...
class C1 {
	...
	function fm1(p0: string, p1: int, p2: bool, globalState: GlobalState): seq<string> {
		[seq(abs(8), i0  => ('w'))] + (["ptmxxv"] + (seq(abs(-969), i1  => ("xfvmyh"))))
	}
	function fm2(p0: int, p1: int, p2: int, globalState: GlobalState): int {
		-|{!true, true, false, !!!false}| * safeDivisionInt(|map[true := -|"f"|]|, 0x1ff)
	}
	method m0(p0: seq<bool>, p1: int, globalState: GlobalState) returns (r0: seq<bool>, r1: int, r2: bool) {
		...
		v0[safeIndex(101, v0.Length)] := v2;
		v0[safeIndex(101, v0.Length)] := new bool[20](i0 => v1);
		var v3 := DC0(-0x2c8);
		...
		match (v3) {
			case DC0(cf0) =>
				...
				globalState.f1 := fm2(if (true) then p1 else |v13|, safeDivisionInt(p1, p1), |(v14 + {v6.f23})|, globalState);
		}
			...
			decreases 100 - i3
		{
			...
			var v21 := DC2(if (v1 in v20) then v20[v1] else |(seq(abs(0x34a), i4  => ('h')))|, safeDivisionInt(v6.f23, v6.f23), 0x4f * v6.f23, multiset{v1});
...
function fm12(globalState: GlobalState): map<int, int> {
	match DC10(|map[328 := !false]|, false, true) {
		case DC9() => map[|multiset{|(seq(abs(-434), i0  => ('n')))|}| := |"lvkiymydd"|] + map[-0x7b := |"hbmvsuvj"|]
		case DC10(cf17, cf18, cf19) => map[cf17 := -cf17] + map[cf17 := cf17]
		case DC8(cf16) => map[--|map[7 := true]| := -0x1df] + (map v0 : int | (0xb5 <= v0) && (v0 < -695) :: (safeDivisionInt(v0, |"tyrwk"|)) := (|[true]|))
...
method m1(p0: seq<bool>, p1: int, p2: bool, globalState: GlobalState) {
	...
	var v1 := "kajqui";
	v0 := v0[safeIndex(0x3d0, |v0|) := fm7(p1, fm11(p1, p1, globalState), |v1|, globalState)];
	if (match DC0(-p1) {
		case DC0(cf0) => !p2
	}) {
		var v2 := DC1(p2);
		match (v2) {
			case DC2(cf2, cf3, cf4, cf5) =>
				...
				var v5: map<int, int> := map[safeModuloInt(cf2, |v4|) := cf2];
				v5 := v5[cf3 := p1 * p1];
			case DC1(cf1) =>
				var v6: seq<string> := [v1];
				var v7 := 'd';
				var v8: array<string> := new string[3] [v6[safeIndex(p1, |v6|)], v1[safeIndex(p1, |v1|) := v7], v1];
				v8[safeIndex(760, v8.Length)] := if (cf1) then v1 else v1;
				v8[safeIndex(760, v8.Length)] := (v1 + ("noirux")[safeIndex(p1, |"noirux"|) := 'x']) + (v1 + v1);
				var v9: map<string, bool> := map["xklvyc" := p0[safeIndex(p1, |p0|)]];
				var v10: array<array<int>> := new array<int>[7];
				var v11: C0 := new C0(0xf5, v10);
				var v12: map<bool, C0> := map[false := v11];
				var v13: array<int> := new int[18] [p1, 0x325, p1, p1, p1, p1, p1, |v12|, v11.f23, 0x3df, v11.f23, 0x10e, |(seq(abs(0x282), i0  => (p1)))|, v11.f23, p1, p1, p1, |p0|];
				...
				var v20: array<int> := new int[12] [p1, p1, v0[safeIndex(v0[safeIndex(p1, |v0|)], |v0|)], p1, p1, -539, p1, |v19|, |p0|, v11.f23, v11.f23, safeModuloInt(|v8[safeIndex(760, v8.Length)]|, -v11.f23)];
				v13[safeIndex(814, v13.Length)] := 0x2ec + p1;
				...
				v21[safeIndex(859, v21.Length)] := v23;
				v9, v13[safeIndex(814, v13.Length)], v21[safeIndex(859, v21.Length)], globalState.f7 := v9, v11.f23, v23, v11.f23 * p1;
				v8[safeIndex(760, v8.Length)] := (seq(abs(0x31c), i1  => (v7)))[safeIndex(safeModuloInt(p1, |map[!cf1 := v13[safeIndex(814, v13.Length)]]|), |(seq(abs(0x31c), i1  => (v7)))|) := v7];
				...
				v24[safeIndex(994, v24.Length)] := v26;
				var v27: map<bool, int> := map[p2 := v13[safeIndex(814, v13.Length)]];
				v25[safeIndex(877, v25.Length)] := p2;
				var v28 := DC8(v26);
				v24[safeIndex(994, v24.Length)], globalState.f1, v27, v25[safeIndex(877, v25.Length)] := v28.cf16, p1 + (|v8[safeIndex(760, v8.Length)]| * v13[safeIndex(814, v13.Length)]), v27, cf1;
			case DC3(cf6) =>
				var v29: array<array<int>> := new array<int>[3];
				var v30 := new C0(p1, if (p2) then v29 else v29);
				var v31: array<int> := new int[7];
				v31[safeIndex(886, v31.Length)] := fm7(p1, p0, v30.f23, globalState);
				globalState.f12, v31[safeIndex(886, v31.Length)] := p2, p1 * v0[safeIndex(v30.f23, |v0|)];
				v29[safeIndex(560, v29.Length)] := v31;
				v29[safeIndex(560, v29.Length)] := v31;
				globalState.f18 := if (p2) then v30.fm5(globalState) <==> p2 else p2;
		}
		
		var v32: array<string> := new string[11](i2 => v1);
		v32[safeIndex(439, v32.Length)] := v1 + v1;
		v32[safeIndex(439, v32.Length)] := v1;
		var v33: array<set<D3>> := new set<D3>[15];
		var v34: multiset<bool> := multiset{p2};
		var v35 := DC2(0x1b, p1, p1, v34[p2 := abs(978)]);
		var v36: set<int> := {p1, p1};
		var v37: map<bool, int> := map[p2 := p1];
		var v38: seq<seq<D1>> := [[v35] + [v35, v35, DC2(|v36|, p1, |v37|, v34[p2 := abs(p1)]), v35]];
		...
		if (p2) {
			...
			v1 := v1;
			v40[safeIndex(70, v40.Length)] := |"dseb"|;
			v40[safeIndex(70, v40.Length)] := p1;
		} else {
			var v45 := 'k';
			var v46: map<int, bool> := map[p1 := !p2];
			var v47 := DC6(v45, v35.cf4 - |v32[safeIndex(439, v32.Length)][safeIndex(|v46|, |v32[safeIndex(439, v32.Length)]|) := v45]|);
			v47 := DC6(v45, p1);
			var v48 := new C1();
			var v49: map<int, seq<bool>> := map[p1 := p0];
			var v50, v51, v52 := v48.m0(p0, safeModuloInt(|v49|, p1), globalState);
			var v53: array<bool> := new bool[26](i4 => p2);
			var v54: map<int, array<bool>> := map[|v37| := v53];
			var v55: multiset<array<bool>> := multiset{if (|v32[safeIndex(439, v32.Length)]| in v54) then v54[|v32[safeIndex(439, v32.Length)]|] else v53};
			var v56: array<int> := new int[2] [p1, fm7(|v55|, v50, p1, globalState)];
			v56[safeIndex(779, v56.Length)] := v51;
			v56[safeIndex(779, v56.Length)] := |v32[safeIndex(439, v32.Length)]|;
			var v57: map<D1, bool> := map[v35 := !(if (true) then v52 else v52)];
			v57 := v57[v35 := [p1] != v0];
		}
		
		var v58 := 'u';
		if (!(v58 !in (seq(abs(799), i5  => (v58))))) {
			globalState.f18 := true;
			var v59: array<multiset<bool>> := new multiset<bool>[26];
			v59[safeIndex(846, v59.Length)] := v34[fm0(seq(abs(0x38e), i6  => ('u')), globalState) := abs(p1)];
			v59[safeIndex(846, v59.Length)] := v34;
			var v60 := new C1();
			...
			var v66: map<char, array<bool>> := map[v1[safeIndex(|v32[safeIndex(439, v32.Length)]|, |v1|)] := v65];
			v66 := v66[v58 := v65];
		} else {
			var v67: map<int, int> := map[p1 := p1];
			var v69: seq<set<int>> := [set v68 : int | v68 in v67 :: (safeModuloInt(v68, -384))];
			globalState.f15 := |v69[safeIndex(p1, |v69|)]| != |v0|;
			v32[safeIndex(439, v32.Length)] := "jbmrcixia";
			globalState.f7 := -p1;
			v39 := if (!(p1 >= p1)) then if (p2) then v39 else v39 else v39;
			var v70: C1 := new C1();
			var v71: map<int, C1> := map[0x36d := v70];
			var v72: map<map<int, C1>, bool> := map[v71 := p0[safeIndex(p1, |p0|)]];
			var v73: seq<C1> := [v70];
		...
		match (v77) {
			case DC5(cf8) =>
				...
				var v87: array<char> := new char[25] [v83, v83, v83, v83, v83, if (p2) then if (p1 in v85) then v85[p1] else v83 else v83, 't', 'j', if (p2) then v83 else v83, cf8[safeIndex(p1, |cf8|)], v83, if (p2 in v86) then v86[p2] else v83, v83, v83, v83, v83, cf8[safeIndex(v79.f23, |cf8|)], v83, v1[safeIndex(-v79.f23, |v1|)], v83, v83, v83, v83, cf8[safeIndex(|fm14(globalState)|, |cf8|)], v83];
				v87[safeIndex(656, v87.Length)] := v83;
				v87[safeIndex(656, v87.Length)] := if (v79.f23 in v85) then v85[v79.f23] else v83;
				var v88: array<bool> := new bool[8](i7 => !(if (p2) then p2 else p2));
				v88[safeIndex(592, v88.Length)] := !p2;
				var v89: multiset<string> := multiset{cf8, cf8};
				globalState.f12, v88[safeIndex(592, v88.Length)] := p2, p1 <= (if ((seq(abs(0x95), i8  => (v83)))[safeIndex(p1, |(seq(abs(0x95), i8  => (v83)))|) := v83] in v89) then v89[(seq(abs(0x95), i8  => (v83)))[safeIndex(p1, |(seq(abs(0x95), i8  => (v83)))|) := v83]] else p1);
			case DC6(cf9, cf10) =>
				var v90: array<array<char>> := new array<char>[29];
				var v91: array<char> := new char[9];
				var v92: seq<array<char>> := [v91, v91];
				v90[safeIndex(278, v90.Length)] := v92[safeIndex(p1, |v92|)];
				var v93 := DC12(v91);
				v90[safeIndex(278, v90.Length)] := (v93.(cf21 := v92[safeIndex(p1, |v92|)])).cf21;
				...
				v95[safeIndex(969, v95.Length)] := p2 !in v96;
				var v97: array<array<int>> := new array<int>[19];
				var v98: C0 := new C0(p1 * cf10, v97);
				v93, v95[safeIndex(969, v95.Length)], v98 := DC12(v91), true, if (p2) then if (p2) then v98 else v98 else v98;
			case DC7(cf11, cf12, cf13, cf14, cf15) =>
				v1 := v1;
				var v99: C1 := new C1();
				v99 := v99;
				globalState.f2 := p2;
				globalState.f20 := -safeDivisionInt(-0x17c, |(seq(abs(0x120), i10  => (cf12)))|);
			case DC4(cf7) =>
				v1 := v1;
				var v100 := new C1();
		...
		decreases 100 - i11
	{
		...
		v106[safeIndex(100, v106.Length)] := !p2;
		v106[safeIndex(100, v106.Length)] := p1 > -p1;
		var v107: set<bool> := {p2, p2};
		globalState.f15 := if (v106[safeIndex(100, v106.Length)]) then v107 > v107 else p2;
		...
		var v114: C0 := new C0(|(seq(abs(0x83), i12  => ('e')))|, v113);
		var v115: map<bool, C0> := map[v106[safeIndex(100, v106.Length)] := v114];
		v114 := if (p0[safeIndex(-|p0|, |p0|)]) then v114 else if (true in v115) then v115[true] else v114;
		var v116: map<bool, int> := map[v106[safeIndex(100, v106.Length)] := p1];
		var v117 := new C0(v114.fm4(if (v106[safeIndex(100, v106.Length)] in v116) then v116[v106[safeIndex(100, v106.Length)]] else |v1|, globalState), v113);
	}
	var i13 := 0;
	while (p2)
		decreases 100 - i13
	{
		...
		var v119: C1 := new C1();
		v118[safeIndex(4, v118.Length)] := v119;
		var v120: array<string> := new string[2](i14 => v1);
		var v121: seq<string> := [v1, v1];
		v120[safeIndex(262, v120.Length)] := v121[safeIndex(-p1, |v121|)];
		var v122 := 'y';
		v118[safeIndex(4, v118.Length)], globalState.f2, v120[safeIndex(262, v120.Length)], globalState.f7 := v119, p2 || p2, (if (p2) then v1 else "rndnxs")[safeIndex(p1, |(if (p2) then v1 else "rndnxs")|) := v122], |(((seq(abs(0x3ce), i15  => (v122))) + v1)[safeIndex(0xc9, |((seq(abs(0x3ce), i15  => (v122))) + v1)|) := v1[safeIndex(p1, |v1|)]] + v1)|;
		var v123: array<char> := new char[1] [v122];
		v123[safeIndex(108, v123.Length)] := v122;
		v123[safeIndex(108, v123.Length)] := 'i';
		globalState.f7 := p1;
		var v124: array<array<int>> := new array<int>[9];
		var v125: C0 := new C0(p1, v124);
		var v126: map<int, C0> := map[p1 := v125];
		v126 := map[|v120[safeIndex(262, v120.Length)]| + p1 := v125];
	}
	var v127: multiset<int> := multiset{p1};
	globalState.f20 := v0[safeIndex(safeDivisionInt(p1, |v127|), |v0|)];
}
method Main() {
	...
	forall i0 | 0 <= i0 < v14.Length {
		v14[i0] := map[v1 := v1] + (map[|map[v1 := v4]| := v1] + (map v15 : int | v15 in map[v1 := --v1] :: (safeDivisionInt(v15, 476)) := (v1)));
	}
	globalState.f20 := v1 * v1;
	var v16: map<bool, int> := map[v4 := v1];
	v6 := v6[safeIndex(v1, |v6|) := |v16|];
	if (!fm0(v2, globalState)) {
		...
		v22[safeIndex(441, v22.Length)] := v21;
		v22[safeIndex(441, v22.Length)] := v21;
		m1(v9, v6[safeIndex(v18.f23, |v6|)], v4, globalState);
	} else {
		...
		m1(v9[safeIndex(v24.f23, |v9|) := v4] + v9, fm7(v24.f23, v9, |v2|, globalState), (fm8(v4, globalState)).cf1 ==> v4, globalState);
		var v25 := 'o';
		globalState.f4 := v25;
		globalState.f20 := v1;
		v11[safeIndex(282, v11.Length)] := v4;
		...
		v11[safeIndex(282, v11.Length)], v26, v28, globalState.f12 := v24.fm5(globalState), v26, v28 + v28, (if (v4 in v29) then v29[v4] else v8) <= (set v31 : int | v31 in v30[|v8| := v4] :: (v31 - |"bmowmb"|));
	}
	...
	if (match v33 {
		...
		v0[safeIndex(880, v0.Length)] := v1;
		v0[safeIndex(880, v0.Length)] := v1;
		var v34 := new C1();
		var v35 := 'q';
		var v36: map<char, char> := map[v35 := v35];
		v11[safeIndex(127, v11.Length)] := v35 !in v36;
		v11[safeIndex(127, v11.Length)] := v4;
		v1 := v1;
		v11[safeIndex(127, v11.Length)] := !(v4 <==> fm0(v2, globalState));
	} else {
		var v37 := 'k';
		var v38: map<char, array<bool>> := map[v37 := v11];
		v38 := v38;
		var v39: set<bool> := {fm0(v2, globalState), v4, v4, v4};
		globalState.f1 := if (({false} !! v39) in v5) then v5[{false} !! v39] else -safeModuloInt(v1, v6[safeIndex(v1, |v6|)]);
		globalState.f1 := v1;
		globalState.f20 := -(v1 * v1);
	...
	for i1 := v1 to |v16| {
		...
		v44 := v44 + (v44 + v44);
		var v45 := DC4(seq(abs(-980), i2  => (v42)));
		v11[safeIndex(78, v11.Length)] := v45.cf7 != v2;
		v11[safeIndex(78, v11.Length)] := fm0(v2[safeIndex(|v6|, |v2|) := v42], globalState);
	}
	for i3 := v1 to 582 {
		...
		var v52 := 'k';
		var v53: map<D1, multiset<bool>> := map[fm10(v9[safeIndex(i3, |v9|)], v2[safeIndex(i3, |v2|) := v52], v1, v1, globalState) := v5];
		var v54 := DC1(v4);
		var v55 := DC3(v54);
		v11, globalState.f20, globalState.f20, globalState.f20, globalState.f7 := if (safeModuloInt(-fm7(i3, [v4], i3, globalState), |v2|) in v49) then v49[safeModuloInt(-fm7(i3, [v4], i3, globalState), |v2|)] else v11, safeModuloInt(safeDivisionInt(478, |v51|), safeDivisionInt(|(if (v55 in v53) then v53[v55] else v5)|, i3)), safeDivisionInt(safeModuloInt(|[i3, i3]|, |v9|), v50.f23), i3, v1;
		globalState.f7 := -573;
		v11[safeIndex(700, v11.Length)] := true;
		v11[safeIndex(700, v11.Length)] := !v4;
	}
	...
	v61[safeIndex(968, v61.Length)] := v33;
	v61[safeIndex(968, v61.Length)] := v33;
	...
	for i5 := v1 to |v68[v67 := abs(|v69|)]| - |v70| {
		var v71 := new C0(i5, v57.f22);
		globalState.f20 := safeDivisionInt(v71.f23, safeDivisionInt(v1, v67.f23));
		v11[safeIndex(212, v11.Length)] := v4;
		v11[safeIndex(212, v11.Length)] := v4;
		...
		v73[safeIndex(0, v73.Length)] := v72;
		globalState.f20, v73[safeIndex(0, v73.Length)], globalState.f12 := v1, v72, v71.fm5(globalState);
	}
	...
	for i6 := v67.f23 to v1 {
		...
		globalState.f9 := v9;
		v11[safeIndex(148, v11.Length)] := v4;
		v0[safeIndex(814, v0.Length)] := |v2|;
		var v75 := 't';
		v2, v11[safeIndex(148, v11.Length)], globalState.f12, v0[safeIndex(814, v0.Length)] := v2 + ("nvpltex")[safeIndex(v67.f23, |"nvpltex"|) := v75], v4, v4, DC0(v67.f23).cf0;
		var v76: array<D1> := new D1[18];
		var v77 := DC2(|v2|, v67.f23, v67.f23, multiset(v9));
		v76[safeIndex(516, v76.Length)] := v77;
		v76[safeIndex(516, v76.Length)] := v77;
	}
	print v0[0], "\n";
	print v0[4], "\n";
	print v1, "\n";
	print v2, "\n";
	print v3 == multiset{522, 522, 522, 1, 651}, "\n";
	print v4, "\n";
	print v5 == multiset{true}, "\n";
	print v6 == [1, 1], "\n";
	print |v7|, "\n";
	print v8 == {522, 164, -522}, "\n";
	print v9 == [true, true, false, false], "\n";
	print v10 == map[[true, true, false, false] := {522, 164, -522}], "\n";
	print v11[4], "\n";
	print v11[6], "\n";
	print v11[7], "\n";
	print |v12|, "\n";
	...
	print globalState.f5 == {522, 164, -522}, "\n";
	print globalState.f6, "\n";
	print globalState.f7, "\n";
	print globalState.f8, "\n";
	print globalState.f9 == [true, true, false, false], "\n";
	print globalState.f10, "\n";
	print globalState.f11 == map[[true, true, false, false] := {522, 164, -522}], "\n";
	...
	print v14[0] == map[522 := 522, 1 := 522], "\n";
	print v14[1] == map[522 := 522, 1 := 522], "\n";
	print v14[2] == map[522 := 522, 1 := 522], "\n";
	print v14[3] == map[522 := 522, 1 := 522], "\n";
	print v14[4] == map[522 := 522, 1 := 522], "\n";
	print v14[5] == map[522 := 522, 1 := 522], "\n";
	print v14[6] == map[522 := 522, 1 := 522], "\n";
	print v14[7] == map[522 := 522, 1 := 522], "\n";
	print v14[8] == map[522 := 522, 1 := 522], "\n";
	print v14[9] == map[522 := 522, 1 := 522], "\n";
	print v14[10] == map[522 := 522, 1 := 522], "\n";
	print v14[11] == map[522 := 522, 1 := 522], "\n";
	print v14[12] == map[522 := 522, 1 := 522], "\n";
	print v14[13] == map[522 := 522, 1 := 522], "\n";
	print v14[14] == map[522 := 522, 1 := 522], "\n";
	print v14[15] == map[522 := 522, 1 := 522], "\n";
	print v16 == map[true := 522], "\n";
	print v33.cf0, "\n";
	print v56[0][0], "\n";
	print v56[0][4], "\n";
	print v56[1][0], "\n";
