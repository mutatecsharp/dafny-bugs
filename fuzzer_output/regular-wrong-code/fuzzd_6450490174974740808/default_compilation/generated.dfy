...
function fm20(p0: int, p1: int, globalState: GlobalState): multiset<map<int, int>> {
	multiset{map v0 : int | v0 in {-0x2f9} :: (v0 + 0x3b5) := (|"tvghivqib"|), map[-361 := |(seq(0x1fe, i0  => ('w')))|], map[|map[|[true, !false]| := !false]| := -0x36a]} - multiset([map[0x24b := |"qbojidmhb"|]] + [map[-55 := --384]])
}
...
function fm28(p0: bool, p1: map<int, int>, p2: D3, p3: map<bool, bool>, globalState: GlobalState): string {
	"axni" + ((seq(0x14a, i0  => ('d'))) + (seq(0x125, i1  => ('o'))))
}
...
function fm35(p0: int, p1: bool, p2: int, p3: char, globalState: GlobalState): seq<int> {
	(seq(0x27e, i0  => (|DC63(map[-0x199 := "vyixwxt"]).cf100|))) + [|(map v0 : char | v0 in map['d' := true] :: (v0) := (false))|, 0x320, 0x5f, -0x188]
}
function fm38(p0: bool, p1: int, p2: int, globalState: GlobalState): seq<int> {
	[-|"oihg"|, -0x3e5, |"gekldkc"|] + (seq(0x3e3, i0  => (|"fjogb"|)))
}
...
function fm42(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): string {
	seq(0x21, i0  => (if (false) then 'u' else 'r'))
}
function fm43(p0: bool, globalState: GlobalState): bool {
	(multiset{'m'} > multiset{'a'}) <== (map[-928 := false] == map[|(map v0 : int | (0x118 <= v0) && (v0 < 0xc5) :: (v0 % |"hcqe"|) := ('j'))| := false])
}
...
function fm47(p0: int, globalState: GlobalState): D2 {
	DC2(|[true]| / |map[[111] := |{!false}|]|)
}
function fm48(globalState: GlobalState): map<map<bool, bool>, int> {
	(map[map[!true := true] := 209] + (map v0 : map<bool, bool> | v0 in (seq(216, i0  => (map[false := false]))) :: (v0) := (0x207))) + (map[map[true := true] := -941] + (map v1 : map<bool, bool> | v1 in {map[true := true]} :: (v1) := (|"fratralci"|)))
}
function fm49(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): set<int> {
	(set v0 : int | (0x2f1 <= v0) && (v0 < 841) :: (v0 * |{-0x1da}|)) - ({|map[false := !false]|, |"yattoed"|, -345, |(seq(0x1bd, i0  => (756)))|, -0x3da} + {|"gx"|})
}
...
function fm54(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): seq<map<bool, int>> {
	[map[true := |(seq(0x14, i0  => ('c')))|]] + (if (false) then [map[!true := 0x3e2]] else seq(0x161, i1  => (map[!true := |{0x3ca}|])))
}
...
function fm61(p0: set<seq<bool>>, p1: int, globalState: GlobalState): map<string, bool> {
	((map v0 : string | v0 in ["yp", "lt", "kkt"] :: (v0) := (true)) + (map v1 : string | v1 in multiset{seq(0x35f, i0  => ('h')), "mh"} :: (v1) := (!false))) + (map["issb" := true] + map[seq(373, i1  => ('m')) := true])
}
function fm62(globalState: GlobalState): seq<D3> {
	([DC3(false), DC3(false)] + (seq(0x39e, i0  => (DC3(false))))) + (seq(0x3a0, i1  => (DC3(false))))
}
function fm63(globalState: GlobalState): D19 {
	DC39(multiset([584, |DC60(0x28, "x", {|[0x179, 0x87, -|multiset{false, true}|]|, |(set v0 : int | (0x1f8 <= v0) && (v0 < 0x2f6) :: (v0 * |[true]|))|, |"kfsij"|}).cf93|]) - multiset{|(seq(339, i0  => ('o')))|})
}
...
function fm65(p0: int, globalState: GlobalState): D3 {
	DC4(map['c' := false] == map['c' := !!false], |{false, !!false}|, 0x1bd % 0x3d3, |map[0x89 := !true]| < |multiset{multiset{true, !true}, multiset{true, false}}|, multiset{!false, DC33(false, false, |[|[|(seq(287, i0  => ('s')))|, |multiset{false}|]|, 0x106]|, false).cf48} > multiset{false, !false, !true, true, false})
}
...
function fm69(p0: int, globalState: GlobalState): map<string, int> {
	(map v0 : string | v0 in map["vioord" := |(seq(763, i0  => (DC9('k').cf14)))|] :: (v0) := (|"pgrs"|)) + DC25(map v1 : string | v1 in map[DC22("oixmk").cf29 := 'm'] :: (v1) := (|"illhgq"|)).cf38
}
...
method m16(p0: char, p1: int, p2: seq<int>, p3: bool, globalState: GlobalState) returns (r0: array<bool>, r1: string, r2: int) {
		...
		decreases 100 - i0
	{
		...
		var v8: array<bool> := new bool[16] [p3, v1 < multiset([p3]), p3, p3, !p3, v2[-0xa8], p3, p3, p3, p3, p3, p3, p3, p1 !in v7, p3 <== p3, p3];
		v8[485] := p3;
		v8[485], globalState.f7 := false, --p1;
		var v9 := 'f';
		v9 := v9;
		var v10: array<array<C3>> := new array<C3>[6];
		var v11: map<int, bool> := map[p1 := p3];
		var v12 := "ouvug";
		var v13: C3 := new C3(|v11|, v12, !v8[485], p3);
		var v14: array<C3> := new C3[7] [v13, v13, v13, v13, v13, v13, v13];
		v10[439] := v14;
		v10[439] := v14;
		var v15 := DC3(false);
		var v16: C2 := new C2(v15, v8[485], p3);
		var v17: seq<C2> := [v16];
		v8[485] := if (p1 < |v17|) then !(if (fm21(globalState)) then false else !v8[485]) else false;
	}
...
class C0 {
	...
	method m15(p0: map<set<int>, string>, p1: map<bool, seq<int>>, p2: int, p3: string, globalState: GlobalState) {
		...
		var v3: seq<bool> := [v0[253], v1];
		var v4 := DC2(|v3|);
		var v5: set<int> := {if (fm37(v0[253], globalState) in v2) then v2[fm37(v0[253], globalState)] else v4.cf2, f27, p2};
		var v6: array<int> := new int[14](i2 => i2 / p2);
		var v7 := DC15(false, v0[253], v5, v6, v0);
		v7 := v7;
		var v8 := DC12();
		var i3 := 0;
		while (match v8 {
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			v0[253], globalState.f7 := true, -fm0(v0[253], globalState);
			var v9 := DC16(|p3|, v0[253]);
			v0[253] := !!!v9.cf24;
			v1 := f27 >= p2;
			var v10: array<array<bool>> := new array<bool>[17] [v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, if (v0[253]) then v0 else v0, v0, v0, v0, v0];
			v10 := if (v1) then v10 else if (v1) then v10 else v10;
		}
		forall i4 | 0 <= i4 < v0.Length {
			v0[i4] := DC16(f27, v1).cf24;
		}
		var v11: map<int, bool> := map[p2 := v0[253]];
		var i5 := 0;
		while (p2 !in v11)
			decreases 100 - i5
		{
			...
			if (!v0[253]) {
				...
				v16[559] := v4;
				v16[559] := v4.(cf2 := p2 - f27);
				v0[253] := v1;
				var v17 := DC4(v1, f27, f27, v0[253], v0[253]);
				f27 := v17.cf5;
				v11 := v11[366 := v1];
			}
			
			var v18: seq<int> := [f27];
			var v19: seq<int> := [|v3| % p2, f27, v18[f27], 0x335, p2];
			var v20: map<bool, bool> := map[v1 := v1];
			globalState.f7, v18, v11 := p2, (fm38(false, p2, p2, globalState))[p2 := |map[f27 := v1]|] + v19, map[-p2 := if (v0[253]) then if (!v0[253] in v20) then v20[!v0[253]] else v1 else v0[253]];
			var v21: map<map<bool, int>, int> := map[map[fm37(v1, globalState) := p2] := p2];
			var v22: map<bool, int> := map[v0[253] := v18[p2]];
			v21 := v21[v22 := f27];
...
class C1 extends T0 {
	...
	method m13(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: char, r3: map<bool, int>) {
		...
		for i4 := if (v14 in v15) then v15[v14] else fm0(v16.cf24, globalState) to f14 {
			...
			var v19: seq<int> := [v6.f27 % -0x6c, |(v18 + v18[f14 := -v6.f27])|, -v6.f27, v6.f27];
			globalState.f2, v19, v19 := v6.f27, [v6.f27], fm38(v16.cf24, -v6.f27, v6.f27 / i4, globalState);
			if (!p1) {
				f25 := !p1;
				var v20: map<char, bool> := map[v14 := f25];
				var v21: seq<seq<bool>> := [v17];
				var v22: multiset<bool> := multiset{p0, p1};
				var v23: array<int> := new int[21] [f14 / v6.f27, v6.f27 + fm0(f25, globalState), fm0(if (v14 in v20) then v20[v14] else f25, globalState) + -0x154, 0x386, v6.f27, -(if (p1 in v3) then v3[p1] else v6.f27), |v3|, |v2|, |v21[v6.f27]| - v6.f27, v6.f27, v8.cf5, v6.f27, if (fm0(p1, globalState) in v18) then v18[fm0(p1, globalState)] else |v22|, v6.f27, |v19|, v6.f27, v6.f27, v6.f27, f14, v6.f27 - -0x1d8, v6.f27];
				v23 := v23;
				...
				v27[484] := v25.(cf26 := v24);
				v27[484] := v25;
				globalState.f7 := f14;
				var v28: array<array<int>> := new array<int>[2];
				v28[273] := v23;
				v28[672] := if (f25) then v23 else v23;
				var v29 := DC9(v14);
				var v31: map<set<int>, string> := map[set v30 : int | v30 in [v6.f27] :: (v30 - 0x29c) := v2];
				var v32: set<int> := {v6.f27, v6.f27};
				var v33: array<string> := new string[24] [v2[v6.f27 := v29.cf14], v2 + v2, v2, v2 + v2, seq(0x253, i5  => (v14)), v2, "slao", fm42(p1, |multiset{v6.f27, v6.f27, v6.f27}|, v6.f27, p1, globalState) + v2, v2[f14 := v14], v2, v2, v2 + fm42(p0, v6.f27, v6.f27, p1, globalState), v2 + v2, v2, v2, v2 + v2, "sub", (seq(0x15, i6  => (v14)))[-0x230 := v14], v2 + v2, ("qrtitlk")[i4 := v14], (seq(605, i7  => (v14))) + "ytmlhni", v2, if (v32 in v31) then v31[v32] else fm42(p0, v6.f27, 453, false, globalState), v2];
				v33[918] := "bwcpbhs";
				v23[704] := |v2|;
				var v34: seq<string> := [v2];
				var v35: map<int, array<bool>> := map[|DC0(v17).cf0| := v0];
				v28[273], v28[672], v33[918], globalState.f7, v23[704] := v23, v23, (if (p0) then v34[v6.f27] else seq(-0x140, i8  => (v14))) + v2, --799, |v35|;
			} else {
				...
				f25 := DC3(!p1).cf3;
				var v40: array<seq<seq<int>>> := new seq<seq<int>>[8](i10 => [seq(118, i11  => (|v3|)), [v6.f27]]);
				var v41: seq<seq<int>> := [v19];
				v40[100] := v41;
				var v42: array<map<bool, bool>> := new map<bool, bool>[6](i12 => map[p0 := f25]);
				v40[100], v42, v37, globalState.f7, r1 := v41, v42, v37, v6.f27, f25;
				r2 := v14;
			}
			
			var v43: map<seq<int>, int> := map[v19 := -0x32];
			var v44: set<bool> := {p1, p1, p1, p0};
			f25 := i4 != (if ((seq(0x112, i13  => (0x15d))) in v43) then v43[seq(0x112, i13  => (0x15d))] else |v44|);
		}
		var v45: set<int> := {f14, f14};
		var v46: multiset<bool> := multiset{p0, p1, p1, f14 < |v45|, p0};
		var v47: multiset<string> := multiset{seq(0x322, i14  => (v14))};
	...
	method m14(globalState: GlobalState) returns (r0: array<char>, r1: int, r2: bool, r3: int) {
		...
		var v13: array<int> := new int[23] [|v0|, f14, |v1| * 105, -|v1|, -|v2|, f14, -f14, f14, f14, if (v8[f14 := v7] in v9) then v9[v8[f14 := v7]] else |v10|, f14 + 0x38b, f14, f14, |v11|, f14, f14 - |v10|, f14, --|v10|, f14, |v0[202 := f25]|, |v12| % f14, f14, 0x71];
		v5[779] := f14 % f14;
		v5[779] := |v0|;
		v7 := v7;
		for i1 := -|v0| to f14 {
		...
		f14, v12, v6, r2, v10 := |DC19(v4[-f14 := v5[779]]).cf27|, seq(0x60, i3  => (|("ymnrs")[v5[779] := 'r']| % v5[779])), v6, fm43(f25, globalState), fm42(true, v5[779], -0x3ca - f14, (if (DC15(f25, f25, v3, v13, v6) in v15) then v15[DC15(f25, f25, v3, v13, v6)] else v1) >= v1, globalState);
		f14 := v5[779] % v5[779];
...
class C2 extends T1 {
	...
	function fm3(globalState: GlobalState): map<int, int> {
		((map v0 : int | (-0x360 <= v0) && (v0 < 0x203) :: (v0 * 832) := (0x14a)) + (map v1 : int | (0x176 <= v1) && (v1 < 74) :: (v1 / |[|"jypfe"|, 0x69, |multiset{f17, f16}|, 562, |map[true := |(seq(0x280, i0  => ('n')))|]|]|) := (---325))) + map[-0x1a7 := |(set v3 : string | v3 in (map v2 : string | v2 in map[seq(0xa1, i1  => ('x')) := f17] :: (v2) := (0x29d)) :: (v3))|]
	}
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		v0[349] := fm34(p0, if (p0 in v1) then v1[p0] else p0, p1, p0, globalState);
		var v2 := 'x';
		v0[349] := v2;
		var i0 := 0;
		while (true)
			decreases 100 - i0
		{
			...
			var v5, v6 := m12(f17, |fm35(p0, false, p0, v0[349], globalState)|, v4, !f17, globalState);
		...
		var v27: set<char> := {v2};
		v27 := fm45(v0[349], globalState);
		r0 := -(p0 % p0);
		var v28: map<int, bool> := map[p0 := f16];
		var v29: seq<map<int, bool>> := [v28];
		var i1 := 0;
		while (match DC11(((v29[p0])[p0 := f17])[p0 := f16]) {
			...
			decreases 100 - i1
		{
			...
			if (p1) {
				var v33 := "ftj";
				var v34: array<string> := new string[9] [v33, v33, v33, v33, v33, v33, v33, v33 + "utmfmeu", seq(0x39d, i2  => (DC9(v2).cf14))];
				v34 := v34;
				var v35: map<bool, char> := map[f17 := v0[349]];
			...
			globalState.f7 := |v42| % (v43[|v44|] * v43[190]);
		}
		r0 := fm0(p1, globalState) % fm0(f16, globalState);
	}
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := 0x32f to 71 {
			...
			var v12 := "ktd";
			globalState.f2, v5.f25, globalState.f2, v2[570], v8 := |v9|, !(v10[p1] != v11), |v12|, -p1, fm47(p1 * p3, globalState);
		}
		r0 := p1 / p3;
		for i1 := p3 to p3 {
			...
			v2[459] := i1;
			v15, v2[459], r0, r0 := v15 + (v15 + v15), 0x141, 0x288 - p1, p1 + 0x28f;
			var v16: map<bool, char> := map[false := p0];
			if (if (f17 in v16) then f17 else v0[|multiset([p3, p3])|]) {
				globalState.f7 := v2[459] % (if (f16) then p1 else -0x2e4);
				...
				var v25: set<int> := {v2[459], p3};
				var v26: array<int> := new int[19];
				var v27 := DC15(p2, p2, v25, v26, v3);
				var v28, v29 := m12(if (f16) then f17 else f16, fm0(f16, globalState) * |v20|, v22[v21 := |v24|] * v22, v27.cf20 > v25, globalState);
			} else {
				var v30: map<int, char> := map[p3 := v13[521]];
				var v31 := "atptjlkbt";
				...
				v37 := v37;
				var v38: map<int, bool> := map[-v2[459] := p2];
				var v39: multiset<string> := multiset{fm42(if (i1 in v38) then v38[i1] else true, v36.f27, v36.f27, f16, globalState)};
				v39 := v39;
				v3[67] := fm43(f16, globalState);
				var v40: seq<array<bool>> := [v3, v3];
				var v41 := DC1(v40[v2[459]]);
				v13[521], v3[67], v2[459], v41 := p0, p2, -|DC22("bsgrpsbcd").cf29|, DC1(v3);
			}
	...
	method m12(p0: bool, p1: int, p2: multiset<T0>, p3: bool, globalState: GlobalState) returns (r0: map<bool, multiset<bool>>, r1: bool) {
		...
		if (fm43(p3, globalState)) {
			...
			if (f17) {
				...
				v12, v14, v0, v16, v17 := v12, (v14 + v14) + v14, v0[f16 := f17], (v16 * v16) * (v16 + v16), v17[v18[|(map[p1 := v13])[p1 := v13]|] := 0x33f] + (map v19 : int | v19 in v20 :: (v19 / (if (f17 in v10) then v10[f17] else |v4|)) := (v7.f27));
				var v21 := new C0(v6, v7.f27);
				f16 := !f16;
				var v22: map<string, bool> := map[v3[545] := !!(p0 <== !false)];
				r1 := if (v3[545] in v22) then v22[v3[545]] else f17;
				...
				var v29: multiset<string> := multiset{if (p3 in v28) then v28[p3] else v4, v3[545], "imiolrx"};
			...
			var v47: array<bool> := new bool[3] [false, multiset(v43[|v45| := f16]) >= v46, p0 || p0];
			v47[749] := multiset(v43) !! v46;
			var v48 := 'u';
			var v49: map<char, int> := map[v48 := p1];
			var v50: seq<int> := [p1, p1];
			v41[385], v47[749], globalState.f2, globalState.f7 := "hbphfkp", p1 >= fm0(!p3, globalState), -((if ('m' in v49) then v49['m'] else p1) / v50[p1]), |v42|;
			if (v40.f25) {
				...
				v54 := v54[v41[385] := v53];
				var v55: multiset<string> := multiset{v42, v41[385]};
				var v56: map<bool, int> := map[f17 := p1];
				var v57: map<bool, char> := map[!v47[749] := 'k'];
				var v58 := DC0([f17, v40.f25, true]);
				var v59: map<int, int> := map[v52.f27 := |v46|];
				var v60: array<int> := new int[22] [|v55|, v52.f27, v52.f27, |v41[385]|, if (f17 in v56) then v56[f17] else p1, if (v48 in v49) then v49[v48] else p1, |v41[385][|v57| := v48]| * v52.f27, |v58.cf0|, v52.f27 * v52.f27, v52.f27, p1 + p1, 249, v52.f27, -|v53|, p1, v52.f27, |v41[385]|, p1, -v52.f27 - v52.f27, if (v47[749]) then |multiset{v59, v59}| else v52.f27, -v52.f27 / p1, 0x27d];
				v60[421] := v52.f27;
				v60[421] := v52.f27;
				...
				v65 := v65[v66 := if (v43[p1]) then v48 else v48];
			...
			var v75: array<int> := new int[11] [p1, p1, |v72|, -p1, |v74|, p1, p1, p1, 0x14a, p1 - p1, |v41[385]|];
			v73[554] := p1;
			v73[554] := p1;
		}
		...
		for i4 := |v82| to p1 {
			...
			if (!(if ((if (f17) then v0 else v0) in v85) then v85[if (f17) then v0 else v0] else v86 <= v86)) {
				...
				globalState.f2 := i4;
				var v90 := 'e';
				var v91: map<bool, seq<int>> := map[p3 := fm35(v83[p1], p3, |v0|, v90, globalState)];
				...
				var v98: array<set<bool>> := new set<bool>[26] [if (f16 in v96) then v96[f16] else v97[i4], v95, {true}, v95, v95, v95, v95, v95, v95, v95, {p0, p0, f16, fm43(f17, globalState)}, v95, v95, v95, v95, v95, v95, v95, {if (p3 in v0) then v0[p3] else p0}, {p3}, {f17}, v95, v95, v95, {p0, p3}, fm44(f16, f16, globalState)];
		...
		var v101: set<int> := {p1};
		r1 := fm49(p1, p1, f16, p1, globalState) == ((set v102 : int | v102 in v101 :: (v102 / |[false]|)) + v101);
...
class C3 extends T1 {
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		match (DC7(v2, |map[v4 := f16]|)) {
			...
			case DC6(cf10) =>
				...
				var v13: array<bool> := new bool[28] [p1, f17, !p1, f17, if (p0 in v8) then v8[p0] else if (p0 in v8) then v8[p0] else if (p0 in v8) then v8[p0] else f16, if (p1) then f16 else f16, v9.cf3, f22 < 0x218, f16, !f16, true, p1, -p0 >= |{!f16}|, f16, p1, !p1, false, v1[p0], p1, f16, p1, v11 !! v11, !f17, f16, f16, f17, true, v12.cf6 < |"rxvxscggb"|];
				v13[717] := fm31(p1, p1, globalState);
				var v14: set<int> := {p0};
				var v16 := DC2(f22);
				var v17: multiset<set<int>> := multiset{{-v16.cf2, p0}, v14, v14, v14};
				v0, f16, globalState.f7, v4, v13[717] := if (!f16) then v0 else v0, fm31(true && true, f16, globalState), |v4| % fm0(p1, globalState), [p0, f22, p0, p0], fm31(f17, multiset{v14, set v15 : int | (0x7a <= v15) && (v15 < 0x44) :: (v15 / p0)} >= v17, globalState);
				var v18: seq<array<bool>> := [v13];
				var v19: array<int> := new int[13] [f22 / -f22, 297, f22 - f22, fm0(f16, globalState), p0, |v18|, f22, p0, fm0(f17, globalState), f22, p0, |v1|, p0];
				var v20 := "maojmxu";
				var v21: seq<map<int, bool>> := [map[p0 := f17], map[p0 := v13[717]]];
				var v22 := DC15(f17, v13[717], {p0}, v19, v13);
		...
		if (!(p1 && fm31(true, p1, globalState))) {
			...
			var v31: map<int, array<bool>> := map[|v28| := v30[f22]];
			...
			v45 := v45[v46[f22] := fm32(p1, false, f16, p1, globalState)];
			f16 := false;
			v4 := v4;
			var v47 := DC8(v4 + v4);
		...
		if (fm31(p1, f17, globalState)) {
			...
			var v54 := DC16(f22, p1);
			var v55: array<int> := new int[29] [-(-|"sdsflqmgt"| - |v48|), DC16(f22, f17).cf23, f22, f22, |("xsh" + f23)|, p0, -0xbe, 0x14, f22, p0 * -p0, f22, p0, |map[v0 := p1]|, p0, p0, p0, f22, p0, if (f16) then 0x331 else fm0(p1, globalState), f22, f22, p0, f22, f22, |v4|, if (v50 in v51) then v51[v50] else p0, |v52| / f22, |(if (v48 in v53) then v53[v48] else (multiset{p0})[v54.cf23 := f22])|, f22 % p0];
			v55[88] := f22 * fm0(p1, globalState);
			v49, v55[88] := v49, f22;
			if (f16) {
				globalState.f7 := p0;
				...
				v0, f16, v60[264] := 'm', f17, (v61 - v61) != (multiset{v60, v60} - v61);
				var v62: multiset<char> := multiset{v0};
				var v63: multiset<bool> := multiset{f16, f17};
				globalState.f7, r0, v60[264], v55[88], v50 := --|v62|, p0, v63 == v63, p0, v50;
				globalState.f7 := f22;
				v60[264] := !f17;
				var v64 := DC3(p1);
			...
			m11(p0 % 0x102, f17, v73 + fm50(f22, p1, p1, globalState), v71, globalState);
			var v74 := new C1(p1, 0x1f6 / p0);
		...
		if (!(|v76| > v77.cf31)) {
			...
			match (v82) {
				case DC26() =>
					...
					var v90: array<int> := new int[26] [f22, |"t"|, f22 % f22, -p0, p0, p0, p0, f22, v4[f22], -f22, p0 - p0, 0x29f, |v89|, p0, p0, p0, if (true) then fm0(p1, globalState) else fm0(true, globalState), |v4|, -p0 + -p0, p0, 0x1a, p0, p0, |fm42(f16, p0, p0, true, globalState)|, f22, f22];
					v90[322] := f22;
					var v91: map<seq<int>, int> := map[fm35(p0, p1, f22, v0, globalState) := f22];
					var v92 := DC22(v88);
					v88, f16, v90[322], r0, f16 := v88 + f23, f17, (f22 % -f22) % |(v91 + v91)|, p0, v0 in v92.cf29;
					r0 := f22;
				case DC25(cf38) =>
					var v93 := DC3(f17);
			...
			if (p1) {
				...
				v98[403] := -f22;
				v98[403] := f22;
				globalState.f7 := if (f16) then v98[403] else p0;
			} else {
				...
				v101 := v101[false <== v1[-p0] := DC12()];
				var v102 := new C1(f17, f22 + f22);
				var v103 := DC3(!true);
				var v104 := new C2(v103, v102.f25 || !f17, v102.f25);
			}
			
			var v105: map<char, int> := map[f23[fm0(f17, globalState)] := 0x218];
			var v106: map<bool, int> := map[f16 := f22];
			var v107: multiset<int> := multiset{34, p0, |v106|, |fm3(globalState)|};
			v105 := v105 + map[f23[-351] := |v107|];
		} else {
			var v108 := DC16(457, false);
			var v109: array<bool> := new bool[20] [f17, f22 in v4, f17, v1[f22], p1, p1, f16, f17, f16, v1[f22], f23 <= f23, f16, !(f22 > p0), true, p1, f16, v108.cf24, true, p1, if (f16) then p1 else f17];
			...
			var v118: array<int> := new int[23] [|f23[|v111| := v0]|, f22, p0, |f23|, -(f22 * f22), |(multiset{!v109[605], p1} * v112[0x1c2])|, p0 + f22, f22, f22 / f22, p0, |v115|, f22, f22, p0, -f22, -0x381 - p0, p0, |f23|, f22, |v117|, p0, f22, |multiset(v4 + v4[p0 := |v76|])|];
			v118 := new int[5];
			v113[761] := p0;
			v113[761] := f22;
			if (fm31(v109[605], v76 == multiset(v1), globalState)) {
				v109[605] := f22 != |v4|;
				var v119 := new C1(v113[761] < |f23|, f22 - |"slvmstdm"|);
				globalState.f7 := p0;
				...
				f16, v120[437], v109[605] := fm43(p1, globalState), fm51(fm0(f16, globalState), 631, v1 + [f16], v123, globalState), p1 <==> f16;
				var v124: multiset<seq<bool>> := multiset{(v110[p0])[p0 := f17] + v1, v1};
				var v125: seq<string> := ["axlauykx", f23, f23];
				v4, v109[605], globalState.f7, v0 := v4, f16, if ((v1 + v1[|v125| := v119.f25]) in v124) then v124[v1 + v1[|v125| := v119.f25]] else p0, fm39(globalState);
			} else {
				var v126 := "srahniy";
				v126 := (if (true) then v126 else v126) + (v126 + f23);
				v1 := v1;
				var v127: set<string> := {f23 + (seq(-0x1ef, i4  => (v0))), f23, f23, f23 + v126};
				var v128: array<string> := new string[2](i5 => "btxaxkf");
				v128[517] := v126;
				var v129: multiset<char> := multiset{v0, v0};
				v127, v109[605], v128[517], v109[605] := v127, if (v109[605] <== !p1) then p1 else v129 < multiset{'w', v0}, f23, f17;
				v109[605] := if ((if (v4[f22] in v3) then v3[v4[f22]] else 0x1cb) > p0) then p1 && f17 else f17;
				f16 := 0x34e < p0;
			}
		...
		r0 := --(0xc0 - |(f23 + (seq(0x35f, i6  => (v0))))|);
	}
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		var v0: map<int, bool> := map[p3 := f16];
		var v1 := DC11(v0);
		var v2: seq<bool> := [f17, p2];
		var v3 := DC4(!f17, |f23|, |v1.cf15|, v2[|v2|], f17);
		match (DC5(v3)) {
		...
		var v14: array<int> := new int[24](i1 => i1 % |{f22}|);
		v14 := v14;
	...
	method m11(p0: int, p1: bool, p2: set<multiset<bool>>, p3: multiset<bool>, globalState: GlobalState) {
		...
		v0[852] := f17;
		v0[852] := fm31(f16, true, globalState);
		if (f16 <== v0[852]) {
			globalState.f2 := f22 % (p0 + f22);
			v0[852] := p1;
			var v1: C1 := new C1(v0[852], p0 + p0);
			v1 := v1;
			var v2: map<bool, bool> := map[false := p1];
			var v3: map<map<bool, bool>, int> := map[v2 := 0x34c];
			globalState.f7 := -(if (v2 in v3) then v3[v2] else -|f23|) * fm0(v0[852], globalState);
			var v4: map<int, bool> := map[p0 := f17];
			var v5: seq<map<int, bool>> := [v4];
			var v6 := DC11(v5[f22] + v4);
			v6 := v6;
		} else {
			f16, globalState.f7 := f16, -p0;
			v0[852] := v0[852];
			var v7: map<bool, map<int, bool>> := map[f17 := map[p0 := true]];
			var v8: map<int, bool> := map[f22 := v0[852]];
			match (DC11(if (p1 in v7) then v7[p1] else v8).(cf15 := v8)) {
				case DC12() =>
					globalState.f7 := f22;
					var v9 := 'h';
					f16 := f22 >= |(if (p1) then f23 else (seq(719, i0  => ('u')))[p0 := v9])|;
					v0[852] := v0[852];
					var v10: array<set<bool>> := new set<bool>[24](i1 => {p1, f16});
					var v11 := new C0(v10, f22);
				case DC11(cf15) =>
					var v12: seq<bool> := [f17, v0[852], f17, if (f17) then true else false, p1 || f16];
					var v13: seq<int> := [0x158, f22];
					v12 := fm52(|(seq(734, i2  => (f23[p0])))| < p0, f22, if (f17) then |v13| else f22, fm0(fm31(v0[852], v0[852], globalState), globalState), globalState);
					var v14: array<seq<bool>> := new seq<bool>[15](i3 => v12);
					v14[482] := v12;
					v14[482] := v12 + v12;
					f16 := f17;
					var v15: set<bool> := {v0[852], false};
					var v16 := DC29(v15);
		...
		var v20: map<D13, int> := map[DC26() := -f22 / p0];
		v20 := v20 + v20;
		v0[852] := p0 < f22;
		v0[852], globalState.f2, v0[852], globalState.f2, v0[852] := match DC29(fm44(f17, v0[852], globalState)) {
			case DC30(cf44) => p1
			case DC29(cf43) => !v0[852]
			case DC31(cf45) => f16
		}, --(if (v0[852]) then -(p0 - p0) else p0 + |(seq(-0x2c6, i4  => ('w')))|), v0[852], fm0(p1, globalState), true;
	}
}
...
class C4 extends T2 {
	...
	function fm12(p0: int, globalState: GlobalState): int {
		----(|(if (f17) then "bsrmhd" else "bv")| / |({f16, false} - {!f16})|)
	}
	function fm13(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<bool> {
		([f21, f17] + [f16]) + ([f21, f21] + [true, !f17])
	}
	function fm3(globalState: GlobalState): map<int, int> {
		(map v0 : int | v0 in map[|{|"teahcor"|}| := [-0x225]] :: (v0 - 912) := (-0x8)) + ((map v1 : int | v1 in [--0x328] :: (v1 % |[0x39a, -|(seq(309, i0  => ('y')))|, 380]|) := (|multiset{|[f21, f16, f16, f17, true]|}|)) + map[|map[|multiset{f21, f17, false}| := |{f17, f16}|]| := |multiset{0x3b7}|])
	}
	method m6(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		var v0: seq<int> := [p2];
		...
		if (true) {
			...
			if (v3 !in v5) {
				...
				var v9: seq<string> := [v8[p2]];
				var v10: set<int> := {p2};
				var v11: multiset<bool> := multiset{f16, f17};
				var v12: array<bool> := new bool[13] [f16, v9[-154] == v6, f21, f17, f21, p2 >= p2, p1, if (!true) then p0 else f17, p0, fm27(0xfe, fm12(|v10|, globalState), p2, map[p2 := p2], globalState), p1, !f16, v2[|v11|]];
				v12[298] := p1;
				var v13: array<int> := new int[12];
				var v14: set<bool> := {p1};
				var v15 := DC4(false, 42, p2, f21, true);
				var v16: map<bool, bool> := map[f21 := p1];
				v12, v12[298], globalState.f2, v6, v13 := v12, (v14 + v14) < {false, !p0}, p2 / 256, fm28(false, map[p2 := |{-p2}|], v15, v16[!true := !f21] + v16, globalState), v13;
				globalState.f7 := p2;
		...
		if (|multiset{f17}| == p2) {
			...
			if (f21) {
				...
				var v54: seq<map<int, bool>> := [v49 + (map v52 : int | (0x215 <= v52) && (v52 < 487) :: (v52 % |v1|) := (p1)), map[|v53| := f16]];
				v54 := v54;
				r3 := !(f21 || !f16);
				...
				f16 := true;
				var v58 := "gdfcanlo";
				var v59: array<int> := new int[8] [|v58| % p2, p2, p2 % p2, -(p2 - p2), |v58|, p2, p2 * p2, |v58|];
				v59 := v59;
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		match (if (false) then v5 else v5) {
			case DC0(cf0) =>
				if (f21) {
					...
					globalState.f2, f16, f16, f16 := fm0(p1, globalState), p1, v4[-p0], v7.cf41;
					v4 := cf0;
					f16 := true;
					var v8 := 'f';
					v8 := v8;
					var v9, v10, v11 := m10(f17, v6.f14 % |[[v6.f14]]|, p0 + v6.f14, p1, globalState);
				} else {
					var v12: array<bool> := new bool[18](i0 => "e" <= (seq(0x101, i1  => ('x'))));
					v12[985] := f17;
					v12, v12[985] := v12, f16;
					...
					var v15 := "uiwdx";
					v14[412] := v15;
					var v16 := DC22(seq(0x181, i2  => ('a')));
					v14[412] := v16.cf29;
					globalState.f2 := p0 + 0x208;
					f16, v12[985] := if ((if (!p1) then p0 else p0) in v2) then v2[if (!p1) then p0 else p0] else f21, v13.f25;
				}
				...
				match (v19.(cf41 := f17)) {
					...
					case DC27(cf39) =>
						...
						v30 := v30[fm0(!f16, globalState) := set v32 : int | v32 in v31 :: (v32 / |map[true := -|[DC6(map[true := !true]), DC6(map[false := true])]|]|)];
						v18.f14 := v18.f14;
						var v33: array<int> := new int[20](i3 => i3 * |v17|);
						v33[988] := v18.f14;
						var v34 := DC4(cf0[v18.f14], -0x104, v18.f14, true, f16);
						v33[988] := v34.cf6;
				...
				var v41: map<int, array<D12>> := map[|(seq(-0x1e7, i4  => (v18.f14)))| := v40];
				...
				v42[228] := v41;
				v37[514], v0[589], v42[228] := v18.f14, v38, v41;
				if (v37[514] in ([p0])[21 := |v17|]) {
					globalState.f2 := |[f16, p1, !f17, fm43(v4[v37[514]], globalState)]|;
					var v43: array<bool> := new bool[21] [cf0[v18.f14], f21, true, f16, f21, DC4(p1, 0x101, v18.f14, f17, false).cf4, cf0[v18.f14], p1, !f17, f17, if (v18.f14 in v2) then v2[v18.f14] else f21, f21, f21, f21, !v4[|v17|], f16, !f17, false, true, f21, f21];
					var v44: map<string, array<bool>> := map[v17 := v43];
					v44 := (v44 + v44) + v44;
					var v45 := DC7(v5, v18.f14);
					var v46: map<bool, bool> := map[p1 := true];
					var v47: map<int, int> := map[|v46| := v39[|v2|]];
					var v48 := DC12();
					var v49: seq<D7> := [v48, v48, v48];
					var v50: multiset<int> := multiset{v18.f14, v37[514], v37[514]};
					var v51: map<seq<D7>, multiset<int>> := map[v49 := v50];
					var v52 := DC4(!!f17, v18.f14, |(if (v49[p0 := v48] in v51) then v51[v49[p0 := v48]] else v50)|, f16, fm27(v37[514], 36, p0, v47, globalState));
					v17 := fm28(v18.f14 != v45.cf12, v47, v52, fm40(!p1, globalState), globalState);
					v43[372] := f16;
					v43[372] := p1;
					var v53: set<int> := {|map[!f17 := v43[372]]|, 684, |v2|, v18.f14, v39[p0]};
					var v54: map<set<int>, bool> := map[v53 := false];
					var v55: seq<map<set<int>, bool>> := [map[{v52.cf6, v37[514], v18.f14} := f17]];
					v54 := (v55[|cf0|])[fm49(-0x158, -264, v43[372], p0, globalState) := f16];
				} else {
		...
		var v64: array<bool> := new bool[20] [!!true, v58 != fm49(p0, p0, f16, p0, globalState), f17, p1, f16, f16, !f17, p1, p1, f17, fm27(|v59|, p0, |v60[|v61| := 'o']|, v63, globalState), p1, fm27(p0, fm12(p0, globalState), p0, v63, globalState), f21, p0 == p0, f16, f16, p1, p1, if (f21) then f17 else f21];
		...
		if (!!false) {
			...
			match (v67) {
				case DC23(cf30, cf31, cf32) =>
					...
					v68[402] := v69 + v69[v64[722] := f21];
					var v70: seq<map<bool, bool>> := [map[v64[722] := v64[722]], v69];
					v68[402] := v70[|(v66 + v66)|];
					var v71 := 'e';
					v71 := v71;
				case DC24(cf33, cf34, cf35, cf36, cf37) =>
					...
					v75 := (if (false) then v75 else v75) + multiset(v76[v73.f27] + v77[p0 := v74]);
					var v78: array<int> := new int[5];
					v78[905] := v73.f27;
					v60, v78[905], cf36 := seq(331, i8  => ('h')), v73.f27, f16;
				case DC22(cf29) =>
					globalState.f2 := p0;
					v60 := v60;
					var v79: seq<int> := [p0, p0];
					var v80: T0 := new C1(f16, p0);
					var v81 := DC4(DC28(p0, f17, v80).cf41, v80.f14, |fm42(false, |v58|, v80.f14, p1, globalState)|, v64[722], f21);
					var v82: map<bool, bool> := map[f17 := f16];
					globalState.f7 := v79[|fm28(p1, v63, v81, v82, globalState)|] / (fm0(f16, globalState) * |map[p0 := v80.f14]|);
					var v83 := 'p';
					var v84: array<set<bool>> := new set<bool>[9] [v66, {f17}, {p1}, v66, v66, v66, v66, {v64[722]}, v66];
					var v85: C0 := new C0(v84, |v79|);
					var v86: map<C0, char> := map[v85 := v83];
					var v87: map<int, char> := map[p0 := v83];
					v83, v60, f16, v64[722] := if (f21) then if (v85 in v86) then v86[v85] else v83 else if (312 in v87) then v87[312] else v83, v60, f17, !f17 ==> f21;
			}
			
			globalState.f2 := fm0(v64[722], globalState);
		} else {
			f16 := f16;
			v64[973] := !p1;
			v64[973], r0 := !(true ==> !p1), p0;
			v64[973] := f16;
			var v88 := 'q';
			var v89: array<set<bool>> := new set<bool>[10];
			var v90: C0 := new C0(v89, p0);
			var v91: T0 := new C1(v64[973], |[v90, v90]|);
			var v92: seq<T0> := [v91, v91, v91, v91];
			var v93: C3 := new C3(v91.f14, seq(0x162, i9  => (v88)), f21, p1);
			...
			var v99: array<D9> := new D9[28] [v98, DC15(f16, f17, v58, v96, v97), v98, v98, v98.(cf22 := v97).(cf18 := p1), v98, v98, v98, DC15(f21, p1, v58, v96, v97), v98, v98, v98, v98, v98, v98, v98, DC15(p1, f17, v58, v96, v97).(cf19 := true), v98, v98, v98, v98, v98, DC15(v64[973], v64[973], v58, v96, v97), v98, v98, DC15(f17, v64[973], {v93.f22}, v96, v97), v98, DC15(p1, f17, v58, v96, v97)];
			var v100: seq<array<D9>> := [v99, v99, v99];
			var v101 := DC3(v64[973]);
			var v102: seq<D3> := [v101];
			var v103 := DC24(f16, v4[p0 := p1], v100, v101.cf3, v102);
			...
			var v105 := new C2(v101, v4[v93.f22], p1);
		}
		...
		match (v106) {
			case DC4(cf4, cf5, cf6, cf7, cf8) =>
				...
				if (fm42(f16, 537, fm12(|"mtf"|, globalState), true, globalState) <= v60) {
					...
					v64[307] := f16;
					v64[307] := if (fm0(cf7, globalState) in v2) then v2[fm0(cf7, globalState)] else !fm31(cf7, cf4, globalState);
					v108 := p1;
			...
			case DC3(cf3) =>
				if (f17) {
					...
					var v127 := new C3(p0 / p0, v60, p1, v126 >= multiset([|v61|]));
					v4 := v4;
					var v128: array<int> := new int[4] [v127.f22, v127.f22, |v127.f23|, p0];
					var v129: map<bool, array<int>> := map[f21 := v128];
					var v130: seq<int> := [p0];
					var v131: array<int> := new int[15] [if (p1) then -291 else |v129|, |"jsmajdos"|, v127.f22, -p0 - |fm13(v127.f22, f21, false, globalState)|, v127.f22, v127.f22, v127.f22, 0x361 + |"mksbkds"|, v127.f22 % v127.f22, |"sjpp"|, v130[p0], --p0, v127.f22, |v127.f23|, p0];
					v128[423] := p0;
					v128[423] := p0;
					var v132: array<array<bool>> := new array<bool>[1] [v64];
					var v133: array<string> := new string[26](i12 => v60);
					v133[708] := v60 + "catdtpru";
					v128[423], v132, v128[423], v133[708] := p0, v132, v127.f22, v60 + v127.f23;
					v64[57] := cf3;
					cf3, v128[423], v64[57], v128[423], v60 := f16, v127.f22, fm27(v128[423], p0 + --p0, -fm0(f17, globalState), v63, globalState), p0, seq(0x373, i13  => ('c'));
				} else {
					...
					v138 := v138[v134 := v137];
					v61, f16, globalState.f2 := v61[cf3 := |map[v4[v136.f14] := f17]| % v136.f14], !!cf3, v136.f14;
					f16 := false;
					globalState.f2 := (v136.f14 / p0) * -fm0(f16, globalState);
					v64 := v64;
				}
				
				var v139: map<bool, int> := map[cf3 := p0 / |"c"|];
				v139 := v139[true := |"n"|];
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		if (v10.cf3) {
			...
			var v23: array<bool> := new bool[18] [v16[|v16|], f16, !f21, f16, f21, f21, p2, p2, f17, if (true) then f21 else if (v7 in v19) then v19[v7] else false, f16, f16, p2, (v20[v17.f14])[|v16| := p0] < v1, v22 == v22, f16, f17 <==> v16[p3], f17];
			v23 := new bool[16];
		}
		...
		if (!!f17) {
			...
			var v34: T1 := new C3(|multiset(v33[p3])|, v1, f21, f21);
			var v35: map<string, T1> := map[seq(430, i0  => (p0)) := v34];
	...
	method m10(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: bool, r1: D6, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			match (if (p2 >= p2) then v5 else v5.(cf38 := v4)) {
				...
				case DC25(cf38) =>
					...
					var v11 := 'q';
					var v12: array<char> := new char[22] [v11, v0[-p2], v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11];
					v12 := v12;
					globalState.f7 := p1;
					var v13: seq<bool> := [p3];
					globalState.f2 := p1 * (|v13| / -p1);
			}
		...
		match (v30) {
			case DC33(cf47, cf48, cf49, cf50) =>
				...
				v33[751] := if (true) then v31 else v31;
				v33[751] := v31;
			...
			case DC34(cf51, cf52, cf53) =>
				...
				globalState.f7, v23[258] := (|v35| - p1) - |v21|, fm43(p3 !in v37, globalState);
				var v38: map<int, int> := map[cf52.f14 := |v0|];
				cf52.f14 := |[f21, true]| / (if (cf53 in v38) then v38[cf53] else |v1|);
			...
			case DC32(cf46) =>
				if (f17) {
					...
					v24, r0, r0, v22[604], v42 := v26, f17, v43 > v43, p2, v42;
					globalState.f7 := -(v22[604] * p2);
					var v45: seq<set<int>> := [set v44 : int | (0x172 <= v44) && (v44 < -0x308) :: (v44 + p2), v18 * {p2, p2, |v0|}];
					v18 := v45[v22[604]];
				} else {
					var v46 := DC23(p0, p2, 182);
					r0, r0 := v46.cf32 == v1[p1], v21[p2];
					r2 := p3;
					var v47 := DC30('m');
					var v48 := 'b';
					v47 := DC30(v48).(cf44 := 'm');
					var v49: map<int, bool> := map[|v25| := v21[p2]];
					v49 := v49[p2 := !f21];
				...
				var v54: map<int, int> := map[p2 % p2 := p2];
		...
		if (fm31(v68 !! v68, v0 <= v0, globalState)) {
			globalState.f7 := (p1 + p2) / p2;
			var v69: set<bool> := {f16};
			globalState.f7 := (p2 - p1) % (|v69| - -|v0|);
			var v70: seq<seq<bool>> := [v21];
			var v71: array<seq<bool>> := new seq<bool>[17] [v21, v21, fm52(f21, -0x3c2, p1, 129, globalState), v21, v21 + v21, fm52(f21, |v1|, p1, p2, globalState), v21, v21 + v70[p1], v21, v21, v21, v21, v21, v21, v21, [true], v21];
			v71 := v71;
			var v72 := 'g';
			v0 := (v0[p1 := v72] + v0) + v0;
			v23[468] := f17;
			...
			var v74: seq<set<int>> := [{|v29|}, set v73 : int | v73 in v1 :: (v73 / 772), v18];
			var v75 := DC36(v74);
...
class C5 extends T2 {
	...
	function fm24(p0: multiset<set<bool>>, p1: bool, p2: bool, globalState: GlobalState): multiset<map<int, bool>> {
		multiset{DC11(map v0 : int | (0xe2 <= v0) && (v0 < 0x18e) :: (v0 / |(seq(40, i0  => ('s')))|) := (f17)).cf15 + (map v1 : int | (-0x243 <= v1) && (v1 < 0x2f) :: (v1 / 0xbe) := (f17)), if (f16) then map v2 : int | v2 in (set v3 : int | (0x6d <= v3) && (v3 < 0x11d) :: (v3 * |[f17]|)) :: (v2 / 595) := (!f17) else map[0x190 := true], map[0x188 := f16], map[|multiset{f17, true}| := f17] + map[|{f17}| := f17], map[0x1 := f16]}
	}
	method m6(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		f16 := !p1;
		...
		v3 := v3[|(if (p0) then map[p2 := p0] else v4)| := v2[v1 := p2] * v2];
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		v0[245] := p0;
		v0[245], f16 := p0, fm23(p1, globalState) || f17;
		var v1 := "ma";
		v1 := v1;
		var i0 := 0;
		while (f16)
			decreases 100 - i0
		{
			...
			match (v5) {
				...
				case DC11(cf15) =>
					...
					var v18: map<string, int> := map[v1 := |(v17 + fm25(v0[245], globalState))|];
					var v19: seq<bool> := [f17];
					var v20: multiset<seq<bool>> := multiset{v19};
					var v21 := 'v';
					var v22: map<int, char> := map[p0 := v21];
					var v23: map<int, map<char, bool>> := map[if (v19 in v20) then v20[v19] else p0 := fm26(v0[245], v0[245], p0, |v22|, globalState)];
					v18 := v18[v1 := v0[245] + |v23|];
					var v24: map<int, string> := map[v0[245] := v1];
					v24 := v24[v0[245] := v1];
					var v25: array<set<bool>> := new set<bool>[26];
					var v26 := new C0(v25, |(seq(0x15e, i1  => (v21)))|);
					f16 := f16;
			}
			
			f16 := f17;
			var v27: seq<int> := [p0, v0[245], |fm13(v0[245], p1, f17, globalState)|, |"jx"|];
			var v28: seq<bool> := [(seq(0x306, i2  => (p0))) == v27, f16];
			v28 := v28;
		}
		if (f17) {
			var v29: seq<bool> := [p1];
			var v30: map<int, int> := map[v0[245] := |v29|];
			f16 := -434 !in v30;
			var v31 := 'y';
			globalState.f7, v31, v0[245] := v0[245], v31, v0[245] + v0[245];
			var v32: array<string> := new string[14] [v1, v1, v1, v1, v1, v1, v1 + v1, "sfbtphsjv", v1, v1, v1, v1, "ocouv", v1 + v1];
			v32[596] := "xaxrbysaq";
			v32[596] := (seq(-0xf4, i3  => (v31))) + (seq(308, i4  => ('p')));
			var v33 := new C1(p1, p0 % |v30|);
			var v34: set<char> := {v31, v31};
			var v35 := new C4(p1, f17, v34 >= v34);
		} else {
			var v36: map<int, bool> := map[p0 := f17];
			var v37: map<bool, int> := map[p1 := |v1|];
			f16 := (-|v36| % -p0) <= (if (p1 in v37) then v37[p1] else v0[245]);
			var v38: seq<bool> := [f16];
			var v39 := DC0(v38);
			var v40 := DC7(v39, 0x165);
			var v41: seq<int> := [p0];
			var v42: map<D4, int> := map[v40 := v41[v0[245]]];
			globalState.f2 := -(if (v40 in v42) then v42[v40] else v0[245]);
			r0 := fm0(p1, globalState);
			f16 := fm43(|v41| > v0[245], globalState);
			var v43 := DC3(f16);
		...
		var v48: multiset<int> := multiset{v0[245]};
		var v49 := DC11(map v47 : int | v47 in v48 :: (v47 + v0[245]) := (f16));
		v0[245] := match if (fm23(f17, globalState)) then DC11(v46) else v49 {
			case DC12() => v0[245]
			case DC11(cf15) => v0[245]
		};
		var v50: T0 := new C1(f17, p0);
		var v51 := DC28(v0[245], p1, v50);
		var v52 := DC4(p1, p0, v51.cf40, v45 <= v45[p0 := v50.f14], f16 || true);
		match (v52) {
			case DC4(cf4, cf5, cf6, cf7, cf8) =>
				v0[245] := cf6;
				var v54: seq<map<int, bool>> := [map v53 : int | (0x2bb <= v53) && (v53 < 0x236) :: (v53 * |v1|) := (true)];
				var v55: map<map<int, bool>, int> := map[v54[p0] := cf5];
				var v56: array<map<map<int, bool>, int>> := new map<map<int, bool>, int>[7] [v55[v46 := v0[245]], v55, map[v49.cf15 := v0[245]], v55 + v55, v55, v55, v55];
				v56[224] := v55;
				var v57: array<bool> := new bool[26];
				v57[568] := f17;
				v56[224], v57[568] := (v55 + (map v58 : map<int, bool> | v58 in map[map[v50.f14 := true] := 0xa3] :: (v58) := (-v50.f14))) + v55, f16;
				var v59: array<string> := new string[2](i5 => v1[|v46| := 'h']);
				var v60 := DC8(v45);
				globalState.f7, cf4, cf8, v59 := v50.f14, false, (multiset{|"pqlcg"|} - v48) !! multiset(v60.cf13), v59;
				var v61: map<bool, bool> := map[f17 := f16];
				var v62 := 'h';
				v1, v57[568], v57[568] := v1 + (v1 + v1), if ((!cf7 || f16) in v61) then v61[!cf7 || f16] else v57[568], v1 < v1[v45[v0[245]] := v62];
			case DC3(cf3) =>
				var v63: array<bool> := new bool[8] [cf3, f17, f16, p1, !!f16, false, p1, f16];
				v63[340] := cf3;
				var v64: seq<bool> := [p1, false, false];
				v63[340] := fm31(f17, v64[|"xus"|], globalState);
				v63[340] := f17;
				v0[245] := |v45|;
				var v65 := DC16(p0, v63[340]);
				var v66 := DC17(v65);
				var v67: map<bool, bool> := map[v63[340] := cf3];
			...
			case DC5(cf9) =>
				...
				if (true) {
					...
					v50.f14 := |(v70 - multiset([f17, v69[263], !f17, f17] + v71))|;
					...
					var v81: set<int> := {|(seq(0x25b, i7  => (|v1|)))|};
					var v82 := DC15(v69[263], f17, v81, v0, v69);
					var v83: array<D9> := new D9[5] [v82, v82, v82, v82, v82];
					var v84: seq<D3> := [DC3(f16)];
					var v85 := DC24(f16, v80, [v83], f17, v84);
					var v86: seq<bool> := [v85.cf36, v69[263], f17];
					f16 := (0x1dc * |v80|) < p0;
					v0[245] := 0x8c;
					v45 := (v45 + v45) + ([DC34(true, v50, v50.f14).cf53, v50.f14] + v45)[87 := v50.f14];
					v69 := v69;
				}
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		if (if (v0 in v1) then v1[v0] else f17) {
			...
			var v18 := new C3(p1 * |v0|, v0, if (v17[|v16|] in v16) then v16[v17[|v16|]] else p2, true);
			var v19: array<int> := new int[27];
			v19[436] := p1;
			globalState.f2, v0, v19[436] := p3, v0, 0x233;
			if (f17) {
				var v20: array<bool> := new bool[12](i0 => f16);
				v20[370] := true;
				var v21: seq<map<int, bool>> := [map[v18.f22 := f17]];
				v0, globalState.f7, v19[436], v20[370], r0 := if (p2) then "wikghvh" else seq(0x318, i1  => (p0)), |v21| / -p3, |v0|, f17, v18.f22;
				v19[436] := v19[436];
				v19[436] := if (f17) then v18.f22 else v18.f22;
				var v22: map<int, string> := map[|(seq(-0x231, i2  => (p0)))| := v0 + v0];
				v22 := v22[683 := v18.f23];
				globalState.f7 := p3;
			} else {
				v19[436], v19[436], v19[436], globalState.f2 := v18.f22 / v18.f22, v18.f22, v18.f22, p1;
			...
			v19[436] := v18.f22;
			var v32: set<int> := {v19[436], v18.f22};
			var v33: map<int, int> := map[p3 := |v32|];
			var v36: map<bool, map<int, int>> := map[!f16 := map v35 : int | (0x8 <= v35) && (v35 < 0xe6) :: (v35 * v18.f22) := (0x14d)];
			var v37: seq<int> := [p1];
			var v38 := DC19(v33);
			var v39: array<map<int, int>> := new map<int, int>[28] [v33 + v33, (map v34 : int | (0x2e0 <= v34) && (v34 < 0x3e) :: (v34 + v19[436]) := (|v18.f23|)) + map[0x4d := p3], v33 + (if (f16 in v36) then v36[f16] else v33), v33, v33 + v33, v33, v33, v33, v33, v33, v33, v33 + map[p3 := 871], v33, map[v19[436] := -v18.f22], v33 + v33, v33, v33 + v33, v33 + v33, v33, v33, (map[p1 := v19[436]])[|v37| := fm0(f16, globalState)], map[-p1 := |v18.f23|], v33, v33 + v38.cf27, v33[fm0(false, globalState) := v19[436]] + v33, v33[-|v33| := -433], v33, v33 + v33];
			v39[394] := v33[p1 := v19[436]] + v33;
			var v40: map<int, bool> := map[744 := false];
			var v41: seq<string> := [v0];
			var v42: seq<string> := [v41[|[f16, true, f17, f17]|]];
			f16, v39[394], f16, f16, globalState.f2 := f16, map[|v40| := p1], if (f16) then p2 else !f17, v42 == v42, v18.f22 - p1;
		}
		
		var v43: seq<bool> := [f16];
		var v44: set<bool> := {false};
		var v45: array<bool> := new bool[18] [fm23(false, globalState), p2, !p2, false, p2, !!(p1 > p1), p2, false, p2, !p2, f16, v43[p1], v43[p1], if (f17) then f17 else p2, false && false, v44 !! v44, p2, f17];
		...
		var v50: set<int> := {p1, p3, |fm28(f17, v46, v47, v49[p1], globalState)|};
		...
		match (v53) {
			case DC12() =>
				...
				f16, v54, v55, v56[192], v59 := p2, 'y', v55, v57, v59[v58 := p1] + (v59 + v59);
				r0 := p3;
				f16 := f17;
			case DC11(cf15) =>
				f16 := f17 ==> f17;
				...
				var v66 := DC24(v43 < v43, v43, v65, if (f16) then p2 else p2, seq(0x1bd, i7  => (DC3(p2))));
				v60[347], v66 := v0[p3], v66;
		...
		for i8 := p3 to p3 {
			...
			v69[835] := (if (f17) then v76 else DC24(f16, v43, v73, f17, v75)).cf34;
		...
		for i10 := p1 to p3 {
			...
			var v85: array<int> := new int[10](i11 => i11 % -761);
			...
			match (v86) {
				...
				case DC16(cf23, cf24) =>
					...
					v85[8] := if (p2) then p1 / |v0| else |map[fm31(p2, p2, globalState) := v97]| / p1;
					var v98 := 'p';
					v98 := p0;
					globalState.f2 := p1 + |v51|;
				case DC14(cf17) =>
					var v99: array<D5> := new D5[23](i12 => DC8(seq(0x1a9, i13  => (p3))));
					...
					var v102 := DC16(p3, p2);
					r0 := p1 / -(v102.(cf24 := f17)).cf23;
					v0, globalState.f7 := seq(524, i14  => ('u')), i10 - (p1 + p3);
					v83.f25 := false;
				case DC17(cf25) =>
					...
					var v112 := DC41((multiset{v110, v110})[v110 := |v0|]);
					var v113: multiset<bool> := multiset{v83.f25, v83.f25};
					var v114: map<multiset<bool>, bool> := map[v113 := f16];
					v83.f25, v83.f25, v85[729] := !!v43[p1], multiset{v110, DC24(p2, v43, v107, v83.f25, v109)} > (v111 - v112.cf64), p3 % |(v114 + v114)|;
					var v115 := DC6(v48);
					var v116: T0 := new C1(p2, v85[729]);
					var v117 := DC34(f17, v116, p1);
					var v118 := DC34(p2, v117.cf52, v116.f14);
					globalState.f7, r0, f16, v83.f25, globalState.f2 := p1, (|v48| / |v115.cf10|) / v117.cf53, p2, !v83.f25, v116.f14;
			}
...
class C6 extends T1, T0, T2 {
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		for i0 := f19 to f19 + f19 {
			var v0 := "usc";
			v0 := v0 + (if (f16) then seq(0x1a9, i1  => ('a')) else v0);
			...
			v2[435], f16, v7, f16 := -(|v4| + p0) / (p0 % |v9|), !DC4(f16, f19, p0, f20, false).cf8, fm20(i0, |v11[f14]|, globalState), false;
		}
		var i2 := 0;
		while ((p0 >= p0) || p1)
			decreases 100 - i2
		...
		var v24: seq<array<bool>> := [v23[f14]];
		var v25: map<map<int, bool>, string> := map[fm22(!f20, globalState) := v20];
		v18, v19, f14, v22, globalState.f7 := v18, map[v24[f14] := -p0], f14, v22 + (v22 + (seq(0x308, i4  => (f19)))), fm12(v22[|v22|], globalState) % |v25|;
		...
		match (DC9('x')) {
			case DC10() =>
				...
				var v33: map<D6, array<int>> := map[v28 := v32[f14]];
		...
		var v47: array<int> := new int[16](i7 => i7 % p0);
		v47 := v47;
		r0 := f14;
	}
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		match (v1) {
			case DC0(cf0) =>
				...
				var v11: seq<array<D15>> := [v7, v7, v7, v10[p1]];
				globalState.f2, v5.f25, globalState.f7, v6, v7 := -202, (v8 <= v8) || !f20, v9[f19], v6, v11[p3];
				v5.f25 := f16;
		}
			...
			decreases 100 - i1
		{
			...
			v16 := (v16 * multiset(v13[f19 := -990]))[p1 := p3];
		}
		var v17: array<bool> := new bool[1](i2 => f20);
		var v18: seq<char> := [p0, 'b'];
		v17[245] := fm27(p3, 599, |multiset(v18)|, map[fm0(p2, globalState) := |v0|], globalState);
		var v19 := DC23(f17, fm12(p3, globalState), p3);
		var v20: map<int, D12> := map[p3 := v19];
		f16, f16, globalState.f7, f14, v17[245] := "sm" < v18, f20, 0x2c2 * (if (f16) then 387 else |v20|), f14 % (f19 * p1), if (v0[p3]) then f20 <== f16 else f17;
	...
	method m6(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		...
		for i2 := f19 to p2 * p2 {
			...
			v6 := map[(v0[|v7| := p3])[if (p1 in v8) then v8[p1] else f19 := p3] + "hr" := f19 % i2];
			...
			v12[804], v13, v16, v17 := ((map v18 : string | v18 in v19 :: (v18) := (p1)) + v9) + fm61(v11, f14, globalState), (v13 + v13) + v13, v16, v17;
			var v20 := DC3(p1);
		...
		var v23 := DC22(v0);
		globalState.f7, f16, r1, v5[443], v22 := f14, false, !match v23 {
		...
		v24[195] := v25[|[[|v26|], fm38(p1, p2, 816, globalState), v27, v28]| := f19];
		var v29: multiset<bool> := multiset{f16};
		var v30: map<bool, multiset<int>> := map[fm1(globalState) >= v29 := v25[0x142 := |v0|]];
		v24[195] := if (v5[443] in v30) then v30[v5[443]] else multiset(v27);
		r0 := fm18(f20, fm0(v5[443], globalState), map v31 : int | (-0x39c <= v31) && (v31 < 0x2c3) :: (v31 + p2) := (v22), -f19, globalState) + 0x2c0;
...
class C7 extends T2, T0 {
	...
	function fm12(p0: int, globalState: GlobalState): int {
		-(f14 + |([[|map[f14 := f17]|], [DC4(true, f14, f14, f17, false).cf5], seq(0x1f3, i0  => (f14)), DC8([f14]).cf13] + (seq(0x1f8, i1  => ([0x5b, f14, f14, f14, f14]))))|)
	}
	function fm13(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<bool> {
	...
	method m6(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		...
		forall i0 | 0 <= i0 < v5.Length {
			v5[i0] := ("gdxkk" + (seq(0x208, i1  => ('e')))) != "cj";
		}
		var i2 := 0;
		while (!fm17(f17, p2 - f14, p2 % -p2, f14, globalState))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			v6 := v6[f17 := p1];
			var v7: array<string> := new seq<char>[27](i3 => seq(0x1f5, i4  => (p3)));
			v7 := v7;
			r3 := p0;
		...
		if (f16) {
			if (if (fm21(globalState)) then v10.f21 else v10.f21 ==> v10.f21) {
				...
				r1 := v14 > v14;
				v3 := (v3 + ([p2] + v3))[0x2e9 := p2];
				globalState.f2 := p2 % f14;
			} else {
				var v15 := 'h';
				var v16 := "oiltx";
				...
				v5[660] := !(if (f17) then true else v3 == ([p2, |v18|])[f14 := |v2|]);
				globalState.f7 := p2 + (p2 + p2);
			}
			
			var v19 := "mdpuq";
			var v20: map<int, int> := map[f14 := f14];
			var v21: array<string> := new string[6] [v19, seq(0x1d4, i5  => (v19[v3[p2]])), fm42(p1, |v3|, 0x156, v10.f21, globalState), "ydpgyfg" + v19, v19, fm42(p0, |v3|, if (p2 in v20) then v20[p2] else f14, v10.f21, globalState)];
			v21[879] := v19;
			v21[879], f16, r2 := v19 + v19, v10.f21, "dgew";
			var v22 := DC1(v5);
			...
			var v28 := DC6(v27[f14]);
			r1, globalState.f7, v24, v5[652], globalState.f7 := f17, f14, v28.cf10, fm21(globalState), |(v21[879] + "dbl")|;
			v5[652] := !(f14 >= v11.fm12(-p2, globalState));
		} else {
			var v29 := "bfbavpph";
			var v30: map<bool, bool> := map[false := p0];
			var v31 := new C3(f14, v29[p2 := 'c'], p1, |v30| == f14);
			v5[227] := [p3, p3, p3, p3] <= v31.f23;
			var v32: multiset<int> := multiset{p2};
			v5[227] := !(v32 !! (if (p1) then v32 else v32));
			var v33: array<set<bool>> := new set<bool>[19](i6 => v4);
			var v34 := new C0(v33, v31.f22);
			var v35: seq<map<int, bool>> := [v2 + v2, v2, v2, v2, v2];
			r1, v35 := f17, seq(284, i7  => (map[p2 := v10.f21]));
			v34.f27 := f14;
		}
		...
		r1 := f17 <==> ([v36, v36[f14 := p3], v36] == v37);
		r2 := v36 + v36;
		var v38: map<multiset<bool>, bool> := map[(multiset{p0, f17, true})[p1 := f14] := !!f17];
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		if (p1) {
			...
			var v17: array<int> := new int[24] [p0, f14, v9.f19, f14, f14, f14, f14, -0xa6, |v12|, p0, |"pxtakl"|, v9.f19, |v13|, v9.f19, |v14|, -f14, f14, p0, -f14, f14, f14, |v16|, p0, |v6[415]|];
			v10[138] := v17;
			var v18: seq<int> := [v9.f19];
			v10[138], v11.f16 := DC15(true, v9.f20, set v19 : int | v19 in v18 :: (v19 % 0x52), v17, v0).cf21, v9.f20;
		} else {
		...
		for i0 := f14 to |v30| {
			...
			var v33 := 'h';
			var v34: array<bool> := new bool[10] [p1, f16 in v31, fm43(p1, globalState), if (f17) then f16 else p1, f16, f16, !f17, p1, i0 != |v32|, v33 !in (seq(-0x1a9, i1  => (v33)))];
			var v35 := "rlmtgv";
			...
			var v40: multiset<map<int, D11>> := multiset{map v38 : int | v38 in v39 :: (v38 / |v32|) := (DC20())};
			v37[892] := v40 - v40;
			v37[892] := (v40 - v40) - v40;
		}
		var v41 := "intkfrwlm";
		v41 := "lmngcvt" + ("iwta" + (seq(0x115, i2  => ('p'))));
		for i3 := f14 to f14 {
			var v42: seq<int> := [0x188];
			var v43: multiset<seq<int>> := multiset{[p0, -f14], v42};
			var v44: map<multiset<seq<int>>, int> := map[v43 := v42[p0]];
			v44 := v44[v43 := p0];
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		v0[460] := if (f17 in v4) then v4[f17] else v3;
		v0[460] := v3;
		forall i0 | 0 <= i0 < v0[460].Length {
			v0[460][i0] := f16;
		}
		forall i1 | 0 <= i1 < v0[460].Length {
			v0[460][i1] := true;
		}
	...
	method m9(globalState: GlobalState) returns (r0: bool, r1: set<bool>, r2: bool, r3: int) {
		...
		var v4: set<int> := {f14};
		v0[691], r0, v3 := v1, !(v4 > v4), v3;
		var v5: array<int> := new int[11](i1 => i1 + |"tjeefai"|);
		forall i0 | 0 <= i0 < v5.Length {
			v5[i0] := i0 - (0xa3 / |map[!v2.f21 := f14]|);
		}
		var v6 := "r";
		v6 := v6;
		var v7: seq<int> := [-|v6|, f14, f14, f14, f14];
		var v8: map<int, seq<int>> := map[fm0(false, globalState) := v7[0x15b := f14]];
		if ((if (fm0(f17, globalState) in v8) then v8[fm0(f17, globalState)] else v7) < (if (|map[f16 := [f14, f14]]| in v8) then v8[|map[f16 := [f14, f14]]|] else v7)) {
			var v9 := 'j';
			globalState.f7 := -(|v6[f14 := v9]| - f14);
			var v10: array<bool> := new bool[4](i2 => v2.f21);
			var v11: multiset<array<bool>> := multiset{v10};
			var v12 := new C6(f14, v2.f21, !v2.f21, v11[v10 := |v6|] <= v11[v10 := f14], f14);
			var v13: map<int, array<bool>> := map[f14 := v10];
			r2 := !(v12.f19 in map[-|v13| := v5]);
			r3 := f14;
			var v14 := v12.m3(v9, |(seq(0x359, i3  => (v12.f19)))|, f17, f14, globalState);
		} else {
			var v15 := 'm';
			v6 := v6[0x1c7 := v15];
		...
		for i4 := |v22[f14 := f17]| to f14 {
			...
			v25[633] := v24;
			v5, v23, v6, v25[633] := v5, v23, v6, v24;
			var v26: map<int, int> := map[f14 := i4];
			var v28: map<int, bool> := map[fm0(v2.f21, globalState) := f17];
			var v29 := DC19(v26 + (map v27 : int | v27 in v28 :: (v27 % i4) := (0x1f8)));
			match (v29) {
				case DC20() =>
					var v30 := DC3(f16);
					...
					var v39 := DC15(f17, v2.f21, set v37 : int | v37 in v4 :: (v37 / 891), v5, v38);
					var v40: array<D9> := new D9[6] [v39, DC15(v22[|v26|], fm31(v2.f21, v2.f21, globalState), v4, v5, v38), v39, v39, v39, v39];
					var v41 := DC24(v2.f21, v22, [v40], v2.f21, fm62(globalState));
					var v42: array<bool> := new bool[19] [v22[165], v2.f21, multiset(v22) !! v34, f17, v2.f21, fm31(f17, f16, globalState), v35 !in v24.f23, v2.f21, v2.f21, f16, f17, -f14 !in v36, f16, v41.cf33, v2.f21, v24.f22 < v2.fm12(f14, globalState), f17, true, v2.f21];
					v42[547] := false;
					var v43: set<bool> := {f16};
					v33, v5[372], v42[547], r2 := map[v2.f21 := v7 + v7], |"h"| / |v7|, v2.f21, v43 > (v43 + v43);
					...
					globalState.f2, r2, r0, v42[547] := v24.f22, v24.f23 !in v44, v48[i4] !! v46, v24.f22 > (v49.cf69 % v24.f22);
					v38 := new bool[13](i5 => v24.f22 >= (if (f14 in v26) then v26[f14] else f14));
				case DC19(cf27) =>
					v5[298] := |(seq(812, i6  => (v24.f22)))|;
					var v50: multiset<int> := multiset{f14};
					v5[298] := |v50|;
					globalState.f7 := v24.f22;
					var v51 := v2.m3(v24.f23[i4], f14, v2.f21, i4, globalState);
				...
				case DC21(cf28) =>
					...
					var v58: map<bool, T1> := map[v22[v24.f22] := v57];
...
class C8 extends T1, T0, T2 {
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			var v9: array<int> := new int[28] [f14, f14, p0, p0 * |f18|, p0, f14, -p0, |v5|, p0 % p0, p0, |(f18 + f18)|, f14 - p0, p0 * |(seq(0xb6, i1  => ('h')))|, 0x28c, |[f16, p1]| / -|v3|, f14, p0, -|v3|, f14, p0, p0, p0 - -f14, 0x237, if (f17) then p0 else 0x18d, v8.cf53, v6.f14, 0x2a0, |(v0 + v0)|];
			v9[864] := v6.f14;
			v9[864], globalState.f2, f14, f16 := -(f14 - v6.f14), |v0|, v6.f14, p1;
			r0, v3 := -v9[864], v3 + ([fm0(v1.f21, globalState)] + v3)[v9[864] := v9[864]];
			if (p1) {
				var v10 := 'r';
				...
				var v13: seq<string> := [v12[f14], f18];
				var v14: array<string> := new string[5] ["dess" + f18, f18, "jlwjpaav" + v13[fm12(-0x319, globalState)], f18, f18 + f18];
				v14[546] := f18 + f18;
				v14[546] := f18;
				var v15: map<bool, string> := map[v1.f21 := v14[546]];
				var v16: map<int, char> := map[f14 := v10];
				var v17: map<bool, int> := map[v1.f21 := |v14[546]|];
				globalState.f7, f16, v6.f14, f14 := --v9[864], v1.f21 <== fm21(globalState), -|((if (v1.f21 in v15) then v15[v1.f21] else seq(0x160, i2  => (v10)))[|multiset(v3)| := if (0x22c in v16) then v16[0x22c] else v10] + f18)|, if (v17 == v17) then 0x16e else v9[864];
			} else {
				var v18: array<D9> := new D9[12];
				var v19: seq<array<D9>> := [v18];
				var v20 := DC23(true, -v9[864], p0);
				var v21: multiset<bool> := multiset{v1.f21, v20.cf30};
				var v22: map<int, int> := map[v6.f14 := f14];
				var v23 := DC3(v1.f21);
				var v24 := DC24(f16, v0, v19, v1.f21, [DC3(fm27(|v21|, v3[f14], f14, v22, globalState)), v23]);
				var v25: map<D12, bool> := map[v24 := v1.f21];
				var v26: map<bool, map<D12, bool>> := map[!p1 := v25];
				var v27: map<int, map<D12, bool>> := map[f14 := v25];
				var v28: array<map<D12, bool>> := new map<D12, bool>[15] [v25, v25 + map[v24 := f16], v25 + v25, v25 + v25, if (p1) then if (v1.f21 in v26) then v26[v1.f21] else v25 else v25, v25, v25 + v25, v25 + v25, v25, map[v24 := v0[v9[864]]], v25, if (p0 in v27) then v27[p0] else v25, v25, v25, v25];
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		var v7: map<int, D20> := map[p1 % -f14 := if (f16) then v6 else v6];
		var v8: T0 := new C6(f14, f17, f16, f17, p1);
		var v9: map<int, T0> := map[f14 := v8];
		var v10 := DC42(0x189 % p3, if (p2) then p2 else DC28(p3, p2, if (f14 in v9) then v9[f14] else v8).cf41, v8);
		var v11: seq<map<int, D20>> := [v7];
		var v12: multiset<char> := multiset{p0};
		var v13: map<bool, map<int, D20>> := map[f17 := v11[|v12|]];
		v7, f18, f16, v10 := (v7 + v7) + (if (f16 in v13) then v13[f16] else v7), ((f18 + f18)[p1 := fm34(v8.f14, p1, f16, p3, globalState)])[fm0(true, globalState) := p0], f17, v10.(cf65 := |[f17, true, f16]|);
		f14 := p3 % f14;
		var i0 := 0;
		while (true ==> p2)
			decreases 100 - i0
		{
			...
			var v21: array<int> := new int[26] [p3 - p3, f14, |v14| % p3, fm0(p2, globalState), v8.f14, p3, p3, p1, p3, p1, |v16| - fm12(p1, globalState), p1 / p3, v8.f14, p3, f14, -|(v0 + (if (v17 in v18) then v18[v17] else v0))|, p3 - v8.f14, |(v19 - {p2, f17})|, f14, |v17|, p3 - v8.f14, f14 - 0x2d8, p3 % |v0|, -v8.f14 * |v0|, |v20|, v8.f14];
			v21[490] := v8.f14;
			v21[490] := if (f17) then |f18| else fm0(!f17, globalState);
			...
			v22, globalState.f2, v23 := v24[p1], (if (false) then |v25| else fm0(f16, globalState)) / (v17[v8.f14] + f14), if (v27 in v28) then v28[v27] else v23;
			if (f17) {
				var v29: map<bool, bool> := map[true := p2];
				v14 := v14[|(fm40(p2, globalState) + v29)| := |v17|];
				var v30 := DC33(f16, f16, v21[490], f16);
				var v31: map<D16, int> := map[v30.(cf50 := false) := 0x3ca];
				v31 := v31[v30 := -p3 + f14];
				var v32 := DC6(map[p2 := p2]);
				var v33 := new C4(f17, f16 in v32.cf10, f17);
				v23[150] := false;
				v23[150] := fm17(false, v8.f14, p3, v21[490], globalState);
				f16 := v33.f21;
			} else {
				...
				globalState.f2 := |f18|;
				v21[490] := |(if (v25 !! multiset{f17}) then [p0] else f18)|;
			}
			
			v23[211] := f16;
			var v40: seq<array<bool>> := [v23, v23, v23, v23, v23];
			var v41 := DC46(v40);
			v23[211], v41 := false, v41;
		}
		if (!f16) {
			r0 := p3;
			...
			if (!(p3 >= -0x124)) {
				...
				v47[538] := v48 + {[f17], v0, v0};
				v47[538] := if (v8.f14 != v8.f14) then v48 else set v49 : seq<bool> | v49 in multiset{[p2], v0} :: (v49);
				f16 := false;
				var v50: array<int> := new int[17];
				v50[889] := v8.f14 + v8.f14;
				var v51: seq<array<int>> := [v50, v50];
				v8.f14, f18, v50, f16, v50[889] := v8.f14, f18 + ("lj" + f18), v51[v8.f14], f17, -(f14 - -|(fm15(globalState) * multiset{seq(0x1ef, i3  => (p0)), f18, "ibuvhh"})|);
			...
			v60[509] := v0 + v0;
			v59, v60[509] := map[v8.f14 / fm0(f16, globalState) := v42], v0;
			...
			match (v61) {
				case DC40(cf61, cf62, cf63) =>
					...
					var v65: map<bool, seq<bool>> := map[f16 <== f16 := if (f16) then v60[509] else v0];
				...
				case DC39(cf60) =>
					...
					var v69: map<bool, multiset<bool>> := map[f16 := v67[f17 := -|['c']|]];
					...
					v73, v74[684], v71, v75 := v73, (v8.f14 % |v76|) / v8.f14, v71 + v71, multiset{DC24(false, [f16], v2, f16, v4), v5, v5};
					var v77: array<seq<int>> := new seq<int>[6];
					f18, v74[684], v77 := f18 + (f18 + f18), p1, v77;
			}
			...
			if (((seq(0x179, i6  => (p0))) == v81[912]) ==> !!p2) {
				...
				var v92: array<set<int>> := new set<int>[25] [{|map[f16 := v82[203]]|}, v84, v85[|v0[|v87| := !f16]|], fm49(p3, |map[true := f16]|, f17, |v81[912]|, globalState), v84, v84, fm49(-|[|(seq(-0x197, i7  => (p0)))|, v8.f14, f14]|, if (p2 in v88) then v88[p2] else if (|v78| in v89) then v89[|v78|] else v8.f14, f16, v8.f14, globalState), fm49(v8.f14, v8.f14, false, v8.f14, globalState), {if (f16 in v90) then v90[f16] else v8.f14}, v84, v84, v84, v84, v84, v84, v84 - {p1, -0x97}, {|v80|}, if (f16) then {v8.f14} else v84, set v91 : int | (0x38d <= v91) && (v91 < 0x136) :: (v91 / |v81[912]|), {p3, 0x86, |f18|}, v84 * v84, v84, v84, fm49(v8.f14, p1, p2, |{f17, f17, f16, p2}|, globalState), v84];
				var v93: map<int, bool> := map[f14 := p2];
				v92[841] := fm49(|v93|, |[p3]|, f16, p3, globalState);
				v92[841] := v84 - (v84 + v84);
			} else {
				f16, v0, globalState.f2, globalState.f7 := (v8.f14 - p3) < 0x12d, v0, v8.f14, (p3 * p3) + v8.f14;
				var v94: array<int> := new int[6](i8 => i8 % 0x220);
				v94[142] := p3 * v8.f14;
				v94[142] := f14;
				var v95: map<int, bool> := map[p1 := f16];
				var v96 := DC23(p2, v8.f14, |v95|);
				var v97: map<int, array<int>> := map[|v0[v94[142] := f16]| := v94];
				...
				var v103: array<bool> := new bool[21] [f17, f16 <== (v96.(cf31 := |v97|, cf32 := v94[142])).cf30, p2, |(map v98 : char | v98 in map[p0 := -p1] :: (v98) := (v8.f14))| != fm0(p2, globalState), p2, p2, f16, f17, !((seq(0x125, i9  => (map[true := f17]))) < v99[v8.f14 := (if (DC6(v101) in v102) then v102[DC6(v101)] else v101)[f16 := p2]]), f16, v78 <= v78, f16 !in fm13(-0x50, true, f17, globalState), false, p2, f16, !f17, f16, true, f16, p2, f16];
				v81[912], v8.f14, f14, v103, v94[142] := f18, v8.f14, --f14, v103, (p3 * f14) + fm0(false, globalState);
	...
	method m6(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		...
		for i0 := p2 / p2 to f14 {
			...
			if (!((v16 > v16) <== true)) {
				...
				globalState.f7, r3, v24[97] := fm12(v25[f14], globalState), (f14 + p2) >= (i0 * |(seq(0x277, i2  => (p3)))|), if (p0) then i0 % i0 else v27.cf65 + |v29|;
				var v30: map<char, D20> := map[p3 := DC42(-0xdb, p1, v26)];
				var v31 := DC47(v30);
				var v32: array<map<char, D20>> := new map<char, D20>[17] [v30 + v30, v30 + v30, v30, (map['h' := DC42(v26.f14, f17, v26)])[p3 := v27], v30[f18[f14] := v27], map[p3 := v27.(cf67 := v26)], map[p3 := v27], v30 + v31.cf73, map[p3 := v27], v30 + v30, v30, map[p3 := v27], v30, v30, v30, v30 + v30, v30];
				v32[538] := v30;
				r3, v32[538], globalState.f2 := f17 <==> p0, v30, fm0(f17, globalState) + i0;
				v15[222] := p0;
			...
			decreases 100 - i3
		{
			...
			var v42: array<string> := new seq<char>[13](i4 => seq(-351, i5  => (p3)));
			v42[87] := "xugnav";
			v41, globalState.f2, v42[87] := v41, f14 % (if (v40[576]) then p2 else -p2), f18;
			f16 := f17;
		...
		for i6 := p2 to f14 {
			...
			var v45 := new C3(f14, fm42(v43.f25, f14, |[!v43.f25]|, false, globalState) + f18[|v44| := p3], !(if (f16) then p0 else true), f16);
			...
			match (fm65(v45.f22, globalState)) {
				case DC4(cf4, cf5, cf6, cf7, cf8) =>
					...
					v50[216][240] := if ('u' in v52) then v52['u'] else |v54|;
					var v55: map<char, int> := map[p3 := v45.f22];
					v50[216][240] := fm0('k' in v55, globalState);
					var v56: seq<int> := [v45.f22, v50[216][240], v45.f22];
					var v57: array<bool> := new bool[24] [fm21(globalState), true, f17, v43.f25 && p1, fm27(|v53|, |v45.f23|, i6, v46, globalState), v50[216][240] !in v56, p1 !in v0, cf7, fm43(if (fm14(globalState) in v1) then v1[fm14(globalState)] else cf4, globalState), f16, f17, f17, p1, cf8, v44[v45.f22], cf8, v43.f25, p0, v56 != v56, f17, v43.f25, cf7, true, v45.f23 <= "awdr"];
					v57[602] := f16;
					v57[602], cf7 := cf7, |v45.f23| <= v45.f22;
				case DC3(cf3) =>
					...
					r0, v43.f25, v58[979], f14 := (|v45.f23| - -0x293) * |(f18 + v45.f23)|, !v43.f25, !f17, v61[i6];
	...
	method m7(p0: int, p1: seq<seq<bool>>, globalState: GlobalState) returns (r0: bool) {
		...
		var v7: multiset<int> := multiset{f14, |v6[f14 := v5]|};
		var i0 := 0;
		...
		if (false) {
			...
			v17[131] := if (v14.f20) then 0xc else p0;
			v17[131] := p0 + 0x280;
			var v18 := DC22("tw");
			match (v18) {
				case DC23(cf30, cf31, cf32) =>
				...
				case DC24(cf33, cf34, cf35, cf36, cf37) =>
					...
					v28[99] := v27;
					var v29: map<int, array<seq<char>>> := map[v14.f19 % |v0| := v27];
					v28[99] := if (v17[131] in v29) then v29[v17[131]] else v27;
				case DC22(cf29) =>
					v17[131] := -p0;
					...
					var v37: map<int, seq<array<bool>>> := map[0x388 - v15.f22 := (v36 + v36)[v15.f22 := v35]];
			...
			var v43: seq<seq<seq<int>>> := [[seq(0x36d, i3  => (p0))], v42];
			var v44: map<bool, seq<seq<int>>> := map[f16 := v43[f14]];
			globalState.f7, v41, v42, globalState.f2 := |f18|, v41, (if (true in v44) then v44[true] else [[p0, f14, f14]])[f14 := v0] + v42, |("lbxjip" + f18)|;
			var v45: array<char> := new char[25](i4 => v40);
			var v46: map<array<char>, bool> := map[v45 := f17];
			globalState.f2 := |v46|;
			var v47: map<int, bool> := map[f14 := f17];
			var v48: map<map<int, bool>, int> := map[v47 := p0 % f14];
			v48 := v48[v47 := |v3|];
			if (true) {
				...
				var v57: array<int> := new int[20] [f14, f14, f14, f14, |v51|, p0, 0x3b2, -0x277, |v7| * -f14, 0x2a0, v53.cf57, p0, |(f18 + f18)|, fm0(f17, globalState), 0x2c7, |v54| * |v56|, p0 + f14, p0, f14 / |v0|, f14 / p0];
				v57[690] := p0;
				var v58: T0 := new C6(f14, !f16, f16, !f16, -p0);
				var v59 := DC42(p0, f16, v58);
				v57[690] := p0 * (v59.cf65 - f14);
				var v60: array<map<int, int>> := new map<int, int>[1];
				var v61: map<bool, int> := map[f17 := v57[690]];
				...
				v65[670] := v67;
				v65[670] := new map<int, bool>[2];
				var v68: array<bool> := new bool[18](i6 => f16);
				v68[611] := !f16 && !fm31(f16, false, globalState);
				var v69: set<string> := {seq(-0x3d2, i7  => ('b'))};
				v68[611] := (v69 - v69) !! ({"jm"} * v69);
				var v70: seq<bool> := [f17];
				var v71: map<array<bool>, bool> := map[v68 := v70[f14]];
				f16 := if (v68 in v71) then v71[v68] else if (v68[611]) then v68[611] else f16;
				...
				v73.f25 := ((seq(659, i8  => (map[false := false]))) + v75) < v75;
			}
			
			var v76 := DC40(p0, f16, p0);
			var v77: array<seq<int>> := new seq<int>[20] [v0, v0 + v0, v0, [f14, p0, |v7|, |v0|, v76.cf61] + v0, v0, v0, v0, v0, v0, v0, v0, seq(0x12e, i9  => (f14)), v0, v0, v0, if (f17) then [-|"hhr"|] else v0, v0, [|v47|], v0, [0x83] + [p0]];
			v77 := v77;
		}
		...
		for i10 := |v78| to p0 {
			...
			v83[490] := map[0xf4 := false] + v84;
			f16, v82, v83[490], globalState.f7 := !((i10 * -fm12(i10, globalState)) <= i10), if (v82 in f18) then v82 else v82, v84, p0;
			if ((f14 / p0) > (i10 % i10)) {
				var v85: array<string> := new string[12];
				v85[924] := f18;
				var v86 := DC22(f18);
				v85[924] := v86.cf29;
				var v87: map<int, map<int, bool>> := map[p0 := v83[490]];
				var v88: T0 := new C7(f16, f16, fm0(f16, globalState));
				var v89 := DC28(0x287, f16, v88);
				v87 := v87[v89.cf40 - f14 := v83[490] + v84];
				var v90: array<int> := new int[8](i13 => i13 % |v86.cf29|);
				...
				var v96: array<D9> := new D9[20] [v94, v94, v94, v94, DC15(f17, f16, v92, v90, v80), v94, v94, v94, v94, v94, v94, v94, v94, v94, DC15(fm14(globalState), f17, {-27}, v90, v80), v94, v94, v94, DC15(f17, f17, set v95 : int | (0x81 <= v95) && (v95 < 0x34f) :: (v95 % p0), v90, v80), v94];
				...
				var v105: map<string, bool> := map[v85[924] := f16];
				var v106: map<int, map<string, bool>> := map[769 % v88.f14 := if (if (v101 in v102) then v102[v101] else v101.f16) then map v103 : string | v103 in v104 :: (v103) := (f17) else v105];
				v106 := v106[0x348 := map[v85[924] := false] + v105];
			} else {
	...
	method m8(p0: array<string>, p1: map<D3, int>, p2: int, p3: int, globalState: GlobalState) {
		if (f16 && f17) {
			...
			v14[284] := v15;
			v14[284] := (v15 - multiset{f16, f16, f17, false, f16}) - v15;
		}
			...
			decreases 100 - i3
		{
			...
			match (v26) {
				case DC4(cf4, cf5, cf6, cf7, cf8) =>
					f16 := cf7;
					v19[294] := cf8;
					v19[294] := |((map v27 : int | (0x15c <= v27) && (v27 < 0x24a) :: (v27 / cf5) := (p3)) + v24)| == 257;
					cf6 := if (fm17(!cf8, -f14, |f18|, 0x363, globalState)) then cf5 else cf6 % p3;
		...
		f18 := seq(0x21f, i4  => (if (f16) then 'u' else 'n'));
...
class C9 {
	...
	method m4(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		for i0 := if (p0) then p1 else p1 to p3 {
			...
			v3[628], globalState.f2, v3[628], v1, globalState.f7 := p2, |v6[|v2.f18|]|, p3, v1 + v1, p2;
			...
			decreases 100 - i2
		{
			...
			v9[756] := p0;
			v9[756] := p0;
			if (fm31(v9[756], p0, globalState)) {
				v9[756] := fm17(v9[756], 0x34b, 637 - -p1, p2 / p3, globalState);
				var v10: array<int> := new int[6] [p2, p3, p1, 352, --|v0|, p1];
				v10[36] := |v2.f18| * p2;
				v10[36] := p3;
				var v11: seq<int> := [p3, v10[36], p3, if (p0) then |"eiimxauy"| else v10[36]];
				var v12 := DC8(v11);
				v11 := v12.cf13[-484 := p3] + v11;
				v9 := v9;
				v9[756] := v9[756];
			} else {
				var v13 := 'b';
				...
				v9[756] := p0;
				globalState.f7 := -|(seq(0x17a, i4  => (v13)))|;
			}
			
			var v18 := 'o';
			var v19: map<char, bool> := map[v18 := p0];
			v9[756] := !(if (v18 in v19) then v19[v18] else false);
		}
		for i5 := p1 to p3 {
			globalState.f7 := -(--0xd5 / p2);
			r0 := p1 / p1;
			var v20 := 'g';
			v20 := 'w';
		...
		for i7 := v2.fm12(|v24[v22 := -p2]|, globalState) to p3 {
			globalState.f7 := if (p0) then p3 + i7 else p1;
			var v25 := 'u';
			var v26: T0 := new C8(v2.f18[p2 := v25], p0, p0, -i7);
			var v27 := DC34(v22[p3], v26, p1);
			match (v27) {
				case DC33(cf47, cf48, cf49, cf50) =>
					...
					v28[247] := |v29| % (v30.(cf47 := cf48, cf48 := true)).cf49;
					v28[247] := v28[247];
				...
				case DC34(cf51, cf52, cf53) =>
					...
					v34 := v34;
					cf51 := v22 <= v22[|v1| := cf51];
					cf51 := p0;
					var v36: array<D17> := new D17[28](i8 => DC36([set v35 : int | (0x3d4 <= v35) && (v35 < 0xe2) :: (v35 % -v26.f14), {i7, 0x1ca, cf52.f14, |{p1, p3, p1}|, v26.f14}]));
					var v37: set<int> := {p1};
					var v38: seq<set<int>> := [v37, v37, v37];
					var v39 := DC36(v38);
					v36[800] := v39;
					v36[800] := if (p2 >= -cf52.f14) then v39 else v39;
				case DC32(cf46) =>
					...
					var v44: set<array<int>> := {v40, v40, v43[|v22[p3 := p0]|], v40};
					var v45: array<bool> := new bool[3] [v42.cf18, !({v40, v40} !! v44), p0];
					v41[519] := i7 > v26.f14;
					v41[519] := p0;
					globalState.f2 := -v26.f14;
					var v46 := new C3(p2, v0 + "bomh", v41[519], v41[519]);
					v41[519] := if (false) then fm31(p0, false, globalState) else p0;
				case DC35(cf54) =>
					var v47, v48 := m5(globalState);
					var v49: array<int> := new int[22](i10 => i10 % p1);
					v49[740] := p2;
					v49[740] := i7;
					var v50: multiset<int> := multiset{v26.f14, p1};
					v50 := v50[v49[740] := v26.f14] * v50;
					globalState.f2 := if (v26.f14 in v50) then v50[v26.f14] else v26.f14;
			}
			
			var v51 := false;
			var v52: multiset<int> := multiset{i7, i7, i7, |v2.f18[|(seq(46, i11  => (v25)))| := v25]|, p2};
			...
			if (v51) {
				...
				var v58: array<string> := new string[19] [v2.f18, fm28(p0, map[|"faf"| := p3], v53, v54, globalState), v2.f18, v0, v2.f18, v2.f18[|[|v52|]| := 'c'] + v2.f18, v2.f18, v2.f18 + v0, ("ecxp")[p1 := v25] + "qoltf", v0, v2.f18 + (if (p1 in v55) then v55[p1] else v2.f18[p1 := v25]), v0, v2.f18, v2.f18, fm28(p0, v56, v53, v54, globalState), v2.f18, seq(-0x2a1, i12  => (v25)), v2.f18, v57[i7]];
				var v59: map<bool, map<bool, bool>> := map[!v51 := v54];
				var v60: map<bool, D10> := map[v51 := DC18(v59)];
				var v61: seq<map<bool, D10>> := [v60];
				var v62: map<map<bool, D10>, int> := map[v61[-v2.fm12(|(seq(0x210, i13  => (v25)))|, globalState)] := i7];
				var v63 := DC27(v62);
				v58, v63 := v58, v63;
				var v64: array<set<bool>> := new set<bool>[2](i14 => v1);
				var v65 := new C0(v64, -759);
				v2 := new C8(v57[v26.f14], v26.f14 == --p3, p0, i7);
				v26.f14 := p2;
				v25 := 't';
			} else {
				...
				v70 := v70;
				v51 := !false;
				var v71 := v2.m3(v25, |v22|, false, |("iir" + (seq(0x1a6, i15  => (v25))))|, globalState);
			}
			...
			decreases 100 - i16
		{
			...
			v78[85] := fm27(|v79|, p3, p2, v72, globalState);
		}
	...
	method m5(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		for i0 := v0 to -132 {
			...
			var v6: seq<string> := [v3, seq(0x1ff, i2  => ('k'))];
			...
			var v19: array<int> := new int[24] [-v0, if (v2 in v14) then v14[v2] else v0, v0, |multiset{i0, v0}|, 0xb5, |v14|, i0, i0, v0, v16[v0], |v17|, v0, v0, |v18|, |v3|, -|v16|, 568, 188, i0, |"k"|, |map[i0 := -v0]|, v0, v16[v0], -v0];
			var v20: map<array<int>, seq<bool>> := map[v19 := v17 + (fm52(true, v0, v0, 0xe5, globalState))[i0 := true]];
			v1[717], globalState.f7, v13[571], v0, v20 := v14 >= multiset{v2}, i0, v12[i0], i0 + i0, v20;
			...
			if (v1[717]) {
				...
				var v25: map<int, bool> := map[i0 := v1[717]];
				var v26 := DC11(v25);
				var v27: map<D19, D7> := map[v23.(cf60 := v24) := v26];
				v27 := v27[v23.(cf60 := v24) := v26];
				r0 := -|v14| + v0;
				globalState.f7 := v0;
				var v28 := DC4(v1[717], v0, v0, v2, v1[717]);
				v3 := fm28(true, v18, v28, v10, globalState);
				globalState.f7 := |v14| % fm0(v2, globalState);
			} else {
				v19[971] := i0;
				v19[971] := |v3|;
				r1 := v1[717];
				var v29: array<set<bool>> := new set<bool>[5];
				var v30: set<bool> := {v17[v19[971]], v1[717], v2, v2, !v1[717]};
				v29[66] := v30;
				v29[66] := v30;
				r1, v2, v2, v19[971] := v1[717], v17[|v15| / v19[971]], v3 != v3, fm0(if (true) then v2 else v1[717], globalState);
				globalState.f7 := -v0;
			}
		...
		var v42: array<int> := new int[20](i4 => i4 % |(set v41 : seq<bool> | v41 in map[[v38.f16, true] := v38.f17] :: (v41))|);
		v42 := v42;
...
class C10 extends T1, T0 {
	...
	function fm9(p0: int, p1: seq<set<int>>, p2: char, p3: int, globalState: GlobalState): string {
		(if (f16) then "nsvqcphrb" else "txojgxj") + ((seq(-0x1b0, i0  => ('s'))) + (seq(348, i1  => ('i'))))
	}
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
		if (f17) {
			...
			v2 := (v2[p0 := v1])[p0 := v2[|(seq(0x2b0, i0  => (v0)))|]];
			var v3 := "bdwbsv";
			...
			var v33: array<bool> := new bool[13] [p1, false, f16, v26 !! v26, f16, f16 <== p1, fm10(v28.(cf0 := v27), v29, v30, globalState), !false, !p1, !(v26 != v26), f17, if (f17) then f17 else f16, v27[|v32|]];
			v33[484] := f17;
			v33[484] := p1;
			var v34 := new C9();
			var v35: seq<string> := [v29];
			var v36 := DC36(seq(-0x2ef, i4  => ({p0, |v26|})));
			v35 := v35[f14 := fm9(p0, v36.cf55, v30, f14, globalState)];
		}
		...
		if (!f16) {
			...
			var v43 := new C8(v37, true, !f17, --v42[-0x8]);
			var v44 := 'e';
			v44 := 'w';
			...
			var v47: multiset<bool> := multiset{v40[p0]};
			...
			v57 := v57[f17 := f17 || f16];
			var v58: array<int> := new int[28](i5 => i5 / p0);
		...
		if (v60 > v60) {
			if (f14 <= (p0 / -p0)) {
				...
				v59[433] := (if (f14 in v61) then v61[f14] else f14) / p0;
			...
			var v69: seq<int> := [f14];
			var v70: set<seq<int>> := {v69, v69, v69, seq(385, i7  => (|multiset(["y"])|))};
			if (v70 > v70) {
				var v71 := new C3(472, "hkqdyi", f14 < p0, p1 || p1);
				v59[125] := -(f14 - p0);
				var v72 := "gwnvcomc";
				v59[125], globalState.f7, globalState.f7, v72 := f14, 0x1b1, p0 % f14, (if (!true) then v72 else v71.f23) + v72;
				var v73: array<bool> := new bool[26];
				var v74: map<int, bool> := map[v59[125] := p1];
				v73[908] := if (p0 in v74) then v74[p0] else f16;
				v73[908] := (v69 + v69) < v69;
				var v75 := new C9();
				var v77: map<map<int, int>, bool> := map[map v76 : int | (0x140 <= v76) && (v76 < 0x1f2) :: (v76 - -0x21) := (v59[125]) := v73[908]];
				var v78: multiset<int> := multiset{f14, v59[125], f14};
				var v79: map<int, int> := map[v59[125] := |v78|];
				globalState.f2 := |(v77[v79 := f16])[v79 := v73[908] <== f16]|;
			} else {
				...
				var v86: array<set<bool>> := new set<bool>[20] [{false, f17, f16}, v83, v83, v83, v83, v83, v83, v83, fm44(f16, p1, globalState), v83, v83, v83, v84.cf43, v83, v83, v83, {v85[0x398], f16, v85[f14], !f17, !true}, fm44(fm17(f17, p0, 831, f14, globalState), p1, globalState), fm44(f17, f17, globalState), fm44(f17, false, globalState)];
				var v87 := "hubavys";
			...
			var v98 := 'v';
			f16, v92[17] := fm10(v97, seq(462, i8  => ('u')), v98, globalState), v94 + v94;
			var v99 := "qhplwtr";
			f14, globalState.f7 := -|v99|, f14 % -p0;
			r0 := 721 - f14;
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		if (!f17) {
			...
			var v11: array<int> := new int[8] [|multiset{p1}|, f14 * f14, |v10| / -0xb8, f14, f14 / p1, |"ripqy"| % f14, -|"fes"|, p1 % p1];
			v11[625] := p1;
			v11[625] := -p1;
			var v12: C7 := new C7(f16, f17, f14);
			v11[625] := -(-p3 % |[v12]|);
			v11[625] := (-0x277 / f14) / 128;
			var v13 := "ip";
		...
		v21[357] := v19[0x30e];
		var v22: seq<int> := [p1, if (f16) then v20[514] else v20[514], v20[514]];
		var v23: map<bool, int> := map[fm21(globalState) := f14];
		var v24 := DC13(v23);
		v21[357], v20[514], v0, v22, r0 := v0, p1, fm34(v18.cf32, v20[514], f16, if (p2) then p1 else p1, globalState), v22, |v24.cf16| % -(p3 + p3);
		v21[357] := 'w';
		var v25: set<int> := {p3, v22[p1], |v19|, v20[514]};
...
class C11 extends T0, T1 {
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			v3 := if (v4 in v5) then v5[v4] else v6[v0[621]] + "chchihtm";
			if (p1) {
				var v7: seq<bool> := [p1];
				v4 := DC0(v7).(cf0 := [f16]);
				...
				f16, v8[962], v11[598], v14[409], globalState.f7 := f16, v10, v3, v12, |(fm8(!p1, f17, globalState))[v15 := if (!p1) then v3 else v3]|;
				var v16: seq<array<bool>> := [v12];
				var v17: array<D1> := new D1[27] [v13, v13, v13, v13, v13, v13, DC1(v14[409]), v13, v13, if (f16) then v13 else v13, if (p1) then v13 else v13, v13, v13, v13, v13, v13.(cf1 := v14[409]), v13, v13, v13, DC1(v14[409]), v13, DC1(v14[409]), v13.(cf1 := v12), v13, v13, DC1(v16[v0[621]]), v13];
				v17[401] := v13;
				v17[401] := v13;
				var v18: map<int, int> := map[v0[621] := f14];
				var v19: map<bool, int> := map[f17 := |v18|];
				var v20 := DC2(if (f17 in v19) then v19[f17] else f14);
				v0[621] := (v20.(cf2 := v0[621])).cf2;
				f16 := f17;
			} else {
		...
		if (if (fm21(globalState) in v38) then v38[fm21(globalState)] else f16) {
			...
			if (v39.cf7) {
				...
				var v55: seq<multiset<C4>> := [multiset{v53[|{|(seq(524, i1  => ('x')))|}|]}, v54];
				var v56: seq<bool> := [f17, false];
				var v57: T0 := new C7(p1, f17, p0);
				var v58 := DC28(|(seq(0x1dd, i2  => ('l')))|, f17, v57);
				...
				var v72: array<int> := new int[24] [f14, -(|v55[p0]| - f14), p0, f14 - p0, f14 - f14, p0 / |v56|, v52.fm12(p0, globalState), p0, v59.cf65, v57.f14 % p0, v39.cf6, -(fm0(f17, globalState) - -f14), p0 / v57.f14, v65[|v68|], p0, p0 * f14, |(set v69 : int | (0x2ba <= v69) && (v69 < 631) :: (v69 - |multiset(v56)|))| - f14, p0, 0x1fd - p0, -0x96, |(set v71 : char | v71 in v70 :: (v71))| - -f14, v57.f14, f14, p0];
				v72 := v72;
				globalState.f7 := -0x3ba;
				var v73: array<D21> := new D21[7](i3 => DC44(v57.f14, v52.f21));
				var v74 := DC44(f14, p1);
				v73[996] := v74;
				v73[996] := if (true) then v74 else v74;
				var v75 := DC30('j');
				var v76 := DC31(v75);
			...
			v78[525] := f17 && v80.cf58;
			v78[525] := v78[525];
			var v81 := DC20();
			match (DC21(v81)) {
				case DC20() =>
					var v82: multiset<bool> := multiset{false};
					var v83: map<string, multiset<bool>> := map[seq(333, i5  => ('n')) := v82];
					r0 := fm0(p1, globalState) / |v83|;
					v78[525] := !false;
					var v84 := "fycuspo";
				...
				case DC19(cf27) =>
					...
					var v96 := new C2(v79, v79.cf3, !DC24(f17, v92, v94[v90.f22 := v93], f17, v95[f14 := DC3(v78[525])]).cf36);
					var v97 := DC22("efq");
					var v98 := 'l';
					...
					var v103: array<int> := new int[29] [-f14, p0, p0, |v97.cf29|, f14, v90.f22, f14, v80.cf57, f14, v90.f22, if ('u' in v99) then v99['u'] else |v100|, -fm0(p1, globalState), p0, f14, |multiset{v101, v101}|, v90.f22 * p0, 29, (if (p0 in v34) then v34[p0] else |[|v102|]|) - p0, v90.f22, -(f14 * p0), f14, v90.f22, if (p0 in v34) then v34[p0] else 0x393, 872, p0 + f14, |("byv" + (seq(418, i6  => (v98))))|, f14, f14 * f14, f14 / |map[true := v102]|];
					v103[635] := v90.f22 * |v90.f23|;
					v103[635] := v90.f22;
				case DC21(cf28) =>
					v38 := v38[v78[525] := v78[525]];
					var v104: seq<int> := [f14 + p0];
					var v105: array<char> := new char[24];
					var v106: seq<array<char>> := [v105];
					v104, v106 := v104, (v106[f14 := v105] + v106) + (v106 + v106)[p0 := v105];
					var v107: array<int> := new int[28];
					v107[505] := f14 % fm0(f17, globalState);
					v107[505] := f14;
					var v108 := "etgkflwva";
					var v109 := 'i';
					var v110: multiset<string> := multiset{if (!fm4(|v104|, f17, v107[505], globalState)) then v108 else v108, v108[f14 := v109], v108, seq(845, i7  => (v109))};
					v110 := multiset{((seq(0x326, i8  => ('i')))[f14 := v109])[f14 := v109] + v108, v108 + v108, seq(0x3c7, i9  => (v109)), v108};
			}
			...
			v116, globalState.f7, f16, f16, v122[396] := v116, 837, fm27(|v119|, |v123|, v124[v117.f14], map[f14 := f14], globalState), f17, (f14 * -|(map v125 : D14 | v125 in v129 :: (v125) := (f17))|) * -76;
			v115[141] := f17;
			v115[141] := f16;
	...
	method m3(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		v4 := v4[p3 := 'a'];
		var v6: array<map<int, bool>> := new map<int, bool>[11](i1 => (map v5 : int | (939 <= v5) && (v5 < 588) :: (v5 - -p1) := (f17)) + map[|(seq(333, i2  => (p0)))| := f17]);
	...
	method m1(p0: bool, globalState: GlobalState) returns (r0: seq<int>, r1: array<bool>, r2: int) {
		...
		for i0 := f14 to |v0| {
			...
			if (p0) {
				...
				v7[981] := v6;
				var v8 := "goxhiusc";
				var v9: set<bool> := {v1[311], false, v1[311], v1[311], f15};
				r2 := v6[486] + -(|v8| % |v9|);
				v1[311] := (v1[311] <== p0) <== f15;
			} else {
				globalState.f7 := i0;
				var v10: T0 := new C10(p0, f15, i0);
				var v11: seq<T0> := [v10];
				globalState.f2 := i0 / fm2(|v11|, v10.f14, fm21(globalState), v10.f14, globalState);
				v1[311] := v10.f14 == f14;
				var v12 := new C4(!(!f15 <==> v1[311]), false, f15);
				v1[311] := !false;
			}
			...
			if (f15) {
				...
				var v15: multiset<bool> := multiset{if (v1[311]) then v1[311] else v1[311]};
				globalState.f2, v1[311], v14, globalState.f2 := if (false in v15) then v15[false] else i0, v1[311], v14, f14;
				var v16: array<seq<bool>> := new seq<bool>[16](i3 => [f15, f15]);
				v16[348] := if (v1[311]) then v2 else v2;
				var v17: map<int, seq<bool>> := map[f14 := v2];
				var v18: map<seq<bool>, seq<bool>> := map[v2 := [v1[311]]];
				var v19: map<bool, seq<bool>> := map[f15 := v2];
				v16[348] := if (i0 in v17) then v17[i0] else (if ((if (v1[311] in v19) then v19[v1[311]] else v2) in v18) then v18[if (v1[311] in v19) then v19[v1[311]] else v2] else v2[0x2ff := f15]) + v2;
				var v20: array<int> := new int[16];
				v20[914] := f14;
				v20[168] := i0;
				v20[914], v20[168] := f14, i0;
				v20[914] := i0;
			} else {
				var v21: set<bool> := {v1[311]};
				var v22: multiset<bool> := multiset{f15, f15, f15, p0};
				var v23 := "skoh";
				var v24 := 'w';
				var v25: array<int> := new int[11] [if (v1[311] in v22) then v22[v1[311]] else i0, i0, |map[i0 := v1[311]]|, i0, |v23[f14 := v24]|, |(seq(0xf, i4  => (i0)))|, f14, f14, i0, i0, -349];
				var v26: map<set<bool>, array<int>> := map[v21 := v25];
				v1[311] := fm27(i0, i0, fm0(!v1[311], globalState), map[f14 := |v26|], globalState);
				globalState.f7 := i0;
				v21 := v21 + v21;
				v25[486] := i0;
				v25[486], v1[311], v1[311] := 709, !fm43(v22 < fm1(globalState), globalState), v1[311] && !fm21(globalState);
				v1[311] := v25[486] >= (if (fm21(globalState)) then i0 else v25[486]);
			}
			
		}
		globalState.f7 := f14 % f14;
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		if (p0) {
			...
			if (p0) {
				...
				var v7: array<int> := new int[8] [|multiset{map[|v4| := p0], v6[-v0 := p0], map[v0 := false], map[v0 := p0], v6}|, 0x2f9, 0x66 / v0, v0 - v0, v0, v0 - v0, -v0, v0];
				v7 := if (false) then v7 else v7;
				var v8: array<bool> := new bool[18](i0 => {p0} > {p0});
				v8[753] := p0;
				var v9 := "ft";
				v0, v8[753], v7, r1 := v0, p0, v7, if (p0) then !p0 else v9 < v9;
				r1 := v8[753];
				var v10 := new C6(v0, p0, fm17(v8[753], v0, v0, v0, globalState), v8[753], v0);
				globalState.f2 := v0;
			} else {
				var v11 := "pkeaspy";
		...
		var v40: array<int> := new int[16] [v0 / |v34|, |v35|, -0xc9, v0, v0, fm0(p0, globalState), v0, if (false) then v0 else v0, v0, 0x38c / v0, v0, -981 * v0, |v36[v0 := v0]|, -(v0 * |v37|), v39.cf31, v0];
		v40[610] := v0 + v0;
		v40[610] := -v0 % v0;
		var i1 := 0;
		while (p0)
			decreases 100 - i1
		{
			...
			v43 := v43[v0 < -v40[610] := DC33(p0, v31.f21, v40[610], v31.f21)];
			var v44: map<bool, int> := map[v31.f21 := |v35|];
			var v45 := 'l';
			var v46 := DC30(v45);
			var v47: map<int, D15> := map[-|v44| % v40[610] := v46];
			v47 := v47[v0 := DC30(v45)];
			r1, r2, r0, r2, v40[610] := !(if (v31.f21) then false else v31.f21), v31.f21, v40[610], !(v40[610] < v0), (v40[610] * v40[610]) % v37[v0];
			if (v41[v0]) {
				v40 := v40;
				var v48 := DC3(v41[v40[610]]);
				...
				v0 := -0x183 + (v0 + v40[610]);
				var v52 := new C3(v0 % |v35|, "dtmbyeffl" + v35, v31.f21, p0);
				var v53: map<int, bool> := map[v40[610] := v31.f21];
				v40[610] := |v53| - (v0 / v40[610]);
				var v54: array<bool> := new bool[13](i2 => v31.f21);
				v54[982] := v31.f21;
				var v55 := DC22("roekfqycj");
				v54[982], v0, v40[610] := v31.f21, -((v40[610] / |v55.cf29|) * v40[610]), v52.f22;
				var v56: map<string, bool> := map[v35 := v31.f21];
				v56 := v56[v52.f23 + v35 := v31.f21];
			}
			
		}
		var v57 := DC44(-v40[610], v31.f21);
		var v58: multiset<int> := multiset{v57.cf69};
		var v59 := 'f';
		var v60: set<int> := {v40[610], v0};
		var v61: array<seq<int>> := new seq<int>[26] [v37, v37 + v37, v37, v37 + v37, v37 + v37, [v0, v40[610]], v37, v37, v37, v37, v37 + v37, v37, v37[v40[610] := v40[610]], v37 + v37, fm35(|v58|, !p0, v40[610], v59, globalState), v37, v37, v37, v37, v37, v37, seq(0x1b8, i3  => (v40[610])), [|v60|, 0x39d] + v37, v37 + v37, v37, seq(-0x1bc, i4  => (v0))];
		v61[70] := v37;
		v61[70] := v37;
		r1 := v31.f21;
		r0 := v40[610];
...
method Main() {
	...
	v3, globalState.f7, v3, v4[310], v3 := if (-v5 in v6) then v6[-v5] else v3, v5 - v5, v3, v9 + ([|v11|])[v5 := v5], if (v3) then |multiset(v9)| != v5 else v3;
	...
	var v17: multiset<bool> := multiset{v14[v5] in v16, !v3, false};
	var v18: map<int, multiset<bool>> := map[fm0(v3, globalState) := v17];
	var v19: seq<multiset<bool>> := [v17, multiset{v3, v3}, v17];
	v17 := (if (-0x167 in v18) then v18[-0x167] else v19[v5]) - (v17 + fm1(globalState));
	...
	if (false) {
		...
		v0[905] := !false;
		v10, v3, v0[905] := v10, !(false ==> v3), !true;
		var v24: array<D16> := new D16[13];
		v24[572] := DC33(v3, false, v5, v3);
		var v25: map<int, int> := map[v5 := v5];
		v24[572] := fm71(v25, fm52(!v3, v5, v5, v5, globalState), 741, v15 + {!v3}, globalState);
		if (if (v0[905] in v7) then v7[v0[905]] else v0[905]) {
			var v26: array<seq<D13>> := new seq<D13>[28];
			var v27 := "mxwae";
			var v28: map<string, int> := map[v27 := |(seq(0x394, i3  => (v10)))[|"lwfis"| := v10]|];
			var v29 := DC25(v28);
			...
			var v33 := DC51(v32);
			v32 := if (v0[905]) then v32 else v33.cf78;
		} else {
			v1[794] := v5;
			v1[794], v3, v7 := v5 - -v5, 931 >= v5, v7;
			var v34: C13 := new C13();
			v34 := v34;
			v5 := v5 / v5;
			var v35: array<bool> := new bool[29] [v3, !v3, v0[905], v3, v0[905], v3, v0[905], v0[905], v0[905], v3, false, v3, v0[905], v0[905], v0[905], v0[905], fm31(v3, v3, globalState), fm43(v0[905], globalState), v3, !v0[905], true, v3, v0[905], v3, v0[905], v0[905], v0[905], v3, v3];
			var v36 := "s";
			var v37: map<array<bool>, string> := map[v35 := v36];
			var v38 := DC22(v36);
			v37 := v37[v35 := v38.cf29 + (seq(0xf, i5  => (v10)))];
		...
		var v41 := "wfsifht";
		if (!((if (v0[905]) then v41 else v41)[v5 := v10] <= v41)) {
			var v42 := new C13();
			var v43: multiset<seq<seq<bool>>> := multiset{v13, v13, v13};
			var v44 := DC0([v3, v3]);
			var v45 := DC7(v44, v5);
			globalState.f2 := if ([v12] in v43) then v43[[v12]] else -(v45.cf12 * v5);
			v6 := v6[fm0(v0[905], globalState) := (seq(0x25a, i6  => (v10))) == v41];
			v6 := v6[v5 - |v9| := v3];
			var v46: set<int> := {v5, v5, 0x1ba};
			var v47: array<bool> := new bool[14];
			var v48 := DC15(v0[905], v0[905], v46, v1, v47);
			var v50: array<D9> := new D9[14] [v48, v48, DC15(v3, v0[905], v46, v1, v47).(cf22 := v47, cf21 := v1), DC15(v0[905], fm43(false, globalState), set v49 : int | v49 in v25 :: (v49 % |{true, true, false, false, !true}|), v1, v47), v48, v48, v48, v48, v48, v48, v48.(cf21 := v1, cf19 := false, cf22 := v47), v48, v48, v48];
			var v51 := DC37(v50);
			v51 := v51;
		} else {
			v41 := (v41 + v41) + v41;
			var v52: array<C0> := new C0[25];
			var v53: array<set<bool>> := new set<bool>[26] [{v3}, v15, {v3}, v15, {v0[905]}, v15, v15, v15, {v3, false, v3, false, !v3}, v15, v15, v15, v15, v15, {v3}, v15, v15, {v3}, v15, v15, v15, v15, fm44(v3, false, globalState), v15, v15, v15];
			var v54: C0 := new C0(v53, |v4[310]|);
			v52[482] := v54;
			v52[482] := v54;
			...
			v3, v0[905], v3, v0[905], v60 := v3, v3, v5 != v5, v3, v60;
			var v61: map<bool, int> := map[v3 := -|v9| - 0x2b9];
			var v62 := DC22(v41);
			var v63: seq<D12> := [v62, DC22(v41), v62];
			v5 := if ((v0[905] !in v61) in v61) then v61[v0[905] !in v61] else |(if (v3) then v63 else v63)|;
		}
		
		if (v3) {
			var v64: C9 := new C9();
			var v65: set<C9> := {v64, v64, v64, v64, v64};
			var v66 := new C6(v5, fm43(v0[905], globalState), v3, v65 > {v64, v64}, --v5 * |v9|);
			...
			var v73: C11 := new C11(v69.f27, v66.f20, v0[905]);
			v72, v0[905], v5, v73, v7 := v72, v66.f20, v5, v73, v7 + v7;
			v3 := v41 < v67.fm9(v5, [v71, v71], 's', v69.f27, globalState);
			var v74: map<bool, int> := map[v0[905] := 0x18];
			v74 := v74[v0[905] && v66.f20 := v69.f27 / |{v69.f27}|];
		} else {
			var v75: C13 := new C13();
			...
			v3 := v41 != ((if (0x3c4 in v78) then v78[0x3c4] else v41) + (seq(0x44, i7  => (v10))));
			globalState.f2 := v5;
			v0[905] := (-0xbc % v5) != (if (v3) then v5 else v5);
			var v79 := new C13();
		}
	...
	match (DC53()) {
		case DC52(cf79) =>
			...
			v6 := map[|v80[|v82| := v10]| := v3] + v6;
		case DC53() =>
			var v83: T2 := new C7(v3, if (v3) then v3 else v3, 0x3e5);
			v83 := v83;
			v83.f16 := v3 <== true;
			v83.f16 := fm17(v83.f16, v5 % v5, v5 * 159, |map[v5 := v5]|, globalState);
			if (!v3) {
				...
				var v89, v90, v91, v92 := v83.m6(v83.f17, v84.cf70, 0x308 / v5, fm34(|v85|, |v88|, v83.f17, -0x1f3, globalState), globalState);
				var v93: multiset<seq<bool>> := multiset{[v90]};
				var v94 := new C11(v89, v93 == v93, !v92);
				globalState.f2 := 0x9e;
				var v95: map<int, int> := map[|(seq(0x153, i9  => ('m')))| := |v12|];
				var v101 := DC19(v95);
				var v102: array<map<int, int>> := new map<int, int>[22] [if (v83.f16) then v95 else v95, map[|v17| := v86.f14], map[v5 := |v95|] + v95, map[v86.f14 := |"fjhe"|], (map v96 : int | (0x9c <= v96) && (v96 < 0x70) :: (v96 + v89) := (-v89)) + (map v97 : int | v97 in v4[310] :: (v97 / v86.f14) := (|[v83.f16, v3, v83.f17]|)), v95 + v95, map v98 : int | v98 in v9 :: (v98 - v89) := (v86.f14), map[v86.f14 := v89], v95 + (map v99 : int | v99 in v4[310] :: (v99 % v86.f14) := (v89)), v95 + v95, v95, v95 + v95, v95, map v100 : int | (0x3da <= v100) && (v100 < 286) :: (v100 * |v95|) := (v86.f14), v95, map[v89 := v89], v95 + map[|v9| := v5], v101.cf27, v95, v83.fm3(globalState), v95, v95];
				...
				v112, v3, v83.f16 := "lkc", v12[v113.f22 / v113.f22], v83.f16;
				var v119 := DC44(v5, v83.f16);
				var v120: map<int, D21> := map[v113.f22 := v119];
				var v121 := new C7(true, |v120| >= v4[310][v5], v113.f22);
				v1[245] := -v5 * |v9|;
				v1[245] := -v113.f22;
			}
		...
		case DC51(cf78) =>
			...
			var v125: set<C8> := {v123, v123, v123, v123, v124[v5]};
			var v126: set<int> := {|v7|};
			...
			v131[676] := v133[v123.fm12(fm0(v3, globalState), globalState)] + v129;
			var v134: C5 := new C5(if (v3) then !v3 else v3, v3 || v3);
			v131[676], v3, v134 := v129, v5 != (v5 + |v122|), v134;
			v3, globalState.f7, v3 := v3, -(v123.fm12(v5, globalState) / (if (false) then |[v3]| else v5)), v3;
		case DC54(cf80) =>
			v3 := if (v3) then v3 else v3;
			if (v3) {
				v3 := v3;
				var v135: map<bool, int> := map[!v3 := v5];
				v1[355] := v5 / (if (v3 in v135) then v135[v3] else v5);
				v1[355] := v5;
				globalState.f2 := v1[355] - (v5 % v1[355]);
				var v136: array<int> := new int[21](i11 => i11 + |v7|);
				var v137: map<int, array<int>> := map[-v5 := v136];
				var v138: map<int, array<int>> := map[fm0(v3, globalState) % |v9| := if (v1[355] in v137) then v137[v1[355]] else v136];
				...
				var v144, v145, v146 := m16(v10, v5 % v5, v9, |v143| > |v12[v5 := v3]|, globalState);
				v3 := v3;
				v3 := v3;
				v3 := true;
				var v147: map<bool, int> := map[!v3 := v5];
				var v148: map<map<bool, int>, int> := map[v147 := v146 % v146];
				v148 := v148[v147 := |(seq(0xf4, i12  => (if (v3 in v17) then v17[v3] else -0x2e5)))|];
			}
			...
			v149[398] := if ((v5 % v5) in v151) then v151[v5 % v5] else v150;
	}
	
	v1[179] := if (v3) then fm0(v3, globalState) else 17;
	v1[179] := v5;
	var v152 := DC32(v17);
	for i13 := |v152.cf46| to v5 {
		...
		var v158: map<int, set<C7>> := map[v1[179] + (if (v154 in v155) then v155[v154] else v5) := v157 - v157];
		v1[179], globalState.f7 := -v5, |v158|;
		...
		v162 := v162[v3 := (v161 + v161)[v154.f22 := v160]];
		v0 := v0;
		var v163 := new C13();
	}
	var v164 := DC30(v10);
	...
	v0[627] := v3 || v3;
	v0[627] := v3;
	for i14 := fm0(!v0[627], globalState) to -v1[179] {
		var v168 := "x";
		var v169, v170, v171 := m16(v10, 361, v9, v168 <= v168, globalState);
		globalState.f2 := i14 % v5;
		var v172: map<int, int> := map[v1[179] := v5];
		...
		match (if (v172 != v172) then if (v3) then DC37(v173) else v174 else v174) {
			case DC38(cf57, cf58, cf59) =>
				...
				v175, v3 := v175, if (v0[627]) then v176 !! v176 else if (cf57 in v6) then v6[cf57] else true;
				var v177: map<bool, array<int>> := map[v0[627] := v1];
				v177 := v177[v0[627] := v1];
				var v178: array<array<int>> := new array<int>[19];
				v178[35] := v1;
				v5, v178[35] := fm0(!fm43(cf58, globalState) && v3, globalState), v1;
				globalState.f7 := fm0(v0[627], globalState);
			case DC37(cf56) =>
				var v179 := new C6(v171, v3, v0[627], |map[v3 := 0x23e]| <= 992, v1[179]);
				v17 := v17;
				...
				v181[296] := v182;
				var v183 := DC33(v179.f20, v3, v1[179], v3);
				var v184: seq<D16> := [v183];
				var v185: C9 := new C9();
				var v186: map<int, C9> := map[v5 := v185];
				var v187: set<C9> := {if (v1[179] in v186) then v186[v1[179]] else v185};
				var v188: seq<seq<D16>> := [v184, v184, v184[17 := v183]];
				globalState.f2, v180, v181[296], v184, v187 := (v1[179] + v171) % -0x23d, v180, v182, ([v183.(cf49 := v171)] + v184) + v188[|v168|], {v185, v185, v185};
				var v189, v190 := v185.m5(globalState);
		}
		
		v0[627] := v12[i14] ==> v0[627];
	}
	var v191: array<set<bool>> := new set<bool>[13](i16 => v15);
	forall i15 | 0 <= i15 < v191.Length {
		v191[i15] := {v3, {v5, v1[179]} <= {v1[179]}};
	}
	globalState.f2 := 0x73;
}