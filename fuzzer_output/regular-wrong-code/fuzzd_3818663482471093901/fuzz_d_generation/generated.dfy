...
function fm14(p0: int, p1: bool, p2: int, globalState: GlobalState): seq<int> {
	seq(0x77, i0  => (|[multiset{|multiset{seq(-0x39, i1  => ('b')), "qpi"}|}]|))
}
function fm19(globalState: GlobalState): map<int, bool> {
	match DC105(false, |"o"|, false) {
		...
		case DC104(cf173) => if (true) then map v0 : int | v0 in {|map['v' := |[true, !true]|]|} :: (v0 % -0x28c) := (false) else map[0x3e0 := true]
...
function fm25(p0: int, p1: int, globalState: GlobalState): string {
	seq(0x29e, i0  => (if (true) then 'o' else 'v'))
}
...
function fm32(p0: int, globalState: GlobalState): seq<int> {
	match DC17(DC17(DC15())) {
		...
		case DC16(cf31) => seq(0xb8, i0  => (0x3d6))
		case DC14(cf30) => [-|"t"|] + [|cf30|]
		case DC17(cf32) => seq(0x3a1, i1  => (0x15e))
	}
}
...
function fm43(p0: bool, p1: D9, globalState: GlobalState): D7 {
	match DC72(0x57, false, false, 0xa7, !!true) {
		...
		case DC73(cf124) => DC21(true, |(seq(0x289, i0  => (410)))|, 'd', |"jma"|, true)
	}
}
...
function fm50(p0: D10, p1: bool, p2: bool, p3: int, globalState: GlobalState): D5 {
	DC13(map[!false := DC6(DC6(DC4(seq(981, i0  => (|"dhmoxs"|)))))])
}
function fm51(p0: bool, p1: int, globalState: GlobalState): seq<multiset<bool>> {
	(seq(0x282, i0  => (multiset{!true, true, false}))) + [multiset{false}, multiset{false}, multiset{false}, multiset{false}]
}
...
function fm55(globalState: GlobalState): D15 {
	DC43("c", true, -|map[false := --|(set v0 : int | (994 <= v0) && (v0 < 695) :: (v0 % 220))|]|, false, if (!false) then 'g' else 'p')
}
...
function fm57(p0: map<int, int>, p1: int, globalState: GlobalState): map<map<bool, int>, int> {
	map[map[true := |(set v0 : int | (815 <= v0) && (v0 < -0x272) :: (v0 / |map[true := true]|))|] := -|[|(seq(-850, i0  => (|{|map[false := false]|, 0x213}|)))|]|] + (map v1 : map<bool, int> | v1 in multiset{map[true := |[false, true]|]} :: (v1) := (0x1ae))
}
...
function fm59(p0: bool, p1: D11, p2: int, p3: set<string>, globalState: GlobalState): map<int, map<int, int>> {
	((map v0 : int | (119 <= v0) && (v0 < 0x2cd) :: (v0 * 0x1ae) := (map[|(map v1 : int | (362 <= v1) && (v1 < 0x1dd) :: (v1 * |"jrgbgi"|) := (true))| := |{true}|])) + map[|(seq(572, i0  => ('r')))| := map[0x3b0 := |"velljmyv"|]]) + (map[0x129 := map[726 := 454]] + map[|"auv"| := map[-0x30 := |"yrk"|]])
}
function fm60(globalState: GlobalState): seq<map<int, bool>> {
	[map[|map[!true := true]| := false], map v0 : int | (0x40 <= v0) && (v0 < 0x124) :: (v0 % 0x15e) := (false)] + [map[478 := false]]
}
...
function fm62(p0: map<bool, map<bool, char>>, p1: string, p2: int, p3: int, globalState: GlobalState): D12 {
	DC32(multiset{377} - multiset{|{false}|, |[|multiset{"pgpuppsjv", "qr"}|]|, -|multiset{-|(seq(0x177, i0  => ('n')))|}|, -0x16e})
}
function fm63(globalState: GlobalState): D12 {
	DC33(-|(multiset([|(seq(0x35c, i0  => ('m')))|]) * multiset(seq(0xf6, i1  => (|"anegtwta"|))))|, false, true, false && false)
}
function fm64(globalState: GlobalState): map<int, int> {
	map[|(seq(707, i0  => (0xc2)))| - 270 := |(seq(0x15f, i1  => ('b')))| * |"lxfkhww"|]
}
...
function fm68(p0: map<bool, int>, p1: bool, globalState: GlobalState): seq<int> {
	(if (false) then [299] else [|{'v', 'q', 'c'}|]) + (seq(459, i0  => (|(seq(0xe0, i1  => ('r')))|)))
}
...
function fm70(p0: bool, globalState: GlobalState): D15 {
	match if (false) then DC11(DC11(DC11(DC11(DC9(!true, |map[false := 0x1f9]|, false, [false], 0x2c9))))) else DC11(DC8(-0x32f, false, false, -|(set v0 : int | v0 in [0x1e8, 133] :: (v0 / |map[true := false]|))|, |(set v1 : int | (394 <= v1) && (v1 < 0x13f) :: (v1 + 0x34d))|)) {
...
function fm71(p0: seq<bool>, p1: int, globalState: GlobalState): D12 {
	DC34(DC66('d', false).cf113 in (seq(963, i0  => ('w'))), true)
}
function fm72(globalState: GlobalState): D2 {
	DC5(|multiset{'w', 's', 'k'}| % -|map[!false := 0x3a5]|)
}
...
function fm79(p0: bool, p1: string, globalState: GlobalState): set<int> {
	{|[[false, true], [false]]|, |{|map[{false, false} := 0xda]|}|} + ((set v0 : int | v0 in multiset([464]) :: (v0 / 0x262)) * {|(seq(-0x14a, i0  => ('j')))|})
}
function fm80(p0: bool, globalState: GlobalState): D7 {
	DC21((set v0 : char | v0 in ['r'] :: (v0)) >= (set v1 : char | v1 in (seq(0x14f, i0  => (DC66('p', true).cf113))) :: (v1)), 10, 'k', -0xb2, !true && false)
}
...
function fm82(p0: bool, globalState: GlobalState): map<int, seq<int>> {
	((map v0 : int | v0 in (map v1 : int | (0x198 <= v1) && (v1 < -0x2fe) :: (v1 + |multiset{false, false, false}|) := (|[115]|)) :: (v0 + |map["vouurojr" := !false]|) := (seq(0x37b, i0  => (-0x185)))) + map[|map[-0x2a7 := 0x1d2]| := [0x35b]]) + map[DC111(false, 7).cf187 := [|[-|"otx"|]|, --0x225]]
}
function fm83(globalState: GlobalState): D12 {
	DC32(multiset([0x370] + (seq(0x2c2, i0  => (|map[|{!true}| := |multiset{false, true}|]|)))))
}
function fm84(globalState: GlobalState): map<D12, int> {
	map[DC32(multiset(seq(0x2f0, i0  => (962)))) := -334] + (map[DC32(multiset{|multiset([true, true, true])|}) := |[0x1bb]|] + map[DC32(multiset([|map[true := false]|, |map[true := |(seq(-647, i1  => (|multiset(seq(0x271, i2  => (0x1de)))|)))|]|, |{|{|multiset([!true])|}|}|, 992])) := |(seq(0x1d6, i3  => ('o')))|])
}
...
function fm86(p0: bool, p1: int, globalState: GlobalState): seq<int> {
	if (!(0x5a >= |multiset{DC10(|map[|(seq(570, i0  => ('m')))| := 467]|, |[|[!false]|, |[false]|]|, --0x2d7)}|)) then [695, 0x1fc] else [-336, |map[--831 := DC40(423, |"by"|)]|] + (seq(0x2b8, i1  => (|map[|[0x1d3, -632]| := 507]|)))
}
...
function fm89(globalState: GlobalState): map<int, int> {
	map[-|"mgvar"| + DC99('r', 0x39b, !false, false).cf166 := |((seq(0x342, i0  => ('x'))) + "lettlt")|]
}
function fm90(p0: char, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, set<int>> {
	(map v0 : int | v0 in [|[|(seq(-0x33d, i0  => ('j')))|]|] :: (v0 * 0x16e) := ({--DC33(-0x20, !false, true, false).cf58})) + map[0x3e3 := {0x22c}]
}
...
function fm94(p0: bool, p1: char, globalState: GlobalState): multiset<int> {
	multiset{|((seq(0xf1, i0  => ('f'))) + "fv")|, |([false, !false] + [true])|}
}
...
function fm101(p0: char, p1: bool, globalState: GlobalState): map<string, multiset<bool>> {
	if (0x227 != |map[-|(seq(929, i0  => (0x21f)))| := false]|) then map["vdi" := multiset{true, false, true}] else (map v0 : string | v0 in map["yawavst" := false] :: (v0) := (multiset{false, false, true, true})) + map["nanjsw" := multiset{true, false}]
}
...
function fm107(p0: bool, p1: int, p2: char, globalState: GlobalState): multiset<map<int, int>> {
	multiset{map[0x2f4 := 977]} + (multiset(seq(794, i0  => (map[525 := |"cejwm"|]))) - multiset{map[0x32c := |"usvsf"|], map[-0x337 := 0x27e]})
}
function fm108(globalState: GlobalState): set<string> {
	({"kyjgfytm"} - (set v0 : string | v0 in map[seq(0x5e, i0  => ('s')) := 0x2cb] :: (v0))) - {"gqexqb"}
}
function fm109(p0: int, p1: int, globalState: GlobalState): set<D32> {
	{DC84(0x1ba, false, !false)} - {DC84(|"afyjqxhh"|, true, true), DC84(-0x125, false, false), DC84(|map[seq(-0x39f, i0  => ('w')) := 0x27f]|, !false, true), DC84(-|map[false := true]|, false, true)}
}
...
function fm116(p0: int, globalState: GlobalState): D3 {
	match DC81(962, |"selspjg"|) {
		case DC80() => DC9(false, --|(seq(0x3b1, i0  => ('i')))|, false, [DC111(false, 0x1b7).cf186], -0x29c)
		case DC81(cf137, cf138) => DC9(false, |[map[|map[true := |multiset([cf137])|]| := false], map v0 : int | v0 in [cf137, |(seq(376, i1  => ('c')))|] :: (v0 / cf138) := (true)]|, true, [true], cf137)
		case DC79(cf136) => DC9(!false, |"n"|, true, [false, true, !!true], 0x372)
	}
}
function fm117(globalState: GlobalState): D29 {
	DC72(if (true) then |"vhdi"| else -|[false, true]|, 0x1ac > -0x233, !false, |DC116(|(seq(-0x1ea, i0  => ('c')))|, 'g', map[false := true]).cf197|, false)
}
...
function fm120(p0: bool, globalState: GlobalState): D30 {
	if (|map[|[false]| := 0x321]| == |map[true := -0x1b9]|) then if (!true) then DC76(map[true := false], true, "g", true) else DC76(map[true := false], false, seq(889, i0  => ('c')), !true) else DC76(map[false := false], false, "kebwtgxi", true)
}
...
method m0(p0: bool, globalState: GlobalState) returns (r0: multiset<D0>, r1: char, r2: bool, r3: int) {
	...
	if (p0 <==> p0) {
		...
		match (v2) {
			case DC45(cf81, cf82) =>
				...
				var v8 := 'h';
				var v9: array<int> := new int[13] [567, cf81, v1 * v1, |(v5 + v5)|, v1, cf81, |v6|, v1, 127, v1, |(seq(0x2a3, i1  => ('o')))[|v7| := v8]|, cf81, --(v1 - v1)];
				v9 := v9;
			case DC44(cf80) =>
				...
				v10.f33 := if (fm2(globalState)) then if (v24[v1] in v23) then v23[v24[v1]] else p0 else v14.f22;
		...
		v28[381] := v1;
		var v29: map<int, bool> := map[0x1b1 := v0[405]];
		v28[381] := |(v29 + v29)|;
		var v30 := 'i';
		...
		var v38 := 'h';
		var v39: array<int> := new int[8] [|v35|, v33, |v32|, v33, v33 / |v36[|v37| := v0]|, |(map[v38 := p0])[v38 := p0]| - v33, v33, v33];
		v39[281] := -v33 % v33;
		v39[281] := fm1(globalState);
		v0[876] := p0 || p0;
		var v40 := "vin";
		v0[876] := !!((v38 !in v40) <==> (v40 != v40));
		var v41: map<int, int> := map[v33 := v39[281]];
		var v42: set<int> := {v39[281], if (v33 in v41) then v41[v33] else v39[281], |multiset{seq(-94, i2  => (v38)), v40}|};
		v42 := v42;
	}
	...
	for i3 := 939 to v44 {
		...
		v0[226] := !p0 || v48.fm16(-v44, if (!p0 in v58) then v58[!p0] else v57, -790, globalState);
	}
	var i4 := 0;
	while (p0)
		decreases 100 - i4
	{
		...
		var v62: array<int> := new int[7] [|(seq(0x2a, i5  => ('n')))|, v44, |[v44, v44, |v60|, v44]|, -(|v61| * v44), v44, v44, v44];
		v62[309] := -v44;
		v62[309] := fm1(globalState);
		...
		r2, v63[930], v62[309], v70 := p0, v66[v64 := !(p0 ==> p0)], v44, v70;
...
class C1 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v10: seq<multiset<int>> := [fm36(fm1(globalState), p0, globalState), v8, multiset{f23, f23}, v9[p0], v8];
				globalState.f8 := |(v8 - v10[f23])|;
			} else {
				var v11: array<D1> := new D1[26](i1 => DC2(DC8(f23, f36, f36, f23, |v0[690]|).cf18));
				v11 := v11;
				globalState.f8 := --p0;
				v0[690] := v1;
				v2[890] := f36;
		...
		var v17: multiset<bool> := multiset{true, f36, v1 <= ("vwvhfbvol")[p0 := f37]};
		var v18 := true;
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			v2[319] := fm2(globalState);
			var v21: seq<bool> := [v18];
			var v22: seq<seq<bool>> := [v21, [v18, f36]];
			v2[319] := (v22[p0] + [f36]) != v21;
			var v23: array<map<int, int>> := new map<int, int>[3](i3 => v14);
			v23[587] := v14;
			v23[587], v18, v2[319], globalState.f8, v2[319] := v14, fm2(globalState), f36, p0, f36;
			...
			if (p0 >= f23) {
				...
				var v32 := DC8(f23, v2[319], !v18, f23, |v23[587]|);
				v29[294], v2[319], v30, v2[319] := f23, f36, if (v18 in v31) then v31[v18] else v30, v32.cf16;
				var v33: set<int> := {f23, |v1|};
				var v35: set<set<int>> := {v33, v33, set v34 : int | v34 in (seq(-0x180, i5  => (p0))) :: (v34 - |"tlsviw"|)};
				var v36 := DC18(v35);
		...
		if (v18 <== (v18 <==> false)) {
			...
			v2[826] := v18;
			v2[826] := f36 ==> v18;
			if (!DC8(f23, fm2(globalState), f36, f23, |fm39(true, v2[826], p0, globalState)|).cf15) {
				var v40: array<int> := new int[2](i6 => i6 / f23);
				v40[244] := if (v2[826]) then p0 else p0;
				v40[244] := p0;
				...
				v44[688] := v40;
				var v45: map<map<int, bool>, bool> := map[v39 := v2[826]];
				v44[688], globalState.f8 := v40, v40[244] / |v45|;
				var v46: seq<int> := [|v0[690]|];
				v46 := seq(0x292, i7  => (|(v0[690] + "ano")|));
			} else {
				var v47: array<char> := new char[10];
				var v48: map<int, char> := map[p0 := f37];
				v47[837] := if (0x27b in v48) then v48[0x27b] else f37;
				v47[837] := p1;
				var v49: seq<int> := [f23, p0];
				var v50: array<int> := new int[12] [|v1|, fm33(f23, v17, v2[826], v19[0x11a := p0], globalState), ---986, p0, p0, p0, f23, v49[f23], f23, |v1|, fm33(0x36, v17, v18, v19, globalState), f23];
				var v51: seq<array<int>> := [v50, v50, v50];
				v51 := v51;
				v18 := v2[826];
				var v52: array<map<string, bool>> := new map<string, bool>[11](i8 => map[v0[690] := if (p0 in v39) then v39[p0] else true]);
			...
			var v56: seq<map<bool, int>> := [fm39(v2[826], f36, |map[f23 := |(seq(57, i9  => (p1)))|]|, globalState)];
			v18 := -|v13| != |(v56 + v56)|;
			v18 := v2[826];
		} else {
			globalState.f8 := p0;
		...
		var v63: array<map<int, int>> := new map<int, int>[20] [v14, v14, if (f36) then v14 else v14, v14, v14, v14, v14 + v14, v14, v14, v14, map v59 : int | (0x1f6 <= v59) && (v59 < 0x342) :: (v59 % |v19|) := (f23), v14, map v60 : int | v60 in v19 :: (v60 * p0) := (p0), v14, v14, v14, v14, if (v61[p0]) then v14 else v14[f23 := p0], v14, v62.cf43];
		r0 := v63;
		r1 := (p0 % f23) * f23;
	}
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
			...
			decreases 100 - i0
		{
			...
			var v6: seq<int> := [f23];
			r1, v4[63], r1 := false, v5[f23], f23 !in (v6 + v6);
			var v7 := new C0(v4[63], p1);
		}
		...
		v9[156] := if (v10 in v11) then v11[v10] else f23;
		globalState.f19 := p2;
		...
		r2 := v9[156] - (v9[156] - DC10(v9[156], v9[156], fm1(globalState)).cf26);
	}
	method m20(p0: int, p1: set<int>, globalState: GlobalState) {
		...
		if (match DC9(false, -96, false, v0, p0) {
			...
			v2[194] := v4[f23 := f23] + v4;
			var v5: set<bool> := {f36, v1, f36, v1, f36};
			var v6: map<bool, bool> := map[f36 := !false];
			v1, globalState.f8, v2[194] := v0[p0], |(v5 + DC27(v5).cf49)|, map[p0 % p0 := 0x3dd % |v6|];
			v1 := f36;
		} else {
			...
			var v15 := "adclxehfm";
			var v16: array<string> := new string[19] [v15, v15, v15, v15, if (f36) then v15 else v15, "ajg", v15, v15, v15, v15 + v15, v15, ("xa")[|map[f23 := v14.f39]| := f37], v15 + v15, fm34(globalState), v15 + v15, v15[0x23d := f37], v15, if (true) then "acvwxab" else "ygd", v15];
			v16[705] := "mqwehleip";
			v16[705] := (seq(0xa4, i0  => (f37)))[if (v14.f38) then f23 else f23 := f37];
			var v17 := DC10(800, 0x123, f23);
			globalState.f8, globalState.f5 := -v17.cf25, v16[705];
			var v18: multiset<bool> := multiset{!f36, true, f36, v14.f38};
			v18 := v18;
			globalState.f5 := (("oevkynl")[fm33(|v16[705]|, (multiset{v14.f39})[true := |v15|], f36, multiset{p0}, globalState) := 'w'] + (if (fm2(globalState)) then "rabcpcr" else fm34(globalState)))[f23 := f37];
		}
		
		if (if (fm1(globalState) != f23) then f36 else f36) {
			var v19 := false;
			var v20: multiset<int> := multiset{f23, f23, p0, f23, 0x150};
			v19, globalState.f8 := (f36 <==> f36) || v19, |(v0 + v0)[|v0| / f23 := multiset{p0} > v20]|;
			v19 := !((-f23 != f23) && true);
			...
			v22 := v22[-p0 := |v23|];
			if (true) {
				var v24: array<D3> := new D3[29](i1 => DC10(|v21|, f23, v23[if (f23 in v22) then v22[f23] else p0]));
				var v25 := DC10(f23, p0, f23);
				v24[916] := if (true) then v25 else DC10(|v23|, |[f37, f37, f37, f37, f37]|, f23);
				v24[916] := if (v19) then v25 else v25;
				var v26: array<bool> := new bool[3];
				v26[160] := f36;
				v26[160] := !f36;
				var v28: map<int, map<int, int>> := map[|v21| := v22];
				var v29: map<int, bool> := map[p0 := f36];
				var v30: map<bool, map<int, bool>> := map[v26[160] := v29];
				var v31: set<bool> := {v26[160], v26[160]};
				var v33 := DC15();
				var v34: multiset<D6> := multiset{v33, v33, v33, v33, v33};
				var v35: multiset<bool> := multiset{v26[160]};
				var v36: seq<map<int, int>> := [v22, map[p0 := |v23[p0 := p0]|]];
				var v39: array<map<int, int>> := new map<int, int>[15] [map v27 : int | (0x84 <= v27) && (v27 < 580) :: (v27 * f23) := (p0), v22, if (f23 in v28) then v28[f23] else map[-|v30[v19 := v29]| := f23], if (v26[160]) then map[f23 := |v31|] else v22, v22, map v32 : int | (330 <= v32) && (v32 < 477) :: (v32 % DC3(p0, |v22|, -195, |DC12(v21).cf28|, v26[160]).cf7) := (f23), v22, v22, map[p0 := f23], map[|v34[v33 := if (v26[160] in v35) then v35[v26[160]] else p0]| := |{--v23[f23]}|], v22, v22, v36[258], (map v37 : int | v37 in v23 :: (v37 / f23) := (p0)) + (map v38 : int | (0xd1 <= v38) && (v38 < -592) :: (v38 - 421) := (f23)), v22];
				var v40 := DC9(!v26[160], f23, v26[160], v0, p0);
				v39, v26[160] := v39, !v40.cf19;
				v26[160] := f36;
				...
				v19, v19, v43, v19, v19 := v19, true, v48[p0], [f36] < ([false, !f36, f36] + v0), [p0, p0, fm1(globalState)] != (v23 + v23);
				var v49: array<seq<int>> := new seq<int>[17](i2 => v23);
				v49[109] := v23;
				v49[109] := [|v23|];
				var v50: multiset<bool> := multiset{v19};
				var v51: map<int, bool> := map[|map[f36 := f23]| / fm33(f23, v50, v19, v20, globalState) := v19];
				v51 := v51;
				v19 := v19;
			}
			...
			match (v55) {
				case DC5(cf11) =>
					...
					v59[437] := f36;
					v59[437] := fm2(globalState);
					var v60 := new C0(true, f36);
					globalState.f8 := (if (v60.f38) then f23 else cf11) + f23;
				case DC4(cf10) =>
					var v62: set<string> := {v53, v53, v53, v53};
					v52[187] := |(map[v53 := v52[187]] + (map v61 : string | v61 in v62 :: (v61) := (p0)))|;
					var v63: map<seq<int>, int> := map[cf10 := fm1(globalState)];
					var v64: map<bool, seq<int>> := map[fm2(globalState) := cf10];
					var v65: multiset<int> := multiset{f23, v52[187] / p0, if ((if (f36 in v64) then v64[f36] else cf10) in v63) then v63[if (f36 in v64) then v64[f36] else cf10] else -0xe8, f23};
					v65 := fm36(f23 / f23, v52[187], globalState);
					var v66: array<bool> := new bool[28];
					v66[612] := f36;
					v66[612] := f36;
					var v67 := DC21(!v66[612], p0, f37, v52[187], f36);
					globalState.f19, v66[612], globalState.f5 := v53, !v67.cf40, ("bjmljy")[-p0 := f37];
				case DC6(cf12) =>
					v52[187], v0 := p0, v0 + v0;
					var v68 := true;
					var v69: map<bool, bool> := map[f36 := f36];
					v68 := (f23 <= v52[187]) || (f23 != |v69[v68 := f36]|);
					v52 := v52;
					var v70: set<bool> := {f23 > v52[187], v68, v68, v68};
					v70 := v70;
			}
			...
			var v74: seq<int> := [p0, f23, v52[187]];
			v73 := v73[|v74| + f23 := v72];
			v52 := v52;
			...
			v52[187] := |v76| + (if (!f36 in v77) then v77[!f36] else v52[187]);
		}
		...
		if (!f36) {
			...
			if (f36) {
				var v81: seq<int> := [f23];
				var v82 := "x";
				var v83 := DC9(v81 == [p0], |v82[p0 := f37]|, v80, fm42(v80, v80, v80, v80, globalState), 0x12c);
				...
				var v86: array<int> := new int[2] [p0 / |v85|, f23];
				v86[142] := p0;
				var v87: seq<array<int>> := [v86, v86];
				v86[142] := |((v81 + v81) + [|v87|, p0, f23])|;
				v80 := v0[p0];
			} else {
				var v88 := new C0(v80, true);
				var v89: seq<int> := [-0x2ec];
				var v90 := DC4(v89);
				var v91: map<seq<int>, string> := map[v90.cf10 := seq(0x20, i4  => (f37))];
				v91 := v91;
				...
				var v100: array<char> := new char[23] [f37, fm0(globalState), if (v88.f38) then f37 else f37, f37, f37, f37, fm0(globalState), f37, f37, v94[0x3a9], if (f37 in v97) then v97[f37] else 'g', f37, f37, f37, if (|map[v99 := f23]| in v98) then v98[|map[v99 := f23]|] else 'l', f37, fm0(globalState), f37, f37, f37, f37, f37, f37];
				v100 := v100;
			}
			
			var v101: map<bool, bool> := map[v80 := v80];
			v101 := v101[false := f36];
			var v102: array<int> := new int[3](i5 => i5 % |DC30(v101).cf56|);
			v102[736] := -0x3b;
			v102[736] := p0 * f23;
		} else {
			var v103 := false;
			...
			var v104: seq<int> := [|(seq(-425, i6  => ([f23])))|];
			if (|v104| == (f23 * p0)) {
				...
				var v108 := DC16(f37);
				v107 := v107[v105 := |[v108, v108, v108]| % f23];
				...
				v113[970] := if (f36) then v111 else v111;
				v113[970] := v111;
			}
			
			var v114: map<bool, int> := map[v103 := p0 + p0];
			var v115 := "cjxliuwo";
			var v116: seq<string> := [v115, v115, v115, seq(601, i8  => ('u'))];
			var v117: map<string, bool> := map[v116[|v79|] := v103];
		...
		var v118 := true;
		var v119 := "wclhapb";
		var v120: array<int> := new int[5](i9 => i9 % |[f36]|);
		...
		var v124: array<int> := new int[20] [|("mkkiif" + v119)|, |(if (v120 in v121) then v121[v120] else v122)|, f23 * p0, f23, f23, |fm34(globalState)|, -p0 + p0, p0, f23, f23, p0, fm1(globalState) % -p0, p0, (if (p0 in v123) then v123[p0] else p0) % f23, |(seq(0x61, i10  => (p0)))|, if (p0 in v123) then v123[p0] else (fm43(!v118, v78, globalState)).cf37, p0, f23, p0 % |(seq(0x3ae, i11  => (p0)))|, f23];
		v120[285] := f23;
		var v125: map<int, bool> := map[f23 % f23 := f36];
		v118, v120[285], v125 := v118, p0, v125;
		globalState.f8 := -v120[285];
	}
}
...
class C2 extends T1 {
	...
	method m12(p0: array<int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		for i0 := f23 to v2[|f35|] {
			...
			var v5: set<int> := {i0};
			r1 := v5 >= (if (f35[f23]) then v5 else v5);
		}
		var v6 := DC2(f23);
		...
		for i1 := |(map[v9 := f23] + v10)| to f23 {
			...
			v11[457] := p3;
			var v12 := "mpibwh";
			globalState.f8 := |v12[|fm32(i1, globalState)| := 'r']|;
			var v13 := DC5(718);
			var v14: map<D2, bool> := map[v13 := p2];
			var v15: map<bool, bool> := map[v11[457] := !p2];
			var v16: seq<map<D2, bool>> := [v14, map[v13 := if (v11[457] in v15) then v15[v11[457]] else v11[457]], v14];
			var v17: multiset<bool> := multiset{p2, p3, fm16(-584, v16[f23], |multiset{p2}|, globalState)};
			v17 := v17;
			globalState.f5 := v12;
		}
		r2 := f23;
		...
		p1[947] := |((fm36(|v19|, f23, globalState) * v20) + fm36(f23, f23, globalState))|;
		if ((v19 + v19) == (v19 + v19)) {
			if (v18.f39) {
				var v21: seq<char> := [v0];
				...
				globalState.f8, p1[947], v24, v25, globalState.f8 := -0x30d % v30.cf47, -(f23 / f23) / f23, v24, (v25 + multiset(f35)) + v25, f23;
			...
			r1 := v33 <= (if (v36[f23] in v35) then v35[v36[f23]] else v33);
			globalState.f5 := "jalmgq";
			p1[947] := p1[947];
			r0 := p1;
		} else {
			var v37: map<int, bool> := map[231 := p3];
			v37 := v37[p1[947] := v18.f38];
			r1 := p3;
			...
			match (v39) {
				case DC25(cf44) =>
					...
					globalState.f8 := |(v2 + (seq(0x2e5, i4  => (|map[v19 := cf44]|))))|;
				...
				case DC26(cf45, cf46, cf47, cf48) =>
					...
					var v49 := DC10(cf47, |v19|, p1[947]);
					var v50 := "jtv";
					var v51: seq<string> := [v50[cf47 := v0]];
					...
					var v56: array<array<array<bool>>> := new array<array<bool>>[25] [v45, v45, v45, v45, v45, if (v18.f38) then v45 else v45, v46[|v48|], v45, v45, v45, v45, v45, v45, v45, v46[v49.cf24], if (v54[0x13d] in v52) then v52[v54[0x13d]] else v45, v45, v45, v45, v45, if (|f35| in v55) then v55[|f35|] else v45, v45, v45, v45, v45];
					v56[654] := v45;
					...
					v56[654], v57[800], v58[759], v60, p1[947] := v45, p2, v59, v60, |v61|;
					cf48, p1[947], cf46 := f23 % (cf47 * f23), -((cf47 % f23) + 0x13), cf46;
					var v62: map<bool, string> := map[v18.f38 := v50];
					p1[947], globalState.f5, globalState.f19, v57[800] := v2[p1[947]] * (cf47 + |v59|), v50, if (!(v57[800] || v18.f39) in v62) then v62[!(v57[800] || v18.f39)] else v50, f35[f23];
				case DC24(cf43) =>
					r1 := p3;
					var v63 := new C1(v18.f39 || v18.f39, v0, f23);
					var v64: map<bool, bool> := map[v18.f39 := p2];
					var v65 := DC20(v18.f39, seq(446, i5  => (f23)));
					...
					var v71: array<bool> := new bool[23] [p3, v18.f39, v18.f38, v18.f39, true, v18.f39, v18.f39, |v64| == p1[947], v18.f39, v18.f38, multiset{v66, v66, v66, v66, v66} >= v67, p1[947] == f23, f23 != -0xae, p2 <==> v63.f36, !false, v18.f39, false, v18.f39, fm16(f23, v70[p1[947]], p1[947], globalState), v63.f36, v18.f39, v18.f39 <==> p3, v18.f38];
					v66[948] := v18.f38;
					var v72: multiset<seq<int>> := multiset{seq(0xed, i6  => (p1[947]))};
					var v73: array<string> := new string[18](i7 => "iwjcrek");
					var v74 := "uuktkb";
					v73[175] := v74;
					var v75: seq<string> := [v74[0x155 := v63.f37], v74, v74 + "qkadsstuq", v74, v74 + "w"];
					r1, v66[948], v72, r1, v73[175] := v39.cf46, v18.f38, multiset{[0x2a6, 0x229], v2}, v63.f36, v75[p1[947]];
					var v76: multiset<bool> := multiset{p2};
					v66[948] := (v76 * v76) !! multiset(f35);
			}
			
			r1 := fm2(globalState);
			var v77 := DC5(p1[947]);
			var v78: map<D2, bool> := map[v77 := v18.f38];
			var v79: C0 := new C0(v18.f38, fm16(fm1(globalState), v78, p1[947], globalState));
			var v80 := DC35(v79);
			v79 := v80.cf64;
		}
	...
	method m13(p0: string, p1: set<int>, p2: array<int>, p3: bool, globalState: GlobalState) {
		...
		p2[396], globalState.f8, v0, globalState.f8, globalState.f8 := -(if (v2.(cf45 := v1) in v3) then v3[v2.(cf45 := v1)] else -386) * f23, (f23 % f23) % (|v4| % -f23), v0, |(fm36(|p0|, f23, globalState))[f23 := f23]| % f23, f23;
		var v5 := DC5(p2[396]);
		var v6: map<D2, bool> := map[v5 := p3];
		var i1 := 0;
		while (fm16(f23, map[v5 := p3] + v6[v5 := p3], p2[396] - p2[396], globalState))
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			if (false) {
				...
				var v11 := DC3(|(seq(-0x3e7, i2  => (v0)))|, if (f23 in v10) then v10[f23] else |p0|, -f23, 0x2d, p3);
				var v12 := new C0(v11.cf9, p3);
				var v13: map<bool, int> := map[!v12.f38 := p2[396]];
				var v14: array<map<bool, int>> := new map<bool, int>[7] [v13, v13 + map[p3 := f23], map[v12.f38 := f23] + v13, v13, map[v12.f39 := p2[396]], v13, map[v12.f38 := p2[396]] + v13];
				v14[148] := v13;
				globalState.f8, globalState.f8, v14[148] := p2[396], if (true in v13) then v13[true] else f23, v13 + v13;
				v13 := v13[p3 := p2[396]];
				var v15: seq<int> := [f23];
				var v16: multiset<bool> := multiset{false};
				var v17: map<bool, bool> := map[v12.f38 := v12.f39];
				var v18: map<int, map<bool, int>> := map[f23 := v14[148]];
				var v19: map<bool, map<bool, int>> := map[!!p3 := if (f23 in v18) then v18[f23] else v14[148]];
				var v20: map<int, int> := map[--f23 := f23];
				var v21: array<int> := new int[28] [p2[396], |fm44(p3, v12.f38, !v12.f39, p0, globalState)|, p2[396], |v15|, f23, f23, p2[396], 0xef, f23 / -0x4b, f23 - |p0|, p2[396] / p2[396], -f23, p2[396], p2[396], p2[396], f23, f23, 0x2ca, p2[396], v15[f23] * -|v16|, f23, |v17|, p2[396] * f23, p2[396], -|v19|, p2[396] % |v15|, if (|p0| in v20) then v20[|p0|] else |v13|, f23];
				p2[396], v21 := -v15[p2[396]], p2;
				var v22 := DC14(v16);
				v16 := v22.cf30;
			}
			...
			if (p3) {
				...
				v24 := v24[f23 := p2[396]];
				var v25 := false;
				v25 := p2[396] > (f23 * p2[396]);
				globalState.f8 := fm1(globalState);
				var v26 := new C0(f23 > f23, p3);
			} else {
				globalState.f8 := f23;
				var v27 := DC10(fm1(globalState), f23, f23);
				var v28: map<int, int> := map[f23 := |map[p3 := p2[396]]|];
				var v29: map<int, int> := map[f23 := |v28|];
				var v30: map<bool, int> := map[false := f23];
				var v31: array<D3> := new D3[19] [v27, v27, DC10(p2[396], p2[396], -0x345), v27.(cf25 := f23), v27, v27, v27, DC10(136, f23, p2[396]), fm45(p3, p2[396], globalState), v27, if (p3) then v27 else v27.(cf24 := f23).(cf26 := p2[396]), DC10(|p0|, 0x2d9, f23), v27, v27, v27, DC10(f23, if (|v30| in v28) then v28[|v30|] else p2[396], f23), v27.(cf25 := |f35|), v27, v27];
				v31[711] := v27;
				v31[711] := v27;
				globalState.f8 := -753 / 0x24b;
				var v32 := DC2(p2[396]);
				var v33: map<char, D1> := map[v0 := v32];
				var v34 := DC7(map[p2[396] := v33]);
				var v35: map<int, D3> := map[-(f23 / p2[396]) := v34];
				v35 := v35[if (p3 in v30) then v30[p3] else fm1(globalState) := v34];
				var v36: seq<int> := [|f35|];
				var v37: seq<seq<int>> := [v36];
				var v38: seq<seq<seq<int>>> := [[[p2[396]]], v37, v37];
				globalState.f19 := (p0 + "u") + fm30(|p0|, v38[p2[396]], p2[396], p3, globalState);
			}
			...
			if (!p3) {
				...
				var v43: array<D6> := new D6[22] [v41, v41, v41, v41, v41, v41, if (p3) then DC17(v40) else v41, v41, v41, v41, v41, v41.(cf32 := if (true in v42) then v42[true] else v40), v41, v41, v41, fm46(p2[396], p3, globalState), if (p3) then v41 else v41, v41, v41, DC17(DC16(v0)), v41, v41];
				var v44 := true;
				globalState.f8, globalState.f8, v43, v44 := (f23 % p2[396]) - 467, fm1(globalState), v43, v44 <==> (if (f23 in v23) then v23[f23] else v44);
				...
				v45, globalState.f8, v46[384], p2[396], globalState.f8 := v45 - {f35}, |p1|, fm31(globalState), 0x4d, |(v48[v47 := fm1(globalState)] + v48)|;
				...
				v46[384], globalState.f8, v53, v44, v54 := v0, v52, fm47(v54.f38, v44, f35, DC24(map[0x3c7 := |v55|]), globalState), p3, v54;
			} else {
				var v56 := true;
				var v57: multiset<bool> := multiset{v56};
				v56 := (if (if (p2[396] in v23) then v23[p2[396]] else v56) then v57 else multiset(f35)) >= multiset(f35 + [v56, p3]);
				globalState.f8 := 431;
				v56 := p3;
				var v58: map<bool, bool> := map[v56 := false];
				globalState.f8, globalState.f8, p2[396] := |v58| % f23, fm1(globalState), p2[396] + -p2[396];
				var v59: C1 := new C1(p3, v0, p2[396]);
				var v60: map<bool, C1> := map[v56 := v59];
				var v61: seq<int> := [0x3aa];
				var v62: seq<int> := [f23, |v23|, p2[396] % |v60|, -v61[f23]];
				v61 := v62;
			}
			
		}
		globalState.f8 := 0x77 - p2[396];
		var v63: array<int> := new int[27](i5 => i5 + p2[396]);
		forall i4 | 0 <= i4 < v63.Length {
			v63[i4] := i4 * f23;
		}
		if (p3) {
			var v64 := false;
			var v65: multiset<int> := multiset{p2[396]};
			v64 := v65 <= v65;
			var v66: seq<int> := [f23];
			var v67 := DC4(v66);
			var v68 := DC6(v67);
			...
			match (v71) {
				case DC13(cf29) =>
					globalState.f5 := if (p3) then p0 else seq(0xe7, i6  => (v0));
					...
					v64 := if ((p2[396] / |v75|) in v74) then v74[p2[396] / |v75|] else false;
			}
			
			if (v64) {
				globalState.f8 := p2[396] * |f35|;
				var v76: array<char> := new char[12](i7 => v0);
				v76[18] := v0;
				v76[18] := v0;
				var v77: map<bool, map<bool, int>> := map[v64 := map[p3 := f23]];
				p2[396] := if (p3) then p2[396] else |v77|;
				...
				v83 := v83[-p2[396] := v64 || v64];
				var v84: seq<set<bool>> := [v4];
				var v85: map<bool, set<bool>> := map[v64 := v4 * v84[0x191]];
				v85 := v85[v65 !! v65 := v4];
				p2[396] := -p2[396];
				p2[396] := (p2[396] * f23) * v66[f23];
				p2[396] := (if (p3) then f23 else p2[396]) % -(f23 * 763);
			}
			...
			if (v64) {
				...
				v64, globalState.f5, v88, globalState.f8, v90 := p3, p0, v91[p2[396]], |p0|, v90;
				f35 := (([p3, true])[p2[396] := v64] + [v90.f39, v90.f38, p3]) + f35;
				...
				v93[995] := DC39(v94).cf70;
				v93[995] := new string[3];
				v64 := p3;
			...
			v98 := p3;
			p2[396] := f23 % p2[396];
			var v99: C1 := new C1({v98, v98, f35[f23]} >= {v98, v98}, v0, p2[396]);
			v99 := v99;
			var v100, v101 := v99.m5(if (f35[p2[396]]) then 0x22f else 83, 'l', globalState);
			globalState.f8 := p2[396];
		}
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		var v13: array<int> := new int[29] [f23, f23, |(if (v0) then v1 else v1)|, f23, f23, |v3|, 0x1a, p0, |((set v4 : int | v4 in {741} :: (v4 - 0xe2)) + v5)|, |v7|, p0, v8.cf6, p0, --0x28a, p0, 0x2e8, f23, p0 / |v9|, |v10|, |v12|, f23, if (true) then f23 else f23, -p0, f23 - -752, 0xe7, f23, f23, |(seq(-0x278, i0  => (p1)))|, f23];
			...
			decreases 100 - i1
		{
			...
			var v19: map<bool, string> := map[false := seq(799, i4  => (v15[925]))];
			var v20: array<string> := new string[24] [v9, v9, "k", v9, "ll", v9, v9, (seq(0x8e, i2  => (p1)))[f23 := v15[925]], v9, v9, v9, v9, v9, seq(0x199, i3  => (v15[925])), v9[p0 := if (v14.f38 in v18) then v18[v14.f38] else p1] + v9, v9 + v9, "ujbwlqb" + v9, v9 + v9, v9, v9 + v9, v9, "nj", v9, if (v0 in v19) then v19[v0] else v9];
			v20[217] := if (v14.f39) then v9 else (seq(-0x79, i5  => (p1)))[p0 := p1];
			...
			v20[217], v2, v21[86], v23 := "hhogjecg", v2[|v23| := p0], v22 + multiset{v11, v11, v11}, multiset{v14.f38};
		}
		for i6 := |v1| to p0 {
			v0 := v0;
			v0 := v0;
			...
			match (v24) {
				...
				case DC20(cf34, cf35) =>
					...
					v13[790] := -|(v7 + v29[0x189])|;
					v13[790] := (i6 - -0x206) + 0x6f;
				...
				case DC22(cf41) =>
					...
					globalState.f19 := seq(0x193, i7  => (p1));
					globalState.f8 := p0;
					v0 := v14.f38;
			}
		...
		if (f23 <= -(p0 * 0x344)) {
			...
			v34[354] := v5;
			v34[354] := fm49(f23, p0, globalState);
			v13[977] := p0;
			var v35: map<int, int> := map[f23 := |v9|];
			var v36 := DC5(|v6|);
			v2, v13[977] := [|v35|, p0, p0] + (seq(0x1b2, i9  => (p0))), if (v11 in v12) then v12[v11] else |multiset{fm16(f23, map[v36 := v14.f38], p0, globalState)}|;
			...
			var v39: map<string, array<seq<bool>>> := map[seq(0x18a, i10  => (p1)) := v38];
			v39 := v39[v9[-p0 := p1] + v9 := v38];
			if (v14.f38) {
				...
				var v44, v45, v46 := v40.m6('e', v42 > v42, v9, if (v13[977] in v43) then v43[v13[977]] else v40.f37, globalState);
				globalState.f8 := |f35| % |(v9 + v9)|;
			} else {
				var v47: multiset<bool> := multiset{v14.f39, v14.f39};
				v47 := v47;
				var v48: array<int> := new int[9](i11 => i11 / v13[977]);
				...
				r1 := if (v14.f39 in v47) then v47[v14.f39] else f23 % v13[977];
			}
			...
			if (fm2(globalState)) {
				...
				v0 := v5 !! v5;
				var v57: map<string, bool> := map[v9 + v9 := v9 < (seq(0x15d, i13  => (p1)))];
				var v58: multiset<bool> := multiset{v0, v14.f38};
				v57 := v57[fm34(globalState) := v2[p0] < |v58|];
				v0 := v9 < v9;
				var v59 := new C1(f35[f23], p1, p0);
			} else {
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		var i0 := 0;
		while (f35[-(if (p1) then --f23 else -f23)])
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v3: seq<int> := [f23, f23 % -f23];
			r1, globalState.f8 := (f23 - |v1|) != (if (p2 in v2) then v2[p2] else f23), v3[f23];
			...
			var v9 := DC30(v8);
			var v10: seq<D11> := [v9];
			var v11: array<int> := new int[27] [f23, -f23, f23, |"dg"|, f23, f23, f23, f23, f23, f23, |v3|, f23, f23, |v6|, |(map v7 : D11 | v7 in v10 :: (v7) := (p0))|, f23, f23, f23, v3[0x9b], |v3|, f23, f23, f23, f23, f23, f23, |p2|];
			v5[900] := v11;
			var v12: map<bool, array<int>> := map[v0.f38 := v11];
			globalState.f8, v4[280], r1, v5[900] := -124, v5, p1, if (false in v12) then v12[false] else v11;
			var v13: array<bool> := new bool[19];
			v13[122] := v0.f38;
			v13[122] := |map[v13 := p1]| != f23;
		}
		r2 := f23;
...
class C3 {
	...
	method m18(globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
			...
			decreases 100 - i0
		{
			...
			if ((if (f33) then if (f33 in v6) then v6[f33] else |multiset(v7)| else v2) != (v2 + -v2)) {
				...
				var v11: map<bool, char> := map[v10[v2] := v8];
				v9, f33, globalState.f19 := fm29(f33, v2, f34 ==> true, false, globalState), (if (true) then v2 else |v3|) < v2, ("xe")[v2 - v2 := if (f34 in v11) then v11[f34] else v8];
				var v12 := DC0(v8, f34, v8);
				f33 := v12.cf1;
				var v13: array<bool> := new bool[2](i1 => f33);
				v13[488] := fm2(globalState);
				var v14: array<set<string>> := new set<string>[7];
				var v15: set<string> := {v0[|[f34]| := v8], v0, v0};
				v14[130] := v15;
				v1[662] := v2;
				v13[488], v14[130], globalState.f8, f33, v1[662] := (-v2 + v7[v2]) > v2, if ((seq(-496, i2  => (v8))) <= v0) then v15 else {v0, v0}, v2, f33, -fm1(globalState);
				var v16: map<array<bool>, int> := map[v13 := v1[662]];
				v16 := v16[v13 := 157];
				...
				v20 := v20;
				f33 := v19[260] || (if (f33) then !f34 else v19[260]);
		...
		v23 := v0[if (f33) then |v25| else v24];
		v0 := seq(0x396, i4  => (v23));
		var v26: seq<int> := [v24];
		var v27 := DC4(v26);
		...
		if (match v32 {
			...
			f33, v33[141], f33, v33[176] := fm2(globalState), v24 / v24, f34, |v34|;
			globalState.f8 := v26[v26[v33[141]]];
			var v35 := new C1(f33, v23, v33[141]);
			if (f34) {
				var v36 := DC0(v35.f37, fm2(globalState), v35.f37);
				var v37: array<char> := new char[24] [v35.f37, v35.f37, v35.f37, if (!v34[0x61]) then v35.f37 else v23, if (v35.f36) then v35.f37 else v35.f37, 't', v35.f37, v35.f37, v23, v35.f37, fm0(globalState), v35.f37, v0[v33[141]], fm0(globalState), v35.f37, v36.cf0, v35.f37, v35.f37, 'w', 'k', v35.f37, v35.f37, v23, v35.f37];
				v37[118] := v35.f37;
				var v38: map<string, char> := map[v0 := v35.f37];
				v37[118] := if (v0 in v38) then v38[v0] else v23;
				f33 := f34;
				f33 := true;
				var v39: array<bool> := new bool[14];
				var v40: map<map<D10, int>, array<bool>> := map[map[DC28(f34, v33[141], v24, f33, v26[v24]) := v24] := v39];
				var v41 := DC28(true, v24, 0xc1, f33, v24);
				var v42: map<D10, int> := map[v41 := v35.fm33(0x11, v31, f34, multiset{v33[141]}, globalState)];
				v40 := (v40 + v40) + map[v42 := v39];
				var v43: array<map<D9, string>> := new map<D9, string>[13];
				var v44 := DC16(v23);
				var v45: array<D6> := new D6[13] [v44, v44.(cf31 := v35.f37), DC16(v37[118]), v44, v44, v44, v44, v44, v44, v44, v44, v44, v44];
				...
				var v51: map<bool, string> := map[v49[683] := v0 + v0];
				var v52 := DC42(v51);
				v51 := v52.cf74;
			}
			...
			var v55: map<int, D15> := map[v24 % fm1(globalState) := if (f33) then v54.(cf75 := v0, cf79 := 'x') else v54];
			r2 := |v55|;
			var v56: array<bool> := new bool[4];
			v56[843] := f34;
			v56[843] := f33;
			var v57: set<bool> := {f33};
			var v58 := DC8(v24, if (v24 in v25) then v25[v24] else f33, v56[843], fm1(globalState), v24);
	...
	method m19(p0: char, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			match (DC7(v5)) {
				case DC8(cf14, cf15, cf16, cf17, cf18) =>
					var v6: seq<bool> := [f33];
					var v7 := new C0(v6[cf17], f34);
					var v8: array<bool> := new bool[28];
					var v9: array<D4> := new D4[8](i1 => DC12(seq(959, i2  => (p0))));
					var v10: map<array<D4>, array<bool>> := map[v9 := v8];
					v8 := if (v9 in v10) then v10[v9] else v8;
					v8[105] := cf16;
					v8[105] := v7.f38;
					var v11: map<int, char> := map[-0x35e / 647 := 'c'];
					v11 := v11[v2 + v2 := p0];
				case DC9(cf19, cf20, cf21, cf22, cf23) =>
					cf23 := cf20;
					f33 := f33;
					var v12: array<int> := new int[19](i3 => i3 % v2);
					v12[419] := v2;
					var v13: array<bool> := new bool[2](i4 => false);
					var v14 := "qr";
					var v15: map<char, array<bool>> := map['o' := v13];
					v12[419], f33, v13, globalState.f8 := |[|v14| != v2]|, f33 && cf21, if (p0 in v15) then v15[p0] else v13, v2;
					...
					v16 := v16[!(cf20 >= cf23) := if (|v18[v2]| in v17) then v17[|v18[v2]|] else |v19|];
				...
				case DC7(cf13) =>
					...
					v27, v28, f33, r0 := v27, v28, fm2(globalState), (v29 + (if (v2 in v32) then v32[v2] else v29)) <= (v29 + v29)[fm1(globalState) := v2];
					var v33 := "w";
					var v34: map<string, bool> := map[(v33 + v33)[v2 := 'j'] := if (f33) then f34 else false];
					v34 := v34["ngdx" := f34];
		...
		f33, f33, globalState.f8, v56, v59 := v56.f36, v55 !in (v60 + v60)[v55 := -v55], fm1(globalState), if ((f34 <==> f34) in v61) then v61[f34 <==> f34] else v56, v59;
		...
		v55 := if (f34) then if (v62 in v65) then v65[v62] else v60[|v66|] else v55 - -v55;
...
class C4 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
			...
			decreases 100 - i0
		{
			...
			if (f32) {
				...
				var v5 := "jxljigp";
				var v6: array<int> := new int[13] [p0, 0x2c3 % (if (f32 in v0) then v0[f32] else p0), f23, p0, f23, f23, p0, |(v4 + v4)|, |v4|, f23, 0x188, p0, |(v5 + v5)|];
				v6[348] := f23;
				v6[348] := p0;
				var v7 := false;
				var v8: seq<bool> := [true];
				v7, globalState.f5, v7, v7, globalState.f5 := !(|v4| !in v4), v5, !(|v8| > (f23 % -18)), v8[fm1(globalState)], v5 + ("ycu" + "h");
				globalState.f8 := p0 / (p0 * f23);
				v7 := f32;
				var v9 := DC4(v4);
				var v10 := DC6(v9);
				var v11 := 'i';
				...
				v12[845] := DC5(v6[348]);
				var v13 := DC5(v6[348]);
				v7, v10, v11, globalState.f8, v12[845] := v7, v10, if (v7) then v11 else p1, -f23, if (v7) then v13 else fm28(globalState);
			} else {
				...
				var v18 := new C2(fm42(f32, f32, true, v15[f23], globalState), p0);
				...
				v22[144] := f23;
				v22[144] := if (false) then p0 else p0;
			}
			...
			var v41: map<int, bool> := map[|(if (fm2(globalState)) then v40[p0 := f23] else v40)| := v23];
			v41 := v41 + map[f23 := v23];
		...
		globalState.f5 := (v47[p0] + (seq(0x3c3, i4  => (p1)))) + "als";
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		if (p1 || v0.f33) {
			...
			if (p3 !in (map v1 : char | v1 in (map v2 : char | v2 in map[p0 := |v3|] :: (v2) := (f23)) :: (v1) := (v0.f34))) {
				...
				globalState.f8, v4, r2, v0.f33, v7[680] := --((-f23 / |p2|) % (f23 % fm26(globalState))), p3, f23, v8[-f23 % f23], p1 <== true;
				v0 := v0;
				r1 := v0.f34;
				globalState.f8 := f23 / (f23 + f23);
				v7[680] := p1;
			} else {
				...
				var v13: array<int> := new int[8] [f23, f23, f23, fm1(globalState), f23, |v11|, v3[v3[|v12|]], f23];
				globalState.f8, r0 := fm26(globalState), v13;
				var v14: map<bool, int> := map[p1 := f23];
				v14 := v14[f23 <= f23 := f23 / 0x3a];
			}
			
			var v15: seq<bool> := [v0.f34];
			var v16: C2 := new C2(v15, |(seq(-732, i0  => (p3)))|);
			var v17: set<C2> := {v16};
			var v18: seq<bool> := [v16 !in v17];
			var v19: seq<seq<bool>> := [v18[-f23 := p1]];
			v18 := v19[107];
			var v20 := DC15();
			var v21: set<int> := {f23, f23};
			v20, v3, v0.f33 := if (f32) then fm52(v0.f33, f23, globalState) else v20, v3[f23 := f23], f23 in (v21 - v21);
			if (v0.f34) {
				...
				var v27: map<int, int> := map[fm26(globalState) * fm1(globalState) := f23 % fm27(v26, v22, p2, p2[f23 := p0], globalState)];
				...
				var v50: map<bool, bool> := map[p3 in p2 := v47 >= {v45, v45, v45, v45, v48[|v49|]}];
			...
			if (f32) {
				...
				var v65: map<int, int> := map[|v63[f23 := |v64|]| := |map[p1 := v0.f33]|];
				var v66: seq<int> := [f23, f23, |v65|];
				var v67: set<int> := {f23, |v66|};
				var v69: seq<set<int>> := [v67];
				var v70: seq<string> := [p2];
				var v71: array<set<int>> := new set<int>[26] [v67, v67, v67, (set v68 : int | (0x1b7 <= v68) && (v68 < 0x21) :: (v68 * |map[true := v67]|)) - {f23}, v67, {278, f23}, v67, v67, v67 - v67, v67 + {f23}, v67 + v67, v67, v67, v67, v67 * {f23, f23, f23}, v67 - v67, {f23}, v67, v67, v67, v67, v67, v67, v69[-257], {f23}, {|v70|, f23, 879, f23}];
				v71[658] := v67;
				v71[658] := v67 + v67;
				...
				var v80 := DC46(v77);
				var v81: array<array<bool>> := new array<bool>[25] [v77, v77, v77, v77, v77, v77, v77, v77, v77, if (v0.f34) then v77 else v77, v77, v77, v78[|v79[f23 := v0.f33]|], v77, v77, v77, v77, v77, if (v0.f33) then v80.cf83 else v77, v77, v77, v77, v77, v77, v77];
				v81[852] := v77;
				v81[852] := v77;
				r1 := fm2(globalState);
				globalState.f8 := -0x13c + (f23 + -f23);
				var v82 := DC10(|"g"|, f23, f23);
				var v83: map<int, array<bool>> := map[f23 := v81[852]];
				var v84 := DC5(f23);
				var v85: array<int> := new int[25] [0x376, f23, f23, f23, f23 / f23, |((seq(0x2bf, i4  => (p0))) + [v62, v62, 'c'])|, f23 - |fm53(v0.f33, p1, f32, globalState)|, f23, -f23, f23, 0x3b4, if (v0.f33) then |[p3]| else f23, f23, f23, f23, v82.cf25, if (v0.f33) then f23 else fm1(globalState), |v83[f23 := v81[852]]|, f23, f23, v84.cf11, f23, f23, f23, -f23];
				var v86: set<bool> := {false, v0.f34};
				v85[979] := |v86|;
				var v87: seq<int> := [f23 * 0x9b];
				v85[979] := v87[f23];
				var v88: multiset<int> := multiset{|v79|};
				v88 := multiset((seq(215, i5  => (v85[979]))) + (seq(0x373, i6  => (v85[979]))));
			}
			
			var v89: seq<bool> := [v0.f33];
			var v90 := new C1(v89[f23], p3, f23 - 0x95);
		...
		for i7 := f23 to -|v94| / f23 {
			...
			v103, v103, r1 := p0, v104.cf31, {-f23} !! (v105 + {-f23, -(if ((seq(333, i8  => (p0))) in v106) then v106[seq(333, i8  => (p0))] else f23)});
		}
		...
		var v108 := DC21(if (v0.f33 in v107) then v107[v0.f33] else f32, f23, p2[476], f23, f32);
		r2 := match v108 {
			case DC19() => f23 / f23
			case DC20(cf34, cf35) => -f23
			case DC21(cf36, cf37, cf38, cf39, cf40) => f23
			case DC18(cf33) => -f23 / 0x30
	...
	method m16(globalState: GlobalState) returns (r0: bool, r1: seq<bool>, r2: char, r3: string) {
		for i0 := fm1(globalState) to f23 * f23 {
			...
			var v7: seq<int> := [f23, -i0 / v1.f23, if (|v6[f23]| in v5) then v5[|v6[f23]|] else f23, if (false) then i0 else |v3|];
			globalState.f8 := v7[|(if (f32) then v3 else v3)|];
		}
		...
		var v9 := "wfmvkk";
		var v10 := new C0(-|v9| != |(seq(-0x205, i3  => ('j')))|, !f32);
		...
		var v15: seq<multiset<int>> := [fm36(|v11|, f23, globalState), multiset{|v13|} - v14[f23 := f23]];
		r0, v15 := v10.f38, v15[f23 / f23 := v14 * multiset{f23, f23, fm1(globalState)}];
		var i4 := 0;
		while (!v10.f39)
			decreases 100 - i4
		{
			...
			v16[491] := if (752 in v14) then v14[752] else f23;
			v16[491] := f23;
			var v17: multiset<bool> := multiset{v10.f39};
			v17 := v17;
			var v18: seq<int> := [v16[491], f23];
			globalState.f8 := fm1(globalState) + v18[v16[491]];
			v16[491] := v16[491];
		}
		var v19: array<seq<bool>> := new seq<bool>[19](i5 => [v10.f39, v10.f39] + ([v10.f39])[|v9| := v10.f38]);
	...
	method m17(p0: D0, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		match (v7) {
			case DC19() =>
				globalState.f8 := (f23 * --0x44) - (951 / f23);
				var v8 := 'w';
				var v9: map<int, set<char>> := map[|v3| := {v8}];
				v9 := v9[|(map v10 : int | (0xe <= v10) && (v10 < 0x31b) :: (v10 - |(seq(728, i1  => (v8)))|) := (|(seq(0x129, i2  => ('o')))|))| := {v8} - {v8}];
				var v11 := false;
				v11 := f32;
				v3 := v3[f23 := f23];
			case DC20(cf34, cf35) =>
				...
				match (v15) {
					case DC47(cf84, cf85, cf86, cf87, cf88) =>
						...
						v19 := v19;
						var v20: multiset<string> := multiset{seq(0x22f, i4  => ('d'))};
				...
				if (fm2(globalState) <==> cf34) {
					...
					v36, v14[254] := DC36(v35, cf34), v13.f36;
					v14[254] := true;
				}
			...
			case DC21(cf36, cf37, cf38, cf39, cf40) =>
				...
				if (fm2(globalState)) {
					...
					v45[999] := multiset(seq(421, i5  => (DC9(cf40, cf37, f32, [f32, cf40], cf37).cf20))) >= v46;
					v45[999], globalState.f5, cf37, r0 := cf36, v38, cf39, cf37 + |v38|;
					var v47: map<array<int>, bool> := map[v2 := v45[999]];
					var v48: map<int, map<array<int>, bool>> := map[cf39 := v47];
					var v49: seq<bool> := [cf40, v45[999]];
					v48 := v48[-cf37 * |v49| := v47];
					var v50: set<bool> := {cf36, fm2(globalState)};
					var v51: seq<set<bool>> := [v50];
					var v52: map<array<int>, set<bool>> := map[v2 := v51[cf37]];
					...
					v45[999] := cf36;
					var v54: map<bool, int> := map[v45[999] := f23];
					...
					var v62: map<array<int>, seq<int>> := map[v2 := if (cf40) then seq(-0x84, i7  => (-460)) else v3];
					cf39, v56, r0, v58[346], v59 := (|v60| + cf37) + (cf39 / cf37), (set v61 : char | v61 in v56 :: (v61)) - v56, -|(if (v2 in v62) then v62[v2] else v3)|, v57, v59;
					cf40 := cf38 !in v38;
			...
			case DC22(cf41) =>
				if (f32) {
					...
					v71[334] := v73;
					v71[334] := DC11(v72);
					v70[554] := fm2(globalState);
					v70[554] := (f23 % f23) == 0x370;
				} else {
					...
					var v82: multiset<string> := multiset{v75, v75, v75, v75, ("ykekbv")[|v81| := v77]};
					v74[652] := if (f32) then v82 else multiset{v75, v75};
					v74[652] := ((multiset{v75})[v75 := |v1|] - v82)["rndb" := f23];
					var v83: seq<string> := [v75];
					v82 := multiset(v83 + v83[f23 := v75]);
					var v84 := true;
					v84 := v84;
				...
				if ((|v87| - f23) >= f23) {
					...
					v3, r1, r1, globalState.f8 := v3, --(|v90| % (0x363 / f23)), 691, (f23 / 0x66) / fm1(globalState);
					globalState.f8 := f23;
					var v91 := 'a';
					...
					v95, v96, r1, v2[104] := v98.cf90, f32, (f23 % (if (f23 in v99) then v99[f23] else |v4|)) - (0xfe - f23), |(if (v96) then v3 else fm32(f23, globalState) + (seq(0x34e, i9  => (|map[|v87| := |v87|]|))))[f23 := 482]|;
					globalState.f8 := v2[104];
					v99 := v99[f23 := f23];
					var v100: array<string> := new string[17];
					v100[846] := seq(0x32f, i10  => (v94));
					v100[846] := ((seq(-0x15c, i11  => ('m'))) + (seq(644, i12  => (v0[164])))) + ((seq(0x1dc, i13  => (v94))) + (seq(350, i14  => (v94))));
				}
...
class C5 extends T1 {
	...
	function fm16(p0: int, p1: map<D2, bool>, p2: int, globalState: GlobalState): bool {
		DC3(|[true, false]|, f31, f23, f23, false).cf8 < (0x166 % DC8(-f23, true, !false, |multiset([f31])|, f23).cf18)
	}
	function fm23(p0: string, p1: bool, p2: seq<int>, p3: int, globalState: GlobalState): bool {
		multiset{"ayrttp", seq(113, i0  => ('b')), "wwr"} >= multiset{"ayvthq", "qo", "qli"}
	}
	...
	method m12(p0: array<int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		for i0 := f23 to f31 {
			...
			var v1 := "bssx";
			v0[60] := v1 + v1;
			v0[60] := fm25(i0, i0, globalState) + (if (p3) then "ub" else v1);
			r1 := p2;
			...
			decreases 100 - i2
		{
			...
			if (true) {
				...
				var v10: set<multiset<int>> := {multiset{|(seq(0x106, i3  => (map[f31 := f31])))|}, multiset{|v9|, 0x143}};
				var v11: multiset<bool> := multiset{!v6.f39};
				var v12: array<bool> := new bool[16] [{v8} > v10, v6.f39, v6.f38, v6.f39, p3, v6.f39 !in v11, v6.f38 <==> v6.f38, p3, if (v6.f38) then v6.f38 else v6.f38, v6.f39 && v6.f38, v6.f39, v6.f38, f31 !in multiset{|v3[f31 := v4]|}, p3, v6.f39, v6.f38];
				v12[290] := v6.f38;
				p0[28] := f31;
				v12[918] := p2;
				var v13: multiset<char> := multiset{v4, v4, 'u'};
				var v14: map<string, multiset<char>> := map[v3 := v13];
				v12[290], p0[28], v12[918], v3 := v6.f39, f31, "kejksdqo" in (set v15 : string | v15 in v14 :: (v15)), v3;
				var v16: array<multiset<bool>> := new multiset<bool>[7];
				v16[670] := v11 + multiset{v6.f38};
				var v17: array<array<seq<bool>>> := new array<seq<bool>>[23];
				var v18: array<seq<bool>> := new seq<bool>[21](i4 => v7);
				v17[642] := v18;
				var v19: map<int, array<seq<bool>>> := map[p0[28] := v18];
				var v20: map<bool, map<int, bool>> := map[!v6.f39 := v9];
				globalState.f8, v16[670], globalState.f19, r1, v17[642] := -f31 * f23, v11, seq(535, i5  => (v4)), p3, if (f23 in v19) then v19[f23] else if (|v20| in v19) then v19[|v20|] else v18;
				var v21: map<bool, int> := map[v12[290] := f31];
				var v22: seq<map<bool, int>> := [v21];
				var v23: multiset<map<bool, int>> := multiset{v22[p0[28]]};
				r1 := if (v23 !! v23) then v12[290] ==> v6.f39 else v6.f38;
				var v24: array<seq<array<char>>> := new seq<array<char>>[11];
				var v25: map<bool, bool> := map[v6.f39 := v6.f38];
				var v26: seq<int> := [f23];
				var v27: array<char> := new char[29] [v4, v4, 'w', v4, v4, v4, v4, v4, fm15(v4, globalState), fm0(globalState), v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v3[|v25[v6.f38 := fm23(v3[p0[28] := 't'], v6.f39, v26, p0[28], globalState)]|], v4, v4];
				v24[549] := [v27];
				var v28: seq<array<char>> := [v27, v27];
				var v29: seq<array<char>> := [v27, v27, v28[p0[28]], v27];
				v24[549] := v28;
				v12[290] := if (v6.f39) then v6.f39 else v6.f39;
			} else {
				...
				v31[203] := v6.f39;
				var v32: seq<int> := [f31];
				v30, p1[797], v7, v31[203] := v30, f23 * f31, if (v6.f39) then v7 else v7, v32 == v32;
				...
				v33[637] := if (false) then map[v34 := f23] else v35;
				var v36: map<int, int> := map[-0x3ad := f31];
				v33[637] := fm57(v36, p1[797] % f31, globalState);
				var v37: multiset<int> := multiset{p1[797]};
				var v38 := DC4([|v3|, |v37|]);
			...
			match (v44) {
				case DC31() =>
					...
					v45 := v46[v47[f31]];
					r1 := (if (p3) then f31 else f23) <= |(if (true) then ("a")[f31 := v4] else seq(-0x8c, i7  => (v4)))|;
					var v49: set<int> := {f31 / 0x161, f23, f23};
					v49 := v49;
				...
				case DC30(cf56) =>
					...
					p1[677] := f31;
					p1[677], r2 := f31 % (if (p3) then f23 else f23), -557;
					globalState.f8 := p1[677];
			}
		...
		var v58: array<set<int>> := new set<int>[26] [v52, v52, if (f23 in v53) then v53[f23] else v52, {f23, f23}, v52, v52, v52, fm49(0xd4, f23, globalState), v52, if (p3) then v52 else v52, {f31}, {if (f31 in v54) then v54[f31] else f23}, v52, (set v55 : int | (131 <= v55) && (v55 < -0x2c9) :: (v55 / 0x49)) + v56[-f31], v52 * v52, {f31}, v52, {f23, f23, f23}, v52, v52, v52 * fm49(f23, f23, globalState), v52, {f23}, v52, fm49(f23, f23, globalState), {|v57|}];
		v58[259] := fm49(|v3|, f23, globalState);
		var v59: multiset<bool> := multiset{true, v6.f39, v6.f39};
		var v60: seq<int> := [0x3e2, |v59|];
		v51, v58[259], r1 := v51 * v51, set v61 : int | v61 in v60[f31 := f23] :: (v61 / (|multiset{0x2c6, |[true]|, |(map v62 : D16 | v62 in map[DC44(map[false := 't']) := multiset{-0x3ce}] :: (v62) := (|"uggspksd"|))|, 0x2a2}| * 0x17c)), p3;
		...
		if (!false) {
			...
			var v65: set<bool> := {v6.f38, if (p2 in v64) then v64[p2] else v63[308], false};
			...
			var v69 := DC30(v68);
			var v70: array<D11> := new D11[12] [v69, v69.(cf56 := v68), v69, fm58(seq(0x270, i8  => (v4)), globalState), v69, v69, v69, fm58(v3, globalState), v69, v69, v69.(cf56 := v68), DC30(map[v6.f38 := v6.f39])];
			...
			var v75: map<int, array<bool>> := map[|v74[f31 := v73]| := v63];
			p0[599] := |(v75 + v75)|;
			var v76 := DC8(-f23, !v6.f38, v63[308], f23, f31);
			r1, p0[599] := v6.f38, v76.cf18;
			r1 := v6.f38;
			var v77: map<array<bool>, bool> := map[v63 := v6.f39];
			v77, globalState.f8, globalState.f8, globalState.f5 := v77 + (v77 + map[v63 := v6.f39]), -(f31 * -(|v68| + -p0[599])), -f23, v3;
			v63[308] := if ((p0[599] % -0x1d4) in v57) then v57[p0[599] % -0x1d4] else p2 || p2;
		}
	...
	method m13(p0: string, p1: set<int>, p2: array<int>, p3: bool, globalState: GlobalState) {
		...
		var v3 := DC27(v2);
		var v4: multiset<bool> := multiset{p3, v1[0x2e7]};
		v3, v4, globalState.f8 := if (p3) then DC27(v2) else v3, fm38(f31, !p3, p3, p2[531] * f23, globalState), p2[531];
		if (!!(-(f23 + -0x21b) > f23)) {
			if (p3) {
				var v5 := new C3(fm24(p3, p0, p3, globalState), v4 > multiset([p3]));
				v5.f33, v5.f33 := !!v5.f33, v5.f33;
				var v6: map<int, bool> := map[p2[531] := fm2(globalState)];
				var v7: map<map<int, bool>, int> := map[v6 := if (v5.f34) then f31 else p2[531]];
				v7, globalState.f8, globalState.f8, v5.f33, v5.f33 := v7, -(|map[p3 := p2[531]]| % (fm1(globalState) + f23)), fm1(globalState), v5.f33, v5.f34;
				var v8: multiset<seq<bool>> := multiset{v1[f31 := v5.f33], v1};
				v5.f33 := -|v8| < f31;
				var v9 := 'd';
				var v10: multiset<char> := multiset{v9, 'v'};
				var v11: seq<multiset<char>> := [v10];
				var v12: map<multiset<char>, array<int>> := map[v11[-p2[531]] := p2];
				...
				v15[203] := p3;
				v15[203], globalState.f8 := p3, p2[531];
				var v16: map<int, int> := map[f31 := f23];
				var v17: map<int, map<int, int>> := map[p2[531] := v16];
				var v18: set<string> := {fm34(globalState)};
				v17 := fm59(p3, DC30(v0), -p2[531], v18, globalState) + (map v19 : int | (100 <= v19) && (v19 < 0x16f) :: (v19 % f31) := (map[|v1| := |p0|]));
				v15 := new bool[17];
				var v20: map<int, bool> := map[p2[531] := p3];
				v20 := v20[|fm60(globalState)| := if (false in v0) then v0[false] else v15[203]];
				var v21: multiset<seq<char>> := multiset{p0};
				var v22 := new C0(p3 <== p3, v21 >= v21);
			}
			
			p2[531] := |(seq(0x53, i1  => (multiset(v1))))|;
			...
			v25 := v25[v24.f38 := p2[531]];
			match (fm61(globalState)) {
				case DC0(cf0, cf1, cf2) =>
					p2[531] := p2[531];
					var v26: multiset<char> := multiset{cf2};
					var v27: array<int> := new int[22] [p2[531] + f23, -fm1(globalState), p2[531], f31, p2[531], f31, f31, -(f31 + p2[531]), -0x1fe, |(v25 + v25)|, p2[531], f23, f31, f31, f23, p2[531], f31 % p2[531], -fm1(globalState), f31 + |v1|, |v26|, f31, p2[531]];
					v27 := new int[1];
					var v28: multiset<int> := multiset{f31};
					p2[531] := if (false) then -(if (f23 in v28) then v28[f23] else |v4|) else -(f23 / |{f23}|);
				...
				case DC1(cf3) =>
					...
					var v37: array<bool> := new bool[26] [v24.f39, !v33.f32, v36.cf50, v24.f38, fm24(v24.f39, p0, v24.f39, globalState), p3, v24.f39, v24.f38, v33.f32, false, v24.f38, v24.f38, true, v24.f39, true, !v1[f23], v24.f38, v24.f38, v24.f39, v24.f39, v24.f39, p3, v24.f39, true, true, v24.f39];
					v34[859] := v37;
					var v38: multiset<int> := multiset{f23, |{v24.f39, true, v24.f38}|, |p0|};
					v34[859] := new bool[11] [false, v24.f38, f23 !in v38, 817 == f23, !(!(if (fm1(globalState) in v35) then v35[fm1(globalState)] else v24.f39) && v24.f38), p2[531] > |p0|, p3, v24.f39, v33.f32, if (v24.f38 in v0) then v0[v24.f38] else v24.f39, v24.f38];
					var v39 := true;
					v39 := v1[684];
			...
			var v41: multiset<int> := multiset{p2[531]};
			...
			var v48: array<D12> := new D12[22] [v43, v43, v43, fm62(v45, "mmwyxmeix", -p2[531], f23, globalState), DC32(v41).(cf57 := v41), v43, v43, v43, v43, DC32(multiset(v46)), v43, v43, v43, v43, v43, v43, v43, DC32((multiset{f23, f23, |v41[p2[531] := -0x35e]|})[v46[f23] := p2[531]]), v43, v43, DC32((multiset(seq(311, i2  => (f23))))[|v47| := p2[531]]), v43];
			v48[609] := v43;
			v48[609] := v43;
			var v49: array<T0> := new T0[12];
			var v50: map<int, set<int>> := map[f23 - p2[531] := p1];
			var v51: map<char, array<T0>> := map[v44 := v49];
			v49, v1, v50 := if (v44 in v51) then v51[v44] else v49, (v1 + [true])[|(seq(-0x2bb, i3  => (|map[-0x276 := v1]|)))| := v24.f39] + v1, v50;
		}
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		if (false) {
			...
			var v7: seq<seq<char>> := [[p1], v0, seq(0x333, i0  => (p1)), v0];
			...
			var v13: map<int, bool> := map[f31 := v12[-0x2e3]];
			v11 := v11[v0 := |v13|];
		} else {
			...
			var v23: array<int> := new int[13] [p0, |(v16 + v16)|, f31, if (v18 in v19) then v19[v18] else f23, f31 / |v20|, fm1(globalState) % |v16|, v22.cf54, f31, f31, |(v16 + v16)|, f23, f31, f23];
			v23 := v23;
			v17 := v17;
			var v24: seq<int> := [-(f31 + |"graj"|)];
			v24, r1 := seq(0x2a2, i1  => (0x317)), 0x143;
			v17 := v17;
		}
		...
		var v28 := "ioyivqx";
		v27 := v27[|v28| := v26];
		for i2 := f23 to p0 / f23 {
			if (v26) {
				var v29: array<bool> := new bool[14](i3 => multiset{v26} >= multiset{!false, !v26, v26, v26, v26});
				v29[316] := !true;
				var v30: map<bool, int> := map[v26 := v25[466]];
				var v31: set<int> := {v25[466], |v30|};
				var v32: seq<set<int>> := [v31, v31];
				v29[316] := (v32[fm1(globalState)] - v31) !! (v31 * {p0});
				var v33: seq<seq<bool>> := [v27];
				v29[316] := [v26, v29[316], v26] != (v27 + v33[p0]);
				globalState.f8 := |v27| - p0;
				var v34: multiset<array<int>> := multiset{v25};
				var v35 := DC33(p0, v29[316], v29[316], v34[v25 := 885] !! v34);
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		var i1 := 0;
		while (p0 in (seq(0x37b, i2  => (p3)))[|v4| := p0])
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			if (p1) {
				...
				var v25 := DC50(v24);
				var v26 := DC45(f31, p1);
				r1, v25 := (seq(0xf7, i4  => (v5))) <= (if (v26.cf82) then p2 else p2), v25;
				globalState.f5 := p2;
				r1 := p1;
			}
			...
			decreases 100 - i5
		{
			...
			if (true) {
				...
				var v33: array<int> := new int[27] [f31, 0x1ff, f23, f31, f23, f31, |v27| / f31, f23, f23, -0x235 + f23, f23 + f23, -f23, -(|v28| + 0xd5), f31, f23, 0x6d, fm1(globalState), f31, f31, |(map v29 : int | v29 in v31 :: (v29 + f23) := (true))|, v32.cf84, |v4|, 0x3e7, |v27|, f31, f23, f23];
				v33[435] := f31 + f23;
				var v34: seq<seq<int>> := [v31, v31];
				v33[397] := |(v34 + v34)[f31 := fm32(f31, globalState)]|;
				r1, v33[435], v33[397] := p1, f23, f23;
				var v35 := 'y';
				v35 := p0;
				v27 := (v27 + v27) + (v27 + v27);
				var v36 := new C3(f31 != f31, p1);
				var v37: map<bool, int> := map[v36.f34 := v33[435]];
				var v38: map<int, int> := map[|"tvyv"| := ---0x1dc];
				var v39: map<int, int> := map[v33[435] % -0x363 := if (!v27[-0x25a] in v37) then v37[!v27[-0x25a]] else |v38|];
				...
				globalState.f8, r1, v41[155], r2 := |(v43 + v43)|, p1, v42[p1 := p0], f31 % f23;
				r1 := !true;
				var v44 := 'e';
				v44 := v44;
			...
			v46[717] := |v47|;
			var v48 := DC12("o");
			var v49: map<string, int> := map["rjkcotkh" := -(|(seq(0x224, i6  => (p3)))| - |p2|)];
			globalState.f8, r2, v46[717], v48, r1 := f23 - f23, |v49|, f31 % f23, v48, p1;
			globalState.f19 := p2;
		}
		if (fm24(p1, "reyejhlr" + p2, p1, globalState)) {
			r1 := f31 > f23;
			var v50: seq<string> := [p2, p2];
			globalState.f19 := v50[-f31] + p2[f31 := fm15(p3, globalState)];
			r2 := f23;
			var v51: array<array<array<bool>>> := new array<array<bool>>[11];
			var v52: array<array<bool>> := new array<bool>[21];
			v51[766] := if (false) then v52 else v52;
			v51[766] := new array<bool>[4] [v0, if (false) then v0 else v0, v0, v0];
			var v53: map<int, int> := map[f31 := f23];
			var v54: seq<bool> := [!p1];
			var v55: map<int, bool> := map[f23 / (if (|{p1}| in v53) then v53[|{p1}|] else 0x1eb) := !v54[f31]];
			v55 := v55[f31 := p1];
		} else {
			if (p1) {
				globalState.f8 := fm1(globalState);
				...
				r1 := fm16(f31, v57, f31 / |p2|, globalState);
				...
				globalState.f8 := f31;
				var v61: array<int> := new int[15](i7 => i7 % f23);
...
class C6 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		globalState.f8 := if (v1[f23]) then f23 else -p0;
		r1 := f23;
		r1 := f23;
		...
		var v5: map<int, char> := map[|(seq(0x2b1, i0  => ([p0])))| := if (true) then 'c' else p1];
		var v7: seq<map<int, char>> := [map v6 : int | (0x2f7 <= v6) && (v6 < 0x3e4) :: (v6 % |v1|) := (p1), map[p0 := p1]];
		var v8: seq<map<int, char>> := [v5[f23 := p1], v7[p0] + v5, v5, v5];
		var v9: set<bool> := {f29};
		...
		var v16: array<map<int, int>> := new map<int, int>[19] [v12, v13[f23], v12, v13[p0] + v12, v12 + v12, v12, v12, v12 + (if (f29 in v15) then v15[f29] else map[p0 := p0]), v12, v12, v12, map[f23 := p0] + v12, v12, v12, v12 + v12, v12 + map[fm1(globalState) := p0], v12[p0 := f23], v12, v12];
		r0 := v16;
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		if (f29) {
			...
			if (p1) {
				...
				v2[496] := v3;
				v2[496] := fm22(p1, globalState) + fm22(false, globalState);
				r1 := f29;
				...
				v15[528] := f29;
				v15[528] := p1 <== !fm2(globalState);
				v15[528] := v15[528];
				var v16: map<bool, string> := map[v15[528] := f30];
				v16 := v16[f29 := f30];
			}
			...
			var v27: array<map<int, int>> := new map<int, int>[21] [v22[f23 := f23], v22, v22, v22, v23[-|v24|], v22, v22, v22, v22, v22[f23 := f23] + v22, map[|v25| := |fm38(f23, f29, f29, 0x1eb, globalState)|] + v22[f23 := f23], v22 + map[|(seq(-0xa9, i1  => (p0)))| := f23], map[f23 := |map[p1 := f29]|], v22, v22, map[|(if (f29 in v26) then v26[f29] else v24)| := f23], map[|v25| := f23], v22, v22 + v22, v22, v22];
			v27[869] := v22;
			v27[869] := map[f23 := f23];
			r1 := !(f29 <==> f29);
			r1 := p1;
			...
			var v32 := new C2([v28[|v25|]] + v28, |v31|);
		...
		v33[375], v34, r0 := f23 % |v35|, v34, v33;
		globalState.f19 := f30;
		var v36: multiset<bool> := multiset{true, !f29, f29, p1};
		r1 := v36 > v36;
		v33[375] := -(-v33[375] % v33[375]);
		...
		var v48: map<int, int> := map[if (false in v47) then v47[false] else v33[375] := -v33[375]];
		r0 := new int[29] [f23, v33[375], f23 * f23, |map[f23 := v37]| % (if (v38 in v39) then v39[v38] else v33[375]), |v40| * f23, |(set v41 : int | v41 in v35 :: (v41 * 0x1a5))| - -|v42|, -(0x16e - f23), v33[375] - -0x81, f23, v33[375], v38.fm27(v43, |v44|, f30, p2, globalState), v33[375], f23, |{v46[|f30|], v45}|, f23, -v33[375], v33[375], f23, f23, f23, |(v35 * v35)|, |(v40 + v40)|, 0xad, f23, if (f29) then --f23 else f23, |fm42(true, v42[f23], v38.f32, !v42[v33[375]], globalState)|, |v48|, |v44|, v33[375]];
		r1 := fm2(globalState);
		r2 := f23;
	}
	method m14(p0: multiset<int>, p1: bool, p2: bool, globalState: GlobalState) {
		...
		var v2 := new C4(v0[f23] ==> f29, |multiset(v1)|);
		...
		match (v10) {
			case DC28(cf50, cf51, cf52, cf53, cf54) =>
				...
				v11 := v11;
				cf53 := cf50;
				var v12: array<char> := new char[24] [v4, f30[f23], 'n', v4, f30[--0x59], fm0(globalState), v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, 's'];
				v12[436] := v4;
				v12[436] := v4;
			...
			case DC27(cf49) =>
				if (!!v2.f32) {
					...
					v16, globalState.f8, v4, v4 := v16, v2.fm26(globalState), f30[|(f30 + f30)|], v4;
					var v17 := false;
					v17 := f23 == f23;
					var v18: multiset<string> := multiset{f30};
					var v19: T0 := new C1(v2.f32, v4, 0x18d);
					var v20: multiset<T0> := multiset{v19, v19};
					v17, globalState.f8, v17 := v2.f32, |v1|, v18 == v18[fm34(globalState) := |v20|];
					...
					v33[563] := v0[0xff];
					v33[348] := v2.f32;
					v32, v33[563], v33[348] := v32, v2.f32, v2.f32;
					globalState.f8, v33[563], v33[563] := f23, p2, (if (v2.f32) then v33[563] else p1) <==> p1;
					v1 := v1;
					var v34: map<bool, array<bool>> := map[p2 := v33];
					v33[563] := (|[f23, f23]| - f23) >= |v34|;
					var v35: map<bool, int> := map[v2.f32 := v1[f23]];
					var v36: multiset<bool> := multiset{v2.f32};
					var v37: seq<map<bool, int>> := [v35[fm2(globalState) := v2.fm27(map[v36 := [p1]], f23, f30, f30, globalState)], v35, (fm39(v33[563], p1, f23, globalState))[!true := if (f23 in p0) then p0[f23] else f23]];
					var v38 := DC36(DC4([0x30d]), v2.f32);
					v4, v37, v4, v33[563] := v4, if (f29) then v37 else seq(-0x26b, i2  => (v35)), v4, v2.f32 || v38.cf66;
				}
				...
				v0, globalState.f8, globalState.f8, v39[923], v42 := v0, -(|v1| * (-f23 / v2.fm26(globalState))), f23 + f23, v40, if (p2) then v42 else v42;
			...
			case DC29(cf55) =>
				...
				var v52: array<seq<bool>> := new seq<bool>[10] [v0, [p2, f29, v2.f32], v0, [p2, p2, fm2(globalState), p1, p1], v0, if (v48 in v49) then v49[v48] else fm42(p1, p2, p2, !p1, globalState), [p1], v0[-f23 := f29], v51.cf68, [p2]];
				v44[792] := v52;
				var v53: seq<seq<bool>> := [v0, v0];
				var v54: multiset<bool> := multiset{true, f29};
				var v55: seq<multiset<bool>> := [v54];
				v44[792] := new seq<bool>[27] [fm42(v2.f32, v2.f32, f29, !p1, globalState) + v53[|v0|], v0, v0, fm21(v55, v2.f32, globalState), DC37(f29, v0).cf68[f23 := v2.f32], v0, v0, v0 + v0, v0, v0, v0, v0 + v0, v0, v0, [v2.f32], if (v2.f32) then v0 else v0, v0, v0[f23 := p2], v0, v0, v0, v0, v0, v0, v0, v0, v0];
				...
				if (fm66(f29, globalState) > v58) {
					...
					var v64: array<bool> := new bool[18] [p2, p2, true, f29, p2, p2, v2.f32, p2, f29, true, f29, v0[f23], p1, true, p1, v2.f32, v2.f32, p1];
					...
					v72 := v72[v69.f32 := v71];
					var v73: map<int, int> := map[f23 := |(seq(-0x7d, i5  => (|DC24(map[f23 := -405]).cf43|)))|];
		...
		var v83 := DC23(set v82 : int | (240 <= v82) && (v82 < 0xb5) :: (v82 % f23));
	...
	method m15(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>, r2: int) {
		...
		var v8: array<bool> := new bool[6] [fm2(globalState), multiset(v0) > v2, p0, p0 && v3[p1], v5.cf1, v7 != v7];
		v6[602] := f29;
		v6[602] := p3;
		v6[602] := |(f30 + f30)| <= (f23 % |v2|);
		for i1 := |f30| to p1 {
			var v9: map<int, int> := map[|f30| := i1];
			var v10: map<map<int, int>, bool> := map[v9 + map[i1 := i1] := f29];
			v6[602] := if ((v9 + v9) in v10) then v10[v9 + v9] else f29;
			globalState.f8 := i1 - i1;
			r2 := 0x18f + (|"ssqy"| * f23);
			var v11 := DC33(p1, !p3, v6[602], fm2(globalState));
			var v12 := DC21(p0, -fm1(globalState), v4, v11.cf58, fm2(globalState));
			var v13 := DC53(-f23, f30, |v2|);
			var v14 := DC25(i1);
			var v15: array<D7> := new D7[22] [v12, v12, v12, v12, v12.(cf37 := v13.cf94, cf38 := fm0(globalState), cf39 := |f30|), DC21(p2, i1, 'p', p1, v6[602]), v12, v12, DC21(f29, -0x1a8, v4, f23, p3).(cf39 := |f30|), v12, v12, v12, v12, v12, v12.(cf40 := true), if (false) then v12 else v12, v12, v12, DC21(p2, f23, v4, f23, p3), fm43(DC21(f29, i1, v4, 0x1be, v6[602]).cf36, v14, globalState), v12, v12];
			v15 := v15;
		}
		var v16: set<bool> := {v6[602], v6[602]};
		var v17 := new C3(v16 > fm44(p0, !p2, false, f30, globalState), if (p2) then v6[602] else fm2(globalState));
		var v19: array<int> := new int[15](i2 => i2 / |(set v18 : int | v18 in v2 :: (v18 % 521))|);
		...
		r2, v21, v6[602] := if (v23[|v1|] in v22) then v22[v23[|v1|]] else -131, v21, !v17.f34 ==> !(p1 <= f23);
		v19 := v19;
		r0 := multiset{f23, f23, p1, |"x"|, v0[|f30|]};
		r1 := v3 + v3;
		r2 := -(p1 / v0[-|"qigcql"|]);
	}
}
...
class C7 extends T2 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		var v0: array<string> := new string[17](i0 => if (false) then "odo" else seq(0x25c, i1  => (p1)));
		var v1 := "nygqg";
		v0[362] := v1;
		v0[362] := v1;
		var v2 := 'b';
		v2 := if (true) then p1 else v1[f23];
		var v3 := false;
		if (!!!v3) {
			v2 := fm0(globalState);
			...
			if (fm2(globalState)) {
				...
				v16 := v16;
				v3 := true;
				var v17: multiset<char> := multiset{v1[|v0[362]|], p1};
			...
			match (v27) {
				case DC28(cf50, cf51, cf52, cf53, cf54) =>
					...
					var v34: array<bool> := new bool[15] [true, if (v3) then v3 else cf50, cf53, |v29| == cf54, cf50, cf53, cf50, v3, cf50, !v3, cf50, [v33[|v0[362]|], v32] == v33, !true, cf53, !!true];
					v34 := v34;
				case DC27(cf49) =>
					var v35: seq<int> := [|"jpdifyx"|, f23];
					var v36: array<int> := new int[21](i3 => i3 % p0);
					...
					var v43: seq<string> := [v0[362], seq(0x36, i4  => (v2)), v1, v1, v1];
					var v44: array<int> := new int[17] [p0, p0, f23 / fm1(globalState), fm1(globalState), f23, f23, -v35[|v35|], f23, f23, f23, |(v37 + v37)|, f23, |v41|, |v42|, p0, p0, |v43|];
					v36 := v36;
					...
					globalState.f8 := |(seq(0x198, i5  => (p1)))[p0 - -0x387 := v2]|;
				case DC29(cf55) =>
					var v49: array<bool> := new bool[28];
					v49[906] := v3;
					v49[906] := v3;
					var v50 := DC39(v0);
					var v51: map<int, D14> := map[|fm85(v49[906], globalState)| := v50];
					...
					v3, v26, v49[906], v54 := fm1(globalState) > --|v26|, v26 - {v3}, v49[906] && v49[906], v54;
					var v55: map<bool, bool> := map[v49[906] := v49[906]];
					var v56: array<D6> := new D6[2];
					var v57 := DC26(v56, fm2(globalState), |v1|, p0);
					v55 := v55[v57.cf46 := !v49[906] && fm2(globalState)];
			}
		...
		for i6 := f23 * --p0 to |v0[362][-p0 := p1]| {
			var v59: multiset<bool> := multiset{!v3};
			var v60: map<int, bool> := map[|v59| % f23 := v3];
			v60 := v60[f23 := true];
			...
			match (v68) {
				case DC45(cf81, cf82) =>
					...
					var v72: multiset<seq<int>> := multiset{v62 + v62, (if (v3 in v71) then v71[v3] else v62) + v62[cf81 := |v60|], fm86(cf82, -988, globalState)};
					v72 := v72;
				...
				case DC44(cf80) =>
					...
					v3, v77[809], v3 := v3, !(-0x14 < |v78[p0]|), |v79| <= i6;
					var v80: map<int, int> := map[i6 := 0x2bb];
					var v81 := DC10(i6, p0, f23);
					var v82: map<int, D3> := map[|v80| := v81];
					r1 := |v82| * i6;
					v61, v77[809], v3 := (v61 + v61)[f23 / p0 := v3], v3, v3;
					v77[809] := v77[809];
			}
			
			v62, v3, globalState.f8 := [f23], v3, i6 / -f23;
		}
		if ((multiset{v3} < multiset{v3}) <== v3) {
			...
			match (DC40(|[true, v3]|, p0)) {
				case DC40(cf71, cf72) =>
					...
					var v87 := DC60(v86, v2);
					v87 := v87;
					cf71 := (0xae / f23) / (|(seq(-628, i7  => ('q')))| + cf72);
				case DC39(cf70) =>
					...
					r1, v3, v83, v94 := -817, fm2(globalState), (v83 - v83)[f23 := |(v1 + DC12(v0[362]).cf28)|], v94;
					var v95: array<int> := new int[18](i8 => i8 % -|v1|);
					v95[146] := p0;
					v3, globalState.f19, r1, globalState.f8, v95[146] := v1 == v0[362], v0[362], f23, |(seq(947, i9  => ({f23})))|, p0;
					r1 := f23;
					v95[146] := p0;
				case DC41(cf73) =>
					var v96 := new C6(v3 <==> v3, ("ufnanifxu" + "jysjdd")[f23 := v2], |(map[v3 := !v3])[v3 := v3]| / p0);
					r1 := f23 + (-f23 / -141);
					r1 := -f23;
			...
			var v99: seq<bool> := [v3];
			var v100: array<bool> := new bool[23] [v3, DC34(v3, v3).cf62, v3, v98 >= v98, v3, (seq(28, i10  => (v2))) < (seq(98, i11  => (v1[-p0]))), v3, v3, v3, p0 != f23, v3 ==> v3, false, v3, v3, v3, v3 && false, v3, v3, v3, f23 <= f23, v3, v99[p0], v3];
			v100[242] := true;
			v100[242] := f23 !in v98;
			v0 := v0;
		} else {
			var v101: array<int> := new int[5](i12 => i12 % f23);
			v101[180] := p0;
			v101[180] := p0;
			v101 := v101;
			var v102: seq<int> := [f23, f23, -v101[180]];
			if ((p0 !in v102) <== !v3) {
				var v103: array<bool> := new bool[14];
				v103[523] := v3;
				var v104: seq<bool> := [false, v3];
				var v105 := DC63(false);
				var v106: multiset<bool> := multiset{v104[f23], v105.cf108, v3, v3, v3};
				v103[523], globalState.f8 := fm87(v101[180], v3, p0, v3, globalState) > v106, f23;
				v102 := (seq(546, i13  => (f23))) + v102;
				...
				var v109: array<array<char>> := new array<char>[18] [v107, v107, v107, if (false) then v107 else v107, v107, v107, v107, v107, v107, if (v3) then v107 else v107, v107, v107, DC65(v107).cf112, v107, v107, if (v0[362] in v108) then v108[v0[362]] else v107, v107, v107];
				v109[832] := v107;
				v109[832] := if (fm2(globalState)) then v107 else v107;
				v3 := f23 <= fm1(globalState);
				var v110: map<bool, char> := map[v3 := p1];
				r1 := |(v0[362] + (v1 + v0[362])[|v110[v3 := 'x']| := p1])|;
			} else {
				var v111: array<bool> := new bool[9];
				v111 := if (v101[180] < v101[180]) then v111 else v111;
			...
			if (v3) {
				...
				var v119: multiset<int> := multiset{f23, v101[180], p0, -v101[180], v117};
				var v120: array<D6> := new D6[10](i14 => DC16(v2));
				var v121 := DC26(v120, v3, v117, p0);
				var v122: seq<bool> := [v118 < ([!v3])[if (v101[180] in v119) then v119[v101[180]] else v117 := (v121.(cf45 := v120, cf47 := f23)).cf46]];
				var v123: multiset<bool> := multiset{v116};
				globalState.f5, v122, v123 := v1 + v0[362], v122, v123;
				v1 := v1;
				v101[180] := fm1(globalState);
				...
				v128 := (fm88(f23, globalState))[p0 / f23 := v3];
		...
		var v136: map<seq<int>, int> := map[v134 := p0 / |v135|];
		var v137: seq<seq<int>> := [v133];
		v136 := v136[v133 := |(v137[p0] + v133)|];
		var v138: map<int, int> := map[p0 := f23];
		var v140 := DC24(v138);
		var v142: array<int> := new int[25];
		var v143: multiset<array<int>> := multiset{v142};
		var v144: array<map<int, int>> := new map<int, int>[14] [fm89(globalState), v138 + v138, map[p0 := p0], v138, v138, v138, v138, map v139 : int | (0x1ea <= v139) && (v139 < 0x3c4) :: (v139 % 0x6a) := (p0), v138, map[f23 := |multiset{v3}|], v140.cf43, v138[f23 := f23], (map v141 : int | (303 <= v141) && (v141 < 0xa3) :: (v141 + f23) := (f23))[f23 := |v143|], v138];
		r0 := v144;
		r1 := p0;
	}
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		if ((p1 <== p1) <==> (!p1 <== p1)) {
			...
			var v17: array<seq<int>> := new seq<int>[25] [(if (p1) then seq(783, i1  => (f23)) else v14)[f23 := |v2|], [-0x3d2], v14, v14, v14, v14, [f23], [0x7e, fm1(globalState), f23, f23], v14 + v14, v14, [|v15|, |[f23]|, f23, f23], seq(-0x1ad, i2  => (|map[p1 := |p2|]|)), fm86(p1, fm1(globalState), globalState), [f23], [f23], v14 + [|v16|, |v9|], if (p1) then v14 else v14, v14, (seq(0x2f4, i3  => (|DC64(v16, p1, p1).cf109|))) + v14, v14, v14, v14, ([f23, f23])[f23 := -f23], v14, v14 + v14];
			v17[561] := fm86(p1, -f23, globalState);
			var v18: map<int, map<array<D22>, bool>> := map[f23 := v12];
			v2, r1, globalState.f8, v12, v17[561] := v2[f23 := p1] + ([p1, p1, true])[f23 := p1], p1, f23, v12 + (if (f23 in v18) then v18[f23] else v12), [f23];
			var v19: set<string> := {p2, fm17(p1, true, p1, globalState)};
			v19 := v19 + v19;
			globalState.f8 := fm1(globalState);
			var v20: array<bool> := new bool[17];
			v20[785] := fm2(globalState);
			v20[785] := p1;
		} else {
			var v21 := DC66(p0, p1);
			...
			v22[277] := p1;
			v22[277] := fm17(p1, p1, p1, globalState) <= p2;
			var v23 := new C3(false, p1 <==> true);
			var v24: seq<int> := [f23];
			var v25: seq<int> := [v24[f23]];
			...
			var v31: array<int> := new int[22] [f23, f23, f23, f23, f23, |v26|, f23, -0xfd % f23, v24[f23], |p2| / |v27|, f23, if (p1) then |multiset{f23, v29.cf44, f23, f23, f23}| else f23, f23, |v30|, f23 % f23, -f23, f23, f23, f23, f23, |v27|, -|p2| + f23];
			v31[586] := f23 + f23;
			var v32 := DC65(v7);
			var v33 := DC67(DC67(v32).cf115);
			globalState.f8, v22[277], v31[586], v33, globalState.f8 := f23 / (f23 * f23), false, -(f23 + -fm1(globalState)), DC67(v32), 0x33d;
			var v34 := new C3(v22[277] in v2, v23.f34 <==> v22[277]);
			var v35: map<string, int> := map[p2 := -v31[586]];
			v31[586] := if ("y" in v35) then v35["y"] else |(p2 + p2)|;
		}
		...
		if (fm2(globalState)) {
			...
			v36 := v36[if (f23 in v37) then v37[f23] else fm17(v2[f23], !p1, false, globalState) := fm1(globalState)];
			...
			r1, globalState.f8, v39[658], v41, v46[530] := p1, -v47[v38.f31], v40, v41, v44;
			...
			if (v50 > v50) {
				...
				var v53: array<array<char>> := new array<char>[11] [if (|p2| in v51) then v51[|p2|] else v7, v7, v7, v52[f23], v7, v7, v7, v7, v7, v7, v7];
				v53 := v53;
				r1 := p1;
				...
				v49[140] := f23;
				var v63: map<int, array<int>> := map[|(fm92(globalState))[f23 := p2]| := v49];
				...
				var v68: seq<map<int, array<int>>> := [map[f23 := v49], v63[f23 := v49], v63 + v63, v66.cf116, v67[|v9|] + v63];
				var v69: seq<int> := [|map[p1 := [f23]]|, 0x364];
				var v70: seq<int> := [f23, |v2|, |v69|];
				var v71: map<seq<bool>, seq<int>> := map[[p1] := v70];
				r1, v49[140], globalState.f8, v63, v64[611] := false, |v65|, f23, v67[f23 - f23], v70 < (if (v2 in v71) then v71[v2] else v70);
				r2, v49[140] := v70[v49[140]], fm1(globalState);
				var v72, v73, v74, v75 := m0(v64[611], globalState);
			}
			...
			v49[752] := (f23 * |map[|v79| := if (p1 in v80) then v80[p1] else p1]|) - f23;
		}
		...
		match (if (p1) then v82 else v82) {
			case DC36(cf65, cf66) =>
				...
				r0 := if (v81.f39) then v84[f23] else v83;
				v83[126] := f23;
				v83[126] := f23;
				...
				v88[143] := v83;
				v88[143] := DC55(v83).cf98;
				var v89: map<seq<bool>, bool> := map[v2 := cf66];
				v89 := v89[v2 := v81.f39 || cf66];
			case DC37(cf67, cf68) =>
				var v90: set<int> := {f23};
				var v91: map<bool, bool> := map[fm2(globalState) := v81.f39];
				var v92: array<bool> := new bool[11] [v81.f39, v90 < v90, false, v81.f39, v81.f38 ==> v81.f39, (if (v81.f38 in v91) then v91[v81.f38] else v81.f39) ==> cf67, fm2(globalState), true, v2[|cf68|], v81.f39, v81.f39];
				v92[545] := v81.f39;
				cf67, v92[545], globalState.f8 := p1, p1, f23 * f23;
				v90 := fm93(v92[545], |p2|, globalState);
				var v93: array<int> := new int[27];
				v93[954] := f23;
				v93[954] := fm1(globalState) * f23;
				v92[545] := !(v92[545] || v81.f39);
			case DC35(cf64) =>
				var v94: map<int, bool> := map[f23 := true];
				var v95: array<multiset<bool>> := new multiset<bool>[18](i6 => v9);
				v95[911] := multiset{v81.f39} * multiset(v2);
				var v96: map<bool, bool> := map[cf64.f39 := !v81.f38];
				v7, v94, v95[911], r1, r2 := v7, v94, (if (v81.f39) then v9 else v9) + v9, if (cf64.f39 in v96) then v96[cf64.f39] else v81.f39, -((if (!cf64.f39 in v9) then v9[!cf64.f39] else f23) + f23);
				r2 := (-867 / |map[f23 := v2]|) / f23;
				...
				v100 := v100[v99 - (set v101 : int | (-739 <= v101) && (v101 < 0x16) :: (v101 / f23)) := p2];
			case DC38(cf69) =>
				...
				globalState.f8 := fm1(globalState) % (0x2ab - |v106|);
		}
		
		var v107: map<int, bool> := map[f23 := v81.f39];
		var v108: seq<int> := [f23, f23, |v107[f23 := false]|];
		var v109: array<bool> := new bool[14] [v81.f39, !v81.f39, v1 < multiset{f23, |"anmnsgxwf"|, 362}, true, fm2(globalState), p1, fm2(globalState), -f23 != |v107|, v81.f38, false, v108[f23 := -f23] != v108, p1, false, true];
		v109[525] := -0x35d == f23;
		v109[525] := v81.f39;
		var v110 := DC65(v7);
		var v111: array<D26> := new D26[10] [v110, v110, v110, v110.(cf112 := v7), v110, v110, DC65(v7), v110, v110, v110];
		v111 := v111;
		var v112: map<bool, int> := map[v109[525] := -f23];
		var v113 := DC43(p2, v81.f38, f23, v81.f38, p0);
		var v114: array<int> := new int[17] [f23, |(p2 + "gcnbpn")|, if (v109[525]) then if (f23 in v1) then v1[f23] else |v1| else f23, |(seq(0x267, i8  => (p3)))| + -f23, f23, f23, f23, f23, f23, f23, f23 + |v2|, if (v109[525]) then -f23 else f23, if (v109[525] in v112) then v112[v109[525]] else f23, f23, v113.cf77 % f23, f23, f23];
		r0 := v114;
		r1 := if (v109[525]) then p1 else p1;
...
class C8 extends T2 {
	...
	function fm17(p0: bool, p1: bool, p2: bool, globalState: GlobalState): string {
		((seq(0x2f0, i0  => ('o'))) + (seq(0x367, i1  => ('n')))) + (if (false) then "islg" else seq(0, i2  => ('o')))
	}
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		if (true) {
			...
			globalState.f8, globalState.f19, globalState.f5, globalState.f8, v0 := v5.cf14, v6 + v6, v6, p0, v7[f41];
			if (v2.f38) {
				...
				v12 := fm1(globalState) / |[fm1(globalState)]|;
				v0 := v2.f38;
			}
			...
			if (v2.f38) {
				...
				v17 := v18[p0 % f23];
				var v19: seq<int> := [-489];
				var v20 := new C4(v2.f39, -(if (v2.f38) then p0 else v19[|v6|]));
				v4 := v4 - (v4 + v4);
				...
				v25[947], globalState.f8, v25[312], v26 := |v6|, -v27[f23 * p0], if (v2.f38) then f41 else |(map[f41 := v2.f38] + v29)|, v26;
				v27 := (v27 + (v27 + v27))[-p0 := f41];
			...
			var v44: array<int> := new int[26] [if (v0) then 501 else f41, f41, |("ikqhbfpgr" + v38)|, p0, p0, -f41 + fm1(globalState), p0, f41 * f41, fm1(globalState), f41, f41, p0, f41, f41, 0x2b6, p0, f23, p0, fm1(globalState), f23, |v41[-(if (f23 in v35) then v35[f23] else fm1(globalState)) := v34[760]]|, p0 / p0, |v43|, 0x1e3, p0, f23];
			v44[709] := -f41;
			v1, v44[709] := v1, f41;
		}
		...
		if (v0) {
			...
			var v52: array<int> := new int[28] [fm1(globalState), if (p1 in v45) then v45[p1] else -0x185, |((map[v0 := |v46|])[v0 := f23] + v47[v0 := f23])|, 0x2bd, f41, f41, f23, f23, f23 / 410, |v48|, f23, if (|v51| in v49) then v49[|v51|] else p0, p0 / f41, p0 - p0, p0, p0 + fm1(globalState), f23, f23, f41 - f23, f23, p0, |v47|, -f41, f41, f41 - f41, -|v45|, f23, f23];
			var v53: seq<bool> := [v0];
			v50[577] := |v53|;
			v50[577] := f23 * p0;
			v1[585] := v0;
			...
			if (v0) {
				v50 := v52;
				globalState.f8 := v50[577];
				var v54, v55, v56, v57 := m0(v1[585], globalState);
				...
				v59[843] := v60;
				v59[843] := v60;
				var v61: map<bool, bool> := map[v1[585] := v1[585]];
				var v62: map<set<int>, bool> := map[v48 := v53[-|v61|]];
				v1[585] := if ((v48 * v48) in v62) then v62[v48 * v48] else v1[585];
				var v63, v64, v65 := m23([f23], globalState);
				v50[577] := fm1(globalState);
				globalState.f8 := (|(seq(0x7e, i0  => (-0x3bd)))| * -307) % (p0 % -v50[577]);
			}
			...
			if (fm2(globalState)) {
				...
				v70, v0, v71[591], v76, r1 := v70, v0, if (v0) then v74 else v74, v76, f41;
				var v77: seq<bool> := [v0];
				var v78 := new C2(v77[f41 := v0], f23);
				...
				v80[407] := if (f23 in v86) then v86[f23] else v85;
				v80[407] := v85;
			} else {
				v1[541] := v0;
				...
				v1[541], r1, v87[445], globalState.f8 := v0, p0, f23 % 0x2ed, if (false in v88) then v88[false] else f23;
				var v90: array<set<int>> := new set<int>[6](i2 => {|(seq(0x2cb, i3  => (p1)))|, -f41} - (set v89 : int | v89 in [|{-p0}|] :: (v89 * 0x236)));
				var v91: set<int> := {f41};
				var v93: seq<set<int>> := [set v92 : int | v92 in [v87[445]] :: (v92 + -0x1aa)];
				v90[896] := v91 + v93[v87[445]];
				var v94 := DC55(v87);
				var v95: multiset<D22> := multiset{v94, v94, v94};
				var v96: seq<D22> := [v94];
				var v97: multiset<multiset<D22>> := multiset{v95};
				var v98 := "jhevfyroy";
				v90[896] := fm79(multiset([v95, multiset(v96[0x211 := v94]), v95, v95]) <= v97, v98, globalState);
				var v99: seq<bool> := [v1[541], v0, fm2(globalState), v1[541], v0];
				var v100 := new C0(v0, v99[v87[445]]);
				var v101 := DC35(v100);
				...
				v102[246] := v101;
				v102[246], v1[541] := v101, v1[541] || v0;
				v1[541] := v100.f38;
			}
			
			var v103: array<int> := new int[4](i4 => i4 % p0);
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		var v6: multiset<int> := multiset{v3[184]};
		var v7: seq<int> := [v3[184], |p2|, f23, v3[184]];
		r2, r2, v4[487], v3[184] := (f41 % f23) % (|p2| + |v5|), f23 * v3[184], (p1 <==> p1) ==> (v6[0x239 := |v7|] <= v6), f23 % (v3[184] - -0x379);
		var v8 := DC43("rrpm", v4[487], f23, false, p0);
		var v9 := DC21(v4[487], -f23, v8.cf79, fm1(globalState), p1);
		v3[184] := f41 / v9.cf39;
		var v10: set<bool> := {v4[487], p1};
		match (DC29(DC27(v10))) {
			case DC28(cf50, cf51, cf52, cf53, cf54) =>
				var v11 := DC27(v10);
				var v12 := DC29(v11);
				...
				v14 := [v4[487]] + [cf53, cf50, v4[487], v4[487]];
				var v15 := new C2(v14, |[p1, v4[487], v4[487]]|);
				cf51 := v8.cf77;
			case DC27(cf49) =>
				v3[184] := f23;
				r2 := (f41 / --0x33f) + v3[184];
				var v16: seq<bool> := [v4[487]];
				v16 := v16;
				var v17: C6 := new C6(p1, seq(247, i1  => (p0)), |p2|);
				var v18: T0 := new C1(v4[487], p3, f41);
				var v19 := DC20(v4[487], v7);
			...
			case DC29(cf55) =>
				...
				match (v21) {
					case DC49(cf90) =>
						...
						v28 := v28;
						globalState.f8 := -(v3[184] % (if (!p1) then v7[-0x27] else v3[184]));
				}
				
				var v29: map<bool, char> := map[v4[487] := 'p'];
				var v30 := DC40(-|v29|, v3[184]);
				match (DC41(v30)) {
					case DC40(cf71, cf72) =>
						v4[487] := true <== v4[487];
						...
						v31[820] := p3;
						v31[820] := 'e';
						var v32: seq<bool> := [v4[487]];
						v32 := v32 + [p1, v4[487]];
						var v33 := new C3(p1, p1);
					case DC39(cf70) =>
						v4[487] := fm2(globalState);
						v3[184] := f41;
						var v34: map<int, bool> := map[f23 := p1];
						v4[487] := v3[184] in v34;
						var v35: seq<bool> := [v4[487], v4[487]];
						var v36: seq<bool> := [p1, DC37(v4[487], v35).cf67];
						var v37 := new C2((v36[f23 := v4[487]])[|fm79(!p1, p2, globalState)| := p1], f23);
					case DC41(cf73) =>
						var v38: array<map<int, int>> := new map<int, int>[1];
						var v39: map<int, int> := map[v3[184] := v3[184]];
						v38[586] := if (v4[487]) then v39 else v39;
						v38[586] := (map[v3[184] := v3[184]] + v39) + v39;
						var v40, v41, v42 := m23(v7 + v7, globalState);
						globalState.f8 := |map[v7 := f23]|;
						var v43 := DC8(-fm1(globalState), v4[487], fm2(globalState), 0x1b0, v40);
						var v44 := DC11(v43);
						v44 := v44;
				}
		...
		if (p1) {
			globalState.f19 := p2[f23 := p0];
			v4[487] := v3[184] >= (0x30e % f41);
			var v45, v46, v47 := m23(v7, globalState);
			var v48 := DC28(true, v46, DC28(v4[487], v46, f41, p1, v45).cf51, p1, v46);
			r2 := -v48.cf51;
			var v49 := new C4(v4[487], -0x3d7);
		} else {
			var v50 := 'm';
			v50, r2, globalState.f8 := p0, f23, v7[fm1(globalState)];
			v4[487] := !(fm80(p1, globalState)).cf40;
			if (p1) {
				r1 := fm2(globalState);
				var v51: C3 := new C3(v4[487], v4[487]);
				var v52: set<C3> := {v51};
				r1 := !true && (|v52| <= v3[184]);
				r1 := v4[487];
				v4[487] := true;
				...
				v60 := v60[v59 := p1];
				var v61: map<bool, bool> := map[p1 := v4[487]];
			...
			v4[487] := true;
			if (if (false) then p1 else v4[487]) {
				var v64 := DC56(p1, v3[184]);
				var v65: map<int, D22> := map[v3[184] := DC57(v64)];
				var v66 := DC57(DC55(v3));
				v65 := v65[f41 := v66];
				v3[184] := v3[184];
				globalState.f8 := v3[184];
				var v67 := new C4(false, DC40(|(seq(0x8e, i2  => (p0)))|, v3[184]).cf72);
				globalState.f8 := f41 * (f23 + |{p1, v4[487], v4[487], v67.f32, p1}|);
			} else {
				r1 := p1;
				var v68 := DC46(v4);
				...
				var v69: seq<bool> := [p1];
				var v70 := DC51(v69);
				var v71: seq<seq<bool>> := [v70.cf92 + (v69[f23 := v4[487]])[f41 := v4[487]], v69, v69];
				var v72: map<int, bool> := map[v3[184] := p1];
				var v73: multiset<map<int, bool>> := multiset{v72, v72, v72[0x14c := true], v72};
				var v74 := DC3(|v5|, |v73|, f41, f23, p1);
				r1, r1, v4[487], globalState.f8, v71 := (v10 * v10) != (if (p1) then v10 else v10), v74.cf9, p1, --f23, [v69, v69 + [false], v69, [p1]];
				v4 := new bool[24](i3 => v4[487]);
			}
	...
	method m22(p0: D7, p1: int, globalState: GlobalState) returns (r0: map<bool, array<int>>, r1: map<int, int>) {
		...
		v4 := if (v7[p1] in v7[p1 := f23]) then v4 else fm81(f41, f41, globalState);
		...
		match (if (v0 ==> v0) then v10 else v10) {
			...
			case DC52(cf93) =>
				...
				v14[561] := v17.cf46;
				var v18 := new C3(v0, v14[561]);
				var v19: map<int, seq<int>> := map[-p1 := v7];
				var v20: array<int> := new int[4];
				var v21: seq<array<int>> := [v20];
				var v22: set<bool> := {v18.f33};
				var v23: map<map<int, bool>, array<int>> := map[map[f41 := v0] := v21[|v22|]];
				var v25: map<char, int> := map[v13 := f41];
				var v26: array<map<int, seq<int>>> := new map<int, seq<int>>[24] [v19 + fm82(!!v0, globalState), v19 + v19, v19 + v19, v19, v19, v19, v19, v19, v19, v19, v19, v19 + v19, v19, map[|v7| := v7[f41 := f23]] + map[-|v23| := v7], (map v24 : int | v24 in multiset{|v16|, f41, f23} :: (v24 / f23) := (v7))[f41 := v7] + map[p1 := v7], v19, v19, if (v0) then v19 else v19, v19, if (v18.f34) then v19 else v19, v19, v19, v19, map[f41 := [-(if (v13 in v25) then v25[v13] else 0xdc), f41]] + v19];
				v26[498] := v19;
				v26[498] := v19 + v19;
			case DC54(cf97) =>
				var v27 := "dqmofjeb";
				...
				v29[283] := v0;
				v29[283] := if (false) then v0 else !v0;
				var v30: map<int, bool> := map[p1 := v29[283]];
				var v31: seq<seq<int>> := [v6, v7, v6, v6, seq(0x229, i1  => (f23))];
				var v32: map<bool, seq<int>> := map[f23 <= |v30[f41 := v29[283]]| := v6 + v31[f23]];
				v32 := v32[v29[283] := v7];
				var v33: C3 := new C3(if (v29[283]) then fm2(globalState) else v29[283], v29[283]);
				v33 := v33;
				v29[283] := v28[|v27| * 0x32c];
		}
			...
			decreases 100 - i2
		{
			...
			v34[474] := |((seq(942, i3  => (p1))) + v7)|;
			var v35: map<int, bool> := map[p1 := v0];
			v34[474] := (|v7| / |v35|) - (f23 % -f41);
			...
			match (v38) {
				case DC40(cf71, cf72) =>
					...
					v39 := v39;
					var v40 := "l";
					var v41: map<int, int> := map[v34[474] := f41];
					var v42: seq<bool> := [v36[546]];
					var v43: set<int> := {if (v34[474] in v41) then v41[v34[474]] else |(v42[cf71 := v36[546]])[v34[474] := v36[546]]|, f23};
					v36[546], v34[474], v34[474], v36[546], v34 := if (v0) then fm2(globalState) else v0 <==> !v0, |v40| - cf72, |v43|, v0, v34;
				case DC39(cf70) =>
					var v44 := 'x';
			...
			decreases 100 - i4
		{
			...
			v53[136] := |(if (v0) then map[v54 := |v55|] else v57.cf102 + v58)|;
			globalState.f8 := (f23 * v53[136]) - -v53[136];
		}
	...
	method m23(p0: seq<int>, globalState: GlobalState) returns (r0: int, r1: int, r2: map<int, int>) {
		...
		if (v0) {
			...
			var v13: array<int> := new int[20] [f23, |v5|, -f23, f23, |(seq(0x105, i0  => (v2)))|, f41, |map[f41 := v10]|, f41, v7.f23, f41, if (v11 in v12) then v12[v11] else f41, -0x52, -v7.f23, -0x1c1, |[v0, v0]|, f23, f23, f41, v7.f23, f23];
			...
			if (fm2(globalState)) {
				...
				v0 := true;
				var v22: set<int> := {f41};
				var v25: set<set<int>> := {set v23 : int | v23 in v22 :: (v23 * |[789, |map[|(set v24 : int | (982 <= v24) && (v24 < -0x35b) :: (v24 % |"ukv"|))| := "yuy"]|]|), v22};
				v0 := !((v25 + v25) >= v25);
			} else {
				globalState.f8 := f23;
				v0 := true;
				...
				v31[1], v32[851] := (v33 * v33) !! fm87(0x1e1, v0, f23, v0, globalState), v28;
				v28 := v32[851];
			}
			...
			r1 := |fm94(v0, v35[f23], globalState)|;
			...
			globalState.f8 := f23 - ((if (f41 in v39) then v39[f41] else |v41|) / f23);
		}
		
		globalState.f8 := f41 % f41;
		for i1 := f23 to f41 {
			var v42: set<bool> := {!v0};
			if ({v0, v0} < v42) {
				var v43 := new C4(true, p0[p0[i1]]);
				var v44: map<int, int> := map[f41 := i1];
				globalState.f8 := f23 / |v44|;
				globalState.f8 := i1 + |p0|;
				v0 := v43.f32;
				globalState.f8 := f23;
			} else {
				globalState.f8 := (i1 + f23) + (i1 / i1);
				...
				v50[455] := v46;
				v45[751], v50[455] := if (fm2(globalState)) then v0 else v0, if (v0) then v46 else v46;
				var v51: multiset<int> := multiset{f41};
				r0 := if ((0x38 + f23) in v51) then v51[0x38 + f23] else -(i1 + i1);
				var v52: C0 := new C0(v0, v45[751]);
				var v53 := DC38(DC35(v52));
				var v54: seq<bool> := [v52.f38];
				var v55 := DC37(v52.f39, v54);
				var v56 := DC38(v55);
				var v57: multiset<D13> := multiset{if (v45[751]) then v53 else DC38(v55)};
				v57 := v57;
				v45[751] := true;
			}
...
class C9 extends T2 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		var v4: array<seq<int>> := new seq<int>[22] [v0, v0, fm68(v1, !v2, globalState), v0, v0, v0, ([p0, 0x211])[f23 := p0], v0 + v0, [f23, f23, |v3|, f23, f23], v0, v0, v0, v0 + v0, v0, v0, v0, seq(0x2f0, i0  => (DC45(f23, v2).cf81)), [f23, f23], v0, v0, v0, v0];
		v4[358] := v0;
		var v5: map<int, bool> := map[f23 := v2];
		var v6: map<int, int> := map[0x205 := |v5|];
		v4[358] := v0[f23 / |v6| := p0 - p0];
		var v7: set<bool> := {v2};
		var v8: multiset<bool> := multiset{v2};
		var v9: seq<string> := [f40, fm17(v2, v2, v2, globalState), f40, fm17(v2, v2, v2, globalState)];
		if (f23 in (if (v2) then v4[358] else [|v7|, |v0|, p0, f23, |v8|])[|v9| := p0]) {
			v2 := !v2;
			var v10: array<int> := new int[2] [p0, f23];
			var v11: set<int> := {|map[true := v2]|, f23};
			var v12: map<seq<char>, set<int>> := map[f40 := v11];
			var v13: map<int, set<int>> := map[|v7| := if ((seq(0x178, i1  => (p1))) in v12) then v12[seq(0x178, i1  => (p1))] else v11];
			...
			v23[296] := fm1(globalState) + p0;
			var v24: multiset<seq<int>> := multiset{v4[358] + v4[358]};
			var v25: array<array<bool>> := new array<bool>[22];
			v25[47] := v22;
			globalState.f8, v23[296], v24, r1, v25[47] := f23, -(f23 % 0x3a0), v24, p0 / (p0 + p0), v22;
			...
			if ((|f40[f23 := p1]| <= p0) && fm2(globalState)) {
				var v28: map<bool, string> := map[!v2 := f40];
				var v29 := DC42(v28);
				var v30: multiset<D15> := multiset{v29, v29, v29, if (v2) then v29 else v29, fm70(v22[886], globalState)};
				...
				var v31: seq<bool> := [fm2(globalState), v22[886]];
				v23[296], v2, globalState.f8, v22[886] := p0 / (f23 / (if (!v2 in v8) then v8[!v2] else f23)), (fm71(v31, p0, globalState)).cf62, p0, v2;
				var v32 := DC5(fm1(globalState));
				var v33: array<D2> := new D2[21] [v32, v32, v32, v32, v32, v32, DC5(v23[296]), v32, v32, fm72(globalState), v32, v32, DC5(|"qbwm"|), v32, v32, v32, v32, DC5(|f40|), v32, v32, v32];
				v33 := if (if (v2) then v22[886] else v22[886]) then v33 else v33;
				v22[886] := v2;
				var v34: map<bool, map<int, bool>> := map[false := v5 + v5];
				var v35: map<array<bool>, bool> := map[v22 := v22[886]];
				var v36 := 'n';
				var v37: seq<array<int>> := [v23, v23, v23, v23, v23];
				var v38 := DC55(v23);
				var v39: array<array<int>> := new array<int>[28] [v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, v37[|f40|], v23, v23, v23, v23, v38.cf98, v23, v23, v23, v23, v23, v37[-v23[296]], v23, v23, v23];
				v39[645] := v23;
				var v40 := DC28(v22[886], p0, p0, v22[886], p0);
				var v41 := DC56(v22[886], 0x89);
				var v42 := DC57(v41);
				...
				var v44: map<array<D22>, int> := map[v43 := v23[296]];
				v34, v35, v36, r1, v39[645] := fm73(v22[886], v40, if (v43 in v44) then v44[v43] else f23, globalState), v35 + v35, v36, -(2 + p0), v23;
				var v45 := DC15();
				var v46: array<D6> := new D6[16] [v45, v45, v45, DC15(), v45, v45, v45, v45, DC15(), v45, v45, v45, if (true) then v45 else v45, v45, v45, if (v22[886]) then v45 else fm74(f40, globalState)];
				v46[664] := v45;
				v46[664] := DC15();
			}
		...
		for i3 := f23 to p0 {
			...
			v47[5] := -p0 > |multiset{v2, v2}|;
			var v48: multiset<map<int, int>> := multiset{v6};
			v2, globalState.f8, v47[5] := (v48 - multiset{v6, v6}) >= v48, |f40|, (-p0 > p0) <==> v2;
			v4[358] := v4[358];
		}
		for i4 := if (v2) then 0x375 else p0 to 0x310 {
			...
			if (v2) {
				...
				v53[40] := v52;
				v51[130] := v2;
				v2, v51[279], v53[40], globalState.f8, v51[130] := v2, v2, v52, p0, !v2;
				var v54: array<int> := new int[25](i8 => i8 - i4);
				globalState.f8, v51[279], v54 := i4, v51[279], if (v51[279]) then if (v51[279]) then v54 else v54 else v54;
				var v55: map<seq<char>, bool> := map[f40 := v2];
				v55 := v55[f40 := v51[279]];
				var v56: seq<bool> := [v51[279], v51[279]];
				...
				var v61: array<int> := new int[17] [i4 * 7, f23, p0, -|[p1, v58.cf79]|, f23, 0x31e - 253, |v60|, i4 * -0xf8, p0, p0, if (v2) then p0 else 216, fm1(globalState), i4, p0, i4, p0, i4 % p0];
				...
				v63, globalState.f8, v2, globalState.f8, v2 := (v63 + v63) + ([false])[0x103 := v2], |(v67 + v67)|, v2 && v2, |(f40 + fm17(v2, v2, true, globalState))|, v2 <== !v63[f23];
		...
		var v71: array<map<bool, bool>> := new map<bool, bool>[13] [map[v2 := v2], map[v2 := v2], v70[f23], v69, v69, v69, v69[v2 := v2], v69, map[v2 := v2] + v69, v69 + v69, v69 + v69, v69 + v69, v69 + v69];
		forall i9 | 0 <= i9 < v71.Length {
			v71[i9] := v70[if (v2 in v8) then v8[v2] else f23];
		}
		var v72: seq<bool> := [v2];
		var v73: array<int> := new int[4] [|v72|, -f23, if (v2) then f23 else 0x11a, p0];
		v73 := v73;
		var v75: seq<map<int, int>> := [v6];
		var v77: array<map<int, int>> := new map<int, int>[7] [(map v74 : int | v74 in v3 :: (v74 % p0) := (p0))[f23 := |v72|], v6, v75[f23] + v6, v6 + v6, v6 + (map v76 : int | (0x37c <= v76) && (v76 < 0x52) :: (v76 % f23) := (f23)), v6, v6];
		r0 := v77;
		r1 := -p0;
	}
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		if (!(f23 > f23)) {
			...
			v0[205] := if (|fm75(f23, -0x2e, true, p1, globalState)| in v2) then v2[|fm75(f23, -0x2e, true, p1, globalState)|] else f23;
			var v3 := 'g';
			var v4 := DC53(|v1|, p2, f23);
			var v5: multiset<int> := multiset{f23, f23, f23};
			v0[205], globalState.f8, globalState.f8, v3 := -v4.cf94, if (p1) then f23 + -f23 else |(v5 - v5)|, f23, p3;
			var v6: seq<set<bool>> := [{p1, p1}];
			var v7: set<int> := {744};
			var v8: map<bool, seq<set<bool>>> := map[|v7| != |f40| := v6];
			v6 := if (p1 in v8) then v8[p1] else v6 + (seq(0x235, i1  => ({p1, p1})));
			v3 := v3;
			v1 := v2;
			var v9: set<char> := {v3};
			...
			globalState.f8 := if ((f23 / f23) in v18) then v18[f23 / f23] else if (|v20[f23 := {f23}]| in v18) then v18[|v20[f23 := {f23}]|] else fm1(globalState);
			globalState.f8 := fm1(globalState);
			var v21 := new C6(false || p1, p2, f23 * f23);
			var v22 := DC53(f23, p2, f23);
			var v23: seq<D21> := [v22, v22];
			var v24 := DC54(v23[f23]);
			match (v24) {
				case DC53(cf94, cf95, cf96) =>
					var v25: seq<string> := ["qo"];
					var v26: map<string, int> := map[v25[|p2|] := cf94];
					...
					v28 := v28[if (true) then p2[cf96 := p3] else f40 := p2];
					var v29: set<char> := {p3};
					var v30: map<int, set<char>> := map[|(v17 * multiset{false})| := v29];
					v30 := v30[0x12d % f23 := v29];
					var v31: multiset<int> := multiset{cf94};
					var v32 := DC45(-|(seq(0x39e, i2  => (cf94)))|, v21.f29);
					...
					v36[825] := !v21.f29;
					globalState.f8, v36, v36[825], v34, r1 := cf96, v36, v21.f29, v34, v21.f29 || v21.f29;
				case DC52(cf93) =>
				...
				case DC54(cf97) =>
					...
					var v45: map<int, seq<int>> := map[|v44| := seq(0x226, i5  => (f23))];
		...
		if (p1) {
			...
			v56, r1, v53[484], v53, r1 := v56, v50.f23 != -647, -v50.f23, DC55(v53).cf98, v50.f23 > v53[484];
			var v57: seq<bool> := [p1];
			...
			v56[981] := !p1;
			v56[981] := p1 && (if (p1) then p1 else p1);
		} else {
			...
			if (p1) {
				...
				v65 := v65;
				var v66: map<int, bool> := map[v53[484] := p1];
				v66 := fm88(-f23, globalState);
				r1 := (if (!v63[415]) then p1 else v63[415]) <== p1;
			} else {
				r1 := p1;
				...
				r2 := (-0x175 / v50.f23) / (if (|v54| in v72) then v72[|v54|] else f23);
				r1, globalState.f8, r1 := p1, v53[484], !false;
			}
			...
			v73[885] := !p1;
			var v77: seq<bool> := [p1];
			var v78: seq<bool> := [v77[v50.f23], true, true];
			var v79 := DC51(v78);
			var v80: set<bool> := {p1, p1};
			var v81: map<bool, set<bool>> := map[p1 := v80];
			var v82: map<map<bool, set<bool>>, bool> := map[v81 := p1];
			var v83: array<seq<bool>> := new seq<bool>[20] [[p1, p1], v78, v78 + v77, v78, v77, v78, v78 + v78, fm95(p1, p1, globalState), v78, v79.cf92, v78, fm95(p1, p1, globalState), fm95(p1, p1, globalState), [if (v81 in v82) then v82[v81] else p1] + v77, if (false) then v78 else v78, if (p1) then v78 else v77, v78 + v77, [p1, true] + v77, (v77 + v77)[|p2| := p1], v78 + [p1, p1, p1]];
			var v84 := DC15();
			var v85 := DC24(v54);
			v76, v54, v73[885], v83, v84 := v76, v85.cf43, p1, v83, DC15();
			if (p1) {
				var v86 := DC8(v50.f23, true, true, v50.f23 / f23, v50.f23 / v53[484]);
				v86 := v86;
				var v87: set<string> := {f40};
				var v88: map<bool, set<string>> := map[v73[885] := v87];
				...
				v89[967] := v87 * v87;
				v89[967] := {"hresh" + (seq(0x348, i9  => (p0)))};
				var v90: array<char> := new char[23];
				v90[387] := p0;
				v90[387] := p3;
				v73[885] := v73[885];
				var v91: seq<seq<int>> := [[v53[484], v50.f23], v52, v52, v52[v50.f23 := |[v53, v53]|], v52];
				var v92: array<seq<int>> := new seq<int>[19] [v52, v52 + v52, v52 + v52, v52, [fm1(globalState)], v52, v91[|v77|], v52, v52, v52, seq(-0x2fe, i10  => (0x1f1)), v52, v52, v52, v52, [0x1a4, v50.f23], (seq(156, i11  => (|[map[p1 := v53[484]]]|))) + (seq(316, i12  => (v50.f23))), v52 + v52, v52];
				v92[86] := v52 + [v53[484]];
				v92[86], v73[885], v80 := v52, p1, fm85(v76 <= v76, globalState);
			} else {
				var v93: map<array<int>, bool> := map[v53 := v73[885]];
				v73[885] := v53 in v93;
				v73[885] := p1;
				v52 := fm86(!false, v50.f23 - v50.f23, globalState);
				r1 := !(v50.f23 <= (v50.f23 - v53[484]));
				v73[885] := v50.f23 >= v50.f23;
			}
			
		}
		
		var i13 := 0;
		while (v50.f23 > v53[484])
			decreases 100 - i13
		{
			if (i13 >= 100) {
				break;
			...
			var v95: multiset<bool> := multiset{p1, f23 <= f23, (v94.(cf86 := v53[484])).cf88};
			v95 := multiset{p1};
			var v96 := 'l';
			var v97: seq<map<int, int>> := [v54];
			var v98: T0 := new C4(false, v50.f23 / v53[484]);
			var v99: map<bool, int> := map[false := -v98.f23];
			globalState.f8, v96, v97, v98 := if (p1) then f23 / f23 else if (p1 in v99) then v99[p1] else v53[484], if (!p1) then v96 else v96, v97 + v97, v98;
			globalState.f8 := v98.f23 % v50.f23;
	...
	method m21(globalState: GlobalState) returns (r0: D21, r1: bool) {
		...
		if (v0) {
			...
			var v36: seq<bool> := [v0];
			var v37: set<array<int>> := {v35, v35, if (v36[f23]) then v35 else v35, v35};
			var v38: map<bool, bool> := map[v0 := true];
			var v39: multiset<int> := multiset{v1[|v38|], |f40|, -f23};
			globalState.f8, globalState.f8, globalState.f8, v37 := v1[if (f23 in v39) then v39[f23] else f23] * f23, -(f23 / f23), |f40| + |(v32 + v32)|, v37 * {v35, v35};
			...
			if (v0) {
				var v42: array<int> := new int[26](i0 => i0 / -0x53);
				v42[618] := f23 + f23;
				v42[618] := f23;
				var v43: multiset<int> := multiset{|f40|};
				var v44 := DC28(false, f23, |(if (v0) then v43 else v43)|, !v0 || v0, f23 % v42[618]);
				...
				v48[864] := v0;
				var v49: array<int> := new int[18](i2 => i2 % |map[f23 := !v0]|);
				v49[759] := f23;
				v49[560] := 0x73;
				var v50: map<char, bool> := map[v40 := v0];
				v48[864], v49[759], v49[560], v0 := f23 != (if (v0) then f23 else f23), f23 - |multiset{v40}|, f23 + 0x17c, ((seq(0xaf, i3  => (v40))) + f40)[|v50| := v40] == "sljciqiw";
				var v51: map<int, bool> := map[f23 := v48[864]];
				v48[864], v49[759], globalState.f8, v0, globalState.f8 := f23 !in v51, f23, fm1(globalState), v0, v47[--61 / v49[759]];
				var v52 := new C3(v0, v48[864]);
				var v53: array<multiset<int>> := new multiset<int>[1](i4 => multiset{v49[759]});
				var v54 := DC53(v49[759], f40, |fm87(v49[759], !v0, f23, v52.f33, globalState)|);
				var v55: seq<string> := [f40, v54.cf95];
				var v56: multiset<int> := multiset{f23, |fm86(false, v49[759], globalState)|, |v55|};
				v53[56] := v56;
				var v57 := DC47(f23, v52.f33, v49[759], true, v52.f33);
				var v58: map<array<bool>, bool> := map[v48 := true];
				v49[759], v53[56], v0 := 0x22, multiset{v49[759]}, (v57.cf88 || true) ==> (v48 !in v58);
			}
			
			var v59: array<set<D1>> := new set<D1>[13](i5 => {DC3(|map[v0 := v0]|, |multiset{f23}|, f23, |[false]|, v0), DC3(f23, |multiset{|f40|}|, 0x13d, f23, v0)} * {DC3(|(seq(0x1ed, i6  => ('v')))|, -f23, -f23, f23, !v0)});
			var v60: set<int> := {f23, f23, f23};
			var v61 := DC3(f23, f23, |v60|, f23, v0);
			var v62: seq<bool> := [v0];
			var v63: T1 := new C2(v62, f23);
			var v64: map<bool, T1> := map[v0 := v63];
			v59[59] := {v61, DC3(f23, f23, |v64|, f23, fm2(globalState)), v61, v61};
		...
		var v70: seq<bool> := [v0];
		v68, v69 := if (v0) then v68 else v68, multiset{v0, v0, v0, v0, v70[f23] || v0};
		var v71 := 'l';
		if (v71 !in (seq(0x12, i7  => (v71)))) {
			var v72: seq<int> := [f23];
			var v73: map<char, int> := map['v' := |f40|];
			globalState.f8, r1 := |v72| / -|v73|, v0;
			...
			if (v86[|"tsryqjiix"|] < f40) {
				v68[560] := f23;
				var v87: set<int> := {f23};
				v68[560], r1 := f23 % (if (v0) then f23 else f23), if (v0) then f23 > f23 else v87 !! v87;
				...
				v68[99] := (|v94| / f23) - |v95|;
				r1 := (fm93(v0, v68[99], globalState) !! {v68[99]}) || !v0;
				globalState.f8 := -(if (v0) then v68[99] else f23 % 0x314);
				v84[358] := v0;
				v84[358] := v0;
				v0 := v70[-949];
			}
		...
		for i10 := f23 to f23 {
			...
			var v110: map<D10, seq<int>> := map[DC27(v108) := v109 + v109[f23 := i10]];
			v110 := v110 + v110;
			...
			v112[82] := i10 != f23;
			v112[82] := !(if (v0) then v0 else v0);
			var v113 := new C4(v0, f23);
			v0 := fm2(globalState);
		}
		globalState.f8 := fm1(globalState) + 257;
		var v114: array<char> := new char[6] [v71, 'b', v71, v71, f40[f23], v71];
		var v115 := DC65(v114);
		match (v115) {
			case DC66(cf113, cf114) =>
				...
				match (if (f23 > f23) then v116 else v116) {
					case DC56(cf99, cf100) =>
						...
						var v121: array<array<int>> := new array<int>[15] [v68, v68, v68, v119[cf100], if (f23 in v120) then v120[f23] else v68, v68, v68, v68, v68, v68, v68, if (cf99) then v68 else v119[f23], v68, v68, v68];
						v121[81] := v68;
						v68[342] := f23;
						var v122: map<int, int> := map[f23 := fm1(globalState)];
						v68[941] := v118[|v122|] / fm1(globalState);
						var v123: multiset<int> := multiset{fm1(globalState)};
						var v124: map<multiset<int>, int> := map[v123 := |f40|];
						globalState.f8, v121[81], v68[342], v68[941], v69 := if (multiset{cf100} in v124) then v124[multiset{cf100}] else 0x2da, v68, cf100, cf100, if (cf99 || cf114) then v69 + v69 else v69 - multiset(v70);
						var v125: array<D12> := new D12[21];
						v125[984] := DC32(v123);
						var v126: map<bool, int> := map[cf114 := v68[342]];
						var v127 := DC32(multiset(v118) + multiset{|v126|, v68[342]});
						v125[984], globalState.f8, r1 := v127, v68[342], v0;
					case DC55(cf98) =>
						var v128: array<bool> := new bool[9];
						v128[153] := v0;
						v128[153] := !true;
						v128[153] := fm2(globalState);
						var v129: seq<int> := [f23, fm1(globalState)];
						var v130: seq<int> := [-|f40| * v129[f23], f23];
						var v131: map<bool, multiset<bool>> := map[cf114 := v69];
						var v132: map<bool, int> := map[v0 := if (v70[f23] in v69) then v69[v70[f23]] else f23];
						cf113, cf114, cf114, v129 := v71, if (f23 >= f23) then (if (v0 in v131) then v131[v0] else v69[v128[153] := f23]) != v69 else v128[153], v128[153], ([f23])[0x376 := f23 / -(if (cf114 in v132) then v132[cf114] else |v67|)];
						v128[153] := v128[153];
					case DC57(cf101) =>
						v68[126] := f23;
						v68[126] := -f23;
						var v134: seq<string> := [f40[|(map v133 : int | (0xb1 <= v133) && (v133 < 660) :: (v133 % f23) := (f23))| := cf113]];
						var v135: map<seq<bool>, string> := map[v70 := v134[0xe7]];
						var v137: seq<seq<bool>> := [v70];
						var v139: map<seq<bool>, bool> := map[v70 := v0];
						var v141: array<map<seq<bool>, string>> := new map<seq<bool>, string>[20] [v135, map[v70 := seq(167, i11  => (v71))], if (v0) then map[v70 := f40] else v135, v135, v135, v135, v135, v135, v135, v135, v135 + v135, v135, map v136 : seq<bool> | v136 in v137[|f40| := v70] :: (v136) := (f40), v135, if (!!cf114) then v135 else map[[!v0] := f40], map[(fm97(f40, globalState)).cf68 := "oirln"], (map v138 : seq<bool> | v138 in v139 :: (v138) := (f40)) + v135, v135, v135, map v140 : seq<bool> | v140 in [[!true]] :: (v140) := (("h")[f23 := cf113])];
						v141[617] := v135;
						var v142: array<bool> := new bool[25](i12 => v0);
						v142[733] := v0;
						var v143: map<int, int> := map[f23 := v68[126]];
						var v144: map<bool, map<int, int>> := map[v0 := v143];
						var v145: map<bool, bool> := map[cf114 := !cf114];
						globalState.f8, v141[617], r1, v142[733] := |(v144 + map[!cf114 := v143])|, map[[v0, cf114, cf114, cf114] := fm17(cf114, v0, false, globalState)] + (v135[v70 := f40] + map[v70 := f40]), (if (cf114 in v145) then v145[cf114] else cf114) !in v69, fm2(globalState) ==> false;
						cf114 := map[0x25c := f23] != v143;
						var v146: set<int> := {v68[126], v68[126], f23, v68[126]};
						v146 := v146 - v146;
				}
				...
				r1, globalState.f5, globalState.f8 := (|"ihre"| % f23) == fm1(globalState), f40 + f40, 0x242 * f23;
				globalState.f8 := fm1(globalState);
			case DC65(cf112) =>
				var v151: seq<int> := [f23, |v69|];
				var v152 := DC20(v0, v151[-f23 := |v69|]);
			...
			case DC67(cf115) =>
				...
				var v168: array<seq<int>> := new seq<int>[27] [[f23], seq(0x237, i13  => (f23)), v163, v163, fm86(v161, 666, globalState), [v162], [v162], v163, [f23], v163, seq(0x19b, i14  => (f23)), v163, v163, fm68(v165, v161, globalState), v163, v166.cf10, v163, v163, [f23], v163, if (!v161 in v167) then v167[!v161] else v163, v163, [|v158|], v163, [f23, f23], [v162, v162], seq(0x3dc, i15  => (f23))];
				...
				globalState.f8 := |v171[-(-v162 + f23) := f23]|;
...
class C10 extends T0, T1, T2 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		match (v3) {
			case DC5(cf11) =>
				...
				v4[754] := cf11;
				v4[754] := f23 * f23;
				v0[149] := p0 == |fm19(globalState)|;
				var v5: seq<bool> := [v0[149], v0[149], v0[149], v0[149]];
				var v6 := "psdjbd";
				var v7: map<seq<bool>, seq<int>> := map[v5 := [cf11] + [|v6|, 965]];
				var v8: seq<int> := [cf11];
				v7 := v7[v5 := v8];
				v0[149] := v4[754] != |(fm20(f23, p1, globalState))[0x84 := cf11]|;
			case DC4(cf10) =>
				var v9: multiset<int> := multiset{f23, f23, f23};
				var v10: map<bool, multiset<int>> := map[v0[149] := v9];
				var v11 := new C4((if (v0[149] in v10) then v10[v0[149]] else fm36(p0, p0, globalState)) > fm36(f23, p0, globalState), p0);
				v0, globalState.f8, globalState.f8 := v0, p0, f23;
				var v12 := "npn";
				globalState.f5 := v12;
				v0[149] := v11.f32;
			case DC6(cf12) =>
				var v13 := new C3(v0[149], v0[149]);
				var v14 := 'x';
				var v15 := DC43("gmmwlywj", v0[149], 0x24e, v13.f33, fm0(globalState));
				var v16: map<D15, char> := map[v15 := p1];
				var v17 := "yqcn";
				v14 := if (DC43(v17, !v0[149], p0, false, p1) in v16) then v16[DC43(v17, !v0[149], p0, false, p1)] else v14;
				var v18: T2 := new C8(f23, f23);
				var v19: seq<int> := [-(-|{v18}| % f23), v18.f23, -p0 - v18.f23];
				r1 := v19[v18.f23];
				var v20 := new C1(v17 <= v17, fm0(globalState), v18.f23);
		}
		
		if (if (v0[149]) then v0[149] else v0[149]) {
			var v21: array<D2> := new D2[2];
			var v22: seq<int> := [f23];
			var v23 := DC4(v22);
			v21[813] := v23;
			var v24 := "mob";
			var v25: multiset<string> := multiset{v24[f23 := p1]};
			globalState.f8, v0[149], globalState.f8, r1, v21[813] := -f23, v0[149], p0, |v25| / f23, v23.(cf10 := [f23]);
			var v26: array<multiset<bool>> := new multiset<bool>[19];
			var v27: map<array<multiset<bool>>, bool> := map[v26 := v0[149]];
			v27 := v27[v26 := v0[149]];
			var v28: array<int> := new int[10];
			var v29: seq<bool> := [v0[149], v0[149]];
			var v30: map<seq<bool>, bool> := map[v29 := v0[149]];
			v28[471] := 0x55 * fm18(v30, globalState);
			v28[471] := -(f23 + f23);
			var v31: array<char> := new char[7](i0 => p1);
			v31[14] := p1;
			v31[14] := p1;
			var v33: map<char, bool> := map[p1 := v0[149]];
			var v34: map<D2, bool> := map[v3 := v0[149]];
			var v35: map<bool, bool> := map[fm16(f23, v34, p0, globalState) := v0[149]];
			var v36: array<map<char, bool>> := new map<char, bool>[6] [map v32 : char | v32 in v33 :: (v32) := (v0[149]), v33, map[v31[14] := if (v0[149] in v35) then v35[v0[149]] else v0[149]], v33, map[p1 := v0[149]] + v33, v33];
			var v37: map<int, bool> := map[p0 := v0[149]];
			var v38: set<bool> := {v0[149], false, !v0[149], !v0[149], v0[149]};
			v36, v28[471], v0[149], r1, v0[149] := v36, |((v37 + v37) + map[v28[471] := true])|, true, |{|v37|, |v38|}|, v0[149];
		} else {
			v0 := v0;
			var v39 := "gqcjtuju";
			var v40: seq<int> := [|v39|];
			var v41: array<multiset<bool>> := new multiset<bool>[14](i1 => multiset{!v0[149]} - multiset{v0[149], v0[149]});
			var v42: seq<bool> := [v0[149], v0[149]];
			var v43: multiset<bool> := multiset{v42[f23]};
			v41[338] := v43;
			var v44: array<array<bool>> := new array<bool>[18];
			v44[708] := v0;
			v40, v41[338], v44[708] := v40, multiset{false, v0[149] <==> v0[149], fm2(globalState), p0 > f23}, v0;
			if (p0 >= p0) {
				var v45 := new C0(v0[149], v0[149]);
				var v46: array<int> := new int[29];
				v46[816] := -0xf6;
				v46[816] := f23;
				v0[149], v0[149], v46 := v0[149], true, v46;
				v0[149] := v45.f38 ==> v45.f38;
				var v47: array<multiset<int>> := new multiset<int>[19];
				var v48: multiset<int> := multiset{v46[816], p0, v46[816]};
				v47[625] := v48;
				var v49 := DC53(f23, v39, |v42|);
				var v50: set<int> := {p0};
				var v51: seq<set<int>> := [v50];
				var v52: map<set<set<int>>, string> := map[{v51[f23]} := v39];
				...
				var v56: seq<string> := [v39, v39, v39, v39[f23 := p1]];
				var v59 := DC23(set v58 : int | (0x2a8 <= v58) && (v58 < 0x125) :: (v58 / f23));
				v0[149], v46[816], v47[625], v54, v0[149] := v45.f38, (if (p1 in v55) then v55[p1] else v46[816]) / v46[816], v48[|v39| := p0], multiset(v56) + v54, !((set v57 : int | (514 <= v57) && (v57 < -0x2bf) :: (v57 + |"k"|)) < DC23(v59.cf42).cf42);
			} else {
				v0[149] := v0[149];
				var v60: map<bool, string> := map[v0[149] := "btbjjh"];
				var v61: array<string> := new string[14] ["pig" + v39, "embbkf" + (seq(0x2ce, i2  => (p1))), v39, if (true in v60) then v60[true] else v39, v39, "bglbe", DC53(|v1|, v39, 27).cf95, "lhqfgdqjs", v39, "stnpiygrn", seq(0x21f, i3  => (p1)), v39, v39 + v39, v39];
				v61[68] := v39;
				v61[68] := v39[p0 := p1];
				var v62 := new C3(false, v0[149]);
				var v64: multiset<seq<bool>> := multiset{[v0[149]], v42, v42};
				r1 := p0 % (if (v62.f33) then p0 else fm18(map v63 : seq<bool> | v63 in v64 :: (v63) := (v62.f33), globalState));
				v0[149] := v42[fm1(globalState)];
			}
			...
			var v70: array<multiset<array<D9>>> := new multiset<array<D9>>[25] [multiset{v66} * v67, v67, v68.cf118, v67, if (fm2(globalState)) then v67 else multiset{v66}, v67 * v67, v67, v67, v67, v67, v67, v67[v66 := f23] * v67, v67, v67, if (false) then v67 else v67, v67 + multiset{v66}, v68.cf118, multiset{v66, v66}, multiset{v66, v66, v66}, v67, v67 - v67, DC71(multiset{v66}).cf118 - (multiset{v66, v66})[v69[|v39[|[f23]| := p1]|] := p0], v67, v67 * multiset{v66, v66, v66, v66, v66}, v67 + v67];
			v70[52] := v67;
			var v71: set<bool> := {v0[149]};
			var v72: array<int> := new int[11] [p0 + -0x100, f23 * |v39[f23 := p1]|, f23, fm1(globalState) % |v41[338]|, p0, p0, |v71| - 447, p0, f23, p0, p0];
			var v73: multiset<char> := multiset{p1};
			v72[311] := |(v73 * v73)|;
			v70[52], v72, v72[311] := v67, if (f23 < 0x17b) then v72 else v72, -f23;
		}
			...
			decreases 100 - i6
		{
			...
			var v77 := 's';
			v77 := fm0(globalState);
			v0, globalState.f8, globalState.f8, r1 := v0, (if (v0[149]) then p0 else p0) % -p0, -0x21b + f23, v74[f23];
		}
		r1 := p0 % f23;
		...
		r0 := v78;
		var v79: map<bool, bool> := map[v0[149] := v0[149]];
		r1 := |v79[true := v0[149]]|;
	}
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		if (p1) {
			...
			match (v1) {
				...
				case DC59(cf103) =>
					...
					var v13: array<int> := new int[21](i1 => i1 / f23);
				...
				case DC61(cf106) =>
					...
					v15, v0[932], globalState.f8, v18[793], globalState.f8 := v15[0x229 := fm2(globalState)], if ((if (fm2(globalState)) then !p1 else p1) in v19) then v19[if (fm2(globalState)) then !p1 else p1] else p1, -(f23 % f23), v16, f23;
			...
			var v30: array<int> := new int[21] [f23, f23, |v21|, if (p1) then -969 else f23, f23 - f23, v22.cf4, |(v25.cf125 + map[v23 := !p1])|, f23 * f23, f23, f23, f23, f23 - f23, DC9(p1, f23, p1, v27[f23], --f23).cf20, |v21|, f23 + f23, f23, |v29|, f23, f23, fm1(globalState), f23 % -0x10b];
			var v31: map<int, int> := map[f23 := fm1(globalState)];
			v30[719] := f23 * |v31|;
			globalState.f5, v30[719] := p2 + p2, f23;
			v31 := fm64(globalState);
			var v32 := new C7(f23);
			var v33: multiset<bool> := multiset{p1};
			var v34: map<int, multiset<bool>> := map[v30[719] := v33];
			var v35: seq<map<int, bool>> := [map[v30[719] := p1]];
			var v36 := DC25(|v33|);
			var v37: map<multiset<bool>, D9> := map[if (|v35[v30[719]]| in v34) then v34[|v35[v30[719]]|] else v33 := v36];
			v37 := v37[multiset{fm2(globalState)} := v36];
		} else {
			var v38: multiset<string> := multiset{"kxw"};
			globalState.f8 := |v38|;
			r1 := p1;
			var v39 := DC36(DC4(seq(0x8b, i2  => (|p2|))), p1);
			var v40 := DC38(DC38(v39));
			...
			if (([v43] + v44) < [v44[f23], v43, v43]) {
				...
				var v55: seq<set<int>> := [v52, v52, v52 + v52, v52 + (set v54 : int | v54 in v53[f23] :: (v54 * 0x164)), v52 * {|p2|, f23}];
				r2, v55 := 0xe0, v53;
				var v56: seq<seq<bool>> := [[p1]];
				var v57 := DC51(v56[f23]);
				v57 := v57;
				var v58: map<bool, char> := map[p1 := p2[f23]];
				v58 := v58;
			} else {
				v43[89] := |p2|;
				v43[89] := -f23;
			...
			v63[854], v64, v66, r1, r1 := f23 == f23, map v67 : char | v67 in fm34(globalState) :: (v67) := (p2), v66, if (p1) then p1 else fm2(globalState), p1;
		}
		...
		v68, v70[426], r1, v71[548], r1 := v68, f23, p1, -(f23 - f23) <= f23, v74[|v75|];
		var v76: map<int, bool> := map[v70[426] := p1];
		v76 := v76[|fm100(v71[548], v70[426], p1, globalState)| := 0x320 <= 0x17e];
		if (v71[548]) {
			v71[548] := p1;
			var v77: map<bool, bool> := map[v71[548] := p1];
			var v78 := DC30(v77);
			var v79: map<string, D11> := map["qvkhroqlg" := v78];
			r2, v79 := f23 * f23, v79;
			var v80 := new C9(p2 + p2, v70[426]);
			globalState.f5 := p2;
			var v81: seq<int> := [|p2|];
			var v82 := DC27({p1});
			var v83: map<seq<bool>, bool> := map[v74 := p1];
			var v84: map<D10, int> := map[v82 := fm18(v83, globalState)];
			var v85: map<int, int> := map[v81[|v84|] := f23];
			v85 := v85[v70[426] / f23 := 0x33 / f23];
		} else {
			v70[426] := f23 + (f23 - |"bjeo"|);
		...
		var v90: seq<int> := [v70[426]];
		var v91 := DC4(v90);
		var v92 := DC36(v91, v71[548]);
		var v93: map<D13, seq<bool>> := map[v92 := v74];
		v93 := v93[v92 := v74];
		if (p1) {
			v76 := v76[v70[426] := v70[426] < |fm94(v71[548], p0, globalState)|];
			v90 := v90;
			r2 := 127;
			var v94 := DC45(f23, p1);
			var v95: map<bool, int> := map[!v71[548] := v94.cf81];
			var v96: set<int> := {|{v71[548]}|};
			v71[548] := !((v95 == v95) <==> (fm49(-157, 0x299, globalState) >= v96));
			r1, v70[426], globalState.f8, v71[548], v71[548] := p1, v70[426], |("hyfyftv" + p2)| * (f23 - f23), (343 < --0x11) <== p1, v71[548];
		} else {
			var v97 := DC16(fm0(globalState));
			v97 := DC16(p3);
			var v98: map<bool, bool> := map[v71[548] := p1];
			var v99 := new C6(if (p1 in v98) then v98[p1] else p1, p2, f23);
			var v100: map<bool, char> := map[v71[548] := p3];
			var v101: seq<map<bool, char>> := [v100];
			v101 := v101 + (seq(0x23c, i7  => (v100)));
			globalState.f8 := f23;
			var v102, v103, v104, v105 := m0(v90 != (seq(898, i8  => (f23))), globalState);
		}
		
		r0 := v70;
		r1 := ((p2[v70[426] := p0] + p2)[v70[426] := p3])[|v76| := p3] == p2;
		r2 := |((if (v74[f23]) then fm34(globalState) else seq(0x233, i9  => (p3))) + (p2 + p2))|;
	}
	method m12(p0: array<int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		var v0 := DC5(f23);
		...
		if (!fm16(f23, v1, f23, globalState)) {
			...
			var v4: map<int, seq<array<bool>>> := map[p1[27] := [v2] + v3[f23 := v2]];
			v4 := v4[p1[27] := v3];
			var v5: set<int> := {f23, p1[27]};
			...
			var v13: seq<seq<int>> := [v7[p1[27] := -|v7|], v7, seq(-0x21f, i1  => (f23))];
			v5, p1[27], r1, v7, globalState.f8 := set v8 : int | v8 in v7 :: (v8 - (0x10e % |(map v9 : int | (-0x2c4 <= v9) && (v9 < 461) :: (v9 * |map[|{false}| := false]|) := (|"ttncljjas"|))|)), |v10|, p2, fm86(p2, |v12|, globalState) + v13[f23], p1[27];
			p1[27] := f23;
		} else {
			var v14: seq<bool> := [p3];
			...
			var v18 := "hvjsoq";
			var v19 := 't';
			var v20 := DC76(v17[p3 := p3], p3, v18[f23 := v19], p2);
			v16[893] := v20.cf129;
			var v21: multiset<bool> := multiset{p3, p3, p2, !p2};
			v16[893] := v21 <= multiset{p2, p2, p3, !p2};
			var v22 := new C0(v16[893], !p2);
			var v23: map<bool, int> := map[false := f23];
			var v24 := new C1(v23 == v23, v19, |v15|);
			var v25: map<bool, array<int>> := map[v22.f39 <==> v22.f39 := p1];
			v16[893], r2, v25 := p2, (|(set v26 : int | v26 in v15 :: (v26 + |"gjsvnaaad"|))| - f23) % |v14|, v25 + v25;
		}
		...
		for i2 := -f23 to -|v27| {
			...
			p1[9] := if ((seq(0x1c9, i3  => (i2))) <= [f23]) then |v28| else fm18(map[v29 := false], globalState);
			var v30: map<int, int> := map[p1[9] := p1[9]];
			var v31: seq<int> := [fm18(map[v29 := p3], globalState), f23];
			v30 := v30[p1[9] := v31[i2]];
			if (p3) {
				var v32: multiset<bool> := multiset{!!fm2(globalState), p2, p3 <== p2};
				p1[9], v32, p1[9] := f23, v32[p1[9] == p1[9] := -0x329], -(if (true) then p1[9] % |v30| else -422 * p1[9]);
				...
				var v38: multiset<int> := multiset{p1[9]};
				var v39 := new C8(i2, f23 - (if (p1[9] in v38) then v38[p1[9]] else f23));
				globalState.f8 := v31[p1[9]];
				var v40: multiset<bool> := multiset{true, p2, !fm16(i2, v1, |(seq(920, i4  => ('y')))|, globalState), p3};
				r1 := (f23 + v39.f41) <= |v40|;
			}
			...
			decreases 100 - i6
		{
			...
			i6 := i6 + 1;
			var v54: map<int, bool> := map[p1[9] := p2];
			if (if (f23 in v54) then v54[f23] else fm2(globalState)) {
				...
				r1 := DC26(v57, p2, p1[9], p1[9]).cf46;
			} else {
				var v58: map<int, int> := map[f23 := f23];
				v58 := map v59 : int | (477 <= v59) && (v59 < 0x22b) :: (v59 % p1[9]) := (p1[9]);
				v41 := v41;
				p1[9] := -(p1[9] % p1[9]);
			...
			match (v68) {
				...
				case DC39(cf70) =>
					...
					v47[508] := !(if (p3) then p2 else v73.f34);
				...
				case DC41(cf73) =>
					...
					v63 := (v82 + v82) != v82[|v27| := true];
					var v83: multiset<int> := multiset{f23 + v81.f41, f23, v64};
					r2 := -|v83|;
					globalState.f8 := |fm51(true, v64 % |map[v62 := p1[9]]|, globalState)|;
			}
			
			var v84: array<multiset<int>> := new multiset<int>[27](i10 => multiset{v64, p1[9]} - multiset{--p1[9]});
			var v86: multiset<int> := multiset{f23, |(map v85 : int | (-0x264 <= v85) && (v85 < 0x1b1) :: (v85 + f23) := (map[p2 := p2]))|};
			v84[510] := v86;
			var v87: seq<multiset<int>> := [multiset{p1[9]}];
			v84[510] := v87[0x215];
		}
		r0 := p1;
		r1 := p2;
	...
	method m13(p0: string, p1: set<int>, p2: array<int>, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v3[725] := p2;
			v3[725] := p2;
			var v4: map<int, array<int>> := map[fm1(globalState) := v3[725]];
			var v5: map<int, int> := map[|v4| := f23 / f23];
			globalState.f8 := if (f23 in v5) then v5[f23] else f23 % |fm36(f23, 0x365, globalState)|;
			var v6 := true;
			v6 := v6 && (-f23 == f23);
			...
			match (v11) {
				...
				case DC82(cf139) =>
					...
					var v28: array<bool> := new bool[18] [p3, 0x37c >= f23, v6, v6, !v23.cf66, p3, if (fm103(globalState) in v25) then v25[fm103(globalState)] else v6, p3, v6, fm1(globalState) >= f23, v6, v6, p3, p3, if (v20[f23] in v26) then v26[v20[f23]] else p3, v6, v6, v27 >= v27];
					v28[616] := if (v2[f23]) then v6 else p3;
					v28[616] := f23 < f23;
					v7 := v7[false := f23];
					var v29 := 'a';
					globalState.f8, v28[616], v29, v28[616] := -0xf9 + f23, v6, v29, !!v2[0x28c];
				case DC85(cf145) =>
					...
					p2[718] := 782;
					p2[718] := (f23 - f23) + |p1|;
					var v32: multiset<array<int>> := multiset{v3[725]};
					v32 := multiset{v3[725]} * multiset{v3[725]};
					globalState.f8 := p2[718];
			}
		...
		match (DC74(v37)) {
			case DC75() =>
				...
				v39, v38[496], v38[496] := p2, v38[496], if (p3 ==> true) then v38[496] else fm2(globalState);
				v35 := v35;
				globalState.f8 := f23;
			...
			case DC77(cf130, cf131, cf132, cf133, cf134) =>
				...
				var v66: array<array<bool>> := new array<bool>[20] [v62, v62, v62, v62, v62, v62, if (if (cf131 in v46) then v46[cf131] else cf132) then v62 else v62, v64[f23], v62, v62, v62, v62, v62, v62, v64[cf131], v62, v62, if (p0 in v65) then v65[p0] else v62, v62, v62];
				v66[368] := v62;
				v66[368] := new bool[12];
				cf130 := fm94(true, v35, globalState) >= v45;
				var v67 := new C4(cf132, f23);
			case DC74(cf125) =>
				var v68: map<string, int> := map[p0 := fm1(globalState) / f23];
				v68 := v68[p0 := 910];
				var v69 := new C3(p3, p3 ==> v2[f23]);
				var v70: array<char> := new char[8](i3 => v35);
				var v72: map<bool, array<char>> := map[fm16(|(map v71 : int | (523 <= v71) && (v71 < 0xe1) :: (v71 % |map[v69.f34 := f23]|) := (v69.f33))|, v1, f23, globalState) := v70];
				var v73: seq<array<char>> := [v70, v70, v70];
				var v74: seq<int> := [|v2|, f23, 0x24b, f23];
				var v75: array<array<char>> := new array<char>[28] [v70, v70, if (v69.f34 in v72) then v72[v69.f34] else v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v70, v73[|v74|], v70, v70, v70, v70, v70, v70, v70, v70, v70];
				v75 := v75;
				var v76: multiset<bool> := multiset{false, p3, v69.f33, false};
				match (fm104(if (p3 in v76) then v76[p3] else |p0|, !v69.f33, f23 / f23, globalState)) {
					case DC45(cf81, cf82) =>
						globalState.f8 := cf81;
						globalState.f8 := f23;
						cf82 := f23 != (|(seq(-0x184, i4  => (v35)))| / cf81);
						var v77: array<map<char, D2>> := new map<char, D2>[23](i5 => map[v35 := DC6(DC4(v74))]);
						v77 := v77;
					case DC44(cf80) =>
						var v78 := new C0(true, v69.f34);
						v74 := v74;
						var v79: map<bool, int> := map[p3 := |([-0x2c, |(seq(0x1c3, i6  => (v35)))|, f23])[|p0| := -f23]|];
						...
						var v83: map<map<int, map<char, bool>>, bool> := map[v82[f23] := v69.f34];
			...
			decreases 100 - i8
		{
			...
			i8 := i8 + 1;
			globalState.f8 := f23;
			if (!(if (p0 <= p0[fm1(globalState) := v35]) then p3 else v101)) {
				var v103 := DC63(p3);
				...
				globalState.f8 := fm1(globalState) % |v124|;
				globalState.f19 := p0;
				var v125 := new C6(v101, p0, v102.f41);
				v101 := v101;
				var v126: map<int, int> := map[v102.f41 := |(seq(571, i10  => (v35)))|];
				var v127: seq<int> := [v102.f41, v102.f41];
				var v128: seq<seq<int>> := [v127, v127, v127];
				v126 := v126[|v125.f30| := |v128[v102.f41]| % v102.f41];
			}
...
class C11 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		var v4: map<bool, int> := map[v0 := |v3[f23 := v2]|];
		...
		v9[585] := (map[v0 := f28])[v0 := -fm1(globalState)];
		var v10: map<array<int>, char> := map[v2 := fm0(globalState)];
		v9[585], v0, globalState.f8, globalState.f8, v0 := v4, true && !v0, f28, -(239 - f23), v10 != v10;
		var v11: seq<int> := [f28];
		var v12: seq<bool> := [v0];
		var v13: map<int, bool> := map[v11[|(fm14(-945, v0, p0, globalState))[f23 := |v12|]|] := v0];
		var v14 := "oblfoaek";
		v13 := v13[f28 := v14 <= v14];
			...
			decreases 100 - i0
		{
			...
			if (v0) {
				...
				var v20: array<seq<bool>> := new seq<bool>[9] [([false])[|"nqclfplg"| := true], v12, v12, v12, v12, v12, v12, v12, fm42(true, v16.f34, v0, v0, globalState)];
				...
				v19, v16.f33, v21[631] := v19, !(v8[fm2(globalState) := 0x89] !! v8[v0 := if (v14 in v22) then v22[v14] else 0x335]), v20;
			} else {
			...
			v16.f33 := v16.f34;
			v6[714] := fm0(globalState);
			var v31 := DC4([0x205]);
			var v32: set<D2> := {v31};
			var v33: map<set<D2>, char> := map[v32 := p1];
			v6[714] := if ((v32 + v32) in v33) then v33[v32 + v32] else fm0(globalState);
		}
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		if (!p1) {
			if (fm2(globalState)) {
				...
				var v2: multiset<int> := multiset{|v1[f28]|};
				var v3: map<bool, bool> := map[!v0.f36 := v0.f36];
				var v4 := DC30(fm75(f28, |v2[f23 := |v2|]|, v0.f36, p1, globalState) + v3);
				v4, globalState.f8 := v4, fm1(globalState);
				var v5: map<int, int> := map[f28 := f23];
				var v6: T2 := new C9(("gdpgy")[|multiset{f28, f23}| := v0.f37], if (f28 in v5) then v5[f28] else 0x1a4);
			...
			v13[334] := fm1(globalState);
			v13[334] := f23;
			v13[334] := f28;
			var v14: seq<int> := [v13[334]];
			var v15: seq<int> := [|(if (p1) then v14 else seq(23, i0  => (v13[334])))|];
			var v16: multiset<bool> := multiset{p1, p1, p1, p1, p1};
			var v17: seq<seq<int>> := [v14 + [|v16|], v15, [v13[334], v13[334], f28, v13[334]]];
			v14 := v17[v13[334]];
			var v18: seq<bool> := [p1];
			v18 := v18;
		} else {
			...
			var v22 := DC53(861, seq(0x27b, i1  => ('v')), |v21|);
			v19[914] := v22.cf94;
			...
			v24[685] := v25 !! v25;
			v19[914] := -v19[914] / --v19[914];
			var v26: map<seq<char>, bool> := map[p2 := !v24[685]];
			v24[685] := if (v22.cf95 in v26) then v26[v22.cf95] else v25 < v25;
		}
		...
		for i4 := f28 to f28 {
			...
			if (p1 in v32) {
				...
				var v37 := DC25(f23);
				v36[424] := 0x3da / v37.cf44;
				v36[86] := i4 / f28;
				v36[424], r1, v32, r1, v36[86] := |(v35.f40 + "lhoegqba")|, f23 <= |v30.f40|, v32, p1, -(f28 + i4);
				...
				var v43: map<array<char>, seq<bool>> := map[v40 := v41 + v42[v39.f41]];
				v43 := v43[if (p1) then v40 else v40 := v41];
				var v44: multiset<bool> := multiset{p1};
				var v45: array<int> := new int[22](i5 => i5 % f23);
	...
	method m11(p0: map<int, T0>, p1: array<bool>, globalState: GlobalState) returns (r0: set<int>, r1: array<bool>, r2: bool, r3: set<bool>) {
		...
		if (v0) {
			...
			var v3 := 'q';
			v0, v0, v0 := v1 != (map[v0 := v0] + fm75(f23, if (v3 in v2) then v2[v3] else f23, v0, true, globalState)), v2[v3 := f23] !! v2, v0;
			globalState.f8 := -f23;
			var v4 := DC30(v1);
			var v5: seq<map<bool, bool>> := [v4.cf56];
			var v6 := DC76(v5[f28], fm2(globalState), "eyov", v0);
			var v7 := "eqeerdhxh";
			var v8: map<D30, string> := map[v6 := v7];
			var v9: seq<int> := [f23];
			var v10: map<bool, int> := map[v0 := v9[f28]];
			var v11 := new C6(f28 >= 0x36d, (((if (v6 in v8) then v8[v6] else "xfcfh") + v7[f23 := v3])[|v10| := v3])[f23 := v3], |v1| / f28);
			...
			if (v0) {
				...
				var v17: map<bool, int> := map[v15.f33 := f28 / |v16|];
				v17 := v17;
				v15.f33 := v15.f33;
				globalState.f8 := f28 / f28;
			}
			...
			match (v24) {
				case DC5(cf11) =>
					...
					v25[642] := if (v0) then cf11 else f28;
					v25[642] := |(seq(-0x131, i0  => (v21)))|;
				...
				case DC6(cf12) =>
					r2 := fm2(globalState);
					globalState.f8, r2 := f23 / v23[f28], (0xb6 - f28) != (f23 + f23);
					var v30: array<C3> := new C3[16];
					var v31: C3 := new C3(v0, v0);
					v30[453] := v31;
					var v32: map<int, int> := map[f23 := f23];
					v30[453] := if (-f23 !in v32) then v31 else v31;
					globalState.f8 := f23;
			}
			
			var v33: array<int> := new int[9] [fm1(globalState), f28, f28, f28, f23, f23, f28, f23, f28];
			v33[265] := |v23| + f23;
			r2, v33[265] := f23 == (f23 + |v19.f40|), (f23 / |v19.f40|) * (v20.(cf17 := f23, cf14 := f28)).cf18;
		}
		
		globalState.f8 := f28;
		var v34: T0 := new C10(f23);
		var v35: seq<bool> := [v0];
		var v36: multiset<bool> := multiset{v35[v34.f23], v0, v0, v0};
		var v37: seq<multiset<bool>> := [v36, fm87(v34.f23, v0, f23, v0, globalState)];
		var v38: seq<map<int, T0>> := [p0, map[f28 := v34], map[f28 := v34], p0, map[|v37[f23]| := v34]];
		var v39: array<int> := new int[5];
		var v40: map<int, array<int>> := map[|v38[f28]| := v39];
		v40 := v40[f28 := v39];
		...
		r0 := match v48 {
			case DC19() => v46 - v46
			case DC20(cf34, cf35) => set v49 : int | (0xb4 <= v49) && (v49 < 0x0) :: (v49 / |cf35|)
...
class C12 {
	...
	method m9(globalState: GlobalState) returns (r0: int) {
		...
		globalState.f8 := |(((if (v0 in v3) then v3[v0] else v1 + v1)[f27 / |v5| := f26])[v4.f23 := f26])[f27 := f26]|;
		...
		if ((v8 + (v11[f27])[v4.f23 := 0x26b]) == v10) {
			...
			if (v4.f23 !in (multiset(v8) - v15)) {
				...
				globalState.f8 := |(if (v6[537]) then v1 else v1)| / (if (v4.f23 in v15) then v15[v4.f23] else --|v16|);
				var v17 := DC80();
				var v18: map<D31, bool> := map[v17 := !v6[537]];
				var v19: array<int> := new int[20] [|(seq(-258, i0  => (v4.f23)))|, v4.f23, v4.f23, |v7|, fm1(globalState), v4.f23, v4.f23, v4.f23 % 412, v4.f23 - v4.f23, v4.f23, v4.f23, 0x18a, 451 + 284, fm1(globalState), v4.f23, v4.f23, v4.f23 - v4.f23, -v4.f23, v4.f23, |v18|];
				v19 := v19;
				v15 := v15;
			} else {
				var v20: multiset<array<bool>> := multiset{v6};
				v20 := (v20 - multiset{v6}) * (multiset{v6} * v20[v6 := v4.f23]);
				var v21: seq<array<bool>> := [if (v6[537]) then v6 else v6];
				v21 := v21;
				var v22: C3 := new C3(v6[537], v0);
				var v23: seq<C3> := [v22];
				v23 := v23;
				var v24: array<string> := new string[21];
				v24[339] := seq(0x1a2, i1  => (f26));
				var v25: array<array<seq<int>>> := new array<seq<int>>[3];
				var v26: array<seq<int>> := new seq<int>[23];
				v25[19] := v26;
				v24[339], r0, v6[537], globalState.f19, v25[19] := (v1 + v1) + v1, |(v15 * (v15 - v15))|, v0 ==> v22.f34, v1, v26;
				var v27 := DC3(f27, v4.f23, v4.f23, v4.f23, v6[537]);
				v0, v22.f33 := fm2(globalState), v27.cf9 ==> v0;
			}
			
			if (!((0xd7 % v4.f23) >= v4.f23)) {
				var v28 := DC87(v6[537], v4.f23);
				var v29 := DC88(v28);
				var v30 := DC88(v29);
				var v31 := DC88(v30);
				var v32: map<bool, D33> := map[v6[537] := v31];
				var v33: seq<map<bool, D33>> := [map[v6[537] := v31], v32, v32];
				v33 := v33;
				var v34: map<bool, char> := map[v6[537] := f26];
				...
				var v39: map<bool, map<int, bool>> := map[v6[537] := v38];
				v37 := v37[fm106(f27, f27, globalState) := (if (v6[537] in v39) then v39[v6[537]] else v38) + v38];
				v0 := v6[537];
				v3 := v3[v6[537] := v1];
				var v40: multiset<map<int, int>> := multiset{fm89(globalState)};
				var v41: map<int, int> := map[v4.f23 := v8[0x316]];
				v40, v6[537] := (fm107(v0, 0x215, f26, globalState) * v40) + v40[v41 := -f27], v4.f23 < v4.f23;
			} else {
				...
				var v46 := DC43(v1 + v1, v6[537] || v0, -|v15|, v6[537], v1[|v1|]);
				v46 := v46;
				v6[537] := v6[537];
				v6[537] := v4.f23 > 0x227;
			}
		...
		r0 := -(f27 % (if (!v6[537]) then v4.f23 else v4.f23));
	}
	method m10(p0: D2, p1: int, globalState: GlobalState) returns (r0: int, r1: array<bool>, r2: bool) {
		...
		var v4 := DC76(v3, v0, seq(177, i0  => (f26)), v0);
		...
		var v10: map<string, array<bool>> := map[v8[p1] := v9];
		v10 := (v10 + v10) + v10[v7 := v9];
		var v11 := 'f';
		v11 := f26;
		for i2 := -(f27 % v2.f31) to -f27 * v2.f31 {
			...
			var v16 := DC60(v9, v11);
			var v17: array<char> := new char[26] [v11, v11, v2.fm15('p', globalState), v11, 'e', f26, v11, v11, f26, f26, v11, f26, 'i', f26, f26, f26, v16.cf105, v11, if (fm2(globalState)) then v7[v2.f31] else f26, v11, f26, f26, f26, 'q', 'e', v11];
			v17[821] := f26;
			v17[821] := v2.fm15(f26, globalState);
...
class C13 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		var v12: seq<bool> := [v3];
		v3, v4[799], v7 := match v8.(cf14 := |(if (v3 in v10) then v10[v3] else v9)|, cf16 := v3, cf15 := v3, cf17 := f23) {
		...
		}, v0, fm9(true || v3, v11 + v11, !(fm10(v12, false, v0[583], globalState) > multiset{v3}), globalState);
		if (true) {
			if (v3) {
				var v13: map<int, seq<bool>> := map[0xee := v12];
				var v14: map<seq<bool>, bool> := map[if (0x271 in v13) then v13[0x271] else v12 := v3];
				var v15: map<char, array<int>> := map[p1 := v4[799]];
				v3 := |v14| != (f23 % |v15|);
				var v16 := DC5(f23);
				...
				v3 := (v19 != v19) && v3;
				var v20: set<int> := {v0[583]};
				var v21: map<bool, bool> := map[p1 !in v2 := v20 > {f23, p0}];
				v21 := v21[v3 := v21 == v21];
			} else {
				v3 := v3;
				globalState.f5 := fm11(v1, -|(seq(0x1ac, i1  => ('f')))|, globalState);
				r1 := 0x10a;
				...
				v26[249] := fm12(v3, globalState);
				var v27: seq<map<array<bool>, bool>> := [v25, v25];
				globalState.f8, v25, v26[249] := v1[v0[583] * p0], v27[-p0 % -v0[583]], [v3, v3];
			}
			...
			if (v3) {
				...
				var v32: set<array<int>> := {v0, v4[799], v0, v4[799], if (v12[p0] in v31) then v31[v12[p0]] else v4[799]};
				v32 := v32;
				...
				var v39: map<bool, int> := map[if (fm1(globalState) in v9) then v9[fm1(globalState)] else false := v0[583]];
				var v40: set<string> := {v38[|v39|], v2, v2, v2, v2 + v2};
				var v41: array<D1> := new D1[2];
				var v42: multiset<array<D1>> := multiset{v41};
				globalState.f8, v37, v3, globalState.f8, v40 := v0[583], v37 - (v37 + v37), true, |(v42 * v42)|, fm108(globalState) + v40;
				v3 := true;
				v3 := v3;
				var v43 := DC56(v3, f23);
				var v44 := DC57(v43);
				var v45: array<D22> := new D22[12] [DC57(DC57(v43)), DC57(v43).(cf101 := DC56(v3, v0[583])), v44, if (fm2(globalState)) then v44 else v44, v44, DC57(v43), DC57(v43), v44, v44, DC57(v43), v44, v44];
				v45[113] := v44;
				var v46: array<bool> := new bool[3](i4 => v3);
				v46[390] := v3;
				r1, v45[113], v3, v46[390] := fm1(globalState) % (if (v3) then if (0xc9 in v11) then v11[0xc9] else p0 else f23), v44.(cf101 := v43), v12[-0x2a4], !(p0 >= (v0[583] % f23));
				v3, v46, v46[390], v0[583] := fm2(globalState), v46, !fm2(globalState), v0[583] * (f23 % p0);
			}
			
			v3 := fm2(globalState);
			var v47: seq<seq<bool>> := [v12, v12, v12, v12, v12];
			var v48 := new C2(v47[|v11|], |fm85(v3, globalState)|);
			if (v3) {
				v3 := v3;
				globalState.f19 := (seq(-0x1d0, i5  => (p1)))[p0 := f25];
				v0[583], v3, v3, v0[583] := f23, fm1(globalState) <= f23, v3, v1[f23];
				var v49: multiset<int> := multiset{p0};
				globalState.f8 := (|v49| - |[p0]|) / -v0[583];
				var v50: array<bool> := new bool[14];
				v50[53] := v3;
				v50[53] := if (v3) then v3 else v3;
			} else {
				v3 := fm2(globalState);
				v0[583] := |fm89(globalState)|;
				v3 := f23 != p0;
				var v51: set<string> := {v2};
				var v52: seq<set<string>> := [v51, v51];
				var v53: multiset<set<string>> := multiset{v51, v52[-p0]};
				var v54: seq<string> := [v2];
				var v55: multiset<bool> := multiset{v3, v3};
				globalState.f8 := (p0 / p0) / (if ({v2, v2, fm34(globalState), v54[-431], v2} in v53) then v53[{v2, v2, fm34(globalState), v54[-431], v2}] else |v55|);
			...
			var v59: seq<string> := [v2, v2, v2, seq(993, i7  => (f25))];
			var v60: set<int> := {p0};
			...
			var v65: array<string> := new seq<char>[27] [(seq(0x75, i6  => (v2[304]))) + ((v2[|v12| := 'g'])[|v1| := f25])[v0[583] := p1], v2, v2, v2, v2, v2, v2, v59[|v60|], v2, if (v2 in v61) then v61[v2] else v2, v2, (seq(0x386, i8  => (f25))) + (seq(0x35f, i9  => ('b'))), v2[p0 := p1] + v2, v2, v2 + v2, v2, if (v3) then "turdwlhud" else "dbhkg", v2, seq(51, i10  => (f25)), v2[if ((if (v0[583] in v9) then v9[v0[583]] else v3) in v62) then v62[if (v0[583] in v9) then v9[v0[583]] else v3] else |v63| := f25], v2, "mjehkoqm", v2[|map[|multiset{v3, v3, v3}| := if (!v3 in v64) then v64[!v3] else v3]| := f25], "v", "pqyxtqi", v2, v2 + (seq(0x6f, i11  => (p1)))];
			v65[110] := v2;
			v65[110] := v59[if (!v3) then f23 else 0x21a];
			var v66: C8 := new C8(-0x2c1, f23);
			v66 := new C8(-v0[583], f23);
			...
			v70 := v70[v67 := v68];
			v3 := (v63 - multiset{|(seq(-0x278, i12  => (p1)))|}) > multiset(v1);
			var v71: seq<multiset<int>> := [multiset(v1)];
			var v72 := new C6(|v71| in v11, v2, v66.f41);
		}
		
		var v73: array<char> := new char[15] [p1, p1, f25, 'r', 'k', 'p', 'j', f25, v2[0x1dd], f25, f25, p1, p1, f25, f25];
		forall i13 | 0 <= i13 < v73.Length {
			v73[i13] := p1;
		}
		var v74: multiset<int> := multiset{v0[583]};
		var v75: multiset<multiset<int>> := multiset{v74};
		var v76: seq<multiset<int>> := [multiset{p0}];
		r1 := |(v75 * multiset([v74] + v76))|;
		v0[583] := (v0[583] + p0) * |(v11 + map[f23 := v0[583]])|;
		r0 := new map<int, int>[6] [map[|v2| := v0[583]], v11[v0[583] := 0x385], v11, v11, v11, v11];
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		...
		var v9: seq<bool> := [p1];
		match (DC95(v8[f23], v9)) {
			case DC94(cf158, cf159) =>
				if (map[p1 := -0x300] != v2) {
					v7[126] := v6;
					r1, r2, v7[126] := fm2(globalState), f23, v6;
					r2 := |p2|;
					cf159 := p1;
					...
					v16[553] := !p1;
					v6[311] := f23;
					v6, v16, v16[553], v6[311] := v6, if (cf159) then v16 else v16, !!cf159, fm1(globalState);
					var v17: array<int> := new int[5];
					var v18: map<int, array<int>> := map[0x29a := v17];
					v6[311] := (f23 - |v18|) % |(p2 + p2)[v6[311] := f25]|;
					globalState.f8 := v6[311];
				}
				...
				if (!!p1) {
					...
					var v26: array<array<bool>> := new array<bool>[16] [DC60(v23, p0).cf104, v23, v23, v24[f23], v23, v23, v23, v23, v25.cf104, v23, v23, v23, v23, v23, v23, v23];
					v26[205] := v23;
					v26[205] := v23;
					...
					var v29 := DC36(v28, p1);
					var v30 := DC38(v29);
					v5, v6[385], r1, v30, r1 := v5, -0x297, p1, v30, f23 <= (f23 % f23);
					var v31: set<bool> := {fm2(globalState), v3 == ([f23])[v6[385] := f23], cf159};
					v31 := v31;
			...
			case DC95(cf160, cf161) =>
				...
				match (if (p1) then fm110(|(map v38 : int | (949 <= v38) && (v38 < -234) :: (v38 * |v1[p1 := p1]|) := (p1))|, map[fm2(globalState) := p2], false, f23, globalState) else DC81(f23, f23)) {
					case DC80() =>
						...
						globalState.f8, r1, v39[741], r2, globalState.f8 := if (p1) then f23 else f23, if (v7 in v41) then v41[v7] else fm2(globalState), v40, f23, if (p1) then fm1(globalState) else f23 - -f23;
						var v42 := DC92(p1);
						...
						v43, f25, globalState.f19, v6[889] := fm111(globalState), 'h', v45.cf75 + v46.cf128, f23;
						r1 := v9[-v6[889]];
					case DC81(cf137, cf138) =>
						...
						v49[464] := "m";
						var v50: seq<string> := [seq(0x3f, i2  => (p0)), p2];
						var v51: map<int, array<bool>> := map[|v50| := v47];
						v48, v3, v3, v49[464] := [if (f23 in v51) then v51[f23] else v47], ([|multiset{cf138}|] + (seq(0x1b5, i3  => (-0x2c2)))) + v3, [cf137, cf138, f23] + v3, ("qwkxxcj")[cf137 := p0] + (p2 + p2);
					case DC79(cf136) =>
						...
						v57[716] := v58;
						var v59 := DC96(v56);
						v53, v56, v57[716], globalState.f8, globalState.f8 := v53, v59.cf162 + v56, v58, f23 + f23, f23;
			...
			case DC93(cf157) =>
				if (p2 == p2) {
					...
					r0, r1, v86, globalState.f8, v87[158] := v6, (v85 / v85) <= (if (fm2(globalState) in v88) then v88[fm2(globalState)] else f23), if (("suuyo" < p2) in v89) then v89["suuyo" < p2] else v86, 147, multiset{v0} - (multiset(v90) * v91);
				...
				v105[3] := if (v106[p1 := f23] in v107) then v107[v106[p1 := f23]] else f25;
				v105[3] := p0;
				var v108: seq<string> := [p2];
				var v109: multiset<int> := multiset{|v108[f23]|};
				r1 := v109 !! v109;
				globalState.f8 := f23;
		}
		...
		var v112 := DC84(v3[f23], p1, v5 !! (set v111 : int | v111 in v5 :: (v111 % 913)));
		match (v112) {
			case DC83(cf140, cf141) =>
				var v113: map<bool, string> := map[true := p2];
				r2 := -|((if (p1) then v113 else v113) + v113)|;
				var v114: array<string> := new seq<char>[25] [(seq(-0x3d8, i6  => (p0))) + p2, "to", p2 + "snxag", p2, p2 + p2, p2 + p2[f23 := f25], p2, if (true) then p2 else p2, p2 + p2, p2, p2 + p2, (seq(952, i7  => (p0)))[-|v3| := f25], p2, p2 + p2, p2, p2, seq(-405, i8  => (f25)), "tav", p2, p2, p2, fm25(cf141, cf141, globalState), seq(238, i9  => (p0)), p2 + "toynrnh", "fuadbt"];
				v114[826] := "jv" + "tg";
				var v115: array<set<char>> := new set<char>[14];
				var v116: set<char> := {f25};
				v115[357] := v116;
				var v117: map<bool, char> := map[cf140 := f25];
				r1, v114[826], globalState.f8, globalState.f8, v115[357] := fm2(globalState), p2, cf141 - 0x3ca, fm1(globalState), if (if (f23 in v0) then v0[f23] else p1) then v116 - {if (fm2(globalState) in v117) then v117[fm2(globalState)] else f25, p0, p3, p0, if (p1 in v117) then v117[p1] else f25} else v116 * {fm0(globalState)};
				var v118 := DC12(p2);
				...
				r2, r1 := v124.cf154 * -cf141, v9[cf141];
				if (p1) {
					...
					v128[255], r1, v130, v128[255] := p1, false, v130, cf140;
					globalState.f8 := v129.f31;
				}
				
			case DC84(cf142, cf143, cf144) =>
				globalState.f8 := cf142 / -(-cf142 * f23);
				var v131: T0 := new C1(true, p3, cf142);
				var v132: map<T0, int> := map[v131 := f23];
				var v133: seq<map<T0, int>> := [v132];
				globalState.f8, globalState.f8, globalState.f8 := -cf142 * -f23, |(([map[v131 := v131.f23]] + v133) + v133)|, (cf142 / cf142) - |multiset(v9)|;
				var v134 := new C7(f23);
				var v135: multiset<int> := multiset{|p2|};
				cf142 := if (cf143 in v2) then v2[cf143] else |v135|;
			case DC82(cf139) =>
				r1 := (v9 + [p1, p1, p1, p1])[|(seq(132, i11  => (p3)))| := !fm2(globalState)] < v9;
			...
			case DC85(cf145) =>
				...
				v140[160] := p1;
				v140[160] := !(true <==> (|[f23, f23, 0x1f0, -fm1(globalState), f23]| == |"lsc"|));
				v140[160] := !true;
				var v141 := new C5(f23, |(seq(0x78, i12  => (p0)))|);
		}
		
		var i13 := 0;
		while (|v3| != (if (v9[0x29c] in v2) then v2[v9[0x29c]] else 252))
			decreases 100 - i13
		{
			if (i13 >= 100) {
				break;
			...
			if (p1) {
				...
				var v147: seq<map<D10, seq<char>>> := [v144, map v145 : D10 | v145 in v146 :: (v145) := (seq(703, i14  => (f25)))];
				var v148: map<int, seq<char>> := map[-0x1ba := p2];
				var v149 := DC98(v144);
				var v151: seq<D10> := [DC27(v142), v143, fm112(fm2(globalState), false, -931, f23, globalState)];
				var v152: array<map<D10, seq<char>>> := new map<D10, seq<char>>[29] [v144, v144, v144, v144, v147[f23], v147[0x31] + v144, v144 + v144, v144, v144, v144 + v144, v144, v144, v144, v144[DC27(v142) := p2], v144, v144, v144 + v144, map[v143 := if (|"vnkoyi"| in v148) then v148[|"vnkoyi"|] else p2], v144, v149.cf164, v144 + v144, v144, v144, v144[v143 := p2], v144, v144 + v144, map[v143 := p2], map v150 : D10 | v150 in v151 :: (v150) := ([p3, p3]), v144 + v144];
				v152[818] := map[v143 := seq(0x37b, i15  => (p0))];
				v152[818] := v147[0x3cd] + v144;
				v6[722] := f23 / f23;
				var v153: array<char> := new char[25];
				v153[434] := p3;
				var v154 := DC33(f23, p1, p1, p1);
				globalState.f8, r1, v6[722], v153[434] := |(if ((f23 - f23) in v148) then v148[f23 - f23] else seq(0xac, i16  => (p3)))|, true, -v154.cf58 + (f23 % f23), p3;
				...
				v159[478] := seq(0x238, i18  => ('y'));
				v158, r1, globalState.f8, v159[478], v6[722] := v158 * v158, p1, v6[722], p2[if (v155 in v156) then v156[v155] else f23 := 'a'], fm1(globalState);
				r1 := p1;
			} else {
				globalState.f8 := f23;
				globalState.f8 := f23;
			...
			decreases 100 - i19
		{
			...
			match (v165) {
				case DC75() =>
					...
					var v171: array<bool> := new bool[15] [v166.cf67, !p1, p1, p1, p1, p1, p1, p1, p1, !false, p1, true, if (DC56(p1, v6[432]) in v170) then v170[DC56(p1, v6[432])] else p1, p1, p1];
					...
					r1 := if ((map[v6[432] := f23])[-0x16 := 0x287] in v175) then v175[(map[v6[432] := f23])[-0x16 := 0x287]] else !p1 && false;
					var v176: array<seq<int>> := new seq<int>[1](i20 => v3 + v3);
					v176[76] := v3;
					v176[76] := v3;
				case DC76(cf126, cf127, cf128, cf129) =>
					v6[432] := -v6[432];
					var v177: map<int, int> := map[f23 := |{v6[432]}|];
					v177 := v177;
					var v178: multiset<bool> := multiset{cf127, cf127, cf129};
					var v179: set<bool> := {false, p1};
					cf129, globalState.f8 := cf129, 0x264 % ((if (cf129 in v178) then v178[cf129] else -|v179|) - |multiset(v3)|);
					var v180: array<bool> := new bool[2] [cf129, cf129];
					var v181: seq<array<bool>> := [v180];
					var v182: array<array<bool>> := new array<bool>[27] [v180, v180, v180, v180, v181[f23], v180, v181[f23], v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v180, v181[|fm94(p1, p0, globalState)|], v180, v180];
					v182[938] := v180;
					v182[938] := v180;
				case DC77(cf130, cf131, cf132, cf133, cf134) =>
					globalState.f5 := p2;
		...
		v193 := v193 + (v193 + v193);
		r0 := new int[15] [f23, |v1|, f23 - -0x3ac, f23, -501, 0x104, f23, f23, if (!p1) then f23 else f23, f23, f23, f23, f23 / |p2|, f23, 655];
		r1 := p1;
		r2 := 0x2aa;
	}
	method m7(p0: bool, p1: int, p2: char, globalState: GlobalState) returns (r0: bool) {
		var v0 := DC69();
		match (match v0 {
			case DC69() => DC62(map[seq(0x2c2, i0  => (|[p0]|)) := f23])
			...
			case DC63(cf108) =>
				...
				var v11: array<int> := new int[29] [f23, f23, -0x90, p1, p1, |v2|, f23, p1, p1, -f23, |[p0]|, v5.cf163, 0x148, v3[|v6|], p1, |v7|, f23, |"oaxfip"|, f23, |v8|, p1, |(seq(0x227, i1  => (p2)))|, p1, |"fpirody"|, p1, |v9|, p1, |v10[p1 := [cf108, cf108]]|, |v8|];
				...
				v13[788] := v12 + (if (p1 in v14) then v14[p1] else v12);
				v13[788] := v12[v11 := p1];
				var v15 := new C7(418);
			case DC64(cf109, cf110, cf111) =>
				...
				var v20: set<int> := {p1};
				globalState.f5 := fm11(v19[|v20|], -151, globalState);
			...
			case DC62(cf107) =>
				...
				var v26: array<string> := new seq<char>[29](i3 => (seq(390, i4  => (p2))) + "tilhakslx");
				v26 := v26;
				...
				var v31: set<array<bool>> := {v29, v30[p1], v29};
		...
		v33[108], r0, globalState.f8, globalState.f8 := if (if (p0) then p0 else p0) then 'v' else f25, |(v34 + v34[p1 := f25])| > |(v34[p1 := fm0(globalState)] + v34)|, -(-(p1 + f23) / p1), if (p0) then p1 % -|map[p1 := |v35|]| else f23;
		...
		match (v38) {
			case DC69() =>
				...
				v36[698] := p1 * |v39|;
				r0 := f23 >= |v35|;
				var v40: map<seq<char>, string> := map[(seq(-0x35b, i6  => (f25))) + v34 := "sgev"];
				v40 := v40[v34 := v34];
				...
				var v45: seq<map<array<bool>, int>> := [v43[v41 := v39[if (p0 in v44) then v44[p0] else f23]]];
				var v46: map<bool, bool> := map[p0 := p0];
				var v47: map<int, array<bool>> := map[|v46| := v41];
				var v48 := DC60(v41, 'd');
				var v49: array<map<array<bool>, int>> := new map<array<bool>, int>[11] [v43, v43, v43, v43, v45[p1], map[if (v36[698] in v47) then v47[v36[698]] else v41 := f23], v43, v43, map[v41 := v36[698]], map[v48.cf104 := v36[698]] + v43, v43 + v43];
				v49[728] := v43 + v43;
				var v50 := DC30(v46);
				var v51: map<bool, D11> := map[p0 := v50];
				v49[728], globalState.f5, r0, r0 := v43, fm11(v39 + v39, p1, globalState), p0 !in v51[if (p0 in v46) then v46[p0] else p0 := v50], p0;
			case DC68(cf116) =>
				var v52 := new C12(f25, f23);
				var v53: map<bool, string> := map[fm2(globalState) := v34];
				v53 := v53[p0 := v34];
				var v54: seq<int> := [198];
				var v55: map<bool, int> := map[false := v54[|v34|]];
				var v56: seq<int> := [f23, v52.f27, |v34|, |v55|];
				var v57: seq<string> := ["ikficfxcs"];
				var v58: map<int, int> := map[f23 := v52.f27];
				var v59: seq<seq<int>> := [(seq(0x3bb, i7  => (|v34|))) + v56, v56, v56 + fm86(p0, |v57[|v58|]|, globalState), v54 + v54, seq(0x1c3, i8  => (p1))];
				v59 := seq(487, i9  => (v56));
				var v60 := DC4(v56);
			...
			decreases 100 - i10
		{
			...
			r0, r0, globalState.f8, r0 := p0, fm2(globalState), |(v34 + (seq(669, i11  => (v33[108]))))|, (|v34| * |fm21(v65, true, globalState)|) in map[p1 := fm1(globalState)];
			r0 := p0;
			var v66: array<bool> := new bool[29](i12 => p0);
			v66[768] := !p0;
			v66[768] := p0;
			var v67 := new C6(v66[768], v34, p1 + p1);
		}
		var v68: seq<int> := [f23, p1, -0x1e0, fm1(globalState)];
		var v69: map<int, int> := map[|v34| := -f23];
		globalState.f8 := v68[(if (f23 in v69) then v69[f23] else 0xb) / -f23];
		r0 := |(multiset{v34, v34, seq(-714, i13  => (p2))})[v34 := 0x304]| < f23;
	}
	method m8(p0: map<int, int>, p1: bool, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: seq<string>) {
		...
		var v1: map<int, seq<int>> := map[p3 / p3 := v0];
		v1 := v1[p3 := v0];
		var v2 := new C7(p3);
		var v3 := "ayaeoo";
			...
			decreases 100 - i0
		{
			...
			var v9: seq<string> := [v3, seq(0x1df, i1  => (f25)), v3];
			v8 := v8[v4.f28 := v7.(cf162 := v9)];
			globalState.f8 := p3;
			var v10: array<int> := new int[25](i2 => i2 - p3);
			v10[954] := v4.f28 * v4.f28;
			var v11 := DC83(p1, |v6|);
			var v12: map<D32, int> := map[if (p2) then v11 else v11 := v4.f28 % f23];
			v10[954] := |v12|;
			var v13: array<bool> := new bool[11](i3 => p1);
			match (DC61(DC60(v13, v3[v4.f28]))) {
				case DC60(cf104, cf105) =>
					...
					globalState.f8 := if ((v18 + v18) in v19) then v19[v18 + v18] else v10[954] * |v3|;
					var v20 := false;
					var v21: map<bool, bool> := map[p1 := p1];
				...
				case DC59(cf103) =>
					...
					v10[954] := -v10[954] + -(v4.f28 / v10[954]);
				case DC61(cf106) =>
					v10[954] := p3 + -0x289;
					globalState.f8 := fm1(globalState);
					var v36 := true;
					var v37: map<int, bool> := map[fm1(globalState) := p2];
					v36, v13, v10[954], v10[954] := if ((v10[954] / v4.f28) in v37) then v37[v10[954] / v4.f28] else v4.f28 <= v4.f28, v13, if (v36) then v4.f28 else -v4.f28, f23 + -f23;
		...
		var v44: seq<string> := [v3 + v2.fm17(v41, v41, !v41, globalState), v3 + (seq(0x206, i6  => ('k'))), v3];
		r2 := v44;
	}
}
...
class C14 extends T0 {
	...
	method m5(p0: int, p1: char, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: int) {
		...
		v0, r1, r1, v0 := fm7(!(if (v0) then !v0 else f24), v0, f24, f23 / p0, globalState), f23, if (v2 in v3) then v3[v2] else f23, f24;
			...
			decreases 100 - i0
		{
			...
			var v7: seq<D3> := [v6];
			var v8 := "vowepsd";
			globalState.f8, v7 := if (!v0) then -|(v8 + v8)| else -4, seq(568, i1  => (v6));
			var v9: map<int, bool> := map[f23 := f24];
			v9 := v9;
			var v10 := DC3(0x207, f23 + p0, p0, |v8[f23 := p1]|, v0);
			match (v10) {
				...
				case DC2(cf4) =>
					...
					var v20: map<set<bool>, bool> := map[v19[p0] := v0];
		...
		var v24 := "um";
		var v25: set<int> := {|v24|};
		globalState.f19, v0, v23[917] := v24, v25 <= v25, p0;
		var v26: map<bool, int> := map[f24 := v23[917]];
		var v27: map<string, bool> := map[(seq(-0x34c, i3  => (p1)))[if (f24 in v26) then v26[f24] else p0 := p1] := v0];
		var v28: map<bool, string> := map[f24 := seq(234, i4  => (p1))];
	...
	method m6(p0: char, p1: bool, p2: string, p3: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: int) {
		if (p1) {
			...
			var v6: array<int> := new int[10] [f23 / 0x3d6, v3 - f23, |v5|, f23, f23 * v3, v3, f23, 0xf5, f23, v3];
			v6[943] := f23;
			v6[487] := f23;
			var v7: map<int, seq<int>> := map[f23 := v5];
			var v8: set<bool> := {fm7(v2, f24, f24, f23, globalState), f24};
			v3, v6[943], v6[487] := -|v7|, (f23 * f23) * |v8|, v3;
			var v9: map<bool, char> := map[p1 := p3];
			r2 := (f23 * -|v9|) * v3;
			v2 := p2 < (seq(0x32a, i0  => (p0)));
			var v10: map<int, bool> := map[v6[943] := v2];
			var v11: set<int> := {v3};
			var v13: seq<set<int>> := [v11, v11];
			var v14: array<set<int>> := new set<int>[10] [v11, {v3}, v11, v11, set v12 : int | (301 <= v12) && (v12 < 347) :: (v12 * v3), v11, v11, v11, v13[v3], v11];
			...
			if (p1) {
				...
				var v20: seq<int> := [f23, f23];
				var v21: seq<string> := [("wsnao")[|v20| := p0]];
				var v22: seq<int> := [|(v21 + v21)|, f23];
				r1, globalState.f8 := fm7(f24, f24, !(v18 == v18), |(v19[v17.f34 := f23] + v19)|, globalState), |v20|;
				var v23 := DC80();
				v23 := v23;
				r2 := -((f23 - f23) % f23);
				...
				v26[210] := f24;
				v25, r1, globalState.f5, v26[210] := v25 * v25, !((v19 + v19) >= v19), ("buvw")[f23 := p0], p1;
			} else {
				var v27: set<int> := {f23};
				...
				var v36: array<map<int, int>> := new map<int, int>[6] [v30, v30, if (f23 in v31) then v31[f23] else v30, map v32 : int | v32 in v34 :: (v32 + |v27|) := (-777), map[fm1(globalState) := f23], map v35 : int | (598 <= v35) && (v35 < -792) :: (v35 / |v33|) := (f23)];
				v36[261] := v30;
				var v37: seq<map<int, int>> := [if (p1) then v30 else v30];
				v36[261] := v37[425];
				var v38 := new C7(489);
				r1 := f24;
				var v39: seq<multiset<bool>> := [v33, v33, v33[f24 := f23], v33, fm38(f23, f24, p1, -f23, globalState)];
				var v40: map<bool, bool> := map[true := f24];
				var v41: array<bool> := new bool[20] [false, p1, f23 < |p2|, p1, p1, p1 ==> false, false, f24, v33 >= v39[f23], |v40| != f23, fm2(globalState), p1, !p1 <== p1, |v28| == f23, f24, f24, !p1, f24, f23 > f23, p1];
				v41[404] := f24;
				v41[404] := f24;
				var v42 := 'h';
				var v43: seq<int> := [842];
			...
			r2 := -|([f24, p1, p1] + v50[|v51|])|;
			var v52: map<int, bool> := map[v44.f28 := v49[f23]];
			v52 := v52;
		}
		...
		match (v57) {
			case DC28(cf50, cf51, cf52, cf53, cf54) =>
				globalState.f5, v55 := ("oeeime" + (if (f24) then p2 else p2))[cf52 + v55[485] := if (cf50) then p0 else p0], v55;
				var v58: map<set<bool>, bool> := map[v56 := p1];
				v58 := v58[{f24} := f24];
				var v59 := new C2(v53[fm1(globalState) := cf53], -0x361);
			...
			case DC29(cf55) =>
				...
				var v75: map<int, int> := map[v55[485] := v55[485]];
				v70[823], v55[485], v71[604], v73, r2 := v69, |(v74 + v74)| / |v75|, ([f24] + v53) + v53, v73, f23;
				var v76: map<string, int> := map[p2 := f23];
				v76 := v76[seq(0x182, i1  => (p0)) := v55[485]];
				var v77: map<string, bool> := map[p2 := f24];
				r1 := (if (p2 in v77) then v77[p2] else !p1) ==> (f23 >= |"yhnwx"|);
		}
		
		var v78: multiset<int> := multiset{f23};
		r2, v55, v78, v55[485] := v55[485], v55, v78 * fm36(fm1(globalState), f23, globalState), -v55[485];
		if (f24) {
			r2, r1, globalState.f8, v55[485], r1 := f23, f24, v55[485], v55[485], f24;
			r2 := |v54| / v55[485];
			var v79: map<char, int> := map[p0 := v55[485]];
			...
			var v83: set<int> := {f23};
			var v84: map<int, int> := map[|v83| := |(seq(0x2ae, i2  => (p0)))|];
			v81 := map v82 : string | v82 in map[p2 := v84] :: (v82) := (v79);
			var v85: set<string> := {p2 + p2};
			v85 := v85;
			var v86 := new C7(f23 / |v80|);
		} else {
			var v87 := DC55(v55);
			var v88: map<D22, bool> := map[v87 := f23 > v55[485]];
			v88 := v88[v87 := f24];
			globalState.f8 := f23;
...
class C15 {
	...
	function fm3(p0: bool, p1: int, globalState: GlobalState): bool {
		(multiset{|[|[f22]|, |multiset([true, f22])|, |[f22]|, |[|["lonfleaok"]|]|, 754]|} * multiset(seq(0x37e, i0  => (|(map v0 : int | v0 in map[|{f22, f22}| := |(seq(0x1b7, i1  => ('g')))|] :: (v0 - 170) := (|(set v1 : int | (219 <= v1) && (v1 < 0x267) :: (v1 - |[f22]|))|))|)))) >= multiset(DC4([DC2(429).cf4, |"bj"|]).cf10)
	}
		...
		if (f22) {
			...
			match (v24) {
				case DC87(cf147, cf148) =>
					v4 := cf148;
					v20 := true && (v1 < (fm21(seq(0x2bc, i4  => (multiset{cf147})), true, globalState))[cf148 := v20]);
					...
					var v29: map<D25, bool> := map[v28 := v1[cf148]];
					var v30: multiset<bool> := multiset{f22};
					var v31 := "cmfmumoy";
					var v32: array<int> := new int[16] [v4, |v1|, cf148, cf148, v4, cf148, cf148, cf148, 0xf2, |v29|, cf148, if (cf147 in v30) then v30[cf147] else cf148, fm1(globalState), |v31|, cf148, v13[v4]];
					var v33 := DC90(v32, v25.f36);
					v32[192] := -v4;
					v26[616], v33, v32[192], globalState.f8 := v25, v33.(cf152 := f22), cf148, v4 * (v4 - cf148);
					cf148 := cf148;
				case DC86(cf146) =>
					...
					var v39: array<array<array<bool>>> := new array<array<bool>>[21] [v35[-|v36|], if (f22) then v34 else v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v35[if (v37 in v38) then v38[v37] else |v14|]];
					v39[816] := v34;
					var v40: map<bool, string> := map[!false := "exujiajr"];
					v39[816] := if (f22 in v40) then v34 else v34;
					r1 := v4;
					v4 := -fm1(globalState);
					v20 := v20;
				case DC88(cf149) =>
			...
			if (f22) {
				var v44 := "d";
				var v45, v46, v47 := v42.m6(v15, v13[v4] <= v4, v44, v15, globalState);
				...
				v50 := (multiset{f22, v20, v46})[!!v46 := v48.f27] + v50;
				v45[785] := |map[if (v47 in v14) then v14[v47] else |v13| := f22]|;
				v45[785] := -(v47 % v47);
			} else {
				var v51 := "vgxfjdgd";
				...
				var v65: map<string, int> := map[v51 := |(seq(0x32d, i5  => (v15)))|];
				var v67: array<set<string>> := new set<string>[26] [v52, {v51, v51, v51} + v52, v52, v52 - v52, {v51}, v52, v52 - (set v53 : string | v53 in [v51] :: (v53)), v52, v52 + v52, set v55 : string | v55 in v54 :: (v55), {v51, v51, fm25(v4, v4, globalState)}, (set v56 : string | v56 in v52 :: (v56)) + (set v60 : string | v60 in (map v57 : string | v57 in v59[v4] :: (v57) := (v20)) :: (v60)), v52, v61.cf173, v52 - v52, {v51}, set v62 : string | v62 in [v51] :: (v62), v52 - v52, v52 - v52, set v64 : string | v64 in v63 :: (v64), {v51, v51[v4 := v15], "lptbkbv"}, v52, v52, set v66 : string | v66 in v65 :: (v66), v52, v52];
				v67[327] := v52 - v52;
				v67[327] := if (v20) then v52 else v52 - {"hsylapkye"};
				var v68: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[17](i6 => [v0, map[v20 := f22]] + [v0]);
				var v69: seq<map<bool, bool>> := [v0];
				v68[508] := v69;
				v68[508] := ([v0, map[v20 := f22], v0, v0, map[false := f22]] + ([map[v20 := v20], fm78(v20, |v51|, globalState)])[0x2a8 := v0])[v4 := v0];
				var v70 := new C8(v4, v4 % v4);
	...
	method m4(globalState: GlobalState) returns (r0: bool) {
		...
		var v1 := 0x2b8;
		var v2 := 'e';
		globalState.f5 := v0[v1 := v2];
		var v3: C9 := new C9(v0, v1);
		var v4: map<C9, int> := map[v3 := v1];
		var v5: seq<bool> := [f22];
		var v6 := DC9(f22, |v4|, f22, v5[v1 := f22], v1);
		...
		if (!true) {
			...
			r0 := (|v14| == |(fm115(globalState))[{-353} := v1]|) || f22;
		} else {
			...
			match (DC98(v19)) {
				case DC99(cf165, cf166, cf167, cf168) =>
					...
					v20[168] := cf166;
					v20[168] := |multiset(v5)| / -v16;
					v16 := (v20[168] / v1) - -v1;
					r0 := !v5[v1];
				case DC100(cf169) =>
					var v21: array<int> := new int[16];
					v21[460] := |(v3.f40 + v3.f40)|;
				...
				case DC98(cf164) =>
					...
					globalState.f8 := v16;
					var v29: map<int, bool> := map[v1 / -|"iqwctfcha"| := f22];
					var v30: array<T0> := new T0[9];
					var v31: map<bool, array<T0>> := map[f22 := v30];
					v29 := v29[v1 := v1 < |v31|];
					var v32: map<bool, char> := map[f22 := v2];
					r0 := v5[|v32|] <== !fm2(globalState);
			}
			
			r0 := v0 < "attxeqla";
			var v33: multiset<bool> := multiset{f22, v5[v16]};
			...
			if (!f22) {
				...
				v35, v15[8], v38[807], v35 := v35, map[v1 * v16 := -v1 / fm1(globalState)], v42.(cf178 := v43), v35;
				r0 := multiset{v16, fm1(globalState), -v1} >= v43;
				v35[915] := v16;
				v35[915] := -84;
				var v44 := new C8(v16, |v3.f40| / v1);
				globalState.f8 := -((v44.f41 % -0x1b6) - |(v3.f40 + "h")|);
			} else {
				var v45: seq<int> := [v16, v16];
				v17 := map[fm3(f22, v1, globalState) := v45[-v16]];
				var v46: array<int> := new int[21](i0 => i0 + v1);
				v46[114] := -930;
				v46[114] := fm1(globalState);
				var v47: set<bool> := {f22};
				var v48: seq<set<bool>> := [{f22}, v47, v47, v47, v47];
				r0 := v47 !in (v48 + v48);
				var v49: set<char> := {v2, v2, v2};
				v49 := v49 * {v2};
				globalState.f8 := v46[114];
			}
			...
			decreases 100 - i1
		{
			...
			if (f22) {
				...
				var v51: set<int> := {v1, v1 % v1};
				v51 := v51;
				v0 := v3.f40;
				r0 := v50.f36;
				var v52: array<bool> := new bool[26](i2 => v5[v1]);
				v52[65] := v50.f36;
				...
				v56[17] := if (v58.cf1 in v57) then v57[v58.cf1] else v1;
				v56[17] := v1;
				var v59: set<bool> := {v5[v1]};
				var v60 := new C11(|v59|, -v56[17]);
				var v61: C5 := new C5(-|v3.f40| - v56[17], v60.f28);
				v61 := v61;
		...
		match (v71) {
			case DC66(cf113, cf114) =>
				...
				var v74: map<bool, bool> := map[v5[|v73|] := f22];
				...
				match (v76) {
					case DC53(cf94, cf95, cf96) =>
						...
						v77[973] := v5[|v78|];
						v77[973], globalState.f8, cf114 := cf114, -v67.f23, if (cf114 <== f22) then if (cf114 in v74) then v74[cf114] else cf114 else cf114;
						v77[973] := v77[973];
					case DC52(cf93) =>
						cf114 := v67.f23 >= v67.f23;
						var v79: seq<seq<bool>> := [v5, v5];
						var v80: seq<int> := [v67.f23];
						var v81 := new C2(v5 + v79[v67.f23], v80[v1]);
						...
						var v85: map<string, bool> := map[v0[887 := cf113] := true];
						v85 := v85[v3.f40 := v84.f32];
					case DC54(cf97) =>
						globalState.f8 := v67.f23 / |[false]|;
						cf114, cf114 := f22, (v67.f23 / v1) <= (v67.f23 % |v74|);
			...
			case DC65(cf112) =>
				...
				if ((multiset{--v67.f23, |{v94, v94}|, |v95|, v1, v67.f23} * v96) <= (v96 - multiset(v97))) {
					...
					cf112[417] := if (v98.f36) then if (|v3.f40| in v100) then v100[|v3.f40|] else v2 else v98.f37;
					cf112[417] := v94.fm15(v98.f37, globalState);
					v1 := |v3.f40| * (v1 * v1);
					r0 := v98.f36;
				} else {
					v1 := v67.f23;
					var v101 := new C14(v1 > v67.f23, v1 * -v67.f23);
					var v102 := new C9(v3.f40 + (seq(853, i6  => (v2))), v1);
					var v103: map<string, int> := map[v3.f40 := v67.f23];
					var v106: multiset<string> := multiset{seq(0x1fb, i7  => ('i')), seq(20, i8  => (v2))};
				...
				v110[601] := fm1(globalState);
				var v112: map<bool, array<int>> := map[f22 := v110];
				v109[671], v111, globalState.f8, v110[601], v2 := if (f22 in v112) then v112[f22] else v110, v111, v111.f23, v111.f23 - fm1(globalState), v2;
			case DC67(cf115) =>
				r0 := f22;
		...
		r0 := f22;
		var v114: map<int, int> := map[(fm117(globalState)).cf119 := |(seq(-0x3db, i9  => (v2)))|];
		r0 := !(v67.f23 !in v114);
	}
}
...
class C16 {
	...
	method m1(p0: multiset<int>, p1: int, p2: map<array<int>, int>, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: int) {
			...
			decreases 100 - i0
		{
			...
			var v15: seq<bool> := [v5[648], v0, v0];
			r2 := if (v15[p1]) then v0 else v0;
			var v16 := DC47(|(seq(231, i1  => (f21)))|, v0, p1, !v0, fm2(globalState));
		...
		var v20 := "gvpocmkpg";
		var v21 := DC21(v5[648], |v20|, v6, p1, v0);
		var v22: seq<bool> := [v0, !v0];
		var v23: seq<bool> := [v5[648], v21.cf40 || fm2(globalState), v22[p1]];
		r2 := !v22[|v20|];
		var v24: T2 := new C10(-p1);
		var v25: map<T2, set<bool>> := map[v24 := fm44(v5[648], v5[648], fm2(globalState), v20, globalState) * v4];
		r3 := |v25|;
	}
	method m2(globalState: GlobalState) returns (r0: array<seq<bool>>, r1: int, r2: int) {
		...
		var v1 := 0x320;
		var v2: seq<bool> := [v0];
		var v3: multiset<string> := multiset{seq(0x3c, i0  => (f20))};
		var v4: array<int> := new int[13](i1 => i1 % v1);
		var v5: seq<array<int>> := [v4];
		var v6 := "jxa";
		var v7: array<int> := new int[10] [fm1(globalState), |(([v0])[v1 := v0] + v2)|, v1, v1, if ("ivyws" in v3) then v3["ivyws"] else fm1(globalState), v1, fm1(globalState), v1, |v5|, if (false) then v1 else |v6|];
		var v8: seq<int> := [v1];
		v4[987] := v1 % |v8|;
		v4[987] := v1;
		...
		v9[456] := if (v0) then v11 else [v10];
		v9[456] := (v11 + v11) + v11;
		var v12: array<D7> := new D7[4];
		forall i2 | 0 <= i2 < v12.Length {
			v12[i2] := DC18(DC18(set v13 : set<int> | v13 in (seq(0xb8, i3  => ({v1, |multiset{|v8|}|, |v6|, |map[v0 := v0]|}))) :: (v13)).cf33);
		}
			...
			decreases 100 - i4
		{
			...
			if (f20 !in (v6 + v6)) {
				...
				var v24 := DC100(v0);
				v23[793] := v24;
				v23[793], v0 := v24, v18.f23 < v4[987];
				var v25: map<bool, int> := map[v19.f29 := |v14[376]|];
				...
				v39[330] := v42;
				v39[330], r1, globalState.f19, globalState.f8, v0 := v42, --|map[v0 := (seq(0x34e, i6  => (v34.f41))) + v8]|, v6 + (v6 + v6), |(v2 + (v2 + v2))|, v0;
				var v43: multiset<int> := multiset{|v8|, fm1(globalState)};
				var v44, v45 := v10.m5(if (v4[987] in v43) then v43[v4[987]] else 0x83, f21, globalState);
			}
			
			v0 := true;
			v0 := v0;
		}
		for i7 := v4[987] to --0x8c / v1 {
			v0, v4[987], v0 := |v6| >= v4[987], v1, v0;
			v0, v1 := v0, v4[987];
			var v46: array<bool> := new bool[1];
			v46 := v46;
			var v47: T1 := new C2(v2, v1);
			var v48: seq<T1> := [v47, v47];
			var v49: map<bool, int> := map[v0 := v4[987]];
...
method Main() {
	...
	var globalState := new GlobalState(false, -0xfa, true, 0x26, true, v0, false, true, 0x334, map[v1 := v1] + v2, 976, 'a', multiset{v1}, 364, (map[v4 := v4])[map v5 : int | (-0x2c7 <= v5) && (v5 < -0x1db) :: (v5 / v3) := (v1) := v4], v6 + v6, true, 942, v0 + (seq(0x38a, i0  => ('l'))), v7[|v8|]);
	var v9 := 'y';
	...
	match (v11.(cf3 := v11.cf3)) {
		case DC0(cf0, cf1, cf2) =>
			...
			v15[563] := if (v16[v3 := cf1] != v16) then [v3, |v0|] else v17[fm1(globalState)];
			v12[256] := cf2;
			v12[256] := v9;
		case DC1(cf3) =>
			v1 := false;
	...
	var v27: array<int> := new int[28] [v3, 0x35a, -v3 % v3, v6[|v26|], |v4|, |multiset{|v6|}| * v3, v3, v3 % v3, v3, -0x85 - v3, |(v26 + v26)|, v3, |(v8 + v8)|, v3, |v0| + v3, fm1(globalState), v3, -v3, -(if (true) then v3 else v3), -fm1(globalState), fm1(globalState), fm1(globalState), v3, v3, v3 + 792, v3, v3, DC3(v3, |v0|, -12, 0x35e, v1).cf8];
	v27[154] := v3;
	...
	var v35: seq<map<string, int>> := [map[seq(0x2f0, i1  => (v9)) := 751], v34];
	v27[154] := -(if (v1) then |v29| else |v35[v3]|);
	if (fm2(globalState)) {
		v3 := v3;
		globalState.f8 := v27[154] + v27[154];
		if (v1) {
			v6 := v6 + v6[|v0| := v27[154]];
			var v36: array<bool> := new bool[18](i2 => v1);
			var v37: seq<array<bool>> := [v36];
			var v38: map<int, seq<array<bool>>> := map[v3 := v37];
			globalState.f8, v1, v27[154] := |(v37 + ((if (fm1(globalState) in v38) then v38[fm1(globalState)] else v37) + v37))|, v0[v27[154] := v9] == v0, v3;
			v3 := v3 - 0x3dd;
			v36[629] := v1;
			v36[629] := v1;
			var v40: map<int, int> := map[if (true) then -0x232 else |(map v39 : int | (0x373 <= v39) && (v39 < 0x3db) :: (v39 / |v6|) := (v27[154]))| := v3 * fm1(globalState)];
		...
		if (v1) {
			...
			v51 := multiset(v6 + v6) == (multiset{|v6|, v27[154]})[|v53| := v27[154]];
			v1 := false;
			var v54 := DC21(v51, |v0|, v50, v52, v1);
			v27[154] := (v54.cf39 * 0x27b) * v27[154];
		}
		
	} else {
		var v55: array<bool> := new bool[13](i3 => false);
		v55[949] := fm2(globalState);
		v55[949] := v1;
		match (DC102(DC100(v55[949]))) {
			case DC102(cf171) =>
				v27[154], v55[949], v27[154], globalState.f8, globalState.f5 := v3, fm2(globalState), v6[v27[154]], v27[154], "frowsos";
			...
			case DC101(cf170) =>
				...
				v65[454] := v27;
				v65[454] := v27;
				var v66, v67 := v59.m5(--v27[154], cf170.f37, globalState);
			case DC103(cf172) =>
				globalState.f8 := -v27[154] / v27[154];
				v27[154] := v27[154] - (|multiset{v3}| / 0x381);
	...
	for i4 := v27[154] to v27[154] - v3 {
		...
		if (v1) {
			...
			v0 := v0 + ("jiohjuowq")[|v91[!true := v6]| := v9];
			var v92: array<string> := new string[11](i6 => v0[v3 := v9]);
			v92[901] := v0;
			var v93: array<bool> := new bool[22](i7 => v3 <= v27[154]);
			v93[513] := v1;
			var v94: map<int, array<bool>> := map[|multiset(seq(0x55, i8  => (v3)))| := v93];
			var v95: multiset<set<bool>> := multiset{{v1}, v8};
			globalState.f8, v92[901], v93[513] := fm1(globalState), v0, (v27[154] !in v94) || (v95 < v95);
			var v96: seq<array<int>> := [v27, v27, v27];
			var v97: array<seq<array<int>>> := new seq<array<int>>[10] [v96, v96, v96[0x17b := v27], [v27, v27], v96 + v96, v96, v96, v96, v96 + v96, v96];
			var v98 := DC49(v96);
			v97[193] := v96 + v98.cf90[0x19f := v27];
			v9, v80, v97[193], v1 := v9, v80, v96[v27[154] := v27] + [v27, v27], !((v80.f35 + v26) == (v80.f35 + (v26[-i4 := v1])[i4 := v1]));
			var v99 := DC28(v1, v3, |[v4, map[i4 := v93[513]]]| / |v8|, v93[513], v27[154]);
			v99, v27[154], v1, v3 := v99, (v27[154] % v3) * v27[154], v93[513], fm1(globalState);
			v93[513] := !fm2(globalState);
		}
		
	}
	for i9 := |v26| * v27[154] to v27[154] {
		var v100 := new C7(v3);
		var v101: array<bool> := new bool[13];
		var v102: set<array<bool>> := {v101};
		var v103: map<int, int> := map[v27[154] := |v6|];
		var v104: C11 := new C11(v27[154], --992);
		var v105: map<C11, int> := map[v104 := v3];
		var v106 := DC2(i9);
		var v107: array<bool> := new bool[28] [v4 != v4, v1, v1, v1, !(v1 || v1), v1 ==> v1, v102 >= v102, v1, v1, v27[154] >= -0x1c, v1, v1, v1, v1, !false, v1, |(map[|v103| := v1])[|(seq(797, i10  => (v9)))| := v1]| !in v29, v1, v26[|v105[v104 := -v27[154]]|], v1, v1, false, v8 >= {v1, v1, v1, v1}, v9 !in "rnboh", v1, v106.cf4 <= -|v4|, v1, !(if (v1) then fm2(globalState) else !v1)];
		v107[424] := v1;
		var v108: array<char> := new char[26];
		v107[424], v108 := v1, v108;
		v107[424] := fm2(globalState);
		var v109: multiset<bool> := multiset{false};
		var v110 := DC14(v109);
		v110 := DC14(v109);
	}
	var v111: T0 := new C11(v27[154], v3);
		...
		decreases 100 - i11
	{
		...
		globalState.f8 := v114;
		v27[154] := 0x7c - v111.f23;
	}
	v1 := if (v27[154] in v4) then v4[v27[154]] else v1;
	var v116 := DC21(v1, 0x360, fm0(globalState), v27[154], !false);
	...
	v118[10] := [v119.(cf92 := v26), fm119(v1, v9, v122, v3, globalState)];
	var v123: array<char> := new char[3] ['r', fm0(globalState), fm0(globalState)];
	v123[564] := v9;
	var v124: seq<D20> := [DC51(v26)];
	v29, v116, v117[427], v118[10], v123[564] := v29 - (v29 - v29), v116, true, v124, if (v1) then v9 else fm0(globalState);
	var v125: multiset<bool> := multiset{fm2(globalState)};
	var v126: seq<multiset<bool>> := [v125];
	var v127: T1 := new C5(-|v0|, |(v126[v111.f23] - v125)|);
	var v128: seq<T1> := [v127, v127, v127, v127, if (v117[427]) then v127 else v127];
	v127 := v128[|(v26 + v26)|];
	var i13 := 0;
	while (v1)
		decreases 100 - i13
	{
		...
		globalState.f19, v129, v1, v27[154], v26 := v0, v129, |"shdbjhvgw"| <= |v125|, fm1(globalState), v26;
		globalState.f8 := v111.f23;
	}
	for i14 := v3 to v127.f23 {
		if (v1) {
			var v131: map<bool, set<int>> := map[v117[427] := set v130 : int | v130 in (seq(0x223, i15  => (0xe4))) :: (v130 % --0x16c)];
			var v132 := DC23(if (v1 in v131) then v131[v1] else v29);
			var v133: map<D8, bool> := map[v132 := if (v1) then v117[427] else false];
			v133 := v133;
			...
			v135[837] := v30;
			v27 := v27;
			var v136, v137, v138, v139 := m0(v117[427], globalState);
		}
	...
	if (v1) {
		if (v1) {
			v27[154] := fm1(globalState);
			var v140: array<array<int>> := new array<int>[4] [v27, v27, v27, v27];
			v140[714] := v27;
			v140[714] := v27;
			v117[427] := v1;
			v117[427] := v1;
			var v141: C2 := new C2([v117[427], v117[427], v117[427]], 543);
			v141 := if (v117[427]) then v141 else v141;
		} else {
			globalState.f8 := (v3 + 458) * (526 - |v0|);
			var v142: map<bool, int> := map[v1 := v111.f23];
			var v143: C8 := new C8(v111.f23, if (v117[427] in v142) then v142[v117[427]] else |v125|);
			var v144: map<C8, T1> := map[v143 := v127];
			v127 := if (v143 in v144) then v144[v143] else v127;
			v9 := v9;
			v1 := v1;
			globalState.f8 := v127.f23 / (v127.f23 - v111.f23);
		}
		
		globalState.f8 := v111.f23 - v27[154];
		if (v117[427]) {
			var v145, v146, v147 := v127.m6(v9, v117[427], v0, v123[564], globalState);
			var v148: multiset<T1> := multiset{v127};
			var v149: map<int, multiset<T1>> := map[v147 := v148];
			var v150: array<multiset<T1>> := new multiset<T1>[19] [v148, v148, v148, v148, v148, v148, v148, v148, v148, v148[v127 := fm1(globalState)], v148[v127 := v147], v148 + v148, v148, multiset(v128), v148, v148, if (v146) then v148 else if (v3 in v149) then v149[v3] else v148, multiset(v128 + v128), v148];
			v150[444] := v148;
			v1, v27[154], v150[444] := v117[427], -v111.f23, v148;
			v3 := |v0|;
			var v151: seq<T0> := [v111, v111];
			v111 := if (false <==> v1) then v111 else v151[|v2|];
			var v152: multiset<string> := multiset{v0, v0, v0, v0};
			var v153 := new C11(v147, if (v0 in v152) then v152[v0] else v3);
		} else {
			var v154: C2 := new C2(v26, -v27[154]);
			v154 := v154;
			var v155, v156, v157 := v127.m12(v27, v27, v127.f23 != 0x3cd, if (v117[427]) then false else v117[427], globalState);
			var v158: map<int, int> := map[v127.f23 + v3 := -v127.f23];
			var v159 := DC43(v0, false, v27[154], v156, v123[564]);
			v158 := v158[v27[154] := v159.cf77];
			v117[427] := v156;
			var v160, v161 := v154.m5(v157, v123[564], globalState);
		}
		...
		var v164: T2 := new C9(v0 + v0, v27[154]);
		v164 := v164;
	} else {
		...
		match (v171) {
			case DC60(cf104, cf105) =>
				...
				v176, globalState.f8, v117[427], v174, v1 := v176, v127.f23, v117[427], v165.f24, !v165.f24;
			...
			case DC59(cf103) =>
				...
				var v188: map<int, multiset<int>> := map[v111.f23 := v30[v111.f23 := v3]];
				v117[427] := v165.fm7(v29 > v29, v30 >= (if (|v181.f30| in v188) then v188[|v181.f30|] else v30), if (v117[427]) then v117[427] else v181.f29, -|(v6 + v6[0xcf := v127.f23])|, globalState);
			case DC61(cf106) =>
				var v189 := new C8(v111.f23, v111.f23);
				var v191 := DC7(map v190 : int | v190 in v29 :: (v190 + |v29|) := (map[v123[564] := DC2(v127.f23)]));
				var v192 := DC2(v111.f23);
				var v193: map<char, D1> := map[v9 := v192];
				var v194: map<int, map<char, D1>> := map[v27[154] := v193];
				...
				var v198: map<string, bool> := map[seq(-929, i16  => (v123[564])) := v1];
				var v199 := DC46(v117);
				var v200 := DC106(v117, v30);
				var v201: map<bool, array<bool>> := map[v117[427] := v117];
				...
				var v204: C0 := new C0(if (|v6| in v4) then v4[|v6|] else v165.f24, v117[427]);
				var v205: map<C0, int> := map[v204 := v3];
				var v206: multiset<C14> := multiset{v165};
				v27 := new int[29] [|v26| - -0x33a, |v197|, -|v198|, v27[154], v127.f23 / v3, -v127.f23, |map[-v111.f23 := !v165.f24]| % v27[154], v111.f23, v27[154] * |v26|, v111.f23, 0x36c, |v26| % v111.f23, fm1(globalState), |v0| % v127.f23, v127.f23, 0x183, v111.f23, -0x1a5, v189.f41, |v203|, 0x38, v111.f23 / -v111.f23, |v205|, v127.f23, v127.f23, -v127.f23, v3 % v111.f23, v111.f23 % v111.f23, -v127.f23 % (if (v165 in v206) then v206[v165] else v189.f41)];
				var v207: map<bool, char> := map[v204.f38 := 'o'];
				var v208: map<map<bool, char>, bool> := map[v207 := true];
				var v209 := DC74(v208);
				var v210 := DC78(v209);
				var v211: map<int, int> := map[|v8| := -v27[154]];
				var v212: seq<seq<int>> := [seq(0x25f, i17  => (|v2|))];
				v210, v3, v117[427], globalState.f8 := v210, |(if (v117[427]) then v211 else map[|v0| := 806])| - |v212[v111.f23]|, v204.f38, -(|(if (!true) then v0 else "udvj")| * (if (v204.f39) then v127.f23 else v127.f23));
				v117[427] := !(v117[427] <== (v204.f39 ==> v204.f39));
		}
		
		var v213: map<array<int>, string> := map[v27 := fm34(globalState)];
		v213 := v213[v27 := v0 + v0];
		var v214: map<bool, char> := map[true := v9];
		var v215: set<map<bool, int>> := {v168, v168, map[v117[427] := v3]};
		var v216 := DC82(v215);
		var v217 := DC85(v216);
		var v218: map<bool, D32> := map[v117[427] !in v214[!v165.f24 := v123[564]] := v217];
