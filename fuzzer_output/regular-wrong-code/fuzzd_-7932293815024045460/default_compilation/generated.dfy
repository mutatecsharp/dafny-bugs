...
function fm0(p0: bool, p1: bool, p2: bool, globalState: GlobalState): string {
	DC3(seq(807, i0  => ('a'))).cf6
}
function fm4(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<set<int>> {
	if (true) then if (false) then [{0x1a1}, set v0 : int | (574 <= v0) && (v0 < 0x23e) :: (v0 * |multiset{|[true]|, 0x8e}|), {-371}, {-0x2ac}, set v1 : int | (0x2a9 <= v1) && (v1 < 0x2b6) :: (v1 * -0x36a)] else [set v2 : int | v2 in [22, 339] :: (v2 % |"ne"|)] else [set v3 : int | (-0x8d <= v3) && (v3 < 911) :: (v3 / -0x1a)] + [{|multiset{-|[false, !false]|}|}, {0x2fb, |map[|[true, !false]| := "ughyyb"]|, 0x33e, -0x3da, |map['r' := true]|}]
}
...
function fm8(p0: map<int, bool>, p1: bool, p2: int, p3: bool, globalState: GlobalState): D3 {
	DC6(--0x18e % |[|map[true := false]|, 0x8e, --0x2df]|, -(|"uttjjc"| * --0x158), |((seq(0xbf, i0  => ('r'))) + "liregypiy")|)
}
...
function fm16(p0: map<bool, int>, p1: bool, p2: bool, globalState: GlobalState): D2 {
	if ((seq(-476, i0  => ('x'))) <= "en") then DC4(|(seq(0x93, i1  => ('e')))|, 0x2dd, !true) else if (false) then DC4(|"dneb"|, -593, false) else DC4(-402, -0x58, false)
}
function fm17(p0: bool, p1: char, p2: int, p3: char, globalState: GlobalState): seq<int> {
	match DC20(!true, 0xbc, DC10(false, -280, 'm', true).cf24, false) {
		case DC20(cf37, cf38, cf39, cf40) => (seq(0x2d, i0  => (cf38))) + [|[cf37]|, -cf38]
		case DC19(cf36) => (seq(0x368, i1  => (|map[false := false]|))) + [82, |"xpmig"|]
	}
}
function fm18(globalState: GlobalState): set<int> {
	((set v0 : int | (0x1cd <= v0) && (v0 < 955) :: (v0 / |{!false}|)) - {0x56, 663}) - ({896, |{585, -|[|"tiyhydno"|, |[false, !false]|]|, |[0x36f]|, |map[|[|"dwpbuttrr"|]| := false]|}|} + {|multiset{|map[0x1b6 := |[217]|]|}|})
}
function fm19(p0: bool, globalState: GlobalState): map<int, int> {
	map v0 : int | v0 in ([0x2fb] + (seq(0x23e, i0  => (|[false]|)))) :: (v0 * 0x38) := (0x1f5)
}
function fm20(p0: int, p1: int, globalState: GlobalState): map<int, seq<int>> {
	(map[-558 := [0x187, 0x6f]] + map[0x11b := [139]]) + (map[-|multiset{false, false}| := seq(794, i0  => (|multiset{true, true}|))] + (map v0 : int | (840 <= v0) && (v0 < 877) :: (v0 % -0x2c4) := ([|map[multiset([!false]) := true]|])))
}
function fm21(p0: int, p1: bool, globalState: GlobalState): map<string, bool> {
	map[seq(0x29a, i0  => ('u')) := false]
}
function fm22(p0: bool, globalState: GlobalState): set<set<int>> {
	(if (false) then {{0x166}, {|map[0x2bd := true]|, -136}} else {{|"j"|}}) * {{0x19d, |map[|{-|multiset{"wtsfdd"}|}| := true]|, 0x3, |"xahkablsp"|}, set v0 : int | (0x141 <= v0) && (v0 < -0x3d5) :: (v0 / -0x3db), {|DC3("oih").cf6|, |[|{false}|]|}}
}
...
method m3(p0: char, p1: D2, p2: int, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: array<int>, r3: int) {
	...
	if (fm7(v4, p3, true, multiset{p3} > multiset{p3}, globalState)) {
		...
		globalState.f18, r0, globalState.f19, r3 := (p2 / p2) < |v17|, p2, (p2 * p2) <= |(v18 + v18)|, p2;
		v10[211] := |map[v0 := p3]| % p2;
		var v19: map<char, int> := map[p0 := p2];
		v10[211] := (p2 % (if (p0 in v19) then v19[p0] else p2)) + p2;
		v15 := v15;
		...
		v21, globalState.f15, v22, v25 := v21 - (v21 + {v10, v10, v10, v10}), if (fm7(v4, p3, p3, p3, globalState)) then p2 else v8[|v26|], 'q', v25 + v25;
		globalState.f19 := p3;
	...
	var v30: seq<bool> := [p3];
	var v31 := "iysurklx";
	var v32: map<seq<bool>, string> := map[v30[|map[p3 := fm7(v4, p3, false, p3, globalState)]| := p3] := v31];
	var v33 := DC19(v30);
	...
	if (p3) {
		var v38: set<string> := {v31, seq(0x2ad, i1  => (p0))};
		var v39 := DC14(v38);
		match (v39) {
			case DC15(cf30, cf31, cf32) =>
				...
				var v42: map<int, int> := map[|v8[cf30 := cf30]| := v35.f23];
				var v43 := DC5(v42);
				v41[90] := if (p3) then v43 else v43;
				v41[90] := v43;
			case DC14(cf29) =>
				v13.f27[531] := !true;
				v13.f27[531] := v30[-0x21f];
				var v44 := 'h';
				v44 := p0;
				...
				v6[132] := v48;
				var v49 := DC0(v13.f27[531]);
				var v50 := DC20(p3, v35.f23, fm5(v49, globalState), v13.f27[531]);
				globalState.f15, v13.f27[531], v6[132], r1, v13 := v8[-p2 * v35.f23], false && (true && !v50.cf37), v48, !v13.f27[531] || v13.f27[531], v13;
			case DC16(cf33) =>
		...
		if (p1.cf9) {
			...
			var v58 := new C1(v13.f26, v13.f27, fm5(v56, globalState) % v35.f23, v12 * (if (v35.f23 in v57) then v57[v35.f23] else v35.f24));
			var v59: seq<C1> := [v13, v58];
			v58 := if (p3) then v59[|(seq(-406, i4  => (p0)))|] else v58;
			v13.f27[103] := p3;
			v13.f27[103] := (|v30| <= p2) || !!(if (p3) then !p3 else p3);
		} else {
			r3 := p2;
		...
		v67[869] := v68;
		v67[869] := [v31] + (seq(0x26d, i5  => (seq(19, i6  => (p0)))));
		v30 := v30;
	} else {
		...
		if ((v70 + v70) < v70) {
			...
			v13.f27[949] := p3;
			var v73 := DC21(v69);
			v69, v71, v72, v13.f27[949], v8 := v73.cf41, v71, v72, v35.f23 > v35.f23, [p2];
			var v74 := DC0(v13.f27[949]);
			globalState.f0 := (if (p3) then --v35.f23 else 0x293) != (fm5(v74, globalState) + 0x138);
			var v75: multiset<int> := multiset{p2};
			r1 := v75 !! multiset{p2};
			var v76 := 'e';
			v76 := v31[fm5(v74, globalState)];
		...
		if (!(p3 || !(v35.f23 <= p2))) {
			...
			v13.f27[672] := v81.cf16;
			globalState.f0, v0[885], globalState.f15, r3, v13.f27[672] := !(481 <= 0x17e), p3, -(v35.f23 * p2) % -703, v35.f23, v30[p2];
			var v82: array<map<bool, bool>> := new map<bool, bool>[12](i8 => if (v13.f27[672]) then map[v13.f27[672] := p3] else map[v13.f27[672] := p3]);
			v82[149] := map[!v0[885] := !v13.f27[672]] + map[p3 := v0[885]];
			var v83: map<bool, bool> := map[false := true];
			globalState.f15, r0, v82[149] := v35.f23, if (v35.f23 < p2) then v35.f23 else |v31|, v83 + v83;
			...
			v13.f27[257] := if (p3) then p3 else v95 !! multiset{DC13(v93)};
			globalState.f19 := v13.f27[257] ==> (p3 ==> p3);
			v13.f27[257] := v31 < v31;
		}
		...
		if (p2 != |v96|) {
			...
			v10[437] := p2 - v35.f23;
			v10[437] := -(v8[v35.f23] - v35.f23);
			v96 := v96[p3 := true];
			r3 := |v35.fm1(globalState)| / (v35.f23 + |v8|);
			globalState.f18 := v35.f23 < p2;
			v0[611] := p3;
			var v98: multiset<int> := multiset{|[p3]|, v10[437]};
			...
			r3, v0[611], globalState.f12, v0 := 0x253, !((p2 <= v35.f23) && (v99 <= v99)), v31 + v31, if (v100 in v101) then v101[v100] else v13.f27;
		}
	...
	for i9 := |v31| to v35.f23 {
		...
		if ((v31 + v31) <= (seq(-0x335, i10  => (p0)))) {
			...
			v13.f27[954] := |v31| > v35.f23;
			v13.f27[954] := p3;
			v104[690] := v0;
			v104[690] := v13.f27;
			var v111 := DC0(p3);
			var v112 := new C1(v13.f26, v104[690], fm5(v111, globalState), v35.f24);
			r0 := i9;
...
class C1 extends T0 {
	...
	method m0(globalState: GlobalState) returns (r0: seq<int>, r1: seq<string>, r2: array<int>) {
		var v0 := "efhuq";
		var v1 := 'c';
		var v2: seq<string> := [v0, v0, v0, ("b")[f23 := v1], v0];
		var v3: array<int> := new int[1] [|v2[f23]|];
		r2 := v3;
		var v4: set<int> := {f23};
		if (true <==> (v4 > v4)) {
			var v5 := false;
			...
			var v8: seq<bool> := [!v5];
			v7[90] := v8;
			v7[90] := if (!false) then v8 else v8;
			f27[742] := v5;
			var v9: multiset<int> := multiset{f23, 544, f23};
			f27[742] := (multiset{f23} - v9) >= v9;
			...
			var v20: map<int, bool> := map[f23 := f27[742]];
			var v21: map<bool, int> := map[false := |v20|];
			var v22: seq<map<int, int>> := [map v19 : int | v19 in v4 :: (v19 / f23) := (|{v5}|), v12, map[fm5(v6, globalState) := |v21|], v12];
			var v24: array<map<int, int>> := new map<int, int>[27] [map v11 : int | (0x3d2 <= v11) && (v11 < 293) :: (v11 + 0x102) := (|v0|), map[f23 := 0x254] + v12, v13.cf10[|f24| := f23], v12, v12, v12 + map[f23 := fm5(v6, globalState)], v12, if (f27[742]) then (map[|v4| := 0x1a])[f23 := f23] else map[f23 := --f23], (map[fm5(DC0(f27[742]), globalState) := f23])[f23 := |v15|], map v16 : int | (0x38c <= v16) && (v16 < 0x6d) :: (v16 % |[f23]|) := (|v9|), v12, v12, v12, v12, map v17 : int | v17 in v9 :: (v17 - f23) := (-0x356), v12[|v18| := f23], v22[if (f27[742] in v21) then v21[f27[742]] else |multiset(v7[90])|], map[f23 := f23], v12, map[f23 := fm5(v6, globalState)], map[f23 := f23], v12, v12, v12 + v12, v12, v12, map v23 : int | v23 in (seq(844, i1  => (f23))) :: (v23 % f23) := (-607)];
			v24[878] := v12 + v12;
			var v25: multiset<bool> := multiset{f27[742], fm5(DC0(!v5), globalState) > f23, f27[742], v0 <= v0, fm5(v6, globalState) > |map[f27[742] := f23]|};
			var v26: map<bool, map<int, int>> := map[v5 := v12];
			globalState.f15, v10[383], f27[742], globalState.f19, v24[878] := if ((if (f27[742]) then f27[742] else f27[742]) in v25) then v25[if (f27[742]) then f27[742] else f27[742]] else f23, v1, fm0(v5, v5, v5, globalState) < v0, v5, (if (f27[742] in v26) then v26[f27[742]] else v12) + v12;
		} else {
			...
			var v39: array<map<char, bool>> := new map<char, bool>[13] [v31, v31 + v31, v31, v31, map[v1 := v28], v31, map v32 : char | v32 in v34 :: (v32) := (v28), map v35 : char | v35 in v31 :: (v35) := (v28), fm6(v28, globalState), v38[f23], v31, fm6(v28, globalState) + map[v1 := v28], v31];
			v39[532] := map['l' := v28];
			v39[532] := v31;
			globalState.f19 := v28 <==> v28;
			v3[154] := f23 / f23;
			v3[154] := if (v28) then f23 + |f24| else f23 + f23;
		...
		var v45: multiset<bool> := multiset{v42[|v43|], v41, v41, fm7(v44, v41, v41, v41, globalState)};
		...
		v52.f28[223] := f23;
		var v53 := DC0(v41);
		v52.f28[223] := fm5(v53, globalState);
		var v54 := DC4(v52.f28[223], f23, v41);
		r0 := v43 + [-v54.cf8, v52.f28[223]];
		r1 := v2;
		r2 := v3;
	}
}
...
class C2 extends T0 {
	...
	function fm1(globalState: GlobalState): seq<bool> {
		[f23 < |multiset{|(seq(0x72, i0  => (f25)))|, f23, 0x366}|, !true ==> false, false, !(["skesdwe"] <= ["peosewwp"]), false <==> true]
	}
	...
	method m0(globalState: GlobalState) returns (r0: seq<int>, r1: seq<string>, r2: array<int>) {
		...
		var v2 := "wbjrub";
		var v3 := DC3(v2);
		var v4: map<int, bool> := map[f23 / |v1| := v3.cf6 <= v2];
		var v5 := false;
	...
	method m1(p0: string, p1: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: int, r3: int) {
		...
		for i0 := if (p1) then f23 else f23 to fm3(p0, fm4(p1, |v0|, 0x31e, p1, globalState), f23, globalState) {
			...
			v4[628] := if (p1 in v5) then v5[p1] else 0x144;
			var v6 := DC2(i0, p1, v4, i0);
			v2, v3, v4[628], r3, globalState.f15 := if (v6.cf3) then if (p1) then v2 else v2 else v2, v3, -i0, i0, if (p0 < p0) then |p0| else f23 + i0;
		...
		v9[108] := f23;
		var v10: map<bool, int> := map["dbr" == p0[f23 := f25] := f23];
		v9[108] := if (p1 in v10) then v10[p1] else -f23;
		match (fm8(map v11 : int | (0x1f8 <= v11) && (v11 < 273) :: (v11 % v9[108]) := (p1), p1, 0x3f % v9[108], f25 !in p0, globalState)) {
			case DC6(cf11, cf12, cf13) =>
				...
				v16[914] := v0 + v0;
				r0, globalState.f0, v9[108], v15, v16[914] := cf12 > f23, p1, cf12, DC4(|(p0 + p0)|, f23, p1), v0;
				globalState.f15 := -(v9[108] - cf11);
			case DC7(cf14, cf15, cf16, cf17) =>
				...
				if (fm7(v17, true, p1, false, globalState)) {
					...
					var v23: seq<int> := [v9[108]];
					var v24: array<seq<int>> := new seq<int>[1] [v23 + v23];
					var v25: map<int, seq<int>> := map[f23 := v23];
					v24[614] := (if (0x2ea in v25) then v25[0x2ea] else v23)[v9[108] := v9[108]];
					v24[614] := v23;
					v22.f27[179] := p1;
					v22.f27[179] := cf15;
					var v26: map<int, bool> := map[|p0| := p1];
					var v27: map<C1, int> := map[v22 := v9[108]];
					var v28: multiset<int> := multiset{|v27|};
					var v29: map<int, int> := map[|p0| := v9[108]];
					var v30: map<multiset<int>, char> := map[v28 := fm11(cf14, f25, |v29|, globalState)];
					var v31: seq<map<int, bool>> := [v26, map[cf14 := p1] + v26, map[v9[108] := p1] + map[|v30| := cf17]];
					v31 := [v26, v26, v26 + v26, v26];
					var v32: array<D4> := new D4[5];
					v32[338] := fm12(|v10|, globalState);
					var v33 := DC8(multiset{|v0|});
					cf16, v32[338], globalState.f18, r3 := v18.cf0, v33, 832 > |f24|, 0x311;
				} else {
					...
					var v44: map<D1, seq<int>> := map[DC1(v40) := [v9[108], f23, cf14, |multiset{|[cf16]|, |v35|, |(map v41 : int | v41 in v42 :: (v41 / |v0|) := (cf15))|, --112, 0x2a0}|, |(map v43 : int | v43 in map[v9[108] := p1] :: (v43 / f23) := (p1))|]];
					var v45: array<bool> := new bool[28] [cf17, if (cf17) then !cf15 else !cf15, cf15, cf17, cf16, true, cf16, p1, cf15, p1, cf15, cf15, p1, v0[-0x3d7] <== cf16, cf14 !in v38[v9[108] := f23], !(v39 >= multiset{|p0|}), v44 == v44, false, p1, true, !(726 <= cf14), v17 > v17, v0[cf14], !(f24 >= f24), !cf17, cf15, p1, !(v0 != v0[cf14 := p1])];
					v40[402] := cf16;
					var v46: array<string> := new string[8](i4 => p0);
					v46[605] := fm0(cf15, v0[v9[108]], !cf17, globalState);
					var v47: set<D3> := {v34, v34};
					var v48: map<int, multiset<int>> := map[v9[108] := v39];
					var v49: seq<string> := [fm0(cf15, cf16, cf16, globalState), "rjfqifje"];
					v40[402], v46[605], v47 := |(p0 + p0)| !in (v48 + map[v9[108] := v39]), v49[f23], fm13(cf14, cf14, globalState);
				}
				
				var v50: set<int> := {cf14};
				var v51 := DC10(!cf15, fm3(p0, [v50, {|(seq(0x56, i5  => (|p0|)))|, v9[108]}, v50], f23, globalState) + |p0|, f25, p1);
				v51 := if (cf17 && cf15) then v51 else v51;
				var v52 := DC6(v51.cf24, v9[108], |v17|);
				var v53 := DC0(cf16);
				var v54: map<char, bool> := map[fm11(cf14, f25, cf14, globalState) := true];
				var v55: array<D3> := new D3[17] [v52, DC6(0x259, v9[108], f23), v52, v52, v52, DC6(cf14, cf14, fm5(v53, globalState)), v52, v52, v52, v52, v52, DC6(|v54|, |map[f23 := true]|, 0x102), v52, v52, v52, v52, DC6(|[0x1de]|, v9[108], cf14)];
				var v56: C0 := new C0(v9, v55);
				var v57: map<C0, C0> := map[v56 := v56];
				var v58 := DC2(f23, cf16, v9, v9[108]);
				...
				var v63: array<bool> := new bool[15] [cf17, cf16, fm7(v17, cf17, cf17, cf16, globalState), cf17, cf16, p1, true, cf15, fm7(v17, cf17, cf17, p1, globalState), !fm7(v17, p1, p1, cf16, globalState), v0[|v62|], !p1, cf16, cf16, p1];
				var v64, v65 := m2(v9[108] * f23, -0x2a2, cf14, v60, globalState);
				if (true) {
					...
					v60[288] := if (v68 in v69) then v69[v68] else v65;
					v60[288] := !cf16;
					globalState.f18 := cf17;
					var v70: array<multiset<array<int>>> := new multiset<array<int>>[1];
					var v71: map<int, array<int>> := map[cf14 := v56.f28];
					v70[744] := multiset{v56.f28, if (v61.f23 in v71) then v71[v61.f23] else v56.f28};
					var v72: multiset<array<int>> := multiset{v9};
					v70[744] := v72 * multiset{v9};
					v63 := new bool[5] [cf17, cf17, cf17, "krgr" <= fm0(!true, cf17, cf16, globalState), p1];
					globalState.f15 := v9[108];
				} else {
					var v73 := new C1(v59, v60, -v9[108], v61.f24);
					var v74: map<int, bool> := map[|"qhjsfsl"| / v61.f23 := cf17];
					v74 := v74[if (v65) then -v9[108] else v9[108] := !!v65 ==> cf17];
					...
					r0, v9[108], v77 := v53.cf0, v61.f23 % v61.f23, v73;
			...
			case DC5(cf10) =>
				...
				if (v78.cf0) {
					...
					var v86: map<int, seq<D4>> := map[fm2(globalState) / f23 := v85];
					v85 := if ((v9[108] * v9[108]) in v86) then v86[v9[108] * v9[108]] else [v83];
					globalState.f12 := p0;
					var v87 := 's';
					v87 := f25;
				} else {
					var v88 := DC2(0x6d, p1, v9, v9[108]);
					...
					v96[402] := fm9(p0, globalState);
					var v97: set<string> := {p0, fm0(v89[715], !v89[715], p1, globalState)};
					var v98 := DC14(v97);
					v95[45], v96[402], v97, globalState.f19, globalState.f15 := if (true ==> p1) then v9 else v9, f24 - f24, v97 - (v98.cf29 * v97), !(v89[715] && (true <== true)), |fm0(v89[715], v89[715], v89[715], globalState)|;
				}
				
				cf10 := cf10[v9[108] := if (p1) then f23 else f23];
				var v99: array<bool> := new bool[13];
				v99[708] := p1;
				var v101: seq<set<int>> := [set v100 : int | (0x216 <= v100) && (v100 < 0x2fc) :: (v100 - v9[108])];
				v99[448] := fm7(fm10(f23, p1, p1, fm3(p0, v101, v9[108], globalState), globalState), p1, p1, p1, globalState);
				var v102: map<char, string> := map[f25 := "vl"];
				var v103 := DC3(p0);
				var v104: array<string> := new string[29] [p0, p0, p0, p0[0x9c := f25], p0, p0 + "kijtk", p0, p0, fm0(p1, p1, p1, globalState), p0, p0, p0, p0, if ('a' in v102) then v102['a'] else seq(-523, i8  => (f25)), p0, p0, p0 + (seq(-0x16b, i9  => ('l'))), if (p1) then p0 else p0[v9[108] := f25], p0, p0, p0, v103.cf6, p0 + "glmdsbci", "evl", p0, p0, p0, p0 + p0, p0];
				v104[333] := p0;
				var v105: multiset<bool> := multiset{!p1, p1, p1};
				var v106 := DC6(f23, |v105|, |[f25]|);
				var v107: seq<int> := [|p0|, |v10|];
				v99[708], r3, v99[448], globalState.f12, v104[333] := p1, -fm3(p0 + p0, v101, v106.cf12, globalState), p1, p0, p0[v9[108] := f25] + p0[v107[v106.cf13] := 'g'];
				v104[333] := p0 + p0;
		}
		...
		r1 := v9;
		r2 := f23 - (v9[108] + |v0|);
		var v111 := DC2(v9[108], p1, v9, -487);
		var v112: seq<int> := [v9[108], v9[108]];
		r3 := -(|map[v111 := v112[v9[108]]]| * f23);
	}
	method m2(p0: int, p1: int, p2: int, p3: array<bool>, globalState: GlobalState) returns (r0: bool, r1: bool) {
			...
			decreases 100 - i3
		{
			...
			if (fm7(if (v0) then v10 else v10, v0, v0, DC2(p2, v0, v8, p2).cf3, globalState)) {
				...
				v14.f27[755] := fm7(v10, !(if (v0 in v12) then v12[v0] else v0), v0, false, globalState);
				v14.f27[755] := !!(v0 <== fm7(v10, v0, v0, fm7(v10, false, !v0, v0, globalState), globalState));
				var v15 := DC10(v14.f27[755], p2, 't', v0);
				var v16: T0 := new C1(DC2(0x42, v0, v8, 75), v11.f27, |v10|, f24);
				var v17: map<D4, T0> := map[v15 := v16];
				var v18: map<bool, map<D4, T0>> := map[v0 := v17];
				var v19 := DC17(v18);
				var v20: array<map<bool, map<D4, T0>>> := new map<bool, map<D4, T0>>[16] [v18[!v0 := v17] + v18, v18 + v18, map[v14.f27[755] := v17], v18 + v18, v18, v18, v18, map[true := v17] + v18, v18, v18, v18, v18, v18, v18, v19.cf34, v18];
				v20[572] := v18;
				v20[572] := v19.cf34;
				globalState.f15 := -0x2f4 + f23;
				var v21: array<D3> := new D3[1](i4 => DC6(v16.f23, |(seq(0x2b1, i5  => (|map[v16.f23 := v14.f27[755]]|)))|, f23));
				...
				var v28: array<C1> := new C1[8] [v11, v11, v11, v11, v11, v24[|v27|], v11, v11];
				var v29: map<int, int> := map[|v4| := |v1|];
				var v30: set<D3> := {fm15(p2, |f24|, globalState), DC5(v29)};
				var v31: seq<array<C1>> := [v28, v28];
				v11.f27[169], v28, globalState.f18 := v30 > v30, v31[p0], v0;
				var v32, v33, v34 := v11.m0(globalState);
				var v35: map<int, bool> := map[p0 := true];
				v35 := v35[|v1| - p0 := [v11.f27[169], v11.f27[169]] != v27];
				v1, v34, globalState.f0, v5, v8 := v1 + v1, v34, v11.f27[169], v5, if (v0) then v34 else v8;
				v12 := v12[v0 := v11.f27[169]];
			}
		...
		r1 := v42[v2[if (false in v43) then v43[false] else p1]] <==> v0;
	}
}
...
method Main() {
	...
	var v2 := -0x2e3;
	var v3 := DC0(true);
	var v4: array<bool> := new bool[25] [v0, !true, true, v0, v0, v0, !v0, v0, v0, v0, v0, false, !v1[v2], v0, v0, v0, v0, v0, v0, v0, v3.cf0, !v0, v0, v0, v0];
	var v5 := DC1(v4);
	...
	var v12: array<int> := new int[19](i2 => i2 / -v2);
	var v13: map<string, bool> := map[v7 := v0];
	var v14 := DC3(v7);
	var globalState := new GlobalState(false, 0x27a, -0x30d, v4, seq(893, i0  => ('s')), v4, 0x1a5, if (v6 in v9) then v9[v6] else v8, v10, {v11}, v12, v4, v7, v13 + map[v7 := !v0], 536, 701, 0x383, (v14.(cf6 := v7)).cf6, true, true, 0x1e, 0x355, v7);
	v4[451] := v0;
	v4[451] := (v2 % v2) > |v7|;
	if (v7[v2] !in (if (v0) then v7 else v7)) {
		globalState.f18 := fm0(true, v4[451], v0, globalState) < ("fdcfhyoev" + v7);
		if (v4[451]) {
			var v15 := 'v';
			var v16: map<int, bool> := map[v2 := v4[451]];
			var v17 := new C2(v15, |(v16 + v16[v2 := v0])|, v11);
			var v18: map<bool, int> := map[v0 := 0x1bc];
			v18 := v18;
			globalState.f19 := v7 < (v7 + v7[v2 := v15]);
			var v19: multiset<bool> := multiset{v0, v4[451]};
			var v20, v21, v22, v23 := v17.m1(fm0(if (0x2a6 in v16) then v16[0x2a6] else true, v0, false, globalState), fm7(v19, !fm7(v19, v4[451], v0, false, globalState), !fm7(v19, v4[451], v0, v0, globalState), v0, globalState), globalState);
			var v24: array<set<bool>> := new set<bool>[28](i3 => {false, !v4[451]});
			v24[14] := v11;
			var v25: seq<set<bool>> := [v11];
			var v26: seq<set<bool>> := [v11, v11, v25[936], v11];
			v24[14] := v26[v22] - (v11 + v11);
		} else {
			var v27: set<string> := {(seq(0x13c, i4  => ('j')))[v2 := 'f']};
			var v28: map<bool, int> := map[v4[451] := |v27|];
			v28, globalState.f15, v4[451] := v28, v2, v4[451];
			var v29: array<D4> := new D4[17];
			var v30 := 'b';
			var v31 := DC10(v4[451], v2, v30, v0);
			v29[928] := v31;
			v29[928] := v31;
			...
			var v36: map<bool, bool> := map[v4[451] := v0];
			var v37: seq<C0> := [if (|v36| in v35) then v35[|v36|] else v34];
			v12[97], globalState.f15 := |([v34, v34] + v37)|, v2;
		}
		
		var v38: seq<array<bool>> := [v4];
		var v39: seq<int> := [v2, 0x3d5, v2, |v1|, v2];
		var v40: map<int, int> := map[|v38| := |v39|];
		v2 := (if (v2 in v40) then v40[v2] else v2) - (|v1| % |v39|);
		var v41 := 't';
		var v42: map<bool, int> := map[v0 := v2];
		var v43, v44, v45, v46 := m3(if (v0) then v41 else v41, fm16(v42, v4[451], true, globalState), v2, v4[451], globalState);
		var v47 := DC4(v39[v2], |(fm0(!v4[451], false, v44, globalState))[211 := v41]|, v4[451]);
		...
		var v53 := 'w';
		var v54: C2 := new C2(v53, v2, {v4[451]} + v11);
		globalState.f0, v2, v54, v7 := true, |fm0(v0, false, v4[451], globalState)|, v54, v7;
		var v55: map<bool, int> := map[v0 := v2];
		if ((v55 + map[v4[451] := |v1|]) != (v55 + v55)) {
			globalState.f19 := v0 ==> v4[451];
			var v56 := DC2(|[v2]|, v4[451], v12, v2);
			var v57: multiset<bool> := multiset{v4[451], false};
			var v58: C1 := new C1(v56.(cf5 := v2), v4, -|v57|, v11);
			v58 := v58;
			var v59: set<int> := {v2};
			var v60: seq<set<int>> := [v59];
			var v63: multiset<int> := multiset{v2, v54.fm2(globalState)};
			var v64: array<set<int>> := new set<int>[22] [fm18(globalState), v59 - v60[v2], v59 + v59, v59, {v2, |v59|} + v59, v59, {-0x21d} * {v2}, set v61 : int | v61 in {|"kl"|, v2} :: (v61 % |(seq(0x102, i5  => ('x')))|), v59, v59 + v59, v59, {v2}, v59, set v62 : int | (734 <= v62) && (v62 < 221) :: (v62 * v2), v59, fm18(globalState), v59, {v2, if (-0xa7 in v63) then v63[-0xa7] else v2, |v7|, |v7|}, if (v4[451]) then v59 else v59, v59, v59, v59];
			v64[9] := if (v4[451]) then v59 else {v2};
			var v66: map<int, bool> := map[v2 := v4[451]];
			v64[9] := if (v0) then set v65 : int | (19 <= v65) && (v65 < 0x3a3) :: (v65 / v2) else {v2, v2, |v66|};
			globalState.f0 := !v4[451];
			globalState.f15 := v2 + v2;
		} else {
			var v67: map<string, int> := map[v7[v2 := v54.f25] := v2];
			var v68: multiset<bool> := multiset{true};
			var v69: C1 := new C1(DC2(v2, v4[451], v12, v2), v4, v2, {v4[451], v4[451]});
			var v70 := DC15(v2, v68, v69);
			v67 := v67[v7 := v70.cf30];
			v0 := !v4[451] && v0;
			globalState.f0 := v4[451] <==> (v7 <= (seq(-0x133, i6  => ('i'))));
			v10[149] := v54.f25;
			var v71: map<array<int>, bool> := map[v12 := v0];
			var v72: map<bool, char> := map[v4[451] := v54.f25];
			var v73: map<int, bool> := map[0x26e := v4[451]];
			v10[149], v2, v71, v1, globalState.f18 := if (v0 in v72) then v72[v0] else v54.f25, if (v0 !in v1) then v2 else |v73|, v71, v1, v4[451];
	...
	if (v83.f23 != v83.f23) {
		if (v4[451]) {
			...
			v12[359] := v2;
			v12[359] := 0x167;
			var v87 := new C2(v81, v83.f23 / v83.f23, {v0});
			...
			var v95: map<bool, D6> := map[v4[451] := v94];
			v4[451], v4[451], v81 := v4[451], !(v82.cf3 !in v95), v81;
			var v96: array<D3> := new D3[20](i9 => DC6(|v77[86]|, v83.f23, v2));
			var v97 := new C0(v12, v96);
			var v98: multiset<int> := multiset{v2};
			var v99: seq<int> := [-(if (|v7| in v98) then v98[|v7|] else v2), 0x91];
			var v100: map<int, bool> := map[|map[-v99[|v77[86]|] := v86.f27]| := v0];
			v1 := ([v4[451] <== v0])[0x64 := if (v83.f23 in v100) then v100[v83.f23] else !v0];
		...
		var v108: map<int, bool> := map[v83.f23 := fm7(v107, false, true, fm7(v107, v4[451], v4[451], v0, globalState), globalState)];
		...
		if (if (v4[451]) then v4[451] else v0) {
			...
			v117[509] := v118[v83.f23];
			v117[509] := v115.f28;
			var v119: multiset<bool> := multiset{v0, v4[451]};
			v117[509][232] := |v119| + |v7|;
			v117[509][232] := v83.f23;
		} else {
			...
			v7, globalState.f0, v4 := v77[86], v4[451], if ((v83.f23 / v122[v83.f23]) in v120) then v120[v83.f23 / v122[v83.f23]] else v86.f27;
			var v123: C2 := new C2(v81, v83.f23, v83.f24);
			v123 := if (v4[451]) then v123 else v123;
			v4 := v86.f27;
		...
		v4[451] := v0 in [v0, v4[451], v4[451]];
		if (v0) {
			var v125: multiset<bool> := multiset{v4[451], v0};
			globalState.f0 := if ("yewfuklni" in v13) then v13["yewfuklni"] else fm7(v125, v0, v0, v0, globalState);
			var v126 := DC10(v0, v83.f23, v81, v4[451]);
			globalState.f19 := v126.cf23;
			globalState.f15 := 0x21b - (-v83.f23 - v2);
			globalState.f18 := v0;
			var v127: map<bool, int> := map[v4[451] := v83.f23 + v83.f23];
			v127 := v127[v0 := v83.f23];
		} else {
			var v128, v129, v130 := v83.m0(globalState);
			var v131: multiset<bool> := multiset{v0};
			globalState.f15 := v83.f23 % (v83.f23 / (if (v0 in v131) then v131[v0] else 0x1dd));
			v2 := v2;
			v2 := v2 % |(fm19(v0, globalState) + map[v83.f23 := -278])|;
		...
		match (v133) {
			...
			case DC10(cf23, cf24, cf25, cf26) =>
				...
				var v138, v139, v140, v141 := v136.m1(v77[86], v4[451], globalState);
			case DC8(cf18) =>
				var v142: seq<int> := [v83.f23];
				var v143: map<int, seq<int>> := map[v83.f23 := v142];
				var v144: map<bool, int> := map[v4[451] := v83.f23];
				v143, v4[451], v4[451], v4[451] := fm20(|"qsalhq"|, v83.f23, globalState), v0, v4[451], fm7((multiset(v1))[true := v83.f23] - multiset{true}, v0, v0, DC4(0x66, if (v0 in v144) then v144[v0] else |v77[86]|, v0).cf9, globalState);
				globalState.f0 := v0;
				globalState.f18 := v0 && v0;
				v81, v2, globalState.f15, v2 := fm11(-v83.f23 * |v7|, v81, v83.f23, globalState), |cf18| / v83.f23, |{v0}|, v83.f23 % v83.f23;
		}
	...
	match (v14.(cf6 := v7)) {
		case DC4(cf7, cf8, cf9) =>
			if (v83.f23 < -v83.f23) {
				v4[451] := !((v83.f23 % |v83.f24|) > cf7);
				v4 := new bool[4] [!(v145 != v145), v0, cf9, v0];
				globalState.f12 := v77[86] + v7;
				v4[451] := false;
				var v147: map<bool, set<bool>> := map[false := v83.f24];
				var v148: map<char, bool> := map[v7[-0xe8] := v4[451]];
				...
				v150, globalState.f0, v83 := [-v83.f23, |fm22(v0, globalState)|, |v7|] + [cf8], |(if (v4[451]) then v152 else v152)| != v83.f23, v83;
				var v153: array<set<seq<int>>> := new set<seq<int>>[26](i10 => {[|[cf8]|], [|(seq(-580, i11  => (v77[86][|v77[86]|])))|, |v1|], [0x91, v2], v150});
				var v154 := DC18([cf8]);
				var v155: set<seq<int>> := {v150, v154.cf35};
				v153[6] := v155;
				globalState.f19, v153[6] := fm5(v3, globalState) == fm5(v3, globalState), v155 + v155;
			...
			var v164: seq<array<seq<bool>>> := [v162, v162, if (v4[451]) then v162 else v162];
			globalState.f0, v162 := |v163| != (cf8 + -v2), v164[v83.f23];
			if (cf9 || cf9) {
				...
				v167[206] := v86.f26;
				v12[368] := v83.f23 - v2;
				var v168: map<int, array<char>> := map[v83.f23 := if (!v4[451]) then v10 else v10];
				v167[206], globalState.f8, v12[368] := v86.f26, if (v83.f23 in v168) then v168[v83.f23] else v10, (v2 % |v7|) % cf7;
				...
				var v176 := new C2(fm11(v83.f23, v81, v83.f23, globalState), if (|v175| in v175) then v175[|v175|] else cf7, fm9(v77[86], globalState));
				var v177: set<string> := {v7, v7};
				var v178 := DC14(v177);
				var v179 := DC16(v178);
				var v180: seq<map<bool, bool>> := [v163, v163];
				var v181: multiset<map<bool, bool>> := multiset{v180[v83.f23], v163 + v163};
				var v182: seq<array<char>> := [v10];
				var v183: set<int> := {v174};
				v179, globalState.f19, globalState.f8, globalState.f15, v181 := DC16(v178), v0, v182[0x32c], |v183| / (0x42 + v83.f23), v181;
			} else {
				v79 := v79[|v13| := |v77[86]|];
				v4[451] := !!fm7(v145, v4[451], v77[86] !in v13, cf9, globalState);
			...
			v186[831] := v5;
			v186[831] := DC1(v86.f27);
		case DC3(cf6) =>
			v83, cf6, globalState.f18, globalState.f15, globalState.f18 := v83, (("geke")[|v7| := v81])[0x128 := v81] + (seq(-0x2f, i12  => (v81))), true, v2, v4[451];
			var v187 := DC5(v79);
			var v188: seq<D3> := [v187];
			var v189: array<seq<D3>> := new seq<D3>[16] [v188, v188 + v188, v188, v188, v188, v188, v188[|v1| := v187.(cf10 := v79)], v188, [v187, v187.(cf10 := v79)], v188 + v188, v188 + v188, v188, fm23(v4[451], globalState), seq(0x32c, i13  => (v187)), v188, v188];
			v189[576] := seq(0x77, i14  => (DC5(v79)));
			v2, v189[576], v77 := v2 + (v83.f23 * v2), v188, v77;
			v6[647] := v86.f27;
			var v190: map<array<bool>, array<bool>> := map[v86.f27 := v4];
			v6[647] := if (v4 in v190) then v190[v4] else v86.f27;
			v2 := |v1|;
	}
	
	var v191: seq<int> := [0xb];
	var v192: set<int> := {v191[|map[v0 := v83.f23]|], v2, v83.f23, v2};
	var v193: seq<map<bool, bool>> := [map[v0 := v0]];
	v4[451] := DC0(v0).cf0 && (v192 >= (set v194 : int | v194 in [|v193|] :: (v194 / -|[!false]|)));
	var v195, v196, v197 := v83.m0(globalState);
	if (v4[451]) {
		var v198 := new C1(v82, v4, |v7| + |v7|, v83.f24);
		v77[86] := fm0(v0, v0, v0, globalState) + (seq(0x3c9, i15  => (v81)));
		v77 := new string[21];
		var v199: map<bool, int> := map[v0 := 0x24d];
		var v200: map<char, string> := map[v81 := v77[86]];
		globalState.f15 := if ((v4[451] <==> v4[451]) in v199) then v199[v4[451] <==> v4[451]] else |(v200 + v200)|;
		v2 := v2 % v83.f23;
	} else {
		...
		v1 := v1 + v1;
		v4 := v86.f27;
		var v203 := DC10(v0, |v7[v2 := v81]|, v81, v4[451]);
		globalState.f15, globalState.f19, v2, v4[451], globalState.f15 := v2 % -v83.f23, !v0, v83.f23, (v203.(cf25 := v81, cf24 := fm5(v3, globalState))).cf23, --v2 % (if (false) then v2 else -v83.f23);
		if (v0) {
			var v204: array<C0> := new C0[15];
			var v205: C2 := new C2(v81, v2, {v4[451]});
			var v206: map<bool, bool> := map[v0 := v4[451]];
			var v207: multiset<int> := multiset{v83.f23};
			var v208 := DC6(v2, v83.f23, v2);
			var v209: seq<set<int>> := [v192];
			var v210: map<set<bool>, bool> := map[v83.f24 := v4[451]];
			...
			v204[751] := v212;
			v204[751] := if (v4[451]) then v212 else v212;
			v4[451] := v4[451];
			v4 := v86.f27;
			var v213: seq<seq<set<int>>> := [v209, [v209[|map[-v83.f23 := v83.f23]|], v192, {|v1|, v2}], v209];
			v209 := if (v4[451]) then v209 + v209 else v213[v2];
			globalState.f18, v81 := if (v4[451]) then v0 else v83.f23 <= v83.f23, if (v4[451]) then v205.f25 else v205.f25;
		} else {
			var v214: map<T0, seq<array<int>>> := map[v83 := [v197, v197, v12]];
			var v215: seq<array<int>> := [v12, v197];
			v214 := v214[v83 := v215];
			v197[290] := v83.f23;
			var v216 := DC7(v83.f23, v0, v4[451], v4[451]);
			globalState.f18, globalState.f19, globalState.f19, v197[290] := true, if (v216.cf14 in v202) then v202[v216.cf14] else v4[451], (seq(0x2f4, i16  => (v2))) != ((seq(532, i17  => (v83.f23))) + v191), v2;
			var v217 := DC4(v83.f23, v83.f23, v0);
			globalState.f18 := if (fm0(fm7(multiset{v0, v4[451]}, v217.cf9, false, v4[451], globalState), v0, true, globalState) in v13) then v13[fm0(fm7(multiset{v0, v4[451]}, v217.cf9, false, v4[451], globalState), v0, true, globalState)] else v4[451];
			var v218: multiset<seq<bool>> := multiset{v1[v83.f23 := v4[451]], v1, v1, v1, if (!v4[451]) then DC19(v1).cf36 else v1};
			v218 := v218;
