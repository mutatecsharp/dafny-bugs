...
class C1 extends T0 {
	...
	function fm6(p0: seq<bool>, p1: int, globalState: GlobalState): set<multiset<int>> {
		({multiset{|(seq(abs(175), i0  => (multiset{f12})))|}} - DC7({multiset([|map[f12 := f12]|, f8])}).cf9) + ({multiset{-0x18e}, multiset{f8, f8}, multiset{f7}, multiset{0x27f}, multiset{f7}} * {multiset{|map[f12 := 'v']|, f7, |(seq(abs(0xef), i1  => (f13)))|}})
	}
	function fm7(p0: string, p1: int, globalState: GlobalState): int {
		f7
	}
	method m6(p0: int, globalState: GlobalState) returns (r0: seq<bool>, r1: D3) {
		for i0 := p0 to f7 {
			...
			v1[safeIndex(23, v1.Length)] := safeModuloInt(f7, f8);
			var v2: array<D3> := new D3[26];
			var v3: multiset<int> := multiset{|"mpakoftbq"|, f13, |(seq(abs(307), i1  => ('i')))|};
			var v4: seq<multiset<int>> := [v3];
			var v6 := DC7(set v5 : multiset<int> | v5 in v4 :: (v5));
			v2[safeIndex(597, v2.Length)] := v6;
			...
			v1[safeIndex(23, v1.Length)], v2[safeIndex(597, v2.Length)], globalState.f3 := |(if (|v10.cf12| in v8) then v8[|v10.cf12|] else v7)|, fm12(!v0.f11 || true, v0.f11, fm3(f12, globalState), globalState), if (f12) then f7 != |v11| else p0 == |map[v0.f11 := f8]|;
			v1 := v1;
		}
		var v12 := "nhflilcl";
		v12 := v12;
		...
		var v16: set<int> := {safeModuloInt(f13, f13), f13, f7, f7};
		v16 := v16;
		f13 := safeDivisionInt(p0, fm7(v12, f7, globalState));
...
class C2 extends T0 {
	...
	function fm6(p0: seq<bool>, p1: int, globalState: GlobalState): set<multiset<int>> {
		{multiset{|[true, false, !false, true]|}, multiset{f8}} - {multiset{|map[|map[true := |"ql"|]| := f8]|}, multiset{f8, f7, f9}, multiset{0x34e, f8}, multiset{|(seq(abs(0x17), i0  => ({f9})))|}}
	}
	function fm7(p0: string, p1: int, globalState: GlobalState): int {
		f8
	}
	...
	method m5(p0: string, p1: map<bool, int>, globalState: GlobalState) returns (r0: string) {
			...
			decreases 100 - i0
		{
			...
			if (true <== v0) {
				...
				var v4: seq<bool> := [v0];
				var v5 := DC3(v2);
				var v6: map<int, D1> := map[safeModuloInt(f7, |multiset(v4)|) := v5];
				v6 := map[0x231 := v5] + v6;
			...
			if (if ((v28 !in v29) in v26) then v26[v28 !in v29] else v20 != v20) {
				...
				var v35: seq<T0> := [v27];
				v34[safeIndex(951, v34.Length)] := |v35| != v27.f8;
				v34[safeIndex(951, v34.Length)] := v0;
				v21[safeIndex(680, v21.Length)] := v27.f8;
				v21[safeIndex(680, v21.Length)] := safeModuloInt(f9, v27.f8);
				f10 := (if (v34[safeIndex(951, v34.Length)]) then f8 else fm0(v18, globalState)) * -v27.f8;
			} else {
				...
				v39 := (v39 + v39) + v39;
				v21[safeIndex(321, v21.Length)] := f8;
				v18, v21[safeIndex(321, v21.Length)] := v18, v27.f8;
				globalState.f1 := v0;
			}
		...
		if (if (v41) then false else v41) {
			...
			if (v41) {
				...
				v44 := (multiset{v43, v43} * v44)[v43 := abs(319)];
				r0 := "cget" + p0;
				v42[safeIndex(710, v42.Length)] := v41;
				v42[safeIndex(710, v42.Length)], f10, f10, globalState.f1, f10 := !v41, f10, f9, true, fm0('l', globalState);
				var v45: seq<bool> := [v42[safeIndex(710, v42.Length)]];
				var v46: set<seq<bool>> := {v45, v45, v45};
				v41 := !(|(v46 * {v45})| != safeModuloInt(-0x8b, -0x1a5));
			} else {
				f10 := |p0|;
				f10, globalState.f1 := f10, v41;
				globalState.f1 := v41;
				var v47: array<bool> := new bool[3];
				v47[safeIndex(729, v47.Length)] := v41;
				v47[safeIndex(729, v47.Length)] := v41;
				var v48 := new C0(v41);
			}
			...
			var v55 := 'y';
			var v56: array<int> := new int[29] [f10, -f10, |v49| + f8, f7, |v50|, f10, -f8, f7, f7, if (v41) then |v51| else f8, fm7(seq(abs(0x185), i6  => ('q')), 454, globalState), safeModuloInt(-f7, f9), f10, -|v53| - f7, v52.f8, f9, v52.f8, f7, f8, f10, -f7, f9, f7, -(f8 - -0x2e), v52.f8, (if (f9 in v54) then v54[f9] else f8) + f9, f10, fm0(v55, globalState), f10];
			v56[safeIndex(627, v56.Length)] := |v51|;
			var v57: map<char, bool> := map[v55 := v41];
			var v58: seq<T0> := [v52, v52];
			var v59: map<int, seq<T0>> := map[|(seq(abs(516), i7  => (v55)))| := v58];
			v56[safeIndex(627, v56.Length)] := |(v57 + fm13(|(if (f10 in v59) then v59[f10] else v58)|, globalState))|;
			...
			if (p0 <= p0) {
				...
				var v75: map<int, multiset<C0>> := map[fm7(("glko")[safeIndex(0x11b, |"glko"|) := 'o'], -0x80, globalState) := v74];
				...
				var v80: array<int> := new int[19] [|p0| * |(seq(abs(547), i8  => (v64)))|, |(map v72 : int | v72 in [f7] :: (safeDivisionInt(v72, 0x3b6)) := (f10))[v69.f13 := v69.f13]| * f7, f9, |map[if (f8 in v75) then v75[f8] else v74 := f9]|, if (v41) then f7 else f10, f9, 0x4c - f9, f7 - f10, |(p0 + p0)|, -v69.f13, -0x145, f9, f8 * |v76|, safeDivisionInt(--f10, v69.f13), v69.f13, f7, f8, |[f10, f8]| * |v78|, |(v79 + v79)|];
				v80[safeIndex(530, v80.Length)] := 793;
				v80[safeIndex(530, v80.Length)] := |v76|;
				globalState.f1 := v41;
				f10 := -(v80[safeIndex(530, v80.Length)] - -0x5b);
			} else {
				globalState.f3 := (v41 <== v41) || v41;
				var v81 := 'y';
				r0 := ((seq(abs(0x1ef), i9  => ('f'))) + p0)[safeIndex(f9, |((seq(abs(0x1ef), i9  => ('f'))) + p0)|) := v81] + p0;
				globalState.f1 := false;
				var v82: array<int> := new int[8] [f8, f9, |(seq(abs(0x1d4), i10  => (f7)))|, f8, |[|multiset{f7}|]|, 0x194, f10, f8];
				...
				var v87: seq<int> := [v86[safeIndex(|p0|, |v86|)], f7 - f7];
				var v88: multiset<seq<int>> := multiset{fm16(globalState), fm16(globalState), v86, v87};
				var v89: map<multiset<seq<int>>, int> := map[v88 := f7];
				v41, v87 := !v41, ([f10, f10, if (v88 in v89) then v89[v88] else f10])[safeIndex(0x1f2 + f8, |[f10, f10, if (v88 in v89) then v89[v88] else f10]|) := f9];
				r0 := p0;
			}
			...
			if (v41) {
				...
				var v92: array<int> := new int[4] [f8, safeModuloInt(|fm17(v41, f10, globalState)|, f8), v90.cf4, -safeModuloInt(f10, |v91|)];
				v92, f10 := v92, f10;
				...
				var v99: multiset<map<bool, array<bool>>> := multiset{v97, v97[v41 := v98[safeIndex(-0x202, |v98|)]], v97, map[false := v96], v97};
				var v100: array<bool> := new bool[16] [fm16(globalState) < v93, v41, v41, v41, v94 >= {p0, seq(abs(0x5d), i11  => ('o'))}, f7 != f8, if (v41) then v41 else true, v41 && v41, v41, if (fm2(v41, globalState)) then v41 else v41, v41, v95 < v95, v41, (if (v97 in v99) then v99[v97] else f8) > f9, v41, v41];
				v96[safeIndex(867, v96.Length)] := !v41;
				...
				v96[safeIndex(867, v96.Length)], v101, f10, v103, v96 := v41, v101, |map[f7 := f8]|, v103, v96;
				var v104: set<bool> := {false, false};
				var v105 := new C1(true, |v104|, f7 - f10, if (!v41) then f9 else -f8);
				var v106: array<set<bool>> := new set<bool>[15] [v104, v104 + v104, v104, v104, v104, if (v96[safeIndex(867, v96.Length)]) then v104 else v104, v104 - v104, v104, if (v96[safeIndex(867, v96.Length)]) then v104 else v104, v104, {v105.f12}, {v105.f12, v41, v105.f12, false, v41}, v104, v104 - v104, v104];
				v106[safeIndex(904, v106.Length)] := v104;
				v106[safeIndex(904, v106.Length)], v100, v102 := v104, v100, p0[safeIndex(|(seq(abs(387), i12  => (v105.f13)))|, |p0|)];
				r0 := p0;
				globalState.f1 := false;
			}
			...
			v107[safeIndex(674, v107.Length)] := v109.cf13 != 0x11c;
			...
			var v113: array<multiset<bool>> := new multiset<bool>[12] [v110, v110 * v110, v110, v110, (multiset(v111))[v41 := abs(f9)], if (v41) then v110 else v110, v110, v110, v110, v110, multiset{v41, v41, v41}, v112[safeIndex(f7, |v112|)]];
			v113[safeIndex(918, v113.Length)] := multiset{v41};
			var v114: set<char> := {v108, v108};
			var v115: map<set<char>, int> := map[v114 := f10];
			v107[safeIndex(674, v107.Length)], v113[safeIndex(918, v113.Length)], f10 := if (true) then v41 else !(v115 == v115), v110, safeDivisionInt(f8 * -f10, f7);
			var v116: set<int> := {f9, 658, 0xa3};
			var v117: map<set<int>, bool> := map[v116 := true];
			var v118: map<bool, map<set<int>, bool>> := map[v107[safeIndex(674, v107.Length)] := v117];
			var v119: map<map<set<int>, bool>, bool> := map[if (v41 in v118) then v118[v41] else v117 := v41];
			v41, v107, v41, v107[safeIndex(674, v107.Length)] := v107[safeIndex(674, v107.Length)], if (v41) then v107 else v107, false, if (v117 in v119) then v119[v117] else v107[safeIndex(674, v107.Length)];
		}
		
		var v120: seq<int> := [f8];
		var v121 := 'q';
		r0 := p0[safeIndex(|v120|, |p0|) := v121] + "vhgenyj";
		r0 := p0;
	}
}
...
class C3 extends T0 {
	...
	method m3(p0: string, p1: bool, p2: D1, p3: int, globalState: GlobalState) returns (r0: int, r1: seq<char>, r2: int, r3: bool) {
		...
		match (if (fm2(p1, globalState)) then v6.(cf3 := 'f') else v6) {
			case DC3(cf3) =>
				...
				v8 := v8;
				if (p1) {
					var v9 := new C2(p3, p3, fm0(fm3(false, globalState), globalState), safeDivisionInt(-p3, f7));
					v9.f10 := (|"r"| - |v3[safeIndex(f8, |v3|) := p1]|) * (if (p1) then 761 else v9.f9);
					var v10: array<int> := new int[10];
					v10[safeIndex(922, v10.Length)] := v9.f10;
					v10[safeIndex(922, v10.Length)] := fm0(cf3, globalState);
					var v11 := DC4(f8);
					var v12 := DC6(v11);
					var v13 := DC6(v12);
					var v14 := DC6(v11);
					...
					var v28 := DC0(v27.cf0);
					v27 := v27;
					r2 := safeDivisionInt(0x1e6, v22.f7);
				}
				
				v0[safeIndex(759, v0.Length)] := "hql" + p0;
				var v29: array<int> := new int[20];
				var v30: set<array<int>> := {v29, v29};
				v29[safeIndex(654, v29.Length)] := safeDivisionInt(|v30|, p3);
				var v32: set<char> := {cf3};
				var v33: set<int> := {|v32|};
				globalState.f1, v0[safeIndex(759, v0.Length)], v29[safeIndex(654, v29.Length)], r0 := fm2(p1, globalState), p0 + fm11(p1, |p0|, globalState), p3, |((v2 + v2) + (map v31 : int | v31 in v33 :: (v31 - f7) := (DC4(p3).cf4)))|;
				m0(globalState);
			case DC2(cf2) =>
				var v34: array<bool> := new bool[28];
				v34[safeIndex(558, v34.Length)] := p1;
				v34[safeIndex(558, v34.Length)] := cf2;
				var v35: array<int> := new int[14];
				v35[safeIndex(175, v35.Length)] := safeModuloInt(fm0('d', globalState), p3);
				v35[safeIndex(175, v35.Length)] := p3 - -f7;
				globalState.f3 := cf2;
				cf2 := v1 <= (v1 + v1);
		}
		
		r0 := safeDivisionInt(|v3|, f7);
		var v36 := DC11(f7, v5);
		var v37 := DC13(v36);
		r1 := match v37 {
			...
			case DC10(cf12) => [v5]
			case DC13(cf18) => seq(abs(0x369), i0  => (v5))
		};
		r2 := f8;
		r3 := p1;
	}
	method m4(p0: array<int>, globalState: GlobalState) returns (r0: array<map<int, int>>, r1: bool, r2: seq<int>) {
		...
		for i0 := v4 to v4 {
			...
			var v12 := 'y';
			var v13: map<array<int>, int> := map[p0 := |v1[safeIndex(-0x31c, |v1|) := v12]|];
			var v14: set<string> := {v1, v1};
			v11, v4, v4 := v11, -|v13| - safeModuloInt(v2.f8, |v14|), v2.f8;
		...
		r0 := if (v0) then if (v0) then v6 else v5[safeIndex(189, v5.Length)] else v5[safeIndex(189, v5.Length)];
		var v19: multiset<bool> := multiset{!v0};
		r1 := (if (v0) then v0 else v0) in v19;
		var v20: seq<int> := [0x3e4, v18.f10];
		var v21 := DC16(v20);
		r2 := (v20 + v21.cf22) + (seq(abs(786), i1  => (|(map v22 : D1 | v22 in map[DC3('n') := f8] :: (v22) := (v0))|)));
	}
}
...
class C4 {
	...
	method m1(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v10: array<int> := new int[18](i1 => safeModuloInt(i1, -v5));
			var v11 := DC0(v10);
			var v12: seq<array<int>> := [v10];
			match (v11.(cf0 := v12[safeIndex(v5, |v12|)])) {
				case DC1(cf1) =>
					var v13 := new C3(v5, if (v1) then v5 else v5);
					var v14: map<int, int> := map[0x20c := v5];
					var v15: map<bool, map<int, int>> := map[v1 := map[v5 := v5]];
					var v17: seq<map<int, int>> := [if (v1 in v15) then v15[v1] else map v16 : int | (0x358 <= v16) && (v16 < 0x214) :: (safeModuloInt(v16, v5)) := (v5)];
					var v18: map<char, bool> := map[v2 := !(v14 in v17)];
					v18 := v18[v2 := true];
					var v19: array<bool> := new bool[26](i2 => v1);
					v19[safeIndex(679, v19.Length)] := if (v1) then v1 else v1;
					v19[safeIndex(679, v19.Length)] := v1;
					var v20 := "xjhkseht";
					var v21 := DC17(v20, v1, v5, false, !v19[safeIndex(679, v19.Length)]);
			...
			v26 := v26[v25 := v5 == v5];
			var v27: seq<int> := [v5];
			v10[safeIndex(829, v10.Length)] := |((seq(abs(-759), i4  => (v2))) + ("t")[safeIndex(|v27|, |"t"|) := v2])|;
			var v28: multiset<map<int, int>> := multiset{map[|v7| := v5]};
			v10[safeIndex(829, v10.Length)] := |(v28 * (v28 + fm18(globalState)))|;
		}
		var v29 := "geidfsen";
		var v30: map<int, int> := map[v5 := 0xbc];
		var v32 := DC17(v29, (DC12(|(set v31 : int | v31 in v30 :: (v31 - |multiset{0x8f}|))|, [v1], false).(cf17 := !v1)).cf17, if (v5 in v8) then v8[v5] else v5, v7[safeIndex(-v5, |v7|)], false);
		v1 := v32.cf27;
		var v33: array<bool> := new bool[10](i5 => v1);
		v33[safeIndex(61, v33.Length)] := v1;
		v33[safeIndex(61, v33.Length)] := !v7[safeIndex(v5, |v7|)];
		globalState.f1 := v33[safeIndex(61, v33.Length)];
	}
	method m2(p0: map<int, bool>, p1: seq<bool>, p2: bool, globalState: GlobalState) {
		...
		v4[safeIndex(285, v4.Length)] := v7;
		var v8 := 'a';
		var v9: multiset<array<int>> := multiset{v0, v0, v0, v0, v0};
		var v10 := "jmjl";
		var v11: map<bool, bool> := map[true := p2];
		v4[safeIndex(285, v4.Length)], v8, globalState.f3, v5, v9 := v7, v8, DC12(|v10|, p1, p2).cf17, |v11|, multiset{v0};
		...
		globalState.f1 := ((seq(abs(169), i0  => (v8))) != v10) || (p2 <== p2);
		if (!p1[safeIndex(v5, |p1|)]) {
			v2[safeIndex(747, v2.Length)] := p2;
			v2[safeIndex(776, v2.Length)] := !p1[safeIndex(v5, |p1|)];
			v2[safeIndex(747, v2.Length)], v5, v5, v5, v2[safeIndex(776, v2.Length)] := p2, |((seq(abs(0x137), i1  => (v8))) + v10)|, fm0(v8, globalState), v5, p2;
			globalState.f1 := v5 != (v5 - v5);
			v2[safeIndex(747, v2.Length)] := !p2;
			globalState.f1 := fm2(v2[safeIndex(747, v2.Length)], globalState);
			v4[safeIndex(285, v4.Length)] := v4[safeIndex(285, v4.Length)][v5 := safeModuloInt(v5, v5)];
		} else {
			var v17 := new C2(v5, |multiset(v6)|, v5, v5);
			globalState.f3 := fm2(false, globalState);
			globalState.f3 := p2;
			var v18 := DC17(v10, false, v17.f10, p2, p2);
			v5 := safeModuloInt(safeDivisionInt(v17.f9, v17.f9), |((seq(abs(0x1b0), i2  => (v8))) + v18.cf23)|);
			var v19 := DC8(v17.f10);
			...
			var v25: array<string> := new string[24] [v10, v10, v10[safeIndex(0xac, |v10|) := v8], (v10[safeIndex(if (v19 in v20) then v20[v19] else -v21.cf13, |v10|) := v8])[safeIndex(|v24[safeIndex(v17.f10, |v24|)]|, |v10[safeIndex(if (v19 in v20) then v20[v19] else -v21.cf13, |v10|) := v8]|) := v8], "t" + v10, seq(abs(-519), i3  => (v8)), v10, "sval", v10, v10, v10 + (seq(abs(0x2e7), i4  => (v8))), v10, v10 + v10, v10, v10, v10, v10, v10, v10 + v10[safeIndex(v5, |v10|) := v8], v10, v10, v10 + "tswjrvwl", v10 + v10, v10];
			v25[safeIndex(376, v25.Length)] := v10;
			v25[safeIndex(376, v25.Length)] := if (!(!!p2 <== p2)) then v10 else v10 + "hupyfkie";
		}
		
		var v26: array<C3> := new C3[4];
		var v27: C3 := new C3(-|{p2, true}|, 0x17f);
		v26[safeIndex(884, v26.Length)] := v27;
		v26[safeIndex(884, v26.Length)] := v27;
	}
}

function fm0(p0: char, globalState: GlobalState): int {
	|map[multiset{'j'} := multiset{|{DC24(!false, |(seq(abs(0x1d2), i0  => ('s')))|)}|, 0x254}]|
}
...
function fm16(globalState: GlobalState): seq<int> {
	([-0x73] + [0x36f, |(seq(abs(-0x337), i0  => (DC19('n', false).cf29)))|]) + ([|(seq(abs(0x24e), i1  => (map[!true := false])))|] + [373])
}
...
function fm19(globalState: GlobalState): D3 {
	match if (false) then DC10(map[0x204 := 0x20d]) else DC10(map v0 : int | v0 in (map v1 : int | (375 <= v1) && (v1 < 0x69) :: (v1 * |(map v2 : int | (0x394 <= v2) && (v2 < 0x2b2) :: (v2 - 893) := (|map[|map[true := 90]| := 'c']|))|) := (|(seq(abs(434), i0  => ('h')))|)) :: (safeModuloInt(v0, -0x22)) := (0x168)) {
...
function fm20(p0: D2, p1: bool, globalState: GlobalState): set<bool> {
	match if (!true) then DC18(map[map['m' := false] := map v0 : int | (0x38e <= v0) && (v0 < 0x122) :: (safeModuloInt(v0, 50)) := ('q')]) else DC18(map[map['m' := true] := map[0x25 := 'y']]) {
...
method m0(globalState: GlobalState) {
	...
	for i1 := |v12| to v9.f9 {
		if (v0) {
			...
			v11 := (fm11(v0, -i1, globalState))[safeIndex(v16[safeIndex(i1, |v16|)], |fm11(v0, -i1, globalState)|) := v6];
		} else {
			...
			v25[safeIndex(875, v25.Length)] := v24;
			v25[safeIndex(875, v25.Length)] := v24;
			v1 := -i1;
		...
		var v35: seq<int> := [v9.f9, i1, |(if (true in v34) then v34[true] else v2)|, v9.fm7((fm11(v0, v9.f9, globalState))[safeIndex(i1, |fm11(v0, v9.f9, globalState)|) := v6], v9.f9, globalState)];
	...
	v3[safeIndex(468, v3.Length)] := v37 > v37;
	v3[safeIndex(468, v3.Length)] := fm2(v0, globalState);
}
method Main() {
	...
	v1 := safeDivisionInt(v1, |(map[v3 := fm0(v4, globalState)] + v6)|);
	if (!v2) {
		...
		v13, v0 := v13, (seq(abs(-0x2a), i0  => (v4))) + (v0 + v0);
		globalState.f3 := v2;
		v2 := v2;
		var v14 := DC1(v4);
		v14 := v14;
		...
		m0(globalState);
		if (v3[safeIndex(if (v2) then v1 else v1, |v3|)]) {
			var v15: set<char> := {v4, v4, v4, fm3(v2, globalState)};
			var v16: seq<set<char>> := [v15, v15];
			v16 := v16 + [v15, v15, v15];
			v0 := v0;
			var v17: array<int> := new int[10](i1 => i1 - v1);
			v17[safeIndex(415, v17.Length)] := v1 * v1;
			var v18: array<string> := new string[8];
			v18[safeIndex(395, v18.Length)] := v0;
			var v19: set<bool> := {v2};
			var v20: array<char> := new char[8] [v4, v0[safeIndex(|v19|, |v0|)], fm3(v2, globalState), v4, v4, v4, v4, v4];
			v20[safeIndex(438, v20.Length)] := 't';
			v17[safeIndex(415, v17.Length)], v18[safeIndex(395, v18.Length)], v4, v20[safeIndex(438, v20.Length)], v1 := -|fm4(-v1, v2, globalState)|, v0, v4, v4, safeModuloInt(fm0(v4, globalState), fm0(v4, globalState));
			var v21 := DC1(v4);
			v21 := DC1(v20[safeIndex(438, v20.Length)]);
			v18[safeIndex(395, v18.Length)] := v18[safeIndex(395, v18.Length)] + v18[safeIndex(395, v18.Length)];
		} else {
			m0(globalState);
			var v22: seq<int> := [fm0(v4, globalState), 0x320];
			var v23 := new C1(v2, v1, |v22|, |(v0 + v0)|);
			var v24: multiset<bool> := multiset{v2, v23.f12};
			var v25: map<int, string> := map[|v24[v23.f12 := abs(v1)]| := v0[safeIndex(v23.f13, |v0|) := 'q']];
			var v26: T0 := new C2(|v25|, safeDivisionInt(852, v1), if (v23.f12) then v23.f13 else v23.f13, v22[safeIndex(v1, |v22|)]);
			v26 := v26;
			v4 := v4;
		...
		v32 := v32;
		v1 := safeModuloInt(v1, v1 * -|fm21(|v3|, v1, globalState)|);
	}
	...
	if (v2) {
		if (v2 || v2) {
			...
			var v46 := DC20(v45);
			v40 := new int[17] [0x3a7, v1, |v41[v2 := v37.f11]|, |(v42 + v42)|, v1, v1 - v1, 0xc3 - v1, v1, -fm0(v43.cf1, globalState), safeDivisionInt(-v1, v1), |v0[safeIndex(v1, |v0|) := v4]| * v1, |map[v2 := true]|, |(if (v2) then v42 else [v1, v1, v1])|, -v1, v1, |v46.cf31|, safeModuloInt(v1, v1)];
			...
			v44[safeIndex(785, v44.Length)] := v2;
			v44[safeIndex(785, v44.Length)] := false;
			var v50 := DC17(v0, v2, |v3|, fm2(v44[safeIndex(785, v44.Length)], globalState), v44[safeIndex(785, v44.Length)]);
			v47.f13 := v50.cf25;
		} else {
			var v51: array<int> := new int[10];
			var v52: set<int> := {v1};
			var v53: seq<int> := [|v5|, v1];
			v51[safeIndex(150, v51.Length)] := safeModuloInt(|v52|, v53[safeIndex(v1, |v53|)]);
			v1, globalState.f1, v51[safeIndex(150, v51.Length)] := -(0x3a9 - (v1 * v1)), v2, v1;
			v51 := v51;
			globalState.f3 := v51[safeIndex(150, v51.Length)] <= 0xac;
			var v54: set<bool> := {v2};
			var v55: seq<set<bool>> := [v54];
			var v56: array<set<bool>> := new set<bool>[13] [v54, v54, v54, {v2, v2, DC17(v0, v2, v1, v3[safeIndex(v51[safeIndex(150, v51.Length)], |v3|)], !true).cf24} - v54, v55[safeIndex(v51[safeIndex(150, v51.Length)], |v55|)], v54, v54, {v2, v2}, {v2, v2, v2}, v54, v54, v54, {v2, v2} * v54];
			v56[safeIndex(456, v56.Length)] := v54;
			var v57: array<string> := new string[21];
			v57[safeIndex(497, v57.Length)] := "vyygsh" + v0;
			var v58 := DC19(v0[safeIndex(v1, |v0|)], v2);
			globalState.f1, v56[safeIndex(456, v56.Length)], v57[safeIndex(497, v57.Length)] := v58.cf30, v54, v0 + v0;
		...
		var v63: C2 := new C2(v1, v62[safeIndex(v1, |v62|)], v1, v1);
		v61[safeIndex(49, v61.Length)] := map[v63 := v63.fm7(v0, v63.f10, globalState)];
		var v64: map<C2, int> := map[v63 := v63.f10];
		v61[safeIndex(49, v61.Length)] := v64;
	} else {
		v1 := v1;
		...
		v68[safeIndex(546, v68.Length)] := v73;
		var v74: multiset<bool> := multiset{v2};
		v68[safeIndex(546, v68.Length)] := new int[10] [v1, v1 - 591, v1, v1 * |v74|, v1 - |v72|, v1, v1 * -0x150, v1, fm0(v0[safeIndex(0xa1, |v0|)], globalState), v1];
		var v75 := DC12(v1, [v2], !!v2);
		var v76 := DC19(v4, v2);
		var v77: set<int> := {v1, -(if (v2 in v74) then v74[v2] else 0xb3), v1};
		var v78: array<bool> := new bool[25] [v2, v2, v2, v2 || false, v2 || v2, v3 <= v3, v2 <== v2, v2, v2, v2 ==> v75.cf17, v2, v2, v2, v2, v2, v2, -v75.cf15 > v1, v2, v76.cf30, !(v2 <== v3[safeIndex(-|v77|, |v3|)]), v2, v2, v2, v2 <== v2, !v2];
		v78[safeIndex(995, v78.Length)] := v2;
		v78[safeIndex(995, v78.Length)] := v2;
		v73[safeIndex(652, v73.Length)] := v1;
		v73[safeIndex(652, v73.Length)] := (v1 + v1) - v1;
	}
	...
	var v79: seq<int> := [v1];
	v79 := v79;
	var v80: array<char> := new char[16] [v4, v0[safeIndex(|v3|, |v0|)], v4, 'a', v4, v4, 'f', v4, v4, v4, v4, v4, v4, v4, v4, 'j'];
	var v81 := DC22(v80);
	v80 := v81.cf33;
	for i2 := v1 to if (v2) then v1 else |{|fm16(globalState)|, v1}| {
		if (v2) {
			v1 := safeModuloInt(i2, i2);
			var v82: map<int, int> := map[safeDivisionInt(-v1, i2) := i2];
			v82 := v82;
			...
			v88[safeIndex(649, v88.Length)] := if (v4 in v89) then v89[v4] else v2;
			v88[safeIndex(649, v88.Length)], v4, globalState.f3 := v2, v4, v86 ==> v86;
		} else {
			var v90: array<int> := new int[16];
			v90[safeIndex(532, v90.Length)] := fm0(v4, globalState);
			var v91: seq<string> := [v0];
			v90[safeIndex(532, v90.Length)] := -(|v91| * i2);
			v1 := if (if (true) then v2 else fm2(v2, globalState)) then safeDivisionInt(v1, i2) else v1;
			v90[safeIndex(532, v90.Length)] := -i2 + fm0(v4, globalState);
			var v92: map<int, bool> := map[v90[safeIndex(532, v90.Length)] := v2];
			...
			v94[safeIndex(732, v94.Length)] := v2;
			v94[safeIndex(732, v94.Length)] := v3[safeIndex(safeModuloInt(v1, i2), |v3|)];
			globalState.f1 := if (v2) then v2 else {v94[safeIndex(732, v94.Length)], true} > {v94[safeIndex(732, v94.Length)]};
		}
		
		match (DC21(safeModuloInt(-625, i2))) {
			case DC21(cf32) =>
				var v95: array<seq<int>> := new seq<int>[11](i3 => v79);
				v95[safeIndex(443, v95.Length)] := v79;
				v95[safeIndex(443, v95.Length)] := v79 + v79;
				v36.m1(globalState);
				var v97: multiset<int> := multiset{v1, i2};
				var v98 := new C2(|(map v96 : int | v96 in v97 :: (safeDivisionInt(v96, -i2)) := (v2))|, -cf32, cf32, cf32);
			...
			case DC20(cf31) =>
				...
				v106[safeIndex(491, v106.Length)] := v105;
				v106[safeIndex(491, v106.Length)] := v105;
				v1 := |v0|;
				var v107: array<string> := new seq<char>[24](i4 => seq(abs(0x75), i5  => ('m')));
				v107[safeIndex(158, v107.Length)] := v0;
				var v108: array<int> := new int[29](i6 => i6 * 281);
				v108[safeIndex(352, v108.Length)] := if (v2) then v1 else v1;
				globalState.f1, v107[safeIndex(158, v107.Length)], v108[safeIndex(352, v108.Length)], globalState.f3 := v2, v0, v1, v2;
				var v109: T0 := new C2(i2, v1, i2, v108[safeIndex(352, v108.Length)]);
				var v110: seq<T0> := [v109];
				v108[safeIndex(352, v108.Length)] := -(if (v2) then v108[safeIndex(352, v108.Length)] else if (v2) then |v110| else v109.f8);
		}
		
		globalState.f1 := v3[safeIndex(v1, |v3|)];
		if (!(v1 > i2)) {
			var v111: map<int, int> := map[i2 := i2];
			var v112: set<bool> := {true};
			var v113: set<int> := {|v112|, i2, i2};
			var v114: map<multiset<bool>, int> := map[(multiset{v2})[v2 := abs(|v113|)] := |"rxrjsdrs"|];
			...
			v129[safeIndex(915, v129.Length)] := v1;
			v129[safeIndex(915, v129.Length)] := -i2;
			var v130: array<bool> := new bool[5];
			v130[safeIndex(457, v130.Length)] := false;
			v130[safeIndex(457, v130.Length)], globalState.f3 := v3[safeIndex(safeDivisionInt(|v79|, i2), |v3|)], v129[safeIndex(915, v129.Length)] >= (v129[safeIndex(915, v129.Length)] - v1);
			v130[safeIndex(457, v130.Length)] := v130[safeIndex(457, v130.Length)];
			var v131: map<int, bool> := map[v1 := v130[safeIndex(457, v130.Length)]];
			v36.m2(v131, v3 + v3, !v130[safeIndex(457, v130.Length)], globalState);
		}
		
	}
	v1 := -(v1 * (v1 + v1));
	v2 := v2;
	var v132: set<char> := {v0[safeIndex(v1, |v0|)]};
		...
		decreases 100 - i8
	{
		...
		v135[safeIndex(378, v135.Length)] := v140;
		v135[safeIndex(378, v135.Length)] := v140;
		...
		v143[safeIndex(692, v143.Length)] := v136.f7;
		v143[safeIndex(692, v143.Length)] := v1;
		var v144: map<bool, bool> := map[v2 := v2];
		v143[safeIndex(692, v143.Length)] := |v144| + (v1 * v142.fm7("qyb", |v79|, globalState));
	}
	var v145: array<D1> := new D1[3](i10 => DC2(false));
	var v146 := DC2(false);
	v145[safeIndex(11, v145.Length)] := v146;
	v145[safeIndex(11, v145.Length)] := DC2(v2);
	if (v2) {
		...
		var v151 := DC17(seq(abs(833), i11  => (v4)), v2, |v0|, v2, v2);
		v151 := v151;
		v36.m1(globalState);
	...
	print v4, "\n";
	print v5 == map[true := 2], "\n";
	print v6 == map[[true, true] := 414], "\n";
	print v34 == map[map['p' := true, 'q' := true, 'i' := true, 't' := true, 'b' := true, 'm' := true] := map[-958 := 'q']], "\n";
	print v35.cf28 == map[map['p' := true, 'q' := true, 'i' := true, 't' := true, 'b' := true, 'm' := true] := map[-958 := 'q']], "\n";
	print v36.f6 == map[map['p' := true, 'q' := true, 'i' := true, 't' := true, 'b' := true, 'm' := true] := map[-958 := 'q']], "\n";
	print v79 == [-958], "\n";
	print v80[0], "\n";
	print v80[1], "\n";
	print v80[2], "\n";
