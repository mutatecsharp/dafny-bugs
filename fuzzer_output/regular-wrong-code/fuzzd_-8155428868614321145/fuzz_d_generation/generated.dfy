...
function fm2(p0: int, p1: char, p2: int, p3: int, globalState: GlobalState): map<seq<bool>, map<bool, int>> {
	(map v0 : seq<bool> | v0 in (seq(183, i0  => ([false]))) :: (v0) := (map[!true := |map[|{|{'h'}|}| := |multiset{map[false := true], map[true := true], map[true := false]}|]|])) + map[[true, false] := map[false := 0x2f8]]
}
function fm3(p0: int, p1: int, globalState: GlobalState): seq<int> {
	[|(seq(0x199, i0  => ('k')))|, |(map[|['r', 'm']| := !false] + (map v0 : int | v0 in map[|"kfo"| := -676] :: (v0 - |(seq(141, i1  => ('d')))|) := (true)))|, -(765 + |map[!true := 0x81]|), |"ny"| / 382, -840]
}
...
function fm12(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): seq<string> {
	[if (false) then "txrnv" else "wvkpmu", "pwry" + (seq(-0x12e, i0  => ('a'))), "y" + (seq(0x253, i1  => ('w')))]
}
...
function fm29(p0: int, p1: bool, p2: seq<bool>, globalState: GlobalState): D3 {
	DC11(|(seq(0x394, i0  => (|"iqsfuxsch"|)))| - |{!!true}|, map[true := false] + map[false := false])
}
...
function fm34(p0: int, globalState: GlobalState): D2 {
	DC8(DC7(|(seq(0x392, i0  => ('k')))|, true, |[-|"gjqrabqx"|, |[multiset([|map[789 := !true]|]), multiset([-|[false, false]|, |[|{0x6f, |['l', 'q']|}|]|])]|, -0xe9, -0x106]|))
}
function fm35(p0: seq<int>, p1: seq<int>, p2: bool, globalState: GlobalState): set<int> {
	{451, |{-|multiset{false, !!false}|}| + |(seq(-0x276, i0  => ('j')))|}
}
function fm38(p0: bool, p1: int, globalState: GlobalState): string {
	(if (true) then seq(0x30c, i0  => ('h')) else "xrwuvm") + ("dbhrr" + "ctmp")
}
...
function fm42(globalState: GlobalState): D11 {
	match DC24(-0x2ff) {
		case DC23() => DC32(map v0 : int | (-0x210 <= v0) && (v0 < -312) :: (v0 % 0x42) := (!true))
...
function fm43(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<D5> {
	match DC13(map[[false] := true]) {
		...
		case DC13(cf20) => [DC18(DC18(DC16(multiset{false})))] + (seq(0x16, i0  => (DC18(DC18(DC18(DC16(multiset{false, !false})))))))
	}
}
function fm44(p0: int, globalState: GlobalState): map<string, int> {
	map[seq(0x1cb, i0  => ('m')) := 0x99] + (map v0 : string | v0 in ["ajwlwtmnx"] :: (v0) := (264))
}
...
function fm47(p0: int, p1: bool, globalState: GlobalState): multiset<seq<int>> {
	(multiset{[-|map[false := false]|], [884], [|{true, false}|], [DC3(|multiset{0x302}|).cf4]} - multiset{[|(seq(110, i0  => ('e')))|, 0x384]}) + (multiset{[|[!false]|]} + multiset{seq(0x8f, i1  => (0x217))})
}
...
function fm50(p0: bool, p1: int, globalState: GlobalState): map<int, char> {
	if (true) then map[|(seq(419, i0  => ('l')))| := 'a'] + (map v0 : int | v0 in [631] :: (v0 + -154) := ('n')) else map[0x33b := 'q']
}
...
function fm59(p0: bool, p1: string, p2: D10, p3: int, globalState: GlobalState): seq<seq<int>> {
	(DC79(DC79([seq(9, i0  => (|map[990 := true]|)), [|[true]|], [|(map v0 : int | (0x1d0 <= v0) && (v0 < 352) :: (v0 % |[false]|) := (|map[false := true]|))|]]).cf141).cf141 + (seq(500, i1  => ([0x3b8, |[DC53([map['m' := false]]), DC53([map v1 : char | v1 in map['m' := |{-|"doi"|}|] :: (v1) := (true), map['t' := false]])]|])))) + [[0x1e5, |multiset(seq(-0x182, i2  => (DC21(true, true, true, 0x190).cf39)))|], seq(0x137, i3  => (|map[0x39d := false]|)), [|{|{true}|, 250}|, |map[0x159 := false]|]]
}
function fm60(p0: D7, p1: char, p2: bool, p3: D15, globalState: GlobalState): map<int, map<char, bool>> {
	map[-|multiset{!!true, false}| / 141 := map v0 : char | v0 in ['y', 'n', 'w', 'f'] :: (v0) := (true)]
}
...
function fm62(p0: set<int>, globalState: GlobalState): map<multiset<bool>, bool> {
	map[multiset{false, true} - multiset{!false, !!false} := multiset{[-|map[0xe6 := 0x1e3]|]} >= multiset{[|map[0x81 := false]|, |(seq(0xec, i0  => (|multiset{true, !true}|)))|, |map[!false := false]|]}]
}
...
function fm65(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState): D3 {
	match DC77(-|map[!!true := {false}]|, {true}, |(seq(0x30e, i0  => ('w')))|, true, map[multiset{0x1c0, |{true}|, -|multiset{-0x2b2}|} := true]) {
		case DC77(cf135, cf136, cf137, cf138, cf139) => DC10(seq(-969, i1  => ('e')), cf138, !cf138)
...
method m0(p0: int, p1: array<bool>, globalState: GlobalState) returns (r0: string, r1: string) {
	...
	v0, v0, v1, v2[173] := fm0(|multiset((if (v0) then v3 else v3)[p0 := v0])|, globalState), true, map[p1 := v4 == v4], -|(match v8 {
		case DC33(cf54, cf55) => "dwc"
		case DC34(cf56, cf57, cf58) => seq(-397, i1  => (v6))
		...
		decreases 100 - i2
	{
		...
		v9[922] := p1;
		v9[922] := if (if (v0) then !v0 else v0) then p1 else p1;
		r1 := (v7 + v7) + v7;
		globalState.f7 := v2[173];
		if (v0) {
			var v10: map<bool, bool> := map[v0 := v0];
			var v11: T0 := new C12(v0, v0, v0);
			var v12: map<int, T0> := map[|v10| := v11];
			var v13: seq<T0> := [if (v2[173] in v12) then v12[v2[173]] else v11, v11];
			var v14: seq<seq<bool>> := [v3[p0 := v11.f10], v3, v3, v3, [v11.f10]];
			v13 := (v13 + v13)[|v14| := v11] + v13;
			var v15: set<int> := {p0};
			var v16: set<int> := {v2[173], p0, -|v15|, p0};
			v0 := {-0x9d} >= (v15 * v15);
			v2 := v2;
			v4 := fm3(0x8e, if (v11.f10) then p0 else 0x3cd, globalState);
			r0 := v7;
		} else {
			globalState.f0 := p0 / (p0 / -689);
			var v17: map<int, int> := map[v2[173] := p0];
			v17 := v17[-p0 := p0 % |{p0, |v7|}|];
			v0 := fm0(fm1(globalState), globalState);
			var v18: array<D1> := new D1[2];
			var v19 := DC27(v0, [v18, v18], v4, v2[173]);
			var v20 := DC63(v19.cf46, v0, v0, v0);
			v0 := !((-p0 * (if (v0 in v5) then v5[v0] else 938)) > -v20.cf106);
			globalState.f1 := 0x163 / p0;
		}
	...
	if (v0 <== (!v0 <== v0)) {
		...
		v22 := v22[[v7] := v0];
		var v23: multiset<int> := multiset{-v2[173]};
		...
		if (p0 > ((if (v0 in v5) then v5[v0] else |v26|) - v2[173])) {
			var v27: seq<array<int>> := [v2, v2, v2, v2, v2];
			var v28: T1 := new C2(v0, v2[173]);
			var v29: multiset<T1> := multiset{v28};
			var v30: map<array<int>, bool> := map[v27[-v2[173]] := v29 == v29];
			v30 := v30 + v30;
			...
			v32[118] := v7;
			v32[118] := v7[p0 := v6] + v7;
			var v33: multiset<int> := multiset{|v32[118]|, v2[173]};
			p1[988] := v33 !! v33;
			globalState.f7, p1[988], v2[173] := p0, v7 < (seq(0x146, i3  => (v6))), p0;
			var v34: array<array<int>> := new array<int>[27];
			v34[529] := v2;
			v34[529] := new int[26];
			var v35: multiset<seq<bool>> := multiset{[p1[988]] + v3};
			var v36: map<int, bool> := map[p0 := v0];
			v35 := fm19(p1[988], -|v36| > v2[173], p1[988], v2[173], globalState);
			var v37: map<bool, bool> := map[p1[988] := p1[988]];
			var v38: array<bool> := new bool[21] [p1[988], false, v0, fm0(v2[173], globalState), p1[988], p1[988], p1[988], if (p1[988] in v37) then v37[p1[988]] else p1[988], v0, v0, p1[988], v0, p1[988], p1[988], p1[988], p1[988], false, v0, v0, v0, !p1[988]];
	...
	for i4 := v2[173] to |v3| {
		...
		v2[173] := if (v45 <= (set v46 : char | v46 in v7[p0 := v6] :: (v46))) then v2[173] else i4;
		var v47: array<string> := new seq<char>[6] [v7, v7 + v7, seq(-0xd3, i5  => (v6)), v7 + v7, v7 + v7, v7];
		v47[927] := v7;
		v47[927] := "gwrlipv";
		if (v0) {
			v7 := v47[927] + (seq(0x291, i6  => (v6)));
			v2[173] := |{v0 ==> v0}|;
			v0 := v0;
			...
			globalState.f1 := v2[173];
			var v52 := new C10(i4, v0);
			v0 := v52.f16;
			p1[979] := v0;
			p1[979] := fm0(0xb9, globalState);
		}
		
		v2[173] := v2[173];
	}
	v2[173], globalState.f7, v0 := -0x122, v2[173], v0;
...
class C0 {
	...
	function fm36(globalState: GlobalState): int {
		(|map['e' := 0x2e8]| % --0x122) - |([[0x132]] + [[-286, |[0x130, -160]|]])|
	}
...
class C1 extends T1, T0 {
	...
	function fm9(p0: string, p1: set<map<bool, bool>>, globalState: GlobalState): int {
		(--0x11b - -0x25d) * |(if (f10) then seq(622, i0  => ('v')) else ['l'])|
	}
	function fm6(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState): bool {
		!((if (f10) then map[f10 := "mljbys"] else map[f10 := "gekebnpd"]) == map[f10 := "vup"])
	}
	function fm7(p0: bool, globalState: GlobalState): bool {
		!(multiset{--0x1c9} == (multiset{|[f10]|} + multiset{|map[|{f10}| := -|map[f10 := |"xgpysmdex"|]|]|, -|"mifruf"|, -|(seq(0x37, i0  => (0x7d)))|}))
	}
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		var v0 := 0x2eb;
		...
		var v1: array<int> := new int[23](i0 => i0 / 287);
		v1[330] := v0;
		var v2 := 'r';
		v1[330] := (|multiset{v2}| / v0) / (v0 * v0);
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		var v6: array<bool> := new bool[14] [v2 < v2, f10, v0 !in [v0, v0, v0, v0[|(seq(0x2a4, i0  => (p0)))| := f10], v0], multiset{v3} !! v4, p0 == p0, v1 !! v1, !!fm6(-p0, fm1(globalState), p0, f10, globalState), (if (v0[p0] in v5) then v5[v0[p0]] else f10) && f10, f10, !f10, f10, f10, !f10 <== f10, f10];
		...
		v13, v14[487] := if (|(v17 + v17)| in v16) then v16[|(v17 + v17)|] else f10, if (v13) then v6 else v6;
		var v18: set<int> := {p0};
		var v19 := "xmpiyma";
		var v20: map<char, bool> := map[v19[p0] := f10];
		var v21 := 't';
	...
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
			...
			decreases 100 - i0
		{
			...
			v0[668] := map v1 : map<bool, char> | v1 in v4 :: (v1) := (!!f10);
			...
			if (fm0(if (p1 in v9) then v9[p1] else v6, globalState)) {
				...
				v10[30] := fm8(v6, f10, p1, globalState);
				var v11 := "ojm";
				var v12: map<bool, bool> := map[f10 := f10];
				var v13: multiset<map<bool, int>> := multiset{v9};
				globalState.f1, r0, v10[30], globalState.f1 := fm9(v11, {v12}, globalState), f10, (v13 > v13) !in v9, v6 / v6;
				var v14: array<int> := new int[1](i1 => i1 % DC11(v6, v12).cf17);
				var v15: multiset<int> := multiset{v6};
				v14[378] := if (v6 in v15) then v15[v6] else v6;
				v14[378] := v6;
				var v16 := new C0();
				var v17: seq<int> := [v14[378]];
				v17 := v17;
				var v18: multiset<bool> := multiset{p1, f10, false, f10, v10[30]};
				var v19: seq<bool> := [v10[30]];
				r0 := multiset{p1} !! v18[v19[-|v17|] := -324];
			} else {
				var v20 := new C0();
				r0 := f10;
		...
		var v36: array<bool> := new bool[24] [f10, f10, v29[v27], v27 == 728, f10, f10, v27 != v27, f10, v31 >= v31, if (v27 in v34) then v34[v27] else f10, if (f10) then !!f10 else false, v35.cf32, if (-fm1(globalState) in v34) then v34[-fm1(globalState)] else p1, f10, f10, v27 < v27, p1, f10, p1, p1, f10, v27 > |map[v27 := true]|, f10, f10];
		v36[738] := if (true) then !!p1 else p1;
		var v37: array<int> := new int[28](i2 => i2 / v27);
		var v38 := DC4(v27, v37);
		var v39 := DC6(v26);
		...
		v36[738], v42, r1, r0 := [f10, p1] < v29, if (p1) then v42 else v42, "xk", p1 ==> (if (p1 in v43) then v43[p1] else f10);
		v36[738], v27, globalState.f7 := if (true) then true <==> fm7(v36[738], globalState) else v36[738], -v27, v27;
...
class C2 extends T1 {
	...
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		...
		if (f21) {
			...
			if ((v3 + fm28(f21, f21, globalState)) >= (if (false) then v3 else v3)) {
				var v4: array<int> := new int[22](i0 => i0 % 0xc9);
				v4 := v4;
				...
				var v16: map<bool, int> := map[(seq(0x71, i1  => (f22))) <= v12 := 0x29e / fm1(globalState)];
				v16 := v16[f21 := f22];
				r1 := f21;
			}
			...
			v22 := (v18 + v22) + (v22 + v22);
			globalState.f0, v17 := (if (f21 in v17) then v17[f21] else v19[964]) - -(f22 + 0x31), v17;
			...
			match (fm29(|v24|, f21, [f21, f21, fm8(f22, f21, fm8(f22, f21, f21, globalState), globalState), f21, true], globalState)) {
				case DC10(cf14, cf15, cf16) =>
					var v25: array<char> := new char[13] [v0, v0, v0, v0, v0, v0, v0, fm4(f21, cf15, cf15, globalState), v0, v2[f22], v0, v0, v0];
					var v26 := DC17(f21, v0);
					v25[670] := v26.cf29;
					var v27 := DC6('b');
					v25[670] := v27.cf8;
					...
					cf15 := v28[|(if (220 in v29) then v29[220] else v30)| := v30] == v28;
				...
				case DC11(cf17, cf18) =>
					...
					v34[753] := f21 ==> fm0(cf17, globalState);
					v34[753] := f21;
				...
				case DC9(cf13) =>
					...
					globalState.f1, r1, v44[741] := DC11(f22, v45).cf17, f21 <== (0x86 != -995), f21;
					v39[827] := f22 * f22;
					v39[827] := --859;
				case DC12(cf19) =>
			...
			r1, r1 := f22 >= (f22 / f22), f21;
			var v50: array<bool> := new bool[18](i4 => {"esg", seq(537, i5  => (v0)), v2} !! {v2, seq(0x2c6, i6  => (v0))});
			var v51: multiset<int> := multiset{f22, -0x1d3};
			v50[344] := !fm0(|v51|, globalState);
			var v52 := DC1("imswxpkga");
			var v53: array<D0> := new D0[28] [v52, DC1(v2), fm32(f21, f22, false, globalState), v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, DC1(seq(0x337, i7  => (v0))), DC1("uuajlyoaj"), v52, v52, v52, DC1(seq(0x6, i8  => (v0))), v52, v52, v52.(cf1 := v2), if (!f21) then v52 else v52, DC1(v2), DC1(seq(0x8b, i9  => (v0)))];
			v53[663] := v52;
			v50[344], globalState.f1, v53[663] := f21, 0xb4, v52;
			var v54: multiset<char> := multiset{v0, v0, v0};
			var v55: set<bool> := {v50[344]};
			v54 := v54 + v54[v0 := if (f22 in v51) then v51[f22] else |v55|];
			var v56: map<bool, bool> := map[v49[f22] := f21];
			var v57: seq<map<bool, bool>> := [v56[v50[344] := v50[344]] + fm33(v50[344], f21, seq(-0x2e8, i10  => (v0)), v50[344], globalState)];
			globalState.f0 := |v57|;
		}
		...
		match (fm34(f22, globalState)) {
			...
			case DC6(cf8) =>
				if (f21) {
					...
					v81 := if (if (f21 in v82) then v82[f21] else f21) then map[v80 := v2] else map[v80 := ((v2[|v83| := cf8])[f22 := v0])[f22 := cf8]];
					...
					v86[455] := |(v2 + (seq(0x309, i14  => (cf8))))|;
					v86[455] := f22 % f22;
					var v87: map<bool, bool> := map[f21 := f21];
					v87 := v87 + (v87 + map[f21 := false]);
					var v89: seq<string> := [seq(-580, i15  => (v0)), v2];
					...
					var v93 := DC6(v0);
					v92[7] := v93;
					v92[7] := fm39(|(seq(0x47, i17  => ('i')))|, seq(625, i18  => (v0)), false, globalState);
					r1 := fm0(if (f21) then f22 else f22, globalState);
				}
				
				var v94: multiset<bool> := multiset{f21};
				var v95 := DC16(v94[f21 := f22]);
				r1 := (v95.cf27 !! v94) ==> (f21 <== true);
				r1 := fm0(f22 / f22, globalState);
			...
			case DC8(cf12) =>
				...
				v100, v102[113], v103, v2, v107 := v100, v101, v103, if (fm8(f22, f21, f21, globalState)) then v2 else "hgl", v107;
				r1 := !false;
				var v108 := DC26();
				match (v108) {
					case DC26() =>
						...
						v2, v105, globalState.f0, globalState.f0 := v2, v105 + ([f21, f21, f21, v105[|v110|]] + fm40(f21, false, globalState)), f22, f22 % (f22 / f22);
						r1 := !f21;
						...
						v114 := new multiset<bool>[23] [v115, multiset(fm40(f21, f21, globalState)), multiset{f21, false}, v116[f22], v115 - v115, multiset(v105 + [f21, f21]), (multiset(v105))[f21 := f22], if (f21) then multiset{true} else v115, v115, v115 - v115, fm41(globalState), v115, v115[v117.cf10 := f22], (if (f21 in v118) then v118[f21] else v115) * multiset(v105), v115, v115 * v115, multiset(v105 + v105), v115, multiset{f21}, v115, v115, v115, v115];
					case DC27(cf43, cf44, cf45, cf46) =>
						v99[493] := cf43;
						v99[493], globalState.f0 := cf43, |"nungwwqg"|;
						cf43 := cf43 && false;
						v102[113][972] := |v2| % cf46;
						v102[113][972] := -332 % cf46;
						globalState.f7 := -f22;
					case DC25(cf42) =>
						...
						v121 := v124[|v2|] + v127.cf45;
						var v128 := new C1(f21);
						v99[695] := f21;
						r1, globalState.f0, v99[695] := f21, f22 - -525, f21;
					case DC28(cf47) =>
						v101[888] := f22;
						v101[888] := f22;
						var v129: map<int, bool> := map[v101[888] := fm8(v101[888], f21, f21, globalState)];
						var v130: map<map<int, bool>, int> := map[v129 + v129 := f22];
						v101[888] := if ((fm42(globalState).(cf53 := v129)).cf53 in v130) then v130[(fm42(globalState).(cf53 := v129)).cf53] else v101[888] + f22;
						var v131: seq<int> := [f22];
						var v132: multiset<bool> := multiset{f21};
						var v133: multiset<int> := multiset{|v132|, f22, f22, v101[888]};
						...
						var v137: map<int, char> := map[v101[888] := v0];
						var v138: map<char, map<int, char>> := map[v0 := v137];
						var v139 := DC17(f21, v0);
						v136[493] := v138 + map[fm4(f21, f21, v139.cf28, globalState) := v137];
						v136[493] := map[v0 := v137];
				}
		...
		var v152: map<int, map<multiset<bool>, string>> := map[f22 := v143 + (map v151 : multiset<bool> | v151 in (seq(0x2b4, i21  => (v142))) :: (v151) := (v2))];
		v140[691], r1, v0, v143 := fm8(if (fm0(f22, globalState)) then if (v144 in v145) then v145[v144] else -(if (v146 in v147) then v147[v146] else -0x4e) else f22, if (if (v148 in v149) then v149[v148] else f21) then f21 else f21, if (f21) then f21 else f21, globalState), DC34(f22, f21, |v150|).cf58 > f22, v0, if (f22 in v152) then v152[f22] else v143;
		var v153 := DC0(v140);
		var v154: map<D0, bool> := map[v153 := v140[691]];
		r1 := fm0(|v154|, globalState);
		var v155 := DC24(f22);
		match (v155) {
			case DC23() =>
				var v157: array<D1> := new D1[16](i22 => DC3(|(map v156 : int | (0x80 <= v156) && (v156 < 0x21f) :: (v156 + f22) := (f22))|));
				var v158 := DC28(DC27(v140[691], [v157], (seq(61, i23  => (f22)))[f22 := -2], 0x317));
				var v159 := DC28(v158);
				v159, r2 := v159, f22;
				v144 := v144[-f22 := v140[691]];
				...
				if (|v160| < f22) {
					...
					var v165 := m15(v164, v140[691], f21, v0, globalState);
					globalState.f7 := f22;
					v150 := v150;
					v165 := v165;
					...
					var v170: map<seq<D5>, bool> := map[v169 := v140[691]];
					var v171: map<int, seq<D5>> := map[-f22 := v169];
					v170 := v170[if (f22 in v171) then v171[f22] else fm43(f22, v140[691], v140[691], globalState) := v150[f22]];
				} else {
			...
			case DC24(cf41) =>
				...
				var v180: array<int> := new int[9] [f22, f22, cf41, f22, f22, cf41, |{fm0(|[v140[691]]|, globalState), v140[691], f21, v140[691], f21}|, -cf41, |v179|];
				v178[875] := v180;
				v178[875] := v180;
				var v181 := DC10(v2, !f21, v140[691]);
				var v182: set<seq<char>> := {[v0], v181.cf14};
				r0 := (v182 * {v2, v2[f22 := v0]}) + v182;
				cf41 := |fm3(|(v2 + v2)|, cf41, globalState)|;
				v140[691] := f21;
			case DC22(cf40) =>
				v140[691] := (v140[691] ==> f21) <== (f22 <= |[v140]|);
				var v183: set<int> := {f22, f22, f22};
				r1, globalState.f0, v140[691] := v150[|v183|], 169, f21;
				var v184, v185 := m0(f22, v140, globalState);
				var v186 := new C1(!f21);
		}
		
		var v187: set<string> := {v2, seq(0xce, i24  => ('n'))};
		r0 := {v2, v2, v2} - v187;
		r1 := v140[691];
		r2 := -(f22 * (-0x4b - f22));
	}
	method m5(p0: int, globalState: GlobalState) {
		...
		v3[341] := if (0x36a in v5) then v5[0x36a] else p0;
		v3[684] := p0;
		...
		var v12 := DC35(seq(529, i1  => (v6)));
		var v13: seq<seq<D10>> := [v12.cf59 + v7, v7 + (seq(0x2ad, i2  => (v6)))[f22 := v6]];
		var v14: multiset<int> := multiset{f22};
		v2, v3[341], v3[684], v7 := v2, f22, fm9((v8[0x1d1 := 'm'] + v8)[|fm38(false, |(seq(-606, i0  => ('p')))|, globalState)| := v9], v11 - {v10}, globalState), v13[fm1(globalState) % (if (f22 in v14) then v14[f22] else p0)];
		...
		globalState.f1 := if (|v17| in v5) then v5[|v17|] else v3[341];
	}
	method m15(p0: map<seq<int>, array<bool>>, p1: bool, p2: bool, p3: char, globalState: GlobalState) returns (r0: array<int>) {
		...
		for i0 := |v0| to f22 {
			...
			v3[603] := p1;
			v3[603], globalState.f7 := v0[i0 + i0], f22;
		...
		var v14: set<string> := {v12, v13[f22]};
		...
		v16[364] := f22 + fm9(v12, v18, globalState);
		var v19 := false;
		...
		v10, v16[364], v19, v19 := v10, fm1(globalState) * f22, !(v21[f22] <= v20), v22 >= v22;
		var v23: multiset<array<bool>> := multiset{v10};
		var v24 := DC38(v23);
		var v25: map<bool, multiset<array<bool>>> := map[v19 := v23];
		var v26: array<multiset<array<bool>>> := new multiset<array<bool>>[22] [v24.cf64 + (if (v19 in v25) then v25[v19] else v23), v23, v23, multiset{v10}, v23, v23, v23, v23, v23, v23, v24.cf64 * (multiset{v10})[v10 := -f22], v23, v23, multiset{v10, v10, v10}, v23, v23, v23, v23, v23[v10 := v16[364]], v23 - multiset{v10}, v23, v23];
		v26[245] := multiset{v10};
		v26[245] := v23;
		var v27: seq<int> := [v16[364], -0x3a0];
		var v28: seq<int> := [|v17|, |v27|];
		v19 := 0x41 > v28[v16[364]];
		for i2 := 0x19 % v16[364] to v16[364] {
			var v29: map<int, set<string>> := map[i2 := v14];
			v0, v19 := fm40(f21, (if (v16[364] in v29) then v29[v16[364]] else {v12, v12}) >= v14, globalState), !(p3 in (if (!p1) then v12 else "co"));
			var v30 := DC21(f21, v19, f21, if (0x106 in v15) then v15[0x106] else i2);
			v19 := f22 > (v30.cf39 + |(seq(417, i3  => (f22)))|);
			var v31 := DC10(v12[v16[364] := p3], p2, true);
			var v32 := DC39(if (!true in v11) then v11[!true] else f22, v19);
			var v33: array<string> := new string[28] [v12, v12, v12 + v12, v12 + v12, v12, v12, v13[v16[364]], v12, v12, fm38(f21, |v12|, globalState) + "gotocugl", v12, v12, v12 + v12, v12, v12, v12, v31.cf14, v12, (seq(77, i4  => (p3))) + (seq(0x6a, i5  => (p3))), v12, if (true) then v12 else v12, v12, v12, v12, v12 + v13[302], v12, (v12 + v12)[v16[364] := fm4(p1, f21, f21, globalState)], v12[v32.cf65 := p3]];
			v33[442] := "mu";
			v33[442] := if (p1) then v12 + "ussllkr" else v12;
			var v34: set<int> := {f22};
			var v35: map<int, int> := map[|v34| := f22];
			var v36 := DC34(v16[364], p1, if (v16[364] in v35) then v35[v16[364]] else |v34|);
			v36 := v36;
		}
		r0 := v16;
	}
...
class C3 extends T0, T1 {
	...
	function fm9(p0: string, p1: set<map<bool, bool>>, globalState: GlobalState): int {
		|(("pmomwxle" + "nd") + ("lltikvrj" + (seq(0x103, i0  => ('v')))))|
	}
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
		...
		match (v2) {
			case DC17(cf28, cf29) =>
				...
				r0 := p1;
				var v5: seq<bool> := [f10];
				v4[591] := -(if (v5[v3]) then v3 else v3);
				v4[591] := v3;
			case DC16(cf27) =>
				...
				v6[331] := v7;
				var v8 := 967;
				globalState.f1, v6[331] := 0x37c, v7[v8 := v1];
				var v9: seq<bool> := [f10, f10, false];
				var v10: array<seq<bool>> := new seq<bool>[19] [v9, v9, [f20, f20, f20, p1, true], v9[v8 := f10], v9, [p1], v9, v9, v9 + v9, v9, v9, v9, v9, v9 + [f10], v9, v9, v9, v9, v9 + v9];
				v10 := v10;
				var v11: array<bool> := new bool[24](i0 => !f10);
				v11[528] := f20;
				var v12: map<int, bool> := map[0x17 := !f20];
				v11[528] := fm6(v8, fm1(globalState), v8, if (|(seq(0x1e0, i1  => (v1)))| in v12) then v12[|(seq(0x1e0, i1  => (v1)))|] else f10, globalState);
				var v13: multiset<int> := multiset{v8};
				var v14 := DC15(v8, v13, v1, v8);
				var v15: array<int> := new int[21](i2 => i2 / -v8);
				v15[723] := v8;
				var v16: set<int> := {508};
				v8, v14, v15[723], globalState.f1 := |v16|, DC15(|v16|, multiset{v8}, v1, v8).(cf23 := v8, cf24 := v13 + v13), |v6[331]|, v8;
			case DC18(cf30) =>
				var v17: array<int> := new int[28];
				var v18 := 0x24e;
				v17[464] := v18 / v18;
				v17[464], r0, r0, v1, globalState.f0 := -(v18 % (v18 - v18)), f20 ==> f10, f20 <== false, v1, --v18 + v18;
				v1 := v1;
				r0 := false;
				var v19: map<bool, int> := map[p1 := v18];
				var v20: multiset<int> := multiset{if (f20 in v19) then v19[f20] else v18, v18};
				r0 := if (|v20| > -v17[464]) then f20 else false;
		}
		...
		v25[810] := v27;
		r0 := p1 <== p1;
		forall i3 | 0 <= i3 < v25[810].Length {
			v25[810][i3] := f20;
		}
		var v28: array<int> := new int[5](i4 => i4 / v21);
	...
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		...
		var v4: seq<bool> := [f10];
		var v5: map<bool, multiset<bool>> := map[!v4[605] := v3];
		if (|(v0 + v0)[v1 := v2]| >= |(v3 + (if (f20 in v5) then v5[f20] else v3))|) {
			...
			if (!f10) {
				...
				v20[215] := if (v1 in v23) then v23[v1] else v22;
				v20[215] := v22;
				...
				var v29: set<D5> := {v28};
				v1, v26[751], v2, globalState.f0, v2 := 0x220, v27, v2, v1, fm4(v29 !! v29, f20, f10, globalState);
				var v30: array<int> := new int[6];
				v30[860] := v1;
				var v31: seq<int> := [v1];
				var v32: map<string, int> := map[v0 := |v31|];
				v30[860] := |(v32 + (fm44(v1, globalState) + v32))|;
				r1 := fm6(v30[860], v30[860], if ((seq(0x2eb, i3  => (v2))) in v27) then v27[seq(0x2eb, i3  => (v2))] else v1, f10, globalState);
			}
			...
			var v38: multiset<int> := multiset{0x360, -v35[|(seq(359, i4  => (v2)))|], v1, |v37|, v1};
		...
		var v43 := DC35(seq(0x18d, i5  => (DC31(f20, f10, -733))));
		var v44: map<D12, string> := map[v43 := v0];
		v1 := |v42[|v44[v43 := v0]| := v41]|;
		r1 := true;
		...
		match (v47) {
			case DC0(cf0) =>
				...
				v57[118] := v1;
				if (f10 in v4) {
					var v58: map<string, bool> := map[seq(911, i8  => (v2)) := f10];
					cf0[519] := !(if (v0[v1 := v2] in v58) then v58[v0[v1 := v2]] else f20);
					cf0[519] := f10 <== f20;
					var v59: array<C1> := new C1[1];
					var v60: C1 := new C1(f10);
					v59[315] := v60;
					v59[315] := new C1(v52 > v52);
					globalState.f7 := v57[118];
					v60.m5(|v49|, globalState);
					r1 := fm0(v1, globalState);
				} else {
					var v61 := new C0();
					r1 := (v57[118] + v57[118]) < v57[118];
					var v62: map<int, int> := map[v57[118] := 0x8f];
					var v63: map<bool, int> := map[!(908 == (if (v57[118] in v62) then v62[v57[118]] else v1)) := v1];
					var v64 := DC10(v0, f20, f20);
					v57[118], r1, v0 := if (f20 in v63) then v63[f20] else DC7(v57[118], f10, v57[118]).cf11, !f10, v64.cf14 + v0;
					r1 := f10;
					r1 := f10;
				}
			...
			case DC1(cf1) =>
				...
				v66.m5(v66.f22 / v66.f22, globalState);
			case DC2(cf2, cf3) =>
				var v68: seq<int> := [0x144, v1];
				var v69: seq<seq<int>> := [v68, v68, v68, v68 + v68, seq(0x374, i9  => (v1))];
				...
				v71[828] := v72;
				v0, v71[828] := "kwtb" + fm38(f10, v1, globalState), v72;
				var v73: map<string, bool> := map[v0 + v0 := false];
				v73 := v73[v0 := v1 <= v1];
				r1 := f10 <== cf2;
		}
		
		var v74: set<string> := {v0 + v0, v0[|multiset{v1}| := v2] + v0, v0};
		r0 := v74;
		r1 := f10;
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		var v12 := DC41(v11);
		v0, v5[51], v0, globalState.f7 := if (|(v10 + v10)| in v9) then v9[|(v10 + v10)|] else fm8(-0x22c, f10, true, globalState), v1, |{v9}| == (p0 + p0), |v12.cf71|;
		v0 := |(map v13 : int | (65 <= v13) && (v13 < 828) :: (v13 * p0) := (v0))| <= p0;
		var v14 := "gip";
		var v15: multiset<bool> := multiset{v6[p0], false};
		var v16: array<int> := new int[10] [|v14| / p0, p0 * |v15|, |(v15 * multiset{v0})|, p0, p0, 0xe7 - p0, p0, fm1(globalState), p0, p0];
		var v17 := 'v';
		v16, globalState.f0, globalState.f1, globalState.f0 := v16, -(p0 * (fm1(globalState) % p0)), DC15(p0, multiset(v7), v17, p0).cf26 - |v6|, |v6|;
		var i0 := 0;
		while (!!f10)
			decreases 100 - i0
		{
			...
			v4 := (v4 + v4) + map[v0 := v1];
			v0 := true;
			var v18: array<multiset<bool>> := new multiset<bool>[18](i1 => v15[if (|v14| in v9) then v9[|v14|] else v0 := |v14|]);
			v18[244] := multiset{v0} - v15;
			v18[244] := v15;
		}
		var v19: multiset<seq<int>> := multiset{[p0], v7 + (seq(754, i2  => (p0))), v7};
...
class C4 extends T1 {
	...
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		...
		globalState.f7 := (0x71 + v2) % fm9(v5[0x62 := 'm'], v8, globalState);
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		var i0 := 0;
		while (match fm49(if (p0 in v2) then v2[p0] else v3[p0], p0, globalState) {
			case DC10(cf14, cf15, cf16) => cf15
			case DC11(cf17, cf18) => v0 && v0
			case DC9(cf13) => v0
			case DC12(cf19) => v1[680]
		})
			decreases 100 - i0
		{
			if (i0 >= 100) {
			...
			v1[680], globalState.f1 := |(map[true := false])[v1[680] := v1[680]]| <= |v4|, |v4[962 := v1[680]]|;
			var v5: array<array<string>> := new array<string>[18];
			var v6: array<string> := new string[7](i1 => "wmyxcurb");
			v5[256] := v6;
			v1[680], globalState.f7, v5[256], v4 := v0, p0, v6, v4;
			var v7: array<map<bool, int>> := new map<bool, int>[7];
			var v8: map<bool, int> := map[false := |map[true := v1[680]]|];
			v7[219] := v8;
			v7[219] := v8;
		...
		for i2 := |(seq(766, i3  => ('v')))| to p0 {
			var v11: seq<bool> := [v1[680]];
			v1[680] := !v11[i2];
			var v12 := 'b';
			var v13: map<seq<bool>, int> := map[v11 := p0];
			v1[680], v1[680], v12, globalState.f0 := v1[680], v0, if (p0 >= p0) then v12 else v12, if (v1[680]) then if (true) then |v13| else p0 else i2;
			var v14: array<int> := new int[24](i4 => i4 + p0);
			v14 := v14;
			var v15 := "evnnhnsnk";
			var v16 := DC4(-p0, v14);
			var v17 := DC42(v16, v11, false);
			var v18: map<D14, bool> := map[v17 := v1[680]];
			v0, globalState.f7 := (p0 / |v11[p0 := v1[680]]|) == (|v15| * p0), p0 - (|v18| % i2);
		}
		var v19 := DC33(v1[680], p0);
		var i5 := 0;
		while (v19.cf54 || v1[680])
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			var v21: map<map<int, bool>, D13> := map[map[p0 := v1[680]] := v20];
			v21 := v21;
			var v22 := DC23();
			v22 := v22;
			...
			var v28: multiset<bool> := multiset{v1[680]};
			var v29: map<char, bool> := map[v26 := v0];
			var v30: set<map<bool, bool>> := {map[!(if (v26 in v29) then v29[v26] else true) := v0], v27};
			var v31: seq<seq<int>> := [fm3(|(seq(0x348, i6  => (v3)))|, -0x115, globalState)];
			var v32: array<int> := new int[27] [if (698 in v23) then v23[698] else 0x1e5, -|(v24 + v24)|, p0, fm9((v25[p0 := v26])[p0 := v26], {v27, v27}, globalState), |v28|, 0x322, p0, p0, p0, fm9(v25, v30, globalState), p0, |v24|, fm9(v25, {map[v1[680] := v0]}, globalState) - p0, p0, p0, 204, if (!v0) then p0 else p0, 0x363, --p0, p0, p0, p0 % p0, 0xe + p0, p0, p0 / fm9(v25, v30, globalState), p0 - |v31[p0]|, -p0];
			v32[380] := |(v24 + v24)|;
			var v33 := DC15(p0, v2, v26, |v27|);
			v1[680], v32[380], v33, globalState.f7 := v1[680], p0, v33, p0;
			var v34: array<multiset<char>> := new multiset<char>[12](i7 => multiset(v25));
			var v35: map<array<multiset<char>>, bool> := map[v34 := v1[680]];
			v35 := v35[v34 := v0];
		}
		for i8 := p0 to if (fm0(0xd8, globalState)) then p0 else p0 {
			var v36: set<int> := {p0, fm1(globalState)};
			globalState.f1 := (|v36| % |v3|) + 0x2bd;
			var v37: seq<bool> := [v0, fm0(-p0, globalState), if (v1[680]) then v1[680] else v1[680], |multiset(v3)| < i8];
			v1[680] := v37[|multiset(v37)|];
			var v38 := "tleyvejo";
			var v39 := 'u';
			var v40: T1 := new C1(v0);
			var v41: set<T1> := {v40};
			globalState.f7 := |(v38[i8 := v39])[fm1(globalState) := v39]| + |v41|;
	...
	method m14(globalState: GlobalState) returns (r0: int, r1: set<bool>) {
		...
		if (v0 !in v6) {
			...
			var v8, v9 := m0(v0 % -|v2|, v7, globalState);
			var v10 := new C3(v1[554] <==> v1[554], fm0(0x16e, globalState));
			var v11 := DC22(v6);
			match (v11) {
				case DC23() =>
				...
				case DC24(cf41) =>
					var v14: C1 := new C1(v1[554]);
					v14, v1[554] := v14, v10.f20;
					var v15: map<int, bool> := map[0x3c2 := v10.f20];
					var v16: map<bool, bool> := map[v10.f20 := v1[554]];
				...
				case DC22(cf40) =>
					...
					var v19: map<bool, bool> := map[v1[554] := !v4];
					v18[928] := v19;
					v18[928] := map[v1[554] := v10.f20];
					var v20: map<bool, int> := map[!v4 := v0 % |v9|];
					v20 := v20[v10.f20 := v0];
					var v21 := 'l';
					v21 := v21;
			}
			...
			v4, globalState.f1 := v24[523], |(v25[true := v0] + v25)|;
			v1[88] := fm0(|v3|, globalState);
			v1[88] := v22.fm37(v2, -v0, v4, v4, globalState);
		...
		if (v29.f20) {
			...
			v1, globalState.f7, globalState.f1, v4, v30 := v1, |(v2 + v3)| / v0, |(seq(486, i1  => ('l')))| / v0, v29.f20, (if (v0 in v33) then v33[v0] else v30)[v29.f20 := "pkc" != v2];
			...
			v34[11] := -|(if (|"fqjtt"| in v37) then v37[|"fqjtt"|] else v36)|;
			v4 := !false;
			var v38 := DC30(v5);
			...
			v39[712] := v42;
			v1[538], globalState.f1, v1[59], v39[712] := !(v34[11] > (v0 + 0x111)), v0, (v2[|map[v29.f20 := v4]| := 'v'] + v3) < ("nhmbab" + v2), v42;
		} else {
			...
			v47 := v0 > |multiset((v52 + (if (v0 in v53) then v53[v0] else v52))[v0 := v52[-0x102]])|;
			...
			var v57 := DC40(v56, !v4, |(seq(0x274, i4  => (-0xe3)))|, v0);
...
class C5 {
	...
	method m13(p0: T1, globalState: GlobalState) returns (r0: array<char>, r1: bool) {
		...
		v21, v27, v24[587], v0, v0 := v21 + "ys", v27, v23, v22 < v22[-v23 := if (v0 in v28) then v28[v0] else v0], fm0(v23, globalState);
		...
		for i1 := v23 to v23 {
			...
			var v40: set<bool> := {v35[663], v35[663]};
			v35[663], globalState.f3 := (if (v35[663]) then p0.fm8(|v38|, !v0, v0, globalState) else v35[663]) <== !(v0 !in v39), v40 + {v35[663], v0};
		}
		var v41 := 'x';
		...
		var v45: array<C1> := new C1[18] [v43, v44[v23], v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43];
		var v46: map<int, array<C1>> := map[v24[587] / 0x374 := v45];
	...
	method m11(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<string>) {
		...
		match (v12) {
			case DC20(cf32, cf33, cf34, cf35) =>
				...
				v13[663], globalState.f1, globalState.f7, cf34 := v15, v0, v1[v0], v17.cf2;
				...
				v21 := v21[cf35 := if (cf32) then v20 else v22[-v0]];
			...
			case DC21(cf36, cf37, cf38, cf39) =>
				...
				cf36 := if (fm23(p0, v0, cf38, |fm24(globalState)|, globalState)) then --cf39 <= v0 else v26[cf39];
				var v27 := 'd';
				var v28: array<char> := new char[3] [fm4(cf37, true, cf36, globalState), v27, v27];
				v28[230] := v27;
				cf37, v28[230] := cf38, v4[-0x19c];
				var v29: array<map<bool, bool>> := new map<bool, bool>[8];
				var v30: map<bool, bool> := map[cf38 := cf38];
				v29[642] := v30;
				v29[642], cf37, r0 := v30 + v30[false := p0], false ==> cf36, "echwct" <= "fckgecd";
				var v31: array<bool> := new bool[4] [cf38, cf37, p0, p0];
				var v32: seq<array<bool>> := [v31, v31];
				var v33: array<array<bool>> := new array<bool>[27] [v31, v31, if (cf37) then v31 else v31, v31, v31, v31, v31, v31, v31, v31, v31, v32[cf39], v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31];
				var v34: seq<array<array<bool>>> := [v33];
				var v35: multiset<bool> := multiset{!p0};
				v33, cf37, globalState.f1 := v34[-(v0 % cf39)], p0, |((v4 + (if (cf37) then v4 else v4))[|(v35 * multiset{cf37})| := 'm'])[v0 := v28[230]]|;
			case DC19(cf31) =>
				var v36 := DC1(seq(-0x215, i3  => ('s')));
				...
				if ((map[p0 := v36.(cf1 := v4)] + map[p0 := v36]) != (if (p0) then (if (p0 in v38) then v38[p0] else v37)[p0 := v36] else v37)) {
					var v39: map<string, int> := map[(seq(0x52, i4  => ('b'))) + v4 := v0];
					...
					v40[902] := if ((v0 * v0) in v42) then v42[v0 * v0] else v43[-802];
					...
					r0, globalState.f0, v51, r0, r0 := p0, -v0 % v0, seq(0x18b, i5  => (v4)), (v4 != v4) <==> !p0, {v0, 648, 0x1fe} !! (v52 - fm26(globalState));
					var v53 := DC14(v0, v0);
					m12(v0 % v53.cf21, globalState);
					var v54: map<bool, seq<bool>> := map[true := [p0, p0]];
					v50 := (if (p0 in v54) then v54[p0] else v49[715]) + [false];
					r0 := p0 <== p0;
				}
				...
				match (v55) {
					case DC20(cf32, cf33, cf34, cf35) =>
						...
						var v60 := DC15(v1[cf35], v3, v56, cf35);
						v59[79] := v60;
						v59[79] := v60;
						v4 := v4;
					case DC21(cf36, cf37, cf38, cf39) =>
						...
						var v62 := DC39(v0, p0);
						var v63: array<seq<int>> := new seq<int>[14] [v2, if (p0) then [cf39, cf39, -v0] else v2, v61[|v4|], v1, v1, (seq(-211, i6  => (cf39)))[v0 := cf39] + v2, v2, v1, v2[0x2f0 := v0] + (seq(-0x2af, i7  => (0x306))), [fm1(globalState)], [---0x32b] + v2, v2, seq(763, i8  => (-|v4|)), [v62.cf65]];
						v63 := v63;
					...
					case DC19(cf31) =>
						r0 := p0;
						var v66: array<int> := new int[21](i9 => i9 % 0x16);
			...
			decreases 100 - i11
		{
			...
			v75 := if (if (v69[201] in v76) then v76[v69[201]] else v69[201]) then v75 else v75;
			r0 := v4 != v4;
			var v77 := new C1(v69[201] <==> v69[201]);
			var v78: seq<bool> := [false];
			var v79: multiset<bool> := multiset{v78[v0], |v4| in v73};
			v79, v0, v69[201], r0 := fm41(globalState), |(v73 + v73)|, v69[201], v72 > v72;
		}
		v69[201], v69[201] := fm0(v0, globalState), p0;
		r0 := !fm22(v0 / 739, p0, globalState);
		r1 := v0;
	...
	method m12(p0: int, globalState: GlobalState) {
		...
		match (v7) {
			...
			case DC3(cf4) =>
				...
				var v24: map<bool, bool> := map[v0[395] := v1];
				...
				v26 := new int[13] [cf4 - cf4, 320, p0, cf4 / cf4, |v27| % p0, p0, cf4, 937, -|v6|, p0 % |v28|, cf4, cf4, |v29|];
			...
			case DC5(cf7) =>
				if (v0[395]) {
					globalState.f1 := -(-|(seq(0x38a, i0  => ('e')))| * (p0 % p0));
					globalState.f7 := 0x2e4;
					v1 := v0[395];
					var v32: array<int> := new int[16];
					var v33: seq<bool> := [v1, v0[395]];
					v32[301] := |v33|;
					...
					v1, v32[301], v6, v0[395] := v2.fm37(v6 + v5, if (p0 in v36) then v36[p0] else p0, v0[395], v1 in v37, globalState), p0, v5, v0[395];
					var v38 := 'q';
					v38 := v38;
				} else {
					var v40: set<map<int, int>> := {map v39 : int | (-0x59 <= v39) && (v39 < 883) :: (v39 - p0) := (p0), map[p0 := p0]};
					var v41: map<int, int> := map[p0 := p0];
					var v43: seq<seq<int>> := [seq(134, i1  => (p0))];
					var v44: seq<int> := [|v43|];
					v40 := {v41 + (map v42 : int | v42 in v44 :: (v42 + p0) := (325))[p0 := p0], v41};
					var v45: array<int> := new int[9](i2 => i2 / p0);
					var v46: array<array<int>> := new array<int>[15] [v45, v45, v45, v45, v45, v45, v45, v45, if (!v0[395]) then v45 else v45, v45, v45, v45, v45, v45, v45];
					v46[781] := v45;
					var v47: multiset<int> := multiset{p0};
					var v48: set<int> := {-p0, p0};
					globalState.f7, v0[395], globalState.f0, v46[781] := |((v47 - multiset{p0}) + v47)|, p0 < -|v48|, p0, v45;
					v0[395] := v0[395];
					v1 := v1;
					v45[730] := p0 % p0;
					v45[730] := p0;
				...
				var v52: map<bool, int> := map[v0[395] := |v51|];
		...
		var v61: seq<int> := [v60[81]];
		var v62: map<seq<int>, string> := map[[p0] := v6];
		var i3 := 0;
		while (v61 !in (v62[[p0, p0] := seq(477, i4  => ('v'))] + v62))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			i3 := i3 + 1;
			var v63 := 'y';
			var v64: map<int, bool> := map[p0 := v0[395]];
			var v65: map<int, int> := map[|multiset{p0}| := |v64|];
			var v66: array<char> := new char[21];
			var v67 := DC37(p0, v66, 'j');
			var v68: map<string, int> := map[(v6 + v5)[p0 := v63] := -(if (|(seq(0x10f, i5  => (v63)))| in v65) then v65[|(seq(0x10f, i5  => (v63)))|] else v67.cf61) * p0];
			...
			var v72: set<bool> := {v1, v1, v0[395]};
			var v73: map<bool, set<bool>> := map[v0[395] := v72];
			v71 := v71[(if (v0[395] in v73) then v73[v0[395]] else v72) >= v72 := v63];
			var v74 := DC31(v0[395], false, 0x3a2);
			var v75: map<D10, bool> := map[v74 := v0[395]];
...
class C7 extends T0 {
	...
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
		...
		if (p1) {
			...
			var v14 := "tmux";
			v12 := fm4(v13[|v14|], f10, fm7(false, globalState), globalState);
		} else {
			globalState.f1 := v0;
			var v15 := "lsp";
			var v16: map<bool, string> := map[v0 < v0 := v15];
			var v17 := 'n';
			var v18: array<string> := new string[2] [v15[v0 := v17], v15];
			v18[775] := seq(627, i0  => (v17));
			...
			v16, v18[775], v19, v22, r0 := v16 + (if (-0x362 in v23) then v23[-0x362] else map[f19 := v15]), v15, v19, v22, p1;
		...
		v53[678] := f10;
		r0, globalState.f0, v53[678], r0, globalState.f1 := f10, v0 + -0xba, f10 <==> false, !f19, v0;
		...
		var v59: map<int, int> := map[|v57[if (-847 in v58) then v58[-847] else v0]| := |v50|];
		var v60: map<int, bool> := map[|v46| := true];
		var v61: array<int> := new int[22] [0xbe, |(v54 * v54)|, v0, v0, |v56|, v0, -v0, v0, (if (v0 in v59) then v59[v0] else -0x2b5) * 684, |{v53[678]}| - |v55|, |v60|, v0, |v55|, v0, fm1(globalState), -0x156 - |v55|, v0, v0, v0, v0, v0, v0];
		v61[976] := fm1(globalState);
		v61[976] := fm1(globalState);
		r0 := f10;
		r1 := v55;
...
class C8 {
	...
	method m10(p0: int, p1: array<bool>, globalState: GlobalState) returns (r0: bool) {
		...
		v4[703] := -p0;
		v4[703] := DC3(fm1(globalState)).cf4;
		var v5 := new C6();
		globalState.f7 := (v4[703] * v4[703]) / v4[703];
		var i0 := 0;
		while (v1)
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			v1 := multiset{0x13c, v4[703]} !! v0;
			var v6 := DC39(0xf7, v1);
			v1 := v6.cf66;
			var v7 := "elrwfcc";
			var v9: seq<bool> := [false, v1];
			var v10: seq<map<bool, int>> := [v2];
			var v11 := DC34(|v9|, v1, |v10[|v0| := fm51(globalState)]|);
			var v12 := DC13((map[[v11.cf57, v1] := v1])[v9 := v1]);
			var v13: seq<D4> := [v12];
			var v14 := DC1(v7);
			var v15: seq<D0> := [v14, v14, v14];
			if (fm17(v7 <= "js", 0x1c0, (seq(75, i1  => (DC13(map v8 : seq<bool> | v8 in [[v1]] :: (v8) := (v1))))) + v13, v14 in v15, globalState)) {
				var v16: array<bool> := new bool[15](i2 => {v1, v1, v1, v1} != {true});
				v16 := p1;
				var v17: seq<int> := [v4[703]];
				var v18: C4 := new C4();
				v17, r0 := [p0 - v4[703], v4[703], |map[v18 := v1]| + p0], 'a' in v7;
				var v19: map<bool, bool> := map[v5.fm23(false, |v0|, v1, 0x196, globalState) := v1];
				var v20: map<int, bool> := map[|v19| := v1];
				v16[749] := if (|v0| in v20) then v20[|v0|] else fm0(v4[703], globalState);
				v16[749] := v1;
				globalState.f1 := 0x172;
				globalState.f7 := (if (v4[703] in v0) then v0[v4[703]] else v4[703]) + (if (v1) then p0 else v4[703]);
			} else {
				var v21: map<bool, bool> := map[fm0(p0, globalState) := v1];
				var v22: map<array<bool>, D3> := map[p1 := DC11(v4[703], v21)];
				var v23 := DC10(v7, true, v1);
				var v24 := DC12(if (p1 in v22) then v22[p1] else v23);
				v24 := v24;
				v4[703] := (if (true) then 0x126 else |v9|) + v4[703];
				var v26: array<map<int, D11>> := new map<int, D11>[8](i3 => map v25 : int | (0xc3 <= v25) && (v25 < -0x6c) :: (v25 * p0) := (DC33(v1, v4[703])));
...
class C9 extends T0 {
	...
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
		...
		if (v5 !! v5) {
			...
			var v20: array<map<int, int>> := new map<int, int>[10] [v18[v2], v17 + v17, if (f17 in v19) then v19[f17] else v17, v17, v17, v17, map[v2 := -v2], v17 + v17, map[v2 := v2], map[v2 := v2]];
			v20[507] := map[0x6d := fm1(globalState)];
			var v21: seq<string> := [v10, v10];
			v15, v20[507] := if (v21[v2 := v10] <= v21) then v15 else v15, v17;
			v2 := v2;
		}
		
		var v22: seq<int> := [v2 / |v5|];
			...
			decreases 100 - i1
		{
			...
			if (!(if (v32 in v33) then v33[v32] else p1)) {
				var v34 := DC4(v2 / v2, v4);
				r0, v1, globalState.f1, v34, r1 := !!p1, v1, v2 % (v2 * v2), v34, ("nn" + v23)[-v2 := v1];
			...
			v47[903] := if (!f17 in v49) then v49[!f17] else v50[|v23|];
			v47[903] := if (!p1 in v49) then v49[!p1] else fm6(v2, fm1(globalState), v2, p1, globalState);
		}
		var v51: array<string> := new string[5];
		v51[404] := v23;
		v51[404] := v23[v2 := v1] + (v23 + v23);
		var v52: seq<bool> := [f17, p1];
		r0 := v52[v2];
		r0 := (p1 ==> true) || (v2 != -v2);
		r1 := v51[404];
		var v53: seq<seq<int>> := [v22, [v2]];
		r2 := fm45(v53, -v22[v2], globalState);
	}
	method m8(p0: seq<bool>, p1: bool, p2: bool, p3: set<bool>, globalState: GlobalState) returns (r0: set<int>) {
		...
		for i1 := v0 to v0 {
			...
			v17 := v17;
			var v19: array<multiset<D4>> := new multiset<D4>[22](i2 => multiset{DC13(DC13(map[[p2] := p1]).cf20), DC13(map[p0[|"neft"| := f10] := DC21(true, f10, f17, |"cjrt"|).cf36]), DC13(map v18 : seq<bool> | v18 in [p0] :: (v18) := (p2)), DC13(map[[f10, f10, true] := f17])} - multiset{DC13(map[p0 := f10]), DC13(map[p0 := f17])});
			var v20 := DC13(map[p0 := p1]);
			v19[659] := multiset{v20} * multiset{v20};
			var v21: multiset<D4> := multiset{v20, v20};
			v19[659] := (v21 + v21)[v20 := v12[i1] % i1];
			var v22 := true;
			var v23 := 'l';
		...
		globalState.f7 := match DC24(v0) {
			case DC23() => v0
			case DC24(cf41) => -0x7a
			case DC22(cf40) => v0 - |[seq(0x207, i3  => ('f')), seq(0x72, i4  => ('m'))]|
		};
		var v26: set<int> := {v0};
		r0 := v26;
	}
	method m9(p0: int, p1: bool, p2: seq<bool>, globalState: GlobalState) returns (r0: bool) {
		...
		globalState.f7, v0 := match DC35([v1, fm46(f17, f17, false, globalState), v1, v1, v1]) {
			case DC36(cf60) => if (p1) then |(seq(0x32c, i0  => (p0)))| else p0
		...
		v4 := v4;
		r0 := !(if (p2[0x1a7]) then f17 || !f17 else f10);
		if (p1) {
			...
			v10, v6[72] := (fm52(p0, p1, p0, |v9|, globalState) + v10) + ([p2, p2, p2] + v10), f10;
			var v11: map<bool, string> := map[if (f17) then v6[72] else v6[72] := v3 + "meguffaj"];
			v3, r0, globalState.f7 := if (false in v11) then v11[false] else seq(0xa0, i2  => (v2)), if (v6[72]) then p0 != p0 else if (v6[72]) then f17 else p1, fm1(globalState);
		} else {
			var v12: array<bool> := new bool[22];
			var v13 := DC38(multiset{v12});
			var v14: seq<string> := [v3];
			var v15: seq<int> := [p0, |v14[-0x2b2]|, |v0|, 0x27e, |v3|];
			v13 := v13.(cf64 := v13.cf64[v12 := v15[-p0]]);
			var v16: array<int> := new int[25];
			v16 := v16;
			v16[545] := |v3| % p0;
			v16[545] := p0;
			globalState.f7 := (if (p0 in v4) then v4[p0] else -131) % p0;
			v16[545] := -v16[545];
		}
		...
		var v24: map<C8, seq<int>> := map[v22 := v23[p0 := p0]];
		var v25: seq<seq<int>> := [v23, v23];
		var v26: multiset<seq<int>> := multiset{if (v22 in v24) then v24[v22] else v25[p0], v23, [0x24b, p0]};
		var v28: map<int, string> := map[fm1(globalState) := v3];
		var v29: multiset<bool> := multiset{p1};
		var v30: array<bool> := new bool[27] [f10, v19 < (set v20 : char | v20 in v19 :: (v20)), |v21| < (if ([p0] in v26) then v26[[p0]] else p0), false, if (f17) then f17 else f10, p1, p0 in (map v27 : int | v27 in v28 :: (v27 + p0) := (p0)), p0 == p0, p0 != |(seq(0x1ae, i3  => ({p1, p1, f17, !f10})))|, false, true, p0 == p0, !true, f17 <==> f10, v29 !! v29, false, if (f17 in v0) then v0[f17] else f10, f17, true <==> f10, p1, p0 >= |fm38(f17, p0, globalState)|, p0 == p0, f17, |v3| != p0, p1, false, f17];
...
class C10 extends T1 {
	...
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		for i0 := f15 to 0x153 % f15 {
			if (f16) {
				...
				v0, v3, globalState.f7 := if (f16) then v0 else v4.cf1 + v0, v3.(cf13 := v5[-f15] - v2), f15 / (i0 * i0);
				...
				var v12: seq<int> := [f15];
				var v13: array<int> := new int[26] [f15, -f15, i0, |v1|, v8.cf22, |v9|, f15, i0, -i0, i0, 0xf4, f15, f15, f15, 435, 526, i0, 0x1e4, |v11|, -0x3bb, 496, i0, i0, i0, v12[|v0|], f15];
				...
				var v24 := DC36(v21);
				var v25: array<multiset<array<int>>> := new multiset<array<int>>[18] [multiset{v10}, v21, v21 + v21, if (i0 in v22) then v22[i0] else multiset{v10}, v21, v21, v21, if (f16) then v21 else if (f15 in v22) then v22[f15] else v21, v21, multiset{v10, v13, v10}, v23[i0], v21[DC4(f15, v10).cf6 := i0] - v21, v21 * v21, v21, v21[v13 := i0], v21 + v21, v24.cf60, v21];
				v25[463] := v21 + v21;
				v16, v20, globalState.f0, v25[463] := v16, fm53(v19, f15, globalState), if (f16) then |fm13(f16, f16, globalState)| else f15, v21 * multiset{v10, v10, v10, v10};
				...
				v13 := new int[29] [f15, f15, f15, f15, -|v1|, i0 % |v26|, (fm54(globalState)).cf23, |(v0[0x348 := v19])[f15 := v19]| * i0, i0, f15, i0, f15, if (v16.f10 in v6) then v6[v16.f10] else |v0|, f15 * |v26|, i0, i0, v28.cf65, i0 - f15, fm1(globalState), |[v16.f10]|, -f15 / i0, 0x40, 0x243, f15 * |v0|, f15, f15, i0, i0, f15];
			} else {
				globalState.f0 := fm1(globalState);
				...
				var v35: seq<array<int>> := [if (|v33| in v32) then v32[|v33|] else v34[f15], v31];
				var v36: set<int> := {i0, |{v35[i0], v31}|};
				var v37: map<set<array<bool>>, set<int>> := map[v30 := v36];
				v37 := v37[v30 := v36];
				var v38 := new C1(f16);
				r1 := f16;
				var v39: seq<int> := [0x26];
				var v40: seq<int> := [f15, v39[|v39|]];
				v31[795] := -v39[i0];
				...
				v44[983] := v42;
				v31[795], v41, v44[983] := (i0 % fm1(globalState)) + i0, if (f16) then v41 else v41, v42;
			}
		...
		for i1 := 0x9 to f15 {
			...
			var v50: map<int, bool> := map[|v48| := v49[f15]];
			v47 := v47[v46 := v50];
			var v51 := new C1(f16);
			r1 := f16;
			var v52 := 'g';
		...
		v55[165] := if (f16) then if (f16 in v68) then v68[f16] else v56 else v56;
		v55[165][495] := f16;
		var v69: map<bool, string> := map[f16 := v66];
		v55[165][495] := !((if (f16 in v69) then v69[f16] else v66) != (v66 + v66));
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		var i1 := 0;
		while (|(set v11 : int | v11 in v10 :: (v11 / 0x154))| > (|v12| - p0))
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			if (f16) {
				...
				var v19: seq<int> := [737];
				var v20: seq<int> := [f15, v19[p0]];
				var v23: multiset<D15> := multiset{DC46()};
				var v26: array<set<int>> := new set<int>[19] [v15, {f15}, v15, v15, v15, v16[-0x165], set v17 : int | (0x3e1 <= v17) && (v17 < 0x2dd) :: (v17 * f15), set v18 : int | (0x71 <= v18) && (v18 < 0x3c0) :: (v18 * |v4|), set v21 : int | v21 in v20 :: (v21 * -|multiset([!false])|), v15, v15, v15, set v22 : int | (0x9b <= v22) && (v22 < 0x307) :: (v22 * f15), {f15, p0, |v23|}, v15, v15, set v24 : int | v24 in v10 :: (v24 / -723), set v25 : int | (0x195 <= v25) && (v25 < 0x35f) :: (v25 % |{DC49(-p0), DC49(f15)}|), v15];
				...
				var v31: seq<array<bool>> := [v8, v8, v30[p0], v8, v8];
				var v32: map<seq<array<bool>>, bool> := map[v31[f15 := v8] := f16];
				v32 := v32[v30 := f15 >= f15];
				v1 := v1 + v1;
			...
			match (v35) {
				case DC51(cf87, cf88) =>
					...
					globalState.f0 := p0 / f15;
				case DC50(cf86) =>
					v8[195] := v5.f17;
					v8[195] := !!f16;
					var v38: map<bool, char> := map[v5.f17 := v0];
					v38 := v38[!v5.f17 <== f16 := v1[p0]];
					var v39 := new C8(v0);
				...
				case DC52(cf89) =>
					...
					v54[263] := map[v12 := v5.f17];
					var v55: map<map<bool, bool>, bool> := map[v12 + v12 := true];
					var v56: seq<map<int, bool>> := [v10, map[fm9(v1, {v12}, globalState) := v5.f17], v10, v10];
					v0, globalState.f1, v54[263], v55 := v0, |(v52 + v52)[|v9| / f15 := |v56|]|, v55, if (v5.f17) then v55 else (map v57 : map<bool, bool> | v57 in v55 :: (v57) := (v5.f17))[v12 := v5.f17];
			}
		...
		if (f16) {
			...
			v64[851] := if (v5.f17) then 'i' else v65.cf87;
			var v66 := false;
			...
			v64[851], v66, v70 := v0, f16, v72.cf90[p0 := v69];
			if (v5.f17) {
				globalState.f1 := p0;
				...
				v76 := (v76 * (set v77 : int | (614 <= v77) && (v77 < 0x33f) :: (v77 / f15))) * (v76 + (set v78 : int | v78 in v10 :: (v78 % 0xba)));
				v8[871] := v5.f17;
				v66, v66, globalState.f0, v1, v8[871] := v66, v7 <= multiset{v5.f17, f16}, p0, v1, v5.f17;
			...
			globalState.f7 := |v85| / p0;
		} else {
			var v86 := new C8(v0);
			var v87 := new C0();
			if ((|multiset{v5.f17, v5.f17}| / p0) <= -p0) {
				var v88 := true;
				...
				globalState.f7 := v89[|{v94.f10}|] % (f15 / |v9|);
			} else {
				...
				globalState.f1, v86.f18, globalState.f0 := f15 - f15, v86.f18, -(p0 - (if (v5.f17) then p0 else |(seq(0x14e, i3  => (v86.f18)))|));
				var v104: array<map<string, string>> := new map<string, string>[20](i4 => map[v1 := v1] + map["pabfkukml" := seq(0x66, i5  => ('w'))]);
				...
				v104[125] := v106[if (v5.f17) then f15 else |v108|];
				...
				v116, globalState.f1, v8[781], v8[813], v117 := (v118.cf101 + v116) + v116, |(map[v5.f17 := v119] + v120)|, v110, false, v117;
			}
			
			v8[792] := v5.f17;
			v8[792] := if (v5.f17) then v5.f17 else !f16;
			globalState.f1 := f15;
		}
	...
	method m7(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: D0, r3: int) {
		for i0 := f15 + f15 to f15 {
			...
			v2[13] := if (!p1) then p1 else v7[f15];
			v2[13] := v7[f15];
		}
		...
		if (v9 <= v9) {
			...
			var v17: array<map<int, char>> := new map<int, char>[15] [(map[f15 := v10])[|v11| := v10], map v12 : int | (0x91 <= v12) && (v12 < 0x1ae) :: (v12 % f15) := (v10), map[f15 := v10], v13, v13, v13[f15 := v10], v13, v13, map[f15 := v10], fm50(p0, |v15|, globalState), v13, map v16 : int | (12 <= v16) && (v16 < -0x3e5) :: (v16 + f15) := (v10), map[f15 := v10], v13, fm50(DC17(f16, v10).cf28, 0x38d, globalState)];
			...
			var v27: map<array<set<bool>>, set<array<int>>> := map[v23 := v26[f15]];
...
class C11 extends T0, T1 {
	...
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
		...
		var v10 := DC12(v5);
		v3[539] := if (p1) then |v9[v10 := v8]| else f13;
		v3[539] := f13;
		for i1 := v3[539] * -f13 to --(f13 + 135) {
			var v11: set<int> := {v3[539]};
			v11 := (v11 - {DC7(i1, true, v3[539]).cf11, 0x0, 0xf1, i1, f13}) - v11;
			...
			if (f10) {
				...
				v20 := v20[[p1, true, f10, v12.f21] + [v12.f21] := v11 * {i1, f13, v3[539]}];
				...
				v28[395] := p1;
				globalState.f0 := i1;
				globalState.f1 := |(map v29 : int | v29 in (map v30 : int | v30 in v11 :: (v30 + v12.f22) := ([f10])) :: (v29 % -|f14|) := (0x242))|;
				r0 := !false <== p1;
			}
			
		}
		r0 := p1;
		for i3 := v3[539] to -v3[539] % -|f14| {
			v3[539] := f13 * (|fm41(globalState)| / v3[539]);
			var v31: array<set<bool>> := new set<bool>[16](i4 => {f10, p1});
			var v32: map<array<set<bool>>, int> := map[v31 := i3];
			v32 := v32[v31 := v3[539]];
			var v33: multiset<seq<bool>> := multiset{[p1] + ([f10, f10])[f13 := f10]};
			v33 := v33;
			v8 := v8[i3 := p1];
		}
		r0 := p1;
		r1 := f14 + ((seq(961, i5  => ('e'))) + f14);
		var v34: map<int, int> := map[0xd4 := v3[539]];
		r2 := v34;
	}
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
		for i0 := f13 to if (f10) then f13 else f13 {
			...
			v10[690] := f10;
			var v11 := DC39(if (f10 in v3) then v3[f10] else v8[482], !f10);
			v10[690] := !(if (f10) then v11 else v11).cf66;
		}
		...
		match (v14) {
			case DC31(cf50, cf51, cf52) =>
				...
				v15[116] := f13;
				v15[116] := cf52;
				var v16 := DC0(DC2(false, v12[909]).cf3);
				var v17: seq<array<bool>> := [v16.cf0, v13, v13];
				var v18 := new C10(|v17|, cf50);
				globalState.f7 := v18.f15 % (v18.f15 % f13);
				if (v18.f16) {
					...
					v24[437] := v32;
					var v33: multiset<int> := multiset{v15[116]};
					...
					cf50, cf50, v24[437], v36 := if (v15 in v37) then v37[v15] else cf51, fm8(v18.f15, v18.f16, cf51 <== cf51, globalState), v32 + v32, v36;
					globalState.f1 := cf52;
					...
					v15[116] := fm9(v38[cf52], v40 * {v39, v39[cf50 := v18.f16], map[cf51 := f10], v39}, globalState);
					v12[909][590] := cf51;
					...
					var v44: map<array<bool>, bool> := map[v12[909] := cf50];
					var v45: C2 := new C2(cf51, v18.f15);
					var v46: seq<C2> := [v45];
					v12[909][590], v41[925], v12[909][220], globalState.f1, r1 := f10, (v42 + v42) + [(v43.(cf58 := |{v12[909], v13}|).(cf56 := f13, cf57 := v18.f16)).cf57, if (v13 in v44) then v44[v13] else f10], v18.f16, |((v46 + [v45]) + v46)|, false;
				}
			...
			case DC30(cf49) =>
				...
				match (v48) {
					case DC17(cf28, cf29) =>
						v13[170] := cf28;
						v13[170], cf29, r2 := f10, cf29, f13;
						var v49: array<set<int>> := new set<int>[1];
						var v50: set<int> := {f13};
						v49[314] := v50;
						v49[314] := {f13, f13} + (v50 - v50);
					...
					case DC16(cf27) =>
						...
						var v55: multiset<int> := multiset{if (f10 in cf27) then cf27[f10] else f13, |(map v54 : int | v54 in v53 :: (v54 / f13) := (f13))|};
						var v56: map<bool, bool> := map[false := f10];
						var v57: array<int> := new int[29] [f13, -(f13 * f13), f13, |f14|, f13, f13, -v53[f13] + f13, 658, f13 / f13, --0x342, f13, f13, |(v55 * v55)|, f13, f13, |(map[f10 := f10] + v56)|, f13, f13 - fm1(globalState), f13, f13 % |f14|, f13, -(|"ffvvncjhg"| + f13), -|fm3(-f13, f13, globalState)|, f13 / 0x272, f13, f13, f13, f13, f13];
						v57[865] := |fm41(globalState)|;
						v57[865] := f13;
						var v58 := new C6();
						r1 := f10;
						...
						r1 := (if (f10) then v61 else v61[v57[865] := v60]) == v61;
					case DC18(cf30) =>
				...
				var v71 := 't';
				v70[261] := v71;
				v47, r1, v69[589], v70[261] := v47, (cf49 + cf49) > cf49, f13 - f13, v71;
		...
		for i4 := f13 to |v74| {
			...
			var v78: map<bool, int> := map[v73.f17 := v77.cf56 % i4];
			var v79 := "gijrn";
			var v80 := 'j';
			var v81: map<char, int> := map[v80 := f13 / i4];
			var v82: seq<int> := [f13];
			var v83: seq<bool> := [v73.f17, false];
			v78, v79, v81 := ((v78[f10 := f13])[v73.f17 := i4])[v73.f17 <== v73.f17 := v82[f13]], f14 + f14, (v81[fm4(v73.f17, v73.f17, v83[0x1bb], globalState) := i4])['i' := -i4];
			var v84: array<array<int>> := new array<int>[11];
			v84 := v84;
			v83 := v83 + DC56(v83).cf97;
		}
		globalState.f0 := f13 / f13;
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		var v4: seq<seq<int>> := [seq(0x205, i0  => (|(map v3 : int | v3 in map[f13 := f13] :: (v3 * |f14|) := (seq(0xef, i1  => ('n'))))|)), [f13]];
		...
		v0, v2[670], v7[667] := v8 != (v8 + v8), v1 + v1, v6.(cf85 := p0);
		var v9: map<char, int> := map[fm4(f10, v0, f10, globalState) := v1[fm1(globalState)] / 0x394];
		var v10 := 'x';
		v9 := v9[v10 := p0];
		v9 := v9[v10 := |f14|];
		...
		for i2 := p0 to fm1(globalState) {
			if (f10) {
				...
				v15 := v15;
				var v16: set<bool> := {!v5[-0x2cf], v0, v0};
				...
				var v22: map<int, int> := map[|[|f14[if (f13 in v19) then v19[f13] else |fm26(globalState)| := v10]|, i2]| := |(v21 + v21)|];
				var v23: multiset<char> := multiset{v10};
				var v24: multiset<int> := multiset{f13, f13, |([v20.fm8(f13, f10, f10, globalState), v0, f10, f10, f10])[if (v10 in v9) then v9[v10] else if (v10 in v23) then v23[v10] else 0x324 := v0]|, p0, i2};
				v19 := v19[p0 - -|v24| := i2];
				var v25: array<int> := new int[9];
				v25 := v25;
				var v26: seq<T1> := [v20, v20, v20, v20, v20];
				var v27: array<T1> := new T1[1] [v26[0x180]];
				v27 := v27;
		...
		var i3 := 0;
		while (if (p0 in v42) then v42[p0] else v10 in v43[p0])
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			if (fm0(f13, globalState)) {
				...
				v44 := v44;
				v0 := fm6(fm9("ywsbusnf", v38, globalState), |map[f10 := |(seq(575, i4  => (v10)))[f13 := v10]|]|, p0 - fm1(globalState), f10, globalState);
				var v45: T1 := new C4();
				var v46: array<bool> := new bool[18];
				v46[929] := if (v0) then f10 else true;
				v46[556] := v0;
				v45, globalState.f7, v46[929], v46[556] := v45, v45.fm9(fm38(v0, p0, globalState), v38, globalState), v0, v5[p0];
				v46[929] := v5[f13];
			} else {
				globalState.f7 := if (f10) then fm1(globalState) * 0xcf else f13;
				var v47 := "rbiusl";
				v47 := seq(733, i5  => (if (f10) then v10 else v10));
				v0 := f10;
				var v48 := new C8(v10);
				var v49: array<bool> := new bool[6];
				v49[71] := v0;
				v49[71] := if (f10) then f10 else v5[f13];
			}
...
class C12 extends T0, T1 {
	...
	function fm9(p0: string, p1: set<map<bool, bool>>, globalState: GlobalState): int {
		-((-|(set v0 : int | (0x3a2 <= v0) && (v0 < 0x21e) :: (v0 + -0x230))| + 0x1f2) + (|[405]| / -0x1a2))
	}
	function fm10(globalState: GlobalState): bool {
		!((|"rhyfgw"| / |"nhdnniyk"|) >= (|{f12}| - |(seq(0x29, i0  => (0xd2)))|))
	}
	method m3(p0: map<int, map<char, bool>>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, int>) {
		if (!f11) {
			var v0 := 'r';
			...
			var v6: set<char> := {v2[-fm9(seq(0xea, i0  => (v0)), v5, globalState)]};
			v6 := if (!p1) then v6 else v6;
			if (p1) {
				var v7: map<int, bool> := map[v4 := f11];
				v7 := v7[v4 := true];
				var v8: multiset<string> := multiset{seq(934, i1  => (v0)), v2};
				...
				v16, r1, f12 := (v16 + v16) + (seq(0x2c1, i2  => (DC11(v4, v3).cf18))), v2, v17[v4];
				...
				v13[5] := if (f10 in v3) then v3[f10] else !true;
				...
				globalState.f1, r0, v13[5], globalState.f0 := |v23| + v4, p1, multiset{v24} >= v25, |(map[v13 := v17[v4]] + (v26 + (if (|v17| in v29) then v29[|v17|] else map[v13 := f12])))|;
			...
			v32, r1, r0, v33 := (v32 + ([true])[v4 := fm8(|(map v34 : int | v34 in v36 :: (v34 % v4) := (v3))|, f11, false, globalState)]) + v32, (v2 + v2) + v2, ((seq(42, i4  => (v0))) + v2) <= "y", v33;
			if (false ==> f10) {
				...
				v39[409] := f12;
				var v40 := DC14(v37[959], v4);
				v39[409], globalState.f0, globalState.f7 := f10, v4, v40.cf21;
				var v41: map<int, int> := map[v4 := |v32|];
				globalState.f0 := 0x243 % (if (v37[959] in v41) then v41[v37[959]] else -|map[f11 := f11]|);
				v41 := v41[v4 := v37[959] - v4];
				f12 := v32[v4];
			} else {
				var v42: map<bool, int> := map[f10 := v4];
				var v43 := new C3(p1, v32[fm1(globalState)] !in v42);
				var v44: array<int> := new int[24];
				v44[133] := |(v36 + map[v4 := true])|;
				var v45: seq<int> := [|v32|, v4, 0x3c3];
				v44[133] := v45[|v2|];
				var v46: map<set<bool>, bool> := map[{p1} := f10];
				globalState.f7 := -v44[133] * |(v32 + v32)[|v46[{false} := f12]| := f11]|;
				r0 := f12;
			...
			var v49 := 0x279;
			var v50 := 'u';
			var v51: map<bool, bool> := map[false := v48 <= v48[v49 := v50]];
			v51 := v51[f12 := p1] + v51;
			r0 := v50 in v48;
			var v52: seq<bool> := [p1];
			var v53 := DC11(|(v52 + v52)[v49 := true]|, v51);
			match (v53) {
				case DC10(cf14, cf15, cf16) =>
					...
					var v60: map<int, int> := map[v49 := fm9(seq(-0x25f, i5  => (v50)), v59, globalState)];
					var v61: multiset<map<int, int>> := multiset{v60};
					var v62: array<bool> := new bool[27] [DC7(|v54|, cf15, v49).cf10 || f10, !f10, !f12, !(v55 > v55), f10, f10, v52[v49], v49 >= v49, f12, !cf15, cf15, cf15 <==> !f10, v57.cf66, false, v49 < |v58|, f11, f12, cf16, f12, !!!fm10(globalState), false, cf16, v55 > v55, cf14 == cf14, p1, !f12, v60 !in v61];
					v62[267] := f10;
				...
				case DC11(cf17, cf18) =>
					...
					var v68: map<array<bool>, int> := map[v66 := -fm9(v48, v67, globalState) / 0x62];
				...
				case DC9(cf13) =>
					...
					var v73: array<bool> := new bool[23] [v49 > v49, !p1, (if (|v71| in v70) then v70[|v71|] else v48) < (seq(934, i7  => (v50))), f10, f11, f12, f10, p1, f11, false, f10, f12, p1, f10, p1, !fm7(f10, globalState), p1 <== !true, p1, !!(v49 >= v49), f11, v72 >= multiset{0xde}, f10, f12];
					v73[458] := !(f11 || p1);
					v73[458] := v52 == (fm40(f12, f11, globalState) + v52);
				...
				case DC12(cf19) =>
					...
					f12, v79[773] := (if (f11) then v80 else fm18(v49, fm51(globalState), f10, globalState)) < v80, f12;
					var v81: map<int, map<bool, bool>> := map[0x277 := v51];
					var v82 := DC41(v81);
					v82 := v82;
					var v83 := DC60(|v48|);
					var v84: set<bool> := {v79[773]};
					var v85: seq<int> := [|v80|];
					var v86: array<int> := new int[7] [if (p1) then v49 else v49, v49, v49, v49, v83.cf102, v49 + -|v84|, v49 - |v85|];
					v86[516] := v49 + v49;
					var v87 := DC32(map[v49 := f10]);
					globalState.f0, globalState.f0, v86[516] := v49 * --|(v80 - v80)|, v49, if ((if (p1) then 255 else |v87.cf53|) in v80) then v80[if (p1) then 255 else |v87.cf53|] else |v84|;
					var v88: map<int, bool> := map[v86[516] := f12];
					var v89 := new C9(f11, if (v86[516] in v88) then v88[v86[516]] else true);
			}
			...
			var v96: array<int> := new int[16] [v49, fm1(globalState), 629, |v92|, v49, |(seq(-0x18f, i9  => (v50)))|, |v48|, v95.cf99, 0x53, -0x2ee, v49, v49, 208, v49, fm1(globalState), v49];
			v90[285] := v96;
			...
			var v103: array<bool> := new bool[19] [v93.f17, f12, v97 !in v100, v48 < v48, v49 == v49, v49 >= |v51|, f10, f10, multiset{v93.f17} > v91, !f10 in v101, f12, multiset{v49, |v48|} > v102, !true, p1, v93.f17, f11, v93.f17, v93.f17, fm6(v49, -|v48[|v52| := v50]|, v49, f12, globalState)];
			v103[377] := (seq(-354, i10  => (v50))) == v48;
			var v104 := DC46();
			r0, v90[285], v103[377], v104 := (seq(-0x2dc, i11  => (v50))) < v48, v96, v93.f17, DC46();
		...
		var v113: array<string> := new string[26] ["prqda", v105, "wx" + v105, v105, if (if (v108 in v109) then v109[v108] else f10) then ("wjuvsa")[v106 := 'h'] else v105, (seq(-0x22d, i12  => ('h'))) + v105, v105 + v105, v105, v105, "jnfj" + (seq(0x126, i13  => ('y'))), fm13(v107.f10, v110[v106], globalState) + v105, v105, v105, v105, v105, v105, v105, v105, if (!f10) then v105 else v105, v105, v111.cf1, v105, v105, v105, v105, (if (v107.f10 in v112) then v112[v107.f10] else v105) + v105];
		v113[176] := v105;
		v113[176] := v105;
		var v114 := 'a';
		f12 := v114 in v105;
	...
	method m4(globalState: GlobalState) returns (r0: set<string>, r1: bool, r2: int) {
			...
			decreases 100 - i0
		{
			...
			match (v9) {
				case DC14(cf21, cf22) =>
					...
					v11[139] := f12;
					v11[139] := f10;
					var v12 := new C3(cf21 == v0, |v5[985]| !in (seq(0x366, i2  => (-|(seq(-0x20d, i3  => (|v5[985]|)))|))));
					var v13: map<int, bool> := map[cf22 := v11[139]];
					v1[95] := 319;
					v13, f12, v5[985], r1, v1[95] := map[cf21 := f10] + map[cf21 := f11], v12.fm8(cf22, true, cf22 == 304, globalState), v5[985], false, cf22;
				case DC15(cf23, cf24, cf25, cf26) =>
					globalState.f0 := fm1(globalState);
				...
				case DC13(cf20) =>
					...
					r1, globalState.f7, v16[989], v17, globalState.f7 := v7 !in (seq(400, i5  => (v7))), v0, fm0(v0, globalState), v17 + (v17 + v17), v0;
					v1[131] := 0x300;
					var v18: map<bool, int> := map[v16[989] := v0];
					var v19: map<int, int> := map[v0 := 653];
					var v20: seq<map<int, int>> := [v19];
					var v21: multiset<bool> := multiset{fm0(0xb, globalState)};
					r1, globalState.f0, f12, v1[131] := v18 == (v18 + v18), v0 - 0x38f, f12 && f12, |v20[|v21|]| - v0;
					v7 := v7;
					var v22: multiset<int> := multiset{v1[131]};
					var v23: C11 := new C11(|v22|, v6, f10);
					var v24: map<C11, bool> := map[v23 := f10];
					v24 := v24;
			}
			
			if (fm8(|v5[985]|, f10, fm40(f10, f10, globalState) <= v3, globalState)) {
				v1[886] := v0 * v0;
				v1[59] := v0;
				v1[886], v1[59] := v0, v0;
				var v25: array<array<bool>> := new array<bool>[24];
				r2, f12, v25 := v1[886] / v1[886], !f10, if (f10) then v25 else v25;
				var v26: map<int, int> := map[-0x371 := v0];
				f12 := v1[886] < -(v0 / |v26|);
				var v27: multiset<bool> := multiset{f10};
				var v28 := DC45(v1[886], f10, f11);
				...
				v29[105] := v28;
				var v30: multiset<int> := multiset{v1[886]};
				v27, v29[105], v1[886], v6, r1 := v27, v28, v1[886], v6, fm0(|v30|, globalState);
				f12 := f12;
			} else {
		...
		for i6 := fm1(globalState) to v0 {
			...
			if (f11) {
				...
				v35[888] := f11;
				v35[888] := (v0 != i6) ==> f10;
				var v36: set<bool> := {v35[888], f11};
				globalState.f7 := v1[169] % |v36|;
			} else {
				var v37 := 'i';
				var v38: array<char> := new char[3] [v37, v37, v37];
				var v39 := DC37(-0x2d6, v38, v37);
				var v40 := DC40(v39, f10, i6, v1[169]);
				...
				var v47: array<array<bool>> := new array<bool>[18] [v45, v45, v45, v45, v45, v45, if (v1[169] in v46) then v46[v1[169]] else v45, v45, v45, v45, v45, v45, v45, v45, v45, v45, v45, v45];
				var v48 := DC50(v47);
			...
			var v52: C6 := new C6();
			var v53: seq<int> := [(if (v0 in v51) then v51[v0] else v1[169]) - |[v52]|, v1[169], i6];
			globalState.f7 := v53[i6];
			f12 := v3[|(v50 + v50)|];
		}
		var v54 := "gjbsmqq";
		var v55 := 'i';
		var v56: seq<string> := [v54[|v54| := v55]];
		var v57: multiset<string> := multiset{v54, v56[v0]};
		var v58, v59 := m6(v0, f12, v57, globalState);
		for i9 := -0x17e to v59 % v59 {
			f12 := i9 in multiset(if (v58) then seq(0x2da, i10  => (v0)) else [v59]);
			var v60: map<bool, bool> := map[f10 := f12];
			v60 := v60[v58 := !!!f11];
			if (fm0(v59, globalState)) {
				f12 := f11;
				var v61: seq<int> := [--0x169, |map[v0 := f11]| * i9];
				globalState.f7 := v61[0x177];
				...
				var v65: seq<seq<bool>> := [v3, ([f12])[v0 := f11], v3];
				v58 := (v3 + v3) !in v65;
				var v66: array<bool> := new bool[19];
				v66[286] := f10;
				v66[286] := v58;
				var v67: map<char, string> := map[v55 := v54[i9 := v54[i9]]];
				var v68: set<bool> := {v58, v58, false, f11};
				var v69: map<set<bool>, string> := map[v68 := seq(0x326, i16  => (v55))];
				var v70: array<string> := new string[24] [if (v55 in v67) then v67[v55] else v54, v54, v54, v54 + v54, seq(354, i12  => ('b')), if (f10) then "jcg" else fm25(v0, v66[286], i9, globalState), v54, v54, v54, v54, seq(0x3b5, i13  => (v55)), seq(502, i14  => (v55)), v54 + v54, "whgxodd", v54, (v54 + v54)[v0 := v55], v54, v54, v54 + v54, v54, seq(855, i15  => (v55)), if (v68 in v69) then v69[v68] else v54, v54 + v54, v54];
				...
				v71[386] := map v72 : multiset<int> | v72 in v75[fm1(globalState)] :: (v72) := (map[v2 := DC18(DC18(DC17(v66[286], v55)))]);
				v1[661] := v0;
				v1[963] := |v68|;
				var v76: map<seq<bool>, int> := map[[v58, f11] := i9];
				var v77: map<bool, int> := map[!f10 := i9];
				var v78: multiset<bool> := multiset{v58};
				var v79 := DC16(v78[v66[286] := v59]);
				var v80 := DC18(v79);
				var v81 := DC18(v80);
				var v82: map<D10, D5> := map[DC31(v58, v58, v59) := v81];
				var v83: map<multiset<int>, map<D10, D5>> := map[fm18(i9, v77, v66[286], globalState) := v82];
				var v84: set<D19> := {fm58(globalState)};
				var v85 := DC58(|v73|, v66[286]);
				var v86: seq<set<D19>> := [v84, {v85, v85}];
				v58, v70, v71[386], v1[661], v1[963] := v3 !in v76, v70, v83, |v86|, -i9 + (v0 * v59);
				v77 := v77[f12 := v59];
				var v87: seq<array<bool>> := [v66, v66, v66];
				var v88: array<char> := new char[20] [v55, v55, v55, 'r', v55, v55, v55, v55, v55, fm4(f12, v66[286], false, globalState), v55, v55, if (v58) then v55 else v55, v55, v55, v55, v55, v55, v55, v55];
				v88[970] := v55;
				v87, r1, v54, v88[970] := v87, v58, ("gim" + fm13(f11, f10, globalState)) + v54, v55;
			}
		...
		r1 := !fm0((if (|v95| in v93) then v93[|v95|] else |v3|) / v59, globalState);
		r2 := fm1(globalState);
	}
	method m5(p0: int, globalState: GlobalState) {
		if (f10) {
			...
			v0[351] := |v1| * |(v3 * fm31(p0, globalState))|;
			var v4 := DC20(f11, f12, f11, p0 / v0[351]);
			var v5 := 'a';
			var v6: multiset<int> := multiset{p0};
			globalState.f7, v4, f12, v0[351] := p0, DC20(f11, f11, DC17(f12, v5).cf28, |v6|).(cf34 := true, cf35 := p0, cf32 := f12), f12, (if (f12) then v0[351] else v0[351]) - v0[351];
			var v7: array<array<bool>> := new array<bool>[11];
			var v8: array<bool> := new bool[3];
			v7[93] := v8;
			v7[93] := v8;
			var v9 := new C10(v0[351] * p0, f12);
		} else {
			var v10 := "pbgo";
			...
			var v15: map<array<int>, bool> := map[v14[p0] := fm0(p0, globalState)];
			v15 := v15[v13 := f11];
			globalState.f1 := if (v11.f20) then -29 / p0 else p0;
			f12 := !v11.f20 <== (p0 > p0);
		...
		for i2 := p0 to |v21| {
			...
			globalState.f0, v25 := (i2 % p0) - p0, v25;
			var v26 := new C0();
		...
		if (f12) {
			...
			v31[575] := f12;
			v31[575] := f12;
			var v32: map<bool, int> := map[f12 := p0 % |v28|];
			v32 := v32;
			v31[575] := p0 < p0;
		} else {
			...
			var v36: multiset<seq<int>> := multiset{seq(0x1a3, i7  => (0x21d))};
			var v37 := 'm';
			var v38: seq<char> := [v37, v37];
			var v39: array<int> := new int[19] [0x288, |map[false := p0]|, p0, p0, -p0, p0, p0, p0, p0, p0, |v33|, p0, 208, if (|fm45((seq(-0xa5, i6  => ([p0, p0])))[p0 := v34], p0, globalState)| in v33) then v33[|fm45((seq(-0xa5, i6  => ([p0, p0])))[p0 := v34], p0, globalState)|] else 541, p0, p0, p0, |v35| / p0, |v36| + |v38|];
			v39[2] := 571;
			v39[2] := p0;
			f12 := false;
			f12 := f11;
		...
		match (v44) {
			...
			case DC46() =>
				...
				if (if (f10) then f10 else v20[390]) {
					...
					v54[31] := v53;
					var v55 := DC61(v53);
					v54[31] := if (423 != -v50.f22) then if (v50.f21) then v53 else v55.cf103 else v53;
					v47[295] := f10;
					v47[295] := if (v50.f21) then v20[p0] else v50.f21;
					var v56 := new C9(f10, f11);
					var v57: map<string, bool> := map[v48 := v56.f17];
					v57 := v57[v49 := v56.f17];
				} else {
					globalState.f1 := p0 % p0;
					var v58 := new C2(!v20[p0], p0);
					var v59: array<int> := new int[5];
					v59 := new int[8];
					globalState.f0 := |"qe"|;
					var v60 := new C9(v20[-v58.f22], f10);
				}
				
				var v61 := 'l';
				var v62 := DC6(v61);
				var v63: array<char> := new char[17] [v61, v61, 'p', fm4(f12, f10, f12, globalState), v61, v49[-p0], v61, v61, v61, v61, v61, v61, 'g', v62.cf8, v61, v61, fm4(f10, f11, f11, globalState)];
				v63[226] := v61;
				v63[226] := v61;
				v47[427] := f10;
				v47[427] := !!true;
			case DC44(cf79) =>
				...
				var v73 := DC15(if (!f11) then fm1(globalState) else |v67|, v72[p0 := p0], v71[p0], -p0);
				match (v73) {
					case DC14(cf21, cf22) =>
						var v74: C2 := new C2(f12, |v68|);
						var v75: map<int, bool> := map[cf22 := f12 <== f12];
						v74, v71, v75, v20, v67 := v74, v71, v75, [fm0(|v71|, globalState), v74.f21, v74.f21 ==> !f12], (if (!v74.f21) then v67 else v67) + (seq(-929, i8  => (v74.f22)));
						var v76: set<map<bool, bool>> := {v68, v68};
						v68 := v68[fm10(globalState) := multiset{|v20|} <= (multiset(fm3(cf21, 469, globalState)))[-v74.fm9(v71, v76, globalState) := fm9(v71, v76, globalState)]];
				...
				var v90: map<string, array<int>> := map[("able")[p0 := fm4(f11, f12, true, globalState)] := v64];
			...
			case DC47(cf83) =>
				...
				if (0x290 != p0) {
					...
					f12, globalState.f0, v94[154], v95[505] := f11, -|(v96 + v96)| % p0, v91, if (f12) then v96 else v97.cf14;
					...
					v105 := v105[[v103] := f11];
					var v106: set<string> := {v95[505] + v96, v95[505], v95[505]};
					v106 := v106;
					globalState.f1 := p0 * p0;
					v96 := v96;
				} else {
					...
					var v110 := 'x';
					var v111 := "wknhrdj";
					v108, v109, globalState.f1, v110, v110 := DC0(v107), v109, p0, v110, v111[p0];
					f12 := f12;
	...
	method m6(p0: int, p1: bool, p2: multiset<string>, globalState: GlobalState) returns (r0: bool, r1: int) {
			...
			decreases 100 - i0
		{
			...
			var v5: array<array<bool>> := new array<bool>[22] [v3, v3, v3, if (v4[p0]) then v3 else v3, v3, v3, v3, v3, v3, v3, if (p1) then v3 else v3, v3, v3, if (!!true) then v3 else v3, v3, v3, v3, v3, v3, v3, v3, v3];
			v5[467] := if (p1) then v3 else v3;
			v5[467] := v3;
		}
		globalState.f7 := p0;
		...
		v17[923] := fm8(p0, f12, f11, globalState);
		var v18 := DC43(v9, p0, -p0, p0);
		globalState.f1, v17[923], globalState.f7 := |[-v18.cf78]|, f12 ==> false, |fm11(if (true) then f11 else f12, p0, p0, globalState)|;
		r0 := f12 ==> f11;
		r1 := -942;
	}
}
...
class C13 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		var v1 := new C11(|v0|, seq(-595, i0  => ('w')), f9);
		var i1 := 0;
		while (f8)
			decreases 100 - i1
		{
			...
			match (v5) {
				case DC23() =>
					...
					var v10 := 'k';
					v7, v8 := v7, if (v9 >= (set v11 : string | v11 in (multiset{v1.f14, seq(0x281, i3  => ('t')), v1.f14, v1.f14, "cwulthy"})[v1.f14[v1.f13 := v10] := 0x125] :: (v11))) then v8 else v8;
					var v12: array<int> := new int[20];
					v12[898] := p0 / 0x74;
					var v13: multiset<bool> := multiset{false, v2.f19};
					var v14: map<int, int> := map[v1.f13 := 441];
					v12[898] := |((v13 - multiset(v6[if (-p0 in v14) then v14[-p0] else -p0 := v2.f19])) - (v13 - v13))|;
					var v15: map<bool, int> := map[v2.f19 := |(multiset{v14})[v14 := v1.f13]|];
					var v16: map<int, bool> := map[v12[898] := f9];
					var v17: seq<map<int, int>> := [v14[|v16| := p0]];
					v15 := v15[v2.f19 := |v17[|"hioaqwmh"|]|];
				case DC24(cf41) =>
					var v18: seq<seq<int>> := [[0x35b, v1.f13], v0];
					var v19: array<char> := new char[12];
					var v20 := 't';
					var v21: seq<seq<int>> := [v18[DC37(|multiset(v0)|, v19, v20).cf61]];
					...
					var v27: multiset<int> := multiset{v1.f13, |(map v26 : seq<int> | v26 in multiset([v0, v0]) :: (v26) := (-199))[seq(572, i4  => (cf41)) := |map[cf41 := v1.f13]|]|};
					var v28 := DC46();
					...
					globalState.f0, cf41, v33 := |v1.f14| / (305 - cf41), v1.f13, v33;
				case DC22(cf40) =>
					...
					var v43: seq<bool> := [f8];
					var v44: map<int, seq<multiset<bool>>> := map[|v39| % v1.f13 := if (v1 in v42) then v42[v1] else [multiset(v43)]];
		...
		var v49: map<bool, bool> := map[v1.fm8(p0, f9, f8, globalState) := v48[v0[p0]]];
	...
	method m2(p0: bool, p1: bool, p2: int, globalState: GlobalState) {
		...
		var v5: array<seq<char>> := new seq<char>[29] [v2, [v1, if (v1 in v3) then v3[v1] else v1], v2, v2, v4.cf14, v2, v2, fm25(p2, p0, p2, globalState), v2, v2, v2, v2, v2, v2, v2, v2, v2, v4.cf14, [v1, fm4(p1, p1, f8, globalState)], seq(0xbd, i0  => (v1)), v2, v2, v2, v2, v2, v2, v2, seq(357, i1  => ('p')), v2];
		v0[198] := v5;
		var v6: map<bool, int> := map[!fm0(488, globalState) := -p2];
		var v7: set<int> := {0xa};
		v0[198], v5, v6 := v5, v5, map[if (p0) then f8 else f9 := |({-p2} + v7)|];
		var v8: seq<bool> := [p1];
		var v9 := DC14(p2, p2);
		for i2 := p2 / |v8| to v9.cf22 {
			var v10: map<int, bool> := map[i2 := p0];
			var v11: map<bool, bool> := map[f8 := f8];
			var v12: set<bool> := {if (p0 in v11) then v11[p0] else false};
			var v13: map<map<int, bool>, int> := map[v10 := |v12| % p2];
			v13 := v13[v10 := p2];
			...
			if (p0) {
				...
				v0[198][699] := v23[i2 := v1] + v23;
				var v25: seq<string> := ["vxw"];
				v0[198][699] := v25[i2];
				v22[291] := |v0[198][699]| <= |multiset{p0, v8[|(map v26 : char | v26 in v23 :: (v26) := (p0))|]}|;
				v22[291] := p0;
				var v28 := DC57(set v27 : int | (0xdb <= v27) && (v27 < -0x295) :: (v27 + |v24|));
				var v29: seq<set<int>> := [v7, v7, v7, v28.cf98, v7];
				v7 := v29[|v0[198][699]|];
				var v30: seq<map<int, bool>> := [v10, v10, map[|"aldu"| := v22[291]]];
				var v31: array<char> := new char[24] [v1, v1, v1, v1, v1, v1, 'b', v1, v1, v1, v1, v1, fm4(f8, p0, v22[291], globalState), v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1];
				var v32 := DC37(|v30|, v31, v1);
				var v33 := DC40(v32, p0, i2, i2);
				globalState.f7 := (|v7| % v33.cf69) - i2;
			}
		...
		if ((p2 * -0x338) == -(p2 - p2)) {
			...
			v0[198][715] := if (p0 in v37) then v37[p0] else v2;
			var v38: array<int> := new int[17](i3 => i3 / p2);
			v38[921] := -(p2 - p2);
			...
			v36[597], v0[198][715], v38[921], v42 := v1, "adr", -p2, DC65(v42).cf111;
			...
			match (fm63(globalState)) {
				...
				case DC16(cf27) =>
					...
					v48[65] := v47;
					v1, v8, v48[65] := v36[597], v8 + v8, v47;
					var v49: multiset<int> := multiset{p2, p2};
					v49, v38[921] := fm18(p2, v6, v2 != (seq(-0x223, i4  => (v36[597]))), globalState), v40.fm15(globalState);
					var v50 := DC17(p1, v1);
				...
				case DC18(cf30) =>
					...
					var v56 := new C9(v38[921] > v38[921], v54[822]);
			}
			
			var v57: seq<int> := [p2];
			var v58: map<int, int> := map[|v57| := v38[921]];
			v58 := v58[p2 + p2 := p2];
		} else {
			var v59: seq<int> := [-513, p2];
			var v60: multiset<bool> := multiset{f9, f9};
			var v61: array<int> := new int[4] [v59[p2], if (p0 in v60) then v60[p0] else p2, p2, 942 % -p2];
			...
			var v70: map<seq<int>, int> := map[seq(0xa0, i5  => (v67.f15)) := |v62|];
			var v71: set<map<bool, bool>> := {v62};
			var v72: map<int, int> := map[v67.fm9(v2, v71, globalState) := p2];
			v61 := new int[29] [600, p2, p2 * -p2, p2, p2, p2, -(if (p0 in v60) then v60[p0] else fm1(globalState)), p2, -(-p2 % p2), p2, p2, p2 % fm5(p2, globalState), p2, p2 * p2, p2, p2, p2, p2, |[v62, map[f8 := f8], v62]|, if (v1 in v63) then v63[v1] else v59[|v2|], p2 + -p2, p2, DC40(v65, p1, if (f8 in v6) then v6[f8] else p2, p2).cf70, p2, p2 + |v69|, p2 * p2, -|v70|, p2 * p2, |v72|];
			v66[484] := p0;
			v66[484] := v8[--p2];
			v66[484] := !v67.f16;
			var v73: map<bool, char> := map[v66[484] := 's'];
			var v74 := DC7(v67.f15, v67.f16, |v73|);
			globalState.f7 := v74.cf11;
			if (!v67.f16) {
				v61[360] := v67.f15;
				var v75: seq<map<bool, int>> := [v6];
				v61[360] := -|(if (f9) then (v75[|(seq(0x78, i6  => (v67.f15)))|])[v66[484] := -v67.f15] else v6 + fm51(globalState))|;
				globalState.f0 := 0x185;
				v61[360] := (p2 - p2) - (|v69| - fm5(v67.f15, globalState));
				var v76 := new C6();
				v66 := v66;
			} else {
				...
				var v80: map<seq<bool>, bool> := map[v8 := v66[484]];
		...
		match (fm64(globalState)) {
			case DC31(cf50, cf51, cf52) =>
				...
				v92[601] := fm0(|v94|, globalState);
				var v95: multiset<set<int>> := multiset{v7, v7};
				v91, v92[601] := v91, multiset{{cf52}} <= (if (p1) then multiset{{cf52}} else v95);
				globalState.f0 := p2;
				if (cf52 > p2) {
					var v96: C5 := new C5();
					v96 := if (v2 < (seq(0x1af, i8  => (v1)))) then v96 else if (!f8) then v96 else v96;
					var v97: C4 := new C4();
					var v98 := DC67(v97);
					v97 := v98.cf116;
					var v99: map<bool, bool> := map[f8 := p0];
					var v100: set<bool> := {p0, !!v93.f10, if (false in v99) then v99[false] else f8, v92[601]};
					var v101 := new C12(v8[p2], v92[601], |v100| < cf52);
					var v102: array<char> := new char[2](i9 => v1);
					v102[929] := fm4(v87, v92[601], v87, globalState);
					var v103: array<int> := new int[2] [|v6|, cf52 + |map[cf52 := cf52]|];
					v103[866] := p2;
					v92[601], v102[929], v103[866], v7 := v101.f11, v1, -(p2 * |v2|) % (cf52 - |v88|), v7 * v7;
					cf50 := p0;
				} else {
					var v104: multiset<bool> := multiset{v87};
					var v105: seq<multiset<bool>> := [v104];
					var v106: array<multiset<bool>> := new multiset<bool>[17] [v104, multiset(v8) - v104, v104, multiset(v8), v104, v104, fm41(globalState), v104, v105[0x6a], v104, DC16(v104).cf27, v104 * multiset([cf50]), v104, multiset{v93.f10, f8}, (multiset{!p1})[cf50 := p2] + v104, v104, v104];
					v106[125] := multiset{cf51};
					var v107 := DC0(v92);
					v106[125], v87, v92[601], v107 := v104, f8, v93.fm7(!v87, globalState), v107;
			...
			case DC30(cf49) =>
				...
				v111, v110[906], v111, globalState.f0 := !f8, v112 !! v112, v8[|(v2 + v2)|], p2;
				v110[906] := v111;
				var v113: set<array<bool>> := {v110};
				var v115 := DC30(cf49);
				var v116: seq<int> := [p2];
				v110[906], cf49, v113, globalState.f0, v110[906] := p1, {p0, (DC33(f9, -|(map v114 : int | (0x2e8 <= v114) && (v114 < 0x355) :: (v114 - |v8|) := (|v2|))|).(cf54 := p0)).cf54} + ({true, p1, v110[906]} * v115.cf49), v113 - v113, p2, |v116| != p2;
		}
...
method Main() {
	...
	v5[318] := v0;
	v14, v5[318] := v14, v4 <= v4;
	var v15: seq<int> := [|"nsrrqfxka"| - 0x1b3];
	globalState.f1 := -|v15|;
	v5[318] := v0;
	var v16: map<int, int> := map[|v4| := 0x385];
	var v17 := 470;
	var v18 := DC2(v5[318], v6[if (0x323 in v16) then v16[0x323] else v17]);
	match (v18) {
		case DC0(cf0) =>
			var v19: seq<bool> := [v0, v0];
			var v20: array<int> := new int[23](i2 => i2 + v17);
			var v21 := DC4(|v19|, v20);
			globalState.f1, v5[318], v0, v0, v0 := v17, !(-v17 > -v17), v5[318], v17 != v21.cf5, v5[318];
			v5[318] := [v0, !false, v5[318]] < (([fm0(v17, globalState)])[v17 := v5[318]] + [true]);
			v17, v0 := fm1(globalState), v18.cf2;
			v17, v0, v4 := fm1(globalState), v0, v4;
		case DC1(cf1) =>
			var v22: map<string, bool> := map["ncsyqp" := false];
			v5[318] := if (cf1 in v22) then v22[cf1] else !v5[318];
			...
			var v26: map<bool, int> := map[v5[318] := |v3|];
			var v27: map<seq<bool>, map<bool, int>> := map[v23 := v26];
			var v28: seq<map<seq<bool>, map<bool, int>>> := [(map[v23 := v26])[v23 := v26]];
			var v29: array<map<seq<bool>, map<bool, int>>> := new map<seq<bool>, map<bool, int>>[7] [if (false) then v27 else map[v23 := v26], if (v0) then v27 else v27, v27, fm2(v17, 'o', v17, v17, globalState), map[v23 := map[fm0(v17, globalState) := v17]], v28[v17], map[v23 := v26]];
			v29[568] := v27;
			v29[568] := v27;
		case DC2(cf2, cf3) =>
			...
			if (true) {
				var v32 := DC0(v5);
				v5[318], globalState.f1, cf2, v32 := if (fm0(v17, globalState)) then v18.cf2 else false, fm1(globalState), cf2, v32;
				...
				var v43: array<int> := new int[10] [|(seq(0x395, i3  => (v2)))|, v17, v17, v17, v17, v17, |v6|, |multiset{cf2}|, |v16|, v17];
			...
			match (v44) {
				case DC0(cf0) =>
					var v45, v46 := m0(-v17 % v17, cf3, globalState);
					cf2 := !fm0(v17, globalState);
					var v47: array<array<bool>> := new array<bool>[7];
					v47[465] := v5;
					var v48: multiset<int> := multiset{v17, v17, v17};
					var v49: set<string> := {v45, seq(476, i4  => (v2)), "ig"};
					cf2, v31, v5[318], globalState.f7, v47[465] := if (cf2) then v45 < v4 else v48 !! v48, v4, (v31 !in v49) || (v5[318] <==> cf2), v17, cf3;
					var v50, v51 := m0(v17, v6[v17], globalState);
				case DC1(cf1) =>
					...
					var v58: map<int, seq<int>> := map[v17 := seq(0x225, i5  => (v17))];
					v30, v0, v15, v52[845] := if (!(if (!cf2 in v13) then v13[!cf2] else v54[0x0]) in v53) then v53[!(if (!cf2 in v13) then v13[!cf2] else v54[0x0])] else cf1, !(v55 < v55), if (v57 >= multiset{v56}) then fm3(v17, v17, globalState) + (if ((if (v0 in v3) then v3[v0] else v17) in v58) then v58[if (v0 in v3) then v3[v0] else v17] else seq(0x4b, i6  => (v17))) else v15, cf3;
					var v59, v60 := m0(340, v5, globalState);
					var v61: array<char> := new char[20] [v2, v2, v2, v2, v2, v2, v2, DC6(fm4(v0, true, v5[318], globalState)).cf8, v2, v2, v2, fm4(cf2, v0, v5[318], globalState), v2, if (v0) then v2 else 'y', v2, v2, v2, if (!cf2) then v2 else v2, v2, v2];
					v61[301] := v2;
					v61[301] := fm4(v5[318], !fm0(--0x34a, globalState), multiset(v54) <= v3[v0 := v17], globalState);
					globalState.f3 := if (!DC2(cf2, v5).cf2) then v1 + v1 else v1;
				case DC2(cf2, cf3) =>
					var v62 := DC6(v2);
					var v63: multiset<char> := multiset{v30[v17], (v62.(cf8 := v2)).cf8};
					v5[318] := 0x39d != (if (v2 in v63) then v63[v2] else fm1(globalState));
					globalState.f1 := fm1(globalState);
					var v64: seq<bool> := [v5[318], v5[318]];
					var v65: set<seq<bool>> := {v64};
					v5[318] := (v65 + {v64}) > v65;
					var v66: array<int> := new int[6];
					var v67 := DC4(v17, v66);
					v66[423] := v17 * v67.cf5;
					v66[423], globalState.f0 := 984, v17;
			}
			
	}
	
	var v68: seq<set<bool>> := [v1];
	var v69: set<set<bool>> := {v68[v17]};
	var v70 := DC9(v69);
	v5[318] := !(v69 >= v70.cf13);
	for i7 := v17 to v17 {
		globalState.f7 := v17;
		...
		var v74: array<int> := new int[19] [i7, i7, v17 + v17, 0x170, i7, |v71|, fm1(globalState) * 0x199, |map[v5[318] := |v1|]| - 0x158, |v71|, |v72| + i7, if (v5[318]) then |v71| else i7, v17, v17, i7, fm1(globalState), |v73|, v17 % v17, i7, v17 * i7];
		v74 := v74;
		globalState.f1 := v17;
		v5[318] := v0;
	}
	if (v5[318]) {
		v0 := !v0;
		var v75 := new C1(v5[318]);
		var v76: array<int> := new int[6];
		v76[895] := v17;
		v76[895] := (v17 % v17) % (438 - v75.fm9(v4, {map[v0 := v5[318]]}, globalState));
		var v77 := new C5();
		v5[318] := !v75.fm6(0x1bd, v76[895], -(v17 - v76[895]), v5[318], globalState);
	} else {
		v4, v5[318] := seq(-0xa, i8  => (v2)), v0;
		globalState.f7 := |v4| - (0x174 * v17);
		var v78: map<bool, string> := map[v5[318] := v4];
		var v79: seq<bool> := [v0, false];
		v78 := v78[v5[318] in multiset{v5[318], (fm65(v0, v79, v17, globalState)).cf16} := v4];
		var v80: array<char> := new char[19] [v2, v2, v2, fm4(v5[318], v0, v0, globalState), if (!v5[318]) then v2 else 'v', v2, v2, if (v5[318]) then fm4(!!v0, v5[318], v0, globalState) else v2, v2, 'u', v2, v2, v2, v2, 'w', v2, v2, v2, v2];
	...
	match (match v84 {
		...
		case DC23() =>
			...
			if (v0) {
				...
				v85[811] := v88;
				var v89: C7 := new C7(v5[318], v0);
				var v90: map<C7, char> := map[v89 := v2];
				v85[811], v90, globalState.f0 := v88, map[v89 := v2] + map[v89 := v2], -v17;
				globalState.f1 := v17;
				var v91: C6 := new C6();
				v91 := v91;
				...
				v93[628] := "jqicmgfh";
				v92, globalState.f0, v93[628] := v92, -(-265 + v17), v4 + ("qsyncjph" + v4);
			} else {
				var v94 := new C2(v5[318], v17 - v17);
				var v95, v96 := m0(v17, v5, globalState);
				v2 := v2;
				var v97 := new C8(v95[v94.f22]);
				var v98: array<int> := new int[6](i10 => i10 % v17);
				var v99: seq<array<int>> := [v98];
				var v100 := DC68(v99[|v14| := v98]);
				var v101: map<seq<array<int>>, bool> := map[v100.cf117 := if (v5[318]) then v94.f21 else v94.f21];
				var v102: seq<seq<array<int>>> := [v99];
				var v103 := DC13(fm66(v94.f21, v2, v17, v5[318], globalState));
				var v104: seq<D4> := [v103];
				v101 := v101[v102[v17] := v97.fm17(v5[318], v17, v104, v5[318], globalState)];
			}
			...
			if (!(v17 > v17)) {
				...
				var v112, v113 := m0(v17, DC2(v5[318], v5).cf3, globalState);
				var v114: array<int> := new int[13];
				v114[955] := v17;
				v114[955] := --|v1|;
				var v115 := DC49(v17);
				v115 := v115;
				var v116: T1 := new C11(v114[955], v112, v5[318]);
				v116 := v116;
				var v117 := new C2(v5[318], v17);
			}
			
			var v118 := new C11(fm1(globalState), if (v0) then v4 else v4, (fm67(v5[318], v17, v17, globalState)).cf109);
		case DC24(cf41) =>
			if (v5[318]) {
				...
				var v124: T1 := new C1(if (multiset{'a'} in v123) then v123[multiset{'a'}] else v121.fm37(v4, cf41, v5[318], v119.f12, globalState));
				...
				var v132: seq<map<int, int>> := [v16, v16[v17 := cf41], map v129 : int | (547 <= v129) && (v129 < 0x1d6) :: (v129 % cf41) := (cf41), map v130 : int | (0x3cf <= v130) && (v130 < -0x3dd) :: (v130 - DC15(if (|v14| in v128) then v128[|v14|] else 0x155, v128, v2, cf41).cf23) := (|"tolfmsbf"|), v131.cf40];
				var v133 := DC40(v127, true, if (|v1| in v128) then v128[|v1|] else v17, |v132[cf41]|);
				var v134: seq<D13> := [v133];
				var v135: multiset<seq<D13>> := multiset{v134};
				v122, globalState.f0, v124, v125[732] := v122, cf41, v124, if ((v134 + v134) in v135) then v135[v134 + v134] else cf41;
				var v136: array<seq<int>> := new seq<int>[18];
				v136 := v136;
			} else {
				var v137 := DC32(v14 + v14);
				v137 := v137;
				var v138 := DC58(|v4|, v5[318]);
				var v139: map<D19, string> := map[v138 := v4 + v4];
				v139 := v139[v138.(cf100 := v5[318]) := v4 + v4];
				var v140 := DC60(v17);
				v140 := DC60(v15[|v1|]).(cf102 := cf41);
				var v141 := DC10("hrso", v0, v0);
				var v142: map<bool, int> := map[v5[318] := -v17];
				...
				v144 := v144[v141 := v145];
				var v146: array<char> := new char[9] [v2, v2, v2, v2, v2, v2, v2, v2, if (v5[318]) then v2 else v2];
				v146[230] := v2;
				v146[230] := v2;
			}
			...
			globalState.f1, v2 := |((v4 + v4) + v147[-v17])|, if (cf41 in v148) then v148[cf41] else if (if (cf41 in v14) then v14[cf41] else v5[318]) then v2 else v2;
			...
			var v151: array<char> := new char[28] [v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v4[cf41], v2, v2, v2, 'e', v2, v2, v2, v2, 'k', v2, v2, v2, v150.cf63, v2, if (!v5[318]) then v2 else v2, v2, v2];
			v149[428] := v2;
			v149[428] := if (true) then v2 else 'k';
		case DC22(cf40) =>
			v0 := v5[318];
			globalState.f7 := v17;
			globalState.f7 := v17;
			...
			var v154: map<map<bool, char>, bool> := map[v153 := v5[318]];
			var v155 := DC29(v154);
			v152[103] := v155;
			var v156: array<int> := new int[14];
			var v157 := DC6(v2);
			var v158: set<map<int, bool>> := {map[|v14| := v5[318]]};
			var v159: seq<bool> := [v5[318], v5[318], v5[318], v5[318], v5[318]];
			...
			var v165: array<set<map<int, bool>>> := new set<map<int, bool>>[13] [v158 * v158, {v14, map[|v4| := false], v14, v14, map[|v16| := v159[v17]]}, v158, v158, if (v17 in v161) then v161[v17] else v158, {map[v17 := v0], v14, v14}, (set v163 : map<int, bool> | v163 in v162 :: (v163)) * v164[v17], v158, v158, if (v0) then v158 else DC70(v158).cf121, v158, v158 - v158, {v14} - v158];
			v165[314] := v158;
			v4, v152[103], v156, v157, v165[314] := v4 + fm38(v0, v17, globalState), v155, v156, v157, if (fm0(v17, globalState)) then v158 else v158;
	}
	...
	v167 := v167[|v168| := v166];
	globalState.f7, v5[318] := v17, (v17 - v17) <= v17;
	...
	v166 := v171.cf118;
	var v172 := new C11(|"qwudkt"|, v4, v17 != |(seq(420, i12  => ('f')))|);
}