...
class C1 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: int) {
		if (!f4) {
			...
			v0[safeIndex(845, v0.Length)] := if (f4) then v2.f10 else f4;
			var v3: seq<bool> := [v1.f10, v1.f10];
			var v4: seq<int> := [|fm19(p0, globalState)|];
			var v5 := "hxpnn";
			var v6 := DC10(|v3|, v1.f11, v4[safeIndex(|v4[safeIndex(-|v5|, |v4|) := p0]|, |v4|)]);
			globalState.f1, v0[safeIndex(845, v0.Length)] := v6.cf17, !f4;
			var v7 := 'j';
			v7 := 'c';
			globalState.f1 := f7;
		} else {
			...
			globalState.f1 := safeModuloInt(-f3, |map[f7 := f4]|);
			if ("ukt" == fm20(-|v8|, globalState)) {
				globalState.f1 := f3;
				var v11: multiset<bool> := multiset{f4};
				v11 := v11;
				globalState.f2 := if (f4) then p0 > -f7 else false;
				globalState.f1 := safeModuloInt(791, |map[f3 := f4]|);
				v10 := v10;
			} else {
				globalState.f2 := fm2(safeModuloInt(p0, f3), globalState);
				var v12 := DC0(f4);
				var v13: multiset<bool> := multiset{f4, f4, f4, v12.cf0, f4};
				var v14: map<string, multiset<bool>> := map[v8 := v13];
				v14 := v14[(seq(abs(-0x1dc), i1  => ('y')))[safeIndex(f7, |(seq(abs(-0x1dc), i1  => ('y')))|) := 'q'] := v13];
				globalState.f1 := -f7;
				var v15: array<int> := new int[11] [p0, f3, f7, fm0(globalState), f3, |v8|, p0, -f7, f7, p0, -0xe9];
				v15[safeIndex(868, v15.Length)] := -f7 * p0;
				v15[safeIndex(868, v15.Length)] := fm0(globalState);
				globalState.f2 := true;
			}
		...
		for i2 := |(seq(abs(0x28), i3  => (f3)))| to safeModuloInt(0x152, f3) {
			var v17: array<string> := new string[20](i4 => "kjyvte" + "ydnlt");
			var v18 := "wjj";
			v17[safeIndex(329, v17.Length)] := v18;
			v17[safeIndex(329, v17.Length)] := "hyb";
			var v19: array<int> := new int[20](i5 => i5 * |[f4]|);
			v19[safeIndex(812, v19.Length)] := i2;
			v19[safeIndex(812, v19.Length)] := f3;
			r0 := fm0(globalState);
			var v20: array<char> := new char[17];
			var v21 := 'u';
			v20[safeIndex(584, v20.Length)] := v21;
			var v22: map<bool, bool> := map[f4 := f4];
			var v23: seq<map<bool, bool>> := [v22];
			var v24: seq<set<D0>> := [fm21(v23, globalState)];
			var v25: seq<bool> := [f4];
			var v26: seq<int> := [|v25|];
			globalState.f2, v20[safeIndex(584, v20.Length)], v19[safeIndex(812, v19.Length)] := f4, v21, |v24[safeIndex(safeDivisionInt(f7, |v26|), |v24|)]|;
		}
		var v27 := "s";
		v27 := v27 + (v27 + "asujtxoi");
		var v28: map<int, int> := map[|v27| := 235];
		var v29: seq<map<int, int>> := [v28, map[f3 := |v27|], v28];
		for i6 := safeDivisionInt(f7, 357) to f3 + |v29| {
			...
			if (fm2(f3, globalState)) {
				...
				var v34 := 'r';
				v33[safeIndex(463, v33.Length)] := v34;
				v32, globalState.f1, f4, f4, v33[safeIndex(463, v33.Length)] := v32, safeModuloInt(fm0(globalState), i6), f4, !f4, v34;
				...
				var v39: multiset<char> := multiset{v33[safeIndex(463, v33.Length)]};
				var v40 := DC2(v39, f4);
				...
				v46[safeIndex(612, v46.Length)] := v27 + (seq(abs(0x3ac), i9  => (v45)));
				var v47 := DC5(i6);
				var v48: map<D1, int> := map[v47 := 0xdc];
				var v49: map<bool, bool> := map[f4 := f4];
				var v50: map<map<bool, bool>, int> := map[v49 := i6];
				globalState.f1, v46[safeIndex(612, v46.Length)] := if (v47 in v48) then v48[v47] else |v50|, fm20(f3, globalState);
			}
			...
			decreases 100 - i10
		{
			...
			var v55 := 'f';
			v27, v53, v28, v51 := if ((if (fm2(f7, globalState)) then v52.fm5(p0, f7, v55, v52.f10, globalState) else f4) in v54) then v54[if (fm2(f7, globalState)) then v52.fm5(p0, f7, v55, v52.f10, globalState) else f4] else v27, v53, v29[safeIndex(p0, |v29|)] + v28, if (f4) then v51 else v51;
			var v56: seq<bool> := [v52.f10, f4];
			var v57: array<seq<bool>> := new seq<bool>[4] [v56, v56 + [v52.f10], v56, v56];
			v57[safeIndex(598, v57.Length)] := v56;
			var v58: array<int> := new int[27];
			var v59: set<string> := {"vfxj"};
			v58[safeIndex(910, v58.Length)] := f3 * |v59|;
			var v60: seq<set<int>> := [v53, v53];
			var v61: map<array<bool>, char> := map[v51 := v55];
			v57[safeIndex(598, v57.Length)], globalState.f1, v58[safeIndex(910, v58.Length)], v53 := v56, |(v60 + v60)|, |v61|, {p0, p0} * v53;
			globalState.f1 := f3;
		}
		var v62: set<bool> := {!f4};
		var i11 := 0;
			...
			decreases 100 - i11
		{
			...
			v64[safeIndex(441, v64.Length)] := v63;
			var v65: array<map<int, string>> := new map<int, string>[1](i12 => map[f7 := v27]);
			var v66 := DC20(map[f3 := "tfjfsyru"]);
			v65[safeIndex(196, v65.Length)] := v66.cf27;
			var v67 := 'y';
			var v68: map<int, string> := map[-p0 := v27];
			v64[safeIndex(441, v64.Length)], v65[safeIndex(196, v65.Length)], globalState.f1, v67 := v63, v68, f3, v67;
			r0 := fm0(globalState);
			var v69: array<bool> := new bool[16](i13 => f4);
			var v70: map<bool, bool> := map[f4 := f4];
			v69[safeIndex(813, v69.Length)] := if (f4 in v70) then v70[f4] else f4;
			v69[safeIndex(813, v69.Length)] := v67 !in (seq(abs(-39), i14  => (v67)));
			var v71 := DC3();
			match (v71) {
				case DC1(cf1, cf2, cf3, cf4) =>
					v63[safeIndex(193, v63.Length)] := |"cnff"|;
					v63[safeIndex(193, v63.Length)], v69[safeIndex(813, v69.Length)], globalState.f2 := |((seq(abs(0x38d), i15  => ('t'))) + ("hmi")[safeIndex(f7, |"hmi"|) := v67])|, v69[safeIndex(813, v69.Length)], v69[safeIndex(813, v69.Length)];
					var v72: seq<bool> := [-(if (p0 in v28) then v28[p0] else p0) <= v63[safeIndex(193, v63.Length)], !cf2];
					v69[safeIndex(813, v69.Length)] := v72[safeIndex(-(p0 - f3), |v72|)];
					var v73 := DC17(fm1(v67, cf2, globalState));
					var v74 := DC14(map[cf2 := multiset(v73.cf23)]);
					v74 := v74;
					v69[safeIndex(813, v69.Length)] := false;
				case DC2(cf5, cf6) =>
					v69[safeIndex(813, v69.Length)] := !(|v27| < f3);
					globalState.f2 := cf6 <== v69[safeIndex(813, v69.Length)];
					v27 := v27;
					var v75: seq<bool> := [if (v69[safeIndex(813, v69.Length)]) then f4 else v69[safeIndex(813, v69.Length)]];
					var v76: seq<seq<bool>> := [v75, v75, [f4], v75];
					var v77: multiset<int> := multiset{f3, |v75|};
					v75 := v76[safeIndex(-safeModuloInt(if (f7 in v77) then v77[f7] else p0, f3), |v76|)];
				case DC3() =>
					var v78: array<array<map<bool, char>>> := new array<map<bool, char>>[27];
					var v79: array<map<bool, char>> := new map<bool, char>[11];
					v78[safeIndex(158, v78.Length)] := v79;
					v78[safeIndex(158, v78.Length)], v67, v69[safeIndex(813, v69.Length)] := v79, v67, (v62 !! v62) && f4;
					var v80: map<string, array<bool>> := map[v27 := v69];
					v80 := v80[v27 + v27 := v69];
					var v81: seq<int> := [0x230];
					var v82: map<int, bool> := map[|v81| := v69[safeIndex(813, v69.Length)] <== v69[safeIndex(813, v69.Length)]];
					v82 := v82[f3 := v69[safeIndex(813, v69.Length)]];
					var v83: multiset<bool> := multiset{v69[safeIndex(813, v69.Length)], p0 != p0, v69[safeIndex(813, v69.Length)]};
					v83 := v83;
				case DC0(cf0) =>
					v27 := v27 + "uclqne";
					var v84 := DC8(v69);
					var v85: C0 := new C0(fm2(p0, globalState), v84.cf13);
					var v86: map<C0, bool> := map[v85 := v69[safeIndex(813, v69.Length)]];
					v86 := v86[v85 := false];
					var v87: multiset<char> := multiset{v67};
					var v88 := DC2(v87, v69[safeIndex(813, v69.Length)]);
					v85.f10 := (if (cf0) then v88 else v88).cf6;
					var v89: multiset<bool> := multiset{false, fm2(f7, globalState), v85.f10};
					var v90: seq<multiset<bool>> := [v89, v89, v89 + v89, v89[f4 := abs(-f7)] - v89, multiset{v85.f10} - v89];
					var v91: multiset<int> := multiset{p0};
					v90 := v90[safeIndex(if (p0 in v91) then v91[p0] else f3, |v90|) := v89];
				case DC4(cf7) =>
					var v92: seq<bool> := [!false];
					globalState.f2 := f4 || (v69[safeIndex(813, v69.Length)] !in v92);
					var v93: seq<int> := [|{f7, f7}|];
					v69[safeIndex(813, v69.Length)] := 563 < v93[safeIndex(f7, |v93|)];
					globalState.f2 := v69[safeIndex(813, v69.Length)];
					v69[safeIndex(813, v69.Length)] := f4;
			}
...
class C2 extends T0 {
	...
	method m6(p0: array<seq<bool>>, p1: int, p2: int, globalState: GlobalState) {
		if (f4) {
			...
			if (true) {
				...
				f15[safeIndex(460, f15.Length)] := p1;
				f15[safeIndex(460, f15.Length)] := f3;
				var v3 := "di";
				...
				f15[safeIndex(460, f15.Length)], globalState.f1, v2.f10 := if ((if (v1.f10) then 0x1b3 else -f14) in v6) then v6[if (v1.f10) then 0x1b3 else -f14] else p1, safeDivisionInt(f14, -p2 * p2), v7 > (v7 * v7);
			} else {
				var v8: seq<int> := [-723, f14, f3, p2, f3];
				globalState.f1 := v8[safeIndex(p2, |v8|)];
				globalState.f1 := p1;
				var v9: array<bool> := new bool[2];
				v9[safeIndex(116, v9.Length)] := f4;
				v9[safeIndex(116, v9.Length)] := f4;
				var v10: map<bool, int> := map[v9[safeIndex(116, v9.Length)] := f3];
				globalState.f1 := |(if (v9[safeIndex(116, v9.Length)]) then v10 else v10)|;
			...
			v12[safeIndex(404, v12.Length)] := v14;
			v12[safeIndex(404, v12.Length)] := multiset{v13};
			globalState.f2 := false;
		} else {
			var v15: array<multiset<int>> := new multiset<int>[11];
			var v16: multiset<int> := multiset{-f14};
			v15[safeIndex(319, v15.Length)] := v16;
			var v17 := 'f';
			var v18: map<bool, char> := map[f4 := v17];
			v15[safeIndex(319, v15.Length)] := v16 + multiset{|v18|};
			...
			v19[safeIndex(931, v19.Length)] := v21;
			var v22 := DC14(v21);
			v19[safeIndex(931, v19.Length)] := (if (f4) then v22 else v22).cf20;
			globalState.f2 := !f4;
			var v23 := "arajbrv";
			if (v23 < v23) {
				...
				v25[safeIndex(325, v25.Length)] := v24;
				v25[safeIndex(325, v25.Length)], globalState.f2 := v24, fm2(f14 + p1, globalState);
				globalState.f1 := p2 * p2;
				v15[safeIndex(319, v15.Length)], globalState.f2 := v15[safeIndex(319, v15.Length)], f4;
				v23 := v23;
				var v26: set<bool> := {v16 > v15[safeIndex(319, v15.Length)], f4, f4, f4};
				var v27: seq<set<bool>> := [v26];
				var v28: seq<int> := [p2, p2];
				v26 := v27[safeIndex(|v28|, |v27|)];
			} else {
				...
				v31 := v31[p1 := f4];
				globalState.f1 := safeDivisionInt(safeDivisionInt(f14, f14), f14);
				var v32: array<D5> := new D5[4](i4 => DC16(DC16(DC16(DC16(DC14(v21[f4 := multiset{f4, f4}]))))));
				f15[safeIndex(114, f15.Length)] := |v20|;
				v32, globalState.f2, globalState.f2, globalState.f1, f15[safeIndex(114, f15.Length)] := v32, f4 <== f4, f4, safeModuloInt(f14, p1), -f14 + (f14 - p1);
			...
			decreases 100 - i6
		{
			...
			v38[safeIndex(909, v38.Length)] := v39;
			var v40: seq<bool> := [if (f4) then f4 else f4, false, f4, f4];
			v39[safeIndex(221, v39.Length)] := f4;
			v38[safeIndex(909, v38.Length)], v40, v39[safeIndex(221, v39.Length)] := v39, v40, p1 == f3;
			var v41: map<bool, int> := map[v39[safeIndex(221, v39.Length)] := f3];
			var v42: multiset<int> := multiset{850};
			var v43: multiset<bool> := multiset{false, v39[safeIndex(221, v39.Length)]};
			var v44: map<int, bool> := map[|v35| := f4];
			var v45: map<int, int> := map[f14 := |v44|];
			var v46: array<int> := new int[25] [safeModuloInt(p1, f3), |v41| + 0x2b0, p1, p1 * f3, f14 * f14, fm0(globalState), safeModuloInt(f3, f3), p2 - -0x184, -f14, DC5(fm0(globalState)).cf8 - p1, if (p2 in v42) then v42[p2] else f14, f14, f14, p2, p2, p2, f3, p2, p1, p1, f3, p1, if (v39[safeIndex(221, v39.Length)] in v43) then v43[v39[safeIndex(221, v39.Length)]] else |v45|, f3, -0x1b8];
			var v47: array<T1> := new T1[19];
			var v48 := DC22(v44);
			var v49: T1 := new C1(f3, |v48.cf31|, false);
			v47[safeIndex(327, v47.Length)] := v49;
			var v50: map<map<int, int>, array<int>> := map[v45[p2 := f3] := v46];
			f4, globalState.f1, v46, v47[safeIndex(327, v47.Length)], globalState.f1 := v39[safeIndex(221, v39.Length)], p1, if ((fm23(globalState))[v49.f7 := -v49.f7] in v50) then v50[(fm23(globalState))[v49.f7 := -v49.f7]] else v46, v49, v49.f3;
			var v51: array<char> := new char[17] [v34, v34, v34, v34, v34, v34, v34, v34, if (f4) then 'k' else v34, v34, v34, v34, v34, v34, v34, v34, v34];
			v51[safeIndex(317, v51.Length)] := v34;
			var v52: map<int, char> := map[safeModuloInt(p1, p1) := 'n'];
			v51[safeIndex(317, v51.Length)] := if (693 in v52) then v52[693] else 'g';
		}
		...
		v56 := v56[DC2(v58, f4).cf6 := safeDivisionInt(f3, f3)];
		if (f4 <== (f4 || true)) {
			...
			f15[safeIndex(271, f15.Length)] := if (f3 in v61) then v61[f3] else -f3;
			var v62: set<bool> := {f4};
			f15[safeIndex(271, f15.Length)] := p1 + |(v62 + v62)|;
			v54 := v54;
			var v63: seq<int> := [p1, p2];
			globalState.f1 := |(v63 + ((seq(abs(0xde), i9  => (p2))) + v63)[safeIndex(f15[safeIndex(271, f15.Length)], |((seq(abs(0xde), i9  => (p2))) + v63)|) := p1])|;
		} else {
			var v64: map<seq<bool>, int> := map[v54 := f3];
			globalState.f1 := if ((v54 + v54)[safeIndex(fm0(globalState), |(v54 + v54)|) := true] in v64) then v64[(v54 + v54)[safeIndex(fm0(globalState), |(v54 + v54)|) := true]] else p1;
	...
	method m7(p0: int, p1: array<array<bool>>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		for i0 := f14 to fm0(globalState) {
			...
			match (fm25(if (f4) then fm2(-606, globalState) else f4, globalState)) {
				case DC1(cf1, cf2, cf3, cf4) =>
					...
					var v13: array<bool> := new bool[14] [f4, f4, if (fm2(f3, globalState) in v6) then v6[fm2(f3, globalState)] else f4, fm20(|(if (fm2(p0, globalState) in v8) then v8[fm2(p0, globalState)] else v9[safeIndex(i0, |v9|)])|, globalState) < v10, f4 || fm2(|v12|, globalState), false, cf2, !f4, f14 < i0, if (cf2) then cf1 else cf2, if (cf2 in v6) then v6[cf2] else cf2, !f4, f4, fm0(globalState) != p0];
					var v14: multiset<multiset<bool>> := multiset{v11, v11};
					v13[safeIndex(435, v13.Length)] := v14 == multiset([v11]);
					v13[safeIndex(435, v13.Length)] := i0 < i0;
					var v15 := new C0(v13[safeIndex(435, v13.Length)], v13);
					f15[safeIndex(232, f15.Length)] := f3;
					cf4, f15[safeIndex(232, f15.Length)] := f15, -f14 - -f14;
				case DC2(cf5, cf6) =>
					var v16: array<array<int>> := new array<int>[18];
					v16[safeIndex(570, v16.Length)] := if (cf6) then f15 else f15;
					var v17: array<D8> := new D8[26];
					var v18 := DC23(false, cf6, f4, v2);
					var v19 := DC24(v18);
					v17[safeIndex(626, v17.Length)] := v19;
					var v20: multiset<int> := multiset{i0, f14};
					var v21: seq<bool> := [cf6, cf6];
					v16[safeIndex(570, v16.Length)], v17[safeIndex(626, v17.Length)], v20 := f15, fm26(globalState), v20[|v21| := abs(f3)];
				...
				case DC3() =>
					...
					v24 := v24[!(f4 <==> v25[safeIndex(i0, |v25|)]) := v26];
				...
				case DC0(cf0) =>
					...
					f15[safeIndex(586, f15.Length)] := f14;
					f15[safeIndex(586, f15.Length)] := f14;
					var v33: array<string> := new string[14];
					v33[safeIndex(836, v33.Length)] := v30;
					var v34: map<int, int> := map[f14 := f15[safeIndex(586, f15.Length)]];
					...
					var v41: map<multiset<map<bool, int>>, string> := map[v37[v36 := abs(f3)] := if (v39 in v40) then v40[v39] else "tpoiv"];
					v33[safeIndex(836, v33.Length)] := if (v37 in v41) then v41[v37] else v30;
					v0 := seq(abs(0x4), i1  => (f3));
				case DC4(cf7) =>
					...
					v49 := v50[safeIndex(p0, |v50|)] + v49;
			}
			
			var v52 := DC20(map v51 : int | (353 <= v51) && (v51 < 82) :: (safeModuloInt(v51, p0)) := ("xoulfc"));
			match (v52) {
				case DC21(cf28, cf29, cf30) =>
					f4 := cf29;
					var v53: map<int, bool> := map[p0 := true];
					f15[safeIndex(354, f15.Length)] := p0 + |v53|;
					...
					p1[safeIndex(686, p1.Length)] := v57[safeIndex(f3, |v57|)];
					globalState.f1, globalState.f2, f15[safeIndex(354, f15.Length)], v56, p1[safeIndex(686, p1.Length)] := -0xa3, if (fm2(f3, globalState)) then fm2(i0, globalState) else true, p0, v56, cf28;
					f15[safeIndex(354, f15.Length)] := safeDivisionInt(fm0(globalState), if (cf29) then f15[safeIndex(354, f15.Length)] else f14);
					var v58 := new C0(cf30, p1[safeIndex(686, p1.Length)]);
				case DC20(cf27) =>
					...
					v64[safeIndex(330, v64.Length)] := f4;
					v64[safeIndex(330, v64.Length)] := f4;
					v64 := v64;
			}
		...
		r0 := p0 * f14;
		globalState.f2 := f4;
		r0 := if (906 < p0) then f14 else safeDivisionInt(f14, -f3);
		r1 := fm2(safeModuloInt(f14, p0), globalState);
	}
}
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			if (f4) {
				...
				var v6: seq<int> := [f3];
				var v7 := new C0(|(fm15(!v5.f10, f3, |v6|, globalState))[safeIndex(p0, |fm15(!v5.f10, f3, |v6|, globalState)|) := f12]| == p0, v5.f11);
				var v8 := DC11(v0);
				var v9 := DC11(v8.cf18);
				v0 := v8.cf18;
				...
				r0, v11, globalState.f1, v10, v6 := safeDivisionInt(f3, |v13| - p0), v11 - v11, f7, v10, v6;
			} else {
				var v14: array<char> := new char[7] [f12, f12, f12, f12, f12, f12, f12];
				var v15: seq<array<char>> := [v14];
				var v16: multiset<int> := multiset{f3};
				var v17: array<array<char>> := new array<char>[13] [v14, v14, v14, v15[safeIndex(|v16|, |v15|)], v14, v15[safeIndex(f7, |v15|)], v14, v14, v14, v14, v14, v14, v14];
				v17[safeIndex(448, v17.Length)] := v14;
				var v18 := DC9(v14);
				v17[safeIndex(448, v17.Length)], globalState.f2 := v18.cf14, f4 || f4;
				var v19: array<bool> := new bool[11];
				v19[safeIndex(379, v19.Length)] := f4;
				var v20: seq<int> := [p0];
				var v21 := DC5(f7);
				var v22: map<D1, int> := map[v21 := f3];
				var v23 := DC5(if (v21 in v22) then v22[v21] else f7);
				var v24: seq<bool> := [f4, f4, f4];
				var v25: map<bool, int> := map[v24[safeIndex(p0, |v24|)] := p0];
				var v26: map<int, map<bool, int>> := map[f3 := v25];
				var v27: array<int> := new int[21] [f7, f3, f7, f3, p0, f7 - |v20|, p0, f7 - 166, f7, v21.cf8, fm0(globalState), -367, 407 * f3, |v26|, safeModuloInt(DC5(f7).cf8, p0), -0x110, p0, safeModuloInt(|v24|, f3), f7, safeModuloInt(f7, f7), f3];
				v19[safeIndex(379, v19.Length)], v27 := f4, v27;
				var v28 := new C0(v19[safeIndex(379, v19.Length)], v19);
				globalState.f1 := p0;
				var v29: array<set<int>> := new set<int>[2](i2 => v0);
				var v30: array<D3> := new D3[3];
				var v31 := DC10(-p0, v28.f11, f7);
				v30[safeIndex(84, v30.Length)] := v31;
				var v32: seq<string> := [f13];
				var v33: multiset<string> := multiset{f13, f13};
				v29, v19[safeIndex(379, v19.Length)], globalState.f2, v30[safeIndex(84, v30.Length)] := v29, f7 >= |(if (true) then multiset(v32) else v33)|, p0 == safeModuloInt(p0, f7), v31.(cf16 := v19, cf15 := 0x3e5 + f3);
			}
			
			var v34: array<int> := new int[25];
			v34[safeIndex(57, v34.Length)] := p0;
			v34[safeIndex(57, v34.Length)] := f7;
		}
		var i3 := 0;
		while (f4)
			decreases 100 - i3
		{
			...
			v38[safeIndex(436, v38.Length)] := !f4;
			var v39: map<int, int> := map[0x222 := f3];
			v38[safeIndex(436, v38.Length)] := f7 == |v39|;
		...
		globalState.f1, globalState.f2, globalState.f1 := fm12(fm2(|v0|, globalState), f4, globalState), match v41 {
			...
			case DC7() => f4
			case DC5(cf8) => |(seq(abs(0x12c), i4  => (cf8)))| in multiset{f3}
		}, (p0 - |f13|) * f3;
		var v42: map<multiset<bool>, int> := map[v2 := f7];
		r0 := safeModuloInt(safeDivisionInt(if (multiset([f4]) in v42) then v42[multiset([f4])] else f3, |v0|), f3);
	}
	method m5(globalState: GlobalState) {
		for i0 := f7 to safeDivisionInt(f7, f3) {
			var v0: array<bool> := new bool[25];
			var v1 := new C0(!(-f7 < |(seq(abs(591), i1  => (f12)))|), v0);
			globalState.f1 := f3;
		...
		match (v7) {
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				v8[safeIndex(967, v8.Length)] := cf2;
				var v9: seq<array<int>> := [v6];
				var v10: multiset<array<int>> := multiset{v9[safeIndex(f3, |v9|)]};
				var v11: map<bool, int> := map[!cf2 := |f13[safeIndex(-|v10|, |f13|) := f12]|];
				v8[safeIndex(967, v8.Length)], v11 := cf1, v11;
				globalState.f2 := f7 <= (f7 - f7);
				v8[safeIndex(967, v8.Length)] := cf2;
			case DC2(cf5, cf6) =>
				var v12: seq<bool> := [cf6, cf6];
				var v13: seq<seq<bool>> := [[f4], v12[safeIndex(f7, |v12|) := f4], v12, v12];
				var v14 := DC1(false, f4, f12, v6);
				var v15: map<seq<bool>, string> := map[v13[safeIndex(|fm15(cf6, -f3, |f13|, globalState)|, |v13|)] := f13 + f13[safeIndex(-f3, |f13|) := v14.cf3]];
				v15 := v15;
				f4 := cf6;
				...
				globalState.f1 := |v20[safeIndex(f7, |v20|)]| + f3;
			case DC3() =>
				var v21: array<char> := new char[25];
				var v22 := DC9(v21);
				var v23: seq<D3> := [v22, v22, v22, v22];
				var v24: array<seq<D3>> := new seq<D3>[29] [v23, [v22], v23, v23 + v23, [v22, v22, v22], v23, v23, v23, v23, v23, (v23 + v23)[safeIndex(f7, |(v23 + v23)|) := v22], [v22], v23, v23, v23, v23, [v22, v22], v23, [v22], v23, v23 + v23, [v22], [v22, v22], v23 + v23, v23, [DC9(v21)], [v22, DC9(v21), v22], v23, v23];
				v24[safeIndex(83, v24.Length)] := v23;
				v24[safeIndex(83, v24.Length)] := if (f4) then v23 else v23 + v23;
				...
				var v36: array<bool> := new bool[22] [f4, f4, f4, f4, f4 && true, f4, v27[safeIndex(f7, |v27|)], f7 !in v28, f4, f4, f4, |fm14(f4, f4, globalState)| == -524, f4, -900 >= -434, (set v29 : char | v29 in f13 :: (v29)) >= fm18(v31, DC6(v32, fm20(|v33|, globalState), f4, v32.f4).cf11, v32.f4, globalState), v32.f4, v32.f4, v34.cf32, v32.f4, f4, if (f4 in v35) then v35[f4] else f4, f4];
				var v37: map<bool, string> := map[f4 := f13];
				v36[safeIndex(521, v36.Length)] := |v37| >= |v33|;
				var v38: seq<int> := [|"kmrehf"|];
				globalState.f1, v26, v36[safeIndex(521, v36.Length)] := (if (v34.cf32) then f7 else 0x384) * |fm27(globalState)|, v26[safeIndex(v32.f3, |v26|) := v25], f13[safeIndex(v32.f3, |f13|)] in fm15(f4, 0x13e, -|v38|, globalState);
				f4 := fm13(globalState);
				var v39 := 'l';
				v39 := f12;
			case DC0(cf0) =>
				...
				if (fm13(globalState)) {
					...
					var v49: seq<int> := [|"h"|];
					v48, globalState.f1, globalState.f1, globalState.f1 := if (v49 != v49) then v48 else v48, v45.f14, safeDivisionInt(v45.f14, f7), 0x80;
					f13 := f13 + (seq(abs(0x293), i4  => (f12)));
				} else {
					var v50: seq<bool> := [!cf0, cf0];
					globalState.f2 := v50[safeIndex(|f13|, |v50|)];
					var v51: set<bool> := {true};
					var v52 := DC25(v51);
					v51, globalState.f2 := v52.cf37 - v51, fm13(globalState) || f4;
					v40[safeIndex(555, v40.Length)] := !cf0;
					...
					v40[safeIndex(555, v40.Length)] := f4 <== !(v53 !! multiset([|v54|, |v55|]));
					globalState.f1 := f3;
					globalState.f2 := f4;
				}
				
				v40[safeIndex(283, v40.Length)] := fm0(globalState) > |"mibpnhp"|;
				var v56: multiset<int> := multiset{f3, f3, f7, f7};
				v40[safeIndex(283, v40.Length)] := v56 !! v56;
				v6[safeIndex(216, v6.Length)] := safeModuloInt(f3, f7);
				var v57: map<int, multiset<int>> := map[f7 := v56];
				v6[safeIndex(216, v6.Length)] := |(v57 + v57)|;
			case DC4(cf7) =>
				...
				v63[safeIndex(513, v63.Length)] := f4;
				v63[safeIndex(513, v63.Length)] := if (if (f4) then false else !f4) then !(!true && f4) else f4;
		}
		...
		for i5 := f7 to -f3 {
			...
			var v68 := DC19(|v67|);
			v66[safeIndex(13, v66.Length)] := v68;
			v66[safeIndex(13, v66.Length)] := v68.(cf26 := i5);
			var v69: map<map<seq<int>, string>, int> := map[fm28(!f4, f3, f4, globalState) := f3];
			var v70: seq<int> := [-f7];
			var v71: map<seq<int>, string> := map[v70 := seq(abs(-0x2f0), i6  => (v64))];
			v69 := v69[DC28(v71).cf41 := i5];
			globalState.f2 := (i5 >= f7) ==> f4;
			var v72: array<bool> := new bool[3](i7 => f4);
			v72[safeIndex(363, v72.Length)] := f4;
			v72[safeIndex(363, v72.Length)] := f4;
		}
		var v73 := DC3();
		match (v73) {
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				f13 := ("ymicw" + f13)[safeIndex(|v75|, |("ymicw" + f13)|) := v64];
				v6[safeIndex(829, v6.Length)] := if (cf2) then f3 else 476;
				var v76: array<bool> := new bool[1](i8 => cf1);
				v76[safeIndex(613, v76.Length)] := f4;
				var v77: seq<bool> := [!true];
				f4, v6[safeIndex(829, v6.Length)], f4, v76[safeIndex(613, v76.Length)], globalState.f2 := v77[safeIndex(-f3, |v77|)] ==> cf2, 0x34, ("dcb" + f13) == f13, !v77[safeIndex(safeDivisionInt(|"athho"|, f3), |v77|)], cf2;
			case DC2(cf5, cf6) =>
				globalState.f1 := safeDivisionInt(f3, f3);
				f4 := |(f13 + f13)| != f3;
				var v78: array<bool> := new bool[23];
				var v79 := new C0(!cf6, v78);
				v78[safeIndex(624, v78.Length)] := cf6;
				v78[safeIndex(624, v78.Length)] := (seq(abs(0x2d8), i9  => (v64))) == f13;
			case DC3() =>
				globalState.f1 := -f3;
				...
				var v83: multiset<bool> := multiset{v82[safeIndex(f3, |v82|)], f4};
				globalState.f1 := safeModuloInt(-|(v83 - v83)|, f3);
...
class C4 extends T1, T0 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: int) {
		...
		for i1 := f7 to 0x3cc {
			...
			v3[safeIndex(549, v3.Length)] := v4 + v4;
			var v5: map<int, set<array<int>>> := map[-fm0(globalState) := v2];
			globalState.f2, v2, v3[safeIndex(549, v3.Length)] := f4, if (p0 in v5) then v5[p0] else v2, v4;
			var v6 := "g";
			globalState.f1 := -|(v6 + (seq(abs(-923), i2  => ('k'))))|;
			var v7 := new C0("dmaqyb" == (seq(abs(0x1e6), i3  => ('d'))), v0);
			var v8: multiset<int> := multiset{i1};
			var v9 := 'a';
			var v10: multiset<char> := multiset{v9};
			var v11 := DC2(v10, v7.f10);
			var v12: map<D0, bool> := map[v11 := v0[safeIndex(80, v0.Length)]];
			if (v8 !! fm6(if (DC2(v10, true).(cf5 := v10) in v12) then v12[DC2(v10, true).(cf5 := v10)] else f4, v0[safeIndex(80, v0.Length)], globalState)) {
				...
				globalState.f1 := safeModuloInt(f7, p0);
				var v19: map<bool, int> := map[v7.f10 := f7];
				v1[safeIndex(696, v1.Length)] := |v19|;
				var v20 := DC7();
				var v21: map<D1, bool> := map[DC7() := f4];
				var v22: multiset<bool> := multiset{f4, v7.f10, v7.f10};
				globalState.f2, globalState.f1, globalState.f2, v1[safeIndex(696, v1.Length)] := !v7.f10, f7, v20 in v21, (|v6| * |v22|) - f7;
				var v23 := new C0(f4 || f4, v7.f11);
				var v24 := DC3();
				v24 := v24;
			} else {
				globalState.f2 := v0[safeIndex(80, v0.Length)];
				globalState.f1 := f7;
				var v25: map<bool, bool> := map[v7.f10 := !f4];
				v1[safeIndex(950, v1.Length)] := i1 * f7;
				f4, v25, globalState.f1, v1[safeIndex(950, v1.Length)] := v7.f10, v25, |(set v26 : int | (0x95 <= v26) && (v26 < 0x35d) :: (safeModuloInt(v26, i1)))|, -(safeDivisionInt(p0, f3) * fm0(globalState));
				var v27 := DC0(v7.f10);
		...
		var v28: seq<int> := [0xe7, -|{v0[safeIndex(80, v0.Length)], f4}|];
		r0 := v28[safeIndex(p0 - f3, |v28|)];
		var v29 := DC8(v0);
		var v30: seq<array<bool>> := [v29.cf13];
		var v31: array<array<bool>> := new array<bool>[19] [v0, if (v0[safeIndex(80, v0.Length)]) then v0 else v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v30[safeIndex(-p0, |v30|)], if (v0[safeIndex(80, v0.Length)]) then v0 else v0, v0];
		v31[safeIndex(203, v31.Length)] := v0;
		v31[safeIndex(203, v31.Length)] := v0;
		var v32 := new C0(v0[safeIndex(80, v0.Length)], v30[safeIndex(0x397, |v30|)]);
		var v33 := DC0(v32.f10);
		r0 := -match v33 {
			case DC1(cf1, cf2, cf3, cf4) => p0 + |map[v0[safeIndex(80, v0.Length)] := true]|
			case DC2(cf5, cf6) => f7
			case DC3() => 0x1e0
			case DC0(cf0) => f7
			case DC4(cf7) => f7
	...
	method m4(p0: string, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v8: array<array<char>> := new array<char>[22] [v2, v2, v2, v2, if (f4) then v2 else v2, v2, v2, v3[safeIndex(|fm9(p0[safeIndex(|v4|, |p0|)], f4, globalState)|, |v3|)], v3[safeIndex(|v5|, |v3|)], v6.cf14, v2, v2, v2, v2, v2, v2, v2, v2, if (f4) then if (f3 in v7) then v7[f3] else v2 else v2, v2, v2, v2];
			v8 := v8;
			globalState.f1 := f7 - |([f3])[safeIndex(|fm10(f4, f4, f3, map[f4 := p0], globalState)|, |[f3]|) := 730]|;
			f4 := !f4;
			if (!true) {
				globalState.f2 := false;
				globalState.f1 := -safeModuloInt(safeDivisionInt(-0x3c4, f3), f3);
				globalState.f2 := f4;
				f4 := false;
				globalState.f2 := true;
			} else {
				...
				v10[safeIndex(52, v10.Length)] := f4;
				v10[safeIndex(52, v10.Length)] := f4;
				var v11: set<int> := {f7};
				...
				globalState.f1 := if (v13 != [|(if (f4 in v17) then v17[f4] else "eu")|]) then -f3 else safeDivisionInt(122, -f3);
		...
		if (if (|v22| in v20) then v20[|v22|] else f4) {
			...
			v28[safeIndex(657, v28.Length)] := fm0(globalState);
			...
			v28[safeIndex(657, v28.Length)] := |(if (v30[safeIndex(f3, |v30|)] != (fm11(f7, globalState))[f3 := f7]) then v35 else v35)[safeIndex(-(if (v33.f10) then f3 else f7), |(if (v30[safeIndex(f3, |v30|)] != (fm11(f7, globalState))[f3 := f7]) then v35 else v35)|) := v34]|;
			...
			v38[safeIndex(856, v38.Length)] := v39 + v39;
			var v40 := DC7();
			v28[safeIndex(657, v28.Length)], v37, v38[safeIndex(856, v38.Length)], v40 := f7 - f7, v37, v39, v40;
			var v41 := DC20(map[v28[safeIndex(657, v28.Length)] := p0]);
			...
			if ([p0, p0, p0, "gjq"] < v44) {
				...
				var v46: map<multiset<array<int>>, int> := map[v45 := v28[safeIndex(657, v28.Length)]];
				...
				var v50: map<int, multiset<map<bool, bool>>> := map[safeModuloInt(f3, v28[safeIndex(657, v28.Length)]) := v49];
				v50 := v50[-v37.f3 := v49];
				v33.f11[safeIndex(986, v33.f11.Length)] := f4;
				globalState.f2, v33.f11[safeIndex(986, v33.f11.Length)] := v37.f4, v37.f3 >= v37.f3;
...
class C5 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: int) {
		...
		v0, v1, globalState.f1 := v2[safeIndex(|multiset{p0, f3, f3}|, |v2|)], v1, (if (f4) then p0 else f7) * p0;
		...
		f4 := f4;
		var v28: array<int> := new int[9](i4 => safeModuloInt(i4, 0x1c5));
		var v29: set<int> := {f3};
		var v30 := "hnjykaw";
		v28 := new int[8] [p0, p0, p0, f7, safeDivisionInt(|v29|, |v30|), f3 * f3, 0x147, f7];
	...
	method m2(p0: bool, p1: array<int>, p2: map<bool, bool>, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: char, r2: map<array<bool>, char>, r3: bool) {
		...
		forall i0 | 0 <= i0 < v3.Length {
			v3[i0] := v0[safeIndex(|map[f7 := p3]|, |v0|)];
		}
		var v4 := "lgks";
		var v5 := 'f';
		var v6: T0 := new C3(v5, v4, f7, f4, f3);
		var v7 := DC6(v6, v4, v6.f4, p3);
		v4, v4 := v4, v7.cf10 + ("uuopatwnv")[safeIndex(0x348, |"uuopatwnv"|) := v5];
			...
			decreases 100 - i2
		{
			...
			var v12 := DC34(v10);
			var v13: array<array<map<D4, int>>> := new array<map<D4, int>>[24] [v10, v10, v10, v10, v11[safeIndex(v6.f3, |v11|)], v10, if (v6.f4) then v10 else v10, v10, v10, v10, v10, v10, v10, v10, v10, v10, DC34(v10).cf55, v10, v12.cf55, v10, v10, v10, v10, v10];
			v13[safeIndex(69, v13.Length)] := v10;
			v3[safeIndex(745, v3.Length)] := p3;
			var v14: multiset<int> := multiset{f3, -f7};
			v9, v13[safeIndex(69, v13.Length)], v3[safeIndex(745, v3.Length)], v6.f4 := v9.(cf31 := v8[v6.f3 := f4]), v10, !(|v14| == (if (v6.f4) then f7 else fm0(globalState))), if (p3) then p3 else p3;
			v4 := "ncpxl";
			var v15: seq<map<bool, bool>> := [p2];
			var v16 := DC38(v15);
			v3[safeIndex(745, v3.Length)] := v16.cf68 <= [p2];
		...
		globalState.f1 := |(match v23.(cf41 := v22) {
			...
			case DC28(cf41) => seq(abs(894), i3  => (v5))
		})|;
	...
	method m3(p0: map<bool, int>, p1: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: string, r3: int) {
		for i0 := -f3 to fm0(globalState) {
			...
			var v1: seq<bool> := [f4];
			var v2 := "epm";
			var v3: seq<bool> := [true, v1[safeIndex(|v2|, |v1|)]];
			v1 := v1;
			...
			v6[safeIndex(468, v6.Length)] := f3 * f3;
			globalState.f1, r0, v6[safeIndex(468, v6.Length)] := fm0(globalState), v4 <= {f4}, -(i0 - p1);
		}
		for i2 := p1 to f3 {
			f9[safeIndex(104, f9.Length)] := |"hpexysybx"| <= f7;
			var v7: multiset<bool> := multiset{f4, f4, f4};
			var v8: map<int, bool> := map[safeModuloInt(f7, f7) := fm2(i2, globalState)];
			var v9 := "he";
			f9[safeIndex(104, f9.Length)], r1, globalState.f2, globalState.f1, r3 := fm14(f4, false, globalState) >= v7, f7, if (f7 in v8) then v8[f7] else !f4, f7 * |v9|, (if (f4) then f7 else p1) - -f3;
			var v10: array<array<bool>> := new array<bool>[2];
			var v11 := DC18(f9[safeIndex(104, f9.Length)], |v9|);
			var v12: array<bool> := new bool[5] [f9[safeIndex(104, f9.Length)], f4, f4, v11.cf24, !fm2(p1, globalState)];
			v10[safeIndex(923, v10.Length)] := v12;
			var v13: seq<bool> := [true, f9[safeIndex(104, f9.Length)], f9[safeIndex(104, f9.Length)], !f9[safeIndex(104, f9.Length)]];
			var v14 := DC35(v12, f4, v13, "tgykad", p1);
			v10[safeIndex(923, v10.Length)] := v14.cf56;
			r1 := safeDivisionInt(safeModuloInt(f7, f3), -p1);
		...
		if ((if (f4) then DC20(v20) else v21) in (v22 + v22)) {
			...
			v29[safeIndex(652, v29.Length)] := v30;
			v29[safeIndex(652, v29.Length)] := v30;
			...
			v38 := (v38[-f3 := abs(p1)])[if (f4 in p0) then p0[f4] else p1 := abs(-(p1 - p1))];
			var v39 := 'o';
			var v40: map<string, int> := map[v36[safeIndex(p1, |v36|) := v39] := f7];
		...
		var v43: seq<bool> := [f4];
		globalState.f1 := if (v43[safeIndex(f7, |v43|)]) then safeModuloInt(p1, |(seq(abs(-567), i3  => ('s')))|) else 0x2fa;
		...
		var v46 := "gtmwd";
		r1 := |v46|;
		r2 := fm15(f4, safeModuloInt(p1, f3), 639, globalState);
		r3 := -f3;
	}
}
...
class C6 extends T0, T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: int) {
		if (f4) {
			...
			var v2 := new C4(safeModuloInt(p0, |"qvoflbfav"|), f3 * f3, f4);
			...
			v7 := (if (f4) then v7 else (multiset{"oeofpknod", v6, "ou", v6})[v6 := abs(p0)]) - (v7 * (multiset(v8))[v6 := abs(p0)]);
			var v9: array<bool> := new bool[13];
			v9[safeIndex(608, v9.Length)] := f4;
			v9[safeIndex(608, v9.Length)] := f4;
			var v10 := 'o';
			v10 := v10;
			var v11: array<map<int, bool>> := new map<int, bool>[2];
			v11[safeIndex(690, v11.Length)] := map[p0 := v9[safeIndex(608, v9.Length)]];
			var v12: map<int, bool> := map[f3 := fm2(p0, globalState)];
			v11[safeIndex(690, v11.Length)] := v12 + v12;
			globalState.f1, v6, globalState.f2, v6, globalState.f2 := if (v9[safeIndex(608, v9.Length)]) then f3 else f7, (v6 + (seq(abs(588), i0  => (v10))))[safeIndex(safeModuloInt(f8, p0), |(v6 + (seq(abs(588), i0  => (v10))))|) := v10], v9[safeIndex(608, v9.Length)], fm20(f8, globalState) + v6, true;
		}
		...
		if (!(v15 !in (v16 + v16))) {
			...
			match (v19) {
				case DC12() =>
					var v20: array<int> := new int[15](i2 => safeModuloInt(i2, f3));
					v20[safeIndex(61, v20.Length)] := f7;
					v20[safeIndex(61, v20.Length)] := fm0(globalState);
					var v21 := new C2(safeModuloInt(f3, -0xf0), v20, f3, f4);
					globalState.f2 := f4;
					globalState.f1 := -0x2e5;
				case DC11(cf18) =>
					globalState.f1 := |"jacm"| - safeModuloInt(f8, f7);
					v15 := "cmeqw";
					var v22: set<bool> := {f4};
				...
				case DC13(cf19) =>
					...
					v31[safeIndex(5, v31.Length)] := p0;
					var v32 := 'j';
					v31[safeIndex(5, v31.Length)], globalState.f2 := safeModuloInt(-f8 + f7, -|fm9(v32, f4, globalState)|), !f4;
					v31[safeIndex(5, v31.Length)] := if (f4) then p0 else 819;
					var v33: seq<int> := [f3 - p0, f3, f8];
					var v34: seq<bool> := [f4];
					var v35: map<int, char> := map[f7 := v32];
					var v36: set<char> := {v32, if (v31[safeIndex(5, v31.Length)] in v35) then v35[v31[safeIndex(5, v31.Length)]] else 'k', v32};
					var v37: map<int, bool> := map[|v36| := f4];
					var v38: C1 := new C1(f3, |(seq(abs(542), i4  => (f8)))|, f4);
					...
					v33, v31[safeIndex(5, v31.Length)], globalState.f2, f4, globalState.f1 := v33[safeIndex(|(if (f4) then map[|v34| := f4] else v37)|, |v33|) := p0], if ((if (f4) then v38 else v38) in v40) then v40[if (f4) then v38 else v38] else safeModuloInt(p0, f8), v34[safeIndex(f3 + fm0(globalState), |v34|)], f4, v31[safeIndex(5, v31.Length)];
					v31 := v31;
			}
			...
			v51[safeIndex(958, v51.Length)] := |v52|;
			v51[safeIndex(958, v51.Length)] := safeDivisionInt(0x2e, f7);
			var v53: set<bool> := {f4};
			var v54: map<int, set<bool>> := map[f8 := v53];
			v51[safeIndex(958, v51.Length)] := |(((if (p0 in v54) then v54[p0] else v53) - v53) - v53)|;
		} else {
			var v55: seq<array<bool>> := [v14.f9, v14.f9, v14.f9];
			v55 := v55[safeIndex(f7, |v55|) := v14.f9] + (v55[safeIndex(p0, |v55|) := v13] + v55);
			var v56: map<bool, bool> := map[!f4 := f4];
			v56 := v56;
			var v57: seq<bool> := [f4, f4];
			var v58: set<seq<bool>> := {v57[safeIndex(f8, |v57|) := f4] + v57, v57, v57, v57};
		...
		var v68: array<int> := new int[24] [f3, p0, f8, 0x2b0, |v15|, |v63|, p0, f8, f7, f8, |v64|, fm0(globalState), |(seq(abs(0x33f), i6  => ('h')))|, |multiset(v65)|, |v66[p0 := p0]|, p0, v67.cf17, |fm31(globalState)|, f3, p0, f8, p0, f8, f3];
		...
		v62, v69, v65, globalState.f2, v71 := if (f4) then v62 else DC12(), v72[safeIndex(v70.f14, |v72|)], match v74 {
			case DC23(cf32, cf33, cf34, cf35) => v65[safeIndex(|multiset{DC0(cf34).cf0}|, |v65|) := f8]
			case DC22(cf31) => v65 + [-v70.f14, |multiset{f4}|]
			case DC24(cf36) => seq(abs(0x2d4), i7  => (|v15[safeIndex(v70.f14, |v15|) := v73]|))
		...
		var v78 := new C3(v73, seq(abs(-483), i8  => (v73)), |v15|, f4, |(v77[p0 := abs(p0)])[f8 := abs(-529)]|);
		r0 := v70.f14;
	}
}
...
class C7 extends T0 {
	...
	method m0(globalState: GlobalState) returns (r0: seq<bool>, r1: int) {
		...
		for i0 := f6 to f3 + v0.cf8 {
			var v1: seq<bool> := [f4];
			var v2: seq<bool> := [!v1[safeIndex(0xf2, |v1|)], f5, f4, f4, f4];
			...
			var v9: array<bool> := new bool[24] [f5, v1[safeIndex(f6, |v1|)], f4, f5, f4, fm4(f5, if (v3 in v4) then v4[v3] else f5, f5, f4, globalState) < v5, f5, f3 != i0, f4, v6.cf0, f4, !f4, f5, f5, f4, f6 < |v7|, f5, f5, multiset{f5, f4} !! v8, f4, f5 ==> f5, f4, f4, !!!f4];
			var v10: seq<array<bool>> := [v9, v3, v9];
			v9 := v10[safeIndex(f3, |v10|)];
			var v11: map<int, string> := map[safeDivisionInt(-i0, f6) := "u"];
			v11 := v11[f3 := v7];
			globalState.f1 := f6;
			var v12 := new C6(safeDivisionInt(f3, -f3), f3, true, f6);
		}
		var v13: array<int> := new int[27](i3 => i3 + f3);
		forall i2 | 0 <= i2 < v13.Length {
			v13[i2] := safeModuloInt(i2, 947);
		}
		var v14: seq<bool> := [f4];
		v13[safeIndex(527, v13.Length)] := |v14|;
		v13[safeIndex(527, v13.Length)] := fm0(globalState);
		f4 := f4;
		f4 := f4 && f4;
		r0 := v14;
		r1 := f3;
...
function fm2(p0: int, globalState: GlobalState): bool {
	-0x302 >= --safeDivisionInt(-551, |"apvmft"|)
}
function fm4(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): seq<int> {
	if (if (true) then false else false) then [0x32b] else (seq(abs(0x228), i0  => (-|map[0x39f := -|multiset{true, false}|]|))) + [|[-0x22f, -0x2b7, 903]|, -|[false, false]|]
}
...
function fm8(p0: bool, p1: D1, p2: D0, p3: int, globalState: GlobalState): seq<char> {
	seq(abs(0x1d4), i0  => (if (true) then 'k' else 'a'))
}
...
function fm10(p0: bool, p1: bool, p2: int, p3: map<bool, string>, globalState: GlobalState): seq<int> {
	match DC38([map[false := false]]) {
		case DC39(cf69) => [-0x18c] + [367, 184, |map[838 := -|(seq(abs(-0x1ec), i0  => (-0x287)))|]|]
		case DC40(cf70, cf71) => [cf71]
		case DC38(cf68) => seq(abs(0x22d), i1  => (|{true}|))
		case DC41(cf72) => (seq(abs(-0x351), i2  => (|map[|map['g' := 0x25b]| := 0x1f1]|))) + [-|[map['f' := false], map['u' := true]]|, 0xd4]
	}
}
...
function fm23(globalState: GlobalState): map<int, int> {
	(map[0xd2 := 454] + map[|(seq(abs(0x1a1), i0  => (DC23(!false, true, false, 'i'))))| := 0x31a]) + ((map v0 : int | (0x86 <= v0) && (v0 < 361) :: (v0 - |[false]|) := (-|"vu"|)) + map[0x29a := -331])
}
function fm24(globalState: GlobalState): char {
	'h'
}
function fm25(p0: bool, globalState: GlobalState): D0 {
	DC0((set v0 : seq<int> | v0 in (seq(abs(249), i0  => ([0x1ac]))) :: (v0)) !! {[|(seq(abs(-0xa8), i1  => (|map['i' := false]|)))|, -|{false, DC46(seq(abs(0xd2), i2  => ('v')), {false}, false).cf81}|]})
}
...
function fm28(p0: bool, p1: int, p2: bool, globalState: GlobalState): map<seq<int>, string> {
	if (|(map v0 : set<bool> | v0 in map[{false, false, false} := true] :: (v0) := (|[true, true, false]|))| < DC33(false, |map[false := false]|, -0x201).cf54) then (map v1 : seq<int> | v1 in map[[-|[true, true]|] := 'm'] :: (v1) := ("mkjgpgh")) + map[[--0xc7] := seq(abs(659), i0  => ('u'))] else (map v2 : seq<int> | v2 in {[-0x30a, 0x2d3]} :: (v2) := ("ivuqtjs")) + (map v3 : seq<int> | v3 in [[0xc4]] :: (v3) := ("qpbh"))
}
...
method Main() {
	...
	if (v1) {
		...
		var v7: seq<int> := [0x2b, 0xce, if (v1) then v3 else 0x35e, |v6[v5 := abs(v3)]|, v3];
		...
		var v13 := 744;
		v12[safeIndex(164, v12.Length)] := v13;
		v12[safeIndex(164, v12.Length)] := fm0(globalState);
		var v14: map<int, int> := map[v13 := fm0(globalState)];
		var v15 := "t";
		var v16: map<int, string> := map[v13 := v15];
		var v17: seq<int> := [v13];
		var v18: map<int, map<int, int>> := map[safeDivisionInt(v12[safeIndex(164, v12.Length)], v12[safeIndex(164, v12.Length)]) := map[|v16| := v17[safeIndex(v12[safeIndex(164, v12.Length)], |v17|)]]];
		v14 := if (v13 in v18) then v18[v13] else v14[-0x1f9 := v13];
		var v19: seq<array<int>> := [v12, v12, v12];
		var v20: seq<bool> := [!v1];
		var v21: array<array<int>> := new array<int>[16] [v12, v12, if (v1) then v12 else v19[safeIndex(v13, |v19|)], v12, v12, v12, v12, v12, v12, v12, v12, v19[safeIndex(|v20|, |v19|)], v12, v12, v12, v12];
		v21[safeIndex(223, v21.Length)] := v12;
		var v22: map<int, bool> := map[v12[safeIndex(164, v12.Length)] := false];
		var v23 := 'm';
		var v24: seq<string> := [v15[safeIndex(|v22|, |v15|) := v23]];
		var v25: set<int> := {fm0(globalState), v12[safeIndex(164, v12.Length)], v13};
		...
		v1, v21[safeIndex(223, v21.Length)], v24, v1, v15 := -v12[safeIndex(164, v12.Length)] in v25, v12, v24 + (v24 + v24), if (!(fm0(globalState) != |map[|v26| := v28]|) in v27) then v27[!(fm0(globalState) != |map[|v26| := v28]|)] else v1, v15;
		var v29 := new C1(v13, safeDivisionInt(v12[safeIndex(164, v12.Length)], v13), fm2(0x84, globalState));
		var v30 := v29.m1(v12[safeIndex(164, v12.Length)], globalState);
	}
	...
	for i3 := |v41| to if (v1) then v32 else v32 {
		...
		v42[safeIndex(952, v42.Length)] := v44 + v44;
		var v45: T1 := new C4(472, |fm31(globalState)|, v1);
		var v46: map<int, map<int, array<C4>>> := map[safeModuloInt(i3, |[v45, v45]|) := v44];
		v42[safeIndex(952, v42.Length)] := if (-(v32 + i3) in v46) then v46[-(v32 + i3)] else v44;
		var v47: map<string, string> := map[v36 := v38.f13];
		var v48: array<string> := new string[29] ["wiusmh", fm20(v45.f3, globalState), (seq(abs(0x248), i4  => (v38.f12))) + "tr", v38.f13, "bybpuk", "qkhmicrt", v36, seq(abs(-0x15d), i5  => (v35)), v36 + (seq(abs(0x125), i6  => (v38.f12)))[safeIndex(53, |(seq(abs(0x125), i6  => (v38.f12)))|) := DC23(v45.f4, v1, true, v38.f12).cf35], fm20(-0xf5, globalState) + v36, v38.f13, v38.f13 + v36, "crcifcx", v38.f13, v38.f13, v38.f13, v36 + v38.f13, fm20(v45.f7, globalState), v38.f13 + v36, "jluu", ("wagffgkjj" + v38.f13)[safeIndex(v32, |("wagffgkjj" + v38.f13)|) := v38.f12], v36, "agrk", if (v1) then v38.f13 else if ("x" in v47) then v47["x"] else "k", seq(abs(-793), i7  => (v35)), v38.f13, v38.f13, v36 + v38.f13, if (v45.f4) then seq(abs(0x356), i8  => (v35)) else v36];
		v48 := v48;
		if ((true ==> v1) <== v45.f4) {
			...
			v50[safeIndex(202, v50.Length)] := v45;
			v50[safeIndex(202, v50.Length)] := new C5(v34.f9, v45.f3, -0x196, v45.f4);
			var v51 := new C7(v45.f4, v45.f7, v45.f7, v33 < v33);
		} else {
			v45.f4 := v45.f4;
			var v52: C7 := new C7(v45.f4, v45.f7, |v36|, v1);
			var v53: seq<C7> := [v52, v52, v52];
			v37[safeIndex(608, v37.Length)] := |v53|;
			v37[safeIndex(608, v37.Length)] := v52.f6;
	...
	var v69: C1 := new C1(|v36|, 840, v40[safeIndex(|"p"|, |v40|)]);
	var v70: seq<C1> := [v69];
	var v71: set<C1> := {v69, v69, v69, v70[safeIndex(v32, |v70|)]};
	v71 := v71 * v71;
	for i10 := v32 to 0x111 - v32 {
		var v72: multiset<bool> := multiset{v1, v1};
		var v73: multiset<int> := multiset{i10};
		v38.f13 := fm15(v1 || v1, safeModuloInt(if (!v1 in v72) then v72[!v1] else -565, i10), if (i10 in v73) then v73[i10] else v32, globalState);
		v31[safeIndex(840, v31.Length)] := v1;
		v31[safeIndex(840, v31.Length)] := |map[v1 := i10]| < -0x23a;
		var v74: set<C3> := {v38, v38, v38, v38, v38};
		v74 := v74;
		var v75: array<bool> := new bool[1](i11 => v31[safeIndex(840, v31.Length)] ==> v31[safeIndex(840, v31.Length)]);
		v0[safeIndex(947, v0.Length)] := v38.f12;
		v75, globalState.f1, globalState.f1, v0[safeIndex(947, v0.Length)], v1 := v75, safeModuloInt(v32 - v32, v32), i10, v38.f12, v1;
	}
	v1 := v1;
	var v76: set<int> := {v32};
	var i12 := 0;
	while (!(v32 != safeModuloInt(|v76|, -v32)))
		decreases 100 - i12
	{
		if (i12 >= 100) {
			break;
		...
		i12 := i12 + 1;
		v32 := v32;
		v37[safeIndex(699, v37.Length)] := safeDivisionInt(v32, fm0(globalState));
		...
		v78[safeIndex(388, v78.Length)] := v82;
		v37[safeIndex(699, v37.Length)], v77, v78[safeIndex(388, v78.Length)] := |v76|, v77, (v82[v80.f4 := v81] + v82)[v1 := v81];
		if (v80.f4) {
			...
			var v88 := DC37(v87, v1, v37[safeIndex(699, v37.Length)], v80.f7);
			var v89: seq<int> := [v80.f7, safeModuloInt(v80.f7, v80.f7), v88.cf66];
			...
			v86, v40, v37[safeIndex(699, v37.Length)], v89, v89 := v86, [v80.f7 == -|(if (v80.f7 in v90) then v90[v80.f7] else v40)|, |v91| != v80.f3, v80.f4], fm0(globalState), v89, fm4(v80.f4, v1, fm2(-v80.f3, globalState), v32 < |v92|, globalState);
			var v93: map<int, bool> := map[v80.f7 := v80.f4];
			globalState.f2 := if (v86.f14 in v93) then v93[v86.f14] else v80.f4;
			v80.f4 := fm2(-safeDivisionInt(v80.f7, if (v80.f7 in v92) then v92[v80.f7] else v80.f3), globalState);
			var v94: C7 := new C7(!false, fm0(globalState), v32, v80.f4);
			var v95: array<C7> := new C7[5] [v94, v94, v94, v94, v94];
			v95[safeIndex(150, v95.Length)] := v94;
			globalState.f1, v37[safeIndex(699, v37.Length)], globalState.f1, v83, v95[safeIndex(150, v95.Length)] := v86.f14, fm0(globalState), v80.f7, v86.f15, v94;
		} else {
			...
			v37[safeIndex(699, v37.Length)] := v38.fm12(fm2(v32, globalState), "jd" == v36, globalState);
			v80.f4 := (v36 + v38.f13)[safeIndex(v80.f3, |(v36 + v38.f13)|) := v38.f12] < v36;
			var v101 := DC35(v34.f9, true, [v1], seq(abs(-0x202), i14  => (v38.f12)), v80.f7);
	...
	var i15 := 0;
	while ((v38.f13[safeIndex(v32, |v38.f13|) := if (v1 in v102) then v102[v1] else v38.f12] == v36) <== ((seq(abs(-0x318), i16  => (v32))) < v103))
		decreases 100 - i15
	{
		if (i15 >= 100) {
			break;
		...
		var v109: array<C4> := new C4[14] [v106, v106, v106, v106, v106, v106, v106, if (true in v107) then v107[true] else v106, v106, v106, v106, v106, v108[safeIndex(v32, |v108|)], v106];
		v109[safeIndex(199, v109.Length)] := v106;
		v109[safeIndex(199, v109.Length)] := v106;
	...
	v114[safeIndex(998, v114.Length)] := v38;
	v114[safeIndex(998, v114.Length)] := v38;
	...
	v115[safeIndex(91, v115.Length)] := v118 + v118;
	v115[safeIndex(91, v115.Length)] := v118;
	var v119: seq<array<int>> := [v37, v37];
	var v120: seq<seq<array<int>>> := [v119, DC43(v119).cf74];
	v31[safeIndex(209, v31.Length)] := v117.f15 !in v120[safeIndex(v117.f14, |v120|)];
	v31[safeIndex(209, v31.Length)] := v1;
	var i18 := 0;
	while (v1)
		decreases 100 - i18
	{
		...
		v121 := v121[v31[safeIndex(209, v31.Length)] := v116.f4];
		var v122: multiset<int> := multiset{v32};
		globalState.f2 := fm2(|(v122 * v122)|, globalState);
		var v123 := new C0(v116.f4, v34.f9);
		v116.f4 := !v116.f4;
	}
	v37[safeIndex(911, v37.Length)] := v116.f3;
	v37[safeIndex(911, v37.Length)] := v32;
	var v124: map<bool, bool> := map[v1 := false];
	var v125 := DC38((seq(abs(144), i19  => (map[v116.f4 := v31[safeIndex(209, v31.Length)]])))[safeIndex(v117.f14, |(seq(abs(144), i19  => (map[v116.f4 := v31[safeIndex(209, v31.Length)]])))|) := v124]);
	match (v125) {
		case DC39(cf69) =>
			globalState.f2 := v116.f4;
			v36 := fm15(v31[safeIndex(209, v31.Length)], v117.f14, v116.f3, globalState) + (seq(abs(-0xee), i20  => (v38.f12)));
			var v126: multiset<bool> := multiset{v116.f4};
			var v127: map<int, int> := map[v117.f14 := |"sqq"|];
			globalState.f1 := |(if (v38.fm13(globalState)) then v126 else v126)[fm2(v32, globalState) && v116.f4 := abs(if (|{v34}| in v127) then v127[|{v34}|] else fm0(globalState))]|;
		...
		case DC40(cf70, cf71) =>
			var v132: seq<seq<bool>> := [v40, [v116.f4, v1, v31[safeIndex(209, v31.Length)], v116.f4]];
			var v133: C6 := new C6(v117.f14, cf71, v116.f4, |v132[safeIndex(v32, |v132|)]|);
			var v134: seq<C6> := [v133, v133, v133];
			var v135: multiset<int> := multiset{|multiset(v103)|, v117.f14, 0x34c};
			var v136 := DC10(|v135|, v34.f9, |multiset{-(if (v117.f14 in v135) then v135[v117.f14] else v37[safeIndex(911, v37.Length)]), v117.f14, v116.f3}|);
			var v137: array<C6> := new C6[24] [v133, v133, v133, v133, v133, v133, v133, v133, v133, if (v1) then v133 else v133, v134[safeIndex(v136.cf15, |v134|)], v133, v133, v133, v133, v133, v133, v133, v133, v133, v133, v133, v133, v133];
			v32, v137 := |("qxab" + v38.f13)|, v137;
			var v138: map<bool, int> := map[false := v116.f3];
			var v139 := DC37(v124, v1, |v36|, |v138|);
			var v140 := DC6(v116, "pvomejghm", v31[safeIndex(209, v31.Length)], v116.f4);
			match (if (v116.f4) then v139 else DC37(v124, v140.cf12, v116.f3, v117.f14)) {
				...
				case DC36(cf61, cf62, cf63) =>
					...
					v147[safeIndex(524, v147.Length)] := v149;
					var v150 := DC35(v34.f9, v1, v40, v38.f13, |(seq(abs(-843), i22  => (v38.f12)))|);
					var v151 := DC11({737, v150.cf60});
					var v152: map<D4, multiset<int>> := map[v151 := v135];
					v135, globalState.f1, v38.f13, v40, v147[safeIndex(524, v147.Length)] := if (v151 in v152) then v152[v151] else v135 - v135, -|multiset(v103)|, v38.f13, v40, if (v116.f4) then v149 else v149;
					...
					var v157: multiset<map<char, bool>> := multiset{v156[safeIndex(v116.f3, |v156|)]};
				...
				case DC37(cf64, cf65, cf66, cf67) =>
					...
					v162[safeIndex(349, v162.Length)] := DC45(map[!v1 := v36]).cf78 + v160;
					v162[safeIndex(349, v162.Length)] := v160;
				case DC34(cf55) =>
					var v163: array<T0> := new T0[26];
					var v164: set<array<T0>> := {v163, v163, v163};
					v164 := v164 + {v163, v163};
					globalState.f1 := |v38.f13|;
					var v165, v166, v167, v168 := v34.m2(v31[safeIndex(209, v31.Length)], v117.f15, v124 + v124, v1, globalState);
			...
			if (v116.f4) {
				...
				v171[safeIndex(771, v171.Length)] := if (false) then v172 else v172;
				v171[safeIndex(771, v171.Length)] := v172;
				v37[safeIndex(911, v37.Length)] := 0xb9;
				...
				v176 := v176;
				v31[safeIndex(209, v31.Length)], v31[safeIndex(209, v31.Length)], globalState.f1, v31[safeIndex(209, v31.Length)] := v174.f4, false || v173.fm5(v133.f8, v174.f3, v35, v1, globalState), |((v103 + (seq(abs(-229), i23  => (|v38.f13|)))) + v103)|, v116.f4;
			} else {
				v1 := v116.f4;
		...
		case DC38(cf68) =>
			...
			v181 := v181[v117 := v37[safeIndex(911, v37.Length)]];
			var v182: C7 := new C7(v116.f4, v32, v117.f14, v1);
			var v183: map<C7, seq<bool>> := map[v182 := v40];
			var v184: multiset<seq<bool>> := multiset{[v1, v1], if (v182 in v183) then v183[v182] else v40[safeIndex(|v36|, |v40|) := false], v40};
			v184 := v184[v40 := abs(|v76|)] + DC48(multiset{[v116.f4]}).cf83;
			v31[safeIndex(209, v31.Length)] := v182.f5 <== v31[safeIndex(209, v31.Length)];
		case DC41(cf72) =>
			v37 := v117.f15;
			globalState.f1 := v116.f3;
			globalState.f2 := v1;
			var v185: set<array<char>> := {v0};
			globalState.f2, v1, v38.f13 := !((if (v31[safeIndex(209, v31.Length)]) then v185 else v185) > v185), v1, v38.f13;
	}
	...
	print v38.f13, "\n";
	print |v39|, "\n";
	print v40 == [false, false, false, false], "\n";
	print |v41|, "\n";
	print |v70|, "\n";
	print |v71|, "\n";
	print v76 == {714}, "\n";
	print i12, "\n";
	print v102 == map[false := 's'], "\n";
	print v103 == [714], "\n";
	print i15, "\n";
	print v114[0].f12, "\n";
	print v114[0].f13, "\n";
	...
	print |v120|, "\n";
	print i18, "\n";
	print v124 == map[false := false], "\n";
	print v125.cf68 == [map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[false := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false], map[true := false]], "\n";
}