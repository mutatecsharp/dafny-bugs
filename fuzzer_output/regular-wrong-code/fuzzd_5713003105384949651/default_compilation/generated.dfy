...
function fm3(p0: bool, p1: string, p2: int, globalState: GlobalState): string {
	((seq(309, i0  => ('n'))) + "dwtkddnh") + ("kq" + (seq(218, i1  => ('x'))))
}
function fm4(globalState: GlobalState): int {
	-(if (!(true && false)) then 512 + |map[true := 's']| else |[|map[268 := true]|, 0x24d, |map[false := false]|, |"ddwiwxcq"|]| % -0x22b)
}
...
function fm10(globalState: GlobalState): set<int> {
	(set v2 : int | v2 in map[|multiset{144, |(set v1 : int | v1 in (set v0 : int | (66 <= v0) && (v0 < 817) :: (v0 % 0x191)) :: (v1 % |{true, true}|))|, -|[true]|}| := true] :: (v2 / -|"vup"|)) * (if (!true) then set v3 : int | (0x2c0 <= v3) && (v3 < -0x1af) :: (v3 - -676) else {|"qdem"|, |[true, true, true, !DC0(true).cf0, false]|})
}
function fm11(p0: bool, p1: char, globalState: GlobalState): multiset<int> {
	(multiset{|[true, false, false, !!!false, true]|} + multiset{-0x301, |[0x31e]|}) - (multiset([-0x26b]) + multiset{|map[true := true]|, |(seq(752, i0  => ('v')))|, 803, |map[DC5(false, false).cf8 := true]|, 0x288})
}
...
function fm14(p0: string, globalState: GlobalState): map<bool, map<int, int>> {
	map[false := map v0 : int | (920 <= v0) && (v0 < 0x65) :: (v0 + |[false]|) := (|multiset(seq(0x26d, i0  => (|"yfuahe"|)))|)] + (map[true := map[|(set v1 : int | v1 in [|[DC25(), DC25(), DC25()]|, -0x19b] :: (v1 % 0x118))| := 0x72]] + map[false := map[0x1a8 := 0x9a]])
}
...
function fm16(p0: int, p1: bool, globalState: GlobalState): seq<bool> {
	[!(['g'] == (seq(0x102, i0  => ('w')))), true, false || false]
}
function fm17(p0: bool, p1: seq<int>, p2: bool, p3: bool, globalState: GlobalState): D1 {
	DC4(multiset(seq(216, i0  => ("nrkvxhch"))) * multiset(["ugtro"]), 0x95)
}
...
function fm19(globalState: GlobalState): map<int, int> {
	map[-|"cjrbft"| := 0x24b] + (map[-296 := 0x1d0] + map[0x219 := |[|(map v0 : int | (932 <= v0) && (v0 < 0x12e) :: (v0 / --0x6a) := (false))|]|])
}
...
function fm21(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<D1, char> {
	match DC1(-|(seq(0x38c, i0  => ('y')))|, -506, 0x232) {
		case DC1(cf1, cf2, cf3) => map v0 : D1 | v0 in [DC6(DC3('f')), DC6(DC5(false, true))] :: (v0) := ('y')
		case DC0(cf0) => map[DC6(DC4(multiset([seq(0x378, i1  => ('r'))]), 0x2d0)) := 'k']
...
method m0(p0: array<bool>, p1: int, p2: array<map<bool, bool>>, p3: int, globalState: GlobalState) {
	...
	if (v1[p3]) {
		...
		var v18: array<int> := new int[24] [p1, p3, p3, v12[p1], p1, p3, p1, p3, p1, p3, |v10|, p3, p3, -p1, 0x1, p1, if (v0 in v15) then v15[v0] else p3, 0x255, p3, p1, -0x1d5, v13.f13, 0x380, |v17|];
		var v19: seq<array<int>> := [v18, v18];
		var v20: array<array<int>> := new array<int>[22] [v18, v18, v18, v18, v18, v18, v18, v18, v19[p3], v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18];
		...
		var v29 := DC17(v0);
		var v30 := DC23(v26);
		p0[491], globalState.f2, v0, v25[855] := (233 in v26) && (v27 <= "g"), |(v28 + fm20(v0, -p3, fm0(true, v0, v29.cf25, v0, globalState), globalState))|, if (if (!fm0(v0, v0, v0, v0, globalState)) then v0 else false) then v0 else if (v0) then v0 else v0, v30.cf34[p1 * p3 := -p1];
		p0[491] := v0;
		var v31: C1 := new C1(v0);
		var v32: map<bool, C1> := map[p1 <= p1 := v31];
		var v33: map<int, C1> := map[v26[p1] := v31];
		v31 := if (p0[491] in v32) then v32[p0[491]] else if (p3 in v33) then v33[p3] else v31;
		globalState.f2 := v25[855][|v27|];
	...
	if (v0) {
		...
		v41 := v41[v39[p1 := v38] := (if (|v44| in v42) then v42[|v44|] else p3) - p1];
		var v45: set<int> := {p3};
		...
		if (!v0) {
			...
			var v54 := 'g';
			v52[704] := if (v54 in v53) then v53[v54] else v49;
			v52[704] := v49;
			var v55: map<C0, int> := map[v38 := |v46|];
			v55 := v55[v38 := p3];
			globalState.f2 := v50.f13;
		} else {
			var v56: array<int> := new int[12](i0 => i0 % p3);
			...
			var v61 := DC7(v60);
			var v62 := 'm';
			globalState.f2, v0, v61 := p1 - (p3 / |fm11(v0, v62, globalState)|), -p3 >= -p1, v61;
			globalState.f2 := --p1;
			var v63 := new C2(p1);
			v56[895] := fm2(v0, globalState);
			v56[895] := v63.f13;
		}
		...
		match (v64) {
			case DC17(cf25) =>
				...
				var v68: seq<int> := [|v67|];
				globalState.f2, globalState.f2 := v68[0x328], p1;
			...
			case DC16(cf24) =>
				...
				v71, v72[235], v71, v74, v75 := if (v0) then v71 else v71, p1, v71, v74 + v74, v75;
				var v76: set<bool> := {v0};
				p0[979] := v76 !! v76;
				var v77: array<map<int, int>> := new map<int, int>[2](i4 => map[p3 := p1] + map[v72[235] := p3]);
				var v78: map<int, int> := map[|"nufq"| := p1];
				v77[296] := v78;
				var v79: multiset<int> := multiset{p1};
				globalState.f2, p0[979], v77[296], v72[235] := p1 - p3, v79 >= v79, v78, p1;
				var v80: C1 := new C1(DC17(false).cf25);
				var v81: map<bool, C1> := map[p0[979] := v80];
				p0[979] := !!(|(v73 + v73)| > |(v81 + v81)|);
				globalState.f2 := -(if (p0[979]) then -(v72[235] + |v73|) else -|(v76 + v76)|);
			case DC18(cf26) =>
	...
	if (multiset{|v96|} < v97) {
		...
		var v108: array<array<int>> := new array<int>[19] [v105, v105, v105, v105, v105, v105, v106[|v107|], v105, v105, v105, v105, v105, v105, v105, v105, v105, v105, v105, v105];
		v108[744] := v105;
		...
		globalState.f10, v108[744], v113 := v105, v105, (fm21(v0, v0, -0x273, v0, globalState) + v113) + map[v110 := 'w'];
		v0 := v0 <== v0;
		v0 := if (v0) then v0 else !v0;
	}
	
	if (((seq(0x315, i5  => ('k'))) + v95) != v95) {
		...
		var v118: array<string> := new string[23](i6 => v95[v116.f13 := 'o'] + (seq(0x1ad, i7  => ('v'))));
		v118[301] := v95 + fm9(v0, globalState);
		v118[301] := seq(-589, i8  => ('v'));
		var v119: set<int> := {v116.f13};
		var v120: seq<set<int>> := [v119];
		v0 := v120[-v116.f13] > v119;
	} else {
		var v121: array<map<bool, int>> := new map<bool, int>[24];
		var v122: map<bool, int> := map[v0 := p1];
		v121[978] := map[v0 := |(seq(0x6b, i9  => ('n')))|] + v122;
		var v123: seq<int> := [p1];
		...
		var v129 := DC26(p3, v128[p1], v0);
		var v130: array<set<bool>> := new set<bool>[15] [fm15(p3, |v123|, fm0(fm0(v0, v0, v0, !v0, globalState), v0, v0, !v0, globalState), globalState), v124, v125[v123[p3]], v124, v124 * v124, v124, if (v0) then v124 else fm15(p1, p1, v0, globalState), v124, v124 + {!v0, v129.cf38}, v124, fm15(p1, p1, v0, globalState), v124, {false}, v124, v124];
		v130[387] := v124;
		var v131: set<int> := {p1, p3};
		v121[978], v130[387] := v122, {v131 !! v131};
		var v132 := DC0(v0);
...
class C1 {
	...
	method m4(p0: map<bool, int>, globalState: GlobalState) returns (r0: string, r1: D1, r2: int) {
		...
		for i0 := v1[|("n")[v0 := v2]|] to |v3| * v0 {
			...
			v4[770], f14, f14 := v10, f14, !f14 <==> (if (i0 in v11) then v11[i0] else f14);
		...
		match (fm5(v0, v0, v0, v18, globalState).(cf5 := fm6(|v15|, v20.cf14, !f14, 'a', globalState))) {
			case DC4(cf6, cf7) =>
				...
				var v23: array<array<bool>> := new array<bool>[23] [v19, if (f14) then v19 else v19, v19, v19, v19, v19, v19, v20.cf17, v19, v19, v19, v19, v22[cf7], v19, v19, v19, v19, v19, v19, v19, v19, v19, v19];
				v23[347] := v19;
				v23[347] := v19;
			...
			case DC3(cf5) =>
				var v31 := new C0();
				f14 := v18[if (|v16[345]| in v3) then v3[|v16[345]|] else v0];
				v19[870] := false;
				var v32: map<array<bool>, int> := map[v19 := v0];
				var v33: seq<map<array<bool>, int>> := [map[v19 := v0], map[v19 := -v0]];
				v19[870], v32, f14, f14, r0 := f14, (if (false) then v32 else v32) + v33[-v0], f14 <==> true, f14, fm9(f14, globalState);
				var v34 := "ihdetle";
				var v35: set<int> := {-v0, v0};
				var v36: multiset<string> := multiset{v34};
				var v37 := DC4(v36, v0);
				var v38: map<bool, seq<bool>> := map[v19[870] := v18];
				var v39: array<int> := new int[17] [v0, v0, v0, v0, 0x89, v0 / v0, |v34| + |v35|, v0, v37.cf7, v0 + |v38|, if (v0 in v3) then v3[v0] else 0x2e9, v0, v0 + v0, fm4(globalState), 0x182 % v0, v0, v1[|v35|]];
				v39[802] := v0;
				v39[802] := v0;
			case DC6(cf10) =>
				...
				globalState.f2 := |(if (f14) then multiset{v42} - multiset{v42, v42} else (multiset{v42})[v42 := v0] + v43)|;
				var v44 := new C0();
		}
		
		var v45 := "nwhkcx";
		var v46: seq<string> := [v45, v45[-v0 := v2], v45, v45];
		r0 := v46[|v1| * v0];
...
class C2 {
	...
	method m3(p0: array<bool>, p1: string, p2: seq<int>, globalState: GlobalState) {
		for i0 := f13 to f13 {
			...
			var v7: map<bool, bool> := map[fm0(true, !v0, v0, v6[f13], globalState) := v0];
			var v8: seq<map<int, int>> := [map[|p1| := i0]];
			var v9: array<int> := new int[29] [|p1|, p2[i0], 0x38c, i0, |v7|, f13 - fm2(v0, globalState), i0, f13, -i0, 0x3af, f13, f13, |p1|, 917, |(v8 + (seq(681, i2  => (map[i0 := |{f13}|]))))|, -545 * i0, i0, i0, f13, f13, i0, f13, f13 - f13, f13, f13, |("ngpktyvor" + p1)|, i0, f13, |[v0]|];
			v9[171] := |(seq(-0x9b, i3  => (v1)))|;
			var v10 := DC0(v0);
			var v11: set<D0> := {v10};
			...
			v9[171], v0 := |(if (v0 in v12) then v12[v0] else if (v0) then v11 else v11)|, v16 > {v0, v0};
			v0 := v0;
		}
		var v17: seq<array<bool>> := [p0];
		f13 := |v17|;
		var v18 := true;
		v18, v18 := f13 != f13, (f13 / f13) > f13;
		v18 := false;
		for i4 := f13 to f13 % f13 {
			...
			if (!!(v19 <= v19)) {
				...
				var v23 := DC3(v21);
				v20[281] := if (v23.cf5 in v22) then v22[v23.cf5] else p1;
				v20[281] := fm3(v18, p1, f13, globalState);
				...
				var v31 := DC7(v30);
				var v32: multiset<string> := multiset{v20[281], p1};
				var v33 := DC4(v32, i4);
				...
				v29, v18, v35 := ([DC5(v18, v18)])[0x26c / f13 := v28], !v18, v35;
			} else {
				...
				v40[425] := i4;
				f13, globalState.f10, v40[425] := f13, v40, f13;
				var v41: array<bool> := new bool[15](i5 => v18);
				v41 := v41;
				v18, f13, globalState.f2, globalState.f2, v40[425] := v18, i4 * fm2(v18, globalState), f13 + (v40[425] * f13), i4, f13;
				var v42: map<int, int> := map[0x1ca / f13 := |p2| + i4];
				v42 := v42;
			}
			...
			var v47 := DC10(v18, |v45|, v18, v17[f13], v46);
			if (v47.cf16) {
				...
				v53[729] := v54;
				p0[573], v53[729] := v18, v54;
				var v55: array<array<bool>> := new array<bool>[25];
				var v56: array<bool> := new bool[18];
				v55[897] := v56;
				v55[897] := v56;
				var v57: multiset<bool> := multiset{p0[573], true, !p0[573]};
				v57 := v57;
				var v58 := new C1(v18);
				var v59: seq<string> := [seq(-0x3a2, i6  => (v44)), p1];
				var v60: map<bool, bool> := map[p0[573] := true];
				var v61: map<bool, int> := map[v58.f14 := |v60|];
				var v62: set<int> := {|p2|, if (fm0(v18, v58.f14, v58.f14, p0[573], globalState) in v61) then v61[fm0(v18, v58.f14, v58.f14, p0[573], globalState)] else i4, f13};
				var v63: array<int> := new int[5](i7 => i7 - i4);
				var v64: seq<array<int>> := [v63, v63, v63, v63];
				v18, v44, f13, v59, p0[573] := v19 !! {v18}, p1[|v62|], |(v64 + ([v63, v63] + v64))|, (v59[i4 := p1])[-f13 := p1 + p1], false;
			}
			...
			var v70: map<bool, bool> := map[v18 := v69[i4]];
			var v71: map<bool, char> := map[!v18 := v44];
			var v72: array<int> := new int[29] [647, |(if (v18) then p1 else p1)[f13 := v44]|, |(seq(466, i8  => ('b')))| / p2[i4], f13 - |v19|, |(if (v18 in v65) then v65[v18] else if (f13 in v67) then v67[f13] else v19)|, i4, f13 % 0xb6, f13 % f13, i4, f13, |p1|, if (|v69| in v68) then v68[|v69|] else i4, i4, f13, i4, i4, 0x305, |v70|, fm4(globalState), |(p1 + p1)|, f13, i4, i4, --|multiset{v44, v44, v44, if (v18 in v71) then v71[v18] else v44, v44}|, f13, f13, i4, i4, f13];
			v72[878] := f13;
			v72[878] := f13;
		}
		v18 := ([f13] + p2[f13 := f13]) <= (seq(0x322, i9  => (f13)));
	}
}
...
class C3 {
	...
	function fm1(p0: string, p1: int, globalState: GlobalState): int {
		(|"ngc"| / |multiset{f11}|) / (|"ttwonxung"| / |multiset([seq(0xad, i0  => (f12))])|)
	}
	method m1(p0: bool, globalState: GlobalState) {
		...
		if (DC2(v0) in v3) {
			...
			var v7: seq<bool> := [p0];
			v6[559] := |v7|;
			v6[559] := -0x36e % |fm10(globalState)|;
			var v8 := false;
			var v9: set<int> := {v6[559]};
			v8 := !(v9 != v9);
			var v10 := 'e';
			var v11 := "wdfkv";
			if (fm0(v10 in v11, if (f11) then v8 else f11, f11, f11, globalState)) {
				globalState.f2 := v6[559] * v4.f13;
				v8 := |v7| < f12;
				...
				var v15: map<int, char> := map[v6[559] := v10];
				var v16: map<char, bool> := map[if (f12 in v15) then v15[f12] else v10 := v10 in v11];
				v8 := if ('o' in v16) then v16['o'] else f11;
				var v17: array<bool> := new bool[9] [v8 <==> v7[v4.f13], f11, !v14.f14, f11, v7[-640], v14.f14, p0, v14.f14, f11];
				v17 := v17;
			...
			decreases 100 - i1
		{
			...
			var v28 := "dcu";
			var v29 := 'h';
			var v30: multiset<string> := multiset{v28[f12 := v29], "rbbmc"};
			...
			globalState.f2 := f12 + (f12 % |v37|);
		}
		for i2 := f12 % f12 to -f12 {
			var v38: seq<bool> := [true];
			v38 := v38[i2 := p0] + (v38[f12 := f11])[-i2 := !f11];
			...
			var v53 := DC15(v52);
			var v54: set<multiset<int>> := {(if (v26 in v43) then v43[v26] else multiset{|DC14(map[i2 := v47]).cf22|})[|v49| := -13], v42 + multiset{f12, f12}, v42, v50[|multiset{|map[v53.cf23 := f11]|, i2, f12}|], v42 - v42};
		...
		var v56 := 'g';
		if (fm0(v56 !in (seq(-0x2b1, i4  => (v56))), v26, v26 && f11, f11, globalState)) {
			var v57 := new C2(|"my"|);
			if (f11) {
				v26 := v26 ==> !!p0;
				var v58 := "xoku";
				...
				var v68 := "yfahqywud";
				var v70: seq<string> := [seq(80, i5  => ('l'))];
			...
			var v82: array<int> := new int[15] [f12, f12, |v79|, 584 - v76.f13, -(v76.f13 + f12), |v80| % v76.f13, f12, f12 * v76.f13, f12, if (f11) then f12 else v76.f13, fm1("lnlmx", fm2(f11, globalState), globalState), f12, |map[v81 := true]|, f12, f12];
			v82[700] := v76.f13;
			var v83: C0 := new C0();
			var v84 := DC16(v83);
			...
			v76, v26, v78, v82[700], v86 := DC19(v76).cf27, f11, v78 + (DC10(v26, f12, p0, v81, v78).cf18 + v78), f12, v86 + v86;
			var v87 := DC13('f');
			var v88: map<bool, D4> := map[p0 := v87];
			var v89: seq<int> := [v76.f13, |v88|];
			var v90: seq<int> := [|v89|, v76.f13];
			var v91: seq<int> := [|v90|];
			v76.m3(v81, v80, v89 + (seq(0x38f, i6  => (-0x12a))), globalState);
			if (v26) {
				v76.f13 := v76.f13;
				v76.f13, v80 := v76.f13 * (f12 + |v91|), "ebyufrei" + v80;
				globalState.f2 := v82[700];
				v80 := v80[f12 := v56];
				v81[891] := p0;
				v81[891] := true;
			} else {
				var v92: multiset<string> := multiset{"wtrbr"};
				var v93 := DC4(v92 - v92, -v82[700]);
				v93 := v93;
				globalState.f2 := v82[700] + f12;
				v81[395] := p0;
				v81[395] := "brsji" != v80;
				globalState.f2 := --(v76.f13 % |(map v94 : int | v94 in v78 :: (v94 / f12) := (v56))|);
				var v95: map<int, string> := map[if (v26) then v76.f13 else v82[700] := v80];
				v95 := v95;
			}
			
			var v96: set<bool> := {!p0, f11};
			v26 := !({v89[v76.f13], |multiset{true}|, f12} !! {v82[700]}) in v96;
		}
		...
		var v103: multiset<multiset<int>> := multiset{v102, v102, multiset{f12}, (multiset{f12})[f12 := f12], v102};
	...
	method m2(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: map<seq<bool>, bool>, r2: bool) {
		...
		var v7 := new C0();
		var v8: array<int> := new int[29](i0 => i0 / f12);
		globalState.f10 := v8;
		if (p0) {
			v2[312] := p0 <==> f11;
			...
			v2[312] := if (v10 in v11) then v11[v10] else f11;
			if (f11) {
				...
				v14 := v14;
				v4, v2[312] := fm6(f12, p0, fm0(f11, true, p1, f11, globalState), v4, globalState), !v2[312];
				var v15 := DC5(p0, p0);
				r2 := v7.fm7(if (p1) then v15.cf9 else f11, DC3(v4), v0, v2[312], globalState);
				v8[941] := f12;
				v8[941] := (f12 % f12) / f12;
			} else {
				...
				var v18 := DC19(v17);
				v16[588] := if (p1) then v18 else DC19(v17);
				v16[588] := v18;
				var v19: map<int, int> := map[v17.f13 := |v0|];
				var v20: map<bool, map<int, int>> := map[v2[312] := v19];
				v20 := v20[false := v19];
				var v21 := DC17(v2[312]);
				var v22 := DC18(v21);
				var v23 := DC18(v21);
				var v24: map<D7, bool> := map[v23 := v2[312]];
				v8[897] := v6[|v24|];
				v8[897] := v17.f13;
				var v25: array<int> := new int[21](i1 => i1 * v8[897]);
				globalState.f10, globalState.f2, v2[312], globalState.f2, globalState.f7 := v25, v17.f13, p0, v8[897], fm12(v17.f13, globalState) + (v6 + v6)[f12 := 0x196];
			...
			var v32 := DC21(v0);
			var v33: array<string> := new string[13] [v32.cf32 + v0, v0, v0 + v0, v0, v0, "kctfg" + (seq(908, i2  => (v4))), v0, v0, v0, v0 + v0, v0, v0 + fm9(p1, globalState), v0];
			v33[651] := v0;
			v33[651] := v0;
			var v34: set<int> := {f12};
			var v35: multiset<bool> := multiset{f11};
			var v36: map<int, int> := map[f12 := |v35|];
			v34 := (set v37 : int | v37 in v36 :: (v37 % -|multiset([365])|)) - v34;
		}
...
method Main() {
	...
	var v9: map<int, array<int>> := map[|v7[v3]| := v8];
	...
	if (!v0) {
		...
		match (fm13(v18, multiset(v19), globalState)) {
			case DC4(cf6, cf7) =>
				v0, globalState.f2, v13, v3 := v0, v3 / cf7, v13, -cf7;
				globalState.f2 := cf7;
	...
	for i2 := v3 * v3 to v3 {
		...
		var v40: array<C2> := new C2[25] [v33, v33, v33, v33, v33, v33, v33, v33, v33, v33, v33, v33, v33, if (v0) then v33 else v33, v33, v33, v33, v33, v33, v33, if (v36 in v38) then v38[v36] else v33, if (v39[v33.f13]) then v33 else v33, v33, v33, v33];
		v40[930] := v33;
		v0, v40[930] := !((v3 * -0x327) <= v33.f13), v33;
		v4 := v4 + v4;
		var v42: multiset<int> := multiset{i2, v33.f13};
		var v43: set<int> := {|v42|};
		v34.f14 := v3 !in (map v41 : int | v41 in v43 :: (v41 % v3) := (v33.f13))[-v33.f13 := |v43|];
		var v44: multiset<array<int>> := multiset{v8, v8, v8, v8};
		if (v8 in v44) {
			globalState.f2 := -(v6[v33.f13] * i2);
			v4 := (v4 + v4) + v4;
			var v45: multiset<string> := multiset{v4 + "ux", v4, v4 + v4, v4, v4};
			v45 := v45;
			var v46: array<string> := new string[15](i3 => "k");
			var v47 := 'd';
			v46[63] := ("dfldjy" + "e")[v33.f13 := v47];
			var v48 := DC8(|v39|);
			v33.f13, v46[63], globalState.f2, globalState.f2 := v33.f13 * v48.cf12, "cqdmq", v33.f13, v33.f13 + v33.f13;
	...
	v8[595] := |v70|;
	v3, v66, v68, v8[595] := -(v58.f12 % |(v11 + v11)|), v66, fm14(v4 + v4, globalState), |v4| + v58.f12;
	var i4 := 0;
	while (v58.f12 >= |v10|)
		decreases 100 - i4
	{
		...
		i4 := i4 + 1;
		var v71: map<int, seq<char>> := map[v8[595] % v58.f12 := v4];
		var v72: seq<C3> := [v58];
		var v73 := DC22(v72);
	...
	match (fm13(v57, multiset{v58.f11, v65, !v77.f11}, globalState)) {
		case DC4(cf6, cf7) =>
			...
			match (v81) {
				...
				case DC6(cf10) =>
					...
					v8[595], v95, v63 := v3, v95, (v77.f12 % v8[595]) == (v77.f12 * v3);
					v3 := v58.f12;
			}
			...
			if (v0) {
				...
				v0, globalState.f2 := v97 >= {cf7}, |(if (v77.f11) then seq(-994, i6  => (v57)) else seq(-963, i7  => (v57)))|;
				...
				cf7 := if (!v58.f11 <==> fm0(true, v58.f11, v58.f11, v58.f11, globalState)) then v58.f12 else if (v78 in v102) then v102[v78] else v8[595];
			...
			var v105 := DC22(v104);
			var v106: array<D10> := new D10[9] [v105.(cf33 := v104), v105, v105, v105.(cf33 := v104), v105.(cf33 := v104), v105, v105, DC22(v104[v77.f12 := v58]), v105];
		...
		case DC5(cf8, cf9) =>
			...
			var v111: map<seq<bool>, int> := map[if (cf9 in v110) then v110[cf9] else v62[v3 := v63] := |v62[-0x207 := !!cf8]|];
			var v112: multiset<int> := multiset{|v111|};
			v3 := |{v58.f12 - |v112|}|;
			var v113 := DC5(cf9, cf8);
			if (v113.cf9) {
				v4 := v4 + v4;
				var v114 := new C3(v77.f11, |fm15(v77.f12, v77.f12, v0, globalState)| / v3);
				var v115: seq<array<int>> := [v8, v8];
				var v116: map<char, array<int>> := map[v57 := v8];
				var v117: array<array<int>> := new array<int>[20] [if (83 in v9) then v9[83] else v115[-0x231], v8, if (v77.f11) then v8 else v8, if (v57 in v116) then v116[v57] else v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8];
				v117[20] := v8;
				v117[20] := v8;
				v114 := v58;
				v8[595] := -v114.f12 - 500;
				...
				m0(v118, v3 / v58.f12, v14, v58.f12, globalState);
				var v119, v120, v121 := v58.m2(cf8, v58.f12 <= v77.f12, globalState);
				globalState.f2, v119, v63 := v6[if (v0) then v77.f12 else v3], v62[0x1b1], v57 in v4;
				globalState.f2, v62, v13[333], globalState.f10, cf9 := if (cf8 in v10) then v10[cf8] else v77.f12, v62 + fm16(0x159, v113.cf9, globalState), true, if (!v65) then v8 else v8, !v63;
				var v122 := new C2(v3);
			}
		...
		case DC6(cf10) =>
			...
			var v128 := DC10(v13[923], v8[595], true, v126, map[v58.f12 := v77.f11]);
			match ((if (v77.f11) then DC10(v65, v8[595], v58.f11, v126, v127) else v128).(cf16 := v0, cf14 := v58.f11, cf17 := v126)) {
				case DC10(cf14, cf15, cf16, cf17, cf18) =>
					v8[595] := v58.fm1(v4, |v67|, globalState);
					v57 := 'w';
					v3 := -v58.f12 * v58.f12;
					v64 := v64[v62 := fm0(v0, v58.f11, v63, v58.f11, globalState)];
				case DC9(cf13) =>
					v79[46] := if (v58.f11) then v57 else v57;
					v79[46] := if (v63 !in v62) then v57 else v57;
					var v129: multiset<int> := multiset{v58.f12};
					v129 := v129;
					var v130 := DC20(v77.f11, v13[923], if (|v11| in v127) then v127[|v11|] else v77.f11, v58.f11);
					...
					v13[923] := if (v134 in v135) then v135[v134] else v77.f11;
				case DC11(cf19) =>
					globalState.f2, v13[923] := fm2(v65, globalState) % v77.f12, true <== v0;
					...
					v65 := v128.cf16;
					v57 := if ({v13[923], !v63, v63} >= {!v77.f11, v65, v77.f11, v58.f11}) then 'c' else v57;
			}
	...
	match (DC0(v0)) {
		case DC1(cf1, cf2, cf3) =>
			match (fm17(v77.f11, v6 + v6, v62[cf2], v0, globalState)) {
				case DC4(cf6, cf7) =>
					var v137 := DC23(v6);
					v6 := v137.cf34 + (if (v58.f11) then v6 else v6)[|v4| := |v5|];
					...
					v144 := v144;
				case DC5(cf8, cf9) =>
					var v145: map<int, bool> := map[cf3 := v58.f12 <= v8[595]];
					v145 := v145;
					globalState.f2 := v77.f12;
					var v146 := DC1(0x11f, v8[595], v58.f12);
					v3 := v6[v146.cf2 / -(if (v58.f11 in v10) then v10[v58.f11] else v58.f12)];
					v4 := v4;
				case DC3(cf5) =>
					v62 := v62;
					var v147: map<int, array<bool>> := map[|v4| := v13];
					v13 := if (v8[595] in v147) then v147[v8[595]] else v13;
					v4 := v4 + v4;
					v63 := (v58.f12 / -v58.f12) <= v77.f12;
				case DC6(cf10) =>
					...
					var v152 := DC25();
					v151[150] := v152;
					var v153: map<int, seq<int>> := map[cf3 / v58.fm1(v4, v8[595], globalState) := [v77.f12]];
					v8[595], v65, v8[595], v151[150], v8[595] := |(if (cf1 in v153) then v153[cf1] else v6)|, false, if (v57 in v4) then cf1 else v77.f12, v152, v3 % |v4|;
			}
			
			var v154 := new C3(v63, |v67| % cf3);
			match (fm17(v58.f11, v6, !(|[v58.f11]| <= v77.f12), v4 <= v4, globalState)) {
				case DC4(cf6, cf7) =>
					v65 := v4 < (seq(0x17b, i11  => (v57)));
				...
				case DC5(cf8, cf9) =>
					...
					var v157 := new C3(v77.f11, cf3 % |fm18(cf2, globalState)|);
				case DC3(cf5) =>
					var v158 := DC3(cf5);
					cf5 := v158.cf5;
					var v159: seq<multiset<bool>> := [v10[v58.f11 := v77.f12]];
					v57 := fm6(v154.f12, v159 != (seq(0x2c8, i12  => (multiset{v77.f11}))), v77.f11, cf5, globalState);
					globalState.f2 := |v6|;
					v13[918] := true;
					v13[918] := v63;
				case DC6(cf10) =>
					...
					cf3 := (-cf2 / v154.f12) + v154.fm1("sn", cf1, globalState);
					var v161: C0 := new C0();
					var v162 := DC16(v161);
					var v163: map<C0, int> := map[v162.cf24 := |v6|];
					var v164: map<map<C0, int>, int> := map[v163 := -|(seq(376, i13  => (DC25())))|];
					v164 := v164;
					globalState.f2 := v3;
			}
			...
			match (v165) {
				case DC10(cf14, cf15, cf16, cf17, cf18) =>
					cf16, v57, v63 := v58.f11, v4[cf15], !!false;
					var v166: seq<seq<bool>> := [v62 + v62];
					v166 := v166;
					cf15 := |(v67 + (v67 + v67))|;
					v11 := v11;
				case DC9(cf13) =>
					v3 := |((v4 + "qgqwbmtnb") + ((seq(58, i14  => ('r')))[0x9c := fm6(v3, v77.f11, v65, 'b', globalState)] + v4))|;
					v8[595] := v58.f12;
					var v167 := DC1(v58.f12, -v58.fm1(seq(637, i15  => (v57)), v58.f12, globalState), v154.f12);
					v3 := v167.cf3;
					cf13[714] := v65 <== true;
		...
		case DC0(cf0) =>
			...
			var v174, v175, v176 := v77.m2(|v173| == v8[595], v58.f11, globalState);
			v58.m1(v65, globalState);
			v174 := v6 != (v6 + v6);
			var v177: map<int, bool> := map[|v11| := v174];
			var v178 := DC10(v174, v58.f12, v63, v13, v177);
			v11 := v11[v178.cf15 >= v8[595] := v63];
		case DC2(cf4) =>
			var v179: seq<string> := [v4, v4, v4, seq(0x23a, i16  => (v57))];
			if (v179 < (seq(0x18, i17  => (v4)))) {
				var v180: map<int, bool> := map[-v58.f12 := v58.f11];
				v180 := v180[v3 := true];
				v13[578] := v77.f11;
				v13[578] := DC10(v77.f11, v77.f12, v65, v13, v180).cf16;
				v77.m1(v58.f12 >= v8[595], globalState);
				v4 := v4;
				v77.m1(v77.f11, globalState);
			} else {
			...
			v3, v65, v67, v3 := v77.f12 * v6[|v62|], 0x2b6 > v185.cf2, map[-v77.f12 := v58.f12], (v58.f12 % 0x2b9) % v77.f12;
			...
			match (v187) {
				case DC1(cf1, cf2, cf3) =>
					...
					cf2 := if (v58.f11) then v77.f12 % cf2 else |v188|;
					v65 := v77.f11;
					v0 := v77.f12 <= cf3;
					v0 := v77.f11;
				case DC0(cf0) =>
				...
				case DC2(cf4) =>
					...
					v197[130] := v4;
					v197[130], v193 := "c" + v4, v195;
			}
			
			var v198: set<int> := {v77.f12, |(seq(-0x9, i19  => (-|v1|)))|, v8[595]};
			var v199: map<set<int>, bool> := map[v198 := v0];
			var v200: seq<map<set<int>, bool>> := [v199 + v199, v199, v199, map[v198 := false]];
			v3, v199 := if (v58.f11) then -(v58.f12 - v3) else -v58.f12 / |v4|, v200[v3];
	}
