...
function fm1(p0: char, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D0 {
	match DC30(DC30(DC28(map v0 : int | (0xa7 <= v0) && (v0 < 166) :: (v0 - |(seq(309, i0  => ('n')))|) := ([true])))) {
...
function fm10(p0: bool, p1: int, p2: char, globalState: GlobalState): int {
	-(|{|(seq(0x2a6, i0  => ("mop")))|, 0x1ba}| - (|"qslbt"| / -0x36a))
}
...
function fm13(p0: char, globalState: GlobalState): bool {
	{{871}} !! (set v2 : set<int> | v2 in [set v1 : int | v1 in (map v0 : int | (0x17e <= v0) && (v0 < -0x35b) :: (v0 % |{false}|) := (false)) :: (v1 * -0x2a6)] :: (v2))
}
...
function fm18(p0: bool, p1: string, globalState: GlobalState): set<map<int, int>> {
	{map v0 : int | v0 in multiset{-0x6b} :: (v0 * 970) := (0x38), map[|[|["ectyjxqe", "go"]|]| := -|"t"|] + map[|[-0x18d, |map[map[348 := |map[true := map[|(seq(794, i0  => ('l')))| := false]]|] := false]|]| := 247]}
}
...
function fm31(p0: bool, p1: bool, p2: bool, globalState: GlobalState): seq<map<int, bool>> {
	[map[0x25 := true], map[--|[0x103, |map['f' := false]|]| := true]] + [map v0 : int | (666 <= v0) && (v0 < 531) :: (v0 + -|(set v1 : int | (0x287 <= v1) && (v1 < 0x2a9) :: (v1 + 0x1e8))|) := (true), map v2 : int | (388 <= v2) && (v2 < -0x5a) :: (v2 / -0xf7) := (true), map[0x3b0 := true], map[|(seq(499, i0  => (|map[|"jxgb"| := !false]|)))| := false]]
}
...
function fm34(globalState: GlobalState): seq<int> {
	[|[0x294]|, 0x219, 188, |multiset{-0xfc, 608, 0x1e9, 165, |"csnw"|}|] + [|[282, 0xb9, 198, |(seq(851, i0  => (294)))|, |{true}|]|]
}
...
function fm39(p0: int, p1: int, p2: bool, globalState: GlobalState): map<string, seq<bool>> {
	(if (false) then map[seq(0x3af, i0  => ('w')) := [false]] else map["xpuyrrswu" := [false]]) + map[seq(0x308, i1  => ('p')) := [true, !false]]
}
...
function fm45(p0: bool, p1: multiset<string>, p2: bool, globalState: GlobalState): string {
	if (map[-0x2f7 := !false] != map[|map[-694 := ---114]| := DC7(!false).cf11]) then seq(0x1de, i0  => ('i')) else "dymkseene" + "x"
}
...
function fm49(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<D2, multiset<int>> {
	(map v0 : D2 | v0 in (seq(157, i0  => (DC10()))) :: (v0) := (multiset{-704})) + map[DC10() := multiset([|multiset{"rww", "fjapjve", "wqisn", "o"}|, -|{|"rgle"|}|])]
}
...
function fm51(globalState: GlobalState): multiset<set<int>> {
	if (!(!false in {true})) then multiset{{|[!!false]|}, {|{657}|}, {|map[|(seq(187, i0  => ('b')))| := false]|, |(map v0 : D12 | v0 in (map v1 : D12 | v1 in multiset{DC29(true, -0x1b3, [{-0x2d5, 0x226}], 0x2d0, false), DC29(true, -0x27f, seq(744, i1  => (set v2 : int | v2 in {-695, |[true]|} :: (v2 % |map[0x384 := false]|))), |map[false := |[false, true, false, true, true]|]|, false), DC29(false, 0x362, seq(-901, i2  => ({|(seq(0x16a, i3  => ('u')))|, |map[|[true]| := false]|})), |[|"govqs"|, 0xd0]|, true), DC29(!true, -0x70, [set v3 : int | (565 <= v3) && (v3 < 249) :: (v3 - |"iysawpjfr"|), {0x1ac}], |multiset([false])|, false)} :: (v1) := (true)) :: (v0) := (|map[false := |"lfwjfch"|]|))|, |(seq(0x20f, i4  => ('q')))|}, set v4 : int | v4 in {0x259, 0x1ce} :: (v4 * |map[!true := false]|), {|(seq(0x52, i5  => ('s')))|, -0x2f}} else multiset([set v5 : int | v5 in [|multiset{293}|] :: (v5 + 263)]) - DC87(multiset{{|[0x2e6]|, |(map v6 : int | (-0x344 <= v6) && (v6 < 0xab) :: (v6 / -|[DC55(!true)]|) := (true))|}}).cf142
}
...
function fm63(p0: char, p1: seq<bool>, p2: int, globalState: GlobalState): seq<map<bool, int>> {
	((seq(0x2b4, i0  => (map[false := 253]))) + [map[true := |map[!false := true]|], map[true := -0x67]]) + ([map[false := |multiset{|[true, true]|}|]] + (seq(732, i1  => (map[false := 665]))))
}
...
function fm67(p0: int, globalState: GlobalState): D18 {
	match DC24(false, DC52(0x55).cf79, 0x2c3) {
		case DC24(cf36, cf37, cf38) => DC43(set v0 : map<bool, int> | v0 in multiset{map[cf36 := |(seq(0x31, i0  => ([cf36])))|], DC19(map[cf36 := cf37]).cf29, map[!cf36 := cf37]} :: (v0))
		case DC23(cf35) => DC43({map[false := |{|(seq(0x4, i1  => ('j')))|}|], map[true := --519], map[false := 0x3a6], map[false := |"hfdhg"|], map[true := 906]})
	}
}
function fm68(p0: bool, p1: bool, globalState: GlobalState): D21 {
	DC57(0x256 - 0x26d, if (false) then -|{|[!false]|}| else 0x363, !(|multiset{true}| != 0x1), |([true, true] + [false, true, false])|, [|(seq(-0x217, i0  => ('f')))|] <= [-0x106])
}
...
function fm71(globalState: GlobalState): map<int, string> {
	(map[|map[true := |(set v2 : map<int, int> | v2 in (set v1 : map<int, int> | v1 in map[map[|(map v0 : int | v0 in map[0x64 := false] :: (v0 / |(seq(0x339, i0  => ('w')))|) := (-788))| := 0x170] := false] :: (v1)) :: (v2))|]| := DC15("k", 0x11e, seq(0xba, i1  => ('j')), |"fjdwlpb"|).cf21] + map[|"tagsl"| := "bbvfd"]) + (map[DC72(-520, 0x288, true).cf117 := "tyyl"] + map[0x230 := "w"])
}
...
function fm73(p0: int, globalState: GlobalState): map<seq<bool>, bool> {
	(map v0 : seq<bool> | v0 in map[[true] := multiset{|(map v1 : int | (0x22d <= v1) && (v1 < -776) :: (v1 / 404) := (map[false := 0x226]))|, |"jkdgsalw"|}] :: (v0) := (true)) + (map[[false, !false, true, true] := true] + (map v2 : seq<bool> | v2 in {[true], [!false]} :: (v2) := (false)))
}
...
function fm80(globalState: GlobalState): map<string, int> {
	map["jyinucdjo" := 441] + (map[seq(0xdb, i0  => ('i')) := |(set v0 : int | v0 in map[|map[true := -|"wumdqm"|]| := false] :: (v0 - |map[false := false]|))|] + map["tmystelkn" := |map[|[true]| := true]|])
}
function fm81(p0: bool, p1: int, p2: bool, p3: string, globalState: GlobalState): D22 {
	DC59((seq(-0xbd, i0  => (map['h' := true]))) + [map v0 : char | v0 in ['n', 'h'] :: (v0) := (false)])
}
...
function fm84(p0: int, p1: set<int>, globalState: GlobalState): map<string, char> {
	map["vljbcx" + (seq(0x368, i0  => ('w'))) := if (true) then 'd' else 's']
}
trait T0 {
...
class C1 extends T1 {
	...
	method m4(p0: string, p1: bool, p2: set<bool>, globalState: GlobalState) returns (r0: char, r1: bool, r2: string, r3: bool) {
		...
		globalState.f4, v2, r3, v3[715], v0 := p1, v2, p1 && f29, !p1, if (v5 in v6) then v6[v5] else |[f29, !fm29(globalState)]| % -v0;
		var v7: array<int> := new int[8](i1 => i1 * v0);
		forall i0 | 0 <= i0 < v7.Length {
			v7[i0] := i0 / v0;
		}
		var v8 := DC4(DC1(v3[715], v0, -0x6d, p1, v0));
		var v9: map<bool, bool> := map[f29 := true];
		var v10 := DC12(v8, v0, if (p1 in v9) then v9[p1] else v3[715]);
		v3[715] := !(if (v10.cf17) then true else true);
		var v11 := new C0(v7);
		for i2 := v0 to v0 {
			var v12 := DC9(p0);
			globalState.f13 := v11.fm28(v12, globalState) / v0;
			var v13: map<int, array<int>> := map[v0 := v11.f28];
			var v14 := new C0(if (i2 in v13) then v13[i2] else v11.f28);
			v11.f28[857] := i2;
			var v15: map<bool, set<bool>> := map[v3[715] := p2];
			var v16: seq<set<bool>> := [p2 * p2, if (f29 in v15) then v15[f29] else p2, p2, p2];
			v11.f28[857], v16, v0 := (v0 % |p0|) / 0xa0, (v16[i2 := p2] + [p2]) + v16, v0;
			r1 := v11.f28[857] != DC1(p1, v11.f28[857], 0x2f, p1, i2).cf5;
		}
		r0 := v5;
		r1 := if (!v3[715] in v9) then v9[!v3[715]] else p1;
		r2 := "k";
	...
	method m19(p0: bool, globalState: GlobalState) returns (r0: int) {
		...
		match (fm30(v3, globalState)) {
			case DC6() =>
				...
				v4 := v4[!p0 := f29];
				var v5: seq<int> := [v2];
				var v6: map<int, int> := map[0x18c := v5[v2]];
			...
			case DC7(cf11) =>
				...
				if (v2 == -|(seq(0x38f, i4  => ('x')))|) {
					...
					v24[622] := if (v25[v2]) then v27 else v27;
					v24[622] := v27;
					globalState.f11 := !p0;
					...
					var v34: map<bool, map<char, bool>> := map[f29 := map v31 : char | v31 in v33[v32 := v2] :: (v31) := (cf11)];
					...
					var v39: array<bool> := new bool[28] [cf11, false, p0, p0, p0, v20[920][!f29 := -v2] !! multiset(v25[v2 := v30.cf11]), p0, if (f29) then true else f29, f29, v36 !! v36, cf11, v1 !in fm31(cf11, p0, !true, globalState), p0, v30.cf11, f29, v26 < v26, p0, false, cf11, v32 !in fm32(v25[-|v37|], f29, [v2, v2, v2], f29, globalState), v38 > {-|v29|, |v26|}, cf11, cf11, p0, p0, f29, if (cf11) then true else f29, p0];
					var v40: map<seq<int>, bool> := map[v29 := cf11];
					v39[135] := if (v29 in v40) then v40[v29] else cf11;
					var v41: map<bool, seq<int>> := map[p0 := v29];
					var v42: set<bool> := {p0};
					var v43 := DC1(true, -|v42|, v2, !f29, -0x2e4);
					v28[495], v29, v39[135] := fm33(globalState), v29 + (if (!false in v41) then v41[!false] else fm34(globalState)), |[v43.cf1]| < v2;
					v2 := v2;
					var v44 := new C0(v21);
				} else {
					var v45: seq<multiset<bool>> := [v20[920], v3, v3];
					v45 := v45;
					var v46: array<D3> := new D3[23](i5 => if (p0) then DC13() else DC13());
					v46[531] := DC13();
					var v47 := DC13();
					v46[531] := if (!(-v2 <= DC2(v2).cf6)) then v47 else v47;
					var v48 := DC6();
					...
					v23.f28[45] := v2 / v22.fm28(DC9([v50, v50]).(cf13 := v51).(cf13 := v51), globalState);
					var v52: array<string> := new seq<char>[25](i6 => v51);
					v52[897] := v51;
					v52[897] := v51 + fm33(globalState);
				}
			...
			case DC8(cf12) =>
				...
				if (true) {
					...
					v58 := v58;
					v57 := seq(0x3c6, i8  => (if (p0) then 'c' else 't'));
					...
					var v70: map<bool, seq<map<bool, int>>> := map[p0 := (seq(97, i9  => (map[true := cf12]))) + [v69, fm35(v62, 0x12c, f29, globalState), v69, v69]];
					...
					globalState.f1 := -(cf12 / cf12);
				}
				
				var v73: map<bool, bool> := map[f29 := p0];
				var v74: map<bool, bool> := map[p0 := if (p0 in v73) then v73[p0] else f29];
				var v75 := DC5(v73);
				var v76: seq<int> := [-|(fm34(globalState))[v2 := |map[v2 := v75]|]|, |"vlovo"|, |(seq(0x1f1, i10  => (v2)))|, v2, cf12];
				var v77: seq<bool> := [true];
				var v78: seq<map<bool, bool>> := [v74, v73, map[p0 := p0], map[f29 := p0], v74];
				var v79 := "wcbsbhcs";
				var v80: set<int> := {|v79|};
				var v81: array<bool> := new bool[27] [f29, p0, f29, false, if (p0 in v73) then v73[p0] else !fm29(globalState), !p0, f29, if (f29) then f29 else p0, |v76| > cf12, p0, v77[-512], f29, p0, p0, false, f29, |v78| > fm36(237, true, p0, f29, globalState), v80 == v80, !p0, p0, p0, !p0, -v2 >= v2, false, f29, !f29, p0];
				v81[446] := f29;
				v81[446] := false;
			...
			case DC5(cf10) =>
				...
				var v92: array<int> := new int[11](i11 => i11 / v2);
				var v93: seq<array<int>> := [v92];
				var v94: multiset<int> := multiset{v2};
				var v95 := DC7(!p0);
				var v96 := 'l';
				var v97: map<bool, string> := map[v95.cf11 := (seq(747, i12  => ('e')))[556 := v96]];
				var v98: array<int> := new int[23] [-0x28e, |v84|, v2, |v91|, v2, v2, |v84|, 172, if (p0 in v3) then v3[p0] else v2, v2, |v93|, v2, if (-0xc2 in v94) then v94[-0xc2] else v91[v2], |v97|, 0x95, |v84|, v2, |v84|, v2, v2, v2, |v84|, |v91|];
		...
		var v107: set<int> := {|(set v106 : int | v106 in v1 :: (v106 / |multiset([true, false, true])|))|};
		var v108 := DC22(v107);
		var v109: seq<multiset<int>> := [v102, multiset(seq(-0x38d, i16  => (|v103|)))];
		var v110: array<multiset<int>> := new multiset<int>[23] [multiset{v2, v2}, if (p0 in v100) then v100[p0] else v102, multiset(v103), multiset{|v1|, |v104|, v2, v2, -v2}, v102, if (f29) then multiset(v103) else v102, v102, if (v2 in v105) then v105[v2] else v102, multiset{v2}, v102, v102, fm37(f29, |v108.cf34|, v2, v2, globalState), multiset(v103 + v103), v102[-v2 := v2], multiset(v103 + (seq(-0xad, i14  => (v2)))), v102, (fm37(p0, v2, v2, |(seq(0x1cf, i15  => ('v')))|, globalState))[v2 := v2], v102, v109[v2], v102, v102 + v109[v2], multiset(v103) - v102, multiset{v2}];
		forall i13 | 0 <= i13 < v110.Length {
			v110[i13] := v102;
		}
		var v111 := "lkvesntl";
		var v112: array<string> := new string[8] [v111, fm33(globalState) + v111, ("rltnffrf" + v111)[-309 := 'w'], v111, v111, v111, seq(-0x3c0, i18  => ('b')), v111];
	...
	method m20(p0: array<array<bool>>, globalState: GlobalState) {
		if (if (f29) then false else f29) {
			...
			var v3: seq<bool> := [f29];
			v3 := v3;
			var v4: map<int, seq<bool>> := map[0x116 + v1 := v3[v1 := f29]];
			v4 := v4[0x178 := v3 + v3];
			var v5 := 'l';
			v5 := v5;
		} else {
			...
			globalState.f13 := (v15[-0x39] - v10) / -|v16|;
		}
		...
		v17[553], v20, v21 := v18, (v20 + (seq(0x157, i2  => (v19)))) + v20, v21;
		...
		for i3 := -(|v24| * v23) to fm36(v23, f29, !f29, f29, globalState) + v23 {
			...
			v25[398] := map[v19 := v23] + v26;
			v20 := v20 + (v20 + v20);
			v20 := (v20 + v20[0x24e := v19]) + (v20 + v20);
			var v27: multiset<int> := multiset{v23, i3};
			var v28: multiset<int> := multiset{i3, -|v20| % |v27|, v23 * |v20|};
			globalState.f1 := -|v27|;
		}
		for i5 := v23 to v23 {
			...
			var v32: seq<int> := [|v31|];
			globalState.f1 := -v23 / |(v31 + fm34(globalState))|;
...
class C2 extends T2 {
	...
	method m21(p0: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: array<bool>) {
		...
		if (v0.cf11) {
			...
			v1[750] := v2;
			v1[750] := v2;
			globalState.f4, globalState.f13 := f21, (p0 % f22) / p0;
			globalState.f1 := f22;
		...
		for i3 := p0 to v13[973] {
			var v16: array<bool> := new bool[24];
			v16[678] := f21;
			var v17 := "od";
			globalState.f4, r3, r1, globalState.f11, v16[678] := f21, v16, fm14('k', f21, globalState) == v13[973], true, (if (f21) then seq(0x19c, i4  => ('o')) else v17) <= v17;
			globalState.f1 := i3;
			var v18 := new C1(f21);
			if (true) {
				var v19 := 'o';
				...
				globalState.f4, globalState.f13, v13[973], r0 := f21 <== v16[678], i3, v13[973], p0;
				globalState.f13 := f22;
				var v25: array<char> := new char[7];
				v25[241] := v21;
				v25[241] := if (|v12[false := v13[973]]| <= p0) then 'q' else v19;
				var v26: multiset<int> := multiset{-0xef};
				var v27 := DC4(fm44(v13[973], v18.f29, globalState));
				...
				var v34: multiset<string> := multiset{v17, v33[-0x255]};
				v32 := v32[f22 * 266 := v34];
				r1 := v18.f29;
				r1 := v18.f29;
				var v35 := new C1(!(if (true) then v16[678] else !v18.f29));
			}
		...
		r1 := DC0(!f21).cf0;
		var v36 := "fdajne";
		r2 := fm45(v13[973] != v13[973], multiset{v36}, if (false) then f21 else f21, globalState);
...
class C3 extends T0, T2 {
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := f22 to |(v0 - fm27(globalState))| {
			if (!!f21) {
				...
				v1[713] := if (|multiset{true}| in v2) then v2[|multiset{true}|] else i0;
				v1[713] := -0x2f6;
				v1[713] := |{f26, p2}| + f22;
				var v3 := 's';
				var v4: array<string> := new string[2] [f27, f27[f22 := v3]];
				v4 := v4;
				var v5 := new C0(v1);
			} else {
				...
				globalState.f4 := |(seq(0x267, i1  => (|f27|)))| >= i0;
			...
			if (f21) {
				...
				var v12: seq<bool> := [f21, v11[i0]];
				var v13: map<D1, int> := map[fm30(p0, globalState) := i0];
				var v14: map<int, bool> := map[p1 := f21];
				var v15: array<int> := new int[16] [i0, -(if (fm29(globalState)) then p1 else p1), i0 - p1, f22, i0, if (p2) then v10.cf31 else f22, i0, p1, i0, i0, 537, |v11| / |"bsq"|, |v13|, |v14|, i0 % f22, f22 - i0];
				v15[445] := p1 - p1;
				v15[445] := (f22 / p1) + f22;
				globalState.f1 := p1;
				var v16 := DC2(f22);
				v16 := v16.(cf6 := |map[p2 := f26]| % |v11|);
				var v17 := new C1(!f21);
				globalState.f11, globalState.f13, v12, globalState.f4, globalState.f13 := v12[i0], -(p1 / |f27|) * --(p1 * v15[445]), (v12 + v11) + (v12 + v12), p2, v10.cf31;
			} else {
				var v18: array<bool> := new bool[5](i2 => false);
				v18 := p3;
				var v19 := 'w';
				globalState.f7 := new char[6] [v19, v19, v19, f27[fm14(v19, f26, globalState)], v19, v19];
				var v20 := DC7(f26);
				...
				var v24: map<bool, seq<bool>> := map[p2 := v23[f22 := f26]];
				var v25: map<int, int> := map[p1 := fm36(0x177, p2, p2, p2, globalState)];
				var v26: multiset<int> := multiset{f22};
				var v27: array<int> := new int[15] [f22, fm14(v19, f21, globalState), p1, |(if (p2) then f27 else f27)|, --p1, p1, -0x195, |(if (f26 in v24) then v24[f26] else v23)|, f22, i0 / |v25|, if (p2) then |v26| else i0, p1, p1, 0x9e, i0];
				v27[362] := -i0;
				...
				v30[234] := if (v27[362] in v32) then v32[v27[362]] else p0;
				v30[234] := fm40(globalState);
			}
		...
		match (v35) {
			case DC20() =>
				...
				var v38: set<int> := {p1};
				var v39 := 'f';
				var v40: map<bool, char> := map[v37[|v38|] := v39];
				var v42: map<int, set<int>> := map[0x25d := set v41 : int | v41 in map[p1 := true] :: (v41 + |"gwwtpa"|)];
				var v43: seq<int> := [f22];
				var v44: array<int> := new int[10] [f22, |v0| / v36.cf6, p1 + p1, |v40| % p1, -(0x1de * f22), f22, -|v42|, |v43|, fm36(-f22, p2, p2, p2, globalState), fm36(f22, p2, p2, f26, globalState)];
				v44[320] := fm14(v39, !p2, globalState);
				v44[320] := |f27|;
				var v45: array<set<int>> := new set<int>[26](i3 => v38);
				v45[142] := v38;
				var v46: set<string> := {f27 + f27, f27 + f27[v44[320] := v39]};
				globalState.f13, globalState.f1, v45[142], v46 := |p0|, -p1, fm41(globalState), v46;
				var v47: map<int, bool> := map[f22 := p2];
				v47 := v47[|{v43[-v44[320]], v44[320]}| + -v44[320] := if (f21) then f26 else f21];
				globalState.f11 := p2;
			case DC21(cf30, cf31, cf32, cf33) =>
				...
				var v57 := m18(v56, true, f22 % p1, if (cf30) then f26 else cf30, globalState);
			case DC19(cf29) =>
				globalState.f4 := fm29(globalState);
				var v58: set<int> := {|f27|};
				...
				if ((v59 + v59) > v59) {
					...
					globalState.f1 := -(f22 % p1);
					v62, globalState.f4, f27, globalState.f11 := v62, f21, ((seq(338, i6  => (v62))) + f27)[p1 := v62] + f27, f21;
					v0 := {f26} * v0;
				} else {
					globalState.f1 := p1;
					f27 := f27;
					...
					var v71: seq<int> := [|(seq(0x25c, i7  => ('p')))|, |v68|, |v70|, p1];
				...
				var v75: array<char> := new char[19](i8 => f27[f22]);
		...
		if (f26) {
			...
			globalState.f4 := !(f22 <= v79[f22]);
			var v80: array<int> := new int[13];
			var v81: map<int, int> := map[v79[p1] := fm36(p1, f26, f26, f21, globalState)];
			v80[39] := |v81| - f22;
			var v82: map<int, bool> := map[|p0| := p2];
			v80[39] := v79[-(0x3c9 - |v82|)];
			var v83: map<bool, bool> := map[fm29(globalState) := f21 || p2];
			var v84: map<bool, map<bool, int>> := map[true := v34];
			var v85 := 'd';
			v83 := v83[f21 := |v84| == |("ysjpwcjg")[0x92 := v85]|];
			var v86: set<char> := {v85, v85};
			var v87: seq<bool> := [f26];
			var v88: map<int, string> := map[f22 := f27];
			var v89 := DC10();
			var v90: multiset<D2> := multiset{v89};
			var v91: array<seq<bool>> := new seq<bool>[12] [[p2, p2], v87[|map[|v88| := DC18(v90, f26, v87, f21).cf28]| := false], v87, v87, v87, v87, v87, v87, v87 + v87, [f21], v87, v87];
			var v92 := DC18(v90[v89 := v80[39]], f26, v87, f26);
			v91[62] := v87 + v92.cf27;
			globalState.f11, v86, v91[62], globalState.f11, v80[39] := !(v80[39] != p1), v86, v87, p2, 0xaa - (f22 - v80[39]);
		...
		for i10 := if (f21 in p0) then p0[f21] else f22 to p1 - |v34| {
			...
			p3[552] := if (f21 in v109) then v109[f21] else f26;
			...
			decreases 100 - i11
		{
			...
			var v116 := DC1(false, -p1, |(map v113 : int | v113 in multiset{830} :: (v113 / f22) := (p1))|, f21 && f26, |v115|);
			var v117: seq<bool> := [false];
			var v118: set<string> := {f27};
			var v119: seq<int> := [|v118|, f22];
			var v120: map<seq<int>, bool> := map[v119 := true];
			var v121 := 'f';
			v112[357], v112[92], v116, f26, globalState.f11 := -v114.f22 / (|v117| / -f22), p1, if (!(if (p2) then v114.f21 else f26)) then v116.(cf5 := -f22, cf3 := |v120|) else v116, !(0xec < fm14(v121, p2, globalState)), f21;
			var v122: multiset<int> := multiset{v112[357], -p1};
			var v123: set<int> := {v112[357], v114.f22};
			...
			var v127: array<bool> := new bool[20] [!(true && v114.f21), v114.f21, v114.f21, f21, p2, v122 <= v122, !(v123 < v123), if (f21) then fm43(p1, f21, |v124|, globalState) else f26, if (f21) then !f21 else v117[0x44], f26, f26, |v125| != -v112[357], v122 > v122, true, true, !(multiset{v119} > v126), f26, f21 in v117, v114.f21, v114.f21];
			var v128: array<set<int>> := new set<int>[20];
			v128[204] := v123;
			globalState.f11, v127, v128[204], v127, globalState.f4 := v114.f21, v127, v123 - (v123 * v123), p3, v114.f21;
			var v129 := DC20();
			match (v129) {
				case DC20() =>
					v114.f22 := (v114.f22 + p1) % (v114.f22 / f22);
					...
					globalState.f1, v132, globalState.f11, globalState.f1, v112[357] := f22, v132, v114.f21, p1 - f22, v114.f22;
				case DC21(cf30, cf31, cf32, cf33) =>
					v127[603] := !f26 && cf32;
					var v133: array<char> := new char[19];
					globalState.f11, v127[603], globalState.f7 := [false] != v117, cf31 != 919, v133;
					globalState.f11 := v127[603];
					...
					globalState.f1 := f22;
				case DC19(cf29) =>
					var v137: array<multiset<int>> := new multiset<int>[10] [if (fm29(globalState)) then v122 else v122, fm37(v114.f21, f22, v112[357], |v123|, globalState) + v122, multiset(v119), v122, multiset([f22]), v122, v122, v122, v122, multiset{|map[v114.f21 := !f21]|, v114.f22}];
					var v138: seq<multiset<int>> := [v122];
					v137[685] := ((v138[p1])[0x250 := v114.f22])[-|f27| := v112[357]];
					var v139: seq<string> := [f27];
					var v140 := DC10();
					var v141: multiset<D2> := multiset{v140, v140};
					var v142: map<bool, bool> := map[v114.f21 := v117[v114.f22]];
					var v143 := DC18(v141, true, v117, if (f21 in v142) then v142[f21] else p2);
					v137[685], globalState.f13, globalState.f11, globalState.f4, f26 := multiset{|v0| - v114.f22, f22}, v114.f22 + v114.f22, false, fm42(|v139|, f26, p2, v114.f22, globalState) > (v0 - v0), v143.cf28;
					globalState.f4 := !p2;
					globalState.f11 := f21;
					v112[357] := v119[v114.f22 * v114.f22];
			}
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		if (|(fm46(f22, 254, f21, f21, globalState) + v1)| >= f22) {
			...
			v4, v5[123], f22, v7, v8[851] := ((map v9 : seq<int> | v9 in (map v10 : seq<int> | v10 in v11 :: (v10) := (f22)) :: (v9) := (f21)) + map[v3 := true]) + v4, (f27 + f27) == f27, |map[-0x8 := f21]|, v7 * v7, if (f26) then v6 else v6;
			var v12: map<int, int> := map[-f22 := f22];
			var v13: map<bool, bool> := map[f21 := f26];
			var v14 := DC0(f26);
			var v15: map<bool, int> := map[v5[123] := f22];
			v5 := new bool[22] [f26, f21 <==> f21, f26 <== !f21, fm43(-f22, f26, if (|v13| in v12) then v12[|v13|] else f22, globalState), f26, f26, v14.cf0, f26, v5[123], v5[123], f26 in v15, 744 >= f22, if (fm29(globalState)) then f26 else f21, |v12| != f22, false, f26, f21, f26, v5[123], v5[123], f21, true];
			if (v15 != v15) {
				var v16 := DC2(f22);
				var v17 := DC4(v16);
				...
				v22[392] := f27;
				v8[851][55] := f22 % |v1|;
				var v23: seq<multiset<int>> := [v2, multiset(v3) - v2, fm37(f26, v3[0x398], -0x125, f22, globalState)];
				var v24: T1 := new C1(f21);
				v22[392], v8[851][55], v23, v5[123], v24 := f27 + f27[f22 := v19], |v12|, ((v23 + (seq(0xd4, i0  => (v2)))) + v23)[|("htwh" + f27)| := v2], !f21, v24;
				...
				globalState.f1 := |v1|;
				v8[851][595] := |f27| - f22;
				v8[851][595] := |(f27 + f27)| - -(f22 * f22);
				var v27 := new C0(v6);
				v5[123] := true;
				var v28: array<map<bool, bool>> := new map<bool, bool>[9];
				v28[332] := fm25(f27, true, v8[851][595], f21, globalState);
				r0, globalState.f13, v28[332], r0 := |(if (v5[123]) then v2 else v2)|, -0x346, v13[v5[123] := v5[123]] + v13, 0x325;
			}
			
			var v29 := new C1(v5[123]);
			f27 := f27;
		} else {
			f27 := f27 + (seq(-0x1c8, i1  => ('a')));
			var v30 := 'u';
			v0 := v0[fm14(v30, f21, globalState) := !f21];
			var v31: map<bool, bool> := map[f21 := f21];
			var v32: seq<int> := [831];
			var v33 := DC2(f22);
			globalState.f13, globalState.f11, v31, globalState.f4 := v32[v33.cf6] + f22, f21, (v31 + v31) + map[false := f21], !(!v1[f22] || f26) ==> fm29(globalState);
			globalState.f4 := f21;
			var v35: set<int> := {f22};
			var v36: array<int> := new int[21];
			var v37: multiset<array<int>> := multiset{v36};
			var v38: map<bool, multiset<array<int>>> := map[DC22(set v34 : int | (0x9f <= v34) && (v34 < -0x38b) :: (v34 % f22)).cf34 > v35 := v37 - v37];
			v38 := v38[f26 := v37 - v37];
		}
		...
		if (f21) {
			...
			if (f22 != -|v40|) {
				...
				var v43: map<int, seq<int>> := map[v42.cf22 := seq(-426, i3  => (f22))];
				...
				v41[280], globalState.f14, globalState.f1, globalState.f1, v46 := (f22 * (if (f21 in v47) then v47[f21] else |v48|)) + f22, v47, fm14('a', fm43(fm14(v39, f26, globalState), f26, |v48|, globalState), globalState), (f22 % f22) * (-0x123 / f22), [v45];
				var v49: array<string> := new string[5] [f27, f27, if (f26) then "lomo" else f27, f27 + f27, f27[v41[280] := 'h']];
				v49[915] := "ommt";
				v49[915] := "ibwjmvb" + (f27 + ("k")[v41[280] := v39]);
				var v50 := new C0(v41);
				...
				f27, v54[629], v54[766], v54, v55 := "jdrj", |v56|, |(map[v57.cf20 := v1] + v58.cf42)|, v59[f22], v55;
				var v60: seq<int> := [f22];
				var v61: multiset<int> := multiset{v54[629] - |map[f22 := -|v60|]|};
				v61 := v61 * v61;
			...
			var v69 := new C0(v68[0xc8]);
			var v70: array<char> := new char[1](i5 => 'e');
			var v71 := 'l';
			v70[254] := v71;
			globalState.f1, f26, v70[254] := f22, f27 <= ("tkkdqrdhe" + "csuu"), v71;
			...
			var v75: multiset<int> := multiset{0x20d, fm14(v70[254], fm43(|f27[f22 := v71]|, f21, f22, globalState), globalState)};
			...
			decreases 100 - i6
		{
			...
			i6 := i6 + 1;
			var v78 := 'u';
			var v79: array<bool> := new bool[13] [f21, true, v1[f22], f21, f22 < f22, f26, fm14(v78, f26, globalState) == f22, f21, f26, if (f26) then f26 else !f26, v78 in f27, if (!f21) then f21 else f26, f26];
			v79[468] := f21 ==> f26;
			globalState.f11, v79[468], globalState.f11, globalState.f1 := f21 || f21, !fm29(globalState), f22 != -f22, f22;
			var v80 := DC21(f21, f22 * -f22, v79[468], v79[468]);
			...
			v81[715] := v83.cf49[|f27| := v84];
			v81[715] := (map[0x147 := {v78, v78}] + v82) + v82;
			...
			var v88: map<int, int> := map[|v87| % f22 := f22];
			v88, v79, v79[468], f22 := map v89 : int | (0x88 <= v89) && (v89 < 999) :: (v89 - f22) := (0x3e4), v79, (if (f26) then v1 else v1) < (v1 + v1), |(f27 + (f27 + f27))|;
		}
		var i8 := 0;
		while (!f21)
			decreases 100 - i8
		{
			...
			v100 := v100[[f21, !f21, f26, !f26, !(if (|(seq(0x1ee, i9  => (DC3({f21}, f22))))| in v0) then v0[|(seq(0x1ee, i9  => (DC3({f21}, f22))))|] else f21)] := v99];
			f26 := false;
		}
		var v101: multiset<bool> := multiset{f26, f21, f26};
		var v102: seq<multiset<bool>> := [v101];
		if (v102 != (seq(518, i10  => (multiset{f21})))) {
			...
			if (f26) {
				...
				v110[919] := !fm43(|v111|, fm43(f22, f26, fm14(v112, f21, globalState), globalState), |v113|, globalState);
				v110[919] := f26;
				f22 := fm36(|f27|, true, f26, !f21, globalState);
				var v114: set<bool> := {v110[919], f21};
				...
				v110[908] := v0 == (map v119 : int | v119 in v120 :: (v119 + v120[f22]) := (f26));
				v110[908] := fm29(globalState);
				var v121: map<int, int> := map[f22 := f22];
				var v122: map<bool, bool> := map[v118 := v110[908]];
				var v123: seq<map<int, int>> := [v121, v121[f22 := |v122|], v121, v121];
				var v124: multiset<seq<int>> := multiset{v120, [f22], v120};
				var v125: array<bool> := new bool[14] [f26, f26, v110[908], DC1(f21, 0xaf, f22, f26, f22).cf4, f26, f21, false, f26, !(if (f21) then f21 else v118), v1[|v123|], true, f22 < f22, v110[908], !(v124 >= v124)];
				v125 := v125;
				f26 := f26;
			}
			...
			r0 := f22;
			var v126 := 'a';
			v110[327] := if (|f27[f22 := v126]| in v0) then v0[|f27[f22 := v126]|] else f21;
			v110[327] := fm43(f22, f21, |(v101 + multiset{f26, f26})|, globalState);
			var v127: array<int> := new int[16](i12 => i12 % f22);
			v127[366] := f22;
			v127[366] := f22;
		}
	...
	method m18(p0: array<char>, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		var v4: array<int> := new int[11] [--f22, f22, fm36(p2, f26, !p1, f26, globalState), (v2.(cf55 := f26)).cf56, f22, |(seq(0x6c, i0  => (v0)))|, 0x1fb, |v3|, f22, fm14('p', f21, globalState), p2];
		...
		if (!(v4 !in (if (!false) then v5 else [v4]))) {
			...
			globalState.f13 := p2;
			v4[715] := |multiset(seq(404, i1  => (|v1|)))|;
			var v10: set<string> := {seq(-0x2af, i2  => (f27[p2])), f27};
			v4[715] := -|v10|;
			var v11: set<bool> := {f26};
			var v12: map<int, int> := map[v4[715] := f22];
			var v13: multiset<bool> := multiset{f26, p1, f26, f26};
			var v14 := DC3(v11, |v13|);
			var v15: map<int, set<bool>> := map[|v12| := v14.cf7];
			if ((v11 - (if (v4[715] in v15) then v15[v4[715]] else v11)) !! v11) {
				...
				var v30: map<seq<bool>, int> := map[v29 + v29 := v4[715]];
				v30 := v30[v29 := p2 - -f22];
				var v31: multiset<seq<bool>> := multiset{v29 + v29, [!p3, !p3, f26, f21, f26] + v29};
				var v32: seq<seq<bool>> := [v29, fm46(f22, |(seq(0x27e, i3  => (v4[715])))|, p3, p3, globalState)];
				v31 := multiset(v32);
			}
			
		} else {
			var v33: seq<bool> := [!f21, f26];
			globalState.f1 := --v3[|v33| + |v33|];
			f22 := f22;
			var v34: array<bool> := new bool[8];
			v34[426] := f26;
			globalState.f1, v34[426], f26, r0 := f22, false, p1, f26;
			if (false) {
				...
				v34[426] := |(v43[v42 := v4] + (map[v42 := v4])[DC15(("bwqvp")[f22 := v0], 0x205, f27, |v44[p2 := p3]|) := v4])| != f22;
				v4[308] := f22;
				v4[308] := p2;
				v34 := new bool[18](i4 => (if (f22 in v1) then v1[f22] else |{p2, f22}|) < |map[p3 := p2]|);
				f27, v34[426] := (seq(158, i5  => (v0)))[v4[308] := v0] + (f27 + f27), f21;
				var v45: multiset<bool> := multiset{v34[426], p3};
		...
		for i6 := p2 % p2 to p2 {
			...
			var v51 := DC15(f27, i6, seq(-0x2aa, i7  => (v0)), |v50|);
			var v52: set<D2> := {v48.(cf13 := v49[v51.cf20])};
			v52 := v52;
			globalState.f4 := !f21;
			f27 := f27;
		}
		var v53: set<char> := {v0};
		var v54: map<int, set<char>> := map[v3[p2] := v53];
		var v55 := DC31(v54);
		if (match v55 {
			...
			if (f21) {
				...
				var v57 := DC20();
				v57 := v57;
				var v58 := new C2(f21, |(f27 + (seq(-459, i8  => (v0))))|);
				...
				var v62: map<int, char> := map[|(seq(0x2a6, i9  => (v0)))| := v0];
				v61[911] := v62 == (map v63 : int | (512 <= v63) && (v63 < 0x3dc) :: (v63 % |map[-v3[f22] := p1]|) := (v0));
				v61[911] := f21;
				v0 := v0;
			}
			...
			v67 := v67[|(map v68 : int | (340 <= v68) && (v68 < 0x57) :: (v68 + |map[p2 := v0]|) := (p2))| + (if (f22 in v67) then v67[f22] else -f22) := v3[p2]];
		} else {
			var v69 := DC10();
			match (v69) {
				case DC10() =>
					var v70: map<bool, int> := map[f21 := f22 + p2];
					globalState.f13, globalState.f13 := if (p1 in v70) then v70[p1] else p2 * p2, 0x261 / (f22 / p2);
					var v71: set<bool> := {f21, fm29(globalState), p3};
					var v72: multiset<bool> := multiset{f26};
					var v73: seq<multiset<bool>> := [v72];
					var v74 := DC3(v71, f22 % |v73|);
			...
			var v81: seq<set<int>> := [v78, set v80 : int | v80 in v79 :: (v80 / |multiset{|map[0x125 := false]|}|)];
			...
			decreases 100 - i11
		{
			...
			match (v93) {
				case DC32() =>
					...
					var v99 := DC11(v1[p2 := p2] + fm37(p3, f22, |v97[p2 := f21]|, |v98|, globalState));
					v99 := if (p1 <==> f21) then DC11(v1[if (p2 in v1) then v1[p2] else p2 := p2]) else if (p1) then v99 else v99.(cf14 := multiset{f22});
					var v100: seq<string> := [f27];
					globalState.f1 := |v100| * f22;
					var v101: map<bool, int> := map[f21 := f22];
					v4[126] := if (p3 in v101) then v101[p3] else |map[f21 := f21]|;
					v4[126] := f22 / f22;
				case DC33(cf50, cf51, cf52, cf53) =>
					var v102: seq<bool> := [false];
					f26 := [f21, cf51] < v102;
					cf50 := |v3|;
					globalState.f13 := p2 / (f22 % |f27|);
					v4 := v4;
				case DC31(cf49) =>
					globalState.f4 := f21;
					...
					v103[516] := p3;
					globalState.f1, v103[516] := (f22 % v3[f22]) * (fm36(p2, f26, p1, p1, globalState) - |f27|), f22 in v3;
					var v104: array<set<int>> := new set<int>[12];
					v104[428] := fm41(globalState);
			...
			if (p3) {
				...
				var v111: array<string> := new string[17] [f27 + f27, f27, (seq(-0x202, i12  => (v0)))[v109.fm28(DC9(f27), globalState) := v0], f27, seq(882, i13  => (v0)), f27, f27 + f27, f27, f27, f27, f27, fm33(globalState), f27, f27, (seq(795, i14  => (v0))) + f27[0x1e1 := v0], f27, fm45(f26, v110, false, globalState)];
				v111[547] := fm45(p1, multiset{f27}, p1, globalState);
				v111[547] := "du";
				var v112: map<bool, bool> := map[p3 := true];
				var v113: set<bool> := {p1};
				var v114: seq<map<bool, bool>> := [v112, fm25(DC15(seq(120, i15  => (v0)), |v112|, f27, |v113|).cf21, f21, |fm45(p3, multiset{v111[547], f27}, p3, globalState)|, true, globalState)];
				v114 := seq(22, i16  => (v112 + map[!!f21 := p1]));
			} else {
				var v115: set<int> := {0x29d, p2 / 80};
				v115 := v115;
				...
				var v120: array<bool> := new bool[24] [f21, f26, p2 >= 0x2a4, true, p1, v116[915][p2], p1, p2 > f22, p3, p1, f26, true, f21, f26, false !in fm50(v3, v118, globalState), !(|v119[f21 := map[true := f22]]| >= |v1|), f21, true, p1, p3, p3, !f26, fm43(f22, f26, p2, globalState), fm43(|v1|, f21, p2, globalState)];
				v120[463] := f26;
				v120[463] := fm29(globalState);
				globalState.f4 := f26;
			}
			...
			globalState.f1 := if (true ==> f26) then |v124| else |v125| % f22;
		}
...
class C4 {
	...
	method m16(globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: int) {
		...
		for i0 := v1 to v1 {
			...
			var v3: array<int> := new int[10](i1 => i1 % i0);
			r1 := v3;
		}
		...
		if (v4 !in v5) {
			...
			if (f24) {
				...
				v9 := v9;
				var v10 := "a";
				v10 := (seq(0x8f, i2  => ('n'))) + v10;
				v10 := v10;
				var v11 := new C2(v7[216], v1);
			} else {
				var v12 := DC7(f24);
				var v13: map<D1, bool> := map[v12 := true];
				v13 := v13[v12 := !f24];
				var v14: array<int> := new int[13](i3 => i3 + v1);
				var v15: map<bool, string> := map[f24 := seq(0x236, i4  => ('l'))];
				v14[155] := |v15| * v1;
				var v16 := "d";
				v14[155] := |v16|;
				...
				var v18: seq<T2> := [v17];
				var v19 := 'v';
				var v20: seq<int> := [|v16[v14[155] := v19]|];
				var v21: map<bool, seq<int>> := map[[v17] != v18 := v20];
				v21 := v21[true := seq(0x2b9, i5  => (v14[155]))];
				v16 := fm33(globalState);
				var v22: map<int, seq<bool>> := map[v20[v1] := [f24, v17.f21]];
				var v23 := DC28(v22);
			...
			var v31 := "xdfqdxh";
			var v32: map<string, int> := map[v31 := v1 % v1];
			...
			globalState.f4, globalState.f11, globalState.f1, r1, v35 := if (f24) then f24 else f24, !f24, |v36[v1 := 'b']| * -|(v37 * fm41(globalState))|, v38, v35;
			globalState.f1 := v1;
			var v39: array<string> := new string[26](i6 => v36 + v36);
			v39[514] := v36;
			var v40: multiset<int> := multiset{v1};
			v39[514], globalState.f4 := (v36 + v36) + v36, v40 !! v40[|v36| := v1];
			var v41: seq<array<int>> := [v38];
			var v42: seq<array<int>> := [v41[|v39[514]|]];
			r1 := v42[v1];
		}
		...
		if (f24) {
			...
			var v56: set<int> := {v1, fm36(v1, v52[265], v52[265], v52[265], globalState)};
			v53 := fm45(!(v1 >= v1), v55, v56 >= v56, globalState);
			var v57: map<bool, array<bool>> := map[if (f24) then v51[|DC9(v53).cf13|] else f24 := v52];
			v57 := map[f24 := v52];
		...
		v59[336] := |(([f24, f24])[|v61| := true] + v62)|;
		v59[336] := v1;
		var v63: array<bool> := new bool[25];
		var v64: map<array<bool>, D2> := map[v63 := DC10()];
		var v65 := DC26(v64);
		v63[626] := f24;
		v65, v63[626], globalState.f4 := v65, v59[336] >= v59[336], true;
		r0 := f24 !in v62;
		r1 := v59;
		r2 := 0x26f + v59[336];
	}
	method m17(p0: int, p1: int, globalState: GlobalState) {
		...
		var v1 := "nsjg";
		v0 := ((seq(0x90, i0  => ("oxgua"))) + v0[p1 := v1])[-p1 := v1];
		...
		match (v3) {
			case DC32() =>
				...
				match (v6) {
					...
					case DC17(cf24) =>
						...
						globalState.f11 := v14[p0] == (if (f24) then v13 else v13);
						globalState.f11 := f24;
						v1 := seq(0xa8, i2  => ('w'));
						globalState.f11 := f24;
				}
			...
			case DC33(cf50, cf51, cf52, cf53) =>
				if (f24 <==> cf51) {
					var v15 := DC21(cf51, p0 % (fm24(globalState)).cf5, cf52, f24);
					v15 := v15;
					...
					var v28: seq<int> := [v20];
					var v29: map<int, multiset<set<int>>> := map[|(seq(0x3c9, i4  => ('u')))| := v22];
					var v30: map<seq<int>, multiset<set<int>>> := map[v28 := if (cf50 in v29) then v29[cf50] else v22];
					var v31: seq<bool> := [v18];
					var v32: array<multiset<set<int>>> := new multiset<set<int>>[27] [v22, if (!cf51) then v22[{p1, cf50} := cf50] else v22, multiset{{cf50}} + v22, v22, multiset(v24), if (v25.cf43) then v22 else v22, v22, v22 - v22, multiset{{|(seq(-495, i3  => ('u')))|}, {p1, |v26|, -p1}, v21, set v27 : int | (35 <= v27) && (v27 < 0x106) :: (v27 + p0)}, v22, v22 - v22, v22, v22[v21 := p1] + v22, v22, v22, multiset{{p0, p0, |"nmjb"|, cf50}}, v22 - v22, v22, v22, multiset{v21, v21}, v22, v22, if ([-0x181, |v31|, v20] in v30) then v30[[-0x181, |v31|, v20]] else fm51(globalState), v22, fm51(globalState), if (false) then multiset(seq(0x108, i5  => (v21))) else v22[v21 := p0], v22 - v22];
					v32[92] := multiset(v24) * multiset{set v33 : int | v33 in v21 :: (v33 / |map[false := true]|), v21};
					v32[92] := v22 * v22;
					var v34 := new C1(f24);
				}
				...
				v37[535] := |v38| - |v40|;
				globalState.f13, v37[535] := -p0 * p0, p0;
			...
			case DC31(cf49) =>
				...
				var v57: seq<int> := [p1];
				globalState.f13, globalState.f13, v2[122] := p0 + -|v48[v47 := f24]|, fm36(-p0, if (p1 in v51) then v51[p1] else f24, f24, f24, globalState), if (DC25(v56) in v55) then v55[DC25(v56)] else !(v57 == v57);
		...
		globalState.f13 := (p0 / |(seq(234, i7  => ('u')))|) * p0;
		var v63 := DC15(v1, p0, "ta", |v1|);
		globalState.f1 := p1 - (--v63.cf20 % p1);
	}
}
...
class C5 {
	...
	method m14(p0: seq<char>, p1: map<array<int>, int>, p2: int, p3: bool, globalState: GlobalState) returns (r0: int) {
		...
		var v2: multiset<int> := multiset{p2 % p2, --|v1| - 203, |v1|};
			...
			decreases 100 - i1
		{
			...
			if ((p3 && p3) || false) {
				var v4: map<bool, int> := map[v1[p2] := 0xbd];
				r0 := if (p3 in v4) then v4[p3] else p2 / p2;
				...
				var v12: set<int> := {|v11|};
				var v13: array<int> := new int[8] [p2 - |v9|, 609, if (p3) then p2 else -p2, p2, -(p2 + p2), p2 % p2, p2 - |v12|, p2];
				v13 := v13;
				globalState.f1 := p2;
				globalState.f11 := ("uc" + (seq(-0x397, i2  => (v10)))) < p0;
				var v14: set<bool> := {true};
				v13[691] := |v14|;
				var v15: seq<string> := [p0, p0, p0];
				v13[691] := |[p3, |p0| <= |v15|, p3]|;
			}
			
			var v16: array<int> := new int[12](i3 => i3 + (if (p2 in v3) then v3[p2] else p2));
			v16[584] := p2;
			var v17 := DC8(p2);
			globalState.f11, v16, v16[584], globalState.f1, globalState.f1 := p3, v16, -v17.cf12, p2, p2;
			var v18: set<int> := {|fm46(p2, v16[584], p3, p3, globalState)|};
			var v19 := DC7(p3);
			var v20: array<D1> := new D1[24] [v19, DC7(p3), v19, v19, DC7(p3), DC7(v1[p2]), v19, v19.(cf11 := p3), fm52(v16[584], p3, globalState), v19, v19.(cf11 := p3), v19.(cf11 := p3), v19, v19, DC7(p3), v19, v19, DC7(true), v19, DC7(p3), v19, v19, v19, v19];
			var v21: seq<seq<char>> := [p0];
			var v22: map<int, seq<char>> := map[v16[584] := v21[v16[584]]];
			v20[533] := fm52(|v22|, p3, globalState);
			v0[547] := p3;
			v18, v20[533], v0[547] := v18, v19, p2 > -0x32;
		}
		var v23 := DC21(p3, p2, p3, p3);
		globalState.f1 := v23.cf31;
		var v24: array<set<char>> := new set<char>[5];
		forall i4 | 0 <= i4 < v24.Length {
			v24[i4] := DC42(set v26 : char | v26 in (map v25 : char | v25 in map['x' := p3] :: (v25) := (p3)) :: (v26)).cf63 - ({p0[p2]} * {'w'});
		}
	...
	method m15(p0: string, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			v3[622], globalState.f1, globalState.f1, r0, r1 := if (v4 in v5) then v5[v4] else v0, p2, -p2, false, p1;
			var v6: multiset<char> := multiset{v0, v0};
			v6 := multiset{v3[622], v0, v0} + (v6 - v6);
			v4[18] := p2 % p2;
			v4[18] := (|"ek"| / p2) % p2;
			r0 := p1 ==> DC1(p1, v4[18], |f23|, p1, p2).cf1;
		}
		var v7: array<bool> := new bool[17];
		var v8: set<array<bool>> := {v7, v7, v7};
		var v9: map<string, set<array<bool>>> := map[(seq(-484, i2  => (v0)))[p2 := p0[|[fm36(p2, p1, !p1, true, globalState)]|]] := v8];
		...
		v22[881] := p2;
		var v23 := DC4(DC0(p1));
		v22[881] := -|(match DC12(v23, p2, false).(cf16 := p2) {
			case DC12(cf15, cf16, cf17) => v19
			case DC13() => v19
			case DC11(cf14) => v19
		})|;
		var v24: set<int> := {v22[881], p2, p2, p2};
...
class C6 extends T1, T0, T2 {
	...
	method m4(p0: string, p1: bool, p2: set<bool>, globalState: GlobalState) returns (r0: char, r1: bool, r2: string, r3: bool) {
		...
		match (v0) {
			...
			case DC9(cf13) =>
				var v7 := 'p';
				var v8: multiset<int> := multiset{f22, |p2| - |cf13[fm14(v7, f21, globalState) := v7]|};
				var v9 := DC11(v8);
				v8 := v9.cf14 * v8;
				var v10, v11 := m13(globalState);
				var v12: seq<bool> := [v11, v11];
				var v13: map<int, seq<bool>> := map[|v12| := v12 + v12[v10 := true]];
				v13 := v13[f22 := [p1, v11]];
				var v14: map<bool, bool> := map[p1 := v12[v10]];
				var v15: array<set<bool>> := new set<bool>[7] [p2, p2, {fm16(p1, v0, v14, globalState), f21}, {f21}, p2, if (v11) then p2 else p2, p2 - p2];
				v15[306] := p2;
				v15[306], v11 := if (f21) then p2 else p2, p1;
		}
		...
		for i1 := f22 to f22 {
			if (p1) {
				...
				v16[623] := -i1;
				v16[623] := i1 / fm15(|p0|, i1, |"rcac"|, i1, globalState);
				globalState.f11 := p1;
				v16[623] := f22 % (f22 / |p2|);
				var v17: map<bool, bool> := map[false := f21];
				var v18: seq<bool> := [false, fm16(f21, v0, v17, globalState)];
				var v19: multiset<bool> := multiset{f21, f21, v18[i1]};
				v16[623] := |(v19 - fm17(globalState))|;
				var v20: set<int> := {|"vo"|, 822};
				v16[623] := fm14(p0[|v20|], f21, globalState);
			} else {
				var v21 := 'i';
				...
				var v39: seq<map<int, int>> := [map v37 : int | (0x1d <= v37) && (v37 < 135) :: (v37 % i1) := (f22), v38];
				var v40: map<int, map<bool, map<bool, D3>>> := map[|v39[f22]| := v35];
				var v41: map<bool, char> := map[f21 := v21];
				v25[504], globalState.f1, v29, globalState.f11 := v26, |(v36.cf18 + (v35 + (if (|p0| in v40) then v40[|p0|] else v35)))|, v29, !fm16(|p0| <= |v41|, v0, v27, globalState);
			}
			...
			decreases 100 - i3
		{
			...
			v46[353] := p1 <== p1;
			v46[353] := (DC9(p0).cf13 < p0) || p1;
			var v47: set<char> := {'e'};
			var v48: multiset<bool> := multiset{f21};
			var v49 := 'k';
			v47, globalState.f14, r0 := fm19(p1, if (v46[353]) then p0 else p0, v48, !(v46[353] ==> f21), globalState), fm17(globalState), v49;
			globalState.f1 := (fm20(globalState)).cf8;
			globalState.f11, v46[353] := v46[353], f21;
		}
		globalState.f11 := !p1;
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		if (v0 in v1) {
			...
			p3[429] := !f21;
			var v5 := DC43(v4);
			v4, p3[429], r0 := v5.cf64, p2, -949;
			v1 := v1;
			if (f21) {
				var v6: map<int, bool> := map[p1 := f21];
				v6 := v6 + v6;
				var v7: map<bool, bool> := map[f21 := p3[429]];
				var v8: seq<bool> := [if (p3[429] in v7) then v7[p3[429]] else p2, false, p3[429]];
				globalState.f4 := |v8| == DC8(|v8|).cf12;
				var v9: array<int> := new int[5](i0 => i0 % p1);
				...
				var v17: seq<bool> := [false, p3[429]];
				var v18: seq<multiset<bool>> := [multiset(v17), p0, multiset{p3[429]}, p0, p0];
				var v19: map<int, int> := map[f22 := f22];
				var v20: seq<string> := ["jdobvq"];
				globalState.f4 := multiset{true, f21} >= (v18[if (|v20| in v19) then v19[|v20|] else f22] - p0);
				globalState.f4 := v17[|(seq(-939, i1  => (v0)))| - p1];
				var v21: map<int, bool> := map[fm36(fm36(f22, p3[429], p3[429], !f21, globalState), !p3[429], p2, p2, globalState) := p2];
				v21 := v21[f22 := p3[429]];
				var v22: array<D2> := new D2[26];
				var v23: array<array<D2>> := new array<D2>[6] [v22, v22, v22, v22, v22, v22];
				v23[697] := if (f21) then v22 else v22;
				var v24: map<bool, bool> := map[p2 := -p1 != f22];
				var v25: multiset<string> := multiset{seq(-0x1f1, i2  => (v0))};
				globalState.f4, v23[697], globalState.f11, v1, v24 := DC33(f22, p3[429], !f21, p3[429]).cf52, v22, v1[p1] !in (fm45(p3[429], v25, f21, globalState) + v1), v1 + v1, v24;
				var v26 := DC0(p2);
				var v27: map<string, D0> := map[v1[f22 := v0] := v26];
				v27 := v27[v1 + v1 := DC0(p3[429])];
			}
			
			globalState.f4 := f21;
			var v28: array<bool> := new bool[18](i3 => p2);
			var v29: seq<array<bool>> := [v28];
			var v30 := DC21(v29 <= ([v28, v28, v28, v28, v28])[f22 := v28], f22, f21, p3[429]);
			v30 := fm48(globalState);
		} else {
			var v31: seq<bool> := [p2];
			globalState.f4 := fm43(0x2ad, p2, |v31| % |"nfxeejwcg"|, globalState);
			globalState.f13 := f22;
			if (p2) {
				v1 := v1;
				...
				v33 := fm54(v34, "ntvofahyx" + v35.cf21[f22 := v0], |(seq(0x2db, i4  => (v0)))| > -fm15(|v1|, f22, p1, f22, globalState), p2, globalState);
				p3[83] := f21;
				var v36: map<bool, bool> := map[f21 := v0 in v1];
				var v37: array<seq<bool>> := new seq<bool>[17](i5 => v31 + v31);
				v37[493] := v31;
				globalState.f11, p3[83], v36, v37[493] := fm29(globalState), f22 == -541, v36, [f21, p2, 'j' in v1, f21, f21];
				var v38: seq<int> := [|v1|, f22, f22, p1, p1];
				var v39 := DC34(v38 + v38);
				v39 := v39;
				var v40: array<set<int>> := new set<int>[16];
				v40[619] := set v41 : int | (-809 <= v41) && (v41 < 647) :: (v41 % f22);
				...
				v44, globalState.f11, globalState.f4, globalState.f11 := if (v31[|multiset(v46)|] in v45) then v45[v31[|multiset(v46)|]] else p3, f21, p2, p2;
				...
				globalState.f1, v47, v48, globalState.f11 := (if (p2) then p1 else f22) % |(if (p2 in v50) then v50[p2] else {p1, |v51|, if (|v1| in v51) then v51[|v1|] else -f22, f22})|, v47, fm55("rdtld" + v1, if (p2) then |"y"| else |v52|, globalState), f21 <==> p2;
				v47 := v47;
			}
		...
		v54 := v54;
		if (fm29(globalState)) {
			var v55: map<bool, int> := map[if (p2) then f21 else f21 := -(p1 / p1)];
			v55 := v55[!p2 := p1 * p1];
			if (p2) {
				globalState.f4 := p2;
				var v56: seq<array<bool>> := [p3];
				var v57: seq<int> := [f22];
				var v58: map<seq<array<bool>>, int> := map[v56 := v57[p1] - f22];
				v58 := v58[[p3, p3, p3] := f22];
				globalState.f4 := !!f21;
				v1 := v1;
				var v59: map<array<bool>, bool> := map[p3 := f21];
				var v60 := DC36(p3);
				p3[401] := if (v60.cf57 in v59) then v59[v60.cf57] else p2;
				p3[401] := if (f21 <== f21) then false else p2;
			} else {
				...
				globalState.f13 := p1;
				var v62: seq<int> := [f22];
				globalState.f1, globalState.f1 := f22 - p1, -v62[f22];
				var v63 := DC9(seq(-875, i8  => (v0)));
			...
			v68 := ((seq(0x2c3, i9  => (p1))) + ([160, if (f22 in v74) then v74[f22] else |v1|] + v68))[p1 := 0x2ff];
		} else {
			var v75 := DC2(f22);
			var v76: C4 := new C4(f21, DC4(v75));
			var v77: set<C4> := {v76};
			var v78: seq<set<C4>> := [v77];
			var v79: seq<set<C4>> := [v77, v77, {v76}, v77, v78[f22]];
		...
		var v86: seq<bool> := [v1 <= v1, v1 <= (seq(260, i12  => (v0))), f21];
		var v87: set<bool> := {f21};
		var v88: set<string> := {v1, "sixtyttt", v1, v1[f22 := v0], v1};
		globalState.f13, v86 := f22, fm46(|v87| / p1, |v86|, f21, fm57(f21, fm43(p1, p2, p1, globalState), |"bf"|, globalState) !! v88, globalState);
		var i13 := 0;
		while (f21 && f21)
			decreases 100 - i13
		{
			...
			globalState.f13 := -((|(fm46(f22, p1, p2, p2, globalState))[f22 := p2]| - -|v92|) - (819 % f22));
			v1 := v1 + v1;
			...
			var v101 := DC29(p2, v95[|v97|], v100, p1, f21);
			...
			decreases 100 - i14
		{
			...
			v102[307] := p3;
			v102[307] := new bool[16](i15 => f21 !in v86);
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		f22, globalState.f11, f22, globalState.f1 := f22, false ==> !f21, (f22 / f22) * f22, f22;
		...
		v3[375] := (v5 - {true, fm16(f21, v7, v8, globalState)}) > v5;
		v3[375] := v3[375];
		r0 := f22;
	}
	method m13(globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i1
		{
			...
			v18[476], v19, v18[606] := v3.f26, v19 + v19, v3.f27 == v19[fm15(0x3a5, f22, f22, |v20|, globalState)];
			var v22: set<string> := {v3.f27, v3.f27, seq(0x3e4, i2  => ('e')), v2, v2};
			...
			v23[506] := set v25 : string | v25 in v24[f22] :: (v25);
			var v26 := 's';
			var v27: map<string, char> := map[v3.f27 := v26];
			f22, v23[506] := f22 % f22, set v28 : string | v28 in v27 :: (v28);
			...
			var v33: array<int> := new int[16] [f22, 0x328 + f22, f22, f22, f22 / f22, f22, f22, |['u']| - --f22, if (|fm33(globalState)| in v29) then v29[|fm33(globalState)|] else f22, f22, |fm41(globalState)|, fm15(f22, 0x3c6, f22, |v30|, globalState), -f22 * f22, f22, |DC9(v3.f27).cf13|, -|fm45(v3.f26, v31[v2 := |v32|], false, globalState)|];
			v33[11] := f22;
			var v34: map<bool, char> := map[f21 := v26];
			var v35 := DC54(v34);
			v33[11] := -|v35.cf81|;
			var v36 := new C2(fm43(v33[11], v3.f26, |v1.f23|, globalState), v33[11]);
		}
		...
		for i3 := |fm45(v3.f26, v37, v3.f26, globalState)| to |(v38 - v38)| {
			...
			match (v42) {
				...
				case DC3(cf7, cf8) =>
					...
					v51, v3.f26 := ([f21, f21])[|((seq(0x327, i4  => (v3.f27))) + (seq(0xa4, i5  => (v3.f27))))| := if (v3.f26 in v57) then v57[v3.f26] else !false], v3.f26;
				case DC0(cf0) =>
				...
				case DC4(cf9) =>
					...
					var v70: seq<map<bool, bool>> := [v67, v68[i3], if (!v3.f26 in v69) then v69[!v3.f26] else map[f21 := v3.f26]];
					var v71: set<array<int>> := {v66, v66, v66, v66, v66};
					var v72: array<bool> := new bool[18] [v3.f26, v3.f26, fm16(v3.f26, DC9(v3.f27), v68[|v2|], globalState), v3.f26, v3.f26 && f21, v3.f26, true, !v3.f26, v3.f26, v3.f26, v3.f26, f21, fm29(globalState), v3.f26, f21, if (!true in v67) then v67[!true] else f21, v71 == {v66}, if (v3.f26 in v67) then v67[v3.f26] else v3.f26];
					v72[772] := v3.f26;
					v72[772] := v3.f26;
					v66[805] := f22;
					v66[805] := (0x37f / |v3.f27|) + f22;
...
class C7 extends T0 {
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		match (v0) {
			case DC6() =>
				...
				var v7: map<array<bool>, set<bool>> := map[p3 := if (f20) then v5[|v6|] else v4];
				v7 := v7[p3 := v4 + v4];
				var v8 := DC8(p1);
				match (v8.(cf12 := p1).(cf12 := p1)) {
					case DC6() =>
						...
						p3[783] := fm13(v1, globalState);
						var v13: array<map<int, string>> := new map<int, string>[15];
						var v14: map<int, string> := map[p1 := seq(211, i1  => (v1))];
						v13[462] := v14;
						var v15 := "nstv";
						p3[783], v13[462], globalState.f4, globalState.f13, r0 := p2, v14 + v14[|v15| := v15], f20, -p1, 0x3b0 * p1;
						v3[52] := p1;
						var v16: map<bool, bool> := map[p2 := f20];
						v3[52] := -p1 - -(p1 + |multiset([|v16|, p1, v10[p1]])|);
					case DC7(cf11) =>
					...
					case DC5(cf10) =>
						globalState.f4 := f20;
						var v33: seq<int> := [p1];
						var v34: seq<int> := [0x3d4, |v33| / p1];
						globalState.f13 := v33[p1 - p1];
						var v35: map<bool, seq<int>> := map[f20 := v33];
						v35 := v35 + (v35 + v35);
						var v36: array<bool> := new bool[8];
						var v40: array<D18> := new D18[16](i2 => DC43(set v39 : map<bool, int> | v39 in (map v37 : map<bool, int> | v37 in (map v38 : map<bool, int> | v38 in (seq(0x342, i3  => (map[f20 := p1]))) :: (v38) := ([!p2, p2, f20, f20, true])) :: (v37) := (p2)) :: (v39)));
						...
						globalState.f1, v36, globalState.f13, v40[991], globalState.f11 := p1, p3, fm36(|v44| / p1, v45[|v45|], f20, f20, globalState), DC43({map[p2 := |v45|], map[p2 := p1]}).(cf64 := v43.cf64), !p2;
				}
			...
			case DC8(cf12) =>
				...
				match (v55) {
					case DC1(cf1, cf2, cf3, cf4, cf5) =>
						...
						var v61: seq<int> := [cf2, v60[cf12], cf2];
						v61 := v61[cf5 := cf5];
					case DC2(cf6) =>
						globalState.f4 := p2;
						var v62: seq<int> := [cf12, cf12 / cf12, -cf6 * p1];
						v62 := (seq(573, i5  => (v62[cf6]))) + v62;
						...
						v66[648] := cf12;
						v66[648], globalState.f4 := |v64| % cf12, |(seq(264, i7  => ('e')))| != cf12;
					case DC3(cf7, cf8) =>
					...
					case DC0(cf0) =>
						...
						v71[533] := 0x31a;
						var v72 := 't';
						v71[533], v72, globalState.f11 := -(p1 + cf12), v72, p2;
						globalState.f11 := f20;
						globalState.f4 := p2;
					...
					case DC4(cf9) =>
						...
						globalState.f13, globalState.f4, p3[663], globalState.f13 := p1 / cf12, (f20 <== f20) || f20, f20 <==> (v74 <= ([0x8d])[cf12 := fm36(p1, p2, f20, f20, globalState)]), |v75|;
						var v76 := DC49(false, cf12, !p2, p1, p2);
						globalState.f1, p3[663], globalState.f11 := p1, v76.cf74, p2;
						var v77: array<bool> := new bool[17](i9 => |map["d" := v74[p1]]| > |[p3[663]]|);
						v77 := v77;
				}
			...
			case DC5(cf10) =>
				if (f20) {
					...
					var v81 := "fc";
					var v82 := 'f';
					globalState.f4 := (v81 + v81) < (if (p2) then (seq(-950, i10  => ('u')))[p1 := v82] else v81);
					var v83: array<map<string, int>> := new map<string, int>[1](i11 => map[v81 := p1] + map[seq(0x399, i12  => (v82)) := p1]);
					var v85: map<string, int> := map["hbdhawo" := |(map v84 : int | (386 <= v84) && (v84 < -0x1f) :: (v84 % p1) := (v82))|];
					v83[690] := v85;
					v83[690] := v85;
					globalState.f4 := p2;
				} else {
					...
					var v92: array<seq<string>> := new seq<string>[28] [v91 + v91, [v90, v90], v91, v91, v91, v91, [v90, v90] + v91, v91, v91, v91, v91, v91, seq(-0xe6, i13  => (v90)), v91 + v91, v91, v91, v91, v91, seq(0x322, i14  => (v90)), ([v90])[p1 := v90], v91 + ["bjd", v90], [v90] + v91, fm59(p1, p1, f20, globalState), v91, seq(-895, i15  => ("uabxlymt")), v91, v91, v91];
					var v93: seq<seq<string>> := [v91, v91, v91, seq(-0x2cc, i16  => ("cqtnoji")), v91];
					v92[735] := v93[p1];
					v92[735] := (v91 + v91[p1 := v90]) + v91;
				}
				...
				if (v97 !in v98) {
					globalState.f13 := p1 / |(v94 - v94)|;
					var v99 := "ky";
					var v101: array<seq<D21>> := new seq<D21>[9](i17 => [DC56([[false, true, f20]], f20, |map[|(set v100 : int | (0x147 <= v100) && (v100 < 521) :: (v100 + |p0|))| := p2]|, p2)] + (seq(0x2b9, i18  => (DC56([[p2], [p2, true]], p2, p1, f20)))));
					v95, v99, v101, v99 := v95, ((seq(-0x2a0, i19  => (v95))) + "ef") + (seq(0x339, i20  => (v95))), v101, v99;
					var v102 := DC15(seq(0x101, i21  => (v95)), p1, seq(534, i22  => (v95)), |p0|);
					var v103: array<D4> := new D4[5] [DC15(v99, p1, v99[|v99| := v95], p1), v102, v102, DC15(v99, p1, v99, -p1), v102];
					var v104 := DC35(p2, p1);
					...
					var v112: map<seq<int>, string> := map[fm34(globalState) := (fm33(globalState))[p1 := v95]];
					var v113: seq<int> := [0x97, p1, |v111.f27|];
					v111.f27 := if (v113 in v112) then v112[v113] else v111.f27;
					var v114: seq<array<bool>> := [p3, p3];
					var v115: multiset<array<bool>> := multiset{v114[845]};
				...
				var v125: array<int> := new int[28] [fm36(|v117|, f20, f20, p2, globalState), if (p2) then -406 else -0x20e, fm36(p1, f20, !p2, false, globalState) * p1, -0x2c9, p1, -p1, p1, p1 / p1, p1, p1, |v118|, p1, p1 % |v119|, p1, if (f20) then p1 else v123.cf85, 0x391, p1, |(v124 + v124)|, p1, p1, p1 - p1, p1 - p1, p1, p1, p1, |v117|, p1 % -p1, p1];
				v125[563] := p1;
		...
		var v136: array<multiset<bool>> := new multiset<bool>[27] [p0 + v131.cf77, v132[p1], p0[p2 := |v133|] + p0, p0, p0, multiset{fm29(globalState)}, p0, p0, p0, p0[p2 := -0x2cd], p0, p0, multiset(v134), p0 + p0, p0, p0, multiset{f20, true, p2}, (multiset(v134))[!f20 := -0x7f], p0 - p0, multiset{p2, f20}, multiset{f20} - p0, p0, p0, if (f20 in v135) then v135[f20] else p0, p0, p0, multiset{p2, false, p2, !p2, f20} * multiset{f20, p2}];
		v136[35] := p0;
		var v137 := "q";
		var v138: set<int> := {p1, p1, |v137|};
		var v139: seq<set<int>> := [v138, v138];
		v136[35] := match DC8(|v139[p1]|) {
			case DC6() => p0
			case DC7(cf11) => p0
			case DC8(cf12) => p0
			case DC5(cf10) => p0 * p0
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		var v7: seq<bool> := [f20];
		globalState.f11, v4, v0, globalState.f11, globalState.f13 := v5 !in v0, v4, ("obnwkedrs")[v2 := if (f20 in v6) then v6[f20] else 'c'], v7 <= v7, v2;
		var v8: map<bool, string> := map[f20 && false := (seq(0xd8, i0  => (v5)))[fm36(v2, f20, f20, f20, globalState) := v5]];
		v8 := v8[f20 := v0 + v0];
		globalState.f1 := |(set v9 : int | (0x39 <= v9) && (v9 < 0x222) :: (v9 * v2))| + v2;
		for i1 := |fm41(globalState)| * |v0| to v2 {
			v2 := -i1;
			var v10: array<int> := new int[17];
			v10[662] := fm36(v2, f20, f20, false, globalState);
			var v12 := DC29(f20, v2, seq(0x1f8, i2  => (set v11 : int | v11 in [0x13] :: (v11 + 0x24))), v2, f20);
			var v13: set<map<D12, int>> := {map[v12 := -i1]};
			var v14: C1 := new C1(v13 <= v13);
			var v15: array<array<int>> := new array<int>[16];
			v10[662], v14, v15 := i1, v14, v15;
			globalState.f11 := !(v7 <= v7);
			var v17: seq<string> := [v0[i1 := 'a']];
		...
		if (v21.cf11) {
			...
			var v26 := DC12(DC4(v22), v2, 0x46 != (if ((seq(-0x59, i3  => (v5))) in v25) then v25[seq(-0x59, i3  => (v5))] else v2));
			match (v26) {
				...
				case DC13() =>
					...
					var v32: array<array<bool>> := new array<bool>[28] [v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v31[|multiset{v2}|], v30, v30, v30, v30, v30, if (false) then v30 else v30, v30, v30, v30];
					v32[274] := v30;
					v32[274] := new bool[14](i5 => f20);
					v1 := v1[f20 := v2 * v2];
					globalState.f4 := false;
					globalState.f11 := f20;
				case DC11(cf14) =>
					var v33: seq<int> := [v2, v2];
					var v34 := new C3(f20, v0, f20, v33[v2]);
			...
			v0 := (v0[v2 := v5] + (seq(-0x10a, i6  => (v5)))) + v0;
		} else {
			var v41: map<int, bool> := map[v2 := if (f20) then f20 else f20];
			var v42: array<int> := new int[8](i7 => i7 / v2);
			v42[897] := v2;
			var v43: multiset<string> := multiset{"lbtlbt"};
			var v44: multiset<bool> := multiset{f20, f20, f20};
			var v45 := DC33(v2, f20, f20, f20);
			v41, v0, v42[897], globalState.f4, globalState.f13 := v41 + v41, fm45(f20, v43 - fm61(v2, v2, v44, v45, globalState), f20, globalState), v2 + (v2 - fm36(v2, f20, f20, !f20, globalState)), false, 0x300;
			...
			v2, v48[269], v42[897] := |v50|, v53[v2], v2;
			globalState.f1 := v2;
		}
	...
	method m11(p0: array<string>, globalState: GlobalState) returns (r0: array<set<bool>>, r1: seq<int>) {
		...
		r1 := [if (!f20 in v0) then v0[!f20] else v1, |v8| + v1, v3[v1], v1 * v1, v1];
		var v9 := "vsfdmanue";
		for i0 := |v9| to v1 {
			...
			var v13 := DC52(847);
			v10, v11[484], v5, globalState.f1, globalState.f13 := {v9}, !f20, v5, v1, -((|v12| / 0x2f4) / (if (f20) then v13.cf79 else |"xwk"|));
			var v14 := DC0(v11[484]);
			var v15 := new C6(v14.cf0, v1 / i0);
			if ((v5 !in v9) ==> v11[484]) {
				v7[78] := 0x9c - i0;
				v7[78] := v1;
				var v16: set<map<int, bool>> := {v2};
				var v17 := new C3(f20, v9, i0 < |v16|, v7[78]);
				v11[484] := v17.f26;
				var v18: multiset<int> := multiset{v7[78], v1};
				var v19: map<bool, bool> := map[v18 !! multiset{v7[78]} := f20];
				...
				v19, v20[350], v24 := (v19 + v19)[multiset{"ippwuhjjd"} >= v25 := true], v23 + v23, v24;
				var v26: T0 := new C3(v1 == 0x289, v17.f27, v11[484], DC29(v11[484], |[v5, v5]|, DC29(v11[484], i0, [v12], v1, f20).cf45, v1, v11[484]).cf46);
				var v27: map<array<int>, int> := map[v21 := fm36(-v7[78], v11[484], v17.f26, !v11[484], globalState)];
				var v28: seq<bool> := [f20];
				v26, v17.f27, v7[78], v18, v27 := v26, v9 + v9[|v28| := fm38(v11[484], globalState)], i0, multiset{|v3|, v1 + |v18|, v1 - |v12|, if (f20) then i0 else |v28|}, (v27 + map[v21 := 0x3bd]) + v27;
			} else {
				var v29 := new C5((v3 + v3)[i0 := i0]);
				var v30: map<char, int> := map[v5 := v1];
				v30 := v30[v5 := v1];
				globalState.f11 := f20 ==> v11[484];
		...
		for i2 := v1 to v1 - v1 {
			...
			v7[720] := |v40| * fm36(v36.fm14(v5, f20, globalState), v41.cf36, f20, f20, globalState);
			...
			v37, globalState.f4, v39, v7[720] := v37, i2 <= -i2, fm62(map[i2 := true], -((if (v7 in v42) then v42[v7] else v1) % |v46|), true, v9, globalState), i2;
			var v47 := new C6(f20, i2 % |v40|);
			p0[339] := v9;
			p0[339] := fm33(globalState);
			var v48: map<int, int> := map[0x31d := i2];
			if (v7[720] < ((if (v1 in v48) then v48[v1] else v1) - v1)) {
				v4 := v4;
				v7[720] := v47.fm14(v5, !f20, globalState);
				var v49 := DC34(v3);
				var v50 := new C5(v49.cf54);
				var v51: seq<multiset<bool>> := [v0, v0[f20 := |v40|]];
				globalState.f1 := v7[720] + (|v51| % v7[720]);
				globalState.f13 := fm36(v7[720], f20, f20, v5 !in v9, globalState);
			} else {
				var v52: array<int> := new int[14] [-|v35|, if (f20 in v0) then v0[f20] else if (-v7[720] in v44) then v44[-v7[720]] else v7[720], 451, v7[720], i2, |v44|, v1, v47.fm14('t', f20, globalState), 0xa2, v1, v1, v7[720], v7[720], -v1];
				var v53 := new C0(v52);
				v43 := v43[f20 := if (f20) then |p0[339]| else i2];
				globalState.f13 := (v1 * -0x29e) / v7[720];
				...
				v55 := v55[f20 := multiset(v56) + multiset(v56[86 := v3])];
				v46 := v46 + (v46 + v46);
			}
	...
	method m12(p0: map<int, int>, globalState: GlobalState) returns (r0: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			var v4 := DC35(!f20, v2);
			var v5 := DC55(f20);
			globalState.f4 := v3[v2] == fm36(fm36(v2, f20, v4.cf55, f20, globalState), false, v5.cf82, f20, globalState);
			var v6: seq<bool> := [f20];
			...
			globalState.f13, v7[748], v2, v9 := v2 * (if (if (!f20 in v10) then v10[!f20] else true) then |v1| else v2), v2 + v2, -(if (v1 in v11) then v11[v1] else fm36(|v10|, f20, f20, true, globalState)) + |("atcu" + v1)|, v9;
		}
		...
		v12, globalState.f11, globalState.f4, globalState.f1 := v13[v14], v17[0x240] !! (set v18 : int | v18 in v16 :: (v18 % --|map[!false := 0x22a]|)), match v21 {
		...
		var v28 := new C5(((if (v14 in v27) then v27[v14] else v19) + v19)[647 := --v14]);
		globalState.f1 := v14;
		r0 := multiset(v26);
	}
}
...
class C8 extends T0, T1 {
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := p1 % p1 to |v0| {
			...
			match (fm9(i0, globalState).(cf12 := fm10(p2, p1, v1, globalState))) {
				case DC6() =>
					...
					v2 := v2[|v3| > i0 := p3];
					globalState.f11 := v3[fm10(p2, p1, v1, globalState)];
					var v4 := "ecnn";
					r0 := (p1 + -p1) * fm10(p2, |v4|, 'm', globalState);
					var v5: map<int, bool> := map[if (p2) then p1 else |multiset{p1}| := p2];
					globalState.f11 := if ((i0 / p1) in v5) then v5[i0 / p1] else p1 != p1;
				case DC7(cf11) =>
					...
					var v13 := "hgsdssiph";
					var v14: multiset<string> := multiset{seq(0x153, i2  => (v1)), v13};
					v12[429] := v14;
					v12[429] := (v14 - v14) - multiset(fm11(globalState));
					r0 := -(p1 % p1);
				case DC8(cf12) =>
					globalState.f1 := i0;
				...
				case DC5(cf10) =>
					...
					v21[548] := v22;
					globalState.f1, v21[548] := if (fm8(globalState)) then i0 else i0, v22;
			...
			globalState.f13 := |(seq(0x1b1, i4  => (v1)))| % i0;
		}
		globalState.f13 := p1;
		...
		var v33 := DC1(p2, p1 / p1, p1, !p2, --(|v32| * p1));
		v33 := v33;
		r0 := (p1 % p1) * p1;
		globalState.f4 := true;
		r0 := p1;
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		if (|v2.cf13| > |v4|) {
			...
			v5 := v5;
			var v6 := 0x158;
			r0 := -(fm10(v3, v6, v0, globalState) / v6);
			...
			var v14: array<char> := new char[21] [v0, v0, v0, v1[v6], v0, v0, v0, 'l', v0, 'd', v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
		...
		if (v23[v21 - 676]) {
			...
			match (v28) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					v21 := -(|(if (([v20])[cf3 := v20] in v30) then v30[([v20])[cf3 := v20]] else if (cf5 in v31) then v31[cf5] else v23)| / (|fm64(v3, globalState)| * cf3));
					v24[265] := cf5;
					v24[265] := cf3;
				case DC2(cf6) =>
					...
					v41[267] := v3;
					r0, v41[267], globalState.f4 := fm36(cf6, v3, true, v3, globalState), v3 !in v27, v3;
				case DC3(cf7, cf8) =>
					var v42: map<map<char, bool>, bool> := map[map[v0 := v3] := v3];
					var v43 := new C7(v42 + v42, v3);
					var v44: array<array<int>> := new array<int>[2];
					v44[972] := v24;
					v44[972], globalState.f11 := if (v23[v21]) then v24 else v24, v3;
					var v45 := new C2(v43.f20, -v21);
					var v46: seq<array<int>> := [v24];
					var v47: map<int, bool> := map[cf8 := true];
					var v48: array<bool> := new bool[26] [v43.f20, v43.f20, v46 == [v46[fm36(|v20|, v43.f20, v3, v3, globalState)], v24], v4 > multiset{v43.f20, v43.f20}, v43.f20, v3, v3, v3, v3, v1 == v1, v3, v3, v3, true, v3, v3, v21 < cf8, if (|v27| in v47) then v47[|v27|] else fm43(cf8, v3, v21, globalState), v3, v3, {!(if (v21 in v47) then v47[v21] else v43.f20)} > v27, v3, v3, v3, if (v43.f20) then v43.f20 else v3, v3];
					var v49 := DC36(v48);
					v48 := v49.cf57;
				case DC0(cf0) =>
					v24[659] := |multiset{fm10(!v3, --0x2c1, 'g', globalState)}|;
					var v50: seq<seq<bool>> := [v23, v23];
					var v51: seq<seq<seq<bool>>> := [v50, v50];
					v24[659], globalState.f13 := |(v50 + v51[|v1|])|, (v21 + v21) % (v21 / |v1|);
					var v52 := DC3(v27, -|v1|);
					var v53 := DC4(v52);
					var v54 := new C4(true, v53);
					var v55: array<int> := new int[5] [v21, v21, v21, v24[659], --0x3a4];
					var v56 := new C0(v55);
				...
				case DC4(cf9) =>
					...
					v60[768] := v63;
					v24[37] := v21;
					v60[768], globalState.f4, v24[37] := v63 + v63, fm29(globalState), -|"mvimj"| * v21;
					globalState.f13 := v24[37];
			...
			var v70 := new C0(v69);
			if (v3) {
				var v71: map<int, int> := map[v21 := -|(seq(468, i2  => (v0)))|];
				var v72: set<int> := {v21 / (if (v21 in v71) then v71[v21] else v22[v21])};
				v72 := v72;
				globalState.f13 := (v21 * v21) / v70.fm28(v2, globalState);
				...
				v74, globalState.f13, globalState.f13, globalState.f11 := v74, v21 * |v76|, |v77| - (v21 / v21), fm43(-|(v23 + v23)|, v3, -|v4|, globalState);
				v1, globalState.f11 := v1 + ((seq(-0x12d, i3  => (v0))) + v1), v3;
				var v78 := new C1(!v3);
			...
			var v85, v86, v87 := m10(v83, v84, v22[v21], globalState);
			globalState.f13 := v21;
			globalState.f11, v21 := (v87 / v21) < v87, |((if (v3) then multiset{!false} else v4) + (v4 - v4))|;
		}
		...
		if (|v89| >= v21) {
			...
			v92[496] := v21;
			v92[496] := v21;
			globalState.f1 := v92[496];
			var v93 := DC52(v21);
			v93 := DC52(v92[496]);
			globalState.f13 := (v92[496] / -|v22|) + |v1|;
		} else {
			var v94: set<bool> := {v3};
			var v95 := DC3(v94, -|v1|);
			var v96: map<int, D0> := map[v22[v21] := v95.(cf7 := v94)];
			v96 := v96 + v96;
			var v97: set<int> := {|v1|, v21};
			var v98: seq<set<int>> := [v97];
			var v99: map<int, int> := map[v21 := fm36(v21, v23[v21], v3, true, globalState)];
			...
			v102[791] := v101;
			v102[791] := v101;
			var v103: set<string> := {v1, ("fa")[v21 := v0]};
			var v107: array<set<string>> := new set<string>[19] [v103 * v103, v103, v103, {seq(-0x118, i5  => (v0))} - v103, v103, v103, v103, {v1} - v103, v103, v103, v103, v103, v103, if (v3) then set v104 : string | v104 in v103 :: (v104) else v103, {v1, seq(-0x67, i6  => (v0))}, (set v106 : string | v106 in (map v105 : string | v105 in (map[v1 := v3])[v1 := v3] :: (v105) := (true)) :: (v106)) * {v1}, v103, {v1}, {v1, v1, v1, v1, v1} - v103];
			v107[362] := v103;
			var v108: seq<string> := [v1];
			v107[362] := set v109 : string | v109 in v108 :: (v109);
			globalState.f11 := v3;
		...
		match (v111) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				var v112: array<char> := new char[6] ['f', v0, v0, v0, v0, v1[|v20|]];
				v112[519] := v0;
				v112[519] := v0;
				...
				v116[81] := v115 + v115;
				var v117 := DC5(v115);
				v114, globalState.f4, v116[81], v114 := v114, cf4, v117.cf10, v114 + (v114 * v114);
				var v118 := DC35(cf4, cf3);
				var v119: array<bool> := new bool[14] [v118.cf55, true, false, !!cf4, cf4, if (cf4 in v116[81]) then v116[81][cf4] else cf4, true, cf1, v3, (seq(0x24d, i7  => (v112[519]))) == v1, cf2 > |(seq(0xd4, i8  => (cf3)))|, v3, cf4, cf1];
				v119 := new bool[9](i9 => cf4);
			case DC2(cf6) =>
				var v120: array<int> := new int[24];
				v120[403] := cf6 * cf6;
				var v121: map<array<int>, int> := map[v120 := cf6];
				v120[403] := if (v120 in v121) then v121[v120] else cf6 + -391;
				...
				var v127 := DC59(v126);
				v120[403], v123[886], v126 := cf6, !v3, v127.cf93;
				var v128: array<string> := new string[22];
				v128[705] := seq(0x246, i11  => (v0));
				v128[705] := v1;
			case DC3(cf7, cf8) =>
			...
			case DC0(cf0) =>
				if (v3) {
					...
					v133[359], globalState.f4, globalState.f4, globalState.f13, v1 := v21 + |v135|, v3, |v1| !in v140, if (cf0) then v21 else v21, v1;
					var v141: array<C4> := new C4[5];
					var v142: seq<array<C4>> := [v141, v141];
					v141 := v142[-v21];
					globalState.f4 := v3;
					v133, v133[359] := v133, |(v1 + v1)|;
				} else {
					...
					v146[65] := |v154|;
					var v155: multiset<int> := multiset{v21, v21, v21, |(seq(0x397, i13  => (0x2b2)))|, |"lbfoidg"|};
					var v156: multiset<string> := multiset{v1};
					v146[65] := |v155| - |fm45(!v3, v156, cf0, globalState)|;
					var v157 := DC15(v1, v21, v1, v21);
					var v158: map<int, int> := map[v146[65] := 0x263];
					var v159: map<map<int, int>, int> := map[v158 := v146[65]];
					var v160 := DC15(v157.cf19, |v159|, v1, if (v146[65] in v155) then v155[v146[65]] else v146[65]);
					var v161: map<int, string> := map[fm10(cf0, -|map[v146[65] := v146[65]]|, v0, globalState) := v157.cf21];
					var v162: set<map<bool, int>> := {fm35(v0, 680, cf0, globalState)};
					var v163 := DC33(v146[65], v3, v3, v3);
					var v164: seq<D13> := [v163];
					var v165: array<bool> := new bool[12](i14 => false ==> cf0);
					v165[378] := v3;
					v161, v162, v164, v165[378], globalState.f1 := v161 + v161, v162 - v162, seq(0x3b8, i15  => (v163)), v21 != |v23|, v21;
					var v167: map<map<int, bool>, bool> := map[map v166 : int | v166 in v22 :: (v166 / v146[65]) := (cf0) := v3];
					var v168: map<map<map<int, bool>, bool>, array<bool>> := map[v167 := v165];
					var v170: map<int, bool> := map[v146[65] := v165[378]];
					var v171: map<map<int, bool>, int> := map[v170 := |v170|];
					v165 := if ((if (v165[378]) then map v169 : map<int, bool> | v169 in v171 :: (v169) := (true) else v167) in v168) then v168[if (v165[378]) then map v169 : map<int, bool> | v169 in v171 :: (v169) := (true) else v167] else v165;
				}
				
				var v172: array<bool> := new bool[11](i16 => false);
				v172[544] := !!cf0 <==> cf0;
				var v173: array<multiset<bool>> := new multiset<bool>[6];
				v173[212] := v4 - (multiset{true})[v3 := 0x21f];
				v172[544], r0, v173[212] := !fm13(v0, globalState), v21, v4 + v4;
				globalState.f11 := fm43(v21, v172[544], v21, globalState);
				r0 := 0x254;
			case DC4(cf9) =>
				...
				var v180: array<int> := new int[27] [v21, v21, v21 + v21, v21 * v21, v21, v21, v21 / v21, v21, v21, v21, v21, |v1| - v21, v21, v21, |(v178 + v178)|, |v22|, v21, |v174|, v21, |v179| * v21, v21, fm36(v21, v3, !v3, v3, globalState), -(if (v21 in v174) then v174[v21] else v21) * v21, if (v3) then |v179| else v21, v21 - v21, v21, v21];
				v180[141] := 633;
				var v181: map<bool, bool> := map[v3 := v3];
				var v182: map<map<bool, bool>, bool> := map[v181 := v3];
				v180[141] := if (v111.cf1) then |(v182 + map[v181 := v3])| else v21;
	...
	method m4(p0: string, p1: bool, p2: set<bool>, globalState: GlobalState) returns (r0: char, r1: bool, r2: string, r3: bool) {
		...
		var v3: map<string, char> := map[p0 := p0[140]];
		if (v3 != (v3 + v3)) {
			...
			if (v2.f20) {
				...
				globalState.f1 := fm10(v8[105] < v5, -|v9|, v0, globalState);
			} else {
			...
			v15[484], globalState.f11, globalState.f4, globalState.f13, v17 := [|v17|, |{true}|] + v16, v2.f20, v2.f20, v5 - (v5 * v5), {v2.f20 && v2.f20, v2.f20, p1, fm43(|v18|, v2.f20, v5, globalState) !in p2};
			...
			match (v19) {
				case DC55(cf82) =>
					...
					v22[739] := v2.f20;
					var v23 := DC21(v6[v5], v5, v2.f20, v2.f20);
					v22[739] := !!v23.cf30;
					var v24: array<D1> := new D1[11];
					var v25 := DC7(v2.f20);
					v24[998] := v25;
					v24[998] := v25.(cf11 := !!v22[739]);
					globalState.f4 := v5 > v5;
					var v26: array<char> := new char[23] [v0, if (false) then v0 else v0, v0, v0, v0, v0, p0[0x247], fm38(cf82, globalState), v0, v0, DC40(v0).cf62, v0, v0, v0, v0, v0, v0, 'c', v0, v0, v0, 'a', v0];
					v26[618] := v0;
					v26[618] := if (p1) then v0 else v0;
				case DC56(cf83, cf84, cf85, cf86) =>
					...
					var v32: array<int> := new int[28] [cf85, cf85, v5, cf85 * v28.cf99, cf85, cf85, cf85, v5, -0x36c, |v30|, if (v16 in v31) then v31[v16] else cf85, v5, cf85 + cf85, -|p0|, v5, v5, v5, cf85, -cf85, cf85, cf85 / -v5, cf85 / cf85, fm10(v2.f20, cf85, v0, globalState), v5, cf85, cf85, v5 / cf85, cf85 + -v5];
					v32 := v32;
				case DC57(cf87, cf88, cf89, cf90, cf91) =>
					var v33: array<int> := new int[2];
					v33[906] := v5;
					v33[906] := cf88;
					var v34: array<bool> := new bool[28](i0 => {multiset{v0, p0[cf88]}} !! {multiset{v0, v0}});
					v34 := v34;
					v33[906] := -0x4f;
					cf90 := -(-(|p0| / cf87) - (v5 + fm36(|v15[484][-cf90 := cf88]|, p1, true, cf89, globalState)));
				case DC54(cf81) =>
					...
					v40 := v40[v39 := |(p0 + p0)[v5 := v0]|];
					var v41: array<seq<bool>> := new seq<bool>[5](i1 => v6);
					v41[762] := fm46(v5, v5, v35.f20, !true, globalState) + v6;
					v41[762] := v6;
				case DC58(cf92) =>
					var v42: multiset<string> := multiset{"nfhyc", p0, p0, p0, seq(0x33f, i2  => (v0))};
					globalState.f13 := |("vbquya" + fm45(v2.f20, multiset{fm45(v2.f20, v42, p1, globalState)}, true, globalState))|;
					globalState.f13 := -v5 % v5;
			...
			if (p1) {
				...
				v44[624] := v45 + v47;
				v43[67], globalState.f1, v44[624], v43 := v2.f20, v5, v47, v43;
				...
				var v52: map<bool, map<map<char, bool>, bool>> := map[v43[67] := v2.f19];
				var v53 := new C7(if (|v51| in v48) then v48[|v51|] else if (p1 in v52) then v52[p1] else v2.f19, if (v2.f20) then false else v2.f20);
				r1, v45, r2 := v15[484] <= (v15[484] + v15[484][v49.f22 := v49.f22])[341 := 0x37c], (v47 + v44[624]) + (v47 + v47), p0 + p0;
				...
				var v56: C2 := new C2(v43[67], v49.f22);
				var v57: array<char> := new char[6];
				var v58: map<C2, array<char>> := map[v56 := v57];
				var v59: multiset<bool> := multiset{p1, false};
				var v60: map<int, bool> := map[|p0| := v43[67]];
				var v62: array<int> := new int[25](i3 => i3 % -v49.f22);
				var v63: map<array<int>, bool> := map[v62 := true];
				var v64: multiset<int> := multiset{v49.f22};
				var v65: array<int> := new int[29] [v49.f22, 0xae + v49.f22, if (v54 in v55) then v55[v54] else v49.f22, v49.f22, v5, fm36(v5, v2.f20, v2.f20, v49.f21, globalState), v49.f22, |v58|, v5, -v49.f22, |p0|, v5, v49.f22 % |v59|, v5, |v60| * v49.f22, |v15[484]| / -v5, v49.f22 - |p0|, -|(map v61 : seq<bool> | v61 in v7 :: (v61) := (!p1))|, 0x22a, 976, v49.f22, v49.f22 % v49.f22, fm36(v49.f22, v2.f20, false, v2.f20, globalState) + v5, 0x27, -v5, v49.f22 / |v63|, v49.fm14(v0, p1, globalState) + |v64|, |v16|, -v5];
				v65 := v65;
			} else {
				...
				var v72: map<int, array<map<int, char>>> := map[v5 % -v5 := v71];
				var v73: C2 := new C2(v2.f20, v5);
				var v74: seq<C2> := [v73];
				var v75: seq<seq<C2>> := [v74];
				var v76: map<seq<seq<C2>>, int> := map[v75 := v5];
				v71 := if ((if (v75 in v76) then v76[v75] else |(seq(-0x387, i5  => (v0)))|) in v72) then v72[if (v75 in v76) then v76[v75] else |(seq(-0x387, i5  => (v0)))|] else v71;
			}
			...
			if (v2.f20) {
				...
				var v80: seq<seq<int>> := [[|(v79[v77 := map[|v78| := |p0|]])[|"ilb"| := v78]|]];
				var v81: seq<int> := [v77, |p0|];
				var v82: multiset<int> := multiset{76};
				var v83 := DC11(v82);
				var v84: array<seq<seq<int>>> := new seq<seq<int>>[19] [v80, if (p1) then [fm34(globalState)] else v80, seq(0x1db, i6  => ([|{v77, v77}|, |p0[0x161 := v0]|])), v80, [v81[v77 := v77], [|map[v2.f20 := |v83.cf14|]|, v77, v77]] + (seq(0x1e1, i7  => (v81))), v80 + [v81, v81[|v81| := 953]], v80, v80, [v81, v81] + v80, v80, seq(0x294, i8  => (v81)), v80, [v81[v77 := v77]], v80 + v80, seq(0x1dd, i9  => (v81)), v80 + v80, v80, v80, ([v81, v81])[v77 := v81]];
				v84[922] := (v80 + v80)[|fm23(-v77, v2.f20, v82, globalState)| := seq(0x149, i10  => (v77))];
				v84[922] := v80;
				var v85: array<int> := new int[20](i11 => i11 * |p2|);
				v85[458] := -v77;
				v85[458] := v77 + v77;
				globalState.f1 := fm36(v77, fm43(0x3bd, v2.f20, v85[458], globalState), !(p0 < p0[|p0| := v0]), p0 <= p0, globalState);
				var v86 := DC1(p1, v85[458], v77, v2.f20, v77);
				var v87 := new C3(v86.cf1, p0 + p0, p1, v77);
				globalState.f13 := v87.fm14(v0, v2.f20, globalState) % v85[458];
			} else {
				...
				var v94: map<array<bool>, int> := map[v93 := v77 + |p0[v77 := v0]|];
				v94 := v94;
			...
			v98[720] := !p1;
			globalState.f13, v98[720], v0 := (v77 % v77) - |{p1}|, p1, v0;
			var v99: array<int> := new int[10](i14 => i14 % v77);
			var v100: map<int, seq<bool>> := map[v77 := [p1]];
			v99[647] := |v100| / v77;
			var v101 := DC15("hogmgrbca", v77, p0, -v77);
			v99[647] := -|(p0 + v101.cf21)|;
			var v102: set<int> := {v99[647] - v99[647]};
			var v103: array<seq<bool>> := new seq<bool>[28](i15 => [p1] + [p1]);
			var v104: map<bool, int> := map[false := 246];
			var v105: set<map<bool, int>> := {v104 + map[p1 := |p0|], v104, map[v98[720] := v77]};
			v102, globalState.f13, v99[647], v103, globalState.f4 := v102, v77, |v105|, v103, (|v102| % v99[647]) > (v77 % v99[647]);
		}
		
		globalState.f11 := p0 == p0;
		var v106 := 0x8;
		var v107: seq<string> := [p0, "nei", "pk", p0, p0];
		var v108 := DC15(p0, v106, v107[v106], v106);
		match (v108) {
			case DC15(cf19, cf20, cf21, cf22) =>
				...
				v109[769] := if (if (|multiset(v111)| in v110) then v110[|multiset(v111)|] else !p1) then v2.f20 else fm29(globalState);
				v109[769] := v2.f20 || !(if (true) then v2.f20 else p1);
				var v112: map<int, seq<int>> := map[cf20 := v111[cf22 := v106]];
				v112 := v112[cf20 := v111];
				v106 := v106;
			case DC14(cf18) =>
				...
				v116.f28[84], globalState.f4, v118[877], globalState.f11 := -(|v120| - 264), false, v121[-v106], v2.f20;
		}
	...
	method m9(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState) returns (r0: char) {
		...
		v7[256] := true <== p0;
		globalState.f11, globalState.f4, v7[256] := p1, fm8(globalState), (p3 + p3) <= p3;
		var v8: C1 := new C1(if (p2) then v7[256] else !p0);
		var v9 := 'c';
		var v10: seq<char> := [v9];
		var v11: map<bool, int> := map[true := p3];
		var v12: seq<map<bool, int>> := [v11];
		var v13: map<int, int> := map[p3 := |v12|];
		r0, globalState.f1, globalState.f13, v8 := v9, p3 + p3, --((p3 % p3) * |(v10 + (seq(0x55, i2  => (v9))))[|v13| := v9]|), v8;
		globalState.f11 := p3 > -0x27b;
		var v14: set<int> := {-p3, |(seq(-0x2c7, i3  => (multiset{v7[256]})))|};
		if (fm43(p3 % |v13|, v14 > (set v15 : int | (-0x3d9 <= v15) && (v15 < 0x108) :: (v15 / |[v8.f29, DC21(v8.f29, |multiset{v8.f29}|, p2, v7[256]).cf32]|)), fm36(p3, v8.f29, true, false, globalState), globalState)) {
			...
			if (v7[256]) {
				...
				globalState.f4 := |v20[p3 := p3]| <= (p3 * p3);
				globalState.f4 := v8.f29;
				var v21 := new C6(p0, p3 % 0x31e);
				r0 := v9;
			} else {
				var v22: array<int> := new int[7];
				v22[187] := -629;
				var v23: seq<bool> := [v8.f29];
				v22[187] := -(fm10(p0, |v23|, v9, globalState) + 0x289);
				var v24: array<string> := new string[29];
				v24[316] := v10;
				var v25: multiset<int> := multiset{p3};
				var v26: map<multiset<int>, int> := map[v25 := v22[187]];
				globalState.f4, v24, v24[316], globalState.f1, v10 := v23[fm36(if (v25 in v26) then v26[v25] else |v10[p3 := v9]|, !v8.f29, p2, p1, globalState)], v24, (v10 + v10) + "htwhtky", p3, if (v8.f29) then v10 else v10;
				globalState.f13 := p3;
				var v27: seq<int> := [p3];
				globalState.f4 := multiset{-0x240, v22[187], v22[187]} != multiset(v27);
			...
			var v33: map<int, bool> := map[p3 := v7[256]];
			var v34: map<string, bool> := map[v10 + (seq(908, i5  => (v9))) := v7[256]];
			...
			globalState.f13, v33, v34, v7[256], globalState.f1 := p3 * p3, if ((fm10(v8.f29, |v13|, v9, globalState) < p3) in v36) then v36[fm10(v8.f29, |v13|, v9, globalState) < p3] else v33, v34, if (v8.f29 in v38) then v38[v8.f29] else v7[256], 0x140;
			...
			if (v37[|v13|] <==> p2) {
				...
				v42[791] := 'a';
				v42[791], globalState.f4, v37 := v9, p3 <= p3, (([v8.f29] + v37) + v37)[p3 := v8.f29];
				var v43: array<int> := new int[16](i6 => i6 % |v38|);
				v43 := v43;
				globalState.f11 := p0;
				var v44: seq<string> := [v10, ((seq(0x28a, i7  => (v42[791])))[p3 := fm38(false, globalState)])[|(seq(0x1eb, i8  => ('b')))| := v42[791]], v10];
				v10 := v44[p3];
				...
				v9 := v9;
				globalState.f1 := p3;
				globalState.f11, globalState.f1, globalState.f11, v10 := !v7[256], p3, p1, v10 + v10;
			}
		...
		if (p3 < (0x32 + p3)) {
			...
			match (v47) {
				case DC6() =>
					...
					v7[256], v49, globalState.f4 := p2, v49, if ((v53 - v53) in v52) then v52[v53 - v53] else p0;
					var v54: array<int> := new int[26](i9 => i9 * p3);
					var v55: seq<bool> := [v7[256], v7[256]];
					v54[483] := fm36(0x2b, !v55[p3], v8.f29, v8.f29, globalState);
					v54[483] := 0x264 * p3;
				case DC7(cf11) =>
				...
				case DC8(cf12) =>
					globalState.f13 := p3 / cf12;
					v10 := v10;
					var v60 := DC10();
					var v61: map<array<bool>, D2> := map[v7 := v60];
					var v62 := DC26(v61[v7 := DC10()] + v61);
					v62 := v62;
					var v63 := DC46(v7[256], p2, |v14|);
					var v64 := DC2(133);
					var v65 := DC4(v64);
					var v66 := new C4(v63.cf68, v65);
				case DC5(cf10) =>
					var v67: seq<int> := [p3];
					var v68: multiset<seq<int>> := multiset{(seq(-4, i11  => (130))) + v67};
					globalState.f1 := if (v67 in v68) then v68[v67] else 0xa8 / p3;
					var v69: seq<map<int, int>> := [v13];
					var v70: multiset<int> := multiset{p3, |(if (v8.f29) then v69[fm10(v8.f29, p3, v9, globalState) := v13] else v69[p3 := v13])|, 0x8f};
			...
			var v79: array<int> := new int[27](i12 => i12 * |map[p1 := v7[256]]|);
			var v80 := new C0(v79);
			var v81 := DC10();
			var v82: multiset<D2> := multiset{v81};
			var v83: seq<bool> := [p2];
			var v84: seq<bool> := [v83[p3], v7[256], fm8(globalState)];
			var v85 := DC18(v82, v8.f29, v84[|v13| := p1], p2);
			var v86 := DC8(p3);
	...
	method m10(p0: map<map<int, int>, array<int>>, p1: array<multiset<bool>>, p2: int, globalState: GlobalState) returns (r0: bool, r1: string, r2: int) {
		...
		var v3 := "ekrvjx";
		var v4 := 'y';
		var v5: set<string> := {v3[p2 := v4], v3};
		var v6: map<bool, bool> := map[v0 := v0];
		var v7: array<int> := new int[5] [p2 / p2, |v1|, p2 - |v2|, |(v5 - {v3})|, |v6|];
		...
		var v12: seq<int> := [|v11|];
		v7[559] := -0x394 - |(if (v0 in v9) then v9[v0] else v8[-(if (v0 in v10) then v10[v0] else p2) := |v12|])|;
		v7[559] := v12[p2];
		var i0 := 0;
		while (v1 >= (v1 * v1))
			decreases 100 - i0
		{
			...
			r2 := -v7[559];
			globalState.f13 := p2;
			r1, v12, globalState.f13, v1, r2 := "yrtlexu" + v3, v12[|[v12[p2]]| := p2 - v7[559]], -(if (v0) then v7[559] + v7[559] else p2 - |[v7[559]]|), v1 + v1, v7[559] / -|multiset(v2)|;
			var v13: array<bool> := new bool[26];
			v13, v7[559] := v13, p2;
		}
		var v14 := DC15("lxbeqbbj", p2, v3, v7[559]);
		v14 := v14;
		globalState.f11 := v4 !in v3[v7[559] := v4];
		globalState.f11 := v0;
		var v16: set<int> := {v7[559], if (p2 in v8) then v8[p2] else v7[559], p2, p2};
...
class C9 extends T1 {
	...
	method m4(p0: string, p1: bool, p2: set<bool>, globalState: GlobalState) returns (r0: char, r1: bool, r2: string, r3: bool) {
		...
		for i0 := f18 to f18 {
			...
			var v6 := 'b';
			var v7: set<string> := {p0, p0[i0 := v6], p0};
			var v8: array<int> := new int[2];
			var v9: map<int, array<int>> := map[f18 := v8];
			var v10: seq<map<int, array<int>>> := [v9];
			var v11: array<int> := new int[23] [if (true) then 514 else i0, i0, i0, i0, f18, |v2|, v3.cf50 % -0x9, |(v4 - v4)|, f18, |p0| * i0, |v5|, |(v7 * v7)|, |v10[f18]|, |v0| + |[f18, f18]|, f18 / 583, i0, i0, |v0| * i0, f18, f18, i0 * i0, i0 - f18, f18];
			v8[42] := if (p1) then i0 else 83;
			v8[42] := f18;
			var v12 := new C0(v11);
			...
			match (v14) {
				case DC6() =>
					...
					var v16 := DC64(v15);
					var v17: array<string> := new string[25] [fm45(p1, v15, p1, globalState), "du", "odktjfhwr", fm45(false, v16.cf104, p1, globalState), p0, p0, seq(0x26d, i1  => (v6)), ("mjku")[v8[42] := v6], p0, p0, p0, p0, p0, ("bdhobk")[i0 := v6], p0, p0, p0, p0, p0, seq(662, i2  => (v6)), p0, p0, p0, p0[f18 := v6], p0];
					var v18: map<bool, array<string>> := map[p1 := v17];
					var v19: seq<array<string>> := [v17];
					v18 := v18[p1 := v19[i0]];
					var v20 := DC9([v6]);
					var v21: seq<string> := [v20.cf13, (p0[i0 := 'q'] + p0)[v8[42] := v6], p0, p0, "ilw"];
					var v22: array<bool> := new bool[22](i3 => p1);
					var v23: map<int, bool> := map[v8[42] := p1];
					v22[513] := if (v8[42] in v23) then v23[v8[42]] else p1;
					var v24: map<string, multiset<char>> := map[p0 := multiset{v6}];
					var v25 := DC62(v24);
					var v26: multiset<int> := multiset{i0, -f18, i0 / i0};
					var v27: multiset<char> := multiset{v6, v6};
					v8[42], v21, globalState.f11, v22[513], v25 := if ((i0 * fm36(-i0, true, p1, p1, globalState)) in v26) then v26[i0 * fm36(-i0, true, p1, p1, globalState)] else fm6(p2, v2, v3.cf53, globalState), v21, (-0x221 % i0) < v12.fm28(v20, globalState), p1, (if (true) then v25 else v25).(cf100 := map[p0 := v27]);
					var v28: map<char, bool> := map[v6 := p1];
					r3 := |v28| >= v8[42];
					var v29: T1 := new C8();
					var v30: multiset<T1> := multiset{v29};
					var v31: multiset<map<bool, bool>> := multiset{v13, v13[p1 := v22[513]], v13, map[p1 := v22[513]] + v13, v13 + v13};
					v8[42], v22, r3, r2, globalState.f13 := f18, v22, (v30 * v30[v29 := i0]) !! v30, p0, if (v13 in v31) then v31[v13] else if (v22[513]) then f18 else f18;
				case DC7(cf11) =>
					globalState.f13 := (f18 - v8[42]) - (0x15 / i0);
					globalState.f11 := v0[v8[42]];
					var v32: map<int, string> := map[i0 := p0];
					r2 := "tl" + (if (-0x1f9 in v32) then v32[-0x1f9] else "jeeyde");
					globalState.f11 := p1;
				case DC8(cf12) =>
					globalState.f4 := 0x288 <= v8[42];
					var v33: seq<string> := [p0];
					var v34: multiset<string> := multiset{p0, p0};
					var v35: array<string> := new string[29] [p0, p0, p0, p0, p0, (p0 + (seq(0x12, i4  => (v6))))[|p0| := v6], p0, "gsaohdwu", "jxmb" + p0, fm33(globalState), p0 + (seq(60, i5  => (v6))), p0 + "tq", p0, (seq(0x35b, i6  => (v6))) + p0, "yrxowbsm", "kvri", p0 + "n", fm33(globalState), "bqffaloy", "q", seq(0x148, i7  => (v6)), v33[-i0], p0, p0, p0, p0, fm45(v0[|p2|], v34, true, globalState) + "yvbonj", p0, p0 + p0];
					v35[213] := "xndg";
					var v36 := DC44(false);
					...
					v35[213], r2, v8[42], r2, v38 := p0[v8[42] := v6], (p0 + "vp") + p0, f18, (p0 + "yb") + p0, v38 + (v38 + v38);
					globalState.f11 := fm8(globalState);
					globalState.f13, r1, globalState.f13 := v8[42] % (f18 - i0), !(if (p1) then p1 else p1) <== !("xp" <= v35[213]), f18;
				case DC5(cf10) =>
					var v39: set<bool> := {p2 >= p2, "qaf" == (seq(0x3c2, i8  => (v6)))[|v0| := v6], p1, p1};
		...
		for i9 := f18 to |v43| {
			...
			if (i9 != |map[p1 := |v45|]|) {
				...
				globalState.f13 := (f18 % f18) % (if (p1 in v51) then v51[p1] else i9);
			} else {
				globalState.f11 := p1;
				...
				v55 := v55;
				globalState.f13 := f18 / |map[f18 := p2]|;
				globalState.f13 := i9;
			}
			...
			if (v62.cf58) {
				...
				var v67: array<int> := new int[22](i11 => i11 % i9);
				...
				v70[162] := f18 * (if (p1 in v71) then v71[p1] else i9);
				var v72: map<bool, bool> := map[p1 := !true];
				var v73: map<int, bool> := map[v70[162] := if (p1 in v72) then v72[p1] else p1];
				globalState.f11 := p1 || !(if (|(seq(0x39a, i12  => (|v0|)))| in v73) then v73[|(seq(0x39a, i12  => (|v0|)))|] else p1);
				v70 := v70;
				r3 := p1;
				v45 := seq(0x4f, i13  => (i9));
			}
		...
		if (!(|(v79 + v79[f18 := fm10(p1, f18, v80, globalState)])| !in (map v81 : int | v81 in v82 :: (v81 * f18) := (p1)))) {
			var v83: array<C0> := new C0[7];
			globalState.f1, v83, globalState.f11 := f18 / f18, v83, p1;
			r2 := p0;
			var v84: map<bool, bool> := map[true := p1];
			var v85 := DC15("rqyshhyqv", f18, p0, f18);
			var v86: array<bool> := new bool[21] [p1, p1, v1.fm16(p1, DC9(p0), v84, globalState), fm43(f18, p1, -|v85.cf21|, globalState), p1, p1, true, p1, p1, if (p1) then p1 else v0[f18], p1, p1, p1, p1 && p1, p1, p1, p1, p1, p1, p1, p1];
			v86[664] := p1;
			v86[664], r3, r1 := fm29(globalState), p1, p1;
			if ((fm46(f18, f18, v86[664], v86[664], globalState) < v0) && (v86[664] || p1)) {
				...
				var v90: map<string, multiset<map<int, int>>> := map[p0 := v89 - multiset(seq(-0x2a6, i15  => (v42)))];
				v90 := v90["mtrw" + p0 := fm69(p1, |p2|, f18, globalState)];
				var v91: array<int> := new int[3](i16 => i16 + f18);
				var v92: map<bool, array<int>> := map[p1 && v86[664] := v91];
				v92 := v92[p1 := if (p1) then v91 else v91];
			}
			
			var v93: map<int, bool> := map[-f18 := v86[664]];
			var v94: array<int> := new int[14] [f18 * |v79|, f18, f18, if (p1) then 219 else f18, -f18, f18, f18, f18, f18, f18, 0x287, f18, |v93|, -(f18 / |p0|)];
			v94[355] := f18;
			var v95: array<char> := new char[29](i17 => v80);
			v95[682] := p0[f18];
			var v96 := DC57(f18, f18, true, |p0|, v86[664]);
			v86[664], v94[355], v95[682], r2 := v96.cf89, f18 / -0x142, v80, p0 + p0;
		} else {
			var v97: array<bool> := new bool[19](i18 => !DC1(p1, |map[p1 := |p0|]|, 0x339, p1, f18).cf4);
			var v98: map<array<bool>, string> := map[v97 := "a"];
			var v99: set<int> := {f18};
			var v100 := new C3(p1, ((if (v97 in v98) then v98[v97] else p0) + fm33(globalState))[|p0| := v80], v99 !! v99, f18);
			var v101: array<int> := new int[7];
			v101[241] := f18;
			var v102: multiset<string> := multiset{seq(0x24e, i19  => (v80)), v100.f27};
			v101[241] := -(f18 - (|fm45(true, v102, v100.f26, globalState)| % f18));
			var v103, v104 := v1.m13(globalState);
			globalState.f11 := v0[f18];
			if (v101[241] !in [v103]) {
				...
				globalState.f4 := v0[f18];
				var v109 := DC10();
				var v110: map<string, bool> := map[v100.f27 := v107.f24];
				v109, v101[241], v80, v110, v101[241] := v109, v103, v80, v110 + (map[v100.f27[|v105| := v80] := false] + v110), f18;
				v103 := f18;
				var v111 := new C6(fm8(globalState), ---216);
			} else {
				var v112 := new C8();
				v0 := v0;
				globalState.f13 := v101[241];
				v101[241], v100.f27, globalState.f4, globalState.f4 := v101[241], v100.f27, fm29(globalState), v82 !! v82;
				v101, r2, v101[241] := v101, (p0 + (seq(0x119, i20  => (v80)))) + fm33(globalState), f18 + (-v103 * v101[241]);
			}
	...
	method m7(p0: D1, p1: int, globalState: GlobalState) returns (r0: int, r1: array<bool>, r2: D0) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v3: array<bool> := new bool[20](i1 => [f18] <= (seq(-0x208, i2  => (|(seq(0x338, i3  => (f18)))|))));
			v3[411] := v0;
			v3[411] := true;
			var v4: array<int> := new int[28];
			var v5: multiset<array<int>> := multiset{v4};
			v3[411] := multiset{v4, v4, v4} <= (v5 * v5);
			v4 := v4;
			var v6 := 'g';
		...
		for i5 := p1 to |v18| {
			...
			var v27: map<int, multiset<int>> := map[i5 := multiset{p1, |v24[|map[f18 := v26]|]|}];
			var v28 := DC36(v19);
			var v29: array<int> := new int[3](i6 => i6 / 0x12c);
			var v30: set<int> := {|[v29]|};
			var v32: map<bool, map<array<bool>, int>> := map[false := map[v19 := |(set v31 : int | v31 in v30 :: (v31 + |[|(seq(875, i7  => (|"tvyqhk"|)))|]|))|]];
			var v33: array<map<array<bool>, int>> := new map<array<bool>, int>[15] [v20, v20 + v20, map[v19 := p1], v20, v21[0x160], v20, v20 + map[v19 := |(if (p1 in v27) then v27[p1] else multiset{-0x2a})|], v20 + v20, v20, v20 + v20, v20 + v20, v20, v20[v28.cf57 := f18] + (if (v9 in v32) then v32[v9] else v20), v20, v20];
			v33[146] := v20 + v20;
			var v35 := DC49(v9, i5, false, |(map v34 : int | (0x120 <= v34) && (v34 < 0x137) :: (v34 * -f18) := (|v30|))|, v9);
			v33[146] := (v20 + map[v19 := 881])[if (v0) then v19 else v19 := i5 * v35.cf73];
			var v36: seq<multiset<int>> := [multiset{|fm70(fm36(f18, v0, v9, v0, globalState), f18, globalState)|}, multiset{-0x1aa}];
			var v37: multiset<multiset<int>> := multiset{v26 * v36[p1], v26, v26};
			var v38: seq<int> := [f18];
			var v39: multiset<bool> := multiset{true};
			v37, globalState.f14 := multiset{v26[p1 := -i5], v26, fm37(v0, p1, i5, p1, globalState), multiset(v38)}, v39[v9 := p1];
			...
			if (v0) {
				...
				var v45 := 'a';
				v19, globalState.f11, v25 := if (v43 in v44) then v44[v43] else v19, v43.f26, v43.f27[f18 * f18 := v45];
				v29[637] := f18;
				v29[637] := |multiset{0x3bd, p1}|;
				v2 := v2 + v2;
				globalState.f11 := v9;
			} else {
				globalState.f1 := i5;
				...
				v48 := v49[-i5] + (v48 + v48);
				v22 := v22[f18 / |[v0, v0]| := i5 >= 0x2f4];
			}
			
		}
		var v50 := "kknhdxhd";
		var v51: multiset<string> := multiset{v50, v50};
		var v52 := new C3(v0, fm45(v0, v51, v0, globalState) + (seq(0x348, i8  => ('d'))), v9, p1);
		r0 := p1 % p1;
		r1 := new bool[22];
	...
	method m8(globalState: GlobalState) returns (r0: seq<seq<char>>, r1: bool) {
		...
		var v3: C8 := new C8();
		var v4: array<int> := new int[13] [f18, f18, f18, f18 % f18, 581 + |v1|, |"ki"| - f18, f18 - 0x3a0, f18, --fm36(f18, v0, v0, v0, globalState), |v2|, f18, |map[v0 := v3]|, f18];
		v4 := new int[20](i0 => i0 * |multiset(seq(0x14f, i1  => (f18)))|);
		var v6: multiset<int> := multiset{f18};
		var v7 := "dgqyrelcb";
		var i2 := 0;
		while (-|v1| == (f18 / |(map v5 : int | v5 in v6 :: (v5 % f18) := (f18))[f18 := |v7|]|))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			v8, globalState.f1, f18 := v8, v9[f18], f18;
			v7 := v7;
			globalState.f4 := v0;
			...
			decreases 100 - i3
		{
			...
			if (fm8(globalState)) {
				...
				v4[21] := f18;
				v18, globalState.f11, v4[21] := fm72(v7, v0, !v16[225], globalState), !!!v16[225], f18 / f18;
				globalState.f1 := |v7|;
				globalState.f4 := v0;
				var v19: seq<int> := [v4[21], -472, v4[21]];
				var v20 := new C5(v19);
				globalState.f11 := v16[225];
			} else {
				v4[990] := f18;
				v4[990] := 813;
				var v21 := DC37(v0, f18);
				var v22: map<bool, int> := map[v0 := v4[990]];
				v21 := v21.(cf58 := v0).(cf58 := (map[v0 := f18])[false := 0x1e1] != v22);
				v16[225] := v0;
				v16 := v16;
				var v23: set<int> := {f18};
				var v24: seq<set<int>> := [v23, {v4[990], f18}, {-f18, v4[990]}];
				var v25 := DC29(v0, |[false, v0]|, v24, f18, v16[225]);
				var v26 := DC29(v0, f18, (v25.(cf44 := f18, cf45 := [v23, v23])).cf45 + [v23], |v7| % v4[990], v16[225]);
			...
			if (v0) {
				...
				var v30: map<multiset<int>, array<int>> := map[fm37(v16[225], f18, |v29|, f18, globalState) := v4];
				var v31 := DC33(f18, v0, v0, v0);
				globalState.f1 := |v30| / (if (v31.cf51) then f18 else f18);
				var v33: map<map<char, bool>, bool> := map[map[v11 := v16[225]] := v0];
				var v34 := new C7(map v32 : map<char, bool> | v32 in v33 :: (v32) := (false), if (v16[225]) then v0 else v0);
				v4 := v4;
			} else {
				var v35: set<bool> := {v0, v0};
				var v36: seq<map<bool, bool>> := [map[v0 := v0]];
				var v37: map<bool, int> := map[v16[225] := |v36|];
				...
				var v42: map<seq<int>, array<array<bool>>> := map[seq(-0x9b, i4  => (0x3e3)) := v41];
				...
				var v50: map<array<int>, int> := map[v4 := |(map[v49 := v16[225]] + map[v49 := v49.f24])|];
				v46, v50, globalState.f1, globalState.f11, globalState.f13 := v46, v50, -(f18 * 10), v49.f24, f18;
				var v51: array<multiset<bool>> := new multiset<bool>[15](i5 => multiset{v0} * multiset{v49.f24, v49.f24, v16[225]});
				v51[34] := multiset(v1);
				var v52: multiset<bool> := multiset{true, !v49.f24};
				v51[34] := (v52 * multiset{v16[225]}) - multiset{v49.f24, v16[225]};
				var v53: T0 := new C8();
				v53 := v53;
			}
		...
		v54, v4[572], globalState.f13, v4 := if (if (v0) then v0 else true) then DC47(DC47(v55)) else v54, f18 - f18, v57.cf8, v4;
		...
		var v62: seq<seq<char>> := [fm45(fm29(globalState), v61[v4[572]], v0, globalState)];
		r0 := v62 + v62;
		r1 := f18 > (v4[572] % f18);
	}
}
...
class C10 extends T0, T1 {
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		if (p1 >= (p1 % |v0|)) {
			...
			if (p2) {
				...
				var v3 := "fdadnw";
				v3 := fm33(globalState);
				p3[222] := |v3| in map[p1 := map[p1 := p2]];
				p3[222] := if (p2) then p2 else p2;
				globalState.f11 := (p1 < |"fkg"|) <==> p2;
				var v4: map<string, bool> := map[v3 := p2];
				var v5: map<map<string, bool>, int> := map[v4 := p1];
				globalState.f11 := if (p2) then p3[222] else (if (map[v3 := false] in v5) then v5[map[v3 := false]] else p1) > p1;
			} else {
				f17 := f17;
				globalState.f13 := p1;
				globalState.f4 := p2;
			...
			var v12 := "noubslb";
			f17, v11, globalState.f4 := f17, if (v12[|(seq(-0x3e6, i2  => (v12[p1])))|] !in v12) then v11 else v11 - v11, p2;
			...
			var v23: array<int> := new int[28] [|p0|, p1, p1, p1, p1, p1, p1, |p0|, p1, p1, |fm4(globalState)|, |v18|, |v19|, p1, |v18|, p1, -0xbe, -|map[p1 := false]|, p1, |v20|, |([v21, if (p1 in v22) then v22[p1] else v21])[p1 := v21]|, p1, p1, |multiset(fm5(p2, globalState))|, p1, p1, |v10|, p1];
		...
		if (p2) {
			...
			var v32: set<bool> := {p3[885]};
			var v33: map<int, multiset<int>> := map[|(v31 + [f17])| := fm37(p3[885], p1, 946, |v32|, globalState)];
			v33 := (v33[p1 := multiset{p1}] + v33) + v33;
			var v34: multiset<char> := multiset{fm38(p3[885], globalState)};
			p3[885] := v34 !! (v34 - v34);
		} else {
			var v35 := DC51(f17);
			...
			if ((v38[v37 := p1] * v38) !! (v38 + multiset{"bb"})) {
				var v39: array<bool> := new bool[8];
				v39 := v39;
				var v40: seq<array<bool>> := [v39, v39];
				p3[885] := v39 in (if (p2) then [v39] else v40);
				var v41: map<int, bool> := map[0xeb := p3[885]];
				var v42: map<bool, bool> := map[false := p3[885]];
				var v43: map<map<int, bool>, string> := map[v41 := v37];
				var v44: array<int> := new int[23] [p1, |v37|, p1, p1 % p1, p1, p1 % |v41|, |v37|, p1, p1, p1, 291, p1, p1, p1 + |v42|, p1, p1, |v42|, p1 * 988, p1, p1, -0x91, |(if (!true) then v43 else v43)|, p1];
				v44[169] := p1;
				globalState.f1, v44[169], p3[885], globalState.f1 := p1, 859 * (p1 + p1), true, p1;
				var v45: map<bool, array<bool>> := map[fm13(f17, globalState) := v39];
				var v46: map<int, int> := map[|v45| := v44[169]];
				globalState.f13 := p1 / (if (p1 in v46) then v46[p1] else p1);
				globalState.f11 := fm43(0xb4, p3[885], -v44[169] + p1, globalState);
			} else {
				var v47: seq<int> := [p1 / p1, p1];
				v47 := v47;
				globalState.f13 := p1;
				globalState.f13 := p1;
			...
			var v49: map<set<int>, bool> := map[{p1, p1} := p3[885]];
			var v50: multiset<int> := multiset{p1};
			var v51: seq<int> := [p1, -p1, p1];
			var v52: seq<seq<bool>> := [fm46(p1, p1, p2, p2, globalState), v0, v0, v0[|v51| := true], v0];
			var v53: array<seq<bool>> := new seq<bool>[22] [v0[p1 := p2], v0, v0, v0 + v0, v0 + [p3[885]], v0, ([p2, p2, p3[885]] + [p2])[|v49| := p2], v0[p1 := p2], v0, v0, v0, v0 + v0, v0, v0, [p3[885], p3[885]], v0, v0, v0 + v0, [p3[885]], (fm46(p1, if (0x40 in v50) then v50[0x40] else p1, p2, p3[885], globalState))[0x397 := p2], v0, v52[793]];
			var v54: map<int, bool> := map[p1 := p3[885]];
			var v55 := DC21(p1 != p1, p1, p3[885], if (p1 in v54) then v54[p1] else !p3[885]);
			v53, v55, r0, globalState.f11, p3[885] := v53, v55, p1, v0[p1], p3[885];
			if (fm8(globalState)) {
				var v56: map<int, multiset<char>> := map[p1 := multiset(v37)];
				var v57: multiset<char> := multiset{v37[383], f17};
				v56 := v56[-p1 := v57 + v57];
				globalState.f1 := if ((p2 ==> true) in p0) then p0[p2 ==> true] else p1;
				p3[885] := p2;
				v50, globalState.f13 := multiset([p1]), p1;
				globalState.f13 := |(if (!false) then ([f17])[p1 := 'c'] else v37)| / -p1;
			} else {
				globalState.f4 := true;
				var v58 := new C2(v0[p1], |(v37[p1 := f17] + v37)|);
			...
			decreases 100 - i6
		{
			...
			match (v63) {
				case DC55(cf82) =>
					...
					var v69: map<bool, bool> := map[p3[885] := cf82];
					...
					v73 := v74[p1];
				case DC56(cf83, cf84, cf85, cf86) =>
					v0 := cf83[fm36(-0x302, false, p3[885], p3[885], globalState)];
					var v75 := "twhsev";
					v75 := v75;
				...
				case DC54(cf81) =>
					...
					var v91 := "srb";
					v91 := "iak";
					var v92: array<map<bool, bool>> := new map<bool, bool>[16](i7 => map[p3[885] := p3[885]]);
					var v93: map<bool, bool> := map[p2 := !p3[885]];
					v92[314] := v93;
					v92[314] := v93;
				case DC58(cf92) =>
					var v94: seq<char> := [f17, f17, f17];
					v94 := v94;
					globalState.f11 := p3[885];
					p3[885] := p2;
					var v95: map<bool, int> := map[p3[885] := p1];
					var v96 := DC19(v95);
					var v97: map<int, D7> := map[|(v0 + [p3[885]])| := v96];
					v97 := v97[-0x39f := v96];
			}
			...
			var v102: array<int> := new int[13] [p1, 832, p1, p1, |(if (true) then (v0[p1 := p2])[p1 := p2] else v0)[|"pof"| := p2]|, 0x4a, p1, |v99| / v100[p1], p1, |(v101 * v101)|, p1, p1, 256];
			v102[700] := p1;
			var v103: map<bool, int> := map[p2 := p1];
			var v104: map<bool, array<bool>> := map[p3[885] := p3];
			var v105: map<int, array<bool>> := map[|v98| := if (true in v104) then v104[true] else p3];
			v102[700] := |(v103 + v103)| + |(v105 + v105)|;
			var v106 := DC43({v103});
			var v107: map<bool, D18> := map[p2 := v106];
			var v108: map<array<int>, bool> := map[v102 := p2];
			var v109: set<int> := {|multiset{p3[885]}|};
			var v110 := DC69(|v108|, v102, v109);
			var v111: map<D25, string> := map[v110 := "bqmkkb"];
			var v112: seq<map<D25, string>> := [v111[v110 := v98]];
			v107 := v107[!(v110 in v112[p1]) := v106];
			globalState.f13 := |v100|;
		}
		var v113: seq<int> := [p1];
		var v114 := "ev";
		var v115: array<string> := new string[10] ["jo", v114, v114, v114, seq(0x25c, i8  => (f17)), "dg", "xreovqblb", v114, v114, v114];
		var v116 := DC73(DC71(v115));
		var v117 := DC71(v115);
		var v118 := DC73(v117);
		var v119 := DC73(v118);
		match (if (v113[p1 := p1] < v113) then v116 else DC73(v117)) {
			case DC72(cf116, cf117, cf118) =>
				var v120: map<bool, int> := map[p3[885] := cf117];
				var v121: multiset<int> := multiset{cf117};
				var v122: C6 := new C6(p3[885], |v121|);
				var v123: multiset<C6> := multiset{v122};
				globalState.f4 := (p1 - cf116) < (-cf116 % (if (true in v120) then v120[true] else |v123|));
				globalState.f1 := p1;
				var v124: map<char, bool> := map[f17 := p3[885]];
			...
			case DC71(cf115) =>
				...
				var v129 := DC1(p3[885], p1, p1, p2, p1);
				var v130 := DC4(v129);
				var v131 := DC49(p3[885], p1, p3[885], fm36(p1, p2, p2, p3[885], globalState), p2);
				var v132: multiset<D19> := multiset{v131};
				var v133 := DC12(v130, if (DC49(p3[885], 0x21, p3[885], |fm34(globalState)|, p3[885]) in v132) then v132[DC49(p3[885], 0x21, p3[885], |fm34(globalState)|, p3[885])] else p1, p2);
				v128[310] := v133.(cf17 := p2);
				v128[310] := v133;
				var v134: map<bool, multiset<bool>> := map[|v113| < |v114| := p0 * p0];
				globalState.f14 := if (p2 in v134) then v134[p2] else p0;
				v114 := (seq(-0x38e, i9  => (f17))) + v114;
				var v135: set<bool> := {true};
				cf115 := if (p3[885] in v135) then v115 else v115;
			case DC73(cf119) =>
				...
				var v141 := DC74(v139);
				v140 := v140[-(if (p2) then if (!p3[885] in p0) then p0[!p3[885]] else p1 else p1) := v141.cf120];
				var v142: array<map<int, bool>> := new map<int, bool>[14](i10 => map[p1 := p2] + map[p1 := true]);
				v142 := v142;
				var v143 := DC1(p2, p1, 312, p2, -p1);
				var v144 := DC4(v143);
				var v145 := new C4(false, if (p3[885]) then v144 else DC4(v143));
				var v146: map<bool, string> := map[true := v114];
				v146 := v146[p2 := v114[p1 := f17]];
		}
		
		globalState.f1 := fm36(p1, p3[885], p3[885], p2, globalState);
		r0 := |v114[p1 := f17]| % p1;
	}
	method m1(globalState: GlobalState) returns (r0: int) {
		if (fm13(f17, globalState)) {
			...
			match (DC8(v0)) {
				case DC6() =>
					...
					var v7: multiset<seq<bool>> := multiset{[v6[v0]], [v5]};
					...
					var v9: array<bool> := new bool[15] [if (v5) then v5 else v5, true, v0 > v0, !(v5 || !v5), false, !(if (v5) then v5 else v5), v5, v5, v5, !v6[v0], v5, v5, v5, v0 >= v0, v5];
					v9[300] := v5;
					...
					v9[300], globalState.f11, v12, globalState.f11, v13 := fm13(f17, globalState), false, v12 * (if (false) then {v11, v11} else v12), [v16[v0], v0] != ((seq(0xcc, i0  => (|"j"|))) + v16), v13;
				...
				case DC8(cf12) =>
					...
					v25 := if (false) then (multiset(v27[|(map v28 : int | (0xb0 <= v28) && (v28 < 0x1a6) :: (v28 * v0) := (cf12))| := cf12]))[v0 := cf12] + v25 else multiset{|v25|} * v25;
					globalState.f4 := v23;
					var v29: seq<bool> := [!v23];
					var v30 := new C6(v29[|v29|], -(cf12 - 711));
				...
				case DC5(cf10) =>
					...
					v32 := {fm43(v0, v31, |v33|, globalState), fm46(|v34|, -v0, v31, v31, globalState) <= v35, v35[v37.cf123]};
					globalState.f13 := v0;
			}
			...
			v43[769] := |v44|;
			v43[769] := 0x273;
			var v45: map<int, multiset<int>> := map[|v44| := multiset(seq(0x3e6, i1  => (473)))];
			var v46: multiset<int> := multiset{v43[769], v43[769], v43[769]};
			var v47: map<multiset<int>, int> := map[v46 := v43[769]];
			var v49: set<multiset<int>> := {v46, multiset{v43[769], v43[769], 0x1dc}, v46, v46, v46};
			var v50: multiset<map<multiset<int>, int>> := multiset{map[if (v43[769] in v45) then v45[v43[769]] else v46 := v43[769]] + v47, map v48 : multiset<int> | v48 in v49 :: (v48) := (|map[false := false]|), v47};
			r0 := if ((v47 + v47) in v50) then v50[v47 + v47] else v43[769];
			if (true) {
				var v51 := false;
				var v52: seq<bool> := [false, v51, v51, false, false];
				var v53 := new C3(v52 < v52, "dskmpr" + v44, v51, v43[769]);
				var v54 := DC1(v51, |(map[v51 := f17])[true := f17]|, v43[769], v51, v43[769]);
				var v55 := DC4(v54);
				var v56 := DC12(v55, v43[769], v53.f26);
				var v57: array<bool> := new bool[18];
				var v58: map<array<bool>, int> := map[v57 := v43[769]];
				v56 := v56.(cf16 := |v58|);
				...
				var v63: seq<int> := [-|(seq(-433, i2  => (f17)))|];
				var v64: set<int> := {v43[769], if (v43[769] in v46) then v46[v43[769]] else v43[769], |v63|};
				var v65 := new C3(v64 < v64, v44 + v44, !v62, -v43[769]);
				var v66 := new C5(v63);
			}
		...
		r0 := |(if (v68) then v69 else v69)| / v73;
		...
		for i5 := if (v79 in v80) then v80[v79] else fm36(v73, v68, fm29(globalState), v68, globalState) to v73 {
			...
			v81[151] := -(v82.cf59 - (0x2ba % -i5));
			var v83 := DC40(f17);
			var v84 := DC70(false, v83);
			var v85: map<D25, int> := map[v84 := --(v73 + i5)];
			v85 := v85[DC70(v68, fm75(v68, f17, v68, v81[151], globalState)) := v81[151]];
			globalState.f13 := v73;
			var v86: map<char, int> := map['u' := v73];
			var v88: map<char, bool> := map[f17 := false];
			v86, globalState.f11, globalState.f1 := v86 + ((map v87 : char | v87 in v88 :: (v87) := (v81[151]))[f17 := i5])[f17 := 0x3c], v68 <== (!true <== v68), v73;
		}
		r0 := -((v73 % v73) / v73);
	}
	method m4(p0: string, p1: bool, p2: set<bool>, globalState: GlobalState) returns (r0: char, r1: bool, r2: string, r3: bool) {
		...
		if (v8 >= v8) {
			...
			if (v10.f20 <==> (if (!v10.f20) then v10.f20 else fm8(globalState))) {
				...
				var v20: seq<int> := [v0];
				var v21 := DC1(!p1, v0, v20[v0], p1, v0);
				var v22: map<bool, int> := map[v21.cf4 := v0];
				var v23: array<int> := new int[11] [fm10(v10.f20, -|v19|, f17, globalState), if (v10.f20 in v22) then v22[v10.f20] else v0, v0, v0, fm10(true, v0, f17, globalState), v0, v0, |fm46(v0, v0, v10.f20, v10.f20, globalState)| % v0, v0 % |"uvcddbyh"|, v0, v0];
				v17[463] := v20[v0];
				...
				v17[463], v26, f17, v25, r2 := (v0 - v0) - 0x2a7, v26, f17, v25, seq(0x336, i1  => (f17));
			...
			if (-|(v28 + v28)| > v0) {
				...
				var v39: array<map<int, bool>> := new map<int, bool>[16] [v32[|v34[v33 := p1]| := v10.f20], v32, v32, v32, v32, v32, v32, v32, map v35 : int | (-0x3e6 <= v35) && (v35 < 997) :: (v35 % v0) := (v10.f20), v32, map v36 : int | v36 in v37 :: (v36 % v0) := (v10.f20), v32, v32, map[v0 := v10.f20], if (v0 in v38) then v38[v0] else v32, v32 + v32];
				v39 := v39;
	...
	method m5(p0: int, p1: array<int>, p2: array<bool>, p3: bool, globalState: GlobalState) returns (r0: seq<bool>, r1: map<int, int>, r2: char) {
		...
		var v2 := new C4(p3, v1);
		var v3 := "ua";
		v3 := v3[|fm60(false, globalState)| := f17];
		p1[133] := p0;
		p1[133] := p0;
		p1[133] := -p0;
		var v4: map<bool, array<int>> := map[v2.f24 := p1];
		var v5: set<int> := {p1[133]};
		var v6: map<int, bool> := map[p0 := p3];
		var v8: map<array<int>, bool> := map[if (p3 in v4) then v4[p3] else p1 := v5 >= (set v7 : int | v7 in v6 :: (v7 % |(seq(0x36d, i0  => ('s')))|))];
		v8 := (v8 + v8)[p1 := !v2.f24];
		globalState.f4 := p3;
		var v9: seq<bool> := [p3];
		r0 := (if (false) then v9 else v9) + (v9[p0 := v2.f24] + v9);
		var v10: map<int, int> := map[674 := -p1[133]];
		r1 := v10;
		r2 := 'h';
	}
	method m6(p0: int, globalState: GlobalState) returns (r0: string, r1: array<int>) {
		...
		var v1 := true;
		if (v1) {
			var v2: array<int> := new int[13](i0 => i0 % p0);
			v2[924] := p0;
			v2[924] := -(-(p0 / p0) / p0);
			var v3 := DC0(v1);
			var v4 := DC4(v3);
			...
			var v7 := DC56(seq(2, i1  => ([v1])), true, |map[v1 := v1]|, v1);
			var v8: seq<int> := [v2[924], v7.cf85];
			var v9: seq<bool> := [v1];
			var v10: set<array<int>> := {v2};
			var v11: multiset<bool> := multiset{v1};
			var v12: array<bool> := new bool[27] [v1, v1, v1, v1, !(v2[924] < p0), v2[924] == p0, v5.cf17, !v1 !in v6[v1 := v2[924]], v2[924] == 0x2d, v1, true, v1, [v2[924]] < v8, v1, false, v1 ==> v1, !v1, v1, v9[|v10|], v1, v1 in map[true := !v1], false, v1, v11 !! v11, !v1, "rexmeb" == v0, v1];
			v12[141] := false;
			v12[141] := v1;
			var v13: array<string> := new seq<char>[25](i2 => v0 + v0);
			v13[903] := (fm4(globalState))[v2[924] := f17];
			var v14: multiset<string> := multiset{"sierlxg"};
			v13[903] := fm45(v1, v14, v12[141], globalState) + (v0 + v0);
			...
			var v24: seq<int> := [p0];
			var v25: array<int> := new int[17] [p0, |v23[p0]|, if (v1) then p0 else p0, v24[p0], |v0|, p0, p0, |v24|, p0, p0, fm36(p0, v1, v1, v1, globalState), p0, p0, p0, p0, p0, p0];
			v25[995] := 0x10d;
			var v26: array<char> := new char[25](i4 => f17);
			v26[239] := v0[p0];
			v25[995], v1, v26[239] := p0, -fm10(v1, p0, f17, globalState) >= (|v24| + p0), v0[p0];
			globalState.f13 := v25[995];
			v19 := v20.cf128;
		...
		var v43: array<int> := new int[27] [p0, fm10(false, p0, f17, globalState), |v0|, p0, |([v1, true] + [v1])|, |(v34 + {v33})|, if (v1) then p0 else |v35|, |((map[v37 := p0])[v37 := p0] + (if (v0 in v39) then v39[v0] else map[v37 := p0]))|, p0, p0 / fm36(0x1fd, v1, v36.f29, false, globalState), p0, p0, p0, p0, p0, -(p0 % p0), p0, p0, |(v40 + v40)|, p0, p0, |v41|, p0, if (v36.f29) then p0 else if (v1 in v41) then v41[v1] else p0, if (fm29(globalState)) then |v29| else if (p0 in v42) then v42[p0] else |v0|, p0, p0];
		r1 := v33;
	}
}
...
class C11 extends T0 {
	...
	method m0(p0: multiset<bool>, p1: int, p2: bool, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		v0 := v0;
		var v1: seq<bool> := [p2];
		var v2: set<bool> := {p2, p2, false, v1[642], p2};
		var v3 := DC3(v2, f16);
		match (if (!p2) then v3.(cf8 := v3.cf8) else v3) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				var v4 := "qbjehw";
				v4 := v4;
				match (fm1(if (v1[f16]) then f15 else f15, fm0(cf4, cf2, globalState), p2, cf4, globalState)) {
					case DC1(cf1, cf2, cf3, cf4, cf5) =>
						var v5: multiset<int> := multiset{f16 % 601, cf2, cf2 * --0x2a2, f16};
						v5 := v5;
						var v6: array<char> := new char[11] [f15, f15, f15, 's', 'x', f15, f15, f15, f15, f15, f15];
						v6[966] := f15;
						var v7: array<int> := new int[9](i0 => i0 + |v4|);
						v7[334] := |v4| % cf5;
						v6[966], v7[334] := f15, cf2;
						v4 := v4;
						var v8 := DC2(-(v7[334] + |v4|));
						var v9: map<array<bool>, seq<bool>> := map[v0 := v1];
						v8, v6[966], v4, v9 := if (p2) then v8 else v8, f15, v4, (v9 + v9) + (v9 + v9);
					case DC2(cf6) =>
						...
						var v15: array<int> := new int[9] [|v12| - p1, p1, f16, 505, fm2(cf4, 6, p2, cf4, globalState), 0x83, |v14|, |v4| % cf3, cf6];
						v15[478] := cf5 + p1;
						v15[478] := p1;
						var v16 := 'r';
						v16 := f15;
						var v17: seq<array<int>> := [v15, v15];
						v15 := if (!cf1) then v15 else v17[f16];
					case DC3(cf7, cf8) =>
						...
						v24[580] := f15;
						v24[580], globalState.f11, globalState.f11 := f15, if (cf3 in v21) then v21[cf3] else cf2 <= cf8, p2;
						globalState.f13 := f16;
						cf5 := p1;
					case DC0(cf0) =>
						var v25: array<int> := new int[16];
						v25[518] := f16;
						v25[662] := fm2(cf1, p1, p2, p2, globalState);
						var v26: map<int, bool> := map[cf5 := cf0];
						var v27 := DC0(true);
						cf2, cf5, v25[518], v25[662], globalState.f4 := cf2, fm2(cf4, f16 % f16, if (|map[|map[cf1 := cf3]| := cf1]| in v26) then v26[|map[|map[cf1 := cf3]| := cf1]|] else p2, v27.cf0, globalState), (p1 / cf5) + 646, --cf3, f16 > cf3;
						p3[926] := p2;
						p3[926] := cf1;
						...
						p3[926] := v28 == (v28 + v29[|v2|]);
					case DC4(cf9) =>
						var v31: seq<int> := [p1];
						var v32: seq<seq<int>> := [v31];
						var v33 := DC1(cf1, 0x212, |(map v30 : int | v30 in v32[cf3] :: (v30 * cf2) := (cf4))|, true, |v31| - |{|v4|}|);
				...
				if (v36.cf0) {
					...
					globalState.f14 := p0[v2 == v2 := cf5];
					var v39 := m3(globalState);
					var v40: array<C2> := new C2[1];
					var v41: multiset<int> := multiset{p1};
					var v42 := DC52(-|p0|);
					var v43: array<int> := new int[16] [cf3, cf5, f16, |fm46(cf3, |v41|, v39, p2, globalState)|, fm36(f16, cf1, cf1, p2, globalState), |v37|, cf2, cf3, p1, |(seq(686, i1  => (cf5)))|, p1, |v37|, |(seq(-0xf4, i2  => (f15)))|, v42.cf79, p1, p1];
					...
					v50[147] := cf3 / p1;
					v50[147] := fm10(cf3 > f16, cf3, f15, globalState);
				}
			...
			case DC2(cf6) =>
				...
				globalState.f7 := v58[if (!v55) then f16 else cf6];
				var v59: array<int> := new int[8](i3 => i3 % cf6);
				v59 := v59;
				v0[524] := v55 ==> fm0(!v55, cf6, globalState);
				v0[524] := f16 > f16;
			case DC3(cf7, cf8) =>
				var v60: array<seq<bool>> := new seq<bool>[19](i4 => [p2, false] + v1);
				v60 := new seq<bool>[4];
				globalState.f13, globalState.f4 := if (p2) then cf8 % p1 else p1, false;
			...
			case DC0(cf0) =>
				...
				globalState.f13 := p1 % (p1 - (if (fm2(true, p1, p2, cf0, globalState) in v63) then v63[fm2(true, p1, p2, cf0, globalState)] else f16));
			case DC4(cf9) =>
				var v65: seq<int> := [p1];
				var v66: seq<int> := [f16, v65[p1], p1, p1, p1];
				...
				var v72 := 'w';
				v72 := if (p2) then v70[fm10(p2, f16, v72, globalState)] else f15;
				var v73: array<string> := new string[19];
				v73[778] := "kvsgf" + v70;
				var v74: C1 := new C1(if (p2) then false else p2);
				var v75 := DC80(!p2, p1, p1, -0x38e, f16);
				globalState.f1, globalState.f4, v73[778], v74, globalState.f11 := (if (p2) then p1 else |v70|) / --0x2e3, v74.f29, v70, v74, v75.cf129;
				v1 := v1;
		}
		...
		v81 := v81;
		globalState.f1 := fm10(p2, f16, f15, globalState) % f16;
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		var v2: seq<bool> := [v0];
		var v3: array<bool> := new bool[10] [false, v0, v0, v0, v0, v0, v0, fm13(f15, globalState), v1 > v1, v2[f16]];
		v3[609] := v0;
		...
		var v8: array<multiset<bool>> := new multiset<bool>[12] [v1, v1, fm23(|v5|, v0, v6, globalState) + v1, (fm40(globalState))[v0 := |v2|] * v1, v1 + v1[v0 := f16], v7[-fm2(v0, f16, v0, v0, globalState)], v1, v1, v1, v1[v0 := -0x1bd], v1 * v1, v1];
		var v9: seq<int> := [|("n")[f16 := 'a']|];
		var v10: set<seq<int>> := {v9};
		v3[609], v4, v8, globalState.f4, v3 := {(v9[f16 := f16])[f16 := f16]} > v10, v4, v8, v0, v3;
		var v11: C6 := new C6(v0, |v6|);
		var v12: map<C6, int> := map[v11 := f16];
		var v13: map<bool, int> := map[v3[609] := |v2[|v12| := v0]|];
		var v14: map<map<bool, int>, char> := map[map[v3[609] := |v13|] := f15];
		var v15: map<map<map<bool, int>, char>, seq<bool>> := map[v14 := v2];
		var v16: seq<map<map<bool, int>, char>> := [v14];
		var v17: map<bool, bool> := map[v0 := v3[609]];
		v15 := v15[v16[f16] + v14 := [fm29(globalState), v3[609], v11.fm16(v0, fm77(857, f16, globalState), v17, globalState), v0] + v2];
		...
		var v24: seq<T0> := [v23];
		var v25: set<array<int>> := {v22[|v24|]};
		var v26: seq<C10> := [v18, v18, v18, v18, v18];
		r0, globalState.f1, globalState.f13, v18, v20 := (f16 / f16) / |v13|, f16 * |v25|, if (v3[609]) then f16 else f16 * f16, v26[(if (v3[609] in v1) then v1[v3[609]] else |v2|) / f16], if (false) then v20 else fm78(v0, globalState);
		var v27: map<seq<bool>, int> := map[[v3[609]] := f16];
		var v28: map<seq<bool>, C10> := map[[v3[609], v0] := v18];
		if (multiset([f16, f16, |map[|v27| := if (v2 in v28) then v28[v2] else v18]|, f16]) <= v6) {
			...
			var v31: set<bool> := {!v3[609], v3[609], |v30| >= v11.fm14(v18.f17, v3[609], globalState)};
			v31 := v31;
			...
			if (f16 >= ((if (v18.f17 in v32) then v32[v18.f17] else f16) * f16)) {
				...
				var v36 := DC7(v3[609]);
				v35[739] := v36;
				v35[739], globalState.f1 := v36.(cf11 := v0), f16 / --|fm74(v3[609], false, ['m', f15, v18.f17], globalState)|;
				var v37: seq<seq<bool>> := [v2];
				var v38 := DC49(v3[609], f16, f16 != f16, f16, f16 <= |v37|);
				v38, v3[609] := v38.(cf75 := f16, cf72 := v3[609]), v3[609];
				var v39: seq<set<int>> := [v19, v19];
				v3[609] := |(if (v3[609]) then v39[|multiset{v3[609], v0, v0, false}|] else v19)| == f16;
			} else {
				globalState.f1 := f16;
			...
			var v45: map<bool, array<int>> := map[v3[609] := v21];
			var v46: map<bool, array<int>> := map[false := if (v3[609] in v45) then v45[v3[609]] else v21];
			v44[569] := if (!v0 in v45) then v45[!v0] else v21;
			v44[569] := v21;
		} else {
			var v47 := "xqxjykc";
			v47 := ("pqacusqf" + v47) + (seq(0x2f0, i1  => ('k')));
			var v48 := DC2(f16);
			var v49 := DC4(v48);
			var v50: C4 := new C4(v0, v49);
			var v51: set<C4> := {v50, v50};
			if (|v51| == f16) {
				globalState.f13 := f16 / -f16;
				...
				var v55 := DC28(v54);
				v53[369] := v55;
				v53[369] := fm79(f16, globalState);
				var v56: set<bool> := {v50.f24};
				var v57: set<char> := {f15};
				var v58: set<seq<char>> := {v47};
				globalState.f4, v3[609], v3[609], v56 := (v3[609] <== v50.f24) || (0x3a3 > |v57|), !v50.f24, v50.f24 ==> ({v47, v47, [v18.f17, v18.f17, 'e'], v47} !! v58), v56 * v56;
				var v59: C9 := new C9(f16);
				var v60: map<C9, multiset<int>> := map[v59 := v6 * v6];
				v60 := v60[v59 := v6];
			} else {
				globalState.f4 := !v50.f24;
				var v61 := DC24(v2[f16], -0x1b4, f16);
				var v62 := DC65(v61);
				v62 := v62;
			...
			if (v3[609]) {
				...
				v67 := if (!v3[609]) then v67 else v67;
				v21[105] := f16 / f16;
				v21, v47, v21[105] := v21, v47, f16;
			} else {
		...
		v3[609] := match DC50(v1) {
			case DC51(cf78) => v0
			case DC52(cf79) => f16 <= f16
			case DC50(cf77) => v3[609]
			case DC53(cf80) => v0
		};
		for i3 := f16 to -138 {
			var v72 := DC19(v13);
			match (if (!fm13(v18.f17, globalState)) then DC19(v13) else v72.(cf29 := v13).(cf29 := v13)) {
				case DC20() =>
					...
					var v76 := v11.m0(multiset{false} * v1, i3 / f16, !v3[609], v3, globalState);
					var v77 := "yocwd";
					var v78: map<int, string> := map[v76 := v77];
					var v79: map<char, bool> := map[v18.f17 := v0];
					var v80 := DC82(map[v3[609] := v79]);
					globalState.f4, v3[609], v3, v3[609], v3[609] := v2[|(if (i3 in v78) then v78[i3] else v77)|], (v3[609] ==> true) !in v80.cf136, v3, v0, true;
				case DC21(cf30, cf31, cf32, cf33) =>
					var v81 := "cgbsaayr";
					var v82 := v11.m0(multiset{v0, !v3[609], cf30}, |v81|, cf30, v3, globalState);
					globalState.f1 := --0x112;
					var v83: map<char, int> := map[fm3(cf30, fm2(false, v82, cf32, cf32, globalState), globalState) := v82];
					v3[609], globalState.f13 := v3[609], if (v3[609]) then |v83| / cf31 else v82;
					globalState.f4 := fm8(globalState);
				case DC19(cf29) =>
					globalState.f4 := (0xad * i3) !in (map v84 : int | (107 <= v84) && (v84 < 0x2e2) :: (v84 - v9[f16]) := (v3[609]));
					v21 := v21;
					var v85 := "fyyj";
			...
			var v90: multiset<map<bool, bool>> := multiset{map[v0 := v3[609]]};
			var v91: map<bool, map<string, int>> := map[v0 := map[v87 := i3]];
			var v92: array<map<string, int>> := new map<string, int>[22] [fm80(globalState), v88 + v88, v88, v88, v88, v88[v87 := f16], v88, v88, map[v87 := i3] + v88, v89[|v90|], v88, v88 + map[v87 := f16], map[v87 := f16] + v88, if (v3[609] in v91) then v91[v3[609]] else v88, v88, fm80(globalState), v88, v88, v88, v88[v87 := i3], fm80(globalState), v88];
			var v94: multiset<string> := multiset{"ndbvliwml", v87};
			v92[454] := map v93 : string | v93 in v94 :: (v93) := (i3);
			v21[167] := -f16 - f16;
			v23, v92[454], globalState.f4, r0, v21[167] := v23, v88, (f16 == f16) && v0, i3, i3 % i3;
			v18.f17 := if (!v3[609]) then v18.f17 else f15;
			globalState.f4 := !v3[609];
		}
		var v95 := DC63(true, v0, map[f16 := v3[609]]);
	...
	method m2(p0: int, p1: D0, p2: array<array<bool>>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: string) {
		...
		var v10: array<int> := new int[25](i2 => i2 / f16);
		v10 := v10;
		var v11 := DC44(!v0);
		var v12 := DC47(v11);
		match (v12) {
			case DC44(cf65) =>
				...
				match (DC33(f16, cf65, v15.cf86, cf65).(cf52 := v13[fm36(p0, v0, v0, v0, globalState)])) {
					case DC32() =>
						var v16: map<char, bool> := map['o' := cf65];
						var v17 := DC59([v16, v16]);
						var v18: seq<string> := ["hjerb"];
						var v19: seq<map<char, bool>> := [v16, v16, v16];
						var v20: array<D22> := new D22[12] [v17, v17, v17.(cf93 := [map[f15 := v0]]), v17, v17, fm81(v0, f16, cf65, v18[p0], globalState), v17, DC59(v19), v17, v17, v17, v17];
						v20[616] := DC59(v19);
						v20[616] := DC59(v19);
						var v21 := "iyas";
						...
						v24 := v24;
					case DC33(cf50, cf51, cf52, cf53) =>
						var v25: array<bool> := new bool[4](i3 => |(seq(683, i4  => (f15)))| < -p0);
						var v26: map<bool, bool> := map[false := fm29(globalState)];
						v25[844] := if (!cf51 in v26) then v26[!cf51] else cf51;
						v25[844] := cf65;
						var v27: seq<int> := [f16, p0, f16, cf50];
						v10[707] := cf50 + |fm32(v25[844], v25[844], v27, v0, globalState)|;
						v10[707] := 0x3b4;
						var v28: map<int, bool> := map[p0 := v0];
						globalState.f13 := |(v28 + v28)|;
						var v29 := DC52(v10[707]);
						v29 := v29;
					case DC31(cf49) =>
						var v30: seq<int> := [|v13|, -0xe3, 0x223];
						var v31: map<bool, seq<int>> := map[v0 := v30[p0 := p0]];
						var v32: set<bool> := {true};
						var v33 := new C5(v30 + (if (true in v31) then v31[true] else v30[f16 := |v32|]));
						var v34: multiset<int> := multiset{p0, f16, f16 / p0, f16};
						globalState.f1 := |v34|;
						var v35: array<seq<int>> := new seq<int>[2] [seq(0x2a9, i5  => (p0)), v30];
						v35[601] := v30[f16 := |v32|] + [f16];
						var v36 := DC34(v30);
						v35[601] := if (cf65) then v36.cf54 else v33.f23;
						var v37 := DC17(p2);
						v37 := v37;
				}
				...
				if (multiset{v0, v0, v0, v0} >= multiset{fm13(if (p0 in v38) then v38[p0] else f15, globalState), cf65}) {
					var v39: array<int> := new int[2](i6 => i6 - v10[924]);
					v39 := v39;
					var v40: multiset<int> := multiset{605};
					var v41: multiset<bool> := multiset{f16 != v10[924], v0, multiset{f16} <= v40};
					globalState.f1 := if (!cf65 in v41) then v41[!cf65] else v10[924];
					globalState.f4 := v0;
					var v42: seq<int> := [v10[924]];
					globalState.f4 := v0 || (v42 < v42);
					globalState.f4 := fm8(globalState);
				} else {
					globalState.f4 := cf65;
					v10[924] := v10[924];
					globalState.f11 := v13[f16];
					var v43 := DC35(v0, p0);
					var v44: multiset<int> := multiset{p0};
					var v45: multiset<multiset<int>> := multiset{v44};
					var v46: seq<multiset<int>> := [multiset{|v13|}];
					var v47 := "kax";
					var v48: array<bool> := new bool[19] [v43.cf55, v0, f16 >= p0, !v0 && fm0(v0, v10[924], globalState), cf65, v0, v0, cf65, cf65, v0, v45 == multiset(v46), cf65, v0, |v47| <= |v47|, |[f16]| <= |"hedexln"|, !cf65, v0, true, !cf65];
			...
			case DC45(cf66) =>
				...
				globalState.f13 := (p0 / f16) + (|map[p0 := v55]| / -p0);
				...
				v58[541] := (v60 + (if (f15 in v61) then v61[f15] else map[cf66 := v59])) + map[v54.f20 := v59];
			case DC46(cf67, cf68, cf69) =>
				...
				if (!(([v0] + v63) <= v63)) {
					...
					v78[437] := v75;
					v78[437], v77, globalState.f4 := (v75 + [v74, v74]) + v75, v77, !v0;
					...
					v81[527] := !fm43(-|v72|, v62.f29, 0x26f, globalState);
					v81[527] := f16 in v71;
				}
				
				var v82: map<char, bool> := map[fm38(cf67, globalState) := v62.f29];
				var v83: multiset<bool> := multiset{cf68, if (f15 in v82) then v82[f15] else v62.f29, v63[-p0], cf68, cf68};
				globalState.f14 := v83 * v83[v62.f29 := cf69];
			...
			case DC43(cf64) =>
				...
				var v86: seq<int> := [p0];
				var v87: seq<int> := [0x3b3, p0 - p0, if (v0 in v85) then v85[v0] else v86[-p0]];
				v86 := v86;
				var v88: seq<seq<int>> := [v86[p0 := p0], v86];
		...
		r2 := match v100 {
			...
			case DC74(cf120) => "oo" + ("sojx")[|[f15]| := DC51(f15).cf78]
		};
	}
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := 0x45 to f16 {
			...
			v9[142] := if (v5) then v5 else v5;
			v9[142] := v5;
			if (v9[142]) {
				var v10: multiset<bool> := multiset{v9[142], true};
				...
				v15 := v15[fm41(globalState) - v14 := v9[142]];
				var v16: array<int> := new int[7] [i0, i0, f16 % f16, f16, i0, i0, f16];
				...
				globalState.f1, v16[288], v23[994] := |v27| % i0, |v0| + (if (if (v16 in v28) then v28[v16] else v9[142]) then i0 else v18.f22), v22;
			} else {
				var v29: map<int, bool> := map[728 := v9[142]];
				var v30: multiset<int> := multiset{|v29|};
				var v31: map<multiset<int>, bool> := map[v30 := v9[142]];
				v31 := v31[multiset{i0} := v9[142]];
				var v32: multiset<string> := multiset{"jcubwiqsj", v0};
				var v33: array<string> := new string[13] [v0, seq(0x1aa, i2  => (f15)), v0, "bmtkadpk", "xgdxlrqcj", "kthpw", v0, v0, seq(0x4, i3  => (f15)), fm45(v9[142], v32, v5, globalState), v0, "kj", v0];
				...
				v37[188] := if (v5 in v34) then v34[v5] else v33;
				v37[188], globalState.f11 := v33, v5;
				var v38: array<int> := new int[25](i4 => i4 / |[|map[!v5 := multiset{true}]|, f16, -f16, f16]|);
				v38[792] := i0;
				var v39: multiset<bool> := multiset{true, !v5};
				v38[792] := if (v39[v9[142] := f16] !! v39) then i0 else fm36(i0, v9[142], v5, v9[142], globalState);
				v9, v38[792], v38[792], globalState.f4 := v9, -fm2(v9[142], v38[792], v5, v5, globalState), --f16, fm13(f15, globalState);
				var v40: seq<int> := [i0];
				var v41: seq<seq<int>> := [seq(0x207, i5  => (0xc6)), v40, fm34(globalState) + v40];
				v41 := [v40, v40, v40];
			}
		...
		globalState.f11, globalState.f1, v42 := v5, -((f16 + |v43|) + f16), fm46(-f16 / f16, |v0|, v5, !v5, globalState);
		for i6 := 0xc2 to f16 {
			var v44: array<bool> := new bool[1];
			v44 := v44;
			var v45: set<string> := {v0, v0, "wg", v0};
			v45 := v45 - ({v0, v0, v0} + {seq(-0xa5, i7  => (f15)), "miggc"});
			...
			var v54: array<int> := new int[18] [f16, if (v47 in v51) then v51[v47] else f16, i6, i6, i6, i6, |(v0 + v0)|, i6, 0x201, fm2(true, f16, v5, v5, globalState), fm36(i6, v5, v5, v5, globalState), v52.cf22, f16, i6 / i6, i6, |v53| + i6, |v0|, f16];
			v46[68] := |v42|;
			v46[68] := -|v0| * i6;
		...
		var v57: map<bool, bool> := map[v5 := v42[f16]];
		...
		var v64: array<int> := new int[24] [f16, |(v42 + v42)|, f16, |fm83(globalState)|, f16, f16, f16, |v56| % |map[v5 := v5]|, |DC5(v57).cf10|, f16, f16 + -|v58|, f16, |(seq(0x13a, i9  => (f15)))| * f16, |v56| % fm2(v5, -|v57|, v5, v59.cf107, globalState), f16, f16, --0x109, |v60| / f16, |v61|, f16 + -f16, |v63|, f16, f16, f16];
		v64[770] := |v0|;
		...
		forall i10 | 0 <= i10 < v62.Length {
			v62[i10] := i10 - (0x306 / v64[770]);
		}
		var v68: multiset<int> := multiset{f16, v64[770]};
...
method Main() {
	...
	var v23: array<map<string, char>> := new map<string, char>[22](i0 => map v22 : string | v22 in (seq(444, i1  => (v20))) :: (v22) := (v18));
	var v24: map<string, char> := map["uwc" := 'g'];
	v23[807] := v24;
	v23[807] := fm84(v5, fm41(globalState) - v6, globalState);
	...
	for i2 := v15.f18 to |(v29 + v29)| {
		v4 := v14.f24;
		if (true) {
			var v30: multiset<string> := multiset{v20[v15.f18 := v0], v16};
			v16 := (fm45(v11 >= v11, v30, v19, globalState))[v5 := v25.f15];
			...
			v10 := v10;
			globalState.f4 := v4;
			var v34 := new C2(v2[v32.f22], v15.f18);
		} else {
			...
			v26, v41, globalState.f4, v18, v18 := v26, v41, v2[v15.f18], v25.f15, fm38(if (v44.cf74) then false else !v14.f24, globalState);
			var v45: array<multiset<bool>> := new multiset<bool>[12];
			v45[525] := v11;
			v45[525] := multiset{v21, !v14.f24} - v11;
		...
		v51[147] := v47;
		v51[147] := v47;
		if (v2[if (v14.f24) then |"dv"| else v15.f18]) {
	...
	v18 := v25.f15;
	v5 := v25.f16;
	v0 := v20[fm10(v4, v5, 'w', globalState) / v5];
	var v66: map<bool, bool> := map[v21 := v14.f24];
	var v67: seq<int> := [|v66[v21 := v19]|, v25.f16];
	var v68: map<char, int> := map[v0 := v25.f16];
	for i4 := v25.f16 to -88 * v67[|v68|] {
		v26[42] := |v16|;
		v26[42] := v15.fm6(v17, if (v4) then seq(91, i5  => (|{v25.f16}|)) else v67, v19, globalState);
		v15.f18 := v5 % --v15.f18;
		var v69: multiset<int> := multiset{|(seq(0x39a, i6  => (v25.f15)))|, |v67|};
		var v70 := new C11(v25.f15, |(if (v21) then v69 else v69)|);
		globalState.f13 := 0xbd / (v25.f16 * |v20|);
	}
	for i7 := v15.f18 to |v17| - v5 {
		...
		var v88: set<C6> := {v87};
		globalState.f1, v10[381], globalState.f4, globalState.f13, v17 := -v15.f18, v4, (if (v4) then v88 else v88) < v88, |v67|, v17;
	}
