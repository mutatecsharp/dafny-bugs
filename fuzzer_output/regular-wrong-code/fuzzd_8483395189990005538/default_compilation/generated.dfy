...
function fm0(p0: map<int, int>, p1: int, globalState: GlobalState): bool {
	|(map v0 : int | (0x22b <= v0) && (v0 < 0x3e0) :: (v0 * -0x21e) := (DC6([0x7b, |(seq(0x26f, i0  => ('y')))|, |map[seq(0xa1, i1  => ('n')) := true]|, |[false]|])))| >= |(map[true := true] + map[false := false])|
}
function fm1(p0: bool, p1: D0, globalState: GlobalState): map<seq<int>, bool> {
	(map[[55] := true] + (map v0 : seq<int> | v0 in [DC6([523, |multiset{'p', 'l'}|]).cf11, [156, -0x208]] :: (v0) := (!true))) + (map v1 : seq<int> | v1 in map[seq(615, i0  => (742)) := 0xe1] :: (v1) := (true))
}
function fm2(p0: bool, p1: int, globalState: GlobalState): multiset<set<char>> {
	if (!!false || true) then multiset{{'t', 'c', 'h'}, set v0 : char | v0 in map['v' := true] :: (v0)} + multiset([{'e', 'n'}]) else multiset{set v1 : char | v1 in multiset(seq(0x3b9, i0  => ('t'))) :: (v1), {'y', 'o'}, {'q', 'n'}, set v2 : char | v2 in map['b' := "iasqoksj"] :: (v2)}
}
function fm3(p0: int, p1: int, p2: seq<multiset<int>>, p3: char, globalState: GlobalState): seq<set<char>> {
	(seq(0xb7, i0  => (set v0 : char | v0 in map['i' := 'q'] :: (v0)))) + (seq(872, i1  => ({'o'})))
}
...
function fm16(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<int> {
	(if (!false) then [|{false, false, true}|] else seq(0x94, i0  => (-|map[true := --0xa9]|))) + ([|[true, !!true]|, ---0x112, |map[0x20d := 0x1f8]|, -521] + [0xae, |map[-|{false, false}| := 'p']|])
}
...
function fm21(p0: bool, globalState: GlobalState): seq<set<int>> {
	seq(105, i0  => ((set v0 : int | v0 in [-371] :: (v0 + |map[-|multiset{0x318}| := |map[true := 0x1f8]|]|)) + {0x65, |[|(map v1 : int | v1 in multiset{|"bkuhorvqx"|} :: (v1 - -619) := (DC23(multiset{true})))|]|}))
}
function fm22(p0: bool, p1: bool, globalState: GlobalState): char {
	if ({seq(-0x1cb, i0  => (|[true]|)), [|(set v0 : int | (786 <= v0) && (v0 < 0x272) :: (v0 / |"olteeivdc"|))|, |(seq(-0x33e, i1  => (0x182)))|]} < {[|map[true := true]|], [885, |{"mxe"}|, -0xd], [|{12}|, 0xaa, |"tjay"|], [0x37a]}) then if (true) then 'd' else 'q' else if (true) then 'd' else 'o'
}
...
function fm26(p0: char, p1: int, p2: int, globalState: GlobalState): set<int> {
	((set v0 : int | (782 <= v0) && (v0 < -0x3be) :: (v0 - 0x56)) * {|multiset([0x19b, 918, 0x1f2, 0x174, |multiset(seq(656, i0  => (75)))|])|, 0x1de}) * {|[false]|, |"dslxbs"|}
}
...
function fm35(p0: int, globalState: GlobalState): seq<int> {
	((seq(0x238, i0  => (--181))) + (seq(-152, i1  => (-0xb6)))) + ([|["eolvsmea"]|] + [0x2a1, 562])
}
...
function fm37(p0: bool, globalState: GlobalState): map<int, map<bool, int>> {
	map v0 : int | (0x37a <= v0) && (v0 < 0x159) :: (v0 % 137) := (map[true := |"gmgrm"|])
}
function fm38(p0: bool, globalState: GlobalState): map<seq<bool>, map<bool, int>> {
	match DC15(DC12(map[true := |[-443]|])) {
		case DC13() => map[[false] := map[DC28(false).cf44 := |map[false := |[|[DC25(true, |{false}|, false).cf40]|, -0x318]|]|]] + (map v0 : seq<bool> | v0 in (map v1 : seq<bool> | v1 in multiset{[true, true]} :: (v1) := (-606)) :: (v0) := (map[false := |map[478 := |(seq(0x96, i0  => ('t')))|]|]))
...
function fm39(p0: int, globalState: GlobalState): map<int, int> {
	match DC28(true) {
		case DC28(cf44) => map[320 := -|multiset(seq(0xbd, i0  => (|(seq(775, i1  => ('u')))|)))|] + map[0x192 := |multiset{|"vavsi"|}|]
		...
		case DC31(cf50) => map v0 : int | v0 in multiset{0x2ba} :: (v0 / -0x176) := (531)
	}
}
function fm40(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): multiset<int> {
	multiset{-|"aynax"|} - multiset(seq(0x183, i0  => (--0x196)))
}
function fm41(p0: int, globalState: GlobalState): D4 {
	match DC29(-157, 677, |multiset{|[|{seq(0x30, i0  => (-0xbc)), seq(0x3b9, i1  => (-|[|multiset{true}|]|))}|, |"tsx"|]|}|, 681) {
...
function fm43(globalState: GlobalState): multiset<string> {
	multiset{"yaynwj", seq(188, i0  => ('i')), "yrbinxrmv"} - (multiset{"b", "fmj"} - DC32(multiset(["mtvdgkj", "xxyl"])).cf51)
}
function fm44(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): seq<D1> {
	seq(855, i0  => (DC2(DC2(map[|(seq(0x1b, i1  => (multiset{true})))| := 0x37e]).cf3)))
}
...
function fm46(p0: int, globalState: GlobalState): set<map<int, int>> {
	{map v0 : int | (821 <= v0) && (v0 < 144) :: (v0 + -|"dav"|) := (-163), map[-|(map v1 : int | (0x2ff <= v1) && (v1 < 440) :: (v1 / |map[|DC6([0xb9, |"kvwjkcv"|, 0x2ad]).cf11| := |{152, |{!true}|}|]|) := (|multiset{0x46, 0x320}|))| := 489] + map[0x3bb := 299], map[|[0x17f]| := |"yi"|] + map[-|(seq(203, i0  => ('t')))| := 0x78]}
}
...
method m0(p0: map<string, bool>, globalState: GlobalState) returns (r0: int) {
	...
	var v14 := "wm";
	var v15 := 'v';
	var v16: multiset<string> := multiset{"yyl", v14[v0 := v15]};
	var v17: multiset<seq<bool>> := multiset{v3};
	var v18: array<bool> := new bool[29] [v0 < |v1|, v3[|v5|], v7 > v7, v2, !v6.f16, v6.f16, v6.f16, v2, true, v2, v2, v2, v6.f16, (v10.(cf42 := map[v8 := v2])).cf42 == v9[v8 := v6.f16], if (v8 in v9) then v9[v8] else v2, v2 <==> v2, fm25(v1, v11, v0, v2, globalState) !! fm25(v1, fm20(v2, v0, v6.f16, globalState), v0, v6.f16, globalState), v2, v6.f16, v6.f16, false, -421 >= v0, if (v6.f16) then v2 else v6.f16, !v12.cf21, fm0(v13, v0, globalState), multiset{v14, seq(139, i0  => ('r')), v14} >= v16, !false || v2, !(if (v6.f16) then v2 else v6.f16), v0 <= (if (v3 in v17) then v17[v3] else v0)];
	v18 := v18;
	...
	match (DC22(v19[v0])) {
		case DC22(cf34) =>
			...
			v20[375] := v21 * v21;
			v20[375], v2 := v21 + multiset{v15, 's'}, !v2;
			v2 := -|"rokcgkova"| <= v0;
	}
		...
		decreases 100 - i1
	{
		...
		i1 := i1 + 1;
		v8[275] := |("nntti" + v14)[v0 := v15]|;
		v8[275] := v0 + v0;
		var v23 := new C4(v8[275] != -v8[275], v1 <= DC27(v1).cf43);
...
class C1 extends T1 {
	...
	method m5(p0: array<D0>, globalState: GlobalState) {
			...
			decreases 100 - i2
		{
			...
			match (v18) {
				case DC3(cf4) =>
					...
					v20[871], v7, v21, cf4, v21 := DC3(|"x"|).(cf4 := if (v21) then |v22| else cf4), v7 / cf4, !f17, v16.f15, f17;
					var v23 := DC7(f18, v16.f15, v16.f15, f17);
					var v24: seq<bool> := [v21, v21];
					var v25 := 'l';
					var v26: multiset<D1> := multiset{v18, v18.(cf3 := v17)};
					var v27: array<bool> := new bool[25] [v21, v23.cf15, v21, f17, v21, v7 < |v24|, f17, v21, v21, f17, f17, !!v21, v25 !in "eyusi", v21, v24[|v22|], !v21, false, f17, false, v21, v21 <==> f17, f17, v21, f17, fm17(v26, globalState) != f18];
					v27[336] := !(f17 <== f17);
					v27[336] := v16.f15 == (0xfa % 0x350);
					var v28: seq<seq<int>> := [[v16.f15]];
					var v29: multiset<seq<int>> := multiset{[v16.f15, v16.f15]};
					v22, v21, v7 := v28[v16.f15], multiset{v22[v7 := v16.f15], fm16(0x107, v16.f15, !!f17, v7, globalState), seq(0x20b, i4  => (|map[v27[336] := f17]|))} !! v29, 172;
					var v30, v31, v32 := m6(v27[336], globalState);
				case DC4(cf5, cf6, cf7) =>
					var v33: set<bool> := {f17, f17};
					var v34: map<string, int> := map[if (f17) then f18 else "mkrgtsv" := v7 / |v33|];
					v34 := v34[f18 := v16.f15];
					var v35: map<bool, bool> := map[f17 := f17];
					cf6 := -(v7 * |v35|);
					f18 := (f18 + (seq(-0x3b8, i5  => (cf7))))[v16.f15 := cf7];
					var v36 := true;
					v36 := (-718 + cf6) <= 0x1bf;
				...
				case DC2(cf3) =>
					...
					v43[993], v44 := !((|v45| + v16.f15) != v16.f15), v16.f15 < |f18|;
					v43[993] := !true;
					v44 := v43[993];
			}
			...
			v47 := v47[|map[{f17, f17} := v50[v7]]| := v46];
			var v51 := DC0(f17);
			match (v51) {
				case DC1(cf1, cf2) =>
					f14[810] := v16.f15 / cf2;
					...
					var v56: array<bool> := new bool[25] [cf1, f17, cf1, cf1, !cf1, f17, cf1, false, cf1, f17, f17, false, f17, false, cf1, true, f17, cf1, cf1, true, v46[|v54|], fm14(v16.f15, cf1, v16.f15, |v55|, globalState), f17, false, cf1];
					var v57: seq<map<bool, bool>> := [v53];
					var v58: map<array<bool>, map<bool, bool>> := map[v56 := v57[|(seq(-0x101, i8  => ('j')))|]];
					var v59 := DC9(v53);
					var v60: array<map<bool, bool>> := new map<bool, bool>[10] [v53, map[!cf1 := !f17], v53 + v53, if (v56 in v58) then v58[v56] else v53[cf1 := if (f17 in v53) then v53[f17] else cf1], v53, v59.cf19, v53, v53, v53, fm20(cf1, f14[810], cf1, globalState) + v53];
					v60[679] := v53;
					v60[679] := v53;
					v52 := v52;
				case DC0(cf0) =>
					var v61, v62, v63 := m6(v46[v16.f15], globalState);
					v50 := v50 + v50;
					var v64 := 'h';
		...
		var v70 := false;
		v70 := v70;
		var v71, v72, v73 := m6(v7 < |(seq(-78, i10  => ('t')))|, globalState);
	...
	method m6(p0: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		if (fm0(v4, |multiset{v5.cf1}|, globalState)) {
			...
			var v8 := m0(if (f18 in v7) then v7[f18] else map[seq(498, i0  => ('r')) := f17], globalState);
			r1, r2 := v8, p0;
			...
			v17[608] := "okriy";
			v12[254], v14, r1, v15[298], v17[608] := false, v14, v0 * v0, v16, (seq(0x12c, i1  => ('r'))) + f18;
			var v18 := DC3(v0);
			match (v18.(cf4 := v0)) {
				case DC3(cf4) =>
					var v19 := new C0(-v0 % cf4);
					var v20 := DC2(v4);
					v20 := v20;
					cf4 := v19.f15;
					v12 := v12;
				case DC4(cf5, cf6, cf7) =>
					var v21: set<int> := {-fm7(|("qqslcms")[cf6 := cf7]|, v0, v12[254], globalState), cf6, cf6};
					var v22: seq<set<int>> := [v21, v21, v21, v21, v21];
					var v23: map<bool, bool> := map[true := true];
					var v24: map<bool, seq<set<int>>> := map[fm14(cf6, v12[254], |v23|, cf6, globalState) := fm21(!p0, globalState)];
					v22 := if (v12[254] in v24) then v24[v12[254]] else v22;
					var v25: map<bool, int> := map[p0 := v0];
					var v26 := DC2((map[|multiset{cf7, cf7}| := |v25|])[|[v0, 0x71]| := |v17[608]|]);
					var v27: multiset<D1> := multiset{v26};
					v17[608] := fm17(v27 + multiset{v26, DC2(map[cf6 := v0]), v26, v26, v26}, globalState);
					v12[254] := p0;
					var v28: map<map<int, bool>, seq<map<int, bool>>> := map[v1 := seq(0x16d, i2  => (v1[|[f17, p0, f17]| := v12[254]]))];
					var v29: seq<map<int, bool>> := [v1, v1];
					var v30: map<bool, D0> := map[(if (v1 in v28) then v28[v1] else seq(0x265, i3  => (v1))) != v29 := v5];
					v30 := v30;
				case DC5(cf8, cf9, cf10) =>
				...
				case DC2(cf3) =>
					...
					var v39: multiset<seq<char>> := multiset{seq(0xdd, i4  => (v34))};
					var v40 := DC7(v17[608], v0, if (v17[608] in v39) then v39[v17[608]] else 0xcc, f17);
					...
					v37[898], r1, r1, v38, v0 := v17, v40.cf14, v44.cf10, v38[v0 < |v46[879]| := v0], v0;
			}
			
			v12 := v12;
			var v47: seq<array<bool>> := [v12, v12];
			var v48 := 'm';
			var v49: array<array<bool>> := new array<bool>[19] [v47[|[v48]|], v12, if (p0) then v12 else v12, v12, v12, v12, v12, v12, v12, v12, v47[v0], v12, v12, v12, v12, v12, v12, v12, v12];
			v49[900] := v12;
			var v50: map<bool, bool> := map[!(if (f17) then p0 else f17) := f17];
			v49[900], v12[254] := v47[v0], if ((p0 && f17) in v50) then v50[p0 && f17] else p0;
			v12[254] := v0 > v0;
		}
		...
		var v60: multiset<bool> := multiset{p0, v59 !! v59, true || fm0(v4, f14[292], globalState)};
...
class C2 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>) {
		...
		for i0 := |v0| + p0 to --p0 {
			if (true) {
				...
				var v4: seq<int> := [|v3|];
				v1 := -|v4| / DC7([v2, v2], p0, v1, false).cf14;
				var v5: map<int, int> := map[p0 := p0];
				var v6: seq<bool> := [f13];
				var v7: map<int, bool> := map[fm31(globalState) := v6[i0]];
				...
				var v23: array<D1> := new D1[23] [v20, v20, v20.(cf10 := i0, cf8 := v13), v20, DC5(v13, v14, i0), v20, DC5(seq(0x7b, i1  => (v15)), v14, i0), v20, DC5(v13, v14, i0), v20, v20, v20, v20, v20, v20, v20, DC5(fm32("xehdabxv", f13, if (f13 in v21) then v21[f13] else p0, i0, globalState), v14, i0), DC5(v13, v14, |v22|), v20, v20, v20, v20, v20];
				v23, f13 := if (f13) then v23 else v23, f13;
				var v24: array<int> := new int[27](i2 => i2 + -i0);
				v24[322] := fm31(globalState);
				v24[322] := |(((seq(593, i3  => (v15))) + v13) + (v13 + v13))|;
				v24[322] := v24[322];
				f13 := f13;
			}
		...
		v28[501] := |v36|;
		v28[501] := v30.f15;
		var v37: multiset<int> := multiset{v28[501]};
	...
	method m2(p0: int, p1: string, p2: int, globalState: GlobalState) returns (r0: map<int, array<bool>>, r1: bool, r2: bool, r3: seq<bool>) {
		...
		for i0 := |fm33(f13, false, v0, f13, globalState)| to p2 {
			...
			v2[110] := |"wawnlrb"| / (if (v3 in v4) then v4[v3] else i0);
			...
			r2, v1, v2[110] := f13, v1, |"tasrqgp"| - |(v11 + v11)|;
			r1 := (v2[110] <= i0) || f13;
			v2[110] := 62;
		...
		var v17 := 'w';
		var v18: map<string, int> := map[p1[|v16| := v17] := p2];
			...
			decreases 100 - i1
		{
			...
			var v25 := DC1(f13, p2);
			var v26: array<bool> := new bool[5] [f13, fm34(globalState) !in p1, v20[|v21.cf12| := -|v23|] !in v24, fm4(f13, v25, v19, v23, globalState), f13];
			v26[493] := true;
			v26[493] := (seq(0x6a, i2  => (v17))) == "k";
			var v27 := "y";
			v27 := v27;
			if (v26[493]) {
				...
				var v29: seq<bool> := [!v26[493], v26[493]];
				var v30: set<bool> := {v26[493]};
				var v31: seq<int> := [|v30|, v19];
				var v32 := DC4(v26, p2, 'y');
				var v33: multiset<char> := multiset{v32.cf7};
				var v34: array<int> := new int[15] [|multiset(v29)|, v19, 0x12c, p0, p0, |v29|, |v16|, p2, p2, v31[if (v17 in v33) then v33[v17] else v19], v19, p0, if (v19 in v20) then v20[v19] else p0, 0x130, p2];
				var v35 := new C1(f13, v27, v34);
				v19 := p0;
				var v36: map<bool, char> := map[f13 := v17];
				var v37: array<seq<bool>> := new seq<bool>[13];
				v37[845] := v29;
				v19, v36, v31, v37[845], v27 := -0x19, map[p1 == ("krd")[p0 := 'o'] := v17], v31, [f13 <==> f13, v35.f17], v27;
			} else {
				var v38: array<int> := new int[3] [p2, v19, 0x95];
				v38[825] := v19;
				var v39: seq<int> := [v19, p0, p0];
				v38[825] := if (v26[493]) then p2 * p2 else |(v39 + v39)|;
				var v40 := new C0(v19);
				var v41: array<set<bool>> := new set<bool>[2];
				v41 := v41;
				v17, f13 := v17, f13;
				v27 := if (if (v26[493]) then v26[493] else v26[493]) then p1 else p1;
			}
		...
		for i3 := -|(v0 - v0)| to 0x97 {
			...
			v53[413] := v47.fm6(globalState);
			v53[910] := f13;
			var v54: seq<int> := [i3, p2];
			var v55: map<int, int> := map[v47.fm7(i3, -v54[|v47.f18|], f13, globalState) := |p1|];
			var v56: set<bool> := {v47.fm14(i3, v47.f17, |v55|, p2, globalState)};
			v51, r1, v53[413], v53[910], r1 := map[multiset{f13, v48.cf0, v47.f17} := v47.f17] + map[multiset(v44) := v47.f17], true, v56 >= v56, !v47.f17, p1 != v47.f18;
		}
		...
		match (v60) {
			case DC11(cf21) =>
				var v61 := new C0(0x336 / fm31(globalState));
				...
				v68[657] := if (f13) then false else cf21;
				var v69: multiset<array<bool>> := multiset{v68, v68, v68};
				v68[657] := !((v69 !! v69) || cf21);
				v68[657] := v64.f17;
			case DC10(cf20) =>
				var v70: seq<bool> := [f13];
				var v71 := new C1(!v70[v19] <==> f13, p1, cf20);
				if (f13) {
					var v72: seq<string> := [("cqgr")[v19 := v17], seq(-0x2f2, i4  => (v17)), "uthxbo"];
					var v73: map<bool, seq<string>> := map[v71.f17 := v72];
					var v74: seq<int> := [|v57|];
					r1 := (if (f13) then if (v71.f17 in v73) then v73[v71.f17] else v72 else v72) <= [fm32(v71.f18, v71.f17, p2, v74[|v16|], globalState)];
					v19 := -(v19 * v19);
					v0 := if (v71.f17) then v0 else v0;
					v19 := |[p2]| * -(|v18| % 0x1a0);
					var v75 := new C1(v71.f17, p1, cf20);
				} else {
					var v76: array<string> := new seq<char>[13](i5 => seq(4, i6  => (v17)));
					var v77: seq<array<string>> := [v76, v76, v76, v76, v76];
					v76 := v77[|map[v19 := true]|];
					cf20[114] := p0;
					cf20[114] := p2 % p0;
					r2 := f13;
					v19 := --(-0x150 - cf20[114]);
				...
				match (if (p2 > v19) then v60 else DC10(cf20)) {
					case DC11(cf21) =>
						...
						var v80: seq<int> := [p0];
						var v81: seq<int> := [v80[v19]];
						v79[621] := v81 + v80;
						var v82: array<map<int, array<bool>>> := new map<int, array<bool>>[10];
						var v83 := DC1(v71.f17, p0);
						var v84 := DC14(cf21);
						var v85 := DC11(f13);
						var v86: array<bool> := new bool[26] [v71.f17, f13, cf21, v71.f17, false, cf21, false, !!v71.f17, cf21, false, v71.f17, fm4(v71.f17, v83, |fm36(globalState)|, map[0x6a := v19], globalState), cf21, !v71.fm14(p0, v71.f17, v19, v71.fm7(p2, |v71.f18|, f13, globalState), globalState), v84.cf23, f13, f13, v70[v19], v71.f17, v71.f17, v71.f17, !v71.f17, v71.fm6(globalState), v71.f17, true, v85.cf21];
						v82[282] := map[p0 := v86];
						v86[563] := v71.f17;
						var v87: multiset<int> := multiset{-p2};
						var v88: map<int, array<bool>> := map[|v87| * p2 := v86];
						v79[621], v59, v82[282], v86[563], cf20 := fm35(v71.fm15(globalState), globalState), v59, v88, f13 <==> f13, cf20;
						v19 := if (f13 in v16) then v16[f13] else p0;
						var v89: map<int, array<int>> := map[-p2 := cf20];
						var v90: map<int, bool> := map[p2 := p0 < |v89|];
						r2, v57, v19, cf21, r1 := v71.fm6(globalState), v57, p2 + (if (false) then p0 else v71.fm7(v19, p2, v71.f17, globalState)), if ((p0 / v19) in v90) then v90[p0 / v19] else v87 >= v87, f13;
						v19 := 976;
					case DC10(cf20) =>
						v19 := |((v58 + map[v71.f17 := v71.f17]) + (v58 + map[v71.f17 := v71.f17]))|;
						v19 := v19;
						var v91: multiset<bool> := multiset{f13};
						v19 := (p2 * |v91[v71.f17 := p0]|) / v19;
						var v92: seq<C1> := [v71];
						...
						v95.f14[576] := |(([v71.f18, v71.f18, "sp", v71.f18, v71.f18])[p2 := p1])[p2 := v71.f18]|;
						var v97 := DC19(v95);
						v95, v96, v95.f14[576] := v97.cf30, fm37(v71.f17, globalState), p2 / (|p1| + |(seq(-849, i7  => (v17)))|);
				}
...
class C3 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>) {
		for i0 := p0 to p0 {
			...
			f13 := v0[|(seq(0x271, i1  => ('v')))|];
			var v1: array<array<bool>> := new array<bool>[28];
			var v2: array<bool> := new bool[24];
			v1[376] := v2;
			v1[376] := new bool[4](i2 => false);
			var v3 := "rn";
			v3 := v3;
			if (!f19) {
				var v4 := 0x2af;
				var v5: set<array<bool>> := {v1[376], v2, v1[376], v1[376]};
				v4 := |(v5 - v5)|;
				var v6: array<string> := new string[21](i3 => v3);
				var v7 := 'n';
				v6[759] := (seq(0x8a, i4  => (v3[p0])))[v4 := v7];
				...
				v16[678] := |v23|;
				var v24 := DC14(!false);
				v24, v16[678], f13 := v24, -i0, f13;
				var v25: map<bool, int> := map[v24.cf23 := v16[678]];
		...
		for i6 := p0 to p0 {
			...
			v36 := v36.(cf10 := v30, cf8 := ("f")[0x2b6 := 's']);
		}
		...
		var v50: array<bool> := new bool[6] [fm0(v47, p0, globalState), v48[fm31(globalState)], v48[|v49|], f13, f19, f13];
		var v51 := DC5(v46 + v46, v50, p0);
		match (v51) {
			case DC3(cf4) =>
				var v52 := DC4(v50, -|(seq(955, i7  => (cf4)))|, v40);
				...
				if (v54[cf4] < (v53 - v53)) {
					...
					var v59: array<string> := new seq<char>[3] [seq(0xef, i9  => (v40)), v46, "f"];
					v59[280] := v46;
					v59[280] := v57.f18[p0 := v40];
					v57.f18, v57, v43 := "bplas", v57, v43;
				} else {
					var v60: array<int> := new int[2](i10 => i10 * cf4);
					v60[188] := fm31(globalState);
					v60[188] := p0;
					var v61: map<array<int>, array<int>> := map[v60 := v60];
					v61 := v61[v60 := if (f13) then v60 else v60];
					var v62: set<int> := {v60[188]};
					var v63 := DC7(v46, cf4, -0x3dd, f13);
					var v64: multiset<set<int>> := multiset{v62 - {v63.cf13, v60[188], v60[188], |(seq(367, i11  => (v40)))|}, v62};
					v64 := v64;
					v60[188] := cf4;
					v40 := 'v';
				}
				...
				v65[721] := if (f13) then v46 else v46;
				v65[721] := DC7(v46, -0x290, |v43|, f13).cf12;
				var v66: array<map<int, int>> := new map<int, int>[24](i12 => map[p0 := cf4]);
				v66 := v66;
			case DC4(cf5, cf6, cf7) =>
				cf6 := p0 % (if (f19) then fm31(globalState) else cf6);
				...
				v67[909] := --(if (p0 in v47) then v47[p0] else |v68|) / |v69[|v70| := f19]|;
				v67[909] := cf6;
				var v71: map<char, array<bool>> := map[cf7 := v50];
				v71 := v71[cf7 := v50];
				var v72: multiset<int> := multiset{cf6};
				var v73: map<bool, bool> := map[f19 := f19];
				if (v72 >= multiset{-|v73[f13 := f13]|, v67[909], cf6}) {
					var v74 := DC4(v50, cf6, v40);
					var v75: C2 := new C2(f13);
					var v76: seq<C2> := [v75];
					cf7, cf6, f13, v72, v67[909] := cf7, v74.cf6, (0x37a * v67[909]) < 0x3b4, (v72 - fm40(|v76|, f13, f13, f19, globalState)) - v72, v67[909];
					...
					var v80: set<int> := {v67[909]};
					v67[909] := if (fm40(-v67[909], false, f13, f13, globalState) in v79) then v79[fm40(-v67[909], false, f13, f13, globalState)] else |v80|;
					var v81 := new C2(f13);
				} else {
					v67[909] := v67[909];
					f13 := v48[cf6 + |v46|];
					...
					var v84: map<string, bool> := map[seq(0x96, i14  => (v40)) := v48[0x290]];
			...
			case DC5(cf8, cf9, cf10) =>
				...
				cf10 := cf10;
				v50[658] := f19 || f13;
				cf9, cf10, v50[658] := if (f13 ==> false) then cf9 else v50, cf10 % cf10, f13;
			case DC2(cf3) =>
				var v88 := 0x78;
	...
	method m2(p0: int, p1: string, p2: int, globalState: GlobalState) returns (r0: map<int, array<bool>>, r1: bool, r2: bool, r3: seq<bool>) {
		...
		r2 := fm0(map v5 : int | v5 in v8 :: (v5 / p2) := (p0), |v9|, globalState) && f19;
		var i2 := 0;
		while (p0 < p0)
			decreases 100 - i2
		{
			...
			var v13: seq<string> := [p1, seq(-0x19, i3  => ('c')), p1];
		...
		if (match v21 {
			case DC7(cf12, cf13, cf14, cf15) => f13
			case DC8(cf16, cf17, cf18) => |['g']| < v6[p2]
			...
			v25 := v25[{p0} - v22 := v24];
			var v27: C1 := new C1(fm0(map v26 : int | (-0x2fd <= v26) && (v26 < 322) :: (v26 + |v8|) := (p0), v6[p2], globalState), p1, v23);
			v27 := v27;
			var v28 := DC11(v27.f17);
			var v29: multiset<D4> := multiset{v28};
			var v30: seq<multiset<D4>> := [v29, v29, multiset{v28}, v29, v29];
			var v31: array<bool> := new bool[12] [f13, false, v27.f17, v27.f17 || f19, f19, f13, f13, f13, v27.f17, f13, v29 !! v30[p2], v27.f17];
			var v32 := DC14(!f19);
			v31[289] := (v32.(cf23 := f13)).cf23;
			v31[289] := f13;
			var v33 := 470;
			v33 := 0xcb;
		} else {
			...
			var v35: map<string, int> := map[p1 := p0 % p0];
			var v36 := 'd';
			v35 := v35[p1[p0 := v36] + p1 := -p0];
			v36 := fm34(globalState);
			var v38: array<int> := new int[3](i5 => i5 + DC20(|(map v37 : int | (-0x26e <= v37) && (v37 < 0x12c) :: (v37 / |[true]|) := (969))|, DC20(|[true]|, v36).cf32).cf31);
		...
		var v45: seq<bool> := [v44[p0]];
		var v46: array<bool> := new bool[26] [f19, f13, !f19, v45[p0], f13, fm4(f19, fm42(globalState), p0, map[p0 := fm31(globalState)], globalState), !f19, p1 <= (seq(0x17b, i6  => ('s'))), f19, f19, !f13, f13, f13, f13, f13, f19, f13, v6 == v6, f13, f19, f19, f13, false, f13, !f19, !f13];
		v46 := v46;
		var v47: array<int> := new int[9];
		v47[662] := p0;
		v47[662] := fm31(globalState);
		var v48: map<int, array<bool>> := map[v47[662] := v46];
		r0 := v48 + v48;
		r1 := (true || f19) in multiset{f13, f19};
		r2 := f19;
		r3 := [true, v47[662] != p2, f19, if (f19) then f13 else true];
	}
}
...
class C4 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>) {
		for i0 := p0 to p0 {
			...
			var v10: array<int> := new int[9] [-p0, |(if (f16) then v4 else v4)|, v0.f15, p0 / fm13(v5.cf1, f16, v6, globalState), if (v8 in v9) then v9[v8] else p0, 0x163, p0 + v0.f15, p0, p0];
			v10[219] := i0 - p0;
			var v11 := 0x97;
			...
			v3, f13, v10[219], v11, v12 := v3, 0x230 > 0x3b3, (-v11 / v11) - v0.f15, p0 / (i0 + v12.fm7(v0.f15, |v13|, true, globalState)), v14[v0.f15 - v15.cf13];
		}
		var v16 := 'n';
	...
	method m2(p0: int, p1: string, p2: int, globalState: GlobalState) returns (r0: map<int, array<bool>>, r1: bool, r2: bool, r3: seq<bool>) {
		...
		for i0 := p2 to |(if (p2 in v0) then v0[p2] else p1)| {
			...
			v5[164] := v6[p0 := p2];
			var v7 := 's';
			v4, v5[164], f13, v1, v1 := v4, v6[fm13(f16, true, v7, globalState) := p2], !f13, |(p1 + (p1 + p1))|, v1;
			var v8: map<bool, string> := map[f16 <==> !f16 := p1[p2 := v7]];
		...
		v12[780], v13, v12[583], f13 := f13, v13 / -0x297, (v14 + fm25(v15, v16, p0, f13, globalState)) != (v14 - v14), f13;
		v13 := 0x146;
		...
		var v22: array<int> := new int[25](i2 => i2 / 0x344);
		var v23: map<bool, int> := map[f16 := v13];
		var v24 := DC12(v23);
		var v25: map<array<int>, int> := map[v22 := |v24.cf22|];
		var v26: seq<bool> := [f16];
		var v27: seq<int> := [v13, p0];
		var v28: array<int> := new int[26] [v17.cf10, 0xa8, p0, |p1| + 0x24e, p0, fm13(!v18.cf21, f13, v19, globalState), p0, -(-|v20| / |v21|), fm13(f16, f13, 'd', globalState) % -p0, p0, -(p2 % |fm26(v19, p0, v13, globalState)|), p0, if (v22 in v25) then v25[v22] else |p1|, p2 / |v26|, p2, p0, 0x214, p2, p0, v13 + v13, 0x2c3 * p2, v13 + v13, p2, -(v27[p2] + p2), 0x14d, |(multiset{v19, v19})[v19 := v13]|];
		v22[659] := p2 * |v27|;
		var v29 := DC9(v16);
		v22[659], v29 := p0, v29;
		var v30: array<map<seq<bool>, map<bool, int>>> := new map<seq<bool>, map<bool, int>>[17];
		var v31: map<seq<bool>, map<bool, int>> := map[v26 := v23[v12[780] := v13]];
		v30[63] := v31;
		var v32 := DC16(v31);
		var v33: map<bool, string> := map[v12[780] := p1];
		v12[780], v30[63], v22[659], v13, v22 := v26[p2] <== f13, v32.cf25, -(p0 - (v22[659] + |v33|)), p2 + 534, v28;
		v14 := v14;
		var v34: seq<array<bool>> := [v12];
		var v35: map<int, array<bool>> := map[|v16| := v34[v13]];
		r0 := if (v12[780]) then v35 else v35;
		r1 := if (f13) then v26[|multiset(v26)|] else v12[780];
	...
	method m4(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		match (v0.(cf21 := v4.cf15)) {
			case DC11(cf21) =>
				...
				v5[739] := v3;
				v5[739] := fm13(cf21, cf21, v1, globalState) % --(v3 * v3);
				var v6: set<bool> := {p1, f13, cf21};
				v6 := v6;
				var v7: map<bool, bool> := map[f13 := !p1];
				v7 := v7[p1 := cf21];
				var v8 := new C1(cf21, v2[|v7| := 'c'], v5);
			case DC10(cf20) =>
				var v9: array<bool> := new bool[10](i0 => p1);
				var v10 := DC4(v9, v3, fm22(f16, p0, globalState));
				var v11: array<char> := new char[28] [v1, v1, v1, v10.cf7, v1, v1, v1, 'u', 'k', v1, v1, 'o', 'p', v1, v1, 's', v1, v1, v2[v3], v1, v2[v3], v1, v1, v1, v1, v1, v10.cf7, v1];
				v11[262] := fm22(f13, p0, globalState);
				f13, v11[262] := !(if (f13) then f16 else p1) || (p1 && f16), v1;
				var v12: map<int, int> := map[v3 := v3];
				var v13: T0 := new C2(true);
				r1 := (|map[v12 := v13]| + |v2|) > 0x1cb;
				var v14: map<int, bool> := map[v3 := f16];
				var v15: map<bool, int> := map[if (-v3 in v14) then v14[-v3] else p0 := v3 / v3];
				v15 := v15[v13.f13 := v3 / v3];
				v14 := v14;
		}
			...
			decreases 100 - i2
		{
			...
			if (f16) {
				...
				r0, v3, r2 := v16[v3 % v3], (if (p0) then |v19| else v3) * (v3 / v3), |map[multiset{v3, -0x281, |v2|, v3} := fm25(v22, v23, |[f13, false, f16]|, p0, globalState)]|;
				var v24 := DC1(f16, -0x27a);
				var v25: map<int, int> := map[-v3 := v3];
				var v26: map<int, int> := map[|v2| := |v25|];
				var v27: seq<int> := [v3];
				v1 := fm22(fm4(v16[v3], v24, v3, v25[v3 := v3], globalState), v3 >= v27[v3], globalState);
				var v28: array<int> := new int[8];
				v28[711] := v3;
				f13, r0, v28[711] := (|v2| - v3) < |v20|, f13, v3;
				v27 := seq(0x12f, i3  => (v28[711]));
				var v29: multiset<int> := multiset{v28[711] - v3, 0x2e5, v28[711], v3};
				var v30: T1 := new C1(p0, "nldyh", v28);
				var v31: seq<T1> := [v30, v30];
				var v32 := DC19(v30);
				var v33: array<T1> := new T1[14] [v30, v31[v3], v30, v32.cf30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30];
				var v34: seq<array<T1>> := [v33];
				v1, v16, r1, v29, v34 := v1, if (p1) then v16 else v16, v2 <= v2, v29[v3 := |v21|], v34;
			} else {
				var v35: array<int> := new int[4] [v3, 330, v3, v3 / v3];
				var v36: map<array<int>, bool> := map[v35 := p0];
				v35[831] := |v36|;
				var v37: map<bool, bool> := map[f13 := v16[v3]];
				...
				var v43: seq<int> := [v41[53], if (|v2| in v42) then v42[|v2|] else v35[831], v35[831], v3];
				v2, r0, v3 := (if (!f16) then v2 else ("aiwrcowth")[|v40| := v1]) + v39.f18, !!p1, v43[v3];
				r2 := v35[831];
				v42 := (multiset(v41))[v3 := v35[831] - 0x1f];
			}
			
			var v44 := DC4(v17, v3, v1);
			var v45: seq<string> := [v2, v2[v3 := 'l'], v2];
			var v46: array<int> := new int[11] [v3 - v44.cf6, 0x261, v3 % |[v4.cf13]|, v3, v3, -v3, v3 / |v16|, v3 * v3, v3 * v3, -(v3 * |v45|), v3];
			v46[646] := |v2|;
			...
			v3, v3, v49, v46 := 120, |"dcdkyipa"|, multiset(fm28(if (f13) then |v2| else v46[646], fm31(globalState), v50 != v50, globalState)), v46;
			var v51: seq<seq<int>> := [v50];
			var v52 := DC6(v51[fm31(globalState)]);
			match (v52) {
				case DC7(cf12, cf13, cf14, cf15) =>
					var v53: map<string, int> := map["ajufne" + v2 := v46[646]];
					v53 := v53;
					v17[268] := fm0(map[v46[646] := -v3], v46[646], globalState);
					var v54: map<int, bool> := map[-|v49| := f13];
					var v55: set<seq<bool>> := {v16};
					var v56: C2 := new C2(true);
					var v57: map<C2, int> := map[v56 := v46[646]];
					r1, v46[646], v17[268], r0, v54 := cf15 && p1, cf13 % (cf13 - v46[646]), (v3 - 635) !in v50, (v55 * v55) < {v16, v16}, v54 + (map[|v51[if (v56 in v57) then v57[v56] else v46[646]]| := p0] + v54);
					v46[646] := fm13(p1, f16, v1, globalState) - -0x160;
					var v58: array<seq<D8>> := new seq<D8>[15](i4 => [DC22(v16), DC22([v17[268]])]);
					v58 := v58;
				case DC8(cf16, cf17, cf18) =>
					var v59: map<bool, int> := map[cf18 := |v49|];
					var v60: multiset<int> := multiset{v3, if (cf18 in v59) then v59[cf18] else v46[646], v46[646]};
					v46[646] := |v60|;
					var v61: multiset<string> := multiset{v2, v2 + "hpqdcyt", v45[--0x2a1]};
					v61 := (multiset(v45) * fm43(globalState)) * v61;
					var v62: map<int, int> := map[v3 := 0x2ff];
					var v63 := DC2(v62);
					var v64: seq<D1> := [v63, v63];
					v64 := fm44(v3, false, 0x2c0, v2 != (seq(0x14a, i5  => (v1))), globalState);
					v46[646] := v46[646];
				case DC6(cf11) =>
					v46[646] := v46[646];
					var v65: seq<seq<bool>> := [v16, v16];
					var v66 := DC23(multiset(v65[-0x157]));
					var v67: multiset<bool> := multiset{f16};
					var v68 := new C3(!(v66.cf35 > v67), f13);
					var v69 := DC5(("caoyl")[0x1b3 := v1], v17, v3);
					v46[646] := v69.cf10 - --cf11[|v2|];
					var v70 := DC14(p0);
					var v71 := DC15(v70);
					var v72: multiset<int> := multiset{v3, v46[646]};
					var v73: multiset<multiset<int>> := multiset{v72, v72};
					v17[770] := v73 > v73;
					var v74 := DC12(map[f16 := v3]);
					var v75: map<int, array<bool>> := map[|v2| := v17];
					var v76: map<int, array<bool>> := map[0x1dc := if (v46[646] in v75) then v75[v46[646]] else v17];
					var v77: map<array<bool>, array<bool>> := map[v17 := v17];
					var v78: array<array<bool>> := new array<bool>[21] [v17, v17, v17, v17, v17, v17, v69.cf9, if (f13) then v17 else v17, if (v46[646] in v76) then v76[v46[646]] else v17, v17, v17, v17, v17, v17, v17, v17, if (v17 in v77) then v77[v17] else v17, v17, v17, v17, v17];
					v78[119] := v17;
					var v79: array<seq<char>> := new string[2] [fm32(v2, f16, v3, v46[646], globalState), v2];
					v79[375] := v2;
					var v80: map<string, bool> := map[(v2 + v2)[0xfb := v1] := !(v2 < v2)];
					v71, v17[770], v74, v78[119], v79[375] := v71, if ((seq(0x46, i6  => (v1))) in v80) then v80[seq(0x46, i6  => (v1))] else f16, v74, v17, v2;
			}
			
		}
		var v81: map<bool, bool> := map[p1 := true];
		var v82 := DC22(v16[|v81| := f13]);
		...
		var v90: array<set<bool>> := new set<bool>[23] [{p1, v16[v3]}, if (if (p0 in v81) then v81[p0] else f13) then fm25(v84, v81, v3, f13, globalState) else {p1}, if (!f13 in v86) then v86[!f13] else {p0}, v85, if (true) then {f16, p0} else v85, v85, v85, v85, v87[v3], v85, v85, if (if (multiset(seq(0x2c3, i7  => (0x393))) in v89) then v89[multiset(seq(0x2c3, i7  => (0x393)))] else p0) then v85 else v85, v85 * v85, v85, if (p1) then {p1, f16} else v85, v85, v85, v85, v85 - v85, if (f13) then v85 else {f16}, v85, {true}, v85];
		v90[465] := v85 * v85;
		v17, v90[465] := v17, (v85 + {v16[v3], f13, p0, f16}) + v85;
		r0 := v2 <= v2;
		r1 := (v90[465] * v85) > v85;
		r2 := |v81| + v3;
	}
...
class C5 extends T0, T1 {
	...
	function fm5(globalState: GlobalState): D1 {
		DC3(|{f13}| % |(seq(0x15a, i0  => ('v')))|)
	}
	function fm6(globalState: GlobalState): bool {
		!DC1(f13, |"box"|).cf1
	}
	function fm7(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
		(0x1c9 / -669) - (|"nuqc"| % |map['o' := DC1(false, 0x72)]|)
	}
	function fm8(p0: D1, p1: int, globalState: GlobalState): bool {
		'a' !in "rq"
	}
	function fm9(p0: int, globalState: GlobalState): int {
		-(if (f13) then -0x2b6 else |multiset([f13, !f13, f13])|) % (-159 * |multiset{!f13, f13}|)
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>) {
		...
		match (v1) {
			case DC3(cf4) =>
				...
				cf4 := fm7(fm9(p0, globalState), p0 / |v2[p0 := p0]|, f13, globalState);
				if (!true) {
					var v3 := "gljnndblh";
					...
					f13, cf4 := f13, cf4;
					var v9: map<bool, multiset<int>> := map[f13 := v2[p0 := p0]];
					v9 := v9[f13 := v2 - v2];
					cf4 := p0;
					f14[371] := p0;
					f14[371] := cf4;
					var v10: map<int, bool> := map[f14[371] := f13];
					cf4 := |v10|;
				}
		...
		var v38: seq<int> := [p0];
		var v39: map<int, array<int>> := map[v38[fm9(v27, globalState)] := f14];
	...
	method m2(p0: int, p1: string, p2: int, globalState: GlobalState) returns (r0: map<int, array<bool>>, r1: bool, r2: bool, r3: seq<bool>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v0 := 0x15;
			v0 := (p2 / p2) / (if (f13) then p0 else |(seq(545, i1  => ('v')))|);
			...
			var v4 := 't';
			var v5: map<set<multiset<int>>, string> := map[v3 := p1 + p1[v0 := v4]];
			v5 := v5[v3 := v1[152][p2 := v4]];
			var v6: array<T0> := new T0[12];
			var v7: T0 := new C3(f13, f13);
			v6[838] := v7;
			v6[838] := new C3(f13, !f13);
		}
		...
		if (f13) {
			...
			match (v11) {
				case DC1(cf1, cf2) =>
					...
					var v15: array<set<int>> := new set<int>[5] [v12, v12, v12 * v12, v12, set v14 : int | v14 in v13 :: (v14 * |[|map[false := [false, false]]|, |map[true := |map[false := false]|]|, |(seq(0x1ba, i3  => ('o')))|]|)];
					var v16: map<int, C3> := map[p2 := v8];
					v15[473] := {|v16|};
					var v17 := "ucptmuvvm";
					var v18: seq<int> := [p2];
					v15[473], cf1, cf1, cf2, v17 := (v12 + v12) - ({cf2, cf2, |v18|} * v12), f13, v8.f19, |{p0 + cf2, --p2, p0}|, p1;
				case DC0(cf0) =>
					var v19 := 'm';
					var v20: map<bool, bool> := map[v8.f19 := v8.f19];
					var v21: multiset<bool> := multiset{if (cf0 in v20) then v20[cf0] else v8.f19, f13};
					var v22 := DC7((['b', v19, v19])[|p1| := v19], |v21|, p2, cf0);
			...
			f13, v33[852] := v8.f19, fm9(|(if (v34 in v36) then v36[v34] else {f13})|, globalState) >= p0;
			var v37 := DC22(v9);
			match (v37) {
				case DC22(cf34) =>
					v33[852] := v8.f19;
					...
					var v43 := DC2(map[p0 := fm7(f14[980], |multiset{-p0}|, v34.f16, globalState)]);
					var v44: multiset<bool> := multiset{fm8(v43, p0, globalState), v34.f16};
					var v45 := DC23(v44);
					v42[387] := v45;
					v33[852], f14[980], v42[387], v30 := !false, if (!true in v44) then v44[!true] else p2, v45, v30;
			}
		...
		var v58: map<int, bool> := map[f14[400] := fm0(v57, |multiset{f13}|, globalState)];
		...
		var v62: map<int, array<bool>> := map[0x49 := v61[p2]];
		var v63: seq<int> := [p2];
		var v64 := DC5("yvhsai", v60, p2);
		var v65: seq<map<int, array<bool>>> := [v62 + map[|v63| := DC5(v64.cf8, v60, f14[400]).cf9]];
		r0 := v65[f14[400]];
	...
	method m3(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if (!true) {
			...
			v3[42] := v5 !! {fm9(165, globalState), p1};
			var v6: array<string> := new string[18];
			var v7 := "n";
			v6[94] := v7 + v7;
			var v8 := DC5(v7, v3, p0);
			v3[42], v6[94] := v0 in "ywfkh", v8.cf8;
			v7 := v7;
		...
		for i1 := p0 to |v17| {
			...
			var v27: set<map<int, int>> := {if (v18[600]) then map v22 : int | (0x3d7 <= v22) && (v22 < 0x192) :: (v22 - p0) := (p0) else v26[p0 := 0x169], map[|v17| := 726], v26[p0 := -|{fm13(v18[600], v18[600], v0, globalState), p0, p2, |fm24(|v17|, v18[600], globalState)|}|], map[p2 := p2]};
			var v28 := DC1(v23.f16, 0x164);
			r1, r1, v18[600], v27 := f14[560], p0, v23.fm4(-p1 < 306, v28, i1, v26, globalState), fm46(p0, globalState);
		}
		var i3 := 0;
		while (f13)
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			r1 := -(p2 / (if (true) then -0x9e else p0));
			...
			var v35: array<D2> := new D2[19] [v32, v32, v32, v32, v32, v32.(cf13 := p1), DC7(v17[p2 := v0], p1, -p0, f13), v32, v32, v32, DC7([v0], |v33|, p0, f13), v32, fm23(p1, f13, globalState), v32, v32, fm23(p1, f13, globalState), DC7(v34[p2], p0, p0, f13), DC7([v0, v0], p2, p1, f13), v32];
			v35[923] := v32;
			v35[923] := v32;
			f13 := f13;
		}
		if (f13) {
			...
			match (v36) {
				...
				case DC25(cf39, cf40, cf41) =>
					...
					var v53: map<int, map<bool, bool>> := map[v51[0x1db] := v52];
					var v54: map<char, int> := map[v0 := cf40];
					r1 := |v53[|v54| := v52]| + p2;
					r1 := cf40 / cf40;
					v16[301] := if (cf39) then p0 else 0x298;
					var v55 := DC1(cf39, 0xd1);
					var v56: set<char> := {v0, v0};
					r1, v16[301], v50 := |(fm47(v55, p0, globalState) + (set v57 : char | v57 in v56 :: (v57)))| / p2, |v17|, v50;
				case DC23(cf35) =>
					var v58: array<bool> := new bool[12];
					v58[937] := if (f13) then f13 else f13;
					...
					f13, f13, v58[937], v61 := (v62[seq(-486, i4  => (v0)) := |v63|])[v64[p1] := if (f13 in cf35) then cf35[f13] else p0] !! v62, f13, if (v59.f17) then if (f13) then f13 else false else !f13, if (v59.f17 <== v59.f17) then v61 else v61 + v61;
					v16[624] := p2;
					v58[937], v16[624], r1, v58[937], cf35 := v58[937], p0, -p2 - p0, v59.f17, cf35 - cf35;
					var v65: set<string> := {v17};
					var v66: array<int> := new int[23];
					var v67: map<string, bool> := map[v59.f18 := v59.f17];
					r0, v65, v0, v66, v16[624] := (p1 / |v60|) >= p0, set v68 : string | v68 in v67 :: (v68), v0, f14, v59.fm7(0x205, v16[624] * p2, v59.f17, globalState);
					r0 := !true;
			}
...
method Main() {
	...
	var v2 := -0xc7;
	var v3: array<bool> := new bool[27] [v0, v0, v0, v0, v0, v0, v0, v0, true, v0, v0, v0, !v0, true, v0, v0, v0, v0, v0, v0, v0, v0, v0, v1[v2], v0, v0, v0];
	var v4 := DC0(false);
	var v5: set<seq<bool>> := {v1, ([v0, v4.cf0, !false, v0, v0])[v2 := false], v1};
	var v6 := "nftgk";
	var globalState := new GlobalState(-0x24a, v3, true, false, v1, v5 + v5, false, multiset{v2}, true, 0x2d1, v3, (seq(0x309, i0  => ('s'))) + v6, 604);
	var v7 := DC1(v0, v2 / v2);
	v3[243] := v6 < v6;
	var v8: map<int, int> := map[-v2 := 0x341];
	var v9: multiset<int> := multiset{v2};
	var v10 := 'd';
	v7, v3[243], v0, v0, v3 := v7, fm0(v8, -|v9|, globalState), v10 in (v6 + "qtgkj"), v0, v3;
	var i1 := 0;
	while (false)
		decreases 100 - i1
	{
		...
		v12[995] := (if (-75 in v17) then v17[-75] else v16) + v16;
		v12[995] := {v15};
		v10 := v10;
		var v18: map<string, bool> := map["wm" := v3[243]];
		...
		decreases 100 - i4
	{
		...
		v20[484] := |(set v29 : int | (0x1c0 <= v29) && (v29 < 0x56) :: (v29 * v2))|;
		var v30: map<bool, int> := map[v0 := |v24|];
		v0, v20[484], v20, v2, v3[243] := false, v2, v20, 0x30e + v2, v3[243] !in (v30 + v30);
		var v31: seq<array<bool>> := [v3, v3];
		v3[243] := v3 !in v31;
	}
	var v32: map<bool, int> := map[!v3[243] := v2];
	for i5 := |(v32 + v32)| to v2 {
		...
		v2, v33, v35, v3[243], v3[243] := v2, v33, fm1(false, v7, globalState), if (if (v3[243]) then v3[243] else v0) then v36 != v36 else true, v3[243];
		v2 := -(i5 - i5);
		v3[243] := v2 != |"mjidffht"|;
		v0 := -i5 == |(v6 + (seq(-0xf9, i6  => (v10))))|;
	}
	var v37: set<char> := {v10};
	var v38: multiset<set<char>> := multiset{v37};
	var v39: multiset<bool> := multiset{false, v3[243], v1[|v9|]};
	var v41: seq<set<char>> := [v37, set v40 : char | v40 in map['p' := v3[243]] :: (v40)];
	var v42: array<multiset<set<char>>> := new multiset<set<char>>[9] [v38, v38, fm2(!false, v2, globalState), multiset(fm3(|v39|, v2, [v9, v9], v10, globalState)), v38, v38, multiset(v41), (multiset{v37, v37})[v37 := v2], v38];
	v42[457] := multiset(seq(0x185, i7  => (set v43 : char | v43 in map[v10 := 0x265] :: (v43))));
	v42[457] := v38[v37 := v2];
	for i8 := v2 to v2 - |map[v2 := v2]| {
		...
		v2 := i8;
		if (v2 <= 452) {
			v2 := |(v1[|v6| := v3[243]] + [!v0, v0, v0, v0])| + i8;
			var v44: map<int, bool> := map[-v2 := v3[243]];
			...
			v47[852] := v48;
			v0, v2, v2, v47[852] := (v2 - 0x3bd) <= 0x357, i8, if (|(v44 + v44)| in v8) then v8[|(v44 + v44)|] else i8, v48;
		} else {
			v6 := "tkuqi";
			var v49 := DC8(v0, v0, v0);
			v3[243], v2, v0 := v0, --((i8 * 479) % v2), v49.cf17;
			v10 := 'l';
		...
		decreases 100 - i9
	{
		...
		i9 := i9 + 1;
		v20[541] := v2;
		v20[541] := if (v3[243] in v32) then v32[v3[243]] else v2;
		var v53: map<string, bool> := map[v6 := v3[243]];
		var v54 := m0(v53, globalState);
		v3[243] := v0;
		v2, v20[541] := 0x2c7, v54 + -0x12d;
	}
	var v55: C3 := new C3(v0, !v3[243]);
	v55 := if (v3[243] !in v1) then v55 else v55;
	...
	if (v0) {
		...
		var v60: set<bool> := {v55.f19, v55.f19, v3[243], !fm0(map v59 : int | v59 in v9 :: (v59 + v2) := (v2), v2, globalState)};
		v58[787] := if (v1[v2]) then v60 else {v3[243]};
		v58[787] := v60 + v60;
		var v61 := new C3(v55.f19, |{v2}| > v2);
		v3[243] := (v2 % v2) < |(v60 - v58[787])|;
	} else {
	...
	match (v67) {
		case DC13() =>
			var v68: set<int> := {v2};
			v2, v3[243] := v2 - v2, v68 == {v2, |v6|};
			var v69: array<D5> := new D5[8];
			var v70: map<C3, map<int, int>> := map[v55 := v8];
			var v71: seq<map<int, int>> := [v8];
			var v72: array<map<int, int>> := new map<int, int>[23] [if (v55 in v70) then v70[v55] else v8, v8, v8, v8, v8[v2 := v2], if (v3[243]) then v71[v2] else v8, if (v0) then v8 else map[0x12f := 0x388], (DC2(v8).(cf3 := map[v2 := v2])).cf3 + v8, v8, fm39(v2, globalState), v8[|fm28(203, v2, !true, globalState)| := v2] + v8, v8, v8, v8, v8, v8, v8, v8, if (v0) then v8 else v8, fm39(v2, globalState), v8, v8, v8];
			v72[920] := v8;
			var v73: seq<int> := [v2, v2];
			var v74: set<seq<int>> := {v73, v73, v73, v73};
			v20[318] := |v74|;
			var v75: map<bool, bool> := map[v3[243] := v3[243]];
			var v76 := DC11(v55.f19);
			var v77: set<bool> := {v3[243], !v76.cf21};
			v69, v72[920], v20[318] := if (v1[v2] !in v75) then v69 else v69, v8[|v9| := |(if (v55.f19) then v73 else v73)|], -0xd0 - |(v77 + {v55.f19})|;
			if (v3[243]) {
				var v78: seq<seq<int>> := [v73, if (v3[243]) then v73 else v73, v73, v73, v73];
				v78 := v78;
				var v79 := new C3(v55.f19 ==> v55.f19, if (v0) then v55.f19 else v3[243]);
				var v80: array<char> := new char[12];
				v80 := new char[11];
				v3 := v3;
				var v81 := new C3(v55.f19, v3[243]);
			} else {
				var v82 := v55.m1(v20[318], globalState);
				var v83 := DC5(v6, v3, v2);
				var v84, v85, v86, v87 := v55.m2(v20[318], v6[-0x3a0 := v10], v83.cf10, globalState);
				v20[318] := (v73[v20[318]] + v2) / -v20[318];
				v20[318] := fm31(globalState) * -(|v9[v2 := v20[318]]| % v2);
				v3 := v3;
			}
		...
		case DC14(cf23) =>
			...
			v88[37] := if (cf23) then v3 else v3;
			v88[37] := v3;
			var v89: seq<int> := [v2];
			var v90: seq<array<bool>> := [v3, v3];
			var v91: map<seq<int>, int> := map[v89 + fm16(|v90|, v2, v3[243], v2, globalState) := |v6|];
			v91 := v91[v89 := v2 % v2];
		...
		case DC15(cf24) =>
			...
			if (v0) {
				...
				var v106, v107, v108, v109 := v55.m2(|{v55.f19, v55.f19}| + |v105[v2]|, v6, v2, globalState);
				v66[244][267] := v2 % |v109|;
				var v110: array<set<map<bool, bool>>> := new set<map<bool, bool>>[23](i13 => {map[v108 := v107], map[v3[243] := v0]} + {map[false := v108], map[v107 := v55.f19]});
				var v111: map<bool, bool> := map[v0 := !v107];
				var v112: set<map<bool, bool>> := {v111, v111};
				v110[396] := v112;
				var v113: set<int> := {v2};
				v2, v2, v39, v66[244][267], v110[396] := v2 + |v113|, v2, v39, v2, v112;
				v66[244][267], v8 := v66[244][267], map[v66[244][267] := v2];
				var v114: map<bool, seq<int>> := map[true := v104];
				v66[244][267] := |v114| % fm13(v108, v55.f19, v10, globalState);
				v3[243] := v55.f19 <==> v55.f19;
			} else {
				v3[243] := false;
				var v116: seq<int> := [|v6|, v2];
				v3[243] := fm0(map v115 : int | v115 in v116 :: (v115 + v2) := (|v9[0x110 := v2]|), v2, globalState);
				var v117 := DC6(v116);
				var v118 := DC6(v117.cf11);
				var v119: map<int, string> := map[-v2 := v6];
				var v120: map<bool, map<int, string>> := map[v55.f19 := v119];
				v2, v118, v116, v32 := |"od"|, fm48(v10, (if (v3[243] in v120) then v120[v3[243]] else v119)[v2 := v6], v2, v6 < v6, globalState), seq(0x2c2, i14  => (v2)), v32[v55.f19 := 0x1e8];
				v66[244] := new int[21];
			...
			v3[243], v10 := v0, v55.fm27(globalState);
	}
