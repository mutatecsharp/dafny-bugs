...
function fm1(p0: bool, p1: bool, globalState: GlobalState): seq<int> {
	([|"ln"|, 0x24d, |(seq(0x369, i0  => ('e')))|] + (seq(46, i1  => (-0x394)))) + ((seq(0x2, i2  => (|(map v0 : char | v0 in ['q'] :: (v0) := (-0x2c4))|))) + DC15(seq(609, i3  => (|{true, true}|))).cf25)
}
...
function fm19(p0: set<bool>, p1: bool, p2: char, p3: int, globalState: GlobalState): D0 {
	DC0((set v0 : int | (0x345 <= v0) && (v0 < -677) :: (v0 / 0x1fd)) < (set v1 : int | (-0x320 <= v1) && (v1 < 437) :: (v1 / 0x282)))
}
...
function fm24(p0: bool, p1: multiset<int>, p2: int, globalState: GlobalState): D2 {
	DC5(--(-|map[true := false]| % |map[0xda := |"gikgwt"|]|), true, true)
}
function fm25(p0: seq<int>, globalState: GlobalState): D3 {
	if (0x32f != |(seq(0x10, i0  => ('r')))|) then DC9(0x21, |"gkarebnxj"|) else DC9(|multiset{|"wwdkvrqt"|, 0x3e0}|, 0x2db)
}
...
function fm28(p0: string, p1: bool, p2: int, globalState: GlobalState): multiset<int> {
	multiset(([|(map v0 : int | (0x26a <= v0) && (v0 < -0x18a) :: (v0 / |map[DC37("k", true) := map[true := 0x3a2]]|) := (multiset{|"eskdxn"|, 0x17f, 0x1ec}))|, -0x35d] + [0x315, 0xd2]) + [--831])
}
...
function fm47(globalState: GlobalState): map<string, seq<int>> {
	map[seq(0xf7, i0  => ('x')) := [0x232, 0x28e, |(map v0 : int | (0x1e <= v0) && (v0 < -0x35b) :: (v0 - -|[-0x38a, 0x3b9]|) := (|map[false := false]|))|]] + (map v1 : string | v1 in {"ryegaxv", "kpurpehd", "vrthtypa"} :: (v1) := ([854, |multiset{0x3e6}|]))
}
...
function fm57(p0: string, p1: bool, p2: map<int, bool>, globalState: GlobalState): multiset<map<int, int>> {
	multiset{map v0 : int | (228 <= v0) && (v0 < 0x3ac) :: (v0 - |"huket"|) := (0x2f5), (map v1 : int | (0x34e <= v1) && (v1 < 0x34f) :: (v1 / |map[false := 0x27b]|) := (--|[false, true]|)) + map[-0x26b := -0xa9]}
}
...
function fm62(p0: int, globalState: GlobalState): map<int, map<bool, int>> {
	map v0 : int | (0x15c <= v0) && (v0 < 0x128) :: (v0 % 0x1ea) := (map[false := 0x39])
}
...
function fm66(globalState: GlobalState): map<int, int> {
	map[0x36 := |[false, true, true]| % |[0x38f, |multiset([true])|, |multiset{|map[false := |"bybpefmp"|]|, -|"p"|, |{'x'}|, |multiset{0x3f, 840}|}|]|]
}
function fm67(p0: int, p1: int, p2: int, globalState: GlobalState): D8 {
	DC24(false)
}
function fm68(p0: bool, globalState: GlobalState): map<char, bool> {
	(map['u' := true] + (map v0 : char | v0 in ['l', 'e'] :: (v0) := (false))) + ((map v1 : char | v1 in (seq(0x2f, i0  => ('i'))) :: (v1) := (false)) + map['x' := false])
}
function fm69(p0: int, p1: int, p2: int, globalState: GlobalState): D20 {
	if ({|(seq(0x90, i0  => (-237)))|} >= (set v0 : int | (-13 <= v0) && (v0 < 0x27c) :: (v0 - 0x2d2))) then DC54(DC29('f').cf44, map[-0x22b := false], map[false := seq(0x242, i1  => ('j'))], -|"yjsq"|) else DC54('x', map[-0x348 := false], map[false := "aquqvkpq"], 0x1d7)
}
function fm70(p0: bool, p1: string, p2: int, p3: bool, globalState: GlobalState): set<int> {
	(if (!true) then DC17({0xc7, |{false, true}|, 937, |(seq(225, i0  => ('l')))|, 0x2f2}) else DC17({|multiset{|"h"|}|})).cf27
}
method m0(p0: bool, p1: D0, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: int, r3: bool) {
	var v0: array<int> := new int[1](i0 => i0 % |[0x203, -90]|);
	var v1: multiset<bool> := multiset{p0, p0, p2};
	var v2 := 0x314;
	v0[288] := if (p0 in v1) then v1[p0] else v2;
	var v3: C7 := new C7();
	var v4: seq<C7> := [v3];
	var v5: map<seq<C7>, string> := map[v4 := "cn"];
	var v6 := "kvva";
	v0[288], v5, v6 := 0x11e, v5 + v5, v6;
	r2 := v0[288];
	...
	var v11 := 's';
	r2, globalState.f4, v7, r1, v8 := |v8| - |(map[p0 := v9.cf13] + v10)|, false, v7, v6[v2 := v11] < ("gtswhfxei" + v6), v8 + fm70(p0, "qecc", v2, p2, globalState);
	var i1 := 0;
	while (p2)
		decreases 100 - i1
	{
		...
		i1 := i1 + 1;
		var v12: array<bool> := new bool[10](i2 => multiset(([v2])[v0[288] := v0[288]]) !! multiset{-v2, |multiset{v2, v0[288]}|});
		v12[530] := p2;
		var v13: C4 := new C4();
		var v14: map<C4, set<int>> := map[v13 := v8];
		var v15: set<set<int>> := {v8, if (v13 in v14) then v14[v13] else v8};
		var v16: seq<bool> := [p2, p2, false];
		var v17: map<int, map<bool, int>> := map[v0[288] := v10];
		var v18: map<int, set<set<int>>> := map[0x1f1 := {{v0[288], v2, fm0(v16[v2], v17, p2, globalState), v0[288]}}];
		v12[530] := !((v15 - {v8, v8, {v2}, v8, v8}) == (if (0x329 in v18) then v18[0x329] else v15));
		var v19: map<bool, bool> := map[p0 := v12[530]];
		var v20: map<bool, map<bool, bool>> := map[p2 := v19];
		var v21: multiset<int> := multiset{v2, v2, 0xd5, v0[288]};
		var v22: seq<multiset<int>> := [v21];
		var v23: set<bool> := {p2};
		var v24: array<multiset<int>> := new multiset<int>[28] [v21, v21, v21, v21, v21, v21, v21, v21, v21, multiset{v0[288]}, v21, v21, v21, v21, v21, multiset{v0[288]}, v21, v22[0x20b], v21, multiset{v2, |v23|}, v21, v21, v21, v21, v21, v21, multiset([v2]), multiset([0x39e])];
		var v25: C2 := new C2([v2], p2, v20, v16, v24);
		var v26: map<C2, multiset<int>> := map[v25 := v21];
		var v27: seq<int> := [v0[288]];
		var v28: array<multiset<int>> := new multiset<int>[19] [v21, v21, v21, v21, v21, v21, v21, v21, multiset(seq(0x20c, i3  => (157))), multiset{0x25a}, multiset{v0[288]}, v21, multiset{v2}, v21, multiset{v0[288], v2, 873, v2}, v21, v21, if (v25 in v26) then v26[v25] else v21, multiset(v27)];
		...
		v30, v2, v31, v2, v12 := v30, v2, v31, v0[288], v12;
	}
	var v32: seq<int> := [v0[288]];
	var v33: seq<bool> := [p2];
	var v34: map<bool, bool> := map[p2 := p0];
	var v35: map<bool, bool> := map[v33[|v34|] := p0];
	var v36: map<bool, map<bool, bool>> := map[p2 := v35];
	var v37: multiset<int> := multiset{v0[288]};
	...
	var v45: seq<D14> := [v44];
	var v46 := DC70(v45);
	var v47: array<multiset<int>> := new multiset<int>[25] [v37, v37, multiset(v32), v37, if ((if (v33 in v39) then v39[v33] else !p0) in v38) then v38[if (v33 in v39) then v39[v33] else !p0] else v37, if (p2 in v38) then v38[p2] else v37, multiset{if (v42 in v43) then v43[v42] else v0[288], |v6|}, v37, v37, v37, v37, if (true in v38) then v38[true] else multiset{v2, |v37|, |v33|}, multiset{v2}, v37, (multiset(v32))[0x112 := |v46.cf106|], multiset{v0[288]}, v37, v37, v37, v37, fm28(v6, p0, v2, globalState), v37, v37, (fm56(v11, globalState))[v2 := v0[288]], multiset{v2}];
	var v48 := new C2(v32 + v32, !p0, v36, v33, v47);
	if (!p0) {
		var v49, v50, v51 := v3.m2(v0[288], globalState);
		...
		v60[640] := (map[if (|v37| in v62) then v62[|v37|] else v63 := v11])[v63 := v11] == v64;
		v60[640] := p2;
		var v65: array<char> := new char[15] ['p', v11, v11, v11, v11, v11, v11, v11, v11, v11, v6[v2], v11, v11, v11, v11];
		var v66: map<array<bool>, array<char>> := map[v60 := if (v60[640]) then v65 else v65];
		v66 := v66[v60 := v65];
		v6 := v6;
		v10 := v10 + map[p0 := v2];
		r3 := "fpbqponc" <= ((seq(359, i6  => (v11))) + (seq(-0x1a2, i7  => (v11))));
	}
	
	r0 := v32 + (seq(0x4b, i8  => (v0[288])));
	r1 := p2;
	var v67 := DC25(v41.f19, |v33|, v2, v10);
	r2 := (v2 - |fm35(|v1|, v67, globalState)|) % v48.fm8(v41.f19, p2, globalState);
	r3 := p0;
}
trait T0 {
...
class C0 {
	...
	method m7(p0: int, p1: seq<D1>, p2: int, p3: char, globalState: GlobalState) returns (r0: array<array<bool>>, r1: int) {
		...
		var v5: set<int> := {-p0};
		v2 := v2[v1 := {|v4|, -|v5|} >= v5];
		var v6 := DC2(|multiset{p2, fm14(p0, globalState)}| + |v2|, v0[306]);
		match (v6) {
			case DC1() =>
				globalState.f4 := v1;
				r1 := p2 / p2;
				v1 := !((-p0 >= p0) ==> (v1 <== v1));
				v3 := if (v1) then v3 else v3[p0 := p3];
			case DC2(cf1, cf2) =>
				...
				var v12: seq<int> := [|v11|];
				v7[306] := (v10.cf4[|([p0, 0x249] + v12)| := fm15(v0[306], p2, p0, p2, globalState)])[|v3| := (v8 + [true])[p2 := v1]];
				globalState.f4 := !cf2;
				var v13: array<array<bool>> := new array<bool>[15];
				v13[968] := v0;
				v13[968] := v0;
				var v14 := DC3(v11[false := |v11|]);
			...
			case DC0(cf0) =>
				...
				v17 := v17[|(v18 - multiset{!true})| := v5 * (set v19 : int | (0x29b <= v19) && (v19 < 0x3b2) :: (v19 % 0xc7))];
				r1 := |v3| % p2;
				r1 := -p0;
		}
			...
			decreases 100 - i1
		{
			...
			if (v0[306]) {
				...
				var v25 := DC7(DC4(v24));
				v25 := v25;
				var v26, v27, v28, v29 := m0(v1, v6, v0[306], globalState);
				...
				var v32: seq<bool> := [v0[306]];
				r1 := fm14(|v31[v32[p0] := p2]| - p2, globalState);
				v5 := v5 - {p0};
				globalState.f4 := v0[306];
			}
		...
		var v34: seq<array<array<bool>>> := [if (v0[306]) then v33 else v33];
		r0 := v34[p0];
		r1 := (-p2 % p0) - p2;
	}
}
...
class C1 extends T1 {
	...
	method m3(globalState: GlobalState) returns (r0: bool, r1: int, r2: set<seq<bool>>, r3: bool) {
		...
		r3 := !!fm17(v14[v3 := v3] + [v3], |map[if (false in v16) then v16[false] else |v14| := f18]|, globalState);
...
class C2 extends T3, T0, T4 {
	...
	function fm7(p0: int, globalState: GlobalState): int {
		(|(map v0 : int | (0xd1 <= v0) && (v0 < 0x1f1) :: (v0 / 0x1ee) := (f15))| + |map[-0x236 := f16]|) / 0xef
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): int {
		0x34c
	}
	function fm6(p0: string, globalState: GlobalState): seq<int> {
		f16[-(if (true) then -|DC17({0x229, 0x25d}).cf27| else -|(seq(0x205, i0  => ("nan")))|) := |(map v0 : string | v0 in (set v1 : string | v1 in map["pjnkal" := f15] :: (v1)) :: (v0) := (|"oy"|))|]
	}
	function fm5(p0: bool, globalState: GlobalState): int {
		|(f14 + f14)|
	}
	...
	function fm38(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState): int {
		--(|(DC8(map[f15 := f15]).cf11 + map[false := f15])| * (0x3e7 / 0x390))
	}
	method m4(p0: int, p1: int, p2: string, p3: multiset<int>, globalState: GlobalState) returns (r0: int) {
		...
		globalState.f4 := !((v4 < v4[p0 := v5]) <==> f15);
		for i0 := |f14| to 414 {
			var v6 := 'm';
			var v7: map<bool, char> := map[f15 := v6];
			var v8: array<char> := new char[13] ['j', v6, v6, p2[i0], v6, v6, v6, v6, v6, if (false in v7) then v7[false] else v6, if (f15) then v6 else v6, v6, v6];
			v8[344] := if (false) then v6 else fm39(p1, !f15, p0, p2, globalState);
			v8[344] := v6;
			...
			decreases 100 - i2
		{
			...
			var v17: array<map<bool, int>> := new map<bool, int>[15] [v14[p1], v13 + v13, v13[v10[859] := p0], if (false) then map[f15 := 0x33b] else map[f15 := 0xeb], v15.cf35, v13, v13 + v13, v13[v10[859] := |f16|], v13[v10[859] := p0], v13[v10[859] := |p3|], v13, v13[v10[859] := if (p1 in v16) then v16[p1] else p1], v13[f15 := p0], v13, if (f15) then map[v10[859] := 97] else map[f15 := p1]];
			v17[699] := v13;
			v17[699] := v13 + v13;
			var v18: T1 := new C1(!f15, f15, f13, f14, f12);
			var v19: multiset<T1> := multiset{v18};
			var v20: seq<T1> := [v18, v18];
			var v21: map<bool, T1> := map[v10[859] := v18];
			var v22: map<char, bool> := map[v11 := v10[859]];
			var v23: array<multiset<T1>> := new multiset<T1>[19] [v19, v19, v19, v19, multiset(v20), v19, v19, v19, multiset{v18, v18, v18, v18, v18} - v19, v19, v19, multiset{v18, if (f15 in v21) then v21[f15] else v18, v18}, multiset{v18, v18}, multiset{v18, v18, v18}, multiset{v18, if ((if (v11 in v22) then v22[v11] else v10[859]) in v21) then v21[if (v11 in v22) then v22[v11] else v10[859]] else v18}, v19 - v19, v19, v19, v19];
			var v24: map<bool, array<multiset<T1>>> := map[v10[859] := v23];
			var v25: seq<array<multiset<T1>>> := [if (fm2(v10[859], globalState) in v24) then v24[fm2(v10[859], globalState)] else v23, v23, v23];
			r0, r0, v23 := p1, p0, v25[p1];
			v10[859] := fm2(f14 == v18.f14, globalState);
		}
		r0 := |p2[-p1 := v11]| % p1;
		r0 := fm38(p1, -f16[|"qifnlwcgl"|], p0, v10[859], globalState);
	}
	method m3(globalState: GlobalState) returns (r0: bool, r1: int, r2: set<seq<bool>>, r3: bool) {
		var v0 := DC4(seq(0x1b, i0  => (f14)));
		v0 := v0;
		var v1 := -0x39c;
		var v2: set<int> := {v1};
		var v3 := DC24(f15);
		...
		var v8 := "qjlnmny";
		var v9: array<bool> := new bool[27] [f15, f15, v2 >= v2, !f15, f15 && f14[v1], f15, v1 < |v7|, f15, fm2(f15, globalState), f15 ==> f15, f15, f15, f15, f15, f15, f15, v8 != v8, false, f15, false, f15, false, f15, f15, v1 > |map[true := 0x2d2]|, f15, false];
		var v10 := DC22(f15);
		v9[4] := v10.cf34;
		var v11: multiset<int> := multiset{v1, v1};
		v9[4] := (multiset{v1, v1, v1} - v11[v1 := |v8|]) < v11;
		m12(!v9[4], globalState);
		var v12: map<int, int> := map[if (v9[4]) then v1 else 271 := v1];
		v12 := v12[v1 := v1];
		var v13: map<bool, string> := map[fm2(v9[4], globalState) := v8[|f16| := v5]];
		var v14: set<bool> := {v9[4], v9[4], v9[4]};
		var v15: seq<int> := [|v13|, |(v14 * {false, v9[4]})|, if (|"jefu"| in v11) then v11[|"jefu"|] else v1, 0x208, |f14| - v1];
		v5, v15 := v5, f16[v1 := v1];
		var v16 := DC14(v9[4]);
	...
	method m5(p0: set<bool>, p1: string, p2: int, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := if (f15 in v5) then v5[f15] else p2 to |(p1 + p1)| {
			...
			match (DC6(v6, v6).(cf8 := v6)) {
				case DC5(cf5, cf6, cf7) =>
					var v8: array<int> := new int[19] [p2, cf5, if (f15) then cf5 else fm5(cf6, globalState), -0x164, i0, cf5, if (!cf7) then cf5 else cf5, p2, p2 + cf5, p2, |p1|, i0, |(seq(0x2f2, i1  => (v0)))|, 0xd1 - i0, p2, cf5, |(map v7 : int | (624 <= v7) && (v7 < 0x2cd) :: (v7 - p2) := (v0))| % p2, cf5 % |p1|, i0];
					v8 := v8;
					cf5 := p2 / (cf5 - |"mmitbisb"|);
					globalState.f4 := cf7;
					cf5 := -0x27 + p2;
				case DC6(cf8, cf9) =>
					...
					v6[352] := v12[|p0| := f14] <= v12;
					v6[352] := fm2(f15, globalState);
					var v13 := DC16(v6[352]);
					var v14: map<D5, array<multiset<int>>> := map[v13 := f12];
					var v15 := new C1(v6[352], v6[352], f13, fm43(v10, v11, globalState), if (v13 in v14) then v14[v13] else f12);
					var v16: array<int> := new int[20](i2 => i2 / i0);
					var v17: seq<array<int>> := [v16, v16];
					var v18: map<bool, seq<array<int>>> := map[false := v17];
					var v19: map<int, array<int>> := map[p2 := v16];
					v6[352] := ((if (v15.f18 in v18) then v18[v15.f18] else [v16, if (p2 in v19) then v19[p2] else v16])[if (p2 in v1) then v1[p2] else -225 := v16] + v17) == v17;
				case DC4(cf4) =>
					globalState.f4 := v3 != v3;
					var v20 := "pdnbe";
					v20 := (v20 + (seq(0xe9, i3  => (v0)))) + (fm40(DC14(f15), i0, f15, f15, globalState) + (seq(-820, i4  => (v0))));
					var v21 := DC29(v0);
					v21 := v21;
					var v22 := 0x7b;
					v22 := v22;
		...
		match (fm44(v27, f15, globalState)) {
			case DC5(cf5, cf6, cf7) =>
				...
				r0, v28[816], cf5, cf5 := cf6, 0x39f, cf5, (if (v0 in v29) then v29[v0] else p2) + p2;
				var v30: map<int, int> := map[v28[816] := p2];
				var v31: map<map<int, int>, char> := map[v30 := v0];
				var v32: map<map<int, bool>, int> := map[v3 := |v31|];
				var v33: map<bool, int> := map[f15 := |v32|];
				v33 := v33[f15 <== f15 := if (if (-v28[816] in v3) then v3[-v28[816]] else cf6) then -p2 else p2];
				v28[816] := cf5;
			case DC6(cf8, cf9) =>
			...
			case DC4(cf4) =>
				...
				v42[818] := p2;
				v42[818] := if (v38 in v5) then v5[v38] else |(seq(0x170, i8  => (v0)))|;
			case DC7(cf10) =>
				var v43: map<bool, int> := map[f15 := -|p1|];
				var v44: seq<map<bool, int>> := [v43, v43, fm45(f15, f16[p2], p2, globalState), map[true := p2] + v43];
				v44 := ([v43, v43] + [v43])[|(v43 + v43)| := v43];
				var v45 := 138;
				v45 := -v45;
				var v46: set<int> := {p2 / |"ahgwcjry"|};
				v46 := v46 * {v45, v45};
				v0 := 'n';
		}
		...
		if (p2 != p2) {
			...
			if (f15) {
				...
				v49[379] := !((if (v48 in v54) then v54[v48] else v55) !! v55);
				v48[813] := v47;
				var v56 := DC0(f15);
				v56 := v56;
				var v57: map<bool, bool> := map[v49[379] := true];
				var v58: C1 := new C1(false, !v49[379], map[false := v57], [v49[379]], f12);
				var v59: C1 := new C1(map[v58 := v48[813]] == map[v58 := v47], v58.f18, f13, f14, f12);
				v59 := v58;
			} else {
				...
				var v63: map<bool, int> := map[f15 := --|(seq(595, i9  => (p1[|{f15}|])))|];
				v60[9], v61[892], v47, v47, v47 := f15, |f14|, -|(v62 + [v61, v61, v61])| / p2, if (!true) then p2 else |p1| + v47, |(v63 + v63)|;
				var v64: array<seq<D3>> := new seq<D3>[5];
				var v65 := DC8(map[f15 := v60[9]]);
				var v66: map<bool, bool> := map[f15 := !f15];
				var v67: seq<D3> := [DC8(v66)];
				v64[588] := [v65, v65] + v67;
				var v68: set<int> := {v61[892]};
				v64[588] := ([v65, v65])[|v68| := v65];
				var v69 := DC18(v61[892]);
				var v70 := DC16(f15);
				var v71: map<D5, int> := map[v70 := |multiset{|f16|}|];
				var v72 := DC5(if (DC16(v60[9]) in v71) then v71[DC16(v60[9])] else v61[892], v60[9], f14[v47]);
				var v73: map<D6, D2> := map[v69 := v72];
				var v75: multiset<D6> := multiset{DC18(v47), v69, v69};
				var v76: array<map<D6, D2>> := new map<D6, D2>[5] [v73[v69 := v72], map v74 : D6 | v74 in (v75[DC18(v61[892]) := p2])[v69 := p2] :: (v74) := (v72), map[v69 := v72], v73, v73];
				v76[298] := v73;
				var v77: map<int, int> := map[v47 := p2];
				v76[298], r0, v61[892], globalState.f4, globalState.f4 := v73, |p1| >= (|v77| % v47), p2, f14[v61[892]], v60[9];
				var v78: C1 := new C1(v60[9] && v60[9], !v60[9], f13, f14, f12);
				v78 := v78;
			}
			
			var v79 := new C0();
			var v80: seq<array<multiset<int>>> := [f12, f12, f12];
			var v81 := new C1(f15, f15, f13, f14 + f14, v80[|p1|]);
			globalState.f4 := v81.f18;
		} else {
			globalState.f4 := f15;
			var v82: array<int> := new int[16](i10 => i10 / p2);
			var v83 := DC3(v5);
			var v84: map<array<int>, D1> := map[v82 := v83];
			v82[811] := |v84|;
			var v85 := DC22(f15);
			var v86: map<D7, int> := map[v85.(cf34 := f15) := -0x1ee];
			v82[811] := if (DC22(f14[p2]) in v86) then v86[DC22(f14[p2])] else p2;
			...
			decreases 100 - i11
		{
			...
			v95[757] := if (fm0(f15, map[|v97| := v98], f15, globalState) in v96) then v96[fm0(f15, map[|v97| := v98], f15, globalState)] else p1;
			v95[757] := p1;
		}
		var v99 := new C0();
		r0 := f15;
	...
	method m6(globalState: GlobalState) returns (r0: bool) {
		...
		v8[820] := v9;
		var v10 := DC1();
		v7, v8[820], v0, globalState.f4 := v7, v9, |(match v10 {
			case DC1() => seq(0x2ff, i0  => (|v5|))
			case DC2(cf1, cf2) => f16[v0 := cf1] + [cf1, v0]
			case DC0(cf0) => f16
		})|, fm2(f15, globalState);
		globalState.f4, v0 := f15, f16[|v5|];
		var i1 := 0;
		while (f15)
			decreases 100 - i1
		{
			...
			match (v13) {
				...
				case DC7(cf10) =>
					...
					v6[370] := -v0;
					globalState.f4 := f15;
					globalState.f4 := v0 != v6[370];
					var v31 := DC5(|"vljqrh"|, f15, f15);
					v6[370] := if (true) then v0 else v31.cf5;
			}
			
			var v32: array<string> := new seq<char>[11](i4 => seq(-0x12d, i5  => ('q')));
			var v33 := DC36(v32, v0, fm47(globalState), {v9, v9});
			v9[644] := fm2(!f15, globalState);
			var v34 := "npgudenrk";
			globalState.f4, v33, globalState.f4, v9[644] := f15, v33, v34 < (if (f15) then v34 else "eghjdwmk"), f15 || f15;
			v0 := v0;
		}
		v0 := v0;
		...
		if (f15) {
			v2 := v2 + (map[!f15 := v0] + v2);
			var v36 := new C1(f15, f16 == (seq(0xca, i7  => (|map[v0 := v0]|))), f13, f14[v0 := f15], f12);
			v8[820] := v9;
			var v37 := DC31();
			v37 := DC31();
			v0 := --0x23c;
			...
			v38, v39 := v38, f16[-0x1b5 := v0] + f16;
			v0 := 709;
			var v40: seq<array<bool>> := [v9, v9];
			var v41: multiset<array<bool>> := multiset{v40[v0], v9};
			var v42 := 'b';
			var v43: map<multiset<array<bool>>, char> := map[v41 + v41 := v42];
			v43 := v43[v41 + v41 := v42];
			var v44: array<array<int>> := new array<int>[15] [v6, if (fm2(f15, globalState)) then v7[v0] else v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v7[v0], v6];
			...
			match (v45) {
				case DC16(cf26) =>
					...
					var v46 := DC15(f16);
					v9[837] := cf26;
					var v47: multiset<seq<int>> := multiset{f16, [v0], f16[v0 := v0], f16};
					var v48: seq<multiset<seq<int>>> := [v47, v47];
					v46, globalState.f4, globalState.f4, v38, v9[837] := v46, (v47 + v48[0x95]) >= (v47 * v47), (f15 <==> cf26) && f15, v38, if (cf26) then !f15 else !f15;
					globalState.f4 := cf26;
					var v49: seq<bool> := [v9[837], v9[837], v9[837]];
					v49 := [v9[837], cf26, true, !v9[837], fm2(v49[-0x1e9], globalState)] + v49;
				case DC15(cf25) =>
					v0 := |f14|;
					var v50: map<bool, array<bool>> := map[f15 := v9];
					v50 := v50[v1 > v1 := v8[820]];
	...
	method m11(globalState: GlobalState) returns (r0: char, r1: bool) {
		...
		match (match v3 {
			...
			case DC25(cf37, cf38, cf39, cf40) =>
				...
				var v13 := 'l';
				v12[678] := v13;
				cf38, v2, cf37, r0, v12[678] := v2 - cf38, (0x1a5 / cf39) - v2, fm2(f15, globalState), v13, v13;
				...
				if (!(v16 && !v18)) {
					...
					v21[916] := [f15, !!(if (f15 in v23) then v23[f15] else cf37), cf37];
					var v24: multiset<bool> := multiset{f15};
					var v25 := DC3(v24);
					v21[916] := fm43(v25, DC22(f15), globalState) + (f14 + f14);
					...
					var v31: map<D6, int> := map[v30 := cf39 % cf38];
					v31 := v31[v30 := 0x298];
				} else {
					v17 := cf39 % cf38;
					...
					var v35: array<bool> := new bool[20] [v32 <= v32, map[fm39(cf39, f15, -v17, v0, globalState) := v17] != v33, !true <==> cf37, (seq(231, i0  => ('n'))) <= v0, f15, if (cf37) then v18 else v18, v18, cf37, if (cf37) then false else f15, f15, f15, f15, f14[cf39], v16, f15, false, v18, cf37, (if (|v15| in v34) then v34[|v15|] else cf39) <= cf38, v16];
					v35[596] := !f15 || cf37;
					v35[596] := v16;
					var v36: multiset<array<bool>> := multiset{v35};
					v35[596] := multiset{v35, v35} >= v36;
					var v37: map<map<bool, int>, string> := map[cf40[v35[596] := 0x125] := v0];
					var v38: map<bool, bool> := map[v16 := cf39 == v17];
					v37, v14[267], globalState.f4, v35 := (v37 + v37) + v37, v15[-v2], !(if (fm2(v35[596], globalState) in v38) then v38[fm2(v35[596], globalState)] else false), v35;
					v35[596] := cf37;
				}
			...
			case DC26(cf41) =>
				...
				v40, v43[542], v44, v2 := v40 + f14, f15, v44, v2;
				...
				var v51: array<D11> := new D11[20] [v49, v49, v49, DC32(|v50[v2]|, v2), v49, v49.(cf46 := |v0|), v49, v49, v49, v49, v49, v49, v49, v49, DC32(v2, |v0|), if (f15) then v49 else v49, v49, v49, v49, v49];
				v51 := v51;
			case DC23(cf35) =>
				...
				v55[940] := v56 !! multiset{f15, f15};
				var v57 := DC3(v56);
				var v58 := DC22(f15);
				var v59: seq<seq<bool>> := [fm43(v57, v58, globalState), if (f15) then f14 else f14, f14, f14 + f14];
				var v60: set<int> := {v2, f16[847], v2, |multiset{v52}|, -v2};
				v55[940], v59, v60 := fm2(f15, globalState), v59, v60 + {|v0|, v2};
			...
			case DC27(cf42) =>
				...
				v66, r1, v67[961], v69[871], v71 := if ({v73} !! v74) then v66 else v66, !f15, v68, |(if (v78 in v80) then v80[v78] else v79)|, fm52(v83, !f15, fm2(f15, globalState), globalState);
				r1 := false;
		}
		...
		v2, v2 := match v85 {
			...
			case DC25(cf37, cf38, cf39, cf40) => v2 / cf38
			case DC26(cf41) => |f14|
			case DC23(cf35) => |v0|
			case DC27(cf42) => v2
		...
		if (v86.f18) {
			...
			v88[739] := v2 / v2;
			v88[739] := if (fm2(v86.f17, globalState)) then v2 else v2;
			globalState.f4 := v86.f18;
			var v89: map<int, int> := map[v88[739] := 0x31];
			v89 := v89[-0xf8 := v88[739]];
			v86.f18 := false;
		} else {
			v86.f18 := v86.f18;
			var v90: seq<seq<bool>> := [f14[v2 := true], [f15]];
			var v91 := DC4(v90);
			...
			v2 := v2 - |(v90[|fm10(v86.f17, v94, v86.fm6(v95[v2], globalState), v2, globalState)|] + f14)|;
			var v96: array<array<int>> := new array<int>[18];
			var v97: array<string> := new string[11] [v95[v2], "nddakcmt", v0, v0, "bkkowjg", "t", v0, v0, v0, v0, "kw"];
	...
	method m12(p0: bool, globalState: GlobalState) {
		...
		var v1 := DC8(v0);
		var v2 := -0x118;
		var v3: array<D3> := new D3[14] [fm54(-|(seq(-0x221, i0  => ('q')))|, globalState), v1, v1, v1, v1, v1, v1, v1, v1, if (f14[v2]) then DC8(v0) else v1, v1, v1, fm54(v2, globalState), v1];
		v3[841] := v1;
		v3[841], v2, globalState.f4 := fm54(v2, globalState), v2, p0;
		...
		var v20: seq<map<D4, bool>> := [v14, v14, v16[|fm56(v6, globalState)|], map v17 : D4 | v17 in v19 :: (v17) := (f15), v14];
		var v21: set<bool> := {f15, p0, false};
		v14, v10[705], v2 := v20[v2 * v2], |v21|, |{v2 >= v2, fm2(p0, globalState), p0, !p0}|;
	}
}
...
class C3 extends T0, T2 {
	...
	function fm7(p0: int, globalState: GlobalState): int {
		-((0x2e % |multiset(['g'])|) / (|map[f15 := f15]| - |f14|))
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): int {
		match DC22(f15) {
	...
	method m3(globalState: GlobalState) returns (r0: bool, r1: int, r2: set<seq<bool>>, r3: bool) {
		...
		for i0 := v3 to fm34(v1.f17, v3, f20, v1.f17, globalState) {
			...
			var v6: array<seq<bool>> := new seq<bool>[20] [f14, v4.cf18, f14, f14[i0 := !v1.f18] + [false, f20], f14, f14, v5[-0x34e], f14, v5[0x341], f14, f14 + f14, f14 + [v1.f18, v1.f18, v1.f17], f14, f14, f14[i0 := v1.f17], [v1.f17], f14 + f14, f14, f14, [v1.f18]];
			...
			var v12 := "jas";
			var v13: map<bool, string> := map[f15 := seq(0x1f9, i2  => ('r'))];
			var v14 := 'j';
			var v15: map<int, string> := map[i0 := v12];
			var v16: array<string> := new string[14] [fm35(v3, v11, globalState), v12, v12, v12, seq(809, i1  => ('x')), v12, "cpq", v12, v12 + v12, if (false in v13) then v13[false] else v12, v12[v3 := v14], "jpvq" + (if (-v3 in v15) then v15[-v3] else "ytiar"), v12, v12];
			v16[562] := v12;
			v16[562], globalState.f4 := v12 + ("iw" + v12), v1.f18;
			r1 := v3;
			var v17 := new C1(v1.f18, v1.f18, f13, f14, f12);
		}
		var v18: seq<int> := [v3];
		var v19: seq<seq<int>> := [v18];
		var v20: set<seq<int>> := {v19[|"cekuw"|]};
		var v21: map<bool, seq<int>> := map[f15 := v18[-v3 := |v20|]];
		for i3 := |(if (v1.f17 in v21) then v21[v1.f17] else v18)| to |f14| + v3 {
			var v22: map<int, bool> := map[v3 := v1.fm17(([i3])[i3 := -v3], i3, globalState)];
			var v23 := "v";
			v22 := v22[|v22| := v23 < v23];
			globalState.f4 := f20;
			var v24: array<int> := new int[23](i4 => i4 + v18[|multiset(if (v1.f18 in v21) then v21[v1.f18] else seq(0x177, i5  => (|v18|)))|]);
			v24[219] := v1.fm5(true, globalState);
			r1, r0, v24[219] := v3 + i3, v3 == v3, i3;
			r0 := v1.f17 ==> !!v1.f17;
		}
		var v25 := "k";
		...
		var v30 := 'b';
		v3, v28, r1, v25 := v3, {|v29|, v3 / v3, v3, v3}, |[v30, 'c', v30, v30]| - v3, v25;
		var v31: map<int, bool> := map[0x1b4 := v1.fm17(v18, |v28|, globalState)];
		var v32 := DC21(v31, false, f14[v3]);
		...
		r1 := match v35 {
			...
			case DC12(cf18) => |v18| + |(seq(665, i6  => (v3)))|
		};
		var v37: map<bool, int> := map[v1.f18 := v3];
		var v38: set<string> := {v25, v25, v25, seq(0x3a, i7  => (v30)), fm35(v3, DC25(f15, v3, v3, v37), globalState)};
	...
	method m9(p0: bool, p1: bool, p2: string, globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: map<int, bool>) {
			...
			decreases 100 - i0
		{
			...
			v5[911] := f15;
			v8, v5[911], globalState.f4, v0, r0 := v8, true, --0x38e != v0, v0, v0;
			r0 := v0 - v0;
			var v9: multiset<bool> := multiset{v5[911], f15, p0, !p0};
			r1 := v0 - |v9|;
		}
		...
		for i1 := v0 to |v10| {
			...
			if (if (p2 in v11) then v11[p2] else f15 && p0) {
				...
				var v18: map<int, int> := map[-i1 := -|("ymee")[|v17| := v13]|];
				var v19 := new C1(f20, fm2(p0, globalState), if (f14[-|p2|]) then f13 else f13, v14.cf18[|v18[i1 := |v1|]| := p1], f12);
				v19.f18 := p0;
				var v20: array<bool> := new bool[22](i2 => v19.f17);
				var v21: seq<array<bool>> := [v20];
				var v22: map<seq<array<bool>>, int> := map[(v21 + v21)[fm7(0x2c4, globalState) := v20] := i1];
				v22 := v22[v21 := -(i1 + v0)];
			...
			var v36: seq<T4> := [v35];
			var v37: array<T4> := new T4[12] [if (f20) then v35 else v35, v35, v35, v35, v35, v35, v35, v35, v36[0x1e7], v35, v35, v35];
			v37[556] := v35;
			var v38: set<bool> := {f15, false, p1, p0};
			var v39: seq<int> := [i1, |v38|, i1, |f14|];
			v37[556] := new C2(v39, f15, f13, f14, f12);
			var v40 := new C0();
			var v41: seq<string> := [seq(219, i3  => ('s'))];
			v41 := v41 + v41;
		}
		r0 := v0 % |fm57(p2, f15, map[|v10| := f15], globalState)|;
		var v42 := 'r';
		v42 := v42;
		...
		r3 := ((map v45 : int | (0x1c7 <= v45) && (v45 < 0x307) :: (v45 % v0) := (DC21(map[|v10| := f15], f15, p1).cf32)) + v46) + v46;
	}
	method m10(globalState: GlobalState) {
		...
		for i0 := v1 to v1 {
			...
			v4 := v4;
			var v5: seq<int> := [v1];
			globalState.f4 := (v5 + v5[-0x39 := v1]) <= v5;
			v2 := v2;
		...
		v0[796] := if (|(seq(113, i1  => ('a')))| in v8) then v8[|(seq(113, i1  => ('a')))|] else true;
		v0[796] := false;
		globalState.f4 := (407 % 0x232) < v1;
	}
}
...
class C4 extends T4 {
	...
	function fm10(p0: bool, p1: set<int>, p2: seq<int>, p3: int, globalState: GlobalState): set<int> {
		set v1 : int | v1 in (map[495 := false] + (map v0 : int | (0x392 <= v0) && (v0 < 0x3b8) :: (v0 / -0x1e6) := (true))) :: (v1 * |"s"|)
	}
	...
	method m5(p0: set<bool>, p1: string, p2: int, globalState: GlobalState) returns (r0: bool) {
		...
		if ((if (148 in v2) then v2[148] else v4.cf1) == (if (p2 in v2) then v2[p2] else p2)) {
			...
			var v8 := DC9(fm0(v3, v7, v3, globalState) * -p2, |(seq(662, i0  => ('a')))|);
			match (v8) {
				case DC9(cf12, cf13) =>
				...
				case DC10(cf14, cf15, cf16) =>
					cf14 := cf16.f14[-(cf15 / cf15)];
					var v10: array<string> := new seq<char>[12](i1 => (seq(0xdc, i2  => (v0)))[|p1| := 'f']);
					v10[237] := p1;
					v10[237] := "uqnkr" + p1;
				...
				case DC8(cf11) =>
					...
					var v17: seq<multiset<int>> := [v16, v16, v16, v16, v16[0x3bb := p2]];
					var v18: map<map<int, bool>, int> := map[v15 := |v17[-p2]|];
					...
					v19[157] := p2;
					var v20: seq<bool> := [v3];
					v3, v19[157] := v3, (v19[157] - p2) - (|v20| * p2);
					...
					v19[157] := fm0(if (v20[|v27|]) then v3 else v23.f17, v7, true, globalState);
				case DC11(cf17) =>
					var v28 := -0x30d;
					v28 := -p2;
			...
			v35[236] := fm28(p1, v3, p2, globalState);
			...
			globalState.f4, v38[731], v39 := (if (v3 in v37) then v37[v3] else false) ==> true, v3, v39;
			v38[731] := v38[731];
			v38[731] := v3 ==> v38[731];
		...
		var v47: array<int> := new int[18](i6 => i6 / p2);
		v47[852] := |p0|;
		var v48: map<char, bool> := map[v0 := v3];
		v47[852] := |p1[|p0| := v0]| * |v48|;
		r0 := v3;
	}
	method m6(globalState: GlobalState) returns (r0: bool) {
		var v0 := false;
		...
		if (v0) {
			...
			var v18 := 'd';
			var v19: array<string> := new string[9] [v12, v12, fm29(v17.cf14, v0, v0, v9, globalState) + v12, v12[v9 := v18], v12, v12 + v12, v12, v12 + v12, "pysu" + "ndnibmluf"];
			v19[325] := "pxcb";
			v19[325] := fm29(v0, fm2(true, globalState), v0, v9, globalState);
			...
			if (v9 <= v9) {
				...
				v26[544] := v27.cf5 * |(map v28 : int | v28 in [v9] :: (v28 * v9) := (multiset{0x11b}))|;
				v26[544] := 0x3cd;
				var v29 := new C0();
				v26[544] := v26[544];
				var v30: map<int, array<bool>> := map[v9 := if (v0) then v8 else v8];
				v30 := (v30 + v30) + (map[|v19[325]| := v8])[|v25[|v25| := v9]| := v8];
			}
			...
			if ((|v34| + v39) < |(seq(0x12b, i0  => (-v39)))|) {
				...
				v51, v36, v36, v39 := ((set v52 : int | v52 in v40 :: (v52 / |multiset{true, !true}|)) * v51) - v51, v36, v36, v39 * -(-0x3b3 / v39);
				globalState.f4 := v49.f17;
				var v53 := 's';
				var v54: array<string> := new string[24] [v34, ("di" + v34[-0x34a := v53])[v39 := v53], v34, fm29(v49.fm17(v47, -v49.fm5(v49.f18, globalState), globalState), v49.f17, v49.f18, 305, globalState), v34, v34, "qafisv", v34, "qxdoh", v34, "bnfm", v34[v39 := v53], "lwfvvvjpx", v34 + v34, v34 + "pawwyk", v34, fm29(v49.f18, v0, v0, DC9(v39, v39).cf12, globalState), v34 + v34, v34, v34 + (seq(-652, i1  => (v53))), v34, v34, v34 + "uqvycdvnb", v34];
				v54[982] := v34;
				var v55: seq<string> := [v34];
				v54[982] := v55[v39] + v34;
				var v56: map<multiset<char>, int> := map[multiset(v54[982]) := v39 * v39];
				var v57: multiset<char> := multiset{v53};
				var v58: map<int, int> := map[v39 := v39];
				v56 := v56[v57 - v57[v53 := -0x10f] := if (|v34| in v58) then v58[|v34|] else v39];
				v39 := v39;
			} else {
				...
				var v65: C1 := new C1(|v60[v39]| == v39, (if (v34 in v35) then v35[v34] else v39) in v61, v63, v2[v39], v64);
				v65 := v65;
			}
		...
		for i2 := v69 to v69 {
			...
			if (v74 < multiset{v69, v69, |v70|, v69, |(map v75 : char | v75 in v76[v68 := i2] :: (v75) := (v0))|}) {
		...
		v90[546] := fm28(if (true in v92) then v92[true] else v91, true, v69, globalState);
		var v93: seq<int> := [v69];
		var v94: seq<int> := [-v93[v69], v69, v69, v69];
		...
		if (v0) {
			...
			var v99: array<int> := new int[16] [v69, if (v0) then v69 else v69, v69, 472 % v69, v69, -0x2e6, v69 / v69, v69, -773 % (if (v96 in v97) then v97[v96] else |v98|), v69, |v96|, v69, v69, 674, v69, v69];
			v99 := v99;
			globalState.f4 := fm2(v69 == v69, globalState);
			v69 := -0x19d;
			var v100: map<bool, bool> := map[v1[v69] := v0];
			v69 := |v100|;
			var v101 := DC8(v100 + (map[v0 := v0])[v0 := v0]);
			match (v101) {
				case DC9(cf12, cf13) =>
					var v102: multiset<string> := multiset{seq(-0x26, i3  => (v68))};
					v99[382] := 0x371;
					...
					v102, v99[382], globalState.f4, v69 := v102, v69, v1[v94[v69]], |v105|;
					var v106 := new C1(v93 < v94, true, map[v0 := v100], v1 + v1, v90);
					var v107: array<int> := new int[14](i4 => i4 / v99[382]);
					var v108: set<int> := {-cf13, cf13, |v91|, |v91|, v69};
					v107 := new int[7] [-v69 * |v94|, |v108|, v69, v69, cf13, cf13, v99[382] % v99[382]];
					v69 := cf12;
				case DC10(cf14, cf15, cf16) =>
					v0 := cf14;
					...
					v110[319] := !(v69 < cf15);
					v99[572] := cf15 / v69;
					var v112: map<int, int> := map[cf15 := |(map v111 : int | (409 <= v111) && (v111 < 735) :: (v111 / |map[cf14 := v69]|) := (v0))|];
					v109, cf15, v110[319], v99[572], cf15 := v109, cf15, v69 <= v69, |v112| - --(cf15 + cf15), (0x2c0 - cf15) - cf15;
					v98 := v98;
					v99[572] := v69;
				case DC8(cf11) =>
					...
					var v114 := DC2(v69, v0);
					v113[509] := v114;
					v113[509] := v114.(cf1 := |[fm2(v0, globalState)]|).(cf2 := false <==> v0);
					...
					var v121 := DC23(v118);
					var v122: array<map<bool, int>> := new map<bool, int>[24] [v118, v118, v119[|v120|], v118 + v118, v118[v115 := |v94|], v118, v118[!v0 := 0xbf], v118, v119[v69], v118, v118, v118 + v118, v118, v118, v121.cf35, map[v115 := -0x114], v118, (map[v115 := v69])[v0 := 0x35a], v118, v118, v118, v118, v118[v115 := |(seq(-0x351, i6  => (|v93|)))|], v118 + v118];
					v122 := v122;
				case DC11(cf17) =>
					v69 := v69;
					globalState.f4 := v0;
			...
			match (v125) {
				case DC9(cf12, cf13) =>
					var v126: array<string> := new string[22] [v91, v91, v91, if (v0 in v92) then v92[v0] else v91, v91, "xunrvxhf", v91, v91, v91, v91, v91, seq(0x26f, i7  => (v68)), v91, v91[cf12 := v68], v91, v91, v91, "b", (seq(580, i8  => (v68)))[|map[cf13 := v0]| := v68], v91, v91, v91];
				...
				case DC11(cf17) =>
					...
					var v138: seq<seq<int>> := [seq(0x280, i10  => (v69))];
					var v139: map<D6, seq<seq<int>>> := map[v137 := v138 + v138];
					v139 := v139[DC17(v135) := [v93, [v69], v93] + (seq(0x1d9, i11  => (([v69, v69])[DC9(v69, v69).cf12 := -v69])))];
					v93 := (v138[v69])[v69 := -147];
					var v140 := new C0();
					v69 := 0x95;
			}
			...
			if (v141[757] && (v69 != -v69)) {
				...
				var v143: multiset<bool> := multiset{v0, v142 > v142, v0, v141[757]};
				v143 := v143;
				...
				v69 := v69;
				var v147: multiset<bool> := multiset{v141[757]};
				var v148: map<char, bool> := map[v68 := v0];
				v90[546] := multiset{if (v141[757] in v147) then v147[v141[757]] else |[v69, |v148|]|};
				v141[757] := v0;
				v69 := v69;
				globalState.f4 := v0 || v141[757];
			}
	...
	method m8(globalState: GlobalState) returns (r0: bool, r1: seq<string>, r2: seq<bool>) {
		...
		var v3: array<string> := new seq<char>[10](i2 => seq(73, i3  => ('k')));
		forall i1 | 0 <= i1 < v3.Length {
			v3[i1] := "vaderto" + (seq(0x19b, i4  => ('b')));
		}
		var v4 := "gfbewqfba";
		var v5 := 0x23b;
		...
		var v13 := DC13(fm2(v0, globalState), v8 <= (set v9 : int | (453 <= v9) && (v9 < 0x3c4) :: (v9 % v5)), fm0(v0, v12, v0, globalState), v5 % v5, true);
		match (v13) {
			case DC13(cf19, cf20, cf21, cf22, cf23) =>
				v6[635] := 0x260;
				var v14 := 'e';
				var v15: map<int, char> := map[cf21 := v14];
				v6[635] := v5 + -|fm32(cf19, v14, |v15|, 322, globalState)|;
				...
				v6[635], v19, cf19, v20 := cf21, if (if (cf23) then cf19 else v0) then if (cf20) then v19 else v19 else if (cf23) then v19 else v21[cf21], !fm2(v0, globalState), v20;
			...
			case DC14(cf24) =>
				...
				v0, v4 := false, if (v29 !in v4) then v4 else v30[0x218] + "kmbesbw";
		...
		var v40 := DC21(v38 + map[v5 := v0], fm2(v0, globalState), !(v5 <= v39[v5]));
		match (v40) {
			case DC21(cf31, cf32, cf33) =>
				if (v0) {
					...
					var v45 := 'r';
					var v46: array<multiset<int>> := new multiset<int>[29] [v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, (v43[|v38| := |v44|])[v5 := -0x1da], v43, v43, multiset{|v43|}, multiset{|[v5]|}, multiset{v5, v5}, v43, v43, v43, v43, v43, v43, v43, fm56(v45, globalState), v43, v43, multiset{v5}, v43, v43];
				...
				if (cf33) {
					...
					var v60 := 'w';
					globalState.f4 := (v39 != [v5, |v58|]) || (v5 <= (if (v4[v5 := v60] in v59) then v59[v4[v5 := v60]] else v5));
					var v61 := DC14(cf33);
					v0 := v61.cf24;
					v1[600] := v0 || cf32;
					var v62: set<char> := {v60};
					v1[600] := fm2(v62 <= v62, globalState);
					var v63 := DC12(v10);
					r0 := (fm44(v63, true, globalState)).cf6;
				} else {
					var v64: map<bool, bool> := map[cf32 := cf32];
					v64 := fm59(v52, cf32, if (cf32) then cf33 else cf32, if (cf32) then v5 else |(set v65 : int | (0x343 <= v65) && (v65 < 0x374) :: (v65 / v5))|, globalState);
					...
					var v69 := DC20(v52);
					v68 := {v1[89], v69.cf30 >= v52, v10[|v10|]};
				}
			...
			case DC22(cf34) =>
				...
				var v76: array<multiset<int>> := new multiset<int>[21] [v74, v74[v5 := 0x10d], v74, v74[|v75| := v5], v74, v74, v74, v74, v74, v74, v74, v74, multiset{v5, v5}, v74, v74, v74, v74, v74, v74, v74, v74];
				...
				match (DC33(cf34, v5, !true, v77, v77.f17).(cf49 := v5)) {
					case DC31() =>
						...
						v6[586] := -v5;
						v5 := v6[586];
						v1[17] := if (v0) then true else v77.f17;
						v1[17] := !false;
					case DC32(cf46, cf47) =>
						v5 := -v5;
						v6 := v6;
					...
					case DC33(cf48, cf49, cf50, cf51, cf52) =>
						...
						v5 := cf49 / (0x1ac % |(map v81 : int | (-0x238 <= v81) && (v81 < -0x264) :: (v81 % cf49) := (|[cf51.f18]|))|);
						v1[916] := !v77.f18;
						...
						v1[916], globalState.f4, v4, v1, v1 := cf51.f17, cf49 >= (|v85| / cf49), v4, v1, v1;
						v5 := cf49;
					case DC30(cf45) =>
						...
						v6[288] := v5;
						v86, v6[288] := fm61(globalState), (0x265 * v5) - v5;
			...
			case DC20(cf30) =>
				...
				if (!v0) {
					...
					v6[360], globalState.f4, v5, v6[169], globalState.f4 := v5, v97 >= (v97 - v97), |fm27(globalState)|, (v5 - -v5) * v5, v0;
					v1[554] := true;
					var v98: map<int, int> := map[v6[360] := v5];
					var v99 := 'j';
					v1[554], v6[360] := v0, |((seq(0x292, i10  => ('g')))[if (v6[360] in v98) then v98[v6[360]] else v6[360] := v99] + ("adwid" + v4[v6[360] := v99]))|;
					var v100: array<map<bool, bool>> := new map<bool, bool>[5];
					var v101: map<int, array<map<bool, bool>>> := map[fm0(false, v12, v0, globalState) % v5 := v100];
					v101 := v101[v6[360] := v100];
					var v102: array<array<int>> := new array<int>[2];
					var v103 := DC28(v102);
					var v104: array<int> := new int[23];
					var v105: map<string, int> := map[v4 := |v4|];
					v103, v6[360], v1[554], v104, v6[360] := v103, (if (v4[v5 := v99] in v105) then v105[v4[v5 := v99]] else fm0(v1[554], v12, v10[fm0(v0, v12, false, globalState)], globalState)) + -(v5 % |v11|), v1[554], v104, v39[v5];
				} else {
					v5 := v5;
					globalState.f4 := false;
					var v106: map<int, seq<int>> := map[v5 := v39];
					var v107: map<bool, map<int, seq<int>>> := map[v0 := v106];
					v6[272] := |(if (v0 in v107) then v107[v0] else v106)|;
					r0, v6[272], globalState.f4 := v0, fm0(v4 < v4, v12, v0, globalState), v5 < (if (v0) then -v5 else v5);
					v5 := v6[272];
					v5 := v6[272];
				}
				
				v6[943] := -(-|"n"| / v5);
				v6[943] := if (v0) then |v4| else v5;
				if (true) {
					var v108: seq<array<bool>> := [v1, v1];
					globalState.f4 := (v108 + v108) != v108;
					var v109: map<int, seq<int>> := map[|v10| := v39];
					var v110: array<seq<int>> := new seq<int>[6] [v39[v5 := 0x155], v39, [68], [v6[943], v5] + (if (v6[943] in v109) then v109[v6[943]] else v39), v39, seq(0x7e, i11  => (|(seq(-106, i12  => ('n')))|))];
					v110[157] := fm1(v0, v0, globalState);
					var v111 := DC1();
					var v113: map<int, array<bool>> := map[v6[943] := v1];
					var v114: multiset<map<int, array<bool>>> := multiset{v113, map[|v4| := v1]};
					v110[157], v6[943], v6[943], v111 := v39 + (seq(0x252, i13  => (0x27b))), (-0x19f * v5) - v6[943], fm0(!v0, map v112 : int | (0x3ac <= v112) && (v112 < 896) :: (v112 / v5) := (DC25(v0, v6[943], |map[DC20(cf30) := v5]|, map[v0 := v6[943]]).cf40), v0, globalState) % (if (v113 in v114) then v114[v113] else v5), v111;
...
class C5 extends T0, T1, T4 {
	...
	function fm5(p0: bool, globalState: GlobalState): int {
		0x3b0 % -|map[multiset{DC4([f14]), DC4([f14])} := f14]|
	}
	function fm6(p0: string, globalState: GlobalState): seq<int> {
		([0x198] + [0x1b4, |[|f14|, |map[-25 := 366]|]|, -|(map v0 : int | v0 in (seq(-832, i0  => (-0x377))) :: (v0 - 0x1b3) := (150))|]) + (seq(0x2bb, i1  => (--0x9b)))
	}
	function fm10(p0: bool, p1: set<int>, p2: seq<int>, p3: int, globalState: GlobalState): set<int> {
	...
	method m3(globalState: GlobalState) returns (r0: bool, r1: int, r2: set<seq<bool>>, r3: bool) {
		...
		match (v3) {
			case DC1() =>
				...
				v4[297] := (if (fm2(f19, globalState)) then v6[v5 := 0x1ed] else v6) >= v6;
				var v7 := "sacmgtow";
				v7 := (fm21(f19, globalState))[v0 := 'm'];
			...
			case DC2(cf1, cf2) =>
				...
				var v13 := "jsmors";
				v11, cf2, r3 := v11, !f14[v0], (v0 % -v0) <= (if (true in v12) then v12[true] else |[|v13|]|);
				r0 := cf2;
				var v14: C0 := new C0();
		...
		if (f19) {
			...
			var v27: set<int> := {v0};
			var v28 := "bpo";
			var v29: array<bool> := new bool[22] [if (f19) then f19 else f19, f19, f19, f19, f19 <==> fm2(f19, globalState), f19, f19, f19, f19 in [f19, f19, f19, f19, f19], !false, v26 <= v26[v25 := v0], -0x2c7 != v0, f19, f19, v0 in fm10(false, v27, seq(0x15c, i2  => (-0x341)), v0, globalState), f19, fm2(f19, globalState), v28 == v28, false, f19, f19, true <==> f19];
			v29[88] := f19;
			v29[88] := true;
			var v30: seq<int> := [v0];
			v0 := -v0 + v30[-0x19c];
			if (f19) {
				...
				v25[596], v0, r1, v31[840], r1 := v0, v0 / v0, 501 / 0x240, v32, v30[|v33|];
				var v34: array<int> := new int[23];
				v34 := v34;
				v30 := v30 + v30;
				var v35 := DC0(v29[88]);
				v29[88], v29[88], v25[596] := false, v29[88], if (fm2(v35.cf0, globalState)) then |v28| else v25[596];
			...
			var v37 := 'r';
			match (if (f14[v0]) then v24 else fm23(v0, v37, globalState)) {
				case DC5(cf5, cf6, cf7) =>
					cf5 := 0xae;
					globalState.f4 := cf7;
				...
				case DC4(cf4) =>
					...
					var v48: map<bool, bool> := map[f19 := !v29[88]];
					var v49: map<map<bool, seq<int>>, bool> := map[v47 := if (v29[88] in v48) then v48[v29[88]] else v29[88]];
					v49 := v49[v47 := v29[88]];
					var v50: array<char> := new char[9](i3 => v37);
					v50[346] := v37;
					v50[346] := if (true) then v37 else v37;
				case DC7(cf10) =>
					var v51: map<int, int> := map[v0 := v0];
					r1 := |(map[|f14| := v0] + v51)|;
					r0 := fm2(v29[88] <== f19, globalState);
					v0 := v0 * v0;
					var v52: set<D2> := {fm24(v29[88], multiset(v30), 749, globalState)};
			...
			var v55: array<array<bool>> := new array<bool>[29] [v53, v53, v53, v53, if (v53[34]) then v53 else v53, if (v0 in v54) then v54[v0] else v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53, v53];
			v55 := v55;
			var v56 := new C1(v53[34], v53[34] || v53[34], f13, f14, f12);
			var v57: array<int> := new int[9];
			v57[993] := v0 * v0;
			v57[993] := v56.fm5(!false, globalState) * v0;
			...
			decreases 100 - i4
		{
			...
			v59[941] := v60 in (if (false) then v61 else v61);
			var v62: map<int, map<bool, map<bool, bool>>> := map[v0 := f13];
			var v63: map<bool, bool> := map[v59[941] := f19];
			var v64 := DC8(v63);
			var v65 := new C1(v59[941], !(f19 <== v59[941]), (if (v0 in v62) then v62[v0] else f13) + f13[f19 := v64.cf11], f14, f12);
		}
		var v66 := "pyqhtx";
		var v67: map<string, bool> := map[v66 := !f14[v0]];
		r3 := "bqw" in v67;
		r0 := DC0(f19).cf0;
		r1 := v0;
	...
	method m5(p0: set<bool>, p1: string, p2: int, globalState: GlobalState) returns (r0: bool) {
		...
		match (v0) {
			case DC9(cf12, cf13) =>
				...
				var v4: map<multiset<seq<bool>>, seq<string>> := map[v2 := (v3 + v3)[cf12 := p1]];
				v4 := v4[v2 := v3];
				var v5: array<bool> := new bool[11];
				var v6: T1 := new C1(DC5(cf12, f19, f19).cf6, f19, f13, f14, f12);
				v5[140] := (DC10(f19, cf12, v6).(cf14 := f19)).cf14;
				var v7: map<bool, bool> := map[f19 := f19];
				v5[140] := (v7 + v7) != v7;
				var v8 := "vbxdea";
				v8 := v8;
				globalState.f4 := p2 <= (0x289 % cf12);
			case DC10(cf14, cf15, cf16) =>
				var v9: seq<int> := [p2];
				r0 := fm2([p2] == v9, globalState);
				var v10: map<bool, int> := map[cf16.f14[cf15] := 0x15f];
				...
				match (fm25(v9, globalState)) {
					case DC9(cf12, cf13) =>
						var v13: array<int> := new int[8](i0 => i0 / p2);
						v13 := if (cf14) then v13 else v13;
						v12.f18 := (v12.f18 ==> v12.f18) ==> f19;
						v13[3] := cf12;
						var v14 := DC15(v9);
						globalState.f4, cf15, v13[3], v12.f18 := !((seq(0x315, i1  => (p2))) < (v14.cf25 + v9)), v9[cf12], cf13 % cf13, cf14;
						var v15 := new C0();
					case DC10(cf14, cf15, cf16) =>
						...
						v18 := v18[cf14 := p1 + (seq(951, i3  => ('p')))];
						var v19: array<string> := new string[6];
						v19[262] := "su";
						v19[262] := p1 + ("yi" + "rffepbepm");
						globalState.f4 := fm2(v12.f17, globalState);
					case DC8(cf11) =>
						var v20: array<bool> := new bool[15];
						v20[286] := f19;
						v20[286], cf14 := v12.f17, v12.fm17((seq(22, i4  => (cf15))) + v9, |(if (cf14) then p1 else p1)|, globalState);
						var v21 := new C0();
						v20[286] := (if (!v20[286] in cf11) then cf11[!v20[286]] else v12.f18) ==> (if (v20[286]) then v20[286] else cf14);
						cf15 := p2;
					case DC11(cf17) =>
						r0 := v12.f18;
						...
						var v25: set<int> := {p2};
						var v26: array<int> := new int[24] [p2, cf15 / cf15, cf15, cf15, fm5(v12.f17, globalState), -p2, -268, cf15, if (v12.f17 in v10) then v10[v12.f17] else if (cf15 in v22) then v22[cf15] else p2, |v23|, cf15, cf15, p2, |cf16.fm6(seq(0x2f3, i5  => ('s')), globalState)|, -cf15, cf15, cf15 * cf15, cf15 - cf15, cf15, p2, p2, --0x121, cf15, |(v24.(cf27 := v25)).cf27| + 0x34a];
						...
						var v32: array<multiset<bool>> := new multiset<bool>[27] [v28, multiset{v12.f18, v12.f17}, v28, v28, v28, v28, v28, v29[cf15], multiset{v12.f18} - multiset(cf16.f14), v28, v28 * v28, v28, multiset{cf14, v12.f17}, v28 - multiset(cf16.f14), v28, (multiset(cf16.f14))[cf14 := cf15], v28, if (v12.f18 in v30) then v30[v12.f18] else multiset{v12.f18}, v28, v28, v28 + multiset{true, v12.fm17(v9, cf15, globalState)}, if (f19) then v28 else v28, multiset{v12.f18, false}, v28, v28, multiset{v31.cf20}, multiset(f14 + cf16.f14)];
						v32[313] := v28[v12.f17 := p2];
						v26[210], globalState.f4, cf15, v32[313], globalState.f4 := v26[210], true, -(0x10c + p2), v28 - v28, v12.f17;
						var v33 := 'u';
						v33 := v33;
				}
			...
			case DC8(cf11) =>
				if (f19) {
					...
					r0, v34[888], globalState.f4, v35 := f19, if (f19) then f19 else f19, if (p2 in v36) then v36[p2] else fm2(f19, globalState), DC13(f19, f19, -p2, 0x37e, !f19);
					var v37: map<int, int> := map[p2 := |{v34[888]}|];
					...
					globalState.f4 := f14[p2] && f19;
					var v41: map<bool, int> := map[DC16(f19).cf26 := |p1|];
					var v42: multiset<int> := multiset{|v41[f19 := p2]|, p2, p2};
					v42 := v42;
					var v43 := new C1(f19, f19, map[f19 := map[f19 := f19]], f14[p2 := !fm2(true, globalState)], f12);
					var v44 := 0xc7;
					v44 := p2;
					var v45: T4 := new C4();
					var v46: seq<T4> := [v45, v45, v45];
					var v47: map<bool, T4> := map[v43.f17 := if (!v43.f17) then v46[p2] else v45];
					v45 := if (f19 in v47) then v47[f19] else v45;
				}
				
				var v48: multiset<int> := multiset{-p2};
				var v49: seq<multiset<int>> := [v48, multiset(seq(865, i7  => (---|(f14[p2 := f19])[0x3c0 := f19]|)))];
				v49 := v49;
				var v50 := DC16(f19);
			...
			case DC11(cf17) =>
				...
				v53[477] := fm0(f19, if (f19) then fm62(355, globalState) else v55, f19, globalState);
				var v56: seq<int> := [-0x23a];
				var v57: set<seq<int>> := {fm1(f19, f19, globalState) + v56, [-0x1f3, v53[477], v53[477], p2, p2] + [v53[477], v53[477], v53[477]], v56};
				v57 := v57;
				var v58 := DC2(0x1c7, f19);
				var v59, v60, v61, v62 := m0(!f19, if (f19) then v58 else v58, true, globalState);
				v53[477], v62, v53[477] := v61, f19, v61;
		}
		...
		if ((multiset{fm0(!f19, v71, f19, globalState), p2, 899, |p1|} + v72) >= v72[p2 := p2]) {
			r0 := f19;
			...
			if (v73[161]) {
				...
				var v76: C1 := new C1(v73[161], v73[161], f13[f19 := v75], f14, f12);
				var v77: seq<C1> := [v76];
				var v78: map<int, int> := map[p2 := p2];
				var v79: set<C1> := {v77[|v78|]};
				...
				v73[161] := fm2(fm2(!v73[161], globalState), globalState);
				var v88 := 350;
				v88 := fm5(!f19, globalState);
				var v89 := new C3(true, f12, v73[161], f13, f14);
				globalState.f4 := !!f14[0x16];
				...
				globalState.f4, v91, v92[987], v94, v73 := f14[0x104], [v90, map[-p2 := v88], v90 + v90, v90, v90], v93, if (f19 || false) then multiset{multiset(v95), v72} else v94, v73;
			}
			...
			v101 := v101[if (!f19) then f14 else f14 := seq(139, i10  => (v68))];
			v98 := p2;
			...
			decreases 100 - i13
		{
			...
			if (if (f19) then f19 ==> false else true) {
				...
				v127[834] := v118;
				v72, v113, r0, v126[520], v127[834] := fm56('a', globalState), v113 / v113, if (v125.f17) then v125.f17 else !v125.f17, f19, p1;
				var v128: array<int> := new int[18];
				v128[877] := v113 % v113;
				var v129: set<array<bool>> := {v126};
				v128[877], globalState.f4 := v113, |(v129 + {v126})| <= (if (!f19) then v113 else 981);
				v126[520] := fm2(v125.f18, globalState);
			}
		...
		if (f19 ==> f19) {
			...
			match (v0.(cf41 := f19).(cf41 := f19)) {
				...
				case DC26(cf41) =>
					...
					var v8 := DC44(v7);
					globalState.f4, v5 := v7 !! v8.cf67, v5 / (v5 % 0x29);
				...
				case DC23(cf35) =>
					...
					v12[941] := if (f19) then f19 else f19;
					v12[941] := f19;
					var v13 := new C0();
					var v14 := -0x19d;
				...
				case DC27(cf42) =>
					...
					var v29: array<int> := new int[27] [|{v19}|, v19, v19, v19, v19, |v21|, 0x26a, if (!f19 in v22) then v22[!f19] else v19, 0x12f, v19, |v23|, 0x353, 0x246, v19, v19, v19, v19, |v24|, if (!f19 in v25) then v25[!f19] else |v26|, |v25[f19 := -(if (false in v22) then v22[false] else |v28|)]|, |v26|, v19, v19, 0x333, |v24|, v19, v19];
					var v30: set<array<int>> := {v29};
					v20[643] := if (f19) then v30 else v30;
					v20[643] := v30 + v30;
			}
			...
			var v39: seq<int> := [v32];
			var v40: map<bool, int> := map[f19 := v39[|[v34]|]];
			var v41: map<int, map<bool, int>> := map[|f14| := v40];
			var v42: map<int, bool> := map[v32 := f19];
			var v43 := DC21(v42, !f19, f19);
			var v44: set<int> := {v32, -v32};
			var v45: array<int> := new int[21] [v32, |v37|, v32, v32, fm0(if (f19 in v38) then v38[f19] else f19, v41, f19, globalState), v32, v32, v32, v32, v32, fm0(f19, v41, f19, globalState), if (|map[v43.cf32 := v34]| in v33) then v33[|map[v43.cf32 := v34]|] else v32, -v32, |v35|, v32, |v44|, v32, |f14|, v32, v32, |v39[-|v35| := |v39|]|];
			...
			v50[187] := v59.cf38;
			v50[187] := if (f19 && true) then v52 else v52;
		}
		...
		if (f19) {
			...
			match (if (v66 > v66) then v67 else fm63(v68, globalState)) {
				case DC1() =>
					...
					var v73: seq<string> := [v72[v68], v71, v72[-v68], v71];
					globalState.f4, v69, globalState.f4, v68, globalState.f4 := f19, f14[|v70| := f19], v69[v68], |v72[v68]|, if (v68 > |[f19]|) then f19 else f19;
					var v74: set<int> := {v68};
				...
				case DC2(cf1, cf2) =>
					...
					var v81: map<int, seq<int>> := map[if (f19 in v80) then v80[f19] else v68 := seq(481, i5  => (|(seq(-747, i6  => ('v')))|))];
					v79[263] := v81;
					v79[263] := v81 + v81;
					cf2 := cf2;
					var v82 := "veo";
				...
				case DC0(cf0) =>
					...
					var v104 := DC31();
					var v105: C1 := new C1(f19, v98[67], f13, f14, v96.f12);
					var v106: map<C1, bool> := map[v105 := v105.f17];
					var v107: C2 := new C2([v68, v68], if (v105 in v106) then v106[v105] else v105.f18, f13, f14[|v89| := v105.f17], v96.f12);
					...
					v102[454] := v110;
					var v111 := 'd';
					v91, v98[67], r0, v68, v102[454] := v91[619 % v68 := v111], f14[v107.fm38(-v68, v68, v68, f19, globalState)], if (v105.f17) then v105.f18 || v105.f18 else v105.f17 && false, v68 * 0x2aa, v110;
			}
			...
			var v115: array<int> := new int[21](i8 => i8 / v68);
			var v116: multiset<int> := multiset{v68, v68};
			var v117: seq<int> := [|v116|];
			v115[25] := if (v68 in v116) then v116[v68] else |v117|;
			...
			v68, v115[25], v118[743], v115[754] := v68, if (true) then v68 else |v121|, fm2(!true, globalState), v126.cf56;
			v68 := if (f19) then v68 else v115[25];
		}
...
class C6 extends T3, T4 {
	...
	function fm7(p0: int, globalState: GlobalState): int {
		-|("h" + "qi")| / (|map[!f15 := multiset{f15, f15}]| % -0x231)
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): int {
		(|(seq(354, i0  => ('d')))| + |f14|) + (DC2(-0xb6, false).cf1 * -0x129)
	}
	function fm6(p0: string, globalState: GlobalState): seq<int> {
		match DC2(--|(seq(0x199, i0  => ('j')))|, f15) {
			case DC1() => f16
			case DC2(cf1, cf2) => f16
			case DC0(cf0) => [-|multiset(f14)|] + f16[|map[cf0 := |map[f15 := f15]|]| := 17]
		}
	}
	function fm5(p0: bool, globalState: GlobalState): int {
		0x3a4
	...
	function fm10(p0: bool, p1: set<int>, p2: seq<int>, p3: int, globalState: GlobalState): set<int> {
		{-|map[DC2(|"l"|, f15) := -|(seq(0x11f, i0  => ('m')))|]|} + ({832} + {254, -0x354})
	}
	...
	method m4(p0: int, p1: int, p2: string, p3: multiset<int>, globalState: GlobalState) returns (r0: int) {
		...
		if (fm13(p1, globalState) == v0) {
			var v5: map<string, string> := map[seq(0x15d, i0  => ('c')) := p2];
			...
			v7[890] := !(p2 !in (if (false in v9) then v9[false] else v8));
			v7[890] := f15;
			r0 := -(0x1dc % (p1 * p1));
			var v10 := DC6(v7, v7);
			var v11: map<D2, int> := map[v10 := |(v4 + v4)|];
			v11 := v11[v10.(cf8 := v7) := p0 % p0];
		} else {
			globalState.f4 := f15;
			var v12 := new C0();
			r0 := p1;
		...
		if (f15) {
			...
			v17 := v17[p1 := p2 + p2];
			var v18 := 'q';
			var v19: seq<string> := [p2 + p2[p1 := v18], p2, p2 + (seq(371, i2  => (v18))), fm11(globalState)];
			...
			match (fm16(fm2(false, globalState), globalState)) {
				case DC5(cf5, cf6, cf7) =>
					...
					r0, cf5, v21[513], cf5, globalState.f4 := 0x157, if (cf5 in v23) then v23[cf5] else p0, v4, p1, f15;
					r0 := -p1;
				...
				case DC6(cf8, cf9) =>
					...
					var v32: map<int, array<bool>> := map[89 / |v31| := cf8];
				...
				case DC7(cf10) =>
					...
					v44[351] := fm19({f15, f15}, f15, 'l', p1, globalState);
					var v45 := DC0(f15);
					v44[351] := v45;
			}
			...
			v48[205] := !((seq(0x33, i5  => ('d'))) < (if (v49 in v50) then v50[v49] else fm11(globalState)));
			...
			var v54 := DC45(v47);
			globalState.f4, r0, v47, v48[205], v51 := v51.f17, p0 / (p0 % |v53|), v54.cf68, false, v51;
	...
	method m3(globalState: GlobalState) returns (r0: bool, r1: int, r2: set<seq<bool>>, r3: bool) {
		var v0 := "bxffsdmo";
		var v1 := 30;
		for i0 := |v0| % fm7(v1, globalState) to fm5(f15, globalState) {
			...
			match (v7.(cf8 := v6)) {
				...
				case DC6(cf8, cf9) =>
					...
					cf8[184] := f15;
				case DC4(cf4) =>
					var v12: array<int> := new int[9](i1 => i1 / -v1);
					var v13 := DC35(f15);
					...
					v15[163] := v18[v1];
					v12, v13, v14[708], globalState.f4, v15[163] := v12, v13, v6, !f15, multiset{v16, v16, v16, v16};
					r0 := (f15 ==> f15) || f15;
					var v19 := DC2(v1, f15);
		...
		globalState.f4 := (fm5(f15, globalState) % 0x5a) != (v1 / v1);
		...
		var i4 := 0;
		while (-v1 <= (-(if (v1 in v37) then v37[v1] else |v39|) / |v0|))
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			r1, v46, v47, r0 := v1, v46, (if (f15) then v47 else if (fm8(f15, f15, globalState) in v48) then v48[fm8(f15, f15, globalState)] else v47)[f15 := -|v0|], f15;
		}
		var i5 := 0;
		while (true)
			decreases 100 - i5
		{
			...
			var v49: array<int> := new int[17](i6 => i6 % v1);
			v49[341] := v1;
			v49[341] := v1;
	...
	method m6(globalState: GlobalState) returns (r0: bool) {
		...
		var v3: map<bool, bool> := map[f14[|v2[v0 := v1]|] := f15];
		for i0 := v0 to |v3| {
			var v4 := new C1(DC16(f15).cf26, f15, f13 + f13, ([fm2(!f15, globalState)])[-i0 := f15], f12);
			...
			if (f15 <== !false) {
				...
				var v29: seq<bool> := [v4.f18 && true, !false, -|(seq(0x102, i1  => ('y')))| >= (if (852 in v28) then v28[852] else v0)];
				...
				var v34 := DC14(v4.f18);
				var v35: map<bool, string> := map[true := fm40(v34, v30[236], v4.f18, f15, globalState)];
				var v36: array<string> := new string[22] [v24 + v24, v24, v24, "snwcxjku", "fhlw", v33.cf59, v24, v24, v24 + v24, (seq(-67, i3  => ('n'))) + v24, v24, v24, if (v4.f18 in v35) then v35[v4.f18] else "bn", seq(438, i4  => ('x')), v24 + "xykacskdp", v24, (seq(0x47, i5  => ('i'))) + v24, v24, "ftpjtp", v24, v24 + v24, v24];
				v36[792] := "htrpkjrkt" + v24;
				var v37: set<bool> := {f15};
				v4.f18, v24, v32[259], v36[792], v4.f18 := ({!f15} - v37) < {f15}, v24, v31, v24, v4.f18;
			}
		...
		v1[209] := !(map[f15 := v39] != v40);
		var v41 := "jimfygn";
		var v42: seq<string> := [v41, v41, v41, "twglwr"];
		var v43: map<bool, seq<string>> := map[f15 := v42];
		v1[209] := |([seq(0x3a3, i7  => ('f')), v41] + (if (f15 in v43) then v43[f15] else seq(86, i8  => (v41))))| <= v0;
		...
		if (f15) {
			if (f15) {
				v39 := v39;
				var v49: seq<bool> := [!v1[209], v3 != v3, v1[209]];
				var v50: array<map<bool, bool>> := new map<bool, bool>[7](i9 => map[v1[209] := f15]);
				var v51 := DC50(v50);
				var v52: seq<array<map<bool, bool>>> := [v50, v50];
				var v53 := DC37(seq(0x224, i10  => (v39)), f15);
				var v54: array<array<map<bool, bool>>> := new array<map<bool, bool>>[26] [v50, if (v1[209]) then v50 else v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, (v51.(cf74 := v50)).cf74, v50, v50, v50, v52[|v53.cf59|], v50, v50];
				v54[935] := v50;
				var v55: multiset<bool> := multiset{f15};
				var v56: multiset<int> := multiset{|v55|};
				var v57: map<multiset<int>, char> := map[v56 := v39];
				v49, v54[935], v0, v57 := if (!(v0 != |v41|)) then f14 + v49 else f14, v50, |v41| - |(seq(419, i11  => (DC13(v1[209], f15, v0, v0, false).cf21)))|, v57;
				var v58: multiset<string> := multiset{v41, v41};
				v0 := |(if (v1[209]) then v58 * v58 else multiset(v42) - multiset{v41})|;
				var v59 := new C4();
			...
			if (f15) {
				var v64 := DC5(v0, v1[209], v1[209]);
				var v65: array<D2> := new D2[2] [DC5(0x38e, !f15, fm2(f15, globalState)).(cf6 := f15, cf5 := if (v1[209] in v46) then v46[v1[209]] else -254), v64];
				v65[661] := v64;
				v65[661] := v64;
				var v66: array<string> := new string[18](i12 => v41);
				v66[236] := v41[v0 := v39];
				v66[236] := (v41 + v41) + (v41 + v41);
				v0 := -v0;
				v41 := v66[236];
				globalState.f4, globalState.f4, v1[209] := v1[209], !true, f15 <== fm2(v1[209], globalState);
			} else {
				globalState.f4, v0, v0, v42 := f15, v0, v0 + v0, v42[fm8(!f15, v1[209], globalState) := v41];
				...
				v72, v74, v1[209], v1[209], v0 := v72[-v0 := |multiset(f16[|v46| := v0])|], DC4([f14, f14] + v73), v75 != (v75 + v75), v1[209], if (f15) then if (f15) then v0 else 454 else fm8(!!v1[209], fm2(true, globalState), globalState);
			}
			
			var v76: array<array<int>> := new array<int>[5];
			var v77 := DC28(v76);
			var v78: array<D9> := new D9[29] [v77.(cf43 := v76), if (v1[209]) then v77 else v77, v77, v77, v77, v77, v77, v77, DC28(v76), DC28(v76), v77, v77, v77, v77, v77, v77, v77.(cf43 := v76), v77.(cf43 := v76), v77, v77, v77, v77.(cf43 := v76), v77.(cf43 := v76), v77, if (v1[209]) then v77.(cf43 := v76) else DC28(v76), v77, v77, v77.(cf43 := v76), v77];
			v78[899] := v77;
			v78[899] := v77.(cf43 := v76).(cf43 := v76);
			if (f15) {
				v46 := v46[v0 <= -(if (f15 in v46) then v46[f15] else 0x174) := |v41[v0 := 'n']| % v0];
				var v79: set<bool> := {v1[209], f15};
				var v80: T1 := new C1(v1[209], f15, f13, f14, f12);
				var v81 := DC10(v1[209], |v79|, v80);
				var v82 := DC11(v81);
				...
				v0, v87, r0 := -(v0 - v0) / (734 + -|v88|), v87, f15;
				v41 := v41;
			} else {
				...
				v0 := (|v41| * (if (map[v89 := v3] in v92) then v92[map[v89 := v3]] else v0)) % v0;
				var v93: set<int> := {v0, 450};
				var v94: map<set<int>, bool> := map[v93 := f15];
				v94 := v94[v93 := v1[209]];
				globalState.f4 := f15;
				var v95 := new C2(([v0])[v0 := v0], !v1[209], f13, f14, v89.f12);
			}
			
			v41 := v41 + ((seq(0x36f, i13  => (v39))) + v41);
		} else {
			globalState.f4 := f15;
			var v96: map<string, bool> := map[v41 := f15];
			var v97 := DC37(v41, f15);
			v1[209] := if (v41 in v96) then v96[v41] else v97.cf60;
			if (!f15) {
				var v98: array<int> := new int[2];
				var v99: C1 := new C1(v1[209], v1[209], f13, f14, f12);
				var v100 := DC33(f15, v0, v1[209], v99, v99.f17);
				v98[879] := v0 * -v100.cf49;
				var v101 := DC46(f13);
				var v102: C2 := new C2(f16, v99.f18, v101.cf69, f14, f12);
				var v103: set<int> := {v0};
				v0, v98[879], v102, v99.f18 := |({v0} * v103)|, if (v99.f18) then v0 else 620 * v0, v102, !(58 != --v0);
				var v104 := DC0(!false);
				var v105 := DC13(v104.cf0, !v1[209], 0x207, fm5(v99.f18, globalState), v99.f17);
				...
				var v110: multiset<bool> := multiset{f15, false, v1[209], v99.f18, v99.f17};
				var v111: array<multiset<bool>> := new multiset<bool>[2] [multiset{v99.f18}, v110];
				v109[323] := v111;
				v109[323] := v111;
			} else {
				var v112: array<D14> := new D14[2];
				var v113: T2 := new C3(v1[209], f12, !v1[209], f13, f14);
				var v114 := DC40(v113);
				v112[463] := v114;
				v112[463], v41, v39, v0 := v114, v41, v39, -v0;
				v0 := f16[|(v41 + v41)|];
				v39 := v39;
				globalState.f4 := v0 > v0;
				var v115: array<int> := new int[19](i14 => i14 - v0);
				v115[336] := v0 / v0;
				var v116: multiset<bool> := multiset{v1[209]};
				var v117: multiset<int> := multiset{v0};
				globalState.f4, v115[336], v0, v3 := v116 >= fm20(f15, v0, globalState), v0, |v113.f14|, fm59(v117, v1[209], fm2(v113.f15, globalState), |(multiset([v0, v0, v0, 841]) + v117)|, globalState);
			}
			
			var v118: C3 := new C3(f15, f12, !v1[209], map[f15 := v3], fm15(v1[209], v0, v0, 0x1d2, globalState));
			var v119: map<C3, int> := map[v118 := v0];
			var v120: C2 := new C2(f16, v119 != v119, map[v1[209] := v3], f14, f12);
			v120 := v120;
			v1[209] := f15;
		}
		
		for i15 := fm5(f15, globalState) % v0 to |(v3 + v3)| {
			var v121: array<multiset<seq<int>>> := new multiset<seq<int>>[13](i16 => multiset{f16, f16, f16} + multiset{f16, f16, seq(0x192, i17  => (i15))});
			v121[801] := multiset{f16[fm7(-f16[v0], globalState) := v0], f16};
			var v122: seq<seq<int>> := [f16, f16];
			var v123: multiset<seq<int>> := multiset{seq(-238, i18  => (i15)), (v122[-v0])[i15 := i15]};
			var v124: map<bool, multiset<seq<int>>> := map[v1[209] := v123];
			var v125: map<bool, multiset<seq<int>>> := map[v1[209] := if (true in v124) then v124[true] else v123];
			v121[801] := v123 - (if (false in v124) then v124[false] else v123);
			var v126: array<string> := new seq<char>[14](i19 => seq(0x177, i20  => (v39)));
			v126[248] := fm40(DC14(f15).(cf24 := f15), |v48|, f15, v1[209], globalState);
			v126[248] := (seq(0x31, i21  => (v39))) + v41;
			var v127: array<int> := new int[5] [i15, i15, i15, i15, v0];
			var v128: seq<array<int>> := [v127, v127];
			v128 := [v127];
			globalState.f4 := f15;
		}
		r0 := (v0 < v0) <== (v1[209] <==> v1[209]);
	}
}
...
class C7 {
	...
	method m1(p0: char, p1: seq<int>, globalState: GlobalState) returns (r0: D0, r1: map<bool, bool>, r2: bool) {
		...
		if (v0) {
			var v1 := "hlnnql";
			var v2 := -0x3d6;
			var v4 := DC2(|v1| % v2, DC2(|(map v3 : int | (0x25b <= v3) && (v3 < 0x72) :: (v3 + |multiset{v0, v0}|) := (v0))|, v0).cf2);
			match (v4) {
				case DC1() =>
					var v5: map<bool, int> := map[v0 := p1[v2]];
				...
				case DC2(cf1, cf2) =>
					...
					v11[677] := if (v4 in v12) then v12[v4] else 863;
					var v13: array<D0> := new D0[1] [DC2(--cf1, v0)];
					v13[496] := DC2(-0x101, v0);
					var v14: map<char, int> := map[p0 := v2];
					var v15: map<bool, int> := map[!cf2 := if (p0 in v14) then v14[p0] else v11[677]];
					var v16: seq<map<bool, int>> := [v15, v15, v15, v15];
					v13[496] := fm3(v16, globalState);
					v1 := seq(0x1f8, i0  => (p0));
					cf1 := v11[677];
				case DC0(cf0) =>
					v2 := v2;
					...
					var v20 := DC0(cf0);
					var v21: seq<D0> := [v20];
					var v22: array<int> := new int[21] [|map[v17 := |[v0, false, v0, v0, cf0]|]|, v2, |multiset{v0}| + v2, v2, v2, v2, |(v1 + (seq(0x204, i1  => (p0)))[v2 := p0])|, -v2 * v2, v2, v2, v2, 0x2a8 % |map[v0 := v18]|, v2, 0x22b, |multiset(v19)|, -0x35f, |[true, true]|, -v2 * |v1|, |v21[v2 := fm4(p0, -0x28c, globalState)]|, v2, v2];
					v22[593] := v2;
					v22[593] := if (v0) then v2 else v2;
					var v23: map<bool, bool> := map[cf0 := cf0];
					var v24: map<bool, map<bool, bool>> := map[true := v23];
					var v25: multiset<int> := multiset{v22[593]};
					var v26: map<bool, multiset<int>> := map[cf0 := v25];
					var v27: array<multiset<int>> := new multiset<int>[26] [v25, v25, v25, v25, v25, v25, v25, v25, multiset{|v23|, v22[593]}, v25, v25, if (!cf0 in v26) then v26[!cf0] else fm28(v1, v0, v2, globalState), v25, v25, v25, v25, multiset(p1), v25[v22[593] := v22[593]], v25, v25, v25, v25, multiset{v22[593], v2, v22[593], v22[593]}, v25, multiset{v22[593]}, v25];
					var v28 := new C6(p1, !cf0, v24 + v24, [v0, v19[v22[593]], true, v0], v27);
			}
			...
			v2, v2, globalState.f4, globalState.f4, globalState.f4 := v2, 0x74 % |(v31 + v31)|, v0, false <==> (if (v2 in v32) then v32[v2] else v0), (v2 * v2) == v2;
		} else {
			var v33 := -0x65;
			...
			var v48: seq<C1> := [v47];
			var v49 := DC33(v0, -|v46|, v0, v48[v33], v47.f17);
			var v50: array<int> := new int[25] [|v34| * v33, |fm20(v0, v33, globalState)|, |v35|, v33, 0x3c4, v33, --v33, v33 * |v40|, 732, v33, v33, v33 + v33, v33, v33, v33, |v41[|v43|]|, v33, p1[v33], if (v0) then v33 else -v33, v33, |(if (v0) then v45 else map[v33 := v44])|, v33, v44.fm7(-v33, globalState), v33 % v33, v49.cf49];
			v42[479] := v33;
			v42[479] := v33;
			var v51: C0 := new C0();
			var v52 := DC45(v51);
			...
			v54 := v54;
			if (!(p1 <= p1)) {
				var v55: map<int, int> := map[v42[479] := v33];
				v55 := map[v42[479] := p1[v42[479]]];
				v47.f18 := v47.f18;
		...
		if (false) {
			var v71 := -0x81;
			var v72: set<bool> := {v70.f20, v70.f20, v69[v71], v70.f20};
			...
			if (v70.f20) {
				...
				v71 := if (v0) then v71 % |multiset{v70.f20, if (v71 in v73) then v73[v71] else v70.f20}| else |(if (v70 in v76) then v76[v70] else v73)| / v71;
				var v77 := 'n';
				...
				v71, v71, v77, v71, v79 := if (v71 in v79) then v79[v71] else -|v75| % v71, v71, 's', v71, v80[v71 % v71];
			} else {
				var v81 := "yhmrbo";
				...
				globalState.f4, v90[267], v93, v89, r2 := v71 == v71, -v71, v93, fm66(globalState), false;
				v90[267] := v71;
				var v94 := DC11(DC9(v90[267], 0x12));
				var v95: map<set<bool>, D3> := map[fm13(v71, globalState) := v94];
				var v96 := DC25(v0, v71, v71, map[!v0 := v90[267]]);
			...
			var v100: multiset<map<int, int>> := multiset{map v99 : int | (430 <= v99) && (v99 < -0x253) :: (v99 / v71) := (v71)};
			var v102 := "bcsn";
			var v103: map<int, multiset<map<int, int>>> := map[if (v0) then v71 else v71 := v100[map v101 : int | (0x1ae <= v101) && (v101 < 674) :: (v101 / -v71) := (0x377) := |v102|]];
			...
			v108[187] := v107;
			v108[187] := fm67(v105, -v105, v105, globalState);
			var v109: map<int, map<bool, int>> := map[-v105 := map[v0 := v105]];
			v105 := fm0(v70.f20, v109, v70.f20, globalState) % v105;
			if (fm2(v0, globalState)) {
				var v110: set<bool> := {true};
				var v111: multiset<int> := multiset{p1[v105]};
				...
				v112[274], v117[919] := v105 < ((if (v70.f20 in v118) then v118[v70.f20] else v105) * v120.cf65), p0;
				var v121: C0 := new C0();
				var v122 := DC45(v121);
				var v123: map<D16, seq<int>> := map[v122 := p1[v105 := v105]];
				var v124: seq<seq<int>> := [p1, p1];
				var v125 := DC15(p1);
				var v126: map<bool, seq<int>> := map[fm2(v0, globalState) := p1];
				var v127: array<seq<int>> := new seq<int>[26] [[v105], p1, p1[|multiset{v70.f20}| := v105], if (v115.f19) then [v105, v105] else p1, p1, [v105], p1, p1[v105 := v105] + fm1(v70.f20, v70.f20, globalState), p1[v105 := v105], if (v122 in v123) then v123[v122] else v124[v105], p1, p1 + p1, seq(672, i6  => (875)), p1, [v105, v105, if (v115.f19 in v118) then v118[v115.f19] else v105, v105, v105], p1, p1, seq(0x39c, i7  => (v105)), fm1(v112[274], !v70.f20, globalState), p1, p1, p1, v125.cf25, p1, v115.fm6("morqadjvx", globalState), if (fm2(v70.f20, globalState) in v126) then v126[fm2(v70.f20, globalState)] else [|v106|]];
				v127[948] := p1 + p1;
				var v128: map<int, int> := map[v105 := |v110|];
				v127[948] := [v105, |v119[v105 := p0]|, |v128|] + (p1 + p1);
			} else {
				...
				v139 := new C5(v134 >= v134, v139.f12, v139.f13, v69 + fm15(v70.f20, p1[v134], v105, v105, globalState));
			}
			
			var v140 := new C6(p1 + (seq(523, i8  => (|"fvbnjdfav"|))), false, v68 + v68, v69, v66);
			if (!v0) {
				var v141 := DC9(v105, |(seq(0x2c4, i9  => ('g')))|);
				var v142: C0 := new C0();
				...
				v158[160] := new bool[7] [if (v70.f20) then v70.f20 else v70.f20, v105 == v105, if ('o' in v160) then v160['o'] else v70.f20, v70.f20, v162.cf32, !(if (v140.fm7(v105, globalState) in v161) then v161[v140.fm7(v105, globalState)] else v70.f20), v70.f20];
			}
		...
		if (v0) {
			...
			var v179 := DC32(v173 % v173, v163 % 0x39a);
			v179 := DC32(v173, v174);
		} else {
			v163 := v163;
			...
			var v186: seq<seq<int>> := [[-0x2e5, v163], p1, [|v182|], p1, (seq(296, i12  => (|multiset([v70.f20])|)))[v163 := |p1|]];
			v163, v163, v0, v185 := v163 / -(v163 / |v186|), v163, !!v70.f20, v185 * v185;
			var v187 := v184.m4(v163, v163 * p1[v163], v182, fm56(p0, globalState), globalState);
			v163 := --v187;
		}
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: int, r2: D0) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := "cbrqflr" != ((seq(0x276, i2  => ('w'))) + "m");
		}
		var v1 := false;
			...
			decreases 100 - i5
		{
			...
			if (v1) {
				...
				globalState.f4, v10[359], v4 := !(v12 < v12), v11, v4;
			} else {
				...
				v3[176] := if (false in v13) then v13[false] else |v16|;
		...
		var v32 := new C2(v24 + (seq(-379, i7  => (p0))), v1, v25, v26[p0 := false], v31);
...
method Main() {
	...
	for i0 := v3 to fm0(v1, map v5 : int | (0x1e1 <= v5) && (v5 < -0x29b) :: (v5 + |[v1]|) := (map[v1 := v3]), v1, globalState) {
		...
		if (v1) {
			...
			v23[770] := if (v18) then v2 else v2;
			v18, v11, v22, v23[770] := !fm2(v20, globalState) <== v20, DC2(|v10|, v18), v22, if (v1) then multiset{v20, false, v1} else if (v18) then multiset{true, v1} else v2;
	...
	for i2 := v3 to v3 {
		...
		v1 := if (v1) then false else !(if (v36.f20 in v34) then v34[v36.f20] else v28[i2]);
	...
	for i4 := |v40| to v3 {
		...
		if (v1) {
			...
			globalState.f4 := if (v43[0xe9]) then v1 else v1;
			globalState.f4 := v1;
			var v44 := "nwe";
			var v45 := 'n';
			...
			var v51: seq<C6> := [v50];
			var v52: map<int, char> := map[|v44[v3 := v45]| * |v51| := v45];
			v52 := v52[v3 := v45];
			var v53: map<int, string> := map[i4 := v44];
			var v54 := v50.m5(v40, v44 + (if (0x2f9 in v53) then v53[0x2f9] else v44), -(0x2ce / |v44|), globalState);
			...
			v58, v0[680], v3, v0[296] := v59[|(if (v1) then v60 else v60)|], fm0(true, v61, if (if (i4 in v60) then v60[i4] else v1) then true else v1, globalState), i4 - (v3 % -|fm68(v1, globalState)|), i4 - v3;
			globalState.f4 := v1;
			...
			var v75: map<int, array<bool>> := map[|(map[v3 := v74])[v0[680] := v74]| := v42];
			var v76: map<T1, array<bool>> := map[v73 := if (-i4 in v75) then v75[-i4] else v41[552]];
			var v77: map<bool, T1> := map[v1 := v73];
			v76 := v76[if (v74.f19 in v77) then v77[v74.f19] else v73 := v41[552]];
		}
	...
	if (v1) {
		...
		var v91 := DC13(v1, v1, v3, v3, v88[|v90|]);
		var v92 := "b";
		var v93 := DC14(v1);
		var v94 := DC37("de", v1);
		var v95: multiset<string> := multiset{fm29(v91.cf23, v1, v1, |v92|, globalState), (v92 + fm40(v93, v3, v1, !v1, globalState))[-v3 := fm39(-0x152, v1, v3, v94.cf59, globalState)]};
		v0[947], v0[14], v3, v3 := v3, if (v92 in v95) then v95[v92] else v3, |v2| % (v3 + |v88|), 0x189 % |(v88 + v88)|;
		...
		var v101 := new C6(([v3, -v3])[fm0(true, map[v3 := v96], v1, globalState) := |v92|], v1, v98 + map[v1 := v97], fm15(v1, v3, |v92|, -0xfe, globalState), if (v0[947] in v100) then v100[v0[947]] else v99);
		var v102: seq<int> := [v3];
		v102 := v102;
		v86 := v86;
		var v103: multiset<int> := multiset{0xed, v3};
		var v104 := v101.m4(v3, 0x252 + v3, v92, v103[-v0[947] := |v4|] * v103, globalState);
	} else {
		...
		v3 := (|v106| / |v108.cf30|) % v109.cf47;
		var v110: array<char> := new char[19];
		var v111 := 'g';
		v110[673] := v111;
		v110[673] := if (v1) then v111 else v111;
		var v112: C7 := new C7();
		...
		decreases 100 - i9
	{
		...
		var v135: C2 := new C2(seq(485, i11  => (v3)), v128.f19, v134, v132, v127);
		...
		v138[338] := v135;
		v132, v138[338], v3, globalState.f4, v132 := (v132 + v132) + (v132 + v132), v135, 0x132, !true, v132;
	}
	...
	for i12 := |v141| to |v143[--v3]| {
		...
		var v148: C7 := new C7();
		v147[213] := v148;
		v147[213] := if (v1 <==> !v1) then v148 else v148;
		if (v1) {
			...
			var v167: array<D20> := new D20[15](i14 => if (false) then DC54('e', map[i12 := v1], map[true := seq(0x37f, i15  => ('x'))], -0x1d8) else DC54('g', map v166 : int | v166 in v4 :: (v166 * |[false]|) := (v1), map[v1 := v141], v3));
			var v168: multiset<int> := multiset{i12, i12};
			v167[915] := fm69(141, if (i12 in v168) then v168[i12] else v3, v3, globalState);
			...
			var v176: seq<seq<int>> := [seq(0x382, i17  => (i12)), v175, v175, v175, v175];
			var v177: map<int, multiset<int>> := map[0x304 := v168];
			var v178: array<multiset<int>> := new multiset<int>[15];
			var v179: T4 := new C6(v175 + v176[v3], v1 && v1, map[true := fm59(if (i12 in v177) then v177[i12] else v168, v1, v1, v3, globalState)], [v1], v178);
			v0[903] := 0x3d9;
			v1, v174, v179, v0[903], v141 := !v1, v174, v179, i12, v141;
	...
	match (v191.(cf63 := v190)) {
		case DC41(cf64, cf65) =>
			if (v190.f15) {
				...
				v200[430] := fm2(false, globalState);
				var v201: array<char> := new char[15](i20 => 'n');
				var v202: seq<array<char>> := [v201];
				var v203 := DC69(v202);
				v1, cf65, globalState.f4, v200[430], globalState.f4 := v190.f15, -cf65, v190.f15, v190.f15, (v202 + v202[cf65 := v201]) < v203.cf105;
				var v204: C4 := new C4();
				var v205: array<C4> := new C4[6] [v204, v204, v204, v204, v204, v204];
				var v206: map<bool, C4> := map[fm2(v190.f15, globalState) := v204];
				v205[324] := if (v200[430] in v206) then v206[v200[430]] else v204;
				v205[324] := v204;
				v3 := ((if (v190.f15 in v2) then v2[v190.f15] else v190.fm5(false, globalState)) * |v141|) / v3;
				cf65 := cf65;
				v3 := cf65 / v3;
			}
		...
		case DC42() =>
			...
			match (v222) {
				case DC24(cf36) =>
					v0[226] := v190.fm5(v190.f15, globalState);
					v0[226] := -v3;
					var v223: array<bool> := new bool[25];
					v223[139] := v218 == v218;
					var v224: map<int, bool> := map[v3 := v190.f15];
					v223[139] := fm2(v190.f15, globalState) <==> (|v224| == v0[226]);
					v218 := |v141|;
					var v225 := 'm';
					var v226: multiset<int> := multiset{v0[226]};
					v0[226] := |(map[v225 := v190.f15] + map[v225 := v190.f15])| + (v3 + |v226|);
				case DC25(cf37, cf38, cf39, cf40) =>
					globalState.f4 := !false;
				...
				case DC23(cf35) =>
					...
					var v241, v242, v243, v244 := m0(v1, DC2(v238, v236), v190.f14[v235], globalState);
				case DC27(cf42) =>
					globalState.f4 := v190.f15;
					v189 := v190.f14;
					v0[553] := v218 / |v40|;
					...
					v245[359] := |v4| == v3;
					v139, v217, v0[553], v245[359] := if (v190.f15) then v139 else (map[v1 := v218])[v190.f15 := v3] + map[v190.f15 := 969], !v1, v218, !v1;
					v1 := v190.f15;
			}
		...
		case DC40(cf63) =>
			...
			var v248: map<array<string>, int> := map[v247[v3] := -(if (v3 in v4) then v4[v3] else cf63.fm5(v190.f15, globalState))];
		...
		case DC43(cf66) =>
			...
			v254 := v254 + (v254 + ([|map[v190.f15 := v1]|, v3, v3])[|v141| := v3]);
			var v255 := DC37(v141, v190.f15);
			var v256: map<int, string> := map[v3 := v141];
			v1 := (v255.cf59 + (if (v254[v3] in v256) then v256[v254[v3]] else seq(503, i22  => ('q')))) == v141;
			var v257 := new C0();
			var v258 := DC56(v190);
			match (v258) {
				case DC56(cf85) =>
					...
					var v267: array<seq<map<int, int>>> := new seq<map<int, int>>[7] [seq(0x18b, i23  => (map v263 : int | (-0x286 <= v263) && (v263 < 0x2bd) :: (v263 + 0x32e) := (|v254|))), v265, v265 + v265, v265, v265 + [v4], (seq(168, i24  => (map[v3 := v3]))) + [map[v266.cf46 := -v3], v265[-v260], v4], v265];
					v267[119] := seq(0x180, i25  => (v4));
					v267[119] := v265;
				...
				case DC57(cf86, cf87, cf88) =>
					var v273: C7 := new C7();
					v273 := new C7();
					v1 := !!((if (true in v2) then v2[true] else -v3) <= (v3 / -0x3da));
					var v274: set<int> := {v3};
				...
				case DC58(cf89, cf90) =>
					...
					cf89, globalState.f4, cf90, v281[651] := v282[cf90 := cf90] >= multiset{cf90}, !false, -(cf90 * v3), (v141 + fm21(v1, globalState)) + v141;
					var v283: map<int, bool> := map[cf90 := v190.f15];
					var v284 := DC3(v2);
					var v285: seq<D1> := [v284];
					var v286 := 'n';
					var v287, v288 := v257.m7(v3 % |v283|, v285, v3, v286, globalState);
					var v289: seq<string> := [v281[651], v281[651], v141, v281[651]];
					globalState.f4 := v289 <= v289[0x2d2 := v281[651]];
				case DC55(cf84) =>
	...
	if (v1) {
		...
		var v303: map<int, array<string>> := map[v0[330] := if (v0[330] in v302) then v302[v0[330]] else v298];
		var v304: array<array<string>> := new array<string>[22] [v298, v298, v299[|v141|], v298, v298, v298, v298, v298, v298, v298, v298, v298, v298, v298, v298, if (v300 in v301) then v301[v300] else if (v3 in v302) then v302[v3] else v298, v298, v298, v298, v298, v298, v298];
		v304[233] := v298;
		v304[233] := v298;
		v1 := |v141| > v0[330];
		var v305: array<bool> := new bool[24];
		v305[378] := fm2(v1, globalState);
		v305[378] := v190.f15;
		var v306: array<char> := new char[21](i32 => v300);
		var v307: seq<array<char>> := [v306, v306, v306];
		var v308 := DC52(v307[-v3]);
		var v309: map<int, D20> := map[v0[330] := v308];
		...
		v0[330], v310, v3 := |(((if (v3 in v314) then v314[v3] else map[v312 := v190.fm8(v190.f15, v190.f15, globalState)]) + v313) + v313)|, v310, v190.fm8(v190.f15, !(if (v305[378]) then v190.f15 else v190.f15), globalState);
	} else {
		var v315, v316, v317, v318 := v190.m3(globalState);
		var v319: seq<int> := [v3, v3];
		var v320 := new C2(v319, v190.f15, v190.f13, v190.f14[|v141| := !v190.f15], v190.f12);
		var v321 := v320.m6(globalState);
		var v322, v323, v324, v325 := v190.m3(globalState);
		var v326 := 'd';
		var v327: array<char> := new char[2] [v141[v316], v326];
		...
		decreases 100 - i33
	{
		...
		i33 := i33 + 1;
		globalState.f4 := v189[v3];
		if (true) {
			var v331: map<bool, array<int>> := map[v190.f15 := v0];
			v3, globalState.f4, globalState.f4, v1 := |v142|, (v1 || v190.f15) <== v190.f14[|v331|], |"v"| < 0x17, v1;
			var v332: map<array<int>, bool> := map[v142[0x42] := false];
			...
			var v349 := new C6(v346, fm70(v190.f15, v141, v3, v190.f15, globalState) != (set v348 : int | v348 in v347 :: (v348 / 0x16)), v190.f13 + v190.f13, [v190.f15, v190.f15], v187);
		}
		
		v3 := v3;
		var v350: array<bool> := new bool[21];
		var v351: seq<array<bool>> := [v350];
		var v352: map<array<bool>, bool> := map[v351[0x3c6] := v190.f15];
		...
		decreases 100 - i34
	{
		...
		if (!true) {
			...
			v3 := v3 + (0x1b6 * v3);
			var v388: C6 := new C6(seq(0x161, i36  => (DC53(v139, v3, v3).cf79)), v190.f15, v190.f13, v190.f14, v190.f12);
			var v389: map<C6, bool> := map[v388 := v190.f15];
			var v390: seq<int> := [v3, |v389|];
			var v391: set<int> := {v3, v3 % |v390|};
			v391 := v391;
			v3 := -((|v2| / v3) - v3);
		} else {
			var v392: array<map<bool, bool>> := new map<bool, bool>[22];
			v392[782] := (v188[v190.f15 := v190.f15])[v190.f15 := fm2(v190.f15, globalState)];
			var v393: array<T0> := new T0[14];
			var v394: T0 := new C5(v190.f15, v190.f12, v190.f13, v190.f14);
			v393[862] := v394;
			globalState.f4, v392[782], v3, v393[862] := v1, v188, v3, v394;
			v3 := v3;
			...
			v400 := false;
			v0[84] := v399;
			v0[84] := v190.fm7(v399, globalState);
		}
		
		var v401 := DC26(v190.f15);
		var v402: array<D8> := new D8[6] [v401, v401, DC26(v1), v401, v401, v401];
		v402[116] := DC26(v190.f15);
		v402[116] := v401.(cf41 := !v190.f15 && v1);
	}
	var v403: array<bool> := new bool[6];
	var v404: multiset<array<bool>> := multiset{v403, v403};
	v403[462] := multiset{v403} > v404;
	v403[462] := v3 == |(v141 + v141)[v3 := v353]|;
	var v405: T4 := new C2(seq(0x156, i37  => (|v141|)), v190.f15 <==> v190.f15, v190.f13, v190.f14, v190.f12);
	v405 := v405;
	...
	var v412: array<seq<int>> := new seq<int>[12] [v408 + v408, [v408[v3], v3], v408 + v408, v408, v408 + [v3, |"rkdkja"|], v408, v408, v408 + DC15(if (v3 in v409) then v409[v3] else if (v1 in v411) then v411[v1] else [v3]).cf25, v406.fm6(v141, globalState), v408, v408, v408];
