...
function fm8(p0: bool, p1: string, globalState: GlobalState): seq<int> {
	((seq(0x259, i0  => (0x213))) + [238]) + (seq(0x30b, i1  => (0xd1)))
}
...
function fm12(p0: int, globalState: GlobalState): D2 {
	if (!(DC17(multiset{map[false := 977], map[false := 0x65]}).cf28 !! multiset{map[true := |(map v0 : int | (0x359 <= v0) && (v0 < 0x163) :: (v0 / 0x376) := ([true]))|]})) then DC3(!true, false) else DC3(!true, false)
}
function fm13(p0: int, p1: int, p2: string, p3: bool, globalState: GlobalState): set<string> {
	if (true) then {"b", seq(-0x227, i0  => ('q')), "w"} + {"l"} else {"ll"}
}
...
method m1(p0: int, p1: array<bool>, globalState: GlobalState) returns (r0: array<bool>) {
	...
	p1[666] := v0 <== ([p0, p0, |"benlgnvi"|, p0] < v3);
	var v4 := DC3(p1[666], p1[666]);
	var v5: array<D2> := new D2[3] [DC3(p1[666], p1[666]), v4, v4];
	var v6: seq<array<D2>> := [v5];
	v6 := v6;
	var v7: seq<bool> := [p1[666]];
	if ((p1[666] !in v7) && !(fm0(v0, true, 0x1bc, p0, globalState) ==> !p1[666])) {
		var v8 := DC0(p1[666]);
		var v9: C1 := new C1(v8);
		var v10 := 'i';
		...
		match ((if (!v0) then DC9("j", v0, v9, v10) else v11).(cf14 := v9)) {
			case DC9(cf12, cf13, cf14, cf15) =>
				...
				var v13: map<set<bool>, int> := map[v12 := |multiset{p1[666]}|];
				var v14: C0 := new C0(cf12[p0]);
				var v15: map<bool, C0> := map[fm16(globalState) != v13 := v14];
				v0, globalState.f9, v15 := |(if (p1[666]) then v7 else v7)| !in (set v16 : int | (0x126 <= v16) && (v16 < 0x1e5) :: (v16 - |[v1, cf12]|)), v0 <==> fm0(v0, v0, p0, p0, globalState), v15;
				var v17 := new C0(v10);
				...
				var v23: array<char> := new char[28] ['k', cf15, cf15, cf15, if (0x11d in v20) then v20[0x11d] else v10, cf15, 'e', v14.f12, v17.f12, v10, v17.f12, v10, v17.f12, cf15, v1[-0x239], v10, v14.f12, v14.f12, fm5(|v22|, globalState), v10, v10, v17.f12, v10, cf15, v10, v14.f12, 'f', v14.f12];
				var v24: map<bool, array<char>> := map[cf13 := v23];
				var v25: seq<array<char>> := [if (p1[666] in v24) then v24[p1[666]] else v23];
				v0 := true ==> (v23 !in v25[p0 := v23]);
			case DC8(cf11) =>
				p1[666] := p1[666];
				globalState.f4 := p0 * p0;
				var v26: array<char> := new char[20];
				v26[104] := v10;
				globalState.f4, v1, v26[104] := -951, v1, v10;
				var v27: map<int, char> := map[p0 := v26[104]];
				var v28: map<int, map<int, char>> := map[p0 := v27];
				globalState.f4 := (p0 / p0) % (if (p1[666]) then p0 else --|(if (p0 in v28) then v28[p0] else map[p0 := v10])|);
		}
		
		var v29: multiset<string> := multiset{"hqp", seq(0xc, i0  => (v10))};
		var v30: multiset<bool> := multiset{v0};
		var v31: map<int, multiset<bool>> := map[p0 := v30];
		var v32: map<bool, bool> := map[p1[666] := v0];
		var v33: map<int, bool> := map[p0 := p1[666]];
		var v34: map<int, int> := map[|v33| := p0];
		var v35: array<int> := new int[21] [p0, p0 * p0, p0, if (v1 in v29) then v29[v1] else |v1|, |(seq(0xff, i1  => (v1)))|, p0, p0, -p0, p0 - p0, p0, |v31|, 0x3a8, p0, -|v32[v0 := true]|, p0, p0, p0, p0, p0 * (if (v0 in v30) then v30[v0] else |v34|), 405, if (v0) then p0 else p0];
		v35[878] := p0;
		v35[878] := if (DC7(if (v0 in v30) then v30[v0] else p0, p1[666]).cf9 in v34) then v34[DC7(if (v0 in v30) then v30[v0] else p0, p1[666]).cf9] else p0;
		var v36 := new C0(if (fm0(p1[666], true, -p0, v35[878], globalState)) then fm5(|v1[768 := v10]|, globalState) else v10);
		globalState.f10 := !p1[666];
		var v37: set<string> := {v1, v1};
		v35 := new int[12] [v35[878], v35[878], p0, p0, p0, v35[878], v35[878], |v37|, v35[878], p0 % p0, |(v7 + v7)|, v35[878]];
	} else {
		var v38 := DC0(!v0);
		...
		var v45: map<bool, C1> := map[p1[666] := v39];
		var v46: seq<C1> := [v39];
		var v47: array<map<C1, bool>> := new map<C1, bool>[25] [if (v2 in v42) then v42[v2] else v40, v40, v40, v40, v40, v40 + v40, map[v39 := p1[666]], v40, v43[p0], v40, v40 + v40, v40, v40, v40[v39 := true] + map[v39 := v0], v40, map[v39 := fm0(v0, fm0(true, v0, p0, p0, globalState), p0, p0, globalState)], v40, (if (|v3| in v44) then v44[|v3|] else v40) + v40, v40, v40, v40, map[if (v0 in v45) then v45[v0] else v39 := v0], v40, map[v46[p0] := p1[666]], v40 + map[v39 := v0]];
		var v48: map<int, int> := map[p0 := -p0];
		var v49: array<int> := new int[3] [p0, if (p0 in v48) then v48[p0] else p0, p0];
		v49[242] := fm2(v0, p0, p0, v1, globalState);
		...
		var v55: map<int, map<int, bool>> := map[p0 := map[p0 := p1[666]]];
		v47, v49[242], globalState.f4, globalState.f9, v50[267] := if (multiset{|DC11(v1, v54, |[v54]|, [p0, p0], p0).cf20|, p0, p0, p0, -582} in v52) then v52[multiset{|DC11(v1, v54, |[v54]|, [p0, p0], p0).cf20|, p0, p0, p0, -582}] else v47, p0, -p0, v0, fm17(v55, v1, p0, globalState);
		globalState.f9 := v0;
		globalState.f4 := p0 + p0;
	...
	v59[21], v60[430], v62, v64 := v3 + (v3 + v3), v62, v62, v64;
	var v65: set<bool> := {p1[666]};
	if (v65 >= v65) {
		var v66: map<D0, bool> := map[v61 := !p1[666]];
		v66 := v66[v62.f11 := v0];
		v1 := if (v0) then if (true) then v1 else v1 else v1 + v1;
		var v67: map<seq<bool>, bool> := map[v7 + v7 := v0];
		v67 := v67[[!p1[666]] + v7 := p1[666]];
		globalState.f3 := p1;
		globalState.f4 := 0x1f;
	} else {
		...
		var v73 := DC14(v72[|v1|]);
		v73 := v73;
		v1 := v1 + (seq(0x303, i4  => ('y')));
		globalState.f9 := p1[666];
	}
...
class C1 {
	...
	method m0(p0: int, p1: string, p2: bool, p3: int, globalState: GlobalState) returns (r0: seq<string>) {
			...
			decreases 100 - i0
		{
			...
			v1 := v1[p0 := p1];
			globalState.f10 := fm0(p2, if (p2) then p2 else true, p3, p3 / p3, globalState);
		...
		for i2 := p3 to p3 {
			...
			var v6: array<int> := new int[6] [p3, i2, i2, fm2(p2, |multiset{p2, p2, p2}|, |v4|, v5[|p1|], globalState), p3, p0 - p3];
			v6[323] := i2;
			var v7: seq<bool> := [p2];
			v6[323] := -(|v7| - i2);
			if (p2) {
				var v8: multiset<int> := multiset{866, i2};
				globalState.f4 := v6[323] * -(-(if (|p1[p0 := v3]| in v8) then v8[|p1[p0 := v3]|] else i2) * -p3);
				v6[323] := p3;
				globalState.f9 := p2 ==> fm0(p2, false, v0[v6[323]], -|v7|, globalState);
				v6[323] := (if (|p1| in v8) then v8[|p1|] else -p3) * v0[p3];
				...
				v11[209] := v13[v6[323] * p3];
				var v14 := new C0(v10.f12);
				var v15: array<string> := new string[13](i3 => p1);
				v15[933] := seq(-0x2c2, i4  => (DC4(p3, v3).cf6));
				var v16: set<int> := {p3};
				var v17: seq<array<int>> := [v6];
				var v18: map<array<int>, int> := map[v17[p0] := |v0|];
				var v19: multiset<D0> := multiset{DC0(p2)};
				var v20: map<int, int> := map[615 := i2];
				v15[933], globalState.f9, globalState.f4, globalState.f9 := p1, v16 >= v16, if (v18 != v18) then if (DC0(v7[|v0|]) in v19) then v19[DC0(v7[|v0|])] else i2 else if (p0 in v20) then v20[p0] else p3, !p2;
				var v21: multiset<C0> := multiset{v10, v10};
				v15[933] := fm4(-|v21|, p2, !p2, v6[323] * v6[323], globalState);
			}
			
			var v22 := DC1(v4);
			var v23: seq<D1> := [v22, v22];
			globalState.f10 := (if (p2) then v23 else v23) <= v23;
			globalState.f4 := (fm2(p2, v6[323], |(seq(0xc7, i5  => (v3)))|, p1, globalState) / i2) % v6[323];
		}
		if (p2) {
			...
			var v29: seq<bool> := [p2];
			var v30 := DC3(p2, p2);
			v26[933], globalState.f9, globalState.f4, globalState.f4, globalState.f9 := p3, v27 >= v27, -(p0 / p0), p0 / p0, |fm4(|multiset{v28}|, p2, v29[p0], p0, globalState)| > (if (v30.cf4) then p3 else p0);
			...
			var v35: array<map<multiset<bool>, C0>> := new map<multiset<bool>, C0>[8] [if (p2 in v34) then v34[p2] else v32, map[fm6(true, v26[933], globalState) := v24], map[v31 := v24], v32, map[v31 := v24], v32, v32, v32];
			v35[352] := v32;
			v35[352] := v33.cf7;
		} else {
			globalState.f10 := p2;
			...
			match (v36) {
				case DC3(cf3, cf4) =>
					...
					globalState.f10, v40, v38[415] := cf4, p1 + (v40 + p1), (false in v41) <==> p2;
					var v42: array<int> := new int[14] [fm2(!p2, -|{p0, p0}|, p0, seq(-0x14b, i7  => (v37)), globalState), -31, p3, p3, p3, p3, p3, p0, p3, p0, p0, -p0, p3, p3];
					var v43: map<bool, array<int>> := map[p2 := v42];
					var v44: seq<bool> := [cf3];
					var v45: map<char, int> := map[v37 := |"w"|];
					var v46: multiset<int> := multiset{43};
					var v47: seq<bool> := [false, fm0(fm0(cf3, v44[p0], 0x328, p0, globalState), p2, if ('r' in v45) then v45['r'] else 0x226, |v46|, globalState), cf4, cf3, p2];
					v43 := v43[v44[-0xd9] := v42];
					globalState.f9 := cf3;
				case DC4(cf5, cf6) =>
					var v48 := DC4(cf5, cf6);
				...
				case DC2(cf2) =>
					...
					var v68: array<int> := new int[21] [fm2(p2, p3, |p1|, p1, globalState), --fm2(p2, p3, p0, p1, globalState), if (p2) then -p0 else p3, p0, if (!p2) then |v61| else p0, 807 / p0, |p1| % p3, p3, p3, |multiset(seq(0x2ee, i8  => (p0)))|, p3, p3, if (p2) then p0 else if (f11 in v62) then v62[f11] else p3, p0, |p1|, -0x275, -(-0x6f % |v63|), |v65|, -|v66|, p3, if (p2) then p3 else |[|multiset{if (p2 in v67) then v67[p2] else p0}|]|];
					var v69: array<char> := new char[21](i9 => v64.f12);
					v69[650] := cf2;
					v68, v69[650], globalState.f10, globalState.f9 := v68, cf2, p2, p2;
					v64 := new C0(v64.f12);
			...
			var v79: array<int> := new int[28] [|{p3}|, p3, -(p3 % p3), p0, if (p2) then p0 else -p3, |fm7(p2, p0, p2, |v73|, globalState)| - -p3, p0, p3, p3, p3, |v75|, p0, p0 / |v74|, -p0, |("m")[p0 := v76]|, v0[250], p3, |fm8(p2, p1, globalState)|, -p3, p3, -652 - p0, |"xlpfc"|, 739, |((multiset{p2})[p2 := p3] + v77)|, p3, p3, 655, |(p1 + v78[p0])|];
			var v80: multiset<int> := multiset{|p1|, p3};
			var v81: C0 := new C0('j');
			var v82: map<multiset<bool>, C0> := map[v77 := v81];
			var v83 := DC5(v82);
			var v84: set<D3> := {v83};
			v79[566] := if (p0 in v80) then v80[p0] else -|v84|;
			...
			v79[566], v76, globalState.f10 := |fm1(v85, !p2, |p1|, -p0, globalState)|, p1[414], fm9(p2, globalState) != v87;
			globalState.f9 := p2;
		...
		var v93 := DC5(v92);
		var v94: seq<D3> := [v93];
		for i10 := |multiset(v94)| / p0 to fm2(p2, --285, p0, p1, globalState) {
			...
			v99[950] := v93;
			v99[950] := v93.(cf7 := v92).(cf7 := (map[v89 := v91])[v89 := v91]).(cf7 := v92);
		...
		var v105: array<D0> := new D0[26] [DC0(p2), DC0(p2), f11, f11, f11, f11, f11, f11, f11, f11.(cf0 := true), f11, f11, f11, DC0(p2), f11, f11, f11, f11, f11, f11, f11.(cf0 := v104[p3]), f11, f11, f11, DC0(p2), f11];
		v105[463] := f11;
		v105[463] := f11;
		r0 := fm10(globalState);
	}
...
method Main() {
	...
	for i0 := v4 to -v4 - v4 {
		...
		v7[840] := v9;
		var v10 := DC0(false);
		v7[840] := map[i0 - |fm1(map[i0 := v4], v10.cf0, i0, v4, globalState)| := v8];
		var v11 := "ewk";
		v11 := v11;
	}
	...
	var v14: seq<int> := [v4, -|v13| % |(seq(0x29f, i2  => ('u')))|];
	var v15 := DC0(v1);
	var v16: map<D0, int> := map[v15.(cf0 := v1) := v4];
	var v17 := "ajftdewh";
	globalState.f4 := v14[fm2(v1, if (v15 in v16) then v16[v15] else v4, v4, v17, globalState)];
	...
	match (v15) {
		case DC0(cf0) =>
			...
			var v22: array<string> := new string[18] [v17 + v17, "kwmdrfli", v17, v21[v4], seq(0x65, i3  => (v19)), v17, if (fm0(v1, v1, v4, v4, globalState) in v13) then v13[fm0(v1, v1, v4, v4, globalState)] else v17, (seq(195, i4  => (v19))) + v17, "krisnrwt", v17 + (seq(0x1f0, i5  => (v20.f12))), v17, seq(0x289, i6  => (v20.f12)), v17 + v17, v17, v17, "dkm", fm4(-v4, cf0, cf0, -v4, globalState), (v17 + "qfkthhxah")[v4 := v19]];
			v22[280] := v17;
			v22[280] := v17;
	...
	if (v1) {
		...
		v24[891], v1, globalState.f4, globalState.f9 := v4 - v4, v1 !in v25[v4 := v1], v4 / |fm11(-v4, globalState)|, v1;
		match (fm12(v4, globalState)) {
			case DC3(cf3, cf4) =>
				var v26: set<bool> := {if (v4 in v12) then v12[v4] else cf3};
				globalState.f9 := v26 != v26;
				v14 := v14;
				v24[891] := |fm11(v24[891], globalState)|;
				var v27 := DC3(v25[v24[891]], false);
			...
			case DC2(cf2) =>
				...
				var v37 := v34.m0(|v36|, v17 + (seq(0x396, i9  => (cf2))), v1 <== v1, v24[891], globalState);
		}
		
		v24[891] := v24[891];
		var v38 := 'f';
		var v39 := DC3(v17 <= v17[v4 := v38], v17 < v17[v4 := v38]);
		v39 := v39;
		...
		var v44: seq<C0> := [v43];
		var v45: array<C0> := new C0[21] [v43, v43, v43, v43, v43, v43, v44[v4], v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43];
		v45 := v45;
		globalState.f4 := fm2(v1, 942, v4, "p", globalState) + v4;
		var v46 := m1(v4, v0, globalState);
		var v47 := DC6(v46);
		var v48 := m1(-v4 / v4, v47.cf8, globalState);
	}
	...
	if (v1) {
		...
		v55 := v55[((([v4])[v4 := v4])[v4 := v4])[|[v1]| := |map[v1 := v1]|] := -0x72];
		var v56: C0 := new C0(v53);
		var v57: array<seq<int>> := new seq<int>[11](i10 => v14[v4 := v4]);
		var v58: seq<array<seq<int>>> := [v57];
		var v59: array<array<seq<int>>> := new array<seq<int>>[18] [v57, v57, v57, v58[0x13c], v57, v57, v57, v57, v57, v57, v57, v57, v57, if (!v1) then v57 else v57, v57, v57, v57, v57];
		v59[757] := v57;
		var v60: array<array<int>> := new array<int>[15];
		var v61: map<int, C0> := map[-v4 := v56];
		v56, globalState.f10, v59[757], v60, globalState.f4 := if (|fm8(v1, v17, globalState)| in v61) then v61[|fm8(v1, v17, globalState)|] else if (v1) then v56 else v56, if ((if (v1) then v1 else v1) in v18) then v18[if (v1) then v1 else v1] else v1, v57, v60, v4;
		...
		var v65 := DC1(v12);
		if (fm0(v1, v17 < v64[v4], -0x2f4, fm2(fm0(v1, v1, v4, v4, globalState), |[v65]|, |v50|, v17, globalState), globalState)) {
			var v66 := 'w';
			var v67 := new C0(v66);
			globalState.f4 := v4;
			var v69: array<map<int, int>> := new map<int, int>[20](i11 => map[v4 := v4] + (map v68 : int | (-874 <= v68) && (v68 < 754) :: (v68 % v4) := (v4)));
			...
			v69[565], v3, v74 := v70, map[v2 := v1] + ((map v75 : multiset<bool> | v75 in v78 :: (v75) := (v1)) + fm14(true, v4, v79, globalState)), if (v81 in v82) then v82[v81] else v74[v83 := v4];
			var v84 := m1(v4, v0, globalState);
			var v85 := DC2(v67.f12);
			var v86: multiset<D2> := multiset{v85};
			globalState.f10 := !((v86 * v86[v85 := v4]) > v86);
		} else {
			var v87: map<bool, int> := map[if (v1) then v1 else v1 := v4];
			var v88 := 'n';
			globalState.f10, globalState.f4, globalState.f10, v24, v87 := !v1, v4, v17 == v17[v4 := v88], v24, v87 + map[v1 := v4];
			var v89: array<C1> := new C1[4];
			v89[264] := if (v1) then v49 else v49;
			v24[183] := |fm15(globalState)|;
			var v90: set<array<bool>> := {v0};
			v89[264], v1, v24[183], v90, globalState.f10 := v49, fm0(v1, v1, v4, v4, globalState), fm2(v1, v4, v4, v17, globalState) % (|(seq(-0x144, i12  => (v4)))| * v4), v90, true;
			var v91 := m1(v24[183], v0, globalState);
			var v92: seq<array<bool>> := [v0, v91, v91, v0];
			var v93 := m1(|v17|, v92[v4], globalState);
			v24[183] := 0x19c;
		}
