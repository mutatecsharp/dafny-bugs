...
class C0 {
	...
	method m1(p0: int, p1: bool, globalState: GlobalState) {
		for i0 := p0 to p0 {
			...
			v0 := v0 * |((map v1 : int | (666 <= v1) && (v1 < -533) :: (safeModuloInt(v1, v0)) := (|DC2("dchcbikbk").cf4|)) + v3)|;
			var v4: seq<int> := [i0];
			var v5: seq<seq<int>> := [v4];
			var v6: map<int, bool> := map[v0 := !p1];
			globalState.f0 := v5[safeIndex(|(map[p0 := p1] + v6)|, |v5|)];
			globalState.f1 := |([p1])[safeIndex(i0, |[p1]|) := p1]| > DC1(v0, fm1(i0, globalState), p1).cf1;
			globalState.f1 := p1;
		}
		globalState.f1 := p1;
		var v7 := 0x1b4;
		var v8: multiset<bool> := multiset{p1, p1};
		v7 := safeDivisionInt(fm1(p0, globalState), 0x323 + |v8|);
		var v9 := "hb";
		var v10: seq<bool> := [p1];
		var v11: map<int, bool> := map[|[fm0(v7, globalState)]| := p1];
		var v12: array<seq<bool>> := new seq<bool>[20] [[true, p1], v10, v10[safeIndex(v7, |v10|) := p1] + v10, v10 + v10, [p1, p1], v10, [p1, p1], v10[safeIndex(312, |v10|) := p1], v10, v10, v10 + v10, v10, [p1, p1, p1], v10, [p1, p1, p1], fm2(p1, p1, v11, p1, globalState), v10, if (p1) then v10 else v10, v10, [true, p1]];
		v12[safeIndex(468, v12.Length)] := v10 + v10;
		v9, v12[safeIndex(468, v12.Length)], globalState.f1, globalState.f1 := fm3(globalState) + v9, v10, fm4(globalState) < (seq(abs(857), i1  => (DC2(v9).cf4))), p1;
		v7 := v7;
...
function fm3(globalState: GlobalState): string {
	("eh" + "rm") + ("qlxxw" + (seq(abs(0x3e0), i0  => ('q'))))
}
...
function fm5(p0: bool, p1: bool, p2: D0, globalState: GlobalState): multiset<int> {
	multiset{|map[0x77 := true]|, 0x399, |map[|(set v0 : int | v0 in multiset([836]) :: (v0 * 0xf8))| := false]|} - multiset([|map[true := 839]|, |(seq(abs(0x2a), i0  => ('h')))|, |{false, false, !false, false}|])
}
function fm6(p0: bool, p1: map<int, bool>, p2: bool, p3: int, globalState: GlobalState): map<string, string> {
	map["iffq" := (seq(abs(0x261), i0  => ('b'))) + "rxl"]
}
function fm7(globalState: GlobalState): map<int, D4> {
	match DC10(multiset{false}) {
		case DC11(cf17) => map[|map[true := |map["csjiecvhl" := |[|map[!true := |map['a' := |(map v0 : int | (-0x27 <= v0) && (v0 < 0x30c) :: (safeModuloInt(v0, |"nshammh"|)) := (true))|]|]|]|]|]| := DC8(map[true := 0x234])]
...
function fm8(p0: bool, p1: multiset<char>, globalState: GlobalState): seq<int> {
	(if (true) then seq(abs(0x2f3), i0  => (--863)) else seq(abs(-0x2ed), i1  => (|"uhedjju"|))) + (if (!true) then [0xe3] else [|{false, false, false, !false}|, 0xd7])
}
function fm9(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<int, bool> {
	map[|([0xdd] + (seq(abs(6), i0  => (|map[|map[true := true]| := multiset{true}]|))))| := !(|"dwneg"| >= |"sjycrdgy"|)]
}
...
function fm13(p0: bool, p1: bool, p2: string, globalState: GlobalState): map<string, set<int>> {
	DC14(map["qsiewudbc" := {|[0x39e, |(seq(abs(-0x1b2), i0  => ('t')))|, -827, 851, 0x32c]|, 380}]).cf24
}
method m0(p0: multiset<seq<int>>, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
	...
	match (if (v0) then DC2(v1) else v2) {
		case DC2(cf4) =>
			...
			v5 := v5[v6 := v6 >= -326];
			if (v0) {
				var v7: seq<string> := [cf4, seq(abs(180), i0  => (v3))];
				var v8: array<seq<string>> := new seq<string>[6] [v7 + v7, v7, ["tsajg"], v7 + v7, v7 + [v1, cf4], v7 + v7];
				v8[safeIndex(9, v8.Length)] := seq(abs(-648), i1  => (cf4));
				v8[safeIndex(9, v8.Length)] := [seq(abs(0x336), i2  => (v3))];
				var v9: array<seq<int>> := new seq<int>[18](i3 => [v6, v6] + [v6]);
				v9[safeIndex(573, v9.Length)] := fm8(true, v4, globalState);
				var v10: seq<int> := [--v6];
				var v11: seq<seq<int>> := [v10 + fm8(v0, v4, globalState)];
				v9[safeIndex(573, v9.Length)] := v11[safeIndex(safeModuloInt(v6, v6), |v11|)];
				...
				v14[safeIndex(397, v14.Length)] := fm0(if (|(set v21 : char | v21 in map[v3 := |v20|] :: (v21))| in v19) then v19[|(set v21 : char | v21 in map[v3 := |v20|] :: (v21))|] else 0x24d, globalState);
				var v22: map<char, array<int>> := map[v3 := v17];
				v14[safeIndex(397, v14.Length)] := (if (v0) then v22 else map[v3 := v17]) != (v22 + v22);
			} else {
				var v23: map<bool, string> := map[v0 := cf4];
				v23 := (map[v0 := seq(abs(269), i6  => (v3))] + v23) + v23;
				var v24 := new C0();
				var v25: array<seq<seq<bool>>> := new seq<seq<bool>>[16];
				var v26: set<int> := {v6};
				var v27: multiset<multiset<bool>> := multiset{fm11(v0, v0, |v26|, globalState)};
				v25[safeIndex(150, v25.Length)] := fm10(|v27|, globalState);
				var v28: array<string> := new string[24] [cf4, v1 + "knesulqj", cf4, cf4, "yxthifwc", if (true in v23) then v23[true] else v1, cf4, v1 + cf4, cf4, v1, cf4, v1 + v1[safeIndex(|v1|, |v1|) := v3], "dqmctbicw", v1, v1, cf4, cf4, v1 + (seq(abs(-182), i7  => (v3))), cf4 + "gkykgdr", v1, v1 + (seq(abs(0x12), i8  => (v1[safeIndex(v6, |v1|)]))), (cf4 + "hyohbsaxk")[safeIndex(v6, |(cf4 + "hyohbsaxk")|) := v3], v1, "krh"];
				v28[safeIndex(140, v28.Length)] := cf4 + cf4;
				var v29: set<bool> := {!true, v0, v0, v0};
				var v30: seq<bool> := [v0];
				var v31: seq<seq<bool>> := [v30];
				v0, v25[safeIndex(150, v25.Length)], v28[safeIndex(140, v28.Length)], r0, v24 := fm0(|v29|, globalState), v31, v1 + cf4[safeIndex(v6, |cf4|) := v1[safeIndex(v6, |v1|)]], -v6, v24;
				v2 := v2;
				v1 := cf4;
			}
			
			r1 := safeDivisionInt(v6, |cf4|);
			v6 := v6;
	}
		...
		decreases 100 - i9
	{
		...
		var v38: map<C0, int> := map[v37[safeIndex(v33, |v37|)] := v33];
		...
		var v40: map<int, bool> := map[|(seq(abs(0x363), i10  => (v34)))| := fm0(v33, globalState)];
		var v41: array<bool> := new bool[11] [v0, v0, v0, v0, v0, if (v33 in v40) then v40[v33] else v0, !v0, v0, v0, v0, v0];
		v41[safeIndex(760, v41.Length)] := if (v0) then false else v0;
		var v42 := DC12(v33, fm12(globalState), v0, v1, v33);
		v41[safeIndex(760, v41.Length)] := !(v0 || v42.cf20);
		r0, v0, globalState.f1, r1 := v33, v41[safeIndex(760, v41.Length)], v41[safeIndex(760, v41.Length)], v33 + v33;
	...
	var v55: array<map<string, set<int>>> := new map<string, set<int>>[18] [v47, v47, map v48 : string | v48 in v49 :: (v48) := (v45), fm13(v0, false, v1, globalState), map[v1 := v45], v47, map[v1 := v45], v47 + v47, map[v2.cf4[safeIndex(v33, |v2.cf4|) := v50] := v45], v47 + v51.cf24, if (v0) then v47 else map v52 : string | v52 in v49 :: (v52) := (v45), v47, (map["xrfel" := {v33, v33}])[v1 := v45], v47, map[v1 := v45], map[v1 := v45] + v47, map[v1 := v45], map v53 : string | v53 in v54 :: (v53) := (v45)];
	v55[safeIndex(5, v55.Length)] := v47;
	var v56: array<int> := new int[4];
	var v57: array<D2> := new D2[23](i11 => DC3(multiset{v33}));
	var v58 := DC3(multiset{v33, v33});
	v57[safeIndex(306, v57.Length)] := v58;
	var v59 := DC9(v56, |v49|, v56);
	var v60: multiset<int> := multiset{v33, v33};
	v46, v55[safeIndex(5, v55.Length)], v56, r2, v57[safeIndex(306, v57.Length)] := v46, v47, if (if (v0) then fm0(v33, globalState) else v0) then v59.cf13 else v56, -(if (0x161 in v60) then v60[0x161] else v33) >= v33, v58;
	var v61 := new C0();
	for i12 := v33 to v33 {
		var v62: array<bool> := new bool[9];
		v62[safeIndex(379, v62.Length)] := true;
		v62[safeIndex(379, v62.Length)] := v0;
		var v63: array<multiset<bool>> := new multiset<bool>[20];
		v63 := v63;
		var v64 := new C0();
		v61.m1(i12, !v0, globalState);
	}
	var v65 := DC0(v33 != |(seq(abs(0x59), i13  => (v33)))|);
	v65 := v65.(cf0 := v60 >= v60);
	r0 := v33;
	r1 := -0x3a0;
	r2 := v0;
...
method Main() {
	...
	var v0: array<bool> := new bool[12](i1 => multiset{-|[645, 0x3a8, |[901, |(seq(abs(0x3b1), i2  => ('s')))|, 0x3dd, 0x214, 0x1b8]|]|, |[|(seq(abs(0x112), i3  => ('l')))|]|, -|(seq(abs(0x368), i4  => (467)))|} != multiset{0x36a});
	...
	match (v1) {
		case DC1(cf1, cf2, cf3) =>
			...
			if (|v2| !in ((seq(abs(308), i5  => (|(seq(abs(0x1e8), i6  => ('b')))|))) + (if (cf3 in v5) then v5[cf3] else v4))) {
				cf1 := safeModuloInt(|map[cf3 := seq(abs(0x29d), i7  => (cf2))]|, cf2);
				...
				v10 := v10[v9 := v11[safeIndex(v7, |v11|)]];
				globalState.f1 := v9;
			} else {
				var v12, v13, v14 := m0(multiset{v4, v4}, globalState);
				globalState.f1 := safeModuloInt(-cf1, fm1(cf2, globalState)) <= v12;
				v2 := ("ne" + v2) + (v2 + v2);
			...
			if (v1.cf0 <== !cf3) {
				...
				v0[safeIndex(47, v0.Length)] := fm0(cf1, globalState);
				v0[safeIndex(47, v0.Length)] := cf3 ==> cf3;
				globalState.f0 := v4;
				cf1 := fm1(|v4| + cf1, globalState);
				cf2 := safeDivisionInt(|(seq(abs(0x14c), i8  => ('i')))|, cf2);
			} else {
				...
				globalState.f1 := cf3;
				v0[safeIndex(77, v0.Length)] := cf3;
				v0[safeIndex(77, v0.Length)], cf2 := cf3, cf1 - 0x28d;
				var v19: map<bool, int> := map[v0[safeIndex(77, v0.Length)] := cf1];
		...
		case DC0(cf0) =>
			var v25 := 0x88;
			var v26: array<int> := new int[2](i11 => safeModuloInt(i11, v25));
			v26[safeIndex(660, v26.Length)] := safeDivisionInt(v25, v25);
			var v27: multiset<bool> := multiset{cf0};
			var v28: seq<multiset<bool>> := [v27];
			var v29 := DC1(v25, v25, cf0);
			var v30: map<bool, int> := map[!cf0 := -0x18];
			v25, v25, v25, v26[safeIndex(660, v26.Length)], cf0 := |(if (cf0) then v28[safeIndex(v25, |v28|)] else (multiset{v29.cf3, cf0})[fm0(|v30|, globalState) := abs(v25)])|, v25, |map[cf0 := cf0]| - v25, if (true in v30) then v30[true] else v25, fm0(v25, globalState);
			var v31: set<map<bool, int>> := {v30, v30};
			var v32: set<string> := {"wop"};
			v0[safeIndex(634, v0.Length)] := v32 != v32;
			var v33 := "iqinws";
			v31, globalState.f1, cf0, v25, v0[safeIndex(634, v0.Length)] := v31, v33 != v33[safeIndex(v25, |v33|) := 'p'], cf0 ==> (-v25 <= |(seq(abs(786), i12  => ('g')))|), -fm1(-v25, globalState), cf0;
			match (v29) {
				case DC1(cf1, cf2, cf3) =>
					var v34 := new C0();
					var v35: seq<bool> := [v0[safeIndex(634, v0.Length)]];
					var v36: seq<int> := [|map[v0[safeIndex(634, v0.Length)] := v25]|];
					var v37: map<int, C0> := map[0x1f0 := v34];
					v1, v35, globalState.f0, cf2, v34 := DC0(v27 == v27), [false, v0[safeIndex(634, v0.Length)], cf0], (v36 + v36) + [|v35|, cf2, cf2], -|v33| + |(v37 + v37)|, v34;
					var v38 := new C0();
				...
				case DC0(cf0) =>
					...
					v40 := (v40 * v40) - {v39};
					v26[safeIndex(660, v26.Length)] := v25;
					var v41: seq<int> := [v26[safeIndex(660, v26.Length)]];
	...
	if (v50) {
		...
		v51 := v51;
		var v54 := new C0();
		if (safeModuloInt(v52, v52) <= v52) {
			v49.m1(v52 + v52, v50, globalState);
			v0[safeIndex(720, v0.Length)] := v50;
			v0[safeIndex(720, v0.Length)] := v50;
			globalState.f1 := !!v0[safeIndex(720, v0.Length)];
			var v55: array<string> := new string[27](i13 => "hvo");
			var v56 := "sdpbjuu";
			v55[safeIndex(674, v55.Length)] := v56 + v56;
			var v57 := DC1(692, v52, v0[safeIndex(720, v0.Length)]);
			var v58: multiset<bool> := multiset{v0[safeIndex(720, v0.Length)], v0[safeIndex(720, v0.Length)], v50, v0[safeIndex(720, v0.Length)], !v0[safeIndex(720, v0.Length)]};
			v55[safeIndex(674, v55.Length)] := if (!(fm5(v0[safeIndex(720, v0.Length)], v0[safeIndex(720, v0.Length)], v57, globalState) !! DC3(multiset{v52, |v58[v0[safeIndex(720, v0.Length)] := abs(v52)]|}).cf5)) then seq(abs(196), i14  => (v51)) else (seq(abs(-0x22c), i15  => (v51))) + v56;
			var v59: seq<int> := [v52, |v58|, -v52];
			v52 := v59[safeIndex(0x155, |v59|)] * (v52 * v52);
		} else {
			var v60: array<int> := new int[24](i16 => i16 + |[false]|);
			v60[safeIndex(922, v60.Length)] := -v52;
			v60[safeIndex(922, v60.Length)] := v52;
			var v61: map<char, int> := map[v51 := v52];
			var v62: map<int, int> := map[v60[safeIndex(922, v60.Length)] := v60[safeIndex(922, v60.Length)]];
			v61 := v61[v51 := safeDivisionInt(|v62|, 0xc4)];
			var v63: multiset<char> := multiset{v51, 'w', v51, v51, v51};
			var v64: seq<char> := [v51, v51, 'a', v51, v51];
			var v65: seq<multiset<char>> := [v63, v63, v63[v51 := abs(v52)], multiset(v64), v63];
			v63 := v65[safeIndex(v52, |v65|)];
			v52 := safeDivisionInt(safeDivisionInt(v52, v52), v52);
			v49.m1(v60[safeIndex(922, v60.Length)], if (v50) then !v50 else v50, globalState);
		}
		...
		v68[safeIndex(54, v68.Length)] := fm1(v67, globalState);
		v68[safeIndex(54, v68.Length)] := v67;
		var v69: seq<bool> := [v50];
		var v70: multiset<seq<bool>> := multiset{v69};
		var v71: map<int, multiset<seq<bool>>> := map[v68[safeIndex(54, v68.Length)] := v70];
	...
	if (fm0(v72 - v72, globalState)) {
		...
		var v88: set<int> := {|v87|};
		v88 := {-|v79[safeIndex(v72, |v79|) := v72]|, v72};
		var v89 := "hlrf";
		var v90: map<int, string> := map[-v72 := if (!!v50) then "iff" else v89];
		v89 := if (v72 in v90) then v90[v72] else v89;
		v86[safeIndex(71, v86.Length)] := |map[v50 := v72]|;
		v86[safeIndex(71, v86.Length)] := safeModuloInt(|(v89 + v89)|, v79[safeIndex(0x1c8, |v79|)]);
		v49 := v74;
	} else {
		var v91 := new C0();
		v49 := v74;
		...
		v50 := v92[safeIndex(-0xf2, |v92|)];
		var v93: seq<int> := [-v72, if (v50) then v72 else v72, v72];
		v72 := v93[safeIndex(-0xfc, |v93|)];
	}
	...
	for i19 := 0x2fa to v72 {
		...
		globalState.f1 := v50;
		v72 := v72;
		var v95: array<int> := new int[25](i20 => safeDivisionInt(i20, v72));
		v95[safeIndex(670, v95.Length)] := -i19;
		v95[safeIndex(670, v95.Length)] := i19;
	}
	for i21 := |"q"| to v72 {
		var v96: multiset<int> := multiset{i21};
		v72 := (if (247 in v96) then v96[247] else i21) - -|(seq(abs(92), i22  => ('x')))|;
		var v97 := 'f';
		v97 := v97;
		if (false) {
			var v98: array<int> := new int[10];
			v98[safeIndex(273, v98.Length)] := fm1(-0x316, globalState) - v72;
			var v99 := "ensayrry";
			v98[safeIndex(273, v98.Length)] := |((fm3(globalState) + v99) + v99)|;
			var v100 := DC8(map[fm0(v72, globalState) := v98[safeIndex(273, v98.Length)]]);
			var v101: map<bool, int> := map[false := v98[safeIndex(273, v98.Length)]];
			var v102: map<map<bool, int>, char> := map[v100.cf12 + v101 := v97];
			v102 := v102[v101 := v97] + v102;
			v97 := 'k';
			var v103 := new C0();
			var v104: map<seq<bool>, int> := map[[false] := v72];
			v98[safeIndex(273, v98.Length)] := --0x2d3 - safeDivisionInt(|v104|, v98[safeIndex(273, v98.Length)]);
		} else {
			var v105 := new C0();
			v50 := true;
			var v106 := "sxn";
			...
			v106 := (v106[safeIndex(i21, |v106|) := v97] + fm3(globalState)) + v106;
		}
	...
	for i23 := 188 to 285 {
		...
		v72 := v113[safeIndex(-|(seq(abs(0x264), i24  => ('o')))| + fm1(i23, globalState), |v113|)];
		v73 := v73;
		if ((v72 * -552) != |fm7(globalState)|) {
			var v114 := DC5(|multiset(seq(abs(-0x5e), i25  => (v72)))|, 0x386);
			...
			var v120: array<int> := new int[5] [v72, v113[safeIndex(if (v117 in v118) then v118[v117] else |v119|, |v113|)], v72, safeModuloInt(v72, |v119|), if (v50) then 0x9a else i23];
			v120[safeIndex(621, v120.Length)] := v72;
			v120[safeIndex(621, v120.Length)] := i23;
			globalState.f1 := v50;
			var v121: map<bool, bool> := map[v50 := true];
			var v122: array<char> := new char[17](i26 => 'e');
			v122[safeIndex(120, v122.Length)] := v117;
			var v123: array<multiset<bool>> := new multiset<bool>[9](i27 => v111);
			var v124 := DC10(v111);
			v111, v121, v120[safeIndex(621, v120.Length)], v122[safeIndex(120, v122.Length)], v123 := v111 + v124.cf16, v121, --i23, v117, v123;
			globalState.f1 := fm0(fm1(|"ehbbvaf"|, globalState), globalState);
		} else {
			v72 := v72;
			var v125 := DC1(i23, v72, v72 !in map[i23 := v50]);
			v125 := v125;
			var v127: array<int> := new int[24](i28 => safeModuloInt(i28, |(map v126 : int | (374 <= v126) && (v126 < 471) :: (v126 * -0x50) := (v72))|));
			v127[safeIndex(907, v127.Length)] := i23;
			var v128 := 'o';
			var v129: seq<string> := [v112[safeIndex(0x20d, |v112|) := v128]];
			var v130: array<string> := new string[18] [v112, v112, v112, v112 + v112, "cscllebh", v112, (v112[safeIndex(i23, |v112|) := v128] + (seq(abs(0x35c), i29  => ('h'))))[safeIndex(i23, |(v112[safeIndex(i23, |v112|) := v128] + (seq(abs(0x35c), i29  => ('h'))))|) := v128], v129[safeIndex(v113[safeIndex(i23, |v113|)], |v129|)], v112, v112 + v112, v112 + v112, v112, v112, v112, v112, v112, if (false) then v112 else v112, v112];
			...
			v50, v127[safeIndex(907, v127.Length)], v130, v72 := !v50, v72 * |(v133 + v133)|, v130, -(i23 + i23);
			v127 := v127;
	...
	if (!fm0(safeModuloInt(v72, v72), globalState)) {
		var v134 := "hceiynyhv";
		v134 := v134;
		var v135 := new C0();
		...
		var v139: map<array<array<int>>, int> := map[if (true) then v136 else v136 := |(v137 + v137[v72 := abs(|v138|)])|];
		v139 := v139[v136 := v72];
		globalState.f1 := v50;
		...
		if ((v141 >= v141) <== (if (false in v142) then v142[false] else v50)) {
			...
			v0[safeIndex(244, v0.Length)] := v144 == v144;
			var v145 := DC1(v72, |map[-55 := v72]|, v50);
			var v146: map<bool, seq<int>> := map[fm0(-0x10c, globalState) := v144];
			v0[safeIndex(244, v0.Length)] := fm1(v72, globalState) in ([v72, -|fm5(v50, v50, v145, globalState)|] + (if (v50 in v146) then v146[v50] else v144));
			v50 := v50 && true;
			v72 := safeModuloInt(v72 + v72, v72);
		} else {
			v72 := (|v134| - v72) * v72;
			...
			v147, v72, globalState.f1, v148 := v150[safeIndex(fm1(v72, globalState), |v150|)], v72, (v50 && v50) ==> v50, v148;
		...
		var v157: map<int, bool> := map[|v156[safeIndex(|v111|, |v156|) := v72]| - v72 := v50];
	...
	print v50, "\n";
	print v72, "\n";
	print v73[0] == [false, false, false], "\n";
	print v73[1] == [false, false, false], "\n";
	print v73[2] == [false, false, false], "\n";
	print |v94|, "\n";
	print v111 == multiset{}, "\n";
	print v166 == [true], "\n";
}