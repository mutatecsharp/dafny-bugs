...
function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): multiset<int> {
	multiset{|"tu"| % |map[|"phdhb"| := true]|, 0xba + |(seq(0x2b5, i0  => ('q')))|, |[|(seq(474, i1  => ('i')))|]| / |{747}|, |multiset{false}|}
}
...
function fm3(p0: string, p1: seq<bool>, p2: string, globalState: GlobalState): string {
	if (["whhn"] <= ["anphc", "vwmr", seq(987, i0  => ('i'))]) then "qjybkom" else "braawg"
}
function fm10(p0: string, globalState: GlobalState): map<bool, seq<int>> {
	map[!!true := [858, |map[false := 'r']|, DC38(true, |map[0x2f9 := true]|, |multiset([|multiset{|"dpil"|, |"hjktq"|, 0xeb}|, |(seq(0x39f, i0  => ('x')))|])|, false).cf48]] + (map[true := seq(-0x2ae, i1  => (0x332))] + map[true := seq(123, i2  => (|multiset([true])|))])
}
function fm11(p0: char, p1: int, globalState: GlobalState): char {
	'x'
}
function fm12(globalState: GlobalState): map<int, int> {
	map[|((map v0 : int | v0 in DC34(map v1 : int | (-0x3c0 <= v1) && (v1 < -0xcb) :: (v1 % |{|"mntatlif"|}|) := (false)).cf43 :: (v0 - |(seq(-0x1b7, i0  => ('s')))|) := (multiset{true})) + map[0x98 := multiset{false}])| := if (false) then |multiset{false}| else |map[[false] := -0x1e2]|]
}
...
function fm33(p0: bool, p1: bool, p2: bool, globalState: GlobalState): seq<int> {
	[DC32(map[575 := multiset{false}], false, |map[true := |[true, false]|]|, true).cf40, |{|[false, false, false]|, |[-0x25]|}|, |map[|"m"| := 'm']|, |"ridyjryoa"|, -251] + (seq(0x327, i0  => (-298)))
}
...
function fm42(p0: D4, p1: string, globalState: GlobalState): map<bool, multiset<int>> {
	if (true in [true, true]) then map[false := multiset{|{|[false, !!false]|}|}] else map[false := multiset{|(seq(0x1b5, i0  => ('i')))|, |{true}|}]
}
...
function fm47(p0: char, globalState: GlobalState): map<int, int> {
	map v0 : int | v0 in (map v1 : int | (742 <= v1) && (v1 < -0x1db) :: (v1 % |(seq(0xae, i0  => (0x24e)))|) := (650)) :: (v0 - -430) := (|multiset{false}| / -0x311)
}
...
function fm49(p0: char, p1: string, p2: int, p3: int, globalState: GlobalState): map<bool, int> {
	(map[true := |{true}|] + map[true := |map[true := false]|]) + map[false := |(seq(-308, i0  => ('d')))|]
}
...
function fm53(globalState: GlobalState): D17 {
	if (['a', 'r'] < (seq(0x99, i0  => ('y')))) then DC38(!false, |"ja"|, |map['q' := "h"]|, true) else DC38(true, -|"qlulnrygi"|, -0x12, true)
}
...
function fm55(p0: string, globalState: GlobalState): map<seq<int>, bool> {
	map[seq(0x223, i0  => (|(seq(327, i1  => ('w')))|)) := !(---0x166 == 752)]
}
...
function fm57(p0: bool, p1: bool, globalState: GlobalState): D17 {
	if (true) then DC39(DC39(DC37(map v0 : string | v0 in (seq(-172, i0  => ("v"))) :: (v0) := (|[0x3b6]|)))) else DC39(DC38(false, 0xf9, |"liwkhyx"|, true))
}
...
function fm60(p0: int, globalState: GlobalState): seq<map<int, bool>> {
	match DC43(false, |"nurrawome"|) {
		case DC42(cf54, cf55, cf56) => [map[cf55 := cf54], map v0 : int | (0x1 <= v0) && (v0 < 0x368) :: (v0 - 0x28) := (cf56)] + (seq(0x190, i0  => (map[cf55 := cf54])))
		case DC43(cf57, cf58) => [map[cf58 := cf57]] + [map[cf58 := cf57], map[|{'g'}| := cf57]]
		case DC41(cf53) => seq(-0x8d, i1  => (map[|{{|map[false := -0x120]|, 0x20e}}| := false]))
	}
}
function fm61(p0: bool, p1: string, p2: bool, p3: bool, globalState: GlobalState): seq<map<bool, bool>> {
	([map[false := !true]] + (seq(-538, i0  => (map[false := false])))) + [map[false := true]]
}
function fm62(p0: int, p1: string, p2: bool, p3: bool, globalState: GlobalState): D0 {
	if (0x12b < 0x37b) then DC0(multiset{|[seq(0xec, i0  => ('o')), ['n'], ['k']]|, |(seq(0x31d, i1  => ('f')))|}) else DC0(multiset{-|DC0(multiset{0xd7, -0x37b}).cf0|})
}
...
function fm66(p0: bool, p1: bool, p2: int, p3: multiset<int>, globalState: GlobalState): map<seq<int>, int> {
	(map[[-|(seq(0x177, i0  => (DC95(-0x3d9, 'e', 79).cf130)))|, |"aytld"|] := |multiset(seq(0x21, i1  => (0x91)))|] + map[[-0xc9, 0x50] := -|map[0x59 := |["tsymirds", "if"]|]|]) + map[[-|map[DC81() := !true]|] := |multiset{0x1fe, 0xa7}|]
}
function fm67(p0: map<int, int>, p1: bool, globalState: GlobalState): D4 {
	match DC33(DC33(DC33(DC32(map v0 : int | v0 in multiset{-0x26d} :: (v0 % 0x2fe) := (multiset{false, !true}), true, 0xb2, !true)))) {
		case DC32(cf38, cf39, cf40, cf41) => DC7(cf40, cf40)
		case DC31(cf37) => DC7(-158, |(seq(0x92, i0  => ('w')))|)
		case DC33(cf42) => if (false) then DC7(|[-0x259, 0x7c]|, |[970, |map[true := 0x3e0]|]|) else DC7(-736, -447)
	}
}
function fm68(globalState: GlobalState): D20 {
	match if (false) then DC65(map[true := 0x1b9], seq(0x35e, i0  => (33))) else DC65(map[false := |"spyojml"|], [0xb9, |map[false := true]|]) {
...
function fm79(p0: string, p1: int, p2: bool, p3: bool, globalState: GlobalState): D22 {
	DC51(false <==> true, |map[false := false]| % 0x1a6, 0x132 - -65)
}
function fm80(p0: set<int>, p1: multiset<int>, globalState: GlobalState): seq<set<int>> {
	DC98([set v0 : int | v0 in multiset{|"hwiqflx"|, |(seq(0x4b, i0  => (|[true, true, false]|)))|} :: (v0 % 0x3a7)]).cf134
}
...
function fm82(p0: int, p1: int, p2: int, globalState: GlobalState): set<map<int, int>> {
	({map[0x11c := 435], map[|"bjw"| := |map[523 := true]|], map v0 : int | (0x6c <= v0) && (v0 < 0xef) :: (v0 % 0x197) := (|map[0x311 := 647]|), map[|map[|map[!true := true]| := false]| := |[true]|]} - {map[|(set v1 : int | (0x2d1 <= v1) && (v1 < 126) :: (v1 - 387))| := -0x116]}) + {map[0xb4 := 296]}
}
...
function fm85(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): multiset<string> {
	multiset{"hodmixbla"} * (multiset(seq(0xed, i0  => (seq(0x1b0, i1  => ('e'))))) - multiset{"hycmemvn"})
}
function fm86(p0: int, globalState: GlobalState): D31 {
	match DC28(DC28(DC24(map[!true := |map[|"bwibtu"| := 0x1d8]|]))) {
		...
		case DC28(cf34) => DC74(seq(0x23a, i0  => (|(seq(0x2a8, i1  => ('f')))|)))
	}
}
...
function fm90(globalState: GlobalState): set<string> {
	{"r" + "oijwbpqva", "fubc" + "cupyg", "sisgcy", if (false) then seq(0x2d5, i0  => ('q')) else "l"}
}
...
class C0 {
	...
	function fm15(p0: int, p1: int, globalState: GlobalState): bool {
		!(true <== ({seq(0x11, i0  => ('o'))} !! (set v0 : string | v0 in {"gv"} :: (v0))))
	}
}
...
class C1 extends T1 {
	...
	function fm6(p0: char, globalState: GlobalState): int {
		(DC4(|(seq(-0x2c9, i0  => ('y')))|).cf4 - -|f23|) % 0x23a
	}
	function fm4(p0: string, p1: int, p2: map<int, bool>, globalState: GlobalState): int {
		0x146
	}
	...
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		...
		for i1 := v5[v0] to v0 {
			...
			v2[405], v7 := !f16, v7.(cf11 := fm5(i1, f16, i1, false, globalState));
			v2 := v2;
			var v8 := 'l';
			r3 := (f23 + "c")[v0 + |f23| := v8];
		}
		...
		var v11 := 'j';
		v10 := v10[f23[v0 := v11] + (seq(-0x191, i2  => (v11))) := |v5|];
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		var v0 := new C0();
		var v1 := 0x53;
		globalState.f7 := v1 / (v1 * |{p0, p0}|);
		v1 := match DC5() {
			case DC4(cf4) => v1 / 0x162
			case DC5() => |map[false := |f23|]| / -0x35f
			case DC3(cf3) => v1 * |cf3|
		};
		...
		var v12: array<int> := new int[24] [v1, v1, 145, 0x2c7, |fm42(v9, f23, globalState)|, if (f16) then v1 else v1, v1, -v1 + v1, v1, fm1(f17, p0, |f23|, globalState), 0x2c6, -538 * v1, v1, 75, |multiset{v1}| / v1, |(v10 + fm41(f16, v1, |v11|, globalState))|, v1, v1, v1, v1, v1, -438, v1, -0x1ae];
		var v13: array<char> := new char[17](i1 => v7);
		v13[903] := v7;
		var v14: map<bool, int> := map[p0 := v1];
		r2, v7, v12, globalState.f7, v13[903] := f16 <==> (v14 == map[true := v1]), v7, v12, v1, if (p0) then v7 else v7;
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		...
		for i0 := v1 to fm4(f23, v1, v2, globalState) {
			...
			v3[468] := if ({v4} in v6) then v6[{v4}] else f16;
			v3[468] := !v3[468] <==> f16;
			var v7: seq<bool> := [f16, v3[468]];
			var v8: seq<int> := [|v7|, 41, v1, i0];
			var v9: map<bool, seq<int>> := map[v3[468] := v8];
			var v10: array<seq<int>> := new seq<int>[21] [v8, v8, v8, seq(0x88, i1  => (v1)), v8, v8, v8, [|v0|, |v0|, fm1(f16, !f16, -0xe3, globalState), v1], v8, v8[i0 := |v7|], [i0], v8, v8[v1 := v1] + v8, v8, v8, if (v3[468] in v9) then v9[v3[468]] else v8, seq(306, i2  => (0x6b)), v8, v8, v8 + [i0], [459]];
			v10[556] := (seq(0x36d, i3  => (0x34e))) + (seq(0x132, i4  => (|f23|)));
			v10[556] := if (v3[468]) then v8 + fm44(v1, true, 119, f16, globalState) else seq(0x293, i5  => (v1));
			v3[468] := f17;
		}
		for i6 := v1 to v1 {
			...
			match (v14) {
				case DC21(cf25, cf26, cf27) =>
					...
					v17, cf26, globalState.f7 := v18[i6], cf26, v1 % v1;
					var v19: map<set<bool>, seq<int>> := map[{f16, f16} := [-0x397]];
					var v20: map<bool, string> := map["ilw" != fm3(f23, (fm45(globalState))[|v19| := f16], "ftrkhyhai", globalState) := f23];
				...
				case DC23(cf29) =>
					...
					var v28: array<int> := new int[20] [v1, v1 * i6, i6, i6 % 0x78, |f23|, v1, |multiset{0x3e6}|, |map[!!f17 := |map[f16 := if (v12 in v27) then v27[v12] else 0x234]|]|, -(if (f17) then i6 else i6), i6, --i6 - v1, fm1(f16, true, 902, globalState), v1, -v1, -v1, v1, -v1 * v1, v1, v1 * v1, |map[f17 := true]|];
					r0 := v28;
				...
				case DC20(cf24) =>
					...
					v32[592] := fm6(if (f16) then if (i6 in v34) then v34[i6] else v33 else 'x', globalState);
					var v35: map<int, int> := map[i6 := v32[592]];
					var v36: map<map<int, int>, bool> := map[v35 := f17];
					v36 := (v36 + fm46(f16, v1, v1, !f16, globalState)) + v36;
					v32[592] := (v32[592] + -i6) + i6;
			}
			...
			var v43 := DC22(|v42|);
			globalState.f13, r0, v13[733], v37 := v38.cf11, v39, fm5(|(v40[fm4(f23, i6, map v41 : int | (0x309 <= v41) && (v41 < -698) :: (v41 / v1) := (f16), globalState)])[|"ieqymobgr"| := v37]|, f16, fm6(v37, globalState), fm5(v43.cf28, f16, v1, f17, globalState), globalState), v37;
			if (f16) {
				v39[281] := i6;
				v39[281] := v1;
				var v44 := "rpv";
				...
				var v46: map<int, int> := map[v39[281] := i6];
				var v49: seq<map<int, int>> := [map v48 : int | (0x130 <= v48) && (v48 < 278) :: (v48 / v39[281]) := (|f23|)];
				var v50: array<map<int, int>> := new map<int, int>[23] [v46, v46, v46, v46, map[v39[281] := -v1], map[i6 := i6], v46, map[v1 := 0x2c3], map v47 : int | (-0xeb <= v47) && (v47 < 23) :: (v47 + v39[281]) := (i6), v46, v46, v46, fm47('x', globalState), v46, v46, map[0x1f := v39[281]], map[v39[281] := v1], map[922 := |v0|], v46, v49[v39[281]], v46, v46, v46];
				var v51 := DC35(v50);
				var v52: map<bool, D15> := map[v45 == v45 := v51];
				v52 := v52[v13[733] := v51];
				var v53: seq<bool> := [if (i6 in v2) then v2[i6] else v13[733], v13[733], if (v13[733]) then f16 else fm2(v13[733], globalState), f16];
				globalState.f3 := v53[v1 + i6];
				var v54: map<seq<string>, string> := map[[v44, v44, v44, v44] := if (f16) then v44 else v44];
				v54 := v54[v40 := v44];
			} else {
				globalState.f13 := v13[733];
				var v55, v56, v57 := m15(v13[733], globalState);
				var v58: map<bool, int> := map[v57 := v1];
				v58 := v58[v13[733] := v55];
				v57 := fm5(v55, f23 != fm3("l", [f17, f16], f23, globalState), |f23| / v55, !v57, globalState);
				var v59: multiset<bool> := multiset{v13[733]};
				var v60: map<D4, int> := map[DC6(map[v57 := v13[733]]) := if (v57 in v59) then v59[v57] else v1];
				var v61 := DC6(map[v13[733] := false]);
				v60 := v60[v61 := v55 * v1];
			}
			...
			decreases 100 - i8
		{
			...
			globalState.f0 := v64;
			if (f17) {
				var v65: map<bool, char> := map[v64 := f23[|(seq(0x3d0, i9  => ('y')))|]];
				var v66 := 'q';
				var v67 := DC18(v1, f17, v1);
				var v68: seq<int> := [v62];
				v65 := v65[f17 <==> fm5(|(seq(0x9d, i10  => ('t')))[v62 := v66]|, v67.cf21, |v68|, v64, globalState) := v66];
				...
				var v82 := DC36(v81);
				var v83: multiset<map<int, int>> := multiset{map[55 := v1], v81, map[|f23[fm4(f23, |{f16}|, map[v73 := v64], globalState) := fm48(f16, v76, f17, v1, globalState)]| := -347], v81[v73 := v1], v82.cf45 + v81};
				var v84: map<int, char> := map[v62 := v76];
				var v85: set<char> := {if (0x2ac in v84) then v84[0x2ac] else v76};
				v79[618], v83, globalState.f13, v64 := v80 + (if (f17) then v80 else v80), multiset{map[v62 := v73]}, v85 !! {v76}, !v64;
				var v86: array<map<string, int>> := new map<string, int>[13](i11 => map[f23 := v1] + DC37(map[f23 := |{|{|{v1, |f23|}|, v1}|, |map[f17 := v62]|}|]).cf46);
				v86[429] := (map[f23 := v73])["unsoodkco" := v1];
		...
		for i12 := |"eyl"| to 524 {
			...
			v96[455] := |{f16, f16, f17}| / i12;
			v96[455] := v1 - -0x245;
		}
		var v97: seq<bool> := [true];
		var v98: map<seq<bool>, string> := map[v97 := f23];
		var v99: array<int> := new int[7];
		var v100: map<int, array<int>> := map[|(fm3(seq(-0x2dc, i13  => ('b')), [f16], f23, globalState) + (if ([f17, f17] in v98) then v98[[f17, f17]] else seq(-0x365, i14  => ('q'))))| := v99];
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		match (v4) {
			case DC9(cf9) =>
				...
				v7, v8[686], v2, v10, v8[262] := v7, f16, v2, v10, v12[--fm6(v10, globalState)];
				var v13 := DC30(seq(0x258, i2  => (v0)));
				v13 := v13;
		}
		
		var v14: seq<int> := [|(seq(36, i3  => ('a')))|, v0, v0, v0, v0];
		var v15: set<seq<int>> := {v14};
		var v16: map<int, int> := map[|(v15 * {v14})| := v14[-686]];
		v16 := v16[v0 := v0 + -v0];
		globalState.f7 := -(-(|f23| + v0) + v0);
		r0 := f16;
		r1 := (v0 % v0) >= |(seq(150, i4  => (v0)))|;
	}
	method m15(p0: bool, globalState: GlobalState) returns (r0: int, r1: array<array<int>>, r2: bool) {
		...
		match (v4) {
			case DC11(cf11) =>
				...
				var v9 := 0x2d2;
				var v10: array<char> := new char[16] [v7, v7, v7, v7, v7, 'j', v7, v7, v7, if (f17 in v8) then v8[f17] else f23[v9], v7, v7, if (fm5(|v6|, true, v9, f17, globalState) in v8) then v8[fm5(|v6|, true, v9, f17, globalState)] else v7, v7, if (f16) then v7 else v7, if (f17) then v7 else v7];
				v10[519] := v7;
				var v11 := DC6(v6);
				globalState.f13, v6, v10[519] := !f17 ==> (v9 > -|v5|), v11.cf5, v7;
				var v12 := "imnnjm";
				v12 := (seq(0x6f, i1  => ('k'))) + v12;
			...
			case DC12(cf12, cf13) =>
				...
				var v21 := 'k';
				v0[195] := fm5((if (v19 in v20) then v20[v19] else cf13) * cf13, p0, cf13, v21 in f23, globalState);
			...
			case DC13(cf14, cf15) =>
				...
				var v26 := -0x97;
				var v27 := DC18(-fm4(v25[v26], v26, map[v26 := false], globalState), cf15, v26);
				match (v27) {
					case DC17(cf19) =>
					...
					case DC16(cf18) =>
						...
						var v43, v44 := m16(|v41[v40[|f23| := v26] := fm1(p0, cf15, |f23|, globalState)]|, f23 + f23, (if (f17) then v42 else v42)[fm6(cf14, globalState) := p0], !f17, globalState);
						v26 := v43 + v43;
						var v45: array<seq<int>> := new seq<int>[14];
						v45[245] := [v26, v26, v26, v44, v43];
						v45[245] := v40;
					case DC19(cf23) =>
						var v46: seq<bool> := [!cf15];
						globalState.f7 := |v46[|v25| := f16]| / 0x101;
						cf15 := f16;
						v0[73] := f17;
						var v47: set<bool> := {p0};
						var v48: map<bool, set<bool>> := map[f17 := v47];
						v0[73] := fm5(v26, fm41(true, v26, v26, globalState) >= (if (false in v48) then v48[false] else v47), 205 % v26, true, globalState);
						v1[752] := |[v0[73]]|;
						r2, v1[752] := f17, v26;
				}
				...
				match (v52) {
					case DC32(cf38, cf39, cf40, cf41) =>
						...
						v0[41] := v53 > v53['b' := fm4(f23, cf40, map[0xf4 := f17], globalState)];
						v0[41] := cf39;
						var v54: seq<bool> := [cf41];
						v0[41] := if (274 in v51) then v51[274] else v54[0x19e];
						var v55 := DC34(v51);
						...
						v26, v0[41], v58[606], globalState.f7 := v26 + v26, v60 != v60, v51 + v63[v26], v26;
					case DC31(cf37) =>
				...
				v1[649] := |v68| + |map[cf14 := v26]|;
				var v69: seq<map<string, bool>> := [v67];
				var v70: map<array<bool>, map<string, bool>> := map[v0 := (v69[|f23|])[f23 := f17]];
				v67, v1[649] := if (v0 in v70) then v70[v0] else map[f23 := fm2(f17, globalState)], v26;
			case DC10(cf10) =>
				var v71: seq<string> := ["rkrhrwk"];
				var v72 := 0x3;
				var v73: map<bool, int> := map[f16 := v72];
				v0[368] := !(v71[|v73|] == "ljk");
				var v74: seq<int> := [|(seq(0x223, i2  => ('r')))|];
				v0[368] := v74 <= v74;
				var v75 := 'x';
				v75 := v75;
				globalState.f0 := (seq(0x21b, i3  => ('y'))) != (seq(566, i4  => ('o')));
				v0[368] := !f16;
			case DC14(cf16) =>
				...
				match (v81) {
					...
					case DC6(cf5) =>
						...
						var v91 := DC16(v87);
						v84, globalState.f13, v85[366], v90 := v84, f16, v91, if (p0) then v90 else v90;
						v1[940] := v84;
						v1[940] := v84;
						globalState.f7 := -fm4(f23, fm1(f17, f17, v1[940], globalState), v88 + (map v92 : int | (-194 <= v92) && (v92 < 0x52) :: (v92 % v84) := (p0)), globalState);
					case DC8(cf8) =>
			...
			decreases 100 - i6
		{
			...
			if (fm45(globalState) < (v106 + v106)) {
				globalState.f7 := -(v100 / v100);
				v1 := v1;
				var v107: map<string, bool> := map[f23 + "ykffasnh" := v105[0x18e] > |{seq(-0x30e, i7  => ('a'))}|];
				var v108 := 'a';
				var v109: map<int, string> := map[v100 := f23];
				r0, v107, v108 := v100, (v107 + v107[f23[v100 := v108] := !f17])[f23 + (if (v100 in v109) then v109[v100] else f23) := p0], v108;
				var v110 := "ucrlq";
				v110 := v110;
				var v111: C0 := new C0();
				...
				var v120: array<map<int, int>> := new map<int, int>[6] [map[v100 := v100], v115, v116[|map[p0 := v118]|], v115, v115, map[|v105| := |v119|]];
				var v121 := DC35(v120);
				...
				v100 := v100 * |v126|;
				var v127: set<bool> := {v106[v100], f16, p0, f16};
	...
	method m16(p0: int, p1: string, p2: seq<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int) {
			...
			decreases 100 - i0
		{
			...
			r0, globalState.f13, v0[681] := fm4(seq(0x8a, i1  => ('i')), 0x100, v1, globalState), !f17, p0;
			if (p3) {
				v0[681] := v0[681];
				r1 := p0 * 0xee;
				...
				var v4 := 'j';
				var v5: map<int, int> := map[|fm49(v4, p1, v0[681], -0x26f, globalState)| := -v0[681]];
				var v6: map<int, int> := map[v0[681] := if (v0[681] in v5) then v5[v0[681]] else v0[681]];
				var v7: set<bool> := {f16, f16};
				globalState.f3, v6, globalState.f10 := f17, map[p0 - v0[681] := fm6(v4, globalState)], (v7 + {false, p3, f17, fm5(|{f16}|, fm2(true, globalState), 605, f17, globalState), true}) - v7;
				var v8: map<bool, string> := map[v0[681] != -p0 := p1];
				v8 := v8[p3 := p1];
			} else {
				var v9: map<bool, int> := map[f17 := v0[681]];
				var v10: multiset<int> := multiset{p0, v0[681], 0xcc};
				...
				v15[336] := map[f23 := v11];
				v0, v15[336] := v0, v12 + v12;
			}
			
			var v16: map<bool, int> := map[f17 := -0x3b1];
			var v17: multiset<int> := multiset{p0, p0, p0, v0[681], p0};
			v16 := v16[f16 := |v17|];
		}
		var v18: array<int> := new int[18](i3 => i3 % p0);
		v18[979] := p0 + p0;
		var v19 := DC4(p0);
		v18[979] := (if (p3) then -636 else p0) + v19.cf4;
		v18[979] := p0;
		r0 := p0 + p0;
		globalState.f8 := p2;
		r0 := v18[979] / |p1|;
...
class C2 extends T3, T0 {
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		...
		if ((if (f19 in v4) then v4[f19] else map v5 : int | (0xb <= v5) && (v5 < 869) :: (v5 / 0x13b) := (f16)) == map[f18 := false]) {
			...
			var v15: array<bool> := new bool[22] [fm8(f16, -f18, -f18, globalState), f17, DC18(|v8|, f17, f18).cf21, f19, f16, f17, fm5(f18, f22, 0x2c6, false, globalState), f22, f17, f22, f16, f22, f17, fm5(|v11.cf30|, f17, f18, if (v12 in v13) then v13[v12] else f16, globalState), f22, f22, f22, f16, f17, !v14[f18], f19, f16];
			var v16: map<set<bool>, array<bool>> := map[v0 := v15];
			v16 := (v16 + v16) + v16;
			var v17 := 'u';
			var v18: array<multiset<bool>> := new multiset<bool>[26](i1 => multiset{f19, v14[-|v9|], !f17, f19, true});
			var v19: multiset<bool> := multiset{v14[f18], f19};
			v18[410] := v19;
			v17, v18[410], globalState.f3 := v17, v19 + multiset{f16}, f17 <==> (if (f17) then f19 else fm2(false, globalState));
		} else {
			var v20: array<int> := new int[20];
			var v21: seq<array<int>> := [v20, v20];
			var v22 := DC10(v20);
			var v23: array<array<int>> := new array<int>[24] [v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v21[f18], v20, v22.cf10, v20, v20, v20, v20, v20, v20, v20, v20];
			v23[685] := v20;
			...
			var v31 := "awadhc";
			var v32 := DC29(v30);
			v23[685], v25, v26[289], v28, v30 := v20, v25, v31[-|v31|], v28, v32.cf35;
			globalState.f7 := |multiset{v23[685], v20, v23[685], v23[685]}|;
			var v33: seq<int> := [f18, -f18, f18];
			if (v33 == [f18]) {
				var v34: map<map<bool, int>, int> := map[map[v29[f18] := -f18] := f18];
				v34 := v34[v24 := f18];
				...
				var v38 := DC21(v23[685], v37, f17);
				globalState.f7, globalState.f7, globalState.f7, globalState.f7, globalState.f7 := fm4(v31, |v38.cf26| % |v29|, v3, globalState), 0x26a, -f18, f18, f18;
				var v39: seq<set<int>> := [{|v36|}, v36, v36];
				var v40: map<set<int>, int> := map[v39[f18] := f18];
				var v41: map<int, int> := map[f18 - f18 := f18 - |v40|];
				v41 := v41[-f18 := fm4("uoognp", |(seq(0x338, i4  => (f21)))|, v3, globalState)];
			} else {
		...
		if (f17 && f22) {
			...
			v48[175] := v49[f22 ==> f16 := multiset{f19, f19} >= v50];
			globalState.f7 := f18;
			globalState.f0 := f17;
			var v51: seq<D9> := [DC22(f18)];
			var v52: seq<int> := [f18];
			var v53 := "d";
			var v54: array<int> := new int[17] [|v51|, -f18, f18, f18 - v52[f18], f18, -0x355, -f18, 0x1f4, f18, |v53|, f18, -|(if (if (f18 in v3) then v3[f18] else f17) then v53 else v53)|, if (f19) then f18 else fm1(f19, f17, f18, globalState), f18, f18, f18, |v53|];
			v54[165] := f18;
			var v55: map<int, string> := map[f18 := v53];
			var v56: seq<string> := [v53];
			var v57: seq<bool> := [f16];
			v54[165], globalState.f7, v53, v53, globalState.f3 := |v52|, f18, fm3(if (f18 in v55) then v55[f18] else v56[v52[|v3|]], v57, v53, globalState), "fjwnrt" + v53, f22;
			if (!f17) {
				var v58 := new C0();
				v53 := "lvwnd";
			...
			var v63: array<int> := new int[5](i6 => i6 / 0x2fe);
			var v64 := "c";
			v63[857] := fm4(v64, 758, v3, globalState);
			v63[857] := 277;
			globalState.f0 := f16;
			var v65: seq<set<bool>> := [v0];
			globalState.f0 := (|v65[-|[f18, -|([f21])[v63[857] := f21]|]|]| + -|fm37(globalState)|) < f18;
			v63[857] := f18;
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v9: array<bool> := new bool[5] [f22, f17, (seq(-0x305, i1  => (v7))) <= v0, f22, f18 <= 0x155];
		v9[490] := !f17;
		f22, v6, v7, v8, v9[490] := v0 == v0[f18 := v7], v6, f21, v8, f18 > (0x49 - f18);
		...
		var v15: map<bool, bool> := map[v9[490] := v9[490]];
	...
	method m13(p0: char, p1: int, p2: string, globalState: GlobalState) returns (r0: D2, r1: bool, r2: bool) {
		...
		v0[17], r2, f22, globalState.f7, globalState.f13 := fm5(f18, f17, |v1|, f19, globalState), f22, f19, p1, f22;
		if (f16) {
			globalState.f3 := !f19 ==> (f18 > f18);
			var v2: array<int> := new int[6];
			var v3: seq<bool> := [false];
			var v4: map<bool, int> := map[v3[p1] := p1];
			v2[165] := fm9([f16], f17, p1, globalState) % |v4|;
			v2[165] := |fm38(fm4(p2, p1, map v5 : int | (-0x89 <= v5) && (v5 < 0x41) :: (v5 % f18) := (f17), globalState) * -p1, |(map[f19 := p1] + v4)|, globalState)|;
			var v6: map<int, char> := map[if (f22 in v4) then v4[f22] else |v1| := f21];
			v6 := v6[v2[165] := p0];
			var v7 := DC18(p1, f19, f18 % f18);
			match (v7) {
				case DC17(cf19) =>
					var v8: array<map<map<bool, int>, array<int>>> := new map<map<bool, int>, array<int>>[2];
					v8[707] := map[v4 := v2];
					var v9: map<map<bool, int>, array<int>> := map[v4 := v2];
					v8[707] := map[map[f22 := p1] := v2] + v9[v4 := v2];
					globalState.f7 := (p1 % |p2|) - p1;
					var v10 := new C0();
					var v11 := m14(f22, globalState);
				case DC18(cf20, cf21, cf22) =>
					var v13 := DC30(v1);
					var v14: set<int> := {|v13.cf36|, v2[165]};
					var v15 := DC31(v14);
					var v16: seq<set<int>> := [set v12 : int | (0x111 <= v12) && (v12 < -0x2e2) :: (v12 / f18), v14, v15.cf37, v14];
					...
					v18[220] := v16;
					var v19: multiset<bool> := multiset{v0[17]};
					var v20: array<multiset<bool>> := new multiset<bool>[5] [v19, v19 + v19, multiset{f17}, v19, v19 + (multiset{v0[17], f17})[cf21 := |[f18]|]];
					globalState.f3, v18[220], v20 := p2 != (p2 + p2), v16, v20;
					var v21: multiset<int> := multiset{v2[165], -cf22};
					f22 := v21 >= v21;
					var v22 := 'v';
					v22 := f21;
				...
				case DC19(cf23) =>
					...
					v27 := v27[v26 := p1];
					v0[17] := fm36(globalState);
					var v28: array<multiset<bool>> := new multiset<bool>[21];
					var v29: multiset<bool> := multiset{f17};
					v28[775] := v29 - multiset{f17};
					v28[775] := v29 - (fm39(p1, f16, |(multiset(v1))[-369 := f18]|, globalState) * (multiset{f17})[v0[17] := f18]);
					var v30 := new C0();
			}
			...
			v32[279] := fm1(v0[17], f17, |p2|, globalState) - f18;
			var v33: map<int, int> := map[f18 := -p1];
			v32[279] := |(v33 + (map v34 : int | v34 in [p1] :: (v34 - p1) := (p1)))|;
			var v35: map<int, bool> := map[p1 := f22];
			var v36 := DC34(v35);
			var v37: map<multiset<int>, bool> := map[multiset(v1) := !f17];
			var v38: multiset<bool> := multiset{multiset{f18, f18, fm4(seq(0x50, i1  => (p0)), v32[279], v36.cf43, globalState)} in v37, v0[17]};
			v38 := v38;
			v35 := v35[p1 := v0[17]];
		...
		var v41 := DC18(f18, f16, fm1(v0[17], f16, f18, globalState));
		var i2 := 0;
		while (824 != -v41.cf20)
			decreases 100 - i2
		{
			...
			globalState.f0 := if ((p1 % f18) in v42) then v42[p1 % f18] else fm8(f19, f18, p1, globalState);
			var v43: array<string> := new string[17](i3 => p2 + p2);
			v43 := v43;
			v0[17] := f17;
			var v44: array<char> := new char[9](i4 => f21);
			var v45: seq<array<char>> := [v44, v44];
			var v46: array<array<char>> := new array<char>[13] [v44, v44, v44, v45[p1], v44, v44, v44, v44, v44, v44, v44, v44, v44];
			var v47: array<array<array<char>>> := new array<array<char>>[8] [v46, v46, v46, v46, if (v0[17]) then v46 else v46, v46, v46, v46];
			v47[540] := v46;
			v47[540] := v46;
		}
		var v48: map<int, bool> := map[f18 % f18 := f22];
		var v49: set<bool> := {v0[17]};
		if (if ((p1 % p1) in v48) then v48[p1 % p1] else !(v49 !! v49)) {
			...
			var v52 := DC4(v50[551]);
			v52 := v52;
			globalState.f7, globalState.f0, globalState.f7, globalState.f14 := v50[551], f22, |p2| % fm1(f22, !f19, 0x66, globalState), v0;
			var v53 := new C0();
		} else {
			var v54: array<string> := new string[6](i6 => "yl" + p2);
			v54[352] := p2 + "wrrg";
			v54[352] := (p2 + p2)[|(seq(-0x239, i7  => (v1)))| := p0];
	...
	method m14(p0: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i2
		{
			...
			if (f19) {
				...
				var v22: array<int> := new int[9](i3 => i3 % 0x8c);
				var v23 := DC10(v22);
				v21[684] := v23.cf10;
				var v24 := "gufp";
				var v25: seq<bool> := [f22];
				v20[675], v21[684], f22, v24 := if (p0) then v18 else v18, v22, f17, fm3(v24 + v24, fm38(f18, f18, globalState) + v25, "trh" + "euonhf", globalState);
				v17 := f21;
				globalState.f7 := f18 / 0x84;
				globalState.f13 := p0;
			}
			
			var v26 := "megqky";
			var v27: T1 := new C1(v26 + (seq(0xe7, i4  => (f21))), fm5(f18, f17, -f18, f19, globalState), f16);
			v27 := v27;
		...
		match (v29) {
			case DC4(cf4) =>
				...
				if (!({v30} < v31)) {
					var v32 := "umwi";
					var v33 := new C1(v32, f17, !(if (p0) then v28[f18] else f19));
					globalState.f7 := f18 / f18;
					...
					globalState.f7 := f18 * |((seq(0x30b, i6  => (353))) + v4)|;
					...
					var v42 := "behcb";
					var v44 := DC22(if (|v42| in v41) then v41[|v42|] else fm4(v42, |v4|, map v43 : int | (768 <= v43) && (v43 < -924) :: (v43 / f18) := (f17), globalState));
					v40 := v40[v37 := v44.cf28];
					v30[462] := f18 - cf4;
					var v45: array<array<map<bool, int>>> := new array<map<bool, int>>[9];
					var v46: array<map<bool, int>> := new map<bool, int>[25] [v38, map[f22 := cf4], v38, v38, v38, v38, fm49(v42[if (!p0 in v38) then v38[!p0] else f18], v42, |v28|, |v42|, globalState), v38, v38, v38, v38, v38, map[f16 := |v42|], v38, v38, v38, fm49(f21, "axxildwtm", 0xf, cf4, globalState), v38, v38, v38, v38, v38, v38, v38, fm49(f21, v42, -f18, cf4, globalState)];
					v45[674] := v46;
					var v47 := DC24(v38);
					var v48: map<bool, D10> := map[cf4 >= f18 := v47];
					globalState.f13, v30[462], cf4, cf4, v45[674] := f17, cf4, |v28|, |v48|, v46;
					var v49: set<string> := {"kyv"};
					v49 := set v50 : string | v50 in fm50(f21, f19, fm36(globalState), globalState) :: (v50);
					var v51: C1 := new C1((seq(-417, i7  => (f21))) + v42, p0, v28[f18]);
					v51 := v51;
				}
				...
				var v57 := 'a';
				v30[287], cf4, v56, v57 := |v56| - f18, -fm1(f17, f17, -cf4, globalState), v56, v57;
				globalState.f13 := f19;
				var v58 := DC20(v53);
				match (v58) {
					case DC21(cf25, cf26, cf27) =>
						...
						v59[326] := multiset{v30[287], v4[0x2d6]};
						v59[326] := cf26;
						v53[621] := if (if (cf27 in v56) then v56[cf27] else f19) then f22 else cf27;
						var v60: seq<seq<int>> := [[fm1(p0, f17, v30[287], globalState), cf4]];
						v53[621], f22 := 42 < 0x24d, (seq(0x7f, i8  => ((seq(646, i9  => (|v56|)))[-0x19a := |v56|]))) != v60;
					case DC22(cf28) =>
						globalState.f0 := p0;
						var v61: set<int> := {v30[287]};
						globalState.f3 := v61 <= v61;
						var v62: map<int, bool> := map[f18 := f19];
						var v64: map<int, int> := map[cf4 := cf4];
						var v65: map<map<int, int>, int> := map[v64 := if (f22 in v52) then v52[f22] else v30[287]];
						cf28 := |(set v63 : int | v63 in multiset([fm4(v55, 0x1bf, v62, globalState)]) :: (v63 * |[0x375, |multiset{['x']}|]|))| * (v4[|{!p0}|] / (if (v64 in v65) then v65[v64] else cf4));
						globalState.f0 := p0;
					case DC23(cf29) =>
						v53[959] := f17;
						v53[959] := false;
						...
						globalState.f7 := fm4((v55 + "htk")[|v67[v30[287]]| := f21], 0x68 * 0x1ab, v68, globalState);
					...
					case DC20(cf24) =>
						...
						v53[393] := f16;
						var v71: multiset<int> := multiset{v30[287]};
						var v72: map<int, int> := map[|fm44(cf4, p0, cf4, f19, globalState)| := f18];
						var v73: map<bool, string> := map[f22 := v55];
						var v74 := DC3(v55);
						v70, cf4, v30[287], v53[393], globalState.f3 := v70, (|v71| - v30[287]) - |v72|, v30[287], f18 < -0xa, ((if (f22 in v73) then v73[f22] else v55) + v55) != v74.cf3;
				}
				
			case DC5() =>
				var v75 := 'i';
				var v76: seq<char> := [f21, f21, f21];
				v75 := if (false) then v76[f18] else v75;
				globalState.f0 := f19;
				var v77: map<bool, int> := map[v28[f18] := f18];
			...
			case DC3(cf3) =>
				...
				var v86: map<bool, int> := map[v28[|v84|] := |v85| * fm9(v28, f22, f18, globalState)];
				v86 := v86[f22 := f18];
				globalState.f3 := if (|map[f17 := p0]| >= f18) then f16 else (seq(43, i10  => (f21))) < cf3;
				globalState.f7 := f18;
				if (fm2(!f22, globalState)) {
					...
					var v97: array<bool> := new bool[27] [f16, !(multiset([f18]) >= v94), !(if (f17) then !p0 else f17), f17, f17, f19, (seq(0x19e, i12  => (f21))) == "igdw", cf3 != "m", f19, f18 <= f18, f18 > f18, p0 && p0, !f19, p0, !(if (f17) then p0 else p0), f16, f16, true, false, {|fm3(cf3, v28, cf3, globalState)|, f18, f18} !! v95, fm2(p0, globalState), f16, !f22, v95 >= fm43(globalState), f17, v96 == v96, f22];
					globalState.f14, globalState.f7 := v97, f18 - fm1(f22, f17, |(map v98 : int | (0x177 <= v98) && (v98 < 0x39d) :: (v98 % f18) := (f18))|, globalState);
...
class C3 extends T2 {
	...
	function fm31(globalState: GlobalState): int {
		(|(seq(0x178, i0  => ('r')))| - |"yhkawadvw"|) - (|"qkwu"| + |{f16, f16, f17, f17}|)
	}
	method m4(p0: string, p1: T0, p2: bool, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		var v0 := "yqx";
		v0 := p0;
		...
		var v7 := DC3(v5[fm1(f17, false, |v6|, globalState)]);
		for i0 := -v1 to v3[|(if (v1 in v4) then v4[v1] else v7.cf3)|] {
			...
			v13, globalState.f13, v0, v14[251] := fm32(v15, i0, globalState) * (set v17 : map<char, bool> | v17 in (seq(0x17, i1  => (map v16 : char | v16 in map[p3 := i0] :: (v16) := (p1.f17)))) :: (v17)), false, v0, p1.f17 <==> p1.f17;
			if (p1.f17) {
				var v18 := new C0();
				var v19: map<string, bool> := map["eoufmxhg" := p1.f16];
				globalState.f7 := (i0 + |v19|) / (v3[v1] * v1);
				var v20 := new C0();
				r0 := i0;
				var v21 := new C0();
			} else {
				var v22 := new C0();
				globalState.f0 := !((v3 + v3)[v1 := |(seq(0x16, i2  => (v1)))|] == (fm33(p1.f16, !p1.f16, false, globalState) + [|v5|]));
				var v23 := new C0();
		...
		var v28 := DC12(map[v27 := p2], v3[0x153]);
		var v29: map<bool, bool> := map[p2 := f16];
		var v30: multiset<int> := multiset{v1, v1, |v29|};
		var v31 := DC7(v1, |[v1, v1]|);
		var v32: array<int> := new int[25] [if (!p2) then v1 else v1, v1, |"iuxywskee"|, |v26|, v1, v1, -v1, v1 % v1, v1, v1, v1, |(v6 - v6)|, v1, -v1, fm6(p3, globalState), v1, v1, |v0| % v1, v28.cf13, v1, v1, |(p0 + v0)|, if (v1 in v30) then v30[v1] else v1, |v0| - v31.cf6, v1];
		v32 := v32;
		var v33 := DC1(p1.f17);
		...
		r1 := if (|((seq(0x3cb, i4  => (p3))) + v0[v1 := p3])| in v36) then v36[|((seq(0x3cb, i4  => (p3))) + v0[v1 := p3])|] else fm30(globalState);
	...
	method m5(globalState: GlobalState) {
		...
		if (f16) {
			...
			var v15 := 'c';
			var v16: array<string> := new string[16] [fm3("xooi", [f16, f16], v10, globalState), v10 + v10, v10, fm3(v10, v11, fm3(v10, v11, v10, globalState), globalState), v10, v10, v10, v10, "ckw", "txu", v10 + v12[|v13|], fm3(v10[|v14| := v15], v11, v10, globalState), (seq(0x1ea, i2  => (v15))) + v10, v10, (v10 + "lsrixilja")[v1 := v15], seq(0x7c, i3  => (v15))];
			...
			if (v19.cf15) {
				v1 := |v11|;
				v16[460] := v10 + (seq(956, i5  => ('i')));
				v16[460] := v10 + v10;
				var v20 := DC4(v1);
				var v21: map<int, int> := map[v20.cf4 := if (f16) then v1 else v1];
				var v22: seq<multiset<bool>> := [v13[f17 := v1]];
				v1, v21, v13 := v1, v21[|v12| := v1], v22[v1 * v1];
				v16[460] := v16[460];
				globalState.f3 := f16;
			} else {
				globalState.f13 := f17;
		...
		match (v24) {
			case DC11(cf11) =>
				...
				var v27: map<multiset<bool>, int> := map[fm35(v1, globalState) := v1 / fm4(v25, |v26|, v2, globalState)];
				...
				v34 := v34[v1 := v1];
				var v35 := DC3(("le")[v1 := fm48(v30.f17, v29, v30.f16, fm4(v25, v1, v2, globalState), globalState)]);
				v25, v27, globalState.f13, v25 := (v25 + v25) + v35.cf3, map[v28 := v1], f16 || (v1 <= v1), v25;
			case DC12(cf12, cf13) =>
				var v36: map<int, int> := map[cf13 := 0xf9];
				v23[206] := -(if (v1 in v36) then v36[v1] else cf13);
				v23[206] := v1;
				var v37: seq<bool> := [f16, f16];
				globalState.f0 := (if (f17) then v37[cf13] else f17) ==> false;
			...
			case DC13(cf14, cf15) =>
				...
				if (if (true) then fm30(globalState) else !((if (v1 in v54) then v54[v1] else v49) < v49)) {
					v46 := (v46 + v46)[-843 := cf14] + (v46 + v46[v1 := cf14]);
					cf14 := cf14;
					var v55: multiset<int> := multiset{v1};
					globalState.f3 := !(v55[v1 := -v1] !! v55);
					...
					v23[761] := v1;
					globalState.f3, globalState.f7, v23[761] := v46 != (seq(522, i7  => ('u')))[v1 := cf14], v1 / v1, v1;
					globalState.f7 := |v44|;
					globalState.f13 := f16;
					var v59: array<set<map<bool, int>>> := new set<map<bool, int>>[5];
					var v60: map<bool, int> := map[f17 := v1];
					v59[892] := {v60, v60};
					var v61: set<map<bool, int>> := {if (true) then map[cf15 := v23[761]] else v60, v60, fm49('t', v46, |map[v23[761] := v1]|, v23[761], globalState), v60, v60};
					v59[892] := v61;
				}
			...
			case DC10(cf10) =>
				...
				if (v62[|v64|]) {
					...
					v4[786] := v66.cf39;
					globalState.f7 := v1;
					var v67: map<bool, bool> := map[v4[786] := v4[786]];
					var v68 := DC38(f17, v1, |v67|, v62[|"pyncpesf"|]);
					var v69: array<bool> := new bool[15] [f17, f17, !false, f16, !f17, f16, f17, v68.cf47, f17, f17, f17, v4[786], f16, v4[786], f16];
					...
					var v74: multiset<char> := multiset{v71[898], v72};
					...
					v78 := (v78 + v78)[-(fm31(globalState) * 56) := v71];
					v1 := v1;
				}
				
				v23[946] := v1;
				v23[946] := fm4(v63, v1, map[v1 := f16], globalState) + v1;
				var v79: multiset<int> := multiset{|v63|};
				globalState.f7, v23[946], v23[946], globalState.f14 := v1 / v1, v1, -|(if (f16) then v79 else multiset{v23[946], |v0|})|, v4;
				var v80: map<bool, bool> := map[f17 := f17];
				var v81 := DC6(v80);
				var v82 := DC8(v81);
				globalState.f13, v82, v23[946], globalState.f7, v23[946] := f17, v82, v1, 300, 569;
			case DC14(cf16) =>
				var v83: set<int> := {v1};
				...
				globalState.f7 := |(([v85] + v86) + v86)[v1 := v85]|;
				var v87: map<int, int> := map[v1 := v1];
				var v88: seq<array<int>> := [v23];
				v87 := v87[fm1(f16, f16, v1, globalState) := |v88|];
				var v89 := DC6(v84);
				var v90: seq<bool> := [f17];
				var v91: seq<bool> := [v90[v1]];
				var v92: seq<seq<bool>> := [[f17]];
				v89, globalState.f13, globalState.f0, globalState.f13 := DC6(v84), if (f16) then f17 else fm2(f17, globalState), !false, (v91 + v92[v1]) <= v90;
		}
	...
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		...
		v8[737] := DC38(f17, -fm1(f16, v4, 414, globalState), -v0, f16);
		v8[737] := fm53(globalState);
		...
		if (fm2(v12[792] in v19, globalState)) {
			...
			var v26: map<bool, int> := map[f17 := v12[792]];
			v25 := fm54(v4, |v26|, v25, globalState);
			var v27: multiset<bool> := multiset{v4};
			globalState.f3 := v27 !! v27;
		}
		
		var v28: seq<int> := [0x2dc, v12[792], |v3|];
		r0 := if (|[f16]| <= v0) then (seq(0x202, i4  => (v12[792]))) + v28 else fm33(v4, f17, v4, globalState);
		r1 := v4;
		r2 := !f16;
		var v29: seq<seq<bool>> := [[v4], v6, v6];
		var v30: map<int, seq<bool>> := map[v0 := v29[v12[792]]];
		r3 := fm3(v5, if (-v12[792] in v30) then v30[-v12[792]] else v6, v5, globalState);
	}
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		var v2 := DC15(v1);
		v0[124] := v2.cf17 == (v1 - v1);
		if (p0) {
			globalState.f3 := true;
			var v3: seq<bool> := [p0];
			globalState.f8 := v3 + v3;
			var v4 := 94;
			var v5: map<int, bool> := map[fm1(p0, f17, v4, globalState) := v0[124]];
			...
			match (v7) {
				case DC38(cf47, cf48, cf49, cf50) =>
					...
					var v9 := "uhdbsnsng";
					var v10: T1 := new C1("hutwhqk", DC18(|v3|, v0[124], if (cf49 in v6) then v6[cf49] else |v9|).cf21, !f17);
					v8[673] := v10;
					var v11: seq<T1> := [v10];
					v8[673] := v11[cf49 % cf48];
					...
					v14 := (v14 + v14) + v14;
				case DC37(cf46) =>
					var v15: map<bool, bool> := map[v0[124] := f17];
					var v16: map<bool, bool> := map[if (!v0[124] in v15) then v15[!v0[124]] else true := if (p0) then f17 else fm2(f17, globalState)];
					v16 := v16[if (false in v16) then v16[false] else v0[124] := false];
					var v17: multiset<int> := multiset{v4, 0x3e3};
					globalState.f7 := fm7(-0x2a1 !in v17, 0x163 % v4, v6, v1 + v1, globalState);
					var v18 := new C0();
					globalState.f7 := v4;
				case DC39(cf51) =>
					var v19 := "qmbwyep";
					var v20 := 'y';
					var v21: T1 := new C1((v19 + (seq(72, i2  => ('d'))))[v4 := v20], f16, p0);
					v21 := v21;
					var v22: map<bool, char> := map[f16 := 't'];
					var v23: array<int> := new int[7];
					var v24: map<bool, int> := map[f16 := v4];
					v23[437] := if (p0 in v24) then v24[p0] else v4;
					var v26 := DC16((map v25 : string | v25 in fm50(v20, f16, !p0, globalState) :: (v25) := (map[v4 := v4]))[fm3(v19, v3, seq(-653, i3  => (v20)), globalState) := v6]);
					var v27: map<int, array<int>> := map[0x1e := v23];
					r0, v19, v22, v23[437], v26 := v4, v19, map[!f16 := v20], |(v27 + v27)|, if (v21.f16) then v26 else v26;
					var v28: seq<int> := [v23[437]];
					r0 := v28[-736 / |v19|];
					var v29 := DC36(v6);
					v29 := v29;
			}
			...
			v0[124] := p0;
			var v30 := new C1(seq(0x288, i4  => ('a')), f17, f17);
		} else {
			var v31 := "evari";
			var v32: seq<bool> := [f17];
			var v33 := new C1(v31, f16 !in v32, v0[124]);
			r2 := p0;
			var v34 := 'f';
			var v35 := 0x18f;
		...
		v45[809] := [v0[124]];
		var v46: map<int, bool> := map[v39 := v41[v39]];
		var v47: map<bool, int> := map[f17 := fm4(seq(-623, i5  => (v43)), v39, v46, globalState)];
		var v48 := "fvv";
		v45[809], v47, v47, v0[124], globalState.f7 := v41, v47 + v47, v47, f16, v39 % |multiset{v39, |v48|}|;
		var v49: map<char, bool> := map[v43 := v0[124]];
		if (if (v43 in v49) then v49[v43] else f17) {
			globalState.f3 := f17;
			globalState.f0 := v0[124];
			var v50: array<multiset<char>> := new multiset<char>[7];
			v50[392] := v44;
			v50[392], v0[124] := v44, (multiset{v43, v43} > (multiset{v43})['g' := v39]) <== f16;
			...
			v0[124] := f17;
			if (f16) {
				r0 := (if (v0[124]) then v39 else |v47|) * v39;
				globalState.f7 := |v45[809]|;
				var v54: seq<D2> := [v42];
				globalState.f3 := !((v54 + v54)[v39 := DC2(v41)] < (if (f16) then v54 else v54));
				var v55 := new C2(v43, if (|fm55(v48, globalState)| in v46) then v46[|fm55(v48, globalState)|] else v53, v39, fm5(v39, p0, v39, v0[124], globalState), v0[124], f17);
				globalState.f7 := v39;
			} else {
				var v56: array<int> := new int[20];
				v56[918] := |(fm3(fm3("atljhiy", [true], v48, globalState), v45[809], v48, globalState) + (seq(0xbf, i6  => (v43))))|;
				var v57: array<D12> := new D12[8];
				var v58 := DC4(v39);
				var v59: map<bool, map<int, int>> := map[!f17 := map[|v40| := v39]];
				var v61: seq<int> := [v39, v39];
				var v62: array<map<int, int>> := new map<int, int>[20] [v40, v40, map[v39 := v39], v40, v40, map[v39 := fm4(seq(0x1e, i7  => (v43)), -455, map[|v48| := p0], globalState)], DC36(v40).cf45, v40, v40, v40[|[v39]| := v58.cf4], v40, if (p0 in v59) then v59[p0] else v40, v40, v40, map v60 : int | v60 in v61 :: (v60 + v39) := (v39), v40, v40, v40, v40[|v48| := v39], v40];
				var v63 := DC35(v62);
				var v64: map<D15, map<int, bool>> := map[v63 := v46];
				r0, globalState.f14, globalState.f13, v56[918], v57 := -|(v64 + map[v63 := v46])|, v0, v0[124], v61[v39], v57;
				...
				var v70: seq<C0> := [v68];
				var v71: multiset<int> := multiset{v56[918], if (v70 in v69) then v69[v70] else v56[918]};
				v56[918] := (if (v53 in v67) then v67[v53] else v39) + -(if (v56[918] in v71) then v71[v56[918]] else v39);
				globalState.f0 := v48 == v48[v56[918] := 'i'];
				var v72 := DC0(fm0(!v0[124], v61[fm1(v53, f16, v61[v56[918]], globalState)], |"uayrqkojt"|, globalState));
				v72 := v72;
			}
			...
			match (v76) {
				case DC11(cf11) =>
					...
					var v83: array<map<int, int>> := new map<int, int>[14] [v40, v40, v40, map v77 : int | v77 in (seq(339, i8  => (v39))) :: (v77 + v39) := (|v46|), v40, fm47(v43, globalState), map v78 : int | (0x380 <= v78) && (v78 < 0x16c) :: (v78 + v39) := (v39), v79[|v81[v40 := v39]|], v40, if (f17) then v40 else v40[|v45[809]| := v39], fm47(v43, globalState), v40, v40 + (map v82 : int | (0x370 <= v82) && (v82 < -837) :: (v82 + v39) := (v39)), map[if (|v1| in v40) then v40[|v1|] else v39 := -|v47|]];
					v83[450] := v40;
					var v85: seq<int> := [v39, v39];
					v83[450] := map v84 : int | v84 in v85 :: (v84 / v39) := (v39 + v39);
					globalState.f0 := (v0[124] ==> v53) <== f17;
					var v86 := new C0();
					var v87 := new C1(fm3(v48, v45[809], v48, globalState), f17, p0);
				case DC12(cf12, cf13) =>
					var v88: multiset<bool> := multiset{v0[124]};
					var v89: map<int, multiset<bool>> := map[v39 := v88];
					var v90 := DC32(v89, true, cf13, p0);
					r2 := v90.cf41;
					var v91: multiset<int> := multiset{|v46|, cf13};
					var v92: seq<int> := [v39];
					var v93: array<int> := new int[10] [-41, cf13 + cf13, cf13, v39 - (if (v0[124] in v88) then v88[v0[124]] else DC22(|"fcha"|).cf28), cf13, cf13, -v39, v39 + v39, if (-v39 in v91) then v91[-v39] else v39, v92[|v46|]];
					v93[747] := -(cf13 + cf13);
					v93[747] := |((v41 + v41) + v41)[v39 := v53]|;
					v93[747] := -(-v39 * |v1|) % (if (0x2e2 in v40) then v40[0x2e2] else v93[747]);
					globalState.f7 := v93[747] * v39;
				case DC13(cf14, cf15) =>
					globalState.f3 := fm2(v0[124], globalState);
					var v94: multiset<bool> := multiset{v0[124], p0};
					var v95 := DC41(v94);
					r2 := v95.cf53 <= v94;
					...
					var v99: seq<int> := [-(v39 / v39), v39, (if (|v48| in v98) then v98[|v48|] else -0x75) + v39];
				...
				case DC10(cf10) =>
					var v102 := new C0();
					var v103 := m12(v1, v0[124], globalState);
					var v104 := new C0();
					v43 := v43;
				case DC14(cf16) =>
					globalState.f7 := v39;
			...
			var v109: array<string> := new string[15] [v48[0x3d0 := v43], v48, v48, v48, ("gguk")[v39 := 's'], v48, v48, v48, v48 + fm3(seq(0x1c6, i9  => (v43)), [v0[124]], v48, globalState), v48, v48 + v48, v48, v48[v39 := v43], seq(0x3c2, i10  => (v43)), v48];
			v109 := v109;
		}
		
		var v110: multiset<bool> := multiset{!f16};
		var v111: seq<int> := [|(seq(-400, i11  => (v43)))|];
		var v112: map<seq<int>, int> := map[v111 := v39];
		var v113 := DC26(v0[124], |v110|, |v112|);
		var v114 := DC28(v113);
		match (v114) {
			case DC25() =>
				var v115 := new C1(if (!p0) then "iojph" else seq(0x1a7, i12  => (v43)), p0, v0[124]);
				v111 := v111;
				v43 := v43;
			...
			case DC26(cf31, cf32, cf33) =>
				...
				match (v117) {
					case DC17(cf19) =>
						...
						var v119: array<array<bool>> := new array<bool>[15] [v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v118[|v48|], v0];
						v119 := v119;
						v2 := v2;
						r0 := cf33 / |(v45[809] + cf19)|;
					...
					case DC18(cf20, cf21, cf22) =>
						...
						var v127: map<int, char> := map[|v125| := fm48(f17, v43, cf31, |(map v126 : int | (0x84 <= v126) && (v126 < 987) :: (v126 % |v110|) := (cf31))|, globalState)];
						v127 := (v127 + v127) + (map v128 : int | v128 in v40 :: (v128 + cf22) := (v43));
					case DC16(cf18) =>
						var v129: set<int> := {cf33, v39};
						v129 := v129;
						v0[124] := fm5(cf33, p0, v111[|v111|], f16, globalState);
						globalState.f7 := cf33 % -0x63;
						var v130 := new C2(fm48(true, v43, v0[124], cf32, globalState), cf31 <==> f17, |(v48 + v48)|, cf31, v0[124], 0x9e <= |v48|);
					case DC19(cf23) =>
						var v131: multiset<D16> := multiset{DC36(v40)};
						var v132: multiset<multiset<D16>> := multiset{v131};
						v132 := v132;
						globalState.f7 := (if (p0) then -884 else cf32) * v111[-v39];
						...
						var v139: array<int> := new int[21] [cf33, cf33, |v136|, cf33, v39, fm1(f16, v0[124], 0x2ca, globalState), 0x31a, cf32, cf32, cf33, 0x223, |v48|, v39, cf33, cf32, cf33, cf32, v39, |v48|, |v48|, |v138[v39]|];
						var v140: seq<array<int>> := [v139, v139];
						var v141: map<int, seq<array<int>>> := map[-|v135| := (v140 + v140)[|v45[809]| := v139]];
			...
			case DC27() =>
				...
				match (v150) {
					case DC40(cf52) =>
						...
						v0[124] := if (v153 <= v153) then f17 else f17;
				}
				
				var v154 := DC34(v46);
				r2, v0[124], v147, globalState.f7, v154 := f17, f17, v147, v39, if (f16) then v154 else v154;
			case DC24(cf30) =>
				...
				match (v156) {
					case DC32(cf38, cf39, cf40, cf41) =>
						...
						var v162: map<int, D8> := map[v39 := v161.(cf19 := v45[809])];
						var v163: seq<map<seq<int>, string>> := [v157];
						v160[307], v162 := v157 + v163[v39], v162[v39 := v161];
						globalState.f13 := f17;
						var v164: array<string> := new string[19] [v48, "ggekyb", "weatje", "oedpmt", v48, v48 + v48, v48, v48, seq(0x3cf, i16  => (v43)), "wgfxwmg", v48, v48, v48 + v48, v48, v48, v48, v48, "xiamvv" + v48, v48[|v111| := v43] + v48];
						v48, v164, globalState.f7, v48 := v48 + (v48[cf40 := v43] + v48), v164, v39 % cf40, v48;
						globalState.f8 := if (cf41) then v41 else v45[809];
					case DC31(cf37) =>
						v0[124] := (v39 % v39) > v39;
						var v165: array<string> := new string[22](i17 => v48);
						v165[870] := "blb";
						v165[870] := seq(0x2c, i18  => ('y'));
						var v166: array<int> := new int[8](i19 => i19 / v39);
						v166[345] := v39 * v39;
						v166[345] := --(v39 % (v39 % v39));
						var v168: map<bool, seq<map<int, bool>>> := map[f16 := seq(-0x36c, i20  => ((map v167 : int | (-0xac <= v167) && (v167 < 389) :: (v167 - v166[345]) := (f17))[v166[345] := f16]))];
						var v169: seq<map<int, bool>> := [v46];
						globalState.f7 := |(if (v0[124] in v168) then v168[v0[124]] else v169)[|cf37| + v166[345] := if (!f17) then v46 else v46]|;
					case DC33(cf42) =>
						...
						v172 := v172[p0 := v48[v39]];
				}
				
				if (v0[124]) {
					var v173: set<string> := {(seq(0x3d, i21  => (v43)))[v39 := v43], "ftkew", ("vlx")[v39 := v43]};
					v0[124] := v173 >= (v173 - {"v"});
					r0 := if (v0[124]) then |"dxukjaqr"| else v39 % v39;
					var v174: map<bool, map<int, int>> := map[f16 := v40];
					v155 := if (v0[124]) then v155 * {v39, |v174|} else v155 * {v39, fm6('d', globalState), if (f17 in v110) then v110[f17] else v39};
					...
					var v183 := new C0();
					globalState.f8 := v45[809];
				}
				
				v46 := v46[|map[v39 := v43]| + v39 := v0[124]];
				var v184: array<map<bool, int>> := new map<bool, int>[7];
				v184[338] := cf30;
				v184[338] := v47;
			case DC28(cf34) =>
				var v185: seq<string> := [v48, v48];
				var v186: C2 := new C2(v43, !f16, -v39 - |v185|, v39 != 0x2de, if (f16) then p0 else !v0[124], v0[124]);
				v186 := v186;
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		...
		var v2: seq<int> := [v1];
		var v3 := "dv";
		var v4: seq<seq<int>> := [v2, fm44(v1, f17, v1, !f17, globalState), v2 + v2, [v1, v1] + v2[v1 := |v3|]];
		globalState.f7 := |v4|;
			...
			decreases 100 - i0
		{
			...
			v11[690] := v3;
			v11[690] := fm3(v3 + v3, fm38(v1, v1, globalState), "vqbfc", globalState);
			var v12: array<seq<int>> := new seq<int>[2];
			var v13: multiset<string> := multiset{v3, "l", v11[690], v3};
			v12[991] := v2[if (v3 in v13) then v13[v3] else v1 := v1];
			globalState.f0, globalState.f3, v12[991], globalState.f13 := f17 || f17, f17, v2, f17;
			var v14 := new C1(if (fm2(f17, globalState)) then fm3(v11[690], v5, seq(0x118, i2  => (v6)), globalState) else v3, f16, f17);
			globalState.f3 := f17;
		}
		...
		if (f16 <==> f16) {
			if (fm2(f17, globalState)) {
				...
				var v17 := new C2(v6, fm30(globalState), -(v1 / -v1), fm30(globalState), {v1} in v16, f17);
				globalState.f13 := fm2(!v17.f22, globalState) <== f17;
				globalState.f7 := v2[if (f16) then v1 else |v3|];
				var v18 := new C1(v3, v5[v1], v17.f22);
				...
				v21[228] := if (true in v24) then v24[true] else if (f16) then v23 else v23;
				var v25 := DC43(f16, |v3|);
				...
				var v29: seq<array<int>> := [if (f16) then v28[|v5|] else v27, v27, v27, v27, v28[v1]];
				v29 := v29 + v28;
				v1 := v1;
			}
			
			var v30: map<int, seq<D8>> := map[v1 := seq(0x20d, i4  => (DC19(DC16(map[v3 := map[v1 := v1]]))))];
			...
			var v37: array<int> := new int[16] [fm1(f16, f17, -v1, globalState) / |v2|, if (fm30(globalState)) then v1 else |v36|, v1 % v1, -fm31(globalState), v1 % v1, -v1, 0x2c2 / v1, v1, v1, v1, v1, v1, v1, 0x3c2, v1, v1];
			v37[111] := v1;
			v37[111] := |v3|;
			...
			if ((v38[v1] > v10) || (if (f16) then f16 else f17)) {
				var v39 := new C0();
				v0 := v0;
				...
				v45[820] := v49;
				var v50: array<int> := new int[8](i6 => i6 % v1);
				v50[369] := -(v1 % v1);
				globalState.f13, globalState.f7, v50[369] := !(v1 <= v1), v1, v1;
				globalState.f7 := v1;
			}
			...
			v53[669] := v52;
			if (f16) {
				globalState.f3 := !(([f16, true, f17] + v5[v1 := true]) < v5);
				...
				v64[694] := |v5| < (if (-v1 in v65) then v65[-v1] else |v5|);
				var v66 := DC2([false]);
				...
				v64[694] := !(v68 !! v68);
				globalState.f13 := v64[694];
				var v69: array<C2> := new C2[14];
				var v70: map<int, array<C2>> := map[v1 := v69];
				var v71: C2 := new C2(v6, f16, |"s"|, !v64[694], f16, f16);
				...
				v73[758] := v69;
				v73[758] := v69;
				var v74: map<bool, int> := map[v64[694] := v1];
				v3, v1 := v3[|v74| := v71.f21] + (seq(0x2db, i7  => (v71.f21))), (v1 % v1) % v1;
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		for i3 := v0[941] to v1 - v1 {
			...
			v3[636] := !!(f17 <==> (if (-|v8| in v2) then v2[-|v8|] else f17));
		...
		var v13 := "vhuvidmf";
		var v14 := 'x';
		var v15: multiset<int> := multiset{v0[941]};
		var v16: seq<int> := [v1];
		var v17: map<int, int> := map[0x32 := v0[941]];
		v12, v13, v14, v1, v13 := v12 + v12, (seq(0xc3, i4  => ('d'))) + v13, v14, (|v15| / v16[|[|v17|, v1, |{v2, v2, map[v0[941] := f17]}|, v0[941]]|]) / fm1(fm30(globalState), true, v1, globalState), v13;
		var v18: map<array<int>, bool> := map[v0 := !false || f16];
		v18 := v18[v0 := f17];
		v3[364] := v16 != [v1];
		v3[364] := fm30(globalState);
		r0 := f16;
	...
	method m12(p0: set<bool>, p1: bool, globalState: GlobalState) returns (r0: bool) {
		if (fm2(f17, globalState)) {
			...
			match (v3) {
				case DC17(cf19) =>
					...
					globalState.f7 := v4;
					var v5 := "icefeov";
					globalState.f0, v5 := !fm2(f17, globalState), (seq(0x104, i0  => ('q'))) + v5;
					v5 := v5 + v5;
				case DC18(cf20, cf21, cf22) =>
				...
				case DC16(cf18) =>
					...
					var v20: C0 := new C0();
					var v21: set<C0> := {v20};
					var v23: array<set<int>> := new set<int>[23] [v11, v11, fm43(globalState), v11, v11, v11, {|v14|}, set v16 : int | v16 in v14[if (f17 in v15) then v15[f17] else v9 := |p0|] :: (v16 / 338), v11, v11, v11, {fm7(v17.cf15, v9, map v18 : int | (0x376 <= v18) && (v18 < 0x73) :: (v18 / v9) := (v9), p0, globalState)}, v19.cf37, {|(seq(0x28d, i2  => ('c')))|}, v11, DC31({|v21|}).cf37, v11, set v22 : int | v22 in v10 :: (v22 % 659), v11 * v11, v11, v11, v11 - v11, v11 - fm43(globalState)];
					v23[683] := fm43(globalState);
					v23[683] := {v9};
					var v24: seq<string> := [v12, v12];
					var v25: map<int, bool> := map[v9 := f16];
					v9 := fm4(v24[v9] + v12, v9, v25, globalState);
					globalState.f13 := f16;
				case DC19(cf23) =>
					var v26 := 0x3ab;
					v0[165] := v26 > |v1|;
			...
			if (true) {
				...
				var v31 := 0x299;
				var v32 := 'n';
				var v33: map<string, int> := map[v30 + v30[v31 := v32] := v31];
				...
				var v39: array<int> := new int[16] [|p0|, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v38[|v1|]];
				...
				var v49: array<int> := new int[28] [if (f16) then v31 else if (f17 in v34) then v34[f17] else v31, v31, v31, -v31, |v35|, v31, v31, v31, |v37|, v31, v31, v38[v31], if (p1) then v31 else v31, v31, v31, v31, v31, v31, v31, if (v40 in v41) then v41[v40] else v31, |v1|, |((if (v46 in v47) then v47[v46] else seq(0x146, i3  => (v32))) + v30)|, if (|v37| in v48) then v48[|v37|] else v31, v31, v31, v31, v31, v31];
				var v51: seq<string> := [v30];
				var v52: seq<seq<string>> := [v51];
				v39[450] := |(map[v30 := f17] + (map v50 : string | v50 in v52[-v31] :: (v50) := (!f17)))|;
				v39[450] := if ((v31 / v31) in v37) then v37[v31 / v31] else |v38|;
				globalState.f13 := v30 < (v30 + v30);
				var v53: map<bool, D10> := map[f17 := v44];
				var v54: map<string, map<int, int>> := map[v51[v31] := v48];
				var v55 := DC16(v54);
				var v58: multiset<D8> := multiset{v55.(cf18 := map v56 : string | v56 in (set v57 : string | v57 in v51 :: (v57)) :: (v56) := (map[v39[450] := v31])), v55};
				var v59 := DC15(p0);
				v30, v39[450], v53 := v30[0x126 := 'k'], fm7(if (f17) then f16 else p1, |v30| + v39[450], v48 + map[|v58| := -0x74], v59.cf17, globalState), map[f16 := v44];
				var v60: T0 := new C2(v32, p1, v39[450], f16, p1, true);
				...
				v67 := v67[|"ckgwxril"| := |((seq(402, i4  => (v65))) + v63)|];
				v0[827] := !f16;
				v0[827] := p1;
				var v70: seq<map<int, bool>> := [map[v64 := v1[v64]], map[v64 := f17] + v69, v69];
				var v71: seq<multiset<bool>> := [multiset{f17}, v68];
				var v72: map<seq<multiset<bool>>, char> := map[v71 := 'x'];
				var v73: set<char> := {'s', if ((seq(107, i5  => (multiset{f17, true}))) in v72) then v72[seq(107, i5  => (multiset{f17, true}))] else v65, v65};
				var v74 := DC4(-|v63|);
				var v75: map<D3, int> := map[v74 := v64];
				var v76: array<int> := new int[29] [v64, |v1|, v64, v64, -v64, |v63| % v64, v64, -v64 % v64, v64, -0x13b, -v64, v64 - v64, |v66| * v64, v64, v64, v64 + v64, v64, if (v74 in v75) then v75[v74] else |(seq(-0x6d, i6  => (map[f16 := f17])))|, v64, |("qdafsw")[-fm1(v0[827], v0[827], v64, globalState) := v65]|, -(v64 + v64), -v64, v64, |(v1 + v1)|, v64, v64 * v64, if (v0[827] in v68) then v68[v0[827]] else v64, 20, -v64];
				v76[901] := v64;
				var v77 := DC7(v64, v64);
				var v78: seq<string> := ["kyw"];
				v70, globalState.f7, v73, v76[901] := if (([v63])[v77.cf7 := v63] < v78) then v70 else fm60(v64, globalState), 0x335, v73, v64 * |("miumep")[v64 := v65]|;
			}
			
			var v79 := 'y';
			if (v79 in (seq(0x3b8, i7  => (v79)))) {
				var v80 := 0x10c;
				...
				v85[748] := |fm39(|v86|, false, v80, globalState)|;
				var v87 := DC13(v79, f17);
				globalState.f3, globalState.f13, globalState.f7, v85[748] := (if (f17) then v87 else DC13(v83[v85[748]], f17)).cf15, !(if (false) then f17 else p1), v80, v85[748];
			} else {
				var v88: array<int> := new int[24];
				var v89 := 0x35b;
				v88[115] := if (f16) then v89 else v89;
				v88[115] := ---v89;
				var v90 := "fs";
				globalState.f3 := "n" < v90;
				globalState.f7 := --v89;
				var v91: seq<int> := [v88[115]];
				var v92: map<bool, seq<int>> := map[false := v91];
				var v93: map<int, seq<int>> := map[0xb6 := seq(-0x30c, i9  => (v89))];
			...
			if (if (map[|v98| := |v99|] != v100) then f16 else v97.f22) {
				...
				v98 := seq(361, i10  => (v97.f21));
				var v102: array<string> := new string[2] [v98, v98];
				var v103: map<map<map<int, int>, int>, array<string>> := map[map[map v101 : int | (0x1d4 <= v101) && (v101 < 0x31e) :: (v101 / v96) := (220) := |v98|] + map[v100 := v96] := v102];
				...
				var v108: array<bool> := new bool[9] [!p1, f17, (if (f17 in v106) then v106[f17] else v105) == v105, true, v107 in {v107}, !f17, false, !(f17 && p1), ([f17, v97.f22])[0x2c4 := v97.f22] < v99];
				v108[700] := p1;
				...
				var v114: array<int> := new int[19] [v96 - v96, v96, v96, v97.fm4(seq(0x13e, i12  => ('c')), |fm3(v98, v99, v98, globalState)|, map[v96 := v97.f22], globalState), v96, |[v97.f22, f17]| / v96, v96 % |v109|, v96, v96, v96, v96, v96 % v96, fm1(v97.f22, v97.f22, |v99[v96 := v97.f22]|, globalState), v96, v96, v96, v96, |v112|, |v113| + v96];
				v114[291] := -0x375;
				var v115: map<bool, string> := map[v97.f22 := v98];
				v108[700], v114[291], globalState.f0, globalState.f7, r0 := f17, v96 + |(v109 + v109)|, v96 >= v96, v96, ("hnortr" + (if (!true in v115) then v115[!true] else v98)) <= ((seq(442, i13  => (v97.f21))) + v98);
				globalState.f0, globalState.f13, v96 := v108[700] <== !(true ==> v97.f22), f17, v96;
			} else {
				...
				v118 := v118[f16 := v117];
				var v119: array<int> := new int[28](i14 => i14 % v96);
				v119[441] := v96;
				var v120: array<bool> := new bool[5];
				v120[966] := !p1;
				v119[441], v120[966], globalState.f3, v117, globalState.f3 := v96, f16, f16, v117, f17;
				var v122: seq<map<int, int>> := [map v121 : int | (25 <= v121) && (v121 < 39) :: (v121 % v119[441]) := (v96), v100];
				globalState.f10, globalState.f7 := p0, -|v122|;
				var v123 := new C0();
				var v124: map<bool, int> := map[f16 := |v99[|v116| := f17]|];
				var v125 := DC24(v124);
				var v126 := DC28(v125);
				var v127: seq<D10> := [v126, v126];
				var v128: multiset<int> := multiset{v96, v119[441], |v99|, v119[441]};
			...
			v131[292] := v98[v96 := v95];
			globalState.f0, v130, globalState.f7, v131[292], globalState.f7 := p1, v130, |(("lxsfjouw" + "dprmgy") + v98)|, v98, (if (f17) then v96 else v96) % v96;
		}
		...
		var v144: array<int> := new int[17] [|map[v133 := v134]| / |v135|, v136, v136 - v136, v136 / v136, v136, v136, if (f17) then -v136 else v139[v136], v136, v136, v136, |(if (f17) then v143 else v143)|, if (p1) then |v132| else v136, v136, v136, v136, v136, if (f16 in v135) then v135[f16] else v136];
		...
		if (v148 > v148) {
			...
			if (!(|v149| != (v144[582] * v144[582]))) {
				var v150: C1 := new C1(v134 + v134, p1, fm5(|v134|, true, v136, true, globalState));
				v150, globalState.f13, globalState.f13 := v150, if (fm5(v136, p1, v136, false, globalState)) then true else f17, v132[if (f16 in v135) then v135[f16] else v136];
				...
				v144[582] := v157 + -fm4(v134, 0xb4, map[v136 := v159], globalState);
			} else {
				var v160 := new C0();
				var v162: set<int> := {v144[582]};
				...
				v144[582], v144[582], globalState.f14 := fm4(v134, v136, map v161 : int | (525 <= v161) && (v161 < 611) :: (v161 + v136) := (f16), globalState), |(if (p1) then v134[v144[582] := v133] else ((seq(786, i16  => (v133)))[v144[582] := v133])[|v134| := v133])| * |v132|, if (fm43(globalState) >= (if (false in v163) then v163[false] else v162)) then v164 else v164;
				var v165: map<char, int> := map[v133 := |p0|];
				v144[582] := v144[582] % -|v165|;
				var v166: map<int, char> := map[v144[582] := v133];
				var v167: map<bool, bool> := map[p1 := f16];
				var v168 := new C2(DC13(if (v144[582] in v166) then v166[v144[582]] else v133, fm2(f17, globalState)).cf14, f17 <== f16, if (f16) then |v167| else v144[582], f17, p1, !false);
				var v169: array<array<D17>> := new array<D17>[18];
				var v170 := DC38(p1, v136, v144[582], f16);
				var v171: array<D17> := new D17[3] [DC38(p1, -v136, v136, f16), v170, v170];
				v169[993] := v171;
				var v172 := DC31(v162);
				v169[993], globalState.f7, v170, globalState.f10, globalState.f13 := v171, |v172.cf37|, v170.(cf47 := if (f16) then p1 else p1, cf49 := v136 % v144[582]), p0, !p1;
			}
			...
			if (p1) {
				...
				var v178: map<int, array<bool>> := map[|v174[|v176.cf59| := v144]| % v136 := v177];
				...
				v179 := v179[v136 := v177[168]];
				var v180: set<int> := {v139[v136], v136, |p0|};
				globalState.f0 := !(v180 >= v180) ==> (p1 <==> false);
			} else {
				v134 := (if (p1) then v134 else seq(831, i17  => (v133))) + (seq(-0x35d, i18  => ('j')))[v144[582] := v133];
				...
				v184[992] := fm61(true, v134, f16, f16, globalState);
				var v185: map<bool, bool> := map[f17 := p1];
				v181[48], v184[992], v144[582] := DC8(v182), [v185], v144[582];
				var v186: array<bool> := new bool[21](i21 => [f17] != v132);
				v186[897] := p1;
				v186[897] := v144[582] != (v136 * v136);
				var v187: set<int> := {v144[582], v144[582]};
				var v188: set<int> := {|v187|, v144[582]};
				var v189: seq<set<int>> := [v188];
				v189 := (seq(178, i22  => (v188))) + (seq(-0x1c1, i23  => (DC31(v187).cf37)))[|v134| := v189[v144[582]]];
				v140 := v140[fm6(v133, globalState) := if (v136 in v146) then v146[v136] else v144[582]];
			}
			
			var v190: array<bool> := new bool[10];
			var v191: array<array<bool>> := new array<bool>[3] [v190, v190, v190];
			v191[388] := v190;
			globalState.f0, v191[388], v139 := !(v135[false := v136] >= v135), v190, v139;
			v144[582] := 0x358;
		}
...
class C4 extends T3 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		globalState.f7, globalState.f7, v0[669] := f18 - f18, fm1(fm8(true, -240, f18, globalState), f17, f18, globalState), |(match v1 {
		...
		if (f16) {
			...
			globalState.f0, globalState.f0, v2, v3[886], v0[669] := !(fm1(f19, v2.f16, 932, globalState) >= v0[669]), v7 <= {!!v2.f17}, v2, v6, v0[669];
			r0 := f18 < (if (false) then -f18 else v0[669]);
			var v8 := DC13(v4[f18], f19);
			var v9: map<int, bool> := map[f18 := v5[fm1(fm2(!!v2.f17, globalState), f16, v2.fm6(v8.cf14, globalState), globalState)]];
			var v10: map<int, int> := map[f18 := v0[669]];
			v9 := v9[v0[669] := map[f18 := |v10|] != v10];
			var v11 := new C0();
			...
			var v17: seq<int> := [|v16[true := f18]|, v0[669], |v16|];
			var v18 := DC43(f16, |v17| + f18);
			var v20: set<int> := {v0[669]};
			var v21 := "ukwutyv";
			globalState.f0, v12[96], v0[669], v18 := f17, ((set v19 : int | (0x393 <= v19) && (v19 < 0x2f1) :: (v19 % v0[669])) * v20) > v20, |fm55(v21 + (seq(833, i1  => ('m'))), globalState)|, v18;
			globalState.f7 := f18;
			v0[669] := f18 / -v0[669];
			var v22: array<char> := new char[27];
			var v23 := 'w';
			v22[595] := if (v12[96]) then v23 else v23;
			v22[595] := v23;
		}
		...
		if (v0[669] <= v0[669]) {
			...
			var v28 := "drlh";
			v27[98] := fm62(f18, v28, f17, f19, globalState);
			var v29: multiset<int> := multiset{v0[669], v0[669]};
			var v30: seq<int> := [v0[669]];
			var v31 := DC0(v29 - multiset(v30));
			v27[98] := v31;
			var v32: map<bool, array<int>> := map[f19 := v0];
			v32 := v32[f19 := v0];
			v0 := new int[3];
			var v33: map<int, bool> := map[|(seq(0x3df, i3  => (v25)))| := f19];
			...
			v35[752], v0[669], v35[221], globalState.f7, v0[669] := f19, f18, v0 !in v39, -f18, -0x261 % -0x2b3;
			var v40: seq<array<bool>> := [v35];
			v35 := v40[f18];
			v40 := v40 + v40;
			globalState.f7 := v0[669] % (fm63(0x236, globalState)).cf40;
			var v41: set<int> := {f18, v0[669]};
			var v42: seq<set<int>> := [v41];
			var v43 := DC7(v0[669], v0[669]);
			var v44: seq<int> := [|v42|, -v0[669] * -0x120, f18, v0[669], v43.cf6];
			v44 := v44;
		}
		
		globalState.f13 := f17;
		var v45: set<int> := {v0[669]};
		var v46 := DC31(v45);
		var v47 := DC33(v46);
		var v48: seq<D13> := [v47, v47];
		v48 := v48 + v48;
		var v49 := "yhqncq";
		v49 := "yhfgepq" + (seq(0x381, i4  => ('y')));
		r0 := f16;
		var v50 := 'o';
		var v51 := DC22(-0x218);
		var v52: map<char, int> := map[v50 := v51.cf28];
		r1 := v52 != (map v53 : char | v53 in v49 :: (v53) := (-v0[669]));
	}
}
...
class C5 extends T2, T0 {
	...
	function fm5(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): bool {
		0x311 >= -(|map[true := |"upssp"|]| / |map[0x201 := |map[|{'g', 'h', 'p', 'w'}| := |multiset{|[f16]|}|]|]|)
	}
	method m4(p0: string, p1: T0, p2: bool, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		globalState.f7 := -0x5c;
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			var v12: set<int> := {v0};
			var v13: set<int> := {|v12|};
			var v14: multiset<string> := multiset{p0[|v13| := p3], p0, p0, p0 + p0};
			...
			r2, v9, globalState.f3, v10[438], v14 := v0, if (f16 in v15) then v15[f16] else v9, v18 > v18, v19 + v19, v14;
		}
		...
		if (v21 == v21) {
			...
			v29 := multiset(v31) - (v29 - v29[v28 := |v33|]);
			...
			v37 := v37;
			r1 := p0 != (p0 + (seq(258, i7  => (p3))));
		} else {
			var v38 := "epdvy";
			var v39: multiset<bool> := multiset{p2, f17};
			v38, globalState.f3 := v38, (multiset{f16} + v39) >= v39[p1.f17 := v21];
			...
			match (v43) {
				case DC45(cf60, cf61, cf62, cf63) =>
					...
					var v45: map<bool, string> := map[!p1.f17 := fm3(p0, v44, v38[v40[823] := p3], globalState)];
					var v46: set<int> := {v40[823]};
					var v47: map<int, set<int>> := map[0x307 := v46];
					v45 := v45[v21 != |(if (-v40[823] in v47) then v47[-v40[823]] else {v40[823], v40[823], v40[823]})| := seq(460, i8  => (p3))];
				...
				case DC46(cf64) =>
					...
					var v54: array<D19> := new D19[26] [v53, v53.(cf54 := p1.f16, cf56 := f16), v53, v53, v53, v53, v53.(cf56 := p1.f16, cf55 := v40[823]), v53, v53, v53, v53, v53, v53, v53, v53, v53, DC42(!p1.f16, 0x3bf, false), v53.(cf54 := f17), v53, DC42(p1.f16, v40[823], p1.f16), v53, v53, v53, fm64(globalState), v53, v53];
					var v55: map<array<D19>, array<int>> := map[v54 := if (p1.f16) then v40 else v40];
					v55 := v55[v54 := v40];
					var v56: map<bool, D9> := map[v40[823] >= v21 := DC22(v40[823])];
					v56 := v56[p1.f17 := fm65(v21, v21, globalState)];
					var v57: multiset<int> := multiset{v21};
					v57 := v57;
					var v58: map<bool, string> := map[p1.f17 := v38[|v38| := 't']];
					v58 := v58 + v58;
			}
			...
			decreases 100 - i9
		{
			...
			var v66: seq<int> := [v21 * v21, |v63| % -|v65|, |v65|];
			...
			v75 := v75 - (v75 + v75[v72 := v21]);
		}
		var v76: seq<bool> := [p2];
		var v77: map<bool, int> := map[p1.f17 := |v76|];
		r0 := |(((p0[|v77| := p3])[v21 := 'g'] + p0) + p0)|;
	...
	method m5(globalState: GlobalState) {
		...
		if (f17) {
			...
			if (v3.cf21) {
				...
				globalState.f8 := (v15 + v15)[|v16| := f17] + [f17, f16];
				v14[333] := v2 != v2;
				v14[333] := !(298 <= v2);
				globalState.f0 := f17;
			}
			...
			globalState.f13 := if (f17) then v18 < (seq(0x289, i0  => (v17))) else f17;
			...
			var v26: array<bool> := new bool[25] [v19[|fm66(f16, !f16, v2, v0, globalState)|], 's' in v21[fm7(f17, v2, v22, {f16}, globalState)], if (v1 in v23) then v23[v1] else f17, f17, !(|v20| < |v24|), f16, !f16, v19[v2], f16, f17, !f16, f16, !f16, f17 <==> f17, (if (v1 in v25) then v25[v1] else -v2) != -fm1(f16, !f16, v2, globalState), v19[v2], f16, f16, f17, if (f17) then f16 else f17, f16, v19[v2], f16, f16, f17];
			v26[349] := v2 < v2;
			...
			if (true) {
				...
				var v31: set<bool> := {v26[349], v26[349], fm5(v2, f17, v2, f16, globalState)};
				...
				globalState.f14 := if (fm33(v26[349], f17, v19[|v20|], globalState) <= v33) then v26 else v26;
				...
				var v39: map<set<bool>, bool> := map[v38 := fm5(|"esvkcx"|, f16, v2, v26[349], globalState)];
				var v40: map<array<string>, map<set<bool>, bool>> := map[v37 := v39];
				v40 := v40[v37 := v39 + v39];
				var v41: map<int, string> := map[v2 := seq(678, i3  => (v1))];
				v41 := v41[-0x24d := v20];
				var v42: array<map<bool, multiset<char>>> := new map<bool, multiset<char>>[18];
				var v43: map<bool, multiset<char>> := map[!false := multiset(v20)];
				v42[101] := v43;
				var v44: C2 := new C2(v1, f16, v2, f16, f17, v26[349]);
				var v45: seq<C2> := [v44];
				var v46: multiset<C2> := multiset{v44, v44};
				var v48: seq<set<int>> := [set v47 : int | (583 <= v47) && (v47 < 676) :: (v47 / v2)];
				globalState.f3, globalState.f7, globalState.f7, v42[101] := v26[349], |(multiset(v45) - v46[v44 := v2])|, fm7(false, -0x9f, v22, v38, globalState) % |v48[v2]|, (v43 + v43) + v43;
				v37[408] := v20;
				v37[408] := v20;
				globalState.f14 := v26;
			}
			...
			globalState.f0, globalState.f7 := f16, (v2 * v2) % (v2 - v2);
			var v50: seq<bool> := [false];
			var v51: set<bool> := {f16};
			var v52: array<bool> := new bool[10] [false, f17 ==> f17, f16, !!v50[v2], fm5(v2, f17, v2, f16, globalState), f16, v51 >= v51, f16, true, f17];
			v52[765] := f16;
			...
			v58[397] := fm7(if (v1 in v61) then v61[v1] else f16, -0x21b, v56, v51, globalState);
			v58[397] := v2;
		}
		...
		globalState.f3, v64[601], globalState.f7, v2 := true, -(v2 * v2), fm1(v65.cf31, false, |v62|, globalState), v2;
		var v66 := DC18(v2, f17, v64[601]);
		var v67: seq<bool> := [false, f16];
		var v68: map<int, bool> := map[v2 := v67[v64[601]]];
		var v69 := DC43(f16, -0xb2);
		var v70: set<bool> := {f17, f17};
		var v71: array<bool> := new bool[22] [f17, if (f16) then true else f17, !!f16, f17, f16, v66.cf21, f17, if (|v0| in v68) then v68[|v0|] else f17, true, f16, f17, f17, v69.cf57, f17, (seq(-835, i6  => (v1))) != v62, f17 in v70, f16, f17, f16 ==> f17, f17, f17, false];
	...
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		...
		match (v3) {
			case DC7(cf6, cf7) =>
				...
				var v5 := 'i';
				var v6 := "hlk";
				globalState.f13, globalState.f7, v4, globalState.f7, r1 := !(if (v5 !in v6[cf6 := v5]) then f16 else f16), cf6, v4, |(fm0(f16, fm1(f17, f17, 0x15c, globalState), cf7, globalState) - (if (f16) then v4 else multiset{cf6}))|, f16 && (v6 in [v6, v6]);
			...
			case DC6(cf5) =>
				if (if (if (f17) then f17 else f16) then f16 !in v2 else f17) {
					...
					globalState.f0, v16, v17, v18[457], r1 := f17, v16, v17, v19, v21.cf27 ==> true;
					var v24: array<D15> := new D15[14];
					var v25: array<map<int, int>> := new map<int, int>[21](i0 => map[0x24c := |multiset{f16}|]);
					var v26 := DC35(v25);
					v24[896] := v26;
					v24[896] := if (f17 && f17) then v26 else v26;
					var v27 := new C0();
					var v28: array<map<bool, bool>> := new map<bool, bool>[3](i1 => v2);
					v19[590] := |v20|;
					var v29: seq<bool> := [f17];
					var v30 := DC17(v29[v15 := f17]);
					var v31: multiset<seq<bool>> := multiset{v29, [f16, !f16, f17], ([f16])[v15 := true] + v30.cf19, (v29[v15 := f17])[v15 := f16] + v29, v29};
					var v32: multiset<bool> := multiset{f16, f17, f17};
					var v33: map<bool, multiset<seq<bool>>> := map[f17 := v31];
					v28, v19[590], globalState.f7, v31 := v28, |(v20 + (v20 + v20))|, 0x21f + |v32|, if (f17 in v33) then v33[f17] else v31;
				} else {
					...
					var v40 := DC14(v39);
					var v41 := 0x1fb;
					v37, v40 := (v37 + v37)[-(fm1(f17, f17, v41, globalState) + v41) := v35], v40;
				...
				var v56 := 'l';
				var v57: map<int, char> := map[|fm3(seq(-0x24e, i2  => ('u')), [f16], "lb", globalState)| := v56];
				v54 := map[|v57| - v51 := f16];
				...
				v53, r0, v60, v53 := DC3(v53).cf3, fm44(|{f17}|, f16, |v53|, true, globalState) + ([|v62|, v51] + v63)[v51 := |fm38(v51, v51, globalState)|], DC19(v59).(cf23 := DC19(v59)), fm3("ccbxl", v58, "s", globalState) + v53;
				var v64 := new C3(f16 && true, f16);
			case DC8(cf8) =>
				var v65: map<bool, int> := map[f17 := 0x2fd];
				var v66: array<int> := new int[21](i3 => i3 % -|"xsxsf"|);
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		v6[73] := fm70(true, v8, if (f17 in v9) then v9[f17] else if (f17 in v9) then v9[f17] else f17, |v10|, globalState);
		var v11: multiset<string> := multiset{v0, v0};
		var v12: set<bool> := {f17};
		var v13: seq<int> := [v1];
		var v14: seq<int> := [|v12|, |v0|, |v13|];
		var v15: array<int> := new int[19] [557, |v0|, v1 - v1, |v0| % v1, -v1, v1, v1 - v1, v1, v1, -v1, v1, v1, v1 - -794, v1, -|v11|, 0xab, v1 + v1, v1, |v13|];
		v15[932] := v1;
		var v16: array<char> := new char[3](i0 => v0[v1]);
		var v17: seq<bool> := [f17];
		var v18: multiset<bool> := multiset{p0};
		v16[606] := fm26(v17[v1], v18, globalState);
		var v19 := 'o';
		globalState.f0, v6[73], r2, v15[932], v16[606] := f16, v3 + (v3 + v3), !(false ==> f17), -v1 % v1, v19;
		r1 := f17;
		var v20 := DC22(-v15[932]);
		var v21: map<char, bool> := map[v19 := f16];
		var v22: array<seq<int>> := new seq<int>[19] [v14[v20.cf28 := -|v21|], [0x33c], v13[v1 := -v1], v14, v13 + [|v9|, 0xe9], fm33(p0, f16, f17, globalState), seq(0x144, i2  => (v15[932])), [v15[932]], v13, seq(846, i3  => (v1)), v13, v13, v13, v14[v1 := --v1], seq(931, i4  => (v15[932])), v13 + v14[0x295 := v1], v13, v13, v13 + v13];
		forall i1 | 0 <= i1 < v22.Length {
			v22[i1] := v14 + (v14 + v14);
		}
		r0 := -v1;
		var v23: map<int, int> := map[|v18| := 990];
		var v24 := new C3(f17, v15[932] !in v23);
		var v25: set<int> := {|"ux"|, v1, v1, 0x142, -v1};
		var v26 := DC31(v25);
		match (v26) {
			case DC32(cf38, cf39, cf40, cf41) =>
				globalState.f13 := cf41;
				var v27: array<bool> := new bool[2](i5 => v15[932] < v15[932]);
				v27[542] := cf39;
				v27[542] := if (|[0x1ee, cf40]| != v24.fm6('r', globalState)) then if (f17) then v17[v1] else !false else cf39;
				globalState.f7 := v1 / (fm6(v16[606], globalState) - v15[932]);
				if (if (cf39 in v9) then v9[cf39] else fm5(v15[932], cf39, cf40, cf39, globalState)) {
					globalState.f7 := 0x144;
					v27[542], v15[932], globalState.f13 := f17, v15[932] - 0xa6, v27[542];
					v0 := fm3("aiwaxtp", v17 + v17, v0, globalState);
					globalState.f3 := cf39;
					var v28 := DC42(cf41, v1, cf39);
					var v29 := new C1(v0, f17, !!v28.cf56);
				} else {
					v1 := (v15[932] * v1) * v15[932];
					var v30 := DC24(map[f16 := |[f16]|]);
					var v32: map<bool, int> := map[cf39 := v1];
					var v33: seq<D10> := [DC24(v32)];
					var v34: array<seq<D10>> := new seq<D10>[3] [[v30.(cf30 := map[cf41 := |(set v31 : int | (978 <= v31) && (v31 < 567) :: (v31 / cf40))|])], if (!cf41) then seq(843, i6  => (DC24(map[cf39 := v15[932]]))) else [v30], v33];
					v34[163] := v33;
					v34[163] := v33;
					globalState.f0 := f16;
					v15[932] := cf40;
			...
			case DC31(cf37) =>
				...
				v35[462] := v1 in v2;
				r1, v35[462] := f16, v24.fm30(globalState);
				var v36: map<bool, int> := map[f16 := v1 - v15[932]];
				v36 := v36 + v36;
			case DC33(cf42) =>
				v19 := v16[606];
				var v37 := DC38(p0, v15[932], v1 - 0x196, v17[-v1]);
				v37 := v37;
				globalState.f0 := !f16;
				globalState.f0 := DC42(!true, v15[932], p0).cf56;
		}
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		...
		var v5 := 0xdf;
		globalState.f7 := v5;
		var v6: map<int, int> := map[|(seq(0x34, i2  => ('a')))| := -0x1d];
		...
		var v19: map<string, array<int>> := map[v17[|v18|] := v1];
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v2: seq<bool> := [f16];
		var v3 := new C1((seq(0xd2, i0  => (v0)))[|v2| := v0], !!f17, f16);
...
class C6 extends T2 {
	...
	method m4(p0: string, p1: T0, p2: bool, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
			...
			decreases 100 - i2
		{
			...
			var v25 := 0x276;
			var v26: seq<int> := [-v25 - |p0[v25 := fm18(p1.f17, v25, globalState)]|];
			var v27 := DC7(v25, v25);
			var v28: map<int, D4> := map[v25 := v27];
			var v29: multiset<map<int, D4>> := multiset{v28, v28};
			v24, r1, globalState.f0, v26 := fm19(v29, p1.f16, f17, globalState) + (v24 + v24[fm2(p1.f17, globalState) := p2]), p0 <= (seq(-0x70, i3  => (p3))), p1.f17, v26;
		...
		for i4 := v32 to v33.cf4 {
			...
			var v38: map<seq<int>, int> := map[v37[i4] + v36 := i4 - v32];
	...
	method m5(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			globalState.f0 := fm0(f17, v3[256], v0, globalState) < v5;
		}
		...
		for i1 := v0 * v0 to v0 {
			...
			var v9 := new C0();
			globalState.f0 := f17 && f16;
			var v11: array<set<int>> := new set<int>[26](i2 => set v10 : int | (0x2d4 <= v10) && (v10 < 0x1d8) :: (v10 / v0));
			...
			v11, globalState.f10, v12[331] := v11, v14, i1 % v0;
		}
		...
		match (v17) {
			case DC11(cf11) =>
				...
				v19 := v19[v18 := v15];
				var v20 := new C0();
				globalState.f7 := --(v0 / v17.cf13);
				var v21 := "tvxsj";
				var v22: map<int, bool> := map[v0 := f17];
				v0 := v0 % fm4(v21, v0, v22, globalState);
			case DC12(cf12, cf13) =>
				v6[906] := multiset{f16, f17} > multiset{!f16};
				v6[906] := if (f16) then f17 else f16;
				var v23 := DC5();
				v23 := DC5();
				globalState.f13 := !f17;
				...
				var v25 := DC7(-|v24|, v0);
				var v26 := 'b';
				var v27: array<char> := new char[26] [v26, fm18(f16, |(seq(0x2a7, i4  => (v26)))|, globalState), v26, v26, fm18(v6[906], v0, globalState), v26, v26, v26, v26, v26, v26, v26, v26, v26, v26, v26, 'h', v26, v26, v26, v26, v26, v26, v26, 't', 'y'];
				v27[816] := v26;
				globalState.f7, v25, v27[816] := cf13, v25, fm18(f16, v0, globalState);
			case DC13(cf14, cf15) =>
				var v28 := new C0();
				var v29 := DC5();
				v29 := v29;
			...
			case DC10(cf10) =>
				...
				cf10[357] := fm7(!f17, v0, v32, v33, globalState);
				var v34 := 's';
				cf10[357] := |v31| * fm6(v34, globalState);
				cf10[357] := cf10[357] - v0;
				var v35 := "oibd";
				var v36 := DC3(seq(-0x265, i5  => (v34)));
				var v37: map<seq<int>, bool> := map[[|v36.cf3|] := true];
				var v38: array<string> := new string[19] [v35, v35, v35, v35, v35, "h", fm3(v35, [true], v35, globalState), v35[|v31| := v34], v35, v35, v35, fm3(v35, v31[-|v37| := f17], "flqefydmv", globalState), v35, v35 + "a", v35, v35, v35, seq(0x3a0, i6  => (v34)), fm3(v35, v31, v35, globalState)];
				v38[615] := v35;
				globalState.f7, v38[615] := cf10[357] / cf10[357], "rruavgtga" + "htgfvfr";
				v32 := v32[|v38[615][cf10[357] := v34]| := |v33|];
			case DC14(cf16) =>
				var v39: seq<bool> := [f17];
				globalState.f7 := if (false <== true) then v0 % v0 else |v39|;
				if (!f17 <== f17) {
					globalState.f13 := f16;
					globalState.f0 := f16;
					globalState.f0 := f17;
				...
				if (f16 || (v0 == |fm20(|v51|, globalState)|)) {
					...
					var v57: seq<string> := [seq(0x39b, i7  => ('y'))];
					var v58: map<string, array<bool>> := map[v57[v0] := v6];
					var v59: seq<array<bool>> := [v6, v6, v6];
					v58 := v58[v51 := v59[v0]];
					v6[766] := f17;
					var v60 := 'b';
					v6[766] := (fm6(v60, globalState) - v0) in fm21(0x1c8, globalState);
	...
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		...
		for i1 := -v5 to fm4("s", v5, v7, globalState) {
			...
			var v24 := DC16(v23);
			var v25: array<multiset<int>> := new multiset<int>[29] [multiset((v6 + v6)[|v11| := i1]), v12, multiset(v6), v12, v12, fm0(f17, i1, |v16|, globalState), multiset(v6) * v12, multiset{i1} * v12, v12, v12, v12 - v12, v12 * v17[-i1], multiset{i1, i1, |v19|, i1, |v21|}, fm0(f17, v5, i1, globalState), DC0(v12).cf0, v12, v12 * v12, multiset{v6[0x14c], v5} + v12, v12, (multiset(v6[|v24.cf18| := i1]))[i1 := i1], v12, v12, v12[i1 := -i1] - v12, v12, v12, v12[v5 := |v9|] + v12, v12, v12, v12];
			v25[880] := v12[fm6(v18, globalState) := i1];
			var v26: array<bool> := new bool[22](i2 => true);
			var v27: multiset<array<bool>> := multiset{v26};
			var v28: array<char> := new char[3];
			v26[467] := f16;
			r1, v25[880], v27, v28, v26[467] := (v0 + v0) == v0, v12, v27, v28, !f17;
		...
		globalState.f7 := (|v30| - v5) / (|map[v32[v5] := false]| * -|v33|);
		var v34 := "xxvp";
		globalState.f7 := |v34| / (v5 * v5);
		var v35 := new C0();
		globalState.f0 := f16;
		r0 := ([v6[v5]] + (seq(128, i3  => (v5)))[|v0| := v5]) + (v6 + [v5]);
		r1 := if (f16) then !f16 else !(v0 >= v0);
		r2 := f17;
		var v36 := 't';
		r3 := (v34 + ([v36, v36, v36])[v5 := v36]) + (seq(0x153, i4  => (v36)));
	}
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		var v0 := 0x32;
		...
		var v7: array<bool> := new bool[13] [if (!p0) then true else f17, !(f16 || f16), |v1| >= |v2|, |v3[v0 := v4]| > |map[f16 := |v6|]|, !fm2(f17, globalState), p0, f17 ==> f16, p0, false, p0, f16, !f17, DC18(v0, false, v0).cf21];
		globalState.f14 := v7;
		if (f16 <== f17) {
			...
			if (v6[v0 := |v6|] <= [v0]) {
				...
				var v10 := DC3(v3);
				var v11 := DC3(v10.cf3);
				var v12: multiset<int> := multiset{v0 * v0, v0, -0x364, fm4(v9[v0], 0x16c, v5, globalState) % |v11.cf3[-v0 := v4]|, |v6|};
				v12 := (v12 * v12) * v12;
				v8 := v8;
				globalState.f7 := v0;
				var v13 := DC5();
				...
				globalState.f7 := |((fm3(v3, v14, v3, globalState) + v15[0x264])[v0 := v4])[v0 / v0 := v4]|;
			...
			if (p0) {
				...
				var v25: map<map<int, bool>, int> := map[map v24 : int | (0x101 <= v24) && (v24 < -0x2d4) :: (v24 * v8[411]) := (true) := v0];
				globalState.f7 := |(v25 + map[map v26 : int | (0x2e <= v26) && (v26 < 0x383) :: (v26 - v8[411]) := (f16) := -v0])|;
				globalState.f7 := v8[411];
			} else {
				v3 := "mokbke";
				...
				v7[120] := multiset{v31, v27.fm5(v32, v31, fm1(true, fm5(v0, v27.f17, |multiset(v6)|, v27.f17, globalState), v0, globalState), f17, globalState), p0} !! multiset(v35);
				v8[214] := |v3|;
				v8[223] := |v20|;
				v8[214], v8[223], globalState.f7 := v30, fm6(v4, globalState), v0;
				v32 := |("ssrumx" + v3)|;
			}
			...
			match (v36) {
				...
				case DC13(cf14, cf15) =>
					...
					var v44: multiset<seq<int>> := multiset{seq(838, i0  => (v0))};
					v7[23] := v43 >= v43[if ([v0, v0] in v44) then v44[[v0, v0]] else v0 := v0];
					var v45: map<int, int> := map[|multiset{-v0}| := 0x28b];
					v7[23] := v21.fm7(p0, v0, v45, {cf15}, globalState) < v0;
					globalState.f7 := v0;
					v8[503] := |v3|;
					v8[503] := v0;
				case DC10(cf10) =>
					...
					v48[493] := v49;
					v48[493] := new array<bool>[4] [v7, v7, v7, v7];
					r2 := f16;
					var v50: seq<array<bool>> := [v7];
					var v51: map<char, array<bool>> := map[v4 := v50[v0]];
				...
				case DC14(cf16) =>
					...
					globalState.f7, v53, v3, globalState.f3, v55 := v0, (v53[v7 := 0x5b] + v53)[v7 := |v6|], v3[DC42(f17, v0, f16).cf55 := v4], fm2(p0 <== f16, globalState), v55;
					globalState.f3 := f17;
					r0 := v0;
					var v56: seq<bool> := [p0, p0, true];
					var v57: map<string, char> := map[(fm3(seq(0x285, i1  => (v4)), v56, v3, globalState))[v0 := v4] := v4];
					v57 := v57[if (v56[v0]) then fm3(v3, v56, v3, globalState) else "meowdhl" := v3[v0]];
			}
			
		} else {
			globalState.f7 := if (f16) then -0x245 else v0;
			var v58: set<bool> := {f16};
			var v59: array<int> := new int[16] [v0, v0, v0, v0, v0, v0, v6[v0], v0, v0, v0, v0, v0, v0, v0, v0, |v58|];
			var v60: seq<array<int>> := [v59];
			r0 := |(if (f16) then v60 else v60)[v0 := if (f17) then v59 else v59]|;
			var v61: seq<bool> := [v0 > |"wjcv"|];
			globalState.f0 := v61[-(v0 - |v1|)];
			v59[820] := v0;
			...
			v59[820] := if (v7 in v62) then v62[v7] else 303 * |v66|;
			globalState.f7 := v59[820] * |[v59[820]]|;
		}
		
		var v67: array<seq<int>> := new seq<int>[18](i2 => v6);
		v67[249] := [v0];
		var v68 := DC54();
		v67[249], globalState.f3, r0, v0 := v6, match v68 {
			case DC54() => f16
		...
		for i3 := v0 to v0 {
			...
			v7[72] := v71 !! fm0(f16, v0, if (f17 in v2) then v2[f17] else i3, globalState);
			v7[72] := f17;
			globalState.f3 := f17;
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		if (f16) {
			...
			v0[793] := v1[v2 := v3] + v1;
			var v4: seq<bool> := [f16];
			v0[793] := (v1 + v1) + fm3(v1, v4, v1, globalState);
			...
			match (fm71({-v2}, globalState)) {
				case DC54() =>
					...
					var v13: map<string, int> := map[v0[793] := v2];
					var v14 := DC37(v13);
					var v15 := DC39(v14);
					var v16: seq<D17> := [v15];
					globalState.f7, globalState.f13, v11[535] := (v5.fm4("uvdwjy", v2, v12, globalState) * |v0[793]|) + (v2 * v2), v15 !in v16, true;
					var v17: T3 := new C4(v2, f16, f16, f16);
					var v18: map<bool, T3> := map[v0[793] < v0[793] := v17];
					var v19: array<int> := new int[28] [v17.f18, v2, v17.f18, v17.f18, 0x312, |map[v11[535] := f16]|, v2, 591, |v0[793]|, v2, v17.f18, v2, v17.f18, v17.f18, v17.f18, v17.f18, |v12|, v2, v2, 205, v17.f18, v17.f18, v17.f18, v2, v2, v17.f18, v17.f18, v17.f18];
					var v20: map<int, array<int>> := map[v2 := v19];
					v18 := v18[fm5(|v20|, v17.f17, 0x2ea, fm2(v17.f19, globalState), globalState) := v17];
					globalState.f3 := (v1 + v0[793]) != (v1 + v0[793][|v0[793]| := v3]);
				case DC53(cf76) =>
					var v21: seq<seq<bool>> := [v4];
					globalState.f8 := (v21[v2] + v4) + v4;
					...
					v0[793] := v0[793];
					var v26: array<int> := new int[6](i0 => i0 / v2);
					v26[965] := |v1|;
					v26[196] := v2;
					...
					globalState.f3, v26[965], globalState.f3, v26[196] := f16, fm1(v27 !! (set v29 : int | v29 in v28 :: (v29 / |map[true := true]|)), if (f16) then f16 else f16, |v1|, globalState), f17, if (f17 in v31) then v31[f17] else v2;
			}
			...
			var v40: array<int> := new int[17] [v2, v2, |(v32 * v32)|, |fm72(v2, globalState)| / v2, v2 % v2, -(v2 + |v34|), v2, |v35[v2]|, v2, v2 % v2, v2, v2 + v38.cf40, v2, v5.fm4(v1, v5.fm9(v4, false, v2, globalState), v39, globalState), v2, v2, v2];
			var v41: T3 := new C4(v2, f16, !f17, f17);
			var v42: set<T3> := {v41};
			v40[223] := |v42|;
			var v43: set<int> := {v41.f18};
			v40[223] := v41.fm4("n", -|v43|, v39, globalState);
			var v45 := DC36(map v44 : int | v44 in v39 :: (v44 - |{v2}|) := (v41.f18));
			match (v45.(cf45 := map v46 : int | (0x352 <= v46) && (v46 < 930) :: (v46 / v2) := (|map[v3 := if (v41.f17 in v32) then v32[v41.f17] else v41.f18]|))) {
				case DC36(cf45) =>
					...
					var v51: array<D3> := new D3[11] [v33, if (v41.f16) then v33 else DC4(v41.f18), v33, v33, if (true) then fm73(v2, v48, !v41.f16, f17, globalState) else v33, v33, v33.(cf4 := v40[223]), if (v50.cf31) then v33 else v33, v33, DC4(v2), v33];
					v51[4] := v33.(cf4 := v2);
					v51[4] := v33;
					v0[793] := v1 + ((seq(-0x1ba, i1  => (v3))) + v5.fm25(globalState));
			...
			if (f17) {
				...
				var v54 := "pdkkpal";
				var v55 := 'v';
				var v56: multiset<int> := multiset{v53, |v54[v53 := v55]|};
				var v57: seq<int> := [v53, v53];
				v56 := multiset(v57 + ([v53] + v57));
				var v58: seq<string> := [v54, v54];
				globalState.f7 := |((v58[-|v57|])[v53 := 'g'] + ("i" + v54))|;
				v53 := v53;
				...
				globalState.f0, globalState.f0 := v68 != v52.fm4(seq(-155, i3  => ('h')), v68, v74, globalState), v68 in v76[v68];
				var v77 := 'w';
				...
				v79, v77, v80[139] := (if (v68 in v83) then v83[v68] else map[v68 := v78]) + v79, v78.f21, v68 + v68;
			}
			
			var v84 := 0x374;
			var v85 := "nfdnpq";
			globalState.f7 := (v84 / |v85|) * v84;
			v85 := v85 + v85;
			var v86: array<int> := new int[14](i4 => i4 / v84);
			v86[57] := v84 + v84;
			v86[57] := v84;
		}
		...
		if ((v87 % v87) == v87) {
			...
			globalState.f7 := (if (f16 in v93) then v93[f16] else v87) - (v87 / v87);
			v93 := v93;
			v87 := v87;
			if (false) {
				...
				var v97 := "xrrfdn";
				var v98 := 't';
				v95[819], v95, v97, v97 := v87, v95, v97[if (!!f16) then v87 else v87 := v98], v97;
				...
				v101[931] := v96 < v96;
				v101[931] := |v97| >= v87;
				var v102: map<string, int> := map[v97 + v97 := v95[819]];
				v101[931], v102 := (v88 * v88) == (v88 + v88), v102;
				var v103: map<int, map<bool, bool>> := map[v87 := v91];
				v103 := v103 + v103;
				var v104 := DC26(false, v95[819], v95[819]);
				var v105: map<D10, int> := map[DC28(v104).(cf34 := v104) := -0xa5 / v95[819]];
				v105 := v105;
			} else {
				var v106: array<int> := new int[4](i5 => i5 % v87);
				var v107 := "osldrarr";
				var v108: C2 := new C2('m', f16, |v107|, false, f17, f16);
				var v109: seq<C2> := [v108, v108, v108];
				var v110: map<C2, array<int>> := map[v109[v87] := v106];
				...
				globalState.f7 := v87;
				v93 := v93 + v94;
				var v112: multiset<int> := multiset{-0x2d2 % |v107|};
				v112 := v112 - v112;
			...
			v119[224] := v118;
			v87, v119[224], globalState.f3 := v87, v118, f16;
			v87 := --v87;
		...
		if (f17) {
			...
			var v130: map<int, int> := map[v87 := |v129[f16 := 0x3af]|];
			var v131 := "xmlya";
			...
			var v135: map<int, map<bool, bool>> := map[|(([true, f17])[v87 := f16])[v87 := f16]| - v87 := v134];
			v135 := v135[v87 := v134];
			...
			v137, v138[820], r0 := fm74(globalState), v87, v139[-(if (f16) then 0x209 else -v87)];
			v138[820] := v138[820] % 0x1d5;
			v87, v87 := v138[820] - -v87, v87 * (v138[820] / v87);
			var v140: map<bool, int> := map[!f17 := v138[820]];
		...
		for i9 := v87 - v87 to v87 {
			...
			if (false || ({|v145|} == v149)) {
				...
				v150[214] := v152 != v152;
				var v153: map<bool, int> := map[v150[214] := |(seq(0x1a7, i11  => ('g')))|];
				v150[214] := (if (true) then |v153| else v87) != 559;
				var v154: map<bool, seq<bool>> := map[f16 := v148[v87 := true]];
				var v155: seq<seq<bool>> := [(if (fm5(96, false, v87, f17, globalState) in v154) then v154[fm5(96, false, v87, f17, globalState)] else v148)[v87 := f16] + [f16, fm5(v87, f16, |v145|, v150[214], globalState), f16], if (v150[214]) then v148 else fm23(globalState), v148];
				v155 := v155 + v155;
				var v156: seq<set<int>> := [v149, v149, v149];
				var v157: multiset<string> := multiset{("ouplo")[i9 := 'f']};
				var v158: seq<int> := [i9, |v157|];
				var v159: map<seq<set<int>>, bool> := map[v156 := |fm3(seq(0x36, i12  => (v147)), v148, "funl", globalState)| < |v158|];
				...
				var v166: T3 := new C4(i9, fm3(v145, v148, v145, globalState) < (seq(0xcc, i13  => (v147))), f17 || f16, i9 <= 0x1c5);
				var v167: array<int> := new int[1] [v87];
				v167[863] := i9;
				var v168: multiset<bool> := multiset{true, v166.f16, v166.f16};
				var v169: multiset<int> := multiset{-(|v168| / i9), |(seq(0x87, i14  => (v147)))|, -(|{|(map[v167 := v166.f16])[v167 := v166.f19]|}| % -v166.f18)};
				var v170: T2 := new C5(v166.f16, f16);
				var v171: map<T2, T3> := map[v170 := v166];
				globalState.f7, v166, v167[863], v169, globalState.f3 := v87, if (v170 in v171) then v171[v170] else v166, |v145|, v169 - v169, !false;
				v167[863] := v167[863] * v87;
				var v172: map<int, string> := map[v166.f18 := v145];
				v172 := v172[v167[863] := v145];
			}
			
			var v173: multiset<bool> := multiset{f16};
			var v174: seq<multiset<bool>> := [v173, multiset{f16, true}];
			globalState.f7 := |((v173 * v174[v87]) * multiset{f17})|;
			if (true) {
				...
				var v180: array<array<multiset<int>>> := new array<multiset<int>>[27] [v177, v177, v177, v177, v177, v177, v177, v177, v178.cf80, v177, v177, v177, v177, v177, v177, v177, v177, v177, v177, v177, if (f16) then v177 else v177, v177, v177, v177, v179[i9], v177, v177];
				v180[990] := v177;
				v180[990] := v177;
				var v181: seq<int> := [v87];
				var v182: map<string, int> := map[v145 := v181[v87]];
				...
				v187[76] := -v191[fm1(f16, f16, i9, globalState) / -|v192|];
				globalState.f0 := f16;
			}
			...
			var v199: multiset<int> := multiset{|v146[|v198|]|, i9};
			var v200: multiset<int> := multiset{v196[|v199|]};
		...
		match (v4) {
			case DC21(cf25, cf26, cf27) =>
				...
				if (v6.f16) {
					...
					var v10: C4 := new C4(v0, (multiset(v8))[!v6.f17 := v0] > v9, !v6.f16, v6.f17);
					v10 := v10;
					var v11: set<int> := {v0};
					var v12 := DC31(v11);
					v11 := v12.cf37;
					var v13: set<seq<int>> := {(fm33(f17, cf27, v6.f17, globalState) + (seq(-0x218, i1  => (0x1a4))))[0x2c3 := |v5|]};
					v13, globalState.f0, globalState.f0, globalState.f7 := {v1, v1, v1, v1, v1}, v6.f17, f16, v0 - (v0 - -v0);
					globalState.f7 := v0;
					var v14: seq<array<int>> := [cf25];
					cf25, v1, globalState.f7 := v14[v0], v1 + v1, v0;
				} else {
					globalState.f7 := --(-|fm76(v1[v0], 0x5e, v0, globalState)| - (v0 + v0));
					...
					globalState.f0, v16, v19, globalState.f7 := v0 > |v20|, v16, v19, v1[v0];
				}
			...
			case DC22(cf28) =>
				...
				cf28 := (cf28 % v0) + cf28;
			case DC23(cf29) =>
				var v23: map<string, int> := map[seq(0x12d, i2  => ('q')) := v0];
				v23 := v23;
				var v24: T1 := new C1(seq(0x53, i3  => ('r')), f16, f17);
				v24 := v24;
...
class C7 extends T3, T2 {
	...
	function fm8(p0: bool, p1: int, p2: int, globalState: GlobalState): bool {
		f18 < (|(set v0 : int | v0 in (seq(0x3ba, i0  => (f18))) :: (v0 / |[|{0x162}|]|))| - f18)
	}
	function fm9(p0: seq<bool>, p1: bool, p2: int, globalState: GlobalState): int {
	...
	function fm7(p0: bool, p1: int, p2: map<int, int>, p3: set<bool>, globalState: GlobalState): int {
		if (!f16) then |((seq(0x18f, i0  => ('m'))) + DC3("gogyswei").cf3)| else 0x233
	}
	function fm6(p0: char, globalState: GlobalState): int {
		-(f18 % (39 % f18))
	}
	method m0(globalState: GlobalState) returns (r0: array<int>) {
			...
			decreases 100 - i0
		{
			...
			globalState.f7 := |v5| / (-f18 / f18);
			globalState.f7 := 435 * |(v3 + v3)|;
		}
		var v9 := DC0(multiset{0x29f});
		var v10: multiset<int> := multiset{f18};
		var v11 := "r";
		match (v9.(cf0 := v10[fm1(f17, f19, -f18, globalState) := |v11|])) {
			case DC0(cf0) =>
				if (fm2(f17, globalState)) {
					var v12 := m10(v1, globalState);
					var v13: array<int> := new int[28](i1 => i1 % |map[f18 := f18]|);
					r0 := v13;
					v13[625] := f18 + f18;
					v13[625] := 0x18c;
					v11 := fm3(seq(0, i2  => (v1)), DC2(fm16(globalState)).cf2, v11, globalState);
		...
		match (v2) {
			...
			case DC5() =>
				...
				var v28 := DC7(|v27|, |v11|);
				v22[700], v23[313] := v25, f18 - v28.cf7;
				...
				if (f17) {
					...
					v30[639] := v31;
					var v32: map<string, array<bool>> := map[if (f17) then v11 else seq(711, i5  => (v1)) := v31];
					v30[639] := if (v11 in v32) then v32[v11] else v31;
					globalState.f0 := f17;
					var v33: map<bool, multiset<int>> := map[f19 := v10];
					v33 := v33[false := v10[f18 := |v11|]];
					v23 := v23;
				} else {
					var v34: array<char> := new char[14];
					v34[849] := v1;
					v34[849] := if (f19) then v1 else 'f';
					var v35 := DC10(v23);
					var v36: map<array<int>, char> := map[v35.cf10 := v34[849]];
					v36 := v36[v23 := v34[849]];
					globalState.f7 := if (f17) then 0x376 else v23[313];
					var v37 := DC13(v34[849], f19);
					v37 := v37;
					v23[313] := v23[313];
				}
			...
			case DC3(cf3) =>
				...
				globalState.f3, v38[212], v39 := f16, f17, v39;
				var v40 := new C0();
				var v41: map<int, bool> := map[-0x13a := fm2(f16, globalState)];
				var v42: map<bool, array<bool>> := map[f19 := v38];
				globalState.f7 := |v41[|multiset{fm8(f17, f18, f18, globalState)}| := v38[212]]| % |(v42 + v42)|;
		}
		...
		if (f16) {
			...
			if (f17) {
				...
				v47[690] := if (f17 in v48) then v48[f17] else v1;
				var v49: seq<int> := [0x219, f18];
				v43[806], v44, v45[422], globalState.f7, v47[690] := f19, v44, v46, (f18 / f18) + |v49|, v1;
				globalState.f13 := !f19;
				v46 := v46;
				...
				var v58: map<array<int>, string> := map[v57.cf25 := seq(0xa, i9  => ('r'))];
				v43[303] := (if (f18 in v56) then v56[f18] else v55) !in v58;
				v43[303] := !!f19;
				globalState.f7 := f18;
			}
			...
			if (f17) {
				...
				var v71: array<int> := new int[14] [824, f18, f18, f18, f18, f18, |v66|, |v69|, f18, |(multiset(v69))[f18 := f18]|, |v70|, f18, f18, |[v64.f16]|];
				...
				v73[405] := fm4(v11, f18, v78, globalState);
				globalState.f0 := if (f18 in v78) then v78[f18] else if (f16) then false else v74.f22;
				var v79: array<char> := new char[2];
				globalState.f7 := |(fm38(-f18, f18 / f18, globalState))[f18 := v73[405] > |map[v79 := f18]|]|;
				var v80: seq<bool> := [f16, f19, true, f19];
				var v81: map<int, int> := map[f18 := -v73[405]];
				globalState.f7 := v73[405] / (|v80| + |v81|);
			}
			...
			if (f19) {
				...
				v84[987] := fm5(|[(v103.(cf79 := f19)).cf79]|, false, f18, !f19, globalState);
				...
				var v108: set<bool> := {v107[-f18], f19};
				var v109: map<char, int> := map[v1 := -f18];
				globalState.f7, v84[987], v105, v106[561], globalState.f7 := |multiset{f19, f19}| % f18, v107[f18], v105, v108, |v109|;
				var v110: map<string, bool> := map[v11 := f17];
				var v111: map<char, string> := map[v1 := v11];
				v110 := v110[v11[|v111| := v1] := !f17];
				globalState.f7 := if (f17) then 708 else f18 % f18;
			}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (f16) {
			...
			match (v1) {
				case DC4(cf4) =>
					...
					globalState.f8 := (v5.cf19 + (v4 + v4))[cf4 := |v0| > (if (v0 in v6) then v6[v0] else f18)];
					var v7: array<array<bool>> := new array<bool>[7];
					var v8 := 'n';
					var v9: map<bool, bool> := map[f19 := v8 in (seq(543, i0  => (v8)))];
				...
				case DC5() =>
					...
					var v26: array<bool> := new bool[25] [f19, f18 == f18, (if (f19 in v19) then v19[f19] else fm7(v20[f18], f18, map v21 : int | (-0x3cf <= v21) && (v21 < -140) :: (v21 + |map[f19 := f17]|) := (|[f18]|), v22, globalState)) >= f18, f19, f19, f19, f17, true, f16, f16, f18 < -355, !f16, f16, v24.cf41 <== f16, f16, !f17, f17, f18 < f18, true, f17, f17 ==> !f17, f16, v25.cf47, 0x1ee == f18, false ==> f17];
					v26[760] := f19;
					v26[760] := f19 <== f16;
				case DC3(cf3) =>
					globalState.f7 := f18;
					...
					var v29 := 'f';
					var v30: map<string, int> := map[v28[|cf3[-0x1eb := v29]|] := f18];
					var v31 := DC37(v30);
			...
			var v40: map<multiset<int>, int> := map[(multiset(v37))[|map[v38 := v39]| := |v37|] := f18];
			var v41: seq<bool> := [f19];
			var v42 := DC32(fm77(f18, f17, v0, globalState), f17, f18, f16);
			var v43: map<int, int> := map[-f18 := |v0|];
			var v44: array<int> := new int[14] [f18, |v40|, f18, v37[f18], f18, 0x29, if (f16) then f18 else f18, f18, f18, 0x47, ---0x25a, f18, |(v41 + v41)|, -fm7(f16, v42.cf40, v43, v36, globalState)];
			v44 := v44;
			...
			var v50: map<bool, array<bool>> := map[f17 := v49[|[f18, 0x156, f18, f18, f18]|]];
			var v51: seq<int> := [|v50|];
			var v52 := 'v';
		...
		for i5 := |(v58 + v58)| to f18 {
			...
			v60[994], globalState.f7, globalState.f7, globalState.f7 := v57, f18 * f18, fm6(v61, globalState), |((v62 + v62) + v62)|;
			...
			globalState.f8, v58, v63[726], globalState.f14, v66 := if (f18 >= 0x6f) then v67 else v67[i5 := f16] + v67, v58, v65, v60[994], v66;
		}
		...
		r0, v68, v72, r0, r1 := f17, v68, v72, fm8(if (f19) then f17 else f19, f18, f18 % |v73|, globalState), true;
		r0 := f19;
	...
	method m4(p0: string, p1: T0, p2: bool, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		...
		var v1: seq<int> := [f18];
		v0[571] := v1[f18 := |v1|] + v1;
		v0[571] := [f18, -|(seq(0x12f, i0  => (p3)))|, f18 - f18];
		...
		var v4: map<seq<int>, bool> := map[v0[571] := p1.f16];
		var i2 := 0;
			...
			decreases 100 - i2
		{
			...
			var v11: array<int> := new int[8] [|"knempbahv"| + |"o"|, f18, f18, f18, if (f16) then -f18 else f18, -|v10| / |v3|, f18, |v3| + f18];
			v11[65] := if (f19) then f18 else |v3|;
			var v12: map<int, int> := map[f18 := |p0|];
			v5, v6[248], globalState.f7, v9, v11[65] := v5, v7 * v7, (if (f18 in v12) then v12[f18] else -f18) - -v1[f18], DC29(v8), |v3[f18 := f19]| % -|p0|;
			globalState.f3 := !!false;
			globalState.f13 := f19;
			var v13: map<int, bool> := map[f18 := p1.f17];
			if (!(f18 !in v13) <== f16) {
				var v14 := new C3(p1.f16, false);
				v11[65] := fm6('s', globalState);
				...
				v18 := v18[v15 + multiset{f16, p2, f16} := v19[f18]];
				...
				var v24: map<bool, int> := map[v23.cf21 := v11[65]];
				v24 := v24;
				var v25: seq<seq<bool>> := [v3];
				globalState.f13 := v25 <= v25;
				globalState.f13 := -(if (true) then v11[65] else v11[65]) != f18;
				var v26: set<int> := {|p0|};
		...
		var v32: multiset<bool> := multiset{v3[f18], !true};
		r2 := f18 % |v32|;
		var v33: map<int, bool> := map[f18 := f16];
		r0 := fm4(p0 + p0, f18, (v33[122 := false])[f18 := f16] + v33, globalState);
		var v34: map<bool, int> := map[f17 := -0x6f];
		r1 := (f18 - (if (f19 in v34) then v34[f19] else fm4(seq(-0xbe, i5  => (p3)), f18, v33, globalState))) < f18;
	...
	method m5(globalState: GlobalState) {
		...
		if (f17) {
			...
			globalState.f7, v3 := |(v5 + (v5 + map[f16 := v4]))|, v6[f18];
			...
			if (((v13 + fm3(seq(0x2b1, i1  => (v0)), v14, v13, globalState))[f18 := v0])[f18 := v0] == (v13 + "q")) {
				...
				var v23: array<char> := new char[20] [v0, v0, v0, v0, fm26(f17, v15, globalState), v0, v0, v0, v0, v0, v0, v0, v0, v0, 'm', v0, v0, v0, v0, v13[|multiset{f18}|]];
				...
				globalState.f3, v27, globalState.f3, globalState.f13, v28[81] := if (f19) then if (f17) then f16 else f19 else f17, v27, f17, v32 >= v32, if (fm8(f17, f18, f18, globalState)) then v31 else v31;
				globalState.f0 := f16;
				v13 := v13;
				globalState.f7 := f18;
			}
			...
			v33[133] := v34;
			var v35: seq<string> := [v13 + (seq(-0xa1, i3  => (v0)))];
			v33[133], v13, globalState.f7 := if (f19) then v34 else v34, v35[f18], if (if (f19) then f19 else f19) then -f18 % 178 else f18;
			globalState.f7 := f18;
			var v36: seq<int> := [f18];
			if (|v36[f18 := -0x74]| != (f18 - |[f17]|)) {
				...
				var v47 := m11(f17, -|v37[!f19 := f18]|, globalState);
				globalState.f0 := f16;
				...
				v50[107] := f17;
				v49[511], globalState.f13, globalState.f3, v50[107] := v47, f19, f19, f17;
			} else {
				globalState.f7 := -f18;
		...
		v67 := v67[f18 + f18 := seq(0x10d, i5  => (DC62(v0, f16, f18, f17).cf85))];
		var i6 := 0;
		while (f19)
			decreases 100 - i6
		{
			...
			match (v69.(cf24 := v68).(cf24 := v68)) {
				case DC21(cf25, cf26, cf27) =>
					...
					globalState.f7 := if (f17) then f18 / f18 else |v74|;
					v66 := v66;
				case DC22(cf28) =>
					var v75: seq<bool> := [f17, f17];
					globalState.f3 := v75[f18];
					globalState.f13 := f17;
					...
					var v82: array<int> := new int[19] [f18, f18, f18, f18, |v79|, f18, |v80|, f18, cf28, f18, |v81|, |v80|, -f18, f18, cf28, cf28, cf28, cf28, |(seq(-373, i7  => (v66[0x22d])))|];
					var v83: seq<int> := [cf28, -|{v82, v82, v82}| * -f18];
					var v85: map<string, bool> := map[v66 := f16 || !f16];
					globalState.f7, globalState.f7, globalState.f7, v78, v68[241] := v83[|(set v84 : char | v84 in multiset(v66) :: (v84))|], f18, -0x2e4, if (false) then v78 else v78, !(if (("ung" + v66) in v85) then v85["ung" + v66] else false);
				case DC23(cf29) =>
					v0 := v0;
					globalState.f7, v66, v0 := f18, (seq(0x18a, i8  => (v0))) + (v66 + v66), fm17(f17, v66, globalState);
					var v86 := DC1(f16);
					var v87: multiset<int> := multiset{f18, |([v86])[f18 := v86]|, f18};
					globalState.f0, v87, v0 := f17, v87[f18 := f18], v66[f18 + -0x205];
				...
				case DC20(cf24) =>
					...
					var v90: set<C0> := {v89};
					v90 := v90;
					var v91: map<string, char> := map[v66[f18 := v0] := if (v68[617]) then 'i' else fm18(false, f18, globalState)];
					v91 := v91[v66 + "klesuti" := if (!f17) then v0 else v0];
					var v92: seq<array<bool>> := [cf24, cf24];
					var v93: map<int, bool> := map[|(seq(90, i9  => ([v68[617], v68[617]])))| := v68[617]];
					globalState.f14, globalState.f7 := v92[f18], |(if (false) then v93[0x274 := v68[617]] else v93)|;
			}
			
			globalState.f7 := f18;
			var v94: seq<int> := [-(f18 - f18), f18];
			globalState.f7 := v94[f18 % f18];
			if (f16) {
				var v95: array<int> := new int[7];
				v95[7] := f18;
				v95[7] := f18;
				v95[7] := fm1(f19, f16, fm6(v0, globalState), globalState);
				v94 := v94;
				globalState.f7 := v95[7];
				...
				v66 := v66[|multiset{v94[if (f19 in v98) then v98[f19] else f18]}| := if (f19 in v99) then v99[f19] else v0];
				...
				var v105: array<seq<int>> := new seq<int>[11] [(v102.(cf36 := v94)).cf36, v94, v94, if (v104.cf47) then seq(0x2bc, i10  => (f18)) else v94, v94 + v94, (seq(545, i11  => (|{f16}|))) + v94, [f18, f18, f18], seq(-0x104, i12  => (f18)), v94, seq(0x29a, i13  => (f18)), v94];
				var v106: map<bool, int> := map[f17 := f18];
				v68[822], globalState.f7, v105 := f16, fm1(f19, f16, 0x243, globalState) * |v106|, v105;
				v68[822] := fm2(f16, globalState);
			}
		...
		match (v110) {
			case DC4(cf4) =>
				var v111: array<int> := new int[23](i14 => i14 / -f18);
				v111[836] := cf4;
				var v112: map<int, int> := map[-f18 := cf4];
				v111[836] := -(cf4 * f18) / |v112|;
				globalState.f0 := f17;
				var v113 := m10(v0, globalState);
				var v114: array<seq<int>> := new seq<int>[17](i15 => [v111[836]]);
				var v115: map<bool, array<seq<int>>> := map[f19 := v114];
				var v116: seq<array<seq<int>>> := [v114];
				var v117: array<array<seq<int>>> := new array<seq<int>>[9] [v114, DC69(v114).cf100, v114, if (fm5(cf4, fm8(true, v111[836], cf4, globalState), f18, f16, globalState) in v115) then v115[fm5(cf4, fm8(true, v111[836], cf4, globalState), f18, f16, globalState)] else v116[-716], v114, v114, v114, v114, v114];
				v117[954] := v114;
				v117[954] := v114;
			case DC5() =>
				v0 := v0;
				...
				v121 := v121[v123.cf93[f19 := f18] := !(v124[f18 := v118[f17 := f18]] != v124)];
				if (f16) {
					var v125 := DC62(v0, f19, f18, f17);
					v125 := v125;
					var v126: seq<string> := [v66, v66];
					v66 := (v66 + v126[|v66|]) + v66;
					...
					v129 := (v129[0x3ae := v128] + v129)[|(if (!f16) then v131 else v131)| := v128];
					...
					var v138 := DC7(|(seq(0x2e2, i17  => (v0)))|, |v66|);
			...
			case DC3(cf3) =>
				...
				var v145: array<seq<D12>> := new seq<D12>[1] [seq(0x2e8, i18  => (DC30(v143)))];
				var v146 := DC64(v142, |v144|, v145);
				globalState.f7 := v146.cf91 / f18;
				globalState.f0 := f17;
				var v147: array<char> := new char[6];
				v147[3] := v0;
				var v148: array<bool> := new bool[8](i19 => f16);
				var v149 := DC18(f18, f19, f18);
				v148[702] := if (f17) then v149.cf21 else !f17;
				...
				v147[3], v148[702], v152, globalState.f13 := v0, f16, v152 + v152, v154 <= (multiset{v153} * v154);
				v148[702] := f17;
		}
			...
			decreases 100 - i20
		{
			...
			if (f16) {
				v157[486] := f17 in v107;
				var v158 := DC18(f18, f19, f18);
				v157[486] := v158.cf21;
				var v159: array<map<array<bool>, bool>> := new map<array<bool>, bool>[1];
				var v160: seq<int> := [f18, 20];
				var v161: seq<int> := [v160[f18]];
				var v162 := DC38(f16, v161[|v160|], f18, f17);
				var v163: array<bool> := new bool[10] [f19, f17, false, f16, v157[486], f19, f19, v162.cf50, f17, f17];
				var v164: map<array<bool>, bool> := map[v163 := false];
				v159[926] := v164;
				v159[926] := v164 + v164;
				globalState.f7 := if (v160 != v161) then f18 else f18;
				globalState.f7 := -f18;
				var v165: seq<bool> := [v157[486], f19];
				var v166 := new C5(v165[|(seq(0x74, i21  => (f18)))|], false);
			} else {
				...
				v171[183] := f19;
				v171[183] := f18 > (v168 * v168);
			}
			
			var v172: array<map<int, int>> := new map<int, int>[8];
			var v173: seq<array<map<int, int>>> := [v172, v172];
			var v174: seq<int> := [f18, f18, f18];
			var v175: array<array<map<int, int>>> := new array<map<int, int>>[16] [v173[|v174|], v172, v172, v172, v172, v172, v172, if (f17) then v172 else v172, v172, v172, v172, v172, v172, v172, v172, v172];
			v175[60] := v172;
			var v176: multiset<int> := multiset{f18};
			globalState.f7, v175[60], v176 := -(f18 * (if (f19) then 663 else f18)), v172, v176 + v176;
		}
	}
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		var v0 := "lpt";
		for i0 := -f18 to |v0| {
			...
			var v6: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[19] [v4, v4, v4, v4[i0 := v3], seq(874, i1  => (v3)), if (!v5[|"aufip"|]) then v4 else v4, [DC6(map[false := true]).cf5, v3] + v4, v4, v4, v4, (seq(917, i2  => (v3))) + v4, v4, v4 + v4, (seq(-0xb0, i3  => (v3))) + v4, v4, v4, v4, v4, fm61(f17, fm3(seq(548, i4  => ('b')), v5, "vupjfi", globalState), f17, f16, globalState)];
			v6[452] := [v3, v3] + (seq(0x392, i5  => (map[f19 := f16])));
			v6[452] := (v4 + v4) + (if (f17) then v4 else v4);
			globalState.f0 := true;
		}
		globalState.f7 := f18 % f18;
		match (DC55(seq(0x14, i6  => (v0)))) {
			case DC56(cf78, cf79) =>
				...
				globalState.f3, v12[173], globalState.f7, v16, globalState.f0 := fm5(f18, cf79, f18, |v11| == |fm78(f18, false, cf78, globalState)|, globalState), v15, f18, v16, f19;
			...
			case DC57() =>
				...
				var v20: map<int, array<bool>> := map[fm1(f19, f19, f18, globalState) := v18[-(if (f17 in v19) then v19[f17] else |v0|)]];
				v20 := v20[264 := v17];
				...
				v21[143] := (if (v26 in v27) then v27[v26] else f18) % |(v18 + [v17])|;
			case DC55(cf77) =>
				var v28: array<bool> := new bool[26];
				v28[408] := false;
				var v29: seq<D29> := [DC70(f17)];
				var v30 := DC70(f19);
				v28[408] := v29 != [DC70(f19), v30];
				var v31: array<string> := new string[7];
				v31[160] := "emllljc";
				var v32: seq<int> := [|v0|];
				var v33 := DC26(f16, f18, f18);
				var v34: multiset<int> := multiset{v33.cf33};
				r0, globalState.f7, globalState.f7, v31[160] := v32 + v32, -(|v34| * f18), f18 / (v32[f18] + 0x14f), v0[f18 := 'c'];
				globalState.f0 := f19;
				globalState.f7 := f18;
		}
		
		var v35: seq<bool> := [false, f19, f16];
		var v36: map<int, seq<bool>> := map[f18 % f18 := v35[f18 := !!f17]];
		...
		var v42: seq<int> := [f18 / fm4(v0, f18, map v41 : int | (300 <= v41) && (v41 < 0x3bd) :: (v41 * f18) := (f17), globalState), f18 / f18];
		r0 := v42;
		r1 := f16;
		r2 := f19;
		r3 := v0;
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		var v2 := "itqucav";
		if (!((v2 + (seq(-790, i0  => ('p')))) == (seq(0x305, i1  => ('s'))))) {
			var v3: map<string, int> := map[v2 := f18];
			var v4 := DC17(v0);
			var v5 := 'n';
			var v6: array<int> := new int[11] [-f18, if (v2 in v3) then v3[v2] else f18, f18 - f18, f18, f18 + -f18, f18, f18, f18 / fm9(v4.cf19, f17, f18, globalState), f18, if (f16) then 0x189 else f18, f18 + fm6(v5, globalState)];
			var v7: seq<int> := [0x2b9, 0x210];
			var v8: array<bool> := new bool[12];
			var v9: seq<array<bool>> := [v8];
			v6, globalState.f14, v7, v2 := if (f19) then v6 else v6, if (f17) then v9[f18] else v8, v7, v2;
			r1 := !!v0[f18];
			var v10: map<bool, bool> := map[f16 := f16];
			var v11: map<int, bool> := map[f18 := f17];
			var v12: array<seq<int>> := new seq<int>[10] [[|v10|, f18, f18, f18, |v0|] + v7, v7, v7, v7, v7[|v0| := f18], (seq(0x207, i2  => (|{p0}|))) + [f18], seq(0x1ec, i3  => (f18)), v7, v7 + [0x317], [fm4(v2[f18 := v5], f18, v11, globalState), f18, f18, f18]];
			v12[301] := v7;
			var v13: seq<seq<int>> := [v7, [f18, f18], v7, v7, v7];
			v12[301], globalState.f7 := [f18] + v13[f18], f18 / f18;
			...
			var v17 := DC51(p0, f18 % |v16|, f18 * 0x295);
			v17 := fm79(seq(0x2cc, i4  => ('d')), f18, f19, fm8(f16, 992, f18, globalState), globalState);
			globalState.f3 := f16;
			v2 := v2;
		...
		for i6 := f18 to f18 / f18 {
			...
			if (f17 !in (if (f16 in v21) then v21[f16] else [f17])) {
				...
				v27[795] := v26;
				v23[514], v27[795] := v24, v26 + v26;
				var v28: array<int> := new int[4](i9 => i9 / 0x69);
				...
				globalState.f8 := v1[i6 * |v32|];
				globalState.f13 := f16;
				var v33 := 'l';
				var v34: map<int, map<bool, int>> := map[i6 := map[fm5(|v2[i6 := v33]|, f19, f18, f17, globalState) := i6]];
				r1 := (f18 != |(if (i6 in v34) then v34[i6] else map[f16 := i6])[f17 := |v31|]|) <== !f17;
				var v35: map<int, int> := map[f18 := f18];
				var v36: set<bool> := {f16};
				var v37: map<bool, seq<char>> := map[fm8(fm2(v0[fm7(f17, i6, v35, v36, globalState)], globalState), i6, -i6, globalState) := v2 + v2];
				v37 := v37 + map[f19 := seq(0x19d, i10  => (v33))];
				...
				var v41: array<string> := new string[22] [v2, v2, v2, v2, seq(853, i11  => (v33)), "rrrj", v2, v2, seq(-0x169, i12  => (v33)), v2, v2[f18 := v33], v2, v2 + v2, "de", v2, v2, v2 + v2, v2, v2, v2, seq(-806, i13  => (v33)), (v2 + "w")[i6 := v33]];
				v41[900] := v2;
				var v42: map<int, char> := map[i6 := v33];
				v40, r1, v41[900], v42, globalState.f3 := DC49(f19, f16, f17), p0, v2, v42, f19;
			}
		...
		for i14 := f18 to 0x27d {
			...
			var v50: map<string, bool> := map[("ncqmpnc")[i14 := 't'] + "ulcvaw" := f17];
			globalState.f0 := if ((seq(-0x20b, i15  => ('v'))) in v50) then v50[seq(-0x20b, i15  => ('v'))] else f19;
			globalState.f7 := i14;
			if (if (!f16) then p0 <==> f16 else !(p0 || f17)) {
				...
				r0 := i14;
				globalState.f7 := f18;
				v49[49] := if (f19) then true else f16;
				v49[49] := p0;
			} else {
				var v51: array<string> := new seq<char>[20](i16 => seq(0x213, i17  => (v47)));
				v51[161] := "yfr" + "offllq";
				v51[161] := v2;
				r2 := f19;
	...
	method m10(p0: char, globalState: GlobalState) returns (r0: array<bool>) {
		if (f16) {
			globalState.f13, globalState.f7, globalState.f7, globalState.f7 := f19, (f18 / f18) % f18, f18, f18;
			...
			if (!(v0 >= v1[f18])) {
				...
				v18[910] := v19;
				v18[910] := v19;
				v10, globalState.f7, globalState.f13, globalState.f7, globalState.f7 := v10, (f18 % fm4(v2, f18, v13, globalState)) / -461, false, (if (f18 in v5) then v5[f18] else 0x1e3) - f18, f18;
				var v20: seq<map<int, int>> := [v8 + v8, map[f18 := f18]];
				var v21: map<int, string> := map[-f18 := v2];
				globalState.f7, v20, r0 := v4.fm9(v3, v4.f22, if (f18 in v8) then v8[f18] else f18, globalState) % |v21|, v20, v17;
			} else {
				globalState.f7 := 0x14c * (f18 % -f18);
				var v22 := new C3(f18 <= f18, f17);
				var v23 := new C6(f19, f17);
				var v24: multiset<string> := multiset{seq(0x363, i0  => (p0))};
				v24 := v24;
				var v25: set<char> := {p0};
				globalState.f7 := |v25|;
			}
			...
			match (v37) {
				case DC25() =>
					var v38: map<bool, string> := map[f17 := seq(0x3a7, i2  => (p0))];
				...
				case DC26(cf31, cf32, cf33) =>
					...
					var v42: map<string, array<bool>> := map[seq(0xb0, i3  => ('f')) := v41];
					var v43: seq<seq<char>> := [v33, v33[cf33 := p0], seq(0x59, i4  => (v40)), v33];
					var v44: seq<bool> := [f19, f17, f17];
					var v45: C6 := new C6(!false, v44[f18]);
				...
				case DC27() =>
					...
					var v51 := new C2(p0, f16, 0x33a, v50 <= (seq(0x314, i5  => (f18))), f17, f17);
					var v52: multiset<int> := multiset{f18, f18, f18 % f18};
					v52 := v52;
					var v53 := 'o';
					...
					var v58: map<int, int> := map[f18 := |v57[f18]|];
					var v59: set<bool> := {f17};
					v53, globalState.f0, v54[551], v51.f22, globalState.f13 := v51.f21, f16, f18, f19, fm7(f17, f18, v58, v59, globalState) >= f18;
					...
					var v64 := DC3(v63[|v33|]);
					var v65: array<bool> := new bool[28] [f16, v51.f22, f18 <= -0xd1, f17, if (false) then f16 else f19, f17, f19, f17, v51.f22, v51.f22, fm2(f19, globalState), false, v51.f22, !(|v60| != |v61|), v51.f22 <== v51.f22, f16, true, v51.f22, true, v59 != v59, f19, |v62| != f18, f19 && f16, !f19, f16, f19, v51.f22, v64.cf3 != (seq(-0x5, i6  => (v51.f21)))];
					v65[393] := true;
					v65[393] := f16;
				case DC24(cf30) =>
					...
					var v74: set<int> := {f18};
					v72[514] := (|map[f18 := f18]| * |v73|) > |v74|;
					var v76: array<map<int, seq<bool>>> := new map<int, seq<bool>>[2](i7 => map[f18 := [v66.f22]] + (map v75 : int | v75 in v69 :: (v75 / 0x111) := (v67)));
					var v77: map<int, seq<bool>> := map[-f18 := v67];
					v76[229] := map[f18 := v67] + v77;
					...
					var v82: array<int> := new int[24] [f18, f18, 280 % f18, |v33|, |v79|, |fm3(v33, v67, v33, globalState)|, v78.fm4(v33, |v33|, v80, globalState), f18, f18, f18 * f18, f18, |v69|, f18 - f18, |(v74 + v74)|, |v74|, |"wmmq"|, f18 + v69[f18], f18, f18, -|v81|, f18, -|(v67 + v67[412 := false])|, f18, f18 * f18];
					v82[121] := f18;
					var v83: map<bool, bool> := map[v33 < v33 := v72[514]];
					var v84: map<array<bool>, bool> := map[v72 := f17];
					v76[229], v82[121], globalState.f0, v83 := (if (f16) then v77 else v77) + v77, -f18, if (v72 in v84) then v84[v72] else f16 in v73, v83;
					globalState.f0 := v72[514];
				case DC28(cf34) =>
			...
			v87[178], globalState.f7 := v88, fm7((fm81(f19, p0, 0x353, p0, globalState).(cf69 := f16, cf68 := f17)).cf69, f18, v89, v90, globalState);
		}
		...
		v93, v94[226], globalState.f0, globalState.f3, globalState.f7 := match v96.(cf17 := fm37(globalState)) {
			case DC15(cf17) => v93
		}, match v97 {
			case DC25() => f16
		...
		var v103: array<int> := new int[3](i10 => i10 / |v93|);
		globalState.f0 := !v91.fm5(v91.fm6(p0, globalState) % f18, f18 <= f18, fm7(true, f18, if (false in v102) then v102[false] else v100, v95, globalState) - f18, DC67(f18, false, v103).cf97, globalState);
		globalState.f7 := f18;
		r0 := v94;
	}
	method m11(p0: bool, p1: int, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			if (f18 <= |v1|) {
				...
				var v9 := 'k';
				v3[830], v4, v5[246], globalState.f14, v2 := v6.cf58 - (-f18 - p1), v4, v8 < v8, v5, v2[p1 := v9];
				var v10 := DC31(v0);
				var v11: map<bool, bool> := map[v3[830] !in v10.cf37 := p0];
				v11 := v11[f16 := v5[246]];
				var v12 := new C0();
				var v13 := new C5(!p0, v5[246]);
			} else {
				var v14 := "lnbvkurj";
				var v15 := 'g';
				var v16: map<int, bool> := map[f18 := f19];
				var v17: seq<set<int>> := [v0, {f18, p1, 0x3a0, fm4(v14[0x387 := v15], f18, v16, globalState), |v1|}, v0];
				var v18: map<int, int> := map[f18 := p1];
				var v21 := DC31(v0);
				var v24: array<set<int>> := new set<int>[25] [v0 + v0, v0, v0, {p1, p1}, v0, {p1}, v17[if (p1 in v18) then v18[p1] else f18], v0, set v19 : int | v19 in v16[p1 := f16] :: (v19 % |map[-|{!false, false}| := -0x265]|), v0 * (set v20 : int | v20 in v1 :: (v20 + -0x28)), v0, v21.cf37, v0, v0, v0 - v0, v0, set v22 : int | (0xf2 <= v22) && (v22 < -0x1c5) :: (v22 * p1), v0, (set v23 : int | v23 in map[f18 := v15] :: (v23 % 0x23b)) * v0, v17[|v14|], v0, v0, v0, v0, v0];
				v24[870] := v21.cf37;
				...
				v24[870], v25[803], v15, globalState.f13 := v0, v27 <= (v27 * v27), 'k', v29[if (p0) then p1 else |v16|];
				var v30 := new C4(899, !f16, f16, false);
				globalState.f0 := v29[f18];
				v24[870] := if (f18 > f18) then v24[870] else fm43(globalState);
				globalState.f3 := p0;
			}
		...
		for i4 := f18 / p1 to p1 / p1 {
			...
			if (p0) {
				...
				var v41: multiset<seq<int>> := multiset{seq(0x341, i5  => (p1)), v40, seq(231, i6  => (p1))};
				...
				r0 := |v0| % |(map[v43.f22 := v34] + map[f16 := v34])|;
				var v44: map<bool, int> := map[f16 := p1];
				var v45 := "cqlgk";
				v44 := v44[p0 := |v45| % i4];
				v33[473] := f17;
				globalState.f7, v33[473], r0 := fm1(f16, f19, f18 * p1, globalState), false, f18 - i4;
			...
			if (v52 > multiset((v53 + v53)[fm7(true, p1, v55, v54, globalState) := f17])) {
...
class C8 extends T1 {
	...
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		...
		if (f16) {
			...
			v3[593] := fm1(true, f16, v1 - |map[v4 := v1]|, globalState);
			var v5: array<bool> := new bool[19](i0 => DC1(f16).cf1);
			v5[495] := fm2(f16, globalState);
			var v6 := DC1(true);
			v5[495] := v6.cf1;
			match (v6) {
				case DC1(cf1) =>
					v3[593] := v3[593];
					var v7 := new C7(v3[593] * v1, f16, f16, false);
					var v8 := "as";
					var v9 := new C1(v8, v5[495], f16);
					var v10: C6 := new C6(if (f20[|v9.f23|]) then v5[495] else f17, if (f17) then cf1 else cf1);
					globalState.f7, v10, globalState.f13 := -|v9.f23|, v10, cf1;
			}
			
			globalState.f13 := v5[495];
			var v11: array<array<int>> := new array<int>[8];
			v11[63] := if (v5[495]) then v3 else v3;
			v11[63] := if (f16) then v3 else v3;
		} else {
			var v12: array<set<int>> := new set<int>[28](i1 => {v1});
			var v13: set<int> := {298};
			v12[199] := v13;
			var v14: multiset<int> := multiset{|f20|, v1};
			var v15: map<bool, int> := map[true := |v14[v1 := v1]|];
			v12[199], globalState.f3, globalState.f8 := v13, (0x30d < v1) !in v15[f16 := v1], [f16, f16];
			v2[306] := v2[306];
			v12[199] := (v12[199] + v12[199]) * v13;
			globalState.f7 := v1;
			var v16: seq<int> := [0x3be, v1];
			var v17: map<int, int> := map[|v16| := v1];
			var v18: map<map<int, int>, seq<int>> := map[v17 + v17 := seq(0x260, i2  => (v1))];
			v18 := v18;
		}
		...
		v21[461], v22, globalState.f10 := v20, fm43(globalState), v23;
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			globalState.f7, v1, globalState.f3, v22 := (if (v1 in v20) then v20[v1] else |v22|) / (v1 % v1), v1 / v1, f17, {v1, v1, 0xc2};
			v21[461] := v21[461];
			var v26: C2 := new C2(v2[306], f16, v1, f17, f16, f16);
			var v27: multiset<C2> := multiset{v26};
			var v28: map<bool, map<bool, int>> := map[v26.f22 := map[f17 := v1]];
			var v29: map<char, seq<int>> := map[fm17(f16, v19[DC22(-|v27|).cf28 := v2[306]], globalState) := ([v1, v1])[|v28| := v1]];
			var v31: map<char, string> := map[v0 := "hh"];
			v29, globalState.f3, r1 := v29 + v29, v2[306] in (map v30 : char | v30 in v31 :: (v30) := (f17)), !v26.f22;
			globalState.f13 := f17;
		}
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		match (v3.(cf56 := f17)) {
			case DC42(cf54, cf55, cf56) =>
				...
				var v14: array<map<bool, int>> := new map<bool, int>[23] [v5, map[f16 := cf55] + v5, map[!p0 := fm1(f17, cf56, |{f16, f16}|, globalState)], map[!cf54 := cf55], v5 + v5, v5 + v5, if (!p0 in v6) then v6[!p0] else v5, v5, v5, v5, fm49(v7, "tfyjw", cf55, -0x31a, globalState), v5[f17 := cf55], v5, map[f16 := v2], map[f20[v2] := cf55], v5, v5, v5, v5, v5 + (if (|v13[false := v4]| in v10) then v10[|v13[false := v4]|] else v5), v5, v5 + v5, map[!true := cf55] + v5];
				v14[356] := v5;
				v14[356] := v5;
				r0 := --357;
				if (f17) {
					...
					v15[615] := cf55 * |v5|;
					v15[615] := if (!true ==> p0) then |(seq(0x389, i1  => (v7)))| else |"kwx"|;
					var v16: array<bool> := new bool[28];
					v16[274] := f17;
					var v17 := DC10(v15);
					var v18: multiset<D6> := multiset{v17};
					var v19: seq<D6> := [v17, v17];
					v16[274] := if (v18 > multiset(v19)) then true else fm2(cf56, globalState);
					v7 := v7;
					cf55 := v2;
					var v20: set<bool> := {f20[v15[615]], v16[274], p0, cf56};
					...
					var v33: array<int> := new int[28] [v2, v2, cf55, -(|v25| * v2), v2, cf55, (if (fm48(cf56, v7, p0, cf55, globalState) in v26) then v26[fm48(cf56, v7, p0, cf55, globalState)] else 478) / cf55, v2, -v2, cf55 / v2, 0x239 * |map[v2 := f17]|, v2, |v28|, v2, |(if (cf54 in v29) then v29[cf54] else v12)|, v2, v2 % cf55, cf55, if (f17) then |v30| else cf55, |([false, f16] + f20)|, v24.fm6('f', globalState), v2, v2, 0x23a, if (p0 in v14[356]) then v14[356][p0] else |v32|, |v22|, |v4|, v2];
					var v34: multiset<int> := multiset{cf55};
					v33, cf56, v8, globalState.f3 := v27, v34 == (v34 * v34), v8, f17;
					v33[951] := cf55;
					cf55, v33[951] := v8[|f20| * cf55], v8[cf55] % (cf55 - cf55);
					var v35: array<seq<D12>> := new seq<D12>[19](i3 => seq(0x209, i4  => (DC30([-cf55, 533]))));
					var v36 := DC64(f20, v33[951], v35);
					var v37: map<int, D27> := map[cf55 := v36];
					v37 := v37[cf55 + v8[cf55] := v36];
				}
			...
			case DC41(cf53) =>
				var v44: seq<int> := [v2];
				var v45 := "jagubvsj";
				var v46: multiset<int> := multiset{v2, v44[|v45|]};
				var v47 := DC0(v46);
				...
				var v53 := 'e';
				var v54 := DC10(v51);
				var v55: array<array<int>> := new array<int>[22] [v51, v52[fm6(v53, globalState)], v51, v51, v52[v2], v51, v51, v51, v51, v51, v51, v51, v52[v2], v51, v51, v51, v51, v54.cf10, v51, v51, v51, v51];
		...
		r0 := match v60 {
			case DC62(cf85, cf86, cf87, cf88) => |("q" + (seq(-0x14b, i6  => (v59))))|
			case DC61(cf84) => v2 % |(map v61 : seq<bool> | v61 in multiset{f20} :: (v61) := (p0))|
		};
		var v62: seq<int> := [v2, |"rmhgh"|, 922];
		var v63: multiset<int> := multiset{v2, v2, v2, v62[v2]};
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
			...
			decreases 100 - i0
		{
			...
			v1, globalState.f0 := v1 + fm3(v2[|v3|], f20, v1, globalState), f17;
			...
			var v15: array<int> := new int[24] [v0, -|v11| + v0, |v12|, v0 - v0, v0 / |"glyfj"|, v0, v0, v0 / v0, fm1(f17, f17, v0, globalState), v0, v0, -0x6a, v0, |(v5 + v13.cf45)|, v0, v0, if (f17) then |multiset{f16, f17, f17, f16}| else |v5|, 0x3b0, v14.cf58, v0, v0, v0, -v0, v0 + v0];
			r0 := v15;
		}
		...
		v16[578] := [v18.cf31, f16, false, f17];
		...
		match (v20) {
			case DC15(cf17) =>
				...
				var v27: map<set<int>, map<bool, int>> := map[set v25 : int | v25 in v24 :: (v25 / |multiset{true}|) := v26];
				var v29: set<int> := {176};
				...
				var v40: seq<set<int>> := [v29, set v39 : int | (972 <= v39) && (v39 < 291) :: (v39 / |f20|), {v17}, v29, v29];
				var v43: array<map<set<int>, map<bool, int>>> := new map<set<int>, map<bool, int>>[24] [v27, map v28 : set<int> | v28 in v30 :: (v28) := (v26), v27, if (f17) then v27 else v27, v27, map[v29 := v26], if (v33 in v32) then v32[v33] else map v34 : set<int> | v34 in v30 :: (v34) := (map[f17 := |map[v17 := v22]|]), v27, v27 + v35[v17], map v36 : set<int> | v36 in v37 :: (v36) := (map[f16 := v17]), v27 + (map v38 : set<int> | v38 in multiset(v40) :: (v38) := (v26)), map[v29 := v26] + (map v41 : set<int> | v41 in (set v42 : set<int> | v42 in map[v29 := v17] :: (v42)) :: (v41) := (v26)), v35[v17] + v27, v27 + v27, v27, if (f17) then v27 else v27[v29 := v26], v27 + v27, v27, v27, map[v29 := v26], v27, if (f16) then v27 else v27, v27, v27];
				v43[397] := v35[v17];
				v43[397] := if (f17) then v27 else v27;
		...
		v47[888] := !!(if (v48 in v49) then v49[v48] else f17);
		v47[888] := f17;
		globalState.f7 := v17;
		r0 := new int[16](i3 => i3 / -|v20.cf17|);
	}
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (match v2 {
			...
			v4 := v4;
			globalState.f0 := f20[v3];
			var v5 := 'x';
			v5 := v5;
		} else {
			var v6 := "ugcocr";
			var v7 := -201;
			var v8 := new C1((seq(448, i0  => ('b'))) + v6, v7 >= |v6|, f17);
			globalState.f7 := v7;
			var v9 := 'q';
			...
			var v16: array<int> := new int[8] [v7, v7, v7 % v7, -v7, v7, v7 - |v12|, v7, |(v15[|{f17, f16, f16, f16, f16}|] * v14)|];
			v16[73] := v7;
			...
			v16[73], globalState.f7, v7, globalState.f3, v17[871] := |(v8.f23 + v6)| % v7, |v19| * v7, |([fm5(|(seq(-0x346, i2  => (v9)))[v7 := v9]|, false, v7, f17, globalState)] + f20)| * v7, if (v13 in v20) then v20[v13] else f16, v18;
			v16[73] := v7 - v16[73];
			globalState.f7 := v7;
		}
		...
		match (v22) {
			case DC56(cf78, cf79) =>
				...
				v24[59] := v26[|v27|];
				v24[59] := v25;
				var v28: T2 := new C5(cf79, v24[59] !! v24[59]);
				globalState.f7, v28 := v23 % v23, v28;
			case DC57() =>
				var v29 := "dtbte";
				var v30: C1 := new C1(v29, f17, f17);
				var v31: seq<C1> := [v30];
				var v32 := 959;
				var v33: set<C1> := {v30, v31[v32], v30, v30};
				...
				var v41: map<string, int> := map[(seq(0x76, i6  => ('e'))) + v30.f23 := |v36| / |fm82(|v40|, v32, v32, globalState)|];
				v41 := v41[v30.f23 := 108];
			...
			decreases 100 - i7
		{
			...
			match (v44) {
				case DC25() =>
					...
					var v47 := 502;
					v45, globalState.f3, globalState.f7, v21[427] := v45, f17 !in v46, v47, f17;
					var v48: map<bool, seq<bool>> := map[f17 := [f16, v21[427], f16]];
					globalState.f8 := f20 + (if (f17 in v48) then v48[f17] else f20);
					var v49 := v43.m0(globalState);
				case DC26(cf31, cf32, cf33) =>
					var v50 := DC41((multiset(f20))[cf31 := cf33]);
					...
					var v59: array<int> := new int[19] [cf33, cf33, cf33, cf32 / cf32, |v53| - cf33, -cf33, cf32, cf32, cf33, v43.fm7(f16, cf33, v57, v58, globalState), cf32, cf33, cf32, if (v54) then cf32 else fm1(true, !f17, cf32, globalState), cf32, -cf33 / |v53|, cf32, cf32, cf32];
					var v60 := 'g';
					var v61: multiset<char> := multiset{v60};
					var v62: map<int, multiset<char>> := map[cf33 := v61];
					v59[131] := |((if (|"mp"| in v62) then v62[|"mp"|] else multiset{v60}) - v61)|;
					var v63: set<map<int, bool>> := {map[cf32 := f16]};
					v59[131] := -(if ({map[cf32 := cf31], fm21(cf33, globalState)} >= v63) then 0x9 - cf32 else cf32);
					var v64: array<seq<D12>> := new seq<D12>[23](i9 => [DC30(v52), DC30(seq(-0x210, i10  => (v59[131]))), DC30(v52)]);
					var v65 := DC64(f20[cf32 := true], -(-cf32 * cf33), if (f16) then v64 else v64);
					cf32, v65, globalState.f3, globalState.f7, globalState.f0 := |v52|, DC64(fm23(globalState), cf32, v64), !v55, |(seq(0x13d, i11  => (v51)))|, if (v55) then cf31 else v54 || f16;
				...
				case DC27() =>
					...
					var v72 := 'g';
					var v73: array<string> := new string[22] [v67, v67 + v67, v67, v67, v67, v67, v67 + v67, v67, v67 + (if (v69 in v70) then v70[v69] else v67), v67, v67 + v67, v71[v68], v71[v68], v67 + v67, v67, v67, v67, v67, v67, fm3((v71[v68])[v68 := v72], f20, seq(-0xd, i12  => (v72)), globalState), v67, v67];
					v73[225] := v67 + v67;
					v73[225] := v67;
					globalState.f14 := v21;
					var v74: map<string, int> := map[v73[225] := v68];
					...
					v82[105] := map["d" := fm6(v72, globalState)];
					var v83: set<int> := {v68};
					var v84: seq<map<string, int>> := [v74, v74];
					globalState.f13, globalState.f13, v82[105], v72, globalState.f13 := false, v83 !! v83, v84[v68 % v68], 'w', !(f16 in v0);
				...
				case DC24(cf30) =>
					...
					var v94 := DC78([{true, f16, v21[613], f17, v21[613]}]);
					var v95: array<bool> := new bool[9](i14 => f17);
					var v96: seq<seq<set<bool>>> := [v93, seq(0x3e3, i15  => (v92))];
					var v97: map<array<bool>, seq<set<bool>>> := map[v95 := v96[-v87]];
					var v98: seq<string> := [v88];
					var v99: array<seq<set<bool>>> := new seq<set<bool>>[26] [v93, v93, v93, v94.cf109 + v93, v93[v87 := v92], v93, v93 + v93, v93, v93, v93, [fm20(v87, globalState)] + v93[0x362 := v92], (if (v95 in v97) then v97[v95] else [v92]) + v93, v93, v93, v93, [v92] + [v92], [v92] + [v92], v93, v93 + v93, fm83(!f17, v98, f20, f16, globalState), v93, v93, v93, fm83(f16, v98, f20, f16, globalState), v93 + v93, v93];
					v99[870] := [v92, v92];
					var v100: multiset<bool> := multiset{f17, v21[613]};
					var v101: multiset<int> := multiset{-v87, v87, -v87, v87, v87};
					var v102: T2 := new C7(v87, f17, f16, v21[613]);
					...
					var v107: array<int> := new int[20] [|(map[v100 := "uxtwbk"])[v100 := seq(433, i16  => ('l'))]|, v87, v87, if (f17) then 0x307 else -|v100|, v87 + -0x28, v87, if (-v87 in v101) then v101[-v87] else if (v87 in v101) then v101[v87] else 0x18e, 407, v87, v87, v87, v87, |v105| / -v87, v87, v87, v87, v43.fm4(v88, |f20|, v106, globalState), v87, v87, v87];
					v107[435] := -|f20|;
					v90[975], globalState.f7, v99[870], v107[435], v21[613] := v91, v87, v93, v87, f16;
				case DC28(cf34) =>
					var v108 := 481;
					...
					var v110 := "shcm";
					v109[101] := map[|fm3(v110, f20, v110, globalState)| := v108];
					...
					v109[101] := ((map v111 : int | (355 <= v111) && (v111 < -0x29e) :: (v111 * v108) := (v108)) + (map v112 : int | (880 <= v112) && (v112 < 0x1a) :: (v112 + v108) := (v108))) + ((map v113 : int | (398 <= v113) && (v113 < 0x2ae) :: (v113 % v108) := (v108)) + v122);
			...
			var v137: set<int> := {v131, |(seq(0x2f1, i19  => ('y')))|, v131};
			...
			decreases 100 - i20
		{
			...
			i20 := i20 + 1;
			var v139 := 663;
			globalState.f7 := v139 / v139;
			v21 := v21;
			var v140 := 'h';
			var v141: seq<char> := [v140, v140, v140, v140, v140];
			var v142: map<string, seq<char>> := map[seq(0x5, i21  => ('t')) := v141];
			var v143: multiset<bool> := multiset{false};
			var v144: map<multiset<bool>, bool> := map[(multiset{f17, f17})[f16 := v139] := f16];
			...
			var v151: array<seq<int>> := new seq<int>[24] [v145, [|v146|, v145[|v141|], v139, v139, |v147|], v145, v145, v145, fm33(f17, f16, f17, globalState), v145 + v145, [v139], v145, v145, v145, v145, [v139] + v145, v145, if (f16) then v145 else v145, v145, [-(if (|v149| in v148) then v148[|v149|] else v139), |v150|, 0x23f], v145 + v145, v145 + [v139, |v141|], v145, v145, v145, v145, v145[v139 := |v141|]];
			v151 := new seq<int>[3](i22 => (seq(304, i23  => (v139))) + (seq(-0x47, i24  => (|v0[f20[v139] := DC70(f16).cf101]|))));
		}
		r0 := f16;
		r1 := true;
	}
	method m8(p0: bool, p1: bool, p2: D0, p3: string, globalState: GlobalState) returns (r0: bool, r1: bool, r2: set<D0>) {
		...
		match (v3) {
			case DC25() =>
				if (f17) {
					...
					globalState.f3 := f17;
					var v7: multiset<bool> := multiset{f20[v0], p0};
					var v8 := 'k';
					globalState.f3 := !(fm3("axycyamiw", [p0, p0], (seq(0x9e, i0  => ('a')))[-|v7| := v8], globalState) != p3);
					...
					var v19 := 'm';
					v13, v15 := v13, fm84(p0, v0, v0, |(if (f16) then v17 else v18[fm6(v19, globalState)])|, globalState);
					...
					v22 := v22[-(|v23| - v1.fm4(p3, v0, map[v0 := p0], globalState)) := 0x2fc];
					globalState.f0 := v1.fm5(v0, |p3| <= v0, v0, f17, globalState);
				}
				
				var v24: seq<int> := [v0, v0];
				globalState.f13 := (v0 - |(seq(-0x30a, i1  => ('p')))|) in v24;
				globalState.f0 := true;
			...
			case DC26(cf31, cf32, cf33) =>
				...
				v27[405] := multiset(v30) == multiset{v0, -cf32, cf32, v0};
				var v31: array<int> := new int[20];
				v31[796] := -cf32;
				var v32: multiset<bool> := multiset{p0};
				v27[405], v31[796] := v32 >= v32, DC26(f17, cf33, cf32).cf32;
				v31[796] := v0;
			case DC27() =>
				if (p0) {
					globalState.f7 := v0;
					...
					var v36: seq<T3> := [v35];
					var v37: map<bool, int> := map[f17 := |v36[v35.f18 := v35]|];
					var v38: set<int> := {v35.f18};
					var v39: map<int, int> := map[v35.f18 := |(seq(0x22, i2  => ('i')))|];
					var v40: T2 := new C6(v35.f19, p0);
					var v41: multiset<T2> := multiset{v40};
					var v42: array<int> := new int[27] [if (p0 in v37) then v37[p0] else v35.f18, v0, v0, |({v35.f18} - v38)|, v35.f18, v35.f18, |v39|, |p3|, 0x16f * 0x309, |[!v35.fm5(v0, v35.f19, |v37|, v35.f17, globalState), p1]|, |v41|, v35.f18, v0 * v0, 0x33a, v35.f18 % v35.f18, v0, v35.f18, v35.f18, -(v35.f18 / v35.f18), v35.f18, v35.f18, v35.f18 / -v35.f18, if (v35.f16) then |p3| else v0, v0, v35.f18, v35.f18, v0];
					v42[504] := v35.f18;
					...
					v42[504], v48, globalState.f3, globalState.f7 := fm1(v35.f19, !v35.f19, v35.f18, globalState) - (v35.f18 % v35.f18), v48, (p3 + p3) != p3, v0 - v35.f18;
					var v49: seq<int> := [v42[504], v35.f18];
					v42[504], globalState.f7 := v1.fm4(p3, v35.f18, fm27(p3, v35.f17, globalState), globalState), -(v49[-0xed] - (v0 / v35.f18));
					var v50, v51, v52, v53 := v1.m2(globalState);
					r1 := v35.fm8(p0, v42[504], |((seq(-0x309, i3  => (v35.f18))) + [v0])|, globalState);
					var v54 := DC22(v42[504]);
					v54 := v54;
				}
				...
				match (v56) {
					case DC7(cf6, cf7) =>
						...
						v57 := v57 + v57;
						var v58: array<int> := new int[14] [v0, v0, v0, v0, cf7, cf7, cf6 + cf7, cf7, cf6 % cf6, cf6 + |[|p3|]|, 0x154, fm1(p0, true, v0, globalState), v0, v0];
						v58[415] := v0;
						v58[415] := cf7;
						globalState.f3 := v1.fm5(v58[415], true, cf6, f17, globalState);
					case DC6(cf5) =>
						var v59: array<array<bool>> := new array<bool>[12];
						var v60: array<multiset<int>> := new multiset<int>[1] [multiset(seq(0x23, i4  => (|multiset{p3, p3}|)))];
						var v61 := DC58(v60);
						var v62 := 'd';
						var v63: map<int, string> := map[v0 := p3];
						var v64: multiset<string> := multiset{p3[v0 := v62], if (v0 in v63) then v63[v0] else p3};
						var v65: multiset<int> := multiset{-v0, v0};
						var v66: map<int, int> := map[|f20| := v0];
						var v67: seq<map<int, int>> := [v66];
						globalState.f3, v59, v61, v62, globalState.f3 := v64 >= fm85(p1, if (|p3| in v65) then v65[|p3|] else -v0, v0, f16, globalState), v59, v61, p3[v0], if (p1) then f16 else v67 <= v67;
					...
					case DC8(cf8) =>
						...
						var v74: map<set<int>, int> := map[v73[929] := v0 + v0];
			...
			case DC28(cf34) =>
				...
				var v96 := DC56(v95, p1);
				v94[678] := v96;
				var v97: array<string> := new string[6] [p3, seq(0x163, i7  => (v95)), if (p1) then p3 else p3, p3 + p3, p3, "uemr"];
				...
				v97[245] := if (v98 in v99) then v99[v98] else p3;
				var v100: map<int, bool> := map[v93[744] := f17];
				v97[245] := if (f16 <== f17) then (seq(0x200, i8  => (v95)))[v93[744] := v95] else if (true) then p3[|v100| := v95] else p3;
				var v101: seq<int> := [v0];
				globalState.f0 := (v101 + v101) < v101;
		}
		
		var v102 := 'm';
		var v104: map<char, map<int, bool>> := map[v102 := (map v103 : int | v103 in (seq(-69, i9  => (|{v0, v0}|))) :: (v103 + v0) := (f16))[v0 := p1]];
		...
		match (DC41(v106)) {
			case DC42(cf54, cf55, cf56) =>
				...
				v118 := new int[28] [cf55, -cf55, |(seq(0x25a, i11  => (v0)))|, v0, cf55, cf55 + (if (cf55 in v120) then v120[cf55] else v0), v0, v0, |v121|, cf55, cf55, -v0, -v0 + |(seq(0x1ca, i12  => (v102)))|, cf55, v0, -|(v122 * v122)|, |v124[v0]|, 0x37d + -982, 0x18d % -|fm22(v0, globalState)|, 0x150, if (p1) then v0 else v0, |v125| % v0, cf55, cf55, v0, cf55, |(set v127 : char | v127 in v126 :: (v127))|, v0];
				v118[475] := v0;
				v118[475] := v0;
				var v128 := DC10(v118);
				...
				globalState.f7, globalState.f14, v102, v130 := |((if (f17) then seq(0x310, i13  => (v102)) else p3) + p3)|, v131, v102, if (cf54) then DC40(v129) else DC40(v129).(cf52 := v129);
			case DC43(cf57, cf58) =>
				r1 := v0 < cf58;
				var v132: seq<int> := [v0];
				var v133 := DC74(v132);
				...
				var v139: array<int> := new int[12] [|f20|, cf58, cf58, cf58 / cf58, v0, cf58 - -cf58, cf58, v0 + v0, |v135|, fm4(p3, |p3|, map[|{|v137[cf58]|, v0, v0, v0, fm6(v102, globalState)}| := v138.cf21], globalState) / v0, v0, 0x93];
				...
				globalState.f7 := v1.fm7(true <==> cf57, if (p1 in v106) then v106[p1] else v132[v0], map v142 : int | v142 in v144 :: (v142 / |{true}|) := (v0), fm37(globalState), globalState);
				if (f16) {
					...
					var v151 := DC29(v149 * v150[cf58]);
					v148[317], v151 := v147.cf112, v151.(cf35 := v149);
					globalState.f7 := (cf58 - v0) * cf58;
					globalState.f0 := f16 && p1;
					var v152: array<bool> := new bool[12];
					v152[426] := !p0;
					v152[426] := f17;
					var v153 := new C7(cf58, f17, !f17, v152[426]);
				} else {
					globalState.f0 := (|p3| + cf58) != (cf58 % cf58);
					...
					v160[828] := f17;
					v160[828] := p1;
					var v161: T2 := new C3(!v160[828], f16);
					var v162: map<T2, bool> := map[v161 := v160[828]];
					globalState.f0 := if (v161 in v162) then v162[v161] else v0 in v140;
				}
				
			case DC41(cf53) =>
				var v163: seq<int> := [v0, v0, v0, v0];
				if (fm2(if (v1.fm5(v0, f16, v163[v0], f16, globalState)) then p1 else p1, globalState)) {
					globalState.f7 := v0;
					...
					v168[975] := v167;
					v166[497], v168[975] := -((v0 + v0) * v0), v167;
					globalState.f7 := v165.fm9(f20, !p0, -(|cf53| / v166[497]), globalState);
				} else {
				...
				var v179: multiset<set<int>> := multiset{v176[|v178|]};
				var v180 := new C7(v0, multiset{v175} >= v179[fm43(globalState) := |cf53|], f17, !f17);
				...
				v184[546] := v0 < -((if ('w' in v185) then v185['w'] else |multiset{v0, -v183[432]}|) / v183[432]);
		}
		...
		for i16 := v0 to v0 - v0 {
			...
			if (f16) {
				...
				v187[161] := !f16;
				var v188: seq<seq<bool>> := [[f16] + f20[v0 := p0]];
				var v189 := DC79(p0, v102);
				globalState.f8, v187[161], globalState.f13, globalState.f3 := v188[i16], v189.cf110, p0, p1;
				var v190: multiset<int> := multiset{-|(seq(0x1c1, i17  => (v102)))|};
		...
		for i19 := |(v203 + v203)| to v0 {
			...
			v204[711] := v207;
			v204[711] := (seq(0x137, i21  => (-0x2e4))) + ([i19] + v207);
			globalState.f7 := v0;
		}
	...
	method m9(p0: multiset<int>, p1: int, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		for i1 := p2 + p1 to p1 {
			...
			var v7: multiset<string> := multiset{seq(0xd8, i3  => (v4[i1]))};
			...
			var v12: array<bool> := new bool[19] [!false, (set v5 : char | v5 in v4 :: (v5)) > v6, |v4| > p2, i1 != p1, !f16, f16, f16, (seq(0x235, i2  => (v3))) == [v3], f17, v7 !! v7, f16, v8 in v9, p2 == p1, f17, if (v10 in v11) then v11[v10] else f16, f20 <= f20, false, |multiset{i1}| <= |v8|, f17];
			globalState.f14 := v12;
			globalState.f0 := f17;
		}
		if (f16) {
			...
			match (if (if (|f20| in v13) then v13[|f20|] else f17) then v14 else v14.(cf73 := p2, cf72 := f17)) {
				case DC51(cf72, cf73, cf74) =>
					...
					var v18 := DC6(v17);
					var v19: seq<D4> := [v18];
					globalState.f10, globalState.f0, cf73, globalState.f13 := v16, cf72, cf73, (if (f17) then v19 else v19) < (v19 + (seq(0x159, i5  => (v18))));
					var v20: array<map<int, D8>> := new map<int, D8>[13](i6 => map[cf73 := DC17(f20)]);
					v20 := v20;
				case DC50(cf71) =>
					var v21 := "jkw";
					var v22: seq<string> := [v21, seq(0x2e7, i7  => ('j')), v21, v21, v21];
					var v23: map<string, int> := map[v22[p1] := |(seq(0x75, i8  => ('j')))|];
					var v24 := 's';
				...
				case DC52(cf75) =>
					...
					var v42: array<bool> := new bool[25] [f16, f16, f17, f16, f16, f16, f17, f17, if (f17) then false else f17, f17, multiset{377, p1} == p0, f16, p2 != |f20|, fm40(f16, |f20|, globalState) > (set v37 : char | v37 in v36 :: (v37)), f17, false, v38[f20[p2] := v40[p1]] >= v38, f16, f17, f17 <== f16, !!(v41 <= v41), f17, f16, f17, f16];
					v42[544] := !f17;
					v42[544] := !f16;
			}
			...
			var v65: array<map<int, int>> := new map<int, int>[21] [map v57 : int | (0xe1 <= v57) && (v57 < 150) :: (v57 + p1) := (p2), v53, map[|v51[p2 := v58]| := p1], fm47(if (p2 in v59) then v59[p2] else v58, globalState), v53, v53, v53 + v53, v53, v53, v53 + v53, if (false) then map v60 : int | (102 <= v60) && (v60 < 0x39f) :: (v60 * p1) := (|(map v61 : int | (0x3e0 <= v61) && (v61 < -0x201) :: (v61 - |multiset{v58, v51[0x3a0], v58, v58, v58}|) := (-p2))|) else map v62 : int | v62 in p0 :: (v62 * 390) := (p1), v53, map[31 := |v63|], v53[p1 := -0x2ac] + v53, v53, v53, v53 + v53, map[p1 := p2], map[v64.cf87 := p2], map[p2 := p2], v53];
			v65 := v65;
...
class C9 extends T2, T3 {
	...
	function fm9(p0: seq<bool>, p1: bool, p2: int, globalState: GlobalState): int {
		|((multiset{0x2e5} + multiset(seq(19, i0  => (f18)))) - multiset(seq(0x2fe, i1  => (f18))))|
	}
	method m4(p0: string, p1: T0, p2: bool, p3: char, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		var v0: seq<int> := [f18];
		if (fm5(|(v0[317 := |[f18, f18, f18]|] + v0)|, f19, 0x22f, f18 !in map[0x15c := p1.f16], globalState)) {
			if (f19 ==> p2) {
				r1 := true;
				...
				var v4: map<int, seq<int>> := map[f18 := if (p1.f16) then ([f18, f18, --0xaa, |v1|])[0x23 := |v3[f18 := |map[f16 := p1.f16]|]|] else v0];
				v4 := v4;
			} else {
				...
				globalState.f3 := p1.f17;
				var v8 := "vhylwr";
				v8 := (((p0 + p0)[if (p1.f16) then f18 else -|p0| := fm11('r', f18, globalState)])[f18 := p3])[-|(v8 + p0)| := v8[f18]];
			}
			...
			r1 := p1.f17;
			var v12: set<int> := {|v11|};
			var v13: set<int> := {v10[344] - |map[f19 := p1.f17]|, f18, f18, |v12|, f18 * f18};
			var v15: map<int, int> := map[v10[344] := 22];
			...
			var v25: array<map<int, int>> := new map<int, int>[26] [map v14 : int | v14 in v12 :: (v14 / f18) := (v10[344]), v15, v15 + (map v16 : int | (0x4d <= v16) && (v16 < -0x2ac) :: (v16 + |v9|) := (|p0|)), map v17 : int | (-806 <= v17) && (v17 < 361) :: (v17 - v10[344]) := (v10[344]), v15, v15 + v15, v15, (if (p1.f17 in v18) then v18[p1.f17] else v15)[v10[344] := f18], v15, map[v10[344] := v10[344]], v15, if (v19 in v20) then v20[v19] else v15, v15, v15, v15, v15, map v21 : int | (0x1ce <= v21) && (v21 < 0x317) :: (v21 + v10[344]) := (v10[344]), v15, map[f18 := f18], map v22 : int | (114 <= v22) && (v22 < -613) :: (v22 * f18) := (v10[344]), v15, map v23 : int | v23 in (map v24 : int | (0x201 <= v24) && (v24 < 0x125) :: (v24 + 0x280) := ("eucsa")) :: (v23 - -0x43) := (f18), map[|v12| := f18], v15, v15, v15 + map[|v15| := 0xeb]];
			v25[697] := fm12(globalState) + v15;
			var v26: array<bool> := new bool[28];
			v10[344], globalState.f14, v13, v25[697] := f18, v26, v12, v15;
		} else {
			...
			var v33: array<int> := new int[24] [f18, f18, if (true) then if (f17 in v27) then v27[f17] else f18 else f18, f18, -|v28|, -f18, |(v0 + [-0x27b, f18])|, |v0|, f18, f18, |p0|, if (f17) then f18 else f18, if (f19) then f18 else f18, f18 - f18, f18, 435 * f18, f18, |(v30 * v30)|, f18, -f18, f18, f18, f18, |multiset{true, false, f19, true, p1.f16}| % |v32|];
			v33[153] := f18;
			v33[153] := f18;
			var v34: map<int, int> := map[-v33[153] := v33[153]];
			var v35: map<array<bool>, bool> := map[v29 := p2];
			v34 := v34[|(map[v29 := !f17] + v35)| := 0xd3 % 0x1d1];
			var v36: seq<bool> := [p1.f16, f17];
			v0 := fm33(v31.f16, p1.f16, if (!!v31.f17) then v31.f17 else v36[|(set v37 : int | (-474 <= v37) && (v37 < 0x272) :: (v37 / f18))|], globalState);
			var v38 := "ancinwcd";
			v38 := v38[v0[fm6(p3, globalState)] := p3];
		}
		...
		for i2 := 70 to f18 {
			...
			v40 := v40;
			r2 := v0[|(fm33(f19, f17, f16, globalState) + (seq(0x3b0, i3  => (f18))))|];
		}
		...
		if ((multiset{v41} * v42) > (v42 * multiset{v41})) {
			...
			if (fm5(f18, v43[if (|[v45]| in v44) then v44[|[v45]|] else f18], f18, p1.f17, globalState)) {
				...
				v48[137] := p3;
				v48[137] := if (p1.f17) then p3 else 'k';
				var v49 := DC10(v45);
				var v50: set<D6> := {v49};
				v50 := v50 + (v50 * v50);
				var v51: set<int> := {f18};
				var v52: map<array<int>, bool> := map[v45 := v43[|v51|]];
				var v53 := DC12(v52, f18);
				r0 := v53.cf13;
				globalState.f14 := v41;
			}
			
			var v56: array<set<int>> := new set<int>[10](i6 => (set v54 : int | v54 in map[f18 := f18] :: (v54 * |"najh"|)) - (set v55 : int | v55 in map[f18 := p1.f16] :: (v55 / 0x285)));
			var v57: set<int> := {f18, f18, f18};
			v56[681] := fm43(globalState) - v57;
			var v58: map<bool, set<int>> := map[|p0| < v0[-718] := v57 - v57];
			v56[681] := if (!p1.f17 in v58) then v58[!p1.f17] else v57 * v57;
			globalState.f3 := p1.f17;
			var v59 := DC11(f19);
		...
		r1 := multiset{p0[f18 := p3], p0, p0, p0, p0} > v77;
		r2 := f18;
	}
	method m5(globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			v4, globalState.f0, globalState.f13 := v4, f16 && f17, fm5(|(v5 + v5)[f18 := v1]|, f19, f18, f17, globalState);
		...
		globalState.f7, globalState.f7, globalState.f13 := f18 % |v8|, f18 / |"tawwgl"|, ((v8 + v8)[f18 := v9])[-f18 := 'u'] !in ([v8, "seida", v8] + v10);
		...
		var v13: seq<C5> := [v12];
		var v14 := DC86(v13);
		v1[888] := if (f17 in v11) then v11[f17] else v13 < v14.cf122;
	}
	method m2(globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: seq<char>) {
		globalState.f7 := f18 + -f18;
		var v0 := "fbavdxi";
		var v1 := new C5(!(v0[f18] in v0), f19);
		for i0 := f18 to f18 {
			r3 := v0;
			if (f19) {
				var v2: array<seq<seq<int>>> := new seq<seq<int>>[1];
				var v3 := DC90(seq(-0x28d, i1  => ((seq(0x30d, i2  => (|map[|(seq(0x18b, i3  => ('u')))| := |v0|]|)))[i0 := i0])));
				...
				globalState.f7 := f18;
				var v15: array<int> := new int[14](i5 => i5 / i0);
				v15[234] := i0;
				var v16: map<int, string> := map[|multiset(fm16(globalState))| := v0];
				v15[234] := |(v16 + v16)|;
				var v17: array<bool> := new bool[3](i6 => f17);
				var v18 := DC91([map[v15[234] := f17]]);
				var v19: seq<int> := [|v18.cf125|, 0x6f];
				v17[603] := i0 > v19[i0];
				v14, v17[603], v15[234] := v14, if (fm1(f17, false, -|fm27(v0, !!f19, globalState)|, globalState) in v12) then v12[fm1(f17, false, -|fm27(v0, !!f19, globalState)|, globalState)] else f17, f18;
				globalState.f13 := true;
			}
			...
			if (f19) {
				...
				v27[111] := (if (f17 in v34) then v34[f17] else f16) || f19;
		...
		var i9 := 0;
		while ((f18 % (if (v39 in v40) then v40[v39] else f18)) <= f18)
			decreases 100 - i9
		{
			if (i9 >= 100) {
				break;
			...
			var v50: array<int> := new int[22] [f18, f18, f18, |v45|, -|v46|, f18, f18, f18, f18, f18, 0x32e, 0x354, f18, f18, |v47|, |v48|, f18, f18, |v0[f18 := v43]|, |v49|, f18, f18];
			var v51: map<bool, array<int>> := map[!f16 := v50];
			var v52 := DC61(v51);
			v42[224] := v52.cf84;
			v42[224] := (v51 + map[f17 := v50]) + map[f19 := v50];
		...
		for i10 := f18 to |(v58.f20 + v57)| {
			...
			globalState.f14 := v62;
			var v63: array<int> := new int[29](i11 => i11 % f18);
			v63[788] := f18;
			var v64 := 'l';
			globalState.f0, v63[788] := v64 !in v0, f18;
			var v65 := DC6(map[f19 := f19] + map[f17 := fm8(f19, -i10, v63[788], globalState)]);
		...
		r0 := match v67.(cf67 := v58.fm5(-f18, false, f18, f16, globalState)) {
			case DC48(cf66, cf67) => (seq(0x3c6, i12  => (f18))) + [|multiset([|[cf67, f19]|, f18, |"pu"|, f18, -|map[f17 := |(seq(0x1d6, i13  => ('k')))|]|])|]
			case DC49(cf68, cf69, cf70) => (seq(536, i14  => (|v58.f20|))) + [f18, |(seq(0x1e8, i15  => (|map[cf70 := 'e']|)))|, |map[f18 := f18]|, f18, f18]
			case DC47(cf65) => ([f18])[|multiset{f16, true}| := 0x9c]
		};
		r1 := f19;
		r2 := v0 <= ("pv")[|v0| := 'q'];
		var v68 := 'w';
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		v0 := (map[f16 := |(map[|v1| := |v3[660]|])[f18 := f18]|])[f17 := f18];
		var v4 := 'w';
		v4 := v4;
		var v5 := "maesog";
		...
		var i0 := 0;
		while (-(f18 / -(if (p0 in v8) then v8[p0] else |v2|)) <= |(v1 * v1)|)
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v11: multiset<map<bool, bool>> := multiset{(v9[f19 := f19])[f17 := f19], v9, map[f16 := f16], map[v10[503] := f16], v9};
	...
	method m0(globalState: GlobalState) returns (r0: array<int>) {
		var v0: array<int> := new int[17](i0 => i0 / |map[{false} := 'c']|);
		v0[350] := f18;
		var v1 := "sinxe";
		v0[350] := |(v1 + "r")| + f18;
		for i1 := -(v0[350] - v0[350]) to 0x28e {
			globalState.f0 := true;
			v0[350] := i1;
			var v2: seq<int> := [v0[350]];
			v2 := fm33(f17, !f17, f19, globalState);
			if (f19) {
				var v3 := 'i';
				var v4: seq<bool> := [!f17, f16, !f16, false];
				var v5: array<string> := new string[24] ["eeru", "af", v1, v1, v1, v1, v1, v1 + v1, v1 + v1, v1, v1, v1 + v1, v1, "kw" + v1, (v1 + v1)[v0[350] := v3], fm3(v1, v4, v1, globalState), seq(-629, i2  => (v3)), v1 + (seq(0x1a1, i3  => (v3))), "gerp", v1, v1 + "bvi", seq(0x279, i4  => (v3)), v1, seq(446, i5  => (v3))];
				v5[406] := v1;
				v5[406] := v1;
				...
				var v21: array<C5> := new C5[28] [v16, v16, if (true in v17) then v17[true] else v18[f18], v16, v16, v16, if (v20 in v19) then v19[v20] else v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v18[|v4|], v16, v16, v16, v16, v16];
				v15[857] := v21;
				var v22: map<int, bool> := map[f18 := f16];
				v9[711], v14, globalState.f3, v15[857], globalState.f0 := v10, v14 + v14[v12 := i1], f16, v21, if (f18 in v22) then v22[f18] else true;
			} else {
				...
				var v28 := DC81();
				var v29: map<map<char, D34>, int> := map[map[v26 := v28] := v0[350]];
				var v31: seq<bool> := [f19, f19, {v27, v27} < (set v30 : map<char, D34> | v30 in v29 :: (v30)), f17, f19];
				var v32 := DC59(i1, f16);
				globalState.f7, globalState.f8, v0[350], v25 := i1, v31, v32.cf81 - i1, v25;
				var v33: C6 := new C6(f17, f16);
				var v34: map<map<bool, C6>, string> := map[map[f17 := v33] := v1 + v1];
				v34 := v34;
				var v35: set<int> := {f18};
				var v36: set<string> := {v1, v1, v1};
				var v37: map<string, int> := map[(seq(0x322, i6  => (v26)))[|[f18, f18]| := v26] := f18];
				var v39: array<bool> := new bool[23] [true, f19, true, f19, f19, v35 > v35, f17, f17, v36 != (set v38 : string | v38 in v37 :: (v38)), f17, f17, f17, f18 != fm9(v31[0x155 := true], f16, i1, globalState), false, f16, f17 && f16, f17, f19, f17, f16, f16, f17, f19];
				v39[930] := f19;
				v39[930] := f17;
				var v40: array<D14> := new D14[4];
				var v41: map<int, bool> := map[v0[350] := v39[930]];
				v40[960] := DC34(v41);
				v40[960] := DC34(fm21(f18, globalState));
		...
		if (v0[350] < f18) {
			var v46: multiset<int> := multiset{fm1(f16, f16, v0[350], globalState)};
			var v47: array<bool> := new bool[21];
			var v48: seq<array<bool>> := [v47];
			var v49 := DC20(v47);
			var v50: map<bool, array<bool>> := map[f16 := v47];
			var v51: array<array<bool>> := new array<bool>[26] [v47, v48[f18], v47, v47, v47, v49.cf24, v47, v47, v47, v47, if (f17 in v50) then v50[f17] else v47, v47, v47, v47, v47, v48[0x26d], v47, v47, v47, v47, v47, v47, v47, v47, v47, v47];
			v51[909] := v47;
			var v52: multiset<seq<bool>> := multiset{[f16, true]};
			globalState.f0, v46, globalState.f13, v51[909] := v52 <= (if (f17) then v52 else v52), v46, (seq(366, i7  => ('n'))) <= v1, v47;
			var v53: seq<bool> := [!f17];
			var v54 := new C8(v53, !f19, v53[f18] ==> f16);
			var v55 := 'k';
			...
			if (f19) {
				...
				var v60: seq<int> := [-f18, f18, v0[350], |fm38(-502, f18, globalState)|];
				globalState.f7 := (v0[350] + |v59|) * v60[0xba];
				var v61: map<seq<bool>, bool> := map[v53 := f16];
				v61 := v61[v54.f20 + v54.f20 := f16];
				var v62 := new C4(v0[350], f17, f16, f19);
				...
				v1 := v64[v0[350]];
				var v65: map<int, string> := map[v0[350] := v1];
				var v66: array<string> := new string[25] [v1, seq(27, i8  => (v55)), v1 + "xil", (if (-0x35f in v65) then v65[-0x35f] else v1) + v1, "ufelp", fm3(v1, v54.f20, v1, globalState), v1 + v1, v1, "cgfamd" + v1, "jklyx" + v1, v1, v1 + v1[674 := v55], v1 + v1, v1, v1, v1, v1, seq(0x1fb, i9  => (v55)), "tuiyjooqo", v1, seq(-924, i10  => (v55)), v1, "t" + v1, v1, v1 + v1];
				v66[792] := v1;
				var v67: seq<int> := [f18];
				var v68: seq<int> := [f18 * v67[v0[350]], -0x65, v0[350] * v0[350], 328];
				var v69: map<bool, int> := map[f19 := f18];
				var v70 := DC65(v69, v68);
				v66[792], v68 := (v1 + "qxp") + (seq(0x112, i11  => (v55))), fm44(0x235, f17, 0x34b, fm2(!f17, globalState), globalState) + v70.cf94;
			...
			if (f17) {
				var v75 := 'i';
				var v76: multiset<char> := multiset{v75, if (true) then v75 else v1[|multiset([-f18, -0x49])|], 'w'};
				var v77: map<string, char> := map[v1 := 'x'];
				v76 := multiset{if (v1 in v77) then v77[v1] else fm11(v75, 0x35e, globalState), v75} * v76;
				globalState.f0 := f17;
				var v78: map<int, int> := map[--f18 := -v0[350] - f18];
				v78 := v78[|(v1 + v1)| := v0[350]];
				var v79: multiset<bool> := multiset{true};
				var v80: set<int> := {|v79|, -f18 * f18, f18, -v0[350]};
				v80 := v80 + (v80 * v80);
				var v81 := new C2(fm11(v75, v0[350], globalState), f18 !in fm27(v1, f16, globalState), f18, f16, if (f16) then DC38(f16, v0[350], v0[350], f16).cf47 else f16, f19);
			} else {
				var v82: map<int, bool> := map[0x239 := v0[350] < f18];
				v82 := v82;
				var v83: seq<int> := [|multiset{f18}|, v0[350]];
				var v84: array<bool> := new bool[2] [f16, f17];
				var v85: map<int, array<bool>> := map[v83[v0[350]] := v84];
				var v86: array<map<int, array<bool>>> := new map<int, array<bool>>[5] [v85, v85 + v85, map[f18 := v84], map[fm4(v1, v0[350], map[f18 := f17], globalState) := v84], v85 + v85];
				v86[91] := v85 + v85;
				v86[91] := (v85 + v85)[v0[350] := v84];
				var v88: seq<bool> := [f19, f16];
				var v89: map<int, seq<bool>> := map[v0[350] := v88];
				var v90: map<array<bool>, map<int, int>> := map[v84 := map v87 : int | v87 in v89 :: (v87 % 0x1a7) := (v0[350])];
				var v91 := 'q';
				var v92: multiset<seq<char>> := multiset{[v91]};
				var v93 := DC67(-124, false, v0);
				var v94 := DC59(v0[350], f19);
				var v95: map<int, int> := map[v0[350] := |v1|];
				var v96: set<bool> := {f19, f16};
				v0[350], globalState.f13, v0[350], v90 := |v92| / v93.cf96, (if (f19) then f18 else |map[f19 := v94]|) <= fm7(f17, v0[350], v95, v96, globalState), --(v0[350] * v0[350]) % v0[350], v90;
				globalState.f7 := f18;
				var v97: multiset<bool> := multiset{v88[-f18], f19};
			...
			if (f19) {
				...
				globalState.f7 := 0x29 / v98.fm4("grdakxyu", v0[350], map[v0[350] := f19], globalState);
				var v99: array<string> := new string[13](i12 => v1);
				var v100 := 'x';
				v99 := new string[6] [v1, (seq(-0x2a9, i13  => ('o')))[f18 := v100], v1, v1, v1 + v1, v1 + v1];
				var v101: multiset<bool> := multiset{f17};
				var v102: set<bool> := {f17, f17, f16, f17};
				var v103: seq<int> := [-0x2be, 0x3ad];
				var v104: map<bool, int> := map[f17 := v103[f18]];
				var v105: set<int> := {|v104|};
				var v106: array<bool> := new bool[9];
				var v107, v108, v109, v110 := m7(f18 % fm9([f16], f17, v0[350], globalState), [f18, if (f19 in v101) then v101[f19] else |v102|, |v105|, -f18, v0[350]], v99, v106, globalState);
			} else {
				var v111: set<int> := {0x303, v0[350], f18};
				var v112 := DC31(v111);
				v112 := v112;
				var v113: seq<bool> := [f19];
				globalState.f7 := if (f17) then |v113| else v0[350];
				var v114 := new C0();
				var v115 := DC48(fm2(f16, globalState), f16);
				globalState.f3 := !!v115.cf67;
				var v116 := new C5(--f18 == f18, v0[350] == f18);
			}
			...
			if (!f17) {
				...
				var v126: seq<seq<char>> := [[if (true in v123) then v123[true] else v122, v122], fm3(v124[v0[350]], v125, v1, globalState), v1];
				v126 := v124 + (seq(564, i14  => (v1)));
				globalState.f13 := f16;
			} else {
				var v127: map<int, int> := map[v0[350] := f18];
				var v128: map<map<int, int>, int> := map[v127 := v0[350] / 0x242];
				v128 := v128 + v128;
				globalState.f3 := f16;
				var v129 := 'a';
				v129 := v129;
				var v131: multiset<string> := multiset{v1};
				var v132 := DC37(map v130 : string | v130 in v131 :: (v130) := (|map[f17 := v0[350]]|));
				var v133 := DC39(v132);
				v133 := v133;
				globalState.f3, globalState.f7 := f19, f18 + v0[350];
			}
			
			var v134: multiset<int> := multiset{v0[350]};
			var v135 := DC0(v134);
			var v136: seq<int> := [v0[350]];
			if (v135.cf0[-85 := v136[v0[350]]] !! multiset{f18}) {
				...
				v140 := v140[f17 := f18];
				v134 := (multiset(([v0[350]])[v0[350] := -0x1d2]) - v134) + v134;
				...
				globalState.f7 := if ((if (f16) then v146 else v146) in v147) then v147[if (f16) then v146 else v146] else v0[350];
				var v148 := 'l';
				globalState.f7, v148 := f18, v148;
				var v149: array<D34> := new D34[14];
				var v150: C7 := new C7(fm9([f19], f16, v0[350], globalState), f17, f16, f17);
				...
				v154[817] := f17;
				v149[237], v1, v148, v153, v154[817] := v152, v1, v148, v153, f16;
				v0[350] := |v1| / v0[350];
			...
			decreases 100 - i15
		{
			...
			i15 := i15 + 1;
			globalState.f3 := fm5(f18, f16, v0[350], f17, globalState);
			var v156: array<bool> := new bool[23](i16 => f17);
			var v157: map<array<bool>, int> := map[v156 := -0x127 % f18];
			var v158: map<int, array<bool>> := map[f18 := v156];
			var v159: multiset<int> := multiset{v0[350], f18, f18, f18};
			var v160: map<bool, multiset<int>> := map[f19 := v159];
			var v161: seq<int> := [v0[350]];
			var v163 := DC27();
			var v164 := DC28(v163);
			...
			v165[0] := v166[!f16 := v0[350]];
			v165[0] := v166;
		}
		var v167 := 'u';
		var v168: map<bool, int> := map[f19 := v0[350]];
		...
		if ((-f18 * f18) != |fm3(("sgdcc")[v0[350] := v167], v171, v1, globalState)|) {
			var v172: map<int, int> := map[|v1| := v0[350]];
			var v174 := DC62(v167, f16, f18, f17);
			globalState.f0, globalState.f7 := (v0[350] - 0x7f) > |(v172 + (map v173 : int | (0x295 <= v173) && (v173 < 0x10d) :: (v173 / |multiset{DC62(v167, f17, f18, f17).cf87, v0[350]}|) := (v0[350])))|, v174.cf87;
			v0 := v0;
			v1 := v1 + "kuymqg";
			...
			var v179: array<bool> := new bool[14] [f19, f17, f16, !(if (f17 in v175) then v175[f17] else f17), fm2(false, globalState), if (f17) then !f16 else f17, v0[350] < |v1|, if (0x2f8 in v177) then v177[0x2f8] else f17, |fm29(f18, globalState)| < v0[350], if (f16 in v175) then v175[f16] else f19, fm8(f19, if (v0[350] in v176) then v176[v0[350]] else v0[350], v0[350], globalState), -0x85 >= f18, fm2(f17, globalState), {f16, f17} >= v178];
			v179[874] := f16;
			v179[874], globalState.f7 := false || f16, v0[350] * (-0x3b2 % v0[350]);
			var v180: map<bool, array<int>> := map[v179[874] := v0];
			v180 := v180;
		} else {
			globalState.f7 := v0[350];
			...
			v183[923] := fm89(globalState);
			var v184: map<seq<int>, seq<bool>> := map[v169 := ([f16, f17])[f18 := f17]];
			v181[162], v182[661], v183[923], globalState.f3, globalState.f7 := f16, v1 + v1, v184, !f16, f18 + f18;
			var v185: map<int, bool> := map[f18 := f16];
			v185 := v185;
			if (v171 < v171) {
				var v186: map<bool, string> := map[v0[350] >= f18 := v1];
				v186 := v186[f16 := v1];
				var v187: map<string, int> := map[if (f17) then "elyvb" else v1 := |(seq(0x33e, i19  => ('c')))|];
				v187 := v187[v182[661] := f18];
				v0[350] := v0[350] * v0[350];
				globalState.f0 := f19;
				var v188 := DC42(f19, v0[350], f17);
				var v189: set<seq<bool>> := {[true, v188.cf56, f19], v171, v171, v171, v171};
				globalState.f7 := |v189|;
			} else {
				var v190: C1 := new C1(v182[661], f19, v181[162]);
				var v191 := DC84(f19, v181[162], v181[162], f17);
				var v192: map<bool, seq<int>> := map[v191.cf115 := [-879, f18, v0[350]]];
				var v193 := DC42(fm8(f19, f18, f18, globalState), |(if (v181[162] in v192) then v192[v181[162]] else [v0[350]])|, f16);
				r0, globalState.f7, globalState.f0, v0, v190 := v0, f18, v193.cf54, v0, v190;
				v0[350] := |(seq(-206, i20  => (v167)))|;
				globalState.f13 := f16;
				var v194 := DC62('a', f19, v0[350], f16);
				var v195: map<bool, bool> := map[v181[162] := v171[v194.cf87]];
				var v196 := new C3(true, if (f17 in v195) then v195[f17] else f19);
				globalState.f3 := if (f17) then f16 else fm2(v181[162], globalState);
			}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v2 := new C1((seq(-142, i0  => ('b'))) + v0, !(f18 in v1), f19);
		...
		if (f18 != |([-f18] + v4)|) {
			...
			v8 := map[f19 := v7];
			var v9 := DC17(v5);
			v0 := fm3(v0, v9.cf19, (seq(-60, i1  => ('y'))) + v2.f23, globalState);
			var v10: array<int> := new int[1];
			v10[328] := f18;
			v10[328] := f18;
			if (if (false) then fm5(f18, !f17, -v10[328], false, globalState) else false) {
				r0 := v5[f18];
				globalState.f3 := fm2(f17, globalState);
				var v11 := new C4(|v5| / v10[328], false, f17, !f17);
				var v12: array<bool> := new bool[29](i2 => !('w' !in v2.f23));
				v12[861] := fm5(-824, f17, v10[328], f19, globalState);
				v12[861] := f18 != v10[328];
				var v13: multiset<string> := multiset{"nqoyhoelv", v2.f23, v2.f23, seq(-0x2f7, i3  => ('y'))};
				var v14 := 'c';
				var v15: seq<array<int>> := [v10];
				var v16: set<bool> := {v12[861], f19};
				v10, v13, globalState.f10, v12[861], v14 := v15[f18], v13, v16 + {f17, true, v12[861]}, false, v14;
			} else {
				var v17 := 'x';
			...
			if (-679 == |v0|) {
				...
				v19[992] := f19;
				v19[992] := (f19 && !f19) <== (v2.f23 != v2.f23);
				v0 := "mdipy" + v2.f23;
				globalState.f0 := v19[992];
				globalState.f7 := f18;
			} else {
				var v24: multiset<seq<int>> := multiset{fm44(|(seq(0x13f, i5  => ('v')))|, f19, f18, f17, globalState)};
				v24 := v24;
				...
				v26[669] := v27;
				v26[669] := new C3(f17, !f17);
				var v28: seq<bool> := [f17, f19];
				globalState.f7, v0, globalState.f7 := f18, fm3(v0, v28[0x380 := true], v2.f23, globalState) + v0, f18;
			...
			if (v35.cf115) {
				...
				globalState.f7 := f18 + ((if (-f18 in v57) then v57[-f18] else v51.f18) * v49[0]);
			}
			...
			var v62: array<int> := new int[6](i9 => i9 % f18);
			var v63: array<int> := new int[19] [0x367, (if (f18 in v58) then v58[f18] else -0x356) * f18, f18 * f18, f18, |v4| * f18, f18 / f18, f18 % |map[f19 := v61]|, 0x155 * f18, f18, v4[f18], -(--f18 - f18), -(f18 - f18), f18, f18, -|map[f17 := v62]|, f18 + f18, v2.fm4(v0, f18, map[f18 := f16], globalState), f18, f18];
			v63[87] := f18;
			var v64: array<bool> := new bool[2](i10 => f16);
			var v65 := DC20(v64);
			var v66: map<bool, int> := map[f17 := f18];
			globalState.f14, v63[87], r0 := (if (f17) then v65 else v65).cf24, if (f19 in v66) then v66[f19] else -533 + f18, |v2.f23| < f18;
			v63[87] := v63[87];
		}
		...
		for i11 := f18 to f18 {
			...
			var v70: map<array<bool>, string> := map[v69 := seq(0xec, i14  => ('a'))];
			var v71 := 'l';
			v0 := ((if (v67 in v68) then v68[v67] else seq(0x328, i12  => ('c'))) + (v2.f23 + v2.f23))[|(if (v69 in v70) then v70[v69] else v0)| := v71];
			...
			var v75: array<int> := new int[28] [i11, i11, f18, i11, i11, i11, f18, i11, f18, i11, f18, f18, f18, i11, f18, 0x189, v4[f18], i11, f18, f18, |v72|, 0xa0, f18, f18, i11, |map[i11 := v74]|, 501, i11];
	...
	method m6(p0: array<map<char, int>>, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: multiset<int>) {
		if (f18 > 0x21e) {
			globalState.f7 := (f18 % |map[f16 := true]|) / f18;
			globalState.f8 := (fm16(globalState))[f18 := f17];
			var v0 := 'l';
			var v1 := "vkvfq";
			if (if (v0 in v1) then true else f19) {
				...
				v18[806] := v19;
				v18[806] := if (v14.f17) then ([!f19, v14.f16])[0x30f := f17] + v19 else v19;
				var v20 := DC77(f18);
			...
			var v31 := "kkkwcgho";
			var v32 := new C7(f18 / f18, f18 >= |v31|, f19, !true);
			globalState.f7 := f18;
			var v33 := DC22(|(v31 + "t")|);
			v33 := v33;
		}
		...
		match (v37) {
			case DC59(cf81, cf82) =>
				...
				var v40 := new C4(|(seq(0x110, i3  => ('a')))|, f16, f16, false);
				...
				match (v43.(cf73 := f18 * f18)) {
					...
					case DC50(cf71) =>
						...
						v47[49] := if (f17) then v42 else v42[f18 := f17];
						v47[49] := [f17, cf82] + v42;
						var v48 := 'b';
						var v49: seq<int> := [cf81];
						var v50: multiset<int> := multiset{cf81, cf81, f18};
						var v51 := new C2(v48, !f17, |(v49 + [|v50[if (f16 in v35) then v35[f16] else f18 := |v42|]|])|, f19, f17, false);
						globalState.f3 := v51.f22;
						var v52: map<char, bool> := map[v48 := f16];
						var v53 := "jcgk";
						globalState.f7, v52, cf81 := fm4(v53 + v53, |fm22(f18, globalState)|, v36, globalState), v52[v53[fm9(v47[49], cf82, cf81, globalState)] := cf82] + v52, -cf81 / f18;
					case DC52(cf75) =>
						...
						v38[898] := if (true) then f17 <==> cf82 else |v55| <= 0x223;
						var v56 := "oovpsat";
						r0 := -|((v56 + v56) + v56)|;
				}
			...
			case DC58(cf80) =>
				...
				var v60: array<array<string>> := new array<string>[22] [v58, v59[f18], v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58];
				v60[612] := v59[-f18];
				v60[612] := v58;
				var v61 := new C0();
			...
			case DC60(cf83) =>
				...
				var v64: map<bool, seq<char>> := map[-714 !in v63 := seq(743, i5  => ('e'))];
				var v65 := 's';
		...
		var v74: seq<int> := [f18];
		globalState.f3 := !((|v73| % |v74|) > (f18 * f18));
		var v75: map<string, set<bool>> := map[v72 := {f16}];
		for i6 := f18 + 0xa8 to if (f18 in v73) then v73[f18] else v74[|v74[|v72| := |v75|]|] {
			globalState.f13 := !(false && true);
			var v76: array<bool> := new bool[14];
			v76[143] := f16 || f16;
			v76[143] := f17;
			v76[143], v72, globalState.f0 := f19, v72 + v72, i6 <= i6;
			v35 := v35[fm2(!f17, globalState) := i6];
		}
		for i7 := f18 to |v72| % f18 {
			...
			match (if (f17) then v81 else v81) {
				...
				case DC26(cf31, cf32, cf33) =>
					...
					var v91: map<C4, seq<bool>> := map[v90 := v71[|v35| := f19]];
					v73, r1, globalState.f7 := v73, v89, 0x25 + |v91|;
					globalState.f0 := (|v72| / v90.fm9([f16, f19, f17], f16, i7, globalState)) != f18;
					cf32 := i7;
					globalState.f7 := f18;
				case DC27() =>
					var v92 := 'n';
					var v94 := DC13(v92, fm8(f17, |v74|, |(seq(0x2c, i9  => (|(set v93 : int | v93 in v74 :: (v93 / |map[|map[true := 0x29a]| := -0x33c]|))|)))|, globalState));
					...
					v96[973] := v97;
					globalState.f13, v35, v96[973] := i7 != (if (f17) then i7 else v95.fm4(v72, f18, v36, globalState)), v35[f16 := 0x2e1], v97;
				case DC24(cf30) =>
					v73 := v73[-|(cf30 + cf30)| := v74[i7]];
					var v98 := 'q';
					var v99 := DC3(v72);
					var v100: seq<string> := [v72];
					var v101: array<string> := new string[15] [v72, v72, v72 + v72[f18 := v98], v72 + "nhicj", v99.cf3 + (seq(910, i10  => (v98))), v72, v72, v72, v72, v72, v72, v72, v100[i7], v100[i7] + v72, v72];
					v101[128] := v72;
					v101[128] := v100[|"qrjaeys"|] + v72;
					globalState.f7 := -i7 / f18;
					v35 := v35;
				case DC28(cf34) =>
					var v102 := 'q';
					var v103: map<multiset<bool>, string> := map[v35 := (if (true) then v72 else "nvrhxkl")[f18 := v102]];
					v103 := v103[v35 := v72];
					var v104: T0 := new C5(f17, f19);
					var v105: set<T0> := {v104};
					globalState.f7 := (i7 % fm1(f17, f17, |v105|, globalState)) * i7;
					globalState.f7 := i7;
					var v106: map<bool, int> := map[f17 := f18];
					var v107: map<bool, T0> := map[f16 := v104];
					var v108: seq<T0> := [v104, if (f16 in v107) then v107[f16] else v104];
					v74 := fm44(|v106|, v104.f17, i7 % |v108|, true || v104.f16, globalState);
			}
		...
		r2 := (if (!f17 in v110) then v110[!f17] else v73)[f18 := f18] - (multiset(v74) * v73);
	}
	method m7(p0: int, p1: seq<int>, p2: array<string>, p3: array<bool>, globalState: GlobalState) returns (r0: int, r1: array<bool>, r2: int, r3: int) {
		...
		for i0 := p0 to -0x29c {
			...
			globalState.f0 := f16;
			var v4 := "njp";
			var v5: array<char> := new char[6] [v3, v3, 'w', fm11(v4[p0], p0, globalState), v3, v3];
			v5 := new char[8](i1 => v3);
			...
			v6[163] := if (f17 in v9) then v9[f17] else if (f19 in v9) then v9[f19] else v7;
		}
		var v10: map<bool, bool> := map[p0 >= f18 := !f16];
		if (if ((false || true) in v10) then v10[false || true] else p3[144] && f16) {
			var v11: array<string> := new string[8];
			v11 := v11;
			var v12 := new C2(fm11(v3, f18, globalState), f17, p0, false, f19, true ==> true);
			v12.f22 := f18 > -p0;
			var v13 := new C6(v12.f22 && p3[144], f19);
			v12 := v12;
		} else {
			var v14: map<bool, array<bool>> := map[p3[144] || f16 := p3];
			v14 := v14[f16 := p3];
			globalState.f13 := !f17;
			globalState.f3 := v1[p0];
			var v15 := "f";
			var v16: set<string> := {v15, fm3(v15, v1, v15, globalState)};
			if (v16 != fm90(globalState)) {
				var v17: C6 := new C6(p3[144], f17);
				v17 := v17;
				var v18: array<seq<int>> := new seq<int>[13];
				v18 := v18;
				var v19 := new C6(p3[144], f17);
				var v20: array<int> := new int[25](i2 => i2 - f18);
				v20[100] := p0;
				globalState.f13, v20[100] := f17, f18;
				globalState.f13 := f19;
			} else {
				v2 := v2;
				...
				var v23: array<D35> := new D35[22] [if (p3[144]) then v21 else v21, v21, v21, v21, v21, v21, DC84(f19, f19, f16, fm5(680, f19, f18, f19, globalState)), v21, v21, v21, DC84(f19, fm5(fm1(if (f16 in v10) then v10[f16] else !!f16, false, p0, globalState), f19, |v22|, p3[144], globalState), false, p3[144]), v21, v21.(cf115 := f19), v21, v21, v21, v21, v21, v21, DC84(f19, v1[p0], f19, f16), v21, v21];
				v23[54] := DC84(false, f17, f16, p3[144]);
				v23[54] := v21;
				globalState.f14 := p3;
				var v24: C4 := new C4(p0, p3[144], v0 == v0, if (f16) then fm2(p3[144], globalState) else p3[144]);
				v24 := if (f19) then v24 else v24;
			}
			
			p3[144], v15, r2, v3, p3[144] := v1[0x28b + |v15|], v15, (f18 / f18) * f18, v3, !((if (f19) then f18 else p0) != f18);
		}
		
		var v25: array<bool> := new bool[19](i4 => f17);
		forall i3 | 0 <= i3 < v25.Length {
			v25[i3] := p3[144] || (f18 == --f18);
		}
		r0 := -p0;
		r1 := v25;
		r2 := f18;
...
method Main() {
	...
	var globalState := new GlobalState(false, false, 's', true, true, 0x134, 906, 0x115, v1 + v1, v2, v6[v4], 0x34b, true, true, v7, -779);
	var v8 := "vbfltxj";
	var v9 := 'l';
	v8 := v8[v4 := v9] + ((seq(0x136, i0  => ('o'))) + v8);
	var i1 := 0;
	while (v0)
		decreases 100 - i1
	{
		...
		i1 := i1 + 1;
		globalState.f7 := (v4 % |v8|) * (v4 - v4);
		v7[419] := fm0(v0, v4, v4, globalState) > multiset{-0x345};
		var v10: map<bool, int> := map[false := v4];
		var v11: multiset<int> := multiset{(if (v0 in v10) then v10[v0] else v4) * fm1(v0, v0, v4, globalState)};
		globalState.f7, v7[419], v0, globalState.f0 := |v11|, fm2(v0, globalState), fm2(!v0, globalState), v0;
		v8 := fm3((v8 + v8)[v4 := v9], ([v0, v7[419], v0])[v4 := false], v8, globalState);
		var v12 := new C6(v7[419], v8 <= v8);
	}
	var v13: map<int, int> := map[v4 := |v8|];
	v4 := (if (v0) then v4 else if (v4 in v13) then v13[v4] else v4) % v4;
		...
		decreases 100 - i2
	{
		...
		var v24 := DC74(v23);
		v20[564] := -(|map[v9 := v24]| - v17);
		v20[826] := v17;
		var v25: array<C5> := new C5[15];
		v25[466] := v21;
		var v26: map<int, bool> := map[|v1| / v17 := v19];
		var v27 := DC97(v21);
		globalState.f7, v20[564], globalState.f3, v20[826], v25[466] := v4, |{v8, v14.f23}|, if (v17 in v26) then v26[v17] else v14.fm5(-v4, v19, |v14.f23|, v0, globalState), v17, v27.cf133;
		var v28: T1 := new C1(v8, v19, v0);
		var v29: map<int, T1> := map[v20[564] := v28];
		var v30: set<T1> := {if (v4 in v29) then v29[v4] else v28, v28};
		var v31: seq<set<T1>> := [v30, v30];
		var v32: T3 := new C2(v9, v19, |v31[v20[564]]|, v28.f16, v19, v0);
		v32 := v32;
	}
	for i3 := v4 * v4 to -137 / v4 {
		var v33: array<int> := new int[18](i4 => i4 / i3);
		...
		match (fm91((if (v0 in v35) then v35[v0] else i3) < |v1|, v37, v4, v4 + v4, globalState)) {
			case DC17(cf19) =>
				...
				v0, v7[496] := (v40 - v40) > {v39, v39}, fm2(v0, globalState);
				var v41, v42, v43 := v14.m3(!v7[496], globalState);
				v33[80] := -0x227;
				v33[80] := -v38.fm6(v15[259], globalState);
			case DC18(cf20, cf21, cf22) =>
				var v44: C4 := new C4(cf20, !(v1 != v1), v0, v0);
				v44 := v44;
				var v45: map<bool, int> := map[v0 := 0x357];
				var v46: map<int, bool> := map[i3 := cf21];
				v45 := v45[v35 < v35 := |fm39(|v46|, v0, |(map v47 : int | (0x13f <= v47) && (v47 < 193) :: (v47 / cf22) := (cf21))|, globalState)| + cf20];
				v8 := v14.f23 + v14.f23;
			...
			case DC19(cf23) =>
				...
				v8 := (v60 + v14.f23[i3 := v9]) + fm3("ekixmptd", v1, ("gtpies")[v14.fm4(v14.f23, |"bwr"|, map[0x29f := v59], globalState) := v15[259]], globalState);
		}
	...
	v3, v15[259], globalState.f14, v15[259] := if (false) then v3 else if (v0 in v64) then v64[v0] else v3, v15[259], v7, v15[259];
	var v65 := DC1(v0);
		...
		decreases 100 - i6
	{
		...
		match (v72) {
			...
			case DC69(cf100) =>
				...
				v7[319] := v0;
				v7[319] := v0;
				var v78, v79 := v14.m16(v4, v14.f23, v1 + v1, if (v7[319]) then false else v7[319], globalState);
			case DC71(cf102) =>
