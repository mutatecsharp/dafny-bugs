...
function fm0(p0: int, p1: int, globalState: GlobalState): int {
	--(if (true) then if (!!!false) then 0x245 else |map[-0x3 := |[|"xhl"|]|]| else |(multiset{0x3d5, -0x332} - multiset{|(map v0 : int | v0 in {--229, |[true]|} :: (v0 % -0x2b5) := (|map[-902 := 'd']|))|, |multiset{-|(set v1 : int | (430 <= v1) && (v1 < 54) :: (v1 % 0x2e2))|}|})|)
}
function fm1(globalState: GlobalState): string {
	((seq(669, i0  => ('j'))) + (seq(0x2a9, i1  => ('b')))) + ("tjfujd" + "cnhbwhio")
}
...
method m0(p0: bool, globalState: GlobalState) {
	var v0: array<int> := new int[28](i0 => i0 / -0x34);
	var v1 := 0x1d9;
	v0[723] := fm0(v1, v1, globalState);
	var v2: seq<bool> := [p0];
		...
		decreases 100 - i1
	{
		...
		v5[542], globalState.f4, v7[907], globalState.f2 := v6, 106 + (v0[723] / v0[723]), v11 + v11, !(v9 > v9);
		v0[723] := v1;
		var v13: array<bool> := new bool[23](i3 => (set v12 : int | (0x29f <= v12) && (v12 < -0x83) :: (v12 * DC1(|v10|, p0, v0[723]).cf3)) !! {v1});
		v13[484] := true;
		v13[484] := !fm6((seq(698, i4  => ('k'))) != v5[542], v0[723], globalState);
		var v14 := DC1(v1, p0, v0[723]);
		var v15: map<D0, int> := map[v14 := v0[723]];
		var v16 := new C0(v15);
	}
	for i5 := v0[723] to v0[723] / v0[723] {
		...
		var v26: multiset<int> := multiset{i5, v3[|v25|]};
		var v27: map<bool, int> := map[v1 == (if (v1 in v26) then v26[v1] else v1) := i5 % v1];
		v27 := v27[p0 := v1];
	}
	if (p0) {
		var v29: map<int, bool> := map[v1 := p0];
		var v30 := DC1(v0[723], if (v0[723] in v29) then v29[v0[723]] else p0, v1);
		var v31: map<D0, int> := map[v30 := v0[723]];
		var v32: C0 := new C0(map v28 : D0 | v28 in v31 :: (v28) := (v1));
		var v33 := 'l';
		var v34 := DC24(fm0(v0[723], v0[723], globalState), v32, v33, v1);
		var v35: map<D9, int> := map[v34 := -v1];
		var v36: multiset<bool> := multiset{p0};
		var v37 := "qaoscxjb";
		v35 := v35[v34 := (if (p0 in v36) then v36[p0] else |v37|) % v0[723]];
		globalState.f2 := p0;
		globalState.f2 := p0;
		var v38: map<bool, char> := map[p0 := v33];
		var v39 := DC20(v33);
		var v40: array<char> := new char[26] ['q', v33, v33, v33, DC24(v0[723], v32, 'g', v1).cf29, v33, v33, v33, 'x', if (p0 in v38) then v38[p0] else v33, 's', v33, v33, v33, v33, 'w', v33, v33, v39.cf22, v33, v33, v33, v33, 'k', v33, v33];
		v40[167] := v33;
		var v41: set<int> := {v0[723]};
		v0[723], v40[167], globalState.f3 := if (p0) then -0x21 else |v41|, v33, v1;
		var v42: map<string, int> := map[if (true) then v37 else seq(-0x92, i6  => (v40[167])) := v0[723] - 0x1dc];
		v42 := v42;
	} else {
		if (p0) {
			var v43 := "cnu";
			var v44 := 'n';
			var v45 := DC1(0x157 - v1, v43 <= v43[0x14f := v44], |v2|);
			v45 := v45;
			globalState.f4 := v0[723];
			var v46 := DC3();
			...
			v54[619] := [!true, p0, p0, p0, p0];
			v53, globalState.f4, v54[619], v0[723] := if (p0) then v53 else v53, v0[723], v2, v0[723];
			var v55: map<int, int> := map[v1 := v0[723]];
			var v57: seq<map<int, int>> := [map[fm0(v0[723], 0x39b, globalState) := |multiset{v1, -0x87}|]];
			var v58: multiset<map<int, int>> := multiset{v55, v55, map v56 : int | (0x2ae <= v56) && (v56 < 0x2f6) :: (v56 + 0x183) := (v1), v57[v1], v55};
			...
			v59[637] := v61 != v61;
			v59[637] := p0;
			globalState.f2 := v59[637];
			globalState.f2 := -v0[723] != 0x26d;
		}
		
		v3 := [494];
		v0 := v0;
		var v62 := DC1(v0[723], v2[v1], v0[723]);
		var v63: map<D0, int> := map[v62 := v1];
		var v64: C0 := new C0(v63);
		var v65 := 'k';
		var v66 := DC24(v1, v64, v65, v0[723]);
		...
		var v70 := DC15(v1, v1);
		v69[512] := v70;
		v68, v69[512] := v68, v70.(cf17 := v1);
		var v71: array<T0> := new T0[26];
		var v72: map<array<T0>, bool> := map[v71 := p0];
		globalState.f4, globalState.f2, v0[723], v0[723] := -((v0[723] * -v1) - v0[723]), p0 <==> !(v0[723] <= |v72|), v0[723], fm0(v1, v1, globalState);
	}
...
method Main() {
		...
		decreases 100 - i1
	{
		...
		var v7 := true;
		var v8 := 'i';
		v4[621] := fm0(if (v7) then v0 else -650, |(if (true) then seq(0x1b6, i2  => ('u')) else v2)[v0 := v8]|, globalState);
		v4[621] := fm0(v0, v0, globalState);
		if (v0 < v0) {
			var v9: multiset<int> := multiset{v0};
			var v10: seq<string> := [v2];
			var v11: multiset<int> := multiset{fm0(v4[621], |v9|, globalState), v4[621], |v10[if (v0 in v9) then v9[v0] else v0]|, v0};
			var v12: array<string> := new string[20](i3 => v2);
			v12[607] := v2;
			var v13 := DC4(v2);
			v4[621], v9, v2, globalState.f2, v12[607] := v0, v11, v2, v7, v13.cf4;
			var v14: seq<int> := [v4[621], v4[621], v4[621], v0];
			globalState.f2 := v0 !in v14;
			var v15: multiset<string> := multiset{v2, v12[607]};
			v12[607], globalState.f2, globalState.f2, globalState.f4 := v2[v4[621] := v8] + v13.cf4, v0 != (v0 * v14[v0]), v15 > v15, v0;
			var v16 := DC1(-v4[621], v7, |v2|);
			var v17 := new C0(map[v16 := v4[621]]);
			globalState.f3 := v4[621] - v4[621];
		} else {
			...
			var v19 := DC2();
			v19 := v19;
			var v20: array<string> := new seq<char>[4](i4 => if (v7) then seq(0x396, i5  => (v8)) else v2);
			var v21: map<bool, string> := map[!v7 := "hcnuuyv"];
			v20[931] := if (v7 in v21) then v21[v7] else fm1(globalState);
			v20[931] := v2 + v2;
			var v22: multiset<int> := multiset{v4[621], v4[621]};
			m0(0x241 !in v22, globalState);
		}
		
		if (v0 == v4[621]) {
			globalState.f3 := ---((v4[621] % v0) + v0);
			globalState.f4 := v0;
			v4[621] := -v0;
			var v23: array<map<bool, int>> := new map<bool, int>[13](i6 => map[false := -0x2] + map[v7 := |map[v4[621] := v7]|]);
			var v24: map<bool, int> := map[v7 := v0];
			v23[845] := v24;
			v23[845] := v24[v7 := 0x19a];
			...
			var v30 := DC1(v4[621], v7, v4[621]);
			var v31: map<D0, int> := map[v30 := v0];
			var v32: T0 := new C0(v31);
			var v33: multiset<T0> := multiset{v32, v32};
			var v34 := DC1(|v33|, v7, v0);
			var v35: multiset<D0> := multiset{DC1(v4[621], v7, if (v7 in v29) then v29[v7] else v0), v34};
			var v36: T0 := new C0(map v28 : D0 | v28 in v35 :: (v28) := (v4[621]));
			...
			globalState.f2, v4[621] := v7, v4[621] + -v4[621];
			...
			v46 := v46;
			var v47 := new C0(map[fm2(v7, globalState) := v4[621]]);
		}
	...
	if (v48 <==> (v49 < [true])) {
		...
		if (v0 !in v56) {
			...
			var v60: map<int, seq<T0>> := map[|v57| % v0 := DC9(v59).cf11 + v59];
			var v61: map<T0, int> := map[v58 := v0];
			var v62: map<T0, map<T0, int>> := map[v58 := if (v48) then v61 else v61];
			v5[151], v60, v62 := v48, map[v0 := v59] + v60, v62;
			var v63 := DC13(v54);
			var v64: C0 := new C0(v63.cf14);
			v64 := v64;
			v5[151] := if (v0 == |multiset{v0}|) then v5[151] else v48;
			v58 := new C0(v55.f15);
			v5[151] := if (v51 !in v2) then false else v5[151];
		} else {
			v4[553] := |v56|;
			var v65: multiset<bool> := multiset{v48};
			var v66: map<int, multiset<bool>> := map[v0 := multiset{v48}];
			var v67: multiset<int> := multiset{v0};
			var v68: array<multiset<bool>> := new multiset<bool>[22] [multiset{!true, v48}, v65, v65, v65, v65, multiset(v49), v65, v65, v65, multiset(v49), if (|(seq(0x37c, i7  => (v0)))[v0 := v0]| in v66) then v66[|(seq(0x37c, i7  => (v0)))[v0 := v0]|] else v65, v65, v65, v65, v65, v65, v65, multiset(v49), v65, fm3(true, v67, v48, globalState), multiset(v49), v65];
			...
			var v72: array<array<bool>> := new array<bool>[25] [v5, v5, if (v68 in v70) then v70[v68] else v5, v5, v5, v5, v5, v5, v5, v5, v5, v71[v0], v5, v5, v5, v5, DC14(v5).cf15, v5, if (v48) then v5 else v5, v5, v5, v5, if (v48) then v5 else v5, v5, v5];
			v72[378] := v5;
			var v73: map<seq<char>, int> := map[v2 := v0];
			globalState.f3, v2, v4[553], v72[378] := (-v0 / v0) / (if (v2 in v73) then v73[v2] else v0), v2, 0xd1 - 602, v5;
			var v74 := new C0(map[v52 := v0]);
			var v75: map<int, string> := map[v0 := v2];
			v75 := v75[v4[553] := seq(0x284, i8  => (v51))];
			globalState.f4 := -(v4[553] + 820);
			v56, v4[553] := v56, |fm4(!v48, v48, globalState)|;
		}
		...
		var v84: seq<int> := [|v49|];
		v77, v78 := if (v82[v81 := v81] !in v83) then v77 else v77, v78[v0 := (set v85 : int | v85 in {v84[v0]} :: (v85 % -0x5d)) > (set v86 : int | (0x11 <= v86) && (v86 < 0x257) :: (v86 * 0x388))];
		...
		var v92 := DC6(v91, v48);
		v89[76] := if (!v92.cf7 in v90) then v90[!v92.cf7] else [v0];
		v4[557], globalState.f3, v89[76] := v0 * v0, (v0 * v0) + v0, v84;
	}
		...
		decreases 100 - i10
	{
		...
		if (v48) {
			...
			v4[27] := if (v48) then v0 else |v100|;
			v4[27] := v0;
		} else {
	...
	match (DC0(v0)) {
		case DC1(cf1, cf2, cf3) =>
			...
			v5[207] := v48;
			v5[207] := v48;
			cf1 := fm0(cf3 % cf1, fm0(cf3, cf3, globalState), globalState);
		case DC2() =>
			globalState.f2 := v48;
			v5[690] := false;
			...
			globalState.f2, v5[690], globalState.f4, globalState.f2 := !!(0x3bc < -v0), true, v0, if (v107 in v108) then v108[v107] else v48;
			v0 := v0;
			var v109 := DC6(v105, v5[690]);
			var v110 := 'x';
			...
			v112, globalState.f2, v110 := fm7(v110, |(fm8(v0, globalState) + v114)|, v0, v48, globalState), v5[690], v110;
		case DC3() =>
			globalState.f2 := v48;
			var v115 := DC0(v0);
			v115 := v115;
			...
			if (v48) {
				...
				v119 := v118;
				v5[125] := v0 < v0;
				v5[125] := fm6(false, 0x25b, globalState);
			} else {
				v2 := (v2 + v2) + v2;
				...
				v125, v4[339], globalState.f2, globalState.f3, v127 := v125, v0 % v0, v48, v0, v127;
				var v128 := 'c';
				var v129 := DC20(v128);
				v128 := v129.cf22;
				...
				v130[44] := if (v48 in v131) then v131[v48] else v125;
			}
		...
		case DC0(cf0) =>
			...
			if (fm9(|v138|, fm0(cf0, v0, globalState), globalState) >= v1) {
				globalState.f4 := (cf0 % cf0) - -0xa7;
				var v139: map<char, bool> := map['v' := v5[591]];
				m0(if (v132 in v139) then v139[v132] else true, globalState);
				v137 := v137;
				var v141: multiset<int> := multiset{cf0};
				var v142 := DC1(if (cf0 in v141) then v141[cf0] else v0, v5[591], cf0);
				var v143: map<D0, bool> := map[v142 := v5[591]];
				var v144 := new C0((map v140 : D0 | v140 in v143 :: (v140) := (v0)) + map[v142 := v0]);
				globalState.f2 := v132 !in (seq(0x2ee, i11  => ('j')));
			} else {
				v132 := DC20(v132).cf22;
				m0(v5[591], globalState);
				globalState.f3 := v0;
				var v145: map<bool, int> := map[v5[591] := 189];
				...
				v147 := (v148[cf0] + map[|v2| := 0x1f7]) + v147;
				v2 := "vfpkjomp";
			}
	...
	v4[642] := |v150| % 0x148;
	var v151: map<int, bool> := map[v0 := fm6(v48, v4[642], globalState)];
	v5[359] := v48;
	v4[642], v48, v151, v4, v5[359] := v4[642] + -v0, v48, v151, v4, 0x3bc != v0;
	var v152: multiset<set<int>> := multiset{v1};
	var v153: seq<multiset<set<int>>> := [v152];
	var i12 := 0;
	while ((v152 + v152) > (v153[v0] + v152))
		decreases 100 - i12
	{
		if (i12 >= 100) {
			break;
		...
		i12 := i12 + 1;
		var v154 := DC1(v4[642], v5[359], v4[642]);
		var v155: map<D0, int> := map[v154 := v0];
		var v156: C0 := new C0(v155);
		var v157: map<C0, string> := map[v156 := v2];
		v5[359], v2, v5[359] := v5[359], if (v156 in v157) then v157[v156] else v2, true && !v48;
		var v158 := 'd';
		var v159 := DC20(v158);
		v48 := v159 !in (seq(0x3d6, i13  => (v159)));
		v156 := v156;
		var v160: map<bool, C0> := map[!v5[359] := v156];
		v160 := v160;
	}
	...
	forall i14 | 0 <= i14 < v161.Length {
		v161[i14] := map[false := v0] + map[v5[359] := v4[642]];
	}
	m0(v5[359] <== v48, globalState);
	var v162 := DC4(DC4(v2).cf4);
	v4[642] := match v162 {
		case DC4(cf4) => -(v0 * |multiset{-v4[642]}|)
	};
	v0 := v0;
	var v163 := 'e';
