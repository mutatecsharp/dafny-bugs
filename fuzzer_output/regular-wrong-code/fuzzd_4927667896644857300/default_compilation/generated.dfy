...
function fm2(p0: string, p1: set<bool>, p2: map<bool, char>, p3: bool, globalState: GlobalState): int {
	-(|(seq(0x369, i0  => ('b')))| + -(|map[true := |map[DC5(false, false, --|"q"|, true, true).cf9 := false]|]| - |multiset{|map[DC48(multiset{-0x1d5}) := 0x16a]|, 810}|))
}
...
function fm6(p0: bool, p1: int, p2: string, globalState: GlobalState): seq<int> {
	((seq(0x343, i0  => (|[0x2b8]|))) + [-0x3d4, |map[!!false := !!false]|]) + ((seq(0x28f, i1  => (|map[true := --|(seq(695, i2  => ('m')))|]|))) + [-0x280, |map[|(seq(141, i3  => ('q')))| := map[|"mno"| := true]]|, |(set v0 : int | v0 in multiset([0xb5]) :: (v0 + -0x144))|, |(seq(0x31a, i4  => ('u')))|, -0x27c])
}
...
function fm23(globalState: GlobalState): map<int, bool> {
	(map[738 := true] + (map v0 : int | v0 in multiset{|[false, true, false, false, false]|} :: (v0 * |(seq(0x37a, i0  => ('n')))|) := (true))) + (map v1 : int | (0x260 <= v1) && (v1 < 838) :: (v1 + 190) := (true))
}
...
function fm27(p0: int, globalState: GlobalState): map<D4, int> {
	(map v0 : D4 | v0 in (set v1 : D4 | v1 in {DC10('g')} :: (v1)) :: (v0) := (|(map v2 : int | (-0x2a0 <= v2) && (v2 < 151) :: (v2 + |"jul"|) := (532))|)) + (map[DC10('w') := |map[false := 0x3e6]|] + map[DC10('d') := |(seq(0x5, i0  => ('w')))|])
}
function fm28(p0: bool, globalState: GlobalState): set<D8> {
	{DC21(true, false, 0x64), DC21(!true, true, |{0xa8}|), DC21(true, true, |(map v0 : int | (68 <= v0) && (v0 < 222) :: (v0 / 0x223) := (true))|)}
}
...
function fm30(p0: int, p1: map<string, bool>, globalState: GlobalState): map<bool, int> {
	map[!('q' !in "st") := -0x2a5 - |(seq(-0x157, i0  => (|[|DC37([true], "tytqu", 'f').cf65|, -0x44]|)))|]
}
function fm31(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): multiset<set<int>> {
	multiset{set v0 : int | v0 in map[-|"fkogaj"| := 'q'] :: (v0 / 551), {-0x3c5}} * (multiset{{|multiset{-|map['x' := true]|, 0x39a}|}} + multiset([{|{false}|}]))
}
...
function fm33(p0: bool, globalState: GlobalState): map<seq<int>, char> {
	match if (true) then DC20(DC30(true, false, true, |map[true := false]|, false).cf54, |[[true, true, true, false], [!false], [true, !false], [true], [false]]|) else DC20(-0x19d, |{0xa0}|) {
		...
		case DC21(cf33, cf34, cf35) => map v1 : seq<int> | v1 in {seq(405, i0  => (cf35))} :: (v1) := ('x')
		case DC19(cf30) => if (!false) then map v2 : seq<int> | v2 in {[0x30d]} :: (v2) := ('g') else map v3 : seq<int> | v3 in (seq(0x1ea, i1  => ([0x273]))) :: (v3) := ('k')
		case DC22(cf36) => map[[-559] := 'y']
	}
}
function fm34(globalState: GlobalState): set<int> {
	{|map[false := |"rrwa"|]| % |"opxxf"|, 0x381, |(multiset{0xbc, |"xmiisjrm"|} + multiset{-276})|}
}
...
function fm39(p0: int, globalState: GlobalState): map<map<int, char>, bool> {
	map v0 : map<int, char> | v0 in ([map[|(seq(0x3ac, i0  => ('i')))| := 'o'], map[|(map v1 : int | (0x7b <= v1) && (v1 < 0x19a) :: (v1 / |"nmhpep"|) := (map[|multiset(seq(0x38, i1  => (|map['j' := false]|)))| := -0x2a]))| := 'h'], map v2 : int | (0xcc <= v2) && (v2 < 0x10b) :: (v2 / 0x3c) := ('g'), map v3 : int | (167 <= v3) && (v3 < 0xd9) :: (v3 + 344) := ('q')] + [map[|(seq(0x45, i2  => ('j')))| := 'o'], map v4 : int | v4 in map[|[true]| := |(set v5 : int | (-0xd9 <= v5) && (v5 < -0x3b9) :: (v5 * |map[false := 11]|))|] :: (v4 / 650) := ('x'), map[0x17b := 'f'], map[-|"egagps"| := 'c'], map v6 : int | (0x266 <= v6) && (v6 < 189) :: (v6 / |"bvfmnoywj"|) := ('f')]) :: (v0) := (!true)
}
...
function fm49(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<D12> {
	match DC57('q', |map[0x1d5 := 0xe9]|, |map[true := -799]|, !true) {
		...
		case DC57(cf109, cf110, cf111, cf112) => seq(-892, i0  => (DC30(cf112, cf112, true, cf111, !cf112)))
...
function fm51(globalState: GlobalState): map<map<int, bool>, bool> {
	((map v0 : map<int, bool> | v0 in [map[0x20 := !true], map[-0x39d := !true]] :: (v0) := (false)) + map[map v1 : int | v1 in (set v2 : int | (-806 <= v2) && (v2 < 0x213) :: (v2 % |[true, false, true]|)) :: (v1 + |[true]|) := (!false) := true]) + (map[map[|(seq(-0x2f1, i0  => ('j')))| := false] := !true] + (map v3 : map<int, bool> | v3 in multiset{map[-0x2bc := false], map[--190 := true]} :: (v3) := (false)))
}
...
function fm53(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): set<seq<int>> {
	{[450, |map[!false := !false]|, |[true, true]|, 0x39c], seq(0x34a, i0  => (831)), [15, |(seq(148, i1  => (|[|"oxlytiaam"|, |map[true := false]|]|)))|, -0x1b6]} * ({[-0x340], seq(-0x6d, i2  => (-0xc5))} - (set v0 : seq<int> | v0 in [[623], [|multiset{-901}|], seq(0xfb, i3  => (947)), [|{false}|]] :: (v0)))
}
function fm54(globalState: GlobalState): D6 {
	DC16({DC18(!true).cf29} !! {!true}, "ygv" < (seq(0xd5, i0  => ('i'))))
}
method m0(p0: array<bool>, p1: array<int>, p2: int, p3: int, globalState: GlobalState) {
	...
	p0[666] := if (fm4(globalState)) then v0 else v0;
	...
	var v9 := DC41(v6);
	var v10: seq<seq<int>> := [seq(-0x37b, i1  => (p3)), v6, v6, v9.cf71[p2 := p3], v6];
	var v11: array<seq<int>> := new seq<int>[19] [seq(0x220, i0  => (|"ummi"|)), v6, fm6(v0, p2, v7, globalState), [p3, 0x366, v8.cf106], v10[p3], v6, v6, v6, v6, v6, v6, v6, seq(0x3d9, i2  => (p2)), v6, v6, seq(0x2e8, i3  => (|{v0, DC49('n', p3, v0, if (v0 in v2) then v2[v0] else false, v0).cf92}|)), v6, v6, v6];
	v3[651] := v11;
	v2, globalState.f11, p0[666], v3[651], globalState.f11 := v2, v0, p2 <= p3, v11, p2 != (if (fm4(globalState)) then 0x16d else p2);
	v0 := DC21(p0[666], v0, p3).cf33;
	globalState.f14 := p2;
	globalState.f0 := -p3;
...
class C1 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		...
		v1 := v1[fm2(v2[f42 := v0], v4, fm18(fm7(v3, v3, globalState), v5[f42], globalState), fm4(globalState), globalState) := v0];
		var v6: array<int> := new int[2](i0 => i0 % f42);
		var v7: map<array<int>, int> := map[v6 := f42];
		globalState.f14 := if (v6 in v7) then v7[v6] else f41;
		f42, r1 := f41, (seq(-0x32d, i1  => (v0)))[f41 := v0];
		var v8 := new C0(v4 + v4);
		if (false) {
			...
			v6[993] := if (!v3) then f41 else |v12|;
			...
			if (v3) {
				...
				globalState.f14 := v16[f42];
				var v17: array<bool> := new bool[7];
				var v18: map<bool, char> := map[v3 := v0];
				m0(v17, if (v3) then v6 else v6, fm2(v2, v8.f43, v18, v3, globalState) / f41, f42 + -f42, globalState);
				globalState.f11 := v3;
			...
			globalState.f16 := v5[f41 := v3];
			globalState.f19 := f42 / f41;
		}
	...
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		...
		if (!(p0 in (v0 + v0))) {
			...
			v6[543] := if (p0) then !p0 else p0;
			var v7: map<int, bool> := map[f42 := p0];
			v6[543] := v0[-|v7|];
			var v8: array<int> := new int[2](i4 => i4 / f42);
			v8[584] := f42;
			var v9: multiset<int> := multiset{f41};
			var v10: set<bool> := {p0};
			v8[584] := (f42 * f42) - (f42 * |v9[f42 := |v10|]|);
		} else {
			var v11: seq<int> := [-f41];
			globalState.f24 := v11[f41 / f42];
			globalState.f14 := f41;
			...
			match (v14) {
				case DC7(cf13, cf14, cf15) =>
					...
					var v18: map<set<map<int, bool>>, int> := map[v17 := f41 % |v15|];
					v0, globalState.f24, globalState.f11, globalState.f14 := fm0([cf14, v0[f42]] <= v0[f42 := cf13], globalState), f42, (cf15 + (seq(0x256, i5  => (p1)))) <= (cf15 + (seq(0x244, i6  => (p1)))), if (v17 in v18) then v18[v17] else f41;
					var v19 := 'u';
				...
				case DC8(cf16, cf17) =>
					...
					v23[63] := f42 == (if (cf16) then fm2(v24, v25, v26, p0, globalState) else |v27|);
					...
					v29[585] := seq(0x20b, i9  => (p1));
					v29[585] := (v24 + "mlkpbgw") + v24;
				case DC6(cf12) =>
					globalState.f11 := !p0;
					globalState.f27, v11 := p0, v11;
					globalState.f1 := v0[f41];
					var v30: set<int> := {-0x298};
					var v31: map<int, int> := map[if (p0) then |fm3(globalState)| else f41 := f42 % |v30|];
					v31 := v31[f41 := 0x313];
			}
		...
		if (p0) {
			...
			v36[263] := f41;
			var v37 := "ug";
			v36[263] := |("butbgpmp" + v37)|;
			var v38: array<bool> := new bool[7] [p0, p0, p0, p0, p0, p0, p0];
			m0(v38, v36, |fm3(globalState)|, f41, globalState);
			var v39 := 'o';
			v39 := p1;
			var v40: map<int, int> := map[0x318 + |v37| := v36[263] / f42];
			v36[263], globalState.f14, globalState.f0, v37, globalState.f1 := v36[263], if (f42 in v40) then v40[f42] else -(f42 + 452), v36[263], "ebsaabwkq", p0;
			...
			v42[315] := !(v44 == v44);
			v42[315] := f42 > f42;
			var v45: map<bool, int> := map[v42[315] := f42];
			var v46: set<map<bool, int>> := {map[p0 := f41], v45, v45, v45};
			var v47: seq<int> := [|v46|];
			f42, v42[315] := v47[|v47|], p0;
			globalState.f14 := f41;
			var v48 := "m";
			var v49 := DC4(|v48|, v42[315]);
			...
			decreases 100 - i10
		{
			...
			var v54: seq<int> := [f42];
			var v55 := "ulfbjea";
			var v56: map<int, int> := map[|v54[f41 := |fm6(v53[786], v52[655], v55, globalState)|]| := f42];
			var v58: seq<map<int, int>> := [fm21('g', globalState), v56 + v56, map v57 : int | (0x1b2 <= v57) && (v57 < 0xbe) :: (v57 / f42) := (f42)];
			var v59: map<bool, int> := map[fm4(globalState) := f42];
			r0, v58, v52[655], v55 := |v59| % v52[655], (v58 + v58)[f41 - v52[655] := v56[f41 := 193]], f41, (seq(-297, i11  => (p1))) + (v55 + v55)[f42 := p1];
...
class C2 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		...
		v5[480] := |multiset{v7, v7, v7}| > fm17([v1], v1, globalState);
		v5[480] := !(v6 != v6);
		if (v0) {
			var v8 := 'v';
			var v9: seq<char> := [v8, v8, v8, v8];
			var v10 := DC7(v0, v0, v9);
			var v11: set<D2> := {v10, v10, v10, v10, DC7(v5[480], v0, v9)};
			...
			var v15 := DC9(v14);
			var v16: seq<bool> := [v5[480]];
			var v17: map<seq<bool>, int> := map[v16 := v1];
			v15, globalState.f0, v17, r1 := v15, v1, v17 + (fm22(v5[480], v1, v1, globalState) + f39), fm3(globalState);
			...
			v18[119] := v20 + (map v21 : string | v21 in v22 :: (v21) := (map[v1 := v0]));
			globalState.f27 := !(if (v5[480]) then v5[480] else v0);
			var v23: map<seq<int>, bool> := map[v6 := fm4(globalState)];
			var v24: set<bool> := {!(v0 <==> v5[480]), v5[480], (if (v6 in v23) then v23[v6] else v0) || v0, v5[480], v0};
			v24 := f40 * v24;
		...
		var v26 := DC0(v7);
		v1 := match if (v5[480]) then v26 else DC0(v7) {
			case DC1(cf1) => cf1
			case DC2(cf2, cf3) => --|[v5[480]]|
			case DC0(cf0) => v1
		};
		var v27 := new C1(v1, v1, f28);
		var v28: seq<bool> := [v5[480], v5[480]];
		var v29 := DC4(|v28|, v5[480]);
		for i0 := if (v5[480]) then v27.f42 else v1 to v29.cf5 {
			if (fm7(if (!v5[480] in v3) then v3[!v5[480]] else v0, v5[480], globalState)) {
				var v30 := "jurwunavv";
				var v31: seq<string> := [v30, "rdenx", v30, v30, v30];
				var v32 := 'q';
				var v33: map<bool, char> := map[v0 := v32];
				var v34: set<string> := {v30, v30};
				globalState.f1 := fm2(v31[v27.f42], f40, v33, v0, globalState) <= |({"xledywls", v30} - v34)|;
				globalState.f27 := v0;
				globalState.f19 := v6[|v2|];
				globalState.f14 := -v27.f41 / v27.f41;
				globalState.f11 := v0;
			} else {
				globalState.f11 := v27.f42 <= v27.f41;
				var v35 := "och";
				var v36: array<char> := new char[28];
				var v37: map<array<char>, bool> := map[v36 := v5[480]];
				...
				var v42: array<int> := new int[21] [fm2(v35, f40, v40, v0, globalState), if (v5[480]) then v27.f42 else |v35|, -(-v27.f41 + 463), v27.f41, v27.f42 - i0, |v35|, |[v0]|, v27.f42, 171, fm2(v35, f40, v40, v5[480], globalState), v29.cf5, v27.f41, v27.f42, -v27.f42 * v27.f42, i0, --|(map[-|v35| := v41])[if (-v27.f41 in v7) then v7[-v27.f41] else v27.f41 := v41]|, v27.f41, 0x139, -142, fm17(v6, v27.f41, globalState), v27.f41];
				v42[346] := v1 + v1;
				v42[346] := v27.f41 % v27.f42;
				globalState.f14 := v1;
				v42 := v42;
			...
			v45[599] := v6 + v6;
			var v46 := "vhb";
			globalState.f27, v45[599], v5[480] := v0, ((seq(0x282, i2  => (-0x1c9))) + (seq(404, i3  => (-0x2bf)))) + v6, fm3(globalState) != v46;
		}
		var v47 := 'm';
		...
		if (v49.cf21) {
			...
			var v52 := DC13(v51);
			globalState.f14, v52, globalState.f27 := (v1 % v27.f42) - (v27.f42 + v27.f42), v52, v5[480];
			var v53: array<int> := new int[21];
			v27.f42, v53 := v27.f42, v53;
			var v54 := "vtdv";
			var v55 := new C1(v27.f41 - v27.f42, |v54|, f28);
			globalState.f19 := -|fm0((v29.(cf6 := v5[480])).cf6, globalState)|;
			globalState.f27 := v0;
		} else {
			var v56: map<bool, int> := map[v5[480] := v27.f42];
			var v57: map<bool, char> := map[v0 := v47];
			var v58: map<int, bool> := map[v27.f42 := v5[480]];
			var v59: set<map<int, bool>> := {v58, v58, v58};
			var v60: array<int> := new int[22] [-v1 / v27.f41, v27.f41 - v27.f41, |(v28 + v28)|, v27.f41, -0x38e, v27.f42, (if (v5[480] in v56) then v56[v5[480]] else fm2(fm3(globalState), f40, v57, v0, globalState)) - 0x1a1, v27.f42, |[v0, v5[480], !v5[480]]|, v27.f41, v27.f41, v27.f42, v27.f42 * v27.f41, v1, v27.f42, |v59|, v27.f41, v1, v27.f41, if (v0) then v27.f41 else v27.f41, v27.f42, v27.f41 - v27.f41];
			v60[895] := |v56|;
			v60[895] := v27.f42;
			var v61 := DC6(v5);
			v5 := v61.cf12;
			v27.f42 := v27.f41;
			globalState.f27 := !v0 <==> !v5[480];
			var v62: multiset<char> := multiset{v47};
			if (v62 !! v62) {
				globalState.f1 := v5[480];
				var v63 := new C1(|(v58 + v58)|, v27.f41 / v60[895], f28);
				globalState.f16 := (v28 + v28) + [v5[480], v5[480]];
				var v64: array<C0> := new C0[26];
				var v65: C0 := new C0({v0});
				v64[673] := v65;
				var v66 := DC8(v5[480], v60);
				...
				var v69 := "rh";
				v64[673], v67[112], globalState.f11, globalState.f1, v60[895] := v65, v60, false, if (v5[480]) then v0 else v68 !! v68, |v69|;
				v27.f42 := v63.f42;
			} else {
				...
				var v73: array<array<seq<bool>>> := new array<seq<bool>>[13] [v72, v72, v72, v72, v72, v72, if (v5[480]) then v72 else v72, v72, v72, v72, v72, v72, v72];
				v73[24] := v72;
				v73[24] := v72;
			}
	...
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := v0 % v0 to -v0 {
			if (if (p0) then p0 else -0x19e <= i0) {
				...
				v16, v18[748], v16, v20[982], v21[682] := v16, (multiset{v17.f41, fm2(v22[v0 := p1], f40, v23, p0, globalState)} - v19) - multiset{v0, v17.f41, v17.f41, -v0}, v16, p1, false;
				globalState.f24 := fm2(seq(0x26a, i2  => (v22[-v17.f41])), f40, v23, !p0, globalState);
				v21[682] := true;
			...
			v25[539] := v0 >= fm2(v26, {if (v0 in v27) then v27[v0] else p0}, v28, p0, globalState);
			v25[539] := "trt" == v26;
		...
		if (p0) {
			...
			var v32 := "xdlri";
			var v33: seq<bool> := [p0];
			var v34: map<int, bool> := map[fm2(v32, fm24(v33[v0 := p0], p0, globalState), map[true := v31], p0, globalState) := v0 == v0];
			globalState.f20 := v34;
			var v35: array<D1> := new D1[19];
			v35[700] := DC4(v0, p0);
			var v36: seq<int> := [v0, v0, v0, v0];
			v35[700] := DC4(v36[v0], p0 ==> p0);
			globalState.f27 := fm4(globalState);
			var v37: seq<seq<bool>> := [[p0, p0], v33, v33, v33, v33];
			globalState.f27 := !fm7(p0, v37[v0] == v33, globalState);
		} else {
			globalState.f0 := v0;
			...
			r0 := if (v38[92]) then |v42| else v0 % v0;
			var v43 := new C0(f40);
			var v44 := "neqjhkexi";
			var v45 := DC4(v40[v0], !v38[92]);
			var v46, v47 := m15(p0, 0x27c - fm17([|v44|, 613, v0, v0, v0], v0, globalState), v45, v38[92], globalState);
		}
		...
		globalState.f27, v48[89], v51, globalState.f1, v52[429] := p0 && p0, v49, if (!(!p0 <==> p0)) then fm25(|fm25(v0, p0, v53, v0, globalState)|, p0, if (v53[v0] in v54) then v54[v53[v0]] else [p0], v0, globalState) else v51, p0, p0;
		var v55 := "nldq";
		for i3 := |v55| to v0 {
			globalState.f19 := 292;
			...
			v50 := {|v55[-v0 := p1]|, --|(v57[v52[429] := i3])[v52[429] := 0x130]|};
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			if (v53[|(set v59 : int | (0x3d8 <= v59) && (v59 < 0x69) :: (v59 - |v48[89]|))|]) {
				var v60: map<bool, char> := map[!true := p1];
				var v61: map<bool, int> := map[v52[429] := |v55|];
				var v62 := DC2(v0, |v53|);
				var v63: map<D0, bool> := map[v62 := p0];
				var v64: array<int> := new int[27] [0x30, -273, v0, v0, |v60|, -0x25c, -v0, |(v53 + v53)|, v0, v0, |multiset{v0}|, v0, v0 % -v48[89][|v61[p0 := v0]|], v0 + |v53|, |(if (v52[429]) then v49 else v48[89])[0x1ad := v0]|, 0x1e, v0, -(274 * v0), v0, |v63|, v0, v0, |v48[89]| / v0, 583, if (v52[429]) then v0 else |v55[v0 := p1]|, v0, v0 - -0x275];
				var v65: seq<set<bool>> := [f40];
				v64[35] := fm17(v48[89], |v65|, globalState);
				v64[35] := v0 * (v0 % v0);
				var v66 := DC7(v52[429], v52[429], [p1, p1]);
				var v67: array<map<bool, bool>> := new map<bool, bool>[11];
				var v68 := DC9(v67);
				var v69: multiset<D3> := multiset{v68};
				var v70: map<string, int> := map[v66.cf15 := if (v52[429]) then v48[89][v64[35]] else |v69|];
				globalState.f24 := if (v55 in v70) then v70[v55] else -v0;
				v64[35] := -v0 * v0;
				globalState.f1 := v52[429];
				globalState.f14 := v64[35];
			} else {
				v48, v52[429] := v48, p0;
				var v71 := new C0(f40);
	...
	method m15(p0: bool, p1: int, p2: D1, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (fm7(p0, v11 <= v11, globalState)) {
			...
			globalState.f19 := if (0x2a0 < |v18|) then -0x14b / |map[p3 := v9]| else if (fm4(globalState) in v19) then v19[fm4(globalState)] else |"qrm"|;
		} else {
			var v20: array<int> := new int[22](i2 => i2 / 494);
			...
			match (v22) {
				case DC7(cf13, cf14, cf15) =>
					var v23: map<bool, string> := map[p3 := seq(611, i3  => (v9))];
					...
					globalState.f19, globalState.f1, cf14, cf14 := -|((cf15 + (if (p3 in v23) then v23[p3] else seq(836, i4  => ('c')))) + ((seq(0x49, i5  => (v9))) + (if (p1 in v24) then v24[p1] else cf15)))|, (|v26| % |v27|) > p1, v28 >= v28, p0;
					...
					v30, v29[516], v31[56] := (v30 + v30[cf13 := v20]) + v30, !(v34 < v34), if (p0) then v33 else v33;
					var v35 := DC7(false, cf14, fm3(globalState));
					var v36: array<string> := new seq<char>[24] [cf15, cf15, cf15 + fm3(globalState), cf15, v35.cf15, "mopoyayn", cf15 + cf15, cf15, cf15, cf15, cf15, cf15, cf15, cf15, cf15, cf15, cf15, cf15, fm3(globalState) + cf15, cf15, cf15, cf15 + (seq(-0x274, i6  => (v9))), cf15 + cf15, fm3(globalState)];
					v36[498] := "itmx";
					var v37: map<bool, bool> := map[p3 := false];
					v36[498], v29[516], v37, cf14, globalState.f1 := cf15, v28 < (v28 * v28), v37, !p0, (p1 + p1) < (p1 % p1);
				case DC8(cf16, cf17) =>
					var v38 := "fft";
					v38 := v38 + (v38 + v38);
					globalState.f1 := p0;
				...
				case DC6(cf12) =>
					...
					cf12[517] := v42 > {fm3(globalState)};
					var v43: map<bool, int> := map[p0 := p1];
					cf12[517] := !(!(if (!true) then !false else p3) in v43);
					var v44: multiset<bool> := multiset{p3, p0, p0, p3, p0};
					var v45: map<char, bool> := map[v41[p1] := v44 > v44];
					var v46: map<bool, char> := map[!p0 := v9];
					v45 := v45[fm5(fm2("ohnr", f40, v46, p3, globalState), cf12[517], globalState) := cf12[517]];
					var v47 := DC10(v9);
					v47 := v47.(cf19 := v9);
					...
					globalState.f14, v48, globalState.f24, v9 := fm17(v49, -0x2a6, globalState), DC7(cf12[517], false, [v9]), |v51|, 't';
			}
		...
		if (p0) {
			...
			var v58 := DC0(v57);
			v55, globalState.f19, globalState.f24, v58 := fm3(globalState), -p1, -((0x24a / 0x35b) % -(|"xqfbcws"| + p1)), v58;
			var v59: array<bool> := new bool[10];
			v59[252] := if (p3) then p3 else p3;
			var v60: seq<string> := [v55];
			v59[252] := ((seq(0x29d, i7  => (v55))) + v60) == (v60 + v60);
			if (p3) {
				...
				var v63: seq<int> := [|v55|];
				var v64: seq<bool> := [v59[252]];
				var v65: multiset<bool> := multiset{p0, p0, p0};
				var v66: array<int> := new int[29] [p1, p1, p1, p1, |v57|, p1, 0x1fb, p1, 0x3c5, p1, p1, v63[p1], p1, p1, v63[-p1], p1, -p1, p1, p1, p1, p1, p1, -p1, |v64|, -p1, p1, p1, if (p3 in v65) then v65[p3] else p1, p1];
				v62[384] := v66;
				v62[384] := v66;
				v66[666] := p1;
				v66[666] := p1 / (p1 - p1);
				var v68 := DC7(v59[252], p3, [v9]);
				var v69: map<int, D2> := map[|(set v67 : int | (0x138 <= v67) && (v67 < 531) :: (v67 / |{v66[666]}|))| := v68];
				var v71: map<int, map<int, D2>> := map[v66[666] := map v70 : int | v70 in v57 :: (v70 * p1) := (v68)];
				var v72: set<int> := {p1};
				var v73: map<bool, int> := map[fm4(globalState) := |v72|];
				var v74: map<int, bool> := map[|v73| := true];
				var v75: array<map<int, D2>> := new map<int, D2>[13] [v69, map[p1 := v68], if (0xe0 in v71) then v71[0xe0] else map[|v74| := v68], v69, v69, v69 + map[|multiset{p1}| := DC7(v59[252], v59[252], v55)], v69, v69, v69, v69[v66[666] := v68], v69 + v69, v69, v69];
				v75[324] := v69;
				var v76: T0 := new C1(p1, v66[666], DC3(v59[252]));
				var v77: seq<T0> := [v76, v76];
				v75[324] := v69[|DC15(v77).cf25[v66[666] := v76]| := v68];
				var v78 := new C1(p1, p1 / p1, if (!true) then f28.(cf4 := v59[252]) else v76.f28);
			...
			var v80 := "fvnkssion";
			globalState.f19 := p1 % |fm26(p3, v80, !p0, globalState)|;
			var v81: array<bool> := new bool[24];
			var v82: map<int, bool> := map[p1 := true];
			v81[692] := |v82| <= p1;
			var v83: seq<int> := [p1];
			v81[692] := (v9 in v80) ==> (v83[fm2(v80, {p0}, map[p0 := v9], true, globalState)] < p1);
			var v84: set<char> := {v9};
			var v85: map<char, char> := map[v9 := v9];
			var v86: seq<array<bool>> := [v81];
			var v87: array<int> := new int[18] [p1, p1 / p1, p1, -p1 * -fm17([p1], p1, globalState), |(v83 + v83[p1 := p1])|, |v84|, p1, |v85|, p1, 0x350, fm17(v83, p1, globalState) % |map[p1 := p1]|, |v86|, p1, 0x65, p1 - p1, p1, |v80| % p1, |v83|];
			v87[579] := p1;
			v9, v87[579], globalState.f14 := v9, |[v9]| * p1, p1;
			v87 := new int[1] [-p1];
			var v88 := DC10(v9);
			var v89: map<D4, int> := map[v88 := v87[579]];
			var v91: map<D4, bool> := map[DC10(v9) := p3];
			var v92 := DC17(v89);
			var v93: seq<map<D4, int>> := [v89, v89];
			var v94: map<bool, bool> := map[v81[692] := true];
			var v95 := DC19(v94);
			var v96: set<int> := {|v95.cf30|, v87[579]};
			var v98: array<map<D4, int>> := new map<D4, int>[27] [v89, map v90 : D4 | v90 in v91 :: (v90) := (v87[579]), v92.cf28, fm27(|v80|, globalState), v89, v89, map[v88 := p1], v89, v89, v89, v89, v89, v93[|v96|], v89[v88 := -v87[579]], v89, v89, v89, v89 + v89, v89, v89, if (fm4(globalState)) then v89 else map v97 : D4 | v97 in (seq(326, i8  => (v88))) :: (v97) := (v87[579]), v89 + v89, v89, v89 + v89, if (true) then v89 else v89, v89, v89];
			v98[266] := v89;
			v98[266] := v93[v87[579]];
		}
		...
		for i9 := if (p1 in v101) then v101[p1] else p1 to p1 {
			...
			var v104: array<string> := new string[17] [v102 + v102, v102 + (seq(0x1d5, i10  => (v9))), "pqagahw", fm3(globalState), v103[p1], DC7(p0, p0, v102).cf15, fm3(globalState), (seq(445, i11  => (v9))) + v102, if (p0) then v102 else v102, v102, v102, v102, v102, v102, if (p3) then v102 else seq(0x252, i12  => (v9)), v102 + v102, "pyfkhq" + v102];
			v104[490] := v102 + v102;
			v104[490] := fm3(globalState) + v102;
			v9 := v9;
			var v105 := DC10(v9);
			match (v105.(cf19 := v9)) {
				case DC11(cf20) =>
					r0 := i9 - p1;
					var v106: array<bool> := new bool[18] [p0, true, p0, p3, p3, p0, v104[490] <= v104[490], fm4(globalState), p0, if (false) then p3 else p3, p3, v9 !in v104[490], p0, v99.f28.cf4, p3, !p3, i9 > p1, p3];
					v106[318] := cf20[i9];
					v106[318] := p3;
					var v107: array<char> := new char[29];
					var v108: map<array<char>, array<bool>> := map[v107 := if (v106[318]) then v106 else v106];
				...
				case DC12(cf21, cf22) =>
					...
					var v112: array<bool> := new bool[17] [p0, cf21, p3, p3, |"exijh"| > p1, p0, !cf21, p0, p0, v101 != v101, v110[v111[p1]], p3, true && p3, !p0, v99.fm7(true, p0, globalState), p0, !cf21];
					v112[851] := p0;
					globalState.f1, globalState.f1, v9, r0, v112[851] := v104[490] < v104[490], fm4(globalState), v9, i9, if (cf21) then !p3 || cf21 else p3;
					var v114: multiset<bool> := multiset{p0, p3, p3, p0, v112[851]};
					globalState.f27 := fm8(map v113 : int | v113 in multiset{if (p3 in v114) then v114[p3] else i9} :: (v113 % i9) := (0xcd), !p0, v112[851], globalState) !in "gr";
...
class C3 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		...
		var v4 := DC13(v3);
		r1 := match v4 {
			case DC11(cf20) => "qaegn" + (seq(0xb, i0  => (v1)))
			case DC12(cf21, cf22) => seq(0x18, i1  => (v1))
		...
		var v14: array<bool> := new bool[17] [|v9| in v10, v0, |v11[v6 := v1]| > v6, v0, v0, v12.cf6, true, false, v0, v0, false, v0, v13 <= v13, v0, v0, v6 == v6, v10 <= v10];
		v14 := v14;
			...
			decreases 100 - i4
		{
			...
			var v17: seq<bool> := [v0];
			var v18: seq<map<bool, bool>> := [map[if (v11 in v16) then v16[v11] else v17[818] := v0]];
	...
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		if (p0 && p0) {
			...
			if ((p0 <== p0) || p0) {
				...
				var v5: map<int, bool> := map[if (v3[-328 := p1] in v4) then v4[v3[-328 := p1]] else v2 := p0];
				v1[462] := v5;
				...
				var v12: array<bool> := new bool[9] [p0, p0 !in v8[v2], v2 in v9, p0, p0, !p0 && p0, p0, v2 !in v1[462], (v11[v2])[p0 := v2] >= multiset{fm7(p0, p0, globalState)}];
				v12[114] := p0;
				var v13 := DC4(v2, p0);
				v6, globalState.f27, globalState.f27, v12[114] := v6, !v13.cf6, fm7(p0, p0, globalState), p0;
				var v14: map<bool, bool> := map[v12[114] := p0];
				var v15 := m13(v2 % |v14|, globalState);
				var v16: seq<array<int>> := [v0, v0];
				var v17: map<bool, array<int>> := map[p0 := v0];
				var v18 := DC8(p0, v0);
				var v19: array<array<int>> := new array<int>[26] [v0, v0, v0, v16[v2], v0, v0, v0, v0, v0, v0, if (v12[114] in v17) then v17[v12[114]] else v0, if (p0 in v17) then v17[p0] else v0, v0, v0, v0, v0, v18.cf17, v0, v0, v0, v0, v0, v0, v0, v0, v0];
				v19 := v19;
			} else {
				...
				var v37: array<array<bool>> := new array<bool>[19] [v20, v20, v20, v20, v20, v20, v20, v20, v20, DC6(v20).cf12, v20, v20, v20, v20, v20, v20, v36[v26], v20, v20];
				v37[677] := v20;
				v37[677] := if (p0) then v20 else v21.cf12;
				var v38 := "mudnlnri";
			...
			var v41: set<int> := {v40[v39]};
			var v42 := new C1(v39 / v39, v39 * v39, fm20(!false, p0, v39, v41, globalState));
		} else {
			...
			globalState.f27, globalState.f14, v43[304], globalState.f24, globalState.f27 := !p0, v44, if (if (p0 in v45) then v45[p0] else p0) then !p0 else p0, v44, -0x378 <= (if (p0 in v46) then v46[p0] else |multiset{|v47|, v44}|);
			var v48 := "bksjwejlq";
			v48 := v48 + (v48 + v48);
			var v49: seq<set<bool>> := [{p0}];
			var v50: map<seq<set<bool>>, int> := map[v49 := |(seq(0x133, i1  => (-0x25d)))[v44 := v44]|];
			v50 := v50[v49 := v44];
			var v51: seq<int> := [v44];
			globalState.f0 := v51[-|v45|];
			var v52: set<bool> := {v43[304], v43[304]};
			var v53: map<bool, char> := map[v43[304] := p1];
			r0 := fm2(v48, v52, v53, p0, globalState) % v44;
		}
			...
			decreases 100 - i2
		{
			...
			if (!p0) {
				...
				var v60 := m13(v54 % (if (p1 in v59) then v59[p1] else v54), globalState);
				v58 := p1;
			} else {
				var v61: array<int> := new int[5](i3 => i3 - |multiset{|multiset{p0, p0, p0}|}|);
				var v62 := -0x28e;
				v61[524] := if (!p0) then v62 else -v62;
				v61[524] := v62;
				var v63: seq<bool> := [p0];
				globalState.f11 := !((v63 + v63) <= v63);
				r0 := v62;
				globalState.f0 := v62 / 0x2cd;
				globalState.f11 := p0;
			}
			...
			var v69: multiset<int> := multiset{v64[31]};
			var v70: map<int, bool> := map[-|v69| := p0];
			globalState.f1, globalState.f1, v66[329], v68 := p0, v64[31] < |v70|, p0, v68;
			if (p0) {
				var v71: seq<array<int>> := [v64];
				var v72: set<bool> := {true};
				var v73: seq<seq<array<int>>> := [[v64, v64]];
				var v74: array<seq<array<int>>> := new seq<array<int>>[24] [[v64, v71[|v72|]], v71, v71, v71, v71, v71 + v71, v71, v71, v71, v71[v65 := v64], v71, v71 + v71, v71, (v71 + v71)[-v64[31] := v64], v73[v64[31]], v71, [v64], [v64], v71 + v71, [v64], v71, v71, v71, v71];
				var v75: map<bool, array<int>> := map[p0 := v64];
				v74[474] := ([if (p0 in v75) then v75[p0] else v64])[v65 := v64];
				var v76: map<char, bool> := map[p1 := v66[329]];
				globalState.f0, v74[474] := |v76| + v64[31], v71;
				var v77: set<int> := {v64[31]};
				var v78: map<bool, int> := map[v66[329] := |v77|];
				var v79: map<int, int> := map[|v78| := |v67|];
				var v80: map<bool, map<int, int>> := map[v66[329] := v79];
				v80 := v80[p0 := v79];
				var v81 := new C1(fm2(v67[v65 := p1], v72, map[p0 := p1], p0, globalState) / v65, v64[31], f28);
				v64 := if (fm7(false, p0, globalState)) then v64 else v64;
				v66 := DC6(v66).cf12;
			} else {
				var v82: map<char, bool> := map[p1 := v66[329]];
				var v83, v84, v85, v86 := m14(v82 + v82, globalState);
				globalState.f11 := v66[329];
				var v87: seq<bool> := [p0];
				var v88: map<seq<bool>, int> := map[v87 := 0x200];
				var v89: map<array<int>, int> := map[v64 := v64[31]];
				var v91: T0 := new C2(v88[v87 := v64[31]], fm24(v87, p0, globalState), fm20(v66[329], v66[329], if (v64 in v89) then v89[v64] else v84, set v90 : int | (0x30b <= v90) && (v90 < 0x95) :: (v90 / 0x6), globalState));
				v91 := v91;
				globalState.f27 := v66[329];
				v64 := if (v66[329]) then v64 else v64;
			}
		...
		var v101: multiset<int> := multiset{|[!p0]|, fm2(v92, v93, v94, p0, globalState) / v95, --v96.cf3, |v97|, |v100|};
		var v102: seq<int> := [v95];
		var v103: map<int, bool> := map[0xbc := p0];
		v101, globalState.f0 := fm26(p0, v92[v95 := p1], p0, globalState) + multiset(v102 + [v95, v95, v95]), |v103| * v95;
		if (p0) {
			if (true) {
				...
				var v109 := new C1(v107.f41 % |v108|, v107.f41, f28);
				...
				var v119 := new C2(v116[v95] + v117, if (true in v118) then v118[true] else v93, f28.(cf4 := p0));
				var v120 := 'w';
				v120 := p1;
			}
			
			if (true) {
				var v121 := new C1(v95 % v95, v95, f28.(cf4 := p0));
				var v122: array<int> := new int[19];
				var v123: map<array<int>, bool> := map[v122 := !p0];
				v123 := v123[v122 := v97 >= v97];
				v122[889] := v95;
				v122[889] := fm2(v92, v93 * v93, v94, true, globalState);
				var v124 := DC4(v122[889], p0);
				var v125 := new C1(v124.cf5, v121.f42, f28);
				var v126 := new C0(v93);
			} else {
				var v127: seq<bool> := [fm4(globalState)];
				var v128: seq<seq<bool>> := [v127];
				globalState.f11 := |(v92 + v92)| <= |multiset(v127 + v128[26])|;
			...
			if (!fm4(globalState)) {
				...
				v99[151] := DC18(p0).cf29;
				globalState.f19, v133[100], v134, v99[151] := v95, v95, (map[p1 := p0] + v134) + (if (p0) then v134 else v134), (v97 - v97) > v97;
				globalState.f24 := v133[100];
				globalState.f24 := |v98|;
				var v135 := DC5(p0, p0, v95, v99[151], v99[151]);
				globalState.f1, globalState.f11 := if (p0) then v99[151] else v99[151], !(v135.cf10 <==> p0);
				globalState.f27 := p0;
			} else {
				...
				var v148: array<int> := new int[22] [v95 * v95, v95, v95, -(|v92| / |v93|), v95, v95, -|v140[v95]|, fm2(v92, {p0}, map[p0 := p1], p0, globalState) / -v95, v95, v95, v95 * v95, v95 * -0xb8, |(v142.cf44 + v141)|, v95, v95, v95, |((seq(-0x2fb, i5  => (p1))) + "wbtg")|, v95, v95, v147.cf42, |v145|, v95];
				v136, v148 := (multiset{v97} * (multiset{multiset(v145), v97, v97, multiset{p0}})[v97 := 0xb]) - v136, v146;
				globalState.f0 := fm2((seq(-901, i6  => (p1))) + v92, v93 + fm24(v145, p0, globalState), v94 + v94, p0, globalState);
			...
			globalState.f0 := v102[-164];
			globalState.f24 := v95;
			var v154: map<int, int> := map[v95 := |fm3(globalState)| / |v92|];
			v154 := v154[v95 := v95];
			var v155: map<string, char> := map[v92 := p1];
			v155 := v155[v92 := v92[v95]];
		...
		for i7 := |v158| to v95 {
			...
			var v161: map<int, map<seq<int>, int>> := map[0x2ec := v160[seq(-993, i8  => (v95)) := |multiset{i7}|]];
			...
			v166[261] := -0x1fb;
			v159, v166[261], globalState.f27 := p1, v95 / 448, p0;
			v102 := v102;
			globalState.f11 := p0;
			var v167: map<string, char> := map["xoscp" := p1];
			var v168: map<bool, multiset<int>> := map[p0 := v101[v166[261] := v166[261]]];
			v99[543] := multiset{v95, |v167|, |v158|, i7} !! (if (fm4(globalState) in v168) then v168[fm4(globalState)] else multiset{i7});
			var v169: set<int> := {i7, i7};
			var v170: map<int, int> := map[v95 := |v169|];
			var v171 := DC7(p0, p0, [p1, p1, fm8(v170, p0, p0, globalState), v159, p1]);
			v99[543] := fm7(v171.cf14, true, globalState);
		}
		var i9 := 0;
		while (p0)
			decreases 100 - i9
		{
			...
			globalState.f14, v173, globalState.f1, v95 := v172.f41 / -|(v175 * v175)|, v173, v97 <= (v97 * v97), -v172.f41;
			var v176: array<int> := new int[6] [v172.f42, v95 + 622, fm2(v92, v93, v94, true, globalState), v172.f42, v95, -((if (p0 in v97) then v97[p0] else v172.f41) % 260)];
			v176[693] := v95;
			v176[693] := v172.f42;
			var v177 := DC21(if (p0) then p0 else p0, p0, -v95);
			v177 := DC21(p0, v97 != v97, v176[693]);
		}
		r0 := -604 / v95;
	}
	method m13(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := -p0 to |v1| {
			...
			if (v0) {
				...
				var v9: map<bool, int> := map[v8 !! multiset{p0, p0} := 619 % i0];
				var v10: array<string> := new string[13];
				var v11: array<bool> := new bool[4];
				v11[368] := fm4(globalState);
				v11[346] := !v0;
				var v13: map<string, bool> := map[v2 := v0];
				var v14: seq<set<bool>> := [v1, v1];
				var v15 := 'e';
				var v16: map<bool, char> := map[v0 := v15];
				var v17: set<set<bool>> := {v1, v1, v1, {v0}, v14[fm2(v2[p0 := v15], v1, v16, true, globalState)]};
				var v18: seq<set<set<bool>>> := [v17, {v1}];
				var v19 := DC21(v0, v0, i0);
				var v20: seq<bool> := [v0, v0, !v19.cf33];
				var v21: seq<map<bool, char>> := [map[v0 := v15]];
				v9, v10, v11[368], v2, v11[346] := fm30(i0, map v12 : string | v12 in v13 :: (v12) := (v0), globalState), if (v0) then v10 else if (v0) then v10 else v10, v17 > v18[p0], (if (v0) then v2 else v2) + (v2[i0 := v15] + v2), v20[fm2(v2, v1, v21[i0], v20[|(seq(-0x4d, i1  => (i0)))|], globalState)];
				var v22: map<char, int> := map[v15 := i0];
				var v23: C1 := new C1(|v2|, p0 * |(v22[v15 := -p0])[v15 := i0]|, fm20(v0, v11[368], -p0, v4, globalState));
				v23 := v23;
				var v24 := new C1(-0x3d0, i0, f28);
				globalState.f14 := (i0 / v24.f42) % p0;
				globalState.f27, globalState.f11, v23.f42, globalState.f27 := v11[368], fm4(globalState), v23.f42, v0;
			} else {
				globalState.f0 := i0;
				globalState.f1 := v0;
				...
				var v27 := new C2(v26, {v25[v3[p0]], !v0}, f28);
			}
			
		}
		var v28: array<int> := new int[23](i2 => i2 / -0xd9);
		v28[776] := 0x5b;
		...
		v28[776], v31[287], globalState.f19, v32 := p0, if (v0) then v30 * v30 else v30 + v30, p0, v32;
		var v33 := 'g';
		var v34 := "bxqeqvw";
		...
		for i4 := fm2("gcni", v1, map[v0 := v33], v0, globalState) to fm2(v34, v1, v35, fm4(globalState), globalState) {
			...
			match (DC4(p0 % |v39|, v0)) {
				case DC4(cf5, cf6) =>
					globalState.f14, v34 := v28[776], v34;
					var v40: map<string, bool> := map["dqrd" := cf6];
					var v41 := new C1(cf5 % |v40|, p0, f28);
					r0 := cf6;
					globalState.f19 := -(cf5 / (0x2b0 + cf5));
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					v29[825] := v36[-0x353];
					var v42: C0 := new C0({false});
					var v43: seq<C0> := [v42, v42];
					var v44: array<map<bool, int>> := new map<bool, int>[22] [v38, v38 + v38, v38 + v38, map[cf10 := cf9], v38, v38, v38, v38, v38, v38 + v38, v38, v38, v38, v38, v38, map[cf11 := |v43|] + v38, v38, v38, v38, v38 + v38, v38[!v0 := v28[776]] + v38, map[cf8 := i4] + v38];
					var v45: map<bool, string> := map[cf7 := seq(397, i5  => ('a'))];
					var v46: multiset<bool> := multiset{v0, v0, cf11};
					v29[825], v44, v45, globalState.f11, globalState.f1 := (multiset{cf10} + v46) !! multiset(v36), v44, v45, cf7, false;
					cf11 := fm7(i4 in v39, cf11, globalState);
					var v47: map<string, seq<bool>> := map[v34 := v36];
					v47 := v47[v34 := v36];
					v29[825] := cf11;
				case DC3(cf4) =>
					globalState.f27 := !v36[p0];
					var v48: array<array<int>> := new array<int>[9];
					v48[76] := v28;
					v48[76] := new int[16];
					globalState.f19 := fm2(v34 + v34, v1, v35, v28[776] < p0, globalState);
					var v49: set<int> := {p0};
					var v50: seq<set<int>> := [v49];
					var v51 := DC14(v50);
					var v52: array<set<array<int>>> := new set<array<int>>[14];
					var v53: set<array<int>> := {v48[76], v48[76]};
					v52[960] := v53;
					var v54: multiset<set<int>> := multiset{v49};
					var v55: map<int, set<int>> := map[v28[776] := v49];
					var v56: seq<int> := [p0, i4];
					v51, globalState.f11, v52[960], globalState.f24 := v51, if (v0) then cf4 else i4 > v28[776], v53 - v53, |((if (v0) then v54[if (v28[776] in v55) then v55[v28[776]] else v49 := i4] else v54) * (v54 * fm31(v37.fm17(v56, v28[776], globalState), -p0, cf4, fm4(globalState), globalState)))|;
			}
		...
		if (v0) {
			...
			var v58: map<seq<bool>, int> := map[v57 := v28[776]];
			var v59 := new C2(v58, v1 * v1, f28);
			match (fm32(map v60 : int | (0x357 <= v60) && (v60 < -0x94) :: (v60 - |(seq(698, i6  => (v33)))|) := (map[v0 := v28[776]]), globalState)) {
				case DC1(cf1) =>
				...
				case DC2(cf2, cf3) =>
					...
					v34, globalState.f27, globalState.f19, globalState.f14 := v34 + ("jjrs")[v28[776] := v33], !!(v34 < v34), cf3, p0;
				...
				case DC0(cf0) =>
					...
					globalState.f0 := (if (v0) then p0 else fm2(v34, v59.f40, (fm18(v0, v0, globalState))[v0 := v33], fm4(globalState), globalState)) % |v66[v28[776] := v59.fm17(v67, p0, globalState)]|;
					globalState.f24 := fm2(seq(0x366, i7  => (v33)), if (v0) then v59.f40 else v59.f40, v35, v0, globalState);
			}
			...
			v29[308] := v0;
			var v71: seq<int> := [p0];
			v28[776], v29[308] := -|v71|, !v0;
			var v72: seq<bool> := [!v29[308]];
			var v73: multiset<seq<bool>> := multiset{v72, [v0, v0]};
			v0, v73, globalState.f27 := v0, v73 + v73, v72 != v72;
			v28[776] := if (-p0 < v28[776]) then v28[776] / |multiset{v29[308]}| else if (v0) then p0 else 0x309;
			var v74: array<bool> := new bool[23];
			m0(v74, v28, v28[776], v28[776], globalState);
			globalState.f0 := |v34|;
		}
		
		globalState.f24 := p0;
		v28[776] := (p0 % v28[776]) / |[v0]|;
		r0 := v0;
	}
	method m14(p0: map<char, bool>, globalState: GlobalState) returns (r0: multiset<string>, r1: int, r2: multiset<int>, r3: int) {
		var v0: array<int> := new int[5](i0 => i0 / -0x33c);
		var v1 := 127;
		var v2: seq<int> := [v1, -v1];
		v0 := new int[4] [v1, v2[v1], v1, v1 % v1];
		var v3 := false;
		if (v3) {
			var v4 := new C1(v1 % 662, v1, f28);
			var v5 := "hmjt";
			...
			if (!(fm2(v5, v7[v4.f41], v9, v3, globalState) in (if (v10 in v11) then v11[v10] else v12))) {
				...
				var v18: map<seq<int>, array<bool>> := map[[-(if (v3 in v14) then v14[v3] else v4.f42), v1, |v16[v15 := 0x35]|, |[v1]|] := v17];
				v18 := v18[seq(0x3d4, i2  => (|v2|)) := v17];
				v15 := v15;
				var v19: map<array<bool>, int> := map[v17 := v4.f41 + v4.f42];
				var v20: map<int, bool> := map[v1 := !v3];
				globalState.f0, globalState.f20, v2, globalState.f11 := if (v17 in v19) then v19[v17] else v4.f42, v20, v2[v4.f41 := v4.f42], fm4(globalState);
				globalState.f27 := v3;
			} else {
				var v21: map<int, bool> := map[803 := v3];
				var v22: map<bool, int> := map[v3 := v4.f41];
				var v23 := new C1(|fm3(globalState)| / 0x26a, |v21| % -(if (v3 in v22) then v22[v3] else v1), DC3(v3));
				var v24 := 'h';
				v24 := 'y';
				var v25: array<string> := new string[8] [v5, (seq(0x1f2, i3  => (v24))) + v5, v5 + v5, v5[-v1 := v24] + v5, v5, v5 + v5, v5, v5];
				v25[953] := v5;
				var v26: map<int, string> := map[v4.f42 := v5];
				v25[953] := (if (|v5| in v26) then v26[|v5|] else "nbvq") + fm3(globalState);
				v3 := !(v24 !in v5);
			...
			var v38: map<int, array<bool>> := map[v0[320] := v37];
			var v39: map<int, int> := map[|v38| := v0[320]];
			var v40: map<set<bool>, map<int, int>> := map[v36 := v39];
			var v41 := DC31(v40);
			v40 := v40 + v41.cf56;
			v3 := v35 < (v35 + (seq(-0x32b, i5  => ('x'))));
			if (!(v3 ==> v3)) {
				v37[462] := true;
				var v42: set<array<bool>> := {v37, v37, v37};
				v37[462], globalState.f24, v35 := v3, -|v42|, v35;
				var v43: array<bool> := new bool[24];
				var v44: multiset<array<bool>> := multiset{v43, v43, if (v3) then v43 else v43, v43};
				v0[320], v0[320], globalState.f1 := if (v43 in v44) then v44[v43] else v1, --(if (v37[462]) then v0[320] else v0[320]), v3;
				globalState.f27 := v3;
				var v45: array<array<bool>> := new array<bool>[15];
				v45[392] := v43;
				var v46: array<seq<D4>> := new seq<D4>[19];
				var v47: seq<array<seq<D4>>> := [v46];
				var v48: array<array<seq<D4>>> := new array<seq<D4>>[27] [v46, v46, v46, v46, v46, v46, v46, v46, v46, v47[v0[320]], v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46];
				v48[431] := v46;
				globalState.f11, globalState.f19, v45[392], v48[431], globalState.f0 := !(v37[462] && v3), v0[320], v43, v46, -(v1 / -683);
				globalState.f24 := v1;
			} else {
				var v50: seq<bool> := [v3, v3];
				var v52 := new C2(map v49 : seq<bool> | v49 in (set v51 : seq<bool> | v51 in {v50} :: (v51)) :: (v49) := (|map[v0[320] := 'q']|), v36 + {v3}, DC3(v3));
				v37 := v37;
				var v53 := 'q';
		...
		r1 := v1 - (fm2(v57, v61.f40, v65, if (v3 in v66) then v66[v3] else if (v3 in v66) then v66[v3] else true, globalState) / v1);
...
class C4 {
	...
	method m12(p0: char, p1: bool, p2: set<map<bool, bool>>, p3: array<int>, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		var v7: array<array<int>> := new array<int>[23] [p3, p3, p3, p3, p3, p3, p3, p3, p3, v0[v1], p3, p3, p3, p3, if (v3 in v6) then v6[v3] else p3, p3, p3, p3, p3, p3, p3, p3, p3];
		v7[582] := p3;
		v7[582] := p3;
		var v8: set<bool> := {f37, f37, p1};
		var v9 := new C0(v8);
		var v10: map<string, bool> := map[v2 := true];
		var v12: seq<string> := [seq(0xa5, i0  => (p0)), seq(144, i1  => (p0)), v2];
		...
		match (DC13(v18)) {
			case DC11(cf20) =>
				...
				v19[731] := !({-v1, v1, |{|v20|, v1, v1}|, fm2(v2, v21[v1], map[f37 := p0], p1, globalState)} !! v14);
				var v22: array<seq<int>> := new seq<int>[18](i2 => v3);
				var v23: map<bool, char> := map[!v19[731] := p0];
				v7[582][311] := fm2("fcvvufh", v8, v23, v19[731], globalState);
				var v24 := DC32(v22);
				v2, v22, v19, v7[582][311] := v2 + v2, v24.cf57, v19, --v1;
				var v25: array<array<bool>> := new array<bool>[15];
				v25[248] := v19;
				var v26 := DC16(p1, v19[731]);
				v25[248] := new bool[13] [p1, f37, v19[731], p1, v1 == v1, v19[731], !v26.cf26, f37, p1, v7[582][311] == v1, v5.cf16, p1, true];
				var v27 := new C0({!f37, v19[731]});
			case DC12(cf21, cf22) =>
				v2 := v2 + v2;
				var v28 := DC3(p1);
				var v29 := new C3(v28);
				...
				v30[877] := p1 <== false;
				v30[877] := !((|(set v31 : int | (-687 <= v31) && (v31 < -0x364) :: (v31 + v1))| % 0x34d) == (|map[f37 := 160]| - v1));
				if (v30[877]) {
					var v32 := new C1(v1, v1, v28);
					var v33: seq<bool> := [cf21, !v30[877], f37];
					var v34: seq<seq<bool>> := [v33];
					var v35 := DC6(v30);
					var v36: set<D2> := {v35};
					var v37: map<seq<bool>, bool> := map[v34[v1] := v36 > {v35, v35, v35}];
					v37 := v37;
					var v38: map<int, array<bool>> := map[v32.f41 := v30];
					var v39: seq<array<bool>> := [v30];
					v14, v30[877] := v14, v32.fm7(p1, |DC33(v38[896 := v39[v1]]).cf58| > v32.f41, globalState);
					var v40: map<array<bool>, int> := map[DC6(v30).cf12 := v32.f42];
					v1 := if (v30 in v40) then v40[v30] else v32.f41;
					f38[657] := ("loet")[|[f37, cf21]| := p0];
					f38[657] := fm3(globalState);
				} else {
					...
					var v43: multiset<array<int>> := multiset{v7[582], p3};
					var v44: array<array<bool>> := new array<bool>[17] [v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v42[-|v43|], v30, v30, v30];
					v44 := v44;
			...
			case DC10(cf19) =>
				...
				var v52 := new C1(0x34c, v1 % (if (v1 in v46) then v46[v1] else v1), DC3(f37));
				v2 := v2[v52.f42 := p0];
			...
			case DC13(cf23) =>
				...
				match (v55) {
					case DC18(cf29) =>
						...
						v57 := v57;
						v4 := v4[-(|v14| % v1) := fm4(globalState) && !true];
						v56[467] := p1;
				...
				match (v64) {
					case DC4(cf5, cf6) =>
						...
						var v72: array<multiset<int>> := new multiset<int>[12] [v69, v69, v69, v69, v69[v7[582][676] := cf5], multiset{cf5, v7[582][676]}, v69, v69, multiset{v7[582][676], fm2(v2, fm24([f37, cf6, f37, true], cf6, globalState), v70, p1, globalState)}, v69, v69 + v69, if (f37 in v71) then v71[f37] else v69];
						v72[691] := v69;
						var v74: multiset<map<bool, int>> := multiset{v67};
						v65[506], v3, v72[691] := map v73 : map<bool, int> | v73 in (v74 + v74) :: (v73) := (cf5 == cf5), seq(0x87, i6  => (|(seq(-0x272, i7  => (p0)))[0x30c := p0]|)), v69 * (v69 + v69);
						var v75: array<bool> := new bool[21];
						v75[906] := f37;
						var v76 := DC20(cf5, |(map[cf6 := |v3|])[true := v7[582][676]]|);
						globalState.f27, globalState.f24, v75[906], v7[582][676], f38 := (if (f37) then p1 else cf6) ==> cf6, v76.cf31 / 0x293, fm4(globalState), cf5, f38;
					case DC5(cf7, cf8, cf9, cf10, cf11) =>
						var v77: array<bool> := new bool[28](i8 => cf10);
						v77[801] := if (-v7[582][676] in v4) then v4[-v7[582][676]] else false;
						var v78: seq<bool> := [cf7];
						var v79 := DC3(p1);
						var v80: C2 := new C2(map[v78 := 834], v9.f43, v79);
						var v81: map<C2, bool> := map[v80 := !f37];
						globalState.f27, v77[801], cf7, v81 := !cf8, !f37, 0xa7 == (cf9 % v7[582][676]), v81 + v81;
						globalState.f24 := v7[582][676];
						...
						v77[801], globalState.f11, globalState.f14, cf10 := !((v1 / |v78|) <= v1), |v83| !in (v3 + v3), fm2(v2 + DC7(cf11, f37, v2[v7[582][676] := p0]).cf15, v9.f43, if (cf11) then if (|(map v86 : int | (0x231 <= v86) && (v86 < 0x105) :: (v86 * v7[582][676]) := (cf9))| in v85) then v85[|(map v86 : int | (0x231 <= v86) && (v86 < 0x105) :: (v86 * v7[582][676]) := (cf9))|] else map[p1 := p0] else v84, v77[801], globalState), cf7;
					...
					case DC3(cf4) =>
						...
						var v90: array<array<bool>> := new array<bool>[20] [v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v89[v7[582][676]], v88, v88, if (p1) then v88 else v88, v88, v88, v88, v88];
						v90[21] := v88;
						v90[21] := v88;
						...
						var v93 := DC3(f37);
						var v94 := new C1(if (p0 in v91) then v91[p0] else |v92|, v7[582][676], v93);
				}
				...
				var v99: map<set<C3>, map<int, bool>> := map[v97 := v98[v1]];
		...
		if (p1) {
			globalState.f14 := v1;
			globalState.f0 := v1;
			var v100: map<array<int>, bool> := map[v7[582] := f37];
			v100 := v100[p3 := p1];
			v7[582] := new int[3](i9 => i9 % 0x350);
			f38[753] := v2;
			f38[753] := v12[|(v2 + fm3(globalState))|];
		} else {
			match (DC3(p1).(cf4 := f37)) {
				case DC4(cf5, cf6) =>
					...
					var v112: array<map<int, string>> := new map<int, string>[20] [v105 + (if (cf5 in v107) then v107[cf5] else v105), v105, v105, v105, map v108 : int | v108 in v3 :: (v108 - v1) := (v2), map[|v109| := v2[cf5 := p0]], map[v1 := v2] + v105, v105, map v110 : int | v110 in v101 :: (v110 - cf5) := (v2), (map v111 : int | (57 <= v111) && (v111 < 0x2fa) :: (v111 + |v2|) := (v2))[|multiset([p0, p0])| := v2], v105, v105, (map[v1 := "sf"])[0x33 := "st"], v105, v105, v105, v105, v105, if (p1) then v105 else v105, v105 + v105];
					v112[691] := (map v113 : int | (977 <= v113) && (v113 < 0x331) :: (v113 + cf5) := (v2)) + map[v1 := v2];
					var v114: map<seq<bool>, map<int, string>> := map[v102 := v105[0x92 := v2]];
					v112[691] := fm35(multiset(v3), |v2|, |[v3[cf5]]|, cf5, globalState) + (if (v102 in v114) then v114[v102] else v105);
					var v115 := DC3(v102[|v3|]);
					var v116 := new C1(v1 % DC34(false, -|v3|).cf60, -(v1 - cf5), v115);
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					var v117: seq<bool> := [cf11, true];
					var v118 := DC25(p3, cf8, v117, cf9);
					var v119: array<seq<bool>> := new seq<bool>[24] [v117, v117, v117, v117, v117, v117, v117, v117, v117[0x80 := f37], v117 + v117, v117, (v117 + v117)[|v2| := !cf11], v117, ([cf11])[11 := !p1], v117, v118.cf41, v117 + v117, v117, v117, [p1] + [cf10], v117, v117, v117, fm0(p1, globalState)];
					v119[208] := v117;
					v119[208] := v117;
					var v120 := DC3(cf10);
					var v121 := new C3(v120);
					var v122: array<multiset<char>> := new multiset<char>[27](i10 => multiset{p0});
					var v123: map<array<multiset<char>>, seq<int>> := map[v122 := (seq(0x21c, i11  => (v1))) + [cf9]];
					var v124: map<char, string> := map[p0 := "jytuxwrx"];
					v123 := v123[v122 := [|(if (p0 in v124) then v124[p0] else seq(702, i12  => (p0)))|]];
					var v125 := DC34(cf8, |v2|);
					v10 := map["qocqs" := cf10 && (v125.(cf60 := v1)).cf59];
				case DC3(cf4) =>
					r0 := p1 && (if (-v1 in v4) then v4[-v1] else cf4);
					var v126: multiset<string> := multiset{(seq(0x39d, i13  => (p0))) + v2, if (p1) then v2 else v2, fm3(globalState), v2, "wrpsv"};
					v126 := v126;
					globalState.f24 := (v1 % v1) + |v9.f43|;
					var v127 := 'r';
					...
					v132[615] := v133 <= multiset{v1};
					var v134: seq<bool> := [cf4, f37 || !false, p1, p1, cf4];
					v127, globalState.f11, v132[615] := v127, (seq(330, i14  => ('h'))) < (seq(0xbc, i15  => (p0))), v134[v1];
			}
		...
		r1 := match fm36(globalState) {
			case DC23(cf37) => seq(-0x1dc, i16  => (p0))
		};
	}
}
...
class C5 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		...
		if (f36) {
			...
			var v3: seq<int> := [-v2[f35], -v0.f41];
			var v4: array<seq<int>> := new seq<int>[9];
			var v5 := DC32(v4);
			var v6: map<D14, int> := map[v5 := v0.f42];
			var v7: multiset<int> := multiset{f35, f35};
			var v8: array<int> := new int[23] [v0.f41, |v1|, |v1[v0.f42 := f36]|, f35, 0x14e, v0.f42, v2[-v0.f42], v0.f41, v0.f42, -v0.f41, v0.f42, |v6|, v0.f41, 0x18f, -f35, v0.f41, v0.f41, v0.f42, -v0.f41, v0.f42, -|v7|, --v0.f41, v0.f41];
			var v9: multiset<array<int>> := multiset{v8, v8};
			globalState.f14 := |v9|;
			var v10 := 'k';
			var v11 := "jkw";
			var v12: map<int, string> := map[v0.f41 := v11];
			var v13: array<string> := new string[17] [(fm3(globalState))[f35 := v10], v11, if (fm2(v11, {!v0.fm7(f36, f36, globalState), f36}, map[f36 := v10], !f36, globalState) in v12) then v12[fm2(v11, {!v0.fm7(f36, f36, globalState), f36}, map[f36 := v10], !f36, globalState)] else v11, v11[f35 := v10], seq(742, i0  => (v10)), fm3(globalState), v11, v11, v11, seq(0x382, i1  => (v10)), v11, "wgehews", seq(-0x2e, i2  => (v10)), "eagkks", v11, v11, fm3(globalState)];
			...
			v15 := v15[v0.f41 + |v16| := fm2(v11, {v14.f37, v14.f37}, v17, v1[v0.f41], globalState)];
			...
			v18[86] := f36;
			var v19 := "wxdpojc";
			var v20: set<bool> := {!v18[86], v18[86], v18[86]};
			var v21 := 'o';
			var v22: map<bool, char> := map[f36 := v21];
			var v23: map<string, bool> := map[v19 := v18[86]];
			var v24: array<int> := new int[28] [f35, f35, -v0.f41, v0.f41, -(if (f36) then v0.f42 else 0x3e3), fm2(v19, v20, v22, f36, globalState) % v0.f42, v0.f41, v0.f42, v0.f42, v0.f42 % v0.f42, v0.f41, v0.f41 % v0.f42, f35, v0.f41, -|"jrdrde"|, v0.f42 / v0.f41, v0.f42 - |v23|, v0.f42, fm2(v19, v20, v22, f36, globalState), -v0.f42, v0.f42, v0.f42, v0.f42 % v0.f41, 264, if (f36) then -590 else v0.f42, 977, if (f36) then fm2(v19, v20, v22, f36, globalState) else 0x339, -(fm2(v19[v0.f42 := v21], v20, v22, v18[86], globalState) % v0.f41)];
			v24[866] := v0.f42;
			var v25: seq<int> := [|multiset{v18[86]}|, v0.f41];
			var v26: map<bool, int> := map[f36 := |v25|];
			var v27 := DC2(v0.f42, if (v18[86] in v26) then v26[v18[86]] else v0.f41);
			v24[866] := (v27.cf3 % f35) - |fm24([v18[86]], v18[86], globalState)|;
			var v28: array<D3> := new D3[12];
			var v29: set<int> := {v0.f41 / |v25|, v24[866], v24[866]};
			var v30: seq<bool> := [!v18[86], v18[86]];
			var v31: map<set<int>, int> := map[v29 := v0.f42];
			var v32: map<int, int> := map[|v30[|v30| := f36]| := |v31|];
			var v33: map<set<bool>, map<int, int>> := map[v20 := v32];
			var v34 := DC31(v33);
			globalState.f27, v28, v29, v34, v18[86] := v0.f42 >= (|v19| + |(seq(0x2a2, i3  => (v21)))|), v28, v29 - (set v35 : int | v35 in v29 :: (v35 % |{|{0x2f1}|}|)), v34.(cf56 := v33 + map[v20 := v32]), f36;
			...
			decreases 100 - i4
		{
			...
			var v38: array<int> := new int[9](i5 => i5 / v0.f41);
			v38[708] := v0.f41;
			v38[708] := v0.f42;
			v38 := v38;
			if (f36) {
				...
				var v43 := new C2(map[v41 := v38[708]], v42 + v42, f28);
				...
				globalState.f0 := v0.f41 / (if (f35 in v47) then v47[f35] else v38[708]);
				var v48: seq<bool> := [f36];
				var v49: map<seq<bool>, bool> := map[v48 := f36];
				v49 := v49;
				globalState.f24 := v38[708];
				var v50: array<D4> := new D4[5];
				globalState.f1, r1, v50 := !f36, fm3(globalState), if (f36) then v50 else v50;
				var v51: seq<int> := [626, --v38[708]];
				globalState.f11, globalState.f11, globalState.f0, v0.f42, v0.f42 := fm7(true, if (f36) then f36 else f36, globalState), false, v51[v0.f41], 0x266, -181;
			}
			...
			decreases 100 - i6
		{
			...
			v56[253] := |multiset{--v0.f42, v0.f42, f35, v0.f41, f35}|;
			var v57: map<array<int>, bool> := map[v56 := f36];
			var v58: map<int, bool> := map[v0.f41 := f36];
			v56[253] := |v57| + |[map[|(seq(0x208, i7  => (v52)))| := false], v58]|;
	...
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		for i0 := f35 to f35 {
			...
			var v1: array<bool> := new bool[7] [f36, !f36, p0, f36, f36, p0, v0[f35]];
			...
			match (v3) {
				case DC34(cf59, cf60) =>
					...
					var v16: array<string> := new string[23] ["kogvc" + v7, v7, seq(-0x353, i1  => (p1)), v7 + v7, v7[i0 := p1], v8[cf60], v7, v7, seq(0x236, i2  => ('c')), v7, (if (i0 in v15) then v15[i0] else v7) + fm3(globalState), v7, v7[-i0 := p1], v7 + "qdvhe", "sksexkses", if (p0) then v7 else fm3(globalState), v7, v7, v7, v7 + v7, seq(0x1cf, i3  => (p1)), v7[cf60 := p1] + v7, v7];
					var v17 := 'e';
					v6, v16, v2, v17, v4 := [[false, fm4(globalState), cf59, fm4(globalState)]], v16, v2, if (f36) then v17 else v17, v4 + (if (p0) then v4 else ([cf60])[i0 := 0x127]);
				...
				case DC33(cf58) =>
					...
					var v20: set<bool> := {p0};
					globalState.f11, r0, v19, r0, globalState.f27 := 0x355 >= |fm25(f35, f36, v0, i0, globalState)|, i0, v19, -|v20| % 0x17e, (f35 % 987) >= i0;
					globalState.f11 := p0;
					globalState.f11 := !v19.f37;
			}
			
			v0 := v0[|(seq(0x3c5, i4  => (seq(0x2dd, i5  => (|"occ"|)))))| := f36];
		...
		for i6 := 0x25 to f35 {
			...
			globalState.f0 := if ((seq(0x3a6, i7  => ({f35}))) in v24) then v24[seq(0x3a6, i7  => ({f35}))] else f35;
			...
			if (v25 == v25) {
				...
				var v52 := DC27(v51);
				v50[803] := !f36;
				v26[378], globalState.f24, v52, v50[803] := i6, i6, v52, !f36;
				v50[803] := false;
				var v53: multiset<int> := multiset{i6};
				var v54: map<multiset<int>, string> := map[v53 := fm3(globalState)];
				var v55 := "sm";
				var v56: seq<map<multiset<int>, string>> := [v54[multiset{v26[378]} := v55]];
				var v57: seq<bool> := [f36, !v50[803], v50[803]];
				var v58: multiset<seq<bool>> := multiset{v57, v57};
				var v59: map<map<multiset<int>, string>, multiset<seq<bool>>> := map[v56[f35] := v58];
				var v61: seq<multiset<int>> := [v53];
				v59 := v59[map v60 : multiset<int> | v60 in v61 :: (v60) := ("kaxulpph") := v58 - v58];
				var v62: map<bool, int> := map[p0 := f35];
				v62 := v62[p0 := -(i6 + v26[378])];
			}
			
		}
		for i8 := f35 to f35 + f35 {
			var v63: seq<bool> := [f36, p0];
			globalState.f24 := |(v63 + (v63 + v63))[f35 := false]|;
			if (!p0) {
				var v64: map<int, bool> := map[|v63| := v63[f35]];
				globalState.f20 := v64;
				r0 := i8 - i8;
				globalState.f1 := p0;
				var v65: array<int> := new int[6] [i8, i8, f35, i8, i8, |(seq(0x33, i9  => (i8)))|];
				v65[376] := f35;
				v65[376] := |((v63 + fm0(f36, globalState)) + [p0])|;
				var v66 := "bccnilcqs";
				var v67: multiset<string> := multiset{(seq(0x2c0, i10  => (p1))) + v66[f35 := fm5(0x272, p0, globalState)], "sdc", v66, v66, fm3(globalState)};
				v67 := v67;
			} else {
				globalState.f1 := p0;
				var v68 := "sysqjqqk";
				...
				var v75: map<multiset<bool>, bool> := map[v71[f36 := |v74|] := f36 && p0];
				var v76 := DC38(v71);
				v75 := v75[v76.cf68[v63[i8] := i8] := f36];
				globalState.f19 := f35;
		...
		var v83: array<int> := new int[19](i12 => i12 / f35);
	...
	method m11(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: seq<bool>, r3: int) {
		...
		v0[997], globalState.f1, v1, v1, r3 := false, fm7(true, false, globalState), v1 + v1, "qbhxkruxg", v2[p1];
		var v3: map<string, int> := map[v1 := f35];
		var v4 := new C1(f35 * |v3|, f35, f28);
		var v5: C3 := new C3(f28);
		var v6: seq<C3> := [v5];
		v5 := v6[v4.f42];
		var v7: set<bool> := {v0[997], true, v0[997]};
		var v8: multiset<set<bool>> := multiset{v7, v7};
		v8 := v8[v7 := v4.f41] - multiset{v7, v7};
		...
		var v9: seq<bool> := [f36, p0, p0, v0[997], p2];
		r2 := v9 + [p2, f36];
		var v10 := 'v';
		var v11: map<string, bool> := map[v1[f35 := v10] := false];
		var v12: multiset<map<bool, int>> := multiset{fm30(|[v0[997], v0[997], p0, p0, p0]|, v11, globalState)};
		var v13: map<bool, int> := map[f36 := v4.f42];
		r3 := |((seq(0x109, i1  => ('o'))) + v1[v4.f42 := v10])| % (f35 % (if (v13 in v12) then v12[v13] else p1));
	}
}
...
class C6 {
	...
	function fm16(p0: set<bool>, p1: int, globalState: GlobalState): bool {
		(if (true) then -0x36f else 0x338) <= (f34 % 0x1ec)
	}
	method m9(globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := f34 to fm2(v0, v2, map[true := v3], !v1, globalState) + f34 {
			...
			v7 := v7;
			if (v1) {
				var v8: array<int> := new int[20](i1 => i1 / |map[v1 := v1]|);
				...
				v9[326] := v11;
				v9[326] := v11;
				globalState.f16 := ([v1, v1, true] + v6)[if (v1) then i0 else fm2(v0, v2, map[v1 := v3], true, globalState) := true];
				var v12 := DC10(v3);
				...
				globalState.f0 := |v0|;
				globalState.f27 := (seq(0x3b3, i3  => ('c'))) <= "q";
				var v21: seq<int> := [f34, i0];
				globalState.f0 := v21[-853] / f34;
				globalState.f1 := f34 > i0;
				var v22: array<bool> := new bool[28];
				v22[761] := fm16(v2, i0, globalState);
				var v23: multiset<array<bool>> := multiset{if (v1) then v22 else v22, v22, v22};
				var v24: map<bool, char> := map[v1 := v3];
				globalState.f24, globalState.f11, globalState.f1, v22[761], v23 := fm2(v0, v2, v24, v1, globalState), v1, !!(i0 > f34), (f34 - -58) != (f34 / |v21|), v23;
			}
		...
		v25[783] := v27.f37;
		var v28: seq<bool> := [!v1];
		v25[783] := v27.f37 !in v28;
		v0 := if (if (v1) then false else true) then v0 + v0[f34 := v3] else v0;
		match (DC29(v25[783]).(cf50 := v25[783])) {
			...
			case DC29(cf50) =>
				...
				var v31 := new C0(v30[f34]);
				var v32: map<bool, char> := map[v1 := v3];
				globalState.f0 := fm2(seq(0x5e, i5  => (v3)), v2, v32, v25[783], globalState);
			case DC30(cf51, cf52, cf53, cf54, cf55) =>
				var v33 := new C1(f34 / |v28|, cf54, DC3(!v28[f34]));
				var v34 := DC3(v25[783]);
				match (v34) {
					case DC4(cf5, cf6) =>
						...
						v25[783], v25, globalState.f24, v35 := (seq(0x1e2, i6  => (v3))) != v0, v25, fm2(v36[v33.f41], v2, v37, v27.f37 <== (if (cf53 in v38) then v38[cf53] else cf52), globalState), v35;
						var v39: seq<int> := [cf5 * cf54, v33.f41 / v33.f42, cf5, fm2(seq(892, i7  => (v3)), {false}, v37, v27.f37, globalState) - |v0|];
						v35[959] := v33.f42;
						var v40: map<bool, seq<int>> := map[cf51 := v39];
						v39, globalState.f19, v35[959], v0, v25[783] := fm6(fm4(globalState), 37, seq(0x2bb, i8  => ('t')), globalState), (f34 % cf54) * v33.f41, |v40|, v0, v25[783];
						var v41: multiset<int> := multiset{f34};
						var v42: map<int, int> := map[v33.f41 := |DC48(v41).cf89|];
						globalState.f0 := (|v42| % v33.f42) % |fm3(globalState)|;
						v35[959] := v35[959];
					case DC5(cf7, cf8, cf9, cf10, cf11) =>
						...
						v44, globalState.f0, v47[509] := v44 + v44, |(map v48 : int | v48 in v49 :: (v48 / |v0|) := (cf7))| + |v28|, 986;
						var v50: C3 := new C3(v34);
						var v51: set<C3> := {v50, v50, v50, v50, v50};
						cf10, cf52, v3, globalState.f19, v51 := |v0| <= (cf54 / cf54), (cf52 || cf51) <== v25[783], if (cf51) then v3 else if (true) then v3 else v3, if (cf53) then fm2(fm3(globalState), {v1}, map[cf51 := v3], v25[783], globalState) else v33.f42, v51;
						v33.f42 := v33.f42;
					case DC3(cf4) =>
						...
						v53[803] := if (v27.f37) then |v54| else v33.f42;
						cf51, v53[803], globalState.f24, globalState.f27, v3 := ("dgm" + v0) == (v0 + v0), f34, v33.f42, cf4, if (v1) then v3 else v3;
						v53[803] := -56;
				}
				
				globalState.f0 := v33.f41;
				globalState.f11 := v25[783] ==> v27.f37;
			case DC27(cf44) =>
				...
				var v58 := DC37(v28, seq(792, i9  => (v3)), v3);
				var v59: map<char, D16> := map[v3 := v58];
				v55[529] := v57[v1 := v59];
				var v60: seq<seq<char>> := [v0, [v3, 'p']];
				var v62: map<char, bool> := map[v3 := v27.f37];
				v55[529], v3, globalState.f24, v60 := v57 + v57[false := map v61 : char | v61 in v62 :: (v61) := (v58)], v0[f34 / f34], f34, v60 + v60;
				var v63: seq<int> := [f34];
				globalState.f24 := v63[f34];
				globalState.f19 := -(-f34 * f34);
				var v64: map<int, bool> := map[f34 := v25[783]];
				v64 := v64[v63[0x17a] := v28[--0x2b8]];
		}
		
		var v65: map<bool, char> := map[v27.f37 := 'x'];
		r0 := fm2(seq(0x1ee, i10  => (v3)), v2, v65, v25[783], globalState) != f34;
	}
	method m10(p0: map<bool, bool>, p1: int, p2: bool, globalState: GlobalState) {
		...
		var v11: multiset<string> := multiset{v0[f34 := v2]};
		var v12: seq<int> := [f34, p1, p1];
		var v13: array<int> := new int[29] [fm2(v0, v1, v3, p2, globalState), p1, f34, if (v4 in v5) then v5[v4] else f34, f34, p1, f34 % f34, if (p2) then 0xd2 else -0x29f, |(v6 + v6)|, f34 + p1, f34, |[v4, v4]|, f34, |v7[v2 := f34]|, -fm2(v0, if (p2 in v8) then v8[p2] else v1, v3, p2, globalState), f34, |fm3(globalState)|, 0x3c, p1, p1, -(if (v9 in v10) then v10[v9] else |v0[p1 := v2]|), p1, f34, |v11|, 217, |fm3(globalState)|, |(if (p2) then multiset{p1, p1} else multiset(v12))|, -0x206, -f34 - f34];
		v13[274] := |({f34, f34} + (set v14 : int | (762 <= v14) && (v14 < -0x2fb) :: (v14 - p1)))|;
		var v15: multiset<bool> := multiset{true, p2, p2};
		v13[274] := (if (p2 in v15) then v15[p2] else f34) + f34;
		if ((v13[274] % v13[274]) > (0x67 / p1)) {
			var v16 := DC16(p2, p2);
			...
			v16, v13[274], globalState.f20, v18 := v16.(cf27 := !fm4(globalState)), |(if (false) then multiset{p1, v13[274]} else v20)|, v6, map[v17[v2 := p2] := v0 <= v0];
			...
			var v24: seq<T0> := [v23];
			var v25: seq<bool> := [p2, p2, p2, p2, v9[783]];
			var v26: map<int, char> := map[--|v1| := v2];
			var v27: map<int, map<int, char>> := map[|v25| := v26];
			var v28: seq<T0> := [v24[|(if (|[p2]| in v27) then v27[|[p2]|] else map[v13[274] := 'g'])|], v23, v24[|v0|]];
			if (v28 !in [[v23, v23], v28]) {
				var v29: set<char> := {v2, v2, v2, 'r'};
				var v30 := DC0(v19);
				var v31: map<string, bool> := map[seq(-423, i1  => ('u')) := v9[783]];
				v29 := (v29 + {v23.fm8(v19, p2, p2, globalState)}) * {v23.fm8(v30.cf0, v25[f34], if (v0 in v31) then v31[v0] else p2, globalState), v2};
				var v32: array<set<int>> := new set<int>[2];
				v32[793] := set v33 : int | (0x100 <= v33) && (v33 < 964) :: (v33 / 282);
				var v34: set<int> := {if (p2) then 855 else p1, |v0|};
				v32[793] := v34;
				v2 := v0[|(seq(0xe1, i2  => (v2)))|];
				...
				v35[784] := v2;
				v35[784] := v2;
				var v36: array<bool> := new bool[26](i3 => if (p1 in v6) then v6[p1] else v25[v13[274]]);
				v36 := v36;
			} else {
				var v37 := DC30(p2, v9[783], p2, f34, v9[783]);
				v9[783] := v37.cf51;
				globalState.f11, globalState.f0 := true, |(if (v9[783]) then v0 else v0)| + p1;
				globalState.f27 := p2;
				var v38: map<bool, int> := map[v9[783] := v13[274]];
				v38 := v38[p2 := 226];
				globalState.f1 := !p2;
			}
			...
			globalState.f19 := v13[274] + p1;
			var v41: map<int, int> := map[|p0| := p1];
			var v42: map<bool, map<bool, bool>> := map[p2 := map[p2 := p2]];
			var v43: map<map<int, int>, int> := map[v41[p1 := |v42|] := v13[274]];
			globalState.f14, globalState.f11, v2, globalState.f1, globalState.f1 := (v13[274] - |v12|) / p1, v43 == (v43 + v43), v2, p2, p2;
			globalState.f19 := p1 - v13[274];
			globalState.f0 := v13[274];
			var v44 := DC3(!p2);
		...
		if (p2) {
			...
			var v50 := DC30(p2, !p2, p2, v13[274], p2);
			var v51 := DC34(p2, v50.cf54);
			globalState.f14, v49, globalState.f0, v51 := f34, v49, fm2(v0, v1, v3, p2, globalState), fm38(f34 + p1, p2, p1, v13[274], globalState);
			m0(v48[596], v13, f34, fm2(v0[f34 := v2], v1, map[p2 := v2], p2, globalState), globalState);
			v9[106] := p2;
			v9[106] := !p2;
			...
			globalState.f1, v53, v48[596], v55 := p2, v53, v48[596], v55 + (fm22(false, v13[274], 0xae, globalState) + map[v54 := p1]);
			globalState.f24 := p1 % (p1 / 0x356);
		} else {
			v13[274] := (f34 % |v0|) / p1;
			globalState.f27 := p2;
			v48[596] := v48[596];
...
class C7 extends T0 {
	...
	function fm15(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		811 % (if (true) then 0x102 else |[0x3c1, -0x28c, |"uescm"|]|)
	}
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		var v0 := 0x117;
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			if (!fm7(v1, false, globalState)) {
				...
				var v12: array<int> := new int[9] [|(v11 + v11)|, -v2.f35 * -v2.f35, v0, v0 + -518, v2.f35, |v3| * |v11|, v2.f35 % v2.f35, v2.f35, v0];
				v12[185] := v2.f35;
				...
				var v17: seq<bool> := [v1];
				globalState.f2, v1, v12[185], r1, v13 := v16[|v7| + -v2.f35], v1 && v2.f36, |v17|, v3, v13;
				globalState.f27 := v1;
			} else {
				...
				var v27: array<int> := new int[26] [|v19|, |(set v23 : int | v23 in v22 :: (v23 % -0x24c))|, v0, v0, v0, v0, v0, v0, 0x1cd, v0, -v0, |v24|, v0, v0, v0, |v19|, 0x350, v0, v0, v0, |v25|, v26[v0], v0, 442, v0, v0];
			...
			if (-v0 == v0) {
				...
				var v42 := "hncioyd";
				globalState.f16, globalState.f27, globalState.f12, globalState.f19 := [v1] + v37[if (v38.f34 in v41) then v41[v38.f34] else v38.f34], v1, v36, |(v42 + v42)|;
				var v43: set<bool> := {!v1, v1};
				var v44 := 'g';
				var v45 := DC7(if (v1) then v1 else v1, v42[fm2(fm3(globalState), v43, map[false := v44], v1, globalState)] !in v42, v42);
				var v46: array<int> := new int[27](i4 => i4 * v0);
				v46[859] := v38.f34 - v38.f34;
				v45, globalState.f24, v46[859] := v45, v0 / v38.f34, |v35| / v0;
			...
			var v60: map<int, bool> := map[if (v56[v0] in v58) then v58[v56[v0]] else |(set v59 : int | (0x225 <= v59) && (v59 < 983) :: (v59 + |{v0}|))| := v1];
			var v61: map<char, map<int, bool>> := map[v52 := v60];
			var v62: array<int> := new int[26] [v0, if (v0 in v51) then v51[v0] else v0, v53.cf91 + v0, v0, |v54|, |v55| + DC46(996, v1, v1, v1).cf84, v0, v0, v0, v0 + v0, v0 % |v55|, -v57[v0], v0 % v0, 0x356, v0 - v0, |("jg" + v56)|, -v57[v0], -v0, v0, v0, |(v61 + v61)|, v0, v0, |"rpwmkcsw"|, v0, v0];
			v62[563] := --0x14b / v0;
			v62[563] := v0;
		}
		...
		v67[64] := [v64, v64, v64, v64];
		var v68: seq<bool> := [v64];
		var v69: map<int, seq<bool>> := map[|(seq(885, i5  => ('d')))| := v68];
		var v70: set<int> := {v63[833], v0, |(if (v63[833] in v69) then v69[v63[833]] else v68)|, v63[833]};
		var v71: map<bool, set<int>> := map[v64 := v70];
		v64, v67[64] := fm7((if (true in v71) then v71[true] else v70) > v70, v64, globalState), if (v64) then [v64] else v68;
		var v72: map<bool, int> := map[v64 := -v63[833]];
		var v73 := DC1(|v72|);
		var v74: multiset<int> := multiset{v63[833], v73.cf1};
		if (match DC52(|v74|, v64, false, v63[833], v64) {
			...
			var v77 := "r";
			globalState.f11 := v75 > v76[|v77|];
			var v78: seq<int> := [v0, -|v77|];
			var v79: seq<int> := [v78[v63[833]], v63[833]];
			...
			if (if (v65 !! v65) then v64 else v64) {
				var v85 := "ilwl";
				var v86: seq<int> := [v63[833], -v0, |fm6(!v64, if (v64 in v72) then v72[v64] else v63[833], v85, globalState)|];
				v86 := v86;
				var v87: set<bool> := {v64, v64};
				var v88: T0 := new C2(map[[v64, true, v64, v64, !true] := v63[833]], v87, f28);
				var v89, v90, v91, v92 := m8(-|v67[64]|, v64, -(v86[v63[833]] + |[v64, v64]|), v88, globalState);
				globalState.f11 := |v74| >= |fm6(v67[64][v90], v90, v85, globalState)|;
				var v93: map<map<int, char>, bool> := map[map[v90 := v89] := true];
				v93 := fm39(v90, globalState) + v93;
				var v94: seq<string> := ["ihkanrsjf"];
				var v95 := DC20(fm15(v64, |v68|, |v94[v63[833]]|, globalState), v63[833]);
				v63[833] := v95.cf32;
			} else {
				var v96: set<bool> := {v64, v64, v64, !!v64, fm4(globalState)};
				var v97 := "jj";
				var v98: seq<int> := [|v97|];
				v63 := new int[25] [v0, 0x3e3, v63[833], |v96| / -v0, v63[833], v63[833] * v63[833], v63[833], v63[833] * |"qbo"|, 0xe6, v98[|v98|] / v98[v0], v63[833], -0x221, v63[833], v63[833], v63[833], v63[833], v0, if (v64 in v65) then v65[v64] else -0xd0, v63[833], -v63[833], v63[833], v0, -v0, v0 / v63[833], v63[833]];
				var v99 := DC34(v64, v63[833]);
				...
				globalState.f11, globalState.f1, globalState.f11, v100, v0 := !(v0 != (-|(if (v64 in v101) then v101[v64] else v67[64])| + v63[833])), !((v63[833] !in multiset(v98)) ==> false), !(multiset(v98) !! (v74 - v74)), v100, -|v102[v63[833] % v0]|;
				var v103: C6 := new C6(-fm15(v64, 0x11d, v63[833], globalState));
				v103 := v103;
				var v104: array<char> := new char[27];
				var v105: map<array<char>, int> := map[v104 := v63[833]];
				globalState.f0 := (if (v64) then -|v105| else |v97|) % v0;
				globalState.f1 := v64 ==> (v97 != v97);
			}
			
			if (v63[833] != (0x3d4 - v63[833])) {
				var v106 := 'c';
				var v107 := "vllishi";
				var v108: map<int, bool> := map[v63[833] := v64];
				var v109: array<bool> := new bool[12] [v64 || v64, v64, v64, v106 !in v107, v64 <==> !v64, v64, v64, v64, if (v63[833] in v108) then v108[v63[833]] else !true, v64, v64, true];
				v109[184] := v64;
				v109[184] := v107 != v107;
				var v110: map<bool, char> := map[false := v106];
				globalState.f16, globalState.f27, v109[184], v63[833], v106 := v67[64] + v68, v64, v64, -(v0 * fm2(v107, {!v64}, v110, v109[184], globalState)) / 0xb8, v106;
				v106 := v106;
				var v111 := new C6(v63[833]);
				var v112: array<string> := new string[5](i6 => v107);
				var v113 := DC55(v112);
				var v114 := new C4(true, v113.cf104);
			} else {
				var v115 := 'f';
				var v116: map<int, int> := map[if (!v64 in v65) then v65[!v64] else v0 := v63[833]];
				...
				v119 := v119[v64 := v68[|v68|]];
				v63 := new int[14];
			}
			
			var v120: map<int, int> := map[v0 := v0];
			var v122: map<int, char> := map[v0 := fm8(map[v63[833] := v63[833]], v64, v64, globalState)];
			var v123: set<bool> := {v64, false};
			var v124: map<int, bool> := map[0x386 := v64];
			var v125 := DC38(v65);
			var v126: map<bool, bool> := map[v64 := v64];
			var v127: array<bool> := new bool[25] [v64, v64 <==> v64, v64, !v64, v64, v64, false, v120[v0 := |v74|] != (map v121 : int | v121 in v122 :: (v121 / v0) := (v63[833])), v64, v64, !v64, fm4(globalState), !(v64 !in v123), v64, v64, if (-|v125.cf68| in v124) then v124[-|v125.cf68|] else v64, false || v64, v64, !v64, v64, v64, (if (false in v126) then v126[false] else !v64) <==> v64, v64 ==> !!true, (if (v64 in v126) then v126[v64] else v64) ==> v64, v0 < v63[833]];
			v127[609] := v64;
			v127[609] := v64 <== (v63[833] > v63[833]);
			var v128: seq<int> := [v63[833], v0];
			var v129: map<char, seq<int>> := map[fm5(v63[833], v64, globalState) := v128];
			var v130: seq<int> := [|v129|];
			var v131: map<bool, array<bool>> := map[v130 == [|v67[64]|] := v127];
			v131 := v131[v64 := v127];
			globalState.f14 := -v0 * v0;
		}
		
		var v132 := "xxjwsitb";
		var v133: map<int, string> := map[v63[833] := v132];
		v133 := v133[v0 % v63[833] := v132];
		var v134: map<int, bool> := map[v0 := v64];
		var v135: map<int, int> := map[-v63[833] := v0];
		var v136 := new C5(-(v0 / v63[833]), if (v64) then v64 else if ((if (v0 in v135) then v135[v0] else v0) in v134) then v134[if (v0 in v135) then v135[v0] else v0] else v64, f28);
		r0 := DC8(v136.f36, v63);
		var v137: array<bool> := new bool[6] [v136.f36, v64, v136.f36, !v136.f36, v136.f36, v64];
		var v138 := DC6(v137);
		var v139 := DC28(v136.f36, v132, v136.f36, |v74[-v136.f35 := v136.f35]|, v138);
		r1 := (if (v64) then v132 else (fm3(globalState))[v136.f35 := 's']) + v139.cf46;
	}
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		var v0 := -0x245;
		...
		var v9: array<string> := new string[4] ["gpylep", v7 + v8.cf66, v7, seq(0x1bc, i0  => (p1))];
		v6, v9, r0 := fm6(v7 == v7, v0, v7, globalState), v9, v0 % v0;
		...
		match (v10) {
			case DC4(cf5, cf6) =>
				if (false) {
					...
					v7, v7 := v7, v7;
					var v14 := 'w';
					v14, globalState.f14 := v14, (v13.f35 % |v7|) / v11.f35;
				} else {
					var v15: map<bool, int> := map[cf6 := 0x1e5];
					var v16: map<int, int> := map[|[v0, v0]| := cf5];
					globalState.f19 := (if (p0 in v15) then v15[p0] else cf5) % (|v16| + cf5);
					var v17 := new C6(cf5);
					globalState.f24 := 955 / v0;
				...
				var v21 := new C0(v20);
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				var v24: set<int> := {|(set v22 : int | (-136 <= v22) && (v22 < 0xb0) :: (v22 - |(map v23 : int | (-340 <= v23) && (v23 < 432) :: (v23 / |v5|) := (v0))|))|};
				...
				cf7 := (set v27 : set<int> | v27 in v26[cf9] :: (v27)) >= (v28 * v28);
				var v29: array<int> := new int[1] [v0];
				v29 := v29;
				globalState.f1 := (v0 % cf9) >= (v0 / cf9);
	...
	method m8(p0: int, p1: bool, p2: int, p3: T0, globalState: GlobalState) returns (r0: char, r1: int, r2: map<bool, int>, r3: set<string>) {
		...
		var v10 := new C1(fm2(v0, {p1}, map[p1 := 'p'], !false, globalState) + |multiset(v1)|, |(set v5 : set<bool> | v5 in v4.cf114 :: (v5))| / p0, fm20(p1, p1, |v1|, v9, globalState));
		...
		if (v2[p0]) {
			...
			v26[213], v1, v28, globalState.f24 := v29, v30.cf71[|v0[0x118 := v31]| / 0x17c := if (v28 in v32) then v32[v28] else |v33|], v28, if (|v34[[v10.f42] := v21]| >= v39.cf77) then fm2(v0, v35, v36, p1, globalState) else -p2;
		} else {
			v10.f42 := v10.f41;
			...
			var v44: array<int> := new int[20] [v10.f41, -v10.f41, -v10.f41, -390, |v2|, v1[p2], v10.f41, |v0|, v10.f42, v10.f41, v10.f42, p2, if (p0 in v41) then v41[p0] else |v41|, -628, -v10.f41, v10.f42, |v0|, |(map v42 : seq<int> | v42 in v43 :: (v42) := (p1))|, v1[fm15(p1, v10.f41, 0x119, globalState)], |multiset(v1)|];
		...
		var v51: array<string> := new string[25] [v0, v0[p2 := v47], v0, v0, v0, v0, v48.cf15, v0, v0, v0, v0, v0[|v0| := 'l'], v0, v0, v0, seq(-501, i3  => (v47)), v0, v0, "qnmyost", v0, v0[p2 := if (p0 in v49) then v49[p0] else v47], "vahiro", v0, v0, ("hvmyitwy")[|v50| := v47]];
		var v52 := DC55(v51);
		match (v52) {
			case DC56(cf105, cf106, cf107, cf108) =>
				...
				globalState.f14 := fm15("hliohr" < cf105, v10.f42, if (v56[v10.f42] in v54) then v54[v56[v10.f42]] else |v0|, globalState);
				...
				v58[507] := v59;
				v58[507] := v59;
				var v60: map<bool, array<int>> := map[v2[|cf105|] := v53];
				v60 := (map[cf107 := v53])[cf107 := v53] + map[cf108 := v53];
			case DC57(cf109, cf110, cf111, cf112) =>
				globalState.f19 := 0x71;
				globalState.f14 := v1[v10.f41];
				var v61: seq<multiset<set<bool>>> := [v3];
				var v62: array<D23> := new D23[2] [v4, DC59(v61[v10.f41])];
				v62[700] := v4;
				var v63 := DC29(cf112);
				var v64: set<bool> := {p1, cf112};
				v62[700], v47, globalState.f19, v63 := v4, v10.fm8(fm21(v47, globalState), p1, p1 ==> cf112, globalState), fm2(v0 + v0, v64, map[cf112 := cf109], !(if (cf110 in v15) then v15[cf110] else p1), globalState), v63;
				var v65: map<bool, string> := map[!p1 := v0 + v0];
				var v66 := DC45(p2, !cf112);
				var v67: map<D19, array<bool>> := map[v66.(cf83 := !cf112) := v21];
				v65 := v65[DC45(v10.f42, false) in v67 := seq(0xbb, i5  => ('s'))];
			case DC55(cf104) =>
				var v68: array<D0> := new D0[17];
				var v69 := DC1(|v50|);
				v68[999] := v69;
				v68[999] := fm43(globalState);
				...
				globalState.f11, globalState.f1 := p0 > (fm2("pmqxejnad", v70, v71, p1, globalState) % v10.f42), v73 != v73;
				if (v21 !in [v21, v21]) {
					...
					var v80: array<array<seq<D12>>> := new array<seq<D12>>[4] [v78, v78, v79[|v70|], v78];
					v80[573] := v78;
					v80[573] := v78;
			...
			case DC58(cf113) =>
				...
				var v87: array<int> := new int[28] [v10.f41, v10.f41, |(map v83 : int | v83 in v15 :: (v83 * v10.f42) := (p1))|, 0x32, p2, v10.f41, |v50|, v10.f41, v10.f42, v10.f42, v10.f42, p2, |v84|, v10.f41, p0, v10.f42, v10.f41, |v85[v10.f41]|, -p2, |multiset{-150}|, p0, |"qujafgmvo"|, |v1|, |v86|, p0, v10.f42, v10.f42, p0];
...
class C8 {
	...
	method m7(globalState: GlobalState) {
		...
		var v6: array<int> := new int[27](i1 => i1 / f33);
		var v7: map<int, array<int>> := map[v4[|v5|] * f33 := v6];
		var v8: map<bool, bool> := map[v0 := v0];
		var v9: seq<map<bool, bool>> := [map[v0 := v0], v8];
		var v10 := DC5(v0, v0, |v9|, v0, v0);
		var v11: seq<array<int>> := [v6];
		globalState.f19, v7, globalState.f11 := f33 * |map[f33 := v10]|, v7 + (map[f33 := v11[f33]] + v7), v0;
		v6[0] := f33;
		var v12 := DC4(f33, true);
		v6[0] := match v12 {
			case DC4(cf5, cf6) => f33 % -0x15d
		...
		match (v12) {
			case DC4(cf5, cf6) =>
				...
				if (cf5 < |map[v3 := v4[v6[0]]]|) {
					...
					var v17: seq<seq<map<bool, int>>> := [(v16[528 := v15])[0x198 := v15]];
					var v18 := 'p';
					var v19 := DC10(v18);
					var v20: map<bool, char> := map[v0 := (v19.(cf19 := v18)).cf19];
					v13[751] := v16 + ((v17[-fm2("k", v1, v20, cf6, globalState)])[v6[0] := v15])[cf5 := v15];
					var v21: array<string> := new string[8] [v2, v2, v2, v2, v2, v2, v2, v2 + v2];
					v21[588] := v2;
					globalState.f1, v21[588], globalState.f0 := cf6, v2, cf5 - f33;
					v6 := v6;
					var v22 := new C4(!(v18 in v21[588]), v21);
					var v23: map<int, int> := map[cf5 * v6[0] := v6[0]];
					v23 := v23[-(-cf5 - f33) := f33];
				} else {
					var v24 := 't';
					...
					globalState.f19, globalState.f27, v27 := (|map[cf5 := |[|v29|, v6[0], v4[cf5]]|]| + -v4[fm2(v2, v1, v30, v0, globalState)]) % (v6[0] * f33), fm4(globalState), v27;
					v2 := v2 + "ircgj";
					v3[393] := v0;
					...
					v31[834] := v32;
					globalState.f14, v3[393], v31[834], globalState.f11 := 36, !(v4 != ([0x2c3] + (seq(684, i3  => (-0x31))))), v32, cf6;
					globalState.f11 := f33 == f33;
				}
				
				globalState.f14 := |(v2 + (seq(0x13c, i4  => (v2[cf5]))))|;
				var v33 := DC3(v0);
			...
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				...
				var v37: C6 := new C6(v4[|v36|]);
				v37 := v37;
				globalState.f14 := f33;
				globalState.f0 := -((if (!!v0) then v6[0] else f33) - v37.f34);
				var v38: map<int, int> := map[v6[0] := v37.f34];
				var v39 := 'a';
				v6[0] := (v37.f34 % v37.f34) - (|v2[|v38| := v39]| % v6[0]);
			case DC3(cf4) =>
				m0(v3, v6, v6[0], v6[0], globalState);
				var v40: array<string> := new string[15](i5 => v2);
				v40[123] := v2;
				v40[123] := seq(884, i6  => ('r'));
				var v41: multiset<int> := multiset{0x32};
				globalState.f11, globalState.f1 := multiset{f33} > (v41[0x29 := |v4|] * multiset{v6[0], ---v6[0], f33}), v0;
				globalState.f0 := -(if (cf4) then |v40[123]| else v6[0]) % v6[0];
		}
...
class C9 {
	...
	function fm13(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
		-DC2(0x1c7, |{map[f31 := -0x294], map[f31 := |(map v0 : int | (0x277 <= v0) && (v0 < 0x305) :: (v0 % -0xc9) := (map[|{|multiset{|map[0xbe := f31]|}|}| := |map[f31 := f31]|]))|]}|).cf2
	}
	method m5(globalState: GlobalState) {
		...
		for i2 := v0 + v0 to v0 - v0 {
			...
			var v19 := 'p';
			var v20: array<D22> := new D22[18] [v17, v17, v17, v17, v17.(cf106 := |f32|), fm45(true, globalState), v17, DC56((if (f31 in v18) then v18[f31] else v16)[v0 := v19], v0, f31, f31), v17, v17, v17, v17, v17, DC56(v16, v0, f31, f31), v17, v17, v17, v17];
			v20[686] := v17.(cf105 := v16, cf107 := f31);
			v20[686], globalState.f1, globalState.f27 := v17.(cf105 := v16, cf107 := false), f31, !(if (f31) then f31 else f31);
			var v21: seq<string> := [v16, v16, v16];
			var v22: multiset<bool> := multiset{f31};
			var v23: array<string> := new string[1] [v21[if (f31 in v22) then v22[f31] else |v16|]];
			v23[891] := v16;
			v23[891] := fm3(globalState) + v16;
			globalState.f11 := !fm4(globalState);
		}
		...
		match (if (if (f31) then !f31 else f31) then v32 else v32) {
			case DC11(cf20) =>
				...
				v33[878] := (seq(0xe0, i3  => (v29))) + v34[v0];
				v33[878] := "mdi";
				var v35: multiset<int> := multiset{|v26|, v0 / |multiset{f31}|, v0};
				var v36: seq<multiset<int>> := [v35 - v35, multiset(fm6(f31, v0, v33[878], globalState)) * v35, v35, v35];
				v35 := v36[if (f31) then v0 else v0];
				var v37: map<bool, char> := map[f31 := v29];
				v28 := v28[fm2(v26, v12, v37, false, globalState) := f31];
				var v38: array<bool> := new bool[1];
				v38[62] := fm4(globalState);
				v38[62] := f31;
			case DC12(cf21, cf22) =>
				globalState.f0 := v0;
				var v39: seq<int> := [v0];
				var v40 := DC41(v39);
				v39 := (([v0] + v39) + v40.cf71)[v0 - v0 := v0];
			...
			case DC10(cf19) =>
				if (!!!f31) {
					...
					v55 := v55[-708 / v51.f35 := fm25(|v49|, true, f32, v0, globalState) + v54];
					var v56: seq<int> := [v0];
					var v57: array<array<seq<D9>>> := new array<seq<D9>>[19];
					var v60: array<seq<D9>> := new seq<D9>[8](i4 => [DC23({DC21(v51.f36, v51.f36, v51.f35)}), DC23(set v58 : D8 | v58 in (seq(513, i5  => (DC21(v51.f36, !v51.f36, v0)))) :: (v58)), DC23(set v59 : D8 | v59 in {DC21(v51.f36, f31, |v26|), DC21(if (v51.f35 in v28) then v28[v51.f35] else v51.f36, !f31, v0), DC21(v51.f36, v51.f36, v51.f35)} :: (v59))]);
					v57[686] := v60;
					v56, v0, v57[686], globalState.f1, v27 := [v0] + ([432] + v56), |v26|, v60, f31 <== (|v26| !in multiset(fm6(v51.f36, v0, v26, globalState))), v27[v26 := |(v28 + v28)|];
				}
				
				v26 := v26 + (DC56(seq(591, i6  => (v29)), |[f31]|, f31, fm4(globalState)).cf105[|v26| := v29] + "nfugcqnqm");
				v26 := v26;
				var v61: seq<int> := [-v0, v0 % v0];
				var v62 := DC45(v0, !f31);
				var v63: set<int> := {v62.cf82, v0};
				globalState.f24 := v61[|v63|];
			case DC13(cf23) =>
				var v64: array<bool> := new bool[13](i7 => f32[v0]);
				v64[800] := f31;
				v64[800] := !true;
				var v65: seq<int> := [v0, v0];
				var v66: map<seq<int>, bool> := map[v65 := v64[800]];
				v66 := v66[v65 + v65 := f31];
				globalState.f11 := false;
				globalState.f19 := v0;
		}
	...
	method m6(globalState: GlobalState) returns (r0: bool, r1: seq<int>, r2: int, r3: int) {
		...
		f31 := f31 && f31;
		var v1 := "hgtw";
		globalState.f14 := -|(if (|v1| < |f32|) then v1 else seq(0x349, i1  => ('l')))|;
		...
		if (v2[455]) {
			...
			v5 := if (v2[455] in v6) then v6[v2[455]] else v5;
			var v7: seq<int> := [v3, v3, v3];
			v2[455] := fm47("rqqdcgfg", globalState) > multiset{v7};
			var v8 := DC3(fm4(globalState));
			var v9 := new C7(v8);
			r3 := -(v3 % v3);
		} else {
			v3 := v3;
			v2[455], globalState.f27, globalState.f0, globalState.f24 := false, v2[455], fm13(-v3, v3, v2[455], globalState), v3 + (|(set v10 : int | (0x293 <= v10) && (v10 < -0x12b) :: (v10 / v3))| / v3);
			var v11 := 'i';
		...
		var v15 := DC56(v1, -|(if (v2[455]) then v1 else v1)|, v3 <= |f32|, f32[v3 := f31] != f32);
		v15 := v15;
		r0 := |v1| <= v3;
		var v16: seq<int> := [48];
		r1 := v16 + [-v3, v3];
		var v17: multiset<bool> := multiset{v2[455], v2[455]};
		r2 := if (!v2[455]) then fm13(|v17|, v3, f31, globalState) else v3;
		var v18: map<bool, bool> := map[f31 := f31];
		var v19 := DC61(!v2[455], f31, -|v18|);
		r3 := v19.cf118;
	}
}
...
class C10 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
			...
			decreases 100 - i0
		{
			...
			var v7: map<bool, bool> := map[v0 := v6[v1]];
			var v8: multiset<bool> := multiset{v0, v0};
			var v9: array<int> := new int[25] [v1, |(v2 - v2)|, v1, v1, v1 / v1, v1, v1, v1, v1 / |v3|, v1, v1, 392, v1, v1 % 800, fm2((seq(-0x1d2, i1  => ('w')))[v1 := v4], f30, v5, if (fm7(v0, v0, globalState) in v7) then v7[fm7(v0, v0, globalState)] else true, globalState), 0x54, v1, -|v3|, -(v1 - v1), v1, v1, v1, v1 - v1, |v8|, 0x17];
			v9[507] := 693;
			v9[507] := -(-|"s"| / |(seq(411, i2  => ([v1])))|);
			globalState.f11 := true;
		...
		if (v0) {
			...
			v11[462] := map v12 : int | (0x29b <= v12) && (v12 < 0x28) :: (v12 / |multiset([true, v0, !v0, v0])|) := (DC17(map v13 : D4 | v13 in map[DC10('p') := 0x214] :: (v13) := (-0x17c)));
			var v14 := "ftnbci";
			var v15 := 'm';
			var v16 := DC10(v15);
			var v17 := 584;
			...
			v0, v22, globalState.f24, v25 := v17 <= (v17 * v17), v22, if (v0) then |v14[v17 := 'p']| - v17 else -v17, v25;
		} else {
			var v26 := 0x2a7;
			var v27: seq<int> := [v26];
			var v28 := new C1(v27[v26] * v26, v26, if (v0) then DC3(v0) else f28);
			...
			match (f28) {
				case DC4(cf5, cf6) =>
					...
					v34[40] := v26;
					v34[40] := v27[|(v38 + "yhytnwlse")|];
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					v29[758] := v29[758][v28.f41 := cf9];
					var v41 := "xwnb";
					var v42 := 'm';
					r1 := v41[v28.f41 := v42];
					v41 := v41;
					...
					v43[620] := v45[v27 := {v28.f41, |(set v46 : int | v46 in v30 :: (v46 % DC46(-0x367, false, false, false).cf84))|}];
					v43[620] := (v45 + v45) + v45;
				case DC3(cf4) =>
					...
					var v53 := new C2(map v49 : seq<bool> | v49 in (map v50 : seq<bool> | v50 in v52 :: (v50) := (|{|map[|(seq(983, i5  => (map[v28.f41 := v48.f37])))| := v33]|}|)) :: (v49) := (|map[v28.f42 := v28.f41]|), f30 + v31.f43, DC3(v48.f37));
					var v54: seq<multiset<int>> := [v30];
					globalState.f0 := |v54| / v28.f42;
			...
			case DC1(cf1) =>
				...
				match (v64) {
					case DC45(cf82, cf83) =>
						...
						var v71: array<int> := new int[18] [v60.f41, |v65|, v60.f42, v57, v60.f42, fm2(v63[|(if (cf83 in v67) then v67[cf83] else v63)| := v66], f30, map[cf83 := v66], v0, globalState), -0x1b8 * -v60.f41, v60.f41, |v68|, v60.f41, 0x261, v60.f41, v57, -(if (v0) then 0xbc else -v69.cf31), |(v65 + v65)|, v57, if (cf83 in v70) then v70[cf83] else cf82, -|v63|];
						v71[969] := v57;
						v71[969] := 0x3d3;
						globalState.f11 := v65[v60.f41];
					case DC46(cf84, cf85, cf86, cf87) =>
						var v72: map<bool, bool> := map[v0 := v0];
						var v73: map<map<bool, bool>, int> := map[v72 := cf1];
						var v74 := 't';
						v60.f42 := if ((fm48(v74, cf1, globalState) + v72) in v73) then v73[fm48(v74, cf1, globalState) + v72] else v60.f41 % v60.f41;
						...
						var v77: array<bool> := new bool[20] [true, |(seq(525, i7  => (v74)))| == v60.f41, !cf86, v60.f41 == -0x3e7, !cf86, cf85, cf87, v60.fm7(v0, false, globalState), |"tkyq"| >= v60.f41, v0, cf87, v0, v0, cf87, cf86, cf87 <== cf85, v0, cf84 >= -v60.f41, cf85, cf87];
						v77[317] := true;
						v77[317] := !((v60.f41 % |v72|) == 0x24b);
						globalState.f27 := if (v77[317]) then cf85 else !(!cf85 && cf87);
					case DC44(cf81) =>
						var v78: array<D1> := new D1[6];
						v78[209] := fm29(v57, globalState);
						...
						m0(v82, v87, -fm2(v63, f30, v88[|v59|], v0, globalState), v60.f41, globalState);
				...
				var v97: array<bool> := new bool[29] [v0, v0, false, v94[v57], !(!v0 || v0), v95 !in v63, v0, v0 <==> fm4(globalState), if (false) then v0 else v0, v0, v60.f42 < v60.f41, v0, v0, v0, v0, v0, v0, cf1 <= v60.f41, v0, v60.f42 == cf1, v0, v63 <= v63[|v56[744]| := v95], v0, v0, v96 < fm50(false, v0, v0, globalState), f30 > f30, v0 ==> !v0, v0, v0];
				v97[197] := v94[-0x220];
				var v98: seq<array<int>> := [v93, v93, v93];
				v92[66], globalState.f1, v97[197] := v98[v60.f42], v0, v0 <== v0;
			case DC2(cf2, cf3) =>
				var v99: set<int> := {v60.f41, |v58|, v60.f41};
				cf3 := |v99| + (-0x273 % v60.f41);
				var v100 := "wmck";
				...
				if (v60.fm7(|v101| != v60.f41, v0, globalState)) {
					...
					var v120: array<bool> := new bool[20] [v117.cf83, v0 && false, |(map v118 : int | (0x7c <= v118) && (v118 < -0xd4) :: (v118 % v60.f41) := (v0))| == v60.f41, v0, v0, "mqgq" == (seq(543, i8  => (v115))), v0, fm4(globalState), v0, v0, v0, v0, v0, v0, if (v0) then false else v0, v0, (set v119 : int | (294 <= v119) && (v119 < 458) :: (v119 % v60.f41)) == v99, false, v0, v0];
					v120[965] := v0;
					v120[965] := v0;
					var v121: seq<bool> := [v0];
					var v122 := DC25(v111, v100[cf3] in v100, v121 + v121, cf3 % v60.f41);
					v122 := v122;
				}
				...
				if (!v0) {
					...
					v130[747] := v60.f41 > v60.f42;
					v130[747] := !v129.f37;
					v124 := v124;
				} else {
					var v131: seq<bool> := [v0];
					var v132: map<set<bool>, int> := map[{v131[v60.f42]} := |v101|];
					v60.f42, v132, globalState.f14 := v60.f41 - -v60.f41, v132, v60.f42;
					globalState.f11 := v0;
					var v133 := new C9(DC45(v60.f42, v0).cf83, (fm0(v0, globalState))[v57 := v0]);
					var v134: multiset<seq<map<bool, int>>> := multiset{[v61]};
					var v135 := DC60(v61);
					var v136: seq<map<bool, int>> := [v135.cf115];
					var v137: array<int> := new int[20] [v57, |v133.f32| * |v59|, -v60.f41, cf3 * |v59|, v57, v60.f42, cf2, v60.f41 * v60.f41, v60.f41, v60.f41, if (v0) then cf3 else cf2, v60.f41, v60.f41, -v60.f41, v60.f41, if (v136 in v134) then v134[v136] else cf2, cf3, cf3 % 0x312, v60.f42, v60.f41];
					var v138 := 'w';
					var v139: map<bool, char> := map[v133.f31 := v138];
					v137[488] := fm2(v100, f30, v139, v0, globalState) + v60.f42;
					globalState.f14, v137[488], globalState.f14, v58 := fm12(globalState), cf3, v60.f42, v58;
					var v140: map<bool, string> := map[v133.f31 := "hvnykr"];
					var v141 := new C8(|(if (v0 in v140) then v140[v0] else seq(0x368, i11  => (v138)))|);
				}
	...
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			if (p0) {
				...
				var v7 := "spkw";
				v6[430] := v7[0x2ab := 'h'] != v7[v0 := p1];
				v6[430] := DC29(true).cf50;
				var v8: map<char, bool> := map[p1 := p0];
				var v9: C7 := new C7(f28);
				var v10: map<C7, bool> := map[v9 := p0];
				var v11: array<int> := new int[15] [|v4|, 546, v0, v3[|(seq(0x3c8, i1  => (p1)))|], v0, v0, |v7|, v0, -fm12(globalState), v0, |v8|, v0, |v10|, v0, v0];
				var v12: map<int, array<int>> := map[0x17c := v11];
				v12 := v12;
				var v13: map<bool, char> := map[v6[430] := p1];
				...
				v14, globalState.f27 := v14, (v17 + (seq(0x33e, i2  => (v3)))) == (v17 + v17);
				globalState.f24 := |v15| % -v0;
				globalState.f0 := |v4|;
			}
			
			var v18 := "ijmnfs";
			var v19: map<int, bool> := map[v0 := v18 <= (seq(824, i3  => (p1)))];
			v19 := v19[v0 := p0];
			v18 := v18;
		}
		globalState.f24 := v0;
		...
		match (v21) {
			case DC45(cf82, cf83) =>
				if ((if (cf83) then v0 else cf82) > (cf82 + -v0)) {
					...
					m0(v26, v27, -0xda / -v0, v0 % |v24|, globalState);
					...
					v32 := v32[p0 := cf82 / cf82];
					var v33 := "xisi";
					var v34: C3 := new C3(DC3(p0));
					var v35: seq<C3> := [v34];
					var v36: multiset<C3> := multiset{v34};
					globalState.f14 := |v33| / |(multiset(v35) + v36)|;
					globalState.f19 := v0;
				}
				
				globalState.f11 := !!(v20[v0] != (-0x23b - cf82));
				globalState.f0 := v0;
				var v37: map<int, seq<int>> := map[v0 := v20];
				v37 := v37[|(map[p0 := p1])[p0 := p1]| := v20];
			case DC46(cf84, cf85, cf86, cf87) =>
				var v38 := DC21(p0, !cf87, v0);
				var v39: set<D8> := {DC21(cf85, cf86, fm2(seq(0x47, i8  => (p1)), f30, map[p0 := p1], cf86, globalState))};
				...
				match (v40) {
					case DC23(cf37) =>
						...
						v43[946] := {p0, cf85};
						globalState.f1, v43[946], r0, globalState.f11 := cf85, f30 * f30, cf84, cf87;
						globalState.f19 := v0;
						globalState.f11 := cf86;
				}
				
				var v44 := 'k';
				var v45: seq<seq<int>> := [(seq(790, i9  => (cf84))) + v20];
				v44, v45 := p1, (v45 + v45) + (seq(411, i10  => (v20)));
				...
				if (false) {
					...
					var v52: set<int> := {v0};
					v50[773], globalState.f20, globalState.f1, globalState.f24, globalState.f1 := cf84, v51, !fm4(globalState), cf84, v52 > v52;
					...
					v58, globalState.f19, globalState.f1, v59[478] := v60[if (cf86 in v61) then v61[cf86] else v0], cf84 / |v61|, DC56(v55, cf84, p0, fm7(!cf85, p0, globalState)).cf107, v46;
					...
					globalState.f0, globalState.f11, v63, globalState.f20, v65 := |v55|, (0x385 == -(if (|v55| in v66) then v66[|v55|] else cf84)) && fm4(globalState), [v62 + v62[if (cf85 in v61) then v61[cf85] else v0 := true], v62 + v62, v62], v64 + (v64 + v64[cf84 := cf87]), fm51(globalState);
			...
			case DC44(cf81) =>
				...
				match (v69) {
					...
					case DC22(cf36) =>
						...
						v89[954] := v90;
						v89[954] := v90;
						globalState.f24 := fm12(globalState) / v0;
						var v91 := "gppgxu";
				...
				if (v0 <= (v0 / v0)) {
					...
					v96[306] := v20;
					var v97: array<seq<bool>> := new seq<bool>[19](i16 => [v94[853]]);
					var v98: seq<bool> := [p0];
					v97[238] := v98;
					var v99: multiset<array<bool>> := multiset{v94};
					var v100: map<bool, bool> := map[p0 := p0];
					var v101: map<int, bool> := map[|v100| := v94[853]];
					var v102: seq<map<int, bool>> := [v101, v101];
					var v103 := "qhxilhr";
					v96[306], globalState.f11, globalState.f19, v97[238], globalState.f11 := v20, v94[853], v95[43], ((v98 + fm0(p0, globalState))[(if (v94 in v99) then v99[v94] else v0) % v95[43] := true])[|v102| := p1 in v103], p0;
					var v104: set<int> := {-v0, v95[43], v0, v95[43]};
					v104 := v104;
				} else {
					...
					v105[241] := v107;
					v105[241] := v107.(cf16 := p0);
					var v108: map<bool, int> := map[p0 := v0 - v0];
					var v109 := "agdyntgc";
					v108 := v108[p0 := |v109| / |v109|];
					v106 := v106;
					var v110: array<bool> := new bool[21];
					v110[752] := p0;
					v110[752] := p0;
					var v111: map<int, int> := map[v0 := v0];
					var v112: array<char> := new char[4] [p1, p1, fm5(v0, v110[752], globalState), if (p0) then p1 else fm8(v111, p0, p0, globalState)];
					v112[709] := p1;
					v112[709] := p1;
				}
				...
				v113[250], globalState.f11 := v114.cf75, p0;
			case DC47(cf88) =>
				globalState.f14 := 0x231 / v0;
				var v115: T0 := new C3(f28);
				var v116: seq<T0> := [v115];
				var v117: array<T0> := new T0[16] [v115, v115, v115, v115, v115, v115, v115, v116[v0], v115, v115, if (p0) then v115 else v115, v115, v115, if (p0) then v115 else v115, v115, v115];
				v117[903] := v115;
				globalState.f24, v117[903] := v20[v0], if (p0) then v115 else v115;
				var v118 := "wjtrcmxa";
				globalState.f0 := v0 - |v118|;
				var v119: seq<string> := ["nqhww", "kpc"];
				var v120: multiset<bool> := multiset{p0, p0};
				globalState.f1 := v119[if (p0 in v120) then v120[p0] else v0] !in fm52(p0, v0, true, |f30|, globalState);
		}
		...
		for i18 := -(939 + v0) to v0 {
			...
			v122 := v122[p0 := v121];
			var v123 := "vumynhidj";
			var v124: map<string, int> := map[v123[i18 := p1] := i18];
			var v125: seq<set<bool>> := [{p0}, f30];
			var v126: map<bool, char> := map[p0 := p1];
			v124 := v124[v123 := fm2(fm3(globalState), v125[v0], v126, p0, globalState)];
			...
			var v130: map<string, string> := map[seq(0x108, i19  => (p1)) := v123];
...
class C11 extends T0 {
	...
	function fm9(p0: int, p1: bool, p2: bool, globalState: GlobalState): bool {
		0x15c !in (if (false) then {-0x1b4, |{|(seq(634, i0  => ('s')))|}|} else {|map[true := 348]|, |map[true := |"twhdbjrx"|]|})
	}
	method m1(globalState: GlobalState) returns (r0: D2, r1: string) {
		...
		var v6 := DC6(v4);
		var v7: array<array<bool>> := new array<bool>[26] [v5[v2], v4, v4, v4, v4, v4, v4, v4, v6.cf12, v4, v4, v4, v4, v4, v5[v2], v4, v4, v4, v4, v4, v4, if (false) then v4 else v4, v4, v4, v4, v4];
		v7 := v7;
		...
		var v15 := 'b';
		var v16: map<bool, char> := map[v14[v2] := v15];
		var v17: seq<int> := [v2];
		var v18: multiset<int> := multiset{|v12|, v2};
		var v19: seq<string> := [v12, "ytyvpvjxm", v12, v12, v12];
		var v20: array<int> := new int[7] [v2, fm2(v12, v13, v16, v1, globalState) + v17[|v18|], fm2(v12, v13, v16, !!v1, globalState), fm2(v19[v2], v13, v16, true, globalState), v2, 733, ---v2];
		v20[664] := v2;
		var v21: multiset<map<bool, bool>> := multiset{map[v1 := v1]};
		globalState.f1, v2, v11, v20[664], v15 := !(v1 && v1), |(v12 + v12)| - v2, (multiset{v10, v10})[DC9(v10.cf18) := v2], |(v21 + fm10(v2, v1, v1, globalState))| * fm2(v12, v13, v16, v1, globalState), v15;
		v4 := v4;
		v7[154] := v4;
		v7[154] := v4;
		for i1 := v20[664] to |v17| - 0x37f {
			var v22: array<char> := new char[9];
			var v23: set<array<char>> := {v22};
			var v24: seq<D3> := [v10, v10];
			v23, r1, globalState.f24, globalState.f0 := v23, ("lp" + v12) + v12, |v24| - v20[664], i1;
			var v25: map<seq<bool>, int> := map[v14 := v20[664]];
			var v26: T0 := new C2(v25, v13, f28);
			var v27: map<bool, int> := map[!!v1 := if (v1) then i1 else v2];
			v1, v26, globalState.f1, v27 := v1, v26, v1, v27;
			var v28 := new C1(v20[664], -v2, v26.f28);
			v7[154][647] := v1;
			v7[154][647] := v1;
		}
		var v29 := DC8(v1, v20);
		...
		r1 := v12 + (if (v1 in v30) then v30[v1] else seq(0x319, i2  => (v15)));
	}
	method m2(p0: bool, p1: char, globalState: GlobalState) returns (r0: int) {
		...
		var v3 := 992;
		var v4 := DC4(-v3, p0);
		var v5: map<bool, D1> := map[p0 := if (v2[0x13]) then v4 else v4];
		v0[733], globalState.f1, v5, globalState.f11 := "ev", p0, v5, p0;
		...
		globalState.f1 := v3 >= (v3 / |v11|);
		if (!(v1[|v0[733]| := p1] == "gepy")) {
			var v12: array<int> := new int[16];
			v12[458] := v3;
			globalState.f11, v12[458], globalState.f1 := p0, v3, p0;
			globalState.f27 := p0;
			globalState.f11 := fm7(true, p0, globalState);
			var v13: array<array<seq<bool>>> := new array<seq<bool>>[23];
			var v14: multiset<int> := multiset{|v0[733]|, |v2|};
			var v15: map<multiset<int>, seq<bool>> := map[v14 := v2];
			var v16: array<seq<bool>> := new seq<bool>[8] [v2, if (multiset{v12[458]} in v15) then v15[multiset{v12[458]}] else v2, v2, v2, v2, v2[v12[458] := p0], [true], [fm4(globalState), p0, fm4(globalState)]];
			v13[907] := v16;
			v6[538] := v3 < v3;
			var v17 := DC62(v16);
			var v18: seq<array<seq<bool>>> := [v16, v17.cf119, v16];
			v13[907], v6, globalState.f14, v6[538] := v18[v12[458]], v6, |("o" + v1)| % v3, p0;
			var v19 := DC29(p0);
			var v20: map<seq<bool>, string> := map[v2[v12[458] := v19.cf50] := (seq(0x208, i1  => ('l'))) + v1];
			v0[733] := if (v2 in v20) then v20[v2] else fm3(globalState);
		} else {
			globalState.f1 := p0;
			globalState.f1 := true;
			var v21 := 'a';
			...
			v6[561] := p0;
			v6[561] := p0;
			globalState.f1 := v6[561];
		}
		
		var v22: multiset<bool> := multiset{true};
		var v23: seq<int> := [|v1|];
		var v24: multiset<int> := multiset{|v23|, |v0[733]|};
		...
		match (v27) {
			...
			case DC30(cf51, cf52, cf53, cf54, cf55) =>
				...
				var v48 := DC63(cf54, |v2[v3 := p0]|, v47);
				v1, v3, v46, v48 := seq(-0x34d, i6  => (if (v47.f37) then p1 else p1)), cf54, v46, DC63(v46.f35, v3, v47);
				var v49: map<bool, char> := map[true := v1[cf54]];
				globalState.f24 := fm2(v1[0x27b := p1], v10.f43, v49, !cf52, globalState);
				if (|v1| <= (if (p0 in v22) then v22[p0] else |v1|)) {
					...
					v6[355] := v52 >= v52;
					var v53: seq<string> := [v1, v1, seq(0x240, i9  => (p1)), v1, v0[733]];
					v6[355] := (seq(0x3d4, i7  => (seq(0x2f8, i8  => (p1))))) <= v53;
					var v54: C8 := new C8(-(cf54 - v46.f35));
					v54 := v54;
					globalState.f1 := v46.f36;
					v6[355], cf54, globalState.f1 := 0x1d2 >= |v1|, v46.f35, v0[733] != (v0[733] + v1);
				} else {
					...
					globalState.f27, globalState.f19, v56, globalState.f27, v23 := v55.f30 > v10.f43, -|((seq(-0x28c, i11  => (v23))) + (v57 + v57))|, v56, v46.f36, v23;
					globalState.f0 := cf54;
				...
				match (v60) {
					case DC45(cf82, cf83) =>
						...
						v61[913] := v46.f35 / v46.f35;
						v61[913] := v46.f35 - cf54;
						...
						globalState.f27 := (map[cf55 := v46.f36] + fm48(p1, v61[913], globalState)) !in (v63 + v63);
					...
					case DC46(cf84, cf85, cf86, cf87) =>
						v0[733] := (v1 + "uetbm") + v1;
						var v68 := new C1(-0x3c5 + v46.f35, fm2(v0[733], v10.f43, v49, false, globalState), f28);
						var v69: array<set<char>> := new set<char>[26];
						v69[725] := v8;
						v69[725] := if (cf51) then {v0[733][0xc5], p1} else v8;
						var v70: map<bool, string> := map[cf53 := v0[733]];
						cf55 := v70 != v70;
					case DC44(cf81) =>
						var v71: map<bool, int> := map[v47.f37 := cf54];
						var v72 := DC60(v71);
						v0[733], globalState.f19, v72 := v0[733], v3, v72;
						var v73: map<bool, map<bool, char>> := map[!cf51 := v49];
						var v74 := DC34(v46.f36, v3);
						var v75: map<int, int> := map[fm2(v1, v10.f43, v49, cf52, globalState) := fm2(v0[733], v10.f43, if (cf52 in v73) then v73[cf52] else map[v74.cf59 := p1], v46.f36, globalState)];
						v75 := v75[cf54 := |v1|];
						...
						v76[90], v77, v78[56] := --((v46.f35 * v3) / v46.f35), v77, (if (cf52 in v79) then v79[cf52] else [fm2(v1, v10.f43, v49, cf51, globalState), cf54]) + v23;
						v76 := if (v46.f36) then v76 else v76;
					case DC47(cf88) =>
						var v80: array<int> := new int[23];
						v80[40] := v3;
						v80[40] := --v23[v46.f35];
						var v81 := new C5(v3, v80[40] > v46.f35, f28);
						var v82 := DC7(v47.f37, cf52, v1);
						var v83: map<bool, bool> := map[v10.f43 < {v46.f36} := v82.cf13];
						v83 := v83[v81.f36 := cf55];
						globalState.f1, v80[40] := if (true && p0) then cf53 else fm9(v81.f35, v47.f37, !false, globalState), v46.f35;
				}
			...
			case DC27(cf44) =>
				...
				v84[419], v3, globalState.f11, globalState.f19 := fm2(fm3(globalState) + v1, v10.f43 * v10.f43, v85, false, globalState), v3, if (v86 in v87) then v87[v86] else p0, -v3;
				v86.f33 := -v3;
				var v89: map<seq<bool>, bool> := map[[p0, p0] := p0];
				var v90 := new C2(map v88 : seq<bool> | v88 in v89 :: (v88) := (v86.f33), v10.f43 * v10.f43, f28);
				var v91: map<bool, string> := map[p0 := v0[733]];
				globalState.f27 := (if (p0 in v91) then v91[p0] else v0[733]) != (v27.cf46 + "y")[v84[419] := p1];
		}
		
		var v92: map<bool, char> := map[p0 := p1];
		r0 := fm2(v0[733], v10.f43, v92, p0, globalState) - v3;
	}
	method m3(p0: array<array<char>>, p1: seq<bool>, p2: string, globalState: GlobalState) returns (r0: D2, r1: set<bool>) {
			...
			decreases 100 - i1
		{
			...
			v1[322] := !v2;
			var v3 := 280;
			v1[322] := fm7(v2, p1[v3], globalState);
			var v4 := DC1(v3);
			globalState.f27, globalState.f0 := false, -v4.cf1;
			globalState.f27 := v1[322];
			var v5 := new C7(f28);
		}
		var v6: seq<array<int>> := [v0];
		var v7 := 0x44;
		var v8: map<array<int>, int> := map[v6[v7] := v7];
		var v9 := 't';
		...
		var v14: map<int, string> := map[v7 := v13[|(seq(894, i3  => (v9)))|]];
		var v15: map<bool, char> := map[v11 := v9];
		v8, v7, v9, v10[669] := v8, 915, fm5(fm2(if (v7 in v14) then v14[v7] else p2, {fm4(globalState)}, v15, v11, globalState), false <== true, globalState), v12;
		globalState.f27 := v11;
		var v16: array<D22> := new D22[9];
		forall i4 | 0 <= i4 < v16.Length {
			v16[i4] := DC56(p2 + v13[v7], v7, v11, v11);
		}
		var v17 := DC7(v11, !true, (p2 + p2)[v7 := v9]);
		r0 := v17;
	...
	method m4(p0: array<bool>, p1: multiset<bool>, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := |(v5 + v5)| to -v2 {
			...
			globalState.f11, v9, v10[55], v11 := v15 in v16, v9, v9, v11;
			p0[552] := p1 < p1;
			var v17: map<int, bool> := map[if (v0 in p1) then p1[v0] else v8.f41 := v0];
			var v18: map<map<int, bool>, string> := map[map[v2 := v0] := seq(0x3c3, i1  => ('p'))];
			p0[552] := !!(v17 !in v18);
			v1 := v1;
		}
		...
		var v29: array<bool> := new bool[26] [!v0, v0, v0, v19[-v2], v21.cf16, v0, v0, v0, true, v0 <==> v0, v0, if (false) then fm7(v0, if (v2 in v22) then v22[v2] else v0, globalState) else f28.cf4, v0, !v0, v24 >= fm53(v2, v2, v0, v0, globalState), v0, v0, v2 !in v25, v0, !(fm5(v2, v0, globalState) !in v1), !v0, v26 > v26, if (v0) then true else v0, v28 > {v2, -v2}, v0, v0];
...
method Main() {
	...
	var v13: array<seq<bool>> := new seq<bool>[25] [[v3, v3] + v4, v4, fm0(!v3, globalState) + v4, v4, v4, v4, [v3], v4, v4, v4, v4, v4 + v4, v4 + v4, [v3, v3, v3, v3], v4, v4, v4[v1 := v3], v4, [v3], v4, v4, v4, v4 + fm0(!v3, globalState), v4, v4 + v4];
	...
	v10[223] := v1;
	globalState.f27 := v3;
	var v14: array<set<map<bool, int>>> := new set<map<bool, int>>[21](i2 => {map[DC4(v1, v3).cf6 := v10[223]], map[v3 := v1]} + {map[!v3 := v1]});
	var v15: map<bool, int> := map[v3 := v10[223]];
	var v16: set<map<bool, int>> := {v15, v15};
	v14[925] := v16;
	v14[925] := fm1(|v4|, {v3, v3, false, v3, v3}, globalState);
	var v17: set<bool> := {v3, v3, v3};
	var v18: map<bool, char> := map[v3 := v12[v10[223]]];
	globalState.f24 := fm2(fm3(globalState), v17, v18, v1 <= v10[223], globalState);
		...
		decreases 100 - i3
	{
		...
		i3 := i3 + 1;
		globalState.f24 := v10[223];
		v20 := v20;
		m0(v20, v10, 0x382, v10[223], globalState);
	...
	var v28: array<string> := new seq<char>[10] [(seq(0x170, i4  => (v12[v10[223]]))) + v12, "wsoc", v12[v10[223] := v26], seq(0x3b0, i5  => (v26)), v12 + v12, "kbo", v12, v12, v12, if (v3 in v27) then v27[v3] else v12];
	v28[54] := "s";
	v28[54] := if (true in v27) then v27[true] else v12;
	v28[54] := (v12 + ("obandijdf" + v12))[-v1 := fm5(v10[223], v3, globalState)];
	var i6 := 0;
	while (v3)
		decreases 100 - i6
	{
		...
		var v30: array<D0> := new D0[6] [DC0(v5), DC0(v29[v1]), v7, v7.(cf0 := v5), v7, v7];
		var v31: map<seq<array<D0>>, multiset<int>> := map[[v30] := v6];
		var v32: seq<array<D0>> := [v30, v30, v30];
		v31 := v31[v32 := v6];
		var v33 := DC2(-v10[223], v1);
		match (v33.(cf2 := 0xdc)) {
			case DC1(cf1) =>
				cf1 := fm2(v28[54], v17, v18, v3, globalState) / (cf1 / cf1);
				var v34: map<array<bool>, seq<bool>> := map[v20 := [v3] + v4[v10[223] := v3]];
				v34 := v34[v20 := v4];
				globalState.f27 := false;
				var v35 := DC1(44);
			...
			case DC2(cf2, cf3) =>
				...
				v37[113] := v39;
				v37[113] := DC5(cf3 > v1, v3, cf3, v3, v3);
				...
				var v42: set<int> := {cf3};
				m0(v20, v10, fm2(v28[54], v40[v1], if (|v42| in v41) then v41[|v42|] else v18, v3, globalState), cf2, globalState);
			case DC0(cf0) =>
				v20[961] := if (v3) then !v3 else v3;
				v20[961] := v3;
				m0(v21[606], v10, v1, v10[223], globalState);
				var v43: map<int, array<int>> := map[v1 + v10[223] := v10];
				v10[223] := |v43|;
				globalState.f1 := !fm4(globalState);
		}
		
		v20[955] := fm4(globalState);
		v20[955] := false;
		var v44: seq<map<bool, bool>> := [v8];
		var v45: map<seq<map<bool, bool>>, bool> := map[v44 + [v8] := v3];
		var v46: multiset<bool> := multiset{v3};
		v20[955] := if (v44[|v46| := v8] in v45) then v45[v44[|v46| := v8]] else v3;
	}
	if (v1 == v10[223]) {
		globalState.f27 := if (v3) then v3 else [0xf0] != fm6(v3, |v6|, v12, globalState);
		var v47 := DC1(v1 % |v28[54]|);
		match (v47) {
			case DC1(cf1) =>
				v5 := v5 + v5;
				v20[417] := true;
				v26, v20[417], v10[223] := v26, v3, v10[223];
				globalState.f27 := fm4(globalState);
			...
			case DC2(cf2, cf3) =>
				...
				v3 := |(v49 + v49)| >= (v10[223] + cf2);
				globalState.f27 := v3;
			case DC0(cf0) =>
				var v50 := DC24(fm24(v4, v3, globalState));
				var v51 := new C0(v50.cf38);
				globalState.f27 := !!v4[fm2(fm3(globalState), v17, v18, v3, globalState)];
				m0(v20, v10, v10[223], v1, globalState);
				v10[223] := -(v10[223] + 0x353);
		}
		
		var v52 := DC5(v3, v3, v10[223], v3, !v3);
		v27 := v27[v52.cf8 := v12 + v12];
		var v53 := DC3(v3);
		var v54: C10 := new C10(v17, v53);
		var v55: T0 := new C5(v10[223], v3, v53);
		...
		if (true) {
			...
			var v66 := DC63(|v8|, v10[223], v65);
			var v67 := DC3(v65.f37);
			var v68: T0 := new C1(|v2| / v66.cf120, v10[223], if (true) then v67 else v67);
			var v69: array<C7> := new C7[25];
			var v70: C7 := new C7(v67);
			v69[255] := v70;
			v20[867] := v4 != [v65.f37, v3];
			v68, v69[255], v3, v20[867] := v68, v70, v3, v3;
			...
			m0(v20, v10, v74.f34 - v74.f34, |v28[54]|, globalState);
			v10 := v10;
		...
		decreases 100 - i8
	{
		...
		if ((v1 + v1) == v1) {
			...
			v20[291] := v3;
			v20[291] := true;
			var v79: set<int> := {fm2(v28[54][v1 := v26], v17, v18, v20[291], globalState)};
			globalState.f14 := if ((v79 > v79) in v15) then v15[v79 > v79] else v10[223];
			var v80: array<D1> := new D1[25];
			v8, globalState.f11, globalState.f24, v80, v12 := (v8 + v8)[(fm54(globalState)).cf27 := --v10[223] >= v1], !!v20[291], |(if (v3) then v15 else v15)|, v80, v12;
			var v81: map<bool, multiset<int>> := map[v3 := v6];
			v81 := v81;
		} else {
			globalState.f11 := !(if (v10[223] in v11) then v11[v10[223]] else v3);
			v8 := v8;
			globalState.f27 := v3;
			var v82 := new C8(v1);
		...
		v8 := v8[v4[v10[223]] := v3];
		var v83 := DC52(|[!v3]|, !v3, v3, v10[223], v3);
		v1, globalState.f14, globalState.f14, globalState.f24 := v10[223], ((v83.(cf100 := v1, cf97 := v10[223], cf98 := v3, cf99 := true)).cf97 / v10[223]) * v1, 0x2ef, |v17|;
	...
	var v88: map<string, bool> := map[v28[54] := v3];
	var v89: seq<map<bool, int>> := [fm30(v1, v88, globalState), v15, v15];
	globalState.f24, v0[262], v12, globalState.f0, v26 := -|([map[|v12| := |v12|], v5, v5[v1 := v1]] + (seq(0xaf, i9  => (v5))))| - v10[223], 'a', (seq(613, i10  => (v26)))[(v87.(cf75 := v3, cf73 := v1, cf74 := v3)).cf73 := v26], |(v89 + ((seq(0x1ff, i11  => (v15))) + v89))|, match fm37(v3, "yxhk", |(set v90 : int | v90 in v11 :: (v90 / 897))|, globalState).(cf36 := DC19(v8)) {
	...
	if (fm4(globalState)) {
		if (v3) {
			...
			v26 := if (v3) then v0[262] else v26;
			var v91 := DC2(v1, v1);
			...
			v92[950] := v94;
			globalState.f19, v92[950], v28[54] := if (!v3) then v1 - |v2| else v10[223], v94 + v94, fm3(globalState);
			v16 := v16;
			v5 := v5[v1 % v10[223] := v1];
		}
		
		v20[517] := if (-v10[223] in v11) then v11[-v10[223]] else v3;
		var v95: multiset<char> := multiset{v26, v26, v0[262]};
		var v96: C3 := new C3(DC3(DC46(v10[223], v3, v3, v3).cf86));
		var v97: map<bool, C3> := map[v3 := v96];
		var v98: set<int> := {-|v97|, v10[223]};
		var v99: T0 := new C7(fm20(v3, v3, |v95|, v98, globalState));
		var v100: map<array<bool>, int> := map[v20 := v1];
		var v101: array<map<array<bool>, int>> := new map<array<bool>, int>[14] [v100, v100, map[v20 := v10[223]], v100, map[v20 := 0x66] + v100, v100, map[v20 := 0x309], v100 + v100, v100, map[v20 := v1] + v100, v100 + v100, map[v20 := v1], v100, v100[v20 := v10[223]]];
		v101[651] := v100 + v100;
		v20[517], v8, v99, v101[651], globalState.f27 := v96.fm7(v3, v3, globalState), fm48(v26, v1, globalState) + v8, v99, if (if (v3) then v3 else true) then v100 else v100, !v3;
		var v102 := new C7(v99.f28);
		globalState.f27 := v20[517];
		globalState.f27 := !v20[517];
	} else {
		v10[223] := v10[223];
		var v103: multiset<bool> := multiset{v10[223] !in v2, v3, v3 && v3, v3, v3};
		v103 := v103 + (v103 * v103);
		v3 := (-0x301 + -v10[223]) < fm2(v28[54][|{|v28[54]|}| := if (v3 in v18) then v18[v3] else v0[262]], v17, v18, v3, globalState);
		m0(v20, v10, v10[223] - (if (v3 in v103) then v103[v3] else v10[223]), 811, globalState);
