...
function fm6(p0: bool, p1: bool, globalState: GlobalState): map<bool, int> {
	map[true := 0x320] + (map[true := 0xba] + map[!true := |(set v0 : int | v0 in (seq(331, i0  => (206))) :: (v0 % -|[false]|))|])
}
...
method m0(p0: bool, p1: bool, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>) {
	...
	if (v1 >= (v1 * {if (-v0 in v3) then v3[-v0] else p2})) {
		...
		match (v8) {
			case DC1(cf1) =>
				...
				var v14 := DC3(v13);
				v12[607] := v14;
				v12[607] := v14.(cf3 := v13 + v13);
				var v15 := 'j';
				var v16 := DC2(v0);
				var v17: multiset<C0> := multiset{v9};
				var v18: array<int> := new int[10] [|v17|, v0, |v2|, |v13|, |[v0]|, |v4|, v0, v0, |v13|, |(v13[v0 := v15])[v0 := v15]|];
		...
		if (!(|v4| > v0)) {
			...
			globalState.f12 := p0;
			var v20: array<int> := new int[24](i1 => i1 / v0);
			...
			var v27: array<int> := new int[21] [fm1(p2, v2, globalState), |(v23 + v23)|, v0, -v0, -fm1(p1, v2, globalState), v0, v24.cf2, v0, v0, |v25|, v0, |(v2 + v2)|, v0, v0, 0x255, v0, 353, -(v0 / -|v1|), v0 - |v26|, v0, fm1(p0, v2, globalState)];
			v27[307] := v0;
			v27[307] := v0 * v0;
			var v28 := 'x';
			v28 := v28;
		...
		decreases 100 - i3
	{
		...
		if (p1) {
			...
			var v50: map<array<bool>, map<bool, bool>> := map[v47 := v49[v0]];
			var v51: seq<bool> := [p2];
	...
	for i9 := |v1| to |(v57 + v57)| {
		...
		var v86: array<seq<bool>> := new seq<bool>[25] [v83 + [p0, p2], v83, v83 + v83, v83, v83 + v83, v83, [p1], v83, v83 + [p0, fm2(i9, p0, globalState)], v83, v83, v83, v83, v83[i9 := p0], v83, ((v83 + v83)[v0 := !p0])[v0 := p1], fm9(v84.cf0, globalState), v83, v83, [p0, p1, !!p0, p2], v83, [p1], (v83 + v83)[v0 := p2], v83 + v83, if ((if (i9 in v3) then v3[i9] else p1) in v85) then v85[if (i9 in v3) then v3[i9] else p1] else [p0]];
		v86[295] := v83;
		v86[295], globalState.f12, globalState.f7 := v83 + v83, true, p1;
		globalState.f3 := i9;
		globalState.f5 := i9;
	}
	r0 := v81;
...
method Main() {
	...
	if (v1) {
		...
		if (true) {
			...
			var v18: map<char, int> := map[v0[0x354] := v2];
			...
			var v23: seq<int> := [v2];
			var v24: array<int> := new int[26] [|(v15 + v15)|, v2, v2 % v2, v2, 737, |(if (v1) then v17 else set v19 : char | v19 in v18 :: (v19))|, v2, v2, v2, v2, fm1(!fm2(v2, v1, globalState), v20, globalState), v2, v2, v2, v2 - v2, v2, fm1(v1, map[v1 := v2], globalState), if (v22 in v21) then v21[v22] else |(seq(847, i2  => ('i')))|, -v2, -0x353, v2, v2, v2 * v2, v2, if (v1) then v23[fm1(v1, v20, globalState)] else -v2, v2 + v2];
			v24[86] := v2;
			v24[86] := |(seq(0x73, i3  => (v13)))|;
			var v25: array<bool> := new bool[23];
			var v26: map<int, bool> := map[v24[86] := !true];
			v25[400] := if (v2 in v26) then v26[v2] else v1;
			v25[400] := v1;
			v0, v13, globalState.f12, globalState.f5, v1 := if (v25[400]) then fm3(v1, v24[86], globalState) else v0[v2 := v13] + v0, v0[v2], v25[400], v2, v1;
			var v27: map<bool, string> := map[v25[400] <==> fm2(|v0|, v1, globalState) := v0];
			v27 := v27;
			var v28: seq<seq<int>> := [[v24[86]], v23, [v24[86]], v23[v24[86] := v2], v23];
			var v29: multiset<seq<int>> := multiset{v28[v24[86]]};
			var v30 := m0(v25[400], v25[400], !(v29 == v29), globalState);
		} else {
			var v31 := new C0();
			v14 := v14;
			var v32: array<int> := new int[13](i4 => i4 * -0x39d);
			var v33: seq<array<int>> := [v32, v32, v32];
			var v34: map<map<bool, bool>, array<int>> := map[v10 := if (v1) then v33[|v0[|map[v1 := v2]| := v13]|] else v32];
			v34 := (v34 + v34) + v34;
			var v35: multiset<bool> := multiset{v1};
			var v36: map<int, int> := map[v2 := v2 % (if (false in v35) then v35[false] else v2)];
			var v37: map<bool, int> := map[v1 := v2];
			v36 := v36[fm1(v1, v37, globalState) := v2];
			var v38: array<string> := new string[22](i5 => v0 + v0);
			v38[205] := v0 + "hydejw";
			v38[205] := seq(0xff, i6  => ('a'));
		}
		...
		decreases 100 - i7
	{
		...
		var v41: seq<int> := [v2];
		var v42: array<bool> := new bool[16] [v1, if (v1) then v1 else v1, false, v1, v1, v1, -|v39| > v2, v40 !! (multiset{v2, v2})[v2 := v2], !(v41 < v41), v1, v1, v1, v1, v1, v1 in map[v1 := v1], v1];
		var v43: seq<bool> := [v1];
		var v44: array<int> := new int[8];
		v42, v43, v44, v2 := v42, v43, v44, v2 - (v2 - v2);
		v42[232] := v1;
		v42[232] := v40 <= multiset{|v0|};
		globalState.f12 := v42[232];
		var v45 := DC2(|map[v42[232] := fm2(v2, v1, globalState)]|);
	...
	for i9 := v2 to v2 {
		...
		globalState.f5, globalState.f5, v1, v1, v54 := 0x35a - v2, i9, v1, v1, (v55[v2])[if (v1) then v2 else v56[v2] := v2];
	}
	...
	for i10 := v2 to -fm1(v1, v57, globalState) {
		if (v1) {
			...
			var v63 := DC0(v1);
			var v64 := 'b';
			var v65: array<string> := new string[20] ["apenmlek", fm3(v1, -i10, globalState), v0, v0, v0, "jxraijmpf", v58[|v61[v2]|], v62.cf3 + v0, "vqhbcmux", v0, v62.cf3[i10 := 'o'], v0, v0, v0, v0, fm3(v59.fm4(v1, globalState), i10, globalState), v0, (fm3(!v63.cf0, -v2, globalState))[i10 := v64], seq(247, i11  => (v64)), v0 + v0];
			v65[113] := "evqq";
			v65[113] := v0;
			globalState.f7 := v1;
			...
			v72[28] := 1;
			v72[28] := i10 - (i10 / v2);
			globalState.f5 := fm1(v0 == (seq(0xaa, i12  => ('p'))), v57, globalState);
		}
		...
		globalState.f5, v76, v77[26], v77[79] := -|(if (v80 in v81) then v81[v80] else v0)|, v76, -|v0| + v2, |v0|;
	}
	if (true) {
		var v82 := new C0();
		v57 := v57[v1 := v2 % v2];
		...
		var v85: map<seq<int>, multiset<array<bool>>> := map[v84 := v83[v48 := v2]];
		...
		var v93: map<seq<set<char>>, string> := map[v92 := seq(-0x1db, i14  => ('l'))];
		var v94: seq<bool> := [v1];
		var v95: array<int> := new int[4] [v2, v2, |v94|, v2];
		var v96: map<array<int>, bool> := map[v95 := v1];
		var v97: array<int> := new int[26] [v2, v2, v2, v2, v2, -621, |(seq(-603, i13  => ('m')))| / |v88|, fm1(v1, map[false := 0x2e6], globalState), v2, -310, v2, |{v1}|, |v57|, v2, if (!v1) then |v89| else v89[-|"oe"|], fm1(v1, v57, globalState), v2, fm1(v1, v57, globalState), v2 / v2, v2, v2 % |v90|, v2, |(if (v92 in v93) then v93[v92] else v0)|, v2, v2, |v96|];
		v95[598] := v2;
		var v98 := DC2(v2);
		v95[598] := v98.cf2;
		var v99: set<int> := {if (v1) then v95[598] else v95[598]};
		var v100 := DC0(v1);
		...
		v99, globalState.f12, v101[574], v1 := v99, v1 ==> ([v102] == v103), DC0(fm6(v1, v1, globalState) != v57), ([!v1] + v94) < v94;
		var v104 := m0(v95[598] in v89, v1, v1, globalState);
		var v105: array<set<bool>> := new set<bool>[10];
		var v106: set<bool> := {v1};
		v105[53] := v106;
		v88, v105[53], globalState.f3 := multiset{true}, v106 - (if (v1) then v106 else v106), v2;
		var v107 := new C0();
	}
	...
	if (!v1) {
		...
		v111 := if (v1 && v1) then v111 else v117[v2];
		var v118: map<bool, array<int>> := map[v2 != (if (v1 in v57) then v57[v1] else v2) := v111];
		v118 := v118[!false := v111];
		globalState.f3 := v2;
		globalState.f8 := if (if (v1 in v115) then v115[v1] else v1) then v0[v2 := v112] + (seq(0x110, i15  => (v112)))[v2 := v112] else v0;
	} else {
		var v119: C0 := new C0();
	...
	for i17 := v2 to v2 - v2 {
		...
		var v127: C0 := new C0();
		var v128: map<string, bool> := map[seq(0x1b1, i18  => ('j')) := v1];
		...
		v48[596] := |(seq(-0x127, i19  => (i17)))| > |v131|;
		v48[596] := !(if (v1) then v2 <= |"dvpiwucvt"| else false);
	}
	v1 := v1 <== true;
	globalState.f12 := !((v0 + v0) <= v0);
}