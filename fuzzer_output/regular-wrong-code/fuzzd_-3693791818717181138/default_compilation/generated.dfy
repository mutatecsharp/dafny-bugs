...
function fm23(p0: bool, p1: set<string>, p2: int, globalState: GlobalState): set<int> {
	if (!!!!true) then (set v0 : int | v0 in multiset{|map[false := |{152}|]|, 0x72, |(seq(0x142, i0  => ('i')))|} :: (v0 - |{!true}|)) * (set v1 : int | v1 in [|"chjhmkgm"|, |map[true := false]|, 0x36b] :: (v1 + -0x31b)) else {|(set v2 : int | (0x377 <= v2) && (v2 < 374) :: (v2 * |multiset([|multiset{false}|])|))|}
}
...
method m4(p0: int, p1: bool, p2: string, globalState: GlobalState) returns (r0: int, r1: bool) {
	...
	var v5: seq<int> := [|v4|];
	var v6 := DC1(p1, [p1, v4[-p0]], false);
	var v7: T2 := new C3(p1, p1);
	var v8: map<T2, int> := map[v7 := p0];
	var v9 := DC22(p0, |v5|, p1, -v2.fm2(v6, globalState), v8);
	var v10: multiset<int> := multiset{if (|v3| in v0) then v0[|v3|] else -700, v5[v9.cf35]};
	...
	var v15 := DC11(|v14|, p2);
	var v16 := 'm';
	var v17: array<int> := new int[20] [p0, p0, 0x304 + p0, p0, |"en"|, -(p0 - p0), p0, p0, p0 + p0, p0, 0x8d, v2.fm2(v6, globalState), v5[(v15.(cf19 := (seq(-0x254, i0  => ('d')))[p0 := v16])).cf18], p0, p0, p0, p0 + p0, p0, p0, p0 * p0];
	v0, v11[922], v17, r0 := multiset{p0}, v12 * v12, v17, v5[p0] % |([v7.f9] + v4)|;
...
class C0 extends T0 {
	...
	function fm1(p0: string, p1: D0, globalState: GlobalState): bool {
		("eacmud" + "h") == (if (!false) then "gdjemsj" else seq(0x21f, i0  => ('n')))
	}
	function fm10(p0: int, p1: int, p2: bool, globalState: GlobalState): map<int, int> {
		((map v0 : int | (0x34e <= v0) && (v0 < 0x29) :: (v0 - 450) := (0x226)) + map[-0x261 := --0x272]) + (if (true) then map v1 : int | (942 <= v1) && (v1 < 0x34d) :: (v1 / |(seq(0x113, i0  => (0x3ab)))|) := (|multiset([0x210, 570])|) else map[299 := |[0x351]|])
	}
}
...
class C1 extends T2, T0, T1 {
	...
	function fm2(p0: D0, globalState: GlobalState): int {
		(0x15c + 0x3bf) % (|multiset{f9}| + |multiset(seq(429, i0  => (-0x33f)))|)
	}
	...
	method m0(p0: multiset<bool>, p1: D0, p2: bool, globalState: GlobalState) {
		...
		for i0 := --(if (p2) then v3 else fm2(v4, globalState)) to |v5| {
			...
			var v8: array<string> := new string[25] [v5, fm9(!f8, f8, globalState), v5, v5, v5, v5, v5, v5, (if (fm2(v4, globalState) in v6) then v6[fm2(v4, globalState)] else v5) + (seq(0x1ae, i1  => (f10))), "fltsycqgp", v5 + v5, v5, v5, v5, "rboifjmne", v5, v5 + "mk", v5, ("nvmycqm")[i0 := f10], v5, "tjel", v5 + (seq(0x319, i2  => (f10))), v7[fm2(v4, globalState)], seq(0x153, i3  => (f10)), v5];
			v8[990] := v5;
			v8[990] := v5[i0 := 'n'];
			f8 := !p2;
			f8 := !f9;
			...
			decreases 100 - i4
		{
			...
			v13[518] := if (false in v14) then v14[false] else fm8(globalState);
			v13[518] := fm0(globalState);
			v13[518] := f9;
			f8 := f8;
		}
		if (f8) {
			...
			v15 := v15;
			var v16: array<string> := new string[8] ["atblghtma", seq(0x85, i6  => ('o')), v5, v5, v5, v5, "hvtuvijkn", v5 + v5];
			var v17: seq<string> := [v5];
			v16[788] := v17[|(multiset{f8, !p2, f8})[!f8 := v3]|];
			var v18: map<int, int> := map[v3 := v3];
			v16[788] := (if (p2) then v17[if (v3 in v18) then v18[v3] else v3] else v5 + v5)[0x2f2 * |(seq(0x1ad, i7  => ('u')))| := f10];
			v16[788] := (v16[788] + v16[788]) + v16[788];
			var v19: map<bool, bool> := map[false := f8];
			var v20: multiset<int> := multiset{|v16[788]|, v3, |p0|, v3};
			v19 := v19[f8 := |v19| !in v20];
			if (!f9 ==> f8) {
				f8 := (v3 / v3) > (0x2fe + |v16[788]|);
				var v21: seq<int> := [v3, v3, v3];
				var v22 := DC7("arjmj");
				var v23: map<D4, int> := map[v22 := v3];
				var v24: array<int> := new int[9] [v3, -v3, |v21|, v3 - 0x382, fm2(v4, globalState), v3 / |[v3, fm2(v4, globalState)]|, v3, v3, v3 - (if (v22 in v23) then v23[v22] else fm2(DC1(f8, v0[467], !f8), globalState))];
				v24[585] := v3;
				var v25: set<bool> := {f8};
				v24[585] := |v25|;
				v15[103] := true;
				...
				var v28: map<bool, int> := map[f9 := v24[585]];
				v27[156] := map[f10 := v28];
				var v30: map<char, map<bool, int>> := map[f10 := v28];
				v27[156] := (map v29 : char | v29 in (seq(-0x2a, i8  => (f10))) :: (v29) := (v28)) + v30;
			} else {
				...
				v34[42], v15, f8, f8 := f10, v15, v3 > v3, v33.fm1(v16[788] + (if (-v3 in v35) then v35[-v3] else v17[v3])[fm2(DC1(!!p2, v0[467], f8), globalState) := f10], v4, globalState);
				f8 := [f8, f9] <= v0[467];
			}
			
		} else {
			var v36: array<int> := new int[18] [v3 + v3, v3, v3, v3, v3, 0x14a % v3, 408, v3, fm2(DC1(false, v1, f9), globalState), v3, v3, 392 - v3, v3, v3, |v5|, v3 / v3, v3, v3];
			v36 := v36;
			v3 := v3;
			var v37 := DC10(v36);
			var v38: seq<array<int>> := [v36];
			var v39: array<array<int>> := new array<int>[19] [v36, v36, v37.cf17, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v38[v3], v36, v36, v36];
			var v40 := new C0(v39);
			v36[49] := v3;
			v36[49], v3, v3, v5 := (fm2(v4, globalState) + v3) + (v3 / v3), v3, |"gucbasaxj"| / v3, v5;
		...
		v43 := v43[if (p2) then p2 else f8 := DC6(f9, |v44[v3 := v3]|, 307)];
	}
	method m1(p0: string, p1: bool, globalState: GlobalState) returns (r0: string, r1: int, r2: bool) {
		...
		for i0 := v1 to |[337, -v1]| {
			if (fm0(globalState)) {
				...
				var v13: seq<bool> := [p1];
				var v14: seq<int> := [|v13[i0 := p1]|, v1, i0];
				var v15: map<int, bool> := map[i0 := p1];
				var v16 := DC1(p1, v13, f8);
				var v17: multiset<char> := multiset{f10};
				var v18: array<int> := new int[29] [|v7[v1]|, i0 + v1, if (p1 in v8) then v8[p1] else v1, v1, i0, i0, v1, v1, v1, i0, i0, v1, i0, |v12[|v14|]|, v1, v1, -560, |v15| / i0, i0, |v14|, i0, v1, i0, v1, -(v1 + v1), i0 % i0, fm2(v16.(cf0 := f9), globalState), i0 - (if (f10 in v17) then v17[f10] else i0), -0x241];
				v9[872] := |(v14 + v14)|;
				r0, v6[547], v9[872] := fm9(i0 == i0, true, globalState), p1, i0 - i0;
				var v19 := DC8(|(seq(0x210, i1  => ('b')))|, f9);
				v6[547] := v19.cf12;
				var v20: seq<string> := [p0, p0, p0];
				var v21: map<seq<string>, bool> := map[v20 := v6[547]];
				var v22 := DC5(v14);
				v6[547] := if (fm12(p1, v22, globalState) in v21) then v21[fm12(p1, v22, globalState)] else v13[fm2(v16, globalState)];
				r2 := v9[872] > v9[872];
			} else {
				var v23: multiset<string> := multiset{p0 + p0, p0 + p0};
				v23 := v23 - (if (p1) then multiset{p0, p0, seq(0x178, i2  => (f10)), seq(989, i3  => (f10))} else multiset{p0, p0, p0});
				...
				var v29: seq<int> := [-|v26| * v1, i0, i0 % v1, i0, i0 * |v28[i0]|];
				v1, r2 := |v29|, p1;
				var v30 := new C0(v24);
		...
		var v40: array<seq<int>> := new seq<int>[20](i4 => DC5([v1, |{f8}|]).cf6 + DC5(seq(0x365, i5  => (v1))).cf6);
		v40[488] := fm14(v1, (seq(104, i6  => (f10)))[347 := f10], f8, globalState);
		...
		v40[488] := v46;
		var v47: array<bool> := new bool[11] [p1, p1, f8, false, p1, f8, f8, f8, v40[488] != v40[488], true <==> f9, p1];
		v47[30] := v1 !in v40[488];
		v47[30] := f10 in p0;
		for i7 := v1 to v1 {
			var v48: seq<bool> := [v47[30], p1, !v47[30], v47[30], v47[30]];
			var v49: map<bool, int> := map[|v48| <= v1 := i7];
			var v50 := DC1(f9, v48, true);
			v49 := v49[f9 := fm2(v50, globalState) / 0x3b];
			...
			v53[167] := v54;
			v53[167] := map v55 : int | (796 <= v55) && (v55 < 0xf9) :: (v55 * v1) := (f9);
			r2 := f8;
		}
		v1 := 0x1a5;
		r0 := p0 + p0;
...
class C2 extends T1, T2 {
	...
	method m0(p0: multiset<bool>, p1: D0, p2: bool, globalState: GlobalState) {
		var v0 := 195;
		var v1: map<int, char> := map[194 := fm7(v0, f8, |(seq(0xd9, i0  => (v0)))|, globalState)];
		var v2 := 'w';
		v1 := v1[v0 := v2];
		v0 := v0 - (v0 + v0);
		...
		f8 := (v14 + v14) < v14;
		var v15: array<int> := new int[2](i2 => i2 % 0x21c);
		match (DC10(v15)) {
			case DC11(cf18, cf19) =>
				...
				var v17 := DC8(v0, f9);
				v16[408] := v17.cf12;
				cf18, v0, v16[408] := v0, |map[cf18 * v0 := if (p2) then v16[408] else f8]|, v16[408];
				var v18: multiset<int> := multiset{v0, -cf18};
				var v19: map<int, multiset<int>> := map[cf18 := v18];
				var v20: map<bool, bool> := map[f8 := !v16[408]];
				...
				var v26: seq<int> := [cf18 % 0x37e];
				var v27: map<bool, set<int>> := map[v16[408] := v23];
				var v28: map<char, int> := map[v2 := cf18];
				var v29: map<int, map<char, int>> := map[cf18 := v28];
				var v30: seq<map<bool, seq<bool>>> := [v25];
				v23, v25, v26, cf18 := (if (v16[408] in v27) then v27[v16[408]] else {|v29|}) * v23, v30[-v0], v26, v0 % v0;
			case DC10(cf17) =>
				...
				v0, v32 := |v31[v0 := v0]|, multiset(v35);
				var v36 := "tpt";
				v15[72] := |(v36 + v36)|;
				v0, v15[72] := (if (false) then v0 else v0) / (v0 % v0), v0;
				var v37 := DC14(v33);
				var v38 := DC16(v37);
				var v39: seq<D7> := [v37];
				var v40 := DC16(v39[|{f9, f8}|]);
				v40 := v40;
				if (false) {
					v15[72] := v0 * v0;
					var v41: map<bool, array<int>> := map[v15[72] <= v0 := cf17];
					v41 := v41[p2 := cf17];
					v15[72] := v15[72];
					f8 := f9;
					var v42: seq<array<int>> := [cf17];
					var v43: map<string, array<int>> := map[v36 := cf17];
					var v44: array<array<int>> := new array<int>[18] [cf17, cf17, cf17, cf17, cf17, cf17, cf17, cf17, cf17, cf17, v42[v15[72]], cf17, cf17, cf17, if (v36 in v43) then v43[v36] else cf17, cf17, cf17, cf17];
					var v45 := new C0(v44);
				} else {
					v0 := v15[72];
					var v46: seq<string> := ["u"];
					var v47 := DC1(f8, v35, p2);
					f8 := fm1(v36 + v46[0x238], v47.(cf2 := f9), globalState);
					v31 := v31;
					...
					var v54: map<bool, string> := map[p2 := v36[v15[72] := v2]];
	...
	method m1(p0: string, p1: bool, globalState: GlobalState) returns (r0: string, r1: int, r2: bool) {
		...
		var v1 := 345;
		v0[790] := v1;
		v0[790] := fm6(v1, v1 + v1, globalState);
		var v2 := DC10(v0);
		match (v2) {
			case DC11(cf18, cf19) =>
				v0[790] := v1;
			...
			case DC10(cf17) =>
				...
				var v11 := new C1(v4, v10, f9 && f8, (seq(-0x3cc, i0  => (v4))) <= p0);
				f8 := true;
				cf17 := cf17;
				r1 := v0[790];
		}
		...
		var v14: array<array<int>> := new array<int>[14] [v0, v0, v0, v0, v0, v0, v12[v1], v0, v0, v0, v0, if (f8 in v13) then v13[f8] else v2.cf17, v0, v0];
		var v15: C0 := new C0(v14);
		var v16: multiset<bool> := multiset{p1};
		var v17: seq<int> := [v0[790]];
		var v18: set<bool> := {f8, f9, f9, f8, p1};
		var v19 := DC14(v18);
		var v20: map<int, bool> := map[v0[790] := p1];
		var v21: seq<bool> := [f9];
		var v22 := DC1(p1, v21, v21[v0[790]]);
		...
		var v25: map<int, int> := map[v0[790] := v0[790]];
		var v26: array<bool> := new bool[26] [v1 < (if (f8 in v16) then v16[f8] else v0[790]), f8, fm0(globalState), f9, 0x22e <= v1, f9, f9, |v17| >= v0[790], f8, {p1, f9} !! v19.cf25, f8, f8, f8, p1, false, p1, !(|v20| > v1), v15.fm1(p0, v22, globalState), f8, !(|[|v24|, v0[790]]| in v25), f9, p1, p1, f8 ==> f9, f8, p1];
		v23[815] := p1;
		var v27: set<int> := {v1};
		var v28 := DC17(v27);
		r2, v15, v1, v23[815], r2 := (v28.cf27 - v27) > {0x78}, v15, -v0[790], p1, !(|v17| >= (v1 % v0[790]));
		var v29 := DC4(f9);
		var i1 := 0;
		while (match v29.(cf5 := !v23[815]) {
			case DC4(cf5) => if (v23[815]) then DC19(f9).cf31 else DC13(v23[815], f9, seq(-939, i2  => ('u')), cf5).cf21
			case DC3(cf4) => if (!v23[815]) then p1 else p1
		})
			decreases 100 - i1
		{
			if (i1 >= 100) {
			...
			f8 := p1;
			var v30 := 'm';
			var v31 := DC7(seq(0x377, i4  => (v30)));
			var v32: set<seq<D4>> := {(seq(854, i3  => (DC7(p0))))[v0[790] := v31]};
			var v33: C1 := new C1(v30, v32 - v32, v23[815], f9);
			v33 := v33;
			v30 := if (p1 ==> v23[815]) then fm7(v0[790], f9, |(seq(0x3c1, i5  => (v30)))|, globalState) else if (true) then v30 else fm7(v0[790], v23[815], |v27|, globalState);
		}
		var i6 := 0;
		while (!p1)
			decreases 100 - i6
		{
			...
			v36 := v36[v34 := fm17(f9, f8, v0[790], globalState)];
			var v37: array<array<bool>> := new array<bool>[26];
			v37[925] := v26;
			var v38: array<string> := new string[25];
			v38[813] := p0 + "iudnfs";
			r2, v37[925], v38[813], r0 := v23[815], v23, p0, p0;
			if (if (if (p1) then true else v23[815]) then v23[815] else v1 != v0[790]) {
				v0[790] := v0[790] - v0[790];
				v23[815] := fm0(globalState);
				...
				var v41: set<seq<int>> := {v17, v17 + (seq(0x118, i7  => (v1))), [v0[790], v0[790], v1]};
				var v42 := 'h';
				var v43 := DC2(v42);
				var v44: array<char> := new char[29] ['j', if (f9) then v42 else v43.cf3, v42, v42, v42, v42, v42, v42, v42, 'n', v42, v38[813][0xf0], v42, v42, v42, v42, v42, v42, fm7(fm6(v1, |fm18(f8, v0[790], v0[790], globalState)|, globalState), fm1(v38[813], v22, globalState), v1, globalState), v42, v42, fm7(v0[790], p1, fm2(DC1(false, [v23[815]], f8), globalState), globalState), DC2(v42).cf3, v42, v43.cf3, v42, 'q', fm7(254, p1, -v1, globalState), if (p1) then v42 else v42];
				v44[878] := v42;
				var v45 := DC19(p1);
				var v46: array<D6> := new D6[10];
				var v47: map<D8, array<D6>> := map[v45 := v46];
				f8, v41, v44[878], v47 := !true, ({v17, v17[v0[790] := 0x35a], v17} - v41) - (v41 * v41), 't', v47[v45.(cf31 := f9) := v46];
	...
	method m3(p0: string, p1: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v1 := DC11(|v0|, p0);
		var v2 := DC11(p1, v1.cf19[-p1 := fm7(-p1, f8, p1, globalState)]);
		v1 := v2;
		...
		for i0 := |v3| to if (f9) then p1 else p1 {
			...
			var v7: seq<bool> := [v5[706]];
			r0, r0, v5[706] := i0, |v6|, [v5[706]] != (v7 + v7);
			var v8 := 'o';
			v8 := v8;
			v5[706] := f9;
		}
			...
			decreases 100 - i1
		{
			...
			v10, v12, v13[182], r0, f8 := ("rdheeg")[p1 := if (f8 in v17) then v17[f8] else 'c'], v12, v15, p1, fm0(globalState);
...
class C3 extends T1, T2 {
	...
	function fm0(globalState: GlobalState): bool {
		(set v0 : int | v0 in [--88, |[f8, f8]|] :: (v0 % 0x7)) < {|multiset{f9, f8}|, |map[f8 := |(map v1 : int | (0x39 <= v1) && (v1 < 0x329) :: (v1 * -161) := (f8))|]|, 0x3b0, -0x285}
	}
	function fm1(p0: string, p1: D0, globalState: GlobalState): bool {
		f9
	}
	function fm3(globalState: GlobalState): multiset<int> {
		(multiset([0x3d0, |"ceyl"|, 0x233]) + multiset{|(seq(748, i0  => (0xc9)))|}) - multiset{|[0x1bb, 0xc8, |(set v0 : int | v0 in multiset{0x2ec, 0x8e} :: (v0 + |[DC2('o').cf3]|))|]|}
	}
	method m0(p0: multiset<bool>, p1: D0, p2: bool, globalState: GlobalState) {
		...
		var v2 := 0x1db;
		v0[694] := (if (f9) then p0 else multiset{false, f8}) * v1[v2];
		var v3: seq<int> := [v2];
		f8 := !!(|v3| == v2);
		var v4 := "ks";
		var v5 := DC3(v3[v2]);
		...
		var v7: seq<bool> := [p2];
		v6[170] := v7[-(v2 + v2)];
		v6[170], v2 := |"fvnhbyxkp"| == v2, v2 + 0x27d;
	}
	method m1(p0: string, p1: bool, globalState: GlobalState) returns (r0: string, r1: int, r2: bool) {
		...
		for i0 := |v1| to |v5| {
			...
			var v7: array<bool> := new bool[9] [f9, f9, false, v0.f9, v6[v3], fm0(globalState), if (v0.f9 in v2) then v2[v0.f9] else p1, p1, true];
			...
			match (v10) {
				case DC6(cf7, cf8, cf9) =>
					...
					var v16: multiset<bool> := multiset{v0.f9, |(seq(0x11f, i2  => (v2)))| == |p0|};
					v16 := v16;
				case DC5(cf6) =>
					var v17: map<T2, seq<int>> := map[v0 := v9];
					r2 := (cf6 + (if (v0 in v17) then v17[v0] else seq(-723, i3  => (-i0)))) <= v9;
					v3 := |(multiset{i0} + v4)| % i0;
		...
		var v22: array<int> := new int[1](i4 => i4 / v3);
		var v23: seq<array<int>> := [v22, v22];
		var v24: seq<seq<array<int>>> := [v23, v23];
		v23 := v24[if (f8) then v3 else v3];
		r1 := 0x124;
		r1 := -v3;
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (f9) {
			...
			if ({498} <= v14) {
				...
				var v23 := new C1(v21[-v0], set v22 : seq<D4> | v22 in multiset{seq(0x33, i1  => (DC7("ymfwvwo")))} :: (v22), p0, !(f8 <== f9));
				var v24: array<int> := new int[22](i2 => i2 - v5[68]);
				...
				v26[556] := if (v23.fm1(v21, v29, globalState)) then v27 else v27;
			}
			...
			v30[47], r0, f8 := v33, |v34|, (multiset{v0} * v35) > (v35 + v35);
			r0 := v0;
			r1 := f9;
		} else {
			var v36 := 'h';
			...
			var v39: seq<int> := [-155];
			var v40: seq<bool> := [p0];
			var v41: map<int, D4> := map[v39[v0] := DC8(|v40|, f8)];
			...
			v44 := v44;
			var v45 := DC2(v36);
			v42 := v42 - fm19(f9, v45, v39[v0], globalState);
		}
		...
		match (v49) {
			case DC18(cf28, cf29, cf30) =>
				...
				var v54 := DC20(v53);
				var v55 := DC20(v54.cf32[cf30 := 726]);
				f8, v50, v51, v51, v52 := !((DC20(v53[|v53| := cf30]).cf32 + v55.cf32) !! (v53 * v53)), v50 + v50[v0 := f9], if (cf29) then v51 else v51, v51, v52 - v52;
				var v56 := 'c';
				var v57 := DC7(v47);
				var v58: seq<D4> := [v57];
				var v59: map<multiset<int>, seq<D4>> := map[v53 := v58];
				var v60: set<seq<D4>> := {v58, if (v53 in v59) then v59[v53] else [DC7(v47), v57, v57, v57, DC7(v47).(cf10 := seq(754, i4  => (v56)))]};
				var v61 := DC8(v0, true);
				...
				var v65: seq<C2> := [v51];
				v63, v64, v0, v0, cf30 := if (cf29) then v63 else v63, v64, v0 / |(v53 * v53)|, cf30, |v65|;
			case DC19(cf31) =>
			...
			case DC17(cf27) =>
				...
				v74[59] := if (f9 in v75) then v75[f9] else f8;
				v74[59] := p0;
				v0, v0 := -v0, v0;
				var v76: array<D9> := new D9[16];
				var v77 := DC7(v47);
				var v78: seq<D4> := [v77, v77.(cf10 := seq(0xdb, i8  => ('i')))];
				var v79: set<seq<D4>> := {v78};
				var v80: T2 := new C1(v47[v0], v79, f8, v74[59]);
				var v81: map<T2, int> := map[v80 := v0];
				var v82 := DC22(v0, v0, p0, v0, v81);
				v76[159] := v82;
				v76[159] := DC22(v0, v0 * v0, p0, |fm20(globalState)|, v81 + v81[v80 := v0]);
		}
			...
			decreases 100 - i9
		{
			...
			if (true) {
				...
				v100[286], v101, v103, v47 := if ((v0 + v0) in v109) then v109[v0 + v0] else v101, v101, ((seq(-0x1a8, i11  => (-v0))) + v103) + [|{v0}|], v47;
				var v110 := new C1(v99.f10, v99.f11, p0 && true, !false);
				var v111 := 'f';
				v104[9] := v99.fm2(v88, globalState);
				v104, v111, v104[9] := v104, v111, v0 - v0;
				v104[9] := v99.fm2(v88, globalState) % v104[9];
			}
			...
			r1 := p0 && fm1(v47[v0 := v113], DC1(false, v114, f8), globalState);
		}
		...
		if (v115 > v115) {
			...
			var v120: array<array<int>> := new array<int>[17] [v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v119[-v0], v118, v118, v118];
			...
			v124[982] := fm2(v127.(cf2 := f9), globalState);
		...
		var v132 := 'h';
		r0 := v0 / |(seq(0x3c7, i12  => ('c')))[-265 := v132]|;
		r1 := f8;
	}
}
...
method Main() {
	...
	match (match DC1(v2, v3, v2).(cf1 := v3) {
		...
		case DC0() =>
			if (v2) {
				...
				v6[598] := if (v2 in v7) then v7[v2] else if (v8 in v10) then v10[v8] else seq(621, i1  => (v5));
				v6[598] := v0;
				var v11 := DC21(v8, v8);
				...
				var v24 := DC11(|v23|, v6[598]);
				var v25: array<char> := new char[4](i2 => v5);
				var v26: map<array<char>, bool> := map[v25 := v2];
				var v27: array<int> := new int[29] [v8, v8, v8, v8, v8, v8, if (v11.(cf33 := v8) in v12) then v12[v11.(cf33 := v8)] else v8, v4.fm2(v13, globalState) / v8, v8 / v4.fm2(DC1(v2, v3, v2), globalState), |(v17 + v17)|, -|v18|, v8, if (v2) then v8 else v8, v8, v8, |fm21(|v19|, globalState)|, v8 + v8, v4.fm2(v13, globalState), |v9[v8 := v8]|, v8, if (|v0| in v20) then v20[|v0|] else v8, -(|v21| + |v3|), -0x278 - |map[v2 := v8]|, -0x12e, v8, v8, if (v2) then v24.cf18 else |v26|, -(v8 * v8), v8];
				v27[815] := -v8;
				var v28: multiset<int> := multiset{v4.fm2(v13, globalState), 0x14e, v8, v8 % v8, v8};
				v27[815] := if (v4.fm2(DC1(v2, [v2], v2), globalState) in v28) then v28[v4.fm2(DC1(v2, [v2], v2), globalState)] else -0x153;
				v1[897] := v2;
				var v29: multiset<bool> := multiset{v15.fm0(globalState)};
				v1[897] := v27[815] >= (if (v2 in v29) then v29[v2] else v8);
			} else {
				var v30 := -507;
				var v31: seq<int> := [-v30];
				var v32 := 'e';
				...
				var v34: set<string> := {seq(0x214, i3  => (v32)), v0};
				v34 := v34;
			...
			var v43: C1 := new C1(v38, (set v39 : seq<D4> | v39 in (seq(-0x17f, i4  => ([DC7(seq(413, i5  => (v38)))]))) :: (v39)) + v42, v2, v2);
			v43 := v43;
		case DC1(cf0, cf1, cf2) =>
			var v44 := 0x3b4;
			cf0 := (|v0| <= v44) && cf2;
			var v45 := DC8(-v44 % v44, cf2);
			match (v45) {
				case DC8(cf11, cf12) =>
					...
					var v50: array<map<bool, bool>> := new map<bool, bool>[13] [v46 + v46, v46 + v46, v46, v47[v44], map[v2 := v49.cf7], v46 + v46, v46, v46[v2 := cf2] + map[v2 := !cf0], v46, v46 + v46, v46 + v46, fm22(cf11, |v0|, 0xf0, false, globalState), v46[cf12 := cf12]];
					v50[793] := v46;
					var v51: array<int> := new int[27];
					var v52 := DC24(v46);
					v50[793], v51 := v52.cf42, v51;
					var v53: seq<seq<bool>> := [v3, v3, [cf0], v3, [true]];
					var v54 := DC26(v53);
					v44 := (v44 / -cf11) % |v54.cf44|;
					var v55: set<int> := {|v0|, |v3|};
					v44 := cf11 - -|map[!false := v55]|;
					v51[66] := v44;
					v51[66] := (if (cf2) then v44 else v44) + v44;
				case DC9(cf13, cf14, cf15, cf16) =>
					...
					var v59: set<int> := {|v58|};
					v1[685] := if (cf13) then v2 else false;
					var v60 := DC3(cf14);
					var v61: C2 := new C2(cf16 == v60.cf4, v2);
					v59, v2, v1[685], cf14, v61 := fm23(cf13, {v0}, cf16, globalState), |v0| >= v44, cf13, cf14, v61;
					var v62 := new C2(!(v57 !! multiset{|fm14(|(seq(158, i6  => ('i')))|, v0, v2, globalState)|}), v1[685]);
					var v63 := new C2(if (v2) then cf0 else v62.fm0(globalState), v2);
				case DC7(cf10) =>
					v44 := (v44 - -0x35e) - v44;
					cf2 := (seq(0x152, i7  => ('d'))) <= "hduwoi";
			...
			if (if (v2) then cf2 else cf2) {
				...
				cf2, v72[223] := v73 >= v73, (-v44 + v44) / (-|v74| - v44);
				...
				var v84, v85 := m4(v44 / v44, false, v0, globalState);
				var v86: array<multiset<bool>> := new multiset<bool>[2];
				v86 := v86;
				v1[280] := v85;
				var v87: set<int> := {v84, v44};
				v1[280] := v87 < (set v88 : int | (-626 <= v88) && (v88 < 0x157) :: (v88 % v44));
			}
			
	}
	
	var v89 := -166;
	var v90, v91 := m4(0x33b % v89, v2, fm4(v89, 0x262, globalState), globalState);
	...
	v101[682] := v100;
	var v102: array<int> := new int[9](i8 => i8 / v90);
	v97, v101[682], v102, v91, v90 := v97, v100, v102, !((if (v91) then v90 else v89) <= v90), -v90;
	var v103: seq<int> := [v90];
	v103 := v103;
	v1[875] := v0 < "rggpcxlop";
	var v104 := 'q';
	var v105: array<string> := new string[8] [fm4(v90, |(seq(-0x2e1, i9  => ([v91, v2, v91, v91])))|, globalState), v0, if (v91) then v0 else v0, v0, "hw", (if (v91) then v0 else v0)[v89 := v104], v0, seq(0x24d, i10  => ('j'))];
	v105[762] := v0;
	var v106: map<array<bool>, bool> := map[v1 := v2];
	var v107: map<bool, bool> := map[v91 := v2];
	v91, v90, v1[875], v105[762] := -(if (v91) then -v89 else v89) >= (if (v89 in v97) then v97[v89] else -|v106|), if (v2) then v89 else (fm25(v90, v89, 0x30d, globalState)).cf51 + v90, match DC24(v107).(cf42 := v107) {
		case DC25(cf43) => false
		case DC24(cf42) => v89 == 0x341
	}, v0;
	var v108 := DC7(v105[762]);
		...
		decreases 100 - i11
	{
		...
		i11 := i11 + 1;
		v105[762] := v105[762] + v0;
		if (v1[875]) {
			var v112: multiset<bool> := multiset{!!v2, v1[875]};
			var v113 := DC0();
			...
			var v117: set<bool> := {v1[875], v91};
			var v118: seq<set<bool>> := [v117];
			var v119 := DC14(v118[|(seq(0xd6, i12  => (v89)))|]);
			v119 := v119.(cf25 := v117);
		} else {
			var v120 := DC14({v1[875]});
			var v121 := DC16(v120);
			v121 := DC16(v120);
			var v122: array<D3> := new D3[5];
			var v123 := DC6(v2, 0x347, v90);
			v122[224] := v123;
			var v124: set<int> := {|(seq(0x343, i13  => ('x')))|, v89};
			var v125 := DC1(!(v124 != v124), v3, v91 || true);
			v122[224], v125, v104 := v123, v125, v104;
			var v126: set<bool> := {v2, v1[875]};
			var v127 := DC3(if (|v126| in v95) then v95[|v126|] else v90);
			v89 := v127.cf4;
			v89 := v90;
			v89 := |(fm9(v1[875], v1[875], globalState) + fm4(v90, 0x399, globalState))|;
		}
		
		var v128: map<int, multiset<int>> := map[|(seq(0xf7, i14  => (v90)))| := v95];
		var v129 := DC27(true, v128);
		v91 := !!v129.cf45;
		var v130: multiset<C3> := multiset{v98, v98, v98, v98};
		var v131 := DC30(885, -|v130|);
		v94 := v94[v91 <==> v1[875] := v131.cf51 + v89];
	}
	for i15 := 0x3a1 to -|v0| + 0xcb {
		var v133: set<int> := {|v0|, |(map v132 : int | (0x364 <= v132) && (v132 < 0x267) :: (v132 / v89) := (|multiset([{|v3|}])|))|};
		if (v133 > {v90}) {
			var v134: T1 := new C2(v1[875], v2);
			var v135: array<T1> := new T1[4] [v134, v134, v134, v134];
			v135[539] := v134;
			var v136: map<bool, T1> := map[v2 := v134];
			v135[539] := if (false in v136) then v136[false] else v134;
			v104 := v111.f10;
			v90 := v89 - (i15 / i15);
			v1[875] := v93.fm0(globalState);
		...
		var v144, v145 := v98.m2(v98.fm1(v105[762], v143, globalState), globalState);
		v145 := v2;
		v145 := v144 >= v90;
	}
	v2 := v1[875];
	match (DC27(v2, map v146 : int | (421 <= v146) && (v146 < 465) :: (v146 - v90) := (v95))) {
		case DC27(cf45, cf46) =>
			if (v2) {
				...
				var v148: multiset<string> := multiset{v105[762]};
				var v149 := DC1(v2, v3, v1[875]);
				var v150: map<char, int> := map[v111.f10 := v89];
				v1[875], v147, v89, v91, v89 := v148 > v148, v147, v111.fm2(v149, globalState), v3[if (v111.f10 in v150) then v150[v111.f10] else v90], v147.fm2(v149, globalState);
			} else {
				var v151: seq<array<int>> := [v102, v102, v102, v102, v102];
				cf45 := v151 < v151;
				v2 := !v91;
				v102[83] := |(multiset(v103) + v95)|;
				var v152: seq<D4> := [v108];
				var v153: T2 := new C1(v104, {v152, v152, v152}, true !in v3, v2);
				var v154: seq<T2> := [v153];
				v102[83], v153, v1[875] := 296, if (v91) then v154[|"xj"|] else v153, v1[875];
				var v155: multiset<char> := multiset{v104, v111.f10};
				v1[875] := v155 > v155;
				var v156, v157 := m4(v89, cf45, v105[762], globalState);
			}
			
			v1[875] := v111.fm0(globalState);
			var v158 := DC2(v104);
			var v159: map<int, char> := map[v89 := v158.cf3];
			v89, v89 := v89, (v89 / |v159|) % (v90 + v89);
			if (v91) {
				var v160 := new C0(v93.f12);
				var v161 := new C1(v111.f10, v111.f11, v1[875], cf45);
				v1[875] := if (v91) then v2 else v1[875];
				v1[875] := !v91;
				v2 := false;
			} else {
				var v162, v163 := v98.m2(!(v1[875] <==> v1[875]), globalState);
				v2 := true;
				var v164: multiset<bool> := multiset{v163, v91};
				var v165 := DC0();
				v111.m0(v164, v165, if (v2) then v163 else cf45, globalState);
				var v166: array<D8> := new D8[20](i17 => DC19(v1[875]));
				var v167 := DC19(cf45);
				v166[842] := v167;
				v166[842] := v167.(cf31 := v91);
				v89 := |v105[762]|;
			}
		...
		case DC28(cf47, cf48) =>
			...
			var v172 := DC26(v171);
			var v173 := new C2(DC34(v172, v105[762], v1[875]).cf59, v89 > v90);
			v97 := v97[cf47 := -v90];
			var v174 := DC1(v2, v3, v91);
			var v175 := new C2(v2, v3[v98.fm2(v174, globalState)]);
		case DC26(cf44) =>
			...
			var v180: set<string> := {v105[762]};
			var v182: map<T2, bool> := map[v177 := v2];
			v176, v179, v89, v105[762] := fm23(v2, set v181 : string | v181 in v180 :: (v181), v89 - |v182|, globalState), v179, |v3| / -v89, "qwk" + v105[762];
			var v183: C2 := new C2(v1[875], v2);
			var v184: multiset<C2> := multiset{v183};
			var v185 := DC1(v184 <= v184, v3, v1[875]);
			var v186: multiset<char> := multiset{v104};
			var v187: seq<C2> := [v183, v183, v183, v183, v183];
			v1[875], v91, v185, v90, v183 := true, (v1[875] <== v177.f9) ==> (v186 < multiset{fm7(v89, v177.f9, v90, globalState)}), v185.(cf0 := v2), v89, v187[v89];
			...
			v188[384], v1[875], v91, v189 := if (v1 in v190) then v190[v1] else v105, v2, v1[875], v189;
	}
	
	v1[875] := v91;
	var v191 := DC13(v91, true, v105[762], v91);
	match (v191.(cf24 := v91, cf22 := v1[875])) {
		case DC13(cf21, cf22, cf23, cf24) =>
			v1[875], cf22, v89 := !cf21, !v2, v98.fm2(DC1(!v3[v90], v3, v2), globalState);
			var v192: T1 := new C2(v2, cf21);
			v192 := if ((seq(-0x1d1, i18  => (v3))) == [v3, v3]) then v192 else v192;
			v91 := cf22;
			cf22 := v1[875] <== cf21;
		case DC12(cf20) =>
			v90 := -v90;
	...
	var v199 := DC17(v198);
	if (match if (v1[875]) then v199 else v199 {
		case DC18(cf28, cf29, cf30) => v2
		case DC19(cf31) => v95 !! v95
		case DC17(cf27) => !!(|v97| <= |DC24(v107).cf42|)
	}) {
		v105[762], v90 := v0, |(v103 + v103)| * v89;
		var v200: map<int, bool> := map[-452 := v91];
		var v201: multiset<map<int, bool>> := multiset{v200};
		v89, v90, v103, v90 := v90, v89 + -447, fm14(v90, v105[762], v2, globalState), -|((if (v91) then v201 else v201) - v201)|;
		var v202: map<C1, bool> := map[v111 := v91];
		v202 := v202[v111 := v1[875]];
		v1 := v1;
		v89 := -|(fm4(v89, v90, globalState) + ((seq(-0x2f1, i19  => (v111.f10))) + v0))|;
	} else {
		match (DC6(DC13(false, v91, v0, v91).cf22, -|v94|, v90)) {
			case DC6(cf7, cf8, cf9) =>
				var v203 := new C3(v2, v3[|v3|]);
				var v204, v205, v206 := v98.m1(v0, cf7, globalState);
				v2 := v90 >= (cf9 + cf9);
				var v207 := new C2(v206 || true, v206);
			case DC5(cf6) =>
				var v208: T2 := new C3(v1[875], v91);
				var v209 := DC36(v208);
				var v210: map<int, D14> := map[v89 / v89 := v209];
				v210 := v210[if (v1[875]) then v90 else v90 := v209];
				v102[989] := |(seq(0x8b, i20  => (v111.f10)))[v90 := v104]|;
				v102[989] := v89;
				v91 := (v90 * 0x3a1) >= -v89;
				var v211: map<bool, string> := map[v208.f9 := seq(-0x17f, i21  => (v111.f10))];
				v102[989] := |v211[v111.f10 !in (seq(0x19d, i22  => (v111.f10))) := v105[762] + v0]|;
		}
		
		var v212, v213, v214 := v111.m1(v105[762], v2, globalState);
		var v215 := DC31(v2, v1[875], v90);
		v89, v92, v1[875], v1[875] := v213 / v90, v92, v215.cf53, v214;
		var v216 := DC0();
		v98.m0(v196, v216, v2, globalState);
		v102[131] := v90;
		v102[131] := (390 / v213) % v89;
	}
	
	var v217: map<int, multiset<int>> := map[v89 := v95];
	var v218 := DC27(v1[875], v217);
	match (v218) {
		case DC27(cf45, cf46) =>
			v90 := v90;
			v1[875] := cf45;
			var v219 := DC31(cf45, cf45, |([v1[875]] + [v1[875], v2])|);
			cf45, v90, v219 := v90 == v90, -(v89 - (v90 % |v97|)), v219;
			v107 := v107[v91 && v1[875] := multiset{-0x3cd} !! multiset{v89}];
		case DC28(cf47, cf48) =>
			v102[395] := -(v89 * v89);
			v1[875], v102[395], v2 := ([v89, cf47] + v103) != v103, if (v2) then v89 else v89, v1[875];
			...
			match (v220) {
				...
				case DC31(cf52, cf53, cf54) =>
					v1[875] := (v95 + multiset(v103)) >= multiset{|v105[762]|};
					var v224, v225 := m4(|[v89]|, v91, "xexs", globalState);
					var v226, v227 := m4(v90, -v89 < v224, v105[762], globalState);
					v94 := v94[v91 := v224 - -cf47];
				case DC29(cf49) =>
					var v228: T1 := new C3(v2, v2);
					v228 := v228;
					var v229 := DC21(808, -v102[395]);
					var v230: array<int> := new int[26] [v89, 585, v90 + v102[395], v90, if (v89 in v97) then v97[v89] else v89, cf47, v89 + v89, |v105[762]|, v102[395] + v89, cf47, v90, |v0|, -v90 - v90, v102[395], -v102[395], |v3|, v90, cf47, cf47, v229.cf33 * v89, v89 + |(seq(0x1a5, i23  => (v111.f10)))|, v102[395] - v90, -0x1f7, -v102[395], cf47, v102[395]];
					v230, v89 := v230, v90;
					var v231: T2 := new C3(v228.f8, v1[875]);
					var v232: seq<D4> := [v108];
					v231 := new C1(v111.f10, v111.f11 - {v232, v232}, v1[875], v231.f9);
					var v233 := DC1(v2, v3, v228.f8);
					v2 := (!v228.f8 || v111.fm1(v105[762], v233, globalState)) <==> v1[875];
				case DC32(cf55) =>
					var v234: array<map<array<D9>, int>> := new map<array<D9>, int>[12];
					var v235: T1 := new C3(v1[875], v91);
					var v236 := DC23(v235, v2);
					var v237: array<D9> := new D9[15] [v236, v236, v236, v236, DC23(v235, !v2), v236.(cf41 := v2), v236, v236, v236, v236, v236, v236, v236, DC23(v235, !v1[875]), v236];
					var v238: map<int, C3> := map[v90 := v98];
					var v239: map<array<D9>, int> := map[v237 := |v238[|v3| := v98]|];
					v234[962] := v239;
					v234[962] := v239 + v239;
					v102[395] := v103[0x14a / cf47];
					v102[395] := v102[395] + -v102[395];
					var v240 := DC1(v235.f8, v3, v91);
					var v241, v242, v243 := v98.m1(v105[762], v98.fm1(seq(0x113, i24  => (v111.f10)), v240, globalState), globalState);
			}
			
			var v244 := new C2(!v1[875] && v91, v2);
			v1[875] := v2;
		case DC26(cf44) =>
			var v245: T0 := new C0(v92);
			var v246: map<int, bool> := map[|(v0 + v0)| := v1[875]];
			v91, v245, v1[875], v90 := v2, v245, if (v89 in v246) then v246[v89] else v91 <==> v91, v90 + |fm26(v94, v90, globalState)|;
			var v247 := DC1(v111.fm0(globalState), fm27(globalState), v1[875]);
			if (v93.fm1(v0 + v0, v247, globalState)) {
				...
				var v250: map<T2, bool> := map[v249[v89] := !false];
				v250 := v250[v248 := false];
				v102[968] := |"mnwoqpjhn"|;
				v102[968], v1[875], v89 := v90 / v89, v248.f9, v89 * v89;
			} else {
				v90 := v89;
				v91 := v91;
				...
				v251[609] := fm19(v2, v252.(cf3 := v111.f10), 589 + |v105[762]|, globalState);
				var v253: map<string, bool> := map[(fm4(v89, v89, globalState))[v90 := v111.f10] := v1[875]];
				var v254: map<int, map<string, bool>> := map[v89 * 0x1a4 := v253];
				v254 := v254[v90 % |"tbnxyymh"| := if (|v97| in v254) then v254[|v97|] else v253];
				var v255, v256, v257 := v98.m1(v105[762] + v0, v1[875] ==> false, globalState);
			}
			...
			if (v2) {
				...
				v1[875], v262, v0 := v263 !! v263, if ((if (v259.f8) then v91 else v1[875]) in v265) then v265[if (v259.f8) then v91 else v1[875]] else v262, v0 + (if (v102 in v266) then v266[v102] else v105[762]);
				var v267: seq<multiset<int>> := [v95];
				var v268: set<bool> := {v95 >= v267[v89], v2};
				v268 := v268;
				v89, v105[762] := v89, v0;
				v105[762] := v0;
