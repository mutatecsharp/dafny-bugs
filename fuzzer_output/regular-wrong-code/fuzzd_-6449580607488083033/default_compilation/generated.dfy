...
function fm0(p0: int, globalState: GlobalState): D0 {
	DC1(|[|{'m', 'd', 'v', 'x', 'l'}|, 0xd8]| * 0x38a, if (!true) then seq(0x36b, i0  => ('f')) else "jyfwejrpi", true, -|[|map['x' := 168]|]|, true)
}
...
function fm23(globalState: GlobalState): seq<bool> {
	[true, !true, true, !(-0x13a != |{653}|), !(-|multiset([!true])| in (seq(0x255, i0  => (|map[-|map[true := false]| := 125]|))))]
}
function fm24(p0: bool, globalState: GlobalState): set<int> {
	(set v0 : int | (0x253 <= v0) && (v0 < 298) :: (v0 % 642)) * ((set v1 : int | v1 in [|"pejhxpg"|, 0xa1] :: (v1 * -0x343)) + {0x18, -0x1dc, |map[0x106 := 'v']|})
}
...
function fm42(p0: seq<int>, p1: bool, p2: seq<seq<bool>>, globalState: GlobalState): map<int, bool> {
	map v0 : int | v0 in (multiset([0x350]) - multiset{|"y"|}) :: (v0 % -0x107) := (true)
}
function fm43(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState): map<int, int> {
	map v0 : int | (-0x1d0 <= v0) && (v0 < 0x22d) :: (v0 % -|[|multiset{false, true}|, |{false, true}|]|) := (0xc8)
}
function fm44(globalState: GlobalState): seq<multiset<int>> {
	(seq(0x11a, i0  => (multiset(seq(0x5e, i1  => (|map[!false := 0x148]|)))))) + ([multiset(seq(28, i2  => (|{true}|))), multiset{0x287, -625}, multiset([|map['k' := true]|]), multiset{0x285, 0x2dc, -|(seq(0x2b9, i3  => ('t')))|, |(set v0 : int | v0 in (seq(-0x303, i4  => (|[false]|))) :: (v0 + -|(seq(167, i5  => (|[-0x2b0]|)))|))|}, multiset{0x2af, |[true]|, -0x2e6}] + [multiset{|[-|[0x24a]|]|}])
}
method m0(p0: bool, globalState: GlobalState) returns (r0: int) {
		...
		decreases 100 - i0
	{
		...
		if (p0) {
			...
			var v5 := DC23();
			var v6 := "ehxqgq";
			var v7: multiset<int> := multiset{v3.f31, |(seq(614, i1  => ('k')))|, |v6|, 0x19b};
			var v8: map<bool, bool> := map[!v1.f32 := v1.f32];
			var v9: seq<bool> := [v1.f32, p0, p0];
			var v10: array<bool> := new bool[26] [fm5(v1.f32, v4, v3.f31, globalState), p0, -184 >= v3.f31, p0, p0, v1.f32, v1.f32, p0, p0, |{v5, v5}| <= v0, v0 < 0x16a, v1.f32, v0 > v0, p0, v1.f32, v7 == v7, v1.f32, |v6| == 0x90, v8 != v8[p0 := v9[v0]], |v6| < v3.f31, p0, v1.f32, p0, v1.f32, p0 ==> v1.f32, !(v3.f31 <= v3.f31)];
			v10, globalState.f1 := v10, !v9[v3.f31];
			var v11, v12 := v1.m7(v3.fm7(globalState), v2, v6, globalState);
		} else {
			var v13 := new C2(v0, !p0, v0 % v0);
			globalState.f0 := -v0;
			var v14 := "myjeh";
		...
		var v25 := "ww";
		var v26: seq<int> := [-(v24.f31 - |v25|), v0, v24.f31 % v24.f31];
		globalState.f0 := -|v26|;
	...
	var v29 := "hfda";
	var v30: array<int> := new int[11] [v0, v0 / v0, v0, (if (v0 in v28) then v28[v0] else v0) + v0, v0, v0 % v0, |multiset(fm44(globalState))|, v0, v0, |v29|, |"ewsm"| % v0];
	v30[194] := v0;
	v30[194] := v0;
	globalState.f0 := v0;
	v29 := "fba";
	globalState.f0 := |(seq(324, i2  => ('d')))|;
	if (!(p0 ==> !p0)) {
		globalState.f0 := v30[194] + (v0 / v0);
		var v31: map<seq<char>, int> := map[v29 := -v0];
		v31 := v31[v29 := 0x3ca];
		globalState.f2 := v30[194];
		var v32: map<int, bool> := map[v0 := p0];
		v32 := v32[|{p0, p0}| := p0];
		var v33 := DC0(true);
		var v34 := DC0(fm5(false, map[v33 := |v29|], v0, globalState));
		var v35: map<D0, int> := map[v33 := v30[194]];
		var v36: C3 := new C3("nj", !p0, p0, v30[194]);
		var v37: set<C3> := {v36};
		var v38: seq<bool> := [false];
		var v39: array<bool> := new bool[23] [v36.f30, v38[v30[194]], p0, v36.f30, v36.f30, v36.f30, p0, p0, v36.f30, p0, false, v36.f30, p0, v36.f30, !v36.f30, true, v36.f30, !p0, p0, v36.f30, p0, p0, p0];
		var v40: C0 := new C0(v29, fm5(!p0, v35, v30[194], globalState), |v37|, v39, v36.f30);
		var v41 := DC39(DC38());
		var v42: C2 := new C2(v30[194], false, |map[fm5(p0, v35, |v38|, globalState) := v36.f30]|);
		var v43 := DC37(v42);
		var v44: seq<D17> := [v41.cf64, v43, v43, v43];
		var v45: seq<string> := [v40.f35];
		v40, v41, v38, globalState.f2, globalState.f0 := v40, v41.(cf64 := v44[v30[194]]), (v38 + v38) + v38, v30[194], -(v30[194] % v0) - (|v45| * v30[194]);
	} else {
		var v46 := 'r';
		v46 := v46;
		var v47: array<C0> := new C0[3];
		v47 := v47;
		var v48: seq<string> := [seq(794, i3  => (v29[v30[194]])), v29];
		...
		v52[70] := multiset{-v30[194]} >= v28;
		v52[70] := p0;
		var v53: C1 := new C1(v52[70]);
		var v54 := DC24(v0, v53, v46);
		var v55 := DC24(v30[194], v54.cf37, v46);
...
class C0 extends T0, T1, T2 {
	...
	method m1(p0: multiset<int>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool) {
		globalState.f2 := f26;
		var v0: multiset<string> := multiset{f35, seq(449, i0  => ('u'))};
		...
		var v5: map<array<int>, int> := map[v4 := f26 % 574];
		var v6: map<bool, seq<array<bool>>> := map[f25 := v2 + (v2[396 := f33])[|f35| := f33]];
		var v7: map<int, int> := map[f26 := f26];
		var v8: map<int, bool> := map[|v7| := p1];
		v1[429], globalState.f1, v3[289], v5 := if ((if (f26 in v8) then v8[f26] else f34) in v6) then v6[if (f26 in v8) then v8[f26] else f34] else v2 + [f33, f33], f25, f35, v5;
		v4[197] := f26 % |v3[289]|;
		r0, v4[197], r0 := p1, -f26, p2;
		globalState.f2 := f26 / (v4[197] * v4[197]);
		var v9: map<bool, int> := map[f34 := f26];
		globalState.f2 := if (v9 != map[f34 := |v3[289]|]) then f26 else |[!f34]| - v4[197];
		r0 := p2;
	}
	method m9(p0: multiset<bool>, globalState: GlobalState) returns (r0: char, r1: array<bool>) {
			...
			decreases 100 - i0
		{
			...
			f33[435] := f34;
			globalState.f0, f33[435], globalState.f1, globalState.f2 := -0xbc % -f26, f34, f34, if (f26 <= f26) then f26 else f26;
			var v0: seq<int> := [f26];
			globalState.f2 := fm2(if (f34) then v0[fm16(globalState)] else -0x21, -|v0|, globalState);
			var v1: set<bool> := {f33[435], f33[435]};
			var v2: map<int, int> := map[f26 := |v1|];
			var v3 := DC7(f25, f34, if (f26 in v2) then v2[f26] else v0[f26]);
			var v4: array<D2> := new D2[21] [v3, v3, v3, v3, v3, v3, DC7(f34, f33[435], f26), v3, DC7(f25, f33[435], 0x1ba), v3, v3, v3, v3, v3, if (f25) then v3 else v3, v3, v3, v3, v3, v3, v3];
			v4[703] := v3;
			v4[703] := v3;
		}
		var v5: map<int, multiset<bool>> := map[f26 % f26 := p0];
		v5 := v5[|(p0 * p0)| := p0[f25 := f26]];
		f34 := f34;
		f34 := f34;
		var v6: map<int, int> := map[f26 := f26];
		var v7: map<bool, map<int, int>> := map[f25 := v6];
		for i1 := -(fm6(f25, f25, f26, globalState) + f26) to (if (f25 in p0) then p0[f25] else |v7|) % f26 {
...
class C1 {
	...
	function fm14(p0: set<bool>, p1: int, globalState: GlobalState): bool {
		("ehss" + (seq(556, i0  => ('t')))) < "kbxgttvgb"
	}
	function fm15(p0: multiset<string>, p1: int, p2: D1, p3: int, globalState: GlobalState): int {
		|(seq(0x3c7, i0  => (0x284)))| * |[|(seq(0x2d7, i1  => ('v')))|, -0x3cb, |(seq(-0x1ac, i2  => ('s')))|, |(seq(0x38b, i3  => ('f')))|, 943]|
	}
	method m7(p0: bool, p1: D0, p2: string, globalState: GlobalState) returns (r0: D3, r1: map<int, bool>) {
		...
		v0[20] := if (v1 in v2) then v2[v1] else f32;
		v0[20] := f32;
		var v3 := "qby";
		v3 := p2;
		var v4 := 0xee;
		...
		if (fm5(!f32, v5, v4, globalState)) {
			...
			v0[20] := v6[v4 := f32] == (v6 + v6);
			globalState.f2, v0[20] := v4, !DC1(v4, p2, f32, -v4, p0).cf5;
			globalState.f1 := f32;
			...
			var v9: map<bool, int> := map[v0[20] := 0x15b];
			...
			var v13: multiset<map<bool, int>> := multiset{v9[v0[20] := v4]};
			...
			if (v15 in v16) {
				...
				var v19 := new C0((v18.(cf5 := f32)).cf2, "yggum" != v3, v4, v0, v0[20]);
				globalState.f1 := p0;
			} else {
				globalState.f0 := v4;
				v1 := v1;
				var v20: seq<bool> := [f32];
				var v21: array<int> := new int[10] [0xe0 - v4, v4, 0x3a3, v4, v4, v4 - -173, |p2|, v4, |v20| / v4, -v4];
				var v22 := DC1(0x317, v3, f32, v4, true);
				v21[661] := fm2(v4, v22.cf1, globalState);
				...
				var v29: seq<D0> := [p1];
				v21[661], v24, v0[20], globalState.f2 := v4, (if (v0[20] in v25) then v25[v0[20]] else v24) + map[v21 := (map v26 : int | v26 in v28 :: (v26 - v4) := (v4))[617 := v4]], |v29| > v4, v4 + v4;
				v9 := v9 + v9;
				v3 := seq(-795, i2  => (v1));
			}
		...
		var v34 := DC4(fm14(v33, 0x266, globalState), v0[20]);
		...
		var v36: seq<bool> := [p0, v1 in v3, f32, v0[20]];
		v36 := fm23(globalState);
		var v37: map<bool, int> := map[v0[20] := v4];
	...
	method m8(p0: array<bool>, p1: bool, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		for i0 := |"vfgmwfj"| / p2 to p2 {
			var v2: seq<bool> := [f32, f32, p1, p1, p1];
			var v3: set<int> := {p2};
			globalState.f1 := v2[|(v3 - v3)|];
		...
		if (p1) {
			if (p1) {
				...
				globalState.f0, globalState.f1, globalState.f2, r0, globalState.f1 := |fm1(globalState)|, p1 <==> p1, if (p1) then p2 % -p2 else p2, if (p2 in v5) then v5[p2] else v4, |v6| == 0x71;
				...
				globalState.f1, v7, v0, globalState.f1 := if (v9 !! v9) then f32 || p1 else true, v7, v0, (seq(0x13, i1  => (v0))) <= "h";
				globalState.f0 := |((seq(-0xf8, i2  => (v0)))[p2 := v7.f35[p2]])[p2 * p2 := v7.f35[--p2]]|;
				...
				var v19 := DC12(v12);
				globalState.f2, v12, v16[28], v18 := -p2, v19.cf19 - v12, v13, (v18 + v18) * v18;
			...
			p0[708], v25 := p1 <==> (p2 != |v23|), v25;
		} else {
			var v26: array<int> := new int[15];
			v26[113] := p2;
			var v27 := "scemdf";
			v26[113], globalState.f0 := -|(v27 + (v27 + (seq(0xc3, i4  => (v0)))))|, p2;
			globalState.f2 := p2;
			if ((p2 % 0x294) <= v26[113]) {
				r1 := false;
				...
				v28[493] := 'h';
				v28[493] := v0;
				var v29: set<int> := {v26[113]};
				globalState.f1 := |(v29 + {v26[113]})| > v26[113];
				...
				v30[834] := if (multiset{v33} == multiset{DC12(v34), v33}) then v31 + v31 else v31 + [f32, f32];
				globalState.f1 := f32;
			} else {
				var v35: set<bool> := {p1};
				var v36: C0 := new C0(v27, fm14(v35, v26[113], globalState), -p2, p0, p1);
				var v37: set<C0> := {v36};
				v37 := v37;
				globalState.f2 := v26[113];
				v35 := v35;
				v26[113] := p2 * -v26[113];
		...
		match (v46) {
			case DC4(cf7, cf8) =>
				if (v43[p2]) {
					...
					v52[533] := p2;
					var v53: set<bool> := {p0[816], cf8, f32};
					var v54: set<bool> := {f32, fm14(v53, p2, globalState)};
					var v55 := DC1(p2, "jcg", !p0[816], p2, fm14(v53, p2, globalState));
					v0, v52[533] := fm4(v55, p0[816], p2, globalState), p2;
					var v56: map<bool, bool> := map[f32 := v44 <= v44];
					var v57: array<seq<bool>> := new seq<bool>[20] [v43, v43 + v43[v52[533] := p1], v43, [!f32], [cf7], v43, v43, v43, ([f32, v43[v52[533]]])[v52[533] := p0[816]], v43 + [cf7], v43, v43, v43, v43, [true], v43, v43, v43, v43, v43];
					v57[586] := v43;
					v52[533], cf7, v56, v57[586] := p2, cf7, v56, v43;
				} else {
					var v58: map<bool, int> := map[p1 := 0x261];
					globalState.f0 := p2 / (if (!f32 in v58) then v58[!f32] else -p2);
					var v59: array<array<bool>> := new array<bool>[3];
					v59[148] := p0;
					v59[148] := p0;
					globalState.f0 := p2 + p2;
					globalState.f0 := -0x211 % (fm2(p2, |map[625 := false]|, globalState) * p2);
					v59[148][478] := p1;
					var v60 := "d";
					var v61: T0 := new C0(v60 + v60, f32, p2 % p2, v59[148], true);
					var v62: C0 := new C0(v60, false, p2, p0, f32);
					var v63 := DC14(v61.f26, |map[f32 := v43]|, multiset{!cf7});
					v59[148][478], globalState.f0, v61, v62 := v63.cf23 != p2, v61.f26 - v61.f26, v61, v62;
				}
				...
				globalState.f1 := f32;
			case DC3(cf6) =>
				var v65, v66 := m7(p1, v39, seq(0x29a, i9  => ('x')), globalState);
				var v67: set<bool> := {p1};
				var v68 := DC9(v67 + v67);
				match (v68) {
					case DC10(cf16, cf17) =>
					...
					case DC9(cf15) =>
						...
						var v76: map<bool, seq<C0>> := map[v43[p2] := v75[p2 := v74] + v75];
						v76 := v76[p1 := v75];
						var v77: array<int> := new int[29](i10 => i10 / p2);
						var v78: array<array<int>> := new array<int>[4] [v77, v77, v77, v77];
						v78 := v78;
						var v79: multiset<bool> := multiset{f32};
						var v80 := DC14(|multiset(seq(0x3f, i11  => (cf6)))|, p2, v79);
						var v81: set<int> := {p2};
						var v82 := DC13(v80.cf23, -119, v81);
						var v83: map<bool, int> := map[f32 := p2];
						v82 := DC13(if (!!true in v83) then v83[!!true] else 0x2aa, |v43| % p2, v81);
						globalState.f2 := p2;
				}
				...
				if (f32) {
					...
					v92 := v92;
					v92[509] := v91;
					globalState.f1, v92[509] := (p2 + 724) != p2, v91;
					r1 := (|v67| > p2) <==> p1;
					var v93: array<int> := new int[17](i12 => i12 % -966);
					v93[307] := -p2;
					v93[307] := p2 + |(seq(0x1de, i13  => (cf6)))|;
					v93[307], v93[307] := -988, p2;
				}
			...
			case DC5(cf9) =>
				...
				var v97 := DC10('o', 'p');
				var v98: array<char> := new char[26] [v0, v0, 'i', v0, v0, v0, v97.cf16, v0, v0, v0, 'b', v0, 's', v0, 'o', 'x', v0, v95.f35[p2], v0, v0, v0, v0, v0, v0, v0, v0];
				...
				v101[456] := p2;
				p0[796] := v43 < [p1, p1];
				v101[456], p0[796] := p2 * (|v95.f35[439 := v0]| * p2), false;
				globalState.f1 := p0[796] <==> p1;
		}
...
class C2 extends T0 {
	...
	method m1(p0: multiset<int>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool) {
		for i0 := f31 to f31 {
			...
			var v5: set<int> := {|p0|};
			var v6 := DC6({f26});
			globalState.f1, v1, globalState.f0, globalState.f1 := f25, v1, fm6(p2, if ((if (f26 in v4) then v4[f26] else i0) in v2) then v2[if (f26 in v4) then v4[f26] else i0] else p2, f26 / i0, globalState), v5 == (v6.cf10 - v5);
			var v7 := DC0(true);
			var v8: map<D0, int> := map[v7 := f26];
			globalState.f2 := if (!!fm5(p1, v8, |(set v9 : char | v9 in (seq(-0x76, i1  => ('p'))) :: (v9))|, globalState)) then i0 else f26;
		...
		for i3 := f26 to f26 + f26 {
			...
			match (v30) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					globalState.f1, v25, globalState.f2, globalState.f0, cf3 := v38 != (v38 + v38), {cf1, f26, 0x3c0 / cf4}, if (v35[607]) then f26 else f31 - cf4, f31, false;
				case DC2() =>
				...
				case DC0(cf0) =>
					...
					globalState.f1 := v48 == (([v47, v47, v47, v47])[|v49| := DC15([p1])] + v48);
			}
			
			var v50: multiset<bool> := multiset{!p1, true};
			var v51: map<D0, int> := map[DC0(p2) := |v50|];
			var v52: seq<string> := [seq(0x3a0, i4  => (v11[|"ferpotds"|]))];
			if (fm5(p1, v51, f31, globalState) && (-0x36b > |v52[f26]|)) {
				var v53: map<int, bool> := map[i3 := v28[i3]];
				var v54 := 'r';
				var v55: array<int> := new int[12] [-f26, f31, f26, |(v53[f31 := f25] + v53)|, -f26 % f26, if (0x39e in p0) then p0[0x39e] else f31, |(("b")[f31 := v54])[f26 := 's']|, i3, f26 / f31, i3, f31, fm2(i3, -0x96, globalState)];
				v55[590] := if (p1) then f31 else |[f26, i3]|;
				v55[590] := i3;
				var v56: array<bool> := new bool[23](i5 => p2);
				var v57 := new C0(v11, f25, 0x128, v56, p2);
				v56[555] := p2;
				var v58 := DC0(p2);
				v56[555] := f25 && fm5(f25, v51[v58.(cf0 := p1) := v55[590]], f26, globalState);
				var v59: seq<array<bool>> := [v56];
				var v60: seq<array<bool>> := [v59[f31]];
	...
	method m5(p0: bool, p1: D1, p2: char, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		v0, globalState.f0, globalState.f1, v1[303] := if ((f25 <== p0) in v3) then v3[f25 <== p0] else v0, -(if (f25) then |(v4 + v4)| else f31), v5[-f31] > v7[v6 := f31], if (fm5(f25, v8, f31, globalState)) then p2 in (seq(0x107, i0  => (p2))) else f25;
		for i1 := f31 to f31 {
			...
			var v13 := new C0(v4, !(f26 > f31), |(v4[0x1b6 := if (v10 in v12) then v12[v10] else p2])[i1 := p2]|, v1, !f25);
			v1[303] := !f25;
			var v14: map<bool, int> := map[v1[303] := i1];
			var v15: multiset<map<bool, int>> := multiset{map[v1[303] := f31], v14[v1[303] := -0x2b3]};
			var v16 := DC8(v15);
			match (v16.(cf14 := multiset{v14})) {
				case DC8(cf14) =>
					...
					var v19: seq<bool> := [!p0];
					v19, globalState.f0, v1[303] := v19, i1, v17 > (v17 * v17);
					globalState.f2 := (f26 - f26) / f31;
		...
		var v22: multiset<bool> := multiset{f25, f25, v1[303]};
		...
		for i3 := f31 to |map[f31 := f26]| {
			...
			v21[236][170] := i3;
			v21[236][77] := f26;
			var v30: map<char, bool> := map[p2 := fm5(v1[303], v8, f26, globalState)];
			var v31: set<map<char, bool>> := {v30, v30, v30};
			var v32: multiset<int> := multiset{-|v31|, f26, -0x1e9};
			globalState.f2, globalState.f0, v21[236][170], v21[236][77] := f26, if (p0 in v22) then v22[p0] else f31, f31 * i3, i3 % |v32|;
			var v33 := new C1(v1[303]);
			var v35: map<string, string> := map[v4 := v4];
			var v36: map<int, int> := map[fm11(v35, |(seq(0xa9, i4  => (DC19(DC14(|map[i3 := f31]|, f31, v22)))))|, i3, globalState) := |v32|];
			var v37 := m6((map v34 : int | v34 in v32[f26 := f31] :: (v34 + v21[236][170]) := (i3)) + v36, v21[236][170], f31, globalState);
		}
		globalState.f0 := -f26;
		var v39: seq<int> := [0x321];
		var v40 := DC1(f26, "ac", v1[303], |v23|, fm5(v1[303], v8, |(map v38 : int | v38 in v39 :: (v38 - 0x26b) := (p0))|, globalState));
		var v41: map<int, bool> := map[fm2(|v4|, |v23|, globalState) := p0];
		if (|(v40.(cf4 := f31, cf5 := p0, cf1 := |v41|)).cf2| >= f26) {
			v1[303] := -f31 != f31;
			globalState.f1 := f25;
			globalState.f0 := f26 % (-f26 + f31);
			v21[236][189] := f31;
			v21[236][189] := f26;
			...
			var v48: map<bool, map<array<int>, D9>> := map[v1[303] := v47];
			v48 := v48[v1[303] := v47];
			var v49: C1 := new C1(f25);
			v21[236][294] := |v22|;
			v49, globalState.f1, v21[236][294], v21[236] := v49, !p0, f26, v29;
			var v50: map<bool, bool> := map[fm7(globalState) := v49.f32];
			var v51: map<int, map<bool, bool>> := map[v39[f31] := v50];
			var v52 := DC19(v43);
			var v53: map<map<bool, bool>, D9> := map[if (!v1[303]) then v50 else if (f31 in v51) then v51[f31] else v50 := v52];
			v53 := v53;
		}
		
		r0 := !(v23 == [v1[303], v1[303]]);
	...
	method m6(p0: map<int, int>, p1: int, p2: int, globalState: GlobalState) returns (r0: bool) {
		...
		if (if (false) then f25 else fm5(f25, map[DC0(f25) := p2], 726, globalState)) {
			...
			var v5: seq<seq<int>> := [v2, v2, seq(218, i1  => (f26))];
			var v6: seq<bool> := [f25];
			var v7: array<seq<int>> := new seq<int>[26] [v2[f26 := f26], v2 + v2, v2 + v2, v2 + v2, v2, v2, fm3(p1, false, p2, f25, globalState), v2, v2 + v2, v2, v2, [p2, p2, p1], v2, v2, v2, v2, (v2 + v2)[v4.cf20 := 0x17f], v2 + v2, v2, [327, f31, p2, f26] + (seq(-0x2a7, i0  => (f26))), [f26, p1, p1], (v2 + v2)[0x128 := p1], v5[|v6|], v2 + (seq(0x2d3, i2  => (f26))), v2, v2];
			v7[161] := v2;
			var v8: multiset<bool> := multiset{true};
			v7[161] := (v5[f31 * f26])[|v8[f25 := -f26]| := f31];
			...
			if (!f25) {
				...
				v17 := v18;
				v12[872] := if (f25) then v14.f32 else f25;
				var v19: set<string> := {v13.f35};
				v10, globalState.f1, v15[408], v12[872] := (f31 / v9) % f26, v14.f32, 0x2d7, v19 > (v19 * v19);
			} else {
				var v20: map<int, seq<bool>> := map[if (v9 in v1) then v1[v9] else -0x258 := if (f25) then v6 else v6];
				v20 := (map v21 : int | v21 in v7[161] :: (v21 - -p2) := (v6))[|v7[161]| / p1 := v6];
				globalState.f1 := f25;
				v7 := v7;
			...
			var v23: array<int> := new int[13](i4 => i4 % -p2);
			v23[361] := f31 - p2;
			v23[361] := if (f25) then -p2 else f26;
			var v24 := "pwperytjt";
			var v25: map<bool, int> := map[f25 := p2];
			match (fm28(v24, v24[f31], |map[f25 := (map[f25 := p2])[f25 := if (f25 in v25) then v25[f25] else f31]]| % fm2(p1, -|v25[f25 := v23[361]]|, globalState), globalState)) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					var v26: array<bool> := new bool[27](i6 => cf5);
					var v27: T1 := new C0(seq(0x2ad, i5  => (v0)), cf3, p2, v26, f25);
					var v28: seq<T1> := [v27];
					...
					var v38: map<D2, multiset<map<int, bool>>> := map[v32 := (multiset{map[-923 := cf5]})[v34 := cf1] - v37];
					...
					v23[361] := f26 * -cf4;
				case DC2() =>
					var v42: map<int, bool> := map[v23[361] := p1 == v23[361]];
					v42 := v42[-(f26 / f31) := !f25];
					...
					v52 := v52;
					var v53: map<int, char> := map[956 := v24[f31]];
					var v54 := DC10(v0, v0);
					v53 := v53[p1 := v54.cf16];
				case DC0(cf0) =>
					...
					var v57: array<bool> := new bool[23] [cf0, f25, f25, f25, f25, !cf0, f25, cf0, f25, p1 != v23[361], cf0, cf0, f25, false, !cf0, cf0, f25, cf0, cf0, true, |{|v56|}| in p0, cf0, cf0];
					v57[671] := f25;
					v57[671] := v24 == v24;
			...
			decreases 100 - i8
		{
			...
			var v64: seq<int> := [|v63| / f31];
			globalState.f0 := v64[761];
			var v65: set<int> := {fm2(-0x14e, f31, globalState), p1};
			if (!!(v65 !! v65)) {
				var v66: seq<bool> := [f25, f25, f25, f25];
				var v67 := "ynxpxku";
				var v68: map<int, string> := map[p2 := v67];
				var v69: map<int, bool> := map[|(if (-0x3 in v68) then v68[-0x3] else seq(0x0, i9  => ('n')))| := f25];
				var v70: map<bool, int> := map[f25 := p2];
				var v71: seq<map<bool, int>> := [v70, v70];
				var v72 := DC15((v66[-|v69| := f25])[807 := f25] + v66[|v71| := f25]);
				v72 := v72;
				var v73: multiset<char> := multiset{v0, v0, if (f25) then v0 else v0};
				var v74 := DC1(f31, v67, f25, f31, f25);
				var v76: set<bool> := {f25, true};
				var v77: array<int> := new int[13] [p2 / p1, if (f25) then f31 else p1, p1, f26, v74.cf4, 0x16, f26 * f31, p2, |(map v75 : int | v75 in p0 :: (v75 * f26) := (!f25))|, |v64| * p2, f31, |v76| - f31, f31];
				v77[605] := p1;
				var v78 := DC7(f25, f25, p1);
				v73, globalState.f2, v77[605], globalState.f1, r0 := v73, v78.cf13 - p1, f26, f25 <== !(if (!f25) then f25 else f25), fm7(globalState);
				var v79: seq<string> := [v67, v67];
				v67 := v67 + (v67 + (v79[--0x19e])[|v67[|v67| := v0]| := v0]);
				var v80: multiset<bool> := multiset{f25};
				v80, globalState.f1, v76 := v80[f25 := p2] - v80, !!f25, v76 * v76;
				var v81 := DC13(0x3de, p1, {f26, v77[605], |v67|});
				...
				v89[973] := map v90 : seq<int> | v90 in v91 :: (v90) := (f25);
				var v92: set<bool> := {v87.f34};
				var v93: map<int, seq<int>> := map[p2 := [p2, |v83|]];
				globalState.f0, v87, v86[918], globalState.f2, v89[973] := f31, v87, f25, (if (f25) then p2 else DC7(true, v87.f34, |v92|).cf13) * p2, map[if (-64 in v93) then v93[-64] else v64 := true] + map[v64 := f25];
				var v94: map<string, string> := map[v83 := v83];
				v94 := v94;
				var v95: array<int> := new int[7];
				v95[508] := p2;
				v95[508] := f31;
				var v96 := DC4(v86[918], true);
				globalState.f0 := fm2(if (v96.cf7) then v95[508] else p1, v95[508], globalState);
			...
			v100 := v100[|multiset{v98}| := {v101[p1], f25} - fm29(fm7(globalState), p0, v0, f26, globalState)];
			v99 := v99;
		}
		var v102 := m0(f25, globalState);
		var v103 := DC11(multiset{fm2(|multiset{p2}|, f31, globalState)});
		var v104: seq<int> := [f26];
		var v105: multiset<int> := multiset{v104[f26]};
		var v106: array<D5> := new D5[17] [v103, v103, v103.(cf18 := v105), v103, v103, v103, fm30(globalState), v103, v103, fm30(globalState), v103, v103.(cf18 := v105), v103, DC11(v105[p1 := f26]), v103, v103, v103];
		var v107 := "nnxuic";
...
class C3 extends T0 {
	...
	method m1(p0: multiset<int>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool) {
		...
		if (if (if (if (true in v1) then v1[true] else f25) then true else f30) then f25 else p2) {
			...
			var v5: array<array<bool>> := new array<bool>[26] [v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, if (f30) then v3 else v3, v4[f26], v4[f26]];
			...
			v10[41] := v11[f26 := fm5(f30, v13, f26, globalState)];
			v10[41] := [p1];
			var v14 := DC1(|(seq(0x2b1, i1  => (v0)))|, f29, f30, f26, p2);
			...
			decreases 100 - i2
		{
			...
			var v23: multiset<seq<bool>> := multiset{v22[f26], v21, v21};
			v20[723] := !(v21 !in v23);
			if (!p1) {
				var v24: map<string, int> := map[f29 := f26 + f26];
				var v25: array<seq<int>> := new seq<int>[4];
				v25[587] := fm3(973, v20[723], f26, f30, globalState);
				var v26: seq<int> := [f26, |[f26]|];
				v24, v25[587] := v24, v26;
				var v27: array<char> := new char[15];
				v27[840] := v0;
				var v28: set<bool> := {f26 >= f26};
				v20, v21, v27[840], globalState.f0, v28 := v20, v21 + v21, (DC10(v0, v0).(cf17 := v0)).cf17, f26, v28;
				var v29: map<array<bool>, bool> := map[v20 := v20[723]];
				var v30: seq<map<array<bool>, bool>> := [v29, v29, v29, v29, v29];
				var v31 := new C2(f26, false <== f25, |v30[f26]| * |v21|);
				v0 := v27[840];
				v25[587] := (if (p1) then v26 else v25[587]) + v25[587];
			} else {
				var v32 := DC0(p2);
				var v33: map<D0, int> := map[v32 := 0x289];
				var v34: map<int, int> := map[0x146 := -|f29|];
				var v35: multiset<bool> := multiset{v20[723], fm5(f25, v33, if (f26 in v34) then v34[f26] else f26, globalState)};
				globalState.f1 := !(true in v35);
				var v36: array<int> := new int[22];
				var v37: seq<array<int>> := [v36];
				v36 := if (fm5(p1, v33, f26, globalState)) then v36 else v37[f26];
				var v38: array<set<char>> := new set<char>[17];
				var v39: map<int, multiset<bool>> := map[f26 := v35];
				var v40 := DC14(f26, f26, if (0x31c in v39) then v39[0x31c] else v35[f25 := f26]);
				var v41 := DC19(v40);
				var v42 := DC20(v41);
				var v43 := DC1(-0x3d1, f29, p1, f26, v21[f26]);
				var v44: map<D9, set<char>> := map[v42 := {v0, fm4(v43.(cf5 := p1, cf4 := f26, cf3 := p1), v20[723], f26, globalState), v0, v0}];
				var v45: set<char> := {v0, v0};
				v38[404] := if (v42.(cf32 := v42.cf32) in v44) then v44[v42.(cf32 := v42.cf32)] else v45;
				v38[404] := fm31(globalState);
				v36[952] := f26;
				v36[952] := 0x271;
				var v46: seq<int> := [f26];
				var v47: set<bool> := {fm7(globalState), p1};
				var v48: array<seq<int>> := new seq<int>[21] [v46, fm3(v36[952], false, f26, true, globalState), v46 + v46, [352], v46, v46, v46, v46, v46, fm3(f26, p2, |v47|, false, globalState), [f26, v36[952], 784] + v46, v46, v46, [f26, f26] + v46, v46, v46[f26 := f26], v46, v46, [-f26], v46, [v36[952]]];
				v48[689] := v46;
				v48[689] := v46;
			}
			
			var v49 := new C2(0x90, p2 <==> f25, f26 * f26);
			var v50: map<bool, int> := map[v20[723] := f26];
			v50 := v50[p1 := -v49.f31];
		}
		globalState.f0 := f26;
		var i3 := 0;
		while (|[true]| >= (f26 / fm2(f26, f26, globalState)))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
		...
		r0 := ((if (f26 in v63) then v63[f26] else v62) + v62) <= (seq(0x130, i7  => (v61)));
	}
	method m4(p0: int, p1: bool, p2: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		match (fm32(globalState)) {
			case DC10(cf16, cf17) =>
				...
				var v14: array<int> := new int[21] [f26, |v9|, v5.f26, f26, -(if (v11 in v12) then v12[v11] else v5.f26) + f26, if ("gesulblvl" in v13) then v13["gesulblvl"] else -v5.f26, f26, if (f30) then |v3| else p0, v5.f26, p0, v8[v5.f26], v5.f26, -274, |v8|, |(f29 + f29)|, f26, 312 - v5.f26, p0, fm6(f25, f25, 0x84, globalState), |map[f25 := p1]| - v5.f26, f26];
				v14[661] := p0;
				v14[661] := |(f29 + "ix")|;
				var v15: set<int> := {if (p2) then v14[661] else v5.f26};
				var v16: map<int, string> := map[v5.f26 := fm1(globalState)];
				var v17: seq<bool> := [p1, p2, p1, |v16[v14[661] := f29]| < v5.f26];
				var v18: array<D6> := new D6[9];
				var v19 := DC13(fm2(fm2(f26, 0x66, globalState), v14[661], globalState), v5.f26, v15);
				v18[649] := v19;
				v15, v2, v17, v18[649], cf16 := v15, v2, [v5.f25], v19.(cf21 := v14[661]), cf16;
				v14[661] := v14[661];
				globalState.f1 := p2;
			case DC9(cf15) =>
				...
				v21[717] := (|v22| + p0) !in multiset{|v24|};
				var v25 := new C1(p1);
				var v26 := new C2(p0, v21[717], -0xc);
		}
		...
		for i2 := if (p2) then 606 else f26 to p0 {
			...
			v27[712] := if (fm21(f29, f26, p0, globalState) in v29) then v29[fm21(f29, f26, p0, globalState)] else |(seq(833, i3  => (i2)))| % |f29|;
			...
			if (v32 > multiset{v31, v31}) {
				...
				var v34: seq<map<bool, int>> := [map[false := v27[712]]];
				v33[926] := v34;
				v33[926] := v34;
				var v35 := DC0(f30);
				globalState.f1 := fm5(f30, map[v35 := f26], f26, globalState);
				var v36: set<int> := {v27[712]};
				...
				globalState.f2 := |v40| * (if (p2) then v27[712] else 0x2d0);
				var v41 := "pq";
				var v42: multiset<string> := multiset{v41, f29, f29};
				var v43: set<int> := {v27[712]};
				...
				var v46 := DC21(v45);
				v41, v44[540], v27[712], v45, globalState.f1 := f29 + f29, true, -0xa9 / (-v27[712] * i2), v46.cf33, f25;
				var v47: seq<array<int>> := [v27];
				v47 := v47[v31.f31 := v27] + (v47 + v47);
				globalState.f1 := !f25;
				var v48 := DC0(v44[540]);
			...
			var v51: seq<bool> := [p1];
			r2, v49[398], v50 := v51 < [f30, f30], v31.fm7(globalState), v50;
		}
		if (f25) {
			...
			globalState.f1 := f26 < f26;
			var v59: array<int> := new int[1](i7 => i7 % p0);
			v59[303] := f26;
			v59[303] := (0xdd % p0) % f26;
			r0 := f26;
			...
			v64 := v64;
			var v65: array<int> := new int[7](i9 => i9 % 843);
			var v66: array<seq<string>> := new seq<string>[5](i10 => [f29, f29, seq(0x80, i11  => ('t'))]);
			...
			v65, v66[56], r2, r2, v68 := v65, if (fm7(globalState)) then v67 else v67, f25, fm5(v69 !! fm21("ncdfeu", f26, f26, globalState), if (false) then v70 else map v71 : D0 | v71 in (map v72 : D0 | v72 in v74 :: (v72) := (|map[f30 := f30]|)) :: (v71) := (|f29|), f26 * (if (f26 in v64) then v64[f26] else -f26), globalState), v68;
			var v75: array<set<D2>> := new set<D2>[12];
			v75 := v75;
			var v76: array<bool> := new bool[22];
			v76[734] := f25;
			v76[734] := fm2(p0, --|v67[0x215]|, globalState) >= f26;
			var v77: set<int> := {|{false, f25, p1}|, p0};
			var v78: seq<bool> := [{f26} !! v77, true];
			var v79: C0 := new C0(f29, v76[734], f26, v76, false);
		...
		v82 := v82[|((seq(-0x3d0, i12  => (f26))) + v83)| := p0];
		var v84: array<bool> := new bool[3](i13 => (seq(0x27e, i14  => ('h'))) == f29);
		v84[882] := p1;
		v84[882] := !f30;
		for i15 := p0 to f26 % -f26 {
			var v85: array<set<bool>> := new set<bool>[24](i16 => {false} - {v84[882]});
			var v86: map<int, bool> := map[|v83| := f25];
			var v87: set<bool> := {if (i15 in v86) then v86[i15] else f30};
			v85[58] := v87 + {f30};
			v85[58] := v87 * v87;
			var v88: map<bool, bool> := map[p2 := v84[882]];
			r2 := if (f25 in v88) then v88[f25] else v84[882];
			var v89: seq<bool> := [v84[882]];
			var v90: set<int> := {p0, i15, |multiset(v89[p0 := true])|};
...
class C4 extends T0 {
	...
	method m1(p0: multiset<int>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool) {
		...
		if (v0[f27]) {
			...
			var v5: array<bool> := new bool[25] [true || p2, p2, f25, p2, f25, f25, !p1, !p1, true, true, p1, {"wrebsokg", f28} >= v1, v0[f27], fm5(v2.cf0, v3[DC0(f25) := v4[f27]], f26, globalState), f25, f25, false, !p2, f25, p1, p2 ==> f25, f25, f25, p2, p1];
			v5[191] := |f28| <= f27;
			v5[191] := p2;
			if (f25) {
				var v6: array<string> := new string[1] [f28];
				v6[244] := f28 + f28;
				v6[244] := fm1(globalState);
				var v7: map<bool, int> := map[v5[191] := f26];
				var v8 := DC2();
				var v9: multiset<D0> := multiset{v8, v8};
				var v10: seq<D0> := [v8];
				var v11 := DC1(0x217, v6[244], p2, f26, v5[191]);
				globalState.f1, globalState.f1, globalState.f1, globalState.f2, v7 := (v9 * multiset(v10)) >= multiset{v8, v8, v8, DC2()}, f25, (f26 % 50) in {f26, f27, f27, |{false}|}, v11.cf4, v7 + v7;
				v5[191] := f25;
				var v12 := 'b';
				v12 := v12;
				...
				v13[643] := {696, |map[f27 := v14]|} * v15;
				globalState.f0, v13[643], v12 := |fm1(globalState)| - (0x105 % f26), v15, v12;
			} else {
				globalState.f1 := v5[191];
				var v16: set<bool> := {v5[191], v5[191]};
				var v17 := 'i';
				var v18: map<set<bool>, char> := map[v16 := v17];
				var v19: map<map<set<bool>, char>, int> := map[v18[v16 := v17] := -(f26 - f27)];
				v19 := v19[v18 + v18 := f26];
				v2 := v2;
				var v20: T0 := new C3((seq(-475, i0  => (f28[f27]))) + f28, p1, f26 != -f27, f27);
				var v21: array<int> := new int[20];
				var v22: map<array<int>, bool> := map[v21 := v5[191]];
				var v23: map<bool, int> := map[p1 := -|v22| - v20.f26];
				var v24 := DC1(|f28|, "cmdoif", p2, f26, f25);
				globalState.f1, v20, globalState.f1, v23, v24 := f25, v20, v5[191] ==> v20.fm7(globalState), if (v20.f25) then map[f25 := f26] else v23, v24;
			...
			if (fm13(v5[191], globalState) > v28) {
				v5[191] := p2;
				var v29: multiset<array<bool>> := multiset{v5};
				var v30: map<bool, bool> := map[p2 := v5[191]];
				v29 := (v29 + v29[v5 := |v30|]) - (v29 + v29);
				var v31, v32, v33, v34 := m2(p1, globalState);
				var v35 := 'b';
				v35 := v35;
				var v36: seq<array<bool>> := [if (p2) then v5 else v5, v5, v5];
				v32, v36 := if (p2) then f28 < v27[720] else f25, [v5, v5, v5, v5, v5];
			} else {
				f28 := f28;
				var v37: multiset<bool> := multiset{f25, p1};
				globalState.f1 := (multiset{f25, f25, v5[191], p1, p1} + v37) > (v37 - multiset{p1, p1});
				var v38: map<bool, string> := map[p2 := v27[720]];
				var v39: seq<string> := [v27[720], fm1(globalState), f28, "wddepf", if (v5[191] in v38) then v38[v5[191]] else v27[720]];
				var v40: set<bool> := {fm5(f25, v3, |v0|, globalState)};
				var v41 := new C3(v39[|v40|], v40 != v40, p1, -f26);
				globalState.f1 := (p1 <== true) <== p2;
				var v42: map<bool, bool> := map[v41.f30 := true];
				var v43 := DC25(v42);
				var v44 := 'j';
				v43 := fm34(v41.f29[f26 := v44], f27, globalState);
			}
		...
		if ((f27 / f27) != v55[v55[f27]]) {
			...
			match (v56) {
				case DC4(cf7, cf8) =>
					...
					var v62: array<int> := new int[20] [|f28|, f26, v55[-0x1e0] - f27, 0x385 / |p0|, f26, fm2(f27, |p0|, globalState), -|v58| - f26, f26, fm2(f26, fm2(f27, |v55|, globalState), globalState), |v0|, f27 - v61.cf13, f26, f26, v57.cf24, f27, f26 * f26, -(f27 % f27), f27, f27, f27];
					v62 := new int[5];
					var v63: map<D1, int> := map[v56 := f27];
					v62[602] := -f26;
					v63, v62[602] := map[DC4(p1, true) := 0x8 * |(seq(-0x239, i2  => ('k')))|], -f27 / f26;
				case DC3(cf6) =>
					var v64 := DC6({f26});
					v64 := v64;
					...
					var v68: array<int> := new int[27] [if (f27 in v65) then v65[f27] else f27, |v66[p1 := f26]| % f27, v67.cf4, f26 * f26, if (!p2 in v66) then v66[!p2] else -0x9f, |multiset(f28)|, |[p2]|, f27 / f27, f27, f26, f26, 619, fm2(f26, 0x2db, globalState), --0x107, f26 * f26, f26, f27, f27 % f26, f26, f27, f26 * f26, f26, if (f26 in p0) then p0[f26] else f26, f26, f27, f26, |f28|];
					v68 := new int[5];
					globalState.f0 := f26;
					globalState.f1 := if (p2 ==> p2) then p1 else p1 <== f25;
				case DC5(cf9) =>
					var v69: array<int> := new int[12];
					v69 := new int[8](i3 => i3 % f26);
					var v70 := DC1(|f28|, "dl", true, f26, !false);
					var v71 := 'q';
					f28 := (v70.cf2 + (if (f25) then f28 else f28))[|map[p2 := p2]| + f26 := v71];
					v56 := DC4(f26 > f26, f25);
			...
			if (f25) {
				...
				var v90: set<bool> := {!v0[|(seq(0x2f8, i5  => (f28)))|]};
				v86, r0, v89, globalState.f1 := v86, p2 ==> !(v90 == v90), v89.(cf32 := DC20(v88)), |(if (f25) then f28 else seq(110, i6  => (v86)))| < (|v55| * f26);
				var v91 := new C3(f28, p2, p2, f26);
				var v92: seq<string> := [fm1(globalState)];
				v92 := [f28, seq(0x96, i7  => (v86)), f28, f28];
			...
			if ((f27 % f26) >= f27) {
				...
				var v114: array<multiset<char>> := new multiset<char>[22] [v111, v111, v111, v111 * v111, v111, v111, if (p1) then v111 else fm35(f27, |v112|, globalState), v111, v111 - multiset{v110}, v111 - multiset{v110}, v111, multiset{v110}, if (v103[58]) then v111 else multiset{v110, v110, v110}, v111, v111[v110 := -f26], v111, multiset{v110, f28[|v0|]}, v113[|(multiset{v106.f32, true})[f25 := f27]|], v111, v111, v111 - multiset{v110, v110}, v111];
				v114[135] := v111;
				v114[135] := v111;
				globalState.f0 := f27;
				var v115: map<array<bool>, int> := map[v104[103] := f26];
				var v116, v117, v118, v119 := m2(f26 == |v115|, globalState);
				r0 := p1;
			} else {
				var v120: set<int> := {f27};
				var v121: array<multiset<int>> := new multiset<int>[10] [fm21(f28, f27, |v120|, globalState), p0, p0[f26 := |f28|], p0, multiset{f26}, p0, multiset(v55), p0, p0, p0];
				var v122 := DC21(v121);
				v122, v103[58] := DC21(v121), f25;
				var v123: set<bool> := {f25};
				var v124: seq<set<bool>> := [v123];
				var v125: multiset<bool> := multiset{v106.f32, f25, v106.f32, v106.fm14(v123, f27, globalState), v103[58]};
				...
				v126[572] := DC15(v0);
				var v127 := DC15(v0);
				v126[572], globalState.f0, v125 := v127, |(f28 + f28)|, if (p2) then multiset{v106.f32, !v106.f32} + fm27(|(map[v104[103] := v103[58]])[v104[103] := true]|, globalState) else multiset(v0);
				globalState.f2 := f27;
				var v129: seq<set<int>> := [v120 + v120, v120 - (set v128 : int | (0x8d <= v128) && (v128 < 0x349) :: (v128 / f27)), v120];
				globalState.f0, globalState.f1 := |v129[f26]|, v106.f32;
			}
		...
		r0 := if (v130[894]) then p2 else v130[894];
	}
	method m2(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: map<multiset<bool>, int>, r3: map<int, string>) {
		...
		for i0 := f27 to f27 - -|v1| {
			...
			r1, v7[875], v4[578], v2, globalState.f1 := true, v9 + [v8, v8, v8], p0, fm4(v10, f25, f26 / f27, globalState), v0[f27 - f27];
			v4 := v4;
		}
		var v11 := 't';
		...
		v13 := v13;
		var v14 := DC4(v0[fm2(f26, f26, globalState)], p0);
		var v15: seq<D1> := [v14];
		var v16 := DC2();
		var v17 := DC17(v16, p0);
		...
		var v24: map<int, string> := map[f27 + f26 := if (true) then seq(0x18c, i1  => ('x')) else f28];
		r3 := v24;
	}
	method m3(globalState: GlobalState) returns (r0: array<bool>, r1: bool, r2: int) {
		if (f25) {
			r2 := |(seq(0x18e, i0  => ('n')))|;
			var v0: array<int> := new int[20](i1 => i1 - |[multiset(seq(-0x2b4, i2  => (f27))), multiset{0x293}, multiset{-0x29b, f27}, multiset([f27])]|);
			v0[624] := -f27;
			var v1 := DC28(v0);
			var v2: array<bool> := new bool[27];
			v2[491] := true;
			var v3: set<bool> := {f25, f25, f25};
			globalState.f0, v0[624], f28, v1, v2[491] := if (f25) then f26 else 0xe5, f27, f28, v1, {!f25} >= v3;
			f28 := f28;
			v0[624], globalState.f2 := v0[624], fm6(f25, f25, f26, globalState);
			if (v0[624] <= v0[624]) {
				var v4: map<int, bool> := map[f27 := v2[491]];
				var v5: C1 := new C1(f25);
				var v6: multiset<C1> := multiset{v5};
				var v8 := DC0(v2[491]);
				var v9: set<D0> := {v8};
				var v10: map<int, bool> := map[f26 := if ((if (v5 in v6) then v6[v5] else v0[624]) in v4) then v4[if (v5 in v6) then v6[v5] else v0[624]] else fm5(DC4(f25, f25).cf8, map v7 : D0 | v7 in v9 :: (v7) := (f26), v0[624], globalState)];
				var v11: seq<int> := [v0[624], v0[624]];
				var v12: seq<bool> := [v5.f32];
				v10 := v10[|v10| + |v11[v0[624] := v0[624]]| := if (v2[491]) then v12[f27] else v2[491]];
				v2[491] := v0[624] != v0[624];
				...
				v15 := v15[v0[624] := f28 + f28];
				var v16 := 'u';
				var v17: map<bool, char> := map[f25 := if (v2[491]) then f28[f26] else v16];
				var v18: seq<bool> := [false];
				v17 := v17[v2[491] := if (v18[f27]) then v16 else v16];
			...
			if (f25) {
				...
				var v35: map<int, multiset<bool>> := map[|v29[838]| := v34];
				v32 := v32[v33[-|(if (f26 in v35) then v35[f26] else v34)|] := v28.f32];
			} else {
				var v36 := DC4(f25, f25);
				globalState.f1 := v36.cf7;
				globalState.f1 := f25;
				globalState.f2 := |f28| % -0x1c2;
				var v37: seq<int> := [f26];
				v37 := v37;
		...
		if (match v40 {
			...
			if ((v49 + v49) !! {f25, f25}) {
				...
				globalState.f0, v55, globalState.f1, globalState.f2 := f26, if (v52 in v56) then v55 else v55, fm5(v54.f30, v58, f27, globalState), -(if (v54.fm9(globalState) !in v60) then if (v54.f30) then f26 else f26 else f27 % f26);
				var v61: array<string> := new seq<char>[23](i6 => seq(496, i7  => (v39)));
				v61 := v61;
			} else {
				var v62: multiset<int> := multiset{f27};
				var v63: C2 := new C2((if (0x338 in v62) then v62[0x338] else f26) + f27, f25, f27);
				v63 := v63;
				globalState.f0 := (v63.f31 / f27) * v63.f31;
			...
			var v70 := new C3(f28 + v69[f26], f25, f25, f27);
		...
		for i8 := f26 + f27 to 0x321 {
			...
			v74[96], globalState.f1, v75[518], v77[497], globalState.f0 := !f25, v79[f27], v76, if (|fm36(f27, |f28|, f28, f27, globalState)| in v80) then v80[|fm36(f27, |f28|, f28, f27, globalState)|] else if (f25) then v78 else v78, |v81|;
			globalState.f2 := fm2(-fm2(f26, f27, globalState), f27, globalState);
			var v82: array<set<bool>> := new set<bool>[5];
			var v83 := DC0(v74[96]);
			var v84: map<bool, bool> := map[v74[96] := f25];
			var v85: map<D0, int> := map[v83 := |v84[false := f25]|];
			v82[171] := v81 * {v74[96], f25, v74[96], f25, fm5(v74[96], v85, |(seq(-0x10e, i10  => (f27)))|, globalState)};
			v82[171] := v81;
			var v86: map<int, int> := map[0x25d := f27];
			var v87: multiset<int> := multiset{f26};
			var v88: map<int, multiset<int>> := map[|v82[171]| := v87];
			var v89: C2 := new C2(f27, v74[96], -|v88|);
			var v90: set<C2> := {v89};
			var v91: set<int> := {f26, i8, |v90|};
			var v92: seq<int> := [|v91|, i8, f26, v89.f31, v89.f31];
			globalState.f2 := fm2(|(fm3(f27, v74[96], |v86|, !!f25, globalState) + v92)|, f27, globalState);
		}
		if ((if (f25) then false else f25) <== (!f25 <== f25)) {
			globalState.f1 := f25;
			var v93: seq<bool> := [false];
			var v94: map<bool, bool> := map[true := v93[f27]];
			v94 := v94[f25 := f25];
			var v95: C2 := new C2(f26, f25, f26);
			var v96: seq<C2> := [v95, v95];
			var v97: map<bool, C2> := map[!f25 := v96[-0x43]];
			var v98: seq<C2> := [if (f25 in v97) then v97[f25] else v95];
			var v99: multiset<seq<C2>> := multiset{v98 + v96};
			var v100 := DC30(v99[v98 := f26]);
			...
			if (v106 <= v106) {
				...
				var v117: seq<seq<D1>> := [seq(0x347, i12  => (DC5(v113)))];
			...
			var v122: map<int, map<int, bool>> := map[-f26 := map[|(seq(295, i13  => (|map[f25 := f25]|)))| := f25]];
			r2 := fm2(|v122|, f26, globalState);
			var v123 := m0(v106[f26], globalState);
			r2 := f27;
			globalState.f1 := f25;
		}
		...
		var v124 := DC0(f25);
		var v125: map<D0, int> := map[fm28(seq(973, i14  => (v39)), v39, -187, globalState) := f26];
		...
		if (fm5(v124.cf0, v125, if (f25 in v126) then v126[f25] else f27, globalState)) {
			...
			v135[377] := fm37(DC29(f27, f25, v136, -f26, |v127|).cf46, globalState);
			v135[377] := v133;
			match (fm34(f28, 0x115, globalState)) {
				...
				case DC25(cf39) =>
					...
					var v148 := DC33(v147);
					v147 := (if (v146[374]) then v148 else DC33(v147)).cf57;
					globalState.f2 := f27;
				case DC27(cf43) =>
					globalState.f1 := f25;
					var v149: array<int> := new int[22];
					v149[473] := |v126| % fm2(f27, f27, globalState);
					var v150: map<int, int> := map[|(seq(277, i17  => (v39)))| := f27];
					var v151: map<map<int, int>, int> := map[v150 := |v129|];
					v149[473] := |(v151 + v151)| / fm2(f27, f26, globalState);
					r2 := f27 * f27;
					globalState.f2 := f27 % f26;
			}
			
			var v153: map<int, set<int>> := map[f26 := set v152 : int | (0x371 <= v152) && (v152 < 0x50) :: (v152 % 328)];
			...
			globalState.f1, v154, globalState.f2, globalState.f2 := f25, fm38(if (f27 in v128) then v128[f27] else f25, f26, -|v155|, fm5(f25, map[DC0(f25) := f27], fm6(f25, !f25, 220, globalState), globalState), globalState).(cf10 := {f26, f27, 0x2bc} + {f27}), (if (true in v127) then v127[true] else (v157.(cf54 := v156)).cf53) % f26, f27;
			...
			var v166: C3 := new C3(seq(277, i20  => (v39)), f25, f25, f26);
			var v169 := DC35(v160);
			...
			var v177: array<map<int, int>> := new map<int, int>[29] [v160, map[f26 := if (f28[|v164| := fm4(v165, f25, |map[v166 := v166.f30]|, globalState)] in v161) then v161[f28[|v164| := fm4(v165, f25, |map[v166 := v166.f30]|, globalState)]] else f26], (map v167 : int | (0x53 <= v167) && (v167 < 0x154) :: (v167 - f27) := (f27)) + v160, v160 + v160, (map[f27 := f27])[f27 := f26], v160, map[-f26 := fm6(v166.f30, !v166.f30, f26, globalState)] + v160, v160, map[f27 := f27], v160, v160 + v160, map v168 : int | (491 <= v168) && (v168 < -0x372) :: (v168 + |multiset(v166.f29)|) := (0x157), v160, v169.cf59, (map v170 : int | (0x244 <= v170) && (v170 < 30) :: (v170 - |map[f27 := v166.f30]|) := (f26)) + v160, (map v171 : int | v171 in v172 :: (v171 % f27) := (f26)) + v160, map v173 : int | (0x4d <= v173) && (v173 < -0x228) :: (v173 + -0x396) := (f26), v174[f27], if (f25) then v160 else v160, v160, map[f26 := f27], v160, v160, v160 + v160, v160 + v160, v160, v160[0x9f := |v176|], v160 + v160, v160];
			v177 := new map<int, int>[25];
			var v178: array<int> := new int[13](i21 => i21 % f26);
		...
		r1 := !(v182[fm2(f27, if (|v182| in v183) then v183[|v182|] else f26, globalState) := f25] in v184);
		r2 := (if (f25) then f26 else f26) / f27;
	}
}
...
method Main() {
		...
		decreases 100 - i1
	{
		...
		var v11 := DC1(0x13b, fm1(globalState), v7[810], fm2(if (v2 in v8) then v8[v2] else |v10|, v3, globalState), v2);
		var v12: seq<int> := [v3];
	...
	for i2 := v3 to v3 {
		...
		v16 := v16;
		var v17: seq<int> := [v3];
		var v18: multiset<bool> := multiset{v7[810], v2, v2, v2};
		var v19: array<int> := new int[9] [-0x189, if (false) then v3 else v3, i2 / i2, v3, v3, i2, |(v17[i2 := v3] + v17)|, if (v7[810]) then |v18| else i2, v17[v3]];
		v19[324] := v3 % |v18|;
		v19[324] := v3 / v3;
		var v20 := DC0(v7[810]);
		match (v20) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				globalState.f1 := v21[cf1];
				var v22 := DC2();
				var v23: array<D0> := new D0[15] [v22, v22, v22, DC2(), v22, v22, v22, v22, v22, if (v2) then v22 else v22, DC2(), DC2(), v22, DC2(), v22];
				v23[880] := v22;
				var v24: map<int, int> := map[|[!cf5, cf3, v2]| := i2 * v19[324]];
				var v25: array<string> := new string[18](i3 => cf2);
				v25[504] := if (cf3) then cf2 else seq(363, i4  => (v16));
				var v26: array<seq<int>> := new seq<int>[15] [v17, v17, v17 + v17, v17 + v17, v17, if (v2) then v17 else [v19[324], v3, v3, cf1, |cf2|], v17, v17, v17, v17 + v17, v17, [i2, cf1, v19[324], v3, v3], [v19[324], cf1] + v17, fm3(cf1, cf3, v3, v7[810], globalState), v17];
				v26[967] := v17;
				v23[880], v24, v25[504], v26[967] := v22, v24, v1, (v17 + [v3, fm2(i2, cf1, globalState)])[fm2(v3, |(set v27 : int | (0x184 <= v27) && (v27 < 253) :: (v27 + |v17|))|, globalState) := |v21| * cf4];
			case DC2() =>
				var v28: seq<seq<int>> := [v17, v17];
				v7[810], v28, globalState.f0 := !v2, seq(-0x3b3, i5  => (v17)), -i2;
				var v29: multiset<char> := multiset{v16, v16, fm4(DC1(v3, v1, v7[810], i2, v7[810]), !v2, v19[324], globalState)};
				v29, v7[810], v2, v19[324] := v29, v19[324] <= v19[324], v2, i2;
				globalState.f2 := i2;
				v2 := v3 < i2;
			case DC0(cf0) =>
				globalState.f1 := v2;
		...
		var v33 := new C1({false} == (fm39(v19[324], !v7[810], globalState)).cf15);
	}
	var v34: seq<bool> := [!v2, v7[810]];
	var v35: seq<int> := [v3];
	var v36 := 'r';
	var v38 := DC0(v7[810]);
	var v39: seq<D0> := [DC0(v7[810]), DC0(v2), v38];
	var v40: map<char, map<D0, int>> := map[v36 := map v37 : D0 | v37 in v39 :: (v37) := (|v4|)];
	var v41 := new C3(if (!v7[810]) then v1 else v1, v2, fm5(v34[|v35|], if (v36 in v40) then v40[v36] else map[v38 := |v1|], v3, globalState), v3 / v3);
	var v42: C2 := new C2(-v3, !v7[810], v3);
	v42 := v42;
	var v43: array<map<int, array<C2>>> := new map<int, array<C2>>[20];
	var v44: array<C2> := new C2[21];
	v43[390] := map[v42.f31 := v44];
	var v45: map<int, array<C2>> := map[v42.f31 := v44];
	v43[390] := v45;
	for i6 := v41.fm6(v2, v7[810], v3, globalState) to v42.f31 {
		if (v7[810]) {
			var v46: map<int, seq<bool>> := map[i6 := v34];
			var v47: seq<map<int, seq<bool>>> := [map[v3 := v34], v46, v46];
			v4 := v4[v7[810] := |v47[v42.f31]|];
			v36 := 'f';
			var v48: map<bool, string> := map[v2 := v1];
			globalState.f1 := if (v7[810]) then !v41.f30 else -v3 != |(if (v2 in v48) then v48[v2] else v41.f29)|;
		...
		var v56: map<bool, array<map<int, int>>> := map[v7[810] && v7[810] := v55];
		v55 := if (v41.f30 in v56) then v56[v41.f30] else v55;
		globalState.f2 := -((v42.f31 % v42.f31) + 0x179);
		var v57 := new C1(v7[810]);
	}
	if (!(!(v41.f29 != v1) <== v41.f30)) {
		if (v41.f30) {
			...
			globalState.f1, globalState.f0, globalState.f1, globalState.f2, globalState.f0 := v7[810], if (false) then v42.f31 else |v41.f29| + v42.f31, v41.f30, v42.f31, |(map[if (v41.f30 in v59) then v59[v41.f30] else v42.f31 := v41.f30] + v60)|;
			var v61 := DC37(v42);
			var v62: seq<C2> := [v42, v42, v61.cf63, if (v58.f32) then v42 else v42, v42];
			v62 := v62[|v34| := v42] + [v42, v42, v42, v42, v42];
			globalState.f2 := if (v34[v42.f31]) then v42.f31 else v3;
			var v63: array<int> := new int[19];
			var v64: seq<array<int>> := [v63, if (v7[810]) then v63 else v63, v63, v63];
			globalState.f0 := |v64|;
		} else {
			var v65 := new C4(v3, v41.f29, v41.f30, v42.f31);
			var v66: array<int> := new int[3];
			v66 := v66;
			var v67 := DC36(v7[810], v35, v7);
			var v68, v69, v70, v71 := v65.m2(v67.cf60, globalState);
			v1 := v41.f29;
			var v72: array<array<int>> := new array<int>[6];
			v72[668] := v66;
			var v73: array<seq<int>> := new seq<int>[7] [v35, v35 + v35, v35, seq(-357, i9  => (v42.f31)), seq(0x1ae, i10  => (v65.f27)), v35, seq(0x300, i11  => (v42.f31))];
			v73[805] := v35 + v35;
			v72[668], globalState.f2, v65.f28, v73[805] := v66, v42.f31, (fm40(v2, globalState)).cf55, [v3, |(if (v41.f30) then fm1(globalState) else v41.f29)|, v42.f31];
		}
		
		globalState.f1 := v41.f30;
		v34 := v34 + v34;
		var v74: map<bool, bool> := map[v7[810] := v2];
		var v75: C4 := new C4(|v74|, v1[|v41.f29| := v36], v2, v42.f31);
		var v76: multiset<C4> := multiset{v75};
		var v77: seq<C4> := [v75];
		var v78 := DC40(multiset(v77));
		var v79: set<multiset<C4>> := {v76, v76 - v76, v76, v78.cf65, v76};
		v3, globalState.f0, v79, globalState.f0 := v3, fm2(v75.f27 - v3, v75.fm6(v2, v41.f30, v3, globalState), globalState), {multiset{v75, v75, v75}}, v41.fm9(globalState) % 0x393;
		var v80: set<seq<bool>> := {v34, v34, v34, v34};
		var v81: seq<seq<bool>> := [v34, [v7[810]], v34, v34, v34];
		...
		if (if (!v41.f30) then v2 else !true) {
			...
			var v90: map<int, string> := map[|{v84.f27}| := v1[v84.f27 := v36]];
			var v91: map<bool, array<bool>> := map[!v41.f30 := v7];
			var v92 := DC44(v91);
			var v93: map<map<bool, array<bool>>, string> := map[v92.cf73 := seq(0x8c, i13  => (v36))];
			...
			var v97: array<int> := new int[22] [if (v86.cf66 in v85) then v85[v86.cf66] else v84.f27, |v41.f29| - v84.f27, v42.fm11(map[seq(0x275, i12  => (v36)) := v1], v3, v42.f31, globalState), v3 / v42.f31, |v87| / v84.f27, -v84.f27, |v88|, v42.f31, 671 + v84.f27, -v42.f31, v3, |map[v89[|v90|] := v42.f31]|, v42.f31, v42.f31 % v42.f31, v84.f27, |fm1(globalState)|, -v42.f31, -(|(if (v91 in v93) then v93[v91] else v41.f29)| * 890), v3, -639, v42.f31, if (v95 in v96) then v96[v95] else v84.f27];
			v97[553] := v42.f31;
			v97[553] := (v84.f27 * v42.f31) * |v41.f29|;
			v7[810] := v42.fm7(globalState);
		} else {
			...
			var v103 := DC23();
			var v104: C0 := new C0(v101.f28, v7[810], v3, v7, v41.f30);
			...
			var v108: T0 := new C3(v101.f28, v7[810], v7[810], 0x27d);
			var v109: map<int, T0> := map[v42.f31 := v108];
			var v110: array<int> := new int[10](i14 => i14 / v3);
			var v111: seq<array<int>> := [v110];
			var v112: seq<seq<int>> := [fm3(|v109|, v41.f30, |v111|, !v7[810], globalState)];
			var v113: array<seq<int>> := new seq<int>[28] [[v41.fm6(v41.f30, v41.f30, v42.f31, globalState)], v35, v35 + [0x7d, |v99|, v42.f31, -v42.f31], if (v41.f30) then v35[-v42.f31 := v42.f31] else v35, v35, v35 + v35, v35, [v42.f31], v35, v35, [|multiset{v102}|], [|map[{v103, DC23()} := v7]|, |v35|, v42.f31, v3, -v42.f31], [811], v35, v35, v35, v35, [307, v42.f31], if (v104 in v105) then v105[v104] else v35, v35 + v35, v35, v35[v3 := v3], v35, v35, v35 + v35, v35 + v35[|(map v106 : int | v106 in v107 :: (v106 - v42.f31) := (0xa6))| := v42.f31], v35, v112[-v108.f26]];
		...
		globalState.f1 := v7[810];
	}
	
	var v118: map<bool, char> := map[v7[810] := v36];
	if ((v118 != v118) in v34) {
		var v119: set<bool> := {v7[810]};
		v0[122] := v119;
		v0[122] := v119;
		var v120 := DC4(v2, v7[810]);
		var v121 := DC5(v120);
		var v122 := DC1(v3, v41.f29, v41.f30, v42.f31, v41.f30);
		var v123, v124 := v42.m5(v2, v121, fm4(v122, v7[810], |v41.f29|, globalState), globalState);
		v36 := v36;
		v3 := (-v3 - 0x22a) - (|v35| * v3);
		...
		var v129: array<int> := new int[25] [|"eblm"|, v42.f31, v42.f31, v42.f31, v3, -0x8b, 0x1a4, v3, v42.f31, v3, v42.f31, |v126|, 0x3b8, |v0[122]|, v3, v42.f31, v42.f31, v42.f31, v42.f31, v3, 0x240, v42.f31, |v128|, |[v123, v123, false]|, v127.f27];
		v125[64] := v129;
		v125[64], globalState.f0, v7[810] := v129, 0x59 % -(v42.f31 * v42.f31), v127.fm7(globalState);
	} else {
		...
		if (!(if (v41.f30) then v1 < v1 else v41.f30)) {
			...
			var v138 := v42.m6(map[|fm35(-v3, |multiset(v136)|, globalState)| := v137.cf76], v3, v134.fm6(v2, v7[810], v3, globalState), globalState);
			var v139 := DC6(v6);
			var v140: seq<D2> := [DC6(v6), v139, v139];
			v140 := (v140 + (seq(0x200, i16  => (v139))))[if (v41.f30) then v3 else v42.f31 := DC6(v6)];
			var v141: multiset<int> := multiset{v42.f31};
			var v142 := v41.m1(v141, v41.f30, v2, globalState);
			v3 := (fm41(v142, true, v7[810], globalState).(cf23 := v42.f31, cf24 := v42.f31)).cf23;
		} else {
			v6 := DC6(v6).cf10;
			v7[810] := v2;
			...
			var v147: seq<C2> := [v42];
			var v148 := DC43(v147[v42.f31], v42.f31, v143.f32);
			...
			var v154: array<int> := new int[24] [v42.f31, v42.f31, v42.f31, |(seq(0x308, i17  => (v36)))|, v42.f31, v42.f31, v144.cf36, 0xbb, -v42.f31, v42.f31 % v42.f31, v42.f31, v3, v42.f31 / v42.f31, v42.f31, v3, -|v145|, if (false) then v3 else |v34|, if (v143.f32) then |v146| else v42.f31, 0x3d3, v42.f31, -(if (v143.f32) then v3 else v42.f31), v148.cf71, |(v152 + v152)|, |{v153, v153}|];
			v151[706] := v42.f31;
			var v155: C3 := new C3(fm1(globalState), v131, v131, 0x38);
			var v156: map<int, bool> := map[v3 := v7[810]];
			v151[706], v155, globalState.f1 := |v156| - v42.f31, v155, v7[810];
			var v157: set<bool> := {v143.f32, v143.f32};
			var v158 := new C2(v151[706], v143.fm14(v157, v151[706], globalState), v151[706]);
			v4 := v4;
		}
		
		var v159: array<string> := new seq<char>[26](i18 => seq(-0x24f, i19  => (v36)));
		var v160: seq<string> := [seq(-0x306, i20  => (v36))];
		var v161: multiset<int> := multiset{v42.f31};
		var v162: T1 := new C0(v1, v131, |v161|, v7, v41.f30);
		var v163: seq<T1> := [v162];
		v159[929] := v1 + v160[|v163|];
		v159[929] := v41.f29;
		v3 := v42.f31;
	...
	if (v165 <= v165) {
		var v166: array<int> := new int[1] [v42.f31 % v42.f31];
		v166[641] := -0x23f;
		...
		match (if (v2) then v170 else v170) {
			...
			case DC28(cf44) =>
				...
				v7[810], globalState.f0, v7[810], globalState.f1, v44 := v2 && v41.f30, v42.fm6(true, true, -v42.f31, globalState) % v35[|v1|], !v2, v173 !! (v173 * v173), v44;
				var v174: array<array<int>> := new array<int>[4];
				var v175: map<array<bool>, array<array<int>>> := map[v7 := v174];
				v166[641], v7[810], v174, v167, v2 := v42.f31, v42.f31 <= v3, if (v7 in v175) then v175[v7] else v174, fm21(fm1(globalState), v42.f31, 82, globalState), v41.f30;
		...
		v178, v7, globalState.f2, globalState.f0 := v179[|[v180, v180, v180, v180]|], v7, v42.fm6(!(v42.f31 <= |"jhjne"|), v7[810], (if (v42.f31 in v167) then v167[v42.f31] else v166[641]) % v166[641], globalState), |[0x11b, 161, 0x161]| % v42.f31;
		v180.f34, v7[810], v166, v3, v1 := v2 !in multiset{v180.f34, v41.f30}, v177.f32, v166, v42.f31, v41.f29;
		...
		if (!((if (v2 in v181) then v181[v2] else v3) == v42.f31)) {
			...
			var v187: array<array<int>> := new array<int>[27] [v166, v166, v166, if (v7[810]) then v166 else v166, v166, v166, if (true) then v166 else v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166, v166];
			v180.f34, v166[641], v187, globalState.f0 := v34[v42.f31], v3, v187, |v35[v166[641] := v42.f31]|;
			v4 := v4[v41.f30 := -0x2b];
			...
			v166[641] := (v42.f31 * v42.f31) % v3;
			v166[641] := v166[641];
		}
		
	} else {
		v35 := (fm3(v42.f31, v41.f30, v42.f31, v2, globalState) + v35) + v35;
		var v190: map<bool, bool> := map[v34[|v34|] := true];
		var v191: multiset<map<bool, bool>> := multiset{v190, v190, v190 + v190, v190[!v7[810] := true], v190[v41.f30 := v41.f30]};
		...
		v194[194] := v195;
		var v196: map<int, bool> := map[v42.f31 + v3 := v7[810]];
		var v197: seq<seq<bool>> := [v34];
		v194[194], v195, v196 := v195, if (if (v41.f30) then v7[810] else v41.f30) then v195 else v195, fm42(fm3(|[v42.f31]|, v41.f30, v42.f31, v41.f30, globalState) + v35[v42.f31 := v42.f31], v2, v197, globalState);
	}
	...
	v7[810] := !fm5(multiset{v7[810], !v41.f30, v41.f30, v7[810]} !! multiset{v41.f30}, v200, v3, globalState);
	var v201: map<array<bool>, seq<bool>> := map[v7 := v34 + v34];
	v201 := v201[v7 := [v41.f30] + v34];
	var v202: array<int> := new int[21](i21 => i21 % v3);
	v202[95] := 0x39b;
	v3, v36, v2, v34, v202[95] := v3, v1[v42.f31 % v42.f31], 224 > v3, v34, v42.f31;
