...
function fm7(p0: char, p1: bool, p2: bool, p3: int, globalState: GlobalState): string {
	match DC4({934}) {
		case DC5() => (seq(0xcf, i0  => ('x'))) + (seq(626, i1  => ('p')))
		case DC6(cf5, cf6) => cf5
		case DC4(cf4) => seq(0x3e5, i2  => ('b'))
	}
}
...
function fm11(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): string {
	("je" + "rfsuhwou") + (if (true) then "a" else seq(0xa8, i0  => ('v')))
}
function fm14(p0: int, p1: bool, globalState: GlobalState): set<seq<int>> {
	{[0x30c, 0x19b, 0x23e, |{true}|, 0x16a] + [-|{true}|, 0x3da, |map[[|[true, false]|] := false]|], [187] + (seq(0xa1, i0  => (|{false, true}|))), [|(seq(338, i1  => ('e')))|, 0x26f, |map[true := |{|map[true := true]|, |[--883]|}|]|], [0x3ac] + (seq(0xdd, i2  => (|map['i' := false]|)))}
}
...
function fm17(p0: int, p1: D0, p2: int, p3: bool, globalState: GlobalState): map<D0, bool> {
	map v0 : D0 | v0 in multiset([DC3(false)] + (seq(-0x186, i0  => (DC3(false))))) :: (v0) := (!(|[true]| == 0x2c9))
}
...
function fm26(p0: bool, p1: char, p2: D4, globalState: GlobalState): map<map<bool, int>, int> {
	match DC14(|[|(seq(315, i0  => ('u')))|]|, !!true, |multiset{|{|{0x327}|}|, |map[|multiset{false}| := 865]|}|, !true, |map[!!true := true]|) {
...
function fm29(p0: int, globalState: GlobalState): seq<map<char, bool>> {
	(seq(0x263, i0  => (map['f' := false]))) + [map['i' := !true]]
}
...
function fm31(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<int, bool> {
	map[0x340 := true] + (map[0x33c := !false] + (map v0 : int | (-711 <= v0) && (v0 < 0x3ad) :: (v0 % 0x1b1) := (true)))
}
...
function fm34(p0: seq<int>, globalState: GlobalState): set<int> {
	((set v2 : int | v2 in (map v0 : int | v0 in (map v1 : int | v1 in map[0x2b2 := false] :: (v1 / |"ajo"|) := (0xe5)) :: (v0 + |map[true := DC8(map[false := false])]|) := ("jvslhv")) :: (v2 - --0x3d)) + (set v3 : int | (0x237 <= v3) && (v3 < 0x1b6) :: (v3 - |(seq(-0x74, i0  => ('s')))|))) + {|"l"|, |multiset{|multiset{|"xjjpql"|}|, 404, |map[0x1fc := 'y']|}|, 944}
}
function fm35(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): set<string> {
	((set v0 : string | v0 in (seq(0x23a, i0  => ("a"))) :: (v0)) - {"kejowhwr"}) + ((set v1 : string | v1 in map["iofop" := [true, false]] :: (v1)) * (set v2 : string | v2 in multiset{"thbw"} :: (v2)))
}
...
method m0(p0: char, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: multiset<string>, r3: int) {
	...
	if (v0 || (v0 || v0)) {
		...
		v9[51] := v10;
		v9[51] := new int[17];
		r3 := v1 / (if (v0) then v1 else v1);
		var v11: seq<int> := [v1];
		var v12: map<bool, int> := map[v0 := v11[0x269]];
		var v13: multiset<int> := multiset{-0x100, 0x290};
		r1, v12, r1, v2, v1 := v13 < v13, v12 + v12, v0, seq(-0x3d5, i1  => (p0)), v1;
		r1 := v0;
	} else {
		var v14 := 0x1;
		var v15: seq<bool> := [v0];
		...
		globalState.f2 := v14;
		globalState.f2 := (fm37(v0, 0x325, !v0, globalState) / v14) - 0x1eb;
	}
	
	var v18 := -649;
	for i2 := v18 to v18 {
		var v19: T1 := new C3(false, i2 * v18, v18 % i2);
		v19 := new C1(i2, i2 * -405);
		var v20 := new C2(v18, v19.f6);
		var v21 := "krfj";
		v21 := (fm7(p0, true, v0, v18, globalState) + (v21 + ("bwr")[i2 := p0]))[0x1be := v21[i2]];
	...
	r0 := if ((v35 + ("kcykgfojv")[-0x162 := 'r']) in v38) then v38[v35 + ("kcykgfojv")[-0x162 := 'r']] else v24;
	r1 := v0;
...
class C1 extends T0, T1 {
	...
	function fm1(globalState: GlobalState): bool {
		((set v0 : int | (110 <= v0) && (v0 < 0x2a9) :: (v0 * f6)) - (set v1 : int | v1 in [|(seq(0x1d3, i0  => (f6)))|, f6] :: (v1 / 0x1f3))) < {0xe7}
	}
	function fm2(p0: int, p1: set<bool>, globalState: GlobalState): int {
		f6
	}
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		forall i1 | 0 <= i1 < v3.Length {
			v3[i1] := false <== !((seq(-0x18f, i2  => (v2))) == "djet");
		}
		var v4: array<int> := new int[11];
		var v5: seq<array<int>> := [v4];
		var v6: set<array<int>> := {v5[f5]};
		v6 := {v4, v4} * v6;
		v4[779] := 0x55 * f5;
		v4[779] := f5;
		var v7: seq<int> := [f5];
		...
		if (v7 == [f6]) {
			...
			match (v12) {
				case DC1(cf1, cf2) =>
					...
					v3[716] := v9;
					var v13 := new C0(0x55);
					var v14 := new C0(v4[779]);
				case DC2() =>
					v1 := v0[241];
					var v15: seq<bool> := [v9];
					var v16: map<int, bool> := map[-348 := !v15[-f5]];
					var v18: C0 := new C0(f6);
					var v19: map<C0, int> := map[v18 := v4[779]];
					var v20: set<int> := {|v19|};
					var v21: multiset<bool> := multiset{v9, v9, v3[716]};
					v9 := fm16(v16, f5, map v17 : int | v17 in v20 :: (v17 % v18.f8) := (false), globalState) > (multiset{false} + v21);
					var v22: array<bool> := new bool[11](i4 => v3[716]);
					var v23: map<C0, array<bool>> := map[v18 := v22];
					globalState.f2 := f6 / fm12(v9, |v23|, v3[716], |fm17(v18.f8, DC0(v9), f6, true, globalState)|, globalState);
					var v24: array<array<bool>> := new array<bool>[11];
					var v25 := DC1(false, v3[716]);
					v3[716], v24, v4[779], v22, v7 := (v4[779] % f5) >= f6, if ((v25.(cf2 := v9)).cf2) then v24 else v24, -v4[779] / f6, v22, v7;
				case DC3(cf3) =>
					cf3 := v3[716];
					v1 := v0[241];
					v4 := new int[27](i5 => i5 % f5);
					...
					var v31 := DC8(v30);
					f6, globalState.f2, v29[61], v3[716] := |v31.cf8|, -((|v0[241]| % f6) % |multiset{v0[241], v1}|), map[v26 := v27] + map[v26 := v27], v4[779] >= f6;
				case DC0(cf0) =>
					v4[779] := -f6 - f6;
					var v32: multiset<seq<int>> := multiset{v7};
					v32 := multiset{[v4[779], v4[779]], [fm12(v9, f5, v9, fm12(v3[716], v4[779], v9, f6, globalState), globalState)], DC11(v7).cf13, v7};
					var v33 := new C0(f5);
			...
			var v38: map<bool, bool> := map[false := v3[716]];
			var v39: set<bool> := {v3[716]};
			var v40: array<bool> := new bool[21] [v9, v9, !fm0(v37, true, v1, globalState), false, !true, fm1(globalState), v9 !in v38, v9, v9, v3[716], v9, v3[716], v9, v3[716], v9, v3[716], v39 >= v39, v3[716], false, v9, v9];
			v40 := v40;
			var v41: array<array<bool>> := new array<bool>[15];
			v41[609] := v40;
			v41[609] := v40;
			var v42: map<array<int>, int> := map[v4 := v4[779]];
			var v43: multiset<int> := multiset{f6};
			var v44: map<map<array<int>, int>, multiset<int>> := map[v42 := v43];
			var v45 := DC9(if (v42[v4 := -664] in v44) then v44[v42[v4 := -664]] else v43, DC2(), |(seq(0x1d, i7  => (v2)))|);
			match (v45) {
				case DC9(cf9, cf10, cf11) =>
					v4 := v4;
					var v46: map<bool, seq<int>> := map[v9 := v7];
					var v47 := new C0(|map[seq(0x3a5, i8  => (v2)) := |(if (v3[716] in v46) then v46[v3[716]] else seq(0xa, i9  => (-f6)))|]|);
					v0[241] := v1;
					globalState.f2 := v47.f8;
				case DC8(cf8) =>
					v4[779] := -fm12(true, v4[779], v3[716], f6, globalState);
					v9 := v3[716];
					var v48 := new C0(v4[779]);
					var v49: map<bool, int> := map[v3[716] <== v9 := v4[779] / v7[f5]];
					globalState.f2, v49, v2 := -f6, v49, v2;
				case DC10(cf12) =>
					var v50: seq<bool> := [v9];
					v50 := v50;
					v4, v9 := v4, -v4[779] !in v43;
					var v51: array<char> := new char[23] [v2, v2, v2, v2, v2, fm18(v3[716], v4[779], f6, v3[716], globalState), v2, v2, v2, v2, if (v3[716]) then v2 else fm18(v3[716], f6, -0x314, v9, globalState), v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2];
					v51 := v51;
					var v52 := DC3(v3[716]);
					var v53: array<D0> := new D0[10] [v52, v52, v52, DC3(v9), v52, v52, DC3(v3[716]), v52, v52, v52];
					v53[424] := v52;
					v53[424] := v52;
			}
			...
			v0[241] := v0[241];
			globalState.f2 := fm13(f6, multiset{v1, seq(-505, i10  => (v2)), v1, v0[241]}, globalState) % 0x189;
			if (v9) {
				var v54: seq<string> := [if (v9) then v1 else "ltkjnhdi"];
				var v55: map<bool, bool> := map[v9 := v9];
				v4[779] := |v54[|v55| % 0x343 := (seq(0x91, i11  => (v2))) + v0[241]]|;
				v3[3] := f5 != v4[779];
				v3[3] := fm1(globalState);
				var v56 := new C0(v4[779]);
				var v57: multiset<int> := multiset{v56.f8, f5, f6, -|v1|, v4[779]};
				var v58: map<string, int> := map[v1 := v4[779]];
				var v59: map<int, int> := map[f6 := v4[779]];
				var v60: map<bool, multiset<int>> := map[v3[3] := multiset(v7)];
				var v61: array<multiset<int>> := new multiset<int>[29] [v57, multiset{f5}, v57, v57, v57, multiset(v7) - v57, v57, multiset(v7) + v57, v57, (fm19(v3[3], v56.f8, v3[3], globalState))[f6 := if (v0[241] in v58) then v58[v0[241]] else f5], v57, (multiset{f5})[if (f5 in v59) then v59[f5] else f6 := 0x2b2], multiset{-|v1|, |v57|}, v57, v57, v57, v57 + (if (false in v60) then v60[false] else v57), v57, v57, v57, v57, v57, v57 + v57, v57, multiset{f5}, v57, v57, if (v3[3]) then v57 else multiset(v7), multiset(v7 + [v56.f8])];
				v61[293] := v57 * v57;
				v61[293], v3[3], v54 := v57, (!!v9 <== v9) <== !v9, [v1];
				var v62, v63, v64, v65 := m0(v2, globalState);
			} else {
				var v66 := new C0(v4[779]);
				var v67 := DC14(v4[779], false, f5, v9, v66.f8);
	...
	method m2(p0: int, globalState: GlobalState) {
		var v0 := new C0(f6);
		var v1: array<int> := new int[27](i1 => i1 % v0.f8);
		forall i0 | 0 <= i0 < v1.Length {
			v1[i0] := i0 * |(seq(-0x9b, i2  => ('g')))|;
		}
		var v2 := true;
...
class C2 extends T0, T1 {
	...
	function fm0(p0: multiset<map<int, bool>>, p1: bool, p2: string, globalState: GlobalState): bool {
		multiset{[-363, |map[false := |{true, true}|]|]} !! (multiset{[f6]} - multiset(seq(0x237, i0  => ([|{false, false}|, -401]))))
	}
	function fm1(globalState: GlobalState): bool {
		f5 in ((seq(0x36a, i0  => (f5))) + (seq(0x16, i1  => (f5))))
	}
	function fm2(p0: int, p1: set<bool>, globalState: GlobalState): int {
		-0x12e
	}
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		v2[689] := if (fm9(v6, v0, globalState)) then |v7| else f5;
		for i0 := 0x11a + -v5 to 0xf7 % v5 {
			...
			if (v8[f6 - i0]) {
				...
				v11 := (if (v3 in v12) then v12[v3] else v11)[f5 := v1] + v11;
				var v13: map<int, bool> := map[-v5 := v0];
				var v14: multiset<map<int, bool>> := multiset{v13, v13, v13};
				var v15: array<bool> := new bool[8] [v3 <== (if (|v8[v2[689] := v3]| in v13) then v13[|v8[v2[689] := v3]|] else true), v3, if (v3) then false else v0, v3, fm8(v11, v3, fm0(v14, v3, v11, globalState), v0, globalState), v3, false, v3];
				v15[868] := v0;
				v15[868] := (v9 + v9) != v9;
				...
				r1 := v0;
				var v22 := new C0(v2[689]);
				var v23: seq<int> := [v22.f8, i0];
				var v24 := "gygdbkdr";
				var v25: set<int> := {i0};
				var v26: array<bool> := new bool[12] [true, v2[689] <= v23[i0], false && v3, fm8(v24, v8[|(seq(-830, i1  => (0xa3)))|], v19, v3, globalState), {|v7|, |v8|} !! v25, v0, fm9(v6, v19, globalState), !v3 <==> v3, !v0, v0, v19, !v19];
				v26 := new bool[12];
				v3 := !true;
			}
			...
			var v35 := "cldrgrfef";
			var v36: array<bool> := new bool[12] [v3, if (v3) then v0 else v8[|v7|], v3, fm0(multiset(v34[v2[689]]), false, v35, globalState), if (v0) then false else v0, v0 && v3, v0, v0, v5 > --f5, v3, v3, if (v0) then v0 else v3];
			v36[486] := v3;
			v36[486] := (multiset(v8) + v7) >= (v7 * v7);
			var v37: array<map<bool, bool>> := new map<bool, bool>[29](i2 => map[v36[486] := v0]);
			var v38: map<int, int> := map[-f5 := v2[689]];
			var v39: map<bool, bool> := map[v0 := true];
			v37[439] := fm10(v2[689], v38, !v3, v2[689], globalState) + v39;
			v37[439] := v39;
		}
		v2[689] := f6;
		var v40: seq<int> := [0x309, v2[689]];
		var v41: map<bool, bool> := map[v0 := v3];
		var v42: set<bool> := {v0};
		v2[689] := v5 - (v40[f6] + fm2(|v41|, v42, globalState));
		r0 := v40[v5];
		r1 := v0;
	}
	method m2(p0: int, globalState: GlobalState) {
		...
		if (v0) {
			...
			var v4 := "rwfr";
			v1, v0 := v1, fm11(--p0, f5, f6, f6, globalState) == fm11(f5, |v3[v4[-p0] := 0x3e4]|, p0, |v4|, globalState);
			var v5 := DC6(v4, f6);
			var v6 := DC0(false);
			...
			match (v14) {
				case DC5() =>
					...
					v15[30] := fm2(f6, v10, globalState);
					v0, v0, v15, v15[30] := v0, v11 !! v11, if (v0) then v15 else v15, -fm2(f6, {v0} - v10, globalState);
					f6 := f5;
				...
				case DC4(cf4) =>
					...
					v21[433] := DC2();
					v21[433] := v20;
					var v22: map<string, int> := map[v4 := |v9[379]| * p0];
					...
					v23, v25, v26[249], v0, v0 := v23, v25, v28.cf28, (p0 < fm2(f5, v10, globalState)) && (f5 == p0), v7 > (v7 - multiset{!true});
					f6 := v24.f5;
			}
			...
			var v35: array<int> := new int[28] [p0, p0, f6, f5 / f6, -f5, f5, |(set v29 : int | (590 <= v29) && (v29 < 0x2cc) :: (v29 * f6))|, |v30| - 775, f6, |(v32 + (if (v33 in v34) then v34[v33] else v32))|, p0, f6, f5 % f5, f5 + 0x39, p0, f5, p0, if (v0) then f6 else f5, f6, f5, p0, f5, -(if (true) then f6 else p0), f6 + p0, f6, f6, p0 + |"fmkmdiv"|, f6];
			...
			var v40: seq<int> := [|(seq(0x2f, i0  => ('w')))|];
			var v41: array<bool> := new bool[3] [v0, v40 != v40[f6 := |v40|], v0];
			v41 := v41;
			v35[267] := f6;
			v35[267] := p0;
		}
		...
		if (v46[-0x264]) {
			...
			if (v0 <==> (f6 <= p0)) {
				...
				var v64: set<int> := {f6};
				var v65: multiset<char> := multiset{v42[508], v42[508]};
				var v66: array<bool> := new bool[20] [v0, v49 <= v51, false, !false, v61 >= multiset{v63.cf11}, v64 != {f5}, v0, v0, v44 !! v44, v50 <= v50, v61 !! multiset{f5, p0}, v0, f6 > 888, v0, v0, !v0, v65 >= (multiset{'b', v43})[v43 := p0], v0, v0, v0];
				v66[284] := v0;
				v66[284] := f5 >= f5;
				v66[284] := v0;
				var v67: multiset<array<int>> := multiset{v47};
				var v68: map<multiset<array<int>>, seq<int>> := map[v67 := v49];
				v68 := v68[v67 := ([f5])[|v51| := p0] + v49];
				var v69: set<array<bool>> := {v66, v66};
				v69 := v69;
			}
			
			var v70, v71, v72, v73 := m0('l', globalState);
			var v74: set<char> := {v42[508]};
			v74 := v74;
		} else {
			...
			v0 := !(if (v0) then v46[-|v78|] else v0);
			var v84: array<int> := new int[4](i1 => i1 % f5);
			v84[436] := -(f6 * f6);
			v84[436] := -(p0 - f6);
		}
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			m4(multiset{f5} > multiset(seq(89, i3  => (f5))), globalState);
			f6 := 0x349;
			var v86: seq<set<int>> := [set v85 : int | (379 <= v85) && (v85 < -0xdc) :: (v85 % |"wxvn"|)];
			match (fm20(v86[f6], !(f6 == f5), false, globalState)) {
				case DC1(cf1, cf2) =>
					var v87 := "ekgniqmts";
					v42[508] := v87[f6 + 0x35e];
					cf2 := cf1;
					...
					var v95: set<char> := {v42[508]};
					var v96: seq<int> := [f6, |v87|];
					var v98: multiset<set<char>> := multiset{v95, set v97 : char | v97 in v95 :: (v97)};
					var v99: array<int> := new int[28] [-fm2(|{cf1, cf1}|, {v0}, globalState), f5, if (cf2) then f5 else f5, |v89|, f6, f6, f5, p0, p0, f5, f5, -0x135, f6, fm2(f6, v90, globalState), |v87|, if (!cf2) then |v91| else f6, -p0, f6, |v92| * |v94|, |(v46 + v46)|, f5, p0 * f6, -fm2(|v95|, v90, globalState), -f5, v96[f5], f5, f6, f5 / -(if (v95 in v98) then v98[v95] else f5)];
					var v100 := DC13(!v0, |v92|, cf2);
					v99, v42[508], v99, globalState.f2, v0 := v99, v42[508], v99, |(v96 + v96)|, v100.cf17;
				case DC2() =>
					...
					var v106 := new C1(|(seq(0x6b, i5  => (v43)))|, |v105[fm21(p0, p0, v0, globalState) := f6]|);
					f6 := -p0;
				case DC3(cf3) =>
					var v107 := "lsid";
			...
			if (v0) {
				v0 := v0;
				var v121: seq<int> := [f6];
				var v123: map<D3, bool> := map[fm22(set v122 : int | v122 in v121 :: (v122 + |map[|(seq(0x232, i7  => (-|{0x231}|)))| := |"vudi"|]|), v0, globalState) := v0];
				var v124 := DC21(v123);
				...
				var v132: array<map<D3, bool>> := new map<D3, bool>[28] [v123 + v123, v124.cf37, v123, v123, v123, v123 + (fm23(fm2(p0, v125, globalState), globalState))[v127 := true], v123, map[v127 := v0] + v123, map[v127 := v0], v123 + v123, (map v128 : D3 | v128 in v129 :: (v128) := (v0))[v127 := fm1(globalState)] + v123, map v130 : D3 | v130 in v123 :: (v130) := (v0), v123, v123, v123, if (v0) then v123 else v123, v123, v123, v123, v131[p0], v123 + v123, v123, v123 + map[v127 := v0], v123 + map[v127 := v46[f6]], map[v127 := !v0], v123, v123, v123];
				v132[526] := fm23(f6, globalState) + v123;
				var v133: set<seq<int>> := {[f5, -p0, f6]};
				v0, v0, v0, globalState.f2, v132[526] := (v133 + v133) < (v133 + v133), v0, -p0 >= p0, |v46| * (f5 * f5), v123 + (fm23(-|v46|, globalState) + v123[v127 := v0]);
				var v134: array<bool> := new bool[10] [v0, v0, v0, v0, v0, p0 != f6, v0, v0, v0, v0];
				v134 := v134;
				v0 := !v0;
				var v135: array<seq<int>> := new seq<int>[22];
				v135[431] := if (v0) then v121 else v121;
				v135[431] := v121;
			} else {
				...
				var v143: C1 := new C1(f6 / |v141|, |v142|);
				v43, v143, v0, globalState.f2 := v43, v143, v137, -v139 / v139;
				var v144 := "bnmpaxw";
				var v145 := new C1(-v139, -(f5 - |v144|));
				var v146 := DC3(v0);
				globalState.f2, v146, v137, v139, globalState.f2 := f6, v146, v137, v143.fm2(f6 - 0x39a, v140, globalState), -(|(v144 + v144[|multiset{v137}| := v42[508]])| * p0);
			}
		...
		if (true) {
			...
			match (v152) {
				...
				case DC2() =>
					...
					v147[729] := |(v155 + fm10(f5, map[f6 := p0], v0, p0, globalState))| + (p0 - p0);
					...
					v147[729], v156 := (v147[729] % v147[729]) % v147[729], if (fm24(v160, -597, v0, globalState) in v159) then v159[fm24(v160, -597, v0, globalState)] else v156;
					...
					v161[967] := v162;
					v0, v161[967], v151 := v147[729] < -v147[729], v162, seq(0x16a, i9  => (v43));
				case DC3(cf3) =>
					var v163: set<char> := {'h', v42[508], v42[508], v42[508], v42[508]};
					var v164: multiset<int> := multiset{|v151[0xd2 := v42[508]]|};
					v163, globalState.f2 := v163, (|v164| - f6) / v147[729];
					...
					var v170: map<bool, int> := map[v0 := v147[729]];
					...
					v172[51] := fm25(cf3, f6, v168, v171, globalState);
					v172[51] := fm25(if (v0) then cf3 else true, f6, v168 + v168, v171, globalState);
					v147[729] := f5;
				case DC0(cf0) =>
					var v173 := DC3(v0);
					...
					var v200: map<D5, int> := map[v199.(cf30 := cf0) := v147[729]];
					var v201: array<bool> := new bool[27];
					var v202: array<int> := new int[23] [f5, f6, fm2(p0, v194, globalState), v147[729], 195, f5, f6, f5, |v198|, |v151|, v193.f8, v147[729], f6, f6, |v200[v199 := f6]|, f5, f5, |map[v43 := v201]|, |v178|, v147[729], |v197|, -v193.f8, 0x4f];
					var v203 := DC16(v202);
					v203 := v203.(cf26 := v202);
			}
			...
			if (true) {
				...
				var v209: array<seq<bool>> := new seq<bool>[25] [v46, v46, v46, if (v0) then v46[-0x11 := v0] else v46, v46 + [v0, v0], v46, v46, v46, v46, v46, [v0] + v46, v46, v46, v46[p0 := v0], v46, v46 + v46, v46 + v46, v46[|v208| := false], v46[p0 := v0], v46, [v0], [v0, v0, v0, v0, true], v46, [false, v0, v0], [v46[v206.f8]] + [v0]];
				v209[914] := v46;
				v209[914] := v46;
				var v210: array<bool> := new bool[24];
				v210[970] := v0 !in v46;
				v0, globalState.f2, v210[970], globalState.f2 := !v0 in v209[914], v206.f8, v0, (v206.f8 + v206.fm4(v43, v44, v0, globalState)) % v206.f8;
				var v211 := "nep";
				f6 := -(|v211| * 0x1c1);
			} else {
				v147 := v147;
	...
	method m4(p0: bool, globalState: GlobalState) {
		if (if (p0) then p0 else p0) {
			...
			v5[24] := -f5 <= f5;
			v5[24] := fm9(DC5(), fm1(globalState) <==> p0, globalState);
			v5[24] := true;
			var v6: set<bool> := {p0, f6 == |v0|, p0};
			v6 := ({v5[24], v5[24]} - v6) + v6;
			var v7: seq<int> := [|[f5]|];
			var v8: map<int, int> := map[f6 := |v7|];
			var v9: seq<bool> := [p0, v5[24], v5[24]];
			var v10: multiset<bool> := multiset{p0, !v9[f6], v5[24]};
			var v11: array<int> := new int[18] [f6, |v8|, f5, f5, f5, f5, f6, |multiset(v7)|, f6, 199, f5, f5, f6, f5, f6, f5, |v10|, f5];
			var v12: map<int, bool> := map[f5 := !v5[24]];
			var v13 := DC17(|fm11(f5, f5, f5, -|v7|, globalState)|, v11, v12);
			var v16: map<char, int> := map[v2 := f5];
			var v18: array<D5> := new D5[28] [v13, DC17(f5, v11, map v14 : int | (0xab <= v14) && (v14 < 0x3ba) :: (v14 * |"ljpgjdur"|) := (v5[24])), DC17(|v10|, v11, map v15 : int | v15 in v0 :: (v15 + |v12|) := (v5[24])), if (v5[24]) then v13 else v13, v13, v13, v13, v13, v13, v13, v13.(cf28 := v11), v13, v13, DC17(-f6, v11, v12), DC17(if (v2 in v16) then v16[v2] else f5, v11, map v17 : int | v17 in v12 :: (v17 % f5) := (v5[24])), v13, DC17(0x27f, v11, v12), v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, DC17(f6, v11, v12)];
			v18 := new D5[6] [v13, v13, v13, v13, v13, v13];
			v10 := v10;
		} else {
			var v19: map<int, int> := map[f6 := f6];
			var v20: map<bool, bool> := map[p0 := p0];
			globalState.f2 := (if (|fm10(-0x29e, v19, p0, f6, globalState)| in v19) then v19[|fm10(-0x29e, v19, p0, f6, globalState)|] else f6) % |v20|;
			var v21 := 'h';
			v21 := v21;
			globalState.f2 := f6;
			var v22 := false;
		...
		if (match v31 {
			...
			if (p0) {
				...
				var v43: seq<bool> := [p0];
				var v44: array<bool> := new bool[26] [v28, v28, v28, v28, p0, v41.cf2, v28, p0, false, v28, p0, p0, p0, v28, p0, p0, v42.cf46, v28, true, p0, p0, v43[f5], p0, p0, p0, v28];
				var v45: seq<array<bool>> := [v44, v44];
				var v46: map<bool, int> := map[p0 := f5];
				var v48 := 'b';
				var v49: map<map<bool, int>, char> := map[v46 := v48];
				var v50: map<seq<array<bool>>, bool> := map[v45 := map[v46 := v36[|(set v47 : int | (0x154 <= v47) && (v47 < 0x225) :: (v47 % |v43|))|]] == v49];
				v50 := v50[v45 := v28];
			}
			...
			match (v52) {
				case DC7(cf7) =>
					...
					var v63: set<int> := {f6};
					v61[750] := map v62 : int | v62 in v63 :: (v62 / f6) := (f5);
					v61[750] := v54 + (map v64 : int | v64 in v54 :: (v64 % f5) := (f5));
					v59 := v59;
					globalState.f2 := f5;
			}
			...
			if (v65 !! v65) {
				...
				v66[761] := fm2(f6, v67, globalState);
				var v68: seq<bool> := [p0];
				v66[761] := |map[multiset(v68) := (seq(-0x346, i1  => ('h')))[0x26c := 'l']]| * f5;
				var v69 := 'g';
				var v70: map<int, char> := map[f6 := v69];
				v69 := if ((if (p0) then v66[761] else f6) in v70) then v70[if (p0) then v66[761] else f6] else 'e';
				var v71: array<bool> := new bool[7](i2 => p0);
				v71[169] := fm1(globalState);
				var v72 := DC5();
				v71[169], globalState.f2, v28 := p0, f5, fm9(v72, true, globalState) && v28;
				...
				var v87: seq<C1> := [v86];
				var v88 := DC31(v86);
				var v89: array<C1> := new C1[23] [v86, v86, v86, v86, v86, v86, v86, v87[v82.f8], v86, v86, v86, v88.cf51, v86, v86, v86, v86, v86, v86, v86, v86, v86, v86, v86];
				var v90: set<array<C1>> := {v89, v89, v89, v89, v89};
				v84[154] := [|({v89} - v90)|, v82.f8];
				var v91: array<int> := new int[28](i3 => i3 % f6);
				var v92 := DC16(v91);
			...
			if (v95[913]) {
				v28 := v95[913] <==> p0;
				var v97: multiset<bool> := multiset{v95[913]};
				var v98: set<int> := {-|v96|};
				var v99: multiset<bool> := multiset{v97 >= v97, v98 !! v98};
				var v100: seq<bool> := [v95[913]];
				var v101: seq<set<int>> := [v98];
				v97 := (v99 - multiset(v100[-f6 := p0]))[v95[913] := if (false) then f5 else |v101[f5]|];
				v95[913] := v28 ==> v95[913];
				...
				var v105: map<seq<int>, map<C1, bool>> := map[seq(0x328, i4  => (f5)) := v104];
				var v106: array<seq<bool>> := new seq<bool>[3](i5 => [v95[913], v95[913]] + [v95[913]]);
				var v107: seq<int> := [f6];
				globalState.f2, v105, v106 := f6, map[v107 := v104], v106;
				v96 := "kobrta";
				var v108: seq<bool> := [v95[913], false];
				v108 := if (p0 <==> v95[913]) then v108 + v108 else v108;
...
class C3 extends T1 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			v2, v3[870], v0 := v5.cf4, f7, map[v6 !! v6 := f7];
			var v7 := "eijplewq";
			var v8 := DC6(v7, f5);
			var v9: seq<int> := [f5, f5, -f6, f5, fm2(f5, v4, globalState)];
			var v10: seq<int> := [-f6, v8.cf6, v9[0xa8], 0xf0, f6];
			r0 := v10[-|(seq(0x36d, i1  => ("fnkhhatg")))|];
		}
		r1 := f7;
		...
		v11[709] := !(multiset{v12} > v17);
		v11[709] := f7;
		var v18: multiset<bool> := multiset{v11[709], v11[709]};
		var i2 := 0;
		while (|v18| != -f6)
			decreases 100 - i2
		{
			...
			v19[201] := if (f6 in v21) then v21[f6] else v20;
			var v22 := "wgosnrps";
			var v23: map<string, array<int>> := map[(seq(0x7f, i3  => (v14))) + v22 := v19[201]];
			var v24 := DC6(v22, f6);
			v19[201] := if ((v24.cf5 + v22) in v23) then v23[v24.cf5 + v22] else v20;
			v14 := v14;
			if (v11[709]) {
				var v25: seq<int> := [f5];
				var v26: seq<seq<int>> := [[f5, f6]];
				var v27: seq<bool> := [f7];
				r1 := if (if (f7) then f7 else f7) then !(v25 < v26[|{|v27|}|]) else false;
				...
				v29[155] := v28;
				v29[155] := v28;
				var v30: set<bool> := {v11[709]};
				v30 := (if (f7) then v30 else v30) * v30;
				var v31: map<array<bool>, int> := map[v11 := f5];
				var v32: map<bool, bool> := map[v11[709] := v31 == v31];
				v32 := v32 + v32;
				var v33: seq<string> := [v22, "dajoybt", v22[f6 := v14], v22];
				v22 := (v33[f6] + "iugifadp") + "viaetyyar";
			} else {
				var v34: seq<int> := [f6, f6];
				var v35: map<bool, int> := map[f5 != f5 := v34[f5]];
				var v36 := DC7(v35);
				v35 := v35 + v36.cf7;
		...
		if (v11[709]) {
			...
			var v42: map<bool, char> := map[v11[709] := v14];
			var v43: array<int> := new int[11] [v39.f8 - |v40|, |"sksxj"|, v39.f8 + -v39.f8, f5, v40[|v41|], f6, f6, -v39.fm4(v14, fm5(v40, f7, f6, globalState), v11[709], globalState), |v42|, f5 - f6, v39.f8];
			var v44: map<array<int>, int> := map[v43 := f6];
			var v45: array<string> := new string[6];
			var v46 := "gfn";
			var v47: map<bool, array<int>> := map[v11[709] := v43];
			var v48: multiset<array<bool>> := multiset{v11};
			v43, v44, v45, v46, r0 := if (v11[709] in v47) then v47[v11[709]] else v43, v44, v45, v46, if (v11 in v48) then v48[v11] else v39.fm4(v14, fm5(seq(0x212, i4  => (|map[f7 := v39.f8]|)), v11[709], f5, globalState), v11[709], globalState);
			var v49: map<bool, int> := map[v11[709] := f6];
			globalState.f2 := (|v49| - v39.f8) / v39.f8;
			v11[709] := v11[709];
		} else {
			globalState.f2 := f5;
			v11[709] := true;
			...
			v50 := v51[f6];
			var v52: array<seq<bool>> := new seq<bool>[7](i5 => [f7] + [DC1(!v11[709], v11[709]).cf1]);
			var v53: seq<bool> := [v11[709], v11[709]];
			v52[989] := v53;
			v52[989] := v53;
		}
	...
	method m2(p0: int, globalState: GlobalState) {
		if (if (f7) then true <==> f7 else f7) {
			...
			var v1: array<int> := new int[29](i0 => i0 % f6);
			var v2: seq<array<int>> := [v1, v1];
			var v3: seq<array<int>> := [v1, v2[p0]];
			v0[197] := v2;
			v0[197] := v3;
			var v4 := DC1(f7, f7);
			var v5: multiset<D0> := multiset{v4};
			var v6: seq<int> := [|map[v1 := f6]|];
			var v7: set<multiset<D0>> := {v5, v5[v4 := |v6|]};
			if (v7 <= (if (false) then v7 else v7)) {
				...
				var v13: seq<bool> := [f7];
				var v14: array<string> := new seq<char>[21] [((seq(-0x25a, i1  => (v8))) + v9)[0x326 := fm6(|v10|, |"kjqkqeiu"|, f7, f7, globalState)], if (!f7) then seq(0xe0, i2  => (v8)) else v9, v9, ("me")[p0 := v8], (fm7(v8, f7, f7, f6, globalState))[p0 := v8], v12.cf5, seq(0x1ae, i3  => (v8)), seq(-983, i4  => (v8)), v9, v9, "hcns", "gmyra", v9, "dyonfg", v9, v9 + "npwl", v9, v9, fm7('i', v13[|v9|], f7, |"biesqdee"|, globalState), v9, v9];
				var v15: multiset<int> := multiset{f6, f6};
				v1[928] := |(multiset{p0} + v15)|;
				v14, v1[928] := v14, fm2(|v6|, v11, globalState);
				...
				v8 := if ((if (v19 in v20) then v20[v19] else v8) in v16) then v16[if (v19 in v20) then v20[v19] else v8] else v9[f5];
				var v21: array<seq<int>> := new seq<int>[29];
				var v22 := DC11(v6);
				var v23: map<array<seq<int>>, D4> := map[v21 := v22];
				v23 := v23[v21 := v22.(cf13 := seq(-0x2fc, i5  => (0x1c8)))];
				v13 := v13;
			} else {
				...
				v24.f6 := if ([v1, v1] in v29) then v29[[v1, v1]] else |(seq(351, i6  => ('c')))| - 0x28;
				var v30 := 's';
				var v31 := "yern";
				v28 := v30 in v31;
			}
			...
			match (v33.(cf8 := v32)) {
				...
				case DC8(cf8) =>
					...
					var v46 := 'd';
					v1[456], f6, v40, v43 := f6, -0xd4, (|v6| + f6) >= ((if (v44 in v45) then v45[v44] else 0x123) - p0), map[v46 := v1];
				...
				case DC10(cf12) =>
					...
					var v53 := DC6(v51, f6);
					var v54: T1 := new C2(|(seq(826, i8  => ('e')))|, |fm5([p0, f6, p0], f7, |v53.cf5|, globalState)|);
					...
					v55[150] := f5 in v56;
					v55[150] := !f7;
					var v57: seq<bool> := [v55[150]];
					var v58: multiset<multiset<bool>> := multiset{multiset([v55[150]] + v57)};
					globalState.f2 := |v58|;
					var v59: map<bool, int> := map[v55[150] := |"ffv"|];
					v55[150] := -0x4d <= (fm2(|v59|, {f7, v55[150], f7}, globalState) % p0);
					v55[150] := f7;
			}
			
			var v60 := new C2(v6[f6], f5);
		} else {
			var v61 := 'a';
			v61 := v61;
			var v62: array<int> := new int[10](i9 => i9 % f5);
			...
			v67[713] := v64;
			var v68 := "tsvv";
			v62, v61, f6, v67[713] := v62, v68[|v68|], p0, multiset{v63};
			v68 := v68;
			var v69 := true;
			var v70: set<int> := {f6};
		...
		if (!!f7) {
			...
			v78[446] := if (f7 in v79) then v79[f7] else p0;
			...
			var v83 := "thwvihdbx";
			var v84 := 'm';
			v82[305] := (v83 + "no")[f5 := v84];
			globalState.f2, v80[910], v82[305] := (f5 % p0) + fm2(p0, {f7, f7, f7}, globalState), f7, ("rsn")[f6 := v83[p0]] + (v83 + v83);
			v80[910] := false;
			var v85: map<int, int> := map[v78[446] := 525];
			var v86: map<int, bool> := map[f6 % -v78[446] := fm2(0x12d, {f7, v80[910]}, globalState) == |v85|];
			v86 := v86[f5 := [-v78[446]] == v81];
		} else {
			...
			if (f7) {
				...
				v89[712] := f7;
				v89[712] := fm1(globalState);
				var v91: array<int> := new int[4] [f5 + -0x24b, f5, p0, p0 / 0x23];
				v91[692] := 428;
				v91[692] := (if (v90) then |"qiamx"| else f6) + (p0 * 0x8c);
				var v92 := DC14(p0, v90, v91[692], true, f6);
				var v93: map<int, array<int>> := map[v92.cf22 := v91];
				v93 := v93[f5 := v91];
				var v94: seq<int> := [p0];
				var v96 := DC4(set v95 : int | v95 in v94 :: (v95 / |[!false, true]|));
				var v97: set<int> := {f5, p0, v91[692], p0};
				v96 := v96.(cf4 := v97);
			} else {
				var v98 := false;
				var v99 := "ympy";
				...
				v98, v98, v98, v99 := v100 !in v101, fm2(f5, {f7}, globalState) in ((map v102 : int | v102 in v103 :: (v102 % p0) := (0x339)) + v104), v98, if (true) then v99[p0 := v106.cf34] else seq(0x110, i11  => (v105));
				v98 := f7;
			...
			v89[491] := if (f7) then true else !f7;
			v89[491] := f7;
			var v109: map<bool, bool> := map[v89[491] := v89[491]];
			v109 := v109[v89[491] := f7];
			v89[491] := v89[491];
		}
		...
		for i13 := p0 - |v111| to |fm7(v112, fm0(multiset(v114), f7, "pcfqhi", globalState), f7, f5, globalState)| {
			...
			if (v115.cf15 !in (v110 * multiset{f6})) {
				...
				var v119: seq<seq<bool>> := [v118[f6 := f7]];
				var v120 := DC34(!f7);
				var v121: map<int, D12> := map[f6 := v120.(cf56 := !f7)];
				var v122: map<seq<bool>, int> := map[v119[|v121|] := i13 / i13];
				v122 := v122[([true])[|v111| := true] := |v113| % f6];
				var v123 := true;
				...
				var v133 := new C2(|v111|, |(v131 + v132[857])|);
			...
			if ((v137 - v137) in (v138 * multiset(v139))) {
				v137 := v137;
				globalState.f2 := (p0 * -|fm28(f6, globalState)|) / f5;
				...
				f6 := |fm5(v141, DC37(v137).cf63 <= v137, i13 * |(seq(103, i15  => (v112)))|, globalState)|;
				var v142: array<bool> := new bool[5] [!f7, !true, f7, i13 != |v111|, f7];
				v142[936] := f7;
				v111, v142[936] := v111, true;
				v140 := [false];
			} else {
				globalState.f2 := i13;
				...
				v144[245] := if (f7) then v143 else v143;
				v144[245] := v143;
				var v145: array<int> := new int[4] [i13, p0, f6, p0];
				var v146: map<set<bool>, int> := map[v137 := i13];
				var v147: map<bool, int> := map[f7 := 0x100];
				var v148: T1 := new C2(|(seq(-827, i16  => ('p')))|, f5);
				var v149: set<T1> := {v148, v148};
				v145 := new int[15] [p0, f5 - i13, i13, i13 / -0x9e, if (v137 in v146) then v146[v137] else f5, |(v147 + map[f7 := 627])|, f5, p0, |v149|, v148.f6, v148.f6, if (f7 in v147) then v147[f7] else v115.cf15, if (f7) then f6 else i13, v148.f6, -v148.fm2(p0, v137, globalState)];
				v145[601] := f6;
				var v150: multiset<bool> := multiset{f7};
				v145[601] := fm2(v148.f6, fm21(-|v111|, |v150|, true, globalState), globalState);
		...
		if (f6 <= 918) {
			...
			var v167: seq<set<array<bool>>> := [if (|(seq(-0x31e, i17  => (v112)))| in v166) then v166[|(seq(-0x31e, i17  => (v112)))|] else v162];
			v165[659] := v167[f5];
			v165[659] := v162;
			if (!v153) {
				...
				var v174: C1 := new C1(v154.f8 / (if (f7 in v171) then v171[f7] else v154.f8), |v173| - f6);
				...
				v170, v174, v175[653], v153, v178 := v170, v174, v177, if ((v179 + v179) in v180) then v180[v179 + v179] else v153, v178;
			...
			if (!((multiset{v111, v111} * multiset{v111}) >= fm30(globalState))) {
				...
				var v193: T0 := new C1(v191[v190.fm4(v112, v192, f7, globalState)], f5);
				...
				v201[354] := if (f7) then f7 else true;
				var v202: seq<string> := [seq(0x3b7, i18  => (v112)), seq(0x305, i19  => (v112))];
				var v203: map<int, int> := map[p0 := |v202[f5]|];
				var v204: seq<int> := [|v203|, p0];
				v201[354] := v204[|[f7]|] < f5;
				var v205: C0 := new C0(f6);
				var v206: array<C0> := new C0[5] [v205, v205, v205, v205, v205];
				v206[966] := if (v201[354]) then v205 else v205;
				v206[966] := v205;
				v203 := v203[f5 := p0 % f6];
				var v207: T1 := new C1(if (f7) then f6 else f5, v205.f8 - v205.f8);
				var v208: seq<bool> := [v201[354], f7, f7];
				var v209: C2 := new C2(|v111|, |v208|);
				var v210: seq<C2> := [v209];
				v207, v201[354], v112, v204 := v207, v209 !in v210, v112, v204;
			}
	...
	method m3(globalState: GlobalState) returns (r0: T0) {
		...
		var v6: set<int> := {|v0|};
		var v7 := "exw";
		var v8: multiset<string> := multiset{seq(-0x3bd, i0  => ('c')), v7, seq(0x223, i1  => ('m')), v7};
		...
		match (v18) {
			case DC17(cf27, cf28, cf29) =>
				...
				v11, f6, globalState.f2, v11, v16 := v11, v19[-cf27], 0x3a0, 0x192 != |v3|, map[if (v11) then v13 else v13 := f5 - f6];
				v2 := v2 * v2;
				globalState.f2 := f5;
			case DC18(cf30, cf31, cf32) =>
				...
				if (f6 == (135 % f6)) {
					...
					var v21: C2 := new C2(868, |{seq(0x6b, i2  => (v13))}|);
					var v22: seq<C2> := [v21, v21, v21];
					v21 := v22[-(0x1ef % v20.f8)];
					var v23: array<bool> := new bool[22](i3 => cf30);
					v23[623] := cf32;
					v23[623] := v6 <= v6;
					var v24: map<bool, int> := map[!v23[623] := cf31 / fm2(v20.f8, v4, globalState)];
					...
					v23[623], v13, v24, v25[168], v28[143] := v21.fm9(v29, f5 >= |v6|, globalState), v30.cf34, map[cf30 := 0x25b + f6], fm11(cf31, if (f5 in v31) then v31[f5] else v20.f8, -|v0| % v20.fm4(v13, v2, f7, globalState), cf31 % f6, globalState), v26;
				} else {
					v13 := v13;
					var v32: array<string> := new string[24];
					v32[296] := v7 + v7;
					v32[296] := v7;
					var v33: array<bool> := new bool[6](i4 => multiset{DC23(f6, v7, |v6|)} >= multiset([DC23(if (cf32 in v2) then v2[cf32] else f5, v32[296], f5)]));
					v33 := v33;
					var v34: seq<string> := [DC6("htofcuax", f6).cf5, v32[296], v32[296]];
				...
				if (v37 < v37) {
					...
					var v44: array<multiset<int>> := new multiset<int>[9] [v43, v43, v43, v43[|v43| := f5], v43 * v43, multiset{-0x186, f6, f5}, v43, v43 - v43, v43[f5 := f5]];
					v44 := v44;
					...
					v48[260] := v49;
					v48[260], globalState.f2, v47 := v49, f6, v47;
				}
				
				var v50 := DC36(v11, cf32, v7);
				var v51: seq<string> := [v7, v7, "ey"];
				var v52: array<string> := new string[18] [v7, fm11(f5, f6, cf31, f6, globalState) + v7, v50.cf62, v7[f6 := v13], v7, v7, v7, v7, v7 + "iaddku", v7, v7, "qpastef", v7, v7, v7, v51[cf31], seq(5, i5  => (v13)), v7];
				v52 := new string[8];
			...
			case DC16(cf26) =>
				...
				v64[342] := v63;
				v64[342] := fm27(f6, globalState);
		}
		
		if (!(v4 !! {v11, v11, f7, !f7})) {
			var v65: multiset<map<int, bool>> := multiset{v9};
			var v66: seq<multiset<map<int, bool>>> := [v65];
			if (fm0(v66[f6], v2 > v2, v7 + v7, globalState)) {
				var v67: map<string, int> := map[seq(58, i7  => ('s')) := f5 % f5];
				...
				var v74: seq<int> := [0x2af - f5, f6 / f6, f6 + f6, f5, fm2(f6, v4, globalState)];
				v68[950], v1, globalState.f2, globalState.f2, v68[44] := v71.cf3, map v72 : int | (-0x189 <= v72) && (v72 < 0x2e7) :: (v72 % 513) := (f6), (f6 - (if (v11 in v73) then v73[v11] else f5)) * -f6, v74[f5], v3[|(v7 + ("esd")[fm2(f6, v4, globalState) := v13])|];
				globalState.f2 := -((if (v68[950]) then f5 else -f6) % fm2(f5, v4, globalState));
				v9 := v9[f5 := fm0(v65, f7, v7, globalState)];
				v7 := fm7(v13, v68[950], v11, -|v74|, globalState);
			} else {
			...
			if (v11) {
				...
				v80[931] := v83 + v83;
				var v84: seq<seq<bool>> := [v3 + v3, ([f7])[f5 := !f7] + v3, v3 + v3[|"bsnlo"| := false]];
				var v85: array<char> := new char[15](i9 => if (f7) then v13 else 'u');
				v85[992] := v13;
				v17[304] := f5;
				v13, v80[931], v84, v85[992], v17[304] := v13, v83, v84[|v2| := v3], fm18(v11 || v11, f6 + -|v6|, f5, v11, globalState), (f6 + 580) % (|v2| % f6);
				var v86: seq<multiset<bool>> := [v2];
				var v87 := DC1(!true, f7);
				var v88: C0 := new C0(v17[304]);
				var v89: set<C0> := {v88};
				var v90: seq<int> := [v88.fm4('m', v2, f7, globalState), v17[304]];
				var v91: array<bool> := new bool[23] [f7, !(f7 <== !f7), v11, !v11, v11, v11, f7, v11, v11, v11, v2 > v86[0x308], f7, v3[f5], f7, f7 || (if (f5 in v9) then v9[f5] else v11), false ==> v11, !true, v87.cf1, v89 > v89, fm34(v90, globalState) >= v10[0x2f7], !!fm1(globalState), false, f7];
				v91 := v91;
				v17[304] := 29 % v88.f8;
			} else {
			...
			v104[164], v106, v11 := v11, v106, v11;
		} else {
			...
			v112 := |(if ((v121[f5] >= v120) in v119) then v119[v121[f5] >= v120] else v118)|;
		}
...
method Main() {
	...
	if (v2) {
		...
		var v19 := DC38(v18);
		var v20: array<int> := new int[21] [|v15|, |v16|, v0 % v0, v0 / |{v0}|, |(v17 + v17)|, v0, -903, v0 + |v4|, v0, v0, v0, |v15|, v0, |fm35(true, |(seq(0x32d, i0  => (v0)))|, v0, v0, globalState)|, |v19.cf64|, 0x119, v0, v0, -0xe1, |v17|, v0];
		v20[190] := v0;
		var v21 := DC2();
		var v22 := DC9(v4, v21, v0);
		var v23: array<D3> := new D3[1] [v22];
		v23[694] := fm36(DC19(v0, v1, v0), v1, v2, globalState).(cf10 := v21);
		v2, v20[190], v23[694] := !v2, (0x20c - |v15[v0 := v1]|) - --|v17|, v22;
		var v24 := DC23(v20[190], v15, |v16|);
		var v25: multiset<string> := multiset{v15, v24.cf41, v15};
		if (v25 == v25) {
			var v26, v27, v28, v29 := m0(v1, globalState);
			var v30: C3 := new C3(v27, v0, v0);
			var v31: map<int, C3> := map[v20[190] + 0x260 := v30];
			...
			var v36: set<bool> := {v2};
			var v37: seq<int> := [v20[190], |{true, !v2}|];
			v31, v32[376], v27, globalState.f2 := v31, v30.fm0(v35 - v35, v2, v15, globalState), v30.fm2(209, v36, globalState) >= |v37|, v29;
			var v38 := new C3(v2, v20[190], v0);
			var v39 := new C1(v20[190], -v20[190]);
			var v40: seq<array<bool>> := [v32, v32, v32, v32];
			var v41 := DC22(v32, v15);
			var v42: array<array<bool>> := new array<bool>[13] [v40[v20[190]], v32, v32, v32, v40[v20[190]], v32, v41.cf38, v32, v32, v41.cf38, v32, v32, v32];
			var v43: seq<string> := [seq(167, i1  => (v1))];
			v20[190], globalState.f2, v42, v0 := -(v29 / |[v2, v38.f7, v2, v38.f7, true]|), v20[190], v42, |v43[v20[190]]|;
		} else {
			globalState.f2 := v0;
			var v44: C3 := new C3(v2, v20[190] + 11, v20[190]);
			var v45 := DC39(v44);
			v44 := v45.cf65;
			var v46: array<multiset<bool>> := new multiset<bool>[25];
			v46[558] := v18;
			v0, v46[558] := -v20[190], v18 + v18;
			var v47: array<bool> := new bool[10](i2 => v44.f7);
			var v48: map<char, array<bool>> := map[v1 := v47];
			var v49: map<array<bool>, int> := map[if (v1 in v48) then v48[v1] else v47 := v20[190]];
		...
		var v52: T1 := new C1((if (v50 in v51) then v51[v50] else |v15|) * v50.f8, v20[190] + v0);
		v52 := v52;
		var v53: seq<int> := [v0, if (v20[190] in v16) then v16[v20[190]] else v52.f5, v52.f5];
		...
		decreases 100 - i3
	{
		...
		var v59: seq<bool> := [v2];
		v57 := fm7(if (v2 in v58) then v58[v2] else v1, v2, |v59| == -v0, -v0 % v0, globalState);
	}
	var v60: seq<bool> := [false];
	var v61: set<bool> := {!v60[v0]};
	var v62 := "uapcj";
	var v63: array<int> := new int[9] [if (v2) then v0 else -v0, -(-v0 * v0), |(seq(0x324, i5  => (v1)))|, v0, |v61|, v0, |(v62 + "qmhnk")|, |(v61 * v61)|, v0];
	...
	match (v64) {
		...
		case DC4(cf4) =>
			if (if (v2) then v0 <= v0 else v2) {
				...
				var v79 := DC7(v78 + v78);
				v74, globalState.f2, v79, v2 := v74, -v0, DC7(v78), (v0 / v0) == v0;
			} else {
				v2 := v2;
				var v80: seq<int> := [v0];
				var v81: map<seq<int>, int> := map[v80 := v0];
				var v82: map<string, int> := map[v62 := v0];
				v0 := |v81[v80 + [v0] := if (v62[v0 := v1] in v82) then v82[v62[v0 := v1]] else v0]|;
				v60 := v60;
				...
				globalState.f2 := (v0 % v0) + fm37(v2, v0, v83.fm0(v87, v2, v62, globalState), globalState);
			}
			
			var v88, v89, v90, v91 := m0(v1, globalState);
			var v92: array<bool> := new bool[29](i6 => v89);
			var v93 := DC22(v92, seq(22, i7  => (v1)));
	...
	var v97: seq<int> := [|v4|];
	var v98: map<int, bool> := map[v97[v0] := v2];
	var v99: multiset<bool> := multiset{v2};
	var i8 := 0;
	while (match fm3(fm37(false, |v96|, fm38(v98, v2, v2, v2, globalState), globalState), 0x179, [v99], v97[v0 := |"daff"|], globalState) {
		case DC5() => v2
		case DC6(cf5, cf6) => v2
		case DC4(cf4) => v2 <== v2
	})
	...
	for i9 := |(v105 + v105)| to |v62| {
		...
		v98 := if (v2) then (map v106 : int | v106 in v107 :: (v106 / v0) := (v2)) + v98 else map[v0 := v2];
	...
	v109[135] := v110[v0 := v0];
	v109[135] := if (v2 <== v2) then v110 + map[536 := v0] else v110;
	v63[303] := -0x284 + v0;
	v2, globalState.f2, v63[303], globalState.f2 := !true, -(v0 % v0) * (v0 + |v62|), -(v0 - v0), v0;
	var v111: map<bool, int> := map[v2 := v63[303]];
	v111 := v111[!v2 := v0];
	var v112 := DC8(v96);
	var v113: seq<D3> := [v112, v112];
	var v114 := DC40(v113);
	v113 := v113 + (v113 + v114.cf66);
	var v117: map<int, map<int, bool>> := map[v63[303] := v98];
	var v119: set<int> := {v0};
	var v121: map<map<int, bool>, map<int, bool>> := map[v98 := v98];
	var v122: array<map<int, bool>> := new map<int, bool>[23] [v98, v98, v98, v98, map[0x11c := false], v98 + v98, v98, v98, (map v115 : int | v115 in v4 :: (v115 / -0x1a0) := (v2)) + v98, v98 + v98, v98 + v98, v98, v98[v63[303] := v2] + v98, map[197 := v2], if (v2) then v98 else map v116 : int | v116 in v4 :: (v116 / v63[303]) := (v2), if (|v62| in v117) then v117[|v62|] else v98, map v118 : int | v118 in v119 :: (v118 % v0) := (v2), map v120 : int | (831 <= v120) && (v120 < 188) :: (v120 + v63[303]) := (v2), v98, v98, map[v63[303] := v2] + v98, if (v98 in v121) then v121[v98] else v98, map[v63[303] := !v2]];
	...
	for i10 := v125 to v125 {
		if (v2) {
			v96 := v96[!!v126 := 0x6a > v63[303]];
			v2 := ((set v127 : int | (0x114 <= v127) && (v127 < 0x1f8) :: (v127 % v63[303])) + {v63[303], |multiset{v0, v125}|}) >= ((set v128 : int | (0x330 <= v128) && (v128 < 77) :: (v128 / i10)) + v119);
			v2 := |v4| > v123.fm2(v123.fm2(v63[303], v61, globalState), {true}, globalState);
			var v129: array<seq<bool>> := new seq<bool>[27];
			v129[361] := v60 + v60;
			v129[361] := [v126, false ==> v2];
			var v130: array<bool> := new bool[16](i11 => !false || !v2);
			v130[891] := v126;
			var v131 := DC42(v63[303], |v62|, v1);
			var v132: map<seq<bool>, int> := map[v129[361] := |v62|];
			v1, v2, v130[891] := v131.cf70, v2, !(|v132| < v125);
		} else {
			var v133: map<seq<int>, int> := map[v97 + v97[|v96| := v125] := v125];
			v133 := v133[v97 := |v97|];
			v63[303] := i10;
			v123.m2(v125, globalState);
			var v134 := DC23(fm37(v2, v0, v126, globalState), seq(0x2a9, i12  => (v1)), |"nltodsjko"| % v63[303]);
			v134 := v134;
			v63 := v63;
		}
		...
		match (v151.(cf51 := v149)) {
			...
			case DC31(cf51) =>
				...
				var v157: T1 := new C3(v2, v63[303], i10);
				...
				v63[303], v164 := -(v162.f8 * v63[303]), v164[[v162] := -v63[303]];
		}
		
		var v165: T1 := new C3(v61 !! {v2}, v63[303], v0);
		v165 := v165;
	}
	v0 := fm37(fm38(v98, v2, v2, v126, globalState), v63[303], v2, globalState);
	if (v119 == v119) {
		...
		if (if (v167 in v168) then v168[v167] else v126) {
			var v169 := DC14(v63[303], v2, |v62|, !!v126, v0);
			...
			v172, v173, v174[623], v63[303] := v172, v173, !v2, if (v2) then |v177| - |v60| else v175.f6;
			v174[623] := v126;
			var v178, v179 := v123.m1(globalState);
			v124, v174[623], v123, v2, v179 := (v124 + v124)[v123 := 328], v174[623], v123, v2, v60[|(map[|[v175.f5]| := v1])[-v175.f6 := v1]|];
			v2 := |v62| != 0x3e6;
		} else {
		...
		v183[6] := v184;
		globalState.f2, v183[6], v63[303], v62, v62 := v125, v184, v125, v62, if (v2) then v62 else v62;
		var v185: array<C1> := new C1[2];
		var v186: C1 := new C1(v63[303], |v110|);
		v185[47] := v186;
		v185[47] := v186;
		globalState.f2, v1 := v63[303], v1;
	} else {
		v62 := "qcqcxq";
		v123.m2(|v62| / v63[303], globalState);
		v126 := ('a' in "miaw") ==> (if (0x1cd in v98) then v98[0x1cd] else v2);
		if (v126 || !v2) {
			var v187 := new C0(v63[303]);
			var v188: seq<map<bool, int>> := [v111, v111];
			var v189: set<char> := {v1};
			var v190: array<map<bool, int>> := new map<bool, int>[11] [v111, v111 + v111, v111 + v111, v111, v188[v187.f8], map[v126 := v125] + map[v126 := |v189|], fm39(globalState), v111, v111, v111, v111];
			v190[123] := map[!v126 := v125] + map[v126 := 193];
			globalState.f2, v97, v190[123], globalState.f2, v2 := v125 % |"awmjrtbl"|, v97, v188[v125], v123.fm2(--v63[303], v61, globalState), v126;
			globalState.f2, v1, v110 := v0 + v63[303], v1, map v191 : int | (0xf3 <= v191) && (v191 < 0x195) :: (v191 % |v4[|v61| := |v96|]|) := (v187.f8);
			v62 := v62[v125 := v1];
			var v192 := DC37(v61 - v61);
			v192 := (if (v2) then v192.(cf63 := {false, v126}) else v192).(cf63 := v61);
		} else {
			var v193, v194 := v123.m1(globalState);
			var v195 := new C2(v97[v0], 0x88);
			var v196: seq<string> := [v62];
			var v197: seq<set<int>> := [v119];
			v194, v63[303], v63[303] := if (|v196[|v197[v193]|]| in v98) then v98[|v196[|v197[v193]|]|] else v194, v0 + (v193 * 0x3bb), v125;
			v125 := v125;
			globalState.f2 := v0 % v125;
		}
