...
function fm1(globalState: GlobalState): int {
	-|(match DC0(seq(0x255, i0  => ('q'))) {
		case DC0(cf0) => {cf0} + {cf0, cf0, cf0}
	})|
}
function fm8(globalState: GlobalState): string {
	"vpftgh" + ((seq(0x27f, i0  => ('a'))) + "jimxsttfl")
}
function fm9(p0: bool, globalState: GlobalState): seq<int> {
	match DC34({[true], [true]}) {
		case DC34(cf62) => seq(0x31c, i0  => (0x36b))
	}
}
function fm10(globalState: GlobalState): set<int> {
	(if (false) then {|"ouixhpwjj"|, |DC20(|[false, true, false, false, false]|, true, false, false, map[|{0x13b}| := 0x6a]).cf38|, |map[-0x2a8 := ['f']]|} else DC17(set v0 : int | v0 in map[786 := |map[-0x277 := -19]|] :: (v0 / 0x185)).cf31) + ({0x213, |[false, true, false]|, |{!false}|} * (set v1 : int | v1 in (seq(-219, i0  => (|map[|"suq"| := !false]|))) :: (v1 + 0xc7)))
}
...
function fm14(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): string {
	match DC46({map[false := false]}) {
		...
		case DC46(cf85) => (seq(0x376, i0  => ('l'))) + "rw"
	}
}
...
function fm18(globalState: GlobalState): multiset<seq<int>> {
	multiset{[-|(seq(0x3a8, i0  => ('n')))|], [-501]} + multiset{[878]}
}
...
function fm27(p0: int, globalState: GlobalState): multiset<int> {
	multiset{0x108} + multiset{|DC17({0x2e7}).cf31|, |(seq(0x133, i0  => ({true})))|}
}
...
function fm31(p0: bool, p1: bool, globalState: GlobalState): string {
	match DC18(!true) {
		...
		case DC17(cf31) => (seq(0x375, i0  => ('m'))) + (seq(865, i1  => ('x')))
	}
}
...
function fm36(p0: bool, globalState: GlobalState): D2 {
	match DC51() {
		case DC51() => if (!true) then DC4(|multiset([true])|, 608, -0x359, 'f', seq(199, i0  => ('r'))) else DC4(478, |"crgitqdfk"|, |"hlk"|, 'k', "ovgnevf")
		case DC50(cf92) => DC4(--718, 0x380, -0x349, 'u', seq(-0x281, i1  => ('b')))
	}
}
...
function fm42(p0: int, p1: bool, p2: int, globalState: GlobalState): map<int, int> {
	map[if (false) then |map['j' := false]| else 0xd5 := 0x295 / 0x1f5]
}
function fm43(p0: bool, p1: D3, p2: bool, globalState: GlobalState): seq<int> {
	((seq(0x221, i0  => (|(set v0 : char | v0 in ['j', 'p', 'a', 'x', 'd'] :: (v0))|))) + [0x2a4, -0x337]) + ((seq(0x139, i1  => (-0x1b6))) + [0x277])
}
function fm44(globalState: GlobalState): seq<seq<bool>> {
	seq(-0x250, i0  => ([false, true, false]))
}
...
function fm50(globalState: GlobalState): set<seq<int>> {
	{[-0x1d5, |multiset{'u'}|], [---827]} - {seq(0x100, i0  => (|DC58({false, true}).cf109|)), [-|map[true := -|map[false := 880]|]|, 0x3ae, |multiset{-0x36e, 0x378}|], [|(map v0 : int | (996 <= v0) && (v0 < 410) :: (v0 / 72) := (false))|]}
}
...
function fm54(p0: bool, p1: bool, globalState: GlobalState): map<map<int, int>, int> {
	map[map[|(seq(-0x71, i0  => ('a')))| := 0x50] + map[|['n']| := -|[0x20c, -|(seq(-0x21d, i1  => ('j')))|]|] := |{0x364, -0x39c}|]
}
...
function fm56(p0: D4, p1: bool, p2: D15, globalState: GlobalState): set<string> {
	({seq(0x52, i0  => ('x')), "vgydj", "mxhrte"} + {"fqymdm"}) * {"hydj"}
}
...
method m0(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int) {
	match (DC31(p2).(cf56 := --p1)) {
		case DC31(cf56) =>
			var v0: array<string> := new string[14](i0 => "wqcmjr" + (seq(0xb4, i1  => ('f'))));
			v0 := v0;
			var v1 := DC9(-0x185, p0);
			...
			if (fm0(p3 - cf56, globalState)) {
				...
				globalState.f3 := (|(map v11 : int | v11 in v14 :: (v11 / v10.f36) := (|v10.f37|))[v15[-p3] := p2]| % |(set v16 : int | (0x2cf <= v16) && (v16 < 0x2d7) :: (v16 * 105))|) * (|v17| + cf56);
				...
				v19[565] := |v14|;
				v19[565] := if (true) then v10.f36 else if (v18.f33 in v5) then v5[v18.f33] else v18.f34;
			} else {
				cf56 := p2 / p1;
				var v20 := 's';
				...
				var v28: array<seq<int>> := new seq<int>[7] [v25 + [p3, |v27|], v25, [p1, p3, 0x7], v25 + v25[p1 := -0x133], v25, v25, v25];
				v28[414] := seq(0x2f2, i2  => (p2));
				v24, v28[414] := v24, if (p0) then v25 + v25 else v25;
				var v29: map<int, int> := map[cf56 := 0x2b2];
				var v31 := "adhmxyo";
				var v32: array<map<int, int>> := new map<int, int>[27] [v29, v29, v29, v29, v29, v29, v29, v29, map v30 : int | (-0x19f <= v30) && (v30 < 0x228) :: (v30 / cf56) := (p3), v29, v29, v29, v29, v29, map[p3 := cf56], v29, v29, map[p3 := cf56], v29, v29, v29, v29, v29, v29, v29, map[p1 := |v31|], v29];
				var v33: map<int, D16> := map[p3 := DC39(v32)];
				var v34: multiset<map<int, D16>> := multiset{v33};
				v34 := v34;
				var v35: multiset<char> := multiset{v20};
				var v36: array<int> := new int[10] [-cf56, cf56, cf56, cf56, |v35| / cf56, p3, |"eiavcl"|, cf56, p2, p3];
				v36 := v36;
		...
		case DC32(cf57, cf58, cf59, cf60) =>
			...
			if (p0 <== cf60) {
				...
				v41, v52[547], globalState.f26, cf60 := fm8(globalState), DC20(cf58, !cf60, p0, p0, v53).cf34, false, !p0;
				v42[239] := p0;
				v42[239] := p0;
				var v54: multiset<int> := multiset{|cf59|, p2 - p1, v52[547] / v48.f36, -0x1ec};
				v54, v52[547] := v54 + v54, |v48.f37|;
				globalState.f26 := v42[239];
			} else {
				var v55: map<int, char> := map[p3 := v41[0x34b]];
				var v56: map<int, map<int, char>> := map[p2 := v55];
				var v57: seq<map<int, char>> := [if (cf58 in v56) then v56[cf58] else map[|(seq(678, i4  => ('n')))| := 't']];
				var v58 := DC35(v57);
				v58 := if (p0) then v58 else DC35(v57);
				globalState.f18 := |{cf60}| % -0x336;
		...
		case DC30(cf55) =>
			...
			if (!!(v63 < ([p3, p3, -p3] + v63))) {
				...
				var v65 := "qmttqthg";
				var v66: array<string> := new seq<char>[27] [seq(-0xd4, i5  => ('l')), v65, v65, v65, v65, v65, v65, v65, "cfdjji", v65, v65, v65, "eet", v65, v65, "tqv", v65, "fwkfera", v65, v65, v65, "y", v65, v65, v65, "ldwxsm", "fytgb"];
				var v67: multiset<bool> := multiset{cf55.f35, p0, p0, p0};
				var v68 := new C6(cf55.fm3(multiset{p0}, globalState), p2, multiset(v64), (fm16(511, globalState))[p1 := p2], p1 - p2, v66, v67[true := |v67|], |v65|);
				var v69: C4 := new C4(|(v63 + (seq(-0x15, i6  => (-|v65|))))|, v66);
				v69 := v69;
				var v70 := DC0(v65);
				...
				v84[562] := p2 >= |(map v85 : int | (0x1be <= v85) && (v85 < 851) :: (v85 - 0x213) := (p0))|;
				var v86: map<bool, int> := map[cf55.f35 := -0x163];
				var v87 := "ostrgckj";
				var v88 := DC0(v87);
				v84[562] := !cf55.fm11(true, |v86| - v82.f27, v88, v77.f32, globalState);
				r0 := p0;
				...
				v89[765] := (if (p3 in v91) then v91[p3] else v90) * v90;
			...
			var v111: array<int> := new int[21] [p1 / p1, p1, p3, p1, p2, fm1(globalState) * |v105|, p3, p1 / |v106|, p2, |v107|, p1, 0x133, p1, p2, v108.cf40, p1, |v109[v105 := if (p0 in v93) then v93[p0] else p1]|, -fm1(globalState), -(p2 + p1), p2, p2 - |v110|];
			v111[506] := |v97| % p2;
			var v112: array<C3> := new C3[18];
			var v113: seq<array<C3>> := [v112];
			var v114: map<bool, string> := map[p0 := v96];
			var v115 := DC53(v113);
			v92[466], v104, globalState.f3, v111[506], v113 := v95, (v104 * v104) - v104, |(if (p0 <== cf55.f35) then v63 else v63 + v63)|, |(map[p0 := v96] + (v114 + v114))|, v115.cf94;
			var v116: C6 := new C6(!cf55.f35, |v96|, v93, fm16(p1, globalState), v111[506], v101, v93, p3);
			var v117: map<C6, int> := map[v116 := v111[506]];
			var v118: map<array<int>, map<C6, int>> := map[v111 := v117];
			v118 := v118[v111 := v117[v116 := v111[506]]];
			var v119 := DC9(-0x1c, p0);
			var v120: array<map<int, bool>> := new map<int, bool>[21];
			var v121 := DC52(v120);
			match (if (!(v119.cf16 >= v111[506])) then v121 else v121) {
				case DC52(cf93) =>
					var v122: array<map<bool, D4>> := new map<bool, D4>[1](i9 => map[p0 := DC8(v98, -v116.f34, p0)]);
					var v123 := DC8(v98, |v107|, v116.f33);
					v122[124] := map[true := v123];
					var v124: map<bool, D4> := map[cf55.f35 := v123];
					v122[124] := (v124[cf55.f35 := v123])[false <== p0 := v123];
					var v125 := new C0(p1, if (!cf55.f35 in v114) then v114[!cf55.f35] else seq(0x2ef, i10  => (v98)));
					var v126: seq<C2> := [v92[466], v95];
					var v127: map<int, int> := map[v111[506] := |"kqkukel"|];
		...
		case DC33(cf61) =>
			...
			if ((v135 > v135) <== p0) {
				...
				var v145 := 'e';
				v142, v144 := v136.f37[p2 := v145] + v136.f37, v144;
			} else {
				...
				v157, v158 := v157, v158;
				var v159: set<int> := {|v146|, p3, |{v154[p0 := |(seq(0xa3, i13  => ('q')))|]}|};
				var v160 := 'r';
			...
			var v180 := new C5(v173 + v173, multiset{p0, p0} + v162, v175, p2, v177[|v179|]);
	}
	
	var v181 := "ym";
	var v182 := 'l';
	var v183: multiset<string> := multiset{v181, (("w")[p2 := v182])[p2 := v182]};
		...
		decreases 100 - i14
	{
		...
		var v188 := DC25(DC23(multiset((v187[p1 := v186])[p3 := v186])));
		...
		v191[730] := fm39(globalState);
		v191[730] := DC25(v190).(cf45 := v190);
		r0 := (-p2 < p1) <== !p0;
		var v192: multiset<bool> := multiset{!false, p0};
		var v193 := DC6(p0);
		var v194: array<string> := new string[12](i15 => v181);
		var v195 := new C1(p3 <= p1, v192, fm43(p0, v193, p0, globalState), p2 % p3, v194);
	...
	for i19 := |fm14(p0, p0, p0, |"owyumxl"|, globalState)| to |v213| {
		...
		var v215: seq<int> := [p1, p3, i19, |(seq(-99, i21  => (v182)))|, p3];
		var v216 := DC6(false);
		var v217 := DC32(p3, p3, v215, v216.cf11);
		v214[966] := v217;
		v214[966] := v217;
		globalState.f26 := p0;
		v181 := v181 + (seq(809, i22  => (v182)));
...
class C1 extends T1 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
		...
		var v1 := "ltinafpk";
		var v2 := 'j';
		var v3: set<seq<char>> := {v1, [v2], v1, (seq(595, i0  => (v2)))[-f27 := v2], v1};
		var v4: map<bool, bool> := map[f35 := f35];
		var v5: seq<bool> := [f35];
		var v6: seq<bool> := [f35, f35, if (f35 in v4) then v4[f35] else f35, f35, v5[f27]];
		v1, globalState.f26, f35, r0, globalState.f26 := v1, !(f27 <= f27), f35, |v1| / f27, fm4(v3, f35, v5, globalState) > f27;
		var v7: array<seq<int>> := new seq<int>[11];
		var v8: set<array<bool>> := {v0, v0};
		v0[498] := {v0} !! v8;
		var v9: array<int> := new int[5];
		v9[86] := f27;
		v7, v0[498], v2, v9[86], r2 := v7, if (f35) then f35 else if (f35) then f35 else f35, v2, -114, f27;
		var v10: set<int> := {f27};
		var v11: map<int, set<int>> := map[v9[86] := v10];
		var v12: map<bool, int> := map[v0[498] := 0x91];
		v11 := v11[f27 + |v12| := {v9[86], v9[86], f27}];
		var v13: map<multiset<bool>, string> := map[f29 := v1];
		var v14 := DC6(v0[498]);
		v9[86], v2, v13, f35, v0[498] := f27, fm12(f27 / v9[86], v0[498], globalState), v13, v1 == ((seq(-0x2a, i1  => (v1[f27]))) + v1), v14.cf11;
		var v15 := new C0(v9[86], v1);
		r0 := -f30[v9[86]] * |v1|;
		r1 := v9[86];
		r2 := -(v9[86] / v15.f36);
	}
	method m5(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<int, bool>) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v5 := "ddutqmb";
				var v6 := 'm';
				var v7 := new C0(-849, v5[f27 := v6]);
				globalState.f3 := f27 - fm1(globalState);
				v5 := "o";
				var v8 := new C0(0x2df / -f27, v7.f37);
				v0 := fm13(f27, if (p0) then -v8.f36 else v7.f36, p0, -0xf9, globalState);
			}
			
			var v9 := new C0(f27, "fyxj");
			var v10: map<bool, int> := map[p0 := f27];
			globalState.f21 := f27 % (0x12d + (if (p0 in v10) then v10[p0] else f27));
			var v11 := "yxypbryxn";
			var v12: array<int> := new int[6] [v9.f36 - f27, |((seq(373, i1  => (v9.f36))) + f30)|, |v0|, -0x285, f27, -(f27 / v9.f36)];
			v12[90] := f27;
			var v13: seq<seq<char>> := [v11];
			v11, v12[90], globalState.f18, f35, globalState.f0 := v9.f37 + (v9.f37 + fm14(f35, p0, v0[v9.f36], f27, globalState)), fm4((set v14 : seq<char> | v14 in v13 :: (v14)) * (set v15 : seq<char> | v15 in v13 :: (v15)), false, v0, globalState), f27, true ==> (f27 !in fm15(|(set v16 : int | (0x3e1 <= v16) && (v16 < 216) :: (v16 - v9.f36))|, v9.f36, globalState)), |fm16(f27, globalState)|;
		}
		var v17 := "elhuc";
		var v18 := DC0(v17);
		var v19: map<bool, bool> := map[fm0(|f30|, globalState) := fm11(p1, f27, v18, f27, globalState)];
		globalState.f18 := -(|v1| % (|v19| % |map[f27 := p0]|));
		for i2 := 0x24 to f27 {
			if (p1) {
				var v20: array<string> := new string[4] [v17 + v17, seq(0x192, i3  => ('b')), seq(743, i4  => ('n')), "teeic"];
				v20 := f28;
				...
				var v24 := 't';
				var v25: array<int> := new int[25] [if (f35) then i2 else |fm14(p1, p1, p0, -f27, globalState)|, -f27, f27, f30[f27], i2, |v0|, |{i2, i2, |(seq(0x15f, i5  => ('q')))|}|, i2, i2, f27, -0x2ee, f27, |f29[false := i2]|, |fm17(p1, f35, p0, globalState)|, |map[-f27 := p0]|, |(v23 + v23)|, if (f35) then 0xb4 else i2, i2, -|(v17 + "lylquqbbn")[|(seq(0x28b, i6  => (|(seq(-837, i7  => ('f')))|)))| := v24]|, f27 - |f30|, -f27, |f29|, i2, 0x29d, f27];
				var v26: map<seq<bool>, bool> := map[v0 + v0 := f35];
				globalState.f0, v21[29], v25 := |v26|, p1, v25;
				v24 := v24;
				...
				v30, globalState.f26, globalState.f26, globalState.f18, v32 := 'e', v17 <= v17, if (v0[i2]) then !(-DC2(v30, 0xa8).cf3 == f27) else p0, if (v17 < v17) then i2 else f27, v32;
				globalState.f26 := p1 || p0;
				globalState.f21 := f27 % |(map v33 : int | (750 <= v33) && (v33 < 86) :: (v33 - i2) := (map[f35 := i2]))|;
			...
			v36[806] := v37 >= fm18(globalState);
			var v38: map<bool, int> := map[v36[806] := f27];
		...
		if (f30[2] <= (f27 % 0x25c)) {
			...
			if (f27 == f27) {
				...
				var v55 := 'o';
				var v56: set<seq<char>> := {v17, v17[|v54| := v55]};
				var v57: array<int> := new int[8] [f27, |f30|, 818, --f27 % f27, -f27, -f27, fm4(v56, p0, v0, globalState), -(f27 * f27)];
				v57[767] := -f27;
				v57[767] := f27 % f27;
				globalState.f26 := !f35;
				globalState.f24, v57[767], v17 := |[f27 > f27, p1]|, f30[v57[767]] * v57[767], "vvpnx";
				globalState.f3 := v57[767];
				var v58: map<int, map<bool, bool>> := map[f27 := v19];
				globalState.f26, v19 := !((|v17| + v57[767]) >= fm1(globalState)), (if (f27 in v58) then v58[f27] else v19) + v19;
			} else {
				var v59: set<bool> := {p1};
				...
				v61[196] := set v63 : int | v63 in v62 :: (v63 - (0x30e * 0x236));
			...
			var v66 := 'y';
			var v67: C0 := new C0(f27, v17[f27 := v66]);
			var v68 := DC11(v67);
			...
			v69, v17, globalState.f24 := v69, v67.f37[-v67.f36 := 'b'] + v67.f37, v67.f36;
			var v70: map<string, int> := map[v67.f37 := -f27];
			v70 := v70[seq(0x3a7, i8  => (v66)) := v67.f36];
			var v71: map<bool, int> := map[v53[937] := v67.f36];
			v71 := v71[v53[937] := -461 * |v19|];
		}
		...
		if (v0[f27]) {
			...
			if (fm14(f35, f35, p1, f27, globalState) == (v17 + "qk")) {
				...
				v73[266] := if (341 in v76) then v76[341] else f35;
				var v77: set<multiset<bool>> := {multiset(v0)};
				v73[266], globalState.f26, globalState.f24 := p0, !(v77 >= v77), f27 * v72.f36;
			} else {
				var v78 := DC15(v19);
				var v79: map<map<bool, bool>, bool> := map[v78.cf28 := p0];
				v0 := [if (map[f35 := p0] in v79) then v79[map[f35 := p0]] else p0] + v0[f27 := p1];
				var v80 := 'u';
				var v81: multiset<string> := multiset{if (p0) then seq(-284, i9  => ('b')) else v17[f27 := v80]};
				globalState.f3 := if ((v17 + v17) in v81) then v81[v17 + v17] else -(if (!f35) then f27 else |(seq(0x2be, i10  => (|v0|)))|);
				globalState.f18 := f27;
				f35 := !f35;
			...
			v83[298] := map v84 : char | v84 in fm19(globalState) :: (v84) := (f27);
			var v85 := 't';
			...
			var v91: seq<int> := [|(seq(208, i11  => ('m')))|];
			v90, globalState.f21, v91, globalState.f0, globalState.f0 := v90, f27, f30, f27 / |v17|, f27;
		...
		r1 := new bool[21] [f35, p1, p1 && p0, v0 <= v0, p0, p0, p0, p1, f27 >= f27, p0, p0, p1, |f30| >= f27, v0[f27], p1, fm11(p1, |v93|, v18, |v95|, globalState), fm11(p1, f27, v18, f27, globalState), fm11(p0, |v17|, v18, f27, globalState), p1, fm11(p1, f27, v18, |v17|, globalState), f35];
	...
	method m6(p0: int, globalState: GlobalState) returns (r0: int) {
		...
		var v7: map<seq<int>, int> := map[fm16(if (f35 in v4) then v4[f35] else p0, globalState) + f30 := f27 / (if (v5 in v6) then v6[v5] else f27)];
		v7 := v7[f30 + f30 := f27];
		...
		if (!(if (f35) then f35 else f35)) {
			...
			f35, v15 := f35, ((v15 + [v14]) + v15)[f27 := v14];
			globalState.f26 := f35;
			var v16: seq<string> := [fm14(f35, f35, f35, p0, globalState), v5];
			var v17 := DC12(f35, fm20(f35, globalState), v16[p0]);
			match (v17) {
				case DC12(cf20, cf21, cf22) =>
					...
					v0[350] := |v19|;
					v0[350] := p0 - (p0 - f27);
					var v20: multiset<int> := multiset{f27, p0, v0[350], f27, f27};
					var v21 := DC16(f27, f27);
					var v22: map<int, D8> := map[f30[|fm13(p0, 0x264, !cf20, |cf22|, globalState)|] := v21];
					var v23: map<int, int> := map[|map[v8 := f27]| := f27];
					var v24, v25 := m0(v20 !! multiset{v0[350]}, |v22|, f27, if (f27 in v23) then v23[f27] else |v5|, globalState);
					v1[462] := cf20;
					v1[462] := f35;
				case DC11(cf19) =>
					globalState.f26 := f35;
			...
			var v37 := DC12(f35, seq(216, i2  => ([f35])), v35.f37);
...
class C2 extends T2 {
	...
	function fm5(globalState: GlobalState): bool {
		!match DC20(f32, !!true, true, false, map[-0xf := |DC10(multiset{f32, f32}).cf18|]) {
			...
			case DC17(cf31) => (seq(-888, i0  => ('p'))) <= "im"
		}
	}
	function fm6(p0: set<int>, globalState: GlobalState): seq<seq<bool>> {
		((seq(-0x36b, i0  => ([true]))) + [[true, !true]]) + [[!false, true]]
	}
	...
	method m2(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
		...
		if (p1) {
			...
			if (v4 >= v4) {
				...
				v1[766] := f31 !! (if (|v6| in v5) then v5[|v6|] else f31);
				var v7 := "ojlonqco";
				var v8 := DC8(v0, |v7|, p1);
				var v9: set<D4> := {v8};
				var v10: map<bool, int> := map[true := -|fm23(|v6|, !true, globalState)|];
				var v11: seq<int> := [|v7| - |v9|, -p3, p3, |v7| % |v10|];
				var v12: multiset<map<bool, int>> := multiset{v10};
				v1[766], v11, globalState.f15, v1, globalState.f26 := v7 != v7, [p3, |(if (p1) then [p2] else v11)|], -(if (map[!p0 := -p3] in v12) then v12[map[!p0 := -p3]] else f32 / p3), v1, fm21(globalState);
				var v13 := DC0(v7);
				var v14: array<D3> := new D3[14];
				var v15 := DC6(v1[766]);
				v14[8] := v15;
				globalState.f26, v13, globalState.f26, v14[8], globalState.f26 := p1, v13, p1, v15, p0;
				var v16: map<string, multiset<bool>> := map[if (false) then v7 else v7 := f31 - f31];
				v16 := v16;
				globalState.f26, v7, globalState.f26 := v1[766], fm22(v10 + fm24(p3, globalState), false, if (v1[766] in v10) then v10[v1[766]] else |f31|, globalState), !p1;
			} else {
				var v17 := "vkvarnrk";
				var v18: C0 := new C0(-p3, v17);
				var v19 := DC11(v18);
				var v20: map<D6, string> := map[v19 := (v17 + v17)[|[v0]| := v0]];
				v20 := v20[v19 := "gvq" + v17];
				var v21: map<string, bool> := map[seq(886, i0  => (v0)) := p0];
			...
			var v31 := DC16(f32, p3);
			v30[261] := v31;
			v29, v30[261], r1 := v29, v31, -(-fm1(globalState) + -p3);
		}
		...
		var v42 := new C1(v35 >= multiset{v36}, multiset([p0]) - multiset(v38), v40.cf39, -0xa0 / f32, if (p0) then v41 else v41);
		v1[348] := p0 !in {p0};
		v1[348] := match v40 {
		...
		v43[227], v1[348], globalState.f26 := v38 + v38, p1 <==> !false, !(v45[-f32] > v44);
		r0 := v1;
		r1 := p2;
	}
	method m3(p0: bool, p1: char, p2: string, p3: bool, globalState: GlobalState) {
		var v0: array<int> := new int[24];
		v0[100] := if (p0) then |p2| else |p2|;
		...
		if (false) {
			...
			var v6: seq<string> := [seq(0xfa, i1  => (p1))];
			var v7: array<string> := new string[9] [p2, p2, if (p1 in v4) then v4[p1] else "qnpxuk", p2, fm22(v5, p3, f32, globalState), v6[v0[100]], p2, p2, p2];
			var v8 := new C1(p0, f31, v3 + (seq(192, i0  => (f32))), 0x31e, v7);
			var v9: array<bool> := new bool[15](i2 => v8.f35);
			var v10: map<array<bool>, bool> := map[v9 := p3];
			var v11: C0 := new C0(v0[100], p2);
			var v12: map<bool, C0> := map[v8.f35 := v11];
			var v13 := DC0(seq(0xba, i4  => (p1)));
			var v14: array<C0> := new C0[22] [v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, if (v8.fm11(p3, |(seq(-262, i3  => (v11.f36)))|, v13, v0[100], globalState) in v12) then v12[v8.fm11(p3, |(seq(-262, i3  => (v11.f36)))|, v13, v0[100], globalState)] else v11];
			v14[351] := v11;
			var v15 := "vhmyrad";
			v10, v14[351], v15 := v10, v11, p2;
			globalState.f26 := v11.f36 != v0[100];
			globalState.f26 := (-20 / |v3|) !in (seq(0x8c, i5  => (v11.f36)));
			v15 := v15;
		} else {
			v0 := v0;
			var v16: seq<int> := [f32, -|fm25(p0, globalState)|, f32];
			var v17: array<string> := new string[2] [p2, p2];
			var v18 := new C1(p3, f31, v16, v0[100], v17);
			var v19 := DC8('x', v0[100], p0);
			var v20 := DC0(p2);
			var v21: map<D4, D0> := map[v19 := v20];
			if (v19 !in v21) {
				var v22 := new C1(v0[100] == -977, multiset{p3, !p0}, (v16 + v16)[v0[100] := |p2|], f32, v17);
				var v23: set<bool> := {p3};
				var v24: multiset<int> := multiset{|v23|, f32, 0x1a3};
				globalState.f3, v0[100], globalState.f18, globalState.f24, v0[100] := v0[100], (if (p3) then v0[100] else |(set v27 : int | v27 in (set v25 : int | v25 in v24 :: (v25 + -|[|(set v26 : int | (-421 <= v26) && (v26 < 0xef) :: (v26 + |map[false := "pdfc"]|))|, 0x21f]|)) :: (v27 % 0x37b))|) + v0[100], 0x87, v22.fm4({p2}, p0, [p0, v22.f35], globalState), v0[100];
				var v28: array<set<array<C1>>> := new set<array<C1>>[21];
				var v29: seq<C1> := [v18];
				var v30: array<C1> := new C1[24] [v22, v18, v18, v18, v22, v22, v22, v22, v18, v22, v22, v22, v22, v18, v22, v18, v18, v29[f32], v18, v22, v22, v18, v22, v18];
				var v31: set<array<C1>> := {v30};
				v28[510] := v31 - v31;
				v28[510] := if (v18.f35) then {v30} else {v30};
				var v32: seq<bool> := [!p3, v0[100] <= -0x285, p0, v22.f35, fm5(globalState)];
				v32 := ([v18.f35, v18.f35] + ([p3])[v0[100] := p0]) + v32;
				...
				var v37: T1 := new C1(false, f31, v16, v0[100], v17);
				var v38: map<T1, bool> := map[v37 := p0];
				v38 := v38[v37 := v37.f30[f32] > -0xe7];
				var v39: map<int, bool> := map[f32 := p3];
				var v40 := new C1(p0, f31, [v0[100], DC4(v0[100], -|v39|, f32, p1, p2).cf6], |multiset{p0}| * v37.f27, v37.f28);
				var v41: seq<bool> := [p0];
				var v42: map<bool, int> := map[v18.f35 := v0[100]];
				var v43 := new C0(|[|v41|, |fm22(v42, v18.f35, fm1(globalState), globalState)|]|, p2);
				globalState.f26 := !(v18.f35 || v18.f35) <== fm5(globalState);
				v18.f35 := p3;
			}
			
			var v44: map<char, int> := map[fm26(p1, f32, v0[100], globalState) := f32];
			globalState.f18 := (if (p1 in v44) then v44[p1] else f32) % f32;
		...
		for i7 := -f32 to 220 {
			if (i7 < i7) {
				...
				var v48 := 'k';
				var v49: seq<bool> := [p3];
				globalState.f26, globalState.f15, globalState.f18, v48 := !fm0(if (p3) then |v49| else |(seq(90, i8  => ('l')))|, globalState), v0[100] - (v0[100] % f32), v46.f36 - i7, p1;
				var v50: map<int, bool> := map[v46.f36 := p0];
				var v51: array<string> := new string[23] [v46.f37, v46.f37, (p2[v46.f36 := p1])[-|v50| := p1], v46.f37, fm22(fm24(f32, globalState), p0, |"ngpnnpqao"|, globalState), p2, p2, p2 + p2, "vkphmjmvi" + p2, p2, "tmodjtc", "baincv" + v46.f37, "hehm" + "fgcyfxm", p2 + p2, v46.f37, p2, v46.f37, v46.f37, "bwkywvb", v46.f37, p2, p2, p2];
				v51[124] := v46.f37;
				v51[124] := v46.f37;
				var v53: multiset<set<int>> := multiset{set v52 : int | (0x112 <= v52) && (v52 < 326) :: (v52 * |v1|), {if (p3 in f31) then f31[p3] else v0[100], v46.f36, v46.f36, v46.f36, v0[100]}};
				var v54 := DC23(v53);
				v50 := v50[v46.f36 + |v54.cf42| := !p0];
				var v55: array<bool> := new bool[14];
				v55[63] := !true;
				var v56 := DC4(-v0[100], v46.f36, 0x3da, 'y', v46.f37);
				var v57: map<D2, int> := map[v56 := |map[p3 := p3]|];
				var v58: map<map<D2, int>, map<bool, int>> := map[v57 := map[p0 := i7]];
				var v59 := DC6(true);
				var v60: map<int, D3> := map[v0[100] := v59];
				var v61: seq<C0> := [v46];
				var v62: map<map<int, D3>, seq<C0>> := map[v60 := [v46, v61[v0[100]]]];
				var v63: seq<map<map<int, D3>, seq<C0>>> := [v62];
				var v64: seq<int> := [v0[100]];
				var v65: map<int, map<bool, int>> := map[|v63[f32]| := map[p0 := |v64|]];
				var v66: map<bool, int> := map[p0 := f32];
				var v67: array<map<map<D2, int>, map<bool, int>>> := new map<map<D2, int>, map<bool, int>>[12] [v58, v58, v58 + v58, v58, v58, v58, v58 + v58, (map[map[v56 := v0[100]] := (map[p3 := v0[100]])[p0 := i7]])[v57 := if (v0[100] in v65) then v65[v0[100]] else v66], v58, v58, v58, v58 + v58];
				v67[553] := v58;
				var v68 := DC8(p1, 802, false);
				globalState.f24, v51[124], v55[63], globalState.f21, v67[553] := DC24(if (p0 in v66) then v66[p0] else v46.f36, v68).cf43, v46.f37, true, v46.f36, v58;
			} else {
				var v70: seq<int> := [f32];
				globalState.f24 := |(map v69 : int | v69 in v70 :: (v69 / i7) := (p1))|;
				...
				v73[512] := p3;
				var v74: map<bool, int> := map[p3 := v0[100]];
				var v75: seq<bool> := [p0];
				var v76: seq<seq<bool>> := [v75, v75];
				v73[512] := multiset([|v74|]) > fm27(|v76|, globalState);
				var v77: map<int, bool> := map[v0[100] := p3];
				var v78 := DC1(v77);
				var v79 := "tqpsjmtb";
				var v80: seq<array<bool>> := [v73, v73];
				var v81: multiset<int> := multiset{i7, v0[100], i7, v0[100], f32};
				v73, v78, v79 := v80[|v81|], if (p0) then v78.(cf1 := map[v0[100] := v73[512]]) else fm28('k', --i7, v73[512], v0[100], globalState).(cf1 := v77), v79;
			}
			...
			if (p0) {
				var v82: seq<int> := [i7];
				globalState.f18 := f32 + v82[f32];
				globalState.f3 := i7;
				var v83: map<bool, int> := map[p0 := i7];
				var v84: set<bool> := {p3};
				globalState.f0 := f32 % (-|fm22(v83, p0, |v84|, globalState)| / i7);
				globalState.f26 := true <== p3;
				var v85 := new C0(v0[100] / i7, fm22(v83, true, f32, globalState) + fm22(v83, p0, 0x132, globalState));
			} else {
				globalState.f26 := p0;
		...
		if (!p3 <== p0) {
			globalState.f15 := v0[100];
			var v90: seq<int> := [|p2|, f32];
			var v91: array<string> := new string[2];
			var v92 := new C1(p3, f31, v90, v0[100], v91);
	...
	method m7(p0: map<bool, bool>, p1: int, globalState: GlobalState) {
		...
		if (p1 != p1) {
			...
			var v2 := true;
			var v3: set<bool> := {v2};
			globalState.f21, globalState.f26, v0[857] := |(if (v2) then v3 else v3)| % f32, !v2, v1;
			globalState.f24 := f32;
			...
			v5[976] := fm21(globalState);
			var v6 := "wxwtlr";
			v5[976] := v6 <= v6;
			v4[539] := -0x3b5;
			v4[539] := fm1(globalState);
		} else {
			var v7 := false;
			...
			if (if (!v16[f32]) then v7 else v7) {
				...
				var v21 := 'g';
				var v22 := new C0(fm1(globalState), v11.f37[0x25d := v21]);
				...
				var v27: seq<map<int, int>> := [map[v11.f36 := 0x3f], (v24[f32])[371 := v9], fm30(globalState), v26, v26];
				var v28: map<int, bool> := map[|v27[v11.f36]| := fm5(globalState) <== !v8];
				v28 := v28;
			}
	...
	method m8(p0: seq<map<int, int>>, p1: int, globalState: GlobalState) {
		...
		v0[700] := if ((if (v5 in v6) then v6[v5] else v2) in v4) then v4[if (v5 in v6) then v6[v5] else v2] else v1;
		var v7: multiset<bool> := multiset{v2};
		globalState.f18, v0[509], v0[700], v1, v7 := f32 - 0x3d2, seq(228, i1  => ('g')), seq(0x223, i2  => ('c')), "hucvcbfcp", v7;
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v18: C0 := new C0(f32, seq(0x209, i5  => ('m')));
			v18 := new C0(|v8| / p1, "lwjbo");
			...
			match (v22) {
				case DC4(cf5, cf6, cf7, cf8, cf9) =>
					...
					v28[689] := if (v2) then v10 else v10;
					globalState.f26, v26, v27, v28[689], globalState.f24 := !v2, v26, v27 - (v27[v19 := v18.f36] + v27), multiset(v14 + v14) - (v10 * v10), -((163 * -0x1d5) - 0x373);
					var v29 := new C0(|"jlhbrjm"|, (if (v2) then v1 else "fjfolha")[v18.f36 := v0[509][v18.f36]]);
				case DC3(cf4) =>
					globalState.f18 := p1;
			...
			var v33: multiset<string> := multiset{v0[509], "mlmcu", v18.f37};
			globalState.f8 := v33;
			...
			match (v35) {
				case DC24(cf43, cf44) =>
					...
					v19[844] := v2;
					var v37 := DC9(p1, v2);
					v19[844] := if ((true <== v37.cf17) in v13) then v13[true <== v37.cf17] else !v2;
					...
					v39[317] := v41[683];
					v8, v38[733], globalState.f26, globalState.f15, v39[317] := v8, cf43 % cf43, (if (v19[844]) then v19[844] else v19[844]) <==> v2, f32, v40;
				case DC23(cf42) =>
					v1 := (seq(0x2c9, i8  => (v21))) + v18.f37;
					var v42 := new C1(v2, f31, (seq(0x9, i9  => (v18.f36))) + v14, f32, v0);
				...
				case DC25(cf45) =>
					globalState.f26 := (v7 + v7[v2 := v18.f36]) !! v7;
					globalState.f0 := -v18.f36;
					var v46: C1 := new C1(v2, f31, seq(-0x20, i10  => (v18.f36)), |v5|, v0);
					var v47: set<C1> := {v46};
					var v48: array<int> := new int[18] [f32, v18.f36, f32, v18.f36, |v20[v19 := p1]|, v18.f36, p1, p1, v18.f36, v18.f36 - -p1, 0xcc, p1, v18.f36, |v1|, -|v47|, -|v1[p1 := v21]|, v18.f36, v18.f36];
					v48[703] := -v18.f36;
					v48[703] := (v22.(cf8 := fm26(v21, 677, v18.f36, globalState))).cf7;
					var v49: seq<array<int>> := [if (if (v2 in v13) then v13[v2] else v2) then v48 else v48];
					var v50 := DC21(v14);
					v48 := v49[|(v14 + v50.cf39)|];
			}
...
class C4 extends T0 {
	...
	method m11(p0: C0, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		var v4 := 'k';
		globalState.f18 := |(if (if (p1 in v0) then v0[p1] else p1) then v3.cf22 else (p0.f37 + p0.f37)[f27 := v4])|;
		var i0 := 0;
		while (!(p1 <== (p1 && p1)))
			decreases 100 - i0
		{
			...
			var v8: C1 := new C1(p1, multiset(v1), v5 + v5, fm34(v6, v7, globalState) / |v6|, f28);
			var v9: array<seq<bool>> := new seq<bool>[8](i1 => [p1, v8.f35]);
			v9[593] := v2[|v6|];
			var v10: multiset<bool> := multiset{p1};
			v8, globalState.f26, v9[593] := (DC30(v8).(cf55 := v8)).cf55, true, ((v1[p0.f36 := v8.f35])[p0.f36 := p1])[p0.f36 % 688 := [[p1, v8.fm3(v10, globalState)], v1, v1] == v2];
			globalState.f3 := p0.f36;
			globalState.f26 := p1 && (v1[f27] <== v8.f35);
			if (p1) {
				...
				var v16: array<int> := new int[11] [|p0.f37|, p0.f36, |v9[593]|, |p0.f37|, f27, p0.f36, v13.f32, p0.f36, |(seq(557, i2  => (v4)))|, |(seq(693, i3  => (|(seq(0x6a, i4  => (p0.f37[f27])))|)))|, p0.f36];
				var v17: map<seq<bool>, array<int>> := map[v1 := v16];
				var v18: seq<array<int>> := [if (v9[593] in v17) then v17[v9[593]] else v16, v16, v16];
				var v19: map<int, int> := map[p0.f36 := v13.f32];
				var v20: map<bool, int> := map[v8.f35 := |v19|];
				var v21: multiset<array<int>> := multiset{v18[|v20|], v16};
				var v22: multiset<multiset<array<int>>> := multiset{multiset{v16, v16, v16}, v21, v21};
				var v23: map<string, int> := map[fm37(p0.f36, fm34(v6, DC4(|v12|, |v14|, 0x296, v4, v15[p0.f36]), globalState), globalState) := if (multiset{v16} in v22) then v22[multiset{v16}] else -f27];
				globalState.f24 := -(if (p0.f37 in v23) then v23[p0.f37] else p0.f36);
				var v24 := "tqatqn";
				v24 := (p0.f37 + ("jqpon")[v13.f32 := v4]) + "qq";
				r0 := 695;
				...
				var v29 := DC19(p1);
				var v30: array<bool> := new bool[17] [v8.f35, if (p1) then false else v8.f35, true, false, v8.f35, [v4] in v26[f27 := p0.f37], if (p1) then fm35(v4, fm1(globalState), globalState) else v8.f35, true, p0.f36 != p0.f36, multiset(v5) > v28, p0.f36 >= p0.f36, v10 == multiset{v8.f35, true}, !v8.f35, p1, v8.f35, v29.cf33, false];
				v30[885] := !p1;
				v25, v30[885] := "gpkm", !(p1 ==> v8.f35);
		...
		for i5 := f27 % f27 to |(v37 - v37)| {
			if (!(p0.f36 == 0x1af)) {
				...
				var v43 := new C0(if (p1) then -p0.f36 else |v42|, seq(46, i6  => ('a')));
				var v44: array<array<int>> := new array<int>[24];
				v44 := new array<int>[29];
				var v45: array<char> := new char[10];
				v45[416] := 'c';
				v45[416] := fm38(map[true := false], globalState);
			} else {
				...
				var v49 := DC21(v48);
				v47[315] := v49;
				globalState.f21, globalState.f26, v0, v46, v47[315] := (0x2b3 % p0.f36) - p0.f36, p1, v0, v46, v49;
				...
				var v56: array<int> := new int[28] [i5 / i5, -i5, i5 * p0.f36, i5, v48[i5], |v1|, p0.f36, p0.f36 / |(set v50 : int | (865 <= v50) && (v50 < 0x92) :: (v50 * p0.f36))|, -f27, p0.f36, f27, p0.f36, fm34(v51, v53, globalState) - -|v54|, p0.f36, if (p1 in v36) then v36[p1] else f27, if (p1 in v55) then v55[p1] else p0.f36, -p0.f36, i5, f27, p0.f36, p0.f36, |(seq(0x12c, i8  => (v4)))|, p0.f36 + p0.f36, i5, 594 % |(seq(0x374, i9  => ('w')))|, f27, i5, p0.f36];
				v56[55] := p0.f36 / |v48|;
				v56[55] := i5;
				globalState.f3 := i5;
			...
			v59[162] := if (p1) then v62 else v62;
			var v63: set<seq<bool>> := {v1};
			var v64: map<int, set<seq<bool>>> := map[f27 := v63];
			var v65 := DC34({v1});
			globalState.f0, globalState.f21, globalState.f26, v59[162] := p0.f36 - p0.f36, p0.f36, (if (p0.f36 in v64) then v64[p0.f36] else {v1}) >= v65.cf62, v62;
			v4 := v4;
		}
		r0 := f27;
	}
	method m12(p0: bool, p1: map<array<int>, bool>, p2: bool, p3: char, globalState: GlobalState) returns (r0: seq<bool>, r1: bool, r2: array<array<bool>>, r3: bool) {
		if (!p2) {
			...
			v1, v2, v3, globalState.f0 := v1, map[p0 := v6.cf20], v3, f27 / DC8(p3, |{p2}|, p2).cf14;
			v0 := v0 + ("m" + v0);
			v1 := v1;
			...
			v7[625] := !(false <== (if (p2) then p0 else fm35(fm38(v8, globalState), f27, globalState)));
			var v11 := "g";
			var v12 := DC4(|v11|, f27, f27, p3, v11);
			r3 := (f27 + f27) == fm34(set v9 : int | (234 <= v9) && (v9 < -0x2c6) :: (v9 % |(map v10 : int | (-0x327 <= v10) && (v10 < 0x33b) :: (v10 / f27) := (p3))|), v12, globalState);
			if (p2) {
				...
				v13, v14[165], v18, globalState.f3, v20 := DC25(v25), fm40(154, p0, p2 <== v7[625], fm41(f27, f27, p2, globalState), globalState), fm39(globalState), -619, v27[f27];
				v7[625] := p2;
				var v28: seq<string> := [v11, v11];
				v11, globalState.f15, globalState.f0, v7[625] := v28[f27], f27, -720, !(0x350 < f27);
				var v29 := new C0(|(v15 + v15)|, v11);
				var v30: map<int, int> := map[0x2f2 := |map[0x1de := true]|];
				var v31: map<int, bool> := map[v29.f36 := p2];
				var v32 := DC20(|v15|, if (v29.f36 in v31) then v31[v29.f36] else v7[625], p0, v7[625], v30);
				var v34: seq<int> := [v29.f36, fm1(globalState)];
				var v37: seq<map<int, int>> := [map[|(set v36 : int | v36 in v34 :: (v36 / 0x1d))| := v29.f36], v30];
				var v38: map<int, char> := map[|v15| := p3];
				var v39: seq<map<int, char>> := [v38];
				var v40 := DC35(v39);
				var v41: array<map<int, int>> := new map<int, int>[29] [v30 + map[|v29.f37| := v29.f36], v32.cf38, map[f27 := f27], v30 + (map v33 : int | v33 in map[|v34| := v29.f36] :: (v33 + v29.f36) := (0x13f)), v30, if (false) then v30 else v30, v30, v30 + (map v35 : int | (0x20 <= v35) && (v35 < 0x291) :: (v35 % v29.f36) := (v29.f36)), map[f27 := f27], v30, v30, v30, fm42(if (p2 in v19) then v19[p2] else f27, true, v29.f36, globalState), v30, v30, v30, v30 + v30, v30, v30, v37[|(multiset(v40.cf63))[v38 := v29.f36]|], v30, v30, v30 + v30[fm34(v22, v12, globalState) := v29.f36], v30, v30 + v32.cf38[v29.f36 := f27], v30, v30, map[|v15| := v29.f36], map[f27 := v29.f36]];
				var v42 := DC39(v41);
				var v43 := DC6(v7[625]);
				var v44 := DC18(true);
				...
				var v45 := DC19(p0);
				v45 := if (v7[625]) then v45 else v45;
			...
			r3 := v7[625];
			f28[748] := "naxcrpkh";
			var v51: multiset<bool> := multiset{v7[625]};
			var v52 := DC38(f27, true, 245);
			var v53 := DC6(v7[625]);
			var v55 := DC40(!(v51 > v51), -(fm34(set v54 : int | v54 in fm43(v52.cf71, v53, v7[625], globalState) :: (v54 + |map[|"dp"| := false]|), v12, globalState) % -f27), f27);
			var v56: array<seq<seq<bool>>> := new seq<seq<bool>>[23](i2 => [[false, p0]] + [[p0]]);
			v56[532] := (seq(0x12, i3  => ([p0]))) + (seq(0x22e, i4  => ([v7[625]])));
			var v57 := DC7(v7);
			f28[748], v55, v56[532], globalState.f15, v7 := v11, v55.(cf76 := f27 / 0x20f, cf74 := p2), fm44(globalState), (f27 / f27) + (0x9b + f27), v57.cf12;
		}
		...
		var i6 := 0;
		while (fm0(|(v60 + fm41(v61.f27, v61.f27, v62.cf53, globalState))[v61.f27 := p0]|, globalState))
			decreases 100 - i6
		{
			if (i6 >= 100) {
				break;
			...
			if (p2) {
				...
				var v67: set<seq<bool>> := {v60[|v66| := p2]};
				var v68: array<int> := new int[10] [v61.f27, v61.f27, f27, v61.f27, v61.f27, v61.f27, |v65| % f27, v61.f27 + |v67|, |fm47(globalState)|, v61.f27];
				v68[786] := v61.f27 / 595;
				...
				v68[786], globalState.f26, r1, globalState.f26, v69[439] := v61.f27, -f27 > |(v70[false := v61.f27])[p0 := |v72|]|, p0, fm0(if (p0) then |"nngcbxfxb"| else v61.f27, globalState), |map[p0 := -v61.f27]| > v61.f27;
				v68 := v68;
				globalState.f0 := v68[786] % 0x1dd;
			} else {
				var v73: map<int, bool> := map[-(fm1(globalState) % f27) := p0];
				v73 := fm48(p2, p2, |(multiset{v61.f27, -v61.f27})[v61.f27 := -0xd8]|, globalState) + v73;
				var v74: seq<seq<int>> := [seq(33, i7  => (|v60|)), seq(942, i8  => (v61.f27))];
				globalState.f15, globalState.f26 := if (p0) then fm1(globalState) else |multiset(v74[f27])|, p2;
				...
				v75, r1, v76, r1, globalState.f0 := seq(0x54, i9  => ("qwi" + "aqpplff")), (v77 + v77) !! v77[p0 := v61.f27], v76, !(v78 !! v78), |v79| - f27;
			...
			var v89: array<int> := new int[27] [v61.f27, |v85[360]| * v61.f27, v61.f27, |fm41(|map[p0 := p2]|, f27, p0, globalState)| / -f27, v61.f27, v61.f27, -0x21d, v61.f27, v61.f27, f27, v61.f27, f27, f27, v61.f27, v61.f27, f27, f27, fm1(globalState) * |v86|, |{v60[|{v60[0x9], p0}|], p2}|, v61.f27 + |v82|, f27, v61.f27, -v61.f27, f27 * v61.f27, -0x2e7, if (p2 in v87) then v87[p2] else if (v61.f27 in v88) then v88[v61.f27] else |v87|, v61.f27];
			v89[634] := f27;
			v89[634] := |v82|;
			var v90: set<bool> := {p2, p0, p0};
			globalState.f0 := v61.f27 / (if (v89[634] in v88) then v88[v89[634]] else |v90|);
		}
		var v91 := "cd";
...
class C5 extends T1, T0 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
		var v0 := true;
		var v1: seq<bool> := [!(f29[!v0 := f27] !! f29)];
		if (v1[fm1(globalState)]) {
			...
			match (v4.(cf36 := v0).(cf35 := if (v0) then v0 else v0, cf34 := f27, cf37 := !false)) {
				case DC18(cf32) =>
					...
					globalState.f18, globalState.f0, globalState.f26, v0, globalState.f18 := f27, f27 / (f27 + f27), f27 > f27, f30[f27] in v9, v6.f36;
				...
				case DC19(cf33) =>
					...
					var v23: map<bool, int> := map[v1[f27] := |map[v16 := f27]|];
					var v24: seq<char> := [v16];
					var v25: array<int> := new int[19] [if (map[v16 := -f27] in v19) then v19[map[v16 := -f27]] else f27, f27, f27, |[cf33, cf33]|, if (v0) then f27 else -f27, 19, |v21[f27]|, DC22(|v20|, f29).cf40, f27, f27, 0x3c7 / f27, f27, f27, f30[f27] + -0x39d, f27, if (cf33) then f27 else |v22|, |v23|, -|((seq(0x37b, i1  => (v16))) + v24)|, f27];
					v25[757] := f27 - f27;
					var v27: map<bool, map<int, bool>> := map[f29 < f29 := map v26 : int | (0x251 <= v26) && (v26 < -0x11f) :: (v26 / f27) := (v0)];
					r0, globalState.f24, v25[757], globalState.f26 := f27, |(v24[f27 := v16] + v24)|, |v27|, if (v0 in v20) then v20[v0] else true;
					var v28 := new C1(cf33, f29, f30, --f27, f28);
					var v29: seq<seq<char>> := [v24, v24];
					var v30: map<bool, seq<seq<char>>> := map[cf33 := v29[v25[757] := [v16, v16, 'u']]];
				...
				case DC20(cf34, cf35, cf36, cf37, cf38) =>
					...
					v1, globalState.f26, v36, cf37, v37[333] := (v1 + v1)[f27 := cf37], |(v1 + v1)| >= cf34, v36[v34 := v35] + v36, v38 >= v38, (f29 - fm32(globalState)) + multiset{false};
			...
			globalState.f15, v75[986], globalState.f3 := f27 + -v73.f36, v73, |v76.cf9|;
			var v77 := 'e';
			v77 := v77;
			globalState.f21 := f27;
		}
		...
		var v84: array<bool> := new bool[13] [v1[|"yspuqcihq"|], v0, v0, v78 < v78, v0, v0, v0, false, f27 < f27, f27 < f27, fm33(v79, |v82|, |v1|, |v83|, globalState) == v1, v0, true];
		...
		for i5 := f27 to 0x12 {
			...
			if (if (fm3(f29, globalState)) then !((multiset{v0, v0})[false := i5] > multiset{v0}) else v0) {
				v0 := !true;
				v0, v78 := v0, v78;
				var v89: array<int> := new int[4];
				v89[178] := i5;
				v84[164] := v0;
				v89[178], v0, v84, r2, v84[164] := f27 % 0x13c, i5 == f27, v84, i5 % |[f27, f27]|, multiset{f27, i5} > multiset{f27, f27, i5};
				var v90 := DC10(v83);
				var v91: map<D5, bool> := map[v90 := v84[164]];
				var v92: seq<map<D5, bool>> := [map[v90 := v84[164]], map[v90 := v84[164]]];
				var v93: set<bool> := {v84[164]};
				v91 := v92[|v93| + i5];
				globalState.f3 := f27;
			} else {
				globalState.f0 := i5;
				...
				v78 := v96.f37;
				var v99: map<int, int> := map[v94[562] := v94[562]];
		...
		for i7 := -f27 to f27 {
			...
			v105[289] := v79 + v79;
			v105[289] := v79;
			var v106: array<seq<seq<int>>> := new seq<seq<int>>[27](i8 => if (v0) then [f30] else seq(-529, i9  => (f30)));
		...
		r1 := f30[v110.cf34] / (f27 / |(multiset(v113))[v112 := f27]|);
	...
	method m9(globalState: GlobalState) returns (r0: array<bool>, r1: bool, r2: bool) {
		...
		if ((f27 + |fm2(v0, v0, v0, globalState)|) >= f27) {
			...
			if (v9 < v9) {
				...
				var v13: map<bool, int> := map[if (false) then !v0 else v0 := f27 / f27];
				v13 := v13;
				v8[788] := |v11|;
				var v14: array<bool> := new bool[1] [v0];
				globalState.f26, r0, v8[788], globalState.f26 := v0, v14, v3, (520 >= |v1|) || (v11 <= v10[910]);
			...
			if (v19[f27]) {
				var v20 := 'x';
				var v21: array<char> := new char[13] [v20, v20, v20, v20, v1[f27], v20, v20, v20, v20, fm38(v7, globalState), v20, v20, DC2(v20, v3).cf2];
				...
				globalState.f0, v24, v0, v27, globalState.f21 := fm4(v28, v2, [v0], globalState) * (v3 + v3), v24, v2, seq(906, i1  => (v26)), |v1|;
				var v29: multiset<string> := multiset{"wtdcmrxwf"};
				globalState.f3 := |v29[v1 := f27]|;
				...
				var v40: seq<multiset<bool>> := [f29[v2 := f27]];
				v38 := v38[if (v3 in v39) then v39[v3] else v37 := v40[f27] !! f29];
			}
			...
			globalState.f0 := (|"wibmqbfun"| * f27) % f27;
			globalState.f21 := f27;
			if (v0) {
				...
				v41[603] := v0;
				var v49: array<int> := new int[3](i3 => i3 % f27);
				v49[629] := if (fm0(-f27, globalState)) then f27 else -75;
				var v50 := DC44(f27);
				var v51 := DC45(v50);
				var v52: map<bool, bool> := map[v0 := v0];
				var v53: set<map<bool, bool>> := {v52, v52, v52};
				var v54: seq<set<map<bool, bool>>> := [v53];
				var v55 := DC46(v54[f27]);
				v41[603], v49[629], v51, globalState.f3, globalState.f15 := -f27 !in f30, f27, v51, f27 / |(v55.cf85 + {v52, map[v0 := false], v52})|, f27;
				var v56 := new C2(multiset{v41[603], v0, !v41[603]}, 0x10c);
				var v57: array<bool> := new bool[9];
				var v58: map<int, array<bool>> := map[v49[629] := v57];
				v58 := v58;
				...
				v41[603], globalState.f26, v49, globalState.f26 := v65 >= (v65 - {v49}), !v0, v49, v41[603];
			}
			...
			var v71: seq<C0> := [v70];
			var v72 := v43.m11(v71[v70.f36], v0, globalState);
		}
		
		var v73 := 'g';
		var v74: seq<char> := [v73];
		var v75: multiset<int> := multiset{f27, f27};
		var v76: set<seq<char>> := {v74, v74[|v75| := v73], v74, v74};
		var v77: map<char, bool> := map[v73 := v0];
		var v78: map<int, bool> := map[f27 := false];
		var v79: seq<bool> := [if (|v74[f27 := v73]| in v78) then v78[|v74[f27 := v73]|] else v0];
			...
			decreases 100 - i4
		{
			...
			var v82: seq<C1> := [v81];
			v81 := if (v0) then v82[-|f30|] else v81;
			v74 := v74;
			globalState.f21 := f27;
		...
		if (v0) {
			...
			v86[304] := v79[v88.cf14];
			var v89 := DC12(fm0(f27, globalState), fm44(globalState), (fm31(v0, v0, globalState))[f27 := fm38(map[v0 := v0], globalState)]);
			f28[243], v86[304] := v89.cf22, v0 <==> false;
			var v90: array<map<seq<D1>, bool>> := new map<seq<D1>, bool>[1](i6 => map[seq(0x372, i7  => (DC2(v73, f27))) := v0]);
			var v91: map<int, int> := map[f27 := -418];
			var v92: map<bool, set<bool>> := map[v86[304] := {v0}];
			var v93 := DC2(v73, if (|v79| in v91) then v91[|v79|] else |v92|);
			var v94: seq<D1> := [v93];
			var v95: map<seq<D1>, bool> := map[v94 := v86[304]];
			v90[773] := map[v94 := v85.fm46(f27, v73, globalState)] + v95;
			v90[773] := v95;
			v86[304] := v86[304];
			var v96: seq<seq<int>> := [f30];
			var v97: map<bool, char> := map[v0 := v73];
			var v98: map<bool, int> := map[|v96| != |v97| := f27];
			globalState.f21 := if (v86[304] in v98) then v98[v86[304]] else f27;
		} else {
			v0 := v0;
			...
			var v108: array<map<int, int>> := new map<int, int>[17] [v103, v103, map[f27 := f27], v103 + v103, v103, v103[f27 := f27], map[f27 := f27], v103, v103, map[-0x24f := |v106|], (map[f27 := v104.f27])[|v79| := f27], v103, if (v0) then map[v104.f27 := f27] else v103, v103, if ((if (v79[v104.f27] in v102) then v102[v79[v104.f27]] else v0) in v107) then v107[if (v79[v104.f27] in v102) then v102[v79[v104.f27]] else v0] else v103, v103, map[0xe6 := |v74|]];
			v108[720] := v103 + v103;
			var v110: map<int, char> := map[v104.f27 := v73];
			var v111: map<int, map<int, char>> := map[v104.f27 := v110];
			var v112: seq<map<int, char>> := [map v109 : int | (124 <= v109) && (v109 < 0x17e) :: (v109 % v104.f27) := ('t'), v110[|[!v0]| := v73], v110, if (f27 in v111) then v111[f27] else v110];
			var v113 := DC35(v112);
			var v114: seq<D15> := [DC35(v112), v113];
			var v115: seq<seq<D15>> := [(seq(0x16a, i8  => (DC35([map[v104.f27 := v73]]))))[-0x396 := v113], v114 + v114, v114 + v114];
			var v116: C0 := new C0(f27, v74);
			v108[720], r2, v115, v116 := (v103 + v103) + v103, v0, v115, v116;
		...
		r2 := [f27, f27] <= (f30 + [|map[f30[58] := v0]|])[|(multiset(f30))[f27 := f27]| := 669];
	}
	method m10(p0: bool, p1: seq<int>, globalState: GlobalState) {
		...
		var v14: map<int, bool> := map[if (f30[f27] in v13) then v13[f30[f27]] else -f27 := false];
		...
		match (v16) {
			case DC16(cf29, cf30) =>
				...
				var v18: array<string> := new string[20] ["rnsowybbf", v1, v1, fm31(p0, false, globalState), v1 + v1, fm37(f27, 0x1a6, globalState) + v1, v1, v1, v1, v1, ("yo" + v1)[cf30 := v0], v1, v1 + (seq(-0x286, i1  => (v0))), (seq(-0xe, i2  => (v0))) + v1, v1, v1, if (true in v17) then v17[true] else v1, v1, v1, "ggdic"];
				...
				globalState.f0, globalState.f26, v21, globalState.f18 := f27 * p1[cf29], p0, map[v20 := if (f27 in v22) then v22[f27] else v0], -0x2a0;
				var v23: seq<string> := [v1];
				var v24: T0 := new C4(|v1| - cf29, f28);
				var v25: array<int> := new int[28](i3 => i3 / cf29);
				var v26: multiset<bool> := multiset{0x2e1 < |v1[f27 := v0]|, false, p0, if (p0) then p0 else p0};
				var v27: map<bool, int> := map[false := f27];
				v23, v24, v25, globalState.f0, v26 := v23, v24, if (p0) then v25 else v25, cf29 - (|v27| + f27), multiset((fm41(cf29, |v14|, fm3(multiset{p0}, globalState), globalState) + v12)[cf29 := p0]);
				...
				match (v29) {
					case DC12(cf20, cf21, cf22) =>
						...
						v33[594] := false;
						globalState.f0, v31, v33[594] := cf30, DC8(v0, v28.f36, cf20).(cf15 := v30.f36 == cf29), !(v28.f36 > |v12|);
			...
			case DC15(cf28) =>
				...
				v37[391] := p0;
				v35, v36, v37[391] := v35, v36, !p0;
				var v38: multiset<bool> := multiset{v37[391]};
				var v39: array<array<int>> := new array<int>[11];
				var v40: C3 := new C3(v36.f36, f28);
				var v41: seq<C3> := [v40, v40];
				var v42: array<int> := new int[26] [v36.f36, v36.f36, f27, f27, |v41|, |v15|, |("gtwh")[v36.f36 := v0]|, f27, v36.f36, |"qrfkfxp"|, fm1(globalState), f27, v36.f36, f30[0x380], v36.f36, 0x3af, v36.f36, f27, 719, f27, 306, f27, 947, -688, f27, f27];
				v39[29] := v42;
				var v43: multiset<char> := multiset{v0};
				var v44: C2 := new C2(v38, f27);
				var v45: map<C2, bool> := map[v44 := v37[391]];
				globalState.f15, v38, v39[29], globalState.f26 := (if (v0 in v43) then v43[v0] else |v45|) - v36.f36, v38, v42, p0;
				globalState.f24, v37 := f27 % f27, v37;
...
class C6 extends T1, T2 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
		...
		var v3 := DC3(v1);
		var v6: set<char> := {v0};
		var v7: array<map<char, bool>> := new map<char, bool>[22] [v1, v1[v0 := !fm3(f29, globalState)], v1, v2[f34], v3.cf4, v1, v1, map[v0 := f33], v1 + (map v4 : char | v4 in map[v0 := f33] :: (v4) := (f33)), v1, v1, v1, v3.cf4, v1, v1, v1 + v1, v2[f34], if (f33) then v1 else v1, v1 + v1, v1, (map v5 : char | v5 in v6 :: (v5) := (f33)) + v1, v1];
		...
		v8 := v8[f33 := f33];
		globalState.f26 := f33;
		globalState.f18 := f30[|f30|];
		v0 := v0;
		var v9: set<bool> := {f33};
		var v10: map<bool, set<bool>> := map[f33 := v9];
		for i1 := |(seq(784, i2  => (v0)))[|v10| := v0]| to |(fm9(f33, globalState))[f34 := fm1(globalState)]| {
			var v11: map<int, bool> := map[f32 := f33];
			var v12: multiset<map<int, bool>> := multiset{v11};
			var v13 := "yhq";
			var v14: map<int, string> := map[|v12| := v13];
			if ((|(if (f27 in v14) then v14[f27] else v13)| % f32) == f27) {
				var v15: seq<bool> := [if (|f30| in v11) then v11[|f30|] else f33];
				var v16: array<bool> := new bool[28] [f33, f33, f33, f33, f33, f33, f33, f33, !f33, f33, f33, f33, f33, !f33, true, f33, f33, v15[f27], f33, f33, f33, f33, f33, !f33, f33, f33, f33, f33];
				...
				v18[312] := f27;
				v16[588], v18[312], v16 := fm3(multiset{f33}, globalState), -0x3e6, v16;
				var v19: multiset<int> := multiset{|v15| - i1, -i1, f27, |v13|, v18[312] * i1};
				v19 := v19;
				var v20: map<bool, int> := map[v16[588] := fm7(globalState)];
				var v22: set<int> := {|(map v21 : int | (215 <= v21) && (v21 < 925) :: (v21 / |{f34}|) := (f33))|};
				var v23: map<map<bool, int>, int> := map[v20 := |(if (v16[588]) then v22 else fm10(globalState))|];
				v23 := if (v16[588]) then v23 else v23;
			} else {
				r2 := f34 + (i1 - f32);
				r0 := f32;
				var v24: map<int, map<bool, bool>> := map[|v9| := v8];
				var v25: seq<map<bool, bool>> := [v8, v8, if (i1 in v24) then v24[i1] else v8];
				var v26: seq<map<bool, bool>> := [v25[i1], map[f33 := f33], v8 + v8, map[f33 := f33] + v8, v8];
				v26 := v26;
				var v27: map<bool, int> := map[if (v0 in v1) then v1[v0] else f33 := f27];
				var v28: T1 := new C1(false, f29, (f30[i1 := |v27|])[f34 := f27], f27, f28);
			...
			v32[743] := if (f33) then v34 else v34;
			v32[743] := v34;
			globalState.f15, globalState.f26 := i1, f33;
			v13 := v13;
		}
		var v35 := "asxhdikym";
		r0 := fm1(globalState) % (|v35| * f34);
		r1 := f27;
		r2 := f27;
	}
	method m2(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
			...
			decreases 100 - i0
		{
			...
			var v8: array<bool> := new bool[24] [v3, f33, !p0, false, f33, p1, f33, p1, v3, v3, p1, v3, !p0, fm0(f27, globalState), f33, true, p1, p1, v0[p3], v3, p0, p1, p1, f33];
		...
		for i1 := 0x18b to f32 {
			...
			if (v10 in v11) {
				...
				v2 := (seq(0x172, i2  => ('d'))) + (if (p1) then v2 else v2);
				var v18 := new C2(f31, -|v0|);
			} else {
				var v19: array<seq<int>> := new seq<int>[6];
				v19[398] := f30;
				var v20: map<bool, bool> := map[p0 := p1];
				v2, globalState.f21, globalState.f0, v3, v19[398] := fm14(f32 <= f27, if (f33 in v20) then v20[f33] else p1, p1, f27, globalState), p3, f32, p0, f30;
				...
				var v25: C1 := new C1(p1, multiset(fm13(p2, f32, p0, 0x1a5, globalState)) + multiset{p1}, (v19[398][f27 := p3])[fm1(globalState) := fm1(globalState)], p3, if (f33 in v24) then v24[f33] else f28);
				v25 := v25;
				...
				v38 := v38.(cf41 := f31 * multiset{v0[-0x305]});
			}
	...
	method m3(p0: bool, p1: char, p2: string, p3: bool, globalState: GlobalState) {
		...
		v1, globalState.f26, v2, globalState.f26, globalState.f26 := v1, fm3(f31, globalState), if (f33) then v2 + map[("yskuy")[f27 := p1] := p3] else v2 + v2, !f33 ==> (if (p0 in v3) then v3[p0] else p3), v4 >= v4;
		var i1 := 0;
		while ("msled" == (seq(0x1ec, i2  => (p1))))
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			i1 := i1 + 1;
			globalState.f0 := |(set v5 : int | (-0x50 <= v5) && (v5 < 0x2fb) :: (v5 % f32))|;
			var v6: map<char, map<int, char>> := map[p1 := map[f34 := p2[f32]]];
			var v7: map<int, char> := map[f34 := 'j'];
			var v8 := new C2(f31, |(if (p1 in v6) then v6[p1] else v7)|);
			v0[899] := p3;
			var v9: T1 := new C1(p3, f31[p3 := fm1(globalState)], [f34], f34, f28);
		...
		for i3 := -f32 to f34 {
			...
			var v18: array<map<int, int>> := new map<int, int>[14] [v16, fm15(f27, i3, globalState), map v17 : int | (-0x136 <= v17) && (v17 < 360) :: (v17 % f27) := (-0x112), v16, fm30(globalState), v16, v16, map[i3 := i3], v16, v16, v16, v16, v16, fm42(f32, p3, i3, globalState)];
			var v19: multiset<array<map<int, int>>> := multiset{v18, v18, v18};
			globalState.f0 := if (v18 in v19) then v19[v18] else f34 - f32;
			var v20: seq<D18> := [DC47(|f30[i3 := i3]|, p1)];
			globalState.f3 := |fm51(v20 + [DC47(f27, p1)], v3 != v3, v15 + v15, globalState)|;
			globalState.f0 := if (p0) then i3 / f34 else 0x35d;
			var v21: array<int> := new int[24];
			var v22: seq<bool> := [f33, p3, p0];
			v21[837] := i3 + fm4({p2, seq(566, i4  => (p1))}, f33, v22, globalState);
			var v23 := "jbd";
			v21[837], v18, v23 := f32, v18, v23 + v23;
		}
		...
		var v32: set<int> := {f30[f32], -|v3|, f34, f32, f34};
		var v34: array<map<int, bool>> := new map<int, bool>[19] [v24, map[f32 := f33], v24, (map v25 : int | v25 in v26 :: (v25 - |f30|) := (f33)) + (map v27 : int | (0x1b0 <= v27) && (v27 < -0x2eb) :: (v27 / f32) := (p3)), v24, v28.cf1[|v26| := p3], v24, v24 + map[|map[|v29| := p3]| := p3], v30[|v3|], v24, map[f34 := false], fm48(p3, p3, f34, globalState), map[f34 := !p3], map v31 : int | v31 in v32 :: (v31 / DC32(f32, f32, f30, p3).cf57) := (f33), v24 + fm48(p0, p3, f27, globalState), v24, v24 + (map v33 : int | v33 in f30 :: (v33 + |v3|) := (f33)), map[f32 := p3] + v24, v24];
		v34 := v34;
	}
	method m4(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: set<int>, r1: int, r2: array<array<bool>>) {
		...
		var v4 := "pfggacs";
		var v5 := 'p';
		var v6 := new C5(v2, f29, v3[f32], |v4[p1 := v5]| - f27, f28);
		var v7 := new C3(90, f28);
		var v9: set<int> := {f34, f34};
		var v10 := DC23(multiset{set v8 : int | (-381 <= v8) && (v8 < 0x2b3) :: (v8 % p1), v9, v9});
		match (if (p0) then v10 else v10) {
			case DC24(cf43, cf44) =>
				var v11: array<int> := new int[18](i0 => i0 * f32);
				v11 := v11;
				var v12: seq<seq<bool>> := [v1, ([f33])[f27 := p0]];
				...
				match (DC39(v14)) {
					case DC40(cf74, cf75, cf76) =>
						...
						v11 := v11;
					case DC41(cf77) =>
						var v19: multiset<set<int>> := multiset{v9, set v18 : int | (799 <= v18) && (v18 < 419) :: (v18 % cf43)};
						var v20 := DC28(f32 * -|v19|, f30[-0x160], f33);
						v20 := v20;
						var v21: array<array<T1>> := new array<T1>[4];
						var v22: T1 := new C1(p0, multiset{p2}, f30[f32 := |v1|], --cf43, f28);
						var v23: array<T1> := new T1[18] [v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22];
						v21[659] := v23;
						v21[659] := v23;
						globalState.f24 := |((seq(0x20, i2  => (v5))) + v4)| + |v1|;
						globalState.f21 := f32 % f27;
					case DC42(cf78, cf79, cf80, cf81) =>
						...
						var v27 := DC40(v1[|"lpyjyi"|], p1, f27);
						var v28: map<T0, int> := map[v26 := v27.cf76];
						v25, v11[544], v28 := v25, 0x1be, if (f33) then map[v26 := |f29|] else if (f33) then v28 else v28;
						globalState.f21 := v11[544];
					case DC39(cf73) =>
						globalState.f15, globalState.f26 := 556 / p1, v1[|f30|];
						var v29: map<bool, int> := map[p0 := |{p3}|];
						var v30: map<int, map<bool, int>> := map[f27 := v29];
						globalState.f26, v4, globalState.f18, globalState.f21, globalState.f21 := p2, if (!p3) then v4 else v4, |(v4 + "nq")| + f32, if (p0) then f34 else -(|v4| / 0x2f8), |(v30 + v30)|;
						var v31: array<string> := new string[2] [v4, if (p3) then v4 else "yggtvlhp"];
						v5, v31, globalState.f24 := v4[|f31|], f28, |v1| / cf43;
						globalState.f0 := f27;
				}
			...
			case DC23(cf42) =>
				...
				var v34 := new C1(p2, f29, f30[if (v32 in v33) then v33[v32] else f34 := f27], |fm25(p2, globalState)|, f28);
				...
				v35[105] := (if (p2 in v40) then v40[p2] else v39) in (seq(140, i3  => (v39)));
			case DC25(cf45) =>
				var v41: multiset<int> := multiset{0x11c};
				var v42: T0 := new C5(v6.f38, f31, f30, f32, f28);
				var v43: map<T0, bool> := map[v42 := true];
				var v44: array<bool> := new bool[20] [p3, f33, p3, true, p3, p2, p0, !p0, p2, if (false) then f33 else !p0, p0 <== !p0, !!p0, p0, !p0, v41 == v41[p1 := |v43|], p3, p2, p0, true, p0];
				v44[226] := v1 <= v1;
				v44[226] := fm0(f32, globalState);
				v44[226] := p0;
				var v45: C1 := new C1(p0, f31 * f29, f30, v42.f27, f28);
				var v46: set<string> := {"ogu", v4[p1 := v5]};
				f34, v45, v46 := p1 / f27, v45, v46;
		...
		match (v50) {
			case DC24(cf43, cf44) =>
				...
				if (p3) {
					...
					v52[820] := if ((p1 + v52[820]) in v60) then v60[p1 + v52[820]] else |v61[p1 := v9]|;
					globalState.f26, v52[820] := p0, v53.f32;
					globalState.f26 := true;
					var v62 := DC27(p0, v60, if (|v9| in v60) then v60[|v9|] else p1, v52);
					var v63: seq<D12> := [v62];
					globalState.f24 := |(v63 + [v62])| - |({|v4[0x33e := 'k']|} * v9)|;
				} else {
					globalState.f0 := cf43 % f32;
					var v64: seq<int> := [f27];
					var v65 := DC18(p0);
					...
					globalState.f26, v66[146], v68[565], globalState.f3 := (|DC15(v51).cf28| + p1) <= |v51|, map[fm36(p3, globalState) := p2] !in multiset(v71 + v71), fm7(globalState), 0x366 / cf43;
				}
				
				var v72: array<seq<int>> := new seq<int>[22](i7 => f30);
				v72[456] := seq(-680, i8  => (--f32));
				...
				v74[426] := false;
				globalState.f26, globalState.f24, v72[456], v74[426], v1 := p3 <== p0, p1, [f34], f33, (v1 + [p2]) + v1;
				globalState.f3 := cf43;
			case DC23(cf42) =>
				var v75 := DC36(v5, f32);
				match (v75) {
					case DC36(cf64, cf65) =>
						var v76 := DC40(v4 < v4[p1 := 'g'], f34, -(if (!p0) then -f27 else f27));
						...
						v76, globalState.f15, v77 := DC40(p3, cf65, p1).(cf75 := |v78[f27]|), |(if ((|v80| * f34) in v79) then v79[|v80| * f34] else v9)|, if (f33) then v77 else v77;
						globalState.f0 := |v4[|v4| := v5]|;
					...
					case DC37(cf66, cf67, cf68, cf69) =>
						...
						v87[143] := cf69;
						v87[143] := -0x2d9 != f30[|(seq(0x28e, i9  => (v5)))|];
						var v88: set<bool> := {cf66, v87[143]};
					...
					case DC38(cf70, cf71, cf72) =>
						...
						globalState.f3 := |(if (((seq(0x1d2, i10  => (v5))) <= v4) in v92) then v92[(seq(0x1d2, i10  => (v5))) <= v4] else v9)|;
						...
						var v96 := new C5(map[v0 := |f30|], f29, f30[|(if (v94 in v95) then v95[v94] else f29)[false := |f30[f34 := cf72]|]| := f34], if (p2) then p1 else if (p2 in f29) then f29[p2] else p1, f28);
					case DC35(cf63) =>
			...
			case DC25(cf45) =>
				...
				var v107: array<bool> := new bool[27] [!f33, p0, p0, p0, p0, v1 != v1, p2, |v4| < -f27, false ==> p3, f34 <= p1, p2 <== f33, p0 ==> p3, f32 in (map v105 : int | (0x173 <= v105) && (v105 < 979) :: (v105 - 0x236) := (f32)), f33, v106 >= v106, p2, p3, !v6.fm3(f31, globalState), v1[f32], p0, f33, p2, p0, p3, p0, p2, p3];
				v107[249] := f33;
				var v108: map<bool, bool> := map[f27 <= p1 := !v104.fm35(v5, f27, globalState)];
				var v109: map<int, string> := map[f32 := v4];
				v107[249], v108 := v5 !in ((if (f34 in v109) then v109[f34] else seq(228, i11  => (v5))) + (seq(7, i12  => (v5)))), v108;
				var v110: array<int> := new int[6];
				v110[656] := f32;
				v110[656] := fm1(globalState);
		...
		for i13 := |"e"| + f34 to f27 {
			...
			globalState.f18, v0, v112, globalState.f15 := (|multiset([0x33f, f27, f27, i13])| - |v4|) / p1, fm15(fm4(v113, !p3, v1, globalState), i13, globalState), v112, p1;
		}
		...
		r0 := set v118 : int | v118 in v117 :: (v118 * (-0x1a5 / |map['r' := |multiset{280}|]|));
		r1 := 0xf5;
...
method Main() {
	...
	if (fm0(v6 % v6, globalState)) {
		if (v4 ==> v4) {
			v4 := v4;
			v1 := (v1 + v1)[v6 := v3] + (v1 + v1);
		...
		if (!v4) {
			...
			globalState.f26 := (v9 + v9)[v6 := |v27|] == (seq(-0x3bb, i1  => (v6)));
		...
		globalState.f26, v11[443], v0[283], v4, v4 := v31 != [v9], !v4, -(v6 % v6), (v4 || false) <== v4, (seq(-0x218, i2  => (DC17({v6})))) !in (v34 + v34);
		var v35: multiset<bool> := multiset{v11[443], v4, v11[443] <==> v4};
		v35 := v35;
	} else {
		...
		if (v4) {
			...
			var v46: array<string> := new string[10] [v1, "w", v1, v1, v1, fm8(globalState), v1, v1[v38 := v3], v1, v1];
			var v47: C1 := new C1(v40, v45, v9, v6, v46);
			v47 := v47;
		} else {
			v4 := if (v37) then v4 else v4;
			var v48 := DC32(-v6, v38, v9, v37);
			var v49, v50 := m0(true, |v48.cf59| * v38, --0x1e1 * v38, fm1(globalState) % v6, globalState);
			globalState.f26 := true;
		...
		var v60 := DC34({v36, [v37, v4]} - (set v59 : seq<bool> | v59 in v58[[true] := v38] :: (v59)));
		match (v60) {
			case DC34(cf62) =>
				globalState.f26 := v4 <== !!v4;
				v0 := new int[13](i4 => i4 / v38);
				v1 := seq(675, i5  => (v3));
				v3 := v3;
		}
	...
	match (v61.(cf45 := v63)) {
		case DC24(cf43, cf44) =>
			...
			var v70: array<string> := new string[22] [v1, v1, seq(-0x1bf, i6  => (v3)), v1, v1, v1, "ukgaklleg", "hl", v1, v1, v1, "wkbli", v1, "usfy", "yakla", v1, v1, v1, v1, v1, v1, v1];
		...
		case DC23(cf42) =>
			...
			if (v4) {
				...
				v87 := v87[v76 := v85];
				var v88: C1 := new C1(true, v77[v73 := |v1|], v9, 0x325, v82);
				var v89: multiset<C1> := multiset{v88};
				var v90: C6 := new C6(v84.f32 == |v89|, v84.f32 % |v1|, v84.f31, v9, -v6 / -0x248, v82, v84.f31, v6);
				var v91: map<string, C6> := map[seq(0x4, i7  => (v3)) := if (v90.f33) then v90 else v90];
				...
				var v101: array<string> := new string[27] ["fgvfq", v1, v1, v1, v1, (seq(0x1b1, i8  => (v3)))[v74 := v3], v98.cf0[fm1(globalState) := v3], "a", v1, v1, fm31(v73, v4, globalState), seq(104, i9  => (v3)), v99[|v100|], "qgwx", v1, v1, v1, v1, "kx", seq(486, i10  => (v3)), ("olpvqovqh")[v74 := v3], v1, v1, v1, v1, seq(0x24e, i11  => (v3)), "sfnpbmx"];
				...
				var v110 := DC40(v73, -(if (|v1[|v107| := v3]| in v105) then v105[|v1[|v107| := v3]|] else v6), |v109|);
			...
			var v114, v115 := m0(v73, v74, v74, |(seq(0x187, i12  => (|v1|)))|, globalState);
			v11[395] := v73;
			var v116: multiset<int> := multiset{v115, v115};
			v11[395], globalState.f26, v114 := v114, v73, !((if (fm0(|v116|, globalState)) then v114 else !v114) <== (v114 ==> v114));
		case DC25(cf45) =>
			if (v4) {
				var v117: map<int, string> := map[v6 := "jrjwq"];
				var v118: map<bool, bool> := map[v4 := v4];
				var v119: array<string> := new string[27] [v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, seq(0x2b, i13  => (v3)), fm37(v6, v6, globalState), v1, v1, v1, "by", seq(0x1f, i14  => (v3)), v1, if (|v118| in v117) then v117[|v118|] else v1, v1];
				...
				globalState.f26 := v4;
				v4 := v2 !! (v2 + v2);
				var v127: array<string> := new string[24] [v1, seq(0xe8, i16  => (v3)), v1, v1, v1, seq(195, i17  => ('l')), "wfnbai", v1, v1, v1, v1, "apfximgjv", v1, v1, v1, seq(0x3d7, i18  => (v3)), "gadjbunu", v1, seq(0x2ac, i19  => (v3)), v1, v1, "gwlwggmnv", v1, "ukpupoan"];
			...
			v11[145] := v4 || fm0(v6, globalState);
			v11[145] := v4 ==> v4;
			var v132: multiset<bool> := multiset{v4, v11[145]};
			var v133: C2 := new C2(v132[fm0(-v6, globalState) := 869], v6);
			var v134: map<int, C2> := map[-78 := v133];
			var v136: seq<map<int, bool>> := [map v135 : int | (0x3db <= v135) && (v135 < 775) :: (v135 * |map[v11[145] := v6]|) := (v11[145])];
			var v137: seq<C2> := [v133, v133];
			v133 := if (|(v136 + v136)| in v134) then v134[|(v136 + v136)|] else v137[|fm48(v11[145], v4, v6, globalState)|];
			var v138: array<string> := new string[3] [v1, fm37(v6, v6, globalState), v1];
			var v139 := DC43(v138);
			match (v139) {
				case DC44(cf83) =>
					var v140: seq<bool> := [v4];
					var v141: array<bool> := new bool[23] [v11[145], v11[145], false, v4, v4, v11[145], v11[145], v4, if (false) then v133.fm5(globalState) else v4, true, v11[145], v140 <= v140, v11[145] <== v4, v4, v11[145], fm1(globalState) == v6, v133.fm21(globalState), true, false, v4 && v11[145], v4, v4, multiset(v140) > v132];
					var v142: set<array<bool>> := {v141, v141};
					v141, v1, v11[145] := v141, v1, {v141} > (v142 - v142);
					v11[145] := !v11[145];
					var v143: map<bool, array<int>> := map[v4 := v0];
					var v144 := DC37(v11[145], cf83, v0, v11[145]);
					var v145: array<array<int>> := new array<int>[18] [v0, v0, v0, if (v11[145]) then v0 else if (v11[145] in v143) then v143[v11[145]] else v0, v0, v144.cf68, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
					v145[154] := v0;
					var v146 := DC28(cf83, v6, v4);
					v145[154] := new int[19] [-0x1bc, cf83, cf83 * cf83, |v140|, 0x3c3, v6, v6, v6 * v6, v6 - v6, 0x38d, v6, v6, v146.cf52 * v6, cf83 * |fm9(v11[145], globalState)|, |v1|, v6, cf83, -fm1(globalState), v6];
					globalState.f15 := -(|([v4] + [true])| * (v6 + cf83));
				case DC43(cf82) =>
					v4 := v4;
					var v147: seq<seq<int>> := [v9];
					var v148: set<seq<int>> := {v147[v6], fm43(v4, DC6(v4), v4, globalState)};
					globalState.f15 := |v148|;
					var v149: map<bool, int> := map[false := v9[0x32e]];
					...
					v150 := v150[map[v4 := |(if (v151 in v152) then v152[v151] else v148)|] := [v11[145]] != [v151.f35, false, v151.f35, v4, v11[145]]];
					var v153: map<int, set<bool>> := map[0x298 := v5];
					var v154 := DC23(multiset{v7});
					v153, v154 := map[0xe6 := {v151.f35, v11[145]}], v154;
				case DC45(cf84) =>
	...
	var v163 := new C5(v160, v161[v4 := |v5|], DC21(v9).cf39, v6, v162);
	for i21 := v6 to v6 {
		v0[416] := -0x307;
		v0[416] := i21;
		...
		var v170: C6 := new C6(v4, 615 + v6, v167[i21], [v0[416], (v168.(cf89 := v4)).cf91], v6, v169[0x152], v161, v165);
		v170 := v170;
		var v171: multiset<int> := multiset{|"ugxwp"|};
		globalState.f26 := (v0[416] * |v9|) >= (|v9| + |v171|);
	}
	...
	if (v163.fm4({v1, v1, [fm26(v3, |v177|, v6, globalState)]}, v4, ([!v4])[|{v4}| := v4], globalState) < v6) {
		globalState.f26 := true;
		v1 := v1 + (seq(0x2ac, i22  => ('r')));
		globalState.f0 := 522;
		v11[206] := !v4;
		v11[206] := v4;
		v177 := v177;
	...
	v0[515] := -(v163.fm4(v13, v4, v185, globalState) + (v9[v6] / v6));
	globalState.f26, globalState.f18, v4, v6 := if (v4) then v4 else v4, v6, if (if (v4) then v4 else v4) then v4 else v4, 0x1c3;
	v11 := v11;
	globalState.f26 := |v173| != v0[515];
	for i23 := v174.fm45(globalState) to v6 - v0[515] {
		var v186 := DC40(v4, v0[515], |v8[v3 := v0[515]]|);
		var v187: map<int, char> := map[0x1a3 := v3];
		var v188 := DC8(if (v0[515] in v187) then v187[v0[515]] else v3, |v1|, v4);
		...
		globalState.f26, v186, v190, v0[515], v4 := !!(v163.fm4(v13, false, v185, globalState) > i23), if (!true || v4) then fm55(v6, v191, v4, |{v4, v4}|, globalState) else DC40(v4, v0[515], i23), v190, |v195|, v4;
		globalState.f21 := i23;
		var v196 := DC4(v6, |v1|, v174.fm45(globalState), v3, seq(440, i24  => ('j')));
		v3 := if (v177[i23 := i23] == v177) then v3 else v196.cf8;
		if (v4) {
			var v197: array<array<int>> := new array<int>[7];
			v197 := v197;
			var v198 := DC37(v4, v0[515], v0, true);
			var v199: map<int, bool> := map[i23 := false];
			var v200: map<bool, int> := map[!v4 := v6];
			var v201: T2 := new C2(v161, |v200|);
			var v202: array<D15> := new D15[13] [v198, v198, v198, DC37(v4, v0[515], v0, v4), v198, DC37(v4, |v199|, v0, v4), v198, v198, v198, if (false) then v198 else v198, v198, DC37(!v163.fm3(v161, globalState), |[v201]|, v0, v4), v198];
			v162[1] := v1;
			var v203: seq<set<bool>> := [v5];
			globalState.f18, globalState.f26, v202, v162[1], globalState.f3 := (v6 + i23) % i23, (v201.f32 / v0[515]) >= v9[|v203|], v202, v1, v6;
			...
			var v211 := DC5(v210);
			var v212 := DC5(v211);
			globalState.f26 := if (fm0(i23, globalState) in v173) then v173[fm0(i23, globalState)] else if (v4) then DC42(v0[515], v207, v174.fm46(v6, v3, globalState), v212).cf80 else v4;
			var v213, v214 := m0(-v174.fm45(globalState) > v0[515], |v1|, i23 / v6, v0[515], globalState);
			var v215: array<map<int, bool>> := new map<int, bool>[23](i25 => map[v214 := !v4]);
			var v216: seq<array<map<int, bool>>> := [v215, v215];
			var v217: map<int, array<map<int, bool>>> := map[|(if (false) then v1[v214 := v3] else v1)[-i23 := v3]| := v216[v214]];
			v217 := v217[v0[515] := v215];
			var v218: seq<array<string>> := [v162, v162, v162];
			var v219: map<int, array<string>> := map[v0[515] := v218[0x11b]];
			...
			v221 := (v221[0x3aa := seq(0x246, i26  => (v3))])[v214 := fm14(!v213, v4, v4, v6, globalState)];
		}
		
	}
	if (v4) {
		globalState.f21, v9 := if (false) then v0[515] else v0[515] / |v173|, v9 + v9;
		var v222 := DC20(fm1(globalState), v4, v0[515] < v0[515], v4, map[|[v3, fm12(v0[515], v4, globalState)]| := 0x366]);
		match (v222) {
			case DC18(cf32) =>
				v6 := v174.fm45(globalState);
				var v223: seq<multiset<bool>> := [v161[cf32 := v0[515]] + v161];
				v223 := v223[|v5| % v0[515] := fm32(globalState)];
				v9 := fm9(cf32, globalState);
				var v224: map<bool, multiset<bool>> := map[cf32 := v161];
				var v225 := DC23(v62);
				var v226: map<bool, D11> := map[cf32 in v224 := v225];
				v226 := v226[fm1(globalState) == v0[515] := v225];
			case DC19(cf33) =>
				var v227: map<seq<bool>, array<string>> := map[v185 := v162];
				var v228 := DC13(v185);
				var v229: multiset<map<int, int>> := multiset{v159};
				var v230: C6 := new C6(v4, v0[515], v161, fm9(cf33, globalState) + [v0[515]], v0[515], if (v228.cf23 in v227) then v227[v228.cf23] else v162, v161, if (v159 in v229) then v229[v159] else -|v5|);
				v230 := v230;
				v162[216] := v1 + v1;
				v162[216] := v1;
				...
				globalState.f26 := (|map[v237 := v0[515]]| - v6) > 0x2e8;
			case DC20(cf34, cf35, cf36, cf37, cf38) =>
				globalState.f26 := false;
				v4 := v7 < v7;
				var v238: map<array<bool>, int> := map[v11 := v6];
				var v239: map<bool, string> := map[!v4 := v1];
				var v240: seq<map<array<bool>, int>> := [v238, map[v11 := |(if (v4 in v239) then v239[v4] else v1[v6 := v3])|]];
				var v241: map<int, map<array<bool>, int>> := map[v6 := v238];
				var v242: set<char> := {v3, v3};
				globalState.f26 := v240[v6] == (if (|v242| in v241) then v241[|v242|] else map[v11 := if (cf37 in v161) then v161[cf37] else v0[515]]);
				globalState.f18 := v0[515] + v0[515];
			case DC17(cf31) =>
				v163.m10(false, v9 + v9, globalState);
				var v243: set<array<int>> := {v0, v0};
				v11[808] := v243 !! v243;
				v11[808], globalState.f26 := v4, v4;
				v0 := v0;
				var v244: array<bool> := new bool[6] [true, !v11[808], false, v11[808], v4, v163.fm3(v161, globalState)];
		...
		v11[144] := (set v248 : set<bool> | v248 in v247 :: (v248)) !! (set v250 : set<bool> | v250 in v249 :: (v250));
		var v251: set<C3> := {v174, v174};
		var v252: seq<set<C3>> := [v251];
		v11[144] := !(v252 != v252);
		globalState.f26 := v11[144];
		var v253: array<array<map<int, bool>>> := new array<map<int, bool>>[29];
		var v254: array<map<int, bool>> := new map<int, bool>[23](i27 => map[-v0[515] := v4]);
		v253[111] := v254;
		v253[111] := v254;
	} else {
		v0 := v0;
		var v255: set<char> := {fm26(v3, |v9|, v0[515], globalState), v3};
		var v256: T2 := new C2(multiset{false}, v0[515]);
		var v257: multiset<T2> := multiset{v256, v256};
		var v258: T0 := new C4(v6, v162);
		v0 := new int[19] [|v255| % fm1(globalState), v6, v6, v0[515] - v6, |v9[v0[515] := v0[515]]| + v6, 0x322, if (v4) then |v257| else v6, v163.fm4({v1, v1}, v4, v185, globalState) - -0x137, v6, v6, v0[515] % |v185|, 0x3bc, if (v4) then v256.f32 else v9[|v185|], |v161| * v256.f32, -(v6 / v0[515]), v256.f32, |map[v258 := set v259 : char | v259 in v1 :: (v259)]|, v163.fm4(v13, v4, v185, globalState), v258.f27];
		v11[940] := v4 || !v4;
		var v260: map<array<int>, set<int>> := map[v0 := v7];
		var v263: array<map<array<int>, set<int>>> := new map<array<int>, set<int>>[29] [v260, v260, v260, v260, map[v0 := v7], if (v4) then v260 else v260, v260, v260 + v260, v260, v260, v260 + v260, v260[v0 := v7], v260 + v260, v260, map[v0 := set v262 : int | v262 in (map v261 : int | v261 in [v0[515], v0[515]] :: (v261 * v0[515]) := (v4)) :: (v262 - 458)], v260, v260 + v260, v260 + map[v0 := v7], v260, v260, v260, v260, v260, map[v0 := v7], v260 + v260, map[v0 := v7], v260 + v260, v260, map[v0 := v7]];
		v263[784] := v260;
		var v264 := DC4(-v6, v258.f27, v256.f32 * v258.f27, v3, v1);
		var v265 := DC2(v3, v256.f32);
		globalState.f15, v11[940], globalState.f15, v263[784], v264 := -v258.f27 % (v256.f32 % v256.f32), v4, v265.cf3 * v258.f27, if (v4 || v4) then v260 else v260, v264;
		var v266: C2 := new C2(v256.f31, -0x66);
		v266 := v266;
		globalState.f26 := if (v4) then true else v0[515] !in (seq(0x112, i28  => (v256.f32)));
	}
		...
		decreases 100 - i29
	{
		...
		i29 := i29 + 1;
		var v267 := DC16(v0[515], v6 * v6);
		v267 := v267;
		globalState.f0 := -(|v1| - (v0[515] + |v5|));
		if (v4) {
			globalState.f21 := (v0[515] + |v9|) % |v177|;
			var v268: seq<seq<int>> := [v9, v9];
			v159 := v159[v0[515] := |v268|];
			v0[515] := v9[v0[515]];
			...
			v4 := v4;
			globalState.f26 := v4;
			var v271 := DC27(!v4, v177[0x1e9 := v6], v6, v0);
			var v272: array<D12> := new D12[3] [v271, v271, v271];
			v272[740] := v271;
			var v274: map<char, bool> := map[v3 := v4];
			var v275: seq<map<char, int>> := [map v273 : char | v273 in v274 :: (v273) := (v0[515])];
			v272[740], globalState.f0, globalState.f0, globalState.f21, globalState.f26 := v271, 166 * (v9[v6] + v0[515]), --(-0x230 + |v275|) / v6, v0[515], true ==> !v4;
			var v276: map<int, bool> := map[v6 := v4];
			v276 := v276;
			globalState.f26, globalState.f26, globalState.f0, v185, v9 := v4, v4, 0x8b + v6, fm41(v0[515], v6, v4, globalState), v9;
		}
		
		globalState.f24, globalState.f18, v173 := if (DC12(v4, seq(721, i31  => ([v4, false])), v1).cf20) then v0[515] else v0[515], v0[515], v173;
	}
}