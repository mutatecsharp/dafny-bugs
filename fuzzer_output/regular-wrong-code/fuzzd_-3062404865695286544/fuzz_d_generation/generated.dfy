...
function fm2(p0: bool, globalState: GlobalState): int {
	(|(map v0 : int | (0x62 <= v0) && (v0 < 163) :: (v0 / 0x83) := (false))| - |[map[-0x2d2 := true], map[0x189 := false], map[|(seq(-0x187, i0  => ('h')))| := false], map v1 : int | v1 in map[0x7a := 0x109] :: (v1 - 798) := (true), map[|(seq(-223, i1  => ('y')))| := true]]|) - 0x75
}
...
function fm6(globalState: GlobalState): char {
	if (multiset{|(seq(-0x301, i0  => (985)))|, -713} >= multiset{|(seq(837, i1  => ('s')))|, |multiset([|map[!false := 47]|, -|"okfva"|])|, -0x237, 0x318, -0x39}) then 'l' else 'k'
}
...
class C1 {
	...
	method m0(p0: int, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: array<int>) {
		if (f7) {
			...
			v3[365] := p1;
			globalState.f1, v0[572], r1, v3[365] := p1 % |v1|, if (fm1(globalState)) then map[p1 := v1] else v2 + v2, 0x30, 0x2aa;
			globalState.f5 := if (false) then f7 else f7;
			var v4 := "cfkjko";
			var v5: map<string, int> := map[v4 := v3[365]];
			v5 := v5[v4 := v3[365]];
			var v6: map<bool, int> := map[f7 := p1];
			var v7: map<string, map<bool, bool>> := map[v4 := map[f7 := f7]];
			var v8: map<bool, bool> := map[!f7 := f7];
			globalState.f1 := if (f7 !in v6) then fm2(fm1(globalState), globalState) else if (f7) then |(if (v4 in v7) then v7[v4] else v8)| else v3[365];
		...
		v24[448] := p0 < fm2(f7, globalState);
		v24[448] := f7;
		globalState.f5 := f7;
		var v25: map<int, int> := map[-0x2a1 := p1];
		var v26: set<string> := {(v20 + v20)[|v25| := 'h']};
		r1 := |v26|;
		...
		v31 := v31[v30 := v24[448]];
		globalState.f5 := v24[448];
		var v32: map<bool, int> := map[false := 192];
		r0 := (if (v24[448]) then |{true}| else p1) % |v32|;
...
method Main() {
	...
	globalState.f1 := |multiset(seq(-0x113, i0  => ([v1.f7])))|;
	...
	match (v8.(cf8 := v7)) {
		...
		case DC2(cf6, cf7, cf8) =>
			...
			var v16 := "olipx";
			v16 := (seq(0x12d, i2  => (v1.f6))) + (seq(434, i3  => (v1.f6)));
		...
		case DC3(cf9) =>
			...
			if (v26 !! (v26 + v26)) {
				...
				v27[150] := if (!v1.f7) then v28 else v28;
				v27[150] := v28 + fm8(v4, v1.f7, v1.f7, map[[v1.f7] := cf9], globalState);
				v1, globalState.f5 := v1, v1.f7;
				v7[698] := v1.f7;
				var v29: set<bool> := {!v1.f7, v1.f7 || v1.f7, v1.f7};
				var v30: map<map<int, int>, bool> := map[v5 := !v1.f7];
				v7[698], v29 := |v30| >= v4, v29;
				var v31: C0 := new C0(v5, v7[698]);
				v31 := v31;
				...
				v7[981] := v1.f7;
				v7[981] := if (v1.f7) then cf9 == -0xbe else fm1(globalState);
				v1 := v1;
		...
		case DC0(cf0) =>
			...
			v39[624] := v4;
			v39[624], globalState.f1 := v4, 0x118;
			var v40 := DC0(v7);
			var v41: map<D0, int> := map[v40 := v39[624]];
			var v42 := "htil";
			var v43 := DC5(|v42|, v5, v39[624]);
			v39[624] := if (v1.f7) then (if (v40 in v41) then v41[v40] else v39[624]) % 0x26f else -v43.cf13;
			v7 := v7;
			v6 := v6[v1.f7 := v1.f7];
	}
	...
	for i7 := v4 to v4 {
		...
		v46 := map["tpsq" := v44[413]] + v46;
		v7[132] := !false;
		v7[132], globalState.f5, v0 := v1.f7, v1.f7, v1.f6;
	}
	...
	for i9 := v4 to 320 {
		...
		match (v52) {
			case DC9(cf18) =>
				v50[687] := -|map[v1.f7 := i9]|;
				v50[687] := i9;
				var v53: array<array<bool>> := new array<bool>[4];
				v53[613] := v7;
				v53[613] := v7;
				var v54 := DC7(v1.f6);
				var v55: map<D1, int> := map[v54 := -(-|"pb"| / -v49)];
				v55 := v55;
				v5 := v5[v4 + i9 := 0x141];
			case DC10(cf19, cf20) =>
				var v56: map<bool, int> := map[true := v48];
				v50[536] := |v56[v1.f7 := v48]|;
				v50[536] := |v47| / v49;
				v7[6] := cf19;
				v7[6] := true ==> (v0 !in v47);
				var v57: map<bool, set<bool>> := map[fm2(v1.f7, globalState) != v50[536] := {v7[6]}];
				var v58 := DC4(cf19);
				var v59: map<D1, string> := map[v58 := "g"];
				var v60: seq<int> := [v49];
				var v61: set<bool> := {cf20, true, fm1(globalState), cf19, cf19};
				cf19, globalState.f1, v57, v1 := (if (DC4(cf19) in v59) then v59[DC4(cf19)] else v47) != v47, -v49, v57[v50[536] in v60 := {cf19, cf20, cf19} * v61], v1;
			...
			case DC8(cf17) =>
				...
				var v70, v71, v72 := v1.m0(v49, |v69| % 440, globalState);
				globalState.f5 := v1.f7;
			case DC12(cf23) =>
				...
				var v79: map<int, multiset<array<bool>>> := map[v49 := (multiset{v7})[v7 := v49]];
				var v80: array<multiset<array<bool>>> := new multiset<array<bool>>[14] [v78, v78, v78, v78, v78[v7 := v48], v78, v78 - v78, v78 + v78, v78, v78, v78, if (v48 in v79) then v79[v48] else v78, v78 - v78, multiset{v7}];
				v80[52] := ((multiset{v7})[v7 := i9])[v7 := |v47|];
				var v81: seq<array<bool>> := [v7];
				var v82: seq<multiset<array<bool>>> := [v78, v78, v78, v78, multiset{v7, v7, v81[v4], v7, v7}];
				var v83: map<bool, int> := map[v1.f7 := v4];
				var v84: map<set<int>, map<bool, int>> := map[v77 := v83];
				v80[52] := v82[|(if (v77 in v84) then v84[v77] else v83)|] - v78;
		}
		...
		decreases 100 - i10
	{
		...
		if (v1.f7) {
			...
			v0 := v47[v4];
			v7[41] := v1.f7;
			v47, globalState.f5, v7[41] := (v47 + v47) + "hgpygk", v1.f7, v1.f7;
			globalState.f5 := !(v4 < v4);
			var v91: array<char> := new char[2] [v0, v0];
			var v92: seq<array<char>> := [v91];
			var v93 := DC13(v91);
			var v94: array<array<char>> := new array<char>[26] [v91, v91, v91, v91, v91, v91, v91, v91, v91, if (v1.f7) then v91 else v91, v91, v92[v4], v91, v91, v91, v91, v91, v91, v91, v93.cf24, v91, v91, v91, v91, v91, v91];
			v94 := v94;
			...
			v96[652] := v98;
			var v99: set<bool> := {v7[41]};
			v7[41], v95, globalState.f1, v96[652], globalState.f5 := v7[41], v95, v4 % v4, [v97], (if (v1.f7) then v99 else v99) > {v1.f7};
		}
		
		if (v47 == v47) {
			var v100: map<int, bool> := map[v4 := v1.f7];
			v100 := v100[v4 / |multiset{v47}| := v1.f7];
			v7[823] := v1.f7;
			...
			v7[823], globalState.f1, globalState.f0 := v1.f7, --0x2df, |v102[v101 := v103 > multiset{v4, v4, |v104|, v4, v4}]|;
			...
			var v108: seq<bool> := [v1.f7, fm1(globalState), v1.f7, !v1.f7, v7[823]];
			var v109 := new C0(v5[if (v1 in v107) then v107[v1] else |v108| := v4], v7[823]);
			v4 := v4;
		} else {
			v7[315] := fm1(globalState);
			v7[315] := v1.f7;
			var v110: map<int, string> := map[v4 := v47];
			var v111: map<int, map<int, string>> := map[-0x2d := v110];
			v111 := v111[v4 := v110];
			var v112 := DC4(v1.f7);
			v112 := v112.(cf10 := v7[315]);
			globalState.f0 := -v4;
			var v113 := new C1('j', v7[315]);
		}
		...
		v117[996] := v47;
		v117[996] := v1.fm0(v1.fm0("gqains", v0, globalState), v1.f6, globalState);
	}
	var v118: multiset<map<bool, bool>> := multiset{v6};
	var v119: array<int> := new int[11] [|(seq(-948, i12  => (v1.f6)))|, v4, v4, 0x26d % 0x299, |v6|, fm2(if (false in v6) then v6[false] else v1.f7, globalState), v4, v4, v4, v4, |(fm9(v1.f7, v1.f7, globalState) - v118)|];
	v119[229] := v4;
	var v120: multiset<int> := multiset{v4, v4};
	var v121: seq<int> := [|v47|];
	v119[229], v4, v4, globalState.f5 := v4, if (-0x2b6 in v120) then v120[-0x2b6] else v121[fm2(v1.f7, globalState)], v4, !(!v1.f7 <== v1.f7);
	v119[229] := |(seq(0x368, i13  => (v0)))|;
	var v122: seq<bool> := [v1.f7 <== v1.f7];
	globalState.f5 := v122[v4];
	var v123: map<bool, int> := map[v1.f7 := v119[229]];
	var v124 := DC3(v4);
	var v125: map<bool, D0> := map[v122[|v120[if (!!v1.f7 in v123) then v123[!!v1.f7] else v4 := v119[229]]|] := v124];
	v125 := v125[v1.f7 := v124];
	if (|v47| <= v4) {
		var v126: set<int> := {0x84, v4};
		v126 := v126 * ((set v127 : int | (0x3a0 <= v127) && (v127 < 795) :: (v127 * |(seq(0x15b, i14  => (v119[229])))|)) - v126);
		globalState.f5 := !v1.f7;
		var v128: seq<map<int, int>> := [v5];
		var v130: map<int, bool> := map[v119[229] := v1.f7];
		var v131: seq<map<int, bool>> := [v130];
		var v132 := new C0((v128[|v121|])[v4 := |(map v129 : map<int, bool> | v129 in v131 :: (v129) := (if (true in v6) then v6[true] else v1.f7))|], v1.f7);
		var v133 := DC5(v119[229] / v4, v132.f8 + v5, if (v4 in v132.f8) then v132.f8[v4] else v4);
		match (v133) {
			case DC5(cf11, cf12, cf13) =>
				var v134, v135, v136 := v1.m0(v119[229], cf11, globalState);
				var v137 := new C0(map[|v121| := |v47|] + cf12, true);
				var v138: multiset<char> := multiset{v1.f6};
				v138 := v138;
				v0 := v47[cf11];
			case DC6(cf14, cf15) =>
				globalState.f5, globalState.f1 := v132.f9, 0x254 / v4;
				...
				v139[857], globalState.f1, v141, globalState.f1, globalState.f5 := v132, v119[229], v141, v119[229], !v1.f7;
				cf15 := v1.f6;
				globalState.f5 := v132.f9 || v1.f7;
			case DC7(cf16) =>
				var v142, v143, v144 := v1.m0(v119[229], v4, globalState);
				var v145: map<multiset<bool>, int> := map[multiset{v1.f7, v1.f7, v1.f7, v1.f7} := v4];
				v145 := v145[fm10(105, {v1.f7, false, v1.f7, v132.f9, !!!v1.f7}, globalState) := if (!v1.f7) then v4 else v119[229]];
				var v146 := DC10(v132.f9, v1.f7);
				v146 := DC10(v132.f9, v1.f7);
				var v147: multiset<bool> := multiset{v1.f7, v132.f9};
				v7[807] := -|v147| >= v4;
				globalState.f5, v7[807], globalState.f0 := v119[229] != v119[229], v132.f9, -(v142 % (v142 - |v123|));
			case DC4(cf10) =>
				v7[137] := cf10;
				v7[137] := cf10;
		...
		globalState.f5, v119[229], v149[774] := !(!!v150.cf19 && (v152 !! v152)), v119[229], v47;
	} else {
		var v153: seq<string> := [v47, v47 + v47, v47];
		var v154 := DC16(v153);
		v153 := (v153 + v154.cf31[-v119[229] := v47]) + v153;
		var v155 := DC18(v119);
		v119 := v155.cf37;
		var v156, v157, v158 := v1.m0(v119[229], if (v1.f7 in v123) then v123[v1.f7] else v4, globalState);
		globalState.f5 := v1.f7;
		v7[704] := v1.f7;
		var v159: C0 := new C0(map[v119[229] := v157], v1.f7);
		var v160: seq<C0> := [v159, v159, v159];
		globalState.f1, v0, v7[704], v156, v119[229] := v157, fm6(globalState), -|v160| < v4, v157 - v157, 0x3af;
	}
	
	var v161: set<int> := {110, v119[229]};
	var v162: multiset<string> := multiset{v47};
	var v163, v164, v165 := v1.m0(|v161| - |v162|, if (v1.f7) then v119[229] else v4, globalState);
	v164 := 0x2ed;
}