...
function fm0(p0: int, p1: int, globalState: GlobalState): int {
	(|map[true := |[984]|]| / |(map v0 : int | (0x25a <= v0) && (v0 < 0x2c1) :: (v0 / 0x323) := ([-786]))|) - (0x178 * |"fsmqogqg"|)
}
...
function fm2(p0: int, p1: int, p2: char, globalState: GlobalState): bool {
	|(seq(0x2ca, i0  => ('y')))| > (|"hidhmds"| % |(seq(0x1ab, i1  => (|multiset(['b'])|)))|)
}
...
function fm6(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): map<int, int> {
	map[0x81 := 577] + (map[0x2c7 := |map[false := |DC23({true}).cf36|]|] + map[-|(map v0 : int | (202 <= v0) && (v0 < -0x195) :: (v0 % |map[684 := true]|) := (!true))| := |DC44(map[!true := false]).cf67|])
}
...
function fm18(globalState: GlobalState): set<int> {
	DC16(set v0 : int | (0x1a2 <= v0) && (v0 < -0x122) :: (v0 + |multiset{0x37b, |(seq(0x295, i0  => ('n')))|}|)).cf27
}
...
function fm21(globalState: GlobalState): D0 {
	DC1(-(|map['n' := false]| % |[true, !false]|), |{0x316}| + |(seq(0x1ee, i0  => ('j')))|, DC29(|map[true := |map[false := true]|]|, false).cf46)
}
function fm22(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): set<string> {
	{(seq(0x135, i0  => ('i'))) + (seq(132, i1  => ('a')))}
}
...
function fm29(p0: int, p1: int, globalState: GlobalState): seq<multiset<int>> {
	([multiset{|[!false, false]|, |map[-0x1a8 := |multiset(seq(0x283, i0  => (0x18e)))|]|, |[true]|, |map[map[|[0x3a, 0x208]| := -|"xb"|] := 0x137]|}] + [multiset{|[289]|}]) + [multiset{0x13, |multiset{true}|, 32, 0x2fd}, multiset{|(seq(0x2ac, i1  => (|(seq(-0x192, i2  => ('i')))|)))|, |{true, false}|, -421}]
}
function fm30(p0: char, p1: bool, globalState: GlobalState): map<int, char> {
	(map v0 : int | v0 in (set v1 : int | (0xe8 <= v1) && (v1 < 455) :: (v1 % |"h"|)) :: (v0 / 0x34d) := ('s')) + (map[-|(seq(0x189, i0  => ('f')))| := 'e'] + map[0x2b7 := 'k'])
}
...
function fm32(p0: int, p1: seq<multiset<bool>>, p2: seq<bool>, p3: string, globalState: GlobalState): map<D1, bool> {
	map[DC4(false, true, 'r', -724, |(seq(-318, i0  => ('h')))|) := !false] + map[DC4(true, !false, 'l', -0x170, -0x105) := false]
}
...
function fm35(p0: bool, p1: bool, globalState: GlobalState): seq<set<int>> {
	(seq(0x3cf, i0  => ({-|{0x33}|, |"rvhgqeka"|}))) + (seq(0x15c, i1  => ({-|[true]|, -0xb7, --0x144, |[|[multiset{false, false}, multiset{!true, true}]|]|, -0x2af})))
}
function fm36(p0: seq<bool>, globalState: GlobalState): seq<map<bool, bool>> {
	[map[true := true]] + (seq(-0x388, i0  => (map[DC33('r', !false).cf55 := false])))
}
function fm37(globalState: GlobalState): D8 {
	if ("ycqwr" <= (seq(0x2e1, i0  => ('t')))) then DC26(DC3(DC26(DC3(['k', 'b', 'r']), "ndi").cf42), "w") else DC26(DC3(seq(0x2b5, i1  => ('n'))), seq(0x107, i2  => ('w')))
}
...
function fm40(globalState: GlobalState): seq<string> {
	((seq(0x33c, i0  => ("q"))) + ["fil"]) + ["canhopsk"]
}
function fm41(p0: int, p1: string, p2: bool, globalState: GlobalState): set<multiset<int>> {
	{multiset{|"nw"|} - DC35(multiset{98}).cf57, multiset{-|multiset{|['s']|, |"bcleahc"|}|}, multiset{|map[--0xa5 := |{true, true, true}|]|} * multiset{|(map v0 : int | v0 in map[709 := |[|"jjwyqqi"|]|] :: (v0 % 620) := (false))|, -0xfb, |[!true]|, |"uqgceiacv"|}}
}
...
function fm43(p0: int, p1: bool, p2: bool, globalState: GlobalState): D1 {
	DC4(false ==> false, false, 'i', |({seq(0x27d, i0  => (|[true, !!true]|))} * {[439]})|, 0x7c % |multiset{|"ahdj"|}|)
}
method m0(p0: int, p1: int, globalState: GlobalState) returns (r0: int) {
	...
	var v3: seq<multiset<int>> := [v2[|v0| := fm0(p0, p0, globalState)]];
	var v4 := false;
	...
	v16 := v16 + (v16 + v16);
	for i0 := -v12.f28[862] to |(seq(-0x29d, i1  => (v6)))| {
		...
		var v19: multiset<string> := multiset{seq(0x2b6, i3  => (v6))};
		var v20: seq<int> := [i0, |"ipsloox"|];
		var v21: set<int> := {|v19|, |v20|};
		var v22 := DC29(v9.f24, v4);
		globalState.f18 := if (v4) then v12.f28[862] - |v21| else v22.cf45 % v12.f28[862];
		var v23: array<seq<bool>> := new seq<bool>[27];
		var v24: seq<bool> := [v4];
		v23[349] := v24;
		v23[349], globalState.f1, v5 := v24 + ([v4, v4, v4, v4])[i0 := v4], -(v9.f24 + p0), v5;
	...
	method m1(globalState: GlobalState) returns (r0: bool) {
		if ((f33 - f33) <= f33) {
			...
			if (v0) {
				...
				var v3: seq<bool> := [v0];
				var v4: set<bool> := {v0, v3[0x2da], v0};
				...
				var v12: seq<int> := [f24 / |v11|, f24, |multiset{v0}|];
				v2, globalState.f9, globalState.f9, v12 := v2, |("s" + (seq(0x378, i1  => (v1))))|, f24, v12;
			} else {
				var v13: multiset<int> := multiset{f33};
				var v14: multiset<bool> := multiset{v0, v0, v0};
				var v15 := new C0(|v13[f33 := f24]| != (if (v0 in v14) then v14[v0] else |{true, !v0, v0}|));
				var v16: array<string> := new seq<char>[17](i2 => (seq(0x288, i3  => ('t'))) + (seq(0xd8, i4  => ('y'))));
				var v17 := "wtih";
				var v18 := 'q';
				v16[433] := v17[fm11(v15.f34, v15.f34, true, f33, globalState) := v18];
				v16[433] := "vcjpd" + (seq(558, i5  => (v18)));
				v15 := v15;
				...
				globalState.f2, v21, globalState.f1, v24 := v15.f34, v21, f24, seq(0x28f, i6  => (v22));
			}
			
			var v25: array<array<map<bool, bool>>> := new array<map<bool, bool>>[12];
			var v26: map<bool, bool> := map[v0 := v0];
			var v27: seq<map<bool, bool>> := [v26];
			var v28: array<map<bool, bool>> := new map<bool, bool>[25] [fm13(globalState), map[v0 := v0], map[v0 := v0], v26, v26, map[v0 := v0], v26, v26, v26, map[v0 := !v0], v26, map[true := v0], v26, v26, v26, v27[f24], v26, v26, v26, v26, v26, v26[v0 := v0], v26, map[v0 := !v0], v26];
			v25[428] := v28;
			v25[428] := v28;
			...
			var v32, v33, v34, v35 := m8(v31[f33], globalState);
		} else {
			var v36 := true;
			if (v36) {
				globalState.f2 := v36;
				...
				var v46 := DC12(v45);
				var v47: map<bool, seq<int>> := map[|v42[v44.f34 := f33]| < f33 := v46.cf21];
				v47 := v47[v44.f34 := ([f33, f24])[|map[-f24 := f33]| := f24]];
			} else {
				...
				var v51 := "i";
				globalState.f17 := v51;
				var v52: map<int, string> := map[f24 := seq(329, i7  => ('y'))];
				v52 := v52[f24 := v51];
			}
			...
			globalState.f18, globalState.f9, v36, globalState.f17 := DC13(f33, v57, v55).cf22, f24, v36, seq(133, i10  => ('k'));
		}
			...
			decreases 100 - i11
		{
			...
			var v66: array<int> := new int[19] [f33, f33, |v63|, f24, 0x2a4, |v59|, |fm16(globalState)|, -f24, f24, |v65|, f24, f24 - |[v59, v59]|, f33 % -0x6, f24, f24, |v65|, f33, fm0(-0x20b, f33, globalState), f24];
			v66[92] := f33;
			v66[92], v66 := f24, if (v58) then v66 else v66;
			...
			v69 := v69[v66[92] != f24 := v58];
			var v70 := DC8();
			match (v70) {
				case DC8() =>
					var v71: seq<int> := [|v59|];
					var v72: seq<bool> := [v58, v58];
					var v73: array<map<bool, int>> := new map<bool, int>[27] [fm17(0x316, f24, 580, false, globalState), v63, v63, v63[v58 := v66[92]], map[fm2(v66[92], v66[92], v60, globalState) := f24], (map[v58 := 0x281])[v58 := f33], fm17(|fm4(v58, v66[92], v60, v58, globalState)|, f33, |v71|, v58, globalState), map[v58 := -0x2ab], v63, map[v58 := |map[map[v58 := v66[92]] := |v59|]|], v63, v63, v63, v63, v63, map[v58 := f33], fm17(|fm18(globalState)|, f24, |v72|, v58, globalState), v63, v63, v63, v63, v63, v63, v63, v63[v58 := f24], v63, v63];
					var v74: map<int, array<map<bool, int>>> := map[|(seq(0x1fc, i13  => (v60)))| := v73];
					var v75: seq<array<map<bool, int>>> := [v73];
					v74 := v74[v66[92] := v75[f33]];
					...
					var v82: map<seq<seq<bool>>, array<bool>> := map[fm19(v58, v66[92], globalState) := v81];
					var v83: seq<seq<bool>> := [[v58]];
					v81 := if ((v83 + v83[|v59| := [true]]) in v82) then v82[v83 + v83[|v59| := [true]]] else v81;
				case DC7(cf16) =>
					globalState.f2 := (|v65| % -v66[92]) != f24;
					...
					var v94: array<bool> := new bool[24] [v66[92] != f33, true, fm2(v85[|v59|], f33, v60, globalState), f24 in v85, v58, fm2(f33, f33, 'c', globalState), v58, v58, v58, v58, !true, v58, if (v86 in v87) then v87[v86] else v58, v58, !fm2(v66[92], |v84|, v60, globalState), v58, v58, v58, |v88| <= |v90[v66[92]]|, fm2(|v91|, v92.cf12, v60, globalState), false, v66[92] <= |(map v93 : int | (-0x324 <= v93) && (v93 < 0x2ef) :: (v93 / v66[92]) := (|map[v58 := v60]|))[f24 := v66[92]]|, v58, v58];
					v94 := v94;
	...
	method m7(p0: seq<bool>, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		if (v0) {
			...
			match (v6.(cf10 := v4)) {
				case DC4(cf8, cf9, cf10, cf11, cf12) =>
					...
					var v8 := DC8();
					var v9: set<bool> := {v0};
					var v10: map<string, bool> := map[seq(-689, i0  => (v4)) := true];
					var v11 := "qojo";
					var v12: map<bool, bool> := map[!v0 := cf8];
					var v13: seq<map<bool, bool>> := [v12];
					v8, cf8, globalState.f1 := v8, if (v9 <= v9) then cf8 else if (cf8) then v0 else cf9, -(|v10[v11[|map[multiset(v2) := f33]| := v4] := cf9]| * (f24 + |v13|));
					var v14: map<char, bool> := map[cf10 := cf9 ==> cf9];
					v14 := v14[v4 := v0];
				case DC5(cf13, cf14, cf15) =>
					var v15: array<multiset<bool>> := new multiset<bool>[22];
					var v16: multiset<bool> := multiset{p0[f33]};
					v15[76] := if (v0) then v16 else v16;
					var v17: map<bool, multiset<bool>> := map[v0 := v16];
					v15[76] := if (false in v17) then v17[false] else multiset(p0);
				...
				case DC3(cf7) =>
					...
					v35, globalState.f19, globalState.f1 := map[v0 := |(("pfkfe")[f33 := v4] + cf7)|], multiset{v36}, f24;
					globalState.f9 := f33;
			...
			v37[817] := v0;
			v37[817] := fm2(f24, f33, 'w', globalState);
			globalState.f18 := f24;
			var v38 := DC5(v37[817], v0, !v0);
			if (v38.cf13) {
				var v39: map<bool, int> := map[v0 := f33];
				var v40 := DC13(|"pao"|, v39, "yvdcwh");
				v37[817] := fm0(f33, |v40.cf24[f24 := v4]|, globalState) <= (if (v37[817]) then |v2| else f33);
				v1 := v1[f33 := !v0 && v0];
				r0 := !v0;
				...
				v41[356] := v42;
				var v43 := "bxjwsbdy";
				globalState.f18, v0, v41[356], globalState.f1 := f24 / f33, (v43 + "b") != (v43 + (seq(-744, i3  => (v4)))), (v42[v37[817] := v37[817]])[v37[817] := v0], (fm21(globalState).(cf1 := f33)).cf2;
				...
				v48[378], r2 := f33, v0;
				r0 := v0;
				var v49: map<D1, bool> := map[v6 := v37[817]];
				var v50: array<map<D1, bool>> := new map<D1, bool>[7] [v49, v49 + v49, v49, v49[v6 := v37[817]], v49 + v49, v49, v49];
				v50 := v50;
				...
				globalState.f18 := (if (v37[817]) then f33 else f24) + 0xd6;
			}
			...
			v57 := v57;
			r2, globalState.f21, globalState.f18, v57, v55 := v0, p0, -f33, fm22(f33, v0, v0, fm0(f33, f24, globalState), globalState) * (v57 + {v56, seq(-411, i4  => (v55))}), v55;
			if (v0) {
				var v58: multiset<int> := multiset{f33, f33};
				var v59: array<seq<bool>> := new seq<bool>[13] [p0, p0, p0, p0, p0 + p0, [v0, false, v0], p0 + [v0], p0, p0, fm23(globalState), fm23(globalState), p0, p0[if (|p0| in v58) then v58[|p0|] else f33 := v0]];
				v59[49] := p0;
				v59[49] := p0;
				var v60: seq<string> := [v56];
				globalState.f2 := fm2(fm0(|v60[f33]|, DC11(f33, v59[49][f24], v0).cf18, globalState), f33, fm3(globalState), globalState);
				var v61 := DC13(|(seq(-0x2ef, i5  => (v55)))|, map[true := f33], v56);
				...
				var v68: multiset<map<int, bool>> := multiset{map v66 : int | v66 in v2 :: (v66 / f33) := (v0), map[f24 := v0], v1, v1[if (true in v67) then v67[true] else f33 := v0], v1};
				var v69 := DC12(v2);
				...
				v76[935], v67 := v69.(cf21 := v2), if (v77.cf9) then v67 + v67 else v67;
				var v78: map<bool, seq<int>> := map[v0 := fm24(v2[f24], !v0, v72[611], -f24, globalState)];
				v78 := v78[v0 := v2];
			}
			
			var v79: array<char> := new char[7] [v55, v55, v55, 'p', v56[f24], v55, v55];
			...
			match (v81) {
				...
				case DC7(cf16) =>
					...
					var v85: map<int, D1> := map[v2[-f33] := v84.(cf13 := v0)];
					...
					v89 := v89[seq(0x385, i6  => (v55)) := v88.f34 <==> v88.f34];
			}
		...
		match (v91) {
			...
			case DC14(cf25) =>
				...
				globalState.f9, v101[638], v103 := -f24, v102, (v103 * v103) - v103;
				...
				var v112 := 'y';
				var v113: array<int> := new int[12] [f24 + v2[-|v104[v110 := f33]|], f33, f24, -(f33 + |"bgboi"|), |v103| - |v111|, f24, |v1|, f24, f33, f24, f24, |v90[f33 := v112]|];
				v113 := v113;
				var v114 := DC6();
		...
		r2 := v119 >= (set v120 : int | v120 in v2 :: (v120 / |{{true, true}}|));
	}
	method m8(p0: array<bool>, globalState: GlobalState) returns (r0: int, r1: bool, r2: int, r3: char) {
		...
		if (!(v10 == v10)) {
			...
			if (f24 != fm0(f24, f24, globalState)) {
				...
				v22[92] := fm24(f33, v0, |"dn"|, f33, globalState);
				p0[865] := |v5| == f24;
				v7, v21, f33, v22[92], p0[865] := fm24(-f33, v0, |(v2 + v2)|, 151, globalState), v21, f33, [f24, 0x33d, f33 % |v2|], v0;
				var v23 := new C0(f33 <= f33);
				r1 := p0[865];
				var v24: map<seq<int>, D6> := map[v22[92][f33 := f33] := DC17(v0)];
				var v25 := DC17(!v23.f34);
				v24 := v24[v7 := if (p0[865]) then v25 else v25];
			...
			p0[710] := v0 || v0;
			p0[710] := !!v0;
			var v35: set<string> := {seq(0x349, i0  => (v2[f33]))};
		...
		v43, globalState.f18, v44 := v45.cf36, (0x33e + f33) + 0x2b1, v44[v0 := f24];
		for i1 := if (v0) then f24 else f33 to f24 * |v2| {
			v2 := v2;
			r1 := f24 < -(fm0(f24, 0xb3, globalState) - f33);
			if (v0) {
				var v46: map<array<bool>, int> := map[p0 := f24];
				globalState.f18, r1 := |v46| % (i1 + f33), v6.cf27 != (set v47 : int | (0x118 <= v47) && (v47 < -0x349) :: (v47 % |v44|));
				var v48: array<string> := new string[16](i2 => v2[i1 := 'v']);
				v48 := v48;
				...
				globalState.f2, globalState.f17 := v0, (seq(0xd4, i3  => (v51))) + v2;
			} else {
				globalState.f21 := v8;
				var v55: map<bool, int> := map[v0 := |v7[i1 := i1]|];
				var v56: map<bool, int> := map[v0 := |v55|];
				r0 := (if (v0 in v56) then v56[v0] else 0x2a7) - (i1 / f33);
				var v57 := new C0(v0);
				var v58: map<set<int>, bool> := map[{|(seq(0xd2, i4  => ('g')))|} := v57.f34];
				v58 := v58;
				p0[151] := false;
				var v59 := 's';
				var v60: map<array<int>, char> := map[v9 := v59];
				p0[151], globalState.f9, v60 := !(-i1 > (if (true) then 0x2bd else i1)), v7[0x66 + 0x61], map[v3 := v59] + (v60 + map[v3 := v59]);
			}
		...
		r2 := v7[fm0(-DC4(v0, v0, v61, |v7|, fm0(f33, fm0(|v62|, f24, globalState), globalState)).cf12, f33, globalState)];
		r3 := v2[-0x3a2 - 0x1bf];
	}
}
...
class C2 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool) {
		...
		if (match v0 {
			...
			var v1: array<bool> := new bool[14](i0 => |(seq(-591, i1  => ('x')))| != f24);
			v1, globalState.f2 := v1, f31 <==> (f31 && f31);
			if (f31) {
				var v2 := "dvbaaxfn";
				v1[884] := f24 <= |v2|;
				v1[884] := f31;
				var v3: map<int, int> := map[f24 := |(seq(0x45, i2  => ('i')))|];
				globalState.f9 := f24 - (|v3| / f24);
				globalState.f18 := f24;
				var v4: multiset<bool> := multiset{v1[884], v1[884], f31};
				var v5 := 'o';
				var v6: array<char> := new char[1] [v5];
				v6[531] := if (!f31) then fm3(globalState) else 't';
				var v7 := DC2(f31, f24, v5);
				v1[884], v4, v6[531] := !fm9(v1[884], fm0(f24, f24, globalState), f24, globalState), v4, v7.cf6;
				v1[884] := v1[884] || f31;
			} else {
				r0 := f31;
				v1[816] := 155 <= |(seq(-0x31c, i3  => (f24)))|;
				v1[816] := f31;
				globalState.f2 := fm9(f31, f24, f24, globalState);
				var v8 := "xuqmdjtcc";
				var v9 := 'e';
				var v10 := DC2(v1[816], |"qoctswai"|, v9);
				var v11: map<char, int> := map[v10.cf6 := f24];
				var v12 := new C1(fm29(0x2e7, f24, globalState), f24, f24, f25[|v8| := v11]);
				v12 := new C1(v12.f32, f24, f24, f25);
			}
			
			var v13: multiset<array<bool>> := multiset{v1, v1, v1};
			var v14: array<int> := new int[19](i4 => i4 % f24);
			var v15: map<multiset<array<bool>>, array<int>> := map[v13 - v13 := v14];
			v15 := v15[v13 := v14];
			var v16 := DC3(seq(0x250, i5  => ('j')));
			var v17 := DC26(v16, seq(0x26f, i6  => ('a')));
			...
			match (v22) {
				case DC17(cf28) =>
					...
					var v29: multiset<int> := multiset{v14[655]};
					var v30: seq<multiset<int>> := [multiset{f24}, multiset([|v28|]), multiset{|v25|}, v29[|v27| := v14[655]]];
				...
				case DC16(cf27) =>
					...
					var v38: map<int, set<bool>> := map[f24 / f24 := v37];
					v38 := v38[0x25 := v37];
					var v39 := "h";
					...
					globalState.f21 := (if (v40.f34 && !v40.f34) then fm23(globalState) + v41 else if (v40.f34) then v41 else v41)[f24 * (if (f24 in v45) then v45[f24] else f24) := v39 <= v39];
					v39 := seq(0x297, i7  => (v42));
				case DC19(cf30) =>
					globalState.f2 := f31;
					f31 := f31;
					var v46 := "ea";
					globalState.f17, globalState.f17, globalState.f17, r0 := v46, if (f31) then seq(0xb4, i8  => ('p')) else "hdlwah", v46, -216 == f24;
					var v47 := DC24(f24);
					var v48 := 'f';
			...
			if (v55 < [f24, f24, -f24, f24, f24]) {
				...
				v64 := v64;
				var v65: multiset<int> := multiset{f24, f24, |(seq(0x2ac, i9  => (f24)))|, f24, fm0(f24, f24, globalState)};
				...
				v67 := v67;
				globalState.f17, globalState.f18 := v54, (f24 - |"ljamq"|) - (f24 / f24);
				var v68 := new C0(f31);
				f31 := v68.f34 <== true;
			}
			...
			if (f31) {
				...
				var v75: T0 := new C1(([v74])[|v55| := multiset{|(seq(0x3cd, i11  => ('o')))|}], f24, f24, f25);
				...
				v78[674] := if (f31) then v79[|v80|] else v75;
				var v81: map<int, T0> := map[---0x4f := v75];
				v78[674] := if (f31) then if (f24 in v81) then v81[f24] else v75 else if (!f31) then v75 else v75;
				globalState.f2 := !!!f31;
		...
		v87[812] := v88;
		var v89 := "pe";
		globalState.f9, globalState.f14, v87[812], globalState.f17, globalState.f9 := f24, f24, v88, v89, (f24 / f24) / (f24 % |v89|);
		for i13 := f24 to f24 {
			var v90: seq<bool> := [f31, f31, f31, f31];
			var v91: map<bool, bool> := map[f31 := fm9(fm2(i13, 0x3c8, v87[812], globalState), |v90|, i13, globalState)];
			v91 := v91[f31 := f31];
			if ((f24 / i13) == |fm18(globalState)|) {
				var v92: array<int> := new int[1];
				v92[285] := -i13;
				v92[333] := f24;
				v92[285], v92[333] := f24, f24 % 225;
				...
				var v95: set<int> := {v92[285], i13, |v89|};
				v94[807] := DC16(v95);
				var v96 := DC5(f31, f31, f31);
				var v97 := DC21(v96, fm31(f31, f31, globalState), v93);
				v93, v94[807] := if (f31) then v93 else v97.cf34, DC16(v95);
				var v98: array<array<int>> := new array<int>[2];
				v98[286] := if (f31) then v92 else v92;
				var v99 := DC0(v92);
				v98[286] := v99.cf0;
				globalState.f9 := i13 * (f24 - v92[285]);
			} else {
				...
				var v105 := new C1(v101 + v101, i13, i13 % (if (f31 in v102) then v102[f31] else |v103|), if (true) then [v104, v104, v104] else [v104]);
				globalState.f2 := f31;
				v102 := v102;
				var v106: set<int> := {i13};
				globalState.f1 := v105.f33 / (-i13 % |v106|);
				globalState.f18 := f24;
			}
			...
			if (f24 != i13) {
				...
				v109[737] := (if (v107.f34) then v110 + v110 else if (!v107.f34) then v110 else [[v107.f34], if (0x172 in v111) then v111[0x172] else v90, v90, v90])[-|"q"| := v90];
				v90 := v90;
			} else {
				var v112: multiset<char> := multiset{v87[812], v88};
				...
				globalState.f1 := if (f31) then i13 else v119 / 0x3be;
			...
			var v125: map<char, multiset<bool>> := map[v87[812] := v120[!f31 := |v124|] + v120];
			v125 := v125[v88 := v120];
		}
		...
		match (DC19(v126)) {
			case DC17(cf28) =>
				...
				v127[409] := if (f31) then if (v128 in v131) then v131[v128] else f24 else |map[f24 := f31]|;
				if (fm9(true, 726, f24, globalState)) {
					v87[812] := v87[812];
					var v132: multiset<string> := multiset{seq(0x362, i16  => (v87[812])), if (f31) then seq(0x3bb, i17  => (v88)) else v89[v127[409] := 'o'], "hqys"};
					v89, v127[409], v132 := v89, -(v127[409] % f24), v132;
					var v133: seq<bool> := [cf28];
					globalState.f1, globalState.f20 := v127[409], v133 + v133;
					f31 := v127[409] <= f24;
					var v134: seq<array<int>> := [v127, v127];
					var v135 := DC4(cf28, f31, v88, -v127[409], f24);
					var v136: array<array<int>> := new array<int>[17] [v127, v127, v127, v127, v127, v127, v127, v127, v127, v127, v127, v127, v127, v127, v134[v135.cf12], v134[f24], v127];
					v136[163] := v127;
					v136[163] := v127;
				} else {
					...
					v141 := (v141 + v141) + v141;
					var v142: map<multiset<int>, char> := map[v137[f24 := f24] := v88];
					var v144: multiset<char> := multiset{v87[812]};
					v142 := v142[multiset{|(map v143 : char | v143 in v144 :: (v143) := (map[f31 := v127[409]]))|} := v87[812]];
					var v145 := new C0(f31);
					var v146 := new C1(seq(0x11e, i18  => (v137)), |multiset{v127[409]}|, f24, seq(367, i19  => (map[v88 := -0x312])));
				}
				
				globalState.f14 := -0x2d % (v127[409] + 519);
				var v147: seq<bool> := [false, cf28, cf28, !cf28, cf28];
				if ((cf28 in v147) in v147) {
					v87[812] := v88;
					var v148: map<char, bool> := map[v88 := f31];
					v148 := v148[v87[812] := v147 != v147];
					r0 := !(f31 <==> (if (f31) then true else cf28));
					globalState.f2 := v89 != (v89 + "bxrlmgp");
					globalState.f1 := |v89|;
				} else {
					var v149: map<bool, char> := map[f31 := v87[812]];
					var v150: set<char> := {if (cf28 in v149) then v149[cf28] else v88};
					var v151 := DC11(v127[409], cf28, fm2(|v150|, f24, fm3(globalState), globalState));
					globalState.f2 := v151.cf19;
					globalState.f18 := v127[409] - f24;
					cf28 := !((fm0(v127[409], v127[409], globalState) - f24) >= (f24 % v127[409]));
					var v152: multiset<int> := multiset{f24, v127[409], f24};
					var v153: T0 := new C1([v152, v152[|v152| := |v147|], v152[v127[409] := f24], v152, v152], |v89|, f24, f25);
					v153, globalState.f2, r0, globalState.f17, v127[409] := v153, |map[v127 := v153.f24]| >= |v152|, f31, v89, v127[409] % -v153.f24;
					v127[409] := v127[409];
				}
			...
			case DC18(cf29) =>
				...
				globalState.f18, globalState.f14, v155[152], v156 := f24, v157[f24], cf29, v156 + v156;
				globalState.f14 := f24;
			case DC16(cf27) =>
				...
				var v163: array<map<D1, bool>> := new map<D1, bool>[12] [map[v160 := f31], v161, v161 + v161, map[v160 := f31] + v161, v161 + v161, v161, v161, v161, map v162 : D1 | v162 in v161 :: (v162) := (f31), v161 + v161, v161 + map[v160 := f31], v161 + map[v160 := fm2(v159, v159, v87[812], globalState)]];
				v163[469] := map[v160 := f31] + v161;
				var v164: multiset<bool> := multiset{f31, f31};
				var v165: seq<bool> := [f31];
				var v166 := DC13(v159, v158, "libuqyvxh");
				v163[469] := fm32(f24, [v164, v164, v164, v164], v165, v89[v166.cf22 := v88], globalState);
				globalState.f18 := fm0(f24, v159, globalState);
				var v167: array<map<bool, bool>> := new map<bool, bool>[9];
				var v168: array<string> := new string[5] [v89 + v89, if (f31) then v89 else fm4(f31, v159, v87[812], f31, globalState), v89, v89, v89];
				var v169: map<int, bool> := map[f24 := f31];
				var v170: seq<int> := [v159];
				globalState.f18, v167, r0, globalState.f14, v168 := -((f24 * (if (fm2(fm0(f24, v159, globalState), f24, v88, globalState) in v164) then v164[fm2(fm0(f24, v159, globalState), f24, v88, globalState)] else v159)) + (v159 * v159)), if (false) then v167 else v167, fm16(globalState) == (v169 + v169), v170[v159] * |map[v159 := f31]|, v168;
			case DC19(cf30) =>
				var v171 := DC6();
				v171 := v171;
				var v172 := DC17(f31);
			...
			decreases 100 - i22
		{
			...
			if (f31) {
				...
				v175[849] := |(v176 + (map[v175 := f31])[v175 := f31])|;
				var v177: multiset<int> := multiset{f24};
				var v178: map<int, bool> := map[fm0(|"rfeykmiww"|, f24, globalState) := f31];
				v175[849] := if (f31) then if (f24 in v177) then v177[f24] else f24 else |v178|;
				globalState.f9 := v175[849];
				globalState.f2 := v175[849] > (519 + -v175[849]);
				var v179: map<array<int>, int> := map[v175 := f24];
				var v180: seq<array<int>> := [v175];
				var v181: set<bool> := {f31};
				v179 := v179[v180[fm0(fm0(|v181|, v175[849], globalState), f24, globalState)] := f24];
				var v182: set<int> := {f24};
				var v183: map<bool, int> := map[f31 := |v182|];
				globalState.f2 := fm9(f31, fm0(|v183|, v175[849], globalState), f24, globalState);
			} else {
			...
			if (f24 > f24) {
				...
				v190 := if (f24 in v192) then v192[f24] else if (fm2(f24, f24, v87[812], globalState)) then v194[|v195|] else v190;
...
class C3 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := f24 to |v2| {
			...
			if ((v5 + v5) in v7[f24]) {
				...
				globalState.f18 := i0;
				v4[917] := true;
				v4[917] := v0 < (v0[|"apcb"| := v1] + (seq(426, i2  => ('n'))));
				var v12: multiset<bool> := multiset{!v11.f34, v4[917], v11.f34};
				var v13: set<string> := {seq(0x2c7, i3  => (v1))};
				...
				v14 := v14[v0 := v3];
				var v15: set<bool> := {v3};
				var v16 := DC2(i0 > |v15|, |(seq(-0x24d, i4  => (i0)))|, 'g');
				v16 := v16;
				var v18: array<set<int>> := new set<int>[9](i5 => set v17 : int | (0x123 <= v17) && (v17 < -29) :: (v17 % f24));
		...
		for i6 := |v0| to f24 {
			...
			v22 := v22[f24 != i6 := v21];
			v0 := v0 + (if (v21) then seq(0x1e1, i7  => (v1)) else v0);
			globalState.f2 := v21;
		}
		...
		match (fm33(v24, -f24, globalState)) {
			case DC10() =>
				...
				var v39: array<int> := new int[20] [|v31|, f24 * v23, -f24 / f24, -(f24 * v23), f24, v23, |(v32 + v32)|, |v33|, |"hwuajdbrj"| % f24, |v38|, DC4(v24, v24, v1, f24, fm8(globalState)).cf12, v36.f33, f24, f24, f24 - v36.f33, |v33|, f24, v26[v23], |"hhs"| + -v23, f24];
				...
				v42 := if ((seq(-401, i8  => (v1))) in v43) then v43[seq(-401, i8  => (v1))] else v42;
			...
			case DC9(cf17) =>
				...
				var v55: array<bool> := new bool[28] [v24, v24, v24, v24, v24, v24, v24, v24, f24 == f24, v24, multiset{v24, v24} !! v25[false := v51.f33], v24, v24, v24, v24, v51.f33 != v51.f33, v24, !v24, cf17[v23], v24, v24, if (v24) then v24 else v24, !v24, v24, v24, v24, v24, v24];
				v55 := v55;
		...
		var v61: map<D4, string> := map[v60 := seq(0x1f0, i9  => (v1))];
	...
	method m5(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
			...
			decreases 100 - i0
		{
			...
			match (v5) {
				case DC24(cf37) =>
					...
					var v13: array<int> := new int[27] [cf37, -(v6.(cf3 := v0[f24])).cf1, cf37, cf37, cf37, -f24, f24, f24, cf37, |v12|, cf37, cf37, cf37, cf37, |v3|, f24, f24, 0x255, f24, f24, f24, cf37, -0x1fa, f24, f24, cf37, f24];
					...
					v14, v13[329], globalState.f17, r1, v13[583] := (v14 + [v13]) + v14, f24 - |v17|, ((fm4(p0, |(v19 + v19)|, v2, p0, globalState))[v7[f24] := v2])[|v3| := v2], v18.f34 ==> p0, v7[|{|v20|, f24, f24, |v21|}|] % |v22|;
					v13[329] := v16.f24;
				...
				case DC25(cf38, cf39, cf40) =>
					...
					var v24: map<bool, int> := map[cf39 := |([cf40, cf40, !!p0])[cf38 := if (f24 in v23) then v23[f24] else cf40]|];
					var v25: map<int, int> := map[cf38 := 0x2a7];
					v24 := v24[cf39 && p0 := f24 / |v25|];
					globalState.f1 := cf38 / (cf38 / f24);
				...
				case DC26(cf41, cf42) =>
					...
					v35, v36[800], v38 := v35, true ==> p0, v38;
				...
				case DC23(cf36) =>
					...
					v41[436] := if (!p0) then v40 else v40;
					...
					v41[436], globalState.f17, v42[981], v44, v45[89] := v46[f24], v3 + v3, |(multiset{p0})[p0 := f24]| < f24, fm34(p0, globalState) + v44, v3 + v3;
					var v47: set<int> := {f24};
					var v48: set<int> := {|map[f24 := |v47|]|};
					var v49: map<set<int>, int> := map[if (p0) then v47 else v47 := 0x335];
					v49, globalState.f9 := v49, f24;
					v42[981] := v42[981];
					var v50: map<bool, bool> := map[v42[981] := v42[981]];
					var v51: multiset<map<bool, bool>> := multiset{v50};
					var v52: multiset<int> := multiset{fm0(fm0(|v51|, f24, globalState), |fm17(0x9d, -0x265, f24, v42[981], globalState)|, globalState)};
					var v53: map<char, int> := map[v2 := f24];
					var v54: map<bool, seq<map<char, int>>> := map[v42[981] := f25];
					var v55 := new C1([v52], f24, f24 / f24, if (p0) then [v53] else if (p0 in v54) then v54[p0] else f25);
			}
		...
		v59[473], v60, v61[247], globalState.f9, v62 := v63, v60, -f24 >= f24, |(multiset{f24} * (v64 * v64))|, v62;
		var v65: map<int, map<int, int>> := map[f24 := fm15(f24, p0, f24, v61[247], globalState)];
		v65 := v65;
		if (!(v61[247] <==> v61[247])) {
			var v66 := DC11(f24 - |"c"|, p0, true);
			var v67 := "fidp";
			v61, v66, globalState.f17 := v61, v66, (seq(0x3e5, i4  => (v62))) + v67;
			v61[247] := p0 <== (v61[247] ==> !p0);
			globalState.f2 := v61[247];
			var v68: seq<int> := [f24];
			...
			var v72 := DC22(v71);
			v72 := v72;
			var v73: map<int, bool> := map[f24 := v61[247]];
			var v74: map<bool, int> := map[!p0 := |v67|];
			var v75 := DC13(f24, v74, v67);
			var v76: set<int> := {0x35e};
			var v77: multiset<bool> := multiset{p0, p0, v61[247]};
			v61[247], globalState.f14, globalState.f9, r0, globalState.f1 := v61[247] && !(|v73| <= f24), v75.cf22, -fm0(|v76|, if (v61[247] in v77) then v77[v61[247]] else f24, globalState), v61[247], f24 - (f24 + f24);
		} else {
			globalState.f2 := (if (p0) then p0 else v61[247]) && (if (p0) then p0 else fm2(|v0|, f24, 'w', globalState));
			var v78 := "omqcl";
			if (if (!v61[247]) then p0 else v78 < v78) {
				globalState.f1, globalState.f2 := |(v78 + "sqal")| + f24, p0;
				var v79: map<int, bool> := map[0x22 := !true];
				var v80: set<int> := {|v79| / f24};
				v80 := v80;
				var v81: array<array<int>> := new array<int>[21];
				var v82: map<map<bool, bool>, bool> := map[v63 := v61[247]];
				v81, globalState.f1 := v81, -(if (!(f24 != -f24)) then |(seq(0x126, i5  => (map[v61[247] := f24])))| else |(v82 + v82)|);
				var v83: map<int, array<bool>> := map[f24 := v61];
				v83 := v83[|"nnv"| := v61];
				v61[247] := v0[f24 / f24];
			} else {
				var v84: map<bool, int> := map[v61[247] := f24];
				v84 := v84;
				globalState.f18 := f24;
				var v85: array<int> := new int[5];
				v85[833] := if (v61[247]) then -f24 else f24;
				v85[833] := f24;
				globalState.f2 := p0;
				globalState.f14 := v85[833];
			}
			
			globalState.f9 := -(f24 / f24) / f24;
			if (p0) {
				var v86: map<char, bool> := map[v62 := p0];
				v61[247] := !(if (v62 in v86) then v86[v62] else p0);
				globalState.f9 := f24;
				var v87: array<seq<bool>> := new seq<bool>[16](i6 => v0);
				v87[750] := v0;
				v87[750] := v0[f24 := false];
				var v88: map<seq<bool>, array<bool>> := map[[v61[247], v61[247]] := v61];
				v88 := v88;
				globalState.f9 := f24;
			} else {
				...
				r1 := p0;
				var v90: map<int, bool> := map[f24 / fm8(globalState) := if (p0 in v63) then v63[p0] else p0];
				v90 := v90[f24 := v61[247]];
				var v91 := new C2(p0, f24 % f24, f25);
				var v92: map<char, bool> := map[v62 := !true];
				r0 := if (v62 in v92) then v92[v62] else f24 > 0x7b;
			}
			
			var v93: set<bool> := {v61[247], v61[247]};
			var v94 := DC1(|v93|, f24, v61[247]);
			...
			decreases 100 - i7
		{
			...
			v96 := v96;
			var v97: map<int, bool> := map[f24 := v61[247]];
			v97 := v97;
			var v98: multiset<bool> := multiset{v61[247]};
			r1 := v98 > multiset(v0);
		}
		var v99 := "lq";
	...
	method m6(globalState: GlobalState) {
		...
		var v6: array<bool> := new bool[12] [v1, v1, v1, v1, !v1, v5[f24], v1, v1, v1, v1, v1, v1];
		...
		match (v7.(cf33 := DC19(DC18(fm2(f24, f24, v8, globalState))))) {
			case DC21(cf32, cf33, cf34) =>
				...
				var v11 := DC18(v1);
				var v12: seq<string> := [seq(0x123, i0  => (v8))];
				var v13: multiset<bool> := multiset{v1};
				globalState.f18, v10, globalState.f20, v11, globalState.f18 := |v12[f24 := v9]|, v10, v5, v11.(cf29 := true), fm0(f24 - |v13[v1 := f24]|, 600, globalState);
			...
			case DC20(cf31) =>
				...
				v19[428] := f24 - |v20|;
				var v21 := "gsj";
				globalState.f17, v19[428] := v21, f24;
				v1 := v1;
				globalState.f2 := v1;
				globalState.f9 := v19[428] + v19[428];
			case DC22(cf35) =>
				var v22: map<char, int> := map[v8 := f24];
				var v23 := new C2(v1, -718, ([v22])[f24 := v22]);
				var v24: seq<int> := [f24];
				var v25 := "qe";
				var v27: map<int, int> := map[f24 := |[f24]|];
				var v28: multiset<int> := multiset{f24};
				var v29: array<int> := new int[13] [f24, f24, v24[|v25|], |(map v26 : int | v26 in v27 :: (v26 * |v5|) := (-0x16e))|, f24, f24, f24, f24, 0x1ef, f24, 0x1e8, f24, |v28|];
			...
			decreases 100 - i2
		{
			...
			if (v45) {
				...
				var v54: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[29] [if (v45) then v51 else v51, v51, v51, v51, v51, v51, v51, fm36(v5, globalState) + (seq(0xd6, i3  => (v47))), v51, v51, v51, v52[-f24], v51, v51, v51 + [v47], if (v48.f31 in v53) then v53[v48.f31] else [v47], seq(0x4a, i4  => (v47[v1 := v48.f31])), v51, v51 + v51, v51 + fm36([v1, v1], globalState), v51 + (v51[0x71 := v47])[v46 := v47], seq(0x5, i5  => (v47)), v51 + v51, v51, v51, v51, [v47, v47, v47], [v47], v51 + (seq(0xb8, i6  => (v47[v48.f31 := v48.f31])))];
				v54[151] := v51;
				v54[151] := fm36(fm23(globalState), globalState);
				globalState.f14 := f24;
				var v55 := DC3(v34);
				...
				var v60 := new C1((seq(0x2b6, i7  => (v43))) + v59, f24, f24 * f24, f25);
...
class C4 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool) {
		...
		var v14: array<map<int, int>> := new map<int, int>[13] [map v0 : int | v0 in v1 :: (v0 % f24) := (0x62), map[|map[v2 := v2]| := f24], (((map[f24 := -f24])[f24 := f24])[f24 := 698])[|v3| := v7.cf5], fm6(f24, f24, fm0(f24, f24, globalState), f24, globalState), v9, v9, v9, if (f24 in v10) then v10[f24] else v9, v9, v9, map[f24 := f24] + (map v11 : int | v11 in (fm7(globalState))[f24 := f24] :: (v11 - f24) := (|multiset{map[|v8| := v2]}|)), v9 + v9, v9[|v13| := -f24]];
		...
		for i1 := f24 to f24 + |v15| {
			...
			v16 := v16;
			globalState.f14 := |v8[f24 := v6]| - (f24 % f24);
			var v17: seq<int> := [|v8|, i1, i1];
			var v18 := DC4(f24 <= i1, v2, v6, |([fm2(i1, |v8|, v6, globalState)] + v3)|, v17[|v8[|v17| := v6]|]);
			v18 := v18;
			f28[864] := 0x15e - i1;
			f28[864], globalState.f2 := -|(v8 + v8)[-f24 := v6]|, v2;
		}
		var v19: multiset<char> := multiset{v6, v6};
		var v21: set<char> := {v6, v6, v6};
		for i3 := |((set v20 : char | v20 in v19 :: (v20)) * v21)| to f24 {
			if (v2) {
				v12[302] := (v7.(cf5 := i3)).cf4;
				v12[302] := fm2(-(i3 + |v9|), i3, v6, globalState);
				var v22: seq<int> := [|v8|];
			...
			v12[437], v19, v38, globalState.f2 := ("xho" + v8) < (seq(0x30f, i4  => (v6))), v19, [v8, v8], v2;
			v4 := v4[!v12[437] := i3];
			var v39: seq<array<int>> := [f28, f28, f28];
			globalState.f17, v39, v15, v12[437], globalState.f2 := v8, v39[f24 := f28], v15, v2, v12[437] ==> v2;
		}
		var i5 := 0;
		while (f24 == f24)
			decreases 100 - i5
		{
			...
			if (!(v40 <= fm38(globalState))) {
				f28[211] := |v15|;
				f28[211], globalState.f14 := (f24 + f24) + fm0(f24, f24, globalState), f24;
				globalState.f17 := (seq(0xf4, i6  => (v6))) + v8;
				r0 := v2;
				globalState.f17, f28[211], f28[211] := "f", -(0x151 % -f24), |v19|;
				var v41: array<T0> := new T0[28];
				var v42: T0 := new C2(v2, f28[211], f25);
				var v43: map<bool, T0> := map[v3[f28[211]] := v42];
				v41[134] := if (v2 in v43) then v43[v2] else v42;
				var v44: map<map<int, int>, T0> := map[v9 := v42];
				v41[134] := if ((v9 + v9) in v44) then v44[v9 + v9] else v42;
			} else {
				var v45: array<array<string>> := new array<string>[28];
				var v46: map<int, bool> := map[f24 := v2];
				var v47 := DC3(fm4(false, f24, v6, v2, globalState));
				var v48 := DC26(v47, "b");
				var v49: array<string> := new string[19] [v8, v8, v8, "an", seq(671, i7  => (DC4(v2, v2, v6, f24, |[|v8|]|).cf10)), seq(0xbb, i8  => (v6)), (seq(-0x31d, i9  => (v6)))[|v46| := v6], "kncwpm", v8, "mpjutg", v8, "wx", v8, v8, seq(0x38f, i10  => (v6)), v8, v8, v8, v48.cf42];
				var v50 := DC28(v49);
				v45[552] := v50.cf44;
				var v51: map<bool, array<string>> := map[v2 := v49];
				v45[552] := if ((f24 < -f24) in v51) then v51[f24 < -f24] else v49;
				v4 := v4;
				var v52: array<set<int>> := new set<int>[26];
				var v53: map<char, int> := map[v6 := f24];
				var v54 := new C3(v52, if (v2) then v14 else v14, DC25(f24, v2, v2).cf38 / f24, (f25 + f25)[f24 := v53]);
				var v56 := DC4(v2, v2, v6, f24, |(map v55 : int | (0x310 <= v55) && (v55 < 0x325) :: (v55 + f24) := (v6))|);
				r0 := v56.cf12 >= f24;
				globalState.f2 := !fm2(f24 * |(seq(0x7d, i11  => (-|[v2]|)))[f24 := f24]|, -970, v6, globalState);
			}
			
			globalState.f2 := false;
			var v57: array<set<int>> := new set<int>[5];
			var v58: map<char, int> := map[v6 := f24];
			var v59 := new C3(v57, v14, f24 % f24, [map[v6 := f24], v58]);
			var v60: map<array<bool>, bool> := map[v12 := false];
			var v61 := new C2(if (v12 in v60) then v60[v12] else !!v2, f24, f25[f24 := v58]);
		}
		var i12 := 0;
		while (v2)
			decreases 100 - i12
		{
			...
			if (v2) {
				...
				var v67: seq<int> := [f24];
				var v68: seq<int> := [v67[f24]];
				globalState.f2 := if (v2) then !(v68 < (seq(0x12c, i13  => (0x2cd)))) else v62.f31;
				globalState.f17 := v8;
				...
				f28[42] := f24;
				globalState.f2, globalState.f2, globalState.f2, f28[42], globalState.f9 := v62.f31, false, v62.f31, f24, f24;
				f28[42] := f28[42];
				globalState.f9 := f28[42];
			}
		...
		for i15 := |fm39(f24, v2, globalState)| to |v78| {
			...
			v79[580] := fm28(v2, -i15, true, -i15, globalState) * v80;
			v79[580] := v80 + (v80 - {v2});
			if (i15 != f24) {
				...
				v81[796] := v82[-0xe6 := v8];
				globalState.f9 := i15;
				var v84: multiset<bool> := multiset{(set v83 : int | (0x2cf <= v83) && (v83 < -613) :: (v83 % f24)) == v15, v2, v2 <==> v2, v2 ==> v2};
				var v85: C2 := new C2(!v2, i15 / i15, f25[i15 := map[v6 := f24]]);
				...
				f28[768], v6, v85.f31, globalState.f2 := f28[768], v6, multiset{v9, v86.cf47, v9} > multiset{v9}, if (v8 in v87) then v87[v8] else !v2;
			} else {
				var v88: map<int, array<bool>> := map[i15 := v12];
				globalState.f2, globalState.f17, v88 := v2, v8 + v8, v88;
				v12[351] := v3[i15];
				v12[351] := i15 == |v4[v2 := f24]|;
				var v89: array<bool> := new bool[28](i17 => v2 <== v12[351]);
				v89 := v89;
				var v90 := DC25(i15, v2, v12[351]);
				var v91: multiset<string> := multiset{v8[f24 := 'a'], fm4(v12[351], i15, v6, v90.cf40, globalState), "vhh", v8 + v8, v8};
				var v92: seq<multiset<string>> := [v91, if (v12[351]) then multiset{v8, v8} else v91, multiset{v8, v8, "lqkivho"}, v91[v8 := i15] * v91];
				v91 := v92[f24];
				v8 := v8 + v8;
			}
		...
		var v94: C1 := new C1(v93, f24, f24, seq(0x20e, i18  => (map[v6 := f24])));
	...
	method m4(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: seq<int>, r3: bool) {
		...
		var v6 := DC32(v5);
		var v7: set<bool> := {p0};
		var v8: array<int> := new int[16] [|(v1 + v1)|, f24, f24, f24, f24, f24, f24, if (p0 in v2) then v2[p0] else |v4|, if (p1) then -f24 else f24, f24, f24 - |[p1]|, |v6.cf53| / f24, |(v7 * v7)|, f24, f24, f24];
		forall i0 | 0 <= i0 < v8.Length {
			v8[i0] := i0 * (f24 % -|"spivrnx"|);
		}
		var v9 := new C0(true);
		for i1 := -|{p1}| to -f24 {
			if (v9.f34) {
				...
				var v13: array<bool> := new bool[27] [p1, v9.f34, v9.f34, p1, v9.f34, v9.f34, fm2(111, i1, v3, globalState), v9.f34, if (p1 in v11) then v11[p1] else p0, p1, v9.f34, p0, p0, false, v9.f34, true, false, p1, p0, !true, v9.f34, v9.f34, v9.f34, v12[|map[v9.f34 := v9.f34]|], v9.f34, v9.f34, DC17(p0).cf28];
				...
				globalState.f18 := f24;
				f28[694] := fm0(-fm0(f24, 0x23c, globalState), f24, globalState);
				var v16: array<D4> := new D4[27];
				var v17: map<array<D4>, bool> := map[v16 := v9.f34];
				f28[694] := (if (p0) then i1 else -0x3e2) - |v17|;
				...
				var v22: T0 := new C3(v19, v20, --0x184 % f28[694], (f25 + f25[i1 := v21])[f24 := v21[v3 := f28[694]]]);
				v22 := v22;
			}
			
			var v23 := "epg";
			var v24: map<int, bool> := map[f24 % |v23| := true];
		...
		v8[153] := f24 % -|v27|;
		var v28: seq<int> := [-|v27|];
		v8[153] := fm0(f24, f24, globalState) * v28[f24];
		var v29: map<char, bool> := map[v3 := false];
		v8[153] := fm0(|v29| * f24, |(seq(0x94, i3  => (v3)))|, globalState);
		var v30: array<seq<bool>> := new seq<bool>[26];
		var v31: seq<bool> := [p0];
		v30[571] := if (v9.f34) then v31 else v31;
		v30[571] := v31 + v31;
		r0 := v8[153];
		r1 := f24;
		var v32: seq<seq<int>> := [v28, v28];
		var v33 := DC12([v8[153], v8[153], f24, f24]);
		var v34: seq<seq<int>> := [v28, v32[f24], v33.cf21, v28 + v28];
		r2 := v32[f24];
		r3 := p0;
	}
}
	...
	method m1(globalState: GlobalState) returns (r0: bool) {
		for i0 := f27 % f27 to f27 {
			...
			if (fm2(f27 + -0x2a4, f24, fm3(globalState), globalState)) {
				...
				var v6: seq<T0> := [v4, v4];
				v2[828] := if (v5 !! v5) then v6 + v6 else v6;
				...
				var v10 := "iccnie";
				var v11: seq<int> := [|v10|];
				var v12: multiset<int> := multiset{if (v4.f24 in v9) then v9[v4.f24] else v4.f24, v11[f24]};
				var v13 := m0(-(i0 / |v12|), i0 / fm0(-|v10|, i0, globalState), globalState);
				v0[568] := v1;
			} else {
				globalState.f9 := f27;
				var v14 := true;
				...
				v23 := v23[v22 := |(if (v15.f34) then {v22} else {v22, v22})|];
			}
			
			globalState.f1 := 0x37b % f27;
			var v24 := false;
			if (v24) {
				v24 := v24;
				...
				var v29 := new C4(v26, v26[878], (f25 + f25)[-0x1a7 := v28]);
				globalState.f9 := f24;
			} else {
				...
				v32 := v32;
				globalState.f2, globalState.f18, globalState.f2 := v24, f27 % i0, if (v24) then false else false;
				var v33: seq<bool> := [v24];
				var v34: multiset<int> := multiset{|v33|, f24, i0, v32.f24 * f24, 0x234 + f27};
				v34 := v34;
				globalState.f17 := "tbquywj";
				var v35: C4 := new C4(v31, v32.f24, seq(0x1ce, i3  => (map['u' := f24])));
		...
		match (v40) {
			case DC33(cf54, cf55) =>
				...
				v43[655] := f27;
				var v44: map<bool, int> := map[cf55 := |(seq(114, i4  => ('m')))|];
				v43[655] := |v44| + (f24 % f27);
				f27 := -|(seq(0x265, i5  => (f24)))|;
			case DC32(cf53) =>
				var v45: seq<bool> := [true, v37];
				var v46: set<seq<bool>> := {v45};
				r0 := v46 > v46;
				var v47: seq<multiset<int>> := [multiset(v38)];
				var v48 := new C1(v47, f27, f27, seq(-0x1f6, i6  => (map['x' := f24])));
				var v49 := 'w';
				...
				var v55: array<bool> := new bool[16] [!true, v37, v37, fm2(v48.f33, v48.f33, v49, globalState), v37, {v48.f33, v48.f33} !! (set v50 : int | (794 <= v50) && (v50 < -319) :: (v50 / f24)), true, true, v52.cf57 !! v51, v51[|v53| := v48.f33] <= v51, v48.f33 != f27, v54 !! v54, !fm2(|v54|, f27, v49, globalState), v37, v45[-f27], v37];
				v55[205] := f27 <= f24;
				v55[205] := v37;
				var v56: map<char, bool> := map[v49 := v37];
				globalState.f14, r0, globalState.f2, v48.f33, v55[205] := f27 / (v48.f33 / 0x21d), true && (if (v55[205]) then v37 else v37), v56 != v56, -fm0(f24 / |v38|, f27, globalState), v37;
			case DC34(cf56) =>
				...
				v57[383], globalState.f2, globalState.f20 := ((seq(0x4, i7  => ('f'))) + v58) == v58, if (v59 in v61) then v61[v59] else v37, v62;
				v57[383] := v57[383];
				var v63: multiset<bool> := multiset{v37};
				var v64: map<array<bool>, int> := map[v57 := |"ekhhngqe"|];
				var v65: seq<array<bool>> := [v57, v57, v57, v57, v57];
				var v66: array<int> := new int[24] [-0x1c5 / f27, -f27, fm0(-|v63|, |v58|, globalState), f27, 685, |v64|, |v58| + f27, f27, |v38| * f24, f27, f27, f27 / -0x1, f27, |(v58 + v58)|, f27, f27, |v65[|v62| := v57]|, f27, f24, f27, |v58|, 0x190, -(|v38| - f24), if (v37) then 0x296 else fm0(-0x248, f24, globalState)];
		...
		var v71: C1 := new C1([multiset{|v69|}, v70], f24, f27, seq(0x17e, i8  => (map['y' := f27])));
		...
		var v82: map<int, array<int>> := map[|v68| % 0x1cd := v81];
		var v83: array<string> := new string[21];
		v83[203] := seq(0x3df, i9  => ('v'));
		globalState.f2, v37, v82, r0, v83[203] := false, if (v37 in f26) then f26[v37] else v69 < v69, v82[|v69| := v73], v37, v80;
		v73 := v81;
		...
		var v90 := DC20(v89);
		var v91: map<D7, string> := map[v90 := v83[203]];
		v91 := v91[v90 := "aohh"];
		var v92: array<C4> := new C4[5];
		var v93: C4 := new C4(v81, v77.f24, f25);
		var v94: seq<C4> := [v93];
		var v95: map<bool, seq<bool>> := map[v37 := v69];
		v92[655] := v94[|(if (v37 in v95) then v95[v37] else v69)|];
		v92[655] := v94[f24 * 0x1ec];
	...
	method m2(globalState: GlobalState) returns (r0: bool) {
		...
		if (!v0) {
			...
			if (v2.cf22 == f27) {
				...
				var v12: multiset<bool> := multiset{v3[372]};
				...
				var v18 := new C3(v15[|v16|], v17, f24, v9.f25);
			} else {
				...
				var v27 := 'n';
				globalState.f14, v25, globalState.f18 := -(v22.f24 / v22.f24), {(v26.(cf3 := v0, cf1 := f27)).cf3, fm2(f27, fm0(-0x18d, -v22.f24, globalState), v27, globalState)}, f24;
				...
				v33[644] := v35 >= (v35 * (if (v36 in v37) then v37[v36] else multiset([f24])));
			}
			
			globalState.f18 := f24 / 798;
			var v38 := 'j';
			var v39 := "dhvqnlf";
			...
			if (fm2(f24, f24, v40, globalState)) {
				...
				var v45: T0 := new C4(v44[f24], 0xbf, seq(181, i1  => (map['c' := f27])));
				var v46: seq<bool> := [v0, v0, v0];
				var v47: map<seq<int>, T0> := map[seq(0x3cc, i2  => (DC25(v45.f24, v0, v0).cf38)) := v45];
				...
				v68[96] := v40;
				v68[96] := v40;
				var v69: map<seq<int>, int> := map[[|v57|] := -(-|map[false := false]| / |v55|)];
				var v70: seq<int> := [f27];
			...
			var v75: array<set<int>> := new set<int>[14] [v72 - v72, v72, {f27, f24, f24}, {f27, f27} + v72, v72, v72, v72, v72, v72, v72, {f27, f27, f24, |v73|}, set v74 : int | (234 <= v74) && (v74 < -0x1a0) :: (v74 % f24), v72, {f24, f24}];
			v75 := v75;
		...
		m3(-(f24 / f24), globalState);
		var v80: multiset<int> := multiset{f27};
		if (v80 < v80) {
			var v81: seq<bool> := [v0];
			if (if (v0) then v0 <== v0 else v81[-0x249]) {
				globalState.f18 := f27;
				...
				v87[573] := !(v89 != map[v0 := f27]);
				var v90: map<string, int> := map[v85 := 327];
				v87[573], v90 := v0, map[v85 := fm0(f27, f27, globalState)] + (map[v85 := f24] + (map v91 : string | v91 in (seq(422, i4  => (v85))) :: (v91) := (f27)));
				globalState.f9 := f24;
				var v92: array<map<bool, int>> := new map<bool, int>[3];
				var v93: multiset<bool> := multiset{v87[573]};
				var v94: seq<int> := [|v89|];
				var v95 := DC11(f27, v81[|v94|], true);
				v80, globalState.f9, v87[573], v92 := v80 + v80, f27, if (v87[573]) then |v93| < f27 else v95.cf20, if (!v87[573]) then v92 else v92;
			}
			...
			if (v99[v0 := |v101|] >= multiset{!v0, false}) {
				r0 := v80 !! v80;
				var v102: set<int> := {f24};
				var v103: map<set<int>, int> := map[v102 := f24];
				v103 := v103[fm18(globalState) := |v81| % f27];
				v98[211][777] := !v0;
				v98[211][777] := fm0(f24, f24, globalState) <= f27;
				globalState.f2 := v0;
				...
				var v111: map<C1, bool> := map[v110 := v98[211][777]];
				...
				var v116: array<set<multiset<int>>> := new set<multiset<int>>[27] [v106, v106, v106 - v106, v106, v106, v106 - v106, v107[|v104|] - v106, v106, v106, if (v0) then v106 else v106, v106, v106 * fm41(f24, fm4(v0, f24, v100, !v0, globalState), !!false, globalState), set v108 : multiset<int> | v108 in v106 :: (v108), v107[|v112|] - (if (-v110.f33 in v113) then v113[-v110.f33] else v106), if (!v0) then {v80} else set v115 : multiset<int> | v115 in v114 :: (v115), v106, {v80, multiset{f24, v110.f33}}, v106 - v106, v106, v106, v107[f27], v106, v106, {v80}, fm41(f27, v104, true, globalState), v106, v106 - v106];
				var v117 := DC25(f27, v98[211][777], v0);
				v116[222] := fm41(f24, seq(0x201, i5  => (v100)), v117.cf39, globalState);
				var v118: array<int> := new int[12];
				var v119: array<array<int>> := new array<int>[4] [v118, v118, v118, v118];
				v119[23] := v118;
				v105, v116[222], v119[23] := if (v0) then v105 else if (v98[211][777]) then v105 else v105.(cf7 := v104), v106, v118;
			} else {
			...
			var v124: seq<string> := [seq(0x32d, i7  => ('a'))];
			v123[574] := v124[-f27];
			var v125 := "wugxlqdqp";
			v123[574] := v125;
			var v126: map<int, int> := map[f24 := f27 * 350];
			var v127: seq<int> := [|v80|, f27];
			v126 := v126[f24 := v127[f27]];
		} else {
			var v128: seq<int> := [f27, f24];
			var v129: C1 := new C1(seq(-0x18b, i8  => (multiset{f27, |multiset{v0, DC29(f24, v0).cf46, v0}|})), |v128[|v80| := f27]|, f27, f25);
			...
			var v133: array<int> := new int[27] [f24, v129.f33 / |v131|, v129.f33, f24, v129.f33, v129.f33, f27, f27, f24, if (v0 in v131) then v131[v0] else f24, f27, f24, |v132| / v129.f33, f24 % f27, f27, f27, f27 % f27, f27, v129.f33, 0x2a4, v129.f33, v129.f33, -(0x164 + f24), f27, f24, f27, f27];
			v133[717] := v129.f33;
			v133[717] := f24 / 0x23e;
			var v134 := 'r';
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		if (if (v1 in v2) then v2[v1] else v1 >= fm1(f27, 0x379, globalState)) {
			if (0x362 > p0) {
				...
				var v6: seq<int> := [|(seq(0x302, i0  => (p0)))|, 0x112, p0, f27, p0];
				v5[632] := v6[p0 := f27];
				v5[632] := v6;
				...
				var v14: array<array<int>> := new array<int>[28] [v12[p0], v11, v11, if (v9) then v11 else v11, v11, v11, v11, v11, v11, v12[0x2db], v11, v11, v11, v11, v11, if (v9) then v11 else v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, if (f24 in v13) then v13[f24] else v11, v11];
				v14[793] := v11;
				v14[793] := v11;
			...
			v19[167], v21, globalState.f14 := v20, v21 + f26, |v22[f24]|;
			var v23: C2 := new C2(-986 <= f27, -f27 - p0, seq(0x232, i2  => (map['q' := |(seq(0x54, i3  => (p0)))|])));
			v23 := if ("lylfv" != v0) then v23 else v23;
			v19[167] := v23.f31;
			var v24 := 'd';
			var v25: set<array<bool>> := {v19, v19};
			var v26: seq<set<array<bool>>> := [v25, v25];
			var v27: map<int, set<array<bool>>> := map[|(((seq(-0x17b, i4  => ('o'))) + "fg")[p0 := v24])[f27 := v24]| := v25 + v26[-f27]];
			...
			v36[5] := (v34[v33 := v32])[v33 := v32];
			var v37: seq<bool> := [!v32, v32];
			var v38: map<seq<bool>, int> := map[v37 := f27];
			v36[5] := map[v33 := (if (fm23(globalState) in v38) then v38[fm23(globalState)] else f24) < f27];
			v32 := v37[f24];
			...
			decreases 100 - i5
		{
			...
			var v45: map<bool, char> := map[v44[f24] := fm3(globalState)];
			var v46: array<string> := new string[29] ["c", "jgelqg" + v0, v0, fm4(false, p0, v42, fm2(f24, f24, v42, globalState), globalState), v0, if (v41.f34 in v43) then v43[v41.f34] else seq(0x219, i6  => (v42)), v0 + v0, v0, (v0[|v45| := v42])[p0 := 'f'], v0, v0, v0 + v0, v0, v0 + v0, v0, seq(0x3b2, i7  => (v42)), fm4(v39, f27, v42, v41.f34, globalState), seq(0x3b3, i8  => (v42)), v0 + v0, v0, v0 + v0, v0, v0, "kdm", "nlv", v0[f24 := v42], v0, v0, v0 + v0];
			v46[839] := v0 + v0;
			v46[839] := v0;
			...
			var v54: seq<int> := [|v52|, v53[-0x17f]];
			var v55 := DC33(v42, v41.f34);
			var v56: map<char, bool> := map[v55.cf54 := v41.f34];
			var v57: seq<int> := [|v54[f27 := 132]|, f24, |v56|, |v1|, 0x140];
			v47[918] := map v48 : int | v48 in v57 :: (v48 + 9) := (f27);
			...
			var v61 := DC41(|v60|);
			v47[918] := map[f27 := if (fm2(|"tvsoofsw"|, p0, v42, globalState)) then |v59| else v61.cf64];
		}
		globalState.f1 := p0;
		...
		v64[20] := f27;
		v39, v64[20] := |(v0 + v0)| <= f24, -(|(v0 + "tytwp")| / fm0(f24, p0, globalState));
		var v65 := 'q';
		var i10 := 0;
			...
			decreases 100 - i10
		{
			...
			if (if (!v39 ==> (if (v39 in f26) then f26[v39] else v62.f34)) then false else !v62.f34) {
				...
				var v68: set<seq<bool>> := {v67[|v0|], v66 + v66, v66};
				...
				var v79: set<int> := {f24};
				var v80: map<int, set<int>> := map[v64[20] := v79];
				var v81: map<char, int> := map['h' := p0];
				var v82: map<int, seq<map<char, int>>> := map[f24 := [map[v65 := v64[20]], map[v0[-891] := f24], v81, v81, v81]];
				var v83: C2 := new C2((if (fm0(p0, f27, globalState) in v80) then v80[fm0(p0, f27, globalState)] else v79) !! v79, v64[20], if (v64[20] in v82) then v82[v64[20]] else f25);
				v83 := v83;
				var v84 := DC35(v1);
				var v85: seq<int> := [f27, v64[20], -v64[20]];
				v83.f31 := v84.cf57 !! multiset(v85);
				var v86: set<bool> := {v39, v83.f31};
				var v87: seq<set<bool>> := [v86];
				v85 := ((seq(0x31c, i11  => (v64[20])))[f24 := f27])[f27 := |v87|];
				v64[20] := p0 - v64[20];
				var v88: map<int, bool> := map[|map["xuayu" := v64[20]]| := v83.f31];
				...
				var v91: map<int, char> := map[v64[20] := v65];
				v90, globalState.f2, v91 := v90 + v90, v62.f34, v91 + v91;
			}
			
			if ((if (v39) then v64[20] else f24) == v64[20]) {
				v39 := v62.f34;
				var v92: seq<array<int>> := [v64];
				var v93: array<array<int>> := new array<int>[7] [v64, v64, v64, v64, v64, v92[f27], v64];
				v93[961] := v64;
				var v94: seq<int> := [-469];
				var v95: seq<bool> := [true, true];
				var v96: seq<seq<bool>> := [v95];
				v64[20], globalState.f2, v93[961], globalState.f17, v0 := (-0x2fb % |v94[|fm6(|v94|, f24, f24, f27, globalState)| := p0]|) / (0x1a7 * f27), {|[|v96[v64[20]]|]|} !! {v64[20]}, v64, v0, v0;
				...
				var v101: map<int, int> := map[|fm1(|v1[f27 := -f27]|, fm0(|(if (v62.f34 in v100) then v100[v62.f34] else [v62.f34])|, f27, globalState), globalState)| := v99];
				var v103: seq<map<int, int>> := [map v102 : int | (0x251 <= v102) && (v102 < 0x252) :: (v102 + v99) := (-v64[20]), v101];
				var v104: map<bool, int> := map[v39 := p0];
				var v105 := DC9(v95);
				var v106 := DC4(v62.f34, v39, v65, f24, |v105.cf17|);
				var v108: array<map<int, int>> := new map<int, int>[22] [v101, v101 + v101, v103[f24], map[-f27 := f24], map[0x367 := v99] + v101, v101 + v101, v101, map[f27 := -p0], v101[0xbb := v64[20]], v101, if (true) then v101 else map[if (v39 in v104) then v104[v39] else v64[20] := p0], v101, v101, map[|v95| := v99], if (v39) then v101 else fm15(v64[20], v106.cf8, -368, v62.f34, globalState), map[f27 := |v94|] + (map v107 : int | (794 <= v107) && (v107 < -0x2b6) :: (v107 - p0) := (f27)), v101, v101, v101, v101, map[v99 := f24], v101];
				v108[174] := v101;
				v108[174] := map[f27 := v64[20]];
			} else {
				v65 := 'v';
				var v110: multiset<char> := multiset{v65};
				var v112 := new C2(-f24 == 0x13e, -(v64[20] - f24), (seq(0xf4, i12  => (map[v65 := v64[20]])))[fm0(-p0, p0, globalState) := map v109 : char | v109 in v110 :: (v109) := (v64[20])] + (seq(0x24a, i13  => (map v111 : char | v111 in v110 :: (v111) := (f24)))));
				globalState.f2 := v62.f34;
				f27 := p0 * (f24 % |v1|);
				globalState.f2 := v112.f31;
			}
			
			var v114: seq<int> := [v64[20]];
			var v115: map<int, int> := map[|v114| := p0];
			var v116: map<char, map<int, int>> := map[v65 := v115];
			var v117: map<int, bool> := map[v64[20] := v62.f34];
...
method Main() {
	...
	var v12: map<int, array<bool>> := map[-|(seq(-0x3df, i1  => (v0)))| := v11];
	var v13: set<bool> := {v2, v2, v2};
	var v14 := "nbntyekh";
	var v15 := DC4(v2, v2, v14[v0], v0, v0);
	var v16: map<int, map<int, int>> := map[v0 := map[0x17e := v0]];
	var globalState := new GlobalState(true, 0x22a, true, v1[v2 := v0], false, -0x3d, 'c', v5, ([v2, v2, !false] + v6)[-v0 := !v2], 889, 0xcc, v10, 127, v12, 0x3e4, 982, v13, v14, -0x25f, multiset{v11, v11}, v6, [v2, v15.cf8], if (v0 in v16) then v16[v0] else map v17 : int | (0xc7 <= v17) && (v17 < 972) :: (v17 - v0) := (v0), 790);
	v11[614] := v0 <= v0;
	v11[614] := v2;
	v7 := 'u';
	var v18: multiset<bool> := multiset{!v11[614], v11[614]};
	var v19: map<bool, bool> := map[v2 := false];
	var v20: seq<int> := [v0, |v19|];
	if ((v0 / (if (!v11[614] in v18) then v18[!v11[614]] else v0)) >= fm0(|v20|, v0, globalState)) {
		...
		v26, v27[707], globalState.f9, v11[614], globalState.f1 := v26, fm3(globalState), v0, v28 >= (v28 + v28), v0;
		globalState.f9 := (v0 + 765) % |(v13 - v13)|;
	} else {
		var v29: array<array<int>> := new array<int>[4];
		var v30: map<bool, array<int>> := map[false := v3];
		var v31 := DC2(v11[614], -v0, v7);
		v29[621] := if (!v31.cf4 in v30) then v30[!v31.cf4] else v3;
		v29[621] := v3;
		var v32 := DC1(0xd7, v0, v11[614]);
		var v33: map<int, string> := map[v0 := v14];
		var v34: array<string> := new string[21] [v14 + v14, v14[fm0(v0, v0, globalState) := v7], v14, ("orkpvq")[v0 := fm3(globalState)], v14 + fm4(v32.cf3, -|v20|, v7, fm2(v0, v0, v7, globalState), globalState), v14 + v14, v14, v14, v14, seq(-260, i2  => (v7)), (if (|v13| in v33) then v33[|v13|] else v14) + v14[|v20| := v7], v14, "jmsoaylng", v14 + v14, v14, v14, v14, "arypuvscv", v14, v14[v0 := v7], "bmic"];
		var v35: seq<array<string>> := [v34, v34];
		v34 := v35[v15.cf11];
		globalState.f2 := v11[614];
		var v36: set<string> := {v14, v14, fm4(v11[614], |map[v0 := v2]|, v7, v2, globalState)};
		var v37: map<set<string>, bool> := map[v36 + v36 := v11[614] || v11[614]];
		v37 := v37[v36 := !v11[614]];
		var v38: map<int, char> := map[v0 := v7];
		v2 := fm2(v0 + v0, v0 / v0, if (v32.cf1 in v38) then v38[v32.cf1] else v7, globalState);
	}
	
	var v39 := DC5(v11[614], v0 >= v0, v11[614]);
	v39 := v39;
	for i3 := v0 to v20[v0] {
		v14 := ("ug" + (seq(0x39a, i4  => ('u'))))[-v0 := v7] + v14;
		var v40 := m0(i3, i3, globalState);
		var v41: map<int, int> := map[v0 := v40];
		var v43: seq<map<int, int>> := [v41, map[v0 := -0xdf], map v42 : int | v42 in v20 :: (v42 / 0x87) := (0x255), map[v0 := i3], v41];
	...
	v45[662] := v14;
	var v46: map<seq<string>, string> := map[[v14, v14, "ncd", v14, v14] := ("lbmfhj")[-133 := v7]];
	var v47: seq<string> := [v14];
	var v48: seq<string> := [v14, v47[v0], v14, v14, v14];
	v45[662] := if (v47 in v46) then v46[v47] else "anrxvxycj";
	globalState.f14, v2 := if (fm2(|v19|, v0, v7, globalState)) then -v0 else if (!v2) then v0 else -v0, !(v11[614] <==> v2);
	var v49: set<int> := {|"kyghqhrgx"|};
	var v50 := DC1(v0, v0, !v6[|map[0x2f8 := v49]|]);
	match (v50) {
		case DC1(cf1, cf2, cf3) =>
			var v51 := new C0(v2 <== cf3);
			var v52 := m0(cf1, v0 / v0, globalState);
			cf3 := v51.f34;
			cf3 := v51.f34;
		...
		case DC0(cf0) =>
			if (v11[614]) {
				...
				var v63 := DC43(v62);
				var v64: seq<C1> := [v62];
				var v65: array<C1> := new C1[26] [v62, v62, v62, v62, v62, v62, v62, v62, v62, v63.cf66, v62, v62, v62, v62, v64[|v45[662]|], v62, v62, v62, v64[v0], v64[v62.f33], v62, v62, v62, v62, v62, v62];
				v65[228] := v62;
				v7, globalState.f18, v65[228], v2 := v7, -v0, v62, (v45[662][v62.f33 := v7] + v14) <= v14;
			} else {
				var v67: set<char> := {v7, v7};
				var v68 := DC12(v20);
				var v69: map<bool, D4> := map[v11[614] := v68];
				var v70: map<char, int> := map[v7 := |v69|];
				var v71: seq<map<char, int>> := [map v66 : char | v66 in v67 :: (v66) := (v0), v70];
				var v72: C2 := new C2(v11[614], |v45[662]|, v71);
				var v73: seq<C2> := [v72];
				var v74: multiset<C2> := multiset{v73[v0], v72};
				var v75: map<bool, C2> := map[true := v72];
				var v76: T0 := new C4(v3, if ((if (v11[614] in v75) then v75[v11[614]] else v72) in v74) then v74[if (v11[614] in v75) then v75[v11[614]] else v72] else v0, v71);
				v76 := v76;
				v1 := v1;
				var v77 := new C2(v11[614], -(v20[v76.f24] / 687), fm42(v76.f24, globalState));
				globalState.f17 := "yqdcd" + (seq(-23, i6  => (v7)));
				var v78: C0 := new C0(v11[614]);
				v78 := v78;
			}
			
			globalState.f2 := (-fm0(v0, v0, globalState) / v0) in (v20 + v20);
			...
			var v85: C3 := new C3(v79, if (v81 in v84) then v84[v81] else v83, 0x365, seq(510, i7  => (map[v7 := v0])));
			globalState.f18 := |v14| / |[v85]|;
			var v87: seq<map<char, int>> := [map[v7 := v0]];
			var v88: map<char, int> := map[v7 := v0];
			var v89: C4 := new C4(cf0, v0, v87[v0 := v88]);
			var v90: map<map<bool, char>, C4> := map[(map[!v11[614] := v7])[v81.f31 := v7] := v89];
			v12 := v12[|(set v86 : int | (62 <= v86) && (v86 < 0x115) :: (v86 % v0))| * |v90| := v11];
	}
	...
	for i8 := fm0(v0, v0, globalState) to -v0 {
		...
		v11[614] := (if (v11[614]) then v11[614] else v2) || (multiset{i8} != v91);
		v3[926] := i8;
		var v92: array<char> := new char[27] ['y', v7, v7, v7, v7, if (v11[614]) then v7 else v7, v7, v7, 'u', v7, v45[662][i8], 'l', v7, v7, v7, v7, v7, v7, v7, fm3(globalState), v7, v7, v7, v7, v7, v7, v7];
		v92[997] := v7;
		...
		var v97: seq<C0> := [v96];
		var v98: multiset<array<bool>> := multiset{v94[v0], v11, if (v11 in v95) then v95[v11] else v94[|v97|]};
		globalState.f20, v3[926], v0, v92[997], globalState.f9 := (v6 + v6)[-|v93| / |fm23(globalState)| := v11[614]], fm0(v0, |v93| / v0, globalState), 0x20d, v7, if (v11 in v98) then v98[v11] else i8;
	}
	...
	var v104 := new C3(v99, v100, v0 % v0, (seq(0x307, i11  => (map v101 : char | v101 in map['q' := v2] :: (v101) := (|v6|)))) + v103);
	var v105: map<int, bool> := map[v0 := v2];
	var v106: map<bool, D1> := map[if (false) then if (|v6| in v105) then v105[|v6|] else true else v11[614] := fm43(v0, !fm2(v0, v0, v7, globalState), v2, globalState)];
	v106 := v106 + map[v11[614] := v15];
	var v107 := DC9(v6);
	match (v107) {
		case DC10() =>
			globalState.f2 := !v2;
		...
		case DC11(cf18, cf19, cf20) =>
			...
			match (v114) {
				case DC42(cf65) =>
					globalState.f17 := v45[662];
					v104.m6(globalState);
					var v115 := new C4(v3, v0, v103);
					var v116: map<seq<int>, bool> := map[v20 := cf19];
					var v117: seq<map<bool, int>> := [v1];
					var v118, v119, v120, v121 := v115.m4(if (!!cf19) then if (v20 in v116) then v116[v20] else !true else v11[614], !(v117[v0 := v1] <= v117), globalState);
			}
			
			v104.m6(globalState);
			if (!cf19) {
				globalState.f17, globalState.f14 := v14 + v14, v0;
				globalState.f14 := v0 * (v20[cf18] + |{v11}|);
			...
			globalState.f9 := v0;
		case DC9(cf17) =>
			var v126: C4 := new C4(v3, |v45[662]|, v103);
			var v127 := DC10();
			var v128: seq<multiset<int>> := [(multiset{fm0(v0, v0, globalState), |v45[662]|})[|v105| := v0]];
			var v129: C1 := new C1(v128[v104.fm8(globalState) := multiset{-0x346, v0, v0}], v0, |v1|, v103);
			var v130: map<bool, C4> := map[v11[614] := v126];
			...
			if (v2) {
				...
				v135, globalState.f17, globalState.f9 := v135, v45[662], -(0x1ef - (v129.fm11(v2, v133.f34, v11[614], v0, globalState) + v135.f24));
			} else {
				var v136, v137, v138 := v104.m5(v11[614], globalState);
				globalState.f18 := v0;
			...
			v11[614] := (v139 > v139) ==> v11[614];
	}
	
	globalState.f18 := -(|multiset{v0, |v20|, v0}| + -v0) % v0;
	globalState.f18 := v0;
