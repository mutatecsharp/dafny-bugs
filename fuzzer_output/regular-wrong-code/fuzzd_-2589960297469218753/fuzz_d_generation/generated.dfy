...
function fm0(p0: int, p1: bool, p2: bool, globalState: GlobalState): int {
	-(-|DC27([|map["itjb" := false]|, |{true, !false}|]).cf40| + |(set v0 : int | v0 in [-111] :: (v0 % |"exuvfvup"|))|)
}
...
function fm8(p0: bool, p1: bool, globalState: GlobalState): D2 {
	if ((seq(0x2f7, i0  => (|multiset{!false, !true, false, false, false}|))) != [0x6]) then DC9("txpfrb", -|multiset{-0x3b8, |[true, false, false, true, false]|}|, true, -911) else DC9("asarcrdjh", |multiset{[-0x34a], seq(0x221, i1  => (-0x2a2)), [0x2e]}|, true, 0x249)
}
...
function fm18(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): D2 {
	DC9("nc", |(map v0 : int | (957 <= v0) && (v0 < -0x37) :: (v0 * |map[true := true]|) := (-0xa4))|, true, |map[false := false]| * |multiset{!!DC29(|DC27(seq(0x351, i0  => (388))).cf40|, |map[|"qqe"| := 37]|, true).cf48}|)
}
function fm19(p0: char, globalState: GlobalState): bool {
	-(|{true, true, false}| / -|"enqyyh"|) > (-0x207 * |"aabgm"|)
}
function fm20(p0: bool, p1: bool, p2: seq<bool>, p3: int, globalState: GlobalState): string {
	("fnjmfaxg" + "ms") + ((seq(0x207, i0  => ('s'))) + (seq(734, i1  => ('h'))))
}
...
function fm25(p0: bool, p1: bool, p2: string, globalState: GlobalState): set<seq<int>> {
	match DC62() {
		...
		case DC63(cf112) => {seq(-0x25d, i0  => (|(seq(0x2c6, i1  => ('r')))|)), [0x25d]}
		case DC61(cf111) => DC65(set v1 : seq<int> | v1 in [[0x2eb, |map[-0x3aa := !true]|], seq(-0x1a0, i2  => (-0x31f))] :: (v1)).cf114
		case DC64(cf113) => {[|{true, true, true}|]} + {[|map[true := true]|, -|{[|(seq(0x314, i3  => (0x212)))|], [|(map v2 : int | v2 in [-|(seq(0x9c, i4  => ('j')))|] :: (v2 - 0x16f) := (-0xf5))|]}|]}
	}
}
...
function fm27(p0: int, p1: bool, globalState: GlobalState): multiset<int> {
	multiset{453 / 0x37c, -(|(seq(472, i0  => ('n')))| % -|"nbv"|), |multiset([false, !false, false])| + |"uibebmq"|, |DC9("vmqtwapqp", |"sdv"|, false, |multiset([|multiset{|[true, true, true, !!!false]|}|])|).cf14|}
}
...
function fm40(p0: bool, globalState: GlobalState): D0 {
	if ({30} !! {|{-|"qfejidul"|}|, |(seq(0xb8, i0  => ('l')))|, |map[|[false]| := true]|}) then DC2(multiset{false, !!true, true, !true}, seq(19, i1  => ('j')), true) else DC2(multiset{true, true}, seq(481, i2  => ('u')), false)
}
function fm41(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<int, bool> {
	map[|map[[!true] := DC15(|"rddv"|, |{--719, -0x4f}|)]| := true] + (map v0 : int | (-0x25a <= v0) && (v0 < 331) :: (v0 / |"eqcdui"|) := (true))
}
...
function fm44(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): seq<int> {
	if (multiset{true} > multiset{!false, true}) then (seq(723, i0  => (DC59(false, 0x32a).cf109))) + [|map[false := true]|] else [|{!false}|, 181]
}
function fm45(globalState: GlobalState): map<seq<int>, int> {
	((map v0 : seq<int> | v0 in (map v1 : seq<int> | v1 in [[|[false]|], [|(seq(-250, i0  => ('a')))|], [|{0x3e0, DC59(false, |multiset([true])|).cf109, 0xaf, |[false]|}|], seq(-0x236, i1  => (|"druvqxil"|))] :: (v1) := ('s')) :: (v0) := (0x24e)) + (map v2 : seq<int> | v2 in map[seq(96, i2  => (|map[|"jqmycnx"| := false]|)) := map['h' := false]] :: (v2) := (|"fjboup"|))) + (map[[0x201, 0x30b, |map[false := "yncuqfdbc"]|] := -|"ofyfibxcp"|] + map[[0xa2, |"te"|, 286] := |"dv"|])
}
...
function fm47(p0: bool, p1: bool, globalState: GlobalState): set<map<int, D11>> {
	set v1 : map<int, D11> | v1 in ([map[|{true, false}| := DC35("edl", true)], map[0x76 := DC35("tah", true)], map[|{0x24f}| := DC35(seq(0x147, i0  => ('x')), false)]] + [map[-837 := DC35(seq(831, i1  => ('s')), true)], map v0 : int | (-0x1c8 <= v0) && (v0 < 0x4) :: (v0 + |[|map[|map[false := false]| := true]|]|) := (DC35("rh", true))]) :: (v1)
}
...
function fm51(globalState: GlobalState): D11 {
	DC35((seq(251, i0  => ('q'))) + (seq(0x26, i1  => ('v'))), DC4(false).cf8)
}
function fm52(globalState: GlobalState): map<bool, string> {
	map[!true := seq(0xb7, i0  => ('a'))]
}
...
function fm56(globalState: GlobalState): seq<map<int, bool>> {
	[map[|[DC65({seq(0xe5, i0  => (-0xe1))})]| := true]] + [map v0 : int | v0 in [-0x152] :: (v0 * |{'v', 'q'}|) := (false)]
}
function fm57(p0: bool, globalState: GlobalState): set<char> {
	set v0 : char | v0 in map['c' := map[|(seq(0x37b, i0  => ('i')))| := |[false, false]|]] :: (v0)
}
method m10(p0: char, p1: int, p2: bool, p3: bool, globalState: GlobalState) {
	if (if (!p2) then p3 else p2) {
		...
		v3[891] := p3;
		var v4: seq<bool> := [p3];
		v2, v3[891], globalState.f18, v0[10] := p0, p3, v0[10] >= (fm0(v0[10], p3, v4[fm36(globalState)], globalState) / v0[10]), v0[10] / p1;
		globalState.f17 := new int[9];
		var v5: C2 := new C2(v0[10], {v0, v0}, v3[891], seq(580, i0  => (v2)));
		...
		var v17: map<int, bool> := map[-|v15| % -0x170 := p1 in v16];
		v13[560], globalState.f15 := (fm1(fm42(p3, false, globalState), p1, p1, p3, globalState) !in v14) <==> (|"oa"| >= p1), if (p1 in v17) then v17[p1] else p2;
		var v18: set<char> := {p0, p0, fm42(fm19(p0, globalState), p3, globalState)};
		v18 := fm57(!p2, globalState);
		var v19 := new C4(v13[560], p1);
		v13[560] := v19.f33;
	}
	...
	v24[920] := fm33(p2, |v22|, |v26|, globalState);
	var v27: T0 := new C6(p2, "bydkuf");
	var v28: map<int, T0> := map[p1 := v27];
	var v29: map<T0, char> := map[if (p1 in v28) then v28[p1] else v27 := p0];
	var v30 := "juplsu";
	globalState.f21, v24[920], globalState.f14 := p1, (if (v27 in v29) then v29[v27] else p0) !in v30, p1;
}
trait T0 {
...
class C1 extends T0 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		var v3 := DC25(v2);
		var v4 := 0x28b;
		var v5: multiset<seq<D6>> := multiset{v3.cf39, fm31(v4, 0xf1, globalState), seq(0x294, i0  => (v1)), v2};
		var v6: map<int, set<bool>> := map[v4 := {p0, f40}];
		globalState.f18 := !(v5 !! multiset{v2[0x8c := DC21(if (v4 in v6) then v6[v4] else {f40})]});
		...
		v14[705] := seq(-0xa2, i1  => ('y'));
		v14[705] := fm34(v4, v4, p0, p0, globalState);
		var v15: seq<bool> := [v13[950], f40 || !f40, v13[950] && f40, true, f40];
		var v16 := DC15(v4, v4);
		var v17 := 'i';
		var v18 := DC8(v17, v13[950]);
		var v19: seq<D2> := [DC8(v17, p0), v18, v18];
		globalState.f28, globalState.f19, v15, v16 := if (v13[950] in v7) then v7[v13[950]] else true, v4, fm35(v19 + v19, v4, globalState), v16;
		var v20 := new C0("rrjunsmd" == (seq(0x6a, i2  => (v17))));
	...
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		var v5 := DC27(seq(368, i1  => (102)));
		globalState.f18, globalState.f18, v2, v3[409] := f40, p0, v2[multiset{|v4|, p2, p2, p2, 0x1de} := v5.cf40] + v2, p0 <== !p0;
		if (v3[409] ==> !f40) {
			var v6 := DC14(-p2);
			v6 := v6.(cf23 := p2);
			var v7 := new C0(f40);
			...
			v9[948], globalState.f20, globalState.f19, globalState.f28, globalState.f21 := if (f40) then v3 else v3, v10, |v11|, v7.f37, (0x65 * p2) % (v7.fm12(globalState) / p2);
			...
			globalState.f17 := new int[21] [p2, fm36(globalState) + fm36(globalState), |v16|, p2 / p2, p2, p2, 0x88 - p2, p2, p2, p2, -0x89, p2 % 0x185, p2 % p2, p2, p2, p2, |(v18 + v18)|, v1[p2], p2, if (v3[409]) then p2 else 241, p2];
			v3[409] := p2 > p2;
			var v19: set<bool> := {f40, p0, v3[409], f40};
			var v20: map<int, bool> := map[p2 := false];
			var v21: array<int> := new int[9] [|(v19 - v19)|, p2 / -fm36(globalState), if (f40) then 0x26b else |v18[p2 := v17]|, DC15(p2, |v18|).cf24, p2, -|v20|, 773, p2, fm36(globalState)];
			globalState.f17, v3[409] := v21, DC23(f40, p2).cf36;
			if (f40) {
				var v22: set<char> := {v17};
				var v23: multiset<set<char>> := multiset{v22, {v17}, v22, v22};
				var v24: seq<set<char>> := [v22];
				v3[409] := v23 > (multiset(v24) * v23);
				var v25: seq<bool> := [v19 != {v3[409]}, v3[409] || p0];
				globalState.f13 := v25[p2];
				var v26 := new C0(p2 < 0x3d5);
				globalState.f19, globalState.f28, globalState.f1 := -0xa4, p2 in map[p2 := v20], p2;
				v21[84] := |(if (v3[409]) then v25 else v25)|;
				v3, globalState.f20, v21[84], globalState.f28 := v3, if (-|v25| >= p2) then seq(74, i2  => (v17)) else if (v26.f37) then v18[p2 := v17] else v18, -0x128, !p0;
			} else {
				v21[401] := -fm36(globalState);
				v21[401] := p2;
				globalState.f28 := f40;
				var v27: seq<bool> := [fm36(globalState) >= --0x36d];
				var v28: map<int, seq<bool>> := map[v21[401] := v27];
				v27 := if (!p0) then v27 else if (p2 in v28) then v28[p2] else v27;
				v20 := map[v21[401] := multiset{p0} <= multiset{p0}];
				var v29: array<int> := new int[23](i3 => i3 - p2);
				v17, globalState.f17, globalState.f14 := v17, v29, v21[401];
			}
			
			globalState.f13 := p0;
		}
		
		var v30 := DC11(v3[409], !p0);
		var i4 := 0;
		while (v30.cf20)
			decreases 100 - i4
		{
			...
			v32 := v32[v31 := [p2, p2]];
			globalState.f18 := v3[409];
			globalState.f14 := p2 - |(seq(706, i5  => ('a')))|;
			var v33 := "evxiub";
			var v34: multiset<bool> := multiset{false};
			var v35 := 'p';
			var v36 := DC19(|v33|, v1[|v34|], v35);
			globalState.f13 := p2 != v36.cf28;
		}
		var v37 := new C0(v3[409]);
		var v38: map<bool, int> := map[p0 := p2];
		var v39: map<map<bool, int>, int> := map[v38 := (fm37(globalState)).cf33];
		var v40 := "bobyhh";
		var v41 := 't';
		globalState.f18, globalState.f15, r1 := (v38 + map[fm33(p0, p2, 0x3b1, globalState) := p2]) !in v39, v37.f37, (v40[|map[p2 := |(fm38(globalState)).cf40|]| := v41] + v40) <= v40;
		for i6 := p2 to p2 {
			globalState.f1 := p2 * p2;
			var v42: array<int> := new int[17];
			v42[864] := p2;
			v42[864] := fm36(globalState);
			var v43 := DC22(p2, |v38|, v3[409]);
			var v44: map<array<bool>, int> := map[v3 := v43.cf33];
			v38 := v38[p2 < |v44[v3 := i6]| := v42[864]];
			v0 := v0[|map[v42[864] := v38]| := i6];
		}
		r0 := v40;
		r1 := !false;
	}
...
class C2 extends T1 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		if ((f38 > -f38) <== f29) {
			...
			var v4: seq<bool> := [p0];
			var v5: array<int> := new int[27] [f38, 838, f38, f38 / f38, 13, fm16(v0, globalState), f38, f38, f38, f38, -f38, v1.cf25, f38, f38, f38 % |fm17(f38, globalState)|, f38, fm16(v0, globalState), (fm18(f38, |v3|, f38, |v4|, globalState)).cf15 * f38, f38, |v4|, f38, |[f29]|, f38 / f38, if (p0) then f38 else |(seq(18, i0  => ('l')))|, f38, f38, f38];
			v5[53] := f38;
			v5[53] := f38;
			globalState.f14 := f38;
			...
			if (p0) {
				...
				var v9: array<int> := new int[16](i1 => i1 % f38);
				var v10: map<char, array<int>> := map[f30[fm16(v8, globalState)] := v9];
				var v11 := 'e';
				...
				globalState.f28, globalState.f15, v16, globalState.f11 := multiset{f38, f38, 0x11b} !! (if (fm19(v17, globalState)) then multiset(v22) else v15), v18.f37, v16, seq(0x331, i3  => ('o'));
				...
				v27[921] := -f38;
				v27[327] := f38;
				v27[921], globalState.f2, v27[327], v17 := |f30|, v18.fm12(globalState), f38, v17;
			...
			if (true) {
				var v30: seq<bool> := [p0];
				var v31: seq<seq<bool>> := [[f29], v30[f38 := !p0]];
				var v32: seq<seq<bool>> := [v31[-|f30|], v30];
				var v33 := 't';
				var v34: array<string> := new string[3] [f30[|v31| := v33], (fm20(true, f29, v30, |[p0]|, globalState))[f38 := v33], f30];
				v34[605] := "sar";
				var v35 := DC3(v30);
				var v36: map<bool, D1> := map[f29 := v35.(cf7 := v30)];
				var v37: map<bool, string> := map[p0 := f30];
				var v38: map<bool, int> := map[p0 := f38];
				var v39: seq<int> := [f38, 0x237, |f30[|v38| := v33]|];
				v34[605], globalState.f19, v36 := (if (f29 in v37) then v37[f29] else f30[f38 := v33]) + fm20(!p0, true, [f29, true, !v30[0x388], p0], -|multiset{f38, f38}|, globalState), |v39|, (fm21(p0, f29, p0, globalState)).cf26 + (v36 + v36);
				...
				globalState.f1, v47[760] := |v49| / (|v50| - f38), v51 - (if (f38 in v52) then v52[f38] else multiset(v48));
				var v53: seq<seq<bool>> := [v48];
				globalState.f11 := fm20(f29, p0, v53[f38], f38, globalState);
				var v54: set<bool> := {p0};
				var v55: seq<set<bool>> := [DC21(v54).cf32, fm22(f38, !p0, v43, globalState), v54];
				globalState.f19 := |v55[0x366]|;
			}
	...
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		globalState.f19 := if (v1 >= v1) then f38 else |(map v2 : int | (588 <= v2) && (v2 < 0x183) :: (v2 % p2) := (|[p2, f38, f38]|))| - |v3|;
		var v4: array<int> := new int[21](i1 => i1 % -|f30|);
		...
		if (fm19('k', globalState)) {
			...
			var v9 := DC13(v8);
			v4[822], v9, globalState.f18 := |f30| / 0x357, v9, true;
			var v10 := DC9("xe", v4[822], p0, |f30|);
			...
			v14[365] := v1 + v1;
			var v15 := 'h';
			globalState.f14, globalState.f18, v4[822], v13[115], v14[365] := 0xd3, p2 >= f38, v4[822], fm19(v15, globalState), v1;
		} else {
			var v16: seq<int> := [|f30|];
			...
			v18[2] := f29;
			var v19 := 'x';
			globalState.f14, globalState.f14, r1, v18[2], v19 := -v16[p2], f38, (if (f29) then p2 else f38) >= (-p2 * f38), p0, v19;
			var v20 := DC11(f29, f29);
			var v21: map<D3, char> := map[v20 := v19];
			globalState.f19 := (p2 % -f38) + |v21|;
			v18[2] := f29;
		}
		...
		if (p0) {
			...
			globalState.f14 := -(f38 / |v30|);
			globalState.f13 := f29;
			var v31: seq<array<bool>> := [v22, v22, v22];
			var v32: set<array<bool>> := {v22, v31[p2], v22, v22};
	...
	method m8(p0: array<bool>, globalState: GlobalState) returns (r0: set<int>, r1: int) {
		...
		var v2: map<int, int> := map[f38 := fm16(multiset{f29}, globalState) - v1[f38]];
		v2 := v2[f38 := f38];
		var v3: array<bool> := new bool[16](i1 => f29);
		forall i0 | 0 <= i0 < v3.Length {
			v3[i0] := (seq(0x10d, i2  => ('k'))) == f30;
		}
		globalState.f13 := f29;
		...
		for i4 := fm16(v4, globalState) % f38 to f38 {
			var v5: set<multiset<bool>> := {v4, v4[f29 := f38]};
			globalState.f7 := (v1 + v1)[-f38 := |v5|] + v1;
			...
			match (v8) {
				case DC11(cf19, cf20) =>
					...
					var v13: array<int> := new int[26] [|v0[i4 := f29]|, f38, |multiset(v0)|, f38, v11.fm12(globalState), f38, f38, f38, |f30|, f38, i4, f38, 0x29e, f38, -f38, if (false in v12) then v12[false] else f38, -f38, i4, fm16(v4, globalState), f38, |(seq(698, i5  => ('e')))|, |f30|, f38, 0x149, f38, i4];
				...
				case DC10(cf18) =>
					...
					v3[417] := if (fm19(v17, globalState)) then f29 else (if (f29 in v19) then v19[f29] else fm26(f29, f38, f29, globalState)) != v18;
					globalState.f21 := i4;
					var v20 := DC10(v6[i4 := f38]);
					var v22: map<int, bool> := map[-i4 := f29];
					var v23: array<multiset<int>> := new multiset<int>[29] [multiset(v1), v20.cf18, cf18, cf18, multiset(v1 + v1), fm27(f38, false, globalState), v6, cf18, multiset(v1), cf18, v6, multiset{i4, i4}, cf18[f38 := i4], if (v3[417]) then multiset{f38, i4, i4} else cf18, cf18[i4 := i4], v6 * v6, cf18, cf18 - v6, cf18, fm27(f38, v3[417], globalState), multiset{|(map v21 : int | v21 in v22 :: (v21 % f38) := (|cf18|))|}, v6 - v20.cf18, cf18, cf18, cf18, multiset{0x4f}, v6 * v6, multiset{i4}, multiset{f38, f38}];
					v23[861] := (multiset{i4})[i4 := f38];
					globalState.f21, v23[861], globalState.f11 := i4, v6 + cf18, f30[f38 := v17];
				case DC12(cf21) =>
					v3[429] := f29;
					v3[429] := (!f29 in v4) in ([f29, f29] + v0);
					globalState.f13 := fm16(v4, globalState) == i4;
					globalState.f28 := v3[429];
					var v24: array<bool> := new bool[24];
					var v25: array<array<map<bool, bool>>> := new array<map<bool, bool>>[28];
					var v26: map<bool, bool> := map[f29 := v3[429]];
					var v27 := 'v';
					var v28 := DC24(v26);
					var v29: array<map<bool, bool>> := new map<bool, bool>[27] [v26, fm28(f29, i4, f38, f29, globalState), v26, v26, v26, v26, map[!f29 := v3[429]], v26, map[f29 := fm19(v27, globalState)], v26, v26, v26, v26, v26, v26, v26, v26, v28.cf38, v26, v26, v26, v26, v26, v26, fm28(v3[429], i4, f38, f29, globalState), fm28(v3[429], f38, f38, f29, globalState), v26];
					v25[199] := v29;
					var v30: array<int> := new int[1];
					v30[389] := -i4;
					v24, v25[199], v30[389] := v24, v29, i4 * f38;
			}
		...
		var v38: map<int, set<int>> := map[|(seq(0x1a3, i7  => (v35)))| := {f38}];
		r0 := (set v31 : int | v31 in v1 :: (v31 * |multiset{map[false := -0x1df], map[!false := |(set v32 : char | v32 in ['q'] :: (v32))|], map[false := 0x13d], map[true := |(map v33 : int | (-483 <= v33) && (v33 < -255) :: (v33 % |{-81}|) := (true))|]}|)) * (v37 * (if (f38 in v38) then v38[f38] else v37));
		var v39 := DC12(fm29(f29, f38, f29, globalState));
		var v40 := DC11(v0[0x24b], f29);
	...
	method m9(p0: multiset<bool>, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: set<set<T0>>) {
		...
		var v2: seq<int> := [f38];
		var v3: map<map<bool, int>, multiset<int>> := map[v1 := (multiset(v2))[|f30| := p1]];
		...
		var v6 := 'q';
		var v7: set<char> := {v6};
		v5[162] := match DC9(seq(0x2cc, i1  => ('e')), -|v7|, p3, p1).(cf15 := 0x10f, cf16 := true, cf14 := f30) {
...
class C3 extends T1 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		var v3 := 'f';
		var v4: array<string> := new seq<char>[24] [seq(0xac, i0  => ('m')), seq(0x18b, i1  => ('h')), f30, f30, f30, f30, seq(514, i2  => ('c')), f30, f30, f30, f30, "cdiohjl", f30, f30, f30, seq(107, i3  => ('v')), f30[|v2| := v3], f30, f30, f30, f30, f30, f30[f36 := v3], f30];
		v0[560] := v4;
		v0[560] := v4;
		...
		match (DC3(v5 + [true])) {
			case DC4(cf8) =>
				...
				match (v8) {
					...
					case DC8(cf12, cf13) =>
						...
						globalState.f1, globalState.f14, v5, globalState.f21, v13 := (if (f35) then f36 else fm9(globalState)) / (|f30| * f36), f36, ([fm10(f36, f36, globalState) <==> v5[f36]])[-f36 := f35], v15.cf2, if (cf8) then v13 else v13;
			...
			case DC3(cf7) =>
				...
				v22 := (v22 + (fm13(f36, |(map v23 : int | (-0x310 <= v23) && (v23 < -0x70) :: (v23 % 0x1d7) := (f36))|, f36, !f35, globalState)).cf22) + v22;
				globalState.f20 := f30;
				globalState.f19 := f36;
				var v24 := DC4(p0 ==> p0);
				match (v24) {
					case DC4(cf8) =>
						...
						v25[615], v30, v1, globalState.f17 := v31.cf12, (v30[f35 := v29] + v30[false := v29.(cf21 := v28)]) + v30, v1, v32;
						var v33 := new C0(if (f29) then true else p0);
						var v34: map<bool, int> := map[cf8 := |v5|];
						var v36: multiset<map<bool, int>> := multiset{map[v33.f37 := f36], v34, fm14(f35, seq(900, i9  => (f36)), cf8, |{v1}|, globalState), v34};
						...
						var v44: array<set<map<bool, int>>> := new set<map<bool, int>>[9] [{v34, v34}, set v35 : map<bool, int> | v35 in (seq(0x2a5, i8  => (v34))) :: (v35), set v37 : map<bool, int> | v37 in v36 :: (v37), v39 * (set v41 : map<bool, int> | v41 in v40 :: (v41)), v39, set v43 : map<bool, int> | v43 in v42[v34 := f36] :: (v43), v39, {v34, v34, v34[cf8 := |v38|], v34, v34}, {v34} * v39];
						v44[437] := v39;
						v44[437] := fm15(f36, globalState);
						globalState.f19 := -f36;
					case DC3(cf7) =>
						globalState.f1 := 58;
			...
			case DC5(cf9) =>
				...
				var v50: array<int> := new int[17] [f36, |f30|, f36, f36, f36, |(seq(-0x256, i10  => ('l')))|, f36, f36, |v49|, f36, |v5|, f36, f36, f36, f36, f36, f36];
				var v51: seq<array<int>> := [v50, v50];
				var v52: set<array<int>> := {v50, v51[fm9(globalState)]};
		...
		var v64: array<multiset<bool>> := new multiset<bool>[16] [if (false) then v63.cf4 else v62, v62[f29 := -f36] + fm39(v3, f36, globalState), v62 - v62, multiset{p0}, v62[!f29 := f36], multiset{p0}, v62, v62, v63.cf4, multiset{p0, true, p0, f29, p0}, multiset(v5), v62, v63.cf4, fm39(v3, f36, globalState) * v63.cf4, v62, multiset{fm19('k', globalState)}];
		v64 := v64;
		var v65 := new C1(f35);
		var v66: seq<seq<bool>> := [v5, v5];
		r0 := (v66 + v66)[f36 := v5] + (v66 + v66);
		r1 := false;
	}
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		var v0: seq<bool> := [f29, f29];
		if (f35 !in (v0 + fm35(seq(0x213, i0  => (DC8('o', f35))), -f36, globalState))[f36 := p0]) {
			var v1: T0 := new C1(f29);
			var v2 := DC30(v1);
			globalState.f21 := |[v2]|;
			var v3: map<bool, int> := map[f29 := |f30|];
			var v4: seq<int> := [-p2, f36];
			globalState.f1 := fm9(globalState) - (if (f35 in v3) then v3[f35] else v4[p2]);
			...
			var v12 := 'n';
			var v13: seq<string> := [f30[|f30| := v12]];
			v11[46] := v13[p2 := f30];
			var v14: array<int> := new int[8];
			v14[224] := 0x3e;
			var v15: multiset<bool> := multiset{p0};
			var v16: seq<multiset<bool>> := [v15];
			var v17: array<bool> := new bool[7] [f29, f29, v15[true := p2] > v16[-0x1ef], f35, p0, f35, p0];
			var v18: set<bool> := {p0, f29};
			v11[46], v14[224], globalState.f14, v17 := v13[f36 := f30] + (seq(0x2de, i1  => (f30))), |(f30 + "wjkkiurju")| - (if (f35) then f36 else 0x3ca), |(if (false) then v18 else if (p0) then v18 else {p0, f35})|, v17;
			var v19: multiset<int> := multiset{v14[224]};
			globalState.f13 := v19 > v19;
			globalState.f15 := f36 != -0x8b;
			var v20: array<char> := new char[4] [v12, v12, 'r', v12];
			var v21: seq<array<char>> := [v20, v20];
			var v22: seq<array<char>> := [v20, v20, v20, v21[p2], v20];
			v20 := v22[p2 * -|v0|];
			globalState.f17, globalState.f13 := v14, fm33(f35 && f29, v14[224], p2, globalState);
		}
		...
		if (f29) {
			...
			var v38 := DC2(v37[f35 := p2], f30, f29);
			...
			v42[517] := DC2(v37, seq(0x39e, i3  => (v24)), p0);
			v42[517] := v38;
			v39[641] := f29;
			var v43: multiset<array<bool>> := multiset{v39};
			var v44: seq<multiset<array<bool>>> := [v43, v43, v43[v39 := fm36(globalState)]];
			var v45: seq<int> := [f36, p2];
			v39[641] := multiset{v39, v39, v39} > v44[|v45|];
			globalState.f18 := !v39[641];
		...
		for i4 := |(v50 - v50)| to |v51| {
			...
			v57[613], v58[34] := v52.fm11(v62.cf54, globalState), v61;
		}
...
class C4 extends T0 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		for i2 := |"fwevwbc"| to f34 {
			...
			var v21 := DC9(v16, |v11[|v16| := i2]|, (DC2(v17, v18[|v20[i2 := v19]|], p0).(cf6 := true, cf5 := fm7(i2, globalState))).cf6, f34);
			v13, v14[20], globalState.f2 := [if (p0) then v12 else v12, v12, v12, v12], v15, v21.cf17;
		}
		var v22: array<int> := new int[9](i5 => i5 / f34);
		v22[88] := f34;
		var v23: seq<bool> := [true];
		v22[88], v23 := f34, (if (p0) then [f33] else [f33]) + v23;
		var v24: multiset<int> := multiset{v22[88], v22[88], f34};
		var v25 := DC10(v24);
		globalState.f28 := v24 == v25.cf18;
		v22[88] := f34;
		v22 := new int[2](i6 => i6 / |"bmap"|);
		var v26 := "hoalen";
		var v27: seq<seq<bool>> := [v23, [false, f33, p0, p0, fm6(|v26|, globalState)] + v23];
		r0 := v27;
		r1 := !((v22[88] / v22[88]) <= v22[88]);
	}
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		r0 := v1[v2.cf15 := v1[p2]];
		var v3: set<bool> := {false, v0[618]};
		v2 := fm8(!(f34 > fm5(v3, globalState)), v0[618], globalState);
		var v4 := 'u';
		var v5: array<int> := new int[26];
		v5[73] := p2;
		var v6: set<int> := {p2};
		var v7: multiset<int> := multiset{p2, f34, if (p0) then f34 else f34, |v6|, 0xdf};
		var v8: seq<bool> := [f33, p0, v0[618]];
		var v9: map<int, int> := map[p2 := p2];
		var v10: multiset<seq<bool>> := multiset{v8};
		var v11: seq<int> := [f34, |v10|, p2];
		var v12: map<bool, seq<int>> := map[v0[618] := [-p2]];
		globalState.f21, globalState.f28, v4, globalState.f7, v5[73] := if (fm5({v8[p2]}, globalState) in v7) then v7[fm5({v8[p2]}, globalState)] else |v9|, !v0[618], v4, ([f34, f34, p2, |v8|, f34] + v11) + (if (v0[618] in v12) then v12[v0[618]] else v11), p2;
		p1[801] := seq(-0x346, i0  => (DC8(v4, f33).cf12));
		p1[801] := v1;
		r0 := v1 + "keatndrhj";
	...
	method m6(p0: bool, p1: string, p2: string, p3: D0, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v2: multiset<int> := multiset{|v1| % f34};
		var v3: set<bool> := {f33};
		var v4: seq<bool> := [p0];
		globalState.f2, r0, globalState.f21, globalState.f13, v2 := fm5(v3, globalState), v4[0x3d2], |p2|, !f33, v2;
		var v5: seq<seq<bool>> := [v4[f34 := f33], v4];
		var v6: seq<seq<bool>> := [v5[f34]];
		globalState.f2 := if (fm6(f34, globalState)) then |v5[f34]| - f34 else fm5(v3, globalState);
		var i0 := 0;
		while (!p0)
			decreases 100 - i0
		{
			...
			var v8 := 'k';
			var v9: map<char, bool> := map[v8 := v4[f34]];
			v7[78] := v9;
			var v11: map<char, int> := map['j' := -f34];
			v7[78], globalState.f2, globalState.f14 := map v10 : char | v10 in v11 :: (v10) := (false), -(f34 / f34), f34;
			globalState.f2 := f34 + f34;
			var v12: map<int, bool> := map[f34 % f34 := p0];
			v12 := v12[f34 := p0];
		}
		r0 := f33;
		var v13: set<int> := {f34, f34};
		globalState.f14 := (f34 % |v13|) / f34;
		for i1 := f34 to f34 {
			var v14: multiset<bool> := multiset{fm6(f34, globalState)};
			var v15: seq<int> := [i1];
			var v16 := 'p';
			var v17: map<int, char> := map[i1 := v16];
			var v18: array<int> := new int[11] [i1, |(([f34, f34, i1, i1, --i1])[if (true in v14) then v14[true] else i1 := i1] + v15)|, i1 / i1, i1, f34, i1, 0x131, i1, i1, -|v17|, i1];
			globalState.f17 := v18;
			globalState.f15 := !f33;
			var v19 := new C1(p0);
			if (v19.f40) {
				...
				globalState.f13, v0[887], globalState.f13 := fm6(|v20|, globalState) <==> true, v3 !! (if (!f33) then v3 else v3), f34 != f34;
				...
				var v24: array<bool> := new bool[28] [v0[887], true, v4[f34], p3.cf0, true, v19.f40, v19.f40, p0, v19.f40, f33, if (f34 in v22) then v22[f34] else f33, f33, f33, v19.f40, if (f33 in v23) then v23[f33] else v19.f40, v19.f40, v0[887], v0[887], p0, v19.f40, p0, v0[887], f33, v19.f40, v19.f40, p0, v0[887], v0[887]];
				v21[457] := v24;
				v21[457] := v24;
				v23 := v23[{i1} == v13 := true];
				...
				var v27 := DC26();
				v26[556] := if (v19.f40) then v27 else DC26();
				var v28 := DC8(v16, f33);
				var v29: seq<D2> := [v28];
				globalState.f15, v26[556], globalState.f13 := (-|v2| - |fm35(v29, i1, globalState)|) <= i1, v27, p0;
			}
	...
	method m7(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		match (if (v2.f35) then DC3([f33]) else v4) {
			case DC4(cf8) =>
				...
				var v10 := DC14(|v9|);
				var v11: array<D4> := new D4[8] [v10.(cf23 := -f34), DC14(v2.f36), v10, DC14(|fm20(f33, v2.f35, v3, |(seq(0x235, i2  => (v2.f36)))|, globalState)|), v10, v10, v10, v10];
				v11[231] := v10;
				v5[280], v11[231], r0 := v7, v10.(cf23 := v2.f36), cf8;
				...
				match (fm43(multiset{|v13|}, v14.cf43, globalState)) {
					case DC4(cf8) =>
						globalState.f19, globalState.f18 := f34, v3[v2.f36];
					...
					case DC3(cf7) =>
						...
						globalState.f28, v19 := f33, (map v20 : int | (73 <= v20) && (v20 < 0x3d3) :: (v20 % p0) := (|[p0]|))[0x227 := |v1[v2.f36 := v6]|];
						var v21: map<seq<bool>, int> := map[cf7 + cf7 := p0];
						v21 := map[cf7 := -0xef];
						globalState.f20 := (fm7(v2.f36, globalState) + v1)[--(v2.f36 * v2.f36) := v6];
					case DC5(cf9) =>
			...
			case DC5(cf9) =>
				...
				var v34 := 'e';
				v33 := (if (fm19(v34, globalState)) then v33 else map v35 : int | (717 <= v35) && (v35 < 624) :: (v35 + p0) := (seq(0x378, i4  => (v31))))[-(v2.f36 - p0) := v32 + v32];
				...
				if (v2.f35 ==> !(v2.f36 < 872)) {
					...
					v0[797] := v2.f36;
					v39[62], v39, globalState.f28, v42, v0[797] := !v40.f37, v39, v3[v2.f36], v42, -v2.f36;
					globalState.f19 := v2.f36;
					var v43: set<bool> := {v2.f35};
					var v44: seq<set<bool>> := [{v29}];
					var v45: map<int, set<bool>> := map[v2.f36 := v43];
					var v46: array<set<bool>> := new set<bool>[22] [v43, v43, v43, v43, v43, fm22(f34, f33, v34, globalState), v43 + v43, {true} + v43, v43 * {v40.f37, v2.f35, v40.f37}, v43, {v39[62]}, v44[v2.f36], v43, v43, {v40.f37}, v43, fm22(v2.f36, v29, v34, globalState) - v43, {v2.f35}, {v40.f37}, v43 - (if (v2.f36 in v45) then v45[v2.f36] else v43), v43, v43 - v43];
					v46 := v46;
					...
					v48[902] := v49;
					v48[902] := v49;
					globalState.f21 := v49[-844];
				}
				
		}
		
		globalState.f21 := p0 + (|"oxjnf"| % f34);
		globalState.f21 := v2.f36 * (v2.f36 % v2.f36);
		var v50 := 'g';
...
class C5 extends T1 {
	...
	function fm4(globalState: GlobalState): int {
		(if (f29) then |DC6(multiset{'p'}).cf10| else 0xff) * |["kxmebkric", "qe", seq(-273, i0  => ('p')), "ugd", seq(0x203, i1  => ('w'))]|
	}
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		var v2 := 70;
		var v3: seq<bool> := [f29];
		var v4: map<array<string>, int> := map[v0 := -(|([v1])[v2 := v1]| * fm3(v3, globalState))];
		v4 := v4[v0 := fm4(globalState)];
		var v5: seq<int> := [v2, v2];
		for i0 := v2 + |(seq(0x1c5, i1  => (v2)))| to v5[|v5|] {
		...
		for i2 := v2 to v2 {
			...
			v1[952] := if (p0) then if (|(map v11 : int | (0xe4 <= v11) && (v11 < 0x276) :: (v11 * |"spsbhq"|) := (i2))[0x1a0 := i2]| in v10) then v10[|(map v11 : int | (0xe4 <= v11) && (v11 < 0x276) :: (v11 * |"spsbhq"|) := (i2))[0x1a0 := i2]|] else p0 else i2 == v2;
			if (p0) {
				...
				var v19: map<array<int>, bool> := map[v12 := v1[952]];
				var v20: map<int, int> := map[|v19| := v2];
				v20 := v20[|f30| := v2];
				var v21: map<bool, bool> := map[f29 := p0];
				v20 := v20[v2 + |(seq(0x177, i4  => (|v20|)))[|v21| := i2]| := i2 - 0x33a];
				...
				v1[952] := i2 != v2;
				var v26: map<bool, int> := map[v1[952] := v2];
				globalState.f21 := -(v2 - (v2 % (if (f29 in v26) then v26[f29] else v2)));
				r1 := v1[952];
				var v27 := new C0(p0);
			}
		...
		v29[829] := v5;
		v29[829] := if (f29) then if (p0) then v5 else v5 else v5;
		var v30: multiset<bool> := multiset{p0 <==> true, v3[|f30|], f29};
		v30 := v30;
		var v31 := 'e';
		var v32 := DC8(v31, f29);
		var v33: seq<D2> := [v32];
		var v34: seq<seq<bool>> := [fm35(v33, 654, globalState), [v3[v2], f29, p0], v3];
		r0 := v34 + v34;
		r1 := f29;
	}
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			v1[565] := v2;
			r0, v1[565], globalState.f18, globalState.f19 := f30, v2, fm6(p2, globalState), p2;
			globalState.f2 := p2;
			var v3 := DC33(p0, p2);
		...
		match (v9.(cf26 := v8)) {
			case DC17(cf27) =>
				...
				globalState.f20 := (f30[p2 := v10])[|v11| := if (f29) then v10 else v10];
			...
			case DC18() =>
				...
				match (v18.(cf4 := fm39(v19, p2, globalState))) {
					...
					case DC1(cf1, cf2, cf3) =>
						...
						v24[962] := (v25[v15 := cf2])[([cf2])[-cf2 := cf3] := cf2];
						v23, v24[962], v0, globalState.f21, globalState.f15 := v23, fm45(globalState), v0.(cf25 := cf2), cf2, !!(p2 == -fm9(globalState));
						cf1[724] := f29;
						globalState.f19, cf1[724], globalState.f28, globalState.f15 := cf3, f29, p0, fm19(v19, globalState);
						cf2 := p2 - cf2;
					...
					case DC2(cf4, cf5, cf6) =>
						...
						var v29: array<array<int>> := new array<int>[28] [v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, if (!f29) then v27 else v27, v27, v27, v27, v27, v27, v27, v27, v27, v28[0x15], v27, v27, v27];
						var v30 := DC38(v27);
						var v31: map<bool, array<int>> := map[v26.f35 := v30.cf64];
						v29 := new array<int>[23] [v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, if (cf6 in v31) then v31[cf6] else v27, v27, v27, v28[p2], v30.cf64, v27, v27, v27, v27, v27, v27, v27];
				}
			...
			case DC19(cf28, cf29, cf30) =>
				...
				v32[378] := (if (false in v36) then v36[false] else fm46('k', f30, globalState))[!f29 := v34];
				...
				var v41: array<int> := new int[9] [v38[cf28], cf29, p2, cf28, fm4(globalState), if (fm41(0x12, p0, p0, !f29, globalState) in v39) then v39[fm41(0x12, p0, p0, !f29, globalState)] else |v40|, cf29, p2, cf29];
				var v42: seq<array<int>> := [v41, v41];
				var v43: map<seq<array<int>>, int> := map[v42 := |f30|];
				v32[378], globalState.f14, globalState.f11, globalState.f21 := v35, cf29, f30 + f30, if (v42 in v43) then v43[v42] else p2 / cf28;
				var v44 := new C4(p0, p2);
				globalState.f21 := -|(seq(832, i2  => (v5 + v5)))|;
			case DC16(cf26) =>
				var v45 := 'c';
				var v46: array<int> := new int[5](i3 => i3 % p2);
			...
			case DC20(cf31) =>
				...
				var v51 := DC1(v49, |v5|, v50[fm4(globalState)]);
				var v52: seq<array<bool>> := [v49];
				var v53: array<array<bool>> := new array<bool>[29] [v49, v49, if (p0) then v49 else v49, v49, v49, v49, v49, v49, v51.cf1, v49, v49, v52[p2], v49, v49, v49, v49, v49, if (f29) then v49 else v49, v49, if (p0) then v49 else v49, v49, v49, v49, v49, v49, v49, v49, v49, v49];
		...
		if ((p2 < |v60|) ==> p0) {
			...
			globalState.f19 := if (p0) then p2 % p2 else |{p2}|;
			globalState.f28 := p0;
		} else {
			...
			match (v63) {
				case DC31(cf50, cf51) =>
					...
					v64 := v64;
					var v65 := new C3(cf51, 0x1dc / p2, f29, f30);
					...
					v68, v5, f30, v5, globalState.f13 := v68, fm35([v70], p2, globalState) + ([v65.f35, cf51] + v5), (f30[p2 := v69] + f30) + (f30 + f30), v5, cf50 || p0;
				case DC32(cf52, cf53) =>
					var v71 := new C0(f29);
			...
			globalState.f19, globalState.f21, v82[117], globalState.f15 := |(v84 + (v84 + v84))|, p2, v81, f29;
			...
			decreases 100 - i5
		{
			...
			var v97 := DC37(p2, p0);
			var v98: array<bool> := new bool[14] [p0, f29, !!p0, p0, p0, p0, true, fm33(p0, p2, p2, globalState), f29, f29, if (p0 in v96) then v96[p0] else v5[p2], v97.cf63, f29, p0];
		...
		if (p0) {
			var v104: multiset<int> := multiset{p2 / p2};
			var v105: map<int, multiset<int>> := map[p2 := v104];
			var v106: map<int, int> := map[p2 := p2];
			var v107: map<bool, int> := map[p0 := |v106|];
			v104 := if (|map[v107 := !f29]| in v105) then v105[|map[v107 := !f29]|] else v104[p2 := |f30|];
			var v108 := 'e';
			v108 := v108;
			...
			v109[975] := v110;
			v109[975] := v110;
			globalState.f20 := (f30 + f30[p2 := v108]) + (f30 + f30);
			var v111: seq<string> := [f30];
			var v112: multiset<string> := multiset{f30, v111[-182]};
			var v113: seq<multiset<string>> := [v112];
			globalState.f18 := v113[p2] < (v112 - v112);
		} else {
...
class C6 extends T0, T1 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		for i0 := |v1| to v0 {
			...
			if (!(f29 <== f29)) {
				...
				v12[730] := !p0;
				v12[730] := !f29;
				globalState.f18 := f30 < (seq(0xcf, i1  => ('p')));
		...
		v22 := v22 + map[p0 := |v23|];
		r1 := f29;
		var v24: map<int, seq<seq<bool>>> := map[0x63 := (seq(0x70, i3  => (v21)))[|[p0, f29]| := [p0]]];
		var v25: seq<seq<bool>> := [fm35(seq(948, i4  => (DC8('d', f29))), v0, globalState), v21];
	...
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		var v4: seq<seq<bool>> := [v2[|"kgmvdm"| := p0], [p0]];
		v2 := (v2 + v3.cf41[p2 := p0]) + v4[p2];
		for i0 := p2 + p2 to p2 {
			v2 := v2;
			...
			globalState.f15, globalState.f18, v5[971], globalState.f2, v5[665] := p0, if (0x28 != |v6|) then p0 else fm6(p2, globalState), p0, fm36(globalState), p0;
			var v7: seq<string> := [f30, seq(814, i1  => ('p'))];
			var v8: seq<int> := [i0, -p2, i0, p2, i0];
			var v9, v10 := m5(v7[i0], if (!p0) then v5[971] else p0, |v8| - fm36(globalState), globalState);
		...
		if (f29) {
			...
			var v15 := new C1(|(seq(-0x9c, i2  => ('g')))| <= p2);
			...
			if ((v19 + v19) <= v19) {
				...
				var v22: C2 := new C2(v20[138], v21, v15.f40, f30);
				...
				var v26 := 'k';
				var v27 := DC8(v26, f29);
				var v28 := DC19(v20[138], |v2|, v27.cf12);
				v25, globalState.f7, globalState.f21, globalState.f13, globalState.f1 := v25, v19[v28.cf28 := v22.f38 / v22.f38], p2, (f30 == f30) in v2, v22.f38 * v22.f38;
				var v29 := new C0(f29);
				var v30: map<bool, int> := map[v29.f37 := 0x3e2];
				globalState.f21 := |v30| % (v22.f38 - v29.fm12(globalState));
				var v31: set<int> := {-0xb6 + p2, p2 - |f30|, p2, v20[138]};
				v31 := v31;
			} else {
				globalState.f1 := p2;
				...
				v33[400], globalState.f21, globalState.f21, globalState.f28 := v32, |f30| % p2, |v34| * (if (!p0) then p2 else p2), f29;
				v18 := v18[|v2| := f29];
				f30 := f30;
				var v35 := 'e';
			...
			if ((v37.cf18 + multiset{p2}) >= v16) {
				...
				var v39 := DC23(p0, p2);
				globalState.f19, r1, v38, globalState.f19, globalState.f14 := (v39.(cf36 := v15.f40)).cf37, !!p0, v38, p2, -((p2 * -0x26c) / -0x6c);
				var v40: array<D11> := new D11[25](i3 => if (v15.f40) then DC37(p2, v15.f40) else DC37(|f30|, false));
				var v41 := DC37(p2, f29);
				v40[132] := v41;
				v36[196][590] := v15.f40;
				v40[132], v36[196][590], v2 := v41, (v19 + [|v0|]) <= v19, [false] + [v15.f40, p0];
			...
			v56[728], globalState.f19, v57[708] := (p2 - -v55.f36) - (if (v55.f36 in v59) then v59[v55.f36] else -|[v55.f36]|), v55.f36, v60.cf1;
			...
			var v63 := DC40(v61);
			var v64: seq<C4> := [v61];
			var v65: map<bool, C4> := map[f29 := v64[826]];
		...
		var v69: array<string> := new string[14] [f30, f30, f30, f30, f30 + f30, f30, f30, f30, f30, f30, f30, f30 + "nnvokyy", "uqootstpb" + f30, if (f29) then f30 else seq(-207, i9  => ('r'))];
	...
	method m5(p0: string, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: string) {
		if (f29) {
			...
			if ((v0 + v0) == v0) {
				...
				var v10 := 'k';
				v7 := v9[|("rksaphr")[p2 := v10]|] + (map[p2 := p2] + v7[p2 := p2]);
			...
			var v24: multiset<seq<bool>> := multiset{[f29, p1, f29] + fm35(seq(-0x93, i0  => (DC8('n', f29))), |v23|, globalState)};
			globalState.f1 := if ((v21 + v21) in v24) then v24[v21 + v21] else p2;
			v20[828] := fm9(globalState);
			v20[828] := p2 - p2;
		...
		v26[628] := p2 % -p2;
		v26[628] := fm36(globalState);
		v26[628] := p2 % v26[628];
		for i1 := v26[628] to p2 + p2 {
			var v27 := new C1(!f29);
			var v28: seq<string> := [f30];
			var v29: seq<string> := [v28[i1]];
			var v30: multiset<string> := multiset{p0, f30, p0, p0};
			var v31: map<bool, bool> := map[false := true];
			var v32 := 'k';
			var v33: multiset<char> := multiset{v32};
			v26[628], globalState.f18, globalState.f28, v26[628] := i1, !((multiset(v29))[f30 := i1] <= v30), fm33(fm33(v27.f40, v26[628], |v31|, globalState), |v33[v32 := p2]|, i1, globalState), i1;
			var v34: set<bool> := {f29, v27.f40, p1};
			var v35 := DC21(v34);
			var v36: seq<bool> := [p1];
			v35 := fm50(f29, i1 / i1, f30 + p0, if (v27.f40) then v36 else [f29], globalState);
		...
		for i2 := p2 % |v39| to p2 {
			...
			v40 := (if (p1) then multiset{true, f29} else v40) * multiset(fm35(v43, v26[628], globalState) + v38);
			var v44 := DC29(v26[628], i2, false);
			var v45: map<bool, bool> := map[p1 := f29];
			globalState.f28 := v44.cf48 in v45;
			var v46: multiset<int> := multiset{i2, v26[628], i2, v26[628], p2};
			var v47 := DC10(v46);
			...
			if (v26[628] < v26[628]) {
				globalState.f21 := i2;
				globalState.f28 := f29;
				globalState.f17 := new int[21](i3 => i3 + v26[628]);
				v41 := v41;
				...
				globalState.f18, v50[168], v51, globalState.f28 := v49.f37, v49.f37, v51, p1;
			}
		...
		v52[647] := map v54 : int | v54 in multiset{fm36(globalState), |v56|, v26[628], -0x39} :: (v54 / p2) := (v26[628] / |map[0x5d := p2]|);
		r0 := p1;
		var v57: multiset<int> := multiset{v26[628]};
		r1 := fm34(p2 - v26[628], -0x50 + p2, f29, v57 <= multiset{p2, p2}, globalState);
	}
}
...
class C7 extends T1 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<seq<bool>>, r1: bool) {
		...
		v1[911] := v0;
		var i0 := 0;
		while (fm33(false, 689, v1[911], globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v7, v8, v1[911], globalState.f21, r1 := v7, v8, -0x67, v5.f38, !!fm10(v5.f38, v5.f38, globalState);
			var v9: seq<bool> := [p0];
		...
		var v16: seq<array<int>> := [v3, v15[v0], v3];
	...
	method m3(p0: bool, p1: array<string>, p2: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		var v4: array<bool> := new bool[1] [!(v0 == v3[p2])];
		v4[964] := f32;
		v4[964] := f31;
		v4 := v4;
		r1 := f31;
		...
		var v7: multiset<bool> := multiset{f31, f31, v2[fm36(globalState)], true};
		var v8: map<bool, bool> := map[v7 == v7 := !(p2 != p2)];
		var v9 := DC10(v6);
		globalState.f13, v5[906], v6, globalState.f19, v4 := p0, |v8|, v9.cf18, p2 * p2, v4;
		...
		var v16 := 'd';
		var v17: set<string> := {(seq(0x173, i1  => ('o')))[p2 := v16], "mmynhama"};
		var v18 := DC17(v17);
		var v19 := DC20(v18);
		v13[187], v14, globalState.f21 := p1, map v15 : string | v15 in v17 :: (v15) := (|v6|), match v19 {
			case DC17(cf27) => p2
			case DC18() => |f30|
			case DC19(cf28, cf29, cf30) => 0x21a
			case DC16(cf26) => v5[906]
			case DC20(cf31) => v5[906]
		};
		var v20: seq<string> := [f30, seq(-759, i2  => (v16)), if (true) then f30 else (f30[p2 := 'i'])[|v1| := v16], "o" + "mjfyn", f30];
		r0 := v20[p2];
		r1 := -v5[906] >= -(p2 * 0x59);
	}
	method m4(p0: int, p1: int, globalState: GlobalState) returns (r0: bool, r1: array<char>, r2: int, r3: set<seq<int>>) {
		...
		match (v12) {
			case DC35(cf57, cf58) =>
				...
				if (p1 >= p1) {
					globalState.f2 := fm36(globalState) - (v2.f34 / v2.f34);
					...
					var v25: seq<int> := [|v24|];
					var v26 := new C1(fm44(v2.f33, |(seq(0x275, i2  => (v2.f34)))|, v2.f33, v2.f33, globalState) != v25);
				} else {
					...
					v7[100] := v30.cf90 % v30.cf90;
					v7[100] := -602;
					var v32: map<int, int> := map[622 := |(map v31 : int | v31 in (seq(190, i3  => (v2.f34))) :: (v31 % v2.f34) := (v2.f34))|];
					globalState.f19 := |v32| * v2.f34;
				}
				
				var v33: seq<int> := [p0];
				if (!(((seq(0x12d, i4  => (899))) + (seq(-0x1f5, i5  => (v2.f34)))) <= v33)) {
					v4 := v4;
					globalState.f13 := !(cf58 || (cf57 < f30));
					v11 := v11 * v11;
					v7[538] := p1;
					v7[538], globalState.f18, f30, globalState.f19, globalState.f17 := v33[847 - |v33|], if (v2.f33) then v2.f33 else cf58, if (v2.f33) then fm34(p1, v2.f34, f31, !fm33(f29, p1, 0x350, globalState), globalState) + cf57 else "c" + f30, v2.f34, v7;
					...
					var v36: map<bool, string> := map[v2.f33 := fm20(v0[894], v0[894], v35, v2.f34, globalState)];
					globalState.f18, globalState.f11, globalState.f1, globalState.f14 := v11 > v11, f30 + fm34(|v34|, |(if (false in v36) then v36[false] else cf57)|, f31, v0[894], globalState), v33[v2.f34 + v2.f34], p1;
					var v37: set<array<int>> := {v7};
					var v38: seq<set<array<int>>> := [v37];
					var v39 := new C2(v2.f34, v38[v2.f34], f29, f30);
					var v40: multiset<array<int>> := multiset{v7, v7};
					var v41: array<bool> := new bool[20];
					var v42: multiset<array<bool>> := multiset{v41, v41};
					v0[894] := (multiset{v7} + v40) >= (v40 + v40[v7 := |v42|]);
			...
			case DC36(cf59, cf60, cf61) =>
				...
				globalState.f13 := v44[fm9(globalState)];
				v7[139] := v2.f34;
				var v45: set<int> := {|(seq(0xfa, i6  => (v4)))|};
				v7[139] := p0 + (|v45| - p1);
				var v46 := DC10(v11);
				var v47 := DC12(v46);
				match (if (f29) then v47 else v47) {
					case DC11(cf19, cf20) =>
						...
						var v50: map<bool, multiset<C1>> := map[cf20 := multiset{v48, v48, v49[v2.f34], v48}];
						var v51: map<map<bool, multiset<C1>>, bool> := map[v50 := if (v7[139] in v8) then v8[v7[139]] else !false];
						var v52: multiset<C1> := multiset{v48};
						var v53: seq<int> := [p1, -v7[139], |v44| + |{v7[139], v2.f34, p0}|, p1];
						globalState.f28, v7[139], globalState.f7 := if ((v50 + map[cf61 := v52]) in v51) then v51[v50 + map[cf61 := v52]] else f31 <==> cf19, (v2.f34 % v2.f34) - v2.f34, v53;
						var v54: seq<D3> := [v47, fm29(v2.f33, v7[139], cf61, globalState)];
					...
					case DC12(cf21) =>
						...
						v62[412] := v45;
						v62[412] := if (v2.f33) then v45 else {|f30|, v2.f34} * v45;
						var v63: T0 := new C1(cf61);
						var v64: seq<T0> := [v63];
						var v65: array<T0> := new T0[11] [v63, v63, v64[p1], v63, v63, v63, v63, if (f29) then v63 else v63, v63, v63, v63];
						v65[472] := v63;
						v0[667] := fm19(v4, globalState);
						var v66: array<string> := new string[29](i9 => "agpxc");
						v66[67] := seq(0x366, i10  => (v4));
						globalState.f18, v65[472], v0[667], globalState.f21, v66[67] := v2.f33, v63, v2.f33, -0x3af, "wrfecmi";
						var v67: map<string, bool> := map[f30 := v0[667]];
						var v68: seq<int> := [p0, |fm7(-v2.f34, globalState)|, v2.f34, v2.f34, v7[139]];
						globalState.f7, globalState.f7, v67 := if (f32) then v68 else [v2.f34], v68 + v68, map[f30 := v0[667]];
						var v69: C0 := new C0(v62[412] !! v62[412]);
						v69 := new C0(v11 == v11);
				}
			...
			case DC37(cf62, cf63) =>
				if (if (-0x167 <= p0) then if (v2.f33) then cf63 else false else v2.f34 >= p1) {
					var v70: array<string> := new seq<char>[6](i11 => seq(0x226, i12  => (v4)));
					v70[274] := seq(-0x19f, i13  => (v4));
					v70[274] := f30 + (seq(0xcd, i14  => ('g')));
					var v71: map<bool, char> := map[v2.f33 := v4];
					var v72: seq<map<bool, char>> := [v71];
					var v73 := DC8(v4, f31);
					globalState.f18 := if (cf62 in v8) then v8[cf62] else |(v72[p0])[cf63 := v73.cf12]| > -222;
					globalState.f20, globalState.f1 := (f30 + v70[274]) + (seq(0x31b, i15  => (v4))), |{|map[v2.f33 := -v2.f34]|, v2.f34}| / v2.f34;
					var v74: seq<string> := [v70[274], f30, "pbew", v70[274], f30];
					v8 := v8[|(v74 + v74)| := f32];
				...
				v79 := multiset{f31, v2.f33} + (v79[cf63 := |v80|] + multiset(v82[v2.f34]));
			case DC34(cf56) =>
				...
				match (v85) {
					case DC7(cf11) =>
						var v86: map<int, string> := map[v2.f34 / v2.f34 := f30];
						v86 := v86[p1 := seq(0x297, i16  => ('x'))];
						globalState.f13 := cf11;
						globalState.f1 := -p1;
						var v87: seq<bool> := [f32, f32, p1 >= v2.f34];
						globalState.f13 := v87[|(f30 + f30)|];
					case DC8(cf12, cf13) =>
					...
					case DC6(cf10) =>
						...
						v99, v100, v101 := v102[|v103| + -v2.f34], v100, v101.(cf56 := cf56);
						...
						v112[499] := v111;
						v108, v0[548], v109[233], globalState.f2, v112[499] := fm53(!fm6(v2.f34, globalState), v2.f34, f30, p0, globalState), v2.f33, v110, 0x180, fm22(if (f31) then |v111| else v2.f34, v2.f33, v4, globalState);
				}
				
				v0[67] := v2.f33;
				var v113: seq<bool> := [f29];
				v0[67] := v2.f33 && (!f29 in v113);
				globalState.f15 := DC52(v0[67], v2.f33, v2.f34, v11).cf89;
		...
		v114[315] := map[f31 := v0] + v115;
		var v116: set<string> := {f30};
		var v117: seq<string> := ["rjcvfdu", "lnab"];
		globalState.f19, globalState.f18, v114[315], f30, v116 := v2.fm5({false}, globalState), v2.f33, v115, (f30 + v117[-0x32b]) + (f30 + f30), v116;
		if (f29) {
			var v118: multiset<array<bool>> := multiset{v0};
			if ((v118 + v118) != v118[v0 := |map[v4 := f32]|]) {
				globalState.f20 := f30;
				var v119: array<map<string, int>> := new map<string, int>[14];
				var v120: array<string> := new string[16](i17 => f30);
				var v121: seq<int> := [p1, p0];
				var v122: map<array<string>, map<string, int>> := map[v120 := map[seq(360, i18  => (v4)) := |v121|]];
				var v123 := DC45(v2.f34, p1, v2.f33, f31, v120);
				var v125: map<string, int> := map[f30 := |f30|];
				v119[159] := if (v123.cf80 in v122) then v122[v123.cf80] else map v124 : string | v124 in v125 :: (v124) := (p0);
				v119[159] := v125;
				...
				var v131 := DC50(if (v129[v2.f34] in v128) then v128[v129[v2.f34]] else f31, true, v130);
				...
				globalState.f15 := v8 != ((map v132 : int | v132 in v134 :: (v132 / p1) := (f29)) + v8);
				...
				v135[634] := v7;
				v135[634] := if (v2.f33) then v7 else if (v2.f33) then v7 else v7;
			}
			
			var v136: map<array<int>, bool> := map[v7 := v2.f33];
			var v137: seq<array<int>> := [v7];
			var v138: map<bool, int> := map[f29 := v2.f34];
			v136 := v136[v137[if (f32 in v138) then v138[f32] else p0] := true || !f32];
			globalState.f11 := f30;
			var v139: set<bool> := {f29, f29, f31, f31, v2.f33};
			v7[200] := v2.fm5(v139, globalState);
			var v140: seq<int> := [fm9(globalState)];
			globalState.f28, v7[200] := f32, if (f32) then |v140| else v2.f34;
			if (if (f31) then v5.cf53 else f29) {
				...
				v143 := v144[v2.f34];
				globalState.f19, globalState.f18, v7[200] := v7[200], !v2.f33, v2.f34 / (p0 - v2.f34);
				...
				v148[496] := v140;
				globalState.f15, v7[200], v148[496], globalState.f18 := f32, p1, if (v2.f33) then (seq(0x28c, i20  => (p1))) + v140 else v140 + v140, v2.f33;
				globalState.f2 := -v7[200];
			...
			if (v2.f33) {
				...
				v150[609] := v151;
				globalState.f7, v150[609] := v151, (v151 + [|f30|, 0x3c5, v151[v2.f34], v2.f34, fm36(globalState)]) + v151;
			} else {
				...
				var v155: array<map<int, int>> := new map<int, int>[2](i21 => map[|v8| := |(seq(0xc2, i22  => (v2.f34)))|]);
				...
				v159[549] := v117[|v153|];
				globalState.f20, globalState.f28, v159[549], globalState.f15 := "y", fm6(|(seq(0x239, i24  => (p0)))|, globalState), f30, v152[p0];
			}
			
			var v160: seq<int> := [p1, v2.f34];
			v7[991] := if (f29) then p1 else v160[p0];
			var v161: set<int> := {v2.f34, -|(seq(0x261, i25  => (v4)))|, v2.f34};
			v7[991] := v2.f34 / |v161|;
		...
		if ((v163 * v163) > (if (false) then v163 else v163)) {
			...
			var v168: map<char, int> := map[v166[53] := |v167|];
			var v169: map<string, int> := map[f30 + f30 := if (v4 in v168) then v168[v4] else p1];
			var v170: C6 := new C6(true, f30);
			var v171: seq<C6> := [v170];
			var v172: seq<int> := [v164.f36, |v171[|f30| := v170]|];
			v169 := (v169 + v169) + (v169 + map[f30 := |v172|]);
			var v173: map<int, int> := map[p0 * p1 := v2.f34];
			var v174: seq<D2> := [DC8(v166[53], v164.f35), DC8(v166[53], true).(cf12 := v4)];
			v173 := v173[v2.f34 % |fm35(v174, v164.f36, globalState)| := 0x3d4];
		} else {
			var v175: seq<int> := [p0];
			...
			v177[98], globalState.f11, globalState.f15 := if (v2.f33) then v7 else v7, f30, v178.cf54;
			v177[98][471] := -|f30|;
			...
			v177[98][471], globalState.f13 := v2.f34, (set v179 : map<bool, D11> | v179 in (seq(0x19c, i26  => (map[f29 := DC36(DC23(v2.f33, |[v2.f33]|), {false}, f29)]))) :: (v179)) == v184;
			...
			var v189: map<int, int> := map[v2.f34 := v177[98][471]];
			var v190: set<map<int, int>> := {v189};
			v188[586] := v190;
			var v191: seq<C5> := [v185, v185];
			v177[98][471], v185, v186[726], v188[586] := 493, v191[p0], v187, v190;
			var v192 := new C1(f31);
		}
			...
			decreases 100 - i27
		{
			...
			if (v2.f33) {
				var v194: C3 := new C3(f31, v2.f34, f31, seq(0x310, i28  => (v4)));
				v194 := v194;
				v0 := v0;
				v0[695] := p1 <= |v1|;
				v0[695] := (if (!f32) then -p1 else v2.f34) <= -(if (v2.f33) then v194.f36 else |f30|);
				globalState.f1 := p1;
				var v195 := DC35(f30, f32);
				var v196 := DC9(v195.cf57, v194.f36, v2.f33, |v11[v2.f34 := v194.f36]|);
				...
				var v200: set<int> := {p1};
				var v201: map<bool, bool> := map[v2.f33 := (set v199 : int | (555 <= v199) && (v199 < 0x380) :: (v199 / p0)) !! v200];
				var v202: set<bool> := {v2.f33};
				v201 := v201[f31 !in v202 := f31];
				var v203: map<string, bool> := map[f30 := v193[v2.f34]];
				...
				v7[359] := v2.f34;
				v4, v7[359], globalState.f15 := v4, p1 + v2.f34, f30 != "jtnaivbv";
				globalState.f21 := |f30|;
				globalState.f13 := f31;
			}
...
class C8 {
	...
	method m0(p0: int, p1: array<int>, p2: array<array<bool>>, p3: int, globalState: GlobalState) returns (r0: bool) {
		...
		var v4 := DC2(v3, seq(0x269, i2  => ('c')), v0);
		var v5: seq<bool> := [v0];
		var v6 := "xnoahtmjj";
		var v7 := DC0(v0);
		v0, v2, globalState.f13, globalState.f11, globalState.f13 := !!match v4.(cf6 := v5[p0], cf5 := v6) {
			case DC0(cf0) => cf0
			...
			decreases 100 - i3
		{
			...
			v8[298] := DC1(v1, p3, fm0(p3, v0, v0, globalState)).(cf3 := p0);
			var v9 := DC3(v5);
			var v10 := DC1(v1, fm0(|v9.cf7|, v0, v0, globalState), p0);
			v8[298] := if (false) then v10 else DC1(v1, p0, p3);
			var v11: seq<int> := [p3, p3];
			var v12: map<int, string> := map[v11[p0] := "jr"];
			var v13: seq<array<int>> := [p1];
			var v14: array<seq<array<int>>> := new seq<array<int>>[21] [v13[858 := p1], if (v0) then v13 else [p1, p1], v13, v13, v13, v13, v13[p0 := p1], v13, v13, [p1, p1, p1], v13 + v13, v13, v13, v13, v13, v13, [p1, p1], v13, if (v0) then v13 else v13, v13 + [p1], v13];
			v14[828] := v13[p3 := p1];
			var v15 := 'e';
			var v16: map<int, seq<int>> := map[p0 := [p3]];
			globalState.f1, v12, v14[828], globalState.f21, globalState.f13 := if (v0) then p0 / -p3 else p0, v12, v13 + v13, p3, if (fm1(v15, |(if (p3 in v16) then v16[p3] else v11)|, -p3, v0, globalState)) then v0 ==> v0 else fm0(p0, v0, v0, globalState) > p3;
			var v17: array<string> := new string[9];
			v17[598] := v6;
			v17[598] := if ((fm0(-p3, v0, v0, globalState) + fm0(0x4a, v0, v0, globalState)) in v12) then v12[fm0(-p3, v0, v0, globalState) + fm0(0x4a, v0, v0, globalState)] else v6;
			var v18: set<bool> := {v0};
			globalState.f17, globalState.f7, globalState.f21, v18 := p1, v11, |v17[598]|, {v11 == [-0x198]};
		}
		match (v4) {
			case DC0(cf0) =>
				...
				v20 := v20;
				globalState.f20 := seq(0x114, i5  => (if (false) then 's' else 'g'));
				var v21 := 'r';
				v21 := v21;
			case DC1(cf1, cf2, cf3) =>
				var v22 := DC51(p0, p1);
				...
				var v32 := 'n';
				var v33: seq<seq<int>> := [v30[|(map v31 : D0 | v31 in map[v7 := v32] :: (v31) := (true))|]];
				var v35: map<bool, bool> := map[v0 := v0];
				var v36: map<seq<int>, int> := map[[|v5|, cf2] := |v35[!v0 := v0]|];
				var v42: array<set<seq<int>>> := new set<seq<int>>[24] [v28 - v28, v28, v28, v28, fm25(false, v0, v6, globalState) + (set v29 : seq<int> | v29 in multiset{v27, seq(0x341, i6  => (p3))} :: (v29)), fm25(v0, v0, "t", globalState), set v34 : seq<int> | v34 in v30 :: (v34), v28, v28, {[|v35|], v27} * (set v37 : seq<int> | v37 in v36 :: (v37)), set v38 : seq<int> | v38 in v36 :: (v38), v28, v28 * v28, v28 - {v27}, (set v39 : seq<int> | v39 in v33 :: (v39)) - v28, v28, v28, v28 * v28, v28, v28 * v28, set v41 : seq<int> | v41 in (set v40 : seq<int> | v40 in v30 :: (v40)) :: (v41), {v27, v27}, v28, v28];
				v42[515] := v28;
				v42[515] := v28;
				var v43 := DC28(v5, v0, v27[|{cf2}|], true, v0);
				globalState.f19 := v43.cf43;
				globalState.f1 := p0;
			case DC2(cf4, cf5, cf6) =>
				var v44: map<int, bool> := map[|multiset{v0, true}| := cf6];
				var v45: seq<array<int>> := [p1];
				var v46: map<map<int, bool>, array<int>> := map[v44 := v45[-p0]];
				var v47: map<bool, int> := map[cf6 := |"l"|];
				var v48: map<int, array<int>> := map[|v47| := p1];
				var v49: array<array<int>> := new array<int>[19] [if (v0) then p1 else p1, p1, p1, p1, p1, if (v44 in v46) then v46[v44] else p1, p1, p1, p1, if (|(seq(-0x395, i7  => ('g')))| in v48) then v48[|(seq(-0x395, i7  => ('g')))|] else p1, p1, p1, if (fm0(p3, v5[-|v44|], cf6, globalState) in v48) then v48[fm0(p3, v5[-|v44|], cf6, globalState)] else p1, p1, p1, p1, p1, if (false) then p1 else p1, p1];
				v49[916] := if (v0) then p1 else p1;
				v49[916] := p1;
				var v50 := 'u';
				var v51 := DC8(v50, cf6);
		...
		if (v0) {
			...
			match (v59.(cf7 := v5)) {
				case DC4(cf8) =>
					...
					p1[653] := if (v1 in v60) then v60[v1] else p3 - p0;
					var v61: multiset<int> := multiset{p0, p3};
					var v62 := new C7(cf8, cf8 ==> fm10(|v6|, p1[653], globalState), v61 <= v61, v6);
					var v63 := new C1(true);
					var v64: set<string> := {seq(0x15d, i8  => (v55))};
					var v65: array<int> := new int[15](i9 => i9 / |v6|);
					var v66: map<array<int>, bool> := map[v65 := fm6(p1[653], globalState)];
					cf8 := (|v64| - |v66|) == p0;
				case DC3(cf7) =>
					v1[657] := v0 ==> v0;
					var v67: multiset<seq<bool>> := multiset{cf7};
					v1[657] := v67 < multiset{v5};
				...
				case DC5(cf9) =>
					...
					p1[394] := p0;
					p1[394] := 360;
					var v73: multiset<int> := multiset{p1[394]};
					var v74: array<int> := new int[20] [p1[394], p0, p3, p3, p3 - |v73|, p0, p0, p0, -0x261, p1[394], fm0(p0, v0, v0, globalState), p3 + p3, p3, |v6|, -0x345, p3, p3, fm9(globalState), |v73|, p1[394]];
					var v75: seq<string> := [v6];
					v55, globalState.f17, p1[394], globalState.f11 := v55, v74, -p1[394] / |(v6 + v6)|, v75[0x16f] + (if (v0) then v6 else seq(0x3b6, i10  => (v55)));
					var v76 := new C7(v0, v0, v0, (v6 + (seq(0x3e6, i11  => (v55))))[p0 := v55]);
			}
			...
			if (!(if (v79[p0] in v78) then v78[v79[p0]] else v0)) {
				globalState.f13 := !v0;
				var v80: seq<int> := [p0, p0];
				globalState.f19 := |v80[-|multiset{v0, v0}| := p0]|;
				var v81: map<array<int>, int> := map[p1 := p3];
				v81 := (v81 + v81) + v81;
				v77[588] := "rpkac";
				v77[588] := v6;
				var v82: multiset<seq<int>> := multiset{v80};
				globalState.f1, globalState.f15, globalState.f13 := |v82[v80 := p0]|, (v6 + v6) != (v6 + v77[588]), !v0;
			} else {
				p1[65] := p0;
				...
				v86 := v86;
				v1 := v1;
				globalState.f13 := !fm19(v6[p1[65]], globalState);
			}
	...
	method m1(p0: seq<int>, globalState: GlobalState) returns (r0: int) {
		...
		if (false) {
			...
			var v10: seq<seq<multiset<int>>> := [(if (true) then [v1, v1] else v9)[v0 := v1]];
			v9 := v10[|p0|];
			...
			if (if (v7.f33) then v7.f33 else v7.f33) {
				...
				var v16 := 'h';
				var v17: array<seq<char>> := new seq<char>[20] [[v16], v6, [v16], v6, (seq(-964, i3  => (v16)))[v7.f34 := v16], v6, v6, v6, v6, v6, v6, v6, v6, ['i'], v6, v6, v6, v6, v6, v6];
				v15[349] := v17;
				var v18: array<int> := new int[9](i4 => i4 * v0);
				v18[801] := -p0[v0];
				v15[349], globalState.f15, v18[801] := v17, v0 > v0, -0xf1;
				var v19: seq<bool> := [v7.f33];
				globalState.f18 := v19[v7.f34];
				...
				v29[667] := v26;
				var v30: C3 := new C3(v7.f33, v7.f34, false, seq(-0x318, i5  => (v20)));
				var v31: seq<C3> := [v30, v30];
				v23[773], v1, globalState.f13, globalState.f7, v29[667] := v24, v1[fm36(globalState) := -|v21[!false := |v31|]|], v25[v0], p0 + p0, v26 + v26;
				var v32: array<int> := new int[4] [v7.f34, |v6|, v7.f34, v7.f34];
				var v33 := DC38(v32);
				v2[528] := v25[-v7.f34];
				var v34: T0 := new C4(v7.f33, |v6|);
				v33, v2[528], globalState.f19, v34, v21 := if (v7.f33) then v33 else v33, !fm1('o', |map[v5 := 673]|, v7.f34, !v5, globalState), 0x196, v34, v21;
			}
			...
			if (!(if (true) then v7.f33 else v7.f33) && v7.f33) {
				globalState.f14 := v0 % v7.f34;
				var v40: multiset<bool> := multiset{v5, v7.f33, v7.f33, v7.f33, v7.f33};
				globalState.f28 := (v40 * v40) !! v40[v7.f33 := v0];
				var v41: set<bool> := {v7.f33};
				var v42: map<int, int> := map[|v41| := |v6|];
				var v43: array<int> := new int[19] [|(v1 - v1)|, v7.f34, v7.f34 / v7.f34, |"kljunxavc"|, v7.f34, v7.f34, -0x16f, v0, if (179 in v42) then v42[179] else v7.f34, v0, v7.f34, v7.f34, v7.f34, fm36(globalState), v0, v7.f34, v7.f34 / v7.f34, if (v7.f33) then |"xgc"| else v7.f34, --v7.f34];
				globalState.f17 := v43;
				globalState.f14 := v0 / v7.f34;
				v43[527] := -v0;
				v43[902] := v0;
				v43[527], v43[902] := v7.f34, 0x135;
			} else {
				...
				globalState.f15 := v7.f33;
				globalState.f20 := v44[419] + v44[419];
			...
			var v50 := DC2(if (v0 in v48) then v48[v0] else v47, "umiruj" + v49[v0], v7.f33);
		...
		for i7 := v0 - -v7.f34 to v0 {
			...
			var v54 := 'r';
			var v55: C2 := new C2(|multiset{v7}|, v53, v5, v6[|v6| := v54]);
			v51[130] := v55;
			v51[130] := v55;
...
method Main() {
	...
	var v7: seq<int> := [|v4|, |(map v5 : multiset<int> | v5 in (seq(-0x1f0, i0  => (multiset{v3}))) :: (v5) := (['r', 's']))[v6 := seq(0x1fa, i1  => ('n'))]|];
	var v8 := "rqigbg";
	var v9: array<int> := new int[11];
	var v10: map<bool, array<int>> := map[false := v9];
	var v11: map<int, char> := map[v3 := v8[v3]];
	var v12 := 'l';
	var v13: map<char, bool> := map[if (v3 in v11) then v11[v3] else v12 := v0];
	var globalState := new GlobalState(true, 0x2d4, 0x82, v2, true, multiset{v3}, 288, v7, 643, 0x114, 0x287, v8 + (seq(-875, i2  => ('o'))), 0x2e5, false, 70, true, v10, v9, false, 0x2d3, v8, -758, v13, 0x35f, true, v8, 0x27d, false, true);
	if (!v0) {
		...
		match (v14) {
			...
			case DC1(cf1, cf2, cf3) =>
				...
				var v22: map<int, bool> := map[|(seq(0x2ca, i3  => (v12)))| := !v18.f29];
				var v23 := DC43(v22);
				...
				v24[254] := v23;
				v20, v21, v6, v24[254], globalState.f14 := v20, if (v0) then v21 else v21, (if (v0) then v6 else v6) - v6, v23, cf2 * |v1|;
				...
				v25[595], v3, globalState.f21 := v9, (if (v0 in v26) then v26[v0] else v3) - -fm36(globalState), |(v8 + (if (true in v27) then v27[true] else v18.f30))|;
			case DC2(cf4, cf5, cf6) =>
		...
		var v36: seq<map<bool, int>> := [v34, v34, v35[284]];
		var v37: map<bool, string> := map[true := v8];
		v30[694], globalState.f13, v32[691], v36, globalState.f11 := v31, true, map[v3 := v0], v36 + v36, if (v0 in v37) then v37[v0] else v8;
		...
		var v39: seq<bool> := [v0];
		var v40 := new C2(v3, {v9}, !v39[v3], v8);
		var v41: multiset<string> := multiset{v8, v8};
		v41 := fm55(globalState);
		var v42 := new C0(v0);
		v9[119] := |multiset{v0, v42.f37, v42.f37}|;
		v6, globalState.f2, v9[119], globalState.f15 := fm27(|v6|, v42.f37, globalState) + multiset{-916, v3}, |fm56(globalState)| - v40.f38, v40.f38, if (!v42.f37) then true else v0;
	...
	var v50 := DC28(fm35(v48, -251, globalState), v0, v3, v3 == DC1(v49, |v8|, v3).cf3, v7 < (seq(0x3c, i6  => (v3))));
	match (v50) {
		case DC28(cf41, cf42, cf43, cf44, cf45) =>
			var v51: array<multiset<int>> := new multiset<int>[29];
			v51[900] := v6;
			v51[900] := fm27(|(v8 + v8)|, true, globalState);
		...
		case DC29(cf46, cf47, cf48) =>
			...
			v9[151] := fm0(|v58|, v57.f31, cf48, globalState);
			v9[151] := v3;
			var v59: map<seq<int>, int> := map[v7 := |"wegckpd"|];
			var v60 := DC34(v59);
			v60 := v60;
			globalState.f21 := v9[151];
		case DC27(cf40) =>
			if (v0) {
				var v61: array<seq<string>> := new seq<string>[18](i7 => [v8, seq(0xe1, i8  => (v8[v3]))]);
				var v62: C6 := new C6(v0, v8);
				var v63: map<C6, string> := map[v62 := seq(0x274, i9  => (v12))];
				var v64: seq<C6> := [v62, v62];
				var v65: seq<string> := [if (v64[v3] in v63) then v63[v64[v3]] else v8, v8, v8, "elrvfpxmc"];
				v61[121] := v65;
				var v66: C0 := new C0(v0);
				var v67: seq<C0> := [v66, v66, v66, v66, v66];
				v3, globalState.f20, v61[121], v66 := v3, (v8 + v8) + v8, v65, v67[v3];
				...
				v71[120] := v8;
				v71[120] := v8 + ("ohllvco")[v70.f36 := v12];
			} else {
				globalState.f7 := cf40;
				...
				v76[213] := fm42(false, v0, globalState);
				v49[721] := v0;
				globalState.f15, v76[213], globalState.f2, v49[721], globalState.f15 := v3 != v3, 'j', -v3, v0, v0;
				var v77: array<string> := new string[7];
				var v78: map<int, array<string>> := map[|cf40[v3 := v3]| := v77];
				v78 := v78[0x309 := v77];
				var v79 := new C5(v0, v8);
				var v80: multiset<bool> := multiset{v49[721]};
				globalState.f13 := if (v12 in v13) then v13[v12] else v80[v0 := v3] <= multiset{v0, v0, v0};
			}
			
			m10(v12, v3, -976 >= fm0(v3, v0, v0, globalState), v0, globalState);
			var v81: map<bool, int> := map[v0 := 241];
			var v82: seq<array<bool>> := [v49, v49, v49];
			v49, v12, v81 := v82[v3], v12, v81;
	...
	if (v3 == v3) {
		...
		v9[176] := -(if (v3 in v83) then v83[v3] else |v1|) - |v87|;
		...
		v12 := v12;
		if (v0) {
			globalState.f1 := if ((v3 % |(seq(0x18a, i10  => (v12)))|) in v6) then v6[v3 % |(seq(0x18a, i10  => (v12)))|] else 0x294;
			var v93 := new C5(v0, v8);
			var v94 := new C7(v0, v0, v0, v8);
			globalState.f7 := v7;
			globalState.f19, globalState.f14 := v3 + (if (v3 in v6) then v6[v3] else v3), v3;
		} else {
			v49[858] := fm6(v3, globalState);
			v49[858] := v0 ==> v0;
			var v95: array<bool> := new bool[5] [v0, v49[858], v49[858], true, !v0];
			var v96: seq<array<bool>> := [v95, v95];
			globalState.f28 := v95 in v96;
			var v97: map<int, bool> := map[0x339 := v0];
			m10(if (fm19(v12, globalState)) then v12 else v12, v3, fm33(v49[858], v3, |v97|, globalState), fm36(globalState) < v3, globalState);
			var v98: set<array<int>> := {v9};
			var v99: C2 := new C2(v3, v98, v0, v8);
			var v100: set<C2> := {v99, v99};
			var v101: map<string, seq<int>> := map[if (v49[858]) then v8 else fm20(v0, v49[858], v92, |v100|, globalState) := v7];
			v101 := v101[v8 + v8 := fm44(v49[858], if (v99.f38 in v6) then v6[v99.f38] else v3, v0, v0, globalState) + v7];
			var v102: array<string> := new string[28](i12 => "ughfu");
			var v103, v104 := v99.m3(fm6(|(seq(0x1f6, i11  => (v8[v99.f38])))|, globalState), v102, v3 + v99.f38, globalState);
		}
	...
	match (v122) {
		case DC55(cf94, cf95, cf96, cf97, cf98) =>
			...
			v124, globalState.f2, globalState.f15 := v124, v121.f34 % |v7|, v126 == v128[0x1f3];
	...
	var v135: multiset<string> := multiset{v8, seq(-956, i17  => (v12))};
