...
function fm10(p0: set<bool>, p1: char, p2: D2, p3: int, globalState: GlobalState): seq<bool> {
	[(set v0 : int | (0x19a <= v0) && (v0 < 0x2d5) :: (v0 - |"tsnmoy"|)) <= (set v2 : int | v2 in (map v1 : int | (0x123 <= v1) && (v1 < 256) :: (v1 / |{-0x127, -|multiset{-0x251, 360}|}|) := (true)) :: (v2 * 0xd0)), false, 0x1de !in {-756, |(seq(-0x2c5, i0  => (|[-|map[|"rdw"| := 'm']|, |(seq(497, i1  => (|"smixm"|)))|, 0x152]|)))|}, true]
}
...
function fm14(p0: string, p1: int, globalState: GlobalState): string {
	"dybqgrbwg" + ("wxkb" + (seq(756, i0  => ('p'))))
}
function fm15(p0: bool, p1: bool, globalState: GlobalState): seq<int> {
	DC16(seq(0x12c, i0  => (-0x208))).cf22 + [0x1a5, |{false}|, 0x1d5]
}
...
function fm26(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): D2 {
	match DC10(DC10(DC9(528)).cf12) {
		...
		case DC8(cf10) => DC7(0x152, map[map[false := false] := -77], |(seq(373, i0  => ('o')))|)
		case DC10(cf12) => DC7(|(seq(115, i1  => ('k')))|, map v1 : map<bool, bool> | v1 in [map[true := false], map[true := true]] :: (v1) := (0x2fa), 0x6b)
	}
}
function fm27(globalState: GlobalState): string {
	if (false ==> !false) then "j" + (seq(455, i0  => ('o'))) else seq(0x346, i1  => ('p'))
}
...
function fm31(globalState: GlobalState): multiset<D0> {
	(multiset{DC2(DC0(map[|multiset{multiset{-0x1db}}| := false])), DC2(DC2(DC0(map[|"jgwt"| := true]))), DC2(DC2(DC0(map v0 : int | v0 in (seq(-0x3d5, i0  => (|map[-|multiset{|(seq(0x118, i1  => ('c')))|}| := !false]|))) :: (v0 + 0x326) := (true))))} * multiset{DC2(DC0(map[-|[true]| := false]))}) * (multiset{DC2(DC2(DC1(true))), DC2(DC1(false)), DC2(DC2(DC1(true)))} * multiset{DC2(DC2(DC2(DC2(DC1(true)))))})
}
function fm32(p0: seq<seq<bool>>, globalState: GlobalState): seq<D3> {
	[DC9(-|[|multiset{!true}|, |map[|(seq(0x2f2, i0  => ('a')))| := false]|]|), DC9(-|multiset{|multiset{false}|, 678, 0x32d, |{0x3cd, 0x3e, --0xdd, |map[true := !true]|, |[true]|}|}|)] + [DC9(-0x197)]
}
...
method m0(p0: bool, p1: char, p2: int, p3: map<bool, int>, globalState: GlobalState) {
	...
	var v4: seq<bool> := [p0];
	var v5: set<int> := {-|v4[p2 := !p0]|, p2, p2, 947};
	if ((-(if (true in p3) then p3[true] else |v3.cf41|) % p2) in v5) {
		globalState.f0 := p0;
		var v6: C2 := new C2(p0);
		v6 := v6;
		var v7 := "osmkakap";
		v7 := (seq(0x3e1, i0  => (p1))) + "baefwmqnu";
		...
		v11[776] := fm14(v7, p2, globalState);
		v11[776] := v7 + v7;
	} else {
		...
		var v15: map<int, int> := map[-fm0(|v14|, p2, |v14|, p0, globalState) := |(seq(561, i2  => (p2)))|];
	...
	if (fm1(p0, globalState)) {
		...
		v17[884] := !false;
		if (p0) {
			var v18: array<int> := new int[5](i4 => i4 % p2);
			...
			var v28: set<bool> := {v17[884], p0};
			var v29: array<int> := new int[21] [p2, p2, p2 - |v19|, p2, p2, p2, p2, p2, if (p0 in p3) then p3[p0] else -fm0(|v20|, p2, |v21|, p0, globalState), |v23|, -p2, p2, p2, p2 / -p2, if (p1 in v26) then v26[p1] else p2, p2, -p2, p2, -|(v27 + v27)|, |v28|, p2];
			var v30: C0 := new C0(v17[884], v17);
			var v31: set<C0> := {v30};
			var v32: map<int, seq<int>> := map[|multiset{p2, |v31|}| := seq(0x250, i5  => (|"pbcudgtk"|))];
			var v33: seq<int> := [p2];
			v29[420] := |((if (p2 in v32) then v32[p2] else [552]) + v33)|;
			var v34: array<string> := new seq<char>[25](i6 => seq(209, i7  => (p1)));
			v29[420], globalState.f2, globalState.f5, v34 := p2, "agjcjgg" < (v21 + (seq(944, i8  => (p1)))), p2, v34;
			globalState.f2, globalState.f5, v29[420] := p0, fm0(v29[420], v29[420], p2, p0, globalState), v29[420] * v29[420];
			var v35: C4 := new C4(v29[420]);
			...
			var v40: seq<int> := [p2];
			var v41: C2 := new C2(v4[v40[p2]]);
			v39[618] := v41;
			v39[618] := new C2(v41.f13);
			globalState.f2 := p0;
			var v42: T0 := new C2(p0);
			var v43: map<T0, int> := map[v42 := p2];
			var v44: map<int, bool> := map[|v43| := v17[884]];
			var v45 := DC0(v44);
			v2 := multiset{!(false && v17[884]), !v41.fm4(v45, v45, v2, globalState)};
			var v46 := "colybgq";
			var v47: map<string, seq<int>> := map[v46 := v40 + [0x28c]];
			var v48: seq<seq<int>> := [seq(0x83, i9  => (p2))];
			v47 := v47["tqy" := v48[-0x390]];
			var v49 := new C3(p2);
		}
		...
		var v54: map<bool, seq<seq<D7>>> := map[v17[884] := v53];
		v17[884] := |(if (p0 in v54) then v54[p0] else v53)| <= -(if (true) then -279 else p2);
	} else {
		...
		v57[755], v59, v60[504], v62, globalState.f2 := v63.cf59, v59, |fm8(p0, v65, v66.cf6, globalState)|, v62, (v68 !! v68) && v67.f13;
		var v69 := new C0(p0, v61);
		var v70: T0 := new C1();
		var v71: set<T0> := {v70, v70, v70, v70};
		var v72: seq<int> := [|v71|, p2];
		v60[504] := -((v56.f9 % p2) / |v72|);
		v55 := v55;
		var v74: seq<seq<bool>> := [[v69.f10, v67.f13]];
		var v75: map<map<seq<bool>, int>, array<int>> := map[map v73 : seq<bool> | v73 in v74 :: (v73) := (|v72|) := v60];
		var v76: map<seq<bool>, int> := map[v4 := v60[504]];
		v60 := if ((v76 + v76) in v75) then v75[v76 + v76] else v60;
	}
	
	var v77: array<int> := new int[20](i11 => i11 / |{p0}|);
	var v78: map<bool, array<int>> := map[p0 := v77];
	globalState.f5 := (p2 * |v78|) % fm0(p2, fm0(0x332, p2, |"dmpivcli"|, p0, globalState), p2, p0, globalState);
...
class C0 extends T1 {
	...
	method m1(p0: int, p1: array<array<int>>, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		var v9: array<array<map<int, int>>> := new array<map<int, int>>[21] [v5, v5, v5, v5, v5, v5, v5, v6.cf3, v5, v5, v5, v5, if (f10 in v7) then v7[f10] else v8[517], v5, if (f10) then v5 else v5, v5, v5, v5, v5, v5, v5];
		v9[88] := v5;
		v9[88], globalState.f5, r1 := v5, fm0(|v0|, p2, p0, f10 <==> !f10, globalState), p0;
		...
		if (!true) {
			...
			v13 := [f10] + (v13 + v13);
			var v14: array<int> := new int[7](i1 => i1 % p3);
			v14 := v14;
			r1 := p0;
			globalState.f0 := f10;
		} else {
			var v15: multiset<bool> := multiset{f10};
			globalState.f2 := (fm7(globalState) + v15[f10 := p3]) > v15;
			r0 := true;
			var v16: array<int> := new int[13](i2 => i2 - p0);
			v16 := v16;
			var v17: seq<bool> := [false];
			f11[773] := v17[p2 := v17[|v17|]] <= v17;
			f11[773] := p3 >= p2;
			if (f10) {
				globalState.f5 := fm0(p3, p3, p2, f11[773], globalState);
				globalState.f0 := fm1(false, globalState);
				var v18: map<int, bool> := map[p3 := f11[773]];
				var v19: map<int, int> := map[|v18| := p2 / 0x2aa];
				...
				var v23: map<bool, bool> := map[f11[773] := f10];
				var v24: map<bool, int> := map[f11[773] := (if (fm0(p2, |v23|, p2, f10, globalState) in v22) then v22[fm0(p2, |v23|, p2, f10, globalState)] else p0) * -p0];
				v24 := v24[f10 := p0 - p0];
				var v25: map<int, bool> := map[p3 := f10];
				v16[317] := -0x3d9;
				var v26 := DC0(v25);
				var v27: set<char> := {v21};
				v25, v16[317], v6, globalState.f0 := v26.cf0, 0x2bb, v6.(cf3 := v9[88]), if (v27 > v27) then f10 else f11[773];
		...
		var v31: seq<int> := [p0];
		var v32: map<int, int> := map[v31[p0] := -p0];
		r1 := |v32| - (-p3 - p3);
		r0 := f10;
		...
		var v37: map<bool, int> := map[fm4(v34, v34, v35[f10 := p0], globalState) := p3];
...
class C1 extends T0 {
	...
	method m1(p0: int, p1: array<array<int>>, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		v2.f11[154] := v2.fm4(v4, v5, if (p3 in v7) then v7[p3] else v6, globalState);
		var v8: seq<int> := [p0];
		var v9 := DC16(v8);
		globalState.f5 := fm0(p3, p2, 0x1da, v9.cf22 <= v8, globalState);
		for i0 := p2 to p0 {
			var v10 := DC17([v2.f10]);
			var v11: seq<bool> := [v2.f11[154], v2.f10, v2.f11[154], fm4(DC0(fm22(v2.f10, globalState)), v4, v6, globalState), true];
			...
			if (v10.cf23 in v12) {
				...
				v15 := fm23(v15[fm0(p0, p3, p2, v2.f10, globalState) := p3], p3, globalState);
				...
				var v20 := new C0(v2.f11[154], v2.f11);
				r0 := v2.f10 && true;
			}
			
			var v21 := new C0(v2.f11[154], v2.f11);
		...
		r3, globalState.f5, v0, r1, r1 := !(v0 <== v0), p3 / 0x28c, (v6 + v6) !! v6[v0 := -|multiset(v28)|], match v4 {
			case DC1(cf1) => 0x20f
			case DC0(cf0) => |{v0}| * p0
			case DC2(cf2) => |map[v2.f11[154] := v2.f11[154]]| % p0
		}, (p0 / p2) % -(p3 / p2);
		var v29: map<bool, bool> := map[v2.f11[154] := false];
		var v30: map<map<bool, bool>, int> := map[v29 := p0];
		var v31: seq<bool> := [v2.f11[154]];
		var v32 := DC7(p3, v30, |v31|);
		r0 := p3 > v32.cf9;
		r1 := p2;
		r2 := true !in (map[v0 := |v31|] + map[fm4(DC0(v3), v5, v6, globalState) := fm0(p2, p0, p2, v2.f11[154], globalState)]);
		r3 := v0;
	}
	method m6(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		if (p2) {
			...
			var v4: multiset<int> := multiset{|v3| / p1};
			...
			var v7: map<bool, seq<bool>> := map[v3[|v4|] := v3];
			...
			v8[572] := p1;
			var v10: array<map<bool, map<bool, int>>> := new map<bool, map<bool, int>>[6](i1 => map[p0 := map[p0 := |{{p1}, set v9 : int | v9 in [p1] :: (v9 % 0x2ce)}|]] + map[p0 := map[p0 := p1]]);
			var v11: map<array<bool>, bool> := map[v6 := p0];
			var v12 := DC23(v11);
			v10[659] := fm24(|v12.cf32|, globalState);
			...
			v8[572], v3, v10[659] := |v13|, v3, v15 + v15;
			var v16: seq<int> := [|"bodi"|, p1, p1, -0x1be, v8[572]];
			var v17: set<bool> := {!fm1(p2, globalState)};
			if ((v8[572] - v16[p1]) != (p1 - -|v17|)) {
				var v18 := DC13(v8[572], v6);
				v18 := DC13(v8[572], v6);
				globalState.f2 := -p1 < (v8[572] * |v5|);
				var v19: map<int, array<bool>> := map[v8[572] := v6];
				v19 := v19[p1 := v6];
				var v20: map<int, bool> := map[v8[572] := !!(p2 && p0)];
				globalState.f2, globalState.f5, globalState.f0, v0 := if (fm0(|v17|, v8[572], -0x77, p2, globalState) in v20) then v20[fm0(|v17|, v8[572], -0x77, p2, globalState)] else p0, 0x1b5, (v2.(cf6 := p2)).cf6, v0 + (v0 + v0);
				var v21 := new C0(p0, v6);
			} else {
				v6[481] := p2;
				var v22 := DC15(v8);
				v6, globalState.f5, v6[481], v8[572], v8 := v6, v8[572], p0, p1, v22.cf21;
				var v23: multiset<bool> := multiset{if (p0) then v2.cf6 else v3[v8[572]]};
				var v24 := DC0(fm22(p2, globalState));
				globalState.f5, globalState.f5 := -|v23|, -(fm26(v8[572], 0x385, false, fm4(v24, v24, v23, globalState), globalState)).cf9 / p1;
				var v26: map<int, multiset<int>> := map[|v0| := v4];
				var v27: map<int, multiset<int>> := map[(if (p1 in v4) then v4[p1] else v8[572]) * |(map v25 : int | (0x352 <= v25) && (v25 < 991) :: (v25 % 0x1a0) := (132))| := (if (|multiset{v6[481], p0}| in v26) then v26[|multiset{v6[481], p0}|] else v4) * v4];
				v27 := v27[p1 - p1 := v4];
				v6[481] := (p1 % p1) > (v8[572] + p1);
				var v28: array<map<bool, int>> := new map<bool, int>[1](i2 => if (false) then map[p2 := p1] else v14);
				var v29: array<bool> := new bool[8];
				v28, v8[572], r0, globalState.f5, v29 := v28, fm0(v8[572], p1, |v0|, !p0, globalState) + |v0|, v8[572], p1 + |[v16, v16]|, v29;
			}
			
			var v30: map<map<bool, bool>, int> := map[map[false := p2] := v8[572]];
			var v31 := DC7(p1, v30, v8[572]);
			var v32: array<D2> := new D2[7] [v31, v31, v31, fm26(v8[572], v8[572], p2, !true, globalState), DC7(p1, v30, 587), DC7(v8[572], v30, |v0|), fm26(p1, p1, !!p0, p2, globalState)];
			v32[368] := DC7(v8[572], v30, p1);
			v32[368] := v31;
			var v33 := DC14();
			var v34: seq<D4> := [v33, DC14(), v33];
			var v35 := 's';
			var v36: map<bool, array<bool>> := map[p2 := v6];
			var v37: set<int> := {v8[572], |v36| * -v8[572], 0x15e, p1, -0x392};
		...
		v48[294] := p1;
		r0 := p1;
		var v49: map<bool, int> := map[p2 := v48[294]];
		var v50: seq<int> := [0x141];
		var v51: map<int, bool> := map[v50[p1] := false];
		r0 := |fm2(p0, true, p2, v49 + map[if (v48[294] in v51) then v51[v48[294]] else p0 := p1], globalState)|;
		r1 := p0;
	...
	method m7(p0: bool, p1: bool, p2: multiset<bool>, p3: int, globalState: GlobalState) returns (r0: map<bool, int>, r1: bool, r2: array<set<bool>>, r3: int) {
		...
		var v7: array<bool> := new bool[17] [p0, p1, p1, p0, p0, {v0, v0} > {v0}, true, p0, p1, p0 && v2.cf6, v4 in v5, false, v6[p3 := p3] !! multiset{p3}, p1, p1, p0, p0];
		v7[160] := p0;
		var v8 := DC9(p3);
		v7[160] := match v8 {
			case DC9(cf11) => p1
		...
		match (v9) {
			case DC12(cf14, cf15, cf16, cf17, cf18) =>
				...
				v19[275] := fm28(cf17, |cf16|, v7[160], globalState);
				v19[275] := v10;
				r3 := 340;
			case DC13(cf19, cf20) =>
			...
			case DC14() =>
				...
				r3 := |v25.cf16|;
				var v26: array<string> := new seq<char>[24](i0 => (seq(-0x5c, i1  => (v0))) + "elvverckl");
				var v27: seq<string> := [v22, v22, v22];
				var v28: seq<bool> := [p0, p0];
				var v29 := DC21(p0, p1, v28, true, p3);
				var v30: set<bool> := {v28[|v29.cf28|]};
				v26[380] := (seq(0x27e, i2  => ('s'))) + v27[|v30|];
				v26[380] := v22;
				var v31 := DC0(v3);
				var v32: seq<multiset<bool>> := [multiset([true, p0])];
				var v33 := new C0(fm4(v31, DC0(map[0x2d8 := v7[160]]), v32[811], globalState), v7);
		...
		match (v40) {
			case DC15(cf21) =>
				...
				v41 := (v41 + v41) + v41[v0 := p3];
				globalState.f5 := p3;
				var v43: seq<int> := [p3];
				var v44: seq<map<int, bool>> := [v3 + (map v42 : int | v42 in v43 :: (v42 / -0x3ca) := (p1)), map[p3 := v7[160]], v3];
				v44 := (v44 + v44)[fm0(p3, p3, p3, v7[160], globalState) := fm22(p0, globalState)];
				var v45: array<string> := new string[9](i4 => "ipgn" + "uhyhwmg");
				var v46 := "knmngv";
				v45[544] := v46;
				v45[544] := fm27(globalState);
		}
		...
		var v50: map<bool, int> := map[v7[160] := -467];
		r0 := v50[p0 := p3];
		r1 := v7[160];
...
class C2 extends T0 {
	...
	method m1(p0: int, p1: array<array<int>>, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		var v10: map<bool, map<int, char>> := map[f13 := map v8 : int | v8 in v9 :: (v8 / p2) := (v1)];
		var v11: set<bool> := {f13, f13};
		var v12: map<bool, int> := map[f13 := |v11|];
		var v14: seq<map<int, char>> := [v2];
		var v15: seq<int> := [p0, -|v3|];
		var v17: array<map<int, char>> := new map<int, char>[28] [v2[p2 := v1], v2 + map[0x3b8 := v1], v2[p0 := v1] + v2, v2 + v2, (if (v5 in v7) then v7[v5] else v2) + v2, fm19(globalState), v2, v2 + v2, v2, v2[p2 := 'd'], if (f13) then map[-p2 := v1] else v2, v2, map[p2 := v3[p0]], (map[|map[f13 := f13]| := v1])[|(seq(617, i1  => (v1)))| := v1], map[p2 := v1], v2, v2[p3 := v1], v2, v2, v2, if (!f13 in v10) then v10[!f13] else v2, v2, v2, v2, map[p3 := fm20(-|v12|, f13, p3, globalState)], map v13 : int | v13 in v9 :: (v13 / p3) := (v1), v14[v15[|v3|]], (map v16 : int | (0x399 <= v16) && (v16 < -0x382) :: (v16 * p2) := ('s'))[p2 := v1]];
			...
			decreases 100 - i2
		{
			...
			r1 := (|map[p3 := f13]| % p2) - (|"mow"| + -p3);
			if (f13) {
				var v18: array<int> := new int[21](i3 => i3 + p2);
				v18[306] := p0 + p3;
				v18[306] := p0;
				var v19: array<bool> := new bool[7] [f13, false, if (f13) then v0[|v3|] else f13, f13, false, f13, f13];
				v19 := v19;
				var v20: T1 := new C0(true, v19);
				var v21: set<D2> := {DC5(v20)};
				var v22 := DC5(v20);
				v21 := if (f13) then {DC5(v20).(cf5 := v20), v22} else {DC5(v20), v22, v22, v22, v22};
				v12 := v12[true := v18[306] / p2];
				var v23 := DC6(f13);
				v18[306], globalState.f2, v18 := p3 * fm18(v23, -|fm21(globalState)|, p3, globalState), f13, v18;
			} else {
				var v24 := DC6(f13);
				...
				v26[167] := if (f13) then v1 else v1;
				v25[295], v26[167] := v25[295], v1;
				globalState.f2 := f13;
				globalState.f5 := p3;
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: multiset<int>, r2: map<string, bool>) {
		...
		for i0 := v0 to v0 {
			...
			if (v5 < (v5 + v5)) {
				...
				v2[634] := f13;
				v2[634] := f13;
				v8 := set v10 : int | (676 <= v10) && (v10 < 277) :: (v10 * DC7(v0, map[map[!true := v2[634]] := i0], v0).cf7);
				var v11: array<int> := new int[26];
				v11[525] := v0;
				var v12: map<bool, string> := map[v2[634] := seq(0x2be, i2  => ('f'))];
				var v13 := "d";
				var v14: seq<string> := [v13];
				globalState.f5, v2[634], v11[525] := if (f13) then v0 * v0 else v0 % |(if (false in v12) then v12[false] else "smmjmydnm")|, v14 != v14, i0;
			} else {
			...
			var v28 := 's';
			v25[337] := v26 * DC27(true, if (f13 in v27) then v27[f13] else i0, v28, v26).cf41;
			var v29: set<bool> := {!f13};
			var v30 := DC33(v29);
			v25[337] := multiset{f13, true, true, v30.cf47 <= v29};
		}
		var v31: array<D2> := new D2[6];
		forall i4 | 0 <= i4 < v31.Length {
			v31[i4] := DC7(-v0, map[map[f13 := f13] := v0], if (f13) then |"wlpnjgxrs"| else v0);
		}
		v0, globalState.f5 := v0, 0xb1 / v0;
		var v32 := new C1();
		for i5 := v0 / v0 to v0 {
			...
			var v43: seq<C0> := [v42];
			var v44: array<bool> := new bool[29] [fm1(f13, globalState), false, !f13, f13, f13, fm4(v34, DC0(v33), v35, globalState), v37 != v37, v38 > v38, f13, !(v39 <= v39), v35 < v35, f13, f13, f13, f13, i5 > |v40[v0 := !f13]|, true, !(!!f13 || v41.cf53), f13, fm21(globalState) == v39, f13, fm1(f13, globalState), !f13, !f13, f13, f13, f13, v43 < v43, if (true) then f13 else v42.f10];
			v44 := v42.f11;
			var v45: array<map<int, int>> := new map<int, int>[8];
			v45 := v45;
			v42 := v42;
			globalState.f5 := i5 / i5;
		}
		if (f13) {
			var v46: seq<int> := [v0];
			var v47 := DC16(v46);
			v47 := v47;
			var v48: array<int> := new int[17] [v0, v0, 0x9e, v0 * v0, v46[v0], v0, 0x106, v0, v0, v0, -672, v0, |v46| + |(seq(-0x25e, i6  => ('x')))|, v0, v0, v0, v0];
			v48[646] := -v0;
			v48[646], globalState.f5 := v0, -v0;
			var v49: map<int, bool> := map[v0 := !!f13];
			var v50: seq<bool> := [f13];
			var v51 := DC0(v49);
			var v52: multiset<bool> := multiset{f13};
			var v53: array<bool> := new bool[22] [f13, [f13] < [fm1(f13, globalState)], f13, if (v0 in v49) then v49[v0] else !f13, f13, v48[646] > v0, f13, !f13, !f13, f13, f13, f13, f13, f13, !(if (v0 in v49) then v49[v0] else f13), v50 != [f13, f13], false, f13, f13, f13, !f13, if (v32.fm4(v51.(cf0 := map[v48[646] := f13]), v51, v52, globalState)) then true else f13];
			v53[244] := f13;
			v53[244] := !f13;
			var v54 := 'p';
			v54 := v54;
			...
			if (v58 > (fm30(globalState) * v58)) {
				...
				var v68: seq<multiset<array<int>>> := [v63, v63, v63, (v63[v62 := |v67|])[v62 := v0], v63];
				var v69 := DC6(f13);
				var v70: map<bool, int> := map[v61.f10 := v0];
				var v71 := 'q';
				var v72: map<int, char> := map[fm18(v69, |v58|, |v70|, globalState) := v71];
				var v73: array<multiset<array<int>>> := new multiset<array<int>>[19] [v63, multiset{v62}, (if (v56 in v64) then v64[v56] else multiset{v62})[v62 := |v65|], v63[v66.cf21 := 0x59], v63 + v63, v63 - v63, multiset{v62, v62}, v63, v68[v0], v63 - v63[v62 := |v72|], if (fm1(f13, globalState)) then v63 else v63, v63, v63, v63, v63, multiset{v62, v62, v62}, v63 + v63, v63 * multiset{v62}, v68[v0]];
				v73[592] := v63;
				v73[592] := v63;
			} else {
				...
				globalState.f5, v75, v58, v75[915] := -v0, v75, fm30(globalState), -|(v77 + (seq(-310, i8  => ([f13]))))|;
			...
			var v85 := "pswtnsaun";
			globalState.f0 := !(false ==> (v85 < (seq(-0x20f, i9  => ('p')))));
		}
		...
		var v89: seq<int> := [|v88|];
		r0 := (seq(0x2b3, i10  => (v0))) < v89;
		var v90: multiset<int> := multiset{0x1fb};
		var v91: map<bool, multiset<int>> := map[f13 := v90];
		r1 := if ((|"l"| != |(map[v0 := !f13])[v0 := f13]|) in v91) then v91[|"l"| != |(map[v0 := !f13])[v0 := f13]|] else multiset(seq(0x332, i12  => (v0)));
	...
	method m5(p0: seq<array<int>>, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		v3 := v3[|v4| - p1 := !f13];
		var v5 := 'o';
		v5 := fm20(p1 / p1, f13, p1, globalState);
		var i1 := 0;
		while (false)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v6: array<int> := new int[15](i2 => i2 % 0x15d);
			...
			globalState.f0 := if (f13) then v12[p1] else v1.f10 !in multiset{v1.f10, v1.f10};
			globalState.f0 := f13;
		}
		...
		var i3 := 0;
		while (!(v13 <= ([0x257])[if (0x334 in v15) then v15[0x334] else v13[p1] := p1]))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			v17 := v17 + v17;
			globalState.f5 := -(p1 % 538);
			var v18: map<bool, array<int>> := map[false ==> f13 := p0[p1]];
			v18 := v18;
		}
		v15 := v15[p1 := p1];
		var v19: map<bool, int> := map[!v1.f10 := 381];
		r0 := (p1 - p1) / (if (f13 in v19) then v19[f13] else p1);
		r1 := p1;
...
class C3 extends T0, T1 {
	...
	function fm12(p0: string, p1: int, p2: int, globalState: GlobalState): bool {
		[[f12], [|map[false := f12]|, f12]] < ([[f12, f12, |"cvi"|, -f12], [f12], [f12], [f12, |[false]|]] + (seq(-0x36d, i0  => ([f12, f12]))))
	}
	method m1(p0: int, p1: array<array<int>>, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		var v0 := true;
		if (v0 <== v0) {
			...
			if (v0) {
				...
				var v7: set<array<int>> := {v3, v3, v5[|v6|]};
				v7 := v7;
				...
				var v18 := DC14();
				globalState.f5, v18 := if (v15.f10) then -(p0 % p2) else f12 / p2, v18;
				var v19 := "uqxmp";
				v19 := if (v0) then v19 + (seq(-716, i2  => ('p'))) else fm14(v19, p3, globalState) + "fraq";
			}
			...
			var v29: seq<bool> := [v0, v25[p2], fm4(v27, DC0(v26), v28, globalState), true];
			globalState.f0, globalState.f5 := v23 >= multiset(v24), (p3 % f12) + |(v29 + v29)|;
			var v30 := DC1(v0);
			match (v30) {
				case DC1(cf1) =>
					globalState.f0 := cf1;
					...
					v35 := v35;
				case DC0(cf0) =>
					var v36: array<bool> := new bool[29] [v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, false, v0, v0, v0, true, v0, v0, v0, !v0, v0, v0, v0, v0, v0, v25[0x57], v0, v0];
					var v37: map<array<bool>, bool> := map[v36 := v0];
					v37 := v37 + v37;
					var v38 := 'x';
					var v40: map<bool, int> := map[v0 := f12];
					var v41: seq<map<bool, int>> := [v40];
					m0(v0, if (v0) then v38 else v38, |(set v39 : int | (0x16c <= v39) && (v39 < 0x2ef) :: (v39 + 0xa5))|, v40 + v41[f12], globalState);
				...
				case DC2(cf2) =>
					...
					v44[392] := v45 * (multiset([v29, [v0]]))[v25 := p0];
					var v46 := "ofcufvnr";
					...
					r1, v44[392], v48, p1[666], globalState.f5 := |v50|, v45, [v47], v49, f12;
					var v51: array<seq<int>> := new seq<int>[23] [v24, v24 + v24, if (v0) then v24 else fm15(v0, v0, globalState), v24, v24 + (seq(-0x1ce, i3  => (|(seq(0x1b0, i4  => (p0)))|))), [f12], seq(0x38, i5  => (p3)), v24, (seq(0x2a7, i6  => (p0))) + v24, [f12, p3, fm0(0x1f3, |v47|, p3, v0, globalState)], v24, v24, v24, v24, seq(985, i7  => (p3)), v24, v24, [f12, p2], v24, (seq(0x24e, i8  => (if (false in v50) then v50[false] else p2))) + v24, v24, v24, v24];
					v51[542] := v24;
					v51[542] := seq(0x3ab, i9  => (p2));
					var v52: array<bool> := new bool[25](i10 => v0);
					v52 := v52;
					var v53: map<array<int>, bool> := map[p1[666] := v0];
					v49[582] := fm0(p2, p3, p0, if (v49 in v53) then v53[v49] else v0, globalState);
					v49[582] := f12;
			}
			...
			v60[498] := v0 || v0;
			v60[498], globalState.f5, globalState.f5, globalState.f5 := v0, p3, --(p2 - (p0 * f12)), if (v59.cf6) then p0 else p2;
			var v61: map<bool, int> := map[v60[498] := p0];
			var v62: set<int> := {|v21|};
			...
			globalState.f5, globalState.f5, v64, v0 := p0 / p0, if (v60[498]) then 0x327 else p3 + |multiset{v60[498]}|, v64, !v0;
		}
			...
			decreases 100 - i11
		{
			...
			if (false) {
				...
				var v72: array<bool> := new bool[28] [true, v0, false, v0, v0, v0, if (|v68[p2 := v0]| in v67) then v67[|v68[p2 := v0]|] else v0, v0, fm1(v0, globalState), v0, v0, v0, v0, v0, true, v0, v0, v0, v0, v0, v0, !v0, v0, v0, v0, fm1(v0, globalState), if ((map v71 : int | v71 in v67 :: (v71 * p0) := (v69)) in v70) then v70[map v71 : int | v71 in v67 :: (v71 * p0) := (v69)] else v0, v0];
				var v73 := new C0(true, v72);
				var v75 := DC0(map v74 : int | (0x2d5 <= v74) && (v74 < -252) :: (v74 / p3) := (v73.f10));
			...
			if (v0) {
				...
				var v105: map<map<bool, bool>, int> := map[v104[p0] := 762];
				var v106 := DC7(|("heyc")[-f12 := v65]|, v105[v103 := f12], f12);
				globalState.f5 := v106.cf9;
				var v107: seq<bool> := [!v0];
				var v108 := DC24(true, true, v107[-f12]);
				var v109: map<int, bool> := map[p3 := v0];
				var v110: map<bool, int> := map[v107[0x216] := p0];
				v108, r1 := if ((if (0x278 in v109) then v109[0x278] else if (false in v103) then v103[false] else v0) <==> v0) then DC24(false, v0, v0) else v108, |DC38(v110).cf55| / (|v107| / p3);
				...
				var v116: array<bool> := new bool[9] [v0, true, v113 == v113, v0, !v0, v0, v0, v0, v114 !! (set v115 : int | (0x2ee <= v115) && (v115 < -0x12) :: (v115 % p0))];
				v116[933] := v0;
				var v117: array<D5> := new D5[16];
				var v118: array<int> := new int[11](i15 => i15 % p3);
				var v119 := DC15(v118);
				v117[888] := v119;
				r2, v116[933], v117[888] := (v0 <==> !v0) ==> v0, false, v119;
				var v120 := DC9(0x199);
				var v121 := DC10(v120);
				var v122 := "fxm";
			...
			var v128: array<D4> := new D4[12](i16 => DC12(|multiset([f12, |(set v127 : int | (349 <= v127) && (v127 < 538) :: (v127 / p2))|])|, |[v66]|, "qxnwwoae", -|{true}|, p2));
			...
			var v134 := "sxyqh";
			var v135: array<int> := new int[19] [p0, p2, f12 * p3, -|((seq(0x49, i17  => (DC30()))) + v131)|, p2, p3, p2, p3, f12 + p3, |v133| / p3, f12, -p3 / |[v0, !v0, !v0, v0, v0]|, -586, f12, p2, p0 / f12, |(v134 + v134)|, p0, p2];
			v135[756] := p2 + |v134|;
			v135[756] := p2;
		}
	...
	method m3(p0: string, p1: bool, p2: array<C0>, p3: int, globalState: GlobalState) returns (r0: int, r1: array<int>) {
			...
			decreases 100 - i0
		{
			...
			var v7 := DC0(map v5 : int | v5 in (map v6 : int | (0x2b7 <= v6) && (v6 < 0xf6) :: (v6 % -p3) := (v3.f13)) :: (v5 / p3) := (v3.f13));
			var v8: multiset<bool> := multiset{v3.f13};
			var v9: set<bool> := {p1};
			var v10: array<bool> := new bool[17] [p1 !in v4, v3.f13, true, p1, v3.f13 && p1, p1, p3 >= f12, !v3.f13 <== p1, v3.f13, v3.f13 <==> p1, fm1(v3.f13, globalState), v3.f13, (seq(-224, i1  => ('k'))) == (seq(953, i2  => ('h'))), if (v3.f13) then p1 else v3.f13, fm4(v7, v7, v8, globalState), f12 == |v9|, v3.f13];
			var v11 := "akjkn";
			v10[273] := v3.f13;
			var v12: multiset<D0> := multiset{v1};
			v10, v11, v10[273] := v10, seq(0x2f3, i3  => (DC27(p1, f12, 'n', multiset{false, v3.f13, false, p1}).cf40)), v12 !! (v12 * fm31(globalState));
			globalState.f5 := f12;
			var v13 := 's';
			v13 := 'f';
		...
		for i4 := |v17| + |v18| to f12 {
			...
			var v21 := new C0(v18[p3], v20);
			var v22: map<bool, int> := map[!p1 := -p3];
			v22 := v22[v19.f13 := f12];
		}
		for i5 := |v17| / p3 to f12 * p3 {
...
class C4 extends T1 {
	...
	method m1(p0: int, p1: array<array<int>>, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		v1.f11[204] := v1.f10;
		var v3 := 'm';
		var v4: array<int> := new int[8](i0 => i0 / p0);
		v4[136] := p0;
		var v5: multiset<bool> := multiset{v1.f10};
		v1.f11[204], v3, v4[136] := (v5 * multiset{v1.f10, v1.f10}) != (v5 - v5), v3, p2 / |v5|;
		var v6: seq<bool> := [v2.f10, v1.f10, v2.f10];
		var v7: map<bool, int> := map[v6[p2] := v4[136]];
		v7 := v7[v1.f11[204] := v4[136]];
		r2 := v1.f11[204];
		r0 := v1.f10;
		r1 := p2;
	...
	method m2(p0: int, p1: int, p2: seq<T0>, globalState: GlobalState) returns (r0: map<bool, int>, r1: int, r2: bool) {
		...
		match (match v2 {
			...
			case DC0(cf0) =>
				...
				if (v1) {
					...
					v14 := fm9(-(|p2| / |v17|), globalState);
					globalState.f5 := p1;
					cf0 := cf0[-p1 := true];
				} else {
					var v18: array<int> := new int[21](i0 => i0 / f9);
					var v19: set<int> := {|v0|};
					v18, globalState.f0, v19 := v18, false, v19;
					var v20: multiset<bool> := multiset{v1};
					globalState.f5 := p1 / (if (v8.fm4(v2, v2, v20, globalState) in v20) then v20[v8.fm4(v2, v2, v20, globalState)] else -0x9e);
					r1, globalState.f5, r1 := p1 + f9, f9, p1;
					var v21 := 'i';
					var v22: map<bool, char> := map[v1 := v21];
					var v23 := DC8(v0);
					var v24: array<string> := new string[21] [v0, v0, v0, v0 + (seq(0x29b, i1  => ('r'))), v0, v0 + v0, v0, v0 + v0, v0, v0 + v0, v0, v0, v0, v0 + v0, v0, seq(-0x16e, i2  => ('a')), v0, fm8(v1, map[true := v21], v1, globalState) + v0, fm8(v1, v22, v1, globalState), v0, (seq(0x111, i3  => (v21))) + v23.cf10];
					v24[109] := (("ggh" + v0)[p0 := v21])[p1 := v21];
					v24[109] := (seq(0x33b, i4  => (v21))) + v0;
					var v25: array<char> := new char[28] ['g', v21, v21, 'l', v21, v21, 'v', v21, v21, v21, v21, v21, v21, v21, 'l', v21, v21, v21, v21, v24[109][-|v20|], v21, v21, v21, v21, v21, v21, v21, v21];
					v25[483] := v21;
					v25[838] := v21;
					v18, globalState.f5, v25[483], v25[838] := v18, p0 - p0, v21, v21;
				}
				
				var v26: array<array<int>> := new array<int>[23];
				var v27: array<seq<D3>> := new seq<D3>[6](i5 => [DC10(DC8("ewwnswuai")), DC10(DC9(|cf0|))] + (seq(0x2d4, i6  => (DC10(DC10(DC8(v0)).cf12)))));
				var v28 := DC8(v0);
				var v29: seq<D3> := [DC10(v28)];
				v27[866] := v29 + v29;
				var v30: seq<bool> := [true || v1];
				globalState.f2, v26, v27[866], globalState.f5, r2 := v30[p1], v26, v29, f9, f9 < |(v30 + [v1])|;
				globalState.f5 := p0;
			case DC2(cf2) =>
				globalState.f5, v1, globalState.f5 := (p0 / f9) - f9, v1, f9;
				var v31: array<int> := new int[2];
				v31[555] := 0x387;
				v31[555] := p1 / (p0 + 0x2cd);
				var v32: seq<array<int>> := [v31];
				var v33: array<array<int>> := new array<int>[2] [v32[|"sbtwqs"|], v31];
				var v34: array<array<set<int>>> := new array<set<int>>[21];
				var v35: array<set<int>> := new set<int>[20];
				v34[9] := v35;
				v33, v34[9], globalState.f5, v0, globalState.f2 := v33, v35, p1, v0, v1;
				var v36 := DC9(p0);
				...
				var v41: T1 := new C0(!(v37 >= v37[v38.(cf12 := v36) := v31[555]]), v40);
				v41 := v41;
		}
		...
		if (false) {
			...
			var v49 := DC7(p0, v48, |v0[p1 := v46]|);
			var v50: map<multiset<bool>, seq<bool>> := map[v44 := fm10(v45, v46, v49, p0, globalState)];
			v1, v1, v43 := v1, v44 in v50, ([v42[f9 := v1], map[p1 := v1]] + (seq(-0x314, i7  => (v42)))) + (seq(971, i8  => (v42)));
			globalState.f0 := v1;
			var v51 := DC6(v1);
			match (v51) {
				case DC6(cf6) =>
					...
					var v55: array<bool> := new bool[15] [cf6, v1, v1 <== true, cf6, v54 != [v53], v1, cf6, v53.f10, cf6 <== v1, v0 != (seq(0x82, i10  => (v46))), cf6, v1, v1, cf6, v1];
					v55[638] := !cf6;
					v55[638] := f9 > p0;
					globalState.f2 := v53.f10;
					var v56: array<int> := new int[26];
					v56 := if (cf6) then v56 else v56;
					var v57: seq<bool> := [v55[638], v53.f10];
				...
				case DC5(cf5) =>
					...
					var v83: set<int> := {p1};
					globalState.f5, globalState.f5, globalState.f5, v81, v76.f11[526] := p0, |v82| * (if (v76.f10) then f9 else fm0(|v83|, p0, p1, v51.cf6, globalState)), |((v72 + [v76.f10]) + v72)|, v81, v1;
			}
			...
			if (p1 <= |v45|) {
				...
				v85[991] := v1 ==> v86.f10;
				v85[991] := !v1;
				var v87: map<multiset<bool>, bool> := map[v44 := v85[991]];
				r1 := |((v87 + v87) + v87)|;
				var v88: array<seq<int>> := new seq<int>[19];
				var v89: T0 := new C2(!v86.f10);
				var v90: seq<bool> := [v85[991], v86.f10, v85[991]];
				var v91 := DC17(v90);
				var v92: multiset<D7> := multiset{DC17([v86.f10]), v91};
				var v93: multiset<T0> := multiset{v89};
				v88, globalState.f2, r2, v89, globalState.f8 := v88, v85[991], v86.f10, v89, {v1, v92 !! v92, v93 !! v93};
			} else {
				...
				r1, globalState.f5, v97[230] := if (v99 in v100) then v100[v99] else -(if (v99.f10) then v101[|v96|] else f9), -((p1 + p1) * p1), if (fm1(v99.f10, globalState)) then |v102| else p1 * f9;
				var v103: C3 := new C3(-p0);
				var v104: array<C3> := new C3[8] [v103, v103, v103, v103, v103, v103, v103, v103];
				var v105: set<char> := {v46};
				globalState.f2, v1, v104, v0, v97[230] := (if (v1) then f9 else |v105|) <= -0x15c, v96 != v96, v104, fm27(globalState), v97[230];
			}
			
			var v106: array<bool> := new bool[1](i13 => v1);
			v106[797] := if (v1) then v1 else false;
			v106[797] := v1;
		} else {
			var v107 := 'k';
			...
			match (DC2(if (v1) then v111 else v111)) {
				case DC1(cf1) =>
					...
					var v121: seq<string> := [seq(0x196, i14  => (v107)), v120[p0], v0, "nikx", v0];
					var v122: array<int> := new int[25] [p0, if (if (|v113| in v109) then v109[|v113|] else v1) then fm0(f9, f9, p0, cf1, globalState) else f9, f9, v114[f9], if (v1) then f9 else f9, f9, fm0(|v115|, -0x1e2, p1, true, globalState), f9, p1, p0, p0 * |{f9}|, p0, |v118[-|v114|]|, p0, |(v119 + v119)|, f9, |v115| * |v116|, p1, |(v121[fm0(|v0|, 378, f9, true, globalState)])[0x23b := v107]|, p1, p0, f9, 0x15, p1, p1];
					v122 := v122;
					...
					v124[389], r2, v125[478], globalState.f5, globalState.f2 := (v0 + (seq(-0x11b, i16  => (v107))))[p0 := v107], v1, v1, 0x124, v126 >= (v126 - v126);
				case DC0(cf0) =>
			...
			v132[189] := if (("rngu")[|v134| := v107] in v133) then v133[("rngu")[|v134| := v107]] else v1;
			v132[189] := v1;
			r1 := |v134|;
		}
		...
		var v141: set<string> := {v140[p0], v0};
		...
		v142[902] := v1 && v1;
		var v143: array<multiset<int>> := new multiset<int>[2](i18 => multiset{|map[|(seq(0x390, i19  => (0x25f)))| := {v1, v1}]|, 0xf1});
		v143[446] := multiset{p1};
		var v144: multiset<int> := multiset{|multiset{v0, v0, v0}|, f9, f9};
		v142[902], v143[446] := v1, v144;
		var v145 := new C2(v1);
		var v146 := DC18();
		v146 := if (v142[902]) then v146 else v146;
		var v147 := DC31(p0, -f9);
		v142[902] := v147.cf45 < p1;
		...
		r0 := v151;
		var v152: multiset<bool> := multiset{v142[902]};
		var v153 := DC19(DC18());
		var v154: map<D7, bool> := map[v153 := v142[902]];
		var v155: map<seq<string>, int> := map[v140 := f9];
		r1 := (p0 / (if ((if (v153 in v154) then v154[v153] else v142[902]) in v152) then v152[if (v153 in v154) then v154[v153] else v142[902]] else -0x294)) + (if ([v0] in v155) then v155[[v0]] else p0);
...
method Main() {
	...
	var v2 := false;
	var v3: array<int> := new int[3] [v0, v1[|map[v2 := v2]|], v0];
	...
	var v9 := DC0(map v8 : int | (388 <= v8) && (v8 < 693) :: (v8 / v0) := (v2));
	...
	var v12 := "aiwqmuo";
	globalState.f2 := (v0 % -v0) < fm0(|v12|, v0, v0, v2, globalState);
	var i0 := 0;
	while (v2)
		decreases 100 - i0
	{
		...
		m0(!(v2 <==> v2), v13, -(if (v2 in v14) then v14[v2] else v3[871]), v14, globalState);
		var v15: map<int, seq<int>> := map[-v0 := v1];
		v15 := v15;
	}
	var v17: map<bool, int> := map[v2 := |v12|];
	m0(true, v12[fm0(|(set v16 : char | v16 in v12 :: (v16))|, -v0, v0, v2, globalState)], fm0(v0, v0, if (v2 in v17) then v17[v2] else |v12|, v2, globalState) - v0, fm2(v2, v2, v2, v17, globalState), globalState);
	var v18 := 'n';
	...
	match (v20) {
		case DC1(cf1) =>
			...
			globalState.f5, v0 := if (--|(map v24 : D0 | v24 in v27 :: (v24) := (-v0))| in v23) then v23[--|(map v24 : D0 | v24 in v27 :: (v24) := (-v0))|] else fm0(v0, v0, v0, cf1, globalState), 550 / (v0 / v0);
			var v28: seq<set<bool>> := [v11];
			globalState.f0 := !((cf1 || fm1(cf1, globalState)) in (v11 * v28[v0]));
			v12 := v12;
			globalState.f2 := v2;
		case DC0(cf0) =>
		...
		case DC2(cf2) =>
			...
			globalState.f2 := (if (v2) then multiset{DC1(v5[|v17|])} else v29) == (if (false) then (v29[v20 := v0])[fm3(v20.cf1, v0, |v30|, v0, globalState) := v0] else v29);
			v6 := v6[v0 := -v0 < v0];
			var v31 := new C1();
	}
	...
	if (false) {
		...
		if (v2) {
			...
			v36[47] := map[v0 := v2];
			var v37 := DC21(v2, v2, (v5[|"wcd"| := v2])[-0x241 := v2], v2, v0);
			v36[47] := v6[v0 := v37.cf27];
			v5 := (v5[v0 := v2] + v5) + v5;
			var v38: T1 := new C4(v0);
			var v39: seq<T1> := [v38, v38];
			m0(v2, v18, v0 / fm0(v0, v0, v0, v2, globalState), v17[v2 := |v39|], globalState);
		}
	...
	if (v2) {
		...
		if (fm0(if (v18 in v46) then v46[v18] else v0, |v1|, v0, v2, globalState) <= v0) {
			...
			globalState.f0 := true;
			globalState.f2 := fm1((seq(671, i4  => (v18)))[v0 := v18] < v12, globalState);
		} else {
			...
			v63[122], v66[556], v67 := v59, v2, v67;
		}
		
		var v68: array<T0> := new T0[5];
		var v69: T0 := new C2(v2);
		v68[929] := v69;
		v12, v68[929] := if (v2) then v12 else seq(0x3aa, i5  => (DC27(v2, v0, v18, v45).cf40)), v69;
	...
	if (v87 !! v87) {
		...
		v78 := new bool[13];
		var v92 := DC8(v12);
		globalState.f2 := v92.cf10 <= ((seq(956, i7  => ('a'))) + v12);
		var v93: C1 := new C1();
		var v94: map<C1, bool> := map[v93 := v2];
		v0 := |v94| * v88.f9;
	} else {
		globalState.f2 := v0 != |v12[v0 := v18]|;
		var v95 := new C4(v0);
		v2 := v2;
		var v96 := new C1();
