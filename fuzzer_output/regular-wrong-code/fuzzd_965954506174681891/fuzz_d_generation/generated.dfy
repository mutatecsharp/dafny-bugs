...
function fm5(p0: multiset<bool>, globalState: GlobalState): set<string> {
	set v0 : string | v0 in multiset{seq(0x241, i0  => ('e')), seq(-0xd3, i1  => ('k')), "bmpbyeb", "jeeg"} :: (v0)
}
function fm6(p0: seq<seq<int>>, p1: bool, p2: bool, globalState: GlobalState): D1 {
	DC4((set v0 : string | v0 in (seq(240, i0  => (seq(0x2cb, i1  => ('m'))))) :: (v0)) * {"khuk", "gb", "gbthcxlck"})
}
...
function fm13(p0: bool, p1: int, globalState: GlobalState): map<multiset<int>, int> {
	map[multiset([|[|map[0x3da := |multiset{true}|]|]|, |{'k'}|]) + multiset{|[-994, |map[false := -991]|]|} := |map[-577 := map[0x294 := DC7(0x197)]]| % 0x248]
}
method m0(globalState: GlobalState) returns (r0: int, r1: int) {
	...
	for i0 := v0 to -|(v2 + map[v1 := 'k'])| {
		...
		if (v1) {
			var v3 := "r";
			var v4 := 'l';
			globalState.f9, globalState.f7, v3 := ([v1, v3 < (seq(0xc4, i1  => ('f'))), v1, v1, v1 && fm0(v1, v1, v3, globalState)])[|(seq(0x10b, i2  => (seq(-0x343, i3  => (i0)))))| := v1 && v1], i0, ("quhelj" + v3[v0 := v4]) + v3;
			...
			var v10: map<char, string> := map[v3[v0] := v3];
			var v11: set<int> := {fm1(false, v0, DC7(v0).cf6, globalState)};
			v5, v6, v7[651], v1 := v5, if (!v1 in v8) then v8[!v1] else v6, v9.cf14, |v10| > (v0 % |v11|);
			v0 := i0;
			...
			v1, v23, r0, v22, v1 := fm0(v23.f19, v0 >= v0, v22[i0 := v24], globalState), v23, -(i0 + |v25|), v22, if (v1) then v23.f19 else v1;
			v0 := i0;
		}
	...
	var v30: seq<bool> := [v29 < (seq(0x175, i5  => (v28))), v1];
	var v31: map<int, int> := map[v0 := |(seq(0x2c5, i6  => (v0)))|];
	r1, v1 := (if (!v1) then 0xc else v0) * v0, v30[v0 * (if (|v29| in v31) then v31[|v29|] else fm1(v1, v0, v0, globalState))];
	...
	var v37 := DC0(v36 + v36);
	v1, r1, v34[798], v37 := v1, v0, v1, v37.(cf0 := v36);
	if (v0 < v0) {
		v34[798] := !v1;
		r0 := v0;
		globalState.f7 := v0;
		if (v1) {
			...
			var v39: seq<map<bool, bool>> := [v38, v38, v38, v38, v38[v34[798] := v1]];
			var v40: seq<int> := [fm1(true, |v31|, v0, globalState), v0];
			var v41: array<map<bool, bool>> := new map<bool, bool>[21] [v38, v38, map[v1 := v34[798]], v38, v38, v38, v38, v38, v38, map[v34[798] := v34[798]], v38, map[v1 := v34[798]], v38, v39[|v40|], v38, map[v1 := v34[798]], v38, v38, map[v34[798] := v1], v38, v38];
			var v42: map<bool, array<map<bool, bool>>> := map[false := v41];
			var v43: seq<array<map<bool, bool>>> := [v41, v41, v41];
			var v44: set<int> := {v0, |v40|};
			var v45 := DC8(v1);
			var v46: array<array<map<bool, bool>>> := new array<map<bool, bool>>[27] [v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, if (v34[798] in v42) then v42[v34[798]] else v41, v41, v41, v43[|v44|], if (v1) then v41 else v41, v41, v41, v41, v41, v41, v41, if (v45.cf7) then v41 else v41];
			v46[74] := v41;
			v46[74] := new map<bool, bool>[23](i8 => v38);
			var v47: C0 := new C0(v1, v38);
			v47 := v47;
			r1 := v0;
			v1 := (v0 - |v38|) != (-|v29[v0 := v28]| - -v0);
			globalState.f8 := v0;
		} else {
			v0 := -v0;
			...
			var v51: multiset<array<int>> := multiset{v35, v50[|v29|], v35, v35};
			...
			v49, v51, globalState.f7, v52, v53[147] := if (!v1) then v49 else v49, v51, -|(multiset([v30]) * v56)| + 0x4f, v52 + v52, v55;
			v2 := v2[v1 := v28];
			v34[798] := v1 in v30;
		...
		v35[494] := v0;
		v35[494] := v0;
		var v58: set<seq<bool>> := {[v34[798]], fm8(-0x7, v1, globalState)};
		v34[798] := v58 > {v30};
		v0 := v0;
		var v59: set<int> := {v0, v35[494]};
		var v60: multiset<int> := multiset{v35[494], v35[494]};
		var v61: map<multiset<int>, string> := map[DC14(v60).cf18 := v32[704]];
		var v62 := DC10(v59, v61);
		match (v62) {
			case DC10(cf9, cf10) =>
				v35[494] := v0;
				var v63: set<string> := {seq(0x13e, i9  => (v28))};
				v1 := v63 < (v63 + v63);
				...
				v66[691] := v65;
				var v67 := DC14(v60);
				v67, v35[494] := if (fm0(!!v1, v1, "i", globalState)) then v67 else v67, v35[494];
			case DC11(cf11, cf12, cf13, cf14, cf15) =>
				var v68 := DC11(v30[cf12], v0, v1, cf14, -cf12);
				v68 := v68;
				v0 := if (cf11) then v0 else v0;
				cf11 := cf11;
				var v69: C0 := new C0(v35[494] < v0, map[v34[798] := v1]);
				v69 := v69;
			case DC9(cf8) =>
				var v70 := DC7(0x60);
				...
				v71 := v71[v34[798] := |v73| / |v32[704]|];
				var v74 := DC11(cf8.f19, v35[494], v34[798], v34, v35[494]);
				var v75: multiset<bool> := multiset{v34[798]};
				var v76: seq<multiset<bool>> := [multiset([cf8.f19, v1]), v75, v75];
				var v77: array<int> := new int[11] [v0, v74.cf15 + |cf8.f20|, v0, |"ivkit"|, v35[494], -v35[494], -(v0 + v35[494]), v0, |v76|, v0, v0];
				v77 := v77;
				var v78: set<string> := {"pbduko"};
				v78 := v78 + v78;
				var v79: array<seq<bool>> := new seq<bool>[26](i10 => v30);
				var v80: map<array<seq<bool>>, int> := map[v79 := v35[494]];
				v80 := v80[v79 := |multiset{v35[494]}|];
			case DC12(cf16) =>
				var v81: map<bool, bool> := map[v1 := !v34[798]];
				v1, globalState.f8, v34[798] := v34[798], |v81|, true;
				var v82: array<C0> := new C0[4];
				v82 := v82;
				globalState.f8 := -0x6d % -v35[494];
				var v83 := new C0(v34[798], v81[false := v34[798]]);
		}
		
		var v84: set<bool> := {v1};
		var v85: map<bool, set<bool>> := map[v34[798] := v84];
		var v86: seq<set<bool>> := [if (v34[798] in v85) then v85[v34[798]] else v84, v84];
		v86 := v86;
	}
...
method Main() {
	var v0 := 'u';
	var v1: array<int> := new int[13](i0 => i0 / |"y"|);
	...
	var globalState := new GlobalState(true, "pvfmfbioj", v2, v4, map[seq(0x1ec, i1  => (v0)) := v5], -0x3d8, false, 0x94, -0x178, v6 + v6, false, v1, true, v7, 363, 0x2a8, true, false, false);
		...
		decreases 100 - i2
	{
		...
		i2 := i2 + 1;
		var v10: array<bool> := new bool[28] [v3, v3, v3, v3, v3, v3, !v3, fm0(v3, v3, seq(0x22e, i3  => (v0)), globalState), v3, false, v3, false, false, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, fm0(v3, true, "w", globalState)];
		var v11: multiset<array<bool>> := multiset{v10, v10};
		v11 := (v11[v10 := v5] - multiset{v10}) - v11;
		v10[42] := true;
		var v12: multiset<char> := multiset{v9[|(seq(0x2e, i4  => (|v7|)))|]};
	...
	v23[114] := if (v3) then v24 else v24;
	v23[114] := v24;
	var v25: array<string> := new seq<char>[15](i6 => (seq(-0x232, i7  => (v0))) + "uueqdwt");
	v25[195] := v9;
	v25[195] := v9;
	globalState.f9 := v6;
	var i8 := 0;
		...
		decreases 100 - i8
	{
		...
		v1[640] := fm1(v3, |v26|, v18, globalState);
		var v27: multiset<char> := multiset{v0, v0};
		v1[640] := fm1(v27 >= v27, -v17 * v18, v17, globalState);
		...
		v32[845] := if (v3) then v30 else if (v3 in v33) then v33[v3] else v30;
		globalState.f8 := v18;
	}
	var i10 := 0;
	while (v25[195] <= v25[195])
		decreases 100 - i10
	{
		if (i10 >= 100) {
			break;
		...
		v1[51] := v5;
		v1[51] := -0x2ba;
		var v35: array<multiset<bool>> := new multiset<bool>[29] [v8, multiset{v34.f19, v3, v34.f19, if (v3 in v7) then v7[v3] else v3} - multiset{v34.f19, v3}, multiset{fm0(v3, v3, fm4(v34.f19, v3, !v3, |v4|, globalState), globalState), v34.f19}, multiset(v6), v8, v8[v3 := v1[51]], v8 - multiset{v3}, v8, v8[v34.f19 := v18], v8, v8, multiset([v34.f19]), v8, v8[false := v1[51]], v8, v8 - multiset{v34.f19, v34.f19}, v8, multiset{v34.f19, v34.f19, v34.f19}, v8, v8 + multiset{v3}, multiset{v3}, v8, v8[v3 := v17], v8, v8, multiset{v34.f19, v3, v3}, v8, v8[fm0(v3, v3, v25[195], globalState) := v1[51]], v8];
		v35 := DC3(v35).cf2;
		v34.f19 := v34.f19;
	}
	match (DC1()) {
		case DC1() =>
			var v36: map<bool, set<string>> := map[fm0(!v3, v3, v25[195], globalState) := fm5(v8, globalState)];
		...
		case DC2(cf1) =>
			...
			if (v3) {
				...
				var v45: set<int> := {v5, v5, fm1(v3, v5, |v44|, globalState), -0xb2 / v17, v18};
				globalState.f8, globalState.f9, v24[122], v45 := if (fm0(v3, v3, v9, globalState)) then v5 else v18, (if (v17 <= v18) then v6 else fm8(v18, v3, globalState))[v5 := v3 ==> !false], if (v3) then !(v25[195] <= v25[195]) else -0x151 > |multiset{v23[114], v24, v24}|, v45;
				var v46, v47 := m0(globalState);
				var v48: C0 := new C0(!true, v7);
				v48 := v48;
				v3 := v48.fm2(v0, fm0(v48.f19, v24[122], v9, globalState), globalState) >= v5;
			} else {
				var v49, v50 := m0(globalState);
				v24[830] := fm8(v17, v3, globalState) < fm8(v49, v3, globalState);
				v24[830] := !v3 && v3;
				var v51: map<string, int> := map["mnvbm" := v50];
				globalState.f7 := if (v9 in v51) then v51[v9] else v50;
				var v52: map<int, int> := map[v49 := v49];
				var v53 := new C0(v3, fm9(if (DC7(|v25[195]|).cf6 in v52) then v52[DC7(|v25[195]|).cf6] else v49, v5, |v9|, globalState));
		...
		decreases 100 - i11
	{
		...
		if (fm0(v3, v3, "xahmwdx", globalState)) {
			...
			v7 := v7[fm0(v3, v3, v25[195], globalState) := !v3];
			var v63: map<int, int> := map[fm1(v3, v18, -v5, globalState) / v17 := v17 / v18];
			v63 := v63[v18 * v18 := |multiset{-v17, v62.fm2(v0, v62.f19, globalState), v5}|];
			v7 := v7[false := v3];
			var v64 := new C0(v62.f19 <==> v6[v18], v7);
		}
		
		v1[844] := v18;
		globalState.f8, globalState.f7, v1[844] := |v25[195]|, v17 / v17, v5;
		var v65: multiset<string> := multiset{v25[195][v17 := v0], v9};
		var v66: seq<string> := [v25[195][v5 := v0]];
	...
	if (v3) {
		if (false && v3) {
			...
			var v74: seq<string> := [v25[195], v9];
			v9 := v25[195] + (v74[0x21e] + v9);
			v71 := v71;
			v1[217] := -0x342;
			var v75: set<int> := {v71.fm2(v0, !!v71.f19, globalState), v18};
			var v76: multiset<int> := multiset{|v8|};
			var v77: map<multiset<int>, int> := map[v76[|v9| := v5] := v18];
			var v78: seq<int> := [v17];
			v1[217], v75, v0, v77, v3 := v78[-v18], if (v3) then v75 else v75, fm10(v78, fm11(v0, v71.f19, v17, v18, globalState), globalState), v77 + v77, v3;
		}
		
		var v79: seq<int> := [v17];
		var v80: seq<seq<int>> := [v79, seq(-204, i13  => (|multiset{v17, 0x16a}|))];
		v4 := fm12(v80, v5 >= v5, if (!false in v7) then v7[!false] else v3, globalState);
		if ((if (v6[v18]) then v3 else v3) <== v3) {
			var v81: array<set<int>> := new set<int>[24];
			v81 := v81;
			v23 := v23;
			var v82: seq<array<bool>> := [v24, v24, v23[114]];
			v82 := v82 + v82;
			v24[277] := !true;
			v24[277] := (if (v3 in v7) then v7[v3] else v3) && v3;
			globalState.f8 := v17;
		} else {
			var v83: C0 := new C0(v3, v7);
			v83 := v83;
			globalState.f7 := v5 % v18;
			var v84: seq<C0> := [v83];
			v83 := v84[v5 - v5];
			globalState.f8 := |[v83.f19, !v3, v3, if (v3) then v83.f19 else v3]|;
			v24[721] := v83.f19;
			var v85: map<int, bool> := map[0x1ba := v3];
			v24[721], v85 := v83.f19, v85;
		}
		...
		var v91: set<int> := {v5};
		var v92: map<multiset<int>, string> := map[v87 := v25[195]];
		v1, v90, v0 := v1, ([v89, DC10(v91, v92)])[v17 := v89], v0;
		var v93 := DC13(v9);
		var v94 := new C0(fm0(v3, v3, v93.cf17, globalState), v7);
	} else {
		if ((v17 * 0x335) > v5) {
			v1[458] := v18 - fm1(v3, v18, -v17, globalState);
			var v95: seq<array<int>> := [v1];
			var v96: map<int, int> := map[v18 := v18];
			globalState.f7, v1, v1[458] := if (v3) then |v9| else -v17 - v17, v95[|{v3, v3}|], -v18 / ((if (v5 in v96) then v96[v5] else v17) % v5);
			var v97: multiset<int> := multiset{v18, v1[458]};
			var v98: map<multiset<int>, int> := map[v97 := |v25[195]|];
			var v99: map<int, map<multiset<int>, int>> := map[v1[458] := v98];
			var v100: seq<map<bool, bool>> := [v7, v7, v7];
			var v102: C0 := new C0(v3, v7);
			var v103: map<C0, bool> := map[v102 := v3];
			var v104: array<map<multiset<int>, int>> := new map<multiset<int>, int>[8] [if (v3) then v98[v97[v1[458] := v18] := v1[458]] else if (|v100[v18]| in v99) then v99[|v100[v18]|] else v98, (map v101 : multiset<int> | v101 in [v97] :: (v101) := (v5)) + map[v97 := v5], v98, (map[v97 := v5])[v97 := |v103|], map[multiset{v17, 274, v1[458], v17} := v17], fm13(v3, -v5, globalState), v98, v98 + v98];
			v104[16] := v98;
			globalState.f8, v18, v9, v104[16] := -v1[458], fm1(true, v17, v1[458], globalState), (v25[195] + (seq(905, i14  => (v0)))) + (v9 + (seq(934, i15  => (v0)))), v98;
			var v105: seq<array<bool>> := [v24, v24, v24, v24, v23[114]];
			v105 := v105;
			var v106: seq<int> := [v1[458], -v17];
			var v107: seq<seq<int>> := [v106, v106, v106, [v17, |[v1[458]]|, v5]];
			var v108: set<string> := {"rjjbn"};
			v3, v106, v102.f19, v25[195] := v3, v107[v5] + [|v108|], v3, "mwwcq" + v9;
			...
			v1[32] := -(|v110| / (v5 % v18));
			v109.f19 := v109.f19;
			globalState.f7 := -v1[32] - v17;
		}
		
		var v111 := new C0(v6[v17], v7);
		v7 := v7[v3 := v111.f19];
