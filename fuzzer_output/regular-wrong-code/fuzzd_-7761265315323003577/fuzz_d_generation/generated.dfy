...
function fm0(p0: int, p1: set<int>, p2: bool, globalState: GlobalState): char {
	match DC3(multiset{'s', 'l', 'q'}) {
		case DC4(cf7, cf8, cf9, cf10, cf11) => cf9[|cf9|]
		case DC3(cf6) => 'n'
	}
}
function fm1(globalState: GlobalState): set<int> {
	{-(if (false) then |multiset{false, !!false, false}| else |[|{|(map v0 : int | v0 in multiset{-0x390} :: (v0 % |map[false := true]|) := (|(map v1 : int | (0x2a4 <= v1) && (v1 < 0xde) :: (v1 + -0x38e) := (true))|))|}|]|), -(|map['k' := false]| * -0x38b), -|"lk"| + 802}
}
...
function fm9(globalState: GlobalState): map<int, int> {
	(map[|map[|multiset([DC33(-562, !false, 369, false, {true}).cf65, false])| := 0x19c]| := 0x2c2] + map[|{|{true, false}|}| := 0x38a]) + (map[|{false}| := |(seq(0x2b9, i0  => ('a')))|] + (map v0 : int | (0x126 <= v0) && (v0 < 0x323) :: (v0 * |multiset{multiset{|map[|{true}| := |[true]|]|}}|) := (781)))
}
...
function fm17(p0: int, p1: int, globalState: GlobalState): string {
	((seq(357, i0  => ('e'))) + "fqjluaqn") + "pfpcdepv"
}
function fm18(p0: bool, globalState: GlobalState): string {
	((seq(0x386, i0  => ('m'))) + "go") + "ywfd"
}
function fm19(p0: int, globalState: GlobalState): multiset<int> {
	multiset{|multiset{0x190, |multiset{false, false, !DC1(!true, |multiset(seq(-0xab, i0  => (multiset([-|{!true}|, |"qxcxo"|]))))|, 'h').cf2, !false}|}|, |multiset{false}|, |multiset{false, true, false, true}|} - multiset(seq(0x21a, i1  => (-0x18d)))
}
function fm20(p0: bool, p1: bool, p2: bool, globalState: GlobalState): D0 {
	DC1(-0x77 >= |[-|(map v0 : set<int> | v0 in [set v1 : int | (-0x288 <= v1) && (v1 < 0x3c5) :: (v1 / 0x1a6)] :: (v0) := (true))|]|, |("qnlh" + (seq(0x376, i0  => ('r'))))|, 'r')
}
...
function fm26(p0: int, p1: char, p2: bool, p3: char, globalState: GlobalState): seq<int> {
	([-716, |{true}|] + (seq(993, i0  => (--|map[!true := false]|)))) + (if (true) then [|(seq(0x1ef, i1  => ('o')))|] else [90, 0x3d3])
}
...
function fm33(p0: D3, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<int, bool> {
	(DC51(map v0 : int | v0 in map[0x251 := -876] :: (v0 - 0x1f9) := (true)).cf93 + map[482 := !!true]) + map[-|(seq(0x17d, i0  => (map[false := |multiset{true}|])))| := true]
}
...
function fm36(globalState: GlobalState): multiset<multiset<int>> {
	(multiset{multiset{|"ekwnkte"|, 0x17c, 0x274, -978, 0x32c}, multiset{--0x1f7}, multiset{DC1(false, |"xuckykvh"|, 'f').cf3, 0x32f}} * multiset([multiset{0x179, 315}, multiset{--|map[true := -0x2ac]|, 0x33a}, multiset{0x96, 0x1e9}])) - (multiset{multiset{|map[0x146 := !false]|}} - multiset([multiset{|(seq(0x364, i0  => ("ijuq")))|, |map[true := multiset{true}]|}]))
}
function fm37(p0: bool, globalState: GlobalState): D6 {
	DC19(0x21f, 0x2b3 / 460, 0x5f - |map[!true := |{--0x304}|]|)
}
...
function fm39(p0: char, globalState: GlobalState): map<int, string> {
	DC39(map[|[true]| := seq(0x2ff, i0  => ('g'))]).cf73
}
...
function fm43(p0: char, p1: int, globalState: GlobalState): seq<seq<int>> {
	((seq(-0x37e, i0  => (seq(344, i1  => (-0x257))))) + [[--910], [|[true, !true]|]]) + (seq(792, i2  => ([|(seq(28, i3  => ([0x177, 729])))|])))
}
function fm44(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): map<int, D9> {
	map[-|map[|map[true := !false]| := false]| % |{0x1f3, 373, |{true}|}| := DC25(788, |[|"r"|, |map[|(seq(0x137, i0  => ('b')))| := !false]|]|, |{false, false}|, 'u')]
}
function fm45(p0: int, p1: int, globalState: GlobalState): D4 {
	match DC15(true, !false, "vypeoo") {
		...
		case DC14(cf28, cf29, cf30, cf31) => DC13(seq(43, i0  => (0x28c)), cf28, cf30)
...
function fm51(globalState: GlobalState): multiset<seq<int>> {
	multiset{(seq(0x241, i0  => (-0xc9))) + [|map[true := 0x1eb]|], [0x3da], [|"dyeiakrtw"|, -582, -|multiset{0x2f3, -79, --688}|] + (seq(0x7a, i1  => (|map[true := 23]|))), seq(0x336, i2  => (DC31(|DC14(false, map[true := true], 0x0, map[false := !true]).cf29|, |multiset{false}|).cf59))}
}
...
function fm53(p0: char, globalState: GlobalState): multiset<D1> {
	multiset{DC3(multiset{'v'})} + multiset((seq(-0x3b6, i0  => (DC3(multiset{'j'})))) + [DC3(multiset{'i', 'k'}), DC3(multiset{'l'})])
}
...
function fm56(p0: string, p1: bool, p2: string, globalState: GlobalState): D11 {
	DC31(|([0x324, |multiset([true, !true])|] + [|(seq(316, i0  => ('v')))|, 0x33b])|, 518 + 0x1c1)
}
trait T0 {
	const f6 : int
...
class C0 {
	...
	function fm24(globalState: GlobalState): seq<bool> {
		[!(|map[f20 := |map[map[true := |map[|map[|{false}| := f20]| := f20]|] := seq(-0x25d, i0  => ('f'))]|]| < 0x30b), f20, f20, f20]
	}
}
...
class C1 extends T0 {
	...
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map v0 : int | v0 in (multiset{f6, f6, |"pxn"|, f6} + multiset{f6}) :: (v0 * |map[0x110 := f6]|) := ((seq(256, i0  => (f6))) + [f6])
	}
...
class C2 extends T0, T2, T1 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		match DC8(!!false, false) {
			...
			case DC5(cf12) => [multiset{'r', 'q'}] + (seq(523, i0  => (multiset{'u'})))
		}
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map[f6 := [f6]]
	...
	function fm13(p0: char, p1: multiset<bool>, p2: bool, p3: int, globalState: GlobalState): map<bool, string> {
		map[!!!!!!true := seq(-0x396, i0  => ('t'))] + (map[!false := seq(2, i1  => ('i'))] + map[true := "rxhrrtyr"])
	}
	method m6(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState) returns (r0: seq<string>, r1: bool) {
		...
		var v7: map<bool, multiset<int>> := map[p0 := v6[f6 := p2]];
		globalState.f0, v1, v3, globalState.f5, r1 := (|v4| - 0x288) >= f6, (if (fm22(v5[p0 := f6], p0, f6, globalState)) then v1 else v1) - (if (p0) then v1 else v1), DC5(v2 + v2), f6 % |(if (p0 in v7) then v7[p0] else v6)|, p0;
		var v8: array<int> := new int[3] [f6, f6, f6];
		var v9: set<int> := {f6};
		var v10: seq<set<int>> := [v9, v9, v9, v9];
		v8[48] := |(v10[|multiset([p2])| := v9] + v10)|;
		globalState.f0, globalState.f0, v8[48], globalState.f0 := (if (fm22(v5, p0, f6, globalState)) then p2 else f6) >= (f6 % f6), true, if (v6 !! v6) then |v4| else f6 + f6, p0;
		var v11 := new C1(-0x17c);
		globalState.f0 := (p2 >= v8[48]) ==> p0;
		var v12: array<multiset<int>> := new multiset<int>[24];
		var v13 := DC7(p1, v12, f6, |v4|);
		var v14: map<D2, string> := map[v13 := "gtvimpmrf"];
		var v15 := "ohcxxhxh";
		var v16 := 't';
		globalState.f5 := v8[48] * (|(if (v13 in v14) then v14[v13] else v15)[f6 := v16]| + |v15|);
		f9[375] := p0;
		f9[375] := !p0;
		r0 := (fm29(v9, globalState))[if (p0) then f6 else v8[48] := v15 + v15];
		var v17: seq<int> := [|v2|];
		r1 := p2 >= (|v17| * v8[48]);
	}
	method m7(p0: multiset<int>, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: array<bool>, r3: int) {
		...
		if (v0 ==> !!v0) {
			...
			r0, v3, globalState.f5, r3, v4[282] := v5, if (v0) then v3 else v3, fm21(|(v6 + v6)|, globalState), p1, (v1 * v1) * {v0, true, v0};
			var v7: map<bool, bool> := map[v0 := !v0];
			var v8 := DC14(v0, v7, f6, map[v0 := v0]);
			var v9: seq<bool> := [false, v0];
			var v10: map<D4, seq<bool>> := map[v8 := v9];
			v10 := v10[v8 := ([true])[p1 := !v9[p1]]];
			r3 := |(map[v0 := v0] + (v7 + v7))|;
			var v11 := "cidjjdvpa";
			globalState.f2 := ("ik" + (v11 + v11))[f6 % p1 := v5];
			...
			if (!v0) {
				...
				var v17: seq<int> := [p1];
				v16[246] := -(if (v0) then p1 else |v17|);
				...
				var v22 := 'c';
				globalState.f5, globalState.f5, v15[485], v16[246], globalState.f5 := |v17|, f6 % (p1 / |v18|), v14[if (-|v21| in v21) then v21[-|v21|] else p1 := v22], p1 * p1, p1;
				v16[246] := p1;
			} else {
				var v23 := 'j';
				var v24 := "tgruuabrh";
				var v25: seq<string> := ["yjxblq" + "kfxtlw", if (v0) then seq(0x125, i0  => ('u')) else "yiaoosnib", fm30(true, v23, globalState), v24];
				globalState.f2 := v25[f6];
				globalState.f0 := !!v0;
				v0 := f6 != f6;
			...
			var v39 := "s";
			var v40: map<bool, char> := map[v0 := v39[|v39|]];
			...
			v36[981], v43, v36[24], v44 := f6, [DC4(DC0(v28, -0x354), f6, v39, v0, f6)], |((v47 - v47) + v47)|, {v36, v36, v36, v36};
		}
		
		var v48: array<string> := new seq<char>[11](i1 => seq(0x28b, i2  => ('u')));
		var v49 := "aabonynb";
		v48[739] := v49 + v49;
		var v50: map<int, int> := map[f6 / f6 := |v49|];
		var v51: map<bool, bool> := map[v0 := true];
		r1, v0, v0, v48[739] := if ((0x2db - f6) in v50) then v50[0x2db - f6] else f6, v0, p1 <= |v51|, v49 + v49;
		v48[739] := v49;
		for i3 := p1 to f6 % p1 {
		...
		r3, v0, f9, globalState.f0, globalState.f5 := |(v49 + v49)| - (f6 / |v60|), match DC11(DC11(DC11(DC11(v61)))) {
			case DC10(cf22) => !!(-p1 != p1)
			case DC9(cf21) => -p1 != f6
			case DC11(cf23) => v0 <== v0
		}, v62[-(f6 * f6)], !v0, f6 % (|fm33(v64, 0x3c9, v0, v0, globalState)| + f6);
		r0 := 'j';
	...
	method m15(p0: bool, p1: bool, p2: map<char, bool>, globalState: GlobalState) {
		...
		for i0 := 0x340 to 442 - 553 {
			...
			v2[386] := v3 * v3;
			var v4: seq<bool> := [p1];
			v1[640], v1[374], v2[386] := f6, if (v4 == v4) then 0x2aa / -0xf else f6 - f6, v3;
			var v5 := "fwds";
			if (v4[|v5|] <== true) {
				...
				v10 := v10[v1[640] := !(v11 in v12)];
				globalState.f5 := i0;
				v1[640] := v1[640];
				var v13: map<int, int> := map[v1[640] := v1[640]];
				v13 := v13[f6 % -29 := v1[640]];
			} else {
				var v14 := 'p';
				var v15: map<int, bool> := map[v1[640] := p1];
				var v16: seq<int> := [v1[640], |v15|];
				var v17: map<int, bool> := map[DC13(v16, p1, i0).cf27 := p0];
				var v18: map<char, int> := map[v14 := |v17[f6 := p0]|];
				v18 := v18[v14 := 0x2b];
				globalState.f0 := v1[640] in (seq(0x20, i3  => (f6)));
				globalState.f5 := -(|v4| * -v1[640]);
				v1[640] := v1[640];
				globalState.f0 := p0;
			}
			
			var v19: map<int, bool> := map[i0 := p0];
			var v20: map<int, int> := map[f6 := if (!(if (0x3b3 in v19) then v19[0x3b3] else p1)) then v1[640] else 0xe5];
			v20 := v20;
		}
		var v21: set<array<bool>> := {f9};
		var v22: map<bool, int> := map[p0 := |v21|];
		var v23: seq<int> := [|[false]|];
		for i4 := f6 to |v22[p0 := f6]| - v23[-f6] {
			...
			v24.f19 := if ((|v28| % |v29|) in v26) then v26[|v28| % |v29|] else f9;
			var v30 := new C1(f6);
		}
		...
		var v35 := DC15(p1, p1, seq(0x35, i6  => ('f')));
		var v36: multiset<D4> := multiset{DC15(p1, p0, v32), v35};
		var v37: seq<seq<int>> := [[f6]];
		var v38: array<int> := new int[11] [if ((if (v32 in v33) then v33[v32] else v23) in v31) then v31[if (v32 in v33) then v33[v32] else v23] else |v34|, if (p0 in v22) then v22[p0] else f6, |v36| * 0x17f, f6, f6 / |v32|, |v23|, if (p1) then |map[f6 := f6]| else f6, f6, f6, f6 * |fm34(|v37[f6]|, globalState)|, v23[0x27]];
...
class C3 extends T1 {
	...
	method m6(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState) returns (r0: seq<string>, r1: bool) {
		...
		var v4 := DC7(p1, v3, f6 - v2[281], f6 - |"olpetvk"|);
		match (v4) {
			case DC6(cf13, cf14) =>
				f9[633] := p0;
				...
				var v8 := DC4(v6.(cf1 := v2[281]), cf13, seq(0x399, i1  => ('t')), true, |v7|);
				globalState.f5, globalState.f0, f9[633] := |((map[f9 := p0] + v5) + v5)|, v8.cf10, p0;
				v2[281] := cf13;
				var v9: map<int, bool> := map[fm2(cf13, globalState) := p0];
				var v10: map<int, bool> := map[f6 := if (f6 in v9) then v9[f6] else f9[633]];
				v9 := v9[cf13 := p0];
				f9[633] := p0;
			case DC7(cf15, cf16, cf17, cf18) =>
				...
				var v13 := "o";
				globalState.f5, globalState.f2, globalState.f5, globalState.f0 := (p2 + |v12[p0 := cf18]|) / p2, "lcenstrw" + v13, f6, p0;
				var v14: set<bool> := {false, p0};
				var v15: map<bool, set<bool>> := map[!p0 := v14];
				v15 := v15[p0 := v14];
				var v16: T0 := new C1(cf17 / 0x43);
				var v17 := 'o';
			...
			case DC8(cf19, cf20) =>
				if (v2[281] == |(set v19 : seq<bool> | v19 in (seq(0x26b, i2  => (p1[0x153 := cf20]))) :: (v19))|) {
					var v20 := "hgq";
					globalState.f2 := v20;
					...
					var v26 := 'r';
					var v27: map<char, int> := map[v26 := |(seq(-134, i3  => (v26)))|];
					var v28: map<bool, bool> := map[p0 := cf20];
					var v29: multiset<int> := multiset{|v28|, p2, f6};
					var v30: map<int, bool> := map[v2[281] := p0];
					globalState.f0 := |(map v25 : char | v25 in v27[v26 := v2[281]] :: (v25) := (p0))| !in v29[|v30| := v2[281]];
					...
					var v35: multiset<multiset<int>> := multiset{fm35(p2, |v33|, cf19, |p1|, globalState), multiset{|v34[false := f6]|}, v29};
					var v36: T1 := new C2(p2, v35, f9, f10);
					var v37: array<seq<bool>> := new seq<bool>[5](i4 => p1);
					v37[992] := p1;
					v32, v36, v37[992] := v32, DC18(v36).cf38, p1;
					v2[281] := v2[281];
				...
				var v42: map<D4, bool> := map[v41 := v2[281] < |map[cf20 := cf20]|];
				v42 := v42[v41 := cf20];
			case DC5(cf12) =>
				var v43 := DC8(p0, p0);
				var v44: map<int, bool> := map[|(v0 + (seq(-880, i5  => (v2[281]))))| := v43.cf20];
				var v45: map<bool, bool> := map[p1[f6] := p0];
				v44 := v44[|v45| := true];
				var v46: array<set<seq<char>>> := new set<seq<char>>[27](i6 => {(seq(-0x32a, i7  => ('y')))[0xee := 'l']});
				var v47 := 'b';
				...
				if (false) {
					...
					var v51: multiset<multiset<int>> := multiset{multiset{619, v2[281]}};
					var v52 := new C2(-|v50|, fm36(globalState) - v51, f9, map[|v48| := seq(670, i8  => (v47))]);
					var v53: map<int, array<int>> := map[p2 % f6 := v2];
					v53 := v53;
					f9[918] := p0;
					var v54: map<bool, string> := map[p0 := v48];
					var v55: multiset<bool> := multiset{p0};
					var v56: multiset<int> := multiset{f6};
					var v57: set<int> := {0x2e3, -v2[281], v2[281]};
					...
					f9[918], v58[795], v2[281], v59, r1 := p0, v54, |v48[p2 * p2 := v47]|, v59.(cf2 := p0), p0 in p1;
					var v60: set<bool> := {p0, f9[918]};
					var v61 := DC0(p1[|v60| := p0], -92);
					var v62 := DC4(v61, f6, v48, p0, p2);
					var v63: set<bool> := {if (f6 in v44) then v44[f6] else f9[918], v62.cf10};
					var v64: set<set<bool>> := {v60, v63, {if (false in v45) then v45[false] else f9[918]}};
					var v65: seq<multiset<set<bool>>> := [multiset{v63, v60}];
					var v67: map<set<bool>, int> := map[v63 := f6];
					var v69: map<set<bool>, set<bool>> := map[{p0, f9[918]} := v60];
					var v71: seq<set<set<bool>>> := [v64];
					var v72: map<set<bool>, bool> := map[v63 := f9[918]];
					var v74: array<set<set<bool>>> := new set<set<bool>>[27] [v64, v64, v64, v64, v64, v64 * v64, {v63, v63, v60}, v64, if (p0) then v64 else v64, set v66 : set<bool> | v66 in v65[735] :: (v66), v64 + v64, set v68 : set<bool> | v68 in v67 :: (v68), v64, {{p1[v2[281]], f9[918]}, v60}, v64, v64 - (set v70 : set<bool> | v70 in v69 :: (v70)), v71[|v55|], set v73 : set<bool> | v73 in v72 :: (v73), v71[f6], v64 * {v60, v60}, {v63}, {v63, {p0}, v63, v60, v60} * v64, v64, v64, v64, if (p0) then v64 else v64, v64];
					v74[14] := {v63};
					globalState.f0, globalState.f0, globalState.f0, globalState.f5, v74[14] := p0 && f9[918], f9[918], p0 && f9[918], fm2(v2[281] - p2, globalState), v64;
				} else {
					v2[281] := -(v2[281] - --f6);
					var v75: multiset<int> := multiset{f6};
					var v76: multiset<multiset<int>> := multiset{v75};
					var v77 := new C2(v2[281], v76 - v76, f9, map[f6 := v48]);
					var v78: set<bool> := {p0};
					var v79 := DC16(v78);
					v79 := v79;
				...
				globalState.f5 := v2[281];
		}
		
		var v80 := DC17(v0, p0);
		match (v80) {
			case DC17(cf36, cf37) =>
				var v81: map<int, int> := map[f6 := v2[281]];
				...
				var v86: map<C1, bool> := map[v85[|p1|] := cf37];
				f9[102] := if (v84 in v86) then v86[v84] else cf37;
				var v87 := 'r';
				var v88: multiset<char> := multiset{v87};
				var v89: map<bool, multiset<char>> := map[cf37 := v88];
				var v90: seq<multiset<char>> := [v88, multiset(['v', v87, v87]), v88, if (cf37 in v89) then v89[cf37] else v88['c' := p2]];
				var v91 := DC12(v90);
				f9[102], cf37, v91 := false, |(([p1])[0xed := [p0, !cf37, true, p0]] + [p1])| > (0xb6 - fm2(565, globalState)), v91;
				...
				cf37, v92, v2, globalState.f5, v93 := if (cf37) then v94.cf2 else f9[102] <==> cf37, fm35(v2[281], f6 * -f6, false, p2, globalState), v2, |(seq(0x3a0, i9  => ((seq(0x399, i10  => ('a')))[f6 := v87])))[-96 := v95]|, if (v98 != v98) then v93 else v93;
				f9[102] := p0;
			case DC16(cf35) =>
				var v99: map<int, seq<int>> := map[|multiset(p1)| := seq(0x1a0, i14  => (f6))];
				var v100: multiset<bool> := multiset{p0, true};
				var v101 := 'h';
				var v102: multiset<char> := multiset{'u', v101};
				var v103: map<bool, seq<int>> := map[!p0 := v0[782 := if (p0 in v100) then v100[p0] else |v102|]];
				var v104: multiset<int> := multiset{f6, v2[281]};
				var v105: seq<seq<int>> := [v0];
				var v106 := "nhw";
				var v107: seq<seq<int>> := [v0, v0, v105[fm2(|v106|, globalState)]];
				var v108: array<seq<int>> := new seq<int>[14] [(seq(49, i12  => (v2[281]))) + v0, v0, v0 + (seq(0x14c, i13  => (p2))), if (|v0| in v99) then v99[|v0|] else [p2, f6], v0[v2[281] := fm2(f6, globalState)], v0 + (seq(0x280, i15  => (f6))), v0, v0, if (p0 in v103) then v103[p0] else v0[|v104| := v2[281]], v0, v0 + v0, v105[f6], if (!!!p0) then v0 else v0, [v2[281], f6, v2[281], 953, p2] + [v2[281]]];
				v108 := new seq<int>[28](i16 => v0 + v0[f6 := |p1|]);
				var v109 := DC16(cf35);
				...
				globalState.f5 := |(v111 + [v106, "f"])| / |v106|;
		}
	...
	method m7(p0: multiset<int>, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: array<bool>, r3: int) {
		...
		if (|fm1(globalState)| <= |({v3, map[!v2 := |(map v4 : seq<int> | v4 in map[v5 := v2] :: (v4) := (v2))|]} + {v3, v3})|) {
			...
			v17 := new D2[25];
			var v18: multiset<multiset<int>> := multiset{p0[v1[211] := f6]};
			var v19 := new C2(v1[211], v18[p0 := v1[211]], f9, fm39(v0, globalState));
			var v20: set<int> := {v1[211], f6, p1 + fm2(f6, globalState)};
			v20 := v20;
			...
			if (v2 ==> v2) {
				...
				var v30: map<bool, bool> := map[!v28[0xff] := if (v25 in v29) then v29[v25] else true];
		...
		var v37 := "rtg";
		v36[273] := map[v1[211] := v37];
		v36[273] := f10;
		r0 := v0;
		var v38: seq<bool> := [v2, fm3(globalState)];
		r1 := v1[211] - |v38|;
		r2 := new bool[7] [v2, false, v38 <= v38[f6 := fm3(globalState)], -0x2f5 == |v5|, if (v2) then v2 else v2, v2, true <== v2];
		r3 := -(|v37| / f6);
	}
	method m14(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: char, r2: bool) {
		if (p1) {
			...
			if (!p0) {
				...
				var v18 := DC26(v17[f6]);
				v18, v15[13], f9[199] := v18, v15[13] % |(v13 + v13)|, p0;
				var v19: set<int> := {v15[13] / |v14|};
				v19 := set v20 : int | v20 in v13 :: (v20 / (|map[{-0x3da} := DC12([multiset{'n', 'h'}, multiset{'c', 'm'}])]| * |multiset{|multiset([|{!!!false}|, |"ehssnh"|, |map[true := -0x3ba]|])|}|));
				...
				v21[121] := v5;
				var v22: map<bool, bool> := map[!f9[199] := p1];
				v21[121] := fm0(|v3|, {f6, |v3|}, if (p0 in v22) then v22[p0] else f9[199], globalState);
			} else {
				var v23: multiset<int> := multiset{f6, |"idv"|};
				globalState.f5 := (f6 - |v23|) + (f6 / f6);
				...
				v26[339] := f6;
				globalState.f0, v26[339] := p1, f6;
				var v27: seq<bool> := [f9[199], fm3(globalState), p1];
				var v28: array<bool> := new bool[17];
				var v29: map<int, array<bool>> := map[f6 := v28];
				var v30: set<int> := {v26[339] / v26[339], 0x107 * |v29|};
				var v31: seq<int> := [f6];
				var v32 := DC6(v26[339], v26);
				v26, r0, v27, v30, globalState.f5 := v26, |(v31 + (v31 + v31))|, v27 + v27[f6 := f9[199]], v30 * {|f21|}, v32.cf13;
			}
			...
			var v38 := DC14(p1, map[p1 := f9[199]], fm2(f6, globalState), v37);
			var v39 := 'i';
			var v40: multiset<int> := multiset{f6};
			var v41: multiset<int> := multiset{|v40|, 0x36d};
			var v42 := DC1(f9[199], f6, v39);
			var v43: seq<string> := [v36];
			var v44: array<int> := new int[24] [-382, f6, f6, f6, |v36|, ---|multiset{fm0(f6, v35, p0, globalState), v39}|, |v36|, f6, f6, |([v39])[f6 := 'm']|, |v34|, 0x352, 0xd8, |v40|, -913, -f6, f6, f6, v42.cf3, f6, 0xe3, -f6, if (f6 in v41) then v41[f6] else |v43[f6]|, f6];
			var v45 := DC6(0xb5, v44);
			var v46: array<int> := new int[27] [f6 + f6, --0x372, -0x83, f6, f6, f6 + -0x33d, 0x15, f6, |v34| / |v35|, -|v36|, f6, f6, f6, -v38.cf30, f6, |v36|, f6, f6, f6, f6, f6, f6, f6, f6, |(fm30(p1, v39, globalState))[|(seq(0x21f, i1  => (v39)))| := v39]|, f6, v45.cf13];
			...
			v48[947] := v45;
			globalState.f5, globalState.f2, globalState.f5, v46, v48[947] := if (p0) then -f6 else f6, "i", f6, v44, v45;
		}
		...
		var v56: T0 := new C2(-v53[f6], v55, f9, f10);
			...
			decreases 100 - i2
		{
			...
			r0 := 839;
			f9[28] := p1;
			f9[28] := if (p0 || p0) then p1 else true;
			var v60: array<array<int>> := new array<int>[6] [v49, v49, v49, v49, v49, v49];
			v60[762] := v49;
			var v61: seq<seq<int>> := [v53, seq(0x280, i3  => (v56.f6)), v53];
			var v62: array<bool> := new bool[9](i4 => p0);
			var v63: map<seq<int>, array<bool>> := map[v61[f6] := v62];
			var v64: set<bool> := {f9[28], true};
			r0, v49[450], v60[762], v63, globalState.f0 := (f6 % |fm40(f6, v64, globalState)|) * -v56.f6, v49[450], v49, (v63 + v63) + v63, p1;
		}
...
class C4 extends T1, T0, T2 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		match DC0([false, true], f6) {
			...
			case DC1(cf2, cf3, cf4) => [multiset{cf4}, multiset{cf4}] + (seq(0x1c0, i0  => (multiset{cf4})))
			case DC2(cf5) => (seq(0x199, i1  => (multiset{'e', 'g'}))) + (seq(613, i2  => (multiset(seq(0xed, i3  => ('j'))))))
		}
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map[f17 := [f18]] + (map[|(seq(0x29d, i0  => ('g')))| := [f18]] + map[|[false, true]| := [f18]])
	}
	function fm21(p0: int, globalState: GlobalState): int {
		f18 / (f17 - |map[true := !false]|)
	}
	function fm22(p0: multiset<bool>, p1: bool, p2: int, globalState: GlobalState): bool {
	...
	method m6(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState) returns (r0: seq<string>, r1: bool) {
		...
		for i0 := |(v0 + v0)| to p2 - p2 {
			...
			var v7: map<bool, bool> := map[p0 := p1[-0x1d1]];
			...
			decreases 100 - i2
		{
			...
			globalState.f5 := f18;
			var v11 := DC0([p0], f6);
			globalState.f5 := |fm25(p2, v10.f20, globalState)| / v11.cf1;
			var v12: array<int> := new int[9](i3 => i3 / f18);
			v12[602] := f6;
			...
			r1, v12[602], globalState.f0, globalState.f5, globalState.f5 := v10.f20, f6, v13 <= v13, |map[v10.f20 := v14]|, |fm4(-|v15[f6 := -f18]|, 0x26d, f18, globalState)| / ((if ('g' in v17) then v17['g'] else f6) % f6);
		}
		if (p0) {
			var v18 := DC0(p1, p2);
			var v19 := DC2(v18);
			...
			globalState.f0 := !(v21 > ((set v22 : map<int, D0> | v22 in (seq(-0x375, i4  => (v20))) :: (v22)) + v21));
			var v23 := 'f';
			v23 := v23;
			...
			globalState.f0 := fm21(-|v0|, globalState) < (f17 % |v27|);
		} else {
			if (f18 != p2) {
				...
				var v36 := "koabsqd";
				var v37 := 'v';
				v35[788] := |v36| * |fm26(f6, v37, v34.f20, v37, globalState)|;
				v35[788] := f6;
			}
			
			var v38: seq<int> := [f17];
			var v39 := new C0(f9, f17 > v38[f18]);
			var v40 := "snhg";
			var v41: set<bool> := {v39.f20};
			var v42 := 'b';
			var v43: map<int, char> := map[|multiset{|v41|}| := v42];
			var v45: multiset<string> := multiset{seq(0x12, i6  => (v42))};
			var v46: map<string, int> := map[v40 := -0x80];
			var v48: array<map<string, int>> := new map<string, int>[13] [if (p0) then map[v40 := |[v40[p2], if (f17 in v43) then v43[f17] else v40[p2]]|] else map v44 : string | v44 in v45 :: (v44) := (0x139), v46, v46, v46, v46, fm27(globalState), v46, v46, v46, v46, v46 + map[v40 := --0x210], v46, (map v47 : string | v47 in (multiset{v40})[v40 := f17] :: (v47) := (f17)) + v46];
			v48[179] := v46;
			v48[179] := v46;
			...
			decreases 100 - i7
		{
			...
			v52[522] := p2;
			var v53 := "wmae";
			globalState.f0, globalState.f5, f9[921], v52[522] := p0, f6, p0, |v53| + f17;
			globalState.f5 := p2;
			var v54: multiset<array<int>> := multiset{v52};
			v52, v54, globalState.f2, globalState.f0 := if (f9[921]) then if (p0) then v52 else v52 else v52, v54, seq(0x2ef, i9  => (v53[f17])), fm3(globalState);
		}
		...
		globalState.f5, f9, v55[275] := f18 - f18, f9, v64[|map[p0 := false]|];
		r0 := fm29(if (p0) then v55[275] else v55[275], globalState);
		r1 := p0;
	}
	method m7(p0: multiset<int>, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: array<bool>, r3: int) {
		var v0 := 'v';
		...
		for i0 := f6 to if (v0 in v5) then v5[v0] else |(map v6 : int | (0x23 <= v6) && (v6 < 0x3be) :: (v6 - f18) := (true))| {
			...
			v14 := v14[v12 := v8];
			if (v8) {
				var v15: map<seq<int>, bool> := map[seq(0xc7, i1  => (f18)) := v8 ==> v8];
				v15 := v15;
				globalState.f0 := v8;
				...
				v28[569] := (multiset{v2})[[766] := p1];
				var v29: array<seq<int>> := new seq<int>[10];
				v27, v28[569], v29 := v27, v3, v29;
				r3 := |((if (v8) then v23 else v23) + v23)|;
				f9[921], f9[921], v0, f9[921] := v8, !f9[921], DC1(v8, p1, v0).cf4, v8;
			}
			...
			var v33: seq<bool> := [fm22((multiset{v8})[v32.cf28 := f6], false, f6, globalState)];
			var v34: set<int> := {p1, |v33|, |v1|, f6};
			v30[466] := (v2 + v2) + (v2 + [|v34|, f17, f18]);
			r3 := (p1 * f18) + f6;
		}
		...
		for i5 := f17 to |v38| {
			...
			var v44: seq<array<bool>> := [f9, v43[0x31d], f9, f9];
			var v45 := DC13(seq(-0x1e4, i6  => (f6)), v40, f18);
			var v46: map<bool, bool> := map[v40 := v45.cf26];
			var v47 := new C3(v42, v44[|v46|], f10, |v38|);
			r1 := f6;
			...
			if (v51 != v51) {
				...
				v58 := v58[if (f6 in v59) then v59[f6] else v57 := f6 - v2[f6]];
			} else {
				v50[492] := |v1|;
				v50[492] := f17;
				var v60: set<char> := {v0};
				var v61: map<int, set<char>> := map[f17 := {v0, v0, v0} + v60];
				v61 := map v62 : int | v62 in (v47.f21 + fm42(v49, p0, -f6, v0, globalState)) :: (v62 * |(map v63 : D0 | v63 in multiset{DC1(v49, 0x109, v0), DC1(v48, |v38|, v0), DC1(v40, f18, 'g'), DC1(v48, 0x178, v0), DC1(v49, f6, v0)} :: (v63) := (-v50[492]))|) := ({v0, v0});
				var v64: array<string> := new string[20];
				v64[386] := seq(0x3b4, i7  => (v38[v50[492]]));
				v64[386] := v38;
				...
				var v71: map<D9, seq<bool>> := map[v69 := v70[f18 := v40]];
				v66[472] := new int[12] [p1, |v71|, f18, 0x236, if (v48) then f6 else -f17, 0x72 / i5, -0x393, f17, f6, p1, v50[492], f6];
			}
			...
			decreases 100 - i9
		{
			...
			var v76 := DC17(v2, v40);
			var v77: seq<D5> := [DC17((seq(0x364, i10  => (|map[v40 := f18]|)))[|v74| := |v75|], !v40), DC17(v2, v40), v76];
			var v78: seq<multiset<int>> := [fm35(f17, |map[-p1 := f9]|, v40, |v41|, globalState)];
			var v79: map<seq<D5>, int> := map[v77 := if (v40) then f17 else |(v78[f17])[f17 := f6]|];
			v79 := v79;
			var v80: set<int> := {f6};
			var v81: seq<string> := [v38[p1 := fm0(f6, v80, v73[f18], globalState)]];
			var v82: array<string> := new string[17] [v38 + "dpxwvvn", "oplylgwjk", seq(0x1b7, i11  => (v0)), v38, v38, "huf", fm30(v40, 'n', globalState), v38, "a" + v38, v38, "xkaku", v38, (v81[|v73|])[f18 := v0], fm25(f17, v40, globalState), fm30(v40, v0, globalState), v38, v38];
			...
			if (!v40) {
				...
				var v88 := DC25(if (v40) then p1 else f6, if (v40 in v1) then v1[v40] else 0x8b, if (v40) then |(seq(-0xff, i12  => (f18)))| else -f18, v0);
				v88 := v88;
				var v89 := DC0(v73, f18);
				globalState.f2, r3 := v38 + v38, (if (v40) then v89.cf1 else f18) + (f17 * f17);
				var v90: array<int> := new int[17];
				v90[606] := f18;
				globalState.f0, r3, v41, v90[606] := v40, -0x338 % p1, {v40} - v41, DC13(v2, v40, -f17).cf27;
				r3 := |(v38 + v38)|;
			} else {
				globalState.f0 := v40;
				f9[257] := v40;
				var v91: seq<seq<int>> := [v2, v2];
				f9[257], v91, globalState.f5 := |("afv" + v38)| > (f18 / -p1), v91, f6;
				f9[257] := f9[257];
				var v92 := DC34(v1);
				var v93: map<int, multiset<bool>> := map[f6 := v92.cf67];
				v1 := v1 + (v1[false := f17] - (if (fm21(|v73|, globalState) in v93) then v93[fm21(|v73|, globalState)] else multiset{v40, f9[257]}));
				globalState.f5 := -f6;
			}
	...
	method m12(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>) {
		var v0: seq<int> := [f6];
		var v1: seq<int> := [f18 - f17, v0[f18], f18, 0x370 / f6, f6 + f18];
		var v2 := "xxnkqk";
		...
		var v8: set<int> := {f6};
		var v9: C2 := new C2(|(v5 + v5)|, multiset{v6}, f9, (map v7 : int | v7 in v8 :: (v7 % -0x267) := ("m"))[f17 := v2]);
		var v10: seq<map<int, bool>> := [v3];
		var v11: seq<bool> := [true];
		var v12: map<array<bool>, multiset<bool>> := map[f9 := multiset(v11[|v2| := p1])];
		var v13: seq<map<int, bool>> := [(v10[f6])[|v12| := p1], v3];
		var v14: set<bool> := {!false, f6 > f17, v10 == v13};
		var v15 := 'y';
		var v16: map<char, bool> := map[v15 := !v11[f6]];
		f9[202], v4, v9, v14, r1 := if (v15 in v16) then v16[v15] else fm3(globalState), v4, v9, v14, p1;
		for i0 := f18 to if (!p1) then |v11| else f6 {
			if ((-v9.fm21(|v6|, globalState) != -f17) in v11) {
				...
				var v21: map<bool, int> := map[f9[202] := f18];
				globalState.f5 := DC1(p1, |{f6, |v21|}|, v15).cf3;
				var v22: array<bool> := new bool[23];
				var v23 := new C2(-f18, f16 * f16, v22, map[f18 := v2[f18 := v15]]);
				var v24 := DC9(v1[f6 := fm2(i0, globalState)]);
				var v25 := new C2(f18, f16[multiset(v24.cf21) := |v2|], DC23(v22).cf44, f10);
				globalState.f0 := p1;
				v15 := if (f9[202]) then v15 else v15;
			}
		...
		f9[202], v15 := false, v15;
		r0 := p1;
		r1 := p0;
		var v34: array<int> := new int[24](i1 => i1 / |v33|);
		r2 := v34;
	}
	method m13(p0: int, globalState: GlobalState) returns (r0: D2, r1: seq<bool>, r2: string) {
		if (f17 == (p0 / p0)) {
			...
			if (false) {
				...
				var v10: seq<bool> := [!v0];
				var v11 := DC35(v9);
				var v12: array<map<C2, bool>> := new map<C2, bool>[28] [v9, v9, v9, v9, if (v0) then map[v8 := v0] else v9, v9, v9, v9 + v9, v9, v9, v9, if (true) then v9 else v9, v9[v8 := v0], v9[v8 := true], v9, map[v8 := v0] + v9, v9 + v9[v8 := v10[|"tk"|]], map[v8 := v0] + v9, v11.cf68, v9[v8 := v0], v9, v9, v9 + v9, v9, v9, v9, v9, v9];
				v12[608] := v9 + v9;
				var v13: map<bool, map<bool, bool>> := map[v0 := map[v0 := true]];
				var v14: map<bool, bool> := map[v0 := false];
				v12[608], v3, v10, globalState.f0, globalState.f0 := v9, fm45(|v2| - f17, f6, globalState), v10 + (v10 + fm4(f18, p0, |(if (v0 in v13) then v13[v0] else v14)|, globalState)), v0, v0;
				...
				v27 := v27[v0 := if (v0 in v27) then v27[v0] else v28[f17]];
				var v29: array<int> := new int[6];
				var v30: map<bool, int> := map[v0 := p0];
				v29[768] := 264 / |v30|;
				var v31: map<int, bool> := map[914 := v0];
				v29[768] := fm2(if (v0 in v30) then v30[v0] else |v31|, globalState);
				var v32 := "lnnj";
				var v33: seq<string> := ["hieeu" + v32, v32, seq(0x82, i1  => (v1))];
				v33, globalState.f5 := seq(0x2c0, i2  => ("xrfic")), f18;
			}
			
			var v34: map<bool, int> := map[fm22(multiset{v0, !v0}, v0, 0x42, globalState) := f6];
			var v35: array<int> := new int[12](i3 => i3 / -0xe4);
			var v36: multiset<int> := multiset{f17};
			v35[784] := if (v0) then p0 else |v36|;
			var v37 := "w";
			globalState.f5, v34, v35[784], globalState.f5, v35 := |(v37 + v37)|, v34, --0x223, f18, if (v0) then v35 else if (v0) then v35 else v35;
			if (v0) {
				globalState.f5 := f6 / p0;
				var v38 := new C2(p0 + |v37|, f16, f9, f10 + map[f17 := v37[|(seq(939, i4  => (v1)))| := v1]]);
				var v39 := new C1(f17 / f17);
				...
				v42[807] := v41;
				v42[807], globalState.f5, globalState.f0 := v41, f17, !v0;
				var v43: seq<bool> := [v0];
				r1 := ([v0] + v43) + v43;
				globalState.f5 := f17;
				f9[245] := v0;
			...
			match (v53) {
				case DC19(cf39, cf40, cf41) =>
					...
					f9[900], v54[560], globalState.f5, v55 := -p0 in (if (v49 in v56) then v56[v49] else f10), v59.cf1, -cf39 / 0x1e1, v55;
					var v60: array<map<bool, bool>> := new map<bool, bool>[6](i6 => map[false := v46]);
					var v61 := DC26(v60);
					v61 := v61;
					globalState.f0 := f9[900];
				case DC18(cf38) =>
					var v62: seq<seq<int>> := [v47, v47, v47];
					v62 := v62;
					globalState.f5 := f17;
					var v63: map<int, string> := map[p0 := seq(0x3b, i7  => ('e'))];
					var v64 := "oaqqtxvm";
					...
					var v67: array<int> := new int[7](i8 => i8 / f6);
					v66[475] := if (v46) then v67 else v67;
					var v68: seq<bool> := [v46, v46, p0 <= p0];
					globalState.f5, globalState.f5, v46, v66[475] := v47[f17], f18, v68[f6], v67;
				case DC20(cf42) =>
					var v69: seq<bool> := [v46];
					var v70: map<bool, bool> := map[v69[f17] := !v46];
					...
					var v76: map<D11, map<bool, array<int>>> := map[DC30({f17}).(cf57 := set v73 : int | v73 in v72 :: (v73 / |multiset([true])|)) := v75];
					var v77: map<int, int> := map[f17 := 0x3a3];
					var v78: C3 := new C3(v77, f9, f10, p0);
					var v79: seq<C3> := [v78, v78];
					var v80: map<C3, bool> := map[v79[f6] := false];
					var v81: set<int> := {|v80|};
					var v82 := DC30(v81);
					v76 := v76[v82 := v75];
					v70, globalState.f0, globalState.f5 := v70[v46 := p0 <= p0], v46, (f18 / f6) % f6;
			}
		...
		match (v86) {
			case DC29(cf53, cf54, cf55, cf56) =>
				...
				f9[104] := v90[f18] !in map[v89 := v87];
				var v91: seq<bool> := [f9[104]];
				var v92: seq<seq<bool>> := [v91, v91];
				var v93: map<int, int> := map[-|(v92 + v92)| := f17];
				v93 := v93[|v88| := p0];
				var v94 := DC0(v91, cf53);
				var v95 := DC4(v94, f6 % f6, "pceere", cf55, p0);
				match (v95) {
					case DC4(cf7, cf8, cf9, cf10, cf11) =>
						var v96: map<bool, array<string>> := map[false := v84];
						var v97: array<array<string>> := new array<string>[21] [cf54, v84, if (f9[104] in v96) then v96[f9[104]] else v84, v84, cf54, v84, v84, v84, cf54, cf54, cf54, cf54, DC29(f6, v84, v85, fm2(0x216, globalState)).cf54, v84, v84, cf54, v84, v84, v84, v84, v84];
						v97[959] := cf54;
						v97[959] := cf54;
						f9[104] := [v91, [cf10, cf55]] < v92;
						cf53 := fm2(615, globalState);
						var v98: array<set<int>> := new set<int>[20];
						var v99: array<int> := new int[13];
						v98, v99, r2 := v98, v99, fm25(cf11, f6 !in (seq(-0x299, i11  => (cf11))), globalState);
					case DC3(cf6) =>
						var v100: array<bool> := new bool[8];
						var v101 := new C0(v100, !!f9[104]);
						...
						v106 := (fm47(v87, map v107 : int | (0x163 <= v107) && (v107 < 0x2b2) :: (v107 % f6) := (v85), cf55, globalState) - multiset{v105}) - v106[fm30(v85, v108.cf4, globalState) := |v109|];
						v87 := v87;
				}
				
			case DC28(cf52) =>
				var v110 := new C0(f9, v85);
				globalState.f2 := seq(-0xaa, i12  => ('s'));
				...
				v113 := v113[v110.f20 := multiset(v114[f18 := f17])];
				v110.f19[998] := if (v110.f20) then v85 else v85;
				var v115: array<int> := new int[1](i13 => i13 % f17);
				v115[256] := 0x86;
				var v116 := "tl";
				var v117: seq<string> := [v116];
				v110.f19[998], globalState.f5, v115[256], globalState.f0, globalState.f5 := !v85, p0 / 0x16f, p0, DC13(v114, false, p0).cf26, |([f17, |v117[547]|, f17, f17] + v114)|;
		}
		
		var v118 := 'i';
		var v119: seq<char> := [v118];
		var i14 := 0;
		while (!(f6 < (0x3d5 / fm2(|v119|, globalState))))
			decreases 100 - i14
		{
			if (i14 >= 100) {
				break;
			...
			i14 := i14 + 1;
			globalState.f5 := f17 / (|v119| / f18);
			var v121: seq<int> := [p0];
			var v122: set<int> := {|v121|, f6};
			var v123 := new C2(p0, f16, f9, map v120 : int | v120 in v122 :: (v120 % 0x8a) := (v119));
...
class C5 extends T0 {
	...
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		(map[f15 := [f6]] + map[DC0([false, DC8(!false, false).cf20], |"ig"|).cf1 := seq(0xae, i0  => (f15))]) + (map[f15 := [DC4(DC0([!true, true], f6), f6, seq(108, i1  => ('p')), false, f15).cf11, f6]] + (map v0 : int | (0x5e <= v0) && (v0 < 0x291) :: (v0 + f6) := ([|multiset{true}|])))
	}
	method m10(p0: bool, p1: int, globalState: GlobalState) returns (r0: map<bool, int>, r1: bool) {
		...
		match (if (p0) then DC6(v1.cf13, v0) else v1) {
			...
			case DC8(cf19, cf20) =>
				...
				var v29: map<int, string> := map[0x26e := v28[p1]];
				...
				var v39: map<bool, bool> := map[|(if (!true in v36) then v36[!true] else v35[f15 := p0])| == 0x57 := v38 != v38];
			...
			case DC5(cf12) =>
				...
				var v46: map<set<map<int, int>>, int> := map[v43 := if (([fm2(-138, globalState)])[p1 := f6] in v45) then v45[([fm2(-138, globalState)])[p1 := f6]] else |v44|];
		...
		v0[609] := |v55|;
		v0[609] := p1;
		var v56: map<array<int>, int> := map[v0 := v0[609] * v0[609]];
		...
		var v62: seq<bool> := [p0];
		var v63: map<int, bool> := map[f6 := v62[|fm1(globalState)|]];
		var v64: map<map<int, bool>, bool> := map[v63 := p0];
		r1 := if (p0) then |v61| < |fm33(DC10(v64), |(seq(0x35f, i0  => ('a')))|, !p0, if (v0[609] in v63) then v63[v0[609]] else false, globalState)| else p0;
		var v65: set<bool> := {false, p0};
		var v66 := DC33(f15, p0, f15, p0, v65);
		var v67: multiset<int> := multiset{v66.cf64, f15, 0x70, f6, 0x1dd};
		v0[609] := (p1 - |multiset{v0[609]}|) * |fm42(p0, v67, |v67|, v58, globalState)|;
		r0 := DC36(v60).cf69;
		r1 := p0;
	}
	method m11(p0: bool, p1: bool, p2: map<int, int>, globalState: GlobalState) returns (r0: int, r1: seq<int>, r2: bool, r3: int) {
		...
		r3, v6[307], v7 := f6 + 0xa, v5, v9[f15 + v1[f6]];
		for i0 := 0x1a1 to v1[f15] {
		...
		match (DC17(v1, p0)) {
			case DC17(cf36, cf37) =>
				...
				var v19: map<int, bool> := map[f15 := v17[166]];
				var v20: set<int> := {|v19|, 667, f6};
				var v21: seq<set<int>> := [v20, v20];
				var v22: array<int> := new int[22] [|map[cf37 := true]|, f15, |v18[|cf36| := p0]|, f15, |v21[f6]|, |v0|, f6, fm2(f6, globalState), f15, f6, f6, f15, -f15, f6, -f15, v1[f15], fm2(f6, globalState), 697, f15, f15, 576, f15];
				var v23: map<array<int>, bool> := map[v22 := v17[166]];
			...
			decreases 100 - i2
		{
			...
			var v29: array<int> := new int[14](i3 => i3 % f15);
			var v30 := DC6(f6, v29);
			var v31: seq<array<int>> := [v29, v29];
			var v32: array<array<int>> := new array<int>[11] [v29, v29, v29, v29, v29, (v30.(cf14 := v29).(cf14 := v29)).cf14, v31[|v7[p0 := f15]|], v29, v29, v29, v29];
			v32[790] := v29;
			v32[790] := v29;
			globalState.f5 := f15;
			var v33 := new C1(f15);
		...
		var v34: seq<bool> := [p0];
		var v35: seq<bool> := [v34[-|{p1}|], false];
		var v37: map<int, bool> := map[|(map v36 : int | v36 in v1 :: (v36 * -f15) := (f6))| := p0];
		var v38: map<map<int, bool>, bool> := map[v37 := p0];
		var v39 := DC10(v38);
		var v40: array<D3> := new D3[3] [if (v34[f15]) then v39 else v39.(cf22 := v38), DC10(v38), v39];
		v40[680] := v39;
		v40[680] := if (p1 <==> p1) then v39 else v39;
		if (p1) {
			if (true) {
				globalState.f2 := fm30(p1, v2, globalState);
				var v41: array<bool> := new bool[10](i4 => !p1);
				var v42: map<int, string> := map[f15 := "amxb"];
				var v43: multiset<multiset<int>> := multiset{multiset(v1[f6 := 680])};
				var v44 := new C4(fm2(fm2(f6, globalState), globalState), f15, if (p0) then v41 else v41, v42 + (map[|(seq(0x8d, i5  => (v2)))| := v0])[fm2(|v7|, globalState) := "coc"], f6, v43);
				globalState.f5 := |v1| % f6;
				...
				var v49: seq<seq<D4>> := [v48, seq(710, i6  => (v47)), v48, (v48[f6 := v47])[f6 := DC14(p1, v46, -v44.f17, map[p0 := p0])], v48];
				globalState.f0, globalState.f5, globalState.f0, v2 := v45.cf2, |v49| * f6, ("kx" != v0) || p0, 't';
				var v50: set<bool> := {p0};
				var v51 := new C1(0x224 % v44.fm21(|v50|, globalState));
			} else {
				globalState.f0 := p0;
				...
				var v57 := new C2(-0x2a4, v53 + multiset{v52, v52}, v54, v55 + (map v56 : int | (-0x3a <= v56) && (v56 < 555) :: (v56 % |map[false := |v52|]|) := (v0)));
				...
				v63 := v63[v2 := ([v61.fm21(f6, globalState), |fm35(f6, f6, p1, f6, globalState)|, f6, 0x3df, f15])[|fm40(f6, v64, globalState)| := 0x199] != (seq(0x2f9, i8  => (|"tvotwjin"|)))];
			}
			
			var v65: seq<string> := [seq(-371, i9  => (v2)), v0, seq(714, i10  => (v2))];
			v65 := if (p1 || p1) then v65 else v65;
			var v66: array<bool> := new bool[6];
			v66[861] := v7 <= fm48(globalState);
			var v67: array<D1> := new D1[11];
			var v68: map<array<D1>, bool> := map[v67 := p0];
			v66[861], r2, v68, r3, globalState.f0 := p1, f15 > f15, v68, f15, v35[f6];
			...
			var v75 := new C2(f15, v72, v66, v74[f15]);
		} else {
			var v76: set<char> := {v2};
			var v78: seq<set<char>> := [v76, set v77 : char | v77 in map[v2 := p0] :: (v77)];
			globalState.f5 := |v78| / (if (p0) then 988 else |(seq(0x2bb, i11  => ('q')))|);
			var v79: map<bool, bool> := map[(seq(0x22a, i12  => (-0x91))) != v1 := p0];
			v79 := v79[p0 := p0];
			globalState.f0 := p1;
			v7 := v7 + multiset{p0};
			var v80: set<int> := {f15};
			...
			var v84: multiset<int> := multiset{v1[fm2(|v83|, globalState)]};
			...
			match (v87) {
				case DC6(cf13, cf14) =>
					globalState.f5 := (f6 % |v0|) * f6;
					r3 := f6 + -(f15 + 337);
					globalState.f2 := v0;
					globalState.f0 := if (p0) then p0 else f15 >= f15;
				case DC7(cf15, cf16, cf17, cf18) =>
					globalState.f0 := if (if (p0) then p0 else p0) then p1 else cf15[f15];
					var v88 := DC1(!p0, 0x58, 'f');
					var v89: map<bool, int> := map[p0 := |v7|];
					var v90: array<D0> := new D0[26] [v88, v88, v88, v88, if (p1) then v88 else DC1(p1, cf18, v2), v88, v88, fm20(p1, !p0, true, globalState), v88.(cf4 := v2), v88, v88, DC1(v35[if (p1 in v89) then v89[p1] else f6], f15, v2), v88, if (p1) then v88 else v88, fm20(p0, p1, p1, globalState), v88, v88, v88, DC1(p1, cf17, v2), v88, v88, v88, v88, v88, v88, v88];
					v90 := v90;
				...
				case DC8(cf19, cf20) =>
					...
					v80, v6[307], globalState.f0 := v93[f6], v5.(cf51 := if (v0 in v94) then v94[v0] else DC27(v3)), p0;
...
class C6 {
	...
	function fm15(p0: int, p1: D2, p2: bool, p3: int, globalState: GlobalState): seq<int> {
		[0x387] + ((seq(-992, i0  => (f13))) + (seq(0x14, i1  => (0x2e5))))
	}
	...
	method m8(globalState: GlobalState) returns (r0: int, r1: D2, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			if (f14) {
				...
				globalState.f5 := f13;
				var v7 := "cfytvh";
				var v8: seq<string> := ["cevep", if (f14) then seq(447, i1  => ('h')) else "o", v7 + v7];
				globalState.f2 := v8[-f13 + 97];
				var v9 := 'e';
				v9 := v9;
				globalState.f5 := f13;
			} else {
				...
				var v21: seq<multiset<array<int>>> := [(multiset{v16})[if ('e' in v20) then v20['e'] else v16 := |[v14.(cf1 := f13), v14, v14, v14]|], v17];
				v17 := ((v17[v16 := 0x306])[v16 := |v18[f13]|] + v17) + (v17 - v21[f13]);
				v16[101] := |v3|;
				var v22: set<int> := {|("vp")[f13 := 'q']|};
				v16[101], globalState.f5 := f13 / |v22|, -(f13 * (if (f13 in v3) then v3[f13] else f13));
				v16[101] := f13;
			}
		...
		for i2 := f13 to |map[f14 := f14]| {
			...
			match (v24) {
				case DC6(cf13, cf14) =>
					...
					r2 := v26[|v27| := ((map[f14 := |v28|])[f14 := 0x53])[f14 := cf13]] < v26;
				...
				case DC8(cf19, cf20) =>
					...
					v38 := v39[-871 - |fm4(i2, f13, f13, globalState)|];
				case DC5(cf12) =>
					var v40: array<int> := new int[22](i4 => i4 / -i2);
					...
					v40[298] := -|("gyxgc" + v43)|;
					var v44 := 't';
					var v45: set<string> := {v43[v40[298] := v44], v43, v43};
		...
		for i6 := f13 to f13 % fm16(fm49(f13, fm16(v62, v64, globalState), f14, f13, globalState), v64, globalState) {
			globalState.f0 := f14;
			v0 := v0[f13 := -0x29e + f13];
	...
	method m9(p0: string, p1: string, globalState: GlobalState) returns (r0: set<array<int>>, r1: int, r2: multiset<int>) {
		...
		if (if (f13 == f13) then f14 else v14 in "q") {
			...
			var v19 := DC5(v18);
			v19, globalState.f0, globalState.f5 := DC5(v18), v6[-0x38], f13 - v7[978];
			r1 := f13 + f13;
			var v20: map<bool, bool> := map[v6[f13] := false];
			...
			decreases 100 - i3
		{
			...
			v30[420] := fm2(f13, globalState);
			var v31: map<bool, string> := map[f14 := p0];
			v7, globalState.f0, v26[372], v30[420], globalState.f0 := (fm26(|v31[f14 := p1]| % |v27|, v14, f14, v14, globalState))[f13 := f13], (fm34(|p0|, globalState) * v24) < v24, v7, f13, fm3(globalState);
			r1 := f13;
			if (f14) {
				var v32: array<string> := new string[28];
				v32 := v32;
				var v33: map<seq<int>, int> := map[v26[372] := v30[420]];
				var v34: map<int, map<int, int>> := map[v30[420] := v27];
				v30[420] := if ((v26[372] + v7) in v33) then v33[v26[372] + v7] else |v34|;
				v26[372] := fm40(f13, {f14, f14}, globalState) + v26[372];
				v30[420], globalState.f5 := -v30[420], fm2(|[v24, v24]|, globalState);
				var v35: multiset<bool> := multiset{fm3(globalState)};
				globalState.f0 := v5.fm22(v35, f13 >= f13, f13, globalState);
			} else {
				v3[981] := f14;
				var v36: map<int, seq<bool>> := map[v30[420] := v6];
				var v38: map<int, bool> := map[v30[420] := f14];
				var v40 := DC30(set v39 : int | v39 in v38 :: (v39 * 0x156));
				v3[981] := (v16 * (set v37 : int | v37 in v36 :: (v37 + 744))) > (v40.cf57 * {|(seq(-74, i4  => (v14)))|, v30[420]});
				v26[372] := ((seq(0x191, i5  => (-|v16|))) + v7)[f13 := 0x303 * v30[420]];
				globalState.f5 := f13;
				var v41 := DC33(f13 - |v27|, v30[420] >= f13, v30[420], false, v24);
				var v43 := DC1(f14, |(map v42 : char | v42 in p1 :: (v42) := (v6))|, v14);
				v41, v30[420], v30[420], v3[981], v29 := v41, v30[420], fm16(v13, v43, globalState), v30[420] >= v30[420], v29;
				var v44: multiset<bool> := multiset{v3[981], f14, v3[981]};
				var v45 := DC17(v7, !f14);
				globalState.f0, globalState.f0, globalState.f0, globalState.f5, globalState.f0 := v5.fm22(v44, f14 in v31, f13 * |"uuiikup"|, globalState), v16 > (v16 * {|v6|, f13, f13, f13}), if (|p1| in v38) then v38[|p1|] else f14, if (f14) then -v30[420] else f13 / f13, v45.cf37;
			}
...
class C7 extends T0, T1 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		((seq(-0x261, i0  => (multiset{'u'}))) + (seq(0x254, i1  => (multiset{'u', 'l', DC1(false, 0x2c7, 'g').cf4, 'k'})))) + [multiset{'l', 'b'}]
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map[-f6 := [|[f6]|]] + map[f6 := [|[f6, f6]|, f6, f6, f6]]
	}
	function fm13(p0: char, p1: multiset<bool>, p2: bool, p3: int, globalState: GlobalState): map<bool, string> {
		(if (false) then map[true := "j"] else map[true := "ggjslaqas"]) + (map[true := "kdhe"] + map[!true := seq(0x12a, i0  => ('g'))])
	}
	...
	method m6(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState) returns (r0: seq<string>, r1: bool) {
		for i0 := |([p0, p0] + p1)| to fm14(globalState) {
			globalState.f5 := -((if (p0) then p2 else i0) / i0);
			globalState.f2 := "bksq";
			var v0 := "rwrd";
			...
			if (v2 > v2) {
				...
				v4[778] := [v3.f20, v3.f20] + p1;
				var v5: seq<bool> := [p0];
				var v6: map<int, seq<bool>> := map[|(seq(0x227, i2  => ('n')))| := [!v3.f20, v3.f20]];
				globalState.f0, v4[778], v5, f11, globalState.f5 := fm3(globalState), if (f6 in v6) then v6[f6] else v5, p1, f12, i0;
				...
				v3.f20 := if ((p2 % |v0|) in v9) then v9[p2 % |v0|] else p0;
			} else {
				var v10: multiset<int> := multiset{p2};
				var v11: map<multiset<int>, int> := map[v10 := p2];
				v11 := v11;
				var v12 := DC6(835, f11);
				var v13: array<seq<int>> := new seq<int>[28](i3 => seq(0x3bd, i4  => (f6)));
				var v14: seq<int> := [|v10|];
				v13[944] := v14;
				...
				v12, v13[944], v15[495], globalState.f0, f11 := v12, ([|map[p0 := p0]|])[0x41 := 848] + (v14 + v14), v17, p0, v18[p2];
		...
		f9[449] := if (p0) then !(|[map[p0 := p0], map[p0 := p0]]| == |v22|) else if (p0) then p0 else p0;
		if (p0) {
			var v23: map<int, bool> := map[f6 := !p0];
			var v24: map<map<int, bool>, bool> := map[v23 := f9[449]];
			var v25 := DC10(v24);
			var v26 := DC11(v25);
			var v27: map<bool, seq<bool>> := map[false := p1];
			v26 := fm50(if (f9[449] in v27) then v27[f9[449]] else p1, globalState);
			globalState.f5 := -f6;
			var v28 := "bvftkwuvg";
			globalState.f5 := (|v28| + f6) % p2;
			if (p2 > (f6 * f6)) {
				var v29: seq<array<int>> := [f11];
				var v30: map<bool, bool> := map[!f9[449] := p0];
				var v31 := DC14(f9[449], v30, f6, v30);
				var v32: multiset<bool> := multiset{v31.cf28};
				var v33: seq<int> := [if (f9[449] in v32) then v32[f9[449]] else f6, f6];
				v29, globalState.f0 := v29, v33[f6] < fm2(p2, globalState);
				var v34: array<bool> := new bool[15];
				var v35: map<array<bool>, int> := map[v34 := f6];
				globalState.f5 := if (v34 in v35) then v35[v34] else p2;
				v33 := (v33 + [fm2(p2, globalState)])[fm2(|p1|, globalState) := 745 * |(seq(0x5e, i5  => ('s')))|];
				f9[449] := p0;
				...
				var v39: C6 := new C6(-p2 % f6, if (p2 in v23) then v23[p2] else f9[449]);
				v39 := v39;
				var v40: map<int, int> := map[f6 := -125];
				var v41: seq<int> := [v39.f13];
				var v42: array<bool> := new bool[16] [f9[449], p0, p0, f9[449], p1[|v41|], f9[449], f9[449], p0, p0, p0, p0, f9[449], f9[449], f9[449], f9[449], f9[449]];
				var v43 := new C3(map[f6 := |v40|], v42, f10, v41[v39.f13]);
				var v44: set<int> := {v39.f13, f6};
				var v45 := DC30(v44);
				v45 := v45;
				var v46 := new C5(f6 * v39.f13, 0x2b2);
				var v47: array<D3> := new D3[23];
				v47[466] := v26.(cf23 := v25);
				v47[466] := v26;
			}
			
			globalState.f5 := DC4(fm32(p0, p0, f6, f9[449], globalState), p2, v28, f9[449], p2).cf8;
		} else {
			var v48 := 'u';
			var v49: map<char, bool> := map[v48 := !p0];
			v49 := v49[v48 := p0];
			var v50: multiset<bool> := multiset{p0};
			var v51: set<bool> := {f9[449]};
			globalState.f5 := -((if (f9[449]) then p2 else if (f9[449] in v50) then v50[f9[449]] else f6) - (if (true) then f6 else |v51|));
			var v52 := DC1(f9[449], p2, v48);
			v48, globalState.f5 := v52.cf4, ---p2;
			globalState.f5, globalState.f5 := (p2 % fm14(globalState)) / f6, f6 - (f6 * p2);
			var v53: multiset<char> := multiset{v48};
			var v54: seq<multiset<char>> := [v53, v53, v53];
			var v55 := DC12(v54);
			var v56: map<D4, int> := map[v55 := p2];
			var v57 := "ogh";
			f9[449], globalState.f2 := if (fm2(|multiset([f6, f6])|, globalState) >= |v56|) then !!p0 <==> fm3(globalState) else !!!f9[449], v57;
		}
		
		var v58: multiset<bool> := multiset{f9[449]};
		var v59 := DC19(f6, f6, 0x1ac);
		var v60: map<int, int> := map[if (f9[449] in v58) then v58[f9[449]] else -p2 := v59.cf41];
		v60 := (map v61 : int | v61 in ([f6])[p2 := |v60|] :: (v61 / f6) := (p2))[p2 := f6];
		var v62 := 'y';
		globalState.f5 := |[v62]| + f6;
		var v63: array<map<bool, bool>> := new map<bool, bool>[19](i6 => map[p0 := f9[449]]);
		var v64 := DC26(v63);
		match (v64) {
			case DC25(cf46, cf47, cf48, cf49) =>
				...
				var v68: map<int, seq<char>> := map[|v66| + cf47 := (seq(50, i7  => (cf49))) + v67];
				v68 := v68[v65[--0x2c5] := v67];
				if (p0) {
					...
					var v72: set<bool> := {f9[449]};
					var v73: array<seq<int>> := new seq<int>[28] [v65, v65, v65, v65, seq(-787, i8  => (f6)), v65, v65, v65[fm2(p2, globalState) := f6], v65, v65, seq(-0x29e, i9  => (-939)), v65, v65, v65, v65, v65, v65, v65, [-0x248], [cf47, p2], v65, v65, v65, (v71[p2])[cf47 := cf47], v65, v65, v65[cf46 := |v72|], [f6, p2]];
					...
					r1 := !v77.cf33;
					var v78: array<bool> := new bool[15] [true, false, p0, !p0, !f9[449], fm3(globalState), p0, v77.cf33, f9[449], p0, f9[449], p0, p0, p0, f9[449]];
					var v79 := new C3(v60 + v60, v78, v68 + map[f6 := ("thytt")[cf46 := cf49]], cf48);
					globalState.f5 := cf47;
					var v80: map<bool, char> := map[f9[449] := cf49];
					var v81: set<int> := {cf47, -|(seq(0x2f0, i10  => (cf46)))|};
					cf49 := fm0(|v80|, v81, f9[449], globalState);
					var v82: multiset<multiset<int>> := multiset{v66[0x304 := -|(seq(0x2de, i11  => (cf49)))|], v66};
					var v83: T0 := new C2(cf46, v82, v78, v68);
					var v84: seq<T0> := [v83, v83, v83];
					var v85: T1 := new C3(v60 + v60, if (p0) then v78 else v78, if (false) then f10 else map[|v67| := v67[|v84| := 'j']], -|v58|);
					v85 := new C2(v83.f6, v82, v85.f9, f10 + v85.f10);
				}
				
				f9[449] := (if (fm3(globalState)) then 0x5d else p2) != cf47;
				f9[449] := !!((|p1| - cf48) == |v58|);
			case DC26(cf50) =>
				var v86: seq<char> := [v62];
				var v87: set<bool> := {p0, true};
				var v88 := DC33(p2, p0, |v86|, f9[449], v87);
				if (v88.cf65) {
					globalState.f5 := f6;
					var v89: map<int, char> := map[|v86| := v62];
					var v90: map<int, bool> := map[|v89| := f9[449]];
					var v91: map<bool, bool> := map[f9[449] := f9[449]];
					v90 := v90[p2 := f9[449] in v91];
					globalState.f0 := p0 && (f9[449] !in p1);
					globalState.f5, globalState.f5 := p2, DC31(-0x14a, |map[f6 := f9[449]]|).cf59 * -|v87|;
					globalState.f5 := f6;
				} else {
					var v92: array<D2> := new D2[26];
					var v93 := DC8(f9[449], f9[449]);
					v92[386] := v93;
					v92[386] := if (p0) then v93 else v93;
					globalState.f5 := p2 + f6;
					var v94 := new C1(|v86|);
					var v95: array<array<bool>> := new array<bool>[9];
					f11[471] := -p2;
					var v96: multiset<seq<bool>> := multiset{p1, p1[|v86[p2 := v62]| := f9[449]], p1, p1};
					v95, f11[471] := v95, |(if (fm3(globalState)) then v96[p1 := 569] else v96)|;
					var v97: seq<array<int>> := [f12];
					var v98: seq<int> := [f6, p2];
					var v99: array<array<int>> := new array<int>[9] [f12, f12, f12, f12, f12, f12, f12, f12, v97[---|v98|]];
					var v101: set<int> := {f11[471]};
					var v102: seq<bool> := [(set v100 : int | (-0x3a4 <= v100) && (v100 < -282) :: (v100 % p2)) < v101, f9[449], f6 != -0x15];
					var v103: array<seq<bool>> := new seq<bool>[2];
					f11[471], v99, v102, v103 := |"psadyloiw"|, v99, fm4(p2, -0x34e * 0x11, if (p0) then f11[471] else f6, globalState), v103;
				}
				
				var v104: multiset<int> := multiset{105};
				var v105: multiset<multiset<int>> := multiset{v104, v104};
				var v106: array<bool> := new bool[8] [p0, p0, p0, f9[449], false, p0, p0, f9[449]];
			...
			case DC24(cf45) =>
				...
				var v111: array<bool> := new bool[6] [false, f9[449], p0, !(v110 > v110), false, |p1| == f6];
				var v112: seq<array<bool>> := [if (p0) then v111 else v111];
				v111 := v112[f6];
				globalState.f5 := f6;
				if (f6 <= f6) {
					var v113 := new C0(v111, f9[449]);
					var v114 := "hqae";
					var v115 := DC25(p2, |v114| / p2, -|(seq(0x7d, i12  => (DC9(seq(0x10a, i13  => (p2))))))|, v62);
					v115 := v115;
					var v116: seq<set<bool>> := [{p0}];
					var v117: map<set<bool>, bool> := map[v116[|v114|] + v110 := !f9[449]];
					v117 := v117[v110 := v113.f20];
					var v118: map<int, bool> := map[p2 := p0];
					v118 := v118 + (v118 + (map v119 : int | v119 in map[p2 := |v60|] :: (v119 / p2) := (p0)));
					var v120: seq<int> := [p2];
					var v121: map<bool, bool> := map[v113.f20 := v113.f20];
					globalState.f5 := (v120[|v121|] * f6) * p2;
				} else {
					var v122: multiset<int> := multiset{p2, p2};
					f12[45] := (if (|(seq(0x3e6, i14  => (f6)))| in v122) then v122[|(seq(0x3e6, i14  => (f6)))|] else p2) - p2;
					f12[45] := f6;
					var v123 := new C6(f6, if (f9[449]) then f9[449] else f9[449]);
					var v124: array<D6> := new D6[26];
					var v125 := DC38(v124);
					v124 := v125.cf72;
					var v126 := DC39(f10);
					var v127 := new C3(v60, v111, v126.cf73 + f10, |(if (v123.f13 in f10) then f10[v123.f13] else seq(0x286, i15  => (v62)))|);
					var v128 := new C5(f12[45], v123.f13);
				}
			...
			case DC27(cf51) =>
				...
				var v134: map<int, bool> := map[p2 := if (f9[449]) then !f9[449] else p0];
				v134 := v134[v132.f15 := f9[449]];
				f11[990] := v132.f15;
				...
				f11[990], globalState.f2, v135, globalState.f5, v136 := -v132.f15, if (p0) then v131 else v131[fm14(globalState) := v62], if (v138 >= multiset(v139)) then v135 else v135, v132.f15, v136;
		}
		
		r0 := seq(0x30c, i17  => ("qvp"));
		var v140: set<bool> := {f9[449], f9[449]};
		var v141: multiset<int> := multiset{0x3d0, |v140|};
		var v142 := DC31(f6, f6);
		var v143: map<multiset<int>, bool> := map[v141 := p1[v142.cf58]];
		var v144 := DC16(v140);
		var v145 := DC33(|v143|, p0, f6, f9[449], v144.cf35);
		r1 := v145.cf63;
	}
	method m7(p0: multiset<int>, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: array<bool>, r3: int) {
		globalState.f5 := f6;
...
class C8 {
	...
	function fm11(globalState: GlobalState): int {
		(|[DC4(DC0([!true, false], |"skr"|), 887, "lqerk", false, 0x2e3)]| - -0x122) / |("ctlfngak" + "snnrnqplc")|
	}
	method m4(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: map<D2, bool>, r1: map<bool, bool>, r2: int) {
		...
		if (v3 !! v3) {
			...
			globalState.f0, v5, globalState.f0, globalState.f0 := v6 !! (set v7 : int | (-0x1ec <= v7) && (v7 < 0x2a7) :: (v7 - |[v5.cf2, p1]|)), DC1(p3, p2, v5.cf4), 'k' in v10[p2], p0;
			var v11: array<int> := new int[26];
			v11[2] := p2;
			v11[2] := p2 * 0xf0;
			v4 := (DC1(p1, v11[2], v4).(cf2 := p3)).cf4;
			globalState.f5 := v11[2];
			v11[2] := fm11(globalState);
		} else {
		...
		match (fm12(p2, !(v16 in v17), !!!p0, globalState)) {
			case DC6(cf13, cf14) =>
				...
				if (v26 >= {p1, !p3}) {
					...
					v27 := v27[cf13 := v16];
					var v28: array<seq<int>> := new seq<int>[7](i2 => v2 + (seq(-0x26e, i3  => (p2))));
			...
			case DC7(cf15, cf16, cf17, cf18) =>
				if (p0) {
					...
					v1[479] := if (|v35| in v34) then v34[|v35|] else !p1;
					var v36: seq<multiset<seq<int>>> := [fm51(globalState)];
					var v37: set<int> := {|v0|};
					v3, globalState.f5, v1[479] := v36[p2], cf18, (v37 - {cf17}) >= v37;
					var v38 := new C5(|cf15|, cf18);
					v1[479] := p0;
					var v39: map<int, char> := map[|(if (p0) then v2 else [cf18])| := fm0(v38.f15, {cf17}, v1[479], globalState)];
					v39 := v39[if (p1) then v38.f15 else v38.f15 := v16];
					var v40 := new C5(cf18, -fm11(globalState));
				} else {
					v1[87] := p1;
					v1[701] := p0;
					globalState.f0, v1[87], globalState.f0, v1[701] := p0 && p1, p1, !p1, p1;
					var v41: multiset<bool> := multiset{p3, v1[87], p3};
					var v42 := new C5(fm11(globalState), --(|v41| + -241));
					var v43: array<bool> := new bool[28] [p0, !!p0, p1, v1[87], fm3(globalState), v1[87], -0x3d9 <= cf17, p3, !true, p0, p0, p3, true, p3, p0, !p0, true, p3 ==> p3, v1[87], v1[87], v1[87], p3, p3, p1 <== p0, v1[87], true, cf15 != cf15, fm3(globalState)];
					var v44: array<int> := new int[27](i4 => i4 * p2);
					v1[87], globalState.f0, v43, v44 := !p3, v1[87], v43, v44;
					...
					var v49 := DC17(v2, p3);
					var v50: array<D14> := new D14[29] [v48, DC37(if (p1 in v0) then v0[p1] else v1[87], v17), DC37(fm3(globalState), "im"), v48, v48, v48, v48, v48, v48, v48, v48, v48, if (true) then DC37(p3, v17) else v48, v48.(cf70 := p0), DC37(v1[87], v17), v48, DC37(p3, v17), v48, v48, v48, v48, v48, v48.(cf70 := v1[87]), v48, v48, v48, if (v49.cf37) then v48 else v48, v48, fm52(p1, globalState).(cf71 := v17)];
					v50[388] := DC37(p0, v17);
					v16, v45[302], cf16, globalState.f0, v50[388] := v16, v2[fm11(globalState) % cf18 := cf18], cf16, p0, v48;
				...
				match (v15) {
					case DC6(cf13, cf14) =>
						...
						globalState.f2, globalState.f0 := seq(61, i6  => (v16)), fm53(v16, globalState) !! v54;
						globalState.f5 := cf17;
						globalState.f0 := p0;
					...
					case DC8(cf19, cf20) =>
						...
						var v75 := DC34(v74);
						cf18, v73[201], globalState.f5, v74 := -(cf18 - cf17), p2, p2, (v74 * v75.cf67) * (v74 - v74);
						var v76: set<set<int>> := {v70, v70};
						var v77: map<int, int> := map[if (cf19) then cf17 else cf18 := -(|v76| / -v73[201])];
						var v78: map<array<bool>, bool> := map[v1 := p1];
						var v79 := DC37(cf20, v17);
						var v80 := DC1(true, cf18, fm0(v73[201], v70, cf19, globalState));
						v77, v78, v79 := v77 + map[|cf15| := (v80.(cf4 := v16, cf2 := p3)).cf3], if (cf20) then v78 else v78, v79;
						var v82: C3 := new C3(v77, v1, map v81 : int | v81 in v66 :: (v81 * cf18) := (seq(0x205, i7  => (v16))), cf18);
						var v83: seq<C3> := [v82];
						var v84 := DC40(v82);
						var v85: array<C3> := new C3[20] [v82, v82, v82, if (p0) then v82 else v82, v82, v82, v82, v82, v83[cf18], v82, v82, v82, v82, v82, v82, v82, v82, v84.cf74, v82, v82];
						v85[155] := v82;
						var v86: map<int, C3> := map[cf17 := v82];
						v85[155] := if (--(v73[201] + v73[201]) in v86) then v86[--(v73[201] + v73[201])] else v82;
					case DC5(cf12) =>
						var v87: array<int> := new int[24];
						var v88: multiset<array<int>> := multiset{v87};
						var v89: map<bool, seq<int>> := map[p0 := seq(0x193, i8  => (cf18))];
						var v90: multiset<bool> := multiset{p1};
						var v91: map<int, string> := map[0x11c := v17[850 := v16] + (seq(0x18c, i9  => (v16)))];
						globalState.f0, globalState.f0, globalState.f0, v17 := v88 !! v88, cf17 != cf17, cf18 <= (|(if (p0 in v89) then v89[p0] else v2)| / |v90|), if (cf18 in v91) then v91[cf18] else v17;
						v1 := v1;
						v16 := v16;
						v87[912] := cf17;
						var v92: seq<array<int>> := [v87];
						var v93 := DC15(p1, p0, v17[cf17 := v16]);
						var v94: map<D4, array<int>> := map[v93 := v87];
						var v95: map<int, array<int>> := map[p2 := if (v93 in v94) then v94[v93] else v87];
						var v96 := DC6(p2, v87);
						var v97: array<array<int>> := new array<int>[28] [v87, v92[|v95|], v87, v87, v87, v87, v87, v87, if (p1) then v87 else v87, v87, if (p0) then v87 else v92[cf17], v87, v87, v87, v87, v96.cf14, v87, v87, v87, v87, if (p3) then v87 else v87, v87, v87, v87, v87, v87, v87, v87];
						v97[26] := v87;
						var v98: set<char> := {v17[cf18], v16, v16};
						var v99: map<int, seq<int>> := map[fm2(cf18, globalState) := v2];
						v87[912], v97[26], v98, globalState.f5 := cf17, v87, v98 * {v16, 'y'}, -|(if (|cf15| in v99) then v99[|cf15|] else seq(0x344, i10  => (p2)))|;
				}
			...
			case DC8(cf19, cf20) =>
				...
				match (v103) {
					case DC29(cf53, cf54, cf55, cf56) =>
						var v104: map<int, string> := map[cf53 := seq(0x3be, i11  => (v16))];
						...
						v17 := (v17 + v17) + v17;
						cf54[923] := "btcbtiuf" + v17;
						cf53, cf54[923] := p2, v17 + v17;
				...
				v2, v117[517] := v118[|(seq(291, i12  => (v17)))|], v119[if (974 in v121) then v121[974] else p2];
				globalState.f5 := p2 % -255;
			...
			case DC5(cf12) =>
				...
				var v126: map<map<bool, int>, int> := map[v125 := v124[332] % p2];
				v124[332] := if (v125 in v126) then v126[v125] else v124[332] / v124[332];
				var v127 := DC13([|v17|, v124[332], |fm17(-p2, p2, globalState)|, -v124[332], p2], false, |v2|);
				v127 := v127;
				var v128: array<string> := new string[2] [v17[-v124[332] := v16], v17];
				...
				var v133: map<int, map<bool, D10>> := map[v124[332] := v130];
				var v134: map<int, bool> := map[p2 := true];
				r2, v124, v130, v1[299], v131 := 0x146, v124, (if (p3) then (v132[v124[332]])[p0 := v129] else v130) + (if (p2 in v133) then v133[p2] else map[p0 := v129]), DC8(if (-0x11c in v134) then v134[-0x11c] else p1, p3).cf19, map[v16 := p0];
		}
		...
		r0 := (v141 + v141) + (if (false) then v141 else v142[p2]);
		r1 := v0;
		r2 := v2[p2];
	}
...
class C9 extends T0 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		[multiset{'c', 'v', 'w'}] + ([multiset{'q', 'e'}] + [multiset(seq(26, i0  => ('g'))), multiset{'u', 'a'}, multiset(['r', 'a']), DC3(multiset{'v', 'w'}).cf6, multiset{'p'}])
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map[f6 := [f6]]
	}
	method m3(p0: bool, p1: array<int>, p2: bool, globalState: GlobalState) returns (r0: bool) {
		...
		match (v6) {
			case DC0(cf0, cf1) =>
				...
				globalState.f0 := false;
				if (p0) {
					var v10: seq<string> := [v1, seq(-641, i1  => (v7)), v1[cf1 := v7]];
					v1 := (seq(885, i0  => (v7))) + v10[|(map v11 : int | v11 in (map v12 : int | (381 <= v12) && (v12 < -0x333) :: (v12 - f6) := (|multiset{!p0, p2}|)) :: (v11 - cf1) := (cf1))|];
					globalState.f0 := p2;
					...
					p1[540] := f6;
					p1[540] := fm2(fm2(cf1, globalState), globalState);
				} else {
			...
			case DC1(cf2, cf3, cf4) =>
				...
				v26 := v26[v25 := p0];
				cf3 := if (p0) then |[p2, p2]| % cf3 else cf3;
			case DC2(cf5) =>
				globalState.f5 := f6;
				globalState.f5 := f6;
				var v27: map<int, int> := map[f6 := f6];
				var v31: array<map<int, int>> := new map<int, int>[16] [v27, v27[f6 := -0x1fe], v27, v27, v27 + v27, v27, if (p2) then v27 else v27, map v28 : int | (-1 <= v28) && (v28 < 0x1ca) :: (v28 % 0x4c) := (f6), map v29 : int | (0x34 <= v29) && (v29 < 438) :: (v29 + f6) := (f6), fm9(globalState), v27 + v27[|v5| := f6], map v30 : int | v30 in v4 :: (v30 + |(v0[841][f6 := |[p2, p2]|])[|map[f6 := p0]| := f6]|) := (f6), v27, DC5(v27).cf12, v27, v27 + v27];
				v31 := if (p2 || !p2) then v31 else v31;
				globalState.f5, r0, v1, globalState.f5 := v4[-f6], p2, v1, f6;
		}
		...
		match (if (p0) then v33 else v33) {
			...
			case DC1(cf2, cf3, cf4) =>
				...
				cf3 := if (v5[f6]) then f6 - 0xa9 else f6;
			...
			case DC2(cf5) =>
				...
				var v46: map<int, int> := map[f6 := |v1[f6 := v32]|];
				v46 := v46[f6 := f6];
		...
		if ((|v56[f6]| % f6) == f6) {
			...
			match (v62) {
				case DC22() =>
					p1[11] := v57.f13 - f6;
					p1[11] := f6;
					globalState.f0, globalState.f5, globalState.f2, globalState.f5 := p2, -v4[p1[11]], v1, f6;
					var v63 := new C1(f6);
					globalState.f0 := p0;
				case DC21(cf43) =>
			...
			var v72: array<map<int, map<bool, bool>>> := new map<int, map<bool, bool>>[29] [v68, v68, v68 + v68, v68, v68, v68, v68[|v69| := v52], v68, v68, v68 + v68, v68, v68, map v70 : int | (0x25c <= v70) && (v70 < -0x150) :: (v70 + f6) := (v52), v68, v68[|v5| := v52], v68, v68, v68 + v68, v68 + v71[|v0[841]|], v68 + v68, v68, v68, v68, map[0x356 := map[p0 := p2]], v68, v68, v68, map[f6 := v51[|v1|]], v68];
			v72[896] := map[f6 := map[p0 := p0]];
			var v73 := DC14(false, v52, f6, v52);
			v72[896] := map[f6 := v73.cf29] + v68;
			globalState.f5 := f6;
			if (p0 || p0) {
				...
				var v76: map<bool, string> := map[f6 !in fm26(f6, v32, v5[f6], v32, globalState) := v1];
				v76 := v76[p0 := v1];
				var v77: seq<multiset<bool>> := [v54, v54, v54, multiset(v5), v54[p2 := -f6]];
				var v78: set<seq<int>> := {v4, v4};
				var v79: map<set<seq<int>>, seq<multiset<bool>>> := map[v78 := v77];
				v77 := ([(multiset{p0})[p0 := 0x2ab]] + v77) + (if (v78 in v79) then v79[v78] else v77);
			} else {
				...
				globalState.f0, globalState.f0, globalState.f5, globalState.f0, v83 := p2, (-0x350 % f6) >= f6, f6 + f6, (v84 + v84) <= v84, v83;
				v82 := v82[f6 := f6 < f6];
				globalState.f0 := p2;
				p1[274] := f6;
				var v85: seq<D0> := [v33];
			...
			var v88: map<seq<seq<bool>>, bool> := map[v87[f6] := p0];
...
class C10 extends T0 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		([multiset(['o'])] + (seq(0x303, i0  => (multiset(DC4(DC0([true, !true], 0x31c), f6, "lxfutcy", false, f6).cf9))))) + (if (false) then [multiset{'y', 'l'}] else [multiset{'c'}, multiset(['p'])])
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
		map[f6 := [471, |[false, false, false, false, false]|]] + (map v0 : int | (858 <= v0) && (v0 < 166) :: (v0 % f6) := ([f6, f6]))
	}
	method m1(p0: string, globalState: GlobalState) returns (r0: bool) {
		...
		var v3 := DC0(v2, f6);
		var v4: seq<int> := [f6 * v0[v3.cf1]];
		globalState.f5 := v0[f6];
			...
			decreases 100 - i1
		{
			...
			var v17: array<int> := new int[28] [-0xfe, f6, if (|multiset([f6, 0x3b9, 0x48])| in v10) then v10[|multiset([f6, 0x3b9, 0x48])|] else f6, f6, v7.f13, v7.f13, --((if (v4[v7.f13] in v10) then v10[v4[v7.f13]] else -|v2|) + |v14|), f6, f6, if (v7.f14) then f6 else -f6, f6, v7.f13, v7.f13, v7.f13, |(v0 + v15[|v16|])|, 0xaf, 0x1fd / |(seq(0x160, i2  => ('w')))|, f6 / |"yl"|, f6, --f6, |p0|, v7.f13 + |fm19(v7.f13, globalState)|, v7.f13, v7.f13 / -|[v7.f13]|, v7.f13, 0x76, -(-|p0| / |DC17(v4, v1).cf36|), -f6 % v7.f13];
			var v18 := DC8(v1, false);
			var v19 := 'f';
			v17[736] := v7.fm16(v18, DC1(v1, f6, v19), globalState);
			v17[736] := (f6 % -0x1e) / v7.f13;
			var v20: map<string, bool> := map[p0 := !!v1];
			var v21: seq<string> := [p0];
			var v22: C8 := new C8();
			var v23: seq<C8> := [v22];
			v20 := v20[v21[|v23|] + p0 := v7.f14];
			var v24 := DC25(0x2fd, if (v7.f14) then v7.f13 else f6, v17[736], v19);
			var v25: multiset<multiset<int>> := multiset{v10};
			var v26: seq<seq<bool>> := [fm4(f6, v17[736], v7.f13, globalState)];
			var v27: seq<multiset<int>> := [multiset(v0[v17[736] := v17[736]]), v10];
			globalState.f0, v5, v24, globalState.f0, v25 := v2[f6] && v2[v24.cf48], v5, v24, [v2] < v26, (v25 - multiset(v27)) + v25;
		}
		var v28 := 'q';
		v28 := v28;
			...
			case DC38(cf72) =>
				...
				match (v34) {
					case DC4(cf7, cf8, cf9, cf10, cf11) =>
						...
						var v38: seq<multiset<int>> := [v35, v35, v35, v35, v36[|v37|]];
						var v39: array<int> := new int[15] [fm2(cf11, globalState), -0x189, cf11, -0x3dd, f6 + 0x3e7, cf8 % cf11, -((if (|cf9| in v29) then v29[|cf9|] else |v35|) * |v36|), |p0| * cf11, |map[cf8 := v2[cf11]]|, f6, if (f6 in v35) then v35[f6] else cf11, cf8 - -cf11, 664, |v37|, cf8];
						v39[356] := cf8;
						var v40 := DC6(cf11, v39);
						var v41: multiset<array<int>> := multiset{v40.cf14};
						v39[356] := |(v41 + multiset{v39, v39})|;
						globalState.f0 := cf10;
				...
				var v56: array<int> := new int[17] [f6, f6 + -f6, f6, f6, f6 + f6, f6, f6, |v51|, v50.f6, v50.f6 - fm2(f6, globalState), f6, v50.f6 - v50.f6, v50.f6 - f6, f6, f6, v50.f6, |((v54[v53 := |v55|])[v53 := f6] * v54)|];
				v56[866] := v50.f6;
				v56[866] := fm2(v50.f6, globalState);
				if (fm3(globalState)) {
					var v57: seq<T2> := [v50];
					var v58: map<seq<bool>, int> := map[v2[|v55| := false] := |v57|];
					v58 := v58[v2 := v56[866] - 0x324];
					var v59 := m2(globalState);
					var v60: multiset<seq<int>> := multiset{[f6], v4};
					var v61: map<int, multiset<seq<int>>> := map[v56[866] := v60];
					v0 := [v50.f6 + |(set v62 : seq<int> | v62 in (if (v50.f6 in v61) then v61[v50.f6] else v60) :: (v62))|];
					var v63: array<D11> := new D11[18];
					v63, v59, v5[467], v56[866], v56 := v63, !fm3(globalState), v1, v50.f6 / |p0|, v56;
					globalState.f5 := -((v50.f6 * v50.f6) * v0[v56[866]]);
				} else {
					v56[866] := f6;
					var v64: C9 := new C9(v50.f6 + v56[866]);
					v1, v64, v56[866], globalState.f5 := v2[|[v50.f6, -v50.f6]|], v64, -(v50.f6 % v50.f6), -f6;
					var v65: map<int, bool> := map[v50.f6 := v5[467]];
					globalState.f2 := p0[|v65| := v28];
	...
	method m2(globalState: GlobalState) returns (r0: bool) {
		...
		r0, globalState.f5, v1[145], globalState.f0, v1 := v11.cf80, v10.f17, v0, v0, v1;
		if (false) {
			...
			var v17: set<char> := {if (false) then v12 else v4[|v13|], v12, fm0(if (v14.cf78 in v6) then v6[v14.cf78] else |v15|, set v16 : int | v16 in v15 :: (v16 * 0x2), v1[145], globalState), v12};
			var v18: array<int> := new int[5];
			var v19: map<array<int>, set<char>> := map[v18 := v17];
			var v20: seq<seq<bool>> := [v2, v2, v2, v2];
			var v21 := DC25(|v20[|"q"|]|, v10.f18, v10.f18, v4[v10.f18]);
			var v22: seq<D9> := [DC25(|"qqakq"|, v10.f18, |fm9(globalState)|, v12), v21];
			v17 := if (v18 in v19) then v19[v18] else fm54(v1[145], fm0(v10.f17, v13, v1[145], globalState), v22, globalState);
			v12 := v12;
			...
			var v27 := DC45(v25);
			v23[875] := new T0[20] [v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, if (v10.f17 in v26) then v26[v10.f17] else v25, v25, v25, v25, v25, v27.cf83, v25, v25, v25, DC45(v25).cf83];
			var v28: map<bool, int> := map[v0 := v10.f17];
			var v29: map<bool, int> := map[!v1[145] := |(v28 + v28)|];
			v28 := v28[v4 < "ywxdsc" := |(v15 + v15)|];
		} else {
			var v30 := DC0([v0, false, v1[145], v1[145]], v10.f18);
			var v31: array<int> := new int[19](i0 => i0 / f6);
			var v32: multiset<array<int>> := multiset{v31, v31};
			var v33: map<bool, array<int>> := map[!v1[145] := v31];
			var v34: map<D0, multiset<array<int>>> := map[v30 := v32[if (v1[145] in v33) then v33[v1[145]] else v31 := f6]];
			v34 := v34[v30 := v32 - v32];
			var v35: seq<int> := [v10.f17, v10.f18, -0x183, v10.f18];
			var v36: map<seq<int>, seq<D4>> := map[v35[-0x14e := v10.f18] := [fm55(globalState)]];
			v36 := v36;
			globalState.f0 := (v35 + (seq(0xf9, i1  => (v10.f17)))) <= v35;
			var v37: map<bool, int> := map[v0 := 0x314];
			var v38: seq<map<bool, int>> := [v37];
			globalState.f5 := |(v38[|v35|] + v37)| * (-v10.f17 + v10.f18);
		...
		var v43 := 't';
		v42[893] := v43;
		var v44 := DC37(v1[145], v4);
		v42[893] := match v44 {
			case DC37(cf70, cf71) => DC25(v10.f17, |{|map[v0 := |[v10.f17]|]|, v10.f18}|, -684, v43).cf49
			case DC36(cf69) => if (v1[145]) then DC1(v1[145], f6, v43).cf4 else v43
		};
		var v45: seq<int> := [0x2bd];
		globalState.f5, globalState.f5, globalState.f5 := v45[v10.f18], v45[(fm56(v4, v0, v4, globalState)).cf59 - f6], v10.f17;
		var v46: map<bool, bool> := map[false := v0];
		var v47: set<map<bool, bool>> := {v46, v46[v1[145] := true], v46};
		globalState.f5 := |v47|;
		r0 := v1[145];
	}
}
...
class C11 extends T0 {
	...
	function fm5(p0: string, globalState: GlobalState): seq<multiset<char>> {
		match if (f8) then DC2(DC1(f8, f6, 'l')) else DC2(DC0([f8], f6)) {
			...
			case DC2(cf5) => (seq(0x21a, i0  => (multiset(['f'])))) + [multiset{'g'}, DC3(multiset{'j'}).cf6, multiset{'k'}]
		}
	}
	function fm6(p0: int, globalState: GlobalState): map<int, seq<int>> {
	...
	method m0(p0: char, p1: bool, p2: array<bool>, p3: seq<map<bool, char>>, globalState: GlobalState) returns (r0: string) {
		...
		var v12: array<bool> := new bool[20] [f8 <== p1, f8, 0x16d >= f6, f8, true, v0 == v0, -|v1| == -f6, p1 !in v2, p1, false, !(|v3[v4.cf3 := p0]| <= f6), p1, v9 <= v9, p1, v11 < v11, v2[f6], v8.f6 < 0x2ea, !f8, p1, |v3| >= v8.f6];
		v12 := v12;
		...
		for i0 := if (v13 in v14) then v14[v13] else v13.f17 to -(if (p1) then |v1| else v8.f6) {
			...
			if (f8) {
				...
				v17[854] := 0x123 * v13.f17;
				v17[854], globalState.f0, v3, globalState.f0 := |(v3 + (seq(0x2ee, i2  => ('y'))))[v8.f6 := p0]|, f8, v3, p1;
				var v18 := DC37(f8, v3);
				globalState.f0 := v18.cf70;
				globalState.f5 := v0[v13.f18];
				...
				v24[590] := |v2| * v13.f17;
				globalState.f5, v24[590] := v13.f18, v13.f17;
				v5, v15, globalState.f0, globalState.f5, v12 := v5[v8.f6 := fm2(v8.f6, globalState)] - v5, v15 + v15, !(v8.f6 >= (v13.f18 % 0x2eb)), v8.f6, v12;
			...
			var v32: C5 := new C5(v13.f18, f6 % v8.f6);
			var v33: map<int, char> := map[f6 := 'n'];
			globalState.f5, globalState.f5, globalState.f5, v32 := v13.f17, |(if (f8) then map[|(v3[v32.f15 := p0])[v8.f6 := p0]| := p0] else v33)|, v13.f18, v32;
			globalState.f0 := p1;
		}
		...
		match (v37.(cf68 := map[v36 := fm3(globalState)])) {
			case DC35(cf68) =>
				...
				v40[455] := v39;
				v40[455], f8 := v39, (0x3d1 % v8.f6) < v13.f18;
				f8 := true;
...
method Main() {
	...
	var globalState := new GlobalState(true, seq(0xd7, i0  => ('p')), v1, true, v4, 0x247);
	var v5 := false;
	var v6 := DC1(v5, v2 % v2, fm0(v2, fm1(globalState), v5, globalState));
	match (v6) {
		case DC0(cf0, cf1) =>
			...
			var v11 := DC0(fm4(v2, |v10|, v8[504], globalState), cf1);
			var v12 := DC2(v11);
			var v13 := DC2(v11);
			match (if (fm3(globalState)) then v9 else v9.(cf5 := v11)) {
				case DC0(cf0, cf1) =>
					...
					var v18: map<bool, int> := map[if (cf1 in v17) then v17[cf1] else !v5 := v8[504]];
				...
				case DC1(cf2, cf3, cf4) =>
					...
					v28 := map[v8[504] := !cf2] + map[cf1 := cf2];
					var v29 := DC19(v2, v8[504], 0x79);
					v8[504] := fm2((v29.(cf41 := v8[504])).cf41, globalState);
				...
				case DC2(cf5) =>
					...
					v34[866] := if (v5 in v35) then v35[v5] else v5;
					var v36 := new C9(v8[504]);
					var v37: multiset<bool> := multiset{v34[866]};
					var v38: map<bool, int> := map[v5 := -|v37|];
					v2 := v2 * (v2 % (if (true in v38) then v38[true] else 0x35a));
					...
					v40[369], v37, globalState.f0, globalState.f5 := v39, multiset([false] + (cf0[|v37| := v34[866]] + fm4(v8[504], v2, |v42|, globalState))), (v43 + fm46(globalState)) == v43, v8[504] + (|v1| + v2);
			}
		...
		decreases 100 - i3
	{
		...
		v73 := v73;
		var v74, v75 := v61.m6(-v61.f6 <= v61.f6, v56 + v56, v2 / -v61.f6, globalState);
		var v76: multiset<bool> := multiset{v57 >= v57, true, v5, (seq(0x137, i4  => ('r'))) < v1, v72};
		v76 := v76 * v76;
		v3 := fm40(|multiset(v56)| / v61.f6, v58, globalState);
	}
	v5 := fm3(globalState);
	for i5 := v2 to v61.f6 % |v57| {
		var v77, v78 := v61.m6(v72, [v70] + v56, 0x1e1, globalState);
		if (!v70) {
			var v79: map<bool, bool> := map[false := v78];
			var v80: set<map<bool, bool>> := {v79};
			var v81: array<string> := new seq<char>[8] [seq(0xaf, i6  => (v0)), "kosnitju", fm17(v61.f6, |v1|, globalState), v1, v1, v1, v1, v1];
			var v82 := DC29(v61.f6, v81, v78, i5);
			v65, v80, globalState.f0 := v65, v80, if (v70 in v79) then v79[v70] else v82.cf55;
			var v83 := DC23(v61.f9);
			var v84 := new C7(v65, v65, v61.f6 / |v69[v61.f6]|, v83.cf44, map[v2 := v1]);
			var v85: C1 := new C1(684 - -|v1|);
			v85 := v85;
			var v86 := DC31(v61.f6, -v61.f6);
			v86 := fm56(seq(-0x1cb, i7  => (v0)), v5, v1, globalState);
			var v87: T0 := new C1(|v3[v61.f6 := i5]|);
			var v88: seq<T0> := [v87, v87, v87, v87];
			var v89: array<T0> := new T0[22] [v87, v87, v87, v87, v87, v87, v87, v87, v87, v87, v87, v87, v87, v87, v88[fm2(v87.f6, globalState)], v87, v87, v87, v87, v87, v87, v87];
			v89[295] := v87;
			...
			v89[295], v72, v56, v0, v91 := v87, (|v92| + fm2(v61.f6, globalState)) <= v61.f6, v56, v1[v2], v91;
		} else {
			v61.f9 := v61.f9;
			var v93 := DC13(v3, !v70, v61.f6);
			var v94 := DC37(v5, seq(743, i9  => ('o')));
			v93 := DC13(if (v70) then seq(569, i8  => (|multiset{v70}|)) else v3, v94.cf70, -v61.f6 * v61.f6);
		...
		v100[818] := v101;
		v65[570] := i5;
		var v102: map<char, bool> := map[v99[630] := v5];
		v65[970], v2, v100[818], v65[570], v2 := fm2(|((seq(0x65, i11  => (v0))) + "r")|, globalState), fm2(i5, globalState), v101, |v102| / v2, i5;
	}
	v65[157] := v2 / |{v72}|;
	v65[157] := v61.f6;
	...
	v61.f9[541] := v72 ==> v72;
	v72, v61.f9[541] := v65[157] > 0x135, v5;
		...
		decreases 100 - i13
	{
		...
		v108[968] := v109;
		v108[968] := if (v70) then v109 else v109;
		v2 := -v61.f6;
		v70 := v5;
		if (v72) {
			var v110, v111, v112, v113 := v61.m7(v103, if (v72) then v65[157] else v65[157], globalState);
			var v114: seq<array<int>> := [v65, v65];
			v114 := v114;
			var v115: multiset<bool> := multiset{false, v56[v113]};
			var v116: map<bool, bool> := map[v5 := v109.f20];
			v107 := (|v115| * v111) - (|v1| + |v116|);
			var v117: map<D0, bool> := map[v6 := true];
			v117 := v117[v6 := v61.f9[541]];
			v104 := fm0(fm2(v61.f6, globalState), fm1(globalState) + v57, v1 == "eiyyqrevp", globalState);
		} else {
			v70 := v2 != fm2(-0x2fc, globalState);
			v107 := -v61.f6;
			v5, v61, globalState.f0, globalState.f5, v57 := v109.f20 || v72, v61, v65[157] <= (v2 - v3[v65[157]]), v107, v57;
			v65[157] := v2;
			v56 := v56;
		}
