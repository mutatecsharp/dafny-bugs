...
function fm13(p0: char, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<int, int>> {
	if (false) then map[|(seq(671, i0  => ('p')))| := map[0x111 := |multiset{!false, false}|]] + map[-33 := map v0 : int | (228 <= v0) && (v0 < 940) :: (v0 % 160) := (0x317)] else map[--0x309 := map[|map[false := false]| := -0x292]]
}
...
function fm19(p0: int, p1: bool, globalState: GlobalState): seq<int> {
	[|multiset{'f', 'q', 'y'}|] + ([-|{"kwrvsluv", "mtfd"}|, |multiset([|(set v0 : D0 | v0 in [DC2(DC0(seq(0x279, i0  => ('x'))))] :: (v0))|])|, |{false}|] + [|"yrcmuol"|])
}
...
function fm23(globalState: GlobalState): D1 {
	DC5(-(0xb6 - |(seq(357, i0  => ([true, !!false])))|), -0x2cb != |"lucmkk"|, -424, |((set v0 : int | (0x2a1 <= v0) && (v0 < 0xf5) :: (v0 - 937)) + {|multiset{|[|{map[false := false]}|]|, |(seq(0x149, i1  => ('l')))|}|})|)
}
...
function fm29(p0: int, p1: set<int>, globalState: GlobalState): seq<multiset<bool>> {
	((seq(171, i0  => (multiset{false, false, true}))) + [multiset{true}]) + [multiset{!false}, multiset([true, false]), multiset{true}, multiset{true}, multiset{true, false}]
}
...
function fm31(p0: int, globalState: GlobalState): D12 {
	if (!!true) then DC36(true, false, 125, 710, map[true := seq(674, i0  => (-0x1b6))]) else if (!true) then DC36(false, true, 0x302, |[0x3dc]|, map[false := [735, |"p"|, -0xe0]]) else DC36(false, !false, 0x3d1, |[false, false]|, map[true := [|[|[false]|, -67, |map[!!true := -|[true]|]|]|]])
}
function fm32(globalState: GlobalState): seq<D11> {
	([DC31(-0x2dc)] + (seq(0x2a9, i0  => (DC31(0x246))))) + [DC31(|multiset([DC1(-|{true, false}|, true, 0x14d).cf2, false])|), DC31(|{!true}|), DC31(|[true]|), DC31(|[multiset([|['l']|])]|)]
}
function fm33(p0: int, p1: bool, globalState: GlobalState): map<seq<D11>, seq<int>> {
	(map[seq(-70, i0  => (DC31(807))) := [-|"aguorpcjs"|]] + map[[DC31(|"habj"|)] := [-|"nv"|, 0xc8]]) + (map[[DC31(|"kdusdcx"|)] := [582]] + (map v0 : seq<D11> | v0 in map[[DC31(|"to"|)] := |"bffhds"|] :: (v0) := ([|map[true := -0x2b3]|])))
}
...
method m0(p0: array<bool>, p1: string, p2: int, globalState: GlobalState) returns (r0: D0, r1: map<int, bool>, r2: int) {
	...
	var v3: seq<int> := [p2];
	var v4 := DC20(true, v3[p2]);
	var v5 := new C5(|v2|, p2 % p2, v4.cf34);
	var v6: seq<string> := [p1];
	var v7 := 'x';
	var v8: C4 := new C4(v0, v5.f25);
	var v9: seq<C4> := [v8, v8];
	var v10: multiset<C4> := multiset{v9[v5.f25]};
	var v11: seq<bool> := [fm1(0x37f, v1, globalState)];
	var v12: set<int> := {p2};
	var v13: map<int, int> := map[v5.f25 := v5.f26];
	globalState.f7, r2, v1, globalState.f8 := |p1[DC21(v1, v1, -|v6[p2]|).cf37 := v7]| < (--|v10| % |v11|), v5.f25, v12 >= v12, -|v13| % p2;
	...
	r1 := match v26 {
		...
		case DC36(cf56, cf57, cf58, cf59, cf60) => (map v27 : int | v27 in [|(seq(0x34a, i2  => (v7)))|, |[-950]|] :: (v27 * v5.f26) := (v20.f32)) + (map v28 : int | (-214 <= v28) && (v28 < 460) :: (v28 / cf58) := (cf56))[|map[true := |p1|]| := cf57]
		case DC34(cf55) => map v29 : int | (0x3dd <= v29) && (v29 < 320) :: (v29 % v5.f25) := (v1)
...
class C1 extends T1, T0 {
	...
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		...
		globalState.f14, globalState.f7, r0, v3, p0[216] := fm0(f23, p0[216], globalState), f28, f23, v3, p1;
		var v5: map<array<bool>, int> := map[p0 := f23];
		for i0 := |[|(set v4 : int | v4 in (seq(0x3c5, i1  => (f23))) :: (v4 - 0x30f))|, f23, if (p0 in v5) then v5[p0] else f23]| to f23 {
			if (p1) {
				globalState.f14 := if (v0 <= v0) then i0 * f23 else i0;
				var v6: seq<seq<bool>> := [([p1, f28, p0[216], fm1(f23, f28, globalState), p1])[i0 := f28]];
				var v7: map<int, int> := map[i0 := f23];
				var v8 := DC4(v7, p0[216], f28);
				var v9: map<seq<seq<bool>>, bool> := map[v6 + v6[f23 := [p1, p0[216]]] := v8.cf8];
				v9 := v9[v6 := f28];
				var v10: map<bool, int> := map[p0[216] := -0x177];
				var v11: seq<bool> := [f28];
				globalState.f14, globalState.f9 := f23 + (if (fm1(|v11|, f28, globalState) in v10) then v10[fm1(|v11|, f28, globalState)] else |(seq(-960, i2  => ('v')))|), f23 > f23;
				...
				var v19, v20, v21 := m0(p0, fm2(globalState) + v0, f29[f23], globalState);
				var v22: array<char> := new char[25];
				v22 := new char[24];
				var v23: map<int, int> := map[|v0| := v21];
				var v24: set<int> := {|v23|, f23};
				p0[216], globalState.f7, globalState.f8 := p1, !(if (v24 > v24) then true else v0 != (seq(0xc4, i4  => (v2)))), 595;
			...
			p0[216], v28, globalState.f21 := p1, v28 + v28[i0 := v27], v27[f23 / i0];
			globalState.f8 := if (p0[216]) then 950 + f23 else i0;
			globalState.f21 := f28;
		}
		...
		if (v31[f23]) {
			...
			globalState.f14, f29, v32[532], globalState.f21, r0 := -f23, f29 + (seq(288, i5  => (0x2cb))), -f23, if (v33 in v34) then v34[v33] else fm1(f23, p1, globalState), if (f28 <== !!p0[216]) then |v31| else f23;
			globalState.f14 := v32[532];
			...
			var v41: set<int> := {|(set v40 : int | (0x310 <= v40) && (v40 < 0x1e0) :: (v40 / |map[f23 := multiset(f29)]|))|, v32[532]};
			r0 := fm0(|fm5(v41, globalState)|, p0[216], globalState) / (if (fm1(v32[532], p1, globalState)) then v32[532] else f23);
			if (p0[216]) {
				p0[216] := p0[216];
				var v42 := new C0();
				var v43: array<string> := new string[16];
				var v44: seq<seq<bool>> := [v29, v31, [p1]];
				globalState.f9, v43 := true !in (v44[v32[532]] + v29), v43;
				globalState.f9 := p1;
				var v45: set<char> := {v2, v2};
				var v46 := DC7(v45);
				var v47: map<D2, string> := map[v46 := v0];
				var v48: multiset<bool> := multiset{v42.fm20(v47, v32[532], |v0|, v32[532], globalState)};
				...
				v52 := v52[v32[532] := v32[532]];
				v41 := fm21(v35, globalState);
				var v53, v54, v55 := m0(p0, v0[f23 := v2] + v0, f23, globalState);
				v32[532] := f23;
				globalState.f9 := !((v32[532] != v55) <==> (v53.cf3 == v32[532]));
			}
			...
			v59[461] := f23;
			v59[461] := f23;
			var v60: set<bool> := {!f28, p0[216], false, p1};
			globalState.f9, p0[216], r0, globalState.f9, v59[461] := fm1(fm0(-|v60|, p1, globalState), f28, globalState), !f28, f23, p0[216], (v59[461] % |v0|) % (f23 / fm0(v59[461], p1, globalState));
			var v61 := DC12(v31);
			var v62 := DC10(true);
		...
		for i7 := f23 to f23 {
			var v63: array<bool> := new bool[1] [p0[216]];
			v63 := v63;
			globalState.f11 := v2;
			v30 := v30 + v30;
			p0[216], globalState.f7, globalState.f7 := fm1(f23, p0[216], globalState), f28, v29[i7];
		}
		r0 := f23;
	...
	method m2(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		...
		var v5: seq<map<int, multiset<int>>> := [v3[f23], v4[324 := v2], v4];
		var v6: map<int, int> := map[f23 := |v5[-f23]|];
		var v7 := 'n';
		...
		for i0 := -|[v9]| to f23 {
			...
			if (!fm1(i0, f28, globalState)) {
				...
				v12[536] := new char[23];
				r0 := f23;
				var v14: array<string> := new string[20](i1 => p0[i0 := v7]);
				v14[690] := p0[i0 := v7] + p0;
				var v15: seq<string> := [(p0[i0 := v7])[i0 := v7]];
				v14[363] := v15[i0] + p0;
				var v16: seq<multiset<bool>> := [v0];
				var v17: array<multiset<bool>> := new multiset<bool>[21] [v0, v0, multiset{f28, f28, f28, f28}, v0, v0, v0, (v0[f28 := f23])[f28 := f23] + multiset{f28, true}, v0, v0, v0, v0, v0 * v0, v0[f28 := -f23], v0 + multiset{f28}, v0, v0, v0, v0 - v0, v16[i0], v0, multiset([f28]) * v0];
				v17[314] := v0;
				var v18: set<bool> := {!f28 <== f28};
				v14[690], v14[363], v17[314], v18, globalState.f6 := "bshdxkt" + p0, (seq(0x80, i2  => (v7))) + "sgs", v0, v18, p0;
			} else {
				globalState.f21 := f28;
				v9[258] := i0;
				globalState.f6, v9[258] := "celkv", |[f28]|;
				var v19 := DC1(f23, f28, if (f23 in v2) then v2[f23] else |v2|);
				globalState.f9 := v19.cf2;
				globalState.f21 := f28;
				var v20: map<int, bool> := map[f23 := if (fm1(-v9[258], f28, globalState)) then f28 else f28];
				v20 := v20[f23 := f28];
			}
			
			var v21 := DC15(-165, v7, f29[|v2|] % f23);
			v21 := v21;
			...
			decreases 100 - i3
		{
			...
			var v24 := DC10(v23[f23]);
			var v25: set<bool> := {f28};
			var v26: map<int, bool> := map[0x149 := f28];
			var v27: map<bool, bool> := map[f28 := if (f23 in v26) then v26[f23] else f28];
			var v28: array<bool> := new bool[29] [f28, fm1(f23, f28, globalState), f28, if (f28) then f28 else f28, f28, f28, v24.cf21, f28, f28, f28, f28, f28, fm1(f23, f28, globalState) <== v23[f23], if (f28) then f28 else f28, v25 == {f28}, f28, f28, f28, f28, if (f28 in v27) then v27[f28] else f28, f23 !in f29[f23 := 0x80], !(-f23 < f23), f28, f28, (if (f28 in v1) then v1[f28] else f23) > -581, f28, v23[f23], !f28, f23 < f23];
			v28[547] := if (fm1(f23, f28, globalState)) then f28 else f28;
			var v29: multiset<array<int>> := multiset{v9, v9, v9};
			v28[547], r0, globalState.f21, globalState.f7, globalState.f21 := multiset{v9, v9} <= v29, f23, fm1(f23, f28, globalState), f28 ==> f28, fm1(f23, f28, globalState);
			var v30: map<seq<bool>, bool> := map[if (!true) then v23 else [f28] := f28];
			var v31: map<char, string> := map[v7 := p0];
			v30 := v30[v23 := v28[547] ==> v23[|v31|]];
			var v32 := new C0();
			var v33 := new C0();
		}
		r0 := (f23 - f23) + 0x2c8;
...
class C2 extends T1 {
	...
	function fm18(p0: map<bool, int>, p1: string, p2: bool, globalState: GlobalState): int {
		-|((if (f28) then multiset(seq(779, i0  => ('x'))) else multiset{'k', 'g'}) * (multiset{'s'} * multiset{'n'}))|
	}
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		var v0 := "rovoqj";
		var v1: map<string, bool> := map[v0 := true];
		var v2: map<string, map<string, bool>> := map[v0 + v0 := v1 + v1];
		v2 := v2[seq(-0x188, i0  => ('u')) := v1 + v1];
			...
			decreases 100 - i2
		{
			...
			var v7 := 'f';
			var v8: array<int> := new int[11] [f23, -(if (v0 in v4) then v4[v0] else f23), |{-334, |v6|}|, 118, v5.f23, f29[248], f23, f23, f23, f23, |[v7]|];
			var v9: seq<array<int>> := [v8, v8, v8, v8, v8];
			var v10: map<seq<array<int>>, int> := map[v9 := v5.f23];
			v10 := v10[([v8] + v9)[v5.f23 := v8] := f23];
			var v11: array<seq<C0>> := new seq<C0>[16];
			var v12: C0 := new C0();
			var v13: seq<C0> := [v12];
			v11[624] := v13;
			v11[624] := if (f28) then v13 else v13;
			...
			if (v14.cf8) {
				...
				globalState.f7, globalState.f8, globalState.f8 := !((v5.f23 % v5.f23) <= v5.f23), -f23, v5.f23;
				globalState.f7 := f32 <==> (v0 < v0[v5.f23 := v7]);
			} else {
				var v18: seq<string> := [v0, "tocc"];
				var v19: map<int, map<string, int>> := map[v5.f23 / v5.f23 := map v17 : string | v17 in v18[0x1da := v0] :: (v17) := (|multiset{f28}|)];
				...
				v0, globalState.f14 := (v0 + (seq(-846, i3  => (v7)))) + v0, f23;
			}
			...
			decreases 100 - i4
		{
			...
			var v30: array<int> := new int[26] [fm0(f23, f32, globalState), f23, |(if (v26[f23]) then v0 else seq(0xb, i5  => ('k')))|, f23, |"hpcxes"|, f23, |((seq(0x1e1, i6  => ('g'))) + v0)|, f23, f23, f23, f23 / f23, f23, if (p1) then f23 else 222, -f23, 583, f23, |v0| * |(multiset{p1})[p1 := f23]|, f23, f23, f23 * f23, |v25|, f23, if (|v28| in v27) then v27[|v28|] else f23, |v29|, f23, f23];
			v30 := v30;
			var v31: multiset<bool> := multiset{f32, false};
			var v32: seq<string> := ["thg", ("suocs")[|v31| := 'p'], seq(247, i7  => (DC15(f23, 'f', |v0|).cf27)), v0, v0];
			var v33: seq<seq<bool>> := [v26];
			var v34: map<string, seq<seq<bool>>> := map[v32[fm0(348, !f28, globalState)] := v33];
			v34 := v34[v0 := v33];
		...
		v38 := v38[fm0(|map[|v39| := multiset(v38)]|, !p1, globalState) := fm1(f23, f32, globalState)] + v38;
		r0 := f23;
	...
	method m2(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		...
		globalState.f7, v0, globalState.f9, v1 := "wcapto" == p0, v0, match v2 {
			...
			case DC0(cf0) => f28
			case DC2(cf4) => p0[f23 := DC8(f23, f23, 'o', |p0|, f28).cf17] != (p0[f23 := 'i'])[f23 := 'b']
		}, match v3 {
			case DC4(cf6, cf7, cf8) => [p0]
			case DC5(cf9, cf10, cf11, cf12) => DC17(v1).cf30 + [p0]
			case DC6(cf13) => [p0, seq(-0x2c, i0  => ('f')), p0, p0]
			case DC3(cf5) => v1
		};
		var v4 := DC6(v0);
		...
		for i1 := f23 - f23 to f23 {
			...
			if (i1 in (v6 - v6)) {
				...
				v8 := v8[i1 := |f31|];
				globalState.f8 := |(p0 + (p0 + p0))[i1 - |v5[v0 := f23]| := 'b']|;
				...
				var v13: array<int> := new int[24] [fm0(i1, f32, globalState), f23, i1, i1, i1, f23, |v10|, 362, i1, |v12[i1]|, |p0|, f23, |v9[true := i1]|, fm0(f23, f28, globalState), f23, 0x180, |p0|, i1, 501, |v9|, f23, |v10|, i1, i1];
				var v14 := new C1(f32, f29, if (!f28 in v9) then v9[!f28] else -|map[f32 := v13]|);
			} else {
				var v15: array<int> := new int[27](i2 => i2 % -f23);
				v15[445] := i1;
				v15[445] := f23;
			...
			var v18: map<bool, string> := map[f32 := seq(-469, i3  => ('d'))];
			var v19 := new C1(f32, f29, |(if (f32 in v18) then v18[f32] else p0)|);
			var v20: seq<bool> := [f28, true, f32, f32, fm1(|(seq(131, i4  => ('t')))|, f32, globalState)];
			...
			v23[72] := v3;
			v23[72] := if (f32 <== f32) then fm23(globalState) else v3;
		}
		globalState.f14 := f23;
		...
		r0 := f23;
		r1 := ((seq(-0x39a, i6  => (|p0|))) + (seq(454, i7  => (f23))))[f23 := f23];
	}
	method m6(p0: bool, globalState: GlobalState) returns (r0: bool, r1: map<int, array<bool>>, r2: D1, r3: array<bool>) {
		...
		v6[669] := 0x210;
		v6[669] := f23;
		for i0 := |f29| - f23 to v6[669] - v6[669] {
			globalState.f8 := v6[669];
			var v7 := 'w';
			var v8: map<bool, char> := map[p0 := v7];
			v6[669] := if (v8[f32 := v7] != v8) then if (p0 in v1) then v1[p0] else f23 else f23 * -0x33a;
			...
			decreases 100 - i1
		{
			...
			globalState.f14 := fm18(v14[f23], (seq(339, i2  => ('h'))) + v2, v12[779], globalState);
			v1 := v1[f32 := f23];
		}
		r0 := f28;
		var v15: map<int, array<bool>> := map[f23 * f23 := v12];
		r1 := v15;
		var v16 := DC4(f31, v12[779], v12[779]);
		r2 := v16;
		r3 := v12;
	}
}
...
class C3 extends T0, T1 {
	...
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		...
		if ((f23 / f23) < (f23 * f23)) {
			...
			p0[868] := if (p1 in v2) then v2[p1] else p1;
			p0[868] := f28;
			...
			v7, globalState.f14, v8, v13, globalState.f14 := v7, f23, fm13('q', fm1(f23, f28, globalState), if (fm1(f23, p1, globalState)) then f23 else f23, if (p1) then p0[868] else fm1(f23, p0[868], globalState), globalState), v13, 0x1d9;
		} else {
			globalState.f14 := f23;
			var v14: set<bool> := {p1};
			var v15 := 'h';
			...
			if (if (f28) then f28 else p1) {
				...
				var v24: map<int, multiset<bool>> := map[v19[726] := v23];
				v22 := fm15((DC10(p1).(cf21 := p1)).cf21, v24, globalState);
				var v25: seq<array<bool>> := [v0, v0];
				var v26: array<array<bool>> := new array<bool>[14] [v0, p0, p0, v0, if (f28) then p0 else v0, v0, v25[|multiset(f29)|], v0, if (p1) then p0 else v0, p0, p0, v0, p0, p0];
				v26[281] := p0;
				v26[281] := p0;
				v14 := v14;
				var v27: array<array<int>> := new array<int>[15];
				v27[602] := v19;
				var v28: map<int, bool> := map[v19[726] := p1];
				var v29: map<string, map<bool, int>> := map[v18 := if (p1) then map[v21[v19[726]] := |v23|] else map[if (|v18| in v28) then v28[|v18|] else f28 := v19[726]]];
				v16, v27[602], v19[726], globalState.f9, globalState.f14 := if (v18 in v29) then v29[v18] else v16, v19, fm12(v19[726], false, p1, globalState), f28, v19[726] - f23;
				globalState.f8 := v19[726];
			} else {
				...
				v31 := (v31[if (f23 in v17) then v17[f23] else f23 := f29])[|[p1]| := if (v19[726] in v32) then v32[v19[726]] else [v19[726]]] + (v31 + v31);
				m5(globalState);
				var v33 := DC14(v19);
				v19 := v33.cf25;
			}
			
			var v34: map<int, int> := map[DC1(v19[726], f28, v19[726]).cf1 := f23];
			var v35: seq<map<int, int>> := [fm16(f28, f23, f23, globalState)];
			v34 := v34[f23 := |(v35[v19[726]] + map[|v18| := f23])|];
		}
		...
		if (!("ii" == v36[f23 := v37])) {
			v0[956] := f28;
			v0[956] := !DC10(f28).cf21;
			var v38: array<multiset<bool>> := new multiset<bool>[14](i1 => multiset{v0[956]});
			v38 := v38;
			var v40 := DC4(map v39 : int | (0x39 <= v39) && (v39 < 0x3d8) :: (v39 + f23) := (f23), v0[956], p1);
			v0[956] := fm1(f23, false, globalState) <==> v40.cf7;
			globalState.f6 := v36 + "l";
			globalState.f8 := f29[f23];
		} else {
			v0[296] := p1;
			v0[296] := p1;
			var v41: array<int> := new int[11](i2 => i2 + f23);
			var v42: seq<bool> := [v0[296], p1];
			v41[509] := |v42|;
			v41[509] := fm12(f23, v0[296], v0[296], globalState);
			var v43: array<string> := new string[18](i3 => v36 + v36);
			v43[35] := v36;
			var v44: multiset<char> := multiset{v37};
			var v45: map<bool, int> := map[true := v41[509]];
			var v46: seq<string> := ["qkbs", "uxecrdjl"];
			var v47: set<bool> := {true, f28};
			var v48: multiset<set<bool>> := multiset{v47};
			var v49 := DC15(|v48|, v37, f23);
			v41[509], v41[509], v43[35], v41[509] := v41[509], fm0(f23, v44[v37 := |v45|] > fm17(f28, |v36|, globalState), globalState), v36 + v36, if ((seq(39, i4  => (v36))) < v46) then if (v0[296]) then v49.cf28 else fm12(f23, f28, fm1(f23, p1, globalState), globalState) else v41[509] - f23;
			m5(globalState);
			v0[296] := v41[509] == |v45|;
		}
		...
		for i5 := -f23 to 581 {
			...
			match (v56) {
				case DC4(cf6, cf7, cf8) =>
					...
					v59 := v59[f28 := v50[p1 := cf8] + v60[f23]];
				...
				case DC5(cf9, cf10, cf11, cf12) =>
					...
					var v65: T1 := new C2(v55, false, cf10, [0x3ca], f29[-f23]);
					var v66 := DC16(v65);
					v64[821] := v66.cf29;
					v64[821] := v65;
				...
				case DC3(cf5) =>
					...
					v52[936] := f23;
					v52[936] := fm12(f23, p1, f28, globalState);
		...
		if (--(|v74| - |v75|) == f23) {
			if (v75 > v75) {
				...
				var v76: array<int> := new int[21](i7 => i7 / f23);
				...
				v84, v82[127] := (map v85 : set<int> | v85 in v86 :: (v85) := (v83)) + v84, -|(v36 + "udxyoam")| % v82[127];
			}
			
			globalState.f21 := f23 == 805;
			var v87: seq<bool> := [p1];
			p0[347] := v87[f23 := f28] < [true, f28];
			p0[347] := p1;
			var v89: map<bool, map<char, int>> := map[true := map v88 : char | v88 in v36 :: (v88) := (f23)];
			var v90: set<bool> := {p0[347]};
			var v91: map<int, seq<int>> := map[fm0(|map[v37 := |v89|]|, true, globalState) := (f29[|v90| := f23])[f23 := 0x3af]];
			...
			v98[139] := v99;
			globalState.f14, v98[139], globalState.f9, globalState.f14 := -f29[f23], v99, !p1, f23;
	...
	method m2(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		var v0: array<int> := new int[26](i0 => i0 / f23);
		...
		v4 := v4[v5 := v3];
		v0[260] := f23;
		var v6: seq<string> := [seq(0x13d, i1  => ('m'))];
		var v7 := DC17(v6);
		v0[260] := match if (f28) then v7 else DC17(v6) {
			case DC17(cf30) => f23
		};
		var i2 := 0;
			...
			decreases 100 - i2
		{
			...
			globalState.f7, globalState.f8, globalState.f21 := !!v10.cf19, f23 + (0x2b4 + v0[260]), v8[f28 := v0[260]] != v8;
			globalState.f21 := false;
			globalState.f11 := v9;
			globalState.f8 := v0[260];
		}
		...
		if (false) {
			...
			var v16 := new C2(map v13 : int | v13 in v15[f23] :: (v13 - f23) := (f23), f28, f28, f29, v0[260]);
			var v17: multiset<bool> := multiset{v16.f32, v16.f32, f28};
			globalState.f6 := v6[|v17|];
			...
			var v23: multiset<int> := multiset{39, v0[260]};
			v19[409] := (|v22| - v0[260]) != (if (f23 in v23) then v23[f23] else |v5|);
		} else {
			var v24: map<int, int> := map[-|v6| := 0x3f];
			var v25: T1 := new C2(v24, f28, f28, f29, v0[260]);
			var v26 := DC16(v25);
			match (v26) {
				case DC16(cf29) =>
					var v27: multiset<int> := multiset{v25.f23, cf29.f23, -|v5|};
					var v28: multiset<multiset<int>> := multiset{v27, multiset(f29), v27 + v27, v27[v0[260] := v25.f23], v27};
					var v29: multiset<array<char>> := multiset{v11, v11, v11};
					r0, v28 := -f23 % (f23 + |p0|), multiset{(multiset{v25.f23, |v29|, v25.f23, v0[260], |p0|})[v25.f23 := cf29.f23], v27, v27 * v27, v27};
					...
					var v31 := DC11(v0[260]);
					var v32: map<seq<D3>, int> := map[[v31.(cf22 := v25.f23)] + (seq(0x1ea, i6  => (v31))) := -0xad];
					var v33: seq<D3> := [DC11(cf29.f23), v31];
					v32 := v32[if (cf29.f28) then v33 else v33 := v0[260]];
					var v34: multiset<array<int>> := multiset{v0, v0, v0};
					globalState.f7 := v34 > (multiset{v0})[v1[cf29.f23] := v25.f23];
			}
			...
			if (!fm1(v25.f23, v25.f28, globalState)) {
				...
				v25 := v25;
				var v37: array<bool> := new bool[5] [v25.f28, v25.f28, fm1(-v0[260], v25.f28, globalState), v25.f28, fm1(v0[260], v25.f28, globalState)];
				v37[829] := f28;
				var v38 := 'a';
				var v39 := DC24(v11);
				globalState.f21, globalState.f14, v11, v37[829], v37 := v38 !in p0, -0x2e5, v39.cf40, (seq(729, i7  => (v38))) == p0, v37;
			} else {
				var v40: map<seq<bool>, bool> := map[v5 := f28];
				var v42 := 'w';
				var v43: map<char, bool> := map[v42 := v25.f28];
				v40 := if ((map v41 : int | v41 in (seq(0x302, i8  => (|(seq(0xb1, i9  => ('y')))|))) :: (v41 % v25.f23) := (v0[260])) == fm16(f28, |v43|, f23, globalState)) then map[v5 := f28] else v40;
				var v44 := DC26(0x224);
				var v45: array<D9> := new D9[22] [DC26(v0[260]), v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, DC26(0x25c), v44.(cf43 := f23), v44, v44, v44, v44.(cf43 := v0[260]), v44, v44, v44];
				v45[94] := v44;
				v45[94] := v44;
				v0[260] := 0x2d1;
				...
				var v51: array<multiset<bool>> := new multiset<bool>[22] [v47, v47, v47, v47, v47, v47, v47, multiset{v25.f28, f28}, multiset{v25.f28, f28}, v47, v47, v47, (f30[f23])[f28 := |v48|], v47, v47, v47[v25.f28 := v25.f23], multiset{v25.f28, v25.f28}, fm4(v49, f23, v5, v42, globalState), multiset(v5), multiset{v25.f28, f28}, v47, fm4(v49, if (|v47| in v50) then v50[|v47|] else v25.f23, v5, v42, globalState)];
				v46[491] := v51;
				...
				globalState.f21, globalState.f8, v46[491] := |v52| >= |v54|, v25.f23, v51;
				var v55, v56, v57 := m0(v53, p0 + p0[f23 := v42], v25.f23, globalState);
			}
			
			var v58 := DC22(f28);
			globalState.f8 := if (v58.cf38) then f23 else v0[260];
			globalState.f14 := f23;
		}
		...
		var v62 := 'a';
		var v63: set<int> := {f23, -0x26c, f23, v0[260], f23};
		var v64: map<int, int> := map[if ((if (-0xbf in v61) then v61[-0xbf] else p0)[f23 := v62] in v60) then v60[(if (-0xbf in v61) then v61[-0xbf] else p0)[f23 := v62]] else |v63| := -v0[260]];
		r0 := if (-f23 in v64) then v64[-f23] else v0[260];
		r1 := (f29 + f29)[v0[260] := v0[260]];
	}
	method m5(globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			v2[174] := v3 < {if (f29[f23] in v4) then v4[f29[f23]] else f23};
			v2[174] := !(if (!f28) then (set v5 : int | (0x3d3 <= v5) && (v5 < 0x2af) :: (v5 + f23)) !! v3 else if (f28) then f28 else f28);
			var v6: set<bool> := {false, f28};
			var v7: seq<set<bool>> := [v6];
			globalState.f14, v6, globalState.f8 := f23, v7[f23], f29[f23];
			v2[174] := f28;
		}
		var v8 := "kgw";
		...
		for i2 := |([|fm17(f28, fm0(f23, f28, globalState), globalState)|, f23] + f29)| to if (0x2ad in v9) then v9[0x2ad] else |(if (0x104 in v10) then v10[0x104] else [f23, f23])| {
			...
			var v15: set<int> := {i2, f23 % |v9|, i2 - |v11|, |v12[f28 := i2]| * f23, |v14|};
			v15 := if (false) then v15 else v15;
			var v16 := 'e';
			var v17: map<int, int> := map[|f29| := |[(v8[f23 := v16])[f23 := v16], v8]|];
			var v18 := DC14(v0);
			var v19 := new C2(v17, fm1(i2, f28, globalState), f28, f29[i2 := i2] + f29, |[v18, v18]|);
			...
			if (f28) {
				...
				v23[742] := f29;
				v0[888], v22, v23[742], globalState.f21 := 0x3aa, v22, f29, f28;
				...
				globalState.f14 := v19.fm18(if (f28) then v26 else fm25(|multiset{v16}|, v19.f32, globalState), (DC0("lvnjskw").(cf0 := v8[-v0[888] := v16])).cf0 + (seq(387, i3  => (v16))), v19.f32, globalState);
				globalState.f7 := v19.f32;
			} else {
				var v27: map<bool, int> := map[f28 := i2];
				var v28 := DC18(v27);
				v28 := DC18(v27);
				f29 := [v19.fm18(v27, "epl", v11[i2], globalState), fm0(i2, v19.f32, globalState), f23];
				v0[661] := -|"pnttsu"|;
				globalState.f8, v0[661], globalState.f14, globalState.f14 := |v8| % f23, f23 % (f23 / |"bqnxnel"|), f23, if (fm1(|v19.f31|, v19.f32, globalState)) then f23 / i2 else i2;
				var v29: array<map<string, bool>> := new map<string, bool>[8];
				var v30: map<string, bool> := map[v8 := v19.f32];
				v29[532] := if (v19.f32) then v30 else map["pinimjpwv" := f28];
				var v31: array<int> := new int[25](i4 => i4 * v0[661]);
				v29[532], v31, globalState.f14 := v30[v8 := !v19.f32], v31, i2 / -v0[661];
...
class C4 extends T0 {
	...
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		...
		var v2 := "ru";
		var v3: map<bool, multiset<array<D1>>> := map[p1 := v1[|v2|]];
		var v4: multiset<array<D1>> := multiset{v0};
		var v5 := DC9(v4);
		r0, globalState.f8, r0, globalState.f14, globalState.f6 := |(if (p1 in v3) then v3[p1] else v5.cf20)|, f23, f23, f23 % (if (p1) then fm0(f23, p1, globalState) else f23), ("taruujebt" + v2) + v2;
		...
		v11[122] := [f23] + v9;
		p0[428] := f23 <= f23;
		v11[122], globalState.f7, globalState.f21, p0[428], globalState.f21 := DC27(p1, v9, p0, p1, p1).cf45, p1, p1, p1, f23 > (f23 + f23);
		var i1 := 0;
		while (p0[428])
			decreases 100 - i1
		{
			...
			var v13 := DC10(p0[428]);
			v12, globalState.f8, v13 := v12, f23, DC10(p0[428]).(cf21 := -0x271 > 856);
		...
		var v17: array<map<set<bool>, int>> := new map<set<bool>, int>[16](i2 => map[{false, p1, p0[428]} := f23] + map[{!p0[428], p0[428], true, p0[428], p1} := f23]);
		var v18: set<bool> := {!p0[428]};
		v17[476] := map[v18 := f23];
		var v20: map<set<bool>, seq<int>> := map[v18 := v9];
		v17[476] := map v19 : set<bool> | v19 in v20 :: (v19) := (f23);
		if (p0[428]) {
			var v21: map<int, int> := map[f23 := f23];
			r0 := fm0(if (|v2| in v21) then v21[|v2|] else f23, false, globalState);
			globalState.f9 := p0[428];
			var v22: multiset<bool> := multiset{p0[428], !p1, !p1};
			var v23: seq<multiset<bool>> := [v22];
			var v24: T0 := new C3(v23, fm0(f23, p1, globalState), p0[428], v11[122]);
			var v25: map<T0, bool> := map[v24 := p0[428]];
			var v26 := new C3(if (p0[428]) then v23 else v23, -f23 - |v25|, p0[428], v11[122]);
			var v29: seq<map<int, int>> := [v21, v21];
			var v30: set<int> := {f23, |v21|};
			var v31: array<map<int, int>> := new map<int, int>[16] [v21, v21, v21, v21, if (fm1(if (p0[428] in v22) then v22[p0[428]] else 0x28b, p0[428], globalState)) then v21 else v21, v21, v21, v21, v21, v21, v21 + map[|v21| := v24.f23], map v27 : int | v27 in (map v28 : int | (118 <= v28) && (v28 < 492) :: (v28 / |{DC10(!p1)}|) := (multiset{|v18|})) :: (v27 - v24.f23) := (v24.f23), v29[|v2|], (map[-v24.f23 := v24.f23])[|v30| := f23], v21, v21];
			var v32: seq<bool> := [fm10(seq(868, i3  => ('e')), false, v6, p0[428], globalState), p1, p1, p1, !p0[428]];
			f27[32] := -fm0(v11[122][|v32|], p0[428], globalState);
			var v33 := DC30(v31);
			globalState.f14, v31, f27[32], globalState.f14 := v24.f23, v33.cf51, f23, f23;
			globalState.f14 := |v9|;
		} else {
			var v34: map<int, char> := map[fm0(f23, p0[428], globalState) := fm6(-f23, globalState)];
			globalState.f8 := -|v34|;
			var v35: map<int, int> := map[f23 := f23];
			var v36 := new C2(v35, p0[428], |v2| != -f23, v9 + (seq(397, i4  => (f23))), f23);
			var v37: array<bool> := new bool[21];
			v37 := p0;
			var v38: set<C2> := {v36};
			var v39: seq<bool> := [p1, p0[428], fm1(f23, v36.f32, globalState), p1, v38 !! v38];
			if (v39[-f23]) {
				p0[428] := f23 < f23;
				var v40: array<map<bool, int>> := new map<bool, int>[24] [v6, map[v36.f32 := f23], map[p0[428] := f23], v6 + v6, v6, v6[v36.f32 := f23], v6, v6, if (v36.f32) then v6 else map[v36.f32 := f23], v6, v6 + v6, v6 + v6, v6[false := f23] + v6, v6, v6 + v6, (map[p1 := f23])[v36.f32 := |v2|], v6, v6, v6, v6[p0[428] := |v6|], v6, v6, v6, map[p0[428] := f23]];
				v40[449] := v6;
				var v41 := 'v';
				var v42: map<char, bool> := map[v41 := p1];
				var v43 := DC34(v42);
				v40[449] := map[p1 := |v43.cf55|] + v6;
				f27[259] := f23;
				var v44: map<int, bool> := map[f23 := p0[428]];
				var v45 := DC21(v36.f32, p0[428], |v44|);
				f27[259] := 0x31e / (v45.cf37 * f23);
				...
				f27[914] := f23 / (f23 % f23);
				var v50 := 'n';
				globalState.f21 := v2[f27[914] := v50] <= (v2 + v2);
				var v51 := DC11(453);
				p0[428] := v39[-(if (v36.f32) then f27[914] else v51.cf22)];
				globalState.f21 := false;
			}
			
			var v52: set<int> := {f23};
			var v53 := new C2(v36.f31[f23 := 797], false, fm10(v2, p1, v6[p0[428] := f23], fm1(-f23, v36.f32, globalState), globalState), v9, -|v52| % -f23);
		}
	...
	method m2(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
			...
			decreases 100 - i0
		{
			...
			f27[562] := f23 / f23;
			var v1: seq<bool> := [v0];
			var v2: array<int> := new int[3] [|("uovdktobe" + p0)|, |v1| % f23, f23];
			var v3: seq<int> := [f23];
			...
			f27[562], globalState.f21, v2, v7 := f23 - f23, v0, f27, if (v0) then v7 else v7;
			var v8 := 'n';
			var v9: set<int> := {DC20(v0, f27[562]).cf34, |(("dxmrtsdjn")[f27[562] := v8])[0x200 := v8]|};
			var v10: map<bool, bool> := map[v0 := v0];
			var v11: map<int, bool> := map[|v9| := if (v7.f32 in v10) then v10[v7.f32] else v0];
			var v12: array<bool> := new bool[12] [true, v7.f32, true, v7.f32, v0, v7.f32 || v0, v1 != v1, v0, v0 <==> v0, if (v7.f32) then v7.f32 else v7.f32, false, f27[562] == |[v0, v0, v7.f32, if (-f23 in v11) then v11[-f23] else v7.f32]|];
			v12 := v12;
			var v13 := DC27(|v9| != f23, v3, v12, v0, v7.f32);
			var v14 := DC18(map[v7.f32 := 0x3bd]);
			f27[562], v13 := fm0(|p0|, if (f27[562] in v11) then v11[f27[562]] else if (v7.f32 in v10) then v10[v7.f32] else fm10(p0, v0, v14.cf31, v0, globalState), globalState), v13;
			var v15: map<int, seq<bool>> := map[f27[562] := (v1 + v1)[|p0| := v7.f32]];
			globalState.f9, v15, r0 := f23 == (|multiset{f27[562]}| + f27[562]), (map[f27[562] := v1] + v15) + v15[|v1| := fm11(globalState)], -f23;
		}
			...
			decreases 100 - i1
		{
			...
			if (v0) {
				...
				var v21: map<bool, seq<int>> := map[v0 := seq(-174, i2  => (f23))];
				...
				v24[605] := v17;
				v19, v23[36], v23, v24[605] := v19 + v19, v0 ==> !v0, v23, v17;
				v23[36] := fm1(f23, !v23[36], globalState) ==> v0;
				var v25: map<bool, bool> := map[v0 := false];
				var v26: seq<multiset<bool>> := [v18, v18, (v18[v23[36] := |v25|])[v23[36] := 0x2a6], v18, v18];
				var v27 := new C3(v26, f23, !v23[36], v20);
				globalState.f21 := v0;
			} else {
				var v28 := 'x';
				globalState.f11 := v28;
				...
				var v32: set<int> := {fm0(f23, v0, globalState), f23, f23, fm0(-f23, fm10(seq(0x214, i4  => (v28)), v0, v31, v0, globalState), globalState), f23};
			...
			var v39: array<bool> := new bool[18] [fm1(f23, true, globalState), v0, v16 >= v16, v0, !v0, |v36| >= f23, v0, v38[|"hm"|], v0, v0, v0, v0, false, v0, fm1(|p0|, v0, globalState), !!!v0, v0 ==> v0, v0];
			v39[808] := v0;
			v39[808] := !v0;
			if (v0) {
				var v40: map<seq<int>, bool> := map[v36 := v0];
				v40 := (v40 + v40) + v40;
				var v41: map<bool, bool> := map[fm1(f23, v39[808], globalState) := DC1(0x3c7, v39[808], f23).cf3 <= 872];
				globalState.f7 := if ((-f23 <= f23) in v41) then v41[-f23 <= f23] else f23 <= 0x155;
				globalState.f14 := fm0(f23, 0x50 <= f23, globalState);
				var v42: map<bool, int> := map[v39[808] := f23];
				...
				var v48: C1 := new C1(v39[808], v36, f23);
				var v49: map<C1, array<seq<int>>> := map[v48 := v47];
				var v50: array<array<seq<int>>> := new array<seq<int>>[23] [v47, v47, v47, v47, v47, if (v39[808]) then v47 else if (v48 in v49) then v49[v48] else v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47];
				v50[507] := v47;
				var v51 := 'r';
				var v52: multiset<char> := multiset{v51, 'o', v51};
				f27[136] := if (v51 in v52) then v52[v51] else |[v39[808]]|;
				v50[507], f27[136] := v47, -v46 + (if (v39[808]) then f23 else f23);
				var v53: multiset<int> := multiset{f23};
				var v54: seq<string> := [p0, "sxaeugrwk"];
				var v55: map<int, int> := map[(if (|multiset{v46, f27[136]}| in v53) then v53[|multiset{v46, f27[136]}|] else f23) - f27[136] := |v54[f27[136]]|];
				v55 := v55;
				...
				v56[452] := v57;
				var v58: seq<seq<string>> := [seq(0x3cf, i6  => ("o"))];
				var v59: seq<set<int>> := [fm21((v58[v46])[v46 := p0], globalState)];
				v56[452], globalState.f21, v59, globalState.f8 := map[v45 := v0], false, v59, f23;
				globalState.f14 := fm0(DC1(v46, !v39[808], v46).cf3, !(f27[136] <= v46), globalState);
			}
			...
			if (true) {
				...
				var v64: map<int, array<D11>> := map[-(|v36| % -v36[0x12f]) := v63];
				v64 := v64[0x375 := v63];
				var v65: C1 := new C1(v39[808], v36, f23);
				var v66: seq<C1> := [v65];
				var v67: map<bool, bool> := map[v39[808] := fm1(|v66|, fm1(|v16|, v39[808], globalState), globalState)];
				var v68: map<int, set<bool>> := map[|v67| := v16];
				var v69: map<map<int, set<bool>>, int> := map[v68[f23 := v16] + v68 := f23];
				globalState.f14 := if ((if (v39[808]) then v68 else map[f23 := v16]) in v69) then v69[if (v39[808]) then v68 else map[f23 := v16]] else f23;
				var v70: array<C2> := new C2[10];
				var v71: map<int, int> := map[f23 := f23];
				var v72: map<bool, int> := map[v39[808] := |"eys"|];
				var v73: multiset<int> := multiset{|(seq(-0xfb, i7  => (-0x1bd)))|};
				var v74: C2 := new C2(v71, v0, v39[808], v36, -(if (fm10("bms", v0, v72, true, globalState) in v72) then v72[fm10("bms", v0, v72, true, globalState)] else |v73|));
				v70[156] := v74;
				var v75 := 'o';
				var v76: map<C2, int> := map[v74 := |map[!v0 := v75]|];
				globalState.f9, globalState.f21, globalState.f14, v70[156] := !v0, v74.f32, f23 / (if (v74 in v76) then v76[v74] else f23), v74;
				v39[808] := v0;
				var v77: map<bool, C1> := map[true := v65];
				v77 := v77;
			} else {
				var v78: map<bool, int> := map[if (v39[808]) then v39[808] else v39[808] := f23];
				var v79: map<int, int> := map[f23 / f23 := f23];
				globalState.f7, r0, globalState.f8, v78 := v0, if (f23 in v79) then v79[f23] else f23, |(v78 + v78[v0 := 0x1b5])|, v78 + v78;
				var v80: map<bool, string> := map[v39[808] := p0];
				var v81 := DC32(p0);
				var v82: array<map<bool, string>> := new map<bool, string>[11] [v80, v80, v80, map[!fm1(|(map[v39[808] := v0])[v39[808] := v0]|, v0, globalState) := "lqs"], v80, v80, fm27(globalState), v80, map[v0 := v81.cf53], v80 + v80, v80];
				v82[933] := v80;
				var v83: map<seq<bool>, map<bool, string>> := map[v38 := v80 + v80[v0 := p0]];
				v82[933] := if ((v38 + v38) in v83) then v83[v38 + v38] else fm27(globalState);
				var v84 := DC12(v38);
				var v85: array<D6> := new D6[6](i8 => DC17([p0, p0, p0]));
				var v86: seq<string> := [fm2(globalState)];
				var v87 := DC17(v86);
				v85[292] := v87;
				v84, v85[292], globalState.f8 := v84, v87, f23;
				globalState.f14 := f23;
				var v88: map<int, bool> := map[f23 := v39[808]];
				v79 := v79[|v88| := 0x3a5];
			}
		...
		match (v90.(cf64 := DC40(v89)).(cf64 := v89)) {
			case DC39(cf63) =>
				...
				var v95: array<set<array<bool>>> := new set<array<bool>>[19] [if (v0) then v92 else v92, v92, v92, {v91, v93[cf63]}, v92, v92, v92 + v92, v92, v92, v92, v92, v94[cf63], v92, v92, v92, v92, v92, v92, v92];
				v95[446] := v92;
				var v96: array<char> := new char[23];
				var v97: seq<D9> := [DC24(v96)];
				var v98: seq<int> := [|v97|];
				var v99 := DC27(v0, v98, v91, false, true);
				v95[446] := {v99.cf46, v91};
				f27[197] := f23;
				var v100: C1 := new C1(!v0, v98, f23);
				var v101: map<bool, C1> := map[v0 := v100];
				var v102: seq<bool> := [v0];
				f27[197] := fm0(|v101|, v102[f23], globalState);
				var v103: map<int, bool> := map[fm0(f27[197], v0, globalState) := v0];
				var v104: multiset<int> := multiset{f23, |v103|, f23};
				if ((|v104| + f27[197]) < f27[197]) {
					v102 := v102[|(seq(0x36e, i9  => (|v102|)))| := v0] + ([v0] + v102);
					f27[197] := |(p0 + ("chtuw" + p0))[f27[197] % f27[197] := p0[f27[197]]]|;
					var v105 := DC11(if (cf63 in v104) then v104[cf63] else f27[197]);
					v105 := v105;
					var v106: map<int, int> := map[f27[197] := f23];
					...
					var v113 := DC28(v112);
					v113 := v113;
					var v114: map<bool, int> := map[v0 := f27[197]];
					var v115 := DC26(f23);
					globalState.f6, globalState.f9, globalState.f9, globalState.f9, globalState.f8 := p0, (f27[197] + |v114|) >= (f23 / cf63), v0, v0, -0x199 % v115.cf43;
					v0 := fm10("vrkt", v0, map[v0 := f27[197]], v0, globalState) ==> v0;
					f27[197] := f27[197];
			...
			case DC38(cf62) =>
				...
				var v124, v125, v126 := m0(v123, seq(779, i11  => ('k')), |"lwigmupbn"|, globalState);
				if (v0) {
					var v127 := 'v';
					...
					var v131: T1 := new C1(v0, seq(0x303, i12  => (-0xcd)), |"vfnpyft"|);
					v131 := v131;
					f27[913] := f23;
					f27[913] := f23;
				} else {
					...
					var v136: seq<int> := [|v134|, f23, v135[v126]];
					globalState.f11, r1 := if (f23 in v132) then v132[f23] else v133, v135 + (seq(336, i13  => (f23)));
					var v137: seq<map<int, int>> := [map[f23 := 396]];
					var v138: map<seq<map<int, int>>, string> := map[v137 := seq(-831, i14  => (v133))];
					v138 := v138[v137 + v137 := p0 + (seq(0x10f, i15  => (v133)))];
					v123[403] := !(-v126 <= 495);
					v123[403] := !v0;
					var v139: multiset<char> := multiset{'w', v133, v133};
					globalState.f6, globalState.f7, globalState.f8 := p0, fm1(v135[if (v133 in v139) then v139[v133] else |"ew"|], fm1(|(set v140 : char | v140 in v134 :: (v140))|, true, globalState), globalState), v126;
				...
				if (v0) {
					...
					globalState.f11 := fm6(-v142[f23], globalState);
					...
					globalState.f8 := v145[v126] - f23;
					v123[193] := v0;
					var v146: seq<bool> := [v0, v0];
					var v147: map<seq<bool>, int> := map[v146 := 0x10b];
					v123[193] := (if (true) then fm28(v126, globalState) else v147) != v147;
					var v148 := 'e';
					var v149 := DC15(f23, p0[f23], f23);
					var v150: set<char> := {v148};
					var v151: map<D2, char> := map[DC7(v150) := v148];
					var v152 := DC7(v150);
					var v153 := DC8(v126, |v125|, v148, -f23, if (v126 in v125) then v125[v126] else v123[193]);
					...
					v154 := v154;
					var v155: map<bool, string> := map[v123[193] <==> v0 := p0];
					v155 := v155[v123[193] := p0];
					var v157: C3 := new C3(fm29(v126, set v156 : int | (899 <= v156) && (v156 < 229) :: (v156 - f23), globalState), f23, v123[193], v145 + v145);
					v157 := v157;
				}
			...
			case DC40(cf64) =>
				...
				var v170: array<bool> := new bool[27] [v0, v160 < v160, v161[f23 := f23] >= v161, v0, if (multiset([|v163|]) in v162) then v162[multiset([|v163|])] else v0, v0, v164 > v164, -0x378 != -f23, true, -(if (v165 in v166) then v166[v165] else |v161|) < f23, f23 > f23, v0, !(v0 <==> v0), f23 <= f23, v0, !v0, v0, v0, v0, !v0, |v167| != f23, fm10(p0, v0, v169, v0, globalState), fm10(p0, v0, v169, v0, globalState), v0, v0, v0, v0];
				v170 := v170;
				...
				v173 := v173;
				v170[618] := if (!v0) then true else v0;
				v170[618] := v0;
		}
...
class C5 extends T0 {
	...
	function fm8(p0: D0, p1: set<bool>, p2: bool, p3: int, globalState: GlobalState): map<map<int, bool>, bool> {
		map[(map v0 : int | v0 in (map v1 : int | v1 in multiset{f26, f26} :: (v1 - |(map v2 : char | v2 in DC7(set v3 : char | v3 in (seq(0x223, i0  => ('u'))) :: (v3)).cf14 :: (v2) := (true))|) := (false)) :: (v0 % f25) := (false)) + map[|"vdal"| := false] := true && true]
	}
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		var v0: map<bool, int> := map[p1 := -0x13d];
		globalState.f21, r0 := p1, |fm9(p1, -f25, map[p1 := f26] + v0, globalState)|;
		var v1: seq<int> := [f23];
		var v2 := new C1(fm1(f26, p1, globalState) || p1, v1 + (seq(0xc, i0  => (-0x332))), -f26);
		var v3 := 'm';
			...
			decreases 100 - i1
		{
			...
			v7[507] := -f23 / |v8|;
			v7[507] := -(if (f26 > f25) then f23 else f25);
			p0[281] := p1;
			p0[281] := f26 <= ---fm0(f25, p1, globalState);
			var v9 := "jyx";
			var v10: map<int, bool> := map[0x2fa := p0[281]];
			var v11: map<string, map<int, bool>> := map[v9 := v10];
			v11, v7[507] := (v11[("gxiuegtec")[-0x77 := v3] := v10])[fm2(globalState) := v10], -|v9|;
		}
		v0 := v0[true := f26];
		for i2 := |v1| to f25 {
			...
			var v13 := DC19(v1);
			var v14 := "nxqooq";
			globalState.f7, globalState.f21, v12, globalState.f21 := !(0x4 != (-f23 * f25)), (f26 % f23) != (f26 / f26), (fm30(f23, v13, v14, f25, globalState) + v12) + (v12 + v12), f23 > f26;
			var v15 := DC10(p1);
			var v16: map<D3, int> := map[DC10(p1) := fm0(f25, p1, globalState)];
			if (v15 in v16) {
				var v17: map<bool, seq<int>> := map[false := v1[i2 := f26]];
				var v18 := DC36(false, p1, f25, f25, v17);
				var v19: map<int, char> := map[|map[p1 := v14]| := v3];
				var v20: seq<map<int, char>> := [map[f26 := v3], v19];
				var v21: set<int> := {f26};
				globalState.f8, globalState.f7, globalState.f6, globalState.f8, v18 := f23, p1, v14, |v20[f26]| % |(v21 + v21)|, fm31(f25, globalState);
				...
				var v31: map<int, map<bool, array<int>>> := map[f26 % i2 := v30];
				v31 := v31[f25 := v30];
	...
	method m3(globalState: GlobalState) returns (r0: bool, r1: seq<map<bool, int>>, r2: map<int, bool>) {
		...
		for i0 := |(v6 + v6[-858 := v5])[v5.f23 := v5]| to if (false) then |v8[f23]| else f26 {
			globalState.f9 := f25 != f26;
			var v9: array<int> := new int[10];
			v9 := new int[28](i1 => i1 / f23);
		...
		if (v1) {
			...
			var v14 := 'a';
			var v15: seq<bool> := [!v1];
			var v16: array<bool> := new bool[27] [v5.f28, v5.f28, v5.f28, true, v5.f28, v5.f28, v5.f28, !v1, true, v5.f28, v5.f28, v1, v1, v15[f26], v1, v1, fm1(-0xf6, v1, globalState), v1, v5.f28, v5.f28, false, v5.f28, v1, v15[0x164], true, v5.f28, v1];
			var v17 := DC27(v5.f28, seq(19, i2  => (f23)), v16, v5.f28, v15[f23]);
			var v18 := DC28(v17);
			...
			match (v21) {
				case DC31(cf52) =>
					var v22: set<int> := {v5.f23, 0x14f, |v4|, f23, v3[cf52]};
					...
					v25 := v25[v26 := v5.f23];
				case DC32(cf53) =>
					globalState.f14, globalState.f6 := v5.f23, seq(0x2b7, i3  => ('f'));
					var v27: seq<bool> := [v5.f28];
					v1 := v5.f28 !in v27;
					var v28: set<string> := {seq(915, i4  => ('h'))};
					globalState.f7 := v28 != {cf53, v7};
					v3 := v5.f29;
				case DC30(cf51) =>
					globalState.f8 := (f26 % -v5.f23) * |v7|;
				...
				case DC33(cf54) =>
					...
					globalState.f21 := v44[if (v5.f28) then f25 else 414];
					var v45: array<seq<seq<int>>> := new seq<seq<int>>[20];
					var v46: seq<seq<int>> := [[v5.f23, -v5.f23]];
					v45[694] := v46;
					v45[694] := (seq(0x1fa, i5  => (v5.f29)))[if (v1) then v5.f23 else |v8| := v5.f29];
					...
					v50[119] := v53 + (set v55 : map<char, bool> | v55 in v54 :: (v55));
					globalState.f14, v50[119], globalState.f6 := v5.f23, v53 - v53, v7[|v4| := v51];
			}
			
			var v56: seq<bool> := [v1, v5.f28, v5.f28];
			var v57 := new C1(!!v56[v5.f23], v5.f29, f23 + f23);
			var v58 := 'y';
		...
		for i7 := f23 to v5.f23 - v5.f23 {
			var v65: array<int> := new int[18](i8 => i8 / f23);
			...
			if (fm1(if (v66 in v67) then v67[v66] else f23, v69 <= v69, globalState)) {
				...
				var v73 := 'b';
				globalState.f11 := v73;
				var v74: array<string> := new string[7] [v7, v7 + v7, ("vrrj")[fm0(f26, v5.f28, globalState) := v73], v7, fm2(globalState), seq(0x17b, i10  => (v73)), "etxm" + v7];
				var v75: map<bool, int> := map[v5.f28 := i7];
				v74[926] := (v7 + v7)[if (v1 in v75) then v75[v1] else |v75| := v73];
				v74[926] := v7;
				...
				var v81: map<bool, seq<int>> := map[!v70[470] := v5.f29];
				var v82: multiset<int> := multiset{|v81|};
				globalState.f14 := fm0(|(multiset(v5.f29))[|v76| := v77.cf34]| - -|fm2(globalState)|, !(multiset{|v80|, v5.f23} < v82), globalState);
			} else {
				v66.f27[610] := |("hoqqdqjyb" + (seq(-545, i11  => ('t'))))|;
				v66.f27[610] := v5.f23 + |v7|;
				var v83 := new C0();
				...
				var v89 := DC21(v66.fm10(seq(224, i12  => (v85)), v5.f28, v88, v84[|"ixco"|], globalState), v5.f28, v5.f23);
				...
				var v96: array<bool> := new bool[27] [v1, v1, v84[|v7|], v1, false, v87.cf41, if (v5.f28) then v1 else false, v5.f28, v5.f28, v5.f28, v5.f28, v5.f28, v5.f28, false, v7 != v7, true, v5.f28, v89.cf36, v1, v5.f28, !(v83.fm20(v93, |v7|, v5.f23, v5.f23, globalState) !in map[v5.f28 := v94]), v5.f28, v5.f28, v5.f28, true, v5.f28, v95 >= v95];
				var v97: seq<array<bool>> := [v96, v96, v96];
				v96 := v97[v5.f23];
				globalState.f8 := fm0(|(seq(0x221, i14  => (f26)))|, v1, globalState);
				var v98: multiset<seq<bool>> := multiset{v84};
				globalState.f8 := (if (v84 in v98) then v98[v84] else f23) + v66.f27[610];
			}
			
			r0 := v1;
			var v99 := 'g';
			globalState.f21 := v99 in (seq(0x3a3, i15  => (DC15(f26, v99, |v7|).cf27)));
			match (DC22(v1)) {
				case DC20(cf33, cf34) =>
					globalState.f21 := fm1(f26, fm1(v5.f23, !cf33, globalState), globalState);
					v66.f27[182] := 0x3b9;
					var v100: set<bool> := {v1};
					v99, v66.f27[182], globalState.f11 := if (cf33) then v7[i7] else 'b', fm0(|v100| / |v5.f29|, cf33, globalState), fm6(f25, globalState);
					var v101: array<bool> := new bool[5](i16 => v5.f28);
					var v102: map<array<bool>, bool> := map[v101 := v66.f27[182] <= |multiset{v1, v5.f28}|];
					var v103: map<bool, int> := map[v5.f28 := v66.f27[182]];
				...
				case DC23(cf39) =>
					...
					v4 := v4[v66.fm10(v7, v1, (map[v66.fm10(seq(-438, i20  => (v99)), v5.f28, v118, true, globalState) := 922])[v5.f28 := fm0(|v119[f25]|, v5.f28, globalState)], v5.f28, globalState) := v1];
					...
					globalState.f14, v1, v120[181], globalState.f14, r2 := (|v8| / f25) % 0x1eb, if (!v5.f28 in v4) then v4[!v5.f28] else v99 in v7[v5.f23 := v99], v121, if (v99 in v122) then v122[v99] else 0x285, (v123[-0x2f1 := v5.f28] + (map[i7 := v5.f28])[f25 := v1])[|(map v124 : int | (-391 <= v124) && (v124 < 0x20c) :: (v124 % 909) := (-v5.f23))| / v5.f23 := true];
					v123 := v123[i7 := v5.f28];
		...
		for i21 := -v5.f23 to v5.f23 / f26 {
			...
			var v132: array<int> := new int[15](i22 => i22 / v130);
			var v133: seq<array<int>> := [v132];
			var v134 := DC3(v133);
			match (v134) {
				case DC4(cf6, cf7, cf8) =>
					var v135 := new C3(seq(0x43, i23  => (multiset{true, true})), v5.f23, v5.f28, v5.f29);
					globalState.f14 := f23;
				...
				case DC3(cf5) =>
					...
					globalState.f14 := |v145| / (-f23 + |multiset{v5.f23}|);
					var v146: array<string> := new string[13](i24 => v7);
					v146[404] := v7;
					v146[404] := (seq(-84, i25  => ('x'))) + v7;
					v7 := (v7 + v146[404]) + v7;
			}
			
			if (v1) {
				var v147: array<set<int>> := new set<int>[18](i26 => v131);
				v147[867] := set v149 : int | v149 in (set v148 : int | (0x344 <= v148) && (v148 < 653) :: (v148 * 0x19)) :: (v149 % |multiset{'b', 'e'}|);
				v147[867] := v131;
				...
				v128[568] := !(|v153| > -(if (v5.f28 in v154) then v154[v5.f28] else v5.f23));
				var v155 := 'u';
				var v156 := DC32("mxdqyef");
				var v157: array<string> := new string[26] [v7, v7 + v7, v7, v8[fm0(v5.f23, v5.f28, globalState)], v7[|v8[f23]| := v155], v7, v7 + v7[v150 := v155], v7, seq(0x20d, i27  => ('n')), "tfynwpxj" + v7, v7 + v7, seq(62, i28  => (v155)), seq(-0x342, i29  => (v155)), v156.cf53, "u", fm2(globalState), v7, v7 + v7, v7, "g", v7, v7, v7, v7, "esqnlyvg", "tkq" + v7];
				v157[881] := if (v5.f28) then "nxukkyffw" else v7;
				...
				v128[568], v157[881], v159, v160 := !(v5.f23 < v5.f23), ((if ("culpysq" in v161) then v161["culpysq"] else v7) + v7) + (v7 + v7), v159, v160 + v160;
				v7 := v157[881];
			} else {
				v8 := seq(0xd9, i30  => ("tp"));
		...
		r1 := ((v180 + (seq(681, i33  => (v179)))) + (v180 + [map[v5.f28 := f25], v179, v179, v179]))[|v182| := v179];
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		match (v5) {
			case DC44(cf68, cf69, cf70, cf71, cf72) =>
				...
				var v15: array<int> := new int[27] [|v10|, f26, |v12[|multiset{!cf71}|]|, |v13|, f25, f23, f26, |map[|[-|v14|]| := f26]|, 353, f25, f25, -646, |"rocyxmwas"|, cf70, |v13|, 390, f25, f23, cf70, f23, f23, f26, f25, f23, f23, f23, f23];
				var v16: map<array<int>, bool> := map[v15 := cf71];
				var v17: array<bool> := new bool[4](i0 => cf71);
				v17[644] := cf71;
				v16, v17[644] := v16, if (cf72 in v10) then v10[cf72] else !(f25 <= f23);
			...
			case DC43(cf67) =>
				...
				var v22: set<multiset<bool>> := {v19[p0 := 190], v19};
				if (v22 == (set v23 : multiset<bool> | v23 in map[v19 := p0] :: (v23))) {
					...
					var v30: array<string> := new string[23] [v2, "pfojm" + "mmwijrbtt", seq(0xac, i1  => ('s')), "vabaqredp", v2, v2[f25 := v26], if (|v28| in v27) then v27[|v28|] else v2, v29[195] + v2, v2, "untl", "vfldre" + v2, v2, v2, seq(0x15d, i2  => (v26)), v2, v2, v2, v2, v2, v2 + (fm34(0x1f4, globalState)).cf0, "k", if (p0) then v2 else v2, v2 + v2[f23 := v26]];
					v30[464] := v2;
					v30[464] := v2;
					globalState.f6 := v30[464] + "qwammv";
					var v31: C0 := new C0();
					...
					var v38 := new C1(p0, seq(-0x2f4, i3  => (f26)), (if (|v37| in v35) then v35[|v37|] else f26) % f23);
					r2 := -0x172;
					globalState.f9 := p0;
					var v39: map<bool, bool> := map[p0 := p0];
					var v40: seq<bool> := [p0, p0, p0];
					var v41: seq<bool> := [p0, v40[|multiset{f25}|], p0, p0];
					v39 := v39[p0 := v40[f25]];
				}
		...
		for i5 := f23 to f23 {
			var v49: seq<bool> := [p0];
			var v50: seq<seq<bool>> := [v49, ([fm1(|multiset(v3)|, p0, globalState)])[fm0(f26, p0, globalState) := p0], v49[f25 := p0]];
			var v51: map<int, int> := map[fm0(f23, p0, globalState) := f26];
			var v52 := DC19(v3);
			var v53: array<seq<bool>> := new seq<bool>[27] [v49, v50[f25], v49, v49, v49, v49 + v49, v49, v49 + v49, v49, if (p0) then [true] else v49, v49, fm30(if (|v3[-f23 := 0x264]| in v51) then v51[|v3[-f23 := 0x264]|] else f26, v52, v2, i5, globalState), v49, v49, fm30(f23, v52, v2, f25, globalState), v49, if (true) then v49 else v49, v49, v49[261 := p0], v49, [p0, p0], v49, v49 + v49, v49, fm30(f23, v52, v2, i5, globalState) + [p0, true, !p0], v49[-|v2| := true], v49];
			v53 := v53;
			...
			var v62 := DC16(v57);
			var v63: array<T1> := new T1[28] [v57, v58[|v59|], v57, v57, v57, v57, v57, v57, v57, v58[i5], v57, v58[|v60|], v58[f25], if (!v57.f28 in v61) then v61[!v57.f28] else v57, v57, v62.cf29, v57, v57, v57, v57, v57, v62.cf29, v57, v57, v57, v57, v57, v57];
			v63[638] := v57;
			globalState.f14, v54, globalState.f9, v56, v63[638] := f25 * v57.f23, v54, p0, v56, v57;
			...
			decreases 100 - i6
		{
			...
			match (v65) {
				case DC18(cf31) =>
					...
					var v70: map<map<seq<bool>, array<bool>>, int> := map[v69[f23] := -(-0x35d - f26)];
					v70 := v70[v68 := f23];
					globalState.f21 := true;
					...
					v71[978] := v72[f23 := p0];
					v71[978] := v72;
					var v73: map<int, map<int, bool>> := map[-(f25 - |(seq(0x2c1, i7  => (f25)))|) := map[f23 := !p0]];
			...
			v76 := v76[f23 % f25 := v75];
			globalState.f8 := v3[f26] + (if (p0) then f23 else |v64[p0 := f26]|);
		}
		r0 := p0;
		r1 := f25;
		var v77 := DC0(v2);
		...
		r2 := match v78 {
			...
			case DC0(cf0) => |(map v79 : seq<int> | v79 in (set v80 : seq<int> | v80 in (seq(-0x12a, i8  => (v3))) :: (v80)) :: (v79) := (f25))| % 0x16a
			case DC2(cf4) => f26
		};
	}
}
...
class C6 extends T0 {
	...
	method m1(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: int, r1: set<int>) {
		...
		for i0 := f23 to |v0| {
			...
			var v6: seq<bool> := [p1];
			p0[897] := v5 !! fm4(DC0(seq(591, i1  => (v3))), i0, v6, v3, globalState);
			var v7 := "cduaj";
			var v8: seq<string> := [v7];
			globalState.f14 := -|v8|;
		}
		var v9: seq<int> := [f23];
		globalState.f14 := v9[0x1b7];
		p0[487] := fm0(f23, p1, globalState) != f24;
		...
		var v15: T0 := new C3([v13[true := |v14|], multiset{p1, p1}, v13, v13, multiset{p1}], f23, p1, v9);
		var v16: seq<T0> := [v15];
		p0[487] := v15 !in (v16[|map[p1 := p1]| := v15] + v16);
		var v17: map<bool, int> := map[p1 := 0x388];
		var v18: seq<map<bool, int>> := [map[p0[487] := v15.f23], v17];
		r0 := if (v17 in v18) then f23 * f24 else -954;
		for i2 := v15.f23 to f24 / f23 {
			var v19: map<bool, bool> := map[false := !!p1];
			v19 := v19[p1 := fm1(v15.f23, p1, globalState)];
			var v20: seq<bool> := [fm1(f23, p0[487], globalState), p1, v13 !! v13, p1, if (p1) then !p1 else true];
			globalState.f7 := v20[|fm2(globalState)|];
			var v21 := 'n';
			var v22: map<char, seq<int>> := map[v21 := v9 + [v15.f23]];
			v22 := v22[v11[v15.f23] := v9];
			v20 := v20 + v20;
		}
	...
	method m2(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		...
		var v5: set<int> := {|(if (v3 in v4) then v4[v3] else (p0[f23 := v2])[f23 := v2])|, f23};
		v1 := v1[{f23} > v5 := f24];
		v2 := v2;
		if (v0) {
			var v6 := DC10(!v0);
			match (v6) {
				case DC10(cf21) =>
					...
					globalState.f14, v2, v7[540], v10, v8 := -f23, v2, v8, v10, v8;
					globalState.f6 := fm2(globalState);
					globalState.f21 := v0;
					v8[682] := cf21;
					v8[682] := cf21;
				case DC11(cf22) =>
					var v11: map<set<int>, bool> := map[v5 := p0 <= p0[f23 := v2]];
					v11 := v11[v5 := v0];
				...
				case DC12(cf23) =>
					...
					var v26: seq<string> := [p0[|v25| := v2]];
					var v27 := DC32(v26[f24]);
					var v28: multiset<D11> := multiset{v27, v27};
					var v29: map<multiset<D11>, seq<int>> := map[v28 := ([f23, f24, |cf23|, f24, f24])[f24 := fm0(f24, v0, globalState)]];
				...
				case DC9(cf20) =>
					...
					var v34: array<bool> := new bool[21] [v0, -|p0| >= f23, !v0, !v0, v0, !v0, fm1(f23, v0, globalState), v2 in p0, v0, v0 <==> !v0, true, fm1(f23, v0, globalState), v0, v32 > v32, v0, v0, v0, "thw" <= p0, v0, v33[f23], v0];
					v34 := v34;
				case DC13(cf24) =>
					...
					var v42: array<int> := new int[17] [f24, f23, f23 + f23, f24, f23, f23, f23 * f24, f24, 196 / f24, f24, f23, |v38|, v40.cf59, fm0(if (f24 in v41) then v41[f24] else -104, v0, globalState), f23, f23 * |multiset{f23, f24, f23, |p0|}|, f23];
					v42[645] := f24;
					var v43: set<bool> := {v0};
					v36, v42[645], r0 := {v43}, |p0|, |({v0, v0} * v43)|;
					var v44: array<bool> := new bool[15](i1 => true);
					var v45, v46, v47 := m0(v44, "hqminyem", f23, globalState);
					v0 := f23 != (v42[645] * |(seq(-0x208, i2  => (v2)))|);
			...
			var v53: T1 := new C3([v52, v52, v52, v52], f23, v0 <==> v0, seq(0xcd, i3  => (|p0|)));
			...
			globalState.f6 := ((seq(350, i4  => (v2))) + p0) + ((seq(635, i5  => ('k'))) + (if (v0 in v54) then v54[v0] else p0))[v53.f23 := fm6(-66, globalState)];
		}
...
method Main() {
	...
	var v1 := DC0(v0);
	var v2 := 't';
	var v3: array<string> := new string[12] [v0, "mexrhnq", v0, v0, v0, v1.cf0, v0, "qu", "wggsbwf", "rnjar", v0, v0[-282 := v2]];
	var v4 := true;
		...
		decreases 100 - i0
	{
		...
		v8[91] := if (|v0| in v15) then v15[|v0|] else 0x3cd;
		v8[91] := fm0(v9, v4, globalState);
	...
	v18[957] := v19[0x2b0 := v9] + ((map v20 : int | v20 in v21 :: (v20 - 0x2dc) := (v9)) + v19);
	var v22: array<bool> := new bool[20];
	var v23: set<bool> := {v4, v4};
	v22[547] := {v4, v4, v4, v4} < v23;
	var v24: map<char, bool> := map[v2 := fm1(v9, v4, globalState)];
	var v25: multiset<string> := multiset{"jxuh", fm2(globalState), v0};
	globalState.f7, globalState.f14, globalState.f14, v22[547] := v4 ==> (map[v2 := !!v4] != v24), v9 * (if (v0 in v25) then v25[v0] else v9), v9 % v9, !true;
	var v26: seq<bool> := [!v4];
	for i1 := v9 to |(if (true) then v26[v9 := v22[547]] else v26)| {
		globalState.f14 := v9;
		...
		decreases 100 - i2
	{
		...
		var v33, v34, v35 := m0(v22, seq(0x2ef, i3  => (v2)), |map[|v32| := v31]| * |fm4(DC0("k"), 998, v26, v2, globalState)|, globalState);
		v8[279] := -0x18;
		var v36: map<bool, array<int>> := map[v22[547] := v8];
		v8[279] := fm0(v31, v9 < |v36|, globalState);
	}
	globalState.f6 := "ahdth" + "syrkxpe";
	globalState.f14 := -((if (v4) then v9 else v9) % -|fm2(globalState)|);
	if (v22[547]) {
		globalState.f7 := v4;
		globalState.f8 := |v0| / (v9 + 30);
		var v37: set<int> := {v9};
		var v38: seq<map<int, bool>> := [fm5(v37, globalState)];
		globalState.f8 := v9 % (-|v0| / |v38|);
		var v39: map<bool, int> := map[v4 := v9];
		var v40 := DC1(v9, v22[547], v9);
		v39 := (map[true := |v0[v9 := v2]|])[v40.cf2 := -355] + v39;
		v21 := v21;
	} else {
		var v41: multiset<int> := multiset{v9, |v21|};
		globalState.f14, globalState.f6, v22[547], v4, globalState.f21 := v9, (v0[v9 := v2])[v9 := v2], v4, v41 >= v41, v26[|v26| * |(fm2(globalState))[|v21| := v2]|];
		globalState.f11 := fm6(v9, globalState);
		globalState.f9 := DC1(v9, v22[547], v9).cf2;
		globalState.f7, v22[547], v22[547] := if (v22[547]) then v22[547] else v4, v4, v22[547];
		var v42, v43, v44 := m0(v22, seq(-195, i4  => (v2)), -v9, globalState);
	}
	...
	for i5 := v9 to v9 {
		...
		var v45, v46, v47 := m0(if (v22[547]) then v22 else v22, v0, i5, globalState);
	}
	var i6 := 0;
	while (v9 >= -886)
		decreases 100 - i6
	{
		...
		globalState.f9 := v22[547];
		var v49: seq<seq<bool>> := [[v22[547]], v26];
		globalState.f14 := v9 % (v9 - |v49[v9]|);
		var v50: array<char> := new char[13];
		v50[963] := v2;
		var v51: multiset<int> := multiset{v9};
		globalState.f6, globalState.f11, v50[963] := "ghjmshpn" + v0, v0[|v51|], v2;
	}
	var v52, v53, v54 := m0(v22, fm2(globalState), v9, globalState);
	var v55: set<int> := {|v0|, v9};
	for i7 := |(v5 - v5)| to |v55| {
		globalState.f8, v54, v8 := --|fm2(globalState)|, -737 / i7, v8;
		...
		v18[957] := v18[957][fm0(fm0(v54, v4, globalState), v22[547], globalState) + --|[v9, i7, v60.cf12, i7]| := v9];
	}
	var v61: multiset<int> := multiset{v9, |([0x4b])[v9 := v54]|};
	if (v4 <==> (v61[|{v1, DC0(v0)}| := |v0|] !! v61)) {
		globalState.f9 := v4;
		v8[268] := -v9;
		v8[268] := -0x26;
		var v62: C0 := new C0();
		var v63: seq<multiset<bool>> := [v5, multiset{v22[547]}];
		var v64: C3 := new C3(v63, v8[268], !v4, [v9]);
		var v65: multiset<map<C0, C3>> := multiset{map[v62 := v64]};
		var v66: map<C0, C3> := map[v62 := v64];
		var v67 := new C3(fm29(v9, {v54, v9}, globalState), v8[268], v8[268] !in v21, v21[if (v66 in v65) then v65[v66] else v54 := v9]);
		v22, v8[268], globalState.f7 := v22, v54, fm1(v9, if (false) then !true else v22[547], globalState);
		v22[547] := v0 < v0;
	} else {
		var v68: map<bool, bool> := map[v4 := !v22[547]];
		var v69: map<bool, int> := map[v22[547] := |v68|];
		v9 := if (v22[547] in v5) then v5[v22[547]] else if (v22[547] in v69) then v69[v22[547]] else v9;
		var v70: map<string, bool> := map[seq(0x15b, i8  => (v2)) := v22[547]];
		v70 := v70[v0 := v4];
		...
		v72 := v72;
		v8[201] := v54;
		globalState.f7, v8[201], v9, v9 := v4, v9, v9, v9;
	}
	
	var v73: map<bool, bool> := map[!v4 := v22[547]];
	v73 := v73[v4 := v4];
	var v74: array<C6> := new C6[4];
	var v75: map<bool, array<C6>> := map[v22[547] := v74];
	var v76: T1 := new C2(v18[957], v22[547], v4, fm19(v9, v22[547], globalState), |v75|);
	var v77: array<multiset<char>> := new multiset<char>[11];
	var v78: map<T1, array<multiset<char>>> := map[v76 := v77];
	v78 := v78[v76 := v77];
	globalState.f7 := (v54 % |v0[v9 := v2]|) <= v9;
}