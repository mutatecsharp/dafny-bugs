...
function fm0(p0: int, p1: D0, globalState: GlobalState): int {
	|(set v0 : seq<int> | v0 in (seq(-0x9d, i0  => (seq(0x1c4, i1  => (|[true]|))))) :: (v0))| / 114
}
...
function fm9(p0: set<int>, p1: bool, globalState: GlobalState): seq<bool> {
	[multiset{DC63(true, "fntkqwquv"), DC63(!!!true, "cbbsoqdy"), DC63(!true, seq(0x153, i0  => ('l'))), DC63(false, "qfuqyuqw"), DC63(true, "ftyox")} < multiset{DC63(!true, seq(-0x2c1, i1  => ('d')))}, true, if (!true) then false else true, false]
}
...
function fm20(p0: bool, p1: D0, globalState: GlobalState): D2 {
	match DC62(map v0 : seq<bool> | v0 in map[[false] := map[66 := false]] :: (v0) := (false)) {
		...
		case DC62(cf120) => DC3(seq(200, i0  => ('r')))
...
function fm25(p0: int, p1: seq<multiset<int>>, p2: int, p3: char, globalState: GlobalState): map<string, int> {
	((map v0 : string | v0 in (map v1 : string | v1 in {"krscvahhm", "il"} :: (v1) := (0x155)) :: (v0) := (0x252)) + DC76(map["dkkpy" := |multiset{DC58(true, seq(898, i0  => ('x'))).cf108, !false, !!true}|]).cf140) + (map["u" := -237] + (map v2 : string | v2 in (seq(-0x1a5, i1  => (seq(-304, i2  => ('c'))))) :: (v2) := (-DC18(|map[|"p"| := 728]|, -0x252, [false], false, |map[true := |map[false := false]|]|).cf31)))
}
...
function fm28(globalState: GlobalState): map<set<int>, int> {
	(DC78(map v0 : set<int> | v0 in {DC74(true, {0x18b}, DC72(DC72(map[true := "yltdmqefg"]).cf134)).cf137} :: (v0) := (-0x361)).cf144 + map[set v1 : int | (393 <= v1) && (v1 < -937) :: (v1 * |(seq(0x200, i0  => ('a')))|) := 0x3b6]) + (map[{|[false]|} := 0x27b] + map[set v2 : int | (230 <= v2) && (v2 < 0x1f7) :: (v2 - 0x102) := -0x360])
}
...
function fm34(p0: bool, globalState: GlobalState): string {
	seq(0x26a, i0  => (DC77(|"pdosto"|, 0x1f3, 'm').cf143))
}
...
function fm36(p0: int, globalState: GlobalState): set<map<int, bool>> {
	{map v0 : int | (-0x2ee <= v0) && (v0 < 0x196) :: (v0 % |[true, true]|) := (false)} * ({map v1 : int | (28 <= v1) && (v1 < 0x186) :: (v1 / |"vw"|) := (true), map[|"sa"| := true]} - {map v2 : int | (0x166 <= v2) && (v2 < -0x139) :: (v2 + -589) := (!true)})
}
function fm37(p0: bool, p1: int, globalState: GlobalState): seq<int> {
	([-213] + [0x12]) + ((seq(0x218, i0  => (|[false, true, true]|))) + [819, |[false]|, |"mhdv"|, |"utx"|, 0xea])
}
...
function fm45(globalState: GlobalState): seq<int> {
	([0x210] + (seq(0x138, i0  => (0x20f)))) + ([|(seq(0x2ce, i1  => ('n')))|] + [|(seq(-0xbe, i2  => ('g')))|])
}
function fm46(p0: int, p1: bool, p2: bool, globalState: GlobalState): string {
	("pyfk" + "jch") + ((seq(0x2e9, i0  => ('e'))) + "rtgapgxx")
}
function fm47(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<int> {
	(seq(0x20a, i0  => (|[|multiset{false}|]|))) + DC26([--814]).cf49
}
function fm48(p0: int, p1: int, p2: int, globalState: GlobalState): D0 {
	DC1('q', -0x1c9 / |map[926 := |[|"uqxqbisor"|]|]|, {false, !false, true, false, true} + {false, true}, !('n' !in "lvrugbft"), |"gucrheabq"| in [|"iud"|, |{true, !false}|])
}
...
function fm53(p0: bool, globalState: GlobalState): D10 {
	DC28("jsqyq" + "wl", if (false) then |(seq(0xf6, i0  => (|map[true := !true]|)))| else |(seq(-632, i1  => (|map[true := true]|)))|, false, false, !false && true)
}
...
function fm56(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): multiset<int> {
	multiset{0x26, -0x2dc} - (multiset{588} - multiset{|map['k' := false]|, -0x342, -|"ecwfcmqt"|, 0x2a6, |map[seq(0xa1, i0  => ('d')) := !false]|})
}
function fm57(p0: int, globalState: GlobalState): D0 {
	DC0(true <==> !!!false)
}
function fm58(p0: bool, p1: int, p2: char, globalState: GlobalState): D16 {
	DC44(if (DC48(true, false).cf93) then set v0 : D5 | v0 in (seq(-0x27c, i0  => (DC15(DC13(map[|multiset([map[!false := false]])| := true]))))) :: (v0) else {DC15(DC13(map[653 := true])), DC15(DC14(false))})
}
function fm59(p0: int, globalState: GlobalState): map<int, bool> {
	map v0 : int | v0 in (if (true) then [0x28b] else seq(-0x44, i0  => (0xc0))) :: (v0 + 0x1b4) := ([|"ir"|] < [756, |map[false := |"cyrgjf"|]|])
}
function fm60(p0: int, globalState: GlobalState): set<int> {
	{|"eu"|, -|multiset{true}|, -|(seq(0x21, i0  => (-595)))|} + ({|"a"|} + {|"wqtegsv"|})
}
...
function fm63(p0: set<int>, p1: int, globalState: GlobalState): map<map<int, int>, string> {
	(map[DC82(map[788 := -0xa5]).cf146 := "gsyfjkxk"] + map[map[|[true, true]| := |(seq(0x335, i0  => ('j')))|] := "qj"]) + ((map v0 : map<int, int> | v0 in map[map[0x29f := |multiset{|[966]|}|] := "ir"] :: (v0) := ("rq")) + map[map[0x126 := |"baaaf"|] := "vskrpe"])
}
function fm64(p0: multiset<int>, p1: bool, p2: seq<bool>, globalState: GlobalState): seq<map<int, bool>> {
	[map v0 : int | v0 in multiset(seq(0x3e, i0  => (|{true}|))) :: (v0 * |map[|(seq(-480, i1  => ('f')))| := 0x375]|) := (true)]
}
function fm65(p0: seq<int>, p1: bool, p2: int, globalState: GlobalState): multiset<seq<int>> {
	multiset{[-0x15d, 542] + [|map[-0x17e := |(seq(299, i0  => ('x')))|]|], [-0x1fd] + [0x356, -356]}
}
...
function fm68(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState): map<D10, bool> {
	map v0 : D10 | v0 in multiset{DC26(seq(0x10a, i0  => (|(seq(-0x131, i1  => ('y')))|)))} :: (v0) := (false)
}
function fm69(p0: bool, globalState: GlobalState): set<map<int, int>> {
	(set v0 : map<int, int> | v0 in (seq(0x2a7, i0  => (map[0x270 := -205]))) :: (v0)) - {map[|map[false := false]| := |(set v1 : int | (-0x1ca <= v1) && (v1 < 0x38b) :: (v1 - |map['f' := 0x76]|))|], map v2 : int | (0xc5 <= v2) && (v2 < 485) :: (v2 % 0x3c5) := (0xc7), map v3 : int | (323 <= v3) && (v3 < 926) :: (v3 / |"lksgqv"|) := (0x395), map[|[true]| := -253], map[|map[0x3c0 := true]| := 735]}
}
...
function fm74(p0: int, globalState: GlobalState): D4 {
	DC11(if (false) then !true else true, false, 85, -(|[|[false, true, false]|, 0x30a, 278, 520, 0x2a5]| % |"eciqgjccx"|))
}
...
function fm77(p0: bool, p1: int, globalState: GlobalState): seq<map<bool, int>> {
	(seq(101, i0  => (map[false := 872]))) + (seq(-0x3c6, i1  => (map[false := -881])))
}
...
function fm79(p0: bool, globalState: GlobalState): multiset<set<bool>> {
	multiset(((seq(0x1e9, i0  => ({false, false}))) + [{true, false}, {!false, true}, {true, true}]) + [{false}])
}
function fm80(p0: bool, p1: string, globalState: GlobalState): D13 {
	if (!false) then DC35({|map[false := --0x6e]|}) else if (false) then DC35(set v0 : int | v0 in [|[multiset{false, true}]|] :: (v0 % |[true, false, false]|)) else DC35(DC35({-|(set v1 : int | v1 in (seq(0x34e, i0  => (|"eo"|))) :: (v1 % -79))|}).cf67)
}
...
function fm82(globalState: GlobalState): D22 {
	if (false) then DC60(-|multiset(seq(-334, i0  => (--0x65)))|, map[470 := false], -0x389, -953) else DC60(|(seq(-0x187, i1  => (0x26c)))|, map[394 := false], |multiset{'u'}|, |['o', 'n']|)
}
function fm83(p0: int, p1: int, p2: int, globalState: GlobalState): map<bool, string> {
	map[false := seq(0x1c, i0  => ('n'))] + (if (false) then map[DC50(!true).cf96 := "jffwgpbnf"] else map[true := "kcdflbvs"])
}
function fm84(p0: int, p1: bool, globalState: GlobalState): D13 {
	DC36(|map['o' := false]| % 0x281)
}
method m13(p0: array<T1>, p1: bool, p2: bool, p3: int, globalState: GlobalState) {
	var v0: array<int> := new int[6];
	var v1 := DC21(p3 % p3, p3 > p3, !true, v0, if (true) then p2 else p2);
	...
	if (!p2) {
		...
		var v11: array<set<bool>> := new set<bool>[29] [{p1} * {fm2(v4, |v5|, globalState)}, v6, v6, v7[p3], v6, v6 - v6, v6, v6, v6, v6, v6, v6 - v7[p3], v6, v6 * v6, v6, v6 + v6, v6, {p2}, v6, if (v8 in v9) then v9[v8] else v6, v6 - v6, v6, v6 * v6, v6 + v6, v6, v6 * v6, fm16(v5, globalState) * (v10.(cf132 := v6)).cf132, v6, v6];
		v11[73] := v6;
		v2[280] := p2;
		var v12 := DC23(v5);
		var v13: seq<D8> := [DC23(v5), v12, v12, v12, v12.(cf44 := seq(0xd3, i0  => (v3)))];
		var v14: seq<bool> := [true];
		var v15 := DC5(p1, |v14|);
		var v16 := DC11(p2, p2, p3, p3);
		var v17: seq<seq<D8>> := [v13];
		globalState.f5, globalState.f18, v11[73], v2[280], v13 := p1, v15.cf13, if (if (v16.cf19) then p1 else p1) then v6 else v6 - v6, p1, (v13 + v17[p3])[--p3 := v12];
		var v18 := DC0(v2[280]);
		var v19: C7 := new C7(v2[280], v18);
		var v20 := DC69(v19);
		match (v20) {
			case DC70(cf129, cf130, cf131, cf132) =>
				globalState.f6 := v19.f26;
				var v21: array<map<bool, int>> := new map<bool, int>[16];
				var v22 := DC1(v3, cf130, {p1}, p2, v2[280]);
				var v23: map<array<map<bool, int>>, int> := map[v21 := fm0(0x33f, v22.(cf3 := v7[cf130]), globalState)];
				v23 := v23[v21 := p3];
				v2[280] := p1;
				globalState.f18 := p3;
			case DC69(cf128) =>
				var v24: seq<int> := [p3];
				globalState.f5 := !(multiset{p3} > (multiset{p3, |v24|})[p3 := p3]);
			...
			case DC71(cf133) =>
				...
				p0[918] := v26;
				v5, globalState.f17, p0[918] := (v5 + (seq(-0x354, i1  => (v3)))) + ("akajnsajn" + v5), p3, v26;
				var v27: T0 := new C7(true, v18);
				var v28: map<int, T0> := map[p3 := v27];
				var v29: map<bool, map<int, T0>> := map[v19.f26 := v28];
				var v30: array<map<int, T0>> := new map<int, T0>[5] [if (v2[280] in v29) then v29[v2[280]] else v28, v28, v28, v28, v28];
				...
				v31[781] := if (p1) then v30 else v30;
				globalState.f17, v31[781] := p3, DC73(v30).cf135;
		}
		...
		var v36: map<bool, string> := map[v2[280] := v5];
		v33[383] := new seq<char>[19] [seq(428, i3  => (v3)), ("vi")[|v5| := v3] + v5, v5 + v5, v5, v5, "tugpqptu", v5, v35[p3], (v5 + v5)[p3 := fm1(globalState)], v5, v5 + v5, v5, v5, if (p1 in v36) then v36[p1] else seq(668, i4  => (v3)), "mmprer", v5, v5[p3 := v5[0x351]], v5[p3 := v3], (seq(227, i5  => (v3))) + v5];
		...
		var v40: set<int> := {p3};
		v39 := v39[v40 < v40 := p3 / p3];
		var v41 := "ufsfmdr";
		globalState.f17 := -(|v41| / p3);
		...
		match (v43) {
			case DC17(cf28, cf29) =>
				...
				var v50: seq<string> := [v41, "yfsx", seq(-0x105, i6  => (v44)), v41, v41];
				var v51: seq<int> := [p3, 978];
				globalState.f18, v49, globalState.f6 := v48.fm5(p1, globalState), if (|v50[|v45|]| in v51) then map[v0 := v48] else v49, p1 || p1;
				v2[793] := p1;
				v2[793] := false;
			case DC18(cf30, cf31, cf32, cf33, cf34) =>
				...
				v2[853] := p1;
				globalState.f4, globalState.f17, globalState.f4, v55, v2[853] := v2, p3, v2, v55, p1;
			case DC16(cf27) =>
				...
				v59 := v59.(cf110 := v58);
				var v60: seq<int> := [p3];
				var v61: C1 := new C1(v60[p3], DC0(true));
	...
	for i7 := p3 to -p3 {
		...
		v62[625] := if (v64 in v65) then v65[v64] else v0;
		v62[625] := v0;
		if ((!p2 && false) ==> (i7 == -p3)) {
			var v66 := "xyrcmgb";
			globalState.f16 := v66;
			...
			v77 := new C1(fm0(|[p3, v0[168], p3, v0[168]]|, DC1(v63, p3, {fm2(v78, 52, globalState)}, p2, true), globalState), v76);
			var v79 := "yguwc";
			globalState.f18 := |v79| % -0x255;
		}
	...
	if (match v85 {
		...
		var v97 := DC53(v96);
		var v98 := DC55(v97);
		v95[597] := map[DC55(v97).(cf105 := DC53(v96)) := p3];
		var v99 := DC55(v97);
		var v100: map<D20, int> := map[v99 := 0x159];
		v95[597] := v100 + v100;
		var v101: seq<int> := [p3];
		if (fm2(v94 - multiset(v92[p3 := v93]), |([p3] + v101)|, globalState)) {
			v2[676] := if (p1) then p2 else p2;
			v2[676] := (v92 < v92[p3 := v93]) && (v83 >= {p2, p2});
			...
			var v107: map<bool, set<int>> := map[v2[676] := {p3}];
			globalState.f6 := if (v105 >= v106[p3]) then p2 else |v107| > -p3;
			var v108 := DC0(v2[676]);
			v108 := v108;
			...
			v109[74] := if (!v111.cf85) then map[v112 := v113] else v114;
			v109[74] := map[v112 := v113];
			var v115: map<bool, array<int>> := map[!v2[676] := v0];
			var v116 := DC36(|v115|);
			...
			var v126: array<multiset<bool>> := new multiset<bool>[19] [v123 - v123[p2 := 457], v123, v123, v123, v123, v124[p3], v123, v124[p3] + multiset([fm2(v94, p3, globalState)]), v123, fm30(p1, v92, globalState), v123, v123, v123, multiset{false, p2, !(if (p2 in v125) then v125[p2] else fm2(multiset{v93, v93, v93, v93}, p3, globalState))} - multiset(([p2])[0x1c3 := p2]), v123, v123, v123, v123 * v123, v123];
			var v127: seq<bool> := [p2];
			var v128: map<string, multiset<bool>> := map[v92[|map[p2 := p3]| := v93] := multiset(v127)];
			v126[491] := if (v92 in v128) then v128[v92] else v123;
			v126[491] := v123;
	...
	var v142 := DC18(v134[p3], p3, v136.cf32, !p1, |v141|);
...
class C1 extends T1 {
	...
	function fm3(p0: int, p1: int, p2: bool, globalState: GlobalState): map<int, bool> {
		(map v0 : int | v0 in (seq(0xd5, i0  => (706))) :: (v0 + f21) := (false)) + map[f21 := !false]
	}
	function fm4(p0: char, p1: multiset<multiset<char>>, globalState: GlobalState): D0 {
		f20.(cf0 := true)
	}
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		...
		for i0 := fm0(if (p0 in v3) then v3[p0] else p1, DC1(v4, p1, v5, p0, p0), globalState) to p1 {
			if (p0) {
				...
				globalState.f17, v7, globalState.f18, v8[702] := -p1 * (|v1| / |v3|), v7, 0x1f4, v9 * v10[f21];
				globalState.f17 := v6[811];
				v2 := v2;
			} else {
				globalState.f6 := p0;
				...
				v13 := v13[v11 := v12];
				v12 := v12;
				globalState.f6 := f21 in (map v14 : int | v14 in v2 :: (v14 % f21) := (v0));
				globalState.f5 := !p0;
			}
		...
		forall i3 | 0 <= i3 < v24.Length {
			v24[i3] := ((seq(0x200, i4  => (|(map v25 : int | v25 in map[p1 := |multiset{-p1, f21}|] :: (v25 - p1) := (map[false := p0]))|))) + v2) + (if (p0) then v2 else v2);
		}
		var i5 := 0;
			...
			decreases 100 - i5
		{
			...
			v29 := if (|v32[-f21]| in v31) then v31[|v32[-f21]|] else v29;
			var v33 := DC5(p0, f21);
			var v34: seq<seq<int>> := [fm17(v33, p0, globalState)];
			var v35: array<int> := new int[19] [p1 + f21, |v0|, |v0|, v2[679], 0xb3 % |v20|, 102, v33.cf13, |v34|, if (p0 in v20) then v20[p0] else f21, p1, p1, f21, f21, p1, p1, p1 / f21, 0x27b * p1, f21, |fm18("vbilqwqgm", false, p0, !p0, globalState)|];
			v35[557] := fm0(p1, v26.(cf2 := p1, cf4 := p0, cf1 := v4), globalState);
			v35[557] := |({p0} + v5)|;
		}
...
class C2 {
	...
	method m2(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: D2) {
		...
		if (v4[p1]) {
			...
			v5 := map[p2 := p3];
			globalState.f17 := f22;
			var v6: set<bool> := {v0[301], p0, p0};
			var v7 := DC1(v2, p3, v6, v0[301], false);
			var v8: map<char, multiset<bool>> := map[if (p0) then v2 else v7.cf1 := fm8(true, f22, globalState)];
			v8 := v8;
			var v9: set<int> := {p3, p3, fm0(p3, fm10(f22, p2, v0[301], globalState), globalState), p3};
			r0 := v4 <= fm9(v9, v0[301], globalState);
		} else {
			var v10: map<multiset<bool>, bool> := map[multiset{!p0} := p0];
			var v11: multiset<bool> := multiset{v0[301], p0, true};
			v0 := if (if (v11 in v10) then v10[v11] else p0) then v0 else v0;
			v0[301], globalState.f5 := p2, if (p2) then p2 else 0x319 !in [|{p3}|];
			globalState.f16 := "csug";
			globalState.f5 := p0;
			var v12: map<seq<bool>, string> := map[v4 := fm11(v0[301], globalState)];
			var v13: multiset<int> := multiset{p1, f22, p1, |(if (v4 in v12) then v12[v4] else seq(0x291, i0  => (v2)))|};
			v0[301], v13, v1 := p2, v13, v1;
		}
		
		var v14 := new C0(v0, v4);
		var v15 := DC4(p1, v0[301], p2, v14.f24[p3] || p0);
		match (v15) {
			...
			case DC5(cf12, cf13) =>
				globalState.f6 := true;
				globalState.f5 := (DC5(p0, |(seq(-192, i1  => ('q')))|).(cf12 := v14.f24[f22])).cf12;
			...
			case DC6(cf14) =>
				globalState.f18 := if (v0[301] <==> v0[301]) then p1 else f22;
				var v34: array<D1> := new D1[22];
				var v35: multiset<bool> := multiset{v0[301], v14.fm13(f22, globalState)};
				var v36 := DC2(v35);
				v34[344] := v36;
				v34[344] := v36;
				var v37: array<string> := new string[24](i2 => v1 + v1);
				v37[521] := "drbyfkijt";
				v37[521] := (v1 + "brsiadvol") + v1;
				var v38: set<int> := {p1};
				var v39: map<int, set<int>> := map[f22 := v38];
				var v40: set<set<int>> := {v38, v38, v38, v38, if (|v37[521]| in v39) then v39[|v37[521]|] else v38};
				v0[301] := if (v40 < v40) then p0 else v0[301];
		}
		...
		var v44 := DC1(v2, p3, v43, p2, v0[301]);
		var v45: map<int, string> := map[-f22 := "d"];
		r1 := new int[16] [0x193, p1, if (v42.cf0) then f22 else p1, -|(v1 + v1)|, |v1|, p3 - p1, -0x339, --f22 * p3, p1 / |v41|, 0x195, |fm19(fm0(p3, v44, globalState), v2, globalState)|, p3, f22 + |(if (p1 in v45) then v45[p1] else v1)|, p3, |v41|, p3];
...
class C3 extends T0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		for i0 := p1 to p1 {
			...
			v0[199] := if (i0 in v2) then v2[i0] else if (v4 in v5) then v5[v4] else false;
			var v6 := 'o';
			var v7: seq<char> := [v6];
			var v8 := DC28("vuile", p1, !v0[199], true, v7[|v3| := v6] <= v7[i0 := v6]);
			match (v8) {
				case DC27(cf50, cf51) =>
					v0[199] := !v0[199];
					var v9: array<int> := new int[24];
					v9[145] := i0;
					var v10: seq<bool> := [v0[199]];
					var v11: map<bool, int> := map[v0[199] := |v10|];
					globalState.f15, v9[145] := (v7 + v7) + fm46(0x9b, v0[199], v0[199], globalState), if (v0[199] in v11) then v11[v0[199]] else i0;
					v9[145] := |(seq(0x19b, i2  => (v6)))|;
					globalState.f5 := p0;
				...
				case DC26(cf49) =>
					...
					var v15: set<seq<bool>> := {v14, [!p0] + v14, v14[p1 := p0] + [v0[199], p0]};
					v15, globalState.f6, globalState.f18, globalState.f18 := v15 * v15, p0, i0 - p1, if (if (v0[199]) then v0[199] else v0[199]) then p1 else i0;
					var v16: array<string> := new string[29];
					v16[706] := v7;
					var v17: multiset<int> := multiset{--(p1 / i0), 0x133};
					v16[706], globalState.f5, v17 := (v7 + "nydoft") + v7, v0[199], v17 * v17;
					var v18: array<int> := new int[16];
					v18[390] := p1;
					var v19 := DC2(v3);
					var v20: map<D1, int> := map[v19 := i0];
					v18[390] := |(cf49 + cf49)[(if (v19 in v20) then v20[v19] else p1) % i0 := -i0]|;
					var v21: map<bool, bool> := map[p0 ==> v0[199] := p0];
					var v22: multiset<char> := multiset{'n'};
					var v23: map<array<int>, array<int>> := map[v18 := v18];
					var v24: map<int, int> := map[|v23| := v18[390]];
			...
			var v27: map<bool, multiset<int>> := map[p0 := if (v0[199]) then multiset{i0} else v26];
		...
		if (!p0) {
			...
			if (!(true || p0)) {
				...
				var v33: seq<bool> := [p0];
				var v34: array<seq<int>> := new seq<int>[4] [[|v30|, -0x2bb, p1], v32[|v33| := p1], v32, v32];
				v34[607] := v32;
				var v35 := 'x';
				var v36 := DC1(v35, p1, v28, !p0, p0);
				var v37: multiset<bool> := multiset{p0, p0, p0, fm2(multiset{v35, v35}, |{p1, |v32|}|, globalState)};
				globalState.f5, globalState.f6, v34[607], globalState.f18 := p0, p0, [fm0(p1, v36, globalState), p1, p1, |v37|], -p1;
				var v38: set<seq<int>> := {v34[607], v32};
				var v39: seq<seq<int>> := [fm47(p1, p0, p0, globalState), v34[607], [p1]];
				var v41: map<bool, bool> := map[p0 := p0];
				var v42: set<map<bool, bool>> := {v41};
				v29 := new int[21] [p1 % p1, |(v38 * (set v40 : seq<int> | v40 in v39 :: (v40)))|, fm0(p1, fm48(|(seq(0x196, i3  => (v35)))|, p1, p1, globalState), globalState), p1 % p1, p1, p1, p1, -p1, p1, |v42|, p1 * p1, -0x4b, p1, p1, 0x2d7, fm0(p1, fm48(p1, p1, -0x11f, globalState), globalState), |[p0, p0, p0, p0]|, p1, p1, p1, p1 - -p1];
				...
				var v56: array<int> := new int[19] [p1 - |v46[423 := fm1(globalState)]|, |v47|, |v49|, -884, if (p0) then 0x249 else |v50|, 0x292, fm0(p1, v51.(cf2 := p1), globalState), |(v46 + (seq(402, i4  => (v48))))|, if (p1 in v53) then v53[p1] else 0x2d3, if (p0 in v50) then v50[p0] else p1, |(v54 + v54)[p1 := p0]|, -p1, p1, 0x161, p1, p1 - 0x252, |v55|, |v53| % p1, p1];
				v56[357] := 0x291;
				v56[448] := |v46| + p1;
				...
				globalState.f4, globalState.f18, v56[357], globalState.f6, v56[448] := v57, -(0x2e3 - p1) % 0x1dc, |v61|, !((|v50| - p1) >= |v62|), -fm0(p1, v51, globalState);
				globalState.f6 := p0;
				...
				var v66: map<array<char>, int> := map[v63 := -|v65[p0 := 0x2e]|];
				v66 := v66[v63 := p1];
				v56 := new int[11] [fm0(-v56[357], v51, globalState), v56[357], v56[357], |v54|, p1, |"nkihb"|, v56[357], |v47|, v56[357] * v56[357], v56[357], |v46| - v56[357]];
			}
			...
			if (!p0) {
				...
				var v70: set<int> := {p1, p1, |{p0}| / p1, p1, |v69| - |{p1, p1}|};
				globalState.f17, v67[252], globalState.f18 := p1, v68, |v70|;
				...
				v78[107], globalState.f18, v77, globalState.f17, v80[138] := false, p1, fm46(-|((map v81 : char | v81 in v77 :: (v81) := (p0)) + map[v82 := p0])|, v79 < v79, v28 !! v28, globalState), p1, fm0(p1 * p1, v84, globalState);
				var v85: map<int, int> := map[p1 := p1];
				var v86: seq<int> := [fm0(717, v84, globalState)];
				var v87: multiset<array<int>> := multiset{v80};
				r1 := (if (v80[138] in v85) then v85[v80[138]] else v86[p1]) - |v87|;
			}
			...
			v90[714] := if (if (p0) then p0 else p0) then if (fm2(v93, p1, globalState)) then v94.cf41 else v91 else v91;
		} else {
			var v95 := "caabamdwi";
			...
			if (!(p1 >= v98.cf60)) {
				...
				v101, globalState.f5, globalState.f17, globalState.f5, v96[249] := if (p0) then if (p0 in v109) then v109[p0] else v101 else v101, !(v110 == v110), |v111|, p0, p0;
				var v112 := DC14(p0);
				var v113: multiset<bool> := multiset{v112.cf25};
				var v114: array<multiset<bool>> := new multiset<bool>[11] [v113, v113, v113 + v113, fm51(globalState) * multiset{true}, v113 - v113, multiset{p0}, v113, v113, v113, v113, (multiset(v110))[p0 := p1]];
				v114[127] := v113;
				var v115: map<int, bool> := map[p1 := v96[249]];
				var v116: map<map<int, bool>, bool> := map[v115 := v96[249]];
				var v117: array<bool> := new bool[14] [p0, p0, if (map[p1 := p0] in v116) then v116[map[p1 := p0]] else true, v96[249], fm2(multiset{v104}, p1, globalState), v96[249], v96[249], p0, p0, v96[249], p0, p0, v96[249], v96[249]];
				var v118: multiset<array<bool>> := multiset{v117, v117, v117, v117, v117};
				v114[127], globalState.f6 := (multiset([p0]) * v113) * v113, !((v118 - v118) >= v118);
				v95 := (if (v110[p1]) then v95 else v95) + v95;
				globalState.f6 := v110[-(p1 % -p1)];
				globalState.f6 := p0;
			} else {
				...
				var v120: array<int> := new int[16](i7 => i7 % p1);
				var v121: T1 := new C1(p1, f20);
				var v122: array<bool> := new bool[18];
				var v123: multiset<array<bool>> := multiset{v122, v122, v122};
				v120, v121, globalState.f6, r1, v123 := v120, v121, (p1 % v121.f21) <= (|v95| + v121.f21), -p1, (if (v96[143]) then v123 else v123) - v123;
			}
		...
		for i8 := |(if (p0) then map[p1 := v131] else map[|v134| := fm50(p0, p0, v137, globalState)])| to p1 {
			...
			v138[726] := v141;
			var v142 := 'a';
			v138[726], globalState.f17, globalState.f15, globalState.f6 := v141, i8, (fm46(p1, p0, false, globalState) + v140) + (v140 + v140)[p1 := v142], !p0;
			...
			v147[631] := if (p0) then fm2(v144, i8, globalState) else p0;
			v147[516] := p0;
			globalState.f6, v147[631], v147[516], globalState.f17 := p0, if (p0) then i8 >= -|v143| else p0, p0, p1;
			...
			match (if (!p0) then v149 else DC24(v148).(cf45 := v148)) {
				case DC25(cf46, cf47, cf48) =>
					...
					v150[627] := p1;
					var v151: map<bool, char> := map[v147[631] := v142];
					var v152: seq<int> := [|v151|];
					var v153: multiset<multiset<bool>> := multiset{multiset{v147[631]}};
					cf46, globalState.f17, v150[627], v147[631] := |v152| % 0x2b7, |v134|, cf46, !!(multiset{multiset{p0}, multiset(v131), v135} >= (v153 + multiset{v135, v135}));
					globalState.f6 := !v147[631];
					var v154: C1 := new C1(cf46, f20);
					v147[631], v147[631], v147[631], globalState.f16, v147[631] := (multiset(v131) - v135) >= v135, p0, (p1 !in map[|map[v154 := cf47]| := v137]) ==> true, v140, p0;
					var v155: set<array<bool>> := {v147, v147};
					globalState.f18 := |v155|;
				case DC24(cf45) =>
					var v156 := DC28(v140, p1, true, v143 >= v143, v147[631]);
			...
			decreases 100 - i9
		{
			...
			v131 := (v131 + v131)[p1 := !fm2(v160, if (p0 in v135) then v135[p0] else p1, globalState)] + v131;
			if ((v132 - v132) > v132) {
				...
				globalState.f5 := map[fm2(v160, p1, globalState) := p1] != v168[p1];
			...
			globalState.f6 := ((fm56(p1, p0, false, |v170|, globalState))[p1 := p1] * v170) >= ((if (p0 in v171) then v171[p0] else v170) - v170);
			if (p0) {
				var v172: array<bool> := new bool[15](i11 => !p0);
				globalState.f4 := v172;
				var v173: seq<int> := [|(seq(852, i12  => (-0x65)))|];
				v173 := v173;
				var v174 := "umw";
				var v175: array<string> := new string[10] [v174 + v174, v174, v174, v174 + v174, "ads", v174, (seq(0x2a5, i13  => (v159))) + "o", "aoxrrsm", seq(0x18, i14  => (v159)), v174 + "mn"];
				...
				v176, globalState.f4, v177[386], globalState.f17 := v176, if (p0) then v172 else v172, [DC23(v174), DC23(fm46(p1, p0, false, globalState)).(cf44 := v174), DC23("jbnrtear"), DC23(fm46(|v180|, p0, !p0, globalState))], p1;
				v172[879] := p0 ==> true;
				v172[879] := p0;
			} else {
				r1 := if (p0) then -p1 else -374 / p1;
				var v181 := DC4(-p1, p0, p0, p0);
				var v182: seq<char> := ['t'];
				var v183 := DC1(v182[p1], p1, v28, !true, p0);
				...
				globalState.f17, v184, v184[21], globalState.f5, v186 := -p1, v187[p1 * |v189|], DC20(|v131|, p0).cf36, p0, v186;
				globalState.f18 := p1 % v184[21];
...
class C4 extends T0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		if (p0) {
			...
			v0, globalState.f6 := v0 + v0, fm2(v2[v1 := p1], v3[|v5|], globalState);
			...
			match (fm44(p0, globalState)) {
				case DC8(cf16) =>
					...
					v10[720] := set v11 : int | (0x30 <= v11) && (v11 < 0x3a5) :: (v11 * p1);
					var v12: set<int> := {p1};
					v10[720] := v12;
					var v13 := new C2(p1);
				...
				case DC9(cf17) =>
					...
					globalState.f16 := v31[p1];
			}
			
			globalState.f18 := 0x2fd % p1;
		} else {
			if (p0) {
		...
		v60[288] := fm2(v62, p1, globalState);
		var v63: set<int> := {p1};
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v66: set<bool> := {v60[288]};
			var v68: map<char, bool> := map[v61 := v60[288]];
			...
			match (v76) {
				case DC8(cf16) =>
					...
					v77 := v77;
					var v78: multiset<bool> := multiset{v60[288]};
					v65[986] := -((if (p0 in v78) then v78[p0] else |v73[v74.f22 := v61]|) * p1);
					v65[986] := v74.f22;
					var v80: map<bool, int> := map[cf16 := -v74.f22];
					globalState.f18 := (-|(map v79 : map<bool, int> | v79 in {v80, map[cf16 := v74.f22], map[cf16 := -p1], v80} :: (v79) := (v60[288]))| + |v66|) - v74.f22;
				case DC7(cf15) =>
					var v81: multiset<int> := multiset{|v73|, v74.f22, v74.f22};
					v60[288] := !(multiset{p1, 0x26} >= v81);
					var v82: map<bool, array<bool>> := map[v60[288] := v60];
					var v83 := DC24(v82);
					var v84: map<bool, D9> := map[v60[288] := v83];
					var v85: set<set<bool>> := {v66};
					var v86 := DC17(v81, v85);
					var v87: map<D6, bool> := map[v86 := !!v60[288] <==> v60[288]];
					v84, v60[288], globalState.f5 := v84, if (v86 in v87) then v87[v86] else DC0(p0).cf0, p0;
					var v88 := DC26(v71);
					v88 := v88;
					...
					v89 := v90.cf58;
				case DC9(cf17) =>
					v60[288] := v74.f22 > (v74.f22 + p1);
					r1 := |v71|;
					var v91 := DC1(v61, p1, {v60[288]}, p0, v60[288]);
					var v92 := new C2(fm0(p1, v91, globalState));
					var v93: seq<seq<int>> := [[v74.f22]];
					var v94: map<seq<int>, bool> := map[v93[p1] := v60[288]];
					var v95 := DC16(v94);
					v95 := v95;
			}
			
			var v96: map<int, set<bool>> := map[|v75| := v66];
			if (fm2(v62 + v62[v61 := p1], |v96|, globalState)) {
				v60[288] := v60[288] || v60[288];
				var v97: array<map<int, bool>> := new map<int, bool>[10];
				var v98: map<int, bool> := map[v74.f22 := v60[288]];
				v97[922] := v98 + v98;
				var v99: multiset<string> := multiset{"fshrx", v73};
				var v100: seq<string> := [v73];
				v60[288], v97[922], globalState.f17, r2, v71 := v99 > (multiset(v100) - v99), v98[v74.f22 * v74.f22 := v60[288] && p0], v74.f22, fm1(globalState), v71;
				var v101 := DC26([-0x10b]);
				var v102: T0 := new C3(fm57(v74.f22, globalState));
				var v103: seq<T0> := [v102];
				var v104: map<D10, int> := map[v101 := |v103|];
				v104 := v104[v101 := v74.f22 % v74.f22];
				var v105: array<D0> := new D0[14](i7 => DC1(v61, p1, v66, p0, !v60[288]));
				var v107 := DC1(v61, |(map v106 : int | (0x37f <= v106) && (v106 < -0x16b) :: (v106 * -|multiset{v74.f22}|) := (p0))|, v66, p0, p0);
				v105[89] := v107;
				v105[89] := v107;
				globalState.f18 := -|((("sqptffvha")[--v74.f22 := v61] + v73) + "wwxdlibi")|;
			} else {
				var v108 := DC1(v61, p1, v66, v60[288], v60[288]);
			...
			globalState.f5 := v60[288];
		}
		var v116: multiset<bool> := multiset{false, false};
		var v117 := "kbis";
		if (v60[288] <==> (v116[v60[288] := |v117|] <= multiset{true})) {
			globalState.f18 := -p1 * p1;
			r2 := v61;
			if ((v60[288] <== p0) <== v60[288]) {
				globalState.f18 := 859;
				v61 := v61;
				v117 := v117 + (seq(108, i8  => (v61)))[p1 := v61];
				globalState.f18 := p1;
				var v118: multiset<int> := multiset{-p1};
				var v119: map<multiset<int>, int> := map[v118 := p1];
				var v120: seq<int> := [303];
				globalState.f6 := !!!DC18(if (multiset(v120[|v117| := p1]) in v119) then v119[multiset(v120[|v117| := p1])] else p1, p1, v64, p0, p1).cf33;
			} else {
				globalState.f17 := p1;
				var v121: map<multiset<bool>, bool> := map[v116 + v116[p0 := |[p1]|] := v60[288]];
				var v122: seq<multiset<bool>> := [v116, v116, v116];
				v121 := map[multiset(v64) := v60[288]] + map[v122[p1] := p0];
				v65[874] := p1;
				var v123: map<int, bool> := map[668 := v60[288]];
				var v124: set<bool> := {p0};
				var v125: map<set<bool>, set<bool>> := map[{v60[288], v60[288], if (p1 in v123) then v123[p1] else fm2(multiset(v117), p1, globalState), v60[288], v60[288]} := v124];
				v65[874] := |v125|;
				v65[874] := if (v60[288]) then -v65[874] else -(p1 / |v124|);
				globalState.f18 := v65[874];
			}
			
			if (v64[p1]) {
				var v126 := DC1('g', |[p0]|, {v60[288]}, p0, fm2(v62, p1, globalState));
				globalState.f17 := fm0(p1, v126, globalState);
				var v127 := DC39(v60);
				var v128: seq<array<bool>> := [v60, v60, v60];
				var v129: multiset<int> := multiset{p1};
				var v130: map<bool, array<bool>> := map[v60[288] := v60];
				var v131: array<array<bool>> := new array<bool>[15] [v127.cf72, v60, v60, v60, v128[0x1ca], v60, v60, v60, v60, v60, v128[|v129|], v60, v60, v60, if (!p0 in v130) then v130[!p0] else v60];
				v131[763] := v60;
				v131[763] := new bool[27](i9 => p0);
				var v132: array<T0> := new T0[14];
				var v133: T0 := new C3(f20);
				v132[382] := v133;
				var v134 := DC42(v133);
				v132[382] := if (false) then v133 else v134.cf81;
				globalState.f6 := p0;
				globalState.f5 := true || v60[288];
			} else {
				globalState.f6 := !v60[288];
				var v135: map<bool, int> := map[v60[288] := p1];
				var v137: map<bool, bool> := map[p0 := p0];
				var v138: multiset<map<bool, bool>> := multiset{v137};
				var v139: multiset<int> := multiset{p1 + p1, p1 - p1, p1, fm0(if (p0 in v135) then v135[p0] else p1, DC1(v61, |(map v136 : map<bool, bool> | v136 in v138 :: (v136) := (p1))|, fm52(p1, v117, p0, p0, globalState), p0, fm2(v62, p1, globalState)), globalState) % p1};
				...
				globalState.f17, v60[288], v139 := |v117| / p1, false, (v139 - v139) - fm56(p1, v60[288], p0, |v143|, globalState);
				var v144 := new C2(-|v117|);
				var v145: seq<int> := [p1, v144.f22];
				var v146: map<bool, seq<int>> := map[v60[288] := if (false) then v145 else seq(0x2ef, i10  => (v144.f22))];
				globalState.f17 := |v146|;
				v65[805] := p1 / |v63|;
				v65[805] := v144.f22;
			}
			
			var v148: map<bool, bool> := map[v60[288] := v60[288]];
			var v149: map<int, int> := map[|(map v147 : map<bool, bool> | v147 in [v148] :: (v147) := (p0))| / 0x25c := -p1];
			v149 := v149[|v117| := p1];
		} else {
			var v150 := DC8(false);
			v65[253] := p1;
			globalState.f17, v65, v150, v65[253], globalState.f18 := if (p0) then p1 else 0x2bd % p1, v65, v150, p1 % p1, -(|"llgtgcnr"| + (p1 * p1));
			...
			v65[253] := v65[253];
			if (f20.cf0) {
				globalState.f18 := (-v65[253] + v65[253]) * |v116|;
				var v153: array<set<bool>> := new set<bool>[9](i12 => DC1(v61, p1, {false}, v60[288], !v60[288]).cf3);
				var v154: set<bool> := {v60[288]};
				v153[977] := v154;
				v153[977] := if (p0) then v154 else v154;
				r1 := -(|v63| - p1);
				globalState.f5 := !v60[288];
				globalState.f17 := p1;
			} else {
				...
				globalState.f17 := |v64| % |v157|;
				globalState.f5 := p0;
				v60[288] := p0;
				var v158: map<bool, int> := map[p0 := -p1];
				var v159: multiset<int> := multiset{p1, p1};
				var v160: set<bool> := {v60[288], v60[288], false, v60[288]};
				var v161 := DC1(fm1(globalState), p1, v160, p0, v64[v65[253]]);
				v158 := v158[fm2(v62['e' := |v159|], fm0(v65[253], v161, globalState), globalState) := v65[253] * |v160|];
			}
			
		}
		
		var v162: set<bool> := {p0, p0};
		var v163 := DC1(v61, p1, v162, p0, v60[288]);
		var v164 := DC18(496, p1, v64[p1 := !p0], p0, fm0(p1, v163, globalState));
		r0 := multiset(v164.cf32[|v117| := fm2(v62, p1, globalState)]);
		r1 := p1 + p1;
		r2 := v61;
	}
	method m12(globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: set<seq<bool>>) {
		...
		var v4 := DC36(v2[|v3|]);
		var v5 := 'f';
		match ((if (v0) then v4 else v4).(cf68 := if (v0) then |v3[|v2| := v5]| else v1)) {
			case DC36(cf68) =>
				var v6: array<int> := new int[1](i0 => i0 % |map[v0 := v1]|);
				v6[266] := v1;
				v6[266] := cf68;
				globalState.f5 := v0;
			...
			case DC37(cf69, cf70, cf71) =>
				...
				if (true) {
					...
					v11[70] := if (v12.cf5) then {v14, v14, v14, v14, v14} else v15;
					var v16: seq<string> := [v3];
					var v17: seq<D5> := [v14, v14, v14];
					var v19: map<bool, set<D5>> := map[v0 := set v18 : D5 | v18 in v17 :: (v18)];
					globalState.f17, v8[710], v11[70] := --v1 - |v3|, map[v0 := v16[cf69]], (if (v0 in v19) then v19[v0] else v15) - (fm58(v0, v1, 'b', globalState)).cf87;
					v1 := v1;
					globalState.f18 := cf71;
				} else {
					var v20: seq<bool> := [v0, true];
					var v21: multiset<int> := multiset{|map[v20 := v0]|};
					globalState.f6 := v0 <==> (v21[|v20| := v1] !! fm56(|v3|, v0, v0, cf69, globalState));
					var v22 := DC28("xoox", cf69, !v0, v0, v0);
					globalState.f5 := v22.cf56;
					var v23 := new C1(cf70, f20);
					var v24: seq<seq<bool>> := [v20];
					var v25: array<seq<bool>> := new seq<bool>[29] [v20, v20, v20, [v0], v20, v20, [!v0], v20, v20, v20, v20, v20, [v0, v0], v20, [v0], v20, v20, [v0], v20, v20, v20, v20, v20, [v0], v20, v20, v24[cf70], v20, v20];
					var v26 := DC8(v0);
					...
					var v30: seq<string> := [seq(0x25a, i2  => (v5))];
				...
				v32 := v32;
			case DC38() =>
				var v33: multiset<char> := multiset{v5, v5, v3[-v1]};
				...
				v34[432] := fm0(0x27c, v35, globalState);
				var v36 := DC4(v1, v0, v0, v0);
				v34[432] := v36.cf8;
				globalState.f15 := v3 + (seq(-0x2a5, i4  => (v5)));
				var v37: map<int, bool> := map[-v34[432] := v0];
				...
				var v46: set<int> := {0x20e, v34[432]};
				var v47: array<map<int, bool>> := new map<int, bool>[26] [v37, v37, v37 + v37, v37 + v37, map v38 : int | (82 <= v38) && (v38 < 725) :: (v38 / v34[432]) := (v0), v37, v37, v37, v37, map[-v34[432] := v0], v37 + (if (|v37| in v39) then v39[|v37|] else v37), v37, map v40 : int | v40 in v2 :: (v40 * v34[432]) := (v0), v37, v37[v2[-v34[432]] := v0], map[v34[432] := v0], fm59(|v41|, globalState), v37, v37, v37, v42[|map[v34[432] := v0]|], if (v3 in v43) then v43[v3] else v37, v37 + v37, v37 + (map v44 : int | v44 in (map v45 : int | v45 in v46 :: (v45 + v1) := (seq(0x2d1, i5  => (|[v0, v36.cf10]|)))) :: (v44 - v1) := (false)), fm59(v1, globalState), v37 + v37];
				v47[681] := fm59(|v2|, globalState);
				v47[681] := v37;
			case DC35(cf67) =>
				...
				var v52: array<bool> := new bool[14] [v1 >= v1, fm60(0xef, globalState) !! cf67, !(if (if (|v51| in v48) then v48[|v51|] else false) then v0 else v0), |(seq(-0x2e5, i6  => (v5)))| !in cf67, v0, v0, !true, fm2(v50, v1, globalState), v0, !v0, !v0, v0, v0 && v0, v0];
				v52[733] := v0 in v51[v1 := v0];
				v52[733] := !v0;
				var v53: set<seq<bool>> := {v51 + v51, v51};
				r2 := v53;
				if (v52[733]) {
					v48 := v48[0x2c6 := v52[733]];
					v3 := ("bwf")[v1 := v5] + v3;
					var v54 := DC3(v3);
					globalState.f18, globalState.f18, globalState.f18 := v1, |(v3 + "ti")|, |v54.cf7|;
					var v55: multiset<bool> := multiset{v52[733]};
					var v56: seq<multiset<bool>> := [v55];
					var v57 := DC46(v56);
					var v58 := DC23(v3[|v57.cf91| := v5]);
					var v59: map<string, array<bool>> := map[v58.cf44 := v52];
					var v60 := DC31(v59, v1);
					var v61: set<D11> := {v60};
					var v62: seq<set<D11>> := [v61, {v60} * v61, v61 * v61, v61];
					v62 := [v61, v61] + v62;
					var v63: array<char> := new char[3] [v5, v3[|v3|], v5];
					...
					v66, globalState.f15, v1 := multiset{v1 % v1, |v3| / v1, v1}, v3 + ("lioncxx" + v3), -984;
					var v67: array<int> := new int[18](i7 => i7 + |map[v52[733] := |cf67|]|);
					r0 := v67;
					var v68: map<bool, bool> := map[v0 := false];
					var v69: multiset<bool> := multiset{v0, v68 == map[!v52[733] := fm2(v50, v1, globalState)]};
					v69 := v69 + v69;
					v67[382] := -0x38d;
					v67[382] := (v1 - v1) % (if (v1 in v66) then v66[v1] else v1);
					var v70: map<bool, multiset<int>> := map[v52[733] := v66];
					var v71: T0 := new C3(if (v52[733]) then fm57(|("vnmfxcv")[|v70| := v5]|, globalState) else DC0(v0));
					var v72 := DC42(v71);
					v71 := v72.cf81;
				}
				
				if (false) {
					globalState.f5 := v52[733];
					var v73: array<seq<int>> := new seq<int>[11](i8 => v2);
					v73[225] := v2;
					v73[225] := v2;
					globalState.f5 := (v51 + ([false, v0])[|v3| := true]) != v51;
					globalState.f6 := v52[733];
					...
					var v77 := DC1('t', v1, v76, v52[733], v0);
					globalState.f17 := (|map[v3 := v0]| / v1) + (v1 + fm0(v1, v77, globalState));
					var v78 := DC47(v1);
					globalState.f17 := v78.cf92 * v1;
					globalState.f6 := v52[733];
					var v79: map<bool, string> := map[v0 := seq(0x13d, i9  => (v5))];
					v79 := v79[v52[733] := v3];
					globalState.f6 := v52[733];
				}
		...
		v80[495] := (if (v5 in v81) then v81[v5] else |v83|) - v1;
		...
		var v88 := DC2(v84[true := v1]);
		var v89: multiset<char> := multiset{v5};
		v1, v80[694], v80[495], v0, v84 := v1, DC20(|v84|, v85[v1]).cf36, |fm46(|v87|, v0, v0, globalState)| % v1, (fm50(v0, v0, v88, globalState))[v1 := fm2(v89, v1, globalState)] != v85, v84;
		if (v1 < v80[694]) {
			...
			globalState.f6 := (v80[694] % v80[694]) != v1;
			var v91 := DC3(v3);
			var v92: map<bool, int> := map[v0 := v1];
			var v93: array<D2> := new D2[25] [v91, DC3(v3[-|v92| := v5]), v91, v91.(cf7 := v3[v1 := v5]), DC3(v3), fm61(v0, v0, |v3|, globalState), DC3(v3), v91, v91, v91, DC3(v3), v91, DC3("mjrkmdbrr"), DC3(seq(0x95, i10  => ('x'))), v91, v91, v91, v91, v91, v91.(cf7 := seq(0x399, i11  => (v5))), v91, v91, v91, v91, if (!v0) then fm61(v0, false, 0x169, globalState) else v91];
			var v94: set<int> := {v1};
			var v95 := DC35(v94);
			var v96: array<bool> := new bool[12];
			v80[694], v93, globalState.f6, v80[694], globalState.f4 := v1, v93, !(v95.cf67 <= {v1}), v80[694], v96;
			v1 := v1 - v80[694];
			match (v91) {
				case DC4(cf8, cf9, cf10, cf11) =>
					v96[449] := cf9;
		...
		var v111: map<bool, int> := map[v0 := v80[694]];
		var v112: set<int> := {|v111|, v80[694]};
		if (v112 <= v112) {
			var v113: array<bool> := new bool[10];
			var v114 := DC39(v113);
			var v115 := DC39(v114.cf72);
			var v116: array<array<bool>> := new array<bool>[17] [v113, if (v0) then v113 else v113, (v115.(cf72 := v113)).cf72, v113, v113, v113, v113, v113, v113, v113, v113, if (fm2(v89, v80[694], globalState)) then v113 else v113, v113, v113, v113, v113, v113];
			...
			if (false) {
				...
				var v119 := DC1(v5, v80[694], v118, true, true);
				var v120 := DC5(fm2(v89, fm0(|v111|, v119.(cf2 := v80[694], cf3 := v118), globalState), globalState), v1);
				globalState.f18 := v120.cf13;
				globalState.f5 := v0;
				v80[694] := v80[694] / (v1 + v1);
			} else {
				v113 := v113;
				var v121: map<bool, bool> := map[v0 := v0];
				var v122: map<int, bool> := map[|v121| := v0];
				var v123: map<int, seq<bool>> := map[v1 := [!(if (v80[694] in v122) then v122[v80[694]] else true)] + v85];
				globalState.f17 := |(if ((v1 / -|v2|) in v123) then v123[v1 / -|v2|] else v85[v1 := v0])|;
				v113[470] := v0;
				v113[470] := true;
				var v124: set<bool> := {v113[470]};
				var v126: seq<map<int, bool>> := [map v125 : int | v125 in v2 :: (v125 / v80[694]) := (v113[470]), v122, v122, v122, (v122[v80[694] := v113[470]])[v1 := v113[470]]];
				v84, globalState.f18, v113[470] := v84[-837 > |v124| := |v126|], (v80[694] / 217) % v1, !v0;
				var v127: map<int, int> := map[v1 := |v3|];
				globalState.f5 := (if (v1 in v127) then v127[v1] else v80[694]) == -v80[694];
			}
			...
			globalState.f17 := (if (!v0) then v1 else v80[694]) - v1;
			v80[694] := v1;
			v0 := v0;
			v85 := v85[v1 := v0 <== v0];
			var v130: map<map<int, int>, string> := map[map[v80[694] := v1] := fm46(v80[694], v0, v0, globalState)];
			var v131: map<int, int> := map[|"lmgtb"| := |v3|];
			v130 := (fm63(v112, v80[694], globalState))[v131 := v3 + v3];
		}
		
		var v132 := DC40(!v0, seq(0x1b3, i12  => (v5)), seq(247, i13  => (v5)), true);
		globalState.f6, globalState.f6, v80[694], v80[694] := match v132 {
			case DC40(cf73, cf74, cf75, cf76) => cf76
			case DC41(cf77, cf78, cf79, cf80) => v0
			case DC39(cf72) => v85[0x3a7]
		}, v0, v80[694], v80[694];
		var v133: seq<string> := [seq(0x135, i14  => (v5))];
		var v134 := DC10(v133);
		...
		if (match v136 {
			...
			if (|v84| != (v1 * v1)) {
				...
				var v144: array<bool> := new bool[19] [v0, v0, v0, !(v137.f22 <= v137.f22), v0, fm2(v89, v80[694], globalState), v0, v0 <== v0, v0, !!v0, v0, v0, 161 < v137.f22, !true, v0, fm2(v89, v137.f22, globalState), v0, v143 > v143, v0];
				v144[590] := v0;
				var v145: set<bool> := {v0, v0, v0, !v0};
				v144[590] := if (v0) then if (v0) then v0 else v0 else v137.f22 >= |v145|;
			...
			v80[694] := 738;
			globalState.f18 := v80[694];
			globalState.f5, v84, v80[694] := v0, v84, v80[694];
			if (v0) {
				globalState.f6 := v0;
				var v147 := new C3(f20);
...
class C5 extends T0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
			...
			decreases 100 - i0
		{
			...
			if (!!true) {
				...
				var v5: map<set<int>, map<int, C1>> := map[(set v2 : int | (87 <= v2) && (v2 < 0x2fa) :: (v2 % |map[p0 := p1]|)) - {p1, p1} := v4];
				v5 := (v5 + v5) + v5;
				var v6 := "cimpundh";
				globalState.f18 := -|((fm34(p0, globalState) + v6) + v6)|;
				var v7 := new C1(p1 / p1, f20);
				var v8: map<bool, bool> := map[p0 := p0];
				var v9: map<int, char> := map[p1 := v1];
				var v10: map<map<bool, bool>, map<int, char>> := map[v8 := v9[|v6| := v1]];
				var v11: seq<seq<char>> := [seq(-0x1b9, i1  => (v1)), [v1, v1, v1]];
				var v12: map<map<map<bool, bool>, map<int, char>>, int> := map[v10 := -(|v11[p1]| % p1)];
				v12 := v12[v10 := -|v8|];
				var v13: array<bool> := new bool[5];
				var v14: multiset<int> := multiset{|(seq(638, i2  => (v1)))|, p1};
			...
			decreases 100 - i4
		{
			...
			var v38: array<set<map<int, bool>>> := new set<map<int, bool>>[21] [fm36(0x1ab, globalState) * v29, if (fm2(v31, 0x60, globalState)) then {map[|v0| := p0], v28, map v32 : int | (0x1ae <= v32) && (v32 < 306) :: (v32 % p1) := (p0)} else v29, v29 * fm36(p1, globalState), v29, if (p0 in v33) then v33[p0] else v29, v29, v29, {v28, v28}, {map v34 : int | (0xae <= v34) && (v34 < 0x38) :: (v34 * p1) := (p0)}, v29, v29, v29 * v29, v29 + v29, v29, v29, if (p1 in v35) then v35[p1] else v29, fm36(p1, globalState), v29, set v37 : map<int, bool> | v37 in v36 :: (v37), v29, {v28, map[p1 := p0]}];
			v38[496] := if (p1 in v35) then v35[p1] else v29;
			...
			v38[496] := {v28, v28, map[|v41| := p0], v42[|map[p1 := false]|], v28} - v43[p1];
			var v44: seq<bool> := [p0];
			var v45: seq<seq<bool>> := [v44];
			v45 := v45;
			var v46: array<D4> := new D4[14](i5 => DC10([seq(0x214, i6  => (v30))]));
			v46 := v46;
		}
	...
	method m10(p0: seq<bool>, p1: map<map<int, bool>, int>, globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			globalState.f6, v20, globalState.f6 := (v0 + |[v1[v0]]|) > DC5(v6, |{|(v21.(cf44 := v14)).cf44[v0 := v8]|, v0, v0, |v22[v6 := v6]|, |v24|}|).cf13, v20 + fm40(v6, -fm0(v0, v13, globalState), v25, globalState), !v6;
			var v28: seq<seq<bool>> := [[v6], v20];
			var v29: seq<seq<bool>> := [v28[-v0] + v20];
			...
			if (v6) {
				...
				v23[569], v40[538], globalState.f6, globalState.f6 := 0x0, fm1(globalState), v6, v41 !in map[v41 := v0];
				v41[928] := v6;
				var v42: array<D6> := new D6[5](i6 => DC16(map[v1 := !false]));
				var v43: map<seq<int>, bool> := map[v1 := v6];
				var v44 := DC16(v43);
				v42[661] := v44.(cf27 := v43);
				...
				v47[413] := v45 + map[v6 := v41];
				v41[928], globalState.f18, v42[661], v23[569], v47[413] := !(if (|[v6, true]| == v35.f22) then v6 else v6), |v25[fm0(v0, v13.(cf5 := v6, cf1 := v8), globalState) := v0]|, if (v6) then v44 else v44, v23[569], v45 + v45;
				...
				v49[122] := v51;
				var v52 := DC26(seq(-0x1f8, i7  => (|v12|)));
				var v53: seq<C1> := [v48];
				v1, v48, v49[122] := v52.cf49, v53[|v14|], if (v41[928]) then v51 else v51;
			}
	...
	method m11(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool) {
		...
		if (v0 >= v0) {
			if (p0) {
				...
				v13[475] := 0x2ff;
				v12, v13[475], globalState.f18, v9 := v12.(cf75 := v11, cf74 := v11 + v11), v0, v0, v9;
				v8 := v8;
				var v14 := 'x';
				v14 := p1;
			...
			v15[116] := -v0;
			var v16 := "ldhia";
			v0 := |(v16 + v16)| * (v15[116] - v15[116]);
			var v17 := DC5(p0, v0);
			var v18: array<bool> := new bool[9] [p0, false, p0, p0, v15[116] >= v15[116], p0, p0, p0, v17.cf12];
			v18[307] := !true <==> p0;
			globalState.f17, v18[307], globalState.f5 := v15[116] + v15[116], false, p0;
			globalState.f17 := v0;
		} else {
			...
			v19[384] := if (p0) then v0 else |(v20 - v20)|;
			globalState.f5 := p0;
			var v21: map<int, bool> := map[v0 := p0];
			var v22: seq<map<int, bool>> := [v21 + v21];
			var v23: multiset<int> := multiset{v19[384]};
			var v24: seq<bool> := [p0, false, p0];
			v22 := fm64(v23 + multiset{v19[384], v0}, false, v24 + v24, globalState);
			globalState.f5 := !true;
		}
		...
		v25[587] := if (if (p0 in v26) then v26[p0] else p0) then v27 else v27;
		...
		match (v31) {
			case DC47(cf92) =>
				...
				cf92, v32 := 0x241, ([cf92, |[cf92, v0, v0, v0]|, cf92, -0x3bd])[v0 := -|v33|];
				var v34 := "axwcrc";
				...
				match (DC9(DC9(v35))) {
					case DC8(cf16) =>
						...
						v36 := v36;
						var v37: array<int> := new int[13](i0 => i0 / cf92);
						v37[161] := cf92;
						v37[161] := cf92;
					...
					case DC7(cf15) =>
						...
						var v42: array<string> := new string[22] [v34, v34 + v34, v34, "ajw" + v34, v34, v34 + "qbt", seq(629, i1  => (p1)), v34, v34, v34 + v34, v34, v34[v0 := p1] + v34, "i", v34, "mfpc", v34, v41.cf75, fm34(p0, globalState), v34, seq(0x22, i2  => (p1)), if (p0) then v34 else v34, v34 + fm46(cf92, p0, p0, globalState)];
						v42 := v42;
					...
					case DC9(cf17) =>
						...
						var v55: array<string> := new string[23] [v34[-|v51| := p1], v34, fm46(v0, p0, fm2(v53, -v0, globalState), globalState) + v34, v34 + (if (p0 in v54) then v54[p0] else v34), v34, (seq(0x1b3, i3  => (p1))) + v34, v34, v34, v34, "pnlyxkoeu", v34, v34, ("ful")[cf92 := p1], v34, v34, v34, v34[v0 := p1] + "iwhfwhvp", seq(0x232, i4  => (p1)), v34, v34, fm34(p0, globalState), v34, v34 + v34];
						v55[565] := v34;
						v55[565] := v34;
			...
			case DC48(cf93, cf94) =>
				...
				globalState.f5 := 'y' !in (v59[v64[v0] := p1] + v59);
				r0 := p0;
			case DC46(cf91) =>
				var v65 := "bng";
				globalState.f15 := (seq(577, i6  => (p1))) + (("yupxlchu")[v0 := p1] + v65);
				var v66 := new C4(f20);
				if (p0) {
					var v67: set<bool> := {p0};
					...
					var v80: set<int> := {v0};
					globalState.f18 := (v0 / |v80|) - (v0 % v0);
					var v81: set<bool> := {p0, p0};
					var v82 := DC1(p1, v0, v81, p0, !p0);
					v65, v0 := (((if (p0) then v65 else v65[v0 := p1]) + v65)[|v78.f24| / -|v65| := p1])[v0 := p1], fm0(v0, v82, globalState);
				}
		...
		match (match if (p0) then v85.(cf26 := v84) else v85 {
			...
			case DC28(cf52, cf53, cf54, cf55, cf56) =>
				...
				v90[985] := if (cf56) then fm2(v93, cf53, globalState) else !false;
				v90[985] := fm2(v93, -(cf53 / v0), globalState);
				var v94: set<bool> := {cf54};
				var v95 := DC1(p1, -v0, v94, false, cf54);
				v0, globalState.f17 := v95.cf2, v0 % v0;
				var v96 := 'g';
				v96 := v96;
			case DC26(cf49) =>
				globalState.f17 := v0;
				...
				globalState.f18, globalState.f6, v97, v98[479] := (v101.cf21 + --|v102|) + v0, p0, p1, v99 + v103.cf75[v0 := p1];
				globalState.f16 := v98[479];
				var v104: array<int> := new int[26](i10 => i10 + v0);
				var v105: multiset<int> := multiset{v0};
				v104[258] := |(v105 * fm56(v0, p0, p0, v0, globalState))|;
				var v106 := DC28(v98[479], if (v0 in v105) then v105[v0] else v0, p0, p0, p0);
				v104[258], v98[479], globalState.f17, globalState.f18, globalState.f5 := |{|cf49[v0 := if (v0 in v102) then v102[v0] else v0]|, v0, v0 + v106.cf53, v0, v0 * |cf49|}|, v98[479][v0 := v97] + v98[479], v0, v0, p0;
			case DC29(cf57) =>
				...
				var v108 := "wfvvh";
				var v110: map<int, map<int, bool>> := map[|v108| := map v109 : int | (0x2c6 <= v109) && (v109 < 213) :: (v109 % v0) := (p0)];
...
class C6 extends T0 {
	...
	function fm24(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): bool {
		!(if (-661 > |{|[true]|, |DC10(seq(0x2ec, i0  => (seq(14, i1  => ('e'))))).cf18|, |map[false := |"qo"|]|, |{'q'}|}|) then true else !((seq(-184, i2  => ('c'))) == "flulwi"))
	}
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		var v0: map<int, int> := map[p1 := |(seq(0x20d, i1  => ('o')))|];
		var v1 := "ivofje";
		var v2: seq<string> := [v1, "w", v1];
		var v3 := DC10(v2);
		var v4: set<D4> := {v3, v3};
		for i0 := -(if (p1 in v0) then v0[p1] else p1) to p1 % |v4| {
			...
			if (v6 !! v6) {
				...
				var v10: seq<multiset<int>> := [multiset{i0}, v9[p1]];
				...
				v14, globalState.f5, globalState.f16, v15[818] := fm26(if (p0) then p0 else p0, globalState), p0, fm27(-p1, v6, if (p0) then |v16| else i0, fm28(globalState) + v17, globalState), !!(!p0 && p0);
				var v18 := DC4(i0, p0, true, v15[818]);
		...
		if ((set v28 : int | (0x60 <= v28) && (v28 < 218) :: (v28 * |multiset{'x'}|)) > v29) {
			...
			var v32: array<bool> := new bool[20] [v30[p1], if (p0 in v31) then v31[p0] else p0, p0, p0, p0, p0, p0, p0, p0, p0, p0, p0, false, p0, p0, p0, true, p0, p0, p0];
			globalState.f17 := (p1 / p1) % |[v32]|;
			...
			v33[813] := v34[v1 := map[fm0(p1, DC1(v35, 0x163, v36, p0, !p0), globalState) := 0x161]];
			v30 := v30;
			globalState.f6 := !p0;
			v35 := v35;
		} else {
		...
		var v52: set<bool> := {p0, fm2(v51[v50 := 966], p1, globalState)};
		...
		var v57: multiset<bool> := multiset{!p0, v56[p1]};
		r1, globalState.f5, v48[659], v49, r0 := p1 * p1, p1 < p1, match v54 {
		...
		v58[439] := v59;
		v58[439] := {v48, v48, if (p0) then v48 else v48, v48};
	...
	method m8(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: T1, r1: bool, r2: array<int>) {
			...
			decreases 100 - i0
		{
			...
			var v1: multiset<bool> := multiset{p1, v0[p0]};
		...
		if (p1) {
			...
			var v14 := DC1(v12, p2, {true, p1}, v13[p2], !p1);
			...
			v11, globalState.f17, v17, v18[15], globalState.f18 := (v11 + v11) + v11, |v20|, if (p1) then v17 else v17 + v17, p1, 0x36b;
			var v21 := "tjrergf";
			var v22 := DC3(v21);
			match (v22) {
				case DC4(cf8, cf9, cf10, cf11) =>
				...
				case DC5(cf12, cf13) =>
					v13 := v13;
					globalState.f4 := new bool[8] [cf12 <== v18[15], if (false) then fm2(multiset(v21), cf13, globalState) else fm24(p1, p1, p0, p0, globalState), if (v18[15]) then v18[15] else p1, v14.cf4, cf13 != fm0(p0, DC1(v12, cf13, v8, v18[15], p1), globalState), !p1, p1, cf12 <==> cf12];
					var v27: set<int> := {|v15|, p0};
					globalState.f17, globalState.f6 := |v21| % 0x3dd, {cf13, p2, p0} > v27;
					globalState.f17 := p0;
				case DC3(cf7) =>
					v16[617] := |(cf7 + cf7)|;
					v16[617] := p0;
					var v28: multiset<char> := multiset{v12};
					v18[15] := fm2(v28, p0, globalState);
					var v29: array<int> := new int[23];
					var v30: multiset<array<int>> := multiset{v29, v29, v29, v29};
					v30 := v30;
					var v31 := DC4(v16[617], v18[15], v18[15], p1);
					var v32: seq<array<bool>> := [v18, v18];
					var v33: map<int, bool> := map[p2 := v18[15]];
					var v34: array<D2> := new D2[21] [DC4(fm0(p0, v14, globalState), p1, p1, p1), v31, v31.(cf10 := p1, cf9 := v18[15]), v31.(cf11 := v18[15]), v31, v31, DC4(|cf7|, v18[15], p1, v18[15]), v31, v31.(cf10 := p1, cf11 := !p1).(cf8 := |v32|), DC4(p0, false, p1, p1), v31, v31, v31, fm32(p1, map[|DC13(v33).cf24| := p2], globalState), v31, v31, v31, v31, v31, v31, v31];
					var v35: map<array<D2>, int> := map[v34 := v16[617] + p2];
					v35 := v35[v34 := p0];
				case DC6(cf14) =>
					var v36 := DC4(p2, v18[15], p1, p1);
					var v37: seq<D2> := [v36, v36, v36];
					var v38: seq<array<bool>> := [v18, v18];
					var v39: map<bool, bool> := map[v18[15] := p1];
					var v40: map<int, map<bool, bool>> := map[p2 := v39];
					globalState.f18, globalState.f17, v18[15], globalState.f18, globalState.f17 := p2, --((fm0(p0, v14, globalState) * |v37|) % (931 + -p0)), |v21| > p2, p2 % (p2 * p0), |(v38[|(if (p2 in v40) then v40[p2] else v39)| := v18])[p0 := v18]| - fm0(p2, v14, globalState);
					var v41: map<string, bool> := map[v21 := false];
					var v42: multiset<char> := multiset{v12};
					var v43: seq<int> := [p2];
					globalState.f17, v41, globalState.f5, globalState.f18 := -p0 / -p2, v41 + map[v21 := v18[15]], fm2(v42, -(p2 / |v43|), globalState), p2 * p2;
					globalState.f5 := v18[15];
					var v44: map<seq<int>, bool> := map[seq(-0x1f, i3  => (|[p1, !v18[15], v18[15]]|)) := v18[15]];
					var v45 := DC16(v44);
					v44 := v45.cf27;
			}
			...
			v16 := v16;
			v18[15] := v13[p2 % p2];
			var v46: array<D6> := new D6[17](i4 => DC18(p2, p0, v13, v18[15], p2));
			var v47: map<int, bool> := map[|v21| := v18[15]];
			var v48 := DC18(p0, |v13|, v13, fm24(p1, p1, p2, -|v47|, globalState), p2);
			v46[247] := v48;
			var v49: map<bool, bool> := map[v18[15] := p1];
			var v50: multiset<bool> := multiset{p1, p1};
			var v51: set<int> := {0x14d};
			var v52: map<set<int>, string> := map[v51 := "ubacpbltn"];
			globalState.f17, v46[247], globalState.f17, v21 := (p2 % -p2) - p2, v48.(cf31 := |v49| / |v50|), p0, (if ({p2, p0} in v52) then v52[{p2, p0}] else v21) + v21;
		} else {
			var v53: seq<bool> := [p1, p1];
			globalState.f5 := !(p1 ==> (v53 == v53));
			var v54 := "bv";
			var v55: multiset<string> := multiset{(seq(0x2f8, i5  => ('e'))) + v54, v54, v54};
			...
			v60[489] := p0 >= p2;
			v60[489] := fm2(multiset{'k'}, p0, globalState);
			if (v60[489]) {
				var v61: array<string> := new string[16];
				v61 := v61;
				var v62: multiset<bool> := multiset{false, v60[489], p1, v60[489]};
				var v63: seq<D1> := [DC2(v62)];
				var v64: map<bool, seq<D1>> := map[v60[489] := v63];
				globalState.f5, v60[489], globalState.f18, v63 := v53[p2], fm33(globalState) !! multiset(v57), |v62| * p0, if (v60[489] in v64) then v64[v60[489]] else v63[p2 := DC2(v62)];
				var v65: map<bool, int> := map[p1 := p2];
				var v66 := 'p';
				var v67: array<int> := new int[11];
				var v68 := DC21(v57[fm0(-|v65|, DC1(v66, p2, {v60[489]}, v60[489], v60[489]), globalState)], v60[489], p1, v67, p1);
				var v69: map<array<int>, int> := map[v68.cf41 := |v57|];
				v69 := v69[v67 := v57[p0]];
				r1 := p1;
				var v70: map<int, bool> := map[|v57| := p1];
				var v71 := DC4(p0, v60[489], p1, p1);
				var v72: map<int, D2> := map[|v70| := DC6(v71)];
				var v73 := DC1(v66, p0, v8, v60[489], p1);
				...
				var v76 := new C2(p0);
				v54 := v54;
				var v77 := DC2(multiset{v60[489]});
				var v78: multiset<bool> := multiset{v60[489], v60[489]};
			...
			if (v57 != v57) {
				...
				var v87: array<int> := new int[27](i7 => i7 / v86.f22);
				var v88: multiset<array<int>> := multiset{v87};
				var v89: map<multiset<array<int>>, bool> := map[v88 := fm24(false, fm24(!v60[489], p1, p0, p2, globalState), p0, p0, globalState)];
				v89 := v89[v88 := p1];
				var v90, v91, v92 := v86.m2(p1, -v86.f22, v60[489], p2, globalState);
				var v93: seq<set<bool>> := [v8];
				var v94 := new C2(|v93|);
			} else {
				var v95: array<int> := new int[12];
				var v96: map<bool, array<int>> := map[v60[489] := v95];
				globalState.f5, globalState.f15, r2 := p1, "gka", if ((p1 || v60[489]) in v96) then v96[p1 || v60[489]] else v95;
				v95[937] := if (v60[489]) then p0 else -0x36b;
				var v97 := DC8(false);
				var v98: map<D3, bool> := map[v97 := p1];
				var v99: set<map<D3, bool>> := {v98, v98, v98, v98};
				v95[937] := |v99|;
				m9(v60[489], p1, v60[489], |v57|, globalState);
				v95[937] := p2;
				globalState.f18 := p2 % v95[937];
			}
		...
		var v102: map<int, map<int, seq<int>>> := map[p0 / p2 := v101];
		v102 := v102[p0 := map[v100[0x282] := v100]];
		if (p1) {
			globalState.f18 := p0;
			...
			if (p1) {
				...
				var v110: multiset<seq<bool>> := multiset{if (!v109[--p0]) then v109 else v109};
				var v111 := 'w';
				var v112: array<char> := new char[10](i8 => v111);
				var v113 := DC49(v112);
				var v114: set<D18> := {v113};
				v110, globalState.f16, globalState.f15, globalState.f17 := v110 + v110, "dg", v107[p0 + p0 := v111], p2 - (721 - |v114|);
				...
				v118[666] := v120;
				v118[666] := (if (p1) then v120 else v120) + v120;
				v110 := (v110 * v110)[v109 := p2];
			} else {
				globalState.f6 := (v103 < {0x170}) && p1;
				globalState.f4 := v106;
				var v121: map<int, int> := map[p0 := p2 + p0];
				v121 := v121[p2 * p2 := p0];
				var v122: array<int> := new int[1](i9 => i9 % p0);
				v122[921] := |v103|;
				v106[406] := p1;
				var v123: multiset<int> := multiset{p0};
				r1, v122[921], globalState.f5, v106[406], v123 := p1, p2, p1, true, v123;
				v122[921] := |v8|;
			}
			...
			globalState.f17 := -|(seq(135, i10  => (if (p1) then [p1] else [p1])))|;
			var v125: seq<bool> := [p1, true];
			var v126: multiset<int> := multiset{-|v125|};
			globalState.f17 := (if (-|v124| in v126) then v126[-|v124|] else 0x1f2) % p2;
			var v127 := 'm';
	...
	method m9(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := ((seq(-677, i1  => ('u'))) + "rfxx") + ((seq(-0x39b, i2  => ('v'))) + "lb");
		}
		globalState.f18 := -p3;
		...
		v1[760] := DC37(p3, p3, p3).cf71;
		var v6 := 'b';
		var v7: seq<char> := [v6, v6];
		var v8: seq<bool> := [p1, p0];
		var v9 := DC28(v7, 0x1db, p2, v8[-p3], p0);
		var v10 := DC1(v6, -0x28d, {p0}, p2, p2);
		var v11: map<seq<bool>, int> := map[fm29(globalState) := |v7|];
		v1[930], v5, globalState.f15, globalState.f6, v1[760] := p3 / p3, if (p2) then v5 else v5, v7, v9.cf55, (fm0(0x210, v10, globalState) / |{p0}|) * (if (v8 in v11) then v11[v8] else p3);
		...
		v12[181] := if (0xc5 in v14) then v14[0xc5] else p0;
		if (p2) {
			globalState.f18 := p3;
			...
			var v23 := DC33(v22, p3);
			v1[930] := fm0(v23.cf63, v10, globalState);
			var v24: C2 := new C2(v1[930]);
			v24 := v24;
			globalState.f5 := p2;
		} else {
			var v25: array<map<int, int>> := new map<int, int>[26](i4 => map[p3 := v1[930]]);
			var v26 := DC25(v1[930], p3, v25);
			var v27: multiset<int> := multiset{v26.cf47};
			var v28: map<bool, int> := map[v27 != v27[p3 := p3] := v1[930]];
			v28 := v28[fm2(multiset{v6}, v1[930], globalState) <==> v12[181] := p3];
			if (p0) {
				v12 := if (if (p1 in v13) then v13[p1] else v12[181]) then v12 else v12;
				var v29: map<seq<char>, array<bool>> := map[v7 := v12];
				globalState.f4 := if (v7 in v29) then v29[v7] else v12;
				globalState.f18 := v1[930];
				var v30 := new C1(v1[930], f20);
				globalState.f6 := p0;
			} else {
				globalState.f17 := v1[930];
				globalState.f5 := p2;
				...
				v33[524] := v34;
				v33[524] := if (p0) then v34 else v34;
				globalState.f6 := if (p2) then p2 else p1;
			}
			
			var v35: seq<int> := [v1[930]];
			v35 := ([-v1[930]] + v35)[-|map[p3 := fm24(p1, p2, p3, p3, globalState)]| + |v35| := -0x342];
			var v36: multiset<bool> := multiset{p0};
			var v37 := DC50(true);
			var v38 := DC51(v37);
			var v39: seq<D18> := [v37, v37];
			var v40: seq<D18> := [v38, DC51(v37), DC51(v39[v1[930]])];
			globalState.f18 := if ((v40 < v40) in v36) then v36[v40 < v40] else v1[930] % v1[930];
			match (DC5(p2, 100 / p3)) {
				case DC4(cf8, cf9, cf10, cf11) =>
					v7 := v7;
					globalState.f17 := cf8;
					...
					globalState.f17 := (-|{v8[v1[930] := v12[181]]}| * fm0(|v41|, v10, globalState)) - cf8;
				case DC5(cf12, cf13) =>
				...
				case DC3(cf7) =>
					...
					globalState.f16 := cf7;
					var v45: set<int> := {|v36|};
					var v46: map<set<int>, int> := map[v45 := v1[930]];
					cf7 := ("iemm" + (fm27(0x192, v27, p3, v46, globalState))[v1[930] := v6])[v1[930] % v1[930] := v6];
					var v47 := DC14(p2);
					var v48 := DC15(v47);
					v48 := v48;
				case DC6(cf14) =>
					...
					var v50: map<seq<map<int, bool>>, string> := map[v49 := if (v12[181]) then v7 else v7];
					v50 := v50[fm64(v27, v12[181], v8, globalState) := v7];
					var v51: map<int, int> := map[v1[930] := v1[930]];
		...
		var v54: map<int, map<int, bool>> := map[v1[930] := map[v1[930] := v12[181]]];
		var v55: map<int, map<int, map<int, bool>>> := map[p3 := v54];
		v12[181] := (if (|v14| in v55) then v55[|v14|] else v54) == (v54 + v54);
	}
}
...
class C7 extends T0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		if (p0) {
			...
			if (p0) {
				...
				var v21 := 'g';
				var v22: array<int> := new int[13] [|v13|, v11.f21, p1, v11.f21, p1, |v6| % p1, if (v11.f21 in v15) then v15[v11.f21] else p1, |v19| / v11.f21, -(-(fm67(|v20|, v21, f26, !p0, globalState)).cf63 / v11.f21), v11.f21, v11.f21, p1 + 740, v11.f21];
				v22[693] := v11.f21 + v11.f21;
				var v23: multiset<multiset<int>> := multiset{v15[-0xc8 := v11.f21], v15, v15};
				var v24: map<bool, multiset<int>> := map[f26 := multiset{|v15|, |v1|}];
				v22[693] := if (v15 in v23) then v23[v15] else p1 - -|v24|;
				v20 := v20;
				globalState.f17 := v11.f21;
				var v25: set<int> := {0x163};
				var v26: map<bool, set<int>> := map[p0 := v25];
				v16[906] := !f26;
				v26, globalState.f18, v16[906] := map[p0 := {v11.f21, -v22[693], v11.f21}], v22[693] + v22[693], true;
			} else {
				var v27: map<bool, string> := map[f26 := seq(512, i1  => ('e'))];
				var v28 := "ne";
			...
			if (v33 >= multiset(if (f26) then v34 else v34)) {
				...
				globalState.f18 := -p1 % (if (v35 in v36) then v36[v35] else p1);
				var v37 := 't';
				...
				globalState.f6 := fm2(v38 + v38[v37 := |v40|], |v41|, globalState);
				...
				v43[880] := v40 <= v40;
				globalState.f17, v43[880] := (p1 / p1) * p1, !f26;
				...
				var v52: seq<int> := [-428];
				v50, globalState.f18 := (v51[p1] + v50) + v50, -(|(set v53 : int | v53 in v52 :: (v53 * -0x1dc))| % |(v33 * v33)|);
				var v54 := DC26(v52);
				r1, v52 := -0x30d, v54.cf49[|v33| + p1 := p1];
				var v55: array<string> := new string[16] ["xysq" + v49, v49 + "bcrcl", v49, v49, v49, v49 + v49, v49 + v49, v49, "uej" + v49, v49[|v49| := v47], "x" + (seq(0x319, i2  => (v49[p1]))), v49, v49, fm34(p0, globalState), v49 + v49, v49];
				var v56: seq<string> := ["gnpba", v49, v49[p1 := v47], v49, fm34(f26, globalState)];
				v55[622] := v56[|v34|];
				v55[622] := ((seq(0x197, i3  => (v47))) + v49) + v49;
			}
			
		} else {
			var v57: array<int> := new int[22](i4 => i4 - 0x131);
			var v58: seq<bool> := [f26];
			var v59: map<bool, array<int>> := map[v58[p1] := v57];
			var v60: seq<array<int>> := [v57];
			var v61: map<int, array<int>> := map[p1 := v57];
			var v62: array<array<int>> := new array<int>[11] [v57, v57, v57, if (p0 in v59) then v59[p0] else v57, v57, v57, v57, v57, v60[p1], if (|(seq(-0x198, i5  => ('s')))| in v61) then v61[|(seq(-0x198, i5  => ('s')))|] else v57, v57];
			v62[635] := v57;
			v62[635] := v57;
			var v63 := "kajyo";
			globalState.f6 := v63 != v63;
			var v64 := 'j';
			var v65 := DC23(v63[p1 := v64]);
			globalState.f18, v65 := p1, v65;
			globalState.f5 := false;
			var v66 := DC48(!v58[|multiset{|fm59(p1, globalState)|, p1}|], p0 <==> f26);
			v66 := v66;
		}
			...
			decreases 100 - i7
		{
			...
			if (p0) {
				...
				v67, globalState.f6 := (v67 + v67)[f26 ==> f26 := v74 < v74[p1 := p1]], (v75 >= v75) <== f26;
				v71[486] := 0x165;
				var v76: map<int, int> := map[p1 := p1];
				v71[486] := if ((p1 + p1) in v76) then v76[p1 + p1] else |v69|;
			} else {
				...
				var v83: array<string> := new seq<char>[24] [v69, v69, v69, v69 + v69, v69, v69, v69 + v69, "idylssf" + "cbvimle", seq(0x2dd, i8  => ('e')), v69, v82[-p1] + v69, v69, "pe" + v69, if (true) then v69 else v69, v69, v69, (v69[p1 := v68])[p1 := 'a'], v69, v69, v69 + "opvcfjgy", v69 + v69, fm34(f26, globalState), "qvhgvptst" + v69, v69];
				v83[811] := fm34(p0, globalState);
				v69, v81, globalState.f16, v83[811], globalState.f6 := (v69 + "nmjpw")[p1 := 'c'] + (v69 + v69), v81, fm34(p0, globalState), v69, p0 || (f26 <== p0);
				v79.f23[23] := f26;
				v79.f23[23] := ((if (v68 in v70) then v70[v68] else p1) >= p1) || f26;
				var v84: array<array<int>> := new array<int>[7];
				v84[922] := v71;
				var v85: multiset<int> := multiset{|multiset(v77)|, p1};
				var v86 := DC47(p1);
				var v87: set<int> := {p1};
				v84[922] := new int[13] [p1, p1 + fm0(p1, DC1(v68, p1, v72, p0, p0), globalState), -(p1 % p1), p1, |v85|, p1, p1, p1 / p1, p1, |multiset{p0, f26}|, p1, v86.cf92, if (f26) then 0x29f else if (p1 in v85) then v85[p1] else |v87|];
			}
			
			globalState.f18 := if (p0) then |(v69 + "hewnmccek")| else p1 / p1;
		}
		var i9 := 0;
		while (f26)
			decreases 100 - i9
	...
	method m6(globalState: GlobalState) returns (r0: int, r1: array<bool>) {
			...
			decreases 100 - i1
		{
			...
			var v19: array<bool> := new bool[17] [f26, if (v10 in v11) then v11[v10] else !f26, true, fm2(v12['x' := v2], -v2, globalState), f26, f26, f26, v14.cf96, fm2(multiset{v10, v10}, |v13|, globalState), false <==> f26, f26, f26, f26, false, (seq(687, i2  => (v10))) == fm27(fm0(|map[f26 := v2]|, DC1(v10, v2, v15, f26, f26), globalState), v9, |(set v16 : int | (-0x6d <= v16) && (v16 < 517) :: (v16 + 0x3a7))|, v18, globalState), f26, f26];
			globalState.f6, r1, v2, v7[948] := !(v9 < v9), v19, --(v2 * v2), if (f26) then v8 else v8;
			...
			if (true) {
				...
				var v25 := "pdkxbsgd";
				v7[948][718], v22, v23, v24, globalState.f6 := |(multiset{f26, f26, f26} * v6)|, map[DC26(v20) := false] + ((fm68(v2, v2, v25, |fm51(globalState)|, globalState))[v21 := !false] + v22), v23 + v23, v24, f26;
				var v26 := DC19(v8);
				...
				v28 := v28[fm34(f26, globalState) + v25 := v29[v7[948][718]]];
				...
				v32[623] := v10;
				v32[623] := if (f26) then v10 else fm1(globalState);
				globalState.f5 := (f26 || f26) in v13;
				globalState.f17 := (v2 * v2) % v2;
				globalState.f5 := f26;
				var v33: seq<int> := [if (v2 in v9) then v9[v2] else v2];
				v8[238] := if (f26) then v2 else |v33|;
				v8[238] := (v2 + |v33|) % (v2 % |v3|);
			}
		...
		var v42: array<bool> := new bool[24] [f26, f26, v34[|v35|], f26, if (f26) then f26 else true, f26 <==> f26, fm2(v37, v2, globalState), f26 <== f26, f26, f26, f26, f26, f26, f26, f26, v34[v2], fm2(v37, |v38|, globalState), f26, v39 !in v40, v41 >= v41, false, f26, f26, f26];
		v42[979] := f26;
		...
		for i4 := v2 to |v46| {
			globalState.f17, globalState.f5, v42[979] := i4 / i4, !v42[979], (if (f26) then v36 else v36) in v35;
			var v47: multiset<set<bool>> := multiset{v43, v43 * v43};
			var v48: seq<set<bool>> := [{v42[979]}, v43];
			v47 := multiset(v48);
			var v49: map<int, seq<char>> := map[-0x325 := v35];
			var v50: map<int, seq<char>> := map[v2 % i4 := if (v2 in v49) then v49[v2] else v35];
			...
			match (v54) {
				case DC8(cf16) =>
					...
					v55 := v55 + map[v36 := 93];
					globalState.f6 := (if (v42[979]) then v2 else i4) > v2;
				...
				case DC9(cf17) =>
					v3 := v3[823 := -i4];
					v46 := v46;
					var v58: C1 := new C1(v2, DC0(v42[979]));
					var v59 := DC30(v58);
					v59 := v59;
					globalState.f5 := multiset{v42[979], f26, !v42[979]} >= fm30(f26, v35, globalState);
			}
	...
	method m7(p0: char, globalState: GlobalState) returns (r0: set<seq<int>>, r1: C0) {
		...
		var v3 := DC27(v2, |(seq(222, i1  => (p0)))|);
		match (if (f26) then v3 else v3) {
			case DC27(cf50, cf51) =>
				var v4: seq<int> := [cf51];
				var v5: set<bool> := {f26};
				var v6 := DC1(p0, cf51, v5, f26, f26);
				var v7: map<int, array<array<bool>>> := map[fm0(v4[cf51], v6, globalState) := v2];
			...
			case DC28(cf52, cf53, cf54, cf55, cf56) =>
				if (f26) {
					...
					v17 := v17[|((if (cf53 in v20) then v20[cf53] else v19) + v19)| := cf53 / cf53];
					var v21 := 'b';
					v21 := fm1(globalState);
					...
					var v27: set<map<int, int>> := {v24[cf53 := -cf53], v24, v24, map[|v25| := cf53], if (!cf55) then map v26 : int | (0x166 <= v26) && (v26 < -0x1cc) :: (v26 % cf53) := (cf53) else v24};
					var v28: seq<bool> := [cf54];
					globalState.f18, v27 := cf53, (v27 + v27) - (fm69(v28[cf53], globalState) * v27);
					var v30: map<int, seq<bool>> := map[cf53 := v28];
					var v31 := DC13(map v29 : int | v29 in v30 :: (v29 / cf53) := (DC8(cf55).cf16));
					var v34: map<int, bool> := map[0x26c := f26];
					var v35: array<D5> := new D5[19] [v31, DC13(map v32 : int | v32 in (set v33 : int | (130 <= v33) && (v33 < -0x295) :: (v33 - cf53)) :: (v32 % 0x1e) := (f26)), v31, DC13(v31.cf24), v31, DC13(v34), v31, fm70(cf55, false, globalState), fm70(cf56, cf55, globalState), v31, v31, v31, v31, fm70(cf55, cf54, globalState), v31, v31, v31, v31.(cf24 := map[-54 := false]), v31];
					v35[519] := v31;
					v35[519] := v31;
					var v36 := new C1(cf53, DC0(f26));
					var v37 := 'j';
					var v38: set<int> := {cf53};
					globalState.f5, v37, r1.f24 := ({cf53} * v38) > v38, v37, (v28[cf53 - cf53 := !cf54 && cf56])[cf53 - cf53 := cf54];
				...
				var v44: map<seq<D16>, array<bool>> := map[v40 + v40 := v41[if (cf53 in v43) then v43[cf53] else cf53]];
				v44 := v44;
				if (cf55) {
					...
					v0[324] := cf56;
					v0[324], globalState.f17 := cf56, 0x166;
					globalState.f6 := if (cf55) then cf55 else cf53 >= cf53;
					v0[324] := if (cf55) then cf54 else cf56;
					...
					var v49: map<int, bool> := map[v46[693] := cf56];
					v46[693] := |(v48 + DC18(cf53, -0x2c3, v48[cf53 := cf55], f26, |v49|).cf32)|;
				}
			...
			case DC26(cf49) =>
				...
				if (f26) {
					...
					v0[858] := v51 <= v51;
					v0[858] := f26;
					globalState.f18, globalState.f5 := v51, v0[858];
					var v53 := new C6(f20);
				} else {
					...
					var v58: set<int> := {v56 / v56, -|v57| % v56, v56 / v56};
					v58 := v58;
					...
					v61 := v61 - v61;
					var v62 := new C0(v0, (if (f26) then v57 else v57)[v56 := !f26]);
			...
			case DC29(cf57) =>
				...
				var v76 := DC43(v75, true, v67 % -v67, f26, DC8(f26));
		...
		v0[394], globalState.f6, v82[568], globalState.f6 := v88[0x260] != v86, v89.cf37, if (f26) then v84 else [v83], f26;
		var i5 := 0;
		while (f26)
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v90 := DC1(p0, v83, v85, f26, v0[394]);
			var v91: array<int> := new int[10] [fm0(v83, v90, globalState), v83, -v83, |v87|, v83, v83 - v83, -v83 % v83, v83, v83, v83];
			v91[327] := v83;
			v91[327] := v83;
			v0[394] := v91[327] <= -507;
			var v92: multiset<int> := multiset{v91[327]};
			var v93: seq<seq<char>> := [seq(-0xf8, i6  => (p0)), v87[0x2da := p0]];
			var v94: seq<bool> := [v0[394], !v0[394]];
			v0[394], globalState.f6, globalState.f6, v0[394], v92 := !(v93[-v83] < v87), f26, f26, v94[|v94|], v92;
			...
			decreases 100 - i7
		{
			...
			var v98 := DC34(v0[394], f26 <== v97[v83], v0[394]);
			match (v98) {
				case DC33(cf62, cf63) =>
					var v99: set<int> := {cf63};
					var v100: map<bool, int> := map[v0[394] := cf63];
					...
					v99, globalState.f5, v103, v82[568] := v99, f26, if (v0[394] in v104) then v104[v0[394]] else (if (f26 in v104) then v104[f26] else v103) * v103, v82[568] + v82[568];
					globalState.f6 := f26;
					var v105: array<seq<bool>> := new seq<bool>[1] [v97];
					var v106: multiset<array<seq<bool>>> := multiset{v105};
					var v107: seq<string> := [v87];
					var v108: seq<seq<string>> := [[v87, "vitgtypm", fm46(|(seq(0x3b4, i8  => (cf63)))|, v97[-cf63], v0[394], globalState)], v107];
					var v109: array<seq<string>> := new seq<string>[28] [fm72(f26, f26, if (v105 in v106) then v106[v105] else v83, globalState), v107, v107, ["ipce"], [fm34(f26, globalState)] + v107, v107 + [v87], [v87], v107, v107 + v107, v108[v83] + v107, v107, v107[cf63 := v87] + v107[v83 := "awjq"], ([v87])[|v85| := v87], fm72(fm2(multiset(v87), |v84[v83 := v83]|, globalState), v0[394], v84[-v83], globalState), v107[0x232 := v87], v107, v107, v107 + v107, v107, v108[cf63], v107, v107 + (seq(0x22d, i9  => (v87))), v107 + (seq(292, i10  => (v87))), v107, v107, v107, v107, (seq(0x182, i11  => (v87))) + v107];
					v109[102] := v107;
					v109[102] := v107[v83 := v87[v83 := p0]];
					globalState.f6 := v0[394];
				case DC34(cf64, cf65, cf66) =>
					...
					v111 := if (v83 in v112) then v112[v83] else v111[v83 := fm73(v97[v83], true, v83, v84[v83], globalState)];
				...
				case DC32(cf61) =>
					...
					var v118 := new C0(v0, (v97[v83 := f26])[870 := v97[|v117|]]);
					globalState.f17 := v83 % |v117|;
					...
					var v122: array<set<bool>> := new set<bool>[28] [v85, v85, v85, {f26, v0[394]}, v85, v85, v85, v85, v85, v85, v85, v85, v85, fm52(|v120|, v87, v0[394], false, globalState), v85, if (v83 in v121) then v121[v83] else {f26}, {v0[394], f26, f26}, v85, if (v83 in v121) then v121[v83] else {v0[394]}, v85, v85, v85, v85, v85, v85, v85, v85, v85];
					v119[231] := v122;
					v119[231] := new set<bool>[2] [v85, v85];
			}
			
			globalState.f18 := v83;
			var v123: multiset<bool> := multiset{f26, !f26, f26, v0[394]};
			v83 := |(multiset{!f26, fm2(multiset{v96.cf1}, |multiset{v0[394], f26, v0[394]}|, globalState)} - v123)|;
		...
		var v129: map<map<bool, bool>, bool> := map[v128 := v0[394]];
		var v130: array<multiset<int>> := new multiset<int>[18] [v126, multiset{|v82[568]|, 0x11d} - v126, v126, v126, multiset(v84), v126[v83 := v83], fm33(globalState), v126, v126, multiset{v83}, v126, fm56(v83, v0[394], !f26, v83, globalState), v126, v126 - (if (v87[|v87| := p0] in v127) then v127[v87[|v87| := p0]] else multiset{|(seq(0x303, i13  => (p0)))|}), multiset{v83, |v129|}, v126[-v83 := -v83], v126, v126];
		forall i12 | 0 <= i12 < v130.Length {
			v130[i12] := (v126 - v126) * multiset(v84);
		}
		var v131: multiset<char> := multiset{p0, p0};
		var v132: map<int, bool> := map[|(seq(-0x1d4, i15  => (v82[568])))| := fm2(v131, v83, globalState)];
		for i14 := v83 to |v132| {
			var v133 := new C2(i14);
			globalState.f18 := v83;
			var v134: set<int> := {fm0(-0x37d, v96, globalState), ---i14, fm0(v83, v96, globalState), v83, v84[v83]};
			v134, globalState.f17 := v134, v133.f22;
			var v135: map<bool, int> := map[v0[394] := v133.f22];
			var v136: array<seq<bool>> := new seq<bool>[10];
			var v137: seq<string> := [v87];
			var v138: map<D20, bool> := map[DC54(v133.f22, v136, i14, f26, |v137[v133.f22]|) := true];
			var v139: array<int> := new int[17](i16 => i16 * v133.f22);
			var v140: map<array<int>, bool> := map[v139 := v0[394]];
			var v141: array<int> := new int[22] [-i14, i14, |map[f26 := !f26]| % v83, 0x24e, if (v0[394]) then |v135| else fm0(i14, v96, globalState), v133.f22, |v87|, v133.f22 + fm0(v83, v96, globalState), v83, v83, v133.f22, if (v133.f22 in v126) then v126[v133.f22] else i14, v133.f22 + |v138|, 0x28f, |v87[v133.f22 := p0]| + |v140|, v83 % v133.f22, i14, 0x279, if (!f26) then i14 else |v128|, -0xca, fm0(v133.f22, v96, globalState), v133.f22];
			v139[337] := 0x9d;
			v139[337] := |v87| * 694;
		}
		var v142: set<seq<int>> := {[|v85|], v82[568], v84};
		r0 := v142;
		...
		var v147 := DC21(v83, f26, v0[394], v146, v0[394]);
		var v148: C0 := new C0(v0, (v143 + v143)[v83 := v147.cf39]);
		r1 := v148;
	}
}
...
class C8 extends T0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := i0 / (|[p1, p1]| + |[DC1('a', |{p1, p1}|, {f25}, f25, p0), DC1('d', 0x271, {f25, p0}, p0, !p0)]|);
		}
		...
		match (match fm23(v4, false, p1, f25, globalState) {
			...
			case DC5(cf12, cf13) =>
				...
				if (true) {
					...
					var v50: seq<int> := [|v49|];
					v47 := fm31(if (cf12 in v48) then v48[cf12] else p0, v50 + (seq(243, i2  => (|v47|))), globalState);
					var v51: set<int> := {cf13, cf13, |v24|, |v24|};
					var v52: map<array<bool>, set<int>> := map[v3 := v51];
					v52 := v52[v3 := v51];
					var v53: map<int, array<int>> := map[cf13 / v29 := v26];
					...
					v54[805] := if ("idangmfg" in v56) then v56["idangmfg"] else if (false) then v55 else v55;
				} else {
					v27 := v29;
					...
					var v73: array<map<int, int>> := new map<int, int>[27] [if (true) then v61 else map v62 : int | v62 in v63 :: (v62 + v29) := (cf13), map[v29 := v27], v61 + (map v64 : int | v64 in v65 :: (v64 % v29) := (|map[p0 := p0]|)), v61, v61, map v66 : int | (0x34d <= v66) && (v66 < -0xbe) :: (v66 / v28) := (v27), v61, v61, v61, v61, v61 + (map v67 : int | (0x375 <= v67) && (v67 < 0x29f) :: (v67 / v29) := (p1)), v61, v61, (if (cf12 in v68) then v68[cf12] else v61) + fm31(f25, v60, globalState), v61 + map[p1 := p1], v61[v27 := |(if (cf12 in v71) then v71[cf12] else [v69, v69])|] + v61, v61, v61, v61, v61[p1 := v27], map v72 : int | (0xce <= v72) && (v72 < 0x5a) :: (v72 + cf13) := (|v59|), v61, fm31(p0, seq(-0x2fa, i3  => (p1)), globalState), map[0x1d3 := cf13], fm31(f25, ([-0xb7, v27])[v29 := p1], globalState), fm31(cf12, v60[-cf13 := p1], globalState), v61];
					var v75: map<int, bool> := map[|v59| := cf12];
					v73[93] := map v74 : int | v74 in v75[924 := cf12] :: (v74 + v29) := (826);
					v73[93] := if (!cf12 in v68) then v68[!cf12] else map v76 : int | (-787 <= v76) && (v76 < 0x374) :: (v76 / |v75|) := (cf13);
					globalState.f18 := v27;
			...
			case DC6(cf14) =>
				...
				var v82 := "npwc";
				var v83: array<array<int>> := new array<int>[12] [v0, v0, v0, v0, v0, v0, v2[-|v82|], v0, v0, v0, v0, v0];
				v83[510] := v0;
				v83[510] := v0;
				r1 := p1;
				var v84: set<bool> := {p0};
	...
	method m5(p0: D2, p1: int, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int, r2: int, r3: int) {
		...
		r3, globalState.f6, v0, globalState.f5 := (if (|v4| in v2) then v2[|v4|] else p2) % |v5|, if (v7 in v6) then v6[v7] else v8 >= v8, v0, f25;
		match (f20) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				var v12: seq<multiset<bool>> := [multiset{cf4, f25, cf4}, v11, (multiset{cf5})[f25 := p2], v11];
				cf4, globalState.f5, cf5, globalState.f18, r1 := fm2(v9, |cf3|, globalState) <==> !f25, if ((-p2 <= p1) in v10) then v10[-p2 <= p1] else cf5, (v11 !! v11) !in v12[p1], p2 - |map[cf5 := cf2]|, 0xb4;
				globalState.f17 := (p2 % p1) % (cf2 % cf2);
			case DC0(cf0) =>
				...
				if (f25) {
					...
					var v17 := DC18(p2, p1, [v1[p1]], f25, 0x15e);
					...
					v22[428] := fm0(p2, v24, globalState) < p1;
					var v25: seq<int> := [0x130];
					globalState.f6, v22[428], globalState.f5 := (v2 + map[v25[|{p2}|] := p1]) != v2, cf0, f25;
					var v26: array<string> := new string[16];
					v26[861] := seq(0x13, i1  => (v7));
					v26[861] := seq(0x84, i2  => (v7));
					var v27 := DC20(492, v22[428]);
					var v28: map<int, bool> := map[p2 := !f25];
					var v29: map<bool, int> := map[f25 := p1];
					v27, v22[428], r3 := if (p2 in v28) then v27 else v27, fm22(p2 / p2, cf0, v29, globalState), if (cf0) then p1 * p2 else p2;
					v22[428] := v22[428];
				}
		...
		if (match v34 {
			...
			var v38: seq<string> := ["meoipt", seq(798, i4  => (v7))];
			var v39: array<int> := new int[9] [fm0(p1, v36, globalState) - p2, |v3|, p2, |(v1 + v1)|, p1, if (f25 in v37) then v37[f25] else |map[p2 := v38[-p2]]|, p1, |v5| + p1, -0x255];
			v39[182] := p1;
			v39[811] := p1;
			var v40: C2 := new C2(|v5|);
			var v41: map<int, char> := map[|"pxsptslf"| := v7];
			var v42: map<map<int, char>, bool> := map[v41 := f25];
			r1, v39[182], v39[811], v40, v42 := p2, |v35|, |[f25, f25, f25, f25, f25]| - ((if (|v5| in v3) then v3[|v5|] else |v8|) % v40.f22), if (f25) then v40 else v40, (v42 + (map v43 : map<int, char> | v43 in fm75(p1, globalState) :: (v43) := (f25))) + map[v41 := f25];
			v31 := v31;
			globalState.f5 := false;
			globalState.f6 := f25;
		} else {
			...
			if (p1 > (p2 - p2)) {
				...
				globalState.f17 := if (f25 in v49) then v49[f25] else p1 / p1;
			} else {
				globalState.f18 := -((p2 * p2) - p1);
				var v50: multiset<char> := multiset{v7, v7};
				var v51: T0 := new C7(fm2(v50, p1, globalState), f20);
				var v52: array<char> := new char[18] [v7, v5[p2], v7, v7, v7, v7, v7, v7, v7, v5[p2], v7, v7, v7, v7, v7, fm1(globalState), v7, 'l'];
				var v53: map<T0, array<char>> := map[v51 := v52];
				var v54: seq<array<char>> := [v52, v52];
				v53 := v53[v51 := v54[|multiset(v31)|]];
				var v55: array<seq<bool>> := new seq<bool>[14](i6 => v1);
				v55[454] := v1;
				v55[454] := v1[p2 := f25] + v1;
				var v56: map<bool, bool> := map[v31[p2] >= p2 := if (false) then f25 else f25];
				var v57: multiset<bool> := multiset{f25};
				var v58: seq<multiset<bool>> := [multiset{f25}, v57];
				v56 := v56[f25 !in v58[p1] := f25];
				var v59: array<bool> := new bool[9](i7 => f25);
				v59[378] := f25;
				var v60: array<string> := new string[10](i8 => v5);
				v60[794] := "vxfdoy";
				globalState.f5, globalState.f5, globalState.f6, v59[378], v60[794] := f25, f25, f25, !(v5 != v5[p1 := v7]), seq(0x19d, i9  => ('h'));
			}
			...
			if (!(p2 == p2)) {
				...
				v62[857] := if (true) then f25 else !!!f25;
				v62[857] := f25;
				v62[857] := f25;
				globalState.f15 := "s";
				var v63: set<bool> := {f25};
				var v64: map<bool, multiset<int>> := map[v62[857] := v3];
				var v65: seq<multiset<int>> := [multiset{p2}];
				var v66: map<int, bool> := map[|(if (v62[857] in v64) then v64[v62[857]] else v65[p1])| := f25];
				var v68: set<map<int, bool>> := {v66, map v67 : int | v67 in v8 :: (v67 - -p1) := (v62[857])};
				var v69: array<int> := new int[17] [p1, |map[p2 := v62[857]]|, p1, p2, p1, |(seq(-0x3d, i10  => (0x181)))|, |v5|, p2, -|v63|, |v68|, p1, |multiset{p1, p2}|, p1, p1, p2, p2, p1];
				var v70: seq<array<int>> := [v69, v69];
				r3 := -|(if (v62[857]) then [v69] else v70)|;
			} else {
				var v71: array<bool> := new bool[1](i11 => f25);
				v71[599] := v7 in v5;
				v71[599] := ((seq(0x351, i12  => (v7))) + (seq(373, i13  => (v7)))[0x323 := fm1(globalState)]) <= (v5 + v5);
				var v72 := new C7(!v71[599], f20);
				r0 := new int[5] [p1, p1 + |v5|, p2, p1, p1];
				globalState.f17 := p2;
				var v73 := DC7(v0);
				var v74 := DC41(p1, p2, 0x302, v73);
				var v75 := DC1(v7, p2, {true}, !!f25, v71[599]);
				var v76: map<int, bool> := map[|v5| := v71[599]];
				var v77: map<map<int, bool>, int> := map[v76 := p2];
				var v78: map<bool, bool> := map[false := v72.f26];
				var v79: array<int> := new int[22] [p1, p1 - v74.cf78, fm0(p2, v75, globalState) % -p1, |v77| / |v3|, p1, p2 * fm0(|v76|, v75, globalState), if (|v3| in v2) then v2[|v3|] else p2, |v5|, p1 - p1, p1, p2, |(multiset(v31) + v3)|, 0x12f, p1 % p1, p1, p1, -p1, p1 % p1, p1, |v78|, p2, 0x79];
				v79[430] := p2;
				v79[430] := (p1 - 0xed) + (p1 + p2);
			}
			
			var v80: set<bool> := {f25, f25};
			var v81 := DC1(v7, p1, v80, f25, f25);
			var v82 := new C2(fm0(p1, v81, globalState) % p1);
			if (!f25) {
				...
				var v87: array<int> := new int[11] [-344 % |v86|, v82.f22 / fm0(|v85.f24|, v81, globalState), p2 - v82.f22, 0x1d5 / |{v85.f23, v84}|, p2 % p2, v82.f22, v82.f22, |v31|, v82.f22 * v82.f22, v82.f22, v82.f22];
				v87[636] := p2;
				v87[636] := -v82.f22 - p2;
				globalState.f6 := f25;
				globalState.f15 := v5 + v5[p2 := 'o'];
			} else {
		...
		if (true) {
			...
			var v92 := new C7(fm2(v91, |multiset{|v5[p2 := v7]|}|, globalState), f20);
			globalState.f6 := f25;
			...
			if (true) {
				...
				v105 := (v105 * v106[p2]) * fm51(globalState);
			} else {
				globalState.f15 := v5;
				...
				globalState.f18 := v31[-93];
				var v110: array<D8> := new D8[23];
				var v111 := DC23(v5);
				v110[285] := v111;
				v110[285], globalState.f6 := v111, f25;
			}
...
class C9 extends T0 {
		...
		match (v5) {
			...
			case DC5(cf12, cf13) =>
				...
				if (p0) {
					...
					v9[840], globalState.f17, cf12 := -|v13|, |v14| % |v15|, p0;
					...
					var v21: seq<int> := [-p1, |[v20, v20]|, -v9[840], |v13|];
					var v22: map<bool, seq<int>> := map[cf12 := v21];
					var v23: multiset<seq<int>> := multiset{if (p0 in v22) then v22[p0] else [|v4|, p1, |[p1, v9[840], cf13]|], seq(0x35, i2  => (cf13)), v21, v21, [v9[840], v9[840]]};
					v17 := v17[p0 := v19[|v23|]];
					var v24: map<bool, int> := map[p0 := cf13];
					v24 := v24[cf12 := p1 / v9[840]];
					...
					var v29: seq<seq<array<int>>> := [v28, v28, ([v9, v9])[|(seq(937, i3  => (v1)))| := v9], v28];
					var v30: multiset<int> := multiset{cf13, cf13};
					var v31: map<bool, seq<array<int>>> := map[cf12 := v29[|v30|]];
					var v32: seq<int> := [cf13];
					var v33 := DC21(|v32|, p0, cf12, v9, p0);
					var v34: array<seq<array<int>>> := new seq<array<int>>[22] [v28 + v28, [v9, v9], v28 + [v9], if (cf12 in v31) then v31[cf12] else v28, v28, if (p0) then [v9] else v28, v28, v28 + v28, v28, (v28 + v28)[cf13 := v9], v28, v28 + v28, v28 + v28, v28, v28 + v28, v28, v28 + v28, [v9], v28, v28, [v9, v9, (v33.(cf40 := p0, cf39 := cf12)).cf41, v9, v9], v28];
					v34[109] := v28;
					v34[109] := v28 + v28;
					...
					var v40: array<seq<bool>> := new seq<bool>[23] [v36, [cf12], v36, v36, v36, v36, v36, v36, [cf12, fm2(v8, --0x236, globalState), true, p0], v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, fm50(cf12, cf12, v38, globalState), v36[|v39| := cf12], v36, v36];
					var v41 := DC8(cf12);
					var v42 := DC43(v40, p0, p1, cf12, v41);
					var v43: seq<map<bool, array<int>>> := [v35, v35, v35[v42.cf83 := v9]];
					var v44: map<map<bool, array<int>>, bool> := map[v43[cf13] := cf12];
			...
			case DC3(cf7) =>
				...
				if (!(v45 !in v46)) {
					...
					globalState.f18, v52, globalState.f6, v3[385], v56 := p1, v53, true, {v4} > v57, v56;
				} else {
					v3[364] := cf7 < cf7;
					v3[364] := -p1 != |v45|;
					var v58: array<string> := new string[7](i4 => "lwgw" + cf7);
					v58, globalState.f17 := v58, p1 / -p1;
					globalState.f5 := v3[364];
					globalState.f6 := -p1 < p1;
					globalState.f18 := p1;
				}
				...
				if (false) {
					...
					var v60: map<bool, int> := map[p0 := |v59[p1]|];
					...
					v63 := v63[p0 := v1];
					var v64: map<char, int> := map[v1 := p1 / p1];
					v64 := v64;
					globalState.f17 := (0xaa % p1) / |v63|;
					...
					v67[577] := v68 + map[v3 := v1];
					v67[577] := (if (p0) then v68 else v68)[v3 := v1];
			...
			case DC6(cf14) =>
				...
				v3[286] := v73 > v73[p0 := 0x208];
				var v74: array<int> := new int[6];
				var v75 := DC1(v1, p1, fm52(|v4|, seq(-0x3a3, i5  => (v1)), p0, false, globalState), p0, v3[286]);
				...
				v74 := new int[12] [p1, p1, p1, |v78|, p1 + p1, p1 * p1, p1, p1, |v79[|v80|]| / |v4|, |map[v3[286] := v81]|, if (p0) then p1 else p1, p1];
		}
		
		v3[112] := p0;
		v3[112] := (seq(-129, i6  => (v1))) < (v4 + v4);
		globalState.f18 := -(p1 + p1);
		var v82: multiset<char> := multiset{v1};
		var v83: multiset<bool> := multiset{fm2(v82, 0x2d, globalState)};
		r0 := v83;
		r1 := p1 / p1;
		r2 := if (!(!v3[112] <==> v3[112])) then v1 else v1;
	}
	method m3(globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			globalState.f4, v6[947], globalState.f18, globalState.f17, globalState.f6 := if (v1) then v6 else v6, v1, v0, v0, if (v1) then if (v1 in v7) then v7[v1] else true else v1;
			globalState.f17 := v0;
		}
		...
		var v12 := 'a';
		var v13 := "ru";
		r0 := |(if (!(v0 == |fm78(globalState)|)) then ("cwjneywp")[v0 := v12] + v13[v0 := v12] else v13)|;
	}
	method m4(p0: C1, p1: int, p2: map<int, string>, globalState: GlobalState) {
		...
		for i0 := p1 to p1 + |v2| {
			...
			var v8: array<int> := new int[22] [-p1, p1, i0, p1, p1, i0 * i0, -p1, p1, i0, i0, p1 + p1, -p1, i0, -0x348 % |v5|, -0x3e, i0, |v4| % p1, |(v6 + (seq(-0x36, i1  => ('d'))))|, fm0(i0, v7, globalState), i0 - 0xf3, |v6|, i0];
			v8[128] := 421;
			var v9: array<array<int>> := new array<int>[16];
			var v10: set<int> := {p1};
			var v11: seq<int> := [|v10|, p1];
			v8[544] := -(if (v11[i0] in v4) then v4[v11[i0]] else -0x210);
			var v12: set<bool> := {v1};
			...
			v8[128], v9, globalState.f5, v8[544], v16 := i0 % p1, v9, v18 < v18, -|v20|, v16;
			var v21: array<bool> := new bool[1];
			v21[734] := v17.f26;
			var v22 := 'b';
			v21[734], v8[128], v1, v1, globalState.f17 := if (v1) then !v1 else v1, v8[128], if (v17.f26) then v1 else v1, (if (v1) then v22 else 'j') in (if (!v2[v8[128]]) then v6 else fm46(if (|v6[i0 := 'h']| in v4) then v4[|v6[i0 := 'h']|] else p1, v17.f26, v17.f26, globalState)), i0;
			globalState.f6 := (if (!v17.f26) then v8[128] else v8[128]) < |(seq(0x368, i3  => (v22)))[v8[128] := v22]|;
		}
		globalState.f17 := p1;
		var v23 := 't';
		...
		if (v1 <==> (if (v1) then v1 else if (v1 in v26) then v26[v1] else v1)) {
			...
			v28, v32 := v28, v32;
			v28 := new int[1];
			globalState.f15 := v27[p1 := v23];
			if (v1) {
				v28[619] := p1;
				v28[619] := fm0(p1, v25, globalState);
				globalState.f5 := false;
				globalState.f18 := fm0(p1 - fm0(p1, v25, globalState), fm48(|v24|, v28[619], p1, globalState), globalState);
				var v33: map<string, int> := map[v27 := if (v1) then p1 else ---v28[619]];
				var v34: map<bool, C6> := map[!v1 := v0];
				v33 := v33[v27 + (seq(-221, i5  => (v23))) := -(|v34| + p1)];
				var v35: map<int, bool> := map[v28[619] := v1];
				var v36 := DC11(v1, true, v28[619], |v35|);
				var v37: map<int, int> := map[p1 := v36.cf22];
				v37 := v37[-v28[619] := |fm45(globalState)|];
			} else {
				var v38: map<int, bool> := map[p1 := v1];
				var v39: map<int, bool> := map[p1 % p1 := v1 ==> (if (|{v1}| in v38) then v38[|{v1}|] else v1)];
				...
				globalState.f17, globalState.f5, v39 := |(if (v23 in v40) then v40[v23] else v29)|, v1, (v41[if (v1 in v43) then v43[v1] else p1])[p1 * p1 := if (p0 in v44) then v44[p0] else fm2(v45, p1, globalState)];
				...
				var v53 := DC7(v49);
				var v54: map<bool, set<D14>> := map[v1 := {v50, v50, DC41(|v27|, |(seq(548, i7  => (v23)))|, |(if (true in v52) then v52[true] else v29)|, v53)}];
				var v55: seq<set<D14>> := [{v50}, v51, if (v1 in v54) then v54[v1] else v51];
				var v56 := new C8(v51 !! v55[0x118], DC0(v1));
				v26 := v26[v30 < multiset{p1, |(seq(0x33e, i8  => (v23)))|, p1} := v1];
				globalState.f17 := p1;
			}
			...
			v60[775], globalState.f18, globalState.f4, globalState.f6 := p1, |(([v58, 0x318] + v61[p1 := 0x286])[0x1bf := p1] + v61)|, if (v1) then v62 else v62, v1;
			var v63: set<int> := {v58, v61[|multiset{v58}|]};
			v63 := v63 - ({0x292, v60[775], p1} + v63);
			var v64 := "befrf";
			var v65: map<int, string> := map[v60[775] := v64];
			var v66: map<bool, int> := map[v1 := v60[775]];
			var v67: map<int, int> := map[|v24| := |v66|];
			v65 := v65[|v63| * |v67| := v64 + v64];
			var v68 := DC36(v60[775]);
			v62[559] := p1 <= |v64|;
			v62[890] := v1;
			var v69: seq<string> := ["u" + v64];
			v68, v62[559], globalState.f16, v62[890] := v68.(cf68 := |v66|), v1, v69[v25.cf2 + v60[775]], v1;
		}
		...
		var v73 := DC48(v1, v1);
		var v74 := DC58(v1, seq(820, i9  => (v23)));
		v72, globalState.f17, v73 := fm59(p1, globalState) + fm59(p1, globalState), -p1, DC48(v74.cf108, v2[p1]);
	}
}
...
class C10 extends T1 {
	...
	function fm3(p0: int, p1: int, p2: bool, globalState: GlobalState): map<int, bool> {
		if ((seq(0x89, i0  => ('g'))) != (seq(952, i1  => ('l')))) then map[|map[|"gbuyy"| := 'l']| := true] + map[f21 := DC1('e', f21, {true}, false, false).cf5] else map[f21 := true] + map[419 := true]
	}
	function fm4(p0: char, p1: multiset<multiset<char>>, globalState: GlobalState): D0 {
		f20
	}
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: char) {
		...
		if (fm2(v1, |v2|, globalState) ==> fm2(multiset{v0}, |v3|, globalState)) {
			...
			var v8: array<bool> := new bool[26] [p0, p0, p1 == p1, v4 == (seq(0x3e, i0  => (v0))), p0, p0, p0, p0, p0, v6 != v6, false, p0, p0, p0, p0, p0, p0, p1 < |v7|, if (|"sjitwfms"| in v7) then v7[|"sjitwfms"|] else p0, p0, v0 !in v4, fm2(v1, p1, globalState), p0, p0, f21 <= p1, p0];
			v8[552] := p1 >= f21;
			var v9: seq<bool> := [p0];
			var v10 := DC3(v4);
			var v11: multiset<seq<bool>> := multiset{v9};
			var v12: map<int, multiset<seq<bool>>> := map[f21 := v11[v9 := 42]];
			v8[552] := !((multiset([v9, v9]))[v9 := |v10.cf7|] !! (if (|map[p0 := p0]| in v12) then v12[|map[p0 := p0]|] else v11));
			var v13: map<bool, int> := map[v8[552] := f21];
			var v14: map<int, int> := map[p1 := -0x1cc];
			var v16 := DC1(fm1(globalState), |(set v15 : int | (687 <= v15) && (v15 < 0x3d6) :: (v15 % |v13|))|, v5, v8[552], p0);
			var v17: multiset<map<int, int>> := multiset{v14, v14};
			var v18: array<int> := new int[15] [p1, f21, f21, f21, if (v8[552] in v13) then v13[v8[552]] else f21, f21 * (if (0x39f in v14) then v14[0x39f] else |(seq(0x142, i1  => (v0)))|), p1 - fm0(-f21, v16, globalState), -p1, f21, f21, f21, 697 / |v17|, f21 * |v13|, 0x266, -f21];
			v18[233] := p1;
			v9, v10, globalState.f5, globalState.f6, v18[233] := v9, fm6({false, p0, v8[552]}, p1 - f21, globalState), if (!v8[552]) then (set v19 : int | (0x64 <= v19) && (v19 < 0x6b) :: (v19 % |map[--596 := v0]|)) > {p1} else p0, !v9[p1], -(f21 / 0x64);
			v18[233], globalState.f4, v8[552] := f21, v8, v18[233] >= p1;
			r1 := |fm7(f21, globalState)| + |v4|;
			var v20: multiset<bool> := multiset{false};
			if (true !in v20[v8[552] := v18[233]]) {
				var v21: map<bool, bool> := map[!(|{!v8[552]}| != p1) := p0];
				v21 := v21[!(p0 && v8[552]) := p0];
				v13 := if (f21 >= f21) then map[p0 := v18[233]] else v13;
				v18[233] := p1;
				v10 := v10.(cf7 := if (v8[552]) then seq(0x341, i2  => (v0)) else v4);
				globalState.f6, v8[552] := multiset(v3) >= v2, |(v3 + (seq(0x3a, i3  => (|v4|))))| <= (f21 % -p1);
			} else {
				v10 := v10;
				v18[233] := v18[233];
				v18[233] := v18[233];
		...
		match (v29) {
			case DC4(cf8, cf9, cf10, cf11) =>
				...
				match (v31.(cf2 := cf8, cf5 := cf10, cf1 := v0, cf4 := DC0(cf11).cf0).(cf4 := cf11, cf5 := false && cf11)) {
					case DC1(cf1, cf2, cf3, cf4, cf5) =>
						cf4 := (cf3 * v30) !! (v30 * cf3);
						globalState.f17 := -(f21 % |map[|v3| := cf10]|) - -(f21 - cf8);
					...
					case DC0(cf0) =>
						...
						v35 := (v33 + v35) + (v33 + v35)[p1 := v35[f21]];
				...
				match (v40) {
					case DC17(cf28, cf29) =>
						...
						var v46: map<map<bool, bool>, bool> := map[v43 := fm2(v45[f21], p1, globalState)];
						v46 := v46[v43[p0 := cf10] := p0];
						var v47: array<int> := new int[20];
						v47 := v47;
					case DC18(cf30, cf31, cf32, cf33, cf34) =>
						var v48: array<int> := new int[26](i5 => i5 / |"uvwesnuh"|);
						var v49: map<array<int>, char> := map[v48 := v0];
						v49 := (v49 + v49)[v48 := v0];
						var v50 := "e";
						var v51: multiset<string> := multiset{("mjxvjj")[cf30 := v0]};
						globalState.f17 := |(if (v0 !in v50) then v51 else multiset{seq(0x37b, i6  => ('k')), v50, v50[|v3| := v0], v50})|;
						var v52: map<map<array<int>, char>, bool> := map[v49 := p0];
						v52 := v52[v49 := fm2(v1, v3[f21], globalState)];
						var v53 := new C3(f20);
					case DC16(cf27) =>
						cf9 := cf9;
				...
				v66, v67[346], cf9, r1 := v66, v68, DC1(v0, p1, v30, cf11, cf10).cf1 !in v69, (|v71| - -p1) % cf8;
			...
			case DC5(cf12, cf13) =>
				...
				var v75: array<string> := new string[26] [fm46(p1, true, p0, globalState) + v73, v74.cf52 + v73, v73, v73, "upymoh" + v73[cf13 := v0], v73, v73[|v3| := v0], v73 + v73, v73, seq(-0x34, i11  => (v0)), "vr" + v73, v73 + v73, "prlfknx", v73, "gotsytxmo" + (seq(-0x3bc, i12  => (v0))), v73, v73, v73, v73, v73, "adw", v73, v73, fm11(p0, globalState), "umd", seq(0x5b, i13  => (v0))];
				var v76: seq<array<string>> := [v75];
				v72[867], globalState.f18, v75 := v3[p1], f21, v76[p1];
				var v77 := new C9(if (p0) then f20 else f20);
				var v78: array<map<bool, int>> := new map<bool, int>[9](i14 => map[cf12 := v72[867]] + map[p0 := |map[f21 := p0]|]);
				var v79: seq<bool> := [!cf12];
				globalState.f18, globalState.f5, v78, cf12 := |(v3 + [p1])|, v79[|"trucpo"|], v78, (cf13 / cf13) > v3[v72[867]];
				globalState.f18 := 0x9c / cf13;
			case DC3(cf7) =>
				var v80: map<char, bool> := map[v0 := p0];
				var v81: map<set<int>, map<char, bool>> := map[{p1} := v80 + v80[v0 := p0]];
				v81 := v81[set v82 : int | v82 in v3 :: (v82 / -|(set v83 : char | v83 in multiset{'c'} :: (v83))|) := v80];
			...
			case DC6(cf14) =>
				...
				v3 := (if (p1 in v88) then v88[p1] else v3) + (v3[f21 := -0x391] + v3[|v89| := f21]);
		...
		globalState.f17 := (|map[f21 := v93]| / f21) + (|v95.cf32| - p1);
		var i15 := 0;
		while (v0 !in (seq(-0x110, i16  => (v0))))
			decreases 100 - i15
		{
			if (i15 >= 100) {
				break;
			...
			var v98 := "nmdurf";
			v97, globalState.f6, globalState.f18, globalState.f5, globalState.f17 := seq(0xd, i17  => (DC0(p0))), p0, p1, v3 == (v3 + v3[f21 := fm5(p0, globalState)]), f21 * (|v98| + p1);
			globalState.f18 := -0x3c0 % f21;
			globalState.f18 := f21 + p1;
			globalState.f18 := f21;
		}
		var v99: array<int> := new int[20](i18 => i18 * p1);
		v99[12] := 908;
		globalState.f18, globalState.f17, globalState.f5, v99[12], r0 := f21 * p1, fm5(v2 == v2, globalState), v90 > v90, p1, v90;
	...
	method m1(p0: bool, p1: string, p2: bool, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			v1[635] := true;
			globalState.f17, v1[635] := fm5(p1 <= (seq(-0x234, i1  => ('v'))), globalState), p2;
			...
			var v10: multiset<bool> := multiset{v1[635]};
			v2, v8[986], globalState.f5, v6 := v2, fm79(false, globalState) * v4, !p2 || (multiset(v9) !! v10), v6;
		}
		...
		r0 := -match v14 {
			...
			case DC3(cf7) => -|(if (p2) then map v15 : int | v15 in {-0x277, 0x77} :: (v15 * f21) := (p0) else map v16 : int | v16 in (map v17 : int | v17 in [f21] :: (v17 + f21) := (|(seq(0x9a, i2  => ('f')))|)) :: (v16 - |p1|) := (p2))|
			case DC6(cf14) => f21
		};
	}
}
...
method Main() {
	...
	var v6: map<int, string> := map[v4 := v5[v4]];
	var v7: array<char> := new char[28];
	var v8: array<int> := new int[15];
	var v9: array<string> := new string[28];
	var globalState := new GlobalState(false, true, true, false, v2, false, false, true, -0x1de, v3, v6, v7, 0x22f, 539, v8, seq(834, i0  => ('h')), (seq(0x107, i1  => ('n'))) + v3, 764, 0x11a, v9);
	globalState.f6 := |(seq(0x7, i2  => ('k')))| == -v4;
	...
	globalState.f18, globalState.f18, v8[334], globalState.f17, v4 := -(v4 - v4), -fm0(v4, v12.(cf5 := v0, cf1 := fm1(globalState), cf3 := v11, cf4 := v0), globalState), v13[v4 / v4], 215, if (v1.cf0) then |(v3 + v3)| else |(if (v0) then v13 else v13)|;
	globalState.f17 := v4 / -v4;
	var v14: map<bool, int> := map[v0 := v8[334]];
	v14 := v14[v8[334] >= v4 := v8[334] % v8[334]];
	match (DC0(v0)) {
		case DC1(cf1, cf2, cf3, cf4, cf5) =>
			var v15: multiset<int> := multiset{0x2f6, cf2};
			var v16: seq<bool> := [v0, v0];
			v2[105] := v15 <= v15[v8[334] := |v16|];
			var v17: multiset<bool> := multiset{v0};
			v2[105] := (multiset(v16) - (DC2(v17).(cf6 := v17)).cf6) < v17;
			if (if (0xc1 > v8[334]) then cf5 else v12.cf4) {
				cf5 := if (cf4) then cf5 else !v2[105];
				v8[334] := v8[334];
				var v18: map<array<int>, char> := map[v8 := cf1];
				v10 := if (v8 in v18) then v18[v8] else cf1;
				v2[105] := fm2(multiset{v10}, v8[334], globalState);
				var v19 := new C1(|v3| * cf2, DC0(v0));
			} else {
				var v20: array<seq<bool>> := new seq<bool>[1];
				v20[946] := v16;
				v20[946] := v16;
				var v21 := DC2(multiset(([true])[v8[334] := v2[105]]));
				var v22: array<seq<int>> := new seq<int>[22];
				var v23 := DC7(v22);
				var v24 := new C5(v21, v23, v1);
				cf4 := !cf5;
				globalState.f17 := v8[334];
				var v25: array<bool> := new bool[6](i4 => cf5);
				var v26: multiset<array<bool>> := multiset{v25};
				globalState.f6 := !(v26 >= v26);
			}
			
			var v27: set<int> := {|(seq(150, i5  => (cf1)))[cf2 := v3[cf2]]|};
			var v28: map<string, set<int>> := map[v3 + v3 := v27];
			v28 := v28[v3 := if (fm2(multiset{v3[v8[334]]}, cf2, globalState)) then v27 else v27];
			v2[105] := cf4;
		case DC0(cf0) =>
			...
			var v32 := DC5(v0, 356);
			var v33 := DC37(|v11|, v8[334], v8[334]);
			var v34 := DC8(true);
			var v35 := DC43(v31, v32.cf12, v33.cf70, v0, v34);
			v2[50], globalState.f6, v30 := !!v35.cf83, cf0, v30 + v30[v2 := -v4];
			var v36 := new C3(v1);
	...
	if (v0) {
		...
		var v39: C0 := new C0(v2, v38[0x29b := v0]);
		var v40: map<C0, bool> := map[v39 := v0];
		var v41: multiset<int> := multiset{|v40| * v4, v8[334], v4};
		v41 := (v41 - v41[v4 := v8[334]]) * (if (v0) then v41 else multiset{v4});
		v8 := v8;
		var v42: C1 := new C1(v4, DC0(v0));
		var v43: map<bool, seq<C1>> := map[v0 := [v42]];
		var v44: seq<C1> := [v42];
		var v45: seq<C1> := [v42, v44[|fm30(v0, v3, globalState)|]];
		...
		var v48: array<array<C1>> := new array<C1>[11] [v46, v46, v46, v46, v46, v46, v47[v8[334]], v46, v46, v46, v46];
		v48[135] := v46;
		v48[135] := v46;
		v14 := v14[!(815 < v4) := v4 / v8[334]];
	} else {
		globalState.f17 := v4 - v8[334];
		var v49: map<int, int> := map[-v4 := v8[334]];
		globalState.f17 := |(v49[v8[334] := -v4] + (v49 + v49))|;
		v4 := if (v0 <== v0) then v8[334] else v8[334];
		if (v0 ==> (v8[334] == v8[334])) {
			v8[334] := v4 - |v6|;
			globalState.f6 := v0;
			globalState.f6 := v0;
			v8 := v8;
			var v50: multiset<int> := multiset{v8[334]};
			globalState.f6 := multiset(v13) <= v50[v4 := |"emuwpm"|];
		} else {
			v0 := v0;
			v8[334] := v4;
			var v51 := DC39(v2);
			...
			var v54: multiset<array<bool>> := multiset{if (v0) then v2 else v51.cf72, v2, v53[fm0(v4, v12, globalState)], v2, v2};
			var v55 := DC66(multiset{v2, v2, v2});
			v54, v8 := v55.cf125, v8;
			globalState.f17 := (v4 / v4) / (v4 * v8[334]);
			var v56: map<string, multiset<char>> := map[v3 := fm39([v4, v4, v8[334]], v0, v8[334], -v8[334], globalState)];
			var v57: multiset<char> := multiset{v10, fm1(globalState), v10, v10};
			globalState.f5 := fm2(if (v3 in v56) then v56[v3] else v57, v8[334], globalState);
		}
	...
	for i7 := |v61| to v4 {
		...
		var v67 := DC49(v7);
		m13(v66, v0, (seq(669, i8  => (i7))) < v13, |(multiset{v67, v67, v67})[v67 := i7]| - |v63|, globalState);
		globalState.f6 := v0;
	...
	m13(v69, v0, if (v0) then false else v70[v8[334]], v4, globalState);
	if (v0 in v70) {
		var v71: T0 := new C6(v1);
		var v72: map<T0, int> := map[v71 := v4];
		var v73: map<int, map<T0, int>> := map[v4 := v72];
		var v74: map<bool, map<T0, int>> := map[if (v0) then v0 else v0 := if (v8[334] in v73) then v73[v8[334]] else v72];
		v74 := v74;
		var v75 := new C4(v71.f20);
		var v76: seq<array<int>> := [v8];
		var v77: multiset<array<int>> := multiset{v76[|v13|]};
		var v78: map<bool, bool> := map[v8 in v77 := v0];
		v78 := v78[v0 := v0];
		var v79: seq<array<bool>> := [v2];
		var v80: map<int, int> := map[v4 := v8[334]];
		...
		v8[334] := if (!v0) then --|v82| - v4 else v8[334];
		var v83 := DC58(v0, "k");
		...
		match (v85) {
			case DC25(cf46, cf47, cf48) =>
				...
				v88 := v88;
			case DC24(cf45) =>
				v2[791] := multiset{v8[334], v8[334]} > multiset{v8[334]};
				var v89: multiset<bool> := multiset{v0, v0};
				v2[791] := !(v4 <= (if (v70[|[{v8[334], v4, v4, v4}]|]) then if (v0 in v89) then v89[v0] else v8[334] else v8[334]));
				var v90: multiset<char> := multiset{v10, 'q', v10};
				m13(if (fm2(v90, v8[334], globalState)) then v69 else v69, v2[791], v2[791], v8[334], globalState);
				v3 := v3;
				v9[817] := v3;
				var v91: set<int> := {v8[334]};
				var v92 := DC35(v91);
				var v93 := DC61(fm0(v8[334], v12, globalState), v8[334], v0, v92, v4);
				var v94: map<set<int>, int> := map[{543} := |v3|];
				v9[817] := fm27(v4 % (v93.(cf119 := v8[334], cf117 := v0, cf118 := v92)).cf116, fm33(globalState), fm0(|v70|, v12, globalState), v94, globalState);
		}
		
		v2[582] := v0;
		v2[582] := fm2(multiset{v10} + multiset{v10}, v8[334], globalState);
		v8 := v8;
		m13(v69, v0, v2[582], v8[334], globalState);
	}
	
	forall i10 | 0 <= i10 < v9.Length {
		v9[i10] := (if (!v0) then v3 else "fmm") + v5[v8[334]];
	}
	if (v0) {
		globalState.f18 := |v3| - v4;
		v8[334] := v8[334];
		var v95: set<int> := {636, fm0(0x145, DC1(v10, |v11|, v11, v0, v0), globalState), v8[334]};
		...
		globalState.f6, globalState.f18, v4, globalState.f6 := v0 in fm9(v95, !v0, globalState), v4, fm0(-(v8[334] * -v8[334]), if (v0) then v12 else v12, globalState), |(v101 + map[v100 := true])| <= 851;
		globalState.f5 := v0;
		if (v0) {
			var v102 := new C4(v1);
			...
			v9 := v9;
			globalState.f5 := v95 !! {|fm37(v0, v8[334], globalState)|, v8[334]};
			var v105: array<map<int, bool>> := new map<int, bool>[23](i11 => map v104 : int | v104 in v13 :: (v104 / 0x53) := (v0));
			v105 := v105;
			globalState.f4 := v2;
			v0 := v0;
		}
		...
		var v111: multiset<map<bool, bool>> := multiset{v110[v8[334]] + v109, v109, v109};
		v111 := v111;
		v2[714] := v0 ==> v0;
		v2[714] := true;
		var v112: multiset<bool> := multiset{v2[714]};
		var v113 := DC2(v112);
		var v114: array<seq<int>> := new seq<int>[17];
		var v115 := DC7(v114);
		var v116: C5 := new C5(v113, v115, v1);
		var v117: map<bool, C5> := map[v2[714] := v116];
		v2[714], globalState.f6, v8[334], v116 := v70[v4], false, v8[334], if ((v2[714] && v2[714]) in v117) then v117[v2[714] && v2[714]] else v116;
	}
	
	var v118: set<int> := {v8[334]};
	var v119: C2 := new C2(v4);
	var v120: map<C2, bool> := map[v119 := v0];
	var v121: multiset<char> := multiset{v10};
	var v122: array<seq<bool>> := new seq<bool>[16] [v70, v70, v70, v70, v70, [false, v0, v0, v0, v0], v70, v70, fm9(v118, if (v119 in v120) then v120[v119] else v0, globalState), v70, v70, v70, [fm2(v121, v4, globalState)], v70, [v0, DC21(v8[334], v0, v0, v8, v0).cf39, v0, v0, v0], [v0]];
	var v123 := DC8(v0);
	...
	match (v124) {
		case DC43(cf82, cf83, cf84, cf85, cf86) =>
			...
			v128 := (v128 - v128)[cf84 := |v129| * v119.f22];
			var v130: map<int, int> := map[v119.f22 := 721];
			var v131: C9 := new C9(v1);
			var v132: map<C9, int> := map[v131 := v4];
			if ((if (v8[334] in v130) then v130[v8[334]] else v119.f22) < (cf84 * |v132|)) {
				m13(v69, cf85, v70[v119.f22], v8[334], globalState);
				...
				var v137, v138, v139 := v119.m2(v8[334] == (fm82(globalState)).cf113, v119.f22, v0, |fm45(globalState)|, globalState);
			} else {
				v10 := 'n';
				var v140: multiset<bool> := multiset{cf83, v0};
				var v141 := DC2(v140);
				v122[906] := fm50(true, cf83, v141, globalState);
				var v142: seq<map<int, int>> := [v130];
				v122[906] := [!(v119.f22 !in v142[v8[334]])];
				...
				v8[334] := (if (v146 in v147) then v147[v146] else v119.f22) + cf84;
				var v148: map<C1, int> := map[v143 := if (cf83) then |v122[906]| else |v70|];
			...
			if (-|v70| != v119.f22) {
				...
				v8[334] := if (fm40(v0, cf84, v130, globalState) in v168) then v168[fm40(v0, cf84, v130, globalState)] else cf84;
				globalState.f6 := !v0;
			}
			
		case DC42(cf81) =>
			if (v0) {
				var v169: map<int, bool> := map[DC21(v8[334], false, v0, v8, v0).cf38 := !false];
				var v170: set<map<int, bool>> := {map[v119.f22 := false], v169};
				var v171: seq<map<bool, int>> := [map[v0 := |v170|]];
				v14 := (v14 + v14) + (v171[0x2a5])[v0 := |map[v0 := v119.f22]|];
				...
				var v181: array<D11> := new D11[26] [v177, v177, v177, v177, v177, v177.(cf60 := v4), v177, DC31(v178, 983), v177, v177, v177, v177, v177, DC31(map[v3 := v2], fm0(v8[334], DC1(v10, |v180|, {true}, v0, v0), globalState)), v177, DC31(v178, v119.f22), v177, DC31(v178, v4), v177, DC31(v178, v13[0x1d0]), DC31(v178, |v13|), v177.(cf60 := v4), v177, v177, v177, v177];
				var v182: map<array<D11>, bool> := map[v181 := v3[301 := v10] < v3];
				globalState.f5, globalState.f17 := if (v181 in v182) then v182[v181] else true <==> v0, (v4 / 0x4a) / |[true, v0]|;
				globalState.f6 := v0;
				globalState.f6 := v70[v119.f22];
				globalState.f17 := v8[334];
			}
			
			globalState.f17 := fm0(v8[334], v12, globalState);
			globalState.f6 := v70[v8[334]];
		...
		decreases 100 - i12
	{
		...
		v187[726] := if (v0) then v8 else v8;
		v187[726] := v8;
		...
		decreases 100 - i13
	{
		...
		if (v0) {
			v2[811] := v0;
			globalState.f6, v2[811], globalState.f6 := fm0(|v13|, v12, globalState) > v119.f22, v0, fm2(v121 + multiset(v3), -v4, globalState);
			globalState.f6 := v0;
			var v189: array<seq<int>> := new seq<int>[9];
			v189[967] := v13[|v3| := v119.f22];
			v189[967] := v13;
			var v190: multiset<bool> := multiset{v2[811]};
			var v191: set<seq<int>> := {fm47(|map[v2[811] := v0]|, v2[811], true, globalState), v13, [|v190|, v8[334]]};
			var v192 := DC33(v191, v4);
			var v193: map<D12, bool> := map[v192 := !(|v3| > v119.f22)];
			v193 := v193[v192 := !v2[811]];
			v0 := !v2[811];
		} else {
			var v194: seq<array<int>> := [v8];
			var v195: seq<array<int>> := [v194[v4], v8, v8, v8];
			var v196: array<array<int>> := new array<int>[19] [v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v194[-v119.f22], v8, v8, v8, v8, v8, v8, v8, v8];
			v196[732] := v8;
			v196[732] := v8;
			...
			var v204, v205, v206 := v119.m2(v0, v4, v119.f22 >= |v203|, v8[334], globalState);
			v8[334] := v119.f22 - 0x331;
		}
		
		var v207: multiset<bool> := multiset{v0, v0};
		globalState.f6 := v70[v119.f22] && (|map[v0 := v8[334]]| != (if (v0 in v207) then v207[v0] else v119.f22));
		globalState.f4 := v2;
		var v208 := DC18(v119.f22, v4, [v0], v0, v8[334]);
