...
class C1 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) {
		var v0 := "ju";
		var v1: multiset<string> := multiset{if (false) then v0 else "kcobgiw", seq(abs(0x3b7), i0  => ('r')), v0 + (seq(abs(0), i1  => ('f')))};
		...
		var v8 := DC2(v7, !f6);
		var v9: set<D0> := {v8};
		for i2 := safeDivisionInt(f5, |fm4(|[v2]|, globalState)|) to if (|v0| in v4) then v4[|v0|] else |v9| {
			var v10: seq<map<bool, seq<int>>> := [map[f6 := v6]];
			var v11: map<int, bool> := map[f5 := false];
			v3 := v3[DC2(v10[safeIndex(p0, |v10|)], f6).cf6 := |v11|];
			var v12: map<int, string> := map[i2 := v0];
			var v13 := 'b';
			var v14 := DC1(v0[safeIndex(f10, |v0|) := v13], f5, v3, v6);
			var v15: seq<string> := [v0, v0];
			var v16: map<int, map<bool, int>> := map[0x28c := v3];
			var v17: array<string> := new string[24] [v0 + "md", if (p0 in v12) then v12[p0] else seq(abs(0x46), i3  => ('l')), v0[safeIndex(p0, |v0|) := v13] + v0, v14.cf1[safeIndex(f11, |v14.cf1|) := v13], v0, "o", "th", v15[safeIndex(f10, |v15|)], v0, v0, v0, v0, fm5(v3, v16, globalState), if (f11 in v12) then v12[f11] else v0, v0, "chm" + v0, v0, v0, v0[safeIndex(f11, |v0|) := v13], "u" + v0, DC1("ylxgswe", fm6(f5, f5, f6, f5, globalState), v3, v6).cf1, v0 + v0, v0 + "soi", v0];
			v17[safeIndex(567, v17.Length)] := v0;
			var v18 := false;
			var v19: seq<bool> := [fm0(fm0(true, globalState), globalState), v18];
			var v20: seq<seq<bool>> := [v19];
			f10, f10, v17[safeIndex(567, v17.Length)], v18 := i2 * (f10 * p0), p0, v0, f10 < |(v20 + v20)|;
			f10 := i2;
			f10 := -(f11 - p0);
		}
		...
		for i4 := f5 to f10 {
			...
			if (if (f6) then f6 else f6 <==> f6) {
				var v24, v25, v26, v27 := m0(f10, v6[safeIndex(v23.f13, |v6|)], globalState);
				...
				var v34: array<multiset<int>> := new multiset<int>[15] [v30, v30 - v30, multiset(v6), v30, v30, v30, v30, v30 + v30, v30, v30 - v30, multiset((seq(abs(0xb4), i5  => (v23.f13))) + (fm9(v23.f13, globalState)).cf4), multiset(v6), v30, multiset(v6 + [|(if (i4 in v31) then v31[i4] else v28)|, v23.f13, |v0|]), v32.cf22[if (v2 in v33) then v33[v2] else |v3| := abs(|(seq(abs(0x1c9), i6  => ('u')))|)]];
				v34[safeIndex(573, v34.Length)] := v30;
				var v35 := true;
				v2[safeIndex(837, v2.Length)] := v35;
				var v36: seq<bool> := [true, f6, false];
				var v37 := DC1(v24, v27, v3, [-v23.f13]);
				var v38 := 'd';
				v29, v34[safeIndex(573, v34.Length)], v35, v2[safeIndex(837, v2.Length)] := v29, v30, (v36 + [f6, !f6]) <= [v35], v23.fm8(v35, v37.cf1, v38, globalState);
				v24 := v24;
				v34[safeIndex(573, v34.Length)] := v30;
				v27, v2[safeIndex(837, v2.Length)], v25, f10, v35 := safeModuloInt(f5, f11), v24 < ((seq(abs(0x6e), i7  => (v38))) + (seq(abs(125), i8  => ('k')))[safeIndex(v23.f12, |(seq(abs(125), i8  => ('k')))|) := v38]), v25, v27, v35;
			} else {
				var v39 := 'w';
				v39 := v39;
				...
				v40[safeIndex(794, v40.Length)] := v41 - fm10(v43, v23.f13, globalState);
				v40[safeIndex(794, v40.Length)] := v41;
				v39 := v39;
				var v44 := true;
			...
			if (f6) {
				...
				v46[safeIndex(131, v46.Length)] := f5;
				var v48: map<int, string> := map[v45.f12 := v0];
				f10, v47, v0, v46[safeIndex(131, v46.Length)] := safeModuloInt(0x1de, v45.f12) + |(v48 + v48)|, v47, "ihvp", safeModuloInt(v45.f13, v23.f12);
				v2 := v2;
				var v49: array<string> := new string[24];
				var v50: seq<bool> := [f6];
				v49, v50 := if (v46[safeIndex(131, v46.Length)] >= 0x73) then v49 else v49, (v50 + v50) + v50;
			} else {
				var v51: array<int> := new int[3](i9 => safeDivisionInt(i9, v23.f12));
				v51[safeIndex(153, v51.Length)] := p0;
				var v52: seq<bool> := [!f6];
				var v53 := 'e';
				var v54: map<int, bool> := map[|v4| := f6];
				var v55: map<int, map<bool, int>> := map[v23.f13 := v3];
				v51[safeIndex(153, v51.Length)] := |((v0 + v0)[safeIndex(|v52|, |(v0 + v0)|) := fm11(v53, true, f6, globalState)] + (fm5(v3[f6 := |v54|], v55, globalState) + v0))|;
				f10 := v23.f12;
				v2[safeIndex(22, v2.Length)] := f6 ==> f6;
				var v56 := true;
				var v57: array<array<int>> := new array<int>[25];
				v57[safeIndex(211, v57.Length)] := v51;
				var v58: multiset<bool> := multiset{v56, f6};
				var v59: multiset<int> := multiset{v23.f12};
				v2[safeIndex(22, v2.Length)], v56, v57[safeIndex(211, v57.Length)] := f6 <==> (v58 > fm10(v59, 100, globalState)), v56, v51;
				var v60: map<bool, bool> := map[v56 := false];
				v53 := if (!(|v60| <= 294)) then v53 else v53;
				v56 := !(v52 < [v52[safeIndex(v23.f13, |v52|)]]);
			}
			
			var v61 := new C0(safeModuloInt(0x3b6, f5), p0);
		}
		var v62: map<bool, bool> := map[f6 := f6];
		f10 := |v62| * |(v6[safeIndex(p0, |v6|) := f10] + (seq(abs(0x65), i10  => (0x2c7))))|;
		var v63 := false;
		v63 := !f6;
	}
	method m4(p0: map<int, map<int, bool>>, p1: seq<map<bool, int>>, p2: int, p3: int, globalState: GlobalState) {
		...
		for i0 := p3 to f5 {
			...
			var v4: multiset<int> := multiset{f10, v3[safeIndex(p2, |v3|)], 0x3a1};
			...
			var v10 := false;
			v10 := v10;
			var v11 := DC0(seq(abs(0x1c7), i1  => (p3)));
			match (v11) {
				case DC1(cf1, cf2, cf3, cf4) =>
					...
					v12[safeIndex(446, v12.Length)] := f5;
					v12[safeIndex(446, v12.Length)] := f11 * v6.f13;
				case DC2(cf5, cf6) =>
					...
					v19[safeIndex(898, v19.Length)] := v18;
					v19[safeIndex(898, v19.Length)] := v18;
					var v20: seq<array<bool>> := [v19[safeIndex(898, v19.Length)]];
					var v21: map<int, seq<array<bool>>> := map[|[v6.f12]| := v20[safeIndex(f11, |v20|) := v18]];
				...
				case DC0(cf0) =>
					...
					var v28 := 'n';
					var v29 := "xcfy";
					var v30 := DC6(f6, |v27|, v6.f12, v28 !in v29[safeIndex(v6.f13, |v29|) := v28]);
					v30 := v30;
					v10 := v10;
		...
		var v36: array<int> := new int[5](i3 => safeModuloInt(i3, p3));
		var v37: map<int, array<int>> := map[f10 := v36];
		var v38 := DC11(v36);
		v33 := fm12(|v34| * f10, !(|map[|v35| := if (f10 in v37) then v37[f10] else v38.cf27]| == 431), seq(abs(-214), i4  => ('v')), globalState);
		...
		v41 := v41[if (v43.cf6) then f11 else fm6(|v44|, p3, false, 0x189, globalState) := v40[f5 := abs(515)]];
		var v45 := 'i';
		var v46: map<char, int> := map[v45 := p3];
		var v47 := DC13(v46);
		var v48 := new C0(f11, if (!false) then |(v47.(cf30 := v46)).cf30| else p2);
		forall i5 | 0 <= i5 < v36.Length {
			v36[i5] := i5 + safeModuloInt(f11, v48.f12);
		}
	}
}
...
class C2 {
	...
	method m3(p0: string, globalState: GlobalState) returns (r0: map<map<char, D0>, int>) {
			...
			decreases 100 - i0
		{
			...
			v2 := (if (p0 in v3) then v3[p0] else v4[safeIndex(249, |v4|)]) - (v2 - v2);
			var v5: map<int, string> := map[safeDivisionInt(v1.f5, 0x265) := seq(abs(193), i1  => ('d'))];
			v5 := v5[v1.f5 := if (v1.f6) then "byj" else p0];
			var v6: array<bool> := new bool[2];
			v6[safeIndex(353, v6.Length)] := v0;
			v6[safeIndex(353, v6.Length)] := !!(v1.f5 == fm6(v1.f5, f9, v0, v1.f5, globalState));
			var v7: map<bool, int> := map[v0 := f9];
			var v8: map<bool, map<bool, int>> := map[v6[safeIndex(353, v6.Length)] := v7];
			var v9: seq<int> := [v1.f5];
			var v10 := DC1(p0, f9, v7, v9);
			var v11: map<int, map<bool, int>> := map[f9 := v7];
			var v12: multiset<int> := multiset{v1.f5};
			var v13 := DC6(v0, |v12|, v9[safeIndex(v1.f5, |v9|)], v1.f6);
			var v14: seq<bool> := [v6[safeIndex(353, v6.Length)], v6[safeIndex(353, v6.Length)], v6[safeIndex(353, v6.Length)], v1.f6, v13.cf20];
			var v15: multiset<int> := multiset{|v14|, v1.f5, f9, v1.f5, f9};
			var v16 := DC8(v15);
			var v17: array<map<bool, int>> := new map<bool, int>[19] [if (v1.f6 in v8) then v8[v1.f6] else map[v6[safeIndex(353, v6.Length)] := v1.f5], v7, v7, v10.cf3 + v7, v7, v7, v7, v7, v7, v7, v7, v7, v7 + (if (v1.f5 in v11) then v11[v1.f5] else v7), v7 + v7, v7, v7[v1.f6 := v1.f5], v7, fm13(p0, if (-v1.f5 in v15) then v15[-v1.f5] else 0x90, v16.cf22, globalState), v7];
			v17 := v17;
		}
			...
			decreases 100 - i2
		{
			...
			match (fm14(v0 !in v20, globalState)) {
				...
				case DC6(cf17, cf18, cf19, cf20) =>
					...
					var v40 := 'u';
					var v41: array<bool> := new bool[28] [!v0 <==> cf20, v0, DC9(v34.cf23, 0x329, |p0|).cf23, !cf20, v0, v0, cf17 <== v0, cf17, !!(v0 ==> cf20), cf20, cf17, v0 !in v31, cf17, v34.cf23, cf20, v0, cf17, v0, v0 <== v38.cf6, cf20, multiset{!cf20} !! v39, cf20, v19 == v19, v33.fm2(v35, v33.f11, cf18, globalState), cf20, fm1(v33.f10, v40, globalState), v20[safeIndex(v30, |v20|)], v0];
					v41[safeIndex(564, v41.Length)] := cf17;
					var v42: map<bool, int> := map[v0 := |v27|];
					var v43: seq<map<bool, int>> := [v42];
					var v44 := DC1(p0, v29, v43[safeIndex(v33.f10, |v43|)], seq(abs(0x22d), i3  => (v30)));
					v41[safeIndex(564, v41.Length)] := v40 in v44.cf1;
				case DC3(cf7) =>
					var v45: array<char> := new char[19](i4 => if (true) then 'w' else 'l');
					var v46 := 'f';
					v45[safeIndex(407, v45.Length)] := v46;
					v45[safeIndex(407, v45.Length)] := v46;
					var v47: array<bool> := new bool[22];
					v47[safeIndex(588, v47.Length)] := !v0;
					v47[safeIndex(588, v47.Length)] := v0;
					var v48: multiset<int> := multiset{-f9, f9, f9, f9};
					var v49 := DC8(v48);
					v49 := v49.(cf22 := v48);
					var v50: array<array<bool>> := new array<bool>[5];
					v50[safeIndex(834, v50.Length)] := v47;
					v50[safeIndex(834, v50.Length)] := new bool[18];
				case DC7(cf21) =>
					...
					v55[safeIndex(163, v55.Length)] := |(map v58 : int | (809 <= v58) && (v58 < 0xba) :: (safeModuloInt(v58, f9)) := (v54))|;
					v55[safeIndex(163, v55.Length)] := v57;
			...
			v62[safeIndex(252, v62.Length)] := v20[safeIndex(-|p0|, |v20|)];
			v62[safeIndex(252, v62.Length)] := v0;
			v62[safeIndex(252, v62.Length)] := v62[safeIndex(252, v62.Length)] || v62[safeIndex(252, v62.Length)];
			v62[safeIndex(252, v62.Length)] := f9 == f9;
		}
		v0 := v0 <==> v0;
		var v63 := DC14();
		v63 := v63;
...
class C3 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v4 := new C2(v3[safeIndex(f5, |v3|)] + p0);
			var v5: set<int> := {p0, f5, p0, f5};
			var v6: map<int, int> := map[v4.f9 := 408];
			var v7: map<bool, bool> := map[v0 := v0];
			var v8: array<int> := new int[15] [fm6(0x38, v4.f9, v0, p0, globalState), f8, v4.f9, v4.f9, v4.f9, safeModuloInt(f8, f5), -v4.f9, v4.f9 * |v5|, fm6(v4.f9, f8, v0, f5, globalState), f8, if (f5 in v6) then v6[f5] else v3[safeIndex(-p0, |v3|)], v4.f9, safeModuloInt(v4.f9, p0), |((seq(abs(0x379), i1  => (v4.f9))) + v3)|, if (v0) then -|v7| else p0];
			v8[safeIndex(279, v8.Length)] := v4.f9;
			var v9: array<array<bool>> := new array<bool>[20];
			var v10: array<bool> := new bool[29];
			v9[safeIndex(888, v9.Length)] := v10;
			v8[safeIndex(279, v8.Length)], v9[safeIndex(888, v9.Length)], v4.f9 := --f5, v10, f5;
			v9[safeIndex(888, v9.Length)][safeIndex(338, v9[safeIndex(888, v9.Length)].Length)] := f6;
			var v11: T0 := new C1(v8[safeIndex(279, v8.Length)], f5, v4.f9, f6);
			var v12 := 'b';
			var v13: seq<char> := [v12];
			var v14 := DC16(v11, false, |v13|);
			v0, v9[safeIndex(888, v9.Length)][safeIndex(338, v9[safeIndex(888, v9.Length)].Length)] := (v14.(cf33 := v0)).cf33, f6;
		}
		if (p0 <= p0) {
			var v15 := 'o';
			...
			v20 := if (f6) then v21[safeIndex(|v23|, |v21|)] else v20;
			...
			v25 := v27[safeIndex(|((map v28 : int | (0x77 <= v28) && (v28 < 0x73) :: (safeDivisionInt(v28, v18.f13)) := (!f6)) + (map v29 : int | (223 <= v29) && (v29 < 0x1b9) :: (v29 + v18.f13) := (true)))|, |v27|)];
			var v30: array<C2> := new C2[29];
			var v31: set<char> := {v15, v15, v15, v15};
			var v32: C2 := new C2(|v31|);
			v30[safeIndex(190, v30.Length)] := v32;
			v30[safeIndex(190, v30.Length)] := v32;
			var v33 := true;
			v33 := f6;
			v15 := 'r';
			...
			var v37 := new C1(|((seq(abs(0x112), i2  => (map[f6 := f6]))) + v35)|, f5, |v36|, if (f6) then f6 else f6);
			var v38: array<seq<bool>> := new seq<bool>[10];
			var v39: seq<bool> := [true];
			var v40: map<int, seq<bool>> := map[f8 := v39];
			var v41 := DC17(v39);
			v38 := new seq<bool>[28] [(v39 + v39)[safeIndex(|(if (v37.f10 in v40) then v40[v37.f10] else v39)|, |(v39 + v39)|) := f6], v39, v39 + v39, DC17(v39).cf35, [f6, f6], fm16(globalState), fm16(globalState), v39 + v39, v39, v39, v39 + v39, (fm18(globalState)).cf35, [true], v39, v39, v39 + v41.cf35, v39 + v39, v39, [f6], [f6], [f6, f6], v39, (v39 + v39)[safeIndex(v37.f10, |(v39 + v39)|) := false], v39, v39 + v39, v39, [true], v39];
			var v42: array<bool> := new bool[18](i3 => f6);
			var v43: seq<int> := [f5];
			var v44: seq<int> := [|v43|];
			v42[safeIndex(947, v42.Length)] := v44 <= v43;
			var v45: array<int> := new int[11];
			var v46 := DC11(v45);
			v42[safeIndex(947, v42.Length)], v46 := false, v46;
			var v47 := 'n';
			v47 := v47;
			...
			var v52: map<multiset<int>, string> := map[v49[safeIndex(f5, |v49|)] := v51[safeIndex(v37.f11, |v51|)]];
			v42[safeIndex(947, v42.Length)] := if (v37.fm0(f6, globalState)) then !(v37.f10 > |v52|) else v48 > v48;
		}
		...
		for i4 := f5 - fm6(p0, f5, f6, p0, globalState) to -|v53| {
			...
			v54 := safeDivisionInt(|(v57 + v57)|, v54);
			var v58 := true;
		...
		v69[safeIndex(417, v69.Length)] := v70 + v70;
		v69[safeIndex(680, v69.Length)] := v70;
		var v71 := false;
		var v72 := DC7(DC4(v71, v71, seq(abs(0x1fc), i6  => (v64)), p0, fm6(f8, -0x3e0, v71, 0x396, globalState)));
		var v73: map<D1, multiset<bool>> := map[v72 := v67];
		v66, v68, v69[safeIndex(417, v69.Length)], v69[safeIndex(680, v69.Length)], v71 := v66, DC15(v67).(cf31 := if (DC7(fm14(v71, globalState)) in v73) then v73[DC7(fm14(v71, globalState))] else v67), v70 + v70, fm16(globalState), v71;
		var v74: array<int> := new int[25](i8 => i8 - p0);
		forall i7 | 0 <= i7 < v74.Length {
			v74[i7] := safeDivisionInt(i7, p0);
		}
		var v75: set<bool> := {v71, f6};
		var v76: seq<int> := [-|v75|];
		v74[safeIndex(399, v74.Length)] := v76[safeIndex(|v53|, |v76|)];
		v74[safeIndex(399, v74.Length)] := f5 + |(v75 - v75)|;
	}
	method m2(p0: int, p1: string, p2: int, p3: bool, globalState: GlobalState) returns (r0: array<array<D0>>, r1: D0) {
		...
		var v12: array<int> := new int[9] [p0, |v6|, v0, |(v9 + v9)|, 0x299 + 0x30c, v5.f5, safeDivisionInt(v3.f5, f5), v3.f5, fm6(p0, |v11|, v5.f6, fm6(fm6(v3.f5, f8, v3.f6, v5.f5, globalState), v0, p3, p0, globalState), globalState)];
		v12[safeIndex(109, v12.Length)] := safeModuloInt(f8, v3.f5);
		...
		v0, v5, v12[safeIndex(109, v12.Length)], v13, v5 := fm6(|fm19(|v14|, globalState)|, -(|p1| * p0), p3, |"doyklvo"|, globalState), if (f6 in v15) then v15[f6] else v3, fm6(v3.f5, |(v6 + (if (v3.f6 in v16) then v16[v3.f6] else v6))|, v3.fm0(p3, globalState), safeModuloInt(v0, p2), globalState), if (fm0(p3, globalState)) then v13 else fm20(-|p1|, v14, f6, f6, globalState), v3;
		if (if (v3.f6 in v11) then v11[v3.f6] else fm0(v5.f6, globalState)) {
			var v17 := new C0(p2, |v7|);
			if (v14 >= v14) {
				v12[safeIndex(109, v12.Length)] := v17.f12;
				v0 := fm6(v0 * v5.f5, -p2, v3.f6, v17.f13 * p2, globalState);
				var v18: map<int, string> := map[v17.f13 := seq(abs(737), i0  => ('d'))];
				var v19: array<string> := new string[17] [if (v17.f12 in v18) then v18[v17.f12] else p1, p1, "xvmci", seq(abs(0x3c2), i1  => ('a')), seq(abs(0x38c), i2  => ('v')), "ea", p1, p1, p1, p1, seq(abs(0x354), i3  => ('r')), p1, p1, p1, p1, seq(abs(0x207), i4  => ('y')), p1];
				var v20: map<int, array<string>> := map[v5.f5 := v19];
				v20 := v20[-f8 := v19];
				v19[safeIndex(980, v19.Length)] := p1;
				...
				v19[safeIndex(980, v19.Length)], v0, v21, v24 := p1 + p1, 0x1e1, v21, if (v0 in v25) then v25[v0] else v24;
				var v26 := DC17(v8);
				v26 := v26.(cf35 := v8 + v8);
			} else {
				var v27 := DC4(v5.f6, p3, p1 + "ahcbwma", v5.f5, safeDivisionInt(|v10|, v17.f12));
				v27 := v27;
				var v29: seq<set<int>> := [v1, set v28 : int | (626 <= v28) && (v28 < 0x34b) :: (v28 + v5.f5), v1];
				var v31: array<set<int>> := new set<int>[20] [v1 - v1, v1, v1, fm21(globalState), v1, v29[safeIndex(|p1|, |v29|)], {v3.f5} + v1, v1 - {-219}, v1, v1, v1, set v30 : int | (-558 <= v30) && (v30 < -0x2fc) :: (safeDivisionInt(v30, v12[safeIndex(109, v12.Length)])), v1 + v1, v1, v1, v1, v1, v1, v1, v1];
				v31[safeIndex(347, v31.Length)] := v1;
				v31[safeIndex(347, v31.Length)] := v1 * (v1 + v1);
				var v32: array<bool> := new bool[5](i5 => v3.f6);
				v32[safeIndex(721, v32.Length)] := v3.f6;
				v32[safeIndex(721, v32.Length)] := false ==> ((seq(abs(-432), i6  => ('w'))) != p1);
				v32[safeIndex(721, v32.Length)], v12[safeIndex(109, v12.Length)] := false ==> v32[safeIndex(721, v32.Length)], safeModuloInt(p0, 0x2a0) + v3.f5;
				var v33 := DC11(v12);
				v33 := v33;
			}
			
			var v34: array<bool> := new bool[9] [v3.f6, v3.f6, p3, p3, v3.f6, v3.f6, v3.f6, false, v5.f6];
			v34[safeIndex(913, v34.Length)] := v5.f6;
			v34[safeIndex(913, v34.Length)] := p3;
			v34[safeIndex(913, v34.Length)] := v5.f6;
			v12[safeIndex(109, v12.Length)] := v12[safeIndex(109, v12.Length)];
		} else {
			var v35: map<seq<int>, bool> := map[v6 := v3.f6];
			var v36: array<bool> := new bool[23] [true, v5.f6, v3.f6, v1 !! v1, v5.f6, true, v3.f6, v5.f6, v3.f6, p3, v5.fm0(v3.f6, globalState), f8 < v0, if (p3) then v3.f6 else p3, v5.f6, v5.f6, f6, if ([p2, v5.f5, v12[safeIndex(109, v12.Length)], v12[safeIndex(109, v12.Length)]] in v35) then v35[[p2, v5.f5, v12[safeIndex(109, v12.Length)], v12[safeIndex(109, v12.Length)]]] else f6, true, v3.f6, f6, f6, p3 <== v5.f6, v3.f6 <== v8[safeIndex(-|multiset{fm0(v3.f6, globalState), f6}|, |v8|)]];
			v36[safeIndex(375, v36.Length)] := p3;
			v36[safeIndex(375, v36.Length)] := p3;
			var v37: map<int, array<bool>> := map[p2 := v36];
			v37 := v37[v12[safeIndex(109, v12.Length)] := v36];
			v8 := fm16(globalState);
			v36[safeIndex(375, v36.Length)] := v5.f6;
			var v38: seq<string> := [p1];
			var v39 := DC4(p0 > v0, v3.fm0(p3, globalState), p1, v3.f5 - |v38[safeIndex(-v12[safeIndex(109, v12.Length)], |v38|)]|, v3.f5);
			match (v39) {
				case DC4(cf8, cf9, cf10, cf11, cf12) =>
					...
					v43[safeIndex(199, v43.Length)] := v5;
					v43[safeIndex(199, v43.Length)] := if (p3 in v15) then v15[p3] else v5;
					cf8 := v3.f6;
				case DC5(cf13, cf14, cf15, cf16) =>
					cf15 := v5.f5;
					var v44 := 'e';
					v12, cf14, cf13 := v12, DC4(v5.f6, if (false in v11) then v11[false] else p3, p1, p0, v5.f5).cf8, v44 !in "vhrqm";
					cf16 := |(seq(abs(138), i7  => (v3.f5)))|;
					cf14 := v5.f6;
				case DC6(cf17, cf18, cf19, cf20) =>
					var v45: C2 := new C2(v3.f5);
					var v46: map<array<int>, C2> := map[v12 := v45];
					var v47: seq<array<int>> := [v12];
					var v48: map<C2, set<int>> := map[if (v47[safeIndex(v3.f5, |v47|)] in v46) then v46[v47[safeIndex(v3.f5, |v47|)]] else v45 := {v3.f5, p2}];
					v48 := v48;
					v36 := v36;
					var v49 := 'k';
					...
					var v53: array<map<int, int>> := new map<int, int>[15] [v9, v9, v9, v9, map v51 : int | v51 in v9 :: (v51 * cf19) := (cf19), v9[v3.f5 := v5.f5], v9, v9, v9, v52[safeIndex(-0x108, |v52|)], v9, v9[0x3c7 := f8], map[515 := v0], v9, v9];
					v50[safeIndex(473, v50.Length)] := v53;
					var v54: seq<array<map<int, int>>> := [v53, v53, v53, v53];
					v50[safeIndex(473, v50.Length)] := v54[safeIndex(-573, |v54|)];
				case DC3(cf7) =>
					v36[safeIndex(375, v36.Length)] := v5.f6;
					v12[safeIndex(109, v12.Length)], v12[safeIndex(109, v12.Length)] := v5.f5, v3.f5;
					var v55 := DC11(v12);
					...
					v57 := v57[v5.f5 + p0 := p1];
				case DC7(cf21) =>
					v36[safeIndex(375, v36.Length)] := v3.f6;
					v0 := p2;
					var v58: array<array<bool>> := new array<bool>[9];
					var v59: seq<array<bool>> := [v36, v36];
					var v60: map<bool, int> := map[true := v13.cf19];
					v36[safeIndex(375, v36.Length)], v58, v12[safeIndex(109, v12.Length)], v12[safeIndex(109, v12.Length)] := !(true <==> (v36 !in v59)), v58, safeModuloInt(|(v14 - v14)|, |v60|), fm6(v0, v3.f5 + p2, true, 0xc5, globalState);
					v36[safeIndex(375, v36.Length)] := true;
			}
			
		}
		
		var v61 := new C2(v12[safeIndex(109, v12.Length)] * -v0);
		var i8 := 0;
		while (!v5.f6)
			decreases 100 - i8
		{
			...
			var v63: map<seq<char>, array<string>> := map[if (!false) then p1 else seq(abs(0x1b9), i9  => ('b')) := v62];
			v63 := v63[p1 + p1 := v62];
			var v64: map<bool, int> := map[v3.f6 := v3.f5];
			var v65: seq<seq<int>> := [v6, seq(abs(141), i10  => (p2))];
			v64 := v64[v65[safeIndex(v5.f5, |v65|)] <= v6 := -v5.f5];
			var v66 := new C2(safeModuloInt(0x249, -f8));
			v62[safeIndex(434, v62.Length)] := p1;
			var v67 := true;
			var v68: map<int, map<bool, int>> := map[v5.f5 := v64];
			var v69: seq<string> := [fm5(map[p3 := |[v5.f5]|], v68, globalState), p1];
			v62[safeIndex(434, v62.Length)], v61.f9, v67, v67, v67 := p1 + v69[safeIndex(|v8|, |v69|)], f5, p3, (v3.f5 <= v3.f5) ==> f6, v61.f9 != v5.f5;
		}
		var v70 := DC11(v12);
		var v71: seq<D3> := [v70];
...
class C4 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) {
		...
		v13[safeIndex(428, v13.Length)] := v10.f6;
		v13[safeIndex(428, v13.Length)] := v10.f6;
		v13[safeIndex(428, v13.Length)] := v10.f6;
		if (f6) {
			var v14: array<multiset<D3>> := new multiset<D3>[17];
			var v15 := DC21(v14);
			v13[safeIndex(428, v13.Length)], v15, v13[safeIndex(428, v13.Length)], v12, f7 := false, v15, !v10.f6, v12, v9.f8;
			v13[safeIndex(428, v13.Length)] := if (v13[safeIndex(428, v13.Length)]) then v13[safeIndex(428, v13.Length)] else v10.f6;
			...
			var v22: map<bool, int> := map[v21.cf33 := v1[safeIndex(f7, |v1|)]];
			var v23: map<int, bool> := map[|v22| := true];
			var v24 := new C3(v9.f8, |v23|, false);
			var v25 := new C3(v9.f8, f7 * (if (v13[safeIndex(428, v13.Length)] in v22) then v22[v13[safeIndex(428, v13.Length)]] else |multiset{v13[safeIndex(428, v13.Length)]}|), v24.f8 > v24.f8);
			var v26 := 'e';
			v12 := (v12 + v12) + v12[safeIndex(fm6(-0x222, v5.f12, v10.f6, v5.f13, globalState), |v12|) := v26];
			...
			decreases 100 - i0
		{
			...
			var v30 := DC15(v29[f6 := abs(|v12|)]);
			v28[safeIndex(784, v28.Length)] := v30.(cf31 := fm10(multiset{v5.f12, v5.f12, -0x35f}, f5, globalState));
			var v31: C1 := new C1(|['i']|, f5, v9.f8, false);
			var v32: map<bool, C1> := map[v10.f6 := v31];
			var v33: map<bool, int> := map[f6 := f7];
			v28[safeIndex(784, v28.Length)] := fm22(|(v32 + v32)|, v12, v31.f11 - DC1(v12, v9.f8, v33, v1).cf2, seq(abs(0x7e), i2  => ('o')), globalState);
			...
			v36 := v36[v37.cf34 := f6];
			f7, v36 := -v5.f12, (map[v10.f5 := v10.f6])[v10.f5 * v5.f13 := v13[safeIndex(428, v13.Length)]];
		}
		v12 := v12;
		...
		v40[safeIndex(860, v40.Length)] := v39;
		v40[safeIndex(860, v40.Length)] := v39;
	}
}
...
function fm6(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): int {
	|((multiset{0x2b5} * multiset{533, |[false]|, |(map v0 : char | v0 in {'j'} :: (v0) := (--|[|"vnemwohk"|, |[762]|]|))|}) + multiset{|DC4(!DC4(false, true, "rookixm", 0x114, |[false]|).cf9, true, "kowjt", 0x158, 0x1c4).cf10|, -0xf9, 0x125, DC4(false, true, seq(abs(299), i0  => ('n')), 361, |(seq(abs(-0x2e3), i1  => ('v')))|).cf12})|
}
function fm9(p0: int, globalState: GlobalState): D0 {
	DC1("khaefkx", safeModuloInt(|multiset{false, false, false, false, DC23(|map[-|DC25({false, false}).cf49| := false]|, -|multiset{'o'}|, true, map[934 := {true}], -0x34c).cf45}|, 0x70), map[!false := 0x75], [724] + [-729])
}
...
function fm17(p0: bool, globalState: GlobalState): seq<seq<char>> {
	(seq(abs(0x277), i0  => (['a']))) + ([['x']] + (seq(abs(814), i1  => (['b']))))
}
...
function fm19(p0: int, globalState: GlobalState): set<multiset<int>> {
	{multiset(seq(abs(0x312), i0  => (0xd0))), multiset{-0x246, 0x329}, multiset{|(seq(abs(0x3d6), i1  => ('g')))|}} + ({multiset([|"seyfsdjs"|, 136]), multiset{|{|"pwmmx"|}|}, multiset{|{true, true}|}} * {multiset([|"dnlhtu"|])})
}
...
function fm21(globalState: GlobalState): set<int> {
	set v0 : int | (-0x165 <= v0) && (v0 < 743) :: (safeModuloInt(v0, |[map[false := !false], map[true := true]]|))
}
...
method m0(p0: int, p1: int, globalState: GlobalState) returns (r0: string, r1: array<int>, r2: int, r3: int) {
	...
	for i0 := p1 to |v1| {
		...
		v0 := (map v2 : int | v2 in v3 :: (safeDivisionInt(v2, i0)) := (p0)) != v4;
		var v5: array<int> := new int[25](i1 => safeDivisionInt(i1, p0));
		v5[safeIndex(500, v5.Length)] := p0;
		var v6 := "riotpp";
		var v7 := DC4(v0, v0, v6, p1, p0);
		var v8: seq<seq<bool>> := [v1];
		var v9: C3 := new C3(|(v8[safeIndex(p0, |v8|)])[safeIndex(0x16c, |v8[safeIndex(p0, |v8|)]|) := v0]|, i0, v0);
		var v10: seq<C3> := [v9, v9, v9];
		var v11: multiset<int> := multiset{i0, p0, --|v10|, i0, |v6|};
		v5[safeIndex(500, v5.Length)], r2, r3 := p1 - v7.cf12, |DC8(v11).cf22|, i0;
		r2 := (p1 * |v6|) + p0;
		var v12 := new C2(safeDivisionInt(p1, v5[safeIndex(500, v5.Length)]));
	}
	r2 := p0;
	var v13 := 'q';
	v13 := match DC20(v13) {
	...
	v14[safeIndex(835, v14.Length)] := |v16|;
	v14[safeIndex(835, v14.Length)] := p0;
	...
	var v20: C0 := new C0(867, if (v0 in v19) then v19[v0] else v14[safeIndex(835, v14.Length)]);
	...
	r1 := new int[10] [v14[safeIndex(835, v14.Length)], -p1, 0x70, p0, p1 * fm6(v20.f12, v15.f5, v15.f6, v20.f13, globalState), p1, v25[safeIndex(v20.f12, |v25|)], v20.f12, v14[safeIndex(835, v14.Length)] + v20.f13, v20.f12];
	r2 := v14[safeIndex(835, v14.Length)];
	r3 := |[v14]|;
}
method Main() {
	var v0 := false;
	...
	var v7 := "oxasa";
	var v8: seq<bool> := [v0];
	var v9: array<int> := new int[29] [v1, if (v2 in v3) then v3[v2] else 0x57, 0x368, |v4|, v1, v1, v1, -v1, |v6|, |[v1, v1]|, -v1, |v7|, v1, |v7|, |(seq(abs(325), i0  => (v2)))|, v1, v1, v1, v1, v1, |v8|, v1, |(seq(abs(0x2f), i1  => (v2)))|, v1, v1, -v1, v1, v1, v1];
	var v10: map<bool, array<int>> := map[v0 := v9];
	var v11: set<int> := {v1};
	var v12: seq<string> := [seq(abs(0x1db), i2  => (v2))];
	var globalState := new GlobalState(0x2fe, v10, [v11], v12, true);
	var v13, v14, v15, v16 := m0(0x35d + |(seq(abs(0x1eb), i3  => (v2)))|, v1, globalState);
	var v17: multiset<int> := multiset{v16, v15, v15};
	v16 := safeModuloInt(v16, |(v17 * v17)|);
	var v18: array<multiset<int>> := new multiset<int>[6];
	v18[safeIndex(816, v18.Length)] := v17;
	var v19: seq<multiset<int>> := [v17];
	var v20: seq<int> := [0x2d0];
	v18[safeIndex(816, v18.Length)] := (v17 * v19[safeIndex(|v13|, |v19|)]) * (multiset(v20) + multiset((DC1(v13, v15, v4, ([|v11|, v1])[safeIndex(v15, |[|v11|, v1]|) := v15]).(cf3 := v4, cf1 := v7)).cf4));
	var v21: map<int, int> := map[v16 := safeModuloInt(0x7d, v16)];
	var v22 := DC1("vewema", v1, v4, v20);
	v21 := v21[v15 - v22.cf2 := -(0x2e5 * v16)];
	v15 := v16;
	var v23: array<map<bool, bool>> := new map<bool, bool>[27](i4 => v5);
	v23[safeIndex(758, v23.Length)] := v5 + v5;
	v23[safeIndex(758, v23.Length)] := v5 + (v5 + v5);
	v2 := 'y';
	...
	if (|v11| >= v1) {
		...
		match (v27) {
			case DC1(cf1, cf2, cf3, cf4) =>
				v0 := ((seq(abs(-964), i5  => (v2)))[safeIndex(v16, |(seq(abs(-964), i5  => (v2)))|) := v2] + "l")[safeIndex(v15, |((seq(abs(-964), i5  => (v2)))[safeIndex(v16, |(seq(abs(-964), i5  => (v2)))|) := v2] + "l")|) := v2] == v7;
				var v28 := new C0(cf2, -v1);
				cf2 := safeDivisionInt(v28.f13, cf2);
				v15 := v16 - v28.f13;
			case DC2(cf5, cf6) =>
				v15 := v16;
				v24[safeIndex(847, v24.Length)] := cf6;
				v9[safeIndex(116, v9.Length)] := v15;
				var v29: C0 := new C0(v1, v15);
				var v30: map<C0, bool> := map[v29 := true];
				var v31: map<int, map<bool, int>> := map[|v30| := v4];
				v24[safeIndex(187, v24.Length)] := v15 > |fm5(v4, v31, globalState)|;
				var v32: set<bool> := {true};
				v24[safeIndex(847, v24.Length)], v18[safeIndex(816, v18.Length)], v9[safeIndex(116, v9.Length)], v24, v24[safeIndex(187, v24.Length)] := v0 <==> false, v17 + v18[safeIndex(816, v18.Length)], v29.f12, v24, !(if (false) then v32 >= v32 else v0);
				v2 := fm11(v2, !v24[safeIndex(847, v24.Length)] || v24[safeIndex(847, v24.Length)], v29.fm8(v24[safeIndex(847, v24.Length)], v7, v2, globalState), globalState);
				var v33: T0 := new C4(v29.f12, v9[safeIndex(116, v9.Length)], cf6);
				v33 := v33;
			case DC0(cf0) =>
				var v34, v35, v36, v37 := m0(v15, v1, globalState);
				var v38: array<string> := new string[11];
				v38[safeIndex(373, v38.Length)] := v13;
				v38[safeIndex(373, v38.Length)] := v13;
				var v39: array<char> := new char[20](i6 => 'u');
				v39[safeIndex(60, v39.Length)] := v2;
				v39[safeIndex(60, v39.Length)] := v2;
				v15 := v1;
		}
		...
		v42[safeIndex(472, v42.Length)] := v41;
		v42[safeIndex(472, v42.Length)] := if (v41.f6) then v41 else v41;
	} else {
		...
		v0 := v2 !in (if (v44 in v45) then v45[v44] else v13)[safeIndex(|v47|, |(if (v44 in v45) then v45[v44] else v13)|) := v2];
		v0, v16 := if (v0) then true else v46.f6, (v15 + v1) * -(|v8| - |v8|);
		v2, v16 := v2, -v16;
	}
	
	v1 := safeModuloInt(v20[safeIndex(v15, |v20|)], v15);
	if (fm24(globalState)) {
		v0 := v0;
		var v49 := DC3(map v48 : int | v48 in {v15} :: (safeModuloInt(v48, 236)) := (v0));
		var v50: C3 := new C3(-0x12e, |v20|, v0);
		var v51: T0 := new C1(v16, v15, |map[v49 := v50]|, v0);
		var v52 := DC16(v51, v51.f6, v16);
		var v53 := new C0(fm6(|multiset{v0}|, v1, v0, v1, globalState) + fm6(|v20|, v16, v0, |"puoy"|, globalState), safeModuloInt(-v16, v52.cf34));
		v2 := fm11(v2, v0 && v51.f6, v51.f6, globalState);
		v2 := v2;
		v9[safeIndex(658, v9.Length)] := v53.f13 - v53.f13;
		v13, v1, v9[safeIndex(658, v9.Length)] := v13, v53.f12 + v15, v1;
	} else {
		...
		match (DC12(DC2(v55, fm24(globalState)).cf6, |v17|).(cf28 := v0)) {
			case DC12(cf28, cf29) =>
				...
				v57 := v57[v56 := v58[safeIndex(cf29, |v58|)]];
				var v59, v60, v61, v62 := m0(v15, v1, globalState);
				var v63: C0 := new C0(v1, v16);
				var v64: map<C0, int> := map[v63 := |v18[safeIndex(816, v18.Length)]|];
				...
				v9[safeIndex(831, v9.Length)] := cf29;
				var v66: set<bool> := {v0};
				v9[safeIndex(831, v9.Length)] := |v66|;
			case DC11(cf27) =>
				var v67: map<set<int>, bool> := map[v11 * v11 := !fm24(globalState)];
				v67 := v67[v11 := v0];
				v1 := |(v22.cf3 + fm13("ptcfinu", v16, v19[safeIndex(v15, |v19|)], globalState))|;
				...
				v71[safeIndex(314, v71.Length)] := v7 + v7;
				v71[safeIndex(314, v71.Length)] := v7;
		}
		
		var v72, v73, v74, v75 := m0(safeModuloInt(v1, v15), v16, globalState);
	}
	...
	var v81 := DC10(DC8(v17[v1 := abs(-|(map v80 : char | v80 in v7 :: (v80) := (!v0))|)]));
	var v82 := DC8(v18[safeIndex(816, v18.Length)]);
	match (if (multiset((v78.(cf42 := v77)).cf42) > v79) then v81 else DC10(v82)) {
		case DC9(cf23, cf24, cf25) =>
			v1 := v15;
			v13 := seq(abs(-0x2d), i7  => (v7[safeIndex(v76.f7, |v7|)]));
			cf23 := cf23;
			var v83: C0 := new C0(v1, v15);
			var v84: map<bool, C0> := map[v0 := v83];
			var v85 := new C2(|v84|);
		case DC8(cf22) =>
			v14[safeIndex(5, v14.Length)] := v76.f7 + -v76.f7;
			v14[safeIndex(5, v14.Length)] := v76.f7;
			v76.m1(v76.f7, globalState);
			var v86: array<seq<bool>> := new seq<bool>[21];
			v86[safeIndex(224, v86.Length)] := v8[safeIndex(|v8|, |v8|) := v0];
			v86[safeIndex(224, v86.Length)] := (if (v0) then [v0, true] else v8) + v8;
		...
		case DC10(cf26) =>
			v15 := fm6(v15, safeModuloInt(v76.f7, v76.f7), !v76.fm0(false, globalState), |v18[safeIndex(816, v18.Length)]|, globalState);
		...
		decreases 100 - i8
	{
		...
		var v99, v100, v101, v102 := m0(safeModuloInt(|v98|, v76.f7), if (v0) then v15 else v76.f7, globalState);
		...
		v76.f7 := fm6(safeDivisionInt(0x94, v76.f7), |v106|, v16 != v76.f7, v16 * v1, globalState);
	}
	var v107, v108, v109, v110 := m0(if (v16 in v18[safeIndex(816, v18.Length)]) then v18[safeIndex(816, v18.Length)][v16] else v16, v15, globalState);
	...
	print v2, "\n";
	print v3 == multiset{'d'}, "\n";
	print v4 == map[false := 82], "\n";
	print v5 == map[false := false], "\n";
	...
	print |v10|, "\n";
	print v11 == {82}, "\n";
	print v12 == [['d', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd']], "\n";
	print globalState.f0, "\n";
	print |globalState.f1|, "\n";
	print globalState.f2 == [{82}], "\n";
	print globalState.f3 == [['d', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'd']], "\n";
	...
	print v15, "\n";
	print v16, "\n";
	print v17 == multiset{1, 1352, 1352}, "\n";
	print v18[0] == multiset{1352}, "\n";
	print v19 == [multiset{1, 1352, 1352}], "\n";
	print v20 == [720], "\n";
	print v21 == map[1 := 0, 1270 := -741, 4 := 0], "\n";
	print v22.cf1, "\n";
	print v22.cf2, "\n";
	print v22.cf3 == map[false := 82], "\n";
	print v22.cf4 == [720], "\n";
	print v23[0] == map[false := false], "\n";
	print v23[1] == map[false := false], "\n";
	print v23[2] == map[false := false], "\n";
	print v23[3] == map[false := false], "\n";
	print v23[4] == map[false := false], "\n";
	print v23[5] == map[false := false], "\n";
	print v23[6] == map[false := false], "\n";
	print v23[7] == map[false := false], "\n";
	print v23[8] == map[false := false], "\n";
	print v23[9] == map[false := false], "\n";
	print v23[10] == map[false := false], "\n";
	print v23[11] == map[false := false], "\n";
	print v23[12] == map[false := false], "\n";
	print v23[13] == map[false := false], "\n";
	print v23[14] == map[false := false], "\n";
	print v23[15] == map[false := false], "\n";
	print v23[16] == map[false := false], "\n";
	print v23[17] == map[false := false], "\n";
	print v23[18] == map[false := false], "\n";
	print v23[19] == map[false := false], "\n";
	print v23[20] == map[false := false], "\n";
	print v23[21] == map[false := false], "\n";
	print v23[22] == map[false := false], "\n";
	print v23[23] == map[false := false], "\n";
	print v23[24] == map[false := false], "\n";
	print v23[25] == map[false := false], "\n";
	print v23[26] == map[false := false], "\n";
	print |v25|, "\n";
	print v76.f7, "\n";
	print |v77|, "\n";
	print |v78.cf42|, "\n";
	print |v79|, "\n";
	print v81.cf26.cf22 == multiset{1, 1352, 1352, 0, 0, 0, 0}, "\n";
	print v82.cf22 == multiset{1352}, "\n";
	print i8, "\n";
	print v107, "\n";
	print v108[0], "\n";
	print v108[1], "\n";
	...
	print v109, "\n";
	print v110, "\n";
	print v111 == multiset{false, true}, "\n";
}