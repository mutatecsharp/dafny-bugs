...
class C1 extends T1 {
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
		if (p0 > p0) {
			...
			if (p1.f3) {
				...
				globalState.f0 := safeModuloInt(p0, p0) < p0;
				var v6 := new C0();
				...
				v10[safeIndex(429, v10.Length)] := multiset{p1.f4};
				var v11: multiset<bool> := multiset{p1.f3};
				v10[safeIndex(429, v10.Length)] := v11 - multiset{p1.f4, p1.f4, p1.f4, p1.f4};
			...
			var v15 := 'f';
			v14[safeIndex(917, v14.Length)] := v15;
			v14[safeIndex(917, v14.Length)] := v15;
			...
			if (p1.f3) {
				...
				v22[safeIndex(930, v22.Length)] := p1.f4;
				var v23: map<bool, int> := map[f13 := p0];
				v20, v21, v22[safeIndex(930, v22.Length)], globalState.f0 := f12[safeIndex(|[v23, v23[p1.f4 := -p0]]|, |f12|)], {p1.f4, p1.f3}, (p0 - p0) >= p0, fm21(0x153, fm22(p0, p0, |v23|, globalState), globalState);
				var v24: array<array<seq<bool>>> := new array<seq<bool>>[25];
				var v25: array<seq<bool>> := new seq<bool>[6];
				v24[safeIndex(232, v24.Length)] := v25;
				v24[safeIndex(232, v24.Length)] := new seq<bool>[13];
				var v26: seq<bool> := [if (p1.f3) then p1.f4 else true];
				var v27 := "cw";
				var v28: map<int, char> := map[p0 := v20];
				var v29: map<bool, char> := map[p1.f3 := v20];
				v26, v27, r0, v20, p1.f3 := ([p1.f4, p1.f4, false, v22[safeIndex(930, v22.Length)], f12 == "ter"])[safeIndex(p0, |[p1.f4, p1.f4, false, v22[safeIndex(930, v22.Length)], f12 == "ter"]|) := false], ((seq(abs(-0xa7), i2  => (v20))) + "kjmrx") + f12, p0, if (|(seq(abs(50), i3  => (v20)))| in v28) then v28[|(seq(abs(50), i3  => (v20)))|] else if (f13 in v29) then v29[f13] else fm23(p1.f4, 0x2, globalState), (f12 + f12) == (v27 + f12);
				var v30: multiset<int> := multiset{p0, 134, |([|multiset(v27)|, 0x17e, |v23|])[safeIndex(|v27|, |[|multiset(v27)|, 0x17e, |v23|]|) := p0]|};
				...
				var v34 := DC5(p1.f3, p1.f4, safeModuloInt(p0, p0), p0);
			...
			var v40: seq<C0> := [v38];
			var v41 := DC7(v39);
			var v42: array<multiset<C0>> := new multiset<C0>[10] [v39, multiset{v40[safeIndex(p0, |v40|)], v38, v38, v38, v38}, v39, v39 + multiset{v38}, multiset([v38]), v39 - (multiset{v38})[v38 := abs(p0)], v39[v38 := abs(p0)], multiset(if (!false) then v40 else v40), v41.cf12, v39];
			v42[safeIndex(637, v42.Length)] := v39;
			v42[safeIndex(637, v42.Length)] := v39;
			...
			var v48: seq<string> := [v45[safeIndex(|{p1.f3, p1.f3, p1.f3}|, |v45|)], ((v38.fm11(v46, v47, globalState))[safeIndex(-p0, |v38.fm11(v46, v47, globalState)|) := f12[safeIndex(p0, |f12|)]])[safeIndex(p0, |(v38.fm11(v46, v47, globalState))[safeIndex(-p0, |v38.fm11(v46, v47, globalState)|) := f12[safeIndex(p0, |f12|)]]|) := v46]];
			var v49: seq<bool> := [true];
			v48 := [f12 + f12, ("a")[safeIndex(|{p1.f4, f13, p1.f4, v49[safeIndex(0x10b, |v49|)], true}|, |"a"|) := v46]];
		}
		...
		if (((map v50 : char | v50 in v52 :: (v50) := (multiset([|f12|, p0, |map[false := !p1.f3]|, p0, p0]))) + v53) != v53) {
			...
			if (|v54| == p0) {
				...
				r0 := safeModuloInt(p0, -|v55|);
				r0 := p0;
				var v56: seq<int> := [p0, p0, |(seq(abs(173), i4  => ('h')))|];
				...
				v59[safeIndex(935, v59.Length)] := v56;
				v59[safeIndex(935, v59.Length)] := v56;
			} else {
				v51 := v51;
				...
				v61[safeIndex(213, v61.Length)] := p1.f4;
				v61[safeIndex(213, v61.Length)] := (if (!true) then -p0 else p0) != p0;
				p1.f3 := p1.f3;
			...
			v65[safeIndex(531, v65.Length)] := p0;
			r0, v65[safeIndex(531, v65.Length)] := p0, p0;
			var v66 := new C0();
		} else {
		...
		var v84: array<int> := new int[24] [p0, if (v75[safeIndex(p0, |v75|)]) then p0 else |v76|, p0, p0, p0, |"myku"| - p0, if (p1.f4 in v77) then v77[p1.f4] else p0, safeDivisionInt(if (p0 in v78) then v78[p0] else p0, p0), p0, if (p1.f4) then p0 else p0, p0, -(p0 * p0), 373, 974, |"qrv"|, p0 - p0, |f12|, p0, 0x1, if (p1.f3 in v80) then v80[p1.f3] else p0, -114, |fm25(globalState)|, p0, |v83|];
		v84[safeIndex(188, v84.Length)] := |(f12 + "ywt")|;
		var v85: multiset<string> := multiset{f12 + "x"};
		v84[safeIndex(188, v84.Length)] := if (f12 in v85) then v85[f12] else p0;
		if (p1.f4) {
			var v86: map<bool, set<bool>> := map[p1.f3 := v76];
			v86 := (v86 + v86[p1.f4 := v76])[p1.f4 := v76];
			var v87: seq<array<int>> := [v84, v84];
			v84, globalState.f0 := v87[safeIndex(p0, |v87|)], p1.f4;
			var v88: set<int> := {p0};
			v74[safeIndex(673, v74.Length)] := v88 <= v88;
			v74[safeIndex(673, v74.Length)] := f13;
			var v89 := "kttjwxwja";
			v89 := (seq(abs(0x248), i6  => (DC1(false, v51).cf2)))[safeIndex(p0, |(seq(abs(0x248), i6  => (DC1(false, v51).cf2)))|) := fm23(p1.f3, -p0, globalState)];
			r0 := -(|v76| - safeModuloInt(v84[safeIndex(188, v84.Length)], |v89|));
		} else {
			var v90 := "lvigjoi";
			v90 := (v90 + v90[safeIndex(-p0, |v90|) := v51]) + (v90 + f12);
			var v91 := new C0();
			var v92 := DC6();
			match (v92) {
				case DC4(cf7) =>
					r0 := -safeDivisionInt(cf7, v84[safeIndex(188, v84.Length)]);
					cf7 := cf7;
					var v93: array<D1> := new D1[14];
					v93[safeIndex(587, v93.Length)] := v92;
					v93[safeIndex(587, v93.Length)] := v92;
					globalState.f0 := false;
				case DC5(cf8, cf9, cf10, cf11) =>
					globalState.f0 := cf9;
					r0 := p0 * safeDivisionInt(v84[safeIndex(188, v84.Length)], v84[safeIndex(188, v84.Length)]);
					var v94: array<set<int>> := new set<int>[24](i7 => {|v90|});
					var v95: set<int> := {v84[safeIndex(188, v84.Length)]};
					v94[safeIndex(132, v94.Length)] := v95 + v95;
					var v96: multiset<C0> := multiset{v91};
					var v97 := DC7(v96);
					var v98: map<D2, int> := map[v97 := p1.fm0(globalState)];
					v84[safeIndex(188, v84.Length)], v94[safeIndex(132, v94.Length)], v84[safeIndex(188, v84.Length)], cf9 := v91.fm10(cf11, p1.f4, v79, globalState), v95, (if (true) then |v79| else if (v97 in v98) then v98[v97] else -|v79|) + cf10, p1.f3;
					cf11 := cf11;
				case DC6() =>
					globalState.f0 := p1.f3;
					var v99: set<int> := {v83[safeIndex(|"qyylnovqs"|, |v83|)]};
					v80 := v80[p1.f4 := |(v99 * {|v76|})|];
					v84[safeIndex(188, v84.Length)] := p0;
					var v100: map<seq<bool>, map<int, int>> := map[v75 := v78];
					var v101: map<map<seq<bool>, map<int, int>>, int> := map[v100 := p0];
					v101 := v101[v100 := -p0];
				case DC3(cf6) =>
					v74[safeIndex(716, v74.Length)] := f13;
					v74[safeIndex(716, v74.Length)] := if (if (true) then p1.f3 else p1.f3) then p1.f4 else !p1.f3;
					var v102 := new C0();
					var v103: map<int, bool> := map[p0 := p1.f4];
					v81 := v81[if (v84[safeIndex(188, v84.Length)] in v103) then v103[v84[safeIndex(188, v84.Length)]] else !p1.f4 := |[p1.f4]|];
					v74[safeIndex(716, v74.Length)] := if (p1.f3 ==> p1.f3) then p1.f3 else !(p1.f4 || p1.f3);
			}
			
			v84[safeIndex(188, v84.Length)] := ((if (p1.fm0(globalState) in v78) then v78[p1.fm0(globalState)] else p0) + p0) + v84[safeIndex(188, v84.Length)];
			var v104 := new C0();
		}
		
		var v105 := DC2(p1.f4, |f12|, p0);
		globalState.f0 := match v105 {
			case DC1(cf1, cf2) => multiset{map[p0 := p1.f3], map[|v52| := p1.f4]} >= multiset{map v106 : int | (0x179 <= v106) && (v106 < 23) :: (safeDivisionInt(v106, 441)) := (p1.f3), map v107 : int | (-707 <= v107) && (v107 < 0x5c) :: (safeModuloInt(v107, p0)) := (p1.f4)}
			case DC2(cf3, cf4, cf5) => !(p1.f4 || true)
			case DC0(cf0) => {|v78|} > {-v84[safeIndex(188, v84.Length)]}
		};
		r0 := v84[safeIndex(188, v84.Length)];
	}
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
		if (!f13) {
			...
			v0[safeIndex(126, v0.Length)] := if (v1 in v2) then v2[v1] else f13;
			...
			v0[safeIndex(126, v0.Length)], p1.f3, globalState.f0, v4 := fm26(if (p1.f3 in v6) then v6[p1.f3] else 0x1b2, p0, false, globalState) != v7, v5 != p1.fm0(globalState), p1.f3, v4;
			...
			v9[safeIndex(298, v9.Length)] := v10;
			var v11: set<char> := {p0};
			v5, v9[safeIndex(298, v9.Length)], v11 := v5, v10, fm27(if (v0[safeIndex(126, v0.Length)]) then |v6| else p1.fm0(globalState), p1.f3, v5, globalState);
			var v12 := DC2(v0[safeIndex(126, v0.Length)], |v6|, v5);
			v5, globalState.f0 := (if (v0[safeIndex(126, v0.Length)]) then v12 else v12).cf5, p1.f4;
		} else {
			var v13 := 500;
			...
			var v19: array<bool> := new bool[28] [p1.f3, fm21(v13, v14, globalState), p1.f3, true, p1.f3, f13, p1.f4, f13, p1.f3, p1.f3, p1.f4, ("fhyqkwo")[safeIndex(v13, |"fhyqkwo"|) := p0] != f12, false, fm21(v13, v14, globalState), v15 !! v15, multiset{p1.f4, !p1.f4, p1.f4} < v16, p1.f3, v17.cf8, true, p1.f4, p1.f4 <==> p1.f3, p1.f3, !p1.f4, v18 != v18, p1.f3, f13, f13, p1.f3];
			v19 := v19;
			v13 := safeModuloInt(0x46, -0x9d);
			...
			var v25: seq<int> := [|"c"|];
			v24 := v24[v25[safeIndex(v13, |v25|)] := v23];
			r0 := f12 + f12;
		}
		...
		var v32: array<int> := new int[14] [v26 - |v27|, v26, v26, 477, v26, -(v26 + |v28|), |(seq(abs(733), i1  => ('j')))|, |f12| - v26, (if (v26 in v29) then v29[v26] else |f12|) * v26, if (p0 in v30) then v30[p0] else v26, |v29|, 972, v26, |v31|];
		var v33 := DC11([p1.f4]);
		v32[safeIndex(829, v32.Length)] := -|(v31 + v33.cf18)|;
		v32[safeIndex(829, v32.Length)] := p1.fm0(globalState);
		var v34: multiset<seq<bool>> := multiset{v31, v31};
		for i2 := 472 to safeModuloInt(|f12|, if (v31 in v34) then v34[v31] else -v32[safeIndex(829, v32.Length)]) {
			globalState.f0 := p1.f4;
			var v35: map<int, int> := map[0x362 := i2];
			var v36: multiset<map<int, int>> := multiset{map[-v32[safeIndex(829, v32.Length)] := v32[safeIndex(829, v32.Length)]], v35, v35};
			var v37: multiset<bool> := multiset{p1.f3, fm21(i2, v36, globalState), p1.f4};
			var v38: seq<multiset<bool>> := [v37];
			var v39: array<multiset<bool>> := new multiset<bool>[26] [v37, v37, multiset{p1.f3}, multiset{p1.f4, p1.f3, p1.f3, f13, p1.f3}, v37 + multiset([p1.f3, p1.f3, p1.f3, p1.f3]), multiset{p1.f3, false}, v37, v38[safeIndex(-v32[safeIndex(829, v32.Length)], |v38|)], v37, v37, v37 - v37, v37, v37 + v37, v37, v37, multiset{p1.f3, p1.f4} * v37, v37, v37, v37, v37, multiset{p1.f4, p1.f4, p1.f4, p1.f3}, v37, v37, v37, multiset{p1.f4}, v37];
			...
			v39 := v40[safeIndex(-(|v44[safeIndex(i2, |v44|)]| - v26), |v40|)];
			globalState.f0 := !!(v32[safeIndex(829, v32.Length)] == v32[safeIndex(829, v32.Length)]);
			v32[safeIndex(829, v32.Length)] := v32[safeIndex(829, v32.Length)] + p1.fm0(globalState);
		}
		var v45: seq<int> := [v32[safeIndex(829, v32.Length)]];
		var v46: seq<seq<int>> := [v45, v45];
		var v47: seq<seq<seq<int>>> := [v46, seq(abs(-0x7f), i7  => (v45)), v46, v46, v46];
		var v48: array<seq<seq<int>>> := new seq<seq<int>>[21] [seq(abs(30), i4  => ([|multiset{p1.f3, p1.f3}|])), v46, v46, v46, (seq(abs(0x358), i5  => (v45))) + (seq(abs(0x36b), i6  => (v45))), fm29(v26, globalState), (v46 + v47[safeIndex(0x37d, |v47|)])[safeIndex(v32[safeIndex(829, v32.Length)], |(v46 + v47[safeIndex(0x37d, |v47|)])|) := v45], v46, seq(abs(-0x1e8), i8  => (v45)), v46, v46, if (p1.f4) then v46 else fm29(-v26, globalState), [[v26]], v46, if (p1.f4) then v46 else v46, v46[safeIndex(-|{p1.f3}|, |v46|) := v45] + ([[v26, v32[safeIndex(829, v32.Length)]], v45, seq(abs(997), i9  => (282))])[safeIndex(|f12|, |[[v26, v32[safeIndex(829, v32.Length)]], v45, seq(abs(997), i9  => (282))]|) := v45], v46 + v46[safeIndex(-|f12[safeIndex(v26, |f12|) := fm23(p1.f3, v32[safeIndex(829, v32.Length)], globalState)]|, |v46|) := v45], v46, v46, v46, v46];
		v48[safeIndex(594, v48.Length)] := v46;
		v48[safeIndex(594, v48.Length)] := v46 + v46;
		var v49: map<int, int> := map[|v45| := v26];
		var v50: multiset<map<int, int>> := multiset{fm25(globalState), map[v32[safeIndex(829, v32.Length)] := |v45|], v49, v49, map[v26 := v26]};
		globalState.f0 := fm21(280, v50 - v50, globalState);
		forall i10 | 0 <= i10 < v32.Length {
			v32[i10] := i10 * v32[safeIndex(829, v32.Length)];
		}
		var v51 := DC5(p1.f3, f13, |f12|, v32[safeIndex(829, v32.Length)]);
		r0 := fm30(v51, -v32[safeIndex(829, v32.Length)], v32[safeIndex(829, v32.Length)], globalState) + f12;
	}
	method m10(globalState: GlobalState) {
		...
		var v7 := DC14(v6);
		var v8: array<seq<array<int>>> := new seq<array<int>>[14] [(v6[safeIndex(590, |v6|) := v5])[safeIndex(v0, |v6[safeIndex(590, |v6|) := v5]|) := v5] + ([v5])[safeIndex(v0, |[v5]|) := v5], v7.cf23, v6, v6, v6, v6 + v6, v6, v6, v6, v6, v6 + v6, [v5], v6 + ([v5])[safeIndex(v0, |[v5]|) := v5], v6];
		v8[safeIndex(387, v8.Length)] := v6 + v6;
		v8[safeIndex(387, v8.Length)] := v6;
	...
	method m11(p0: bool, p1: int, p2: set<bool>, globalState: GlobalState) returns (r0: map<array<int>, D1>) {
			...
			decreases 100 - i1
		{
			...
			var v4 := -0x1ad;
			v4 := p1;
			var v5: seq<string> := [(seq(abs(0xfd), i2  => (v2))) + f12, ("gbd")[safeIndex(p1, |"gbd"|) := v2] + f12, f12, "lkugwmyv" + f12];
			v5 := v5 + v5;
		...
		if (match v12 {
			...
			match (v13) {
				case DC4(cf7) =>
					...
					globalState.f0 := fm21(|(v17 + (seq(abs(251), i4  => (set v18 : int | v18 in multiset{p1} :: (v18 - 0x2fa)))))|, v19, globalState);
					globalState.f0 := v15[safeIndex(cf7, |v15|)];
					var v20 := new C0();
					var v21: map<string, map<bool, int>> := map[(seq(abs(-0x325), i5  => ('r'))) + "wcygaqfhi" := v8];
					var v22: array<multiset<set<int>>> := new multiset<set<int>>[20];
					var v23: multiset<set<int>> := multiset{v14};
					v22[safeIndex(716, v22.Length)] := v23 + v23;
					var v25: set<string> := {f12};
					var v28: map<D6, set<int>> := map[v11 := set v27 : int | (-0x1f4 <= v27) && (v27 < 373) :: (v27 + |{f13}|)];
					v21, globalState.f0, cf7, v22[safeIndex(716, v22.Length)] := (map v24 : string | v24 in v25 :: (v24) := (v8)) + (map v26 : string | v26 in v10 :: (v26) := (v8))[f12 := v8], p1 >= -safeModuloInt(cf7, -0x313), cf7, multiset{if (v11 in v28) then v28[v11] else v14};
				case DC5(cf8, cf9, cf10, cf11) =>
					...
					v0[safeIndex(220, v0.Length)] := fm21(cf11, v30, globalState);
					v0[safeIndex(220, v0.Length)] := cf8;
					var v31 := DC5(cf9, v0[safeIndex(220, v0.Length)], cf11, -v6[safeIndex(cf10, |v6|)]);
					var v32: map<D1, int> := map[v31 := p1];
					v32 := v32;
					cf10 := cf10;
				case DC6() =>
					v1[safeIndex(313, v1.Length)] := p1;
					v1[safeIndex(313, v1.Length)] := safeModuloInt(p1, |("bsas" + f12)|);
					var v33: array<seq<D5>> := new seq<D5>[18];
					v33 := v33;
					var v34: map<bool, string> := map[p0 := f12];
					var v36 := DC16(map v35 : int | (483 <= v35) && (v35 < 0x347) :: (safeDivisionInt(v35, |[p0]|)) := (p2));
					var v37: map<string, map<int, set<bool>>> := map[if (!f13 in v34) then v34[!f13] else "bchjxx" := v36.cf25];
					var v38 := DC5(true, p0, |f12|, v1[safeIndex(313, v1.Length)]);
					var v39: multiset<int> := multiset{v1[safeIndex(313, v1.Length)]};
					var v40: map<int, set<bool>> := map[p1 := p2];
					v37 := v37[fm30(v38.(cf8 := true, cf9 := p0), v1[safeIndex(313, v1.Length)], |v39|, globalState) := v40];
					var v41 := DC0(v1[safeIndex(313, v1.Length)]);
					globalState.f0 := (v39[211 := abs(0xb2)] * v39) >= multiset{-v1[safeIndex(313, v1.Length)], p1, v1[safeIndex(313, v1.Length)], v1[safeIndex(313, v1.Length)], v41.cf0};
				case DC3(cf6) =>
					var v42 := -0x3ac;
					var v43: array<char> := new char[21];
					var v44 := 'f';
					v43[safeIndex(517, v43.Length)] := v44;
					var v45: multiset<D7> := multiset{DC17(p1, p0, p0, p1)};
					v42, v43[safeIndex(517, v43.Length)], globalState.f0, cf6 := |((f12 + f12) + f12)|, f12[safeIndex(v42, |f12|)], !(v45 >= v45), v0;
					globalState.f0 := p0;
					v43 := v43;
			...
			v0[safeIndex(486, v0.Length)] := f13;
			v0[safeIndex(486, v0.Length)] := f13;
			v0[safeIndex(486, v0.Length)] := f13;
			if (p1 != p1) {
				v0[safeIndex(486, v0.Length)] := v0[safeIndex(486, v0.Length)];
				var v52: multiset<bool> := multiset{f13};
				var v53: seq<multiset<bool>> := [v52];
				globalState.f0 := v53[safeIndex(v50, |v53|)] !! v52;
				v1[safeIndex(492, v1.Length)] := 0x2c5;
				v1[safeIndex(896, v1.Length)] := v50;
				v1[safeIndex(855, v1.Length)] := v50;
				var v54: set<bool> := {v0[safeIndex(486, v0.Length)]};
				var v55 := DC5(false, p0, v50, p1);
				var v56 := DC0(p1);
				var v57: map<bool, map<bool, int>> := map[f13 := v8];
				var v58: seq<map<bool, map<bool, int>>> := [v57, v57];
				v1[safeIndex(492, v1.Length)], globalState.f0, v1[safeIndex(896, v1.Length)], v1[safeIndex(855, v1.Length)], v54 := safeDivisionInt(p1, safeModuloInt(|map[v0[safeIndex(486, v0.Length)] := 0x98]|, v50)), fm30(v55, v56.cf0, v50, globalState) == (f12 + fm30(v55, p1, p1, globalState)), v50, |(if (v51 <= v51) then v58[safeIndex(|v7|, |v58|)] + v57 else v57)|, p2 - p2;
				...
				v50, v6, v60 := 0x6c, [|(v8 + v8)|], if (v1[safeIndex(492, v1.Length)] in v61) then v61[v1[safeIndex(492, v1.Length)]] else multiset(v62);
				var v63: array<int> := new int[11](i6 => i6 - v1[safeIndex(492, v1.Length)]);
				v63 := if (f13) then v63 else v63;
			} else {
				var v64: map<int, bool> := map[v50 := !p0];
				var v66: set<int> := {p1};
				var v67: multiset<map<int, bool>> := multiset{v64, map v65 : int | v65 in v66 :: (safeDivisionInt(v65, p1)) := (p0)};
				var v68 := DC9(v67);
				v68 := v68;
				var v69 := 'x';
				...
				var v72 := new C0();
				v1[safeIndex(212, v1.Length)] := v50;
				...
				var v76 := "xslucuycd";
				v50, v1[safeIndex(212, v1.Length)], v75, v69, v76 := v50, safeDivisionInt(safeDivisionInt(p1, v50), p1 * p1), v75 - (v75 + v75), v69, v76;
				globalState.f0 := f13;
			}
			...
			v85[safeIndex(603, v85.Length)] := "xoffjr";
			v85[safeIndex(603, v85.Length)] := f12;
			v1[safeIndex(436, v1.Length)] := 0x10b;
			v1[safeIndex(436, v1.Length)] := p1;
		}
		
		var v86: map<seq<string>, array<int>> := map[v10 := v1];
		var v87 := DC3(v0);
		var v88: map<array<int>, D1> := map[if ((seq(abs(0x12f), i9  => ("tyathfrj"))) in v86) then v86[seq(abs(0x12f), i9  => ("tyathfrj"))] else v1 := v87];
		r0 := v88;
	}
}
...
class C2 extends T0, T1 {
	...
	method m0(p0: bool, p1: map<int, bool>, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		var v0: seq<int> := [p2];
		for i0 := |"gqk"| to v0[safeIndex(p2, |v0|)] {
			var v1: array<bool> := new bool[15](i1 => p2 <= 33);
			v1[safeIndex(835, v1.Length)] := true;
			v1[safeIndex(835, v1.Length)] := !f4;
			r1 := if (false) then p2 else p2;
			var v2 := 'v';
			var v3: map<bool, array<bool>> := map[f10 := v1];
			var v4 := DC3(v1);
			var v5: array<array<bool>> := new array<bool>[28] [v1, v1, v1, v1, v1, if (fm18(i0, v2, i0, globalState)) then v1 else v1, v1, v1, v1, if (f11 in v3) then v3[f11] else v1, v1, v1, v1, v1, v1, if (p0) then if (f4 in v3) then v3[f4] else v4.cf6 else v1, v1, v1, v1, v1, if (v1[safeIndex(835, v1.Length)]) then v1 else v1, v1, v1, v1, v1, if (true) then v1 else v1, v1, v1];
			var v6: seq<bool> := [f3, !f4];
			var v7 := "y";
			var v8: map<int, array<bool>> := map[|v6[safeIndex(|v7|, |v6|) := false]| := v1];
			v5[safeIndex(276, v5.Length)] := if (i0 in v8) then v8[i0] else v1;
			v5[safeIndex(276, v5.Length)] := v1;
			r1 := -((i0 + 819) * i0);
		}
		var v9: map<bool, bool> := map[f3 := f3];
		r1 := safeDivisionInt(p2, |v9|);
		f3 := !true;
		...
		var v15: array<int> := new int[13] [if (p2 in v11) then v11[p2] else p2, p2, 0x1eb, v0[safeIndex(p2, |v0|)], if (f4 in v12) then v12[f4] else p2, p2, p2, |v14|, p2, p2, -p2, p2, p2];
		var v16: map<array<int>, bool> := map[v15 := false];
		globalState.f0 := v15 in v16;
		forall i2 | 0 <= i2 < v15.Length {
			v15[i2] := safeModuloInt(i2, p2);
		}
		if (f4) {
			var v17 := 'n';
			var v18: map<bool, string> := map[!fm18(p2, v17, p2, globalState) := fm17(globalState)];
			v18 := map[p0 := seq(abs(0x251), i3  => (v17))] + (v18 + v18);
			...
			f3 := f3;
			v15[safeIndex(532, v15.Length)] := 0x10e + p2;
			v15[safeIndex(532, v15.Length)] := p2;
		} else {
			var v21: C0 := new C0();
			var v22: array<seq<int>> := new seq<int>[19];
			var v23 := "pgmkqgjiw";
			v22[safeIndex(623, v22.Length)] := (fm19(globalState))[safeIndex(|v23|, |fm19(globalState)|) := p2];
			var v24 := 'e';
			var v25: seq<multiset<bool>> := [fm20(p0, globalState), v12];
			v21, f3, globalState.f0, v22[safeIndex(623, v22.Length)], globalState.f0 := if (f10) then v21 else v21, false, !fm18(p2, v24, v21.fm10(0x303, f10, multiset{|v25|}, globalState), globalState), fm19(globalState), f3;
			v24 := v24;
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
		...
		v3[safeIndex(226, v3.Length)] := false;
		var v4: array<map<char, int>> := new map<char, int>[20];
		var v5: set<bool> := {p1.f4};
		f3, v3[safeIndex(226, v3.Length)], v4 := if (f3) then p1.f4 else p1.f4, (v5 + v5) <= v5, v4;
		var v6: seq<bool> := [v3[safeIndex(226, v3.Length)], p1.f4, p1.f4, f4, f4];
		var v7: map<bool, int> := map[v3[safeIndex(226, v3.Length)] := |v6|];
		var v8: seq<int> := [p0, p0, |v7|];
		r0 := |v8|;
		var v9: set<char> := {v0};
		var v10: seq<set<char>> := [v9, v9];
		var v11: C0 := new C0();
		var v12: map<C0, bool> := map[v11 := v3[safeIndex(226, v3.Length)]];
		var v13: map<int, map<C0, bool>> := map[|(seq(abs(705), i0  => ('k')))| := map[v11 := v3[safeIndex(226, v3.Length)]] + v12];
		r0, v10, v0, v13 := p0, v10, v0, v13;
		if (v3[safeIndex(226, v3.Length)]) {
			globalState.f0 := 0xf9 != p0;
			if (p1.f3) {
				var v14: set<int> := {safeModuloInt(|[p0]|, p0), |(v6 + [f11, p1.f3])|};
				v14 := v14;
				var v15: map<T0, int> := map[p1 := p0];
				v15 := v15[p1 := p0];
				var v16: array<string> := new string[13];
				v16[safeIndex(147, v16.Length)] := v1;
				v16[safeIndex(147, v16.Length)] := v1 + (v1 + v1);
				var v17: map<int, int> := map[p0 := p0];
				var v18: seq<map<int, int>> := [v17, v17];
				var v19: seq<map<int, int>> := [v17, v18[safeIndex(|v6|, |v18|)]];
				var v20: map<seq<map<int, int>>, bool> := map[v19 := true];
				p1.f3 := if ((v19 + v18) in v20) then v20[v19 + v18] else if (p1.f3) then v3[safeIndex(226, v3.Length)] else p1.f3;
				r0, v1 := p0, ("ccdmppcba" + v1) + v1;
			} else {
				var v21: map<int, int> := map[p0 := -386];
				var v22: multiset<map<int, int>> := multiset{v21, v21};
				v3[safeIndex(226, v3.Length)] := !fm21(p0, v22, globalState);
				v0 := v0;
				globalState.f0 := p1.f4;
				v0 := if (!p1.f3) then v0 else v0;
				v8 := (v8 + (seq(abs(0xbd), i1  => (p0))))[safeIndex(p0, |(v8 + (seq(abs(0xbd), i1  => (p0))))|) := p0 - p0];
			}
			...
			v3[safeIndex(226, v3.Length)] := f11;
			globalState.f0 := p1.f3;
		} else {
			...
			v28 := map[p1.f4 := !(!p1.f4 <== v3[safeIndex(226, v3.Length)])];
			globalState.f0 := !f3;
		}
	...
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
			...
			decreases 100 - i0
		{
			...
			var v16: seq<bool> := [fm21(v5, fm22(v5, fm16(v5, p1.f3, v5, map v14 : int | v14 in v15 :: (safeDivisionInt(v14, v5)) := (p1.f3), globalState), v5, globalState), globalState), p1.f4, f11];
			var v18: map<int, string> := map[v5 := seq(abs(-868), i2  => (p0))];
			...
			var v23: array<bool> := new bool[27] [!p1.f3, !f3, p1.f4, f4, !p1.f4, f3, false, p1.f4, f4, p1.f3, !p1.f4, f11, v6 < v6, if (if (v5 in v7) then v7[v5] else f4) then p1.f4 else !p1.f3, v8 != (if (true in v9) then v9[true] else [v5]), p1.f4, !(v12 in v13), f4, p1.f4, p1.f4, false, p1.f3 <==> v16[safeIndex(v5, |v16|)], (map v17 : int | (118 <= v17) && (v17 < 0x203) :: (safeDivisionInt(v17, 579)) := (v6)) == v18, multiset{|v13|} >= multiset{v5}, f11, (if (p1.f4 in v20) then v20[p1.f4] else v22) !! v22, if (v16[safeIndex(|[p1.f3, f11]|, |v16|)]) then !p1.f4 else p1.f4];
			v23[safeIndex(940, v23.Length)] := f3;
			...
			v23[safeIndex(431, v23.Length)] := fm21(|v24|, v26, globalState);
			var v27 := DC2(p1.f3, v5, |v6|);
			var v28: seq<array<bool>> := [v23];
			v23[safeIndex(940, v23.Length)], v23[safeIndex(431, v23.Length)] := v27.cf3, ([v23] != v28) <== f4;
		}
		var v29 := 443;
		var v30 := "j";
		var v31: seq<int> := [|v30|, -v29];
		var v32: map<int, int> := map[v29 := v31[safeIndex(v29, |v31|)]];
		...
		p1.f3 := v34[safeIndex(safeModuloInt(v38, -v29), |v34|)];
		v29 := -safeDivisionInt(|v30|, v38 * v29);
	...
	method m9(globalState: GlobalState) {
		...
		if ((if (v0 in v2) then v2[v0] else v1) !! v3.cf35) {
			var v4: seq<bool> := [f4];
			if (!v4[safeIndex(v0, |v4|)]) {
				var v5: array<int> := new int[16];
				var v6: array<array<int>> := new array<int>[9] [v5, v5, v5, v5, v5, v5, v5, v5, v5];
				v6[safeIndex(580, v6.Length)] := v5;
				v6[safeIndex(580, v6.Length)] := new int[23](i0 => i0 - -v0);
				...
				v17[safeIndex(511, v17.Length)] := safeDivisionInt(-|v12|, v0);
				var v18: multiset<int> := multiset{v0, v0};
				v17[safeIndex(511, v17.Length)] := |(v18 + (v18 - v18))|;
				var v19 := 'u';
				var v20 := DC20(v19, true);
				v20 := v20.(cf33 := v19);
				var v21: C1 := new C1(seq(abs(0x322), i1  => (v19)), f3);
				v21 := v21;
				var v22: array<char> := new char[25](i2 => v19);
				var v23: multiset<C1> := multiset{v21};
				v22[safeIndex(883, v22.Length)] := fm23(v21.f13, |v23[v21 := abs(fm16(v0, v21.f13, v0, v16, globalState))]|, globalState);
				...
				v17[safeIndex(511, v17.Length)], v22[safeIndex(883, v22.Length)], v17, v12, v25 := --fm31(v27 < v27, |(map[f3 := v17[safeIndex(511, v17.Length)]])[f3 := v17[safeIndex(511, v17.Length)]]|, f4, v4, globalState), v19, DC22(v17).cf36, v26.fm11(v19, fm33(v17[safeIndex(511, v17.Length)], (if (|map[v17[safeIndex(511, v17.Length)] := v21.f13]| in v28) then v28[|map[v17[safeIndex(511, v17.Length)] := v21.f13]|] else fm34(|map[v17[safeIndex(511, v17.Length)] := f11]|, |v29|, globalState))[safeIndex(151, |(if (|map[v17[safeIndex(511, v17.Length)] := v21.f13]| in v28) then v28[|map[v17[safeIndex(511, v17.Length)] := v21.f13]|] else fm34(|map[v17[safeIndex(511, v17.Length)] := f11]|, |v29|, globalState))|) := v21.f13], globalState), globalState), fm35(!f3, globalState);
			}
			...
			if ((v30 + v30) < "edlbvgnpp") {
				...
				var v39: array<map<int, int>> := new map<int, int>[20] [v34, v34, map[v0 := v0], map v35 : int | v35 in v36 :: (safeModuloInt(v35, v0)) := (v0), v34, v34, v34 + map[v0 := v0], DC24(v34).cf37, v34, v34, v34 + v34, fm25(globalState), fm25(globalState) + (if (v0 in v37) then v37[v0] else v34), v34, fm25(globalState) + (map v38 : int | (0x39c <= v38) && (v38 < 0) :: (safeDivisionInt(v38, |v32.f12|)) := (v0)), map[v0 := v0], v34, v34, v34, v34];
				v39 := v39;
				v30 := v32.f12;
				var v40 := DC23();
				v40 := v40;
			...
			v50[safeIndex(246, v50.Length)] := |v1|;
			var v51: multiset<int> := multiset{|v2|};
			v50[safeIndex(246, v50.Length)] := safeModuloInt(|v51|, 0x223) - v0;
		} else {
			var v52 := new C0();
			var v53 := "ptxas";
			var v54: seq<string> := [v53, v53];
			var v55: multiset<string> := multiset{v53, v53, v53, v53[safeIndex(v0, |v53|) := 'w'], v53};
			var v56: map<string, int> := map[v53[safeIndex(|v54|, |v53|) := 'j'] := |v55|];
			v56 := v56[v53 := v0];
			globalState.f0 := f11;
			...
			var v66: array<bool> := new bool[22] [if (|v53| in v57) then v57[|v53|] else f4, !f3 in v58, false in v58, f3 !in v58, f4, true, v59.cf7 != v0, false <==> f10, !(v61.cf39 > {false, f3, f4, f3, f11}), f11, if (f11) then f3 else f10, if (f4) then !f10 else false, -v62[safeIndex(0x282, |v62|)] <= 0xe9, !((set v63 : int | (0x193 <= v63) && (v63 < -0x1a6) :: (v63 * v0)) !! v1), f10, if (f4) then !f4 else f10, f10, f11, v0 <= v0, {f11} >= {fm21(-0x202, v65, globalState)}, f10, [f11] != [f4, f4]];
			v66[safeIndex(264, v66.Length)] := !f4;
			v66[safeIndex(264, v66.Length)] := f10;
			var v67: array<D2> := new D2[18];
			v67[safeIndex(26, v67.Length)] := DC8(v66, "iuu");
			var v68 := 'v';
			var v69 := DC8(v66, v52.fm11(v68, v60, globalState));
			v67[safeIndex(26, v67.Length)] := v69;
		}
		...
		for i4 := v0 to fm0(globalState) {
			...
			v0 := i4 * v0;
			v70[safeIndex(461, v70.Length)] := f10;
			var v72 := "jhy";
			v70[safeIndex(461, v70.Length)] := if (f4) then f11 else |v72| >= -i4;
			v70[safeIndex(461, v70.Length)] := v70[safeIndex(461, v70.Length)];
		}
		globalState.f0 := f4;
		v0 := safeDivisionInt(v0, v0);
		v0 := -safeModuloInt(v0 - v0, v0);
		var v73 := "hd";
		var v74: array<int> := new int[7] [v0, 0x3dd, |v73|, v0, safeDivisionInt(v0, v0), v0, v0];
		v74[safeIndex(642, v74.Length)] := safeModuloInt(v0, v0);
		v74[safeIndex(642, v74.Length)] := -v0;
	}
}
...
class C3 extends T1, T0 {
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := v0.cf0 * fm0(globalState) to |v8| {
			...
			if ((v10 == map[seq(abs(0x0), i1  => (v1)) := p1.f4]) || (|v9| <= v13[safeIndex(-i0, |v13|)])) {
				var v14: array<bool> := new bool[19](i2 => p1.f4);
				v14 := v14;
				var v15 := DC2(if (false) then p1.f3 else f3, |v4|, p0);
				v15 := DC2(p1.f4, i0, safeDivisionInt(p0, p0));
				v15 := v15;
				var v16: seq<D0> := [v0];
				...
				v11[safeIndex(186, v11.Length)] := -(if (p0 in v20) then v20[p0] else p0);
				v11[safeIndex(186, v11.Length)] := v15.cf5;
			} else {
				var v21: array<array<bool>> := new array<bool>[8];
				var v22: array<bool> := new bool[24];
				v21[safeIndex(891, v21.Length)] := v22;
				var v23: map<bool, int> := map[p1.f3 := i0];
				var v24: multiset<map<bool, int>> := multiset{v23};
				p1.f3, v21[safeIndex(891, v21.Length)], p1.f3, globalState.f0, v22 := true, v22, v24 > v24, p1.f4, v22;
		...
		if (p1.f4) {
			...
			if (f4) {
				...
				var v34 := "yowfhhl";
				v33[safeIndex(766, v33.Length)] := |v34|;
				var v35: map<bool, bool> := map[p1.f4 := (DC2(f4, p0, p0).(cf4 := DC0(p0).cf0)).cf3];
				var v36: seq<map<bool, bool>> := [v35];
				globalState.f0, v33[safeIndex(766, v33.Length)] := true, -|((v36 + v36) + (v36[safeIndex(890, |v36|) := v35])[safeIndex(p0, |v36[safeIndex(890, |v36|) := v35]|) := v35])|;
				var v37 := DC2('u' !in v34, -262, |v4| + |[v34]|);
				var v38: map<int, bool> := map[90 := p1.f3];
				v37 := DC2(if (449 in v38) then v38[449] else p1.f4, v33[safeIndex(766, v33.Length)] + |v34|, fm0(globalState));
				var v39: set<bool> := {p1.f4};
				var v40: multiset<set<bool>> := multiset{v39};
				v40 := multiset{v39 * v39, v39, v39, v39};
				var v41: map<int, char> := map[if (p1.f3 in v4) then v4[p1.f3] else v33[safeIndex(766, v33.Length)] := v1];
				var v42: map<int, map<int, char>> := map[374 + v33[safeIndex(766, v33.Length)] := v41];
				v42 := v42;
				var v43 := new C0();
			} else {
				var v44: seq<array<bool>> := [v27, v27];
				var v45: map<int, array<bool>> := map[p0 := v27];
				var v46: array<array<bool>> := new array<bool>[25] [v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v44[safeIndex(p0, |v44|)], v27, if (|map["juonh" := p1.f4]| in v45) then v45[|map["juonh" := p1.f4]|] else v27, v27, v27, v27, v27, v27, v27, v27, v27, v27];
				v46[safeIndex(420, v46.Length)] := v27;
				var v47 := "mstiflvo";
				var v48: set<string> := {v47, v47, v47};
				var v49: set<bool> := {p1.f4};
				var v50: seq<set<bool>> := [v49];
				var v51: seq<int> := [p0, p0, |v50|, safeDivisionInt(p0, p0)];
				v46[safeIndex(420, v46.Length)], r0, v48, r0 := v27, p0 * 705, v48, |v51|;
				...
				v55[safeIndex(250, v55.Length)] := v56;
				var v57: map<bool, string> := map[p1.f4 := v47];
				var v58: multiset<int> := multiset{|v6|};
				v52, v55[safeIndex(250, v55.Length)], r0, r0, v57 := v52, (map[v1 := p0])[v1 := p0], -(if (p0 in v58) then v58[p0] else p0), |(if (p1.f4) then v3 else v3)| + fm0(globalState), if (p1.f3) then v57 else v57 + v57;
				r0 := 0x181;
				v28 := v28[f4 := if (f4) then p0 else v51[safeIndex(p0, |v51|)]];
				globalState.f0 := f3;
			}
			...
			v60 := v60;
			var v61: array<int> := new int[21](i5 => safeDivisionInt(i5, p0));
			var v62: seq<array<bool>> := [v27, v27, v27];
			v61[safeIndex(588, v61.Length)] := |v62|;
			v61[safeIndex(588, v61.Length)] := 0x17e * |(fm12(p0, f3, p0, globalState))[v59 := f4]|;
		} else {
			r0 := p1.fm0(globalState);
			var v64: array<bool> := new bool[20](i6 => {p0, p0} !! (set v63 : int | (0x226 <= v63) && (v63 < -0x3d) :: (v63 + |(seq(abs(0x10d), i7  => (v1)))|)));
			var v65: multiset<D0> := multiset{v0};
			var v66: set<int> := {0x1fc, p0};
			v64[safeIndex(805, v64.Length)] := {|v65|} > v66;
			var v67: map<int, bool> := map[p0 := p1.f4];
			v64[safeIndex(805, v64.Length)] := !((if (0x12e in v67) then v67[0x12e] else p1.f4) && false);
			var v68 := "kqqftlo";
			var v69: map<string, int> := map[v68 := p0];
			v69 := fm13(p0 * p0, -|v3|, p0, f4, globalState);
			p1.f3 := p1.f3;
			v64[safeIndex(805, v64.Length)] := v6[safeIndex(if (false in v4) then v4[false] else p0, |v6|)];
		}
		
		for i8 := if (f3) then p0 else -0x36c to p0 {
			var v70: array<int> := new int[1];
			v70[safeIndex(710, v70.Length)] := safeModuloInt(p0, |v3|);
			v70[safeIndex(710, v70.Length)] := safeModuloInt(i8, i8 * p0);
			v70[safeIndex(710, v70.Length)] := p0;
			var v71 := new C0();
			v70[safeIndex(710, v70.Length)] := |v2|;
		}
		...
		v74[safeIndex(145, v74.Length)] := if (v1 in v75) then v75[v1] else v72;
		var v76: seq<array<int>> := [v72, v72, v72, v72, v72];
		var v77: map<bool, bool> := map[true := f4];
		v74[safeIndex(145, v74.Length)] := v76[safeIndex(p0 - |v77|, |v76|)];
		var v78: seq<int> := [p0];
		...
		v84 := if (p0 >= p0) then v85[safeIndex(|v86|, |v85|)] else v84;
		r0 := p0;
	}
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
		...
		if (f3) {
			...
			var v14: seq<int> := [v12, |v13[p1.f4 := abs(v12)]|, v12];
			v12 := v14[safeIndex(safeModuloInt(|v14|, v14[safeIndex(|(seq(abs(698), i0  => (p0)))|, |v14|)]), |v14|)];
			...
			v17[safeIndex(261, v17.Length)] := v18[safeIndex(0x2d1, |v18|)];
			var v19: array<bool> := new bool[10];
			var v20 := DC3(v19);
			var v21: map<array<bool>, int> := map[v20.cf6 := v12 - v12];
			v17[safeIndex(261, v17.Length)], v12 := seq(abs(0x1c5), i1  => (v14 + v14)), |v21|;
		}
			...
			decreases 100 - i2
		{
			...
			var v23 := 0x3f;
			v22[safeIndex(522, v22.Length)] := v23;
			v22[safeIndex(522, v22.Length)] := (v23 * 764) * v23;
			p1.f3 := p1.f4;
			v23 := p1.fm0(globalState);
			v22[safeIndex(522, v22.Length)] := p1.fm0(globalState);
		}
		if (!f4) {
			var v24 := 0xe1;
			v24 := v24;
			...
			v24 := v34[safeIndex(-(v24 - v34[safeIndex(v24, |v34|)]), |v34|)];
		} else {
			var v35 := 0x36d;
			var v36: seq<int> := [v35];
			...
			var v43: map<T0, D0> := map[p1 := DC2(p1.f3, |(seq(abs(-986), i4  => (p0)))|, v35)];
		...
		for i6 := v46 * v46 to v46 {
			...
			var v50: array<int> := new int[12] [v46 * v46, |v47|, |v47|, i6, |v47|, v46 + i6, ---safeModuloInt(|v49|, v46), p1.fm0(globalState), |v47|, i6 + 0x2ff, v46, i6];
			v50[safeIndex(370, v50.Length)] := v46;
			var v51: C0 := new C0();
			var v52: set<C0> := {v51, v51};
			v50[safeIndex(370, v50.Length)] := i6 * (i6 * -|v52|);
			var v53: set<bool> := {p1.f3, p1.f3, f3, p1.f4, fm14(globalState)};
			var v54 := DC0(|v51.fm11(p0, v53, globalState)|);
			match (v54) {
				case DC1(cf1, cf2) =>
					var v55 := new C0();
					var v56: map<int, bool> := map[|[v50[safeIndex(370, v50.Length)], -v46, v46, v46, -v50[safeIndex(370, v50.Length)]]| := f4];
					v56 := (map v57 : int | (652 <= v57) && (v57 < -0x3bb) :: (safeModuloInt(v57, i6)) := (true)) + v56;
					var v58 := DC3(v45);
					v58 := v58;
					var v59 := new C0();
				case DC2(cf3, cf4, cf5) =>
					var v60: seq<bool> := [p1.f4, f3];
					var v61: set<int> := {v50[safeIndex(370, v50.Length)], v50[safeIndex(370, v50.Length)]};
					p1.f3 := |v60| in v61;
					v51 := v51;
					v0 := v0[!p1.f4 := -v46 == v50[safeIndex(370, v50.Length)]];
					v50[safeIndex(370, v50.Length)] := safeDivisionInt(cf4, i6);
				case DC0(cf0) =>
					var v62: T1 := new C1(v47, p1.f3);
					var v63 := DC29(v62);
					var v64: seq<T1> := [v62, v63.cf42];
					var v65: map<bool, seq<T1>> := map[!p1.f4 <==> true := v64];
					var v66: map<int, map<bool, seq<T1>>> := map[v50[safeIndex(370, v50.Length)] := v65];
					v65 := (if (cf0 in v66) then v66[cf0] else map[f3 := v64]) + (map[false := v64] + v65);
					globalState.f0 := p1.f3;
					globalState.f0 := p1.f4;
					v50[safeIndex(370, v50.Length)] := if (p1.f4) then cf0 - fm0(globalState) else i6;
			}
		...
		r0 := (if (f3) then v47 else ((seq(abs(0x154), i7  => (p0)))[safeIndex(v46, |(seq(abs(0x154), i7  => (p0)))|) := p0])[safeIndex(v46, |(seq(abs(0x154), i7  => (p0)))[safeIndex(v46, |(seq(abs(0x154), i7  => (p0)))|) := p0]|) := p0]) + v47;
	}
	method m0(p0: bool, p1: map<int, bool>, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		var v0: array<int> := new int[5](i0 => i0 * |map[p2 := p2]|);
		v0[safeIndex(847, v0.Length)] := p2;
		v0[safeIndex(847, v0.Length)] := p2;
		var v1: array<bool> := new bool[28](i1 => !(f3 || true));
		v1[safeIndex(458, v1.Length)] := false;
		var v2 := 'g';
		var v3: map<map<int, bool>, char> := map[p1 := v2];
		var v4: seq<char> := [v2, if (p1 in v3) then v3[p1] else 'x', fm23(f4, v0[safeIndex(847, v0.Length)], globalState)];
		var v5: seq<int> := [0x182];
		var v6: seq<seq<int>> := [seq(abs(0x244), i2  => (-p2)), v5];
		var v7: multiset<int> := multiset{|v4|, v0[safeIndex(847, v0.Length)], |v6|, v0[safeIndex(847, v0.Length)], 0x2f4};
		f3, v0[safeIndex(847, v0.Length)], r1, v1[safeIndex(458, v1.Length)], r1 := f3 && f3, v0[safeIndex(847, v0.Length)], v0[safeIndex(847, v0.Length)] + v0[safeIndex(847, v0.Length)], (p2 + v0[safeIndex(847, v0.Length)]) <= |v7|, -(p2 - -safeDivisionInt(p2, v0[safeIndex(847, v0.Length)]));
		forall i3 | 0 <= i3 < v1.Length {
			v1[i3] := !f4;
		}
		var i4 := 0;
		while (v0[safeIndex(847, v0.Length)] >= v0[safeIndex(847, v0.Length)])
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			var v10 := DC15(seq(abs(450), i5  => (v4)));
			var v11 := DC5(false, f3, fm31(false, v0[safeIndex(847, v0.Length)], f4, v9, globalState), |map[p2 := v10]|);
			v1[safeIndex(458, v1.Length)] := v11.cf8;
			var v12: array<seq<bool>> := new seq<bool>[6](i6 => ([v1[safeIndex(458, v1.Length)], p0, f3])[safeIndex(v0[safeIndex(847, v0.Length)], |[v1[safeIndex(458, v1.Length)], p0, f3]|) := v1[safeIndex(458, v1.Length)]]);
			globalState.f0, v12, globalState.f0 := safeDivisionInt(0x2ac, |[v0[safeIndex(847, v0.Length)], p2]|) in v5, v12, p2 < 0x9e;
			var v13: array<map<bool, int>> := new map<bool, int>[27];
			var v14: map<bool, int> := map[false := -v0[safeIndex(847, v0.Length)]];
			v13[safeIndex(908, v13.Length)] := v14 + v14;
			v13[safeIndex(908, v13.Length)] := v14;
		}
		v1[safeIndex(458, v1.Length)] := v1[safeIndex(458, v1.Length)];
		var v15: set<int> := {p2};
		var v17 := DC16(fm36(|(set v16 : int | v16 in v15 :: (v16 + |[true, false]|))|, v0[safeIndex(847, v0.Length)], globalState));
		var v18 := DC4(v0[safeIndex(847, v0.Length)]);
		var v19: map<D7, D1> := map[v17 := v18];
		var v20: set<bool> := {DC5(f4, f4, v0[safeIndex(847, v0.Length)], -772).cf9};
		var v21: map<int, set<bool>> := map[|p1| := v20];
		v19 := v19[v17.(cf25 := v21).(cf25 := v21[p2 := v20]) := v18];
		var v22: map<bool, array<int>> := map[v1[safeIndex(458, v1.Length)] <== p0 := v0];
		r0 := if ((if (v1[safeIndex(458, v1.Length)]) then f4 else v1[safeIndex(458, v1.Length)]) in v22) then v22[if (v1[safeIndex(458, v1.Length)]) then f4 else v1[safeIndex(458, v1.Length)]] else v0;
		r1 := v0[safeIndex(847, v0.Length)];
	}
	method m7(p0: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		if (f4) {
			...
			var v1: seq<bool> := [f4];
			var v2 := new C1("pavx" + "wibc", if (v1[safeIndex(p0, |v1|)]) then !f4 else f4);
		...
		var v12 := -0x8a;
		var v13 := "pvdeve";
		var v14 := DC15([v13, seq(abs(0x63), i0  => ('s'))]);
		...
		for i1 := v12 to v12 {
			v19[safeIndex(46, v19.Length)] := v12;
			v19[safeIndex(46, v19.Length)] := v12;
			var v20 := DC6();
			v20 := v20;
			v19[safeIndex(46, v19.Length)] := 0x266;
			if (false) {
				var v21: set<int> := {v19[safeIndex(46, v19.Length)]};
				v19[safeIndex(46, v19.Length)] := fm31(f3, v12, v21 > v21, v15, globalState);
				var v22: array<seq<int>> := new seq<int>[3];
				var v23: seq<int> := [v12, -v19[safeIndex(46, v19.Length)]];
				v22[safeIndex(375, v22.Length)] := v23;
				v22[safeIndex(375, v22.Length)] := ([v19[safeIndex(46, v19.Length)]])[safeIndex(v19[safeIndex(46, v19.Length)], |[v19[safeIndex(46, v19.Length)]]|) := |v15|] + v23;
				v19[safeIndex(46, v19.Length)] := i1;
				globalState.f0 := f4;
				var v24: multiset<int> := multiset{p0, safeDivisionInt(|multiset{f3}|, v19[safeIndex(46, v19.Length)]), p0, i1};
				v24 := v24[safeModuloInt(v19[safeIndex(46, v19.Length)], |v21|) := abs(i1)];
			} else {
				var v25: multiset<int> := multiset{v19[safeIndex(46, v19.Length)], v19[safeIndex(46, v19.Length)]};
				var v26: map<int, multiset<int>> := map[-0x270 := v25];
				var v27: seq<int> := [p0];
				var v28 := DC30(multiset{v12});
				globalState.f0 := (fm24(globalState) + v25) >= ((if (v27[safeIndex(v19[safeIndex(46, v19.Length)], |v27|)] in v26) then v26[v27[safeIndex(v19[safeIndex(46, v19.Length)], |v27|)]] else v28.cf43) * v25);
				var v29: set<bool> := {f4, f3, f4, f3};
				v29 := v29;
				var v30 := 'n';
				var v31: map<char, char> := map[v30 := v30];
				v31 := v31[v30 := v30];
				var v32: map<int, char> := map[v19[safeIndex(46, v19.Length)] := v30];
				v32 := v32[v19[safeIndex(46, v19.Length)] := v30];
				v16 := v16;
			}
		...
		for i2 := v12 to safeModuloInt(v12, |v13|) {
			var v35 := new C0();
			v12 := v12;
			...
			match (v36) {
				case DC12(cf19, cf20, cf21) =>
					...
					v40[safeIndex(174, v40.Length)] := f3;
					var v41: map<int, int> := map[cf20 := cf19];
					v40[safeIndex(174, v40.Length)] := fm21(v12, multiset{v41, v41}, globalState);
					f3 := f3;
					v12 := cf19;
					globalState.f0 := f4;
				case DC11(cf18) =>
					...
					var v44: array<seq<bool>> := new seq<bool>[18] [v15, v15, cf18, cf18, [f4], cf18, cf18[safeIndex(v12, |cf18|) := f3], v15, [f3, f4], cf18, cf18, cf18, cf18, v15, v15, fm34(i2, v12, globalState), cf18, if (f3 in v43) then v43[f3] else cf18];
					v42[safeIndex(487, v42.Length)] := v44;
					v33, v42[safeIndex(487, v42.Length)] := v33, v44;
					var v45: seq<int> := [|v13|];
					var v46: seq<seq<int>> := [v45, seq(abs(39), i3  => (v12))];
					var v47: set<seq<int>> := {v46[safeIndex(v12, |v46|)], [p0, v12], [i2]};
					v47 := v47;
					...
					v51 := DC16(v52);
				case DC13(cf22) =>
					v19[safeIndex(514, v19.Length)] := v12;
					v19[safeIndex(514, v19.Length)] := safeModuloInt(v12, v12);
					var v53: seq<int> := [p0];
					v53 := v53;
					globalState.f0 := f3;
					v19[safeIndex(514, v19.Length)] := v19[safeIndex(514, v19.Length)];
			}
		...
		match (v54) {
			case DC4(cf7) =>
				...
				v57[safeIndex(39, v57.Length)] := v16;
				v57[safeIndex(39, v57.Length)] := v16;
			case DC5(cf8, cf9, cf10, cf11) =>
				globalState.f0 := f3;
				cf9 := v15 == v15;
			...
			case DC6() =>
				...
				if (f3) {
					...
					var v61: map<int, int> := map[-v60[safeIndex(v12, |v60|)] := -p0];
					v61 := v61[v12 - p0 := p0];
					...
					v67[safeIndex(19, v67.Length)] := 'a';
					v67[safeIndex(19, v67.Length)] := v33;
				} else {
					v19[safeIndex(941, v19.Length)] := -safeModuloInt(p0, p0);
					v19[safeIndex(941, v19.Length)] := v12;
					v19[safeIndex(941, v19.Length)] := p0;
					v12 := v19[safeIndex(941, v19.Length)];
					var v68: array<bool> := new bool[22];
					var v69 := DC2(f3, 0x290, p0);
					var v70: seq<int> := [|v13|];
					globalState.f0, v19[safeIndex(941, v19.Length)], v12, globalState.f0, v68 := f3 <==> false, safeModuloInt(v19[safeIndex(941, v19.Length)] * v69.cf4, v12), v70[safeIndex(v19[safeIndex(941, v19.Length)], |v70|)], fm30(v54, v19[safeIndex(941, v19.Length)], p0, globalState) <= v13[safeIndex(v19[safeIndex(941, v19.Length)], |v13|) := v33], v68;
					var v71 := new C0();
				}
			...
			case DC3(cf6) =>
				...
				if (!(!(v12 > v12) ==> (p0 != -v12))) {
					...
					var v81: array<array<D9>> := new array<D9>[26] [if (f4) then v78 else v78, v79.cf46, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v78, v80[safeIndex(|multiset(seq(abs(0x35f), i5  => (p0)))|, |v80|)], v78, v78, v78, v78, v78, v78, v78, if (f4) then v78 else v78];
					var v82: map<bool, array<D9>> := map[f3 := v78];
					v81[safeIndex(716, v81.Length)] := if (f4 in v82) then v82[f4] else v78;
					var v83: array<seq<int>> := new seq<int>[27];
					var v84: set<int> := {p0};
					var v85: seq<int> := [|fm34(p0, p0, globalState)|];
					v83[safeIndex(774, v83.Length)] := [|v84|, -v12, p0, 0x21, |v15|] + v85;
					v81[safeIndex(716, v81.Length)], v83[safeIndex(774, v83.Length)] := v78, seq(abs(0x3bf), i6  => (p0));
					v19 := new int[9](i7 => i7 * p0);
					var v86: array<array<int>> := new array<int>[19];
					v86 := v86;
				} else {
					cf6 := cf6;
					v13 := v13 + v13[safeIndex(|(map[true := |v15|])[f3 := p0]|, |v13|) := v33];
					v19[safeIndex(715, v19.Length)] := p0 * p0;
					var v87 := DC31(-p0, p0);
					v19[safeIndex(715, v19.Length)] := v87.cf44;
					r1 := true;
					var v88: array<map<bool, int>> := new map<bool, int>[17] [v17, v17 + v17, v17, map[f3 := p0] + map[f4 := p0], v17, v17, v17[f4 := v19[safeIndex(715, v19.Length)]], v17, v17 + map[false := v12], fm28(false, f3, f3, |v13|, globalState), v17, v17[f4 := 0x350], DC35(v17).cf50, v17, v17, (map[f3 := v19[safeIndex(715, v19.Length)]])[f4 := v19[safeIndex(715, v19.Length)]], v17];
					v88[safeIndex(958, v88.Length)] := v17;
					v88[safeIndex(958, v88.Length)] := v17;
				}
				
				var v89: map<int, multiset<bool>> := map[safeDivisionInt(v12, p0) := multiset{f3}];
				v19[safeIndex(152, v19.Length)] := v12;
				v19[safeIndex(490, v19.Length)] := p0;
				v12, v89, v19[safeIndex(152, v19.Length)], v19[safeIndex(490, v19.Length)], v12 := 0x3ba, map[|v15| := multiset{true, f4}], v12 * (v12 * p0), (v12 * p0) - (p0 + v12), v12;
				var v90 := new C0();
		}
	...
	method m8(p0: int, p1: int, globalState: GlobalState) returns (r0: seq<bool>, r1: array<int>) {
		var i0 := 0;
		while (safeModuloInt(p1, p0) <= fm0(globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v2: array<int> := new int[7] [p0, safeDivisionInt(-p0, p1), if (f4) then p1 else 631, p0, fm31(false, p0, f4, v0, globalState) * p0, |(v0 + v0)|, |map[v1 := f4]|];
			var v3: map<bool, int> := map[f4 := 0x53];
			v2[safeIndex(296, v2.Length)] := |v3| * 84;
			v2[safeIndex(296, v2.Length)] := p0;
			f3 := f4 <== !false;
		...
		var v11 := -243;
		v11 := safeDivisionInt(v11, -33 * p1);
		var v12: array<map<bool, bool>> := new map<bool, bool>[14](i2 => map[true := f3]);
		forall i1 | 0 <= i1 < v12.Length {
			v12[i1] := if (multiset{v11} >= multiset(seq(abs(296), i3  => (p1)))) then map[f4 := f3] + map[f4 := false] else map[f4 := f3] + map[f4 := f3];
		}
		var v13: seq<int> := [p0, fm0(globalState), p1, v11, v11];
		var v14: multiset<int> := multiset{safeModuloInt(|v13|, 0x37)};
		var v15: set<int> := {-0x37a};
		v14 := (v14 - fm24(globalState))[|v15| := abs(498)];
		if (f3) {
			v11 := p1 - v11;
			var v16: array<bool> := new bool[1](i4 => f3);
			v16[safeIndex(739, v16.Length)] := fm14(globalState);
			var v17: map<bool, bool> := map[f3 := f3];
			var v18: map<int, int> := map[664 := |v17|];
			var v19: multiset<map<int, int>> := multiset{v18, v18};
			v16[safeIndex(739, v16.Length)] := fm21(p0 * p0, multiset{v18} * v19, globalState);
			if (v16[safeIndex(739, v16.Length)]) {
				var v20: array<seq<bool>> := new seq<bool>[23](i5 => v9);
				v20[safeIndex(516, v20.Length)] := v9;
				v20[safeIndex(516, v20.Length)] := v9;
				var v21: multiset<bool> := multiset{v16[safeIndex(739, v16.Length)]};
				globalState.f0 := if ((if (v16[safeIndex(739, v16.Length)] in v21) then v21[v16[safeIndex(739, v16.Length)]] else v11) == |v9|) then true else f4;
				v16 := v16;
				globalState.f0 := v16[safeIndex(739, v16.Length)] || fm14(globalState);
				v11 := 0x328;
			} else {
				var v23: set<bool> := {v16[safeIndex(739, v16.Length)]};
				var v24 := 'n';
				var v25: map<char, set<bool>> := map[v24 := v23];
				var v26: multiset<seq<int>> := multiset{v13, v13, v13, v13};
				globalState.f0 := if (p1 in (map v22 : int | v22 in [0xce] :: (safeDivisionInt(v22, -p0)) := (!f3))) then v23 >= (if (v24 in v25) then v25[v24] else v23) else v26 !! v26;
				v11, v16[safeIndex(739, v16.Length)], v16[safeIndex(739, v16.Length)], v24 := 0x2de + p1, v16[safeIndex(739, v16.Length)], f4, v24;
				var v27: array<int> := new int[15](i6 => i6 * v11);
				v27[safeIndex(246, v27.Length)] := -p0;
				var v28: map<bool, int> := map[v14[v11 := abs(0xd3)] > v14 := v11];
				v27[safeIndex(246, v27.Length)] := |v28|;
				v16[safeIndex(739, v16.Length)] := f3;
				v27[safeIndex(246, v27.Length)] := v27[safeIndex(246, v27.Length)] - v27[safeIndex(246, v27.Length)];
			}
			
			var v29 := new C0();
			var v30: array<seq<D2>> := new seq<D2>[22];
			var v31: map<bool, array<seq<D2>>> := map[f4 := v30];
			v30 := if (v16[safeIndex(739, v16.Length)]) then if (f3 in v31) then v31[f3] else v30 else if (true in v31) then v31[true] else v30;
		} else {
			var v32 := 'i';
			v32 := v32;
			v11 := p0;
			var v33: array<bool> := new bool[4];
			v33[safeIndex(2, v33.Length)] := f3;
			var v34: set<bool> := {f4};
			var v35: map<int, set<bool>> := map[-p1 := v34];
			var v36 := DC16(v35 + v35);
			var v37: set<string> := {"lhxyt"};
			v33[safeIndex(2, v33.Length)], v11, v36 := (v37 + v37) == v37, 145, v36;
			var v38: map<seq<bool>, int> := map[v9 := p1];
			var v39 := DC17(fm31(f3, |v38|, f3, v9, globalState), !f3, v33[safeIndex(2, v33.Length)], |multiset{v33[safeIndex(2, v33.Length)]}|);
			var v40: C2 := new C2(v33[safeIndex(2, v33.Length)], false, f3, v39.cf27);
...
class C4 extends T1, T0 {
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
		...
		if (p1.f4 <==> fm6(fm5(false, v1, globalState), globalState)) {
			...
			r0 := fm31(false, f9, v8[safeIndex(|v9|, |v8|)], v8, globalState);
			var v10: array<map<string, int>> := new map<string, int>[10](i0 => map[v1[safeIndex(0x239, |v1|) := v0] := p0] + map[v1 := f9]);
			v10[safeIndex(924, v10.Length)] := map[v1 := 0x260];
			...
			v14[safeIndex(99, v14.Length)] := v15;
			var v16: array<int> := new int[27];
			var v17 := DC12(f9, f9, f4);
			v16[safeIndex(627, v16.Length)] := v17.cf20;
			...
			v10[safeIndex(924, v10.Length)], v13, p1.f3, v14[safeIndex(99, v14.Length)], v16[safeIndex(627, v16.Length)] := v18, v13.(cf25 := v13.cf25), p1.f4 !in v19, map[fm6(|v11|, globalState) := v1] + v15, |(((seq(abs(0xd), i2  => (f9))) + (v20 + (seq(abs(0x3db), i3  => (f9)))))[safeIndex(fm5(f4, v1, globalState), |((seq(abs(0xd), i2  => (f9))) + (v20 + (seq(abs(0x3db), i3  => (f9)))))|) := |v22| * |v23.cf24|])[safeIndex(f9 * p0, |((seq(abs(0xd), i2  => (f9))) + (v20 + (seq(abs(0x3db), i3  => (f9)))))[safeIndex(fm5(f4, v1, globalState), |((seq(abs(0xd), i2  => (f9))) + (v20 + (seq(abs(0x3db), i3  => (f9)))))|) := |v22| * |v23.cf24|]|) := p0]|;
			v1 := if (v0 !in v1) then "vrmn" else v1;
			globalState.f0 := safeModuloInt(f9, p0) > p0;
			var v24: map<int, bool> := map[v16[safeIndex(627, v16.Length)] := p1.f3];
		...
		for i4 := p0 to f9 + 0x5b {
			if (true) {
				...
				v26[safeIndex(752, v26.Length)] := p1.f3;
				...
				v26[safeIndex(752, v26.Length)] := if (v27 in v29) then v29[v27] else !f4;
				v28 := multiset{p1.f4, v26[safeIndex(752, v26.Length)], f8};
				var v30: seq<bool> := [f3, p1.f3];
				var v31: seq<bool> := [f8, v30[safeIndex(p0, |v30|)]];
				v31 := v31;
				f3 := p1.f4;
				var v32: array<int> := new int[2];
				v32[safeIndex(841, v32.Length)] := p0;
				var v33: map<bool, char> := map[f4 := v1[safeIndex(i4, |v1|)]];
				var v34: map<char, string> := map[if (p1.f4 in v33) then v33[p1.f4] else 'a' := v1 + v1];
				globalState.f0, r0, v32[safeIndex(841, v32.Length)], v1 := p1.f4, 0xaf, |v34|, "b";
			} else {
				r0 := p1.fm0(globalState);
				...
				var v44: seq<int> := [f9];
				var v45: array<int> := new int[24] [-f9, |v40| * 453, p0, p0, p0, f9, p0, -0x3b0, 0x18b + |v41|, |fm34(i4, f9, globalState)|, f9, i4, |v43| + p0, f9, f9, safeModuloInt(f9, -0x2dc), safeModuloInt(98, f9), i4, 0x294, p0, f9, i4, f9, |(v39 + fm34(|v44|, p0, globalState))|];
				v42[safeIndex(7, v42.Length)] := if (p1.f3) then p0 else i4;
				v42[safeIndex(7, v42.Length)] := p0;
				var v46: multiset<bool> := multiset{false};
				var v47: seq<seq<bool>> := [v39];
				var v48: seq<seq<int>> := [v44, v44[safeIndex(v42[safeIndex(7, v42.Length)], |v44|) := v42[safeIndex(7, v42.Length)]], v44, [p0]];
				var v49: map<int, seq<seq<int>>> := map[i4 - (if (f8 in v46) then v46[f8] else fm31(f3, -|v39|, !p1.f4, v47[safeIndex(p0, |v47|)], globalState)) := v48];
			...
			if ((fm37(i4, globalState)).cf53) {
				...
				var v54 := new C1(v1, if (if (p1.f3 in v51) then v51[p1.f3] else f4) then f4 else v53[safeIndex(f9, |v53|)]);
				var v55: array<C1> := new C1[10];
				v55 := v55;
				var v56: set<bool> := {false};
				var v57: multiset<bool> := multiset{f3, v53[safeIndex(|v56|, |v53|)], f8};
				var v58 := DC26(v56);
				...
				var v67: array<bool> := new bool[25] [0x16c >= f9, v54.f13, v54.f13, p1.f4, v50.f10, fm18(p0, v0, p0, globalState), v60 < v60, f4, v0 !in v54.f12, p1.f3, p1.f4, fm21(f9, multiset((v66[safeIndex(i4, |v66|)])[safeIndex(p0, |v66[safeIndex(i4, |v66|)]|) := v64]), globalState), f8, v50.f10, !p1.f4, f8, p1.f3, false, f4, p1.f4, f3 || p1.f3, f8 <== v50.f11, fm18(i4, 'd', |[p1.f4, v53[safeIndex(|v51|, |v53|)], v50.f10]|, globalState), !v50.f11, p1.f4 ==> v54.f13];
				v67 := v67;
				...
				var v73: map<bool, int> := map[{p1.f3, p1.f4} >= v72 := -safeDivisionInt(|v70.f12|, f9)];
				v73 := v73[v70.f13 := |v1|];
				...
				var v77 := DC13(v75);
				v77 := v77;
				var v78: array<int> := new int[17](i8 => safeDivisionInt(i8, 0x1de));
			...
			var v84: set<int> := {i4};
			var v85: multiset<map<int, int>> := multiset{map v83 : int | v83 in v84 :: (safeModuloInt(v83, f9)) := (f9)};
			...
			decreases 100 - i9
		{
			...
			var v94: array<int> := new int[14] [f9, p0, fm0(globalState) + v91.cf29, if (p1.f3) then p0 else -0xcf, |v92|, f9 + p0, |v93|, p0, if (p1.f3 in v93) then v93[p1.f3] else p0, f9, f9, safeDivisionInt(p0, p0), -|map[p1.f3 := fm14(globalState)]|, f9];
			v94[safeIndex(887, v94.Length)] := |fm19(globalState)|;
			var v95: map<bool, bool> := map[p1.f4 := p1.f4];
			globalState.f0, r0, v1, v94[safeIndex(887, v94.Length)], v0 := true, |(v95 + map[p1.f4 := f4])|, "yvhykh" + "fccwodxf", safeDivisionInt(if (|v88[safeIndex(|v88|, |v88|) := fm6(p0, globalState)]| in v92) then v92[|v88[safeIndex(|v88|, |v88|) := fm6(p0, globalState)]|] else p0, |v1|), v0;
			var v96: set<bool> := {true, f8};
			var v97 := DC26(v96);
			var v98 := DC28(v97);
			var v99: array<D12> := new D12[16] [if (f8) then DC28(v97) else v98, v98, v98, v98, v98, v98, v98.(cf41 := v97), v98, v98, fm38(p0, p1.f3, globalState), v98, v98, v98, v98, fm38(v94[safeIndex(887, v94.Length)], !p1.f3, globalState), fm38(v94[safeIndex(887, v94.Length)], p1.f3, globalState)];
			v99[safeIndex(751, v99.Length)] := v98;
			v99[safeIndex(751, v99.Length)] := DC28(fm38(p0, p1.f4, globalState));
			v1 := v1;
			v95 := v95[v1 < v1 := true];
		}
	...
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
		...
		v2[safeIndex(237, v2.Length)] := v13 + [|multiset(v14)|];
		v2[safeIndex(237, v2.Length)] := v13;
		var v15: array<bool> := new bool[1];
		v15[safeIndex(317, v15.Length)] := f4;
		var v16: multiset<bool> := multiset{!v1, true};
		v15[safeIndex(317, v15.Length)] := v16 < v16;
		v0 := f9;
		if (if (f4) then false else if (true) then true else p1.f4) {
			v15[safeIndex(317, v15.Length)] := !fm14(globalState);
			var v17 := DC27(f9);
			var v18 := DC28(v17);
			v0, v18 := f9, v18;
			v0 := safeDivisionInt(f9, v0);
			var v19 := "abbgbhwi";
			var v20: map<int, bool> := map[v0 := |v19| >= f9];
			v20 := v20[safeModuloInt(0xdd, |v16|) := f3];
			f8 := p1.f3;
		} else {
			var v21: map<int, bool> := map[f9 := f3];
			var v22 := DC25(v21);
			v22 := if (f3) then v22 else v22;
			if (if (|v16| in v21) then v21[|v16|] else v15[safeIndex(317, v15.Length)]) {
				var v23: array<int> := new int[28];
				v0, v23 := v13[safeIndex(v0, |v13|)] * v0, v23;
				var v24 := DC35(map[false := |v21|]);
				var v25: map<int, int> := map[|v24.cf50| := f9];
				var v26 := "w";
				var v27: seq<string> := [v26];
				var v28: set<int> := {f9};
				var v29 := DC12(|v25|, |v27[safeIndex(|v28|, |v27|)]|, v14[safeIndex(-v0, |v14|)]);
				...
				var v35 := new C2(f8, (multiset{f9})[|v26| := abs(f9)] == v34, v14[safeIndex(f9, |v14|)], v1);
				v1 := fm14(globalState);
				v15[safeIndex(317, v15.Length)] := f8;
			} else {
			...
			match (v22) {
				case DC25(cf38) =>
					...
					v0, r0, p1.f3 := (if (v51 in v52) then v52[v51] else |v2[safeIndex(237, v2.Length)]|) - safeModuloInt(v0, if (0x168 in v53) then v53[0x168] else f9), seq(abs(0x221), i2  => (p0)), fm6(v2[safeIndex(237, v2.Length)][safeIndex(0x35e, |v2[safeIndex(237, v2.Length)]|)], globalState);
				case DC24(cf37) =>
					var v54 := "grqnosdc";
					...
					globalState.f0 := v15[safeIndex(317, v15.Length)];
			}
			
			var v58: set<int> := {f9};
			var v59 := DC17(f9, fm18(|v58|, p0, v0, globalState), true, v0);
			var v60: seq<D7> := [v59, v59];
			f8 := if (p1.f3) then |v14| == v0 else v60[safeIndex(v0, |v60|) := v59] < v60;
			v0 := f9;
		}
		...
		match (v62) {
			case DC36(cf51, cf52, cf53, cf54) =>
				...
				var v70: array<int> := new int[28] [f9, |(v63 + v63)[safeIndex(|v64|, |(v63 + v63)|) := v15]|, 101, |v65| + |v66|, v0, v0 + v0, -(v0 + f9), v0, v0, f9, v0, -f9, v0, |map[v67 := f4]|, |(v67 + "swjrixy")|, -f9, safeModuloInt(if (f3 in v16) then v16[f3] else v0, f9), f9, f9, |(set v68 : int | (283 <= v68) && (v68 < 0x39b) :: (safeDivisionInt(v68, |v66|)))|, f9 * v69.cf10, f9 - f9, f9, v0, f9, v0, safeDivisionInt(v13[safeIndex(v0, |v13|)], fm5(f4, v67, globalState)), v0];
				v70[safeIndex(815, v70.Length)] := v0;
				var v71: map<bool, bool> := map[cf53 := p1.f4];
				var v72: set<map<bool, bool>> := {v71, v71};
				var v73: multiset<map<bool, bool>> := multiset{v71};
				v70[safeIndex(815, v70.Length)] := |(v72 + (v72 * (set v74 : map<bool, bool> | v74 in v73[v71 := abs(v0)] :: (v74))))|;
				if (v1) {
					v70[safeIndex(815, v70.Length)] := f9;
					var v75: T1 := new C1(v67, f9 > 83);
					v75 := v75;
					v0 := f9 + (f9 - 0x109);
					v0 := v70[safeIndex(815, v70.Length)] - v70[safeIndex(815, v70.Length)];
					var v76: map<seq<int>, char> := map[v2[safeIndex(237, v2.Length)] := p0];
					var v77 := DC37(v76);
					var v79: set<seq<int>> := {[v0]};
					var v80 := DC41(v79);
					var v81: seq<map<seq<int>, char>> := [v76, v76, v76];
					var v83: multiset<seq<int>> := multiset{seq(abs(964), i6  => (v0))};
					var v85: map<seq<int>, bool> := map[v2[safeIndex(237, v2.Length)] := p1.f4];
					var v87: array<map<seq<int>, char>> := new map<seq<int>, char>[27] [v76[fm19(globalState) := p0], v77.cf55, map[seq(abs(0x27f), i5  => (-261)) := p0], v76, v76, v76, map v78 : seq<int> | v78 in v80.cf63 :: (v78) := (p0), v81[safeIndex(v70[safeIndex(815, v70.Length)], |v81|)], v76[v2[safeIndex(237, v2.Length)] := p0], map[v13 := p0] + v76, v76, map[v2[safeIndex(237, v2.Length)] := p0], map[[|v67|] := p0], v76, v76 + v76, map[v13 := p0], v76, map v82 : seq<int> | v82 in v83 :: (v82) := (p0), v76, v76, v76, v76, v76, map[v13 := p0] + map[v2[safeIndex(237, v2.Length)] := p0], (map v84 : seq<int> | v84 in v85 :: (v84) := ('p')) + (map v86 : seq<int> | v86 in v83 :: (v86) := (p0)), v76, v76[v13 := p0] + v76];
					v87[safeIndex(760, v87.Length)] := v76;
					v87[safeIndex(760, v87.Length)] := v76 + v76;
				} else {
					var v89: seq<map<int, bool>> := [v65, map v88 : int | v88 in [v70[safeIndex(815, v70.Length)]] :: (safeDivisionInt(v88, v70[safeIndex(815, v70.Length)])) := (!true), if (p1.f4) then v65 else v65, v65 + v65, map[v70[safeIndex(815, v70.Length)] := cf54]];
					v89, globalState.f0, v1, v0 := v89, {|map[v70[safeIndex(815, v70.Length)] := cf54]|} >= (set v90 : int | (0x272 <= v90) && (v90 < 0x267) :: (safeDivisionInt(v90, |[f3, !f3, f3]|))), (if (p1.f4) then p1.f4 else p1.f3) || (cf52 <==> !true), f9;
					...
					var v95 := DC12(v70[safeIndex(815, v70.Length)], f9, f8);
					globalState.f0 := v15[safeIndex(317, v15.Length)] ==> v95.cf21;
					v70[safeIndex(815, v70.Length)] := v0;
					v70[safeIndex(815, v70.Length)] := -fm0(globalState);
				}
				
				p1.f3 := !v1;
				var v96 := DC1(p1.f3, p0);
				var v97: seq<D6> := [DC15([seq(abs(-829), i7  => ('k')), seq(abs(0xf9), i8  => (p0))])];
				var v98: seq<string> := ["ykv"];
				var v99 := DC15(v98);
				v96, v15[safeIndex(317, v15.Length)] := v96, (f9 + v70[safeIndex(815, v70.Length)]) >= safeModuloInt(|v97[safeIndex(v0, |v97|) := v99]|, v0);
			case DC35(cf50) =>
				if (f8) {
					var v100, v101 := m5(p1.f4, p1.f3, globalState);
					var v102: set<int> := {|cf50|, |map[p1.f4 := p0]|, |(seq(abs(-156), i9  => (p0)))|};
					var v103: array<int> := new int[26](i10 => i10 - v100);
					var v104: seq<array<int>> := [v103];
					var v105: array<array<int>> := new array<int>[21] [v104[safeIndex(856, |v104|)], v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103, v103];
					var v106: map<array<array<int>>, bool> := map[v105 := p1.f3];
					var v107 := DC19(v0, f9);
					var v108: map<int, int> := map[f9 := f9];
					var v109: C3 := new C3(v15[safeIndex(317, v15.Length)], true);
					var v110 := DC2(p1.f3, f9, v100);
					var v111: array<int> := new int[13] [fm31(f4, 0xaa, !false, [fm18(|v102|, 'e', v0, globalState), if (v105 in v106) then v106[v105] else v1], globalState), safeDivisionInt(f9, v0), v100, v100, ---(if (p1.f3) then v0 else v107.cf31), f9, f9, f9, 0x70, |(v108 + v108)|, -0xa6 * |[v109]|, v0 - v0, v110.cf4];
					v111 := v111;
					...
					v117[safeIndex(658, v117.Length)] := safeModuloInt(v0, -0x2ab);
					var v118 := DC43(v0, f9, p1.f4);
					v117[safeIndex(658, v117.Length)] := -v118.cf65;
					var v119 := "lhsbcmbd";
					var v120: seq<string> := [v119, v119];
					var v121: seq<string> := [v120[safeIndex(v117[safeIndex(658, v117.Length)], |v120|)], v119 + v119, v119];
					var v122 := DC17(if (v14[safeIndex(v117[safeIndex(658, v117.Length)], |v14|)] in cf50) then cf50[v14[safeIndex(v117[safeIndex(658, v117.Length)], |v14|)]] else v117[safeIndex(658, v117.Length)], v15[safeIndex(317, v15.Length)], f3, |v2[safeIndex(237, v2.Length)]|);
					r0 := v121[safeIndex(safeModuloInt(v122.cf26, v0), |v121|)];
					var v123: multiset<int> := multiset{f9, v117[safeIndex(658, v117.Length)], v0};
					var v124 := new C2(DC20(p0, p1.f4).cf34, f4, v0 == |v123|, p1.f3);
					r0 := v119 + (seq(abs(0x5c), i11  => (p0)));
					v117[safeIndex(658, v117.Length)] := safeModuloInt(0x393, v117[safeIndex(658, v117.Length)]);
				}
				...
				match (v126) {
					case DC31(cf44, cf45) =>
						var v127 := new C3(v15[safeIndex(317, v15.Length)] <==> p1.f4, p1.f4);
						v0 := cf44;
						var v128 := "xxfvhd";
						var v129: map<string, bool> := map[v128 := v15[safeIndex(317, v15.Length)]];
						var v130 := DC5(p1.f3, p1.f4, v0, |{cf45}|);
						var v131: set<int> := {v0, cf44, cf45};
						var v132: map<int, bool> := map[cf45 := v15[safeIndex(317, v15.Length)]];
						v129 := v129[fm30(v130.(cf11 := -fm5(v14[safeIndex(p1.fm0(globalState), |v14|)], v128, globalState)), |v131|, |v132|, globalState) := v15[safeIndex(317, v15.Length)]];
						var v133: array<char> := new char[12](i12 => p0);
						v133[safeIndex(902, v133.Length)] := v128[safeIndex(|v2[safeIndex(237, v2.Length)]|, |v128|)];
						var v134 := 'x';
						v15[safeIndex(317, v15.Length)], v133[safeIndex(902, v133.Length)], v134 := !!p1.f3, DC1(p1.f4, p0).cf2, fm8(-v0, globalState);
					case DC30(cf43) =>
						v0 := v0;
						var v135: map<int, multiset<bool>> := map[-0x65 := v16];
						v16 := (if (fm0(globalState) in v135) then v135[fm0(globalState)] else v16)[p1.f3 := abs(f9)];
						v15[safeIndex(317, v15.Length)] := f8;
						var v136 := new C0();
				}
				
				var v137: map<bool, bool> := map[p1.f3 := v1];
				v137 := v137[v1 := v15[safeIndex(317, v15.Length)]];
				v0 := v0;
		}
		
		r0 := seq(abs(-0x1a7), i13  => ('k'));
	}
	method m0(p0: bool, p1: map<int, bool>, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		r1 := p2;
		...
		var v8 := DC16(v7);
		v2, v0[safeIndex(738, v0.Length)] := (v2 + v2) - multiset(v3 + [v4.cf39]), match v8 {
			case DC17(cf26, cf27, cf28, cf29) => map[false := -|map[v5 := cf28]|] in map[map[f8 := 0x209] := f8]
			case DC16(cf25) => f4
		};
		v0[safeIndex(738, v0.Length)] := f3;
		var v9 := DC17(f9, f3, f8, f9);
		var v10: multiset<D7> := multiset{v9, v9, v9, DC17(|"bydy"|, false, f8, p2), v9};
		var v11 := new C2(p0, f8 ==> v0[safeIndex(738, v0.Length)], if (f3) then !fm14(globalState) else v0[safeIndex(738, v0.Length)], v9 in v10[v9 := abs(f9)]);
		if (!f3) {
			var v12 := DC23();
			v12 := v12;
			...
			var v18: seq<int> := [|v17[safeIndex(f9, |v17|)]|, p2];
			var v19: seq<seq<int>> := [[p2], v18, v18, v18];
			var v20: multiset<int> := multiset{p2, |v19[safeIndex(--f9, |v19|)]|};
			v16 := map[v0 := f9] + (if (v0[safeIndex(738, v0.Length)]) then v16 else map[v0 := |v20|]);
			r1 := |v6|;
		} else {
			var v21: set<int> := {f9, |v6|, 0x2be, p2, f9};
			var v23: C3 := new C3(v0[safeIndex(738, v0.Length)], v21 >= (set v22 : int | (157 <= v22) && (v22 < 522) :: (v22 - p2)));
			v23 := v23;
			...
			match (v26) {
				case DC14(cf23) =>
					...
					v24[safeIndex(251, v24.Length)] := p2;
					v28, v24[safeIndex(251, v24.Length)] := v28, f9 - f9;
					v24[safeIndex(251, v24.Length)] := v11.fm16(p2, true, p2, p1, globalState);
					var v29: seq<bool> := [v11.f10];
					var v30: multiset<bool> := multiset{v29[safeIndex(f9, |v29|)], f8};
					var v31: map<seq<bool>, multiset<bool>> := map[v29 := v30];
					v31 := (map[v29 := multiset(v29)] + v31) + v31;
			}
			
			globalState.f0 := v0[safeIndex(738, v0.Length)];
			var v32: set<array<bool>> := {v0};
			if (v32 > {v0}) {
				v0[safeIndex(738, v0.Length)], r1, v5 := v11.f10, 0xdc, v5;
				var v34: map<int, int> := map[261 := p2];
				var v35: multiset<map<int, int>> := multiset{map v33 : int | v33 in v34 :: (safeModuloInt(v33, |v1|)) := (p2), v34, v34};
				var v36: multiset<bool> := multiset{!v0[safeIndex(738, v0.Length)], v11.f11};
				r1 := (DC39(v24, p0, v11.f10, |v23.fm7(v0[safeIndex(738, v0.Length)], v7, fm21(f9, v35, globalState), v36, globalState)|, p2).(cf58 := f4, cf61 := p2)).cf60 - safeModuloInt(f9, f9);
				v24[safeIndex(504, v24.Length)] := f9;
				v24[safeIndex(504, v24.Length)], v0[safeIndex(738, v0.Length)], r1, v0[safeIndex(738, v0.Length)] := safeDivisionInt(p2, p2 + p2), f4, -safeDivisionInt(p2, p2) + p2, v11.f10;
				var v37 := new C3(p2 >= p2, v11.f10);
				var v38: array<int> := new int[21];
				var v39: seq<bool> := [v11.f10, true];
				var v40 := DC22(v38);
				var v41: array<array<int>> := new array<int>[21] [v38, v38, v38, v38, v38, if (v39[safeIndex(|v34|, |v39|)]) then v38 else v38, v38, v25[safeIndex(v24[safeIndex(504, v24.Length)], |v25|)], v38, v38, v38, v38, v38, v38, v38, v38, v38, v38, v40.cf36, v38, v38];
				var v42: seq<int> := [|map[v24[safeIndex(504, v24.Length)] := v5]|, p2, |v39|];
				v41[safeIndex(187, v41.Length)] := v25[safeIndex(|v42|, |v25|)];
				v41[safeIndex(187, v41.Length)] := v38;
			} else {
				...
				v0[safeIndex(738, v0.Length)], globalState.f0, v6, f3 := f8, v45 <= (v46 - v46), v6, if (fm18(f9, v5, p2, globalState) ==> v11.f11) then 0x127 >= p2 else p0;
				var v47: map<bool, bool> := map[v11.f10 := f4];
				var v48 := new C2(v11.f10, v6 != "ffkltwrcq", v11.f11, fm18(|v47|, v5, |v11.fm17(globalState)|, globalState) || v0[safeIndex(738, v0.Length)]);
				...
				var v54: array<char> := new char[25] [v5, v5, v5, v5, v5, v5, v51.cf2, v5, 'o', v5, v5, fm8(0x3c, globalState), v5, v5, v5, v5, if (|v53| in v52) then v52[|v53|] else 'w', v5, v5, v5, fm8(|{p2}|, globalState), v5, v6[safeIndex(0x36b, |v6|)], 'q', fm23(v11.f11, |v6|, globalState)];
				v54[safeIndex(42, v54.Length)] := v5;
				v54[safeIndex(42, v54.Length)] := 'v';
			}
			
			var v55: multiset<string> := multiset{v6};
			r1 := (if (v6 in v55) then v55[v6] else f9) * safeDivisionInt(p2, p2);
		}
		...
		var v60: seq<array<C2>> := [v58[safeIndex(|v59|, |v58|)], v57, v57];
	...
	method m5(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v7 := DC44(v6);
		var v8: array<bool> := new bool[10] [v1.cf34, f8, p0, DC17(|v2|, f8, f4, f9).cf28, f8, f8, |(map v3 : int | (128 <= v3) && (v3 < 0xc2) :: (safeDivisionInt(v3, f9)) := (f9))| > f9, f4 !in v7.cf68, if (DC1(true, v0).cf1) then f3 else f8, f4];
		v8[safeIndex(217, v8.Length)] := fm14(globalState);
		v8[safeIndex(217, v8.Length)] := f3;
		if (f3) {
			var v9: set<int> := {-848};
			var v10: map<string, int> := map["jvjswysav" := |v9|];
			r0 := if (v2 in v10) then v10[v2] else -f9;
			var v11 := new C3(v8[safeIndex(217, v8.Length)], v8[safeIndex(217, v8.Length)]);
			globalState.f0 := p1;
			var v12: seq<int> := [f9];
			var v14 := DC18(map v13 : int | v13 in v12 :: (v13 + f9) := (false));
			v8[safeIndex(217, v8.Length)], r0 := (v12 < v12) ==> false, -((f9 * |v14.cf30|) * f9);
			var v15: array<multiset<int>> := new multiset<int>[13];
			var v16: multiset<int> := multiset{|(seq(abs(0xe6), i0  => (f9)))|};
			v15[safeIndex(828, v15.Length)] := v16;
			var v17: array<int> := new int[9](i1 => safeDivisionInt(i1, f9));
			var v18: seq<bool> := [!false];
			var v19: map<int, bool> := map[|v18| := p0];
			var v20 := DC25(v19);
			var v21: seq<D11> := [v20];
			var v22: map<seq<D11>, bool> := map[v21 := f4];
			v17[safeIndex(301, v17.Length)] := if (if (v21 in v22) then v22[v21] else p0) then 0x395 else f9;
			v15[safeIndex(828, v15.Length)], v17[safeIndex(301, v17.Length)], r0 := v16, f9, f9;
		} else {
			r0 := f9;
			r0 := f9 + -safeModuloInt(-505, f9);
			var v23 := new C3(p0, v8[safeIndex(217, v8.Length)]);
			var v24: map<int, bool> := map[f9 := f8];
			var v25: map<int, bool> := map[|v24| := !!v8[safeIndex(217, v8.Length)]];
			var v26 := DC18(v24);
			v26 := v26;
			var v27: seq<bool> := [p0, p1];
			var v28: seq<seq<bool>> := [v27, v27, v27, fm34(0x28e, f9, globalState) + v27];
			v28 := [v27, fm34(f9, f9, globalState) + [!false, v8[safeIndex(217, v8.Length)], p1]];
		}
		...
		if (f3) {
			...
			match (v30.(cf6 := v8)) {
				case DC4(cf7) =>
					v29 := new int[15];
					var v31: map<bool, bool> := map[f8 := v8[safeIndex(217, v8.Length)]];
					v31 := v31[p0 := p0];
					var v32, v33, v34 := m6(p1, globalState);
					var v35: map<int, int> := map[v33 := cf7];
					v33 := -(if (v8[safeIndex(217, v8.Length)]) then f9 else |v35|);
				case DC5(cf8, cf9, cf10, cf11) =>
					cf9 := fm14(globalState);
					cf9 := false;
					var v36: map<bool, int> := map[true := cf10];
					v29[safeIndex(774, v29.Length)] := |v36[p1 := f9]| + cf11;
					v29[safeIndex(774, v29.Length)] := f9;
					...
					v37[safeIndex(86, v37.Length)] := v40;
					v37[safeIndex(86, v37.Length)] := v40;
				case DC6() =>
					globalState.f0 := ((seq(abs(263), i4  => (v0))) + "ng") < (v2 + v2);
					var v41, v42, v43 := m6(p1, globalState);
					r0 := f9;
					var v44 := new C1(v2, v41);
				case DC3(cf6) =>
					var v45: multiset<bool> := multiset{v8[safeIndex(217, v8.Length)], fm6(f9, globalState)};
					var v46: map<bool, bool> := map[f3 := v8[safeIndex(217, v8.Length)]];
					var v47: seq<bool> := [f3];
					f8, v45 := if (f3 in v46) then v46[f3] else v47[safeIndex(0x332, |v47|)], (multiset{!f4} * v45) - v45;
					r0 := f9;
					...
					v52 := v52[v8[safeIndex(217, v8.Length)] := cf6];
			}
			...
			v56 := v56[v55 := v2[safeIndex(f9, |v2|) := v0]];
			v29[safeIndex(369, v29.Length)] := 0x55;
			v29[safeIndex(369, v29.Length)] := f9;
			if (f4) {
				var v57 := DC45(safeModuloInt(0x2f, v29[safeIndex(369, v29.Length)]), f9, v54.f10, v54.f11, v55);
				v57 := v57;
				var v58: map<string, bool> := map[v2 + v2 := !f4];
				var v59 := DC5(f4, v54.f11, f9, f9);
				v8[safeIndex(217, v8.Length)] := if (fm30(v59, |v53|, f9, globalState) in v58) then v58[fm30(v59, |v53|, f9, globalState)] else false;
				var v60 := DC8(v8, v2);
				var v61: map<D2, int> := map[v60 := f9];
				v8[safeIndex(217, v8.Length)] := safeDivisionInt(v29[safeIndex(369, v29.Length)], |map[v61 := p0]|) >= fm5(v54.f10, v2, globalState);
				v29[safeIndex(369, v29.Length)] := v29[safeIndex(369, v29.Length)];
				var v62: seq<int> := [f9];
				var v63: map<seq<int>, char> := map[v62 := v0];
				var v64 := DC37(v63);
				var v65: map<D17, int> := map[v64 := v29[safeIndex(369, v29.Length)]];
				v65 := v65[DC37(v63) := v29[safeIndex(369, v29.Length)]];
			} else {
				v2 := "empl";
				var v66: seq<int> := [v29[safeIndex(369, v29.Length)]];
				var v67: map<bool, int> := map[v54.f10 := v29[safeIndex(369, v29.Length)]];
				r0 := fm31(!(if (f9 in v53) then v53[f9] else v8[safeIndex(217, v8.Length)]), v29[safeIndex(369, v29.Length)], v29[safeIndex(369, v29.Length)] !in v66, v55[safeIndex(if ((if (-|v2| in v53) then v53[-|v2|] else f4) in v67) then v67[if (-|v2| in v53) then v53[-|v2|] else f4] else |v55|, |v55|) := f4], globalState);
				var v68: map<array<bool>, int> := map[v8 := v29[safeIndex(369, v29.Length)]];
				var v69 := DC42(f9);
				v68 := v68[v8 := |(([f9])[safeIndex(f9, |[f9]|) := f9] + [v69.cf64])|];
				var v70: array<seq<int>> := new seq<int>[13] [v66 + v66, v66, v66, v66, seq(abs(-0xe5), i5  => (v29[safeIndex(369, v29.Length)])), [f9, f9, f9] + v66, (fm19(globalState))[safeIndex(|v66|, |fm19(globalState)|) := 0x9e], v66, v66, seq(abs(-0x147), i6  => (|DC48([v29[safeIndex(369, v29.Length)]]).cf80|)), v66, if (p1) then v66 else v66, v66];
				var v72: array<map<int, map<bool, char>>> := new map<int, map<bool, char>>[24](i7 => (map v71 : int | (0x89 <= v71) && (v71 < -50) :: (safeDivisionInt(v71, |v2|)) := (map[v54.f10 := v0])) + map[|{v55[safeIndex(v29[safeIndex(369, v29.Length)], |v55|)]}| := map[v54.f11 := 'p']]);
				var v73: map<bool, char> := map[!v8[safeIndex(217, v8.Length)] := v0];
				v72[safeIndex(696, v72.Length)] := map[v29[safeIndex(369, v29.Length)] := v73];
				var v74: array<D12> := new D12[20](i8 => DC27(v29[safeIndex(369, v29.Length)]));
				var v75: set<int> := {|v55|};
				var v76: map<int, set<int>> := map[v29[safeIndex(369, v29.Length)] := v75];
				var v77: map<int, map<bool, char>> := map[f9 := v73];
				var v78: seq<array<D12>> := [v74, if (p0) then v74 else v74, v74, v74, v74];
				r1, v70, v72[safeIndex(696, v72.Length)], v74 := (v75 * (if (f9 in v76) then v76[f9] else {f9, v29[safeIndex(369, v29.Length)]})) < v75, v70, v77, v78[safeIndex(|[|v2|, v29[safeIndex(369, v29.Length)]]|, |v78|)];
				var v79: seq<string> := ["qsnalpc"];
				var v80: map<int, seq<string>> := map[v29[safeIndex(369, v29.Length)] := v79];
				var v81 := DC15(if (v29[safeIndex(369, v29.Length)] in v80) then v80[v29[safeIndex(369, v29.Length)]] else v79);
				...
				v82, v29[safeIndex(369, v29.Length)], r0, r1 := v82, safeModuloInt(f9, v29[safeIndex(369, v29.Length)] * |v55|), f9, f3;
			}
			
		} else {
			var v83: seq<int> := [f9, f9];
			v29[safeIndex(605, v29.Length)] := |v83|;
			v29[safeIndex(605, v29.Length)] := 0x102;
			var v84 := new C3(f3, p0);
			var v85: T0 := new C2(f4, true, f3, f4);
			var v86: map<char, T0> := map[v0 := v85];
			var v87: multiset<int> := multiset{v29[safeIndex(605, v29.Length)], v29[safeIndex(605, v29.Length)], |v86|, f9};
			var v88: seq<bool> := [true, !!v8[safeIndex(217, v8.Length)], v87[f9 := abs(292)] >= multiset{|v83|}];
			v88 := v88[safeIndex(|v2|, |v88|) := v85.f3];
			globalState.f0 := v85.f3;
			f8 := v85.f3 <==> p0;
		}
		
		v29[safeIndex(115, v29.Length)] := f9;
		var v89: multiset<bool> := multiset{f3};
		v29[safeIndex(115, v29.Length)] := |v89|;
		var v90: map<int, string> := map[f9 := v2];
		r0 := if (v29[safeIndex(115, v29.Length)] in v90) then v29[safeIndex(115, v29.Length)] else f9;
		r1 := p1;
	}
	method m6(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<int>) {
		...
		var v4 := "jrkmvyivs";
		var v5: set<seq<T0>> := {v2, (if (f9 in v3) then v3[f9] else v2)[safeIndex(|v4|, |(if (f9 in v3) then v3[f9] else v2)|) := v1]};
		v0[safeIndex(336, v0.Length)] := v5;
		r0, v0[safeIndex(336, v0.Length)] := f3, (v5 - v5) * v5;
		...
		v12[safeIndex(588, v12.Length)] := v11;
		v12[safeIndex(588, v12.Length)] := [v10[v1 := v1]] + v11;
		var v13: array<seq<int>> := new seq<int>[21](i2 => [f9, f9, f9]);
		forall i1 | 0 <= i1 < v13.Length {
			v13[i1] := seq(abs(0x129), i3  => (safeDivisionInt(f9, f9)));
		}
		r0 := v1.f3;
...
class C5 extends T0, T1 {
	...
	method m0(p0: bool, p1: map<int, bool>, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		...
		if (|(v4 + v4)| <= (if (v3.f8) then v3.f9 else p2)) {
			...
			if (v3.f8) {
				...
				var v13 := DC32(v12);
				v11[safeIndex(368, v11.Length)] := v13;
				...
				v15[safeIndex(122, v15.Length)] := v14;
				var v16: array<int> := new int[9](i1 => i1 - |[0x259]|);
				r0, v10, v11[safeIndex(368, v11.Length)], v15[safeIndex(122, v15.Length)] := v16, (if (f3) then v10 else f6) + v10, v13.(cf46 := v12), v14;
				var v17: seq<bool> := [f4];
				...
				r1 := safeDivisionInt(v3.f9, safeModuloInt(v20.f9, if (v3.f8 in v21) then v21[v3.f8] else v3.f9));
				...
				v27[safeIndex(155, v27.Length)] := v3.f8;
				v27[safeIndex(155, v27.Length)] := !!fm21(v3.f9, v19 + v19[map v28 : int | v28 in p1 :: (v28 * v3.f9) := (f7) := abs(v3.f9)], globalState);
			}
			
			var v29: array<int> := new int[22];
			v29[safeIndex(322, v29.Length)] := p2;
			var v30: seq<int> := [p2];
			v29[safeIndex(322, v29.Length)] := DC46(v3.f9, f3, f4, DC5(f3, v3.f8, |f6|, v3.f9), |v30|).cf78 + (v3.f9 * v3.f9);
			var v31 := "aqudafc";
			v31 := f6;
			var v32: multiset<int> := multiset{safeDivisionInt(f7, v29[safeIndex(322, v29.Length)]), p2 + p2};
			v32 := multiset{f7, |v30|, f7, v3.f9, -|(v30 + v30)|};
		} else {
			var v33: multiset<int> := multiset{v3.f9};
			r1 := safeDivisionInt(v3.f9, if (v3.f9 in v33) then v33[v3.f9] else f7);
			var v34: set<bool> := {p0};
			...
			v35 := v35[fm30(v2, f7, |v37[safeIndex(|v39|, |v37|)]|, globalState) := v34];
			f7 := safeDivisionInt(f7 * |f6|, f7);
			var v40: array<multiset<int>> := new multiset<int>[15](i2 => v33);
			v40 := v40;
			var v41: array<bool> := new bool[4](i4 => f4);
			var v42 := DC8(v41, seq(abs(-0x136), i5  => (v38)));
			var v43: seq<string> := [(seq(abs(-0x378), i3  => (v38))) + f6, v42.cf14, f6, f6 + f6];
			var v44 := "tnqupg";
			v43, globalState.f0, r1, v44 := seq(abs(971), i6  => (v44)), (if (f3) then p0 else f4) && (v33 > multiset{v3.f9}), f7, v42.cf14 + ("vqw" + "fetrpyq");
		}
		...
		match (v2) {
			case DC4(cf7) =>
				...
				var v49: seq<bool> := [fm18(|v46[safeIndex(v3.f9, |v46|)]|, v47, v3.f9, globalState), p0, v3.f8, v48 >= v48, false];
				globalState.f0, globalState.f0 := v49[safeIndex(v3.f9, |v49|)], v3.f8;
				...
				var v63: array<int> := new int[26] [-cf7, p2, safeDivisionInt(v3.f9, cf7), |(DC8(v51, f6).cf14 + f6)|, |f6|, |v55[|map[v56 := f4]| := v54]|, safeDivisionInt(v3.f9, |fm42(v58, v3.f8, 0x22d, globalState)|), v3.f9, |(fm20(f4, globalState) - v59)|, -f7, f7, 0x34b, -v3.f9, cf7, v3.f9, f7 - f7, v3.f9, safeModuloInt(|(if (p2 in v61) then v61[p2] else v60)|, -v3.f9), |fm34(|f6|, v3.f9, globalState)|, cf7, v3.f9, -f7, fm31(f4, -|multiset{p2, v3.f9}|, v3.f8, [true, f4, f3, v3.f8], globalState) * v3.f9, f7, f7, -f7 - |v62|];
				var v64: map<char, bool> := map[v47 := f4];
				v63[safeIndex(319, v63.Length)] := |v64|;
				v63[safeIndex(319, v63.Length)] := (if (f3) then |f6| else cf7) * v3.fm5(v3.f8, f6, globalState);
				match (DC18(p1).(cf30 := map[v3.f9 := v3.f8])) {
					case DC19(cf31, cf32) =>
						...
						globalState.f0, v2, r1 := (v65 - v70[safeIndex(|v73|, |v70|)]) !! v65, v2, cf7;
					...
					case DC18(cf30) =>
						...
						globalState.f0 := (fm30(v2, |f6|, v63[safeIndex(319, v63.Length)], globalState) + "dnoyfw") < f6;
						v4 := v4[f6 == (seq(abs(0x372), i7  => ('l'))) := !!!f3];
			...
			case DC5(cf8, cf9, cf10, cf11) =>
				if (false) {
					...
					v80[safeIndex(170, v80.Length)] := v82;
					v80[safeIndex(170, v80.Length)] := v82;
					...
					v84[safeIndex(213, v84.Length)] := v85;
					v84[safeIndex(213, v84.Length)] := v85;
					...
					v87[safeIndex(339, v87.Length)] := v88;
					var v89: array<bool> := new bool[7](i10 => cf8);
					var v90: multiset<bool> := multiset{!v3.f8, true};
					v89[safeIndex(121, v89.Length)] := v90 >= v90;
					var v91 := "wfcgkb";
					v87[safeIndex(339, v87.Length)], cf11, v89[safeIndex(121, v89.Length)], v91, v89 := if (v3.f8) then v88 else v88, safeDivisionInt(cf10 * p2, 0x114), !f4, f6, v89;
				...
				v99[safeIndex(605, v99.Length)] := multiset{cf9};
				var v100: multiset<bool> := multiset{cf8, cf8};
				v99[safeIndex(605, v99.Length)] := v100;
			...
			case DC6() =>
				...
				v3.f8 := v107 < {v104[safeIndex(v3.f9, |v104|)]};
				if (-p2 in fm15(f4, f7, p2, fm4(false, globalState), globalState)) {
					...
					v108 := v108[-(v3.f9 + v109[safeIndex(p2, |v109|)]) := f6 + f6];
					var v110: set<int> := {f7, f7, v3.f9};
					var v111: array<int> := new int[1] [|v110|];
					v111[safeIndex(352, v111.Length)] := |f6|;
					v111[safeIndex(363, v111.Length)] := v3.f9;
					v111[safeIndex(352, v111.Length)], v3.f8, v111[safeIndex(363, v111.Length)] := -p2, true, p2;
					var v112 := DC46(v3.f9 * 0x272, p0, v3.f8, v2.(cf10 := v3.f9, cf9 := !fm21(v3.f9, multiset{v106}, globalState), cf8 := f4), v111[safeIndex(352, v111.Length)]);
					v112 := DC46(p2, v3.f8, p0, v2, -v111[safeIndex(352, v111.Length)]).(cf74 := v3.f9, cf77 := v2, cf75 := f4);
					v111[safeIndex(352, v111.Length)] := 0x3a4;
					v3.f8 := f4;
				} else {
					var v113: array<bool> := new bool[26];
					v113[safeIndex(269, v113.Length)] := if (!f4) then f3 else v3.f8;
					v113[safeIndex(269, v113.Length)] := v3.f8;
					var v114: multiset<int> := multiset{f7, p2};
					var v115 := new C2(v114 >= v114, !fm6(v3.f9, globalState), v113[safeIndex(269, v113.Length)], f3);
					var v116: map<bool, int> := map[v3.f8 := |v106|];
					globalState.f0 := (if (!p0 in v116) then v116[!p0] else f7) <= p2;
					var v117: seq<int> := [p2, -f7, p2];
					var v118 := DC19(|f6|, v115.fm16(v3.f9, v104[safeIndex(v117[safeIndex(f7, |v117|)], |v104|)], f7, p1, globalState));
			...
			case DC3(cf6) =>
				...
				var v121 := 'y';
				v120 := v120[(seq(abs(-0x22d), i11  => ('q')))[safeIndex(v3.f9, |(seq(abs(-0x22d), i11  => ('q')))|) := v121] := |"v"| - -0x214];
				f7 := f7;
				...
				match (v125) {
					case DC38(cf56) =>
						...
						var v128 := DC38(cf56);
						var v129: array<int> := new int[18] [v3.f9, f7, v3.f9, v123[safeIndex(if (f4 in v126) then v126[f4] else p2, |v123|)], f7, v3.f9, |(if (v3.f8) then v127 else v127[safeIndex(v3.f9, |v127|) := cf6])|, v3.f9, v3.f9 - v3.f9, -(v3.f9 * v3.f9), if (v3.f8) then p2 else |v128.cf56|, v3.f9, v3.f9, v3.f9, v3.f9, if (!v3.f8) then |v123| else v3.f9, v123[safeIndex(|v123|, |v123|)], f7];
						v129[safeIndex(790, v129.Length)] := p2 + p2;
						var v130: map<set<bool>, int> := map[{f4} := |f6|];
						v129[safeIndex(790, v129.Length)] := |(v130 + v130)|;
						v129[safeIndex(790, v129.Length)] := safeModuloInt(f7 + p2, v3.f9);
						v3.f8 := p0;
						var v131 := DC4(v3.f9);
						var v132 := DC10(v126 - v126[!f4 := abs(v3.f9)], v131.(cf7 := f7));
					...
					case DC39(cf57, cf58, cf59, cf60, cf61) =>
						f7 := v3.f9;
						cf61 := |(seq(abs(510), i12  => (map[false := v3.f9])))|;
						cf6[safeIndex(817, cf6.Length)] := !cf58;
						cf6[safeIndex(817, cf6.Length)] := fm18(p2, v121, safeDivisionInt(cf61, f7), globalState);
					...
					case DC37(cf55) =>
						...
						var v139: map<bool, int> := map[v137[safeIndex(-|v138[v3.f8 := v121]|, |v137|)] := p2];
						v139 := v139;
						f7 := safeDivisionInt(|[v3.f8, v3.f8]| + f7, v3.f9);
						var v140: array<int> := new int[6](i13 => i13 + f7);
						var v141: seq<array<int>> := [v140];
						var v142: array<seq<array<int>>> := new seq<array<int>>[7] [v141 + v141, v141, v141, v141 + v141[safeIndex(p2, |v141|) := v140], v141, v141 + [v140, v140], [v140, v140]];
						v142[safeIndex(616, v142.Length)] := v141;
						v142[safeIndex(616, v142.Length)] := v141 + (v141 + v141);
						var v143: array<map<int, int>> := new map<int, int>[20];
						var v144: map<int, int> := map[v3.f9 := p2];
						v143[safeIndex(107, v143.Length)] := v144;
						f7, v143[safeIndex(107, v143.Length)] := f7, map[|f6| := |f6|] + v144;
					case DC40(cf62) =>
						var v145 := new C3(true, f4);
						cf6[safeIndex(844, cf6.Length)] := p0;
						cf6[safeIndex(844, cf6.Length)] := f4;
						f7 := 0x11a;
						r1 := (fm0(globalState) * v3.f9) + safeModuloInt(|f6|, v3.f9);
				}
		...
		var v151 := DC3(v150);
		var v152: set<string> := {seq(abs(-315), i14  => ('y'))};
		var v153: set<bool> := {f3};
		r0 := new int[27] [f7, -v3.f9, if ("ochh" in v146) then v146["ochh"] else |v147|, v3.f9, f7, v3.f9, v3.f9, |p1|, if (p0 in v149) then v149[p0] else p2, v3.f9, |(map[v3.f9 := v150] + map[p2 := v151.cf6])|, safeDivisionInt(p2, f7), |f6|, |v152|, p2, f7, |v4| + f7, f7, f7, if (p0) then p2 else f7, v3.f9, p2 - p2, p2, 0x2ca, safeModuloInt(v3.f9, if (p0 in v149) then v149[p0] else f7), p2, |{v3.f9, p2, |v153|}|];
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v0 := new C1(seq(abs(497), i1  => ('y')), p1.f3);
			var v1: map<bool, bool> := map[v0.f13 := p1.f4];
			var v2: seq<int> := [p0, p0 + f7, fm0(globalState), p0, f7];
			var v3 := "fscgsd";
			v1, v2, v3 := v1, ([p0, f7] + v2)[safeIndex(p0, |([p0, f7] + v2)|) := safeDivisionInt(p0, p0)], "psukcoa" + v3;
			p1.f3 := true;
		...
		v9, p1.f3, v10[safeIndex(234, v10.Length)], v12, v13[safeIndex(984, v13.Length)] := v14.cf83, -0x198 <= (if (-f7 in v15) then v15[-f7] else f7), v20.cf70, v12, f6;
		match (v12) {
			case DC36(cf51, cf52, cf53, cf54) =>
				var v21 := new C2(false, cf53, v10[safeIndex(234, v10.Length)] <= f7, p1.f3);
				f7 := p0;
				var v22 := new C0();
				if (v15 == (v15 * v15)) {
					p1.f3, cf51, cf53, p1.f3 := v21.f11, set v24 : int | v24 in (set v23 : int | v23 in fm19(globalState) :: (v23 * -208)) :: (safeModuloInt(v24, if (!false) then 0x2a6 else |{[|[!!false]|, 0x338, |"hyhfjwks"|, |{!true}|], [719, |(map v25 : int | v25 in [|[|"oxtq"|, |"cb"|]|, --0x3da] :: (safeModuloInt(v25, 0xb2)) := (false))|]}|)), if (!f4) then v21.f10 else v21.f10, (v10[safeIndex(234, v10.Length)] + |v15|) >= -v10[safeIndex(234, v10.Length)];
					var v26 := DC5(p1.f3, cf53, fm3(globalState), p0);
					var v27: map<int, array<bool>> := map[v26.cf11 := DC3(v18).cf6];
					v27 := v27[v10[safeIndex(234, v10.Length)] := v18];
					f7 := p0 * v17[safeIndex(|cf51|, |v17|)];
					v21.m9(globalState);
					v18[safeIndex(3, v18.Length)] := p1.f3;
					var v29: seq<array<bool>> := [v18];
					var v30: map<int, int> := map[|v29| := p0];
					var v31: map<map<int, int>, bool> := map[(map v28 : int | (952 <= v28) && (v28 < -0x64) :: (v28 * |v13[safeIndex(984, v13.Length)]|) := (0x69)) + v30 := cf54];
					v10[safeIndex(234, v10.Length)], v13, v18[safeIndex(3, v18.Length)], r0, v31 := p0, v13, (f7 > f7) && cf52, 0x3d7 * (if (v21.f10) then 0x344 else p0), v31;
				} else {
					var v32 := DC5(p1.f3, p1.f3, v10[safeIndex(234, v10.Length)], v10[safeIndex(234, v10.Length)]);
					...
					v34 := DC46(0x2df - v10[safeIndex(234, v10.Length)], p1.f4, {if (cf53 in v35) then v35[cf53] else if (v10[safeIndex(234, v10.Length)] in v16) then v16[v10[safeIndex(234, v10.Length)]] else false} > v36, DC5(p1.f3, p1.f4, f7, v10[safeIndex(234, v10.Length)]), v22.fm10(v10[safeIndex(234, v10.Length)], cf54, v15, globalState));
					var v37: array<C0> := new C0[19];
					var v38: map<bool, array<C0>> := map[p1.f3 := v37];
					var v39 := DC44(v38);
					var v40: map<D19, int> := map[v39 := safeDivisionInt(f7, |v11|)];
					v40 := v40[v39 := |v15|];
					f7 := safeModuloInt(p0, p0);
					v35 := v35[!p1.f3 := v21.f11];
					var v41: seq<bool> := [cf53];
					var v42 := DC26(v36);
					var v43 := DC28(v42);
					var v44 := DC0(v10[safeIndex(234, v10.Length)]);
					var v45: set<D12> := {v43};
			...
			case DC35(cf50) =>
				...
				v18[safeIndex(608, v18.Length)] := p1.f4;
				v48, v18[safeIndex(608, v18.Length)] := v48, f4;
				p1.f3 := !f3;
				var v49: seq<string> := [(seq(abs(355), i3  => (v46))) + v13[safeIndex(984, v13.Length)], f6, "hxq"];
				v49 := v49;
				var v50: map<multiset<int>, bool> := map[v15 := !f3];
				var v51 := DC39(v10, p1.f4, if (v18[safeIndex(608, v18.Length)]) then p1.f4 else f4, |v50[v15 := f3]| + p0, f7);
				match (v51) {
					case DC38(cf56) =>
						v10[safeIndex(234, v10.Length)] := p0;
						v18[safeIndex(608, v18.Length)] := !fm14(globalState);
						var v52: multiset<bool> := multiset{p1.f4, p1.f4};
						var v53: map<string, multiset<bool>> := map[f6 := v52];
						var v54: set<bool> := {false, false, (if (cf56 in v53) then v53[cf56] else fm20(p1.f3, globalState)) < v52, v10[safeIndex(234, v10.Length)] == f7, f4};
						var v55: seq<bool> := [p1.f3];
						v54 := (DC26({f4}).(cf39 := v54)).cf39 - (v54 * fm33(if (f7 in v15) then v15[f7] else |v13[safeIndex(984, v13.Length)]|, v55, globalState));
						f3 := p1.f3;
					case DC39(cf57, cf58, cf59, cf60, cf61) =>
						var v56: array<multiset<bool>> := new multiset<bool>[10];
						var v57: seq<bool> := [cf58, cf59];
						v56[safeIndex(714, v56.Length)] := fm20(fm6(fm31(p1.f3, p0, cf58, v57, globalState), globalState), globalState);
						var v58: multiset<bool> := multiset{!v18[safeIndex(608, v18.Length)]};
						v56[safeIndex(714, v56.Length)] := v58;
						globalState.f0 := p1.f4;
						var v59: C1 := new C1(f6, p1.f3);
						var v60: seq<C1> := [v59];
						var v61: array<bool> := new bool[7](i4 => true);
						var v62: array<C1> := new C1[12] [v59, v59, v59, v59, v59, v60[safeIndex(0x3e7, |v60|)], v59, DC33(v61, v59).cf48, v59, v59, v59, v59];
						var v63: map<string, array<C1>> := map[v59.f12 := v62];
						var v64: map<multiset<bool>, array<C1>> := map[v56[safeIndex(714, v56.Length)] := v62];
						var v65: array<array<C1>> := new array<C1>[12] [v62, if ((seq(abs(0x327), i5  => (v46))) in v63) then v63[seq(abs(0x327), i5  => (v46))] else v62, v62, v62, v62, v62, if (f4) then v62 else v62, v62, v62, v62, v62, if (v58 in v64) then v64[v58] else v62];
						var v66: seq<array<C1>> := [v62, v62, v62, v62, v62];
						v65[safeIndex(626, v65.Length)] := v66[safeIndex(cf60, |v66|)];
						var v67: set<int> := {cf60};
						var v68: map<int, char> := map[p0 := v46];
						var v70: seq<map<int, char>> := [v68, v68, map v69 : int | v69 in v17 :: (safeDivisionInt(v69, cf61)) := (v46)];
						var v71: map<set<int>, int> := map[v67 := v10[safeIndex(234, v10.Length)] + -|v70[safeIndex(|f6|, |v70|) := map[v10[safeIndex(234, v10.Length)] := v46]]|];
						var v72 := DC4(-cf61);
						var v73 := DC5(cf59, p1.f4, v72.cf7, -0x350);
						cf57, v65[safeIndex(626, v65.Length)], v71, v18[safeIndex(608, v18.Length)] := v10, v62, (v71 + v71) + v71, v73.cf9;
						v18[safeIndex(608, v18.Length)] := p1.f3;
					case DC37(cf55) =>
						var v74: map<array<int>, bool> := map[v10 := true];
						v18[safeIndex(608, v18.Length)], p1.f3 := !!(v10 in v74), !(p0 == safeModuloInt(p0, p0));
						var v75 := new C1(f6 + v13[safeIndex(984, v13.Length)], p1.f3);
						v18[safeIndex(608, v18.Length)] := f3;
						r0 := |(seq(abs(779), i6  => (p0)))| + v10[safeIndex(234, v10.Length)];
					case DC40(cf62) =>
						v10[safeIndex(234, v10.Length)] := if (v48.cf34) then -0x2b4 else 0x3cd;
						var v76: set<bool> := {p1.f4};
						var v77: map<set<bool>, int> := map[v76 := f7];
						v77 := v77[v76 := f7];
						v9[safeIndex(106, v9.Length)] := v46;
						v9[safeIndex(106, v9.Length)] := 'e';
						r0 := v10[safeIndex(234, v10.Length)];
				}
		...
		for i7 := |v78| to |"pjx"| {
			f7 := p0;
			f7 := if (p1.f4) then p0 else p0 - v10[safeIndex(234, v10.Length)];
			var v79: array<seq<bool>> := new seq<bool>[12];
			v79[safeIndex(598, v79.Length)] := v78;
			v79[safeIndex(598, v79.Length)] := v78;
			f7 := -0xf0;
		}
		r0 := v10[safeIndex(234, v10.Length)];
	...
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
		...
		match (v1) {
			case DC4(cf7) =>
				...
				p1.f3, v6, v3 := p1.f4, v6 + (v6 + v6), fm32(f3, true, v7[safeIndex(cf7, |v7|)], !(multiset(v8) !! v11), globalState);
				...
				match (v15) {
					case DC33(cf47, cf48) =>
						...
						f7 := f7;
					case DC32(cf46) =>
						r0 := seq(abs(0xba), i2  => (DC1(p1.f4, v2).cf2));
						f3 := p1.f4;
						p1.f3 := p1.f4;
						var v19: multiset<bool> := multiset{p1.f3};
						var v20: seq<multiset<int>> := [multiset(v8), v11];
						var v21: seq<seq<int>> := [v8[safeIndex(|f6|, |v8|) := f7]];
						var v22: array<multiset<int>> := new multiset<int>[26] [v11, v11, v11[-0x214 := abs(cf7)] + multiset{-fm3(globalState)}, multiset(v8), multiset(v8), v11 * v11, v11[f7 := abs(if (false in v19) then v19[false] else f7)] * v20[safeIndex(cf7, |v20|)], multiset{0x190, f7} - multiset([cf7, cf7, |v19|]), multiset{cf7, f7, f7}, v20[safeIndex(|(seq(abs(607), i3  => (v2)))|, |v20|)], v11, v11 * v11, v11, v11, v11, v11, v11, multiset(v8), v11, multiset{cf7, f7, cf7}, v11, v11, multiset(v21[safeIndex(|f6|, |v21|)]), multiset{f7}, v11, v11];
						v22[safeIndex(381, v22.Length)] := v11;
						cf7, v22[safeIndex(381, v22.Length)] := f7, if (cf7 != cf7) then v11 else v11;
					case DC34(cf49) =>
						var v23 := new C1(f6, p1.f3);
						var v24 := DC5(p1.f4, true, f7, f7);
						var v25 := DC46(f7, p1.f3, f3, v24, cf7);
						r0 := if (v25.cf75 <== f4) then seq(abs(0xa9), i4  => (v2)) else v23.f12;
						...
						v28[safeIndex(703, v28.Length)] := v0;
						v8, v27, v28[safeIndex(703, v28.Length)], f7 := v8, v27, v0, f7;
						globalState.f0 := fm34(cf7, f7, globalState) <= (v7 + [p1.f3, p1.f3]);
				}
				
				var v29: array<C3> := new C3[1];
				var v30: C3 := new C3(p1.f3, f3);
				v29[safeIndex(224, v29.Length)] := v30;
				var v31: map<int, int> := map[|f6| := 0x80];
				var v32: multiset<map<int, int>> := multiset{v31};
				var v33 := DC55(v30);
				v29[safeIndex(224, v29.Length)] := if (v7 == [if (fm21(cf7, v32, globalState) in v6) then v6[fm21(cf7, v32, globalState)] else f4]) then v30 else if (true) then v30 else v33.cf88;
			case DC5(cf8, cf9, cf10, cf11) =>
				...
				var v37: seq<bool> := [false, v36[safeIndex(fm3(globalState), |v36|)], cf11 >= cf10];
			...
			case DC6() =>
				if (f3) {
					...
					var v46: array<int> := new int[14] [f7, if (fm4(false, globalState)) then f7 else f7, f7, f7, f7, fm31(if (v41 in v42) then v42[v41] else v43[safeIndex(f7, |v43|)], f7, f4, v43, globalState), |v43|, |v44|, f7, f7 * f7, safeModuloInt(f7, |v45|), -0x1c4, f7, |v41|];
					var v47: set<int> := {f7};
					var v48: seq<string> := [f6, f6, f6, f6, seq(abs(0x2cf), i5  => (p0))];
					f7, f7, f7, v46 := v39.fm0(globalState), if (p1.f4) then f7 else |v47|, |v48[safeIndex(f7, |v48|)]| * f7, v46;
					var v49: map<bool, int> := map[f4 := f7];
					var v50 := DC2(f4, v41[safeIndex(|v49|, |v41|)], f7);
					...
					v52[safeIndex(960, v52.Length)] := map[fm15(f3, f7, f7, p1.f3, globalState) := f4] + v54;
					var v56: map<int, int> := map[f7 := |(seq(abs(0x2b4), i6  => ('j')))|];
					v52[safeIndex(960, v52.Length)] := map v55 : map<int, bool> | v55 in (map[map[f7 := p1.f4] := f7])[v53 := |v56|] :: (v55) := (!false);
				} else {
					...
					v62 := v62;
					globalState.f0 := -safeDivisionInt(175, f7) == 0xd8;
			...
			case DC3(cf6) =>
				cf6[safeIndex(752, cf6.Length)] := f4;
				cf6[safeIndex(752, cf6.Length)] := p1.f3;
				var v71: array<int> := new int[2];
				var v72: set<array<int>> := {v71};
				f7 := |({v71} * v72)|;
				var v73: array<string> := new string[13] [f6 + f6, f6[safeIndex(|"urawnxuq"|, |f6|) := fm23(f3, f7, globalState)], f6 + f6, if (p1.f3) then f6 else f6, f6 + f6, DC38(f6).cf56[safeIndex(219, |DC38(f6).cf56|) := p0], "doqvtbv" + f6, seq(abs(603), i7  => (p0)), f6, seq(abs(0xa8), i8  => (p0)), "porrudmcw", f6, f6];
				v73[safeIndex(747, v73.Length)] := f6;
				v73[safeIndex(747, v73.Length)] := f6 + (seq(abs(-0x3f), i9  => (p0)));
		...
		if (-safeDivisionInt(|v77|, f7) < safeModuloInt(|v78|, f7)) {
			var v79: set<int> := {f7};
			var v80 := DC36(v79, p1.f3, false, !fm14(globalState));
			var v81: seq<bool> := [true, p1.f4];
			match (v80.(cf51 := {706}, cf53 := v81[safeIndex(f7, |v81|)])) {
				case DC36(cf51, cf52, cf53, cf54) =>
					var v82: array<string> := new string[15];
					v82[safeIndex(106, v82.Length)] := f6;
					v82[safeIndex(106, v82.Length)] := f6;
					v76 := v76;
					v76 := v76;
					m4(globalState);
				case DC35(cf50) =>
					...
					var v85 := DC28(v84);
					var v86 := DC28(v84);
					v83[safeIndex(811, v83.Length)] := v86;
					v83[safeIndex(811, v83.Length)] := v86.(cf41 := v85);
					...
					f3 := fm18(|map[|(if (|v90[safeIndex(-fm31(p1.f4, f7, true, v81, globalState), |v90|) := v89]| in v88) then v88[|v90[safeIndex(-fm31(p1.f4, f7, true, v81, globalState), |v90|) := v89]|] else v91)| := |v92|]|, p0, f7, globalState);
					var v93: map<int, bool> := map[f7 := false];
					p1.f3 := f7 >= -|v93|;
			}
			
			v76[safeIndex(336, v76.Length)] := f7;
			var v95: array<D9> := new D9[15](i11 => DC21(set v94 : int | (0x15f <= v94) && (v94 < 0xef) :: (safeDivisionInt(v94, f7))));
			var v96: seq<array<D9>> := [v95];
			var v97 := DC32(v95);
			var v98: multiset<D15> := multiset{DC32(v96[safeIndex(f7, |v96|)]), v97, v97, v97};
			var v99: map<multiset<D15>, bool> := map[v98 := f7 < f7];
			v76[safeIndex(336, v76.Length)], v99 := safeModuloInt(|v78| - -|"cpdfirkd"|, |fm19(globalState)|), (map[v98 := p1.f4])[v98 := p1.f4] + v99;
			...
			var v103: map<map<bool, bool>, map<int, int>> := map[map[!p1.f4 := fm18(v76[safeIndex(336, v76.Length)], p0, 0x5, globalState)] := v102];
			v103 := v103;
		} else {
			f7 := if (p1.f3 in v78) then v78[p1.f3] else f7 * f7;
			var v104 := DC5(p1.f4, p1.f3, f7, f7);
			var v105: seq<string> := [f6];
			p1.f3, v0, globalState.f0, f7 := fm30(v104, f7, f7, globalState) != v105[safeIndex(f7, |v105|)], v0, true, f7;
			if (if (p1.f3) then f7 == |[p1]| else p1.f4) {
				...
				var v111 := new C2(v109 in v110, f6 != (fm30(v104, 0x56, f7, globalState))[safeIndex(f7, |fm30(v104, 0x56, f7, globalState)|) := 'i'], f3, p1.f4);
				...
				var v118 := DC38(("ymgcfot")[safeIndex(f7, |"ymgcfot"|) := p0]);
				var v119: array<string> := new string[29] [f6, "tufjnmcu", f6, f6, seq(abs(0x268), i12  => (p0)), "drlwyki", (if (v114 in v115) then v115[v114] else v114.f12[safeIndex(|v116|, |v114.f12|) := 'p']) + f6, seq(abs(-0xb2), i13  => (p0)), f6 + v114.f12, "iv" + v114.f12, f6, "kagcscus", f6, v114.f12, f6, if (f4) then v114.f12 else "ldrf", if (f3) then v114.f12 else f6, v114.f12, v114.f12, v114.f12, v114.f12, f6, f6, if (p1.f4 in v117) then v117[p1.f4] else f6, f6, "lfmg" + v118.cf56, f6 + "ukbecno", "lxn" + f6, f6];
				v119[safeIndex(279, v119.Length)] := v114.f12;
				v119[safeIndex(279, v119.Length)] := ((seq(abs(31), i14  => (p0))) + v114.f12) + ("pnqsnqy" + f6);
				p1.f3 := p1.f4;
				p1.f3 := !f3;
				var v120: array<array<int>> := new array<int>[11] [v76, v76, v76, v76, v77[safeIndex(f7, |v77|)], v76, v76, v76, v76, v76, v76];
				var v121 := DC50(f7, p1.fm0(globalState));
				var v122: multiset<bool> := multiset{p1.f3, f4, !p1.f4, p1.f3, p1.f3};
				f7, p1.f3, v120, f7, f3 := safeDivisionInt(fm31(f4, 0xac, p1.f4, (fm34(f7, 0x126, globalState))[safeIndex(|f6|, |fm34(f7, 0x126, globalState)|) := p1.f3], globalState), if (p1.f4 in v78) then v78[p1.f4] else f7), p1.f4, v120, v121.cf82 + (f7 * f7), if (p1.f3) then p1.f4 in v122 else if (!v114.f13) then !p1.f3 else f3;
				p1.f3 := v114.f13;
			}
		...
		f7 := f7;
		v76[safeIndex(46, v76.Length)] := |f6|;
		v76[safeIndex(46, v76.Length)] := safeModuloInt(f7, 750);
		var v123: multiset<int> := multiset{v76[safeIndex(46, v76.Length)]};
		var v124 := new C1(f6, v123 >= v123);
		var v125: seq<int> := [v76[safeIndex(46, v76.Length)]];
		...
		var v130: map<seq<int>, array<set<char>>> := map[v125 := v129[safeIndex(v76[safeIndex(46, v76.Length)], |v129|)]];
	...
	method m3(p0: string, p1: bool, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: int) {
		...
		if (f4) {
			...
			var v17: seq<set<D17>> := [v16[safeIndex(f7, |v16|)]];
			...
			match (v28) {
				case DC1(cf1, cf2) =>
					...
					v29[safeIndex(465, v29.Length)] := v31;
					var v32: array<int> := new int[8];
					var v33 := DC39(v32, cf1, true, f7, p3);
					f7, v1, v4[safeIndex(91, v4.Length)], v29[safeIndex(465, v29.Length)], cf2 := f7, f6, p1, map[f4 := (multiset{v33.cf60})[p3 := abs(p3)]] + v31, v0;
					globalState.f0 := fm18(p3, 'v', fm31(f3, p3, false, [f3], globalState), globalState);
					var v34: seq<multiset<int>> := [v30[p3 := abs(p3)]];
					var v35: set<int> := {f7};
					f7 := v5.fm10(f7 * p3, f4, v34[safeIndex(|v35|, |v34|)], globalState);
					var v36 := new C2(cf1, f3, !p2, p1);
				case DC2(cf3, cf4, cf5) =>
					f7, f3, v4 := |v11| + (f7 * f7), f3, v4;
					v1 := seq(abs(0x33c), i2  => (DC1(f4, 'm').cf2));
					var v37: map<char, char> := map[v1[safeIndex(p3, |v1|)] := v0];
					...
					var v44: map<int, seq<int>> := map[|v43[f4 := abs(0x235)]| := v11];
					cf5 := -safeDivisionInt(f7 * |v44|, fm3(globalState));
				case DC0(cf0) =>
					v6 := v6[f7 := f6 != v1];
					r1 := p1;
					cf0 := f7;
					...
					r1 := multiset(v45) > v46[p1 := abs(15)];
			}
			
			var v47: array<int> := new int[20](i3 => safeModuloInt(i3, f7));
			v47[safeIndex(412, v47.Length)] := p3;
			var v48: seq<bool> := [!f3, p1];
			var v49: seq<seq<bool>> := [v48[safeIndex(f7, |v48|) := f4] + v48];
			v47[safeIndex(412, v47.Length)] := |v49[safeIndex(p3, |v49|)]|;
		} else {
			r2 := p3;
			if (f7 != |fm20(f4, globalState)|) {
				...
				v64[safeIndex(642, v64.Length)] := v68;
				var v69 := DC51(v65);
				var v70 := DC54(v69);
				var v71: seq<bool> := [v63.f3];
				var v72: seq<D21> := [v69];
				var v73: array<D21> := new D21[20] [v70, v70.(cf87 := v69), v70, if (f4) then v70 else v70, v70, v70, v70, if (v63.f3) then DC54(v69).(cf87 := v69) else DC54(v69), if (v71[safeIndex(|map[v63.f3 := f3]|, |v71|)]) then v70 else v70, DC54(v69).(cf87 := v69), if (p2) then DC54(v69) else v70, v70, v70.(cf87 := v69), v70, v70, DC54(v69), v70, if (f3) then DC54(v69) else DC54(v69), DC54(v72[safeIndex(f7, |v72|)]), v70];
				v73[safeIndex(343, v73.Length)] := v70;
				var v74: array<int> := new int[11];
				var v75: seq<array<int>> := [v74];
				r1, r2, v64[safeIndex(642, v64.Length)], f7, v73[safeIndex(343, v73.Length)] := false, -safeDivisionInt(p3, f7), v68, |v75|, v70;
			...
			f7, v0, globalState.f0, r1, r3 := fm31(p1, |(v1 + p0)|, false, v81, globalState), v0, v82 in (if (f4) then v83 else v84[safeIndex(p3, |v84|)]), p2, safeModuloInt(p3, fm0(globalState));
	...
	method m4(globalState: GlobalState) {
		var v0: C0 := new C0();
		var v1 := DC7((multiset{v0, v0})[v0 := abs(f7)]);
		var v2: map<D2, bool> := map[v1 := f7 >= |[f3]|];
		v2 := v2[v1 := f4];
		for i0 := f7 to f7 {
			var v3: array<int> := new int[2];
			v3[safeIndex(675, v3.Length)] := i0;
			var v4: C4 := new C4(f3, |{i0}|, !f4, f3);
			var v5: map<C4, int> := map[v4 := v4.f9];
			var v6: set<map<C4, int>> := {v5};
			var v7 := DC62(v6);
			f3, v3[safeIndex(675, v3.Length)] := (v6 - v6) != v7.cf99, |(seq(abs(-0x324), i1  => (-|{f7, 0x99}| * -0x14e)))|;
			var v8 := 'x';
			var v9: multiset<int> := multiset{v4.f9};
			var v10: seq<int> := [|v9|];
			var v11: seq<bool> := [v4.f8, v4.f8];
			v3[safeIndex(675, v3.Length)], f3, v8, f7 := (if (!f3) then i0 else 0x319) + (f7 - |v10|), f4, v8, safeDivisionInt(|v11| + i0, i0);
			var v12: array<D16> := new D16[4];
			var v13: map<bool, int> := map[f3 := i0];
			var v14 := DC35(v13);
			v12[safeIndex(924, v12.Length)] := v14;
			v12[safeIndex(924, v12.Length)] := v14;
		...
		var v20: map<array<int>, int> := map[if (f3) then v16 else v16 := |{v17, multiset{DC2(f3, 491, |v15|).cf3, fm21(f7, v19, globalState), f3}, v17, v17, v17[f3 := abs(f7)]}|];
		v20 := v20[v16 := f7 - |(seq(abs(976), i2  => ('a')))|];
		f7 := f7;
		var v21: array<map<int, bool>> := new map<int, bool>[6] [v15, v15, v15, v15, v15, v15];
		forall i3 | 0 <= i3 < v21.Length {
			v21[i3] := (v15 + v15) + v15;
		}
		var v22: C4 := new C4(fm21(f7, v19, globalState), 0x2f7, if (!f3) then f3 else f4, fm21(f7, v19[v18 := abs(f7)], globalState));
		v22 := v22;
	}
}
...
class C6 extends T0, T1 {
	...
	function fm1(p0: bool, p1: int, p2: bool, p3: seq<seq<int>>, globalState: GlobalState): int {
		-safeDivisionInt(safeModuloInt(0x33c, |"x"|), 0x20a)
	}
	...
	method m0(p0: bool, p1: map<int, bool>, p2: int, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		...
		var v3 := new C5(v2[safeIndex(p2, |v2|)], -|(v1 + v1)|, f4, f4);
		for i0 := p2 to p2 {
			r1 := v0[safeIndex(v3.f7, |v0|)];
			var v4: array<bool> := new bool[1] [f3 && p0];
			v4[safeIndex(931, v4.Length)] := f5;
			var v5 := 'f';
			var v6: map<bool, bool> := map[f3 := f5];
			v1, v4[safeIndex(931, v4.Length)] := v3.f6, fm18(0x3e4, v5, |v6|, globalState);
			if (f4) {
				var v7: array<int> := new int[24];
				v7[safeIndex(196, v7.Length)] := i0;
				v7[safeIndex(196, v7.Length)] := (p2 - p2) + v3.f7;
				var v8: array<array<int>> := new array<int>[22];
				v8[safeIndex(250, v8.Length)] := v7;
				v8[safeIndex(250, v8.Length)] := v7;
				v7[safeIndex(196, v7.Length)] := v3.f7;
				var v9: seq<seq<int>> := [v0, v0];
				var v10: C4 := new C4(i0 < fm1(!f5, v3.f7, p0, v9, globalState), -i0, true, if (f5) then !f4 else false);
				v10 := v10;
				var v11: map<int, int> := map[v3.f7 * v7[safeIndex(196, v7.Length)] := v3.f7];
				v11 := v11[safeModuloInt(v7[safeIndex(196, v7.Length)], v3.f7) := v3.f7];
			} else {
				var v12: C2 := new C2(f3, v4[safeIndex(931, v4.Length)], f4, f5);
				var v13: map<C2, char> := map[v12 := v5];
				var v14: map<char, bool> := map[if (v12 in v13) then v13[v12] else v5 := v12.f10];
				f5 := map[v5 := false] != v14;
				var v15: array<int> := new int[12](i1 => safeModuloInt(i1, |v3.f6|));
				r0 := v15;
				var v16: C0 := new C0();
				var v17: map<C0, bool> := map[v16 := v12.f10];
				var v18: T0 := new C4(v4[safeIndex(931, v4.Length)] <==> p0, |v17|, v12.f10, v12.f10);
				v18 := v18;
				var v19: multiset<int> := multiset{i0, |v0|};
				var v20: C3 := new C3(true, v4[safeIndex(931, v4.Length)]);
				var v21: map<C3, multiset<int>> := map[v20 := multiset{i0, v3.f7, 0x35a}];
				var v22 := new C3(v4[safeIndex(931, v4.Length)], v19 >= (if (v20 in v21) then v21[v20] else multiset(v0)));
				var v23: map<bool, int> := map[v12.f10 := v0[safeIndex(p2, |v0|)]];
		...
		v25 := v25;
		r1 := safeModuloInt(safeDivisionInt(v3.f7, p2), p2 - v3.f7);
	...
	method m1(p0: int, p1: T0, globalState: GlobalState) returns (r0: int) {
		...
		var v9 := DC48(v8);
		var v10 := 'x';
		var v11: seq<string> := [seq(abs(-0x69), i0  => ('s')), v6[safeIndex(p0, |v6|) := v10]];
		v4 := map[v0 := p0] + fm47(|v7|, f3, v9, v11[safeIndex(p0, |v11|)], globalState);
		v6 := v6[safeIndex(-p0, |v6|) := v10];
		var i1 := 0;
		while (p1.f3)
			decreases 100 - i1
		{
			...
			if (p1.f4) {
				...
				var v19: array<seq<bool>> := new seq<bool>[15] [v12, v12, [f4, true, p1.f4, p1.f3, true], v12, v12, v12 + v12, v12, v12, v12, v12 + v12, v12, (v12 + v18[safeIndex(p0, |v18|)])[safeIndex(|v12|, |(v12 + v18[safeIndex(p0, |v18|)])|) := p1.f3], v12, v12, [false]];
				v19[safeIndex(613, v19.Length)] := v12 + v12;
				v19[safeIndex(613, v19.Length)] := (fm34(p0, v14.f9, globalState) + v12) + v12;
				r0 := safeModuloInt(p0, p0 * |v6|);
			} else {
				var v20: map<int, bool> := map[|v12| := p1.f4];
				var v21, v22 := p1.m0(p1.f4, v20, safeDivisionInt(p0, p0), globalState);
				var v23: map<int, int> := map[v22 := -0x110];
				var v24: multiset<bool> := multiset{f3};
				globalState.f0 := DC2(p1.f3, -0x232, |v23[|v8| := |v24|]|).cf3;
				v21[safeIndex(155, v21.Length)] := v22;
				var v25: seq<seq<int>> := [v8];
				var v26: map<int, seq<seq<int>>> := map[-p0 := v25];
				var v27 := DC66(if (p0 in v26) then v26[p0] else v25);
				v22, v21[safeIndex(155, v21.Length)] := fm1(fm4(p1.f3, globalState), v22, if (v22 in v20) then v20[v22] else p1.f3, v27.cf108, globalState), -((if (p1.f4) then -p0 else |v8|) - v22);
				var v28 := DC39(v21, p1.f3, p1.f3, p0, v21[safeIndex(155, v21.Length)]);
				v21[safeIndex(155, v21.Length)] := v28.cf60;
				v21[safeIndex(155, v21.Length)] := p0;
			}
		...
		match (v32.(cf88 := v31).(cf88 := v31)) {
			case DC56(cf89, cf90) =>
				...
				var v35: map<char, array<int>> := map[v10 := v34[safeIndex(cf89, |v34|)]];
				...
				v36[safeIndex(265, v36.Length)] := v33;
				var v37: C0 := new C0();
				...
				v41[safeIndex(579, v41.Length)] := v30.f11;
				var v42 := DC0(0x14f);
				var v43: set<bool> := {v30.f11, p1.f3};
				v36[safeIndex(265, v36.Length)], v7, r0, v40, v41[safeIndex(579, v41.Length)] := v33, multiset{safeDivisionInt(cf89, cf89)}, if (fm18(p0, v10, v42.cf0, globalState)) then |v43| else |{fm4(p1.f4, globalState), p1.f4}|, v40, f4;
				var v44: array<char> := new char[24](i2 => v10);
				v44[safeIndex(813, v44.Length)] := v10;
				v44[safeIndex(813, v44.Length)] := v10;
				v44[safeIndex(813, v44.Length)] := v10;
				v36[safeIndex(265, v36.Length)][safeIndex(209, v36[safeIndex(265, v36.Length)].Length)] := |v8|;
				v36[safeIndex(265, v36.Length)][safeIndex(209, v36[safeIndex(265, v36.Length)].Length)] := cf89;
			case DC55(cf88) =>
				var v45: array<bool> := new bool[18](i3 => DC43(v8[safeIndex(p0, |v8|)], DC45(p0, 0xa7, v30.f10, f5, [f5]).cf70, p1.f4).cf67);
				v45 := v45;
				...
				v45[safeIndex(537, v45.Length)] := p1.f3;
				var v50: multiset<string> := multiset{v6};
				var v51: map<bool, int> := map[v30.f11 := 0x299];
				var v52 := DC5(p1.f3, p1.f4, |v50["fiktmwl" := abs(|v51|)]|, p0);
				var v53: array<D1> := new D1[8] [v52, DC5(!true, v30.f11, -0x220, p0), DC5(p1.f3, p1.f3, p0, p0), v52, fm48(v30.f10, globalState), v52, v52, v52];
				v45[safeIndex(537, v45.Length)], v53, p1.f3 := p1.f4, if (v30.f11 || true) then v53 else v53, p1.f4;
				r0 := if (v46[safeIndex(p0, |v46|)] in v51) then v51[v46[safeIndex(p0, |v46|)]] else p0 + p0;
			case DC57(cf91) =>
				p1.f3 := p1.f4;
				r0 := -(837 + p0);
				v10 := v10;
				...
				var v56 := DC45(|v6|, v8[safeIndex(|v55|, |v8|)], true, false, v54);
	...
	method m2(p0: char, p1: T0, globalState: GlobalState) returns (r0: string) {
		...
		var v6, v7 := p1.m0(f5, v1, |v2[p1.f3 := abs(-v3[safeIndex(fm1(true, |v4|, f5, v5, globalState), |v3|)])]|, globalState);
		...
		var v9: multiset<string> := multiset{seq(abs(0x3cd), i0  => (p0)), v4, fm30(DC5(!f3, f5, v0, fm1(p1.f4, |[f5]|, p1.f3, seq(abs(0x17f), i1  => ([v0])), globalState)), v7, v7, globalState), v4};
		var v10: map<int, seq<int>> := map[v0 := v3];
		var v11 := DC39(v6, f4, f3, v7, v7);
		var v12: map<bool, D17> := map[p1.f3 := v11];
		v6 := new int[13] [v7, if (!f4) then v7 else -0x2e, if ((seq(abs(-0x37b), i2  => (p0))) in v9) then v9[seq(abs(-0x37b), i2  => (p0))] else v7, |(if (v0 in v10) then v10[v0] else seq(abs(630), i3  => (v0)))|, |v12[f4 := v11]|, v0, v0, v0, safeDivisionInt(v0, -v0), |v4|, v0, v7, v7];
		for i4 := v0 to v7 - v0 {
			v0 := i4;
			v7 := v0;
			var v13: seq<bool> := [f4];
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			p1.f3 := p1.f4;
			v6[safeIndex(799, v6.Length)] := 0x17 + v7;
			v6[safeIndex(799, v6.Length)] := |(set v14 : int | v14 in v1 :: (v14 * (|map[!true := --|map[true := 'w']|]| * DC5(!true, !true, 803, |multiset{true}|).cf11)))|;
			v0 := v7;
			f5 := false;
		}
...
function fm13(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState): map<string, int> {
	match if (!!false) then DC59("bhpqe", 0x12c, 162) else DC59(seq(abs(0x17c), i0  => ('q')), -580, -|multiset{0x247}|) {
		case DC59(cf93, cf94, cf95) => map[cf93 := cf94] + map["f" := cf95]
		case DC60(cf96, cf97) => map["bk" := |map[cf97 := false]|] + (map v0 : string | v0 in (seq(abs(0xf8), i1  => ("qvbfh"))) :: (v0) := (0x1bf))
		case DC61(cf98) => map v1 : string | v1 in multiset{"aubgkgk"} :: (v1) := (cf98)
		case DC58(cf92) => map[seq(abs(0x2b6), i2  => ('l')) := -0x2cb]
	}
}
function fm14(globalState: GlobalState): bool {
	("eb" + "mehe") < ((seq(abs(-217), i0  => ('n'))) + "lypkvvier")
}
...
function fm18(p0: int, p1: char, p2: int, globalState: GlobalState): bool {
	!((seq(abs(971), i0  => (|map[false := false]|))) < [0x1e5, 0x38c, |{14}|, 375])
}
...
function fm24(globalState: GlobalState): multiset<int> {
	multiset(if (if (false) then true else !!false) then if (!true) then [|"ptxr"|] else [622] else (seq(abs(0x6b), i0  => (-0x24b))) + [|multiset([true])|])
}
...
function fm29(p0: int, globalState: GlobalState): seq<seq<int>> {
	(seq(abs(-0x3ab), i0  => ([|[-0x19]|]))) + [[153, -|(map v0 : char | v0 in multiset(seq(abs(0x178), i1  => ('g'))) :: (v0) := (0x280))|]]
}
function fm30(p0: D1, p1: int, p2: int, globalState: GlobalState): string {
	(seq(abs(0x3de), i0  => ('t'))) + "h"
}
...
function fm32(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): set<int> {
	{-safeModuloInt(|[!false, true, false]|, |[seq(abs(-0x22b), i0  => (-0x2b5)), [|(map v0 : int | (634 <= v0) && (v0 < 0x13a) :: (safeDivisionInt(v0, --|"crmga"|)) := (false))|, |[true, true]|], seq(abs(0x23c), i1  => (|(seq(abs(0x82), i2  => ('g')))|))]|), -951, 0x2e3 * 0x139}
}
function fm33(p0: int, p1: seq<bool>, globalState: GlobalState): set<bool> {
	{true, DC56(-|(set v0 : int | v0 in [0x142] :: (safeDivisionInt(v0, 0xf4)))|, false).cf90, true} + {true}
}
function fm34(p0: int, p1: int, globalState: GlobalState): seq<bool> {
	[true, false] + [!false, false]
}
function fm35(p0: bool, globalState: GlobalState): seq<string> {
	(["yg"] + ["strrna"]) + ([seq(abs(0x1), i0  => ('r'))] + ["ifw"])
}
...
function fm37(p0: int, globalState: GlobalState): D16 {
	if (---|{|map[false := |map[map[!true := false] := true]|]|, 0x25f, -|multiset{seq(abs(0x17c), i0  => ('r')), seq(abs(0x3e3), i1  => ('a'))}|}| == -0x2ce) then DC36({-0x377}, !true, true, false) else DC36({0x8d}, false, false, !false)
}
...
function fm39(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): D3 {
	DC10(DC10(multiset{true, false}, DC4(-0x3e0)).cf16, DC4(|map[|(seq(abs(0x23f), i0  => ('t')))| := 0xc]|))
}
...
function fm42(p0: D8, p1: bool, p2: int, globalState: GlobalState): multiset<D4> {
	(multiset{DC12(|[|(seq(abs(391), i0  => (|"bpkjcwei"|)))|, |"kkajua"|, |[true]|]|, |[|map[!true := false]|]|, false)} - multiset{DC12(|multiset{false}|, -0x29, DC56(560, false).cf90)}) - multiset(DC68([DC12(-|"pw"|, -0x253, true), DC12(|"nmeenbgie"|, 0x375, true)]).cf110)
}
...
function fm44(p0: bool, p1: bool, globalState: GlobalState): set<set<D17>> {
	{{DC37(map[[|"a"|, 0x37] := 'b']), DC37(map[[0x1c8, -|[false, false]|] := 'x']), DC37(map v0 : seq<int> | v0 in [[0x176]] :: (v0) := ('o'))} - {DC37(map v1 : seq<int> | v1 in map[[|map['a' := |multiset{0x34e, -631}|]|, 0x21e] := |[!!false, false, false]|] :: (v1) := ('f')), DC37(map[seq(abs(0x267), i0  => (|"mcdjuq"|)) := 'q'])}, {DC37(map v2 : seq<int> | v2 in multiset(seq(abs(0x49), i1  => ([-617]))) :: (v2) := ('i'))}}
}
function fm45(p0: int, p1: bool, globalState: GlobalState): map<char, char> {
	map['i' := 'u']
}
function fm46(globalState: GlobalState): map<bool, string> {
	map[499 < -DC5(false, false, |multiset{true}|, --179).cf11 := (seq(abs(0x2f), i0  => ('j'))) + "dwrbjb"]
}
function fm47(p0: int, p1: bool, p2: D20, p3: string, globalState: GlobalState): map<set<int>, int> {
	map[{|(map v0 : string | v0 in multiset(["ji", "yns", seq(abs(0x3a6), i0  => ('w')), seq(abs(0x2de), i1  => ('e'))]) :: (v0) := (false))|} := 0x276]
}
function fm48(p0: bool, globalState: GlobalState): D1 {
	if ({!true} < {true}) then DC5(true, true, |{|(seq(abs(-114), i0  => (|{false}|)))|, 0x3ad, -0xfe, 841}|, 0x75) else DC5(!true, true, |multiset{|multiset{|map[|map[!false := 'x']| := false]|}|, -0x360}|, |map['n' := false]|)
}
function fm49(p0: int, globalState: GlobalState): D23 {
	DC59(seq(abs(0x1fb), i0  => ('v')), 0x8, |{true, true}| * 0x1e7)
}
...
method m12(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: D11, r1: int, r2: seq<T1>, r3: C2) {
	...
	for i0 := p0 to fm31(p2, p0, !p3, v0, globalState) {
		...
		var v7: array<array<bool>> := new array<bool>[18] [if (i0 in v3) then v3[i0] else v2, v2, v2, v2, v2, v2, v2, v5.cf47, v2, v2, v2, if (p2) then v2 else v2, v2, v2, v6[safeIndex(-869, |v6|)], v2, v2, v2];
		v7[safeIndex(44, v7.Length)] := v2;
		var v8: C3 := new C3(v4.f13, p2);
		var v9 := DC55(v8);
		v1, v7[safeIndex(44, v7.Length)], globalState.f0, v2, v9 := seq(abs(0x2f1), i2  => (if (v4.f13) then 'm' else 'o')), v2, p3, v2, v9;
		...
		var v18 := DC8(v7[safeIndex(44, v7.Length)], v4.f12);
		var v19 := 'i';
		var v20: C0 := new C0();
		var v21: seq<C0> := [v20];
		var v22: multiset<int> := multiset{v12.f7, 870};
		var v23: set<int> := {|(seq(abs(0x155), i3  => (v19)))|, -p0};
		var v24: array<int> := new int[20] [p0 * i0, i0, i0, 24 - |[v11]|, v10.f9, |(v14 * {if (fm21(i0, v17, globalState) in v15) then v15[fm21(i0, v17, globalState)] else v13})|, p0, i0, |fm30(DC5(v4.f13, v4.f13, i0, v10.f9), v10.fm5(v4.f13, v18.cf14[safeIndex(i0, |v18.cf14|) := v19], globalState), |v12.f6|, globalState)|, v12.f7 * v12.f7, |v0| * p0, |([v20, v20, v20, v20] + v21[safeIndex(|v22|, |v21|) := v20])|, v10.fm0(globalState), v10.f9, v12.f7 - p0, v12.f7, -490, i0, safeModuloInt(--p0, |v23|), v10.fm5(p2, v1, globalState) * i0];
		v24[safeIndex(883, v24.Length)] := v12.f7;
		v24[safeIndex(883, v24.Length)] := p0;
	}
	var v25: array<int> := new int[7];
	var v26: array<bool> := new bool[2](i4 => p1);
	v26[safeIndex(969, v26.Length)] := p1;
	var v27 := "fkcu";
	...
	var v35: seq<map<int, bool>> := [v34[safeIndex(|v28.f12|, |v34|)], v31];
	globalState.f0, r1, v25, v26[safeIndex(969, v26.Length)] := !(v30 <= (v30 + v30)), p0, v25, (v32 + {v31, map[|v33.cf30| := v28.f13]}) !! (set v36 : map<int, bool> | v36 in v35 :: (v36));
	var v37: C4 := new C4(!!false, p0, v28.f13, v26[safeIndex(969, v26.Length)]);
	var v38: map<C4, bool> := map[v37 := v37.f8];
	v38 := v38[v37 := v28.f12 < v27];
	for i5 := 838 to -p0 {
		v25[safeIndex(813, v25.Length)] := v37.f9;
		var v39 := DC45(i5, -i5, fm6(v37.f9, globalState), p1, v0);
		var v40: C6 := new C6(!v28.f13, v28.f13, v39.cf72);
		var v41: set<C6> := {v40, v40, v40};
		r1, v37.f8, v25[safeIndex(813, v25.Length)], r1 := |("lg" + v28.f12)| + (if (v26[safeIndex(969, v26.Length)]) then |v41| else v37.f9), i5 <= |v27|, p0, v37.f9;
		v25[safeIndex(813, v25.Length)] := -p0;
		var v42: seq<int> := [p0, v37.f9, i5, p0, p0];
		r1 := safeModuloInt(v40.fm1(v28.f13, v25[safeIndex(813, v25.Length)], true, fm29(i5, globalState), globalState) + 0x3b4, |v42| * -0x3b8);
		var v43 := 'r';
		var v44: array<string> := new seq<char>[15] [(seq(abs(0x3cd), i6  => ('v'))) + (seq(abs(197), i7  => ('d'))), v28.f12, v27[safeIndex(v25[safeIndex(813, v25.Length)], |v27|) := v43], v28.f12, v27 + v28.f12, v27, v28.f12 + v28.f12, v27, v27, v27, v28.f12, v27, v27 + v28.f12, v27, v27];
		v44[safeIndex(298, v44.Length)] := v28.f12;
		v44[safeIndex(298, v44.Length)] := if ((fm51(globalState)).cf3) then "ugxsphir" + (seq(abs(-0x11f), i8  => (v43))) else v27 + v27;
	}
	var v45: multiset<bool> := multiset{v28.f13};
	v25[safeIndex(697, v25.Length)] := if (v37.f8 in v45) then v45[v37.f8] else p0;
	r1, v25[safeIndex(697, v25.Length)], v26 := p0, v37.f9 + -v37.fm5(true, v27, globalState), if (p1) then v26 else v26;
	var i9 := 0;
	while (v26[safeIndex(969, v26.Length)])
		decreases 100 - i9
	{
		if (i9 >= 100) {
			break;
		...
		var v47 := DC11(v0);
		v46[safeIndex(199, v46.Length)] := v47;
		v25[safeIndex(697, v25.Length)], v46[safeIndex(199, v46.Length)] := v25[safeIndex(697, v25.Length)], v47.(cf18 := [v37.f8]);
		v26[safeIndex(969, v26.Length)] := p1;
		var v48: seq<int> := [if (p3 in v45) then v45[p3] else v37.f9, 593, v37.f9, p0];
		r1 := (|v48| + v37.f9) * -v37.f9;
		var v49 := new C1(v28.f12 + v27, v28.f13);
	}
	var v50: map<int, int> := map[p0 := v25[safeIndex(697, v25.Length)]];
	var v51: seq<map<int, int>> := [v50];
	var v52: multiset<string> := multiset{v27};
	r0 := DC24(v51[safeIndex(|v52|, |v51|)]);
	r1 := v25[safeIndex(697, v25.Length)];
	var v53: T1 := new C3(p2, !!fm21(v25[safeIndex(697, v25.Length)], multiset([v50, v50, v50]), globalState));
	var v54: seq<T1> := [v53];
	r2 := v54;
	r3 := new C2(v26[safeIndex(969, v26.Length)], v37.f8, -v37.f9 <= -p0, p1);
}
method Main() {
		...
		decreases 100 - i0
	{
		...
		var v10: array<multiset<bool>> := new multiset<bool>[14] [v3 * v3, v3, if (v5.f8 in v8) then v8[v5.f8] else fm20(v2.f5, globalState), v3, v3 - v3, fm20(v2.f5, globalState), v3, v3, v3, v3, v9[safeIndex(-0x254, |v9|)], multiset{v2.f5}, v3 + v3, v3];
		v10[safeIndex(329, v10.Length)] := v3;
		v10[safeIndex(329, v10.Length)] := fm20(v2.f5, globalState);
	...
	if (if (v1) then v1 <==> v1 else v1) {
		...
		match (v14.(cf98 := if (v1) then v12 else v12)) {
			...
			case DC60(cf96, cf97) =>
				...
				var v22: array<array<int>> := new array<int>[27] [v19.cf57, v18, v18, v18, v18, v18, v20.cf36, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v21[safeIndex(fm31(cf96, v12, cf97, v0, globalState), |v21|)], v18, v18];
				...
				v23[safeIndex(704, v23.Length)] := v22;
				var v24: multiset<map<int, int>> := multiset{map[v12 := v12]};
				var v25: multiset<bool> := multiset{cf96, fm21(v12, v24, globalState)};
				v15, v23[safeIndex(704, v23.Length)], globalState.f0 := v15, v22, (multiset{cf97} * v25) > multiset{cf97};
				v18[safeIndex(443, v18.Length)] := v12;
				var v26: map<int, int> := map[v12 := safeModuloInt(-v12, v12)];
				v18[safeIndex(443, v18.Length)] := if (0x12a in v26) then v26[0x12a] else v12;
				var v27: T1 := new C5(v15, |{true}|, cf97, true);
				var v28: map<bool, T1> := map[cf97 := v27];
				var v29: seq<int> := [v12, v18[safeIndex(443, v18.Length)]];
				var v30 := DC59(("xa")[safeIndex(|v29|, |"xa"|) := v15[safeIndex(DC19(v12, v18[safeIndex(443, v18.Length)]).cf32, |v15|)]], |v25|, v12);
				var v31 := DC5(cf97, fm4(v1, globalState), |{fm49(|v28|, globalState), v30}|, if (0x1ae in v13) then v13[0x1ae] else |v26|);
				v15 := ((if (v1) then v15 else v15) + fm30(v31, |v15|, |map[v12 := -v12]|, globalState))[safeIndex(v12, |((if (v1) then v15 else v15) + fm30(v31, |v15|, |map[v12 := -v12]|, globalState))|) := v17];
				v15 := ((seq(abs(0x1c4), i1  => (v17)))[safeIndex(v12, |(seq(abs(0x1c4), i1  => (v17)))|) := v17])[safeIndex(v18[safeIndex(443, v18.Length)], |(seq(abs(0x1c4), i1  => (v17)))[safeIndex(v12, |(seq(abs(0x1c4), i1  => (v17)))|) := v17]|) := v15[safeIndex(v12, |v15|)]];
			case DC61(cf98) =>
				...
				var v34 := "kpqwyym";
				var v35 := 'a';
				v34 := ("bedn")[safeIndex(cf98 - cf98, |"bedn"|) := v35];
				var v36 := DC8(v32, "pvrbrm");
				var v37 := DC5(v1, v1, v12, cf98);
				var v38: T0 := new C5(v34, cf98, !false, v1);
				var v39: map<bool, T0> := map[v1 := v38];
				var v40: array<seq<char>> := new string[18] [v34, if (v1) then v34 else v34, (if (v1) then ['b', v35] else v34)[safeIndex(cf98, |(if (v1) then ['b', v35] else v34)|) := v35], [v35] + v34, v34 + v36.cf14, seq(abs(0x213), i2  => (v35)), v34, (seq(abs(0x245), i3  => (v35)))[safeIndex(|v0[safeIndex(v12, |v0|) := !v1]|, |(seq(abs(0x245), i3  => (v35)))|) := v35], v34, v34, v34, fm30(v37, 0x2ba, -v12, globalState), v34, if (fm4(true, globalState)) then v34 else v34, v34 + ['a', v35, v34[safeIndex(|v39[v38.f4 := v38]|, |v34|)]], v34, [v35], v34];
				v40[safeIndex(113, v40.Length)] := v34;
				var v41: T1 := new C3(v1, v38.f4);
				v40[safeIndex(113, v40.Length)], v34, v41, cf98, v34 := (v34 + (seq(abs(-0x281), i4  => (v35)))) + ((seq(abs(223), i5  => (v35))) + v34), v34, v41, cf98, v34 + v34;
			case DC58(cf92) =>
				...
				var v47: array<int> := new int[27](i6 => safeModuloInt(i6, v12));
				var v48: T1 := new C5(seq(abs(0x369), i7  => ('q')), v12, v1, !v1);
				var v49: map<T1, array<int>> := map[v48 := v47];
				var v50 := DC52(v12, v47);
				var v51: seq<array<int>> := [v47, v47, v50.cf85];
				var v52: array<array<int>> := new array<int>[14] [v47, v47, v47, v47, v47, v47, v47, if (v1) then v47 else v47, v47, v47, v47, if (v48 in v49) then v49[v48] else v47, v47, v51[safeIndex(v12, |v51|)]];
				v52 := v52;
				var v53 := "gvdye";
				var v54: C0 := new C0();
				var v55: seq<C0> := [v54];
				var v56: array<C0> := new C0[8] [v54, v54, v54, v54, v54, v54, v54, v55[safeIndex(|[v12, v12]|, |v55|)]];
				var v57: map<bool, array<C0>> := map[true := v56];
				var v58 := DC44(v57);
				v47[safeIndex(764, v47.Length)] := v12 + |[v48]|;
				var v59: seq<int> := [v12];
				v53, globalState.f0, v58, v12, v47[safeIndex(764, v47.Length)] := v53, v1, v58, -v12, v54.fm10(v59[safeIndex(-v12, |v59|)], v1, v13, globalState);
				var v61 := DC5(fm4(v1, globalState), true, |(map v60 : int | (0x19 <= v60) && (v60 < -0x14b) :: (safeDivisionInt(v60, v12)) := (0x365))|, v54.fm10(|map[v47[safeIndex(764, v47.Length)] := -0x2e6]|, v1, v13, globalState));
				var v62 := DC46(-v47[safeIndex(764, v47.Length)], v1, v1, v61, -v47[safeIndex(764, v47.Length)]);
				v47[safeIndex(764, v47.Length)] := v62.cf78;
		}
		...
		var v67 := DC8(v66, seq(abs(928), i8  => (v63)));
		match (v67.(cf13 := v66)) {
			case DC8(cf13, cf14) =>
				...
				var v78: seq<T0> := [v71];
				var v79: seq<map<int, bool>> := [map v73 : int | v73 in v75 :: (safeDivisionInt(v73, v12)) := (v71.f4), map[|v76| := v64.f8], v74, (map v77 : int | v77 in v74 :: (safeDivisionInt(v77, 600)) := (v64.f8))[v12 := v1], map[|v78| := v71.f3]];
				var v80, v81 := v64.m0(v72 <= v72, (v79[safeIndex(v64.f9, |v79|)])[v64.f9 := v64.f8], v64.f9, globalState);
			case DC7(cf12) =>
				var v82: T0 := new C2(v64.f8, false, true, v1);
				var v83 := v64.m1(v64.f9 * v64.f9, v82, globalState);
				v66[safeIndex(754, v66.Length)] := v82.f4;
				var v84: seq<int> := [v83];
				...
				v87[safeIndex(960, v87.Length)] := v86;
				var v88: map<bool, bool> := map[v64.f8 := v64.f8];
				var v89 := DC67(v86);
				v12, v66[safeIndex(754, v66.Length)], v87[safeIndex(960, v87.Length)] := v64.f9, if (v64.f8 in v88) then v88[v64.f8] else v64.f8, v89.cf109;
				var v90 := "y";
				var v91: map<int, bool> := map[|v90| := v66[safeIndex(754, v66.Length)]];
		...
		var v101 := DC5(v1, true, |v95[safeIndex(if (v1 in v100) then v100[v1] else v98, |v95|) := v63]|, |"wgwyb"|);
		var v102: seq<int> := [fm31(v64.f8, v96.f7, v1, v0, globalState)];
		var v103 := DC0(v12);
		v95 := fm30(v101, v102[safeIndex(v96.f7, |v102|)], if (v97) then v103.cf0 else |"vcroj"|, globalState);
	} else {
		var v104 := 0x1d;
		...
		var v108: array<bool> := new bool[21] [v1, v1, v1, v1, v1, v1, v1, v1, true, v1, v1, !v1, v0[safeIndex(v104, |v0|)], v1, v1, fm21(v104, v107, globalState), false, v1, v1, !v1, v1];
		...
		if (v116.f10 ==> v116.f10) {
			...
			var v120: map<int, map<map<int, C2>, seq<bool>>> := map[v117[safeIndex(v104, |v117|)] := v119];
			...
			v108 := v121[safeIndex(|v124| * v104, |v121|)];
			v1 := !v116.f11;
			...
			v134[safeIndex(685, v134.Length)] := v104;
			v108[safeIndex(88, v108.Length)] := v114 > v104;
			v134[safeIndex(685, v134.Length)], v108[safeIndex(88, v108.Length)] := v114, v1;
			var v138 := "g";
			var v139 := new C1(v138, false || v108[safeIndex(88, v108.Length)]);
			var v140: array<array<int>> := new array<int>[9] [v134, v134, v134, v134, v134, v134, v134, v134, v134];
			v140[safeIndex(705, v140.Length)] := if (v116.f10) then v134 else v134;
			v140[safeIndex(705, v140.Length)] := v134;
			v104 := v114;
		}
	...
	v144 := safeModuloInt(v144, safeDivisionInt(v144, v146[safeIndex(|v0|, |v146|)]));
	var v147: array<int> := new int[12];
	v147[safeIndex(624, v147.Length)] := v144;
	var v148 := "d";
	var v149 := DC5(v1, v1, v144, |v148|);
	var v150 := DC46(v144, DC56(v144, false).cf90, v1, v149.(cf11 := v144, cf10 := 0x2eb), -v144);
	v147[safeIndex(624, v147.Length)], v144, v144 := match v150 {
	...
	v151 := v151;
	var v152: C4 := new C4(|v145| <= v147[safeIndex(624, v147.Length)], v147[safeIndex(624, v147.Length)], v1, v1);
	v152 := v152;
	var v153: T0 := new C4(v1, v144, false, v1);
	var v154 := v152.m1(v147[safeIndex(624, v147.Length)] * -0x54, v153, globalState);
	for i10 := v154 to v154 - v144 {
		v147[safeIndex(624, v147.Length)] := v152.fm0(globalState);
		v147[safeIndex(624, v147.Length)] := v154;
		v154 := 0x2fb;
		...
		match (v158.(cf27 := v149.cf9)) {
			case DC17(cf26, cf27, cf28, cf29) =>
				...
				v159 := v159[v155 := safeDivisionInt(v147[safeIndex(624, v147.Length)], cf26)];
				v153.f3 := if (v155.f5) then {v153.f3} !! v145 else v153.f3;
				v152 := v152;
				var v160 := new C1(v148 + "e", v152.f8);
			case DC16(cf25) =>
				v147[safeIndex(624, v147.Length)] := |((v148 + "po") + v148)|;
				v147[safeIndex(624, v147.Length)] := safeModuloInt(v152.f9, v154);
	...
	v154 := match v173 {
		...
		case DC60(cf96, cf97) => -v152.f9 - v146[safeIndex(v144, |v146|)]
		case DC61(cf98) => DC63(v152.f9, v148, v153.f4, 's').cf100
		case DC58(cf92) => v144 * v144
	};
	var v174: array<string> := new string[23];
	v174[safeIndex(230, v174.Length)] := "qvlmx";
	v174[safeIndex(230, v174.Length)] := v148;
	v154 := v154;
	v151[safeIndex(497, v151.Length)] := v152.f8;
	v151[safeIndex(497, v151.Length)] := v148 <= v148;
	var v175: array<seq<int>> := new seq<int>[7] [v146, v146, v146, v146 + (seq(abs(0xcb), i11  => (v152.f9))), v146, fm19(globalState), v146];
	v175 := v175;
	var v176: map<bool, int> := map[v153.f4 := v152.f9];
	var v177: multiset<map<bool, int>> := multiset{v176[true := 0xa0]};
	var v178 := new C2(v154 != v147[safeIndex(624, v147.Length)], v153.f3, v177 > v177, v153.f3);
	var v179 := 'a';
	...
	print v150.cf77.cf8, "\n";
	print v150.cf77.cf9, "\n";
	print v150.cf77.cf10, "\n";
	print v150.cf77.cf11, "\n";
	print v150.cf78, "\n";
	print v151[5], "\n";
	print v152.f8, "\n";
	print v152.f9, "\n";
	...
	print v153.f4, "\n";
	print v154, "\n";
	print v166 == map[true := true], "\n";
	print v169.cf55 == map[[-1] := 'l'], "\n";
	print v170 == {DC37(map[[-1] := 'l'])}, "\n";
	print v171 == [{DC37(map[[-1] := 'l'])}], "\n";
	print v173.cf92 == {{DC37(map[[-1] := 'l'])}}, "\n";
	print v174[0], "\n";
	print v175[0] == [-1], "\n";
	print v175[1] == [-1], "\n";
	print v175[2] == [-1], "\n";
	print v175[3] == [-1, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965, 965], "\n";
	print v175[4] == [-1], "\n";
	print v175[5] == [705], "\n";
	print v175[6] == [-1], "\n";
	print v176 == map[true := 965], "\n";
	print v177 == multiset{map[true := 160]}, "\n";
	print v178.f10, "\n";
	print v178.f11, "\n";
	print v179, "\n";
	print v180 == ['k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k'], "\n";
}