...
function fm0(p0: bool, p1: int, p2: int, p3: map<int, int>, globalState: GlobalState): int {
	match DC20() {
		...
		case DC21(cf37) => |"yc"| / |map[true := cf37]|
		case DC19(cf36) => |{false, false}| % -|"bhwgx"|
	}
}
...
function fm2(p0: int, p1: D1, p2: char, globalState: GlobalState): map<int, bool> {
	match DC62(0x3b0, true, |(seq(0xcf, i0  => (0x221)))|, true) {
		...
		case DC61(cf122) => map v0 : int | (665 <= v0) && (v0 < 0x312) :: (v0 + |(map v1 : int | (0x12e <= v1) && (v1 < -902) :: (v1 / |"ayknvx"|) := (!!!!!false))|) := (!false)
	}
}
function fm6(globalState: GlobalState): seq<char> {
	(['f', 'q', 'w', 'w'] + ['q']) + (seq(276, i0  => ('j')))
}
...
function fm11(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): D1 {
	DC3(|{DC83(48)}|, |map[[true, true] := 'r']| / 0x1c, [|"esk"|] + [|[false]|])
}
...
function fm15(p0: bool, p1: bool, p2: bool, globalState: GlobalState): map<bool, bool> {
	map[true || false := |(seq(0x1f6, i0  => ('f')))| in {0x1a7}]
}
...
function fm17(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState): set<int> {
	{-|([multiset{|(seq(0xf5, i0  => ('o')))|, 746}, multiset{0x71}] + (seq(326, i1  => (multiset{0x143}))))|}
}
...
function fm30(p0: int, globalState: GlobalState): D0 {
	match DC39('x', false, 538, true, |[map[true := false], map[false := false]]|) {
		...
		case DC36(cf64) => DC0(|(seq(0x39b, i0  => ('g')))|)
	}
}
...
function fm33(p0: bool, p1: char, p2: bool, globalState: GlobalState): multiset<multiset<bool>> {
	multiset{multiset([false, false]), multiset{false, false}, multiset([DC85(false).cf170]), multiset{!false}, multiset{false}} * (multiset(seq(0x82, i0  => (multiset{!true, true}))) - multiset{multiset{true}, multiset([false, true, false])})
}
function fm34(p0: string, p1: string, p2: int, globalState: GlobalState): char {
	'b'
}
function fm35(p0: bool, globalState: GlobalState): D3 {
	DC7(multiset{'f'}, [419] + [|map[0x3d7 := |{DC42(map[-0x38c := seq(976, i0  => ('g'))])}|]|], false)
}
function fm36(p0: string, globalState: GlobalState): map<multiset<D4>, bool> {
	match DC18(|(seq(606, i0  => ('e')))|) {
		case DC17(cf33, cf34) => if (false) then map[multiset{DC11(set v1 : char | v1 in map[cf34[|(seq(0x2b9, i1  => ('p')))|] := |DC32(map v0 : int | (8 <= v0) && (v0 < -0x396) :: (v0 - |{|[0x18e]|}|) := (-0x1ea)).cf55|] :: (v1), [[215]], -0x373)} := true] else map[multiset(seq(902, i2  => (DC11({'y', 'n'}, [[|map[true := 'l']|], [|multiset{-83}|], [|{|"dqqkw"|}|, |map[false := 0x3a1]|, |multiset{false, true}|, 0x164, |cf34|], seq(0x357, i3  => (|map[true := |cf34|]|))], 0x112)))) := true]
		case DC18(cf35) => if (true) then map[multiset{DC11(set v2 : char | v2 in multiset(seq(0x74, i4  => ('c'))) :: (v2), [[cf35, cf35]], 0x129), DC11({'w'}, [[cf35, |multiset{false, false}|], [cf35]], |{|[|"kfi"|, 229]|, cf35}|), DC11({'n'}, [[|map[false := false]|], [|[cf35]|]], cf35), DC11({'s', 'e'}, seq(0x84, i5  => ([0x54, cf35])), 0xc8), DC11({'m'}, [[cf35]], cf35)} := false] else map v3 : multiset<D4> | v3 in {multiset([DC11({'w'}, [[cf35, cf35], [cf35, cf35, cf35, cf35, |[true, !!true]|]], |(seq(-0x16e, i6  => ('e')))|), DC11({'o', 'l'}, seq(-220, i7  => ([cf35, cf35])), cf35)]), multiset{DC11({'s', 'e'}, [[0x118, |map[false := cf35]|]], cf35), DC11({'g'}, seq(0x77, i8  => ([cf35])), cf35)}, multiset{DC11({'x'}, [seq(-0x382, i9  => (cf35))], 0x18c)}, multiset{DC11({'e', 'e'}, [seq(392, i10  => (cf35)), [cf35], [cf35, cf35]], cf35)}} :: (v3) := (true)
		case DC16(cf32) => if (false) then map[multiset{DC11({'y'}, [seq(-0x63, i11  => (|map[false := DC54(780, true, |map[|map[|[false]| := |multiset{true}|]| := false]|)]|))], 632)} := false] else map v4 : multiset<D4> | v4 in [multiset{DC11({'m', 'd'}, [[|['c']|, |[false, false]|], [0x3c0]], 0x399)}] :: (v4) := (!true)
	}
}
...
function fm42(p0: D5, p1: int, p2: map<char, int>, p3: int, globalState: GlobalState): seq<int> {
	(seq(0x10c, i0  => (-|map[|multiset{DC38(-183, 0x231, map[-0x2c7 := !!false])}| := 0x3b4]|))) + ((seq(815, i1  => (|(seq(0x1cb, i2  => ("xljny")))|))) + [DC41(---|"mcwpap"|, seq(0x10d, i3  => ('c')), |multiset{true, false}|, 894, 'y').cf78, |map['h' := DC35(true, !true, false, |map[101 := 'g']|, 0x3ba)]|, 0x320, |[false]|, -380])
}
function fm43(p0: bool, p1: int, globalState: GlobalState): D1 {
	if (!('x' !in "bitp")) then DC3(-|(set v0 : int | (0x171 <= v0) && (v0 < -333) :: (v0 / 796))|, --|map[-701 := 0x37b]|, [|{|"ayqblk"|}|]) else DC3(|"aoggquvsb"|, |(map v1 : char | v1 in map['w' := true] :: (v1) := (true))|, seq(0x203, i0  => (0x75)))
}
...
function fm46(p0: bool, p1: bool, p2: int, globalState: GlobalState): seq<set<D5>> {
	if (296 >= 573) then [{DC14(true), DC14(false), DC14(false)}] else (seq(528, i0  => (DC96(set v0 : D5 | v0 in [DC14(false), DC14(false)] :: (v0)).cf192))) + [{DC14(false)}, {DC14(true), DC14(false), DC14(false)}, set v1 : D5 | v1 in multiset([DC14(!true), DC14(false)]) :: (v1), {DC14(true)}, set v2 : D5 | v2 in map[DC14(true) := !false] :: (v2)]
}
...
function fm48(p0: string, p1: string, p2: string, globalState: GlobalState): D0 {
	DC1(-339 % 851, |(multiset{|(seq(0x69, i0  => ('x')))|, |map[|"nvjwnyvr"| := true]|} * multiset([0x141]))|, 'p', {true} >= {false, false})
}
...
function fm53(p0: int, p1: seq<seq<int>>, globalState: GlobalState): D7 {
	if (true !in multiset([false, false])) then DC19(seq(-132, i0  => (seq(823, i1  => ('l'))))) else if (true) then DC19(seq(0x1d0, i2  => (seq(0x21b, i3  => ('h'))))) else DC19(seq(-0x299, i4  => ("q")))
}
...
function fm56(p0: int, p1: int, globalState: GlobalState): D12 {
	DC32(if (true) then map v0 : int | (655 <= v0) && (v0 < 0x26c) :: (v0 / 0x8a) := (0x18) else map[|[[true]]| := |"mqay"|])
}
...
function fm59(p0: int, p1: int, globalState: GlobalState): seq<string> {
	if (false) then ["uagowgshq"] else ["vybrbnm", "uncbrtaa", "nriqx", seq(0x7, i0  => ('c')), "usrmab"] + [seq(0x30b, i1  => ('x'))]
}
function fm60(globalState: GlobalState): set<bool> {
	({false, true} + {true, true}) + ({!!true} + {!false})
}
function fm61(globalState: GlobalState): seq<D1> {
	seq(-0x33a, i0  => (if (true) then DC3(|"pivdwjx"|, |multiset{false, !true, false}|, seq(0x259, i1  => (-395))) else DC3(|map[|map[220 := true]| := DC80(0x2b3, true, false, !false).cf164]|, 0xaa, [|(seq(0x1f5, i2  => (|(map v0 : int | (0x3e6 <= v0) && (v0 < 0x31f) :: (v0 / |{true, true}|) := (true))|)))|])))
}
...
function fm75(p0: bool, p1: seq<set<int>>, p2: map<bool, char>, globalState: GlobalState): seq<D0> {
	seq(770, i0  => (DC1(|"sbudxpf"|, 0x196, 'u', true)))
}
...
function fm77(p0: int, p1: int, globalState: GlobalState): D13 {
	if ((set v0 : string | v0 in multiset(seq(-830, i0  => ("oqhsrv"))) :: (v0)) !! {"adk"}) then DC39('y', false, |(seq(0x297, i1  => ('b')))|, !false, |map[true := 436]|) else DC39('s', true, |map[-|map[DC29(true) := -|DC86([0xc7], true, 0x5).cf171|]| := 0x4a]|, true, |(seq(0x3e0, i2  => (-|"rjynswosq"|)))|)
}
function fm78(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): seq<map<int, bool>> {
	(seq(623, i0  => (map[|(seq(35, i1  => (0x3bf)))| := true]))) + [map[127 := false], map[|map[false := false]| := true]]
}
function fm79(p0: bool, p1: int, p2: bool, p3: char, globalState: GlobalState): D15 {
	DC43(|(multiset{!true} * multiset{false})|, |(seq(0x198, i0  => ('b')))| - ---|map['t' := true]|, 930, -0x39a, if (true) then |{68}| else -0x242)
}
function fm80(p0: bool, p1: int, p2: bool, globalState: GlobalState): map<char, int> {
	(map['u' := |(seq(-251, i0  => ('a')))|] + (map v0 : char | v0 in ['a', 'k'] :: (v0) := (0x2b0))) + (map v1 : char | v1 in multiset{'b', 't'} :: (v1) := (|multiset{false}|))
}
function fm81(p0: char, p1: int, p2: int, globalState: GlobalState): D6 {
	DC16(multiset(seq(0x1b4, i0  => (multiset{!false, false}))))
}
function fm82(p0: int, globalState: GlobalState): D25 {
	match DC31(true, true, false) {
		case DC31(cf52, cf53, cf54) => DC68(seq(0x3c2, i0  => ('s')), cf52, !cf52, cf52)
...
function fm86(p0: int, p1: int, p2: char, globalState: GlobalState): map<seq<int>, string> {
	(map v0 : seq<int> | v0 in [seq(-314, i0  => (-|"d"|))] :: (v0) := (seq(0x3ae, i1  => ('t')))) + (map[[-0x3bd] := "yi"] + map[seq(-0x14e, i2  => (|map[false := |map[0x12d := true]|]|)) := DC33(|multiset{|{false}|, 750}|, "qgmdg", 'w').cf57])
}
...
function fm88(p0: bool, p1: int, p2: bool, globalState: GlobalState): D11 {
	DC30(map[true := |map[seq(0x31e, i0  => ('i')) := false]|] + map[false := 0x204])
}
function fm89(p0: set<int>, p1: bool, p2: seq<bool>, p3: int, globalState: GlobalState): D24 {
	match DC31(true, !!false, true) {
		...
		case DC30(cf51) => DC66(DC66(DC64(seq(0x19a, i0  => (map[0x132 := true])))))
	}
}
...
function fm93(p0: char, p1: int, globalState: GlobalState): map<int, D31> {
	match DC16(multiset([multiset{!!false, false}])) {
		...
		case DC16(cf32) => map[|multiset{--|"h"|, 0x2d3, 0xc2, |(seq(0, i0  => ('r')))|, |[|"brnl"|, |"ni"|, 0x160]|}| := DC81(multiset{"wc", "e"})]
	}
}
method m0(p0: int, globalState: GlobalState) returns (r0: bool, r1: array<multiset<int>>) {
	...
	if (v1[--0x343]) {
		...
		r0 := (v3 - v3) > (v3 + v3);
		if (v0) {
			var v4: array<int> := new int[14](i0 => i0 / 0x2b6);
			v4[517] := p0;
			v4[517] := p0;
			var v5: array<bool> := new bool[14];
			v5[294] := fm1(!v2.f28, p0, globalState);
			v5[294], globalState.f16, v4 := v2.f28, p0, v4;
			var v6 := 'g';
			var v7: map<bool, char> := map[v2.f28 := v6];
			var v8: map<array<bool>, T0> := map[v5 := v2];
			var v9: map<bool, int> := map[v2.f28 := v4[517]];
			v7 := fm92(v8 == v8[v5 := v2], 0x1f1, if (v0) then v9 else v9, globalState);
			var v10: map<int, int> := map[|v1| := p0];
			var v11: array<char> := new char[28] [v6, v6, v6, v6, v6, v6, v6, 'f', v6, v6, if (v2.f28) then v6 else v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, 'w', v6, DC58(p0, fm0(v5[294], v4[517], v4[517], v10, globalState), -0x3a1, v6, v4[517]).cf118, v6, v6, v6, v6];
	...
	var v28: seq<int> := [p0, |(map v27 : int | (0x391 <= v27) && (v27 < 116) :: (v27 / p0) := (|map[p0 := |{0xb1}|]|))|];
	if (v28 < [p0]) {
		var v29 := "sf";
		...
		match (v32) {
			case DC41(cf78, cf79, cf80, cf81, cf82) =>
				...
				v37[775] := v0;
				var v38: set<bool> := {v0};
				v33[720], v36, v37[775], globalState.f16, globalState.f11 := v1, v36, v0, |v38| - (cf78 / |[v0, false]|), if (v0) then v0 else v0;
				globalState.f16 := cf80;
				var v39: map<bool, int> := map[!v37[775] := -0x3b9];
				v39 := v39[v0 := -(if (v37[775] in v39) then v39[v37[775]] else cf80)];
				v37[775] := (cf78 + 878) >= cf81;
			case DC40(cf77) =>
		...
		if (v0) {
			...
			v72[59] := v71;
			v55, globalState.f21, v72[59] := if (v0) then v55 else v55, p0, if (v69.f39) then v71 else v71;
			r0 := v69.f39;
			var v73: map<int, multiset<bool>> := map[p0 := v65];
			var v74: seq<multiset<bool>> := [v65];
			v65 := v65 - (if (p0 in v73) then v73[p0] else v74[-v59.f29]);
		} else {
			...
			v75, v78, globalState.f21, v0, v79[331] := v75, v78, DC3(v76.f44, v82.cf69, v28).cf7, v0, v83;
			var v84 := "jyvegcifr";
			var v85: seq<string> := [v84];
			globalState.f1, globalState.f16, globalState.f1, v75, globalState.f16 := fm1(if (v0) then v0 else !v0, p0 % v76.f44, globalState), p0, false, fm34(v84 + "okso", v84[|[p0, |v1|]| := v75], if (v0) then |"fir"| else v76.f44, globalState), |v85[v76.fm26(p0, v0, p0, p0, globalState)]|;
			globalState.f8 := v84;
		...
		var v94: multiset<int> := multiset{953, 0x90, v88[662], |multiset(v1)|};
		var v95 := DC10({v88[662]});
		v93 := v93[v94 >= v94[p0 := |v95.cf20|] := v88[662]];
	}
	...
	if (v0) {
		...
		v96[587] := if (p0 in v99) then v99[p0] else v101 != v101;
		var v103: map<int, int> := map[p0 := p0];
		var v104: array<int> := new int[18] [fm0(true, p0, p0, map v102 : int | (-0x24a <= v102) && (v102 < 158) :: (v102 / p0) := (-0x361), globalState), p0 - -p0, p0, |v103|, p0, p0 - p0, p0, |v98|, |[|v101|]| + p0, p0, -p0, fm0(v96[587], p0, p0, v103, globalState), -0x24f, -0x274, |v28|, p0 + p0, p0, -|(seq(0x31a, i6  => ('r')))|];
		v104[723] := p0;
		v104[723] := 369;
		var v105: C5 := new C5();
		v105 := v105;
		...
		if (v0) {
			...
			var v108 := new C9(set v107 : int | (0x265 <= v107) && (v107 < 0x175) :: (v107 + p0), v106[111], v106[111]);
		} else {
			...
			var v118 := "txbpckne";
			var v119 := DC5(v112.f42, v0, v116.f43, v112.f42, map[v118[|v118|] := p0]);
		...
		if (p0 < |v126|) {
			...
			v127[236] := if (v0 in v137) then v137[v0] else p0;
			var v138: map<int, int> := map[p0 := p0];
			var v139 := DC37(|v134|, p0, p0, p0);
			r0, v127[236], globalState.f21, globalState.f21, globalState.f11 := v128.f28, -fm0(p0 in [p0, p0], -p0, -p0, v138, globalState), 0x1d, v139.cf66, !v128.f28;
		} else {
			globalState.f21 := p0 / (p0 + -0x2a7);
			var v140: array<bool> := new bool[8];
			var v141: T0 := new C12(v1, v0);
			var v142: map<T0, bool> := map[v141 := v141.f28];
			v140[720] := if (v141 in v142) then v142[v141] else v141.f28;
			var v143 := "bon";
			var v144: seq<string> := ["urd", v143];
			var v145: seq<T0> := [v141];
			v140[720] := if (v0) then v143[97 := v125] == v144[|v145|] else v141.f28;
			var v146 := new C5();
			var v147: C2 := new C2(-|"lwtxbkg"|);
			var v148: C1 := new C1(|map[v140[720] := v147]|, v147.fm26(|v143|, v140[720], p0, p0, globalState));
			var v149 := DC93(v148);
			var v150: array<C1> := new C1[15] [v148, v148, v148, v148, v148, v148, v148, v148, v148, v149.cf188, v148, v148, v148, v148, v148];
			v150[769] := v148;
			v150[769] := v148;
			var v151: array<seq<bool>> := new seq<bool>[5] [v1 + v1, v1[v148.f45 := v141.f28] + v1, v1, [v140[720]], v1 + v1];
			v151 := v151;
		}
		
		var v152: set<int> := {0x2c8};
		v152 := (v152 * (set v153 : int | (0x373 <= v153) && (v153 < 0x1b3) :: (v153 * DC53(|(map v154 : int | (0x2b2 <= v154) && (v154 < 0x224) :: (v154 % p0) := (DC64([map v155 : int | v155 in map[p0 := v0] :: (v155 / p0) := (v0)])))|, p0).cf101))) + v152;
		globalState.f21 := |v1|;
	}
	...
	var v172: array<bool> := new bool[26] [v0, v0, v0, v0, v0, v159 !! v159, !v0, v0, v158.f45 <= -v158.f45, v160 !in v161, |v163| <= |v165|, !true, v0, !v0, v0, !DC85(v0).cf170, v0, v0, v0, v158.f46 <= |[v167]|, v1[v170.cf41] <==> v167.f28, v1[v158.f46], !v167.f28, !(v171 > v171), |fm29(globalState)| == 0x8, false];
	v172[696] := true;
	v172[696] := v0;
	...
	match (v174) {
		case DC65(cf130, cf131, cf132) =>
			...
			var v176: multiset<map<bool, bool>> := multiset{v175[cf130]};
		...
		case DC64(cf129) =>
			...
			match (v178) {
				case DC41(cf78, cf79, cf80, cf81, cf82) =>
					...
					var v181 := DC5(v167.f28, v172[696], |multiset(v1)|, v167.f28, v180);
					var v182: C11 := new C11(v181.(cf14 := v180, cf12 := v158.f46, cf10 := v0), cf78, v167.f28);
					var v183: map<C11, int> := map[v182 := v158.f46];
					var v184: array<seq<int>> := new seq<int>[19] [v28, v28, [v158.f46, cf81, |v179.cf55|, if (v182 in v183) then v183[v182] else p0] + v28, ([|v1|, cf80] + v28)[cf81 := v158.f46], v28, v28, v28 + v28, v28[cf81 := v158.f46], fm16(globalState), seq(60, i11  => (0x1b)), [|v166|, v158.f46, v158.f45], v28, v28, if (v1[|v166|]) then [|v177|] else v28, v28, v28 + (seq(0xad, i12  => (v182.f34)))[cf78 := |v1|], v28, [cf81, v158.f45], v28];
					v184[560] := if (v167.f28) then seq(0x2dc, i13  => (0x3c2)) else v28;
					var v185: C6 := new C6(v167.f28);
					v184[560], v185 := v28 + v28[v182.f34 := v158.f45], v185;
					globalState.f22 := !!(if (v167.f28) then |v157| <= v158.f46 else v172[696]);
					v169 := new int[2](i14 => i14 * |v168|);
					v169[949] := v158.f45;
					v169[949] := v158.f46;
				case DC40(cf77) =>
					v0, v167, globalState.f11, globalState.f22, globalState.f1 := v167.f28, if (true) then v167 else v167, true <==> v167.f28, v172[696], v167.f28;
					globalState.f16 := 0x1af;
					globalState.f21 := |{v167.f28, fm66(globalState) > multiset{v158.f45}}|;
					var v186 := DC5(v172[696], v167.f28, v158.f46, v0, map[v160 := v158.fm27(v161[v158.f46 := v160], {v168}, globalState)]);
					var v187 := new C11(v186, |v1|, v167.f28);
			}
			
			v1 := v1;
			globalState.f16 := |(map v188 : string | v188 in map[v161 := v172[696]] :: (v188) := (v166 > v166))|;
		case DC66(cf133) =>
			v169[920] := v158.f46;
			...
			v169[920], v189[309], v191 := --v190.f36 - v190.f36, v190, (v191 + map[v162 := v190.f35]) + (v191 + map[v162 := v169]);
			globalState.f16 := v158.f46 * v169[920];
			globalState.f21 := -|v161| / -|"dhkjka"|;
			var v192: map<int, D1> := map[v158.f46 := fm11(v172[696], v167.f28, p0, v158.f45, globalState)];
			var v193 := DC3(v169[920], 745, seq(438, i15  => (v158.f45)));
	...
	var v198: multiset<multiset<bool>> := multiset{multiset{v172[696]}};
	var v199 := DC83(v158.f46);
	r0 := (|v198| / 711) == v199.cf168;
...
class C0 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		var v7 := "idrtbvy";
		var v8 := DC2(v7);
		r1, globalState.f11, v0[66], v2, globalState.f8 := v3, v6 > v6, v1 - (v1 - v1), v2, v7 + v8.cf5;
		r0 := f28;
		...
		var v13: array<int> := new int[12](i0 => i0 + |multiset{map v12 : int | (-0x333 <= v12) && (v12 < 237) :: (v12 / v3) := (f28)}|);
		v13[895] := v3;
		v13[895] := v3;
		r0 := v10 > v10;
		var v14: map<int, int> := map[|[f28]| := v3];
		var v15: map<string, int> := map[fm31(if (-v13[895] in v14) then v14[-v13[895]] else v3, f28, f28, globalState) := v3];
		r1 := -(|v15| * v3);
		r2 := v3;
	}
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		var v3: seq<int> := [p3];
		var v5: array<int> := new int[17] [--p3, p3, -274, |v0|, p3, -p3, -p3 - p3, v1.cf25, |([v2, v2] + [v2])|, 257, p3, v3[p3], p3, p3, p3 * p3, fm0(p0, p3, fm0(!false, p3, p3, p1, globalState), map v4 : int | v4 in v3 :: (v4 - v3[|[[p0, p0], [p0], [!f28, f28, f28, f28], [false], [p0, f28]]|]) := (p3), globalState), p3];
		...
		var v8: seq<bool> := [f28, fm1(f28, |v7[p0 := |v7|]|, globalState)];
		v8 := v8;
		var v9 := 'y';
		var v10: array<bool> := new bool[8];
		v9, v10, globalState.f21, globalState.f21, globalState.f21 := v9, v10, -(|p1| - p3), p3, p3 % 528;
		r2 := p0;
		globalState.f21 := p3;
		r0 := p3;
		r1 := v7;
...
class C1 {
	...
	method m24(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: char, r2: int, r3: bool) {
		...
		v3[2] := new array<bool>[28] [v5, v5, v5, v5, v5, v5, if (false) then v5 else v5, if (p1) then v5 else v5, v5, v5, v5, v5, v5, v5, v5, v5, v5, v5, if (v0 in v6) then v6[v0] else v5, v5, v5, v5, v7[f45], v5, v5, v5, v5, v5];
		var v8 := "modtlr";
		if (f46 != |(v8 + "g")|) {
			...
			var v12, v13 := m0(fm0(p1, fm27(v8, v10, globalState), -47, v11, globalState) % f46, globalState);
			var v14 := DC13(f46, p1);
			globalState.f1 := v12 ==> (if (p0) then p0 else v14.cf26);
			globalState.f8 := v8;
			globalState.f1 := v8[f45 := v2] < v8;
		} else {
			...
			match (v15) {
				...
				case DC10(cf20) =>
					...
					v17 := v17;
					var v18: array<int> := new int[14](i0 => i0 % f46);
					var v19: seq<array<int>> := [v18];
					var v20: map<seq<array<int>>, bool> := map[[v19[-830], v18, v18, v19[f46], v18] := !v0];
					v20 := v20[[v19[f45]] + [v18] := v0];
			}
			
			var v21: map<bool, bool> := map[!false := p0 || p0];
			var v22: seq<int> := [|v8|];
			v21 := v21[v0 := (multiset(v22))[|v8| := f45] < (multiset{f46})[f46 := f45]];
			var v23, v24 := m0(f46, globalState);
			var v25: multiset<string> := multiset{seq(-0x6c, i1  => ('j'))};
			...
			var v31: multiset<char> := multiset{v2, v2, v2, v8[f46]};
			...
			decreases 100 - i2
		{
			...
			r2 := (if (v8 in v36) then v36[v8] else f46) / |(v8 + v8)|;
			if (f45 == (0x6d - f46)) {
				...
				v34[713] := if (true) then |(if (v39.fm3(fm27(v8, v42, globalState), f46, v44, v5[22], globalState)) then [v45] else v46)| else f45 * -f45;
		...
		r0 := -0x398 + f45;
		r1 := fm34(v8[f45 := v2], seq(-0x34b, i4  => (v2)), -(-0x329 / f46), globalState);
		r2 := f46;
		r3 := !p1;
	}
}
...
class C2 {
	...
	method m23(p0: int, p1: int, globalState: GlobalState) returns (r0: map<multiset<D4>, bool>, r1: int) {
		...
		if (v2) {
			...
			v12[88] := if (v2 in v14) then v14[v2] else v13;
			globalState.f11 := v2;
			globalState.f21 := p0;
		} else {
			globalState.f22 := v2;
			...
			v18[600] := !v20[v6.f46];
			v17[801], globalState.f22, v18[600] := v0, (v0 != v0) <== v2, |map[v16.f46 := v2]| >= (if (v2) then v6.f46 else v16.f45);
			var v21 := 'x';
			var v22: multiset<char> := multiset{v21};
			var v23: multiset<array<int>> := multiset{v7, v7, v7, v7, v7};
			var v24: multiset<int> := multiset{if (v21 in v22) then v22[v21] else p1, |v23|, |v17[801]| / v16.f46};
			v24 := v24;
			if (v2) {
				globalState.f22 := |v17[801]| >= |v24|;
				var v25: seq<int> := [v16.f45];
				var v26: map<bool, bool> := map[v18[600] := v18[600]];
				var v27: set<map<bool, bool>> := {map[v2 := v18[600]]};
				globalState.f1, globalState.f8, v20, globalState.f1, globalState.f16 := v18[600], v17[801], v20 + v20, !(v25[471] != (v6.f45 * |v26|)), v6.f46 + v16.fm27(seq(307, i1  => (v21)), v27, globalState);
				var v28: map<int, bool> := map[v6.f46 := v2];
				v28 := v28[0x1e7 := true];
				var v29: multiset<array<bool>> := multiset{v18};
				var v30: map<bool, int> := map[v18[600] := |v29|];
				r1 := (if (v2) then |v30| else v6.f45) - fm0(v2, 0x166, v6.f45, v1, globalState);
				globalState.f22 := v2;
			} else {
				var v31: seq<D3> := [fm35(v18[600], globalState)];
				var v32: seq<int> := [p0];
				var v33: map<seq<D3>, seq<int>> := map[v31 := v32 + v32];
				v33 := v33;
				globalState.f21 := -0x151 * v6.f45;
				v18[600] := v2 ==> (v15 != v15[v18[600] := v6.f45]);
				var v34: map<bool, set<bool>> := map[v2 := if (v2) then v5 else v5];
				v34 := v34[v18[600] := v5];
				v17[801] := v17[801] + (v0 + v17[801]);
			}
			...
			decreases 100 - i2
		{
			...
			r1 := |(if (if ('g' in v36) then v36['g'] else v2) then v38[v37 := p1] else (v41[|v42|])[multiset(v44[if (true in v45) then v45[true] else 492 := v2]) := v6.f45])|;
			globalState.f8 := v0;
			r1 := p1 * |{p1}|;
		...
		v7[752] := (if (false in v47) then v47[false] else p1) * p1;
		var v48 := 'b';
		...
		r0 := if (v2) then map[v52 := v2] else fm36(("taedbywsj")[p1 := v48], globalState);
		r1 := v6.f46;
	}
}
...
class C3 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (v6 < v6) {
			...
			match (v9) {
				case DC13(cf25, cf26) =>
					...
					v12, globalState.f1, globalState.f22, v14[936] := v12 + (v12 * v12), fm24(globalState), cf26, v15[cf25];
				...
				case DC14(cf27) =>
					...
					var v22: map<map<int, D6>, string> := map[v20 := v21[f43]];
				...
				case DC15(cf28, cf29, cf30, cf31) =>
					...
					var v31: map<int, int> := map[f43 := |v30[f43]|];
				...
				case DC12(cf24) =>
					...
					v7, globalState.f14, globalState.f21, globalState.f21, v6 := v7, if (f28) then v36 else v36, (f43 + |v35|) + 849, f43, (v6 - multiset{f28, f28})[f28 := -0x2be - f43];
			...
			var v38 := "acjkefc";
			var v39 := new C1(|v38[f43 := v0]|, f43);
			var v40: array<array<int>> := new array<int>[13];
			var v41: seq<array<array<int>>> := [v40];
			var v42: seq<array<array<int>>> := [v40, v41[v39.f45], v40, v40];
			v40 := v42[v39.f45 - f43];
		} else {
			var v43 := "rtx";
			var v44: map<int, int> := map[|v43| := -0x380];
			r1 := -((fm0(f28, f43, f43, v44, globalState) % f43) % f43);
			var v45: set<bool> := {f28};
			var v46: array<string> := new string[7] [v43, v43 + v43, v43, v43, (v43 + v43)[-f43 := v0], "iu" + v43, v43 + (fm37(f28, f43, v45, globalState))[f43 := v0]];
			v46 := v46;
			...
			if (if (|v43| in v47) then v47[|v43|] else f28) {
				...
				var v51 := DC2(v43);
				var v52: array<D1> := new D1[23] [v51, v51, v51, v51, v51, DC2(v43), v51, v51, v51, v51, v51, fm38(|(seq(0x13e, i1  => (v0)))|, globalState), v51, v51, DC2("dc"), v51, v51, v51, v51, v51, DC2("tqfmm"), v51, v51];
				v43, globalState.f21, globalState.f21 := "pvnayly", -|[v52, v52, v52]| / -|fm39(v3, f43, f28, globalState)|, -((if (f28) then 0x2f5 else 0x23d) + (f43 / -0x1ec));
			}
		...
		if (if (false) then !(f43 <= f43) else f28) {
			if (f28) {
				...
				var v69 := "fsck";
				v67 := v67[|(map v68 : int | (0x395 <= v68) && (v68 < 0x262) :: (v68 % v66.f44) := (f28))| == -f43 := v69 <= v69];
				var v70: array<char> := new char[19];
				v70[501] := v0;
				globalState.f16, v70[501] := v66.f44, v0;
			} else {
				var v71 := "a";
				...
				v73[431] := v74;
				v73[431] := if (if (true) then v72[223] else v72[223]) then v74 else v74;
				v72 := v72;
				var v75 := DC2(v71);
				...
				v76[889], globalState.f21, v78, globalState.f1, globalState.f16 := v71, f43, DC1(f43, 0x1e4, 'a', f28), v79 != v79, |[f28]| / |(v63 - v63)|;
				globalState.f11 := f28;
			}
			...
			match (v83) {
				case DC7(cf16, cf17, cf18) =>
					...
					var v89: map<int, int> := map[f43 := v64[668]];
					var v90: map<array<int>, int> := map[v88 := fm0(!true, v64[668], v64[668], v89, globalState)];
					var v91: map<bool, array<int>> := map[true := v88];
					var v92: multiset<int> := multiset{|v91|, v87.f44};
					var v93 := DC23(f28, f28, if (f43 in v92) then v92[f43] else v64[668], v88);
					v90 := v90[v93.cf42 := v64[668] * v87.f44];
				case DC8() =>
					...
					var v98: seq<seq<int>> := [seq(0x375, i4  => (f43)), v4, v4, v4, v4];
					...
					globalState.f21 := |v102[v100.cf23]|;
				...
				case DC9(cf19) =>
					v64[834] := f43 * f43;
					globalState.f1, globalState.f11, v64[834], globalState.f22 := f28, true, 0x130, f28;
					var v106 := new C2(f43);
			...
			if (f28 <==> !true) {
				...
				v64[406] := |v107|;
				v64[406] := |(seq(0x67, i5  => (|[v2[|"rbsqrb"|]]|)))|;
				globalState.f16 := -v4[-v64[406]];
				var v108: map<multiset<bool>, int> := map[v6 := v64[406]];
				r1 := |(v108 + v108)|;
				globalState.f21 := f43;
			} else {
				r2 := f43;
				...
				v109[397], globalState.f1, v110 := v0, v110.f28, v110;
			...
			match (DC22(v2 + v2)) {
				case DC23(cf39, cf40, cf41, cf42) =>
					...
					globalState.f1 := (v123 + v123) == (v123[|v123| := 'x'] + v123);
				case DC22(cf38) =>
		...
		r0 := !(v132 < v132);
		var v133: multiset<int> := multiset{if (f28) then f43 else v64[680]};
		r1 := if (v64[680] in v133) then v133[v64[680]] else f43;
		var v134: map<int, bool> := map[|multiset{|v2|, f43}| := f28];
		var v135 := DC15(seq(0x3e6, i6  => (v0)), true, f28, false);
		var v136 := DC1(f43, f43, v0, f28);
		var v137: seq<string> := [v132];
		var v138: map<int, int> := map[v64[680] := |fm42(v135, -v64[680], map[v136.cf3 := f43], |v137|, globalState)|];
		r2 := fm0(map[v64[680] := f28] != v134, f43, f43, v138, globalState);
	}
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		for i0 := -fm0(f28, f43, |v0|, p1, globalState) to p3 * |v1| {
			...
			v7 := v7;
			globalState.f21 := p3 / f43;
			globalState.f21 := f43;
		}
		if (p0) {
			var v8: seq<bool> := [!f28, p0];
			var v9: array<bool> := new bool[8] [v8[p3], f28, p0, f28, f28, DC15(v1, f28, p0, p0).cf30, f28, f28];
			...
			if (fm1(p0, f43 - p3, globalState)) {
				...
				v12 := v12;
				var v13: map<bool, char> := map[f28 := v1[|[f43]|]];
			...
			var v21: set<bool> := {v8[0x2b4], f28};
			var v22: seq<int> := [|v21|];
			globalState.f21 := -(|v22| % p3);
			r0 := (|v1| - f43) % (p3 - -|v22|);
			...
			if (fm3(f43, f43, v26 * v26, f28, globalState)) {
				...
				var v32: array<seq<bool>> := new seq<bool>[26] [v27, v28.cf38, if (-p3 in v29) then v29[-p3] else v27, v27, v27 + [true, v27[p3]], fm40(v30, f28, globalState), v27[p3 := p0] + v27, fm40(v30, true, globalState), (if (f28) then v27 else v27)[f43 := p0], if (!p0 in v31) then v31[!p0] else v27, (fm40(v30, p0, globalState))[p3 := false] + v27, v27, ([f28])[p3 := f28], fm40(fm44(f28, globalState), false, globalState), v27 + v27, [p0, f28, f28], v27 + v27, v27, v27, v27, v27, v27, v27 + v27, v27, v27, fm40(v30, p0, globalState)];
				v32[362] := v27 + v27;
				var v34: set<bool> := {f28};
				var v35: seq<map<int, int>> := [p1, map v33 : int | (-0x34a <= v33) && (v33 < 0x1d) :: (v33 * f43) := (|multiset{f28}|), map[|v34| := p3], p1, p1];
				v32[362], v25, globalState.f16, globalState.f1, globalState.f21 := v27 + (v27 + v27), (fm45(-p3, fm0(p0, |v1|, f43, v35[881], globalState), f43, p0, globalState)).cf14, f43 % 0xec, f28, fm23(p3 / -p3, true, globalState);
				v24 := v24;
				v24 := v24;
				...
				v48 := v48;
				globalState.f16, r0, r0, globalState.f16 := p3, -0x102, f43 % p3, if (p0) then |v40| else f43;
			...
			var v52: map<array<bool>, int> := map[v51 := -p3 % 947];
			var v53: seq<int> := [f43];
			...
			if (p3 != p3) {
				...
				var v58: map<bool, D1> := map[v51[959] := v57];
				var v59: multiset<int> := multiset{if (|v56| in p1) then p1[|v56|] else p3, |v1|, p3, |v58|, f43};
				var v60: map<int, bool> := map[|(seq(749, i4  => ('s')))| := v51[959]];
				var v61: set<int> := {p3};
				var v62: set<seq<bool>> := {v56};
				var v63: array<int> := new int[20] [p3, fm0(!fm1(v51[959], |v54|, globalState), f43, -f43, p1, globalState), |v55|, |v59| - 0x1a3, 0xe, 0x79, p3, p3, |v60| * |v55|, f43 + f43, |v61| / |v56|, f43, f43 * f43, f43, -p3 * |{f43}|, |v1| - |p1|, 0x2df, f43, p3, |(v62 * v62)|];
				v63[964] := p3;
				v63[964] := |(v56 + v56)|;
				v63[964] := v63[964] - fm23(p3, v51[959], globalState);
				globalState.f8 := seq(263, i5  => (v24));
				globalState.f21 := f43;
			} else {
				...
				var v69: seq<string> := [seq(0x27a, i6  => ('x'))];
				var v70: array<int> := new int[8] [f43 + f43, f43, p3 * -0x2cf, if (f28) then |(set v64 : int | (0x41 <= v64) && (v64 < 0x3dd) :: (v64 * f43))| else p3, p3, p3 % p3, -0x3b, |(v65[v1 := |v67|] + (map v68 : string | v68 in v69 :: (v68) := (p3)))|];
				v70[660] := p3 + f43;
				...
				globalState.f21, v70[660], r1, v71 := f43, f43, v73, v71.(cf27 := true).(cf27 := !p0);
				...
				var v80: array<array<bool>> := new array<bool>[27] [v51, if (p0) then v51 else v51, v51, v51, v51, v51, v51, if (f28) then v51 else v51, v51, v78[f43], v51, v51, v51, v51, v51, v51, v51, v51, v51, v51, v51, if (false) then v51 else if (v70[660] in v79) then v79[v70[660]] else v51, if (p0) then v51 else v51, v51, v51, v51, v51];
				var v81 := DC25(v80);
			...
			var v84: array<int> := new int[18](i7 => i7 % f43);
		...
		match (v86) {
			case DC20() =>
				var v87 := 'n';
				var v88: C1 := new C1(f43, |("rbmldxsrj")[p3 := v87]|);
				var v89: set<C1> := {v88, v88};
				r0 := |v89| % (v88.f45 - -0x1a0);
			...
			case DC21(cf37) =>
				...
				v104[832] := cf37;
				var v105: seq<string> := [seq(0x36d, i9  => (v98)), seq(0x381, i10  => (v98))];
				v104[832] := (-0x4b % f43) > |v105[p3]|;
				...
				if (-p3 != |v110|) {
					...
					v115[321] := seq(0x62, i11  => (|v1|));
					r0, v115[321] := fm0(v104[832], f43, fm23(f43, cf37, globalState), p1, globalState), [f43 * f43];
					v101[800] := f43;
					var v116: seq<bool> := [false, !f28, v104[832]];
					v101[3] := fm0(true, |v107|, f43, p1, globalState);
					...
					v101[800], v116, v101[3] := p3, fm40(v117, v104[832], globalState), f43 - fm0(cf37, |v118|, |v122|, p1, globalState);
					globalState.f16 := f43;
				}
			...
			case DC19(cf36) =>
				...
				match (v126) {
					case DC11(cf21, cf22, cf23) =>
						var v127 := 'u';
						var v128: map<string, char> := map[seq(0x356, i13  => (v127)) := v127];
		...
		match (fm48(v1 + v1, fm37(p0, p3, v139, globalState), v1, globalState)) {
			case DC1(cf1, cf2, cf3, cf4) =>
				if ((seq(0x113, i14  => (|v1|))) < v138) {
					...
					var v154: array<int> := new int[6](i15 => i15 / cf1);
					v154[799] := cf2 * p3;
					v154[799] := -(0x12e - |v1|);
					v154[799] := cf2;
					...
					var v162: seq<seq<int>> := [seq(-0x2d1, i16  => (f43))];
					globalState.f21, v156, v157, v159, globalState.f8 := if (v160 in v161) then v161[v160] else p3 / f43, v156, fm45(v138[cf2], |v162|, ---|v0|, cf4, globalState), v159, "colomu";
					globalState.f16 := cf2;
			...
			case DC0(cf0) =>
				...
				var v173: array<int> := new int[21] [p3, f43, p3, f43, p3, -906, cf0 - fm0(f28, f43, cf0, p1, globalState), -cf0, p3 - |v170|, f43, -(if (p0) then cf0 else p3), cf0 + cf0, cf0, p3, if (p0) then 941 else f43, f43 % cf0, cf0, -0x300 % f43, 357, |v171|, |fm40(v172, false, globalState)| + |v1|];
				v173[90] := if (p0) then cf0 else p3;
				v173[90] := cf0;
				v173[90] := cf0;
		...
		var v176: map<array<bool>, int> := map[v175 := -v174[335]];
		var v177 := DC12(v176);
		match (v177) {
			case DC13(cf25, cf26) =>
				r2 := cf26;
				...
				if (fm24(globalState)) {
					...
					var v182: seq<seq<int>> := [v138, fm42(DC15(v1, v180.cf18, cf26, f28), |(seq(683, i20  => (v136)))|, v181, cf25, globalState), v138];
					globalState.f8, v182, r0, globalState.f1 := fm37(cf26, 535 - -35, v139, globalState), v182 + v182, p3 % f43, (p3 != v174[335]) <==> (if (!!p0) then !p0 else cf26);
				} else {
					var v183: set<map<bool, char>> := {v179, v179};
					globalState.f16 := |(v183 - v183)| * f43;
					var v184 := new C1(v174[335], f43);
					v1 := seq(0x8, i21  => (v136));
				...
				match (v189) {
					case DC5(cf10, cf11, cf12, cf13, cf14) =>
						...
						var v191 := DC7(v137, seq(-856, i22  => (cf12)), !p0);
						var v192: map<bool, seq<D3>> := map[cf13 := v190];
						var v193: array<seq<D3>> := new seq<D3>[21] [v190 + v190, v190, [v191, v191, DC7(v137, v138, cf11)] + [v191], if (f28 in v192) then v192[f28] else [v191, v191], v190, v190, v190, v190, v190, v190, v190, v190, v190, v190, v190, v190, [v191], [v191, v191, v191, v191], v190, seq(0x1e4, i23  => (v191)), v190 + v190];
						v193[970] := [v191];
						globalState.f11, v193[970] := cf13, v190;
						v175[4] := cf26;
						v175[4] := cf26;
					case DC4(cf9) =>
						globalState.f8 := (v1[0x24a := v136] + v1)[v174[335] := v136];
						globalState.f16 := f43;
						v136, globalState.f16 := v136, cf25;
						globalState.f16 := p3 % (f43 * cf25);
				}
				
			case DC14(cf27) =>
				var v194: array<D4> := new D4[20](i24 => DC11({v136}, [v138, seq(0x3a6, i25  => (0x7d)), seq(0x104, i26  => (-325))], v174[335]));
				var v195: set<char> := {v136};
				var v196: seq<seq<int>> := [v138];
				var v197 := DC11(v195, v196, f43);
				v194[224] := v197;
				v194[224] := DC11({v136, v136, v136}, v196, p3);
				globalState.f22 := !p0;
				var v198: map<int, bool> := map[p3 := cf27];
				v198 := v198[-0x212 := p0];
				v174[335] := -f43 * -(p3 / 0x231);
			case DC15(cf28, cf29, cf30, cf31) =>
			...
			case DC12(cf24) =>
				...
				globalState.f21 := -716;
				var v203: multiset<int> := multiset{v174[335], v174[335]};
				var v204: map<int, bool> := map[0x298 := f28];
				r0 := |(v1 + v1)| % --(if (-|v204| in v203) then v203[-|v204|] else 0x22c);
		}
		
		var v205: multiset<bool> := multiset{f28, f28, false};
		var v206: multiset<multiset<bool>> := multiset{v205};
		var v207: map<int, multiset<multiset<bool>>> := map[|v1| - v174[335] := v206];
		r0 := |(if (p3 in v207) then v207[p3] else v206 * v206[multiset{p0} := v174[335]])|;
		r1 := v205;
		r2 := "hbdiqlfae" < v1;
	}
	method m22(p0: int, globalState: GlobalState) returns (r0: seq<D0>, r1: int) {
		if (f28) {
			...
			v2[719] := fm0(f43 <= |multiset(v4)|, p0 + 0x139, p0 / p0, v5, globalState);
			globalState.f16 := p0;
			var v6, v7 := m0(v2[719], globalState);
			globalState.f8 := v1 + v1;
		} else {
			var v8 := 'y';
			...
			var v11 := "u";
			var v12: array<int> := new int[21] [p0, |fm32(f28, v8, f28, f43, globalState)|, p0, p0, |(v10 + v10)|, f43, -f43, |v11|, p0, -0xb9, p0, |"xttpl"|, f43, p0, f43, f43 / |(seq(-0x3b5, i0  => (v8)))|, p0, p0, if (-f43 in v10) then v10[-f43] else p0, -f43, f43];
			v12[786] := f43 * p0;
			var v13: seq<int> := [p0 * p0];
			v12[786] := v13[f43];
			globalState.f22 := false;
			globalState.f16 := v12[786];
			globalState.f21 := -0x235;
			var v14: set<bool> := {f28, f28};
			var v15: seq<string> := [v11, fm37(f28, p0, v14, globalState)];
			if (v15[v12[786]] != (seq(0x392, i1  => (v11[-772])))) {
				var v16: seq<bool> := [f28];
				globalState.f22 := !(f28 || v16[p0]);
				var v17: map<set<bool>, int> := map[{f28} := v12[786]];
				v17 := v17[v14 := p0];
				var v18: seq<map<bool, int>> := [map[false := |v11|]];
				globalState.f22 := (|v10| % |v13|) == |v18|;
				var v19: set<int> := {f43, |fm37(f28, |v11|, {f28}, globalState)|};
				var v20: set<int> := {|[-v12[786], v12[786]]|, p0, -p0, |v19|};
				globalState.f16 := |(v20 + (set v21 : int | v21 in v10 :: (v21 / |DC30(map[true := |[false, false, true, true, false]|]).cf51|)))| % (0x2b8 * |v16|);
				...
				var v36: array<multiset<seq<bool>>> := new multiset<seq<bool>>[8] [multiset(v33), v34, v34, v34, (multiset{v32, v32})[v32 := |v13|] * v34, v34 * v34, v34, v35[p0]];
				v36[889] := v34;
				var v37: array<char> := new char[11];
				v31, v36[889], v37 := (v31 + [v30, v30, v30, v30])[p0 := v30], v34, v37;
				globalState.f8 := "cukopw" + (v11 + v11[f43 := v8]);
			}
			...
			decreases 100 - i3
		{
			...
			v41, globalState.f1, r1, globalState.f11 := v41, !f28, 0x1a8, !(if (v38 < v38[f28 := 0x11f]) then fm3(p0, |v42|, v44, true, globalState) else f28);
			globalState.f1 := (-f43 / f43) != f43;
			globalState.f21 := f43;
		...
		v45, globalState.f21, v46[292] := v45, match v49 {
		...
		for i5 := f43 to p0 {
			globalState.f11 := f28;
			var v51: set<string> := {v46[292]};
			var v52: seq<set<string>> := [v51];
			var v54: map<string, int> := map[v47 := 523];
			var v56: array<set<string>> := new set<string>[17] [v51 - v52[f43], v51 - v51, v51, {v46[292]}, v51, v51 - {seq(0x39e, i6  => (v45)), v47}, v51 + v51, v51, if (f28) then set v53 : string | v53 in v51 :: (v53) else v51, {v47}, v51, set v55 : string | v55 in v54 :: (v55), v51, v51, fm50(v54[seq(0xe5, i7  => (v45)) := i5], 496, globalState), v51, v51 - v51];
			var v57: seq<string> := [v46[292]];
			v56[885] := set v58 : string | v58 in v57 :: (v58);
			v56[885] := v51;
			var v59: array<int> := new int[6] [p0, |v46[292]|, 0x4e, DC0(f43).cf0, 0x3e2, i5];
			var v60 := DC4(v59);
			...
			decreases 100 - i8
		{
			...
			if (f28) {
				...
				var v71: set<char> := {'f'};
				var v72 := DC7(v69, v65, !((if (v46[292] in v70) then v70[v46[292]] else v48)[f28 := |v71|] >= v48));
				v72 := v72;
				...
				var v76: array<array<bool>> := new array<bool>[16] [if (f28 in v74) then v74[f28] else v50, v50, v50, v50, v50, v50, DC17(v50, v47).cf33, v75[|v47|], v50, v50, v50, v50, v50, v50, v50, v50];
				var v77: array<int> := new int[9](i9 => i9 * f43);
				v77[50] := p0;
				v77[928] := -0x38e;
				v46[292], v76, v77[50], globalState.f16, v77[928] := v46[292] + v46[292], v76, p0, -f43, 0x2f2 + (if (f28) then f43 else p0);
				var v78: array<array<char>> := new array<char>[3];
				var v79: array<char> := new char[2](i10 => v45);
				v78[948] := v79;
				v78[948] := v79;
				var v80: map<bool, multiset<bool>> := map[f28 := v48];
				var v81: set<int> := {v77[50]};
				var v82 := DC0(|v81|);
				var v83: seq<int> := [v82.cf0, f43];
				var v84: seq<array<int>> := [v77, v77, v77];
				v45, globalState.f21, globalState.f11, v80, v77[50] := v45, f43, fm24(globalState), (fm51(f28, globalState))[f28 := v48] + map[f28 := fm32(f28, v45, f28, |v83|, globalState)], -|[-f43, -513, if (!f28) then |v84| else v77[50], |(seq(-0x3dc, i11  => (v45)))|]|;
				var v85: map<int, int> := map[p0 := p0];
				var v86, v87 := m0(fm0(f28, v77[50], p0, v85, globalState), globalState);
				var v88: array<seq<int>> := new seq<int>[27];
				v88[660] := v83;
				var v89: map<bool, int> := map[v86 := v77[50]];
				v88[660] := if (false) then seq(914, i12  => (0x17b)) else [f43, |v89|, v77[50], p0, p0];
			}
			...
			if (f28) {
				...
				var v96 := DC11((set v90 : char | v90 in v46[292] :: (v90)) * v91, if (f28) then v95 else v95, p0);
				v96 := v96;
				var v97 := new C0(f28);
				var v98: map<int, int> := map[v93[p0] := p0];
				v98 := v98[p0 := |v47|];
				globalState.f21 := f43;
...
class C4 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
			...
			decreases 100 - i1
		{
			...
			globalState.f8 := v11;
			v7[388] := f28;
			v7[388] := fm1(f28, fm20(globalState), globalState);
			globalState.f21 := v6;
			v7[388] := f28;
		}
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			if (v12[v6] in v10) {
				...
				globalState.f22, globalState.f8 := map[false := v6] != map[f28 := fm0(f28, |v13|, v6, v14, globalState)], v16[if (f28) then v6 else v6];
				var v17: array<int> := new int[26];
				v17[89] := |v13|;
				v17[89] := -v6 * 0x63;
				globalState.f1 := !f28;
				globalState.f16, globalState.f1 := |[f28]|, fm1(f28, v17[89], globalState);
				r0 := f28;
			} else {
				...
				v18[642] := fm0(f28, v6, |v20|, v21, globalState);
				v18[642] := v6;
				var v22: map<bool, bool> := map[false := f28];
				v7[461] := if (f28 in v22) then v22[f28] else f28;
				v7[461], v18 := f28, v18;
			}
			...
			if ((v23 + v23) == v23) {
				...
				var v32 := 'd';
				v29[383] := fm52(if (f28) then v23 else v23, !(if (v27.f44 in v31) then v31[v27.f44] else f28), |[v32]|, globalState);
			} else {
				globalState.f16 := v6;
				...
				v35 := (v35 + v35)[v33.f43 := v34] + v35;
				r0 := v33.f43 >= v6;
			}
			
			if (f28) {
				globalState.f1 := v12[v6];
				...
				v7[545] := v6 == v6;
				globalState.f22, v7[545] := f28, f28;
				var v39: map<bool, bool> := map[v7[545] := f28];
				var v40: seq<map<bool, bool>> := [v39, v39];
				var v41: map<int, int> := map[v6 := |v12|];
				var v42: map<int, int> := map[fm0(f28, v6, v6, v41, globalState) := v6];
				globalState.f1 := if (f28) then v6 < |v40[fm0(v7[545], v6, v6, v41, globalState)]| else v7[545];
		...
		if (match v49 {
			...
			v7[653], v63, r1, v7 := f28, v63, if (true) then -0x2a6 else v6 - v6, v7;
			var v64: multiset<seq<bool>> := multiset{v63, if (!f28) then v63 else v63, v63, v63, [f28] + v63};
			v64 := v64;
			globalState.f1 := v7[653];
			v6 := fm20(globalState);
		} else {
			globalState.f16 := fm20(globalState);
			var v65: seq<bool> := [f28];
			v65 := if (f28) then v65 + v65 else v65[v6 := f28];
			var v66: map<int, bool> := map[v6 := !f28];
			v7[321] := v6 < |v66|;
			v7[321] := f28;
			if (f28) {
				globalState.f1 := v7[321] && true;
				var v67: set<int> := {660};
				v67 := v67;
				v6 := -v6;
				v48 := {false, v6 >= v6};
				...
				var v71 := DC15(fm37(v7[321], |v70|, v48, globalState), true, v7[321], v48 > v48);
				var v72 := DC2(seq(0xe4, i4  => (v69)));
				var v73: set<map<int, bool>> := {v66, fm2(v6, v72, v69, globalState)};
				var v74: array<bool> := new bool[12] [f28, !f28, v7[321], true, f28, !f28, v7[321], f28, f28, false, f28, f28];
				var v75: map<array<bool>, multiset<bool>> := map[v74 := multiset{f28}];
				v71, globalState.f11, globalState.f21, globalState.f21 := v71, (v73 >= v73) !in (v5 - multiset{f28}), |(if (!v68.fm28(v68.f45, v7[321], globalState)) then v75 else v75)|, if (f28) then -0x7a else v68.f46;
			}
		...
		if (f28) {
			...
			v7[992], v7[176], v6, globalState.f11 := f28, f28, |multiset(v79)|, true;
			if (if (f28) then fm1(f28, v6, globalState) else v7[992]) {
				v48 := v48;
				globalState.f16 := v6;
				var v80: seq<array<int>> := [v77];
				var v81: seq<array<int>> := [v77, v80[v6], v77, v77];
				v81, globalState.f16 := v81 + [v77], v6 / |([v6])[|v48| := v6]|;
				globalState.f11 := false;
				var v82: map<int, bool> := map[v6 := v7[992]];
				v82 := v82[v6 := f28 <== f28];
			} else {
				v77[9] := v6;
				v77[9] := v6;
				...
				var v86: multiset<int> := multiset{|v79|, v77[9]};
				var v87 := new C3(v6 - |v86|, v7[992]);
				...
				var v93: array<bool> := new bool[24] [false, f28, v84, f28, v7[992], v84, v84, v7[992], f28, f28, f28, true, v7[992], !v7[992], f28, !v7[992], !f28, v7[992], v84, f28, v84, f28, v87.fm3(v87.f43, |v89|, v92, false, globalState), v84];
				var v94: seq<array<bool>> := [v93, v93];
				var v95: seq<int> := [v6 * |v88|, v87.f43, |(if (true) then [v93, v93, v94[|v79|]] else v94)|];
				v95 := v95 + (v95 + v95);
			}
			
			v78 := v78;
			var v96 := "yek";
			globalState.f21 := 0x377 % |(v96 + v96)|;
		} else {
			...
			var v102: seq<string> := [v100[|v101| := v98], v100, v100, v100];
			v97[100], globalState.f21, globalState.f1, v98 := v6, if (f28) then |(map v99 : int | (0x34d <= v99) && (v99 < 0x2a2) :: (v99 - -v6) := (f28))| else v6, v102 < v102, v98;
			var v104: set<int> := {v97[100]};
			r0 := ((set v103 : int | (561 <= v103) && (v103 < 370) :: (v103 + v97[100])) * v104) !! v104;
			v7[795] := f28;
			v7[795] := f28;
			r0 := false;
			globalState.f22 := !(!f28 <==> (0xf3 > v97[100]));
		}
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		globalState.f21 := if (if (p3 in v6) then v6[p3] else p0) then -291 else |(v3 + (seq(0x74, i0  => (-p3)))[p3 := -p3])|;
		var v7: set<bool> := {f28, p0};
		var v8 := DC6(v7 - v7);
		match (v8) {
			case DC7(cf16, cf17, cf18) =>
				globalState.f16 := p3 % fm20(globalState);
				if (true) {
					globalState.f22 := cf18;
					var v9 := "rghpij";
					...
					var v13: map<int, array<bool>> := map[p3 % |v3| := if (f28 in v12) then v12[f28] else v11];
					v13 := v13;
					var v14: map<bool, int> := map[cf18 := p3];
					var v15: array<string> := new string[20] [v9, "inbxl", fm37(f28, |v7|, v7, globalState), v9, v9, v9, fm37(cf18, p3, v7, globalState), fm37(p0, |v14|, v7, globalState), v9, fm37(f28, p3, v7, globalState), v9, v9, "votdymt", (seq(384, i2  => (v1))) + v9[p3 := v1], v9 + "ixacipe", v9, v9, v9, "cwh", v9];
					v15 := v15;
				} else {
					...
					globalState.f21, v22[677], globalState.f16 := p3 - -0x331, fm1(f28, -(p3 % p3), globalState), if (if (v24 in v23) then v23[v24] else cf18) then -p3 else p3 - fm0(if (p3 in v6) then v6[p3] else fm1(f28, p3, globalState), p3, -|v6|, p1, globalState);
					globalState.f16 := --(p3 % |v3|);
					v16 := if (p0) then v16 else v16;
				}
				
				globalState.f16 := p3;
				var v25: seq<bool> := [p0];
				match (fm53(p3, ([v3])[0x1ba := [p3, if (!p0 in v0) then v0[!p0] else |v25|]], globalState)) {
					case DC20() =>
						var v26: array<seq<bool>> := new seq<bool>[4] [v25[|"jxaga"| := cf18], v25, v25, [cf18]];
						v26[779] := v25;
						var v27 := DC22(v25);
						v26[779] := v27.cf38;
						...
						v28[386] := fm1(v4.cf18, p3, globalState);
						v28[386] := cf18 || cf18;
					...
					case DC21(cf37) =>
						...
						var v40: array<int> := new int[14] [p3, p3, |v33|, |v3|, p3, p3, |(seq(0x63, i3  => (p3)))|, p3, |v39|, p3, p3, |"y"|, p3, |(seq(0x67, i4  => ('i')))|];
						var v41 := DC4(v40);
					...
					case DC19(cf36) =>
						...
						globalState.f1, globalState.f21 := v45 >= (v45 + v45), v3[|fm54(p0, globalState)|];
			...
			case DC8() =>
				match (fm55(p0, fm20(globalState), globalState)) {
					case DC11(cf21, cf22, cf23) =>
						...
						globalState.f22, globalState.f1, globalState.f1, globalState.f16, v47 := fm1(f28, cf23, globalState), true, p0, p3, if (false) then v47 else v48[-0x22b];
						var v49: array<int> := new int[2](i5 => i5 + cf23);
						v49[148] := |v7|;
						var v50 := DC23(p0, true, p3, v49);
						var v51: set<int> := {cf23};
						v49[148] := -((v50.cf41 + |v51|) + (p3 * |v7|));
						var v53: map<bool, int> := map[fm1(p0, |(set v52 : int | v52 in p1 :: (v52 / |map[|multiset{|{false}|}| := |map[383 := -|{true, false}|]|]|))|, globalState) := v49[148]];
					...
					case DC10(cf20) =>
						...
						v57, v3, globalState.f4, globalState.f21 := fm56(-|(v56[p3 := if (v58 in v59) then v59[v58] else 'n'] + v56)|, if (v61.(cf49 := p2) in v62) then v62[v61.(cf49 := p2)] else |v0|, globalState), v63[|(seq(0x398, i7  => (v1)))|], {v1, v1}, p3;
						var v64: map<char, int> := map[v1 := p3];
						var v66: array<bool> := new bool[26] [p0, p0, fm3(|v56|, p3, {map[v56[p3] := p3], v64, map[v1 := p3], v64, v64}, f28, globalState), DC15(("swn")[|v56| := v1], p0, f28, f28).cf30, !f28, p0, f28, f28, fm1(f28, p3, globalState), f28, !p0, cf20 > cf20, fm1(f28, p3, globalState), p0, !p0, p0, !false <==> p0, p3 < |v56|, f28, p0, false, f28, f28, if (f28) then f28 else p0, p0, p3 in (set v65 : int | v65 in v3 :: (v65 + |multiset{multiset([|[true]|])}|))];
						v66[453] := !false;
						var v67: array<int> := new int[17](i8 => i8 + p3);
						v67[864] := -p3 / p3;
						globalState.f21, v66[453], v67[864] := if (p3 < |v7|) then p3 else p3, p3 != p3, if (fm1(!p0, p3, globalState)) then p3 else p3;
						globalState.f16 := v67[864];
				}
				...
				match (v69) {
					case DC5(cf10, cf11, cf12, cf13, cf14) =>
						...
						var v77: map<array<bool>, bool> := map[v76[cf12] := p3 <= cf12];
						v77 := v77[v73 := cf13];
				...
				match (fm57("a", !f28, p0, globalState).(cf19 := v84)) {
					case DC7(cf16, cf17, cf18) =>
						...
						v86 := v86;
						var v87: seq<seq<int>> := [v3, seq(0x3b3, i9  => (p3))];
						var v88 := "qwlkj";
					...
					case DC9(cf19) =>
						...
						var v103 := DC16(v102[v0[f28 := p3] := -p3]);
						var v104: map<D6, bool> := map[v103 := p0];
						v104 := v104;
						globalState.f1 := !f28;
						var v105 := "hdr";
						var v106 := new C2(-|(v105 + v105[|"hxaqnej"| := v1])|);
				}
				
			case DC6(cf15) =>
				var v107 := "sc";
				globalState.f16 := |("wrpc" + v107)|;
				var v108: array<multiset<bool>> := new multiset<bool>[9] [multiset{p0, p0}, v0[true := p3], v0, v0, v0, multiset{false}, v0, v0, v0 - multiset{p0, f28}];
				v108[466] := v0 - multiset{p0};
				var v109: seq<string> := [v107];
				var v110: map<int, seq<int>> := map[p3 := v3];
				globalState.f14, globalState.f21, globalState.f16, globalState.f16, v108[466] := (v109 + v109) + v109, p3, |v110|, p3 / p3, v0 * v0;
			...
			case DC9(cf19) =>
				...
				var v123: array<bool> := new bool[29] [f28, v116 >= v116, f28 !in v117, true, if (v113 in v6) then v6[v113] else f28, v1 !in v118, f28, true || f28, p0, if (p0) then f28 else p0, if (|v119| in v6) then v6[|v119|] else f28, p0, |v0| <= p3, fm3(-v113, v113, v120, true, globalState), true, f28, if (p0) then f28 else f28, f28, true, p3 <= p3, v121.cf54, v122 == v122, !((seq(0x35c, i12  => (v1))) < v118), p0, p0, !f28, f28, !p0, p0];
				var v124: multiset<array<bool>> := multiset{v123, v123};
				v114[958], v123, globalState.f1, globalState.f22, globalState.f1 := |v118|, v123, (if (p0) then v0[!p0 := p3] else v0) > v0, p3 == v113, !!(v123 !in (multiset{v123} + v124));
				v123[429] := p0;
				globalState.f11, v123[429], v114[958], v114 := ((seq(200, i13  => (v118))) != ["frrryivp"]) || f28, p0, if (-v114[958] in p1) then p1[-v114[958]] else |fm2(v113, DC2("ed"), v1, globalState)|, v114;
				var v125: array<map<bool, multiset<bool>>> := new map<bool, multiset<bool>>[14](i14 => map[false := (multiset([f28]))[v123[429] := p3]]);
				v125[733] := map[p0 := v0];
	...
	method m20(p0: int, globalState: GlobalState) returns (r0: char, r1: bool, r2: bool) {
		...
		for i2 := p0 to |(if (f28) then v9 else v9)| {
			...
			var v13 := DC30(v10);
			var v14: map<D11, char> := map[v13 := fm34("ouqp", seq(0x112, i3  => ('o')), i2, globalState)];
		...
		v2, globalState.f16, v18 := v2, (if (v0.f28) then p0 else p0) % p0, v18;
		var v19 := 'v';
		r0 := v19;
		r1 := v0.f28;
	...
	method m21(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int) {
		...
		if (p2) {
			...
			r0 := fm0(!true, -p0 % p0, |v15|, v16, globalState);
			var v17 := "pxyuwrs";
			globalState.f8 := v17;
		} else {
			var v18 := 'k';
			...
			match (v26) {
				case DC5(cf10, cf11, cf12, cf13, cf14) =>
					...
					v20[631] := fm3(p1, |v19|, v27, f28, globalState) in v24;
					var v28: C1 := new C1(p1, cf12);
					globalState.f1, v20[631] := !fm1("g" == v19, |[v28, v28, v28, v28]|, globalState), cf11;
				...
				case DC4(cf9) =>
					...
					var v34: map<bool, seq<int>> := map[f28 := v33[p1 := p3]];
					var v35: seq<string> := [v19, v19, seq(-0x35d, i2  => (v18)), v19];
					var v36: set<map<char, int>> := {v25};
					var v37 := DC35(f28, fm1(false, 0x217, globalState), p2, -0x3, |v19[p3 := 'b']|);
					v34, globalState.f16 := (v34 + v34)[fm3(|v35|, p3, v36, v37.cf60, globalState) := [p1, |v24|, p1, p1] + v33], v33[p0];
			...
			v43 := v43[fm58(p1, p1, globalState) := |(map v44 : int | v44 in (seq(0x36a, i3  => (p0))) :: (v44 * p3) := (|multiset{p3}|))|];
		...
		if (!false) {
			...
			var v52: multiset<int> := multiset{if (v46.fm3(v47[p1], p1, v51, fm1(p2, 638, globalState), globalState)) then p3 else p0};
			v52 := v52;
			if (!!f28 ==> true) {
				...
				v54, globalState.f10, globalState.f22 := v54 + v54, (map v55 : int | (605 <= v55) && (v55 < 491) :: (v55 / p0) := (p3)) + (v57 + v57), p0 == -p0;
				globalState.f21 := -p1;
				...
				v61[827] := if (p2 in v63) then v63[p2] else multiset{v56};
				...
				var v72: multiset<map<bool, array<int>>> := multiset{v66[-|v71|] + map[f28 := v58]};
				var v73: seq<seq<int>> := [v47, [p3], v47, [0xc0], v47[p3 := p1]];
				globalState.f16, r0, globalState.f21, v61[827] := p3 + |v47|, if ((v65 + v65) in v72) then v72[v65 + v65] else -p0, |(v73 + v73)|, (multiset([v56]) - v62) * v62;
			...
			var v84: seq<array<int>> := [v83[p0], v82, v82];
			var v85: array<array<int>> := new array<int>[17] [v83[p3], v82, v82, v82, v82, v82, v82, v82, v82, v82, v82, v83[p1], v82, v82, v82, v82, v82];
			...
			globalState.f16 := |v94|;
			v91[901] := p0;
			v91[901], globalState.f22 := p0, !(f28 && (p0 < p3));
		}
		
		var v95: seq<bool> := [f28, true];
		var v96: map<int, int> := map[p3 := 0x150];
		var i4 := 0;
		while ((fm0(v95[|v95|], -p3, p0, v96, globalState) - p1) == p1)
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			var v101: map<bool, bool> := map[v98 == v99[p3] := v95[|fm37(f28, p1, v100, globalState)|]];
			v101 := v101[f28 := p2];
			var v102 := DC6(v100);
			...
			if (f28) {
				var v104 := DC20();
				v97, globalState.f1 := ((seq(0x39b, i5  => (-|{p3, p3}|))) + v97[|{v104, v104}| := p3]) + (v97 + v97), !!(!f28 ==> p2);
				...
				var v113: array<multiset<bool>> := new multiset<bool>[24] [v105, multiset{p2}, if (f28) then multiset{f28} else v105, v105[p2 := fm0(p2, 472, p1, map[p1 := p1], globalState)] - fm21(p1, v106, p3, globalState), v105, v105, v105, v105 * v105, v105, v105, multiset{!p2}, v105 * v105[f28 := |v108|], v109.cf77, v105 - v105, v105, v105 * v110[p0], v105, multiset([f28, f28, false, if (v111 in v112) then v112[v111] else p2, p2]), v105, multiset(v95), v105, v110[p3], v105, v105 + multiset(v95)];
				v113[422] := multiset{p2, p2, p2};
				v113[422] := v109.cf77;
				var v114: array<map<int, bool>> := new map<int, bool>[29];
				v114 := v114;
				var v115 := 'd';
				v0[555] := v115;
				v0[555] := if (p2) then v115 else v115;
		...
		for i8 := -p0 to -0x368 {
			var v119: seq<int> := [p3];
			var v120 := "kvfqhgm";
			var v121: multiset<int> := multiset{v119[i8], |v119|, p0, |v120|, p0};
			var v122: array<bool> := new bool[1] [v95[|v121|]];
			v122[387] := p2;
			v122[387] := f28 && f28;
			var v123: seq<string> := [v120, v120, seq(342, i10  => ('w')), v120];
			var v124: array<seq<string>> := new seq<string>[25] [(seq(0x25a, i9  => (v120))) + v123, v123, v123, v123, fm59(p0, |v120|, globalState), v123 + (seq(0x309, i11  => (v120))), v123, v123, v123, (seq(0x358, i12  => (v120))) + v123, v123[p0 := "gnu"], v123, [v120, v120, v120, seq(602, i13  => ('i'))] + v123, v123 + v123, v123, fm59(p0, p0, globalState), if (v122[387]) then v123 else ["uykufu", v120], v123, v123, [v120, v120, v120, v123[i8], v120] + fm59(p0, p3, globalState), v123, v123, v123 + (seq(-0x27, i14  => (seq(-78, i15  => ('j'))))), seq(411, i16  => (v120)), v123];
			v124[748] := v123;
			v124[748], globalState.f22 := v123, true;
			var v125: map<bool, int> := map[p2 := p3];
			globalState.f21 := -(p0 - ((if (v122[387] in v125) then v125[v122[387]] else p1) * p3));
			globalState.f22 := f28;
		}
		globalState.f21 := p0;
		var v126 := "anvqoa";
...
class C5 {
	...
	method m18(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		if (if (p1) then p1 else !(v0 == |v2|)) {
			var v3: array<int> := new int[1](i0 => i0 / |v1|);
			v3 := v3;
			...
			var v8: seq<bool> := [p0];
			globalState.f16 := |v7[v6.f44 := !(p3 && v8[v0])]|;
			var v9: array<bool> := new bool[23];
			v9[118] := p3 ==> p1;
			var v10: array<seq<bool>> := new seq<bool>[22](i1 => v8 + v8);
			var v11: map<bool, seq<bool>> := map[p2 := v8];
			v10[777] := (if (p1 in v11) then v11[p1] else v8)[0x69 := p2];
			v9[118], v10[777], globalState.f22 := fm1(if (v6.f44 in v7) then v7[v6.f44] else p1, v0, globalState), v8, !("f" <= "ybxtoq");
		} else {
			globalState.f16 := v0;
			var v12: map<int, int> := map[v0 := v0];
			var v13: C3 := new C3(fm0(p2, |map[p1 := seq(0x3a2, i2  => ('s'))]|, fm0(p3, v0, v0, v12, globalState), v12, globalState), p2);
			...
			v13, globalState.f21, globalState.f11, v14[170], globalState.f22 := v13, -0x19d - (if (!p2) then |v15| else v13.f43), p3, !(v16 !in v17[v13.f43 := v16]), if (p2) then p2 else fm2(v0, v18, v16, globalState) in v21;
			v14[170] := v14[170];
			var v22: seq<bool> := [p0];
		...
		var v36 := DC0(v0);
		var v37: array<map<int, string>> := new map<int, string>[27] [v26, (fm52([v0], p1, 350, globalState))[0x2a9 := v25], map[v0 := v25], v26 + v26, map[v0 := v25], if (fm0(!p3, v0, |v25|, v29, globalState) in v27) then v27[fm0(!p3, v0, |v25|, v29, globalState)] else v26, v26, v26, v26, if (true) then v26 else map v30 : int | v30 in v2 :: (v30 % |map[set v31 : D5 | v31 in {DC14(p3), DC14(p0)} :: (v31) := v0]|) := (v25), v26, v26, v32.cf83 + v26, (map v33 : int | (0x17c <= v33) && (v33 < 0x19a) :: (v33 * v0) := ("ayjmssphm")) + map[0x18c := seq(-0xcd, i4  => ('g'))], v26, v26 + v26, v26, v26, (map[v0 := v25])[|v29| := v25], map v34 : int | (642 <= v34) && (v34 < -0x3a) :: (v34 + 146) := (v25), v26, v26[v0 := seq(0x169, i5  => ('v'))], v26, fm52(v2, p0, |[v0]|, globalState), map v35 : int | v35 in map[v0 := p3] :: (v35 % v0) := (v25), map[v2[|[v0]|] := fm37(true, v0, {!p2}, globalState)], map[v36.cf0 := v25]];
		v37[496] := v26;
		v37[496] := (map v38 : int | (0x19f <= v38) && (v38 < -0x211) :: (v38 / v0) := (v25))[|v25| % v0 := v25];
		if (--v0 != v0) {
			var v39: array<bool> := new bool[21];
			v39[839] := p3;
			v39[839] := p0;
			var v40 := new C2(|v25| + v0);
			var v41 := DC17(v39, seq(535, i6  => ('d')));
			var v42: multiset<string> := multiset{v41.cf34};
			if (!!(v42 > v42)) {
				globalState.f11 := v0 != v40.f44;
				globalState.f22 := p2;
				var v43, v44 := v40.m23(v2[v40.f44], v0, globalState);
				globalState.f1 := p3;
				var v45: seq<array<bool>> := [v39, v39, v39];
				var v46: set<int> := {v0};
				v45 := v45 + (v45[|v46| := v39] + v45);
			} else {
				var v47: map<string, bool> := map[v25 := v39[839]];
				v47 := v47["toydhvi" := p2];
				r0 := !p2 && p2;
				var v48: array<multiset<string>> := new multiset<string>[29](i7 => v42[v25 := v40.f44]);
				v48[881] := v42;
				var v49: map<bool, string> := map[p3 := v25];
				var v50: set<string> := {"p", if (true in v49) then v49[true] else v25, v25};
				v48[881], globalState.f22, v50 := v42, v0 <= -0x37e, fm50((map[v25 := v40.f44])[v25 := v40.f44], v0, globalState);
				var v51 := new C1(|fm60(globalState)|, v40.f44);
				var v52: seq<bool> := [v39[839]];
				var v53 := DC35(p3, p3, p3, v40.f44, |(v52 + v52)[|"dk"| := p2]|);
				v53 := v53;
			}
			
			var v54: array<int> := new int[7];
			var v55: map<bool, array<int>> := map[p3 := v54];
			var v56 := DC36(v55[!v39[839] := v54]);
			match (v56) {
				case DC37(cf65, cf66, cf67, cf68) =>
					var v57 := 'm';
					var v58: seq<bool> := [p2, p0, false, fm1(v39[839], v40.f44, globalState), !p0];
					var v59: map<int, bool> := map[v0 := v58[cf66]];
					v57 := fm34(v25, v25, |v59|, globalState);
					v58 := v58 + v58;
					globalState.f21 := cf67;
					var v60: array<C0> := new C0[18];
					var v61: array<char> := new char[12](i8 => v57);
					var v62: set<bool> := {true, if (v0 in v59) then v59[v0] else v39[839], p1, if (cf68 in v59) then v59[cf68] else v39[839]};
					var v63 := DC6(v62);
					var v64: set<int> := {|v63.cf15|};
					var v65: set<string> := {"xqn"};
					v61[268] := v25[fm0(true, fm0(v39[839], |v64|, |v65|, v29, globalState), cf67, v29, globalState)];
					v60, cf66, cf66, v61[268] := v60, 0x14c % cf66, cf66, v25[cf65 - v0];
				case DC38(cf69, cf70, cf71) =>
					v2 := v2;
					v37[496] := v37[496][cf70 := v25];
					var v66: map<bool, bool> := map[v39[839] := v39[839]];
					var v67: multiset<map<bool, bool>> := multiset{v66, v66, v66 + v66, v66, v66};
					v67 := if (fm1(p1, cf70, globalState)) then v67 else v67;
					var v68: set<bool> := {p0, v39[839], v39[839]};
					globalState.f1 := v68 !! v68;
				case DC39(cf72, cf73, cf74, cf75, cf76) =>
					var v69: seq<bool> := [v39[839]];
					var v70: map<seq<bool>, bool> := map[v69 := p3];
					var v71: array<seq<bool>> := new seq<bool>[15] [v69, v69, v69 + v69, v69, v69, v69, (v69 + v69)[cf74 := p0], [p0], [cf73], v69, v69[0x1f8 := fm1(p2, cf74, globalState)] + v69[v0 := v39[839]], [p2] + fm40(v70, true, globalState), v69, v69, v69];
					v71[337] := v69;
					v71[337] := [true, p1];
					v39[839] := cf75;
					v39[839] := cf75;
				...
				case DC36(cf64) =>
					var v72: seq<bool> := [p3];
					globalState.f1 := v72[v0];
					globalState.f11, v54, globalState.f16 := v72[v40.f44 * v40.f44], v54, if (v40.f44 in v29) then v29[v40.f44] else 0x319;
					v39[839] := fm1(p1, v40.f44, globalState);
					var v73 := 'h';
					v73 := 'u';
			}
			...
			match (v75) {
				case DC7(cf16, cf17, cf18) =>
					...
					v54[62], v77, globalState.f21, globalState.f21, v78 := v0, v77, v40.f44, fm0(true, v40.fm26(v40.f44, p2, v40.f44, v40.f44, globalState), v40.f44, v29 + (map v79 : int | (0x3ba <= v79) && (v79 < 556) :: (v79 - v0) := (v40.f44)), globalState), v78;
					var v80 := new C1(v54[62], |"mvjxf"|);
				case DC8() =>
				...
				case DC6(cf15) =>
					...
					var v96 := new C4(p0);
					globalState.f22 := v1[v40.f44 := |v29|] !! v1;
					v95 := v95;
				case DC9(cf19) =>
					var v97: map<bool, bool> := map[p1 := v39[839]];
					var v98: array<seq<int>> := new seq<int>[17];
					v97, v98 := v97, if (!(v39[839] || v39[839])) then if (p3) then v98 else v98 else v98;
					globalState.f8 := if (true) then seq(-0x1b4, i9  => ('r')) else ("eowtr" + "c")[v0 := 'b'];
					var v100: map<bool, int> := map[!v39[839] := fm0(p1, v40.f44, 0x43, map v99 : int | v99 in v2 :: (v99 / v40.f44) := (v40.f44), globalState)];
					globalState.f21 := (if (v39[839]) then if (false in v100) then v100[false] else |[p1, false, p0, v39[839], p2]| else v40.f44) - v0;
					var v101: array<string> := new string[22](i10 => "wulsfvem");
					v101[698] := v25 + "mvchfdlps";
					v101[698] := v25;
			}
			...
			v102[601] := p1;
			v102[601] := (|"rvfmyprby"| * v0) >= v0;
			var v103 := 'l';
			globalState.f11 := ((seq(-0x3d7, i11  => ('p'))) + v25) < ("pfd")[v0 := v103];
			var v104: seq<bool> := [fm1(p0, v0, globalState)];
			var v105: seq<seq<bool>> := [v104, v104, v104];
			var v106: map<seq<bool>, bool> := map[v104 := p1];
			var v107 := DC22(v104);
			var v108: array<seq<bool>> := new seq<bool>[26] [v104, v104, v104, v104, v105[|v25|], v104, fm40(v106, p0, globalState), if (p3) then v104 else v104, v107.cf38, v104, v104, v104 + v104, v104, v104[v0 := v102[601]] + v104, v104, if (p3) then v104 else v104, v104, v104, v104[-v0 := p0] + v104, v104, if (p2) then v104 else v104, [false, p1, v102[601]], v104, v104, [v102[601]], v104];
			v108 := v108;
			v108 := v108;
		...
		v118[486] := p3;
		v112[195] := v0;
		v117, v118[486], v112[195], globalState.f21, globalState.f8 := v117, p1, if (p1) then 520 else -0x3c8 * v0, 0x149, v25;
		var v119 := DC29(p2);
		r0 := v119.cf50;
	}
	method m19(p0: string, globalState: GlobalState) returns (r0: int, r1: seq<int>, r2: int, r3: int) {
		...
		var v8: array<seq<D1>> := new seq<D1>[14] [v3, v3 + (if (|v6| in v4) then v4[|v6|] else v3), v7[|(seq(476, i0  => (v0)))|], v3, if (v5) then v3 else v3, v3, v3, v3 + v3, v3 + v3, v3, v3, (v3 + v3)[|p0| := v2], fm61(globalState), v3];
		v8[342] := v3;
		v8[342] := v3;
		globalState.f8 := p0;
		var v9 := 't';
		globalState.f8 := p0[v0 := v9];
		...
		var v16: set<string> := {"jebocvaq", p0 + (seq(0xed, i1  => (v9)))[fm0(v5, v0, |p0|, v15, globalState) := v9], p0, "gxahu"};
		var v17: set<bool> := {v5};
		var v18: set<map<int, int>> := {map[|v17| := |{v0}|], v15, v15, fm41(|v14[765]|, v5, v5, globalState), v15};
		...
		if (!v5) {
			...
			var v38: array<int> := new int[10] [|v32| % v28.f43, 0x29f, |v33| * v28.f43, -915, |(v32 + v32)|, v28.f43, |v36|, v28.f43 - |v37|, v28.f43, v0 * v0];
			v38[428] := v28.f43;
			var v39: map<D1, int> := map[fm38(0x20e, globalState) := v0];
			v38[428] := -(v28.f43 / v30.f43) + (0x11 / |v39|);
			var v40: seq<seq<bool>> := [v32, v32];
			r2 := -v38[428] + |v40[v28.f43]|;
		}
		
		var v41 := DC37(v0, v0, v0, v0);
		r0 := match v41 {
			case DC37(cf65, cf66, cf67, cf68) => -(cf68 - cf66)
			case DC38(cf69, cf70, cf71) => -v0 / v1[|v15|]
...
class C6 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (!f28) {
			...
			v7[575] := fm17(v0, v0, "umwgtkrgh", fm0(f28, v0, -598, v8, globalState), globalState);
			...
			if ((v16 + v16) !in (if (|v17| in v18) then v18[|v17|] else v17)) {
				...
				globalState.f1 := f28;
				var v23: array<int> := new int[13](i0 => i0 / |multiset(v13)|);
				v23[430] := v21 / -0x12a;
				v23[430] := if (f28) then 331 else -v16;
				var v24: map<bool, bool> := map[f28 := f28];
				var v25: seq<bool> := [if (f28 in v24) then v24[f28] else f28, f28, f28];
				var v26: map<int, seq<bool>> := map[v23[430] := [true, f28]];
				var v27: map<bool, int> := map[f28 := v23[430]];
				var v28: map<map<bool, int>, seq<bool>> := map[v27 := [f28, f28]];
				var v29: array<seq<bool>> := new seq<bool>[10] [v25, v25, if (v21 in v26) then v26[v21] else v25, v25[43 := f28], (if (v27 in v28) then v28[v27] else v25[v23[430] := f28]) + v25, v25 + v25, v25, v25, v25 + v25, v25];
				v29 := v29;
				v27 := v27[f28 := v21];
			} else {
				v17 := seq(-0x113, i1  => (v16));
				globalState.f22 := f28;
			...
			var v34: array<map<int, int>> := new map<int, int>[11](i3 => map v33 : int | v33 in v17 :: (v33 % v16) := (154));
			var v35: map<int, int> := map[|v13| := v16];
			v34[756] := v35;
			v34[756] := v35;
			globalState.f22 := f28;
			var v36: seq<bool> := [f28];
			globalState.f1 := v36[|(v36 + v36)[v16 := f28]|];
		}
		
		var v37: array<int> := new int[13](i4 => i4 - -558);
		var v38 := 919;
		v37[580] := if (f28) then v38 else v38;
		v37[580] := v38;
		var v39: multiset<int> := multiset{v38};
		var v40: seq<map<int, int>> := [map[208 := 0x257], map[v37[580] := v38]];
		for i5 := if (v38 in v39) then v39[v38] else |v40| to v37[580] {
			var v41 := "ktfrc";
			globalState.f8 := v41;
			var v42 := 'h';
			...
			var v46: map<int, int> := map[v37[580] := v38];
			v43 := fm18(i5, |v44|, fm0(!f28, fm0(f28, v38, i5, map[|v39| := v37[580]], globalState), v45[-0x16f], v46, globalState), globalState);
			r1 := -v38;
			var v47, v48 := m0(i5, globalState);
		}
		var v49 := 'y';
		v49 := v49;
		for i6 := v38 to v37[580] {
			var v50: map<string, char> := map["elrmemmaq" := v49];
			globalState.f11 := (seq(0x241, i7  => ('s'))) in v50;
			var v51: map<int, int> := map[|"r"| := v38];
			var v52: array<char> := new char[24];
			var v53: map<int, array<char>> := map[|v51| := v52];
			var v54: map<array<char>, bool> := map[if (f28) then if (v37[580] in v53) then v53[v37[580]] else v52 else v52 := f28];
			v54 := v54[v52 := f28];
			var v55 := "ohelh";
			globalState.f16 := v37[580] + |multiset{|v55|}|;
			var v56: array<bool> := new bool[24];
			v56[71] := f28;
			var v57: seq<int> := [-v37[580]];
			v56[71] := if (true) then i6 <= -|v57| else DC15(v55, f28, f28, f28).cf29;
		}
		r0 := f28;
		r1 := v38 * (v38 - 0x16a);
		var v58: seq<int> := [-v37[580], 0x3e, -v38, 0x55, v37[580]];
		var v59: seq<bool> := [f28];
		var v60: seq<char> := [v49];
		var v61: map<int, int> := map[|v60| := v58[v37[580]]];
		r2 := if (f28) then |v58| * fm0(v59[|[f28]|], v37[580], v37[580], v61, globalState) else v37[580];
	}
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		if (f28) {
			...
			var v3: multiset<multiset<bool>> := multiset{v0, (multiset(v2[p3]))[p0 := fm0(f28, p3, p3, p1, globalState)] + v0, v0, v0};
			var v4 := DC16(multiset{v0, v0});
			v3 := (v4.(cf32 := v3)).cf32;
			var v5 := 'j';
			v5 := v5;
			var v6: array<int> := new int[12](i0 => i0 % 854);
			var v7: multiset<array<int>> := multiset{v6};
			v7 := (v7[v6 := p3])[v6 := p3];
			globalState.f21 := p3;
			var v8 := "epassrta";
			var v9 := DC15(v8, f28, p0, f28);
			match (if (f28) then DC15(v8[p3 := v5], p0, p0, f28) else v9) {
				case DC13(cf25, cf26) =>
					globalState.f21 := fm0(p0, p3, cf25, p1, globalState) / 0x29c;
					v5 := v5;
					...
					globalState.f22 := !(v5 !in (if (p0) then v13[v5 := cf25] else v13));
				case DC14(cf27) =>
					globalState.f21 := p3;
					globalState.f16 := p3;
					var v14: map<bool, int> := map[!p0 := p3];
					var v15 := new C4(|v14| < fm0(!f28, 0x3d8, p3, p1, globalState));
					var v16: array<bool> := new bool[5](i1 => if (true) then v1[p3] else f28);
					v16[430] := p0;
					var v17: set<map<int, int>> := {p1};
					var v18 := DC45(v17);
					v16[430], r1, globalState.f16, v18, globalState.f16 := !cf27, v0, (|"fr"| * p3) * |v8|, v18, p3;
				case DC15(cf28, cf29, cf30, cf31) =>
					cf31 := cf30 <==> cf31;
					var v19: set<int> := {p3};
					...
					v6[290] := --p3;
					v6[290] := p3;
					var v20: seq<int> := [(fm62(563, cf29, p0, globalState)).cf89, fm0(cf31, v6[290], p3, p1, globalState) + 0x16d];
					globalState.f21 := v20[v6[290]];
				case DC12(cf24) =>
					var v21: array<bool> := new bool[26](i2 => f28);
					v21[925] := p0;
					v21[925], v1 := f28, fm40(map[v1 := p0], p0, globalState);
					var v22 := new C1(p3, |v8|);
					var v23: T0 := new C4(v21[925]);
			...
			var v30: map<int, int> := map[p3 := |v29| / |p1|];
			...
			var v41 := "g";
			var v42 := DC35(f28, p0, p0, v34[822], p3);
			var v43: map<bool, int> := map[|[v41, v41]| != v35.f43 := v42.cf62];
			v40, v43, v34[822], v26, v27 := v40 + v40, v43, v34[822], v26, set v44 : int | (0x350 <= v44) && (v44 < 734) :: (v44 % v34[822]);
			globalState.f22 := p0;
		}
		
		var v45: seq<bool> := [p0];
		var v47: map<seq<int>, bool> := map[seq(-0x249, i3  => (p3)) := f28];
		...
		globalState.f21, v45, globalState.f1, globalState.f22, globalState.f21 := (p3 % |(map v46 : seq<int> | v46 in v47 :: (v46) := (p3))|) - (p3 * p3), v45, !(if (if (f28 in v48) then v48[f28] else p0) then v52 >= v52 else p0), !false, |(multiset{p0})[false := p3]| - (p3 * -0x78);
		...
		var v70 := new C3(|v45|, if (v45[|v69|]) then p0 else !p0);
		...
		r1 := match if (fm3(p3, v70.f43, fm63(p0, |v72|, p3, f28, globalState), f28, globalState)) then v73 else v73 {
			case DC13(cf25, cf26) => (multiset{p0})[f28 := p3]
			case DC14(cf27) => multiset{f28, p0} * multiset{f28, p0, v45[v70.f43], f28, cf27}
			case DC15(cf28, cf29, cf30, cf31) => multiset{cf31, cf29} - multiset{p0, cf31}
			case DC12(cf24) => multiset([p0, f28, p0, f28] + v45[p3 := f28])
		};
		r2 := p0;
	}
	method m17(p0: int, globalState: GlobalState) returns (r0: array<bool>, r1: int, r2: int, r3: array<bool>) {
		...
		if ((v0 - v0) >= v0) {
			...
			if (f28) {
				...
				globalState.f22 := (v6.f44 - |(map v12 : int | v12 in v5 :: (v12 * v6.f44) := (map[|v0| := DC2(v3[v6.f44 := 'n'])]))|) !in v13;
				var v14: array<int> := new int[29](i1 => i1 % 535);
				v14 := v14;
			}
			
			var v15: seq<bool> := [false, f28];
			globalState.f11 := fm1(v15[p0], v6.f44, globalState);
			...
			match (v16) {
				...
				case DC34() =>
					...
					var v20: seq<string> := ["pclyqwxfa", v3, seq(0x88, i3  => (v1)), seq(452, i4  => (v1))];
					var v21: multiset<bool> := multiset{false};
					var v22: array<string> := new string[21] [v3, v3, v3, v3, v3, v3, v3 + v3, v3 + v3, "l" + v3, (seq(731, i2  => (v1))) + v3, fm37(f28, -v6.f44, v19, globalState), "taraggm", v3[|v3| := v1], v3[v6.f44 := v1] + v3, v20[v6.f44], v3 + v3, v3, "qrq", "dyp", if (f28) then v3[|v21| := v1] else v3, seq(0x340, i5  => ('v'))];
					v22[420] := v3;
					v22[420] := v3 + v3;
					...
					var v25: multiset<int> := multiset{v6.f44, v24[v6.f44], |(if (f28) then "ylj" else v22[420])|, v6.f44, v6.f44};
					v25 := v25;
					globalState.f16 := |v25|;
				case DC35(cf59, cf60, cf61, cf62, cf63) =>
					...
					var v29: seq<seq<int>> := [v27, v28[-cf63]];
					var v30: map<bool, bool> := map[cf59 := cf61];
					cf62, v26[338], v29, cf63 := p0 + cf62, (cf63 + |v30|) % (cf63 * |v3|), v28[cf62 := v27], cf62;
					...
					var v36: seq<C3> := [v35];
					var v37: seq<C3> := [v36[0x54]];
					var v38: array<C3> := new C3[28] [v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v37[|v3|], v35, v35, v35, v35, v35];
					v38[166] := v35;
					v31[60], globalState.f8, v34[483], v38[166], r1 := v32, v3, v33, v35, v26[338];
			...
			var v48: seq<int> := [|(seq(0x2, i8  => (v42)))|, if (|([f28, f28])[|v46| := f28]| in v45) then v45[|([f28, f28])[|v46| := f28]|] else p0, -|v47|, v44.f43, v44.f43];
			...
			v49[119] := v53 > v53;
			if (multiset([v49[119], v49[119], v49[119], v49[119]]) > v51) {
				var v55: map<int, int> := map[p0 := p0];
				var v56: map<map<int, int>, int> := map[v55 := -0x377];
				r2 := |(map v54 : map<int, int> | v54 in v56 :: (v54) := (DC39(v42, v49[119], -|map[f28 := DC21(v49[119])]|, f28, v44.f43).cf76))| * (p0 % v44.f43);
				globalState.f16 := p0 * (p0 / v44.f43);
				...
				var v63: array<map<bool, bool>> := new map<bool, bool>[20] [v60[f28 := v49[119]], v60, v60, v60, v60, v60[true := v49[119]], map[!v49[119] := false] + v60, if (-v44.f43 in v61) then v61[-v44.f43] else v60, v60, v60 + map[f28 := false], (fm54(v49[119], globalState))[f28 := v49[119]], v60, v60 + (if (v49[119] in v62) then v62[v49[119]] else v60), if (true) then map[v49[119] := v49[119]] else v60, v60 + v60, v60, v60, v60[v49[119] := v49[119]], v60, map[v49[119] := f28]];
				var v64: array<seq<D12>> := new seq<D12>[14](i9 => [DC34()]);
				var v65 := DC34();
				var v66: seq<D12> := [v65];
				v64[58] := v66;
				v46, globalState.f16, v63, v64[58] := v46, v44.f43, v63, v66 + v66[v44.f43 := DC34()];
				v55 := v55[p0 := v44.f43];
			} else {
				var v67: seq<string> := [v43, v43];
				var v68: seq<multiset<int>> := [multiset{p0} + v45, v45, multiset{0x1a2}, v45 + v45, multiset(v48)];
				v49[119], v49[119], v45 := !(v67 < v67), !true, v68[v44.f43];
				var v69: array<int> := new int[9];
				v49[119], globalState.f1, v69, globalState.f21 := v49[119], f28, v69, v44.f43 * 0x12d;
				globalState.f16 := if (v49[119]) then -v44.f43 else v44.f43;
				v69[793] := -v44.f43;
				v69[793] := p0;
				var v70 := new C1(|map[v49[119] := p0]| + v69[793], v69[793]);
			}
			
			var v71: array<int> := new int[27];
			var v72: map<bool, bool> := map[v49[119] := f28];
			var v74: map<array<int>, int> := map[v71 := |v72| + |(map v73 : char | v73 in (seq(0x4a, i10  => (v42))) :: (v73) := (v49[119]))|];
			v74 := v74[v71 := p0];
			var v75: map<char, int> := map[v42 := p0];
			globalState.f16 := v44.fm23(|v75|, v49[119], globalState);
		}
		...
		var v78 := 'u';
		var i12 := 0;
		while ((seq(726, i13  => ('c')))[|v77| := v78] <= v77)
			decreases 100 - i12
		{
			if (i12 >= 100) {
				break;
			...
			var v82 := DC38(18, |(seq(44, i14  => (v78)))|, v81);
			...
			match (v82.(cf69 := p0 + |v83|, cf71 := v81)) {
				case DC37(cf65, cf66, cf67, cf68) =>
					...
					v90[284] := p0;
					v90[284] := -(if (f28) then cf66 else v80.f46);
				case DC38(cf69, cf70, cf71) =>
					v76 := v76;
					v80 := v80;
				...
				case DC39(cf72, cf73, cf74, cf75, cf76) =>
					...
					v76[865], r3, v92[623] := v95[cf74 - v80.f45], v76, (v94[v80.f46 := |v99|] + fm42(v100, p0, v101, v80.f46, globalState))[if (cf73) then cf76 else -v80.f46 := v80.f45];
					v76[865] := v76[865];
					var v102 := new C4(!(v80.f45 <= |v77|));
					var v103: map<bool, bool> := map[f28 := cf73];
					cf72, globalState.f16, globalState.f16 := 'a', cf74 + |v95|, v80.fm27((seq(550, i17  => (cf72))) + v77, {v103, map[false := cf73]}, globalState);
				case DC36(cf64) =>
					var v104: map<bool, bool> := map[f28 := true];
					globalState.f1, globalState.f16 := !(f28 || f28), v80.f46 / (v80.f46 * |v104|);
		...
		if (f28) {
			...
			v115[44] := seq(0x24, i18  => (p0));
			var v116: array<multiset<int>> := new multiset<int>[20](i19 => multiset(seq(329, i20  => (p0))));
			var v117: seq<array<multiset<int>>> := [v116, v116];
			var v118 := DC49(v116);
			var v119: array<array<multiset<int>>> := new array<multiset<int>>[27] [v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v116, v117[p0], v116, v116, v116, v116, v116, v118.cf95, v116, v116, v116, v116, v116];
			v119[284] := v116;
			...
			r2, globalState.f16, v115[44], v119[284] := p0, |(v77 + (if (f28) then "pfwfavj" else "vi"))|, v122, if (false) then v116 else v116;
			...
			v76[823] := fm3(-|"umfuhyyoi"|, p0, v126, f28, globalState);
			v76[823] := f28;
			var v127: map<bool, bool> := map[true := f28];
			globalState.f11 := if (f28 in v127) then v127[f28] else v76[823];
		} else {
			var v128: array<int> := new int[4];
			v128[907] := fm0(false, p0, p0, (map v129 : int | (0xd0 <= v129) && (v129 < 0x8a) :: (v129 % -|[f28, f28]|) := (p0))[p0 := p0], globalState);
			var v130: map<int, int> := map[|v77| := p0];
			v128[907] := fm0(f28, p0, p0, v130 + v130, globalState);
			globalState.f16 := -v128[907];
			v128[907] := p0 * v128[907];
			if (f28) {
				var v131: seq<array<bool>> := [v76, v76, v76];
				var v132: map<int, bool> := map[v128[907] := f28];
				var v133: array<array<bool>> := new array<bool>[25] [v76, v76, v76, v76, v76, v76, v76, v131[|v132|], v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76, v76];
				v133[91] := v76;
				v133[91] := v76;
				...
				var v135 := DC25(v133);
				v135 := v135;
				globalState.f21 := -fm0(f28, v128[907], |(seq(0x324, i21  => (v78)))|, v130, globalState);
				var v136: map<bool, bool> := map[true := f28];
				var v137: set<bool> := {f28, if (f28 in v136) then v136[f28] else f28};
				globalState.f11 := v77 != (if (f28) then fm37(f28, v128[907], v137, globalState) else v77);
			} else {
				var v138: C3 := new C3(p0, f28);
				var v139: map<char, int> := map[v78 := p0];
				var v140: multiset<int> := multiset{p0 + |v77|, if (v78 in v139) then v139[v78] else v128[907], v128[907] / v138.f43, -v138.f43};
				var v141: C2 := new C2(-628);
				var v142: seq<int> := [p0];
				v138, v140, v141, globalState.f16, v140 := v138, v140, v141, -|v142| / v128[907], v140[-|v77| := fm0(f28, |fm65(globalState)|, v141.f44, v130, globalState)];
				globalState.f11 := f28;
				var v143: set<multiset<bool>> := {multiset{f28, false}};
				var v144: map<bool, char> := map[f28 := v78];
				globalState.f11, v78, globalState.f1, v76, v78 := if (-|v143| != v128[907]) then -470 > -v138.f43 else !false, v78, !(v144 == v144), v76, v78;
				v128[907] := -v141.f44;
				globalState.f11 := f28;
			}
		...
		v76[194] := f28;
		var v145 := DC15(seq(-89, i22  => (v78)), f28 <== true, !f28, f28);
		var v146 := DC43(p0, p0, |v77|, p0, p0);
		v76[194], r1, v145, r2, globalState.f11 := true, p0, DC15(seq(0x8a, i23  => (v77[p0])), f28, f28, f28).(cf30 := f28), v146.cf87, f28;
		r0 := v76;
		var v147: multiset<bool> := multiset{v76[194]};
		var v148: seq<int> := [-|v147|, p0];
		var v149: multiset<int> := multiset{p0, p0};
		var v150: seq<int> := [v148[|v149|], p0, p0];
		var v151: map<bool, bool> := map[f28 := v76[194]];
		var v152: map<seq<int>, map<bool, bool>> := map[v148 := v151 + v151];
		r1 := |v152|;
		r2 := -(p0 / 596);
		r3 := if (v76[194]) then v76 else v76;
	}
}
...
class C7 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		for i1 := v1 to v1 {
			...
			var v12: seq<string> := [v9, seq(0x51, i2  => (v7)), v9, v9];
			v10 := v10[|(v11 - v11)| := v12[i1]];
			var v13: map<int, int> := map[v1 := |map[f28 := v6[903]]|];
			...
			var v17: seq<int> := [i1];
			r1 := if (!true) then |v15| % |v16| else |v17|;
		}
		v1 := v1;
		var v18: seq<int> := [v1];
		r0 := v18 != v18;
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			match (DC9(v2)) {
				...
				case DC8() =>
					...
					var v14: array<char> := new char[14] [v0, v0, v0, v12[fm0(true, p3, p3, p1, globalState)], v0, v0, v0, 'd', v13.cf82, v0, 'w', fm34(seq(0x3db, i1  => ('l')), "nusvnvt", p3, globalState), if (false) then 'j' else v0, v0];
					v14[209] := v0;
					var v15: set<bool> := {f42, f28, f28};
					var v16 := DC39(v0, f28, p3, p0, p3);
					globalState.f22, globalState.f22, globalState.f22, v14[209] := fm1(!f42, -|v15|, globalState), f42, f42, v16.cf72;
					globalState.f11 := false;
				case DC6(cf15) =>
					var v17 := new C0(f28);
					var v18: set<char> := {v0};
					...
					var v24 := m15(DC11(v18, v21, p3).(cf22 := seq(837, i2  => (v20))), !(p0 <== f28), v23, globalState);
		...
		match (v33.(cf5 := v32 + v32)) {
			...
			case DC2(cf5) =>
				...
				if (v52 !! {seq(0x327, i3  => (v50)), v51}) {
					var v53: seq<map<int, int>> := [map[p3 := |cf5|]];
					var v54: multiset<int> := multiset{p3, |v53[p3]|};
					...
					v59, globalState.f11, v60[319] := v59 + v59, if (v61 in v62) then v62[v61] else true, v46;
					var v63 := DC14(p0);
					var v64: seq<bool> := [v63.cf27];
					var v65: array<bool> := new bool[20] [v64[p3], f42, f28, v58, f41, f42, v58, f28, !!f28, f42, f41, v58, v58, v56, !v56, v56, v56, v56, f41, false];
					...
					v75[938] := 0x322;
					v75[938] := p3;
					globalState.f21 := |v39[p3 := v75[938]]| * |v76|;
				}
		...
		r0 := p3;
		var v78: array<int> := new int[23](i6 => i6 / p3);
		...
		if (!true) {
			...
			v84[638] := p3 > 0x7b;
			var v85: seq<seq<int>> := [v83 + v83, seq(990, i8  => (-470)), seq(-828, i9  => (p3)), [p3] + v83, [p3, p3, p3, 0x241, p3]];
			var v86: map<int, bool> := map[p3 := !f28];
			var v87 := DC13(p3, f41);
			v81[177], v84[638] := v85[p3], if (v87.cf25 in v86) then v86[v87.cf25] else f28;
			if ((p3 - p3) == p3) {
				var v88: seq<array<int>> := [v78, v78];
				var v89: map<array<int>, map<int, bool>> := map[v88[p3] := v86];
				v89 := v89[v78 := v86];
				globalState.f16 := -p3;
				...
				var v93: multiset<bool> := multiset{f28, fm1(false, |v32|, globalState), v84[638], f41};
				...
				var v98: set<bool> := {v84[638]};
				var v99: map<int, set<bool>> := map[p3 := v98];
				var v100: multiset<string> := multiset{fm37(v84[638], p3, if (p3 in v99) then v99[p3] else v98, globalState) + v32, fm37(v84[638], 68, v98, globalState)};
				v84[638], r0, v95, v97, v100 := v83 <= v83, p3, v95, v97, v100;
				...
				var v107: multiset<int> := multiset{|[p3, |map[p3 := v84[638]]|]|};
				v106 := if (multiset(seq(0x3cb, i10  => (p3))) > v107) then v106 else v106;
			...
			v110[986] := if (f42 in v111) then v111[f42] else p0;
			v78[596] := p3;
		}
	...
	method m15(p0: D4, p1: bool, p2: array<bool>, globalState: GlobalState) returns (r0: D3) {
		...
		var v5 := 0x36f;
		var v6: seq<multiset<bool>> := [v4[|multiset{v5, v5}|]];
		v2, v3, p2[258] := (if (p1) then v2 else set v7 : multiset<bool> | v7 in v4 :: (v7)) - v2, (v3 - v3) - v3, f28;
		var v8: array<int> := new int[8](i0 => i0 % 0x307);
		...
		match (v10) {
			case DC26(cf45, cf46, cf47) =>
				...
				if (!((v11 >= {-v5}) <==> f41)) {
					globalState.f16 := (cf45 * |(seq(-902, i1  => ('y')))|) * cf45;
					...
					v20 := v20[p2[258] := fm0(f42, 530, -|v21|, v25, globalState)];
			...
			case DC25(cf44) =>
				...
				var v34: array<multiset<int>> := new multiset<int>[20] [v29, multiset{if (v5 in v31) then v31[v5] else v5, v5}, v29, multiset{if (false in v0) then v0[false] else v5, 958}, v29, v29, v32[|v1|], v29, v29, multiset{v5}, fm66(globalState), v29, v29, v29, multiset{v5}, v29, v29, v29, multiset(v33), multiset(v33)];
				var v35 := DC49(v34);
				v35 := v35;
				var v36 := 't';
				...
				match (fm30(|v38|, globalState)) {
					case DC1(cf1, cf2, cf3, cf4) =>
						...
						var v50: array<bool> := new bool[17] [DC22(v1).cf38 <= v1, cf4, p2[258], multiset(v33) > v29, f28, !fm1(cf4, if (v43 in v44) then v44[v43] else -cf2, globalState), f41, f42, if (|v46| in v45) then v45[|v46|] else p1, f42, cf4, p1, p1, v42.f44 in v47, f28, p2[258], v49 !! v49];
						var v51: map<char, int> := map[cf3 := v42.f44];
						cf2, v50, p2[258] := v42.f44, v50, fm3(v5 * v42.f44, v42.f44 % cf2, {map['i' := v5], v51}, false, globalState);
					case DC0(cf0) =>
						var v52: map<bool, bool> := map[f41 := !f42];
						var v53: seq<map<bool, bool>> := [map[p2[258] := false] + v52];
		...
		if (v57 > v57) {
			...
			v58[722] := map v59 : int | v59 in v60 :: (v59 - |multiset{'x'}|) := (v5);
			...
			v61[571] := {DC12(map[p2 := |v65|]), v63, v63, v63};
			globalState.f16 := v5;
		} else {
			var v66: set<bool> := {p1, f42};
			v66 := v66;
			var v67: map<int, int> := map[v5 := v5];
			globalState.f16 := |[f41, f28, f41]| % (v5 / fm0(p2[258], v5, v5, v67, globalState));
			var v68 := "hpncv";
		...
		globalState.f16 := (if (p2[258]) then v79 else fm69(v5, p2[258], globalState)).cf70;
		var v80: array<string> := new seq<char>[17](i4 => (seq(0x42, i5  => ('c'))) + "yf");
	...
	method m16(p0: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: array<int>, r3: bool) {
		...
		if ((multiset{f41})[true := v10[p0]] != v11) {
			...
			if (p0 != p0) {
				...
				v19 := v19[f42 := p0];
				var v20: map<string, bool> := map[DC33(|v19|, seq(0x209, i1  => (v0)), v0).cf57 := f28];
				var v21 := "ugtqxorvf";
				v20 := v20[v21 := f28];
				globalState.f22 := f28;
				globalState.f16 := p0;
			...
			v25[300] := f28;
			v25[300] := if (!f28) then !f42 else p0 >= p0;
			globalState.f16 := p0 % p0;
		}
		...
		if (map[v27 := p0] in {v28}) {
			...
			var v37 := "pxk";
			globalState.f10 := map[p0 := p0] + (map v35 : int | v35 in (map v36 : int | v36 in multiset(v10) :: (v36 % p0) := (-0xab)) :: (v35 + |[f42, f28, f41, !true, f42]|) := (p0))[|v37| := p0];
			...
			v38[210] := fm3(p0, -|v40|, v42, !f28, globalState);
			v38[210] := f42;
			...
			v44[638] := v45;
			v38[210], v43, globalState.f22, v44[638] := fm1(v11 > v11, p0, globalState), v43, v9 >= (v9 * v9), v45;
			if (f41) {
				var v46: seq<multiset<bool>> := [v11, multiset{v38[210], f41}, fm32(f28, v0, f28, p0, globalState)];
				globalState.f22 := v38[210] || (v11 >= v46[p0]);
				var v47 := DC1(-708, p0, v0, !f28);
				var v48: seq<set<int>> := [{v47.cf2} * v1, fm17(p0, p0, v37, p0, globalState), v1, v1, v1];
				globalState.f16, v1 := -p0, v48[p0];
				v9 := v9;
				v38[210] := f28;
				var v49: array<int> := new int[21](i3 => i3 + |v37|);
				var v50: seq<array<int>> := [v49];
				var v51: array<array<int>> := new array<int>[13] [v49, v49, v49, v50[p0], v49, v49, v49, v49, v49, v49, v49, v49, v49];
				v51 := new array<int>[9];
			} else {
				var v52: map<bool, string> := map[f42 := v37[-p0 := v0]];
				var v53: seq<string> := [seq(0x173, i8  => (v0)), v37];
				var v54: array<string> := new string[18] [v37, v37 + (seq(-0x170, i4  => (v0))), "dajiovbl", v37, v37, seq(0xaa, i5  => (v0)), if (true) then v37 else v37, v37, v37 + v37, v37, v45.fm31(p0, f41, f41, globalState), (seq(0x2c2, i6  => (v0))) + v37, v37[p0 := v0] + v37, v37, "a", seq(0x398, i7  => (v0)), "agij", "si" + (if (f42 in v52) then v52[f42] else v53[p0])];
				v54[225] := v37;
				v54[225] := v37 + v37;
				r3 := v38[210];
				globalState.f1 := fm1(f41, v10[p0], globalState);
				globalState.f21 := -p0;
				var v55: array<int> := new int[20](i9 => i9 / p0);
				v55[289] := -p0;
				globalState.f21, globalState.f11, v55[289], globalState.f21 := p0, f28, p0, p0 % -|[p0]|;
			}
			
			var v56: map<int, bool> := map[|v10| := f28];
			var v57: seq<map<int, bool>> := [v56];
			var v59: multiset<int> := multiset{p0};
			var v60 := DC42(map v58 : int | v58 in v59 :: (v58 / p0) := (v37));
			var v61: map<D15, bool> := map[v60 := f42];
			var v62: seq<bool> := [f41, if (v60 in v61) then v61[v60] else f28];
			var v63 := DC22(v62);
			var v64: set<map<int, bool>> := {v56, v56, v57[|v63.cf38|], v56};
			...
			if ((set v65 : map<int, bool> | v65 in v64 :: (v65)) > (if (v38 in v66) then v66[v38] else v64)) {
				...
				var v69: array<int> := new int[11] [-p0 % |map[-|"iksv"| := v38[210]]|, p0 / p0, |multiset{v67}|, p0, |v37|, p0, p0, p0 - p0, fm0(f42, p0, p0, fm41(p0, false, f42, globalState), globalState), |fm47(f28, |(set v68 : int | v68 in v56 :: (v68 % |[false]|))|, globalState)|, p0 % p0];
				v69[915] := 532;
				v69[915] := p0 * 0x11e;
				var v70: map<multiset<bool>, bool> := map[v11 := f41];
				var v71: map<map<multiset<bool>, bool>, int> := map[v70 := p0];
				v71 := v71[v70 := if (f42) then v69[915] else p0];
				var v72: T0 := new C4(f28);
				v72, globalState.f21 := v72, v69[915];
				var v73: map<char, char> := map[v0 := v37[647]];
				v73 := v73[v0 := v0];
				var v75 := new C3(p0 / |(map v74 : int | (602 <= v74) && (v74 < 25) :: (v74 + p0) := (f41))|, f28);
			} else {
				var v76: map<char, seq<int>> := map[v0 := v10];
				var v77: map<seq<int>, bool> := map[(if (v0 in v76) then v76[v0] else v10)[|v10| := p0] + v10 := f41];
				globalState.f16 := |v77|;
				var v78: array<int> := new int[1](i10 => i10 * |v10|);
				v78[210] := p0;
				var v79: map<array<bool>, bool> := map[v38 := v38[210]];
				var v80: map<int, int> := map[|v37| := |v79|];
				v78[210] := if (0x2e7 in v80) then v80[0x2e7] else p0;
				globalState.f21 := p0;
				v78[210] := -p0;
				v10 := (if (false) then v10 else seq(0x31, i11  => (v78[210]))) + v10;
			}
			
		}
		
		var v81: map<bool, seq<int>> := map[f42 := seq(0x34f, i12  => (v10[-p0]))];
		var v82: map<int, bool> := map[p0 := f41];
		var v83 := DC38(|(if (f41 in v81) then v81[f41] else v10)|, 0x387, v82);
		match (v83) {
			case DC37(cf65, cf66, cf67, cf68) =>
				var v84 := "qw";
				v0 := fm34(v84 + v84, seq(-0x95, i13  => (v0)), |v11| / cf68, globalState);
				var v85 := new C0(f42);
			...
			case DC38(cf69, cf70, cf71) =>
				...
				v94[393], v0 := (multiset(v10) + v95) !! v95, v97.cf72;
				...
				if (v102) {
					cf70 := cf69;
					v94[393] := f28;
					var v104: seq<bool> := [f42, v94[393], f41];
					...
					var v109: array<int> := new int[23] [cf70, cf69, cf70, |fm40(v106, v102, globalState)|, p0, fm0(!v94[393], 0x35c, cf69, v96, globalState), cf69, |v105|, p0, |v107|, |{v0, v0, v0}|, fm0(v94[393], cf70, p0, v96, globalState), fm0(true, p0, cf70, map v108 : int | v108 in v10 :: (v108 * |v107|) := (cf69), globalState), |v107|, cf69, cf69, cf69, p0, cf70, |v107|, cf70, |v82|, cf69];
					var v110: map<bool, array<int>> := map[f28 := v109];
					v110 := v110;
					v109[357] := p0;
					v109[357] := p0 % cf70;
					globalState.f11 := f41;
					v103[396] := multiset(v10 + v10);
					v103[396] := v95[|v9| := if (v94[393]) then cf70 else v109[357]];
					v94, v109[357] := v94, -(if (v105[|v107|] <==> fm1(f41, 0x183, globalState)) then cf69 else v109[357] * v109[357]);
				}
			...
			case DC36(cf64) =>
				...
				match (v118.(cf5 := v117)) {
					case DC3(cf6, cf7, cf8) =>
						...
						var v120: multiset<int> := multiset{|map[fm34(v117, v117, v114[668], globalState) := v114[668]]|, cf7};
						...
						var v124: multiset<map<bool, bool>> := multiset{fm54(f41, globalState), if ([v114[668]] in v123) then v123[[v114[668]]] else v122};
						...
						v125, r1, v114[668], v128 := v125, !(v117 == v117), cf7, v128;
					case DC2(cf5) =>
						v26 := v26;
						v114[668] := v114[668];
						var v129: T0 := new C4(f41);
						var v130: map<T0, int> := map[v129 := p0];
						v130 := v130[v129 := -(v114[668] + 0x2cf)];
						globalState.f21 := p0 - p0;
				}
...
class C8 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		if (f28) {
			...
			var v6 := 'e';
			var v7: set<char> := {v6};
			v4 := v4[if (f28 in v4) then v4[f28] else fm1(f40[v5], v5, globalState) := v5 <= |v7|];
			if (f39) {
				v2[691] := v3;
				v2[691] := v3;
				v2[691][11] := |[f40, f40, f40, f40]|;
				var v8: map<seq<bool>, seq<bool>> := map[f40 := [f28, f39]];
				var v9: map<int, int> := map[v5 := v5];
				var v10 := "dvmldkph";
				globalState.f22, globalState.f22, v2[691][11], v8, globalState.f8 := f39, f39, -|(v4 + fm15(f40[fm0(f28, v5, v5, v9, globalState)], f28, f28, globalState))|, map[f40 + f40 := f40], v10;
				var v11 := new C6(f39);
				var v12: seq<int> := [v5];
				globalState.f1 := f39 ==> !DC23(f28, f39, |v12|, v2[691]).cf39;
				v10 := ((v10 + v10) + v10)[564 := v6];
			} else {
				v3 := v3;
				globalState.f11 := !(if (f28) then f39 else v5 <= v5);
				v4 := v4 + v4;
				globalState.f16 := -361 / (v5 - v5);
			...
			var v18: map<int, int> := map[|(map v17 : int | (0x20f <= v17) && (v17 < 931) :: (v17 % v5) := (v5))| := v5];
		...
		if (!f39) {
			...
			v24 := v24[v22 := v23];
			var v25: seq<map<bool, int>> := [map[f28 := |(seq(0x2b6, i1  => (0x30f)))|]];
			var v26 := new C1(v21, fm0(f39, |[f39]|, v21, map[|v25| := v21], globalState));
			var v27: map<int, int> := map[v21 := -v26.f45];
			var v28: seq<int> := [|v27|];
			globalState.f11 := v20[697][if (|v28| in v27) then v27[|v28|] else v21];
			...
			var v32 := "vfgssf";
			globalState.f22, v31 := f28, fm70([f28], |(seq(-0x1f7, i2  => (272)))|, |v32|, globalState) * v31;
			var v33 := 0x2b0;
			var v34: set<int> := {v33};
			var v35: map<bool, bool> := map[f39 := f28];
			v34 := {v33 * v33, |v35| / |"bjpgqmq"|, v33, v33, v33 * v33};
		...
		var v60: set<char> := {v56, v58[fm0(f39, v53, v53, v59, globalState)]};
		...
		match (v63) {
			case DC11(cf21, cf22, cf23) =>
				...
				v67[953] := v65;
				v64[77], globalState.f1, globalState.f16, v67[953], globalState.f1 := f28, true, cf23, v65, f39;
				v56 := v56;
				var v68: set<map<char, int>> := {map[v56 := cf23]};
				var v69: map<bool, bool> := map[!fm3(v53, v53, v68, v64[77], globalState) := v64[77]];
				var v70: array<int> := new int[17] [|v57|, 0x3ac, |multiset(v61)|, cf23, -0x315, v53, v53, v53, cf23, |v69| + cf23, 0x335, |(v61 + v61)|, if (v64[77]) then v53 else 0x1f3, -(v53 * cf23), -0x36f, v53, cf23];
				v70[4] := cf23;
				v70[4] := |f40|;
				var v71 := new C1(v70[4], v70[4] / v53);
			case DC10(cf20) =>
				var v72 := new C6(f39);
				v56 := v56;
				...
				var v76: array<array<int>> := new array<int>[29] [v73, v73, v73, v73, v73, v73, v73, v73, v74[v53], if (!fm1(f28, v53, globalState) in v75) then v75[!fm1(f28, v53, globalState)] else v73, v73, v73, v73, v73, v73, if (false) then v73 else v73, v73, v73, v73, v73, v73, v73, v73, v73, v73, v73, v73, v73, v73];
				v76[573] := v73;
				v76[573] := v73;
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			if (f28) {
				...
				var v2 := new C2(p3);
				globalState.f16 := -p3;
				var v3: set<bool> := {f39, v0[640], f28};
				v3, globalState.f21 := v3, --(v2.f44 / p3);
				...
				v10[989] := v9;
				var v11 := 'c';
				v8, v10[989], v11 := (v8 + map[v5 := v6])[v5 := v6], v9, v11;
			} else {
				var v12: multiset<bool> := multiset{f28, v0[640]};
				var v13: seq<int> := [p3];
				var v14 := DC3(p3, 528, v13);
				globalState.f16, globalState.f1 := p3 / |v12|, (if (false) then v14.cf8 else v13) == (v13 + [p3, p3]);
				...
				v18[686] := v13;
				var v19 := DC60({v16});
				v15, v16[871], v17, v18[686] := if (|p1| >= p3) then v15 else v15, if (p0 in v15) then v15[p0] else |(v15 + map[f28 := 0xde])|, (v19.(cf121 := v17)).cf121, seq(0x328, i2  => (p3));
				var v20 := 'k';
				var v21: map<char, int> := map[v20 := p3];
				var v22 := DC5(f28, p0, -0x36e, f39, v21);
				var v23: set<bool> := {v0[640]};
				var v24: multiset<string> := multiset{if (v22.cf11) then "nfhrr" else fm37(p0, v16[871], v23, globalState)};
				v24 := v24;
				v0[640] := v0[640];
				var v25 := "g";
				var v26 := DC6(v23);
				var v27: multiset<int> := multiset{v16[871]};
				...
				globalState.f21 := |(v25 + fm37(p0, p3, v26.cf15, globalState))| * (|v30[|v13|]| % 803);
			}
			
			var v31: array<int> := new int[3] [p3 % p3, p3 + p3, p3];
			v31[143] := p3;
			var v32: map<int, multiset<bool>> := map[p3 := multiset([v0[640], f39, f39, v0[640], v0[640]])];
			v31[143] := p3 % |v32|;
			v31[143] := p3;
			globalState.f11 := f40[p3];
		}
		for i3 := p3 to -(|p1| / p3) {
			var v33: array<array<bool>> := new array<bool>[26];
			v33[332] := v0;
			var v34 := "ubsiacniw";
			v33[332] := DC17(v0, v34).cf33;
			...
			var v38: map<int, map<int, bool>> := map[-(560 % p3) := v36[p3 := p0] + v37.cf71];
		...
		var v43 := 'x';
		var v44: multiset<bool> := multiset{v0[640]};
		var v45: seq<seq<bool>> := [f40, f40];
		r1 := fm32((if (p3 in v41) then v41[p3] else |v42|) != p3, v43, v44 >= multiset(v45[p3]), p3, globalState);
		var v46 := "pjwvhfmpd";
		r2 := v46 <= "elxvtobr";
	}
	method m14(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			var v5 := 'm';
			var v6: array<bool> := new bool[15] [p1 !in f40, fm0(f28, |v0|, v2, map[v2 := v2], globalState) < v2, !(f39 in v0), f39, f39, p0, v4[f39 := -0x370] >= v4, p1 && p1, f28, p1, !f28, true, f28, v5 !in "ygxretagm", true];
			v6[264] := f28;
			var v7: array<array<bool>> := new array<bool>[13];
			v7[822] := v6;
			v6[264], globalState.f22, globalState.f22, globalState.f16, v7[822] := f39, f39, false, v2, v6;
			globalState.f16 := --v2;
			var v8 := "entquqktd";
			globalState.f21 := v2 % |v8|;
			var v9: map<bool, bool> := map[v6[264] := p0 && f28];
			v9 := (v9 + v9) + v9;
		}
		var i1 := 0;
		while (f39)
			decreases 100 - i1
		{
			...
			var v12 := "dmkg";
			var v13 := 'k';
			var v15: multiset<int> := multiset{|(if (|v12[v2 := v13]| in v11) then v11[|v12[v2 := v13]|] else map v14 : int | (0xa8 <= v14) && (v14 < 0x1f2) :: (v14 - v2) := (f28))|, v2};
			...
			v16[822] := if ((v18 + v18) in v19) then v19[v18 + v18] else p0;
			globalState.f1 := if (!f39) then if (true) then p0 else p0 else f28;
			globalState.f16, f40 := v2, f40;
		}
		globalState.f22 := p1;
		var v20: seq<int> := [200];
		var v21 := DC3(v2, 0x154, v20[v2 := |f40|]);
		var v22: seq<D1> := [DC3(v2, v2, v20), v21];
		var v23: seq<seq<D1>> := [v22, seq(0x6b, i2  => (v21)), v22, v22, seq(0x25d, i3  => (v21))];
		v23 := (if (p0) then [v22] else v23)[-v2 - |fm60(globalState)| := v22];
		var v24: array<int> := new int[9];
		v24[485] := v2;
		var v25: map<int, int> := map[|v0| := v2];
		v24[485] := 0x78 - (--v2 - fm0(p1, -0x15d, v2, v25, globalState));
		r0 := f39;
	}
}
...
class C9 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (f38) {
			...
			if (f38) {
				...
				var v8: seq<bool> := [f28];
				v7[843] := v8[v0 / v0];
				var v9 := new C3(v0 * v0, fm14(!f28, v7[843], globalState));
			...
			var v19: multiset<int> := multiset{v18[168], 0x3ca};
			if ((v19[v18[168] := v0] - v19) > multiset{-230}) {
				var v20 := DC21(f38);
				...
				var v25 := 'n';
				var v26: map<int, char> := map[v18[168] := v25];
				var v27: set<set<bool>> := {v24[-|v26|]};
				var v28 := DC29(!f38);
				...
				v40[671] := (v27 - (set v42 : set<bool> | v42 in v41 :: (v42))) - {v23, v23};
				var v43: seq<bool> := [true, !f38];
				var v44 := DC3(|v34|, |v43|, [v35[v0]]);
				v44 := v44;
				globalState.f16 := (v0 % |v34[|v23| := v25]|) * v18[168];
			} else {
				globalState.f16 := v0 % v18[168];
				globalState.f11 := f38;
				globalState.f22 := f38;
				var v45: array<multiset<bool>> := new multiset<bool>[1];
				var v46: multiset<bool> := multiset{f28};
				v45[235] := v46;
				v45[235], globalState.f1 := v46, !!f38;
				globalState.f1 := fm1(v18[168] == -0x30c, v18[168], globalState);
			}
			...
			if (v50 == v51[v0]) {
				...
				v57, v49, globalState.f16 := fm74(!f28, globalState), if ((seq(108, i3  => (v53))) in v58) then v58[seq(108, i3  => (v53))] else v49, fm0(f38, |v59|, -v0, v59, globalState);
			} else {
				...
				var v65: map<array<bool>, array<int>> := map[v63 := v64[v0]];
				...
				v49[435] := if (f38) then 0x301 else v0;
				var v67: map<int, int> := map[v0 := -0x190];
				v49[435] := if (fm0(f38, |v48|, v0, map[-|f37| := v0], globalState) >= -0x288) then v0 else |(v67 + (map v68 : int | v68 in v61 :: (v68 % |map[f38 := f38]|) := (v0)))|;
			...
			v74[106] := v71 + map[v0 := false];
			v74[106] := v71 + v71[v0 := f28];
		}
			...
			decreases 100 - i4
		{
			...
			v76[506] := if (f28 in v78) then v78[f28] else v77;
			var v79: array<seq<seq<int>>> := new seq<seq<int>>[7];
			var v80: seq<int> := [|[v0, v0, v0, v0, v0]|, v0, v0];
			var v81 := "bjro";
			var v82: seq<seq<int>> := [v80, [|v81[v0 := fm34(v81, v81, v0, globalState)]|, v0], v80];
			v79[622] := v82;
			var v83: array<array<array<bool>>> := new array<array<bool>>[11];
			var v84: array<array<bool>> := new array<bool>[18];
			v83[834] := v84;
			var v85: set<bool> := {f28};
			v76[506], globalState.f16, v79[622], v83[834], r0 := v77, |v85|, v82 + v82, v84, f28;
			if (f28) {
				globalState.f11 := f38;
				var v86 := 'k';
				var v87: seq<string> := [v81 + fm37(f28, v0, {f38}, globalState), v81[v0 := v86]];
				globalState.f11, v75, globalState.f8, globalState.f1 := f38, v75 + v75, v87[v0], f38;
				var v88, v89 := m13(globalState);
				var v90: array<int> := new int[10] [-v0, v0, v0 * v0, fm0(f28, v0, v0, map[v0 := v0], globalState) / |v81|, v0, -v0, |map[v0 := multiset(v80)]|, v0, v0, v0];
				v90[413] := v0;
				v90[413] := v0 / v0;
				r1 := v0;
			} else {
				...
				v95 := if (fm1(v93[327], 123, globalState)) then v95 else v95[f38 := v0];
				var v96: map<int, bool> := map[v0 := !!(if (f28) then v93[327] else !f38)];
				v96 := v96;
			}
			...
			var v101: map<map<bool, int>, int> := map[v98 := fm0(f28, -v0, |(v81[|v75| := v99])[-0x2e7 := 't']|, v100, globalState)];
			var v102: map<bool, multiset<int>> := map[f38 := v97[|(seq(0x1d5, i6  => ('s')))| := if (v98 in v101) then v101[v98] else v0]];
			v102 := v102;
			globalState.f22 := f38;
		}
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		if (v0 <= v0) {
			...
			v4 := v4;
			globalState.f16 := -(|v1| % -p3);
			globalState.f16 := (p3 / p3) / p3;
		} else {
			r0 := p3;
			var v5: map<bool, int> := map[f38 := p3];
			var v6: seq<int> := [(if (f28 in v5) then v5[f28] else p3) % p3, p3 / fm0(f38, p3, p3, p1, globalState)];
			v6 := v6 + (v6 + [p3, v6[p3]]);
		...
		for i1 := p3 to p3 {
			...
			v15[758] := if (|v17| in v16) then v16[|v17|] else true;
			v15[758] := (f37 + f37) >= (f37 - f37);
			var v18 := "cbjgo";
			globalState.f8 := v18;
			r1 := multiset([v15[758]] + (if (f38) then v0 else [v15[758]]));
			globalState.f8 := v18;
		}
		var i2 := 0;
		while (p0)
			decreases 100 - i2
		{
			...
			var v28: seq<D0> := [DC1(v24.fm20(globalState), 0x141, v26, v0[|v27[p3 := v19]|])];
			globalState.f22 := fm75(f38, v21[p3 := set v23 : int | v23 in v22 :: (v23 + |[[true]]|)], map[v19.f42 := fm34("vdgjlo", (("te")[|v25| := v26])[0x2b := v26], p3, globalState)], globalState) < (v28 + v28);
		}
		v15[207] := p0;
		v15[207] := f28;
		...
		match (DC56(v15, v33 + v33, |(if (p0) then v31 else v31)|, {v32, v32} !! {v32, v32}, p3 - p3)) {
			case DC56(cf107, cf108, cf109, cf110, cf111) =>
				var v34: set<bool> := {p0};
				var v35 := DC6(v34);
				var v36: array<string> := new string[17] ["ebjvfaxv", v31 + v31, v31, v31, "tmfisouil", v31, v31, fm37(false, p3, v35.cf15, globalState) + v31, v31, v31, v31, v31, v31 + v31, v31, seq(0x1bf, i3  => ('q')), v31, v31];
				var v37 := DC29(p0);
				var v38 := DC21(p0);
				globalState.f1, v36 := (if (v37.cf50) then fm76(p3, f28, cf109, "x", globalState) else v38).cf37, v36;
				v32 := v32;
				v32[466] := cf111;
				v32[466] := (-|v0| + cf111) + |(v31 + v31)|;
			...
			case DC57(cf112, cf113, cf114) =>
				v32[308] := |v31|;
				cf112, v32[308] := p3, fm0(!f38, p3, |v0| * p3, p1 + map[p3 := cf112], globalState);
				...
				if (p0) {
					...
					v43[194] := fm34(v31, v31, |v45|, globalState);
					globalState.f21 := p3;
					globalState.f11 := cf113;
					var v46: set<bool> := {v42.f39, p0, f28, p0, v15[207]};
					v46 := v46;
					...
					v32[308] := |(map v49 : string | v49 in (set v51 : string | v51 in v50 :: (v51)) :: (v49) := (|f37|))|;
					var v52 := 'p';
					v52 := v52;
				...
				v15, v55, v32[308] := v15, v55, (799 + v32[308]) - 421;
			...
			case DC55(cf106) =>
				v32[351] := if (p0 in v29) then v29[p0] else p3;
				v32[351] := p3;
				var v58 := new C4(f38);
				globalState.f22 := p0;
				globalState.f8 := (v31 + v31)[v32[351] := v31[p3]];
			case DC59(cf120) =>
				var v59: set<bool> := {f38};
				var v60: seq<set<bool>> := [fm60(globalState) + v59, v59, v59];
				var v61 := DC21(v15[207]);
				v60, v61 := v60, v61;
				var v62: map<bool, string> := map[!(v29 >= multiset(v0)) := v31 + v31];
				var v63: map<bool, int> := map[false := p3];
				var v64 := 'h';
				var v65: map<char, int> := map[v64 := 0x361];
				v62 := fm39(v63, if (p0) then -p3 else if (v64 in v65) then v65[v64] else |v0[p3 := v0[|("wqyrs")[p3 := v64]|]]|, v15[207], globalState);
				globalState.f11 := (p3 - p3) <= p3;
				var v66: map<bool, bool> := map[v15[207] := v15[207]];
	...
	method m12(p0: int, p1: int, p2: char, globalState: GlobalState) returns (r0: bool, r1: set<bool>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			if (f28) {
				...
				v1[172] := f38;
				var v2: seq<bool> := [f38];
				var v3: map<int, bool> := map[|(seq(0x14f, i1  => (p2)))[p0 := p2]| := f38];
				v1[172] := v2[|v3|];
				var v4: set<bool> := {f38, f28, v1[172], f38};
				r2 := |(fm37(v1[172], p0, v4, globalState))[p0 := p2]| <= p1;
				var v6: map<int, int> := map[p0 := -p0];
				var v7: C2 := new C2(p0);
				var v8: map<C2, int> := map[v7 := v7.f44];
				var v9: map<char, int> := map[p2 := v7.f44];
				var v10 := DC5(true, if (fm0(v1[172], p1, |(map v5 : int | v5 in v3 :: (v5 % p0) := (-538))|, v6, globalState) in v3) then v3[fm0(v1[172], p1, |(map v5 : int | v5 in v3 :: (v5 % p0) := (-538))|, v6, globalState)] else v1[172], |v8|, f28, v9);
				globalState.f16 := v10.cf12 / p0;
				globalState.f1 := f38;
				var v11: seq<int> := [p1, p0, -p0, v7.f44];
				var v12: map<bool, bool> := map[f28 := v1[172]];
				var v13 := new C7((if (v7.f44 in v6) then v6[v7.f44] else p0) !in v11, v1[172], v2[|v12[f38 := v1[172]]|]);
			} else {
				globalState.f21 := p1;
				...
				var v22 := DC39('g', f38, |(map v16 : int | (704 <= v16) && (v16 < 861) :: (v16 / p0) := (p0))|, f38, fm0(f38, -p1, |v19|, v21, globalState));
			...
			v25[839], globalState.f21, v26[658], v28[365] := v29 == (if (v25 in v30) then v30[v25] else v29), -p0, v27, v25;
		}
		...
		var v38 := DC64(seq(0x12b, i6  => (v32)));
		var v39: array<seq<map<int, bool>>> := new seq<map<int, bool>>[14] [(v33 + fm78(p0, p1, p1, p1, globalState))[p0 := v32], v33, if (v35.cf10 in v34) then v34[v35.cf10] else v33[p0 := v32], v33, v33 + v33, v33, [v32, v32, v32], [map[p0 := f28], v32], seq(0x1b6, i5  => (v32[p1 := f38])), v33[|v37| := (map[p0 := !f28])[p0 := f38]], v33, v33, v33, v38.cf129 + v33];
		v39[587] := if (f28) then v33 else v33;
		v31[796], v39[587], globalState.f22, globalState.f16 := f28, v33, f38, p1;
		globalState.f22 := v31[796];
		for i7 := p0 to p1 * -0x1f9 {
			...
			var v47 := "wkyssuh";
			globalState.f11 := !fm3(|(fm37(fm3(i7, 412, v46, v31[796], globalState), p0, {if (f28 in v36) then v36[f28] else f38, v31[796]}, globalState) + v47)|, i7, v46 - v46, fm14(!v31[796], f28, globalState), globalState);
			var v48: array<map<int, map<int, bool>>> := new map<int, map<int, bool>>[1](i8 => map[p1 := map[i7 := v31[796]]]);
			...
			decreases 100 - i9
		{
			...
			if (f28) {
				...
				var v54 := DC44(v52[|(map v53 : int | v53 in f37 :: (v53 / p0) := (f38))|]);
				var v55: map<bool, D15> := map[true := v54];
				var v56: array<T0> := new T0[9];
				var v57: set<array<T0>> := {v56};
				var v58: map<set<array<T0>>, bool> := map[v57 := v31[796]];
				v55 := v55[if (v57 in v58) then v58[v57] else v31[796] := DC44(p0)];
				var v59: multiset<int> := multiset{p1 / p1};
				v59 := (v59[p1 := p0] * v59) + multiset{p1, p1, 59, p1};
			} else {
				var v60: array<int> := new int[1] [0x15e];
				var v61: array<array<int>> := new array<int>[5] [v60, v60, v60, v60, v60];
				v61[904] := v60;
				v61[904] := new int[1] [0x107];
				v31 := v31;
			...
			if (f38) {
				...
				v66 := v66;
				globalState.f16, v31[796] := -p0, if (v31[796]) then f38 else f28;
				var v67: seq<int> := [p0];
				globalState.f21 := |{!v31[796], f38, p1 !in multiset(v67), false}|;
				globalState.f16 := -p0;
			} else {
				...
				var v81 := DC31(f28, v31[796], f38);
				var v82: array<int> := new int[28] [p0, |v68|, -|(v69 + (seq(0x2f2, i10  => (v50))))|, p1, p0, --p1, p0, p0, p0, |v70|, p1 % p0, -861 / -p0, -|(if (v74 in v77) then v77[v74] else v76)|, p1, |v79| / p1, |v32|, |multiset{|v73|, p1, p0}|, 0x1e, p0, p1, -|(v72 + map[-0x3a6 := |v80[f28 := p1]|])|, -|{v81, v81, v81, v81, v81}|, -p0, p1, p1, p0, fm0(v31[796], p1, p1, v72, globalState), p1 + -p0];
				v78[992] := DC54(fm0(f38, -p0, p1, v72, globalState), f28, p0).cf103;
				v78[992] := p1;
				v32 := map[p0 := !f38] + map[v78[992] := f38];
				var v83: array<map<bool, int>> := new map<bool, int>[27];
				v83 := new map<bool, int>[19];
				globalState.f16 := v78[992];
		...
		var v88: map<bool, array<int>> := map[v31[796] := v87];
		r2 := f28 <== (|v86| != |v88|);
	}
	method m13(globalState: GlobalState) returns (r0: map<bool, string>, r1: bool) {
		...
		globalState.f1 := false;
		var v4: map<bool, string> := map[f28 := seq(0x3d8, i0  => ('q'))];
		r0 := v4 + v4;
		r1 := 841 >= v1;
	}
}
...
class C10 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (f28) {
			...
			globalState.f11, v15[91] := !(v16 == (v16 - v16)), f28;
			var v17: array<map<bool, multiset<D19>>> := new map<bool, multiset<D19>>[6](i1 => if (DC62(0x277, f28, f36, f28).cf126) then map[false := multiset{DC50(map[false := v15[91]])}] else map[f28 := multiset{DC50(map[v15[91] := v15[91]])}]);
			var v18 := DC50(map[f28 := v15[91]]);
			var v19: multiset<D19> := multiset{DC50(map[f28 := v15[91]]), v18};
			var v20: map<bool, multiset<D19>> := map[v12[f36] := v19];
			v17[536] := v20;
			v17[536] := v20;
			var v21: array<int> := new int[4] [f36, |(v0 + (seq(0x1a6, i2  => (f36)))[f36 := -f36])|, f36, f36];
			v21 := f35;
		} else {
			var v22 := "ycx";
		...
		var v34: map<multiset<int>, bool> := map[v33[f36 := 0x202] := false];
		...
		var v40: array<bool> := new bool[25] [f36 > f36, true, false, f28, !v31[|v32|], f28, f28, f28, f28, f28, !f28 ==> f28, f28, f28, f28, f28, f28, f28, f28, f28, true, if (multiset{f36} in v34) then v34[multiset{f36}] else v31[fm0(f28, f36, fm0(f28, f36, |v0|, map v35 : int | (0x6d <= v35) && (v35 < 0x206) :: (v35 + f36) := (-755), globalState), v36, globalState)], fm1(!f28, |v37|, globalState), f28, f28 !in v38[f28 := |v39|], !false];
		v40[871] := f28;
		v40[871] := f28;
		var i4 := 0;
		while (!v40[871])
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v41: seq<seq<bool>> := [([v40[871]])[f36 := !v40[871]]];
			v40[871] := (v31 + v31) == v41[|v31|];
			...
			var v50: array<set<char>> := new set<char>[11] [v45, {v44, v44}, if (true) then set v47 : char | v47 in v46 :: (v47) else v45, {v44}, v45, v45, v45 + (set v48 : char | v48 in v46 :: (v48)), {v44}, v49[f36], v45 - v45, {v44}];
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		for i1 := p3 to v3[f36] {
			...
			v9 := v9 - v9;
			var v10: multiset<int> := multiset{v3[i1]};
		...
		if (f28) {
			...
			var v21: array<multiset<seq<int>>> := new multiset<seq<int>>[15] [(multiset{v3})[v3 := |(map v12 : char | v12 in v14 :: (v12) := (f36))|] + v17[v3 := f36], v17, v17, v17 + multiset(v18), if (p0) then v17 else if (f36 in v19) then v19[f36] else v17, v17, v17 - v17, v17, v17, v17, multiset{seq(440, i2  => (|v14|))}, v17, v17, v17, v20[p3]];
			v21[816] := v17;
			globalState.f16, globalState.f8, v21[816] := |("mccqow" + v14)|, (("sgjf")[0x58 := v13])[p3 := v13], if (!f28) then v17 else v17[v3 := 488];
			v13 := v13;
			globalState.f1 := f28;
			...
			var v29 := "dswysuq";
			var v30 := DC43(p3, |(map v27 : int | v27 in v28 :: (v27 - |[0x15b]|) := (-|(seq(0x2f1, i3  => ('n')))|))|, 0x13b, p3, --|v29|);
			var v31 := 't';
			...
			v33[505] := v30;
			globalState.f21, v33[505], globalState.f16 := fm0(!f28, -f36, -|[p3]| % -0x2f6, p1, globalState), v30, |multiset{true}| * p3;
			if (f28) {
				globalState.f21 := |(v29 + v29)|;
				var v34: array<string> := new string[6] [v29, "vsayk", "wggs", ("xqgvbawf" + v29)[766 := v31], v29, v29];
				v34[818] := v29;
				v34[818] := v29 + (v29 + v29);
				v0[273] := f28;
				v0[273] := p0;
				globalState.f16 := if (p0) then -f36 / 647 else f36;
				globalState.f16 := f36;
			} else {
				var v36 := DC20();
				var v37: seq<D7> := [v36];
				var v38: seq<seq<D7>> := [seq(0x117, i5  => (DC20())), v37, [v36, v36, v36], [v36]];
				var v39: array<int> := new int[20] [-(f36 % p3), |v29| * -0x3a5, -p3, |map[f28 := v3[f36]]|, 916 - p3, p3, p3 - f36, p3 * p3, f36, p3, -|v29|, |(if (p0) then [|v29|, f36] else (seq(0x6f, i4  => (p3)))[-f36 := f36])|, p3, 0x362 % f36, p3, f36, p3 + 0x3d4, f36, |(map v35 : seq<D7> | v35 in [v38[p3]] :: (v35) := (f36))|, f36];
				...
				var v42: set<bool> := {p0};
				globalState.f21, globalState.f11, globalState.f8 := 0x111 / p3, p0, fm37(p0, f36, v42, globalState) + "mlbx";
				v0[961] := p3 <= p3;
				v0[961] := !(if (f28 <==> p0) then f28 else !f28);
	...
	method m10(p0: D4, p1: multiset<char>, p2: array<int>, p3: bool, globalState: GlobalState) returns (r0: D2, r1: int, r2: int) {
		...
		var i0 := 0;
		while (if ((seq(0x10e, i1  => ('g'))) != v0) then v2 <= v2 else !p3)
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			if (f36 > (|v3| + -409)) {
				...
				var v5 := 'x';
				var v6: set<bool> := {p3};
				var v7: array<string> := new seq<char>[20] [(seq(-0x2d2, i2  => ('i'))) + ("lnlf")[f36 := v5], fm37(false, f36, v6, globalState) + v0, seq(0x2d, i3  => (v0[f36])), v0, "xyqq", v0, "sfhra", v0 + v0, v0, v0, seq(-475, i4  => (v5)), v0, "dqbpr", v0[f36 := v5], v0, v0, v0, v0, seq(0x19a, i5  => (v5)), seq(942, i6  => (v5))];
				v7 := new seq<char>[15](i7 => seq(0x35b, i8  => (v5)));
				globalState.f1 := -f36 > f36;
				v5 := v5;
				var v8: map<array<int>, bool> := map[f35 := f28];
				var v9: seq<map<array<int>, bool>> := [v8[p2 := p3]];
				var v10: seq<map<array<int>, bool>> := [v8, v8 + v8, v8 + v8, v9[|v3|]];
				v8 := v10[f36];
			} else {
				...
				var v13: map<char, int> := map[v0[f36] := f36];
				...
				v11[568] := v14[v16.cf101];
				var v17: array<bool> := new bool[23](i9 => f28);
				v17 := v17;
				var v18 := 'k';
				var v19: seq<int> := [|['t', v18]|, f36, 0x33c];
				var v20: seq<seq<int>> := [[f36] + (seq(-0x319, i10  => (f36))), v19 + v19[f36 := f36], v19];
				var v21: array<int> := new int[23];
				var v22: map<bool, D12> := map[f28 := DC35(p3, f28, p3, f36, f36)];
				r2, globalState.f21, v20, v21, v21 := -(|v22| - (f36 / f36)), |v3|, seq(-0x1ed, i11  => (v19)), p2, v21;
				var v23 := DC17(v17, v0);
				var v24: set<string> := {v23.cf34, v11[568]};
		...
		if (match p0 {
			...
			if ((v45[f36] * f36) >= v48.cf125) {
				v1 := v1;
				p2[949] := v41.f44 * f36;
				globalState.f16, r2, p2[949] := v41.f44, f36, f36;
				var v49: multiset<multiset<bool>> := multiset{v39};
				var v50 := DC16(v49);
				p2[949], r2, v50 := p2[949], v41.f44, fm81(v42, -v41.f44, f36, globalState);
				globalState.f21 := p2[949];
				...
				var v54: array<array<int>> := new array<int>[7] [v52, p2, v52, v52, p2, f35, v53[f36]];
				v54[214] := f35;
				var v55: array<D7> := new D7[26];
				var v56: array<multiset<int>> := new multiset<int>[16];
				var v57: seq<array<D7>> := [v55, v55];
				v54[214], v55, globalState.f11, globalState.f21, v56 := p2, v57[f36], p3, v41.f44, v56;
				globalState.f1 := p3;
			...
			decreases 100 - i15
		{
			...
			v72, globalState.f22 := seq(368, i16  => (-v67.f45)), p3;
			...
			v75[320] := v73;
			var v76: map<int, string> := map[v67.f46 := (seq(-437, i18  => (v58)))[v67.f46 := v58]];
			var v77: array<string> := new string[11] [v0, v0, v0, v0[v67.f46 := v58] + ("mff")[|v69| := v58], v0 + v0, "bl", DC68(v0, p3, p3, p3).cf135, (seq(-0x104, i17  => (v58))) + (if (v67.f45 in v76) then v76[v67.f45] else v0), fm37(!p3, v67.f45, v68, globalState), if (!f28) then v0 else v0, v0];
			v77[903] := v0 + v0;
			globalState.f22, v75[320], globalState.f16, v77[903] := p3, v73[v67.f46 := f28], (f36 - v67.f45) / 0x2b, v0;
		}
	...
	method m11(p0: bool, p1: array<bool>, p2: int, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		globalState.f16 := fm0(true, |v7| % |v8|, fm0(p0, --p2, |v9|, v10, globalState), v10 + v10[f36 := f36], globalState);
		globalState.f21 := p2;
		r0 := 0x3d9 % (fm0(!false, |v10|, f36, v10, globalState) * 0x2f5);
...
class C11 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (v1 !in multiset{v1, map v2 : int | (0xb5 <= v2) && (v2 < 0x23c) :: (v2 * f34) := (DC1(f34, -0x34a, v0, true).cf4)}) {
			...
			v19[395] := ((if (f34 in v16) then v16[f34] else f34) + |v18|) >= |v21|;
		...
		r0 := f34 <= 0xbd;
		r1 := f34 % |(map v30 : int | (-0x229 <= v30) && (v30 < -0x9e) :: (v30 - |{f34}|) := (|[true, f28]|))|;
		r2 := f34;
	}
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
			...
			decreases 100 - i1
		{
			...
			v6[888], globalState.f22, v10[256], globalState.f22, globalState.f1 := p0, p0, v11, !(p3 >= -|v12|), if (|map[f28 := f28]| in v13) then v13[|map[f28 := f28]|] else f28;
			var v14: array<char> := new char[17](i2 => 'v');
			v14[485] := v1;
			var v15: set<int> := {0xac, f34};
			var v16: map<set<int>, bool> := map[v15 := v6[888]];
			var v17: array<int> := new int[28];
			var v18 := DC10(v15);
			v14[485], v16, v17 := v12[p3], map[v15 := f28] + map[v18.cf20 := fm3(p3, p3, v4, f28, globalState)], if (f33.cf13) then v17 else v17;
			var v19: set<bool> := {v6[888], v6[888]};
			v12, v6[888] := fm12(globalState), !(v19 >= v19);
			globalState.f16 := p3;
		}
	...
	method m8(globalState: GlobalState) returns (r0: int, r1: array<bool>, r2: array<int>) {
		...
		for i0 := f34 to |v1| {
			...
			match (v5) {
				case DC7(cf16, cf17, cf18) =>
					...
					var v12: map<char, int> := map[v2[755] := |v0|];
					var v13: set<bool> := {false, cf18};
					var v14: seq<string> := [v0];
					var v15: seq<seq<string>> := [v14, v14, [v0]];
					var v16: array<multiset<string>> := new multiset<string>[18] [multiset{seq(0x60, i1  => (v2[755])), v0}, v11, v11["teg" := f34], v11, v11, v11, v11, multiset{v0}, v11, if (fm3(-i0, |v12|, {v12, v12, map[v3 := |v13|]}, f28, globalState)) then v11 else v11, if (f28) then v11 else v11, multiset{"evaj"}, multiset(v15[i0]), v11, v11, multiset{"jsyrggaj"}, v11, v11 + v11];
					v16[830] := v11;
					v16[830] := v11;
				case DC8() =>
					...
					v18[772] := f28;
					var v19: map<char, int> := map[v2[755] := 863];
					var v20: set<bool> := {f28};
					v18[772], globalState.f22 := fm1({f28, fm1((f33.(cf11 := f28, cf14 := v19)).cf10, v17[56], globalState)} >= v20, |v0|, globalState), f28;
					globalState.f22 := v18[772];
					var v21 := new C6(f28);
				case DC6(cf15) =>
					...
					var v27: seq<bool> := [f28, fm0(true, i0, i0, map v24 : int | v24 in v25 :: (v24 % i0) := (i0), globalState) == |map[fm0(!f28, i0, i0, v26, globalState) := f28]|, f28, v0 < v0];
					var v28: map<char, int> := map[v3 := f34];
					var v29: map<map<char, int>, int> := map[v28 + v28 := fm0(f28, |v27|, f34, v26, globalState) - i0];
					v27, globalState.f21, globalState.f11, v29 := v27, i0, 507 > (f34 / 0x388), v29;
				...
				case DC9(cf19) =>
					...
					var v39: seq<int> := [fm0(false, f34, f34, v38[i0], globalState)];
			...
			globalState.f16, globalState.f8, globalState.f21, globalState.f11 := |v51| + f34, v0, |v53| / (if (f28) then i0 else f34), if (f28) then f28 else f28;
			var v54 := new C0(f28);
		}
		...
		if (f28) {
			...
			if ((v57 !! v57) && (f28 || !false)) {
				...
				v59 := v59[f28 := v58];
				var v60: map<int, int> := map[|(seq(-0x203, i6  => ('l')))| := f34];
				var v61: seq<int> := [f34];
				...
				v67[407] := (map v68 : int | (0x1b2 <= v68) && (v68 < -0x30e) :: (v68 + f34) := ([f28, f28])) + v70;
				v67[407] := (map v71 : int | (0x139 <= v71) && (v71 < 93) :: (v71 / f34) := (v69)) + v70[f34 := v69];
				...
				v77 := (([f28, f28, fm1(f28, f34, globalState), false, f28] + v77) + v77)[-|v78| := f28];
			...
			if (f28) {
				var v83: array<int> := new int[23](i8 => i8 / 0x31e);
				v83[171] := f34;
				...
				var v90: seq<bool> := [v89[f34], f28, !f28];
				v83[171], globalState.f22, globalState.f1, v87[410], v88 := |v90|, fm1(!(f28 || f28), f34, globalState), if (f28 && f28) then f28 else f28, v84, v88;
				v1 := (v1 - v1) * v1;
				...
				globalState.f16 := (if (f28) then 0x134 else v102.f43) % v102.f43;
			}
			...
			globalState.f11, globalState.f11, v111[569], globalState.f11 := !f28, |v116[fm0(!f28, v117[f34], f34, v118, globalState)]| == (f34 + f34), v108, {f34, 0x24b} !! {-|v0|, f34};
			var v119: array<char> := new char[3];
			var v120: seq<array<char>> := [v119, v119, v119, v119, v119];
			var v121 := DC74(v119);
			var v122: array<array<char>> := new array<char>[23] [v119, v119, v119, v119, v119, v119, v119, v119, v119, v120[|v1|], v119, if (f28) then v121.cf152 else v119, v119, v119, v119, v119, v119, v119, v119, v119, v119, v119, v119];
			v122 := v122;
			if (f28) {
				...
				globalState.f11, globalState.f11, globalState.f16, v126[927], globalState.f8 := (v0 + "f") == (fm12(globalState) + v128[|v125|]), !((v129 + v129) !! v129), f34, v127, if (f28) then v0 else v0 + "ed";
				globalState.f22 := |v57[f34 := f34]| > f34;
			} else {
				var v130: seq<bool> := [f28, f28, f28];
				globalState.f1 := if (!(v117 <= [f34])) then v130[f34] else f28;
				var v131: set<bool> := {f28};
				v0 := fm37(f28, f34, v131, globalState);
				globalState.f22 := v130[f34];
			...
			globalState.f16, v112[924], v133[686], v112[449] := |(if (f28) then v134 else v134)|, f28, if (f28 || v134[f34]) then f34 else -|v1|, fm1(!fm3(f34, |[|v134|]|, v137, f28, globalState), 0x2e7, globalState);
			var v138 := new C6(fm3(v133[686], f34, fm63(f28, v133[686], f34, v112[924], globalState), f28, globalState));
		}
		...
		if (f28) {
			...
			v144[864] := multiset(v143);
			var v145 := 'r';
			var v146: set<map<char, int>> := {map[v145 := f34]};
			var v147: multiset<char> := multiset{v145};
			var v148 := DC7(v147[v145 := 0x16d], v143, false);
			v144[864], globalState.f11 := v57, fm3(|v0|, f34, v146, v148.cf18, globalState);
			...
			var v156 := 'k';
			var v157 := DC68(v0[f34 := DC41(f34, v0, f34, |v0|, v156).cf82], true, f28, f28);
			...
			var v161: map<array<bool>, int> := map[v158 := |v160[v159 := |v55|]|];
			var v162 := DC12(v161);
			v155[443] := v162;
			v155[443] := v162;
			var v163: array<string> := new string[29];
			v163[724] := v0;
			v163[724] := ((v0 + v0) + (if (!f28) then v0 else "l"))[f34 := v156];
			...
			var v168: array<int> := new int[29](i15 => i15 % |map[v156 := !f28]|);
			var v169: seq<array<int>> := [v168, v168, v168];
			var v170: seq<array<int>> := [v169[f34], v168];
			...
			var v174 := DC6(v173[0x299]);
			var v175: array<set<bool>> := new set<bool>[3] [if (f28) then {false, f28} else v164, {f28, f28, v165[f34], f28, f28}, v174.cf15];
			v175[382] := v164;
			v175[382] := v164;
	...
	method m9(globalState: GlobalState) returns (r0: seq<set<int>>, r1: D2, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			match (v2) {
				...
				case DC39(cf72, cf73, cf74, cf75, cf76) =>
					...
					v19[380] := fm0(cf75, |v20|, cf76, v22[cf74 := f34], globalState) < |"in"|;
					var v24 := "d";
					var v25: seq<string> := [v24];
					v19[380] := (v25 + v25) != (v25 + v25);
			...
			match (v35.(cf19 := v34)) {
				case DC7(cf16, cf17, cf18) =>
					...
					r2 := fm32(f28, v36, true, |(seq(925, i2  => (v36)))|, globalState) >= (v37 + (multiset{f28, f28})[f28 := |v38|]);
				...
				case DC8() =>
					...
					v43[485] := |v31|;
					v43[485] := |(v1 + v1)|;
					var v44: multiset<int> := multiset{if (f28) then v43[485] else f34};
					var v45: seq<int> := [f34, v43[485], v43[485], f34, f34 % f34];
					var v46 := 'r';
					var v47: map<char, bool> := map[if (f28) then 'h' else v46 := f28];
					var v48 := "x";
					var v49: map<string, bool> := map[v48 := DC15(v48, f28, f28, f28).cf30];
					v44, v45, v31, globalState.f11, v45 := v44 - (v44 + v44[f34 := f34]), v45, (v31 + v31) + v31, if (v46 in v47) then v47[v46] else f28 <== f28, fm42(DC15("jqmrdjmv", f28, f28, if (fm12(globalState) in v49) then v49[fm12(globalState)] else f28), f34, map[v46 := |v1|], f34, globalState);
					globalState.f1 := f28;
				case DC6(cf15) =>
					globalState.f1 := f28;
					var v50 := "md";
					var v51 := 'e';
					var v52: seq<string> := [seq(150, i4  => (v51))];
					var v53: array<bool> := new bool[6] [f28, f28, f28, f28, f28, false];
					var v54: seq<array<bool>> := [v53];
					var v55: set<array<bool>> := {v54[f34]};
					var v56: array<string> := new string[25] [v32.fm31(f34, f28, f28, globalState), v50 + v50, v50, "tk", v50 + v50, v50, v50, v50[f34 := v51], (seq(0xd0, i3  => (v51))) + v52[f34], v50, v50, v32.fm31(|v55|, fm1(f28, f34, globalState), f28, globalState), "ednrwese", v50, if (f28) then seq(360, i5  => (v51)) else v50, v50 + (seq(0x141, i6  => (v51))), v50, v50 + (seq(0x2d5, i7  => (v51))), fm12(globalState), v50 + v50, "qbeuo", (seq(0x128, i8  => (v51))) + (seq(820, i9  => (v51))), v50, (v50[f34 := v51])[f34 := v51], v50];
					v56 := v56;
				...
				case DC9(cf19) =>
					...
					var v60: multiset<int> := multiset{-0x3d2 % |v59|, f34, f34};
					...
					v62, globalState.f1 := v62, v67[f34];
					globalState.f22 := f28;
			}
		...
		for i11 := fm0(true, |(if (v78[f34] in v77) then v77[v78[f34]] else seq(0x201, i12  => (f34)))|, f34, map[f34 := |v79|], globalState) to -f34 {
			if (false) {
				globalState.f16 := fm0(f28, |v78|, i11, v71, globalState);
				v68[770] := v76[fm0(f28, 543, i11, fm41(f34, f28, f28, globalState), globalState)];
				v68[770] := i11;
				var v80: array<D11> := new D11[18](i13 => DC31(!f28, f28, f28));
				var v81 := DC31(f28, f28, !f28);
				v80[993] := v81.(cf54 := !f28);
				v80[993] := DC31(f28, f28, f28).(cf53 := f28, cf52 := true);
				var v82 := "tbkphpraf";
				var v83 := DC53(f34, v68[770]);
				var v85: array<int> := new int[23](i14 => i14 + |v71|);
				var v86: map<int, array<int>> := map[v68[770] := v85];
				var v87: map<char, int> := map[v82[f34] := v68[770]];
				var v88: multiset<int> := multiset{if ('b' in v87) then v87['b'] else f34};
				var v89: set<map<char, int>> := {v87};
				var v90: map<bool, bool> := map[fm3(if (v68[770] in v88) then v88[v68[770]] else i11, i11, v89, false, globalState) := f28];
				var v91: array<int> := new int[24] [i11, |v82|, |{!f28}|, i11, i11, |{|v82|, v72[f34], |v82|}|, i11, f34, |v78|, i11, f34, v83.cf102, f34, i11, -f34 + |(map v84 : int | (634 <= v84) && (v84 < -0x16a) :: (v84 + i11) := (!f28))|, |v86[v68[770] := v85]|, i11, |v78|, |v90[f28 := fm1(f28, v68[770], globalState)]| / |v78|, i11, v68[770], fm0(f28, i11, i11, map[f34 := i11], globalState) + v68[770], i11, v68[770]];
				var v92 := 'o';
				var v93: map<int, map<int, int>> := map[i11 := v71];
				var v94 := DC43(f34, i11, |(if (|{f28}| in v93) then v93[|{f28}|] else map[654 := f34])|, |v82|, f34);
				v85, globalState.f16, v92 := v85, |((v82 + v82)[v94.cf88 := v92] + (v82 + fm12(globalState)))[fm0(!f28, i11, i11, v71, globalState) := v92]|, v82[0x2fa * 0x16];
				v78 := v78;
			} else {
				globalState.f21 := i11 / (f34 + f34);
				var v95 := "ovqf";
				v68[650] := |v95|;
				var v96: map<seq<int>, string> := map[v76 + v72 := v95 + v95];
				var v97: set<bool> := {f28, f28, f28, f28};
				var v98 := 'h';
				globalState.f22, v68, v68[650], v96, globalState.f21 := i11 == (|fm37(!f28, f34, v97, globalState)| % f34), v68, -i11, v96 + (fm86(|v78|, f34, v98, globalState) + v96), f34;
				v71 := v71[f34 / v68[650] := f34];
				var v99: array<bool> := new bool[28](i15 => f28);
				var v100: array<set<D24>> := new set<D24>[11];
				v99, v100, globalState.f21, v72, globalState.f16 := v99, v100, fm0({!f28, !f28} <= v97, |"thev"|, |(seq(0xa, i16  => (v98)))|, map[v68[650] := f34] + v71, globalState), [f34, f34] + v72, f34;
				v98 := v98;
			}
		...
		v68[583], v102 := |(map v103 : string | v103 in v105 :: (v103) := (v72))| / |v104|, v102;
		...
		var v111: set<int> := {fm0(f28, f34, f34, map v108 : int | v108 in v110 :: (v108 / v68[583]) := (v68[583]), globalState), 742};
...
class C12 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		var v10: map<char, int> := map[v6 := |(seq(567, i2  => (0x2c)))|];
		var v11: map<bool, bool> := map[f28 := f28];
		var v12: set<int> := {v0, v0};
		var v13 := DC3(|v11|, |v12|, v4);
		var v14: map<int, int> := map[v1.f45 := 333];
		var v17 := DC10(set v16 : int | v16 in v3 :: (v16 % -0x152));
		var v18: map<char, D4> := map[v6 := v17];
		var v19: map<bool, int> := map[f28 := v1.f46];
		var v20: seq<map<bool, int>> := [v19];
		var v21: array<seq<int>> := new seq<int>[27] [v3, [v1.f46], v4, if (v1.f46 in v5) then v5[v1.f46] else v3, [v1.f45, |v7|, v1.f46], v3[v1.f46 := -0x1ff], seq(218, i0  => (|(seq(-568, i1  => (v6)))|)), if (f28) then v4 else v4, v4, fm42(v8.(cf31 := f28), |v9|, v10, v0, globalState) + v4, v13.cf8, fm42(fm87(v1.f46, false, v1.f45, v14, globalState).(cf30 := !f28, cf28 := fm37(f28, v1.f46, {f28}, globalState), cf29 := false), fm9(globalState), map v15 : char | v15 in v18 :: (v15) := (0x17e), |v20|, globalState), seq(0x3f, i3  => (|multiset{f28, f28}|)), v3, v4, v3, v3, seq(0xad, i4  => (v1.f45)), [v1.f45], v4, v4, v3, v4, (fm16(globalState))[v1.f45 := |v14|], v4, v4, v4];
		v21 := v21;
		var v22: array<char> := new char[22];
		v22[12] := 'a';
		var v23: set<bool> := {true};
		r1, globalState.f16, v22[12], v6 := v1.f45, (v1.f46 - v0) * (v1.f46 / v1.f45), fm34(fm37(f28, -v1.f46, v23, globalState), v2, v1.f46, globalState), v6;
		r0 := !(v12 > v12);
		r1 := |f32|;
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		...
		if (f28 <== f28) {
			...
			if ((v17 in v18) && !v13) {
				...
				var v21: set<char> := {fm34(seq(0x1ce, i1  => (v15)), v16, v12, globalState)};
				...
				var v25: array<int> := new int[29] [p3, 0x3e4, v17[p3], v12, 0x367 % v12, v0, p3, p3, 86, v22.cf12, fm0(v13, |v16|, |v2|, map[0x11b := p3], globalState), p3, v12, -(v0 * v0), v12, v0, -p3, v12 - 0x35c, 0x67, |v24[v12]|, p3, v12, v0, p3, -0x5c, v12, v0, -0x242, p3];
				v25[879] := 0x1dc;
				v25[879] := p3;
				v1 := !!(p3 in v17);
				var v26: set<int> := {v25[879], v12, v0 * v0, |(p1 + fm41(v25[879], p0, v1, globalState))|, |(seq(974, i2  => (v15)))|};
				var v28: seq<set<int>> := [{v25[879], |(seq(0x31a, i3  => (v15)))|}, set v27 : int | v27 in v26 :: (v27 * -0x394)];
				v26 := (v28[-101] * (set v29 : int | (405 <= v29) && (v29 < 0x2fa) :: (v29 % |v16|))) + (set v30 : int | (0x218 <= v30) && (v30 < 397) :: (v30 * |[642, -v0]|));
				globalState.f21 := v0;
			} else {
				var v31: set<map<char, int>> := {map[v15 := p3]};
				var v32 := new C7(fm3(|(seq(-0x204, i4  => (v0)))|, -p3, v31, p0, globalState), v13, f28);
				var v33 := new C2(v12);
				...
				var v38: array<int> := new int[27] [|v36|, p3, 0x1ec, v0, v33.fm26(p3, false, v33.f44, p3, globalState), |v17| / v0, v12, p3, if (v13 in v37) then v37[v13] else v0, v0, v12, v33.f44, v0 % v0, p3, -359, v12, v33.fm26(0x159, v13, v0, v33.f44, globalState), v12 % v0, 0x83, v12, v0, v33.f44, |map[v16 := v33.f44]|, v12, |v16|, -|f32|, if (true) then 496 else p3];
				v38[908] := v12 + v0;
				var v39 := DC41(p3, v16, |v17|, v33.f44, v15);
				v38[908] := v17[v39.cf80] / v33.f44;
				var v40: set<int> := {v38[908]};
				var v42 := new C9(v40 - (set v41 : int | v41 in {v12, |v16|, |(seq(957, i6  => (v15)))|} :: (v41 - |"qtxlrste"|)), v32.f41, !v13);
			}
			...
			var v47: seq<string> := [v46[v0] + v45];
			var v48: map<bool, bool> := map[v1 := p0];
			globalState.f8 := v46[|v48| * p3];
		}
		...
		var v54 := 'j';
		v54 := v54;
		var v55: map<int, string> := map[|(seq(0x2a4, i8  => (v51[648])))| := v49];
		...
		r0 := |(match v58 {
			...
			case DC44(cf89) => v49[v0 := v54] + (seq(488, i9  => (v54)))
			case DC42(cf83) => v49
		})|;
		var v59: multiset<bool> := multiset{false, fm1(p0, v51[648], globalState), (v3.(cf37 := p0)).cf37, v49 == "ort"};
		r1 := v59;
		r2 := f28 <==> !p0;
	}
	method m6(globalState: GlobalState) returns (r0: int) {
		...
		var v4: multiset<int> := multiset{v0, v1[|v3|]};
		...
		for i0 := v0 / v0 to v0 {
			...
			v11[634], globalState.f11, v13[320], v2 := v7.f28 ==> fm3(|v14|, i0, v15, if (v16 in v17) then v17[v16] else f28, globalState), !v7.f28, |(map[v7.f28 := v13] + v20)|, v2;
			var v21 := "wuixejrr";
			var v22: map<multiset<int>, int> := map[v4 := |DC50(v3).cf96[f32[|v21|] := f32[v13[320]]]|];
			var v23 := DC2(v21);
			...
			v25 := DC33(v13[320] % fm0(v7.f28, v13[320], 0x2d8, v12, globalState), (seq(0x206, i1  => (v2))) + "jgco", v2);
			v21 := v21 + v21[i0 := v2];
			...
			var v31: array<D6> := new D6[24] [v29, v29, v29, v29, v29, v29, v29, DC16((multiset{v27})[v27 := |v1|]), v29, DC16(v28), v29, fm81(v2, |v21|, |(if (v7.fm3(i0, i0, v15, v7.f28, globalState) in v30) then v30[v7.fm3(i0, i0, v15, v7.f28, globalState)] else v1)[fm9(globalState) := i0]|, globalState), v29, v29, v29, DC16(v28), DC16(v28), fm81(v2, v0, i0, globalState), v29, v29, v29, v29, v29, v29];
			v26[387] := v31;
			v26[387] := v31;
		}
		var v32: map<int, int> := map[v0 := |(seq(0x360, i2  => (v2)))|];
		...
		globalState.f8 := (fm12(globalState))[v0 := v2];
	...
	method m7(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: map<char, bool>) {
		...
		var v3: map<string, bool> := map[seq(-0x294, i1  => ('h')) := false];
		var v4 := "mvejbuwht";
		if (if (v4 in v3) then v3[v4] else p0) {
			...
			v7[593] := multiset(if (-v2.f36 in v9) then v9[-v2.f36] else v8);
			var v10: multiset<int> := multiset{v2.f36};
			v7[593] := v10;
			var v11: map<bool, bool> := map[p0 := p0];
			var v12: multiset<map<bool, bool>> := multiset{v11};
			v12 := v12;
			r1, r1, v2.f35[527] := !!(p0 <== (-487 < v2.f36)), v2.f36 > v2.f36, v2.f36;
			var v13: array<array<int>> := new array<int>[21];
			v13[566] := v2.f35;
			var v14 := DC77(v9);
			v13[566] := new int[12] [0x86, v2.f36, v2.f36, -(if (p0) then v2.f36 else v8[v2.f36]), -v2.f35[527], |v14.cf159|, v2.f35[527], v2.f36, v2.f35[527], v2.f35[527] % -498, v2.f35[527], v2.f36];
		} else {
			...
			v15[279] := if (f28 in v20) then v20[f28] else v18;
			globalState.f11 := p0;
			v2.f35[100] := v2.f36;
			v2.f35[100] := v2.f36;
			...
			var v24 := DC51(p0, v2.f36, |map[v23[v2.f35[100]] := v2.f35[100]]|);
...
class C13 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		globalState.f1, v0[517], v0[868], r2, v2 := fm1(v2.f28, f31, globalState) ==> (if (v2.f28) then f28 else f28), 0x2b3, f31, -v4[fm0(f28, |v5|, f31, v6, globalState)], v2;
		var v7 := 'k';
		v7 := v7;
		var v8: multiset<int> := multiset{f31, v0[517]};
		var v9: map<int, multiset<int>> := map[-v0[517] / v0[517] := v8];
		v9 := v9[f31 := v8[v0[517] := |v1|]];
		if (f28) {
			var v10 := new C9(f30, v2.f28, v2.f28);
			globalState.f16 := -f31;
			var v11: multiset<bool> := multiset{v2.f28, f28, v10.f38, false};
			globalState.f11 := |v11| != (f31 % v0[517]);
			globalState.f22 := DC62(v0[517], v10.f38, f31, f28).cf124;
			var v12: map<bool, bool> := map[v10.f38 := v3 <= v3];
			v12 := v12[v2.f28 := v0[517] > v0[517]];
		} else {
			r1 := v0[517];
			if (v1[v0[517]]) {
				v0[517] := f31;
				var v13: multiset<bool> := multiset{false, v2.f28, true};
				globalState.f22 := (if (v2.f28 in v13) then v13[v2.f28] else v0[517]) != (f31 % -f31);
				var v14: C1 := new C1(v0[517], |"sgxfmcjga"|);
				var v15: seq<C1> := [v14];
				var v16: set<char> := {v7, v7, v7};
				var v17: seq<seq<int>> := [v4];
				var v18: seq<seq<seq<int>>> := [v17, v17];
				var v19 := DC11(v16, v18[v14.f46], -|v6|);
				var v20 := DC5(v1[|v15|], f28, v19.cf23, v2.f28, map[v7 := f31]);
				v20 := v20;
				var v21: map<char, bool> := map[v7 := f28];
				globalState.f21 := if (if (v7 in v21) then v21[v7] else v2.f28) then -v0[517] else v0[517];
				var v22: array<bool> := new bool[13];
				v22[300] := true;
				globalState.f21, globalState.f16, v22[300], v0[517], v7 := -0x28a / -0x248, v14.f45 / (f31 + -0xae), f28, v0[517], fm34(v5 + v5, seq(0xe1, i1  => (v7)), f31, globalState);
			} else {
				v0[517] := (if (0x2b4 in v8) then v8[0x2b4] else f31) - -(f31 * v0[517]);
				var v23: array<bool> := new bool[9];
				var v24: C8 := new C8(f28, v1, v2.f28);
				var v25: map<C8, bool> := map[v24 := v2.f28];
				v23[538] := if (v24 in v25) then v25[v24] else !true;
				v23[538] := v2.f28;
				...
				globalState.f21 := (v4[f31] - |(if (fm34("c", v5, f31, globalState) in v27) then v27[fm34("c", v5, f31, globalState)] else v3)|) % v0[517];
				globalState.f16 := (f31 * f31) + f31;
			}
			
			var v28 := DC35(f28, v2.f28, f28, |v4|, v0[517]);
			...
			globalState.f22 := (v0[517] + |map[fm3(f31, f31, v32, v2.f28, globalState) := v2.f28]|) >= |{!!v2.f28}|;
			v0[517] := 0x2f9;
		}
		
		for i2 := f31 to -(if (v2.f28) then |v1| else f31) {
			globalState.f8 := fm37(f28, v0[517], v3, globalState);
			...
			var v38: array<D3> := new D3[23] [v34, DC6(v3).(cf15 := v3), v34, v34, v34, v34, v34, v34, v34, v34, v34, fm90(f31, f30, |v36|, globalState), v34, if (!f28) then DC6(v3) else fm90(i2, {|v5|}, v0[517], globalState), v34, DC6({f28}), DC6(v3), DC6(v3), v34, fm90(i2, set v37 : int | (460 <= v37) && (v37 < 0xb1) :: (v37 % i2), i2, globalState), v34, v34, fm90(i2, f30, i2, globalState)];
			v38[193] := v34;
			var v39: seq<seq<bool>> := [[!f28, v2.f28]];
			var v40: seq<seq<bool>> := [v39[f31], [v2.f28, f28, v2.f28], v1, v1, v1];
			var v41: map<int, bool> := map[v0[517] := v2.f28];
			v0[517], v38[193], r0, v0[517], globalState.f1 := -(i2 - -v0[517]), DC6(v3), f28, i2, (v1 + v35.f32) < v40[|(map[f31 := |v41|])[|v8| := v35.fm8(v1[f31], globalState)]|];
			v7 := v7;
		}
		r0 := v2.f28;
		r1 := -v0[517] - |f30|;
		var v42: multiset<string> := multiset{seq(-0x2bd, i3  => (v7)), v5};
		var v43 := DC81(v42);
	...
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			if (v0 in (v1 + v1)) {
				...
				r0, v5, r0, globalState.f21 := p3, (v5[p3 := p0])[(if (fm1(f28, |multiset{p3}|, globalState) in v6) then v6[fm1(f28, |multiset{p3}|, globalState)] else p3) / 0x1e := f28], -f31 * p3, fm0(f28, f31, p3, map[f31 := 0x1ba] + p1, globalState);
				var v7: array<set<int>> := new set<int>[13](i1 => {if (f31 in p1) then p1[f31] else p3, f31});
				v7[477] := {p3};
				v7[477] := f30 * f30;
				globalState.f8 := (fm12(globalState))[f31 % p3 := if (f28) then v0 else v0];
			...
			var v28: array<int> := new int[10] [f31 - f31, |v25|, |v1| % p3, f31 + f31, if (p0 in v27) then v27[p0] else f31, f31, 0x323, f31, f31, |v25| - f31];
			v28 := v28;
		}
		var i2 := 0;
		while (f28)
			decreases 100 - i2
		{
			...
			var v32: seq<int> := [p3];
			var v33 := "eebf";
			var v34: array<bool> := new bool[7] [f28, (fm91(globalState)).cf93 !in v30, f28 !in [!v31[|v32|], p0, p0, true], p0, !p0, p0, -|v33| > p3];
			v34[173] := f28;
			v34[173] := p0;
			if (f28) {
				var v35: map<bool, int> := map[v34[173] && v34[173] := p3];
				v35 := v35[f28 := f31];
				var v36: array<C10> := new C10[22];
				v36 := v36;
				var v37 := DC14(v34[173]);
				var v38: array<D5> := new D5[2] [v37, DC14(f28)];
				var v39 := DC84(v38);
				var v40: seq<array<D5>> := [v38, v38];
				var v41: array<array<D5>> := new array<D5>[14] [v39.cf169, v38, v40[p3], v38, v38, v38, v38, v38, v38, v38, v38, v38, v38, DC84(v38).cf169];
				v41[705] := v38;
				v41[705] := v38;
				var v42: array<int> := new int[21](i3 => i3 / p3);
				v42 := v42;
				v31 := v31;
			} else {
				...
				v34[173] := v44 !! ({v43} * v44);
				var v45 := new C1(f31, if (v34[173]) then |v31| else p3);
				var v46 := 't';
				var v47: seq<string> := [v33];
				var v48: map<int, bool> := map[p3 := v34[173]];
				var v49: map<string, char> := map[(v47[|v48|])[|v33| := v46] + v33 := v46];
				v46 := if (v33 in v49) then v49[v33] else v46;
				v34 := v34;
				globalState.f22 := f28 <==> (f28 <== f28);
			}
			
			globalState.f22 := v34[173];
		}
		...
		if (if (f28) then p0 else f28) {
			...
			var v54 := DC52(v53);
			r0, v52[63], r0, v53, r0 := f31, p0, f31, v54.cf100, f31;
			r0 := f31;
			...
			match (DC66(v58)) {
				case DC65(cf130, cf131, cf132) =>
					...
					var v61, v62 := m0(cf130 / |v60|, globalState);
				...
				case DC64(cf129) =>
					...
					v68[119] := v69 + v69;
					var v70 := "nqjgdc";
					v68[119] := if (f28 && false) then v69[f31 := |v70|] else v69;
					globalState.f21 := p3 + p3;
					var v71: seq<set<bool>> := [v55];
					var v72: seq<set<bool>> := [v55, v71[|p1|]];
					var v73, v74, v75 := m4(v71[f31] + {p0}, globalState);
				...
				case DC66(cf133) =>
					...
					v56[579] := f31;
					globalState.f16, v56[579] := (0x331 * f31) - p3, f31 % 197;
			...
			if (p0) {
				var v86: array<int> := new int[8](i5 => i5 - |multiset{seq(0x27c, i6  => ('y'))}|);
				v86[496] := f31;
				var v87: map<char, int> := map['i' := 0x255];
				var v89 := 'g';
				var v90: set<char> := {v89, 'n'};
				var v91: array<bool> := new bool[19] [v51.fm3(|f30|, p3, {v87, map v88 : char | v88 in v90 :: (v88) := (|(seq(0x35f, i7  => ('b')))|)}, p0, globalState), false, !f28, true, true, fm1(p0, f31, globalState), f28, p0, p0, p0, p0, p0, f28, p0, p0, !p0, p0, f28, false];
				var v92: seq<array<int>> := [v86];
				var v93 := "svow";
				var v94 := DC68(v93, f28, f28, p0);
				var v95 := DC56(v91, v92, -f31, v94.cf137, |v87|);
				var v96: seq<string> := [seq(0x3bf, i8  => (v89))];
				r0, globalState.f16, v86[496] := if (f28) then (v95.(cf107 := DC17(v91, v93).cf33, cf109 := p3)).cf109 else -f31, |(v93 + v96[f31])|, -f31;
				globalState.f11 := v86[496] == (f31 - |(set v97 : int | (0xb9 <= v97) && (v97 < 0x128) :: (v97 - f31))|);
				var v98: multiset<int> := multiset{v86[496]};
				globalState.f1 := v98 >= (v98 * v98);
				var v99 := v51.m6(globalState);
				globalState.f11 := p3 == p3;
			} else {
				r0 := v51.fm9(globalState);
				var v100: array<int> := new int[11] [p3, f31, p3, p3, f31, p3, p3, |(f30 - f30)|, |v50| % p3, p3, p3];
				...
				v100[744] := if (p0) then |v102| else if (p3 in v105) then v105[p3] else p3;
				v100[744] := f31;
			...
			var v107 := new C1(p3, p3 % p3);
			r2 := f28;
			var v108: array<int> := new int[3];
			var v109 := "hjnp";
			var v110: map<bool, bool> := map[p0 := p0];
			var v111: set<map<bool, bool>> := {fm10(globalState), v110};
			v108[99] := v107.fm27(v109, v111, globalState);
			v108[99] := -v107.f45;
		}
		
		v51.f32 := fm40(map[v51.f32 := f28], f28, globalState) + v50;
		globalState.f16 := f31;
		r0 := (0x31e + |[f28, true, p0, p0, f28]|) % f31;
		var v113 := "brkbyroid";
		var v114: set<map<int, bool>> := {map v112 : int | v112 in map[|v113| := 0x2ea] :: (v112 % |v51.f32|) := (f28)};
		var v116 := 'q';
	...
	method m4(p0: set<bool>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool) {
		var v0 := "mdrundgjq";
		var v1 := 'q';
		var v2 := DC33(|(seq(-0x1ed, i0  => ('c')))|, v0, v1);
		...
		globalState.f21 := (f31 % 0xe5) % fm0(v3.cf4, |v9|, |v11[fm0(v5.f38, -|v12|, f31, v13, globalState)]|, map[v7.f36 := f31], globalState);
		globalState.f21 := f31;
		if (f28) {
			var v14: map<string, string> := map[v0 := v0];
			globalState.f8 := if (v0 in v14) then v14[v0] else (v0 + v0)[|v0| := v1];
			var v15: map<int, bool> := map[f31 / fm0(f28, fm0(v5.f38, f31, v7.f36, v13, globalState), v7.f36, v13[f31 := v7.f36], globalState) := f28];
			...
			var v22: array<bool> := new bool[21] [v5.f38, v5.fm3(|v17|, v7.f36, v20[|[v0, v0]|], f28, globalState), v16.fm23(v16.f43, f28, globalState) <= v16.f43, false, f28 ==> f28, true, v16.f43 >= f31, v5.f38, false, f28, fm1(v5.f38, v7.f36, globalState), fm1(f28, |v12|, globalState) <== v5.f38, f28, v5.f38, ("m")[fm0(!v5.f38, f31, 0x200, map[v16.f43 := f31], globalState) := 'u'] == v0, v16.fm24(globalState) || v5.f38, true, v5.f38, if (v5.f38 in v21) then v21[v5.f38] else fm1(v5.f38, |v0|, globalState), f28, v16.f43 >= v7.f36];
	...
	method m5(globalState: GlobalState) returns (r0: bool, r1: map<int, char>, r2: bool) {
		...
		for i0 := |(v2[|v5| := 'y'] + v2)| to f31 {
			...
			var v14: array<int> := new int[27] [i0, f31, f31, -i0, 0xe4, |f30|, i0 - i0, i0, i0 - |v2|, i0 % f31, v3[|map[f28 := f28]|], 231, i0, i0, 15, fm0(f28, f31, fm0(f28, i0, f31, map[0x1d5 := f31], globalState), v10, globalState), |map[f31 := if (i0 in v13) then v13[i0] else {v11}]|, f31 % i0, f31, i0, f31, 0x335, 0x2a, f31, i0, |(v10 + v10)|, if (false) then i0 else |v2|];
			v14[740] := f31 - f31;
			v14[740] := if (true) then i0 else fm0(f28, i0, f31, v10, globalState);
		}
		var v15: array<bool> := new bool[1];
		var v16: map<bool, array<bool>> := map[fm1(true, |"aarrxs"|, globalState) := v15];
		var v17: map<bool, map<bool, array<bool>>> := map[v1.f32[0x196] := v16];
		v17 := v17[f28 := v16];
		r0 := f28;
		r1 := map v18 : int | v18 in (seq(0x3b7, i1  => (f31))) :: (v18 % f31) := ('i');
		var v19 := 'a';
...
class C14 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (if (f28 in v0) then v0[f28] else v1 <= [v2]) {
			...
			var v10: array<seq<char>> := new seq<char>[7] [fm6(globalState), v6, v6, v6[|map[f29 := v9]| := v5], v6, v6 + v6, seq(841, i0  => (v5))];
			v10[676] := v6;
			v10[676] := v6 + fm6(globalState);
			var v11: seq<int> := [f29, f29];
			var v12: map<string, seq<int>> := map[v10[676] := v11];
			var v13: map<multiset<int>, bool> := map[multiset(if (v10[676] in v12) then v12[v10[676]] else v11) := f28];
			var v14: multiset<int> := multiset{-f29, -f29, f29};
			v13 := v13[v14 := f28];
			var v15 := DC4(v3);
			match (v15) {
				case DC5(cf10, cf11, cf12, cf13, cf14) =>
					var v16: map<array<int>, seq<int>> := map[v3 := fm7((DC0(|multiset(seq(-0x2ae, i1  => (|[cf10, f28]|)))|).(cf0 := cf12)).cf0, globalState)];
				...
				case DC4(cf9) =>
					...
					globalState.f11 := f28;
					var v24: map<map<int, int>, string> := map[map[f29 := -0x101] := v10[676]];
			...
			v32[391] := v30 || v30;
			var v33 := "uhmgnesip";
			globalState.f8 := (v33 + v33) + (seq(-0x2f9, i2  => ('j')));
			var v34: set<bool> := {f28};
			var v35: multiset<bool> := multiset{fm1(f28, f29, globalState)};
			var v36: map<int, set<bool>> := map[|map[v35 := v32[391]]| := v34];
			var v37: seq<set<bool>> := [v34 + v34, v34 - v34, if (false) then {v32[391]} else if (-0x11f in v36) then v36[-0x11f] else {v30, v32[391], v32[391]}, {f28, v30} - v34, {!v30, !f28}];
			v37 := fm84(-0x11e, fm1(v30, f29, globalState), v30, f29 > f29, globalState);
		}
		
		var v38: multiset<bool> := multiset{f28};
		globalState.f21 := (f29 - |v38[f28 := f29]|) * f29;
		...
		match (v39) {
			...
			case DC30(cf51) =>
				...
				match (v50) {
					case DC31(cf52, cf53, cf54) =>
						var v51: array<int> := new int[24](i3 => i3 / |"hfodc"|);
						v51 := v51;
						globalState.f16 := 423;
						globalState.f1, globalState.f1, cf54, globalState.f21 := !f28, (f29 + |multiset([f29, f29])|) != f29, cf54, (f29 % -0x81) % f29;
						v51[742] := f29;
						v51[238] := f29 / f29;
						var v52: C1 := new C1(f29, f29);
						var v53: multiset<C1> := multiset{v52};
						v51[742], v51[238], v53 := v52.f46, v52.f46, v53;
					case DC30(cf51) =>
						var v54 := "dqtwv";
						...
						globalState.f8, v49, globalState.f21, globalState.f21, globalState.f16 := v54, fm34(v54, v54, f29, globalState), if (v55 !in v56) then f29 - f29 else f29, f29 / fm0(f28, fm0(f28, -f29, f29, v57, globalState), -0x79, v57, globalState), f29;
						f29 := f29;
						...
						var v64 := DC2(seq(715, i4  => (v49)));
						var v65 := DC64(v61[|fm42(v62, f29, v63, f29, globalState)| := fm2(f29, v64, v49, globalState)]);
						v59[972] := v65;
						v59[972] := v65;
				}
		...
		for i5 := if (f28) then --f29 else f29 to f29 {
			...
			var v69: array<int> := new int[4] [f29 - i5, |(seq(-0x22c, i6  => ('k')))|, -437, f29];
			v69[123] := f29;
			var v70: C7 := new C7(f28, f28, f28);
			globalState.f11, v67.f39, globalState.f11, v69[123], globalState.f16 := if (v67.f39) then f28 else f28, f29 >= |map[f29 := v70]|, fm1(v70.f42, f29, globalState), i5, i5;
		}
		r2 := f29;
		...
		r2 := (f29 * |fm6(globalState)|) % |(if (DC48(|(map v75 : int | (-0x146 <= v75) && (v75 < 0x114) :: (v75 - f29) := (f29))|) in v74) then v74[DC48(|(map v75 : int | (-0x146 <= v75) && (v75 < 0x114) :: (v75 - f29) := (f29))|)] else v76)[f29 := f28]|;
	}
	method m2(p0: bool, p1: map<int, int>, p2: array<map<bool, int>>, p3: int, globalState: GlobalState) returns (r0: int, r1: multiset<bool>, r2: bool) {
		globalState.f21 := p3;
		var v0 := "o";
		var v1: map<int, int> := map[p3 := f29 / |v0|];
		v1 := v1[f29 := f29];
		globalState.f11 := p0;
	...
	method m3(p0: bool, p1: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v6 := DC14(f28);
		var v7: array<bool> := new bool[27] [false, p0, f28, f28, p0, f28, f28, f28, v1[p1], true, p0, p0, true, f28, p0, f28, f28, p0, p0, p0, f28, f28, fm1(f28, 0x36f, globalState), f28, fm3(|v2|, f29, v5, !f28, globalState), p0, v6.cf27];
		v0[755] := DC63(p1, v7).cf127;
		v0[755] := f29;
			...
			decreases 100 - i1
		{
			...
			v7[699] := v12 == (v12 + v12);
			var v13: map<bool, int> := map[v7[699] := p1];
		...
		var v18: map<int, bool> := map[fm0(p0, -f29, v0[755], v17, globalState) := fm1(f28, v0[755], globalState)];
		var v19: map<bool, bool> := map[f28 := p0];
		var v20: multiset<array<bool>> := multiset{v7, v7, v7, v7};
		var v21: map<map<int, bool>, int> := map[v18 + fm2(fm0(f28, p1, v0[755], v17, globalState), DC2(v2), 'o', globalState) := fm4(v19, globalState) % (if (v7 in v20) then v20[v7] else -p1)];
		v21 := v21;
		forall i2 | 0 <= i2 < v0.Length {
			v0[i2] := i2 / p1;
		}
		forall i3 | 0 <= i3 < v7.Length {
			v7[i3] := if ((p1 % -f29) in v18) then v18[p1 % -f29] else f28 && p0;
		}
		var v22: multiset<bool> := multiset{p0};
		r0 := v1[|v22| / v0[755]];
		r1 := v1[f29];
		var v23: seq<seq<string>> := [[seq(0x2f, i4  => (v3))]];
		r2 := -|(set v24 : string | v24 in v23[f29] :: (v24))| + (f29 % fm5(globalState));
	}
}
...
method Main() {
	...
	var v11: array<int> := new int[15] [v4[v3], v3, v3, |v5|, -v3, v3, v3, v3, -|"vmxbbce"|, v3, if (v3 in v6) then v6[v3] else if (v3 in v9) then v9[v3] else v3, |v9|, if (v0 in v10) then v10[v0] else v3, |v5|, v3];
	var v12: map<char, string> := map[v1 := seq(0x25e, i0  => (v1))];
		...
		decreases 100 - i1
	{
		...
		v20 := v20[if (v3 in v21) then v21[v3] else seq(986, i2  => (v3)) := v22];
		v9 := (if (v16[119]) then v9 else v9) + v9;
		v7 := v7;
	}
	var v23, v24 := m0(v3, globalState);
	globalState.f21 := -v3;
	var v25, v26 := m0(v4[v3], globalState);
	var v27: seq<bool> := [v0];
	if (if (v16[119]) then v27[v3] else v16[119] <== v16[119]) {
		var v28: multiset<char> := multiset{v1};
		v28 := v28;
		v1, globalState.f1, v16[119] := v1, (multiset{--0xbd, fm0(v0, v3, |[v16[119]]|, v6[|v27| := v3], globalState), v3} + v9) <= multiset(v4), -v3 <= v3;
		...
		if (fm1(v16[119], if (v0) then v3 else 0x155, globalState)) {
			globalState.f21 := v4[v3] % v3;
			var v31: array<array<bool>> := new array<bool>[26];
			var v32: map<bool, array<bool>> := map[v23 := v16];
			v31[108] := if (v25 in v32) then v32[v25] else v16;
			var v33: seq<array<bool>> := [v16];
			v31[108] := v33[|(map v34 : int | v34 in v4[v3 := fm0(true, v3, 0x283, v6, globalState)] :: (v34 / v3) := (v3))|];
			v11 := v11;
			var v35: array<seq<int>> := new seq<int>[26];
			var v36: map<int, array<seq<int>>> := map[v3 := v35];
			v36 := v36[v4[0x18b] := v35];
			v29 := v29;
		} else {
			...
			var v41: seq<array<int>> := [v40[v3], v11];
		...
		v11[789] := v3;
		v11[789] := (v3 / |v27|) - (if (v23) then v3 else v3);
		var v47: map<bool, set<string>> := map[v23 := set v46 : string | v46 in v15 :: (v46)];
		var v48: set<string> := {v5};
		var v49: map<string, int> := map[v5 := v3];
		if (((if (v0 in v47) then v47[v0] else v48) - {seq(0x7e, i3  => (v1))}) > (v48 - fm50(v49, v3, globalState))) {
			var v50: multiset<char> := multiset{v1};
			var v51 := DC7(v50, v4, false);
			var v52 := DC86(v51.cf17, !v23, v11[789]);
			v25 := v52.cf172;
			v16 := new bool[25](i4 => v25);
			v23, globalState.f22, globalState.f10 := if (v16[119]) then v16[119] else v23, v0, v6;
			...
			v55[702] := v57;
			v55[702] := if (v56.f28) then v57 + v57 else v57[v3 := v57[v3]];
			v16[119] := v23;
			v16[119] := !v0;
			globalState.f1 := v16[119];
		}
		
		var v58: map<bool, int> := map[true := v11[789]];
		var v59: set<bool> := {v16[119]};
		var v60 := DC86(v4[v11[789] := |v4|], v25, -v11[789]);
		var v61: C8 := new C8(v23, v27, v25);
		var v62: multiset<C8> := multiset{v61};
		var v63: array<int> := new int[29] [-(v11[789] * v11[789]), -v3, -v11[789], v3, v11[789], 0x37a * v11[789], 0x360, |v5|, v11[789], v3, v3, if (v25 in v58) then v58[v25] else v11[789], |v5|, v3, if (v23) then |v9| else v11[789], v3, |"ttysfwlrs"|, v11[789], v11[789], v3 / 361, v11[789], v3, |(v59 * v59)|, |(v15 + v15)|, v60.cf173, v3, v3, if (v61 in v62) then v62[v61] else |(seq(0x157, i5  => (v58)))|, if (v16[119]) then v3 else 0x33f];
	...
	forall i6 | 0 <= i6 < v64.Length {
		v64[i6] := (map[|{v3}| := v0] + (map v65 : int | (0x116 <= v65) && (v65 < 533) :: (v65 / v3) := (true))) + (map[v3 := v16[119]] + map[-|v10| := v23]);
	}
	v23 := !v0;
	var v66, v67 := m0(|(seq(0x1e2, i7  => (v1)))|, globalState);
	var v68, v69 := m0(v3, globalState);
	if (v25) {
		globalState.f22 := v5 == v5;
		v1 := v1;
		var v70: set<bool> := {v68};
		globalState.f8 := (fm37(v0, v3, v70, globalState))[v3 * v3 := 'a'];
		globalState.f22 := v23;
		...
		v73[801] := if (v68) then v11 else v11;
		globalState.f16, v73[801], v3 := -|(v5 + v5)|, v11, -v3;
		globalState.f21 := v3 % (v3 * v3);
		v73[801] := if (v66) then v73[801] else v73[801];
		var v74: array<array<string>> := new array<string>[22];
		var v75: array<string> := new string[15] [v5, v5, fm12(globalState), v5, seq(-653, i8  => (v1)), v15[v3], v5, v5, v5, seq(-413, i9  => (v1)), v5, v5, "uaakof", v5, v5];
		v74[782] := v75;
		v74[782] := v75;
	}
