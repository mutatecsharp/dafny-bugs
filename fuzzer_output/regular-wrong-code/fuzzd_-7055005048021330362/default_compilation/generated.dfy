...
function fm5(p0: int, p1: int, p2: int, globalState: GlobalState): seq<int> {
	seq(0x21, i0  => (|((seq(0x19c, i1  => (map[true := false]))) + [map[false := false], map[false := false], map[true := !false]])|))
}
function fm6(globalState: GlobalState): int {
	(|"nasbdl"| * -|['h', 'k']|) % |((map v0 : int | (-0x8b <= v0) && (v0 < 404) :: (v0 % 0x99) := (map v1 : int | v1 in [741] :: (v1 / 0x125) := (!true))) + map[|{-|"u"|}| := map v2 : int | v2 in map[0x16 := 0xcb] :: (v2 - |map[true := true]|) := (false)])|
}
function fm9(p0: bool, p1: bool, globalState: GlobalState): map<seq<bool>, bool> {
	map v0 : seq<bool> | v0 in ((seq(-0x221, i0  => ([true, false, false]))) + [[true, true, false]]) :: (v0) := (!(!false <==> true))
}
...
function fm18(p0: int, p1: seq<int>, p2: int, p3: int, globalState: GlobalState): map<string, int> {
	map["rkakqfc" + "uhejkofsg" := |(if (false) then "olxnmwt" else seq(461, i0  => ('b')))|]
}
...
method m0(p0: array<bool>, p1: bool, globalState: GlobalState) returns (r0: bool) {
	...
	for i0 := -(|map[|v5| := v6]| * 582) to if (p1) then |v2| else v1 {
		if (p1) {
			...
			var v16: map<int, array<bool>> := map[v4[v1] := v15];
			var v17 := DC17(v16);
			var v18: map<int, int> := map[v1 := v1];
			var v19: array<int> := new int[20] [v1 + -i0, i0, v1 + i0, i0, fm6(globalState), |(v9 + v9)|, if (v8 in v10) then v10[v8] else v1, i0, v1, v1 - |v13|, 0x274, if (v1 in v5) then v5[v1] else |v14|, |(v16 + v17.cf30)|, i0, v1, v1, v1 / i0, if (v1 in v18) then v18[v1] else v1, v1 * |v8.f26|, i0];
			v19[378] := i0;
			var v20: array<char> := new char[9];
			v20[84] := v6;
			v19[378], globalState.f20, v20[84], p0[666], p0[666] := i0 + (if (v11.f28) then v1 else 468), i0 % |v2|, v6, !((v2 + v2)[v1 := v6] <= v2), v11.f27;
			var v21: T0 := new C3(p1, true, v2, p0[666]);
			var v22: map<T0, bool> := map[v21 := p1];
			var v23: seq<bool> := [v21.f22];
			var v24: map<bool, int> := map[v11.f28 := v1];
			var v25 := DC5(v21.f22, v24, v1, (multiset{0x17b})[v19[378] := |(seq(0x273, i1  => (v20[84])))|]);
			var v26 := DC8(|v23|, map[v14 := |v23|], v25, p1);
			var v27 := DC5(v26.cf16, v24, -v1, multiset{i0, v19[378]});
			var v28: seq<seq<int>> := [v4];
			var v29: T2 := new C2(v28, seq(0x25c, i2  => (v20[84])), v11.f28);
			...
			r0 := (if (|v42[v1]| in v41) then v41[|v42[v1]|] else v6) in v2;
		}
		...
		p0[286], v44 := (v1 - i0) in v4, if (!true) then p0 else v45[0x201];
	}
	...
	var v49: set<int> := {|v0|};
	var v50 := DC6(v49);
	var v51: seq<seq<int>> := [v4[v1 := v1], v4, v4];
...
class C1 {
	...
	method m3(p0: bool, p1: bool, p2: bool, globalState: GlobalState) {
		...
		var v6: multiset<bool> := multiset{!!v0, f25, p0, v5[fm6(globalState)], f25};
		var v7 := "ekkjfqs";
		v3[442] := v7 < v7;
		var v8: seq<seq<bool>> := [v5, v5, v5];
		v6, v0, v3[442] := v6, v5 == v8[|v7|], p0;
		var i0 := 0;
		while (v3[442])
			decreases 100 - i0
		{
			...
			if (v10.cf1) {
				...
				var v12 := new C0(v11);
				globalState.f3 := |(v7 + (seq(687, i1  => ('c'))))|;
				var v13: map<bool, int> := map[p1 := v1];
				var v14: seq<int> := [v1, |fm9(v0, p2, globalState)|];
				var v15: map<int, multiset<int>> := map[v1 := (multiset(v14))[v1 := v1]];
			...
			match (fm10(globalState)) {
				case DC4(cf4, cf5, cf6) =>
					...
					var v22: map<bool, map<array<D0>, int>> := map[v3[442] := v21];
					v22 := v22[f25 := v21];
					var v23: array<int> := new int[5];
					var v24: map<bool, array<int>> := map[false := v23];
					v24 := v24[p0 := v23];
					var v25: array<string> := new seq<char>[8](i3 => seq(-0x361, i4  => (cf4)));
					v25[96] := fm11(false, globalState);
					v25[96] := v7;
					v1 := -((v1 - v1) - cf6[v1]);
				case DC5(cf7, cf8, cf9, cf10) =>
					var v26 := 't';
					v0 := if (p1) then v26 !in "bdncgjj" else v3[442];
					v3[442] := v2 > (v2 - v2);
					var v27: seq<int> := [cf9, cf9];
					var v28: multiset<multiset<bool>> := multiset{v6};
					var v29: map<int, int> := map[v1 := cf9];
					v3[442] := fm12(|(v27 + v27)|, v6[v0 := cf9] * v6, v3[442], multiset{multiset{fm12(cf9, v6, p2, v28, globalState), p2}, multiset(v5), multiset{v5[v27[|v29|]], v0}, multiset{p0, f25}}, globalState);
					...
					v31 := map[cf10 := seq(786, i5  => (v26))] + v31;
				case DC3(cf3) =>
					v0 := (v1 * v1) <= v1;
		...
		v3[442] := (set v36 : int | v36 in v35[v1] :: (v36 - |{DC1(true).cf1}|)) != (v2 + v2);
		var v37: map<bool, int> := map[p2 := v1];
		var v38: multiset<int> := multiset{|v2|};
		var v39 := DC5(v3[442], v37, v1, v38);
		globalState.f3 := match v39 {
			case DC4(cf4, cf5, cf6) => |(if (v3[442]) then seq(0x1de, i6  => (cf6)) else seq(0x1b5, i7  => ([|{cf4}|])))|
...
class C2 extends T2 {
	...
	method m1(p0: bool, p1: map<map<int, bool>, array<bool>>, globalState: GlobalState) returns (r0: int) {
		...
		var v2: multiset<seq<int>> := multiset{f23[v0], v1};
		...
		if (true) {
			...
			var v12: array<array<bool>> := new array<bool>[6] [v9, v9, v9, v10.cf0, v9, v11[v0]];
			var v13 := DC1(f22);
			...
			globalState.f20 := |(v21 + v21[0xb6 := {v0, -v0}])|;
		}
		...
		var v26: array<int> := new int[15] [|v24|, v0, v0, v0, 0x1aa, v0 % v0, -v0, 834, v0, |v24|, v0, -0x19c, v0, v0, |v25|];
		v26[925] := |v1| * v0;
		globalState.f20, v0, globalState.f20, v23, v26[925] := |f23|, v0, --v0, v23, v0 / --|(v25 + v25)|;
		r0 := v26[925];
		var i1 := 0;
		while (false)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v27 := 'i';
			var v28: map<int, char> := map[v26[925] := v27];
			var v29: map<bool, int> := map[f22 := |v28|];
			var v30: set<seq<int>> := {fm5(v26[925], |[true]|, v0, globalState)};
			v26[925] := (|v29| - 914) - |(if (false) then v30 else {v1, [v0, v26[925], v0]})|;
			...
			var v38: multiset<string> := multiset{f21, f21[|v25| := v27], f21, f21};
			v37[214] := v38;
			var v39 := DC1(v32.f25);
			var v40: set<bool> := {v39.cf1, false, !f22, p0};
			var v41: map<C1, set<bool>> := map[v32 := v40];
			v37[214] := fm13(f22, v40, |f21| / |multiset{if (v32 in v41) then v41[v32] else v40, v40, {false, p0, v32.f25, v32.f25, v32.f25}}|, p0, globalState);
		}
		...
		f21, r0, v26, globalState.f20, globalState.f20 := f21 + f21, match v43 {
			case DC4(cf4, cf5, cf6) => v26[925] - DC5(f22, map[!f22 := |cf6|], |{f22, false}|, multiset{v0, |f21|}).cf9
			case DC5(cf7, cf8, cf9, cf10) => v0
			case DC3(cf3) => v26[925] + 0x1bb
		}, v26, v26[925] - v0, |(v44 + v44)|;
		var v45 := 's';
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: string, r1: bool) {
		...
		v1 := [v0[931] !in map[0x15e := |v2|], f22, f22 && f22];
		if (f22) {
			var v3: multiset<bool> := multiset{f22};
			globalState.f3 := if (!(if (!f22) then f22 else f22)) then fm6(globalState) % v0[931] else |v3|;
			var v4 := 'u';
			var v5: map<int, int> := map[|v3| := v0[931]];
			var v6: seq<int> := [v0[931]];
			var v7 := DC4(v4, v5, v6);
			v7 := v7;
			var v8: map<bool, int> := map[fm12(v0[931], multiset([f22]), f22, multiset{multiset{false, !true}, v3, v3, multiset{f22, f22, f22}, v3}, globalState) := -v0[931]];
			...
			globalState.f20 := v0[931] - |"etxvn"|;
			globalState.f12 := 'd';
			var v15: array<set<int>> := new set<int>[15](i0 => {v0[931]});
			var v16 := DC6({v0[931], p0});
			v15[983] := v16.cf11;
			var v17: map<bool, bool> := map[fm1(f21, true, false, globalState) := f22];
			v15[983] := fm14(v17, p0, globalState);
			match (v16) {
				case DC6(cf11) =>
					globalState.f20 := fm6(globalState) + (|f21| / v0[931]);
					v16 := v16;
					v17 := v17;
			...
			var v20: map<int, int> := map[v0[931] := p0];
			v19 := v19[v18 := v20];
		}
		
		if (true) {
			var v21: set<int> := {v0[931]};
			var v22 := DC6(v21 * v21);
			v22 := v22;
			...
			v25[184] := !((0xd3 == v0[931]) <==> (v26 !! multiset(v1)));
			r1 := f22;
			var v27: array<map<bool, int>> := new map<bool, int>[14];
			var v28: multiset<string> := multiset{f21, fm11(false, globalState), "bdbdchmi"};
			globalState.f20, v25[184], f22, v27 := if (f21 in v28) then v28[f21] else v0[931], v25[184], v25[184], v27;
		} else {
			...
			var v34: map<multiset<bool>, map<multiset<bool>, int>> := map[v30 := v33[-v0[931]]];
			v34 := v34[multiset{f22} * v30 := v33[v0[931]]];
			v1 := v1 + v1;
			if (!f22) {
				v0[931], f22, v0 := -(if (f22) then (if (f22 in v30) then v30[f22] else -0x3a8) + v0[931] else p0), f22, v0;
				...
				var v43: map<int, bool> := map[v0[931] := f22];
				f22 := |f21| <= (|v43| % v0[931]);
			...
			var v50: array<multiset<bool>> := new multiset<bool>[2](i3 => v30[f22 := p0]);
			...
			decreases 100 - i4
		{
			...
			v0[931] := p0;
			globalState.f20 := fm6(globalState);
			var v57: set<int> := {p0, v0[931], p0};
			var v58: map<bool, bool> := map[if (f22) then f22 else f22 := f22];
			var v59 := DC1(true);
			var v60 := DC2(v59);
			v57, r1, v58, v60 := fm14(map[if (!f22 in v58) then v58[!f22] else f22 := f22], |f21|, globalState) - v57, v1[|fm15(globalState)|], if (f22) then v58 else v58, v60;
		}
		var v62 := DC6(set v61 : int | (-0x19 <= v61) && (v61 < 428) :: (v61 % v0[931]));
		r0 := match v62 {
			case DC6(cf11) => f21
		};
		...
		var v67: map<int, array<bool>> := map[|v64| := v66[p0]];
	...
	method m4(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: array<array<char>>) {
		...
		for i0 := |f21| to p1 {
			...
			if (f27) {
				...
				var v4: set<string> := {"cafmfqmaf", seq(-524, i1  => ('m'))};
				var v5: C0 := new C0(v4);
				var v6 := DC10(v5);
				...
				v8, globalState.f3 := v8, if (true) then i0 / i0 else i0 / p3;
				f22 := false;
			} else {
				...
				var v14: map<int, set<int>> := map[|"mkm"| := set v13 : int | v13 in (seq(502, i2  => (0x2c7))) :: (v13 + -0x2fa)];
		...
		v21[690] := v22[p0];
		v21[791] := f27;
		v20, v21[690], v21[791], f28 := v20, f22, v22[-0x213], if (f22) then f28 || f22 else true;
		var v23: set<int> := {|(multiset([p2, p3]))[p2 := p0]|, p1};
		var v24 := DC6(v23);
		match (v24) {
			case DC6(cf11) =>
				globalState.f3 := p3;
				...
				v25 := v25;
				f28 := (seq(0x150, i4  => ('d'))) <= f21;
				var v26 := 't';
				var v27: set<string> := {seq(468, i5  => (v26))};
		...
		if ((seq(0x20e, i6  => (map v30 : int | (0x2a8 <= v30) && (v30 < 0x265) :: (v30 + p2) := (f27)))) < [v31, v31, map[p1 := f27], v31]) {
			var v32: array<seq<bool>> := new seq<bool>[5];
			v32[617] := v22 + [f22, v21[690], v21[690], v21[690]];
			v32[617] := (if (!f22) then v22 else v22) + v22;
			...
			var v39: multiset<bool> := multiset{v21[690]};
			var v40: multiset<multiset<bool>> := multiset{v39, v39, v39, v39, v39};
			var v41: map<bool, bool> := map[f27 := false];
			v34, globalState.f12, v20[331], globalState.f3 := v34, if (v36 < fm5(p3, |v38|, p3, globalState)) then f21[p0] else 'k', fm6(globalState) - |v32[617]|, if (fm12(p1, v39, f28, v40, globalState)) then fm6(globalState) else v36[if (v21[690] in v39) then v39[v21[690]] else -|v41|] + p3;
			var v42 := 'e';
			...
			match (v45) {
				case DC4(cf4, cf5, cf6) =>
					...
					v45 := v45.(cf3 := v44);
					var v46 := DC13(v34);
					v34, globalState.f3, f22 := v46.cf23, p3, if (f28) then f27 else f21 < (seq(-738, i8  => (v42)));
				case DC5(cf7, cf8, cf9, cf10) =>
					f22 := multiset(v32[617] + v32[617]) > v39;
					v21[690] := f22;
					f28 := cf7;
					var v47: seq<seq<int>> := [[|map[v22 := f22]|], v36, v36];
					var v48 := new C2(v47, f21, v36[|v32[617]|] >= 0x285);
				case DC3(cf3) =>
					var v49: set<bool> := {!f27, false, !v34.f25};
					v20[331] := (|v49| + -0x2fd) - p1;
					globalState.f20, v21[690], v42 := -((v20[331] * 0x36c) - (|map[false := |v22|]| % fm6(globalState))), v21[690], fm4(-v20[331] !in [p1], multiset{v34.f25, !f28, f27, f27, v34.f25}, globalState);
					f22 := !v34.f25;
					globalState.f3 := p0;
			}
			...
			var v66: array<seq<int>> := new seq<int>[27] [v54, seq(-664, i9  => (p2)), v55, [v57.cf9, p2, p0, |v54|], v54 + v59[p1], v55, v54, fm5(p3, p0, -0x171, globalState), v54 + v54, v55, fm5(p3, p3, -0x17b, globalState), [0x397], seq(588, i10  => (p1)), v55, v54, v54, v55, (((seq(766, i11  => (p2)))[p0 := |v65|])[p0 := p1])[|f21| := p0], v54, v54, v55, v54, [p1, |map[f27 := p1]|, p3, p2], [|v56|, p1], v54 + v55, v54, v54 + v55];
			v66[543] := [p0];
			v66[543] := v55 + v55;
			...
			match (v67) {
				case DC8(cf13, cf14, cf15, cf16) =>
					...
					globalState.f20, cf16, v57, cf16, f22 := if ((|f21| * p1) in v68) then v68[|f21| * p1] else -p3, f22, cf15.(cf9 := p2, cf10 := v73, cf8 := v56[f28 := if (false in v56) then v56[false] else p1]), v21[690], f22;
					var v74: map<bool, bool> := map[!cf16 := |v68| != p1];
					v74, v70, f28, v74 := v74, v70, cf16, v74 + v74;
					f28, f22 := v21[690] && (if (f28) then v61.f25 else f28), f27;
				case DC9(cf17, cf18, cf19) =>
					var v75: seq<array<multiset<bool>>> := [v60];
					var v76 := new C1(v75[cf18], v21[690] || f27);
				...
				case DC7(cf12) =>
					...
					v79 := v79[f27 := v61.f25];
					var v80: array<string> := new string[11] [f21, (fm11(f22, globalState))[668 := v51], "jnsquovwx", f21 + "ittgfr", "cqonwvi" + f21, "xwfxaqtqq", "mt", seq(0xf2, i12  => ('v')), (seq(-696, i13  => (v51))) + f21, f21, f21];
					v80[733] := (seq(-0x7a, i14  => (v51))) + "kmvw";
					v80[733] := f21;
					v55 := seq(301, i15  => (0xde));
			}
			
			v21[690] := true;
			var v81: seq<multiset<multiset<bool>>> := [multiset{v63}];
			v62 := v62[fm12(p2, multiset{f27, f22, v61.f25, fm12(p1, v63, f27, multiset{v63}, globalState), fm12(|f21|, multiset{f22, f28}, f22, v64, globalState)}, f22, v81[-0x3d3], globalState) := v61];
		}
...
method Main() {
	...
	var globalState := new GlobalState(false, map v0 : string | v0 in v2 :: (v0) := (|[0x119]|), -0x292, 2, -0x2c8, true, (("v")[-v3 := v4])[v3 := v4], true, v1, v1, 0x380, true, 'c', -0x9e, 316, -0x28e, v5, v6, false, v7, 0x134);
	var v8 := false;
	var i0 := 0;
	while (!!v8)
		decreases 100 - i0
	{
		...
		v9[512] := v5;
		v3, v9[512], globalState.f20 := v3 - (if (v8) then v3 else v3), v5, v3;
		globalState.f20 := v3;
		v3 := v3;
	...
	if (v8) {
		...
		var v17: map<bool, C2> := map[fm12(v3, v13, v12.f25, v14[v13 := |v1|], globalState) := v16];
		...
		globalState.f3, v18, globalState.f3, v8 := v3, v18, v3 / v3, v19 !in v20;
		...
		var v24: map<int, bool> := map[v6[347] := v8];
		var v25: multiset<multiset<bool>> := multiset{v23};
		var v26: array<multiset<bool>> := new multiset<bool>[27] [v23, multiset{true}, v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, v23, multiset{v8, v8, v8}, v23, v23, multiset{v8}, multiset{v8, v8}, multiset{v8, v8}, multiset{v8, v8, fm12(v3, multiset{v8, true, if (v3 in v24) then v24[v3] else v8}, !fm12(v3, multiset{v8, v8}, v8, v25, globalState), v25, globalState)}, v23, fm17(v6[347], v8, globalState), multiset{v8, v8, v8}, v23, v23, multiset{v8}, v23];
		var v27: map<bool, int> := map[fm12(|map[v8 := v3]|, v23, v8, v25, globalState) := v3];
		var v28: C1 := new C1(v26, v6[347] >= |v27|);
		var v29: seq<bool> := [true, v8];
		var v30 := DC7(multiset(v29));
		v28, v6[347], v30, v8 := v28, if (v3 >= v3) then |(v2 + v2)| else -0x31a, v30, (|v22| % v3) >= v3;
	...
	match (if (fm12(v3, v38, v8, v39, globalState)) then v41 else v41) {
		case DC1(cf1) =>
			...
			var v46: C1 := new C1(v45[0x268], v8);
			var v47: seq<C1> := [v46, v46, v46];
			v6[881], globalState.f20 := v3 + |v47|, v3 - -0x312;
			v6[881] := 0x2d3;
			var v48: array<T0> := new T0[19];
			var v49: T0 := new C3(v46.f25, v8, ("r")[-v3 := v4], false);
			v48[947] := v49;
			v48[947] := v49;
		...
		case DC0(cf0) =>
			...
			if (v57 < v57) {
				...
				var v63 := DC14(v61);
				var v64: array<T2> := new T2[28] [v53, v53, v53, v53, v53, v58[-v3], v53, v53, v53, v53, if (v59 in v60) then v60[v59] else v53, v53, v53, if (v53.f22) then v53 else v53, v53, v53, v53, v53, v58[if (v63.cf24 in v62) then v62[v63.cf24] else v3], v58[|v53.f21|], v53, v53, v53, v53, v53, v53, v53, v53];
				v64[357] := v53;
				var v65: seq<string> := [v53.f21, v1];
				var v66: map<bool, int> := map[v61.f28 := v3];
				var v67: map<map<bool, int>, int> := map[v66 := v3];
				var v68: array<string> := new string[14] [v65[|v67|], v1, v53.f21, v1, v53.f21, fm11(v61.f27, globalState), v53.f21, v53.f21, v53.f21, v1, fm11(v61.f28, globalState), v53.f21, seq(434, i4  => (v4)), v53.f21];
				var v69: multiset<array<string>> := multiset{v68};
				var v70: set<array<int>> := {v6, v6, v6, v6, v6};
				v6[657], v5[483], v64[357] := if (v68 in v69) then v69[v68] else v3, v70 !! (v70 * {v6}), v53;
				...
				v53.f21, v73, v76 := fm11(v73.fm1(v1, v5[483], v61.f27, globalState), globalState), v73, v76;
				var v77: map<int, bool> := map[v6[657] := v73.f22];
				...
				var v82: C4 := new C4(v75, true ==> v8, fm16(v81, v61.f28, v8, globalState), ("lpt")[v3 := v4], v53.f22);
				v5[483], v80[193], v82 := v82.fm1(v1, !v82.f30, v61.f28, globalState), v4, v82;
			} else {
				v53.f22 := v57[|(if (v53.f22) then v51 else fm5(-fm6(globalState), v3, 109, globalState))|];
				globalState.f20 := v3;
				v8 := v8;
				...
				v86 := v86[v84 := v57[fm6(globalState)]];
		...
		case DC2(cf2) =>
			...
			v6[775] := v3;
			globalState.f20 := fm6(globalState);
			var v87: seq<int> := [v6[775], v3];
			globalState.f20, globalState.f3 := v3 + v3, v87[v3];
			var v88: set<int> := {v6[775]};
			var v89: seq<set<int>> := [v88];
			var v90 := DC6(v89[v3]);
			var v91: seq<seq<int>> := [v87, v87];
			var v92: T1 := new C4(v90.(cf11 := {v6[775]}), v8, v91, seq(-0x25, i5  => (v4)), fm6(globalState) in v87);
	...
	var v96: array<multiset<array<bool>>> := new multiset<array<bool>>[25] [v93, v93, v93, v93 * DC15(v93).cf25[v5 := v3], v93, multiset{v5, v5}, v93 - v93, v93, v93, v93, v93, v93 + v93, v93, if (if (v3 in v94) then v94[v3] else !v8) then v93 else v93, v93, multiset{v5}, v93, if (fm12(0x23c, multiset{v8, v8, v8, v8, v8}, v95[|v1|], multiset{v38}, globalState)) then v93 else v93, DC15(v93).cf25, v93, v93, v93[v5 := v3], v93, v93 + v93, multiset{v5} + v93];
	v96[543] := multiset{v5, v5} + v93;
	v96[543] := (v93[v5 := |v94|] + v93) - v93;
	var v97: set<int> := {v3, v3, |"ly"|};
	var v98 := DC6(v97);
	var v99: seq<int> := [v3];
	var v100: C4 := new C4(v98, v8, [[v3], v99, ([v3])[v3 := v3]], v1, true);
	...
	for i6 := v3 to -|v102| {
		...
		var v104: seq<seq<int>> := [v103[v3]];
		var v105 := new C2(v103, v1 + v1[i6 := 'u'], v3 >= v3);
		var v106: seq<map<int, bool>> := [v94];
		var v107 := v105.m1(v100.f30, map[v106[840] := v5], globalState);
		v8 := v100.f30;
		v99 := v99;
	}
	v8 := v100.f30;
	...
	v3 := |v112| % DC8(v3, v113, v114, v8).cf13;
	for i7 := 0x56 / v3 to v3 {
		...
		v108[578] := v1[|(multiset{v1} * v116)|];
		v3 := |v38[v111.f25 := -(v3 + 0x3d8)]|;
	}
