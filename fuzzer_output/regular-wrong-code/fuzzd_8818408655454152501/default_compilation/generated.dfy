...
function fm0(p0: int, globalState: GlobalState): bool {
	"gmyjs" < (seq(0x2e7, i0  => ('o')))
}
function fm1(p0: bool, globalState: GlobalState): seq<bool> {
	[{set v0 : int | (-0x1d6 <= v0) && (v0 < 0x46) :: (v0 % -241), {0x268}, {0x2c, |multiset{[766, 916, |multiset{!!true}|, 948]}|, 194}, {|(seq(-194, i0  => ('u')))|, -|map[|map[!true := true]| := |[false]|]|}} <= {set v1 : int | v1 in map[-0x226 := false] :: (v1 / |"owyrbapmv"|)}, multiset{[DC5(), DC5()]} >= multiset{[DC5()], [DC5()], seq(0x283, i1  => (DC5())), [DC5()]}, multiset{false} >= multiset{false}, |{|multiset{true}|, |"magrhjlxm"|}| != -0x258, true <== !false]
}
function fm2(p0: int, p1: int, globalState: GlobalState): string {
	((seq(0x39f, i0  => ('m'))) + (seq(20, i1  => ('l')))) + "o"
}
...
function fm6(globalState: GlobalState): seq<string> {
	["x" + (seq(0x124, i0  => ('q'))), "dutfa", "qorshhqg", (seq(0x6f, i1  => ('r'))) + "sqdlj", "dveovbd"]
}
...
function fm18(globalState: GlobalState): int {
	|map[0xbf := DC13(-0x1e4, true, false, false).cf19]| / 0x37a
}
function fm19(p0: bool, globalState: GlobalState): seq<int> {
	(if (true) then DC8([|{false}|, 0xa6, 0x2cc, |[false]|, |"dkqc"|]) else DC8(seq(0x16, i0  => (0x4f)))).cf11
}
...
function fm22(p0: set<int>, p1: int, globalState: GlobalState): D4 {
	DC13(|((seq(0x3ba, i0  => ('g'))) + "cvhr")|, !true, true, true)
}
function fm25(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): D1 {
	match DC37(map[0x2 := |(seq(0xc8, i0  => ('c')))|]) {
		case DC38(cf58) => DC5()
		case DC37(cf57) => DC5()
	}
}
function fm27(p0: bool, p1: map<int, string>, globalState: GlobalState): set<int> {
	{0x3aa + |multiset(seq(0x26, i0  => (499)))|, 0x21e, if (!true) then -|{false, true}| else |multiset([false, true, false])|}
}
...
function fm29(p0: seq<char>, p1: bool, p2: int, p3: string, globalState: GlobalState): seq<int> {
	([0x1e4] + [|(set v0 : int | (993 <= v0) && (v0 < 0x8e) :: (v0 % |(map v1 : int | v1 in (set v2 : int | (0x174 <= v2) && (v2 < 544) :: (v2 % |map[true := true]|)) :: (v1 + |map[true := "crkbo"]|) := (false))|))|]) + ([|(seq(0x197, i0  => (0x125)))|] + [-0xd, -|multiset{true, true}|, -|(seq(0x302, i1  => ("bjkrgyb")))|])
}
...
function fm34(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): D4 {
	if ((seq(0x5f, i0  => (|[-843]|))) < [DC44(404, true, "sdtgfltt", !true, [set v0 : int | (-0x3e6 <= v0) && (v0 < 189) :: (v0 + -224), set v1 : int | v1 in multiset{0x1ac, |[0x157]|} :: (v1 - -0x3d7)]).cf63, 0x175, 0xfc, -0x18f, -973]) then DC11(set v2 : int | v2 in multiset{|"kft"|, |"vdsnhhe"|} :: (v2 % -|(seq(0x10c, i1  => (|multiset{!false}|)))|)) else DC11({|multiset{false, !true}|})
}
...
function fm36(p0: bool, p1: map<int, bool>, p2: char, globalState: GlobalState): map<int, bool> {
	map[|multiset{DC50(DC17(|map[true := true]|, true), true, "jydkg")}| / 365 := true]
}
...
function fm42(p0: int, globalState: GlobalState): D0 {
	DC3(|(set v0 : map<bool, bool> | v0 in multiset{map[false := false], map[true := true], map[false := true]} :: (v0))| / 439, DC44(|"vbu"|, false, "newukpfn", true, [{0x1fc}, {--0x161, |map['j' := false]|}]).cf64)
}
...
function fm46(p0: int, p1: bool, p2: bool, globalState: GlobalState): D10 {
	DC29(|(seq(0x31f, i0  => ('o')))| >= |multiset{|multiset{true, false, !false}|}|, 'e' !in "aif", |"djacvwmb"|)
}
function fm47(p0: bool, p1: int, p2: int, p3: char, globalState: GlobalState): set<int> {
	if (if (true) then true else true) then if (false) then set v0 : int | v0 in [|map[map[0x13f := true] := -0x61]|, 0xd8] :: (v0 * |(seq(0x1dc, i0  => ('i')))|) else {0x97, 219} else {|[true]|, |"mgaketdgp"|} * {|map['f' := -0xd]|}
}
function fm48(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): map<bool, multiset<char>> {
	map[|(map v0 : int | v0 in {|(seq(-0x6d, i0  => (|map[132 := {false, false}]|)))|} :: (v0 * |map[|{false, false}| := -|multiset{'r'}|]|) := (|"wdm"|))| < -844 := multiset(if (false) then ['j', 'o', 'k'] else ['b', 'v'])]
}
...
function fm57(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<int, int> {
	map[if (!false) then 874 else |(seq(-241, i0  => (DC14(DC14(DC11({|"kffsxfa"|}))))))| := -(0x256 % 0x34b)]
}
function fm58(p0: seq<char>, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<seq<char>> {
	((seq(0x30a, i0  => (['c']))) + (seq(0x273, i1  => (['p', 't', 'g', 'g'])))) + ([['j', 'p'], ['t'], ['v', 'q']] + (seq(0x20c, i2  => (['c']))))
}
function fm59(p0: string, p1: D4, globalState: GlobalState): map<string, int> {
	map v0 : string | v0 in ((set v1 : string | v1 in {"i", seq(0x293, i0  => ('f'))} :: (v1)) + {"n", "no", "cplx"}) :: (v0) := (|(map[true := !true] + map[!true := !true])|)
}
function fm60(globalState: GlobalState): D6 {
	match DC41(map[-|"fij"| := !!true]) {
		case DC41(cf60) => DC19(DC3(|map[false := false]|, true), |(seq(0x1fd, i0  => ('l')))|)
	}
}
...
function fm63(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): multiset<set<int>> {
	multiset{{0x1ea, 0x116}, {-498, 0x2f0}, {|"j"|, --|map[[0x3bc] := true]|}, {|(seq(0xb2, i0  => (-0x76)))|}} + multiset{{-0x336}, {DC3(|(map v0 : int | v0 in [|[|(seq(0x304, i1  => ('r')))|, |[false]|]|, |map[false := -862]|] :: (v0 + |{true, false}|) := (!true))|, true).cf4}, {|"kyskdkmkh"|, |map[|map[-0x52 := --|map[true := map[|"faso"| := true]]|]| := "huu"]|}}
}
...
function fm67(p0: bool, p1: int, p2: map<multiset<int>, set<bool>>, globalState: GlobalState): set<string> {
	match DC63(562, "bikakvgqv", 0x34f, 0xae) {
		...
		case DC64(cf100) => {"kgkdbmw", "coc"} - (set v1 : string | v1 in [seq(825, i0  => ('p'))] :: (v1))
		case DC61(cf94) => {seq(0x13e, i1  => ('r')), "isxpgybe"}
	}
}
function fm68(p0: bool, p1: bool, p2: string, p3: char, globalState: GlobalState): seq<D1> {
	((seq(0x91, i0  => (DC4([true, false, true])))) + [DC4([true, true])]) + ([DC4([true])] + [DC4([false, true])])
}
function fm69(p0: bool, globalState: GlobalState): seq<multiset<bool>> {
	DC65(seq(-685, i0  => (multiset{false, !!true}))).cf101
}
...
function fm72(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): seq<seq<int>> {
	match DC40() {
		case DC40() => [[|[677]|], [-|(seq(0x35c, i0  => (|{true}|)))|, 0xaf]]
		case DC39(cf59) => [[|"j"|]] + [seq(0x25e, i1  => (|[DC29(true, true, |map[|map[false := 0x114]| := 'h']|)]|)), [|(seq(-0x216, i2  => ('d')))|]]
	}
}
...
method m0(globalState: GlobalState) returns (r0: array<bool>, r1: array<int>, r2: bool) {
	...
	v3[360] := v4;
	var v5 := 'e';
	globalState.f12, globalState.f10, v2, v3[360], v1 := v0, v4, v2 + v2, (v4 + v4)[-|v4| := v5], v1;
	var i0 := 0;
		...
		decreases 100 - i2
	{
		...
		i2 := i2 + 1;
		v1 := -|(seq(0x274, i3  => ('r')))|;
		var v15: multiset<int> := multiset{-v1, v1 / 0x141, v1};
		v15 := v15;
		v14[149] := v0;
		v14[149] := v0;
...
class C0 {
	...
	function fm26(p0: int, p1: bool, globalState: GlobalState): int {
		match DC14(DC12()) {
			case DC12() => |[!!false]|
			case DC13(cf19, cf20, cf21, cf22) => |(if (cf20) then [{0x164}, DC11({cf19}).cf18] else [{cf19}, set v1 : int | v1 in (set v0 : int | (345 <= v0) && (v0 < 0x206) :: (v0 + cf19)) :: (v1 / 274), {-|"crfbyfmc"|}, {cf19}])|
...
class C1 extends T1 {
	...
	method m4(p0: D1, globalState: GlobalState) {
		...
		v0 := (-|v2[f25 := v1]| / f25) / |([v3] + v4)|;
		v1 := if (v1) then !v1 else v1;
		var v5: map<bool, char> := map[v1 := 'x'];
		v5 := v5[v1 := v3];
		var v6: map<int, int> := map[v0 / |v4| := 0x1ef];
		v6 := v6[-v0 + v0 := v0];
		...
		v9[724] := v7;
		var v10 := DC5();
		v9[724], globalState.f12 := v7, match v10 {
			case DC5() => v2[v0]
	...
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
		if (p1) {
			...
			var v2: map<bool, int> := map[p1 ==> p1 := v1[f25] % f25];
			var v3: multiset<bool> := multiset{fm0(f25, globalState), p1, p1};
			v2 := v2[p1 := |v3|];
			var v4: map<int, int> := map[-f25 := v1[f25]];
			...
			if (if (v7 in v8) then v8[v7] else f25 > f25) {
				...
				v10 := v10[p1 := v11[|v13|]];
				var v14 := DC4(([p1])[f25 := p1]);
				v11 := v14.cf6;
				globalState.f10 := ((seq(0x1bb, i0  => (v12))) + ((seq(0x389, i1  => (v12))) + v9))[f25 := v12];
				v4 := v4[-679 := |v11| * f25];
				v2 := v2[false := f25];
			} else {
				globalState.f12 := !(p1 || p1);
				var v15 := "pntpd";
				var v16: map<int, bool> := map[f25 := (seq(0x18c, i2  => ('q'))) != v15];
				v16 := v16[f25 % f25 := f25 >= |v3|];
				r0 := f25 - (if (true) then f25 else f25);
				var v17: multiset<int> := multiset{f25, f25};
				var v19 := DC15(v17[f25 := f25]);
				var v20: array<multiset<int>> := new multiset<int>[29] [v17, fm32(f25, globalState), v17, v17[f25 := |(map v18 : int | (293 <= v18) && (v18 < 0x2b6) :: (v18 - f25) := ('i'))|] - multiset{f25}, v17 + v17, v17, v17, v17, multiset{f25, fm31(v15, globalState), f25, f25}, v17, v17, v17, v17 - v17, v17, multiset(v1), v17, v17, v17 * multiset{f25, f25, -|v17|, f25, f25}, v17, if (fm0(f25, globalState)) then (multiset{|v15|})[fm31(v15, globalState) := f25] else v17[f25 := 0x93], v17 * v17, v17, v17, fm32(|(seq(0x2bd, i3  => ('f')))|, globalState), v17 * v19.cf24, v17, v17, v17, v17];
				var v21: array<int> := new int[26];
				v20[382] := multiset{f25} * fm32(|[v21]|, globalState);
				v20[382] := v17;
				var v22: seq<bool> := [p1];
				var v23: set<int> := {f25, fm31("htgrnhtir", globalState)};
				var v24: map<bool, bool> := map[v22[f25] := v23 >= {697, f25, f25, f25}];
				var v25 := DC6(fm33(f25, !p1, f25, globalState), p1, v15);
				v24 := v24[false := v25.cf8];
			}
			
			var v26 := "mqhshe";
			r0 := fm31(v26 + (seq(898, i4  => ('w'))), globalState);
		} else {
			r0 := f25;
			var v27: array<int> := new int[26](i5 => i5 % f25);
			v27[69] := f25;
			var v28 := "hy";
			var v29: seq<int> := [|v28|];
			var v30: seq<seq<int>> := [v29];
			var v31: array<seq<seq<int>>> := new seq<seq<int>>[7] [v30, v30, v30, v30, v30 + (seq(0x188, i6  => ([f25, -f25]))), v30, v30[f25 := v29]];
			v31[450] := v30;
			var v32: array<bool> := new bool[29];
			v32[13] := fm33(f25, !true, f25, globalState) in v28;
			...
			r0, r0, v27[69], v31[450], v32[13] := |[f25]| * f25, (f25 + f25) / f25, |v33| / f25, v30, v39 < v39;
			v32[13], globalState.f12 := p1, v27[69] != f25;
			v36 := v36;
			globalState.f12 := fm0(f25 * v27[69], globalState);
		}
		...
		for i8 := f25 to f25 {
			match (v42) {
				case DC12() =>
					...
					v45[730] := v50[fm31(v40, globalState)];
					r0 := i8;
					globalState.f12 := p1;
				...
				case DC11(cf18) =>
					...
					v55, r0, globalState.f23 := v55, if (p1) then f25 else |(seq(0x227, i9  => (-i8)))|, fm33(f25, !p1, f25, globalState);
					globalState.f12 := fm0(-i8, globalState);
					r0, r0 := i8, -((f25 / |v40|) / 0xe2);
					var v56: multiset<bool> := multiset{p1};
					var v57 := DC2(true);
					var v58: set<bool> := {p1};
					v56, globalState.f12 := v56[!v57.cf3 := i8], !((v58 - v58) > v58);
				case DC14(cf23) =>
					var v59: array<int> := new int[16];
					v59[482] := -f25 * f25;
					var v60: multiset<int> := multiset{f25 - f25};
					v59[482], globalState.f12, globalState.f10, globalState.f12 := |v60|, p1, v40, (|(multiset{p1})[p1 := |v60|]| + i8) == i8;
					globalState.f12 := --f25 != v59[482];
			...
			var v67 := DC8(v66);
			var v68: seq<bool> := [p1];
			var v69: array<seq<int>> := new seq<int>[11] [seq(0x1b1, i11  => (f25)), seq(0x29f, i12  => (i8)), v66, v66, v67.cf11, [f25, |v68|], v66, v66, v66, v66, v66];
			v64[108] := v69;
			v64[108] := v69;
			if (false) {
				globalState.f10 := (v40 + v40) + v40;
				globalState.f12 := false;
				var v70: array<int> := new int[18](i13 => i13 / |map[p1 := 'j']|);
				v70 := v70;
				var v71 := 'k';
				r0 := |((v40 + (v40 + v40[i8 := v71]))[-f25 := fm33(|v68|, p1, f25, globalState)])[f25 := if (false) then v71 else v71]|;
				var v72 := new C0();
			} else {
				r0 := |v66|;
				globalState.f12 := p1;
				var v73: map<int, string> := map[i8 := v40];
				v73 := v73[f25 := v40 + (seq(0x2b0, i14  => ('f')))];
				var v74: array<D5> := new D5[22];
				v74 := v74;
				globalState.f10, r0, v45 := (v40 + (seq(0x2eb, i15  => ('h')))) + "gltbwdt", f25, v45;
			}
...
class C2 {
	...
	method m16(globalState: GlobalState) returns (r0: int, r1: int, r2: seq<int>, r3: D1) {
		...
		for i0 := v0 to -v0 + fm24(v0, globalState) {
			...
			var v5: map<array<D3>, int> := map[v4 := |(seq(416, i2  => ('n')))|];
			v3[66] := v5;
			var v6 := 'f';
			var v7 := false;
			var v8 := DC6(v6, v7, v2);
			v1[178], v3[66] := v8.cf9, v5;
			if (v7) {
				globalState.f12 := fm0(i0, globalState);
				var v9: array<bool> := new bool[16];
				v9[419] := !v7;
				v9[419] := fm0(v0 / i0, globalState);
				var v10: array<int> := new int[16](i3 => i3 * 0x3d5);
				v10 := v10;
				var v11: map<int, bool> := map[|(seq(0x375, i4  => ('e')))| * v0 := i0 < 0x2c4];
				var v12: seq<bool> := [v7];
				v11 := v11[-v0 := v12[i0]];
				var v13 := DC5();
				var v14: array<D1> := new D1[20] [v13, DC5(), v13, v13, v13, if (v7) then v13 else v13, v13, v13, v13, fm25(v7, v9[419], i0, v9[419], globalState), DC5(), v13, DC5(), v13, if (!v9[419]) then v13 else fm25(v7, v7, i0, v7, globalState), v13, v13, v13, fm25(v7, v7, 0x99, v7, globalState), v13];
				v14[186] := v13;
				v14[186] := v13;
			} else {
				r1, globalState.f12, r1 := v0, v7, v0 + i0;
				globalState.f10 := (v1[178] + v1[178]) + v1[178];
				globalState.f12 := v7;
				var v15 := new C0();
				var v16: set<int> := {i0};
				var v18: set<set<int>> := {v16, v16, v16 - fm27(v7, map v17 : int | (0x1d6 <= v17) && (v17 < -0x303) :: (v17 / v0) := (v1[178]), globalState)};
				v18 := v18;
			}
		...
		if (fm0(-0x3bf, globalState)) {
			...
			var v25 := false;
			var v26: map<int, bool> := map[-v24[v0] := v25];
			var v27: multiset<map<int, bool>> := multiset{map[v24[v0] := v25], v26};
			globalState.f12 := !(v27 <= v27);
			var v28 := new C0();
			v0 := -fm23(fm28(v25, v0, v23, v0, globalState), v25, v25 <== fm0(v0, globalState), globalState);
			var v29: array<int> := new int[12](i6 => i6 / v0);
			v29[359] := v0;
			v29[359] := v0;
			globalState.f12 := v25;
		} else {
		...
		for i7 := -0x144 - v0 to v0 {
			...
			v57 := v57[v55 := v56 <==> v58[i7]];
			v53[588] := 0xb6;
			var v59 := "bunpdm";
			var v60: multiset<int> := multiset{|v59|};
			v56, globalState.f10, v53[588], r1, v57 := v56 ==> v56, v59 + v59, if ((if (v56) then i7 else i7) in v60) then v60[if (v56) then i7 else i7] else -i7, -v0, v57;
			...
			decreases 100 - i9
		{
			...
			if (v64) {
				...
				var v77: array<string> := new string[7] ["qu", seq(0xc6, i11  => ('y')), v73, (seq(-519, i12  => ('b')))[|v74| := v75], seq(219, i13  => (v75)), v76.cf9, v73];
			...
			decreases 100 - i14
		{
			...
			v84 := v84[0x56 - |v85[v81 := fm23(v86, v81, v81, globalState)]| := v81];
			var v87: multiset<string> := multiset{v82, v82, v82};
			var v88: seq<bool> := [true, v81, v81, v81];
			var v89: map<bool, char> := map[v81 := v83];
			var v90: array<int> := new int[7] [v0 % v0, v0, if (v82 in v87) then v87[v82] else v0, |(v88 + v88)|, v0, |v89| / v0, v0];
			v90[183] := |v82|;
			r1, v83, v90[183], v0 := -v0 + 3, v83, (-v0 % v0) % v0, v0 % v0;
		}
		r0 := v0;
		r1 := v0;
		var v91: seq<bool> := [true];
		var v92: multiset<bool> := multiset{v91[|v91|]};
		var v93: map<int, bool> := map[630 := v81];
		var v94: map<int, map<int, bool>> := map[v0 := v93];
		r2 := (([v0, -v0])[|v92| * v0 := v0 / |v94|])[v0 := if (v81) then v0 else v0];
		var v95 := DC4([v81]);
	...
	method m17(p0: bool, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<int>, r1: int) {
			...
			decreases 100 - i0
		{
			...
			var v9 := new C0();
			var v10: array<string> := new seq<char>[1] [seq(0x119, i1  => (v7))];
		...
		var v19: seq<int> := [|v18|];
		r1 := |(if (fm0(v3, globalState)) then v19[v3 := v3] else [-0x28])| / -753;
	}
}
...
class C3 extends T0 {
	...
	method m2(p0: array<array<bool>>, p1: bool, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		if (p2) {
			...
			var v17 := DC21(p3);
			v10, v13, v15[460], globalState.f12, v16 := v10, v13, v14, p1 <==> v1[355], v17.cf32;
			var v18: map<bool, int> := map[f25 > f37 := -(f25 % f25)];
			v18 := v18[f38 := f25];
			var v19 := 'p';
			...
			var v23: map<int, string> := map[f25 := seq(112, i1  => (v19))];
			var v24: array<string> := new string[12] [v4 + v4, v4 + v4, "b", v4, v4, v4, if (f37 in v23) then v23[f37] else v4, v4 + v4, v4, v4, seq(0x25b, i2  => (v4[-f25])), v4];
			var v25: map<int, int> := map[f25 := |v9|];
			r1, v24, v1[355], r1 := f37 / f25, v24, v1[355], (if (fm0(f37, globalState)) then |v12| else v3.fm26(0x1, v1[355], globalState)) / (if (f25 in v25) then v25[f25] else f37);
		} else {
		...
		if ((if (true) then v1 else v1) in v32.cf35) {
			...
			match (v35.(cf10 := v34)) {
				case DC5() =>
					...
					r1, globalState.f12, v46[196], globalState.f12, v48 := if (!v33[f37] && f38) then |v49| * -f37 else f25, p1, v38, !f38, v48;
					globalState.f10 := "xehpc" + (v36 + f26[802]);
					p3[587] := f25;
					var v50: map<int, int> := map[877 := |v33|];
					p3[587] := -(v3.fm26(|v36|, !true, globalState) - -v3.fm26(-f37, !v33[if (0x6b in v50) then v50[0x6b] else f25], globalState));
				case DC6(cf7, cf8, cf9) =>
					var v51 := DC16(!p1);
					v51 := v51;
					r0 := f25 + f37;
					globalState.f10 := cf9;
					var v52: set<int> := {|(seq(-429, i3  => (cf7)))|, f25};
				...
				case DC7(cf10) =>
					...
					v60[555] := fm42(|v61|, globalState);
					v1[43] := false;
					var v62 := DC3(f25, p1);
					var v63 := DC19(v62, f25);
					var v64 := 'm';
					v59, v60[555], v1[43], v63, globalState.f23 := v59, v62, (!f38 in v33) <== f38, v63.(cf29 := v62), v64;
					var v65: array<seq<bool>> := new seq<bool>[18](i5 => v33);
					var v66: seq<seq<bool>> := [v33, v33];
					v65[485] := [p2] + v66[f37];
					var v67: map<char, bool> := map[v64 := v1[43]];
					...
					v69[869] := v71[f37] + map[v64 := f38];
					v65[485], v1[43], v1[43], v69[869] := v33, f37 == (if (p1) then f37 else f25), p1, map[v64 := fm0(f25, globalState)] + v67;
					var v72: seq<int> := [f37];
			...
			var v93: map<bool, int> := map[p2 := v88[|v87|]];
			var v94: seq<bool> := [p2, false];
			var v95: set<bool> := {p1};
			var v96: array<int> := new int[27] [f37, f25, f25 / -0x32e, -0x149, |(v86 + v86)|, -(|v87| * f25), f25 * f37, f25 / 0x6e, f25, v3.fm26(f37, p1, globalState), f25, v88[if (v89 in v90) then v90[v89] else f25], --v91.cf17 / f25, 662, |v87|, f25, f25, f25, f25, -(f25 % f25), 40, |v92|, v3.fm26(f25, f38, globalState), f37, v3.fm26(f25, p1, globalState) * f25, if (p2 in v93) then v93[p2] else |v94|, |v95|];
			...
			p3[613] := |v95|;
			p3[613], globalState.f12, r0 := |(v87 + "rxowgeyge")|, p2, f25;
			globalState.f23 := v84;
		}
	...
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		var v6: seq<bool> := [p1];
		var v7: array<int> := new int[20] [|v3|, f37, 0x321, f25, f37, 355, f37, f37, f25, f25, f25, f25, f25, f37, f25, f25, -v0[|(v3[f25 := v4])[|v5| := v4]|], |v6|, f25, f25];
		...
		var v14: array<int> := new int[20] [-f37, f37, |(v0 + [f37, f25])|, f37, if (f38) then 0x29a else f37, if (p1) then f25 else f25, f25 * |v8|, |v9|, |v1|, f37, f25, 0x2ad + f37, f25, 0x268 / -0x60, f37 - -|v10|, f37 - f25, 0x3d3 + f25, f37, f25, |((if (f38 in v13) then v13[f38] else v12) + [v11, v11])|];
		v7[314] := 764;
		v7[314] := 919;
		r0, v7[314] := |(v3 + ((seq(0x2a, i0  => (v4))) + v3))|, f37;
		if (fm0(f37 % f25, globalState)) {
			match (DC8(v2)) {
				case DC8(cf11) =>
					...
					var v20: array<map<bool, bool>> := new map<bool, bool>[26] [v15, if (p1 in v16) then v16[p1] else v15, v15, v15, v15, v15, map[p1 := p1], if (v14 in v17) then v17[v14] else DC30(map[p1 := p1]).cf45, v15, v15, map[p1 := f38], v15, v15[v6[-0x3c9] := p1], map[p1 := f38], v15 + v15, v15 + v15, fm43(f38, f38, globalState) + v15[f38 := f38], v15, v15, v15, map[f38 := p1], map[!f38 := p1], (if (fm44(p1, f38, p1, v7[314], globalState) in v18) then v18[fm44(p1, f38, p1, v7[314], globalState)] else map[if (f37 in v1) then v1[f37] else !p1 := f38]) + v15[p1 := f38], map[fm0(f37, globalState) := f38], v19[f25], v15];
					v20[722] := v15 + v15;
					var v21: array<bool> := new bool[10](i1 => p1);
					var v22 := DC10(f38, v21, p1, 0x2b, f37);
					var v23: map<array<bool>, D3> := map[v21 := DC10(p1, v21, v22.cf13, |fm1(f38, globalState)|, fm44(!false, p1, f38, v7[314], globalState))];
					v20[722], v7[314] := v15, |v23|;
					var v24: multiset<int> := multiset{v7[314]};
			...
			var v31 := DC16(f38);
			v30[288] := v31.(cf25 := p1);
			v30[288] := fm45(0x27d, fm44(f38, p1, p1, f37, globalState), globalState);
			var v32 := DC3(f37, p1);
			var v33 := DC19(v32.(cf4 := v7[314]), v7[314]);
			var v34: array<D6> := new D6[25];
			var v35: map<D6, array<D6>> := map[v33.(cf29 := v32) := v34];
			var v36 := DC31(v35);
			v7[314] := |v36.cf46[v33 := v34]|;
			globalState.f12 := fm0(-(|map[true := p1]| % fm44(p1, true, f38, f37, globalState)), globalState);
			v3 := v3 + (seq(255, i2  => ('y')));
		}
		
		var v37 := DC27(f37, --0x25d);
		match (v37.(cf40 := -f37 + v7[314])) {
			case DC27(cf39, cf40) =>
				cf40, v7[314], globalState.f12, globalState.f10 := v7[314], -cf39, f38, fm2(cf40 * -f25, v7[314], globalState);
				...
				var v47: array<array<bool>> := new array<bool>[29] [v43, v44[cf39], v43, v43, v43, if (!p1) then if (f37 in v45) then v45[f37] else v43 else v43, v43, v43, if (v4 in v46) then v46[v4] else v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, if (p1) then v43 else v43, v44[0x24f], if (cf39 in v45) then v45[cf39] else v44[f37], v43];
				v47[780] := v43;
				...
				v42, cf40, cf40, v47[780], v48[71] := v42, if (v14 in v50) then v50[v14] else v7[314], 0x388 / f37, if (v6 <= [p1]) then v43 else v43, v49[cf40 / f37];
				cf40 := f25;
			case DC26(cf38) =>
				globalState.f12 := p1;
				if (p1) {
					var v51 := DC29(p1, p1, if (f38) then v7[314] else f37);
					...
					v54[941] := fm39(p1, globalState);
					var v55: array<seq<int>> := new seq<int>[12](i5 => v2 + v2);
					v55[518] := [v52.fm24(f25, globalState)];
					v54[941], v55[518] := v4, (seq(0x4a, i6  => (f37)))[f25 := f25 + f25];
					globalState.f12 := p1;
				} else {
					v6 := v6;
					v7[314] := -0x12c;
					var v56: multiset<int> := multiset{f37};
					var v57: set<int> := {v7[314]};
					var v58: seq<multiset<int>> := [v56[f25 := |v5|], v56, multiset{|v57|}, v56, v56];
					var v59: map<int, char> := map[613 := v4];
					var v60: set<int> := {|v58|, |v59|, v7[314], v7[314]};
					var v61: array<bool> := new bool[4](i7 => p1);
					var v62: map<array<bool>, set<int>> := map[v61 := v60];
					var v63: seq<array<bool>> := [v61, v61];
					v60, v57 := if ((if (fm0(f25, globalState)) then v63[f37] else v61) in v62) then v62[if (fm0(f25, globalState)) then v63[f37] else v61] else v57, {|v0|, |{f38}|, v7[314]} * v60;
		...
		var v67 := DC13(|v66|, p1, fm0(v2[-0x2f0], globalState), p1);
		var v68: map<int, int> := map[f25 / f25 := v67.cf19];
		v68 := v68[|fm1(true, globalState)| := v7[314]];
		globalState.f12 := p1;
		r0 := -0x3b + f25;
	}
	method m18(p0: bool, p1: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (f38) {
				...
				globalState.f6 := seq(-0x92, i1  => (f37));
				var v13: map<bool, multiset<char>> := map[p0 := multiset(['k'])];
				var v14: map<char, bool> := map[v0 := p0];
				var v15: array<int> := new int[25];
				var v16 := DC3(|[v15]|, f38);
				var v17: array<map<bool, multiset<char>>> := new map<bool, multiset<char>>[23] [map[p0 := v3], v13 + v13[f38 := v3], v13, v13, v13, v13, map[f38 := v3] + v13, map[p1 := v3], v13, if (f38) then v13 else v13, v13, fm48(f38, v1, v1, |(v4[|v14| := v0])[f25 := v0]|, globalState), map[f38 := v3], map[p0 := v3['j' := v1]], v13, v13, v13, v13, v13, v13[v16.cf5 := v3[v0 := f37]], v13, v13, v13];
				v17[289] := v13;
				v17[289] := map[p0 := v3] + fm48(fm0(f37, globalState), f37, f37, v1, globalState);
				globalState.f12 := fm0(v1, globalState) || fm0(|v11|, globalState);
				var v18: array<array<int>> := new array<int>[6];
				v18[777] := v15;
				v1, v11, globalState.f12, v1, v18[777] := v1, [p0] + v11, f38, v1 % f25, v15;
			} else {
				var v19: seq<bool> := [f38, f38];
				v0 := if (v19[f25]) then v0 else 'l';
		...
		var v28: seq<int> := [f25];
		var i2 := 0;
		while (fm0(fm44(p0, p0, p0, v28[f25], globalState) / -|{f25}|, globalState))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			globalState.f23 := v29;
			var v30: seq<bool> := [p0];
			var v31: seq<bool> := [p0, v30[f37], f38, fm0(f25, globalState)];
			if (f38 !in v30) {
				v29 := v29;
				var v32 := 0x242;
				v32 := f37 + (v32 + f25);
				...
				var v39: array<int> := new int[20](i4 => i4 / -f25);
				v39[960] := f37;
				v39[960] := f37;
				var v40 := DC15(multiset{v39[960]});
				var v41 := DC2(f38);
				v40 := fm49(f37, p0, if (v41.cf3) then f37 else f25, v29, globalState);
				var v42 := DC0(true);
				var v43: array<bool> := new bool[29] [f38, false, p1, p1, p1, true, v42.cf0, f38, p1, p1, p1, false, p0, p1, p1, true, !f38, p0, p0, p1, p1, p1, false, f38, p0, !p0, false, !fm0(v39[960], globalState), fm0(f37, globalState)];
				...
				var v49: array<bool> := new bool[28] [p1, p0, f38, f38 <==> p0, p0, !(p1 && f38), fm0(f25, globalState) && (if (v43 in v44) then v44[v43] else f38), p0 <== p1, f38, v45 !! v45, p1, v39[960] < 0x82, !!p0 <== v30[v39[960]], p0, v46 !in v48, true, false, p0, !!fm0(f37, globalState), f38, p1, p1, fm0(-0x64, globalState), p1, f38, f38, f38, p1];
				v43[600] := p0;
				v43[600] := fm0(f37, globalState);
				var v50 := "wow";
				var v51: map<bool, int> := map[!p0 := f25];
				var v52: map<bool, map<bool, int>> := map[|v50| <= DC3(f37, p0).cf4 := if (p0) then v51 else v51];
				v52 := (if (v43[600]) then v52 else v52) + v52;
			}
			
			var v53: map<bool, bool> := map[p0 := p1];
			var v54: map<seq<int>, map<map<bool, bool>, int>> := map[v28 := map[v53 := |v31|]];
			var v55: map<map<bool, bool>, int> := map[v53 := |(seq(0x2c0, i5  => (f25)))|];
			v54 := v54[v28 := v55];
			var v56 := DC24(DC5());
			match (v56) {
				case DC24(cf36) =>
					...
					var v59 := DC0(f38);
					v53 := v53[p1 := f37 < |v58[f25 := fm38(v59, globalState)]|];
					var v60: array<int> := new int[3](i6 => i6 * f37);
					var v61: map<array<int>, bool> := map[v60 := p1];
					var v62: multiset<bool> := multiset{false, if (v57[495] in v53) then v53[v57[495]] else v57[495]};
					var v63 := 0x1f1;
					var v64 := "hr";
					var v65: set<string> := {v64};
					var v66: seq<set<string>> := [{v64}, v65];
					globalState.f12, v61, v62, v63 := (if (f38) then v66[v63] else v65) !! {seq(395, i7  => (v64[f37])), v64}, v61, multiset{p1} + multiset{f38, true, v57[495]}, if (v57[495]) then v63 else f25;
					v63 := v28[f25 / v63];
				case DC23(cf35) =>
					...
					v68 := -(f37 / f25);
					globalState.f23 := v29;
					v68, v31, v68 := 106 * 0x18e, v31, -(if (p0) then -f37 else v68) % f37;
				case DC25(cf37) =>
					...
					v74 := v74[v73 := f37];
					var v75 := 547;
					v75 := |(map v76 : int | v76 in v28 :: (v76 / v75) := (v72))| * v75;
					v71 := v71[false := 291 + 0x340];
					f26[332] := seq(0x232, i8  => (v29));
					var v77 := "rkvfdt";
					f26[332] := v77;
			}
		...
		v78[131] := f38;
		v78[131] := p0 <==> fm0(|v28|, globalState);
		var i10 := 0;
		while (f38)
			decreases 100 - i10
		{
			...
			v80[983] := 697;
			var v81 := 0x1e4;
			v79, v80[983], globalState.f12, v81 := v79, 0x207 % v81, true, f37;
			var v82: map<bool, bool> := map[p1 := p0];
			var v83: multiset<seq<int>> := multiset{v28, v28};
			var v84: set<int> := {0x21c, f37, |v83|};
			v82 := v82[v84 >= v84 := v78[131]];
			v78[131] := false;
			v84 := v84;
		}
		var v85 := "iei";
		var v86 := 'h';
		var v87: multiset<int> := multiset{|v85[f37 := v86]|};
		for i13 := f37 to |v87| {
			var v88: set<int> := {v28[f25]};
			var v89: map<int, bool> := map[i13 := p0];
			var v90 := DC17(|v88|, if (i13 in v89) then v89[i13] else p0);
			var v91: seq<bool> := [p1, f38];
			var v92: multiset<bool> := multiset{v78[131]};
			var v93: set<multiset<bool>> := {fm50(i13, v85, v90.cf27, |v91|, globalState), v92, v92, v92[v78[131] := -f37], v92};
			var v94 := 0x335;
			var v95: map<int, int> := map[f37 := i13];
			v78[131], v93, v94 := (v87 + v87) > v87, fm51(v88 - fm47(f38, 0xaa, |v95|, v86, globalState), -0x1e6, v86, v94, globalState), v28[v28[-f37] / f37];
			v91 := fm1(f38, globalState) + [f38];
			var v96: set<bool> := {p1, p0};
			v78[131], v94, v94, globalState.f12, v94 := false, v94, (|v96| % -109) / -0xdb, v91[fm44(f38, v78[131], true, f37, globalState) * i13], v94;
			v78[131] := p0;
		}
		var v97 := DC32(false);
		var v98 := DC34(v97);
		match (v98) {
			case DC32(cf47) =>
				...
				v102 := v102[if (v78[131]) then v101 else set v103 : int | v103 in multiset(v28) :: (v103 - |[|map[true := false]|]|) := if (f37 in v104) then v104[f37] else f37];
				var v105: seq<set<int>> := [v101];
				var v106: map<int, char> := map[f37 := v86];
				var v108: map<int, bool> := map[f37 := cf47];
				var v111: array<set<int>> := new set<int>[23] [fm47(!!p1, f37, |v101|, v86, globalState), v101, v101, v101 - v101, v105[392], {f37, |v87|, f25}, v101, v101 * v101, v101 * v101, {f25}, v101, v101, v101, fm47(f38, f25, f37, v86, globalState) + v101, v101, v101, v101 - (set v107 : int | v107 in v106 :: (v107 % -0x7b)), v101 + v101, {-fm44(true, v78[131], if (f25 in v108) then v108[f25] else true, fm44(cf47, p1, v78[131], f37, globalState), globalState)}, v101 * v101, {f37, f37}, if (f38) then set v109 : int | v109 in v104 :: (v109 - 172) else DC11(set v110 : int | v110 in v101 :: (v110 - |"f"|)).cf18, v101];
				v111[346] := v101;
				var v112: seq<bool> := [f38];
				var v113 := 533;
				var v114: array<int> := new int[2] [v113, f25 * f37];
				v114[289] := |v108| - f25;
				v111[346], v112, v113, v78[131], v114[289] := v101, v112 + v112, 0x3b3, (f37 / v113) == (|v85| + f25), f25;
			case DC33(cf48, cf49, cf50, cf51) =>
				var v116: set<string> := {"hglnqof", v85[|v85| := v86]};
				cf50, cf51, cf51, cf51, cf51 := !false, f37, -f37, cf51, |(map v115 : string | v115 in v116 :: (v115) := (false))|;
				var v117: multiset<bool> := multiset{v78[131]};
				if (!(if (cf50 && p1) then fm0(f37, globalState) else v117 !! v117)) {
					...
					v119 := v119[v85 := v118];
					globalState.f12 := f38;
					globalState.f12 := if (v78[131]) then v78[131] else p1;
					...
					var v129: map<C1, int> := map[v128 := 0x3d6 % f37];
					v129 := v129;
					v28 := v28;
					globalState.f12 := false;
					...
					v130[127], v85, cf51, cf51 := v131.cf18, v85, f37, -(if (cf51 != 747) then f37 else -cf51 - f37);
				}
				...
				if (cf50) {
					...
					var v134: array<char> := new char[26](i15 => v85[f37]);
					var v135 := DC35(v134);
					v133[718] := v135.cf53;
					v133[718] := new char[7](i16 => v86);
					globalState.f23 := fm39(p1, globalState);
					globalState.f12 := (cf51 > f37) ==> f38;
				} else {
					var v136: map<bool, int> := map[false <== p0 := f37];
					var v137: map<int, bool> := map[cf51 := v78[131]];
					globalState.f10, cf51 := v85, if ((v78[131] <== cf50) in v136) then v136[v78[131] <== cf50] else fm44(!(if (cf51 in v137) then v137[cf51] else v78[131]), p0, p0, -f25, globalState);
					globalState.f12 := v78[131];
					var v138: array<int> := new int[26];
					v138[114] := |(map v139 : seq<int> | v139 in fm52(cf50, f37, cf51, globalState) :: (v139) := (3))|;
					v138[114] := f25 - |fm47(true, |v85|, |v137|, v86, globalState)|;
					v138[114] := f37 % f25;
					var v140: multiset<string> := multiset{"y"};
					globalState.f10, v78[131] := (v85 + v85)[fm44(fm0(v138[114], globalState), fm0(f25, globalState), !false, v138[114], globalState) := v86], !(v140 >= (v140 * multiset{seq(0x74, i17  => (v86)), seq(-0x2e4, i18  => ('w'))}));
				}
				
				cf51 := cf51 - cf51;
			case DC31(cf46) =>
				var v141: set<bool> := {v78[131]};
...
class C4 extends T0 {
	...
	method m2(p0: array<array<bool>>, p1: bool, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		if (!p1) {
			...
			r1, globalState.f10, p3[990] := f25, v0 + "ctwwm", if ((v1 + v1) in v3) then v3[v1 + v1] else f25;
			globalState.f12 := !p1;
			...
			var v8: seq<int> := [f25];
			var v9: map<int, int> := map[p3[990] + fm21(v7, -60, false, v0, globalState) := v8[p3[990]]];
			v9 := map[-p3[990] := p3[990]];
		} else {
			var v10 := "bliyyoh";
			globalState.f10 := fm2(f25, f25, globalState) + (v10 + v10);
			var v11: seq<bool> := [fm0(-f25, globalState), p2 ==> p2];
			globalState.f12 := v11[f25];
			if (false) {
				r0 := f25 % f25;
				var v12: set<bool> := {p2};
				var v13: array<int> := new int[3] [-|v12| % f25, f25, f25];
				var v14 := DC4([p2]);
				var v15 := DC7(v14);
				var v16: seq<D1> := [v15];
				r1, globalState.f12, v13 := -|((seq(0x145, i1  => (DC7(DC6('o', p2, v10))))) + v16)| % f25, p2, v13;
				var v17 := 'h';
				globalState.f23 := v17;
				globalState.f12 := false;
				globalState.f12 := p1;
				...
				f26[297] := v10;
				f26[297] := v10 + v10;
				globalState.f23 := v10[p3[806] / f25];
				var v18: map<int, seq<bool>> := map[p3[806] := v11];
				var v19: map<string, int> := map[v10 := |((if (p3[806] in v18) then v18[p3[806]] else v11[|"kytjdmn"| := p2]) + v11)|];
				v19 := v19[(v10 + f26[297])[p3[806] := 'f'] := p3[806] % p3[806]];
				var v20: array<bool> := new bool[29];
				var v21: seq<array<bool>> := [v20];
				var v22 := 'v';
				f26[297], globalState.f12, globalState.f23, v21 := DC6(v22, true, v10).cf9, v11[|f26[297]|], v22, v21;
			}
			...
			if (p1) {
				...
				v27[848], v32, globalState.f6, r1 := !p2, v32, v33, (|v31| - |v10|) * (|v24| - |v34|);
				...
				v40[694] := map[p2 := false] + v37;
				p3[105] := f25 + -f25;
				var v41: seq<int> := [f25, f25];
				p3[134] := |v41|;
				var v42 := DC0(p1);
				var v43: map<D0, bool> := map[v42 := p1];
				v40[694], p3[105], globalState.f10, p3[134] := v37, if (v11[fm21(v43, |"mlkroi"|, p2, "aufslk", globalState)]) then f25 else f25, v10 + v10, |v11|;
				p3[105] := (p3[105] / p3[105]) * f25;
			...
			if (!!(f25 < f25)) {
				...
				v46[795] := multiset{p2} + v47;
				v46[795], globalState.f12 := (v47[p1 := |v10|] + v47)[fm0(f25, globalState) := f25], !p2;
				var v48 := DC0(p2);
				var v49: map<D0, bool> := map[v48 := !p1];
				var v50: map<int, string> := map[|v10| := seq(0x168, i2  => ('d'))];
				var v51 := 'w';
				var v52 := DC6(v51, false, v10);
				var v53: seq<string> := [v52.cf9, v10];
				r0 := fm21(v49, f25, false, if (|v53[f25]| in v50) then v50[|v53[f25]|] else v10, globalState);
				...
				v56[551] := (if (p1) then v58 else v58)[v57 := |{|v59|}|];
				...
				v60[861] := fm22(v63, f25, globalState);
				var v64: array<set<bool>> := new set<bool>[11];
				var v65: set<bool> := {p2};
				v64[288] := v65;
				v64[288] := v65 * (v65 - v65);
				var v66: seq<int> := [f25];
				var v67: map<seq<int>, bool> := map[if (p2) then v66 else seq(-301, i4  => (f25)) := p2];
		...
		for i5 := |v73| to if (-f25 in v74) then v74[-f25] else f25 {
			...
			if (true) {
				...
				var v82: seq<int> := [p3[770], |v81|, |v80|, |v75|, i5];
				globalState.f12, r0, p3[770] := !p1, |v79| % (p3[770] + -|v80|), if (p1) then -0xe8 else v82[0xaf];
				var v83 := DC0(p1);
				var v84 := 'd';
				var v85: multiset<bool> := multiset{fm0(0xa6, globalState)};
				var v86: map<int, bool> := map[p3[770] := p2];
				r0 := (fm21((map[v83 := fm0(f25, globalState)])[v83 := p1], i5, false, DC6('c', p2, v79).cf9[f25 := v84], globalState) * -0x131) / (if ((if (f25 in v86) then v86[f25] else p1) in v85) then v85[if (f25 in v86) then v86[f25] else p1] else i5);
				globalState.f12 := i5 >= 0x3a6;
			} else {
				var v87 := 'f';
				var v88: map<char, int> := map[v87 := f25];
				var v89: set<int> := {f25};
				globalState.f12 := (|v88| % |v89|) >= i5;
				var v90 := "xtm";
				...
				globalState.f12 := f25 != (f25 / fm21(v95, 0x22b, p1, "dbb", globalState));
				v75 := v75;
			}
		...
		forall i7 | 0 <= i7 < v102.Length {
			v102[i7] := ({|(seq(0xcd, i8  => ('b')))|} - {DC13(|v74|, p1, p1, !p2).cf19, f25}) >= ({f25, -|map[p2 := f25]|} - (set v103 : int | (0x24 <= v103) && (v103 < 152) :: (v103 % -f25)));
		}
		var v104 := DC0(!true);
		...
		r1 := (if (v110 in v111) then v111[v110] else f25) / f25;
	}
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		if (if (f25 in v0) then v0[f25] else true) {
			...
			if (!(v1 <= v1)) {
				...
				var v9: map<bool, bool> := map[v8[f25] := !true];
			...
			v22[538], r0 := v24 <= v24, |fm37(v26, globalState)|;
			var v27: seq<string> := [v24];
			v24 := fm2(|(v27[f25 := v24] + v27)|, f25, globalState);
			v24, v22[538] := v24, p1;
			r0 := (-f25 % --231) / (|v0| + f25);
	...
	method m15(p0: bool, p1: map<bool, int>, p2: int, globalState: GlobalState) returns (r0: D0, r1: bool, r2: map<seq<bool>, bool>) {
		...
		v3[3] := DC0(p0).(cf0 := p0).(cf0 := p0);
		var v4: map<string, bool> := map[v2 := !p0];
		var v5: seq<string> := [v2];
		globalState.f12, r1, v0, v3[3], r1 := p0, p0, v0, v1, if (v5[p2] in v4) then v4[v5[p2]] else f25 == -p2;
		var v6 := 'd';
		v2 := v2[-0x56 := v6];
		...
		if (if (v8 in v26) then v26[v8] else p0) {
			if ((!p0 ==> v8[864]) || p0) {
				...
				v8[864] := if (v8[864]) then if (false) then p0 else !v8[864] else p0;
				globalState.f23 := v6;
				var v29: map<map<int, int>, int> := map[v16 := |p1[v8[864] := v0]|];
				v29 := v29[map[f25 := |(set v30 : int | v30 in v16 :: (v30 % |{true, !true, false, true, true}|))|] := |p1| - |v13|];
				globalState.f10 := (seq(-11, i2  => (v6))) + v2;
			} else {
				var v31 := new C3(p2 * v0, !!p0, 0x3b9, f26);
				var v32: map<bool, bool> := map[v31.f38 := p0];
				var v33: map<bool, bool> := map[v31.f38 := if (v8[864] in v32) then v32[v8[864]] else v8[864]];
				var v34 := DC36(v33 + map[v8[864] := !!v31.f38], p0, f25 - -v31.f37);
				v34 := v34;
				v0 := -((v0 / v31.f37) * v31.f37);
			...
			var v37 := DC21(v36);
			v36 := v37.cf32;
			var v38: map<bool, bool> := map[v8[864] := v8[864]];
			...
			v41[838] := v44;
			v41[838] := if (v15[|("fwphtpp")[|v2| := v6]|]) then [[v42, v42]] else v44;
			var v45 := DC32(p0);
			var v46: map<char, bool> := map[fm33(p2, v8[864], p2, globalState) := v45.cf47];
			var v47 := DC28(v46);
			v47, r1, v8[864], r1, v4 := v47, v8[864], p0, v38 == (v38 + v38), v4;
		} else {
			...
			if (v8[864]) {
				v8[864] := !v8[864];
				v48[88] := |(v15 + v15)|;
				v0 := DC33(v11, v8, v8[864], v52.f37).cf51;
				var v53: array<seq<bool>> := new seq<bool>[6];
				v53[378] := v15;
				v0, v0, v53[378], v0, v48[88] := v48[88], p2, v15 + (fm1(if (v52.f37 in v14) then v14[v52.f37] else v8[864], globalState) + v15), v48[88], v0;
				var v54: seq<array<bool>> := [v8, v11];
				var v55: map<seq<array<bool>>, bool> := map[v54 + v54 := !!p0];
				v55 := v55[v54 := fm0(v21[v52.f37], globalState)];
			} else {
				globalState.f12 := v52.f38;
				var v56 := DC2(p0);
				var v57: array<D0> := new D0[8] [v56, v56, v56, if (v52.f38) then v56 else fm54(multiset(v15), globalState), v56, DC2(v8[864]), v56, v56.(cf3 := v15[|v2[v0 := v6]|])];
				v57[319] := DC2(p0);
				var v58: array<multiset<int>> := new multiset<int>[5](i5 => v50);
				v50, v57[319], v58 := v50, if (v48[88] <= v52.f37) then v56 else v56, v58;
				var v59: map<bool, bool> := map[v52.f38 := v52.f38];
				globalState.f12 := !((v48[88] * |v59|) <= fm31(v2, globalState));
				globalState.f12 := p0;
				v13 := [true, !v52.f38];
			}
		...
		r0 := DC2(p0);
		r1 := v8[864];
		var v60: map<seq<bool>, bool> := map[[p0, v8[864]] := if (true) then v8[864] else p0];
		r2 := v60;
	}
}
...
class C5 {
	...
	method m13(p0: int, p1: bool, p2: bool, p3: map<int, int>, globalState: GlobalState) returns (r0: int, r1: set<int>, r2: bool, r3: array<int>) {
		...
		r0 := p0;
		if (p2) {
			globalState.f12 := (p0 / p0) > -283;
			r0 := p0;
			globalState.f6 := fm19(p1, globalState) + ((seq(0xb5, i0  => (p0))) + [p0]);
			var v1: array<int> := new int[4];
			v1[966] := p0;
			v1[966] := |(fm20(fm0(p0, globalState), globalState) + {f35, p2, p2, p2})| / (p0 / p0);
			v1 := v1;
		} else {
			globalState.f12 := f35;
			if (if (p2) then p1 else !f35) {
				...
				v3[579] := ([p0])[fm18(globalState) := p0];
				var v4 := "d";
				var v5: set<int> := {778, |v4|};
				var v6 := DC11(v5);
				v3[579] := [p0, |v6.cf18|, fm18(globalState)];
				r0 := p0;
				r0 := p0;
				r0 := p0;
				...
				globalState.f12 := fm0(fm18(globalState) / v10.cf19, globalState);
				var v11: array<int> := new int[25];
				r3 := v11;
				var v12 := DC0(p2 && f35);
				var v13 := 't';
				var v14: seq<int> := [p0, p0, fm18(globalState), -|map[false := v13]|, p0];
				r0, v12, r0, r2 := v14[0x235], v12, p0, fm0(p0, globalState) || p1;
				globalState.f12 := p1;
				var v15: seq<array<int>> := [v11];
				var v16: array<array<int>> := new array<int>[21] [v11, v11, v15[p0], v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, if (fm0(p0, globalState)) then v11 else v11, v11, v11, if (f35) then v11 else v11, v11, v11, v11, v11];
				v16[613] := v11;
				v16[613] := v11;
			}
			...
			v17[492] := v19;
			var v20 := 'n';
			v17[492], r0, globalState.f23 := v19, p0 + p0, v20;
			globalState.f23 := v20;
			globalState.f12 := 0x30a > p0;
		}
		
		var v21: multiset<int> := multiset{p0, p0};
		for i2 := |(v21[p0 := p0] + multiset{|[p2, p2, true]|, p0, p0, p0})| to p0 {
			globalState.f12 := !fm0(|(seq(639, i3  => (i2)))|, globalState);
			r2 := p1;
			...
			if (f35 <==> ({false} < v25)) {
				...
				var v33 := new C3(v30[i2], v25 !! v25, i2 % i2, v32);
				...
				var v43 := 'f';
				v42[889] := v43;
				globalState.f10, v41, v42[889] := seq(0x3de, i6  => (if (f35) then 'f' else 'q')), v41, v43;
		...
		r0 := p0;
		var v46: set<int> := {p0};
		r1 := (v46 - (set v47 : int | (0x380 <= v47) && (v47 < 496) :: (v47 % p0))) * v46;
	...
	method m14(p0: int, p1: multiset<int>, p2: bool, globalState: GlobalState) {
		if (p0 >= -0x3c3) {
			...
			var v5: map<array<int>, bool> := map[v4 := v2[783]];
			v3 := |v5|;
			...
			var v10 := new C4(v0, |("fhtp")[v3 := if (f35 in v9) then v9[f35] else v8]|, v0);
		} else {
			var v11 := 108;
			var v12 := DC0(p2);
			...
			var v16 := 't';
			v11 := fm21(v13, fm31(v14, globalState), p2, (if (f35 in v15) then v15[f35] else v14)[v11 := v16], globalState) / v11;
			...
			v24 := v24[v22 := v23 - v23];
			var v25: array<string> := new string[24] [v14, "xyqt", v14, v14, v14, v14, v14, seq(0x6c, i1  => (v16)), v14, v14, "om", v14, v14, v14, v14, v14, "cupth", v14, v14, v14, v14, v14, v14, v14];
...
class C6 extends T1 {
	...
	method m4(p0: D1, globalState: GlobalState) {
		...
		if (v2) {
			...
			match (v4) {
				...
				case DC21(cf32) =>
					...
					cf32[507] := if (v2) then |v11| else f25 / |v12|;
					var v13 := 's';
					cf32[507] := fm31(v11 + v11[f25 := v13], globalState);
					var v14: multiset<bool> := multiset{true, v2};
					var v15: seq<map<bool, int>> := [v12];
					var v16 := DC26(v12);
					var v17: array<map<bool, int>> := new map<bool, int>[19] [v12, (map[v2 := --0x1b7])[!false := -(if (v2 in v14) then v14[v2] else f25)], v12, v12[v2 := cf32[507]], v12, v12, v12, v12, v12, v12, v12, v15[603], v12, v12, v12, v12, v16.cf38, map[fm0(f25, globalState) := f25], v12];
					var v18: map<int, array<map<bool, int>>> := map[f25 := v17];
					v18 := v18[-(cf32[507] + cf32[507]) := v17];
			}
			...
			match (DC27(f25, f25)) {
				...
				case DC26(cf38) =>
					...
					v28[52] := v27;
					v28[52] := if (v2) then v27 else v27;
					...
					v30[9] := v2;
					var v32 := 'k';
					globalState.f10 := if (f25 in v0) then fm2(f25, f25, globalState) else v19[f25 := v32];
			}
			...
			var v39 := "wrtlea";
			globalState.f12, globalState.f23, v37 := multiset{v2, v2, v2} != (v38 - v38), v39[-f25 % f25], v37;
			var v40: array<int> := new int[5](i0 => i0 / |v38|);
			var v41: map<D0, bool> := map[DC0(v2) := v2];
			v40[361] := fm21(v41, f25, v2, v39[0xa9 := v35], globalState);
			v40[361] := f25;
			...
			v2 := (if (v2 in v38) then v38[v2] else v40[361]) <= (if (v2) then -fm18(globalState) else if (v43 in v44) then v44[v43] else |v46|);
			v40[361] := 272;
			...
			if ((if (v2) then v47 else multiset{-675}) > (v47 * multiset{f25})) {
				...
				v40[361] := if (v49 in v50) then v50[v49] else |(if (fm55(v2, |v51|, |v39|, globalState) in v52) then v52[fm55(v2, |v51|, |v39|, globalState)] else v38)|;
				globalState.f23 := v35;
				globalState.f12 := fm0(|v0| % 0x23b, globalState);
				var v53: seq<bool> := [v2, v2, v2, v2, v2];
				var v54: map<int, int> := map[-v40[361] := v40[361]];
				var v55: map<int, seq<bool>> := map[v40[361] := [v2, false]];
				var v56 := DC29(v2, v2, f25);
				var v57: array<seq<bool>> := new seq<bool>[24] [v53, v53[|v54| := v2], v53, v53, (p0.(cf6 := v53)).cf6, fm1(v2, globalState) + [true, v2, v2], v53, v53, DC4([v2]).cf6, v53, v53, v53, v53, v53 + v53, [!false] + v53, if (v56.cf44 in v55) then v55[v56.cf44] else v53, fm1(v2, globalState), [v2, v2, v53[0x219]], v53, v53, v53, v53 + v53, v53, v53];
				v57[148] := if (fm0(f25, globalState)) then v53 else v53;
				var v58 := DC1(true, v2);
				globalState.f12, v2, v57[148], v58 := v2, fm0(f25, globalState), v53 + v53, fm56(v2, globalState);
				v48[778] := v2;
				v48[778] := v2;
			} else {
				globalState.f10 := "mrtsnphg" + ("rcfgfvj" + v39);
				globalState.f10 := v39 + (seq(0x1b6, i1  => (v35)));
				v40[361] := f25;
				v40 := v40;
				var v59: seq<string> := [v39];
				v1.f36[680] := v59[v40[361]] + (seq(-695, i2  => (v35)));
				v1.f36[680] := ("mipgqij")[f25 + |v39| := v35];
			}
		...
		var v61: map<int, bool> := map[f25 := !v60[f25]];
		v61 := v61;
		...
		if (v63 !in "fiqda") {
			...
			v64 := v64[f25 := f25];
			var v65 := DC27(|(seq(672, i4  => (v63)))|, f25);
	...
	method m2(p0: array<array<bool>>, p1: bool, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int) {
		if (p1) {
			...
			v3 := v3[f25 := v2];
			r0 := f25;
			globalState.f12 := v0 < ((seq(444, i0  => ('w'))) + v0);
			p3[46] := f25;
			p3[46] := f25;
		} else {
			...
			v6 := (v6 * v6) * v6;
			var v7: seq<bool> := [p1];
			globalState.f12 := ({p1, p2} - v6) >= {p2, v7[f25], p1, p2};
			...
			var v15: array<set<int>> := new set<int>[19](i1 => (set v13 : int | v13 in {|multiset{f25, f25, f25}|} :: (v13 % |(map v14 : int | (0x180 <= v14) && (v14 < 189) :: (v14 % |['w', 'i', 'e']|) := (false))|)) - {f25});
			var v16: set<int> := {f25, f25, f25};
			v15[829] := v16;
			var v17: map<int, set<int>> := map[f25 := v16];
			var v18 := "wbpat";
			v15[829] := if (fm31(v18, globalState) in v17) then v17[fm31(v18, globalState)] else v16;
		}
		...
		if (p1) {
			...
			v21 := v21[f25 := v19];
			var v22: T0 := new C4(f26, --(f25 / f25), f26);
			v22 := v22;
			...
			if (p2) {
				...
				var v41: map<int, bool> := map[-p3[586] := p1];
				f26[288] := v40[|v41| % p3[586]];
				globalState.f12 := p1;
			} else {
				var v42: C2 := new C2();
				v42 := v42;
				...
				v43 := v43;
				v43[948] := p2;
				globalState.f12, r1, r1, v43[948] := p1, f25 - f25, -f25, p2;
				var v44: seq<int> := [0x3a0];
				var v45: map<string, bool> := map[seq(-0x50, i3  => ('i')) := p2];
				var v46 := "f";
				var v47: set<bool> := {p1, fm0(f25, globalState), if (v46 in v45) then v45[v46] else v43[948], !p2, v43[948]};
				var v48: map<set<bool>, seq<int>> := map[{v43[948], fm0(fm44(fm0(v44[0xa0], globalState), v43[948], p1, f25, globalState), globalState)} + v47 := v44];
				v48 := v48;
			...
			var v56 := "vpr";
			var v58: seq<D0> := [v54];
			r1, v51, v53, r1 := fm21(v55, f25 % |v53|, p1 || p2, v56, globalState), v51[f25 := v50], [v56, [v52, fm39(p1, globalState), v52, v52, v52]] + fm58(v56, fm21(map v57 : D0 | v57 in v58 :: (v57) := (p2), f25, p1, v56[f25 := v52], globalState), p1, f25, globalState), f25;
			var v59 := DC32(p1);
		...
		var v68: seq<string> := [v64 + v64, v64, seq(373, i5  => ('v'))];
		v64 := v68[-fm44(p2, p1, true, f25, globalState)];
		var v69: multiset<int> := multiset{p3[853]};
		v69 := multiset{p3[853], p3[853], p3[853]};
		r0 := p3[853];
		r1 := (p3[853] % p3[853]) * fm44(false, !p2, p1, 0x7, globalState);
	}
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			v1[988] := 0x201 + (if (p1) then v2[|v3|] else f25);
			globalState.f12 := p1;
		}
	...
	method m11(p0: array<int>, p1: bool, p2: map<bool, array<bool>>, globalState: GlobalState) returns (r0: D3, r1: bool) {
		...
		match (v2) {
			case DC5() =>
				...
				if (p1) {
					...
					v8[491], v9, v8[339] := |(v10 - v10)| < v9.f25, if (|v11| < v9.f25) then v9 else v9, p1;
					globalState.f12, globalState.f12, v8[491], globalState.f12, r1 := v8[491], p1, v8[491], fm0(-567, globalState), v0 !in "muieyuiqy";
			...
			case DC4(cf6) =>
				if (p1) {
					...
					v16[842] := cf6[if (f25 in v17) then v17[f25] else v15];
					p0[708] := v15;
					var v18 := DC29(p1, p1, f25);
					v15, v16[842], p0[708], v15, globalState.f12 := -DC38(v15).cf58, p1, -(f25 + v18.cf44), f25, fm0(v15 / f25, globalState);
					var v19: multiset<bool> := multiset{v16[842], p1, p1, p1, v16[842]};
					var v20: map<bool, int> := map[v16[842] := if (p1 in v19) then v19[p1] else 279];
					v20 := v20[p1 := -990];
					var v22: map<bool, seq<set<int>>> := map[true := seq(0xd4, i1  => (set v21 : int | (0x26d <= v21) && (v21 < 0x1c6) :: (v21 - 969)))];
					var v23: set<int> := {|"fyq"|};
					var v24: seq<set<int>> := [v23, v23, v23, v23];
					var v26: set<set<int>> := {fm47(v16[842], p0[708], v15, v0, globalState)};
					var v28: map<int, int> := map[p0[708] := v15];
					var v30: seq<int> := [fm44(true, p1, v16[842], f25, globalState)];
					var v34: array<set<set<int>>> := new set<set<int>>[29] [set v25 : set<int> | v25 in (if (v16[842] in v22) then v22[v16[842]] else v24) :: (v25), if (v16[842]) then v26 else {v24[v15]}, v26, v26 - v26, v26, v26, v26, v26, v26, v26 - v26, v26, v26, {v23, set v27 : int | v27 in v23 :: (v27 / |map[|"ohtqnsan"| := |multiset{0x17f, |map[|map[true := false]| := |"dvft"|]|, -285}|]|), set v29 : int | v29 in v28 :: (v29 - 0x369), {|v30|}}, v26, {v23, {|(map v31 : int | v31 in v23 :: (v31 * |v19|) := (cf6[|map[v16[842] := v16[842]]|]))|, v15}} + v26, {{p0[708]}, v23} - v26, {v23, v23} * {set v32 : int | (-0x1af <= v32) && (v32 < -0x78) :: (v32 + 0x3db), v23}, {v23, v23}, v26, v26, v26, v26, v26, fm61(v15, v16[842], p1, globalState), v26, fm61(f25, !v16[842], cf6[v15], globalState), v26, set v33 : set<int> | v33 in v24 :: (v33), fm61(p0[708], p1, p1, globalState)];
					v34[851] := fm61(f25, p1, v16[842], globalState);
					var v35 := DC27(f25, p0[708]);
					v34[851], globalState.f12, v15, p0[708], v35 := if (fm0(v15, globalState)) then v26 - v26 else v26, false && v16[842], |(if (v16[842]) then ("gf")[p0[708] := v0] else DC6(v0, v16[842], v1[f25 := v0]).cf9)|, |v30|, DC27(f25 - p0[708], -0x331);
					var v36: array<char> := new char[27];
					var v37: map<bool, array<char>> := map[v16[842] := v36];
					v37 := v37[p1 := v36];
					var v38: set<bool> := {p1};
					var v39: map<set<bool>, D11> := map[v38 := DC30(map[p1 := v16[842]])];
					p0[708] := |(v39 + v39)|;
				} else {
					globalState.f12 := !p1 <== p1;
					var v40 := 0x2eb;
				...
				if (p1) {
					...
					var v59 := DC41(v55);
					var v60: array<map<int, bool>> := new map<int, bool>[26] [v55 + v55, v55, v55 + v55, (map v56 : int | (629 <= v56) && (v56 < -124) :: (v56 % |v51|) := (p1)) + v55, v55, v55 + v55, v55, map[fm44(p1, !p1, p1, v48, globalState) := if (p1 in v57) then v57[p1] else p1], v55, v55 + map[v48 := p1], fm36(p1, v55, v0, globalState), v55, map[f25 := p1], v55, v55, v55, v55, v55, map[DC3(f25, fm0(|v50|, globalState)).cf4 := p1], v55[v48 := p1], v55 + v55, v55, v55 + v55, v58[v48], v55, v59.cf60 + v55];
					...
					var v66 := new C4(v62[f25], |(v65 - {v64})|, f26);
					var v67: multiset<bool> := multiset{p1};
					v61 := 0x66 / (|v67| / v61);
					var v68: array<multiset<bool>> := new multiset<bool>[17](i3 => v67 + v67);
					v68[403] := fm50(-0x57, v1, p1, f25, globalState);
					v68[403] := multiset(cf6) + (v67 - v67);
					var v69: multiset<int> := multiset{v61, |v68[403]|, v61};
			...
			case DC7(cf10) =>
				...
				v72, globalState.f12, r1, v73, globalState.f10 := v72, p1, (v74 + fm58(['r', v0, v0], f25, p1, fm44(p1, fm0(f25, globalState), p1, |[f25, |v1|, f25, v73]|, globalState), globalState))[|v1| := v1] <= ([v1, v1, v1] + v74), |{f25, f25, f25, v75.cf39, v73}| % f25, (v1 + v1) + ([v0, v0, v0, 'j', v0] + v74[|v76|]);
				var v77: map<char, int> := map[v0 := f25];
				var v78: seq<bool> := [p1, p1, false];
				var v79: map<bool, int> := map[v78[56] := f25];
				v77 := map[v0 := |v79| % f25];
				var v80 := DC17(f25, v78[v73]);
				var v81: set<bool> := {p1};
				match (v80.(cf26 := f25).(cf27 := v81 !! v81)) {
					...
					case DC17(cf26, cf27) =>
						...
						v93[102] := fm39(cf27, globalState);
						v93[692] := v0;
						v90, v93[102], v93[692] := if (p1) then v90 else v90, v0, v0;
					case DC15(cf24) =>
						globalState.f12 := p1;
						...
						v97[741] := p1;
						v97[741] := v1 <= (v1 + "xum");
						var v98: map<seq<char>, array<bool>> := map[seq(0x397, i7  => (v0)) := v97];
						var v99: map<array<bool>, bool> := map[if ((seq(0x32e, i8  => (v0))) in v98) then v98[seq(0x32e, i8  => (v0))] else v97 := v97[741]];
						var v100 := DC23(v99);
						var v101 := DC25(v100);
						var v102: set<D8> := {v101};
						v73 := 0x239 % |(v1[|v102| := v0] + v1)|;
				}
		...
		for i11 := f25 to v109 % f25 {
			...
			globalState.f12, v109, p0[396], v109, v111 := v114 <= v114, v109 / (v112.f25 / -|v115|), -f25, v112.f25 - i11, v111;
			var v116: array<bool> := new bool[22];
			v116[590] := fm0(-v112.f25, globalState);
			v116[590] := true;
			var v117: map<bool, string> := map[v116[590] := v1];
			...
			v109, v109, globalState.f10, r1, globalState.f6 := -|v110| * i11, v118[f25 - |v105|], v1, !(if (multiset{p1, p1} >= v110) then p1 else v116[590]), [|(v1 + v1)|];
		}
		var i12 := 0;
		while (p1)
			decreases 100 - i12
		{
			...
			if (p1) {
				...
				var v124: map<seq<int>, int> := map[v123[f25 := v109] := -f25];
				var v125: seq<seq<int>> := [v123];
				v124 := v124[[v109] + v125[f25] := (if (p1 in v105) then v105[p1] else -0xc7) + v109];
				var v126: multiset<int> := multiset{|(seq(0x310, i13  => (v0)))|};
				...
				var v136: map<array<bool>, set<bool>> := map[v133 := v135[f25]];
		...
		r0 := v143.(cf14 := v142, cf15 := v144[f25]);
		r1 := p1;
	}
	method m12(globalState: GlobalState) returns (r0: string, r1: multiset<int>, r2: bool) {
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v2: array<int> := new int[2](i2 => i2 / f25);
			v2[916] := f25;
			v2[916] := 0x237 * f25;
			var v3: map<bool, bool> := map[v0[562] := v0[562]];
			var v4: seq<bool> := [!(if (v1 in v3) then v3[v1] else !v1)];
			v2[916], v2[916], v0, v0[562], v2[916] := v2[916], f25, v0, v4[f25] && (v2[916] > v2[916]), -((--0x20 * v2[916]) * f25);
			var v5 := 'o';
			var v6: map<bool, char> := map[!v1 := v5];
			globalState.f23 := if (v1 in v6) then v6[v1] else v5;
			var v7 := "qbnx";
			var v8: map<string, int> := map[v7 := f25];
			v8, globalState.f12, globalState.f12 := v8 + v8, v7 <= v7, v0[562];
		}
		var i3 := 0;
		while (v0[562])
			decreases 100 - i3
		{
			...
			var v9 := 0x30e;
			v9 := v9;
			var v10: array<int> := new int[28](i4 => i4 / |[-v9, v9]|);
			v10[414] := f25;
			var v11: map<int, bool> := map[-f25 * fm31("tdedfs", globalState) := v0[562]];
			v10[414] := -|v11|;
			var v12 := new C0();
			var v13 := new C1(f25 + |v11|, f26);
		}
		var v14: seq<int> := [f25];
		var v15: multiset<bool> := multiset{v1, fm0(fm31(seq(0x75, i6  => ('v')), globalState), globalState), v0[562], false, v0[562]};
		var v16: array<int> := new int[8] [f25, |v14| - |"edjrpfsui"|, f25, |v14| * |v14[f25 := f25]|, f25, f25, if (false in v15) then v15[false] else f25, f25];
		forall i5 | 0 <= i5 < v16.Length {
			v16[i5] := i5 / (f25 % |(seq(475, i7  => (map[v1 := f25])))|);
		}
		var v17 := 'd';
		var v18: map<char, int> := map[v17 := f25];
		var v19: map<map<char, int>, array<bool>> := map[v18 := v0];
		v19 := (v19 + map[v18 := v0]) + v19;
		var v20: map<bool, array<bool>> := map[v0[562] := v0];
		var v21, v22 := m11(v16, v1, v20, globalState);
		r0 := seq(0x2b2, i8  => (DC6(v17, v0[562], "wubujscf").cf7));
		var v23: seq<bool> := [v0[562]];
...
class C7 {
	...
	method m10(p0: string, p1: int, globalState: GlobalState) returns (r0: int) {
		...
		v1[22] := if (if (f34 in v3) then v3[f34] else true) then f34 else p1;
		globalState.f12, r0, v1, v1[22] := v2, f34, v1, p1;
		var v4: map<bool, int> := map[v2 && false := 0x20a];
		var v5: set<bool> := {v2};
		var v6: multiset<set<bool>> := multiset{v5, v5};
		r0 := if ((multiset{{v2, v2}, v5, v5, v5} > v6) in v4) then v4[multiset{{v2, v2}, v5, v5, v5} > v6] else v1[22];
		globalState.f12 := v2;
		if (v2) {
			globalState.f12 := fm0(f34, globalState);
			v1[22] := p1;
			var v7: seq<bool> := [v2];
			var v8: seq<int> := [v1[22], f34, v1[22] + |v7|];
			r0 := -v8[f34];
			r0 := f34;
			var v9 := DC2(v2);
			...
			var v12: multiset<bool> := multiset{fm0(v1[22], globalState)};
		...
		v18[731] := v1;
		v18[731] := v1;
		var v19: seq<int> := [0x4d, -|(seq(0x387, i0  => ('s')))|];
		var v20: set<seq<int>> := {v19, [v1[22]]};
		var v21 := DC1(v2, v2);
		r0 := v1[22] - fm17(v1[22], v20, v21, p0, globalState);
	}
}
...
class C8 extends T1 {
	...
	function fm13(globalState: GlobalState): bool {
		match DC3(f25, f33) {
			...
			case DC0(cf0) => !("tgkclqti" < (seq(0x28c, i0  => ('w'))))
		}
	}
	...
	method m4(p0: D1, globalState: GlobalState) {
		for i0 := f25 to f25 {
			...
			var v5 := "vsr";
			v4[106] := |v5|;
			var v6: seq<int> := [v4[106]];
			var v7: multiset<int> := multiset{|v6|};
			globalState.f12 := v7 !! fm15(globalState);
			v4[106], globalState.f12 := -(0x187 - (|v6| - v4[106])), f32;
			var v8: set<int> := {-|v5|};
			var v9 := DC2(!f33);
			var v10 := 'n';
			var v11 := DC6(v10, f33, v5);
			var v12: map<char, int> := map[v10 := v4[106]];
			var v13: seq<seq<int>> := [seq(0x86, i2  => (i0))];
			var v14: seq<seq<char>> := [(v5[0x3d6 := v10])[|[v4[106]]| := v10]];
			v8, globalState.f12, v0, v4[106], v4[106] := fm16(v9, f32, f32, (v11.(cf9 := v5)).cf7, globalState), !(i0 != (if (v10 in v12) then v12[v10] else |v13[0x36a]|)) in v0, [f32, !(f33 <== f32), f33, f32], 0x1f / --(i0 - f25), |v14[|v5| - |v5|]|;
		}
		...
		if ((-f25 % f25) >= -(396 / |(seq(157, i4  => ('x')))|)) {
			...
			if (v15 >= (set v34 : int | v34 in {if (-f25 in v25) then v25[-f25] else v23} :: (v34 * |[0x187, 0x335]|))) {
				v23 := v29[842];
				v29[842] := 0x12e % v29[842];
				var v35 := DC15(v26);
				var v36: array<bool> := new bool[11];
				v36[538] := f33;
				var v37 := "bsjsoh";
				v35, globalState.f10, globalState.f12, v36[538] := v35, v37, v23 == v29[842], !!f33;
			...
			var v43 := DC27(f25, |(seq(0x2c0, i5  => ('k')))| % f25);
			match (v43) {
				case DC27(cf39, cf40) =>
					var v44 := "jgikbaco";
					cf39 := (if (true) then cf40 else -|map[multiset{f33} := f33]|) + (|(seq(-0x239, i6  => ('n')))| * -|v44|);
					var v45: array<bool> := new bool[23](i7 => 0xd7 >= 492);
					v45[262] := f33;
					var v46: array<array<int>> := new array<int>[19];
					var v47: array<int> := new int[7](i8 => i8 / |map[cf39 := DC30(map[f33 := f33])]|);
					v46[146] := v47;
					...
					globalState.f12, v45[262], cf39, v46[146], v48 := |v50| >= f25, if ((|v53| % cf40) in v51) then v51[|v53| % cf40] else f32 || !f32, |v54| % -823, if (|v48| in v55) then v55[|v48|] else v47, v48 + (map v56 : int | (0x68 <= v56) && (v56 < -568) :: (v56 % f25) := (-0x23d));
					v48 := v48[cf40 := cf40];
					cf40 := 0x336;
				case DC26(cf38) =>
					var v57: array<bool> := new bool[7];
					...
					v58[587] := map[f25 := f33];
					var v59: map<int, bool> := map[-f25 := v57[113]];
					v58[587] := v59 + v59;
					var v60 := 0xee;
					v60 := f25;
		...
		var v69: map<int, int> := map[|fm64(f25, f32, 'q', f32, globalState)| := |(set v67 : int | v67 in multiset{f25, f25} :: (v67 % |map[|(map v68 : int | (0x40 <= v68) && (v68 < -0x3e5) :: (v68 % 0x102) := (0x16d))| := |"ksgs"|]|))|];
		...
		if (f32) {
			...
			var v72 := 0x4b;
			v72 := if (f32) then v72 / 0x36d else v72;
			var v73 := new C2();
			...
			var v79 := -719;
			var v80 := DC32(f32);
			var v82: seq<int> := [v79, |(set v81 : int | (0x1c0 <= v81) && (v81 < 957) :: (v81 / f25))|, v79];
			var v83: multiset<int> := multiset{f25, |v82|};
			globalState.f12, v79, v80 := v83 == v83, f25 / v79, v80;
			globalState.f6 := v82[-0xea := v79];
			...
			v87[783] := if (f32) then seq(-0x33c, i10  => (f25)) else v82;
			v79, v86[559], v87[783] := (v79 / f25) % --0x1de, v85, fm19(f32 <==> true, globalState);
		...
		var v93: array<int> := new int[25] [f25, f25, f25, f25, |v89|, v91[f25], |(seq(994, i11  => ('h')))|, f25, f25, |[f33, f33]|, f25, f25, |v92|, |v88|, f25, f25, 317, f25, f25, 0x36a, f25, f25, -0x1d2, f25, 57];
		var v94: seq<array<int>> := [v93, v93];
		globalState.f23 := fm33(f25, f32, |v94|, globalState);
	}
	method m2(p0: array<array<bool>>, p1: bool, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int) {
		var v0: array<int> := new int[20](i1 => i1 + |(seq(0x60, i2  => (multiset{p1, p2, f33})))|);
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := i0 / (|(seq(0x244, i3  => ('w')))| % f25);
		}
		var v1: C2 := new C2();
		var v2: set<bool> := {p1};
		r0, globalState.f12, v1 := --0x1fa / (f25 + |v2|), {p1, f32} > fm20(p2, globalState), v1;
		...
		for i4 := -v3.cf44 to f25 {
			...
			p3[659] := -(i4 / -(f25 % v5[i4]));
			v4[186] := f33;
			v4[186], p3[659], globalState.f12, p3[659] := true, p3[659], f32, p3[659];
			var v6: seq<seq<int>> := [[i4], v5 + v5, v5, v5, [i4]];
			var v7: seq<bool> := [f32, p1];
			v5, v4, p3[659], p3[659], p3[659] := v6[|(if (f33) then map[v4 := f25] else map[v4 := i4])|], v4, |v7|, i4 + p3[659], i4;
		}
		...
		if (p2) {
			...
			v15 := v16[|(v17 * v17)|];
			var v18: array<char> := new char[19] [v10[|v10|], if (!f32) then fm39(p2, globalState) else v9, v9, v9, v9, v9, v9, if (f33) then v9 else 'w', v9, fm39(p1, globalState), v9, fm39(f33, globalState), 'k', v9, v10[f25], v9, v9, v9, v9];
			v18[482] := v9;
			var v19 := DC27(-f25, f25);
			var v20: seq<D9> := [v19];
			var v21: seq<seq<D9>> := [v20 + v20, v20 + v20, [v19]];
			v9, r1, v18[482], globalState.f10, v20 := v9, f25 - f25, 'w', fm2(f25, f25, globalState) + v10, v21[f25];
			globalState.f12 := f32;
			var v22: map<string, char> := map[v10 := v18[482]];
			...
			match (v25) {
				case DC40() =>
					...
					v26.f26[607] := v28 + v28[|v29| := v27];
					var v30: multiset<string> := multiset{v28};
					var v31: seq<int> := [|(seq(0x8d, i5  => ('m')))|];
					var v32 := DC6(v28[|v31|], f33, v28);
					var v33: map<int, bool> := map[|v28| := f32];
					var v34: seq<bool> := [true];
					globalState.f12, v26.f26[607], globalState.f12 := !((-(if (v32.cf9 in v30) then v30[v32.cf9] else |v28|) != f25) ==> f32), if (f33) then seq(0x21a, i6  => (v27)) else v28[|v29| := fm39(false, globalState)], if (f33) then if (f25 in v33) then v33[f25] else f32 else v34[f25];
			...
			var v40: map<map<string, array<char>>, bool> := map[v39 + map[seq(0xdf, i8  => (v37)) := v38] := f25 != f25];
			v40 := v40[v39 := |"wya"| != f25];
			...
			if ((v43 + v43) >= v43) {
				var v44: array<map<int, bool>> := new map<int, bool>[20];
				var v45: map<int, int> := map[|(seq(650, i9  => (f25)))| := f25];
				v44[906] := map[|v45| := f33];
				var v46 := "fpmh";
				var v47: multiset<int> := multiset{-f25, f25};
				var v48: map<int, bool> := map[f25 := p1];
				globalState.f12, globalState.f10, r1, v44[906] := f33, "pdjfim" + v46, (if (|v46| in v47) then v47[|v46|] else fm44(f33, p1, f32, f25, globalState)) - f25, v48 + ((map v49 : int | (349 <= v49) && (v49 < -119) :: (v49 * -f25) := (p1)) + v48);
				...
				r1, v51[693], v53[206] := |v54|, v47, v55[fm44(p2, p1, p1, --f25, globalState)];
				globalState.f10 := seq(-0x2a1, i11  => (v37));
				globalState.f10 := v46;
			} else {
				var v56: array<bool> := new bool[27];
				var v57: map<bool, bool> := map[f32 := f32];
				v56[693] := DC36(v57, fm13(globalState), f25).cf55;
				v56[693] := p1;
				var v58: map<char, int> := map[v37 := -(f25 - f25)];
				v58 := v58[v37 := f25];
				r0 := 22 + f25;
				v57 := v57[p1 := !v56[693]];
				globalState.f23 := if (v56[693]) then v37 else v37;
			}
	...
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		v3 := v3[f25 := true];
		var v9: seq<int> := [f25];
		var v10: array<bool> := new bool[5] [v5[515], f33, f32, v9 != v9, f33];
		v10[180] := !fm0(-|(map[v1 := f25])[v1 := f25]|, globalState);
		v10[180] := f33;
		...
		var v14: set<int> := {f25};
		r0 := f25 * (v9[f25] * (if (f25 in v13) then v13[f25] else |v14|));
	}
	method m8(p0: bool, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: T1) {
		...
		var v2 := 'l';
		var v3: multiset<int> := multiset{if (p0) then 250 else |p2|, v0, v0, |v1[|("gs")[f25 := v2]|]| % v0, f25};
		v3 := v3;
			...
			decreases 100 - i0
		{
			...
			var v7: set<bool> := {f32};
			v0, globalState.f12, v0, v0 := f25, p0, (f25 / f25) % (v0 % |v6|), 314 % -|(map[v7 := p2] + map[v7 := "hwy"])|;
			var v8: multiset<bool> := multiset{f32, p0};
			globalState.f12 := v8 !! (v8 * v8);
			if (f33) {
				p1[677] := -f25;
				p1[677] := f25;
				var v9: seq<int> := [p1[677], |"wfla"|];
				var v10: set<multiset<int>> := {v3, v3 * v3[p1[677] := |v9|]};
				var v11 := DC43(v10);
				v10 := v11.cf62;
				var v12 := new C3(p1[677], p0, -f25, f26);
				...
				p1[323] := v0;
				p1[323] := -fm44(p0, f32, fm0(|v3|, globalState), v0, globalState);
			}
			
			if (f32) {
				globalState.f12 := f32;
				v4[411] := fm0(v0, globalState);
				v4[411], v0 := f33, f25;
				var v21: map<string, seq<bool>> := map[((seq(0x1e, i1  => (v2))) + p2)[|v1| := v2] := v6 + [!p0]];
				v6 := if (p2 in v21) then v21[p2] else (v6 + v6)[|v7| := true];
				globalState.f12 := f32;
				...
				var v27: map<int, int> := map[f25 := v0 / v0];
				v27 := v27;
	...
	method m9(p0: int, globalState: GlobalState) returns (r0: bool, r1: map<bool, bool>, r2: bool, r3: seq<bool>) {
		...
		if (f25 == f25) {
			if (p0 != --v2.f37) {
				...
				r0, globalState.f12, v21 := f33, v2.f38, (0x2b3 - v2.f37) / v2.f37;
				var v23 := DC48(f25 % 0x315);
			...
			var v32 := new C2();
			var v33: map<bool, string> := map[v30 != (seq(0x103, i3  => (v29))) := v30];
			v33 := v33[v31.f35 := v30];
			var v34 := new C2();
		} else {
			var v35 := 0x306;
		...
		var v50: set<int> := {p0, (v47.(cf44 := v2.f37, cf42 := true)).cf44, |fm67(f32, v46, v49, globalState)|, f25 % p0};
		v46 := |v50|;
		...
		match (v55) {
			...
			case DC33(cf48, cf49, cf50, cf51) =>
				...
				var v66: array<int> := new int[4] [|(map[|v63| := v64])[|v65| := "dtftgurm"]|, cf51, fm44(f32, !f33, f33, --v2.f37, globalState), f25 % p0];
				v66[438] := 0x314;
				v66[438] := |(v0 + v0)| - fm18(globalState);
				v66[438] := v66[438];
				if (true) {
					globalState.f10 := v64;
					v66[438] := v2.f37 - v2.f37;
					v66[438] := f25;
					...
					cf50 := v2.f38;
					var v72 := 's';
					v66[438], globalState.f23, v66[438] := (cf51 - cf51) + f25, v72, |fm15(globalState)| + v53[v2.f37];
					var v74: map<int, bool> := map[v46 := v2.f38];
					var v75: set<map<int, bool>> := {map v73 : int | (0x1d6 <= v73) && (v73 < -568) :: (v73 / |[cf50]|) := (v2.f38), map[v66[438] := f32], v74};
					v75, v66[438] := v75 - v75, v2.f37;
					v66[438] := v46 + (f25 + v46);
				}
			...
			case DC31(cf46) =>
				v51 := v51;
				var v77 := "erjupre";
				var v78: map<int, bool> := map[-(|(map v76 : int | (0x149 <= v76) && (v76 < 650) :: (v76 - v2.f37) := (p0))| % v2.f37) := v77 == (seq(177, i5  => ('f')))];
				v78 := v78;
				v46 := --p0;
				var v79 := DC15(v48 - v48);
				v79 := v79;
			case DC34(cf52) =>
				var v80: array<int> := new int[17](i6 => i6 / 0xaf);
				v51[723] := v2.f38;
				v80[354] := f25;
				v80, v51[723], v80[354] := if (v0[v2.f37]) then v80 else v80, v2.f38, (v46 * v46) / p0;
				v80[354] := v2.f37 % p0;
				var v81: array<bool> := new bool[4];
				var v82 := DC18(map[v81 := v80[354]]);
				match (v82) {
					case DC19(cf29, cf30) =>
						v46, cf30 := v80[354], -v2.f37;
						v80[354] := -(v2.f37 + (96 - -0x24f));
						cf30 := v53[cf30] + (0xec + |v0|);
						v46 := v46;
					case DC18(cf28) =>
						...
						v83[641], v46, v80[354], v84, v80[354] := v85.cf32, v46, |(v0 + v0)|, v84, (|v86| % v2.f37) * 663;
						v46 := -p0;
						v80[354] := v2.f37;
						v80[354] := f25;
					case DC20(cf31) =>
						...
						var v94: C6 := new C6(v80[354], f26);
						var v95: map<C6, bool> := map[v94 := f33];
						v91 := v91 + (if (v2.f38 in v92) then v92[v2.f38] else map[v90 := v93[|v95|]]);
				}
			...
			decreases 100 - i7
		{
			...
			v98[674] := DC22(v2.f37, f25);
			var v99 := DC22(v2.f37, 0x289);
			v98[674] := if (fm0(392, globalState)) then v99 else v99;
			v46 := |(v52[v2.f38 := p0] + v52)| % |[v53, seq(-0x32e, i8  => (f25)), [-f25]]|;
...
class C9 {
	...
	method m7(p0: array<D1>, p1: seq<int>, p2: char, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v12: map<multiset<array<int>>, multiset<string>> := map[multiset{f30} := multiset{"lv", v11[v3]}];
		var v13: multiset<array<int>> := multiset{f30};
		var v14: map<char, string> := map[p2 := "ntjlswu"];
		var v15: multiset<string> := multiset{if (p2 in v14) then v14[p2] else v10, (v10[p3 := p2])[p3 := p2]};
		globalState.f16 := if (v13 in v12) then v12[v13] else v15;
		for i1 := p3 to -fm11(set v16 : int | v16 in {-|multiset{v10, seq(-153, i2  => (p2))}|, p3} :: (v16 * |(seq(0x2ad, i3  => ("k")))|), p2, globalState) {
...
class C10 extends T0 {
	...
	method m2(p0: array<array<bool>>, p1: bool, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int) {
			...
			decreases 100 - i0
		{
			...
			v0[133] := v2;
			p3[676] := f25 % f25;
			v0[133], p3[676] := v2, (if (p2) then f25 else f25) + -0x1a9;
			if (p1) {
				var v3 := new C0();
				var v4: array<bool> := new bool[21](i1 => {|multiset{DC29(p2, p2, p3[676]).cf44, p3[676]}|} > {f25});
				v4 := v4;
				p3[676] := f25;
				var v5 := new C5(false);
				globalState.f23 := f29;
				...
				var v8 := DC3(|v6[p1 := |v7|]|, p2);
				p3[676] := -((p3[676] * v8.cf4) - f25);
				p3[676] := if (true) then -f25 else f25;
				var v9: seq<int> := [f25];
				globalState.f12, p3[676], r0, globalState.f12 := !(f25 != p3[676]), p3[676] - |(seq(0x281, i2  => (|v1|)))|, (|v9| + p3[676]) + f25, p3[676] >= p3[676];
				globalState.f6 := (v9 + (seq(0x51, i3  => (p3[676])))) + v9;
				r1 := f25 * -p3[676];
			}
			
			globalState.f10 := (seq(650, i4  => (f29))) + "kmuer";
		}
		r1 := f25;
		var v10 := new C6(f25, f26);
		for i5 := f25 to f25 - f25 {
			var v11: seq<array<string>> := [f26, f26, f26, f26, f26];
			var v12 := new C3(i5, p1, f25, v11[f25]);
			r0 := f25;
		...
		if (p1) {
			globalState.f12 := p1;
			r0 := -(fm44(p1, p2, false, f25, globalState) % f25) + f25;
			globalState.f12 := !p2;
			if (p2) {
				...
				v31[884] := v28;
				f26[696] := [fm39(p2, globalState), f29, f29, f29];
				var v32: seq<char> := [f29];
				v31[884], f26[696], globalState.f12 := v28, v32, v32 == "pbgxd";
				var v33: array<bool> := new bool[16];
				v33 := v33;
				var v34: set<int> := {|([f29])[f25 := 'y']|};
				var v35: map<int, string> := map[|v34| := v32];
				p3[718] := |((if (f25 in v35) then v35[f25] else "v") + v32)|;
				p3[718] := f25;
				var v36: array<multiset<bool>> := new multiset<bool>[25](i6 => multiset(v30) + multiset{!p1, p2});
				var v37 := DC32(p2);
				v36[997] := multiset{v37.cf47};
				var v38: multiset<bool> := multiset{!p1};
				var v39: map<int, multiset<bool>> := map[f25 := v38];
				var v40: seq<int> := [|f26[696][p3[718] := f29]|];
				v36[997] := if (-(p3[718] * v40[f25]) in v39) then v39[-(p3[718] * v40[f25])] else v38;
			...
			var v60: array<multiset<bool>> := new multiset<bool>[21] [v53, multiset([p2, fm0(f25, globalState)]), multiset(v54), v53[p1 := f25], v53, fm50(|v56[v55 := f25]|, v57, p1, f25, globalState), v53, v53 - multiset(v54), v53, v53, v53, (multiset{p2})[p1 := f25], v53[p2 := |v58|], v53, v53, fm50(|v59|, v57, true, f25, globalState), v53, v53, v53, v53, v53 + v53];
			v60[0] := v53;
			r1, p3[76], v60[0] := -(|map[p1 := p2]| / f25), fm18(globalState) * -367, v53;
		} else {
			p3[246] := f25 * |[f25, 0xf3]|;
			var v61: array<map<bool, string>> := new map<bool, string>[14](i7 => map[p1 := seq(0xa3, i8  => ('m'))] + map[p2 := seq(337, i9  => (f29))]);
			var v62 := "is";
			var v63: map<bool, string> := map[p1 := v62];
			v61[948] := v63;
			var v64: multiset<bool> := multiset{p1};
			var v65: set<int> := {fm44(p1, p1, p2, f25, globalState), |v64|, f25 % |[f25, f25]|};
			p3[246], v61[948] := |v65|, v63;
			if (if (p2) then p1 else p2) {
				...
				v72 := v72 + ((seq(0x256, i11  => (DC4(v71).cf6))) + v72);
			} else {
				p3[246] := |(map v73 : int | (298 <= v73) && (v73 < 0x37b) :: (v73 + f25) := (p1))| / 0x176;
				globalState.f12 := p2;
				globalState.f12 := ((seq(0x389, i12  => (f29))) + v62[p3[246] := f29]) < (v62 + "xsanvurs");
				...
				var v78: map<D18, int> := map[DC44(f25, p2, v62, p2, v77) := p3[246]];
				var v80: set<D18> := {DC44(p3[246], p1, v62, true, v77)};
				var v81: map<bool, int> := map[p2 := p3[246]];
				var v82: map<int, map<bool, int>> := map[0x1e9 := v81];
				var v83 := DC17(|(if (f25 in v82) then v82[f25] else v81)|, p1);
				var v84: array<bool> := new bool[17] [fm0(p3[246], globalState), p1, v74[|(if (-0xed in v75) then v75[-0xed] else v62)|], (set v79 : D18 | v79 in v78 :: (v79)) > v80, 282 >= 0x350, v83.cf27, v74[22], p1, p2, if (!p1) then p2 else !false, p2, p1, p1, false, !p1, v74 < v74, p2];
				v84[187] := v62 == v62;
				v84[187] := !(v62[546] !in (v62 + v62));
				v84 := v84;
			}
			...
			v85[180] := multiset{v86};
			var v88: multiset<int> := multiset{|v62|, p3[246]};
	...
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			var v5: array<multiset<D0>> := new multiset<D0>[22] [v1, v1[v0 := f25], v1, v1, v1, v1, v1, v1, v1, v1, multiset{v0.(cf3 := p1)}, v1, v1, v3[0x1b], if (p1) then v1 else v1, v1 - v1[v0 := f25], v1, v1, v1, multiset{v0, v0}, (multiset(v2))[v0 := if (p1 in v4) then v4[p1] else f25] * v1, v1];
			v5[69] := v1;
			var v6 := "yupwkrstt";
			globalState.f10, r0, v5[69] := v6 + ("tmq" + "in"), f25 + (f25 - (if (p1 in v4) then v4[p1] else f25)), v1[DC2(p1) := f25];
			if (p1) {
				...
				v22[532] := |(if (p1) then v23 else v23)|;
				v17[553] := p1;
				v17[553] := p1;
				var v24: set<int> := {-v22[532]};
				v22[532], globalState.f12, globalState.f12 := v22[532], v17[553], |(seq(0x321, i1  => (f29)))| in v24;
			}
			
			var v25: array<int> := new int[4];
			var v26: array<array<int>> := new array<int>[11] [v25, if (p1) then v25 else v25, v25, v25, v25, v25, v25, v25, v25, v25, p0[f25]];
			v26 := v26;
		}
...
class C11 {
	...
	method m6(p0: seq<bool>, p1: char, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			var v12: array<int> := new int[19] [v4, |"pb"|, fm44(v0, v0, v0, v7.f25, globalState), v7.f25 / v4, v7.f25, -v7.f25 + v7.f25, v7.f25, |v9|, |"xeoqcuqdk"|, v7.f25, v7.f25, v4, fm18(globalState), 0x17a - v4, v4, |v11|, -v4, v4 - v4, v7.f25];
			v12 := v12;
		}
		var v13 := -572;
		var v14 := "hkg";
		...
		var v19: map<C1, int> := map[v18 := v17.f37 / v17.f37];
		v19 := v19[v18 := 0x262];
		if (v15) {
			if (v17.f38) {
				v15 := p1 in v14;
				...
				v22 := v22[v21 := v13 % v13];
				v13 := (v17.f37 % v17.f37) - |v14[|(seq(0x3bc, i1  => (p1)))| := p1]|;
				...
				v20[544] := |v25|;
				v20[544] := fm18(globalState) / |{fm44(v17.f38, v15, v17.f38, |v23|, globalState), v17.f37, v17.f37}|;
			} else {
				...
				var v28: array<int> := new int[9] [v17.f37, v17.f37, v17.f37, |(seq(0x133, i3  => ('q')))|, v17.f37, -|("vbievbw")[v17.f37 := p1]|, v13, |v27|, 0x1ad];
				var v29: map<bool, int> := map[v17.f38 := v17.f37];
				var v30: C7 := new C7(|map[v28 := |v29[v26[878] := |v14|]|]|);
				var v31: set<array<bool>> := {v26};
				var v32 := DC9(v31);
				var v33: seq<int> := [v17.f37];
				var v34: C4 := new C4(v16, v30.f34, v16);
				var v35: map<seq<int>, C4> := map[v33 := v34];
				v30, v15, v13, v13, v32 := v30, v15 <== v17.f38, v17.f37, -(|v14| * |v29|) / |v35|, v32;
				v13 := v13;
				...
				var v39 := DC18(v38);
				v37[432] := v39;
				r0, v26[878], v36, v37[432] := v17.f38, -v17.f37 <= v13, map[v17.f37 := v26], v39;
			}
			
			var v40: array<int> := new int[11](i4 => i4 / |map[v15 := 0x368]|);
			v40[525] := -(v17.f37 + v17.f37);
			v40[525] := (-v17.f37 * v13) * fm44(v17.f38, v17.f38, v17.f38, v17.f37, globalState);
			globalState.f12 := v17.f38;
			if (v17.f38) {
				var v41: map<bool, int> := map[v17.f38 := v40[525]];
				...
				var v44 := DC9({v43});
				var v45: map<int, D3> := map[v40[525] := v44];
				var v46 := DC46(v45 + v45);
				v46 := v46;
				var v47 := DC4(p0);
				var v48: seq<D1> := [v47, v47.(cf6 := p0), v47];
				var v49: array<seq<D1>> := new seq<D1>[26] [v48[v17.f37 := DC4(p0)], v48, v48, v48, v48, v48, [v47, DC4(p0)], v48, fm68(v17.f38, v17.f38, v14, fm9(v15, |map[v17.f38 := v15]|, globalState), globalState), v48, v48 + v48[v17.f37 := v47], [v47], v48, v48, seq(0x365, i5  => (v47)), v48 + v48, v48, v48, v48[v40[525] := v47], v48, v48, [DC4([v15]), v47], v48, v48[v40[525] := v47] + v48, (([v47])[v17.f37 := v47])[|p0| := v47], [v47]];
				v49 := v49;
			} else {
				var v50: array<set<bool>> := new set<bool>[24](i6 => {v17.f38, v17.f38, false});
				v50 := v50;
				var v51: map<bool, bool> := map[v15 := v17.f38];
				v40[525] := if (v40[525] > v40[525]) then v17.f37 else |v51| / v17.f37;
				var v52: array<bool> := new bool[26] [v17.f38, v17.f38, v17.f38, v17.f38, v15, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, p0[(fm66(globalState)).cf71], v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, v17.f38, !!!true, v15, v17.f38];
				var v53: seq<array<bool>> := [v52, v52, v52];
				var v54: array<array<bool>> := new array<bool>[26] [v52, v53[0x24e], v52, v52, v52, v52, v52, v52, v52, v52, if (v17.f38) then v52 else v52, v52, v52, v52, v52, v52, if (false) then v52 else v52, v52, v52, v52, v52, v52, v52, v52, v52, v52];
				var v55: multiset<bool> := multiset{v17.f38, false};
				var v56 := DC49(v54);
				v13, v54, v40[525], v55 := DC38(v40[525]).cf58, v56.cf72, v13, v55;
				var v57: seq<bool> := [v15];
				v57 := v57 + v57[v17.f37 := v15];
				var v58 := new C5(v17.f38);
			}
			
			v40 := if (v17.f38) then v40 else v40;
		} else {
			if (-(v13 / v17.f37) != v17.f37) {
				var v59: set<bool> := {v17.f38, v17.f38, v15, fm0(v17.f37, globalState), v17.f38};
				v59 := v59;
				var v60: map<int, bool> := map[-v17.f37 + |multiset{|v14[v17.f37 := p1]|, v17.f37}| := true];
				v60 := v60[v17.f37 := v15];
				var v61: map<int, int> := map[v13 := v17.f37 / v17.f37];
				v61 := v61[v13 := 0x1b7];
				...
				var v73: multiset<bool> := multiset{DC10(v15, v70, v17.f38, v71[|v72|], |v67|).cf13};
		...
		if (match v78 {
			...
			var v79: C0 := new C0();
			var v80: seq<C0> := [v79];
			var v81: array<C0> := new C0[26] [v79, v79, v79, v79, v79, v79, v79, v80[v13], v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79, v79];
			v81[478] := v79;
			v81[478] := new C0();
			...
			globalState.f6, v13, v13 := [if (v17.f38) then |v82| else |v83|], if ((|v85| / |v14|) in v84) then v84[|v85| / |v14|] else v17.f37, v17.f37;
...
class C12 extends T1 {
	...
	method m4(p0: D1, globalState: GlobalState) {
		...
		var i0 := 0;
		while ((f27 / f27) >= (v0[f25] * |(if (|v5| in v2) then v2[|v5|] else v1)|))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v7: array<bool> := new bool[24] [f28, f28, f28, f28, false, fm0(f25, globalState), f28, !f28, f28, v6[f27], f28, f28, f28, f28, true, false, f28, f28, f28, f28, f28, f28, f28, f28];
			var v8: map<bool, array<bool>> := map[f28 := v7];
			var v9: seq<map<bool, array<bool>>> := [v8];
			v8 := (v8[f28 := v7] + v8) + (v9[f27] + v8);
			var v10 := 0x28;
			v10 := (f27 / v10) + v10;
			v7 := v7;
		...
		var v14 := new C8(v12 < multiset(v13), !f28, -(f25 / f25), f26);
		...
		v18[922] := v20 + multiset([v19, DC10(f28, v15, false, f27, f27), v19, v19, v19]);
		v3[74] := f27;
		var v21 := 'y';
		v16, globalState.f23, v17, v18[922], v3[74] := if (fm0(0x373, globalState)) then fm15(globalState) else if (f28) then v16[f27 := f25] else multiset{f25, f27}, v21, v17 + v17, multiset{v19} - v20, f25;
		forall i3 | 0 <= i3 < v3.Length {
			v3[i3] := i3 - (0x246 / -f27);
		}
		var v22: array<multiset<D4>> := new multiset<D4>[24];
		var v23 := DC13(v3[74], v14.f33, v14.f33, f28);
		var v24: multiset<D4> := multiset{DC13(f25, f28, v14.f32, v14.f32), v23};
		v22[908] := v24 + v24;
		var v25 := DC8(v0);
		var v26 := DC38(v14.fm14(f28, globalState));
		v3[74], v22[908], v3, v25 := match v26 {
			case DC38(cf58) => if (!false) then v3[74] else f25
			case DC37(cf57) => f27
	...
	method m3(p0: seq<array<int>>, p1: bool, globalState: GlobalState) returns (r0: int) {
		...
		match (v1) {
			case DC1(cf1, cf2) =>
				...
				if (if (f28) then v2 !! v2 else true) {
					...
					v16 := fm48(cf1, |v17| / -0x92, f25, |(v18 * v18)|, globalState);
				...
				var v23: map<bool, C11> := map[p1 := v20[|v22|]];
				var v24: map<bool, C11> := map[!cf2 := if (cf1 in v23) then v23[cf1] else v19];
				v24 := v24[!p1 := v19];
				var v25: seq<int> := [f25, -f27, 0x351];
				var v26 := DC17(-(-f25 - f27), v25[f25] > f27);
				var v27 := "lfdfdgsi";
				var v28: seq<string> := [v27];
				var v29: array<bool> := new bool[4] [v28[0x2e3] != v27, true, !!p1, f27 < f27];
				v29[762] := f28;
				var v30: map<int, string> := map[|v25| := v27];
				r0, cf1, v26, v29[762] := f25, v27 <= (if (f27 in v30) then v30[f27] else v27), v26.(cf27 := cf1), f27 < f25;
				v29[762] := cf2;
			case DC2(cf3) =>
				var v31: set<int> := {f27};
				cf3 := (v31 - v31) >= (v31 * {f25});
				...
				var v43: array<int> := new int[21] [f25, -f27, if (v34 in v36) then v36[v34] else |map[false := cf3]|, f25, fm31(v37, globalState), f27, f25, 0x59, f27, |v39|, f25, f25, |(set v41 : int | v41 in v40 :: (v41 % -|[true, !true]|))|, if (fm21(v42, |p0|, cf3, v37, globalState) in v32) then v32[fm21(v42, |p0|, cf3, v37, globalState)] else f25, |v32|, f27, f27, |v33|, |v31|, f27, f27];
				var v44: seq<int> := [f27, 0x227];
				var v45: multiset<int> := multiset{v44[f27], f27, f27};
				var v46 := DC15(v45);
				var v47: seq<multiset<int>> := [multiset{f25, f25, |v40|}, v45, v46.cf24];
				var v48: map<array<int>, multiset<int>> := map[v43 := v47[f27]];
				v48 := v48;
			case DC3(cf4, cf5) =>
				var v49: array<bool> := new bool[23];
				var v50: map<bool, array<bool>> := map[fm0(cf4, globalState) := v49];
				v50 := v50[cf5 := v49];
				var v51: map<bool, string> := map[f28 := seq(0x146, i1  => ('h'))];
				globalState.f10 := if (p1 in v51) then v51[p1] else fm2(267, f27, globalState);
				v49[619] := v0[cf4];
				v49[619] := !!cf5;
				globalState.f23 := fm33(cf4, !cf5, fm8(v49[619], v49[619], globalState), globalState);
			case DC0(cf0) =>
				...
				if (f25 >= f27) {
					v54[225] := !(f25 >= (302 * f27));
					globalState.f12, globalState.f12, r0, r0 := v54[225], !p1, f27, f25 - f25;
					r0 := 0x1c6;
					f28 := (f25 % f27) > 0x1fa;
					var v55: array<int> := new int[2](i2 => i2 + |v0|);
					var v56: map<int, int> := map[f27 := f25];
					f28, v55, r0, f28, f28 := f28, if (0x35b <= |v56|) then v55 else v55, -f25, p1, v0[f27];
				} else {
					r0 := f25;
					var v57: map<bool, int> := map[v0[f27] := f25];
					v57 := v57 + (v57 + v57);
					...
					var v60 := 'o';
					var v61 := "m";
					var v62: map<string, array<array<D3>>> := map[seq(701, i3  => (v60)) := v58];
					v59[664] := if (v60 in v61) then v58 else if (v61 in v62) then v62[v61] else v58;
					var v63 := DC38(f25);
					var v64: multiset<bool> := multiset{cf0};
					v63 := fm70(v54[225], f25 - |v64|, v54[225], globalState);
		...
		match (match DC4(v0) {
			...
			case DC42(cf61) =>
				var v71: map<bool, int> := map[p1 <== p1 := f27 / f27];
				v71 := v71;
				...
				var v79: array<set<seq<T0>>> := new set<seq<T0>>[16] [{v73}, v74, v74, {[v72]}, v74, v74 + v74, v74 - v74, v74, v74, v74 * v74, v74, {v73, v73} - v74, {v73, v75[819], v73, ([v72])[|v78[v76 := v77]| := v72], v73}, v74, v74 * v74, {v73, v73}];
				v79[818] := if (f28) then {[v72, v72, v72]} else v74;
				...
				r0, r0, v79[818] := |(v81[v72.f25 := v76] + map[|v83| := v76])|, f25 / |v84|, (DC51(v74).(cf76 := v74)).cf76;
				globalState.f6 := v69;
				var v85 := DC9(v84);
				...
				match (v87) {
					case DC47(cf69, cf70) =>
						var v88: set<seq<int>> := {v69[f25 := f25]};
						globalState.f12 := if (v88 !! {v69, seq(0x1f8, i5  => (|v67|)), v69, v69}) then !(v72.f25 < v72.f25) else f28;
						cf69[928] := v77.f35;
						cf69[928] := fm0(v72.f25, globalState);
						globalState.f12 := v77.f35;
						cf70 := fm0(v72.f25 - v72.f25, globalState);
					case DC48(cf71) =>
						v0 := v0;
						v76[624] := if (f28) then v77.f35 else p1;
						var v89: set<int> := {f25, cf71};
						v76[624] := v89 > v89;
						globalState.f12 := v76[624];
						...
						globalState.f23, v90[31], v94 := v82, DC12(), p0[v72.f25];
					case DC46(cf68) =>
						var v95: map<int, seq<bool>> := map[if (v77.f35 in v71) then v71[v77.f35] else f25 := [v77.f35]];
						v76[438] := (if (v72.f25 in v95) then v95[v72.f25] else [p1, f28]) <= v0;
						v76[438] := f28;
						v76[438] := p1;
						r0 := if (v77.f35) then -0xc8 / |v67| else v72.f25;
						var v96 := new C0();
				}
		...
		if (!(v67 <= (if (p1) then v67 else fm2(0x227, f27, globalState)))) {
			var v97 := 'y';
			globalState.f10 := DC6(v97, v0[f27], v67).cf9;
			globalState.f12 := !p1;
			var v98: map<bool, bool> := map[f28 := f28];
			var v99 := DC52(0xa4 / |v98|, -f25 * f25, v67, f28, f27);
			v99 := v99.(cf81 := f27 / f25, cf79 := v67 + v67, cf80 := !false);
			...
			var v108: map<int, int> := map[f25 / v105.f34 := |fm2(f25, |v0|, globalState)| * |v107|];
			v108 := v108[0xbe * f27 := f25 / v105.f34];
			...
			v109[986] := DC10(p1, v110, if (p1 in v111) then v111[p1] else f28, v105.f34, f27).cf14;
			...
			v120[278] := map[f25 := f27];
			var v121: map<int, string> := map[-v105.f34 := v67];
			var v122: map<int, array<bool>> := map[fm44(f28, f28, false, v105.f34, globalState) := v110];
			var v123 := DC23(map[if (f27 in v122) then v122[f27] else v109[986] := p1]);
			var v124 := DC25(v123);
			var v125 := DC25(v124);
			var v126: seq<D8> := [DC25(v123), v125, v125, v125.(cf37 := v123)];
			var v128: multiset<int> := multiset{|v67[v105.f34 := v118]|, f27};
			var v129: map<int, multiset<int>> := map[942 := v128];
			v120[278], r0, v121, v126, globalState.f12 := map v127 : int | (0x3a9 <= v127) && (v127 < 61) :: (v127 - v105.f34) := (|map[false := |v0|]|), f27, (map[-fm8(p1, true, globalState) := "lf"] + v121)[-f27 := v67 + "h"], (v126 + v126) + v126, (|(fm71(if (f27 in v129) then v129[f27] else multiset(v69), globalState)).cf6| <= f25) <== p1;
		}
	...
	method m5(p0: array<int>, p1: bool, p2: D2, p3: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: string) {
		...
		var v11: seq<bool> := [if (v5.cf21 in v4) then v4[v5.cf21] else p1, v0 !in (seq(-0x3a4, i1  => ('t'))), v10 !! multiset{-893}];
		v1[187], v3, r1, v3 := v3 > f27, f27, v11[0x322], -v3;
		if (p1 || (-v3 > f25)) {
			var v12: multiset<bool> := multiset{p3, p1, f28};
			v4 := v4[v1[187] := multiset{v1[187], p1} < v12];
			globalState.f12 := !p1;
			v1[187] := !(p3 || (if (p3) then v1[187] else f28));
			p0[362] := v3;
			var v13: map<int, string> := map[f25 := seq(0x10f, i2  => ('j'))];
			var v14: set<int> := {f27};
			var v15: map<int, int> := map[f27 := --v3];
			var v16: map<int, int> := map[fm44(v1[187], !p3, fm0(|"cojfkt"|, globalState), v3, globalState) := -(if (0x1e2 in v15) then v15[0x1e2] else 0x31f)];
			var v17 := "cqj";
			var v18: set<bool> := {p3};
			var v19: map<set<bool>, int> := map[v18 := fm44(true, v1[187], f28, v3, globalState)];
			p0[362], globalState.f12, v3, f28 := f25, fm27(p1, v13, globalState) >= v14, if ((|v17| % f25) in v15) then v15[|v17| % f25] else |(v19 + v19)|, true;
			var v20: map<char, int> := map[v0 := f27];
			v20 := v20[v0 := f25];
		} else {
			var v21: seq<array<int>> := [p0];
			var v22: multiset<bool> := multiset{p3, |{v21[f27]}| == f27, true};
			v22 := v22 - (v22 - v22);
			var v23: array<int> := new int[12](i3 => i3 % |(seq(0x1f3, i4  => (v0)))|);
			v23 := p0;
			if (v1[187]) {
				var v24: map<bool, char> := map[p1 := v0];
				var v25: C9 := new C9(p0, v3);
				var v26: map<bool, C9> := map[v1[187] := v25];
				...
				var v30: set<seq<int>> := {seq(-0x364, i5  => (f27))};
				v29 := v29[map[v24 := v26] + map[v24 := v26] := v30];
				globalState.f12 := p1;
				f28 := !!v1[187];
				var v31 := "fjfg";
				r2, v3, v3 := if (v11[v3]) then v31 else v31, v25.f31, |(v31 + (seq(-750, i6  => (v0))))|;
				v23[18] := -852;
				var v32: map<int, int> := map[v25.f31 := f25];
				v23[18] := f27 * (v25.f31 + |v32|);
			} else {
				v1[187] := !!f28;
				v3 := |fm2(f27, f25, globalState)|;
				v3 := v3;
				r0 := !!f28;
				var v33 := DC10(v11[v3], v1, f28, f25, v3);
			...
			if (true) {
				...
				v36, v3, r0, v3, v23 := v36.(cf58 := |v4|).(cf58 := f27), v3 + f25, |(if (v1[187] in v38) then v38[v1[187]] else multiset{v10, multiset(v7), v10})| == (v3 - 810), f25 - f27, v21[v7[v3] + v3];
				v3 := |(v11 + v11)|;
				...
				var v48 := DC39(multiset{v1[187], v1[187]});
				...
				p0[988] := |v11|;
				p0[988] := f25;
				p0[988], v3, v11 := fm44(false, !f28, false, fm18(globalState), globalState), f25, v11;
				f28 := fm0(p0[988] + f27, globalState);
			}
			
			if (p1) {
				var v53 := new C7(v3 % 0x240);
				var v54 := "gmclbyo";
				globalState.f12, v1[187], v23, r2, v3 := (if (!p1 in v22) then v22[!p1] else f27) <= v53.f34, p3, p0, v54, -f27;
				v3 := v53.f34;
				v3 := --v3 % f25;
				v7 := v7[f27 := 155] + v7;
			} else {
				...
				var v63: map<bool, string> := map[f28 := seq(229, i8  => ('a'))];
				v63 := v63[f28 := v62];
			}
		...
		forall i9 | 0 <= i9 < v1.Length {
			v1[i9] := if (!f28) then v1[187] else true;
		}
		r1 := |[v7[f27], f27]| <= f27;
		v1[187] := v1[187];
		r0 := (p1 <== false) <==> f28;
...
class C13 {
	...
	method m1(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool, r1: map<seq<int>, string>, r2: bool, r3: seq<bool>) {
		...
		var v6: multiset<D1> := multiset{v2, v2, DC7(v5[p0]), v2};
		r3 := [v4[p0] >= (set v7 : D1 | v7 in v6 :: (v7)), false];
		var v8 := 'c';
		globalState.f23 := v8;
		...
		for i0 := p0 to -|(fm4(f24, globalState) - v9)| {
			if (f24 <==> p1) {
				...
				var v19: map<bool, bool> := map[f24 := v0[v13.cf4]];
				v15[6], globalState.f23, v16[589], v16[224] := |v17| * |v18|, v8, f24, p1 <== (if (p1 in v19) then v19[p1] else p1);
				v14, v15[6], globalState.f12, v12 := v14, p0, false, fm5(f24, globalState);
			} else {
				var v20 := 0x1d8;
				var v21: seq<int> := [p0, -p0];
				var v22: multiset<int> := multiset{p0, i0, v20 % p0, fm5(!f24, globalState), v21[p0] % p0};
				var v23 := DC2(f24);
				var v24 := DC1(p1, p1);
				var v25 := "gdwocu";
				...
				var v32 := DC8(v21);
				globalState.f12, v20, v22, v28[361], v20 := f24, p0, (v22 + v22) * multiset{i0, v20, |v31|, v20, |v32.cf11|}, !v0[i0], fm5(p1, globalState);
				...
				v36 := v36 + v36;
				var v37 := DC3(p0, !f24);
				globalState.f12 := (i0 * v37.cf4) < |(([i0])[p0 := i0] + v21)|;
				r2 := v28[361];
			}
			
			var v38: array<int> := new int[4](i1 => i1 % i0);
			v38[833] := p0;
			v38[833] := (p0 % i0) - (|v0| * i0);
			var v39: map<int, bool> := map[|v0| := f24];
			var v40: seq<map<int, bool>> := [v39, v39];
			var v41: map<bool, multiset<bool>> := map[v38[833] < i0 := multiset((v0[v38[833] := f24])[|v40[i0]| := f24])];
			v41 := v41[f24 := v9];
			var v42 := DC8([i0, |v9|]);
			match (v42) {
				case DC8(cf11) =>
					...
					v43[739] := !!(if ((if (p0 in v44) then v44[p0] else v38[833]) in v39) then v39[if (p0 in v44) then v44[p0] else v38[833]] else false);
					v43[739] := p1;
					v43[739] := f24 && f24;
					var v45: map<bool, bool> := map[v43[739] := p1];
					var v46: map<int, int> := map[|(seq(0x120, i2  => (i0)))| := |v45|];
					v46, v45, v43 := v46, (v45[v43[739] := p1] + v45) + v45, v43;
					var v47 := DC4(v0);
					v47 := v47;
			}
		...
		match (v49) {
			case DC1(cf1, cf2) =>
				...
				var v51: array<int> := new int[8](i4 => i4 % p0);
				v51[202] := p0;
				cf2, v50, v51[202] := cf1, v50, 0x11d;
				var v52 := "ugn";
				var v53: map<int, string> := map[p0 := if (cf2) then "qfodmffx" else v52];
				v53 := v53[0x1cf := "aqq"];
				var v54: set<int> := {p0 - p0, v51[202]};
				v54 := v54;
				var v55: map<int, int> := map[v51[202] := -(if (cf2) then p0 else p0)];
				v55 := v55;
			case DC2(cf3) =>
				if (f24) {
					...
					v71[246] := v72 <= v72[|v68[|multiset(v0)|]| := p0];
					v70[371], v71[246] := v68, p1;
					var v73, v74, v75 := m0(globalState);
					var v76: multiset<int> := multiset{v66};
					globalState.f12 := v0[|(v76 * v76)|];
					v76 := v76 - v76;
				}
				
				var v77 := new C0();
				var v78 := 0x201;
				v78, v78 := p0, (if (p1) then v78 else |(seq(-0x110, i5  => (v78)))|) - v78;
			...
			case DC3(cf4, cf5) =>
				...
				match (v83) {
					case DC24(cf36) =>
						...
						var v87: seq<int> := [v84[666]];
						var v88 := DC27(|v86[cf4]|, v87[-0x369] - cf4);
						v88 := DC27(p0, p0);
					...
					case DC23(cf35) =>
						...
						var v98: map<bool, bool> := map[v97 < v97 := v0[|fm2(-p0, p0, globalState)|]];
						var v99: map<char, int> := map[v81[466] := v94.f31];
						v98 := v98[(if (v81[466] in v99) then v99[v81[466]] else |v97|) != fm31(v95, globalState) := true];
					case DC25(cf37) =>
						var v100: map<int, int> := map[cf4 := cf4];
						var v101: array<bool> := new bool[7];
						var v102: map<array<bool>, bool> := map[v101 := !p1];
						var v103: seq<int> := [|map[!cf5 := |(seq(140, i6  => (v8)))|]|, p0];
...
method Main() {
	...
	var globalState := new GlobalState(286, 0x290, true, 606, v0, 0x96, v2, 0x37, 0x29b, v3, v4[v1] + v3[0x1de := v5], true, true, false, false, true, v6 + v6, v7, v10, true, v11, 517, 0x3d, 'p');
	forall i2 | 0 <= i2 < v0.Length {
		v0[i2] := v8;
	}
	...
	v14 := map v15 : int | v15 in v17 :: (v15 % |[v8, v8, v8, v8]|) := (v13);
	var v18: seq<bool> := [v8];
	var v19: seq<seq<bool>> := [v18];
	var i3 := 0;
	while (!(multiset{v18, fm1(v18[-684], globalState)} >= multiset(v19)))
		decreases 100 - i3
	{
		if (i3 >= 100) {
			break;
	...
	if (|(v3 + fm2(v1, v1, globalState))| == |v2|) {
		...
		v1 := v1 / 0x15b;
		v0[988] := if (v8) then v8 else v8;
		var v23 := DC4(v18);
		v0[988] := v3[|v23.cf6|] in v3;
		v1 := if (v8) then if (v1 in v17) then v17[v1] else v1 else v1;
		var v24 := DC6(v5, v0[988], v3);
		var v25: map<bool, string> := map[fm0(v1, globalState) := "qujrkn"];
		var v26: array<string> := new seq<char>[20] [(seq(0x4e, i4  => (v5))) + v3, v3, v3, v24.cf9, v3 + v3, v3 + "dakda", v3, v3, v3, v3, v3, if (v8) then fm2(v1, v1, globalState) else fm2(v1, 0x9f, globalState), v3, v3, v3, (if (v0[988] in v25) then v25[v0[988]] else v3) + v3, v3, seq(-947, i5  => (v5)), seq(-0x204, i6  => (v5)), v3];
		v26[647] := v3;
		v26[647] := v3 + "otnycwpnk";
	} else {
		...
		if (v8 <==> false) {
			...
			v0[525] := v33;
			var v39: map<char, int> := map[v5 := -v2[v1]];
			v32[28] := -|v39|;
			v0[525], v29, v32[28] := (v1 == v1) <== v8, v29, 0x232 % v1;
		} else {
			v0[194] := true;
			v0[194], v1 := v1 != (v1 / |v3|), fm31(v3, globalState);
			v32 := v32;
			v1 := v1 - (v1 - -|v3|);
			var v40: multiset<char> := multiset{v5};
			v0[194], v0[194], v1, globalState.f23, v1 := false, v8, -|v18|, fm39(v3 < v3, globalState), v1 % (if (v5 in v40) then v40[v5] else v1);
			v0[194] := v8;
		}
		...
		decreases 100 - i7
	{
		...
		v44[251] := if (false) then v45 else v45;
		v44[251] := v45[v3 + v3 := |((seq(-0x2e7, i8  => (v1))) + v2)|];
		v8 := v11 !! (fm20(v8, globalState) - v11);
		var v46 := DC47(v0, v18[v1]);
		match (v46.(cf69 := v0)) {
			case DC47(cf69, cf70) =>
				var v47 := DC1(cf70, cf70);
				var v48: map<D0, char> := map[v47 := v3[fm31((fm2(v1, v1, globalState))[|v18| := v5], globalState)]];
				v48 := v48[v47 := v5];
				v1 := v1;
				var v49 := DC40();
				v49 := v49;
			...
			case DC48(cf71) =>
				...
				var v52: array<int> := new int[9] [fm21(v51, v1, v8, v3, globalState) - cf71, 0x1e8, cf71, |("lgha")[cf71 := 'c']|, cf71, 0x29a, 0x111, v1, v1 - cf71];
				v52 := v52;
				var v53 := DC41(v43);
			...
			case DC46(cf68) =>
				...
				v60, globalState.f10, v1 := v60, "tkcekenj", (v1 - -fm44(v0[191], v8, v0[191], v1, globalState)) / v1;
				var v61: C5 := new C5(v0[191]);
	...
	if (true) {
		var v62: array<int> := new int[15](i9 => i9 / v1);
		...
		v62[12] := |v66|;
		v62[12] := v64.f27 * v64.f27;
		v1 := if (v8 in v9) then v9[v8] else v1;
		v62[12] := 0x134;
		var v67: set<int> := {v62[12]};
		if ((v67 + v67) > (v67 + v67)) {
			v0[288] := v64.f28;
			v2, v64.f28, v0[288], globalState.f12, v62[12] := v2[v64.f27 % v62[12] := v62[12]], false, v64.f28, v8, 0x24d;
			...
			var v73 := DC5();
			var v74 := DC24(v73);
			var v75: map<bool, D8> := map[v0[288] := v74];
			v75 := v75;
			v71 := v2[|v17| + v1];
			v1 := v64.f27;
		} else {
			var v76 := DC8([v62[12], |v3|]);
			var v77: map<int, int> := map[701 := v62[12]];
			var v78, v79, v80 := v64.m5(v62, v64.f28, v76.(cf11 := v2[|v77| := v64.f27]), v8, globalState);
			v0[373] := v64.f28;
			...
			var v86 := DC44(|v77|, v79, v3, v0[373], v85);
			v62[12] := v86.cf63;
		...
		if (if (|v94[v1]| != v1) then v93 else v93) {
			v91[79] := fm0(v1, globalState);
			v91[79] := if (v93) then v8 else v8;
			var v95: array<string> := new string[19];
			var v96 := new C6(v1, v95);
			v0, v1 := v0, v2[fm31(seq(0x233, i11  => ('g')), globalState)];
			var v97: map<int, char> := map[v1 := v5];
			var v98 := DC0(fm0(v1, globalState));
			var v99: map<D0, bool> := map[v98 := v91[79]];
			globalState.f23 := if (fm21(v99, v1, v8, v3[|v3| := v5], globalState) in v97) then v97[fm21(v99, v1, v8, v3[|v3| := v5], globalState)] else v5;
			globalState.f23 := v5;
		} else {
			...
			var v103: map<array<int>, C13> := map[v92 := v102[v1]];
			v103 := v103[v92 := v101];
			globalState.f10, v1 := ((v3 + v3) + v3[v1 := fm33(-47, v93, v1, globalState)])[v1 := v5], v1;
			var v104: array<C11> := new C11[12];
			var v105: C11 := new C11();
			v104[218] := v105;
			v104[218], v0, v1 := v105, v0, v1;
			var v106 := new C5(v93);
		}
		
		var v107: array<char> := new char[8];
		v107[885] := v5;
		v107[885] := fm33(v1, v93, v1, globalState);
		globalState.f12 := fm0(-v1, globalState);
		if (v93) {
			globalState.f23 := v107[885];
			var v108: map<int, seq<bool>> := map[v1 := v18];
			var v109: array<seq<bool>> := new seq<bool>[17] [v18, (if (v1 in v108) then v108[v1] else v18) + v18, v18 + v18, v18, v18, v18 + [v8], v18, v18, fm1(v8, globalState), v18, fm1(v93, globalState), v18, v18, fm1(v8, globalState) + v18, v18, v18, [v18[v1], v8] + fm1(v93, globalState)];
			v109[512] := v18;
			var v110: map<int, int> := map[v1 := -v1];
			var v111 := DC6('n', v8, v3);
			var v112: array<string> := new string[14] ["sddesiht", (v3[|[v8]| := v5])[v1 := v107[885]], v3, "mtvkkmo", fm2(v1, |v110|, globalState), "rcb", seq(0xa6, i12  => ('m')), v3, "o", v3, v3, "ybch", v3[v1 := v107[885]], v111.cf9];
			var v113: array<array<string>> := new array<string>[1] [v112];
			v113[429] := v112;
			v109[512], v113[429] := v18, v112;
			v5, v1 := 't', v1;
			globalState.f12 := v93;
			globalState.f10 := v3;
		} else {
			...
			var v115 := new C10(v107[885], v1, v114);
	...
	for i13 := v1 to v1 {
		...
		v0[327] := multiset(if (v124 in v131) then v131[v124] else v130) > v133;
		var v134: array<string> := new string[26];
		v134[379] := v3;
		v134[379] := (seq(0xd5, i14  => ('x'))) + (if (v8) then v3 else v3);
		v121 := v121;
	}
	globalState.f23, globalState.f10, v122 := v3[0x25d], v4[v1 * fm18(globalState)], v122;
	v122 := !!v8;
	v43 := v43[v1 := v8];
	var v135 := DC47(v0, v8);
	...
	var v139 := DC8((fm19(!v122, globalState))[v1 := |v138|]);
