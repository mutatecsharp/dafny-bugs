...
class C1 extends T0 {
	...
	function fm24(p0: bool, p1: map<map<int, bool>, bool>, globalState: GlobalState): bool {
		!((383 < f24) <==> !(f24 == |(set v0 : int | v0 in [|map[f24 := multiset{true, true}]|] :: (safeModuloInt(v0, |[--0xc7]|)))|))
	}
	function fm25(p0: char, globalState: GlobalState): seq<int> {
		((seq(abs(920), i0  => (f24))) + [f24]) + [-f24, f24]
	}
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		for i0 := -f24 to f24 {
			var v0: array<int> := new int[13];
			v0[safeIndex(50, v0.Length)] := f24 * f24;
			var v1 := true;
			var v2: set<bool> := {v1};
			...
			v0[safeIndex(50, v0.Length)] := -safeModuloInt(|v3|, safeModuloInt(|v6|, f24));
			var v7 := 'p';
			v7 := v7;
			var v8: array<D1> := new D1[25](i1 => DC3(map[v1 := v1]));
			var v9: map<bool, bool> := map[v1 := v1];
			v8[safeIndex(863, v8.Length)] := DC3(v9);
			var v10 := DC3(v9);
			v8[safeIndex(863, v8.Length)], r1 := v10, !((v5 + v5)[safeIndex(-0x376, |(v5 + v5)|) := v7] <= v5);
			r1 := v1;
		}
		var v11 := false;
		var v12: set<bool> := {v11};
		r1 := v12 >= v12;
		var v13: array<int> := new int[3](i2 => safeModuloInt(i2, f24));
		var v14: seq<array<int>> := [v13, v13, v13, v13];
		var v15: seq<D3> := [DC6(v14[safeIndex(-f24, |v14|)])];
		...
		v13[safeIndex(596, v13.Length)] := f24;
		var v22: multiset<bool> := multiset{!v16.f23};
		v13[safeIndex(596, v13.Length)] := 192 + |v22|;
		var i4 := 0;
		while (v17 < v17)
			decreases 100 - i4
		{
			...
			v25 := v25[v23 := v24];
			var v26: map<int, bool> := map[v13[safeIndex(596, v13.Length)] := true];
			var v27: map<bool, int> := map[!v16.f23 := f24];
			v26 := v26[if (v16.f23 in v27) then v27[v16.f23] else f24 := v11];
			var v28 := 's';
			v18[safeIndex(321, v18.Length)] := v16.f23;
			v28, v18[safeIndex(321, v18.Length)], r0 := if (v16.f23) then v28 else v28, false, -v13[safeIndex(596, v13.Length)];
			var v29: set<int> := {f24, v13[safeIndex(596, v13.Length)]};
			var v30: array<bool> := new bool[10] [v11, v11, v16.f23, v11, !v16.f23, v18[safeIndex(321, v18.Length)], v11, v16.f23, v18[safeIndex(321, v18.Length)], v18[safeIndex(321, v18.Length)]];
			var v31: set<array<bool>> := {v30, v30};
			var v32: map<int, set<int>> := map[|v31| := v29];
			var v33 := DC0(v11);
			var v34 := DC2(v33);
			var v35: array<string> := new seq<char>[12] [v17, v17, v17, "ocslm", seq(abs(0x2b), i5  => (v28)), v17, v17, "dmbkie", v17, v17, seq(abs(-0x268), i6  => ('d')), v17];
			var v36: map<array<string>, bool> := map[v35 := true];
			var v38: map<bool, map<int, set<int>>> := map[v11 := v32];
			var v41: seq<int> := [|v24|];
			var v42: multiset<int> := multiset{v13[safeIndex(596, v13.Length)], v41[safeIndex(v13[safeIndex(596, v13.Length)], |v41|)], v13[safeIndex(596, v13.Length)], |v41|};
			var v43: map<int, int> := map[v13[safeIndex(596, v13.Length)] := |v42|];
			var v44: array<map<int, set<int>>> := new map<int, set<int>>[18] [map[-f24 := v29], v32, (fm26(v28, v34, if (v35 in v36) then v36[v35] else v11, v16.f23, globalState)).cf19, map[f24 := v29] + v32, (map v37 : int | (0xe5 <= v37) && (v37 < 0x9) :: (v37 * v13[safeIndex(596, v13.Length)]) := ({0x1ff, f24, f24})) + v32, v32, v32 + v32, v32 + v32, v32 + v32, map[f24 := {v13[safeIndex(596, v13.Length)], v13[safeIndex(596, v13.Length)]}] + fm27(f24, v13[safeIndex(596, v13.Length)], f24, v13[safeIndex(596, v13.Length)], globalState), v32, map[v13[safeIndex(596, v13.Length)] := v29], v32, if (v16.f23) then (if (v18[safeIndex(321, v18.Length)] in v38) then v38[v18[safeIndex(321, v18.Length)]] else map[f24 := set v39 : int | (84 <= v39) && (v39 < 0x328) :: (v39 * |v22|)])[f24 := v29] else v32, v32, v32, (map v40 : int | v40 in v43 :: (v40 + 0x330) := (v29)) + v32, v32 + v32[|v17| := {f24}]];
			v44[safeIndex(166, v44.Length)] := map[v13[safeIndex(596, v13.Length)] := v29];
			...
			v44[safeIndex(166, v44.Length)] := if (v45 in v46) then v46[v45] else if (v16.f23) then v32 else v47[safeIndex(v13[safeIndex(596, v13.Length)], |v47|)];
		}
		r0 := -f24 * f24;
		r1 := !(v14 != v14);
	}
	method m2(p0: bool, globalState: GlobalState) {
		var v0 := "n";
		var v1: seq<string> := [v0, "wkapm", seq(abs(0x39d), i0  => ('p'))];
		var v2: seq<seq<string>> := [v1];
		v1 := v2[safeIndex(f24 + f24, |v2|)];
		var v3: seq<bool> := [p0, p0];
		for i1 := if (v3[safeIndex(f24, |v3|)]) then f24 else 0x143 to fm1(p0, globalState) {
			globalState.f1 := p0;
			var v4 := DC11(i1);
			var v5 := DC13(v4);
			...
			globalState.f1 := !true;
			var v8: array<int> := new int[19](i2 => safeDivisionInt(i2, -0xbb));
		...
		globalState.f6 := safeModuloInt(0x18d, |v15|) + f24;
		var i4 := 0;
		while (v14.f23)
			decreases 100 - i4
		{
			...
			globalState.f6 := safeModuloInt(v20[safeIndex(|v3[safeIndex(|(if (v14.fm17(0x360, |[|v22|]|, v14.f23, globalState) in v21) then v21[v14.fm17(0x360, |[|v22|]|, v14.f23, globalState)] else v23)|, |v3|) := v14.f23]|, |v20|)], safeDivisionInt(-f24, f24));
		}
		globalState.f6 := -f24;
		v0 := seq(abs(0x193), i5  => ('e'));
	}
}
...
class C2 extends T1 {
	...
	function fm15(globalState: GlobalState): int {
		--(|((seq(abs(-329), i0  => ('m'))) + (seq(abs(0x21e), i1  => ('s'))))| - |({DC7(|[false, false]|)} - {DC7(f21)})|)
	}
	...
	method m11(p0: string, p1: int, globalState: GlobalState) returns (r0: char) {
		...
		for i0 := |map[fm16(v1, v0, globalState) := v2.cf7]| to -v2.cf7 {
			...
			var v5 := DC10(v4);
			v3[safeIndex(810, v3.Length)] := v5.cf13;
			v3[safeIndex(810, v3.Length)] := v4;
			var v6 := 'v';
			var v7: map<int, int> := map[|map[v6 := i0]| := 0x32b];
			globalState.f6 := safeModuloInt(|(v7 + v7)|, 0x117);
			var v8: seq<int> := [p1, f21];
			var v9: array<int> := new int[27] [p1, |v7|, 0x293, f20, i0, |(seq(abs(0x238), i1  => (v6)))|, |fm0(v0, v0, i0, globalState)|, p1, f20, f20, f20, 527, p1, |(seq(abs(0x2f3), i2  => (i0)))|, |v8[safeIndex(-i0, |v8|) := f20]|, f20, f20, f20, f21, f21, 0x36c, 0x2b5, |p0[safeIndex(i0, |p0|) := v6]|, p1, 0x117, p1, -252];
			var v10 := DC6(v9);
			var v11: seq<D3> := [v10];
			...
			v13[safeIndex(64, v13.Length)] := v14;
			v13[safeIndex(64, v13.Length)] := v14;
		}
		var v15: seq<int> := [f20];
		...
		var v19: array<int> := new int[14] [f21, v15[safeIndex(f21, |v15|)], p1, p1, f21, p1, |{v16, v16}|, p1, p1, f21, f21, |v18|, p1, f20];
		var v20 := DC6(v19);
		match (v20) {
			case DC7(cf7) =>
				v16[safeIndex(429, v16.Length)] := v0;
				v16[safeIndex(429, v16.Length)] := v0;
				var v21 := new C0([v20.(cf6 := v19), v20, v20, v20], !v0);
				var v22: array<D0> := new D0[2](i5 => DC0(v21.f23));
				var v23: map<bool, bool> := map[v16[safeIndex(429, v16.Length)] := v0];
				var v24: set<bool> := {v21.f23};
				var v25: set<int> := {|v24|};
				var v26 := 'y';
				var v27 := DC8(v15, p0, v16[safeIndex(429, v16.Length)], v26);
				v22 := new D0[24] [v1, v1, v1, v1.(cf0 := v16[safeIndex(429, v16.Length)]), v1, v1, v1.(cf0 := v0), v1, v1, fm18(f20, v15, globalState), fm18(cf7, v15, globalState), if (v21.fm17(|[v16[safeIndex(429, v16.Length)]]|, p1, !v21.f23, globalState)) then v1 else v1, fm18(|v23|, v15, globalState), v1, v1, DC0(v0), v1, v1, v1, fm18(-f21, v15, globalState), v1, fm18(|v25|, v27.cf8, globalState), fm18(f21, v15, globalState), v1];
				var v28: multiset<bool> := multiset{v21.f23, v0};
				globalState.f1, globalState.f6, globalState.f1, globalState.f1, globalState.f6 := multiset(v17) !! ((multiset{v0, v16[safeIndex(429, v16.Length)], v21.f23, v21.f23})[v21.f23 := abs(|"npqmwqi"|)] + v28), 0x73, !v0 ==> (if (v0) then v16[safeIndex(429, v16.Length)] else v0), false, -(|(map v29 : int | v29 in map[f21 := 0x84] :: (safeDivisionInt(v29, p1)) := (map[v21.f23 := f21]))| - f20);
			case DC8(cf8, cf9, cf10, cf11) =>
				v19[safeIndex(404, v19.Length)] := |v17|;
				v19[safeIndex(404, v19.Length)] := p1;
				v0 := cf10;
				var v30: map<string, array<bool>> := map[p0 := v16];
				var v31: set<int> := {|(fm19(globalState))[safeIndex(v19[safeIndex(404, v19.Length)], |fm19(globalState)|) := cf10]|, p1};
			...
			case DC6(cf6) =>
				...
				globalState.f1 := fm16(if (fm16(fm18(|v34|, seq(abs(411), i6  => (p1)), globalState), v0, globalState)) then v1 else v1, v0, globalState);
				...
				if (v0) {
					...
					f21 := --f21;
					v16[safeIndex(919, v16.Length)] := v38.f23;
					var v39: seq<string> := [p0];
					var v40: map<bool, int> := map[v0 := p1];
					v16[safeIndex(919, v16.Length)] := p0 < ("ervcnys" + v39[safeIndex(if (v38.f23 in v40) then v40[v38.f23] else -f20, |v39|)]);
					var v41: array<map<int, bool>> := new map<int, bool>[19];
					var v42: map<bool, bool> := map[fm2(globalState) := v0];
					v41[safeIndex(177, v41.Length)] := map[|v42| := v38.f23];
					var v43: set<int> := {f21 - p1};
					var v44 := "iburkss";
					var v45: map<int, bool> := map[f21 := true];
					var v46: seq<map<int, bool>> := [v45];
					var v47: seq<seq<bool>> := [v17, v17, v17];
					v41[safeIndex(177, v41.Length)], v43, globalState.f1, v44, globalState.f1 := v46[safeIndex(p1, |v46|)], v43 + {f21, f21}, multiset{v47[safeIndex(|v17|, |v47|)]} != fm20(313, globalState), v44, v38.f23;
					globalState.f6 := p1;
				} else {
					var v48: multiset<bool> := multiset{v0, v0, v0, v0, v0};
					globalState.f1 := v48 != (((multiset(v17))[v0 := abs(0x3df)])[true := abs(p1)] * v48);
					var v49: array<array<bool>> := new array<bool>[18];
					v49[safeIndex(857, v49.Length)] := v16;
					v49[safeIndex(857, v49.Length)] := v16;
					globalState.f9 := v19;
					v17 := v17;
					v16[safeIndex(93, v16.Length)] := v0;
					var v50: map<array<int>, string> := map[v19 := p0];
					v16[safeIndex(93, v16.Length)] := !(cf6 !in v50);
				}
			...
			decreases 100 - i8
		{
			...
			v19[safeIndex(331, v19.Length)] := f20;
			v19[safeIndex(331, v19.Length)] := f21;
		}
		var v54 := 'r';
		r0 := v54;
	}
	method m12(p0: int, p1: int, p2: string, p3: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		if (p2 <= fm21(globalState)) {
			...
			v4 := v4[f20 := safeDivisionInt(p1, p1)];
			var v5: array<multiset<seq<D2>>> := new multiset<seq<D2>>[22](i0 => multiset{seq(abs(0x7c), i1  => (DC5([f20, 829]))), [DC5([p1, -0x17e]), DC5(seq(abs(0x1f), i2  => (f21)))]} - multiset(seq(abs(508), i3  => (seq(abs(0x2f8), i4  => (DC5(seq(abs(0x2ef), i5  => (|p2|)))))))));
			var v6 := DC5([|(seq(abs(-122), i6  => ('r')))|]);
			var v7: seq<D2> := [v6];
			var v8: multiset<seq<D2>> := multiset{v7, v7, v7, v7, v7};
			v5[safeIndex(163, v5.Length)] := v8;
			var v9: seq<multiset<seq<D2>>> := [v8, v8 * multiset{fm22(v0, v0, globalState)}, v8, v8 * v8];
			v5[safeIndex(163, v5.Length)] := v9[safeIndex(if (!fm2(globalState) in v3) then v3[!fm2(globalState)] else -0x31a, |v9|)];
			var v10 := 'i';
			var v11: seq<bool> := [v0, v0];
			var v12 := DC12(15, v11[safeIndex(f21, |v11|)], v10);
			var v13 := DC11(p0);
			...
			v26[safeIndex(792, v26.Length)] := true;
			var v27 := false;
			v26[safeIndex(792, v26.Length)] := v27;
			var v28: array<int> := new int[17];
			var v29: map<int, array<int>> := map[safeModuloInt(f21, f20) := if (v27) then v28 else v28];
			var v30: map<bool, array<int>> := map[DC12(p0, v26[safeIndex(792, v26.Length)], v24).cf16 := v28];
			v29 := (v29 + v29)[p1 := if (v26[safeIndex(792, v26.Length)] in v30) then v30[v26[safeIndex(792, v26.Length)]] else v28];
			var v31: seq<bool> := [v27, v27, v27];
			var v32: seq<int> := [-|v31|];
			var v33 := DC5(v32);
			var v34: map<bool, char> := map[v26[safeIndex(792, v26.Length)] := v24];
			var v35 := DC8(v32, p2, v26[safeIndex(792, v26.Length)], v24);
			v33 := fm23(v34, p2 + v35.cf9, v26[safeIndex(792, v26.Length)], f20, globalState);
			r0 := v27;
		}
		
		var v36 := true;
		var v37: seq<bool> := [v36];
		for i7 := safeDivisionInt(fm15(globalState), f21) to |v37[safeIndex(p0, |v37|) := v36]| {
			...
			v43[safeIndex(277, v43.Length)] := map[v40 := v37];
			v43[safeIndex(277, v43.Length)] := v41;
			...
			var v50: array<int> := new int[13] [|(seq(abs(573), i8  => ('g')))|, 680, p1, -(f20 * |v47[safeIndex(p0, |v47|) := DC10(v45)]|), f20, 0xd2, if (v40 in v49) then v49[v40] else f21, |v37|, safeDivisionInt(|{v36}|, 0x16f), p0 * 0x2c0, p1, f20 + p0, p0];
			v50[safeIndex(702, v50.Length)] := -0x26e;
			v50[safeIndex(702, v50.Length)], globalState.f6 := f20, 210;
			var v51: map<bool, bool> := map[v36 := v36];
			var v52: set<bool> := {v36};
			if ((|v51| <= |v52|) <==> false) {
				var v53: set<int> := {|"x"|, v50[safeIndex(702, v50.Length)] * f20, safeDivisionInt(v50[safeIndex(702, v50.Length)], p0)};
				v53 := v53;
				var v54: array<map<array<int>, int>> := new map<array<int>, int>[2];
				v54[safeIndex(735, v54.Length)] := map[v50 := i7];
				var v55: map<array<int>, int> := map[v50 := p1];
				v54[safeIndex(735, v54.Length)] := map[v50 := p0] + (if (v36) then v55 else map[v50 := |v37|]);
				globalState.f6 := -256;
				var v56: multiset<bool> := multiset{v36};
				var v57 := DC11(p0);
				var v58: array<D5> := new D5[4] [DC11(p1), v57, v57, v57];
				var v59: seq<array<D5>> := [v58, v58, v58];
				var v60: array<array<D5>> := new array<D5>[27] [v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v59[safeIndex(i7, |v59|)], v58];
				var v61: map<bool, array<array<D5>>> := map[v56 !! v56 := v60];
				v61 := v61[v37[safeIndex(p0, |v37|)] := v60];
				var v62 := 'b';
				v62 := v62;
			} else {
				var v63: seq<int> := [p1, f21, |(p2 + p2)|];
				globalState.f6, v36 := v63[safeIndex(|p3|, |v63|)], v36;
				var v64: set<int> := {v50[safeIndex(702, v50.Length)], f20, i7};
				var v65: map<D3, set<int>> := map[DC6(v50) := v64 + {f21}];
				var v66 := DC6(v50);
				v64 := if (v66.(cf6 := v50) in v65) then v65[v66.(cf6 := v50)] else if (v36) then fm28(v50[safeIndex(702, v50.Length)], v36, v36, globalState) else v64;
				var v67: multiset<int> := multiset{i7, fm1(v36, globalState)};
				v67 := multiset{-f21};
				globalState.f1 := !v36;
				var v68 := 'j';
				var v69: multiset<bool> := multiset{v36};
				v68 := fm29(v36, (if (v50[safeIndex(702, v50.Length)] in v67) then v67[v50[safeIndex(702, v50.Length)]] else |v69|) * p0, |v63|, v52 > v52, globalState);
			}
		...
		var v75 := DC11(p0);
		globalState.f6 := safeDivisionInt(--|v74.cf9|, v75.cf14);
		var i9 := 0;
		while (p0 >= f20)
			decreases 100 - i9
		{
			...
			v76[safeIndex(386, v76.Length)] := v36;
			var v77: multiset<bool> := multiset{v36, false};
			var v78: multiset<seq<int>> := multiset{v72};
			v76[safeIndex(386, v76.Length)] := !((|v77| > p1) && (v78 !! multiset{v72}));
			var v79: array<int> := new int[17](i10 => i10 - f20);
			v79[safeIndex(275, v79.Length)] := -p1;
			v79[safeIndex(275, v79.Length)] := safeDivisionInt(p0, -f21);
			var v80 := DC6(v79);
			var v81: array<array<int>> := new array<int>[10] [v79, v79, v79, v79, v79, if (!v76[safeIndex(386, v76.Length)]) then v79 else v79, v80.cf6, v79, v79, v79];
			var v82: map<int, array<int>> := map[|[false, v36]| := v79];
			v81[safeIndex(355, v81.Length)] := if (|v72| in v82) then v82[|v72|] else v79;
			v81[safeIndex(355, v81.Length)] := v79;
			...
			var v88: set<bool> := {v76[safeIndex(386, v76.Length)], v76[safeIndex(386, v76.Length)], v76[safeIndex(386, v76.Length)]};
			var v89: array<multiset<multiset<bool>>> := new multiset<multiset<bool>>[22] [v83, fm30(!v76[safeIndex(386, v76.Length)], {|v84|}, globalState), v83, v83, v83, multiset{v77}, multiset{multiset{v76[safeIndex(386, v76.Length)]}} - v83, multiset(seq(abs(0x232), i11  => (multiset{v36}))), v83 - multiset{v77, v77}, (multiset([multiset([v36]), v77, v77, v77]))[multiset{v76[safeIndex(386, v76.Length)], v76[safeIndex(386, v76.Length)], v36, v76[safeIndex(386, v76.Length)], v76[safeIndex(386, v76.Length)]} := abs(if (f21 in v85) then v85[f21] else f20)] - v83, multiset(v86) + v83, multiset(v86), v83, v87[safeIndex(|v88|, |v87|)], multiset{v77}, v83, v83, v83, v83, v83[v77 := abs(|p2[safeIndex(v79[safeIndex(275, v79.Length)], |p2|) := v73]|)], if (v76[safeIndex(386, v76.Length)]) then multiset{multiset([v36]), multiset(v37)} else multiset{v77, v77}, multiset(v86 + v86)];
			v89[safeIndex(286, v89.Length)] := v83[v77 := abs(v79[safeIndex(275, v79.Length)])];
			v89[safeIndex(286, v89.Length)] := v83;
		}
		...
		for i12 := safeModuloInt(|v70|, |v95|) to 0x3b1 {
			...
			v98[safeIndex(192, v98.Length)] := p3;
			v98[safeIndex(192, v98.Length)] := ((seq(abs(4), i13  => ('v'))) + p3) + p3;
			if (v36) {
				globalState.f6 := f21;
				...
				var v105 := DC10(v104[safeIndex(p1, |v104|)]);
				globalState.f6, globalState.f6, v100, v98[safeIndex(192, v98.Length)], globalState.f1 := -(f20 - (f21 + i12)), -|(map v101 : map<bool, int> | v101 in v102 :: (v101) := (p3 <= "fsri"))|, v100[v36 := abs(-fm15(globalState))], v98[safeIndex(192, v98.Length)], if (DC17((fm18(f21, v72, globalState)).cf0, v94.fm17(i12, p0, v36, globalState), v99, v105, false).cf24) then if (v94.f23) then v99.f23 else v94.f23 else v99.f23;
				var v106: map<int, string> := map[0x3db := p2];
				v106 := v106[f20 := v98[safeIndex(192, v98.Length)]];
			} else {
				...
				globalState.f1 := safeDivisionInt(|v72|, f21) == fm1(v94.f23, globalState);
				r1 := fm21(globalState) + (seq(abs(-0x3cb), i15  => ('n')));
			}
	...
	method m14(p0: bool, p1: bool, p2: int, p3: string, globalState: GlobalState) returns (r0: int) {
		...
		match (v7) {
			case DC9(cf12) =>
				...
				var v9 := new C1(|v8|);
				globalState.f6 := p2;
				v0[safeIndex(500, v0.Length)] := 0xf7;
				v0[safeIndex(500, v0.Length)] := -f20;
				if (|v8[v3 := p0]| > f21) {
					var v10: seq<D3> := [v1];
					...
					var v14 := "sdistbhg";
					v14 := seq(abs(-230), i0  => ('m'));
					var v15: set<map<int, int>> := {v4, v4};
					var v16: seq<int> := [-(f20 + 0xfc), v0[safeIndex(500, v0.Length)], v9.f24, |v15| - p2, v9.f24];
					v16 := v16;
					var v17: seq<set<bool>> := [v2, v2];
					var v18: array<set<bool>> := new set<bool>[26] [v2 - v2, v2 + v2, v2 - {v13.f23, v13.f23}, v2, v2 * {p0}, v2, v2, v2 * v2, fm31(f21, p0, globalState), v2, v2, v2, {false, true}, if (v3) then {v3} else {p0}, v2, v2, v2, v2, v2, v2, v17[safeIndex(v9.f24, |v17|)], v2 - {true, v13.f23}, v2, v2 - {v3, p1, v3}, v2 - v2, v2];
					v18[safeIndex(323, v18.Length)] := if (v13.f23) then v2 else v2;
					v18[safeIndex(323, v18.Length)] := v2 * v2;
					v3 := v13.f23;
				} else {
					var v19: array<bool> := new bool[11] [v3, v3, p1, v3, f21 <= v9.f24, v2 <= v2, p1, f20 <= v0[safeIndex(500, v0.Length)], v3 && p1, v0[safeIndex(500, v0.Length)] == v0[safeIndex(500, v0.Length)], v3];
					v19[safeIndex(309, v19.Length)] := p0;
					v19[safeIndex(309, v19.Length)] := p0;
					v0[safeIndex(500, v0.Length)] := f21;
					...
					v22[safeIndex(737, v22.Length)] := v23;
					v22[safeIndex(737, v22.Length)] := v23;
					v8 := v8[v21.f23 := p0];
				}
			...
			decreases 100 - i1
		{
			...
			v35[safeIndex(864, v35.Length)] := p1 && p1;
			v35[safeIndex(864, v35.Length)] := v3;
			var v36 := new C1(-f20 + f21);
		}
		v6, r0 := v6, -f21;
		if ((p2 + f20) > f20) {
			var v37: array<set<bool>> := new set<bool>[13];
			v37[safeIndex(515, v37.Length)] := v2;
			v37[safeIndex(515, v37.Length)] := (if (p0) then v2 else v2) * v2;
			var v38 := 'y';
			v38 := v38;
			v2 := v2;
			if (p0) {
				...
				var v48: array<seq<int>> := new seq<int>[19] [v40[safeIndex(0x135, |v40|) := -p2], v40, fm32(f20, |v47|, p0, globalState), fm32(f21, f20, p1, globalState), v40, v40, [-p2, f21, p2], v40, v40, (fm32(|fm32(f21, f21, p0, globalState)|, f21, p1, globalState))[safeIndex(0x1e5, |fm32(|fm32(f21, f21, p0, globalState)|, f21, p1, globalState)|) := f21], v40, ([|(seq(abs(0x133), i2  => (f20)))|])[safeIndex(f20, |[|(seq(abs(0x133), i2  => (f20)))|]|) := v39.cf7], v40, v40, v40, v40 + v40, v40 + [p2, f20], seq(abs(0x398), i3  => (|DC21(seq(abs(167), i4  => (v38)), {p0}).cf34|)), v40];
				v48[safeIndex(257, v48.Length)] := v40 + v40;
				var v49 := DC22(v45);
				v45, v37[safeIndex(515, v37.Length)], v48[safeIndex(257, v48.Length)], globalState.f1 := v49.cf36, v37[safeIndex(515, v37.Length)], v40[safeIndex(f21, |v40|) := f20], p0;
			} else {
				v3 := (p3 + p3) < p3;
				var v50: seq<D3> := [v1];
				...
				v52[safeIndex(459, v52.Length)] := p0;
				v52[safeIndex(459, v52.Length)] := v51.f23;
				var v53: set<int> := {f20};
				var v54: map<string, set<int>> := map[p3 := v53];
				var v55: seq<bool> := [v51.f23, v52[safeIndex(459, v52.Length)], false, v51.f23, true];
				var v56: seq<int> := [|v55|, f20];
				v54 := v54["tff" + "xubovus" := {v56[safeIndex(p2, |v56|)], p2}];
			}
			...
			if (v3) {
				...
				v62[safeIndex(403, v62.Length)] := v67;
				var v68: array<char> := new char[24];
				var v69 := 'w';
				v68[safeIndex(123, v68.Length)] := v69;
				var v70 := DC26(v67);
				v62[safeIndex(403, v62.Length)], v68[safeIndex(123, v68.Length)], globalState.f1 := (v70.(cf45 := v67)).cf45, v69, p0;
				globalState.f1 := p0;
				globalState.f1 := true || true;
				f21 := safeModuloInt(fm1(p1, globalState) * fm1(p0, globalState), safeModuloInt(f21, f21));
			} else {
				...
				v77[safeIndex(878, v77.Length)] := 't' !in p3;
				...
				v74, globalState.f1, v76, v77[safeIndex(878, v77.Length)] := v74 - multiset{(v79.(cf63 := v4)).cf63}, if (p1) then p0 in v80 else if (p0) then v3 else v73.f23, v76[v75 := abs(-f21)] - (if (v81 in v82) then v82[v81] else v76), v84.cf23;
				...
				m0(set v86 : int | v86 in v85 :: (v86 - |{|(seq(abs(-153), i6  => ('g')))|}|), v90, v0, p3, globalState);
				...
				v77[safeIndex(878, v77.Length)] := "wefcbtsh" < (p3 + (if (v73.f23 in v91) then v91[v73.f23] else v95.cf9));
				var v96 := new C1(f20);
			}
			...
			r0 := safeModuloInt(0x156, f21 * f20);
			v2 := v2;
			v104[safeIndex(0, v104.Length)] := p1;
			v104[safeIndex(0, v104.Length)] := false;
		}
		
		var v107: array<string> := new seq<char>[15](i8 => (seq(abs(0x172), i9  => ('v'))) + p3);
		v107[safeIndex(868, v107.Length)] := p3;
		var v108: multiset<int> := multiset{f21};
		v107[safeIndex(868, v107.Length)], v3, globalState.f1 := p3, v108 >= multiset([f21]), v3;
		r0 := f20;
	}
	method m15(p0: D3, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: map<int, int>, r2: array<map<bool, int>>) {
		if (p1) {
			...
			var v4: array<map<bool, D10>> := new map<bool, D10>[19] [map[true := DC28(|v0|)], v2, v2, v2, v2, v2, v2, v2, map[p1 := v1], v2, v3[safeIndex(0x345, |v3|)], v2, v2, map[p1 := v1], v2, v2, v2, v2, map[p1 := v1]];
			...
			globalState.f6 := v8[safeIndex(f21, |v8|)];
		} else {
			var v9 := "vkn";
			...
			var v11 := DC7(12);
			var v12 := 'y';
			var v13: array<string> := new string[22] [v9, if (true) then (v9[safeIndex(v11.cf7, |v9|) := v12])[safeIndex(p3, |v9[safeIndex(v11.cf7, |v9|) := v12]|) := v12] else v9, v9, v9, v9, v9 + v9, v9, "a" + v9, "hnastust", v9, v9 + v9, "nsv" + v9, fm21(globalState) + v9, if (p1) then v9 else "jtgqkrddi", "nflhvqi", v9, v9, v9, v9, v9 + (seq(abs(958), i0  => (v12)))[safeIndex(p3, |(seq(abs(958), i0  => (v12)))|) := v12], (v9 + v9)[safeIndex(f20, |(v9 + v9)|) := v12], v9[safeIndex(p3, |v9|) := 't']];
			v13 := v13;
			...
			globalState.f1 := v14[safeIndex(157, |v14|)];
			f21 := -(--0x19b + p2);
		}
		...
		if (v21[safeIndex(|v23|, |v21|)]) {
			...
			v22[safeIndex(740, v22.Length)] := p1;
			v22[safeIndex(740, v22.Length)] := p1;
			var v30: seq<int> := [f21, f20, p2];
			var v31: seq<map<bool, bool>> := [v24];
			var v32: map<bool, int> := map[v22[safeIndex(740, v22.Length)] := v18.f24];
			var v33 := DC5(v30);
			var v34: map<map<bool, bool>, seq<int>> := map[v31[safeIndex(if (v22[safeIndex(740, v22.Length)] in v32) then v32[v22[safeIndex(740, v22.Length)]] else f21, |v31|)] := v33.cf5];
			var v35 := 'x';
			var v36: array<bool> := new bool[14] [v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], p1, v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], v22[safeIndex(740, v22.Length)], p1, p1, v22[safeIndex(740, v22.Length)], p1, p1];
			var v37: set<array<bool>> := {v36, v36};
			var v38: map<int, int> := map[|v37| := v18.f24];
			v30 := if ((map[false := !v22[safeIndex(740, v22.Length)]] + fm34(p2, p1, fm1(v22[safeIndex(740, v22.Length)], globalState), v35, globalState)) in v34) then v34[map[false := !v22[safeIndex(740, v22.Length)]] + fm34(p2, p1, fm1(v22[safeIndex(740, v22.Length)], globalState), v35, globalState)] else [|v24|, -p2, |v38|, |v19|];
			var v39: array<D7> := new D7[28];
			var v40: map<char, array<bool>> := map[fm29(v22[safeIndex(740, v22.Length)], f21, p2, v22[safeIndex(740, v22.Length)], globalState) := v36];
			...
			if (if (p1) then p1 else v18.fm24(p1, v43, globalState)) {
				...
				var v49 := 'j';
				var v50: array<int> := new int[23](i1 => safeDivisionInt(i1, v18.f24));
				r0, globalState.f9, globalState.f6 := p1, DC23(v45, v46[safeIndex(|(if (p1 in v48) then v48[p1] else v47)|, |v46|) := v49], p1, v50, v49).cf40, v18.f24;
				...
				var v56: array<multiset<int>> := new multiset<int>[23] [v51[|v52| := abs(DC1(|(seq(abs(0x2e2), i2  => (v49)))|).cf1)], (multiset{v18.f24, f20})[v18.f24 := abs(v18.f24)], v51, v51 * multiset(v53), v51 - multiset{0x45}, v51, v51, multiset{-f21}, multiset{v18.f24, |v46|}, v54[safeIndex(v18.f24, |v54|)] - v51, multiset{0x261, f21, p3}, v51, v51, v51 - v51, v51, v51, multiset{v18.f24, p3}, v51, v51[|v55| := abs(p2)] + v51, v51, v51, v51, v51];
				v56[safeIndex(843, v56.Length)] := multiset{f20, v18.f24, |v19|, v18.f24, |v46|};
				var v57: seq<map<int, bool>> := [map[f20 := p1], v42];
				v22[safeIndex(428, v22.Length)] := (seq(abs(450), i3  => (v42))) <= v57;
				...
				f21, v56[safeIndex(843, v56.Length)], v22[safeIndex(428, v22.Length)], v58 := p3 - v18.f24, v51, p1, if (v59 in v60) then v60[v59] else v58;
				globalState.f6 := |fm28(|v19|, fm2(globalState), p2 > v18.f24, globalState)|;
				r0 := v22[safeIndex(428, v22.Length)];
				globalState.f1 := p1;
			} else {
				var v61 := "ydlpbiue";
				var v62 := 'i';
				...
				var v68: seq<int> := [p2];
				var v69: array<array<bool>> := new array<bool>[27] [v22, v22, v22, v22, v22, v22, v22, if (v18.f24 in v66) then v66[v18.f24] else v22, v22, v22, v22, v67[safeIndex(|v68|, |v67|)], v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22];
				var v70 := DC17(p1, |v61[safeIndex(v18.f24, |v61|) := v62]| in (seq(abs(940), i6  => (|v21|))), v65, DC10(v69), !p1);
				v70 := v70;
				globalState.f6 := p2;
				var v71: array<seq<int>> := new seq<int>[10](i7 => v68 + v68);
				var v72: seq<array<seq<int>>> := [v71, v71, DC38(v71).cf67];
				v71 := v72[safeIndex(0x117, |v72|)];
				v22[safeIndex(35, v22.Length)] := v65.f23;
				v22[safeIndex(424, v22.Length)] := v65.f23;
				v22[safeIndex(35, v22.Length)], globalState.f6, v22[safeIndex(424, v22.Length)], globalState.f1 := v65.f23, v18.f24, v65.f23, v65.f23;
				var v73 := new C1(f21);
			}
			
			var v74 := "lsek";
			globalState.f6 := safeModuloInt(p2, |v74|);
			var v75 := 'a';
			if (v75 !in v74) {
				f21 := f20;
				...
				var v78: seq<int> := [v77[safeIndex(f21, |v77|)], v18.f24, f20];
				v76 := multiset(v77 + v78);
				globalState.f1 := v18.f24 > 0xa5;
				var v79: array<int> := new int[12];
				v79[safeIndex(701, v79.Length)] := -0x3c3;
				v79[safeIndex(701, v79.Length)] := -fm15(globalState);
			} else {
			...
			if (p1) {
				var v81: map<seq<bool>, int> := map[fm19(globalState) := safeDivisionInt(p2, p2)];
				var v82: seq<int> := [p3];
				...
				var v86: map<set<multiset<int>>, int> := map[v85 := safeDivisionInt(p2, v18.f24)];
				v86 := v86[v85 := f20];
				globalState.f6 := -0x164;
				v22[safeIndex(178, v22.Length)] := p1;
				v22[safeIndex(178, v22.Length)], f21 := if (p1) then v74 <= v74 else p1, if (p1) then v18.f24 else 421;
				var v87: map<char, string> := map[v75 := v74];
				r0 := v18.fm24("eisnpxsp" != (if (v75 in v87) then v87[v75] else seq(abs(268), i8  => (v75))), v43, globalState);
			} else {
				...
				var v94: set<char> := {v74[safeIndex(|v93|, |v74|)], v75};
				...
				var v103: array<int> := new int[15] [f21 - |v90|, if (p1) then p3 else |"hty"|, -safeModuloInt(|[DC25(v96), v100]|, p3), v18.f24, |(if (v92.f23 in v101) then v101[v92.f23] else fm19(globalState))|, |v21| - f21, safeModuloInt(|v21|, v18.f24), v18.f24, -|v21|, safeModuloInt(f20, f20), p3, |(map v102 : int | v102 in map[f21 := |v21|] :: (v102 * v18.f24) := (v74))|, f20, v18.f24, p2];
				v103[safeIndex(396, v103.Length)] := f21;
				var v104: seq<int> := [fm1(false, globalState), p3];
				v103[safeIndex(396, v103.Length)] := -safeDivisionInt(|DC8(v104, v74, p1, v75).cf9| + 391, fm1(v92.fm17(|map[p1 := v75]|, 0x18, v92.f23, globalState), globalState));
		...
		for i9 := fm1(p1, globalState) to -v18.f24 {
			...
			if (p1) {
				v22[safeIndex(598, v22.Length)] := p1;
				var v108 := "kpy";
				v22[safeIndex(598, v22.Length)] := ("ja" + (seq(abs(622), i10  => ('t')))) != v108;
				globalState.f1 := -0x225 <= |v21|;
				var v109: seq<D3> := [p0, p0];
				var v110: C0 := new C0(v109, v22[safeIndex(598, v22.Length)]);
				var v111: multiset<C0> := multiset{v110, v110, v110};
				var v112: seq<C0> := [v110];
				var v113: seq<seq<C0>> := [v112, v112, v112];
				var v114: array<multiset<C0>> := new multiset<C0>[22] [v111[v110 := abs(v18.f24)], v111, v111[v110 := abs(p3)], v111, v111, v111, v111, v111, v111, multiset(v112 + v112), v111, multiset(v113[safeIndex(p2, |v113|)] + v112), v111 + v111, v111, (multiset{v110, v110})[v110 := abs(v18.f24)], v111 * v111, v111, v111, v111, v111, v111, (multiset{v110, v110})[v110 := abs(v18.f24)]];
				v114[safeIndex(726, v114.Length)] := v111;
				var v115 := 'g';
				var v116: map<char, bool> := map[v115 := v22[safeIndex(598, v22.Length)]];
				var v117: map<bool, bool> := map[p1 := if (v115 in v116) then v116[v115] else !v22[safeIndex(598, v22.Length)]];
				var v118: map<int, multiset<C0>> := map[|v117| := multiset(v112)];
				var v119: array<bool> := new bool[7];
				v114[safeIndex(726, v114.Length)], globalState.f1, r0, globalState.f14 := (if (v18.f24 in v118) then v118[v18.f24] else v111) - v111, v22[safeIndex(598, v22.Length)], !v22[safeIndex(598, v22.Length)], v119;
				v106 := fm28(f21, v22[safeIndex(598, v22.Length)], v19 > v19, globalState);
				var v120: seq<C1> := [v18, v18];
				v18 := v120[safeIndex(-25, |v120|)];
			} else {
				var v121: array<int> := new int[16](i11 => i11 - 0x389);
				v121[safeIndex(821, v121.Length)] := |(if (p1) then v19 else v19)|;
				var v122 := "kn";
				var v123 := 'a';
				...
				v121[safeIndex(821, v121.Length)], globalState.f1, v122, globalState.f1 := v18.f24, f21 == -|v126|, v122[safeIndex(i9, |v122|) := 'r'], p1;
				...
				var v130: map<multiset<set<int>>, string> := map[v128 := v129[safeIndex(v18.f24, |v129|)]];
				r2, globalState.f1, globalState.f6, v123 := if (p1) then v127 else v127, !!p1, |(if (v128 in v130) then v130[v128] else v122)|, 'v';
				v22[safeIndex(96, v22.Length)] := p1;
				v22[safeIndex(96, v22.Length)] := p1;
				globalState.f1 := v22[safeIndex(96, v22.Length)];
			}
...
class C3 extends T0, T1 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i2
		{
			...
			if ((v1 > {f18}) <== !f18) {
				...
				var v7 := new C0(if (v2[safeIndex(f19, |v2|)]) then v5[safeIndex(|v6|, |v5|) := v4] else v5, f18);
				globalState.f6 := f19;
				...
				v11[safeIndex(885, v11.Length)] := v7.f23;
				var v12: seq<int> := [f19];
				var v13 := 'm';
				var v14 := DC8(v12, "brgrt", v7.f23, v13);
				var v15 := "xnu";
				var v16: multiset<int> := multiset{|v15|, f19};
				v10, v11[safeIndex(885, v11.Length)], globalState.f1, globalState.f1 := DC17(v7.fm17(|v12|, |v14.cf8|, v7.f23, globalState), v7.f23, v7, if (f18) then v9 else v9, v7.f23), fm2(globalState), (v16 - v16) !! v16, f18;
			...
			var v28 := "cpvoudn";
			var v29 := 'u';
			var v30 := DC8(v27[safeIndex(f19, |v27|) := |"nlep"|], v28, f18, v29);
			...
			v31 := ((if (if (f18 in v32) then v32[f18] else f18) then v31 else v31) + v31)[safeIndex(|v34|, |((if (if (f18 in v32) then v32[f18] else f18) then v31 else v31) + v31)|) := f18];
			...
			decreases 100 - i4
		{
			...
			match ((if (false) then v38.(cf13 := v37) else v38).(cf13 := v37)) {
				case DC11(cf14) =>
					var v39 := 'x';
					v39 := v35[safeIndex(f19, |v35|)];
					r1 := f18;
					globalState.f1 := !true;
					var v40: array<map<set<int>, array<bool>>> := new map<set<int>, array<bool>>[12];
					var v42 := DC42(set v41 : int | (0x2b0 <= v41) && (v41 < 0x3d1) :: (safeDivisionInt(v41, cf14)));
					var v43: map<set<int>, array<bool>> := map[v42.cf73 := v36];
					v40[safeIndex(508, v40.Length)] := v43;
					v40[safeIndex(508, v40.Length)] := v43;
				case DC12(cf15, cf16, cf17) =>
					...
					v45 := v45;
				case DC10(cf13) =>
					v36[safeIndex(986, v36.Length)] := f18;
					v36[safeIndex(986, v36.Length)] := f19 < f19;
					globalState.f6 := f19 + f19;
					var v46: multiset<int> := multiset{f19};
					var v47 := new C2(safeModuloInt(-f19, |v46|), f19, if (f18) then f17 else f17);
					...
					var v55: seq<int> := [-736, fm1(f18, globalState), |v54[safeIndex(v47.f21, |v54|)]|];
					var v56: map<int, bool> := map[v47.f20 := v36[safeIndex(986, v36.Length)]];
					var v57: set<int> := {v47.f20, f19};
					var v58: map<bool, int> := map[v36[safeIndex(986, v36.Length)] := |v57|];
					var v59: array<int> := new int[10] [v47.f21, -0xf9 + f19, |(map v48 : int | v48 in v50 :: (safeModuloInt(v48, |(map v51 : int | (0x17a <= v51) && (v51 < 24) :: (v51 + 91) := (!f18))|)) := (f18))| * v47.f20, f19, |v55|, v47.f21, safeDivisionInt(|v56|, -v47.f21), if (v36[safeIndex(986, v36.Length)] in v58) then v58[v36[safeIndex(986, v36.Length)]] else -0x222, v47.f20 * v47.f20, v47.f21];
					v52[safeIndex(351, v52.Length)] := |fm28(-v47.f20, f18, v36[safeIndex(986, v36.Length)], globalState)|;
					v52[safeIndex(351, v52.Length)] := -f19;
				case DC13(cf18) =>
					...
					v63[safeIndex(484, v63.Length)] := v64;
					v63[safeIndex(484, v63.Length)] := v64 + v64;
			}
		...
		v79[safeIndex(120, v79.Length)] := v82;
		var v83: seq<bool> := [true, true, if (f18) then f18 else f18, f18 || f18, f18];
		var v84: seq<seq<bool>> := [[f18, true] + [f18], v83, v83, v83 + v83, [f18, v83[safeIndex(f19, |v83|)], f18, fm2(globalState), f18]];
		var v85 := DC28(fm1(f18, globalState));
		var v86: set<D10> := {v85};
		var v87: set<set<D10>> := {{DC28(DC11(65).cf14), v85, v85, v85}, v86};
		v78, r1, v79[safeIndex(120, v79.Length)], v83, globalState.f1 := DC35(), f18, v82, v84[safeIndex(-|v87|, |v84|)], fm2(globalState);
		r0 := safeDivisionInt(f19, f19);
		r1 := !f18;
	}
	method m2(p0: bool, globalState: GlobalState) {
		var v0 := "elwpjwmet";
		globalState.f6, globalState.f1 := safeDivisionInt(safeModuloInt(f19, f19), |v0|), p0;
			...
			decreases 100 - i0
		{
			...
			var v7: set<seq<int>> := {v6, v6[safeIndex(f19, |v6|) := f19], fm32(-f19, f19, f18, globalState)};
			globalState.f1 := v7 <= {v6, seq(abs(0xd6), i1  => (f19)), v6, v6, v6};
		}
		if (f18) {
			var v8: set<bool> := {p0};
			v8 := v8;
			if (if (f18 <== true) then f19 < f19 else false) {
				m13(globalState);
				v0 := v0 + (v0 + v0[safeIndex(f19, |v0|) := 'm']);
				var v9 := DC7(f19);
				var v10: map<bool, int> := map[p0 := f19];
				var v11: array<int> := new int[11] [-safeDivisionInt(-0x68, f19), f19, f19, f19, f19, |[p0, p0]|, v9.cf7, f19 - f19, |v0|, f19, |v10| + 523];
				v11[safeIndex(222, v11.Length)] := f19;
				var v12: seq<int> := [f19 - -f19, f19];
				v11[safeIndex(222, v11.Length)] := v12[safeIndex(if (f18) then |v0| else |v0|, |v12|)];
				globalState.f6 := f19;
				var v14: map<int, bool> := map[v11[safeIndex(222, v11.Length)] := p0];
				v2 := if (|(map v13 : int | v13 in v14 :: (safeModuloInt(v13, f19)) := (v2))| in v3) then v3[|(map v13 : int | v13 in v14 :: (safeModuloInt(v13, f19)) := (v2))|] else v2;
			} else {
				var v16: array<D0> := new D0[27](i2 => DC2(DC1(f19)));
				var v17: array<int> := new int[22](i3 => safeDivisionInt(i3, f19));
				m0(set v15 : int | v15 in [fm1(f18, globalState)] :: (v15 - 701), v16, v17, v0, globalState);
				var v18 := DC6(v17);
				var v19: seq<D3> := [v18, DC6(v17), v18, v18, DC6(v17)];
				var v20 := new C0((v19 + v19)[safeIndex(52, |(v19 + v19)|) := v18], f18);
				v17[safeIndex(392, v17.Length)] := f19;
				v17[safeIndex(392, v17.Length)] := fm1(253 == f19, globalState);
				var v21: seq<bool> := [p0];
				var v22 := DC31(v21, v17[safeIndex(392, v17.Length)], f19, fm1(true, globalState), f19);
				...
				v24[safeIndex(932, v24.Length)] := f18;
				v24[safeIndex(932, v24.Length)] := v20.fm17(safeModuloInt(-fm1(f18, globalState), v17[safeIndex(392, v17.Length)]), f19, p0, globalState);
				var v25: array<map<int, bool>> := new map<int, bool>[21];
				v25 := v25;
			}
			
			var v26: array<bool> := new bool[21];
			v26[safeIndex(741, v26.Length)] := !!p0;
			v26[safeIndex(741, v26.Length)], globalState.f6, v0, v0 := f18, safeModuloInt(f19, f19 * -f19), v0, v0 + v0;
			globalState.f6 := f19;
			var v27: array<char> := new char[20];
			v27[safeIndex(141, v27.Length)] := v2;
			v27[safeIndex(141, v27.Length)] := v0[safeIndex(f19, |v0|)];
		} else {
			globalState.f1 := p0;
			...
			v30[safeIndex(292, v30.Length)] := v28;
			v30[safeIndex(292, v30.Length)] := v28;
			if (p0 && p0) {
				v28 := v30[safeIndex(292, v30.Length)];
				var v31: seq<int> := [f19];
				...
				var v38: array<bool> := new bool[5] [v36.f23, p0, v37[safeIndex(f19, |v37|)], f18, p0];
				...
				var v44: array<array<D7>> := new array<D7>[25] [v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v43[safeIndex(f19, |v43|)], v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42];
				...
				var v48 := DC26(v44);
				v47 := v47[v48 := |(seq(abs(0x119), i4  => (v2)))|];
			} else {
				...
				v52[safeIndex(905, v52.Length)] := v51;
				v52[safeIndex(905, v52.Length)] := v51;
				globalState.f1 := p0;
				globalState.f1 := false;
		...
		var v59: map<multiset<bool>, seq<int>> := map[v57 := (seq(abs(0x73), i5  => (|[f19]|))) + [|v58|, f19]];
		var v60: map<bool, int> := map[f18 := safeModuloInt(151, f19)];
	...
	method m11(p0: string, p1: int, globalState: GlobalState) returns (r0: char) {
		...
		m0(v0, v1, v2, seq(abs(747), i0  => ('o')), globalState);
		var v3: array<seq<int>> := new seq<int>[13];
		var v4: seq<int> := [f19, p1];
		v3[safeIndex(519, v3.Length)] := v4 + v4;
		v3[safeIndex(519, v3.Length)] := [p1];
		globalState.f6 := -f19 + p1;
		globalState.f1 := f18;
		globalState.f6 := v3[safeIndex(519, v3.Length)][safeIndex(f19, |v3[safeIndex(519, v3.Length)]|)];
		var v5 := 'r';
		r0 := v5;
	}
	method m12(p0: int, p1: int, p2: string, p3: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		for i0 := p0 to f19 {
			...
			v0[safeIndex(678, v0.Length)] := v1[safeIndex(|p3|, |v1|)];
			...
			v0[safeIndex(678, v0.Length)], v3, r0, r1 := v4 !! v4, if (v8.cf66) then v3 else map v9 : multiset<bool> | v9 in v10 :: (v9) := (p3), !(v11 > v11), if (f18 !in v11) then p3 else seq(abs(590), i1  => ('l'));
			var v12 := new C2(p1, f19, f17);
			var v13 := 'r';
			var v14: map<int, int> := map[|v5| := |{v13, v13}|];
			var v15: seq<int> := [|p2|];
			var v16: array<int> := new int[17] [i0, v12.f20, v12.f20, v12.f20, |p3| - 0x35b, v12.f20, v12.f20, |[v0]| + |v11|, p1, p1 * fm1(v0[safeIndex(678, v0.Length)], globalState), |[f18]| * i0, -i0, |v11|, p1, -0x2f9 * |v14|, f19 * f19, if (!f18) then |v15| else f19];
			var v17 := DC31(v1, i0, p1, p1, p0);
			v16[safeIndex(327, v16.Length)] := v17.cf56;
			v16[safeIndex(327, v16.Length)] := i0;
			v16[safeIndex(327, v16.Length)] := 515;
		}
		globalState.f6 := -p1;
		globalState.f6 := p1;
		if (f18) {
			...
			v18[safeIndex(376, v18.Length)] := p0;
			v18[safeIndex(376, v18.Length)] := f19;
			var v20: multiset<int> := multiset{v18[safeIndex(376, v18.Length)], p1};
			...
			if ((v27 + (seq(abs(-0x177), i2  => (p3)))) == v27) {
				var v28: seq<int> := [p0];
				...
				v31 := v31;
				var v32: map<bool, int> := map[v26.f23 := v18[safeIndex(376, v18.Length)]];
				var v33: map<map<bool, int>, int> := map[v32 := |fm28(p1, false, v26.f23, globalState)|];
				v33 := v33[v32 := f19];
				var v34 := new C1(0x2d1 + |p2|);
			} else {
				var v35: map<seq<int>, bool> := map[[v18[safeIndex(376, v18.Length)], f19] := !v26.f23];
				v18[safeIndex(376, v18.Length)] := |(set v36 : seq<int> | v36 in v35 :: (v36))|;
				globalState.f6 := v18[safeIndex(376, v18.Length)] - 0x17;
				globalState.f1 := false;
				var v37: array<array<int>> := new array<int>[23];
				v37[safeIndex(841, v37.Length)] := v18;
				...
				v37[safeIndex(841, v37.Length)] := v41.cf40;
				var v42: map<int, multiset<int>> := map[p0 := v20];
				var v43: seq<map<map<int, bool>, int>> := [f17, f17, f17];
				var v44: seq<int> := [531];
				var v45 := DC5(v44);
				var v46 := new C2(|v42|, v18[safeIndex(376, v18.Length)], v43[safeIndex(v44[safeIndex(|v45.cf5|, |v44|)], |v43|)]);
			}
			...
			var v52 := 'm';
			v47 := v47[safeModuloInt(|(if (v49 in v51) then v51[v49] else v50)|, p1) := p2[safeIndex(f19, |p2|) := v52]];
			if (f18) {
				r0 := f18;
				globalState.f6 := safeDivisionInt(p0, 0x14);
				...
				var v59: map<map<bool, set<int>>, int> := map[v57[safeIndex(|[p0, |v58|]|, |v57|)] := f19];
				...
				v63[safeIndex(265, v63.Length)] := |v66|;
				var v67: array<char> := new char[11];
				var v68: array<bool> := new bool[3];
				v68[safeIndex(389, v68.Length)] := f18;
				v63[safeIndex(265, v63.Length)], v67, globalState.f6, globalState.f6, v68[safeIndex(389, v68.Length)] := 0x1bc, v67, 0xe7, 0x31, f18;
				var v69: multiset<bool> := multiset{v68[safeIndex(389, v68.Length)], v68[safeIndex(389, v68.Length)]};
				var v70: seq<bool> := [v68[safeIndex(389, v68.Length)], f18];
				globalState.f1 := (v69 + v69) <= multiset(v70[safeIndex(f19, |v70|) := f18] + v70);
				v50 := v50[592 := p1];
				globalState.f6 := |p2|;
				var v71 := DC31(v70, f19, p1, 0x12c, v63[safeIndex(265, v63.Length)]);
				var v72: seq<int> := [f19, v63[safeIndex(265, v63.Length)], |"unna"|, safeModuloInt(p1, v71.cf58)];
	...
	method m13(globalState: GlobalState) {
		...
		v0[safeIndex(246, v0.Length)] := v2 + [v1, v1, v1];
		v0[safeIndex(246, v0.Length)] := v2[safeIndex(fm1(f18, globalState), |v2|) := v1];
		var v3: multiset<bool> := multiset{f18};
		globalState.f6 := safeDivisionInt(safeModuloInt(f19, |v3|), if (f18 in v3) then v3[f18] else f19);
		var v4: seq<bool> := [f18];
		var v5: array<bool> := new bool[10] [f18, f18, f18, f18, if (f18) then f18 else f18, f18, f19 < 0x2db, v3 < (multiset(v4))[f18 := abs(f19)], f18, f18];
		forall i0 | 0 <= i0 < v5.Length {
			v5[i0] := f18;
		}
		v5[safeIndex(148, v5.Length)] := f18;
		...
		v14[safeIndex(318, v14.Length)] := v8;
		var v15: map<int, bool> := map[v6.f24 := !f18];
		var v16: seq<int> := [|v15|];
		var v17: map<bool, int> := map[!(v6.f24 !in v16) := 891];
		v5[safeIndex(148, v5.Length)], v13, globalState.f6, v14[safeIndex(318, v14.Length)] := f18 <==> (if (false) then f18 else f18), v13, if (true in v17) then v17[true] else -f19, v8;
		globalState.f1 := if (v5[safeIndex(148, v5.Length)]) then true else v5[safeIndex(148, v5.Length)];
		var v18: set<bool> := {f18};
		var i1 := 0;
		while (f18 <== !({v5[safeIndex(148, v5.Length)], v5[safeIndex(148, v5.Length)], v5[safeIndex(148, v5.Length)], v5[safeIndex(148, v5.Length)], f18} !! v18))
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			i1 := i1 + 1;
			var v21: set<int> := {|(map v19 : int | v19 in (set v20 : int | v20 in v16 :: (v20 - 0x1d2)) :: (safeDivisionInt(v19, 0xf0)) := (v6.f24))|};
			var v22: seq<set<int>> := [v21, v21];
			if (!(v22[safeIndex(v6.f24, |v22|)] > v21)) {
				v5[safeIndex(148, v5.Length)] := true;
				v18 := {{!v5[safeIndex(148, v5.Length)]} >= v18};
				...
				var v25: map<bool, bool> := map[f18 := v5[safeIndex(148, v5.Length)]];
				var v26: multiset<set<bool>> := multiset{v18};
				v25 := v25[f18 := v26 > v26];
			} else {
				var v27: seq<array<bool>> := [v5];
				var v28: array<array<bool>> := new array<bool>[13] [v5, v5, v5, if (f18) then v5 else v5, v5, v5, v5, if (false) then v5 else v5, v5, v27[safeIndex(f19, |v27|)], v5, v5, v5];
				v28 := v28;
				var v29: map<bool, bool> := map[!(v6.f24 > -f19) := true];
				v29 := v29[v5[safeIndex(148, v5.Length)] := f18];
				globalState.f14 := v5;
				v8[safeIndex(71, v8.Length)] := fm1(fm2(globalState), globalState);
				...
				var v34 := "rboenvi";
				v8[safeIndex(71, v8.Length)], v30, v31, globalState.f14 := -|[v32, v32, v32]|, v30, (if (false) then if (v6.f24 in v33) then v33[v6.f24] else v31 else fm33(v6.f24, v6.f24, f18, globalState)) + map[v6.f24 := |v34|], v5;
				v29 := v29[f18 := f18];
			}
			
			var v36: map<map<int, bool>, bool> := map[map v35 : int | (0x131 <= v35) && (v35 < 0x24d) :: (v35 * v6.f24) := (false) := true];
			v5[safeIndex(148, v5.Length)] := if (v6.fm24(v5[safeIndex(148, v5.Length)], v36, globalState)) then v5[safeIndex(148, v5.Length)] else f18;
			...
			match (DC37(true, true)) {
				case DC37(cf65, cf66) =>
					...
					globalState.f9 := new int[11] [f19, safeModuloInt(v6.f24, |v39|), |v40|, v6.f24, v6.f24, v6.f24, |((seq(abs(0x2fd), i2  => (f19))) + v16)|, v6.f24, -42, v6.f24, |(v41 + fm38(f19, v5[safeIndex(148, v5.Length)], true, f18, globalState))|];
					globalState.f1 := !f18;
					...
					v43 := v43;
				case DC36(cf64) =>
					var v44: seq<seq<D3>> := [v10, v10[safeIndex(f19, |v10|) := v9]];
					var v45 := new C0((v44[safeIndex(v6.f24, |v44|)])[safeIndex(v6.f24, |v44[safeIndex(v6.f24, |v44|)]|) := v9], false);
					var v46: map<bool, bool> := map[v45.f23 := v45.f23];
					v17 := v17[v5[safeIndex(148, v5.Length)] := -|v46|];
...
class C4 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v2 := 0x32e;
		v1[safeIndex(822, v1.Length)] := -v2;
		var v3: array<bool> := new bool[2];
		var v4 := 'l';
		var v5: multiset<char> := multiset{v4};
		v3[safeIndex(511, v3.Length)] := v4 !in v5;
		var v6 := true;
		globalState.f6, v1[safeIndex(822, v1.Length)], v3[safeIndex(511, v3.Length)], globalState.f6, v0 := safeModuloInt(0x151, v2 - v2), fm1(v6, globalState), v6, safeDivisionInt(v2, v2 + -0x26d), if (v6) then v0 else v0;
		var v7: map<int, bool> := map[0x239 := v3[safeIndex(511, v3.Length)]];
		var v8: map<map<int, bool>, int> := map[v7 := v2];
		var v9 := new C3(false, v2, v8);
		v1[safeIndex(822, v1.Length)] := v9.f19;
		var v10: map<int, int> := map[|v7| := v2];
		var v11 := DC34(v10);
		v1[safeIndex(822, v1.Length)] := match v11 {
			case DC35() => safeModuloInt(v9.f19, v9.f19)
			case DC34(cf63) => v1[safeIndex(822, v1.Length)]
		};
		v6 := !false;
		r0 := v1[safeIndex(822, v1.Length)];
		var v12: seq<bool> := [v3[safeIndex(511, v3.Length)], fm2(globalState), v3[safeIndex(511, v3.Length)], v6, v9.f18];
	...
	method m2(p0: bool, globalState: GlobalState) {
		...
		v3 := v3;
		if (p0) {
			globalState.f6 := safeDivisionInt(v1, v1);
			var v4: array<int> := new int[25];
			v4[safeIndex(526, v4.Length)] := -199;
			v4[safeIndex(526, v4.Length)] := v1;
			v4[safeIndex(526, v4.Length)] := v4[safeIndex(526, v4.Length)];
			var v5 := 'n';
			var v6: multiset<char> := multiset{v5, v5, v5, 'd'};
			var v7: map<bool, int> := map[p0 := v4[safeIndex(526, v4.Length)]];
			var v9: multiset<int> := multiset{v1, v1};
			var v10 := DC20(65, v1, v4[safeIndex(526, v4.Length)]);
			var v11: map<int, int> := map[v10.cf31 := v4[safeIndex(526, v4.Length)]];
			var v12 := "b";
			var v13 := DC12(v4[safeIndex(526, v4.Length)], p0, v5);
			var v14: set<D5> := {v13};
			var v15: seq<bool> := [p0];
			var v16: map<bool, seq<bool>> := map[p0 := v15];
			var v17: multiset<bool> := multiset{p0};
			var v18: map<bool, bool> := map[p0 := p0];
			v4 := new int[26] [if (v5 in v6) then v6[v5] else fm1(p0, globalState), v1, v4[safeIndex(526, v4.Length)] * v1, |v7|, v4[safeIndex(526, v4.Length)], |((map v8 : int | v8 in (seq(abs(936), i2  => (|{p0}|))) :: (safeDivisionInt(v8, v4[safeIndex(526, v4.Length)])) := (-v1))[|v9| := v1] + v11)|, v4[safeIndex(526, v4.Length)], safeDivisionInt(v1, v4[safeIndex(526, v4.Length)]), if (fm1(p0, globalState) in v11) then v11[fm1(p0, globalState)] else |v12|, |(v7 + v7)|, v4[safeIndex(526, v4.Length)], |(v14 * v14)|, v4[safeIndex(526, v4.Length)], v1, v1, v1 * v4[safeIndex(526, v4.Length)], v4[safeIndex(526, v4.Length)], safeModuloInt(v1, -v1), v4[safeIndex(526, v4.Length)] + 0x2f9, fm1(p0, globalState), -|v16|, |v17| * v4[safeIndex(526, v4.Length)], v4[safeIndex(526, v4.Length)], |v11|, v1, |v18|];
			globalState.f6 := if (!p0) then v1 else v1;
		} else {
			v1 := v1;
			var v20: map<int, bool> := map[v1 := p0];
			var v21: multiset<int> := multiset{|(map v19 : int | v19 in v20 :: (v19 + |(seq(abs(0x1e5), i3  => ('e')))|) := ("fpfcroym"))|, v1};
			...
			var v29: array<string> := new string[20] [v26, v26, (fm21(globalState))[safeIndex(v1, |fm21(globalState)|) := v27], v26, seq(abs(0x102), i4  => (v27)), v26, v26, "n", v26, v26, v26, v26, "rtuxv", v26, seq(abs(0x196), i5  => (v27)), v26, v28[safeIndex(v1, |v28|)], v26, v26, v26];
			var v30: array<array<string>> := new array<string>[4] [v29, v29, v29, v29];
			v30[safeIndex(282, v30.Length)] := v29;
			v30[safeIndex(282, v30.Length)] := new string[9](i6 => v26);
			globalState.f1 := p0;
		}
			...
			decreases 100 - i7
		{
			...
			if (true) {
				...
				v44[safeIndex(220, v44.Length)] := v43;
				var v45: multiset<int> := multiset{v32.f24, v1};
				var v46: seq<multiset<int>> := [v45];
				var v47: seq<int> := [|v46|];
				var v50: set<D12> := {v41};
				v44[safeIndex(220, v44.Length)], v47 := ((map v48 : D12 | v48 in (map v49 : D12 | v49 in v50 :: (v49) := (v37)) :: (v48) := (v31)) + map[v41 := v31]) + v43, v47;
				globalState.f1 := true;
				v1 := v32.f24 - v32.f24;
				globalState.f1 := fm2(globalState);
			} else {
				...
				v33[safeIndex(301, v33.Length)] := safeDivisionInt(|v53|, |fm28(|v54|, v36.f23, true, globalState)|);
				v33[safeIndex(301, v33.Length)] := |v52|;
				...
				var v57: multiset<bool> := multiset{v56[safeIndex(v33[safeIndex(301, v33.Length)], |v56|)], !p0, p0};
	...
	method m10(globalState: GlobalState) {
		...
		var v3 := 'm';
		var i0 := 0;
		while (!(v0 || (v2[safeIndex(|(seq(abs(0x2c), i1  => (|[{false}, {v0}]|)))|, |v2|) := v3] <= v2)))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v7 := DC34(v6);
			var v8: array<int> := new int[16] [if (true) then v4 else v4, v4, v4, fm1(v0, globalState), v4, |[|(seq(abs(629), i2  => (|[v0]|)))|, v4, v4, v4]|, v4, -v4, |v5|, |v2|, |"btflmnhpm"|, |map[v4 := v7]| * v4, fm1(true, globalState), fm1(v0, globalState) - v4, v4, v4];
			v8[safeIndex(246, v8.Length)] := v4;
			var v9: multiset<string> := multiset{seq(abs(192), i3  => (v3)), v2};
			v8[safeIndex(246, v8.Length)] := -(if (v2 in v9) then v9[v2] else v4);
			var v10: set<bool> := {!!fm2(globalState)};
			v10 := v10;
			if (true) {
				var v11: array<bool> := new bool[24];
				v11[safeIndex(818, v11.Length)] := v0;
				v11[safeIndex(818, v11.Length)] := v0;
				var v12: set<int> := {v8[safeIndex(246, v8.Length)], v8[safeIndex(246, v8.Length)]};
				var v13 := DC42(v12);
				v8[safeIndex(246, v8.Length)], v13 := v4, v13;
				...
				v16 := v16[v0 := v15];
				globalState.f6 := --safeDivisionInt(v4, if (v11[safeIndex(818, v11.Length)]) then v8[safeIndex(246, v8.Length)] else fm1(v0, globalState));
				var v17: T0 := new C1(v8[safeIndex(246, v8.Length)]);
				var v18 := DC15(v17);
				var v19: seq<T0> := [v17, v17];
				var v20: array<D7> := new D7[16] [v18, v18, v18, v18, v18, v18, v18, v18, v18, DC15(v19[safeIndex(v8[safeIndex(246, v8.Length)], |v19|)]), v18, v18, v18, v18, v18, v18];
				var v21: multiset<array<D7>> := multiset{v20, v20, v20};
				var v22: C2 := new C2(v8[safeIndex(246, v8.Length)], v4, map[map[v8[safeIndex(246, v8.Length)] := v0] := v4]);
				var v23: seq<C2> := [v22];
				var v24: array<multiset<array<D7>>> := new multiset<array<D7>>[20] [v21, v21, v21, multiset{v20, v20, v20}, v21, v21, v21, v21, v21[v20 := abs(v4)] - v21, v21, v21, v21, v21, v21 * v21[v20 := abs(v8[safeIndex(246, v8.Length)])], multiset{v20, v20, v20, v20, v20}, v21 * v21, multiset{v20}, v21[v20 := abs(|v23|)], v21, v21];
				v24[safeIndex(672, v24.Length)] := v21;
				var v25 := DC44(v14);
				globalState.f6, v24[safeIndex(672, v24.Length)], globalState.f1, globalState.f1 := v22.f21, (v21 * multiset{v20, v20}) * v21, fm2(globalState), false !in ((v25.(cf77 := v14)).cf77 * v14);
			} else {
				v0 := v0;
				var v26 := new C1(v4 * v4);
				v8[safeIndex(246, v8.Length)] := v4 + v4;
				var v27: map<bool, bool> := map[v26.fm24(!v0, fm39(v0, globalState), globalState) := false];
				v27 := v27[!v0 := true ==> v0];
				v8[safeIndex(246, v8.Length)] := |v5|;
			}
		...
		for i4 := v29 to safeDivisionInt(|v32|, v29) {
			...
			v36[safeIndex(106, v36.Length)] := v29;
			v36[safeIndex(106, v36.Length)] := v29;
			v2 := (fm21(globalState))[safeIndex(v36[safeIndex(106, v36.Length)], |fm21(globalState)|) := v3];
		}
		globalState.f6 := v29;
		if (v0) {
			var v37: set<int> := {v29};
			...
			v40[safeIndex(264, v40.Length)] := v41;
			var v43: map<int, bool> := map[v29 := v0];
			var v44: seq<map<int, int>> := [v39, map v42 : int | v42 in v43 :: (v42 * v29) := (v29), v39, v39];
			v39, v40[safeIndex(264, v40.Length)], v3 := v44[safeIndex(-v29, |v44|)], v41, fm29(v0, v29, fm1(v0, globalState), false, globalState);
			v0 := v0;
			globalState.f6 := 788;
			if (v0) {
				...
				var v47: array<map<seq<D9>, int>> := new map<seq<D9>, int>[28](i6 => map[[DC24(map[v29 := DC14(map[|"oorciw"| := {v29}])], [v0]), DC24(map[|v2| := DC14(map[v45.f24 := v37])], [v0, v0])] := 86] + map[seq(abs(802), i7  => (DC24(map[v29 := DC14(map[v45.f24 := v37])], [v0, v0]))) := 0x2d6]);
				var v49 := DC14(map v48 : int | (-0x90 <= v48) && (v48 < 0x203) :: (safeDivisionInt(v48, v45.f24)) := (v37));
				var v50: map<int, D6> := map[v45.f24 := v49];
				var v51: seq<bool> := [v0, v0, v0, v0];
				var v52 := DC24(v50, v51);
				var v53: map<seq<D9>, int> := map[[v52] := -v29];
				v47[safeIndex(760, v47.Length)] := v53;
				...
				v29, v47[safeIndex(760, v47.Length)], v54, globalState.f6, v29 := v29, fm40(v29, globalState), (v54[safeIndex(|v40[safeIndex(264, v40.Length)]|, |v54|) := v1] + v54) + v54, -0x85, (fm1(v0, globalState) - (if (v45.f24 in v56) then v56[v45.f24] else v45.f24)) - safeModuloInt(v45.f24, v29);
			} else {
				var v57: map<int, string> := map[|"h"| := v2];
				var v58: array<string> := new string[23] [v2, fm21(globalState), "yfhwoiw", v2, (seq(abs(0x4f), i8  => ('n'))) + v2, "q" + v2, v2, "wjvd", v2, v2, v2 + v2, v2, v2 + v2, v2, v2, if (v29 in v57) then v57[v29] else v2, "gqj" + (seq(abs(0x372), i9  => (v3))), "gv", v2, v2, "gjbixrfgg", "oarbcrux", v2 + v2];
				var v59: seq<string> := [v2, v2, v2, v2, v2];
				v58[safeIndex(316, v58.Length)] := v59[safeIndex(v29, |v59|)];
				v58[safeIndex(316, v58.Length)] := v2;
				...
				var v61: map<string, int> := map[v58[safeIndex(316, v58.Length)] := v29];
				var v62: array<int> := new int[24](i10 => safeDivisionInt(i10, v29));
				var v63: seq<bool> := [v0, v0, !false];
				var v64 := DC34(map[|multiset(v63)| := |v2|]);
				v62[safeIndex(879, v62.Length)] := |fm36(v3, v64, globalState)|;
				var v65: multiset<int> := multiset{v29};
				var v66: seq<multiset<int>> := [v65];
				var v67: seq<int> := [v29];
				var v68: set<string> := {v58[safeIndex(316, v58.Length)], v2[safeIndex(v29, |v2|) := v3]};
				globalState.f6, v61, v62[safeIndex(879, v62.Length)], globalState.f1, globalState.f1 := 957 - -v29, (if (v0) then v61 else v61) + v61, v29 * v29, !((v66 + fm41(|v67|, globalState)) != [v65]), {"qxbpkigo"} !! (v68 * v68);
				var v69: array<bool> := new bool[6];
				v69[safeIndex(576, v69.Length)] := v0;
				var v70: map<int, array<int>> := map[v62[safeIndex(879, v62.Length)] := v62];
				v69[safeIndex(576, v69.Length)] := |v70| != safeModuloInt(-v29, v62[safeIndex(879, v62.Length)]);
			}
			...
			match (v72) {
				case DC20(cf31, cf32, cf33) =>
					...
					var v81: array<multiset<multiset<int>>> := new multiset<multiset<int>>[29] [multiset{v74}, v76, v76, v76, multiset{multiset{|v37|}, v74}, v76, v76, v76, v76[v74[if (v77 in v78) then v78[v77] else v29 := abs(v29)] := abs(-0xfb)], v76, fm43(v0, fm2(globalState), v0, cf33, globalState), v76, v76, v76, if (v0) then v76 else v76, v76 + multiset{v74, v74}, v76, fm43(v0, v0, !v0, -0x178, globalState), v76 * v76, v76, v76 + v76, v76 + (v76[multiset(v79) := abs(v29)])[v74 := abs(|(seq(abs(313), i11  => (DC24(map[cf32 := DC14(map[cf33 := v37])], [v0, v0]))))|)], multiset(v80) + multiset([v74[if (v0 in v1) then v1[v0] else cf33 := abs(cf32)], v74]), v76 - v76, v76 - v76, v76, multiset(v80) - v76, v76, multiset(v80)];
					v81[safeIndex(934, v81.Length)] := multiset{v74};
					v81[safeIndex(934, v81.Length)] := multiset{multiset{-cf32} + v74};
				...
				case DC21(cf34, cf35) =>
					...
					v95 := v95;
					globalState.f6 := v29;
					globalState.f6 := safeModuloInt(v29, v29) + (v29 * |v90|);
				case DC19(cf30) =>
					...
					v99[safeIndex(720, v99.Length)] := v2;
					v99[safeIndex(720, v99.Length)] := v2;
			...
			var v101: array<bool> := new bool[8](i13 => v2[safeIndex(v29, |v2|) := v3] == v2);
			v101[safeIndex(317, v101.Length)] := v29 == 0x67;
			var v102: array<int> := new int[23];
			v102[safeIndex(372, v102.Length)] := v29;
			var v103: map<int, int> := map[v29 := v29];
			var v104 := DC34(v103);
			var v105: seq<bool> := [v0, v0, v0, v0];
			var v106: map<bool, bool> := map[v0 := v0];
			var v107: array<map<bool, int>> := new map<bool, int>[29] [v1, v1, fm36(v3, v104, globalState) + v1, v1, v1, v1, v1, map[v0 := v29], v1 + map[v0 := v29], v1 + v1[v0 := |v2|], v1, v1, v1, v1, v1 + v1, v1, if (v105[safeIndex(699, |v105|)]) then v1 else v1[v0 := v29], v1[true := v29] + v1, v1, v1, v1, v1, v1, map[v0 := |v106|], v1, v1 + fm36(v3, v104, globalState), v1, v1, v1];
			var v108: map<int, map<bool, int>> := map[v29 := v1];
			v107[safeIndex(326, v107.Length)] := if (v29 in v108) then v108[v29] else v1;
			var v109: map<array<bool>, string> := map[v101 := v2];
			v101[safeIndex(317, v101.Length)], v102[safeIndex(372, v102.Length)], v107[safeIndex(326, v107.Length)], globalState.f6, globalState.f1 := if (v0) then v0 else |(if (v101 in v109) then v109[v101] else v2)| >= fm1(v0, globalState), v29, v1, safeDivisionInt(v29, v29), v0;
			...
			v110[safeIndex(703, v110.Length)] := v112[safeIndex(v29, |v112|)];
			var v113: map<int, bool> := map[v102[safeIndex(372, v102.Length)] := v0];
			globalState.f6, v0, v102[safeIndex(372, v102.Length)], globalState.f1, v110[safeIndex(703, v110.Length)] := fm1(false, globalState), v0, if (v0) then 0x5a else v102[safeIndex(372, v102.Length)], v0 && (0x1b0 !in v113), v111;
			v2 := v2;
			var v114: multiset<bool> := multiset{v101[safeIndex(317, v101.Length)]};
			var v115: seq<map<int, bool>> := [v113];
			var v116: map<map<int, bool>, int> := map[DC48((v115[safeIndex(v29, |v115|)])[v29 := v101[safeIndex(317, v101.Length)]]).cf84 := v29];
			var v117 := DC47(v116);
			var v118 := new C2(v29, -|(v114[v101[safeIndex(317, v101.Length)] := abs(|v113|)] - v114)|, v117.cf83 + v116);
			var v120 := new C3(v101[safeIndex(317, v101.Length)], --(0x9f + v118.f20), map v119 : map<int, bool> | v119 in v116 :: (v119) := (|v106|));
		}
...
class C5 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v4: seq<int> := [|v3|];
		var v5: array<bool> := new bool[11] [v0, v0, true, v0, v0, v1[safeIndex(f16, |v1|)], --v4[safeIndex(f16, |v4|)] < f16, if (v0) then !v0 else v0, v0, fm2(globalState), v0];
		var v6 := 'n';
		var v7 := "y";
		v2[safeIndex(854, v2.Length)] := v6 in v7;
		v2[safeIndex(854, v2.Length)] := v0;
		var i0 := 0;
		while (if (v0) then false else v4[safeIndex(f16, |v4|)] > |v7|)
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v9: map<int, array<seq<int>>> := map[safeDivisionInt(f16, f16) := v8];
			v9 := v9[if (v2[safeIndex(854, v2.Length)]) then f16 else f16 := v8];
			var v10: set<int> := {f16};
			var v11: array<D0> := new D0[26](i1 => DC2(DC2(DC0(v2[safeIndex(854, v2.Length)]))));
			var v12: array<int> := new int[24];
			m0(if (v2[safeIndex(854, v2.Length)]) then v10 else v10, v11, v12, v7, globalState);
			var v13: multiset<bool> := multiset{v0, false};
			v12[safeIndex(908, v12.Length)] := safeDivisionInt(|fm12(v13, f16, globalState)|, f16);
			v12[safeIndex(908, v12.Length)] := f16;
			v2[safeIndex(854, v2.Length)] := !!v2[safeIndex(854, v2.Length)];
		}
		var v14: array<seq<bool>> := new seq<bool>[14] [v1, v1, fm13(v0, v6, f16, globalState), v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1 + v1];
		v14[safeIndex(43, v14.Length)] := v1;
		v14[safeIndex(43, v14.Length)] := fm13(f16 > f16, v6, |v7|, globalState);
		var v15: multiset<bool> := multiset{false};
		if (v15 < fm11(0x67, globalState)) {
			var v16 := DC0(v1[safeIndex(f16, |v1|)]);
			...
			v19 := v19[f16 := v18];
			var v20 := DC5(v4);
			v4 := (v4 + (seq(abs(-0x14c), i2  => (f16)))) + v20.cf5;
			...
			var v25 := DC0(v2[safeIndex(854, v2.Length)]);
			match (v25) {
				case DC1(cf1) =>
					var v26: set<int> := {cf1};
					...
					m0(v26, v28, v29, (seq(abs(0xd6), i4  => (v6))) + v7, globalState);
					v2[safeIndex(854, v2.Length)] := v0;
					var v30: multiset<int> := multiset{cf1};
					var v31 := DC4(v6);
					var v32: array<char> := new char[10] [v6, v6, v7[safeIndex(|v30|, |v7|)], v6, v31.cf4, 'i', v6, v6, v6, v6];
					v32[safeIndex(655, v32.Length)] := v6;
					v32[safeIndex(655, v32.Length)] := v6;
					var v33: map<int, string> := map[cf1 := v7];
					var v34: multiset<string> := multiset{"mh", if (cf1 in v33) then v33[cf1] else seq(abs(0xdd), i5  => (v6))};
					var v35: map<int, int> := map[|v34| := f16];
					globalState.f6 := safeModuloInt(|{|v15|}|, if (cf1 in v35) then v35[cf1] else cf1);
				case DC0(cf0) =>
					var v36: map<bool, int> := map[v0 := |multiset{f16, f16}|];
					var v37 := DC9(v36);
					var v38: map<map<bool, int>, bool> := map[v37.cf12 + v37.cf12 := v0];
					var v39 := DC5(v4);
					var v40: map<int, D2> := map[fm1(v2[safeIndex(854, v2.Length)], globalState) := v39];
					v38 := v38[fm14(v40, f16, cf0, globalState) := v0];
					globalState.f1 := fm1(cf0, globalState) == |v7|;
					var v42: map<int, int> := map[0x308 := f16];
					var v43 := DC34(v42);
					var v44 := new C3(v0, safeModuloInt(f16, 0x353), map[map v41 : int | v41 in v43.cf63 :: (safeDivisionInt(v41, f16)) := (v0) := f16]);
					var v45 := DC7(f16);
				...
				case DC2(cf2) =>
					globalState.f6 := f16;
					r0 := |v14[safeIndex(43, v14.Length)]|;
					v2[safeIndex(854, v2.Length)] := v0;
					globalState.f6 := f16;
			}
			
			globalState.f6, globalState.f1, globalState.f6, v2[safeIndex(854, v2.Length)] := --f16, (if (v0) then f16 else 799) < 0x2c1, fm1(v2[safeIndex(854, v2.Length)], globalState), v0;
			var v53: multiset<char> := multiset{'k', v6};
			var v54: multiset<int> := multiset{f16, |v53|, f16};
			var v55: set<int> := {|v54|};
			var v56: map<int, set<int>> := map[f16 := v55];
			var v57: map<int, D6> := map[v4[safeIndex(f16, |v4|)] := DC14(v56)];
			var v58 := DC24(v57, v1);
			match (v58) {
				case DC23(cf37, cf38, cf39, cf40, cf41) =>
					var v59 := DC44(multiset{false, cf39} - v15);
					globalState.f6, cf39, v59 := f16, if (v0) then v2[safeIndex(854, v2.Length)] else v0, v59;
					var v60: map<seq<int>, int> := map[seq(abs(0x243), i6  => (f16)) := f16];
					var v61: array<map<seq<int>, int>> := new map<seq<int>, int>[6] [v60, v60, v60, v60, v60[v4 := f16], v60[[f16] := f16]];
					v61[safeIndex(218, v61.Length)] := v60;
					var v62: set<array<int>> := {cf40};
					var v63: set<bool> := {v0};
					globalState.f6, cf39, v61[safeIndex(218, v61.Length)], globalState.f6, globalState.f6 := f16, v62 >= v62, v60 + (v60 + map[[f16] := 0x76]), |v4|, |v63|;
					var v64: map<string, bool> := map[seq(abs(0x30), i7  => (cf41)) := v14[safeIndex(43, v14.Length)][safeIndex(f16, |v14[safeIndex(43, v14.Length)]|)] && cf39];
					var v65: map<int, bool> := map[|cf38| := v2[safeIndex(854, v2.Length)]];
					r0, v64, v2[safeIndex(854, v2.Length)] := f16, v64 + v64, !v14[safeIndex(43, v14.Length)][safeIndex(|v65| + f16, |v14[safeIndex(43, v14.Length)]|)];
					globalState.f6 := f16;
				case DC24(cf42, cf43) =>
					v7 := v7;
					var v66 := DC28(f16);
					v66 := DC28(f16);
					v2[safeIndex(854, v2.Length)] := fm2(globalState);
					var v67: multiset<seq<bool>> := multiset{v1, cf43, [v2[safeIndex(854, v2.Length)], v0], [fm2(globalState)]};
					var v68: map<int, bool> := map[f16 := v2[safeIndex(854, v2.Length)]];
					var v69: map<map<int, bool>, int> := map[v68 := f16];
					var v70 := new C2(if ([v2[safeIndex(854, v2.Length)], v2[safeIndex(854, v2.Length)], v0] in v67) then v67[[v2[safeIndex(854, v2.Length)], v2[safeIndex(854, v2.Length)], v0]] else f16, f16, v69);
				case DC22(cf36) =>
					var v71: map<bool, seq<set<int>>> := map[v0 := seq(abs(0x229), i8  => (v55))];
					var v72: seq<set<int>> := [v55];
					var v73: map<int, bool> := map[480 := v0];
					var v74: map<map<int, bool>, int> := map[v73 := f16];
					var v75 := new C2(f16, f16 - |(if (v2[safeIndex(854, v2.Length)] in v71) then v71[v2[safeIndex(854, v2.Length)]] else v72)|, v74 + v74);
					var v76: set<bool> := {v0, v2[safeIndex(854, v2.Length)]};
					var v77 := DC32(v0 <== v2[safeIndex(854, v2.Length)], -v75.f20, v54 > v54[|v76| := abs(v75.f21)]);
					v77 := if (fm2(globalState)) then if (v2[safeIndex(854, v2.Length)]) then v77 else v77 else v77;
					...
					v81[safeIndex(154, v81.Length)] := if (v0) then v79 else v79;
					globalState.f1, v81[safeIndex(154, v81.Length)], v55 := v75.f20 <= v75.f21, if (!v0) then v79 else v79, v55;
					var v82: array<string> := new string[10];
					v82 := v82;
				case DC25(cf44) =>
					var v83: array<int> := new int[20](i10 => i10 + |v4[safeIndex(f16, |v4|) := f16]|);
					v83[safeIndex(615, v83.Length)] := f16;
					v83[safeIndex(615, v83.Length)] := f16;
					var v84: map<bool, array<int>> := map[v2[safeIndex(854, v2.Length)] := v83];
					globalState.f6 := v83[safeIndex(615, v83.Length)] - |v84|;
					var v85: multiset<multiset<bool>> := multiset{v15, v15};
					v85 := if (v0) then v85 else v85;
					var v86: map<bool, bool> := map[true := v0];
					globalState.f1, v2[safeIndex(854, v2.Length)], globalState.f6 := false, if (v2[safeIndex(854, v2.Length)]) then if (v2[safeIndex(854, v2.Length)] in v86) then v86[v2[safeIndex(854, v2.Length)]] else v2[safeIndex(854, v2.Length)] else v2[safeIndex(854, v2.Length)], f16;
			}
			
			var v87: set<bool> := {v0};
			var v88 := DC19(v87);
			v88 := v88;
			if (v4[safeIndex(f16, |v4|)] < f16) {
				r1 := true;
				...
				var v95: map<array<D4>, array<int>> := map[v93 := if (v1[safeIndex(f16, |v1|)]) then v94 else v94];
				var v96: seq<map<array<D4>, array<int>>> := [v95];
				var v97: map<int, int> := map[|v4| := f16];
				v95 := v96[safeIndex(f16 - |v97|, |v96|)];
				v54 := v54 - (multiset(v4[safeIndex(f16, |v4|) := f16]))[52 := abs(f16)];
				v2[safeIndex(854, v2.Length)] := v0;
				v94[safeIndex(906, v94.Length)] := f16;
				globalState.f1, v94[safeIndex(906, v94.Length)], globalState.f1, globalState.f1, r0 := v0, safeDivisionInt(f16, f16), 0x2ed < |"ayqx"|, v0, if (safeDivisionInt(150, if (v2[safeIndex(854, v2.Length)] in v15) then v15[v2[safeIndex(854, v2.Length)]] else f16) in v54) then v54[safeDivisionInt(150, if (v2[safeIndex(854, v2.Length)] in v15) then v15[v2[safeIndex(854, v2.Length)]] else f16)] else (if (0x246 in v54) then v54[0x246] else f16) * -f16;
			}
			
		}
		
		v0 := f16 >= safeModuloInt(|map[f16 := v6]|, f16);
		globalState.f6 := f16;
		r0 := f16;
		r1 := (true || v2[safeIndex(854, v2.Length)]) in (fm13(v2[safeIndex(854, v2.Length)], 'f', f16, globalState) + v1);
	}
	method m2(p0: bool, globalState: GlobalState) {
		var i0 := 0;
		while (p0)
			decreases 100 - i0
		{
			...
			v1 := ([p0])[safeIndex(if (p0) then f16 else f16, |[p0]|) := p0];
			...
			var v11 := DC23(v3, v4, v5[safeIndex(f16, |v5|)] < [p0, p0], v10, fm29(p0, f16, f16, p0, globalState));
			match (v11) {
				case DC23(cf37, cf38, cf39, cf40, cf41) =>
					var v12: set<bool> := {p0, p0};
					v12 := if (v1[safeIndex(f16, |v1|)]) then v12 - v12 else v12;
					v1 := v1;
					var v13: array<array<int>> := new array<int>[19];
					v13[safeIndex(569, v13.Length)] := v10;
					v13[safeIndex(569, v13.Length)] := v10;
				...
				case DC22(cf36) =>
					globalState.f1 := p0;
					var v21: map<map<int, bool>, bool> := map[map v20 : int | v20 in v9 :: (safeModuloInt(v20, f16)) := (p0) := p0];
				...
				case DC25(cf44) =>
					...
					v25 := (if (p0 <== p0) then v25 else if (p0) then v25 else v25)[safeIndex(-safeModuloInt(f16, if (p0 in v29) then v29[p0] else f16), |(if (p0 <== p0) then v25 else if (p0) then v25 else v25)|) := v10];
					var v30: array<bool> := new bool[2] [p0, p0];
					v30[safeIndex(529, v30.Length)] := p0;
					v30[safeIndex(529, v30.Length)] := p0;
					v6 := v6;
			...
			var v38 := new C2(v33[safeIndex(if (0x2d7 in v9) then v9[0x2d7] else |v34|, |v33|)], safeModuloInt(-f16, f16), v37);
		}
		...
		match (v39) {
			case DC14(cf19) =>
				...
				if (p0) {
					...
					var v56 := DC6(v54[safeIndex(|v55|, |v54|)]);
					var v57: seq<D3> := [v56];
					...
					v43[safeIndex(584, v43.Length)] := |(v59[v50.f19 := v58] + map[|v61| := v58])|;
					v43[safeIndex(584, v43.Length)] := v50.f19;
					globalState.f6 := 0x261 * v50.f19;
					v43[safeIndex(584, v43.Length)] := |v44|;
				} else {
					globalState.f6 := fm1(p0, globalState);
					var v62 := new C4();
					var v63 := 'j';
					v63 := v63;
					v43[safeIndex(761, v43.Length)] := f16;
					v43[safeIndex(761, v43.Length)] := v50.f19;
					var v64: multiset<bool> := multiset{v50.f18};
					globalState.f6 := if (v50.f18) then if (fm2(globalState) in v64) then v64[fm2(globalState)] else 0x148 else safeDivisionInt(f16, v50.f19);
				}
		...
		var v67 := DC9(v66);
		v65 := match v67 {
			case DC9(cf12) => map v68 : int | v68 in {f16, f16, 0x2cb} :: (safeModuloInt(v68, f16)) := (false)
		};
		...
		match (v74) {
			case DC11(cf14) =>
				...
				var v78 := DC39(seq(abs(0x2aa), i2  => (|[p0, p0]|)), v77, p0);
				...
				if (p0) {
					var v82 := DC11(cf14);
					var v83: array<int> := new int[10] [v82.cf14, v80[safeIndex(cf14, |v80|)], cf14, |{f16}|, fm1(p0, globalState), -536, cf14, 363, f16, f16];
					var v84: set<bool> := {p0, p0};
					v83[safeIndex(232, v83.Length)] := |v84|;
					v83[safeIndex(232, v83.Length)] := f16;
					...
					var v89: seq<set<int>> := [set v88 : int | (0x370 <= v88) && (v88 < -220) :: (safeModuloInt(v88, 0xef))];
					v86[safeIndex(188, v86.Length)] := multiset{if (p0 in v66) then v66[p0] else |(map v87 : set<int> | v87 in v89 :: (v87) := (p0))|};
					var v90: map<int, int> := map[|v81| := -cf14];
					var v91: multiset<int> := multiset{f16};
					v86[safeIndex(188, v86.Length)] := multiset{cf14, if (f16 in v90) then v90[f16] else f16} - v91;
					globalState.f1 := if (p0 ==> p0) then if (p0) then p0 else true else p0;
					globalState.f6 := |((v81 + (seq(abs(878), i4  => (v75)))) + v81)|;
					v72[safeIndex(131, v72.Length)] := v75 !in "emichywvs";
					v72[safeIndex(131, v72.Length)] := cf14 >= |fm21(globalState)|;
				}
				...
				v95 := v95;
				v72[safeIndex(135, v72.Length)] := p0;
				var v96: multiset<bool> := multiset{v93.f18};
				var v97: set<seq<int>> := {seq(abs(368), i5  => (|v65|)), [0x1bb, v93.f19], fm12(v96, cf14, globalState)};
				var v98: set<int> := {f16};
				globalState.f1, globalState.f1, v72[safeIndex(135, v72.Length)] := !(if (831 in v65) then v65[831] else !p0), (v97 * v97) >= {seq(abs(0x2f0), i6  => (|v96|)), seq(abs(0x10a), i7  => (v93.f19))}, (v98 * v98) >= v98;
			case DC12(cf15, cf16, cf17) =>
				globalState.f1 := !!cf16;
				...
				if (|v102| == cf15) {
					...
					var v109: array<int> := new int[20] [cf15, fm1(!p0, globalState) * |multiset{cf17, cf17}|, f16, v99, cf15 - cf15, |[cf15]|, cf15, v99, f16, safeDivisionInt(cf15, 0x227), v99, |v106| + 809, safeModuloInt(cf15, f16), |v107|, f16, fm1(v100, globalState), if (p0) then cf15 else |v108|, cf15 - cf15, v99, v99];
					v109[safeIndex(284, v109.Length)] := v99;
					var v110: array<D15> := new D15[14];
					var v111: map<bool, array<D15>> := map[!v100 := v110];
					var v112: map<map<bool, array<D15>>, int> := map[v111 := v99];
					v109[safeIndex(284, v109.Length)] := if (cf16) then if (v111 in v112) then v112[v111] else |v107| else cf15;
				} else {
					globalState.f1 := !p0;
					globalState.f1 := !fm2(globalState);
					globalState.f14 := v72;
					...
					v116[safeIndex(571, v116.Length)] := |v117|;
					v116[safeIndex(571, v116.Length)] := safeDivisionInt(|map[v99 := cf15]| + 0x9a, cf15);
				}
				
				var v118: array<int> := new int[23];
				v118[safeIndex(239, v118.Length)] := 788 + cf15;
				v118[safeIndex(239, v118.Length)] := if ((if (f16 in v102) then v102[f16] else -cf15) in v102) then v102[if (f16 in v102) then v102[f16] else -cf15] else v99;
			case DC10(cf13) =>
				globalState.f6 := safeDivisionInt(f16, f16);
				var v119: array<multiset<bool>> := new multiset<bool>[18];
				var v120: multiset<bool> := multiset{p0, p0};
				v119[safeIndex(837, v119.Length)] := v120 * multiset{!p0, p0, p0, p0};
				v119[safeIndex(837, v119.Length)] := v120;
				var v121 := DC1(f16);
				match (v121) {
					case DC1(cf1) =>
						var v122 := DC1(cf1);
					...
					case DC0(cf0) =>
						...
						var v134 := DC37(!v133[safeIndex(f16, |v133|)] ==> cf0, v119[safeIndex(837, v119.Length)] > v120);
						v134 := if (p0) then v134 else v134;
						globalState.f1 := p0;
					case DC2(cf2) =>
						var v135: seq<int> := [safeModuloInt(f16, f16)];
				...
				if (p0) {
					...
					var v146: array<int> := new int[18] [f16, |v144| * f16, f16, |v145|, f16 + f16, f16, f16, f16, f16, f16, v145[safeIndex(f16, |v145|)], f16, -f16, f16, 619, safeDivisionInt(f16, -314), -|v66|, f16];
					var v147: map<int, int> := map[f16 := f16];
					v143, globalState.f6, globalState.f9, globalState.f6, globalState.f6 := v143, 534, v146, if (f16 in v147) then v147[f16] else |v144| + f16, v145[safeIndex(f16, |v145|)];
					var v148: array<map<int, int>> := new map<int, int>[11];
					v148 := new map<int, int>[21](i10 => v147 + v147);
					v72[safeIndex(617, v72.Length)] := p0;
					v72[safeIndex(617, v72.Length)] := p0;
					v144 := fm21(globalState);
					var v149: multiset<int> := multiset{DC45(f16, v143, f16, v72[safeIndex(617, v72.Length)]).cf78};
					globalState.f6 := |(v144[safeIndex(|v149[fm1(p0, globalState) := abs(f16)]|, |v144|) := v143] + fm21(globalState))| - |v66|;
				}
				
			case DC13(cf18) =>
				globalState.f1 := p0;
				v73[safeIndex(270, v73.Length)] := v72;
				v73[safeIndex(270, v73.Length)] := v72;
				globalState.f1 := p0;
				if (p0) {
					var v150 := 't';
					...
					var v153: seq<int> := [v152[safeIndex(f16, |v152|)]];
					var v154: array<int> := new int[6] [|(seq(abs(565), i11  => ('y')))| * f16, -f16, f16, f16, safeModuloInt(-0x1ae, f16), |v151[v150 := abs(|v152|)]| + fm1(p0, globalState)];
					v154[safeIndex(771, v154.Length)] := f16;
					v154[safeIndex(771, v154.Length)] := safeDivisionInt(f16, f16);
					var v155 := "gg";
					globalState.f6 := safeModuloInt(|v65|, v154[safeIndex(771, v154.Length)] * |v155|);
					globalState.f6 := (if (false) then v154[safeIndex(771, v154.Length)] else v154[safeIndex(771, v154.Length)]) * |"gunwfodep"|;
					var v156, v157 := v71.m1(globalState);
					globalState.f1, v154[safeIndex(771, v154.Length)] := v157, f16;
				} else {
...
class C6 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v3: array<int> := new int[13] [v0 + -v0, v0, 317 - v0, v0, v0, v0, v0, fm1(!v1, globalState), -v0, v0, -safeModuloInt(v0, v0), safeDivisionInt(v0, v0), |DC3(v2).cf3| * -379];
		var v4: array<bool> := new bool[11] [v1, v1, v1, false, v1, v1, v1, v1, v1, v1, !!v1];
		var v5: map<bool, array<bool>> := map[v1 := v4];
		v3[safeIndex(8, v3.Length)] := |(v5 + map[v1 := v4])|;
		v3[safeIndex(8, v3.Length)] := v0 * safeModuloInt(v0, 0x3a4);
		...
		v0 := match v6 {
			case DC1(cf1) => cf1
			case DC0(cf0) => v3[safeIndex(8, v3.Length)]
			case DC2(cf2) => -|"krasuv"|
		};
		var v7: map<int, bool> := map[v3[safeIndex(8, v3.Length)] := true];
		var v8: map<map<int, bool>, int> := map[v7 := v3[safeIndex(8, v3.Length)]];
		var v9 := new C3(v1, v0, v8);
		v0 := v0;
		globalState.f14 := new bool[13];
		r0 := v3[safeIndex(8, v3.Length)];
		r1 := v1;
	}
	method m2(p0: bool, globalState: GlobalState) {
		var v2: array<multiset<int>> := new multiset<int>[15](i0 => multiset{729, 0x1e4, -|(map v0 : int | v0 in map[|(set v1 : int | (0x9 <= v1) && (v1 < 0x1c4) :: (safeModuloInt(v1, 0x1d2)))| := p0] :: (v0 - |"cc"|) := (|multiset{p0}|))|} + multiset([-0x2f1, -0x143]));
		var v3 := 0x1ef;
		var v4: multiset<int> := multiset{v3};
		v2[safeIndex(226, v2.Length)] := v4;
		var v5 := 'r';
		var v6: array<int> := new int[12];
		var v7: map<int, int> := map[v3 := v3];
		var v8: map<int, int> := map[|v7| := v3];
		v6[safeIndex(715, v6.Length)] := |v8|;
		v2[safeIndex(226, v2.Length)], globalState.f1, v5, v6[safeIndex(715, v6.Length)] := v4 - v4, p0, v5, v3;
		var v9: array<bool> := new bool[3];
		forall i1 | 0 <= i1 < v9.Length {
			v9[i1] := p0 && p0;
		}
		v6[safeIndex(715, v6.Length)] := v6[safeIndex(715, v6.Length)];
		var i2 := 0;
		while (p0)
			decreases 100 - i2
		{
			...
			var v11: map<map<int, bool>, int> := map[v10 := -v6[safeIndex(715, v6.Length)]];
			var v12 := new C2(837 + -0x320, v3, v11);
			if (p0) {
				var v13 := DC52(v9);
				var v14: seq<array<bool>> := [v9, v9, v13.cf92, v9, v9];
				var v15: array<array<bool>> := new array<bool>[11] [v14[safeIndex(v12.f21, |v14|)], v9, v9, v9, v9, v9, v14[safeIndex(v3, |v14|)], v9, v9, v9, v9];
				v15 := v15;
				var v16 := new C5(|{v6}|);
				globalState.f6 := v12.f21;
				v9[safeIndex(456, v9.Length)] := v3 < 0x72;
				v9[safeIndex(456, v9.Length)] := p0;
				globalState.f1 := p0;
			} else {
				v6[safeIndex(715, v6.Length)] := safeModuloInt(v12.f21, v3);
				var v17 := "idh";
				v17 := v17;
				globalState.f1 := p0;
				var v18: map<int, seq<char>> := map[v3 := v17];
				v18, v12.f21 := fm38(safeModuloInt(fm1(p0, globalState), fm1(p0, globalState)), p0, p0, !p0, globalState), 0xea;
				var v19: array<string> := new seq<char>[14] [if (p0) then seq(abs(0x44), i3  => (v5)) else "ckh", v17, v17, v17, if (p0) then "xyjs" else v17, v17, v17, v17, v17, v17, v17, v17, seq(abs(0x2ae), i4  => ('s')), v17];
				v19[safeIndex(510, v19.Length)] := if (v12.f21 in v18) then v18[v12.f21] else v17;
				v19[safeIndex(510, v19.Length)] := v17;
			}
			
			v10 := v10[v3 := p0];
			var v20: array<multiset<array<int>>> := new multiset<array<int>>[12];
			var v21 := "pvfjavan";
			v20[safeIndex(852, v20.Length)] := (multiset{v6, v6})[v6 := abs(|v21|)];
			var v22: seq<bool> := [p0];
			var v23: multiset<array<int>> := multiset{v6};
			globalState.f1, v20[safeIndex(852, v20.Length)], globalState.f1, v22 := (fm44(globalState)).cf65, v23, p0, v22;
		}
		v6[safeIndex(715, v6.Length)] := safeDivisionInt(v3, 880) + fm1(p0, globalState);
		var v24 := "o";
	...
	method m8(p0: char, globalState: GlobalState) returns (r0: bool) {
		...
		v2[safeIndex(545, v2.Length)] := v1;
		v2[safeIndex(545, v2.Length)], globalState.f1 := v1, fm2(globalState);
		var v3 := false;
		globalState.f1 := v3;
		var v4: array<bool> := new bool[3](i0 => v3);
		var v5 := DC52(v4);
		var v6: seq<bool> := [v3];
		var v7: multiset<bool> := multiset{v6[safeIndex(|"sqjejkkcx"|, |v6|)], v3};
		var v8 := -0x141;
		v5, r0, globalState.f6 := v5, v7 >= v7, v8;
		if (v3) {
			r0 := false;
			var v9: array<char> := new char[22];
			v9[safeIndex(193, v9.Length)] := p0;
			v9[safeIndex(193, v9.Length)] := 'x';
			...
			var v14 := "qwmvti";
			var v15: array<int> := new int[29](i1 => safeModuloInt(i1, v8));
			var v16: map<array<int>, bool> := map[v15 := v3];
			v13 := v13[safeIndex(fm1(true, globalState) + |v14|, |v13|) := fm1(if (v15 in v16) then v16[v15] else v3, globalState)];
		} else {
			globalState.f1 := v3;
			var v17 := 't';
			var v18 := DC12(v8, v6[safeIndex(v8, |v6|)], p0);
			...
			v19[safeIndex(639, v19.Length)] := |v24|;
			v19[safeIndex(639, v19.Length)] := v8;
			var v25: map<bool, string> := map[v3 := v20];
			v25 := map[v3 := seq(abs(0x23), i2  => (p0))] + (map[false := "spti"] + map[v3 := v20]);
			var v26 := DC6(v19);
			var v27: seq<D3> := [v26];
	...
	method m9(p0: int, globalState: GlobalState) returns (r0: int) {
		...
		var v11: array<int> := new int[21] [p0, 800, p0, p0, p0, p0, |map[p0 := p0]|, p0, v7.cf48, |v8|, p0, p0, p0, p0, p0, p0, |(seq(abs(280), i0  => ('l')))|, p0, |v9|, p0, |v10|];
		var v12 := DC6(v11);
		...
		match (v15) {
			case DC23(cf37, cf38, cf39, cf40, cf41) =>
				...
				v20[safeIndex(465, v20.Length)] := v16 * v16;
				v20[safeIndex(465, v20.Length)] := multiset(v18);
				cf39 := 'v' in "esckela";
				v4[safeIndex(228, v4.Length)] := v5;
				v4[safeIndex(228, v4.Length)] := v5;
				var v21: array<bool> := new bool[20](i1 => !v5);
				globalState.f14 := v21;
			case DC24(cf42, cf43) =>
				var v22: multiset<bool> := multiset{v5, v5, v5, v5, v5};
				v11[safeIndex(279, v11.Length)] := (if (v5 in v22) then v22[v5] else p0) * p0;
				v11[safeIndex(279, v11.Length)] := safeModuloInt(p0, -safeDivisionInt(|"bb"|, -p0));
				globalState.f6 := -v11[safeIndex(279, v11.Length)];
				v5 := v5;
				var v23: map<int, bool> := map[v11[safeIndex(279, v11.Length)] := false];
				var v24: map<map<int, bool>, int> := map[v23 := v11[safeIndex(279, v11.Length)]];
				var v25 := new C2(v11[safeIndex(279, v11.Length)], if (v11[safeIndex(279, v11.Length)] in v8) then v8[v11[safeIndex(279, v11.Length)]] else p0, v24 + v24);
			case DC22(cf36) =>
				...
				v26[safeIndex(438, v26.Length)] := v28;
				v26[safeIndex(438, v26.Length)] := {p0};
				var v29: set<string> := {v0, v0, v0, "vkytdei", v0[safeIndex(0x189, |v0|) := v2]};
				v11[safeIndex(557, v11.Length)] := p0 - |v29|;
				v11[safeIndex(557, v11.Length)] := p0 * p0;
				if ((fm21(globalState) + v0) <= v0) {
					globalState.f1 := v5;
					globalState.f6 := v11[safeIndex(557, v11.Length)];
					var v30: map<bool, bool> := map[v5 := v5];
					var v31 := DC39(v1, v30, v5);
					var v32 := DC43(v5, v31.cf70, v5);
					var v33: multiset<bool> := multiset{v5};
					var v34: map<map<int, bool>, int> := map[map[|[v11[safeIndex(557, v11.Length)]]| := v5] := p0];
					var v35: map<int, bool> := map[p0 := v5];
					var v36: C3 := new C3(v5 || v32.cf74, if (v5) then |v33| else DC12(|(seq(abs(855), i3  => (v2)))|, v5, v2).cf15, v34[v35 := -637] + DC47(v34).cf83);
					var v37: set<char> := {'p'};
					globalState.f6, v5, v36 := (p0 * v11[safeIndex(557, v11.Length)]) - safeModuloInt(v36.f19, v1[safeIndex(if (v5 in v33) then v33[v5] else |v6|, |v1|)]), |(v37 - v37)| <= p0, v36;
					var v38: array<seq<bool>> := new seq<bool>[15];
					var v39: seq<bool> := [v36.f18];
					var v40 := DC31(v39, |v9|, v36.f19, p0, v36.f19);
					v38[safeIndex(955, v38.Length)] := v40.cf54;
					v2, v38[safeIndex(955, v38.Length)], r0 := v2, v39 + v39, safeModuloInt(0x102, v36.f19) - p0;
					globalState.f1 := v5;
				} else {
					v11[safeIndex(557, v11.Length)] := v11[safeIndex(557, v11.Length)];
					globalState.f6 := if (v5) then v11[safeIndex(557, v11.Length)] else p0;
					var v41: array<D16> := new D16[11];
					var v42: map<string, array<D16>> := map["fyhai" := v41];
					v41 := if (v0 in v42) then v42[v0] else v41;
					v0 := v0;
					var v43 := new C0(([v12])[safeIndex(p0, |[v12]|) := v12], v5);
				}
				
				globalState.f6, v0, globalState.f1, globalState.f14 := safeModuloInt(0x1a2, p0), v0 + v0, |v26[safeIndex(438, v26.Length)]| == p0, v4;
			case DC25(cf44) =>
				if (DC50(v5, p0, p0, v5, fm2(globalState)).cf89) {
					...
					v46[safeIndex(42, v46.Length)] := v2;
					v46[safeIndex(42, v46.Length)] := v2;
					v4[safeIndex(980, v4.Length)] := v5;
					...
					var v51 := DC1(|[v5]|);
					var v52 := DC2(v51);
					var v53: array<D6> := new D6[29] [DC14(v47), v49, v49, v49, DC14(v47), v49, v49, v49, DC14(map[|v45| := {p0, |v50|}]), v49, v49.(cf19 := v47), v49, fm26(v46[safeIndex(42, v46.Length)], v52, v5, v5, globalState), v49, DC14(v47), DC14(map[fm9(seq(abs(0x259), i4  => (v2)), globalState) := {v44.f24, p0}]), v49, v49, v49, v49, v49, v49, v49, v49, v49, v49, v49.(cf19 := v47).(cf19 := map[|v1| := v48]), v49, v49];
					var v54: array<array<D6>> := new array<D6>[5] [v53, v53, v53, v53, v53];
					v4[safeIndex(980, v4.Length)], v54 := !(v5 || v5), v54;
					...
					var v59 := DC8(v1, seq(abs(0xc1), i7  => (v2)), v5, 'n');
					var v60: array<string> := new string[21] [v0, (seq(abs(0xcc), i5  => (v2))) + (seq(abs(0x176), i6  => (v2))), v0, "mcf", v0, v0, v0, v0, v0, v0, if (fm10(v56, v57, if (p0 in v58) then v58[p0] else 'p', p0, globalState)) then v0 else v0, v59.cf9, v0, "fmsrvacn" + v0, "timqowl", v0, "a" + v0, v0, v0, v0, v0];
					var v61 := DC21(v0, {v5, v5});
					v60[safeIndex(216, v60.Length)] := v61.cf34;
					var v62: seq<string> := [v0[safeIndex(p0, |v0|) := v2], v0, v0 + v0, v0];
					v60[safeIndex(216, v60.Length)] := v62[safeIndex(p0, |v62|)];
					v5 := p0 == (p0 * p0);
					var v63: set<bool> := {v5};
					globalState.f6 := |(v63 + (v63 * fm31(-p0, v5, globalState)))|;
					v4[safeIndex(50, v4.Length)] := v5;
					v4[safeIndex(50, v4.Length)] := v5;
				}
				...
				var v66 := DC53(v65);
				var v67: map<int, C5> := map[|(seq(abs(335), i8  => (v2)))| * fm1(v5, globalState) := v66.cf93];
				v67 := v67[p0 := v65];
		...
		v69 := v69.(cf71 := v5);
		v5 := v5;
		var v71 := new C3(p0 in v9, safeModuloInt(p0, p0), map v70 : map<int, bool> | v70 in fm45(p0, globalState) :: (v70) := (p0));
...
class C7 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (!(if (v0) then true <==> true else v0)) {
			...
			if (v0) {
				var v2 := 0x342;
				globalState.f6 := safeModuloInt(v2, v2);
				var v3 := "bjdokiwra";
				var v4: array<bool> := new bool[20](i0 => v0);
				var v5: seq<bool> := [v0, v0];
				v4[safeIndex(882, v4.Length)] := v5[safeIndex(v2, |v5|)];
				var v6: seq<int> := [v2, v2];
				v3, v4[safeIndex(882, v4.Length)] := v3, v6 <= v6;
				var v7 := new C4();
				var v8 := new C6();
				var v9 := 'i';
				var v10 := DC11(v2);
				...
				v15[safeIndex(235, v15.Length)] := |(v17 + v17)|;
				var v18: map<bool, bool> := map[v0 := v0];
				v9, v15[safeIndex(235, v15.Length)] := fm29(v4[safeIndex(882, v4.Length)], v2, v2, if (v0 in v18) then v18[v0] else v0, globalState), 16;
			} else {
				var v19 := 0x3de;
				var v20: seq<int> := [v19];
				var v21 := 'd';
				...
				var v23 := "okujifd";
				v0 := !!(v22.(cf11 := v23[safeIndex(v19, |v23|)], cf9 := v23)).cf10;
				var v24 := DC37(v0 <== v0, v0);
				v24 := v24;
				var v25: array<string> := new string[5](i1 => v23);
				v25[safeIndex(24, v25.Length)] := v23 + v23;
				var v26: array<array<bool>> := new array<bool>[26];
				var v27: array<bool> := new bool[29];
				v26[safeIndex(939, v26.Length)] := v27;
				var v28: seq<bool> := [false];
				r0, v25[safeIndex(24, v25.Length)], v19, v26[safeIndex(939, v26.Length)] := v19, v23 + (v23 + v23), if (v0) then -(v19 - v19) else |(v28 + v28)|, v27;
			...
			var v44 := 'b';
			v42[safeIndex(803, v42.Length)] := v43[safeIndex(|fm13(v0, v44, v31, globalState)|, |v43|)];
			var v45: seq<bool> := [fm2(globalState) <== v0, v0, false, v0, v0];
			r1, v41, v42[safeIndex(803, v42.Length)], globalState.f1 := v45[safeIndex(v36.f20, |v45|)], v41, v32 + v32, fm2(globalState);
			if ((v36.f21 <= fm1(v0, globalState)) <==> (if (v0) then !v0 else v0)) {
				...
				v53 := v53;
				var v54: map<int, int> := map[v36.f20 + v31 := |v42[safeIndex(803, v42.Length)]|];
				var v55 := DC7(v31);
				globalState.f6, r1, v36.f21 := if (v55.cf7 in v54) then v54[v55.cf7] else --v31, !v0, --((-v36.f21 - v36.f21) + 0x3b);
				globalState.f1 := true;
				v30[safeIndex(669, v30.Length)] := false;
				v30[safeIndex(669, v30.Length)], globalState.f6 := false, fm1(v39.cf0, globalState);
			}
			...
			v58 := v58[v0 := safeModuloInt(|v60|, -v59.f24)];
			var v61 := "jqob";
			v61 := if (v0) then v61 else v61;
			var v62: array<D16> := new D16[9];
			var v63 := 's';
			v62[safeIndex(436, v62.Length)] := DC45(v59.f24, v63, |v61|, v0);
			var v64 := DC45(|v61|, v63, v59.f24, false);
			var v65: map<bool, char> := map[v0 := v63];
			v62[safeIndex(436, v62.Length)] := v64.(cf80 := v59.f24).(cf78 := |v65| - fm1(v0, globalState), cf81 := v0);
			globalState.f1 := !v0;
		...
		r0 := match v75 {
			...
			case DC36(cf64) => safeModuloInt(v72, v72)
		};
		var v76: T0 := new C4();
	...
	method m2(p0: bool, globalState: GlobalState) {
		if (p0) {
			...
			var v1 := 0x2b5;
			var v2: set<int> := {v1};
			v0[safeIndex(753, v0.Length)] := v2 + v2;
			v0[safeIndex(753, v0.Length)] := v2 * v2;
			...
			if (p0) {
				...
				v12[safeIndex(592, v12.Length)] := p0 <==> p0;
				v12[safeIndex(592, v12.Length)] := v11.f23;
				var v13 := 0x3b2;
				var v14: seq<bool> := [false];
				v12[safeIndex(592, v12.Length)] := fm13(p0, 'q', v13, globalState) <= v14;
				...
				v16 := v16;
				var v17 := 's';
				var v18: map<int, bool> := map[|(seq(abs(356), i2  => (v17)))| := p0];
				var v19 := 0x14f;
				v17 := v16[safeIndex(if (p0) then |v18| else v19, |v16|)];
				var v20: array<map<string, int>> := new map<string, int>[3];
				var v21: map<string, int> := map["nmetnnr" := -v19];
				v20[safeIndex(317, v20.Length)] := v21;
				v20[safeIndex(317, v20.Length)] := v21;
				var v22: seq<bool> := [p0, p0, p0, DC40(p0).cf71, p0];
				var v23: multiset<bool> := multiset{p0};
				var v24: C6 := new C6();
				var v25: map<bool, C6> := map[p0 := v24];
				var v26: array<char> := new char[15] [fm29(p0, v19, v19, v22[safeIndex(|(fm12(v23, v19, globalState))[safeIndex(v19, |fm12(v23, v19, globalState)|) := v19]|, |v22|)], globalState), 'q', v17, v17, v17, v17, v17, 'v', v17, fm29(p0, |v25|, v19, p0, globalState), v17, v17, v17, v17, v17];
				v26, v16 := v26, v16;
			}
			...
			match (DC22(v27)) {
				case DC23(cf37, cf38, cf39, cf40, cf41) =>
					...
					v28 := v29[safeIndex(0x3af, |v29|)];
					globalState.f1 := p0;
					var v30: multiset<string> := multiset{cf38};
					cf40[safeIndex(916, cf40.Length)] := |v30[cf38 := abs(fm1(cf39, globalState))]|;
					var v31 := 133;
					var v32: seq<int> := [v31, v31];
					cf40[safeIndex(916, cf40.Length)] := -safeDivisionInt(v32[safeIndex(v31, |v32|)], v31);
				...
				case DC24(cf42, cf43) =>
					...
					v44[safeIndex(13, v44.Length)] := p0;
					v44[safeIndex(13, v44.Length)] := v38 < v38;
					v44[safeIndex(13, v44.Length)] := (v39 + v39) != v39;
				case DC22(cf36) =>
					var v45: array<bool> := new bool[3];
					v45[safeIndex(292, v45.Length)] := fm2(globalState);
					var v46 := 0x361;
					v45[safeIndex(292, v45.Length)] := fm1(true, globalState) < v46;
					var v47 := new C4();
					...
					v45 := if (p0) then if (p0) then v45 else v45 else v49[safeIndex(v46, |v49|)];
				case DC25(cf44) =>
					var v50 := 'h';
					v50 := v50;
					var v51 := new C6();
					...
					v52[safeIndex(995, v52.Length)] := v57;
					v52[safeIndex(995, v52.Length)] := v57;
					var v58: map<multiset<bool>, int> := map[multiset{p0} := v54];
					globalState.f6 := safeModuloInt(safeDivisionInt(v54, |v58|), v54);
			}
		...
		for i5 := |(v63 + v63)| to v62 - -0x43 {
			if (!p0) {
				...
				globalState.f1 := p0;
				globalState.f6 := 0x21e + -|(map v70 : int | (490 <= v70) && (v70 < 853) :: (safeDivisionInt(v70, v62)) := (p0))|;
			} else {
				var v71 := 'j';
				v71 := v71;
				var v72: set<int> := {-i5};
				...
				v63 := ((seq(abs(-148), i8  => (|v63|))) + v63)[safeIndex(|v73|, |((seq(abs(-148), i8  => (|v63|))) + v63)|) := v62 + i5];
				v62 := i5;
			}
			...
			var v84: array<int> := new int[29] [safeDivisionInt(v62, i5), v62, if (p0) then |fm31(v62, true, globalState)| else |map[v76.f18 := v62]|, -i5, v62, -i5, -0x33d, v62, v62, i5, safeDivisionInt(i5, v62), i5 * v62, i5, 0x1cd, |multiset(v81)|, v76.f19, |fm28(v62, v76.f18, true, globalState)|, -899, safeModuloInt(i5, i5), |v82|, safeDivisionInt(v76.f19, i5), i5, v76.f19, i5, |v83[safeIndex(i5, |v83|)]|, i5, safeDivisionInt(-v62, 673), v62, i5];
			globalState.f9 := v84;
			globalState.f1 := p0;
		}
		...
		for i9 := v62 to |v86| {
			...
			v87[safeIndex(357, v87.Length)] := if (p0) then v62 else i9;
			v87[safeIndex(357, v87.Length)] := i9;
			var v88: seq<bool> := [fm2(globalState)];
			v62 := safeModuloInt(|v88|, i9);
			var v90 := 'o';
			var v91: set<bool> := {fm2(globalState), p0, p0};
			var v92: map<map<char, int>, bool> := map[map v89 : char | v89 in map[v90 := p0] :: (v89) := (|{p0}|) := v91 > v91];
			var v93: map<char, int> := map[v90 := v87[safeIndex(357, v87.Length)]];
		...
		v100[safeIndex(802, v100.Length)] := v62;
		var v101: C4 := new C4();
		var v102: map<int, C4> := map[|v63| := v101];
		v100[safeIndex(802, v100.Length)] := |[if (v62 in v102) then v102[v62] else v101]|;
		...
		v103, v62 := if (!(p0 && p0)) then v103 else fm13(fm2(globalState), v104, v62, globalState), safeDivisionInt(v63[safeIndex(|v106|, |v63|)], v100[safeIndex(802, v100.Length)]);
	}
	method m7(globalState: GlobalState) {
		...
		v8, v0 := safeDivisionInt(0xd, -v8), v0 && v0;
		globalState.f6 := -335;
		...
		if (false) {
			...
			v18 := if ((v8 - v8) in v19) then v19[v8 - v8] else v20[safeIndex(v8, |v20|)];
			var v21 := new C5(v8);
		} else {
			...
			var v28: map<seq<int>, char> := map[seq(abs(0x7d), i1  => (|v24|)) := 'o'];
			...
			v29[safeIndex(974, v29.Length)] := v23;
			v29[safeIndex(974, v29.Length)] := v23;
			var v30 := DC35();
			v30 := v30;
			var v31: array<bool> := new bool[24];
			v31[safeIndex(680, v31.Length)] := v0;
			v31[safeIndex(680, v31.Length)] := v0;
		}
...
class C8 {
	...
	function fm6(p0: bool, p1: int, globalState: GlobalState): int {
		safeModuloInt(-572, |map[0x367 := 0x211]|)
	}
	...
	method m5(globalState: GlobalState) returns (r0: int, r1: string, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			var v8: seq<int> := [v5];
			v0 := !!!v7[safeIndex(v8[safeIndex(v5, |v8|)], |v7|)];
			...
			v5 := safeDivisionInt(|"lxvm"|, |v7|);
			var v14: multiset<bool> := multiset{v0, v0};
			var v15: multiset<multiset<bool>> := multiset{v14, v14, v14[v0 := abs(v5)], v14};
			var v16 := new C5(|v15|);
		}
		var v17 := "jkeuhyxcb";
		r1 := (seq(abs(334), i1  => ('s'))) + v17;
		...
		for i2 := v5 - |multiset{v18}| to |v19| + v5 {
			if (v0) {
				...
				var v24 := new C2(|v20| - |v20|, safeDivisionInt(0x118, v5), map[v23 := v5]);
				globalState.f6 := fm6(v0 <==> !v0, |v17|, globalState);
				var v25: set<int> := {v5};
				v21 := fm29(v20[safeIndex(v20[safeIndex(v24.f21, |v20|)], |v20|)] <= v5, |v20|, v24.f21, v25 >= v25, globalState);
				...
				v26[safeIndex(344, v26.Length)] := v18;
				var v27: map<bool, array<bool>> := map[fm2(globalState) := v18];
				v26[safeIndex(344, v26.Length)] := if ((|map[v0 := v0]| <= v5) in v27) then v27[|map[v0 := v0]| <= v5] else v18;
				var v28: map<bool, bool> := map[if (v0) then !v0 else v0 := v0];
				v28 := v28[v0 := v0];
				var v29: array<int> := new int[17];
				v29[safeIndex(181, v29.Length)] := v5;
				v29[safeIndex(795, v29.Length)] := -fm6(!v0, i2, globalState);
				v18[safeIndex(783, v18.Length)] := -v5 >= v5;
				v29[safeIndex(181, v29.Length)], v29[safeIndex(795, v29.Length)], globalState.f6, v18[safeIndex(783, v18.Length)], v5 := i2, i2, v5 - v5, !v0, i2;
			}
		...
		v37 := v37[v34 := v36];
		r0 := v5 * safeModuloInt(v5, v5);
		var v38 := DC14(map[-|v17| := v36]);
		r1 := match v38 {
			case DC14(cf19) => v17
		};
		var v39: seq<bool> := [v0];
		r2 := !((v0 || v0) <== v39[safeIndex(v5, |v39|)]);
	}
	method m6(p0: bool, p1: bool, globalState: GlobalState) {
		var v0 := 150;
		var v1: seq<int> := [v0];
		var v2 := DC28(|v1|);
		for i0 := safeDivisionInt(v0, v2.cf51) to -0x10e {
			var v3 := new C5(v0);
			...
			if (p0) {
				...
				v7[safeIndex(702, v7.Length)] := v6;
				v7[safeIndex(702, v7.Length)] := 'a';
				var v8: array<int> := new int[29](i1 => safeDivisionInt(i1, v0));
				var v9 := DC6(v8);
				...
				var v17: map<int, multiset<int>> := map[i0 := v16[safeIndex(v5.f24, |v16|)]];
				...
				var v33: array<bool> := new bool[15] [v19 != v19, !p1, p0, v23.f23, v23.fm17(v5.f24, v0, p0, globalState), true, v3.f16 < v3.f16, p0, !v23.f23, (seq(abs(0x146), i2  => ('y'))) < v19, v23.f23, fm2(globalState), v23.f23, !(false !in v28), !((set v29 : int | (0x88 <= v29) && (v29 < 0x3ca) :: (safeModuloInt(v29, |multiset{0x198}|))) !! v32)];
				var v34: seq<bool> := [p1];
				v33[safeIndex(699, v33.Length)] := v34 == v34;
				v33[safeIndex(699, v33.Length)] := i0 <= safeDivisionInt(-v3.f16, v0);
		...
		v44[safeIndex(956, v44.Length)] := v0;
		var v45 := 'm';
		v44[safeIndex(956, v44.Length)] := |(v40 + v40)[safeIndex(v0, |(v40 + v40)|) := v45]|;
		var v46: array<T1> := new T1[5];
		var v47: map<int, bool> := map[v0 := p0];
		var v48: map<map<int, bool>, int> := map[v47 := v44[safeIndex(956, v44.Length)]];
		var v49: T1 := new C2(v0, |v1|, v48);
		v46[safeIndex(261, v46.Length)] := v49;
		v46[safeIndex(261, v46.Length)] := v49;
		for i3 := safeModuloInt(|(set v50 : int | (426 <= v50) && (v50 < 0x29c) :: (safeModuloInt(v50, v44[safeIndex(956, v44.Length)])))|, v0) to v44[safeIndex(956, v44.Length)] {
			var v51: array<string> := new string[7] [v40, v40, if (true) then v40[safeIndex(|"io"|, |v40|) := 'g'] else v40, seq(abs(504), i4  => ('s')), v40, v40 + fm21(globalState), "n"];
			v51 := v51;
			globalState.f6 := v0;
			var v52 := new C7();
			var v53: map<int, map<bool, int>> := map[v44[safeIndex(956, v44.Length)] := v38];
			var v55 := DC57(map v54 : int | (-0x1a2 <= v54) && (v54 < -301) :: (safeDivisionInt(v54, v44[safeIndex(956, v44.Length)])) := (DC5(v1)));
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			globalState.f6 := v44[safeIndex(956, v44.Length)] + v44[safeIndex(956, v44.Length)];
			var v56 := new C2(fm1(v39[safeIndex(v44[safeIndex(956, v44.Length)], |v39|)], globalState), |(map[v0 := |v1|] + map[v0 := v0])|, v48 + v49.f17);
			var v58: map<bool, bool> := map[!p0 := p0];
			globalState.f1 := v56.f21 !in ((set v57 : int | (0x4e <= v57) && (v57 < 0x13b) :: (v57 + |v40|)) - {|v58|});
			var v59 := DC5([v56.f21]);
			globalState.f6, v44[safeIndex(956, v44.Length)] := v44[safeIndex(956, v44.Length)], v56.fm15(globalState) - -|v59.cf5|;
		}
	}
}
...
class C9 extends T0 {
	...
	function fm4(p0: int, globalState: GlobalState): bool {
		(DC1(f15).cf1 + |(seq(abs(892), i0  => (f15)))|) <= (|map[-f15 := true]| - --f15)
	}
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v6: seq<int> := [|v5|, safeModuloInt(781, -|v1|), f15 + v4, f15];
			v6 := [|(multiset(v1))[v2 := abs(-v4)]|, --v4, if (v2) then f15 else f15];
			var v7 := new C5(f15);
		...
		for i1 := -|(v10 + v10)| to f15 {
			...
			if (v0) {
				v19[safeIndex(476, v19.Length)] := i1;
				v19[safeIndex(476, v19.Length)] := safeModuloInt(i1, i1 - f15);
				r1 := v0;
				var v20 := 'y';
				...
				v24 := v24[v20 := v23];
				v19[safeIndex(476, v19.Length)] := v19[safeIndex(476, v19.Length)];
			} else {
				r1 := {i1, i1, fm1(v0, globalState)} > v15;
				var v25 := new C5(f15 * i1);
				var v26: seq<int> := [i1, i1, v25.f16];
				globalState.f6 := i1 - v26[safeIndex(i1, |v26|)];
				var v27 := 'p';
		...
		if (v29[safeIndex(f15, |v29|)]) {
			var v30: array<int> := new int[12](i3 => safeDivisionInt(i3, f15));
			var v31: array<bool> := new bool[24];
			...
			if (v0) {
				...
				var v34: C4 := new C4();
				v33[safeIndex(625, v33.Length)] := v34;
				var v35 := "wlaqsdmhf";
				var v36 := DC60(v34);
				v33[safeIndex(625, v33.Length)], globalState.f1, v35 := v36.cf100, v0, v35;
				...
				v28 := seq(abs(0x19f), i4  => (f15));
				var v41: set<int> := {-f15, -f15};
				globalState.f6 := |v41| * f15;
				var v42: array<string> := new string[26];
				var v43 := "eioyj";
				v42[safeIndex(752, v42.Length)] := v43;
				v42[safeIndex(752, v42.Length)] := "sewysnmpc";
				v43 := "udky";
				var v44, v45, v46 := m3([v0], globalState);
			}
			
			r0 := v28[safeIndex(safeDivisionInt(f15, -890), |v28|)];
		} else {
			var v47: T0 := new C4();
			var v48: seq<T0> := [v47];
			v9 := v9[v0 := f15 != |v48[safeIndex(v28[safeIndex(f15, |v28|)], |v48|) := v47]|];
			var v49 := "hutlw";
			var v50: seq<seq<bool>> := [v29];
			globalState.f6 := (f15 + |v49|) - |v50[safeIndex(f15, |v50|)]|;
			var v51: array<array<bool>> := new array<bool>[28];
			var v52: array<bool> := new bool[16];
			v51[safeIndex(893, v51.Length)] := v52;
			v51[safeIndex(893, v51.Length)] := v52;
			var v53: C4 := new C4();
			var v54 := DC40(v0);
			var v55 := DC41(v54);
			...
			v51[safeIndex(893, v51.Length)][safeIndex(124, v51[safeIndex(893, v51.Length)].Length)] := v0;
			var v59 := 'b';
			var v60: multiset<char> := multiset{v59};
			v51[safeIndex(893, v51.Length)][safeIndex(124, v51[safeIndex(893, v51.Length)].Length)] := (fm46(!v0, true, v0, v0, globalState) - v60) < v60;
		}
		
		var v61: array<bool> := new bool[25](i5 => v0);
		v61[safeIndex(287, v61.Length)] := true;
		var v62: map<int, bool> := map[f15 := v0];
		var v63 := DC44(multiset(v29));
		var v64: seq<D16> := [v63, v63];
		v61[safeIndex(287, v61.Length)], v62, r1 := v0, v62 + v62, [v63, v63] != (v64 + (seq(abs(0x1f4), i6  => (DC44(multiset{v0})))));
		...
		var i8 := 0;
		while (if (v61[safeIndex(287, v61.Length)]) then v0 else (if (v0 in v68) then v68[v0] else multiset{v66, v66}) > multiset(v69))
			decreases 100 - i8
		{
			if (i8 >= 100) {
				break;
			...
			i8 := i8 + 1;
			var v70: multiset<bool> := multiset{false, v61[safeIndex(287, v61.Length)], v61[safeIndex(287, v61.Length)]};
			var v71: seq<multiset<bool>> := [multiset(v29) + v70, v70, v70, v70];
			globalState.f6, v71 := if (false) then 0x1c8 else f15, ([multiset{v61[safeIndex(287, v61.Length)]}] + v71)[safeIndex(f15 + f15, |([multiset{v61[safeIndex(287, v61.Length)]}] + v71)|) := v70 * v70];
			v65[safeIndex(991, v65.Length)] := f15;
			v65[safeIndex(991, v65.Length)] := safeDivisionInt(f15, -f15) - f15;
			var v72: seq<array<bool>> := [v61];
			r0 := |(v72 + (([v61, v61, v61])[safeIndex(f15, |[v61, v61, v61]|) := v61])[safeIndex(f15, |([v61, v61, v61])[safeIndex(f15, |[v61, v61, v61]|) := v61]|) := v61])|;
			v61[safeIndex(287, v61.Length)] := v0 !in [true];
		}
		r0 := f15;
		r1 := v61[safeIndex(287, v61.Length)];
	}
	method m2(p0: bool, globalState: GlobalState) {
		...
		if (p0) {
			...
			var v7 := DC9(v6);
			var v8: set<D4> := {v7};
			var v9: multiset<bool> := multiset{p0, p0, v5[safeIndex(|v8|, |v5|)], p0, p0};
			...
			if (v9 > v9) {
				...
				var v17: C7 := new C7();
				var v18: seq<C7> := [v17];
				var v19: multiset<int> := multiset{|(seq(abs(0xbf), i0  => (v13)))|, f15};
				var v20: multiset<C7> := multiset{v17, v18[safeIndex(|v19|, |v18|)]};
				var v21: array<seq<array<bool>>> := new seq<array<bool>>[27] [[v0], v15, v15, v15, v15, v15, v15, [v0, v0], if ((if (v17 in v20) then v20[v17] else f15) in v16) then v16[if (v17 in v20) then v20[v17] else f15] else v15, v15 + v15, [v0] + v15, v15, v15, v15, [v0, v0, v0, v0], v15 + v15, v15 + v15[safeIndex(f15, |v15|) := v0], v15, v15, v15, v15, v15, if (p0) then v15 else v15, v15 + v15, ([v0, v0, v0, v0, v0] + v15)[safeIndex(0x17c, |([v0, v0, v0, v0, v0] + v15)|) := v0], v15, v15[safeIndex(f15, |v15|) := v0] + v15];
				v21[safeIndex(388, v21.Length)] := if (p0) then v15 else v15;
				var v22: array<map<int, char>> := new map<int, char>[26];
				var v23: map<int, char> := map[|v4| := v13];
				v22[safeIndex(446, v22.Length)] := v23 + (map v24 : int | (0xa3 <= v24) && (v24 < 0x30d) :: (safeModuloInt(v24, |v19|)) := (v13));
				...
				var v36: array<char> := new char[25] ['n', v13, v13, v13, v13, v14[safeIndex(|(seq(abs(0x227), i1  => (v13)))|, |v14|)], v13, v13, v13, 'p', v13, v13, v13, v13, 'b', v13, v13, v13, v13, v13, fm29(false, |v28[safeIndex(f15, |v28|) := v27]|, if (v13 in v26) then v26[v13] else f15, p0, globalState), v13, v13, v13, v35.cf41];
				v25[safeIndex(195, v25.Length)] := v36;
				v21[safeIndex(388, v21.Length)], v7, v13, v22[safeIndex(446, v22.Length)], v25[safeIndex(195, v25.Length)] := v15, v7, v13, v23 + v23[f15 := v13], v36;
				globalState.f1 := v5[safeIndex(f15, |v5|)];
			} else {
				globalState.f1 := p0;
			...
			match (DC12(f15, p0, v44).(cf17 := v44, cf16 := v45 >= v45)) {
				case DC11(cf14) =>
					...
					var v51: seq<bool> := [p0];
					v50[safeIndex(314, v50.Length)] := safeModuloInt(|v51|, cf14);
					var v52: set<bool> := {fm2(globalState), p0};
					var v53: map<bool, set<bool>> := map[fm2(globalState) := v52];
					var v54 := DC0(p0);
					var v55: seq<set<int>> := [v47, v47];
					var v56: map<set<int>, int> := map[v55[safeIndex(cf14, |v55|)] := -|v51|];
					var v57: multiset<set<bool>> := multiset{v52};
					v50[safeIndex(314, v50.Length)], globalState.f1, globalState.f9, v53, v54 := (if (v47 in v56) then v56[v47] else cf14) - (if (v52 in v57) then v57[v52] else 0x13e), p0, v50, v53, v54;
				case DC12(cf15, cf16, cf17) =>
					...
					var v68: map<map<int, bool>, int> := map[v67[safeIndex(cf15, |v67|)] := 425];
				...
				case DC10(cf13) =>
					...
					v76[safeIndex(833, v76.Length)] := f15;
					v76[safeIndex(833, v76.Length)] := -f15;
					globalState.f1 := p0;
					var v77 := "do";
					v76[safeIndex(833, v76.Length)] := |(if (p0) then v77 else "ecflprnxd")|;
				case DC13(cf18) =>
					...
					m0(if (!false) then v78 else v78, v84[safeIndex(f15, |v84|)], v85, v81, globalState);
					var v86 := DC6(v85);
					...
					v85[safeIndex(660, v85.Length)] := f15;
					v85[safeIndex(660, v85.Length)] := f15;
					var v89 := new C6();
			}
			...
			v0[safeIndex(467, v0.Length)] := !p0;
			v0[safeIndex(467, v0.Length)] := fm2(globalState);
			var v100 := new C7();
		}
			...
			decreases 100 - i4
		{
			...
			v101[safeIndex(636, v101.Length)] := fm49(!p0, globalState);
			var v102: map<bool, int> := map[p0 := f15];
			var v103 := DC9(v102);
			v101[safeIndex(636, v101.Length)] := v103.(cf12 := v102);
			var v104 := 'a';
			...
			v111[safeIndex(234, v111.Length)] := v106;
			v111[safeIndex(234, v111.Length)] := v106;
			globalState.f6 := f15;
			globalState.f1 := fm2(globalState);
		}
	...
	method m3(p0: seq<bool>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		var v0: seq<int> := [f15];
		var v1: map<int, int> := map[|p0| * |v0| := safeModuloInt(f15, f15)];
		var v2 := "d";
		v1 := v1[f15 := |v2|];
		var v3 := true;
		if (v3) {
			...
			v0 := v0;
			var v4: array<int> := new int[7](i0 => safeModuloInt(i0, f15));
			var v5 := DC6(v4);
			...
			var v13: array<bool> := new bool[27] [v10.f23, v10.f23, !(v10.f23 || v3), v3 || !false, v3, v10.f23, !(if (v10.f23) then v3 else v3), !v10.f23, v3 || v3, true, !v10.f23, (multiset(v0))[|p0| := abs(if (f15 in v1) then v1[f15] else f15)] != multiset{f15}, v3, v3 <== v3, v10.fm17(-0x241, 982, v10.f23, globalState), f15 != f15, v3, v11.cf60 !in {f15}, if (v10.f23) then v10.f23 else v3, f15 > |p0|, fm2(globalState), fm4(|[f15, |v12|]|, globalState), f15 <= |v2|, !(f15 < |map[|v0| := v10.f23]|), v3 && v3, v10.f23, false];
			v13[safeIndex(782, v13.Length)] := v10.f23 ==> v3;
			var v14 := DC50(v3, f15, f15, v3, v10.f23);
			v13[safeIndex(782, v13.Length)] := v14.cf90;
			var v15: array<string> := new string[10] [v2, v2 + fm21(globalState), seq(abs(255), i1  => ('j')), fm21(globalState), if (v10.f23) then v2 else "togmll", v2, "xvnvbtp", v2 + v2, v2, v2];
			var v16 := 'k';
			...
			var v22 := DC40(v13[safeIndex(782, v13.Length)]);
			var v23: multiset<bool> := multiset{v10.f23, v13[safeIndex(782, v13.Length)], v3, if (v3 in v21) then v21[v3] else v22.cf71, v10.f23};
			v15, globalState.f6, globalState.f6, globalState.f6, v16 := v15, f15, if (|v17| >= |v18|) then safeModuloInt(256, |v2[safeIndex(f15, |v2|) := v16]|) else safeModuloInt(f15, |v20|), if ((v2 != "pbpuyrmd") in v23) then v23[v2 != "pbpuyrmd"] else f15, v16;
		} else {
			globalState.f1 := v3;
			r1 := !v3;
			var v24: array<D16> := new D16[29];
			v24[safeIndex(4, v24.Length)] := DC44(multiset{false, v3, v3});
			var v25: multiset<bool> := multiset{v3, v3};
			var v26 := DC44(v25);
			r2, globalState.f6, v24[safeIndex(4, v24.Length)], r2, v2 := f15 * (-fm1(v3, globalState) - |v0|), f15, v26, -f15, if (v3) then v2 else "orpgjwi";
			if ((f15 - f15) < f15) {
				var v27 := new C6();
				...
				var v32 := 'j';
				var v33: array<int> := new int[6] [safeModuloInt(f15, f15), if (!!v3) then |v31| else f15, f15 + v27.fm9([v32, v32], globalState), -v0[safeIndex(f15, |v0|)], f15, |v25|];
				v33[safeIndex(303, v33.Length)] := |v2|;
				v33[safeIndex(303, v33.Length)] := 0x85;
				v32 := v32;
				var v34: map<bool, char> := map[v3 := 'u'];
				var v35: map<bool, bool> := map[v3 := v3];
				v34, v33[safeIndex(303, v33.Length)], globalState.f1, v2 := v34, -|"rsimrwma"| * v33[safeIndex(303, v33.Length)], if (!!v3 in v35) then v35[!!v3] else v3, v2;
			} else {
				globalState.f1 := v3 !in v25;
				var v36: array<bool> := new bool[3];
				v36[safeIndex(171, v36.Length)] := v3;
				v36[safeIndex(171, v36.Length)] := v3;
				var v37 := new C4();
				var v38: array<int> := new int[18];
				v38[safeIndex(128, v38.Length)] := f15;
				var v39: C5 := new C5(f15);
				var v40: map<multiset<bool>, C5> := map[v25 := v39];
				v38[safeIndex(128, v38.Length)] := |(v40 + v40)|;
				globalState.f6 := -(690 + |((seq(abs(-0x1ad), i2  => (map[v36[safeIndex(171, v36.Length)] := v3]))) + fm50(v39.f16, -868, globalState))|);
			}
			
			var v41: array<bool> := new bool[9](i3 => v3);
			v41[safeIndex(203, v41.Length)] := v3;
			r1, v41[safeIndex(203, v41.Length)] := !v3, !v3;
		}
		
		for i4 := f15 to -f15 {
			var v42: array<int> := new int[18](i5 => i5 - -f15);
			var v43 := 'j';
			v42[safeIndex(710, v42.Length)] := safeDivisionInt(f15, -|v2[safeIndex(i4, |v2|) := v43]|);
			var v44: map<bool, int> := map[v3 := i4];
			v42[safeIndex(710, v42.Length)] := |v44| - |v2|;
			v2, globalState.f1, v2, r1, r2 := ((if (v3) then v2 else v2) + v2)[safeIndex(|(v2 + v2)|, |((if (v3) then v2 else v2) + v2)|) := v43], v3, v2, v3, f15;
			var v45: map<bool, bool> := map[v3 := v3];
			var v46 := DC3(v45);
			match (v46) {
				case DC4(cf4) =>
					var v47: map<bool, string> := map[false := v2];
					v2 := if (v3) then "nhk" + "fiwsofh" else (if (v3 in v47) then v47[v3] else seq(abs(0x2d0), i6  => (cf4)))[safeIndex(f15, |(if (v3 in v47) then v47[v3] else seq(abs(0x2d0), i6  => (cf4)))|) := cf4];
					var v48 := new C4();
					var v49: seq<array<int>> := [v42];
					globalState.f6 := -((v42[safeIndex(710, v42.Length)] * |v49|) * 0x28b);
				...
				case DC3(cf3) =>
					...
					v53[safeIndex(804, v53.Length)] := v3;
					var v54: array<array<bool>> := new array<bool>[5] [v53, v53, v53, v53, v53];
					var v55: map<bool, array<bool>> := map[fm2(globalState) := v53];
					v54[safeIndex(196, v54.Length)] := if (v3 in v55) then v55[v3] else v53;
					v52, v53[safeIndex(804, v53.Length)], v54[safeIndex(196, v54.Length)], v42[safeIndex(710, v42.Length)] := v52, |v51| == (f15 - i4), v53, |v2| * -fm1(true, globalState);
					var v56: array<array<int>> := new array<int>[19] [v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42];
					v56 := v56;
					var v57: multiset<array<bool>> := multiset{v53, v54[safeIndex(196, v54.Length)], v53, v54[safeIndex(196, v54.Length)]};
					r2, r1 := v42[safeIndex(710, v42.Length)], v57 >= v57;
			}
			
			var v58: multiset<bool> := multiset{v3, v3, v3, v3, v3};
			var v59: map<int, multiset<bool>> := map[v42[safeIndex(710, v42.Length)] := v58];
			var v60 := DC50(!v3, f15, v42[safeIndex(710, v42.Length)], v3, !(v43 !in v2));
			var v61: map<bool, map<int, multiset<bool>>> := map[v3 := v59];
			var v62: array<bool> := new bool[29] [v3, v3, v3, v3, v3, p0[safeIndex(f15, |p0|)], v3, true, v3, false, v3, !v3, v3, v3, true, v3, !v3, true, v3, v3, false, v3, v3, !v3, v3, v3, v3, v3, v3];
			var v63: array<array<bool>> := new array<bool>[27];
			var v64: seq<array<array<bool>>> := [v63, v63];
			var v65 := DC10(v64[safeIndex(-v42[safeIndex(710, v42.Length)], |v64|)]);
			var v66: map<array<bool>, D5> := map[v62 := v65];
			var v67: map<int, bool> := map[v42[safeIndex(710, v42.Length)] := v3];
			var v68 := DC1(f15);
			v59, v60, v44, v44 := (if (!v3 in v61) then v61[!v3] else fm51(-0x159, globalState))[|(v66 + v66)| := v58], DC50(!v3, i4, f15, i4 !in v67[v42[safeIndex(710, v42.Length)] := v3], !!(false <==> false)), v44 + v44, map[v3 := v68.cf1];
		}
		...
		match (fm52(v70, f15, globalState)) {
			case DC7(cf7) =>
				...
				v71[safeIndex(37, v71.Length)] := v3;
				var v72: multiset<string> := multiset{v2, v2, v2, v2};
				v71[safeIndex(37, v71.Length)] := v72 !! (if (v3) then v72 else v72);
				v3 := v71[safeIndex(37, v71.Length)];
				var v73: set<int> := {fm1(true, globalState), cf7};
				var v75: seq<set<int>> := [v73, set v74 : int | (616 <= v74) && (v74 < 728) :: (v74 - cf7), v73 - v73, v73];
				v75 := (v75 + (seq(abs(0x2f3), i9  => (v73)))) + v75;
				r0 := !v3;
			case DC8(cf8, cf9, cf10, cf11) =>
				var v76: set<int> := {f15, f15};
				var v77: map<bool, set<int>> := map[f15 == -0x3d0 := v76];
				v77 := v77[fm2(globalState) := set v78 : int | (0x2a <= v78) && (v78 < 0x177) :: (safeModuloInt(v78, |p0|))];
				r2 := f15;
				cf9 := "wxctkag";
			...
			case DC6(cf6) =>
				...
				v85 := v86[safeIndex(--0x19d, |v86|)];
				cf6[safeIndex(823, cf6.Length)] := |v2|;
				cf6[safeIndex(823, cf6.Length)] := f15;
				var v87: C6 := new C6();
				v87 := v87;
		}
		...
		match (v93) {
			case DC11(cf14) =>
				if (v89) {
					...
					v94[safeIndex(76, v94.Length)] := v96 + v96;
					v94[safeIndex(76, v94.Length)] := [v95, v95, v95 + v95];
					var v97: array<string> := new string[8];
					v97[safeIndex(876, v97.Length)] := v2;
					v97[safeIndex(876, v97.Length)] := if (true) then "mltwv" + v2 else v2[safeIndex(cf14, |v2|) := v92];
					...
					v100 := (map[|v97[safeIndex(876, v97.Length)]| := v92] + fm54(v95, globalState)) + v100;
				} else {
					var v101: set<bool> := {v90, !(if (v90) then v89 else false)};
					var v102: array<map<char, int>> := new map<char, int>[1] [map['v' := f15]];
					var v103: multiset<int> := multiset{|v2|, |("qyropc")[safeIndex(f15, |"qyropc"|) := v92]|, cf14};
				...
				if (v3 || (v105 < v105)) {
					...
					var v109: C6 := new C6();
					var v110: map<int, C6> := map[safeDivisionInt(cf14, cf14) := v109];
					v110 := v110;
					var v111: multiset<int> := multiset{safeModuloInt(cf14, -0x152), safeDivisionInt(cf14, |p0|), safeDivisionInt(f15, f15)};
					v111 := v111;
				...
				var v118: array<int> := new int[24] [|v114| * f15, cf14, |v0|, f15, |p0| - f15, cf14, cf14, cf14, f15, safeDivisionInt(-0x351, f15), cf14, -0x115, cf14, |(v115[safeIndex(f15, |v115|)] + (seq(abs(265), i10  => (f15))))|, cf14, cf14, |v116|, if (false in v117) then v117[false] else -f15, |(v105 - v105)|, cf14, cf14, cf14 - cf14, 0x163, f15];
				v118[safeIndex(508, v118.Length)] := f15;
				v118[safeIndex(508, v118.Length)] := cf14;
				v69 := v69;
			case DC12(cf15, cf16, cf17) =>
				var v119 := new C8();
				...
				var v123: array<bool> := new bool[24] [true, v89, true || !!v3, v90, true, v89 || v90, v89 && v90, v120 > multiset{'h', fm29(v89, |v69|, f15, v3, globalState), cf17, fm29(fm2(globalState), v93.cf15, f15, v90, globalState), cf17}, v3, cf16, p0[safeIndex(|map[cf16 := f15]|, |p0|)], cf16, !(fm2(globalState) <==> v89), v121.cf86, cf16, cf16, cf16, (if (cf16 in v122) then v122[cf16] else cf15) >= f15, v90, v89, v3 && cf16, cf16 <== v90, v89, v3];
				v123[safeIndex(321, v123.Length)] := v3;
				v123[safeIndex(321, v123.Length)] := cf16;
				...
				match (v125) {
					case DC7(cf7) =>
						...
						var v129 := DC4(v92);
						v129 := v129;
						var v130 := DC7(v0[safeIndex(-0x389, |v0|)]);
					...
					case DC6(cf6) =>
						r1, v90 := v89 <==> v89, v89;
						var v134 := new C1(f15);
						v123[safeIndex(321, v123.Length)] := v134.fm24(cf16, fm39(v90, globalState), globalState);
						var v135: array<map<bool, D5>> := new map<bool, D5>[8];
						v135 := v135;
				}
				
				var v138: seq<seq<int>> := [v0];
				var v139: map<map<int, bool>, int> := map[map[cf15 := v123[safeIndex(321, v123.Length)]] := f15];
				var v140: T1 := new C3(v123[safeIndex(321, v123.Length)], f15, v139);
				var v141: set<T1> := {v140, v140};
				var v142: map<bool, set<int>> := map[false := {cf15}];
				var v143: map<bool, bool> := map[|(map v136 : int | v136 in (map v137 : int | v137 in v138[safeIndex(|v141|, |v138|)] :: (v137 + cf15) := (v123[safeIndex(321, v123.Length)])) :: (v136 * f15) := (|v2|))| <= |v91| := (if (v90 in v142) then v142[v90] else {|v2|}) >= v91];
				v123[safeIndex(321, v123.Length)] := if (v3 in v143) then v143[v3] else v3;
			case DC10(cf13) =>
				globalState.f6 := |((v0 + v0[safeIndex(f15, |v0|) := f15]) + (v0 + (seq(abs(-720), i11  => (f15)))))|;
				v91 := v91;
				if (v90) {
					...
					var v148 := new C2(0x47, safeModuloInt(|v146|, f15), v147);
					...
					v152[safeIndex(446, v152.Length)] := v89;
					var v153: array<array<D7>> := new array<D7>[26];
					var v154 := DC26(v153);
					var v155: set<D10> := {v154, v154, DC26(v153), v154};
					v152[safeIndex(446, v152.Length)] := v155 <= v155;
					var v156: array<int> := new int[20];
					v156[safeIndex(127, v156.Length)] := f15;
					v156[safeIndex(127, v156.Length)] := f15;
					v156[safeIndex(127, v156.Length)] := f15;
					r2 := safeDivisionInt(v156[safeIndex(127, v156.Length)], |(seq(abs(-0x3c2), i13  => (v92)))|);
					globalState.f6 := safeModuloInt(v156[safeIndex(127, v156.Length)], |v2|);
				}
			...
			case DC13(cf18) =>
				if (v3) {
					...
					var v161: seq<string> := [v160[safeIndex(f15, |v160|)], v2, fm21(globalState), v2];
					var v162 := DC21(v160[safeIndex(f15, |v160|)], v157);
					v162 := v162;
					v158[safeIndex(984, v158.Length)] := f15;
					var v163: map<int, bool> := map[f15 := !v90];
					v158[safeIndex(984, v158.Length)] := f15 * |v163|;
					var v164 := new C7();
				} else {
					...
					globalState.f9, v166, globalState.f1, v90 := v167, v166, p0[safeIndex(v0[safeIndex(-491, |v0|)], |p0|)], !(f15 > 727);
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool) {
		for i0 := f15 to f15 {
			if (if (p0) then fm2(globalState) else p0) {
				...
				v0[safeIndex(557, v0.Length)] := !p0;
				v0[safeIndex(557, v0.Length)] := false;
				var v1: seq<bool> := [p0, v0[safeIndex(557, v0.Length)], v0[safeIndex(557, v0.Length)], !p0, v0[safeIndex(557, v0.Length)]];
				v1 := v1;
				globalState.f1 := v0[safeIndex(557, v0.Length)];
				r1 := p0;
			} else {
				var v2: map<int, bool> := map[i0 := p0];
				var v3: map<int, map<int, bool>> := map[f15 := v2];
				var v5: map<map<int, bool>, int> := map[if (-i0 in v3) then v3[-i0] else map v4 : int | (0x2d8 <= v4) && (v4 < 0xbe) :: (safeModuloInt(v4, f15)) := (p0) := i0];
				...
				var v10: array<int> := new int[9] [512, v6.f19, f15 + i0, 0x2d9, safeModuloInt(i0, i0), 0x9a, i0, |fm12(v9, 0x2f7, globalState)|, v6.f19];
				var v11 := "tviyhhlfk";
				v10[safeIndex(13, v10.Length)] := |["mpbabn", v11]|;
				v10[safeIndex(13, v10.Length)] := safeModuloInt(f15, fm5(!p0, globalState));
				var v12: map<int, int> := map[v10[safeIndex(13, v10.Length)] := f15];
				...
				globalState.f6 := |(seq(abs(0x3d5), i2  => ('x')))|;
			}
			...
			v16[safeIndex(46, v16.Length)] := v17;
			v16[safeIndex(46, v16.Length)] := v17;
			globalState.f1 := p0;
		}
		globalState.f6 := f15;
		...
		var v21: array<seq<int>> := new seq<int>[18] [v18, v18, [f15, f15, f15, 0x3e2], v18, v18, v19[safeIndex(-0x1d9, |v19|)], seq(abs(340), i4  => (0x29e)), v18, v18, v18, v18, v18, if (f15 in v20) then v20[f15] else v18, v18, [f15, |"doh"|], v18, v18, v18];
		var v22 := "osjud";
...
function fm0(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<int, bool> {
	(map[|"clrpyqdpw"| := false] + map[|(seq(abs(0x382), i0  => (|[-0xa5, |{false, false}|, |map[|[true]| := false]|, 0x24e]|)))| := true]) + (map v0 : int | v0 in [|"qjcdhou"|] :: (v0 - |map['h' := true]|) := (!true))
}
function fm1(p0: bool, globalState: GlobalState): int {
	if (false) then -(|map[|[DC45(--0x50, 'o', 808, true).cf79, 'k', 'o', 'j']| := |(seq(abs(0x361), i0  => ('b')))|]| * |[false, !true]|) else |(seq(abs(0x30d), i1  => ('h')))| - 0x38
}
...
function fm12(p0: multiset<bool>, p1: int, globalState: GlobalState): seq<int> {
	((seq(abs(-895), i0  => (|map[|"xvso"| := |[true]|]|))) + [|(seq(abs(251), i1  => ('l')))|, -0x270]) + [789, 0xfd]
}
...
function fm20(p0: int, globalState: GlobalState): multiset<seq<bool>> {
	match DC36(map v0 : D7 | v0 in [DC16(true, -|(seq(abs(0x199), i0  => ('u')))|, !!false), DC16(true, -0x120, false)] :: (v0) := ("hsvfptg")) {
		case DC37(cf65, cf66) => multiset{[cf66, cf66], [cf66, cf65, cf66], [cf65, cf65, cf65, cf66], [cf65]}
		case DC36(cf64) => multiset((seq(abs(-0x20e), i1  => ([false]))) + [[!true, !true]])
	}
}
...
function fm22(p0: bool, p1: bool, globalState: GlobalState): seq<D2> {
	[DC5(seq(abs(-0x271), i0  => (|"cqfqwylgv"|))), DC5([|map[true := false]|, |multiset{-0xb1, |[-0x1a9]|}|]), DC5([-684])] + (seq(abs(-0x4c), i1  => (DC5([|['r']|]))))
}
...
function fm28(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<int> {
	if (if (false) then false else !!false) then set v0 : int | (768 <= v0) && (v0 < 0x1d) :: (safeDivisionInt(v0, 801)) else {-|multiset([0x73])|} * {0x311, |{0x17a, |(map v1 : int | (678 <= v1) && (v1 < -0x42) :: (v1 - 0x145) := (true))|, |map[!true := "nb"]|, |"kokftkjn"|, |map[|(seq(abs(0x310), i0  => ('t')))| := map[DC34(map v2 : int | (0x4b <= v2) && (v2 < 695) :: (v2 - |(seq(abs(654), i1  => ('x')))|) := (|map[false := true]|)) := true]]|}|, 709, 0x7c, |map[false := |"pmilbnjok"|]|}
}
...
function fm32(p0: int, p1: int, p2: bool, globalState: GlobalState): seq<int> {
	[|map[true := map[0x2b := false]]|, -0x228 * |(map v0 : int | (0x102 <= v0) && (v0 < 0x170) :: (v0 - 0x51) := (false))|, safeDivisionInt(|"kchk"|, 0x2db)]
}
...
function fm38(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<int, string> {
	map[0x33a := "fghwqouji"] + (map v0 : int | v0 in [0x2f5, 853, -|"krtxro"|] :: (safeModuloInt(v0, |multiset{--|[DC36(map[DC16(false, |"rsiiwqtrg"|, false) := "k"]), DC36(map v1 : D7 | v1 in [DC16(false, -159, true), DC16(false, -0x3b6, false), DC16(!false, 953, false), DC16(false, |"jbwndisey"|, true), DC16(false, 0x158, true)] :: (v1) := ("tmge"))]|}|)) := ("ubeopiw"))
}
function fm39(p0: bool, globalState: GlobalState): map<map<int, bool>, bool> {
	map[map[|multiset{|{!true, true, false}|}| := true] := false] + (map[map[0x90 := false] := false] + map[map v0 : int | v0 in [|[|"p"|, |(seq(abs(-0x34f), i0  => ('s')))|]|] :: (v0 * 954) := (false) := false])
}
function fm40(p0: int, globalState: GlobalState): map<seq<D9>, int> {
	map[[DC24(map[|[false, false]| := DC14(map[0x14e := {345}])], [true]), DC24(map[0x50 := DC14(map[|{false}| := {0x1c7, 528, |(seq(abs(747), i0  => ('d')))|, |{563}|}])], [false, true])] := 0x1e8] + (map v0 : seq<D9> | v0 in [seq(abs(0x2af), i1  => (DC24(map v1 : int | (0x35e <= v1) && (v1 < 0x275) :: (safeModuloInt(v1, -0x10e)) := (DC14(map[0x2f4 := {|map[-241 := -0x166]|}])), [true])))] :: (v0) := (0x208))
}
function fm41(p0: int, globalState: GlobalState): seq<multiset<int>> {
	[multiset([--901, -0x17d, |[true]|]) - multiset{0x2ac, 0x3b2}, multiset{|DC21(seq(abs(-0x29b), i0  => ('p')), {false, true}).cf34|, DC32(false, 392, true).cf60, |{true, true}|, -0x248, |[!true]|}, if (false) then multiset([|(seq(abs(0x70), i1  => ('l')))|]) else multiset{|"lkidualy"|}]
}
...
function fm45(p0: int, globalState: GlobalState): seq<map<int, bool>> {
	([map v0 : int | (0x329 <= v0) && (v0 < 0x2c1) :: (safeDivisionInt(v0, |map[false := false]|)) := (true)] + [map[-192 := !false], map[0x2e9 := false]]) + ([map[|"afelo"| := true], map[|"h"| := true], map[|{0x295}| := false]] + [map[0x301 := true], map[0x27f := false]])
}
function fm46(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): multiset<char> {
	match DC19({true, false}) {
		...
		case DC21(cf34, cf35) => multiset{'g'} + multiset{cf34[safeIndex(0x358, |cf34|)]}
		case DC19(cf30) => multiset{'d'}
	}
}
function fm47(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): map<map<int, bool>, int> {
	map[map[|(seq(abs(0x3a7), i0  => (0x32b)))| := false] + map[-766 := !false] := 0xe2]
}
...
function fm50(p0: int, p1: int, globalState: GlobalState): seq<map<bool, bool>> {
	if (!("rqld" < "futiieesj")) then [map[true := true], map[true := !true], map[false := false], map[false := true]] + [map[false := true]] else seq(abs(0x183), i0  => (map[true := true]))
}
...
method m0(p0: set<int>, p1: array<D0>, p2: array<int>, p3: string, globalState: GlobalState) {
	...
	match (if (v1 <= v1) then DC61(v7).(cf101 := v7) else v8) {
		case DC62(cf102, cf103, cf104, cf105) =>
			...
			var v10: seq<int> := [v9];
			var v11: array<seq<int>> := new seq<int>[22] [v10, [v9], v10, v10, v10, v10, [v9, v9, v9, -v9, v9], v10, v10, v10, [v9], seq(abs(-0x1d7), i1  => (v9)), v10[safeIndex(v9, |v10|) := v9], v10, v10, v10, v10, v10, v10, v10, v10, v10];
			var v12 := DC38(v11);
			var v13: seq<D14> := [DC41(v12)];
			v9 := |v13|;
			var v14: set<string> := {p3};
			var v15 := 'j';
			var v16: map<string, int> := map[p3[safeIndex(v9, |p3|) := v15] := v9];
			var v18: set<bool> := {cf105};
			var v19: map<int, string> := map[|v18| := p3];
			var v20: seq<bool> := [cf105];
			v0 := new bool[11] [v5.f23, cf104, v5.f23, cf105, v5.f23, cf105, !!(v14 >= (set v17 : string | v17 in v16 :: (v17))), p3 < p3, v14 <= {"ctqonb", if (0x33f in v19) then v19[0x33f] else p3, p3, p3, "iqkhgippl"}, v4, v5.fm17(|p3|, DC32(v20[safeIndex(0x250, |v20|)], v9, true).cf60, cf102, globalState)];
			p2[safeIndex(618, p2.Length)] := v9;
			...
			v15, p2[safeIndex(618, p2.Length)] := v15, fm1(v25 > v25, globalState);
		case DC63(cf106, cf107) =>
			cf107 := cf107;
			var v26: set<bool> := {v5.f23};
			v0[safeIndex(476, v0.Length)] := v26 < v26;
			var v27 := DC20(-cf107, cf107, cf107);
			v0[safeIndex(476, v0.Length)] := (fm52(v27, cf107, globalState)).cf10;
			v6[safeIndex(30, v6.Length)] := v5;
			v6[safeIndex(30, v6.Length)] := v5;
		...
		case DC61(cf101) =>
			...
			v30[safeIndex(639, v30.Length)], v32, v34, v6[safeIndex(212, v6.Length)] := v31, p3, v34, v5;
			var v35: seq<int> := [-0x229];
			var v36: seq<seq<seq<int>>> := [[v35, v35]];
			globalState.f6 := safeModuloInt(|v36[safeIndex(DC16(true, v33, v5.f23).cf22, |v36|)]|, v33);
	}
		...
		decreases 100 - i3
	{
		...
		var v43 := "dicognbwi";
		var v44 := 'j';
		v43 := p3 + ((seq(abs(0xe0), i4  => ('r'))) + p3)[safeIndex(v38, |((seq(abs(0xe0), i4  => ('r'))) + p3)|) := v44];
		if (fm2(globalState)) {
			v37[safeIndex(534, v37.Length)] := safeDivisionInt(|v42|, v38);
			var v45: map<int, string> := map[v38 := p3];
			v37[safeIndex(534, v37.Length)] := |(if (v38 in v45) then v45[v38] else p3[safeIndex(v38, |p3|) := 'm'])| - v38;
			globalState.f6 := -0x3ca;
			var v46 := DC50(v5.f23, v38, v38, true, false);
			globalState.f1 := v46.cf87 > (v37[safeIndex(534, v37.Length)] + v38);
			v0[safeIndex(216, v0.Length)] := v38 <= |p3|;
			v37[safeIndex(534, v37.Length)], v0[safeIndex(216, v0.Length)], globalState.f6 := -0x4c, p0 > p0, 0x177;
			globalState.f6 := 0x1bb - (798 * 54);
		} else {
			globalState.f6 := v38;
			var v47: map<char, bool> := map[v44 := !v5.f23];
			v0[safeIndex(28, v0.Length)] := if (v44 in v47) then v47[v44] else v5.f23;
			v0[safeIndex(28, v0.Length)] := v43 != v43;
			var v48: array<array<D10>> := new array<D10>[11];
			var v49: array<D10> := new D10[27];
			v48[safeIndex(450, v48.Length)] := v49;
			v48[safeIndex(450, v48.Length)] := v49;
			v37[safeIndex(581, v37.Length)] := v38 + |[[v4]]|;
			var v50: map<int, bool> := map[v38 := v5.f23];
			var v51: seq<int> := [|v43|, v38, -261, v38];
			globalState.f1, v37[safeIndex(581, v37.Length)] := safeModuloInt(|v43|, v38) == v38, |v50| + safeDivisionInt(v38, -v51[safeIndex(v38, |v51|)]);
			var v52: array<D3> := new D3[20];
			var v53: set<array<D3>> := {v52, v52};
			var v54 := DC23(v53, p3, v5.f23, p2, 'i');
			v54 := DC23({v52, v52, v52, v52}, p3[safeIndex(v38, |p3|) := 'a'], v0[safeIndex(28, v0.Length)], p2, v44);
		}
	...
	for i5 := v38 to v38 {
		...
		globalState.f6 := safeModuloInt(|v55|, i5) - safeModuloInt(i5, |fm21(globalState)|);
		globalState.f1 := (seq(abs(742), i6  => ('y'))) <= p3;
		v0[safeIndex(850, v0.Length)] := v5.f23;
		p2[safeIndex(497, p2.Length)] := v38;
		var v56: seq<C0> := [v5, v5];
		var v57 := DC7(i5);
		v0[safeIndex(850, v0.Length)], p2[safeIndex(497, p2.Length)], globalState.f6 := (v38 + v38) != 0x208, v38 * |v56|, v57.cf7;
		p2[safeIndex(497, p2.Length)] := v38;
	}
	v37 := p2;
}
method Main() {
	...
	v14[safeIndex(696, v14.Length)] := map[v3 := v0];
	v14[safeIndex(696, v14.Length)] := (v4 + map[v3 := v0]) + fm0(v0, false, v3, globalState);
	for i3 := |v12| to v3 {
		v10[safeIndex(390, v10.Length)] := v0;
		v10[safeIndex(390, v10.Length)] := false;
		v10[safeIndex(390, v10.Length)] := !v10[safeIndex(390, v10.Length)];
	...
	if (v12[safeIndex(|v6| + v3, |v12|)]) {
		...
		globalState.f1 := v0;
		v10[safeIndex(992, v10.Length)] := v0;
		v10[safeIndex(992, v10.Length)] := true;
		...
		if (v0) {
			...
			v6 := v6[safeIndex(-(if (v0 in v27) then v27[v0] else v3), |v6|) := v11] + (if (v29 in v31) then v31[v29] else v6);
			...
			var v40: map<int, int> := map[v37[safeIndex(v37[safeIndex(|(map v38 : char | v38 in v39 :: (v38) := (v0))|, |v37|)], |v37|)] := v3];
			v35 := v35[v0 := v40 + v40];
			v8[safeIndex(503, v8.Length)] := |map[fm2(globalState) := "yxdfyxg"]|;
			v8[safeIndex(503, v8.Length)] := v3 + v3;
			var v41: T0 := new C6();
			var v42: multiset<T0> := multiset{v41};
			var v43 := new C9(if (v0) then v8[safeIndex(503, v8.Length)] else -|v42|);
		}
		
		v10[safeIndex(669, v10.Length)] := false;
		v10[safeIndex(669, v10.Length)] := v0 && v0;
		var v44: seq<int> := [v3];
		v44 := if (-0x394 > v3) then seq(abs(495), i4  => (-v3)) else v44;
		var v45: map<int, int> := map[v3 := v3];
		var v47: map<bool, set<int>> := map[v0 := set v46 : int | v46 in v45 :: (safeModuloInt(v46, |"co"|))];
		var v48: array<map<bool, set<int>>> := new map<bool, set<int>>[13] [v47 + v47, v47, v47, v47 + v47, v47[v0 := {v3, 0x240}] + v47, v47, v47, v47 + v47, map[!fm2(globalState) := v9], v47, v47, map[v10[safeIndex(669, v10.Length)] := v9], v47 + v47];
		v48[safeIndex(891, v48.Length)] := v47 + v47;
		var v49: array<bool> := new bool[12];
		var v50: map<bool, array<bool>> := map[v10[safeIndex(669, v10.Length)] := v49];
		var v51: set<bool> := {v10[safeIndex(669, v10.Length)]};
		globalState.f6, globalState.f1, globalState.f14, v48[safeIndex(891, v48.Length)] := v3, v10[safeIndex(669, v10.Length)], if ((v10[safeIndex(669, v10.Length)] in v51) in v50) then v50[v10[safeIndex(669, v10.Length)] in v51] else v49, map[v10[safeIndex(669, v10.Length)] := v9] + v47;
		if (v0) {
			v8[safeIndex(449, v8.Length)] := v3;
			v10[safeIndex(669, v10.Length)], v8[safeIndex(449, v8.Length)] := v10[safeIndex(669, v10.Length)], v3 + --v3;
			v8[safeIndex(449, v8.Length)] := v3;
			var v52: map<map<int, bool>, int> := map[v14[safeIndex(696, v14.Length)] := v3];
			var v53: T1 := new C2(v8[safeIndex(449, v8.Length)], v3, v52);
			v6 := ("flwge")[safeIndex(|multiset{v53, v53, v53}|, |"flwge"|) := v11];
			v51 := v51 * (v51 + v51);
			var v54: array<D0> := new D0[17];
			var v55: array<int> := new int[4];
			m0(v9, v54, v55, v6, globalState);
		} else {
			var v56: map<map<int, bool>, int> := map[v14[safeIndex(696, v14.Length)] := v3];
			...
			v59[safeIndex(909, v59.Length)] := {v6};
			v59[safeIndex(909, v59.Length)] := {if (v10[safeIndex(669, v10.Length)]) then v6 else fm21(globalState), fm21(globalState)};
			var v60: array<set<D11>> := new set<D11>[17];
			var v61 := DC31(v12, |v6|, v57.f20, v57.f20, v3);
			var v62: set<D11> := {v61};
			v60[safeIndex(747, v60.Length)] := v62 - {v61};
			var v63 := DC7(|v45|);
			var v64 := DC27(v57.f21, "upuot", v57.f20, v63, map[v49 := v10[safeIndex(669, v10.Length)]]);
			v60[safeIndex(747, v60.Length)] := fm55(-v3, v64.cf48, v3, globalState);
		}
	...
	if (v0 <== v0) {
		...
		v65 := v65;
		var v66: map<map<int, bool>, int> := map[v14[safeIndex(696, v14.Length)] := v3];
		var v67: T1 := new C3(v0, |"upii"|, v66);
		var v68: set<bool> := {v0};
		var v69 := DC31(v12, v3, v3, |v68|, v3);
		var v70: array<seq<bool>> := new seq<bool>[19] [v12, v12, v12, v12, [v0, !!v0, v0, v0, v0], [v0], v12, v12 + v12, v12 + v12, v12, v12, v12, v12[safeIndex(fm1(v0, globalState), |v12|) := v0], (v12 + v69.cf54)[safeIndex(v3, |(v12 + v69.cf54)|) := v0], fm19(globalState), v12, v12, v12, ([v0])[safeIndex(0x135, |[v0]|) := v0]];
		var v71: seq<seq<bool>> := [v12, v12, [v0]];
		v70[safeIndex(883, v70.Length)] := v71[safeIndex(v3, |v71|)];
		var v72: seq<array<bool>> := [v10, v10];
		globalState.f1, globalState.f6, globalState.f1, v67, v70[safeIndex(883, v70.Length)] := v0, |v72|, fm2(globalState), v67, v12;
		var v73: seq<int> := [--0x167];
		v73 := v73;
		globalState.f1 := fm2(globalState);
		if (v0) {
			var v74: map<bool, bool> := map[v0 := v0];
			var v75 := v67.m11(seq(abs(44), i5  => (v11)), |v74|, globalState);
			var v76: C8 := new C8();
			v76 := v76;
			var v77: seq<T1> := [v67];
			...
			v79[safeIndex(701, v79.Length)] := v78;
			v79[safeIndex(701, v79.Length)] := v78[v77 := if (v0) then v0 else v0];
			var v80: map<array<int>, bool> := map[v8 := v0];
			v80 := v80;
			var v81: array<array<bool>> := new array<bool>[6];
			var v82 := DC10(v81);
			globalState.f6, globalState.f6, v82 := safeDivisionInt(v3, |v6|) - (972 * |v6|), v3, v82;
		} else {
			globalState.f6 := v3;
			globalState.f1 := fm2(globalState);
			globalState.f1 := v0;
			v10[safeIndex(252, v10.Length)] := v0;
			v10[safeIndex(252, v10.Length)] := if (v0) then fm2(globalState) else if (v0) then v0 else v0;
			var v83: C4 := new C4();
			var v84: array<D10> := new D10[17];
			var v85: array<C0> := new C0[24];
			var v86: seq<array<C0>> := [v85, v85];
			var v87: map<bool, int> := map[v10[safeIndex(252, v10.Length)] := fm1(v10[safeIndex(252, v10.Length)], globalState)];
			var v88: array<bool> := new bool[3] [v10[safeIndex(252, v10.Length)], v0, false];
			var v89 := DC61(v86);
			v10[safeIndex(252, v10.Length)], v83, v84, globalState.f14, v86 := (v72 + v72[safeIndex(if (v0 in v87) then v87[v0] else if (v0 in v87) then v87[v0] else fm1(false, globalState), |v72|) := v88]) != (v72 + [v88, v88]), v83, v84, v88, v89.cf101;
		}
		...
		globalState.f6 := -safeModuloInt(-v3, v3);
	...
	var v97: array<map<bool, int>> := new map<bool, int>[10] [v95, v95 + v95, v95, v95 + v95, v95, v96[safeIndex(v3, |v96|)], map[v0 := v3], v95, if (!v0) then map[true := v3] else v95, v95];
	v97[safeIndex(31, v97.Length)] := v95 + v95;
	var v98: map<int, int> := map[0x287 := |v6|];
	var v99 := DC34(v98);
	v97[safeIndex(31, v97.Length)] := fm36(v11, v99, globalState);
	...
	match (DC10(v100)) {
		...
		case DC12(cf15, cf16, cf17) =>
			...
			v107 := v107[|(set v108 : int | (-232 <= v108) && (v108 < 0x24e) :: (safeDivisionInt(v108, v3)))| := v11];
			globalState.f6 := v3;
			if (true) {
				v8[safeIndex(974, v8.Length)] := cf15;
				var v109: set<bool> := {cf16, !cf16};
				var v110: seq<int> := [v3, |v109|];
				var v111: seq<seq<int>> := [v110, v110];
				v8[safeIndex(974, v8.Length)] := |v111[safeIndex(v3, |v111|)]|;
				v3 := v3 * cf15;
				v8[safeIndex(974, v8.Length)] := cf15;
				var v112: map<string, multiset<int>> := map[("jdakhap" + v6)[safeIndex(v3, |("jdakhap" + v6)|) := v11] := v1];
				v112 := v112[v6 := multiset(v110)];
				var v113 := DC1(v8[safeIndex(974, v8.Length)]);
				var v114 := DC2(v113);
				...
				v8[safeIndex(206, v8.Length)] := cf15;
				v8[safeIndex(206, v8.Length)] := v3;
				cf16 := !v0;
				var v118: seq<int> := [-0x1d1, v8[safeIndex(206, v8.Length)], 0xe9];
				globalState.f1 := v8[safeIndex(206, v8.Length)] in v118;
				v10[safeIndex(649, v10.Length)] := v0;
				var v119: map<bool, bool> := map[v0 := v0];
				var v120 := DC50(v0, |"korfyx"|, cf15, v0, v0);
				var v121: set<bool> := {v120.cf90};
				v10[safeIndex(649, v10.Length)] := (v118[safeIndex(v3, |v118|)] > v3) || (|v119| >= |v121|);
			}
			
			v8[safeIndex(512, v8.Length)] := v3;
			v8[safeIndex(512, v8.Length)] := cf15;
		case DC10(cf13) =>
			v3 := v3;
			globalState.f1 := false;
		...
		case DC13(cf18) =>
			...
			if (true) {
				v3 := v3;
				globalState.f6 := v128;
				globalState.f6 := -safeModuloInt(v3, -943);
				var v130: multiset<bool> := multiset{v0};
				var v131: map<map<int, bool>, int> := map[v14[safeIndex(696, v14.Length)] := 0xb1];
				...
				v133 := v133;
				var v134 := new C8();
				v8[safeIndex(250, v8.Length)] := safeModuloInt(-570, -137);
				v8[safeIndex(250, v8.Length)] := v128;
				v129 := v128 > v8[safeIndex(250, v8.Length)];
				v10[safeIndex(40, v10.Length)] := fm2(globalState);
				v10[safeIndex(40, v10.Length)] := if (v0) then !!true else v129;
			}
	...
	m0(set v137 : int | v137 in v136 :: (safeModuloInt(v137, 0x27a)), v141, v8, v6 + v6, globalState);
	if (fm2(globalState)) {
		...
		v144, v0, v0, globalState.f1, v6 := v144, true, v0 <==> v0, v0, (((v6 + v6) + v6)[safeIndex(|v6[safeIndex(|v9|, |v6|) := v11]|, |((v6 + v6) + v6)|) := v11])[safeIndex(-|v145[safeIndex(v3, |v145|)]|, |((v6 + v6) + v6)[safeIndex(|v6[safeIndex(|v9|, |v6|) := v11]|, |((v6 + v6) + v6)|) := v11]|) := v11];
		var v146: multiset<bool> := multiset{v0, v0};
		var v147 := new C2(v3, |v146|, map[v14[safeIndex(696, v14.Length)] := v3]);
		globalState.f6 := if (v0 in v146) then v146[v0] else v147.f21;
		if (true) {
			var v148: map<bool, string> := map[v0 := v6];
			v148 := v148[v0 := v6];
			v145 := v145;
			globalState.f1 := v12[safeIndex(v147.f21, |v12|)];
			v8 := v8;
			...
			var v153, v154 := v147.m12(v147.f20, v147.f21, v6 + v6, v7[safeIndex(v147.f21, |v7|)], globalState);
			var v155: set<bool> := {v153, fm2(globalState)};
			var v156 := DC21("ahhjndpbh", v155);
			var v157 := v147.m11(v156.cf34[safeIndex(v147.f20, |v156.cf34|) := v11] + v154, v147.f21, globalState);
		}
		
	} else {
		var v158: set<char> := {v6[safeIndex(v3, |v6|)]};
		...
		if ((v1 + v1) >= (if (v3 in v160) then v160[v3] else fm42(fm1(!v0, globalState), v11, v3, true, globalState))) {
			...
			var v168: T1 := new C2(|v167|, v163.f15, map[v14[safeIndex(696, v14.Length)] := v166.f16]);
			...
			var v173 := new C5(-safeDivisionInt(v3, |v172|));
			var v174, v175 := v168.m12(|(v6 + "swd")|, v3, v6 + v6, ("yeigb")[safeIndex(v163.f15, |"yeigb"|) := v11] + v6, globalState);
		} else {
			var v176 := DC40(!v0);
			...
			v177[safeIndex(799, v177.Length)] := v176;
			v177[safeIndex(799, v177.Length)] := DC40(v0);
			var v178: array<seq<int>> := new seq<int>[5](i8 => v136);
			var v179 := DC5(v136);
			var v180: set<map<int, int>> := {v98, v98};
			v178[safeIndex(434, v178.Length)] := v136 + v179.cf5[safeIndex(|v180|, |v179.cf5|) := v3];
			var v181: map<map<int, bool>, int> := map[v4 := -v3];
			var v182: T1 := new C3(v0, fm1(v0, globalState), v181);
			v3, v11, v178[safeIndex(434, v178.Length)], v182 := v3, v11, [|fm28(v3, true, v0, globalState)|, v3, v3] + v136, v182;
			var v183: map<int, T1> := map[v3 := v182];
			var v184: map<bool, map<int, T1>> := map[v0 := v183];
			globalState.f6 := v178[safeIndex(434, v178.Length)][safeIndex(|(v184 + v184)|, |v178[safeIndex(434, v178.Length)]|)];
			var v185 := DC47(v181);
			...
			v188[safeIndex(289, v188.Length)] := v186;
			v188[safeIndex(289, v188.Length)] := v186;
			v13[safeIndex(617, v13.Length)] := v8;
			var v189: map<map<int, int>, int> := map[v98 := v186.f19];
			v13[safeIndex(617, v13.Length)] := new int[20] [v3, v186.f19 + v186.f19, safeModuloInt(|v12|, |[v186.f19]|), v3, if (!v186.f18) then v3 else 916, v3, v3, v3, 0x6a, safeDivisionInt(v186.f19, |v6|), v3, -0x21d, |v6|, -581, --v186.f19, v3, fm1(v186.f18, globalState), 942 * v3, |v189|, safeDivisionInt(-0x22f, v3)];
		}
		
		v4 := v4[v3 := v0];
		globalState.f9, globalState.f1, globalState.f6 := v8, fm2(globalState), v136[safeIndex(v3, |v136|)];
	}
	
	globalState.f6 := v3 - 0xa8;
	print v0, "\n";
	print v1 == multiset{1}, "\n";
	print v2 == map[multiset{1} := false], "\n";
	print v3, "\n";
	print v4 == map[781 := true], "\n";
	print v5 == multiset{map[781 := true], map[781 := true], map[781 := true], map[781 := true]}, "\n";
	print v6, "\n";
	print v7 == ["kajndjn"], "\n";
	print v8[0], "\n";
	print v8[1], "\n";
	...
	print globalState.f4 == map[multiset{1} := false], "\n";
	print globalState.f5 == multiset{map[781 := true], map[781 := true]}, "\n";
	print globalState.f6, "\n";
	print globalState.f7, "\n";
	print globalState.f8 == ["kajndjn", "kajndjn"], "\n";
	...
	print v13[0][2], "\n";
	print v13[0][3], "\n";
	print v14[0] == map[781 := true], "\n";
	print v14[1] == map[781 := true], "\n";
	print v14[2] == map[781 := true], "\n";
	print v14[3] == map[781 := true, 0 := true, 9 := false, 898 := true, 6 := false], "\n";
	print v14[4] == map[781 := true], "\n";
	print v14[5] == map[781 := true], "\n";
	print v14[6] == map[781 := true], "\n";
	print v14[7] == map[781 := true], "\n";
	print v14[8] == map[781 := true], "\n";
	print |v19|, "\n";
	print v95 == map[true := 0], "\n";
	print v96 == [map[true := 0], map[true := 0]], "\n";
	print v97[0] == map[true := 0], "\n";
	print v97[1] == map[true := 1, false := -685], "\n";
	print v97[2] == map[true := 0], "\n";
	print v97[3] == map[true := 0], "\n";
	print v97[4] == map[true := 0], "\n";
	print v97[5] == map[true := 0], "\n";
	print v97[6] == map[true := 0], "\n";
	print v97[7] == map[true := 0], "\n";
	print v97[8] == map[true := 0], "\n";
	print v97[9] == map[true := 0], "\n";
	print v98 == map[647 := 7], "\n";
	print v99.cf63 == map[647 := 7], "\n";
	print v136 == [0], "\n";
	print v138.cf0, "\n";
	print v139.cf2.cf0, "\n";
	print v140.cf2.cf0, "\n";
	print v141[0].cf2.cf0, "\n";
}