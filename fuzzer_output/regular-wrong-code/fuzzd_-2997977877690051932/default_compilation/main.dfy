...
function fm4(p0: int, p1: int, globalState: GlobalState): map<int, int> {
	map[--0x183 := -safeDivisionInt(0x5d, |"xuqnfvfjl"|)]
}
...
function fm7(p0: set<int>, globalState: GlobalState): string {
	(seq(abs(0x23b), i0  => ('t'))) + ("mclcxtfx" + (seq(abs(0x3), i1  => ('r'))))
}
function fm8(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): int {
	safeDivisionInt(0xa1, |(if (true) then "wvcutvx" else "entn")|)
}
		...
		decreases 100 - i0
	{
		...
		match (if (true) then v2 else v2) {
			...
			case DC6(cf8) =>
				...
				var v11: map<string, bool> := map["y" := cf8.fm1(if (p2 in v10) then v10[p2] else v0, seq(abs(0x3d8), i1  => (DC9("kqfg").cf10)), globalState)];
				var v12 := 'm';
				v11 := v11[v9 := v12 !in v9];
				var v13 := new C0(v1.f22[v0 := p0]);
			case DC8(cf9) =>
				var v14: array<array<bool>> := new array<bool>[9];
				v14[safeIndex(703, v14.Length)] := p0;
				v14[safeIndex(703, v14.Length)] := p0;
				var v15 := "u";
				...
				var v21 := 't';
				var v22: array<int> := new int[26] [740, p2, p2, p2, 0x3e0 - p2, safeDivisionInt(p2, p2), p2, safeDivisionInt(p2, p2), --0x231, p2, |v16|, safeModuloInt(p2, p2), -|[true]|, p2, -|v17|, p2 - p2, |(v19 + map[v0 := DC7()])|, p2, -p2, p2, p2, -(p2 * p2), p2 * |v20|, p2, |("eybkhsaop" + "ddyvcpun")[safeIndex(p2, |("eybkhsaop" + "ddyvcpun")|) := v21]|, -0xd1];
				v22[safeIndex(783, v22.Length)] := p2;
				var v23: multiset<C0> := multiset{v1};
				var v24 := DC6(v1);
				var v25: map<D3, bool> := map[v24 := v0];
				r0, v15, v22[safeIndex(783, v22.Length)], globalState.f7 := (v23 * v23) == multiset{v1}, v15, if (v0) then |v25| else p2 * p2, 0x28a;
				var v26: seq<string> := [v15];
				var v27: multiset<bool> := multiset{v0, !v0, v0, !v0, if (v0) then v1.fm1(v0, v26, globalState) else v0};
				v27, globalState.f20 := v27, v22[safeIndex(783, v22.Length)];
				var v28: seq<bool> := [false, v0, v0, v0];
				p0[safeIndex(73, p0.Length)] := v0 !in v28;
				p0[safeIndex(73, p0.Length)] := v0;
		}
		...
		var v31: seq<C0> := [v1];
		var v32 := "nb";
		v29[safeIndex(202, v29.Length)] := (if (v0 in v30) then v30[v0] else |v31|) * fm8(p2, |v32|, v0, v0, globalState);
		var v33: map<C0, bool> := map[v1 := v0];
		var v34 := 'p';
		globalState.f6, globalState.f4, globalState.f14, v29[safeIndex(202, v29.Length)], globalState.f7 := v0, (v0 <== !v0) <==> v0, (|fm9(p2, p2, v0, globalState)| * p2) + p2, if (v32 != ("necjelxnj")[safeIndex(|v33|, |"necjelxnj"|) := v34]) then -p2 else p2, p2 - (|"j"| * p2);
		v0 := v0;
		var v35: seq<bool> := [v0, v0];
		var v36: set<bool> := {v0, !v35[safeIndex(-v29[safeIndex(202, v29.Length)], |v35|)]};
		...
		v1, v37, globalState.f14, v34, v38 := v1, v37 + v37[v0 := v0], v29[safeIndex(202, v29.Length)], fm10(v42, v44 - v44, globalState), v38;
	}
	r1 := v0;
	globalState.f20 := p2;
	var v45 := "eqgwm";
	var v46: seq<bool> := [v45 == v45, p2 < -p2, v0 || v0, v0, v0];
	var v48: seq<int> := [|(map v47 : int | (209 <= v47) && (v47 < 0x39d) :: (safeModuloInt(v47, p2)) := (v0))|];
	r0 := v46[safeIndex(fm8(|v48|, p2, v0, false, globalState), |v46|)];
	var v49: array<bool> := new bool[1];
	v49 := p0;
	var v50: map<array<bool>, int> := map[v49 := v48[safeIndex(p2, |v48|)]];
	v50 := v50 + v50;
	var v51 := DC1(p2, v0);
	r0 := match v51 {
		case DC1(cf1, cf2) => v0
...
method Main() {
	...
	var v9: array<int> := new int[22] [v1, |v5|, |(seq(abs(-0x38a), i1  => (v0)))|, v1, v1, v1, v1, v1, |map[v1 := v6]|, v1, v1, v1, v1, v1, v1, v1, v1, if (v6 in v7) then v7[v6] else v1, |v8|, v1, v1, 0x36b];
	...
	var v15 := "je";
	var globalState := new GlobalState(map[seq(abs(-417), i0  => ('x')) := v0], v9, v10, v11, true, v12, true, 0x3a1, v7, 0x13f, -0x1b2, true, v4 * v4, v9, -685, true, v14[safeIndex(v1, |v14|)] + {v6}, v2, map[false := |v15|] + map[true := v1], 581, 0x25, v15);
	if (true) {
		v2[safeIndex(196, v2.Length)] := -v1;
		v2[safeIndex(196, v2.Length)] := v1;
		v8 := v8[v7 <= v7 := v2[safeIndex(196, v2.Length)] * v2[safeIndex(196, v2.Length)]];
		var v16: array<bool> := new bool[19];
		v16 := v16;
		v15 := seq(abs(971), i2  => (v0));
		v6 := v6 <== true;
	} else {
		var v17: array<bool> := new bool[2](i3 => v15 == v15);
		v17[safeIndex(675, v17.Length)] := v6;
		var v18: multiset<int> := multiset{0x325, v1};
		var v19: seq<int> := [v1];
		var v20: multiset<int> := multiset{(if (v1 in v18) then v18[v1] else v1) - v1, v1, |v19| + v1, v1};
		v2[safeIndex(475, v2.Length)] := safeDivisionInt(v1, v1);
		var v21: map<seq<int>, multiset<int>> := map[[|v15|, v1] := multiset{v1}];
		v17[safeIndex(675, v17.Length)], v20, v2[safeIndex(475, v2.Length)], globalState.f20 := v6, if (v19 in v21) then v21[v19] else v20, -971 - v1, v1;
		globalState.f6 := fm0(map[v1 := v2[safeIndex(475, v2.Length)]], v1, v17[safeIndex(675, v17.Length)], v6, globalState);
		v9 := v9;
		var v22: map<int, int> := map[v2[safeIndex(475, v2.Length)] := v1];
		var v23: map<int, bool> := map[|v22| := v17[safeIndex(675, v17.Length)]];
	...
	v25[safeIndex(919, v25.Length)] := v26;
	v25[safeIndex(919, v25.Length)] := v26;
	globalState.f4 := v6;
	...
	if (!v6 <== v6) {
		...
		var v30: array<bool> := new bool[11] [v6, v6, v6, v6, v28[safeIndex(v1, |v28|)], v6, v6, v6, fm0(v29, v1, v6, v6, globalState), v6, !!v6];
		...
		var v37: seq<int> := [v1 - |multiset{0xec}|, v1, safeModuloInt(|v36[v9 := v34]|, v1)];
		var v38 := DC0(v10);
		var v39: map<int, bool> := map[v1 := v35];
		var v40: map<int, map<int, bool>> := map[|v38.cf0| := v39];
		v37 := v37[safeIndex(v1, |v37|) := |(v40 + map[v1 := v39])|];
		var v41 := new C0(v31);
		var v42 := new C0(v31);
	} else {
		globalState.f20 := safeDivisionInt(v1 - -v1, v1);
	...
	for i4 := v1 to -v1 {
		...
		var v64: seq<string> := [seq(abs(0x11a), i5  => (v0))];
		var v65: array<set<bool>> := new set<bool>[14] [{v54}, v13, v13, v13, v13, v13, v13, v13, v13, if (v54 in v63) then v63[v54] else fm2(v54, v61.fm1(v54, v64[safeIndex(v1, |v64|) := v15], globalState), |v15|, globalState), {v53}, v13, v13, v13];
		v62[safeIndex(118, v62.Length)] := v65;
		v62[safeIndex(118, v62.Length)] := if (v54) then v65 else v65;
		var v66 := DC5(v2);
	...
	if (fm0(v58, v1, v54, v6, globalState)) {
		v12[safeIndex(508, v12.Length)] := v15;
		var v72: multiset<int> := multiset{0x2ea, v1};
		var v73: seq<int> := [|v72|];
		var v74: seq<seq<int>> := [v73, v73, v73];
		v54, globalState.f7, v54, v12[safeIndex(508, v12.Length)] := v74[safeIndex(v1, |v74|)] < fm3(globalState), v1 - v1, !((if (v1 in v72) then v72[v1] else v1) == v1), ((['f'] + v15)[safeIndex(v1, |(['f'] + v15)|) := v0])[safeIndex(safeDivisionInt(v1, v1), |(['f'] + v15)[safeIndex(v1, |(['f'] + v15)|) := v0]|) := if (v54) then v0 else v0];
		var v75: seq<map<bool, array<bool>>> := [v52, v52];
		var v76 := new C0(v75[safeIndex(v1, |v75|)]);
		...
		if (v61.fm1(v53, seq(abs(-0x2ab), i6  => ("u")), globalState) && (v1 >= v1)) {
			...
			v88[safeIndex(867, v88.Length)] := v87 + v87;
			var v89: seq<bool> := [v6, v54, !!true];
			var v90 := DC5(v2);
			var v91 := DC5(v90.cf7);
			var v92: seq<int> := [-0x178, 212];
			var v93: map<D2, int> := map[v91 := -|v92[safeIndex(v1, |v92|) := v1]|];
			var v94 := DC0(v10);
			...
			v9[safeIndex(435, v9.Length)], v61, globalState.f7, v88[safeIndex(867, v88.Length)], v89 := v1, if (v1 in v96) then v96[v1] else v97.cf8, |v98|, (v87 + v87) + v87, v89;
			...
			var v102: array<C0> := new C0[21] [v61, v101[safeIndex(v1, |v101|)], v61, v100, v100, v99, v61, v61, v100, v100, v61, v100, v99, v100, v99, v61, v61, v99, v100, v100, v100];
			var v103: set<array<C0>> := {v102};
			v6, globalState.f6, globalState.f14 := !v53, v6, |((v103 + v103) + (v103 - {v102}))|;
		}
		
		v9[safeIndex(129, v9.Length)] := v1;
		var v104: map<bool, array<int>> := map[v54 := v9];
		v9[safeIndex(129, v9.Length)] := |v104|;
		...
		var v108: seq<int> := [v9[safeIndex(129, v9.Length)]];
		var v109: map<seq<bool>, int> := map[v107 := |fm6(v108, v53, v6, globalState)|];
		v9[safeIndex(129, v9.Length)], globalState.f4, globalState.f14, globalState.f14 := if (v54) then v9[safeIndex(129, v9.Length)] - v9[safeIndex(129, v9.Length)] else v9[safeIndex(129, v9.Length)], !v6, -(if ((v107 + v107) in v109) then v109[v107 + v107] else v9[safeIndex(129, v9.Length)]), v9[safeIndex(129, v9.Length)];
	}
	
	globalState.f14 := v1 * v1;
	var i7 := 0;
	while (v15 < ("pt" + (seq(abs(0x342), i8  => (v0)))))
		decreases 100 - i7
	{
		if (i7 >= 100) {
			break;
		...
		var v113: seq<string> := [v15, seq(abs(285), i10  => ('y')), "ikudn"];
		if (fm0(v58, --v1 + |(seq(abs(0x6), i9  => (90)))|, v53, v111.fm1(v6, v113, globalState), globalState)) {
			globalState.f14 := v1 - safeDivisionInt(0x393, v1);
			v15 := "sv";
			v15 := "jbjlpyup";
			var v114 := new C0(v61.f22 + v61.f22[v6 := v51]);
			var v115: seq<int> := [|map[v111 := v111]|, v1];
			var v117: map<string, map<int, int>> := map[v15 + fm7(set v116 : int | v116 in v115 :: (v116 * |(seq(abs(783), i11  => (--0x75)))|), globalState) := map[v1 := v1]];
			var v118 := DC8(DC7());
	...
	for i12 := if (v6) then |(map v122 : int | (0x174 <= v122) && (v122 < 0x2e3) :: (safeDivisionInt(v122, v1)) := (v53))| else v1 to 492 {
		var v123 := DC6(v61);
		var v124 := DC8(v123);
		var v125: array<D3> := new D3[6] [v124, v124, v124, v124.(cf9 := v123), v124.(cf9 := v123), v124];
		var v126: map<array<D3>, array<int>> := map[v125 := v9];
		v51[safeIndex(778, v51.Length)] := v54;
		var v127: map<char, C0> := map[v0 := v61];
		v126, v51, v61, v51[safeIndex(778, v51.Length)] := v126[v125 := v2] + (v126 + v126), v51, if ('t' in v127) then v127['t'] else v61, v54 || v6;
		var v128 := new C0(v61.f22);
		v2[safeIndex(739, v2.Length)] := v1;
		var v129: multiset<int> := multiset{|(seq(abs(198), i13  => (v0)))|, i12};
		var v130: map<multiset<int>, seq<int>> := map[v129 - v129 := [0x28d]];
		v2[safeIndex(739, v2.Length)], v130, v128, v51[safeIndex(778, v51.Length)] := |[v1, i12, v1, i12, 658]| - safeModuloInt(v1, v1), v130, if (!v6) then v61 else v128, !v51[safeIndex(778, v51.Length)];
		var v131: seq<string> := ["uiiomhn"];
		v51[safeIndex(778, v51.Length)], globalState.f20 := if (v51[safeIndex(778, v51.Length)]) then fm0(v58, v1, v128.fm1(!v53, [fm7(v4, globalState), "odeavklj"], globalState), v128.fm1(true, v131, globalState), globalState) else v53, v2[safeIndex(739, v2.Length)];
	}
	print v0, "\n";
	print v1, "\n";
	print v2[0], "\n";
	...
	print |v3|, "\n";
	print v4 == {1, 557}, "\n";
	print v5 == multiset{{1, 557}}, "\n";
	print v6, "\n";
	print v7 == multiset{true}, "\n";
	print v8 == map[true := 310249], "\n";
	print v9[0], "\n";
	print v9[1], "\n";
	print v9[2], "\n";
	print v9[3], "\n";
	...
	print v11 == {map[true := 557]}, "\n";
	print v12[0], "\n";
	print v13 == {true}, "\n";
	print v14 == [{true}], "\n";
	print v15, "\n";
	print globalState.f0 == map[['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'] := 'w'], "\n";
	...
	print globalState.f2 == map[true := false], "\n";
	print globalState.f3 == {map[true := 557]}, "\n";
	print globalState.f4, "\n";
	print globalState.f5[0], "\n";
	print globalState.f6, "\n";
	print globalState.f7, "\n";
	print globalState.f8 == multiset{true}, "\n";
	print globalState.f9, "\n";
	print globalState.f10, "\n";
	print globalState.f11, "\n";
	print globalState.f12 == {1, 557}, "\n";
	...
	print globalState.f18 == map[false := 2, true := 557], "\n";
	print globalState.f19, "\n";
	print globalState.f20, "\n";
	print globalState.f21, "\n";
	print v27 == map[true := "vfucpd"], "\n";
	print v51[0], "\n";
	print v51[1], "\n";
	print v51[2], "\n";
	print v51[3], "\n";
	...
	print v53, "\n";
	print v54, "\n";
	print v56 == [map[true := false], map[true := false]], "\n";
	print v57 == map[map[map[true := false] := true] := false], "\n";
	print v58 == map[387 := -10], "\n";
	print v59 == map[map[false := false] := true], "\n";
	print |v60.cf3|, "\n";
	print |v61.f22|, "\n";
	print i7, "\n";
}