...
function fm3(p0: int, p1: bool, p2: int, p3: map<int, bool>, globalState: GlobalState): int {
	(|[map v0 : int | v0 in (map v1 : int | v1 in [151] :: (v1 - 829) := (|[|{|(seq(0x50, i0  => ('y')))|}|, 523]|)) :: (v0 - 0x21e) := (921), map[0x273 := 0x1d0], map[|[map[true := 0x27e]]| := 126], map[-0xdc := |(seq(487, i1  => (|map[true := !false]|)))|]]| % -511) + 0x217
}
function fm4(globalState: GlobalState): multiset<int> {
	(multiset{0x1ce} + multiset{|[|"rnvmueh"|, |map[614 := multiset(seq(0x336, i0  => ('k')))]|]|, -|map[true := 0xef]|, -650, |multiset([false])|}) - multiset([-0x249] + [913, |{map['e' := |"f"|], map['j' := |map[0x12d := false]|]}|])
}
function fm5(p0: char, globalState: GlobalState): map<int, bool> {
	(map[-|[true]| := false] + map[|[|map[-0x26c := |multiset{false}|]|]| := true]) + (map v0 : int | (0x3c3 <= v0) && (v0 < 0x297) :: (v0 % 441) := (false))
}
...
function fm10(p0: int, p1: int, p2: int, globalState: GlobalState): seq<bool> {
	[(map v0 : int | (0x14f <= v0) && (v0 < 0x21b) :: (v0 * -|{false}|) := (-|(seq(0x81, i0  => ('p')))|)) != map[0xba := |map[true := true]|], true !in [true, true, !true, true, true]]
}
function fm11(p0: int, p1: char, globalState: GlobalState): multiset<string> {
	(multiset{"xqmuuiom", "sjc", "f"} * multiset{"ofdbvnl"}) + (multiset{"bc"} - multiset(seq(0x17b, i0  => (seq(0x2a, i1  => ('w'))))))
}
...
method m0(globalState: GlobalState) {
		...
		decreases 100 - i0
	{
		...
		if (fm0(globalState)) {
			...
			var v12 := "btlenkt";
			var v13: set<array<bool>> := {v9, v10.cf17, v9, v11[-|v12|]};
			...
			var v19 := DC4(v7.f28);
			v13, v15, v9, v16 := v18[v1], v15, v9, (v16 + v16) * fm6(v19.cf5, v1, globalState);
			...
			v9[970] := v24.cf14;
			globalState.f0, globalState.f0, v22, v9[970] := false, v1 > (v1 * |map[v1 := -0x39c]|), v22, !v7.f28;
			var v25 := DC6(v16);
			...
			var v31 := DC1(v0, -832);
			v1, v28[941], v0 := |v30| + v31.cf2, v7.f28, if (v7.f28) then v1 in (set v32 : int | v32 in (seq(0x3b0, i1  => (v1))) :: (v32 % |"sbrnrtwv"|)) else v1 < v1;
			v29 := v29;
			var v33: multiset<C0> := multiset{v7, v7, v7};
			v1 := if (v7 in v33) then v33[v7] else v1 + v1;
			var v34: map<string, bool> := map[v30 := v0];
			var v35: array<map<bool, bool>> := new map<bool, bool>[7] [v2[v0 := false], v2, v2, v2 + fm7(v7.f28, v7.f28, v28[941], v1, globalState), v2, (fm7(v0, fm0(globalState), v7.f28, |v34|, globalState))[v0 := v0], v2];
			v35[382] := map[v7.f28 := v7.fm2(v7.f28, globalState)] + map[v28[941] := v7.f28];
			v35[382] := v2;
		}
		...
		if ((!v7.f28 <== v7.f28) <== v0) {
			...
			var v38 := DC12(v36);
			globalState.f0, v37 := (seq(0x2a8, i3  => ('h'))) <= ((v38.(cf18 := seq(0x366, i4  => ('x')))).cf18 + v36), if (v7.f28) then v37 else if (v7.f28) then v37 else v37;
			v0 := v0;
			v1 := (v1 / v1) - fm3(v1, v7.f28, v1, map[v1 := v7.f28], globalState);
			var v39: array<set<bool>> := new set<bool>[23];
			var v40: map<int, C0> := map[v1 := v7];
			var v41: map<int, set<bool>> := map[|v40| := fm8(v1, globalState)];
			v39[908] := {v7.f28, v0, v0, v7.f28, v7.f28} - (if (330 in v41) then v41[330] else fm8(v1, globalState));
			v39[908] := v5 - (v5 + v5);
		} else {
			var v42 := 'l';
			...
			v1, v7, v42 := v1, v45[|(v48 + v48)|], v49.cf19;
			...
			var v56: map<string, int> := map[seq(-0x2df, i5  => (v42)) := |v55|];
			...
			v57 := v57[if (v3[765]) then v1 else fm3(v1, v7.f28, v1, v59[|v46|], globalState) := v1];
		}
	...
	globalState.f0, v0, globalState.f0, v1 := v60 !! v60, true, v7.f28, |(v63[|[v1, v1]|] + v62)| - v1;
	if (!v7.f28) {
		v1 := v1;
		globalState.f0 := v7.f28;
		...
		if (v65.cf1) {
			...
			var v75 := 'i';
			var v76: array<D6> := new D6[10] [v72, v72.(cf25 := v73).(cf24 := v74), v72, v72, v72, v72, v72.(cf25 := v73[|v2| := v75]), v72, v72, v72];
			v76[929] := DC16(v74, v73);
			v76[929] := if (v7.f28) then v72 else v72;
			globalState.f0 := v7.f28;
			v72 := v72;
		} else {
			...
			v78 := if (|("ysstjicth" + (seq(-0x2f6, i6  => ('h'))))| in v79) then v79[|("ysstjicth" + (seq(-0x2f6, i6  => ('h'))))|] else v78;
			var v80 := "ipw";
			var v81: map<int, string> := map[v1 := v80];
			v3, globalState.f2, v1, globalState.f0 := fm10(-0x2a8 + v1, v1, v1, globalState), (v80 + (if (v1 in v81) then v81[v1] else v80)) + v80, 491 % v1, v7.f28;
			v7.f29[738] := v1;
			v7.f29[738] := v1;
		...
		v84[57] := set v85 : int | (-913 <= v85) && (v85 < 0x148) :: (v85 - |multiset{v1, v1}|);
		v84[57] := v4;
	} else {
		var v86: map<bool, int> := map[v0 := v1];
		v1 := (if (!!v7.f28 in v86) then v86[!!v7.f28] else v1) + v1;
		globalState.f0 := true;
		v61[488] := v7.f28 <== v7.f28;
		var v87 := "dicp";
		var v88: seq<int> := [v1];
		v3, v1, v61[488] := v3, if (v0) then |(v87 + "dqnhuuat")| else -v88[v1], v7.f28;
		var v89: array<bool> := new bool[13] [v61[488], v60 !! multiset{v0, v0, v7.f28, v0}, v0, false, v7.f28, v61[488], true, v7.f28, v61[488], multiset{0x2a0} == multiset(seq(0x2f0, i7  => (|v88|))), v61[488], v7.f28, v7.f28];
		v89 := v89;
		var v90: seq<C0> := [v7, v7, v7];
		var v91: map<int, bool> := map[v1 := v61[488]];
		v7 := v90[fm3(0x1f6, false, v1, v91, globalState)];
	}
	...
	match (v92) {
		case DC1(cf1, cf2) =>
			...
			v94, globalState.f0, cf2, v1 := v94 + (v94 + v94), !v7.f28 <== (v95[cf2] == v4), cf2 / -|v96|, cf2;
			if (v1 != v1) {
				var v97 := new C0(v7.f28, v7.f29);
				v7.f29[804] := 0x1fb * cf2;
				v7.f29[804] := |(v2 + v2)|;
				...
				var v102 := DC0(v99);
				var v103: map<int, multiset<int>> := map[v7.f29[804] := v99];
				var v104: array<multiset<int>> := new multiset<int>[18] [v99 + v99, v99[0xbb := v7.f29[804]] - v99, v99, multiset{|v100|, cf2, v1, |v100|, v1} * v99, multiset{---|v101|}, v99, (multiset(v96))[v1 := v1], v99, v99, multiset(v96), v99 * v99, v102.cf0, multiset([v1]), v99, v99, v99, (if (705 in v103) then v103[705] else v99)[cf2 := v1], multiset{cf2, -0x297}];
				v104[414] := multiset(v96);
				var v105 := 'b';
				...
				var v112: multiset<string> := multiset{"f", v100, v100, "a", seq(55, i8  => (v105))};
				var v113 := DC18(v7.f28);
				v98, v7.f29[804], v104[414], globalState.f0, v107 := v98, |(v110 + [v97, v97, v97])[0x17d := v97]|, v99, (multiset(v111) - v112) > (if (v97.f28) then fm11(-0x282, 'a', globalState) else v112), fm12(v1, v7.f29[804], if (v97.f28 in v60) then v60[v97.f28] else v7.f29[804], v113, globalState);
				v61[991] := v7.f28;
				v61[991] := v7.f28;
				v7.f29[804] := cf2 + (v1 * v7.f29[804]);
			} else {
				v93 := v93[v1 := v7.f28];
				v7 := v7;
				var v114 := DC11(v61);
				...
				v115[346] := 'k';
				var v116 := 'p';
				v114, v115[346] := DC11(v61).(cf17 := v61), v116;
				v7.f29[767] := 0x15;
				var v117: multiset<int> := multiset{-0x144};
				v7.f29[767] := -(if (v1 in v117) then v117[v1] else v1);
				var v118: seq<array<bool>> := [v61, if (v7.f28) then v61 else v61, v61];
				v7.f29[767], v61, cf2 := v1, v118[v7.f29[767]], v1;
			}
		...
		case DC2(cf3) =>
			...
			match (v126) {
				case DC14(cf20) =>
					...
					v7.f29[878] := v1;
					v7.f29[878] := v1;
					v1 := v7.f29[878] - v7.f29[878];
					var v128: seq<string> := [v125];
					globalState.f2 := v128[v1];
				...
				case DC16(cf24, cf25) =>
					...
					var v133 := DC19(v132);
					var v134 := DC19(v132);
					v131[24], v7, globalState.f2, v134 := v130, if (v0) then v7 else v7, fm9(globalState), v134;
					v4 := v4;
					v1 := |cf25| / v1;
					var v135: map<int, bool> := map[-(v1 / v1) := v7.f28];
					var v136: seq<int> := [v1];
				...
				case DC13(cf19) =>
					...
					var v138 := DC4(v1 <= v1);
					v1, v138, globalState.f0, globalState.f0, v6 := v1 % v1, v138, v7.fm2(v7.f28, globalState), !v7.f28 || v137.f28, v137.f29;
					v1 := v1 - -v1;
			}
			...
			var v143: seq<C0> := [v7];
			var v144: multiset<int> := multiset{|(seq(597, i9  => ('f')))|, |v143|};
			var v145 := DC20(v5);
			var v146: array<map<char, array<char>>> := new map<char, array<char>>[24] [v141, v141, v142[if (v1 in v144) then v144[v1] else |v145.cf29|], v141, v141, map[v139 := v140], v141, v141, v141 + v141, v142[-0x1a9], v141, v141, v142[267], map[v139 := v140] + v141, map[v139 := v140], v141, v141, v141, v141[v139 := v140], v141, v141, v141, map[v139 := v140] + v141[v139 := v140], v141[v139 := v140] + v141];
			v146[957] := v141;
			v146[957] := v141 + map[v139 := v140];
			var v147: map<int, bool> := map[v1 := v7.f28];
			v1 := v1 % --(|v147| - v1);
			v7.f29[649] := 0x15a;
			v7.f29[649] := v1 - v92.cf2;
	}
...
method Main() {
	...
	var globalState := new GlobalState(true, {if (v0 in v1) then v1[v0] else v0} - v2, v3, v4, v8, -0x3a1, 851, true, v11, 0x5a, -909, 917, 0x150, v12, 0xce, 664, -0x1b0, v13 + (map v14 : string | v14 in (seq(-0xbf, i1  => ("incqt")))[v5 := v3] :: (v14) := (DC0(multiset{v5}).cf0)), true, v15, v3[v5 := v9], -661, -0x59, [v5], true, 0x351, false, v20);
	m0(globalState);
	if (|v4| == |v20|) {
		v5 := |v3|;
		...
		v12[59] := |v7|;
		v12[59] := -|(v1 + v1[v0 := v0])|;
		var v25: array<int> := new int[21](i2 => i2 % |v8|);
		var v26 := new C0(v0, v25);
		globalState.f0 := v26.f28;
		v5 := v12[59];
		var v27: array<bool> := new bool[11];
		var v29: multiset<map<int, bool>> := multiset{v20, map[v12[59] := v26.f28], map v28 : int | v28 in (seq(-0x188, i3  => (|DC6(multiset{v26.f28}).cf7|))) :: (v28 / v5) := (v26.f28), v20, v20};
		v27[414] := |v29| < v12[59];
		v27[414] := v26.f28;
	}
	...
	v30 := v30 + (v30 + v30);
	var v31: multiset<int> := multiset{-v5 / -v5};
	...
	var v40: seq<map<bool, array<int>>> := [v39[v5]];
	v38 := v38[v40[v5] + v35 := true];
	...
	for i5 := |(v30 + v30)| to |v41| {
		...
		v4 := (if (|(map[v43 := v5] + (map[v36 := -0xc7])[v43 := i5])| in v44) then v44[|(map[v43 := v5] + (map[v36 := -0xc7])[v43 := i5])|] else [!v36.f28])[i5 + v5 := v36.f28];
	}
	v32 := v32;
	var v45 := DC10(v36.f28, 0x119, v0, v5, v36.f29);
	v5 := |"iy"| % fm3(v5, v36.f28, |[!v45.cf14]|, fm5(v9, globalState), globalState);
