...
class C1 extends T0 {
	...
	method m9(globalState: GlobalState) returns (r0: char, r1: int, r2: char, r3: bool) {
		...
		v6, r2, v7, v1, globalState.f12 := v6 + v6, v6[safeIndex(|v8|, |v6|)], match v10 {
			case DC8(cf15, cf16, cf17) => v7 * DC1(v7).cf1
			case DC9(cf18, cf19, cf20, cf21) => v7
			case DC7(cf14) => v7
		}, (v1 + v1) + (v11[safeIndex(|v6|, |v11|)] + v11[safeIndex(v0, |v11|)]), fm22(|v6|, v0, v12 <= {|v5|}, globalState);
		if (!fm1(f43, v0 * v0, globalState)) {
			var v13 := 't';
			var v14: map<char, seq<int>> := map[v13 := v5];
			var v15: array<seq<int>> := new seq<int>[24] [v5, v5, fm23(f28, fm24(f29, 0x1e9, globalState), globalState), v5, v5[safeIndex(v0, |v5|) := fm24(false, fm24(false, v0, globalState), globalState)], v5, v5, v5, v5, [v0], v5, v5, seq(abs(0x178), i0  => (|v6|)), seq(abs(0x3bb), i1  => (v0)), fm23(f43, |v6|, globalState), v5, v5, if (v13 in v14) then v14[v13] else v5, fm23(f29, v0, globalState), v5, v5, ([v0, 0x2ba, 0x147])[safeIndex(v5[safeIndex(0x63, |v5|)], |[v0, 0x2ba, 0x147]|) := |v3|], v5 + v5, if (f28) then v5 else v5];
			v15[safeIndex(956, v15.Length)] := v5;
			var v16 := DC15(seq(abs(-0x220), i2  => (v0)));
			v15[safeIndex(956, v15.Length)] := v16.cf32;
			var v17 := DC10(v3 + v3);
			match (v17) {
				case DC11(cf23, cf24, cf25) =>
					var v18: multiset<char> := multiset{v13};
					var v19: seq<bool> := [f43, f28];
					globalState.f12 := v3 !! v3[DC8(v18, v19[safeIndex(cf25, |v19|)], cf23).cf17 := abs(|v6|)];
					var v20: array<int> := new int[22];
					v20[safeIndex(251, v20.Length)] := fm24(cf24, 818, globalState);
					var v21: seq<string> := [v6, (v6 + v6)[safeIndex(|map[v0 := v19]|, |(v6 + v6)|) := v13]];
					v20[safeIndex(251, v20.Length)], v19 := |v21[safeIndex(cf25 - fm24(f43, fm24(f28, cf23, globalState), globalState), |v21|)]|, v19;
					globalState.f12 := f29;
					cf25 := v20[safeIndex(251, v20.Length)] - (v0 + cf25);
				case DC10(cf22) =>
					var v22: array<bool> := new bool[19];
					v22[safeIndex(439, v22.Length)] := f29;
					v22[safeIndex(439, v22.Length)] := f43;
					globalState.f12 := f29;
			...
			if (f29) {
				...
				v23[safeIndex(434, v23.Length)] := fm1(f28, v0, globalState);
				v23[safeIndex(434, v23.Length)] := if (f28) then f29 else f43;
				...
				v25[safeIndex(104, v25.Length)] := v0 - v0;
				v25[safeIndex(104, v25.Length)] := safeModuloInt(v0, 0xf);
				r1 := v0;
				v25[safeIndex(104, v25.Length)] := if (f29) then v25[safeIndex(104, v25.Length)] else v25[safeIndex(104, v25.Length)] * v25[safeIndex(104, v25.Length)];
				var v26: map<int, string> := map[-safeDivisionInt(v25[safeIndex(104, v25.Length)], v25[safeIndex(104, v25.Length)]) := v6];
				v26 := v26[v25[safeIndex(104, v25.Length)] := v6];
				var v27: seq<bool> := [f43];
				var v28: map<bool, bool> := map[v0 > |v6| := v27[safeIndex(|v7|, |v27|)]];
				v28 := v28[f29 := f28];
			}
			
			r2 := 'h';
			var v29: array<bool> := new bool[12];
			v29[safeIndex(209, v29.Length)] := f28;
			v29[safeIndex(209, v29.Length)] := !(v0 >= v0);
			r3 := if (f28 ==> f43) then !fm22(v0, v0, f28, globalState) else f29;
			var v30: array<int> := new int[20](i3 => i3 * v0);
			v30[safeIndex(445, v30.Length)] := v0 * v0;
			var v31: map<bool, bool> := map[f28 := f28];
			var v32: set<map<bool, bool>> := {v31, v31};
			v30[safeIndex(445, v30.Length)] := |v32|;
		}
	...
	method m10(globalState: GlobalState) returns (r0: map<bool, seq<bool>>) {
		...
		var v2: array<int> := new int[20](i0 => safeModuloInt(i0, v1));
		var v3: set<array<int>> := {v2};
		var v4: array<T1> := new T1[26];
		var v5 := DC5(v4);
		var v6: map<bool, D2> := map[v3 >= {v2} := if (f29) then v5 else DC5(v4)];
		v1, globalState.f12, v6 := -(v1 - safeModuloInt(v1, 0x186)), false, v6;
		var i1 := 0;
		while (!f28)
			decreases 100 - i1
		{
			...
			var v12 := m0(v10, v11[safeIndex(|(seq(abs(0x170), i3  => (0x2f6)))|, |v11|)], -v1, f29, globalState);
		...
		v16[safeIndex(690, v16.Length)] := f43;
		v16[safeIndex(690, v16.Length)] := f29;
		var v17: array<char> := new char[18];
		var v18 := new C0(v17);
		var v19: set<int> := {v1, v1};
		v1 := safeDivisionInt(0x1ba, |map[v19 := v1]|);
		var v20: map<bool, seq<bool>> := map[!v16[safeIndex(690, v16.Length)] := [f28, !!!f29, f29, f28, f29]];
	...
	method m13(p0: seq<string>, p1: map<bool, int>, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			if (f31) {
				...
				globalState.f13 := f46;
				globalState.f13 := f46;
				v1[safeIndex(333, v1.Length)] := f31;
				var v4 := "d";
				v1[safeIndex(333, v1.Length)] := |v4| < f46;
				v1[safeIndex(333, v1.Length)] := v1[safeIndex(333, v1.Length)];
			...
			v7[safeIndex(542, v7.Length)] := v8;
			var v9: map<bool, bool> := map[f28 := f29];
			v7[safeIndex(542, v7.Length)], globalState.f13, globalState.f13 := {f28, f29} + v8, if (true <==> f31) then f46 else f46, f46 + (|v9| * f30);
		}
		var v10: array<set<int>> := new set<int>[27](i2 => {f46, -0x226} + {p3});
		forall i1 | 0 <= i1 < v10.Length {
			v10[i1] := ({f30, f30} - {v0[safeIndex(f46, |v0|)]}) * ({p3} + {950});
		}
		...
		var v15 := "xuygtgj";
		v14 := (fm0(safeModuloInt(|v15|, f30), f29, f29, 0x328, globalState))[safeIndex(f30, |fm0(safeModuloInt(|v15|, f30), f29, f29, 0x328, globalState)|) := true];
		var v16: map<bool, array<char>> := map[fm1(p2, |p1|, globalState) := v13.f37];
		var v17 := new C0(if (p2 in v16) then v16[p2] else v13.f37);
		r0 := |((seq(abs(61), i3  => ('u'))) + v15)| <= v0[safeIndex(f30, |v0|)];
	}
}
...
class C3 extends T4 {
	...
	function fm7(p0: multiset<int>, p1: int, globalState: GlobalState): bool {
		("vsrndyx" + "jsqkph") <= ("mfxuo" + (seq(abs(0x2a1), i0  => (f36))))
	}
	function fm6(globalState: GlobalState): bool {
		f29
	}
	function fm4(p0: bool, p1: set<int>, p2: int, p3: bool, globalState: GlobalState): set<int> {
		{if (f35) then f34 else -f34, f34, f34 - f30, f30, safeDivisionInt(f30, f30)}
	}
	function fm5(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<bool> {
		(f32 + f32) + f32
	}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		...
		if (v1 > (v1 - v1)) {
			var v2 := "mmi";
			var v3: map<int, int> := map[f30 := |v2[safeIndex(f30, |v2|) := v2[safeIndex(f30, |v2|)]]|];
			var v4: multiset<int> := multiset{f44};
			var v5: T1 := new C2(|fm31(fm32(!f28, globalState), v3, (DC14(f35, f44).(cf31 := -0x12)).cf30, f32[safeIndex(|v4|, |f32|)], globalState)|, 0x1c6, f34 == f30, f35, f32[safeIndex(0x384, |f32|)]);
			v5 := if (f31) then v5 else v5;
			var v6: map<bool, int> := map[v5.f31 := f44];
			var v7 := DC13(v5.f31, v6, f36);
			match (v7) {
				case DC13(cf27, cf28, cf29) =>
					globalState.f13 := safeModuloInt(|multiset{f34}|, f34);
					var v8: seq<int> := [f34, v5.f30];
					var v9: array<int> := new int[10] [fm32(f28, globalState), v8[safeIndex(v5.f30, |v8|)], v5.f30 + |(seq(abs(0xee), i0  => (cf29)))|, |v8|, -f30, v5.f30, f34, -0x5b, safeDivisionInt(v5.f30, v5.f30), f30];
					v9 := new int[1];
					...
					var v14: seq<D1> := [v12];
					var v15: array<multiset<D1>> := new multiset<D1>[14] [multiset{v12, v12.(cf7 := v11), v12, DC4(v11), v12}, v13 + v13, v13, v13, v13, v13[DC4(v11) := abs(|v2|)], v13, v13, v13 * v13, multiset{DC4(v11)}, v13, v13, if (v5.f29) then multiset(v14) else v13, v13];
					v15[safeIndex(980, v15.Length)] := multiset{v12};
					var v16: seq<seq<D1>> := [v14, v14];
					v15[safeIndex(980, v15.Length)] := multiset(if (v5.f31) then v14 else v16[safeIndex(v5.f30, |v16|)]);
					globalState.f12 := v5.f29;
				case DC14(cf30, cf31) =>
					v5.f31 := !v5.f31;
					globalState.f1 := !f28;
					var v17: array<bool> := new bool[28];
					v17[safeIndex(42, v17.Length)] := v5.f31;
					var v18: map<int, bool> := map[0xf2 := false];
					var v19 := DC6(f34, v5.f28, |v18|, f31, v5.f30);
					var v20: seq<D2> := [v19, v19];
					var v21 := DC6(safeModuloInt(fm32(f31, globalState), f30), v19 !in v20, v5.f30, v5.f29, f44);
					var v22 := DC14(v5.f31, f30);
					v17[safeIndex(42, v17.Length)], v19, cf31, globalState.f12, v5.f28 := f31, if (true) then v21 else v19, 0xe3 * f34, fm1(v22.cf30, f30 + f30, globalState), if (if (f35) then f28 else v5.f31) then v5.f31 else [cf30] == f32;
					globalState.f13 := safeDivisionInt(if (f32[safeIndex(cf31, |f32|)]) then -11 else v5.f30, f30);
				case DC12(cf26) =>
					...
					v26[safeIndex(914, v26.Length)] := |v6|;
					v26[safeIndex(914, v26.Length)], v5.f31 := fm32(v25, globalState), v5.f29;
					var v27: C1 := new C1(f31, v5.f29, v5.f28);
					var v28: multiset<C1> := multiset{v27};
					globalState.f1 := v28[v27 := abs(895)] !! v28[v27 := abs(f34)];
			}
		...
		for i1 := f30 to f44 - (if (f31 in v37) then v37[f31] else f44) {
			...
			v47[safeIndex(277, v47.Length)] := fm32(f29, globalState) == i1;
			v47[safeIndex(277, v47.Length)] := fm7(v39, safeDivisionInt(|v45|, f44), globalState);
		...
		var v57: array<int> := new int[26] [f34, f30, |v52[safeIndex(v55.cf4, |v52|)]|, f34, f44 + |v54|, f44 * f34, f30, -0x242, f44, f30, f34, f30, f44, f34, |map[f30 := 0x151]| * f30, f30 + f44, -f34, f34, f34 - f30, f34, if (f28) then -f34 else f44, if (-f44 in v56) then v56[-f44] else |[f36]|, safeDivisionInt(f44, |v54|), f44, f44, if (!f35 in v37) then v37[!f35] else f44];
		v57 := v57;
		if (fm6(globalState)) {
			if (f35) {
				...
				v54, globalState.f21, v54 := "d", v58, (fm3(!(v57 !in v59), f29, globalState))[safeIndex(safeDivisionInt(|v56|, f30), |fm3(!(v57 !in v59), f29, globalState)|) := v54[safeIndex(-|v52|, |v54|)]];
				v57[safeIndex(616, v57.Length)] := f30;
				v57[safeIndex(616, v57.Length)] := f34 - f30;
				var v60: seq<int> := [-v57[safeIndex(616, v57.Length)]];
				globalState.f12 := -(|v60| * v57[safeIndex(616, v57.Length)]) > f34;
				v58[safeIndex(836, v58.Length)] := !false;
				v58[safeIndex(836, v58.Length)] := f44 < f30;
			} else {
				r2 := v54;
				var v61: map<bool, char> := map[f31 := f36];
				var v62: map<char, int> := map[if (f35 in v61) then v61[f35] else f36 := |v54|];
				v57[safeIndex(169, v57.Length)] := safeDivisionInt(|v62|, |map['g' := f34]|);
				...
				v66[safeIndex(467, v66.Length)] := f35 || f29;
				var v67: set<int> := {|(seq(abs(0x37f), i2  => (f36)))|};
				v57[safeIndex(169, v57.Length)], v66[safeIndex(467, v66.Length)] := f44, {f30} >= (set v68 : int | v68 in v67 :: (safeModuloInt(v68, |"aohlb"|)));
				globalState.f13 := v63.cf11 * v57[safeIndex(169, v57.Length)];
				var v69: map<bool, int> := map[v66[safeIndex(467, v66.Length)] := v57[safeIndex(169, v57.Length)]];
				var v70: multiset<map<bool, int>> := multiset{v69, v69, if (f35) then v69 else v69};
				v70 := v70;
				globalState.f12 := v66[safeIndex(467, v66.Length)];
			}
			
			var v71: array<bool> := new bool[1](i3 => if (f29) then f28 else f35);
			v71[safeIndex(727, v71.Length)] := f29;
			v71[safeIndex(727, v71.Length)] := (f28 ==> f28) !in f32;
			globalState.f13 := fm32(true, globalState);
			var v72: map<int, bool> := map[f30 := f31];
			f36 := fm34(|v72[f44 := f28]|, f34, f44, f31, globalState);
			v57[safeIndex(146, v57.Length)] := f30;
			v57[safeIndex(146, v57.Length)] := safeModuloInt(fm32(v71[safeIndex(727, v71.Length)], globalState), f30);
		} else {
			globalState.f13 := fm32(f28, globalState) * f30;
			r0 := f28;
			var v73: seq<int> := [f34, 307, safeDivisionInt(f34, 0x17d), f44, f30];
			var v74: multiset<seq<int>> := multiset{v73};
			v73, f29, globalState.f26 := [if (f31) then |v74| else f44, -f30, f44, f34, safeModuloInt(f34, -0x1bd)], f30 !in multiset(v73 + v73), !(f44 < (f30 + f34));
			...
			v76 := v76[f34 - |(f32[safeIndex(|v77|, |f32|) := f29])[safeIndex(f30, |f32[safeIndex(|v77|, |f32|) := f29]|) := f31]| := v75];
			globalState.f13 := f30;
		}
		...
		r1 := v84[safeIndex(f34, |v84|)];
		r2 := (seq(abs(0x39e), i4  => (f36)))[safeIndex(f44, |(seq(abs(0x39e), i4  => (f36)))|) := f36] + (v54 + v54)[safeIndex(f44, |(v54 + v54)|) := f36];
	}
	method m12(p0: int, p1: map<map<int, int>, bool>, globalState: GlobalState) returns (r0: set<int>, r1: bool) {
		...
		if (f29 || v3.cf16) {
			...
			v2, globalState.f1, v14, v15, v17 := |(multiset{v18} * v19[v18 := abs(f34)])|, f28, f32, v15[v2 := abs(|[p0, f30, v1[safeIndex(p0, |v1|)]]|)], v17;
			v13[safeIndex(604, v13.Length)] := !(f32[safeIndex(f44, |f32|)] <==> f29);
			globalState.f26, v14, v2, f36, v13[safeIndex(604, v13.Length)] := f35, v14 + (f32 + f32), v2, v18[safeIndex(v2, |v18|)], f31;
			var v20 := new C1(f35, f32[safeIndex(729, |f32|)], f31);
			globalState.f1 := f28;
		}
			...
			decreases 100 - i3
		{
			...
			v22[safeIndex(595, v22.Length)] := f29;
			v22[safeIndex(595, v22.Length)] := f28;
			var v23: multiset<int> := multiset{f34, f34, fm32(!v22[safeIndex(595, v22.Length)], globalState), f44};
			r1 := fm7(v23, f44, globalState);
			var v24: array<char> := new char[4];
			v24[safeIndex(246, v24.Length)] := f36;
			var v25 := DC13(f29, map[v22[safeIndex(595, v22.Length)] := f30], 'y');
			v24[safeIndex(246, v24.Length)] := v25.cf29;
		}
		var v26 := new C2(f34, -v2, !f35, !f31, f31);
		var v27: seq<char> := [f36, f36];
		var v28: map<char, bool> := map[f36 := v27 <= (seq(abs(377), i5  => ('y')))];
		var v29: array<multiset<bool>> := new multiset<bool>[9];
		var v30: multiset<char> := multiset{f36};
		var v31: seq<array<multiset<bool>>> := [v29];
		globalState.f13, v28, v29 := if (f36 in v30) then v30[f36] else |map[f35 := f35]| * p0, v28, v31[safeIndex(|f32|, |v31|)];
		var v32: set<int> := {v2};
		r0 := v32 + (v32 + v32);
		r1 := f28;
	}
...
class C4 extends T3 {
	...
	function fm4(p0: bool, p1: set<int>, p2: int, p3: bool, globalState: GlobalState): set<int> {
		((set v0 : int | (460 <= v0) && (v0 < 658) :: (safeModuloInt(v0, f34))) - {972}) + ({f34} + {|{f28}|})
	}
	function fm5(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<bool> {
		f32
	}
	function fm3(p0: bool, p1: bool, globalState: GlobalState): string {
		if (multiset(seq(abs(845), i0  => (f30))) > multiset{f30}) then "fe" else "sjcbfbtrq"
	}
	function fm2(globalState: GlobalState): map<bool, int> {
		map[{f31} >= {!!f32[safeIndex(f34, |f32|)]} := f34]
	}
	function fm44(p0: int, globalState: GlobalState): bool {
		safeModuloInt(f30, -f30) > f30
	}
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		f35 := f31;
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			var v5: array<set<bool>> := new set<bool>[23] [fm45(f30, v0, f35, |f32|, globalState), DC33(v1).cf64 - {f29, false, f29, f35, f31}, v1, if (v2 in v3) then v3[v2] else v1, v1 - v1, v1, v1, v1, v1, {f35} - fm45(-f30, v0, f35, f34, globalState), v1 * v1, v4[safeIndex(133, |v4|)], v1, v1, v1, v1, v1, v1, fm45(f30, v0, f35, |map[fm6(globalState) := f34]|, globalState), {true}, v1, v1, v1];
			v5 := v5;
			var v6: multiset<int> := multiset{f30, 355};
			if (f32[safeIndex(fm46(f34, |v6|, f28, globalState), |f32|)]) {
				var v7: set<int> := {f34, f34};
				r1 := safeDivisionInt(|(v7 - v7)|, |v6|);
				var v8: map<int, bool> := map[f34 := f29];
				var v9: array<int> := new int[12] [|f32|, f30, f30, f34 * f30, |v8|, f30, f30, safeDivisionInt(f30, f30), f34, if (f29) then f34 else |"khil"|, -safeModuloInt(f34, f34), f34];
				v9[safeIndex(655, v9.Length)] := f30 * -f30;
				v9[safeIndex(655, v9.Length)] := 0x322;
				globalState.f13 := |(v7 + v7)|;
				v9[safeIndex(655, v9.Length)] := --v9[safeIndex(655, v9.Length)];
				globalState.f1 := f30 < v9[safeIndex(655, v9.Length)];
			} else {
				v2[safeIndex(443, v2.Length)] := f30 == f30;
				v2[safeIndex(443, v2.Length)] := f29;
				globalState.f13 := |(v6 - v6)|;
				globalState.f13 := f30;
				r1 := |f32|;
				v2[safeIndex(443, v2.Length)] := f28;
			}
			
			var v10 := 'p';
			v10 := v10;
			var v11: array<array<bool>> := new array<bool>[18] [v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2];
			v11[safeIndex(658, v11.Length)] := v2;
			...
			var v16: map<bool, bool> := map[f35 := v15[safeIndex(0x1cb, |v15|)] >= v13];
			v11[safeIndex(658, v11.Length)], v12, v13, v16 := v2, v12 - (multiset(([f32, f32])[safeIndex(f30, |[f32, f32]|) := f32]) + v12), v13, v16 + v16;
		}
		r1 := f30;
		if (f35) {
			...
			v17[safeIndex(445, v17.Length)] := fm47(f29, v19, globalState) + v20;
			var v21: array<bool> := new bool[26];
			var v22: map<array<bool>, bool> := map[v21 := f28];
			var v23: seq<int> := [f34];
			var v24 := DC24(f28, f34, f32, f31, v23);
			var v25: array<bool> := new bool[9] [|v22| > f34, f31, if (f31) then true else fm1(f31, f30, globalState), 711 == 238, v23[safeIndex(f34, |v23|)] !in v24.cf50, true, f29, f31, f32 != [f31, f31]];
			globalState.f26, r1, v17[safeIndex(445, v17.Length)], globalState.f21, globalState.f12 := f31, f30 + 0x34d, map[|"yowl"| + f34 := seq(abs(0x20e), i1  => (v18))], v25, true;
			globalState.f13 := f34 + f34;
			var v26 := "uiiih";
			f31 := f32[safeIndex(--|(v26 + v26)|, |f32|)];
			var v27: map<int, bool> := map[f30 := f29];
			var v28: array<int> := new int[5] [|{0x3a3}|, -f34, |(v27 + map[-0x22d := f35])|, safeModuloInt(f30, f34), f30];
			v28[safeIndex(748, v28.Length)] := |map[!f28 := f34]|;
			v28[safeIndex(748, v28.Length)] := f30;
			...
			var v41 := new C3(f34, v29, v18, f34, !f35, f32[safeIndex(f34, |f32|) := f29], f33, if (f29 in v37) then v37[f29] else f30, v40.cf3, !f29, f31);
		} else {
			...
			globalState.f1 := f35;
			var v48 := "hngyxcapn";
			var v49: array<char> := new char[3] [v44, v44, v48[safeIndex(f30, |v48|)]];
			v49[safeIndex(724, v49.Length)] := v44;
			v49[safeIndex(724, v49.Length)] := if (fm6(globalState)) then v44 else v44;
		...
		r1, globalState.f13, v51 := safeDivisionInt(f30, f30), safeModuloInt(|(v52 * v52)|, if (f29) then |v53| else f30), v51 * v51;
		var v54 := "cmjcaq";
		var v55: set<string> := {v54};
		var v56 := 'h';
		globalState.f13 := |((v55 * {v54, v54, v54[safeIndex(-f34, |v54|) := v56]}) - (v55 + v55))|;
...
class C5 extends T3, T2 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		...
		var v5: seq<int> := [f48];
		var v6: map<bool, bool> := map[!f28 := v5 <= (seq(abs(0x281), i0  => (f48)))];
		var v7: seq<bool> := [f32[safeIndex(f34, |f32|)]];
		var v8: array<D4> := new D4[13];
		var v9 := DC11(|(seq(abs(0xf8), i1  => (v0)))|, true, f30);
		v8[safeIndex(423, v8.Length)] := v9;
		v6, v7, v8[safeIndex(423, v8.Length)], f35 := v6, v7, DC11(f30, f34 >= f48, -0x160), f35 ==> (f34 == f30);
		var v10: map<bool, int> := map[false := 0x3ad];
		var v11: multiset<bool> := multiset{f29};
		var v12: map<bool, char> := map[true := v0];
		var v13: array<int> := new int[29] [f30, f30, f48, v5[safeIndex(if (f34 in v2) then v2[f34] else f30, |v5|)], f30, f30, f34, f34, 381, f30, -f34, f48, f48, f48, |v5|, 0x323, f34, f34, f48, |multiset{f29, false, fm1(f28, if (f28 in v10) then v10[f28] else f48, globalState), f35, true}|, f48, |v11|, f34, f48, f48, f34, |v12|, f34, |(seq(abs(0x290), i2  => (v0)))|];
		var v14: set<array<int>> := {v13, v13, v13, v13, v13};
		v14 := v14;
		var v15 := DC22(|"djojhst"|, safeModuloInt(0x3b4, f48));
		match (v15) {
			case DC22(cf41, cf42) =>
				...
				if (!f28) {
					...
					v21[safeIndex(263, v21.Length)] := v16;
					v21[safeIndex(263, v21.Length)] := v16;
					...
					v22[safeIndex(580, v22.Length)] := v23;
					v13[safeIndex(529, v13.Length)] := cf41;
					var v24: array<string> := new string[14];
					v6, v22[safeIndex(580, v22.Length)], v13[safeIndex(529, v13.Length)], v24, v7 := ((map[f29 := f47])[f35 := f35])[f35 := f47], v23, cf41, v24, f32 + f32;
					...
					v25 := new int[22] [cf41, cf42, f30 + cf42, fm39(if (|v26| in v26) then v26[|v26|] else f28, v2, f31, globalState), safeModuloInt(cf42, |v27|), |(v5 + [v13[safeIndex(529, v13.Length)]])|, f30, fm39(false, v2, f29, globalState) * f48, f30, -0x27a, cf42, cf41, f34, safeDivisionInt(f30, |fm4(fm1(f35, v13[safeIndex(529, v13.Length)], globalState), v29, cf42, f28, globalState)|), fm39(f31, v2, !v28.f43, globalState), f30, |(v32 + v32)|, f48, f30, f34, v13[safeIndex(529, v13.Length)], f34];
					...
					var v34: set<int> := {f48};
					var v35: map<char, multiset<int>> := map[fm41(f35, v0, f29, f34, globalState) := v2[-f30 := abs(|v34|)]];
					v33[safeIndex(825, v33.Length)] := if (fm41(false, v0, f28, fm39(false, v2, f35, globalState), globalState) in v35) then v35[fm41(false, v0, f28, fm39(false, v2, f35, globalState), globalState)] else v2;
					v33[safeIndex(825, v33.Length)] := fm43(globalState);
					var v36: array<bool> := new bool[1] [f35];
					v36[safeIndex(643, v36.Length)] := f47;
					v36[safeIndex(643, v36.Length)] := f30 == f48;
				}
			...
			case DC23(cf43, cf44, cf45) =>
				v0 := v0;
				var v38 := "nujp";
				globalState.f1 := v38[safeIndex(f48, |v38|) := v0] < v38;
				f35 := false;
				globalState.f13 := f48;
			case DC24(cf46, cf47, cf48, cf49, cf50) =>
				...
				v0 := 'i';
				var v39 := "vvj";
				var v40: array<string> := new string[5] [v39, v39, v39, v39 + v39, v39[safeIndex(-f34, |v39|) := v0]];
				v40[safeIndex(528, v40.Length)] := v39;
				var v41: seq<string> := [seq(abs(0x351), i5  => (v0))];
				v40[safeIndex(528, v40.Length)] := v41[safeIndex(f30, |v41|)];
				var v42: seq<seq<int>> := [v5, cf50, cf50];
				var v43: map<seq<int>, bool> := map[v42[safeIndex(-cf47, |v42|)] := cf49];
				var v44 := DC15(v5);
			...
			case DC21(cf40) =>
				...
				var v47 := DC9(v45.fm30(f35, globalState), fm6(globalState), v46, v7[safeIndex(f48, |v7|)]);
				var v48 := DC15(v5);
				var v49: seq<seq<int>> := [v5];
				var v50 := DC24(f35, f34, f32, f28, v49[safeIndex(f34, |v49|)]);
			...
			case DC25(cf51) =>
				...
				v53 := map[|v54| := |v54|] + v55[safeIndex(f48, |v55|)];
				...
				match (v15) {
					case DC22(cf41, cf42) =>
						...
						var v59: array<map<int, bool>> := new map<int, bool>[10] [map v57 : int | v57 in v5 :: (safeDivisionInt(v57, |map[f35 := |{v5}|]|)) := (f31), v56, v56, v56, if (f47 in v58) then v58[f47] else v56, map[f30 := f35], v56, v56, v56, v56];
						var v60: array<array<map<int, bool>>> := new array<map<int, bool>>[9] [v59, v59, v59, v59, v59, v59, v59, if (f35) then v59 else v59, v59];
						v60[safeIndex(381, v60.Length)] := v59;
						var v61: set<int> := {|map[f29 := -0x85]|, |v6|, f48, cf41};
						var v63: array<bool> := new bool[17] [f28, v61 > (set v62 : int | (0x39 <= v62) && (v62 < 0x2f9) :: (v62 * f30)), !f47 || f47, fm1(f35, cf41, globalState) || f28, false, f28, f31, f47, false, f47, f35, fm6(globalState), f28, f29 !in (multiset(v7))[!f31 := abs(cf42)], f29, f35, f31];
						v63[safeIndex(135, v63.Length)] := f29;
						var v64: seq<string> := [seq(abs(889), i6  => (v0))];
						globalState.f13, v60[safeIndex(381, v60.Length)], v63[safeIndex(135, v63.Length)] := 788, v59, |(v64[safeIndex(cf41, |v64|)] + v54)| <= |v11|;
						globalState.f13 := f34;
					...
					case DC23(cf43, cf44, cf45) =>
						...
						v13 := v13;
					case DC24(cf46, cf47, cf48, cf49, cf50) =>
						globalState.f13 := safeModuloInt(f48, f34) - f34;
						...
						v71[safeIndex(224, v71.Length)] := v72 + v72;
						v71[safeIndex(224, v71.Length)] := if (if (f29) then true else f32[safeIndex(f48, |f32|)]) then v72 else map[f30 := f47];
						var v74: set<int> := {-|(set v73 : int | v73 in v71[safeIndex(224, v71.Length)] :: (v73 * |"hmcvtul"|))|, f30};
						var v76: seq<set<int>> := [v74];
						var v77: array<set<int>> := new set<int>[13] [v74, v74 - {f34, f34}, {-f30, f30}, set v75 : int | (0x2ce <= v75) && (v75 < -585) :: (safeModuloInt(v75, 0x1d6)), v74, v74 - v74, v74 - v74, v76[safeIndex(|cf50|, |v76|)], v74, v74, v74, v74, v74];
						v77[safeIndex(248, v77.Length)] := {cf47, f30};
						v77[safeIndex(248, v77.Length)] := fm4(cf49, set v78 : int | (-0x15a <= v78) && (v78 < 0x116) :: (safeDivisionInt(v78, cf47)), f34, cf46, globalState);
					case DC21(cf40) =>
						var v79: map<bool, multiset<int>> := map[f29 := v2 + multiset{f30}];
						v2, globalState.f12, globalState.f13 := if ((f28 <==> f29) in v79) then v79[f28 <==> f29] else v2[f48 := abs(|"gonoudi"|)], f47, f48 - f30;
						var v80: array<bool> := new bool[6] [false, f47 <==> f29, f30 > f48, !f28, true, f28];
						v80[safeIndex(690, v80.Length)] := if (f31) then f31 else f29;
						v80[safeIndex(690, v80.Length)] := false;
						var v81: multiset<D4> := multiset{v8[safeIndex(423, v8.Length)]};
						v80, v80[safeIndex(690, v80.Length)], v81 := v80, !((|(map v82 : int | v82 in v5 :: (safeModuloInt(v82, f30)) := (v54))| - |v54|) >= |v7|), multiset{DC11(f30, v80[safeIndex(690, v80.Length)], f30)};
						f29 := false;
					case DC25(cf51) =>
						f35 := (v7 + f32) < (fm5(f48, f48, f47, f48, globalState) + f32);
						var v83 := new C1(v54 <= (seq(abs(314), i9  => ('b'))), f34 == |"tsm"|, f31);
						globalState.f26 := v83.f43;
						var v84: array<bool> := new bool[29];
						globalState.f21 := v84;
				}
				
				globalState.f13, f29, globalState.f12 := fm39(f28, v2, !f31, globalState), f30 < f48, 0x166 == (if (f28 in v11) then v11[f28] else |v5[safeIndex(f34, |v5|) := f48]|);
		}
		...
		r2 := ("l" + v86)[safeIndex(0xd5, |("l" + v86)|) := v0];
	}
	method m14(p0: char, p1: array<bool>, p2: D6, globalState: GlobalState) returns (r0: bool, r1: char) {
		for i0 := f30 to |"bxgmww"| {
			globalState.f12 := f28;
			globalState.f13 := safeDivisionInt(i0, i0 - i0);
			var v0: map<int, int> := map[0x49 := |(seq(abs(0x89), i1  => (p0)))|];
			...
			match (v3.(cf59 := v4)) {
				case DC29(cf56, cf57) =>
					...
					p1[safeIndex(637, p1.Length)] := f31 !in map[v1.f31 := v5];
					p1[safeIndex(637, p1.Length)] := v1.f29;
					var v6 := "xji";
					var v7: map<string, int> := map[v6 := f30];
					v7 := v7;
					var v8: array<string> := new seq<char>[29](i2 => seq(abs(0x13b), i3  => (p0)));
					v8[safeIndex(472, v8.Length)] := v6;
					v8[safeIndex(472, v8.Length)] := seq(abs(0x336), i4  => (p0));
				case DC30(cf58, cf59) =>
					globalState.f13 := f48;
					...
					var v18: array<seq<bool>> := new seq<bool>[26] [v1.f32, v1.f32, v1.f32, v1.f32, v1.f32, v1.fm5(|(if (f48 in v13) then v13[f48] else v12)|, f34, f47, v1.f30, globalState), v1.f32, v1.f32, f32, [v1.f28, v1.f29], v1.f32, v1.f32, v1.f32, v1.f32, v1.f32, v1.fm5(|v14|, f30, v1.f29, |(map v15 : int | v15 in v17 :: (safeModuloInt(v15, |map[f29 := f30]|)) := (v1.f28))|, globalState), [f29], f32, [v1.f35], v1.f32, v1.f32, f32, v1.f32, v1.f32, [f47, v1.f35, f28], v1.f32];
					var v19: T4 := new C3(0x37d, v18, p0, fm46(|v12|, f34, f31, globalState) * v1.f34, !!f32[safeIndex(v1.f30, |f32|)], [false] + v1.f32, v1.f33 + f33, v1.f30, !(if (v1.f35) then v1.f31 else f35), if (v1.f31) then true else false, true);
					v19 := v19;
					var v20: map<string, set<bool>> := map[seq(abs(0x278), i5  => (p0)) := v14];
					v20 := v20[v12 + (fm3(f47, v1.f28, globalState))[safeIndex(if (|v0| in v0) then v0[|v0|] else |f32|, |fm3(f47, v1.f28, globalState)|) := v19.f36] := v14];
				case DC31(cf60, cf61, cf62) =>
					p1[safeIndex(628, p1.Length)] := v1.f32[safeIndex(0x3bf, |v1.f32|)];
					var v21 := DC19(f47, v1.f34, v1.f34);
					p1[safeIndex(628, p1.Length)] := v21.cf36;
					var v22: array<array<int>> := new array<int>[21];
					v22 := v22;
					var v23: C1 := new C1(false, p1[safeIndex(628, p1.Length)], false);
					var v24 := DC28(v23);
			...
			if (if (v31 <= multiset{f35, f47}) then f32 == f32 else true) {
				...
				var v33 := DC24(v1.f35, v1.f30, f32, v1.f31, v32[safeIndex(f48, |v32|) := f48]);
				var v34 := DC0(v1.f31);
				...
				var v41: map<set<int>, array<bool>> := map[set v40 : int | (0x7f <= v40) && (v40 < 0x148) :: (safeModuloInt(v40, v1.f34)) := p1];
				v37[safeIndex(739, v37.Length)] := map[v39 := p1] + v41;
				v37[safeIndex(739, v37.Length)] := v41;
				...
				var v45 := "sqrfmscn";
				p1[safeIndex(824, p1.Length)] := v45 != v45;
				p1[safeIndex(824, p1.Length)] := v1.f31;
				var v46: map<multiset<bool>, char> := map[v31 := p0];
				v46 := v46[v31[!v1.f31 := abs(v1.f30)] := v45[safeIndex(v1.f34, |v45|)]];
				globalState.f26 := fm1(v1.f28, v1.f34, globalState) in f32;
				f35 := v1.f28;
			}
			
		}
		if (!f32[safeIndex(-0xac, |f32|)]) {
			r1 := p0;
			...
			var v50 := new C3(safeDivisionInt(f30, f30), v49, p0, f48 * f30, f47 <==> f28, f32, f33, f30, false, f47, f35);
			globalState.f12 := (seq(abs(0x330), i6  => (f30))) < (seq(abs(0x2ad), i7  => (|"oaqupmrc"|)));
			var v51: seq<int> := [v50.f44];
			var v52: multiset<seq<int>> := multiset{v51, seq(abs(0x26a), i8  => (v50.f44)), p2.cf32};
			...
			var v65: array<int> := new int[9](i9 => i9 + DC19(f35, |(seq(abs(0x92), i10  => (f30)))|, f34).cf37);
			var v66 := DC0(f35);
			var v67: seq<D0> := [v66];
			var v68: set<int> := {f48};
			var v69 := DC6(-f30, f35, f34, f47, f34);
			var v70: multiset<int> := multiset{f48, f34};
			var v71: array<int> := new int[29] [|fm4(true, {f48, f48}, |(v61[safeIndex(|"kuntapvl"|, |v61|)])[safeIndex(f48, |v61[safeIndex(|"kuntapvl"|, |v61|)]|) := 'j']|, f28, globalState)| + |(set v62 : string | v62 in {"wa"} :: (v62))|, if (f48 in v63) then v63[f48] else f30, f48 - f30, -|v58| * (if (DC31(f29, f47, f48).cf61 in v64) then v64[DC31(f29, f47, f48).cf61] else f34), -safeModuloInt(f34, f30), f30, safeDivisionInt(f30, f34), |[v65, v65, v65, v65]|, |v67|, safeModuloInt(f30, f48), f48, f34 - f34, |v68|, safeModuloInt(-|[map[f29 := f48]]|, f30), v69.cf11 * -f30, f34, f34, f48, f30, f30, f30, f30, -f34, f48, |v68|, -0x274, if (f30 in v70) then v70[f30] else f34, f48 * fm39(f47, v70, f31, globalState), |v55|];
			v71[safeIndex(384, v71.Length)] := f48;
			var v72: map<bool, array<int>> := map[!true := v65];
			v71[safeIndex(384, v71.Length)], globalState.f13, globalState.f13 := 0x328, |v72| * fm39(f47, v70, f31, globalState), -f34;
		}
...
class C6 extends T4, T2 {
	...
	function fm5(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<bool> {
		f33[safeIndex(if (false) then f30 else f30, |f33|)]
	}
	function fm3(p0: bool, p1: bool, globalState: GlobalState): string {
		"crmrunqsx"
	}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		for i0 := f30 to f34 {
			...
			var v2: map<int, array<array<int>>> := map[i0 * i0 := v1[safeIndex(|[0x17c]|, |v1|)]];
			var v3: map<bool, array<array<int>>> := map[f35 := v0];
			v2 := v2[safeDivisionInt(i0, -558) := if (f28 in v3) then v3[f28] else v0];
			var v4 := "xku";
			var v5: map<int, string> := map[-0x12d := v4];
			if (i0 != |v5|) {
				var v6: seq<set<int>> := [{0x1dc, i0}];
				var v7: map<set<int>, seq<int>> := map[v6[safeIndex(f30, |v6|)] := [|map[f32 := f34]|]];
				var v8: set<int> := {0xc, i0, i0};
				var v9: array<seq<bool>> := new seq<bool>[1];
				var v10: map<bool, bool> := map[f31 := f28];
				var v11: T4 := new C3(i0, v9, v4[safeIndex(|[f34]|, |v4|)], f34, f29, f32, seq(abs(658), i1  => (f32)), |[|v10|, 0x183]|, f29, f31, f35);
				...
				var v15 := new C3(i0, v13[safeIndex(f34, |v13|)], if (v11.f36 in v14) then v14[v11.f36] else 'u', 35, f28, [v11.f29, v11.f28], f33, i0, !v11.f31 || f28, true, f31);
				...
				var v22 := DC12(seq(abs(-0x354), i2  => (v11.f36)));
			...
			v33 := f32 + [false, !f35];
			var v34: set<int> := {f30};
			v34 := (v34 - (set v35 : int | v35 in v34 :: (safeModuloInt(v35, |map['v' := -0xf6]|)))) - v34;
		}
		var v36: array<int> := new int[1];
		var v37: map<array<int>, int> := map[v36 := f30];
		var v38 := DC18(v37[v36 := f30]);
		v36[safeIndex(301, v36.Length)] := |(v38.(cf35 := v37)).cf35|;
		...
		var v47: array<map<D0, bool>> := new map<D0, bool>[25] [v41, if (f28) then map[v40 := f28] else v41, map[v40 := !!f35] + v41, v41, v42.cf40 + v41, v41, v41, v41, v41, map[DC1(v39) := fm1(f31, f34, globalState)], v41, fm35(f35, globalState), v41, map[fm36(0x37d, f34, f31, globalState) := !f35] + v41, if (f28) then v41 else map v43 : D0 | v43 in v44 :: (v43) := (f35), v41 + (map v45 : D0 | v45 in v41 :: (v45) := (true)), v46[safeIndex(-f34, |v46|)], map[DC1(v39).(cf1 := v39) := f28], v41, v41, v41, v41, fm35(f35, globalState), v41, map[v40 := f28]];
		var v48: array<bool> := new bool[13];
		v48[safeIndex(592, v48.Length)] := f35;
		var v49: array<char> := new char[29];
		var v50 := "ehackpxcv";
		var v51: map<string, bool> := map[seq(abs(781), i5  => (f36)) := f29];
		v49[safeIndex(984, v49.Length)] := fm34(|v50|, if (f35 in v39) then v39[f35] else |fm37(f36, f31, globalState)|, f30, if ("exfveuas" in v51) then v51["exfveuas"] else true, globalState);
		v36[safeIndex(301, v36.Length)], v47, globalState.f26, v48[safeIndex(592, v48.Length)], v49[safeIndex(984, v49.Length)] := fm28(f34, f35, globalState) + fm28(f30, f29, globalState), v47, !true, f29 || f28, 'u';
		var v52: multiset<int> := multiset{fm27(v48[safeIndex(592, v48.Length)], v36[safeIndex(301, v36.Length)], f30, globalState)};
		var v53: seq<int> := [v36[safeIndex(301, v36.Length)], v36[safeIndex(301, v36.Length)], f30, |[-0x273, f34]|, -f30];
		var v54 := new C2(v36[safeIndex(301, v36.Length)], if (v53[safeIndex(v36[safeIndex(301, v36.Length)], |v53|)] in v52) then v52[v53[safeIndex(v36[safeIndex(301, v36.Length)], |v53|)]] else f34, f28, f35, !f29);
		var v55: map<seq<int>, int> := map[seq(abs(0x31f), i6  => (f30)) := |v53|];
		r1, v50, globalState.f13, globalState.f12 := |(if (|f32| >= f30) then v50 else v50)[safeIndex(v54.f46 - -|v55|, |(if (|f32| >= f30) then v50 else v50)|) := v49[safeIndex(984, v49.Length)]]|, (v50 + v50) + [f36], if (f35) then |(v50 + (seq(abs(0xb2), i7  => (v49[safeIndex(984, v49.Length)])))[safeIndex(f34, |(seq(abs(0xb2), i7  => (v49[safeIndex(984, v49.Length)])))|) := v49[safeIndex(984, v49.Length)]])| else f34, f35 ==> f28;
		v48[safeIndex(592, v48.Length)] := f29;
		v48[safeIndex(592, v48.Length)] := v54.fm30(false, globalState);
		r0 := f31;
		r1 := f34;
		r2 := v50;
	}
	method m11(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: int) {
		...
		match (v1) {
			case DC22(cf41, cf42) =>
				...
				v2[safeIndex(745, v2.Length)] := map[!p0 := v3];
				var v4: map<bool, array<int>> := map[f28 := v3];
				v2[safeIndex(745, v2.Length)] := v4 + v4;
				...
				match (v7) {
					case DC3(cf3, cf4, cf5, cf6) =>
						...
						v11[safeIndex(346, v11.Length)] := if (f31) then v5 else v5;
						v3[safeIndex(577, v3.Length)] := cf4;
						var v12: multiset<bool> := multiset{!f35};
						v11[safeIndex(346, v11.Length)], r2, v3[safeIndex(577, v3.Length)], v1 := v5, if (f31 in v12) then v12[f31] else f30, cf6, v1;
						v8 := v8;
						r2 := cf41;
					case DC2(cf2) =>
						...
						v13[safeIndex(680, v13.Length)] := v16;
						var v17 := DC26(v16);
						v13[safeIndex(680, v13.Length)] := v17.cf52;
						var v18: multiset<seq<bool>> := multiset{f32, f32};
						globalState.f13 := f30 - |v18|;
						var v19: set<int> := {f30};
						v3[safeIndex(529, v3.Length)] := |v19|;
						var v20: map<bool, int> := map[f31 := v16.f46];
						var v21: map<array<int>, int> := map[v3 := |v20|];
						v3[safeIndex(529, v3.Length)] := if (v3 in v21) then v21[v3] else fm27(f29, cf41, 0x2e0, globalState);
					...
					case DC4(cf7) =>
						...
						v26[safeIndex(525, v26.Length)] := v24;
						var v27 := DC2(v5);
						var v28: C1 := new C1(f35, f29, false);
						var v29: map<C1, int> := map[v28 := |"auuk"|];
						v26[safeIndex(525, v26.Length)], f29, globalState.f13, globalState.f13, v27 := v24, false, --safeDivisionInt(|(seq(abs(781), i1  => (DC13(f28, map[true := cf41], f36).cf29)))|, f34 + (if (v28 in v29) then v29[v28] else fm28(|multiset{f35}|, f31, globalState))), cf42, v27;
						var v30: array<string> := new string[15](i2 => "jhgvtevm" + "chiwr");
						var v31 := "yguw";
						v30[safeIndex(746, v30.Length)] := if (p0) then v31 else v31;
						v30[safeIndex(746, v30.Length)] := v31 + "xhyw";
						cf41 := cf41;
						cf41 := |((seq(abs(0x22a), i3  => (f36))) + v31)|;
				}
				...
				var v37: set<int> := {f34};
				globalState.f13 := |v36[safeIndex(|v37|, |v36|) := f30 + cf41]|;
				globalState.f13 := -f30;
			case DC23(cf43, cf44, cf45) =>
			...
			case DC24(cf46, cf47, cf48, cf49, cf50) =>
				...
				match (DC3(f35, cf50[safeIndex(|v49|, |cf50|)], v52, safeModuloInt(cf47, cf47))) {
					case DC3(cf3, cf4, cf5, cf6) =>
						var v53 := new C0(v52.f37);
						var v54: T0 := new C1(cf49, false, true);
						var v55: map<T0, char> := map[v54 := f36];
						cf4 := safeModuloInt(|v55|, cf6) - cf4;
						...
						r3 := fm27(f32[safeIndex(cf6, |f32|)], |cf50| * cf4, cf4, globalState);
					case DC2(cf2) =>
						f36 := f36;
						var v61 := new C0(v52.f37);
						r1 := !cf48[safeIndex(f30, |cf48|)];
						globalState.f13 := f30;
					case DC4(cf7) =>
						var v62 := new C0(v52.f37);
						r2 := safeModuloInt(f34, cf47);
						var v63: map<int, bool> := map[f34 := !cf46];
						var v64: map<int, int> := map[f34 := |v63|];
						var v65: array<seq<bool>> := new seq<bool>[23] [cf48, f32, cf48, f32, cf48, f32, cf48, fm0(cf47, f35, p0, |v64|, globalState), f32, f32, cf48, f32, [f35, cf49, cf46, f31, f29], (f32[safeIndex(cf47, |f32|) := p0])[safeIndex(f34, |f32[safeIndex(cf47, |f32|) := p0]|) := f35], cf48, f32[safeIndex(cf47, |f32|) := !cf46], f32, [p0], f32, f32, [f35], cf48, [p0, cf46, true, f28, false]];
						var v66: set<bool> := {f31, cf49};
						var v67 := DC6(cf47, false, f30, cf46, cf47);
						var v68 := new C3(f34, v65, f36, f34, fm1(f35, |fm38(false, |v66|, globalState)|, globalState) && cf49, ((f33[safeIndex(cf47, |f33|)])[safeIndex(|[f36]|, |f33[safeIndex(cf47, |f33|)]|) := p0])[safeIndex(0x21c, |(f33[safeIndex(cf47, |f33|)])[safeIndex(|[f36]|, |f33[safeIndex(cf47, |f33|)]|) := p0]|) := f35], f33, f34, f35, v67.cf10, p0);
						r3 := cf47 * v68.f44;
				}
				...
				if (cf46) {
					...
					var v76: map<int, int> := map[safeDivisionInt(f34, f30) := fm27(f31, |v75|, fm28(f34, fm7(multiset([f34]), cf47, globalState), globalState), globalState)];
					v76 := v76[-cf47 := safeModuloInt(cf47, cf47)];
					r3 := if (f35) then safeModuloInt(|v49|, f34) else 0x27c - f30;
					var v77: array<C1> := new C1[11];
					var v78: multiset<int> := multiset{-cf47};
					var v79: C1 := new C1(f31, f35, fm7(v78, f34, globalState));
					v77[safeIndex(942, v77.Length)] := v79;
					...
					v80[safeIndex(257, v80.Length)] := v82;
					var v83: map<bool, C1> := map[false := v79];
					var v84: map<bool, map<int, array<bool>>> := map[f29 := v82];
					globalState.f13, v77[safeIndex(942, v77.Length)], v80[safeIndex(257, v80.Length)] := safeDivisionInt(f34, cf47), if (f29 in v83) then v83[f29] else DC28(v79).cf55, ((if (v79.f43 in v84) then v84[v79.f43] else v82) + v82) + v82;
					...
					v85[safeIndex(233, v85.Length)] := v86[safeIndex(-|v49|, |v86|)];
					v85[safeIndex(233, v85.Length)] := v81;
				} else {
					globalState.f1 := f28;
			...
			case DC21(cf40) =>
				var v90 := "ggytjvvm";
				var v91: array<string> := new string[29] [v90, v90, if (false) then v90 else v90, v90, v90, v90, v90, v90 + v90, v90, v90, v90[safeIndex(f30, |v90|) := f36], v90, "nqoj", v90, v90, v90, v90, v90, v90, v90, v90 + v90, seq(abs(-0xa7), i6  => (f36)), v90, fm3(f29, p0, globalState), v90, v90, "lskefdq", v90, (v90 + "k")[safeIndex(-f34, |(v90 + "k")|) := f36]];
				v91[safeIndex(600, v91.Length)] := v90 + v90;
				v91[safeIndex(600, v91.Length)], globalState.f13 := v90, 0x354;
				if (f35) {
					f36 := f36;
					...
					var v97: seq<C0> := [v96];
					var v98 := DC27(v97[safeIndex(f34, |v97|)], v90);
					var v99: multiset<D9> := multiset{v98};
					v92[safeIndex(260, v92.Length)] := |v94| > |v99|;
					v92[safeIndex(260, v92.Length)] := v90 <= v91[safeIndex(600, v91.Length)];
					var v100: array<D8> := new D8[27](i8 => DC21(map[DC1(multiset(f32)) := f35]));
					var v101: map<int, bool> := map[f30 := f31];
					var v102: map<bool, bool> := map[p0 := v92[safeIndex(260, v92.Length)]];
					...
					var v108: seq<bool> := [v106.f29, true, v106.f28, f28, v92[safeIndex(260, v92.Length)]];
					var v109: multiset<seq<bool>> := multiset{v106.f32, v108};
					v107, v108, v106.f29 := v107, v106.f32[safeIndex(f34, |v106.f32|) := f36 !in v91[safeIndex(600, v91.Length)]], ({v108, f32, v106.f32} - (set v110 : seq<bool> | v110 in v109 :: (v110))) >= fm52(DC21(cf40[fm36(v106.f30, |v105|, f29, globalState) := v106.f29]), globalState);
					v102 := v102[!(if (f34 in v101) then v101[f34] else !f28) := p0];
				} else {
					var v111: array<int> := new int[29];
					v111[safeIndex(286, v111.Length)] := f30;
					v111[safeIndex(286, v111.Length)] := f34 - safeDivisionInt(|f32|, f34);
					var v112: set<bool> := {if (p0) then f29 else f28};
					var v113: multiset<bool> := multiset{f28};
					var v114: seq<int> := [if (f35 in v113) then v113[f35] else f34, v111[safeIndex(286, v111.Length)]];
					v112 := {|"pk"| >= |v114|, f28, false};
					var v115 := m0(v114, f29, safeDivisionInt(--0x69, f34), f35, globalState);
					var v116: map<int, bool> := map[0x42 := f28];
					var v117: multiset<int> := multiset{v111[safeIndex(286, v111.Length)]};
					var v118: map<int, int> := map[v111[safeIndex(286, v111.Length)] := f30];
					var v119: C4 := new C4(|v91[safeIndex(600, v91.Length)]|, true && (if (|f32| in v116) then v116[|f32|] else fm7(v117, v115, globalState)), f32, seq(abs(0x34e), i9  => (f32)), |v113|, f35, f29, |v91[safeIndex(600, v91.Length)]| >= |v118|);
					var v120: array<char> := new char[28];
					var v121: C0 := new C0(v120);
					v91[safeIndex(600, v91.Length)], v119, r3 := v90 + "gobhvtjm", v119, DC3(f32[safeIndex(v111[safeIndex(286, v111.Length)], |f32|)], 0x12e, v121, |f32|).cf6;
					v111[safeIndex(286, v111.Length)] := |(v112 * (v112 - v112))|;
				}
				
				var v122: array<int> := new int[19];
				v122[safeIndex(255, v122.Length)] := f34;
				r2, f35, v90, v122[safeIndex(255, v122.Length)] := (-0x1e6 * |v90|) - safeDivisionInt(f34, f34), f29, (v90 + v91[safeIndex(600, v91.Length)]) + v90, safeModuloInt(-f30, -f30);
				f36 := 'a';
			case DC25(cf51) =>
				f35 := p0 <== f31;
				r1 := !p0 <== true;
		...
		if (f30 == f34) {
			...
			var v127: seq<seq<int>> := [seq(abs(274), i10  => (f34))];
			var v128 := DC36(f33);
			var v129: multiset<int> := multiset{v124};
			var v130: seq<multiset<int>> := [v129, multiset{f30, f34}];
			var v131 := new C5(f31, if (|f32| in v126) then v126[|f32|] else fm32(true, globalState), f30, v123 < v127[safeIndex(f30, |v127|)], f32, v128.cf67, safeDivisionInt(f34, fm46(|v130[safeIndex(f34, |v130|)]|, f34, false, globalState)), fm1(true, v123[safeIndex(|v123|, |v123|)], globalState), f32[safeIndex(v124, |f32|)], !f28 || p0);
			...
			match (v132) {
				case DC11(cf23, cf24, cf25) =>
					...
					v125 := v125 + v125;
					globalState.f1 := f32[safeIndex(cf25, |f32|)];
				case DC10(cf22) =>
					var v137: map<bool, bool> := map[f31 := f31];
					var v139 := new C4(v124, true, [!f29], f33[safeIndex(v124, |f33|) := f32] + [f32, f32, fm5(v131.f48, -|v137|, f28, v124, globalState)], f34, f30 !in (map v138 : int | (0x38e <= v138) && (v138 < 734) :: (safeModuloInt(v138, f34)) := (0x155)), v131.f47, f29);
					r1 := v131.f48 >= f34;
					v125 := (v125 + "mhye") + v125;
					var v140: array<bool> := new bool[24](i11 => p0);
					var v141: map<int, bool> := map[f30 := v131.f47];
					var v142: multiset<bool> := multiset{f29};
					v140[safeIndex(721, v140.Length)] := |v141| <= |v142|;
					v140[safeIndex(721, v140.Length)] := (f30 == 0xa6) <==> v131.f47;
			}
			...
			v145 := v145;
			r3 := safeModuloInt(-|multiset{f29}|, f34 * f34);
		}
		...
		match (v154) {
			case DC3(cf3, cf4, cf5, cf6) =>
				...
				var v156 := "xiirlaq";
				v155[safeIndex(860, v155.Length)] := v156 + v156;
				var v157: seq<int> := [f30];
				r0, v155[safeIndex(860, v155.Length)], f29 := f32[safeIndex(v157[safeIndex(f34, |v157|)], |f32|)], seq(abs(0x38e), i15  => (f36)), f28;
				...
				var v160: C2 := new C2(cf6, fm32(!p0, globalState), !f35, f32[safeIndex(cf4, |f32|)], f31);
				var v161 := DC26(v160);
				...
				match (v161) {
					case DC27(cf53, cf54) =>
						...
						var v165 := DC30(f36, v164[v163 := abs(v160.f46)]);
						v165 := v165;
						var v166: array<bool> := new bool[8];
						v166[safeIndex(323, v166.Length)] := v163.f31;
						v166[safeIndex(323, v166.Length)] := p0;
						var v167: map<int, bool> := map[0x22c := v163.f28];
						v167 := v167;
						var v168: map<bool, multiset<bool>> := map[--0x2bc <= v157[safeIndex(|cf54[safeIndex(v160.f46, |cf54|) := f36]|, |v157|)] := multiset{!v163.f35, false, v166[safeIndex(323, v166.Length)]} * multiset{v163.f31}];
						var v169: multiset<bool> := multiset{false};
						var v170: map<string, int> := map[v155[safeIndex(860, v155.Length)] := cf6];
						var v171 := DC27(v151, v155[safeIndex(860, v155.Length)]);
						var v172: seq<D9> := [v171];
						cf6, globalState.f26, globalState.f1, v168, cf6 := v160.f46 * (v160.fm29(globalState) - 0x234), multiset{v163.f28, f28, v166[safeIndex(323, v166.Length)]} > v169[v163.f29 := abs(|v170|)], cf3, (v168 + v168)[v163.f28 ==> v163.f29 := multiset(f32)], |(fm3(v172 <= v172, cf3, globalState))[safeIndex(v160.f46, |fm3(v172 <= v172, cf3, globalState)|) := f36]|;
					case DC26(cf52) =>
						v156 := v155[safeIndex(860, v155.Length)];
						globalState.f12 := true;
						var v173: multiset<string> := multiset{v156};
						var v174: map<multiset<string>, int> := map[v173 + multiset{v155[safeIndex(860, v155.Length)], v155[safeIndex(860, v155.Length)], v155[safeIndex(860, v155.Length)], v155[safeIndex(860, v155.Length)]} := v160.f46];
						v174 := v174[v173 := cf6];
				...
				v176 := (seq(abs(-0x2a5), i16  => (v156))) + [v156];
			case DC2(cf2) =>
				var v177: set<int> := {-|(seq(abs(0x6c), i17  => (f36)))|, f34, f30, fm32(!f35, globalState)};
				v177 := v177 * v177;
				globalState.f1 := f35;
			...
			case DC4(cf7) =>
				...
				match (v182) {
					case DC22(cf41, cf42) =>
						var v183: array<int> := new int[8](i18 => safeModuloInt(i18, cf41));
						v183[safeIndex(571, v183.Length)] := 593;
						v183[safeIndex(571, v183.Length)] := cf42 + (cf42 * f34);
						var v184: array<bool> := new bool[25];
						v184[safeIndex(803, v184.Length)] := p0;
						var v185: set<bool> := {f28};
						var v186 := DC19(f31, 0x212, 0x170);
						v184[safeIndex(803, v184.Length)], f28, v183[safeIndex(571, v183.Length)], globalState.f26 := (if (p0) then v185 else v185) > v185, f31, -f34, !v186.cf36;
						var v187: seq<map<bool, int>> := [map[f28 := f34]];
						var v188: map<bool, int> := map[v184[safeIndex(803, v184.Length)] := cf41];
						globalState.f13 := |(v187[safeIndex(-0x3c2, |v187|)] + (v188 + v188))|;
						var v189 := "mwd";
						r3, v189, globalState.f1 := 0x2e6, ("uy" + (seq(abs(0x35f), i19  => (f36)))) + "gvqi", v184[safeIndex(803, v184.Length)];
					case DC23(cf43, cf44, cf45) =>
						var v190: seq<int> := [f34];
						var v191 := new C4(|v179|, f28, f32 + f33[safeIndex(|(seq(abs(0xe5), i20  => (f36)))|, |f33|)], f33, f30, false, cf44, v190 < v190[safeIndex(0x20e, |v190|) := f30]);
						...
						v199[safeIndex(577, v199.Length)] := f28;
						globalState.f13, v199[safeIndex(577, v199.Length)] := if (f34 in v197) then v197[f34] else -f34, cf43;
						v199[safeIndex(577, v199.Length)] := v199[safeIndex(577, v199.Length)];
					case DC24(cf46, cf47, cf48, cf49, cf50) =>
						var v200: array<bool> := new bool[2] [cf49, f30 <= cf47];
						v200[safeIndex(703, v200.Length)] := f28;
						v200[safeIndex(703, v200.Length)] := !f35;
						var v201: array<int> := new int[1](i21 => safeModuloInt(i21, f30));
						cf46, r3, v201, v200[safeIndex(703, v200.Length)] := cf49, safeModuloInt(cf47, 22) - (|v179| + cf47), v201, 645 <= cf47;
						var v202: T3 := new C4(f30, f35, [f31, p0, f35, cf49, cf46], f33, f34, f35, f31, v200[safeIndex(703, v200.Length)]);
					...
					case DC21(cf40) =>
						...
						v211[safeIndex(917, v211.Length)] := f30 > (fm53('v', f30, globalState)).cf62;
						v211[safeIndex(917, v211.Length)] := fm1(p0, f30, globalState);
						var v212: array<array<int>> := new array<int>[13];
						var v213: array<int> := new int[3];
						v212[safeIndex(170, v212.Length)] := v213;
						v212[safeIndex(170, v212.Length)], globalState.f13, globalState.f13, f35 := v213, f30, f34, fm6(globalState);
						var v214: map<bool, int> := map[p0 := f30];
						v214 := v214[f35 := f34];
					case DC25(cf51) =>
						globalState.f13 := f34;
						globalState.f1 := p0;
						globalState.f13 := safeModuloInt(f34 - 669, ---218);
		...
		v217[safeIndex(484, v217.Length)] := |v219|;
		v217[safeIndex(484, v217.Length)] := f30;
		r2 := v217[safeIndex(484, v217.Length)];
		forall i22 | 0 <= i22 < v217.Length {
			v217[i22] := i22 * f30;
		}
		r0 := true;
		r1 := f31;
		var v220: set<int> := {v217[safeIndex(484, v217.Length)]};
		...
		var v223 := "urgiph";
		var v224: seq<int> := [f34, |v223|, v217[safeIndex(484, v217.Length)] * v217[safeIndex(484, v217.Length)]];
		r3 := v224[safeIndex(v217[safeIndex(484, v217.Length)], |v224|)];
	}
}
...
class C7 extends T1, T0 {
	...
	function fm3(p0: bool, p1: bool, globalState: GlobalState): string {
		((seq(abs(0x22d), i0  => ('j'))) + "lytqd") + (if (f28) then "gig" else "cbkwbpt")
	}
	function fm2(globalState: GlobalState): map<bool, int> {
		map[f28 := f41]
	}
	...
	method m7(p0: bool, p1: array<bool>, p2: bool, globalState: GlobalState) returns (r0: char, r1: seq<map<int, int>>, r2: int, r3: string) {
		...
		globalState.f13 := v3[safeIndex(if (f29 in v4) then v4[f29] else f41, |v3|)];
		var v5 := 'r';
		var v6 := "pdeidmrnl";
		var v7: array<char> := new char[28] [v5, 'q', v5, v5, v5, v5, v5, v5, v5, v5, 'e', fm21(v5, |map[f41 := false]|, globalState), v5, v5, v5, v5, v5, v5, v5, v5, fm21(fm21(v5, f30, globalState), f30, globalState), v6[safeIndex(f30, |v6|)], 'e', v5, v5, v5, v5, v5];
		var v8 := new C0(v7);
		var v9: map<int, int> := map[f41 := f30];
		var v10: array<int> := new int[20] [f41, if (p0) then -f41 else 0x115, f41, -f41, -f41, fm20(f41, !true, globalState), f30, f30, f30, fm20(--f30, p0, globalState), -|v9| * f41, fm20(f41, f31, globalState), f30, f41 + fm20(f41, p0, globalState), -(if (f28 in v4) then v4[f28] else f30), f30, |{f41}|, -f41, f30, safeModuloInt(fm20(f30, fm19(globalState), globalState), f41)];
		v10[safeIndex(943, v10.Length)] := safeDivisionInt(f30, -f30);
		p1[safeIndex(398, p1.Length)] := p0;
		v10[safeIndex(513, v10.Length)] := f41;
		var v11: map<int, bool> := map[f41 := p2];
		var v12: multiset<bool> := multiset{f28};
		globalState.f13, v10[safeIndex(943, v10.Length)], p1[safeIndex(398, p1.Length)], f31, v10[safeIndex(513, v10.Length)] := f30, f41, !(f30 > (f30 - |v11|)), v12 > multiset{p2}, f30 - f30;
		...
		r1 := if (p0) then v15 else seq(abs(0x231), i1  => (v9));
		r2 := safeModuloInt(|v6|, v10[safeIndex(943, v10.Length)]);
		r3 := v6;
	}
	method m8(p0: array<bool>, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
		...
		var v8 := "xbffckyc";
		var v9 := new C5(v6.cf27, 0x251, f41, f31, v4.f32, v4.f33, |map[v7 := -v4.f30]|, true, v4.f32[safeIndex(|f42|, |v4.f32|)], (seq(abs(0x1a2), i0  => (v2))) != v8);
		v0.f29 := v4.f32[safeIndex(f30, |v4.f32|)];
		var v10: seq<int> := [|v5|];
		for i1 := |v10| - f30 to v9.f48 {
			...
			p0[safeIndex(581, p0.Length)] := f29;
			p0[safeIndex(581, p0.Length)] := v12.fm44(-i1, globalState);
			var v13: map<int, bool> := map[i1 := v0.f28];
			v13 := v13[|v4.f32[safeIndex(-685, |v4.f32|) := v0.f29]| := v4.f29];
			...
			var v19 := DC38(v18);
			var v20: array<array<D7>> := new array<D7>[17] [if (p0[safeIndex(581, p0.Length)]) then v18 else v18, v18, v18, v18, v18, v18, v19.cf71, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18];
			var v21: array<char> := new char[8];
			v21[safeIndex(294, v21.Length)] := v2;
			v20, r1, v21[safeIndex(294, v21.Length)], globalState.f12, v0.f29 := v20, safeDivisionInt(v9.f48, safeModuloInt(f41, i1)), 'x', v4.f29, v4.f31;
		}
		if (f29) {
			if (v9.f47) {
				...
				p0[safeIndex(198, p0.Length)] := v9.f47;
				p0[safeIndex(198, p0.Length)] := v9.f47;
				var v27 := new C1(v0.f29, false, v4.f30 >= v9.f48);
				var v28: array<int> := new int[6];
				v28[safeIndex(862, v28.Length)] := f41;
				v28[safeIndex(862, v28.Length)] := --v4.f30;
			}
			
			var v29: map<int, string> := map[f30 := v8 + v8];
			v29 := (v29 + v29) + v29;
			var v30: array<char> := new char[5](i4 => v2);
			v30[safeIndex(109, v30.Length)] := 'a';
			v30[safeIndex(109, v30.Length)] := v2;
			var v31: multiset<bool> := multiset{f28};
			var v32: map<int, bool> := map[v4.f30 := false];
			r1 := |v31[v0.f29 := abs(|v4.f32|)]| - safeDivisionInt(if (!DC6(v4.f30, true, v4.f30, v4.f29, v4.f30).cf12 in v5) then v5[!DC6(v4.f30, true, v4.f30, v4.f29, v4.f30).cf12] else |v32|, v4.f30);
			p0[safeIndex(549, p0.Length)] := v4.f29;
			p0[safeIndex(549, p0.Length)] := v0.f29;
		} else {
			var v33: map<seq<int>, int> := map[seq(abs(665), i5  => (f30)) := v4.f30];
			globalState.f13 := |(v33 + v33)|;
			v4.f28 := v4.f28;
			var v34 := DC11(v4.f30, v0.f28, f41);
			var v35: map<D4, int> := map[v34 := f41];
			var v36: seq<map<D4, int>> := [v35];
			globalState.f13, globalState.f13, v8, v4.f31 := safeModuloInt(0x60, v9.f48), safeModuloInt(-(v4.f30 - fm46(|v8|, |"gtbdkgdg"|, v0.f28, globalState)), v4.f30), v8, fm1(v36 < v36[safeIndex(f30, |v36|) := v35], v9.f48, globalState);
		...
		forall i6 | 0 <= i6 < v41.Length {
			v41[i6] := safeDivisionInt(i6, safeDivisionInt(v4.f30, |v8|));
		}
		r0 := p0;
		var v42: set<int> := {|v8|};
...
class C8 extends T4, T2 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		...
		if ((f30 < f30) && f28) {
			...
			var v7: T0 := new C7(safeModuloInt(-0x1ee, f30), fm49(v1, f36, v3, globalState) - v1, |((map[v4 := v0])[v4 := v0] + v5)|, f40, fm34(f34, f30, |v6|, !f35, globalState) in v0, f29);
			v7 := v7;
			r1 := -fm39(true, v1, f40, globalState);
			v4[safeIndex(605, v4.Length)] := |(f32 + f32)|;
			v4[safeIndex(605, v4.Length)] := f34;
			var v9: map<int, array<int>> := map[f30 := v4];
			var v10: map<int, bool> := map[f34 := true];
			var v11: map<int, map<int, bool>> := map[|v9| := v10];
			var v13: set<map<int, bool>> := {map v8 : int | v8 in v11[f34 := v10] :: (v8 + 0x18) := (f29), map v12 : int | (0x3d9 <= v12) && (v12 < 854) :: (safeDivisionInt(v12, v4[safeIndex(605, v4.Length)])) := (false), v10};
			...
			v19[safeIndex(495, v19.Length)] := f30;
			v19[safeIndex(495, v19.Length)] := f34;
			globalState.f1 := f28;
			...
			decreases 100 - i2
		{
			...
			match (DC27(v23, v20)) {
				case DC27(cf53, cf54) =>
					var v24 := DC27(cf53, if (f32[safeIndex(f34, |f32|)]) then v20 else cf54);
					v24, r2, r0 := v24, fm3(f31, f40, globalState), f29;
					globalState.f12 := f35;
					globalState.f13 := if (f28) then f34 else -f30;
					var v25: set<seq<int>> := {seq(abs(0x2c3), i4  => (f30))};
					var v26: map<int, set<seq<int>>> := map[f30 := v25];
					var v27: seq<int> := [f34];
					var v29: map<int, char> := map[|cf54| := f36];
					var v31 := DC39(v25);
					var v32: seq<seq<int>> := [[f30, f34], v27, [-|"emyatjs"|, f34]];
					var v34: array<set<seq<int>>> := new set<seq<int>>[23] [v25, v25 * v25, if (f34 in v26) then v26[f34] else v25, v25, v25, v25, if (f40) then {v27, v27} else v25, v25, v25, {([f34])[safeIndex(-949, |[f34]|) := f34], v27, v27} * v25, v25, v25, set v28 : seq<int> | v28 in v25 :: (v28), {[f34, |map[f35 := false]|, |(set v30 : int | v30 in v29 :: (v30 * -0x33f))|, |"wt"|]} - v31.cf72, v25, v25, v25, v25, v25, fm54(0x218, v27, |(seq(abs(892), i5  => ('w')))|, globalState) - v25, v25, {v27}, set v33 : seq<int> | v33 in v32 :: (v33)];
					v34[safeIndex(926, v34.Length)] := v25;
					v34[safeIndex(926, v34.Length)], globalState.f13, r1, globalState.f13 := v25, f30 - f30, safeModuloInt(f30 - |(map v35 : int | (0x282 <= v35) && (v35 < 0x39f) :: (v35 * f34) := (f30))|, fm32(f40, globalState) - fm32(f35, globalState)), f34;
				case DC26(cf52) =>
					var v36: array<bool> := new bool[22];
					globalState.f21 := if (f40) then v36 else v36;
					var v37: array<int> := new int[7](i6 => i6 - |[|v20|, f30]|);
					v37[safeIndex(20, v37.Length)] := f34 - f30;
					globalState.f1, v37[safeIndex(20, v37.Length)] := f30 > safeModuloInt(cf52.f46, cf52.f46), f30;
					var v38: map<int, bool> := map[f34 := f40];
					var v39 := new C2(safeDivisionInt(|v38|, v37[safeIndex(20, v37.Length)]), fm24(f31, |v20|, globalState), f29, f35, true);
		...
		var v45 := DC21(v44);
		var v46: seq<D8> := [v45];
		var v47: seq<seq<D8>> := [seq(abs(0x4c), i7  => (DC21(map[DC1(multiset{f31}) := f29]))), v46, seq(abs(0x2f), i8  => (v45)), [v45, v45, v45, v45]];
		if (v47 < [[v45]]) {
			...
			var v52: C0 := new C0(v51);
			var v53, v54, v55, v56 := m6(safeDivisionInt(f34, v49.f44), fm39(true, multiset{|v50|}, f31, globalState), f36, v52, globalState);
			var v57 := "fu";
			r2 := v57 + v57;
			f36 := f36;
			...
			v59[safeIndex(542, v59.Length)] := v61 + v61;
			var v62 := DC42(v61);
			v59[safeIndex(542, v59.Length)], globalState.f1 := v62.cf76, f30 >= f34;
	...
	method m6(p0: int, p1: int, p2: char, p3: C0, globalState: GlobalState) returns (r0: map<map<D3, int>, array<int>>, r1: bool, r2: bool, r3: int) {
		...
		for i0 := if (f31) then p1 else f30 to safeDivisionInt(|v0|, f30) {
			var v1 := "vq";
			...
			var v7: T2 := new C5(f35, |(map v3 : int | v3 in v4 :: (v3 - f30) := (f28))|, --p0, f28, fm0(f34, false, f40, |v1|, globalState), f33[safeIndex(f30, |f33|) := f32], |v6|, false, f31, true);
			var v8: map<seq<int>, T2> := map[v2 := v7];
			globalState.f13 := |v1[safeIndex(|v8|, |v1|) := f36]|;
			f35 := false;
			f36 := f36;
			...
			match (v9) {
				case DC40(cf73, cf74) =>
					...
					var v15 := DC6(|[f34]|, v7.f29, 0x1a7, f29, |v14[safeIndex(v7.f30, |v14|)]|);
					v15 := v15;
				case DC39(cf72) =>
					...
					var v18 := new C3(f34, if (v7.f31) then v16 else v16, f36, |(seq(abs(-686), i2  => (|v7.f32|)))|, f31, v7.f32 + [v7.f31, f31, !v7.f29], v7.f33, v7.f30, fm1(f35, |(map[p1 := v17])[-|v1| := v17]|, globalState), f40, v7.f29);
					v5[safeIndex(691, v5.Length)] := f30;
					v5[safeIndex(691, v5.Length)] := safeDivisionInt(v7.f30, v7.f30);
					var v19: array<bool> := new bool[19](i3 => DC46(multiset{multiset{v7.f28}}).cf80 > multiset{multiset{f29, f40}});
					v19[safeIndex(223, v19.Length)] := f28;
					v19[safeIndex(223, v19.Length)] := p1 < p0;
					v19 := v19;
				case DC41(cf75) =>
					globalState.f1 := f40;
					var v20: array<array<bool>> := new array<bool>[16];
					var v21: array<bool> := new bool[13](i4 => v7.f28);
					v20[safeIndex(720, v20.Length)] := v21;
					r3, v20[safeIndex(720, v20.Length)] := 0x20a, v21;
					var v22: map<array<bool>, int> := map[v21 := |v1|];
					var v23 := new C4(v7.f30, v7.f28, v7.f32, v7.f33[safeIndex(p1, |v7.f33|) := f32] + f33, safeModuloInt(v7.f30, 0x8f), v7.f30 == |v22|, f31, v7.f28);
					...
					v26, globalState.f13, globalState.f13, v27, v7.f28 := fm56(f30, v1 <= v1, -v7.f30 * p0, globalState), safeDivisionInt(p1, f30), p1, v27, v28[safeIndex(|v1|, |v28|)] != ((seq(abs(0x1bb), i5  => (p2))) + v1);
			}
		...
		v29[safeIndex(82, v29.Length)] := fm1(f29, fm24(false, |v32|, globalState), globalState);
		v29[safeIndex(82, v29.Length)] := f32[safeIndex(--f34, |f32|)];
		var i6 := 0;
		while (!f28)
			decreases 100 - i6
		{
			...
			var v38 := "ff";
			var v39: T0 := new C7(if (v29[safeIndex(82, v29.Length)] in v33) then v33[v29[safeIndex(82, v29.Length)]] else p0, v34 - multiset{|v35|}, p0, v37 < v37, f32[safeIndex(|v38|, |f32|)], f29);
			var v40: array<T0> := new T0[9];
			var v41: seq<multiset<int>> := [fm49(v34, f36, [v35, [|v38|, |map[v40 := f31]|]], globalState), v34];
			v39, r1 := v39, (v41 + (seq(abs(0x3c3), i7  => (multiset(v35))))) < (v41[safeIndex(f34, |v41|) := v34] + v41[safeIndex(0x1ec, |v41|) := multiset{f34}]);
			v29[safeIndex(82, v29.Length)], globalState.f13 := fm7(v34, -f30, globalState), f30 * -f34;
			globalState.f21 := v29;
			var v42: array<seq<bool>> := new seq<bool>[26];
			v42[safeIndex(529, v42.Length)] := f32;
			v42[safeIndex(529, v42.Length)] := f32;
		}
		var v43 := "opebgfkic";
		var v44: array<int> := new int[13] [p1, --f30, p0, |v43|, p0, f34, f30, f34, f30, -|v43|, p1, f30, p0];
		var v45: seq<int> := [|[f28]|, f30];
		var v46: map<array<int>, seq<int>> := map[v44 := fm23(v29[safeIndex(82, v29.Length)], p0, globalState) + v45];
		var v47: set<int> := {|v45|};
		...
		v44[safeIndex(551, v44.Length)] := f30;
		v44[safeIndex(551, v44.Length)] := -((if (f29) then f30 else p0) * -0x295);
		f29 := f29;
		...
		r0 := v57;
		r1 := fm7(multiset(seq(abs(0x364), i8  => (DC6(0x1b6, f35, 0x367, f28, |v45|).cf11))), safeDivisionInt(|multiset{v29[safeIndex(82, v29.Length)], f40, f35}|, |v43|), globalState);
		r2 := f28;
		r3 := p1;
	}
}
...
class C9 extends T4 {
	...
	function fm6(globalState: GlobalState): bool {
		(if (f29) then map[!false := f35] else map[f29 := DC0(f35).cf0]) != (map[!f32[safeIndex(f30, |f32|)] := f31] + map[f31 := f28])
	}
	function fm4(p0: bool, p1: set<int>, p2: int, p3: bool, globalState: GlobalState): set<int> {
		{|(DC10(multiset{f34}).cf22 - multiset{0x23b, |DC1(multiset{f28}).cf1|, f34, f30, |(map v0 : int | v0 in {f38} :: (safeDivisionInt(v0, f38)) := (f31))|})|}
	}
	function fm5(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<bool> {
		f32
	}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		...
		if (v0 !! {f29, f35}) {
			...
			if ((if (f31 in v1) then v1[f31] else f34) <= f30) {
				...
				var v13: array<bool> := new bool[16] [true, f31, f28, fm16(f31, v7, v11, f38, globalState), f35, f31, f29, f35, f31, !true, f28, f28, fm7(v12[f34 := abs(f38)], f30, globalState), f35, f29, f28];
				var v14 := DC9(f28, false, v13, f31);
				v10[safeIndex(176, v10.Length)] := -(if (v14.cf21) then f30 else f30);
				v10[safeIndex(176, v10.Length)] := f38;
				var v15: map<char, bool> := map[f36 := f35];
				v15 := v15[f36 := f35];
				var v16: seq<int> := [f34 - v10[safeIndex(176, v10.Length)]];
				globalState.f13 := v16[safeIndex(f34, |v16|)];
				...
				var v22: set<set<int>> := {{f38}, if (f38 in v21) then v21[f38] else v18[safeIndex(f38, |v18|)], v11, v11, {-489, f38}};
				v10[safeIndex(176, v10.Length)] := |[(set v19 : set<int> | v19 in v18 :: (v19)) >= v22, if (f28) then f31 else false, f31]|;
			} else {
				var v23: set<int> := {f30};
				...
				v25 := v25[f31 := f29];
				f36 := f36;
				var v26: map<int, bool> := map[if (true) then |(seq(abs(-0x5c), i1  => (f36)))| else |"im"| := !f35];
				r0 := !(if (f38 in v26) then v26[f38] else f31);
				var v27: array<bool> := new bool[12];
				v27[safeIndex(556, v27.Length)] := f29;
				v27[safeIndex(556, v27.Length)] := f28;
			}
			
			var v28 := "bd";
			var v29: array<string> := new string[2] [v28, v28 + v28];
			v29[safeIndex(798, v29.Length)] := v28;
			var v30: array<C0> := new C0[16];
			var v31: array<char> := new char[22](i2 => f36);
			var v32: C0 := new C0(v31);
			v30[safeIndex(900, v30.Length)] := v32;
			var v33: seq<int> := [f38, f30];
			var v34: T2 := new C5(f28, f34, f30, f31, f32, f33, v33[safeIndex(f30, |v33|)], f28, f35, !f35);
			var v35: map<bool, T2> := map[true := v34];
			var v36: map<int, int> := map[|v28| := fm46(f34, v34.f30, f35, globalState)];
			v29[safeIndex(798, v29.Length)], globalState.f13, globalState.f13, v30[safeIndex(900, v30.Length)] := fm3(f28, f28, globalState), |v35| * (f38 * (if (v33[safeIndex(v34.f30, |v33|)] in v36) then v36[v33[safeIndex(v34.f30, |v33|)]] else v34.f30)), v34.f30, v32;
			...
			v42[safeIndex(436, v42.Length)] := f30;
			v42[safeIndex(436, v42.Length)] := f34;
			globalState.f1 := false;
			globalState.f26 := f35;
			var v43: C8 := new C8(f35, f36, f34, f28, f32, f33, f30, f31, f29, f31);
			var v44: map<C8, int> := map[v43 := f30];
			var v45: set<int> := {-f34, f30, fm24(f35, v42[safeIndex(436, v42.Length)], globalState), f38, |v44|};
			if (-(f34 + f34) >= |v45|) {
				globalState.f1, v42[safeIndex(436, v42.Length)] := f38 == f34, f38;
				v42[safeIndex(436, v42.Length)] := f34;
				var v46: array<bool> := new bool[18](i3 => f28);
				v46[safeIndex(426, v46.Length)] := f35;
				var v47: set<set<int>> := {{f30}};
				var v48: T0 := new C7(f34, v41, f38, f35, f35, v43.f40);
				var v49: map<int, T0> := map[|(if (v48.f29) then f32 else f32[safeIndex(f34, |f32|) := v43.f40])| := v48];
				v46[safeIndex(426, v46.Length)], v47, v48 := f29, v47 * v47, if (safeDivisionInt(v42[safeIndex(436, v42.Length)], |"okb"|) in v49) then v49[safeDivisionInt(v42[safeIndex(436, v42.Length)], |"okb"|)] else v48;
				var v50: C1 := new C1(f31, true, f29);
				var v51: map<char, map<C1, int>> := map[f36 := map[v50 := fm39(v43.f40, v41, f32[safeIndex(f38, |f32|)], globalState)]];
				var v52: map<C1, int> := map[v50 := f38];
				v51 := v51[f36 := v52];
				var v53 := "mhctyq";
				var v54: array<char> := new char[15] [f36, f36, f36, 'h', f36, fm34(f38, f38, |v53|, f28, globalState), f36, fm41(f29, f36, f29, f38, globalState), v53[safeIndex(f30, |v53|)], f36, 'v', 'a', v53[safeIndex(|v41|, |v53|)], f36, f36];
				v54[safeIndex(164, v54.Length)] := f36;
				f36, v54[safeIndex(164, v54.Length)], globalState.f26 := f36, f36, f28 ==> v46[safeIndex(426, v46.Length)];
			} else {
				var v55: map<bool, bool> := map[true := f35];
				var v56: set<char> := {f36, fm41(f31, f36, f35, f30, globalState)};
				var v57 := DC0(f28);
				var v58: map<int, bool> := map[v42[safeIndex(436, v42.Length)] := f31];
				var v59: map<int, bool> := map[v42[safeIndex(436, v42.Length)] := fm1(v43.f40, |v58|, globalState)];
				var v60: array<bool> := new bool[26] [v43.f40, f28, !f35, f35, f35, f31, if (f35 in v55) then v55[f35] else true, v43.f40, !v43.f40, v42[safeIndex(436, v42.Length)] in v41, 's' in v56, v43.f40, f35, f31, f29, fm16(!f28, v57, fm4(f31, {f30}, f30, f29, globalState), |f32|, globalState), v43.f40, f35, f28, f34 == 848, (seq(abs(0x165), i4  => (f36))) != "vdyxsb", f29, f31 || f35, f30 in v58, false || !f35, f29 <== f31];
				v60[safeIndex(225, v60.Length)] := if (true) then f35 else true;
				var v61: multiset<bool> := multiset{f31};
				v60[safeIndex(225, v60.Length)] := if (v61 < v61) then f31 else f29;
				v42[safeIndex(436, v42.Length)] := f34;
				f36 := f36;
			...
			v43.f40, v42[safeIndex(436, v42.Length)], globalState.f12 := !(!f35 || f28), v42[safeIndex(436, v42.Length)], v43.f40;
		}
		
		var v62: array<bool> := new bool[23](i5 => if (f35) then false else f28);
		v62[safeIndex(22, v62.Length)] := f28;
		var v63 := "gxqix";
		var v64: seq<string> := [v63, v63];
		v62[safeIndex(22, v62.Length)] := v64 == v64;
		...
		if (v66 == (v66 + v66)) {
			...
			var v70: C4 := new C4(f34, fm6(globalState), [f35] + f32, [f32] + [f32, f32], safeModuloInt(f34, f34), v69.cf3, f35, f31);
			...
			v72[safeIndex(750, v72.Length)] := v62;
			v72[safeIndex(750, v72.Length)] := v62;
		} else {
			var v73: map<bool, int> := map[v62[safeIndex(22, v62.Length)] := -f34];
			var v74: seq<int> := [|v73|, safeDivisionInt(f34, |multiset{v65}|), f38];
			var v75: seq<seq<int>> := [v74, v74];
			v74 := (v74 + (seq(abs(0x340), i8  => (f38)))) + (v74 + v75[safeIndex(f30, |v75|)]);
			v65[safeIndex(781, v65.Length)] := |v0|;
			v65[safeIndex(781, v65.Length)] := safeDivisionInt(-825, f34);
			var v76: map<int, bool> := map[v74[safeIndex(f30, |v74|)] := f29];
			var v77: map<array<bool>, int> := map[v62 := |v76|];
			var v78: map<int, seq<char>> := map[v65[safeIndex(781, v65.Length)] := seq(abs(0x344), i9  => (f36))];
			var v79: map<bool, char> := map[f35 := 'h'];
			var v80: array<int> := new int[23];
			var v81 := new C5(f34 == 793, |v77|, |(if (f38 in v78) then v78[f38] else v63)|, v62[safeIndex(22, v62.Length)], f32, [[f31, f29], f32[safeIndex(|v79|, |f32|) := f28], f32], |v74[safeIndex(|{v80}|, |v74|) := v74[safeIndex(f34, |v74|)]]|, |f32| < f30, f28, f32[safeIndex(f34, |f32|)]);
	...
	method m4(globalState: GlobalState) returns (r0: map<map<int, bool>, int>) {
		...
		if (v0.cf0) {
			...
			var v7 := DC47(v6);
			v5, globalState.f13, globalState.f1, v6, globalState.f13 := v5, f38, f32[safeIndex(f34, |f32|)], (v7.(cf81 := v6)).cf81, f30;
			var v8: multiset<bool> := multiset{false, f28};
			if (v8 > multiset{f31, f35, f35}) {
				globalState.f13 := f34;
				var v9: map<char, int> := map[f36 := |f33[safeIndex(-f30, |f33|)]|];
				...
				v13[safeIndex(702, v13.Length)] := true;
				v13[safeIndex(312, v13.Length)] := f35;
				var v14 := "wc";
				v13[safeIndex(702, v13.Length)], v13[safeIndex(312, v13.Length)], globalState.f13, v14, globalState.f13 := f34 <= -(-|v1| - -f38), f31, safeDivisionInt(f38, |v1|) * f38, "e", f30;
			} else {
				var v15: array<multiset<bool>> := new multiset<bool>[29];
				v15[safeIndex(3, v15.Length)] := v8;
				v15[safeIndex(3, v15.Length)] := v8;
				f28 := f35;
				...
				var v23: map<int, int> := map[f38 := safeModuloInt(-|v22[-797 := abs(f38)]|, f38)];
				var v24: set<bool> := {f31};
				globalState.f13 := if (|(v24 * {f35})| in v23) then v23[|(v24 * {f35})|] else f34 * f38;
			}
			
			var v25: array<map<int, int>> := new map<int, int>[13](i0 => map[f34 := 0xee] + map[v1[safeIndex(-294, |v1|)] := f30]);
			var v26: map<int, int> := map[0x2c9 := f34];
			v25[safeIndex(646, v25.Length)] := v26 + v26;
			v25[safeIndex(646, v25.Length)] := map[|f32| := f38];
			var v27: multiset<int> := multiset{-f30};
			var v28 := DC37(if (f38 in v27) then v27[f38] else f34, f35, safeModuloInt(0x271, f38));
			v28 := fm58(f28, f33[safeIndex(f38, |f33|)], globalState);
			var v29: set<int> := {f30};
			...
			if (f35) {
				...
				var v35: map<bool, set<int>> := map[f28 := set v34 : int | v34 in v33 :: (safeDivisionInt(v34, |[true, !true]|))];
				var v36 := DC6(-|(if (f31) then v35 else v35)|, f32[safeIndex(f34, |f32|)], f34, f31, safeDivisionInt(v32, 0x1a7));
				var v37: set<bool> := {f31};
				var v38: seq<set<bool>> := [v37, {f28}, v37, fm45(f38, multiset(f32), f28, -v32, globalState), v37];
				var v39: set<set<bool>> := {v38[safeIndex(|f32|, |v38|)]};
				var v40: array<bool> := new bool[3](i1 => f35);
				var v41: seq<array<bool>> := [v40];
				var v42: seq<array<bool>> := [v41[safeIndex(0x2bc, |v41|)], v40];
				v36 := DC6(|v39|, f28, if (!f29) then |f32| else 0x3c8, f29, |v42|);
				var v43: map<seq<int>, bool> := map[v31 := true];
				v43 := (v43[v31 := f28])[(seq(abs(991), i2  => (f30))) + v31 := f35];
			} else {
				...
				var v50: array<int> := new int[16] [f34, |v48| - f38, |"lyvg"| + |f33|, 0x8c, f38, f30 * f30, f30, |((seq(abs(0x330), i3  => (f36))) + v46)|, f34, f30, f38, |v46|, f34, f30, safeModuloInt(f30, f30), |map[f29 := |(map v49 : int | (-0x284 <= v49) && (v49 < 0x136) :: (v49 - f30) := (f31))|]|];
				v50[safeIndex(832, v50.Length)] := f38;
				var v51: set<int> := {f30};
				var v52 := DC51(fm59(f35, f35, f28, globalState));
				var v53: map<int, set<int>> := map[f30 := v51];
				globalState.f12, globalState.f12, f36, v50[safeIndex(832, v50.Length)] := f34 !in v51, false, fm48(v52.cf88 != v53[f38 := set v54 : int | (-564 <= v54) && (v54 < 0x385) :: (safeModuloInt(v54, |map[f29 := f35]|))], f35, f38, globalState), |(seq(abs(0x2f4), i4  => (f38)))|;
				f36 := f36;
				var v55: array<string> := new string[3](i5 => v46);
				v55[safeIndex(958, v55.Length)] := v46;
				v55[safeIndex(958, v55.Length)] := fm3(!!f35, false, globalState);
				var v56: array<multiset<bool>> := new multiset<bool>[6](i6 => multiset{f29});
				var v57: multiset<bool> := multiset{f28, f31, f31};
				v56[safeIndex(962, v56.Length)] := v57;
				var v58: array<bool> := new bool[25];
				v58[safeIndex(323, v58.Length)] := f28;
				v46, v56[safeIndex(962, v56.Length)], globalState.f1, v50[safeIndex(832, v50.Length)], v58[safeIndex(323, v58.Length)] := v55[safeIndex(958, v55.Length)], v57[f31 := abs(f38)], 939 < -f38, v50[safeIndex(832, v50.Length)], !!f28;
				var v59: multiset<int> := multiset{f34};
				var v60 := DC44(v59, f34);
				var v61: map<bool, bool> := map[[f28] < f32 := f29];
				v60, v50[safeIndex(832, v50.Length)] := v60.(cf78 := 695), |v61|;
			}
			
			var v62 := "rvpm";
			v62 := "nnhqon";
			var v63: array<bool> := new bool[26](i7 => multiset{v62[safeIndex(f38, |v62|)]} > multiset{f36});
			v63[safeIndex(361, v63.Length)] := f28;
			v63[safeIndex(96, v63.Length)] := f31;
			var v64: multiset<bool> := multiset{f29, f29};
			var v65: seq<int> := [-f34, if (f31 in v64) then v64[f31] else |{false}|, 0x1af];
			globalState.f13, v63[safeIndex(361, v63.Length)], v63[safeIndex(96, v63.Length)] := safeDivisionInt(|v65|, v65[safeIndex(984, |v65|)]), -f38 >= f34, f28;
		...
		v68[safeIndex(129, v68.Length)] := |v69|;
		v67, globalState.f13, globalState.f13, globalState.f13, v68[safeIndex(129, v68.Length)] := v67, f30, -f34, f38, f30;
		var v70: map<int, bool> := map[f38 := f35];
		var v71: map<map<int, bool>, int> := map[v70 := v68[safeIndex(129, v68.Length)]];
		var v72: seq<map<map<int, bool>, int>> := [v71, v71 + v71, v71, v71];
		r0 := v72[safeIndex(0x152, |v72|)];
	}
	method m5(globalState: GlobalState) returns (r0: int, r1: array<set<bool>>, r2: array<bool>) {
		var v0: array<int> := new int[24];
		var v1: map<string, array<int>> := map[seq(abs(0x30a), i0  => (f36)) := if (false) then v0 else v0];
		v1 := v1[fm3(f28, f31, globalState) := v0];
		var v2: array<bool> := new bool[4](i1 => --f34 >= |map[f28 := f31]|);
		v2[safeIndex(811, v2.Length)] := !(f31 && true);
		var v3: multiset<bool> := multiset{f28};
		var v4: map<int, multiset<bool>> := map[f34 := v3];
		v0[safeIndex(195, v0.Length)] := |fm3(f35, f32[safeIndex(f30, |f32|)], globalState)|;
		var v5: multiset<int> := multiset{f38, 0x145};
		v0[safeIndex(654, v0.Length)] := fm39(f31, v5, f28, globalState);
		f36, v2[safeIndex(811, v2.Length)], v4, v0[safeIndex(195, v0.Length)], v0[safeIndex(654, v0.Length)] := f36, f29, (map[-0x363 := v3] + v4) + (v4 + v4), f30, f38;
		if (f32 < f32) {
			globalState.f13 := v0[safeIndex(195, v0.Length)];
			v0 := v0;
			var v6: seq<char> := [f36, f36];
			var v7: seq<bool> := [true, false, if (!f35) then f29 else f29, f28];
			var v8: set<int> := {f34};
			v6, globalState.f26, v7, globalState.f13, v8 := [f36] + v6, f34 < -f38, f32 + v7, v0[safeIndex(195, v0.Length)], v8;
			var v9: map<array<int>, string> := map[v0 := fm3(f31, v2[safeIndex(811, v2.Length)], globalState)];
			v9 := v9[v0 := v6];
			var v10: map<int, bool> := map[0x3e3 := !v2[safeIndex(811, v2.Length)]];
			v10 := v10[v0[safeIndex(195, v0.Length)] := f35];
		} else {
			var v11 := "aki";
			var v12: seq<int> := [|"ox"|];
			var v13: seq<int> := [--v12[safeIndex(-f30, |v12|)]];
			v11, f35, r0 := (seq(abs(0x110), i2  => (f36))) + v11, (f28 || v2[safeIndex(811, v2.Length)]) ==> (fm60(globalState) != (map[f28 := v12])[v2[safeIndex(811, v2.Length)] := v12]), v0[safeIndex(195, v0.Length)];
			v0[safeIndex(195, v0.Length)] := -(f38 + |f32|);
			...
			var v19: set<bool> := {v2[safeIndex(811, v2.Length)], f29};
			var v21: multiset<D0> := multiset{v15};
			var v22: array<D8> := new D8[18] [v17, DC21(if (|v19| in v18) then v18[|v19|] else map[v15 := v2[safeIndex(811, v2.Length)]]).(cf40 := map v20 : D0 | v20 in v21 :: (v20) := (f29)), v17, v17, v17, fm61(v11, v2[safeIndex(811, v2.Length)], f30, globalState), DC21(v16), v17, DC21(v16), v17, v17, DC21(map[v15 := f35]), v17, v17, DC21(map[DC1(multiset{f31, true}) := f29]), v17, v17, v17];
			v22[safeIndex(661, v22.Length)] := v17;
			v22[safeIndex(661, v22.Length)], v5 := v17, (v5 + multiset(v13)) - (v5 - v5);
		}
		
		globalState.f13 := v0[safeIndex(195, v0.Length)];
		var i3 := 0;
		while ((|map[v0 := v2[safeIndex(811, v2.Length)]]| * f34) > |v3[f32[safeIndex(if (v2[safeIndex(811, v2.Length)] in v3) then v3[v2[safeIndex(811, v2.Length)]] else v0[safeIndex(195, v0.Length)], |f32|)] := abs(f34)]|)
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			i3 := i3 + 1;
			var v23 := "wejhofhx";
			var v24: map<string, bool> := map[v23 := v2[safeIndex(811, v2.Length)]];
			var v25: array<char> := new char[25];
			var v26: C0 := new C0(v25);
			var v27 := DC27(v26, v23);
			var v28: map<bool, D9> := map[f28 := v27];
			var v29: map<int, map<bool, D9>> := map[v0[safeIndex(195, v0.Length)] := v28];
			v24, globalState.f13, v0 := v24, safeModuloInt(|(v29 + v29)|, v0[safeIndex(195, v0.Length)]), v0;
			var v30: seq<int> := [v0[safeIndex(195, v0.Length)], f38];
			var v31: array<seq<int>> := new seq<int>[16] [v30, v30, v30[safeIndex(v0[safeIndex(195, v0.Length)], |v30|) := f38], v30, seq(abs(0x398), i4  => (|v5|)), v30, v30 + v30, v30, v30 + [f30, f30], fm23(f31, |v3|, globalState), v30, (v30 + v30)[safeIndex(f38, |(v30 + v30)|) := f34], if (f29) then fm23(!f35, f38, globalState) else seq(abs(0x6b), i5  => (|"idwc"|)), v30 + v30, v30, v30];
			v31, v0, globalState.f1, v0[safeIndex(195, v0.Length)] := v31, v0, f31, if (fm6(globalState)) then |v23| else -(f38 * f34);
			var v32: map<int, int> := map[-|v23| := f34 + f38];
			var v33: map<map<int, int>, int> := map[v32 := v0[safeIndex(195, v0.Length)]];
			v32 := v32[|(v33 + v33)| := -safeModuloInt(-0x109, f38)];
			var v34: map<bool, D21> := map[f31 ==> f31 := fm62(f36, v2[safeIndex(811, v2.Length)], f29, f28, globalState)];
		...
		for i6 := f34 to f38 {
			...
			var v39 := DC45(v38);
			v39 := v39;
			v0[safeIndex(195, v0.Length)] := -(0x58 + i6);
			var v40: map<char, array<bool>> := map[f36 := v2];
			v40 := v40[f36 := v2];
			if (f35) {
				v0[safeIndex(195, v0.Length)] := 55;
				globalState.f21 := v2;
				var v41 := "fvq";
				var v42: C4 := new C4(718, true, [!f31] + f32, f33, |v41|, v2[safeIndex(811, v2.Length)], f35, f29);
				var v43: map<bool, bool> := map[false := f35];
				f31, v41, v0, f29, v42 := v2[safeIndex(811, v2.Length)], v41, v0, !(multiset{if (f28 in v43) then v43[f28] else f29, f31, false, f29} >= v3), v42;
				var v44: seq<multiset<bool>> := [v3];
				v2[safeIndex(811, v2.Length)] := if ((v44[safeIndex(f38, |v44|)])[f31 := abs(v0[safeIndex(195, v0.Length)])] !! v3) then f35 else true;
				var v45: array<string> := new string[8](i7 => v41);
				v45[safeIndex(145, v45.Length)] := v41;
				v45[safeIndex(145, v45.Length)] := (v41 + v41) + fm3(f28, f31, globalState);
			} else {
				...
				v49 := v49;
				globalState.f13 := i6;
				v0[safeIndex(195, v0.Length)] := v0[safeIndex(195, v0.Length)];
			}
			
		}
		var v50: multiset<multiset<bool>> := multiset{v3, v3, fm33(f29, globalState)};
		r0 := |(v50 + (v50[v3 := abs(v0[safeIndex(195, v0.Length)])])[v3 := abs(0x1bc)])|;
		r1 := new set<bool>[19];
		r2 := v2;
	}
}
...
class C10 extends T4 {
	...
	function fm5(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<bool> {
		match DC1(multiset(f32)) {
			...
			case DC0(cf0) => f33[safeIndex(f34, |f33|)] + f32
		}
	}
	function fm3(p0: bool, p1: bool, globalState: GlobalState): string {
		"lgpghnx" + (seq(abs(0x3df), i0  => (f36)))
	}
	function fm2(globalState: GlobalState): map<bool, int> {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: int, r2: string) {
		...
		match (v1) {
			case DC1(cf1) =>
				...
				var v9: array<int> := new int[12] [0xf, |(v4 + v4)|, |v5|, |v6|, f34, f34, f30, f30, f30, |v8|, f30, safeDivisionInt(f34, 590)];
				v9[safeIndex(469, v9.Length)] := f30;
				v9[safeIndex(469, v9.Length)] := -(fm8(false, f36, f29, globalState) + v5[safeIndex(f34, |v5|)]);
				v9[safeIndex(469, v9.Length)] := f30;
				var v10: map<bool, array<bool>> := map[f28 := DC2(v7).cf2];
				var v11: multiset<array<bool>> := multiset{if (f28 in v10) then v10[f28] else v7};
				var v12: set<int> := {v9[safeIndex(469, v9.Length)]};
				var v14 := m0([if (v7 in v11) then v11[v7] else v9[safeIndex(469, v9.Length)]] + v5, f29, if (|[f28]| in v6) then v6[|[f28]|] else |v5|, v12 > (set v13 : int | (0x244 <= v13) && (v13 < 0x11e) :: (v13 * -0x19f)), globalState);
			case DC0(cf0) =>
				globalState.f26 := f35;
		...
		var v22: array<bool> := new bool[6](i2 => (seq(abs(866), i3  => (f36))) == "fxsini");
		v22[safeIndex(190, v22.Length)] := false;
		r2, v22[safeIndex(190, v22.Length)] := match DC0(f29) {
			case DC1(cf1) => seq(abs(627), i4  => ('s'))
			case DC0(cf0) => "srxfo" + (seq(abs(0x1d1), i5  => (f36)))
		}, f31;
		var v23: seq<int> := [safeModuloInt(f34, 0x6a), f34];
		var v24 := "p";
		v23, r0, r2 := v23, !!f28, v24;
		var i6 := 0;
		while (!((seq(abs(0xf1), i7  => (f36))) < fm3(v22[safeIndex(190, v22.Length)], v22[safeIndex(190, v22.Length)], globalState)))
			decreases 100 - i6
		{
			if (i6 >= 100) {
				break;
			...
			v25 := {f35, f30 > f34, v22[safeIndex(190, v22.Length)], f28 !in v25};
			var v26 := DC0(true);
			var v27: array<string> := new string[9];
			var v28: map<bool, array<string>> := map[false := if (v26.cf0) then v27 else v27];
			v28 := v28[f28 := if (v22[safeIndex(190, v22.Length)]) then v27 else if (f35 in v28) then v28[f35] else v27];
			globalState.f21 := v22;
			...
			match (v31) {
				case DC3(cf3, cf4, cf5, cf6) =>
					...
					var v33 := DC6(f34, v22[safeIndex(190, v22.Length)], |v24|, f29, f30);
					v32 := v32[cf6 := v33.cf9];
					globalState.f1 := fm10(v25, 'y', cf4, !f31, globalState) > {fm11(f33, f35, true, f34, globalState), v25, v25};
					r2 := (v24 + v24)[safeIndex(cf4, |(v24 + v24)|) := 'r'];
					globalState.f12 := f31;
				case DC2(cf2) =>
					...
					var v37 := DC7(seq(abs(-446), i8  => (map[f28 := -f34])));
					var v38: array<seq<map<bool, int>>> := new seq<map<bool, int>>[6] [v36, v37.cf14, v36, v36, v36, v36];
					v38[safeIndex(613, v38.Length)] := v36;
					r0, v22[safeIndex(190, v22.Length)], f36, globalState.f13, v38[safeIndex(613, v38.Length)] := fm8(f31, 'p', f31, globalState) > f30, v22[safeIndex(190, v22.Length)], 'd', f30, (v36 + v36) + v36;
					v35 := v35[v22[safeIndex(190, v22.Length)] := f34];
					v30 := v30;
				case DC4(cf7) =>
					globalState.f26 := f31;
					...
					globalState.f13 := v23[safeIndex(f34, |v23|)];
					globalState.f1 := false;
			}
		...
		r0 := f31;
		r1 := f34;
		r2 := fm3(f32[safeIndex(f34, |f32|)], !true, globalState) + (v24 + v24);
	}
	method m2(p0: int, p1: int, p2: int, p3: seq<set<bool>>, globalState: GlobalState) returns (r0: bool, r1: D0, r2: D0, r3: bool) {
		...
		v0[safeIndex(695, v0.Length)] := f30 == v2.cf17;
		v0[safeIndex(695, v0.Length)] := f29;
		var i1 := 0;
		while (f35)
			decreases 100 - i1
		{
			...
			var v4 := "kddokf";
			v3, globalState.f13, v0[safeIndex(695, v0.Length)], v3, f31 := DC9(f28, !f35 !in [false, v0[safeIndex(695, v0.Length)], f28, v0[safeIndex(695, v0.Length)], f35], v0, v0[safeIndex(695, v0.Length)]), safeDivisionInt(|(v4 + v4)|, p0), f28 <== f28, v3, f31;
			var v5: multiset<int> := multiset{p2};
			var v6: map<bool, int> := map[v0[safeIndex(695, v0.Length)] := |f32|];
			globalState.f26 := (v5 > v5) ==> (v6 != v6);
			var v7: array<int> := new int[10](i2 => safeModuloInt(i2, p0));
			v7 := v7;
			globalState.f1 := !(if (f28) then f31 else v0[safeIndex(695, v0.Length)]);
		}
		var v8: array<string> := new string[19];
		var v9: seq<array<string>> := [v8];
		var v10: set<bool> := {v0[safeIndex(695, v0.Length)]};
		var v11: multiset<set<bool>> := multiset{v10};
		var v12: array<array<string>> := new array<string>[28] [v9[safeIndex(if ({v0[safeIndex(695, v0.Length)]} in v11) then v11[{v0[safeIndex(695, v0.Length)]}] else f34, |v9|)], v8, v8, v8, v8, v8, v8, v8, v8, if (f31) then v8 else v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, if (f28) then v8 else v8, v8, v8, v8, v8, v8, v8, v8];
		v12[safeIndex(469, v12.Length)] := v8;
		v12[safeIndex(469, v12.Length)] := v8;
		var i3 := 0;
		while (true)
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			v0[safeIndex(695, v0.Length)] := (f34 - p1) <= f34;
			var v13: multiset<bool> := multiset{f35, f28};
			var v14: seq<multiset<bool>> := [v13];
			var v15: array<multiset<bool>> := new multiset<bool>[14] [v13, if (f28) then v13 else v13, v13, multiset{f31, f32[safeIndex(f34, |f32|)], f29, f28, f28}, v13, v13, v13, if (f31) then v13 else v13, v14[safeIndex(p2, |v14|)], multiset{f32[safeIndex(f30, |f32|)]}, v13 + v13, multiset{f35, f35, v0[safeIndex(695, v0.Length)], f28, false}, multiset([!f31]), v13];
			v15[safeIndex(490, v15.Length)] := v13[false := abs(-f30)];
			var v16 := "unmvjnend";
			var v17: map<bool, string> := map[f29 := v16];
			v15[safeIndex(490, v15.Length)] := multiset{f29, "jfc" == (if (v0[safeIndex(695, v0.Length)] in v17) then v17[v0[safeIndex(695, v0.Length)]] else v16)};
			...
			var v22 := DC3(v0[safeIndex(695, v0.Length)], p0, v20, f30);
			var v23: T4 := new C3(|f32|, v21, f36, -f30, v0[safeIndex(695, v0.Length)], [f31, v22.cf3], [[f31]], |f32|, f35, f28, !f29);
			var v24: map<T4, int> := map[v23 := p1];
			var v25: map<char, int> := map[if (f28) then f36 else f36 := if (v23 in v24) then v24[v23] else -p2];
			var v26: seq<int> := [f30];
			var v27: multiset<int> := multiset{v26[safeIndex(f30, |v26|)], v23.f34, v23.f30};
		...
		var v30 := DC54(v29);
		v28[safeIndex(891, v28.Length)] := v30.cf91;
		v28[safeIndex(891, v28.Length)] := v29;
		...
		r0 := (multiset{v33})[v33 := abs(f30)] < v34[v33 := abs(p1)];
		var v35: multiset<bool> := multiset{f28, f28, f28, v0[safeIndex(695, v0.Length)], true};
		r1 := DC1(v35);
		var v36 := DC0(!(v10 != {v0[safeIndex(695, v0.Length)], f31, f28}));
		r2 := v36;
		r3 := f28;
	}
	method m3(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: bool) {
		...
		v2[safeIndex(458, v2.Length)] := f30;
		...
		f31, v0, v2[safeIndex(458, v2.Length)] := p0, match v4 {
			case DC13(cf27, cf28, cf29) => {f30, -0x28d}
			case DC14(cf30, cf31) => v0
			case DC12(cf26) => if (f35) then v0 else v0
		}, -|v5[(map[false := f30])[false := f34] := abs(|[fm7(fm49(v7, f36, [v9], globalState), f30, globalState)]|)]| + |v10|;
		if (!p0) {
			var v11: map<bool, seq<int>> := map[f35 := v9];
			var v12: seq<bool> := [|v11| > |v9[safeIndex(v2[safeIndex(458, v2.Length)], |v9|) := |v6|]|, f29];
			v12 := fm0(v2[safeIndex(458, v2.Length)] - f34, f31, p0, f34 + |fm3(f29, f29, globalState)|, globalState);
			f29 := f35;
			var v13: seq<set<int>> := [v0];
			v0 := v13[safeIndex(|multiset{f28, f28}|, |v13|)] * (v0 + v0);
			var v14: multiset<multiset<bool>> := multiset{v10[p0 := abs(178)]};
			var v15 := DC46(v14);
			match (v15) {
				case DC46(cf80) =>
					var v16: array<multiset<bool>> := new multiset<bool>[22];
					v16[safeIndex(163, v16.Length)] := v10;
					var v17: seq<multiset<bool>> := [v10, v10];
					v16[safeIndex(163, v16.Length)] := v17[safeIndex(f30 - v2[safeIndex(458, v2.Length)], |v17|)];
			...
			var v28 := DC48(v2[safeIndex(458, v2.Length)], v27, f28);
			var v29 := DC50(v28);
			v21, globalState.f26, v22, r1 := (if (p0) then v21 else v21).(cf33 := v24[safeIndex(f34, |v24|)]), f36 in v6, if (true) then DC50(v29) else v22, safeModuloInt(f34, -651);
		} else {
			v6, v2[safeIndex(458, v2.Length)] := v6, --v2[safeIndex(458, v2.Length)];
			var v30: map<char, int> := map[f36 := 0x2cd];
			var v31: map<map<char, int>, string> := map[v30 := v6];
			globalState.f1 := v2[safeIndex(458, v2.Length)] >= safeModuloInt(|v31|, f34);
			if (f35) {
				v9 := (v9 + v9) + (v9 + v9);
				var v32: array<bool> := new bool[6](i1 => true);
				var v33: map<char, map<bool, bool>> := map[f36 := v8];
				v32[safeIndex(330, v32.Length)] := fm0(f34, true, p0, f34, globalState) < fm0(|(if ('e' in v33) then v33['e'] else v8)|, false, p0, f30, globalState);
				var v34: map<int, char> := map[f34 := f36];
				var v35: array<char> := new char[1](i2 => f36);
				var v36: C0 := new C0(v35);
				var v37 := DC27(v36, v6);
				var v38: map<D9, bool> := map[v37 := f29];
				var v39: C6 := new C6(if (fm46(|v38|, v2[safeIndex(458, v2.Length)], f28, globalState) in v34) then v34[fm46(|v38|, v2[safeIndex(458, v2.Length)], f28, globalState)] else f36, v2[safeIndex(458, v2.Length)], !!p1, f32, f33, f30, p0, p0, f35);
				var v40: set<C6> := {v39, v39};
				var v41: map<int, bool> := map[safeDivisionInt(|v40|, f30) := p0];
				v32[safeIndex(330, v32.Length)] := if (f34 in v41) then v41[f34] else p0;
				globalState.f21 := v32;
				r2 := -f30;
				...
				v44[safeIndex(932, v44.Length)] := f28;
				var v45: seq<array<int>> := [v2];
				globalState.f26, v44[safeIndex(932, v44.Length)], globalState.f26, f28, globalState.f13 := fm1(f28 || f32[safeIndex(v2[safeIndex(458, v2.Length)], |f32|)], 96, globalState), v45 < v45, fm1(f29, safeModuloInt(f34, v2[safeIndex(458, v2.Length)]), globalState), f31, v2[safeIndex(458, v2.Length)];
				var v47 := DC34(set v46 : int | v46 in v0 :: (safeModuloInt(v46, |[|[true]|, 0x2a0, |[!!true]|, 866]|)));
				var v48: array<D12> := new D12[7] [v47, v47, DC34(v0), v47, if (false) then v47 else v47, v47, v47];
				v48[safeIndex(830, v48.Length)] := v47;
				globalState.f13, v6, globalState.f1, v48[safeIndex(830, v48.Length)] := 0x124, v6, !true, fm63(f28 && v44[safeIndex(932, v44.Length)], p1, p0, globalState);
				var v49: seq<seq<bool>> := [f32 + f32];
				r1, globalState.f13, v2[safeIndex(458, v2.Length)], f36, v49 := 0x2f7, f30 + (f30 * v2[safeIndex(458, v2.Length)]), f34, f36, v49 + f33;
				var v50: seq<bool> := [true];
				v50 := v50;
				var v51 := DC11(|v8|, v44[safeIndex(932, v44.Length)], |"tuwhsf"|);
				v2[safeIndex(458, v2.Length)] := (v51.cf25 - v2[safeIndex(458, v2.Length)]) + v2[safeIndex(458, v2.Length)];
			}
			...
			v59[safeIndex(104, v59.Length)] := f28;
			var v60: map<int, int> := map[f34 := if (f28 in v10) then v10[f28] else f34];
			v59[safeIndex(104, v59.Length)] := f32[safeIndex(|v60| + v2[safeIndex(458, v2.Length)], |f32|)];
		}
		...
		if (p1) {
			...
			if (f31) {
				...
				globalState.f21 := v61;
				var v62 := DC40(v6, v2[safeIndex(458, v2.Length)]);
				var v63: T1 := new C7(f34, v7 * v7, f30, v62.cf73 < v6, f29, f28);
				v63 := v63;
				var v64: multiset<seq<char>> := multiset{[f36]};
				v61[safeIndex(872, v61.Length)] := v64 > v64;
				var v65 := DC9(v63.f28, f31, v61, p1);
				var v66: set<bool> := {!p1, f28, !v63.f28};
				var v67: map<int, bool> := map[v2[safeIndex(458, v2.Length)] := f31];
				var v69: set<map<int, bool>> := {v67, map v68 : int | v68 in {v2[safeIndex(458, v2.Length)]} :: (v68 * v2[safeIndex(458, v2.Length)]) := (v63.f28)};
				var v70: seq<bool> := [{f35, false} != v66, v69 !! v69, !true];
				var v71: array<char> := new char[8] [f36, 'a', f36, 's', f36, f36, v6[safeIndex(f34, |v6|)], f36];
				var v72: seq<seq<seq<bool>>> := [f33, seq(abs(0x19e), i5  => (f32))];
				var v73: T3 := new C5(v63.f29, f34, v2[safeIndex(458, v2.Length)], p1, f32, seq(abs(210), i6  => (f32)), v63.f30, !p0, f31, p1);
				var v74: map<T3, int> := map[v73 := |v3|];
				var v75: T3 := new C5(f35, v2[safeIndex(458, v2.Length)], v63.f30, f35, v70, v72[safeIndex(|v74|, |v72|)], |v70|, v73.f28, p0, p1);
				var v76: map<array<char>, T3> := map[v71 := v75];
				v61[safeIndex(872, v61.Length)], v65, r2, v70 := f29 || p0, v65.(cf20 := if (f29) then v61 else v61), safeDivisionInt(f34, |v76|), v75.f32;
				v2[safeIndex(458, v2.Length)] := |(v66 * ({v61[safeIndex(872, v61.Length)], v63.f29, v63.f31, v63.f29, fm7(v7[-f34 := abs(0x9a)], v75.f34, globalState)} - v66))|;
				...
				var v84: C3 := new C3(|v83|, v82, f36, v2[safeIndex(458, v2.Length)], false, f32, f33, |v0|, fm1(p1, f30, globalState), true, p1);
				var v85: map<int, C3> := map[v2[safeIndex(458, v2.Length)] := v84];
				var v86: seq<C3> := [v84, if (f30 in v85) then v85[f30] else v84];
				var v87: map<int, int> := map[|map[f28 := f36]| := f34];
				var v88 := new C3(|v81|, v82, f36, f34 - v2[safeIndex(458, v2.Length)], fm7(multiset{-v2[safeIndex(458, v2.Length)]}, |v86|, globalState), f32, f33, if (v2[safeIndex(458, v2.Length)] in v87) then v87[v2[safeIndex(458, v2.Length)]] else v84.f44, f28, f34 <= v84.f44, v10 > v10);
				var v89 := new C4(safeModuloInt(|[v2[safeIndex(458, v2.Length)]]|, v84.f44), 213 <= 0x1c4, f32, [f32, f32, f32] + f33, v84.f44, p1 <== false, f28, p1);
				v2[safeIndex(458, v2.Length)] := -v84.f44;
				globalState.f26 := (f30 == f34) <==> v89.fm6(globalState);
				var v90: seq<multiset<int>> := [v7, v7];
				var v91: T1 := new C7(v84.f44, v90[safeIndex(v2[safeIndex(458, v2.Length)], |v90|)], |v6[safeIndex(v84.f44, |v6|) := f36]|, f28, p1, v89.fm44(f30, globalState));
				v91 := new C7(-safeDivisionInt(v91.f30, v88.f44), fm25(globalState), v91.f30, true, v84.f44 != v88.f44, v91.f28);
			}
			
			v8 := v8[p0 := !!f31];
			globalState.f13 := v2[safeIndex(458, v2.Length)];
			var v92 := DC1(v10);
			var v93: map<int, D0> := map[v2[safeIndex(458, v2.Length)] := v92];
			...
			v96[safeIndex(549, v96.Length)] := v93;
			var v97 := DC22(f30, |v6[safeIndex(f34, |v6|) := f36]|);
			var v98: map<bool, D8> := map[f28 := v97];
			var v100: map<int, bool> := map[v2[safeIndex(458, v2.Length)] := p0];
			r1, v96[safeIndex(549, v96.Length)], globalState.f13, v98, globalState.f1 := f34, v93 + (map v99 : int | v99 in v100 :: (safeDivisionInt(v99, f30)) := (v92)), f34, if (p1) then v98 else fm65(f34, f35, f34, globalState) + (map[f35 := v97])[f35 := DC22(f30, f34)], f28;
		} else {
			if (f28) {
				globalState.f13 := v2[safeIndex(458, v2.Length)];
				f36 := v6[safeIndex(v2[safeIndex(458, v2.Length)], |v6|)];
				globalState.f21 := new bool[23](i8 => p1);
				var v101 := DC1(v10);
				var v102: map<int, bool> := map[v2[safeIndex(458, v2.Length)] := f31];
				var v103: seq<map<int, bool>> := [v102];
				var v104: set<bool> := {false};
				var v105 := DC6(f34, f35, |v104|, f35, |map[f31 := f30]|);
				v101, v8, v2[safeIndex(458, v2.Length)], r3 := fm15(|v9|, |v103|, globalState), map[f35 := v105.cf10] + v8, 121, (v6 + v6) <= v6;
				f36 := f36;
			} else {
				...
				var v110: T1 := new C7(|v106| - |v7|, v7 * v7, -|(seq(abs(-0x26a), i9  => (f36)))|, if (|v6[safeIndex(-f30, |v6|) := f36]| in v107) then v107[|v6[safeIndex(-f30, |v6|) := f36]|] else f28, f31 in f32, v109 !! v109);
				v110 := v110;
				var v111: array<bool> := new bool[6](i10 => true);
				v111[safeIndex(527, v111.Length)] := p1;
				v111[safeIndex(527, v111.Length)] := (v110.f31 || !v110.f28) && v110.f31;
				var v112 := new C4(safeDivisionInt(DC31(v108.f29, f28, v110.f30).cf62, 0x2f2), true, f32, v108.f33, v108.f30, v111[safeIndex(527, v111.Length)], v3 in v5, !f31);
				var v113: seq<multiset<bool>> := [(multiset{v111[safeIndex(527, v111.Length)]})[v110.f31 := abs(fm24(v110.f31, v2[safeIndex(458, v2.Length)], globalState))], multiset{v108.f28, v110.f29} * (multiset{f28})[v108.f28 := abs(v2[safeIndex(458, v2.Length)])], v10[v110.f29 := abs(v108.f30)]];
				v113 := [if (v110.f29) then v10 else v10[false := abs(f30)]];
				var v114: T3 := new C4(safeDivisionInt(v108.f30, f30), p1, f32, f33, -f30, v108.f28, f29, false);
				v114, v6 := v114, v6;
			}
			
			var v115: array<string> := new string[24];
			v115[safeIndex(349, v115.Length)] := v6;
			var v116 := DC40(fm3(f29, p0, globalState), v2[safeIndex(458, v2.Length)]);
			v115[safeIndex(349, v115.Length)] := v116.cf73;
			globalState.f1 := f31;
			var v117: array<bool> := new bool[24];
			v117[safeIndex(904, v117.Length)] := f32[safeIndex(f34, |f32|)];
			var v118: array<char> := new char[21](i11 => f36);
			v118[safeIndex(786, v118.Length)] := f36;
			var v119 := DC1(v10);
			var v120: map<int, bool> := map[-0x189 := f28];
			v117[safeIndex(904, v117.Length)], v118[safeIndex(786, v118.Length)], v2[safeIndex(458, v2.Length)], r1, r1 := f28, fm14(f34, p0 <== f29, fm39(f28, multiset{v2[safeIndex(458, v2.Length)]}, f35, globalState), v119.(cf1 := v10), globalState), |((seq(abs(0x266), i12  => (f36))) + v115[safeIndex(349, v115.Length)])| + f34, f34, |(v120[0x2e7 := false])[-f30 := f35]| + f34;
			v2 := v2;
		}
		
		var v121 := new C5(p1, v2[safeIndex(458, v2.Length)], if (f34 in v7) then v7[f34] else 0x1bc, f28, f32, f33, v2[safeIndex(458, v2.Length)], f31, f31, !f29);
		var v122 := DC34(v0);
		v122 := if (!p1) then v122 else v122;
		var v123: map<int, map<bool, bool>> := map[v2[safeIndex(458, v2.Length)] := v8[p0 := p0]];
		var v124: array<array<int>> := new array<int>[25];
		var v125: map<array<array<int>>, seq<seq<bool>>> := map[v124 := f33];
		var v126 := DC36(f33);
		var v127: set<bool> := {p1};
		var v128 := new C9(-v2[safeIndex(458, v2.Length)], v123, f36, |f32|, f34 <= f30, f32, (if (v124 in v125) then v125[v124] else v126.cf67) + (seq(abs(890), i13  => (f32))), f30, v121.f47, fm11(f33, p1, v121.f47, 0xc3, globalState) >= v127, v1 in [v1]);
		r0 := v121.fm6(globalState);
		r1 := if (v121.f47 in v3) then v3[v121.f47] else |f32| - f34;
		r2 := v2[safeIndex(458, v2.Length)];
...
function fm1(p0: bool, p1: int, globalState: GlobalState): bool {
	!!!((seq(abs(0x2ee), i0  => ('g'))) != "uhvt")
}
function fm9(p0: char, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<int> {
	([|[[true], [false]]|, 0xf2] + [--0xf2]) + (if (true) then [-0x287, |"p"|, 0x242, 0xe3] else [|multiset{seq(abs(-0x23d), i0  => ('j'))}|, --|(seq(abs(0x23b), i1  => (|[0x18b, -0x20f]|)))|])
}
...
function fm12(p0: char, p1: int, p2: map<bool, int>, p3: bool, globalState: GlobalState): D2 {
	DC6(--safeDivisionInt(207, -0x4c), multiset{multiset{0x2dc}} >= multiset{multiset{|map[true := |map[0x2a6 := [true]]|]|, 0x24e}, multiset{|"tx"|}, multiset(seq(abs(0x19), i0  => (-0x15c)))}, |(seq(abs(0x1d8), i1  => (|map[false := false]|)))|, false, -|map[!true := |[false, false]|]|)
}
...
function fm23(p0: bool, p1: int, globalState: GlobalState): seq<int> {
	[|[DC10(multiset{0x290}), DC10(multiset{|(seq(abs(-781), i0  => ('v')))|, 413})]|]
}
function fm24(p0: bool, p1: int, globalState: GlobalState): int {
	match DC49(false, 'w') {
		case DC48(cf82, cf83, cf84) => 0x1d6 - 0x265
		case DC49(cf85, cf86) => safeDivisionInt(|{|multiset{cf85}|, -0x1b8}|, 0x261)
		case DC47(cf81) => 132
		case DC50(cf87) => 0x272
	}
}
function fm25(globalState: GlobalState): multiset<int> {
	multiset{|map[-|{'u', 'u'}| := |map[false := -198]|]|, 0x1f0} + (multiset{|{|(map v0 : int | (550 <= v0) && (v0 < -304) :: (safeModuloInt(v0, |(seq(abs(-0x3d4), i0  => ('t')))|)) := (map[false := false]))|, |[0xa5, 557]|}|, |map[true := !true]|} - multiset{0x129, -|{|map[68 := true]|}|})
}
...
function fm31(p0: int, p1: map<int, int>, p2: bool, p3: bool, globalState: GlobalState): map<map<int, bool>, multiset<char>> {
	(map v0 : map<int, bool> | v0 in {map[|[true]| := !true], map[|[!true]| := false]} :: (v0) := (multiset{'p'})) + ((map v1 : map<int, bool> | v1 in (seq(abs(0x1e4), i0  => (map[0x2d7 := false]))) :: (v1) := (multiset(['j', 'o']))) + (map v2 : map<int, bool> | v2 in [map[0x6b := false], map[-709 := DC29(433, true).cf57]] :: (v2) := (multiset{'a', 'r'})))
}
function fm32(p0: bool, globalState: GlobalState): int {
	-safeDivisionInt(0x143, safeDivisionInt(|multiset{826}|, |"cvfvdpjmg"|))
}
...
function fm35(p0: bool, globalState: GlobalState): map<D0, bool> {
	match DC24(true, |(seq(abs(-792), i0  => ('a')))|, [true], false, [|map[map[true := |map[false := true]|] := 0x389]|]) {
		case DC22(cf41, cf42) => DC21(map v0 : D0 | v0 in (seq(abs(682), i1  => (DC1(multiset{true})))) :: (v0) := (false)).cf40 + map[DC1(multiset([true, false])) := false]
...
function fm38(p0: bool, p1: int, globalState: GlobalState): map<int, int> {
	(map v0 : int | v0 in [|"xsk"|] :: (safeDivisionInt(v0, -244)) := (---0x2d9)) + map[0x138 := 0x29d]
}
...
function fm42(p0: seq<char>, p1: int, p2: string, globalState: GlobalState): seq<int> {
	[-|map[0x3dc := |(seq(abs(59), i0  => (0xca)))|]|] + ([|{true, !false, true}|] + (seq(abs(0x5), i1  => (--0x2b2))))
}
function fm43(globalState: GlobalState): multiset<int> {
	match DC25(DC24(true, |map["gbqytxrv" := |map[!false := true]|]|, [true], !true, seq(abs(549), i0  => (-972)))) {
		case DC22(cf41, cf42) => multiset{-766, 342, cf41, cf42}
		case DC23(cf43, cf44, cf45) => multiset{----0xf6} + multiset{-|(seq(abs(0x1ab), i1  => ('g')))|}
		case DC24(cf46, cf47, cf48, cf49, cf50) => multiset{cf47, cf47, cf47, cf47}
		case DC21(cf40) => multiset{0x340, |{!false}|, 0x315, |map[|"fuonpos"| := false]|} - multiset{|(seq(abs(0x15f), i2  => ('n')))|}
...
function fm46(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
	|((DC40("llk", 0x37e).cf73 + "hf") + ((seq(abs(401), i0  => ('j'))) + "lacfjew"))|
}
function fm47(p0: bool, p1: map<int, char>, globalState: GlobalState): map<int, string> {
	map[|map[0x29c := false]| := seq(abs(-920), i0  => (DC52('j').cf89))] + map[|map[true := [!DC31(false, !!true, |map['j' := {|[|"bbpvswxo"|, 0x154]|, |{true, true}|, 0x1e1, |(map v0 : int | (-128 <= v0) && (v0 < 0x24f) :: (v0 * -966) := (true))|, |{|"pnyamwon"|, |"kd"|}|}]|).cf61, false]]| := seq(abs(0x18c), i1  => ('s'))]
}
function fm48(p0: bool, p1: bool, p2: int, globalState: GlobalState): char {
	if ([seq(abs(0x3a9), i0  => (0x5)), [0x2f1], seq(abs(0x173), i1  => (-|(seq(abs(-478), i2  => ('q')))|)), [|[multiset{111}, multiset([|[0x394, 995]|]), multiset{|(seq(abs(0xe6), i3  => (0x38c)))|}, multiset{0x3dd}, multiset([0x376])]|]] == [[0x17e], [-56, 0x308], [|multiset{false}|, 0x24]]) then 'd' else 'j'
}
...
function fm51(p0: bool, p1: char, globalState: GlobalState): seq<seq<bool>> {
	if (!(--0xb8 != |map[0x11c := false]|)) then [[true, true, true, !DC63(-626, 0x2a1, true).cf103]] else (seq(abs(0x18d), i0  => ([true]))) + [[true], [!false], [false]]
}
...
function fm53(p0: char, p1: int, globalState: GlobalState): D10 {
	DC31(!("cvutgcy" != "g"), false ==> true, |multiset{false}| * |(seq(abs(415), i0  => ('p')))|)
}
function fm54(p0: int, p1: seq<int>, p2: int, globalState: GlobalState): set<seq<int>> {
	{seq(abs(0x2ea), i0  => (|"vqw"|)), [|"pqg"|], [|{false}|]} - (set v0 : seq<int> | v0 in multiset{[|(seq(abs(0x114), i1  => ('o')))|, |map[true := |map[272 := |(seq(abs(0x27f), i2  => ('j')))|]|]|]} :: (v0))
}
...
function fm56(p0: int, p1: bool, p2: int, globalState: GlobalState): D2 {
	DC6(safeDivisionInt(0x36b, -348), if (!true) then true else !!!!true, -0x16c, !(0x37 > |map[0xe8 := |map[true := |map[false := false]|]|]|), 667)
}
...
function fm58(p0: bool, p1: seq<bool>, globalState: GlobalState): D14 {
	DC37(safeModuloInt(DC63(|map[!true := |(set v0 : char | v0 in ['q'] :: (v0))|]|, |{0x46}|, true).cf101, |(seq(abs(323), i0  => ('b')))|), true, safeDivisionInt(723, |map[-464 := |map['s' := DC22(|[-737]|, |map[false := false]|).cf41]|]|))
}
function fm59(p0: bool, p1: bool, p2: bool, globalState: GlobalState): map<int, set<int>> {
	((map v0 : int | v0 in (seq(abs(0x3df), i0  => (|[false]|))) :: (safeModuloInt(v0, |{false}|)) := ({326})) + map[-0x23e := {88}]) + (map v1 : int | v1 in multiset{|multiset{|"ekgojohii"|, 0x176, |[|[true, false]|, 0xb9, 0x3be]|}|, |map[true := |(seq(abs(976), i1  => ('v')))|]|, 248, 565} :: (v1 * |"vrr"|) := (set v2 : int | (0x385 <= v2) && (v2 < 0x3a) :: (v2 + |multiset{|(seq(abs(789), i2  => ('d')))|, |map[|multiset([false, true])| := -0x1d6]|}|)))
}
function fm60(globalState: GlobalState): map<bool, seq<int>> {
	(map[!true := [|map[false := |{|map[true := 110]|}|]|, |"vcr"|, |{DC55(|{'p', 'q', 'l', 'l'}|, 0x174, true).cf93}|, -0x265]] + map[true := seq(abs(0x156), i0  => (0x21f))]) + (map[false := seq(abs(0x2ea), i1  => (--0x321))] + map[false := seq(abs(0x7b), i2  => (|"vgo"|))])
}
function fm61(p0: string, p1: bool, p2: int, globalState: GlobalState): D8 {
	match DC41(DC39({seq(abs(522), i0  => (0x2c3)), [|map[|{false}| := false]|, 395, |(seq(abs(-512), i1  => ('u')))|, |"gkgia"|, 806], [124]})) {
...
function fm63(p0: bool, p1: bool, p2: bool, globalState: GlobalState): D12 {
	DC34({-|(seq(abs(687), i0  => ('n')))|, --|(seq(abs(0x181), i1  => ("eix")))|})
}
...
function fm69(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<D16, string> {
	map[DC39({[0x32e], [0x398]}) := "wrtq"] + map[DC39({DC24(false, |(map v0 : int | (-0x310 <= v0) && (v0 < 969) :: (v0 - |{689, 252}|) := (false))|, [false], !!true, [|{false}|]).cf50, [|(seq(abs(141), i0  => (|map[|"neweldmjf"| := 783]|)))|]}) := "dbhwx"]
}
method m0(p0: seq<int>, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: int) {
	var v0: map<int, int> := map[0x22b := safeModuloInt(p2, p2)];
	v0 := v0;
	...
	for i0 := -|v1| * fm46(if (fm68(p3, p1, p1, globalState) in v4) then v4[fm68(p3, p1, p1, globalState)] else p2, |v6|, p1, globalState) to 0x138 {
		...
		var v9 := "kuxvyifu";
		globalState.f26 := multiset{v7} !! v8[v7 := abs(|v9|)];
		var v10: multiset<int> := multiset{i0};
		var v11: array<int> := new int[16] [537, i0, |{p2}|, p2 + -|v9|, if (p3) then i0 else |v10|, p2, p2, p2, fm39(p1, v10, p3, globalState), |v9|, p2, i0, p2, p2 * p2, |(v0 + v0)|, p0[safeIndex(i0, |p0|)] * p2];
		v11[safeIndex(656, v11.Length)] := i0;
		v11[safeIndex(656, v11.Length)] := i0;
		if (p1) {
			globalState.f13 := p2;
			...
			var v17 := new C9(|v5|, v14, v2, |v9| * |v13|, p1, ([p3] + v15)[safeIndex(0x2c4, |([p3] + v15)|) := p3], v16 + v16, i0, v11[safeIndex(656, v11.Length)] > p2, p3, p3);
			globalState.f13 := safeDivisionInt(|v15|, v17.f38 * i0);
			globalState.f26 := p3;
			var v18: array<bool> := new bool[17](i2 => p1);
			var v19: map<string, array<bool>> := map[v9 := v18];
			v19 := v19[v9 + v9[safeIndex(i0, |v9|) := v2] := v18];
		} else {
			...
			v26[safeIndex(897, v26.Length)] := v28;
			v26[safeIndex(897, v26.Length)], globalState.f13 := v28, i0;
			v10 := v10 * DC10(v10).cf22;
			var v29: set<seq<int>> := {[i0], p0, [v11[safeIndex(656, v11.Length)], p2], p0};
			var v30 := DC39(v29);
			var v31: map<D16, string> := map[v30 := v9];
			var v32 := DC0(p3);
			v31, v11[safeIndex(656, v11.Length)] := fm69(p1, p2, |(seq(abs(0x399), i3  => (v2)))|, !v32.cf0, globalState), -p2;
			var v33: T2 := new C8(p3, v2, 0x2b1, p1, v20, seq(abs(418), i4  => (v20)), p2, p3, true, p3);
			var v34: seq<T2> := [v33];
			...
			r0, r0, v37, globalState.f26, globalState.f12 := |v38|, i0, v37, v36.fm6(globalState), (v11[safeIndex(656, v11.Length)] <= i0) ==> v20[safeIndex(|{v33.f29}|, |v20|)];
		}
	...
	var v45: C10 := new C10(v2, p2, p3, v42, v44, p2, v42[safeIndex(p2, |v42|)], p1, p3);
	var v46: T3 := new C4(p2, false, [!p3, p3], v44, p2, p1, p1, p3);
	var v47: map<C10, T3> := map[v45 := v46];
	var v48: seq<map<C10, T3>> := [v47, v47, v47, v47, v47];
	var v49: multiset<map<C10, T3>> := multiset{v48[safeIndex(|p0|, |v48|)], v47};
	var v50: array<bool> := new bool[23] [p1, if (p1) then true else p3, p3 <== p1, fm39(!p1, multiset{p2, p2, p2, -p2, |(seq(abs(0x23e), i5  => (v2)))|}, p1, globalState) in v1, p1, p3, p3, p3, p3, p3 && p1, p3 <==> p3, p3, p3, true, p1, v2 in v41, p1, if (-|v42| in v1) then v1[-|v42|] else p1, p2 < p2, !(v43 !! v43), p3, p1, v49 == v49];
	v50[safeIndex(311, v50.Length)] := v46.f29;
	var v51 := "ujnosv";
	var v52: multiset<string> := multiset{v51};
	var v53: seq<seq<string>> := [seq(abs(0x206), i6  => (v51))];
	...
	v50[safeIndex(311, v50.Length)], v52 := v46.fm6(globalState), (v52 * v52) + multiset(v53[safeIndex(if (--(if (v2 in v58) then v58[v2] else v46.f30) in v54) then v54[--(if (v2 in v58) then v58[v2] else v46.f30)] else |v51|, |v53|)]);
	r0 := v46.f30;
	...
	for i7 := v55.f30 to v46.f30 {
		...
		var v60 := DC1(v5);
		var v61 := new C10(fm14(0x182, v55.f32[safeIndex(v46.f34, |v55.f32|)], v55.f30, v60, globalState), -0x153, p1, v46.f32 + v42, v46.f33 + v44, v46.f30, v50[safeIndex(311, v50.Length)], v46.f31, if (true) then v45.fm7(v54, --0x9e, globalState) else v55.f29);
		var v62: T1 := new C2(v46.f34, v55.f30, v55.f29, v55.f29, false);
		var v63: seq<T1> := [v62, v62];
		var v64 := DC61([v62] + v63);
		v64 := v64;
	}
	r0 := -safeModuloInt(p2, |(if (v50[safeIndex(311, v50.Length)]) then v51 else v51)|);
}
method Main() {
	...
	var globalState := new GlobalState(0x144, false, true, false, 0x35e, v5[v2 := v4], 38, v6, v7[safeIndex(v1, |v7|)], true, 0xa7, -0x3c1, true, 0x1c9, true, v8, 0x2e9, 'd', v9, true, true, v9, v0, true, 'y', v2, false, 0x1aa);
	v1 := 0x239;
	if (v4) {
		...
		v1 := safeModuloInt(if ((if (v4 in v11) then v11[v4] else v1) in v10) then v10[if (v4 in v11) then v11[v4] else v1] else v1, if (v1 in v13) then v13[v1] else v1);
		var v14 := m0(v2, v4, v1, v4 !in (map[v4 := v0])[true := v0], globalState);
		globalState.f1 := v2 == (seq(abs(0x3ac), i1  => (-v14)));
		...
		var v20: array<seq<bool>> := new seq<bool>[11] [v12, v12, v12 + fm0(v14, v4, v4, |v17|, globalState), [v4], if (v4) then v12 else v12, v12[safeIndex(-|v19|, |v12|) := v4], [v4, v4] + v12, v12, fm0(v1, v4, !v4, |v17|, globalState), v12, v12 + v12];
		v20[safeIndex(78, v20.Length)] := v12;
		v20[safeIndex(78, v20.Length)] := v12;
	} else {
		v9[safeIndex(648, v9.Length)] := v4;
		var v21: multiset<bool> := multiset{!v4};
		var v22: map<bool, bool> := map[v4 := v4 !in v21];
		v9[safeIndex(648, v9.Length)], globalState.f26 := if ((v4 ==> v4) in v22) then v22[v4 ==> v4] else v4, !fm1(if (v4) then false else v4, v1, globalState);
		var v23: multiset<int> := multiset{v1};
		var v24: array<bool> := new bool[28](i2 => false);
		var v25: set<array<bool>> := {v24};
		var v26: map<bool, array<bool>> := map[!v9[safeIndex(648, v9.Length)] := v24];
		...
		var v28: seq<bool> := [v9[safeIndex(648, v9.Length)]];
		var v29 := m0(v2, v28[safeIndex(780, |v28|)], v1, !v4, globalState);
		v28 := v28;
		var v30: set<int> := {|v28|};
	...
	var v39: map<int, int> := map[v2[safeIndex(v1, |v2|)] := v36.f41 - v1];
	var v40 := 'm';
	var v41: set<char> := {v40};
	v39 := v39[safeModuloInt(-v1, v1) := |(v41 + v41)|];
	...
	for i4 := v1 to v36.f41 {
		if (v4) {
			...
			v50 := new set<bool>[28] [v51, v51, v51, v51 - {v4, v4}, v51 + v51, v51 - fm11(v53, !v4, v4, v36.f41, globalState), v51, {false}, v51, v51, v51 - v51, {v4, v4, v4}, v51 - v51, {v4, v4, v4}, v51, v51, v51, DC33(v51).cf64, fm45(v54.cf70, v55, if (v36.fm19(globalState) in v56) then v56[v36.fm19(globalState)] else true, i4, globalState), v51, v51, v51 * v51, v51, {v52[safeIndex(v36.f41, |v52|)], v4}, v51 * v51, v51, v51, fm45(|v6|, v55, v36.fm19(globalState), 0x1ec, globalState) + v51];
			var v57 := DC2(v9);
			v57 := DC2(v9).(cf2 := v9);
		...
		v63[safeIndex(405, v63.Length)] := v64 + v64;
		var v65: seq<bool> := [v4, v4];
		v63[safeIndex(405, v63.Length)] := (if (v65[safeIndex(|(seq(abs(0x124), i7  => (map[v4 := v4])))|, |v65|)]) then multiset{v4, v4} else multiset((v65[safeIndex(|v6|, |v65|) := v4])[safeIndex(v36.f41, |v65[safeIndex(|v6|, |v65|) := v4]|) := v4])) * v64;
		globalState.f13 := -|v6|;
	}
	var v66: seq<bool> := [v4];
	v0[safeIndex(179, v0.Length)] := |v66| * v36.f41;
	...
	v0[safeIndex(179, v0.Length)] := safeDivisionInt(safeDivisionInt(v36.f41, |v70|), v1);
		...
		decreases 100 - i8
	{
		...
		globalState.f1 := fm1(v66[safeIndex(-0x13b, |v66|)], v0[safeIndex(179, v0.Length)], globalState);
		v73 := v0[safeIndex(179, v0.Length)];
		...
		match (v78) {
			case DC48(cf82, cf83, cf84) =>
				...
				globalState.f21 := v79[safeIndex(cf82, |v79|)];
				v7 := ((v7[safeIndex(0x1fb, |v7|) := v36.fm3(v4, false, globalState)])[safeIndex(safeDivisionInt(fm39(v4, v36.f42, v4, globalState), -0x3cf), |v7[safeIndex(0x1fb, |v7|) := v36.fm3(v4, false, globalState)]|) := v74])[safeIndex(v0[safeIndex(179, v0.Length)], |(v7[safeIndex(0x1fb, |v7|) := v36.fm3(v4, false, globalState)])[safeIndex(safeDivisionInt(fm39(v4, v36.f42, v4, globalState), -0x3cf), |v7[safeIndex(0x1fb, |v7|) := v36.fm3(v4, false, globalState)]|) := v74]|) := "ydtxhh"];
				cf84 := cf84;
				v39 := v39[v36.f41 + v36.f41 := v36.f41];
			case DC49(cf85, cf86) =>
				v9[safeIndex(259, v9.Length)] := v36.fm19(globalState);
				var v81: map<char, char> := map[cf86 := v71];
				var v82: C2 := new C2(if (fm46(-|(map v80 : char | v80 in v81 :: (v80) := (v4))|, v36.f41, cf85, globalState) in v36.f42) then v36.f42[fm46(-|(map v80 : char | v80 in v81 :: (v80) := (v4))|, v36.f41, cf85, globalState)] else if (v36.f41 in v36.f42) then v36.f42[v36.f41] else v36.f41, |v74|, v4, !v66[safeIndex(0x189, |v66|)], v4);
				...
				v84[safeIndex(383, v84.Length)] := v82;
				var v85 := DC49(v4, v40);
				...
				v87[safeIndex(880, v87.Length)] := 'm';
				v9[safeIndex(259, v9.Length)], v84[safeIndex(383, v84.Length)], v73, globalState.f1, v87[safeIndex(880, v87.Length)] := v82.fm30(cf85, globalState), v82, safeModuloInt(v0[safeIndex(179, v0.Length)], 0x38c), !v4, cf86;
				globalState.f26 := v9[safeIndex(259, v9.Length)];
				v36 := v36;
				cf86 := v87[safeIndex(880, v87.Length)];
			case DC47(cf81) =>
				...
				var v93: C9 := new C9(v89, v91, v40, v89, !v4, v66[safeIndex(74, |v66|) := v36.fm19(globalState)], ([v66, v66])[safeIndex(v36.f41, |[v66, v66]|) := v66], v0[safeIndex(179, v0.Length)], v4, v92 > v92, v4);
				v93 := v93;
				globalState.f1 := !!((seq(abs(0x353), i9  => (v40)))[safeIndex(v36.f41, |(seq(abs(0x353), i9  => (v40)))|) := v71] < (v74 + v74));
				v0[safeIndex(179, v0.Length)] := (|(seq(abs(0x109), i10  => (|[DC53(DC53(DC52(v71))), DC53(DC51(map[v36.f41 := {v36.f41, v89}]))]|)))| - |v6|) * v36.f41;
			case DC50(cf87) =>
				var v94: array<array<bool>> := new array<bool>[23];
				v94[safeIndex(486, v94.Length)] := v9;
				v94[safeIndex(486, v94.Length)] := v9;
				var v95: set<C7> := {v36, v36, v36};
				var v96: set<set<C7>> := {v95};
				var v97: seq<set<set<C7>>> := [v96];
				var v98 := DC57({v95, v95});
				var v99: array<set<set<C7>>> := new set<set<C7>>[15] [v96, {v95, v95}, v96, v96 + {v95}, v96, v96, v96 - v97[safeIndex(|v74|, |v97|)], v96, v96, v96, {v95, v95}, v96, v96, v98.cf96, v96];
				v99[safeIndex(53, v99.Length)] := v96;
				v99[safeIndex(53, v99.Length)] := v96;
				var v100 := DC9(v4, v4, v94[safeIndex(486, v94.Length)], v4);
				...
				v1 := v103.cf13 - (|v74| * v1);
				var v104, v105, v106, v107 := v36.m7(v4 in v66, v94[safeIndex(486, v94.Length)], fm1(true, |fm33(v4, globalState)|, globalState), globalState);
		}
		
	}
	var v108: seq<seq<bool>> := [v66];
	var v109 := new C4(v0[safeIndex(179, v0.Length)], v4, v66, v108, v36.f41 + |v70|, true, v4, v4);
	v7 := v7[safeIndex(v1, |v7|) := seq(abs(0x388), i11  => (v40))] + ["ssisbjr"];
	var v110: multiset<bool> := multiset{!true};
	if (v110 > v110) {
		var v111: array<T0> := new T0[2];
		var v112: T0 := new C1(false, v4, v4);
		v111[safeIndex(55, v111.Length)] := v112;
		var v114: array<set<int>> := new set<int>[20](i12 => {646, -v1} + (set v113 : int | (0x2ce <= v113) && (v113 < 0x251) :: (v113 + v36.f41)));
		v111[safeIndex(55, v111.Length)], v114, v110 := v112, v114, v110;
		...
		match (if (v4) then v122 else v122) {
			case DC29(cf56, cf57) =>
				...
				v0[safeIndex(179, v0.Length)] := -|[v120.f30]|;
				var v127 := new C7(v2[safeIndex(v125, |v2|)], v36.f42 + v36.f42, -0x1a5 - |v6|, v120.f35, cf57, v120.f31);
			...
			case DC30(cf58, cf59) =>
				...
				var v131: T2 := new C5(v120.f31, |(seq(abs(0x217), i13  => (v40)))|, -v36.f41, v120.f35, v120.f32, [v120.f32, v120.f32, v120.f32, [v120.f29, v120.f29, false, v4, v120.f31], v120.f32], |v130|, true, v112.f29, v120.f35);
			...
			case DC31(cf60, cf61, cf62) =>
				...
				var v137: C3 := new C3(-0x3bc, v136, v40, -0x155, v120.f31, v66, seq(abs(860), i14  => (v66)), 0x307, v120.f28, cf60, cf60);
				v135[safeIndex(105, v135.Length)] := v137;
				var v138: array<string> := new string[1] [v118];
				v138[safeIndex(31, v138.Length)] := v118;
				globalState.f13, v134, v135[safeIndex(105, v135.Length)], v138[safeIndex(31, v138.Length)], v1 := v2[safeIndex(v120.f34, |v2|)], DC26(v133), v137, v118, v120.f34;
			...
			case DC28(cf55) =>
				v9[safeIndex(549, v9.Length)] := v117 >= |v110|;
				v9[safeIndex(549, v9.Length)] := v120.f32 != v120.f32;
				...
				var v150 := DC13(v149[safeIndex(v120.f34, |v149|)] > v36.f42, v119, 'e');
				var v151: map<int, C0> := map[safeModuloInt(v120.f30, v120.f30) := v147];
				v147, v148, globalState.f26, globalState.f13, v150 := if ((if (v120.f31) then v36.f41 else v120.f30) in v151) then v151[if (v120.f31) then v36.f41 else v120.f30] else v147, v148[v117 := v112.f28 && v120.f29], !((v70 - fm45(v36.f41, v110, v112.f29, v1, globalState)) > {v120.f35, cf55.f43, v120.f29, v112.f28}), if (v36.fm20(v120.f30, v9[safeIndex(549, v9.Length)], globalState) == v36.f41) then v36.f41 - |v118| else v1, v150;
				var v152: array<bool> := new bool[11];
				var v153: map<array<bool>, bool> := map[v152 := v9[safeIndex(549, v9.Length)]];
				v9[safeIndex(549, v9.Length)] := -safeModuloInt(v36.f41, v1) >= safeModuloInt(0x1b1, |v153|);
				v8[safeIndex(251, v8.Length)] := v0;
				var v154: seq<array<int>> := [v0, v0, v0];
				v8[safeIndex(251, v8.Length)] := v154[safeIndex(v36.f41, |v154|)];
			case DC32(cf63) =>
				v110 := multiset{v70 >= {v112.f29}, true};
				globalState.f13 := 0x1e1;
				var v155 := m0(seq(abs(0x22b), i15  => (v120.f34)), !v112.f28, |multiset{v112.f29, v120.f35}|, v120.f29, globalState);
				var v156: set<int> := {v120.f30, v117, v120.f30, v1, |map[v112.f28 := v109]|};
				var v157: T2 := new C6(v115, |(v6 + v118)|, v156 >= {v36.f41, 0x139}, v66, v120.f33, v117, v120.f35, v120.f32[safeIndex(v117, |v120.f32|)], v112.f28);
				v0[safeIndex(179, v0.Length)], globalState.f12, v157, v157.f31 := v155, false, v157, v157.f29;
		}
		...
		if (false) {
			...
			v163 := DC39({seq(abs(0x195), i16  => (v120.f34))});
			v120.f31 := v120.fm6(globalState);
			var v164: array<seq<bool>> := new seq<bool>[3];
			var v165 := new C3(|v2|, v164, 'd', -v36.f41, v120.f28, v120.f32, seq(abs(18), i17  => ([v120.f28, v120.f31])), |v120.f32| + v0[safeIndex(179, v0.Length)], v112.f28, !v120.f29, v1 != v0[safeIndex(179, v0.Length)]);
		} else {
			var v166: C10 := new C10(if (v36.fm19(globalState)) then v40 else v118[safeIndex(v120.f34, |v118|)], v120.f30, v112.f28, v120.f32, v120.f33, v120.f34, v112.f29, v112.f29, v36.f42 == fm25(globalState));
			...
			v172[safeIndex(985, v172.Length)] := v120.fm3(v120.f35, !v120.f31, globalState);
			...
			v170, v120.f29, v171, v118, v172[safeIndex(985, v172.Length)] := fm67(globalState), !(if (v120.f31) then if ((map v174 : int | (0x30f <= v174) && (v174 < 0x109) :: (safeDivisionInt(v174, v168.f34)) := (v168.f30)) in v173) then v173[map v174 : int | (0x30f <= v174) && (v174 < 0x109) :: (safeDivisionInt(v174, v168.f34)) := (v168.f30)] else v112.f29 else if (v168.f30 in v178) then v178[v168.f30] else v112.f29), v171, v118, (if (!v112.f28) then v118 else v118) + (if (v168.f29) then "lqm" else "xb");
			v9[safeIndex(122, v9.Length)] := false;
			v9[safeIndex(122, v9.Length)] := v120.f32[safeIndex(v36.f41, |v120.f32|)];
		}
		...
		var v187: T3 := new C5(!true, v1, v185, v4, v66, v108, v0[safeIndex(179, v0.Length)], v4, v4, v4);
		v186[safeIndex(899, v186.Length)] := v187;
		v186[safeIndex(899, v186.Length)] := v187;
		...
		var v195 := DC3(v187.f28, -v185, v194, v2[safeIndex(v36.f41, |v2|)]);
	...
	if (multiset{v197} == multiset{v197, v197, v197}) {
		...
		var v203 := DC61(v199);
		var v204: array<seq<T1>> := new seq<T1>[27] [if (v4) then v199 else v199, v199, v199, v199 + v199, v199 + v199, v199 + v199, v199 + [v198], v199, v199 + v199, v199[safeIndex(0x1d9, |v199|) := v198] + v199, v199, v199, [v198], v199[safeIndex(v0[safeIndex(179, v0.Length)], |v199|) := v198], v199 + v199, v199, v199, v199, v199 + (if (v109 in v200) then v200[v109] else v199), [v198, v198, v198, v198, v198], v199 + (v199[safeIndex(|v201|, |v199|) := v198])[safeIndex(v36.f41, |v199[safeIndex(|v201|, |v199|) := v198]|) := v198], v202[safeIndex(if (0x240 in v36.f42) then v36.f42[0x240] else -0x97, |v202|)], v203.cf99, [v198], v199, v199 + v199, v199 + v199];
		v204[safeIndex(187, v204.Length)] := v199 + [v198];
		v204[safeIndex(187, v204.Length)] := (if (v198.f28) then v199 else v199) + v199;
		...
		match (v212) {
			case DC48(cf82, cf83, cf84) =>
				...
				v214 := safeModuloInt(v36.f41, 0x32) - |v66|;
				var v216: seq<set<bool>> := [v70];
				v70 := v216[safeIndex(v207, |v216|)];
				v0[safeIndex(179, v0.Length)] := v36.f41;
			case DC49(cf85, cf86) =>
				v198.f31 := v209.f43;
			...
			case DC47(cf81) =>
				...
				var v227: map<bool, int> := map[v223.f28 := |(seq(abs(0x342), i20  => (v40)))|];
				...
				var v231: map<T2, int> := map[v230 := v0[safeIndex(179, v0.Length)]];
				var v232: seq<map<T2, int>> := [map[v230 := |v36.f42|], v231];
				var v233 := new C6(v40, safeModuloInt(0x2d3, |v227|), v201 >= v201, v66, fm51(v198.f31, v40, globalState), v1, v198.f28, v198.f29, v231 in v232);
				v9[safeIndex(365, v9.Length)] := !v223.f31;
				v9[safeIndex(365, v9.Length)] := v230.f31;
			case DC50(cf87) =>
				var v234: array<string> := new string[15](i21 => "vtf");
				v234 := v234;
				globalState.f13 := v207 + (if (v198.f31) then -v0[safeIndex(179, v0.Length)] else v207);
				v207 := -safeDivisionInt(-v198.f30, v36.f41);
		...
		v236[safeIndex(147, v236.Length)] := v238;
		var v239: T4 := new C8(false, v205, 0x2b6, !v209.f43, v66[safeIndex(v1, |v66|) := v209.f43], [v66], v36.f41, v209.f43, v198.f31, false);
		...
		v236[safeIndex(147, v236.Length)], v241, globalState.f1, v0[safeIndex(179, v0.Length)], globalState.f12 := v238, v241, v239.f34 > (if (v4) then |v201| else 0x31d), v36.f41 + v0[safeIndex(179, v0.Length)], if (v242 in v243) then v243[v242] else v239.f29;
	} else {
		v0, globalState.f1 := v0, v36.fm19(globalState);
		var v244: set<int> := {|map[{false} := v36.f41]|, |v6|};
		globalState.f1 := !(|v244| < v36.f41);
		v0[safeIndex(179, v0.Length)] := v36.f41 + v36.f41;
		v9[safeIndex(159, v9.Length)] := v4;
		v9[safeIndex(159, v9.Length)] := !(if (v4) then v4 <== v4 else v4);
		if (v9[safeIndex(159, v9.Length)]) {
			globalState.f1 := v9[safeIndex(159, v9.Length)];
			v0[safeIndex(179, v0.Length)] := 0x1f5;
			var v245 := new C1(v9[safeIndex(159, v9.Length)], v9[safeIndex(159, v9.Length)], v4);
			v1 := v36.f41;
			var v246 := DC20(DC19(v9[safeIndex(159, v9.Length)], v36.f41, -0xf9));
			var v247: map<D7, seq<bool>> := map[v246 := v66];
			var v248 := DC19(v9[safeIndex(159, v9.Length)], v36.f41, v36.f41);
			v247 := v247[DC20(v248) := [v4]];
		} else {
			var v249: array<bool> := new bool[16](i23 => v9[safeIndex(159, v9.Length)]);
			var v250, v251, v252, v253 := v36.m7(v4, v249, v36.fm19(globalState), globalState);
			v0[safeIndex(179, v0.Length)], v6, v253, v252 := v36.f41, v6 + v253, v6, safeDivisionInt(v36.f41, fm32(v9[safeIndex(159, v9.Length)], globalState));
			var v254 := new C5(v9[safeIndex(159, v9.Length)], safeModuloInt(fm24(false, v36.f41, globalState), v252), v1, v9[safeIndex(159, v9.Length)], v66, v108 + v108, -|map[true := v9[safeIndex(159, v9.Length)]]|, !!(v4 || v4), v1 == v36.f41, false <== v9[safeIndex(159, v9.Length)]);
			var v255: array<char> := new char[27];
			v255[safeIndex(700, v255.Length)] := if (v4) then v40 else v40;
			var v256: map<C4, int> := map[v109 := v36.f41];
			v255[safeIndex(700, v255.Length)] := if (0x63 > v254.f48) then v250 else fm48(v9[safeIndex(159, v9.Length)], true, |v256|, globalState);
	...
	v0[safeIndex(179, v0.Length)] := safeModuloInt(|v257|, v36.f41) + 0x149;
	print v0[9], "\n";
	print v1, "\n";
	print v2 == [20], "\n";
	print |v3|, "\n";
	print v4, "\n";
	print v5 == map[[20] := true], "\n";
	print v6, "\n";
	print v7 == [['m', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm'], "ssisbjr"], "\n";
	print v9[0], "\n";
	...
	print globalState.f5 == map[[20] := true], "\n";
	...
	print globalState.f25 == [20], "\n";
	print globalState.f26, "\n";
	print globalState.f27, "\n";
	print v36.f41, "\n";
	print v36.f42 == multiset{20}, "\n";
	print |v37|, "\n";
	print |v38|, "\n";
	print v39 == map[20 := 0, 0 := 1], "\n";
	print v40, "\n";
	print v41 == {'m'}, "\n";
	print v66 == [true], "\n";
	print v67.cf46, "\n";
	...
	print v67.cf49, "\n";
	print v67.cf50 == [20], "\n";
	print v68 == multiset{'m'}, "\n";
	print v69.cf15 == multiset{'m'}, "\n";
	print v69.cf16, "\n";
	print v69.cf17, "\n";
	print v70 == {false, true}, "\n";
	print i8, "\n";
	print v108 == [[true]], "\n";
	print v110 == multiset{false}, "\n";
	print v197 == [DC8(multiset{'m'}, true, 417)], "\n";
	print |v257|, "\n";
}