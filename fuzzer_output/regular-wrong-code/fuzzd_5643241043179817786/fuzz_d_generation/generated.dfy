...
function fm0(p0: int, p1: bool, p2: seq<int>, p3: char, globalState: GlobalState): int {
	|multiset{DC13(|[0x2f]|, -0x10b, true).cf20, false, false, !true, false}| / (|(seq(0x27, i0  => ("hrdfpvvp")))| - |[true, DC0(true).cf0]|)
}
...
function fm7(globalState: GlobalState): seq<int> {
	[|[true]|, |DC32(multiset(seq(0x2be, i0  => ("re")))).cf55|, |[0x205, 0x2c]|] + ([|[false]|] + [0x341, -|map[!true := !false]|])
}
...
function fm16(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<int, int> {
	map[-0x15e := |{'q', 'l'}|] + ((map v0 : int | v0 in {0x104} :: (v0 % |"uvbomwi"|) := (|(seq(0x312, i0  => ('y')))|)) + (map v1 : int | (0x3ca <= v1) && (v1 < -978) :: (v1 * 0x89) := (0x1e4)))
}
...
method m0(p0: int, p1: multiset<bool>, p2: seq<bool>, globalState: GlobalState) returns (r0: string) {
	for i0 := p0 to p0 {
		var v0: array<seq<seq<int>>> := new seq<seq<int>>[25](i1 => if (false) then seq(899, i2  => ([p0, |{p0, |"wq"|}|, |multiset{p0}|])) else [[i0, i0], seq(0x1d2, i3  => (0x8f)), [p0]]);
		var v1: set<int> := {-p0};
		...
		var v9 := DC7(|v7|, v8);
		v0[570], v4, globalState.f3, globalState.f6, v5[698] := (seq(0x271, i4  => (v2))) + [seq(-0x392, i5  => (p0))], v4, v9.cf7, v8.f9, v1;
		var v10: array<C0> := new C0[21];
		v10[694] := v8;
		v10[694] := v8;
		v4 := v4;
		if (v4) {
			var v11: array<int> := new int[3](i6 => i6 % |p1|);
			var v12 := "kn";
			var v13: set<C0> := {v8};
			var v14: multiset<set<C0>> := multiset{v13};
			v11[243] := |v12| / (if ({v10[694], v8} in v14) then v14[{v10[694], v8}] else v2[|v12|]);
			v11[243] := 0x227;
			var v15: map<int, int> := map[v8.f9 := v8.f9];
			globalState.f6 := 42 * (v8.f9 / |v15|);
			var v16: seq<bool> := [v4, v4, !!v4 !in p1];
			var v17 := DC14(v10[694], v4);
			var v18: map<C0, char> := map[v10[694] := v6];
			var v19: map<D4, char> := map[v17 := if (v10[694] in v18) then v18[v10[694]] else v6];
			var v20: multiset<int> := multiset{|v19|};
			var v21: T0 := new C0(i0, |v16|, v4);
			var v22: seq<T0> := [v21, v21, v21];
			v16, v6, globalState.f6, v11[243] := v16, v6, -|v20|, (-|v22| * v11[243]) + v8.f8;
			var v23 := DC17(v21.f7, false, v4);
			var v24: seq<D6> := [v23, v23, v23];
			v4 := (v24 + [v23]) < ((seq(576, i7  => (v23))) + (v24[|"ljh"| := v23])[v8.f8 := DC17(v21.f7, v21.f7, v21.f7)]);
			var v25: seq<seq<bool>> := [v16];
			var v26: multiset<seq<bool>> := multiset{v16, v16, p2, p2};
			var v27: seq<multiset<seq<bool>>> := [multiset(v25), v26];
			var v28 := DC1(v27[|v12|], 0xe9 % p0);
			v16, v8, v28 := v16, if (fm3(v11[243], globalState)) then v8 else v10[694], v28;
		} else {
			v1 := v5[698];
			var v29 := "dled";
			var v30: seq<string> := [v29, "vsxctdar", v29, "gmyfssb"];
			v30 := v30;
			var v31 := new C0(v8.f8, v8.f9, p0 > |(seq(0x281, i8  => (v6)))|);
			var v32 := new C0(|(seq(38, i9  => (v6)))[v8.f8 := v6]|, 0x193, v4);
			var v33: map<int, bool> := map[p0 := false];
			var v34: map<bool, int> := map[if (-i0 in v33) then v33[-i0] else v4 := v2[-p0]];
			var v35 := DC10(v6, v4);
			v34 := v34[v35.cf12 := v8.f9 % -0x187];
		}
	...
	for i10 := if (!v36) then |v37| else |v37| to p0 {
		...
		var v39: seq<int> := [p0];
		var v40 := 'x';
		v38[102] := multiset([multiset{fm0(0x154, v36, v39, v40, globalState), p0, i10}]);
		...
		v36, v38[102], v41, v41[756], v42[780] := !false ==> (v45 !! v45), v51, v41, fm7(globalState) != v39, multiset(p2);
		var v52: T0 := new C0(v46.f9, p0, !v41[756]);
		var v53: seq<T0> := [v52];
		var v54: array<int> := new int[4] [p0, v46.f8 / |map["xpqepkn" := v53[921]]|, v46.f9, i10 % v46.f9];
		v54[916] := p0;
		v54[916] := v46.f8;
		var v55: seq<C0> := [v46];
	...
	if (p0 != 784) {
		...
		if (|v37| >= 106) {
			...
			var v65: seq<C0> := [v64];
			var v66: array<int> := new int[16] [fm0(p0, v36, [|p2|], v61, globalState), 0x1e3, |v65|, p0, v64.f9, v64.f8, v64.f9, v64.f8, -166, v64.f9, v64.f9, v64.f8, v64.f9, v64.f8, -v60[p0], -v64.f8];
			...
			v68 := map[if (v36 in v69) then v69[v36] else v66 := v67] + v70[v64.f8];
			...
			var v88: multiset<set<int>> := multiset{v86 * (set v87 : int | v87 in v86 :: (v87 / 948))};
			...
			v36, r0, globalState.f6 := v36, "uownf", if ((v86 + (set v89 : int | (0x71 <= v89) && (v89 < 0x39e) :: (v89 - p0))) in v88) then v88[v86 + (set v89 : int | (0x71 <= v89) && (v89 < 0x39e) :: (v89 - p0))] else |v93[|v95|]|;
		...
		var v100 := new C0(|[v99, v99]| / (if (v99.f7 in p1) then p1[v99.f7] else p0), p0, v99.f7);
		...
		if (v101 !in v102) {
			...
			v105 := v106.cf32;
			var v107 := new C0(p0 / |map[p0 := v101]|, v105.f9 / v105.f8, fm3(v105.f8, globalState));
			v105 := v105;
		} else {
			v101.f7 := p2[p0];
			...
			v108[243] := p1 != (if (!v101.f7) then if (p0 in v109) then v109[p0] else p1 else p1);
			var v110: map<bool, bool> := map[true := v108[243]];
			var v111: seq<int> := [|v110|];
			var v112: seq<int> := [|v111|];
			var v113 := DC22({v111});
			var v114: set<seq<int>> := {v112, v111};
			v113 := DC22(v114);
			var v115: C0 := new C0(v101.fm4(globalState), |map[false := p2]|, v108[243]);
	...
	for i15 := p0 to |(multiset{DC1(v123, p0)} + v125)| {
		...
		match (DC3(v126 + v126)) {
			case DC4() =>
				...
				var v128: C0 := new C0(i15, v126[i15], v36);
				var v129: map<C0, C0> := map[v128 := v128];
				var v130: map<bool, map<C0, C0>> := map[v36 := v129];
				var v131 := 'q';
				var v132: multiset<int> := multiset{480, fm0(|(if (v36 in v130) then v130[v36] else v129)|, v36, seq(0x39f, i16  => (v128.f9)), v131, globalState), -|v126|, |(seq(0x1da, i17  => (v131)))|};
				var v133: C0 := new C0(p0, |v132|, v36);
				v127[808] := v128;
				v127[808] := v133;
				globalState.f6 := v128.f9 * (-448 / i15);
				globalState.f3 := v133.f9;
			case DC3(cf4) =>
				var v134 := DC31(v37);
				var v135: multiset<seq<int>> := multiset{cf4, cf4};
				var v136 := 't';
				var v137: array<string> := new string[29] [v37, v37, v37, seq(-0xf6, i18  => ('r')), "iqglrvh", v37, if (v36) then v37 else v37, v134.cf54, v37, v37, v37 + v37, v37 + v37, "ugemjeiny", v37, v37, v37, v37, v37, v37, fm10(p0, v36, i15, v135, globalState) + v37, v37, "foi" + v37, ("ptuxtb")[p0 := v136], v37, v37, v37, v37, v37, v37];
				v137[936] := v37;
				v137[936] := "jquu";
				v121[933] := p0;
				v121[933] := i15;
				var v138: map<seq<bool>, int> := map[p2 := v121[933]];
			...
			case DC5(cf5) =>
				...
				v142 := (fm12(i15, i15, v143, globalState))[v36 := i15] + p1;
		}
...
method Main() {
	...
	for i0 := |([v1])[|(map v8 : char | v8 in v0 :: (v8) := (v1))| := v1]| + 0x53 to v1 {
		...
		if (v9 < v9) {
			...
			globalState.f3, globalState.f3 := fm0((fm1(globalState)).cf2, true, v9, v2, globalState), v1 / |v14|;
		...
		var v26: seq<bool> := [v4];
		var v27 := DC0(false);
		var v28: array<bool> := new bool[10] [v4, v26[0x1d0], v4, v4, v4, v4, true, v4, v4, v27.cf0];
		v28[685] := v4;
		v28[685] := v4;
		var v29: set<char> := {v2};
		var v30: multiset<set<char>> := multiset{v29 * v29, v29};
		var v31: seq<set<char>> := [v29];
		v30 := (multiset(v31) + v30)[v29 := i0];
		var v32: map<bool, int> := map[false := i0];
		var v33: seq<array<bool>> := [v28, v28];
		var v34: seq<multiset<int>> := [multiset{-v1}, v6];
		var v35 := DC3(v9);
		var v36: array<int> := new int[21] [|(seq(-0x14c, i2  => (-|multiset{false}|)))[|v0| := |v32|]|, 0x2e6, |v32|, v1, i0, v1, i0, 0x3c7, i0, 0x238, |v33|, v1, 0x365, v1 % i0, v1, i0 - v1, v1, fm0(|v34|, v28[685], v9, v2, globalState) / fm0(|v0|, v28[685], v35.cf4, v2, globalState), -i0, 0x3cf, -i0 + i0];
		v36[938] := v1;
		v36[938], v1, globalState.f6 := i0, i0, i0;
	}
	var v37: set<char> := {v2};
	var v38: set<set<char>> := {v37, v37, v37, {v2, v2}, v37};
	var v39: seq<set<set<char>>> := [v38];
	var v40: map<int, int> := map[v1 := v1];
	for i3 := |v39[v1]| to v1 - |v40| {
		if (v4) {
			var v41: array<seq<bool>> := new seq<bool>[1];
			var v42: array<int> := new int[18](i4 => i4 % v1);
			var v43: map<array<seq<bool>>, array<int>> := map[v41 := v42];
			v43 := v43[v41 := v42];
			var v44 := new C0(v1, i3 % 163, v4);
			v42[326] := v44.f8 / i3;
			v42[326] := -v1;
			var v45: set<bool> := {v4};
			...
			var v58: map<int, bool> := map[fm0(|v55|, v56[-|v0|], v57, v2, globalState) := v4];
			var v59 := new C0(0x3c9 - i3, v1 / |v55|, if (v1 in v58) then v58[v1] else v4);
			var v60: array<D1> := new D1[12];
			var v61 := DC3([0x92]);
			v60[998] := v61;
			v60[998] := v61;
			var v62: multiset<bool> := multiset{v4};
			var v63 := m0(if (v4) then v59.f9 else |v56|, multiset(v56) * v62, v56[i3 := v4], globalState);
		}
		
		globalState.f6 := (-i3 / |v0|) / v1;
		var v64: seq<int> := [v1];
		var v65: array<bool> := new bool[11] [true, v4, v4, false, !v4, v4, !v4, v4, fm3(-i3, globalState), !false, v4];
		var v66: map<int, array<bool>> := map[v64[i3] := v65];
		var v67: set<bool> := {v4};
		v66 := v66[|v67| := v65];
		if (v4) {
			...
			var v71: seq<bool> := [v4];
			var v72 := m0(i3 / fm0(v1, v4, v64, v2, globalState), v68[v4 := -i3] - v70[v69.f9], v71, globalState);
			v4 := fm3(v69.f9, globalState);
		} else {
			v4 := v4;
			var v73: seq<bool> := [v4];
			var v74: seq<bool> := [v4, v73[|v6|]];
			v65[891] := v73[v1];
			v65[891] := v4;
			...
			v65[891] := fm3(if (v4) then i3 else i3, globalState);
			globalState.f3 := v1;
		}
		...
		decreases 100 - i7
	{
		...
		v84[798] := if (v87 in v88) then v88[v87] else v89 >= v89;
		var v90: array<int> := new int[16];
		v90[384] := v87.f9;
		var v91: map<bool, bool> := map[v4 := v84[798]];
		var v92: set<bool> := {v4, v86.cf0, v91 != v91, fm3(v87.f9, globalState), v84[798] in v85};
		v84[798], globalState.f6, v90[384] := v4, v87.f9, |v92|;
		var v93: array<C0> := new C0[11];
		v93 := new C0[27];
		var v94: multiset<bool> := multiset{!false, !!!v4, v4, !true, v84[798]};
	...
	if (v96.cf0) {
		...
		globalState.f6, v97[29], v99[938] := v102.cf2, fm7(globalState) !in v103, v1;
		...
		var v106: map<int, array<map<int, bool>>> := map[v99[938] := v104];
		var v107: multiset<bool> := multiset{false, v97[29]};
		v105[718] := if (|v107| in v106) then v106[|v107|] else v104;
		v4, v105[718] := v100[0x10c], v104;
		var v108 := new C0(v99[938], v1, v4);
		var v109 := DC4();
		var v110: set<D1> := {v109};
		v99[938], v97[29] := (v108.f9 % |v110|) % v108.f9, multiset(v81 + v82) !! v6;
		if (v97[29]) {
			var v111: map<bool, bool> := map[false := v97[29]];
			var v112: map<map<bool, bool>, char> := map[v111 := v2];
			v112 := v112[map[v97[29] := v4] := v2];
			var v113: T0 := new C0(v108.f9, v99[938], v4);
			var v114: map<T0, bool> := map[v113 := v97[29]];
			v97[29] := if (v113 in v114) then v114[v113] else true;
			var v115 := m0(0x38b, multiset{v4, v97[29]}, v100, globalState);
			globalState.f6, v99, v111, globalState.f3, v108 := v108.f8, v99, v111, v108.f9, v108;
			v99[938] := v108.f8;
		} else {
			v97[29], v99[938] := v4, v108.f9;
			var v116: map<bool, bool> := map[v97[29] := v4];
			globalState.f3 := (|v116| % v82[|multiset{v4, v4}|]) * fm0(v99[938], v97[29], [v108.f9, v108.f8, v99[938]], v2, globalState);
			var v117: seq<string> := [v0];
			v97[29], v83, v97[29] := v108.f8 < v108.fm5(fm8(v108.f9, v99[938], 0x164, v99[938], globalState), v2, v1, v4, globalState), if (v117[v108.f9] != v0) then if (v97[29]) then v83 else v83 else fm9(globalState), v4 <== v97[29];
			v116 := v116[v97[29] := v97[29]];
			var v118 := m0(v108.f8, multiset{v97[29]}, v100, globalState);
		}
		...
		var v124 := m0(|v0|, v123, v119[|[v4]| := v4], globalState);
	...
	globalState.f6, v134[5], v135[568], v0 := |(v140 + [v139])|, v132, v138, fm10(|v136|, !(v132.f8 <= v132.f8), v1, v141 - v141, globalState);
	var v142 := DC10(v2, v4);
	match (v142) {
		case DC10(cf11, cf12) =>
			...
			match (v96) {
				...
				case DC0(cf0) =>
					var v149 := m0(v132.f9 % v1, v129, v136, globalState);
					globalState.f6 := v1 % v132.f9;
				...
				case DC2(cf3) =>
					...
					var v153 := m0(v132.f9, fm12(v132.f8, |(seq(546, i9  => (v146[842])))|, fm13(v132.f8, globalState), globalState), v136, globalState);
					globalState.f3 := |v153|;
			}
		...
		case DC11(cf13, cf14, cf15, cf16) =>
			...
			if (!(v158 !! v158)) {
				...
				var v159: map<array<bool>, bool> := map[v154 := v154[526]];
				v134[5] := new C0(v1, |v159|, cf15);
				v0 := (v0 + (seq(-203, i11  => ('b')))) + ("uw" + v0);
				var v160: array<T0> := new T0[14];
				var v161: T0 := new C0(v132.f8, -634, v154[526]);
				v160[585] := v161;
				v160[585] := v161;
				v0 := v0;
			} else {
				...
				v162[240] := v83;
				v162[240] := DC3(v82);
				globalState.f6 := (v132.f8 + v132.f9) - (v132.f9 % cf13);
				var v163: map<int, bool> := map[v132.f9 := v154[526]];
			...
			if ((set v165 : int | v165 in v164 :: (v165 + |[true, true]|)) == (v164 - v164)) {
				var v166 := new C0(v1, v132.f8, v154[526]);
				v1 := (0x26c * v132.f8) + v138.cf2;
				var v167 := DC11(|v157|, 0x282, fm3(v166.fm4(globalState), globalState), v154[526]);
				var v168: seq<D3> := [v167];
				v168 := v168;
				cf15 := !(if (cf16) then v154[526] else cf15) && true;
				var v169: map<bool, int> := map[false := v166.f9];
				v154[526] := if (v136[cf14]) then |v169| == v166.f9 else cf15;
			} else {
				var v170: map<int, string> := map[cf13 := v0[cf14 := v2]];
				...
				v129, globalState.f3 := v129, v1 + |[true, v4, v154[526]]|;
				v154[526] := cf15;
				var v172: array<array<bool>> := new array<bool>[12];
				v172[306] := v154;
				globalState.f3, v172[306], v129 := cf14, v154, v129;
				var v173 := m0(v132.fm5(v157, v2, 0xd5, v154[526], globalState), v129, [v4], globalState);
			}
		...
		case DC9(cf10) =>
			if (!!!(v4 <==> v4)) {
				...
				v174[369] := fm3(v132.f8 * v132.f9, globalState);
			} else {
				var v178: seq<C0> := [v132, v132];
				var v179: T0 := new C0(|v0|, |v178|, v4);
				var v180: seq<T0> := [v179];
				var v181: multiset<T0> := multiset{v179};
				var v182: array<T0> := new T0[23] [v179, v179, v179, v179, v180[|v181[v179 := v132.f8]|], v179, v179, v179, v179, v179, v179, v179, v179, v179, v179, v179, v179, v179, v179, if (true) then v179 else v179, v179, v179, v179];
				var v183 := DC15(v179);
	...
	v4 := v4;
	v4, v4, globalState.f3, globalState.f3 := v136[if (v4) then v132.f8 else v132.f9], true, -(v1 + v1), v132.f9;
	if (v4 ==> true) {
		var v191 := m0(v1, multiset(v136), v136 + [v4, v4, v4], globalState);
		v4 := true;
		v4 := v0 != v191;
		var v192: array<bool> := new bool[18];
		var v193 := DC3(v82[|map[v192 := v1]| := v132.f8]);
		var v194 := DC5(v193);
		match (v194) {
			case DC4() =>
				...
				var v200: map<int, set<bool>> := map[|v136[v132.f8 := v4]| / |v0| := v199];
				v200 := v200[-v82[v1] % -0x318 := v199 - v199];
			case DC3(cf4) =>
				v4 := !v4;
			...
			case DC5(cf5) =>
				v134[5] := if (v132.f9 == v132.f8) then v132 else v132;
		...
		if (v4) {
			...
			globalState.f6 := 0x41;
			var v212: set<int> := {|v0|, |(set v211 : int | v211 in v81 :: (v211 * |map[[false] := 0x3a3]|))| % v132.f8};
			v212 := (v212 * v212) * v212;
			v2 := v2;
		} else {
			v0 := fm10(v132.f8, v4, |(multiset{v4, v4})[fm3(v132.f8, globalState) := v132.f8]|, v141, globalState) + v0;
			v132 := v134[5];
			v139[54] := -v132.f8;
			v139[54] := v1 - v132.f9;
			var v213: map<bool, set<bool>> := map[!v4 := {v4}];
			var v214 := m0(|(if (v4 in v213) then v213[v4] else v207)|, v129, v136, globalState);
			var v215 := new C0(v132.f8, v132.f9 % v132.f8, v139[54] >= v132.f8);
		}
		
		var v216: map<bool, bool> := map[v4 := v4];
		var v217: map<bool, bool> := map[v4 := !!v136[|v216|]];
		var v218 := DC9((v136[v132.f9 := false])[v132.fm5(v216, v2, 0x1d8, v4, globalState) := v4]);
		var v219 := m0(v132.f8 / v1, multiset{v4, v4}, v218.cf10, globalState);
	}
