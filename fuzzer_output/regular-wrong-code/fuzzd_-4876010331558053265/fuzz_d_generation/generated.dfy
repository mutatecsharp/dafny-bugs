...
function fm1(p0: bool, p1: int, globalState: GlobalState): string {
	("csbalwk" + (seq(-0x55, i0  => ('t')))) + (seq(394, i1  => ('a')))
}
...
function fm10(p0: bool, p1: string, globalState: GlobalState): D0 {
	if (!!false) then if (true) then DC2(false, true, -|map[981 := |(seq(0x2f6, i0  => ('a')))|]|) else DC2(!false, DC8(0x1af, -0x133, true).cf19, |multiset([true])|) else DC2(DC2(!true, true, |[0x3af]|).cf3, true, 0x237)
}
...
function fm13(p0: int, p1: string, p2: bool, globalState: GlobalState): D4 {
	if (!(false <==> !!true)) then DC9(map v0 : D3 | v0 in multiset{DC8(0x2fc, 0xa8, !false)} :: (v0) := (['u'])) else if (true) then DC9(map[DC8(-0x298, |[0x5a]|, true) := ['x']]) else DC9(map[DC8(|map[-0x345 := true]|, |map[false := |['i']|]|, true) := seq(82, i0  => ('y'))])
}
...
function fm17(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<map<int, int>> {
	match if (!false) then DC6("mjffy", |multiset{false}|, false, |map[true := [false, false, !false]]|, false) else DC6("l", 139, !true, |"dop"|, false) {
		case DC6(cf11, cf12, cf13, cf14, cf15) => (seq(0x30c, i0  => (map v0 : int | (0x316 <= v0) && (v0 < 0x3ca) :: (v0 / cf14) := (857)))) + (seq(0x2bd, i1  => (map[-290 := cf12])))
		case DC5(cf10) => seq(0x3d4, i2  => (DC14(map v1 : int | (-768 <= v1) && (v1 < 0x18a) :: (v1 * -880) := (586)).cf32))
	}
}
method m0(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState) {
	if (p0) {
		...
		var v6: map<bool, int> := map[p2 := |(multiset{p0, p2})[p0 := p3]|];
		...
		if (p2 && fm2(globalState)) {
			...
			var v15 := DC0([!p2]);
			var v16: array<seq<bool>> := new seq<bool>[16] [[p0], v4, v4, [p2, v7[74]], v4, v4, [false, true, v0], v4, [true], v4, v4, [v0, v7[74]], v4, v4, v4, if (v13 in v14) then v14[v13] else v15.cf0];
			v12[557] := if (!v7[74]) then v16 else v16;
			v12[557] := v16;
			var v17 := "d";
			...
			var v26: array<C0> := new C0[19] [v3, v3, v3, v3, v24[v25.cf6], v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3];
		...
		if (p2) {
			...
			v35, v40[103] := fm3(p1, p1 % p3, |v41| - p1, if (p0) then v44 else v44, globalState), if (p0) then v36.(cf20 := v38) else v36;
		} else {
			var v45 := true;
			...
			var v60: array<array<bool>> := new array<bool>[12] [v56[p3], v55, v55, v55, v55, if (v55 in v57) then v57[v55] else v55, v55, v55, v55, v55, if (true) then v55 else v55, if (v58 in v59) then v59[v58] else v55];
			v60[247] := v55;
			v45, v46[803], v60[247], v45 := v45, v47, v55, p2;
			var v61: array<set<int>> := new set<int>[26](i1 => v52);
			v61[590] := v52;
			var v62 := 'e';
			v61[590] := (fm14(v62, -p1, globalState) * v52) + v52;
	...
	for i2 := -|v72| to -v73[p1] {
		...
		v77[883] := -(p3 - (if (p0) then |v79| else -|v81|));
	}
	globalState.f0 := p1;
...
class C1 {
	...
	function fm5(globalState: GlobalState): map<string, string> {
		(map[seq(209, i0  => ('a')) := "kipi"] + map["vbvdrrtth" := "n"]) + map[DC5("rt").cf10 := "goeperti"]
	}
	method m1(p0: map<set<int>, bool>, p1: string, p2: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: set<int>, r3: int) {
		...
		for i0 := |p1| to v0 + v0 {
			...
			globalState.f0, r1 := v2[v0], fm2(globalState);
		}
		...
		for i1 := v0 - v0 to v0 {
			...
			if (fm2(globalState)) {
				...
				globalState.f4 := v20;
				v6 := v6[i1 := v0];
				v3[729] := fm2(globalState);
				var v21: array<int> := new int[1];
				var v22: seq<array<int>> := [v21, v21];
				var v23: map<D3, int> := map[DC7(v22[0x2cc]) := v0];
			...
			globalState.f0 := v0;
			var v25 := DC8(i1, v0, v3[729]);
			var v26 := new C0(v25);
		}
		globalState.f0 := v0 / (v0 * |p1|);
		r0 := -|p1|;
		r1 := !p2;
		var v27: set<int> := {v0};
		r2 := v27 + v27;
...
method Main() {
	...
	for i1 := |v1| to |v6| {
		...
		if ((v3 / |(multiset(v10))[v3 := i1]|) > v3) {
			...
			m0(v3 < i1, |v15|, v13[49], v3, globalState);
			var v16: multiset<int> := multiset{i1};
			var v17: map<int, int> := map[i1 := (if (v3 in v16) then v16[v3] else i1) % i1];
			var v18 := 'i';
			v17 := v17[|v6| := |(seq(357, i2  => ('s')))[v3 := v18]|];
			globalState.f0 := i1 % i1;
		} else {
			v3 := v3;
	...
	for i3 := v3 to -v3 {
		...
		var v27 := 'g';
		var v28: seq<int> := [|(fm1(v0, v3, globalState))[|v26| := v27]|];
		var v29: map<int, bool> := map[i3 := !v0];
		m0(v0 in v24, v28[v3], if (i3 in v29) then v29[i3] else v0, |v24[i3 := v0]|, globalState);
	...
	match (v31) {
		...
		case DC2(cf2, cf3, cf4) =>
			...
			v40[78] := fm7(true, globalState);
			var v41: map<bool, bool> := map[cf3 := v0];
			v40[78] := v41 + fm7(v0, globalState);
			var v42: array<bool> := new bool[6](i5 => cf3);
			v42[193] := cf3;
			v42[903] := v3 > cf4;
			v42[417] := cf4 < v3;
			v42[193], cf2, v42[903], v42[417] := cf4 <= cf4, cf3, false, cf3;
		case DC0(cf0) =>
	...
	if (match v48 {
		...
		globalState.f0, globalState.f0, v3 := v3 / |v49|, v3, v3;
		...
		v50[338] := if ((if (v0) then v0 else v0) in v52) then v52[if (v0) then v0 else v0] else |v53|;
		if (fm2(globalState)) {
			...
			v55[726] := v56;
			v55[726] := 'g';
			globalState.f0 := (v50[338] % v3) / v50[338];
			globalState.f0 := v3;
			...
			var v65 := DC8(v50[338], |v64|, v0);
			var v66: array<map<D3, bool>> := new map<D3, bool>[2] [v61, map v62 : D3 | v62 in [v65] :: (v62) := (v0)];
			v66[714] := map[v65 := true];
			v66[714] := v61 + map[v65 := fm2(globalState)];
			v0 := true;
			var v67 := DC2(v0, v0, v50[338]);
			...
			v68[408] := v67;
			globalState.f0, globalState.f4, v68[408], v3 := |v1| + v3, 'e', fm10(v0, v6, globalState), -v50[338];
		}
		...
		v0, v69[779] := v3 != v3, !(v3 != (fm0(globalState) / |v70|));
		v0 := v3 <= |(seq(0x1e6, i7  => (map[v3 := |multiset{v0, v69[779]}|])))|;
		var v71: seq<map<seq<char>, array<bool>>> := [map[v6 := v69]];
		globalState.f0 := -v3 / |v71[|(seq(0x240, i8  => ('f')))|]|;
	}
	...
	var v83: multiset<C0> := multiset{v82[v3]};
	...
	v85[938] := |"lthcc"| > (if (v86 in v87) then v87[v86] else if (v0 in v88) then v88[v0] else v3);
		...
		decreases 100 - i9
	{
		...
		i9 := i9 + 1;
		m0(v85[938], v3, v85[938], v3, globalState);
		var v92 := DC0([v85[938], v0]);
		match (v92) {
			case DC1(cf1) =>
				var v93: array<multiset<int>> := new multiset<int>[21];
				v93[335] := v84;
				v3, v85[938], globalState.f9, v93[335], v82 := cf1, v0, 'o', multiset(v77 + v77) * fm12(v86, v85[938], cf1, globalState), v82;
				var v94 := new C1();
			...
			case DC2(cf2, cf3, cf4) =>
				...
				v99[40] := -0x159;
				v97[336], v98[580], v99[40], cf2 := v85, v6, cf4, (v3 % v3) > cf4;
				v99[40], cf3 := fm0(globalState), !DC12(v0, v78, v31.cf1, v85, v0).cf26;
				var v100: array<C0> := new C0[16];
				var v101: map<bool, array<C0>> := map[cf3 := v100];
				v101 := map[v85[938] := v100];
				v3 := cf4;
			case DC0(cf0) =>
				var v102: array<int> := new int[27];
				var v103: map<bool, array<int>> := map[v0 := v102];
				var v104 := DC7(if (v79[v3] in v103) then v103[v79[v3]] else v102);
				v104 := v104;
				var v105: C1 := new C1();
				var v106: seq<C1> := [v105];
				v85[938] := (|cf0| / v3) < |(v106 + [v105, v105])|;
	...
	var v109: map<string, bool> := map[v6 := v85[938]];
