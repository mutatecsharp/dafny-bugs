...
class C1 extends T0 {
	...
	method m7(p0: int, p1: int, globalState: GlobalState) {
		...
		for i0 := fm9(p0, |v0|, v1, globalState) + DC5(v2, p0, |v2|).cf9 to p1 {
			...
			match (v11) {
				case DC4(cf4, cf5, cf6) =>
					...
					v10[safeIndex(913, v10.Length)] := v12 >= {p0, v3, v3};
					v10[safeIndex(913, v10.Length)] := !v1;
					var v13: multiset<int> := multiset{p1};
					var v14 := DC7(v13);
					v1 := |v14.cf12| == (p1 + p1);
					var v15: map<bool, int> := map[false := |v2|];
					v10[safeIndex(913, v10.Length)] := safeModuloInt(cf4, |v15|) == (v3 + p1);
					var v16: map<int, int> := map[p0 := 0x270];
					var v17 := DC1(v10[safeIndex(913, v10.Length)]);
					var v18 := DC2(v17);
					var v19: map<D0, D0> := map[v18.(cf2 := fm11(i0, v1, v10[safeIndex(913, v10.Length)], i0, globalState)) := v18];
					cf6 := new bool[15] [false, v3 > i0, v10[safeIndex(913, v10.Length)], !v1 <==> v10[safeIndex(913, v10.Length)], -192 > p0, v10[safeIndex(913, v10.Length)] <==> cf5, v10[safeIndex(913, v10.Length)], v16 != fm10(globalState), true, v1, fm9(cf4, i0, cf5, globalState) < |v19|, cf5, v10[safeIndex(913, v10.Length)], v10[safeIndex(913, v10.Length)] || v1, if (v1) then cf5 else cf5];
				case DC5(cf7, cf8, cf9) =>
					v5 := v5;
					var v20: map<bool, seq<bool>> := map[v1 := v0];
					v20 := v20[fm0(v1, v5, v1, globalState) := v0];
					cf7 := ("ss")[safeIndex(i0, |"ss"|) := v5];
					v10[safeIndex(384, v10.Length)] := v1;
					var v21: set<int> := {p0};
					var v22 := DC0(v1);
					v10[safeIndex(384, v10.Length)] := if (v21 > v21) then v22.cf0 else v1;
				case DC6(cf10, cf11) =>
					var v23: set<bool> := {v1};
					...
					v5 := fm12(--safeModuloInt(p1, p1), ((v2 + v26[safeIndex(-v3, |v26|)])[safeIndex(if (f22 in v27) then v27[f22] else cf11, |(v2 + v26[safeIndex(-v3, |v26|)])|) := v5])[safeIndex(-i0, |(v2 + v26[safeIndex(-v3, |v26|)])[safeIndex(if (f22 in v27) then v27[f22] else cf11, |(v2 + v26[safeIndex(-v3, |v26|)])|) := v5]|) := v5], v26[safeIndex(p0, |v26|)], globalState);
					globalState.f11 := v1;
				case DC3(cf3) =>
					var v28: array<seq<int>> := new seq<int>[18];
					var v29: seq<int> := [i0];
					v28[safeIndex(882, v28.Length)] := [v3, p1] + v29;
					var v30: array<set<bool>> := new set<bool>[1](i1 => {v1, v1});
					v2, v28[safeIndex(882, v28.Length)], v30, v3 := seq(abs(0x10a), i2  => (v5)), v29, v30, |v2| + (if (v1) then v3 else 0x242);
					var v31: seq<seq<int>> := [v28[safeIndex(882, v28.Length)], v28[safeIndex(882, v28.Length)]];
					var v32: map<seq<seq<int>>, int> := map[v31 := safeDivisionInt(p1, fm9(p0, |v2|, v1, globalState))];
					var v33: set<int> := {464};
					v32 := v32[([v28[safeIndex(882, v28.Length)], v29])[safeIndex(|v33|, |[v28[safeIndex(882, v28.Length)], v29]|) := v28[safeIndex(882, v28.Length)]] := p0];
		...
		v38 := v38[p1 := p1 > |v40[safeIndex(p1, |v40|)]|];
		var v41: array<bool> := new bool[4](i3 => p0 >= -797);
		v41[safeIndex(199, v41.Length)] := v1 <== v1;
		var v42: multiset<int> := multiset{p1};
		v41[safeIndex(199, v41.Length)] := safeDivisionInt(-0x37c, p1) !in v42;
		globalState.f15 := false;
		var i4 := 0;
		while (v41[safeIndex(199, v41.Length)])
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
	...
	method m8(p0: int, p1: bool, globalState: GlobalState) returns (r0: set<int>, r1: bool, r2: int, r3: map<int, bool>) {
		if (p1) {
			...
			var v14: array<bool> := new bool[24] [p1, p1, p1 && p1, p1, true, !(p0 in v0), p1, p1, p1, v2 != {p0, p0, p0}, p1, p1, v3[safeIndex(p0, |v3|)], p1, p1, if (v5 in v10) then v10[v5] else p1, v0 <= v0, v6 !in (seq(abs(514), i1  => (v6))), !(|v11| <= |v13|), p1, true, fm0(v4.f23, v11[safeIndex(p0, |v11|)], p1, globalState) <==> v4.f23, p1, p1];
			v14[safeIndex(252, v14.Length)] := v4.f23;
			var v15: map<int, bool> := map[p0 := v4.f23];
			var v16: set<set<int>> := {v2};
			var v17: set<bool> := {p1};
			v14[safeIndex(252, v14.Length)] := ({p1, if (|v16| in v15) then v15[|v16|] else false} !! v17) <== v4.f23;
			var v18 := DC0(false);
			v18 := v18;
			var v19 := new C0(if (p1) then !p1 else v14[safeIndex(252, v14.Length)]);
			v6 := v6;
			f22[safeIndex(323, f22.Length)] := |v3|;
			f22[safeIndex(323, f22.Length)] := p0 + |[p0, |[v14[safeIndex(252, v14.Length)], v4.f23]|]|;
		} else {
			...
			match (DC9(v21 + v21)) {
				case DC10(cf17) =>
					...
					var v26 := DC5(v22, cf17, |(seq(abs(-0x2c5), i2  => (v25)))|);
					cf17 := v26.cf8;
					var v27: seq<bool> := [!p1];
					var v28: array<seq<bool>> := new seq<bool>[18] [v27, v27, v27, v27, v27, v27[safeIndex(p0, |v27|) := p1], [!p1], v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27];
					var v29 := DC3(v28);
				...
				case DC11(cf18, cf19, cf20) =>
					...
					var v36 := DC5(seq(abs(-656), i3  => (v30)), cf19, cf19);
					...
					var v41: array<bool> := new bool[26] [p1, p1, p1, !fm0(DC4(cf19, p1, v35).cf5, v30, p1, globalState), p1, p1 ==> p1, false, p1, false, false, |v36.cf7| > cf19, p1, !p1, fm0(p1, v30, fm0(p1, v30, p1, globalState), globalState), p1, v37 == v37, p1, p1, (seq(abs(-0x64), i4  => (v30))) < v32, p1, v38 == v38, p1, p1, !p1, p1, (if (p1 in v40) then v40[p1] else v39) == v39[safeIndex(p0, |v39|) := false]];
					v41[safeIndex(852, v41.Length)] := p1;
					v41[safeIndex(852, v41.Length)] := fm0(p1, v30, p1, globalState);
					r2 := fm9(-0x4d, cf19, v41[safeIndex(852, v41.Length)], globalState);
				case DC9(cf16) =>
					var v42: array<bool> := new bool[22];
					v42 := if (p1) then v42 else v42;
					f22[safeIndex(525, f22.Length)] := p0;
					f22[safeIndex(525, f22.Length)] := 276;
					var v43 := 'a';
					globalState.f15 := fm0(if (false) then p1 else p1, v43, p1, globalState);
					var v44: seq<int> := [f22[safeIndex(525, f22.Length)]];
					f22[safeIndex(525, f22.Length)] := safeDivisionInt(if (p1) then v44[safeIndex(p0, |v44|)] else -p0, f22[safeIndex(525, f22.Length)]);
			}
			
			var v45: array<bool> := new bool[3] [p0 <= 0x29b, !(|(seq(abs(-0xbe), i5  => ('o')))| >= p0), p1];
			v45[safeIndex(123, v45.Length)] := true;
			var v46: seq<int> := [|fm16(!p1, p0, globalState)|];
			v45[safeIndex(123, v45.Length)] := (0x21f in v46) <==> p1;
			var v47: array<array<C0>> := new array<C0>[6];
			v47 := v47;
			var v48: map<array<int>, bool> := map[f22 := v45[safeIndex(123, v45.Length)]];
			var v49 := DC0(p0 <= p0);
			r2, v48, v49, r2, r2 := p0, v48 + v48, DC0(p1).(cf0 := v45[safeIndex(123, v45.Length)]), p0, p0;
			var v50: seq<bool> := [v45[safeIndex(123, v45.Length)], p1];
			var v51: multiset<seq<bool>> := multiset{v50, [v45[safeIndex(123, v45.Length)]]};
			r2 := if (v51[v50 := abs(p0)] >= v51[v50 := abs(p0)]) then p0 else p0;
		}
		...
		var v62: array<int> := new int[11](i7 => safeDivisionInt(i7, |multiset{p0, p0, p0, p0, p0}|));
		forall i6 | 0 <= i6 < v62.Length {
			v62[i6] := safeDivisionInt(i6, |v54|);
		}
		var v63 := 'i';
		...
		r3 := map v69 : int | v69 in multiset(v75) :: (safeDivisionInt(v69, p0)) := (v52.f23);
	}
}
...
class C2 extends T0, T1 {
	...
	method m1(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v2: seq<string> := [seq(abs(0x1c8), i1  => ('h'))];
			globalState.f17 := v1[p3 := abs(|v2|)] !! v1;
			...
			var v9: array<T0> := new T0[12] [if (f21) then v4 else v5.cf21, v4, v4, v4, v4, v4, v6[safeIndex(if (v3 in v8) then v8[v3] else p1, |v6|)], v4, if (f21) then v4 else v4, v4, v4, v4];
			v9[safeIndex(743, v9.Length)] := v6[safeIndex(0xc7, |v6|)];
			v9[safeIndex(743, v9.Length)] := v4;
		}
		var v10 := -0xeb;
		var v11 := "p";
		var v12: map<int, bool> := map[p3 := f21];
		v10 := fm9(-|(v11 + (seq(abs(278), i2  => ('l'))))|, safeModuloInt(p3, v10), if (p3 in v12) then v12[p3] else p0, globalState);
		if ((if (f21) then f21 else f21) <== !!!p2) {
			...
			v16[safeIndex(133, v16.Length)] := |v11| > v10;
			v16[safeIndex(133, v16.Length)] := p2;
			v16 := v16;
			if (p2) {
				var v17: array<map<int, bool>> := new map<int, bool>[15](i4 => v12);
				var v18: seq<bool> := [!p2, p0];
				v17[safeIndex(32, v17.Length)] := fm17(v18[safeIndex(p3, |v18|)], f21, globalState);
				v17[safeIndex(32, v17.Length)] := v12;
				var v19: array<int> := new int[7];
				var v20: set<bool> := {f21};
				v19[safeIndex(216, v19.Length)] := |(v20 + v20)|;
				var v21 := 'g';
				v19[safeIndex(216, v19.Length)] := |(v11[safeIndex(p1, |v11|) := v21] + ("pddyfcmi" + v11))|;
				var v22: multiset<int> := multiset{p1, p3};
				globalState.f17 := |(multiset{--|DC5(v11, v10, v19[safeIndex(216, v19.Length)]).cf7|, p1} + v22)| < v19[safeIndex(216, v19.Length)];
				globalState.f15 := p1 != |(if (!v16[safeIndex(133, v16.Length)]) then v11 else seq(abs(84), i5  => (v21)))|;
				f20 := f20;
			} else {
				var v23: seq<bool> := [if (p3 in v12) then v12[p3] else f21, p2];
				var v24 := DC14(v23[safeIndex(p3, |v23|)], -v10, {|multiset{p1}|, -869, |v12|}, 'l');
				var v25: set<array<bool>> := {v16};
				var v26: map<bool, set<array<bool>>> := map[v16[safeIndex(133, v16.Length)] := v25];
				v24, v10, v25 := v24, v10, (if (p0) then v25 else if (v16[safeIndex(133, v16.Length)] in v26) then v26[v16[safeIndex(133, v16.Length)]] else v25) + (if (p2) then v25 else v25);
				var v27 := 'w';
				var v28: multiset<char> := multiset{v27};
				v28 := v28;
				globalState.f17 := p2;
				v10 := safeDivisionInt(v10, |(map v29 : int | (0x1bf <= v29) && (v29 < -428) :: (safeModuloInt(v29, |[v16[safeIndex(133, v16.Length)]]|)) := (v23))| * p1);
				var v30: set<int> := {-0x1b1};
				var v31: set<int> := {p3, |v30|, p3, fm9(v10, p1, p0, globalState)};
				globalState.f11 := {fm9(v10, p1, p0, globalState)} >= v31;
			}
			
			v16[safeIndex(133, v16.Length)] := p3 != p1;
			var v32 := new C0(v16[safeIndex(133, v16.Length)]);
		}
		
		if (p2) {
			var v33: array<int> := new int[17](i6 => safeDivisionInt(i6, p3));
			var v34: seq<int> := [p1, v10];
			var v35: map<bool, bool> := map[f21 := f21];
			var v36: map<seq<int>, map<bool, bool>> := map[v34 := v35];
			v33[safeIndex(322, v33.Length)] := |v36|;
			v33[safeIndex(322, v33.Length)] := safeDivisionInt(-safeDivisionInt(p3, -v10), if (!f21) then v10 else v10);
			var v37: array<set<char>> := new set<char>[10];
			var v38: multiset<string> := multiset{"yyioc"};
			var v39: set<bool> := {p0};
			var v40 := DC13(v10);
			v33[safeIndex(322, v33.Length)], v37, v33[safeIndex(322, v33.Length)], v11 := p1, v37, (if (v11 in v38) then v38[v11] else |v39|) - v40.cf22, v11;
			var v41: array<string> := new string[20](i7 => v11);
			v41[safeIndex(845, v41.Length)] := v11;
			var v42: map<int, int> := map[v10 := p1];
			var v43: set<int> := {if (p1 in v42) then v42[p1] else 0x267};
			var v44 := 'v';
			v41[safeIndex(845, v41.Length)], v43 := (v11 + v11)[safeIndex(fm9(p3, p3, false, globalState), |(v11 + v11)|) := v44], {p1 + v33[safeIndex(322, v33.Length)], p1, |v34|};
			var v45 := DC6(p3, v33[safeIndex(322, v33.Length)]);
			v45 := DC6(p3, p3);
			var v46 := new C0(f21);
		} else {
			v10 := 0x1ca;
			...
			globalState.f15, globalState.f11, globalState.f15 := !v51[safeIndex(p1, |v51|)], p0, p2;
		}
		
		if ((seq(abs(-0xb8), i8  => ('d'))) != v11) {
			var v52: set<int> := {p3};
			...
			var v55: seq<int> := [p1];
			var v56: array<int> := new int[20] [|v54|, p3, v10, p1, p3, v55[safeIndex(|{f21, true, false, p2}|, |v55|)], -p1, v10, v10, p1, v55[safeIndex(p1, |v55|)], |v12|, p1, p3, |v55|, p1, -p3, p3, v10, v10];
			var v57: multiset<bool> := multiset{false, p2, p2, p2};
			var v58 := DC14(f21, v10, v52, v11[safeIndex(|v57|, |v11|)]);
			...
			if (v10 < v10) {
				...
				v60[safeIndex(565, v60.Length)] := p0;
				var v68: array<int> := new int[4] [v10, p1, 0x9, p3];
				var v69: map<array<bool>, array<int>> := map[v60 := v68];
				var v70: seq<int> := [p1];
				var v71: set<bool> := {true};
				var v72: array<int> := new int[24] [505, p1, p3, |v69|, 0x1f3, |v70|, |(seq(abs(0x27a), i11  => (v61)))|, v10, v10, v10, |v71|, p1, p1, p1, 0xeb, fm9(|v11|, p3, true, globalState), v10, p3, 0xb5, 0x304, |v11|, v10, p3, -85];
				var v73: array<array<int>> := new array<int>[3] [v72, v68, v72];
				globalState.f2, v60[safeIndex(565, v60.Length)] := v73, p2;
				...
				v76[safeIndex(944, v76.Length)] := if (p0) then p1 else 185;
				var v77: set<bool> := {p2};
				var v78: seq<bool> := [p0, p0, p2, p2, p0];
				globalState.f17, v75, v10, v76[safeIndex(944, v76.Length)], v10 := false, 'q', v10, fm9(fm9(|v11|, p1, p2, globalState) + |v77|, safeDivisionInt(v10, 0x27c), p3 != |v78|, globalState), 958;
				globalState.f15 := p0;
			}
			
			var v79: array<int> := new int[18];
			var v80 := new C1(v79);
			v60[safeIndex(954, v60.Length)] := !f21;
			v60[safeIndex(954, v60.Length)] := !f21;
		}
		...
		for i13 := -878 to |v81| {
			...
			var v83: set<int> := {p3};
			var v84 := 'p';
			var v85 := DC14(f21, |[|(seq(abs(477), i14  => ('r')))|, i13, v10]|, v83, v84);
			...
			var v93: seq<int> := [|{'k'}|];
			var v94: array<bool> := new bool[29] [p0, p2, p0, f21, p0, p0, !f21, false, f21, p0, false, !p0, f21, p2, p0, p0, fm0(p0, v84, f21, globalState), fm0(f21, v84, f21, globalState), p2, p2, f21, !(if (f21 in v90) then v90[f21] else if ((map v92 : int | v92 in v93 :: (safeModuloInt(v92, i13)) := (f21)) in v91) then v91[map v92 : int | v92 in v93 :: (safeModuloInt(v92, i13)) := (f21)] else p0), p2, true, p2, p0, p0, f21, f21];
			v89[safeIndex(339, v89.Length)] := v94;
			v89[safeIndex(339, v89.Length)] := DC4(v10, f21, v94).cf6;
		}
		r0 := p2;
	...
	method m5(p0: bool, p1: seq<bool>, globalState: GlobalState) returns (r0: bool) {
		...
		if (f21) {
			...
			var v22 := DC3(v21[safeIndex(|fm20(globalState)|, |v21|)]);
			var v23: multiset<D1> := multiset{v22};
			v19 := v19[safeModuloInt(v1, v1) := |v23| - v1];
			v1 := -v1 + (v1 - |p1|);
			var v24: seq<char> := [v2, v2, v2];
			var v25: T0 := new C0(v24[safeIndex(v1, |v24|)] in "qgaehayk");
			v25 := v25;
			v24 := v24 + v24;
			v1, v24 := safeDivisionInt(fm9(v1, |p1|, f21, globalState), fm9(v1, v4[safeIndex(v1, |v4|)], p0, globalState)), if (p0) then v24 else v24;
		}
			...
			decreases 100 - i0
		{
			...
			if (if (p0) then f21 else !f21) {
				...
				v1 := fm9(|({v1} + v29)|, safeDivisionInt(v1, v1), !f21, globalState);
				globalState.f15 := f21;
			} else {
				var v30: array<bool> := new bool[11];
				v30[safeIndex(241, v30.Length)] := p0;
				var v31: multiset<array<bool>> := multiset{v30};
				v30[safeIndex(241, v30.Length)] := fm0(!f21, v2, v31 <= v31, globalState);
				var v32 := "cb";
				v32 := v32 + (v32 + v32);
				v1 := v1;
				var v33 := new C0(f21);
				var v34: array<int> := new int[28];
				v34[safeIndex(653, v34.Length)] := v1;
				v34[safeIndex(653, v34.Length)] := v1;
			}
			...
			if (p0 && f21) {
				...
				var v37 := "nbewbhblg";
				v36[safeIndex(779, v36.Length)] := v37;
				v36[safeIndex(779, v36.Length)] := "jksnhhduo";
				var v38: set<int> := {0x1de};
				v1 := |(({|v36[safeIndex(779, v36.Length)]|, --v1} - v38) * (set v39 : int | (-0x3bd <= v39) && (v39 < 919) :: (v39 * v1)))|;
			} else {
				var v40 := "p";
				var v41 := DC5(v40, -v1, v1);
				v1 := |(if (p0) then seq(abs(0xa5), i2  => (DC5("dyabgd", v1, v1))) else [v41, v41])|;
				v1 := |v4| * v1;
				var v42 := new C0(|v40[safeIndex(v1, |v40|) := v2]| < v1);
				var v43: seq<string> := [v40];
				v1 := |(if (v42.f23) then v40 + (v43[safeIndex(v1, |v43|)])[safeIndex(v1, |v43[safeIndex(v1, |v43|)]|) := v2] else v40)|;
				v1, globalState.f15, v1 := safeDivisionInt(-v1, |fm8(p0, globalState)|), p1[safeIndex(0x206, |p1|)], if (v42.f23) then -0x27d else v1;
			}
			...
			decreases 100 - i4
		{
			...
			v45[safeIndex(158, v45.Length)] := fm19(v4, p0, globalState);
			v45[safeIndex(158, v45.Length)] := v4 + v4;
			globalState.f11, v1 := v1 !in v45[safeIndex(158, v45.Length)], 0x1cb;
		...
		v48[safeIndex(649, v48.Length)] := v46;
		v48[safeIndex(649, v48.Length)] := v46;
		if (f21) {
			var v49 := "trlsw";
			v1 := |v49| + |(v4 + v4)|;
			if (!p1[safeIndex(fm9(v1, |p1|, !f21, globalState), |p1|)]) {
				var v50: array<bool> := new bool[5];
				v50[safeIndex(474, v50.Length)] := p0;
				v50[safeIndex(474, v50.Length)], v1 := f21, v1;
				v1 := -v1;
				v50 := v50;
				var v51: multiset<bool> := multiset{p0, v50[safeIndex(474, v50.Length)], f21};
				v50[safeIndex(474, v50.Length)] := v51 <= v51;
				v1 := safeModuloInt(0x1d4, v1);
			} else {
				...
				var v57: array<bool> := new bool[20] [p0, f21, false, v54 > v54, fm0(f21, v2, f21, globalState), p0, p0, f21, v55 !! v56[safeIndex(v1, |v56|)], !!false, f21, p0, p0, f21, true, p0, p0, !f21, fm0(f21, v2, p0, globalState), true];
				v57[safeIndex(792, v57.Length)] := p0;
				v57[safeIndex(792, v57.Length)] := -v1 >= (v1 + -0x1b8);
				var v58: map<bool, bool> := map[f21 := p0];
				var v59: map<bool, map<bool, bool>> := map[true := v58 + v58[v57[safeIndex(792, v57.Length)] := f21]];
				v59 := v59[f21 := (fm22(globalState))[p0 := f21]];
				var v60: map<int, int> := map[v1 := |v49|];
				v57[safeIndex(792, v57.Length)] := !(v1 !in v60);
			}
			...
			var v65: multiset<bool> := multiset{v63 > v64[safeIndex(v1, |v64|)], f21, p0, f21};
			v65 := v65;
		} else {
			if ((fm9(v1, v1, f21, globalState) - v1) != (if (f21) then v1 else v1)) {
				var v66 := "upxiueqmn";
				var v67: map<D4, string> := map[v5 := v66];
				v67 := v67[v5 := seq(abs(581), i6  => (v2))];
				...
				v68 := v68[fm23(f21, v68, fm9(v1, v1, p0, globalState), v2, globalState) < v70[safeIndex(-|v69|, |v70|)] := v1];
				...
				var v76: array<set<array<bool>>> := new set<array<bool>>[16] [v74, v74 * v74, v74, v74, v74, v74, {v73, v73, v73, v73, v75[safeIndex(v1, |v75|)]}, v74, v74 - v74, v74, v74, {v73}, v74, v74, v74, {v73}];
				v76[safeIndex(518, v76.Length)] := v74;
				v76[safeIndex(518, v76.Length)] := v74;
				v1 := v1;
				var v77 := new C0(false);
				v73[safeIndex(427, v73.Length)] := f21;
				v73[safeIndex(229, v73.Length)] := true;
				...
				var v82: set<int> := {v1, |v79[v4[safeIndex(|v4|, |v4|)] := abs(v1)]|, |(v79 * v80[safeIndex(|v81|, |v80|)])|};
				var v83: multiset<seq<bool>> := multiset{p1, p1, p1};
				var v84: map<multiset<seq<bool>>, int> := map[v83 := v1];
				var v85: map<bool, int> := map[f21 := v1];
				v73[safeIndex(427, v73.Length)], v73[safeIndex(229, v73.Length)], v78, v82 := p0, fm0(!v77.fm15(v77.f23, p0, if (v83[[p0] := abs(v1)] in v84) then v84[v83[[p0] := abs(v1)]] else v1, fm24(v77.fm15(p0, p0, |v4|, v85, globalState), |v82|, globalState), globalState), v5.cf26, true, globalState), v78, v82 + ((set v86 : int | (0x3c1 <= v86) && (v86 < 0x1ba) :: (v86 * v1)) - {v1, 0x11a, v1});
			...
			var v91: set<map<int, bool>> := {v89, v90[safeIndex(v1, |v90|)]};
			var v92 := DC9(v91 - v91);
			v92 := v92;
			var v93 := new C0(f21);
			...
			match (f20) {
				case DC1(cf1) =>
					v95[safeIndex(956, v95.Length)] := p0;
					v95[safeIndex(956, v95.Length)] := v93.fm15(v93.f23, f21 || v93.f23, 0x18b, v94, globalState);
					var v96 := "aln";
					...
					v99[safeIndex(334, v99.Length)] := v1;
					var v100: multiset<int> := multiset{v1, v1, v1};
					v99[safeIndex(334, v99.Length)], v1, v100 := safeModuloInt(v1, v1), v1, v100 - v100;
				case DC0(cf0) =>
					var v101: array<array<int>> := new array<int>[25];
					var v102 := "uajufq";
					var v103: array<int> := new int[18];
					var v104: map<string, array<int>> := map[v102 := v103];
					v101[safeIndex(686, v101.Length)] := if (v102 in v104) then v104[v102] else v103;
					v101[safeIndex(686, v101.Length)] := v103;
	...
	method m6(p0: int, p1: string, p2: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool, r3: string) {
			...
			decreases 100 - i0
		{
			...
			if (f21) {
				...
				var v9 := DC5(p1, p0, |p1|);
				var v10: array<int> := new int[22] [p0, p0, p0, |(if (|p1| in v3) then v3[|p1|] else v2)|, |multiset{f21}|, p0, p0, p0, |p1|, p0, p0, p0, -v5[safeIndex(fm9(|v7|, p0, f21, globalState), |v5|)], p0, |v1|, p0, |v8|, p0, v9.cf9, p0, p0, 0x293];
				var v11 := new C1(v10);
				var v12: array<D3> := new D3[18];
				var v13: array<bool> := new bool[14](i1 => p2);
				v13[safeIndex(941, v13.Length)] := f21;
				v12, v13[safeIndex(941, v13.Length)] := v12, f21;
				...
				var v18: seq<seq<seq<bool>>> := [seq(abs(857), i2  => (v16)), v17];
				var v19: map<bool, string> := map[p2 := seq(abs(222), i3  => ('r'))];
				var v20 := 'c';
				...
				var v27: map<bool, int> := map[p2 := |(seq(abs(214), i4  => (v20)))|];
				var v28: array<int> := new int[22] [|v16|, v15, p0, -p0, p0, p0, p0, v15, p0, |v18[safeIndex(v15, |v18|)]|, |v19|, p0, v15, |p1|, v15, fm9(0x53, v15, f21, globalState), |[v25, v25]|, |v26[safeIndex(p0, |v26|)]|, v15, |v16|, |v27|, |p1|];
				v15 := DC11(map[f21 := v15], v15, v25).cf19;
				var v29: map<char, int> := map['a' := v15];
				v15 := |[v22, [v15, v15], [544, |v29|]]|;
				globalState.f15 := f21;
				v15 := safeDivisionInt(v22[safeIndex(v15, |v22|)], p0);
			...
			v33 := v33["ubtj" := v32];
			var v34: array<int> := new int[28](i5 => safeModuloInt(i5, p0));
			var v35: seq<array<int>> := [v34];
			var v36: C1 := new C1(v34);
			var v37 := DC16(v36);
			var v38: seq<C1> := [v37.cf28];
			var v39 := new C1(v35[safeIndex(|v38|, |v35|)]);
			...
			decreases 100 - i6
		{
			...
			match (v42) {
				case DC4(cf4, cf5, cf6) =>
					...
					var v44 := new C0(!f21);
					var v45 := 'b';
					var v46: map<string, int> := map[if (v44.f23) then p1 else p1[safeIndex(-cf4, |p1|) := v45] := |{f21, cf5, v44.f23, f21}|];
					var v47: map<bool, bool> := map[f21 := v43.f23];
					v46 := fm25(v43.f23, v47 == v47, globalState);
				case DC5(cf7, cf8, cf9) =>
					var v48: seq<int> := [|p1|];
					var v49: array<int> := new int[17] [cf8, p0 * cf9, cf8, safeDivisionInt(cf9, p0), cf9, p0, p0, cf8, 0x2d3, 0x311, cf9, p0, |{v48[safeIndex(cf8, |v48|)], cf8, cf9, p0}|, cf8, v48[safeIndex(p0, |v48|)], p0, safeModuloInt(p0, p0)];
					v49[safeIndex(620, v49.Length)] := cf9;
					var v50: map<array<int>, array<int>> := map[v49 := v49];
					v49[safeIndex(620, v49.Length)] := |v50|;
					globalState.f11 := f21;
					var v51: seq<bool> := [f21];
					v41[safeIndex(696, v41.Length)] := v51[safeIndex(|{f21, f21, v51[safeIndex(|"xlt"|, |v51|)]}|, |v51|)];
					var v52: array<char> := new char[3];
					var v53 := 'h';
					v52[safeIndex(339, v52.Length)] := v53;
					var v54: set<bool> := {!f21};
					var v55: T0 := new C0(v54 >= v54);
					v41[safeIndex(696, v41.Length)], cf9, r0, v52[safeIndex(339, v52.Length)], v55 := p2, cf9, ({f21} - v54) >= v54, v53, v55;
					v49[safeIndex(620, v49.Length)] := safeDivisionInt(-cf9, cf8);
				case DC6(cf10, cf11) =>
					cf10 := cf11;
				...
				case DC3(cf3) =>
					...
					v62[safeIndex(502, v62.Length)] := v64;
					v62[safeIndex(502, v62.Length)] := v64;
					var v65: array<int> := new int[19];
					v65[safeIndex(796, v65.Length)] := |(p1 + fm16(f21, p0, globalState))|;
					var v66 := DC20(f21, p0, true);
					globalState.f17, globalState.f17, v65[safeIndex(796, v65.Length)] := p2, v66.cf36, -p0;
					var v67: seq<bool> := [if (f21) then p2 else f21, f21, f21, p2];
					globalState.f16 := v67[safeIndex(p0, |v67|) := f21];
			}
			...
			v83[safeIndex(948, v83.Length)] := v76;
			var v84: seq<bool> := [p2];
			var v85: multiset<int> := multiset{p0, 0x3c, p0};
			v75, globalState.f11, v83[safeIndex(948, v83.Length)], globalState.f11 := v75, v70 > v70, v76, !(if (true) then multiset{p0, 115, |v84|} <= v85 else f21);
		...
		if (!((p1 + p1) == p1)) {
			...
			v96 := v96[v97[safeIndex(p0, |v97|)] := safeModuloInt(p0, p0)];
		} else {
			var v98: array<int> := new int[10];
			v98[safeIndex(151, v98.Length)] := p0;
			v98[safeIndex(151, v98.Length)] := p0;
			globalState.f15 := f21;
			v98[safeIndex(151, v98.Length)] := -p0 + v98[safeIndex(151, v98.Length)];
			var v99 := DC20(f21, v98[safeIndex(151, v98.Length)], f21);
			...
			var v104: map<int, int> := map[|v103| := v98[safeIndex(151, v98.Length)]];
			var v106 := 'u';
			var v107 := DC14(false, p0, set v105 : int | v105 in v104 :: (v105 + |"lp"|), v106);
			var v108: map<bool, char> := map[{v101[safeIndex(v98[safeIndex(151, v98.Length)], |v101|)]} >= v102 := fm12(v107.cf24, seq(abs(-558), i8  => ('f')), seq(abs(0x1d0), i9  => (v106)), globalState)];
			v108 := v108[f21 := v106];
		}
			...
			decreases 100 - i10
		{
			...
			var v118: array<string> := new string[21] [p1, p1, "snqcwt", p1, p1, p1, p1, p1, p1, p1, p1, p1, "cx", p1[safeIndex(p0, |p1|) := v113], p1, "ygblryv", if (|v117| in v114) then v114[|v117|] else p1, p1, p1, p1, seq(abs(-0x16f), i11  => (v113))];
			var v119 := DC21(v118);
			var v120: seq<array<string>> := [(v119.(cf39 := v118)).cf39];
			v112[safeIndex(246, v112.Length)] := v120[safeIndex(0xd7, |v120|)];
			var v121: multiset<bool> := multiset{p2};
			v112[safeIndex(246, v112.Length)], globalState.f15, v121 := v118, 0x1a3 >= safeModuloInt(p0, p0), v121 - (multiset{p2})[false := abs(p0)];
			...
			v123[safeIndex(539, v123.Length)] := v122 + fm27(p0, p0, -p0, globalState);
			v123[safeIndex(539, v123.Length)] := ([p2])[safeIndex(p0, |[p2]|) := p2];
			var v124: array<int> := new int[7](i12 => safeModuloInt(i12, p0));
		...
		for i13 := p0 to p0 {
			...
			v126[safeIndex(351, v126.Length)] := v127 + v127;
			var v128: array<array<D5>> := new array<D5>[23];
			var v129 := 0x328;
			var v130 := DC22(v128);
			r1, v126[safeIndex(351, v126.Length)], v128, v129, v129 := !(safeDivisionInt(-0xc, -v129) >= fm9(p0, p0, false, globalState)), v127, v130.cf40, p0 - v129, i13;
			...
			v133[safeIndex(876, v133.Length)] := v135;
			v129, v131, v129, v133[safeIndex(876, v133.Length)] := -safeModuloInt(p0, fm9(0x2aa, |p1|, f21, globalState)), v131, fm9(0x31f, p0, fm28(i13, p2, globalState) > multiset{!false, f21}, globalState), fm10(globalState);
			var v136: map<int, bool> := map[|(seq(abs(322), i16  => ('y')))| := f21];
			...
			var v142: array<int> := new int[27] [p0, p0, i13, |p1[safeIndex(v129, |p1|) := 't']|, -0x251, -p0, v129, v129, |v136|, |v137|, v129, v129, v129, p0, v129, |v137|, fm9(v129, |p1|, p2, globalState), |multiset(p1)|, p0, p0, v129, p0, i13, |v138|, if (|p1| in v141) then v141[|p1|] else v129, v129, |map[p0 := f21]|];
			var v143: multiset<array<int>> := multiset{v142};
			var v144: seq<multiset<array<int>>> := [v143];
			v129 := |v144[safeIndex(p0, |v144|)]|;
			var v145: array<char> := new char[5];
			var v146: seq<array<char>> := [v145, v145];
			var v147: array<array<char>> := new array<char>[26] [v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v145, v146[safeIndex(p0, |v146|)], v145, v145, v145, if (f21) then v145 else v145, v145, v145, v145, v145, v145, v145];
			var v148: seq<seq<bool>> := [v126[safeIndex(351, v126.Length)], v127 + v126[safeIndex(351, v126.Length)]];
			var v149: seq<array<int>> := [v142];
			var v150: seq<array<int>> := [v142, v149[safeIndex(v129, |v149|)], v142, v142, v142];
			var v151: C1 := new C1(v150[safeIndex(-p0, |v150|)]);
			var v152 := DC16(v151);
...
class C3 {
	...
	method m4(p0: int, p1: bool, p2: array<bool>, p3: char, globalState: GlobalState) returns (r0: seq<bool>, r1: int, r2: map<int, bool>, r3: string) {
			...
			decreases 100 - i0
		{
			...
			var v5: seq<array<bool>> := [v2[safeIndex(|v4[safeIndex(p0, |v4|)]|, |v2|)], p2];
			var v6: map<int, seq<array<bool>>> := map[--0x3d8 := v5];
			var v7: seq<bool> := [p1];
			v0[safeIndex(598, v0.Length)] := |(if (p0 in v6) then v6[p0] else v5[safeIndex(p0, |v5|) := p2])| + |multiset(v7)|;
			v0[safeIndex(598, v0.Length)] := p0 * p0;
			...
			if (if (v8 in v9) then v9[v8] else if (true) then p1 else p1) {
				globalState.f15 := fm7(v0[safeIndex(598, v0.Length)], p1, p0 * -0x248, globalState);
				p2[safeIndex(346, p2.Length)] := if (false) then p1 else false;
				var v10 := "wngf";
				r3, p2[safeIndex(346, p2.Length)] := v10, p1;
				var v11: map<int, bool> := map[|v10| := p1];
				var v12: map<int, int> := map[p0 := v0[safeIndex(598, v0.Length)]];
				var v13: map<bool, bool> := map[p2[safeIndex(346, p2.Length)] := if (p0 in v11) then v11[p0] else fm6(v12, globalState)];
				var v14 := DC20(v10 < v10[safeIndex(v0[safeIndex(598, v0.Length)], |v10|) := 'v'], -v0[safeIndex(598, v0.Length)], if (p2[safeIndex(346, p2.Length)] in v13) then v13[p2[safeIndex(346, p2.Length)]] else p1);
				v14 := DC20(true, fm9(p0, |v10|, p2[safeIndex(346, p2.Length)], globalState), p1);
				globalState.f11 := p1;
				var v15: array<bool> := new bool[25](i2 => p1);
				var v16: array<seq<int>> := new seq<int>[28](i3 => [|v10|]);
				var v17: multiset<int> := multiset{p0};
				v16[safeIndex(988, v16.Length)] := [|v17|];
				var v18: map<multiset<string>, array<bool>> := map[multiset([fm16(p1, p0, globalState), fm16(p2[safeIndex(346, p2.Length)], |"cfbueqff"|, globalState)]) := v15];
				var v19: multiset<string> := multiset{v10, v10, v10, v10, v10};
				var v20: seq<int> := [v0[safeIndex(598, v0.Length)], p0, -safeDivisionInt(p0, v0[safeIndex(598, v0.Length)])];
				v15, v16[safeIndex(988, v16.Length)], v0[safeIndex(598, v0.Length)] := if (v19 in v18) then v18[v19] else v15, v20, p0;
			} else {
				v0[safeIndex(598, v0.Length)] := p0;
				var v21 := new C0(if (fm0(p1, p3, p1, globalState)) then p1 else p1);
				var v22 := "xergafjq";
				r0 := ([v21.f23, p1, fm0(p1, v22[safeIndex(v0[safeIndex(598, v0.Length)], |v22|)], p1, globalState)] + v7)[safeIndex(v0[safeIndex(598, v0.Length)], |([v21.f23, p1, fm0(p1, v22[safeIndex(v0[safeIndex(598, v0.Length)], |v22|)], p1, globalState)] + v7)|) := p1];
				var v23: multiset<int> := multiset{|map[p3 := v0[safeIndex(598, v0.Length)]]|, v0[safeIndex(598, v0.Length)], p0};
				r1 := (if (v0[safeIndex(598, v0.Length)] in v23) then v23[v0[safeIndex(598, v0.Length)]] else p0) - v0[safeIndex(598, v0.Length)];
				var v24: map<char, C1> := map[p3 := v1];
				v24 := v24[DC14(p1, v0[safeIndex(598, v0.Length)], v3, 's').cf26 := v1];
			}
			
			if (p1) {
				var v25: map<int, set<int>> := map[p0 := v3];
				r1 := |((if (-v0[safeIndex(598, v0.Length)] in v25) then v25[-v0[safeIndex(598, v0.Length)]] else v3) * v3)| * v0[safeIndex(598, v0.Length)];
				var v26: multiset<bool> := multiset{p1};
				v26, globalState.f15, v0[safeIndex(598, v0.Length)] := v26, if (p1) then p1 && !!p1 else p1, v0[safeIndex(598, v0.Length)];
				var v27: multiset<int> := multiset{p0};
				var v28 := DC20(!p1 ==> true, v0[safeIndex(598, v0.Length)] + |v27|, p1);
				var v29: set<bool> := {p1};
				v28, globalState.f15, globalState.f11, v0[safeIndex(598, v0.Length)] := if (v29 !! v29) then v28 else v28, p1, p1, safeDivisionInt(v0[safeIndex(598, v0.Length)], v0[safeIndex(598, v0.Length)]);
				var v30 := "gghwthy";
				var v31: seq<string> := ["pqjkhiid", v30[safeIndex(v0[safeIndex(598, v0.Length)], |v30|) := p3]];
				var v32: map<int, int> := map[p0 := v0[safeIndex(598, v0.Length)]];
				v31 := if (fm6(v32, globalState)) then v31 else [v30];
				r1 := 0x115;
			} else {
				v0[safeIndex(598, v0.Length)] := v0[safeIndex(598, v0.Length)];
				var v33: map<int, int> := map[p0 := v0[safeIndex(598, v0.Length)]];
				var v35 := "t";
				var v36: multiset<map<int, int>> := multiset{v33, map v34 : int | (0x269 <= v34) && (v34 < 0x3bd) :: (v34 * |"uvscymnab"|) := (p0), map[|v35| := v0[safeIndex(598, v0.Length)]] + v33};
				var v37: map<bool, int> := map[p1 := v0[safeIndex(598, v0.Length)]];
				var v38: seq<int> := [v0[safeIndex(598, v0.Length)], p0, fm9(|v37|, p0, p1, globalState)];
				globalState.f11, globalState.f11, v0, r1, v0[safeIndex(598, v0.Length)] := false, v3 >= v3, v1.f22, if ((map[0x36 := v0[safeIndex(598, v0.Length)]] + v33) in v36) then v36[map[0x36 := v0[safeIndex(598, v0.Length)]] + v33] else v38[safeIndex(v0[safeIndex(598, v0.Length)], |v38|)], p0;
				var v39 := DC24(v38);
				globalState.f15, globalState.f11 := 0xd8 != (|v39.cf42| - 0x3ca), !(false <==> false);
				var v40: map<seq<int>, bool> := map[v38 := p1];
				v40 := v40[v38 := p1];
				p2[safeIndex(936, p2.Length)] := p1;
				var v41: array<string> := new string[24](i4 => v35);
				v41[safeIndex(792, v41.Length)] := fm16(true, p0, globalState);
				var v42: array<array<int>> := new array<int>[5] [v1.f22, v1.f22, v0, v1.f22, v1.f22];
				p2[safeIndex(936, p2.Length)], globalState.f2, v41[safeIndex(792, v41.Length)] := p1, if (p1) then v42 else v42, v35;
			}
		...
		r2 := map[safeModuloInt(|v56|, p0) := p1 <==> !p1];
		var v57 := "suhxbcocc";
		r3 := (v57 + v57) + v57;
	}
}
...
class C4 extends T0, T1 {
	...
	method m1(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v5: array<array<bool>> := new array<bool>[19] [v0, v0, v0, if (p0) then v0 else v0, v0, v0, v0, v0, if ([v1] in v3) then v3[[v1]] else v0, v0, v0, v0, v0, v4[safeIndex(-0x8, |v4|)], v0, v0, DC4(0x33, p2, v0).cf6, v0, v0];
		v5[safeIndex(100, v5.Length)] := v0;
		var v6: seq<string> := [v2];
		var v7: multiset<char> := multiset{v1};
		var v8: map<int, bool> := map[if (v1 in v7) then v7[v1] else p1 := p2];
		v5[safeIndex(100, v5.Length)], globalState.f15, v6 := v0, fm0(!(p1 != |map[p0 := v1]|), v1, v8 != v8, globalState), v6;
		if (!f19) {
			v5[safeIndex(100, v5.Length)] := v5[safeIndex(100, v5.Length)];
			var v9: multiset<int> := multiset{p1, 0x1};
			globalState.f11 := v9 !! v9;
			var v10 := 938;
			var v11: seq<bool> := [p2];
			v10 := fm5(safeDivisionInt(|v11|, p1), globalState);
			v2 := v2;
			var v12: map<int, array<bool>> := map[p3 := v0];
			var v13: map<bool, bool> := map[p0 := p2];
			v12 := v12[safeModuloInt(|v11[safeIndex(|v13|, |v11|) := p0]|, p3) := v5[safeIndex(100, v5.Length)]];
		} else {
			if (f19) {
				var v14: seq<int> := [p1, p1];
				var v15: array<int> := new int[11] [p3, v14[safeIndex(p3, |v14|)], p1, p3, p3, p3, p1, p3, p3, p1, |v6|];
				...
				v19 := map[v17 := safeModuloInt(p1, v17)];
				var v20 := new C3();
				...
				v22[safeIndex(114, v22.Length)] := multiset{p0};
				var v23: multiset<bool> := multiset{p2};
				var v24 := DC27(v23);
				v22[safeIndex(114, v22.Length)] := if (f19) then v24.cf48 else v23;
				var v25: map<bool, int> := map[p2 := safeDivisionInt(|v2|, -|v8|)];
			...
			if (!(v31.(cf37 := 115)).cf38) {
				var v32 := 203;
				var v33: seq<int> := [p3];
				v32 := v33[safeIndex(p3, |v33|)];
				r0 := p2;
				globalState.f15 := !p2;
				var v34: array<int> := new int[16];
				v34[safeIndex(446, v34.Length)] := p3;
				var v35 := DC4(-p1, f19, v0);
				var v36: set<bool> := {false, f19, f19, p2, f19};
				var v37 := DC8(v35.cf6, 770, |v36|);
				v34[safeIndex(446, v34.Length)], v0, v0 := v32, v5[safeIndex(100, v5.Length)], v37.cf13;
				var v38 := DC5(v2, -p3, p3);
				var v39: map<bool, string> := map[f19 := v2];
				var v40: array<string> := new seq<char>[28] [v2, v2, v2, if (true) then v2 else v2, v2 + v2, v2, v2 + v38.cf7, v2 + v2, v6[safeIndex(p3, |v6|)], v38.cf7, v2, v2 + v6[safeIndex(p1, |v6|)], v2, "fpbix", v2, v2, (seq(abs(49), i0  => (v1))) + v2, (seq(abs(0xd2), i1  => (v1)))[safeIndex(0x18e, |(seq(abs(0xd2), i1  => (v1)))|) := v1] + (if (p2 in v39) then v39[p2] else "noveiuir"), (fm16(!p2, v34[safeIndex(446, v34.Length)], globalState) + (seq(abs(129), i2  => (v1))))[safeIndex(p3, |(fm16(!p2, v34[safeIndex(446, v34.Length)], globalState) + (seq(abs(129), i2  => (v1))))|) := v1], if (p2) then v2 else seq(abs(898), i3  => (v1)), v2, "vafiqo", v2, seq(abs(-0xc8), i4  => (v1)), v2 + (seq(abs(717), i5  => (v1))), v2 + v2, v2, v2];
				v40[safeIndex(469, v40.Length)] := v2;
				var v41: multiset<bool> := multiset{p2, v34[safeIndex(446, v34.Length)] >= v32, p2};
				var v42: C0 := new C0(p0);
				var v43 := DC25(p3, p0, p1, v42);
				var v44: multiset<int> := multiset{v43.cf45, |fm16(v42.f23, --0x137, globalState)|};
				v36, v40[safeIndex(469, v40.Length)], v34[safeIndex(446, v34.Length)], v41, globalState.f15 := v36, v2, safeModuloInt(safeDivisionInt(|v44|, |v2|), |v29|), v41[v36 > v36 := abs(v32)], if ((v34[safeIndex(446, v34.Length)] + p1) in v8) then v8[v34[safeIndex(446, v34.Length)] + p1] else p0;
			} else {
				var v45 := DC13(p1);
			...
			if (--p3 >= p3) {
				...
				var v60: map<bool, seq<int>> := map[f19 := v59[safeIndex(p3, |v59|) := |"vbydlk"|]];
				var v61: map<int, int> := map[704 := |(if (p2 in v60) then v60[p2] else seq(abs(0x3cf), i7  => (|v2|)))|];
				var v62: set<bool> := {p2};
				var v63: map<bool, bool> := map[true := p2];
				var v64 := DC24(fm19(v59, if (p0 in v63) then v63[p0] else v58[safeIndex(p3, |v58|)], globalState));
				var v65 := DC26(v64);
				...
				var v70: array<int> := new int[23] [-((if (p1 in v61) then v61[p1] else p3) * -0x9d), p1, |v29| * p3, p1, fm9(p1, 0x51, p2, globalState), p1, safeDivisionInt(p3, p3), -328, p1, if (p0) then fm9(p1, p3, p2, globalState) else |v62|, |(if (p2) then v56 else map[p0 := -174])|, p1 - p1, p3, p1, 258, |map[v66 := p1]| * p1, fm9(p1, -p3, f19, globalState), safeDivisionInt(p1, 0x24d), p1, 0x2da + p1, safeDivisionInt(-p1, p3), |(v69 + v69)|, p1];
				v67[safeIndex(357, v67.Length)] := p1;
				var v71 := 0x166;
				globalState.f11, v67[safeIndex(357, v67.Length)], v71 := !p2, p3, v71;
				var v72 := DC13(|fm20(globalState)|);
				var v73: map<bool, D4> := map[v58[safeIndex(863, |v58|)] := v72];
				v73 := v73[true := v72];
				var v74: C1 := new C1(v67);
				var v75: seq<C1> := [v74];
				var v76: multiset<bool> := multiset{!p2, p2, !false, false, f19};
				v67[safeIndex(357, v67.Length)], v67[safeIndex(357, v67.Length)] := -(p3 * |(v75 + v75)|), -(if (p0 in v76) then v76[p0] else v71) + v67[safeIndex(357, v67.Length)];
				r0 := p3 == v71;
			} else {
				var v78: map<int, int> := map[|multiset(v2)| := p1];
				var v79: map<array<bool>, map<int, int>> := map[v5[safeIndex(100, v5.Length)] := map v77 : int | v77 in v78 :: (safeDivisionInt(v77, p1)) := (p3)];
				v2 := (fm16(p2, |v79|, globalState))[safeIndex(p3, |fm16(p2, |v79|, globalState)|) := v2[safeIndex(p1, |v2|)]];
				var v80 := DC1(p2);
				...
				var v84 := new C0(!f19);
				v0[safeIndex(758, v0.Length)] := v81.f21;
				var v85 := -0x272;
				var v86: set<bool> := {p0};
				v0[safeIndex(758, v0.Length)], v85 := |v86| >= safeDivisionInt(p3, v85), p1;
		...
		v5[safeIndex(100, v5.Length)][safeIndex(820, v5[safeIndex(100, v5.Length)].Length)] := |v2| == p1;
		v5[safeIndex(100, v5.Length)][safeIndex(820, v5[safeIndex(100, v5.Length)].Length)] := p2;
		for i9 := p3 to 0x332 + 0xa2 {
			var v88: array<int> := new int[29];
			var v89: seq<bool> := [p0, fm0(v5[safeIndex(100, v5.Length)][safeIndex(820, v5[safeIndex(100, v5.Length)].Length)], 'a', p0, globalState)];
			v88[safeIndex(780, v88.Length)] := safeModuloInt(|v89|, p3);
			v88[safeIndex(780, v88.Length)] := p1 - (if (p2) then p1 else i9);
			var v90: map<bool, int> := map[p0 := i9];
			var v91: seq<int> := [p3];
			var v92 := DC5(seq(abs(-0xf8), i10  => (v1)), v88[safeIndex(780, v88.Length)], p1);
			var v93 := DC11(v90, safeModuloInt(v91[safeIndex(|v92.cf7|, |v91|)], p1), v88);
			v93 := DC11(v90, |map[p2 := v88[safeIndex(780, v88.Length)]]|, v88).(cf18 := v90);
			v91 := v91;
			...
			decreases 100 - i11
		{
			...
			v99[safeIndex(552, v99.Length)] := 0x28f - p3;
			v99[safeIndex(881, v99.Length)] := p3;
			var v100 := DC17(p2, DC8(v5[safeIndex(100, v5.Length)], p1, -273), true, f19, p1);
			r1, v99[safeIndex(552, v99.Length)], v99[safeIndex(881, v99.Length)] := !v5[safeIndex(100, v5.Length)][safeIndex(820, v5[safeIndex(100, v5.Length)].Length)], v100.cf33, (-|v95| * p1) - p1;
			var v101 := new C3();
	...
	method m2(globalState: GlobalState) {
		...
		var v12: array<char> := new char[20] [v4, v4, if (f19) then if ("apnh" in v5) then v5["apnh"] else v4 else v4, v4, v4, v4, v4, fm12(|v6|, seq(abs(223), i0  => ('e')), "jxjyg", globalState), v4, v3[safeIndex(fm5(|v9|, globalState), |v3|)], v4, v4, v4, fm12(v1, "vnd", v3, globalState), v4, v4, v4, fm12(v1, "op", v3, globalState), v4, fm12(|v11|, "hdoqfle", v3, globalState)];
		v2, v1, v3, v12 := DC27(v0), if (f19 in v0) then v0[f19] else fm5(|v6|, globalState), v3 + v3, v12;
		var v13 := DC28(f19, v1);
		var v14: seq<int> := [-v1, v13.cf50, -v1 * |v3|, v1];
		v14 := (if (f19) then v14 else (v14[safeIndex(v1, |v14|) := |v3|])[safeIndex(v1, |v14[safeIndex(v1, |v14|) := |v3|]|) := |fm29(v4, 420, globalState)|] + v14)[safeIndex(v1, |(if (f19) then v14 else (v14[safeIndex(v1, |v14|) := |v3|])[safeIndex(v1, |v14[safeIndex(v1, |v14|) := |v3|]|) := |fm29(v4, 420, globalState)|] + v14)|) := v1];
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			globalState.f11, v1, globalState.f11, globalState.f17, globalState.f15 := f19 && f19, --(safeDivisionInt(v1, v1) + v1), !fm0(f19, 'l', f19, globalState) <== f19, f19, f19;
			var v17 := new C3();
			v0 := multiset{f19 <==> f19};
			var v18: array<bool> := new bool[11](i3 => f19);
			var v19: map<bool, int> := map[f19 := v1];
			var v20: map<int, bool> := map[if (f19 in v19) then v19[f19] else |v3[safeIndex(v1, |v3|) := v4]| := false];
			var v21: set<int> := {v1};
			var v22 := DC14(f19, v1, v21, v4);
			var v23: multiset<char> := multiset{v22.cf26};
			v18[safeIndex(304, v18.Length)] := if (|v23| in v20) then v20[|v23|] else f19;
			v18[safeIndex(304, v18.Length)] := fm4(f19, map[v3 := v19], v4, v1, globalState);
		}
		globalState.f17 := !f19;
		var v24 := DC24(v14);
		var v25: map<bool, D9> := map[f19 := DC26(v24)];
		var v26: array<map<bool, D9>> := new map<bool, D9>[8] [v25, v25, v25, v25, v25, v25, v25, v25 + v25];
		v26[safeIndex(181, v26.Length)] := v25;
		v26[safeIndex(181, v26.Length)] := v25;
	}
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool) {
		...
		if (if (f19) then if (f19 in v0) then v0[f19] else if (p1 in v0) then v0[p1] else f19 else p1) {
			...
			var v18: seq<int> := [v17[safeIndex(p0, |v17|)], p0, p0];
			...
			v21[safeIndex(336, v21.Length)] := v9;
			v21[safeIndex(336, v21.Length)] := v9;
			if (v1 < v1) {
				var v22: array<int> := new int[13];
				var v23: map<array<int>, int> := map[v22 := v17[safeIndex(-0x361, |v17|)]];
				v23 := v23[v22 := p0];
				var v24 := 0x2f;
				var v25: multiset<D10> := multiset{DC27(v14)};
				v24 := if (fm31(true, v18[safeIndex(-v24, |v18|)], globalState) in v25) then v25[fm31(true, v18[safeIndex(-v24, |v18|)], globalState)] else v24;
				...
				v32[safeIndex(259, v32.Length)] := v29;
				var v33 := DC14(f19, p0, fm18(v30.f23, |v17|, -0x335, globalState), v6);
				var v34: set<int> := {v17[safeIndex(v24, |v17|)]};
				var v35: set<set<int>> := {v33.cf25, {|v2|}, v34, v34, {v8.cf53, p0}};
				v24, v32[safeIndex(259, v32.Length)], globalState.f15 := p0, DC26(v31), !(v35 == v35);
				v22[safeIndex(933, v22.Length)] := safeDivisionInt(v24, |v1|);
				var v36: multiset<char> := multiset{'u'};
				var v37 := DC13(-|v2|);
				var v38: map<D4, int> := map[v37 := -v24];
				globalState.f17, globalState.f17, v22[safeIndex(933, v22.Length)] := v30.f23 || (v36 < v36), v30.f23, if (v37 in v38) then v38[v37] else v24;
			} else {
				...
				v41[safeIndex(987, v41.Length)] := v43 !in v44.cf55;
				var v45 := 0x243;
				var v46: array<int> := new int[8](i0 => safeModuloInt(i0, v45));
				var v47 := DC11(map[f19 := |"l"|], -v45, v46);
				v17, v41[safeIndex(987, v41.Length)], v45 := v17, v1[safeIndex(v47.cf19, |v1|)], p0;
				var v48: set<int> := {v45};
				v45 := |(v48 - v48)|;
				v45 := v45 * |(if (!p1) then v2 else seq(abs(0x10f), i1  => (v6)))|;
				globalState.f17 := !v41[safeIndex(987, v41.Length)];
				var v49 := new C2(v42, v41[safeIndex(987, v41.Length)]);
			}
			
			if ((v2 + fm16(f19, p0, globalState)) <= v2) {
				var v50: array<int> := new int[7](i2 => i2 - -0x139);
				v50[safeIndex(241, v50.Length)] := |(seq(abs(0x272), i3  => (v6)))|;
				v50[safeIndex(1, v50.Length)] := |v2|;
				var v51 := -819;
				var v52: set<int> := {p0, p0};
				var v53: map<char, bool> := map[v6 := f19];
				v50[safeIndex(241, v50.Length)], v2, v50[safeIndex(1, v50.Length)], v51 := |v0|, v2 + fm16(fm0(f19, v6, f19, globalState), p0, globalState), p0, safeDivisionInt(|v52| + v51, |(v53 + map[v6 := !!!p1])|);
				v50[safeIndex(241, v50.Length)] := if (v51 <= v50[safeIndex(241, v50.Length)]) then v51 else fm5(p0, globalState);
				v50 := new int[9];
				var v54 := DC5("iteqm", p0, v50[safeIndex(241, v50.Length)]);
				...
				v56 := fm32(p1, -safeDivisionInt(|v57|, 0x389), v50[safeIndex(241, v50.Length)], fm0(!f19, v58.cf26, p1, globalState), globalState);
			} else {
				var v59 := -0x87;
				v59 := p0;
				var v60: set<int> := {v59};
				...
				v64, v59, globalState.f17 := [v63, v63, v63, v63, v63], |(if (f19) then "je" + v2 else seq(abs(816), i4  => ('m')))|, if (p1) then v1[safeIndex(v17[safeIndex(if (v65 in v66) then v66[v65] else v59, |v17|)], |v1|)] else p1;
				v59 := if (v2 != (seq(abs(26), i5  => (v6)))) then |(v0 + map[f19 := true])| else -108;
			...
			var v86: C3 := new C3();
			var v87: seq<D8> := [v83, DC23((fm23(v84[safeIndex(-p0, |v84|)], ((map[v79.f21 := |v76|])[v79.f21 := |v85|])[!v79.f21 := p0], -|map[p0 := v86]|, v72, globalState))[-748 := abs(p0)]), DC23(v82), v83];
		...
		var v95: seq<int> := [|[p1]|];
		var v96: seq<int> := [p0 * v90, p0, v92.cf56, if (v93[safeIndex(if (f19 in v94) then v94[f19] else 0x24d, |v93|)]) then p0 else v90, |((seq(abs(0x185), i6  => (v90))) + v95)|];
		var v97: array<seq<bool>> := new seq<bool>[2] [v93, v93];
		var v98 := DC3(v97);
		var v99: multiset<D1> := multiset{v98};
		var v100: map<int, multiset<D1>> := map[p0 := v99];
		var v101: map<map<int, multiset<D1>>, int> := map[v100 := safeDivisionInt(p0, v90)];
		var v102: map<bool, array<bool>> := map[-p0 != |[|{p1, p1}|, v90]| := v91];
		var v103: map<int, seq<int>> := map[|v94| := v95];
		v89, v90, v91, r0, v96 := v89, if (v100 in v101) then v101[v100] else p0, if (f19 in v102) then v102[f19] else v91, p1, (if (v90 in v103) then v103[v90] else v96) + (seq(abs(0x38a), i7  => (p0)));
		var v104: seq<map<bool, bool>> := [v0, v0 + v0];
		var v105 := DC36([v0]);
		v104 := (if (p0 > p0) then v105.cf63 else seq(abs(31), i8  => (v0)))[safeIndex(v90 + -v90, |(if (p0 > p0) then v105.cf63 else seq(abs(31), i8  => (v0)))|) := v0];
		var v106 := DC1(f19);
		...
		v110 := v111.cf71;
		var i9 := 0;
		while (safeModuloInt(p0, v90) !in map[v90 := v90])
			decreases 100 - i9
		{
			if (i9 >= 100) {
				break;
			...
			v112 := v112[v113[safeIndex(0xe, |v113|)] := v89];
			globalState.f17, v107 := v107.f21 <== false, v107;
			v108[safeIndex(762, v108.Length)] := p0;
			v91[safeIndex(26, v91.Length)] := p1;
			var v114: set<char> := {v89, v89, v89};
			v108[safeIndex(762, v108.Length)], v91[safeIndex(26, v91.Length)] := if (!(v114 >= v114)) then p0 else |("lxxgp" + v113)[safeIndex(p0, |("lxxgp" + v113)|) := v89]|, f19;
			v90 := |(v113 + v113)|;
		}
		r0 := v107.f20.cf1;
	}
...
class C5 {
	...
	method m0(p0: set<int>, p1: set<string>, globalState: GlobalState) returns (r0: int) {
		...
		if (v1 < v1) {
			...
			var v5 := "bnr";
			v4[safeIndex(378, v4.Length)] := DC5(v5, f18, f18);
			var v6: seq<int> := [797];
			v4[safeIndex(378, v4.Length)], v0, globalState.f15, globalState.f11 := fm1(f18, globalState), multiset(v6) > multiset{f18}, p0 !! p0, v1[safeIndex(f18 * |v6|, |v1|)];
			var v7: map<int, int> := map[f18 := f18];
			v7 := v7[f18 := 0xa6 - f18];
			var v8: array<bool> := new bool[11];
			var v9 := DC6(f18, safeDivisionInt(f18, f18));
			var v10 := DC1(v0);
			var v11 := DC2(v10);
			...
			if (!(v12 != v12)) {
				...
				var v16: multiset<int> := multiset{|(seq(abs(228), i2  => (v5[safeIndex(855, |v5|)])))|};
				var v17: array<int> := new int[23] [f18, f18, safeDivisionInt(|v13[safeIndex(f18, |v13|)]|, |v14|), |p0|, f18 + f18, f18, f18, safeDivisionInt(|v6|, -0x230), 0x367, -f18, 231, -f18 * f18, if (v0 in v15) then v15[v0] else f18, -f18, f18, |(v16[|v7| := abs(655)] * v16)|, f18, f18, fm3(v6[safeIndex(f18, |v6|)], f18, v0, globalState), fm3(f18, f18, v0, globalState) * f18, f18, f18, |v5|];
				var v18 := 'j';
				var v19: multiset<seq<char>> := multiset{v5, [v18]};
				v17[safeIndex(560, v17.Length)] := (if (v5 in v19) then v19[v5] else f18) + f18;
				v8[safeIndex(115, v8.Length)] := v0;
				var v20 := DC1(v0);
				v17[safeIndex(560, v17.Length)], v8[safeIndex(115, v8.Length)], v20 := -f18, v0, v20;
				globalState.f11 := (if (v0) then v1 else [true, v0]) == v1;
				var v21 := new C0(v0);
				v5 := v5 + v5;
				var v22: T1 := new C2(DC1(v0), if (v21.f23) then v8[safeIndex(115, v8.Length)] else v8[safeIndex(115, v8.Length)]);
				v22 := new C4(v8[safeIndex(115, v8.Length)]);
			} else {
			...
			if (v0) {
				...
				v27[safeIndex(67, v27.Length)] := v0;
				v26, v27[safeIndex(67, v27.Length)] := 'o', !v0;
				r0 := f18;
				r0 := f18;
				v26 := v26;
				var v28: map<int, int> := map[safeModuloInt(f18, f18) := -f18];
				var v29: array<char> := new char[18](i4 => DC14(v0, f18, p0, v26).cf26);
				var v30: seq<array<char>> := [v29, v29];
				v28 := v28[safeModuloInt(f18, |v30|) := f18];
			} else {
				var v31 := "xm";
				var v32: array<bool> := new bool[5] [v0, v0, v0, v31 < (seq(abs(0x21e), i5  => ('j'))), v0 <== v1[safeIndex(-f18, |v1|)]];
				v32[safeIndex(131, v32.Length)] := v0;
				v32[safeIndex(131, v32.Length)] := true;
				var v33: multiset<int> := multiset{f18};
				var v34 := DC7(v33);
				var v35: seq<D2> := [v34, v34, v34, v34];
				v32[safeIndex(131, v32.Length)] := (seq(abs(0x95), i6  => (DC7(multiset{f18})))) <= v35;
				r0 := -|(v31 + v31)|;
				var v36: map<int, int> := map[f18 := f18];
				var v37: array<int> := new int[14] [|(v31 + "kkptvhk")|, f18, f18, |v36|, f18, f18, |v31| * 0x97, f18 * f18, |v36|, 0x1c5, |"ddlyqlq"|, f18, safeModuloInt(f18, f18), f18];
				v37[safeIndex(152, v37.Length)] := f18;
				v37[safeIndex(152, v37.Length)] := 476;
				var v38: map<bool, int> := map[v32[safeIndex(131, v32.Length)] := -0x222];
			...
			r0 := safeDivisionInt(fm5(|DC27(v40).cf48|, globalState), f18);
			var v41 := "datkd";
			v41 := v41 + v41;
			...
			v54[safeIndex(546, v54.Length)] := 611;
			v54[safeIndex(546, v54.Length)] := f18;
		}
		...
		var v60: map<bool, int> := map[v1[safeIndex(f18, |v1|)] := f18];
		var v61: multiset<bool> := multiset{v0};
		var v62: set<multiset<bool>> := {v61, v61};
		var v63: array<int> := new int[23] [|(seq(abs(0x300), i7  => ('u')))|, f18, |v55|, f18, 0x132, f18, f18, f18, -f18, f18, |v56[f18 := f18]|, f18, f18, -|v59|, if (false in v60) then v60[false] else f18, -|v62|, f18, f18, f18, |v55|, -f18, f18, f18];
			...
			decreases 100 - i8
		{
			...
			match (DC9(v66)) {
				case DC10(cf17) =>
					...
					v67 := v67;
					v67[safeIndex(40, v67.Length)] := v0;
					var v68: array<string> := new seq<char>[11] [seq(abs(0x1fc), i9  => (v58)), v55, "mk", v55, v55, v55, "qpit", v55, v55, v55[safeIndex(cf17, |v55|) := v58], v55];
					...
					v69[safeIndex(274, v69.Length)] := v68;
					v67[safeIndex(40, v67.Length)], v69[safeIndex(274, v69.Length)] := v1[safeIndex(safeDivisionInt(f18, f18), |v1|)], v68;
					v56 := v56[cf17 := |v55|];
				case DC11(cf18, cf19, cf20) =>
				...
				case DC9(cf16) =>
					...
					v73[safeIndex(333, v73.Length)] := v72;
					v73[safeIndex(333, v73.Length)] := v72;
					globalState.f15 := if (v0) then v0 else v0;
					v63[safeIndex(498, v63.Length)] := -|(v55 + v55)|;
					v63[safeIndex(498, v63.Length)] := safeModuloInt(f18, f18);
			}
			...
			v76[safeIndex(698, v76.Length)] := v77;
			var v78: map<bool, char> := map[v0 := v58];
			v75, v0, r0, v76[safeIndex(698, v76.Length)] := v75 + map[f18 := v74], fm16(fm0(v0, if (v77.f19 in v78) then v78[v77.f19] else v58, v77.f19, globalState), f18, globalState) < (seq(abs(0x1b0), i10  => (v58))), -f18, v77;
			var v79: map<D4, bool> := map[DC13(f18) := v0];
			globalState.f15 := !(|v79| !in (p0 + p0));
		}
		forall i11 | 0 <= i11 < v63.Length {
			v63[i11] := safeModuloInt(i11, DC30(false, f18, v0).cf53);
		}
		v55 := "up" + "calngaa";
		globalState.f17 := !v0 ==> v0;
		r0 := safeModuloInt(-f18, -safeDivisionInt(f18, f18));
	}
}
...
function fm5(p0: int, globalState: GlobalState): int {
	match DC2(DC2(DC2(DC2(DC1(true))))) {
		...
		case DC0(cf0) => --|(seq(abs(0x5f), i0  => ('c')))|
		case DC2(cf2) => -|([!false] + [false])|
	}
}
function fm9(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
	(if (true) then -|"rch"| else -|multiset{true}|) - |({|map[161 := false]|, 0xf0, |map[false := |{!true, false}|]|} + {|{|"xpetoj"|, |(seq(abs(0xd8), i0  => ('o')))|}|, 0x5a})|
}
function fm10(globalState: GlobalState): map<int, int> {
	((map v0 : int | (0x183 <= v0) && (v0 < 0x1dc) :: (v0 * 853) := (|(seq(abs(0x2f6), i0  => ('v')))|)) + map[-|(seq(abs(0xbb), i1  => ('a')))| := 784]) + (map[0x23c := |[0xf9]|] + map[|[true]| := |"bkuqdvcwu"|])
}
...
function fm13(p0: int, p1: int, globalState: GlobalState): seq<seq<int>> {
	[(seq(abs(-0x3bb), i0  => (372))) + DC24([|[|[true]|, |"tqeuo"|]|, |multiset{true}|, |map[|multiset{true}| := |{0x1c8, |{|"dst"|, --802, 0x24b}|}|]|]).cf42, [|multiset{true}|, |{|[-0x22d, -0x3a6]|, 0x32b, -|{-0x264, |[false]|}|}|, -|"wggx"|, |"d"|]]
}
...
function fm21(globalState: GlobalState): D1 {
	DC5("b" + (seq(abs(0x20c), i0  => ('e'))), |("xqjjx" + "uvlppdqpi")|, -|multiset{true}| * |[0x2c8, -|map[0x363 := |map[|(seq(abs(513), i1  => ('h')))| := 'u']|]|, |(map v0 : int | v0 in multiset{|[!true]|} :: (v0 * |map[false := "wcolpleqj"]|) := (!true))|, |[false, !false]|]|)
}
...
function fm23(p0: bool, p1: map<bool, int>, p2: int, p3: char, globalState: GlobalState): multiset<int> {
	multiset{-|[|(seq(abs(-0x142), i0  => ('q')))|, 119, 0x17e, 0x3ca, |map[multiset{|[[false]]|} := false]|]|} - multiset{|map[-0x1d1 := false]|, -0x2dd, 919}
}
function fm24(p0: bool, p1: int, globalState: GlobalState): map<bool, int> {
	if ((map v0 : int | v0 in {|map[true := |{'n'}|]|, |map[|multiset{|"fgnsevrhf"|, 120}| := true]|} :: (safeDivisionInt(v0, -0x33)) := (|"uw"|)) != map[-0x357 := |{map[0xdd := -|(map v1 : map<bool, int> | v1 in multiset{map[false := 0x30f]} :: (v1) := (|[0x16d]|))|], map[535 := |[false]|]}|]) then map[false := 437] + map[false := |[0x311]|] else map[false := -|"eceq"|] + map[true := |[|(map v2 : int | (0x305 <= v2) && (v2 < 0x11b) :: (safeDivisionInt(v2, |[!false, true]|)) := (true))|, 0x219]|]
}
...
function fm34(p0: int, p1: int, p2: bool, globalState: GlobalState): set<seq<bool>> {
	{[false, true, true, false], [true, false], [!true]} * (set v0 : seq<bool> | v0 in (seq(abs(0x261), i0  => ([false, false, !false]))) :: (v0))
}
method m9(p0: bool, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
	var v0 := "dcrcctt";
	var v1 := -0x394;
	var v2: map<string, char> := map[v0 := fm12(v1, seq(abs(0xff), i1  => ('d')), v0, globalState)];
	var v3: seq<bool> := [p1];
	var v4: set<bool> := {v3[safeIndex(0x36b, |v3|)], p1, p1};
	for i0 := |v2| to |v4| {
		globalState.f17 := p1;
		var v5: seq<seq<bool>> := [([p1])[safeIndex(v1, |[p1]|) := p0], v3];
		if (!!((p1 <== false) !in v5[safeIndex(v1, |v5|)])) {
			var v6 := DC1(p0);
			var v7 := new C2(v6, p1);
			var v8 := new C5(i0);
			v0 := v0;
			...
			var v10 := 'e';
			var v11: array<bool> := new bool[25] [false, false, v7.f21, v7.f21, p1, !v3[safeIndex(i0, |v3|)], p0, v7.f21, v7.f21, false, v7.f21, false, p1, p1, p0, p1, p0, v7.f21, p0, v7.f21, true, fm0(p1, v10, v7.f21, globalState), p0, v7.f21, p0];
			...
			v16[safeIndex(645, v16.Length)] := v0 + v0;
			var v17 := DC1(p1);
			...
			var v22: set<int> := {v1};
			v16[safeIndex(645, v16.Length)], globalState.f17, globalState.f11, globalState.f15 := if (v0 in v21) then v21[v0] else v0, v18.f21, v18.f21, v22 >= (v22 + v22);
			var v23: map<bool, bool> := map[p1 := false];
			var v24: map<bool, map<bool, bool>> := map[p0 := v23];
			v24 := v24;
			r2, r2 := fm3(safeDivisionInt(i0, v1), |(seq(abs(0x94), i5  => ('e')))| - v1, p0, globalState), i0;
			var v25 := new C4(v18.f21);
			var v26 := v18.m5(p0 && false, v3, globalState);
		}
		
		v1 := safeModuloInt(-352, |[i0]|);
		var v27: array<bool> := new bool[3](i6 => p1);
		v27[safeIndex(689, v27.Length)] := p0;
		v27[safeIndex(689, v27.Length)] := p0;
	}
	...
	if ((multiset{p0} * v28) >= v28) {
		...
		v34[safeIndex(361, v34.Length)] := v36;
		globalState.f17, globalState.f11, v34[safeIndex(361, v34.Length)] := v1 > (if (true) then |"gvcj"| else -v1), 0x1ad != v1, v36;
		var v37 := DC34();
		match (if (v32.f23) then v37 else v37) {
			...
			case DC33(cf57, cf58, cf59, cf60, cf61) =>
				...
				var v52: map<int, int> := map[|fm27(cf57, cf57, |v47[safeIndex(|v51|, |v47|)]|, globalState)| := 533];
				...
				var v58: seq<int> := [949];
				var v59: array<int> := new int[26] [v32.fm14(|v53|, globalState), cf57, v1, cf57, v1, v54.cf37, cf57, safeDivisionInt(v1, v1), if (v32.f23) then v1 else v1, cf57, cf57, DC14(p0, v1, v56, v44).cf24, cf57, cf57, v1, cf57, |(if (v49.f21) then "kuj" else v0)|, 12, |(v57[v55 := abs(|v58|)] + v57)|, -|v28|, v1, |v0|, cf57, cf57, -cf57, v1];
				var v60: map<int, array<int>> := map[cf57 + v1 := v59];
				r2, v59 := v1, if (-safeDivisionInt(cf57, cf57) in v60) then v60[-safeDivisionInt(cf57, cf57)] else v59;
			case DC34() =>
				...
				var v66: seq<int> := [v1];
				var v67: seq<seq<int>> := [(seq(abs(0x201), i8  => (-|[map[p1 := v32.f23]]|)))[safeIndex(v1, |(seq(abs(0x201), i8  => (-|[map[p1 := v32.f23]]|)))|) := v1], v66, v66];
				var v68: multiset<seq<int>> := multiset{v67[safeIndex(v1, |v67|)], v66};
				v68 := (v68 + v68) - (multiset{seq(abs(648), i9  => (v1))} + v68);
				var v69: array<bool> := new bool[25](i10 => v32.f23 || v32.f23);
				v69[safeIndex(922, v69.Length)] := v32.f23;
				var v70: set<seq<bool>> := {v3};
				v35, v69[safeIndex(922, v69.Length)], globalState.f11 := v35, v70 >= fm34(v66[safeIndex(v1, |v66|)], v1, true, globalState), p0;
				var v71 := DC33(v1, false, v30, p1, p0);
				v1 := v71.cf57;
			case DC31(cf55) =>
				var v72: array<int> := new int[22](i11 => safeDivisionInt(i11, v1));
			...
			case DC35(cf62) =>
				...
				v82 := v82[v32.f23 := -safeModuloInt(v1, v1)];
		}
		
		globalState.f11 := p1;
	} else {
		var v83: array<bool> := new bool[8];
		v83[safeIndex(434, v83.Length)] := p1;
		v83[safeIndex(434, v83.Length)] := !(v1 < v1);
		v83[safeIndex(434, v83.Length)] := v83[safeIndex(434, v83.Length)];
		var v84: seq<string> := [v0, v0, v0, v0];
		var v85: seq<seq<string>> := [v84];
		v84 := v85[safeIndex(|v0|, |v85|)];
		var v86: seq<int> := [-v1, 0x100, |v0|, v1];
		globalState.f11 := (fm19([v1], p1, globalState))[safeIndex(v1, |fm19([v1], p1, globalState)|) := v1] == v86;
	...
	var v90 := DC38(fm12(-0xf8, seq(abs(-0x3af), i12  => ('u')), v0, globalState), p0, -v1, v89);
	var v91: C1 := new C1(v90.cf69);
	v88[safeIndex(771, v88.Length)] := v91;
	v88[safeIndex(771, v88.Length)] := v91;
...
method Main() {
	...
	var globalState := new GlobalState('x', v1[safeIndex(v2, |v1|) := v0], v4, false, v1 + [v0], 'e', -0x343, false, if (v5.cf1) then v6 else v6, false, true, false, v7, true, -305, true, v1 + v1, false);
	var v8 := 'c';
	if (fm0(v0, v8, v0, globalState)) {
		var v9: map<bool, bool> := map[false := v0];
		var v10: seq<int> := [v2];
		var v11 := DC0(v0);
		var v12: array<bool> := new bool[15] [v1[safeIndex(470, |v1|)], v0, v0, false, false, v0, v0 <== v0, v0, true in v9, v0, v0, v10 < v10, v0, DC1(v11.cf0).cf1, v0];
		v12[safeIndex(513, v12.Length)] := v0;
		v12[safeIndex(513, v12.Length)] := v0;
		v6, v2 := seq(abs(0x33d), i0  => (v8)), -0x394;
		v12[safeIndex(513, v12.Length)] := v0 || v12[safeIndex(513, v12.Length)];
		var v13 := new C3();
		var v14 := DC20(v0, v2, v0);
		var v15: T0 := new C2(v5, v14.cf36);
		var v16: array<array<bool>> := new array<bool>[9];
		v16[safeIndex(31, v16.Length)] := if (v0) then v12 else v12;
		var v17: array<T1> := new T1[8];
		var v18: T1 := new C4(v12[safeIndex(513, v12.Length)]);
		v17[safeIndex(74, v17.Length)] := v18;
		var v19: seq<T0> := [v15, v15, v15];
		v12, v15, v16[safeIndex(31, v16.Length)], globalState.f17, v17[safeIndex(74, v17.Length)] := v12, v19[safeIndex(v2, |v19|)], v12, v0, v18;
	} else {
		var v20: array<char> := new char[13](i1 => v8);
		v20[safeIndex(872, v20.Length)] := v8;
		v20[safeIndex(872, v20.Length)] := v8;
		var v21: map<bool, int> := map[v0 := -v2];
		var v22 := DC38(v20[safeIndex(872, v20.Length)], |v21| > |(seq(abs(191), i2  => (v8)))[safeIndex(701, |(seq(abs(191), i2  => (v8)))|) := v20[safeIndex(872, v20.Length)]]|, v2 * -v2, v3);
		v22 := v22;
		var v23: seq<int> := [v2 - |v21|, v2 - 0x199, safeModuloInt(v2, v2), v2 - fm9(v2, v2, false, globalState)];
		v23 := v23 + ((seq(abs(963), i3  => (v2))) + [v2]);
		var v24: set<int> := {|(v6 + v6)[safeIndex(v2, |(v6 + v6)|) := v20[safeIndex(872, v20.Length)]]|, v2, |v23| * v2, v2, DC11(v21, v2, v3).cf19};
		var v25: seq<set<int>> := [v24];
		v24 := v25[safeIndex(v2, |v25|)];
		...
		match (v28) {
			case DC41(cf72, cf73, cf74) =>
				...
				var v31 := DC14(cf72.f21, v2, set v30 : int | (0x25a <= v30) && (v30 < 0x9e) :: (v30 + v2), v20[safeIndex(872, v20.Length)]);
				var v32 := DC28(v26.f21, |v21|);
				var v33: map<bool, bool> := map[v32.cf49 := v26.f21];
				var v34: map<bool, bool> := map[cf72.f21 := if (fm0(v26.f21, v20[safeIndex(872, v20.Length)], v26.f21, globalState) in v33) then v33[fm0(v26.f21, v20[safeIndex(872, v20.Length)], v26.f21, globalState)] else !v26.f21];
				...
				v29[safeIndex(199, v29.Length)] := v36;
				v29[safeIndex(199, v29.Length)] := v36;
				var v37 := DC10(v2);
			...
			case DC40(cf71) =>
				...
				v44 := v44;
				var v45, v46, v47, v48 := v26.m6(v2, (seq(abs(-0x1d1), i6  => (v8))) + v6, if (v26.f21) then v26.f21 else v26.f21, globalState);
				v3[safeIndex(272, v3.Length)] := v2;
				v3[safeIndex(272, v3.Length)] := v2;
		}
	...
	var v54: seq<int> := [v2];
	for i7 := -|v53| to v54[safeIndex(0x1a9, |v54|)] {
		...
		if (v60 < (v60 + v60)) {
			...
			v64[safeIndex(843, v64.Length)] := v62;
			v64[safeIndex(843, v64.Length)] := v62;
			var v65 := new C0(fm0(v0, v8, v57, globalState));
			var v66: map<multiset<bool>, string> := map[v52 := v6];
			var v67, v68, v69 := m9(v65.fm15(v56, v57, -v58, v62, globalState), (if (multiset{!v57} in v66) then v66[multiset{!v57}] else v6)[safeIndex(i7, |(if (multiset{!v57} in v66) then v66[multiset{!v57}] else v6)|) := v8] <= v6, globalState);
			v3[safeIndex(885, v3.Length)] := v58 * v58;
			v3[safeIndex(885, v3.Length)] := v2;
			var v70, v71, v72 := m9(v65.f23, v6 <= v6, globalState);
		} else {
			v2 := i7 + safeDivisionInt(0x369, i7);
			v0 := true;
	...
	if (v77.fm15(v0, v0, v2, v79, globalState)) {
		...
		v80[safeIndex(593, v80.Length)] := v8;
		v80[safeIndex(593, v80.Length)] := v8;
		var v81 := new C2(v5, v77.f23);
		var v82, v83, v84, v85 := v81.m6(safeDivisionInt(v2, v2), v6, v77.f23, globalState);
		var v86: map<char, int> := map['o' := -v2];
		if ((v8 in v86) || (v83 || v82)) {
			var v87 := DC34();
			var v88: map<D12, C0> := map[v87 := v77];
			v88 := v88[v87 := v77];
			var v89: set<seq<int>> := {v54, seq(abs(-0xa0), i9  => (v2))};
			var v90: seq<set<seq<int>>> := [v89, v89, v89];
			globalState.f17 := v89 < v90[safeIndex(v2, |v90|)];
			v2 := |map[v80[safeIndex(593, v80.Length)] := v52]|;
			var v91: array<array<multiset<int>>> := new array<multiset<int>>[4];
			var v92: multiset<int> := multiset{v2, v2};
			var v93: seq<seq<int>> := [v54];
			var v94 := DC23(v92);
			var v95: array<multiset<int>> := new multiset<int>[5] [v92, multiset(v93[safeIndex(v2, |v93|)]), (v94.(cf41 := v92)).cf41, v92, v92];
			v91[safeIndex(556, v91.Length)] := v95;
			v91[safeIndex(556, v91.Length)] := v95;
			globalState.f15 := v82;
		} else {
		...
		var v112, v113, v114, v115 := v81.m6(|v111|, seq(abs(-0x3aa), i10  => ('g')), v81.f21, globalState);
	} else {
		...
		v0 := v77.f23;
		v3[safeIndex(480, v3.Length)] := v2;
		v3[safeIndex(480, v3.Length)] := v2;
	}
	
	var v118, v119, v120 := m9(v0, v0, globalState);
	var v121: map<bool, bool> := map[true := v118];
	var v122 := DC36(([v121, v121, v121, v121, v121])[safeIndex(v2, |[v121, v121, v121, v121, v121]|) := v121]);
	v8 := match v122 {
	...
	for i11 := v120 to v2 {
		...
		v123[safeIndex(581, v123.Length)] := if (v2 in v125) then v125[v2] else v124;
		var v126: seq<C2> := [v124, v124, v124, v124];
		v123[safeIndex(581, v123.Length)] := v126[safeIndex(i11, |v126|)];
		var v127: seq<D13> := [v122];
		var v128: seq<seq<D13>> := [v127];
		if (((seq(abs(0x70), i12  => (seq(abs(0x358), i13  => (v122))))) + v128) <= v128) {
			v0 := true || v118;
			var v129: set<int> := {v2};
			v129 := {|v6|} * v129;
			v120 := 371;
			var v130, v131, v132, v133 := v124.m6(safeDivisionInt(|v6|, |v79|), v6 + "cqmm", v77.f23, globalState);
			var v134 := DC24(seq(abs(-737), i14  => (v120)));
			v54 := v134.cf42;
		} else {
			var v135, v136, v137 := m9(v124.f21, v77.f23, globalState);
			v6 := v6[safeIndex(-v137, |v6|) := v8];
			var v138: set<string> := {v6, seq(abs(-0x1b2), i15  => (v8))};
			v120 := if (v77.f23) then i11 else safeModuloInt(|v138|, v2);
		...
		match (v142.(cf55 := v141)) {
			case DC32(cf56) =>
				...
				var v151 := new C1(v3);
			case DC33(cf57, cf58, cf59, cf60, cf61) =>
				var v152: map<seq<char>, bool> := map[seq(abs(0x2d7), i16  => (v8)) := false];
				cf57 := safeDivisionInt(-fm3(-0x25c, v120, !(if (v6 in v152) then v152[v6] else false), globalState), v2);
			...
			case DC34() =>
				...
				var v158: array<char> := new char[26] [v8, if (!true) then v6[safeIndex(|v156|, |v6|)] else v8, v8, v8, v8, v157.cf66, v8, v8, v8, v8, v8, v8, v8, v8, v6[safeIndex(i11, |v6|)], v8, v8, v8, v8, v8, fm12(v120, v6, v6, globalState), v8, v8, v8, v8, fm12(|v1|, v6, seq(abs(454), i17  => (v8)), globalState)];
				v158[safeIndex(147, v158.Length)] := v8;
				v155, v156, v2, v120, v158[safeIndex(147, v158.Length)] := v155, v156, v120, v2, v8;
				v3[safeIndex(463, v3.Length)] := v2;
				var v159: multiset<int> := multiset{safeDivisionInt(i11, |v154|)};
				v3[safeIndex(463, v3.Length)] := |v159|;
				var v160: map<bool, seq<bool>> := map[true := v1];
				var v161: seq<seq<bool>> := [if (true in v160) then v160[true] else v1];
				v3[safeIndex(463, v3.Length)] := v2 + |v161[safeIndex(fm5(v120, globalState), |v161|)]|;
			case DC31(cf55) =>
				var v162, v163 := v140.m1(v124.f21, |v6|, !v118, safeModuloInt(if (v118 in v79) then v79[v118] else -122, -560), globalState);
			...
			case DC35(cf62) =>
				...
				var v168: array<T1> := new T1[27] [v140, DC42(v140).cf75, v140, v166.cf75, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v140, v167[safeIndex(|fm19(v54, v77.f23, globalState)|, |v167|)], v140, v140];
				v168[safeIndex(995, v168.Length)] := v140;
				var v169: seq<string> := ["tetmmpkc", v6, v6];
				v165, v168[safeIndex(995, v168.Length)], v6 := v165, v140, v169[safeIndex(v120, |v169|)];
		}
	...
	for i20 := v77.fm14(|map[v171 := v120]|, globalState) * -v120 to (if (v77.f23 in v79) then v79[v77.f23] else v2) - v120 {
		...
		match (v172) {
			case DC28(cf49, cf50) =>
				...
				v0 := v77.fm15(v176 <= (if (v2 in v177) then v177[v2] else v176), v119, safeDivisionInt(|v179|, v120), v79, globalState);
				v119 := cf49;
				var v180 := new C5(i20);
			case DC27(cf48) =>
				v170[safeIndex(421, v170.Length)] := true;
				v170[safeIndex(421, v170.Length)] := v119;
				v7 := v7[v120 := |v6|];
				v120 := v2;
				var v181: array<bool> := new bool[2](i21 => v0);
				var v182 := DC4(-v120, v77.f23, v181);
				var v183: seq<seq<bool>> := [v1, v1, [false, v119]];
				globalState.f11, v119, globalState.f11, v2 := v77.f23, v120 == v182.cf4, v119, safeDivisionInt(v2, v120) - safeModuloInt(v120, |v183[safeIndex(i20, |v183|)]|);
		}
		
		var v184 := new C1(v3);
		v184.f22[safeIndex(974, v184.f22.Length)] := v120;
		v184.f22[safeIndex(974, v184.f22.Length)] := v120;
	}
	for i22 := v120 to v2 {
		...
		v7 := v7[safeDivisionInt(|"bmdrnblv"|, v187) := v2];
	}
	...
	v6, v192, v193 := v6[safeIndex(v192 - |v54[safeIndex(v192, |v54|) := if (v170 in v194) then v194[v170] else v2]|, |v6|) := 'w'], |(v195 + v195)|, v193;
	globalState.f1 := [true];
	var v196 := new C1(v3);
	print v0, "\n";
	print v1 == [true, true], "\n";
	print v2, "\n";
	print v5.cf1, "\n";
	print v6 == ['w', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c'], "\n";
	print v7 == map[644 := 644], "\n";
	print globalState.f0, "\n";
	print globalState.f1 == [true], "\n";
	print globalState.f3, "\n";
	print globalState.f4 == [true, true, true], "\n";
	...
	print globalState.f12 == map[644 := 644], "\n";
	print globalState.f13, "\n";
	print globalState.f14, "\n";
	print globalState.f15, "\n";
	print globalState.f16 == [true, true, true, true], "\n";
	print globalState.f17, "\n";
	print v8, "\n";
	print |v51|, "\n";
	print v52 == multiset{false, true}, "\n";
	print v53 == [DC27(multiset{false, true})], "\n";
	print v54 == [-916], "\n";
	print v77.f23, "\n";
	print |v78|, "\n";
	print v79 == map[true := -916], "\n";
	print v118, "\n";
	print v119, "\n";
	print v120, "\n";
	print v121 == map[true := false], "\n";
	print v122.cf63 == [map[true := true], map[true := true], map[true := true], map[true := true], map[true := true]], "\n";
	print v170[0], "\n";
	print v170[1], "\n";
	print v170[2], "\n";
	print v170[3], "\n";
	...
	print v170[26], "\n";
	print v170[27], "\n";
	print v171 == map[1 := true], "\n";
	print v190, "\n";
	print v191, "\n";
	print v192, "\n";
	print v193.f19, "\n";
	print |v194|, "\n";
	print v195 == multiset{1}, "\n";
}