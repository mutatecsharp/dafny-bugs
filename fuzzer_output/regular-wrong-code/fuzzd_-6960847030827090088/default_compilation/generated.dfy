...
function fm9(p0: int, p1: bool, globalState: GlobalState): bool {
	multiset((seq(0xcc, i0  => (-|"d"|))) + [-0x143]) !! (multiset{|[-|[|"ytyc"|]|, 0x2e9]|} - multiset{|multiset{true, true, false, true}|, 849})
}
...
function fm17(p0: int, p1: int, p2: int, globalState: GlobalState): set<map<bool, int>> {
	{map[false := |"u"|], map[false := |(seq(0x3e6, i0  => (|[486, 192]|)))|]} + {map[false := |"afxoea"|], map[true := 0x2b7], map[true := 562], map[false := 0xfb]}
}
...
function fm20(p0: int, p1: bool, globalState: GlobalState): D7 {
	DC18(false, 961 + |(seq(425, i0  => ('i')))|, |"ov"| < |(map v0 : int | v0 in [|map[true := true]|, -0x322] :: (v0 + --362) := (true))|)
}
...
function fm25(globalState: GlobalState): multiset<int> {
	(multiset{|multiset{-0x3c, 0x239, |[false, true]|}|} - multiset{|{false}|}) - (multiset{|{-0xf, -750}|, 478, |map[|[false, false]| := true]|, |map[false := |"rupuths"|]|} - multiset{0x29a, |[false, !false, true]|, |(seq(31, i0  => ('v')))|, 0xb3})
}
...
function fm28(p0: int, p1: bool, globalState: GlobalState): seq<int> {
	(if (false) then [|"rlxqec"|] else [0x8c, |map[false := false]|]) + (if (false) then seq(-0x1b8, i0  => (|(set v0 : int | (0x3a1 <= v0) && (v0 < 0x2ba) :: (v0 / |"ao"|))|)) else seq(877, i1  => (-260)))
}
...
function fm30(p0: int, p1: int, p2: bool, p3: char, globalState: GlobalState): map<int, int> {
	map[0x228 := 730] + map[0x199 := |(seq(676, i0  => (|"w"|)))|]
}
...
function fm34(globalState: GlobalState): multiset<bool> {
	multiset{[true] < [true], true, true && true, -685 != |multiset([false])|, {|(seq(0xd6, i0  => (-|"erehpu"|)))|} <= {-904}}
}
...
function fm38(p0: int, globalState: GlobalState): seq<int> {
	[|{false}|] + (DC11(seq(0x35f, i0  => (0xd5))).cf17 + [|[|"t"|, 0x22f]|])
}
...
function fm47(p0: int, globalState: GlobalState): multiset<map<int, bool>> {
	multiset(((seq(593, i0  => (map[|(seq(0x136, i1  => ('x')))| := true]))) + [map[-0x380 := true], map[-0x178 := true]]) + ([map v0 : int | (0x3a3 <= v0) && (v0 < 400) :: (v0 * |map[!true := 581]|) := (true)] + [map v1 : int | v1 in (map v2 : int | (-0x31b <= v2) && (v2 < 0x382) :: (v2 / |multiset([true])|) := (true)) :: (v1 * |map[true := |map[false := "tv"]|]|) := (false), map v3 : int | (0x38d <= v3) && (v3 < 222) :: (v3 + |multiset([|(set v4 : int | (0x207 <= v4) && (v4 < 0x39) :: (v4 / 0x2fa))|, 0x388])|) := (!false), map[|multiset{false, true}| := true], map[|multiset{false}| := false]]))
}
...
function fm52(p0: int, p1: int, globalState: GlobalState): map<char, seq<int>> {
	(map['y' := seq(-806, i0  => (0x340))] + map['j' := seq(940, i1  => (0x3b9))]) + map['r' := seq(-0x353, i2  => (|"qkaprurhj"|))]
}
...
function fm54(p0: bool, p1: string, globalState: GlobalState): seq<int> {
	[-|(seq(0x2c1, i0  => (701)))|, 0x164] + [0x2ee, |map[|(map v0 : map<int, char> | v0 in [map[|[false, false]| := 'c'], map[0x3a3 := 'y']] :: (v0) := (true))| := true]|]
}
...
function fm61(p0: set<bool>, p1: int, p2: int, globalState: GlobalState): map<seq<int>, map<int, int>> {
	(map[[|(seq(-242, i0  => ('y')))|] := map v0 : int | v0 in (seq(292, i1  => (|[|{--0x18d}|, |[false, false]|]|))) :: (v0 % 790) := (|[true, false]|)] + (map v1 : seq<int> | v1 in map[[|[220]|] := 'o'] :: (v1) := (map[|[false]| := 0x3ad]))) + DC87(map v2 : seq<int> | v2 in multiset{seq(717, i2  => (|multiset{-0x240, 0x4e}|))} :: (v2) := (map[775 := |{|{0x1b1}|}|])).cf150
}
function fm62(p0: char, globalState: GlobalState): D5 {
	match if (false) then DC81(false, |map[|map[-0x1a2 := true]| := 'o']|, false, true) else DC81(!false, --389, !false, true) {
		case DC79(cf134, cf135, cf136) => DC13(|multiset{cf136, cf136, cf136, cf136, cf136}|, [-0x363, |(seq(0x217, i0  => ('v')))|, 724], DC4(map[cf136 := cf136], cf136, {map[cf136 := |[cf136, cf136]|]}), cf136)
		...
		case DC78(cf133) => DC13(|map[false := map[true := DC26('g', map[true := DC10({false})], 0x1de, seq(0x277, i1  => ('r')))]]|, seq(-0x151, i2  => (-|map[true := -|map[0xe4 := |"iijsvqyyt"|]|]|)), DC4(map[true := false], true, set v1 : map<bool, int> | v1 in (seq(0x25e, i3  => (map[false := 0x169]))) :: (v1)), false)
	}
}
function fm63(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): D0 {
	DC1([-|(seq(-0x154, i0  => ('l')))|] < (seq(-0x276, i1  => (|{|(seq(984, i2  => (-0x29d)))|, 501}|))))
}
...
function fm65(p0: string, p1: int, p2: bool, globalState: GlobalState): multiset<seq<int>> {
	DC89(multiset{seq(0x13a, i0  => (|{|map['r' := |map[|[false]| := false]|]|, |{'q'}|}|)), seq(33, i1  => (-0x3b0))}).cf151 - (multiset{[0x2eb]} * multiset([[-|[true, false]|, 0x71], [118, |"hrciqd"|, |map['u' := true]|, 0xd, |{0x81}|], [-0x18, |multiset{false, false}|]]))
}
...
function fm67(globalState: GlobalState): D7 {
	DC18(if (true) then true else true, -(if (!true) then |(seq(-0x1af, i0  => (-0x29)))| else -0x103), false)
}
...
function fm70(p0: int, p1: string, globalState: GlobalState): seq<seq<int>> {
	[[|map[true := -61]|], [179]] + (seq(0x293, i0  => (seq(0x59, i1  => (|map[|map[|[false]| := 0x393]| := 0x234]|)))))
}
function fm71(p0: int, p1: int, globalState: GlobalState): multiset<int> {
	multiset{0xdf, |map[!true := false]|} + (multiset{|(seq(0x1c1, i0  => (map[!true := false])))|, -|(set v2 : set<int> | v2 in [set v0 : int | (0x91 <= v0) && (v0 < -0x3b8) :: (v0 % 815), set v1 : int | (-0x17f <= v1) && (v1 < 0x7e) :: (v1 + 0x230)] :: (v2))|, |multiset{false}|, 2, |"qphy"|} - multiset{0x343, 0x3bb, |[11, 0x306]|})
}
function fm72(p0: int, p1: map<bool, int>, p2: char, globalState: GlobalState): set<seq<int>> {
	{[641], [-0x36a], [|(seq(591, i0  => (|"egdno"|)))|], [|[0x18f]|, 0x1b7, |[0x2bd]|], [|[true]|, |{|[0x310, |multiset{true, true}|]|, 0x362}|]} - ({[|map[true := !true]|, |{|"hi"|, |map[|"oajnm"| := |[false]|]|, 852}|], [0x3e3], [0xa0, |[DC35(true, |map[false := "yvhx"]|, |(seq(601, i1  => (865)))|, !true), DC35(true, 0x97, |"gbnmc"|, !true)]|], [|"mke"|, 943]} * (set v0 : seq<int> | v0 in map[[0xf0] := false] :: (v0)))
}
function fm73(globalState: GlobalState): map<string, bool> {
	map["prwpuqc" := !false]
}
function fm74(p0: D13, globalState: GlobalState): seq<map<bool, int>> {
	(seq(988, i0  => (map[!false := |(seq(0x9f, i1  => ('m')))|]))) + [map[false := |[false, false, false]|], map[false := DC49([false, false], 759, -0x4a).cf81], map[!!false := 351]]
}
...
function fm77(p0: bool, p1: int, p2: seq<multiset<bool>>, p3: bool, globalState: GlobalState): D2 {
	DC8(if (!!false) then true else true, 0x18 % --0x285)
}
...
function fm80(p0: bool, p1: int, p2: char, globalState: GlobalState): map<int, char> {
	(if (false) then map[-813 := 'u'] else map[0x16d := 'e']) + map[|(seq(282, i0  => (|map[DC81(false, 328, true, !!true).cf142 := true]|)))| := 'x']
}
...
function fm82(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): D11 {
	DC29("bvmmrg" < (seq(0x2a7, i0  => ('t'))), |DC92({[false, true]}).cf155|, true)
}
function fm83(globalState: GlobalState): seq<set<bool>> {
	if (!!false) then [{!!false, false, true}] + (seq(0x37f, i0  => ({false, true}))) else [{false}, {true}, {!false}, {!false, !true, !true, true}, {true}]
}
...
function fm87(globalState: GlobalState): D10 {
	if (true <== !false) then DC26('j', map[!false := DC10({false})], 425, seq(255, i0  => ('b'))) else DC26('a', map[true := DC10({!true, false})], 0x298, "swewhwqr")
}
function fm88(p0: int, p1: bool, p2: bool, p3: char, globalState: GlobalState): set<map<int, char>> {
	if (true) then {map[|[-0x3b8, -|"aprfk"|, -0x268, |multiset{!false}|, 0x322]| := 'a'], map[63 := 'y'], map[-689 := 't'], map[|"iflj"| := 'c']} else {map v0 : int | v0 in (seq(-876, i0  => (0x323))) :: (v0 - |[0x1e7]|) := ('f'), map[476 := 'f']}
}
...
function fm92(p0: multiset<int>, globalState: GlobalState): map<string, int> {
	map["lgf" := |map[|(seq(0x355, i0  => ('q')))| := false]|] + map[seq(0x37c, i1  => ('n')) := |{0x23c}|]
}
function fm93(p0: int, p1: int, globalState: GlobalState): D17 {
	match DC73(true, 0x117, DC81(false, 85, false, true).cf142) {
		case DC73(cf124, cf125, cf126) => DC41(map v0 : int | v0 in (map v1 : int | (0xe <= v1) && (v1 < 304) :: (v1 * cf125) := (cf125)) :: (v0 / cf125) := (cf124))
...
method m0(p0: bool, globalState: GlobalState) returns (r0: int, r1: char, r2: array<bool>, r3: bool) {
	...
	var v5: array<int> := new int[11] [v0, |v1|, |v3[|(seq(0xbb, i0  => ('p')))|]|, v0, -v0, v0, v0, v0, 207, v0, |v4|];
	var v6: map<array<int>, map<int, bool>> := map[v5 := v4];
	r0 := -(if (p0) then v0 else |v6|) - v0;
	v0 := v0 - v0;
	var v7: array<bool> := new bool[29];
	var v8: map<bool, bool> := map[v1[v0] := p0];
	v7[995] := if (p0 in v8) then v8[p0] else p0;
	v7[995] := p0;
	var v9 := DC1(v7[995]);
	...
	var v11: set<int> := {v0};
	var v12 := new C7(|v1|, |v11| * v0, v7[995], v0);
	var v13: set<bool> := {p0};
	globalState.f5 := fm16({p0} >= v13, v12.fm2(seq(0x291, i2  => ('v')), globalState), v7[995], !(v7[995] <==> v7[995]), globalState);
	var v14 := 's';
...
class C1 extends T2 {
	...
	function fm3(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<string> {
		{"amhbhvj", seq(0x173, i0  => (f33)), "i" + (seq(337, i1  => (f33)))}
	}
	function fm1(globalState: GlobalState): int {
		f16
	}
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: int) {
		if ((f16 < f16) <==> true) {
			...
			v0[86] := f16;
			v0[86] := fm1(globalState) / f16;
			r1 := fm0(v0[86], f15, f15, f15, globalState);
			...
			var v7: C0 := new C0(v6);
			var v8: seq<C0> := [v7];
			v1[77] := if (f32) then v3[|v8|] else !f15;
			var v9: map<array<int>, int> := map[v0 := v0[86]];
			v1[77] := 303 < (f16 / (if (v0 in v9) then v9[v0] else fm0(571, f32, false, f15, globalState)));
			r1 := f16;
			if (if (false in v2) then v2[false] else f15) {
				var v10 := new C0(DC4(v2, f15, v5));
				v0[86] := f16;
				var v11: set<int> := {v0[86]};
				var v12: array<set<int>> := new set<int>[2] [v11, v11];
				v12 := v12;
				var v13: seq<int> := [--0x296];
				var v14 := "gxfrpr";
				v0[86] := (f16 / v0[86]) * v13[|v14|];
				globalState.f7 := v0[86] >= -((if (f32 in v4) then v4[f32] else f16) / |"f"|);
			} else {
				globalState.f7 := f15;
				var v15: set<bool> := {v1[77]};
				globalState.f1 := (v15 > v15) && (v15 > v15);
				var v16: multiset<bool> := multiset{f32};
				r1, globalState.f7, v0[86] := -(f16 + (if (v1[77] in v4) then v4[v1[77]] else if (v1[77] in v16) then v16[v1[77]] else f16)), !(f16 <= (v0[86] / v0[86])), v0[86];
				var v17: multiset<int> := multiset{f16, f16};
				var v18 := DC17(fm18(f33, f16, v1[77], f16, globalState));
				var v19: seq<map<bool, int>> := [map[true := v0[86]]];
				var v20 := "cmjxpuc";
				var v21 := DC5(v1[77], f32);
				var v22: map<char, D1> := map[f33 := v21];
				var v23 := DC15(f32, v20[v0[86] := 'a'], v22);
				var v24: array<map<bool, int>> := new map<bool, int>[27] [map[v1[77] := |v17|], v4[f32 := |v15|], v4, v4, v4 + v4, v4, v4, v4, v4 + v4, v18.cf29, v4, v4 + v4, v4 + map[f15 := f16], v4, map[f32 := f16], fm18(f33, f16, !f15, -f16, globalState), v19[f16], v4, (map[f32 := v0[86]])[v23.cf23 := f16] + v4, map[v1[77] := f16], (map[v1[77] := v0[86]])[f15 := f16], v4, v4, v4 + v4, v4, map[f15 := f16], v4 + v4[v1[77] := v0[86]]];
				v24[360] := map[f32 := v0[86]];
				v24[360] := v18.cf29;
				v24[360] := v24[360][f15 := f16];
			}
			...
			var v28: array<char> := new char[12] ['q', if (f32) then v25[|v27|] else f33, f33, f33, f33, f33, f33, f33, f33, f33, f33, f33];
			...
			match (DC13(f16, v26 + v26, v31, f15)) {
				case DC12() =>
					...
					r1 := v34;
					v36[297] := if (!f15) then v37 else f32;
					v36[297] := fm19(219, f32, v25, 'v', globalState);
		...
		v57[420] := if (f32) then v53 else v53;
		v48, r1, v53[508], v54[975], v57[420] := (v48 + v48) + v48, f16, f15, f33, v53;
		globalState.f5 := true;
		if (if (f32) then v53[508] else v53[508]) {
			globalState.f1 := 0x295 == f16;
			var v58: map<bool, bool> := map[v53[508] := f32];
			var v59: map<char, D1> := map[v54[975] := DC5(f15, f32)];
			var v60: map<bool, int> := map[DC15(v53[508], "dl", v59).cf23 := f16];
			var v61: set<map<bool, int>> := {v60};
			var v62 := DC4(v58, f15, v61);
			var v63 := new C0(v62);
			var v64: array<int> := new int[16](i2 => i2 % f16);
			var v65: multiset<bool> := multiset{f15};
			var v66: multiset<bool> := multiset{fm19(if (f32 in v65) then v65[f32] else f16, f15, "skhgiss", v54[975], globalState), v53[508], v53[508], !f15, true};
			v64, globalState.f7, f33, globalState.f7, globalState.f5 := v64, f15, fm21(v50, fm19(-f16, f32, v49, v54[975], globalState), globalState), true, !(v66 !! v65);
			r1 := |(seq(651, i3  => (v54[975])))| / f16;
			var v67: map<seq<bool>, array<int>> := map[v52 := v64];
			var v68: map<bool, array<int>> := map[f32 ==> f32 := if (v52 in v67) then v67[v52] else v64];
			v68 := v68[v53[508] := v64];
		} else {
			if ((v49 + v49) <= (v49 + v49[f16 := v54[975]])) {
				var v69: array<D2> := new D2[3](i4 => DC7({multiset{f32}}));
				var v70: multiset<bool> := multiset{v53[508], v53[508], v53[508]};
				var v71: set<multiset<bool>> := {v70, v70};
				var v72 := DC7(v71);
				v69[825] := v72;
				v69[825] := v72;
				var v73: array<int> := new int[24](i5 => i5 / f16);
				v73[852] := f16 - f16;
				v73[852] := f16 + f16;
				var v74: multiset<int> := multiset{|v70|};
				globalState.f12, v53[508] := f15, !((fm19(if (-0x122 in v74) then v74[-0x122] else f16, true, v49, v54[975], globalState) <==> v53[508]) <==> (0x370 <= f16));
				var v76: map<D7, int> := map[v50 := f16];
				var v77: seq<map<D7, int>> := [map v75 : D7 | v75 in [v50] :: (v75) := (|multiset{{v73[852]}, {v73[852]}}|), v76 + v76, v76];
				var v78 := DC20(v77);
				v77 := v78.cf34 + (if (v53[508]) then v77 else [v76, v76]);
				var v79: map<bool, bool> := map[true := f32];
				var v81 := DC4(v79, f15, set v80 : map<bool, int> | v80 in (seq(0x1f6, i6  => (map[f32 := v73[852]]))) :: (v80));
				var v82 := new C0(v81);
			} else {
				var v83: map<bool, string> := map[v52 == [v52[f16]] := v49];
				v83 := v83[v53[508] := v49];
				var v84: array<int> := new int[4] [f16, f16, f16 % f16, -(f16 / |v49|)];
				v84 := v84;
				var v85 := DC0(v84);
				var v86: map<seq<int>, D0> := map[seq(-0x2bf, i7  => (f16)) := v85];
				var v87: seq<int> := [f16];
				var v88: map<int, map<seq<int>, D0>> := map[f16 := v86[v87 := v85]];
				var v89: array<map<seq<int>, D0>> := new map<seq<int>, D0>[25] [v86, v86, v86, v86, v86, v86, v86 + v86, v86[[f16, |v49|] := v85], v86 + v86, map[[-f16, |(seq(0x1a3, i8  => (f33)))|] := DC0(v84)], if (v52[f16]) then v86 else v86, v86, v86, v86 + (if (f16 in v88) then v88[f16] else v86), v86, v86, map[v87 := DC0(v84)], v86, v86, v86, v86[v87 := DC0(v84)], v86, v86 + v86, map[v87 := v85] + v86, v86[v87 := DC0(v84)]];
				v89[831] := v86 + v86;
				v89[831] := (v86 + v86[v87 := v85]) + v86;
				v83 := v83[v53[508] := "jvoy"];
				v84[113] := |(map v90 : int | (499 <= v90) && (v90 < 990) :: (v90 - f16) := (v53[508]))|;
				v84[113] := f16 % f16;
			}
			...
			var v96: array<int> := new int[23] [f16, |{f32, f15, v53[508], fm19(|{f16}|, !f15, v91[f16], fm21(DC18(!v53[508], |v92|, v53[508]), false, globalState), globalState), f15}|, f16, f16, f16, f16, fm0(f16, f15, f32, v53[508], globalState), |(seq(624, i9  => (f16)))|, f16, f16, |multiset{f16}|, f16, f16, f16, fm0(-|v93|, f15, f32, v53[508], globalState), |v49|, f16, f16, |v95|, f16, f16, f16, |v51|];
			var v97 := DC0(v96);
		...
		globalState.f12 := if (f32) then f15 else if (f15) then v53[508] else v53[508];
		r0 := f15;
		r1 := f16;
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
			...
			decreases 100 - i0
		{
			...
			v7[826] := v9 !in v10;
			var v11 := "c";
			v7[233] := fm19(|v9|, f15, v11, f33, globalState);
			...
			globalState.f0, v6, v7[826], r0, v7[233] := v13[-331 := v14 >= v14], v6 + v6, if (v15 >= multiset(v16)) then f32 else f15 && f32, f32, f15;
			r1 := -f16;
			var v17 := DC18(v7[826], p0, false);
			v5[524] := v17.cf31;
			v5[524], r1 := p0, p0;
		}
		for i1 := f16 % f16 to f16 {
			globalState.f7 := f15;
			...
			r1 := if (v18[962] in v21) then v21[v18[962]] else f16;
		}
		...
		if (v3.f29.cf7) {
			var v23 := "gdwmsa";
			v23 := (seq(0x6a, i4  => (f33)))[p0 := f33];
			v23 := seq(306, i5  => (f33));
			var v24: seq<string> := [v23, seq(594, i6  => (f33))];
			r1 := |v24[p0 + f16 := "tgdknxb"]|;
			if (f15) {
				...
				var v31: array<D0> := new D0[25] [fm22(globalState), fm22(globalState), v26, v26, v26, v26, DC2(p0, v27, f32), v26, v26, v26, fm22(globalState), v26, DC2(-fm0(0xa0, !f32, !false, f15, globalState), set v29 : int | v29 in v28 :: (v29 * 0xdb), f15), DC2(f16, v27, f32).(cf2 := fm1(globalState)), v26.(cf4 := v30[p0]), v26, v26, DC2(0x3c1, {p0, 679}, f32), v26, if (f32) then v26 else v26, fm22(globalState), v26, v26, v26, v26];
				v31[344] := v26;
				v31[344] := v26;
				...
				v22[665] := v34[if (-|v37| in v35) then v35[-|v37|] else f16];
				var v39: multiset<map<bool, bool>> := multiset{v0[f15 := f15]};
				v22[665] := (p0 / f16) + |(v39 + multiset{v3.f29.cf6, v0, v0, v0, map[f32 := f32]})|;
				globalState.f12 := f15;
			} else {
				var v40 := new C0(v3.f29);
				var v41: array<bool> := new bool[7];
				v41[880] := if (f32) then f32 else f15;
				v41[880] := f32;
				r1 := f16;
			...
			if (f32) {
				...
				var v55: array<bool> := new bool[26] [f15, f32 || fm19(p0, f32, v42, f33, globalState), v43 !! v43, f15, f16 == |v44|, f15, !f15, f15, f15, !f15, p0 <= f16, f15, !(v44[p0 := 667] == v45.cf19), f32, f15 && f32, f32, f15, !f15, v46 !in v47, f15, f15 ==> f32, v51.cf30, f32, f32, v52 <= [v1, v1], v54 == v54];
				v46[884] := f32;
				v46[884] := f32;
				var v56: array<char> := new char[6](i8 => f33);
				v56[142] := f33;
				v56[142] := f33;
				var v57 := DC9((seq(903, i9  => (f33)))[p0 := fm21(DC18(f32, |[f16]|, v46[884]), f32, globalState)]);
				v42 := v57.cf15;
				v46 := v46;
			} else {
				var v58: seq<int> := [f16, f16];
				var v59 := "yllnbaonp";
				r1 := (f16 + -|v58[f16 := -|v59[|{!f32}| := f33]|]|) - f16;
				...
				v61, globalState.f12, v22[263], v62 := v60, !(-f16 != f16), 0x2e7, if (false <==> f15) then v3 else v3;
				...
				var v67 := DC22(v65);
				globalState.f13, v22[263], v63[978], globalState.f7 := v60 > (if (v22[263] in v66) then v66[v22[263]] else {f15}), v22[263], if (true) then v65 else v67.cf36, f15;
				var v68 := new C0(v3.f29);
				var v69: seq<string> := [v59];
				var v70: seq<bool> := [(seq(-508, i10  => (f33))) < v59, v59 !in v69];
				globalState.f0 := v70;
			}
			...
			v75[919] := if (false in v0) then v0[false] else f32;
			var v76: multiset<int> := multiset{206};
			v75[919] := !((f16 / |v71|) > |v76|);
			var v77: seq<multiset<int>> := [fm25(globalState)];
			var v78: seq<int> := [0xbd];
			var v79: set<multiset<int>> := {fm25(globalState), v77[f16], v76, v76 + v76, multiset(v78)};
			v79 := v79;
		}
		...
		var i11 := 0;
		while (!!((if (fm19(-p0, v80[p0], v81, f33, globalState)) then v83 else multiset{f33, f33}) >= (multiset(v81) - multiset{f33})))
			decreases 100 - i11
		{
			if (i11 >= 100) {
				break;
			...
			i11 := i11 + 1;
			r1 := -fm2(seq(0x82, i12  => (f33)), globalState) / (|"imtrwbctc"| % 0x1a);
			r1 := p0;
	...
	method m1(globalState: GlobalState) {
		...
		if (v1 in v7) {
			if (fm1(globalState) >= f16) {
				...
				v14[368] := v6;
				globalState.f7 := !f15;
				v14[368] := fm1(globalState) - |(seq(0x1db, i0  => ('q')))|;
				var v15: array<bool> := new bool[13](i1 => f15);
				var v16: map<array<int>, array<bool>> := map[v12 := v15];
				globalState.f5, globalState.f5, v6, globalState.f5, v6 := false, ((multiset{v14[368]})[0x29c := f16] > v2) <==> f15, f16 - |v16|, f15, v14[368];
			} else {
				var v17: array<bool> := new bool[12](i2 => f15);
				v17[529] := f32;
				v17[529] := v6 != v6;
				var v18: set<map<bool, int>> := {v5, v5, v5};
				var v19 := DC4(map[f32 := f32], v17[529], v18);
				...
				v21[148] := fm27(v19, false, globalState);
				v21[148] := v19;
				globalState.f7 := v17[529] <==> true;
			...
			var v33 := DC16(DC13(v27[v6], fm28(v6, f32, globalState), v31, f15), f16, if (f16 in v32) then v32[f16] else v4[v6]);
			match (v33) {
				case DC15(cf23, cf24, cf25) =>
					...
					f33 := cf24[--0x161 / -fm0(f16, cf23, f32, cf23, globalState)];
					v1 := (if (f32) then multiset{f32, f32} else multiset{f32}) * v1[f15 := -f16];
				case DC16(cf26, cf27, cf28) =>
					v5 := v5[false := f16];
					var v37: array<int> := new int[11];
					v37[386] := v27[v6];
					globalState.f13, globalState.f13, v37[386] := f32, f15, fm2(v4[cf27 := cf28], globalState);
					globalState.f5 := f16 <= (|v27| - v6);
					globalState.f5 := f32;
				case DC14(cf22) =>
					globalState.f5 := f15;
					var v38: array<string> := new string[15];
					var v39: map<string, array<string>> := map[seq(0x231, i3  => (f33)) := v38];
					v38 := if (v4 in v39) then v39[v4] else v38;
					var v40: seq<bool> := [f15, f15, fm19(|"wligpr"|, f15, ("xeq")[f16 := f33], f33, globalState), f15, f16 >= f16];
					globalState.f13 := v40[0x71 % -f16];
					v6 := f16;
			}
			...
			if (f15) {
				...
				var v54: set<int> := {|v53|};
				var v55 := DC18(fm19(v45, f32, (seq(0x1b5, i6  => (f33)))[|v54| := f33], f33, globalState), v45, f15);
				...
				var v71: map<int, seq<map<D7, int>>> := map[|v63| := [v69, v70[100]]];
				var v72 := DC20((if (v45 in v71) then v71[v45] else v70) + v70[f16 := map[v68 := f16]]);
				v72 := DC20(v70);
			...
			v74[117] := v4[if (v48 in v1) then v1[v48] else |v75| := f33] + "iyxdhqle";
			v74[117] := v4;
		}
		
		var v78 := DC3(v1);
		var v79: seq<bool> := [f15];
		if (if (false) then fm19(|v78.cf5[f32 := |v79|]|, f32, v4, f33, globalState) else v4 < v4) {
			v4 := v4;
			globalState.f13 := fm19(fm2(v4, globalState) % f16, true, v4, f33, globalState);
			...
			if (v88 < (if (v83) then v88 else v88)) {
				var v89: array<int> := new int[14](i8 => i8 / v80);
				v89[771] := -v80 + -v6;
				...
				var v95 := DC25(v79);
				v89[771] := fm0(v94.cf38, v83, v79 <= v95.cf43, v83, globalState);
				var v96: map<int, multiset<int>> := map[if (f32) then fm2(v4[v6 := v81], globalState) else v6 := if (f15) then v2 else DC28(multiset{v6}).cf49];
				v96 := v96[v89[771] := v2];
				v89[771] := v6;
				var v97: set<int> := {fm1(globalState), v89[771]};
				v6 := (f16 + v6) - |v97|;
				v84 := v84[f32 := v83];
			} else {
				...
				var v101: seq<int> := [fm0(|v4|, f15, v83, v82[352], globalState), v6];
				v99, globalState.f7 := v100[|v101|], v83;
			}
			...
			var v105: array<bool> := new bool[27] [f32, false, f15, f32, !f15, (seq(566, i9  => (v6))) <= (seq(466, i10  => (f16))), f15, f16 >= |(seq(0x237, i11  => (0xaf)))|, true, f32, !(f16 <= v6), f32 ==> !f32, |[f32]| < fm1(globalState), f32, f15, f32 <==> f32, v103 != v103, v6 > f16, v6 > |v104|, map[f15 := f32] != v104, f15 && f32, f32, f15 <==> v79[v6], if (f15) then f32 else f32, v79[|v104|], f32, f32];
			v105 := v105;
			if (false) {
				...
				var v112: seq<seq<int>> := [seq(-662, i12  => (v6))];
				v111[701] := v112;
				var v113: map<bool, char> := map[f15 := f33];
				v105[297], v110, v111[701], v6, globalState.f12 := (|v113| + v6) <= (|v2| % 0x2fa), v110, (seq(431, i13  => (seq(0x16, i14  => (|(map v114 : int | (348 <= v114) && (v114 < 0x5) :: (v114 % v6) := (f32))|)))))[|v4| * f16 := v102], if (true) then f16 else fm2(fm23(globalState), globalState) - f16, f32;
				globalState.f5 := multiset{f16, fm1(globalState), v6} < v2;
				var v115: set<map<bool, int>> := {v5, fm18(f33, f16, v105[297], f16, globalState)};
				var v116 := DC4(map[v105[297] := f32], v105[297], v115);
				var v117: C0 := new C0(v116);
				v117 := v117;
				v105[297], globalState.f12 := (v6 / |v102|) > f16, fm19(-f16, v1 < v1, v4, f33, globalState);
				var v118: set<bool> := {fm19(f16, true, v4, f33, globalState)};
				v6, globalState.f12 := f16 / -|(v118 * v118)|, f32;
			}
			...
			var v121 := DC24(v120);
			v121 := v121;
			var v122, v123, v124, v125 := m0(if (f15) then f32 else fm19(v102[v6], f15, v4, 'k', globalState), globalState);
			var v126: multiset<seq<char>> := multiset{v4, v4, v4, ['l']};
			v122 := if ((seq(0x56, i15  => (f33))) in v126) then v126[seq(0x56, i15  => (f33))] else v122;
		}
			...
			decreases 100 - i16
		{
			...
			var v129: set<map<bool, int>> := {map[f15 := v127[v6]]};
			...
			v6, v133, v134 := f16, (map[v132 := v4])[v132 := v4], v138[f16];
			...
			var v151: array<map<int, int>> := new map<int, int>[25] [map[|[f32, f32]| := 0x293] + v141, v141 + v141, v141 + map[fm2(v4, globalState) := f16], v141[|v5| := |v132|], map v142 : int | v142 in v132 :: (v142 * v6) := (f16), v141, map[v6 := |v145|] + v146.cf53, fm30(v6, |v147|, v79[0x107], f33, globalState), map[if (true in v1) then v1[true] else |v4| := f16], DC30(fm30(f16, v6, f15, f33, globalState)).cf53, if (f15) then map[v6 := v6] else v141, v141, map[|v79| := |v4|], v141 + v141, map[-fm0(f16, f32, f15, false, globalState) := |v1|], map[-(if (v6 in v2) then v2[v6] else |v4|) := v6], map[v6 := |(map v148 : int | (0x224 <= v148) && (v148 < -0x326) :: (v148 + |DC10({f32}).cf16|) := (f16))|], (map v149 : int | (-0xe0 <= v149) && (v149 < 0xb7) :: (v149 - v6) := (v6))[fm0(0x1b3, f32, f32, f32, globalState) := f16], v141, v141[f16 := v6], v141, v141, if (true in v150) then v150[true] else v141, v141 + v141, map[-|v127| := v6]];
			v151 := v151;
...
class C2 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		r1, v0[16] := |((v2 * multiset{f16}) + (multiset{f39})[0x37f := f16])|, -|(v3 + v3)|;
		if (v1 !! multiset{f15, f15}) {
			var v4: map<int, bool> := map[p0 := f15];
			v0[16] := f16 - (f39 + |v4|);
			v0[16] := v0[16];
			var v5: seq<int> := [v0[16]];
			v0[16] := v5[p0];
			if (f15) {
				f39 := v0[16];
				var v6 := 'c';
				var v7: map<map<bool, bool>, char> := map[map[false := f15] := v6];
				var v8 := DC18(f15, v0[16], f15);
				v0[16] := v0[16] - (|v7| * v8.cf31);
				var v9: set<int> := {f16};
				var v10 := "fsctqryk";
				r0 := v9 <= (v9 * {|v10|});
				...
				v11[349] := fm51(v12.cf1 in v13, v0[16], p0 * -389, globalState);
				f39 := v0[16] % 0x139;
			} else {
				var v14: set<int> := {v0[16]};
				v3 := v3[f15 ==> f15 := v14 > {f16, v0[16]}];
			...
			var v20 := "mfurnuy";
			globalState.f5 := v19[fm2(v20, globalState) + 0x2ea];
		} else {
			var v21: array<seq<bool>> := new seq<bool>[2];
			var v22: seq<bool> := [f15];
			v21[530] := v22 + v22[v0[16] := f15];
			var v23 := DC1(f15);
			v21[530] := if (f16 >= f39) then v22 else (v22[f16 := v23.cf1])[v0[16] := f15];
		...
		if (f15) {
			...
			if (!!f15) {
				...
				v48[432] := v49 < v49[f39 := f15];
				v48[432] := v48[432];
				globalState.f12 := v48[432] <== f15;
			}
			
			var v50 := DC35(f15, fm0(-v0[16], f15, f15, f15, globalState), |v3|, f15);
			...
			match (v51) {
				case DC33(cf56) =>
					...
					var v54 := "bivyts";
					var v55: array<bool> := new bool[3] [v53[v0[16]], fm53(f15, f15, cf56, f16, globalState), v54 <= v54];
					v55[66] := -v0[16] < p0;
					var v56 := DC41(v52);
					v0[16], f39, v52, v55[66] := -f16, fm1(globalState), v56.cf71, f15;
					var v57: map<bool, char> := map[f15 := 'f'];
					r1 := (f39 / |v57|) % -0x3e3;
					var v58 := DC17(map[f15 := f16]);
					var v59: map<bool, int> := map[cf56 := f39];
					var v60: seq<array<bool>> := [v55];
					var v61: map<int, array<bool>> := map[f16 := v60[p0]];
					var v62: set<array<bool>> := {if (f16 in v61) then v61[f16] else v55, v55};
					v55[66], v0[16] := !([v58, v58, v58, v58] == [v58, DC17(v59)]), (if (fm53(v55[66], cf56, f15, v0[16], globalState)) then f16 else -|v62|) * v0[16];
				...
				case DC34(cf57, cf58, cf59) =>
					...
					var v68 := "rkcdsmae";
					var v69: map<seq<set<int>>, int> := map[v67 := fm2(v68, globalState) % |v68|];
					v69 := v69[v67 := cf59];
				...
				case DC35(cf60, cf61, cf62, cf63) =>
					...
					var v76: map<int, set<map<bool, int>>> := map[|(seq(0x2e6, i3  => (cf61)))| := v73];
				...
				case DC32(cf55) =>
					...
					v0[16] := f39 - p0;
					var v79: seq<bool> := [f15];
					var v80 := DC18(v79[v0[16]], 379, f15);
					var v81 := DC19(v80);
				...
				case DC36(cf64) =>
					...
					v89[155] := v1 == v1;
					var v91 := "nwlku";
					v88, v89[515], v89[155], globalState.f5 := v88, fm53(v90, false, v90, |v2| - f39, globalState), (v91 + v91) <= "ovimjk", f16 > f16;
					v90, v89, globalState.f12, v89[515], r1 := f15, v89, v89[515], v89[515], |v91|;
			}
			...
			var v102: array<bool> := new bool[28] [v92[f16], p0 != v0[16], v0[16] != --f16, f15, f15 ==> f15, f15, f15, false, true, v92[f39], v94 != (set v95 : char | v95 in fm55(globalState) :: (v95)), f15, false, !(f15 <== f15), f15, {v93} >= {v93}, f15, |v97| >= fm50(f15, f15, globalState), v0[16] < |v1|, !!f15, v98.cf30, (map v99 : int | (0x268 <= v99) && (v99 < 983) :: (v99 - f16) := (f15)) == v97, false, f15, f15, f15, true, if ('p' in v101) then v101['p'] else f15];
			v102[53] := !f15;
			var v103: seq<seq<int>> := [v96];
			v102[53] := v96 == v103[v0[16]];
			globalState.f5 := v102[53] <== !false;
			f39, r1 := 24, p0 * f39;
		}
		
		r1 := if (false) then v0[16] else f16;
		var v104 := "bwpuhnssg";
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		var v7: seq<bool> := [f15];
		var v8: array<int> := new int[25] [if (f39 in v0) then v0[f39] else f16, |v1|, f16, 0x2ad, fm2("et", globalState), f16, f16 + f16, f16, if (true in v2) then v2[true] else f16, -0x3d3, f16, f39, if (v3 in v4) then v4[v3] else f39, 969, f16, 0x3a7, f16 / f39, |fm56(f15, f15, f15, globalState)|, f39 + -f16, |v6| * f16, 0x22, f16, |v7|, f16, f39];
		v8[912] := |v1|;
		var v9: seq<set<bool>> := [v1];
		var v10: map<int, bool> := map[f39 := f15];
		var v11: map<set<bool>, map<int, bool>> := map[v9[0x1e] := v10];
		var v12: set<int> := {|v5|, f16, -f39};
		var v13 := DC2(0xac, v12, !f15);
		var v14: map<int, map<set<bool>, map<int, bool>>> := map[f16 := map[v1 := map[f39 := f15]]];
		v8[912], v5, v11, globalState.f1, globalState.f1 := -(0x64 + f16), match v13 {
			case DC1(cf1) => v5
			case DC2(cf2, cf3, cf4) => if (f15) then v5 else "mp"
			case DC0(cf0) => v5
		}, if ((f16 + -f39) in v14) then v14[f16 + -f39] else v11, f15, f15;
		v8[912] := f16 % f39;
		var v15 := DC8(-f16 != v8[912], f16);
		match (v15) {
			case DC8(cf13, cf14) =>
				v3[703] := f15;
				v3[703] := f15;
				...
				v17 := v17[f15 := v16];
				var v18 := 'm';
				var v19 := new C1(fm53(cf13, cf13, v3[703], |v5|, globalState), v18, f15, cf14);
				r0 := cf13 <==> f15;
			case DC7(cf12) =>
				var v20: multiset<array<int>> := multiset{v8, v8, v8};
				v8[912], v20 := v8[912], (v20 * v20) * (v20 * multiset{v8, v8, v8});
				v8 := new int[1](i0 => i0 % v8[912]);
				v10 := v10[f39 := f15];
				var v21: seq<int> := [f16];
				v8[912] := if (f15) then |v21[0x3be := 0x349]| else |multiset{v8}|;
		}
		...
		match (DC35(f15, fm1(globalState), f16, true)) {
			case DC33(cf56) =>
				v10 := v10;
				globalState.f7 := cf56;
				v3[283] := fm1(globalState) >= |v5|;
				v3[283] := cf56;
				v8[912] := -|v1|;
			case DC34(cf57, cf58, cf59) =>
				v3[576] := cf58;
				v3[576] := cf58 <== cf58;
				globalState.f12, globalState.f1, cf58, globalState.f0 := (v8[912] / f39) != 0x1c5, v3[576], ([cf57.f15])[655 := cf57.f15] <= [!!f15, cf57.f15, cf57.f15], v7;
				v6 := v6[v5 := !cf58];
			...
			case DC35(cf60, cf61, cf62, cf63) =>
				...
				match (v27) {
					case DC15(cf23, cf24, cf25) =>
						...
						v8[912] := fm50(true, v7[v8[912]], globalState);
					...
					case DC14(cf22) =>
						v3 := v3;
						cf61 := -|(seq(0x30d, i2  => (v5[|map[v24 := false]|])))|;
						globalState.f1, v3, f39, globalState.f5 := !(if (cf62 in v10) then v10[cf62] else cf60), v3, --(cf62 * 0x346), !true;
						v3[548] := false;
						v3[548] := (if (cf63) then cf62 else -v8[912]) > (f39 * f39);
				}
				
				var v32 := new C1(cf60, v24, cf61 >= -cf62, -0x17);
			case DC32(cf55) =>
				f39 := (f39 / -f39) % f39;
				if ([false, f15] <= [f15, fm53(true, f15, f15, v8[912], globalState)]) {
					var v33 := 'c';
					var v34: C1 := new C1(f15, v33, f15, f16);
					var v35: map<char, C1> := map[v33 := v34];
					var v36: map<bool, C1> := map[f15 := v34];
					var v37: array<C1> := new C1[29] [v34, v34, v34, if (v34.f33 in v35) then v35[v34.f33] else v34, v34, v34, v34, if (fm53(v34.f32, v34.f32, v34.f32, v8[912], globalState)) then v34 else if (!f15 in v36) then v36[!f15] else v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34];
					v37[662] := v34;
					v3, v37[662], f39, v8[912] := v3, v34, v8[912], (fm49(true, 0x4d, f39, v15, globalState) * v8[912]) - -(if (v34.f32) then f16 else fm49(v34.f32, f39, |v12|, v15, globalState));
					var v38 := DC18(v34.f32, |v5|, f15);
					var v39: seq<int> := [f39];
					var v40: seq<int> := [f16, |v39|];
					var v41: seq<seq<bool>> := [v7];
					v8[912] := fm49(!fm53(f15, f15, f15, 0x3a2, globalState), v38.cf31, |multiset(v40)| / |v41|, v15, globalState);
					v3[945] := f15;
					v3[945], globalState.f13, globalState.f12, v8[912] := v34.f32, v7[|v5| + 0x317], (|"bqdiiuggl"| != -f39) <==> v34.f32, --f16;
					var v42 := DC10({v34.f32});
					var v43: map<bool, D4> := map[fm53(true, f15, v34.f32, |[v3[945]]|, globalState) := v42];
					var v44 := DC26(v33, v43, f16, v5);
					var v45: map<string, int> := map[v5 := -v44.cf46];
					v45 := v45[seq(0x221, i3  => (v34.f33)) := 0x1b8];
					v8[912] := f16;
				} else {
					v3 := v3;
					f39 := 0x3b7;
					v3[929] := f15;
					v3[929] := -v8[912] > v8[912];
				...
				if (f15 <== f15) {
					v3[316] := f15;
					v3[316] := f16 == (f16 - f39);
					globalState.f7 := ({v3[316]} * v1) in (seq(0x2e8, i4  => (v1)));
					v8[912] := fm2(v5 + v5, globalState);
					f39 := 0x212;
					var v48: map<bool, int> := map[!!v3[316] := f39];
					var v49: seq<map<bool, int>> := [fm59(f16, globalState), v48];
					var v51 := DC4(v47, v3[316], set v50 : map<bool, int> | v50 in v49[0x4 := v48] :: (v50));
					var v52 := new C0(v51);
				} else {
					v8 := if (f15) then v8 else v8;
					var v53: map<set<bool>, array<int>> := map[v1 := v8];
					f39 := if (f15) then fm49(!f15, |v5|, |v53|, v15, globalState) * v8[912] else f16;
					v8[912] := -f39;
					f39 := --f39;
					var v54: map<bool, int> := map[f15 := f16];
					var v55 := 'b';
					var v56: map<int, char> := map[|v54| := v55];
					var v57: seq<int> := [|v56|, f39, v8[912]];
					var v58: map<int, array<bool>> := map[|v57| := v3];
					v58 := map[f16 := v3] + (v58 + v58);
				}
				
			case DC36(cf64) =>
				var v59: seq<int> := [v8[912], f16, fm2("jbt", globalState)];
				var v60 := 'e';
				var v61 := DC39(fm54(f15, v5, globalState), v8[912], v8[912]);
				var v62: map<char, D15> := map[v60 := v61];
				var v63: seq<seq<int>> := [v59, [414, v8[912], v8[912], 0x24a]];
				f39, f39, v59, globalState.f1 := v8[912], --|v62[v60 := fm60(f15, f16, true, globalState)]|, (v59 + v59) + v63[f16], v1 !! v1;
				var v64: map<seq<int>, map<int, int>> := map[v59 := v0];
				var v65: map<int, map<seq<int>, map<int, int>>> := map[fm2(v5, globalState) * f16 := v64];
				v65 := v65[f16 := fm61(v1, 0x118, v8[912], globalState)];
				if (f15) {
					var v66, v67, v68, v69 := m0(f15, globalState);
					var v70: multiset<array<int>> := multiset{v8, v8, v8};
					v66 := if (v8 in v70) then v70[v8] else v8[912];
					var v71: multiset<int> := multiset{-(-f39 - v66)};
					v8[912] := if (v8[912] in v71) then v71[v8[912]] else f16;
					f39 := -f39;
					...
					v8[912] := |((set v73 : seq<bool> | v73 in v72[|v5| := v7] :: (v73)) - v74)|;
					v3[632] := true;
					v3[632] := f15;
					...
					var v76 := DC1(f15);
					var v77: array<D0> := new D0[24] [fm63(f15, |[v3[632], v3[632], f15]|, --|v75|, v3[632], globalState), v76, v76, v76, v76, fm63(!f15, v8[912], f16, v3[632], globalState), fm63(v7[v8[912]], f16, f39, false, globalState), v76, v76, v76, fm63(v3[632], -f39, v8[912], f15, globalState).(cf1 := v3[632]), v76, v76, DC1(f15), v76, v76, v76, DC1(v3[632]), v76, v76, v76, fm63(v3[632], v8[912], |v5[f39 := v60]|, f15, globalState), v76.(cf1 := f15), v76];
					v77 := v77;
				}
				
				var v78 := DC5(f15, f15);
				v2, v12 := fm64(f15, v78.cf9, v8[912], -v8[912], globalState), (if (f15) then v13 else DC2(f39, v12, f15)).cf3;
		}
...
class C3 extends T2, T1 {
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if ((v0 == v0) && (f16 > |v1|)) {
			...
			v13[453] := "mta";
			var v14: array<bool> := new bool[14] [f15, f38, f38, f37, f15, !f15, !true, f38, f16 > 148, false, f38 <==> f37, fm44(seq(0xef, i1  => (v5)), v2, f15, f37, globalState), f38 <==> true, f38];
			var v15: map<int, bool> := map[f16 := f38];
			var v16 := DC5(f38, if (f38) then if (0x76 in v15) then v15[0x76] else f15 else v12[f16]);
			v13[453], v5, v14, r1, v16 := seq(0x33f, i2  => (v5)), v5, v14, f16, v16;
			r1 := f16;
			var v17 := DC22(v14);
			...
			v24, globalState.f1, v22[652], r1 := v24, f38, (if (f38) then v26 else v26).cf52, f16;
			var v27 := new C0(fm45(f15, v21, false, |v1|, globalState));
			var v28: multiset<bool> := multiset{f15, f15, false};
			var v29: seq<seq<int>> := [[f16], seq(-0xdc, i7  => (|map[|v1| := !true]|))];
			var v30: map<int, seq<int>> := map[f16 := v0];
			var v31: array<seq<int>> := new seq<int>[29] [[f16], v0, v0, seq(346, i3  => (|{f38}|)), v0, v0, v0 + v0, v0, (v0 + v0)[f16 := f16], seq(-0x3af, i4  => (|v1|)), v0, v0, seq(-0x296, i5  => (|map[DC26('k', map[f15 := DC10({v22[652]})], f16, v1) := f16]|)), v0 + [-f16], v0, (v0 + v0)[f16 := f16], if (f37) then [|v1|, f16] else v0, v0, [f16, f16, |v28|, f16, f16], seq(0x286, i6  => (|v1|)), v29[f16] + v0, if (767 in v30) then v30[767] else v0, v0, v0, (seq(-0x230, i8  => (f16))) + v0, v0 + v0, v0[0x369 := 0x2dc] + v0, v0, v0];
			v31[169] := fm46(v1, f16, f16, globalState) + v0;
			r1, v31[169] := f16, ([f16, f16] + v0) + (seq(0x3d4, i9  => (f16)));
		}
			...
			decreases 100 - i10
		{
			...
			var v36: array<bool> := new bool[11] [f15, v34.f32, v34.f32, f37, !f37, v34.f32, f16 < f16, false, f15, v35[|v35|], !f38];
			v36[753] := f16 < f16;
			var v37: seq<array<bool>> := [v36, v36, v36];
			var v38: set<int> := {f16, |v37|};
			v36[753] := (v38 - v38) <= (v38 - {0x2dd, f16});
			var v39 := DC3(multiset(v35));
			var v40: multiset<bool> := multiset{v34.f32, v35[f16]};
			...
			decreases 100 - i11
		{
			...
			if (!((fm47(f16, globalState) + v47) >= v47)) {
				...
				v45[216], globalState.f12, v49, globalState.f7, r1 := f37, f15, v49 + v49, f37, f16;
				...
				v57[476] := if (f37 in v58) then v58[f37] else f16;
				v57[476] := --f16;
				...
				var v61: set<string> := {seq(-347, i14  => (v42)), v1 + v1};
				var v62: multiset<string> := multiset{v1};
				var v63: set<int> := {f16};
				v61 := set v64 : string | v64 in v62[v1 := |v63|] :: (v64);
				...
				var v70: C1 := new C1(v65[|v68|], v42, fm44(v1, v69, f38, f37, globalState), f16);
			...
			globalState.f1, r1, r1, r0 := v75.cf10, fm1(globalState), if (f38) then f16 % |v1| else -f16, f15;
			var v76: seq<string> := [seq(0x131, i15  => ('k')), v1];
			var v77 := DC40(v76[f16 := v1]);
			v77 := v77;
		}
		...
		if (f15) {
			...
			var v81: array<int> := new int[7] [f16, f16, |v1|, |v80[|v0|]|, 639, f16, 0x24d];
			v81 := v81;
			...
			r1 := f16;
			var v86 := 'n';
			var v87 := new C1(f37, v86, true, f16 % -v0[f16]);
			r1 := f16 * f16;
			var v88: multiset<bool> := multiset{f15, f38};
			var v89: seq<bool> := [!f38, v87.f32, f38];
			var v90: seq<bool> := [fm44(v1, (multiset(v89))[f38 := |v88|], f38, !f38, globalState)];
			var v91: seq<multiset<bool>> := [v88, (multiset{fm44(seq(665, i18  => (v87.f33)), multiset{f15, !v87.f32}, fm44(v1, v88, f15, f15, globalState), f38, globalState), f15})[f37 := f16] - v88, v88, v88 * multiset(v89)];
			r1 := |v91[f16]|;
			if (f38) {
				...
				v92[809], v98 := 0x49 - f16, v98.(cf28 := v1[f16], cf26 := v97).(cf26 := v97);
				globalState.f5, v92 := !f38, v92;
				v92[809] := v92[809];
				v78[51] := v87.f32;
				var v99: seq<seq<bool>> := [v89];
				v78[51] := (v99 < v99) !in v94;
				...
				var v101: array<int> := new int[9] [fm2(v1, globalState), v0[807], 359, -f16, f16, f16, |v88| % |v100|, f16, |multiset{v87.fm1(globalState)}|];
				v101[606] := -0x3c;
				v101[606] := f16;
				var v102: map<char, bool> := map[v86 := v87.f32];
				globalState.f13 := (if (fm51(f15, f16, v101[606], globalState) in v102) then v102[fm51(f15, f16, v101[606], globalState)] else false) && v87.f32;
				...
				var v108: map<array<int>, int> := map[v101 := |v0[|map[v101[606] := v87.f32]| := f16]|];
		...
		v110 := v110[v109[f16 := false] + v109 := -f16];
		r0 := f37;
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
			...
			decreases 100 - i1
		{
			...
			var v15: set<string> := {v14[f16], v13, v13, v13, v13};
			...
			v12[555], v19, globalState.f13 := v20.cf50, v19, f15;
			...
			r1 := |v24|;
			if (!f15 ==> (f15 ==> v0[|v0[|fm58(p0, globalState)| := f15]|])) {
				var v25 := 'x';
				...
				var v31: array<int> := new int[26] [599, |(v17 + v17)|, f16, -|(v0 + [f37])|, |("mupy")[fm0(p0, f37, true, v12[555], globalState) := 'w']| + |v13|, |(seq(0x211, i2  => ('x')))|, p0, f16, p0, |v13[f16 := v25]| / p0, fm1(globalState), |(v26 - v26)|, fm0(p0, f15, true, v0[f16], globalState), p0, p0, -0x3d, fm0(|v27|, v12[555], f15, f15, globalState), |v28| * f16, -0x32, p0, |(v29 + v29)|, |v30|, -(f16 + f16), fm2(v13, globalState), |v17|, |"wxwba"|];
				v31[263] := p0;
				v31[263] := p0;
				globalState.f13 := !!(if (v12[555]) then v24 == v24 else false);
				var v32: multiset<array<bool>> := multiset{v12};
				v32 := v32;
				globalState.f7 := v12[555];
				var v33 := DC33(!f38);
				...
				v13, v35, v12[555] := seq(637, i3  => (v34)), v35, false;
				v35[310] := p0;
				v35[310] := f16;
			}
		...
		var v39 := "qp";
		var v40: seq<int> := [f16, |v39[f16 := v36]|];
		...
		var v50: array<int> := new int[27] [p0 * p0, |(seq(0x1d2, i6  => (p0)))|, f16, f16, p0, p0, --f16, f16 * v40[f16], p0, |v40|, f16, p0, -f16, -v40[if (f37 in v41) then v41[f37] else f16], |map[v42[f16] := v0]|, f16 / |[v37.f32, f38]|, v45.cf2, |(if (v36 in v46) then v46[v36] else v39)[|v41| := v36]| % f16, f16 + (if (v36 in v47) then v47[v36] else f16), |v48|, p0, p0 + f16, p0, |(if (f16 in v49) then v49[f16] else v0)| % f16, p0, f16, f16 % p0];
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		for i2 := |((if (f16 in v9) then v9[f16] else "pfnr") + v10)| to |(v12 + v12)| {
			...
			globalState.f13, v13, v14, v10, v14 := f15, fm51(v15[|v15|], |(v18[f16] - {v11, v11})|, |multiset{if (v14 in v19) then v19[v14] else f15, f15, f37, f15}|, globalState), (|fm56(f37, f15, f37, globalState)| * v14) % v14, v10, f16 + v14;
		...
		var v25 := DC1(f38);
		var v26: C1 := new C1(fm64(!f37, f38, f16, 0x169, globalState) >= v24[f38 := f16], v10[|v24|], v25.cf1, f16);
		var v27 := DC21(v10);
		...
		globalState.f12, globalState.f1, globalState.f5, v26, globalState.f13 := match v27 {
			...
			case DC17(cf29) => f38
			case DC19(cf33) => f15
		}, f16 >= ((if (v26.f33 in v31) then v31[v26.f33] else f16) / ---42), v33.cf75, f38;
		var v34: map<bool, array<int>> := map[!f15 := v11];
		var v35: array<array<int>> := new array<int>[12] [v11, v11, if (f38 in v34) then v34[f38] else v12[f16], v11, if (f15) then v11 else v11, v11, v11, v11, v11, v11, v11, DC0(v11).cf0];
		v35[515] := v11;
		var v36: map<int, bool> := map[f16 := f38];
		var v37: seq<map<int, bool>> := [v36, v36];
		v35[515] := if (v37 < (seq(0x46, i3  => (v36)))) then v11 else v11;
		var i4 := 0;
			...
			decreases 100 - i4
		{
			...
			var v43: multiset<map<int, int>> := multiset{map v42 : int | (0x3f <= v42) && (v42 < -0x222) :: (v42 % f16) := (v39[f16])};
			var v44: array<seq<int>> := new seq<int>[9] [v39, [-f16], v40, (v39 + v39)[|v41| := |v43|], v40, v39, v39, v40, v40];
			v44[104] := v40 + [f16];
			v44[104] := v40;
			if (v26.f32) {
				var v45 := 0x1e3;
				...
				v54[738] := v55 + fm43(v26.f32, v26.f33, {|v55|, f16, f16, f16}, f38, globalState);
				var v56: set<bool> := {v55[f16], v26.f32};
				var v57: map<set<bool>, seq<bool>> := map[v56 := v55];
				v54[738] := if ({f15, f37, v26.f32} in v57) then v57[{f15, f37, v26.f32}] else v55;
				globalState.f12 := v26.f32;
				v35[515][42] := f16;
				var v58: seq<string> := [v10[v53 := v26.f33], seq(653, i5  => (v26.f33))];
				var v59: set<string> := {v10 + v10, v58[f16] + v10, v10};
				v35[515][42] := |v59|;
			}
	...
	method m1(globalState: GlobalState) {
		var v0: set<bool> := {f37};
		var v1: seq<int> := [|(seq(510, i0  => (|map[|multiset{f15}| := f16]|)))|, f16];
		...
		match (fm67(globalState)) {
			...
			case DC17(cf29) =>
				...
				var v16: array<seq<int>> := new seq<int>[28] [v1, v1, v1, v1, v1, [f16], seq(0x2fd, i3  => (f16)), [f16, f16], [|[|v13|]|, f16], v1, v1, v1, v1, v1, seq(0x1c6, i4  => (f16)), [|v14|], if (f38 in v15) then v15[f38] else v1, v1, v1, seq(189, i5  => (f16)), v1, v1, [|cf29|, |v14|], seq(273, i6  => (|cf29|)), v1, v1, v1, seq(0x69, i7  => (f16))];
				...
				var v21: map<map<bool, bool>, bool> := map[fm58(v1[fm2(v14, globalState)], globalState) := f38];
				...
				if (f37) {
					...
					v20, globalState.f1 := v20 + v33[|v14|], v11[500];
					v30[697] := v30[697];
				}
			...
			case DC19(cf33) =>
				...
				v36, v37, globalState.f7 := -0x278 % |(if (f37 in v39) then v39[f37] else v38)|, fm59(v36 % v36, globalState), f37 ==> f37;
				if (f15 <==> f38) {
					v36 := f16;
					globalState.f7 := f38;
					...
					var v41: array<int> := new int[20](i8 => i8 % |"lp"|);
					v41[798] := v36;
					var v42: seq<string> := [seq(-0x23d, i9  => (v5))];
					var v43: seq<string> := [v42[f16]];
					v41[798] := |(v42[0x1c3] + v35[v36 := v5])|;
				} else {
					...
					var v49: array<map<int, seq<int>>> := new map<int, seq<int>>[22](i12 => map v48 : int | (0x44 <= v48) && (v48 < 0xcb) :: (v48 / v36) := (v1));
					var v50: map<int, seq<int>> := map[f16 := v1[v36 := |v45|]];
					v49[219] := v50 + v50;
					globalState.f12, v44[513], v47, v49[219] := f15, fm2(v35, globalState), v47, v50;
					var v51: multiset<int> := multiset{f16};
					var v52: array<char> := new char[7];
					var v53: array<multiset<int>> := new multiset<int>[6] [v51, v51 + multiset{v44[513], |[v52, v52, v52]|}, multiset{v44[513]}, v51, multiset{v36}, v51[f16 := f16]];
					v53 := v53;
					v44 := v44;
					var v54 := DC10(v0);
				...
				v60[266] := v36 % v36;
				v60[266] := DC18(f38, 0xeb, f38).cf31;
		}
			...
			decreases 100 - i15
		{
			...
			var v64: set<int> := {346};
			v63[440] := |v61| % |v64|;
			v63[440] := if (true) then -v1[f16] else f16;
			v63[440] := |v1|;
			var v65: array<char> := new char[26](i16 => 'm');
			v65[60] := v5;
			var v66: multiset<int> := multiset{f16 * 0x1be};
			v63[440], v65[60], globalState.f13, v62 := -(if (v62 in v66) then v66[v62] else f16), v5, f38, v63[440];
		}
		if (match DC11(v1) {
			case DC12() => !!f37
			...
			v68 := v68[v67[f16 := seq(0x312, i17  => (v5))] := fm53(f37, f15, f38, |v69|, globalState)];
			var v70: set<int> := {-v62};
			v2 := v2[v70 > v70 := fm53(false, f37, f38, |fm68(globalState)|, globalState)];
			v62 := -f16;
			globalState.f5 := f38;
			var v71: array<int> := new int[6];
			var v72: map<string, array<int>> := map[if (f37) then v61 else fm55(globalState) := if (v69[f16]) then v71 else v71];
			v62 := -|v72|;
		} else {
			...
			if (if (fm44(v61, multiset(v75), f37, f38, globalState)) then fm53(f37, f37, !!f15, f16, globalState) else f16 == f16) {
				...
				v62 := v62 / 664;
				var v83: set<int> := {-f16};
				var v84: map<int, bool> := map[f16 := (set v82 : int | (868 <= v82) && (v82 < 0x180) :: (v82 - v1[|v61|])) !! v83];
				var v85: array<int> := new int[20](i18 => i18 % v62);
				v85[788] := f16 / v62;
				var v86: seq<string> := [v61];
				var v87: map<int, string> := map[f16 := v86[f16] + (seq(0x17b, i19  => (v5)))];
				globalState.f5, v62, v84, globalState.f1, v85[788] := true, f16 - 36, v84[-0x30a * f16 := v83 >= v83], !(f15 || f15), |(if (f16 in v87) then v87[f16] else v61[v62 := v5])[0x260 := fm51(f38, f16, -v62, globalState)]|;
				globalState.f7 := f15;
				v62 := if (f38) then 0xd2 + v62 else v85[788];
			} else {
	...
	method m11(p0: bool, p1: D12, globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: int) {
		...
		v0 := v0 + v0;
		for i0 := f16 % f16 to 0x78 {
			var v1 := 'y';
			var v2: seq<char> := ['w', v1, v1];
			var v3: multiset<bool> := multiset{f38};
			var v4: array<bool> := new bool[6] [-f16 < i0, f38 || p0, f38, false, fm44(v2, v3[f37 := f16], f15, f15, globalState), f38 || p0];
			v4[564] := p0;
			var v5: map<bool, char> := map[f15 := v1];
			var v6: map<string, map<bool, char>> := map[seq(0x7e, i1  => (v1)) := v5];
			var v7 := DC32(v6);
			var v8 := DC36(v7);
			v4[564], r0, r1, v1, v8 := p0, i0, -i0 % i0, v2[f16], v8;
			if (f37) {
				var v9: set<int> := {0x23f, i0};
				var v10: seq<bool> := [!f37, p0];
				r0 := |(if (f16 < i0) then fm43(f15, 'p', v9, f38, globalState) + [p0, v4[564]] else v10)|;
				...
				var v19: seq<seq<bool>> := [([f38])[f16 := p0]];
				var v20: multiset<int> := multiset{i0, f16};
				var v21: map<array<bool>, multiset<int>> := map[v4 := v20];
				v16 := v16[v18.cf69 % |v19| := |(v21 + v21)|];
				var v22: map<int, bool> := map[i0 := !f38];
				var v23: array<int> := new int[17];
				var v24: set<array<int>> := {v23};
				v4 := new bool[10] [if (p0) then if (i0 in v22) then v22[i0] else p0 else f38, !(f16 == i0), p0, v20[f16 := 0xe0] == v20, v10[|"chtbvnveo"|], v4[564], -i0 != f16, f15, v4[564], |v24| <= fm1(globalState)];
				r3 := |v9| + f16;
				r1 := i0;
			} else {
				globalState.f7 := v4[564];
				var v25 := DC7({v3, v3});
				...
				var v27: seq<bool> := [p0];
				var v28 := DC8(true, i0);
				var v29 := new C1(p0, fm51(fm44(v2, v3, f37, v4[564], globalState), fm1(globalState), |v27|, globalState), f37, 95 % v28.cf14);
				v4[564] := true;
			}
			...
			var v38 := DC17(v37);
			v30[775], v31, r3, r3, v30[705] := fm2(if (true) then v2 else v36.cf24, globalState), v31 + v31, fm2(v2, globalState), i0, -((|v38.cf29| * f16) * i0);
			var v39 := new C2(f16, v4[564], f16);
		}
		...
		v43[872] := |(v45 - v45)| / (fm0(if (239 in v46) then v46[239] else f16, f37, p0, p0, globalState) + |v47|);
		var v48 := DC35(f38, v43[872], v43[872], true);
		for i3 := if (v48.cf63) then 921 else f16 to f16 {
			...
			v42, v56[959] := v42 + v42, if (v57[v43[872]]) then if (f15) then p1 else p1 else p1;
			var v58 := 'g';
			var v59: map<bool, multiset<int>> := map[f37 := v45];
			var v60: array<bool> := new bool[21](i6 => f15);
			var v61: seq<array<bool>> := [v60];
			var v62: array<bool> := new bool[15] [(seq(0x98, i5  => ('y'))) != v42, !p0, i3 < f16, p0 || f38, f15, v42[i3 := v58] == v42, v45 < (if (f38 in v59) then v59[f38] else v45), !(v61 == DC50(v61).cf83), false, i3 > i3, f37, !true, false, f37, f15];
			v62[845] := f37;
			v62[845] := p0;
			r2 := f37;
		}
...
class C4 extends T0 {
	...
	function fm1(globalState: GlobalState): int {
		-(|(map v0 : int | v0 in map[|[|map[false := |"lmyqcn"|]|]| := |[map[true := 'l'], map[true := 'r'], map[true := 'o']]|] :: (v0 / |multiset{!false, false, false, false, true}|) := (map[true := |[true]|]))| % -641)
	}
	function fm2(p0: string, globalState: GlobalState): int {
		|({!!true, true, true} - {false})| + |((seq(0x14c, i0  => ('t'))) + (seq(-0x11c, i1  => ('w'))))|
	}
	function fm39(globalState: GlobalState): map<bool, int> {
		(map[!!true := |[false]|] + map[false := |{true, true}|]) + (map[false := |[|(seq(0xed, i0  => ('o')))|]|] + map[false := |DC25([true]).cf43|])
	}
	function fm40(globalState: GlobalState): int {
		|map[|(set v0 : int | v0 in [0x28c] :: (v0 % |{621, |DC15(false, "kxx", map v1 : char | v1 in map['b' := |multiset{0x97, |map[true := false]|}|] :: (v1) := (DC5(true, true))).cf24|}|))| * -822 := 'w']|
	}
	method m1(globalState: GlobalState) {
		var v0 := false;
		var v1: seq<bool> := [v0];
		var v2 := 934;
		var v3 := DC25(v1[v2 := v0]);
		var v4: seq<map<bool, D10>> := [map[v0 := v3]];
		var v5 := 'm';
		var v6: map<map<bool, D10>, char> := map[v4[-v2] := v5];
		v6 := v6 + v6;
		var i0 := 0;
		while (v0)
			decreases 100 - i0
		{
			...
			if (v0) {
				...
				var v22: array<int> := new int[17] [if (!!true) then fm0(|v10|, v0, v0, v0, globalState) else |v16|, -0x90 % v2, |v18.cf49| / v2, |v19|, v2, |v20|, v2, 0x109, v2, v2, v2, v2, fm0(|v19|, v0, v0, v0, globalState), v2, |v9|, v2, -|map[v2 := v0]|];
				v22[986] := if (v0) then v2 else fm1(globalState);
				v22[986] := |v7[652]| % v2;
				var v23 := DC39(v21, v2, 0x2fc);
				var v24: map<array<int>, bool> := map[v22 := v22[986] == v23.cf68];
				var v25: set<seq<int>> := {v20, v21};
				var v26: map<int, set<seq<int>>> := map[v22[986] := {[v2]}];
				...
				var v43 := DC0(v38);
				var v44: array<seq<array<int>>> := new seq<array<int>>[21] [v39 + (if ((map v41 : int | v41 in v42 :: (v41 % -0x36f) := (v31)) in v40) then v40[map v41 : int | v41 in v42 :: (v41 % -0x36f) := (v31)] else v39), v39, if (v0) then [v38, v38, v38] else v39, [v38, v43.cf0], v39, v39, v39, v39, v39, v39, v39, if (v32.f32) then v39 else v39, v39, v39, v39 + v39, v39, v39, v39, v39, v39, v39];
				v44[721] := v39;
				v44[721] := v39;
			...
			if (v2 == v2) {
				...
				var v64 := DC41(map[|v62| := v7[652][v2]]);
				var v65: array<int> := new int[8] [v2, |v64.cf71|, 328, v2, v2 * v2, v2, -(v2 + v2), if (v2 in f36) then f36[v2] else v2];
				v65[729] := v2;
				v2, globalState.f12, v63, v65[729] := fm2(v62, globalState), v0, v63, v2;
				globalState.f13 := !(fm51(v0, v2, v2, globalState) !in v62);
				var v66 := new C3(if (v0 in v57) then v57[v0] else !v0, if (v0) then v0 else v0, v0, v2 % |v62[v65[729] := v5]|);
			} else {
				...
				v69[60] := f36[v67 := v74.cf2] != (map v75 : int | (-0x383 <= v75) && (v75 < -0x52) :: (v75 / v67) := (0x3bf));
				var v76: array<array<int>> := new array<int>[15];
				var v77: array<int> := new int[3];
				v76[602] := v77;
				v76[602] := v77;
				var v78: seq<array<bool>> := [v69, v69, v69];
				var v79: array<array<bool>> := new array<bool>[17] [v69, v69, v69, v78[v67], v69, v69, v69, v69, v69, v69, v69, if (v0) then v69 else v69, v69, v69, v69, v69, v69];
				v79[90] := v69;
				v69[60], v79[90], v2, globalState.f5, globalState.f5 := v1[v2], v69, (fm40(globalState) % |v73|) / v67, true, v70;
				v69[60] := v0;
			}
		...
		for i1 := -v2 + |v82| to v2 * v2 {
			...
			var v86: seq<int> := [|[v2, |(seq(797, i3  => (v85.f33)))|]|];
			var v87: seq<int> := [|((seq(484, i2  => (|"udvuf"|))) + v86)|, v2];
			globalState.f5, v2, v86 := v85.f32, v2 * (|(map v88 : int | (0x2d6 <= v88) && (v88 < 0x2ae) :: (v88 - i1) := (v2))| / v2), v86;
		}
...
class C5 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if (f15) {
			...
			v1[16], globalState.f7, v1[105], r1 := if (v3 in v4) then v4[v3] else 0x111, p0 != |(v2 + v2)|, p0 - f16, p0;
			var v5: map<int, array<bool>> := map[-545 := v3];
			var v6: multiset<bool> := multiset{f15};
			v3 := if ((v1[16] - |v6|) in v5) then v5[v1[16] - |v6|] else v3;
			var v7: map<bool, seq<bool>> := map[f15 := [f15, f15]];
			var v8: map<seq<int>, bool> := map[[f16, p0] := f15];
			v1[16] := |v7[f15 || f15 := [f15] + [if (fm38(|v2|, globalState) in v8) then v8[fm38(|v2|, globalState)] else f15]]|;
			...
			var v14: map<bool, array<char>> := map[f16 !in (seq(0x359, i0  => (p0))) := if (f15) then v13 else v13];
			...
			if (v20 == (if (f15 in v21) then v21[f15] else v20)) {
				...
				v28 := v28;
				var v29: seq<string> := [seq(0x3e3, i2  => ('g'))];
				var v30 := 'o';
				...
				var v35 := DC30(v34[f16]);
				var v36 := DC30(v35.cf53);
				r1, v19, v32, v32, globalState.f12 := |v36.cf53|, "b" + v19, v32, seq(-0x2e0, i3  => (f16 - f16)), f15;
				...
				globalState.f12, v37[56], v40 := f15 || f15, if (v41.cf63) then f16 else f16 / 986, v40;
				...
				v44[976] := v19;
				v44[700] := v19;
				v44[976], v44[700], v37, v38.f39, v32 := f34, (fm55(globalState) + (seq(0x2c4, i4  => ('e')))) + f34, v37, v37[56] - v32[v37[56]], [-f16] + (if (f15) then v32 else v32);
			}
			
			globalState.f1 := f15;
			var v45: multiset<bool> := multiset{f15};
			var v46: seq<bool> := [f15, f15];
			var v47: seq<bool> := [true, fm44(f34, v45, v46[p0], false, globalState)];
			globalState.f13 := v47[f16];
		}
		...
		var v53: set<int> := {f16};
		v51 := map[map v52 : int | v52 in v53 :: (v52 / p0) := (f16) := f15] + v51;
		r1 := p0 % p0;
		var v54 := 'c';
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		match (v2) {
			case DC1(cf1) =>
				...
				var v6 := DC44(f15);
				var v7: multiset<int> := multiset{fm0(-|multiset(v5[f16])|, v6.cf76, v4.f37, !true, globalState)};
				v7 := v7;
			case DC2(cf2, cf3, cf4) =>
				...
				if (v8 !! (v8 - v8)) {
					...
					v12, v12[79], v12, cf2, v12[1] := v12, !(((seq(0x3d6, i2  => (v0)))[cf2 := v0] + f34) == (if (f15 in v13) then v13[f15] else f34)), v12, cf2 + -f16, !!f15;
				} else {
					cf3 := cf3;
					v1[5] := fm1(globalState);
			...
			case DC0(cf0) =>
				...
				v1[564], v26, v28 := f16, (v26 + v26) + v26[f16 := |v29|], v28;
		...
		var v31: array<string> := new seq<char>[4] [seq(456, i5  => (v0)), seq(23, i6  => (v0)), f34, f34];
		var v32: map<array<string>, int> := map[v31 := f16 * f16];
		v32 := v32[v31 := f16];
		globalState.f13 := !f15;
		var v33: seq<bool> := [f15, f15, fm41(f15, f16, globalState)];
		var v34: map<seq<bool>, int> := map[v33[-0x5b := f15] := -fm1(globalState)];
		v34 := v34;
		var v35 := "dw";
		v35 := f34;
	...
	method m1(globalState: GlobalState) {
		for i0 := f16 to f16 {
			...
			match (v2.(cf12 := v1)) {
				case DC8(cf13, cf14) =>
					...
					var v12: array<int> := new int[14] [|v3[|(multiset{i0})[i0 := i0]|]|, cf14, cf14, |f35|, i0, f16, cf14 - i0, v9.cf27, i0, i0, f16, f16 / f16, -601, |(map[f16 := v10] + v11)|];
					v12[751] := cf14;
					v12[751] := -(|(v4 + v4)| * f16);
				...
				case DC7(cf12) =>
					...
					v16[155] := if (!f15) then f15 else f15;
					var v17: seq<int> := [f16];
					var v18: set<seq<int>> := {v17, seq(523, i1  => (|[f15]|)), v17, v17};
					var v19: seq<seq<int>> := [v17];
					var v20: multiset<seq<int>> := multiset{[-i0, |(seq(-0x4b, i2  => ('f')))|, i0, f16, f16], seq(0x1a2, i3  => (|(seq(-0x12d, i4  => ('h')))|))};
					var v22: seq<set<seq<int>>> := [v18, v18, {v19[i0]}, v18, set v21 : seq<int> | v21 in v20 :: (v21)];
					var v23 := 'g';
					var v24: array<set<seq<int>>> := new set<seq<int>>[9] [{v17}, if (f15) then v18 else v18, v18, v18, v18, v18, v22[i0], fm72(f16, f35, v23, globalState), {v17}];
					v24[572] := v18;
					var v26: array<map<bool, seq<D6>>> := new map<bool, seq<D6>>[19](i5 => if (f15) then map[true := seq(-0x7b, i6  => (DC16(DC13(i0, v17, DC4(map[f15 := f15], f15, {f35[f15 := |map[v23 := true]|], f35, map[f15 := i0], map[f15 := |v0|]}), f15), |"umhoc"|, v23)))] else map[f15 := [DC16(DC13(i0, v17, DC4(map[f15 := f15], f15, set v25 : map<bool, int> | v25 in {f35} :: (v25)), true), i0, 'b'), DC16(DC13(i0, [i0, f16], DC4(map[f15 := false], f15, {f35[f15 := i0]}), f15), i0, v23)]]);
					...
					globalState.f13, v16[155], v24[572], v26[147], v32 := if (f15) then f15 else f15, if (f16 in v33) then v33[f16] else f15 <== f15, {v17} * (v18 + v22[0x2e9]), v31, "eoxnchf" + f34;
					var v34: array<set<string>> := new set<string>[18];
					v34[114] := set v35 : string | v35 in map[f34 := f16] :: (v35);
					var v36: set<string> := {f34};
					v34[114] := v36;
					var v37: seq<bool> := [v16[155], v16[155]];
					var v38: seq<bool> := [v37[f16]];
					var v39 := DC25(v38);
					var v40: map<bool, D10> := map[!v16[155] := v39];
					v40 := v40[f15 := v39];
					var v41 := 0xf1;
					v41 := i0;
			}
			...
			if (!f15) {
				...
				v57[884] := v58[f34 := f15] + v58;
				v57[884] := (fm73(globalState))[seq(0x245, i8  => ('r')) := f15];
				v42 := -(f16 - i0);
				globalState.f5 := f15;
				var v59: seq<bool> := [f15];
				var v60 := DC18(f15, i0, f15);
				var v61 := DC25(v59[v60.cf31 := f15]);
				globalState.f0 := v61.cf43 + v59[v54[82] := f15];
			}
			...
			decreases 100 - i9
		{
			...
			var v64: seq<int> := [f16, v63[f16], f16, f16];
			var v65 := 'f';
			var v66: T2 := new C1(f15, v65, false, f16);
			var v67: map<T2, bool> := map[v66 := v66.f15];
			var v68: seq<T2> := [v66];
			var v69: multiset<int> := multiset{v66.f16};
			v64 := ([f16 / |v64|, |v67[v68[fm0(f16, f15, v66.f15, f15, globalState)] := !v66.f15]|, v66.f16])[v64[|f34|] := |(multiset{v66.f16, -v66.f16} * v69)|];
			var v70 := 0x11c;
			v70 := f16 - (v70 % |fm55(globalState)|);
			var v71: array<int> := new int[20](i10 => i10 % 0x1c7);
			...
			var v78: array<int> := new int[12] [v70, v66.f16, v70, |(v73 + v73)|, fm2(f34, globalState), v66.f16, f16, v70, |(v76[v70])[v74 := f16]|, v66.f16, v66.f16, |v77|];
			v78[586] := 0x26a;
			v78[586] := f16;
			var v79: set<int> := {---624};
			globalState.f5 := (v69[--v66.f16 := |v79|] + v69) !! v69;
		}
		var v80: array<int> := new int[17];
		v80[106] := f16;
		var v81: map<bool, bool> := map[f15 := f15];
		var v82: seq<int> := [f16];
		var v83: set<map<bool, int>> := {fm59(v82[|v62|], globalState), f35};
		var v85 := DC4(v81, true, set v84 : map<bool, int> | v84 in v83 :: (v84));
		v80[106] := match if (f15) then v85 else v85 {
			case DC4(cf6, cf7, cf8) => f16 % f16
...
class C6 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v13 := DC13(|v10.cf65|, seq(0x141, i0  => (f16)), v12, f15);
		var v14 := DC16(v13, p0, v0);
		var v15 := DC29(f15, p0, f15);
		var v16: multiset<char> := multiset{'f'};
		var v17: seq<int> := [p0, |v16|];
		var v18: map<int, char> := map[p0 := fm35(seq(0x30b, i1  => (v0)), f15, |v17|, globalState)];
		...
		r1 := f16;
		var v22: seq<bool> := [f15];
		var v23, v24, v25, v26 := m0(v22[f16], globalState);
		var i2 := 0;
			...
			decreases 100 - i2
		{
			...
			match (v10.(cf65 := map[f16 := v7] + v9)) {
				case DC37(cf65) =>
					...
					var v28: map<multiset<array<int>>, bool> := map[v27 + v27 := !v25[337]];
					globalState.f12, v7[85], globalState.f7, v1, v7 := if (v27 in v28) then v28[v27] else v26, f16, !!!(v25[337] || (0x5c <= v23)), v1, v7;
			...
			v25, v25[540] := v30[p0], |(map[!!f15 := if (p0 in v31) then v31[p0] else 0x2c6] + v11)| > f16;
			globalState.f13 := v26;
		}
		r0 := v26;
		var v33 := DC2(f16, set v32 : int | (-0x351 <= v32) && (v32 < 0x12e) :: (v32 / v23), v26);
		r1 := v33.cf2 * p0;
	}
	method m3(globalState: GlobalState) returns (r0: bool) {
		if (f16 != f16) {
			...
			v1[9] := (|v0| + f16) + f16;
			if (true) {
				var v2 := DC2(|{f15}|, {v1[9]}, f15);
				var v3: map<bool, int> := map[f15 := v2.cf2];
				var v4: seq<int> := [if (f15 in v3) then v3[f15] else v1[9]];
				var v5: seq<string> := [v0];
				var v6 := DC35(f15, |v5|, v1[9], true);
				var v7: set<int> := {v1[9]};
				var v8 := DC39(v4, v6.cf61 + v1[9], |multiset{v1[9], -668, 0x21d, |v7|, |v4|}|);
				v8 := v8.(cf68 := v1[9] - f16);
				var v9: map<seq<int>, int> := map[v4 := f16];
				v9 := v9[v4 := v1[9]];
				v4 := v4;
				var v10 := DC18(f15, v1[9], f15);
				v1[9] := v10.cf31;
				var v11: seq<bool> := [f15];
				globalState.f1 := v11[-0x31a];
			} else {
				...
				var v21 := new C0(v19.(cf6 := v20[v1[9]], cf8 := {v14, v14, v15}));
				v1 := v1;
				var v22: set<bool> := {f15, f15};
				var v23: T1 := new C3(f15, f15, f15, f16);
				var v24 := DC34(v23, v23.f15, v1[9]);
			...
			var v41: array<seq<map<bool, int>>> := new seq<map<bool, int>>[28] [v37, v37 + v37, seq(0x280, i1  => (v36)), (seq(0x49, i2  => (v36))) + v37, [v36] + [v36, v36], v37, v37, v37, v37, [v36, map[f15 := 203], v36], v37, v37, v37, v37, v37, seq(339, i3  => (DC17(v36[false := f16]).cf29)), v37, [v36, v36] + v37, v37 + v38[f16], v37, [v36[f15 := f16], v36, v36, v36], v37, v37, v38[0x218], if (f15 in v39) then v39[f15] else v37, seq(-630, i4  => (v36)), v37, [v36] + (fm74(v40, globalState))[f16 := map[f15 := f16]]];
			v41[851] := v37;
			v34, v35, v41[851] := v34, v35[f16 := f15], v37 + ([map[f15 := f16], v36, v36, v36, v36] + v37);
			var v42 := 0x3bd;
			var v43 := "ebpfga";
		...
		for i5 := v54 to v54 {
			if (f15 <== f15) {
				...
				var v64: seq<bool> := [v59.cf54, v61 !in map[v61 := v62], !v62[|v63|]];
				v54 := |v62|;
				globalState.f1 := v62 <= v64;
				var v65: array<int> := new int[20](i6 => i6 / v54);
				v65[929] := 0x178;
				v65[929] := f16;
				v65[929] := v54;
			} else {
				...
				v68 := ((v68 + v68) + [v67, v67, v67, v67])[v58.fm1(globalState) := if (f15) then v67 else v67];
	...
	method m1(globalState: GlobalState) {
		...
		if (fm44(v2, v3 - v3, true, f15, globalState)) {
			...
			v4[948], v6, v6 := v5, fm32(v7 - v7, globalState), --v6;
			globalState.f7 := f15;
			...
			var v17: map<int, int> := map[if (f15 in v3) then v3[f15] else f16 := |v16[f16 := v14]|];
			var v19: seq<int> := [f16, f16, f16, f16, f16];
			v17 := map v18 : int | v18 in (v19 + v19[f16 := f16]) :: (v18 / |v17|) := (0x79);
			var v20 := 0x167;
			...
			if (v22[v20]) {
				...
				v20 := v20 / v20;
				v20, globalState.f12 := |[f15, true, f15]| % (if (|v19| in v27.f36) then v27.f36[|v19|] else f16), (v20 / f16) == f16;
				var v28 := new C5(seq(0x3af, i2  => (v1)), v27.fm39(globalState), f15, v20);
			}
		...
		var v31 := DC20((seq(0x361, i3  => (map[DC18(f15, f16, v29[f16]) := |{f16}|])))[f16 := map[v30 := |"hc"|]]);
		var v32: set<D8> := {v31};
		if (v29[|v32|]) {
			v1 := v1;
			var v33 := 894;
			...
			if ((|v45| + f16) < (-0x256 + |v38|)) {
				...
				v41, v36, globalState.f1, v53[791], v39 := v41, v39, (-0x2ff <= v36) in fm59(|v55.cf15|, globalState), v54 + v54, fm32(v56, globalState);
				...
				v41[54] := ({v61, v61, v61} - {v61}) >= {v61};
				v0[70] := v39;
				v0[70] := v36;
			}
			
			v41[256] := v42;
			v41[256] := f15 <== (fm41(f15, v36, globalState) || v42);
		}
		
		var v62: set<bool> := {f15, false, f15};
		var v63 := DC10(v62);
		var v64: map<bool, D4> := map[f15 := v63];
		var v65 := DC26('h', v64, |(seq(-0xb0, i7  => (v1)))|, seq(176, i8  => (v1)));
			...
			decreases 100 - i9
		{
			...
			if (f15) {
				...
				var v73: set<int> := {v68};
				v68, v68, v70[148], v72 := v69.f39, v69.f39, |({0x352} - v73)| != f16, (v72 + map[v70 := v71]) + v72;
			} else {
				var v74 := 784;
				v74 := f16;
...
class C7 extends T2 {
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		for i0 := f30 to |v0| - f16 {
			...
			var v12: seq<int> := [v3.f16, v11[|v2|], 0x109, f30];
			var v13: seq<bool> := [(seq(0x4e, i1  => (f30))) <= v10];
			v4, v5, v6[888], globalState.f1, f31 := (v4 + v4) + v4, v5, v8, v13[v3.f16 - f16], v10[v3.f16];
			...
			var v17 := new C1(multiset{!v3.f15, v3.f15} > v16, v1, f15, f31 % |map[|v13| := multiset([0x3b3, f31, v3.f16, f16, f31])]|);
			var v18 := new C1(false, v17.f33, --v3.f16 > v10[f30], v10[f31]);
		}
		...
		var v27: array<D0> := new D0[28] [v24, v24, DC2(f31, v23, f15), v24, v24, DC2(|v26|, {|map[v19[478] := f30]|, 0x3d9, f31, v19[478], |v20|}, f15), v24, v24, fm22(globalState), v24, fm22(globalState), v24, v24.(cf2 := f16), v24, v24, DC2(f16, v23, f15), v24, v24, DC2(f30, v23, f15), v24, v24, v24, v24, fm22(globalState), v24, v24, v24, v24];
		v27 := v27;
		r0 := f15;
		r1 := -(f31 % f30);
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v10: map<int, map<int, int>> := map[f30 / (if (f15 in v7) then v7[f15] else |v8|) := v9];
		...
		var v17 := 'y';
		v5[857], r0, v10, v11 := (f30 * f31) < |v12|, (v13 + (set v14 : int | v14 in v13 :: (v14 - -0x66))) > {|v15|}, v10 + map[p0 := map v16 : int | (0x3e7 <= v16) && (v16 < 0x22d) :: (v16 + p0) := (f30)], v11.(cf13 := v17 in v1);
		if (f15) {
			...
			var v21 := DC28(v20);
			var v22: array<multiset<int>> := new multiset<int>[29] [v20, v20, if (v5[857]) then v20 else v20, multiset(v12), v20, v20 * v20, multiset{f30, |v1|}, v20, v20, v20, v20, v20, v20 + v21.cf49, v20, v20 * v20, v20, v20, v20, v20, v20, v20, v20 - v20, v20, v20 * v20, v20, v20, v20, v20 + multiset{f31}, v20 * multiset{f31, |v8|}];
			v22[666] := v20 * v20;
			v22[666] := multiset{f16 + 0xa2};
			match (v6) {
				case DC4(cf6, cf7, cf8) =>
					var v23 := new C0(v4.f29.(cf8 := cf8));
					var v24: array<D1> := new D1[5](i1 => DC6(DC4(cf6, v5[857], v2)));
					...
					var v30 := DC29(cf7, f16, v5[857]);
					r1, f31, globalState.f1, globalState.f12, r1 := v27.cf31, |v29| / v30.cf51, fm19(0x121, !f15, v1 + (seq(847, i2  => (v17))), v17, globalState), v8[f31] && (v5[857] && v5[857]), fm0(f16, f15, !cf7, f15, globalState);
					var v31: multiset<multiset<char>> := multiset{multiset(v1)};
					var v32: multiset<char> := multiset{v17};
					var v33: seq<multiset<char>> := [v32];
					var v34: multiset<D0> := multiset{fm31(v5[857], globalState)};
					var v35: map<bool, multiset<D0>> := map[v31 >= multiset(v33) := v34];
					v35 := map[if (cf7) then f15 else f15 := v34];
				case DC5(cf9, cf10) =>
					globalState.f13 := v5[857];
					var v36: array<D7> := new D7[5](i3 => DC17(v7));
					var v37 := DC9(v1);
					var v38: set<D3> := {DC9(seq(-0x190, i4  => ('r'))), v37, v37};
					var v39: map<array<D7>, set<D3>> := map[v36 := v38];
					v39 := v39[v36 := {v37.(cf15 := seq(-0x122, i5  => (v17)))}];
					cf9 := v5[857] <==> v5[857];
					var v40: T1 := new C3(v5[857], true, v5[857], f16);
					var v41 := DC34(v40, v5[857], |v7|);
					var v42 := DC36(v41);
					v42 := if (v40.f15) then v42 else v42;
				case DC3(cf5) =>
					globalState.f5 := !v11.cf13;
					f30 := -|v1[|{v5[857]}| + -f30 := fm35(v1, f15, f16, globalState)]|;
					f31 := p0;
					v18[337] := fm0(980, v5[857], !f15, f15, globalState) / -300;
					v1, v18[337] := v1, f30 + 0x24d;
				case DC6(cf11) =>
					f31, v1, globalState.f1, f31, f31 := -f16, fm55(globalState) + v1, f31 == f16, |DC13(|v13|, v12, v4.f29, !v5[857]).cf19| * p0, p0;
					var v43: multiset<bool> := multiset{f15, v5[857]};
					...
					v46[51] := new bool[22] [false, v5[857], v5[857], false, f15, |v12| == -246, v5[857], true, v5[857], v22[666] !! v20, f15, p0 == (v47.(cf50 := v5[857])).cf51, !f15 <== v5[857], v5[857], f15, v5[857], v5[857], v5[857], v12 < v12, v5[857], !(if (p0 in v48) then v48[p0] else false), v5[857]];
					v1 := v1;
			}
			...
			var v55: map<array<multiset<bool>>, C0> := map[v54[f30] := v4];
			v52[429] := if (v53 in v55) then v55[v53] else v4;
			globalState.f1 := !v8[-f30];
			if (f15) {
				...
				globalState.f5, v5 := !((v1 + v1) < v61[p0]), v5;
				var v62: C2 := new C2(-772, v5[857], p0);
				...
				v65 := v65;
				v10 := fm76(v5[857], fm35(v1, v5[857], f31, globalState), globalState);
				f30 := -0xf5;
			}
		...
		for i6 := f16 to |v1| {
			globalState.f1 := f15 <== v5[857];
			v1 := v1;
			var v66: set<char> := {v17};
			v5[857] := !DC55(v66, v5[857]).cf95;
		...
		match (v75.(cf96 := v74)) {
			case DC54(cf91, cf92, cf93) =>
				...
				v76[740] := v77;
				v76[740][298] := f30;
				v76[740][298] := if (true) then -cf91 else f31;
				var v78: array<T2> := new T2[24];
				var v79: T2 := new C1(f15, 'u', v5[857], v73.f39);
				v78[636] := v79;
				v78[636] := v79;
				f30 := 305 % |v1|;
			case DC55(cf94, cf95) =>
				var v80: seq<array<bool>> := [v5, v5, v5, v5];
				var v81 := DC22(v80[f30]);
				match (v81) {
					case DC23(cf37, cf38, cf39, cf40, cf41) =>
						...
						var v84: array<int> := new int[12] [f16 / 0x195, |fm72(cf37, v7, 'b', globalState)|, p0, f16, f16, if (v5[857]) then p0 else f16, f16, v73.f39, -f31, v73.f39, |v1|, v73.f39 * p0];
						v84[485] := cf40 + 0x2db;
						var v85: array<seq<int>> := new seq<int>[2];
						v85[471] := [f30, cf37, f16, cf37, f16];
						var v86: map<bool, array<int>> := map[v5[857] := v84];
						var v87: map<int, array<int>> := map[|v12| := v84];
						v83, v84[485], v85[471], v86, v5[857] := v83, -0x329, fm46(v1, f30, v73.f39, globalState), map[cf41 && cf41 := if (|cf94| in v87) then v87[|cf94|] else v84], !cf41;
						var v88: map<bool, string> := map[f15 := v1];
						var v89: map<string, bool> := map["cihkmgupx" := fm53(f15, false, true, |v1|, globalState)];
						v83, v80, v84[485], cf40 := v83, ([v5])[v73.f39 := v5], |v88[cf95 := v1]|, v73.fm50(if (v1 in v89) then v89[v1] else v5[857], cf41, globalState);
					case DC22(cf36) =>
						var v90 := DC10(v15);
						...
						var v99: multiset<bool> := multiset{cf95, !v5[857], v5[857]};
						globalState.f7 := fm44(v98.cf24, v99, f15, cf95, globalState);
						var v100: map<int, char> := map[v73.f39 := v17];
						var v101: seq<string> := [if (f15) then v1[f30 := if (f31 in v100) then v100[f31] else 'a'] else v1, "wfoco" + v1];
						v101 := (if (true) then ([v1, seq(0x38c, i9  => (v17)), v1])[-v73.f39 := v1] else v101) + v101;
						var v102: multiset<array<bool>> := multiset{cf36, cf36, v5};
						var v103: map<multiset<array<bool>>, bool> := map[v102 := false];
						v103 := v103[v102 := v5[857]];
					case DC24(cf42) =>
						var v105 := DC35(f15, v73.f39, fm0(p0, v5[857], f15, f15, globalState), cf95);
						var v106: seq<D13> := [v105, DC35(f15, 0x271, -0x69, v5[857])];
						var v107: map<map<D13, bool>, int> := map[map v104 : D13 | v104 in v106 :: (v104) := (f15) := v73.f39];
						var v108: map<D13, bool> := map[v105 := v5[857]];
						...
						v114 := v114[v109[v73.f39] := cf95];
						var v115: multiset<char> := multiset{v17};
						var v116: map<int, bool> := map[-|v115| := v5[857]];
						var v117 := new C3(false, v5[857] <== (if (p0 in v116) then v116[p0] else cf95), v0 != v0, f30);
				}
			...
			case DC53(cf90) =>
				...
				var v121 := new C2(0x234 * v73.f39, !v5[857], |(v120 + v120)|);
				r1 := f31 - 0x160;
				var v122 := DC11(v12);
				v122 := v122;
				var v123: multiset<bool> := multiset{v5[857]};
			...
			case DC56(cf96) =>
				...
				v128[791] := if ((if (f15 in v132) then v132[f15] else v129) in v131) then v131[if (f15 in v132) then v132[f15] else v129] else v130;
				v128[791] := v130;
		...
		r0 := f15;
		var v134: multiset<bool> := multiset{fm41(true, -0x270, globalState), v5[857]};
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		if (fm41(!f15, f30, globalState) || true) {
			...
			var v9 := DC10(v8);
			v7[472] := |v2| >= |v9.cf16|;
			v6, v7[472], globalState.f12, v1, globalState.f1 := v6 * v6, false, v3 !in (v2 + (seq(0x1e7, i1  => (v3)))), v1, f15;
			var v10 := new C6(v7[472], f16);
			f31, f30 := |(seq(0x63, i2  => (v3)))| * (f30 - f30), f30 + f16;
		} else {
			if (f15) {
				...
				v11, globalState.f1, globalState.f13, f30, globalState.f1 := if (f15) then v11 else if (!f15) then v11 else v11, (seq(-0x32f, i4  => (0xa7))) <= (if (f15 in v13) then v13[f15] else v12), v16.cf21, f30, f15;
				var v17 := 'i';
				...
				globalState.f1 := false;
				var v21: map<bool, char> := map[v20.f37 := v18[v12[f16]]];
				var v22: array<char> := new char[20] [v17, v17, v17, v17, v17, v17, v17, v17, v17, if (v20.f38 in v21) then v21[v20.f38] else v17, v17, if (v20.f38) then 'a' else v17, v17, v18[f31], v17, if (v20.f38) then 'k' else v17, v17, v17, v17, v17];
				v22[895] := v17;
				v22[895], v17, globalState.f1 := v17, v17, fm44(seq(-542, i5  => (v17)), v19, v17 !in v18, v20.f37, globalState);
			} else {
				...
				v23[269] := if (v25 in v24) then v24[v25] else |v28[f31]|;
				v23[269] := |multiset{f30 * |[f16]|, if (DC35(f15, 0x385, |[f15]|, f15).cf60) then f16 else |v26|, f31, fm1(globalState), f31}|;
			...
			var v37: seq<int> := [f31];
			var v39: set<string> := {seq(647, i6  => ('o'))};
		...
		match (v51) {
			case DC44(cf76) =>
				...
				v52[310] := "ww" < (if (f16 in v54) then v54[f16] else v58.cf47[|v59| := v48]);
				v52[310] := v50.f32;
				...
				var v66: array<int> := new int[21] [f16, f31, -f16, f30, 0x21c, |v53| * f30, |v61| / |"ty"|, 0x2a5, f30, |(map[|v55| := v50.f32] + v62)|, f16, 0x271 % f16, f30 + f30, |v63|, f30, if (v52[310] in v64) then v64[v52[310]] else |v61|, f30, f30, f31, |v65|, f16];
				v52, v66, f31, globalState.f13, v52[310] := if (cf76) then v52 else v52, v66, f31, f15, false;
			case DC43(cf75) =>
				var v67: map<int, char> := map[f31 * 0x7f := v48];
				var v69 := DC60(map v68 : int | (0xfe <= v68) && (v68 < 0x39b) :: (v68 / f30) := ('p'));
				v67 := v69.cf101 + v67;
				globalState.f13 := f15;
		...
		while (match fm77(f15, |v83|, fm78(f15, globalState), v50.f32, globalState) {
			...
			case DC7(cf12) => (seq(983, i11  => (v50.f33))) != v83
		})
			decreases 100 - i10
		{
			if (i10 >= 100) {
			...
			var v84: map<map<bool, bool>, string> := map[v0 := seq(0x13, i12  => ('b'))];
			v84 := v84;
		}
		r0 := v50.f32;
	}
	method m1(globalState: GlobalState) {
		...
		match (v1.(cf57 := v0)) {
			...
			case DC35(cf60, cf61, cf62, cf63) =>
				...
				var v14: seq<int> := [479, v0.f16, |(if (v11.cf92) then v13 else v13)|, |(seq(-0x1a5, i0  => ("iuu")))|, cf62 / -0x3d5];
				v14 := v14;
				var v15 := "x";
				v15 := "jhb" + v15;
				f31 := 0x13;
				if ((seq(-0x36e, i1  => ('a'))) <= (if (v0.f15) then seq(0x343, i2  => ('h')) else v15)) {
					var v16: map<int, int> := map[v0.f16 := f30 / f16];
					...
					var v19 := 'e';
					v18 := v18[fm19(0x111, f15, seq(445, i3  => ('e')), v19, globalState) := 3];
					cf60 := cf63;
					v17[659] := v17[659];
				} else {
					f30 := -v0.f16;
					...
					v22[812] := v10[fm33(v26, globalState) := v0.f16];
				}
			...
			case DC32(cf55) =>
				...
				var v34: array<map<int, multiset<bool>>> := new map<int, multiset<bool>>[18] [v29, v29, if (v0.f15) then map[v0.f16 := multiset{f15}] else v29, v29 + v29, v29, v29, v29, if (v30 in v31) then v31[v30] else v29, v29, map v32 : int | v32 in fm75(v0.f15, f30, f15, globalState) :: (v32 % f31) := (multiset(v27)), v29, v29, v33[f16], v29, v29, v29, v29 + map[f31 := v28[v0.f15 := v0.f16]], v29];
				var v36: seq<int> := [v0.f16];
				v34[347] := map v35 : int | v35 in v36 :: (v35 / f30) := (multiset{f15});
				...
				v34[347], v37[773], f30, globalState.f5, v42 := v29, v39 + v39, f30, v0.f15 && !(v0.f16 <= fm0(f31, v0.f15, v0.f15, v0.f15, globalState)), v42 - {v30, v30};
			...
			case DC36(cf64) =>
				...
				v50[81] := v0.f15;
				var v52 := "aualuwa";
				v50[81] := (v0.fm2(v52, globalState) * v0.f16) <= f30;
				var v53: array<array<D18>> := new array<D18>[17];
				var v54: seq<bool> := [f15];
				var v55: seq<int> := [v0.f16];
				var v56: seq<seq<int>> := [v55, v55, v55];
				v53, globalState.f5, f31, globalState.f1 := if (f15) then v53 else v53, v54[v0.f16 + v0.f16], fm0(304, if (v0.f15) then v0.f15 else v50[81], v0.f15, f15, globalState), v55 < (v55 + v56[v0.f16]);
				var v57, v58, v59, v60 := m0(if (v50[81]) then f15 else !v0.f15, globalState);
		}
		...
		match (DC33(v0.f15)) {
			case DC33(cf56) =>
				...
				if (!!v0.f15) {
					...
					v73[134] := v0.f16 == f16;
					v71[534], v71[534], v73[134], v66 := f16, f16, if (v0.f15) then v0.f15 else !!!v0.f15, fm51(!v0.f15, f31, v0.fm2(v61, globalState), globalState);
				} else {
					var v74 := 'g';
					v74 := v74;
			...
			case DC34(cf57, cf58, cf59) =>
				...
				var v89: seq<int> := [f16];
				var v90: array<int> := new int[21] [-|v81|, if (cf58) then cf59 else |v84|, 0x163 % f16, -v0.f16, f30, DC13(cf59, [f16], v87, cf58).cf18, if (f30 in v88) then v88[f30] else cf57.f16, 0x358, |v82|, f31, f30 / cf57.f16, v0.f16, -0x391, f30, f30, cf59, f31, v89[-cf59], cf59 - f16, if (!v0.f15) then v0.f16 else f16, |(seq(0x1cd, i8  => ('k')))|];
				v90 := v90;
				f31 := f31;
			case DC35(cf60, cf61, cf62, cf63) =>
				...
				var v96: array<multiset<bool>> := new multiset<bool>[10] [multiset(v94), v95, v95, v95[v0.f15 := f30], v95, v95, v95, multiset{f15, f15}, v95, v95];
				v96[846] := multiset{f15} + v95;
				var v97: set<multiset<int>> := {v93, v93};
				v96[846] := (v95 - v95)[cf63 := |v97|];
				var v98 := 'i';
				...
				match (v101) {
					case DC54(cf91, cf92, cf93) =>
						...
						v102 := (seq(-0xd9, i9  => (cf62))) + v102;
						cf91 := cf91;
					case DC55(cf94, cf95) =>
						var v103: array<char> := new char[17];
						var v104: map<string, array<char>> := map[seq(0x27e, i10  => (v98)) := v103];
					...
					case DC53(cf90) =>
						...
						var v111 := DC22(v108);
						cf60, globalState.f7, cf90.f39, globalState.f12, v108 := v94[cf90.f39], f15, cf90.f39 - (f16 - |v110|), if (v0.f15 in v91) then v91[v0.f15] else !(v0.f15 in v94), v111.cf36;
						globalState.f13 := cf63;
						var v112: array<int> := new int[4];
						var v113: seq<array<int>> := [v112, v112, v112, v112];
						v108[623] := v94 == fm56(false, v0.f15, cf63, globalState);
						var v114: map<int, bool> := map[-(cf90.f39 + cf61) := !v0.f15];
						v113, cf62, globalState.f1, v108[623] := v113 + v113, f16, v0.f15, if (|multiset{v0.f16}| in v114) then v114[|multiset{v0.f16}|] else true;
					...
					case DC56(cf96) =>
						...
						globalState.f12 := v116[|v117|] >= v115;
						globalState.f5 := -198 > f16;
						var v118: map<bool, int> := map[v94[cf62] := v0.f16];
						var v119: seq<map<bool, int>> := [map[cf63 := -0x25c]];
						var v120: set<map<bool, int>> := {v118, v119[v0.f16]};
						var v121: map<bool, int> := map[DC4(v91, cf60, v120).cf7 := if (f16 in v93) then v93[f16] else -v0.f16];
						f31 := cf62 % (if (v0.f15 in v118) then v118[v0.f15] else |v96[846]|);
			...
			case DC32(cf55) =>
				...
				var v125 := "hksfemb";
				v124[790] := v125 <= (seq(0x129, i13  => ('l')));
				var v126: map<string, string> := map[v125 := "watp"];
				v124[790] := "tvmtwvoej" <= (if (v125 in v126) then v126[v125] else v125);
				f31 := 0x3af;
				var v127: map<int, int> := map[0x167 := v0.f16];
				var v128 := 'r';
				var v129: set<char> := {v128};
				var v130: set<int> := {|v127|, v0.f16 % f31, |(v129 * v129)|};
			...
			case DC36(cf64) =>
				...
				f30 := (|v135| % |v142|) / |({true} + fm36(f15, v0.f16, v145, globalState))|;
				...
				v148[222] := v147;
				v148[222], globalState.f12, v146.f39 := v147, f15, (f16 + v0.f16) / -(f16 * f30);
		...
		match (DC23(f16, |[if (v152 in v154) then v154[v152] else v153]| / f31, v156, f31, f30 < f16)) {
			case DC23(cf37, cf38, cf39, cf40, cf41) =>
			...
			case DC22(cf36) =>
				...
				globalState.f12 := v160[v0.f16];
				var v161 := DC22(cf36);
				f30, v161, globalState.f7 := (v0.f16 * v0.f16) / |map[f15 := f30]|, DC22(cf36), f15;
				globalState.f1 := !f15;
			case DC24(cf42) =>
				if (f15) {
					f31 := v0.f16;
					...
					f31 := if (v0.f15) then |v153| * v167[f30] else f30;
				} else {
					v155[878] := v0.f15;
					v155[542] := v0.f15;
					var v168 := 'v';
					...
					var v172 := DC26(v153[|v153|], v171, 0x2b7, v153);
					...
					v155[878], globalState.f12, globalState.f0, v155[542] := v0.f15, v173 > v173, v174, (multiset{v0.f16} + v175) !! (v175 + multiset{|v169|});
					var v176: map<int, bool> := map[f30 := v0.f15];
					v176 := v176[v0.f16 := v0.f15];
					v155[878] := v0.f16 != |v153|;
				...
				var v184 := DC26(v180, map[v0.f15 := v182], -f30, (seq(0x245, i15  => (v180)))[|v183| := v180]);
				var v185 := DC27(DC27(v184));
				var v186: map<bool, D4> := map[v0.f15 := v182];
				var v187: array<D10> := new D10[28] [fm79('f', v0.f15, globalState), v185, v185, DC27(DC27(v184)), v185, v185, v185.(cf48 := v184).(cf48 := v184), v185, DC27(DC25(v179)), v185, v185, DC27(v184), DC27(v184), v185, v185, v185, v185.(cf48 := v184), v185, v185, v185, DC27(DC26(v180, v186, v0.f16, seq(-0x1fa, i16  => ('q')))), v185, DC27(v184), v185, v185, v185, v185, v185];
		...
		match (v190) {
			case DC1(cf1) =>
				...
				f30, v192, v153 := 0x32d, fm28(f31 % f30, v0.f15, globalState), v153 + ((if (v0.f15 in v193) then v193[v0.f15] else v153) + fm23(globalState));
				v155[692] := !v0.f15;
				...
				v155[692] := !(if (v0.f15) then [v0.f15] <= v195 else v0.f15);
				var v196 := 'n';
				var v197 := DC21(v153);
				var v198 := new C3(DC52(v196).cf89 in v197.cf35, v0.f15, if (v155[692]) then !v155[692] else v0.f15, f31);
			...
			case DC2(cf2, cf3, cf4) =>
				...
				if (!!cf4) {
					...
					globalState.f13 := (v213 > v213) || fm19(|v215|, v0.f15, seq(0x340, i17  => (v205)), v205, globalState);
					v156[676] := v156[676];
					v189[621] := v0.f16;
					v189[621] := f30;
					var v216: map<char, string> := map[v205 := v153];
					var v217: array<string> := new seq<char>[16] [seq(0x10d, i18  => ('k')), v153, v153, (seq(-693, i19  => (v205)))[0xff := v205], v153 + v153, v153, fm55(globalState), v153[|(if ('p' in v216) then v216['p'] else ("fkytywkvj")[f30 := v205])| := v205], seq(426, i20  => ('p')), v153, ("ph")[cf2 := v205], v153, v153, v153 + v153, v153[f30 := v205], v153];
					v217 := v217;
			...
			case DC0(cf0) =>
				...
				v155[647] := (v218 + v218) <= (if (fm44(v153, v219, v0.f15, v0.f15, globalState)) then v218 else fm56(f15, v0.f15, !!v0.f15, globalState));
		}
...
class C8 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if (f15) {
			...
			var v4 := DC4(fm14(f28, globalState), if (f15 in v0) then v0[f15] else v1[f28], v3);
			var v5 := new C0(v4);
			v0 := v0;
			...
			match (v11) {
				case DC4(cf6, cf7, cf8) =>
					...
					v13 := v13[cf7 <==> fm16(f15, f27, f15, f15, globalState) := if (v14 in v15) then v15[v14] else v16[fm0(f16, cf7, fm16(cf7, |v18|, cf7, cf7, globalState), cf7, globalState)]];
					var v19: array<array<int>> := new array<int>[27];
					v19 := if (false) then v19 else v19;
					v13 := v13[f15 := f28 % 0xab];
				case DC5(cf9, cf10) =>
					r1 := -p0;
					var v20 := DC8(f15, f16);
				...
				case DC3(cf5) =>
					...
					v27[726] := if ((f27 > |v30|) in v29) then v29[f27 > |v30|] else v28;
					globalState.f5 := !f15;
					v28[143] := f27 <= 321;
					var v31: seq<bool> := [f15, f15];
					v28[143] := [f15] != (if (false) then v31 else v31);
					var v32: map<multiset<bool>, int> := map[cf5 := -(if (v28[143]) then f28 else p0)];
					v32 := v32[cf5 + cf5 := -f16];
				case DC6(cf11) =>
					...
					var v40 := 'p';
					var v41 := "tfoegwl";
					globalState.f5, v37[579], v33, globalState.f5 := !(v39 >= v39), !f15, v33, v40 !in v41;
					v37[579] := f15;
					var v42: map<bool, bool> := map[f15 := !f15];
					var v43: map<bool, int> := map[v37[579] := |v41|];
					var v44: set<map<bool, int>> := {v43};
					var v45 := DC4(v42, !fm16(v37[579], |map[v33 := -0x1fe]|, v37[579], true, globalState), v44);
					var v46 := new C0(v45);
			}
			
			var v47 := "otrs";
			var v48 := 'd';
			globalState.f7 := |v47[p0 := v48]| > -f28;
			var v49: seq<int> := [f27];
			v49 := v49;
			...
			globalState.f1, f28, v47 := f15, fm2(v57[|v47|], globalState), (v47 + v47)[v49[f28] := v48];
		}
		
		for i2 := f27 - p0 to f16 {
			f27 := (0x91 % -i2) / 0x2dc;
			var v58: map<bool, bool> := map[false := f15];
			var v59 := DC4(v58, true, fm17(|(seq(0x52, i3  => ('b')))|, f28, f16, globalState));
			globalState.f5 := !v59.cf7;
			var v60: array<int> := new int[4](i4 => i4 % f16);
			var v61: seq<bool> := [f15, f15, f15];
			v60[273] := |([f15, f15] + v61)|;
			var v62: seq<int> := [-f16, f28];
			var v63: map<bool, seq<int>> := map[true := DC11(v62).cf17];
			v60[273] := |((if (f15 in v63) then v63[f15] else v62[p0 := p0]) + (seq(0xb9, i5  => (f28))))|;
		...
		if (f15) {
			...
			if (!(v65 >= v65)) {
				...
				var v68: seq<bool> := [f15, true, v67[f28]];
				globalState.f12 := if (v68[f16]) then !f15 else f15;
			...
			if (f15 <== f15) {
				...
				v89 := v89;
				var v90: seq<int> := [f27];
				globalState.f13 := fm16(fm16(true, v90[p0], f15, f15, globalState), f28, if (f15) then !!f15 else f15, f15, globalState);
				...
				var v95: T2 := new C7(f16, f27 + f28, !f15, if ((seq(-0x286, i6  => (v81))) in v94) then v94[seq(-0x286, i6  => (v81))] else f16);
				v95 := v95;
				...
				r1 := -(if (v101[v95.f16] !! v101[f16]) then f28 else f16);
			}
			...
			v102[905] := -(if (f15 ==> v104.cf21) then p0 else |(([v103])[|[f15, f15]| := v103] + v105)[-0x21f := [f28]]|);
		} else {
			if (f15) {
			...
			var v132: map<int, bool> := map[if (f15 in v130) then v130[f15] else |v131| := v131[f27]];
		...
		for i8 := 0x3ce to -(0x32 * 0x6e) {
			...
			globalState.f7 := (fm0(|v135|, f15, !f15, f15, globalState) * f16) >= -(|v136| % f28);
			var v137: array<int> := new int[2] [i8, |(v135 + (v135[f16 := p0])[f28 := p0])|];
			v137[983] := f27;
			...
			v137[983], globalState.f13, v138, f28, v140 := |v143|, v144.cf88, v138, f28, v140;
			r1 := i8;
		}
		r0 := f15;
		r1 := 661;
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		var v8: set<int> := {f16};
		var v9 := 'q';
		var v10: array<bool> := new bool[29] [!f15, |v0| !in v2[f16 := f16], f28 >= f27, if (f15 in v3) then v3[f15] else f15, f27 < (if (f15 in v4) then v4[f15] else f16), true, !f15, f15 ==> v5[f16], v6 in v7, if (f15) then f15 else f15, !(v8 !! v8), f15 <== f15, f15, f28 >= f16, f15, f15, false, f15, f15, f15, v9 !in v1, f15, f15, f15, f15, if (f15) then f15 else f15, f15, f15, false];
		v10[309] := f15;
		v10[309] := f27 != f27;
		var v11 := new C1(f15, v9, f15, |"lsug"|);
		var v12: array<array<bool>> := new array<bool>[10];
		var v13 := DC23(|v1[f28 := v9]|, |v1|, v12, -f28, v10[309]);
		...
		v10[309] := --(694 % |v16|) != -|(if (f15) then if (f28 in v17) then v17[f28] else v1 else v18[f16])|;
		forall i1 | 0 <= i1 < v10.Length {
			v10[i1] := if ((seq(0x36, i2  => (v11.f33))) <= (seq(0x157, i3  => (v11.f33)))) then v10[309] else false;
		}
		r0 := v11.f32;
	}
	method m1(globalState: GlobalState) {
		...
		if (f15) {
			...
			if (v2.f37) {
				...
				var v14: map<bool, bool> := map[v2.f38 := v7[v5.f39]];
				...
				v17 := v17[0x7f := fm33(DC26(v18, map[v2.f37 := DC10(v19)], v13.f31, seq(-0x3b5, i1  => (v18))), globalState)];
...
class C9 extends T1 {
	...
	function fm11(p0: bool, p1: bool, p2: int, globalState: GlobalState): int {
		|(DC9(seq(0x13c, i0  => ('n'))).cf15 + "aggdfsn")|
	}
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		globalState.f12, globalState.f1, r1, globalState.f13, globalState.f12 := f15, fm11(f15, false, |{p0, |v2|}|, globalState) >= |v3|, f16, f15, if ((p0 / f25) in v4) then v4[p0 / f25] else f15;
		var v5 := new C4(v2 + v2);
		var v6 := DC25(v3);
		var v7 := DC27(v6);
		var v8 := DC27(v7);
		...
		match (v9) {
			case DC26(cf44, cf45, cf46, cf47) =>
				...
				v11, globalState.f12, v12, v15, cf47 := v11 + v11, (p0 - cf46) != (p0 % p0), v12, v15, cf47;
				globalState.f12 := f15;
				var v16 := DC25(v3);
				match (v16) {
					case DC26(cf44, cf45, cf46, cf47) =>
						...
						v10[112] := fm12(v19.cf2, v22, v23, f15, globalState) % p0;
					...
					case DC27(cf48) =>
						...
						cf46 := -f16 * f25;
						v13[941] := f15;
						v13[941] := if (f15) then f26 != f16 else if (f15) then false else f15;
			...
			case DC25(cf43) =>
				if ((f15 ==> f15) <==> true) {
					...
					v48[47] := f15;
					var v49: array<seq<seq<int>>> := new seq<seq<int>>[24](i1 => seq(0x13c, i2  => ([f26])));
					var v50: seq<int> := [v41.fm1(globalState), f26];
					var v51 := "rsmogmbus";
					var v52: seq<int> := [v50[65], DC49(cf43, |fm80(cf43[0x321], f25, 'o', globalState)|, |v51|).cf81, f25];
					v49[357] := [v50];
					var v53: seq<seq<int>> := [v52, v52];
					v48[47], v49[357], r1, r1 := if (!fm44(v51, v1, f15, v41.f37, globalState)) then -p0 != fm2(v51, globalState) else v41.f37, v53[p0 := [f16]], f26, f26;
					v51 := v51;
				} else {
					globalState.f13 := !f15;
					var v54 := "rsx";
			...
			case DC27(cf48) =>
				...
				v61[369] := f15;
				v61[369] := !((p0 % f26) > (p0 * f26));
				var v62: map<seq<bool>, int> := map[[f15, v61[369]] + v3 := -(p0 % f25)];
				var v63: seq<int> := [-f25];
		...
		for i3 := -0x3a3 to f16 {
			if (f15) {
				...
				var v74: array<int> := new int[26](i5 => i5 % v71.f30);
				v74[607] := f16;
				v74[607] := f25;
				var v75 := "cenlykx";
				v73 := v71.f30 / |(fm55(globalState) + v75)|;
				v71.f31 := p0;
			}
			
			var v76: map<bool, seq<bool>> := map[f15 := v3 + v3];
			v3 := if (f15 in v76) then v76[f15] else v3 + v3;
			var v77: array<map<string, int>> := new map<string, int>[6](i6 => map[seq(69, i7  => ('j')) := 0x2b6] + map["rmlyfboi" := f16]);
			var v78 := "owdg";
			var v79: map<string, int> := map[v78 := f25];
			v77[711] := v79;
			v77[711] := if (f15) then v79 + v79 else v79;
			if (f15) {
				r1 := |map[f15 := f15]| - f16;
				var v80: array<int> := new int[27](i8 => i8 - |[f16]|);
				v80 := new int[16];
				var v81 := new C5(v78, map[f15 := f26], f15, f26 / f16);
				var v82 := 'b';
		...
		for i10 := if (false) then f25 else f26 to 0x39d % p0 {
			r1 := 0x1f6;
			globalState.f1 := f15;
			...
			var v110: map<string, int> := map[v108.cf47 := -|v109[f25]|];
			var v111: array<int> := new int[9] [i10 - |v102|, 831, i10, fm0(p0, false, true, !f15, globalState), p0 % --|v103|, -p0, |v110|, i10, f26];
			v111 := if (f15 <== f15) then v111 else v111;
			globalState.f13 := v3[-f26];
		}
	...
	method m3(globalState: GlobalState) returns (r0: bool) {
		...
		if (v2 != (if (!fm16(f15, f26, f15, f15, globalState)) then v2 else v2)) {
			...
			match (v6) {
				...
				case DC34(cf57, cf58, cf59) =>
					...
					var v18: map<array<int>, seq<int>> := map[v16 := (seq(969, i0  => (|map[cf57.f16 := -|v15|]|))) + v17];
					v18 := v18[v16 := v17];
				case DC35(cf60, cf61, cf62, cf63) =>
					...
					var v24 := "jau";
					var v25: array<int> := new int[23] [|v20| - (if (cf63 in v21) then v21[cf63] else cf61), f16 % cf61, cf62, f16, |v23|, 0x391 % 859, cf62, cf61, -f25, f25, 0x28b * |v24|, 0xf1, |v24| / f26, f16, f25, f26, f26, cf62, f25, f16, fm1(globalState), if (f16 in v5) then v5[f16] else cf62, -f16];
					var v28: array<map<int, bool>> := new map<int, bool>[26] [v22, v22, v22 + v22, v22, v22, v22, v22, v22, v22, fm66({f25, -0x27b, -cf62, -f26, cf62}, globalState), v22, v22, map[f25 := cf63], v22, v22 + (map v26 : int | (0x21a <= v26) && (v26 < -0x1e4) :: (v26 / f16) := (cf63)), v22, map v27 : int | v27 in {cf61} :: (v27 % 0x145) := (f15), v22, v22, if (!v3[f16]) then map[f26 := f15] else v22, v22 + v22, v22, v22, v22, v22, ((map[f25 := cf60])[(fm82(f25, f26, cf61, |v3|, globalState)).cf51 := cf60])[f25 := cf63]];
					v28[347] := fm66(v0, globalState);
					var v29 := 'r';
					var v30: map<bool, bool> := map[cf63 := f15];
					var v31: map<bool, bool> := map[cf60 := if (!false in v30) then v30[!false] else cf63];
					v25, v1, cf63, v28[347] := v25, {fm19(f25, cf60, v24, v29, globalState), f15 in v30, cf60}, v21 > v21, v22 + (fm66(v0, globalState) + v22);
					var v32: array<bool> := new bool[6];
					v32[908] := v29 in (seq(0xca, i1  => (v29)));
					v32[908] := f15;
					var v33: map<bool, int> := map[true := -fm0(f25, cf60, v32[908], f15, globalState)];
					v33 := v33[cf63 := 0x120 % |(seq(889, i2  => (cf61)))|];
					var v34: multiset<int> := multiset{f16};
					globalState.f12 := |v34| >= f25;
				case DC32(cf55) =>
					var v35 := 'e';
					v35 := v35;
					globalState.f5 := v3[f16];
					...
					var v44 := DC4(v36, fm41(v40, f25, globalState), {v41, v41, v42[|v43|]});
				...
				case DC36(cf64) =>
					...
					v52[983], v51.f39, v54, v46 := f16, -0x3e5, [v46, 35, v51.f39] + v54, |(v55 + v56[f16])|;
					var v57: C3 := new C3(f15, f15, f15, |v53|);
					var v58: map<bool, C3> := map[v57.f37 := v57];
					var v59 := DC62(v57);
					var v60: seq<C3> := [v57];
					var v61: array<C3> := new C3[27] [v57, v57, if (v57.f37) then v57 else v57, v57, v57, v57, v57, v57, if (false in v58) then v58[false] else v57, v57, v57, v59.cf102, v57, v57, v60[f26], v57, v57, v57, v57, v57, v57, v57, v57, v57, v57, v57, v57];
					v61 := v61;
			}
			...
			v62[377] := if (v63 != v63) then f15 else v65.cf58;
			globalState.f12 := v62[377];
			globalState.f7 := fm53(false, true, f26 > |(set v66 : int | (385 <= v66) && (v66 < 0x12d) :: (v66 / |"w"|))|, f25, globalState);
		} else {
		...
		if (f15) {
			...
			var v78: set<map<int, int>> := {map v76 : int | (-0x2b4 <= v76) && (v76 < 254) :: (v76 % |v1|) := (f26), v77};
			var v79 := "ges";
			var v80: map<int, bool> := map[|v79| := f15];
			globalState.f1, globalState.f7 := f15, |v78| == (0x72 % |v80|);
			var v81 := 277;
			...
			globalState.f0, v81, v82, v83[693], v83[716] := (fm29(v84, globalState))[f16 := f15], f25, v82, (|(seq(694, i5  => ('l')))| % v81) - |v86|, f26;
			v79, v79 := v79, v79[v81 := fm51(f15, f26, |(set v87 : int | v87 in v77 :: (v87 - |map[|(seq(124, i6  => ('e')))| := |multiset{0xeb}|]|))|, globalState)];
			...
			if (false) {
				...
				var v94: map<bool, bool> := map[(fm63(f15, |multiset{0x137}|, v83[693], f15, globalState)).cf1 := f15];
				v93[922] := v94;
				var v95 := DC55(fm84(f26, v83[693], f25, globalState), f15);
				v81, globalState.f12, globalState.f7, v93[922], v81 := f16, f15, (multiset{f15} * v85) < DC54(v81, v95.cf95, v85).cf93, if (true) then v94 + map[false := false] else v94, |map[false in map[f15 := v84[v81]] := f15]|;
				var v96: array<array<bool>> := new array<bool>[19];
				v96[449] := v88;
				globalState.f5, v96[449], globalState.f12, v83[693] := true, v88, true, |(fm23(globalState) + (seq(0x176, i7  => ('n'))))|;
				globalState.f1 := f15;
			...
			var v99 := "vbgwu";
			var v100 := 'p';
			var v101: array<int> := new int[8] [f16, f16, f26, |[v97, |v98|]|, |v99[f26 := v100]|, f16, f16, |v99[f25 := v100]|];
			v101[327] := f16;
			...
			v104[319] := v105;
			v97, v101[327], v101, v103, v104[319] := -v97 * -(f25 - v103.fm2(v99, globalState)), f16, v101, v103, v105;
			v100 := 'k';
			var v106: map<int, int> := map[-116 := f16];
			globalState.f13 := fm41(v103.f32, |v106|, globalState) ==> v103.f32;
			globalState.f12 := f15;
			if (true) {
				var v107 := new C7(-|(seq(0x68, i8  => (v100)))| + v97, f26, v103.f32, f25);
				...
				globalState.f13 := f16 > v101[327];
				var v116: array<bool> := new bool[5];
				v116[613] := f15;
				v116[613] := v103.f32;
				var v117: seq<array<bool>> := [if (v103.f32) then v116 else v116];
				v117, v116[613] := v117, {v97} !! (v0 + v0);
				var v118 := new C5(v99 + "cgqabfte", (map[f15 := v97])[true := f26], v103.f32 || !v103.f32, f25 / v101[327]);
			}
		...
		if (f15) {
			...
			match (v124) {
				case DC29(cf50, cf51, cf52) =>
					...
					v129[722] := cf51 + f16;
					v125[554], v126[196], v129[722], cf51, globalState.f12 := cf52, v127, f25, 0x3a9, v119.f37;
					globalState.f12 := f15;
					var v130 := "mfqeuaotk";
					v130 := seq(847, i10  => ('t'));
				...
				case DC28(cf49) =>
					...
					var v137 := "devuvkh";
					var v138: seq<char> := [if (v135 in v136) then v136[v135] else v132, v132, v137[0x3c6]];
					v132 := v137[f16];
					var v139 := 220;
					v139 := if (v119.f38) then f16 % f16 else |(if (v119.f38) then seq(-0x3a2, i11  => (v132)) else fm23(globalState))|;
					...
					v142[236] := if (v119.f38) then set v143 : int | (0x268 <= v143) && (v143 < 0x49) :: (v143 - f25) else {f26};
					v142[236] := (if (v119.f38) then set v144 : int | (-0x11e <= v144) && (v144 < 0x32f) :: (v144 % |v138|) else v0) * {v139, |v137|, f26};
			}
			...
			v147[848] := f15;
			v147[848] := true;
			var v148: array<string> := new seq<char>[8] [seq(0x21f, i12  => ('e')), v145, v145, v145, v145, v145, seq(186, i13  => ('f')), v145];
			var v149: map<array<string>, bool> := map[v148 := f15];
			globalState.f13 := (if (v148 in v149) then v149[v148] else true) <==> (if (true) then v147[848] else v119.f38);
		} else {
			...
			match (v152) {
				case DC29(cf50, cf51, cf52) =>
					...
					v153[403] := true;
					v153[403] := (f25 % f25) <= (f26 - |fm56(v119.f37, f15, true, globalState)|);
					var v154: set<multiset<bool>> := {multiset{v119.f37, v119.f37, true}};
					var v155 := DC7(v154);
					var v156 := new C8(f25 / f25, f16, v119.f38, cf51 / fm12(f26, v155, map[cf50 := -267], v119.f37, globalState));
					...
					v153[403] := v160 < (multiset(v161) + v160);
				case DC28(cf49) =>
					var v162 := 0x78;
					var v163: map<bool, int> := map[v119.f37 := v162];
					v162 := |v163| % f26;
					r0 := fm1(globalState) != (v162 % -290);
					var v164 := "uwpjujcbm";
					var v165: C5 := new C5(v164, v163, v119.f38, f16);
					var v166: map<bool, C5> := map[v119.f37 := v165];
					var v167: seq<C5> := [v165, v165];
					var v168: array<C5> := new C5[16] [v165, v165, v165, v165, v165, v165, v165, v165, v165, v165, v165, v165, if (!v119.f37 in v166) then v166[!v119.f37] else v165, v165, v167[f25], v165];
					v168[993] := v165;
					v168[993] := v165;
					var v169 := 'e';
					v169 := v169;
	...
	method m1(globalState: GlobalState) {
		...
		if ((if (f15) then v8 else v8[f25 := f15]) == (v8 + v8)) {
			...
			if (v9 in v5) {
				...
				v13[614] := if (f15 in v15) then v15[f15] else if (f15) then v14 else v14;
				var v16: multiset<int> := multiset{f26};
				v12 := (f16 + 0x37e) % (if (-f25 in v16) then v16[-f25] else v12);
				globalState.f5 := f15;
			} else {
				var v17, v18, v19, v20 := m0(f15, globalState);
				var v22 := DC41(map v21 : int | (0x1cc <= v21) && (v21 < -172) :: (v21 / f25) := (true));
				v22 := v22;
				...
				v19[991] := !!(if (v7.cf14 in v25) then v25[v7.cf14] else true);
				var v26 := DC33(v20);
				v19[991] := v26.cf56;
			}
			...
			if (v27 >= v27) {
				...
				v32[105] := v29;
				globalState.f5, v32[105], v9, v28 := false, v29, v9, f26;
				...
				v48 := v48[f26 := v47];
				var v49: seq<string> := [v5, seq(-0x24, i1  => (v9)), v6];
				v6 := v6 + v49[v47.f16];
				v37 := v37 - |v8|;
			}
			...
			var v53: array<multiset<bool>> := new multiset<bool>[22] [v27, v27, multiset(fm56(f15, f15, f15, globalState)), v27, v27, v27, v27, v27, multiset(v8), v27, v27, v27, multiset{f15}, v27, v27, v27, v27, v27, v27, v51[f16], if (f25 in v52) then v52[f25] else v27, v27];
			...
			v59[903] := if (f15) then v60 else v60;
			var v61 := DC61();
			...
			v69[361] := v67;
			v58, v59[903], v61, globalState.f0, v69[361] := |(v6 + (if (f15) then v64.f34 else "ppcsdi"))|, map[!f15 := v55], v61, v8 + [true, f15], v67;
			var v70: seq<int> := [v58, f16];
			var v71: set<int> := {v58};
			var v72: seq<seq<bool>> := [v8];
			var v74: array<bool> := new bool[13] [|v70| < f16, !(v71 >= {f16, |v72[f16]|, fm11(f15, f15, |multiset{0x11e}|, globalState), f25, f25}), !fm19(v58, f15, v5, v55, globalState), !((set v73 : int | (-0xfc <= v73) && (v73 < 0x24) :: (v73 * f16)) != {f25}), f15, f15, f15, f15, false, f15, f15, 'a' !in v64.f34, f15];
			var v75: set<bool> := {!false, f15};
			v74 := new bool[14] [f15, f15, f15 <==> f15, 'd' !in (seq(0x43, i3  => (if (f15 in v59[903]) then v59[903][f15] else v55))), false, f15, v6 != v64.f34, [f15, f15] <= v8, f15, f15, !fm53(f15, f15, f15, |v75|, globalState), f15, f15, f15];
			var v76: map<set<bool>, int> := map[v75 := 0x221 - f16];
			v76 := v76[v75 + v75 := f26];
			var v77: array<array<bool>> := new array<bool>[13];
			var v78: multiset<seq<int>> := multiset{fm28(f16, f15, globalState), (v70 + v70)[|v6| := f25], [f25, v58]};
			...
			v77, globalState.f13, v78 := v77, !(v82.cf7 ==> f15), fm65(("cp" + v64.f34)[|v84| := v55], f26, v85 <= v86[f25], globalState);
		}
		...
		if (f15) {
			...
			v87[673] := v89 - v89;
			v87[673] := set v90 : char | v90 in v5 :: (v90);
			if (f15) {
				globalState.f5 := f15;
				...
				v94[332] := f16 < |v96[|v97|]|;
				v94[332] := f16 > (if ('i' in v92) then v92['i'] else f25);
				var v98 := new C7(f16, -f25, fm16(f15, 0x329, f15, f15, globalState), f16);
				var v99: array<int> := new int[5](i4 => i4 % |v5|);
				var v100 := DC0(v99);
				...
				v107[661] := |(v108 - v108)|;
				v107[661] := if (false) then f25 else f16;
				globalState.f13 := !f15;
			...
			if (f15) {
				...
				var v124: array<array<bool>> := new array<bool>[20] [v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v122, v123[f25], v122, v122, v122];
				var v125 := DC23(f26, f25, v124, -f25, f15);
				var v126: array<int> := new int[11] [f25, |map[f15 := |v113|]|, v117[|v118|], f25, f25, f26, f26, f25, 0x124 + f26, 0x213, fm12(f25, v120, v121, v125.cf41, globalState)];
				v126 := v126;
				v122[212] := f15;
				v122[212] := !f15;
				var v127: map<bool, array<int>> := map[v122[212] := v126];
				v122[212] := !(f16 <= (|v127| % f25));
				var v128 := 0xc7;
				v128 := -f26 / f25;
				var v129 := DC29(v122[212], |v8[f16 := v122[212]]|, v122[212]);
				v121 := v121[v129.cf50 := |((seq(0x2ce, i6  => ('f'))) + v5)|];
			} else {
			...
			v137[865] := false;
			v137[865] := v136.f34 == v5;
			var v138 := -0x310;
			v138 := f25;
			v137[865] := v137[865];
			var v139 := 'm';
			var v140: multiset<bool> := multiset{f15, f15, f15};
			globalState.f12 := fm44(v5[f26 := v139], v140[v137[865] := f16], v137[865], |v136.f34| <= f16, globalState);
		}
		...
		if ((if (v141 in v142) then v142[v141] else f25) > f16) {
			...
			v143[541] := f15;
			v6, v143[541], globalState.f5 := v5, false, f15;
			v141 := v141;
			globalState.f7 := !(v5 != (v5 + (seq(0x351, i9  => ('k')))));
			globalState.f1 := f26 != f26;
			var v144 := 0x226;
			var v145: array<char> := new char[4](i10 => if (v143[541]) then 'j' else 's');
			var v146: seq<int> := [0x206];
			v144, v144, v144, v145, globalState.f1 := |(seq(528, i11  => (f25)))|, (f26 / f26) + (v144 * |v5|), v144 * v146[v144], v145, f16 > f26;
		} else {
			...
			var v153 := DC10(v152);
			var v154: array<bool> := new bool[29] [f15, f15, f15, true, f15, f15, f15, f15, f15, false, f15, f15, f15, f15, f15, f15, f15, f15, v8[v151], f15, f15, v8[|v152|], f15, f15, f15, false, false, fm33(DC26(fm51(f15, f16, f25, globalState), map[f15 := v153], |v6|, v5), globalState), f15];
			...
			match (v176) {
				case DC18(cf30, cf31, cf32) =>
					v160 := v160[v173.f27 % v175.fm32(v152, globalState) := v166.f39];
				...
				case DC17(cf29) =>
					...
					v154[411] := !v8[v163.f16 / -|v182|];
					var v183: seq<int> := [v166.f39];
					var v184: set<int> := {v183[v163.f16]};
				...
				case DC19(cf33) =>
					...
					var v187 := new C8(|map[v185 := v173.f28]|, |v6| / f16, v163.f15, f16 + |v186|);
					var v188 := DC61();
					v188 := v188;
	...
	method m10(p0: bool, globalState: GlobalState) returns (r0: set<int>, r1: bool, r2: array<int>) {
		...
		var v2 := "eacjw";
		v0[558] := if (f26 in v1) then v1[f26] else |v2|;
		var v3: map<bool, bool> := map[f15 := f15];
		...
		v0[558] := if (p0 in v8) then v8[p0] else 0x87;
		v0[558] := f25;
		globalState.f5 := p0;
			...
			decreases 100 - i0
		{
			...
			v13, globalState.f0, globalState.f5, globalState.f7, v0[558] := v13, [f15, f15, !fm53(false, p0, f15, |v14|, globalState), f15], f15, p0, f26;
			globalState.f5 := p0;
		...
		var v18: set<int> := {f25, v0[558]};
		r0 := ({-v0[558]} + (set v17 : int | (-0x49 <= v17) && (v17 < 67) :: (v17 / f26))) * v18;
		r1 := p0;
		r2 := v0;
	}
}
...
class C10 {
	...
	method m8(globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: int) {
		...
		v0[891] := !f24;
		v0[891] := f23 >= f23;
		var v1: set<bool> := {fm9(|map[{fm9(f23, v0[891], globalState)} := 0x1e9]|, v0[891], globalState)};
		f24 := f23 == |v1|;
		r0 := f23 / f23;
		if (f24) {
			var v2 := "edv";
			var v3: seq<string> := [v2, "atmkyrwqo"];
			var v4: map<bool, bool> := map[true := v0[891]];
			var v5: set<map<bool, int>> := {(map[f24 := |(seq(0x357, i2  => ('k')))|])[f24 := f23]};
			...
			globalState.f7 := v0[891];
			r2 := v0[891];
			var v7: seq<array<bool>> := [v0];
			var v8 := 'o';
			var v9: seq<bool> := [f24, v0[891]];
			var v10: map<char, int> := map[v8 := |v9|];
			var v11: map<array<bool>, int> := map[v7[f23] := |v10|];
			v11 := v11[v0 := f23];
			var v12: array<int> := new int[13];
			var v13: array<array<int>> := new array<int>[1] [v12];
			v13[612] := v12;
			var v14: map<bool, array<int>> := map[f24 && v0[891] := v12];
			v13[612] := if (f24 in v14) then v14[f24] else v12;
		} else {
			v0[891] := !false;
			var v15 := new C5(fm10(f23, globalState), map[v0[891] := f23], v0[891], |"pybo"| / f23);
			var v16 := "olo";
			v16 := v15.f34 + (v16 + v16);
			if (f24) {
				...
				var v23: seq<map<bool, int>> := [map[f24 := |v21|], v15.f35[v0[891] := |v22|], v15.f35, map[false := f23], v15.f35];
				v19 := v19[v23[f23] := v18[v17 := false]];
				v16 := v15.f34;
				var v24: map<bool, bool> := map[v0[891] := v0[891]];
				var v25: set<int> := {-0x2cc};
				var v26: multiset<int> := multiset{-f23};
				var v27: multiset<int> := multiset{f23, fm0(-f23, v0[891], f24, v0[891], globalState), if (f23 in v26) then v26[f23] else fm0(f23, f24, f24, v0[891], globalState), -f23};
				...
				v28[412] := if (false) then f23 else f23;
				var v29: map<int, bool> := map[f23 := f24];
				var v30: multiset<bool> := multiset{v0[891]};
				globalState.f7, globalState.f1, v28[412] := -f23 <= |v29|, fm44(v15.f34, v30, f24 || f24, v0[891], globalState), -f23;
				var v31 := 's';
				var v32: map<char, array<bool>> := map[v31 := v0];
				var v33: array<seq<int>> := new seq<int>[8] [[v28[412]], v17, v17, v17, v17, seq(0x1cb, i3  => (v28[412])), [f23, |v32|], [v28[412]]];
				var v34 := DC42(v15.f35, v31, v33);
				var v35: map<int, D17> := map[fm0(f23, v0[891], f24, f24, globalState) + f23 := v34];
				v35 := v35[f23 := v34];
				v28[412] := v15.fm2(v15.f34, globalState);
			} else {
				var v36 := 'a';
				v36 := v36;
			...
			if (f24) {
				...
				var v43: set<multiset<int>> := {v42, multiset{f23}, v42[f23 := f23], v42};
				var v44 := DC35(!f24, f23, f23, v0[891]);
				var v45: map<int, D13> := map[|v43| := DC36(v44)];
				var v46 := DC36(v44);
				v45 := v45[if (true) then -f23 else f23 := v46];
				var v47: array<int> := new int[20](i4 => i4 / |map[f24 := f24]|);
				var v48: seq<array<int>> := [v47, v47];
				r3 := |v48| / f23;
				var v49: map<int, int> := map[|v15.f34| := f23];
				var v50: T1 := new C2(f23, v0[891], 947);
				...
				globalState.f5 := f24;
				var v55: array<string> := new string[14] ["b", v15.f34, v15.f34[--f23 := v53], v15.f34, v15.f34, v16, v15.f34, v16, v16, v15.f34, v15.f34, v15.f34, v15.f34, seq(-224, i5  => (v54.f33))];
				v55[97] := v15.f34;
				v55[97] := seq(685, i6  => (v15.f34[f23]));
			}
		...
		var v58 := "msaxhcb";
		var v59 := 'v';
		var v60: multiset<string> := multiset{v58 + v58[|[f24]| := v59]};
		var v61: map<int, int> := map[f23 := 0x2e8];
		var v62 := DC22(v0);
		r1 := if (((seq(-0x2d6, i7  => (v59))) + v58) in v60) then v60[(seq(-0x2d6, i7  => (v59))) + v58] else if (|{v62, v62}| in v61) then v61[|{v62, v62}|] else |{"br"}|;
	...
	method m9(p0: char, p1: int, globalState: GlobalState) {
		...
		if ((v0[|v4| := 0x3c] * v0) != (if (f24) then multiset([f23, p1]) else v0)) {
			v1[353] := if (f24) then f24 else f24;
			v1[353] := f24;
			if (f24) {
				var v5 := "ci";
				...
				f23 := f23 - p1;
				var v14: multiset<bool> := multiset{v1[353]};
				var v15: seq<bool> := [f24, f24, fm44(['j'], v14, f24, v1[353], globalState)];
				var v16: set<int> := {|fm64(v1[353], v1[353], p1, p1, globalState)|};
				...
				var v23: map<bool, map<D22, int>> := map[f24 := v22[f23]];
				var v24 := DC58(|v17[p0 := p1]|, if (f24 in v23) then v23[f24] else map[v20 := 824]);
				var v25 := DC59(v24);
				var v26: map<bool, D23> := map[v15[if (0x14c in v0) then v0[0x14c] else |v16|] := if (f24) then DC59(v24) else v25];
				v26 := v26[f24 := v25];
				v5 := v5 + "brmnej";
			} else {
				...
				var v35: array<int> := new int[15] [f23, f23, f23, p1, 783, p1, p1, fm0(|v27|, v1[353], v1[353], v1[353], globalState), fm0(|(map v28 : char | v28 in v34 :: (v28) := (0xa7))|, f24, f24, f24, globalState), -f23, f23, p1, |v32|, p1, f23];
				var v36 := DC0(v35);
				v35[692] := |(if (false) then v0 else v0)|;
				var v37: array<bool> := new bool[28] [v1[353], !f24, v1[353], fm53(f24, v1[353], f24, f23, globalState), v1[353], v1[353], v1[353], v1[353], f24, f24, v1[353], f24, true, v1[353], f24, v1[353], v1[353], v1[353], v1[353], f24, v1[353], v1[353], v1[353], f24, f24, !f24, v1[353], v1[353]];
				var v38: map<int, array<bool>> := map[|v32| := v37];
				var v39: seq<int> := [f23, |v38|];
				var v40: set<seq<bool>> := {v27[0xa2 := fm53(v1[353], f24, v1[353], f23, globalState)], fm29(v39, globalState), v27};
				v36, globalState.f13, v1[353], v35[692] := v36.(cf0 := v35), v40 > v40, f24, f23;
				var v41: multiset<bool> := multiset{v1[353]};
				globalState.f13 := fm44(if (f24) then v34 else fm10(p1, globalState), v41, false, v34 == v32, globalState);
				var v42 := new C8(f23, f23, v1[353], v35[692] / f23);
				f23 := -((p1 % v35[692]) + v39[p1]);
				var v43: map<int, bool> := map[f23 := v1[353]];
				var v44: map<bool, int> := map[f24 := -v35[692]];
				v43 := v43[if (v1[353] in v44) then v44[v1[353]] else v35[692] := f24];
			}
			
			globalState.f13 := v1[353];
			var v45: map<int, bool> := map[if (f24) then f23 else f23 := f24];
			if (if (f23 in v45) then v45[f23] else !v1[353]) {
				var v46 := "q";
				...
				var v50: map<bool, bool> := map[v1[353] := v1[353]];
				var v51 := new C2(|v49| % p1, if (f24 in v50) then v50[f24] else v1[353], f23 % f23);
				...
				var v55 := "p";
				v54[826] := (seq(-0x11c, i1  => (p0))) + v55;
				var v56: seq<array<bool>> := [v53, v53, v53, v53, v53];
				var v57 := DC5(f24, v1[353]);
				var v58: map<char, D1> := map[p0 := v57];
				var v59 := DC15(v1[353], v55, v58);
				globalState.f12, v53, v54[826] := !!!f24 <== f24, v56[f23], v59.cf24;
				globalState.f7 := v1[353];
				var v60: map<int, int> := map[v51.f39 := 597];
				v60 := v60[v51.f39 := -p1 / p1];
				var v61, v62, v63, v64 := m8(globalState);
			}
			
			f23 := f23;
		} else {
			var v65 := DC9(seq(0x261, i2  => (p0)));
			v65 := v65;
			...
			if (f24) {
				...
				v1[62] := fm16(f24, f23, f24, false, globalState);
				var v93: seq<seq<int>> := [v69];
				var v95: map<string, bool> := map[v74 := f24];
				var v96: map<set<int>, bool> := map[{|v95|, 677, p1} := v81[p1]];
				v1[62] := map[set v94 : int | v94 in (v93[p1])[p1 := fm0(f23, f24, f24, false, globalState)] :: (v94 / 814) := f24] == v96;
				var v97: array<array<bool>> := new array<bool>[19];
				var v98: seq<multiset<bool>> := [v80];
				var v99: map<int, int> := map[p1 := v69[f23]];
				var v100: T0 := new C4(v99);
				var v101: map<map<T0, bool>, int> := map[map[v100 := f24] := |v74|];
				var v102 := DC8(f24, p1);
				var v103: set<bool> := {f24};
				var v104: array<bool> := new bool[17] [f24, true, f24, f24, v1[62], v81[f23], true, v1[62], f24, f24, fm13(f23, fm77(v1[62], f23, v98, v1[62], globalState).(cf14 := p1), fm13(|v101|, v102, v1[62], fm0(|v103|, v1[62], f24, v1[62], globalState), globalState), f23, globalState), v1[62], f24, true, false, v1[62], f24];
				v97[514] := v104;
				var v105 := DC10({f24, v1[62]});
				var v106: map<bool, D4> := map[false := v105];
				var v107 := DC26(p0, v106, f23, v74);
				v97[514] := new bool[29] [f24, f24 <==> f24, v1[62], f24, true, v74 <= v74, f24, v1[62], v1[62], f24, v80 <= v80, f23 == p1, false ==> true, f24, v1[62], v1[62], !f24, multiset{v103} > multiset{v103}, fm33(v107, globalState), f24, f23 >= -p1, v1[62], v1[62] <== v1[62], v1[62], f24, false, f24, v1[62], if (v1[62] in v82) then v82[v1[62]] else fm41(v1[62], |v69|, globalState)];
				f23 := p1;
				var v108: array<D10> := new D10[24];
				var v109: seq<D10> := [DC25([v1[62]])];
				var v110 := DC27(v109[p1]);
				v108[412] := v110;
				v108[412] := v110;
				globalState.f1 := f24;
			}
		...
		if (fm9(p1, f24 <== !!f24, globalState)) {
			...
			var v116: array<int> := new int[14] [-0x110, |(v112 - v112)|, 0xad, f23, -(f23 / f23), f23, f23, f23, p1, |v113|, p1, p1, p1 + f23, |((if (p1 in v115) then v115[p1] else v114) + v114)|];
			var v117: seq<int> := [|v114|];
			v116, f23 := v116, |(v117[p1 := f23] + (v117 + [|(seq(647, i3  => ('t')))|, p1]))|;
			var v118: array<D15> := new D15[1];
			var v119: array<char> := new char[14](i4 => v114[|v114|]);
			var v120 := DC38(v119);
			v118[995] := v120;
			f23, v118[995] := 0x1a6, v120;
			var v121: seq<string> := [seq(-0x25d, i5  => (p0)), v114, v114];
			var v122 := new C3(f24, v114 <= v114, |v114| < p1, |v121[p1]|);
			f23 := f23;
			v116[790] := v122.fm2("sxcua", globalState);
			var v123 := DC5(v112 >= fm64(v122.f37, f24, p1, f23, globalState), !f24);
			f23, v116[790], f23, v123 := f23, p1, f23, v123;
		} else {
			...
			globalState.f1, v124[590], v128, globalState.f0, globalState.f13 := if (v127.f15) then v127.f15 else !v129[f23], v127, fm51(f24, |multiset(v132)| / |v133|, 0x34a, globalState), v129, v127.f15;
			var v134: array<multiset<int>> := new multiset<int>[10] [v0, v0, v0 * v0, v0, v0, v0, v0, v0, v0 + v0[v127.f16 := v130.f16], v0];
			v134[482] := v0;
			v134[482] := fm25(globalState);
			f23 := v127.f16;
		...
		if (!(true <==> false)) {
			var v137 := "rpxfya";
			var v138: set<string> := {v137, "tnclce", v137, v137[p1 := p0]};
			var v139 := DC14(v138);
			v139 := v139;
			...
			v141[358] := v137;
			globalState.f1, v141[358] := f24, (v137 + v137)[p1 := p0];
			var v142, v143, v144, v145 := m8(globalState);
			var v146 := 'a';
			v145, v146 := |((v137 + (seq(694, i6  => (v146)))) + "laarbma")|, v146;
		} else {
			...
			if (if ((v148 > v148) in v147) then v147[v148 > v148] else f24) {
				...
				v152 := v152[f23 / p1 := !(if (f24) then true else f24)];
				v1[275] := p1 == --p1;
				v1[275] := -0x149 != p1;
				var v153 := "athisawfv";
				var v154: seq<string> := ["kljsp", v153];
				v153 := if (v154 < [v153, v153, v153[f23 := p0], v153]) then fm10(p1, globalState) else "dribkul";
				f24 := v1[275];
				f23 := |v150|;
			} else {
			...
			if (f24) {
				...
				v167[13] := fm89(f24, f23, globalState);
				var v168: map<bool, int> := map[v164.f38 := f23];
				var v169 := DC17(v168);
				v167[13] := v169;
				var v171 := DC55(set v170 : char | v170 in [p0] :: (v170), v164.f37);
				var v173: map<D22, int> := map[v171 := |(set v172 : int | (-128 <= v172) && (v172 < 0x293) :: (v172 / f23))|];
				...
				f23 := |(v179[f23] - fm71(f23, p1, globalState))|;
				var v180 := 'e';
				...
				v182[449] := f23;
				var v183: multiset<string> := multiset{v161, v161, "h", v161, seq(0x25d, i8  => (p0))};
				v182[449], f23, f24, f23, v183 := --p1, 0x24d, !v164.f37, -f23, v183 - (v183 * v183[v161 := f23]);
				globalState.f1 := v164.f38;
				var v184: C5 := new C5("gq" + v161, map[f24 := v182[449]], v164.f38 || v164.f37, f23);
				v184 := v184;
				v184.m1(globalState);
				v182[449] := p1;
			}
...
class C11 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		for i0 := f16 to p0 {
			...
			var v7: set<multiset<bool>> := {fm6(|((seq(0x23e, i1  => (f16)))[p0 := |v0|])[i0 := p0]|, f21, map v4 : multiset<bool> | v4 in v6 :: (v4) := ('k'), f15, globalState)};
			...
			var v13: map<bool, bool> := map[f21 := v12[p0]];
			var v14: map<int, int> := map[|v13| := |"iubbllc"|];
			var v17: map<multiset<bool>, bool> := map[v5 := f15];
			var v20 := DC3(v5);
			var v21 := DC7(v7);
			var v22: array<set<multiset<bool>>> := new set<multiset<bool>>[24] [v7, v7, fm7(v10, fm8(globalState), f21, globalState), v7, v7, if (v12[if (|[f21, f15]| in v14) then v14[|[f21, f15]|] else p0] in v11) then v11[v12[if (|[f21, f15]| in v14) then v14[|[f21, f15]|] else p0]] else {v5}, v7 * v7, v7 * v7, set v16 : multiset<bool> | v16 in (map v15 : multiset<bool> | v15 in {multiset{f21}} :: (v15) := (false)) :: (v16), if (!f15) then v7 else v7, if (f15 in v11) then v11[f15] else set v18 : multiset<bool> | v18 in v17 :: (v18), v7, v7, v7, v7, v7, (set v19 : multiset<bool> | v19 in multiset{v5} :: (v19)) - {v5}, {multiset(v12[i0 := f15]), v5, v20.cf5}, v7, {v5, v5}, v7, v7, v7 * v21.cf12, v7];
			v22[83] := (set v23 : multiset<bool> | v23 in {v5} :: (v23)) + v7;
			var v24: map<D0, int> := map[f22.(cf4 := f15) := |v0|];
			globalState.f7, v3, v22[83], v24, globalState.f12 := f21, v3, v7 - v7, v24 + v24, fm8(globalState);
			...
			decreases 100 - i2
		{
			...
			v34[589], v35, r1, v36[942] := f15 || f15, v37[f16], -f22.cf2, p0;
		}
		r1 := --0x1c3;
		var v38 := "pgr";
		var v39 := 'j';
		var v40: multiset<string> := multiset{v38, (seq(826, i5  => ('r')))[p0 := 'o'], "fuhpobvrs", v38[p0 := v39], v38};
		for i4 := |v40| to 688 {
			var v41 := m7(globalState);
			globalState.f7 := f21;
			var v42: array<int> := new int[21](i6 => i6 / p0);
			...
			if ((v43 + v43) == v43) {
				...
				globalState.f0 := (v46 + v46) + (if (f21) then v46 else v46)[v44.f39 := f15];
				var v47: array<seq<int>> := new seq<int>[17];
				var v48: seq<int> := [f16, p0, |"jtrvfe"|, i4];
				v47[723] := v48;
				v47[723] := fm54(v41, v38, globalState) + v48;
			} else {
		...
		var v62 := DC26(v38[p0], v61, p0, seq(352, i7  => (v39)));
		var v63: array<bool> := new bool[27] [f15, f21, true, false, f15, f15, v58[p0], f15, f21, f21, !f21, fm41(f15, p0, globalState), true, f21, v58[f16], f15, f15, !f21, f21, f15, f15, f21, f15, true, fm33(v62, globalState), false, f21];
		...
		v64[698] := new bool[23] [f15, f21 !in v65[f21 := |v38|], f15, f15, f15, f15, f15, f21, f15, f21, f16 == fm0(p0, f15, f15, f21, globalState), f21, f21, f15, f21, f15, f21, fm10(p0, globalState) < v38, f21, f15, if (|map[f15 := p0]| in v66) then v66[|map[f15 := p0]|] else f21, f21, fm71(0x268, f16, globalState) !! multiset{p0}];
		r0 := f15;
		r1 := f16 / f16;
	}
	method m3(globalState: GlobalState) returns (r0: bool) {
		for i0 := f16 + -0x1f6 to f16 % f16 {
			...
			match (v13) {
				...
				case DC22(cf36) =>
					...
					var v21: array<D10> := new D10[28](i2 => DC27(DC27(DC27(DC27(DC26(v6, map[DC4(v4, v0.f15, {v7}).cf7 := DC10({v0.f15})], |[true]|, seq(0x1c4, i3  => (v6))))))));
			...
			if (v0.f15) {
				...
				v26 := v26[|(seq(0x31e, i4  => (v3)))[f16 := |v11|]| := v0.f15];
				globalState.f5 := f15;
				globalState.f13 := if (v0.f15) then v3 <= |v11| else (seq(-0x1a1, i5  => ('i'))) == v11;
				...
				v29[373] := f15;
				v3, v29[373] := v0.f16, f21;
				var v30: seq<bool> := [v29[373], !v0.f15];
				v3 := |v30|;
				...
				v32, globalState.f7, v3, v33[83], v3 := v32, f21, v3, (|v34| % i0) - |v35|, |v7| * |v4[f21 := v29[373]]|;
				globalState.f5 := f15;
			}
		...
		var v40: seq<array<int>> := [v39[f16], v38];
		...
		v38[146] := v38[146];
		var i7 := 0;
		while ((false <== f15) ==> (v42[v38[146]] && v43.f38))
			decreases 100 - i7
		{
			if (i7 >= 100) {
				break;
			...
			if (v43.f38) {
				var v45 := 'r';
				globalState.f13 := fm19(f16, if (f21) then v43.f37 else f15, fm10(v38[146], globalState), v45, globalState);
				v38[146] := -f16 % |v37|;
				...
				v38[146], v38[146], v46 := -104, v48[f16], v46;
				globalState.f1 := fm8(globalState);
				var v49: array<bool> := new bool[11];
				v49[957] := v43.f37;
				globalState.f13, globalState.f12, v49[957], v38[146], v38[146] := !!!!!(966 < f16) <== v43.f37, f21, false, |(("cy" + v37) + v37)|, f16;
			} else {
				v38[146] := (|v37| / 604) / v38[146];
				globalState.f5 := v43.f37;
				globalState.f7 := v42[|(if (true) then "kyc" else seq(0x390, i8  => ('u')))|];
				var v50: array<char> := new char[27];
				v50[363] := 'g';
				var v51 := 'u';
				v50[363] := v51;
				var v52: array<string> := new string[23] [v37[v38[146] := v51], (seq(0x363, i9  => (v51))) + v37, v37, seq(-0x7, i10  => ('h')), "qo", "cyuv", v37, (seq(640, i11  => (v51))) + v37, v37, v37, v37, v37, v37, "rfbdrriw", "k", v37, v37, v37, seq(184, i12  => (v51)), v37, if (v43.f37) then v37 else seq(0x3c8, i13  => ('b')), v37 + "nbbw", v37];
				v52 := v52;
			}
	...
	method m1(globalState: GlobalState) {
		...
		var v1 := 'i';
		v0[268] := fm19(f16, f21, "oulw", v1, globalState);
		var v2: multiset<bool> := multiset{!f15};
		var v3: set<int> := {f16, f16, |v2|};
		v0[268] := v3 >= v3;
		var v4: array<int> := new int[5](i0 => i0 % f16);
		v4[941] := f16;
		var v5: seq<int> := [f16];
		var v6: map<int, bool> := map[v5[f16] := f15];
		v4[941] := |v6|;
		match (DC59(DC58(v4[941], fm90(f16, f15, f15, globalState)))) {
			case DC58(cf98, cf99) =>
				var v7: seq<bool> := [v0[268], f21];
				...
				match (v8) {
					case DC18(cf30, cf31, cf32) =>
						...
						globalState.f5 := true;
						var v9 := "hsqqu";
						var v10: C8 := new C8(f16, -0x20d, v0[268], |v9|);
						var v11: array<C8> := new C8[10] [v10, v10, v10, v10, v10, v10, v10, v10, v10, v10];
						v11[26] := v10;
						globalState.f13, v11[26] := !(fm9(cf31, !v0[268], globalState) ==> v7[|v9|]), v10;
						var v12: seq<string> := [v9];
						globalState.f1, globalState.f12, globalState.f12, globalState.f7, v10.f27 := f15, v7[f16], v0[268] <==> fm16(cf30, fm1(globalState), f15, v0[268], globalState), |v12[fm2(v9, globalState)]| <= v10.f28, (cf98 * |v5|) - -0x10;
					case DC17(cf29) =>
						v1 := v1;
						globalState.f13 := f21;
						v4[941] := v4[941] / |map[f15 := true]|;
						var v13: set<bool> := {!!f21};
						var v14: map<bool, bool> := map[v0[268] := f21];
						var v15: set<map<bool, int>> := {cf29, cf29};
						var v16 := DC4(v14, f15, v15);
						var v17: seq<set<bool>> := [v13, v13, v13, fm36(v0[268], cf98, v16, globalState), v13];
						var v18: multiset<int> := multiset{f16, v4[941]};
						globalState.f13, v0[268], globalState.f5, globalState.f1 := f21, f21 && (v13 >= v13), v13 > (v17[|v18|] - v13), f15;
					case DC19(cf33) =>
						var v19 := "uqhbxii";
						v19 := v19;
						var v20: array<C1> := new C1[2];
						var v21: C1 := new C1(v0[268], v1, v0[268], v4[941]);
						v20[403] := v21;
						v20[403] := v21;
						cf98 := 0x23c;
						var v22: array<D24> := new D24[7](i1 => DC60(map[v4[941] := v21.f33]));
						var v23: map<array<D24>, array<bool>> := map[v22 := v0];
						v0 := if (v22 in v23) then v23[v22] else v0;
				}
				
				var v24: set<bool> := {v7[|v7|]};
				var v25: map<bool, set<bool>> := map[v0[268] := v24];
				v24 := ((if (f15 in v25) then v25[f15] else v24) * {f21}) * v24;
				v0 := v0;
				var v26: map<bool, array<bool>> := map[v0[268] := v0];
				var v27: seq<array<bool>> := [if (f15 in v26) then v26[f15] else v0, v0, v0];
				var v28 := "vtiavgf";
				var v29 := DC50(v27);
				var v30: map<int, int> := map[|{!f21}| := f16];
				v27, v4[941], globalState.f5, v4[941], v28 := ((if (f21) then v27 else v29.cf83) + (v27 + v27)[|v30| := v0])[f16 := v0], |map[-(if (false) then v4[941] else f16) := f16]|, false, v4[941] * (cf98 % v4[941]), if (v0[268]) then seq(0x6a, i2  => (v1)) else v28;
			case DC57(cf97) =>
				...
				match (v33) {
					case DC49(cf80, cf81, cf82) =>
						...
						v4[941] := |v36|;
						var v37: map<bool, int> := map[v0[268] := cf82];
					...
					case DC48(cf79) =>
						...
						var v41 := "okb";
						v4[941] := 0x115 - fm2(v41, globalState);
						var v42: set<bool> := {v0[268]};
						var v43 := DC10(v42);
						var v44 := DC26(v1, map[f21 := v43], v4[941], v41[|v41| := v1]);
						var v45: multiset<string> := multiset{v41, v41, v41, v44.cf47};
						v0[268] := v45 < v45;
						v4[941], globalState.f5, v2 := if (fm33(fm87(globalState), globalState)) then v4[941] else 0xc3, true, multiset{f21, f15, f15, f15} + v2;
				}
				...
				if (!false) {
					...
					var v47 := DC36(v46);
					var v48 := "ymogbl";
					var v49: map<bool, char> := map[v0[268] := v1];
					...
					v51[939] := v47;
					v51[939] := v47;
					var v52: C3 := new C3(if (f21) then f15 else f21, f15, !f15, v4[941] / f16);
					v52 := v52;
					var v53: map<bool, bool> := map[f15 := v52.f37];
					v53 := v53[v52.f38 := v4[941] == f16];
					globalState.f5 := v52.f37;
				} else {
					var v54 := DC8(!f15, f16);
					var v55: seq<bool> := [false, !fm13(-f16, v54, !f15, v4[941], globalState), v0[268], f15, f15];
					var v56: multiset<char> := multiset{v1, v1, 'y', 'p', 'f'};
					var v57: map<int, int> := map[|v56| := f16];
					v4[941], v0[268] := 0x1fa, v55[fm0(0x0, fm41(v0[268], |v57|, globalState), f15, v0[268], globalState)];
					var v58: array<string> := new string[10](i3 => "oqreu");
					var v59: map<string, string> := map[seq(-0x1fa, i4  => (v1)) := seq(773, i5  => (v1))];
					v58[43] := if ("qlgjql" in v59) then v59["qlgjql"] else seq(0x2cc, i6  => (v1));
					var v60 := "xnkkkekm";
					v58[43] := v60 + ((seq(0x2f0, i7  => (v1))) + v60);
					var v61 := DC33(f15);
					v61 := DC33(v0[268] ==> false);
					globalState.f5 := v1 !in (v58[43] + v58[43]);
					globalState.f7 := v0[268];
				}
				
			case DC59(cf100) =>
				globalState.f12 := f15;
				v4[941] := |(if (v0[268]) then v2 else v2)[f15 := f16]|;
				var v62 := "vbyi";
				var v63: map<int, string> := map[v4[941] := v62];
				var v64: seq<string> := [if (v4[941] in v63) then v63[v4[941]] else v62];
				v64 := seq(0xc2, i8  => (v62));
				v1 := v62[0x271];
		}
		
		if (f15) {
			var v65: multiset<int> := multiset{v4[941]};
			var v66: map<int, int> := map[f16 := f16];
			var v67: map<int, int> := map[|v66[v4[941] := v4[941]]| := v4[941]];
			var v68: map<multiset<int>, map<int, int>> := map[v65 := v66];
			v68 := (v68 + v68)[v65 := v66[v4[941] := f16]];
			var v69 := DC8(v0[268], v4[941]);
			globalState.f5 := v0[268] ==> fm13(-f16, v69, f15, v4[941], globalState);
			v4[941] := v4[941];
			var v70: seq<array<bool>> := [v0];
			var v71: set<bool> := {f21, false, f21};
			var v72: map<seq<array<bool>>, set<bool>> := map[v70[f16 := v0] := v71];
			var v73: seq<set<bool>> := [v71];
			v72 := v72[[v0, v0, v0] := v73[v4[941]]];
			var v74: seq<bool> := [f15];
			var v75: seq<seq<bool>> := [v74 + v74];
			var v76 := "rne";
			var v77: seq<map<int, bool>> := [map[v4[941] := f21], v6];
			var v78: map<bool, int> := map[false := -|v77|];
			var v79: array<string> := new string[7] [v76 + v76, v76 + v76, ("uudxpqs")[|v78| := v1] + fm55(globalState), v76, "acs", (v76 + v76)[0x15b := v1], v76];
			v79[653] := v76[|v67| := v1];
			v75, v79[653] := v75 + v75, v76 + (v76 + v76);
		} else {
			var v80: set<bool> := {if (f21) then v0[268] else true, !f15, f21};
			var v81: seq<bool> := [false, v0[268], v0[268]];
			var v82: map<multiset<bool>, array<bool>> := map[v2 := v0];
			v80, globalState.f0, v0 := v80, v81, if (v2 in v82) then v82[v2] else v0;
			var v83 := "g";
			var v84 := new C1(v83 < "x", v1, v0[268], v4[941]);
			v4[941] := v4[941];
			var v85: map<bool, string> := map[false := "v"];
			var v86: array<map<bool, string>> := new map<bool, string>[7] [v85, v85 + v85, if (v0[268]) then v85[f15 := v83] else v85, v85, v85, v85[v0[268] := v83] + map[f21 := v83], v85];
			v86[512] := if (!f15) then v85 else v85;
			v86[512] := v85;
			var v87: map<int, int> := map[|v83| := v4[941]];
			var v88: T2 := new C7(v4[941], v4[941], f21, f16);
			var v89 := DC8(v88.f15, v4[941]);
			v87, globalState.f5 := map[v4[941] := |fm29(v5, globalState)|], fm53(v84.f32, f21, f21, |map[v88 := f16]|, globalState) || (fm13(v4[941], v89, fm41(v84.f32, -0x289, globalState), v4[941], globalState) && f21);
		}
	...
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool, r3: bool) {
		...
		if (f21) {
			...
			v18[730] := f21;
			v18[730] := fm53(f15, f21 ==> f15, f21, v0.f28 % v0.f28, globalState);
			var v19 := 'd';
			var v20: seq<int> := [v0.f27];
			v19 := v17[v20[|[v0.f27, v0.f27, |"uodxve"|]|]];
			var v21: array<int> := new int[29];
			v21[679] := v0.f28;
			v21[679], v0.f27, v0.f27 := v0.f27, v0.f27, v0.f28;
			if (0x19e == |multiset{v18[730], v18[730]}|) {
				var v22: map<char, int> := map[v19 := v0.f27];
				var v23: multiset<int> := multiset{v0.f27, v21[679]};
				...
				v26[596] := v25;
				v26[596] := new D13[29](i2 => DC33(true));
				var v27: map<char, bool> := map[v19 := v18[730]];
				var v28: map<map<char, bool>, seq<int>> := map[v27 := [v21[679]]];
				v28 := v28[map v29 : char | v29 in (map[v19 := v18[730]])[v19 := f15] :: (v29) := (f21) := v20[f16 := --|v16|]];
				...
				v0.f27 := fm0(if (f15) then v0.f27 else DC23(v0.f28, v0.f28, v34, if (v0.f27 in v35) then v35[v0.f27] else v21[679], true).cf37, v18[730], v20 == v20, v0.f27 == v0.f27, globalState);
			...
			v39, v0.f28, globalState.f5, v40 := v39, f16 / v0.f27, f15, v40;
		} else {
			if (f21) {
				r0 := f21;
				v0.f27 := v0.f28;
				var v41 := "dhnwvln";
				v0.f28 := -f16 + |((seq(0x4b, i4  => ('w'))) + v41)|;
				v41 := v41;
				...
				var v52: seq<seq<bool>> := [([f15])[v0.f28 := f21], fm56(!f15, f21, f21, globalState), v51];
				v43, v0.f28, v0.f28 := v43, v46.fm1(globalState) % v0.f27, |v52[|(v46.f35 + v45)|]|;
				v0.f28 := v0.f28;
				var v53: array<int> := new int[28];
				v53[410] := v0.f27 / -v0.f28;
				v53[410] := v0.f27;
				...
				var v61: seq<seq<multiset<bool>>> := [v55 + v55, if (v59 in v60) then v60[v59] else seq(0x1bb, i6  => (v54)), [v54, v54], v55, [v54]];
				v55, v58 := v61[v0.f27], v58;
			}
			...
			var v68: array<int> := new int[10] [f16 * v0.f28, 96, -v0.f27, v67.cf98 % f16, v0.f28, 0x35c, f16, fm2(seq(0x54, i7  => (v63)), globalState), |v62|, fm2(seq(954, i8  => (v63)), globalState)];
			v68[298] := f16;
			v68[64] := v0.f27 + v0.f28;
			var v69: multiset<int> := multiset{f16, v0.f27};
			v0.f27, v0.f27, v62, v68[298], v68[64] := |v69|, f16, (v62 + v62) + v62, v0.f28, f16;
		...
		if (f15) {
			...
			var v83 := "vmnyo";
			v83 := v83[v0.f27 := 'r'] + (seq(0x37e, i9  => ('s')));
			v0.f27 := -|("o" + v83)|;
			var v84: seq<string> := [v83, v83];
			var v85 := DC14({v84[f16]});
			match (v85) {
				case DC15(cf23, cf24, cf25) =>
				...
				case DC16(cf26, cf27, cf28) =>
					...
					globalState.f1 := f15;
				case DC14(cf22) =>
					var v94: map<string, int> := map[v83[0x2d5 := 'i'] := 0x32];
					var v95 := DC72(v94);
					v0.f27 := v0.f27 * |v95.cf123|;
					var v96: seq<bool> := [f15, !f21, false];
					globalState.f12, v0.f27, globalState.f7 := v83[v0.f27] !in "kjo", v0.f27 - v0.f28, v96 != v96;
	...
	method m7(globalState: GlobalState) returns (r0: bool) {
		...
		v0[616] := if (f16 in v1) then v1[f16] else f21;
		v0[152] := f21;
		...
		v0[616], v0[152], v2[741], v3[123], v4 := v10 !! v10, match DC63(true) {
			case DC63(cf103) => cf103
			case DC62(cf102) => v4 == v4
		}, map v11 : int | v11 in v7 :: (v11 % |v4|) := (false), f16, "nuy";
		if (DC31(f21).cf54) {
			var v12 := DC39(v9, v3[123] - v3[123], f16);
			match (v12) {
				case DC39(cf67, cf68, cf69) =>
					v4 := v4;
					var v13: multiset<bool> := multiset{v0[616], f15};
					var v14: seq<bool> := [v0[616]];
					var v15 := DC25(v14);
					...
					v3[123] := |v18|;
					var v19: map<bool, int> := map[v0[616] := |v13|];
					v3[123] := ((if (v0[616] in v13) then v13[v0[616]] else cf68) + |v19|) + (cf68 + cf68);
				case DC38(cf66) =>
					var v20 := new C7(v3[123] / 0x27e, f16, f21, -734 % v3[123]);
					var v21 := DC18(false, f16, f21);
					v21 := v21;
					v20.f30 := v20.f31;
					var v22: map<bool, bool> := map[f15 := !v0[616]];
					var v23: multiset<int> := multiset{-v20.f30 / 0x26, |v22|, v3[123]};
					v23 := v23 + v23;
			}
			
			var v24 := DC32(fm81(-v3[123], v8, v0[616], v0[616], globalState));
			match (v24.(cf55 := map[v4 := map[f21 := v8]])) {
				case DC33(cf56) =>
					var v25: array<char> := new char[6](i0 => v8);
					v25[739] := if (cf56) then v8 else 'c';
					v25[739] := v8;
					var v26: seq<bool> := [cf56, v0[616], f15, !v0[616], false];
					var v27 := DC72(fm92(multiset{|v26|, f16}, globalState));
					var v28: map<string, int> := map[v4 := f16];
					var v29: array<D29> := new D29[1] [v27.(cf123 := v28)];
					v29 := new D29[12];
					var v30: multiset<int> := multiset{v3[123], v3[123], v3[123]};
					var v31 := new C7(v3[123], 0x354, f21, |(v30 - v30)|);
					var v32 := DC8(v0[616], v31.f31);
					var v33 := new C3(fm13(|v4|, v32, cf56, v31.f30, globalState), f15, f21, v31.f31);
				case DC34(cf57, cf58, cf59) =>
					var v34: map<int, string> := map[v3[123] := v4];
					v34 := v34[f16 * cf59 := seq(-0x223, i1  => (v8))];
					var v35: map<bool, set<bool>> := map[cf58 := {f21}];
					var v36: multiset<int> := multiset{f16, v3[123]};
					v0[616] := fm19(|v35|, v36 !! v36, fm23(globalState), v8, globalState);
					v4 := v4;
					globalState.f7 := cf58;
				case DC35(cf60, cf61, cf62, cf63) =>
					v3[123] := f16;
				...
				case DC32(cf55) =>
					...
					globalState.f0 := v45;
				case DC36(cf64) =>
					v0[616] := fm2(fm10(v3[123], globalState), globalState) < (if (v0[616]) then v3[123] else -v3[123]);
					var v46 := new C6(!!f15, |"ehme"| - v3[123]);
					v3[123] := v3[123] % (f16 % f16);
					var v47: seq<bool> := [f15, f15, v0[616]];
					var v48: map<bool, int> := map[f21 := |v47|];
					v48 := v48[v3[123] > 0x2f5 := f16];
			}
			
			var v49 := DC55(fm84(-f16, v3[123], f16, globalState), f21);
			v3[123] := fm0(v3[123], v9[v3[123]] == v3[123], !f15, f21 ==> v49.cf95, globalState);
			var v50 := DC5(true, v0[616]);
			var v51: seq<bool> := [f15, v0[616], false, f21, false];
			var v52: map<D1, seq<bool>> := map[v50 := v51];
			v52 := v52[v50 := v51];
			globalState.f0 := v51;
		} else {
			var v53, v54, v55, v56 := m0(v0[616], globalState);
			v3[123], globalState.f13, v53 := v53, v53 != v3[123], f16;
			globalState.f5 := v0[616] <==> ("ds" != v4);
			var v57: multiset<bool> := multiset{v56, v56};
			v0[616] := v57 >= v57;
			var v58: array<string> := new string[10];
			v58[218] := if (f15) then v4 else v4;
			v58[218] := v4 + v4;
		}
...
class C12 extends T1, T0, T2 {
	...
	function fm2(p0: string, globalState: GlobalState): int {
		0x7a / (if (true) then |(map v0 : int | (0x6 <= v0) && (v0 < 0xd3) :: (v0 * f16) := (false))| else f16)
	}
	function fm3(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<string> {
		(if (f15) then {"ahyq", "pjaostq"} else {"cr", seq(0x92, i0  => ('d')), "rduut", "cinai"}) + ({seq(646, i1  => ('g')), "puyyskfw"} + {seq(-0x238, i2  => ('r'))})
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		globalState.f1 := f15;
		var v0 := "ni";
		...
		var v11 := new C5(fm23(globalState), v2, f15, |v10| / f16);
			...
			case DC18(cf30, cf31, cf32) =>
				match (v17) {
					case DC18(cf30, cf31, cf32) =>
						...
						v12[657] := !(if (v9.f15) then v9.f15 else v9.f15);
						var v21 := DC8(fm41(cf32, v9.f16, globalState), v9.f16);
						globalState.f13, v20, f19, v12[657] := v9.f15, v20, 0x3b, fm13(140, v21, v9.f15, v19.f23, globalState);
						r1 := cf31;
						r0 := cf32;
					case DC17(cf29) =>
						var v22: array<int> := new int[22];
						v22[283] := f16;
						v22[283] := if (v9.f16 in v8) then v8[v9.f16] else -|v1|;
				...
				var v34: array<int> := new int[7] [f16, f16, f19, p0 % -0x1f0, v9.fm2(seq(0x274, i3  => (v4)), globalState), cf31 / |v11.f34|, f19 * f16];
				var v35 := DC2(64, v1, cf32);
				v34[424] := -cf31 / v35.cf2;
				v34[424] := v9.f16;
				v0 := v0;
			case DC17(cf29) =>
				var v36: seq<int> := [p0];
				...
				var v39 := new C5(fm10(-|v11.f34[|v0| := v4]|, globalState), v2, f15, --(v36[v37.f16] - p0));
				r1 := -f19;
			...
			case DC19(cf33) =>
				...
				match (v44) {
					...
					case DC32(cf55) =>
						...
						v12[172] := if (v9.f15 in v58) then v58[v9.f15] else v9.f15;
						globalState.f7 := v9.f15;
						var v59: seq<string> := ["jesfkvy", v11.f34[|v2| := v4], v0];
						v0 := v59[870 - |v1|];
					case DC36(cf64) =>
						f19 := v9.f16;
				...
				if ({v9.f15, v69[|v11.f34|]} < fm36(f15, v9.f16, v72, globalState)) {
					r1 := p0 % (v9.f16 / 0x259);
					...
					v12[165] := fm33(v81, globalState);
					var v82: multiset<array<bool>> := multiset{v12, v12};
					v12[165] := (v82[v12 := f19] * v82) !! v82;
					v12[165] := f15;
					var v83: seq<int> := [v9.f16];
					f19 := |(v83 + (seq(0x179, i6  => (f16))))| / (p0 - v9.f16);
				...
				globalState.f13, v0, v4, v12[210], v85 := |"quwjso"| == (v86.(cf119 := f16)).cf119, seq(0x328, i7  => (v4)), v4, fm53(f15, f15, f15, fm0(-0x319, f15, !fm9(f16, f15, globalState), true, globalState) * f16, globalState), v85 + v85;
				r1 := f16 - p0;
		}
		...
		v87, v12[753], v87[869] := v87, if (!f15) then f15 <==> v9.f15 else v88.cf111 < v11.f34, p0;
		var v89: multiset<bool> := multiset{v12[753], false};
		r0 := multiset{f15, !v9.f15, v9.f15} != (v89 * multiset{v12[753]});
		r1 := -(p0 % v9.f16) / f16;
	}
	method m3(globalState: GlobalState) returns (r0: bool) {
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			var v5 := DC63(f15);
			v2[60] := fm9(v1.f39 - |v4|, v5.cf103, globalState);
			var v6 := "jccsrt";
			var v7: array<D21> := new D21[1];
			var v8: seq<array<bool>> := [v2];
			var v9 := DC50(v8);
			v7[707] := v9;
			var v10: seq<bool> := [f15, v2[60]];
			var v11 := DC25(v10);
			var v12 := DC27(v11);
			...
			var v16 := 'h';
			globalState.f1, v6, v7[707], v1.f39, v12 := v2[60], if (v14 in v15) then v15[v14] else v6, v9, v1.f39, fm79(v16, fm16(v2[60], f16, true, f15, globalState), globalState);
			v13[760] := -f19;
			v13[760] := if (v2[60] in v0) then v0[v2[60]] else if (f15) then fm0(v1.f39, v2[60], !f15, v2[60], globalState) else f19;
		}
		var v17 := "neksqucr";
		if (fm53(f15, v17 == (seq(365, i2  => ('t'))), f15, f19, globalState)) {
			f19, globalState.f5 := (fm2(v17, globalState) + f16) / (f19 + f19), !false;
			var v18 := 'f';
			var v19: map<bool, char> := map[f15 := v18];
			var v20: map<string, map<bool, char>> := map[v17[f19 := v17[f19]] := v19];
			var v21 := DC32(v20);
			var v23 := DC8(f15, f16);
			...
			if (f15) {
				...
				v41[151] := f19 % fm0(f16, f15, f15, f15, globalState);
				var v42: map<bool, multiset<bool>> := map[f15 := v24];
				v41[151], f19 := f19, |(seq(886, i7  => (f19)))[|v42| := f19]|;
				v41[151] := v41[151];
			}
			...
			v43[620] := f15;
			v43[620] := f15;
			var v44: map<int, bool> := map[f16 := v43[620]];
			var v45: array<D6> := new D6[7];
			var v46: map<map<int, bool>, array<D6>> := map[v44 := v45];
			v46 := v46[v44 := v45];
			f19 := |(((seq(939, i8  => ('x'))) + "l") + v17)|;
			var v47 := DC61();
			match (v47) {
				case DC61() =>
					var v48 := 't';
					v48 := v48;
					var v49: map<bool, int> := map[v43[620] := f19];
					var v50: array<map<bool, int>> := new map<bool, int>[11] [v49, v49, map[!v43[620] := f19], map[f15 := f16], v49, v49, v49 + v49, v49 + v49, v49 + v49[f15 := fm1(globalState)], map[f15 := f16], v49 + v49];
					v50 := v50;
					globalState.f13 := v43[620] ==> (f16 <= f19);
					var v51 := DC29(f15, f19, f15);
					var v52: map<int, set<int>> := map[--v51.cf51 := {|v17|}];
					var v53: seq<bool> := [!(f19 !in v52), f16 == f16];
					v43[620] := v53[|("abkmyva" + "lnicm")|];
				case DC60(cf101) =>
					var v54, v55, v56, v57 := m0(v43[620], globalState);
					v43[620] := v57;
		...
		for i9 := |multiset(v62)| to |v63| {
			...
			match (fm93(|v65|, |"bpaqcec"|, globalState)) {
				case DC42(cf72, cf73, cf74) =>
					...
					f19 := fm0(-|v70.cf47|, v64[893], f15, fm16(f15, |v71|, f15, true, globalState), globalState) + (v62[0x2f9] * |map[f19 := f16]|);
					var v72: array<int> := new int[21];
					var v73: seq<seq<int>> := [v62, v62];
					var v74: map<seq<int>, array<int>> := map[v73[0x1ec] := v72];
					var v75: array<array<int>> := new array<int>[26] [v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, if (v62 in v74) then v74[v62] else v72, v72, v72, v72, v72, v72, v72, if (v64[893]) then v72 else v72, v72, v72, v72, v72, v72, v72, v72];
					v75 := v75;
					v72[772] := f16;
					...
					var v83 := DC66(i9, v17, 338, v64[893], DC31(v64[893]).cf54);
					v62, globalState.f7, v72[772], v78, v72[600] := v62, v76.f15, (|v80.cf3| % f19) % |v81|, if (i9 in v82) then v82[i9] else v78, v83.cf110;
				case DC41(cf71) =>
					v64[893] := f19 != |(v65 + v65)|;
					var v84: array<multiset<bool>> := new multiset<bool>[6];
					var v85: multiset<bool> := multiset{!!f15, f15};
					v84[152] := v85 + v85;
					v84[152] := multiset(v65);
					var v86: multiset<int> := multiset{i9};
					var v87: array<int> := new int[22] [94, 963, f19, f16 * fm1(globalState), 567 * f19, f16 / |v17|, fm0(|(seq(-599, i10  => (0x151)))|, v64[893], v64[893], f15, globalState), f16, if (f15) then i9 else f19, f19, f16, 858 + -f16, f16, f19 / f19, |v86|, f19, fm0(i9, f15, v64[893], v64[893], globalState), if (v64[893] in v85) then v85[v64[893]] else f16, f16, i9, i9, 0x2fd % f16];
					v87[966] := f19 % f16;
					v87[966] := f19;
			...
			var v89: map<bool, bool> := map[true := v64[893]];
			var v90: map<bool, int> := map[f15 := f19];
			var v91: seq<map<bool, int>> := [v90];
			var v93: set<map<bool, int>> := {v90, v90};
			var v94 := DC4(v89, --|fm64(f15, f15, i9, |v65|, globalState)| == f19, (set v92 : map<bool, int> | v92 in [v91[f19], map[f15 := f19]] :: (v92)) - v93);
			match (v94) {
				case DC4(cf6, cf7, cf8) =>
					var v95: map<bool, map<bool, int>> := map[f15 := map[false := f16]];
					var v96 := DC17(v90);
					var v97: array<map<bool, map<bool, int>>> := new map<bool, map<bool, int>>[5] [v95, v95 + map[v64[893] := v90], map[f15 := map[f15 := f16]], v95[cf7 := v96.cf29], v95];
					v97[981] := v95;
					v97[981] := v95;
					var v98 := 'b';
					v98 := if (v64[893]) then v98 else v98;
					var v99 := DC44(f15);
					globalState.f12, cf6 := if (v64[893]) then v64[893] else v64[893], v89 + map[v99.cf76 := v64[893]];
				...
				case DC5(cf9, cf10) =>
					...
					v101 := v101;
					v64[893] := cf9;
					globalState.f12 := v64[893];
					var v102 := 'x';
					v17 := (v17[0xa3 := v102] + v17) + "ju";
				case DC3(cf5) =>
					var v103 := new C3(v64[893], f15 || f15, f15 ==> f15, -(fm0(fm0(f16, DC18(false, |v17|, !v64[893]).cf30, f15, v64[893], globalState), !v64[893], false, false, globalState) - f16));
					var v104 := DC73(v64[893] && f15, f16, v64[893]);
					v104 := v104;
					var v105: array<int> := new int[1](i11 => i11 % f16);
					v105[772] := f19;
					v105[772] := f16 % f16;
					v105[772] := if (true) then 0x220 else f16;
				case DC6(cf11) =>
					var v106: array<char> := new char[3](i12 => 'x');
					var v107 := 'p';
					v106[653] := v107;
					var v108 := DC8(false, |[false]|);
					globalState.f13, v106[653] := v108.cf14 < -|v63|, v107;
					var v109: array<array<bool>> := new array<bool>[27];
					v109[432] := v64;
					var v110: C9 := new C9(f16, f19, f15, f16);
					var v111: map<C9, array<bool>> := map[v110 := v64];
					v109[432] := if (v110 in v111) then v111[v110] else v64;
					var v112 := new C10(v110.f25, true);
					globalState.f7 := fm53(v62 == [i9, v110.f25], v64[893], false, v112.f23, globalState);
			}
			...
			decreases 100 - i13
		{
			...
			var v115: multiset<int> := multiset{f19, |(seq(0x7b, i14  => (v113)))|};
			...
			v119[925] := multiset{if (|v17| in v63) then v63[|v17|] else f15, f15, f15} >= v116;
			v119[925] := if (f15) then f15 else f15;
			...
			var v122: map<bool, int> := map[f15 := fm0(0x2fe, false, v119[925], f15, globalState)];
		...
		if (f15) {
			...
			if (f15) {
				...
				v131[979] := (set v132 : int | (-3 <= v132) && (v132 < 0x2) :: (v132 + f16)) !! v133;
				v130, v131[979] := v130 - v130[f19 := f19], f15 <== (|v133| != -0x81);
				var v134: multiset<bool> := multiset{f15};
				var v135 := DC54(f16, f15, v134);
				var v136: seq<bool> := [v131[979]];
				...
				var v142: array<int> := new int[29] [f16, f16 / f19, f19, f16, f16, f16, fm0(f19, v135.cf92, f15, !v131[979], globalState), f19, f19, f19 % f19, f16, -f16, |([false, f15] + v136)|, f19, f19, f16, |v139|, f16 + 0xfc, f16 - |v62|, |v141|, f16, f16, f16 + fm0(|v17|, v137.f38, fm9(|v136|, v137.f37, globalState), true, globalState), f19, f16, |v17|, f19, f19, -847 / f16];
				v142 := v142;
				globalState.f13 := !v131[979];
				v17 := v17;
			} else {
			...
			globalState.f13 := (f16 % f19) < -f16;
			var v163: seq<bool> := [f15];
			f19 := |v62| % -|v163|;
			var v164 := DC20(seq(85, i15  => (map[DC18(f15, f16, f15) := f19])));
			var v165 := DC18(f15, f19, f15);
			var v166: map<D7, int> := map[v165 := f16];
			var v167: seq<map<D7, int>> := [v166, v166, v166, v166];
			var v168: seq<D8> := [DC20(v167), v164, v164, v164, v164.(cf34 := seq(0x37, i16  => (v166)))];
			var v169: seq<seq<D8>> := [[v164], v168, seq(0x5b, i17  => (v164))];
			...
			var v174: array<array<bool>> := new array<bool>[28] [v170, v170, v170, v170, v170, v170, if (37 in v171) then v171[37] else v170, v172[f16], v170, v170, v170, v170, v170, v170, v170, v170, v170, v170, if (f15 in v173) then v173[f15] else v170, v170, v170, v170, v170, v170, v170, v170, v170, v170];
			var v175: set<bool> := {f15};
			var v176 := DC23(|v169[f19]|, f19 - f16, v174, -|v175|, f15);
			v176 := v176;
			var v177 := 'n';
			...
			match (v179) {
				case DC54(cf91, cf92, cf93) =>
					...
					var v181: array<seq<seq<int>>> := new seq<seq<int>>[10](i18 => seq(0x2f5, i19  => (v62)));
					var v182: seq<seq<int>> := [[|"r"|, f16, f16, cf91, |"ouhnqch"|], v62, ([f16])[|[f15, f15]| := f19], v62, [-(if (cf92 in cf93) then cf93[cf92] else 145), f19]];
					v181[190] := v182;
					var v183: map<int, char> := map[|v17| := v177];
					var v184: set<int> := {cf91};
					var v185: map<bool, int> := map[v163[|v184|] := f16];
					var v186: C5 := new C5(seq(580, i20  => ('g')), v185, f15, f16);
					var v187: map<C5, bool> := map[v186 := cf92];
					var v188: array<char> := new char[29] [v177, v177, v177, v177, v177, v177, v177, if (|v187| in v183) then v183[|v187|] else v177, v177, v177, v177, v177, v177, v177, v177, v177, 'y', v177, v177, v177, 'c', v177, v177, v177, v177, v177, v177, fm35(v186.f34[cf91 := v177], cf92, cf91, globalState), v177];
					v170, v180, f19, v181[190], v188 := if (f15) then v170 else DC22(if (cf91 in v171) then v171[cf91] else v170).cf36, fm48(globalState), cf91, v182 + (v182 + (seq(0x72, i21  => (seq(36, i22  => (|v175|)))))), v188;
					v177 := v177;
					var v189: map<int, int> := map[f16 := f16];
					var v190: multiset<seq<int>> := multiset{seq(-398, i23  => (f16))};
					...
					globalState.f13, cf92, v185, v193[986], v194 := |v195| > -(|v186.f34| * -0x28b), cf92, v185 + map[f15 := f16], v192.cf128, v194;
				case DC55(cf94, cf95) =>
	...
	method m1(globalState: GlobalState) {
		if (f19 <= -f16) {
			...
			var v1: set<int> := {f19};
			var v2: map<int, set<int>> := map[v0[|map[f15 := f19]|] := v1];
			f19 := |v2|;
			v1, globalState.f5 := v1, f15;
			var v3: array<int> := new int[13](i0 => i0 / f16);
			v3[376] := f19;
			var v4: seq<bool> := [f15];
			v3[376] := v0[|v4| * |v0|];
			var v5: map<int, bool> := map[|"bv"| * v3[376] := f15];
			v5 := v5;
			globalState.f12 := f15;
		} else {
			if (f15 ==> f15) {
				...
				v18[268] := v12.f21 && !v12.f21;
				var v19: multiset<multiset<bool>> := multiset{v14, v14};
				var v21: map<bool, int> := map[v12.f21 := f19];
				v17, globalState.f12, f19, v18[268] := multiset{DC7(v15), DC7(v15), if (f15) then v16 else v16.(cf12 := v15), v16.(cf12 := set v20 : multiset<bool> | v20 in v19[multiset{v12.f21, v12.f21, f15} := f16] :: (v20)), v16}, fm16(true, |v10|, f15, false, globalState) && !(fm51(f15, f19, f16, globalState) in v9), f16 + -((if (true in v21) then v21[true] else f16) - f16), f15;
				var v22 := 'f';
				var v23: map<bool, char> := map[v18[268] := v22];
				var v24: seq<int> := [|v23|];
				var v25: map<int, int> := map[f19 := |v24|];
				var v26 := DC26(v22, fm94(v18[268], v18[268], |(seq(485, i2  => (v22)))|, v18[268], globalState), |v25|, v9);
				globalState.f13 := fm33(v26, globalState);
			} else {
				var v27: array<seq<int>> := new seq<int>[16];
				var v28: map<int, int> := map[f16 := 716];
				v27[524] := [f16, fm0(f16, f15, f15, true, globalState), |v28|, f19];
				var v29 := "rvgbe";
				var v30: seq<int> := [|(seq(0x24b, i3  => ('q')))| * f19, |v29| / (if (f19 in v28) then v28[f19] else f19)];
				v27[524] := v30;
				...
				globalState.f13, globalState.f5, v31[742], v34, globalState.f7 := f15 <== f15, !f15, v33, v34, (v35 >= v35) <== f15;
				globalState.f1 := f15;
				v29 := v29;
				var v36: array<int> := new int[23](i4 => i4 % f16);
				var v37: multiset<array<int>> := multiset{v36, v36};
				v37 := v37;
			}
			
			var v38 := "qoxd";
			globalState.f5 := (|v38| - |map[f16 := f15]|) >= (f19 % f16);
			var v39 := 'x';
			...
			if (f15 <==> f15) {
				...
				var v45: seq<bool> := [v43 !! v43, f19 >= v44[f16], f15];
				globalState.f12 := v45[|v41.f34|];
				v42[901] := 0x346;
				var v46: map<int, bool> := map[f19 := v45[|v41.f34|]];
				var v47: map<int, int> := map[f19 := |v46|];
				var v48: map<map<int, int>, bool> := map[v47 := false];
				v42[901] := f19 * (if (f15 in v41.f35) then v41.f35[f15] else |v48|);
				...
				var v54: seq<T2> := [v53];
				var v55 := DC29(f15, -|v54[f16 := v53]|, f15);
				...
				var v60: array<int> := new int[28](i6 => i6 / v53.f16);
				var v61: map<map<int, bool>, array<int>> := map[v59 := v60];
				var v62 := DC48(v61);
				var v63: seq<D20> := [v62, v62];
				v58[946] := DC29(v63 < v63, |"w"|, f19 != f16);
			...
			var v74 := DC26(v39, v73, f16, seq(0x35f, i8  => (v39)));
			...
			var v77: map<array<bool>, bool> := map[v75 := v76[f19]];
		...
		var v81 := new C9(f16, |v79|, v80[f19], 725);
		...
		v90[307] := v89;
		var v91 := "ysrwbwt";
		var v92: multiset<bool> := multiset{v80[v81.f26], f19 !in v79};
		var v93 := 'f';
		var v94: set<char> := {v93, v93, 'm'};
		var v95 := DC55(v94, f15);
		var v96: seq<array<bool>> := [v89, v89];
		globalState.f1, v86, f19, globalState.f1, v90[307] := v91[f16] !in ((seq(0x34c, i9  => ('v'))) + v91), v86, if (v95.cf95 in v92) then v92[v95.cf95] else v81.f25, f15, v96[fm2(v91, globalState)];
		v88 := v88;
		var v97: multiset<set<bool>> := multiset{v83};
		var v98: map<char, bool> := map['o' := f15];
		var v99 := DC39(v79, f16, |v97[v83 := |v98|]|);
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v4: array<int> := new int[28](i0 => i0 / 0x98);
		v4[97] := f16;
		var v5 := "sepbfyh";
		var v6: seq<bool> := [f15, f15];
		v3, v4[97], v5, r1, r1 := v3, (f16 / f16) % (|v6| % f19), if (f15) then "oxxyfv" + v5 else seq(55, i1  => ('d')), f19, 0x6c;
		r1 := f19;
		...
		var v15 := DC26(v8, v14, v4[97], v5);
		v11 := v11[fm33(v15, globalState) := true];
		var v16: array<D29> := new D29[17];
		var v17 := DC73(v10, f16, f15);
		v16[795] := v17.(cf125 := v7, cf126 := v10);
		v16[795] := v17;
		var v18: set<int> := {|v5|};
		var v19: map<int, set<int>> := map[v4[97] := v18];
		var v20 := new C10(|(if (v4[97] in v19) then v19[v4[97]] else v18)| + -|v5|, f15);
		r0 := false;
		r1 := match DC10(v12) {
...
class C13 extends T2 {
	...
	function fm3(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<string> {
		match if (f15) then DC1(f15) else DC1(f15) {
			case DC1(cf1) => {"bxrieuygq", f17[f18 := 'l']} + {f17}
			case DC2(cf2, cf3, cf4) => set v0 : string | v0 in (seq(0x136, i0  => (f17))) :: (v0)
			case DC0(cf0) => if (f15) then set v2 : string | v2 in (map v1 : string | v1 in {f17} :: (v1) := (f16)) :: (v2) else set v3 : string | v3 in {f17, seq(0x3bc, i1  => ('p')), "ynnce", f17, seq(0x324, i2  => (f17[f16]))} :: (v3)
		}
	}
	function fm1(globalState: GlobalState): int {
		(f18 / f18) + f16
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: int) {
		if (f15) {
			var v0 := 't';
			var v1: array<char> := new char[12] [v0, v0, v0, 'h', v0, v0, 'l', v0, 'd', f17[f18], v0, v0];
			v1[953] := v0;
			v1[953] := v0;
			var v2: seq<bool> := [f15];
			r1 := -(|v2| / (f16 / f18));
			...
			if (f15) {
				...
				r1, r1, globalState.f0, v5[435] := f18, f16, v2, -f16 * |v7|;
				...
				globalState.f1, v1[953], v10 := !true, v0, v10;
				var v11: set<seq<bool>> := {v2, v2};
				var v12: array<bool> := new bool[17](i1 => v4.f21);
				var v13: map<set<seq<bool>>, array<bool>> := map[v11 * v11 := v12];
				v13 := v13[v11 := v12];
				var v16: multiset<char> := multiset{v1[953]};
				var v17: multiset<bool> := multiset{v4.f21};
				var v19: seq<int> := [f16];
				var v20: map<bool, int> := map[v4.f21 := |v19|];
				var v23: array<set<int>> := new set<int>[14] [v3 - (set v14 : int | (0x24a <= v14) && (v14 < 0xca) :: (v14 + |v2|)), v3, {f18}, set v15 : int | (0x195 <= v15) && (v15 < 259) :: (v15 % f18), {f18, f16}, set v18 : int | v18 in map[|v16| := v17] :: (v18 + 0x2a2), v3, v3, {if (v4.f21 in v20) then v20[v4.f21] else f16}, (set v21 : int | (0x6c <= v21) && (v21 < 608) :: (v21 + |[DC18(v4.f21, f16, true).cf31]|)) - {f18}, v3, v3, set v22 : int | (88 <= v22) && (v22 < -0x1f2) :: (v22 * f18), v3];
				v23[405] := {f18, 0x1a8};
				v23[405] := v3;
				var v24 := new C2(f16 - f18, f15, f16);
				var v25: array<int> := new int[6];
				v25[902] := f16;
				v25[902] := |(v2 + v2)| * v24.f39;
			}
			...
			v26 := v26;
			globalState.f1 := f15 || f15;
			r1 := (if (f15) then -0xee else 0x12d) % f16;
			...
			v27[423] := fm0(|map[|v34| := v35]|, f15, if (f15 in v38) then v38[f15] else f15, f15, globalState);
			...
			decreases 100 - i4
		{
			...
			if (!((v51 + v51) <= v51)) {
				...
				var v57: seq<bool> := [fm41(fm33(v56, globalState), v49[119], globalState)];
				var v58: seq<int> := [-v49[119]];
				var v59 := DC6(fm45(f15, v57, f15, |v58|, globalState));
				v59, v49[119], r1 := v59, f18, f16;
				var v60 := DC49(v57, f18, v49[119]);
				globalState.f0, v49[119], r0, v49[119] := (v60.(cf82 := f18)).cf80, 0x19e, !f15, |(v58 + [f16])|;
				var v61: multiset<int> := multiset{if (f15) then v49[119] else f18, f18};
				v61 := v61;
				...
				v63 := v63[true := {fm44(seq(0x56, i6  => ('y')), v64, true, f15, globalState), f15}];
			} else {
				...
				v66 := DC22(v66).cf36;
				globalState.f1 := f15;
				var v67: map<bool, int> := map[f15 := v49[119]];
				var v68 := DC4(v50, f15, {v67});
				var v69: C0 := new C0(v68);
				v69 := new C0(v69.f29);
				var v70: seq<int> := [-0x9b];
				var v71: map<array<int>, seq<int>> := map[v49 := v70];
				var v72 := DC11(if (v49 in v71) then v71[v49] else [v49[119], f16]);
				v66[490] := true;
				var v73: seq<bool> := [!f15, f15];
				var v74: map<int, seq<seq<bool>>> := map[-f18 := [v73, v73]];
				var v75: seq<seq<bool>> := [v73, v73];
				globalState.f1, v72, v66[490] := fm16(f15, |(if (v49[119] in v74) then v74[v49[119]] else v75)|, f18 !in v70, !(f15 <== !fm41(true, f18, globalState)), globalState), DC11(v70), true;
			}
			
			var v76: multiset<int> := multiset{v49[119]};
			...
			var v83: array<bool> := new bool[21] [f15, f15, !f15, f15, !(v76 >= v76), if (|v79| in v77) then v77[|v79|] else f15, f15, !false, true, f15, !(v49[119] < v49[119]), fm41(f15, -0x3d5, globalState), v81 == v81, true, false, f15, if (f15) then v82.cf138 else f15, f15, f15, f15, f15];
			v83[970] := (seq(-26, i8  => ('d'))) == f17;
			v83[970] := f15;
			var v84: seq<bool> := [f15, f15];
			var v85: map<bool, seq<bool>> := map[v49[119] < f16 := v84 + v84];
			v85 := v85;
		}
		for i9 := f16 to --f16 {
			var v86: array<int> := new int[27];
			var v87: seq<array<int>> := [v86, DC0(v86).cf0];
			var v88: set<array<int>> := {v87[f18], v86};
			var v89 := DC84(v88);
			...
			match (v94) {
				case DC76(cf129, cf130, cf131) =>
					v86[645] := f18;
					v86[645] := (if (f15) then |{!v91[422], cf130}| else f18) % v93.f23;
					cf131 := i9;
					...
					v97 := DC6(v96);
				case DC75(cf128) =>
					var v98: map<int, int> := map[v93.f23 := |(seq(0x12f, i11  => ('p')))|];
					var v99: C4 := new C4(v98);
					var v100: map<int, bool> := map[i9 := v91[422]];
					...
					var v105: map<bool, seq<map<int, int>>> := map[v91[422] := (seq(0x7f, i12  => (v99.f36)))[i9 := v98] + [v98]];
					v99, v93.f23, r1, v101 := v99, -(|(if (!v93.f24) then v104[cf128.f23] else v103)| / v93.f23), fm1(globalState) * (171 % |v48[207]|), if (v91[422] in v105) then v105[v91[422]] else v101;
					...
					r1, cf128.f23, v93.f23, v109 := v93.f23, (|f17| % |v110|) / i9, v99.fm1(globalState), v109;
					...
					v86[165], v102, v114 := v99.fm40(globalState), v118.cf44, ((set v120 : set<int> | v120 in v119 :: (v120)) * v114) * v114;
				case DC77(cf132) =>
					var v121: seq<string> := [f17, f17];
					var v122: set<int> := {|v121[0x79]|};
					...
					var v126: T1 := new C8(f18 + v124.cf91, f16, v91[422], -|v125|);
		...
		for i13 := |map[f15 := f16]| to f18 {
			...
			var v135: map<string, map<bool, char>> := map[seq(0xc4, i15  => ('k')) := v134];
			var v136 := DC32(v135);
			var v137: seq<seq<bool>> := [v132];
			var v138: map<D13, int> := map[v136 := |[|v137|]|];
			v131[140] := -((f16 % -|v132|) * (if (fm96(f15, globalState) in v138) then v138[fm96(f15, globalState)] else f16));
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v4: C3 := new C3(f15, !f15, f15, v3[f18]);
		var v5: seq<C3> := [v4];
		var v6: multiset<seq<C3>> := multiset{v5};
		r1 := -(|(v6 - v6)| + f18);
		var v7 := 's';
		var v8: array<int> := new int[4] [0x6e, |(DC21(f17[p0 := v7]).cf35 + f17)|, f18 % f16, |(if (true) then [f16] else [f18, f18, p0])|];
		v8 := if (v4.f38) then v8 else v8;
		var v9: map<bool, char> := map[f15 := v7];
		var v10: seq<map<bool, char>> := [v9];
		var v11: map<string, map<bool, char>> := map[f17 := v10[p0]];
		...
		var v16: set<int> := {p0, |v2|, v4.fm1(globalState), v2[|f17|]};
		var v17: array<char> := new char[20](i0 => v7);
		var v18: seq<set<int>> := [{f18, p0}, v16];
		v15, v16, v17 := (v15 * v15) * (multiset([-0x247, f16, f16]) - v15), v18[f18 + p0], if (v4.f38 <== v4.f38) then if (f15) then v17 else v17 else if (f15) then v17 else v17;
		var v19: map<int, char> := map[f18 := v7];
		r0 := (v19 != (map v20 : int | (920 <= v20) && (v20 < 186) :: (v20 % -f16) := (v7))) && (f18 !in v15);
		r1 := (-f18 % f18) - (p0 + f16);
	}
	method m3(globalState: GlobalState) returns (r0: bool) {
		var i0 := 0;
		...
		if (!f15) {
			...
			v2 := v2[f18 := f15];
			var v3: seq<int> := [f16];
			var v4 := DC18(f15, v3[f16] % f18, fm41(f15, f16, globalState) ==> f15);
			var v5: array<bool> := new bool[1](i1 => f15);
			var v6: array<int> := new int[9](i2 => i2 / -f16);
		...
		v33 := v33;
		var v34 := 'r';
		var v35: set<string> := {f17[f16 := v34]};
	...
	method m1(globalState: GlobalState) {
		...
		var v6: set<int> := {|v5[f16]|, f16};
		v6 := v6;
		var v7: seq<array<int>> := [v3];
		var v8 := new C12(f18, DC0(v7[f16]).(cf0 := v3), f15, f18 * v0.f39);
		var v9: map<D7, int> := map[DC18(f15, f18, f15) := v8.f19];
		var v10: seq<map<D7, int>> := [v9];
		v0.f39 := match DC20(v10) {
			case DC21(cf35) => f16 / v0.f39
			case DC20(cf34) => v8.f19 / f18
		};
		var v11 := DC33(f15);
		var v12: T2 := new C3(f15, f15, f15, f18);
		var v13: map<multiset<array<int>>, T2> := map[v4 := v12];
		var v14: map<bool, T2> := map[v11.cf56 := if (v4[v3 := v0.f39] in v13) then v13[v4[v3 := v0.f39]] else v12];
		...
		match (v35.(cf132 := v34)) {
			...
			case DC75(cf128) =>
				...
				v33.f23 := (v33.f23 % v12.f16) * |v38|;
			case DC77(cf132) =>
				globalState.f13 := false;
				v31[919] := v12.f15;
				v31[919], v16, globalState.f13 := v33.f24, v16, -0x2b9 <= |f17|;
				...
				if (v31[919]) {
					...
					f17 := f17 + f17[DC26(v16, v49, v24.f25, f17).cf46 := 'k'];
					v31[919] := true;
					var v50 := new C7(|{f15}| - |[v31[919]]|, v0.f39, v12.f15, if (f15) then v0.f39 else |v17|);
					v26 := v26;
				} else {
					var v51 := DC2(v20[v0.f39], {|[v33.f24]|}, v33.f24);
					var v52: T1 := new C11(f15, v51, v12.f15, f18);
					var v53: seq<T1> := [v52];
					v8.f19 := |v53|;
					f17 := f17 + f17;
					var v54: seq<multiset<bool>> := [v32, v32];
					var v55: array<multiset<bool>> := new multiset<bool>[9] [v54[v12.f16], (multiset([v12.f15, v12.f15]))[fm8(globalState) := -v0.f39], v32, v32, v32, v32, v32, multiset{v12.f15}, v32];
					v55[474] := v32;
					v55[474] := v32 - v54[v33.f23];
					...
					v63[494] := v7;
					v31[919], v20, v33.f23, v62[792], v63[494] := v12.f15, v20, v33.f23, f17 + (f17 + f17), v7 + v7;
				}
	...
	method m5(p0: int, globalState: GlobalState) {
		...
		v1, v2, globalState.f13 := p0 / -f16, v2, !(f17 != (f17 + f17));
			...
			decreases 100 - i0
		{
			...
			var v10: map<int, int> := map[p0 / 0x87 := (if (|(v7[!true := v5.f32])[false := v8.f24]| in v9) then v9[|(v7[!true := v5.f32])[false := v8.f24]|] else p0) - v1];
			...
			v9 := v9[if (true in v11) then v11[true] else 0x36a := |v14[v5.fm1(globalState)]| % 708];
			...
			match (v20) {
				case DC58(cf98, cf99) =>
					...
					v21[797] := -v1 > (if (v8.f23 in v22) then v22[v8.f23] else |fm55(globalState)|);
					v1 := p0;
				case DC57(cf97) =>
					globalState.f7 := false;
				...
				case DC59(cf100) =>
					...
					var v24 := DC9(f17);
					var v25: array<string> := new string[23] [if (v8.f24) then f17 else "pd", f17, f17 + f17, f17[v8.f23 := v5.f33], f17, f17[f18 := v5.f33], f17 + (seq(628, i2  => ('s'))), f17, f17, f17 + f17, if (v5.f32) then fm23(globalState) else f17, v24.cf15[f16 := 'i'] + "hepmnj", "ei" + f17, f17, f17, f17, fm23(globalState), f17, f17, f17 + (seq(0x2cc, i3  => ('k'))), f17, f17, f17 + (seq(0x23e, i4  => (v5.f33)))];
					v25[28] := "hurfxyb";
					v25[28] := f17 + (f17 + "qycay");
			}
		...
		if (v5.f32) {
			...
			v33 := v32 + v33;
			v1 := f18;
			var v34: map<int, int> := map[f16 := f18 % f18];
			...
			v35 := if (true) then v39[--|v40|] else v35;
			v1 := |v40|;
			...
			v43, v44, globalState.f1, v45[365], globalState.f13 := (if (f15) then v43 else seq(325, i8  => (v35[245]))) + v43, v44, v5.f32, f17 + (f17 + f17), v46 !! (v46 + v46);
		}
...
method Main() {
		...
		decreases 100 - i0
	{
		...
		var v12: array<array<int>> := new array<int>[17] [v2, if (v9) then v2 else v2, v10.cf0, v2, v2, v2, v2, v2, v2, v11[772], v2, v2, v2, v2, v2, v2, v2];
		var v13: map<int, string> := map[fm0(v6, v9, v0, v3[896], globalState) := v4];
		v12, v6, v13, v5 := v12, 0x62, map[v5 := v4 + v4], v6;
		var v14 := new C10(v6, v3[896]);
		var v15 := DC29(v3[896], v5, !v9);
		if (v15.cf50) {
			v2 := v2;
			v12[410] := v2;
			v12[410] := v2;
			var v16: T1 := new C12(v6, v10, v14.f24, v6);
			var v17 := DC34(v16, !v3[896], |v4| - v16.f16);
			v17 := v17;
			var v18: map<bool, int> := map[v3[896] := v5];
			v18 := v18[v14.f24 := -0x196];
			var v19: C8 := new C8(-v16.f16, v6, v0, v14.f23);
			var v20: map<C8, int> := map[v19 := v14.f23];
			var v21: C1 := new C1(v3[896], v7, v14.f24 <==> v3[896], if (v19 in v20) then v20[v19] else -v14.f23);
			v21 := v21;
		} else {
			...
			v25[968], v26 := fm26(v14.f24, globalState), fm31(fm8(globalState), globalState);
			globalState.f0 := v1;
			var v27, v28, v29, v30 := m0(v3[896], globalState);
			var v31 := DC75(v14);
			var v32 := DC77(v31);
			var v33: seq<D30> := [v32];
	...
	globalState.f1 := match v35 {
		...
		case DC0(cf0) => map[v5 := v3[896]] !in multiset{map[v5 := v0], map[0x140 := v3[896]], map v36 : int | (0x2aa <= v36) && (v36 < 285) :: (v36 % |map[|[v5]| := v0]|) := (v3[896])}
	};
	forall i1 | 0 <= i1 < v2.Length {
		v2[i1] := i1 / |(map[v3[896] := v5] + map[v3[896] := |"grdnirk"|])|;
	}
	v4 := v4;
	var v37: map<bool, bool> := map[v0 := true];
	var v38: map<bool, int> := map[v3[896] := v5];
	var v39: set<map<bool, int>> := {v38};
	var v40: C0 := new C0(DC4(v37, v3[896], v39));
	var v41: C5 := new C5(v4, fm59(|{v3[896]}|, globalState), v0, v5);
	var v42: map<C0, C5> := map[v40 := v41];
	v42 := v42;
	var v43 := 'p';
	v43 := v43;
	var v44: C6 := new C6(v3[896], v5);
	var v45: C1 := new C1(v0, v43, v0, v5);
	var v46: map<C6, C1> := map[if (v3[896]) then v44 else v44 := v45];
	v46 := map[v44 := v45];
	var v47: seq<int> := [v5];
	var v48 := DC63(v3[896]);
	v2[584] := v47[|map[v5 := v48.cf103]|];
	v2[584] := -v5;
	globalState.f5 := true;
	...
	if (v3[896]) {
		if (v0) {
			...
			var v52: multiset<int> := multiset{v2[584], v2[584], v2[584], if (v50 in v51) then v51[v50] else v5};
			var v53: set<int> := {v50.f39};
			var v54: map<bool, set<int>> := map[v52 > v52 := v53];
			v54 := v54[v45.f32 := v53 - v53];
			v2, v2[584] := if (v0) then v2 else v2, v5;
			var v55: array<D5> := new D5[17];
			var v56: map<int, seq<int>> := map[v2[584] := v47];
			var v57 := DC13(v50.f39, if (v2[584] in v56) then v56[v2[584]] else [v5], v40.f29, v0);
			v55[828] := v57;
			v55[828] := v57;
			...
			v58[169] := v59;
			var v60: C7 := new C7(if (v3[896] in v38) then v38[v3[896]] else v50.f39, v5, v45.f32, v5);
			...
			v58[169], v60, v61, v64 := v59, v60, v61, v64;
		} else {
			var v65: multiset<bool> := multiset{true, v3[896]};
			v5 := (|v65| / v5) - (v2[584] + v5);
			var v66: map<int, array<bool>> := map[v2[584] * v2[584] := v3];
			v66 := v66[v2[584] := v3];
			v37 := v37[v45.f32 := v45.f32];
			var v67: map<int, bool> := map[v5 := false];
			var v68, v69, v70, v71 := m0((if (v2[584] in v67) then v67[v2[584]] else v45.f32) in v38, globalState);
			v4 := ((v4 + v4) + (v41.f34 + v4))[if (v45.f32 in v65) then v65[v45.f32] else -0x3d8 := v45.f33];
		}
		...
		v73[83], globalState.f13 := v44, !(-0x379 <= (|map[v0 := v72.f27]| + -|v74|));
		globalState.f5 := true || v45.f32;
	} else {
		globalState.f5 := v3[896];
		var v75: map<bool, string> := map[v45.f32 := v41.f34];
		var v76: T1 := new C5(if (v45.f32 in v75) then v75[v45.f32] else v41.f34, v41.f35, v45.f32, v2[584]);
		...
		v79 := v79[v76 := |v38| * v5];
		var v80: array<seq<char>> := new seq<char>[22] [[v45.f33, v45.f33], v41.f34 + [v43], (fm55(globalState))[v76.f16 := v43], [v45.f33, v43, v45.f33], v41.f34, v41.f34, v41.f34 + v41.f34, v41.f34, v4, v4, v4, v41.f34 + [v45.f33, v45.f33], v4 + v4, seq(-0x301, i3  => (v45.f33)), seq(0x127, i4  => (v45.f33)), (v41.f34 + [v45.f33])[v5 := v43], v41.f34, [v43], v41.f34, v41.f34, if (v45.f32) then fm23(globalState) else [v45.f33, v43], v41.f34];
		v80[689] := v4;
		v2[584], v5, v80[689] := -(|"bclnesi"| % v5), if (v0) then |[v45.f32]| else v76.f16, v41.f34;
		var v81: array<char> := new char[23];
		var v82: seq<array<char>> := [v81];
		var v83: set<array<char>> := {v81, v82[v2[584]], v81, v81};
		v83 := v83;
		v5 := v2[584];
	}
	
	v2[584] := v2[584];
	var v84: seq<string> := [seq(69, i5  => (v43)), v41.f34, v41.f34, v4, v4];
	var v85: map<string, C0> := map[v84[v2[584]] := v40];
