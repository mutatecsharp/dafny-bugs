...
function fm6(p0: bool, p1: multiset<map<int, bool>>, globalState: GlobalState): D1 {
	if (|(seq(0x316, i0  => ('n')))| >= |map["urqk" := 0x361]|) then DC1(true) else DC1(true)
}
...
function fm10(p0: bool, p1: bool, p2: int, globalState: GlobalState): D0 {
	DC0((seq(0x2dc, i0  => (0x80))) + [-|[411, |{|"jsxnajks"|}|]|, 437])
}
...
function fm29(p0: int, p1: bool, globalState: GlobalState): map<int, bool> {
	map[--|[-614, -|(map v0 : int | (0x6 <= v0) && (v0 < 99) :: (v0 + |multiset{false}|) := (true))|, |"tnsrwmjof"|]| := true] + (map[|"ilip"| := true] + (map v1 : int | (0x2e <= v1) && (v1 < 717) :: (v1 % 132) := (DC1(false).cf1)))
}
function fm30(globalState: GlobalState): seq<multiset<char>> {
	match DC33() {
		case DC33() => [multiset{'d'}] + (seq(0x15d, i0  => (multiset{'m', 'v'})))
...
function fm34(p0: char, p1: bool, p2: int, p3: int, globalState: GlobalState): D3 {
	DC7(seq(0x2f8, i0  => ({!false})), 'p' !in map['b' := |[true]|])
}
function fm35(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<bool, set<bool>> {
	map[|(seq(0x24, i0  => (map[0x3b1 := true])))| >= 0x2bf := {!false} - DC16({true}).cf24]
}
function fm36(globalState: GlobalState): D8 {
	DC20()
}
function fm37(p0: int, globalState: GlobalState): multiset<int> {
	(multiset{0x2da, 70, |multiset([|"thphighp"|])|, -40, 563} + multiset{0xd2, 0x214, |(seq(0x12e, i0  => (|[true, !true]|)))|, 561}) + multiset{|map[163 := |[|{290, |map[false := 0x140]|}|]|]|}
}
...
function fm42(p0: bool, p1: bool, globalState: GlobalState): D3 {
	if (!(-|map[-|"bvsgx"| := false]| >= |map[|"tanewc"| := -|[map v0 : int | (0x19a <= v0) && (v0 < 632) :: (v0 + |['f']|) := (0x4e)]|]|)) then DC6(-|(map v1 : int | v1 in (set v2 : int | v2 in multiset{0x36f, 452} :: (v2 % -0xde)) :: (v1 % |multiset([|map[false := true]|])|) := (true))|) else DC6(|(set v3 : int | v3 in multiset{162} :: (v3 * --187))|)
}
trait T0 {
	const f20 : int
	const f21 : bool
...
class C1 extends T0 {
	...
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		if (fm16(v4, DC0(if (824 in v6) then v6[824] else seq(-961, i1  => (f27))), globalState)) {
			...
			match (v7) {
				...
				case DC9(cf14) =>
					...
					v13[348] := v14;
					var v15 := 'k';
					v13[348] := if (true) then v14 else v14[f27 := v15];
					var v16 := DC13(v14);
					v14 := v16.cf21;
			}
			...
			var v22: array<array<bool>> := new array<bool>[7] [if (true) then v20 else v20, v20, v20, v20, v20, v20, v21[f27]];
		...
		var v26 := "ogosrhy";
		globalState.f15 := v26 + ((seq(531, i2  => ('s'))) + v26);
		var v27: array<bool> := new bool[15];
		var v28: set<bool> := {f21, f21};
		var v29: seq<set<bool>> := [v28, v28];
		var v30: map<bool, int> := map[p1 := f27];
		var v31 := 'm';
		var v32: array<set<bool>> := new set<bool>[25] [v28, v28, v28, v29[f27], v28, {!p1, !f21}, v28, fm18(|"m"|, if (p1 in v30) then v30[p1] else 0xdd, v31, globalState), v28, v28, v28, DC16(v28).cf24, v28, {p1, f21}, v28, v28, v28, v28, v28, v28, {true, p1}, v28, v28, v28, fm18(p0, p0, v31, globalState)];
...
class C2 extends T0 {
	...
	function fm0(p0: map<int, int>, p1: string, p2: seq<map<bool, bool>>, globalState: GlobalState): bool {
		!(-(|[DC1(f21), DC1(f21), DC1(true), DC1(f21), DC1(f21)]| + |(seq(189, i0  => (f20)))|) in [f20, f20])
	}
	function fm1(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
		f20
	}
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		if (true) {
			...
			match ((if (f21) then v14 else v14.(cf9 := v13)).(cf9 := v13)) {
				case DC6(cf10) =>
					...
					var v20 := 'f';
					v12[612] := v18 !! fm18(cf10, v4, v20, globalState);
					var v21: map<int, int> := map[f20 := f20];
					var v22 := "nlhaskp";
					var v23: map<bool, bool> := map[p1 := v0[v3]];
					var v24: seq<map<bool, bool>> := [fm19(true, globalState), v23];
					v19, cf10, globalState.f18, v12[612] := v19, f20, v16.fm0(v21, v22, v24, globalState), !p1;
					v0 := v0 + v0;
					var v25 := DC12(v15);
					var v26: seq<array<int>> := [v15];
					var v27: map<D5, array<int>> := map[v25 := v26[0x3a3]];
				...
				case DC7(cf11, cf12) =>
					...
					var v39: array<int> := new int[28] [|v33|, v1, |map[v34 := |v35|]|, v3, v4, fm1(v1, |v35|, cf12, globalState), 0x184, v1, v3, 0x87, |multiset{p0}| / v4, -|v34| - |(seq(-0x271, i2  => (f20)))|, if (cf12) then f20 else |v37|, |v38|, f20, v4, f20, v1, 0x2da, v1, p0, f20, f20, v3, v3, p0, v1, 525];
					v39[370] := v3;
					var v40: set<bool> := {p1};
					var v41 := DC16(v40);
					v39[370] := |([v41, v41] + ((seq(374, i3  => (v41))) + fm20(f20, v3, v3, globalState)))|;
				case DC5(cf9) =>
					...
					v53 := v55[v4] - (multiset{!p1, true} - v53);
					...
					var v65 := DC19(v51);
					var v66: array<multiset<D5>> := new multiset<D5>[26] [v60, v60, v60 - v60, v60, (if (v62.cf22 in v61) then v61[v62.cf22] else if (v1 in v61) then v61[v1] else v60) + v60, v60 * multiset{v59}, v60, v60, v60[v59 := v3], v60, v60, v60 + v60, v60, multiset(v63), v60[v59 := |v64|] * v60, v60, v60[v59 := v3], (multiset{DC12(v58), DC12(v58), v59})[v59 := if (|v65.cf28| in v51) then v51[|v65.cf28|] else v4], v60, v60, v60, v60, v60 * v60, v60, multiset{v59}, v60];
					v66[585] := v60;
					globalState.f4, globalState.f5, v66[585] := !(if (p1) then f21 else p1), -f20, v60;
					var v67: seq<seq<bool>> := [v0];
					var v68 := 's';
					var v69: set<char> := {v68};
					var v70 := DC22(v0);
					var v71 := DC23(v3, v2);
					var v72: seq<map<bool, int>> := [map[p1 := |(seq(783, i4  => (v68)))|]];
					var v73: map<seq<map<bool, int>>, bool> := map[v72 := p1];
					var v74: array<seq<bool>> := new seq<bool>[22] [[f21, v2] + v0, (fm21(globalState))[-0x15 := f21], if (p1) then v0 else [p1, p1], v67[|v69|], v0[v4 := p1], v0, fm21(globalState), [p1], v0, v0[v4 := v2], ((v0 + v0)[112 := true])[v4 := v2], v0, v0, v0, ([p1, v2] + v70.cf30)[v4 := f21], fm21(globalState), if (v71.cf32) then v0 else v0, [f21], v0 + [p1, fm0(fm22(v3, globalState), v45, [v48], globalState)], fm21(globalState), v0 + [f21, if (v72 in v73) then v73[v72] else f21, v0[-f20], v2], v0 + ([f21, p1])[-v4 := f21]];
					v74[823] := v0;
					v74[823] := [v2] + v0;
				case DC8(cf13) =>
					var v75: seq<int> := [f20];
					...
					globalState.f17, v4 := v4 * |(v76.cf26[|v78[v4]| := v3])[p0 := |v79|]|, p0;
					var v80 := "lmfshk";
					var v81: map<string, int> := map[v80 := 0xaa];
					v81 := v81[v80 + (seq(74, i5  => ('m'))) := v1];
					v4 := fm1(v4, |((seq(-0x1c6, i6  => (0x348))) + (seq(85, i7  => (p0))))|, v2, globalState);
					var v82 := 'm';
					v82 := v82;
			}
			...
			var v86: multiset<multiset<bool>> := multiset{(fm23(globalState))[f21 := v4], v85, v85};
			var v87: array<int> := new int[23] [f20, f20, if (f21) then f20 else -p0, v1, f20, v1, v4, |v5|, v4 / v1, p0, v3 / v4, v4, v3, v4, -v1, -v4, v84[|{p1}|], p0, f20, v4 % f20, f20 * v4, p0, --|v86|];
			v87[164] := p0;
			v87[164] := (p0 * |v83|) - (f20 + fm1(v4, v3, f21, globalState));
			globalState.f5 := v1;
		...
		v94[748] := DC11(f20, !f21, f21);
		v94[748] := v92.(cf19 := v1 < v1);
		var v95 := 'w';
		var v96: map<char, bool> := map[v95 := p1];
		if (v2 && ((if (fm17(v2, globalState) in v96) then v96[fm17(v2, globalState)] else v0[v1]) ==> p1)) {
			...
			var v106: seq<int> := [v4];
			globalState.f5 := v106[f20] - v1;
			var v107 := new C0();
			var v108 := "ssmu";
			var v109: multiset<int> := multiset{|v108[v4 := fm17(p1, globalState)]|, v4 / p0, -f20, |v108| - v4, fm1(v1, v3, v2, globalState)};
			v109 := v109 + v109;
			var v110 := new C0();
			var v111 := DC20();
			v111 := DC20();
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: int, r3: int) {
		for i0 := |fm26(f21, globalState)| to f20 {
			...
			var v0 := "nfbohx";
			var v1 := 'r';
			globalState.f15 := v0[i0 := v1] + v0;
			globalState.f15 := v0;
			globalState.f3 := f21;
		}
		var v2 := "fahojwr";
		globalState.f5 := fm1(f20, |v2|, f21, globalState);
		var v3: array<int> := new int[4](i1 => i1 % f20);
		v3[768] := |[f20, f20]|;
		var v4 := 'g';
		var v5: seq<int> := [|v2[f20 := v4]|];
		var v6: map<bool, int> := map[p0 := |v5|];
		v3[768] := f20 - (if (f21 in v6) then v6[f21] else f20);
		var v7: map<array<int>, int> := map[v3 := |"wpkgyo"|];
		var v8: multiset<char> := multiset{'a'};
		var v9 := DC18(v5, |v8|);
		for i2 := |v2| + v3[768] to (if (v3 in v7) then v7[v3] else v9.cf27) % f20 {
			...
			var v14: seq<map<bool, bool>> := [v12, v13[v3[768]], v12, map[f21 := f21]];
			v4, v3[768], globalState.f14, globalState.f18 := v4, v10.cf10, f21, f21 ==> !fm0(v11, v2, v14, globalState);
			...
			if (v15[v16.cf17]) {
				...
				v17[120] := fm0(map v18 : int | (-0x7f <= v18) && (v18 < 0x27) :: (v18 - v3[768]) := (i2), v2, v14, globalState);
				v17[120] := f21;
				var v19 := DC9(v17);
				var v20: map<bool, array<bool>> := map[v17[120] := v19.cf14];
				v3[768] := fm1(i2, |v20|, p0, globalState);
				globalState.f17 := |v2| + f20;
				v17[120], globalState.f5 := i2 in [0x129, i2], -v3[768];
				var v21: map<string, int> := map["mqpn" := v3[768] * i2];
				...
				v24, r3, globalState.f17, globalState.f4 := v24, v3[768] / -(v3[768] + i2), -v3[768], (v3[768] + 193) == -f20;
				var v25: map<bool, seq<bool>> := map[p0 := v15];
				globalState.f5 := -f20 - |(map[false := v15] + v25)|;
				var v26: array<bool> := new bool[1] [fm0(map[-f20 := fm1(v3[768], v3[768], p0, globalState)], "vbcdjta", v13, globalState)];
				var v27 := DC20();
			...
			var v29 := new C1(f20, v3, v3[768] % f20, v28 >= fm23(globalState));
		}
		if (f21) {
			r0 := f20;
			var v30: map<char, bool> := map[v4 := f21];
			var v31: map<map<char, bool>, int> := map[v30 := v3[768]];
			v31 := v31[v30 := v3[768]];
			var v32: map<int, int> := map[f20 := f20];
			var v33: map<bool, bool> := map[true := true];
			var v34: set<bool> := {p0, p0, f21, f21};
			r1 := ({fm0(v32, v2, ([map[p0 := p0]])[v3[768] := v33], globalState), p0, p0} + {p0}) > v34;
			...
			v35, v37, r0, v3[768], v38 := v35, v37, f20, if (f20 >= f20) then |v2| else v3[768], v38;
			var v39: seq<map<bool, bool>> := [v33];
			globalState.f3 := fm0(v32, fm26(p0, globalState), v39 + v39, globalState);
		} else {
			globalState.f14 := f21;
			globalState.f5 := v3[768];
			globalState.f17 := f20;
			var v40: map<string, int> := map[v2 := v3[768]];
			v3[768] := |v40| % f20;
			var v41 := DC1(p0);
			v41 := v41;
		}
		
		var v42: map<int, int> := map[v3[768] := f20];
		...
		if (!((v43 + v45) == ((if (0xf0 in v46) then v46[0xf0] else fm19(f21, globalState)) + v45))) {
			...
			v53 := v53[multiset{f20, f20, -398, v3[768], v3[768]} := DC18(v5, v3[768]).(cf26 := v5)];
			var v54: multiset<bool> := multiset{f21};
			var v55: map<int, array<int>> := map[|v54| := v3];
			var v56: set<bool> := {f21};
			var v57: C1 := new C1(v3[768], if (v3[768] in v55) then v55[v3[768]] else v3, f20 / -|v56|, !f21);
			r3, v57 := 632, v57;
			var v58: map<array<bool>, int> := map[v49 := -v3[768]];
			v58 := v58[v49 := v3[768]];
			v3[768] := -v57.f27;
		} else {
			var v59: array<bool> := new bool[9](i4 => p0);
			var v60 := DC9(v59);
			var v61: seq<bool> := [!(f20 != v3[768]), f21];
			v60, v61, r1, globalState.f17 := v60, v61, f21, f20;
			var v62: map<int, bool> := map[v3[768] := p0];
			v42 := v42[f20 * |v62| := v3[768]];
			var v63: set<bool> := {f21, f21};
			var v64: multiset<set<bool>> := multiset{v63};
			v59[228] := f20 >= |v64|;
			v59[228] := f21 && p0;
			globalState.f4 := v59[228];
			var v65: seq<seq<int>> := [[v3[768], v3[768], v3[768], f20, v3[768]], v5];
			var v66: seq<seq<int>> := [v5 + v65[f20], v5];
			v65 := v66;
		}
	...
	method m4(p0: int, p1: bool, p2: map<bool, int>, p3: D3, globalState: GlobalState) returns (r0: bool, r1: bool) {
		for i0 := -p0 to f20 {
			...
			var v2 := DC6(i0);
			var v3 := "qvejr";
			globalState.f15, v0, v1, v2, globalState.f5 := v3[-478 := 'r'] + v3, v0, v1, DC6(i0), p0;
			v0[278] := v1;
			v0[278] := v1;
			v1[685] := p1;
			v0[278][969] := f21;
			v1[685], v0[278][969] := f21, p1;
			var v4: set<bool> := {v1[685]};
			...
			decreases 100 - i1
		{
			...
			var v10: array<int> := new int[24] [v7[p0], |v8|, f20, f20, v7[f20], f20, p0, |v8|, 0x227, p0, fm1(-0x1d5, f20, f21, globalState), 0x9e, p0, p0, p0, f20, |v8|, |v9|, p0, |{true, p1, f21, f21}|, |map[v7 := p1]|, -fm1(|v8|, f20, p1, globalState), p0, p0];
			...
			if (v9[v11.f27]) {
				...
				var v18: set<string> := {v8, v8 + v8, v8, v8, seq(24, i3  => ('x'))};
				v18 := v18;
				globalState.f5 := v16;
			...
			if ((v11.f27 != p0) ==> true) {
				...
				v28[638] := multiset{f21, v25} >= v29;
				v28[638] := v11.f28[851] < v24;
				var v30 := new C1(v11.f27, v11.f28, -v11.f28[851] / v11.f27, v11.f28[851] == 992);
				var v31: multiset<int> := multiset{v11.fm1(v26, |v23|, true, globalState) / -|v8|, |v8|};
				var v32 := DC25(v31);
				globalState.f18, v31, v11.f28[851], globalState.f18 := f21, v32.cf34 * v31, -v24, p1;
			} else {
				v11.f27 := |v9|;
				var v33 := DC1(!(v8 <= v8));
				v33 := v33;
		...
		var v50: array<int> := new int[28] [|v41|, p0, |v42|, f20, v43[p0], p0, f20, p0, f20, |v39|, p0, |[|v48|]|, p0, v47.f27, |v49|, v47.f27, v47.f27, |v41|, f20, v47.f27, f20, v47.f27, v47.f27, f20, p0, f20, |v45|, |v43|];
		var v51: C1 := new C1(DC26(0x221).cf35, v46, p0, p1);
		var v52: map<char, C1> := map[v40 := v47];
		var v53: seq<map<char, C1>> := [v52, v52, v52];
		var v54 := DC27(|multiset(([|v39|])[p0 := p0])|, v53, fm17(f21, globalState));
		var v55 := DC0(v43);
		match (v54.(cf38 := fm17(v51.fm16(multiset{true, !p1}, v55, globalState), globalState), cf36 := f20)) {
			case DC26(cf35) =>
				...
				v56[441] := fm0(v57, v41, v58[v47.f27 := map[f21 := p1]], globalState);
				var v59: set<bool> := {f21, p1};
				v51.f28[254] := (fm24(v47.f27, !p1, v59, p1, globalState)).cf17;
				v56[292] := p1;
				v46[89] := v51.f27;
				var v60: multiset<array<bool>> := multiset{v56, v56};
				var v61: map<set<int>, C1> := map[v44 := v51];
				v56[441], v51.f28[254], v56[292], v46[89], v60 := f21, cf35, v61 != v61, v51.f27, (v60 + v60) * v60;
				var v62: array<string> := new string[14];
				v62[390] := v41;
				v62[390], v51.f28[254], globalState.f3 := v41, v47.f27 % v47.f27, !f21;
				if (if (v56[441] in v49) then v49[v56[441]] else p1) {
					...
					v64[666] := [{if (f21 in v65) then v65[f21] else 0x2ac, v51.fm1(|(seq(-0x1a2, i6  => (cf35)))|, -0x165, v56[441], globalState)}, v44];
					var v66: seq<set<int>> := [{|p2|, -cf35, v51.f28[254], |(seq(0x2ec, i7  => (v40)))|}];
					var v67: seq<seq<set<int>>> := [v66, v66, v66, [v66[v51.f27]], v66];
					v64[666] := (v67[v51.f27])[v47.f27 := {|v62[390]|}] + v66;
					...
					globalState.f18 := v70[-0x27f];
				} else {
					globalState.f5 := v43[v46[89] - cf35];
					var v71: seq<array<int>> := [v47.f28];
					v56[441] := |v71| == v51.f27;
					v46[89] := v51.fm1(v51.f27, cf35, !p1, globalState);
					var v72 := DC23(v46[89], p1);
					var v73 := DC24(v72);
					var v74 := DC24(v73);
					v74 := v74;
					var v75 := new C1(-v47.f27, v51.f28, |(v62[390] + "ien")|, v56[441]);
				}
				
			case DC27(cf36, cf37, cf38) =>
				globalState.f18 := p1;
				var v76: array<string> := new string[24];
				v76[35] := v41[|v41| := 'a'] + v41;
				var v77 := DC13(v41);
				v76[35] := ("ndkkvypt" + "dat") + v77.cf21;
				var v78: seq<bool> := [f21, f21, f21];
				var v79: multiset<bool> := multiset{!v78[|v43|], f21};
				var v80: seq<bool> := [v51.fm16(v79, DC0([cf36, v51.f27]), globalState), p1];
				var v81: seq<map<bool, bool>> := [v49, v49[f21 := p1], if (!v80[0x358]) then v49 else v49];
				var v82 := DC18(v43, v47.f27);
				var v83: map<D7, bool> := map[v82 := true && p1];
				v81, globalState.f3, v47.f27 := ([map[f21 := f21], v49] + v81)[-v47.f27 := v49], if (v82 in v83) then v83[v82] else p1, |v43|;
				var v84: array<bool> := new bool[17](i8 => f21);
				v84[676] := f21;
				var v85: map<int, int> := map[f20 := v47.f27];
				v84[676] := v51.fm0(v85, v41, v81, globalState);
			case DC25(cf34) =>
				...
				match (DC2(multiset{v86} - v87)) {
					...
					case DC2(cf2) =>
						...
						globalState.f18 := !!p1;
						var v92 := new C1(f20, v47.f28, f20 / f20, p1);
					case DC4(cf8) =>
						...
						var v96: array<array<array<int>>> := new array<array<int>>[29] [v95[if (v47.f27 in cf34) then cf34[v47.f27] else 592], v94, v94, v94, v94, v94, v94, v94, v94, v94, v94, if (p1) then v94 else v94, v94, v94, v94, v94, v95[v47.f27], v94, v94, v94, v94, v94, v94, v94, v94, v94, v94, v94, v94];
						v96[411] := v94;
						v96[411] := v94;
				...
				if (f21 ==> f21) {
					...
					v101, globalState.f18, v100[986], globalState.f3, v102 := v101, p1, v47.f28, f21, v102;
					v46[921] := v51.f27 + v47.f27;
					var v103 := DC17(!f21);
					v46[921] := v47.f27 / v51.fm1(f20, v47.f27, !v103.cf25, globalState);
					globalState.f5 := v51.f27;
					var v104: map<D10, bool> := map[v54.(cf37 := v53) := !!f21];
					v51.f27 := if (f21) then v47.f27 else |v104|;
				} else {
					globalState.f4 := f21;
					var v105: array<seq<int>> := new seq<int>[10] [fm28(v51.f27, globalState), v43, v43, v43, v43, v43[v51.f27 := v47.f27], v43, v43 + (seq(0x2e3, i11  => (v51.f27))), v43, [p0, f20, v47.f27]];
					var v106: map<int, int> := map[v51.f27 := |(seq(512, i12  => (v40)))|];
					var v107: seq<map<bool, bool>> := [v49, v49];
					var v108: map<bool, char> := map[!v47.fm0(v106, v41, v107, globalState) := 'q'];
					globalState.f17, v51.f27, globalState.f18, v105, v108 := v51.fm1(v51.f27, v51.f27, p1, globalState), -p0 / v51.f27, if (f21) then p1 else f20 >= v47.f27, if (p1) then v105 else v105, v108;
					globalState.f18 := p1;
		...
		v46[719] := p0;
		var v111 := DC13(v41);
		var v112: array<string> := new string[22] [v41[v51.f27 := v40], "miga", v41, v41, v41, v41, v41, v41 + v41, v41, seq(807, i15  => (v40)), v41, v41, fm26(true, globalState), v41, v41, v111.cf21, v41, v41, v41 + v41, seq(0x26b, i16  => ('b')), "qifnsfgu", seq(0x39a, i17  => (v40))];
		v112[963] := "bwsydd" + v41;
		...
		v46[719], v112[963], v112, v113[524] := |(v116 + (v116 + v116))|, v117[|v41|] + (v41 + v41), v118.cf39, fm0(v119[f20 := v47.f27] + v119, v41, v120[0xa6 := v49], globalState);
		var v122: seq<bool> := [!v113[524], p1];
		var v123: map<bool, map<int, int>> := map[v122[fm1(v47.f27, |multiset(v117)|, p1, globalState)] := v119];
		var v124: array<map<int, int>> := new map<int, int>[11] [v119, v119, v119, if (p1) then v119 else v119, v119[-0x180 := v47.f27], v119, v119 + v119, v119, if (false) then v119 else map v121 : int | (-508 <= v121) && (v121 < -0x57) :: (v121 % 0x188) := (v51.f27), v119 + (if (false in v123) then v123[false] else v119), v119];
		globalState.f8 := v124;
...
class C3 extends T0 {
	...
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		match (match v0 {
			...
			case DC10(cf15, cf16) =>
				var v1 := "dknejhjps";
				var v2: array<int> := new int[16] [f25 % f20, f25, fm1(|"nbras"|, f20, f26, globalState), p0, f25 / f20, p0, 0xcd, if (f21) then f20 else f25, f20 - |v1|, f25, f25, f20 % p0, fm1(p0, 0x3d2, f21, globalState), f25, -(f20 / f20), f20];
				v2[877] := fm1(|(seq(0x2f7, i0  => ('m')))|, f20, p1, globalState);
				...
				var v9: array<array<int>> := new array<int>[25] [v4.cf20, v2, v2, if (f21) then v2 else v2, v2, v2, v2, if (fm0(map v5 : int | (0x52 <= v5) && (v5 < -0x23b) :: (v5 % 939) := (f20), v1, v7[v8[f20] := map[f21 := cf16]], globalState)) then v2 else v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2];
				v9[339] := v2;
				var v10: array<map<bool, bool>> := new map<bool, bool>[26](i2 => v6[f21 := p1]);
				v10[561] := v6;
				var v11 := 'b';
				var v12: multiset<char> := multiset{v11};
				v2[877], v3, v9[339], globalState.f3, v10[561] := -(p0 - |v12|) - -180, v3, v2, -|(seq(0x353, i3  => (map[f20 := f20])))| != f20, if (f21) then v6[f26 := f21] else fm15(f20, f25, f25, -0x18f, globalState);
				if (f20 == fm1(|v8|, v2[877], false, globalState)) {
					globalState.f15 := seq(0x15c, i4  => (v11));
					...
					v14[51] := v15.cf16;
					var v16: map<int, int> := map[v2[877] := f25];
					...
					v2[877] := p0;
					var v24: C0 := new C0();
					var v25: map<C0, int> := map[v24 := -(f25 * v2[877])];
					var v26: seq<C0> := [v24];
					v25 := v25[v26[v2[877]] := f25];
					var v27: seq<array<int>> := [v4.cf20, v9[339], v9[339]];
					var v28: T0 := new C1(v8[f20] + p0, v27[|fm29(f25, f26, globalState)|], |v1|, f21);
					var v29: map<int, bool> := map[|[v10[561]]| := v28.f21];
					var v30 := DC23(v2[877], f26);
					...
					var v37: map<int, int> := map[f20 := if (v35 in v36) then v36[v35] else |(seq(0x1c6, i6  => (v11)))|];
					...
					globalState.f17, v28, globalState.f3, v8, v33[780] := if (v28.f21) then -0x248 / |(set v43 : int | v43 in v42 :: (v43 / 0x91))| else f25, v28, !v28.f21, seq(846, i7  => (f20)), (p1 <== v39.fm16(cf15, v45, globalState)) ==> (f26 !in v46);
				}
				...
				v49 := v49;
			case DC11(cf17, cf18, cf19) =>
				if ((seq(372, i8  => ('f'))) <= (seq(332, i9  => ('o')))) {
					var v50 := "iagyloo";
					var v51: array<int> := new int[2](i10 => i10 / -f25);
					...
					var v60: seq<multiset<multiset<char>>> := [v58, v58, multiset{v57}, v59[cf17], fm31(globalState)];
					cf19 := !(multiset(fm30(globalState)) == v59[f20]);
					globalState.f4 := f21;
				} else {
					...
					var v72: seq<int> := [cf17, f25, DC18(v69, cf17).cf27, f25, DC21(|v71[f20]|).cf29];
					...
					var v84: array<multiset<char>> := new multiset<char>[17] [v82 + fm32(globalState), v82, v82, v83[f20], v82, v82, multiset(['r', v77]), if (cf19) then multiset{v77, 'v'} else v82, v82 + v83[v78.f27], multiset{v77, v77, v77, v77, v77}, v82, v82, multiset{v77, v77}, multiset{v77}, v82, v82 - v82, v82];
					v84 := v84;
				}
				...
				if (v85.cf1) {
					...
					v86[969] := if (f20 in v92) then v92[f20] else f25;
					...
					var v96 := "ysgax";
					v94, globalState.f17, cf17, globalState.f14, globalState.f5 := v94, 0x311, |[v95[p0], v86]|, cf19, p0 % (p0 - |v96|);
					var v97: seq<bool> := [f21, cf18];
					var v98: map<int, seq<bool>> := map[-p0 := v97];
					globalState.f18 := |v98| == -|v96[-800 := 'f']|;
					...
					v99, v100, globalState.f14, cf17, cf17 := if (p1) then v99 else v99, v100, v101[|"uvtiyhvfl"|], f20, cf17;
					...
					v109[490] := v108;
					var v110: map<bool, bool> := map[f26 := v102[278]];
					var v111: seq<map<bool, bool>> := [v110];
					v109[490] := if (fm0(map[f20 := |"kmql"|], "rbvsweaf", v111, globalState)) then if (!p1) then v108 else v108 else v108;
				}
			...
			case DC9(cf14) =>
				...
				var v120 := DC7(([v118, v118])[f20 := v118] + v119, p1);
				match (v120) {
					case DC6(cf10) =>
						...
						globalState.f17, v121, v122, globalState.f4 := 332 - (if (fm0(v123, "ivwxw", v126[f20], globalState)) then p0 else -0x2e), v121, v122, f26;
						var v128: map<int, bool> := map[p0 := p1];
						var v129: map<int, bool> := map[|v114| := if (|map[f26 := f20]| in v128) then v128[|map[f26 := f20]|] else p1];
						var v131 := "kdacsl";
						var v132: map<set<int>, string> := map[set v130 : int | v130 in v129 :: (v130 % 486) := v131];
						var v133: array<int> := new int[14] [f20 % p0, |(v124 + v124)|, |v118|, f20, f25, cf10, f25, p0, |v123|, f20, |(map v127 : set<int> | v127 in v132 :: (v127) := (|"m"|))| + f25, |"pttigqy"|, p0, p0];
						v133[417] := cf10;
						globalState.f18, v133[417] := !(v118 !! v118), v116.fm1(cf10, f20, f21, globalState);
						v124, cf10, v131, globalState.f3, globalState.f3 := (map[p1 := f21])[p1 := !f26], -v133[417], v131, p1, map[false := true] != fm15(v133[417], v133[417], 0x3b9, |v131|, globalState);
						v133[417] := -p0;
					case DC7(cf11, cf12) =>
						...
						v134[870], v135[835], globalState.f3, globalState.f17 := |v137|, v136, p1, v114[0x1d];
						var v138 := "qgfualrx";
						globalState.f5 := |(v138 + v138)| + |(if (cf12) then [0x2f4] else v114)[v114[f20] := v134[870]]|;
						...
						globalState.f14, cf14[485], v134[870] := cf12, v134[870] <= v134[870], --(v134[870] * |(v138 + v138)[|v143| := v117]|);
					case DC5(cf9) =>
						...
						var v148 := new C1(p0, if (v145 in v147) then v147[v145] else v146, f25 / 0x290, p1);
					...
					case DC8(cf13) =>
						...
						var v155: map<map<bool, bool>, map<int, bool>> := map[(map[p1 := p1])[v116.fm0(v152.cf28, v153[v116.fm1(f20, p0, p1, globalState) := v117], [v154, v154, v154], globalState) := f21] := map[|v114| := f26]];
						...
						var v162: array<int> := new int[12] [v158.cf17, fm1(f20, f25, p1, globalState), p0, (if (v118 in v159) then v159[v118] else if (v160 in v161) then v161[v160] else f25) * f25, 0x1e9, p0, p0, f20 % |v154|, -0xc, |[f20, f25]|, f25 + -p0, p0];
						v162[305] := p0;
						v162[305] := f20;
				}
		...
		globalState.f5, globalState.f17, v164, globalState.f14, globalState.f5 := (|v165| / f25) % f20, -((f20 * f25) * f20), v164, f26, p0;
		var v166 := 'w';
		...
		var v174 := DC19(map v173 : int | (0x179 <= v173) && (v173 < 0x1df) :: (v173 / f20) := (|map[f25 := f20]|));
		...
		forall i16 | 0 <= i16 < v180.Length {
			v180[i16] := v163[|map[DC0(v170) := v176.f27]|];
		}
			...
			decreases 100 - i17
		{
			...
			globalState.f5 := v176.f27 % v176.f27;
			var v183: map<multiset<int>, bool> := map[v165 := p1];
			globalState.f5 := v176.fm1(v176.f27, p0, if (v165 in v183) then v183[v165] else f26, globalState) % |(map[f21 := 0x319] + v182)|;
	...
	method m2(p0: array<map<int, int>>, p1: array<int>, globalState: GlobalState) returns (r0: bool) {
		...
		if (v4[f20]) {
			...
			v5[949] := v6;
			var v7 := 'l';
			globalState.f17, v5[949], globalState.f17 := -(|((seq(402, i1  => (f25))) + [f25])| * 0x335), (v6 + v6)[f20 := v7] + v6, f25;
			globalState.f18 := f26;
			...
			match ((if (v8.cf7) then v10 else fm34('v', f21, f20, f25, globalState)).(cf11 := v9)) {
				case DC6(cf10) =>
					v7 := v7;
					p1[342] := if (cf10 in v1) then v1[cf10] else cf10;
					var v11: set<int> := {f25};
					p1[342] := -|(fm25(globalState) * v11)|;
					var v12: array<bool> := new bool[4] [f21, f26, f21, true];
					var v13: seq<array<bool>> := [v12];
					var v14: multiset<array<bool>> := multiset{v13[DC3(p1[342], !f21, false, f20, f21).cf3], v12};
				...
				case DC7(cf11, cf12) =>
					...
					globalState.f18, p1[382], v15, v16, globalState.f3 := !v15.fm3(f20, f21, globalState), |(v19 + v19)|, v15, v16 + ({f25} + v16), cf12;
					globalState.f17 := f20;
				...
				case DC5(cf9) =>
					...
					v22, globalState.f3, globalState.f5, globalState.f17, globalState.f17 := v22, f21, if (f20 in v1) then v1[f20] else f25, f25, if (f21) then v3[p1[925]] else f25 - p1[925];
					globalState.f4 := f26;
				case DC8(cf13) =>
					globalState.f17 := -|v1|;
					v5[949] := [fm17(f26, globalState)] + ([v7, 'u'] + (seq(-627, i2  => (v7))));
					var v23: array<bool> := new bool[3];
					v23 := new bool[21](i3 => f20 > f25);
					p1[428] := f20;
					p1[428] := fm1(-fm1(f20, f25, !f26, globalState), 0x384, false, globalState);
			}
			...
			var v27 := DC31(DC30(f26, v26[true := f20]));
			var v28: map<D11, int> := map[v27 := |[f25]|];
			var v29: seq<map<D11, int>> := [v28 + v28, v28];
			var v30 := "uielcygj";
			v24, globalState.f15, v25[412], v29, globalState.f15 := v24, "ie" + (v30 + v30), false, v29, v30;
			globalState.f4 := v25[412];
			p1[297] := f25;
			p1[297] := f25;
			var v31: array<T0> := new T0[27];
			var v32: T0 := new C2(|v30|, v25[412]);
			v31[866] := v32;
			v31[866] := v32;
		...
		match (DC30(f21, v38)) {
			case DC29() =>
				...
				if (f20 !in v47) {
					...
					p1[791] := f20;
					globalState.f5, r0, v51, p1[791], globalState.f3 := |fm35(f26, f21, fm1(-v50.f27, 0x3d5, f26, globalState), globalState)|, (f26 <==> v4[f20]) || f21, v51 + fm25(globalState), v50.f27, f25 > (v50.fm1(v50.f27, f25, f21, globalState) + f25);
					r0 := f21 && (v39 != v39);
					var v52 := new C0();
				} else {
					var v53: array<bool> := new bool[16];
					v53[93] := f26;
					v53[93] := (v39 + v39)[f20 := v35] <= v39[f25 := v35];
					globalState.f17 := (-0x218 + f20) % f25;
					var v54: seq<array<bool>> := [v53];
					v54 := v54;
					p1[979] := f20 - f20;
					globalState.f3, globalState.f4, v0, p1[979] := f26, f20 == f20, v0, if ((v3[f25] * f20) in v1) then v1[v3[f25] * f20] else 0x3c1;
					v3 := if (v53[93]) then v3 else v3[p1[979] := f25] + v3;
				}
			...
			case DC30(cf40, cf41) =>
				...
				if (f21) {
					...
					p1[526] := f20 + (if (v35 in v59) then v59[v35] else f20);
					p1[526] := f20 * (f25 * f20);
					var v60: set<int> := {p1[526], f20, f25, f25, -p1[526]};
					var v61 := "hwv";
					v60 := {(if (|v61| in v58) then v58[|v61|] else |v1|) - f20, 0xdd, f20, 123, f20};
					var v62 := DC20();
					v62 := fm36(globalState);
					p1[526] := -(f25 % |map[f26 := p1[526]]|) / (p1[526] % |v4|);
					var v63 := new C2(f25 * p1[526], if (fm1(p1[526], f20, true, globalState) in v2) then v2[fm1(p1[526], f20, true, globalState)] else cf40);
				} else {
					globalState.f17 := f25 - (f25 % f20);
					var v64: set<int> := {f20, f20, f25, f20 % 752, 129 + f25};
					var v65: array<multiset<int>> := new multiset<int>[15];
					v65[453] := multiset([f25]);
					v64, v65[453], globalState.f17 := set v66 : int | (632 <= v66) && (v66 < -0x26) :: (v66 / |v4|), v58, -424;
					...
					var v71: seq<seq<bool>> := [v4, v4, v70[f25], v4];
					var v72 := DC32(v71);
			...
			case DC28(cf39) =>
				...
				var v74 := new C1(f25 % f20, p1, -(if (f26 in v73) then v73[f26] else f20), f26 || f26);
				v74 := v74;
				var v75 := DC12(v74.f28);
				var v76: map<int, D5> := map[|v4| := v75];
				var v77: seq<map<int, D5>> := [v76];
				v74.f27 := (v74.f27 % -|v77[f25]|) + (v74.f27 / -289);
				var v78: array<multiset<bool>> := new multiset<bool>[16];
				v78[945] := v38;
				v78[945] := multiset{!f21};
			case DC31(cf42) =>
				...
				v79[542], globalState.f14, globalState.f17, globalState.f5, globalState.f17 := [f26, f26, false, v80 > v80, f26], v3[|v3|] > (f20 * f20), if (f21) then |v83| else 153, f25, f25 % -f25;
				var v85 := "dr";
				if (!!fm0((map v84 : int | (587 <= v84) && (v84 < -0xa0) :: (v84 * f20) := (f25)) + v1, v85, seq(-466, i5  => (map[f26 := f26])), globalState)) {
					globalState.f17 := 0x58;
					var v86 := DC14(fm1(f20, f20, f21, globalState));
					var v87 := DC3(|v85[|"nw"| := v35]|, f26, f26, f20, f21);
					...
					var v91: array<int> := new int[23] [-|v4|, -f25 % -0x324, v86.cf22, f20 / f20, f25, f20, f25, if (f21) then f25 else f20, fm1(|v85|, f25, f26, globalState), f20, f25, f25 % f20, f25, v87.cf6, f20, f25, if (f26 in v90) then v90[f26] else f20, f20, |v88|, -f25, f25, if (f26) then |v0| else f20, f25];
				...
				p1[598] := |(if (f21) then v97[f20 := |v2|] else v97)|;
				p1[598] := -0x209 * f25;
		}
		...
		var v103 := "cntlqc";
		globalState.f14, globalState.f5, v98, globalState.f5, r0 := (v100 + [v99, v99, v99, v99, v99]) == v100, (if (p1 in v101) then v101[p1] else 0x35e) % f20, v98, DC21(f25).cf29 + (|v102| % -f20), (|v103| == f20) <== f26;
		var v104 := DC19(v1);
...
class C4 extends T0 {
	...
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		globalState.f5 := |(match v1 {
			case DC10(cf15, cf16) => ["lqfaswbj", seq(-0x30a, i1  => ('f')), seq(0x280, i2  => ('i'))]
			case DC11(cf17, cf18, cf19) => seq(0x184, i3  => ("tlweiv"))
			case DC9(cf14) => ["cnq"]
		})|;
		var v2 := DC26(p0);
		var v3: set<D10> := {v2};
		...
		var v6: T0 := new C1(0x2ed % |v3|, v5, p0, if (p1) then f24 else f24);
		v6 := v6;
		if (false) {
			var v7 := "qxdrfss";
			...
			match (v8) {
				case DC14(cf22) =>
					var v9 := new C1(-(-f20 % v6.f20), v5, |v7|, v6.f21);
				...
				case DC15(cf23) =>
					...
					var v15: seq<int> := [v6.f20, f20, fm14(v6.f21, v6.f20, if (v13[if (|v14| in v12) then v12[|v14|] else v6.f20] in v12) then v12[v13[if (|v14| in v12) then v12[|v14|] else v6.f20]] else f20, p1, globalState)];
					v15 := v15;
					var v16 := new C0();
					globalState.f3 := f21 ==> (v6.f21 && DC36(p0, !true, f24).cf48);
					var v17 := new C2(v6.f20 % v6.f20, p0 != |v7|);
				case DC13(cf21) =>
					var v18: array<bool> := new bool[22](i4 => f21);
					v18[292] := false;
					v18[292], globalState.f14 := (seq(0x21e, i5  => ('p'))) == cf21, !f24;
					v5 := v5;
					var v19: map<bool, int> := map[v6.f21 <==> f24 := p0];
					v19 := v19[v6.f21 := p0];
					var v20: seq<int> := [p0, 478, -570];
					globalState.f18, globalState.f5, globalState.f5, v18[292], globalState.f14 := v6.f21, |v20|, p0 + |v20|, f21, v6.f21;
			}
			
			var v21: array<string> := new string[20](i6 => v7);
			v21[433] := seq(0x2e, i7  => ('r'));
			...
			v21[433], globalState.f5, v23, v26, v21 := v7[v6.f20 := v27], 0x291 % p0, (v23 + (if (v31 in v32) then v32[v31] else v23)) + v23, v26, v21;
			var v33: array<bool> := new bool[15];
			v33[620] := (set v34 : int | (0x349 <= v34) && (v34 < 0x4d) :: (v34 * v6.f20)) !! {0x3db};
			v33[620] := |v7| > |v7|;
			var v35: map<bool, int> := map[(fm34(v27, f21, v6.f20, p0, globalState)).cf12 := -844];
			var v36: multiset<int> := multiset{p0};
			var v37: seq<map<bool, int>> := [v35, map[v33[620] := |v36|] + v35, if (f21) then map[v33[620] := p0] else v35, v35 + fm27(v6.f20, globalState), v35];
			v37 := v37;
		...
		if ((v45 - v45) > v45) {
			var v46 := DC36(f20, !!(v6.f21 && v6.f21), v4[v6.f20]);
			var v47: map<int, int> := map[f20 := f20];
			var v48 := "hadgdwudf";
			globalState.f5, globalState.f5, v46 := (v6.f20 % f20) + (if (p0 in v47) then v47[p0] else f20), |v48|, v46;
			var v49: map<int, T0> := map[|v48| := v6];
			if (v6.f20 > |v49|) {
				v5 := v5;
				globalState.f5 := v6.f20;
				var v50: multiset<bool> := multiset{p1};
				var v51: seq<int> := [if (f21 in v50) then v50[f21] else v6.fm1(v6.f20, |{f20, p0, 0x329}|, v6.f21, globalState), |(seq(225, i8  => ('q')))|];
				var v52 := 'v';
				globalState.f18 := v48 <= (if (v6.f21) then v48 else v48[|v51| := v52]);
				var v53: array<bool> := new bool[1];
				var v56: map<multiset<int>, int> := map[fm37(|v48|, globalState) := |(map v55 : char | v55 in (seq(0x16f, i9  => (v52))) :: (v55) := (v6.f20))|];
				v53[919] := (map v54 : multiset<int> | v54 in v56 :: (v54) := (|(seq(0x260, i10  => (v52)))|)) == map[multiset{f20} := f20];
				v53[919] := v6.f21;
				v53[919] := v53[919] ==> (p0 == 0xd0);
			} else {
				...
				var v63: array<seq<int>> := new seq<int>[11] [v58, (v58[if (v44 in v59) then v59[v44] else |v48| := |v48|])[|v62| := v6.f20], (seq(0x49, i11  => (|"gxcytgdfb"|))) + v58, [v6.f20], seq(636, i12  => (p0)), fm28(v6.f20, globalState), v58, v58, v58, v58, v58];
				v63[391] := v58;
				var v64: multiset<bool> := multiset{true, f24};
				globalState.f17, v63[391] := -((|v64| + 908) + v6.f20), v58[p0 := |v4|] + fm28(v6.f20, globalState);
			...
			var v70: array<string> := new seq<char>[13] [seq(-0x2ff, i13  => ('o')), v48, fm26(v6.f21, globalState), v48, fm26(f24, globalState) + v48, v48 + "gntqqvui", v48, v69[f20] + v48, v48, v48, "pxfbmf", v48, v48];
			v70 := v70;
			if (!true) {
				...
				v75[63] := v5;
				v71, globalState.f14, v72[757], v74, v75[63] := v71, v6.f21, v6.f21, v74, v5;
				var v76: multiset<bool> := multiset{p1};
				var v77: map<bool, int> := map[v6.f21 := v6.f20];
				var v78: seq<int> := [f20, v6.f20, f20, |v77|];
				globalState.f4, globalState.f5, globalState.f17 := v76 > (v76[v6.f21 := |[if (v6.f20 in v45) then v45[v6.f20] else f20, f20, |v78|, v6.f20]|] + multiset(v4)), v6.f20 / |(v69[v6.f20] + "jwncqvclf")|, v6.f20;
				var v79: seq<multiset<int>> := [v45, v45 + v45];
				v75[63][754] := f20 % v6.f20;
				v70[623] := "u";
				v75[63][400] := -v6.f20 * p0;
				v79, v75[63][754], globalState.f5, v70[623], v75[63][400] := seq(0xb9, i15  => (v45)), -fm14(multiset{!v6.f21, v6.f21, !v6.f21, v6.f21} >= v76, v6.f20, v6.f20, v6.f21, globalState), v6.f20, v48 + v48, (if (v6.f21 in v76) then v76[v6.f21] else -v6.f20) + (v6.f20 / v6.f20);
			} else {
				globalState.f17 := v6.fm1(v6.f20, p0, f21, globalState);
				var v80: seq<int> := [-p0, v6.f20, f20, v6.f20];
				v80 := v80 + v80;
				var v81 := new C2(v6.f20 / v6.f20, fm13(v6.f20, globalState));
				var v82: array<bool> := new bool[15](i16 => !v6.f21);
				var v83: multiset<array<bool>> := multiset{v82, v82};
				v83 := multiset{v82};
				v82[528] := f24;
				v82[902] := f24;
				var v84: multiset<char> := multiset{v48[p0]};
				var v85 := DC1(v6.f21);
				var v86 := DC0(v80);
				r1, v82[528], globalState.f4, v82[902], globalState.f17 := !(|v84| <= v6.f20), if (v6.f21) then f21 else v85.cf1, v6.f21, v6.f21, -|(v80 + (if (f24) then v80 else v86.cf0))|;
			}
			
		} else {
			globalState.f17 := |((seq(0x12e, i17  => ('i'))) + "h")| % 0x199;
			...
			if (p1) {
				...
				v93[812] := multiset(v94) * v45;
				v93[812] := v45;
				r1 := (v43 - v43) == (v43 - v43);
				var v95 := 'u';
				var v96 := new C1(0x3bb + -|(seq(0x25d, i18  => ('e')))[|v93[812]| := v95]|, if (f21) then v5 else v5, v6.f20, |(seq(0x1a4, i19  => (v95)))[v6.f20 := v95]| < v6.f20);
				var v97 := "d";
				var v98: map<int, int> := map[0x1c5 := -|v97|];
				globalState.f18 := v6.fm0(v98, v97, ([map[f24 := v6.f21]])[|v94| := v88], globalState);
		...
		if (!(multiset{v6.f21} !! v102) && f24) {
			...
			globalState.f5 := p0 % v6.f20;
			globalState.f5 := -v6.f20;
			if (false) {
				var v110: map<bool, char> := map[v6.f21 := fm17(f21, globalState)];
				v5[642] := |(v110 + v110)|;
				v102, globalState.f17, v5[642], globalState.f5 := v102, -f20, |v102|, (v6.f20 * f20) % f20;
				var v111 := DC25(v45);
				var v112: seq<multiset<int>> := [v111.cf34];
				var v113: array<bool> := new bool[6];
				var v114: seq<array<bool>> := [v113];
				var v115: map<seq<multiset<int>>, seq<array<bool>>> := map[(seq(776, i20  => (v45))) + v112 := v114 + v114];
				var v116 := DC5(v114);
				v115 := v115[[v45] := v116.cf9];
				var v117: seq<seq<bool>> := [v4, v4[|v109| := v6.f21], v4, v4, v4];
				var v118: map<seq<seq<bool>>, string> := map[v117 := "cbrjrlv"];
				var v119 := 't';
				globalState.f14, globalState.f14, globalState.f15 := f21, v6.f21, (v108 + (if (v117 in v118) then v118[v117] else v108))[f20 := v119];
				v5[642] := fm14(true, v6.f20, v6.f20, v108 != fm26(f21, globalState), globalState);
			...
			globalState.f4 := v6.fm0(v125, v123, seq(-0x231, i21  => (map[v6.f21 := v6.f21])), globalState);
			...
			v128 := v128[|(v129 + v129[|[v130]| := |v45|])| := if (v6.f21 in v133) then v133[v6.f21] else f21];
		...
		r1 := fm0(map v136 : int | (0x2be <= v136) && (v136 < 756) :: (v136 * |(map v137 : int | v137 in [-|map['t' := p1]|] :: (v137 - v6.f20) := (|v44|))|) := (-v6.f20), seq(0xac, i22  => ('i')), v140, globalState);
	}
	method m1(p0: int, p1: bool, p2: T0, globalState: GlobalState) returns (r0: array<int>, r1: int) {
		...
		if (f24) {
			...
			var v4: C3 := new C3(-|map[fm0(v0, if (p2.f20 in v1) then v1[p2.f20] else seq(-688, i0  => ('c')), v3, globalState) := true]|, f21, p0, f21);
			...
			if (!v4.f26) {
				...
				globalState.f17, globalState.f4, globalState.f5, v9[497] := (v4.f25 * v4.f25) % v4.fm1(|v10|, |map[f20 := p1]|, false, globalState), f20 <= (|v11| * p2.f20), |v2| - |(v10 + v10)|, v8;
				var v12: seq<bool> := [p2.f21, p2.f21];
				var v13: seq<bool> := [v12[v4.f25]];
				var v14: seq<seq<bool>> := [v12, [p2.f21]];
				var v15 := new C2(|v14|, !fm13(p2.f20, globalState));
				var v18: map<int, bool> := map[p0 := fm0(v0, v10, seq(167, i1  => (v3[v4.f25])), globalState)];
				...
				globalState.f18 := (p2.f20 % |v28[p2.f20]|) != p2.f20;
				var v29 := DC37(p1, f20);
				var v30 := DC11(p2.f20, v29.cf49, v4.f26);
				var v31: map<bool, D4> := map[p2.f21 := v30];
				globalState.f4 := v12[|v31[v4.f26 := v30]|];
			} else {
			...
			globalState.f15 := (if (fm13(-p2.f20, globalState)) then v46 else seq(514, i3  => ('u'))) + v46;
			...
			decreases 100 - i4
		{
			...
			var v66 := 'x';
			globalState.f3 := (v64[|v65| := v66] + v64) <= (v64 + v64[|[v66, v66, v66, v66, 'f']| := v66]);
			var v67: array<int> := new int[17](i5 => i5 - f20);
			var v68 := new C1(f20, v67, 0x11c, !f21);
			if (p2.f21) {
				globalState.f17 := p2.f20;
				var v70: map<bool, bool> := map[p2.f21 := p2.f21];
				var v71 := DC3(p2.f20, !f24, p1, f20, v68.fm0(map v69 : int | (260 <= v69) && (v69 < 0x198) :: (v69 % |v64|) := (v68.f27), v64, [v70, v70], globalState));
				var v72: seq<bool> := [!v71.cf7];
				var v73: C0 := new C0();
				var v74: map<C0, T0> := map[v73 := p2];
				var v75: set<T0> := {if (v73 in v74) then v74[v73] else p2};
				var v76: array<bool> := new bool[25] [p2.f21, p2.f21, p1, p1, p2.f21, v64 <= fm26(p2.f21, globalState), !!!p2.f21, v63 == v63, p2.f21, f24, f21, p1, p0 >= p2.f20, p2.f21, p1 || f24, v72[0x301], p2.f21, !(v75 > v75), f24, p2.f21, v68.f27 <= -0x1d1, !p2.f21, if (p2.f21) then !p2.f21 else f24, true, f21 <==> p2.f21];
				v76[452] := p2.f21;
				v76[452] := p1;
				v68.f28[261] := p0;
				v68.f28[261], v64 := -v68.f27, "qfdxlwohg";
				v76[452] := p2.f21;
				...
				globalState.f15 := if (v68.fm0(v79, v64[p0 := v66], v83, globalState) ==> p2.f21) then "tyibl" else if (p2.f21 in v84) then v84[p2.f21] else v64;
				var v85 := new C0();
				globalState.f18 := v65 == (v65 + (seq(169, i6  => (f20))));
				...
				v88[825] := if (f21) then v77 else v77;
				v77[6] := f21;
				var v89: seq<map<int, int>> := [v79];
				var v90: map<array<int>, bool> := map[v68.f28 := false];
				var v91: seq<array<bool>> := [v77];
				globalState.f18, v87, globalState.f3, v88[825], v77[6] := p0 == -(f20 / f20), fm39(globalState), !((v85.fm4(|v80|, v89, -|v90|, globalState) && p2.f21) && f24), v91[p2.f20], p2.f21;
				globalState.f14 := p2.f21;
			}
		...
		var v101 := new C3(p0 / f20, false, f20, v100 !! v100);
		var v102: multiset<bool> := multiset{p1};
		var v104: seq<map<int, bool>> := [map v103 : int | v103 in v63 :: (v103 % v101.f25) := (v101.f26)];
		var v105 := "rukj";
		var v106: seq<int> := [|v105|];
		var v107: array<int> := new int[23] [p2.f20, v101.f25, v101.f25 - p0, |v102|, |v104|, 0x145 + v101.f25, v101.f25 % fm1(p2.f20, v101.f25, v101.f26, globalState), fm1(p0, v101.f25, f24, globalState), |v105|, v101.f25, p0, p2.fm1(|v99|, f20, p2.f21, globalState), v101.f25, p0, v101.f25, p2.fm1(p0, p0, f24, globalState), v101.f25, |v106|, f20, -0x180 * f20, v101.f25, p2.f20, -f20];
		r0 := v107;
		r1 := (500 % p0) % -f20;
	}
}
...
class C5 extends T0 {
	...
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		var v12: seq<bool> := [fm0(v11, seq(0x180, i0  => (v10)), v9, globalState), f23, !f23];
		var v13: map<bool, bool> := map[f23 := p1];
		var v14: array<bool> := new bool[22] [!f21, p1, p1, p1, !(p1 <==> f23), true, f20 <= f20, p1, f21, false, p1, fm0(map v8 : int | v8 in v7 :: (v8 / p0) := (f20), "i", v9, globalState), v10 !in v0, f20 >= f20, f23, f23, v12[|"eghu"|], f23, f20 == |v13|, f21, f21 ==> f23, p0 >= f20];
		v14[886] := p1;
		v14[886] := !f23;
		var i1 := 0;
		while (|v0| <= f20)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v15: array<int> := new int[15](i2 => i2 % p0);
			v15[166] := p0;
			var v16: multiset<int> := multiset{f20, f20};
			v15[166] := p0 - |v16|;
			globalState.f18 := f23;
			var v17: map<string, int> := map[v0 := v15[166]];
			v15[166] := |((v17 + v17) + v17)|;
			if (f20 > f20) {
				var v18: array<seq<int>> := new seq<int>[1];
				var v19: map<array<seq<int>>, bool> := map[v18 := f21 ==> f23];
				v14, v15[166], globalState.f18, globalState.f3 := v14, 0x111, fm0(v11, (seq(0x394, i3  => (v10))) + v0, v9, globalState), if (v18 in v19) then v19[v18] else v14[886];
				...
				var v26: seq<seq<int>> := [v7[p0 := f20]];
				var v27 := DC0(v26[f20]);
				var v28: map<int, multiset<array<bool>>> := map[v15[166] := v24];
				var v29 := DC2(v24);
				var v30: map<bool, int> := map[p1 := f20];
				var v31: array<multiset<array<bool>>> := new multiset<array<bool>>[21] [v24, v24, v25[|fm9(|v0|, v27, f20, globalState)|], v24, v25[v15[166]], v24, if (f20 in v28) then v28[f20] else v24, v24, v24, v24, v24[v14 := p0], v29.cf2, multiset{v14} - v24, v24, v24, v24, v24[v14 := fm1(f20, |v30|, true, globalState)], v24 * multiset{v14, v14}, v24, v24, v24];
				v31[764] := v24;
				v31[764] := v25[f20];
				globalState.f3 := !v14[886];
				globalState.f18 := !f21;
				var v32 := new C0();
			}
		...
		if (f23) {
			...
			v33[234] := if (f21) then f20 else f20;
			v33[234] := f20 / f20;
			v33[234] := |(v11 + map[f20 := 0xcc])|;
			v10 := v10;
			var v34: seq<array<bool>> := [v14, v14];
			var v35 := DC5(v34);
			var v36: multiset<char> := multiset{'q', v10, v10};
			v33[234], v34, r1 := f20, (if (true) then v35 else v35).cf9, v36 >= multiset{v10};
			v14[886], v7, v33[234] := !(0x2ca > f20), seq(0x3bb, i5  => (f20)), (p0 * |v12|) % p0;
		} else {
			var v37: multiset<array<bool>> := multiset{v14};
			var v38 := DC2(v37 * (multiset{v14, v14, v14, v14, v14})[v14 := 0x1b6]);
			v38 := v38;
			var v39 := DC0(v7);
			var v40: set<D0> := {v39};
			...
			v44[337] := p0;
			v44[337], globalState.f17, globalState.f17 := -p0, f20, f20 + (f20 % |v0|);
		...
		var v46 := DC3(|v12|, f23 !in v45, f21, p0, fm5(v14[886], globalState) || f21);
		match (v46) {
			case DC3(cf3, cf4, cf5, cf6, cf7) =>
				...
				var v51: seq<string> := [v0, v0, v0 + v0, v0, v50[cf6]];
				v50 := v51;
			case DC2(cf2) =>
				globalState.f5 := |(seq(0x2b8, i7  => (v10)))|;
				f23 := v14[886];
				globalState.f17 := f20;
			...
			case DC4(cf8) =>
				var v53 := new C0();
				var v54: array<string> := new seq<char>[22](i9 => seq(-0x17a, i10  => (v10)));
				v54[730] := v0;
				v54[730] := "iby" + v0;
				if (p0 > f20) {
					globalState.f17 := fm1(f20, f20, if (p1) then p1 else v14[886], globalState);
					var v55: map<bool, array<string>> := map[v14[886] := v54];
					...
					f23 := fm12(p0, v10, f21, if (f20 in v11) then v11[f20] else f20, globalState) <= (v54[730] + "avxghk");
					...
					var v63 := DC6(f20);
					var v64: set<int> := {p0, f20, |v54[730]|};
					var v65 := DC11(|v12|, f21, p1);
					var v66: array<int> := new int[25] [-p0, |v59|, p0, p0, |v12|, |(map[v46 := f21] + v61)|, |v62|, p0, p0 * 0x1a2, p0 / f20, f20 - v63.cf10, |v64|, -p0, -(f20 * p0), |fm12(f20, 'n', v53.fm3(|(seq(0x1af, i11  => (v10)))|, false, globalState), fm1(-0x3c1, 0x1ba, f21, globalState), globalState)|, 390, f20, |v7|, f20, p0 + v65.cf17, p0, f20, f20, p0, p0];
					v66[471] := -p0;
					var v67: multiset<int> := multiset{|v13|};
					var v68: seq<multiset<int>> := [multiset{p0}, v67, v67];
					v66[471] := -|((seq(0x1f2, i12  => (multiset{p0}))) + v68)|;
					var v69 := new C0();
					var v70 := new C0();
					v66 := v66;
				}
		...
		var v83: map<int, seq<array<int>>> := map[|v72| := v82[v7[0xf4] := v81]];
...
class C6 extends T0 {
	...
	method m0(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			v5 := v5[fm0(v6, seq(787, i2  => ('e')), v9, globalState) := v4];
			match (v0) {
				case DC0(cf0) =>
					var v10: set<bool> := {p1, f21};
					globalState.f3 := {f21} != v10;
					var v11: multiset<D1> := multiset{v8.(cf1 := f21)};
					var v12: array<int> := new int[8] [p0, |v11|, fm1(p0, -0x2e7, p1, globalState), p0, p0 * p0, 296, cf0[-f20], p0 * p0];
					...
					v14[546] := v8;
					v14[546], globalState.f5, globalState.f14, cf0, globalState.f14 := v8, |v10|, (if (f21) then DC1(p1) else v8).cf1, ([|f22|] + v4) + cf0, p1;
					v12[326] := p0 / fm1(p0, f20, p1, globalState);
					v12[326] := 0x9d;
			}
		...
		for i4 := --898 to p0 {
			...
			v20[383] := p0 * |f22|;
			v20[383], globalState.f15 := -f20, f22;
			var v21: seq<int> := [p0];
			match (DC0(v21)) {
				case DC0(cf0) =>
					globalState.f18 := f21;
					...
					var v26: map<int, int> := map[p0 := v20[383]];
		...
		v36[485] := v28;
		var v37 := 'i';
		v36[485], globalState.f17, globalState.f4 := v28, if (false) then |fm12(v30.f20, v37, p1, f20, globalState)| + v30.f20 else v30.f20 % p0, (if (p1) then v37 else v37) in (seq(0x1d5, i6  => (v37)));
		v30 := v30;
		...
		for i9 := f20 % p0 to |v58| {
			...
			if (!((v37 in f22) <==> !v30.f21)) {
				...
				v62[983] := v63;
				v62[983], globalState.f5 := v63 + [p1, f21, v30.f21, v30.f21], if (|"eopxabkhd"| in v33) then v33[|"eopxabkhd"|] else if (p1) then 0xff else v30.f20;
				var v64: array<string> := new seq<char>[19] [f22, f22, f22, f22, f22, "diwso", "xkkwmspk", f22, f22, seq(0x275, i10  => (v37)), f22, f22, seq(-0x11c, i11  => (v37)), f22, f22, f22, f22, "ikkiep", "yvy"];
				...
				var v72: set<seq<bool>> := {[if (v30.f21 in v34) then v34[v30.f21] else !v67.cf4], v68[|v63[|v71| := v30.f21]|]};
				var v73: multiset<bool> := multiset{!v30.f21};
				var v74 := DC10(v73, f21);
				var v75: seq<int> := [v30.f20];
				globalState.f17, globalState.f17, v66, v72, globalState.f17 := -0x74, v30.fm1(-p0, v30.f20 * v30.f20, v74.cf16, globalState), v66, v72, v30.f20 / |(v75[f20 := i9] + [f20])|;
			} else {
				v59 := v59[p0 := true];
				...
				var v83: array<bool> := new bool[13] [f21, v30.f21, p1, fm0(map[|v79| := v30.f20], f22, seq(452, i13  => (v34)), globalState), v30.f21, fm0(v33, f22, v35, globalState), f21, if (|f22| in v59) then v59[|f22|] else v30.f21, v30.f21, f21, v30.f21, true, fm0(map v80 : int | v80 in v82 :: (v80 % v30.f20) := (p0), f22, v35, globalState)];
				v78[188] := v83;
				v78[188] := v83;
				globalState.f5 := 0x313 / f20;
			}
...
method Main() {
	...
	var v18: array<map<int, int>> := new map<int, int>[19] [v8[|([v7, v7, true])[v1 := v7]| := |v10|], v8, v8, v8, map v11 : int | (419 <= v11) && (v11 < 0x23a) :: (v11 / v1) := (0x382), v8, v8, if (v7 in v12) then v12[v7] else v8, v8, v8, v8, v8, if (v1 in v13) then v13[v1] else v8, v8, v8, if (v1 in v13) then v13[v1] else v8, v8, map v14 : int | v14 in v4 :: (v14 / v1) := (v1), map v15 : int | v15 in v17 :: (v15 - v1) := (v1)];
	var v19: seq<string> := [v0];
	var v20: map<array<bool>, int> := map[v2 := |v19|];
	var v21 := 'm';
	var globalState := new GlobalState(687, v0 + v0, true, false, false, 0x15f, if ((if (v7 in v6) then v6[v7] else v1) in v3) then v3[if (v7 in v6) then v6[v7] else v1] else v2, false, v18, 0x339, false, -252, false, 318, true, seq(0x306, i0  => ('u')), v6 + v6, 0x7c, false, v0[|v20| := v21] + v0);
	...
	var v25, v26 := v23.m0(v1 % -v1, v7, globalState);
	globalState.f3 := v7;
	...
	v27[864] := v29 + map[v10 := v23.f27];
	var v30: C5 := new C5(v26, v1, v26);
	var v31: map<bool, C5> := map[v26 := v30];
	var v34: map<bool, bool> := map[v26 := v30.f23];
	v27[864] := if (v7 !in v31) then (map v32 : map<int, bool> | v32 in (map v33 : map<int, bool> | v33 in v29[v10 := |v34|] :: (v33) := (false))[v10 := v30.f23] :: (v32) := (v23.f27)) + v29 else map[v10 := v23.f27];
	for i2 := 0x2a4 - v23.f27 to |[v21]| {
		...
		v37[15] := v38 - v38[v23.f27 := |"v"|];
		var v39: array<seq<bool>> := new seq<bool>[24];
		var v40 := DC13("ip");
		var v41: seq<map<bool, bool>> := [v34];
		globalState.f14, v36, v37[15], globalState.f14, v39 := !v23.fm0(v8 + v8, v40.cf21, v41 + (v41[v23.f27 := v34])[v23.f27 := v34], globalState), v36, v38[0xe := v23.f27] + (v38 + v38), v26, v39;
		v23.f27 := i2;
		v22 := v22;
	...
	match (v42) {
		case DC36(cf46, cf47, cf48) =>
			...
			var v43 := DC1(v7);
			var v44 := new C2(v23.f27 / v23.f27, v43.cf1);
		...
		case DC35(cf45) =>
			...
			v67[567] := DC12(v23.f28);
			v67[567], v16, globalState.f17 := v65, v16 + v16, v23.f27;
	...
	globalState.f17 := v1;
	globalState.f5 := v1;
	var v69 := DC47(|fm41(-v1, if (v7 in v6) then v6[v7] else v23.fm1(v1, v1, v30.f23, globalState), globalState)| % -|v0|, v30.f23, v1 + |v8|);
	v69 := v69;
	var v70: C0 := new C0();
		...
		decreases 100 - i6
	{
		...
		var v77: C6 := new C6(v0, |v6|, v76[v1]);
		v75[200] := v77;
		v2[677] := v26;
		var v78: multiset<string> := multiset{v77.f22};
		var v79 := DC43(v1, v78);
		v2[744], v2[937], globalState.f5, v75[200], v2[677] := v30.f23, v26, if (v7) then v30.fm1(v23.fm1(v79.cf55, v1, v26, globalState), |fm21(globalState)|, v30.f23, globalState) - v1 else |v77.f22| * v23.f27, if (v26) then v77 else v77, false;
		globalState.f5 := v23.f27 + v1;
		var v80 := DC35(v21);
		v80 := if (DC48(v30.f23, v25[(fm42(v26, v2[744], globalState)).cf10]).cf66) then v80 else DC35(v21);
		var v81: array<bool> := new bool[8](i7 => v2[744]);
		v3 := v3[v23.f27 := v81];
	}
}