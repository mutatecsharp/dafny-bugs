...
function fm0(p0: string, p1: int, p2: int, globalState: GlobalState): char {
	if (|[!!false]| < |(seq(-917, i0  => ('m')))|) then DC0('h').cf0 else 'c'
}
...
function fm3(globalState: GlobalState): seq<int> {
	([|map[229 := |(seq(0x346, i0  => ('d')))|]|, -|(seq(0x126, i1  => ('b')))|] + (seq(720, i2  => (|"auo"|)))) + ([|(seq(-51, i3  => (0x13e)))|, |[true, !!!true, true]|] + (seq(0x1f1, i4  => (0xf5))))
}
function fm7(p0: int, p1: int, globalState: GlobalState): string {
	"p" + "rjwgaoud"
}
function fm8(p0: bool, p1: bool, p2: int, globalState: GlobalState): D5 {
	match DC14(DC14(DC14(DC14(DC12(multiset{[0x3dd, |(set v2 : int | v2 in (map v0 : int | (0x2e <= v0) && (v0 < 0x1e3) :: (v0 % |(map v1 : int | v1 in multiset{-0x138, |multiset{0xdc}|} :: (v1 / -0x28b) := (0x22b))|) := (0x383)) :: (v2 * |map[|map[!false := |{899, 0x2bf, |"llm"|}|]| := -0x2c2]|))|]}))))) {
		case DC13(cf17) => DC9(seq(37, i0  => ('l')))
...
function fm12(p0: bool, p1: char, p2: bool, p3: int, globalState: GlobalState): multiset<seq<int>> {
	(if (false) then multiset{seq(0x86, i0  => (0x3af))} else multiset{[0x7, -|map[0x208 := !true]|, 0x1f0, ---0x2f]}) + multiset(if (!true) then [[975]] else [seq(907, i1  => (---0x312)), [|multiset{0x32b, |(seq(0x3cd, i2  => ('x')))|, 948}|, |(map v0 : int | v0 in (map v1 : int | (481 <= v1) && (v1 < 0x251) :: (v1 % 0x34b) := (|[false]|)) :: (v0 / -620) := ("vyeoofmh"))|, |"lmjx"|]])
}
...
function fm14(p0: int, globalState: GlobalState): set<seq<int>> {
	{(seq(-0xad, i0  => (-|{!false, true}|))) + [|[|{|"vetmckar"|}|]|], [|(map v0 : multiset<bool> | v0 in [multiset{true, true}, multiset{true}] :: (v0) := (|[-|map[true := false]|]|))|, |{!!!true}|, 0x29e], [0x332, |DC21([!true]).cf33|, 699]}
}
...
method m0(p0: map<array<bool>, int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: int, r3: set<set<bool>>) {
		...
		decreases 100 - i0
	{
		...
		v9 := DC1(v9).cf1;
		var v10: array<multiset<seq<int>>> := new multiset<seq<int>>[18](i2 => multiset{v1} - multiset{v1, ([v0, |v1|])[v0 := -|[p1]|]});
		var v11: seq<seq<int>> := [v1];
		v10[232] := multiset([[v0]] + v11);
		...
		decreases 100 - i3
	{
		...
		match (v28) {
			case DC16(cf20, cf21, cf22, cf23) =>
				...
				v29[447] := v31[|v34[|{v0, v0}|]|] + (v30[-v0 := p1])[v0 := fm1("hmgxqq", v0, v35, globalState)];
				var v36: T0 := new C0(p1);
				v36 := v36;
				var v37: set<int> := {-|map[v30[v0 := cf20] := v19]|};
				var v38: array<set<int>> := new set<int>[4] [v37, v37, {v0, v0}, v37];
				v38[317] := v37;
				var v39: array<int> := new int[22](i4 => i4 / v0);
				v39[833] := v0 % |v22|;
				v39[982] := |v1|;
				var v40: C0 := new C0(p1);
				var v41: seq<C0> := [v40];
				var v42 := DC8(([v41[v0]])[|v41| := v40] + v41);
				v38[317], v32, v39[833], v39[982], v42 := (v37 - fm16(globalState)) * v37, v32, v1[v0], v0 * |v32|, v42;
				var v43: multiset<seq<int>> := multiset{[v0, v39[833]], v1, v1, v1};
				var v44 := DC12(v43);
				cf20, r2, v44 := if (v36.f0) then cf20 else v36.f0, v39[833], v44.(cf16 := v43);
			case DC17(cf24, cf25, cf26, cf27) =>
				var v45 := 'f';
				var v46 := DC6(v0, cf26, p1);
				var v47: set<bool> := {v46.cf10, p1, p1};
				var v48: map<int, bool> := map[v1[cf25] := fm1(("efgeywy")[cf25 := v45], v0, v47, globalState)];
				v48 := v48[cf27 := v19];
				v19 := cf25 <= v1[-DC11(cf27).cf15];
			...
			case DC18(cf28) =>
				...
				var v66: map<int, C0> := map[|(if (v19) then if (v0 in v63) then v63[v0] else v62 else v62[v0 := if (p1 in v65) then v65[p1] else v64])| := v61];
				var v67 := DC10(v61);
				v61 := if (|(v20[302 := v19] + [v19, p1, true, v19])| in v66) then v66[|(v20[302 := v19] + [v19, p1, true, v19])|] else v67.cf14;
				v19 := p1;
		}
		...
		if (fm1(v68, v0, fm13(v19, v19, p1, globalState), globalState)) {
			...
			var v79: seq<seq<string>> := [if (-272 in v78) then v78[-272] else v76[v0 := v68]];
			v74[860], v75, v75, v76, v0 := v77.cf6, v75, v68[v0], v79[fm2(p1, globalState)] + v76, v0 / v1[v0];
			var v80: array<T0> := new T0[5];
			v80 := new T0[7];
			var v82 := DC19(map v81 : int | (-0x167 <= v81) && (v81 < 0xcb) :: (v81 % v0) := (v20));
			v74[860] := |v82.cf29|;
			v19 := v19;
			var v83 := new C0(v19);
		}
		...
		decreases 100 - i7
	{
		...
		var v85: multiset<bool> := multiset{v84[v0]};
		var v86 := DC3(v85, v19, v19);
		var v87: set<bool> := {p1, v19, p1, v86.cf4};
		v19 := fm1(seq(0xfd, i8  => ('l')), v0, v87, globalState);
		if (0x1c0 == v0) {
			var v88 := "nlwntcgy";
			var v89: C0 := new C0(p1);
			var v90 := 'm';
			v88 := v88[v0 * |{v89}| := if (p1) then v90 else 'j'];
...
class C0 extends T0 {
	...
	function fm6(p0: int, p1: multiset<map<bool, bool>>, p2: int, globalState: GlobalState): bool {
		{seq(0xde, i0  => (-0x18a)), seq(-0x310, i1  => (|"hpmca"|)), [|"hs"|, |"gjhdka"|, -0x2fd], seq(0x1ff, i2  => (240)), [0x32f, 633, DC4(|{-0x15b}|).cf6, |map[false := true]|, 390]} <= {[0x247]}
	}
}
...
method Main() {
	...
	var v10 := DC0('u');
	var v11: array<char> := new char[20] [v8, v8, v8, v8, fm0(v7, -v5, v5, globalState), fm0(v7, |[|v9|, v5, v1]|, v1, globalState), v8, v8, v8, v8, 'c', v8, v10.cf0, fm0(seq(0x1b9, i0  => (v8)), v5, v3, globalState), v8, v8, v7[v3], v8, fm0(seq(916, i1  => ('j')), v3, v3, globalState), 'x'];
	v11 := v11;
	...
	if ((if (v4 in v12) then v12[v4] else v4) != v5) {
		...
		var v28: multiset<int> := multiset{v5, |(seq(448, i2  => (multiset{0x1f})))|, v4, -0xf8};
		v2 := v28 !! (v28 + v28);
		var v29: multiset<string> := multiset{seq(259, i3  => (v8))};
		var v30: seq<bool> := [v2];
		var v31 := DC4(|v30|);
		var v32: set<bool> := {v2, v2};
		var v33: set<bool> := {!v2, v2, fm1(v7, v31.cf6, v32, globalState), !!v2};
		v2, v2, v7, v8, v3 := v2, !(multiset{v7} <= (v29 * v29)), seq(232, i4  => (v8)), v8, |v32|;
	...
	var v42: set<bool> := {v2};
	if (if (true) then fm1(("pkkborlrx")[v5 := v8], fm2(v2, globalState), v42, globalState) else v42 == v42) {
		...
		var v68 := new C0(fm1(v67[|[v3]|], v1, v42, globalState));
	...
	for i5 := 0x31c to -(if (false) then |[v71]| else -|v72|) {
		...
		var v74, v75, v76, v77 := m0(v73 + v73, fm1(seq(-0x31b, i6  => (v8)), v3, v42, globalState), globalState);
		var v78, v79, v80, v81 := m0(if (v2) then v73 else v73, v42 !! {v2, v2, false, v2, v2}, globalState);
		v2 := !false;
		var v82: seq<C0> := [v71, v71];
		var v83: array<seq<C0>> := new seq<C0>[3] [v82[v79 := v71], v82, v82];
		v83[180] := v82;
		...
		v83[180] := if (v89[|v7|] in v88) then v88[v89[|v7|]] else [v71] + v82;
	}
	var v90 := new C0(|v72| < |([v72[-989]])[|[v4, v1]| := v2]|);
	...
	if (match if (v2) then DC0(v8) else DC0(v8) {
		...
		var v105: map<seq<string>, char> := map[v103 + v103[v104[v4] := seq(0x5, i8  => (v8))] := v8];
		...
		v4, v113, v114[537] := 0x2d1, (v113 + (v113 + v113))[|v118| := v110], fm9(|(v7 + "icsjbibk")|, |v72[v4 := v117.f0]|, |map[v117.f0 := -0x349]| + v117.fm5(v3, true, globalState), v8, globalState);
	...
	if (v1 < (v4 - v5)) {
		...
		v8, v7, v4 := v10.cf0, seq(-426, i11  => (v8)), 406;
		...
		v141 := v141[v4 % v4 := v140 + v140];
		var v142: map<int, string> := map[v3 := v7];
		var v143: seq<string> := [v7, v7, "ffchstvvi" + v7];
		v72, v142, v4, v7, v143 := v72, v142, v128.fm5(v5, false, globalState), v7, (seq(-0x372, i13  => (v7))) + v143;
		v90 := v90;
		var v144: array<int> := new int[4](i14 => i14 / |v12|);
		v144[620] := if (false) then -v4 else v5;
		var v145: multiset<string> := multiset{v7, DC9("stnwqxv").cf13, seq(0x3d, i15  => (v8))};
		v2, v144[620], v5 := (v145 - v145) >= v145, v5 * v3, v90.fm5(v4, !v2, globalState);
	}
		...
		decreases 100 - i16
	{
		...
		v2, v8, v4 := v147 >= multiset(v148), v8, if (!false || v2) then v5 / v5 else |v7|;
	...
	if (v128.fm6(|v7|, v149 + v149[v150 := v4], 342, globalState)) {
		...
		if (v2) {
			...
			v152[273] := fm10(v2, -v4, "tdbylyj", v154, globalState).(cf0 := v8);
		} else {
			v0[457] := v2;
			v0[457] := v2;
			var v155 := new C0(v2 <== v0[457]);
			var v156: set<char> := {v8};
			var v157: map<bool, set<char>> := map[if (v2) then v72[v1] else v2 := {v8, v8, v8} + v156];
			var v158: set<int> := {v5};
			var v159: multiset<bool> := multiset{v0[457]};
			var v160 := DC3(v159, v2, v2);
			v4, v0[457], v5, v157 := v1 / (-0x3c7 - v1), if (v2) then v2 else v0[457], v4 % (|v158| * |map[v7 := v160.cf4]|), v157 + (fm11(globalState) + v157);
			var v161: array<bool> := new bool[15];
			var v162: map<array<bool>, int> := map[v161 := v155.fm5(v5, v0[457], globalState)];
			...
			v0[457], v168, v3 := (multiset{v128, v128} - v169) <= v169, if (!v0[457]) then v168 else v168, v4;
		}
		...
		if (v128.fm6(|v42|, v149, v4, globalState)) {
			...
			var v172: array<int> := new int[18] [v5 - v1, |v12|, |(multiset{v4})[v3 := v4]|, v5, |v7| / |v42|, v4, -(v3 * v5), if (v2) then -|v170| else v5, |(map[v2 := v0] + v171)|, v3, v4, v4, v4, -0x36c, v5, |{v2, v2, v2}|, -v90.fm5(0x3b3, v2, globalState), v4];
			v172[493] := v5;
			v172[493] := -0x49;
			var v173, v174, v175, v176 := m0(map[v0 := v5], v2, globalState);
			var v177: multiset<bool> := multiset{v2};
			v3 := v174 * |v177|;
			v1 := v128.fm5(v172[493] * v175, false, globalState);
		} else {
			v5 := v5 + v4;
			...
			var v190: array<int> := new int[17](i20 => i20 % v1);
			v189[693] := v190;
			var v191: map<set<bool>, bool> := map[v42 := v2];
			v188, v71, v189[693], v182, v2 := if (false) then v188 else v188, v90, v190, v181 + -|v7|, v191 == v191;
	...
	v0[901] := v2;
	v0[901] := fm1(v7, |v7|, v42, globalState);
	...
	match (v209.(cf18 := v208)) {
		case DC13(cf17) =>
			...
			v1 := (v3 / v5) * (|v72| - 283);
		case DC12(cf16) =>
			v4, v3, v2, v8, v0[901] := v5, v4, ("xya" + "kbshdbhf") != (seq(-774, i21  => (v8))), v8, v2;
			var v212: set<int> := {v3};
			v0[901] := v71.fm6(v5 / |v7|, v149, -(v5 - |v212|), globalState);
			var v213: multiset<bool> := multiset{v2};
			var v214 := DC3(v213, v2, v0[901]);
			match (if (true) then v214 else v214) {
				case DC2(cf2) =>
					...
					var v224 := DC6(|v213| / v5, 225 - -v4, v0[901]);
					v224 := v224.(cf9 := |(v7 + v7)|);
				case DC3(cf3, cf4, cf5) =>
					...
					var v229, v230, v231, v232 := m0(v225, if (v227 in v228) then v228[v227] else v0[901], globalState);
				...
				case DC1(cf1) =>
					...
					var v239, v240, v241, v242 := m0(v233, v0[901], globalState);
		...
		case DC14(cf18) =>
			if (v0[901]) {
				...
				v0[901] := !(fm14(|v9|, globalState) >= v249);
				v8 := v8;
				var v250: map<array<bool>, int> := map[v0 := v5];
				var v251, v252, v253, v254 := m0(v250, v0[901], globalState);
				var v255: set<int> := {if (!!v2 in v9) then v9[!!v2] else -|v7|};
				var v256: map<seq<bool>, int> := map[[!v0[901], v0[901], v2] := |v255|];
				var v257: seq<seq<bool>> := [v72];
				v256 := v256[v257[v251] + v72 := v5];
			} else {
				v0[901] := v2;
				var v258: multiset<string> := multiset{v7, v7};
				var v259: map<seq<int>, string> := map[seq(0x29d, i22  => (v1)) := seq(23, i23  => (v8))];
				v0 := new bool[19] [if (v0[901]) then v2 else v0[901], v2, v72 <= [v2], v0[901], v0[901], v2, v72[|v258|], true <==> v0[901], v2, v2, v0[901], v0[901], v2, v2, v0[901], fm1(if (v205 in v259) then v259[v205] else v7, v3, v42, globalState), DC13(v0[901]).cf17, v0[901], !v0[901]];
				v2 := !!(v7 < v7);
				v8 := v8;
