...
class C1 extends T1 {
	...
	method m2(p0: int, p1: bool, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<map<bool, D3>>) {
		if (p1) {
			if (p1) {
				...
				v5, v6[safeIndex(119, v6.Length)], globalState.f7, v9 := [p3, |v10|, p3], v7, p3, v9;
				...
				globalState.f7 := safeDivisionInt(safeModuloInt(p0, |v12|), |map[!p1 := true]|);
			...
			if (p1) {
				...
				var v24: set<int> := {fm0(p3, p3, p3, p1, globalState), |v20[safeIndex(p3, |v20|) := p1]|, f29, f29};
				var v25 := DC28(v24);
				globalState.f2 := if (v20 in v23) then v23[v20] else v24 > v25.cf37;
				var v26 := "ifljbrg";
				var v27: seq<int> := [f29, |v26|];
				globalState.f7 := fm0(p0, v27[safeIndex(p0, |v27|)], 0x188, p1, globalState);
				p2[safeIndex(828, p2.Length)] := p0;
				p2[safeIndex(828, p2.Length)] := p3;
			} else {
				var v28 := "gtrohbu";
				var v29: map<bool, string> := map[p1 := v28];
				var v30 := 'w';
				globalState.f8 := (if (p1 in v29) then v29[p1] else v28)[safeIndex(f29, |(if (p1 in v29) then v29[p1] else v28)|) := v30] + v28;
				...
				var v37: set<int> := {p0, p0, |(if (|v33| in v32) then v32[|v33|] else [v36[safeIndex(p0, |v36|)], p0])|};
				v31[safeIndex(53, v31.Length)] := v37;
				v31[safeIndex(53, v31.Length)] := v37;
				var v38: array<D14> := new D14[3];
				var v39 := DC28(v31[safeIndex(53, v31.Length)]);
				v38[safeIndex(136, v38.Length)] := v39;
				var v40: map<bool, array<int>> := map[{v35, v35, v35, map[fm6(p0, globalState) := true], v35} !! {v35[p1 := p1], v35} := p2];
				var v41: multiset<bool> := multiset{p1, v33[safeIndex(0x20a, |v33|)]};
				globalState.f2, v38[safeIndex(136, v38.Length)], v40 := p1, fm32(!p1 !in [p1, false], |v41|, p3, globalState), v40 + v40;
				globalState.f2 := p1;
				var v42: set<bool> := {p1, p1, fm7(p1, p3, p1, globalState)};
				var v43: multiset<D11> := multiset{DC21(v42)};
				var v44 := DC21(v42);
				p2[safeIndex(618, p2.Length)] := if (v44 in v43) then v43[v44] else p0;
				var v45: multiset<int> := multiset{p3 + f29, f29, f29 + p0};
				p2[safeIndex(618, p2.Length)] := -(if (p3 in v45) then v45[p3] else safeDivisionInt(if (p1 in v19) then v19[p1] else p3, f29));
			}
			
			globalState.f13 := |[p0, |v19|, f29, p3, f29]| <= p0;
			var v46 := 't';
			var v47: seq<char> := [v46, v46];
			r1 := safeModuloInt(p0, |((seq(abs(141), i1  => ('s'))) + v47)|);
		} else {
			var v48 := "n";
			var v49 := 'i';
			var v50 := DC6(v48, v49, p1);
			globalState.f7 := |[v50]|;
			p2[safeIndex(348, p2.Length)] := --p3;
			var v51 := DC9(p3);
			var v52: seq<bool> := [p1, p1, p1];
			p2[safeIndex(348, p2.Length)] := p0 * (v51.cf11 + |v52|);
			...
			v54[safeIndex(473, v54.Length)] := !p1;
			var v55: seq<int> := [-p2[safeIndex(348, p2.Length)]];
			var v56: map<bool, int> := map[true := p3];
			var v57: map<string, multiset<int>> := map[v48 := multiset{v55[safeIndex(|v56|, |v55|)], p2[safeIndex(348, p2.Length)]}];
			var v58: multiset<int> := multiset{p0, |v48|};
			f29, v54[safeIndex(473, v54.Length)] := |(if (v48 in v57) then v57[v48] else v58)|, p1;
		}
		...
		var v63: map<bool, bool> := map[v62[safeIndex(|v62|, |v62|)] := v61.f27];
		var v64: map<C0, map<bool, bool>> := map[v61 := v63];
		var v65 := "fgkj";
		var v66: map<seq<bool>, string> := map[v62 := v65];
		m0(p1, safeDivisionInt(|v60|, fm0(-0x2a8, |(if (v61 in v64) then v64[v61] else v63)|, p3, v61.f27, globalState)), v66, |v60|, globalState);
		var v68 := 'w';
		...
		if (|(map v67 : int | v67 in map[if (p3 in v72) then v72[p3] else p0 := p0] :: (safeModuloInt(v67, v60[safeIndex(p0, |v60|)])) := (p0))[f29 := p0]| <= p3) {
			f29 := p3;
			var v73: array<bool> := new bool[1];
			var v74: multiset<int> := multiset{p3, p0};
			v73[safeIndex(758, v73.Length)] := fm33(globalState) > v74;
			v73[safeIndex(758, v73.Length)] := fm29(globalState) >= ((if (p0 in v70) then v70[p0] else p3) + f29);
			globalState.f13 := p1;
			var v75: multiset<bool> := multiset{v61.f27, v73[safeIndex(758, v73.Length)]};
			if (v75 >= v75[p1 := abs(-p0)]) {
				r1 := f29;
				var v76: array<char> := new char[4];
				v76[safeIndex(844, v76.Length)] := v68;
				v76[safeIndex(844, v76.Length)] := fm34(globalState);
				var v77: multiset<seq<bool>> := multiset{[true, p1], v62};
				globalState.f0 := !(v77 > multiset(([v62, v62, [p1, p1, false], v62])[safeIndex(|v60|, |[v62, v62, [p1, p1, false], v62]|) := v62]));
				...
				var v89: array<seq<char>> := new string[21] [v65, v65, v65, v65 + v65, [v68, v68, v68], v65, seq(abs(0x3b7), i2  => (v68)), v65, [v68, v68, v68, v68, v68], v65, seq(abs(631), i3  => (v68)), v65, v65, v65, v65, seq(abs(-0x170), i4  => (v68)), v65, v65, v65, [v68], seq(abs(-300), i5  => (v68))];
				v89[safeIndex(257, v89.Length)] := seq(abs(0x8c), i6  => (v68));
				var v90 := DC5(v68);
				v89[safeIndex(257, v89.Length)] := if (v61.f27) then v65 else [v90.cf5];
				var v91 := new C0(v61.f27);
			}
			
			var v92: seq<array<bool>> := [if (v61.f27) then v73 else v73, v73];
			v73 := v92[safeIndex(p0, |v92|)];
		} else {
			v68 := v68;
			...
			v96 := v96[fm35(p1, p3, globalState) + v95 := v60[safeIndex(|v97|, |v60|)]];
			globalState.f7 := p3;
		}
	...
	method m3(p0: array<int>, globalState: GlobalState) {
		...
		globalState.f0 := (|(if (v0 in v2) then v2[v0] else seq(abs(-0x1cf), i0  => ('f')))| + f29) in map[f29 := v3];
		p0[safeIndex(727, p0.Length)] := f29;
		p0[safeIndex(727, p0.Length)] := |v1| - f29;
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			p0[safeIndex(727, p0.Length)] := p0[safeIndex(727, p0.Length)] + f29;
			var v5 := 'd';
			v5 := v5;
			var v6 := true;
			var v7 := new C0(!v6);
			var v8: multiset<bool> := multiset{v7.f27};
			var v9: map<int, bool> := map[if (v6 in v8) then v8[v6] else p0[safeIndex(727, p0.Length)] := v7.f27];
			var v10: seq<int> := [f29, p0[safeIndex(727, p0.Length)] * p0[safeIndex(727, p0.Length)], |v9| + f29, f29, p0[safeIndex(727, p0.Length)]];
		...
		for i5 := |(if (v12 in v14) then v14[v12] else [v12])| to p0[safeIndex(727, p0.Length)] * f29 {
			var v15 := 'e';
			var v16: map<int, char> := map[i5 := v15];
			v16 := v16[-(|v13| * -0x2bf) := v15];
			var v17 := DC23(|v1|);
			globalState.f7 := v17.cf30;
			var v18: seq<int> := [p0[safeIndex(727, p0.Length)], 0x28b, p0[safeIndex(727, p0.Length)], f29];
			...
			v20 := v20[v11 := (seq(abs(0x370), i6  => ([p0[safeIndex(727, p0.Length)], 0x170, |"jcxjkvp"|]))) + v21];
			var v22: multiset<seq<int>> := multiset{v18, v18, seq(abs(-0x330), i7  => (i5)), [i5, -i5], v18[safeIndex(938, |v18|) := 0xce]};
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		...
		if (fm7(v0, if (v0) then f29 else p0, p0 == |multiset{p0}|, globalState)) {
			...
			match (DC20(v2[multiset(v5[safeIndex(0x8f, |v5|) := f29]) := v0])) {
				case DC20(cf27) =>
					globalState.f13 := v0;
					globalState.f7 := p0;
					var v6 := new C0(v0);
			...
			if (false) {
				...
				v13[safeIndex(938, v13.Length)] := v15;
				var v16: map<bool, bool> := map[true := v0];
				v13[safeIndex(938, v13.Length)] := map[fm2(v16, globalState) := v14] + v15;
				var v17 := DC15(seq(abs(279), i0  => (|"kueylnvh"|)));
				var v18 := DC17(v17);
				var v19: seq<D7> := [v18];
				...
				v21[safeIndex(810, v21.Length)] := -f29;
				var v22: map<bool, int> := map[v0 := p0];
				v21[safeIndex(810, v21.Length)] := safeDivisionInt(if (v0 in v22) then v22[v0] else f29, p0);
				var v23: multiset<bool> := multiset{v0};
				var v24: seq<multiset<bool>> := [v23];
				var v25 := DC19(v24[safeIndex(|v22|, |v24|)]);
				v25 := v25;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			globalState.f13 := !v0;
			var v32: array<int> := new int[2](i2 => safeModuloInt(i2, |multiset{v0, !v31.f27}|));
			...
			v32[safeIndex(572, v32.Length)] := f29;
			v32[safeIndex(572, v32.Length)] := f29;
			var v37: map<int, bool> := map[v32[safeIndex(572, v32.Length)] := v31.f27];
			var v38 := DC2(v37 + v37);
			v38 := DC2(v37);
...
class C2 extends T1 {
	...
	method m2(p0: int, p1: bool, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<map<bool, D3>>) {
		...
		for i0 := f28 to |v0| {
			...
			var v3: multiset<int> := multiset{safeDivisionInt(|v2|, f28), i0};
			var v4 := DC9(-p0);
			v1.f27, globalState.f7, globalState.f7, globalState.f7 := v1.f27, if (f28 in v3) then v3[f28] else -(if (p0 in v3) then v3[p0] else p3), v4.cf11 + p3, -safeModuloInt(p0, i0);
			var v5: seq<bool> := [p1];
			var v6 := DC18(v5);
			var v7 := 'q';
			var v8: array<seq<bool>> := new seq<bool>[19] [v5, v5, v5[safeIndex(0x3cd, |v5|) := v1.f27], v5, v6.cf25, [v1.f27], v5 + (fm18(v1.f27, 'p', v1.f27, globalState))[safeIndex(i0, |fm18(v1.f27, 'p', v1.f27, globalState)|) := v1.f27], v5, v5, v5 + v5, v5, [v1.f27], v5, [p1, v1.f27, p1, v1.f27], fm18(!v1.f27, v7, v1.f27, globalState) + v5, v5[safeIndex(p0, |v5|) := v1.f27], [v1.f27], v5, v5];
			v8[safeIndex(977, v8.Length)] := v5;
			v8[safeIndex(977, v8.Length)] := v5;
		}
		...
		var v14: map<string, set<bool>> := map[seq(abs(-0x5e), i2  => ('w')) := v13];
		var v15: seq<int> := [p0, p0];
		var v16: seq<bool> := [p1, p1, p1];
		var v17: array<set<bool>> := new set<bool>[13] [if (v0 in v14) then v14[v0] else v13, {p1} * v13, v13 * v13, v13, v13, v13, v13, v13, fm19(|v15|, v16[safeIndex(0x2be, |v16|)], p1, -0x384, globalState), DC21(v13).cf28 + {p1}, v13, v13 + v13, v13 * {p1, p1, p1, p1, p1}];
		v17[safeIndex(693, v17.Length)] := v13;
		var v18: C0 := new C0(p3 < f28);
		globalState.f7, globalState.f21, v12, v17[safeIndex(693, v17.Length)], v18 := (f28 * p3) * safeDivisionInt(p3, |v15|), p1, v12, v13, v18;
		v18.f27 := v18.f27;
		var v19: array<bool> := new bool[17](i3 => if (v18.f27) then v18.f27 else v18.f27);
		v19[safeIndex(337, v19.Length)] := p1;
		var v20 := 'a';
		var v21 := DC18(fm18(v18.f27, v20, false, globalState));
		globalState.f7, v19[safeIndex(337, v19.Length)] := fm17(v18.f27, seq(abs(0x206), i4  => (f28)), |(seq(abs(0xbf), i5  => ('x')))|, v21, globalState), v18.f27 || v18.f27;
		...
		r1 := match DC7(0x196) {
			case DC8(cf10) => p3
			case DC9(cf11) => |DC22(map[v19[safeIndex(337, v19.Length)] := p3]).cf29|
	...
	method m3(p0: array<int>, globalState: GlobalState) {
		...
		match (v0.(cf30 := f28 * f28)) {
			case DC23(cf30) =>
				...
				if (v5[fm2(fm20(cf30, v1, v1, v1, globalState), globalState) := |"bkpcvyger"|] != v5) {
					...
					v7[safeIndex(115, v7.Length)] := p0;
					v7[safeIndex(115, v7.Length)] := p0;
					var v8: array<set<map<bool, bool>>> := new set<map<bool, bool>>[6];
					var v9: map<bool, bool> := map[v1 := v1];
					var v10: set<map<bool, bool>> := {v9};
					v8[safeIndex(135, v8.Length)] := v10;
					v8[safeIndex(135, v8.Length)] := v10;
					var v11: set<bool> := {v1};
					var v12: map<int, bool> := map[|v11| := v1];
					globalState.f2 := cf30 !in v12;
					var v13 := "aaacch";
					var v14: seq<string> := [v13 + (seq(abs(0x3c6), i0  => (v2))), v13, v13];
					globalState.f0, globalState.f0, v7[safeIndex(115, v7.Length)], globalState.f19, globalState.f16 := v1, !v1, v7[safeIndex(115, v7.Length)], v14[safeIndex(-f28, |v14|)], cf30;
				} else {
					v2 := 'a';
					m8(!!!v1, v1, v1, globalState);
					var v15: seq<bool> := [v1];
					globalState.f7, globalState.f7 := ---safeModuloInt(cf30, f28), |v15|;
					var v16 := "olkogre";
					var v17: map<string, bool> := map[v16[safeIndex(cf30, |v16|) := v2] := if (false) then !v1 else false];
					globalState.f0, v17, globalState.f2 := v1, v17, v1;
					globalState.f16 := f28;
				}
				
				p0[safeIndex(341, p0.Length)] := cf30;
				p0[safeIndex(341, p0.Length)], globalState.f7, v2 := f28, -20 - cf30, v2;
				...
				match (v20) {
					case DC4(cf4) =>
						...
						globalState.f16 := f28;
						var v23 := "am";
						var v24: set<int> := {safeDivisionInt(-250, f28), p0[safeIndex(341, p0.Length)], f28, |(v23 + v23)[safeIndex(cf30, |(v23 + v23)|) := v2]|};
						v24 := (v24 - v24) - v24;
				}
				...
				var v29: multiset<int> := multiset{p0[safeIndex(341, p0.Length)], v27[safeIndex(|v28|, |v27|)]};
			...
			case DC22(cf29) =>
				...
				var v32 := true;
				var v34 := DC25(map v33 : int | v33 in fm21(globalState) :: (safeModuloInt(v33, f28)) := (f28));
				...
				var v38 := DC4(v37);
				v36[safeIndex(962, v36.Length)] := v38;
				v36[safeIndex(962, v36.Length)] := v38;
				if (true) {
					...
					var v44 := "mg";
					v43 := v43[366 := v44[safeIndex(f28, |v44|)]];
					var v45 := new C0(v32);
					v40 := v40;
					...
					globalState.f7 := (f28 * f28) - safeDivisionInt(if (v47 in v48) then v48[v47] else f28, f28);
					var v49: seq<bool> := [false];
					var v50 := "v";
					var v51 := 's';
					var v52 := DC6(v50, v51, v47.f27);
					var v53: map<seq<bool>, string> := map[v49 := v52.cf6];
					m0(v47.f27, f28, if (v47.f27) then map[v49[safeIndex(f28, |v49|) := v47.f27] := v50] else v53, f28, globalState);
					globalState.f16 := f28;
			...
			case DC24(cf31) =>
				...
				var v60 := DC26(v57, DC6(v57[safeIndex(f28, |v57|) := 'e'], v58, v56).cf8, v59[safeIndex(f28, |v59|)]);
				if (v60.cf35) {
					var v61: seq<int> := [f28];
					var v62: seq<seq<int>> := [v61, seq(abs(0x376), i2  => (f28))];
					var v63: seq<seq<seq<int>>> := [v62, v62];
					var v64: array<seq<seq<int>>> := new seq<seq<int>>[7] [v63[safeIndex(f28, |v63|)], v62, seq(abs(-179), i3  => (([|(seq(abs(-0xb1), i4  => (v58)))|])[safeIndex(f28, |[|(seq(abs(-0xb1), i4  => (v58)))|]|) := f28])), v62, v62, v62, if (v56) then v62 else (fm22(v56, v56, v59[safeIndex(f28, |v59|)], globalState))[safeIndex(f28, |fm22(v56, v56, v59[safeIndex(f28, |v59|)], globalState)|) := v61]];
					var v65: map<int, seq<seq<int>>> := map[-|v59| := v62];
					v64[safeIndex(451, v64.Length)] := v62 + (if (f28 in v65) then v65[f28] else v62);
					v64[safeIndex(451, v64.Length)] := v62;
					globalState.f13 := v56;
					p0[safeIndex(623, p0.Length)] := safeModuloInt(0x3d0, f28);
					p0[safeIndex(623, p0.Length)] := -f28;
					var v66: multiset<char> := multiset{v58, v57[safeIndex(0x139, |v57|)], if (v56) then v58 else v58, v58};
					globalState.f16 := if (v57[safeIndex(f28, |v57|)] in v66) then v66[v57[safeIndex(f28, |v57|)]] else safeDivisionInt(p0[safeIndex(623, p0.Length)], f28);
					globalState.f21 := !(f28 != f28);
				} else {
					globalState.f2 := v56;
					var v67: set<char> := {v58, v58};
					var v68: seq<set<char>> := [v67];
					globalState.f2 := 'w' in v68[safeIndex(0x39c, |v68|)];
					var v69: seq<int> := [f28];
					...
					v69 := [f28, |v75|, |(v77 * multiset{f28, |v57|})|, v69[safeIndex(f28, |v69|)]];
					var v78 := new C0(v56);
					v69 := ([|v59|, f28] + [-630]) + v69;
				}
		...
		if (true) {
			...
			var v80 := false;
			v79[safeIndex(864, v79.Length)] := v80;
			var v81 := "erwiuf";
			var v82: map<bool, string> := map[v80 := v81];
			v79[safeIndex(864, v79.Length)] := (fm23(v80, if (true in v82) then v82[true] else v81, seq(abs(0x32), i5  => ('i')), v80, globalState)).cf34;
			var v83: seq<int> := [|v81|, f28];
			var v84: set<int> := {v83[safeIndex(f28, |v83|)], f28, -f28};
			p0[safeIndex(268, p0.Length)] := --|v84|;
			p0[safeIndex(268, p0.Length)] := f28 + -f28;
			var v85: map<bool, array<bool>> := map[v79[safeIndex(864, v79.Length)] := v79];
			var v86: map<map<bool, array<bool>>, int> := map[v85 := -0xd2];
			v86 := v86[v85 + v85 := p0[safeIndex(268, p0.Length)]];
			var v87: map<bool, int> := map[v80 := -f28];
			var v88: map<int, int> := map[f28 := |v87|];
			v88 := v88[p0[safeIndex(268, p0.Length)] := p0[safeIndex(268, p0.Length)]];
			var v89 := new C0(v79[safeIndex(864, v79.Length)]);
		} else {
			var v90 := true;
			...
			p0[safeIndex(273, p0.Length)] := f28;
			var v98: map<int, bool> := map[|(map v97 : int | (-0x79 <= v97) && (v97 < 0x13b) :: (v97 - f28) := (false))| := v90];
			p0[safeIndex(273, p0.Length)] := safeDivisionInt(|(v98 + v98)|, f28);
			globalState.f21 := v90;
			globalState.f0 := p0[safeIndex(273, p0.Length)] > f28;
		...
		var v101 := "jeovgrwpv";
		var v102: multiset<string> := multiset{seq(abs(0xb5), i6  => ('j')), v101, seq(abs(0x210), i7  => ('t'))};
		v102 := (v102 - v102) + v102;
		var v103 := true;
		...
		for i8 := (if (true in v104) then v104[true] else if (v103 in v104) then v104[v103] else |v105|) + 0x399 to f28 + fm17(v103, [f28], |v106|, v107, globalState) {
			...
			globalState.f16 := safeModuloInt(|v109[v103 := f28]|, safeModuloInt(762, i8));
			...
			match (v111) {
				case DC13(cf19, cf20) =>
					...
					globalState.f7, globalState.f7, globalState.f21, globalState.f21, v113 := cf20, cf20, v103 <==> v103, v114 > multiset{|v101|}, DC12(v112).(cf18 := v112[safeIndex(677, |v112|) := p0]);
				...
				case DC12(cf18) =>
					...
					v117[safeIndex(799, v117.Length)] := v103 in v119[safeIndex(i8, |v119|)];
					v117[safeIndex(799, v117.Length)] := if (v103) then v103 && v103 else i8 <= f28;
				case DC14(cf21) =>
					globalState.f2 := v103 <==> v103;
					var v120 := DC0(v103);
					var v121: seq<multiset<bool>> := [(multiset{!v120.cf0})[!v103 := abs(i8)]];
					v104 := v121[safeIndex(i8, |v121|)];
		...
		v126[safeIndex(873, v126.Length)] := v101 + fm1(f28, globalState);
		v126[safeIndex(873, v126.Length)] := v101;
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		...
		var v7: array<bool> := new bool[16] [!(|v0| <= f28), v1, v2 !in v3, if (v1) then v4[safeIndex(f28, |v4|)] else v5.cf3, v1 <==> v1, v1, v1, fm6(|v6|, globalState), v1, v1 <== true, v1, v1, v1, v1, v1, v1];
		forall i0 | 0 <= i0 < v7.Length {
			v7[i0] := v1;
		}
		var v8: map<int, int> := map[f28 := f28];
		var v9: array<char> := new char[15](i1 => v3[safeIndex(f28, |v3|)]);
		var v10: map<int, array<char>> := map[p0 := v9];
		v8 := v8[p0 := |v10| + f28];
		if (v1) {
			var v11: array<int> := new int[28](i2 => safeDivisionInt(i2, |map[v1 := p0]|));
			v11[safeIndex(261, v11.Length)] := p0;
			var v12: seq<string> := [seq(abs(-0x217), i3  => (v2)), "lwkghweu", v3];
			var v13: seq<string> := [v12[safeIndex(0x1fd, |v12|)], v3, v3, "hpd"];
			...
			v11[safeIndex(261, v11.Length)], globalState.f21, v12, v14 := safeModuloInt(p0, f28), (set v16 : map<int, int> | v16 in v15 :: (v16)) !! v17, v12, (v14 + v14) + v14;
			v1 := false;
			globalState.f13 := !v1;
			globalState.f21 := v1;
			var v18: array<string> := new string[10] [v3, fm1(|v3|, globalState), v3, (fm25(v1, f28, v1, 0x34a, globalState)).cf6, v3, v3, v3, v3[safeIndex(p0, |v3|) := v2], v3, v3];
			v18[safeIndex(327, v18.Length)] := v3;
			v18[safeIndex(327, v18.Length)] := v3 + v3;
		} else {
			...
			v24[safeIndex(141, v24.Length)] := v19;
			...
			v24[safeIndex(141, v24.Length)], v25, globalState.f7, globalState.f0 := if (v1) then if (v1) then v19 else v19 else v19, (v25[safeIndex(|v27|, |v25|) := multiset(v4) - v28])[safeIndex(p0, |v25[safeIndex(|v27|, |v25|) := multiset(v4) - v28]|) := v28[v1 := abs(f28)]], v29.cf16, v1;
			var v30 := new C0(true);
			...
			if (v1) {
				...
				v33[safeIndex(650, v33.Length)] := v37;
				var v38: seq<map<int, bool>> := [v34, v34];
				v7, globalState.f7, v33[safeIndex(650, v33.Length)] := v7, |(v38 + v38)|, if (v31.f27) then v37 else v37;
				v7 := v7;
			...
			v24[safeIndex(141, v24.Length)][safeIndex(365, v24[safeIndex(141, v24.Length)].Length)] := safeDivisionInt(f28, p0);
			var v42 := DC13(f28, |multiset{v31.f27}|);
			var v43 := DC14(v42);
			var v44 := DC14(v42);
			var v45: seq<string> := [v3];
			var v46: seq<string> := [v45[safeIndex(f28, |v45|)], v3, v3, "ikcvsk"];
			v24[safeIndex(141, v24.Length)][safeIndex(365, v24[safeIndex(141, v24.Length)].Length)], v44, globalState.f7, globalState.f20 := -f28, v44, safeModuloInt(p0, p0), v46[safeIndex(f28, |v46|)];
		}
		...
		for i4 := p0 to f28 {
			...
			v47[safeIndex(20, v47.Length)] := v48 + v48;
			v47[safeIndex(20, v47.Length)] := v48 + map[i4 := v1];
		...
		if (fm26(v2, v50, globalState) > v0) {
			...
			if (v1) {
				...
				var v65: array<int> := new int[9] [p0, -|map[v63.cf9 := true]|, -|(seq(abs(0x3da), i5  => (v2)))|, f28, p0, p0, |v64|, p0, f28];
				...
				var v69: seq<seq<int>> := [(seq(abs(0x3dd), i8  => (|"efk"|)))[safeIndex(f28, |(seq(abs(0x3dd), i8  => (|"efk"|)))|) := f28], seq(abs(0x18c), i9  => (p0))];
				var v70: map<bool, seq<int>> := map[v1 := v69[safeIndex(|v68|, |v69|)]];
				var v71: array<seq<int>> := new seq<int>[22] [v68, v68, if (v1) then v68 else v68, v68 + v68, v68, (v68 + v68)[safeIndex(p0, |(v68 + v68)|) := if (p0 in v8) then v8[p0] else |v3|], seq(abs(792), i6  => (p0)), v68, v68, v68, v68, v68[safeIndex(f28, |v68|) := f28], v68, v68 + v68, (seq(abs(0x1d7), i7  => (p0))) + v68, v68, v68, if (fm2(v66, globalState) in v70) then v70[fm2(v66, globalState)] else v68, fm21(globalState), if (v1) then v68 else v68, v68 + v68, v68];
				v71[safeIndex(405, v71.Length)] := v69[safeIndex(-f28, |v69|)];
				v71[safeIndex(405, v71.Length)] := v68;
			}
			
			var v72: array<int> := new int[23](i10 => safeDivisionInt(i10, f28));
			var v73: map<int, array<int>> := map[f28 := v72];
			r0 := if (p0 in v73) then v73[p0] else v72;
			var v74, v75, v76, v77 := m9(globalState);
			if (v4[safeIndex(p0, |v4|)]) {
				v2 := v2;
				var v78 := new C0(v77);
				v4 := [fm6(-80, globalState), v1];
				var v79: array<set<int>> := new set<int>[2] [v0 - v0, v0];
				v79[safeIndex(956, v79.Length)] := v0;
				var v80: array<array<int>> := new array<int>[12];
				v80[safeIndex(124, v80.Length)] := v72;
				v79[safeIndex(956, v79.Length)], v80[safeIndex(124, v80.Length)], globalState.f2 := v0, v72, v76;
				...
				var v85: seq<array<int>> := [v84[safeIndex(p0, |v84|)]];
				v7, globalState.f2, v80[safeIndex(124, v80.Length)] := v7, v82[|v3| := abs(|"xnvuuooh"|)] >= fm28(v79[safeIndex(956, v79.Length)], p0, v74, true, globalState), v84[safeIndex(-f28, |v84|)];
			} else {
				...
				var v88: set<T1> := {v87};
				var v89: seq<int> := [p0];
				var v90 := DC18((v4[safeIndex(|v8|, |v4|) := v74])[safeIndex(f28, |v4[safeIndex(|v8|, |v4|) := v74]|) := v75]);
				...
				v7 := v7;
				v72[safeIndex(526, v72.Length)] := fm0(|v3|, f28, p0, v76, globalState);
				v72[safeIndex(526, v72.Length)] := safeDivisionInt(if (!v75) then |v3| else |fm35(v76, f28, globalState)|, |v3|);
				globalState.f19 := (v3[safeIndex(f28, |v3|) := v2] + v3) + (v3 + v3);
			}
			
			if (v77) {
				v0 := v0;
				var v93: seq<string> := [v3];
				globalState.f20 := (seq(abs(-0x359), i11  => (v2))) + v93[safeIndex(f28, |v93|)];
				...
				var v99: T1 := new C1(|v96|, [map v97 : int | v97 in multiset{-(if (v1 in v98) then v98[v1] else p0)} :: (safeDivisionInt(v97, f28)) := (v1)]);
				var v100: map<bool, T1> := map[!v76 := v99];
				v100 := v100 + v100;
				globalState.f16, globalState.f16 := p0, -|v3|;
				v1 := v77;
				v75 := v1;
				var v101 := new C0(v3 < (seq(abs(-0x2a1), i12  => (v2))));
			}
	...
	method m8(p0: bool, p1: bool, p2: bool, globalState: GlobalState) {
		...
		var v10: array<map<D6, int>> := new map<D6, int>[19] [v6, v6, v7[safeIndex(f28, |v7|)] + v6, v6, v6, v6[v5 := f28], v6 + v6, v7[safeIndex(|v8|, |v7|)] + v6, v6 + v6, v6, v6, v6[v5 := f28], v6, v6[v5 := |v9|], v6, v6 + map[v5 := |v0|], v6, v6 + v6, v6];
		v10 := v10;
			...
			decreases 100 - i1
		{
			...
			if (p1) {
				...
				v11[safeIndex(37, v11.Length)] := p0;
				var v15 := DC3(p2);
				v11[safeIndex(37, v11.Length)] := v15.cf3;
				globalState.f21 := false;
				v3[safeIndex(317, v3.Length)] := safeDivisionInt(f28, f28);
				v3[safeIndex(317, v3.Length)] := safeDivisionInt(f28 * f28, -f28 + |v1|);
				globalState.f21 := false;
			} else {
				globalState.f16 := f28;
				var v16 := new C0(p0);
				globalState.f7 := safeModuloInt(f28, f28);
				var v17: set<int> := {f28};
				var v18: map<set<int>, set<bool>> := map[v17 := {p2, p0}];
				var v19: set<bool> := {v16.f27, false, p1, p2, p1};
				v18 := v18[v17 := v19];
				var v20: array<seq<bool>> := new seq<bool>[13];
				v20[safeIndex(965, v20.Length)] := v0;
				v20[safeIndex(965, v20.Length)] := v0 + v0;
			}
			...
			v23, globalState.f7, globalState.f2, globalState.f16 := v23, --safeModuloInt(f28, fm0(|v24|, fm0(f28, 0x15e, |(if (p2 in v26) then v26[p2] else v25)|, p1, globalState), f28, p0, globalState)), p2, f28;
		}
		var v27: array<multiset<bool>> := new multiset<bool>[28](i3 => multiset{!p2, p2, p0});
		var v28: multiset<bool> := multiset{p2};
		v27[safeIndex(404, v27.Length)] := v28;
	...
	method m9(globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			var v2 := 'h';
			v1[safeIndex(121, v1.Length)] := v2;
			var v3 := false;
			v1[safeIndex(121, v1.Length)] := fm27(f28 == f28, v3, globalState);
			var v4: map<bool, bool> := map[v3 := v3];
			var v5: seq<bool> := [if (v3 in v4) then v4[v3] else v3, v3];
			var v6 := DC18(v5);
			var v7: map<bool, seq<bool>> := map[v3 := v5];
			var v8 := DC29(fm17(v3, seq(abs(0x374), i2  => (|[v3, false]|)), f28, v6, globalState), v7);
			globalState.f16 := -v8.cf38;
			match (DC30(v0, v5[safeIndex(f28, |v5|) := !v3])) {
				case DC29(cf38, cf39) =>
					...
					v14[safeIndex(93, v14.Length)] := cf38 - |v15|;
					v14[safeIndex(93, v14.Length)] := safeModuloInt(cf38, cf38);
					v0 := v0;
					var v16: map<seq<int>, seq<bool>> := map[((v0[safeIndex(v14[safeIndex(93, v14.Length)], |v0|) := cf38])[safeIndex(v14[safeIndex(93, v14.Length)], |v0[safeIndex(v14[safeIndex(93, v14.Length)], |v0|) := cf38]|) := v14[safeIndex(93, v14.Length)]])[safeIndex(--0xcd, |(v0[safeIndex(v14[safeIndex(93, v14.Length)], |v0|) := cf38])[safeIndex(v14[safeIndex(93, v14.Length)], |v0[safeIndex(v14[safeIndex(93, v14.Length)], |v0|) := cf38]|) := v14[safeIndex(93, v14.Length)]]|) := f28] := v5];
					var v17 := "gsaqxlayd";
					...
					var v29: array<map<seq<int>, seq<bool>>> := new map<seq<int>, seq<bool>>[27] [v16, v16, v16, v16, map[v0 := [v3, false, v3]], v16[[|v17|, 0xcd] := v5] + v16, v16, v18[safeIndex(|v19|, |v18|)], v16, v16, v16, v16, v16, fm39(|v9|, v3, f28, globalState), map[v0 := v5], v16, (map v20 : seq<int> | v20 in v22 :: (v20) := ([v3])) + v16, map[v0 := v5], (v23.(cf46 := v16)).cf46, v16, (map v24 : seq<int> | v24 in v25 :: (v24) := (v5)) + v16, v16, v16, v16, v16, (map v26 : seq<int> | v26 in v25 :: (v26) := (v5))[v0 := v5], (map v27 : seq<int> | v27 in v28 :: (v27) := ([v3, false])) + v16];
					v29[safeIndex(867, v29.Length)] := v16;
					var v30: C0 := new C0(false);
					v29[safeIndex(867, v29.Length)], v2, v14[safeIndex(93, v14.Length)], r1, v30 := v23.cf46, v2, v14[safeIndex(93, v14.Length)], f28 != safeDivisionInt(f28, |v17|), v30;
				case DC30(cf40, cf41) =>
					var v31: map<seq<bool>, string> := map[[cf41[safeIndex(-f28, |cf41|)], fm6(f28, globalState)] := seq(abs(0x177), i4  => (v1[safeIndex(121, v1.Length)]))];
					var v32 := "bfsvcv";
					...
					v35[safeIndex(926, v35.Length)] := v34;
					v35[safeIndex(926, v35.Length)] := v34;
				case DC28(cf37) =>
					globalState.f7 := f28 * safeModuloInt(f28, 0x12c);
					var v36: set<bool> := {v3};
					...
					v39[safeIndex(400, v39.Length)] := v36 * v36;
					v39[safeIndex(400, v39.Length)] := v36;
					var v40: seq<seq<int>> := [v0];
					var v41: array<seq<int>> := new seq<int>[4] [v0 + [|cf37|, f28, f28], v0 + v0, v0, v40[safeIndex(f28, |v40|)]];
					v41[safeIndex(791, v41.Length)] := fm21(globalState) + v0;
					v41[safeIndex(791, v41.Length)] := v0;
				...
				case DC31(cf42) =>
					...
					globalState.f7, globalState.f16 := v0[safeIndex(f28, |v0|)], if (true in v46) then v46[true] else f28;
			...
			v58[safeIndex(985, v58.Length)] := !!!v3;
			var v59 := "ji";
			var v60: map<bool, int> := map[v3 := f28];
			var v61: array<string> := new string[10] [v59, seq(abs(947), i6  => ('h')), v59, v59 + v59, seq(abs(0x3b5), i7  => (v2)), v59, v59 + (seq(abs(0x1f), i8  => (v2))), (v59[safeIndex(|v60|, |v59|) := v1[safeIndex(121, v1.Length)]])[safeIndex(|v5|, |v59[safeIndex(|v60|, |v59|) := v1[safeIndex(121, v1.Length)]]|) := 'd'], "xry", seq(abs(0x31), i9  => (v2))];
			v61[safeIndex(629, v61.Length)] := seq(abs(0x11c), i10  => ('w'));
			var v62 := DC26(v59, v3, v3);
			v57, v1[safeIndex(121, v1.Length)], v58[safeIndex(985, v58.Length)], v61[safeIndex(629, v61.Length)] := map[(v62.(cf34 := v3)).cf34 := v56], if (v3 && v3) then v1[safeIndex(121, v1.Length)] else v1[safeIndex(121, v1.Length)], fm2(v4, globalState) && v62.cf35, v59[safeIndex(f28, |v59|) := v1[safeIndex(121, v1.Length)]];
		}
		var v63 := true;
		...
		v67[safeIndex(28, v67.Length)] := v70;
		var v71 := DC38(v70);
		v66, globalState.f7, v67[safeIndex(28, v67.Length)] := v66, f28, v71.cf51;
		var v72 := 'p';
		v72 := v72;
		globalState.f16 := f28;
		globalState.f7 := |{v63, if (v63) then v63 else v63, v63, v63}|;
		var v73 := DC33(([f28])[safeIndex(f28, |[f28]|) := f28]);
		var v74 := DC34(v73);
		...
		var v80: seq<T1> := [v79];
		r3 := !!(|(v80 + v80)| < safeModuloInt(--0x30b, f28));
	}
}
...
class C3 extends T0 {
	...
	function fm5(p0: int, p1: seq<D0>, p2: int, p3: int, globalState: GlobalState): map<bool, string> {
		map[523 == |[[false]]| := seq(abs(992), i0  => ('o'))]
	}
	function fm6(p0: int, globalState: GlobalState): bool {
		false
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		...
		v6 := v6[p0 := v8[safeIndex(p0, |v8|)]];
		if (v4) {
			var v9: array<int> := new int[25](i0 => safeModuloInt(i0, p0));
			...
			r1, globalState.f0, v10 := v12.cf14, !((|v13| * |v11|) <= p0), v15[safeIndex(p0, |v15|)];
			globalState.f16 := p0;
			...
			var v18 := new C0(v4);
			v14 := v14.(cf18 := (v10 + v10)[safeIndex(p0, |(v10 + v10)|) := v9]);
		} else {
		...
		if (match v21 {
			...
			var v25: array<int> := new int[9](i1 => safeModuloInt(i1, |map[v23.f27 := DC9(p0)]|));
			var v26: seq<int> := [p0, p0];
			v25[safeIndex(128, v25.Length)] := |v26| - p0;
			var v27: set<bool> := {v4};
			globalState.f21, v25[safeIndex(128, v25.Length)], globalState.f2 := (v27 - v27) >= v27, fm0(p0 - p0, |multiset{true}|, p0, v24.f27, globalState), v23.f27;
		} else {
			var v28 := "tsxxruaee";
			...
			var v33: array<multiset<int>> := new multiset<int>[22] [v29, v29, v29, multiset([p0]), v29, multiset{p0, 0x316}, v29, v29, multiset{p0, --p0, p0, |v28|}, multiset(v31.cf22) + v29, if (v4) then v29 else v29, v29, v29 + v29, v29 - v29, v29, v29 * v29, multiset{p0}, v29, v29, v29[p0 := abs(|v28|)] - v29, v29, fm12(v28, 0x1c5, v4, globalState) + multiset(v30)];
			v33[safeIndex(891, v33.Length)] := v29 * v29;
			v33[safeIndex(891, v33.Length)] := multiset(v30);
			globalState.f2 := v4;
			var v34: array<int> := new int[19](i2 => safeModuloInt(i2, p0));
			v34[safeIndex(410, v34.Length)] := p0;
			v34[safeIndex(410, v34.Length)] := 62;
			globalState.f13 := v4;
		}
		...
		var v40: array<multiset<char>> := new multiset<char>[12] [v36, v36, v36, v36, v36, fm13(|v37|, !v4, v38, v4, globalState), v36, v36, v36 + v39[safeIndex(p0, |v39|)], v36 * v36, if (v4) then v36 else v36, v36];
		...
		match (v44) {
			case DC16(cf23) =>
				...
				v45 := v45[("jyay")[safeIndex(p0, |"jyay"|) := v35] + v37 := p0];
				var v46 := DC13(p0, p0);
				globalState.f21 := v7[safeIndex(v46.cf20, |v7|)];
				var v47: map<bool, string> := map[v4 := "eaxlkubrh"];
				var v48: map<string, bool> := map[(if (v4 in v47) then v47[v4] else v37)[safeIndex(0x339, |(if (v4 in v47) then v47[v4] else v37)|) := v35] + v37 := v7[safeIndex(fm0(-0x93, p0, p0, v4, globalState), |v7|)]];
				v48 := v48[v37 := p0 >= p0];
				if (v4) {
					globalState.f2 := v4;
					var v49: array<array<int>> := new array<int>[10];
					var v50: array<int> := new int[12](i4 => i4 - p0);
					v49[safeIndex(964, v49.Length)] := v50;
					v49[safeIndex(964, v49.Length)] := v50;
					...
					var v60: array<int> := new int[14](i5 => safeModuloInt(i5, DC9(p0).cf11));
					v60[safeIndex(556, v60.Length)] := p0;
					v60[safeIndex(556, v60.Length)] := p0;
					...
					var v64: multiset<int> := multiset{0x174, if (v35 in v63) then v63[v35] else v60[safeIndex(556, v60.Length)]};
					var v65: map<bool, multiset<int>> := map[v4 := v64];
					globalState.f21, v5, v62 := fm0(p0, |v65|, v60[safeIndex(556, v60.Length)], v4, globalState) >= safeModuloInt(|DC19(v5).cf26|, |v37|), v5, v62 + v62;
					globalState.f7 := p0;
					globalState.f0 := v4;
				}
				
			case DC15(cf22) =>
				var v66: multiset<string> := multiset{seq(abs(0x3b1), i6  => (v35)), "tbsqpray", v37};
				globalState.f7 := |v66|;
				globalState.f0 := v7[safeIndex(p0, |v7|)];
				globalState.f7 := p0;
				var v67: array<int> := new int[16];
				v67[safeIndex(517, v67.Length)] := p0;
				var v68: array<map<bool, array<int>>> := new map<bool, array<int>>[15];
				var v69: map<bool, array<int>> := map[!v4 := v67];
				v68[safeIndex(636, v68.Length)] := v69;
				var v70: seq<map<bool, array<int>>> := [v69];
				v67[safeIndex(517, v67.Length)], cf22, v68[safeIndex(636, v68.Length)] := |fm14(p0, v4, globalState)| + -p0, cf22, v70[safeIndex(fm0(p0, p0, p0, v4, globalState), |v70|)];
			case DC17(cf24) =>
				if (v4) {
					...
					v76[safeIndex(594, v76.Length)] := fm2(v71, globalState);
					var v77: set<int> := {p0};
					var v78: multiset<set<int>> := multiset{v77, v77 + {p0}, {p0, p0} + v77, v77};
					globalState.f16, v76[safeIndex(594, v76.Length)], v78 := 0x383, v37 < v37, v78;
					var v79 := new C0(v4);
				} else {
					v38 := v38;
					globalState.f13 := v4;
					...
					globalState.f7 := fm0(|v80|, p0 - |(seq(abs(94), i8  => (p0)))|, if (false in v5) then v5[false] else p0, !(v4 || v4), globalState);
				}
				...
				v85[safeIndex(480, v85.Length)] := v5 * v5;
				v85[safeIndex(480, v85.Length)] := v5;
		}
	...
	method m7(p0: array<char>, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: D1, r1: int) {
		...
		v2 := v2[v0 := v1];
		for i0 := 0x380 to p3 {
			p0[safeIndex(593, p0.Length)] := 'k';
			var v3 := 'o';
			p0[safeIndex(593, p0.Length)] := v3;
			var v4 := false;
			if (v4) {
				globalState.f2 := v4;
				...
				p0[safeIndex(593, p0.Length)] := 'n';
			} else {
				var v7: array<bool> := new bool[29](i1 => DC10(p3, p1, !v4, v4, -p2).cf15 <== false);
				v7[safeIndex(390, v7.Length)] := i0 < i0;
				globalState.f2, v7[safeIndex(390, v7.Length)], globalState.f0 := v4, DC0(v4).cf0, v4;
				var v8: multiset<int> := multiset{|map[v7[safeIndex(390, v7.Length)] := p3]|, 0x36f, |{false, v4}|, p2, p3};
				var v9: seq<multiset<int>> := [v8, v8];
				var v10: map<multiset<int>, bool> := map[v9[safeIndex(p1, |v9|)] := v4];
				var v11: map<bool, bool> := map[v4 := v4];
				var v12: map<bool, bool> := map[if (v4 in v11) then v11[v4] else v7[safeIndex(390, v7.Length)] := v4];
				...
				var v16 := DC7(|v15|);
				v14[safeIndex(568, v14.Length)] := v16;
				v14[safeIndex(568, v14.Length)] := fm16(p1, v4, globalState);
				globalState.f7 := p2;
				v7[safeIndex(390, v7.Length)] := v7[safeIndex(390, v7.Length)];
			}
			...
			if (v17 !! (v17 + v17)) {
				...
				globalState.f16 := |v19|;
				var v20: multiset<char> := multiset{fm15(seq(abs(0x14), i2  => (p2)), v18[safeIndex(p3, |v18|)], globalState)};
				v20 := v20;
				var v21: array<D6> := new D6[7];
				var v22: set<bool> := {v4};
				var v23 := DC13(|v22|, |{p1}|);
				var v24 := DC14(v23);
				v21[safeIndex(717, v21.Length)] := v24;
				v21[safeIndex(717, v21.Length)] := v24;
				globalState.f16 := p3;
			} else {
				var v25: seq<bool> := [v4, v4, v4];
				globalState.f21 := v25[safeIndex(p1, |v25|)];
				var v26: multiset<int> := multiset{i0};
				var v27: map<multiset<int>, bool> := map[v26 := v4];
				var v28 := DC20(v27);
				globalState.f2 := |(v28.(cf27 := v27)).cf27| == safeModuloInt(p2, p1);
				p0[safeIndex(593, p0.Length)] := p0[safeIndex(593, p0.Length)];
				v3 := v3;
			...
			decreases 100 - i3
		{
			...
			var v31 := DC8(v29);
			v30[safeIndex(56, v30.Length)] := v31;
			var v32 := 'd';
			v30[safeIndex(56, v30.Length)], v32 := v31, v32;
			...
			if (v29 || (v34 >= v34)) {
				...
				v36 := v36;
				v0 := v0;
				v36[safeIndex(753, v36.Length)] := v35.f27 || v35.f27;
				v36[safeIndex(753, v36.Length)] := v33 != v33;
				v32 := v32;
			} else {
				...
				var v40 := "vn";
				var v41: set<int> := {-813};
				var v43: seq<map<int, bool>> := [map v42 : int | (0x13c <= v42) && (v42 < 965) :: (safeModuloInt(v42, p1)) := (true)];
				var v44: T1 := new C1(p2, v43);
				var v45: seq<T1> := [v44];
				var v46: multiset<T1> := multiset{v44, v45[safeIndex(-0x121, |v45|)]};
				globalState.f13, r1, globalState.f20, globalState.f0, globalState.f7 := if (p3 in v38) then v38[p3] else v29, -(if (fm6(p3, globalState) in v39) then v39[fm6(p3, globalState)] else fm0(0xbb, -0x142, p3, v29, globalState)), v40[safeIndex(p1, |v40|) := v32], p2 > (|v41| - -p2), safeModuloInt(if (v44 in v46) then v46[v44] else p3, p1);
				r1 := p2;
				var v47: set<array<char>> := {p0};
				var v48: multiset<int> := multiset{|v47|};
				globalState.f16, globalState.f16 := if (v29) then 0x104 else safeDivisionInt(if (p2 in v48) then v48[p2] else p2, p1), fm0(--0x2fe + p1, fm0(p1, p3, p1, false, globalState), |(v39 + v39)|, v29 ==> v29, globalState);
				var v49 := new C1(p1, (([v38, map[p2 := v29], v38, v38[p3 := v29]])[safeIndex(|v40|, |[v38, map[p2 := v29], v38, v38[p3 := v29]]|) := v38])[safeIndex(p3, |([v38, map[p2 := v29], v38, v38[p3 := v29]])[safeIndex(|v40|, |[v38, map[p2 := v29], v38, v38[p3 := v29]]|) := v38]|) := v38]);
				var v50: array<bool> := new bool[5](i4 => true);
				v50[safeIndex(897, v50.Length)] := v29;
				v50[safeIndex(897, v50.Length)] := v29;
			}
			...
			if (v29) {
				...
				var v56 := new C1(safeDivisionInt(p3, p3), v55 + v55);
				var v57 := DC23(p1);
				var v58: seq<int> := [v57.cf30, v56.f29];
				v0[safeIndex(485, v0.Length)] := |v58|;
				var v59 := "ehgphob";
				v0[safeIndex(485, v0.Length)] := safeModuloInt(|v59|, -0x2d3);
				var v60 := new C0(v29);
				...
				var v64: map<seq<int>, map<int, multiset<int>>> := map[seq(abs(0x1d8), i7  => (p1)) := (map[p3 := v63])[0x374 := v63]];
				var v65 := DC18(v33);
				var v66: map<int, multiset<int>> := map[p1 := multiset{|v65.cf25|}];
				v62[safeIndex(95, v62.Length)] := if (v58 in v64) then v64[v58] else v66;
				v62[safeIndex(95, v62.Length)] := map v67 : int | (0x3 <= v67) && (v67 < 0x20c) :: (safeDivisionInt(v67, -p2)) := (v63);
		...
		v69 := (fm3(p2, v29, v70, v68.f28, globalState) + v71[safeIndex(v68.f28, |v71|)]) + v69;
		forall i8 | 0 <= i8 < v0.Length {
			v0[i8] := i8 - p2;
		}
		r0 := DC2(v69);
		r1 := fm0(p3, v68.f28, |(seq(abs(0x174), i9  => (DC18([v29]))))|, v29, globalState);
	}
}
...
class C4 {
	...
	method m5(p0: bool, globalState: GlobalState) {
		...
		var v2 := 0x2ab;
		var v3: map<array<bool>, bool> := map[DC11(v1[safeIndex(v2, |v1|)]).cf17 := !true];
		...
		f25, globalState.f7, f25, v0[safeIndex(513, v0.Length)] := if (v0 in v3) then v3[v0] else !false, safeDivisionInt((if (|v6| in v5) then v5[|v6|] else v2) + |v7|, if (v2 in v5) then v5[v2] else v2), v6[safeIndex(v2, |v6|)], fm11(v2, globalState) <= v9;
		...
		for i1 := v2 to v2 {
			...
			var v11: seq<int> := [i1];
			v10[safeIndex(387, v10.Length)] := v11[safeIndex(v2, |v11|)] + |v4|;
			v10[safeIndex(387, v10.Length)] := if (v0[safeIndex(513, v0.Length)] in v8) then v8[v0[safeIndex(513, v0.Length)]] else i1;
			var v12: map<array<bool>, int> := map[v0 := safeModuloInt(v2, 0x1db)];
			var v13 := 'v';
			var v14: map<int, map<array<bool>, int>> := map[i1 * v2 := v12[v0 := i1]];
			v0[safeIndex(513, v0.Length)], v12, globalState.f7, globalState.f21, v13 := false, if (v10[safeIndex(387, v10.Length)] in v14) then v14[v10[safeIndex(387, v10.Length)]] else if (v2 in v14) then v14[v2] else v12, (if (0xb in v5) then v5[0xb] else -590) * v2, v6[safeIndex(v10[safeIndex(387, v10.Length)], |v6|)], v13;
			v10[safeIndex(387, v10.Length)] := -safeDivisionInt(28, v2);
			v8 := (multiset{v0[safeIndex(513, v0.Length)], fm9(p0, globalState)})[f25 := abs(i1)] - (v8 + v8);
		}
		for i3 := safeModuloInt(0x211, v2) to -v2 {
			var v15: map<int, bool> := map[v2 + i3 := v0[safeIndex(513, v0.Length)]];
			v15 := v15[v2 := p0];
			var v16: multiset<array<bool>> := multiset{v0};
			var v17 := new C2(|v16|);
			v0[safeIndex(513, v0.Length)] := v0[safeIndex(513, v0.Length)];
			var v18 := DC27(!f25);
			match (if (f25) then v18 else v18) {
				case DC26(cf33, cf34, cf35) =>
					var v19 := 'f';
					globalState.f2 := !v6[safeIndex(safeDivisionInt(v17.f28, |map[v17.f28 := v19]|), |v6|)];
				...
				case DC27(cf36) =>
					...
					var v25: seq<seq<int>> := [(seq(abs(0x31a), i4  => (i3))) + (seq(abs(-0x2a8), i5  => (v17.f28))), if (f25) then v24 else v24, v24];
					var v26: map<int, seq<bool>> := map[|v15| := v6];
					var v27 := 'p';
					var v28: map<bool, bool> := map[v0[safeIndex(513, v0.Length)] := f25];
					var v29: array<seq<bool>> := new seq<bool>[19] [v6[safeIndex(|v26[fm0(v2, v2, v17.f28, false, globalState) := v6]|, |v6|) := p0], fm18(cf36, v27, f25, globalState) + fm18(f26, v27, p0, globalState), v6 + [true, fm2(v28, globalState), true], v6, v6, v6, v6 + v6, v6, [v0[safeIndex(513, v0.Length)], !v0[safeIndex(513, v0.Length)]] + fm18(cf36, v27, p0, globalState), v6, [v0[safeIndex(513, v0.Length)]] + v6, v6, v6 + [v0[safeIndex(513, v0.Length)]], v6 + v6, v6 + v6, v6 + v6, v6, [f25], [p0]];
					v29[safeIndex(952, v29.Length)] := v6;
					var v30 := "ytqvm";
					var v31: set<string> := {v30, v30};
					f25, globalState.f13, v25, v29[safeIndex(952, v29.Length)] := false, f25, fm22(fm2(map[cf36 := v0[safeIndex(513, v0.Length)]], globalState), v31 !! v31, p0, globalState), v6 + v6;
					...
					globalState.f13 := if (!(if (true in v28) then v28[true] else f25)) then v0[safeIndex(513, v0.Length)] else v32 in v33;
				case DC25(cf32) =>
					var v34: array<array<int>> := new array<int>[29];
					var v35: array<int> := new int[20];
					v34[safeIndex(292, v34.Length)] := v35;
					v35[safeIndex(122, v35.Length)] := -(if (v17.f28 in v5) then v5[v17.f28] else i3);
					var v36: array<string> := new seq<char>[8](i6 => (seq(abs(887), i7  => ('q'))) + "yxeguqbr");
					var v37 := "w";
					v36[safeIndex(540, v36.Length)] := v37;
					var v38: map<array<int>, char> := map[v35 := 'd'];
					var v39: map<bool, bool> := map[f25 := v0[safeIndex(513, v0.Length)]];
					var v40: set<array<int>> := {v35};
					v34[safeIndex(292, v34.Length)], globalState.f16, globalState.f2, v35[safeIndex(122, v35.Length)], v36[safeIndex(540, v36.Length)] := v35, -|(v38 + v38)|, fm2(v39, globalState), |((v40 + v40) * v40)|, "iaka" + v37;
					var v41: set<bool> := {v0[safeIndex(513, v0.Length)], p0};
					var v42: map<set<bool>, bool> := map[v41 := v0[safeIndex(513, v0.Length)] <== f25];
					v42 := v42[v41 * v41 := p0];
					globalState.f7 := safeDivisionInt(v17.f28, v17.f28);
					var v43 := new C2(v35[safeIndex(122, v35.Length)]);
			}
			
		}
		v0 := if (false) then v0 else v0;
		var v44: map<bool, bool> := map[p0 := p0];
		globalState.f21, v8 := v6[safeIndex(0xa0 * v2, |v6|)], multiset{p0, v2 < |v44|, p0};
	}
	method m6(p0: array<int>, p1: string, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		var v13: array<map<int, bool>> := new map<int, bool>[23] [v2, v2, v2, map v3 : int | (0x132 <= v3) && (v3 < 956) :: (safeModuloInt(v3, p3)) := (f25), v5.cf2, v2 + (map v6 : int | (0x2fe <= v6) && (v6 < 466) :: (safeModuloInt(v6, p3)) := (f25)), v2 + map[p3 := v7[safeIndex(p3, |v7|)]], v2 + map[p3 := f26], v2, v2, v2, (if (p3 in v8) then v8[p3] else (map[p3 := f26])[p3 := true]) + (map v9 : int | (0x292 <= v9) && (v9 < 0x2fa) :: (safeDivisionInt(v9, p3)) := (f26)), v2, v2, v2, v2, v2, v2, map[|v10| := true], v2, v2, map v11 : int | (0x1bc <= v11) && (v11 < 0x240) :: (safeModuloInt(v11, |map[f25 := f26]|)) := (f25), map v12 : int | (788 <= v12) && (v12 < 0x146) :: (safeModuloInt(v12, p3)) := (f25)];
		...
		v0, v1, v13, v14 := v0, v15[safeIndex(p3 + p3, |v15|)], v13, v14;
		var v16 := DC23(-p3);
			...
			decreases 100 - i1
		{
			...
			if ('u' !in p1) {
				v1 := v1;
				v1[safeIndex(813, v1.Length)] := f25;
				f25, v1[safeIndex(813, v1.Length)], globalState.f16 := "iongp" < (p1 + p1), f26, |(p1 + "osab")|;
				var v20 := 'q';
				var v21: map<bool, int> := map[!v1[safeIndex(813, v1.Length)] := fm0(p3, 169, p3, false, globalState)];
				var v22: map<char, int> := map[v20 := ---|(v21 + v21)|];
				v22 := v22[v20 := -0x19 - (if (v1[safeIndex(813, v1.Length)] in v21) then v21[v1[safeIndex(813, v1.Length)]] else p3)];
				...
				var v27: map<set<int>, bool> := map[set v26 : int | (-0x2ce <= v26) && (v26 < -0x287) :: (safeDivisionInt(v26, p3)) := f25];
				v25 := v25[|v27| := p3];
				var v28 := DC30(v0 + v0, v7 + v7);
				v28 := v28;
				var v29: array<array<int>> := new array<int>[7] [p2, p2, p0, p2, p2, p0, p2];
				v29[safeIndex(638, v29.Length)] := p2;
				v29[safeIndex(638, v29.Length)] := v18;
				var v30: array<char> := new char[11];
				var v31 := 'r';
				v30[safeIndex(501, v30.Length)] := v31;
				v30[safeIndex(501, v30.Length)] := v31;
			...
			v36[safeIndex(892, v36.Length)] := p1;
			var v37 := 'd';
			v36[safeIndex(892, v36.Length)] := (p1 + [v37, v37]) + p1;
		}
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			globalState.f21 := f25;
			var v39: seq<map<int, bool>> := [map v38 : int | (888 <= v38) && (v38 < 0x110) :: (safeDivisionInt(v38, p3)) := (f26)];
			var v40 := new C1(p3, (seq(abs(0x1e3), i4  => (v2))) + v39);
			r1 := -0x1b1 * safeDivisionInt(p3, p3);
...
class C5 extends T1 {
	...
	function fm5(p0: int, p1: seq<D0>, p2: int, p3: int, globalState: GlobalState): map<bool, string> {
		(map[f24 := "wx"] + map[f24 := "mjsnrtion"]) + (map[f24 := seq(abs(0x17a), i0  => ('l'))] + map[false := "sjvmhb"])
	}
	function fm6(p0: int, globalState: GlobalState): bool {
		match DC5('x') {
	...
	method m2(p0: int, p1: bool, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<map<bool, D3>>) {
		...
		if (852 != p0) {
			...
			r1 := p3 - |({f24, p1} - v4)|;
			globalState.f7 := safeModuloInt(0x19c * p3, p0);
			var v5: array<int> := new int[4];
			var v6 := "bqijp";
			var v7 := 's';
			var v8: seq<bool> := [!true];
			globalState.f16, globalState.f0, r0, globalState.f0, v5 := safeDivisionInt(|v3|, p0), f24 <== (if (p1) then p1 else p1), fm7(p1 <== p1, |("dcbbvmlo" + v6[safeIndex(p0, |v6|) := v7])|, true, globalState), v8[safeIndex(v1.cf9, |v8|)], v5;
			var v9 := new C3();
		} else {
			var v10: array<array<int>> := new array<int>[8] [p2, p2, p2, p2, p2, p2, p2, p2];
			v10 := v10;
			p2[safeIndex(572, p2.Length)] := p3;
			globalState.f16, globalState.f16, p2[safeIndex(572, p2.Length)] := p3 - p0, p3, p3;
			var v11 := 'f';
			v11 := 'v';
			p2[safeIndex(572, p2.Length)] := p3;
			var v12: array<D12> := new D12[11](i1 => DC22(map[p1 := p3]));
			var v13: map<int, array<D12>> := map[p2[safeIndex(572, p2.Length)] := v12];
			v13 := v13[p0 := v12];
		}
		...
		if (!p1) {
			...
			v18 := v18[p1 := v17];
			var v19 := 'n';
			var v20: map<int, int> := map[|(v14 + v14[safeIndex(p3, |v14|) := v19])| := p3];
			var v21: seq<map<int, int>> := [v20];
			v20 := (v20 + v21[safeIndex(p0, |v21|)]) + v20;
			r1 := p0;
			globalState.f13 := p1;
		} else {
			p2[safeIndex(96, p2.Length)] := p3;
			var v22: set<array<int>> := {p2, p2, p2};
			p2[safeIndex(96, p2.Length)] := |v22|;
			var v23 := "coillmrw";
			var v24: multiset<string> := multiset{v23};
			var v25: map<int, char> := map[p0 := 'l'];
			var v26 := 'k';
			var v27: multiset<int> := multiset{if (!f24) then |v24| else |(seq(abs(0xb7), i3  => ('c')))[safeIndex(fm8(f24, v25[p3 := v26], v23, globalState), |(seq(abs(0xb7), i3  => ('c')))|) := fm27(f24, !false, globalState)]|};
			var v28: map<int, int> := map[p2[safeIndex(96, p2.Length)] := p0];
			var v29: map<bool, bool> := map[p1 := f24];
			p2[safeIndex(96, p2.Length)] := if (p3 in v27) then v27[p3] else if (0x371 in v28) then v28[0x371] else |v29|;
			var v30: array<bool> := new bool[28](i4 => -p0 <= p2[safeIndex(96, p2.Length)]);
			v30[safeIndex(792, v30.Length)] := p1;
			var v31: map<string, int> := map[seq(abs(488), i5  => (v26)) := p0];
			var v32: C4 := new C4(false, p1);
			var v33: seq<bool> := [v32.f26];
			var v34: seq<bool> := [p1, v33[safeIndex(p0, |v33|)], p1];
			var v35 := DC18([p1, v32.f25]);
			var v36: map<D8, char> := map[v35 := v26];
			v30[safeIndex(792, v30.Length)], v30, globalState.f7, v26 := true, v30, if (p1) then |v31| - -|{v32, v32, v32, v32}| else safeDivisionInt(|v33|, |[p1]|), if (fm41(!true, {fm2(v29, globalState), true, v32.f26, v32.f25}, p2[safeIndex(96, p2.Length)], p3, globalState) in v36) then v36[fm41(!true, {fm2(v29, globalState), true, v32.f26, v32.f25}, p2[safeIndex(96, p2.Length)], p3, globalState)] else v26;
			globalState.f8 := v23;
		...
		if (!p1 <== !p1) {
			...
			v38 := v38;
			var v39 := "i";
			v0[safeIndex(453, v0.Length)] := v39;
			v0[safeIndex(453, v0.Length)] := "woo";
			var v40: array<array<char>> := new array<char>[29];
			v40 := v40;
			var v41: map<char, int> := map[v38 := p0];
			globalState.f19 := (v39[safeIndex(if (v38 in v41) then v41[v38] else -p3, |v39|) := v38])[safeIndex(p3, |v39[safeIndex(if (v38 in v41) then v41[v38] else -p3, |v39|) := v38]|) := v38];
			globalState.f13 := f24;
		} else {
			var v42: array<array<int>> := new array<int>[1];
			v42[safeIndex(201, v42.Length)] := p2;
			p2[safeIndex(609, p2.Length)] := p0;
			var v43 := "krdj";
			r1, v42[safeIndex(201, v42.Length)], p2[safeIndex(609, p2.Length)] := -p0, p2, if (p1) then |v43| else p3;
			...
			var v46 := DC11(v44);
			v45[safeIndex(879, v45.Length)] := v46.cf17;
			...
			v45[safeIndex(879, v45.Length)], globalState.f13, globalState.f13, globalState.f2, v47 := if (p1) then v44 else v44, p1, p1, !(v43 == v43), v50[safeIndex(p3, |v50|)];
			globalState.f0 := fm6(p3, globalState);
			var v51: map<bool, int> := map[false := p2[safeIndex(609, p2.Length)]];
			var v52 := DC10(|v51|, p2[safeIndex(609, p2.Length)], f24, p1, p2[safeIndex(609, p2.Length)]);
			var v53: seq<D4> := [v52, fm42(globalState)];
			var v54: multiset<bool> := multiset{p1};
			var v55 := DC10(|v53|, p3, p1, DC36(!p1, v54, p1).cf49, p2[safeIndex(609, p2.Length)]);
			var v56: map<bool, D4> := map[f24 := v55];
			var v57: map<int, map<bool, D4>> := map[p0 := v56];
			v57 := map[p0 := fm43(f24, p3, |v43|, p1, globalState)];
			var v58: map<bool, array<int>> := map[f24 := v42[safeIndex(201, v42.Length)]];
			v58 := v58[f24 := v42[safeIndex(201, v42.Length)]];
		}
	...
	method m3(p0: array<int>, globalState: GlobalState) {
		...
		match (v4) {
			case DC36(cf47, cf48, cf49) =>
				...
				var v6 := new C0(v5[safeIndex(v0, |v5|)]);
				var v7 := new C0(v0 <= 0x4a);
			case DC35(cf46) =>
				var v8: array<D0> := new D0[13];
				var v9 := DC1(fm4(0x8c, v0, globalState));
				var v10: seq<D0> := [v9, v9, DC0(v2.f25)];
				var v11 := DC1(v10[safeIndex(v0, |v10|)]);
				v8[safeIndex(212, v8.Length)] := v11;
				v8[safeIndex(212, v8.Length)] := v11.(cf1 := v9);
				var v12: array<seq<int>> := new seq<int>[5](i0 => [v0]);
				var v13 := DC32(v12);
				var v14: multiset<D15> := multiset{v13};
				if (!(v14[v13 := abs(v0)] != v14)) {
					var v16: seq<bool> := [v2.f26, !v2.f26];
					var v17: seq<array<int>> := [p0];
					var v18: array<bool> := new bool[20] [v2.f25, v2.f26 <==> f24, v2.f25, v2.f26, v2.f26, v1 >= (set v15 : int | (0x64 <= v15) && (v15 < -0x2e2) :: (v15 - v0)), v2.f25, v2.f25, !(if (fm7(v2.f26, v0, v2.f25, globalState)) then v2.f26 else v2.f26), v2.f26, v2.f26, v16 < v16[safeIndex(v0, |v16|) := false], v2.f26, v17 <= v17, v2.f26, v2.f25, v2.f26, v2.f25, v2.f26, v2.f26];
					v18 := v18;
					var v19 := "lb";
					globalState.f20 := v19;
					globalState.f7 := v0;
					...
					v25[safeIndex(438, v25.Length)] := f24;
					var v26: seq<int> := [v0];
					v25[safeIndex(438, v25.Length)] := (-v0 == v0) || (v26 <= v26);
					var v27: map<int, bool> := map[v0 := f24];
					var v28: map<bool, bool> := map[v2.f26 := false];
					v27, v28, globalState.f16, globalState.f7, globalState.f2 := map[|({v2.f25} * v24)| := v25[safeIndex(438, v25.Length)]], v28[v2.f25 := v2.f26] + (v28 + v28), v0 - 155, v0, v2.f26;
					var v29 := "udixpjur";
					var v30 := 'm';
					globalState.f8 := v29[safeIndex(|v24|, |v29|) := v30];
					var v31: map<D14, bool> := map[fm32(v25[safeIndex(438, v25.Length)], v0, |v26|, globalState) := v2.f25];
					var v32 := DC28({0x2cd, v0});
					v31 := v31[if (v25[safeIndex(438, v25.Length)]) then v32 else v32 := (fm44(globalState)).cf36];
				}
				
				p0[safeIndex(774, p0.Length)] := v0;
				p0[safeIndex(774, p0.Length)] := v0;
				...
				v37[safeIndex(566, v37.Length)] := v2.f25;
				v37[safeIndex(566, v37.Length)] := v2.f26;
			case DC37(cf50) =>
				var v38 := "vuuysgyyb";
				var v39: seq<bool> := [v2.f25];
				var v40: multiset<int> := multiset{|v38| + (if (v2.f25 in v3) then v3[v2.f25] else v0), safeModuloInt(|[v39]|, |v38|)};
		...
		if (fm2(v41, globalState)) {
			...
			if ((if (v2.f26) then v0 else if (v0 in v43) then v43[v0] else v0) <= 161) {
				...
				globalState.f16 := safeDivisionInt(|v44|, v0);
				v2.f25 := v2.f25;
				var v45: map<int, int> := map[safeDivisionInt(v0, 0x17c) := v0];
				...
				v49 := v49[v47 := v48];
				p0[safeIndex(102, p0.Length)] := -0x326;
				p0[safeIndex(102, p0.Length)] := v0;
			} else {
			...
			match (fm45(globalState)) {
				...
				case DC27(cf36) =>
					...
					v59 := v60[safeIndex(if (v2.f25) then v0 else v0, |v60|)];
					var v61: map<int, bool> := map[v0 := v2.f26];
					var v62: seq<bool> := [fm2(v41, globalState), if (v0 in v61) then v61[v0] else f24, v0 < v0];
					v2.f25, globalState.f7, v58, v2, globalState.f7 := v62[safeIndex(v0, |v62|)], -v0, v58, v2, v0;
					var v63 := 'c';
					v63 := v63;
				case DC25(cf32) =>
			...
			var v68 := 'q';
			v42[safeIndex(175, v42.Length)] := v68;
			v42[safeIndex(175, v42.Length)] := v68;
			var v69: seq<bool> := [v2.f26];
			var v70 := DC30(seq(abs(0x74), i3  => (832)), v69);
			...
			v71[safeIndex(1, v71.Length)] := v69;
			var v72: set<bool> := {v2.f26};
			var v73 := DC21(v72 - {v2.f26, v2.f25});
			var v74 := "sgpusvt";
			globalState.f20, globalState.f7, v71[safeIndex(1, v71.Length)], v73, globalState.f21 := v74, -0x2e, v69, v73, v2.f25;
		} else {
			var v75 := "bbe";
			var v76: map<bool, int> := map[v75 != v75 := v0];
			globalState.f7, v2.f25, v76 := safeModuloInt(v0, v0), v2.f26, v76 + v76;
			var v77: array<D13> := new D13[3](i4 => if (true) then DC27(v2.f25) else DC27(v2.f25));
			var v78 := DC27(v2.f25);
			v77[safeIndex(749, v77.Length)] := v78;
			v77[safeIndex(749, v77.Length)] := v78;
			...
			var v85: array<bool> := new bool[15] [(if (v0 in v83) then v83[v0] else v81) >= v81, v79 <= [f24], v2.f26, v0 <= v0, [v2.f25, v2.f25, v2.f25] == [v2.f25, v2.f26, v2.f25], !v2.f26 || false, f24, v2.f26, if (v2.f25) then f24 else f24, v79[safeIndex(v0, |v79|)], v2.f26, v2.f26, v84 == v84, v2.f26, v2.f26];
			p0[safeIndex(568, p0.Length)] := safeModuloInt(-v0, |(seq(abs(-0x64), i5  => (v75[safeIndex(if (v2.f25 in v76) then v76[v2.f25] else v0, |v75|)])))|);
			var v86: seq<string> := [v75, seq(abs(0x1b9), i6  => ('s'))];
			var v87: multiset<array<bool>> := multiset{v85};
			globalState.f13, v85, p0[safeIndex(568, p0.Length)], v86 := !(v87 >= (v87 + DC45(v87).cf59)), v85, safeModuloInt(|v75|, v0), (v86 + v86) + [v75, v75, v75];
			v85[safeIndex(383, v85.Length)] := v2.f25;
			v85[safeIndex(383, v85.Length)] := v0 < (v0 * v0);
			var v88: map<int, char> := map[|v75| := 'r'];
			var v89: set<bool> := {v2.f25};
			if ((v0 * (if (fm8(true, v88, v75[safeIndex(p0[safeIndex(568, p0.Length)], |v75|) := fm34(globalState)], globalState) in v81) then v81[fm8(true, v88, v75[safeIndex(p0[safeIndex(568, p0.Length)], |v75|) := fm34(globalState)], globalState)] else |v89|)) == p0[safeIndex(568, p0.Length)]) {
				var v90 := DC10(v0, -v0, v2.f25, false, |v76|);
				globalState.f2 := v90.cf14;
				var v91: map<bool, string> := map[v2.f26 := v75];
				var v92 := 'y';
				var v93: array<string> := new string[29] [v75, if (v2.f26 in v91) then v91[v2.f26] else v75, fm1(p0[safeIndex(568, p0.Length)], globalState), "hyp", v75, v75, seq(abs(-0x211), i7  => ('o')), "rdnqhsuh" + "fuy", v75, seq(abs(-316), i8  => (v75[safeIndex(p0[safeIndex(568, p0.Length)], |v75|)])), v75, v75, "cepxkgleo", v75[safeIndex(p0[safeIndex(568, p0.Length)], |v75|) := 'd'], v75 + v86[safeIndex(v0, |v86|)], v75, v75, seq(abs(0x74), i9  => ('y')), v75, v75[safeIndex(v0, |v75|) := v92], v75 + (seq(abs(0x327), i10  => (v92))), v75, seq(abs(885), i11  => ('c')), DC26(v75, v2.f25, v2.f25).cf33 + v75, "ctaxiqtj", v75, v75, v75, v75];
				v93[safeIndex(501, v93.Length)] := "rckcmrpbm" + v75;
				var v94: map<int, string> := map[v0 := v75];
				v93[safeIndex(501, v93.Length)] := "srrgrldpd" + (if (v0 in v94) then v94[v0] else v75);
				globalState.f16 := safeModuloInt(p0[safeIndex(568, p0.Length)], p0[safeIndex(568, p0.Length)]);
				var v95: array<array<int>> := new array<int>[18];
				var v96: map<bool, array<array<int>>> := map[f24 := v95];
				v96 := v96[v2.f26 := v95];
				p0[safeIndex(568, p0.Length)] := safeModuloInt(v0, p0[safeIndex(568, p0.Length)]) + v0;
			} else {
				var v97 := DC30(v80, v79);
				var v98: multiset<seq<D14>> := multiset{[DC30(v80, v79), v97, v97]};
				var v99 := 'x';
				v98 := if (false) then v98 - v98 else v98[fm46(v2.f25, v99, globalState) := abs(843)] - v98;
				v76 := v76[v79 < v79 := 0x3a3];
				var v100: C2 := new C2(if (v85[safeIndex(383, v85.Length)]) then 0x266 else p0[safeIndex(568, p0.Length)]);
				v100 := v100;
				globalState.f13 := v75[safeIndex(|v79|, |v75|) := v99] <= "vjgipyft";
				v2.f25 := v1 >= v1;
			}
		...
		for i12 := |v102| to v0 {
			...
			if (v2.f25) {
				...
				v105[safeIndex(805, v105.Length)] := v106;
				var v107 := 'o';
				var v108 := DC26(v101, v2.fm9(v2.f25, globalState), v2.f25);
				var v109 := DC46(v2.f25, v0);
				globalState.f2, globalState.f0, globalState.f7, v105[safeIndex(805, v105.Length)] := v107 !in (v108.cf33 + v101[safeIndex(i12, |v101|) := v107]), v2.f26, if (v2.f25) then if (v2.f26) then i12 else v109.cf61 else v0, v106;
				var v110: map<bool, int> := map[v2.f26 := v0];
				var v111: seq<string> := [fm1(i12, globalState), v101];
				var v112: map<int, int> := map[v0 * |v110| := --|multiset(v111[safeIndex(v0, |v111|) := "je"] + ["xydhcd"])|];
				var v113 := DC47(v104, -809, true);
				var v114: map<array<bool>, bool> := map[v105[safeIndex(805, v105.Length)] := v2.f25];
				...
				v118[safeIndex(13, v118.Length)] := DC12([p0]);
				var v119 := 'w';
				var v120: seq<array<int>> := [p0, p0];
				var v121 := DC12(v120);
				var v122: seq<int> := [v0];
				var v123: map<int, bool> := map[v122[safeIndex(i12, |v122|)] := v2.f25];
				...
				v118[safeIndex(13, v118.Length)], globalState.f2, globalState.f7, globalState.f2, globalState.f13 := if (v119 !in v101) then v121 else v121, |"ys"| < -fm8(if (i12 in v123) then v123[i12] else v2.f26, map[(v125.(cf13 := v0)).cf12 := v119], v101, globalState), i12, if (({v126} > {v126, v126, v126}) in v41) then v41[{v126} > {v126, v126, v126}] else [v127, v127] <= v128, v2.f25;
				globalState.f21 := v2.f25;
				v0 := i12;
				var v129: set<bool> := {v2.f26, v2.f26};
				var v130: seq<set<bool>> := [v129];
				var v131: multiset<set<bool>> := multiset{v130[safeIndex(i12, |v130|)] * v129, v129, {!fm2(v41, globalState)}};
				v131 := multiset{v129};
		...
		for i14 := v0 + v0 to |(v136 + v136)| {
			...
			v140[safeIndex(495, v140.Length)] := false;
			globalState.f13, globalState.f7, globalState.f16, v140[safeIndex(495, v140.Length)] := v2.f26, v0, --i14, !false;
		}
		for i15 := 0xa9 to v0 {
			if (v2.f26) {
				var v141 := DC21(v135);
				...
				v142[safeIndex(416, v142.Length)] := v143 < v143;
				v141, v1, v2.f25, v142[safeIndex(416, v142.Length)] := if (v0 >= i15) then v141 else v141, (set v144 : int | (0x368 <= v144) && (v144 < 0xcc) :: (v144 - i15)) + ({i15} + v1), f24, v2.f25;
				globalState.f2 := if (v2.f26) then f24 else v142[safeIndex(416, v142.Length)];
				v142[safeIndex(416, v142.Length)] := if (!v2.f25) then v0 != |v1| else |v135| != i15;
				var v145: seq<int> := [|v101|, |map[v2.f25 := v0]|, i15, v0, i15];
				v41 := v41[v2.f25 := -v0 in v145];
				p0[safeIndex(625, p0.Length)] := -i15;
				p0[safeIndex(625, p0.Length)] := v0;
			} else {
				var v146: seq<set<int>> := [{0x363}];
				v135, v1 := (v135 + v135) * fm14(i15, v2.f26, globalState), v146[safeIndex(v0, |v146|)];
				globalState.f7 := (if (v2.f26 in v136) then v136[v2.f26] else i15) * (if (v2.f25) then v0 else i15);
				globalState.f2 := v2.f25;
				p0[safeIndex(498, p0.Length)] := i15;
				p0[safeIndex(498, p0.Length)] := safeModuloInt(v0, v0);
				v2.m5(fm2(v41, globalState), globalState);
			}
			
			globalState.f7 := v0 + safeDivisionInt(559, v0);
			...
			v148[safeIndex(176, v148.Length)] := v135 + v135;
			var v149: seq<int> := [i15];
			var v150: seq<bool> := [f24];
			v147, globalState.f0, globalState.f2, v148[safeIndex(176, v148.Length)], v149 := v147, v2.f25, v150[safeIndex(i15, |v150|)], v135, v149;
			p0[safeIndex(57, p0.Length)] := v0;
			p0[safeIndex(57, p0.Length)], globalState.f21 := -safeDivisionInt(v0, 0x1d7), fm2(v41, globalState);
		}
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		var v0: seq<int> := [p0];
		var v1: seq<int> := [v0[safeIndex(p0, |v0|)]];
		for i0 := |v1| - p0 to p0 {
			globalState.f21 := f24;
			var v2 := new C3();
			var v3 := new C2(p0);
			if (true) {
				...
				var v6: set<int> := {safeDivisionInt(v3.f28, fm0(v3.f28, |v5|, |v1|, f24, globalState)), |([|fm21(globalState)|, v3.f28] + v0)|, |(v0 + v1)|};
				var v7: map<int, char> := map[v3.f28 := v4];
				var v8 := "gffxeber";
				var v9: map<int, bool> := map[v3.f28 := f24];
				var v11: seq<bool> := [f24, f24];
				var v12 := DC18(v11);
				globalState.f21, r1, v6, globalState.f7 := f24, p0 <= (p0 - fm8(false, v7, v8, globalState)), (v6 + v6) + (set v10 : int | v10 in v9 :: (safeModuloInt(v10, |multiset(seq(abs(0x36f), i1  => (|map[|"cftvrnjd"| := |map[96 := |map['i' := 0x17b]|]|]|)))|))), v3.fm17(f24, seq(abs(0xbb), i2  => (|[f24]|)), i0, v12, globalState) + safeModuloInt(v3.f28, |map[p0 := false]|);
				var v13: array<string> := new string[29](i3 => v8);
				v13[safeIndex(731, v13.Length)] := v8;
				v13[safeIndex(731, v13.Length)] := seq(abs(0x309), i4  => (v4));
				var v14: array<bool> := new bool[2];
				v14[safeIndex(762, v14.Length)] := f24;
				v14[safeIndex(762, v14.Length)] := |v0| <= -0x71;
				var v16: multiset<seq<int>> := multiset{[p0]};
				var v17 := DC35(map v15 : seq<int> | v15 in v16 :: (v15) := (v11));
				var v18 := DC37(v17);
				globalState.f8, v13[safeIndex(731, v13.Length)], v4, v18 := v8 + (fm1(i0, globalState) + v8), (v13[safeIndex(731, v13.Length)] + v8) + v8, v4, v18;
			} else {
				...
				v21[safeIndex(133, v21.Length)] := v22;
				var v23: array<int> := new int[27];
				var v24: seq<array<int>> := [v23, v23, v23, v23, v23];
				var v25: set<int> := {i0};
				r0, globalState.f13, globalState.f7, v21[safeIndex(133, v21.Length)] := v24[safeIndex(i0, |v24|)], v25 !! DC28(v25).cf37, p0, v22;
				...
				var v29 := "ccmntf";
				var v30: map<seq<bool>, string> := map[v21[safeIndex(133, v21.Length)] := v29];
				var v31: multiset<int> := multiset{p0, v3.f28};
				m0(v21[safeIndex(133, v21.Length)][safeIndex(v3.f28, |v21[safeIndex(133, v21.Length)]|)], i0, v30, |(v31 - v31)|, globalState);
				globalState.f16 := i0;
			}
		...
		globalState.f16, globalState.f16, globalState.f16 := p0, p0, safeDivisionInt(p0, |(v33 + v33)|);
		var v34: array<int> := new int[19](i5 => i5 - p0);
		r0 := v34;
		if (f24) {
			v34[safeIndex(748, v34.Length)] := p0;
			var v35: array<bool> := new bool[13];
			v35[safeIndex(633, v35.Length)] := f24;
			v34[safeIndex(748, v34.Length)], v35[safeIndex(633, v35.Length)], globalState.f16, globalState.f16 := --0x1fe, !f24, p0 - p0, p0 * (p0 - p0);
			var v36: map<bool, int> := map[!f24 := -0x290];
			globalState.f7 := if ((f24 <==> v35[safeIndex(633, v35.Length)]) in v36) then v36[f24 <==> v35[safeIndex(633, v35.Length)]] else p0;
			var v37: set<int> := {533};
			var v38 := "ospctjgb";
			var v39: array<int> := new int[19] [-|v37|, |v38|, v34[safeIndex(748, v34.Length)], v34[safeIndex(748, v34.Length)], -p0, v34[safeIndex(748, v34.Length)], v34[safeIndex(748, v34.Length)], v34[safeIndex(748, v34.Length)], -v34[safeIndex(748, v34.Length)], |v38|, v34[safeIndex(748, v34.Length)], fm8(f24, (map[0x2b4 := v32])[-0x41 := v32], v38, globalState), p0, -0x179, 0x8f, |map[!v35[safeIndex(633, v35.Length)] := f24]|, v34[safeIndex(748, v34.Length)], v34[safeIndex(748, v34.Length)], p0];
			var v40 := DC12([v39]);
			var v42: map<char, bool> := map[v32 := v35[safeIndex(633, v35.Length)]];
			var v43: map<int, map<char, bool>> := map[v34[safeIndex(748, v34.Length)] := v42];
			v35[safeIndex(633, v35.Length)], globalState.f20, globalState.f0, v40, globalState.f13 := v35[safeIndex(633, v35.Length)], seq(abs(0xe7), i6  => (v32)), !(((map v41 : int | (-222 <= v41) && (v41 < 0x193) :: (safeDivisionInt(v41, v34[safeIndex(748, v34.Length)])) := (map[v32 := v35[safeIndex(633, v35.Length)]])) + v43) != fm48(v32, v34[safeIndex(748, v34.Length)], globalState)), v40, f24 ==> v35[safeIndex(633, v35.Length)];
			globalState.f13 := true ==> (p0 <= v34[safeIndex(748, v34.Length)]);
			var v44: C2 := new C2(v34[safeIndex(748, v34.Length)]);
			v44 := v44;
		} else {
			...
			v49 := v49;
			v34[safeIndex(70, v34.Length)] := p0;
			v34[safeIndex(70, v34.Length)] := |(({f24, true} - v46) - v46)|;
			v48 := v48;
			r0 := new int[15];
		}
...
class C6 extends T1 {
	...
	function fm5(p0: int, p1: seq<D0>, p2: int, p3: int, globalState: GlobalState): map<bool, string> {
		(if (false) then map[false := "xdbnkvr"] else map[false := seq(abs(0x249), i0  => ('y'))]) + map[true := "bgtt"]
	}
	function fm6(p0: int, globalState: GlobalState): bool {
		true
	}
	method m2(p0: int, p1: bool, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<map<bool, D3>>) {
		...
		for i0 := p3 to p3 {
			...
			globalState.f0 := (v1[v0 := abs(p0)] > multiset{v0, v0, v0, v0[i0 := abs(-0x15a)]}) <==> p1;
			var v2: seq<bool> := [!p1, p1];
			var v3 := new C0(v2[safeIndex(p0, |v2|)]);
			var v4: seq<int> := [p3];
			if (|v4| >= (if (p1) then i0 else i0)) {
				globalState.f7 := p0;
				var v5: array<string> := new string[27];
				var v6 := "odwrbay";
				v5[safeIndex(423, v5.Length)] := v6;
				v5[safeIndex(423, v5.Length)] := fm1(0x97, globalState);
				globalState.f16 := i0;
				var v7: array<int> := new int[20];
				v7 := v7;
				var v8: seq<string> := [v5[safeIndex(423, v5.Length)], v5[safeIndex(423, v5.Length)], v5[safeIndex(423, v5.Length)], v5[safeIndex(423, v5.Length)], fm1(i0, globalState)];
				var v9: multiset<bool> := multiset{v3.f27};
				v5[safeIndex(423, v5.Length)] := v8[safeIndex(-v4[safeIndex(|v9|, |v4|)], |v8|)] + v6;
			} else {
				p2[safeIndex(398, p2.Length)] := v4[safeIndex(|v2|, |v4|)];
				p2[safeIndex(398, p2.Length)] := p3;
				v3.f27 := v3.f27;
				...
				v15 := v15[v13 := --fm0(511, p2[safeIndex(398, p2.Length)], p2[safeIndex(398, p2.Length)], p1, globalState)];
				var v16: map<int, bool> := map[p2[safeIndex(398, p2.Length)] := !v3.f27];
		...
		v22[safeIndex(13, v22.Length)] := true <== !p1;
		v22[safeIndex(860, v22.Length)] := p1;
		var v23 := 'e';
		...
		p2[safeIndex(304, p2.Length)] := |v26|;
		v22[safeIndex(13, v22.Length)], v22[safeIndex(860, v22.Length)], v26, p2[safeIndex(304, p2.Length)] := p1, p0 < p0, v26, p3;
		r0 := (p1 <==> p1) || p1;
		r1 := safeModuloInt(if (v22[safeIndex(13, v22.Length)]) then p0 else p2[safeIndex(304, p2.Length)], 0x85);
		var v27: array<map<bool, D3>> := new map<bool, D3>[8](i1 => map[v22[safeIndex(13, v22.Length)] := DC6(seq(abs(490), i2  => (v23)), 'b', p1)] + map[p1 := DC6("whrnsnix", v23, v22[safeIndex(13, v22.Length)])]);
		r2 := v27;
	}
	method m3(p0: array<int>, globalState: GlobalState) {
		var v0 := 0x2ad;
		...
		var v15 := "snhrb";
		p0[safeIndex(277, p0.Length)], globalState.f2, globalState.f16, v11 := safeDivisionInt(v0 * 0xe5, -v1.fm8(v6[safeIndex(v0, |v6|)], if (v1.f24 in v14) then v14[v1.f24] else map[v0 := v12], v15, globalState)), if (v1.f24 in v3) then v3[v1.f24] else fm6(v0, globalState), v0 - v0, v11;
		var i0 := 0;
		while (v1.f24)
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			globalState.f16 := safeModuloInt(if (v1.f24) then v0 else v0, v0);
			v10 := v10[0x91 := v1.f24];
			...
			var v23: array<map<D17, map<bool, int>>> := new map<D17, map<bool, int>>[29] [v18 + v18, v18, map[v17 := v4[v1.f24 := p0[safeIndex(277, p0.Length)]]], v18, v18[v17 := v4], v18 + v18, v19[safeIndex(v0, |v19|)], map[DC38(v16) := v4], v18, v18 + v18, v18, map[v17 := v4], v18, if (v1.f24) then map[v17 := v4] else map[v17 := if (p0[safeIndex(277, p0.Length)] in v20) then v20[p0[safeIndex(277, p0.Length)]] else v4], v18, v18, v18, v18, v18, (map[v17 := v4])[v17 := v4[v1.f24 := p0[safeIndex(277, p0.Length)]]] + v18, v18[DC38(v16) := if (v1.f24 in v21) then v21[v1.f24] else v4], v18, v18, map[v17 := map[v1.f24 := -|v22|]], map[v17 := v4] + v18, v18[v17 := v4], v18 + v18, v18[DC38(v17.cf51) := v4], v18];
			v23[safeIndex(907, v23.Length)] := v18;
			v23[safeIndex(907, v23.Length)] := v19[safeIndex(p0[safeIndex(277, p0.Length)], |v19|)];
			globalState.f19 := v15;
		}
		for i2 := p0[safeIndex(277, p0.Length)] * 0xd3 to |v15| {
			var v24: map<bool, seq<int>> := map[v1.f24 := seq(abs(0x13e), i3  => (|v15|))];
			var v25: map<bool, map<bool, seq<int>>> := map[v1.f24 := v24];
			var v26: set<bool> := {v1.f24};
			var v27: seq<int> := [|v4|, |v26|, p0[safeIndex(277, p0.Length)]];
			...
			v28[safeIndex(498, v28.Length)] := v24;
			var v29: map<string, map<int, int>> := map[v15 := v8];
			v12, globalState.f2, v28[safeIndex(498, v28.Length)], globalState.f21, globalState.f7 := v12, v1.f24, map[!v1.f24 := v27], !v1.f24, --|(v29 + (map[v15[safeIndex(p0[safeIndex(277, p0.Length)], |v15|) := 'i'] := v8] + v29))|;
			var v30: seq<map<int, bool>> := [v10];
			var v31 := new C1(if (v1.f24) then i2 else |v15|, fm51('i', p0[safeIndex(277, p0.Length)], globalState) + v30);
			var v32: map<char, int> := map[fm34(globalState) := |v3|];
			v32 := v32[v12 := v31.f29];
			v11[safeIndex(760, v11.Length)] := v1.f24;
			var v33: seq<array<int>> := [p0];
			var v34 := DC12(v33[safeIndex(p0[safeIndex(277, p0.Length)], |v33|) := p0]);
			var v35 := DC14(v34);
			var v36 := DC14(v34);
			var v37 := DC14(v35);
			var v38: map<int, array<int>> := map[v31.f29 := p0];
			v31.f29, v11[safeIndex(760, v11.Length)], v37, globalState.f20, globalState.f7 := v31.fm29(globalState) + (|v10| + i2), (if (v1.f24) then -v31.f29 else v0) in v38, DC14(v34), v15, v31.f29;
		}
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		var v0 := false;
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v5: set<int> := {|(map v4 : int | v4 in v3 :: (v4 + p0) := (seq(abs(351), i1  => (p0))))|, p0};
				var v6: multiset<bool> := multiset{v0, v5 >= v5};
				var v7: map<int, multiset<bool>> := map[p0 := v6[v0 := abs(p0)]];
				...
				var v15: map<seq<bool>, seq<int>> := map[v9 := v14[safeIndex(p0, |v14|)]];
				var v16 := DC52(v15);
				var v17: C2 := new C2(|v16.cf71|);
				v12[safeIndex(504, v12.Length)] := v17;
				v12[safeIndex(504, v12.Length)] := v17;
				globalState.f19 := seq(abs(-0x1e4), i2  => (v2));
			} else {
				...
				v21[safeIndex(680, v21.Length)] := v0;
				v21[safeIndex(680, v21.Length)] := fm2(v1, globalState);
				var v22: T0 := new C3();
				var v23: map<bool, T0> := map[v0 := v22];
				var v24: seq<map<bool, T0>> := [v23];
				var v25: seq<map<bool, T0>> := [v24[safeIndex(p0, |v24|)]];
				var v26: seq<bool> := [false];
				var v27: map<seq<bool>, string> := map[v26 := "ulcd"];
				var v28: seq<char> := [fm27(v21[safeIndex(680, v21.Length)], v21[safeIndex(680, v21.Length)], globalState)];
				var v29: set<seq<char>> := {v28, v28, v28};
				m0(p0 == p0, safeDivisionInt(|v25|, p0), v27, |(v29 - v29)|, globalState);
				var v33: seq<int> := [p0];
				var v34: map<int, int> := map[p0 := 225];
				var v35: seq<map<int, int>> := [map v32 : int | v32 in v33 :: (safeModuloInt(v32, p0)) := (0xfb), v34];
				var v36: map<map<map<int, int>, bool>, bool> := map[map v30 : map<int, int> | v30 in (map v31 : map<int, int> | v31 in v35 :: (v31) := (p0)) :: (v30) := (v0) := true];
				var v38: map<map<int, int>, bool> := map[map v37 : int | (0x53 <= v37) && (v37 < 0x120) :: (v37 + p0) := (p0) := v21[safeIndex(680, v21.Length)]];
				v36 := v36[v38 := v0];
				var v39 := new C2(p0);
			}
			...
			m0(v0 ==> v0, p0, v41[safeIndex(p0, |v41|)], p0 - p0, globalState);
			var v42 := "t";
		...
		for i3 := safeDivisionInt(|v44|, fm0(p0, |v46|, p0, v0, globalState)) to p0 {
			var v47: T0 := new C3();
			v47 := v47;
			...
			globalState.f16, v48[safeIndex(567, v48.Length)] := i3, v50 != (v50 + DC56(map[v49 := false]).cf80);
			var v51: map<bool, int> := map[v0 := i3];
			var v52: multiset<int> := multiset{i3};
			var v53: set<int> := {p0, p0, p0, p0};
			var v54: seq<bool> := [v48[safeIndex(567, v48.Length)], v48[safeIndex(567, v48.Length)]];
			var v55 := DC9(i3);
			var v56: seq<int> := [p0, 515];
			var v57 := DC10(|v54|, |v1|, v0, v48[safeIndex(567, v48.Length)], i3);
			var v58 := 'k';
			var v59: multiset<char> := multiset{v58, v58, v58, v58};
			var v60: set<bool> := {v0, v0, v0};
			var v61: array<int> := new int[24] [i3, i3, |v46|, |v51| + |v52|, p0, safeModuloInt(p0, |v53|), p0 * |v54|, 0x350, p0, v55.cf11, |v46| - i3, v56[safeIndex(i3, |v56|)], v57.cf12, p0, p0 - |v59|, if (i3 in v52) then v52[i3] else p0, i3, i3, p0, if (|v60| in v46) then v46[|v60|] else p0, i3, i3, fm0(p0, 0x33b, p0, !v48[safeIndex(567, v48.Length)], globalState), -0x2e8];
			v61[safeIndex(412, v61.Length)] := i3;
			v61[safeIndex(412, v61.Length)] := -0x55;
			v51 := v51[!true := v61[safeIndex(412, v61.Length)]];
		}
		var v62 := new C0(v0);
		globalState.f7 := p0;
		var i5 := 0;
			...
			decreases 100 - i5
		{
			...
			v64[safeIndex(257, v64.Length)] := v65 * (set v66 : string | v66 in v65 :: (v66));
			v64[safeIndex(257, v64.Length)] := v65;
			var v67 := 'b';
			v67 := v67;
		}
...
class C7 extends T1 {
	...
	method m2(p0: int, p1: bool, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<map<bool, D3>>) {
		...
		for i0 := p3 to p3 {
			...
			var v8 := DC21(v5);
			v4[safeIndex(54, v4.Length)] := v7 + [(map[v8 := p1])[v8 := false]];
			v4[safeIndex(54, v4.Length)] := v7;
		}
		var v9: C2 := new C2(-p0);
		...
		if ({v9, v9} >= v10) {
			...
			match (v20) {
				case DC39(cf52, cf53, cf54, cf55, cf56) =>
					...
					globalState.f13 := fm2(v22[safeIndex(cf52, |v22|)], globalState);
				...
				case DC40() =>
					...
					var v27 := DC18(v26);
					p2[safeIndex(688, p2.Length)] := v9.fm17(p1, [v9.f28], v9.f28, v27, globalState);
					var v28 := "ug";
					p2[safeIndex(688, p2.Length)] := |v28|;
					globalState.f16 := p3;
					var v29 := new C5(fm7(p1, -p2[safeIndex(688, p2.Length)], p1, globalState));
					var v30 := 'u';
					...
					v31[safeIndex(7, v31.Length)] := DC60(v33).cf85;
					...
					v44[safeIndex(329, v44.Length)] := v29.f24;
					var v45: seq<map<int, int>> := [v38];
					v30, v31[safeIndex(7, v31.Length)], v44[safeIndex(329, v44.Length)], r1, globalState.f7 := if (v29.f24) then v30 else v30, v33 + (if (p1) then v33 else v33), !!v29.f24, safeDivisionInt(v42[safeIndex(|multiset(v45)|, |v42|)], fm0(v42[safeIndex(|v28|, |v42|)], 0x1af, p0, fm2(v32, globalState), globalState)), -p2[safeIndex(688, p2.Length)];
				case DC41(cf57) =>
					globalState.f7 := 577;
				...
				case DC38(cf51) =>
					...
					globalState.f2 := v50[safeIndex(|v51|, |v50|)] <==> p1;
					...
					v54[safeIndex(65, v54.Length)] := p1 ==> p1;
					var v55: set<bool> := {true};
					v54[safeIndex(65, v54.Length)] := if (!p1) then v55 >= v55 else !p1;
			}
			...
			v56, globalState.f2 := if (safeModuloInt(v9.f28, |[|v60|, v9.f28]|) in v62) then v62[safeModuloInt(v9.f28, |[|v60|, v9.f28]|)] else v56, v9.fm6(v9.f28, globalState);
			p2[safeIndex(357, p2.Length)] := p3;
			p2[safeIndex(357, p2.Length)] := |v60|;
			r1 := 0x31a;
		}
			...
			decreases 100 - i4
		{
			...
			p2[safeIndex(985, p2.Length)] := p0;
			p2[safeIndex(985, p2.Length)] := p0;
			var v68: array<bool> := new bool[21];
			v68[safeIndex(629, v68.Length)] := p1;
			v68[safeIndex(629, v68.Length)] := p1;
		}
		...
		var v71 := "ygs";
		var i5 := 0;
		while (v69[safeIndex(safeDivisionInt(-v9.f28, v70[safeIndex(|v71|, |v70|)]), |v69|)])
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			var v73: multiset<string> := multiset{v72[safeIndex(v9.f28, |v72|)], seq(abs(991), i6  => ('d')), v71};
			var v74: map<int, multiset<string>> := map[v9.f28 := fm55(v63.f28, p1, p1, globalState)];
			var v75: map<bool, multiset<string>> := map[v69[safeIndex(p0, |v69|)] := if (p3 in v74) then v74[p3] else v73];
			var v76: seq<multiset<string>> := [v73[v71 := abs(v63.f28)], multiset([v71])];
			var v77: array<multiset<string>> := new multiset<string>[17] [multiset{v71, v71}, v73, v73, if (p1) then v73 else multiset(v72), v73 * v73, v73, multiset{v71, "biloj"}, v73, v73, v73, v73, if (p1 in v75) then v75[p1] else v73, v76[safeIndex(0x101, |v76|)], v73, multiset{v71}, (multiset{seq(abs(-0x2d4), i7  => ('t'))})[v71 := abs(v63.f28)], v73];
			v77[safeIndex(233, v77.Length)] := multiset([v71] + v72);
			v77[safeIndex(233, v77.Length)] := v73;
			globalState.f16 := -v63.f28 + (v63.f28 + v63.f28);
			globalState.f13 := !p1;
			var v78: T0 := new C3();
			p2[safeIndex(344, p2.Length)] := v63.f28;
			v78, globalState.f2, p2[safeIndex(344, p2.Length)], globalState.f13, globalState.f7 := v78, [v9.f28, p0] < [p3], p3, p1, v9.f28;
		}
		var v79: C0 := new C0(p1);
		var v80: seq<C0> := [v79];
		var v81: map<C0, int> := map[v80[safeIndex(|v71|, |v80|)] := v9.f28];
		r0 := v69[safeIndex(|v81|, |v69|)];
	...
	method m3(p0: array<int>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (v0) {
				...
				var v3 := 533;
				v1 := v2[safeIndex(v3, |v2|)];
				var v4: array<D15> := new D15[20](i2 => DC33([|"bauwltxil"|]));
				v4[safeIndex(559, v4.Length)] := DC33(fm21(globalState));
				var v5: seq<bool> := [v0];
				var v6: map<D14, int> := map[DC29(v3, map[false := v5]) := -0x106];
				var v7: map<bool, array<int>> := map[v0 := p0];
				var v8: seq<int> := [v3, |v6|, |v7|];
				var v9 := DC33(v8);
				globalState.f13, globalState.f21, v4[safeIndex(559, v4.Length)], globalState.f16 := v0, v3 < v3, v9.(cf44 := v8), -safeDivisionInt(v3, safeDivisionInt(v3, v3));
				var v10: set<int> := {v3};
				var v11 := new C5(v10 < {v3});
				v0 := v11.f24;
				v1[safeIndex(37, v1.Length)] := v5[safeIndex(v3, |v5|)];
				var v12: set<seq<int>> := {v8};
				var v13: seq<seq<int>> := [v8, v8, v8];
				var v15: multiset<bool> := multiset{v0, v0, v11.f24};
				globalState.f2, v1[safeIndex(37, v1.Length)], globalState.f13 := v11.f24, {v8[safeIndex(v3, |v8|) := v3]} > (v12 - (set v14 : seq<int> | v14 in v13 :: (v14))), v15 !! v15;
			} else {
				var v16 := new C4(v0, v0);
				var v17: array<set<int>> := new set<int>[16];
				var v18: set<int> := {0x2e2};
				v17[safeIndex(679, v17.Length)] := v18;
				v17[safeIndex(679, v17.Length)] := v18;
				var v19: array<char> := new char[3];
				var v20 := 'f';
				v19[safeIndex(577, v19.Length)] := v20;
				v19[safeIndex(577, v19.Length)] := v20;
				var v21 := 0x1e6;
				var v22: map<int, char> := map[v21 := v19[safeIndex(577, v19.Length)]];
				var v23: seq<bool> := [v0];
				var v24 := "nwdg";
				var v25: seq<string> := [v24, v24];
				var v26: map<string, bool> := map[v25[safeIndex(v21, |v25|)] := v16.f26];
				var v27: C0 := new C0(v16.f25);
				var v28: map<C0, bool> := map[v27 := v0];
				var v29: map<bool, bool> := map[v27.f27 := !v16.f25];
				var v30: array<bool> := new bool[7] [|v22| <= fm0(v21, v21, fm0(v21, |v17[safeIndex(679, v17.Length)]|, |(seq(abs(19), i3  => (v21)))|, v23[safeIndex(v21, |v23|)], globalState), v16.f26, globalState), if (v24 in v26) then v26[v24] else v0, !(!(if (v27 in v28) then v28[v27] else v16.f25) <==> false), fm2(v29, globalState), true && !false, v0 <==> !v0, false];
				v30[safeIndex(494, v30.Length)] := v20 !in v24;
				v30[safeIndex(494, v30.Length)] := v16.f26;
			...
			v35[safeIndex(847, v35.Length)] := v36;
			v35[safeIndex(847, v35.Length)] := [v0, v0];
			if (v0) {
				var v37 := "dhdknns";
				var v38: map<bool, seq<bool>> := map[v0 := v35[safeIndex(847, v35.Length)]];
				var v39: map<int, int> := map[v32 := v32];
				var v41 := DC25(v39);
				var v42: map<int, D13> := map[|v36[safeIndex(|(map v40 : int | (368 <= v40) && (v40 < 0x274) :: (v40 - v32) := (v0))|, |v36|) := v0]| := v41];
				var v43 := DC39(4, v39, v0, v42, v32);
				var v44: map<int, bool> := map[v32 := v0];
				var v45: seq<map<int, bool>> := [v44];
				var v46 := new C1(safeDivisionInt(fm0(|v37|, |v38|, v32, v43.cf54, globalState), |"cfemxm"|), [v44] + v45);
				var v47: seq<int> := [v32];
				...
				m0(v62 == v62, v32, v63[v35[safeIndex(847, v35.Length)] := v56], |v34|, globalState);
				globalState.f19 := v56;
				var v64 := DC0(fm2(v34, globalState));
				var v65 := DC1(v64);
				var v66: multiset<D0> := multiset{v65, v65, v65};
				globalState.f16 := safeDivisionInt(safeModuloInt(--782, v32), -(if (v65 in v66) then v66[v65] else v61.f29));
		...
		var v69 := 0x330;
		p0[safeIndex(213, p0.Length)] := v69;
		var v70: array<set<bool>> := new set<bool>[22];
		var v71 := DC16(v70);
		var v72: multiset<D7> := multiset{v71};
		p0[safeIndex(213, p0.Length)] := |v72[v71 := abs(v69)]|;
		var v73 := new C5(v0);
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		...
		var v3 := new C4(v1[safeIndex(p0, |v1|)] && v0, v2 in map[v2 := p0]);
		if (v3.f26) {
			...
			var v35 := DC23(p0);
			var v36 := DC24(v35);
			v34[safeIndex(627, v34.Length)] := v36;
			v34[safeIndex(627, v34.Length)] := DC24(v35).(cf31 := v35);
			var v37 := new C6();
		...
		if (p0 == 0x132) {
			...
			var v49 := "ggly";
			var v50 := DC63(v47);
			var v51: array<T0> := new T0[18] [v48[safeIndex(|v49|, |v48|)], v47, v47, v47, v47, v47, v47, v50.cf90, v47, if (v3.f25) then v47 else v47, v47, v50.cf90, v47, v47, v47, v47, v47, if (!v3.f25) then v47 else v47];
			v51[safeIndex(741, v51.Length)] := v47;
			v51[safeIndex(741, v51.Length)] := v47;
			if (!!false) {
				v46[safeIndex(952, v46.Length)] := v3.f25 ==> v3.f26;
				v46[safeIndex(952, v46.Length)] := !!v3.f25;
				globalState.f0 := (v49 <= v49) <==> v3.f26;
				var v52: map<bool, int> := map[v0 := p0];
				var v53: set<int> := {|v49|};
				var v54: set<set<int>> := {{p0, p0}};
				v1, globalState.f16, v52, globalState.f16, globalState.f8 := if (v53 != v53) then v1 else v1, safeModuloInt(p0, fm0(p0, p0, p0, v3.f26, globalState)), fm35(v0, |v54|, globalState), p0, v49;
				globalState.f7 := 0xb3 + p0;
				var v55: array<seq<string>> := new seq<string>[27](i1 => [v49, v49]);
				v55[safeIndex(981, v55.Length)] := [v49];
				var v56: seq<string> := [v49, v49, v49, v49];
				v55[safeIndex(981, v55.Length)] := v56 + fm59(v3.f26, globalState);
			} else {
				var v57: multiset<bool> := multiset{v0};
				var v58: array<int> := new int[1] [p0];
				var v59 := DC53(v46, false, v57[v0 := abs(|v49|)] - v57, v58);
			...
			v62[safeIndex(612, v62.Length)] := |(v2 * v2)|;
			v62[safeIndex(612, v62.Length)] := p0;
		}
		
		var v71: multiset<char> := multiset{v40, v40, fm15(seq(abs(-90), i3  => (214)), p0, globalState)};
		var v72 := "h";
		var v73: multiset<bool> := multiset{v3.f26};
		v71, v3.f25, v40, globalState.f7 := (multiset{v72[safeIndex(|v73|, |v72|)]})[v40 := abs(p0)] + v71[v40 := abs(|fm1(0x1f6, globalState)|)], v3.f25, if (!(706 < 212)) then 'x' else v40, p0;
	...
	method m4(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: string) {
		...
		var v2 := 'd';
		var v3 := "yjscrou";
		var v4: array<int> := new int[16] [|(seq(abs(-831), i0  => ('g')))|, p2, -p2, safeModuloInt(|[false, true]|, fm0(p2, p2, p2, p1, globalState)), |v0| * p2, p0, p2, -p0, |({false} + v1)|, 359, p2, |map[v2 := v2]| - 303, p0, p0, -|v3|, p0];
		v4[safeIndex(676, v4.Length)] := p0;
		v4[safeIndex(676, v4.Length)] := fm0(p2, p2, p0, if (p1) then p1 else p1, globalState);
		var v5: seq<array<int>> := [v4, v4, v4, v4, v4];
		var v6 := DC12(v5);
		v5 := if (p1) then v5 + v5 else (v6.(cf18 := [v4])).cf18;
		globalState.f7 := if (p1) then v4[safeIndex(676, v4.Length)] else p0;
		var v7: C6 := new C6();
		v7 := v7;
		...
		match (v6.(cf18 := v5)) {
			case DC13(cf19, cf20) =>
				...
				var v10: seq<int> := [|v9[safeIndex(cf19, |v9|)]|, -0x21e, v4[safeIndex(676, v4.Length)]];
				var v11: map<int, int> := map[v10[safeIndex(|v3|, |v10|)] := p2];
				...
				v15 := v15[if (p1) then true else p1 := fm52(p1, fm0(|v3|, -cf19, p2, v8[safeIndex(cf19, |v8|)], globalState), globalState)];
			case DC12(cf18) =>
				globalState.f2 := if (p1) then p1 else p1;
				var v16: array<bool> := new bool[25] [p1, p1, p1, p1, p2 <= v4[safeIndex(676, v4.Length)], p1 || p1, fm2(v0, globalState), p1, p1, p1, p1, p1, true, p1, p1, p1, p1, p1, p1, !p1, false, p1, p1, p1, p1];
				v16 := v16;
				var v17: seq<string> := [v3, v3];
				var v18: map<int, bool> := map[0x66 := p1];
				var v19: map<int, map<int, bool>> := map[v4[safeIndex(676, v4.Length)] := v18];
				var v20: map<int, int> := map[|map[p1 := |(if (0xaa in v19) then v19[0xaa] else v18)|]| := v4[safeIndex(676, v4.Length)]];
				var v21 := DC6(v3, v2, p1);
				var v22: array<string> := new string[26] [v17[safeIndex(331, |v17|)] + "hesfue", if (p1) then v3 else v3[safeIndex(p0, |v3|) := v2], seq(abs(-0x29a), i3  => (v2)), v3, fm1(|v3|, globalState) + v3, v3 + v3, "thegxd", v3 + v3, ("npsshuqfe")[safeIndex(|v20|, |"npsshuqfe"|) := v2], v3, v3, "cshpf", v3, (seq(abs(-0x2db), i4  => (v2)))[safeIndex(p0, |(seq(abs(-0x2db), i4  => (v2)))|) := v2], v3, v3, v3 + v3, v17[safeIndex(|"kiiymoo"|, |v17|)], v3, "svnce", (fm1(p0, globalState))[safeIndex(p0, |fm1(p0, globalState)|) := 'd'] + "xkvbkkxeo", v3, v21.cf6, v3[safeIndex(p0, |v3|) := v2], v3, v3];
				v22[safeIndex(809, v22.Length)] := v3;
				var v23: map<int, string> := map[p0 * v4[safeIndex(676, v4.Length)] := v3 + (v3[safeIndex(0x340, |v3|) := v2])[safeIndex(p2, |v3[safeIndex(0x340, |v3|) := v2]|) := v2]];
				v22[safeIndex(809, v22.Length)] := if (v4[safeIndex(676, v4.Length)] in v23) then v23[v4[safeIndex(676, v4.Length)]] else v3;
				globalState.f2 := p1;
			case DC14(cf21) =>
				if (!p1) {
					globalState.f20 := v3 + ("isojrib" + v3);
					globalState.f16 := --safeModuloInt(p2, -215);
					...
					var v28: map<bool, seq<bool>> := map[v26 > v27[safeIndex(p2, |v27|)] := [p1, false]];
					var v29: seq<bool> := [p1, p1];
					v28 := v28[p1 := v29];
					var v30: map<array<int>, C6> := map[v4 := v7];
					globalState.f16 := fm0(if (p1 in v26) then v26[p1] else v4[safeIndex(676, v4.Length)], fm0(fm0(p2, p0, v4[safeIndex(676, v4.Length)], true, globalState), |v24|, |v30|, p1, globalState), fm0(v4[safeIndex(676, v4.Length)], v4[safeIndex(676, v4.Length)], v4[safeIndex(676, v4.Length)], p1, globalState), p1, globalState);
				} else {
					var v31: multiset<bool> := multiset{p1, p1};
					var v32: map<array<int>, bool> := map[v4 := p1 !in v31];
					v32 := v32[v4 := p1];
					var v33: map<int, int> := map[0x10b := p2];
					var v34: seq<int> := [if (|v33[v4[safeIndex(676, v4.Length)] := p0]| in v33) then v33[|v33[v4[safeIndex(676, v4.Length)] := p0]|] else p2, v4[safeIndex(676, v4.Length)], v4[safeIndex(676, v4.Length)]];
					var v35: map<int, bool> := map[v34[safeIndex(|v1|, |v34|)] := p1];
					v35 := v35[v4[safeIndex(676, v4.Length)] := p1];
					var v36: C4 := new C4(p1, p1);
					var v37: set<C4> := {v36};
					v37 := v37;
					globalState.f16 := v34[safeIndex(p0 - p0, |v34|)];
					var v38: array<map<map<char, bool>, D22>> := new map<map<char, bool>, D22>[25];
					var v40: map<char, bool> := map[v2 := false];
					var v41 := DC59(DC57(v4[safeIndex(676, v4.Length)], 0x2ff, v36.f25));
					var v42: map<map<char, bool>, D22> := map[map v39 : char | v39 in v40 :: (v39) := (v36.f26) := v41];
					v38[safeIndex(187, v38.Length)] := v42 + v42;
					...
					var v48: array<array<bool>> := new array<bool>[26] [v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v47[safeIndex(p2, |v47|)], v46, v46, v46, v46, v46, v46, v46];
					v48[safeIndex(558, v48.Length)] := v46;
					v38[safeIndex(187, v38.Length)], v43, v2, v45, v48[safeIndex(558, v48.Length)] := map[v40 := v41] + v42, v43, v3[safeIndex(p0 - p2, |v3|)], DC36(!v36.f26, v31, v36.f25).(cf49 := v43[safeIndex(v4[safeIndex(676, v4.Length)], |v43|)]), v46;
				}
				
				v4[safeIndex(676, v4.Length)] := safeModuloInt(v4[safeIndex(676, v4.Length)], safeModuloInt(|(map v49 : string | v49 in [v3] :: (v49) := (v2))|, p2));
				var v50: multiset<array<int>> := multiset{v4, v4};
				v4[safeIndex(676, v4.Length)] := -(v4[safeIndex(676, v4.Length)] + |(v50 - v50)|);
				if (v7.fm7(p1 ==> !!p1, p0, p1, globalState)) {
					var v51: T0 := new C3();
					v51 := v51;
					v4[safeIndex(676, v4.Length)] := p0;
					var v52: set<int> := {p2, p2};
					var v53: map<bool, int> := map[p1 := -v4[safeIndex(676, v4.Length)]];
					var v54: map<int, int> := map[p2 := |v3|];
					var v55: seq<int> := [v4[safeIndex(676, v4.Length)], |v54|];
					var v56: map<int, bool> := map[if (p1 in v53) then v53[p1] else v55[safeIndex(|v3|, |v55|)] := !p1];
					v52 := fm26(v2, v56, globalState);
					v4[safeIndex(676, v4.Length)] := |(fm61(748, v2, v2, globalState))[v0[true := p1] + (map[p1 := p1])[true := p1] := abs(p0)]|;
					...
					v62[safeIndex(510, v62.Length)] := v4;
					v62[safeIndex(510, v62.Length)] := v4;
					globalState.f13 := p1;
		...
		r0 := (if (p1) then v3 else v3[safeIndex(v4[safeIndex(676, v4.Length)], |v3|) := 'n']) + v3;
	}
}

function fm0(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState): int {
	|(map v0 : int | (-842 <= v0) && (v0 < 0x1b0) :: (safeDivisionInt(v0, 0x134)) := (0xa6))| + |DC26("gtqau", true, true).cf33|
}
function fm1(p0: int, globalState: GlobalState): string {
	("juk" + "liutef") + ((seq(abs(902), i0  => ('b'))) + "olrx")
}
...
function fm3(p0: int, p1: bool, p2: string, p3: int, globalState: GlobalState): map<int, bool> {
	(map[|{|"cacr"|, |map[false := false]|, 0x318}| := !true] + map[0x245 := false]) + (map v0 : int | (310 <= v0) && (v0 < 0x150) :: (safeDivisionInt(v0, |(seq(abs(-0x358), i0  => ('w')))|)) := (DC64(|(seq(abs(0x1d4), i1  => ('x')))|, true, false).cf93))
}
...
function fm11(p0: int, globalState: GlobalState): seq<multiset<bool>> {
	match DC49(map v0 : int | (0x1f4 <= v0) && (v0 < 0x2e7) :: (safeDivisionInt(v0, 0x37d)) := ('v')) {
...
function fm13(p0: int, p1: bool, p2: D4, p3: bool, globalState: GlobalState): multiset<char> {
	(multiset{'h', DC6(seq(abs(0x2e7), i0  => ('w')), 'c', false).cf7} * multiset{'w', 'q'}) + multiset{'a'}
}
...
function fm16(p0: int, p1: bool, globalState: GlobalState): D4 {
	DC7(-DC47(DC2(map[|[false]| := true]), |multiset{|(seq(abs(0x160), i0  => (|map[true := DC39(838, map[|map[false := 0x161]| := |(map v0 : char | v0 in map['m' := |multiset([|"tynvdcxoj"|])|] :: (v0) := (true))|], !false, map[|[true]| := DC25(map[-0x33 := |multiset{52}|])], 358)]|)))|}|, false).cf63)
}
...
function fm21(globalState: GlobalState): seq<int> {
	(seq(abs(0xab), i0  => (|multiset([-0x17c, |"hf"|])|))) + [|(seq(abs(41), i1  => ('c')))|]
}
function fm22(p0: bool, p1: bool, p2: bool, globalState: GlobalState): seq<seq<int>> {
	[[-0x88], [-0x18], [|[0x38a]|, |"xtfitcgkw"|], [-|map[false := |(seq(abs(0x2c), i0  => (-0x310)))|]|], seq(abs(0x34c), i1  => (|"vpemvormm"|))]
}
...
function fm24(p0: char, p1: int, p2: int, p3: int, globalState: GlobalState): multiset<map<char, bool>> {
	(multiset{map['k' := !true]} * multiset{map['l' := !true], map['j' := false], map['j' := false]}) * (multiset{map['n' := false], map['p' := true], map v0 : char | v0 in {'c'} :: (v0) := (false), map['j' := false]} + multiset(seq(abs(0x39a), i0  => (map v1 : char | v1 in map['t' := true] :: (v1) := (false)))))
}
...
function fm28(p0: set<int>, p1: int, p2: bool, p3: bool, globalState: GlobalState): multiset<int> {
	match DC42(map[true := false]) {
		case DC43() => multiset{|(seq(abs(0x282), i0  => ('n')))|, -885, |{|map[true := false]|, -|map[true := false]|, 0x21a, 0x24c}|}
...
function fm30(p0: bool, p1: int, p2: int, p3: multiset<D3>, globalState: GlobalState): set<int> {
	({0x393, 0x67} * {0x341}) * {|(seq(abs(0x170), i0  => (|"rsvm"|)))|}
}
...
function fm35(p0: bool, p1: int, globalState: GlobalState): map<bool, int> {
	match DC54(262, 529, !!true) {
		...
		case DC52(cf71) => if (true) then map[false := |(map v0 : char | v0 in ['b', 'b'] :: (v0) := (|(seq(abs(-442), i0  => ('c')))|))|] else map[false := 0x116]
...
function fm39(p0: int, p1: bool, p2: int, globalState: GlobalState): map<seq<int>, seq<bool>> {
	(map[[|(seq(abs(-0x169), i0  => ('n')))|, |map[false := seq(abs(336), i1  => (0x1dc))]|, |[759]|] := [!true]] + (map v0 : seq<int> | v0 in [[-784], [0x1fc, -|{|['o', 'l']|, 0x1e6}|]] :: (v0) := ([false]))) + (map[[|map[true := -|map[true := false]|]|] := [true, false]] + (map v1 : seq<int> | v1 in multiset{[0x13d], seq(abs(267), i2  => (|multiset{|multiset{0x3c0}|}|))} :: (v1) := ([true])))
}
...
function fm45(globalState: GlobalState): D13 {
	if (false) then DC25(map v0 : int | (190 <= v0) && (v0 < -0x3ab) :: (v0 - |multiset([|{0x2e7, -433}|, |[0xe2, 423]|, |(seq(abs(0x26e), i0  => ('d')))|])|) := (-0x221)) else DC25(map[--|map[true := true]| := 0x28c])
}
function fm46(p0: bool, p1: char, globalState: GlobalState): seq<D14> {
	(seq(abs(0x143), i0  => (DC30([0x2b3, |(seq(abs(-832), i1  => ('l')))|, |"xxqknse"|], [false])))) + (seq(abs(-0x14c), i2  => (DC30([0x5e], [!false, true, true]))))
}
...
function fm49(p0: char, p1: seq<int>, p2: int, p3: char, globalState: GlobalState): D19 {
	DC46(map[DC60(map[false := map[false := !!false]]) := |"unbxcg"|] != map[DC60(map[!false := map[!true := !false]]) := |(seq(abs(366), i0  => ('o')))|], |map[|{DC28({|[true]|})}| := false]| * 0x2c7)
}
function fm50(p0: int, p1: int, globalState: GlobalState): map<bool, seq<int>> {
	map[!false := [|"obwgo"|]] + map[true := seq(abs(40), i0  => (|{false, !true}|))]
}
...
function fm53(p0: bool, globalState: GlobalState): set<string> {
	(if (DC61([true], |map[true := 'b']|, false).cf88) then {"yuclgsvm", "l"} else {"ndjpjd", "n", "jgu", "p"}) * {seq(abs(0x3da), i0  => ('b')), "clwvk"}
}
function fm54(globalState: GlobalState): map<int, int> {
	DC25(map[|(seq(abs(0xe), i0  => (DC5('n').cf5)))| := |[false]|]).cf32
}
function fm55(p0: int, p1: bool, p2: bool, globalState: GlobalState): multiset<string> {
	multiset{"fvrqpnj", "db", seq(abs(0x300), i0  => ('t')), "hs"} - (multiset{"sfwcvbt"} * multiset{"dntsofjge", "ctwuqpd"})
}
function fm56(p0: int, p1: int, p2: bool, globalState: GlobalState): multiset<D6> {
	(multiset{DC13(0x265, 0xc)} - multiset{DC13(|"itggvjgu"|, |(seq(abs(0x24), i0  => ('v')))|)}) + multiset{DC13(|"wmqdtf"|, -359), DC13(-|{true, false, true}|, -|map[true := [false]]|)}
}
...
function fm61(p0: int, p1: char, p2: char, globalState: GlobalState): multiset<map<bool, bool>> {
	multiset(seq(abs(455), i0  => (map[false := true] + map[false := false])))
}
...
method m0(p0: bool, p1: int, p2: map<seq<bool>, string>, p3: int, globalState: GlobalState) {
	...
	var i0 := 0;
	while ((v1[safeIndex(p1, |v1|)] + [p0, p0]) < v0)
		decreases 100 - i0
	{
		if (i0 >= 100) {
			break;
		...
		var v6: array<seq<string>> := new seq<string>[23](i1 => seq(abs(0x105), i2  => ("rphheln")));
		var v7 := "hne";
		v6[safeIndex(422, v6.Length)] := ["lgtdubw", v7, v7];
		v5[safeIndex(760, v5.Length)] := v0[safeIndex(p1, |v0|)];
		var v8: seq<string> := [v7];
		var v9: multiset<bool> := multiset{!p0, p0};
		v5, globalState.f7, globalState.f7, v6[safeIndex(422, v6.Length)], v5[safeIndex(760, v5.Length)] := v5, p1, p1 * (p1 + |v0|), (([v7] + v8) + (if (p0) then seq(abs(0x2a2), i3  => (v7)) else v8[safeIndex(p1, |v8|) := v7]))[safeIndex(p1, |(([v7] + v8) + (if (p0) then seq(abs(0x2a2), i3  => (v7)) else v8[safeIndex(p1, |v8|) := v7]))|) := if (p0) then v7 else v7], v9 >= (multiset{p0} - v9);
		globalState.f13 := v5[safeIndex(760, v5.Length)] <==> v0[safeIndex(p3, |v0|)];
		var v10: seq<int> := [p1];
		globalState.f16 := v10[safeIndex(0x3b3, |v10|)];
	}
	globalState.f16 := p1;
	var v11: array<map<string, int>> := new map<string, int>[11];
	var v13: seq<string> := [fm1(712, globalState)];
	v11[safeIndex(312, v11.Length)] := map v12 : string | v12 in v13 :: (v12) := (p1);
	v11[safeIndex(312, v11.Length)] := map[seq(abs(209), i4  => ('a')) := p1];
	match (match DC0(p0) {
		...
		case DC3(cf3) =>
			...
			v14[safeIndex(612, v14.Length)] := cf3;
			v14[safeIndex(612, v14.Length)] := cf3;
			if (v14[safeIndex(612, v14.Length)]) {
				var v15: array<string> := new string[16];
				var v16 := 'c';
				var v17 := "tmcphea";
				v15[safeIndex(389, v15.Length)] := (seq(abs(0x140), i5  => ('q')))[safeIndex(p1, |(seq(abs(0x140), i5  => ('q')))|) := v16] + v17;
				var v18: set<bool> := {p0};
				...
				v15[safeIndex(389, v15.Length)] := if ({v19} == v21) then ("on")[safeIndex(p3, |"on"|) := v16] else v17;
				v20 := v20[cf3 := cf3];
				globalState.f20 := if (fm0(p1, p3, |v20|, v14[safeIndex(612, v14.Length)], globalState) < p1) then fm1(|"yootrwdif"|, globalState) + v15[safeIndex(389, v15.Length)] else (v17 + "r")[safeIndex(p1, |(v17 + "r")|) := v16];
				globalState.f16 := -p3;
				globalState.f2 := cf3;
			} else {
				...
				v23[safeIndex(286, v23.Length)] := v25.(cf0 := cf3);
				var v27: array<int> := new int[3](i7 => safeModuloInt(i7, |(set v26 : char | v26 in map['p' := v24] :: (v26))|));
				v27[safeIndex(224, v27.Length)] := -p1;
				var v28 := "ylg";
				v22, v23[safeIndex(286, v23.Length)], v14[safeIndex(612, v14.Length)], v27[safeIndex(224, v27.Length)], v14[safeIndex(612, v14.Length)] := v22[p3 - -0x21e := p3], v25, p0, p1 - p3, (seq(abs(-0x33e), i8  => ('r'))) < v28;
				v14[safeIndex(612, v14.Length)], v27[safeIndex(224, v27.Length)], globalState.f7, v27 := cf3, v27[safeIndex(224, v27.Length)], safeModuloInt(-p3, p1), v27;
			}
			
			var v29: array<string> := new string[23];
			var v30 := "x";
			v29[safeIndex(916, v29.Length)] := fm1(p1, globalState) + v30;
			v29[safeIndex(916, v29.Length)] := (seq(abs(0x5a), i9  => ('w'))) + v30;
			v14[safeIndex(612, v14.Length)] := true;
		case DC2(cf2) =>
			globalState.f16 := p3;
			var v31 := 'q';
			...
			var v39 := "frletcac";
			var v40 := new C4(!(v38[safeIndex(|v39|, |v38|)] != v37), p0);
...
method Main() {
	...
	var globalState := new GlobalState(true, v0, false, 0x2ea, true, false, false, 0x2d9, v1, -0x38c, if (v2) then v3 else set v4 : string | v4 in v3 :: (v4), -0x1d2, 794, true, v1[safeIndex(v5, |v1|) := v6] + v1, 0x34, 251, false, 0x3b9, v1, "cesqe" + v1, false, v7);
	var v8: seq<int> := [v5];
	v5 := --0x1f8 - v8[safeIndex(v8[safeIndex(v5, |v8|)], |v8|)];
	var v9: array<bool> := new bool[7];
	v9[safeIndex(773, v9.Length)] := v2;
	v9[safeIndex(773, v9.Length)] := v2;
	v9[safeIndex(773, v9.Length)] := v2 && v9[safeIndex(773, v9.Length)];
	if (v2) {
		globalState.f16 := v5;
		...
		m0(v9[safeIndex(773, v9.Length)], |v11|, v13[v14[safeIndex(v5, |v14|)] := v1], if (v2) then v5 else v5, globalState);
		globalState.f7 := v8[safeIndex(v5, |v8|)];
		var v15 := DC0(v2);
		var v16 := DC1(DC1(v15));
		var v17 := DC1(v16);
		match (v17) {
			case DC0(cf0) =>
				...
				globalState.f7, globalState.f2, v22, globalState.f16, globalState.f2 := |multiset(v25[safeIndex(v5, |v25|)])|, fm2(map[v2 := v9[safeIndex(773, v9.Length)]], globalState), if (v12[safeIndex(if (v0 in v26) then v26[v0] else v5, |v12|)]) then v22 else if (v2 in v27) then v27[v2] else v22, safeDivisionInt(v5 + v5, v5), v9[safeIndex(773, v9.Length)];
				var v28: multiset<map<bool, bool>> := multiset{v18, map[v9[safeIndex(773, v9.Length)] := v2]};
				var v29: multiset<int> := multiset{v5, v5};
				globalState.f16 := fm0(v5, |v28|, -safeModuloInt(v5, v5), v29 > v29, globalState);
				globalState.f13 := v1 <= ("urqdgor" + (seq(abs(-0x1c3), i2  => (v6))));
			case DC1(cf1) =>
				globalState.f21 := v2;
				v5 := 0x1b7;
				var v30: map<bool, bool> := map[v9[safeIndex(773, v9.Length)] := v9[safeIndex(773, v9.Length)]];
				m0(fm2(v30, globalState), v5, v13, -0xc6, globalState);
				var v31 := DC3(v2 || v9[safeIndex(773, v9.Length)]);
				v31 := v31;
		}
		
		var v32 := DC0(v9[safeIndex(773, v9.Length)]);
		v32 := v32;
	} else {
		globalState.f21 := true;
		v1 := "bsi" + v1;
		v2 := false;
		v0[safeIndex(441, v0.Length)] := --0xc1;
		var v33: set<bool> := {v2, v2};
		var v34: map<int, bool> := map[|v33| := v9[safeIndex(773, v9.Length)]];
		var v36 := DC2(v34 + (map v35 : int | (0x3a1 <= v35) && (v35 < 635) :: (safeDivisionInt(v35, v5)) := (v9[safeIndex(773, v9.Length)])));
		globalState.f21, v0[safeIndex(441, v0.Length)], v36 := v9[safeIndex(773, v9.Length)], if (if (v2) then v2 else v9[safeIndex(773, v9.Length)]) then |multiset{-v5}| else v5, v36;
	...
	var v39 := DC0(v2);
	var v40: seq<bool> := [v9[safeIndex(773, v9.Length)], false, v2, false];
	var v41: map<seq<bool>, string> := map[v40 := "ncojfqse"];
	m0(v39.cf0, v5, v41, v5, globalState);
	forall i4 | 0 <= i4 < v0.Length {
		v0[i4] := i4 + (if (v9[safeIndex(773, v9.Length)]) then v5 else -v5);
	}
	m0(if (false) then v2 else true, |([v5] + v8)|, v41 + v41, v5, globalState);
	var v42: map<bool, int> := map[v2 := v5];
	var v43: map<string, bool> := map[v1 + (seq(abs(-461), i5  => (v6))) := !(v9[safeIndex(773, v9.Length)] in v42)];
	v43 := v43;
	globalState.f13 := v2;
	var v44: map<int, bool> := map[v5 := v9[safeIndex(773, v9.Length)]];
	var v45 := DC2(v44);
	var v46: set<int> := {v5};
	...
	match (DC1(fm4(fm0(v5, 0x251, v5, v2, globalState), v5, globalState))) {
		case DC0(cf0) =>
			match (v45.(cf2 := v44)) {
				case DC3(cf3) =>
					...
					v9 := new bool[4];
					v0[safeIndex(575, v0.Length)] := v5;
					var v48: multiset<bool> := multiset{v9[safeIndex(773, v9.Length)]};
					v0[safeIndex(575, v0.Length)] := safeDivisionInt(v5, safeModuloInt(fm0(v5, |v48|, v5, if (|v1| in v44) then v44[|v1|] else v9[safeIndex(773, v9.Length)], globalState), -v5));
				case DC2(cf2) =>
					v40 := v40 + [v9[safeIndex(773, v9.Length)]];
					v8 := [v5, v5] + v8;
		...
		case DC1(cf1) =>
			...
			v53[safeIndex(229, v53.Length)] := v0;
			v53[safeIndex(229, v53.Length)] := v0;
			m0(v9[safeIndex(773, v9.Length)], -0x354, v41, safeModuloInt(v5, v5), globalState);
			globalState.f0 := v9[safeIndex(773, v9.Length)];
			var v54: map<char, bool> := map[v6 := v2];
			v40 := [v9[safeIndex(773, v9.Length)], if (v6 in v54) then v54[v6] else false];
	}
	
	var i6 := 0;
	while (v9[safeIndex(773, v9.Length)])
		decreases 100 - i6
	{
		if (i6 >= 100) {
			break;
		...
		v45 := v45.(cf2 := v44);
		v45 := v45;
		var v55: set<bool> := {v2, v9[safeIndex(773, v9.Length)]};
		v5 := |v55|;
		globalState.f16 := -v5 - (0x94 + -v5);
	}
	var v56: map<array<bool>, int> := map[v9 := v5];
	var v57 := DC6(("yswqe")[safeIndex(v5, |"yswqe"|) := v6], v6, v2);
	var v58: array<map<array<bool>, int>> := new map<array<bool>, int>[21] [v56, v56, v56[v9 := v5], v56 + v56, v56, v56, if (v9[safeIndex(773, v9.Length)]) then v56 else v56, v56 + v56[v9 := |multiset{v57.cf7}|], v56 + v56, v56, v56, v56, v56, v56, v56[v9 := v5], v56, map[v9 := v5], v56 + v56, v56, map[v9 := v5], map[v9 := 0x81]];
	v58[safeIndex(421, v58.Length)] := v56;
	v58[safeIndex(421, v58.Length)], v9[safeIndex(773, v9.Length)], v5 := v56, !v2, v5;
	v2 := v9[safeIndex(773, v9.Length)] && v2;
	print v0[0], "\n";
	print v0[1], "\n";
	print v0[2], "\n";
	print v0[3], "\n";
	...
	print globalState.f10 == {"ucjarmpr"}, "\n";
	...
	print v9[3], "\n";
	print v39.cf0, "\n";
	print v40 == [false, false], "\n";
	print v41 == map[[false, false, false, false] := "ncojfqse"], "\n";
	print v42 == map[false := -206], "\n";
	print v43 == map["" := false], "\n";
	print v44 == map[-206 := false], "\n";
	print v45.cf2 == map[3 := false, 581 := false, 0 := false], "\n";
	print v46 == {-206}, "\n";
	print v47 == multiset{-206}, "\n";
	print i6, "\n";
	print |v56|, "\n";
	print v57.cf6, "\n";
	print v57.cf7, "\n";
