...
function fm10(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): set<int> {
	{-374 + 0x3d4, |(seq(0xfc, i0  => ('a')))|, |{true}| * 99}
}
...
function fm16(globalState: GlobalState): multiset<int> {
	match DC24() {
		case DC23(cf35, cf36, cf37) => multiset(seq(0x2a4, i0  => (0x107)))
...
function fm17(p0: bool, globalState: GlobalState): D0 {
	match DC18(map[0x3b2 := true]) {
		...
		case DC20(cf31, cf32) => if (cf32) then DC1(cf32, [cf31], DC20(cf31, cf32).cf31) else DC1(true, [cf31, cf31, cf31, cf31, seq(-0x365, i0  => ('j'))], cf31)
		case DC18(cf26) => DC1(true, [seq(816, i1  => ('h'))], "narkygd")
		case DC21(cf33) => DC1(!false, seq(0x22e, i2  => ("u")), seq(0x35f, i3  => ('i')))
	}
}
function fm18(p0: char, p1: int, globalState: GlobalState): seq<seq<D0>> {
	(if (!false) then [seq(0x100, i0  => (DC0(|"hwq"|))), [DC0(694)], seq(0x22f, i1  => (DC0(|map[true := true]|)))] else [seq(0x361, i2  => (DC0(|"dnmlywcha"|)))]) + (seq(-0x19e, i3  => ([DC0(|{false, false}|), DC0(|"bgl"|)])))
}
...
function fm25(p0: bool, p1: seq<int>, globalState: GlobalState): multiset<int> {
	(multiset{|[-0x2e3, 362, |[false]|]|} + multiset{0x258, |multiset(seq(612, i0  => (0x321)))|, 0x2c4, -|[!true, !true]|, |"hbr"|}) * (DC31(multiset{0x6c}).cf48 + multiset{0x1a1})
}
...
function fm28(globalState: GlobalState): D0 {
	if (497 > |map[multiset{|(seq(0x3d8, i0  => ('i')))|} := |map[false := true]|]|) then if (!false) then DC3(DC2(true)) else DC3(DC3(DC1(!false, [seq(442, i1  => ('p')), seq(958, i2  => ('n'))], "fwyar"))) else DC3(DC0(0x128))
}
...
function fm30(globalState: GlobalState): seq<int> {
	[93] + (seq(0x19, i0  => (-|{0x2f1, 0xdc}|)))
}
function fm31(globalState: GlobalState): map<int, int> {
	map[|((seq(-0x59, i0  => ('v'))) + "mijsmoem")| := |map[false := DC7(!true, map[false := DC3(DC0(|map[true := 0x1ae]|))], 0x2c6, true).cf13]|]
}
...
function fm34(globalState: GlobalState): multiset<seq<int>> {
	if ({0xe, -|multiset{false, false, !false}|} <= {|"amok"|}) then multiset{[-0x196, |[false]|], [|[!true, true]|]} - multiset{[|(map v0 : int | (0x12b <= v0) && (v0 < 0x2d9) :: (v0 * |[|map[|multiset{true}| := false]|, |{|"mwcb"|}|]|) := ('u'))|, |map[!true := |map[false := false]|]|], seq(0x309, i0  => (0x3c2)), seq(0x24d, i1  => (0x9f)), [|(map v1 : int | v1 in [|(seq(933, i2  => (|map[true := false]|)))|] :: (v1 / 672) := (|[228, |(set v2 : int | (0xe4 <= v2) && (v2 < 0x2a9) :: (v2 % 0x46))|]|))|]} else multiset{[|"juf"|, |map[false := |(seq(0x353, i3  => ('y')))|]|, |map[false := true]|, |multiset([0x397, |map[|"uise"| := 0x17]|])|], [|[!!true]|], [0x2e3, 0x1ea, |[738]|]} + multiset{[|[!false, false]|, |[false, false]|, |(seq(0x1e7, i4  => ('v')))|]}
}
...
function fm40(p0: int, p1: D4, globalState: GlobalState): D7 {
	DC20((seq(-0x213, i0  => ('p'))) + (seq(0x36a, i1  => ('v'))), !(|map[|[false]| := 979]| < --|[true, false]|))
}
...
function fm42(p0: bool, p1: int, p2: map<char, int>, p3: seq<bool>, globalState: GlobalState): multiset<D0> {
	multiset{DC1(false, seq(-783, i0  => ("jtdyx")), "pj"), DC1(!false, ["woy", "dwuebhwk"], seq(0x141, i1  => ('r'))), DC1(false, ["ue"], "wo")} * multiset{DC1(!!true, ["wg", "jwmnfd"], seq(0x1db, i2  => ('v'))), DC1(false, ["jmo"], seq(0x18b, i3  => ('q'))), DC1(false, seq(0x353, i4  => ("boc")), "cihhuxg")}
}
...
class C1 {
	...
	method m8(globalState: GlobalState) returns (r0: int) {
		...
		v4 := v4[v1 >= -0x3cc := v0];
		if (!v0) {
			var v5: array<int> := new int[4](i0 => i0 / -167);
			...
			var v11: seq<bool> := [v0];
			var v12: seq<bool> := [v0, v0, v11[v1]];
			v10[624] := v12[v1];
			v5[819] := -|fm20(|v9|, v0, v0, v1, globalState)| - v1;
			v10[624], v5[819], globalState.f3 := !false, (v1 + v1) - (v1 + v1), (--0x59 * v1) != (v1 / v1);
			globalState.f3 := true;
			var v13: multiset<bool> := multiset{!v0, v0, v10[624]};
			r0 := (if (v0 in v13) then v13[v0] else v5[819]) / v5[819];
		} else {
			...
			var v19: array<array<char>> := new array<char>[28] [v17, v17, v17, v17, v17, v17, v17, v18[-0xb], v17, v17, v17, if (v0) then v17 else v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, if (v0) then v17 else v17, if (v0) then v17 else v17, v17, v17, v17, v17, v17];
			v19[513] := v17;
			v16, v19[513], v0 := v16, v17, v0;
			var v20 := "ddwvkjgl";
			if (v20 != v20) {
				var v21: multiset<int> := multiset{v1, v1};
				var v22: map<int, multiset<int>> := map[v14[755] := v21 * v21];
				v22 := v22[v14[755] + v1 := multiset(v15) * v21[v14[755] := v1]];
				var v23: seq<string> := [v20, v20];
				var v24: seq<string> := [v23[v1], v20];
				var v25: seq<bool> := [v0];
				var v26 := DC5(v0, v20, v25);
				var v27: map<int, int> := map[v14[755] := v14[755]];
				var v28: map<map<bool, bool>, bool> := map[v4 := v0];
				var v29: set<bool> := {v0};
				var v30: multiset<set<bool>> := multiset{v29};
				var v31: array<bool> := new bool[27] [v0, false && v0, true, v0, v0, !v0, v0, v20 <= "rexhpd", v0, v0, !v0, v1 > |v23[if (v14[755] in v21) then v21[v14[755]] else v14[755]]|, !v0, true, v26.cf7, v0, v27[v14[755] := v14[755]] == v27, v0, if (if (v4 in v28) then v28[v4] else v0) then true else !!v0, true, v21 > v21, v0, v0, (if (v29 in v30) then v30[v29] else v14[755]) == v1, v0, v25 == v25, v0];
				v31[182] := v20 <= v20;
				v31[182] := "h" != "kfkrjpla";
				...
				v35[664] := "mcihcac";
				var v36: map<bool, int> := map[v34.f19 := if (v34.f19) then v14[755] else |{0x248, v14[755]}|];
				v35[664], r0, v36 := v20 + (v20 + v20), v14[755], v36;
			} else {
				globalState.f3 := v2.cf4;
				var v37 := 's';
				var v38: array<bool> := new bool[19];
				var v39: multiset<int> := multiset{v1, v1, v14[755], v14[755]};
				...
				var v46: set<int> := {-v14[755]};
				v14[755], r0, v37, v38, v39 := fm22(v44, v42, v0, globalState), fm22(v44, v42, v0, globalState), fm23(v0, fm24(globalState), v0, v14[755], globalState), if ((v20 + v20) in v45) then v45[v20 + v20] else v38, v39[|v20| * v1 := |(v46 - v46)|];
				var v47 := DC1(v0, v40, fm20(v1, !v0, v0, |v20|, globalState));
				var v48 := new C0(multiset([v47, v47]), v0);
				v14[755] := -(v1 + (v14[755] / -v1));
				var v49 := new C0(v48.f18[v47 := |v46|], !v48.f19);
			}
			...
			v14[755] := fm22(v53, DC3(v50), !v0, globalState);
		}
			...
			decreases 100 - i3
		{
			...
			if (fm19(v1, v0, globalState) && v0) {
				...
				var v65: seq<bool> := [v0];
				v59[961], globalState.f5, v1 := v1 % |fm20(|v56|, v0, v0, fm22(v64, v62, v0, globalState), globalState)|, v0 <== v0, |v65|;
				var v66: multiset<int> := multiset{v59[961]};
				var v67: seq<int> := [v59[961], |[v59[961]]|];
				v66, globalState.f13 := (fm25(v0, v67, globalState) * v66) + (multiset{-0x322, v1, v1} + v66), v0;
				var v68 := DC5(v0, v55, v65[-v1 := v65[v1]]);
				var v69: array<D1> := new D1[5] [fm26(v0, v0, globalState), v68, v68, v68, fm26(v0, v0, globalState).(cf8 := v55)];
				v69[711] := v68;
				v69[711] := v68;
				var v70: set<seq<int>> := {[|v66|], seq(-342, i5  => (v1))};
				v59[961], v0, v59[961], v4 := v59[961] / |(fm20(-|v67|, !v0, true, v59[961], globalState) + v55)|, v70 > {v67}, -(if (v0) then v59[961] else 0x111) + (v1 - v1), v4;
				r0 := v67[v59[961]];
			} else {
				...
				var v75: array<bool> := new bool[14] [v71[v1 := v1] <= v71, v0, false, v0, v0 || v0, |v73| != v1, v0, v0, v0, false <== true, false || v0, v74 != [map[v1 := v1]], v0, v0];
				v75[103] := v0;
				v75[103] := (v55 <= v55) || v0;
				var v76 := DC1(v75[103], seq(0x260, i6  => (v55)), v55);
				...
				var v79: map<bool, array<C0>> := map[v0 := if (v75[103]) then v78 else v78];
				v79 := v79[false := v78];
				v55 := "phrjej" + v55;
				var v80: map<bool, map<bool, int>> := map[v77.f19 := v56];
				var v81: seq<bool> := [true];
				v56 := (if (v0) then v56 else map[v77.f19 := v1]) + (if (v81[v1] in v80) then v80[v81[v1]] else v56);
				v75[103] := if (v75[103] in v4) then v4[v75[103]] else !v77.f19;
			}
			
			var v83: multiset<int> := multiset{v1};
			var v84: seq<int> := [v1, |(map v82 : int | v82 in v83 :: (v82 % (if (v0 in v56) then v56[v0] else |v55|)) := (|map[|{v1}| := v0]|))|, v1];
			r0 := v84[v84[v1]];
			var v86: map<int, string> := map[v1 := v55];
			var v88: array<map<int, string>> := new map<int, seq<char>>[11] [(map v85 : int | (0x3bb <= v85) && (v85 < 0x3b9) :: (v85 / -0x355) := (seq(0x15a, i7  => ('i')))) + v86, v86, map[v1 := v55] + v86, v86[418 := fm20(|v54|, v0, v0, |"gj"|, globalState)] + v86, v86 + map[v1 := v55], map[v1 := v55], v86, v86, v86 + v86, v86, (map v87 : int | (0x51 <= v87) && (v87 < 0x85) :: (v87 - |v58|) := (v55))[v1 := v55]];
			v88[30] := v86 + v86;
			var v89: seq<map<int, string>> := [v86];
			v88[30] := (v86 + v89[v1]) + v86;
			v1 := v1;
		}
...
class C2 extends T0 {
	...
	function fm14(p0: set<int>, p1: bool, p2: string, globalState: GlobalState): bool {
		(seq(944, i0  => (DC0(|map[false := true]|).cf0))) in map[seq(0x162, i1  => (-0x304)) := multiset([|[true, false]|])]
	}
	method m6(p0: string, p1: string, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		r1 := |fm15(p2, p2, p2, globalState)| % (if (p2) then fm0(|p0|, 'p', globalState) else p3);
		var v0: set<int> := {p3};
		for i0 := p3 to |(v0 * v0)| {
		...
		if (v5[|("mkjhatikf" + p0)[0x277 := v6]|]) {
			...
			var v15: multiset<array<int>> := multiset{if (fm14(set v14 : int | v14 in v13 :: (v14 * 290), p2, seq(0x384, i1  => (v6)), globalState) in v12) then v12[fm14(set v14 : int | v14 in v13 :: (v14 * 290), p2, seq(0x384, i1  => (v6)), globalState)] else v11, v11, v8, v11, v11};
			var v16: multiset<int> := multiset{p3};
			v15, v16 := v15 + v15, v16 - fm16(globalState);
			var v17 := DC3(DC0(fm0(144, 'w', globalState)));
			var v18: map<int, D0> := map[p3 / 0x2ba := v17];
			var v20: map<int, bool> := map[p3 := p2];
			v18 := v18 + (map v19 : int | v19 in v20 :: (v19 / p3) := (v17));
			globalState.f9 := p2;
			var v21: array<D0> := new D0[17];
			v21[373] := fm17(p2, globalState);
			var v22: map<bool, set<int>> := map[p2 := v0];
			var v23: seq<int> := [p3];
			var v25: seq<string> := [fm1(map[|(if (p2 in v22) then v22[p2] else set v24 : int | v24 in v23 :: (v24 + |[false]|))| := p3], globalState), seq(-0x2d6, i2  => (v6)), p1];
			...
			v31 := fm18(v6, |v33[p3]|, globalState);
			r1 := p3;
		}
		...
		for i5 := p3 to -|map[p3 := if (v0 in v34) then v34[v0] else p3]| * -p3 {
			...
			var v38: seq<string> := [p0, p1, seq(0x1d, i6  => (v6)), fm1(v37, globalState)];
			var v39 := DC1(p2, v38, "unnkkr");
			var v40: multiset<D0> := multiset{v39};
			var v41 := new C0(v40[v39 := i5], p2);
			var v42 := "qumwtaj";
			v42 := "juj";
		}
		for i7 := p3 to -p3 / p3 {
			...
			var v45: map<int, array<bool>> := map[v43[-p3] := v44];
		...
		var v49: seq<int> := [p3];
		r0 := !(if (v49[p3] in v48) then v48[v49[p3]] else !p2);
		r1 := p3;
		r2 := p2;
	}
	method m7(p0: set<bool>, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: seq<bool>, r1: seq<bool>, r2: bool) {
		...
		var v11: array<int> := new int[25] [-p1, p2 - p2, if (p3) then 0x1b3 else p1, p2, p1 + 766, |v3|, p2, |v4| % p2, |v5| - |v7|, -p1, if (-p1 in v8) then v8[-p1] else 0x3ca, p1, p2 * p1, |(v9 + v9)|, -0x104, p2, p2, if (p3 in v2) then v2[p3] else p1, p2, -272, p2, 156, p1, |v10|, p2];
			...
			decreases 100 - i1
		{
			...
			match (v16) {
				case DC7(cf11, cf12, cf13, cf14) =>
					...
					var v18 := DC1(p3, v17, seq(0x23e, i2  => (v0)));
					...
					v24[271] := fm14(v12, |v9| in v25, if (p1 in v26) then v26[p1] else v9, globalState);
				case DC6(cf10) =>
					var v27: seq<int> := [-0x2e2];
					v6[326] := p2 * v27[p2];
					var v28 := DC0(p1);
					v27, r2, v6[326] := v27, p2 != p1, fm22(v16, DC3(v28), p3, globalState);
					var v29, v30, v31 := m6(v9, v9, p3, p2, globalState);
					var v32 := DC3(DC0(v6[326]));
					v6[326] := fm22(v16, v32.(cf5 := v28), v29, globalState) - |v5|;
				...
				case DC8(cf15) =>
					...
					v37[158] := v39[-fm0(p2, v0, globalState)] + v9;
			}
		...
		match (DC0(|v47|)) {
			case DC1(cf1, cf2, cf3) =>
				...
				v11[285] := v53.cf13 * v46;
				v48[99], cf3, v11[285], globalState.f13, v46 := v50, cf3, v46, p3, -((|v47| - p1) % p2);
				v11[285] := v46 / (p1 % p1);
				...
				v57 := v57[v56 := |cf2|];
				v2, v11[285], cf3, r0 := v2 + v2, -0xcd, cf3 + v9, if (cf1) then v5 else v5 + v5;
			case DC2(cf4) =>
				var v58: array<bool> := new bool[2] [cf4, fm19(|(seq(-373, i3  => (v0)))|, cf4, globalState)];
				var v59: seq<string> := [v9, seq(0x44, i4  => (v0)), "t"];
				var v60: seq<int> := [|v59|];
				var v61: map<array<bool>, seq<int>> := map[v58 := v60 + v60];
				v46 := -|v61|;
				var v62: array<string> := new string[8];
				v62[753] := v9 + v9;
				v6[510] := |map[cf4 := p3]| / |p0|;
				v6, v62[753], v6[510], v9 := v11, v9, --((|v60| / |v2|) - p2), "dwq";
				var v63 := DC0(p1 + p2);
				match (v63) {
					case DC1(cf1, cf2, cf3) =>
						globalState.f9 := cf1;
						var v64 := DC1(cf1, v59, v62[753]);
						var v65 := DC3(v64);
						var v66 := DC3(v64);
						var v67 := DC7(cf4, map[cf1 := v66], 0x30b, cf1);
						v46 := fm22(v67, v66, v5[|multiset{v46}|], globalState);
						var v68: multiset<array<int>> := multiset{v11, v11};
						var v69: seq<multiset<array<int>>> := [v68[v11 := v46]];
						v6[510] := -|v69[706]|;
						v58 := v58;
					case DC2(cf4) =>
						var v70 := DC0(p1);
						...
						var v73 := DC7(p3, v72, -|(seq(804, i5  => (v5)))|, p3);
						var v74: set<char> := {v0};
						var v77: array<D2> := new D2[26] [v73, v73, v73, v73.(cf12 := v72, cf11 := p3), v73, v73, v73.(cf11 := p3, cf14 := cf4, cf13 := |v5|), v73, v73, v73, v73, v73, v73, v73, v73, v73, DC7(p3, v72[p3 := v71], |v74|, cf4), fm29(|v2|, v6[510], v62[753], p1, globalState), DC7(v5[v46], v72, v6[510], p3), v73, v73, v73, v73, if (cf4) then v73 else DC7(fm14(set v76 : int | v76 in (map v75 : int | (0x120 <= v75) && (v75 < -0x1cc) :: (v75 - p1) := (cf4)) :: (v76 - -0x3d1), false, v9, globalState), v72, |map[fm30(globalState) := cf4]|, p3), v73, v73];
						v77[262] := DC7(p3, v72, v6[510], p3);
						v77[262] := fm29(-|(v5 + v5)|, p2 + v6[510], v9, v6[510] / v73.cf13, globalState);
						var v78: map<string, bool> := map["gortewya" := !cf4];
						var v79 := DC1(cf4, v59, v59[v46]);
						var v80 := DC9({p3});
						v78 := v78[v79.cf3 := p0 >= v80.cf16];
						v11 := v11;
						var v81: multiset<D0> := multiset{DC1(cf4, seq(-0x3b8, i6  => (v9)), seq(0x1ee, i7  => (v0)))};
						var v82: seq<multiset<D0>> := [v81, v81];
						var v83: multiset<int> := multiset{v6[510]};
						var v84: seq<multiset<D0>> := [v82[|v83|], v81];
						var v85: map<int, seq<multiset<D0>>> := map[p1 := v82];
						v85 := v85[v6[510] + v46 := v82];
					case DC0(cf0) =>
						v11 := new int[3];
						v0, v1, v46, v46, v46 := v0, multiset{v0} - (v1 + v1), |(v62[753] + v62[753])|, -v46, v6[510];
						var v86: map<int, seq<string>> := map[|v10| := v59];
						var v87 := DC1(p3, [v9], fm1(map[v46 := |v8|], globalState));
						var v88: multiset<D0> := multiset{DC1(p3, seq(638, i8  => (v9)), "cv"), DC1(cf4, v59, v62[753]), fm17(p3, globalState), DC1(p3, if (v46 in v86) then v86[v46] else seq(0x69, i9  => (v62[753])), v9), v87};
						var v89 := new C0(v88, cf4);
						var v90: seq<D0> := [fm17(v89.f19, globalState)];
						var v91 := new C0((multiset(v90))[fm17(v89.f19, globalState) := v46], cf4);
					case DC3(cf5) =>
						var v92: map<bool, bool> := map[p3 := fm19(|v60|, p3, globalState)];
						var v93 := DC1(cf4, v59, v9);
						var v94: map<bool, D0> := map[cf4 := DC3(v93)];
						var v95 := DC7(if (|multiset(seq(0x37a, i10  => (v6[510])))| in v10) then v10[|multiset(seq(0x37a, i10  => (v6[510])))|] else p3, v94, v46, !cf4);
						var v96: seq<D2> := [v95];
						var v97: map<int, array<bool>> := map[p2 := v58];
						var v98: map<seq<int>, int> := map[([|v92|])[|v60| := |v96|] := |v97|];
						var v99: array<array<array<bool>>> := new array<array<bool>>[1];
						var v100: array<array<bool>> := new array<bool>[11];
						v99[699] := v100;
						v98, v99[699] := v98, v100;
						var v101: map<string, seq<int>> := map[v62[753] := v60];
						var v102: array<seq<int>> := new seq<int>[10] [v60[|v62[753]| := p1], v60, v60 + v60, if (false) then v60 else fm30(globalState), if (fm20(p1, p3, cf4, v46, globalState) in v101) then v101[fm20(p1, p3, cf4, v46, globalState)] else v60, seq(-0x202, i11  => (|v60|)), v60, v60, v60, [v6[510]] + (seq(0xe0, i12  => (-161)))];
						globalState.f2 := v102;
						var v103 := DC5(!p3, v62[753], v5);
				...
				var v109 := DC1(cf4, v59, v62[753]);
				var v110 := DC1(false, v109.cf2, v62[753]);
				...
				v58[810] := --fm0(if (v113 in v114) then v114[v113] else -858, v0, globalState) != p1;
				v58[810] := ("ooskv" + fm20(v46, cf4, v112.f19, v46, globalState)) < "xfq";
			case DC0(cf0) =>
				if (p3) {
					var v115: seq<string> := [seq(0x359, i13  => (v0)), v9[cf0 := v0]];
				...
				var v146 := DC0(|DC1(!p3, v145[p1 := v9], v9).cf3|);
				var v147 := DC3(v146);
				v147 := v147;
			case DC3(cf5) =>
				r2 := v9 < (v9 + "ienvw");
				v10 := v10[p2 % -0x2ec := true && p3];
				var v148: array<string> := new string[2];
				var v149: map<bool, string> := map[p3 := v9];
				v148[837] := v9 + (if (true in v149) then v149[true] else v9);
				v148[837] := fm20(p2, p3, v9 < (seq(0x3a5, i15  => (v0))), p1, globalState);
				globalState.f3 := p3;
		}
		...
		v150[436] := v151 in v152;
		var v153: multiset<int> := multiset{-0x15, --v46};
		var v154: seq<multiset<int>> := [v153];
		v150[568], v150[436], globalState.f5, v46 := p3, fm14(v47, p3, v9, globalState), v154 != (if (p3) then [multiset{|v8|, p2, p1}, v153] else v154), v46;
		var v155 := DC0(p2);
		var v156 := DC3(DC3(v155));
		var v157: map<bool, D0> := map[p3 := v156];
		var v158: set<map<int, int>> := {map[-p1 := fm22(DC7(v150[568], v157, |multiset{p3, false}|, p3), fm28(globalState), v150[568], globalState)], v8};
		var v159: seq<string> := [v9, v9];
		var v160 := DC1(v150[568], v159, v9);
		var v161 := DC6(multiset{v160, DC1(v150[568], v159, "bfwqt"), v160});
		v158 := match v161 {
...
class C3 extends T1 {
	...
	function fm13(p0: int, p1: seq<int>, p2: int, p3: bool, globalState: GlobalState): bool {
		({[f16, f16], [f16], [f16]} * {[f16], [f16, f16, f16, f16, f16]}) !! ((set v0 : seq<bool> | v0 in (seq(216, i0  => ([f16]))) :: (v0)) * {[f16]})
	}
	method m0(p0: char, globalState: GlobalState) returns (r0: bool, r1: int) {
		var v0 := new C2();
		...
		var v8 := new C1();
		r0 := f16;
		var v9: seq<string> := [v4, seq(0x33c, i0  => (p0))];
...
class C4 {
	...
	function fm7(p0: string, p1: bool, p2: bool, p3: map<bool, bool>, globalState: GlobalState): seq<int> {
		[DC0(-f14).cf0] + ([|(map v0 : int | v0 in {f14} :: (v0 % -0x3be) := (false))|, 0x340, f14] + [f14])
	}
	function fm8(p0: int, p1: bool, p2: bool, globalState: GlobalState): bool {
		("axmcm" <= "elfoqgqbn") <== ({f14} !! {f14, |(map v0 : int | v0 in {f14} :: (v0 / f14) := (true))|, -f14, |multiset{f14}|})
	}
	method m5(p0: seq<char>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (if (!({f14} !! {-v4, v4, |v5|, f14})) then v0 else v0) {
				...
				v14, v15, v16[347] := v14, v15, v13.fm14(v17, v0, p0, globalState);
			} else {
				var v18: C2 := new C2();
				v18 := v18;
				...
				v19[996], v20 := v21 < v21, p0;
				var v23: multiset<int> := multiset{|(set v22 : int | (0x2d0 <= v22) && (v22 < -0x2ba) :: (v22 / f14))|};
				v23 := v23;
				var v24: seq<string> := [v20];
				globalState.f13 := !(v24 == v24);
				var v25: map<seq<bool>, array<bool>> := map[[v19[996], v19[996], v19[996]] := v19];
		...
		for i3 := |fm32(true, v0, p0, v0, globalState)| to f14 {
			...
			if (v32[0x2f8]) {
				...
				var v49 := new C0(v48[v39], false);
			}
			
			var v50: array<array<int>> := new array<int>[5];
			var v51: array<int> := new int[16];
			v50[135] := v51;
			var v53: map<int, int> := map[|(set v52 : int | v52 in map[f14 := p0] :: (v52 / 275))| := 332];
			var v54: multiset<int> := multiset{i3, f14, |v53|, i3};
			v50[135] := if (multiset{i3} >= v54) then v51 else v51;
			v53 := v53[f14 - f14 := i3 % f14];
			var v55 := 0x3d1;
			var v56 := 'x';
			v55 := |p0[0x386 + i3 := v56]|;
		}
		...
		globalState.f13, v58, v59, globalState.f13, v60 := !(-758 == fm11(!v0, globalState)), (v58 * multiset{v57}) - v58, fm27(f14, v60, |v61| % |v61|, globalState), v0, |v62| * f14;
		var v63 := DC1(v0, seq(0xd2, i5  => (seq(0x68, i6  => (v57)))), p0);
		var v64: multiset<D0> := multiset{v63, v63, DC1(v0, seq(0x43, i7  => (p0)), p0)};
		var v65 := DC6(v64);
		match (v65.(cf10 := v64 + v64)) {
			case DC7(cf11, cf12, cf13, cf14) =>
				var v66: seq<D0> := [v63];
				var v67 := new C0(v64 + (multiset(v66))[v63 := fm11(cf11, globalState)], cf11);
				v60 := f14;
				var v68: map<int, int> := map[cf13 := -v60 / -627];
				v68 := v68[v60 := v60];
				var v69 := DC7(v0, cf12, v60, v0);
				var v70 := DC2(!v67.f19);
				var v71 := DC3(DC3(v70));
				var v72: seq<seq<int>> := [fm7(p0, cf14, cf11, map[cf14 := cf11], globalState)];
				var v73: array<int> := new int[20] [|fm10(cf14, cf13, v0, v67.f19, globalState)|, v60, v60, v60, -(if (cf14) then cf13 else v60), cf13, cf13 * |v61|, fm22(v69, v71, false, globalState), |(p0 + (seq(0x195, i8  => (v57))))|, f14 % cf13, |v72|, |"sxb"| - |map[|v59| := v67.f19]|, v60, v60 - f14, v60, 884, |v68|, 0x3b1, cf13 / v60, f14];
				v73[368] := f14;
				var v74 := DC4(map[cf14 := v73]);
				var v75: map<bool, array<int>> := map[cf14 := v73];
				var v76 := DC15(multiset{cf11, v67.f19});
				var v77 := DC12(|v76.cf23|);
				v73[368], globalState.f13, v74, v60 := (v60 - 0x2a) / (v60 * f14), true, DC4(v75), -v77.cf18;
			case DC6(cf10) =>
				...
				var v82: array<int> := new int[23](i9 => i9 % |p0|);
				v82[217] := f14;
				v78[34], v81, globalState.f13, v82[217], globalState.f13 := v0, v81 - v81, (seq(661, i10  => (f14))) <= v61, f14, !v0;
				globalState.f5 := v78[34];
				var v83 := "umgbbbrln";
				v83 := p0 + v83;
				var v84 := DC16(f14);
			...
			case DC8(cf15) =>
				...
				var v90: map<array<bool>, bool> := map[v86 := v59[f14]];
				var v91: multiset<int> := multiset{v60};
				var v92: multiset<int> := multiset{|v91|};
				v61, v85[451], v87[615], v89, v86 := if (v0) then (v61 + v61)[0x8a := f14] else v61, v90 + v90, (fm33(v0, v0, v59[|map[f14 := p0]|], globalState) - v88) + (v88 + {false}), multiset(v59), if (v92 >= v91[v60 := v60]) then v86 else v86;
				v86[250] := v0;
				v86[250] := v0;
		}
...
class C5 extends T1 {
	...
	function fm0(p0: int, p1: char, globalState: GlobalState): int {
		(|(set v0 : int | (947 <= v0) && (v0 < 0x2e9) :: (v0 % |[false]|))| - |map[false := false]|) + 0x112
	}
	function fm1(p0: map<int, int>, globalState: GlobalState): string {
		seq(714, i0  => (if (false) then 'e' else 'c'))
	}
	function fm4(p0: int, p1: int, p2: multiset<seq<D0>>, p3: seq<bool>, globalState: GlobalState): seq<int> {
		([|map[825 := |{false}|]|, 0x2fc] + [-0x36b, 578]) + ([0x358] + [-0x305, |(map v0 : int | (-0xf9 <= v0) && (v0 < 0x2b6) :: (v0 * |(map v1 : int | v1 in {|multiset{0x27c}|} :: (v1 / |[true]|) := (-0x1e3))|) := (0x16d))|])
	}
	...
	method m0(p0: char, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v2 := -0x15e;
		var v3: seq<seq<bool>> := [v1, v1[v2 := v0]];
		var v4 := "dnhvpnw";
			...
			decreases 100 - i0
		{
			...
			if (v0) {
				...
				var v10: seq<int> := [v2, v2 - |(seq(0x362, i1  => (map v7 : int | v7 in multiset{-0x1c6, v2, 576, v2, v2} :: (v7 / v2) := (v2))))[-|v8| := v9]|, |v4|];
				r0, v2, v10 := v0, v2 * v2, v10;
				var v11 := 'b';
				v11 := v11;
				var v12: array<int> := new int[20](i2 => i2 % v2);
				var v13: map<array<int>, string> := map[v12 := seq(0x325, i3  => (p0))];
		...
		if (v0) {
			...
			v2 := v2 % ((if (v0 in v36) then v36[v0] else |v37|) + fm11(fm6(globalState), globalState));
			r0 := v0;
			var v38 := 'e';
			...
			v38, v39[448], v39[837], r1, v41 := v38, |("ebekj" + v5[v2])|, |v1|, -0x34 - |v42|, v41;
			r1 := v2;
			var v43 := new C2();
		}
		...
		if (v0 && v0) {
			...
			v44[138] := p0;
			v44[138] := p0;
			var v45: array<int> := new int[28](i6 => i6 / v2);
			...
			v49[637] := v50;
			v49[637] := v50;
			v2 := if (-v45[312] in v48) then v48[-v45[312]] else v2 - v2;
			r1 := v45[312];
		} else {
			globalState.f9 := if (v0) then v0 else v0;
			var v51: set<bool> := {!false, v0, v0};
			var v52: map<int, int> := map[|v51| := v2];
			v52 := v52[0x97 * 0x93 := -(v2 / v2)];
			var v53: seq<int> := [|v4|];
			var v54: multiset<seq<int>> := multiset{v53, [v2, v2, v2, v2]};
			var v55 := DC5(v0, v4, v1);
			var v56: array<string> := new string[24] [v4, v4, seq(-0x153, i7  => (p0)), v4, seq(932, i8  => (p0)), seq(-0x37f, i9  => (p0)), v4, v4, "rl", v4, seq(-0x2, i10  => (p0)), v4, fm20(|v53|, v0, v0, v2, globalState), v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4];
			var v57 := DC19(v55, v2, v0, v56);
			var v58 := DC2(false);
			var v59: seq<seq<int>> := [v53, v53, (v53[v2 := 927])[v57.cf28 := fm5(v58, globalState)], [v2], v53];
			if ((v54 * fm34(globalState)) !! multiset(v59)) {
				...
				v64[365] := if (v65) then v0 else v0;
				v64[365] := v65;
				...
				var v70: array<int> := new int[12] [if (v0) then |v4[v2 := p0]| else v2, |(v1 + [v0])|, v2 + v2, v2, v2, -v2, -v2, v2 % v2, v2, v2, v2 + v2, |v4|];
				v70[459] := v2 + v2;
				var v71: array<bool> := new bool[11];
				v71[83] := !!!v0;
				v70[459], v71[83], globalState.f9 := v2, v0, v0;
				var v72: array<seq<int>> := new seq<int>[11](i11 => v53);
				v72[705] := v53 + v53;
				var v73 := 'o';
				v72[705], v2, v4, v73 := (v53 + (if (true) then v53 else seq(0x2df, i12  => (|map[v71[83] := v2]|))))[-v2 := v70[459]], v70[459], (v4[v2 := p0] + v4) + "wje", v4[|v4|];
				v73 := p0;
			}
	...
	method m3(p0: int, p1: T1, p2: int, p3: multiset<int>, globalState: GlobalState) {
		...
		var v10: set<bool> := {v2};
		v1[89], v3, v2, v4 := !(|(seq(7, i1  => (p0)))| !in v9), --p0 * |(if (v2) then v10 else v10)|, v2, v4;
		v3 := if (p2 in p3) then p3[p2] else p0 / v3;
		globalState.f3 := v2;
		globalState.f9 := v1[89] ==> v2;
		var v11 := DC2(v2);
		var v12 := DC3(v11);
		match (v12) {
			case DC1(cf1, cf2, cf3) =>
				...
				match (v13) {
					case DC11() =>
						...
						var v18 := new C3(v1[89], if (v1[89]) then p2 else |v17|);
						v9 := fm10(v1[89], p2, cf1, p2 >= p2, globalState);
					case DC12(cf18) =>
						v9 := v9;
						var v19: array<int> := new int[13];
						v19[206] := cf18 - -0x224;
						v19[206] := -p0;
						globalState.f13 := v1[89];
						...
						v22 := v22[v20 := if (v1[89]) then v21 else v21];
					case DC10(cf17) =>
						var v23 := 'e';
						var v25: seq<set<int>> := [cf17];
						v23 := cf3[if (v1[89]) then |(map v24 : set<int> | v24 in multiset(v25) :: (v24) := (v3))| else p0];
						var v26: map<bool, int> := map[!cf1 := -0x16a];
						var v27: map<int, int> := map[p0 := p2];
						var v28: array<int> := new int[11] [p0, |v26|, -p2, 0x242, p0, p0, p2, v3, |(map[v3 := v3] + v27)|, -v3, p0 % p2];
						v28[744] := p0;
						var v29 := DC0(p2);
						v28[112] := -951 * v3;
						...
						globalState.f3, v28[744], v29, v28[112], v30 := fm19(-v3, v2, globalState), p2, DC0(-p0), if ((v31 + v31) in v32) then v32[v31 + v31] else |v27|, v30;
						var v33 := DC2(cf1);
						globalState.f9 := fm5(v33, globalState) > |cf17|;
						v28[744] := fm11(v1[89], globalState);
				}
			...
			case DC0(cf0) =>
				...
				v0[869] := v38;
				v0[869] := v38;
				globalState.f3 := v1[89];
				match (DC10((set v39 : int | (0x15 <= v39) && (v39 < -0x209) :: (v39 / v3)) * v9)) {
					case DC11() =>
						var v40: seq<int> := [-p0, p0, |v10|];
						var v41: map<bool, seq<int>> := map[v2 := v40];
						var v42 := DC16(|v40|);
						var v43 := DC0(p0);
						var v44: array<seq<int>> := new seq<int>[21] [v40, if (v2 in v41) then v41[v2] else v40, (seq(919, i2  => (-|"vcqodo"|))) + v40, v40, v40[p0 := |multiset{v2, v1[89], v2}|], v40, seq(-0x29b, i3  => (0x8)), seq(0x10c, i4  => (cf0)), v40, v40, v40, v40, v40, [v42.cf24, p2, cf0], v40, if (v2) then v40 else v40, (seq(895, i5  => (v3))) + v40, [p0, cf0, v43.cf0] + v40, v40 + v40, v40, fm30(globalState) + v40[p0 := |fm20(|"ybsadm"|, v2, v2, v3, globalState)|]];
						v44[947] := v40;
						v44[947] := [|multiset{0x223, p0}|, cf0, v3];
						var v46: multiset<char> := multiset{v38};
						var v47: seq<bool> := [!!(if (p2 in v5) then v5[p2] else v1[89]), v2];
						globalState.f9, v3, v3 := fm23(!!v2, map v45 : char | v45 in v46[v0[869] := p2] :: (v45) := (map[v1[89] := v1[89]]), v2, p2, globalState) !in v4, |v47| + v3, 0x33f;
						globalState.f13 := v2 && !v1[89];
						var v48 := DC18(v5);
						var v49: map<D7, T1> := map[v48 := p1];
						v3 := |{v48 !in v49, false}|;
					case DC12(cf18) =>
						globalState.f3 := (v4 + (seq(770, i6  => (v0[869])))) <= v4;
						v7 := DC21(v6);
						v1[89] := v1[89];
						var v50 := DC11();
						var v51: array<int> := new int[1];
						v51[573] := cf0;
						globalState.f9, v50, v51[573] := !v1[89], v50, |((seq(0x3bd, i7  => (v38))) + (v4[cf18 := 'u'] + "qwrmofy"))|;
					case DC10(cf17) =>
						...
						var v56: array<D2> := new D2[16](i8 => DC8(DC7(v2, map[v2 := v12], |v4[|v4| := v38]|, v2)));
						var v57: map<bool, array<D2>> := map[v2 <==> v1[89] := v56];
						v57 := v57[if (v2) then v2 else v2 := v56];
						var v58: array<int> := new int[18];
						var v59: map<bool, array<int>> := map[v1[89] := v58];
						v58 := if (v1[89] in v59) then v59[v1[89]] else v58;
				}
			...
			case DC3(cf5) =>
				...
				var v64 := DC1(v1[89], v62, if (p0 in v63) then v63[p0] else v4);
				...
				match (v66) {
					case DC7(cf11, cf12, cf13, cf14) =>
						...
						cf13, v2, v68[110], v68[678] := -(|(map[v1 := v2] + v69)| / (-701 / (if (v2 in v70) then v70[v2] else 0xd6))), v1[89], |v4|, v3;
						v1 := v1;
						var v71: seq<bool> := [cf11];
						var v72: seq<seq<bool>> := [v71];
						var v73 := DC7(v1[89], cf12, fm11(cf14, globalState), cf11);
						cf13 := 143 + |v72[(v73.(cf12 := cf12)).cf13]|;
						var v74 := new C1();
					case DC6(cf10) =>
						var v75 := new C1();
						...
						var v80: map<bool, bool> := map[v1[89] := v1[89]];
						v78 := v78[DC8(v76) := if ((if (v1[89] in v80) then v80[v1[89]] else v2) in v79) then v79[if (v1[89] in v80) then v80[v1[89]] else v2] else p2];
						globalState.f9 := v2;
					case DC8(cf15) =>
						...
						var v86: map<bool, bool> := map[v1[89] := v1[89]];
						var v87: map<bool, bool> := map[v2 := !(if (v1[89] in v86) then v86[v1[89]] else fm6(globalState))];
						var v88: seq<int> := [p0, -0x36e, v3, p0, |v87|];
						var v89: array<int> := new int[13] [-|v84|, v3 - -518, v3, v3, |v85|, v3, v88[p2], |"uvsvmpmou"|, p0, --0x40, p0, --(p2 % v3), p0 % p2];
						globalState.f3, v89, globalState.f5, v1[89], v3 := true, v89, v2, v60 !in ((seq(893, i10  => (v60))) + v4), p2;
						globalState.f3 := v1[89];
	...
	method m4(p0: seq<int>, p1: array<bool>, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		for i0 := |v0| to v2 {
			...
			v7[474] := |((([v1, v1, fm6(globalState)] + v8)[-v2 := v1])[v2 := v1] + v10)|;
		}
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			var v11: seq<bool> := [v1];
			var v12 := 'c';
			match (fm35((v11 + v11)[v2 := v1], v1 <== v1, (seq(703, i2  => (v0[v2])))[v2 := v12], globalState)) {
				case DC11() =>
					v0 := v0;
					var v13: multiset<seq<bool>> := multiset{v11, v11 + v11, v11};
					r2, v13, v2 := p0[v2], multiset{v11, v11, v11} - v13, --497;
					var v14: multiset<string> := multiset{v0};
					r2, v14, r1, globalState.f3, globalState.f3 := (if (fm6(globalState)) then v2 else -v2) / v2, multiset{v0}, v2, fm6(globalState), !!v1;
					...
					var v20: set<int> := {v2};
					var v21: map<char, map<int, bool>> := map[v12 := map v19 : int | v19 in v20 :: (v19 / v2) := (v1)];
					v17[240] := fm23(v1, map v18 : char | v18 in v21 :: (v18) := ((map[v1 := v1])[v1 := v1]), v1, v2, globalState);
					v17[240] := v12;
				case DC12(cf18) =>
					globalState.f3 := v1;
...
class C6 extends T1 {
	...
	method m0(p0: char, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if (if (v0) then {v1} !! v4 else v0) {
			...
			match (v14) {
				case DC7(cf11, cf12, cf13, cf14) =>
					var v15: array<string> := new seq<char>[24](i1 => (seq(229, i2  => (p0))) + DC20(v11, cf14).cf31);
					v15[990] := v11;
					var v16: map<bool, int> := map[cf11 := cf13];
					v15[990] := fm20(cf13, v0, (if (cf11 in v16) then v16[cf11] else |"prnfmcqd"|) > v1, v1, globalState);
					r1 := cf13;
					var v17: seq<seq<bool>> := [v5];
					var v18: seq<int> := [v1, |v17|, cf13, v1];
					var v19: map<int, string> := map[v1 := v11];
					cf13 := fm0(v1, p0, globalState) * v18[|(if (cf13 in v19) then v19[cf13] else "uqbs")|];
					cf14 := !(v1 != 0x3ab);
				case DC6(cf10) =>
					var v20 := new C4(0x1cb % v1, fm36(globalState));
					var v21: map<array<bool>, bool> := map[v10 := v8];
					v21 := (map[v10 := v10[425]] + v21) + v21;
					v1 := 0x3e7;
					var v22: map<bool, bool> := map[v8 := v0 !in v5];
					v22 := v22[v8 := !v0];
				case DC8(cf15) =>
					r1 := v1 % v1;
					globalState.f9 := v10[425];
			...
			globalState.f9 := !(v24 !! (multiset{v23})[v23 := |v5|]);
			if (v10[425]) {
				v1 := v1;
				...
				var v33, v34, v35 := v23.m6(seq(-864, i3  => ('h')), v11, v8, v1, globalState);
				var v36 := new C2();
				var v37: map<int, bool> := map[v34 := v10[425]];
				var v38: seq<int> := [-119, v34];
				var v39: map<bool, int> := map[v35 := v38[v34]];
				var v40: array<int> := new int[25] [v1, v1, v34, v1, v1, -|[v0, v33]|, |{seq(580, i4  => (p0)), v11, seq(0x236, i5  => (p0))}|, v34, v1, |map[v8 := p0]|, v34, v1, v1, |v11|, 0x24, v36.fm0(v1, p0, globalState), v38[|v39|], v1, v34, v1, v1, v1, v34, v1, v1];
				var v41: map<array<int>, int> := map[v40 := -v1];
				var v42 := DC22(v41);
				var v43: set<bool> := {v0, v35, v0};
				v37 := v37[v38[|v42.cf34|] := v43 > v43];
				v11 := (v2.fm1(map[0x229 := v34], globalState))[0xe9 := if (!v8) then p0 else p0];
				v33 := v10[425];
			}
			...
			match (DC18(map[v1 := true])) {
				case DC19(cf27, cf28, cf29, cf30) =>
					...
					var v53 := DC1(v47, v52[0x204 := v51], v51);
					...
					v49 := v49 + v50[if (cf29 in v57) then v57[cf29] else cf28];
					var v58: T0 := new C2();
					v58 := v58;
				case DC20(cf31, cf32) =>
					...
					var v67: seq<map<int, bool>> := [map[|v65| := cf32], map v66 : int | (0x2c9 <= v66) && (v66 < 736) :: (v66 % v1) := (cf32)];
					var v68: set<bool> := {v0};
					var v69: array<int> := new int[20] [v1, v1 - v1, |{cf32}| - |v59[v1 := v1]|, |cf31| / v1, v1, v1, v1 % v1, v1, -v1, fm22(v63, DC3(v61), cf32, globalState), v1 - v1, v1, v1, v1, 0xb7, -(v1 % |fm37(!cf32, v1, v1, if (v1 in v64) then v64[v1] else p0, globalState)|), v1, |v67| - |cf31|, |v68|, 0x156 + 138];
					v69[424] := |v59|;
					v69[424] := 0x2a2;
				...
				case DC18(cf26) =>
					...
					v71[231] := if (v0) then v4 else v4;
					v71[231] := v4;
					var v72: array<int> := new int[1](i7 => i7 / |map[v0 := v0]|);
					var v73 := "taqaliqve";
					v72[882] := -(|v73| % v1);
					v72[882] := v1;
					var v74: array<map<int, int>> := new map<int, int>[20];
					var v75: map<array<int>, int> := map[v72 := |v73|];
					var v76 := DC22(v75[v72 := v72[882]]);
					var v77: array<bool> := new bool[3] [v0, v0, v0];
					v77[695] := v0;
					var v78: set<bool> := {v0, !v0, v0, v0, v0};
					v74, globalState.f3, v72[882], v76, v77[695] := v74, !v0, fm0(v1, p0, globalState) - v1, v76.(cf34 := v75), fm33(v0, v0, v0, globalState) !! (v78 * v78);
					var v79 := DC13(v77);
					v77 := v79.cf19;
				case DC21(cf33) =>
					var v80 := "pdxrtkj";
					...
					r1 := if (fm35([true], v0, seq(0x52, i9  => (p0)), globalState) in v84) then v84[fm35([true], v0, seq(0x52, i9  => (p0)), globalState)] else 0x117 % v1;
			}
			...
			if (v0) {
				...
				v96 := if (v93.f17 != -0x2d3) then v96 + v96 else v97[v1] - {v93.f16};
			} else {
				globalState.f13 := v0;
				r1 := --v1;
				...
				r0 := (v98 + v98) == (v98 + v98);
				r1 := v1;
				v87, v87 := "jmukv", (v87[v1 := 'c'])[-v1 * v1 := p0];
			}
		...
		v105[498] := v104;
		v104[879] := v0;
		v104[879] := (if (v0) then !v0 else v0) <== v0;
		var v107 := new C3(v104[879], v1);
		var i10 := 0;
		while (v107.f16)
			decreases 100 - i10
		{
			...
			var v110: seq<D0> := [DC1(v104[879], v109, v108)];
			var v111 := DC1(v104[879], v109, v108);
			...
			match (DC8(DC6(multiset(v110))).(cf15 := DC6(v112))) {
				case DC7(cf11, cf12, cf13, cf14) =>
					...
					v104[879] := v116[v107.f17];
				case DC6(cf10) =>
					var v117 := DC27(v104[879], v107.f17, v104[879]);
					...
					v104[879] := multiset{v107.f17} >= v119;
					v108 := v108 + (v108 + v108);
					var v120: seq<C3> := [v107];
					v104[879], r1 := v120 < v120, v107.f17;
				case DC8(cf15) =>
					var v121 := DC13(v105[498]);
					var v122 := DC13(v121.cf19);
					v105[498] := v121.cf19;
					globalState.f5 := v107.f17 <= v107.f17;
					var v123: map<int, int> := map[v107.f17 := v107.f17];
					r1 := (-v1 / |fm1(v123, globalState)|) * -|v108|;
					var v124 := DC28(v105);
					v105 := v124.cf45;
			}
			
			var v125: set<bool> := {v104[879], fm19(v107.f17, v0, globalState)};
			v125 := v125;
			var v126: array<int> := new int[2];
			var v127: map<array<int>, int> := map[v126 := v107.f17];
			var v128 := DC22(v127[v126 := |(seq(129, i11  => ('k')))|]);
			v128 := v128;
		}
		...
		v131[360] := v4;
		v129[294], v131[360] := v130, v4;
		var v132: seq<bool> := [!fm6(globalState), v107.f16, if (v107.f16) then v104[879] else v0];
		r0 := v132[v107.f17];
		var v133: map<bool, seq<bool>> := map[true := v132];
		r1 := |(if (v104[879]) then map[v104[879] := v132] else v133)|;
	}
	method m2(p0: seq<bool>, p1: bool, globalState: GlobalState) returns (r0: map<int, int>, r1: multiset<int>, r2: bool, r3: array<multiset<bool>>) {
		...
		var v7: map<bool, string> := map[p1 := seq(0x2dc, i0  => ('n'))];
		v6[73] := v7 + v7;
		var v8 := 'l';
		var v9: map<seq<int>, int> := map[v5 := v4];
		var v10: map<int, int> := map[v4 := |v1|];
		var v11: map<int, int> := map[|v10| := v4];
		v4, v6[73], v8, v9, v0 := -v4, v7 + map[p1 := v0], v8, v9, fm1(v11, globalState);
		v8 := v8;
		...
		if (p1) {
			...
			v14 := v15[fm22(DC7(p1, v18, v4, p1), v17, p1, globalState)];
			...
			match (v24) {
				case DC11() =>
					...
					var v35: array<bool> := new bool[19] [p1, !(--v22.f14 <= |v29|), p1, !p1, v5[v22.f14 := |v31|] < [v4, v22.f14], v33.cf36, p1 in v34, v4 <= v4, p1, p1, true <== p1, p1, p1, !p1, !p1, !p1, p1 || p1, false, p1];
					v35[434] := p1;
					v35[434] := fm19(v22.f14, p1, globalState);
				...
				case DC12(cf18) =>
					...
					v4 := |v38|;
					v37[864] := cf18;
					v37[864] := fm22(fm29(v5[-0x2f7], cf18, "kkiqvf", cf18, globalState), DC3(DC0(cf18)), p1, globalState);
					v37[864] := fm11(p1, globalState);
					v37[864] := cf18;
				case DC10(cf17) =>
					globalState.f3 := p1;
					var v39: array<int> := new int[9](i1 => i1 + |(seq(0x13d, i2  => (|cf17|)))|);
					v39[678] := -(if (p1) then v22.f14 else v22.f14);
					v39[684] := v22.f14;
					var v40: array<bool> := new bool[3] [!p1, v8 in v0, p1];
					v40[574] := p1;
					v39[678], v39[684], v40[574], r2 := v22.f14, |((if (p1 in v7) then v7[p1] else fm1(v11, globalState)) + "wucl")| + |multiset{false}|, p1, v4 == v4;
					var v41: map<bool, bool> := map[v40[574] := p1];
					var v42: map<char, map<bool, bool>> := map[v8 := v41];
					var v43 := new C4(v22.f14, map[fm23(v40[574], v42, v40[574], v22.f14, globalState) := 0x350]);
					globalState.f13 := v40[574];
			}
		...
		r0 := if ((seq(0x43, i3  => (v8))) in v46) then v46[seq(0x43, i3  => (v8))] else fm31(globalState) + v11;
...
class C7 extends T1 {
	...
	method m0(p0: char, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v3 := DC0(664);
		var v4 := DC3(v3);
		globalState.f13 := fm2(p0, if (v2) then v4.(cf5 := v3) else v4, v0 / -v0, globalState);
		...
		match (v7) {
			case DC1(cf1, cf2, cf3) =>
				...
				v2, v9, globalState.f3, v10[335] := cf1, if (cf1) then v9 else if (cf1) then v9 else v9, v2, v2 && (|v11| < |[v0, 0x1cf, v0]|);
				if (v2) {
					v11 := (fm27(v0 - v0, v0 * v0, v0 + v0, globalState))[v0 := v10[335]];
					var v12 := 'o';
					v12 := p0;
					globalState.f3 := !v2;
					var v13 := new C5();
					...
					v0 := v0;
					r1 := v0;
					var v16: map<bool, D0> := map[v10[335] := v4];
					...
					var v24 := DC16(|(seq(-888, i1  => (p0)))|);
					globalState.f5, r1, v10[335], r1, globalState.f3 := v23 !! {fm33(cf1, cf1, v10[335], globalState), v22, v22, v22, v22}, v0 * v0, cf1, v24.cf24, v10[335];
					r1 := v0 + v0;
				}
			...
			case DC2(cf4) =>
				...
				var v28 := DC22(v27);
				var v29: seq<int> := [v0];
				v28, r1, r1 := v28.(cf34 := map[v26 := v0]), -(if (v2) then v0 else v0), |(if (cf4) then v29 else seq(0x29, i2  => (v0)))| * -v0;
			...
			case DC3(cf5) =>
				...
				match (v40) {
					case DC11() =>
						...
						v43[569] := v44.cf35;
						v43[569] := v2;
						globalState.f9, v5 := v43[569], v5;
					case DC12(cf18) =>
						var v45: set<int> := {cf18, |v36|};
						var v46: multiset<set<int>> := multiset{v45};
						cf18, globalState.f13 := if (v2) then cf18 else |(seq(600, i4  => (p0)))|, v46 !! v46;
						var v47: C1 := new C1();
						...
						globalState.f13, v47, v49, r1, r1 := !v2 || (|v50[v2 := -0x1b4]| == -v0), if (cf18 in v51) then v51[cf18] else v47, v49, cf18 + |v5|, fm0(if (v2 in v52) then v52[v2] else cf18, if (!v2) then p0 else p0, globalState);
						v2 := v2;
						v5 := "uf";
					case DC10(cf17) =>
						...
						v53[502] := v2;
						v53[37] := v2 <== fm6(globalState);
						var v57: seq<bool> := [v2, v2];
						var v58: multiset<char> := multiset{p0};
						var v59: multiset<int> := multiset{-(|v57| * |v58|), v0 - v0, v0};
						v53[502], v53[37], v59 := v2, v0 < v0, v59 - v59;
						var v60: map<bool, D0> := map[true := v4];
						var v61 := DC7(v53[502], v60, 0xe5, v2);
						var v62: array<int> := new int[4](i5 => i5 + v0);
						var v63: map<array<int>, int> := map[v62 := v0];
						v59, v0, globalState.f5, globalState.f13 := (v59 * v59)[fm22(v61, v4, v53[502], globalState) := -v0], fm22(v61, v4.(cf5 := v3), v57[v0], globalState), !(v62 in v63), fm19(v0, v2 <== v2, globalState);
						var v64 := DC24();
						v64 := v64;
				}
				...
				var v68: array<int> := new int[6] [v0 % 0x3ac, v0, fm0(v0, p0, globalState), 587 / v0, v0, v0 + |v67.cf46|];
				v68 := v68;
				var v69: seq<int> := [v0];
		...
		var v78: seq<seq<int>> := [v77[v0], v73];
		...
		var v94: multiset<int> := multiset{v79[320], |v93|};
		r0 := (multiset{v0, v79[320]})[v0 := v79[320]] >= v94;
		r1 := v79[320];
	}
	method m1(p0: bool, p1: string, globalState: GlobalState) returns (r0: set<bool>, r1: bool, r2: int, r3: bool) {
		...
		match (v1) {
			case DC16(cf24) =>
				...
				var v10: map<string, bool> := map[seq(-0x10f, i0  => (v7)) := p0];
				var v12: seq<int> := [0x259, cf24];
				var v13: map<int, int> := map[cf24 := cf24];
				var v14: map<bool, bool> := map[p0 := p0];
				var v15: set<bool> := {true};
				var v16: array<int> := new int[24] [fm22(v5, v3, p0, globalState), cf24 + -cf24, cf24 % -cf24, cf24, fm22(DC7(p0, v4, cf24, p0), v3, p0, globalState), cf24, cf24, fm11(p0, globalState), cf24, |v6|, cf24, |v9|, |([|v6|, |(set v11 : string | v11 in v10 :: (v11))|] + v12)|, cf24, |v13| * |v14|, |map[p0 := |p1|]|, cf24, |v15|, cf24, cf24, cf24 - cf24, fm22(v5, v3, p0, globalState), |v0| * cf24, cf24];
				cf24, v16 := (cf24 / cf24) * cf24, v16;
				var v17: C5 := new C5();
				var v18: map<C5, array<int>> := map[v17 := v16];
				v18 := v18[v17 := v16];
				var v19: seq<string> := [p1, p1, p1, p1];
				cf24 := 54 % |v19[if (p0 in v0) then v0[p0] else cf24]|;
				var v20 := DC24();
				v20 := v20;
			case DC15(cf23) =>
				var v21 := -864;
				...
				if (if (p0) then true else v21 == v21) {
					...
					globalState.f3, v22, globalState.f3, v21, v21 := p0, v23.cf48, p0, -(if ((if (p0) then if (v24 in v26) then v26[v24] else v24 else v24) in v25) then v25[if (p0) then if (v24 in v26) then v26[v24] else v24 else v24] else v21), v21 / v21;
					r2 := v21;
				...
				var v34 := DC3(v33);
				var v35: map<bool, D0> := map[v31[v21] := v34];
				...
				var v43: array<int> := new int[27] [v21, v21 * |(seq(819, i1  => ('m')))|, -fm22(v36, v34, p0, globalState), v21, v21, if (v37 in v38) then v38[v37] else v21, v21, v21, v21, if (cf23 in v39) then v39[cf23] else v21, v21, v21, v21, v40[v21], if (p0) then v21 else v21, 0x21e, |(p1 + "da")|, -(v21 + 471), v21, if (p0) then v21 else v21, v21, |v42| / -v21, -(v21 + v21), v21, v21 + v21, v21, v21 / -v21];
				var v44: T0 := new C2();
				var v45: array<C0> := new C0[29];
				var v46 := DC1(p0, v32, p1);
				var v47: seq<D0> := [v46];
				var v48: C0 := new C0((multiset(v47))[v46 := v21], p0);
				v45[648] := v48;
				var v49: set<bool> := {v48.f19};
				globalState.f3, v43, v44, v45[648], globalState.f5 := fm19(if (p0) then v21 else |v49|, v48.f19, globalState), DC33(v43).cf51, v44, v48, p0;
			case DC17(cf25) =>
				var v50 := 0x179;
				...
				var v57: array<int> := new int[15] [v50 - v50, v50, v50 * v50, v50, |(v51 - fm33(p0, p0, !p0, globalState))|, |v52|, -|p1|, fm11(p0, globalState), |(p1 + p1)|, v50 / v50, 0x7c * v50, |(v54 + v54)|, |(v55 + v55)|, |[v56, v56, v56, v56]|, v50];
				v57 := v57;
				r3 := p0;
				v50 := -v50;
				var v58 := "vcvnthiyb";
		...
		if (p0) {
			...
			v59[683] := false;
			var v61 := 0x14a;
			var v62: map<int, int> := map[|(seq(-713, i2  => (v61)))| := v61];
			...
			var v72: seq<seq<int>> := [seq(0x2a7, i3  => (DC12(725).cf18)), v68[v61 := 0xad], v68, if (v66[|v71|]) then v68 else v68, (seq(178, i4  => (|v62|))) + fm30(globalState)];
			var v73: T0 := new C2();
			var v74: map<T0, seq<int>> := map[v73 := v68];
			var v75: map<array<int>, int> := map[v67 := |v74|];
			var v76: multiset<int> := multiset{v61};
			r2, v59[683], r2, v67[756], v72 := v61, p0, if (v67 in v75) then v75[v67] else |v76| * 0x26f, |v65|, seq(868, i5  => (v68 + v68));
			v59[683] := !p0;
			if (!false) {
				v59[683] := v66[v61];
				v61 := 0x28d;
				...
				var v79: array<array<seq<bool>>> := new array<seq<bool>>[27] [v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v77, v78[v67[756]], v77, v77, v77, v77, v77, v77, v77];
				v79[493] := v77;
				v79[493], v59[683] := v77, if (!p0) then v0[p0 := v61] <= v0 else p0;
				r2 := v61;
			} else {
				var v80: set<bool> := {p0};
				r0 := (v80 * fm33(p0, v59[683], v59[683], globalState)) + v80;
				var v81 := DC0(|v66|);
				var v82: array<D0> := new D0[4] [v81, v81, DC0(|p1|), v81];
				var v83 := DC20(p1, fm2('u', fm28(globalState), v67[756], globalState));
				var v84: seq<string> := [p1];
				var v85: map<string, seq<string>> := map["bjx" := (seq(0x1a0, i6  => (p1))) + v84];
				var v86: set<int> := {v61, v61};
				var v87: map<string, set<int>> := map[p1 := v86];
				var v88 := DC10(if (p1 in v87) then v87[p1] else v86);
				v67[756], v82, v61, v83, r2 := |(if (p1 in v85) then v85[p1] else v84)|, v82, v61 * -v61, fm40(v61, v88, globalState), v61 + v61;
				var v89 := new C3(v61 <= v61, v67[756]);
				var v90: set<D7> := {v83};
				var v91: seq<D7> := [DC20(seq(965, i7  => ('g')), p0)];
				v59[683] := if (v59[683]) then v90 !! (set v92 : D7 | v92 in v91 :: (v92)) else p0;
				var v93: array<array<int>> := new array<int>[11];
				v93 := v93;
			}
			
			var v94 := DC33(v63);
			var v95: array<array<int>> := new array<int>[11] [v67, v67, v67, if (p0) then v67 else v63, v64[--0xa8], v94.cf51, v63, v63, v63, v63, v63];
			v95[800] := v67;
			var v96 := DC13(v59);
			globalState.f13, v95[800], globalState.f9, v59[683], v59 := !p0, v67, p0, if (p0) then p0 else p0, v96.cf19;
		} else {
		...
		if (p0) {
			...
			globalState.f5, v109[105] := (fm41(p0, true, globalState)).cf39, fm23({p0, p0} > v110, v108, v111.cf32, v105, globalState);
		} else {
			var v112 := 0x243;
			r2 := v112;
			if (p0) {
				...
				v115[694] := p0 !in v116;
				v115[694], r2, r2 := p0, v112, |p1| / v112;
				var v117: array<C2> := new C2[18];
				var v118: C2 := new C2();
				v117[697] := v118;
				v117[697] := v118;
				var v119: map<bool, array<int>> := map[!v115[694] := v113];
				var v120: set<int> := {v112 - v112, 38, |v119|};
				v120 := v120;
				globalState.f9 := v115[694];
			} else {
				var v121 := 'x';
				...
				var v126: array<int> := new int[17] [v123.f14, |(fm1(v124, globalState))[v112 := v121]|, v123.f14, v123.f14, |v125[v121 := v123.f14]|, v123.f14, v112, v112, v123.f14, v123.f14, -0x162, v123.f14, |(seq(0x94, i9  => (v123.f14)))|, v112, |p1|, v112, v123.f14];
				var v127: seq<array<int>> := [v126];
				var v128: set<bool> := {!p0};
				var v129: map<multiset<bool>, bool> := map[multiset{p0, true} := v128 !! v128];
				r2, globalState.f9, v127 := v123.f14 % v123.f14, if (v0 in v129) then v129[v0] else p0, v127;
			...
			var v136: multiset<map<bool, bool>> := multiset{v134, v135[v112]};
			v133[321] := v136;
			v133[321] := v136 + multiset{v134, v134};
			var v137 := new C1();
		...
		var v143 := DC2(!v142[v141]);
		var v144 := DC3(v143);
		v139[303] := if ((if (p0) then p0 else p0) in v140) then v140[if (p0) then p0 else p0] else fm2(p1[v141], v144, v141, globalState);
		if (210 >= (v141 / |v142[v141 := p0]|)) {
			var v145: seq<array<bool>> := [v139, v139];
			var v146: map<bool, array<bool>> := map[v139[303] := v139];
			var v147: array<array<bool>> := new array<bool>[26] [v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v145[v141], v139, v139, v139, v139, v139, v139, v139, v139, v139, if (v139[303] in v146) then v146[v139[303]] else v139, v139];
			v147[909] := v139;
			v147[909] := DC13(v139).cf19;
			var v148: seq<int> := [v141];
			var v149: seq<seq<array<bool>>> := [v145];
			var v150: array<seq<array<bool>>> := new seq<array<bool>>[24] [v145[v141 := v147[909]], v145, v145, [v147[909]], v145 + v145, v145, v145, v145, v145[-|v148| := v139], v145 + v145, v145 + v145, v145, [v147[909]] + [v147[909], v139], v145, [v147[909], v147[909], v139], v145 + v145, v149[v141] + v145, [v147[909]], v145, [v139, v139], ([v139, v139])[v141 := v139], v145, v145, [v139, v139]];
			v150[134] := v145;
			var v151: map<bool, string> := map[v139[303] := seq(791, i11  => ('y'))];
			var v152: seq<string> := [p1, p1];
			var v153 := 'e';
			var v154 := DC1(false, v152[v141 := p1[v141 := 'f']], p1[v141 := v153]);
			var v155: array<string> := new seq<char>[26] [seq(0xf9, i10  => (p1[-v141])), if (p0 in v151) then v151[p0] else "sfabqetxt", p1 + p1, p1, p1, p1, p1, p1, p1, p1 + p1, p1, p1, p1, p1, p1, p1 + "uatwgx", p1 + (v154.(cf2 := v152, cf1 := v139[303])).cf3, seq(494, i12  => (v153)), "wocuatbi", p1, p1 + p1, DC5(p0, p1, ([v139[303], false])[|(seq(0x3d8, i13  => (v153)))| := v142[v141]]).cf8, p1, p1 + p1, "jp", "scmvf"];
			v155[438] := p1;
			var v156: multiset<int> := multiset{v141};
			globalState.f9, globalState.f13, v150[134], v155[438] := multiset{v141, v141, v141, |p1|} !! v156, v139[303], v145 + v145, p1;
			var v157: set<bool> := {v139[303]};
			...
			r2 := -(v141 - v141);
			if (if (|(seq(0x21c, i14  => ('y')))| <= v141) then if (v139[303]) then v139[303] else v139[303] else v139[303]) {
				var v161: seq<string> := [p1];
				var v162 := DC1(v139[303], v161, seq(0x250, i15  => ('o')));
				...
				var v168: set<int> := {v141 / |v166|, |v167|, v141};
				var v169 := DC5(v139[303], v165, v142);
				v165, globalState.f9, v168 := v165 + v169.cf8, v139[303], v168;
				var v170: seq<int> := [v141, if (v164.f19) then v141 else v141, v141];
				v170 := [|v140|, v141, v141, |v140|];
				v141 := v141;
				var v171: T1 := new C5();
				var v172: set<T1> := {v171};
				var v173 := DC34(v141 % |v172|);
				v173 := v173;
			} else {
				var v174 := new C1();
				var v175: C6 := new C6();
				...
				var v179 := DC29((multiset{v175})[v175 := |v178[v141]|]);
				v179 := v179;
				globalState.f9 := p0;
				var v180: map<string, int> := map[seq(0x344, i16  => ('f')) := v141];
				var v181: T1 := new C3(v139[303], |v0|);
				var v182: multiset<T1> := multiset{v181};
				v180 := v180[seq(768, i17  => ('f')) := |v182|];
				var v183: array<char> := new char[26];
				var v184 := 'b';
				v183[563] := v184;
				v183[563] := p1[|v142| - v141];
			}
			
			var v185: array<char> := new char[14];
			v185[587] := 'c';
			var v186: map<char, map<bool, bool>> := map[p1[v141] := v140];
			var v187: seq<int> := [v141, v141];
			globalState.f3, v139[303], v185[587], r2, r2 := v139[303], "wkpov" == p1, fm23(p1 <= p1, v186, v139[303], v187[v141], globalState), 986, v141;
			globalState.f5 := true;
			var v188: set<multiset<bool>> := {v0, v0};
			var v189: multiset<int> := multiset{0x2f7};
			var v190: map<bool, multiset<int>> := map[v188 !! fm43(v139[303], globalState) := v189];
			var v191: map<array<bool>, seq<bool>> := map[v139 := [false, p0]];
			v190 := v190[fm2(fm23(v139[303], v186, v139[303], |v191|, globalState), DC3(v143), v141, globalState) := v189];
		}
		
		var v192: set<bool> := {fm6(globalState), v139[303]};
		r0 := v192;
		r1 := !v139[303];
		r2 := v141;
		r3 := p0;
...
method Main() {
	...
	var v13: set<bool> := {v8};
	var globalState := new GlobalState('b', v0, v1, true, v7[if (true in v9) then v9[true] else |v11|], true, -0xd1, v12 + v12, v2 + v2, true, true, v13, v2, false);
	v0 := v0;
	var v14: array<int> := new int[3];
	v14[484] := v3;
	v14[484] := v3;
	v0[454] := v14[484] != -|map[v2 := v2]|;
	var v16: seq<int> := [v14[484], v14[484]];
	var v17: seq<int> := [|(map v15 : int | v15 in v16 :: (v15 * v14[484]) := (v8))|];
	var v18: multiset<seq<int>> := multiset{v16};
	var v19: map<int, int> := map[964 := v3];
	var v20: multiset<int> := multiset{v14[484], v14[484], |v9|, if (v3 in v19) then v19[v3] else v14[484]};
	v14[484], v8, globalState.f9, v0[454], v14[484] := -v14[484] / v3, multiset{v14[484], if (v17 in v18) then v18[v17] else v3, v3, -0x128} >= (v20 + v20), v2[-|v10|] in "qahncvdqm", (0x91 + 0x1e2) < (v3 % v14[484]), v14[484];
	var v21: map<map<bool, bool>, array<int>> := map[(map[v8 := v8])[v0[454] := v0[454]] := v14];
	v14 := if (v10 in v21) then v21[v10] else v14;
	v3 := --0x3ba;
	var v22 := new C7();
	var v23: C5 := new C5();
	v8 := if (v23 !in [v23]) then v8 else v0[454];
	for i0 := v14[484] * v3 to |fm20(v14[484], v8, v8, v3, globalState)| {
	...
	var v27: map<char, int> := map['p' := |(seq(-90, i2  => (v4)))|];
	var v28 := DC25(v27);
	var v29: map<int, D9> := map[v3 := v28];
	v3, v2 := |v29|, v2;
	var v30: map<int, string> := map[v14[484] := v2];
	for i3 := v14[484] to |(if (0x120 in v30) then v30[0x120] else v2)| {
		var v31: multiset<char> := multiset{v4, v4};
		var v32 := DC35(v31);
		var v33: set<int> := {|v2|};
		var v34: seq<bool> := [fm19(|v33|, v0[454], globalState)];
		if ((v31 <= v32.cf53) ==> (v34 <= v34)) {
			globalState.f5 := v0[454];
			v3 := (85 / v14[484]) / (|v2| / v14[484]);
			var v35: set<string> := {v2};
			var v36: T0 := new C2();
			var v37 := DC12(-0x285 / |v9|);
			var v38: map<int, set<string>> := map[0x2c := v35];
			var v39: map<bool, set<string>> := map[v0[454] := v35];
			v35, v36, v37, globalState.f5 := (if (v14[484] in v38) then v38[v14[484]] else v35) * (v35 + (if (v8 in v39) then v39[v8] else v35)), v36, v37, v8;
			var v40: C1 := new C1();
			var v41: map<bool, int> := map[!v0[454] := v14[484]];
			var v42: map<int, C1> := map[v17[v14[484]] := v40];
			v40, v0[454], v34, v19, v41 := if (i3 in v42) then v42[i3] else v40, multiset{v3} < multiset{i3, v16[i3]}, v34 + v34, v19, map[if (v0[454] in v10) then v10[v0[454]] else v8 := |v2|] + (v41 + v41);
			var v43 := new C6();
		} else {
			v14[484] := (v14[484] * v3) + -(i3 / v14[484]);
			var v44: map<array<int>, bool> := map[v14 := v0[454]];
			var v45: array<multiset<D1>> := new multiset<D1>[7];
			var v46 := DC5(v0[454], v2, v34);
			var v47: multiset<D1> := multiset{DC5(v0[454], seq(0x2bc, i4  => (v4)), v34), v46};
			v45[403] := v47;
			v44, v45[403], v28 := v44, multiset{v46, v46, fm26(true, v8, globalState)}, v28;
			globalState.f5 := !v8;
			var v48: map<int, bool> := map[v14[484] := v8];
			var v49 := DC18(v48);
			v49 := v49.(cf26 := map[0x1fa := v8]);
			globalState.f13 := fm6(globalState);
		}
		
		var v50: T1 := new C3(!v0[454], i3);
		var v51: seq<multiset<int>> := [multiset{fm11(v8, globalState), |v34|}, v20];
		v23.m3(v3, v50, v50.fm0(v3, v4, globalState), v51[v14[484]], globalState);
		v0[454] := v0[454];
		v14[484] := --v3;
	}
	var v52: map<int, bool> := map[v3 := v0[454]];
	var v53 := DC18(v52);
	var v54: seq<bool> := [v0[454]];
	var v55: seq<string> := [v2, v2];
	var v56 := DC1(v8, v55, v2);
	var v57 := DC3(DC3(v56));
	v10, v3, globalState.f13, v2, v53 := v10, v14[484], v54[v3], v2, match v57 {
	...
	var v59 := DC26(v0[454], v4, v8);
	var v60: array<char> := new char[29] [v4, 'y', v4, v4, fm23(v0[454], map[v4 := v10], false, if (v8 in v58) then v58[v8] else v14[484], globalState), v4, v4, v4, v4, v4, v4, v4, v4, v4, v59.cf40, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4];
	v60[873] := v4;
	v60[873] := v4;
	var v61: T1 := new C5();
	...
	var i5 := 0;
	while ((if (v0[454]) then v63 else v63) !! v63)
		decreases 100 - i5
	{
		if (i5 >= 100) {
			break;
		...
		i5 := i5 + 1;
		v3 := --(v14[484] * |[357, v3, v3, v14[484]]|) + DC0(v14[484]).cf0;
		globalState.f13 := if (v0[454]) then v8 else v8;
		var v64: map<int, array<int>> := map[v3 := if (v0[454]) then v14 else v14];
		var v65 := DC30(false);
		var v66: map<int, D11> := map[-|(seq(465, i6  => (v60[873])))| := v65];
		var v67 := DC2(v0[454]);
		v14[484], v64, v61, v14[484], globalState.f13 := (if (v8) then |v66| else v3) / v14[484], map[v14[484] := v14], v61, v23.fm5(v67, globalState), !false;
		var v68: C1 := new C1();
		var v69: set<C1> := {v68, v68};
		globalState.f3 := (v69 * DC38({v68}).cf56) == (if (fm6(globalState)) then v69 else v69);
	}
	if (v8) {
		globalState.f13 := !fm2(if (v8) then 'd' else v4, v57, v14[484], globalState);
		var v70: set<int> := {v14[484]};
		var v71: map<bool, set<int>> := map[!(v0[454] <==> true) := v70 + v70];
		var v72 := DC10(v70);
		v71 := v71[v0[454] := v72.cf17];
		globalState.f13 := v8;
		...
		v73, globalState.f9, v74[958], globalState.f13, v76 := (v73 + v73) + (if (false) then v73[v14 := v2] else v73), false, v75, (v8 in v54) in (v54 + v54), (v76 + v76) + v76;
		v23.m3(v3 + v3, v61, v14[484], fm16(globalState) - v20, globalState);
	} else {
		v54 := [v0[454]];
		var v77: map<int, T1> := map[v14[484] := v61];
		var v78: C2 := new C2();
		var v79: map<int, C2> := map[v14[484] := v78];
		v23.m3(v14[484] % v3, if (v3 in v77) then v77[v3] else v61, |multiset{v79}|, multiset{|map[v14[484] := |v52|]|, v14[484], |v2|, v14[484]}, globalState);
		var v81: seq<map<int, bool>> := [map[v3 := true], v52, map v80 : int | (-0x14b <= v80) && (v80 < -333) :: (v80 % v14[484]) := (v0[454]), v52, map[v16[v14[484]] := v0[454]]];
		...
		var v85: array<multiset<map<bool, bool>>> := new multiset<map<bool, bool>>[16] [v11[map[v0[454] := v0[454]] := |v52[v14[484] := v8]|], v11, multiset{v10}, v11, fm44(v14[484], v3, v8, globalState), v11 - v11, v11, v11, v11, multiset(v84[--v14[484]]), multiset{map[v0[454] := false], v10, v10, v10}, if (v0[454]) then v11 else v11, v11, v11, v11[v10 := v3], v11];
		v85[542] := v11 + v11;
		v3, v85[542], v0[454], globalState.f9 := (if (v0[454]) then v3 else v3) % v3, multiset{map[v0[454] := v8]}, !v0[454], v8;
		v3 := v3;
	}
