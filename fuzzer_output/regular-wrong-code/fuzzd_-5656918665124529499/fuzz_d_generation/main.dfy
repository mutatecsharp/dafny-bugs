...
class C0 extends T0 {
	...
	function fm11(p0: bool, p1: int, p2: int, globalState: GlobalState): map<int, D1> {
		map[safeDivisionInt(f18, f18) := DC2(f12, false, f17, 'f', 'x')]
	}
	function fm12(globalState: GlobalState): int {
		safeDivisionInt(f18, 0x123)
	}
}
...
class C1 extends T0 {
	...
	method m6(globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			if ((if (f12) then f16 else |map[f12 := f12]|) == safeDivisionInt(f16, f16)) {
				var v0 := DC4(0x2b);
				globalState.f9 := safeModuloInt(v0.cf8, f16);
				var v1: array<int> := new int[27](i1 => i1 + f16);
				var v2: seq<array<int>> := [v1];
				var v3: map<bool, int> := map[f12 := |(v2 + v2)[safeIndex(f16, |(v2 + v2)|) := v2[safeIndex(f16, |v2|)]]|];
				v3 := v3 + v3;
				v1[safeIndex(524, v1.Length)] := -f16;
				v1[safeIndex(524, v1.Length)] := 0x114;
				var v4: array<bool> := new bool[3];
				v4 := v4;
				var v5: array<array<bool>> := new array<bool>[27];
				v5[safeIndex(596, v5.Length)] := v4;
				v4[safeIndex(240, v4.Length)] := false;
				var v6: array<string> := new string[22];
				var v7 := 't';
				var v8 := DC2(f12, f12, true, v7, v7);
				v6[safeIndex(789, v6.Length)] := fm9(v1[safeIndex(524, v1.Length)], v8.cf3, globalState);
				var v9 := "xcdmomb";
				var v10: multiset<string> := multiset{seq(abs(0xf8), i2  => (v7)), "cqudam", v9};
				var v11: map<bool, bool> := map[f12 := f12];
				var v12: seq<int> := [|v11|, v1[safeIndex(524, v1.Length)], |v9|, v1[safeIndex(524, v1.Length)]];
				var v13: seq<string> := [v9];
				var v14: multiset<int> := multiset{f16};
				var v15: map<int, int> := map[v1[safeIndex(524, v1.Length)] := f16];
				v5[safeIndex(596, v5.Length)], f12, v4[safeIndex(240, v4.Length)], v6[safeIndex(789, v6.Length)] := v4, (v10 - v10) > v10, [|v11|] == v12, v9 + v13[safeIndex(fm1(fm2(v14, f16, map[f12 := -0x2fa], f12, globalState), v1[safeIndex(524, v1.Length)], |v15|, globalState), |v13|)];
			} else {
				var v16 := 't';
				var v17: seq<char> := [v16];
				var v18: seq<bool> := [f12, 'p' !in v17, f12, f12];
				globalState.f6 := v18[safeIndex(f16 * f16, |v18|) := true];
				var v19: multiset<int> := multiset{|v17|};
				var v20: array<int> := new int[27];
				var v21: map<seq<bool>, array<int>> := map[v18 := v20];
				globalState.f9 := if (!v18[safeIndex(f16, |v18|)]) then if (|v21| in v19) then v19[|v21|] else 0x162 else -844;
				globalState.f3 := !f12;
				globalState.f9 := f16;
			...
			v26[safeIndex(19, v26.Length)] := f12;
			var v27: map<bool, bool> := map[!f12 := v25 == v25];
			var v28: seq<seq<bool>> := [v24, v24, [f12, f12], v24, fm10(f12, f12, true, globalState)];
			var v29: multiset<int> := multiset{|v28[safeIndex(f16, |v28|)]|};
			var v30: map<bool, int> := map[f12 := f16];
			globalState.f9, v26[safeIndex(19, v26.Length)] := f16 - |"ddcprsn"|, if (f12 in v27) then v27[f12] else fm2(v29, f16, v30, f12, globalState) <== f12;
			var v31: array<array<bool>> := new array<bool>[2];
			v31[safeIndex(811, v31.Length)] := v26;
			v29, v25, v31[safeIndex(811, v31.Length)], v26 := v29, ("nvme" + v25)[safeIndex(f16 - f16, |("nvme" + v25)|) := v23], v26, v26;
			var v32: multiset<char> := multiset{v23, v23, v23};
			var v33: seq<int> := [f16, f16];
			var v34: map<multiset<char>, seq<int>> := map[v32 := v33];
			v34 := v34[v32 := v33[safeIndex(f16, |v33|) := f16]];
		}
		var v35: array<int> := new int[26];
		v35[safeIndex(829, v35.Length)] := f16;
		var v36 := "bso";
		v35[safeIndex(829, v35.Length)] := safeDivisionInt(|v36|, |(seq(abs(0x34), i3  => (DC3(DC2(f12, f12, f12, 'k', 'd')))))|);
		...
		v35[safeIndex(829, v35.Length)], v40 := f16 + (f16 * v35[safeIndex(829, v35.Length)]), v40;
		var v41: seq<bool> := [f12];
		var v42: map<int, seq<bool>> := map[f16 := v41];
		var v43: array<seq<bool>> := new seq<bool>[10] [v41, v41, v41, v41[safeIndex(v35[safeIndex(829, v35.Length)], |v41|) := f12], v41, v41, fm10(!f12, f12, v41[safeIndex(f16, |v41|)], globalState), v41, (if (fm1(f12, f16, f16, globalState) in v42) then v42[fm1(f12, f16, f16, globalState)] else v41) + v41, [f12]];
		var v44 := DC0(f12);
		var v45: set<bool> := {f12};
		var v46: seq<seq<bool>> := [v41, v41, ([f12, v44.cf0, f12])[safeIndex(|v45|, |[f12, v44.cf0, f12]|) := f12], v41, v41];
		var v47: map<int, bool> := map[v35[safeIndex(829, v35.Length)] := f12];
		v43[safeIndex(21, v43.Length)] := v46[safeIndex(|v47|, |v46|)];
		v43[safeIndex(21, v43.Length)] := v41;
		v44 := v44;
		r0 := |map[!f12 := v35[safeIndex(829, v35.Length)]]|;
	}
	method m7(p0: multiset<int>, p1: string, globalState: GlobalState) returns (r0: array<string>) {
		...
		match (v2) {
			case DC2(cf2, cf3, cf4, cf5, cf6) =>
				...
				if ((p0 - multiset{f16}) < p0) {
					...
					var v7: seq<bool> := [cf4];
					globalState.f9, globalState.f9, cf3, f11, globalState.f3 := |fm9(-0x194, cf3, globalState)|, safeDivisionInt(f16, 0x12e), cf2, multiset(v7) + (if (cf4) then f11 else multiset{cf2, cf3, cf3}), cf3;
					globalState.f9 := f16;
					var v8: seq<string> := [p1];
					var v9: set<int> := {f16};
					var v10: array<string> := new string[23] [p1, p1, v8[safeIndex(f16, |v8|)], "exlcjc", p1, p1, p1, fm9(|v9|, cf3, globalState), p1, seq(abs(527), i1  => (v1)), p1, seq(abs(0x6e), i2  => (cf6)), p1, p1, p1, ("mw")[safeIndex(|v7|, |"mw"|) := cf6], p1, p1, p1, p1, seq(abs(0x319), i3  => (v1)), seq(abs(0xe9), i4  => (cf6)), p1];
					var v11: map<char, array<string>> := map[cf5 := v10];
					var v12: map<bool, array<string>> := map[cf2 := v10];
					var v13: seq<array<string>> := [v10];
					var v14: array<array<string>> := new array<string>[19] [v10, v10, v10, if (v1 in v11) then v11[v1] else v10, if (f12) then v10 else v10, v10, v10, v10, v10, if (cf4 in v12) then v12[cf4] else v10, v10, v10, v10, v10, if (cf4) then v13[safeIndex(f16, |v13|)] else v10, v10, v10, if (cf2 in v12) then v12[cf2] else v10, v10];
					v14[safeIndex(160, v14.Length)] := v10;
					v14[safeIndex(160, v14.Length)] := v10;
				} else {
					var v15: map<bool, int> := map[f12 := f16];
					globalState.f7 := fm2(p0[f16 := abs(f16)] + p0, safeDivisionInt(0x300, -f16), v15, f16 == f16, globalState);
					v1 := v1;
					globalState.f9 := f16 - f16;
					var v16: seq<bool> := [cf4, cf2];
					var v17: map<string, seq<bool>> := map[seq(abs(0x176), i5  => (v1)) := v16 + v16];
					...
					globalState.f9, globalState.f7, f16, v20, globalState.f9 := safeDivisionInt(|(v16 + v16)|, f16), v16[safeIndex(f16 * f16, |v16|)], safeModuloInt(safeDivisionInt(-|map[false := cf4]|, |[cf2]|), f16 + f16), v20, if (cf2) then f16 else -(f16 - (if (f16 in v21) then v21[f16] else |v22|));
				}
			...
			case DC1(cf1) =>
				...
				var v29: set<int> := {f16};
				if (if (f12) then f12 else f16 < |(if (-670 in v27) then v27[-670] else map[map v28 : int | v28 in v29 :: (safeModuloInt(v28, 0x229)) := (f12) := f16])|) {
					globalState.f7 := f12;
					f12 := f12;
					f16, globalState.f3 := fm1(f12, f16, f16, globalState), false;
					globalState.f9 := safeModuloInt(fm1(f12, 0x342, if (f12 in f11) then f11[f12] else 0x351, globalState), f16 + 0x3b1);
					...
					v36[safeIndex(726, v36.Length)] := |"gdkv"| > f16;
					v36[safeIndex(726, v36.Length)] := f12;
					var v37 := DC6(v36);
					v36 := v37.cf14;
					var v38: array<multiset<int>> := new multiset<int>[9];
					v38[safeIndex(284, v38.Length)] := fm13(v1, f12, globalState);
					v38[safeIndex(284, v38.Length)] := p0 * p0;
					v36[safeIndex(726, v36.Length)] := f12;
				}
				
				var v39: map<bool, int> := map[!false := f16];
				var v40: seq<map<bool, int>> := [v39, v39];
				v40 := if (true) then ([v39])[safeIndex(|p1|, |[v39]|) := v39] + [v39] else v40;
			...
			case DC3(cf7) =>
				if (!fm0(v1, globalState)) {
					...
					var v51: array<array<int>> := new array<int>[11] [v48, v48, if (f12) then v48 else v48, (v49.(cf24 := v48)).cf24, v50[safeIndex(f16, |v50|)], v48, v48, v48, v48, v48, v48];
					var v52: map<bool, char> := map[false := v1];
					var v53: map<bool, int> := map[f12 := f16];
					v46[safeIndex(387, v46.Length)] := fm2(multiset{if (!f12 in f11) then f11[!f12] else |v52|}, f16, v53, f12, globalState) && f12;
					v47, v51, v46[safeIndex(387, v46.Length)] := v47[safeIndex(f16, |v47|) := fm14(v2, f16, globalState)], v51, v47[safeIndex(f16, |v47|) := 'c'] < (v47[safeIndex(f16, |v47|) := v1] + p1);
				} else {
					var v54: map<int, bool> := map[f16 := f12];
					v1 := if (v54 == v54) then v1 else v1;
					var v55: array<string> := new string[1](i8 => "nol");
					v55[safeIndex(481, v55.Length)] := p1;
					v55[safeIndex(481, v55.Length)] := p1;
					globalState.f9 := f16 * f16;
					var v56: seq<int> := [f16, 0x116];
					var v57 := DC12(v56);
					v56 := v57.cf29[safeIndex(if (f12) then |multiset{f12, f12}| else -|v55[safeIndex(481, v55.Length)]|, |v57.cf29|) := f16];
					var v58: seq<bool> := [f12, f12];
					globalState.f9 := safeDivisionInt(f16, f16 - |v58|);
				}
				...
				match (v0) {
					case DC0(cf0) =>
						...
						var v71: array<char> := new char[25] [v1, v1, v1, v1, v1, v1, fm14(v2, f16, globalState), v1, v1, v1, v1, v1, v1, v1, v1, fm14(fm15(f16, f16, f12, globalState), 651, globalState), 'o', v1, v1, 'p', v1, v1, v1, v61[safeIndex(f16, |v61|)], v1];
						...
						var v77: C0 := new C0(cf0, |v76|, f11, v66[safeIndex(if (|f11| in p0) then p0[|f11|] else f16, |v66|)]);
						...
						v79[safeIndex(765, v79.Length)] := v77.fm2(p0, f16, v80, v77.f17, globalState);
						var v81: map<string, bool> := map[p1 := v77.f17];
						v60[safeIndex(693, v60.Length)], v61, v62[safeIndex(188, v62.Length)], v79, v79[safeIndex(765, v79.Length)] := f16, v61, v64, v79, !(if (p1 in v81) then v81[p1] else cf0);
						v60[safeIndex(693, v60.Length)] := -0x12;
						v59[safeIndex(736, v59.Length)] := p1;
						v59[safeIndex(736, v59.Length)] := fm9(v60[safeIndex(693, v60.Length)], -v60[safeIndex(693, v60.Length)] >= (if (v77.f17 in v80) then v80[v77.f17] else f16), globalState);
						v2 := v2;
				}
				
				var v82: array<char> := new char[11];
				v82[safeIndex(113, v82.Length)] := v1;
				v82[safeIndex(113, v82.Length)] := if (f12) then v1 else v1;
		}
		
		for i9 := f16 to f16 {
			var v83: map<int, bool> := map[|(seq(abs(434), i10  => (f16)))| := f12];
			...
			v86[safeIndex(225, v86.Length)] := v89 + v89;
			var v90: array<bool> := new bool[2];
			var v91: seq<array<bool>> := [v90, v90];
			v86[safeIndex(225, v86.Length)] := if (v91 == v91) then if (f12) then v89 else v89 else v89 + v89;
			f12 := v85.f17 && (v85.f17 && f12);
			var v92: map<int, seq<int>> := map[v85.f18 := seq(abs(0x42), i11  => (v85.f18))];
		...
		v95[safeIndex(617, v95.Length)] := f12;
		v95[safeIndex(617, v95.Length)] := (f11 + multiset{f12, true}) > f11;
		...
		var v98 := DC13(f16, v95[safeIndex(617, v95.Length)], f16, v97, v95[safeIndex(617, v95.Length)]);
		var v99: seq<bool> := [v95[safeIndex(617, v95.Length)], v95[safeIndex(617, v95.Length)], f12, false];
		var v100: array<multiset<int>> := new multiset<int>[3] [p0, p0, (p0[v98.cf32 := abs(-f16)])[|v99[safeIndex(0x8e, |v99|) := v95[safeIndex(617, v95.Length)]]| := abs(f16)]];
		v100[safeIndex(505, v100.Length)] := p0 - p0;
		v100[safeIndex(505, v100.Length)] := p0 * p0;
		if (v95[safeIndex(617, v95.Length)]) {
			f12 := safeDivisionInt(|multiset{v95[safeIndex(617, v95.Length)]}|, f16) <= f16;
			globalState.f9 := f16;
			...
			match (v101) {
				case DC7(cf15, cf16, cf17) =>
					globalState.f7 := true;
					cf15, globalState.f9, cf17, globalState.f9 := -safeDivisionInt(|"eokqyem"|, cf16), safeModuloInt(cf16 + cf15, f16), cf17, -cf17.f18;
					...
					var v106: set<bool> := {f12, v95[safeIndex(617, v95.Length)], !f12, fm16(|v104|, globalState) != v105};
					var v107: seq<int> := [cf15, |v100[safeIndex(505, v100.Length)]|];
					v95[safeIndex(617, v95.Length)], cf16, v106, globalState.f8 := (set v108 : int | v108 in v107[safeIndex(f16, |v107|) := cf15] :: (v108 - 0x3e0)) > (v103 - v103), |v102|, v106 * {cf17.f17}, {f12} >= v104;
				case DC8(cf18, cf19) =>
					v97[safeIndex(474, v97.Length)] := p1;
					v97[safeIndex(474, v97.Length)], globalState.f6, globalState.f7, globalState.f3, v95 := p1, (if (!!false) then [v95[safeIndex(617, v95.Length)], f12] else v99) + v99, !fm0(v1, globalState), f12, (v101.(cf14 := v95)).cf14;
					var v109: T0 := new C0(false, f16, f11, v99[safeIndex(cf19, |v99|)]);
					var v110: map<int, T0> := map[cf19 := v109];
					var v111: map<bool, int> := map[v95[safeIndex(617, v95.Length)] := f16];
					globalState.f7 := fm2(fm13(v1, v95[safeIndex(617, v95.Length)], globalState), safeModuloInt(|v110|, cf18), v111 + v111, v95[safeIndex(617, v95.Length)], globalState);
					var v112: seq<int> := [cf18, cf18];
					var v113: array<int> := new int[25];
					var v114: map<multiset<int>, array<int>> := map[multiset((if (f12) then v112 else v112)[safeIndex(f16, |(if (f12) then v112 else v112)|) := f16]) := v113];
					v114 := v114[p0 - v100[safeIndex(505, v100.Length)] := v113];
					var v115: C0 := new C0(v95[safeIndex(617, v95.Length)], f16, v109.f11 + f11, v95[safeIndex(617, v95.Length)] || v95[safeIndex(617, v95.Length)]);
					v115 := v115;
				case DC9(cf20, cf21, cf22, cf23) =>
					var v116: array<int> := new int[16];
					v116[safeIndex(12, v116.Length)] := f16;
					var v117: map<string, bool> := map[p1 := f12];
					v116[safeIndex(12, v116.Length)] := safeModuloInt(|v117|, cf22.f18);
					var v118 := DC2(f12, v95[safeIndex(617, v95.Length)], f12, v1, v1);
					var v119 := DC3(v118);
					var v120 := DC3(v119);
					var v121 := DC3(v118);
					...
					v124 := v124[v95[safeIndex(617, v95.Length)] := v95];
				case DC6(cf14) =>
					var v125: set<int> := {f16};
					var v126: map<bool, int> := map[f12 := f16];
					var v127: set<bool> := {f12, v95[safeIndex(617, v95.Length)]};
					var v128 := DC4(f16);
					var v129: array<int> := new int[6] [f16, f16, -|map[DC5(|v99|, f16, f16, f16, v99).cf9 := f12]|, |(v125 - {-f16})|, -623 - |v126[!f12 := fm1(!v95[safeIndex(617, v95.Length)], |v127|, f16, globalState)]|, fm1(f12, v128.cf8, 0x31d, globalState)];
					v129[safeIndex(273, v129.Length)] := f16;
					var v130: map<char, bool> := map['o' := v95[safeIndex(617, v95.Length)]];
					var v131: multiset<char> := multiset{v1, v2.cf5, v1, p1[safeIndex(f16, |p1|)]};
					var v132: seq<int> := [f16, |(v130 + v130)|, safeModuloInt(|v99[safeIndex(0x29f, |v99|) := v95[safeIndex(617, v95.Length)]]|, f16), f16, |(v131 - v131)|];
					v129[safeIndex(273, v129.Length)] := v132[safeIndex(f16, |v132|)];
					var v133 := new C0(f12, f16, multiset{v95[safeIndex(617, v95.Length)], f12} + f11, f16 == f16);
					v129[safeIndex(273, v129.Length)] := f16;
					v129[safeIndex(273, v129.Length)] := v129[safeIndex(273, v129.Length)];
			}
			
			var v135: set<int> := {f16};
			var v136 := new C0(false, f16, multiset(([v95[safeIndex(617, v95.Length)]])[safeIndex(f16, |[v95[safeIndex(617, v95.Length)]]|) := f12]), (set v134 : int | (447 <= v134) && (v134 < 0x26f) :: (safeModuloInt(v134, f16))) > v135);
		} else {
			globalState.f9 := f16;
			var v137: map<bool, int> := map[!v95[safeIndex(617, v95.Length)] := f16];
			globalState.f3 := safeModuloInt(-201, if (v95[safeIndex(617, v95.Length)] in v137) then v137[v95[safeIndex(617, v95.Length)]] else f16) != |(seq(abs(0x25e), i14  => (-f16)))|;
			if ((f16 == fm1(f12, f16, f16, globalState)) !in map[f12 := f16]) {
				var v138: set<bool> := {f12, f12};
				var v139: C0 := new C0(f12, |map[f16 := |v138|]|, f11[f12 := abs(|p1|)], f12);
				var v140 := DC9(f16, |fm18(f16, f12, globalState)|, v139, v139.f18);
				var v141: map<int, int> := map[f16 := safeDivisionInt(f16, |map[v140 := v139.f17]|)];
				v141 := (v141 + v141) + v141;
				v95[safeIndex(617, v95.Length)] := true;
				var v142: array<int> := new int[10](i15 => i15 * 263);
				v142[safeIndex(122, v142.Length)] := f16;
				var v143 := DC6(v95);
				v142[safeIndex(712, v142.Length)] := f16;
				v1, v142[safeIndex(122, v142.Length)], v143, v142[safeIndex(712, v142.Length)] := v1, -safeDivisionInt(f16, f16 + |f11|), v143, f16;
				globalState.f3 := v95[safeIndex(617, v95.Length)];
				v95[safeIndex(617, v95.Length)], v100[safeIndex(505, v100.Length)], globalState.f7, f12 := f12, p0, v139.fm2(fm13(v1, false, globalState), -f16, v137, v95[safeIndex(617, v95.Length)] <== f12, globalState), v139.f17;
			} else {
				var v144: array<D3> := new D3[24];
				var v145 := DC6(v95);
				v144[safeIndex(190, v144.Length)] := v145.(cf14 := v95).(cf14 := v95);
				v144[safeIndex(190, v144.Length)] := v145;
				var v146 := new C0(f12, |v100[safeIndex(505, v100.Length)]|, f11 * f11, !(v95[safeIndex(617, v95.Length)] ==> v95[safeIndex(617, v95.Length)]));
				var v147: T0 := new C0(if (v95[safeIndex(617, v95.Length)]) then v95[safeIndex(617, v95.Length)] else f12, v146.f18 * f16, f11[f12 := abs(v146.f18)], f12);
				v147 := v147;
				var v148 := new C0(v95[safeIndex(617, v95.Length)], v146.f18, v147.f11 + v147.f11, f12);
				var v149 := "ggsc";
				v149 := p1;
			}
			...
			var v153: array<array<bool>> := new array<bool>[10] [v95, v95, v95, v95, v150[safeIndex(|v152|, |v150|)], v95, v95, v150[safeIndex(f16, |v150|)], v95, v95];
			v153[safeIndex(807, v153.Length)] := v95;
			v153[safeIndex(807, v153.Length)] := v95;
			globalState.f3 := v95[safeIndex(617, v95.Length)];
		}
...
class C2 extends T0 {
	...
	method m4(p0: int, p1: bool, p2: D1, globalState: GlobalState) returns (r0: bool, r1: string, r2: int, r3: bool) {
		if (|[p0]| == p0) {
			if (p1) {
				...
				var v1 := "nbffrd";
				globalState.f7 := ((seq(abs(0x5), i0  => ('j'))) + v1) <= "xycvusgt";
				...
				v8[safeIndex(166, v8.Length)] := (seq(abs(0x17), i1  => ('u'))) != (seq(abs(924), i2  => ('h')));
				v8[safeIndex(166, v8.Length)] := f12;
				var v9: array<int> := new int[4];
				v9[safeIndex(459, v9.Length)] := fm1(f15, p0, p0, globalState);
				var v10: map<int, bool> := map[p0 := f12];
				v9[safeIndex(459, v9.Length)] := safeModuloInt(p0, p0) - |v10|;
				m0(globalState);
			...
			var v14: seq<int> := [p0];
			var v16 := new C0(f12, p0, f11, {|v14|} != (set v15 : int | (0x117 <= v15) && (v15 < 0x12b) :: (safeModuloInt(v15, p0))));
			...
			v19[safeIndex(21, v19.Length)] := if (!!true in v21) then v21[!!true] else v16.f17;
			v19[safeIndex(21, v19.Length)] := f15;
			globalState.f3 := p0 == safeDivisionInt(p0, p0);
			v17 := v17[v19[safeIndex(21, v19.Length)] := v16.f18];
		}
			...
			decreases 100 - i3
		{
			...
			var v28: map<seq<int>, int> := map[v22[safeIndex(-0x2e4, |v22|) := p0] := 0x3ba];
			var v30: multiset<seq<int>> := multiset{v22};
			var v31: seq<map<seq<int>, int>> := [v28];
			v28 := (v28 + (map v29 : seq<int> | v29 in v30 :: (v29) := (p0))) + v31[safeIndex(p0, |v31|)];
		}
		f15 := f15;
		var v32: seq<bool> := [f12];
		var v33: seq<int> := [fm1(p1, p0, p0, globalState), p0, p0];
		var v34: map<int, int> := map[|f11| * (if (v32[safeIndex(|v33|, |v32|)] in f11) then f11[v32[safeIndex(|v33|, |v32|)]] else p0) := p0];
		var v35 := "hptlhvxc";
		var v36 := 'c';
		v34 := v34[if (f12) then |v35[safeIndex(-p0, |v35|) := v36]| else p0 := |v35|];
		...
		r1 := seq(abs(0x370), i6  => (v36));
		r2 := safeModuloInt(p0, fm1(p1, if (f15 in f11) then f11[f15] else -0x37, |v40|, globalState));
		r3 := !f12;
	}
	method m5(p0: int, p1: string, globalState: GlobalState) returns (r0: D0, r1: int) {
		...
		if (if (f15 in v7) then v7[f15] else f15) {
			...
			var v9: seq<string> := [p1, ((seq(abs(591), i1  => ('h')))[safeIndex(if (f15 in v8) then v8[f15] else p0, |(seq(abs(591), i1  => ('h')))|) := v0])[safeIndex(p0, |(seq(abs(591), i1  => ('h')))[safeIndex(if (f15 in v8) then v8[f15] else p0, |(seq(abs(591), i1  => ('h')))|) := v0]|) := v0]];
			var v10: seq<int> := [-|p1|, |v9| - p0, if (f15) then p0 else p0, p0, p0];
			var v11: C0 := new C0(f12, p0, f11, f15);
			globalState.f9 := v10[safeIndex(|[v11, v11]|, |v10|)];
			var v12: seq<seq<int>> := [v10 + v10, v10];
			v10 := v12[safeIndex(v11.f18, |v12|)];
			var v13: set<char> := {v0};
			var v14: map<D5, bool> := map[DC14() := !false];
			var v15 := DC17(v14);
			var v16: array<int> := new int[26] [p0, p0, v11.f18, p0, 0x12c * v11.f18, 0x277 - v11.f18, p0 + p0, p0, p0, v11.f18 + p0, |v4|, 0x0, safeModuloInt(|v13|, p0), -|v15.cf39|, p0, p0, fm1(f12, v11.f18, v11.f18, globalState), v11.f18, if (f12 in f11) then f11[f12] else v11.f18, v11.f18, v11.f18, |p1|, -v11.f18 * v11.f18, v11.f18 + |f11|, v11.f18, v11.f18];
			v16[safeIndex(371, v16.Length)] := v10[safeIndex(p0, |v10|)];
			v16[safeIndex(371, v16.Length)] := -(p0 + 0x27b);
		} else {
			var v17: array<seq<int>> := new seq<int>[17];
			v17[safeIndex(387, v17.Length)] := fm8(f15, f12, globalState);
			var v18: seq<int> := [p0];
			var v19 := DC12(v18);
			v17[safeIndex(387, v17.Length)] := DC12(v18).cf29 + v19.cf29;
			var v20: array<int> := new int[25](i2 => safeModuloInt(i2, p0));
			var v21: map<bool, array<int>> := map[f15 := v20];
			var v22: seq<array<int>> := [if (f15 in v21) then v21[f15] else v20];
			v3[safeIndex(260, v3.Length)] := f12;
			var v23 := "muarlkhi";
			v22, v3[safeIndex(260, v3.Length)], v23 := (v22 + v22) + v22, v7 == v7, p1;
			var v24: map<int, string> := map[p0 := v23];
			var v25: multiset<int> := multiset{p0};
			globalState.f3, globalState.f9, v24 := p1 <= (seq(abs(370), i3  => ('a'))), safeDivisionInt(safeModuloInt(if (p0 in v25) then v25[p0] else p0, p0), safeDivisionInt(---p0, |p1|)), v24[|(seq(abs(108), i4  => ('f')))| := p1] + v24;
			var v26: map<int, int> := map[p0 := v18[safeIndex(p0, |v18|)]];
			...
			var v30 := DC15(v25);
			var v31: set<int> := {|v28|};
			var v32 := DC11(fm2(if (v30 in v29) then v29[v30] else v25, p0, v28, v3[safeIndex(260, v3.Length)], globalState), p0, p0, fm1(v3[safeIndex(260, v3.Length)], -|v31|, |v7|, globalState));
		...
		var v36 := new C1(|p1|, v34.cf45[v35[safeIndex(-0x359, |v35|)] := abs(-462)], f12);
...
class C3 extends T0 {
	...
	method m2(p0: string, p1: bool, p2: array<string>, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (f14) {
			...
			v0[safeIndex(206, v0.Length)] := v3[safeIndex(f13, |v3|)];
			v0[safeIndex(206, v0.Length)] := multiset(p0 + (p0 + (([v1, v1])[safeIndex(f13, |[v1, v1]|) := v1])[safeIndex(f13, |([v1, v1])[safeIndex(f13, |[v1, v1]|) := v1]|) := 'i']));
			if (p1) {
				var v4: set<int> := {f13, f13};
				var v5: array<bool> := new bool[5] [f12, f13 != f13, v4 !! v4, f14, p1];
				v5[safeIndex(1, v5.Length)] := p1 <==> f14;
				var v6: seq<array<bool>> := [v5, v5, v5];
				var v7: map<seq<array<bool>>, bool> := map[v6 := f12];
				v5[safeIndex(1, v5.Length)] := if (v6 in v7) then v7[v6] else if (p1) then false else p1;
				var v8: array<int> := new int[15];
				v8[safeIndex(557, v8.Length)] := f13;
				v8[safeIndex(557, v8.Length)] := f13;
				var v9: map<int, seq<char>> := map[|[v8, v8, v8]| := p0];
				v9 := v9[v8[safeIndex(557, v8.Length)] * f13 := p0];
				var v10 := DC2(true, f14, v5[safeIndex(1, v5.Length)], v1, 't');
				var v11 := DC3(v10);
			...
			if (!f14) {
				...
				v20[safeIndex(265, v20.Length)] := f13;
				var v21: set<int> := {f13, f13, 0x0};
				var v23 := DC18(f13, seq(abs(0x313), i0  => (v1)), f12, f14, set v22 : int | v22 in v21 :: (v22 + |multiset{false}|));
				r0, v19, v20[safeIndex(265, v20.Length)], globalState.f7 := if (p1) then 43 else f13, v23.cf41, f13 * f13, !f12;
				var v24: map<bool, bool> := map[p1 := f14];
				var v25: array<C2> := new C2[10];
				var v26: map<bool, array<C2>> := map[f11 > multiset{p1} := v25];
				var v27 := DC11(false, v20[safeIndex(265, v20.Length)], f13, f13);
				var v28: map<int, array<int>> := map[v20[safeIndex(265, v20.Length)] := v20];
				v24, v26, v27 := v24, v26, DC11(DC20(p1, f12, p1).cf48, v20[safeIndex(265, v20.Length)], v20[safeIndex(265, v20.Length)], |(if (f14) then v28 else v28)|);
				var v29: array<seq<array<D6>>> := new seq<array<D6>>[23];
				var v30: array<D6> := new D6[2];
				v29[safeIndex(684, v29.Length)] := [v30, v30, v30, v30, v30];
				v29[safeIndex(684, v29.Length)] := [v30, v30];
				var v31 := DC0(f12);
				var v32: map<bool, char> := map[v31.cf0 := v1];
				m3(f13 - |v32|, globalState);
				r0, globalState.f9, f11, v20[safeIndex(265, v20.Length)] := f13, 386, f11, v20[safeIndex(265, v20.Length)] + safeModuloInt(0x396, v27.cf28);
			} else {
				r1 := false;
				globalState.f9 := f13;
				...
				var v38: seq<T0> := [v37];
				var v39: map<bool, T0> := map[p1 := v38[safeIndex(f13, |v38|)]];
				var v40 := DC5(|v36|, |v39|, f13, f13, [v37.f12, v37.f12]);
				var v41: set<set<int>> := {v35, v35, {v40.cf12, |(seq(abs(0x2c2), i2  => (v1)))|}};
				v33[safeIndex(974, v33.Length)] := v41;
				var v42: array<bool> := new bool[10];
				v33[safeIndex(974, v33.Length)], v42, v37.f12 := v41, v42, if (p1) then p1 else f12;
				v42[safeIndex(888, v42.Length)] := v37.f12;
				v42[safeIndex(888, v42.Length)] := p1;
				var v43: multiset<D2> := multiset{v40, v40};
				var v44: seq<multiset<D2>> := [multiset{v40, v40}, v43[v40 := abs(f13)], v43];
				v44 := v44 + (seq(abs(-0x390), i3  => (v43)));
			}
			...
			v50[safeIndex(514, v50.Length)] := if (p1) then v46 else v46;
			var v51: multiset<int> := multiset{-f13};
			var v52: seq<multiset<int>> := [v51, v51];
			var v53: map<bool, int> := map[f14 := f13];
			r0, v50[safeIndex(514, v50.Length)], globalState.f3, r0 := f13, v46 + v49.cf55, !fm2(v52[safeIndex(-|v47|, |v52|)], f13, v53[false := f13], f14, globalState), safeModuloInt(safeDivisionInt(f13, f13), |f11| + f13);
			var v54: array<int> := new int[7];
			v54[safeIndex(68, v54.Length)] := f13;
			v54[safeIndex(68, v54.Length)] := f13;
		} else {
			var v55 := 'y';
			...
			var v58: seq<int> := [f13];
			v57[safeIndex(204, v57.Length)] := v58;
			v56, r1, globalState.f9, v57[safeIndex(204, v57.Length)] := multiset{v55}, f14, safeDivisionInt(-f13, f13), (v58 + v58) + v58;
			var v59: multiset<int> := multiset{f13};
			var v60 := DC2(f12, f12, f12, v55, v55);
			var v61 := DC2(p1, false, !p1, v55, fm14(v60, f13, globalState));
			var v62: array<string> := new string[23] [p0, seq(abs(0x341), i4  => (v55)), p0, p0, p0, p0, p0, p0, p0, p0, p0, p0, p0, "ppym", p0 + p0, p0, p0, p0 + p0, if (f14) then p0 else p0[safeIndex(-|v59[f13 := abs(-(if (f13 in v59) then v59[f13] else f13))]|, |p0|) := v61.cf6], p0, seq(abs(-0x21e), i5  => (v55)), "drfnfyqmg", p0];
			...
			var v72: seq<array<int>> := [v67, v67, v68[safeIndex(v57[safeIndex(204, v57.Length)][safeIndex(fm1(p1, f13, |v71|, globalState), |v57[safeIndex(204, v57.Length)]|)], |v68|)]];
			var v73 := DC24("c", f12, f13);
			globalState.f9, v62, v57[safeIndex(204, v57.Length)], globalState.f4, globalState.f7 := -0x2a4, if (v65.(cf9 := 697) in v66) then v66[v65.(cf9 := 697)] else p2, v58 + (seq(abs(-730), i6  => (f13))), v68[safeIndex(safeModuloInt(f13, f13), |v68|)], (v73.(cf58 := f13)).cf57;
			var v74: map<int, bool> := map[f13 := f12];
			v74 := v74[safeDivisionInt(f13, f13) := p1 ==> f12];
			r0 := -f13;
			var v75: C0 := new C0(f14, f13, f11[f12 := abs(f13)], f14);
			var v76 := DC9(f13, safeModuloInt(if (fm1(f12, f13, f13, globalState) in v59) then v59[fm1(f12, f13, f13, globalState)] else f13, -|v57[safeIndex(204, v57.Length)][safeIndex(|v57[safeIndex(204, v57.Length)]|, |v57[safeIndex(204, v57.Length)]|) := -0x3c8]|), v75, v75.f18);
			v76 := v76;
		}
		
		var v77: seq<bool> := [!f14, f12, p1];
		r1, globalState.f3 := f14, v77[safeIndex(|map[f13 := f13]|, |v77|)];
		var v78: map<bool, int> := map[!f12 := f13];
		var v79: multiset<map<bool, int>> := multiset{v78};
		var v80 := DC27(v78);
		var v81: seq<int> := [|v78[p1 := -f13]|, f13, f13];
		var v82: array<multiset<map<bool, int>>> := new multiset<map<bool, int>>[13] [multiset{map[f14 := |p0|], v78, map[f12 := f13]}, multiset{v78, v78}, v79 * v79, v79, v79, multiset{v80.cf63}, v79, v79, v79, v79, v79, v79[v78 := abs(|v81|)], v79 - fm19(f13, globalState)];
		v82[safeIndex(599, v82.Length)] := v79;
		v82[safeIndex(599, v82.Length)] := v79 - (v79 + v79);
		var v83: map<seq<int>, int> := map[[f13] := f13];
		if (v81 in v83) {
			var v84: map<seq<bool>, bool> := map[v77 := p1];
			v84 := v84[v77 + v77[safeIndex(|f11|, |v77|) := !p1] := f12];
			...
			v100 := v100[f12 := v98];
			f12 := ((seq(abs(0x22e), i7  => (f13))) + v81) != v81;
			var v101 := "m";
			v101 := p0;
		}
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		if (f14) {
			...
			match (v13) {
				case DC13(cf30, cf31, cf32, cf33, cf34) =>
					...
					v14 := v14;
					cf32 := safeModuloInt(v0[safeIndex(3, v0.Length)], |"klkgrol"| * cf32);
					var v15: array<bool> := new bool[8](i1 => f12);
					v15[safeIndex(803, v15.Length)] := f12;
					v15[safeIndex(803, v15.Length)] := f14;
					var v16: map<bool, array<bool>> := map[v14.f15 := v15];
					globalState.f3 := (v16 + v16) == v16;
				case DC14() =>
					globalState.f9 := fm1(f14, 0xc, |[0x56, 617, |f11|]| - v0[safeIndex(3, v0.Length)], globalState);
					var v17: seq<bool> := [f12];
					var v18: map<map<bool, bool>, int> := map[map[false := false] := p0];
					var v19 := "x";
					var v20: set<int> := {|v19|};
					var v21: C0 := new C0(f12, p0, f11 - (multiset(v17))[f14 := abs(|v17|)], {-(if (map[DC0(false).cf0 := f14] in v18) then v18[map[DC0(false).cf0 := f14]] else -0x274), v0[safeIndex(3, v0.Length)]} <= v20);
					v21 := new C0(f14, f13, multiset{v21.f17}, f14);
					var v22 := DC25(v19, v21.f17, p0);
					var v23 := 'y';
					v19 := v22.cf59[safeIndex(v0[safeIndex(3, v0.Length)], |v22.cf59|) := v23];
					var v24 := DC5(p0, v0[safeIndex(3, v0.Length)], 223, p0, v17);
					globalState.f8, v23, globalState.f7, globalState.f9 := f12, v23, safeModuloInt(v21.f18, v21.fm12(globalState)) < (|v24.cf13| + f13), safeModuloInt(|v20|, |map[v23 := f12]|);
				case DC12(cf29) =>
					var v25: T0 := new C2(f14, f11, f12);
					v25 := v25;
					var v26 := 'c';
					var v27: seq<bool> := [f14];
					var v28: map<int, int> := map[|v27| := v0[safeIndex(3, v0.Length)]];
					var v29 := new C0(fm0(v26, globalState), fm1(v25.f12, f13, f13, globalState), multiset{!f14, f14, f12, f12, !f14}, !((if (f13 in v28) then v28[f13] else v0[safeIndex(3, v0.Length)]) == -0x1a8));
					...
					v32[safeIndex(186, v32.Length)] := v31.f17;
					v32[safeIndex(186, v32.Length)] := fm0(v26, globalState) ==> !v29.f17;
			}
			
			v0[safeIndex(3, v0.Length)] := safeModuloInt(-f13, v0[safeIndex(3, v0.Length)]) + f13;
			...
			match (if (f12) then DC13(|f11|, f12, |v33|, v12, v35.cf2) else v13) {
				case DC13(cf30, cf31, cf32, cf33, cf34) =>
					...
					v36[safeIndex(763, v36.Length)] := !cf34;
					var v38: set<char> := {'c', v34, v34};
					v36[safeIndex(763, v36.Length)] := (set v37 : char | v37 in fm21(cf34, true, cf31, globalState) :: (v37)) <= v38;
				...
				case DC14() =>
					var v41: seq<bool> := [f12];
					v0[safeIndex(3, v0.Length)], globalState.f9, v1[safeIndex(525, v1.Length)] := f13, safeDivisionInt(|v41|, fm1(f12, p0, |"scarno"|, globalState)), DC10(v0);
					var v42: seq<seq<bool>> := [v41, v41, v41[safeIndex(0x32f, |v41|) := f12]];
					var v43: map<bool, seq<seq<bool>>> := map[false := v42];
					v43 := v43[f14 := v42 + v42];
					var v44: array<bool> := new bool[28];
					v44[safeIndex(468, v44.Length)] := f14;
					globalState.f9, v44[safeIndex(468, v44.Length)], globalState.f8 := p0, f12, f12;
				...
				case DC12(cf29) =>
					...
					var v52 := "tdx";
					var v53: set<int> := {|v52|, |(seq(abs(583), i4  => (v34)))|};
					v51[safeIndex(668, v51.Length)] := v53;
					v51[safeIndex(668, v51.Length)] := set v54 : int | (0xbc <= v54) && (v54 < 25) :: (v54 - v0[safeIndex(3, v0.Length)]);
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			m0(globalState);
			v0[safeIndex(3, v0.Length)] := -0x136 * safeModuloInt(-f13, p0);
			var v55 := 'p';
			var v56: map<int, char> := map[v0[safeIndex(3, v0.Length)] := v55];
			if (fm0(if (p0 in v56) then v56[p0] else v55, globalState)) {
				var v57: array<bool> := new bool[25](i6 => f13 < --|"ad"|);
				var v58 := "xmboh";
				var v59: set<int> := {|(seq(abs(134), i7  => (v55)))|};
				...
				var v62 := new C2(f12, (multiset{f14})[fm0('c', globalState) := abs(f13)], f14);
				var v63: map<int, array<bool>> := map[p0 := v57];
				globalState.f8 := (v63 == v63) ==> v62.f15;
				var v64 := new C2(f12, f11, f14);
				globalState.f9 := v0[safeIndex(3, v0.Length)];
			} else {
				var v65: map<bool, int> := map[f12 := v0[safeIndex(3, v0.Length)]];
				var v66: seq<int> := [|"tpnnpacy"|];
				var v67: seq<seq<int>> := [v66, v66];
				var v68: map<map<bool, int>, seq<int>> := map[v65 := v67[safeIndex(v66[safeIndex(p0, |v66|)], |v67|)] + v66];
				v68 := v68;
				var v69: array<array<int>> := new array<int>[4];
				v69[safeIndex(251, v69.Length)] := v0;
				v69[safeIndex(251, v69.Length)] := v0;
				var v70: C2 := new C2(fm0(v55, globalState), (fm22(p0, f12, globalState))[f14 := abs(v0[safeIndex(3, v0.Length)])], f14);
				var v71: map<multiset<bool>, int> := map[f11[v70.f15 := abs(p0)] := v0[safeIndex(3, v0.Length)]];
				var v72: map<char, int> := map[v55 := v0[safeIndex(3, v0.Length)]];
				var v74: array<map<char, int>> := new map<char, int>[8] [v72[v55 := f13], v72, v72, v72, map v73 : char | v73 in {v55} :: (v73) := (v0[safeIndex(3, v0.Length)]), v72, v72, v72];
				v74[safeIndex(354, v74.Length)] := map[v55 := v0[safeIndex(3, v0.Length)]];
				var v76: multiset<multiset<bool>> := multiset{f11};
				var v78: seq<multiset<bool>> := [f11, f11];
				var v79: set<multiset<bool>> := {f11, v78[safeIndex(p0, |v78|)]};
				v70, v0[safeIndex(3, v0.Length)], v71, v0[safeIndex(3, v0.Length)], v74[safeIndex(354, v74.Length)] := v70, safeDivisionInt(fm1(f14, v0[safeIndex(3, v0.Length)], f13, globalState), -v0[safeIndex(3, v0.Length)]) * p0, if (f13 != 0x19b) then (map v75 : multiset<bool> | v75 in v76 :: (v75) := (|v65|)) + (map v77 : multiset<bool> | v77 in v79 :: (v77) := (f13)) else map[f11 := f13] + v71, safeDivisionInt(815, |v65|), v72;
				var v80: T0 := new C0(f12, v0[safeIndex(3, v0.Length)], f11, f12);
				var v81 := "xcisubu";
			...
			v84[safeIndex(705, v84.Length)] := if (f12) then fm0(v55, globalState) else f14;
			var v85 := "hbi";
			v84[safeIndex(705, v84.Length)] := (if (fm6(f14, p0, globalState)) then fm9(p0, false, globalState) else v85) == v85;
		}
		var v86: set<bool> := {f12, false, f14};
		var v87 := "kjje";
		var v88: set<int> := {f13};
		for i8 := v0[safeIndex(3, v0.Length)] to DC18(|v86|, v87, false, f14, v88).cf40 {
			if (f14) {
				var v89: array<bool> := new bool[21](i9 => f14);
				var v90: map<int, array<bool>> := map[i8 := v89];
				v90 := (v90 + v90) + v90;
				var v91: seq<int> := [i8];
				globalState.f9 := if (f12) then v0[safeIndex(3, v0.Length)] else v91[safeIndex(p0, |v91|)] - f13;
				v90 := v90;
				v0[safeIndex(3, v0.Length)] := safeModuloInt(f13, f13);
				...
				var v97: array<map<bool, int>> := new map<bool, int>[19] [v92, v92, v93[safeIndex(|v94|, |v93|)] + v92, v92, map[f12 := v0[safeIndex(3, v0.Length)]] + v92, v92, v92 + v92, v92[false := f13], fm23(p0, globalState) + v92, v92, v92, (fm23(f13, globalState))[f14 := f13], v92 + v92, v92, v92 + v92, v92 + map[f14 := p0], if (|v96| in v95) then v95[|v96|] else map[false := i8], v92 + v92, v92];
				v97, v87 := v97, "l";
			} else {
				var v98: array<bool> := new bool[2](i10 => true);
				v98[safeIndex(627, v98.Length)] := f12;
				v98[safeIndex(627, v98.Length)] := f14;
				globalState.f1 := v0;
				var v99: seq<set<bool>> := [v86, v86 - v86];
				var v100 := 'q';
				var v101: seq<string> := [v87];
				globalState.f9, f12, v87, globalState.f8, v98[safeIndex(627, v98.Length)] := |v99[safeIndex(-fm1(true, i8, -i8, globalState), |v99|)]|, if (f14) then f12 else v98[safeIndex(627, v98.Length)], v87[safeIndex(|(f11 + f11)|, |v87|) := v100], 'd' in v101[safeIndex(v0[safeIndex(3, v0.Length)], |v101|)], !f12;
				m0(globalState);
				var v102: array<C0> := new C0[10];
				var v103: map<bool, array<C0>> := map[v98[safeIndex(627, v98.Length)] := v102];
				var v104 := DC23(v103);
				v104, v0[safeIndex(3, v0.Length)], globalState.f9, v0[safeIndex(3, v0.Length)] := v104.(cf55 := v103), f13, p0, -637;
			}
			
			v0[safeIndex(3, v0.Length)] := f13;
			var v105: seq<bool> := [f12, f12];
			var v106: map<bool, bool> := map[false := f14];
			var v107: array<bool> := new bool[8] [f14, !(if (f14) then true else f12), !(-|v105[safeIndex(p0, |v105|) := f12]| == v0[safeIndex(3, v0.Length)]), if (f14 in v106) then v106[f14] else f12, f12, f14, f12, f12];
			v107[safeIndex(174, v107.Length)] := v87 == v87;
			var v108: array<D8> := new D8[9];
			var v109 := DC19(f11);
			var v110 := DC22(v109);
			v108[safeIndex(659, v108.Length)] := v110;
			v107[safeIndex(174, v107.Length)], v0[safeIndex(3, v0.Length)], v108[safeIndex(659, v108.Length)], globalState.f9, globalState.f9 := !(v88 >= v88), if (f12) then f13 + 466 else i8, v110, f13, p0;
		...
		var v115: seq<int> := [p0, v0[safeIndex(3, v0.Length)], |"tyfnjxj"|, f13, if (f12 in v114) then v114[f12] else v0[safeIndex(3, v0.Length)]];
		v0[safeIndex(3, v0.Length)] := (v0[safeIndex(3, v0.Length)] + |v115|) + v0[safeIndex(3, v0.Length)];
	}
}
...
class C4 extends T0 {
	...
	method m1(p0: set<bool>, globalState: GlobalState) returns (r0: array<map<int, char>>, r1: array<seq<bool>>, r2: int) {
		var v0 := -0x343;
		var v1 := "fahubdda";
		globalState.f9, globalState.f7, f11, globalState.f6 := -(fm1(f12, v0, v0, globalState) * v0), f12, f11[f12 := abs(-(0x24 + v0))], fm5(f12, f12, f12, v0, globalState) + fm5(f12, f12, f12, |v1|, globalState);
		...
		var v6 := DC1(p0);
		var v7: array<set<bool>> := new set<bool>[29] [p0, p0, p0 * p0, p0 + p0, {f12, DC0(f12).cf0, f12, !f12}, p0 + p0, p0, p0 + p0, p0, p0 - v5[safeIndex(v0, |v5|)], p0, v6.cf1, p0, p0, p0, p0, p0, v5[safeIndex(-0xf9, |v5|)], p0, p0 * p0, p0, p0 - {f12, f12}, if (f12) then p0 else p0, {!false} + p0, p0 * {f12}, p0, {f12, f12}, p0 - p0, p0];
		v7[safeIndex(185, v7.Length)] := p0 - p0;
		var v8: seq<set<array<bool>>> := [v3];
		v3, v4, v7[safeIndex(185, v7.Length)], globalState.f3, v0 := v8[safeIndex(safeModuloInt(0x296, -v0), |v8|)], v4, p0, f12, 0x39a;
		v2 := v2;
		var i0 := 0;
		while (f12)
			decreases 100 - i0
		{
			...
			globalState.f3 := !f12;
			if (f12) {
				var v9 := DC1(v7[safeIndex(185, v7.Length)]);
				var v10: multiset<D1> := multiset{DC3(v9)};
				var v11 := DC3(v9);
				globalState.f3 := v10[v11 := abs(v0)] > (v10 - v10);
				...
				v15[safeIndex(748, v15.Length)] := if (f12) then v2 else v2;
				v0, v15[safeIndex(748, v15.Length)] := v0 - (if (v12.f14) then v12.f13 else v0), v2;
				var v16: map<int, string> := map[v4[safeIndex(v12.f13, |v4|)] := v1];
				...
				var v31: seq<C0> := [v30];
				var v32: array<int> := new int[19] [v0, v0, (if (f12 in f11) then f11[f12] else v0) + v0, |v18|, v0, v0, v0, v0, |v20|, |v21|, |map[v19.f13 := v25]|, safeDivisionInt(v19.f13, v19.f13), |(v26 - v26)|, -v19.f13, if (v25.f12 in v29) then v29[v25.f12] else |v31|, v30.f18, 278, v19.f13, v19.f13];
				v32[safeIndex(355, v32.Length)] := safeDivisionInt(v0, v0);
				v32[safeIndex(355, v32.Length)] := v0;
				var v33 := new C0(v19.f14, safeModuloInt(|p0|, v19.f13), f11, |multiset{v4}| != v0);
				v2[safeIndex(162, v2.Length)] := v30.f17;
				v2[safeIndex(162, v2.Length)] := v30.f17;
				globalState.f8 := if (v19.f13 == 0x24f) then v25.f12 else f12;
				var v34: map<int, seq<int>> := map[-(v32[safeIndex(355, v32.Length)] + |(seq(abs(0x318), i2  => (v23)))|) := seq(abs(0x150), i3  => (v19.f13))];
				v34 := if (if (!v2[safeIndex(162, v2.Length)]) then v33.f17 else v33.f17) then v34 else map[v33.f18 := v4] + (map[v32[safeIndex(355, v32.Length)] := v4])[0x38b := v4];
			}
		...
		v36[safeIndex(164, v36.Length)] := fm14(v37, -v41.cf53, globalState);
		globalState.f9, v7[safeIndex(185, v7.Length)], v36[safeIndex(164, v36.Length)], v4 := |v4|, p0 * {true}, v35, fm24(globalState);
		for i4 := safeDivisionInt(v0, v0) to v0 {
			v7[safeIndex(185, v7.Length)] := p0;
			var v42: array<string> := new string[11];
			v42[safeIndex(383, v42.Length)] := v1;
			v42[safeIndex(383, v42.Length)] := v1;
			var v43: seq<bool> := [f12];
			var v44: map<multiset<bool>, seq<bool>> := map[multiset([v39.f12, f12]) := v43];
			var v45: map<char, bool> := map[v36[safeIndex(164, v36.Length)] := v39.f12];
			globalState.f6, v0, globalState.f7 := if (v39.f11 in v44) then v44[v39.f11] else v43, v0, v36[safeIndex(164, v36.Length)] in (v45 + v45);
...
function fm0(p0: char, globalState: GlobalState): bool {
	safeModuloInt(0x2fb, 0x126) > |((seq(abs(934), i0  => ('a'))) + "goxbqw")|
}
function fm1(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
	if (true <==> true) then |((seq(abs(882), i0  => ('y'))) + "ov")| else |(['f', 'v', 'd', 'y'] + ['k', 'p', 'w', 'p'])|
}
...
function fm13(p0: char, p1: bool, globalState: GlobalState): multiset<int> {
	(multiset{|(map v0 : int | (-834 <= v0) && (v0 < -0x308) :: (safeModuloInt(v0, |multiset{true}|)) := (54))|, |map[false := -|map[false := |map[true := |[false]|]|]|]|, |map[[false] := false]|, |{!DC20(true, false, false).cf48}|} * multiset{|{false, true}|, 0x0, -|[|map[DC18(|map[|[true]| := 0x228]|, "dvkfi", true, !false, set v1 : int | v1 in {-0x2ab} :: (safeDivisionInt(v1, |"mqnecwgoe"|))).cf43 := 'r']|]|, |[0x3b7, |map[-0x35f := true]|, 159, |map[!true := true]|, |[false]|]|}) + (multiset([-0x2a5]) * multiset{|[|[true]|, 0x35d]|, |"od"|, |[0x1]|})
}
...
function fm17(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): multiset<set<D1>> {
	multiset(seq(abs(172), i0  => ({DC3(DC1({true}))})))
}
...
function fm20(p0: char, p1: int, p2: int, p3: map<int, char>, globalState: GlobalState): set<int> {
	(set v0 : int | (0x202 <= v0) && (v0 < -0xec) :: (v0 + |(seq(abs(-0xb7), i0  => (|map[!true := |(map v1 : int | (740 <= v1) && (v1 < 0x12f) :: (v1 + |multiset{0x116}|) := (|"wag"|))|]|)))|)) - ((set v2 : int | (-0x2e <= v2) && (v2 < 0x35) :: (v2 * 370)) + {-604, -|{DC2(!true, true, false, 'g', 'i').cf2}|, 0x326})
}
...
function fm24(globalState: GlobalState): seq<int> {
	[120, -safeModuloInt(|{|map[false := false]|}|, 0x2c8), -0x32d, if (!true) then 0x3ad else |"ldpqylslw"|]
}
function fm25(p0: char, p1: char, p2: bool, globalState: GlobalState): map<string, string> {
	((map v0 : string | v0 in {"aua", seq(abs(0x42), i0  => ('c'))} :: (v0) := ("jhdbecap")) + map[seq(abs(-0x41), i1  => ('t')) := seq(abs(0x3e1), i2  => ('o'))]) + map["iqvwwh" := "oudm"]
}
...
method m0(globalState: GlobalState) {
		...
		decreases 100 - i0
	{
		...
		if (!!!!v0) {
			...
			var v6 := "luog";
			v5[safeIndex(830, v5.Length)] := v6 != v6;
			v5[safeIndex(830, v5.Length)] := fm0(v1, globalState);
			var v7: array<int> := new int[27];
			globalState.f3, v5[safeIndex(830, v5.Length)] := {v7} > {v7}, if (v5[safeIndex(830, v5.Length)]) then true else v5[safeIndex(830, v5.Length)];
			...
			var v12: set<int> := {v3};
			var v13 := "jlgqgkipu";
			v3 := (if (v9[safeIndex(v3, |v9|)] in v8) then v8[v9[safeIndex(v3, |v9|)]] else v3) + (if (v12 in v11) then v11[v12] else |v13|);
			var v14 := new C2(v0, v8, fm0(v13[safeIndex(v3, |v13|)], globalState));
			globalState.f9, v3, v3, v0 := v3 - (if (v14.f15) then |v13| else v3), -264, -v3, v0;
			var v15: multiset<int> := multiset{v3, v3, v3, v3, |v13|};
			globalState.f9 := safeModuloInt(--(if (v3 in v15) then v15[v3] else |v4|), |{v14.f15}|) - v3;
		...
		match (v17.(cf63 := map[!v0 := v3] + v16)) {
			case DC28(cf64, cf65, cf66, cf67) =>
				...
				var v30: array<set<seq<int>>> := new set<seq<int>>[15] [v21, fm27(v23, v24, globalState), v21, {v4, v4}, fm27(DC35(v22).(cf77 := v22), v24, globalState), v21, v21, set v25 : seq<int> | v25 in (seq(abs(-30), i2  => (v4))) :: (v25), v21, (if (v3 in v26) then v26[v3] else {v4, v4}) - {v4[safeIndex(v3, |v4|) := v3]}, v21, set v27 : seq<int> | v27 in v21 :: (v27), v21, set v29 : seq<int> | v29 in v28 :: (v29), v21];
				v30[safeIndex(210, v30.Length)] := fm27(DC35(v22), v24, globalState);
				v30[safeIndex(210, v30.Length)] := v21;
				globalState.f9 := 0xa2;
			case DC29(cf68) =>
				v1 := v1;
				globalState.f9 := v4[safeIndex(v3 + v3, |v4|)];
				var v31: array<map<D5, int>> := new map<D5, int>[11](i3 => map[DC14() := v3] + map[DC14() := |multiset{v0, cf68}|]);
				var v32 := DC14();
				var v33: map<D5, int> := map[v32 := v3];
				v31[safeIndex(36, v31.Length)] := v33;
				v31[safeIndex(36, v31.Length)] := v33 + v33;
		...
		decreases 100 - i4
	{
		...
		if (v47[safeIndex(v3, |v47|)]) {
			...
			var v53: map<int, int> := map[-|(v50 + v50)[safeIndex(v3, |(v50 + v50)|) := v1]| := v3 - |v52[safeIndex(v3, |v52|)]|];
			v53 := v53[v3 := v3];
		...
		v66[safeIndex(460, v66.Length)] := !v0;
		var v67: map<bool, int> := map[v0 := v3];
		v66[safeIndex(460, v66.Length)] := true in (v67 + v67);
		globalState.f6 := v47;
		var v68: multiset<char> := multiset{v1};
		var v69: seq<char> := [v1];
		v66[safeIndex(460, v66.Length)] := v68 > multiset(v69);
	}
	var v70 := "dslsfkrf";
	...
	v74, v74, v0 := v75[safeIndex(safeModuloInt(|(seq(abs(0x318), i6  => (v70[safeIndex(0x36d, |v70|)])))|, v3), |v75|)], v74, if (v70 < v70) then !v0 else v3 in v76;
	...
	for i7 := v3 to v78.cf30 {
		...
		match (v79) {
			case DC35(cf77) =>
				...
				var v81: seq<bool> := [v0, v0, false, v80[safeIndex(-|"jcvbfjwrl"|, |v80|)]];
				globalState.f9 := if (i7 in v76) then v3 else i7 + |v81|;
				var v82: array<int> := new int[1](i8 => i8 + v3);
				v82[safeIndex(618, v82.Length)] := v3 * v3;
				var v83: multiset<array<int>> := multiset{v82, v82};
				var v84: set<int> := {i7, i7, v3};
				var v85 := DC5(-i7, |v83|, |v84|, |(multiset(v80))[v0 := abs(fm1(v0, i7, v3, globalState))]|, v81);
				globalState.f4, v82[safeIndex(618, v82.Length)], v85 := v82, fm1(v0, v3 * v3, v3, globalState), v85;
				v1 := if (true) then v1 else v1;
				var v86: map<char, int> := map[v1 := v3];
				v86 := v86[v1 := fm1(v0, v82[safeIndex(618, v82.Length)], -v82[safeIndex(618, v82.Length)], globalState)];
		}
		
		v0 := false;
		var v87: seq<seq<bool>> := [[v0]];
		var v88: map<seq<bool>, multiset<string>> := map[v87[safeIndex(v3, |v87|)] := multiset([seq(abs(529), i9  => (v1)), v70, v70, "bultv", "yvdibk"] + [v70, v70])];
		var v89: seq<bool> := [v0];
		var v90: multiset<string> := multiset{v70, v70, v70};
		v88 := v88[v89 := v90];
		if (!!v0) {
			var v91 := new C4(multiset(v89) + v73, !!v0);
			globalState.f9 := safeDivisionInt(i7, i7);
			v70 := v70;
			var v92: set<int> := {i7};
			var v93 := DC8(--v3, i7);
			...
			var v96: map<map<int, map<bool, int>>, int> := map[fm29(v89[safeIndex(|v92|, |v89|)], v3, globalState) := |{0x395, |v4|, v91.fm3(v0, v95, v0, i7, globalState)}|];
			...
			v104 := v104 + v104;
			v74[safeIndex(705, v74.Length)] := v0;
			var v105: map<bool, bool> := map[!(if (v0) then v0 else !v0) := !(v0 && v0)];
			v74[safeIndex(705, v74.Length)] := if ((if (!v0) then v0 else v0) in v105) then v105[if (!v0) then v0 else v0] else v0;
			var v106 := DC24(v70, v0, v3);
			var v107: array<bool> := new bool[20] [v74[safeIndex(705, v74.Length)], v0, v74[safeIndex(705, v74.Length)], false, v74[safeIndex(705, v74.Length)], v106.cf57, v74[safeIndex(705, v74.Length)], !v0, v89[safeIndex(v3, |v89|)], v74[safeIndex(705, v74.Length)], v74[safeIndex(705, v74.Length)], v74[safeIndex(705, v74.Length)], v74[safeIndex(705, v74.Length)], v74[safeIndex(705, v74.Length)], v0, v0, v0, v0, v0, v0];
			var v108: set<array<bool>> := {v107, v107};
			var v109: map<int, int> := map[i7 := |v105|];
			var v110: map<bool, map<int, int>> := map[v0 := v109];
			var v111: map<bool, map<bool, map<int, int>>> := map[|v105| != |v108| := v110[v74[safeIndex(705, v74.Length)] := map[v3 := |[0x131]|]] + v110];
			v111 := v111[if (v89[safeIndex(i7, |v89|)]) then v74[safeIndex(705, v74.Length)] else v0 := v110 + map[v0 := v109]];
			var v112: C1 := new C1(0x12c, multiset{v74[safeIndex(705, v74.Length)]}, v0);
			var v113: map<bool, int> := map[true := v3];
			var v114: array<int> := new int[10] [|v113|, v3, v3, |v89|, i7, 93, v4[safeIndex(v112.f16, |v4|)], v112.f16, -v3, |v4|];
			...
			v112, v107, globalState.f8 := v112, if (v115[safeIndex(-v112.f16, |v115|) := v114] <= v115) then v117.cf52 else v107, v74[safeIndex(705, v74.Length)];
			v114[safeIndex(553, v114.Length)] := v112.f16;
			v114[safeIndex(553, v114.Length)] := i7;
		}
...
method Main() {
	...
	var v5: array<int> := new int[29](i0 => safeModuloInt(i0, v1));
	var v6 := false;
		...
		decreases 100 - i1
	{
		...
		var v8: map<int, bool> := map[safeModuloInt(v1, v1) := fm0(v3, globalState)];
		var v10: map<bool, int> := map[v6 := v1];
		v8 := map v9 : int | v9 in [fm1(v6, v1, |v10|, globalState)] :: (safeDivisionInt(v9, |multiset{v1, |"kengs"|, |(set v11 : int | v11 in v8 :: (v11 - 206))|}|)) := (multiset{v6, v6} > multiset{v6, v6});
		var v12: multiset<bool> := multiset{v6};
		var v13 := new C4(v12, v6);
		if (v6) {
			v5[safeIndex(968, v5.Length)] := |(seq(abs(284), i2  => (v3)))| - v1;
			v5[safeIndex(968, v5.Length)] := v1;
			v5[safeIndex(968, v5.Length)] := v1;
			globalState.f9 := v1;
			...
			var v15 := "fuaink";
			var v16: multiset<string> := multiset{v15, if (v6) then v15 else seq(abs(0xd9), i3  => (v3)), v15 + "tdvl", v15, if (if (-v1 in v8) then v8[-v1] else v6) then v15 else DC25(v15, v6, |"gsmf"|).cf59};
			globalState.f9 := |v16|;
			...
			v21[safeIndex(591, v21.Length)] := v1 >= 489;
			v21[safeIndex(591, v21.Length)] := v18.f12;
		...
		decreases 100 - i4
	{
		...
		v25[safeIndex(509, v25.Length)] := multiset{!true, v24.f12};
		...
		globalState.f3, globalState.f7, v25[safeIndex(509, v25.Length)], v27, globalState.f7 := if (DC23(if (v28.f17 in v34) then v34[v28.f17] else v32) in v33) then v33[DC23(if (v28.f17 in v34) then v34[v28.f17] else v32)] else v6 <==> v28.f17, (v22 + "svi") <= v22, fm22(if (map[v28.f17 := v28.f17] in v38) then v38[map[v28.f17 := v28.f17]] else v28.f18, v24.f12, globalState), ([v26] + v27) + v27, !!v24.fm2(v40, v28.f18, fm23(v28.f18, globalState), v26.f15, globalState);
		var v41 := DC16(v1, v39[v3 := abs(if (v26.f15 in v24.f11) then v24.f11[v26.f15] else v1)] > v39, !v6);
		match (v41) {
			case DC16(cf36, cf37, cf38) =>
				...
				var v46: set<array<bool>> := {v44, v44, v45[safeIndex(0x351, |v45|)]};
				v46 := v46 * v46;
			...
			case DC15(cf35) =>
				var v50, v51 := v26.m5(safeModuloInt(v28.f18, v28.f18), v22, globalState);
	...
	if (v1 <= |v57[safeIndex(v1, |v57|)]|) {
		...
		var v66: array<string> := new string[14] [v54, v54, seq(abs(60), i6  => (v54[safeIndex(|(map v65 : int | v65 in [v64.f16] :: (v65 - v1) := (-0xf4))|, |v54|)])), v54, v54, "r", v54[safeIndex(v64.f16, |v54|) := v3], v54, v54, v54, v54, "foxyq", v54, v54];
		...
		match (v68) {
			case DC24(cf56, cf57, cf58) =>
				...
				v71 := v71[0xc := v70];
				v5[safeIndex(222, v5.Length)] := |(cf56 + cf56)|;
				v5[safeIndex(222, v5.Length)] := v64.f16;
				v3 := v3;
			case DC25(cf59, cf60, cf61) =>
				...
				var v77: map<C3, int> := map[v76 := |(seq(abs(0x11b), i7  => (v3)))| - v64.f16];
				globalState.f9 := |v77|;
			...
			case DC26(cf62) =>
				globalState.f8 := v59.f12;
				var v79 := new C0(!v59.f12, safeModuloInt(v64.f16, v64.f16), v58, !v6);
				cf62 := -0x2b9;
				var v80: array<C3> := new C3[4];
				var v81: seq<multiset<bool>> := [v59.f11];
				var v82: C3 := new C3(v64.f16, v6, v81[safeIndex(v1, |v81|)], v59.f12);
				v80[safeIndex(648, v80.Length)] := v82;
				v80[safeIndex(648, v80.Length)] := v82;
			case DC23(cf55) =>
		...
		v94 := v94[v7[safeIndex(v1, |v7|)] := seq(abs(226), i8  => (v1))];
		globalState.f8 := v1 > v1;
		v5[safeIndex(537, v5.Length)] := v1 * v1;
		globalState.f9, v5[safeIndex(537, v5.Length)] := if (v6) then v1 else v1, v2[safeIndex(0x39f, |v2|)];
		m0(globalState);
		var v95: map<bool, int> := map[true := v5[safeIndex(537, v5.Length)]];
		var v96: map<int, int> := map[v5[safeIndex(537, v5.Length)] := v5[safeIndex(537, v5.Length)]];
		globalState.f9 := safeDivisionInt(if (!true in v95) then v95[!true] else fm1(v6, v5[safeIndex(537, v5.Length)], -|v96|, globalState), v5[safeIndex(537, v5.Length)]);
	}
	
	globalState.f3 := |(if (v6) then v54 else ("gul")[safeIndex(v1, |"gul"|) := 'd'])| == v1;
	if (v6) {
		...
		if (v97 < v97) {
			...
			v102[safeIndex(838, v102.Length)] := v55;
			v102[safeIndex(838, v102.Length)] := v55;
			var v103: map<int, bool> := map[v1 := v6];
			var v104: map<map<int, bool>, int> := map[v103 := v1];
			globalState.f9 := |(v104 + map[map[v1 := v6] := -|v102[safeIndex(838, v102.Length)]|])|;
			v1 := v1;
			globalState.f7 := v6;
		} else {
			var v105: map<set<bool>, int> := map[v97 := v1];
			v5[safeIndex(579, v5.Length)] := if (v97 in v105) then v105[v97] else v1;
			v5[safeIndex(76, v5.Length)] := v1;
			var v106: C4 := new C4(multiset{v6, v6}, v6);
			var v107: multiset<C4> := multiset{v106, v106};
			globalState.f3, v5[safeIndex(579, v5.Length)], v5[safeIndex(76, v5.Length)], globalState.f9, globalState.f9 := v6, v1, safeDivisionInt(574, v1), safeDivisionInt(v1, -498), |(if (map[v107 := v6] == map[v107 := v6]) then seq(abs(543), i10  => (v1)) else seq(abs(0x331), i11  => (v1)))|;
			...
			var v111: C0 := new C0(v6, v1, if (v5[safeIndex(579, v5.Length)] in v109) then v109[v5[safeIndex(579, v5.Length)]] else multiset{v6, v6, (v110.(cf2 := false, cf6 := v3)).cf4}, v6);
			var v112: map<C0, char> := map[v111 := v3];
			v112 := v112[v111 := 'd'];
			v5[safeIndex(579, v5.Length)], v5[safeIndex(579, v5.Length)], globalState.f9 := v111.f18 * (v111.f18 * 0x37), safeDivisionInt(v5[safeIndex(579, v5.Length)], if (v6 in v108) then v108[v6] else 0x21e), -v111.f18;
			var v113, v114, v115 := v106.m1(fm18(0x10d, v111.f17, globalState), globalState);
		}
		
		globalState.f3 := v1 != safeDivisionInt(v1, v1);
		var v116: array<C0> := new C0[9];
		var v117: seq<array<C0>> := [v116];
		var v118: array<array<C0>> := new array<C0>[14] [v116, v116, v116, v116, v116, v117[safeIndex(-v1, |v117|)], v116, v116, v116, v116, v116, v116, v116, v116];
		v118[safeIndex(802, v118.Length)] := if (v6) then v116 else v116;
		v118[safeIndex(802, v118.Length)] := v116;
		...
		if (fm0(v3, globalState)) {
			...
			v124[safeIndex(301, v124.Length)] := v123;
			v124[safeIndex(301, v124.Length)] := v123;
		...
		var v133: T0 := new C0(v6, v1, v131[v6 := abs(v1)], v6);
		v133 := v133;
	...
	var v140: map<string, bool> := map[("muwivve")[safeIndex(v1, |"muwivve"|) := v3] := (fm26(v1, !false, globalState)).cf46];
	if (if ((seq(abs(0x334), i12  => (v3))) in v140) then v140[seq(abs(0x334), i12  => (v3))] else v55 < (set v141 : int | (0x237 <= v141) && (v141 < 0x3ae) :: (v141 + v1))) {
		var v142: array<bool> := new bool[7](i13 => v6);
		var v143: seq<array<bool>> := [v142];
		var v144: array<array<bool>> := new array<bool>[23] [v142, v142, v142, v143[safeIndex(fm1(v6, fm1(v6, v1, v1, globalState), |(seq(abs(0x32a), i14  => (v3)))|, globalState), |v143|)], v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142, v142];
		...
		v144[safeIndex(586, v144.Length)] := v142;
		...
		v144[safeIndex(586, v144.Length)] := if (v147.fm2(v152, v1, v153, !v6, globalState) in v151) then v151[v147.fm2(v152, v1, v153, !v6, globalState)] else v142;
		v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)] := v147.f15;
		v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)] := v6;
		var v154 := new C0(v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)], v1, v146, v6);
		if (v147.f15) {
			v6 := (|v153| * v154.f18) >= v154.f18;
			globalState.f8 := v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)];
			var v155: set<char> := {v3, v3};
			var v156: array<string> := new string[27] [v54, seq(abs(-0x12a), i15  => (v3)), "ecbkysbx", "mekb", v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, "cnflkujmg", v54, v54, v54, fm9(|v155|, true, globalState), seq(abs(0x1b0), i16  => ('f')), v54, v54, v54, "c", seq(abs(325), i17  => (v3)), v54, v54];
			...
			v147.f15 := v160.cf70 == v161[safeIndex(v154.f18, |v161|)];
			...
			m0(globalState);
			v5[safeIndex(527, v5.Length)] := v154.f18;
			v5[safeIndex(527, v5.Length)] := if (v147.fm2(v152, v154.f18, map[true := v154.f18], v6, globalState) in v146) then v146[v147.fm2(v152, v154.f18, map[true := v154.f18], v6, globalState)] else v154.f18;
			var v165: multiset<char> := multiset{v3};
			var v166: map<bool, multiset<char>> := map[v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)] := v165];
			var v167: set<bool> := {!v6};
			var v168: array<int> := new int[14] [-v154.f18, if (v154.f17) then -0x1a4 else |(if (false in v166) then v166[false] else v165)|, -(|multiset{v154.f17, v6}| - v154.f18), v1, |v167|, v1, v1 - 844, v154.fm12(globalState) * v154.f18, 620, |map[0x262 := v154.f18]|, v154.f18, safeModuloInt(v1, v154.f18), v5[safeIndex(527, v5.Length)], safeDivisionInt(v1, |v54|)];
			globalState.f1 := v168;
			...
			v54, v5[safeIndex(527, v5.Length)], globalState.f7, v152 := v54 + v54, v154.f18, v147.fm2(multiset{v154.f18, |(if (|v55| in v170) then v170[|v55|] else v152)|}, v173.cf32, (fm23(-v5[safeIndex(527, v5.Length)], globalState))[false := v1], v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)], globalState), (multiset(v2) * fm13(v54[safeIndex(v154.f18, |v54|)], false, globalState)) + v152;
		...
		match (v174) {
			case DC13(cf30, cf31, cf32, cf33, cf34) =>
				...
				v5[safeIndex(539, v5.Length)] := 0x87;
				...
				v3, v175, v55, v5[safeIndex(539, v5.Length)], v179 := v3, v175, v55 * v55, |v180.cf56|, v179;
				globalState.f9 := v154.f18;
				var v181: seq<multiset<bool>> := [v146];
				var v182: T0 := new C4(v181[safeIndex(v5[safeIndex(539, v5.Length)], |v181|)], !cf34);
				var v183: map<T0, string> := map[v182 := v54[safeIndex(-v176.f13, |v54|) := v3]];
				var v184: seq<map<bool, int>> := [fm23(|v2|, globalState), fm23(v5[safeIndex(539, v5.Length)], globalState)];
				...
				v183, cf30, v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)], v145, v184 := v183, if (v182 in v185) then v185[v182] else safeDivisionInt(v154.f18, 222), (v54 + v54) < (seq(abs(0x325), i18  => (v3))), DC21(v147.f15, if (v5[safeIndex(539, v5.Length)] in v186) then v186[v5[safeIndex(539, v5.Length)]] else v144, safeModuloInt(v5[safeIndex(539, v5.Length)], v154.f18), v144[safeIndex(586, v144.Length)], |v188| * fm1(cf31, cf30, cf30, globalState)), v184 + v184;
			...
			case DC14() =>
				...
				v6, v152, globalState.f3, v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)] := !!false, v152 - (v152 + v152), v154.f17, !v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)];
			case DC12(cf29) =>
				var v191 := new C2(v147.f15, v146, v144[safeIndex(586, v144.Length)][safeIndex(94, v144[safeIndex(586, v144.Length)].Length)]);
				globalState.f9 := |v54|;
		...
		var v196: C1 := new C1(v1, (multiset(v7))[v6 := abs(|v195|)], v6);
		...
		v194[safeIndex(601, v194.Length)] := v199;
		v194[safeIndex(601, v194.Length)] := v199;
		...
		v1 := safeDivisionInt(|((map v205 : int | (0x167 <= v205) && (v205 < -0x36f) :: (safeDivisionInt(v205, |multiset(v7)|)) := (v195[!v6 := v6])) + v206[|v54| := v195])|, |v54|);
		var v207: array<bool> := new bool[15](i19 => v7[safeIndex(v1, |v7|)]);
		v207[safeIndex(717, v207.Length)] := v6;
		var v208: set<bool> := {true};
		v207[safeIndex(717, v207.Length)] := ({v6, v6, v6} != v208) ==> (if (v6) then v6 else v6);
		var v209: set<string> := {v57[safeIndex(v196.f16, |v57|)]};
		if ((v209 * (set v210 : string | v210 in map[v54 := v6] :: (v210))) < v209) {
			v7 := (v7 + v7)[safeIndex(v1, |(v7 + v7)|) := v6];
			v54 := seq(abs(32), i20  => (v3));
			var v211: multiset<bool> := multiset{v207[safeIndex(717, v207.Length)], v6, v207[safeIndex(717, v207.Length)]};
			var v212 := new C4(v211, false);
			var v213 := new C0(v207[safeIndex(717, v207.Length)], 449, v211, v207[safeIndex(717, v207.Length)]);
			v6 := v213.f17;
		} else {
			var v214: multiset<bool> := multiset{v207[safeIndex(717, v207.Length)]};
			...
			var v216 := DC21(false, v215, v1, v207, |{v207[safeIndex(717, v207.Length)], v207[safeIndex(717, v207.Length)]}|);
			var v217: C4 := new C4(v214, v216.cf49);
			var v218: map<bool, C4> := map[true := v217];
			var v219: map<int, bool> := map[v196.f16 := v207[safeIndex(717, v207.Length)]];
	...
	var v226: map<C0, bool> := map[v221 := v225[safeIndex(v221.f18, |v225|)] !! fm22(v223.f13, v223.f14, globalState)];
	...
	var i23 := 0;
	while (!!((v229 + [v228])[safeIndex(v1, |(v229 + [v228])|) := v228] == v229))
		decreases 100 - i23
	{
		if (i23 >= 100) {
			break;
		...
		v57 := [seq(abs(0x1e5), i24  => (v3)), v54, ("ot")[safeIndex(-|v231|, |"ot"|) := 'r'], v54];
		var v233: array<map<seq<int>, int>> := new map<seq<int>, int>[8](i25 => map[[v221.f18, v1] := v223.f13] + (map v232 : seq<int> | v232 in multiset{v2[safeIndex(v228.f16, |v2|) := v1], v2} :: (v232) := (v223.f13)));
		var v234: map<seq<int>, int> := map[[|v54|] := v1];
		var v235 := DC34(v234);
		v233[safeIndex(824, v233.Length)] := v235.cf76;
		v233[safeIndex(824, v233.Length)] := (v234 + map[v2 := v1]) + (v234 + (map v236 : seq<int> | v236 in (seq(abs(0x52), i26  => (v2))) :: (v236) := (v221.f18)));
		...
		v239 := (v240[safeIndex(v223.f13, |v240|)])[safeIndex(v221.f18, |v240[safeIndex(v223.f13, |v240|)]|) := [v241.cf58] + v2];
		v230.f12 := !v6;
	}
	m0(globalState);
	if (v6) {
		...
		var v246 := new C1(safeModuloInt(0x34f, |v54|), multiset{if (|v245| in v242) then v242[|v245|] else v243.f12, v223.f14}, !v221.f17);
		if (v243.f12 <== v223.fm6(!!v6, v221.fm12(globalState), globalState)) {
			...
			var v251: array<multiset<int>> := new multiset<int>[12] [fm13(v3, !v221.f17, globalState), v249, v249, v249, if (v221.f18 in v250) then v250[v221.f18] else multiset{v228.f16}, v249, v249[v223.f13 := abs(v223.f13)], v249, multiset{|v2|} + v249, multiset{v228.f16, v246.f16, |"co"|}, if (v243.f12) then v249 else v249, (multiset{0xa2, v228.f16})[-v1 := abs(v228.f16)]];
			v251[safeIndex(845, v251.Length)] := fm13('h', v223.f14, globalState);
			v251[safeIndex(845, v251.Length)] := v249;
			var v252: map<seq<int>, int> := map[v2[safeIndex(v246.f16, |v2|) := v221.f18] := 0x162];
			var v253 := DC34(v252);
			var v254: map<D13, bool> := map[v253 := v223.f14];
			var v255: array<D8> := new D8[10];
			var v256: map<map<D13, bool>, array<D8>> := map[v254 := v255];
			v5[safeIndex(120, v5.Length)] := safeModuloInt(v221.f18, v228.f16);
			v256, v243.f12, v223, v5[safeIndex(120, v5.Length)] := v256, v223.f13 != v221.f18, if (v7[safeIndex(v221.f18, |v7|)]) then if (v221.f17) then v223 else v223 else v223, v228.f16;
			var v257: C2 := new C2(v243.f12, v243.f11, v243.f12);
			var v258 := DC32(safeDivisionInt(v221.f18, |map[-0x35d := v246]|), v257, v221, v223.f13);
			var v259: map<int, C0> := map[v246.f16 := v221];
			var v260: seq<C0> := [v221, if (v221.f18 in v259) then v259[v221.f18] else v221, v221];
			v258 := DC32(v228.f16, v257, v260[safeIndex(|v220|, |v260|)], -|v54|);
			...
			var v267: array<bool> := new bool[10] [v55 > {|v220|, v1, v228.f16}, v223.f13 > 0x215, v221.f17 && v223.f14, v6, v223.f14, v223.f14, v243.f12, !v243.f12 !in v266, v7[safeIndex(fm1(v6, v1, v228.f16, globalState), |v7|)], v221.f17];
			v267[safeIndex(622, v267.Length)] := v223.f14;
			globalState.f7, globalState.f9, v267[safeIndex(622, v267.Length)], v3 := (v2 <= v2) || v221.f17, v221.f18, v221.f17, v3;
			...
			var v273: map<int, array<bool>> := map[if (v243.fm2(v271, -|v270|, v269, v267[safeIndex(622, v267.Length)], globalState) in v269) then v269[v243.fm2(v271, -|v270|, v269, v267[safeIndex(622, v267.Length)], globalState)] else |v272| := v267];
			var v274: set<char> := {v3};
			var v275: map<bool, array<bool>> := map[v274 == v274 := if (v223.f14) then v267 else v267];
			v273, globalState.f3, v228.f16, v228.f16, v275 := v273, if (v223.f14) then v267[safeIndex(622, v267.Length)] else v243.f12, |v54|, v221.f18 + -v228.f16, v275 + v275;
			v270 := v270[v221.f17 := v223.f14];
		}
		
		v223 := v223;
		var v276 := DC2(v221.f17, v223.f14, v221.f17, v3, v3);
		var v277: array<char> := new char[12] [fm14(v276, v246.f16, globalState), v3, v3, v3, fm14(v276.(cf3 := v223.f14), v221.f18, globalState), v3, v3, v3, v3, v3, if (!!v223.f14) then v54[safeIndex(|map[v223.fm6(v6, v223.f13, globalState) := v1]|, |v54|)] else v3, v3];
		v277[safeIndex(314, v277.Length)] := fm14(v276, v221.f18, globalState);
		...
		var v281: array<multiset<int>> := new multiset<int>[12] [v279[v228.f16 := abs(v1)], v279 * v279, v279, v279, v279, multiset(v2), if (v221.f18 in v280) then v280[v221.f18] else v279, v279, v279, (fm13(v3, v221.f17, globalState))[v221.f18 := abs(-|v54|)], multiset{v246.f16} + v279, v279];
		v281[safeIndex(81, v281.Length)] := v279;
		globalState.f9, v277[safeIndex(314, v277.Length)], v278, v281[safeIndex(81, v281.Length)] := v228.f16, v3, v278, v279;
	} else {
		var v282: T0 := new C1(-|v222|, v222, true);
		var v283: map<T0, int> := map[v282 := if (v221.f17) then |(v57[safeIndex(|v55|, |v57|)])[safeIndex(v221.f18, |v57[safeIndex(|v55|, |v57|)]|) := v3]| else |v7|];
		v283 := v283[v282 := fm1(v7[safeIndex(v221.f18, |v7|)], -v221.f18, v223.f13, globalState)];
		...
		var v289 := DC21(v221.f17, v288, v221.f18, v286, safeModuloInt(v223.f13, v221.f18));
		match (v289) {
			case DC20(cf46, cf47, cf48) =>
				var v290: seq<set<bool>> := [v220];
				v1 := -|(v290[safeIndex(v228.f16, |v290|)] - (v220 * v220))|;
				var v291: map<int, char> := map[803 := v3];
				v3 := if (v228.f16 in v291) then v291[v228.f16] else v3;
				var v292: multiset<char> := multiset{v3, v3, v3, v54[safeIndex(v221.f18, |v54|)]};
				var v293 := DC35(multiset{v3});
				var v294: seq<multiset<char>> := [v292];
				cf47 := (if (true) then v292 else v293.cf77) >= v294[safeIndex(|v54|, |v294|)];
				globalState.f3 := v223.f14;
			case DC21(cf49, cf50, cf51, cf52, cf53) =>
				cf51 := |v57[safeIndex(if (v282.f12) then v1 else v221.f18, |v57|)]|;
				v282.f12 := cf49;
				cf52 := v286;
				var v295: multiset<seq<int>> := multiset{seq(abs(0xeb), i28  => (v228.f16))};
				cf51 := if ((seq(abs(0x383), i29  => (--0xc6))) in v295) then v295[seq(abs(0x383), i29  => (--0xc6))] else safeDivisionInt(v221.f18, v221.f18);
			case DC19(cf45) =>
				m0(globalState);
			...
			case DC22(cf54) =>
				...
				var v304: array<map<bool, int>> := new map<bool, int>[19] [v297, v297, if (v298 in v299) then v299[v298] else v297, v297, fm23(v228.f16, globalState), v297, map[v221.f17 := v223.f13], v297, v297 + v297, v297 + v297, map[v221.f17 := v221.f18], v297, v297, v297, v297, v297 + v297, v297, v297, v297 + v300[safeIndex(|v303|, |v300|)]];
	...
	print v1, "\n";
	print v2 == [-351, 231, -351, -351, 231, -351], "\n";
	print v3, "\n";
	print v4 == map[map[0 := false, 582 := false] := 'p'], "\n";
	print v5[0], "\n";
	print v5[1], "\n";
	print v5[2], "\n";
	print v5[3], "\n";
	...
	print v6, "\n";
	print v7 == [false, true], "\n";
	print globalState.f0 == map[map[0 := false, 582 := false] := 'p'], "\n";
	...
	print globalState.f1[27], "\n";
	print globalState.f1[28], "\n";
	...
	print globalState.f4[27], "\n";
	print globalState.f4[28], "\n";
	print globalState.f5, "\n";
	print globalState.f6 == [false, true], "\n";
	...
	print v56.cf44 == {-351}, "\n";
	print v57 == ["eyxck"], "\n";
	print v140 == map["mupivve" := true], "\n";
	print v220 == {false}, "\n";
	print v221.f17, "\n";
	print v221.f18, "\n";
	print v222 == multiset{false, false, false}, "\n";
	print v223.f13, "\n";
	print v223.f14, "\n";
	print |v224|, "\n";
	print v225 == [multiset{false, false, false}, multiset{false, false, false}, multiset{false, false, false}, multiset{true}], "\n";
	print |v226|, "\n";
	print v227[0], "\n";
	print v227[1], "\n";
	print v227[2], "\n";
