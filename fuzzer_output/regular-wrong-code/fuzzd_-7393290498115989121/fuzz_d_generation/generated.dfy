...
function fm13(p0: multiset<bool>, p1: int, globalState: GlobalState): multiset<seq<int>> {
	(multiset([[0x26c], [|"vsrbg"|, 0x269, |multiset{true}|]]) * multiset{seq(481, i0  => (-|[false, !false]|)), [-578]}) * multiset([[|map[|{false}| := true]|], [-0x52, 0x173]] + [[-0x268]])
}
function fm14(globalState: GlobalState): map<int, int> {
	map[-0xbc := 0xca] + (map[0x14a := 681] + map[|(seq(0x26b, i0  => (524)))| := |[false]|])
}
...
function fm21(p0: D1, p1: bool, p2: seq<D2>, globalState: GlobalState): seq<int> {
	match DC14(true, DC23(true, 0x30d, true).cf44) {
		case DC13(cf22, cf23, cf24, cf25) => seq(0x153, i0  => (cf23))
		case DC14(cf26, cf27) => seq(-0x327, i1  => (|[|[|{|multiset{|[cf26]|, |(set v0 : int | (752 <= v0) && (v0 < 428) :: (v0 - 708))|}|}|, 0x0]|]|))
...
function fm22(p0: int, p1: seq<map<int, bool>>, p2: bool, p3: bool, globalState: GlobalState): set<int> {
	if (!(true <== true)) then {-|{|map[true := |[|"nuqceuqr"|, -0x167]|]|, 0x366}|} + (set v0 : int | (0x300 <= v0) && (v0 < -0x2c0) :: (v0 / 0xec)) else {569, |multiset([false, !false])|, |(set v1 : int | v1 in multiset([|"l"|]) :: (v1 % |[-|[|[|[688, 0x163, |[!true, true]|]|, |(seq(0x19c, i0  => (384)))|]|, |"dp"|, -0x13e, -|map[true := true]|, 0x32d]|]|))|, -0x388}
}
...
function fm26(p0: int, p1: bool, p2: int, globalState: GlobalState): seq<seq<char>> {
	match DC38(DC30('y', true, -|map[true := -0xaa]|, {-|multiset{--48, 0x106}|, |{true}|}, -0x60).cf52) {
		case DC38(cf64) => [['b', 'x']]
		case DC39(cf65) => seq(881, i0  => (seq(277, i1  => ('r'))))
		case DC37(cf63) => [seq(114, i2  => ('c'))] + (seq(87, i3  => ([DC30('j', true, |multiset([true])|, set v0 : int | (0x2ee <= v0) && (v0 < 0xd0) :: (v0 % |(set v1 : int | v1 in map[|[|map[false := false]|]| := true] :: (v1 % 0x371))|), -0x152).cf50])))
		case DC40(cf66) => [seq(0x36a, i4  => ('j'))]
	}
}
function fm27(p0: int, p1: bool, globalState: GlobalState): string {
	"vkgblbh" + (seq(122, i0  => ('t')))
}
...
function fm30(p0: bool, globalState: GlobalState): multiset<int> {
	multiset{-690} - multiset{-0x27f, |multiset{[false], [false]}|, -0x2e0, |(seq(-596, i0  => (|[|"cmgn"|]|)))|, 0x1d1}
}
function fm31(p0: bool, p1: bool, globalState: GlobalState): map<int, char> {
	map[-|("ymdokrv" + (seq(957, i0  => ('q'))))| := 'c']
}
...
function fm34(globalState: GlobalState): set<string> {
	set v1 : string | v1 in ((map v0 : string | v0 in (seq(0x393, i0  => (DC70(true, !false, "rgiu", |multiset{0x14b, |"ia"|}|, |map[-0x2f := |(seq(0x35c, i1  => ('l')))|]|).cf114))) :: (v0) := (|[[true, !true]]|)) + map["elx" := 919]) :: (v1)
}
...
function fm38(globalState: GlobalState): seq<bool> {
	match DC17([[true, false, false]], false, multiset{372, |map[|(seq(142, i0  => ('e')))| := |{'w', 'n', 'j', 'r'}|]|, |map[false := multiset{839}]|, |map[0x147 := false]|}) {
...
function fm39(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): D9 {
	DC30('w', if (true) then false else true, |map[|"sfdadptf"| := true]| - 0x34c, set v0 : int | (626 <= v0) && (v0 < 0x15d) :: (v0 % 168), |map[|{DC23(false, 232, !false).cf43, |"ixq"|, |map[-0xe9 := true]|}| := true]|)
}
...
function fm42(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): D8 {
	match DC33({multiset([false])}) {
		...
		case DC35() => DC26(false, map[0x42 := seq(108, i0  => ('y'))])
		case DC33(cf57) => DC26(!true, map v1 : int | (0x210 <= v1) && (v1 < 0x317) :: (v1 - 586) := ("hsqevyqb"))
		case DC36(cf62) => if (!true) then DC26(true, map[-0x77 := seq(0xa9, i1  => ('e'))]) else DC26(false, map[-0x3b9 := "m"])
	}
}
function fm43(p0: int, p1: int, p2: int, globalState: GlobalState): seq<multiset<bool>> {
	([multiset{DC0(true).cf0, !true, true, true}] + [multiset{false}, multiset([true, false]), multiset{false}, multiset([true]), multiset{!false}]) + ([multiset{true}] + (seq(-251, i0  => (multiset([false, false])))))
}
function fm44(p0: bool, p1: int, p2: int, globalState: GlobalState): D2 {
	match DC41({[0x2b1]}) {
		case DC42(cf68, cf69) => DC8(-|[seq(0x261, i0  => (cf68))]|, -0x93, -0xd6)
...
function fm49(p0: int, globalState: GlobalState): set<seq<D9>> {
	({[DC31(DC30('h', false, |(map v0 : seq<int> | v0 in map[[386] := map[!true := true]] :: (v0) := (false))|, set v1 : int | v1 in multiset{954} :: (v1 / |[|map[|map[-0xfd := |map[false := 0x370]|]| := DC4(|{-0xf}|, |multiset{0x3ce, |[!false, false]|, |{true}|, 0x6a, |"xpse"|}|)]|, 0xa2, |[false, false, !false]|, 0x3a1]|), 0x115))], [DC31(DC31(DC29(map v2 : int | (0x8c <= v2) && (v2 < 0x284) :: (v2 + 0x125) := (|"phlpopw"|))))], seq(-0x1bf, i0  => (DC31(DC31(DC30('i', true, |map[true := |map[false := true]|]|, {|[true, true, true, true]|}, |(seq(-0x339, i1  => ('x')))|)))))} * {[DC31(DC31(DC31(DC30('w', false, |[|{false}|]|, {0x10f, 0x1bc}, 0xa8))).cf55), DC31(DC29(map[0x2dd := -0x1eb]))]}) * ((set v4 : seq<D9> | v4 in [[DC31(DC31(DC29(map v3 : int | (0x18a <= v3) && (v3 < -0xbb) :: (v3 / |(seq(0x397, i2  => ('f')))|) := (|multiset{-0x22f, 990}|)))), DC31(DC29(map[|multiset{false}| := |(seq(395, i3  => ('g')))|]))]] :: (v4)) - {[DC31(DC31(DC31(DC31(DC31(DC29(map[-463 := 0x259])))))), DC31(DC31(DC31(DC29(map v5 : int | v5 in map[|multiset{false, false}| := false] :: (v5 / |map['j' := |map[0x7e := |{|"fjfiraa"|}|]|]|) := (-|"to"|)))))]})
}
function fm50(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState): set<seq<int>> {
	{[|(map v0 : int | (0x266 <= v0) && (v0 < 0x1e4) :: (v0 + |(seq(-399, i0  => ('b')))|) := (true))|]} * {[|[true, false]|]}
}
...
function fm52(p0: int, globalState: GlobalState): map<int, seq<int>> {
	(map[|{false}| := [|{|multiset{true}|}|, |(seq(-0x135, i0  => (|"jlkqqbehd"|)))|, 589]] + map[0x242 := [---0x35b]]) + map[-0x21d := [83]]
}
function fm53(p0: bool, p1: bool, globalState: GlobalState): seq<set<int>> {
	[{-116, |[|[[|{!false}|], [50]]|, 0x3b1]|}, {|(map v0 : char | v0 in DC67("hac").cf108 :: (v0) := (|multiset(seq(0x1aa, i0  => (-|(seq(911, i1  => ('x')))|)))|))|}, {0x6a, -|[|multiset{|[false]|, 427}|]|}] + ([{|multiset{'q'}|, 0x146}] + [{0x377}])
}
function fm54(p0: int, p1: string, globalState: GlobalState): set<set<bool>> {
	if (!(|"pgi"| >= -|(seq(371, i0  => ('l')))|)) then {DC24({DC5(true, false).cf7}).cf45} else (set v0 : set<bool> | v0 in {{true, false}} :: (v0)) * {{true, false}}
}
function fm55(p0: bool, globalState: GlobalState): seq<seq<int>> {
	((seq(352, i0  => ([|"wvjfiqb"|]))) + [[-532, -0x1d6]]) + ([seq(0x148, i1  => (|multiset{false}|))] + [[|(seq(0x267, i2  => ('u')))|, |[false]|], seq(-0x3e2, i3  => (|"xoxncefj"|)), [0x329]])
}
method m11(p0: D13, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: map<int, array<T0>>) {
	...
	match ((if (false) then v2 else v2).(cf22 := "lkgqgh")) {
		...
		case DC14(cf26, cf27) =>
			...
			globalState.f3, globalState.f9 := |(if (p3) then v15 else v15)| / (|map[0x2b2 := cf26]| - |v17[v15[p1] := v16]|), v16.fm2(v15 <= v15, p2, globalState);
			...
			var v25: map<bool, int> := map[v16.fm2(p2, v19.f19, globalState) := -p1 / |v24|];
			v0, globalState.f9, v22[372], v1[564] := v0 + (seq(0x396, i0  => ('o'))), cf26, |v25|, p2;
			v1[564] := v15[v22[372]];
		case DC12(cf21) =>
			v1[719] := p1 < p1;
			var v26: set<bool> := {p3, p2, false};
			var v27: set<set<bool>> := {v26};
			globalState.f3, v1[719] := -(p1 % p1), fm54(0x352, v0, globalState) >= (v27 + v27);
			if (v1[719]) {
				globalState.f3 := p1;
				var v28: seq<int> := [p1];
				...
				var v35: set<int> := {|v34|};
				globalState.f9 := |([v32[p1], v31, v31, v31, v31] + v32)| !in v35;
				v1[719] := !true;
			} else {
				v1[719] := p1 >= p1;
				var v36: map<int, bool> := map[p1 := v1[719]];
				var v37 := DC5(p3, true);
				...
				var v43: map<bool, bool> := map[v1[719] := v1[719]];
				var v44 := 'c';
				var v45: map<char, int> := map[v44 := p1];
				var v46: seq<int> := [p1, p1, p1, p1, p1];
				var v47: set<seq<int>> := {v46, v46, v46, v46};
				v39, v1[719], v40 := v41[|v42|] - v39, if (!v1[719] in v43) then v43[!v1[719]] else fm23(|v36|, if (p1 in v36) then v36[p1] else !p3, v45, v47, globalState), v40;
				var v48: array<array<bool>> := new array<bool>[8] [cf21, cf21, cf21, cf21, cf21, cf21, cf21, cf21];
				v48[246] := cf21;
				v48[246] := new bool[29];
				var v49: multiset<bool> := multiset{p3, p2};
				var v50 := new C5(p1, p3, v49 - v49[p3 := |v49|]);
			}
			
			var v51: map<bool, bool> := map[p2 := p3];
			var v52: multiset<bool> := multiset{v1[719], v1[719], p2};
			var v53: multiset<int> := multiset{-0x231, p1};
			var v54: seq<int> := [p1];
			var v55: seq<seq<int>> := [v54];
			var v56: map<bool, int> := map[false := 622];
			var v57: array<int> := new int[23] [p1 % p1, fm0(p2, -p1, p1, (multiset{|v0|, -0x26e, p1, p1, -p1})[p1 := -|v51|], globalState), p1, p1 + -|v52|, p1, 978, fm0(false, p1, p1, v53, globalState), |v55|, p1, if (p2) then p1 else p1, if (v1[719]) then v54[p1] else p1, p1 / p1, p1, 0x3a1, -|v54|, p1, -|v54|, p1, if (v1[719] in v56) then v56[v1[719]] else 0xab, p1, p1, p1, p1];
			v57 := v57;
			if (-(p1 / p1) <= p1) {
				globalState.f9 := !(if (true) then v1[719] else p2);
				var v58: map<array<bool>, bool> := map[cf21 := v1[719]];
				var v59 := 'p';
				...
				var v67: C3 := new C3(fm0(v1[719], p1, p1, v53, globalState), v0[|map[fm0(fm23(p1, false, map v63 : char | v63 in v0 :: (v63) := (p1), set v65 : seq<int> | v65 in v64 :: (v65), globalState), p1, p1, v53, globalState) := v66]| := v59] + v0[p1 := v59], v1[719], v52);
				...
				var v81 := DC30(fm25(p1, p1, p3, fm1(p2, p1, true, v80, globalState), globalState), v1[719], p1, v80, 0x3c1);
				var v82: map<char, int> := map[v81.cf50 := -|(seq(0x210, i1  => (v75)))|];
				var v84: map<seq<int>, int> := map[[0x65] := p1];
				v1[719] := fm23(p1, false, (map v74 : char | v74 in v79 :: (v74) := (0x30d)) + v82, set v85 : seq<int> | v85 in (map v83 : seq<int> | v83 in v84 :: (v83) := (0x21c)) :: (v85), globalState);
				var v86: array<string> := new string[1] [v0];
				v86[664] := v0 + (seq(0x365, i2  => (v75)));
				v86[664] := v0;
				globalState.f3, cf21, r0 := 0x29b, cf21, p1 - |(v86[664] + v86[664][p1 := v86[664][|v56|]])|;
				v80 := (v80 * v80) + ({p1} - v80);
				var v87 := DC3(p1);
				v57[906] := v87.cf3;
				v57[906] := (p1 / 0x1da) - p1;
		...
		case DC15(cf28) =>
			...
			var v98: T0 := new C8(v95, v97, v93[|v93|], v90[p3 := -p1]);
			var v99 := DC9(v98.f14, 0x13, v0[p1]);
			...
			var v105: C8 := new C8(map[p1 := v94], v97, v98.f14, (multiset{p2})[v98.f14 := p1]);
			var v106: multiset<C8> := multiset{v105};
			var v107: map<int, bool> := map[p1 := v98.f14];
			v100[988], r0, v103[718], v1[672], v94[614] := v104[p1], -(-(|multiset{-|v106|}| * p1) + p1), p1, if (|fm27(0x1d3, v98.f14, globalState)| in v107) then v107[|fm27(0x1d3, v98.f14, globalState)|] else p2, v88;
			if (!v1[672]) {
				var v108 := new C2(v107);
				v103[718] := v91[v103[718]];
				var v109: array<array<array<int>>> := new array<array<int>>[12];
				var v110: map<int, array<int>> := map[v103[718] := v103];
				...
				v109[822] := v112;
				v109[822], globalState.f3, globalState.f3 := v112, v103[718], p1 / v103[718];
				var v113 := new C1();
				var v114 := DC1(p3);
				v114 := v114;
			} else {
				...
				globalState.f2 := if ((if (v98.f14) then v103[718] else -369) in v116) then v116[if (v98.f14) then v103[718] else -369] else v115;
				var v117: map<map<int, bool>, bool> := map[map[v103[718] := v98.f14] := v98.f14];
				...
				v125[26] := v124;
				v125[26] := v124;
				v103[718], v98.f14 := 0x29b % fm0(v98.f14, 0xad, p1, v102, globalState), p3;
				globalState.f2 := v115;
				var v126: set<int> := {|v96|};
				v98, globalState.f3, v88, v126 := v98, -((|v107| + v103[718]) / p1), v94[614], v126 + (fm6(globalState) + v126);
			}
	...
	var v132: map<int, bool> := map[-(p1 / -p1) := v127.fm10(v128, v131, v129.f19, v0, globalState)];
	if (if ((p1 / p1) in v132) then v132[p1 / p1] else p3) {
		globalState.f3 := p1 + p1;
...
class C1 {
	...
	method m10(p0: array<map<int, char>>, p1: array<int>, p2: bool, globalState: GlobalState) returns (r0: D1, r1: int, r2: bool, r3: int) {
		if (p2) {
			...
			var v4 := -0x2e2;
			var v5 := new C0(v3[v4] <= "rylyonx", true);
			var v6 := new C0(!v5.f23, true || v5.f23);
			var v7: map<bool, int> := map[p2 := v4];
			r3 := -v4 - (-(if (p2 in v7) then v7[p2] else v4) / v4);
			var v8: seq<int> := [v4];
			v8 := v8;
		} else {
			...
			var v14: array<int> := new int[27] [|v11|, v10, v10 - 620, v10, |v12|, fm0(p2, v10, v10, multiset{v10, v10, v10}, globalState), v10, v10, v10, v10, v10, v10, v10, v10, fm0(p2, v10, v10, multiset{0x226, v10}, globalState), v10, v10 % v10, |(v13 * v13)|, v10, v10, v10, |v11|, v10, v10, 589, v10, v10];
			v14 := p1;
			...
			v11 := fm21(DC3(fm0(p2, v10, p1[69], v17[v10 := v10], globalState)), v15[p1[69]], v19, globalState);
			...
			var v25: array<map<bool, int>> := new map<bool, int>[15] [v21, if (p2) then v21 else v21, v21, v21 + v21, (fm1(if (p2 in v12) then v12[p2] else p2, p1[69], true, fm22(|v22|, v24, p2, p2, globalState), globalState))[p2 := v10], v21[false := p1[69]], v21 + v21, v21, v21, v21, v21, v21, v21, v21, v21 + v21];
			v25[374] := v21 + v21[p2 := p1[69]];
			var v26 := DC5(true, p2);
			var v27: set<D1> := {DC5(!p2, p2), v26, v26, v26, v26};
			globalState.f3, globalState.f9, v25[374], v11 := |(v27 + v27)|, p2, map[p2 := p1[69]] + v21, v11 + (seq(624, i0  => (|map['h' := 'o']|)));
		}
		...
		if (fm23(v28 / v28, fm23(v28, p2, fm24(v28, p2, p2, v28, globalState), {v29, v29}, globalState), v31 + v31[v30 := v28], v32, globalState)) {
			...
			match (v37) {
				case DC4(cf4, cf5) =>
					var v38 := DC3(cf5);
					var v39: array<bool> := new bool[29] [p2, !!p2, p2, false, fm23(v28, true, v31, {fm21(v38, p2, seq(-0x396, i1  => (v34)), globalState)}, globalState), p2, p2, p2, p2, p2, false, p2, p2, p2, !v33[cf5], false, p2, true, p2, true, p2, p2, p2, v33[cf4], !false, p2, p2, p2, true];
					var v40: map<bool, array<bool>> := map[v33[cf4] := v39];
					var v41: C0 := new C0(p2, !p2);
					var v42: seq<C0> := [v41, v41, v41];
					v39[170] := v42 == v42;
					v35, v40, v39[170] := v35, v40, if (cf4 < cf4) then v41.f23 else p2;
					var v43: array<D2> := new D2[28];
					v43[395] := v34;
					var v44: map<bool, int> := map[v39[170] := 0x11c];
					v30, v41, v30, cf5, v43[395] := fm25(cf4, -(cf4 + cf4), v41.f23, v44, globalState), v41, v30, 0x3b4, v34;
					var v45: map<array<int>, bool> := map[p1 := v41.f23];
					v45 := v45[p1 := v41.f23];
					var v46: multiset<int> := multiset{-v28};
					var v47: map<array<int>, set<bool>> := map[p1 := {v39[170]}];
				...
				case DC5(cf6, cf7) =>
					...
					var v53: map<seq<int>, string> := map[v29 := v52[|[v28, v28, v28]|]];
					globalState.f9 := v29 !in v53;
				case DC3(cf3) =>
					r3, r3 := v28, (cf3 % 0x144) * |v35|;
				...
				case DC6(cf8) =>
					...
					var v57: array<bool> := new bool[27] [p2, p2, p2, p2, p2, p2, true, p2, p2, p2, if (p2 in v56) then v56[p2] else p2, p2, p2, p2, p2, p2, p2, v33[v28], p2, p2, !false, p2, v33[v28], true, p2, p2, false];
					var v58 := DC13(v35, |v35[0x2eb := v30]|, !false, v57);
					var v59 := DC15(v58);
			...
			var v72: map<bool, seq<char>> := map[p2 := (seq(0x2c3, i3  => (v30)))[fm0(p2, v28, v28, v71, globalState) := v30]];
			v72, v29 := (v72 + v72) + v72, seq(59, i4  => (DC4(-0x346, v28).cf4));
			...
			v73[920] := v75;
			v73[920] := v75 + (v75 + fm26(v28, p2, |v74|, globalState));
			var v76: array<string> := new string[6](i6 => "tulofkoow");
			v76[573] := (seq(0x258, i7  => (v30))) + v74[v28 := v30];
			v76[573] := fm27(-v28, p2, globalState) + v74;
		...
		for i8 := p1[15] to v28 {
			...
			if (v28 <= i8) {
				...
				globalState.f3 := fm0(fm23(i8, v80.f23, v31, {v29}, globalState), |v89| + v28, |{p1[15]}|, multiset{i8}, globalState);
				...
				globalState.f9 := !((v92[v91 := 911] - v92) == v92);
			}
		...
		r1 := p1[15];
		var v95: seq<bool> := [!p2];
		var v96: seq<seq<bool>> := [v95, v95[|map[p1[15] := p1[15]]| := p2]];
		var v97: multiset<int> := multiset{-v28};
		var v98: seq<D5> := [DC17(v96, p2, v97).(cf31 := p2)];
		r2 := fm23(p1[15], p2, map[v30 := |v98|] + v31, v32, globalState);
		r3 := v28;
	}
}
...
class C2 {
	...
	method m8(p0: array<int>, globalState: GlobalState) returns (r0: char, r1: int, r2: D3) {
			...
			decreases 100 - i0
		{
			...
			match (v2) {
				case DC1(cf1) =>
					var v3 := 0x8;
					globalState.f3 := v3;
					var v4: array<seq<D1>> := new seq<D1>[24](i1 => (seq(981, i2  => (DC4(v3, v3)))) + [DC4(|f22|, |map[v3 := |map[cf1 := v0]|]|)]);
					...
					var v13: array<int> := new int[8] [|"cudqbqnau"|, -0x62, v3 + v3, v3, |(if (false) then [v3] else v8[v3 := |v10|])|, v3 - |v8|, fm0(cf1, v3, 0x1b9, multiset(v8), globalState) / -|v12[v3]|, |v8| + 0x22e];
					...
					v4, v3, v13, v9, v14[203] := v15[v3 * |v16|], fm0(false, v3 + 0x166, v3, v17, globalState), v13, DC12(v9).cf21, v2.(cf1 := cf1);
					var v18 := new C1();
					p0[418] := v3;
					p0[418] := (v3 * v3) * (v3 - v3);
				case DC0(cf0) =>
					var v19 := DC0(v0);
					v19 := v19;
					var v20: map<bool, string> := map[cf0 || v0 := seq(0x211, i3  => (v1))];
					var v21 := "lksdhhcbj";
					v20 := v20[cf0 := v21];
					var v23 := m9(|(set v22 : int | (0x1f6 <= v22) && (v22 < 693) :: (v22 / |v21|))|, globalState);
				...
				case DC2(cf2) =>
					...
					var v30: array<array<D4>> := new array<D4>[10] [v28, v28, v28, v28, v28, if (true) then v28 else v28, v28, v28, if (p0[63] in v29) then v29[p0[63]] else v28, v28];
					v30[97] := v28;
					v30[97] := v28;
			}
			...
			decreases 100 - i4
		{
			...
			var v39: map<int, set<int>> := map[v31 := v38[v31]];
			v39 := v39[v31 := v37];
			var v40 := "ncnudk";
			var v41: multiset<int> := multiset{|v40|, v31, v31, v31, v31};
			p0[215] := |v41|;
			p0[215] := |(seq(0x322, i5  => (v31)))| + fm0(v0, v31, v31, v41, globalState);
			var v42 := new C0(v0, v0);
			var v43: map<int, int> := map[p0[215] := v31];
			r1 := |[|v43|]| + p0[215];
		}
		var v44: multiset<bool> := multiset{!v0};
		var v45: seq<int> := [v31, v31, v31, v31, 0x1ee];
		globalState.f3 := |v44| % |(if (v0) then v45 else v45)|;
		r0 := v33;
		r1 := v31;
		var v46: seq<map<char, int>> := [v34, v34, v34, map['v' := 0x2bd], v34];
		var v47 := "ymak";
		var v48 := DC10(v32);
		r2 := if (fm23(v31, v0, v46[|v47|], v35, globalState)) then v48 else v48;
	}
	method m9(p0: int, globalState: GlobalState) returns (r0: int) {
		...
		var v3 := "p";
		var v4 := DC19(DC17(fm29(globalState), v0, v2[-|v3|]));
		var v5: seq<D5> := [v4];
		var v6: seq<bool> := [v0];
		var v7 := DC7(v6);
		...
		globalState.f9 := v6[|(v9 + v9)|];
		var v10 := new C1();
		var v11: array<bool> := new bool[23](i0 => DC18(true).cf33);
		v11[190] := v0;
		v11[512] := !v0;
		v11[190], v0, v8[459], v11[512] := v0, !((p0 / v8[459]) <= v8[459]), v8[459] % fm0(v0, 0xb1, v8[459], v1, globalState), v0;
		v11[190], v8[459] := v11[190], 0xae;
		var v12 := 'q';
		var v13: map<bool, bool> := map[!v0 := v11[190]];
		var v14: seq<int> := [p0, |v13|, p0, v8[459]];
		var v15: set<seq<int>> := {v14};
		var v16: set<bool> := {v0, fm23(v8[459], false, map[v12 := v8[459]], v15, globalState)};
		if ((v16 * v16) > v16) {
			if (v11[190]) {
				var v17: map<bool, int> := map[v0 := p0];
				var v18: map<string, map<bool, int>> := map[v3 := v17];
				var v19 := DC11(p0, |v13|, v0, v14[p0]);
				v18 := v18[if (v0) then "byt" else "e" := fm1(v19.cf19, v8[459], !v0, fm22(p0, [map[p0 := v0], map[p0 := v11[190]]], v0, !v11[190], globalState), globalState)];
				var v20: multiset<map<bool, int>> := multiset{v17[v11[190] := p0], map[v0 := p0]};
				v8[459] := |v20|;
				globalState.f3 := p0;
				globalState.f9 := !v0;
				...
				var v23 := DC17(v22, v11[190], v1);
				globalState.f9, v21, v8[459], globalState.f9, v11[190] := v11[190], v21, -((v8[459] / p0) - -(|v1| * v8[459])), true, (v11[190] || !v11[190]) ==> v23.cf31;
				globalState.f3 := 0x1f;
				v11[190] := 0x372 == (p0 * v8[459]);
			}
			
			v8[459] := p0 * (v8[459] * p0);
			if (v11[190]) {
				var v24: map<int, int> := map[v8[459] := p0];
				v24 := (map[v8[459] := v8[459]])[v8[459] := -p0] + v24;
				globalState.f9 := p0 >= p0;
				var v25 := DC14(v0, 446 <= p0);
				v25 := v25;
				v0 := v0;
				v8[459] := -(if (v11[190]) then v8[459] else -p0 / |v3|);
			} else {
				globalState.f9 := !!v0;
				var v26: array<char> := new char[16](i1 => v12);
				v26[846] := v12;
				v26[846] := v12;
				var v27: map<char, int> := map[v26[846] := 0x76];
				var v28 := DC5(v0, fm23(v8[459], v11[190], v27, v15, globalState));
				var v29 := DC6(v28);
				var v30 := DC6(v28);
				var v31: map<int, D1> := map[p0 := v30];
				v31 := v31[p0 := v30];
				globalState.f3 := |map[fm25(fm0(v0, |v1|, v8[459], v1, globalState), v8[459], v0, map[fm23(|v1|, v0, v27, v15, globalState) := v8[459]], globalState) := v6]|;
				globalState.f3 := --0xcc % (-v8[459] / v8[459]);
			}
			
			v0 := true;
			var v32 := DC9(v11[190], p0, v12);
			var v33 := DC13(v3, v8[459], v11[190], v11);
			v8[459], v3, v11[190], globalState.f3 := v32.cf14, v33.cf22, false, (p0 % p0) + fm0(v11[190], p0, p0, v1, globalState);
		} else {
			globalState.f3 := 0x343;
			globalState.f3 := --((v8[459] / v8[459]) % v8[459]);
			var v34 := DC13(v3, 452, v0, v11);
			var v35: seq<D4> := [v34, v34, v34];
			v0 := v35 <= v35;
			var v36 := DC9(v0, -p0, v12);
			var v37: set<multiset<bool>> := {multiset{!true}, multiset{v11[190]}};
			var v38: map<char, int> := map[if (false) then v36.cf15 else v12 := v8[459] - |v37|];
			var v39: multiset<array<int>> := multiset{v8};
			v38 := v38['w' := |v39|];
			if (!(v8[459] == v8[459])) {
				globalState.f13 := v16;
				var v40: map<int, char> := map[v8[459] := v12];
				var v43 := DC20(v40);
				var v44: array<map<int, char>> := new map<int, char>[28] [v40, v40[p0 := 'o'], v40, map v41 : int | v41 in fm30(v11[190], globalState) :: (v41 / |v6|) := (v12), v40, map v42 : int | (-39 <= v42) && (v42 < -511) :: (v42 % v8[459]) := ('v'), v40, fm31(v0, v0, globalState), v40, v40, v40, v40, v40, v40, v40, map[p0 := v12], v40, v40, v43.cf35, v40, v40, fm31(true, v0, globalState), v40, v40, v40, map[v8[459] := v12], v40, v40];
				var v45 := DC1(v0);
				var v46, v47, v48, v49 := v10.m10(v44, v8, v11[190] && v45.cf1, globalState);
				var v50: multiset<char> := multiset{v12, v12, v12, v12, v12};
				var v51 := DC14(|fm29(globalState)| != |v50|, v11[190]);
				var v52: multiset<bool> := multiset{v48, v11[190], v0, v11[190], v48};
				v51 := DC14(if (v49 in f22) then f22[v49] else v0, v0).(cf26 := v52 > v52);
				globalState.f3 := v47;
				var v53 := new C0(v0, v0);
			} else {
				v8[459] := 0x120;
				globalState.f9 := v11[190];
				globalState.f9 := v0;
				var v54: map<int, string> := map[p0 := seq(-811, i2  => (v12))];
				v3 := v3 + (if (-v8[459] in v54) then v54[-v8[459]] else "tecdvlbj");
				var v55: map<int, seq<bool>> := map[327 := v6];
				var v56: multiset<bool> := multiset{v0, v0, v0};
				r0, r0 := |{|v55| <= 970, v11[190], v0, v11[190]}|, if (if (v11[190] in v13) then v13[v11[190]] else false) then |v9| else if (v0 in v56) then v56[v0] else fm0(v11[190], p0, p0, v1[554 := |v14|], globalState);
			}
			
		}
		
		var v58: set<char> := {v12};
		r0 := fm0(!v0, fm0(v11[190], v8[459], v8[459], multiset{v8[459]}, globalState), |(map v57 : char | v57 in v58 :: (v57) := (v11[190]))|, if (false) then v1 else v1, globalState);
	}
}
...
class C3 extends T0 {
	...
	function fm3(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): string {
		("dowcmd" + (f21[|(seq(0x3b8, i0  => ('j')))| := 'y'] + f21))[f20 := 'a']
	}
	method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: map<map<int, bool>, int>, r3: bool) {
		...
		v0 := v0 - (multiset{v2[false := f14], v2})[v1 := fm0(f14, f20, f20, v3, globalState)];
		var v4 := DC7([f14]);
		var v5: multiset<D2> := multiset{v4};
		v5 := v5;
		globalState.f3 := 0x2c9 / (f20 * 115);
		...
		for i0 := f20 to |v6| {
			...
			globalState.f2, globalState.f9, v7[290], globalState.f3 := v8, !f14, if (fm2(f14, f14, globalState) in f15) then f15[fm2(f14, f14, globalState)] else |(seq(0x36b, i1  => (f21)))|, v9.cf4;
			var v10: array<string> := new string[24];
			v10[632] := seq(-0x3e1, i2  => ('f'));
			var v11: array<D1> := new D1[8](i3 => v9.(cf4 := -v7[290]));
			v11[817] := v9;
			v7[290], v10[632], r1, globalState.f3, v11[817] := i0, f21, (if (true) then false else f14) || f14, i0, v9;
			v7[290] := 578;
			if (true) {
				var v12: map<int, bool> := map[f20 := f14];
				v12 := map[i0 := true] + (v12 + v12);
				var v13 := DC0(!f14);
				var v14: array<D0> := new D0[13] [v13, v13, fm20(-0x23f, v7[290], v7[290], globalState), if (f14) then v13 else v13, fm20(600, v7[290], v7[290], globalState), v13, if (f14) then v13 else v13, v13, v13, if (f14) then v13 else v13, v13, v13, v13];
				v14[768] := v13;
				v14[768] := v13;
				var v15 := 'e';
				var v16: multiset<char> := multiset{v15, 'p'};
				var v17: seq<int> := [f20];
				globalState.f3, v16, globalState.f3, globalState.f3, globalState.f3 := f20, v16, i0, f20, v17[f20];
				var v18: map<bool, multiset<bool>> := map[f14 := multiset{f14, f14, f14, f14, false}];
				v8[322] := |(if (!f14 in v18) then v18[!f14] else f15)| != i0;
				v8[322] := true;
				globalState.f3 := f20 - v7[290];
			} else {
				var v19 := new C2(map[f20 := f14]);
				var v20: map<bool, int> := map[if (f14) then f14 else f14 := f20];
				v20 := v20[f14 := v7[290] * i0];
				v7[290] := (0x291 % v7[290]) / 0x277;
				var v21: map<int, int> := map[v7[290] := i0];
				var v22: map<array<int>, map<int, int>> := map[v7 := v21];
				var v23: seq<int> := [v7[290]];
				var v24: array<map<array<int>, map<int, int>>> := new map<array<int>, map<int, int>>[25] [v22, map[v7 := v21] + v22, v22, map[v7 := v21], v22, map[v7 := v21], v22, v22 + v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22 + v22, v22[v7 := v21], map[v7 := v21] + v22, v22 + v22, v22 + v22, map[v7 := v21], v22 + v22, map[v7 := map[135 := fm0(f14, i0, -v23[v7[290]], multiset(v23), globalState)]]];
				v24[349] := v22 + v22;
				v24[349] := v22[v7 := v21];
				f14 := if (v6[i0]) then f14 else f14;
			}
		...
		if (!f14) {
			...
			var v34 := 'p';
			var v35: map<array<char>, string> := map[v33 := f21[f20 := v34]];
			v35 := v35;
			globalState.f3 := 0xff;
		}
	...
	method m1(p0: set<int>, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		v2[232] := |fm27(|p0|, v1.f24, globalState)|;
		v2[232] := p1 / fm0(v0[887], f20, p1, fm30(false, globalState), globalState);
		forall i0 | 0 <= i0 < v2.Length {
			v2[i0] := i0 + DC11(|map[f20 := -f20]|, |map[p0 := map[p1 := DC9(!v1.f24, p1, 'w')]]|, v1.f24, f20).cf20;
		}
		if (false) {
			r2 := if (v0[887]) then p1 >= |f21| else f14;
			var v3: array<string> := new string[24];
			v3[644] := f21;
			v3[644] := f21;
			var v4: map<string, bool> := map[f21 := v1.f23];
			var v5: seq<bool> := [v1.f23];
			globalState.f6 := {true, if (v1.f23) then if (v3[644] in v4) then v4[v3[644]] else v5[p1] else v1.f24, !!false};
			f14 := !fm2(f14, !(v1.f23 <==> v1.f24), globalState);
			var v6 := 'f';
			f14, v6, v0[887] := v1.f24 && v1.f24, v6, v1.f24;
		} else {
			var v7: array<array<int>> := new array<int>[20];
			v7[283] := v2;
			v7[283] := new int[8];
			globalState.f9 := v1.f24;
			var v8: map<bool, bool> := map[v0[887] := !v0[887]];
			var v9 := DC10(v8[v0[887] := v1.f23]);
			var v10: map<D3, bool> := map[v9 := v2[232] < -|[f14, v1.f24]|];
			v10 := v10[v9 := v1.f23];
			var v11: set<int> := {p1};
			v11 := v11 - (if (v0[887]) then v11 else v11);
			v0[887] := v1.f23;
		}
		...
		r0 := |(f15 - f15)| - |v14|;
		var v15: multiset<int> := multiset{v2[232], p1};
		r1 := (|{p1}| * |v15|) - (f20 / 546);
		r2 := !(!false ==> (p1 > |fm27(-|v12|, v0[887], globalState)|));
	}
}
...
class C4 extends T0 {
	...
	function fm3(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): string {
		((seq(-0xd, i0  => ('i'))) + "xlscb") + ("fu" + (seq(866, i1  => ('x'))))
	}
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: map<map<int, bool>, int>, r3: bool) {
		if (!f19) {
			...
			v0[891] := (fm19(v1, v2[-v1], globalState) - v4) !! (set v6 : char | v6 in v5 :: (v6));
			globalState.f9 := f14;
			var v7: map<bool, bool> := map[v0[891] := f14];
			...
			globalState.f3 := fm0(v1 >= |f15[f19 := v1]|, v1, v14.cf20, v12, globalState);
		} else {
			var v15 := DC5(f14, f14);
			...
			var v18 := -0x26a;
			var v19: array<seq<array<D1>>> := new seq<array<D1>>[12] [v17, v17 + v17, (v17 + v17)[v18 := v16], v17, v17, v17, v17, [v16, v16], v17, v17 + v17, v17, v17];
			v19[930] := v17;
			v19[930] := (v17 + v17) + (v17 + v17);
		...
		var v28 := -847;
		var v29: seq<int> := [v28];
		var v30: multiset<int> := multiset{v29[|(seq(-0x261, i2  => ('b')))|]};
		...
		var v35: seq<string> := [seq(-0xc9, i4  => ('y'))];
		var v36: array<bool> := new bool[22] [if (v33 in v34) then v34[v33] else f14, 0x179 <= v28, f19, v28 <= -v28, f19, fm2(f19, f14, globalState), !f19, f19, f14, v32 != v35[v28], fm2(f19, f19, globalState), !f19, f19 <==> f14, f14 ==> f14, false, true || false, if (f14) then f14 else f19, f14, false, f14, multiset{v32} !! multiset{"lpfkgsqvw"}, !f14];
	...
	method m1(p0: set<int>, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		if (f19 <== !(f14 <== f19)) {
			...
			if (v4 !in {v4, if (v5 in v6) then v6[v5] else v4, v4, v4}) {
				var v7 := 'v';
				var v8 := new C3(p1, v3[p1 := v7], f14, v4.f15);
				v0[899] := v8.f21;
				v0[899] := if (!f19) then v8.f21 else v8.f21;
				var v9: set<seq<int>> := {seq(0x2ed, i2  => (|v8.f21|))};
				var v10: seq<bool> := [f19];
				var v11: seq<bool> := [v10[p1]];
				var v12: set<string> := {v8.f21};
				r2 := if (!fm23(v8.f20, v4.f14, map[v7 := p1], v9, globalState)) then v11 == v10[v8.f20 := f19] else fm34(globalState) > v12;
				var v13: array<bool> := new bool[8];
				globalState.f2 := v13;
				var v14: array<seq<bool>> := new seq<bool>[23](i3 => ([v4.f14])[|{f14}| := true]);
				v14[603] := [true, v4.f14, v4.f14];
				v5[7] := v8.f20 * p1;
				v14[603], v7, v5[7], f14 := v10, v7, -(|v3| + p1) / |(v4.f15 - v4.f15)|, v4.f14;
			} else {
				r0 := p1 * -p1;
				r0 := -(0x26d - (if (v4.f14) then p1 else -p1));
				var v15: multiset<bool> := multiset{f19, p1 != p1, false, false, true};
				v15 := ((multiset{v4.f14})[v4.f14 := p1] - multiset{v4.f14, f14, f19, f19}) - (v4.f15 + v15);
				v5[591] := p1;
				v5[591] := p1;
				r2 := v4.f14;
			}
			...
			match (v35) {
				case DC1(cf1) =>
					...
					v18 := fm25(p1, p1 / p1, v18 in v36, v37, globalState);
					globalState.f3 := p1;
					globalState.f9 := cf1;
					var v38: array<D3> := new D3[8](i4 => DC10(map[DC5(f14, f19).cf6 := cf1]));
					v38 := v38;
				case DC0(cf0) =>
					globalState.f3 := p1 / (if (p1 in v22) then v22[p1] else p1);
					...
					v42[853] := (f19 <== f19) && v43[p1];
					m6(globalState);
				case DC2(cf2) =>
					var v44: array<array<int>> := new array<int>[3];
					var v45: array<int> := new int[25](i5 => i5 / 0x24c);
					v44[265] := v45;
					v44[265] := v45;
					var v46 := DC23(f14, |v20[-p1 := p1]|, f14);
					...
					v49[870], v57[25] := !!!f14, if (f19 in v58) then v58[f19] else v56;
					var v59: map<int, bool> := map[-0x107 := false];
					v44[265][932] := if (p1 in v21) then v21[p1] else |v59|;
					var v60: map<bool, int> := map[v49[870] := |(seq(0x102, i7  => (p1)))|];
					globalState.f3, v44[265][932] := if (f19 in v60) then v60[f19] else p1, p1 - p1;
			}
			
			var v61: array<int> := new int[6](i8 => i8 + p1);
			v61[327] := p1;
			var v62: seq<bool> := [fm2(f14, false, globalState)];
			r0, v61[327], globalState.f3, r2, globalState.f3 := p1, p1, p1 * |(v62 + v62)|, fm2(f14, f19, globalState), if (fm2(f14, f14, globalState)) then |(v62 + v62)| else p1;
		}
		...
		if (f19) {
			...
			m7(v71, v69[949], p1, v69[949], globalState);
			r2 := p1 == p1;
		} else {
			globalState.f3 := -0x1ca / 0x2cb;
			var v72: set<bool> := {true};
			if (f14 !in v72) {
				var v73: array<set<bool>> := new set<bool>[8];
				v73 := v73;
				var v74: seq<bool> := [f14, f19];
				globalState.f9 := v74[p1];
				var v75 := DC1(!f14);
			...
			v88 := v88;
			var v89: array<int> := new int[1](i10 => i10 / 380);
			...
			var v97 := DC11(|v92|, |(if (v95[p1] in v94) then v94[v95[p1]] else map[v96[p1] := p1])|, f19, p1);
			v89, globalState.f9, v97, f14 := v89, f19, v97, !f19;
			globalState.f9 := v95[0x20d];
		}
		...
		if (f19 && !f14) {
			...
			if (!fm2(p1 > p1, f19, globalState)) {
				...
				v99[808], r0 := v102[v107.cf43], p1;
				var v108: map<int, bool> := map[p1 := false];
				var v109: map<map<int, bool>, int> := map[v108 := v99[808]];
				var v110 := DC21(v109);
				var v111: set<bool> := {f14, f14, f19, f14, f14};
				globalState.f3, r0, v99[808], v110 := |(({f14, false, f14, f14} * {f19}) * v111)|, v99[808], v99[808], v110;
			} else {
				var v112: multiset<D8> := multiset{DC25()};
				var v113 := DC7(v98);
				globalState.f3, r1, v112, v63 := |v113.cf9|, (p1 + p1) % p1, v112 * v112, "e";
				globalState.f3 := p1;
				var v114: seq<int> := [p1];
				...
				var v118: C3 := new C3(p1, seq(0x29d, i12  => ('b')), f19, f15);
				...
				v127[129], v128[891], globalState.f9 := v117.(cf18 := p1, cf19 := v120 !in v129), f15, ((map[[fm23(|v118.f21|, fm23(v118.f20, f19, v129, v130, globalState), map v131 : char | v131 in v118.f21 :: (v131) := (p1), set v132 : seq<int> | v132 in multiset{v114, [-0x222]} :: (v132), globalState), f14] := f19])[[f19] := f19])[v98 := f19] == v133;
			...
			globalState.f3, f14, v137[773] := -p1, v138 > v138, p1 / p1;
		} else {
			var v139: multiset<bool> := multiset{f19 || f19};
			var v140: array<array<bool>> := new array<bool>[20];
			var v141: seq<bool> := [f19];
			var v142 := DC1(f14);
			var v143: array<bool> := new bool[12] [f14, f14, f14, f14, !f14, v141[p1], f19, f14, v142.cf1, f19, f19, f14];
			v140[985] := v143;
			v139, v140[985] := v139 + f15, if (false) then v143 else v143;
			v143[828] := f19;
			var v144: set<bool> := {f19, f19, false};
			v143[828] := (--|v144| >= 70) ==> !f14;
			...
			globalState.f3, v145, v63 := -|v63| % p1, v145 + v148[|(map v149 : int | (581 <= v149) && (v149 < 0x1b7) :: (v149 / |v144|) := (f19))|], v63;
			var v150: multiset<int> := multiset{p1, p1};
			var v151 := DC4(fm0(v143[828], p1, p1, v150, globalState), p1);
			...
			match (v153) {
				case DC11(cf17, cf18, cf19, cf20) =>
					...
					var v155 := 'd';
					var v156 := DC29(v145);
					v154 := v154[v63[|(seq(345, i14  => ('v')))| := v155] := v156.cf49];
					r2 := if ((cf20 * cf17) in v147) then v147[cf20 * cf17] else cf19;
					var v157: set<char> := {v155, v155};
					var v158: seq<set<char>> := [v157, v157 - v157];
					v158 := v158;
					f14 := ((seq(0x89, i15  => (v155))) != v63) <== cf19;
				case DC10(cf16) =>
					m6(globalState);
					var v159: array<int> := new int[1] [p1 - p1];
					v159[918] := 0x3c6;
					v159[918] := (p1 + fm0(f14, p1, p1, fm30(f19, globalState), globalState)) - p1;
					r2 := true;
					v143[828], globalState.f2, r0, globalState.f3 := v159[918] >= v151.cf4, v143, -942, p1 * v159[918];
			}
			
			var v160: map<array<bool>, int> := map[v140[985] := p1];
			var v161 := DC13(seq(671, i16  => ('p')), 0x312, f19, v140[985]);
			var v162: multiset<seq<bool>> := multiset{[f14, f19]};
			r1, globalState.f3, r1, r0, r1 := |fm30(v143[828], globalState)| + p1, -(if (-|v160| != p1) then p1 / p1 else p1), (p1 * p1) - -p1, p1 + (--|v161.cf22| * -p1), (fm17(p1, f14, v162, p1, globalState) / p1) / p1;
		}
		
		var v163: array<bool> := new bool[15];
		var v164: seq<array<bool>> := [v163];
		var v165 := DC13("uoqpauedn", p1, f14, v164[p1]);
		match (v165.(cf22 := seq(0x1af, i17  => ('m')))) {
			case DC13(cf22, cf23, cf24, cf25) =>
				var v166: map<int, bool> := map[cf23 := cf24];
				var v167: map<int, map<int, bool>> := map[|v63| := v166];
				v167 := v167[cf23 / cf23 := v166];
				cf25[241] := cf24;
				cf25[241] := fm2(f19, f14, globalState);
				if (cf25[241]) {
					var v168: array<int> := new int[17](i18 => i18 + p1);
					var v169: map<int, array<int>> := map[p1 := v168];
					globalState.f3 := -|((v169 + v169) + v169)|;
					var v170: C3 := new C3(p1, v63[cf23 := 't'], false, f15);
					v170 := v170;
					...
					var v174: seq<int> := [p1];
					var v175 := DC9(cf25[241], v171.f20, v172);
					var v176: seq<bool> := [f14];
					var v177: set<string> := {v63};
					var v179: array<D9> := new D9[21] [DC30(v172, f19, cf23, p0, p1), v173, v173, v173, v173.(cf50 := v172), v173, v173, DC30(v172, cf24, v170.f20, p0, 746), DC30(v172, f19, v171.f20, p0, p1), DC30(v172, false, -|[v174, v174]|, {v171.f20, 0x5}, v171.f20), DC30(v175.cf15, cf25[241], v170.f20, p0, v170.f20), v173, fm39(|v176[p1 := cf25[241]]|, v170.f20, p1, |v177|, globalState), v173, DC30(v172, f19, v170.f20, p0, p1), v173, DC30(v172, cf25[241], |(map v178 : char | v178 in (seq(-0x244, i19  => (v172))) :: (v178) := (false))|, {|v170.f21|}, v171.f20), v173, v173, v173, v173];
					var v180: map<array<D9>, bool> := map[v179 := cf25[241]];
					r2, cf24 := if (v179 in v180) then v180[v179] else DC4(v170.f20, v170.f20).cf4 !in (seq(588, i20  => (|map[cf24 := cf24]|))), v171.fm2(false, cf24, globalState);
				} else {
					f14 := (p1 - |"qd"|) != cf23;
					...
					cf25[241] := cf25[241] <== fm23(p1, if (|v190| in v166) then v166[|v190|] else f14, v192, v194[940], globalState);
					var v195 := new C2(v166 + v166);
				}
				
				var v196: map<bool, multiset<bool>> := map[cf24 := f15];
				var v197 := new C3(p1, cf22 + cf22, cf24, if (cf25[241] in v196) then v196[cf25[241]] else f15);
			case DC14(cf26, cf27) =>
				var v198: multiset<int> := multiset{fm0(f14, p1, |v63|, multiset{|(seq(-0x354, i21  => ('v')))|}, globalState), |v63|, 0x365};
				var v199: seq<multiset<int>> := [v198, multiset{p1}];
				r1 := fm0(cf26, |v63|, p1, v199[p1] * v198, globalState);
				var v200: seq<multiset<bool>> := [f15];
				var v201: seq<int> := [-|[p1, p1]|, p1];
				m7(v200 + (seq(0x302, i22  => (f15))), p1 >= |v201|, -0x1c4, cf27, globalState);
			...
			case DC12(cf21) =>
				...
				var v210: array<seq<int>> := new seq<int>[28] [seq(955, i23  => (681)), v203, v203, [p1], fm21(v204, f14, fm40(globalState), globalState), v203, v203, v203, v203, v203, v203, v203, v203, v203, v203, [0xbd], v205.cf56, if (v207 in v208) then v208[v207] else v203, if (f19) then v203 else v203, v203, v203, v203 + v203, [p1, p1], seq(-99, i24  => (|[!f19, f19, f14, f19, f19]|)), v203 + v203[|v209| := 790], v203, v203, v203];
				v210 := v210;
				...
				var v215: set<seq<int>> := {seq(0x206, i25  => (|map[0x16e := |(map v214 : int | (210 <= v214) && (v214 < 0x3cc) :: (v214 * p1) := (true))|]|))};
				v212[632] := {!true, fm23(fm0(false, 0x117, p1, multiset{if (p1 in v213) then v213[p1] else -p1, |v209|, p1}, globalState), f14, fm24(p1, f19, false, p1, globalState), v215, globalState), f19, f19, f19};
				globalState.f3, r2, v212[632] := p1, !!((v63 + "nhxiqa") <= v63), if (f14) then {!f14, f14, f14, f19, f19} else v202 - v202;
			...
			case DC15(cf28) =>
				if (p1 > 0x253) {
					...
					v163[853] := f19;
					var v222 := 'r';
					var v223: map<char, bool> := map[v222 := v163[853]];
					v223 := v223[v222 := f19];
					var v224: map<seq<bool>, int> := map[[!f19] := |v164|];
					var v226: seq<bool> := [v163[853]];
					var v227: map<int, string> := map[p1 := v63];
					var v228 := DC26(v163[853], v227);
					var v229: multiset<D8> := multiset{fm42(false, !v163[853], 265, v163[853], globalState), v228};
					var v230 := DC11(p1, p1, f14, -0x116);
					var v231: multiset<int> := multiset{v230.cf18, |v63|};
					var v232: set<multiset<int>> := {v231, v231};
					v224, globalState.f9, f14, v163[853] := map v225 : seq<bool> | v225 in [v226] :: (v225) := (p1), !(v229 > v229), v163[853], v232 !! v232;
					var v233: array<array<int>> := new array<int>[2];
					var v234: array<int> := new int[28](i27 => i27 / p1);
					v233[844] := v234;
					var v235: map<int, char> := map[p1 := v222];
					var v236: map<bool, char> := map[f14 := v222];
					globalState.f3, globalState.f3, v233[844], v63 := p1, p1, v234, (fm3(-p1, p1, !(if (v222 in v223) then v223[v222] else f14), |v235| % p1, globalState))[p1 := if (!f14 in v236) then v236[!f14] else v222];
					var v237: set<int> := {|{f19, f19, !v163[853]}|, v230.cf18, p1};
					v237 := v237;
				} else {
					...
					v238[696] := if (f14) then v242 else v242;
					v238[696] := v242;
					var v243: seq<string> := [v63];
					r1 := if (f19) then p1 / |v63| else |v243|;
					var v244 := DC12(v163);
				...
				if (!true) {
					...
					m7(fm43(v251.f20, p1, |[-fm0(!f19, v251.f20, p1, v250, globalState)]|, globalState), f14, |(v250 * v252[p1])|, f14, globalState);
					var v253 := DC8(|(seq(-565, i29  => ('g')))|, v251.f20 / p1, p1);
					var v254: array<int> := new int[20];
					v254[298] := -(v251.f20 % p1);
					v254[605] := |v249| - p1;
					v163[902] := true;
					var v255: set<array<int>> := {v254};
					r2, v253, v254[298], v254[605], v163[902] := f19, fm44(f19, v251.f20, v251.f20, globalState), if (f14) then p1 else p1, v251.f20, (v255 + v255) == {v254};
					var v256: map<bool, int> := map[true := 560];
					v254[298] := v251.f20 * (if (f14 in v256) then v256[f14] else v251.f20);
					globalState.f3 := |"owt"|;
				} else {
					...
					v259[559] := if (f19) then p1 else p1;
					...
					var v263: map<int, string> := map[p1 := v262[p1]];
					r0, globalState.f3, v258, v259[559] := p1, |v261|, v258.(cf47 := v263), (p1 * |f15|) % p1;
					var v264 := DC9(f19, v259[559], 'n');
					r0 := v264.cf14;
					r2 := !f14;
					var v265: map<int, int> := map[v259[559] := |p0|];
					var v266: map<map<int, int>, int> := map[v265 := v259[559]];
					v266 := v266[v265 + v265 := v259[559]];
				}
				...
				if (f19) {
					...
					globalState.f9, globalState.f9, v269[236] := 0xf1 < --p1, v271 >= v271, v63[p1];
	...
	method m6(globalState: GlobalState) {
		if (f14) {
			var v0: array<int> := new int[22](i0 => i0 / |[f14]|);
			var v1 := 835;
			v0[612] := v1 * 0x2ba;
			var v2 := "dchmesu";
			var v3: seq<int> := [v1];
			var v4: seq<bool> := [f14];
			var v5: set<int> := {v1};
			v0[612], v2, globalState.f9, globalState.f3, globalState.f3 := --v3[v1], v2 + v2, {v1, ---v1, |v4|} > v5, 0x2c7, v1 % v1;
			var v6: array<bool> := new bool[29](i1 => f19 in map[f14 := f14]);
			globalState.f2 := v6;
			v6[909] := f14;
			v6[909] := f14;
			var v7: map<int, bool> := map[v0[612] := false];
			v5 := fm22(|"epm"|, [v7], f19, f19, globalState) * (v5 * v5);
			var v8 := 'h';
			v1, globalState.f3, v0, v2 := -|(v2[v1 := v8] + "ob")|, if (v6[909]) then v0[612] else |[v6[909], f19, f14]|, v0, v2;
		} else {
			var v9 := 0x333;
			globalState.f3 := v9;
			...
			globalState.f2 := v11[fm0(f14, -v9, v9, v12, globalState)];
		...
		for i3 := v14 to v14 {
			...
			v18[997] := f19;
			v18[997] := f14;
			var v19: seq<bool> := [v18[997]];
			var v20: multiset<seq<bool>> := multiset{fm38(globalState)};
			v14 := fm17(i3, !v18[997], multiset{v19} * v20, -899, globalState);
			globalState.f9 := v19[i3 / i3];
		}
		if (f19) {
			...
			if (f14) {
				...
				v27[462] := fm37({v14}, v28, f14, f19, globalState);
				var v29: array<bool> := new bool[7];
				v29[222] := !f19;
				var v30: set<int> := {v14};
				var v31 := "pw";
				var v32: map<int, string> := map[|(seq(0x157, i8  => ('v')))| := v31];
				var v33 := DC26(f14, v32);
				v23, v24[618], globalState.f9, v27[462], v29[222] := v23, v26, v30 !! v30, DC1(fm2(!f19, f14, globalState)).(cf1 := v33.cf46).(cf1 := !f19), f14;
				globalState.f2 := v29;
				f14 := !v29[222];
				var v34 := new C1();
				...
				var v39 := 'y';
				globalState.f3 := |((v37 + v37) + (if (v38[v14]) then v37 else v37)[-v14 := v39])|;
				var v40: seq<int> := [571];
				var v41 := DC32(v40);
				var v42: map<D10, bool> := map[v41 := f14];
				var v43: seq<string> := [v37, v37, "qvqxuld"];
				var v44: array<string> := new string[10] [v37 + v37, "ebteocn", "lronodbd", v37, v37, fm27(v14, true, globalState), if (if (v41 in v42) then v42[v41] else f19) then v37 else v37, v43[v14], if (f19) then v37 else "evmfvq", v37];
				v44[523] := v37;
				v44[523] := v37;
				globalState.f3 := v14;
				...
				var v49: array<seq<map<int, bool>>> := new seq<map<int, bool>>[28](i9 => seq(0x10f, i10  => (map[v14 := false])));
				var v50: map<int, bool> := map[v14 := f14];
				var v51: seq<map<int, bool>> := [v50];
				v49[598] := v51;
				var v52: set<int> := {|v48|, v14};
				v46[750], globalState.f9, v48, v49[598] := f14, |(set v53 : int | v53 in v52 :: (v53 - 0xd8))| < (v14 - v14), v48, [v50, v50 + v50, v50, v50[0x12a := f19] + v50[v14 := f19]];
			}
			
			var v54: map<bool, int> := map[f14 := v14];
			var v58: seq<map<bool, int>> := [v54];
			var v59: seq<int> := [v14, v14];
			var v60: set<int> := {v14, v59[|f15|], v14};
			var v61 := "chvabiuu";
			var v62: array<map<bool, int>> := new map<bool, int>[23] [v54 + map[f14 := v14], v54, v54, v54 + fm1(false, v14, f14, set v55 : int | (-621 <= v55) && (v55 < 0x36f) :: (v55 + |(map v56 : int | v56 in (map v57 : int | v57 in map[-v14 := f14] :: (v57 / v14) := (f19)) :: (v56 / 403) := (v14))|), globalState), v58[v14] + v54, v54, if (f19) then v54 else v54, v54, map[f14 := v14], v54, v54, v54[false := v14], map[f19 := v14] + fm1(f19, v14, f14, v60, globalState), v54, v54 + v54, v54, v54, v54, v54, v54, map[f19 := v14], v54 + v54, v54 + map[!f19 := |v61|]];
			v62[860] := v54;
			v62[860] := v54;
			...
			if (f19) {
				...
				globalState.f9, v70, v66[156], v14 := f19, if (v71[|v73|]) then v70 + v70 else fm46(v14, f19, globalState) + v70, true, fm17(v14, v74 !! v74, v75, v14, globalState);
				globalState.f3 := v14 / v14;
			} else {
			...
			var v89: seq<int> := [v14, fm17(if (f14 in v86) then v86[f14] else v14, f14, multiset{v85, v85[|v87| := f19], v85, v85, v85}, -|v88[-v14 := [f19]]|, globalState)];
			v84[360], v89 := v85[v14 := f19], seq(0x190, i12  => (v14 % |"ldnplt"|));
		...
		var v96: map<int, string> := map[v14 := ("voqhvj")[v14 := v90]];
		var v97: multiset<int> := multiset{|v95|, v14, |v96|};
		v90 := fm25(v14, -v14 - |v97|, v91[821] ==> f19, v95, globalState);
	}
	method m7(p0: seq<multiset<bool>>, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
		...
		v3[43] := fm47(globalState) - v2;
		var v4: set<int> := {p2};
		var v5 := "ovck";
		var v6: seq<int> := [-|v4|, --0x127, p2, |map[|v5| := v0]|];
		v1[886], v3[43], globalState.f9 := (p3 <== p3) && (v6 <= v6), v2, true;
		...
		var v13 := DC30(v7, p1, |v8|, fm22(v9.cf23, v12, f19, v1[886], globalState), p2);
		var v14: map<D9, int> := map[v13 := p2];
		for i0 := |v14[v13 := p2]| to |(seq(0x3a6, i1  => (v7)))| + p2 {
			var v15: multiset<int> := multiset{p2};
			var v16 := DC9(f19, |(seq(41, i2  => ('k')))|, v7);
			...
			var v25: seq<D7> := [v24];
			var v26: array<int> := new int[11] [p2, p2 + p2, p2, i0, (if (v1[886] in f15) then f15[v1[886]] else fm0(v1[886], 24, i0, v15, globalState)) * p2, -p2 / |map[i0 := p2]|, |v5|, fm0(f14, p2, i0, v15, globalState), p2, i0 - |v5|, |v25|];
			var v27: seq<bool> := [f14, f14, f14, p3, f14];
			var v28: multiset<seq<bool>> := multiset{v27};
			v19[23] := fm17(p2, !f19, v28, -fm0(v1[886], i0, i0, v15, globalState), globalState);
			var v29 := DC37(v28);
			v19[23] := (p2 + 0x210) % fm17(i0, v27[p2], v29.cf63, i0, globalState);
			var v30: map<bool, int> := map[f14 := v19[23]];
		...
		v31 := v31;
		var v32: seq<bool> := [p1];
		var v33: map<bool, seq<bool>> := map[v1[886] := v32 + v32];
		globalState.f3, globalState.f9, globalState.f9 := |(if ((f14 && p1) in v33) then v33[f14 && p1] else v32)|, f19 <== v1[886], f19;
	}
}
...
class C5 extends T0 {
	...
	function fm15(p0: bool, p1: bool, p2: int, globalState: GlobalState): string {
		("y" + "kfx") + ((seq(0x28e, i0  => ('v'))) + (seq(0x19, i1  => ('o'))))
	}
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: map<map<int, bool>, int>, r3: bool) {
		...
		v6[819] := f14;
		v6[819] := if (f14) then f14 else v5.f19;
		var v7: map<int, int> := map[f18 := f18];
		var v8: map<bool, int> := map[v5.f19 := |v7|];
		var v9 := "lm";
		var v10: seq<int> := [f18];
		var v11: array<int> := new int[26] [f18, f18, f18, f18, f18, f18, f18, f18, f18, |v8|, |v9|, -0x25c, |v10|, 817, |[v6[819], v5.f19]|, f18, f18, f18, f18, 0x3cf, f18, -0xbb, f18, f18, v10[f18], f18];
		var v12 := DC16(v11);
		var v13: map<string, array<int>> := map[v9 := v11];
		var v14: map<bool, array<int>> := map[v5.f19 := v11];
		var v15: array<array<int>> := new array<int>[26] [(v12.(cf29 := v11)).cf29, v11, v11, v11, v11, if (v5.f19) then v11 else v11, v11, v11, v11, v11, v11, if ((seq(979, i0  => ('m'))) in v13) then v13[seq(979, i0  => ('m'))] else v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, if (v6[819] in v14) then v14[v6[819]] else v11, v11];
		v15 := new array<int>[9];
		r0 := f18;
		r1 := f14 && f14;
		var v16: seq<array<bool>> := [v6];
		var v17 := DC13(v9, f18, v6[819], v16[f18]);
		var v18: map<map<int, bool>, int> := map[((map[f18 := v6[819]])[f18 := v5.f19])[v17.cf23 := f14] := f18];
		r2 := v18;
		r3 := v6[819];
	}
	method m1(p0: set<int>, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		var v3: seq<int> := [f18];
		var v4: seq<bool> := [f14];
		var v5 := new C4(v3 <= v3, f14, multiset{v4[f18], f14});
		var v6 := 't';
		var v7 := "h";
		var v8: seq<string> := [v7, v7];
		var v9: array<bool> := new bool[21] [v5.f19, v5.f19, 720 >= f18, f14, f14, f15 >= f15, v5.f19, f14, f14, f14, true, f14, v6 in (seq(815, i2  => (v6))), p1 <= |v7|, f18 < |v8|, p0 != p0, !v5.f19, p0 >= p0, v5.f19, fm2(v5.f19, v5.f19, globalState), f14];
		v9[928] := f14;
		v0[46] := -0x3a6;
		...
		v9[928], v0[46], f14, v10[245] := v12 !! (multiset{p1})[f18 := f18], -f18, v5.f19, v11;
		var v13: seq<multiset<int>> := [v12, multiset{f18}];
		var v14: set<multiset<int>> := {v13[p1]};
		for i3 := -v0[46] to v0[46] / |v14| {
			var v15: set<seq<bool>> := {v4};
			var v17: set<bool> := {v5.fm2(v5.f19, f14, globalState)};
			var v18: map<bool, set<bool>> := map[v9[928] := v17];
			var v19: map<seq<int>, int> := map[v3 := |(if (v5.f19 in v18) then v18[v5.f19] else v17)|];
			v7, v0[46], v0[46], v7, globalState.f9 := v7, -((-p1 * i3) / |((set v16 : seq<bool> | v16 in v15 :: (v16)) * v15)|), f18, fm15(v5.f19, v0[46] == p1, if (v3 in v19) then v19[v3] else p1, globalState), v9[928];
			var v20: array<char> := new char[7](i4 => 'g');
			var v21: map<bool, int> := map[v9[928] := 0x5f];
			v20[812] := if (v5.f19) then fm25(p1, p1, false, v21, globalState) else v6;
			v20[812] := 'w';
			...
			if ((set v23 : map<bool, int> | v23 in v22 :: (v23)) <= v24) {
				r1 := i3;
				v20[812] := 'h';
				globalState.f9, globalState.f9, v0[46] := v5.f19, !(v5.f19 <==> f14), |(seq(720, i5  => (|p0|)))|;
				globalState.f2 := new bool[29];
				var v25: array<array<bool>> := new array<bool>[13];
				var v26 := DC1(v5.f19);
				globalState.f3, r2, globalState.f3, v25 := v0[46], if (v5.f19) then v26.cf1 !in v21 else v9[928] || v9[928], (0x17 * i3) - (0x3f * |"v"|), v25;
			} else {
			...
			var v29 := DC5(v9[928], fm2(false, f14, globalState));
			var v30 := DC34(f15, v12, v9, v29);
			var v31: array<array<bool>> := new array<bool>[18] [v9, v9, v9, v9, v9, v28[p1], v9, v9, v9, v9, v9, v9, v9, v9, v9, v30.cf60, v9, v9];
			v31[777] := v9;
			var v32: map<char, seq<bool>> := map[v20[812] := v4];
			r2, v31[777], v9[928], v32 := v9[928], v9, (f15 - f15) !! f15, v32;
		}
		var v33: map<int, array<bool>> := map[v0[46] := v9];
		var v34: multiset<seq<bool>> := multiset{v4, v4};
		var v35: seq<array<bool>> := [v9];
		var v36: map<char, array<bool>> := map[v6 := v9];
		var v37: map<bool, int> := map[v9[928] := f18];
		var v38: array<array<bool>> := new array<bool>[24] [v9, v9, v9, v9, v9, if (v5.fm17(f18, v5.f19, v34, v0[46], globalState) in v33) then v33[v5.fm17(f18, v5.f19, v34, v0[46], globalState)] else v9, v9, v9, v35[v0[46]], v9, v9, v9, v9, v9, v9, v9, v9, v9, if (fm25(p1, p1, v5.f19, v37, globalState) in v36) then v36[fm25(p1, p1, v5.f19, v37, globalState)] else v9, v9, v9, v9, v9, v9];
		var v39 := DC12(v9);
		var v40: map<D4, array<array<bool>>> := map[v39 := v38];
		var v41: seq<array<array<bool>>> := [v38];
		v38 := if (v39 in v40) then v40[v39] else v41[v3[p1]];
		r0 := 0x231;
		r1 := p1;
		r2 := -p1 > v0[46];
	}
...
class C6 extends T0 {
	...
	function fm2(p0: bool, p1: bool, globalState: GlobalState): bool {
		(set v0 : int | (0x1ea <= v0) && (v0 < 573) :: (v0 / 0x26d)) != ((set v1 : int | v1 in {-0xe0} :: (v1 * 544)) - (set v2 : int | (0x265 <= v2) && (v2 < 0x91) :: (v2 - 943)))
	}
	function fm3(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): string {
		"evj"
	}
	function fm11(p0: map<D0, bool>, p1: int, globalState: GlobalState): bool {
		f14 && ((set v0 : int | v0 in multiset{|multiset{|map[0x359 := |multiset{"bv", seq(-494, i0  => ('v'))}|]|}|, 0x153} :: (v0 - 177)) <= {|[0x360, 0x1dc, 0xb4, DC3(0x286).cf3, 0x131]|, |"njb"|})
	}
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: map<map<int, bool>, int>, r3: bool) {
		...
		for i0 := v0 to v0 {
			var v1 := "li";
			var v2: map<int, string> := map[|(seq(0x36e, i1  => ("pf")))[v0 := seq(0x157, i2  => ('t'))]| := v1];
			v2 := v2[v0 := if (f14) then v1 else v1];
			var v3 := DC0(f14);
			if ((if (v3.cf0) then v3 else v3).cf0) {
				var v4: seq<int> := [|v1|];
				var v5: multiset<int> := multiset{i0};
				var v6: multiset<seq<int>> := multiset{if (f14) then [fm0(f14, i0, |v4|, v5, globalState)] else [i0], v4, v4[v0 := v0]};
				...
				var v15: seq<bool> := [(seq(0x200, i3  => ('g'))) == v1, true, v14, v14, v14];
				...
				v20 := v20[!fm12(f14, v22[v0], globalState) := f14];
				...
				var v34: array<multiset<map<bool, bool>>> := new multiset<map<bool, bool>>[19] [multiset(v29) + v30, v30 * v30, v30, v30, v30, v31[|v33|], v30, multiset(v29[|v16| := v20]), v30, v30 - v30, v30, v30, v30, v30, v30, v30, v30, multiset{v20, v20}, v30[map[false := v25.f14] := |v24|]];
				v34[765] := v30 + v30;
				v34[765] := multiset(v29);
			}
			...
			if (f14) {
				...
				var v43 := 't';
				v42[347] := v43;
				globalState.f3, v41[4], v42[347], v0 := v0 + i0, i0, v43, -i0;
				var v45: array<bool> := new bool[3](i4 => (set v44 : int | v44 in {i0} :: (v44 - 0x112)) !! {v0});
				v45[279] := true;
				var v46: seq<bool> := [f14, f14 || true, f14];
				var v47: set<bool> := {f14};
				r3, r1, v45[279] := f14, v46[|(if (f14) then {f14, true} else v47)|], f14;
				var v48: map<char, int> := map[v42[347] := 0x37b];
				var v49: seq<int> := [v0, i0];
				var v50: set<seq<int>> := {v49, v49, v49[v41[4] := v41[4]], v49};
			...
			v55[518] := |(v56 + (map v57 : int | (964 <= v57) && (v57 < -0x363) :: (v57 - |v1|) := (i0))[-v0 := i0])|;
			...
			v55[518] := (if (v1 in v58) then v58[v1] else |DC41(v61).cf67|) / i0;
		}
		...
		r0 := (v0 * v68) + |(map v71 : int | v71 in (seq(0x16b, i6  => (v0))) :: (v71 / v68) := (v0))|;
		var v72 := DC3(-v0);
		var v73 := DC6(v72);
		...
		var v74: map<bool, int> := map[v66[542] := v67];
		var v75: map<map<int, bool>, int> := map[map[if (v66[542] in v74) then v74[v66[542]] else -v68 := v66[542]] := v0];
		r2 := v75;
		r3 := v70;
	}
	method m1(p0: set<int>, p1: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		var v1: seq<char> := ['i'];
		v0[538] := |v1| > p1;
		v0[538] := fm2(f14, f14, globalState);
		globalState.f9 := v0[538];
		...
		v3[2] := v2;
		v3[2] := if (DC5(f14, true).cf7) then v2 else if (v0[538]) then v2 else v2;
		var v4 := 'y';
		var v5: set<char> := {v4};
		...
		var v7 := DC12(v0);
		var v8: seq<D4> := [v7];
		var v9 := new C4(v8 != v8, v0[538], f15);
		if (v9.f19) {
			if (v9.f19) {
				v0 := v0;
				...
				v5, globalState.f3, r2, v12 := (if (v14 in v15) then v15[v14] else v5) * {'f'}, p1, !(p1 <= |[-fm0(v9.f19, -p1, p1, v6, globalState), p1]|), v16[p1 % p1];
				var v17 := new C1();
			} else {
				var v18 := DC13(v1, p1, v0[538], v0);
				v1, v1 := v18.cf22 + (seq(0x124, i1  => (v4))), v1;
				var v19: map<bool, int> := map[v9.f19 := p1];
				var v20: array<char> := new char[19] [v4, v4, v4, v4, v4, v4, v4, v1[|v6|], v4, v4, fm25(p1, 0x81, f14, v19, globalState), v4, v4, 't', 'g', v4, v4, v4, v4];
				v20[774] := v4;
				v20[774] := v4;
				...
				v21[949] := v22;
				v21[949] := v22;
				var v24: map<bool, set<int>> := map[v20[774] !in v1 := p0 * (set v23 : int | (636 <= v23) && (v23 < 0xb5) :: (v23 / p1))];
				v24 := v24;
			...
			v27[338] := {p1, p1} + (set v32 : int | v32 in v30 :: (v32 + 876));
			var v33: array<int> := new int[14];
			v33[453] := if (p1 in v29) then v29[p1] else p1;
			var v34: set<string> := {v1};
			v27[338], r1, v33[453], v1, v34 := {p1}, p1, p1, seq(-551, i3  => (v4)), v34;
			var v35: map<map<bool, int>, array<int>> := map[map[v0[538] := v33[453]] := v33];
			var v36: map<bool, int> := map[f14 := v33[453]];
			var v37: seq<array<int>> := [if (v36 in v35) then v35[v36] else v33, v33];
			var v38 := DC16(v33);
			v0[538], v37, r1, globalState.f9 := DC0(v0[538]).cf0, [v33, v33, v33, v38.cf29, v33], v33[453], !true;
		} else {
			v4 := v4;
			...
			if (v0[538]) {
				...
				v40[831] := p1;
				v0[538] := v0[538];
				var v41: map<int, string> := map[|(seq(0x12f, i5  => (v4)))| := if (v9.f19) then v1 else v1];
				v41 := v41[|v1| - |v1| := if (v0[538]) then "aupfiojbx" else v1];
				var v42: map<bool, int> := map[v0[538] := v40[831]];
				var v43: map<char, int> := map[v4 := 720];
				var v44: seq<int> := [|map[v9.f19 := v4]|, -p1];
				var v45: set<seq<int>> := {v44, v44};
				var v46 := DC41(v45);
				var v47: map<int, bool> := map[if (v9.f19 in v42) then v42[v9.f19] else v40[831] := fm23(p1, v9.f19, v43, v46.cf67, globalState)];
				var v48 := new C2(v47);
				var v49 := new C5(v40[831] * p1, v40[831] > p1, f15 + f15);
			} else {
				v9.m6(globalState);
				...
				v0[538] := p1 != (--v53[|v1|] / |v56|);
				var v57: C3 := new C3(0x168, v1, v54.f23, f15);
				var v58: map<C3, int> := map[v57 := |"tfija"|];
				var v59 := DC47(v58);
				r1 := DC11(-p1, v9.fm17(|v59.cf76|, f14, multiset{v51}, v57.f20, globalState), v0[538], v57.f20).cf17;
				v53 := v53;
			}
	...
	method m5(globalState: GlobalState) returns (r0: int, r1: int, r2: multiset<int>, r3: bool) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := (-0x140 % |"vuy"|) != |((seq(-0x130, i2  => ('j'))) + "qdea")|;
		}
		if (f14) {
			r3 := f14;
			r3 := f14;
			...
			match (v1) {
				case DC1(cf1) =>
					...
					var v6 := 'f';
					var v7: set<int> := {v2};
					var v8 := DC30(v6, cf1, |(seq(875, i3  => (v6)))|, v7, v2);
					var v9 := new C3(|(v4 + v4)|, v5[v2], if (cf1) then v8.cf51 else cf1, f15);
				...
				case DC0(cf0) =>
					...
					var v17: set<seq<int>> := {v16, seq(0x125, i4  => (v13.f18)), v16, v16, v16};
			...
			if (f14 ==> !(v32 <= v32)) {
				...
				var v38: set<multiset<bool>> := {(multiset{f14, v33.f24})[f14 := |(seq(0x270, i7  => (v35)))|], f15, multiset{v33.f23}, multiset(v37)};
				...
				var v54 := new C2(if (true) then v53[v30] else v52);
			...
			if (([true, true, f14, f14] + v58[0x28e]) != v57[v30 := f14]) {
				var v59: multiset<int> := multiset{v30, 943, v30, 97};
				r1 := if ((v30 % fm0(f14, |v32|, v30, v59, globalState)) in v59) then v59[v30 % fm0(f14, |v32|, v30, v59, globalState)] else -v30;
				var v60 := new C3(v30 % v30, v32, f14 ==> f14, f15[f14 := v30]);
				v32 := "srr";
				...
				v0[935] := !(if (v0 in v66) then v66[v0] else f14);
				v0[935] := f14;
				var v67 := DC0(v0[935]);
		...
		v71[202] := v72;
		var v73 := 0x1b5;
		v71[202] := (v72 + (seq(0x33, i8  => ('y')))) + (fm27(v73, f14, globalState) + v72);
		var v74: set<int> := {v73};
		for i9 := |v74| to v73 {
			var v75 := DC18(!true);
			var v76: map<int, D5> := map[i9 := v75];
			v76 := v76[|v74| - v73 := v75];
			v0[686] := if (f14) then f14 else !f14;
			v0[129] := f14;
			var v77 := 'h';
			v0[686], v0[129], v71[202] := true, f14, v72[v73 := v77] + v71[202];
		...
		var v85: array<int> := new int[22](i10 => i10 % v73);
		v85[239] := v73;
		v85[239] := -((if (f14) then v73 else v73) % (if (f14) then 284 else 0x10d));
		var v86: seq<int> := [v85[239]];
		var v87: map<int, bool> := map[|(v86 + [v85[239]])| := f14];
		v87 := v87[v73 := v85[239] <= 0x1fe];
		r0 := v85[239];
		r1 := v73 * v73;
		var v88: multiset<int> := multiset{v73, |v72|, v73, v73 % v85[239]};
		r2 := v88;
...
class C7 {
	...
	method m3(p0: int, globalState: GlobalState) {
		for i0 := p0 to p0 {
			...
			var v3 := 'j';
			var v4: seq<char> := [v3];
			var v5: array<seq<int>> := new seq<int>[15] [v2, v2 + v2, v2, v2, v2, v2[i0 := v0.cf3], [|v4|, p0], v2, v2, if (true) then v2 else v2, v2[i0 := i0], v2 + [p0, p0, |v4|], v2, v2, v2];
			v5[789] := v2[i0 := p0];
			var v6: array<bool> := new bool[26];
			var v7 := true;
			v6[752] := v7;
			globalState.f9, v5[789], v6[752] := v7, (v2 + v2) + (v2 + v2), !v7;
			var v8: map<int, char> := map[p0 := v3];
			var v9: multiset<map<int, char>> := multiset{v8};
			var v10: array<map<int, int>> := new map<int, int>[2];
			var v11: map<seq<int>, char> := map[seq(414, i1  => (|[v6[752]]|)) := v3];
			var v12: map<bool, array<bool>> := map[v7 := v6];
			v9, v7, globalState.f2, v10, v11 := v9 - v9, !v7, if (v6[752] in v12) then v12[v6[752]] else v6, v10, map[v5[789] := v3];
			v4 := v4 + "reyaln";
			...
			decreases 100 - i4
		{
			...
			var v28: seq<int> := [p0, |v27[p0 := !v26]|, -573, |map[v26 := v26]|, -p0];
			var v29 := DC32((seq(0x393, i5  => (0x1fa))) + v28);
			match (v29) {
				case DC32(cf56) =>
			...
			match (v45) {
				case DC42(cf68, cf69) =>
					...
					v47[241] := fm9(p0, globalState);
					v47[241] := |(v25 + (v25 + v25))|;
					var v48: map<bool, seq<bool>> := map[cf69 := v27 + ([v26])[p0 := cf69]];
					var v49: map<char, int> := map['h' := v47[241]];
					var v50: map<bool, int> := map[cf69 := 0xca];
					var v51 := "jrpyg";
					v48 := v48[fm23(v47[241], false, v49, {v28, v28, v28}, globalState) := if (v26 in v48) then v48[v26] else [v26, cf69, !fm10(v50, v23, false, v51, globalState)]];
					var v52: seq<string> := ["sct"];
					var v53 := DC13(seq(326, i8  => (cf68)), |(seq(-776, i9  => (DC42(cf68, DC30(cf68, cf69, p0, {v47[241]}, v47[241]).cf51).cf68)))|, v26, v24);
					var v54: array<string> := new string[23] [v52[-p0] + v51, v51, v51, v51 + v51, v51, v51 + v51, v51, v51 + v51, v51[v47[241] := cf68], seq(0xda, i6  => (cf68)), v51, seq(0x324, i7  => (cf68)), v51, v51, v53.cf22, seq(325, i10  => (cf68)), v51, v51, "abhvu", v51 + "u", v51, if (cf69) then v51 else seq(0x186, i11  => ('w')), v51];
					v54[243] := "i";
					v54[243] := v51 + "k";
				case DC41(cf67) =>
					var v55 := "gv";
					var v56: map<int, int> := map[p0 := |v55|];
					globalState.f3 := (if (v26) then p0 else p0) / |(v56 + (map v57 : int | v57 in v23 :: (v57 % |v55|) := (p0))[p0 := p0])|;
					var v58 := 'f';
					...
					v67[597] := if (v26) then v65 else v65;
					v67[597] := v65;
					v59[857] := p0;
		...
		var v75 := DC2(v74);
		if (match v75 {
			case DC1(cf1) => !!(0x3b8 in [|(seq(234, i12  => ('v')))|, p0])
			case DC0(cf0) => cf0
			...
			var v84 := true;
			var v85: map<string, bool> := map[seq(0x199, i13  => (v82)) := v84];
			v85 := (v85 + v85) + v85;
		...
		if (v88) {
			...
			v101[642] := v100;
			globalState.f9, v101[642], v73, globalState.f3 := v97.f23, if (v97.f23) then v100 else v100, fm27(p0, v88, globalState), p0;
			var v102: seq<bool> := [v97.f23];
			var v103 := DC7(v102);
			if ([true] == v103.cf9[p0 := v97.f23]) {
				...
				v104[440] := v109;
				v104[440] := v109 + map[v106 := v97.f23];
				globalState.f9 := (|"yacasvvoi"| > p0) ==> v88;
				var v110: map<int, int> := map[p0 % p0 := p0];
				v110 := v110 + v110;
			...
			var v141: multiset<array<bool>> := multiset{v140[p0]};
			v137[984] := (((fm27(p0, v88, globalState))[p0 := v138])[-0x32 := v138])[|v141| := v138];
			var v142: array<int> := new int[8];
			v142[4] := p0;
			v142[4] := (|v137[984]| + p0) - p0;
			v138 := v138;
		}
	...
	method m4(p0: bool, p1: int, p2: int, p3: set<array<char>>, globalState: GlobalState) returns (r0: bool) {
		globalState.f9 := p0;
		var v0: array<int> := new int[27](i1 => i1 / 0x96);
		forall i0 | 0 <= i0 < v0.Length {
		...
		v3[262] := p0;
		v3[262] := p0;
		var v4: map<bool, bool> := map[p0 := v3[262]];
		v0[107] := -p1;
		v4, v3[262], v0[107], globalState.f3 := v4, p1 != -(p1 - p2), p1, p2;
		var v5 := 'c';
		var v6: multiset<int> := multiset{v0[107], 0x1b9};
		var v7: multiset<bool> := multiset{false};
		var v8: T0 := new C5(v0[107], p0, v7);
		var v9: multiset<T0> := multiset{v8, v8};
		var v10 := "nnbtloi";
		var v11: set<int> := {v0[107], fm0(v3[262], v0[107], v0[107], v6[|v9| := p1], globalState), |v10|, p1};
		globalState.f9, v0[107], v5, v0[107] := v3[262], v0[107] % |v11|, v5, -p2;
...
class C8 extends T0 {
	...
	function fm3(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): string {
		(if (f14) then seq(-0x2e2, i0  => ('l')) else seq(0x7b, i1  => ('l'))) + "jshowx"
	}
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: map<map<int, bool>, int>, r3: bool) {
		...
		if (v0 !in v1) {
			...
			if (if (f14) then true else f14) {
				...
				v0[425] := "ahnxhipsh" == v3;
				v6, v0[425] := (if (f14) then v6 else v6) + v6, if (f15 == f15) then f14 else f14;
			} else {
				var v7: array<int> := new int[3];
				var v8 := 726;
				v7[68] := fm0(f14, 0x145, v8, multiset{v8, 0x172, v8, v8, v8}, globalState);
				var v9: seq<int> := [-348];
				...
				v7[68] := fm0(f14, v8, v8, v12, globalState);
				var v13 := DC1(f14);
				var v14: seq<bool> := [v13.cf1];
				var v15: map<seq<int>, int> := map[v9 := |v14|];
				var v16: map<int, bool> := map[if (f14) then v7[68] else if (v9 in v15) then v15[v9] else v7[68] := f14 <==> f14];
				var v17 := DC0(f14);
				v16 := v16[v8 % v8 := v17.cf0];
				var v18: map<bool, array<int>> := map[f14 := v7];
				var v19: set<int> := {v8, |v18|, v7[68], v8};
				var v20 := "h";
				var v21 := m2(|map[f14 := |v19|]| % v8, v20 + "fmlv", f14, f14 ==> f14, globalState);
				var v23: map<string, bool> := map["mkl" := true];
				var v24: map<D0, bool> := map[DC0(false) := |(map v22 : string | v22 in v23 :: (v22) := (seq(0x225, i0  => (v21))))| > |v20|];
				f14 := if (v17 in v24) then v24[v17] else |v20| > 0x108;
				var v25: map<bool, int> := map[f14 := 0x232];
				var v26: map<int, map<bool, int>> := map[v7[68] := v25];
				v25 := if (-(0x3b1 - v7[68]) in v26) then v26[-(0x3b1 - v7[68])] else v25[f14 := |{f14, f14}|];
			}
			...
			v36, v38, v29 := v36, map v39 : map<bool, bool> | v39 in (seq(0x286, i2  => (v37[false := f14]))) :: (v39) := (v33), v29 + v29;
			...
			decreases 100 - i3
		{
			...
			if (DC0(v47[v43]).cf0) {
				...
				var v57: map<bool, seq<int>> := map[f14 := (if (f14 in v55) then v55[f14] else v56)[v43 := v43]];
				...
				v60[33] := v59;
				var v61 := DC4(v43, v43);
				v60[33], v61, v43 := if (false && f14) then v59 else v59, v61, v43;
				var v62: seq<array<bool>> := [v0, v0, v0];
				v62 := (v62[-0x3de := v0])[v43 := v0];
				var v63: seq<seq<bool>> := [v47];
				var v64 := new C6(f14, multiset(v63[v43]));
				var v65 := "ehllenung";
				v65 := v65;
				var v66: C7 := new C7();
				v66 := v66;
		...
		var v69: array<map<int, seq<int>>> := new map<int, seq<int>>[10](i4 => if (f14) then map v68 : int | (-0x229 <= v68) && (v68 < 0x3c7) :: (v68 * v43) := (seq(0x27c, i5  => (v43))) else map[|multiset{v44, 'v'}| := DC32(seq(281, i6  => (v43))).cf56]);
		var v70: C1 := new C1();
		...
		globalState.f9, v44, v69[793] := true, (v75.(cf52 := v43, cf51 := f14, cf54 := v43)).cf50, fm52(-v43 * v43, globalState);
		var v76: array<int> := new int[2];
		var v77: seq<array<int>> := [v76, v76];
		v76 := if (if (f14) then true else f14) then v76 else v77[v43];
		r0 := |v74|;
	...
	method m2(p0: int, p1: string, p2: bool, p3: bool, globalState: GlobalState) returns (r0: char) {
		...
		var v8: set<seq<int>> := {seq(14, i1  => (v3.f20))};
		var v9: map<bool, int> := map[fm23(p0, v2[|v4|], v7, v8, globalState) := v3.f20];
		...
		for i2 := p0 to v3.f20 {
			...
			v12, globalState.f3 := v12, -(if (v14.cf46) then v12.f18 else v12.f18 % -|v16|);
			var v17 := DC12(v11);
			v17 := v17;
...
method Main() {
	...
	for i1 := fm0(v4, v0, v0, (multiset(v10))[v0 := v0], globalState) to v0 {
		var v11: map<int, array<string>> := map[v0 := v7];
		v7 := if ((v0 * -0x1de) in v11) then v11[v0 * -0x1de] else v7;
		var v12: map<bool, int> := map[v4 := i1 % i1];
		...
		v0, globalState.f3, globalState.f3, v12 := (i1 - i1) % (v0 / v0), |(v3 + (v3 + v3))|, --|(if (v4) then multiset{v13} else v14)[if (i1 in v15) then v15[i1] else v13 := -v0]|, v12 + fm1(false, |map[i1 := v4]|, v4, v16, globalState);
		...
		if (if (v0 in v17) then v17[v0] else true) {
			...
			v2[804] := v4;
			globalState.f3, v22[543], v23, v2[804] := -v0, v21, (if (v4) then v23 else v23) * v23, v4;
			globalState.f3 := if (v4) then v0 % i1 else i1;
		...
		var v27: array<T0> := new T0[24] [v25, v25, v25, v25, v26[i1], v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25, v25];
	...
	var v31 := 'm';
	var v32, v33 := m11(v29, |v30[|v3[v0 := v31]| := v0]|, v4, v4, globalState);
	if (if (!!(true || v4)) then v4 else v32 <= v32) {
		...
		var v39: array<int> := new int[15](i2 => i2 % DC4(v0, 0).cf5);
		v39[190] := v32;
		v39[190] := -v32;
		if (v4) {
			...
			var v45: map<bool, int> := map[v4 := v39[190]];
			var v46: map<int, bool> := map[if (v4 in v45) then v45[v4] else |v10[|(seq(-0x271, i4  => ('r')))| := v37]| := v4];
			var v47 := DC5(v4, false);
			var v48 := DC34(v44, v1, v2, v47.(cf7 := v4));
			var v49: array<multiset<bool>> := new multiset<bool>[26] [multiset(if (fm23(|v8|, v4, v41, v42, globalState) in v40) then v40[fm23(|v8|, v4, v41, v42, globalState)] else v8[v39[190] := fm23(|v8|, !v4, fm24(v37, v4, v4, v39[190], globalState), v42, globalState)]), (if ((seq(-0x3b4, i3  => (v31))) in v43) then v43[seq(-0x3b4, i3  => (v31))] else v44) * multiset{v4}, v44, v44, multiset([!v4, v4]), fm33(!false, globalState) + v44, v44 * v44, multiset(v8), v44, multiset{false}, v44, v44[v4 := v32], multiset{v4, !v4, if (v37 in v46) then v46[v37] else false}, v44, multiset{true}, (v44[v4 := v37])[v4 := v0], v44 + v44, v44, v44, v44, v44, multiset{v4, !v4, true, v4}, v44, (v48.(cf60 := v2, cf58 := v44)).cf58, v44 - v44, v44];
			var v50: array<C3> := new C3[9];
			var v51: map<array<C3>, int> := map[v50 := v37];
			var v52: array<char> := new char[1](i5 => v31);
			var v53 := DC51(v52);
			globalState.f3, v37, v31, v49, globalState.f9 := fm0(v32 >= |v51|, -v32, v32, v1, globalState), v37, v31, v49, v8[|(multiset{v52})[v53.cf83 := 0x23]|];
			var v54: array<D14> := new D14[7];
			var v55 := DC44(v7);
			v54[715] := v55;
			v54[715] := v55.(cf71 := v7);
			var v56: map<int, multiset<bool>> := map[v39[190] := v44[v4 := v32]];
			var v57 := new C5(v37, v4, (if (|(seq(0x183, i6  => (v31)))| in v56) then v56[|(seq(0x183, i6  => (v31)))|] else v44) + multiset(v8));
			v31 := v31;
			var v58: array<seq<bool>> := new seq<bool>[28](i7 => ([v4, v4])[|v3| := v4] + v8);
			v58[201] := v8;
			v58[201] := v8;
		} else {
			globalState.f9 := v4;
			...
			v59[307] := v8;
			var v60: map<seq<bool>, int> := map[v8 + [false] := if (v4) then -|fm53(v4, v4, globalState)| else v39[190]];
			var v61: C4 := new C4(v4, v4, (multiset{v4, v4})[v4 := |v1|]);
			var v62: map<C4, int> := map[v61 := v32];
			v59[307], v60 := fm38(globalState), (map[v8 := |v62|])[v8 := 0x10b] + map[v8[v0 := v61.f19] := v32];
			v39[190] := -956;
		}
		
		var v64: map<int, set<bool>> := map[v10[v39[190]] := {v4}];
		var v65 := DC2(fm37(set v63 : int | v63 in v10[|v3| := |v1|] :: (v63 / 0xf0), v64, v4, v4, globalState));
		match (v65) {
			case DC1(cf1) =>
				globalState.f3 := v37;
			...
			case DC0(cf0) =>
				...
				globalState.f9 := ((if (v39[190] in v70) then v70[v39[190]] else v8) + v8) < v8;
			case DC2(cf2) =>
		...
		if (if (v4) then true else if (v79.fm2(v79.f19, v4, globalState)) then v79.f19 else v4) {
			...
			v83[845], globalState.f3, globalState.f3, v85 := (v0 / 632) * |v88|, v32, v32, v85.(cf28 := v84);
			v83[845] := v83[845];
			...
			v103[207] := if (v79.f19) then v77 else v0;
			var v104: map<array<int>, bool> := map[v103 := if (v4) then v8[|v30|] else v4];
			var v105 := DC18(v79.f19);
			var v106: map<int, D11> := map[v0 := DC35()];
			var v107: set<string> := {v3};
			globalState.f9, globalState.f9, v4, v103[207], v104 := v79.f19, v105.cf33, if (v106 != v106) then v79.f19 else v107 !! v107, v0 % v0, v104;
			var v108: C3 := new C3(v103[207], v3, v4, v81);
			var v109 := DC55(v108);
			var v110: multiset<C3> := multiset{v109.cf91, v108};
			var v111: seq<map<int, int>> := [(map[|v110| := v108.f20])[|v8[v103[207] := v79.f19]| := -v108.f20]];
			v111 := v111;
			v2[919] := true;
			v2[919] := v79.f19;
	...
	if (v10 != v10) {
		...
		var v122: array<set<bool>> := new set<bool>[16] [v5, v5, v5, v118.cf45, v5, if (v0 in v119) then v119[v0] else v5, v5 + fm41(v32, |v120|, globalState), v121[v32] * {v4}, if (v4) then v5 else v5, fm41(|v10|, v0, globalState), {v4, v4}, v5, v5 - {v4, v4, v4, v4, v4}, v5 + v5, v5, v5];
		v122[78] := v5 * v5;
		var v123: array<int> := new int[10] [-v0, v10[|v3|], |v8|, v32 / v0, v0, -(v0 + v0), v32, |(map[v4 := v31])[v4 := v31]|, v32 - v32, v0];
		v123[170] := v0;
		var v124 := DC39(v32);
		v122[78], globalState.f6, v123[170], v32 := fm41(|v3|, v124.cf65, globalState), v5 * v5, -(v0 + |v3|), fm0(v4, v0, -0x23b, v1, globalState);
		v4 := !v4;
		v4 := true;
		v123[170] := v0;
	} else {
		if (v4) {
			...
			var v131: map<int, C3> := map[v128 / v128 := v130];
			v131 := v131[v32 := v130];
		...
		v151 := v151;
		v151[349] := 0x32f;
		v151[349] := if (true) then v32 else v32;
		v3 := v3;
		v151[349] := v151[349];
	}
		...
		decreases 100 - i11
	{
		...
		v153[945] := v154;
		v153[945] := new C3(|[true, v4, v4, v4]|, v154.f21 + v154.f21, v4, v116);
		var v155 := DC7(v8);
		var v156: set<D2> := {v155, v155, v155};
		globalState.f9 := DC7(v8) !in v156;
		v2[918] := v4;
		var v157: map<bool, char> := map[v4 := v154.f21[-0x294]];
		var v158: set<int> := {-|v157|};
		v2[918] := v158 >= fm6(globalState);
	}
		...
		decreases 100 - i15
	{
		...
		i15 := i15 + 1;
		var v165: multiset<seq<int>> := multiset{seq(0x4c, i16  => (188)), seq(0x2db, i17  => (v32)), v10};
		v165 := v165;
		var v166 := DC5(v4, v161);
		v163, v2[302], v3 := if (v2[302]) then v166.cf6 else v161, v163, DC13(v3, v160, v161, v2).cf22;
	...
	if (v2[302]) {
		...
		v2[302], v174 := v172, v174;
		v163 := v161;
	} else {
		var v175, v176 := m11(v29, fm0(v2[302], v0, v0, fm30(v161, globalState), globalState), multiset(v8) <= v116, v163, globalState);
		...
		v8, v163, v179, v1, v2[302] := [v163] + [!v163, if (v2[302] in v180) then v180[v2[302]] else v161], v163, v179, v1, v2[302];
		var v181: set<int> := {v0};
