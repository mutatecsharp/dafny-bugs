...
class C0 {
	...
	function fm36(p0: int, p1: bool, p2: map<int, bool>, globalState: GlobalState): seq<int> {
		[f27, |(seq(abs(0x314), i0  => (--f27)))| + |map[true := |[true, false]|]|]
	}
}
...
class C1 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3: seq<int> := [f5];
			v1 := map[v2.cf11[safeIndex(|map[f5 := v3]|, |v2.cf11|) := f16] := f5 != p0];
			var v4: set<int> := {p0};
		...
		var v28: array<multiset<bool>> := new multiset<bool>[16] [fm47(f4, globalState) + multiset{f4}, v22, v22, v22, v22, multiset{f16, false, f16, f16}, fm47(f4, globalState), v25[safeIndex(f5, |v25|)], v22[f16 := abs(v24.f27)], v22[if (f4 in v26) then v26[f4] else f4 := abs(p0)], fm47(f4, globalState), multiset(v27 + v27), v22, v22, v22, v22 - v22];
		v28[safeIndex(688, v28.Length)] := multiset([!v17.cf15]);
		var v29 := 911;
		...
		globalState.f0, v28[safeIndex(688, v28.Length)], v29, v29 := v31, v22, safeModuloInt(f15, |(fm48(v24.f27, globalState) + v31)|), -(if (-v29 !in v33) then fm49(v16, -fm49("fgjpp", f5, false, fm0(globalState), globalState), false, f16, globalState) else p0 - 0x254);
		var v34 := true;
		v34 := f4;
		var i1 := 0;
		while (false)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			if (fm0(globalState)) {
				v29 := -v32[safeIndex(v24.f27, |v32|)];
				var v35 := 'h';
				v35 := v35;
				var v36: map<int, map<bool, int>> := map[v24.f27 := v18];
				var v37: set<int> := {v24.f27, v24.f27, 0x258, v24.f27};
				v14, v34, v29, v34, v22 := v14, f16, if (if (f4) then v34 else v34) then -0x355 else v24.f27, !({f15, v29, |v32|, -f15, |multiset{map[f4 := 0x117], v18, if (|v16| in v36) then v36[|v16|] else v18}|} >= v37) ==> f4, v28[safeIndex(688, v28.Length)] * v22;
				v27 := fm45(v24.f27, globalState);
				v34 := !f4;
			} else {
				var v38 := 'y';
				v29 := |v16[safeIndex(|v32|, |v16|) := if (v34) then v38 else v38]|;
				v38 := fm50(globalState);
				var v39: map<string, int> := map[seq(abs(0x28c), i2  => (v38)) := -|v16|];
				v14[safeIndex(379, v14.Length)] := |v39|;
				var v40: set<int> := {740, v24.f27, f5};
				v14[safeIndex(379, v14.Length)] := if (|v40| in v19) then v19[|v40|] else -(f15 * 984);
				var v41 := m0(f4, |([f5] + ([p0, p0])[safeIndex(0xb8, |[p0, p0]|) := p0])|, globalState);
				var v42 := DC10(!v41, v41, v27);
				var v43 := DC11(v42);
				var v44: array<char> := new char[18] [v38, v38, v38, v38, v38, v38, v38, v38, 'r', v38, v38, v38, v38, v16[safeIndex(fm49(v16[safeIndex(|v27|, |v16|) := 'p'], |v16|, f4, true, globalState), |v16|)], v38, v38, v38, 'q'];
				var v45: map<D4, array<char>> := map[v43 := v44];
				var v46: array<int> := new int[15](i3 => i3 + v24.f27);
				v45, v46 := v45 + v45, v46;
			}
			
			v29 := safeDivisionInt(v29, f15);
			v29 := |(v27[safeIndex(v24.f27, |v27|) := f4] + DC10(fm0(globalState), f4, fm45(v24.f27, globalState)).cf26)|;
			v14, v29 := v14, v24.f27;
		}
		...
		var v57: set<int> := {v29};
		var v58: array<multiset<string>> := new multiset<string>[21] [v53, v53, v53, multiset{v16, v16} - v54[safeIndex(f5, |v54|)], v53 * v53, v53 + v53, v53, v53["mg" := abs(v24.f27)], v53, v53, if (v34) then v53 else fm51(globalState), v53, multiset(v55), fm51(globalState), multiset{v16, v16, v16}, v53 - v53, v53, v53 * multiset{v16}, multiset{v16}, v53, if (f16 in v56) then v56[f16] else multiset{fm52(f16, v57, |v30|, f16, globalState)}];
		v58[safeIndex(825, v58.Length)] := v53;
		v52, v34, v58[safeIndex(825, v58.Length)], v14, v50 := v52, !v34, v53, v14, v50;
	}
}
...
class C2 extends T2 {
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		var v3: seq<bool> := [f18];
		var v4: array<int> := new int[10] [p0 * p0, |v1.cf50|, f5, f5, |v2| - -645, f5, safeModuloInt(p0, f5), f5 - -fm55(p0, v3, p0, globalState), 0x29c, f5];
		v4[safeIndex(440, v4.Length)] := safeModuloInt(p0, f5);
		v4[safeIndex(440, v4.Length)] := f5;
		v4[safeIndex(440, v4.Length)] := fm55(v4[safeIndex(440, v4.Length)], v3, p0, globalState) - safeModuloInt(p0, -f5);
		if (f18 <== f4) {
			...
			v4[safeIndex(440, v4.Length)], v7, v8 := |(f17 + f17)| * v4[safeIndex(440, v4.Length)], v7, v8;
		} else {
			var v9: set<int> := {v4[safeIndex(440, v4.Length)], f5, |f17|, v4[safeIndex(440, v4.Length)]};
			var v10 := new C1(v4[safeIndex(440, v4.Length)] * 0x2f1, f4, v4[safeIndex(440, v4.Length)] !in v9, fm55(|([false])[safeIndex(p0, |[false]|) := !true]|, v3, v4[safeIndex(440, v4.Length)], globalState));
			var v11: map<int, int> := map[0x41 := 0x2dd];
			v11 := v11[v4[safeIndex(440, v4.Length)] := v4[safeIndex(440, v4.Length)]];
			var v12: map<bool, int> := map[f4 := v4[safeIndex(440, v4.Length)]];
			v4[safeIndex(440, v4.Length)] := fm55(fm55(-v4[safeIndex(440, v4.Length)], [v10.fm0(globalState)], |f17|, globalState) + |v12|, v3 + [f18], |(v9 * v9)|, globalState);
			var v13 := new C0(fm56(f4, globalState), p0);
			var v14: seq<int> := [-v4[safeIndex(440, v4.Length)], p0];
...
class C3 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		for i2 := f15 to f15 {
			...
			v10 := set v11 : int | (790 <= v11) && (v11 < -133) :: (safeModuloInt(v11, |[v8.f27, 0x325, |[|("mmlptudj")[safeIndex(v8.f27, |"mmlptudj"|) := f25]|]|, i2, f15]|));
			var v12 := -598;
		...
		var v27: multiset<map<int, D6>> := multiset{map[0x3a5 := v21], v25, map v26 : int | (264 <= v26) && (v26 < 0x240) :: (safeModuloInt(v26, 0x70)) := (v21)};
		if (v27 > multiset{v25, map[0x30e := v21]}) {
			...
			v37[safeIndex(256, v37.Length)] := |v38| + v36.f27;
			var v39 := 'h';
			v0[safeIndex(551, v0.Length)] := f16;
			...
			v37[safeIndex(256, v37.Length)], v22, v39, v0[safeIndex(551, v0.Length)] := |(if ((v41 + multiset([v40])) in v43) then v43[v41 + multiset([v40])] else v44)|, seq(abs(0x2e0), i3  => (f5)), f25, f4;
			var v45: array<bool> := new bool[2](i4 => if (f4 in v24) then v24[f4] else f16);
			v45 := new bool[19];
			v0[safeIndex(551, v0.Length)] := !fm0(globalState);
			v37[safeIndex(256, v37.Length)] := fm35(|fm39(|v17|, globalState)| != p0, f16, p0, globalState);
		}
		...
		var v52 := DC20(v51[safeIndex(p0, |v51|)]);
	...
	method m17(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: string, r1: D0, r2: bool) {
		for i0 := f5 to p1 {
			...
			var v5: seq<multiset<int>> := [v3[p2 := abs(i0)], if (true) then v3 else v3, v3, multiset{f15, -|v4|}, v3];
			...
			v2 := safeModuloInt(safeModuloInt(|v0|, p0), v2);
			r2 := f16;
		}
		var v9: map<bool, int> := map[f4 := f5];
		var v10: seq<bool> := [false, f4];
		var v11: seq<int> := [p2];
		var v12: map<map<bool, int>, int> := map[v9 := fm35(f4, v10[safeIndex(p0, |v10|)], |v11|, globalState)];
		var v13 := "sndnas";
		...
		match (if (0x2bf < -p0) then v15 else fm42(globalState)) {
			case DC16(cf37, cf38) =>
				...
				if (fm0(globalState)) {
					...
					v16[safeIndex(22, v16.Length)] := map[p0 := v17];
					r2, r2, v16[safeIndex(22, v16.Length)] := !(if (f16) then cf38 <= 0x3b6 else f16), f4, fm43(p1, v11[safeIndex(p3, |v11|) := |v9|], p0, globalState);
					...
					v23[safeIndex(289, v23.Length)] := if (f4) then map[v24 := f16] else v25;
					v22, r2, cf38, r2, v23[safeIndex(289, v23.Length)] := v22, !(v24.f5 < -(cf38 + v11[safeIndex(cf38, |v11|)])), -(|v10| * p3), v24.f4, map[v24 := f16] + v25;
				} else {
					var v26 := DC20(fm38(f4, f4, p1, f16, globalState));
					var v27 := new C0(v26, safeModuloInt(f5, cf38));
					var v28: array<bool> := new bool[12];
					v28[safeIndex(0, v28.Length)] := !v10[safeIndex(|"ptyokebry"|, |v10|)];
					v28[safeIndex(0, v28.Length)] := f16 ==> (f16 <== f4);
					var v29: array<int> := new int[1](i1 => safeDivisionInt(i1, |v13|));
					var v30: map<bool, bool> := map[f4 := v28[safeIndex(0, v28.Length)]];
					v29[safeIndex(237, v29.Length)] := |v30|;
					v29[safeIndex(237, v29.Length)] := |v13|;
					v10 := fm45(-315 * v29[safeIndex(237, v29.Length)], globalState);
					v28 := v28;
				}
			...
			case DC15(cf36) =>
				...
				var v33: seq<string> := ["lrvipmo", v13, v13 + "hjb", v13, seq(abs(153), i2  => (f25))];
				v33 := if (f4) then fm53(globalState) else v33 + v33;
				r2 := f16;
				var v34: array<map<map<int, int>, string>> := new map<map<int, int>, string>[25];
				var v36: map<map<int, int>, string> := map[map v35 : int | (0x9c <= v35) && (v35 < 907) :: (safeDivisionInt(v35, p3)) := (p2) := seq(abs(-616), i3  => (f25))];
				var v37: map<int, int> := map[0xb5 := 0xee];
				v34[safeIndex(724, v34.Length)] := v36[v37 := v13];
				var v39: multiset<map<int, int>> := multiset{v37};
				v34[safeIndex(724, v34.Length)] := (if (f16) then map v38 : map<int, int> | v38 in v39 :: (v38) := (v13) else v36) + v36;
			case DC17(cf39) =>
				...
				if (v43.cf6) {
					r2 := f16;
					var v44 := 0x260;
					v44 := safeDivisionInt(p0, v44);
					var v45: map<bool, bool> := map[f16 := f16];
					var v46: map<int, int> := map[|v9| := p3];
					var v47 := DC4(f4, p3, p0);
					var v48: map<char, int> := map[f25 := v47.cf14];
					var v49: array<int> := new int[16] [v44, 622, if (f16) then v11[safeIndex(f15, |v11|)] else p0, p0 + p1, safeDivisionInt(p1, fm35(f16, f16, |v10|, globalState)), v11[safeIndex(|v45|, |v11|)], p1, fm35(f4, f4, 0x142, globalState), p1, fm35(v40, v40, |v46|, globalState), |v48| * p1, -p1, f5, p0, 0x367, f15 - 940];
					v49[safeIndex(575, v49.Length)] := p3;
					v49[safeIndex(575, v49.Length)] := p2;
					v49 := v49;
					var v50: array<multiset<set<bool>>> := new multiset<set<bool>>[25](i4 => multiset([v41, v41, v41]) * multiset{{v40}});
					v50[safeIndex(919, v50.Length)] := multiset{v41, v41, v41};
					var v51: multiset<set<bool>> := multiset{v41};
					v50[safeIndex(919, v50.Length)] := v51[v41 := abs(v44)];
				} else {
					var v52: map<int, bool> := map[p1 := f16];
					v40 := if (p2 in v52) then v52[p2] else v10[safeIndex(p0, |v10|)];
		...
		if (f4) {
			...
			v60[safeIndex(463, v60.Length)] := v61;
			v60[safeIndex(463, v60.Length)] := v61;
			v13 := ((seq(abs(0x368), i6  => (f25))) + v13) + v13;
			var v62: multiset<int> := multiset{f5, p1, p3, |v10|};
			var v63: set<multiset<int>> := {v62[p1 := abs(p2)]};
			var v64: seq<multiset<int>> := [v62[f15 := abs(f5)], multiset([|{f4, f16, true, f4}|]), v62, v62];
			r2, v63 := fm0(globalState) <== (v13 != v13), {v64[safeIndex(-fm35(f16, f4, -872, globalState), |v64|)]};
			var v65 := DC10(f4, f4, v10);
			var v66 := DC11(v65);
			match (if (f16) then DC11(v65) else v66) {
				case DC9(cf21, cf22, cf23) =>
					var v67: array<char> := new char[22];
					v67[safeIndex(560, v67.Length)] := f25;
					var v68: array<bool> := new bool[25];
					v68[safeIndex(552, v68.Length)] := f4;
					v67, v67[safeIndex(560, v67.Length)], cf22, r2, v68[safeIndex(552, v68.Length)] := v67, f25, p3, fm0(globalState), f16;
					var v69: map<seq<int>, array<bool>> := map[v11 + v11 := v68];
					v68 := if (v11 in v69) then v69[v11] else v68;
					var v70: set<bool> := {v68[safeIndex(552, v68.Length)]};
					var v71: multiset<set<bool>> := multiset{{false, v68[safeIndex(552, v68.Length)], v68[safeIndex(552, v68.Length)]}, v70};
					r2 := v71[v70 := abs(-p1)] <= v71;
					var v72: array<int> := new int[7];
					v72[safeIndex(506, v72.Length)] := p2;
					var v73 := DC1(p2, f4, p3, cf22);
					v72[safeIndex(506, v72.Length)] := v73.cf7;
				case DC10(cf24, cf25, cf26) =>
					...
					v74, r2, cf24, v74 := safeDivisionInt(403, 684), if (true) then v13 <= v13 else cf25, cf24, f15 - fm35(cf25, fm0(globalState), |v80|, globalState);
					...
					var v86: array<bool> := new bool[16] [v85 !! v85, cf24, cf24 ==> cf24, f16 <==> cf25, f4, cf25, cf25, cf26[safeIndex(v74, |cf26|)], !!cf24 ==> cf25, f4, p0 >= |cf26|, f16, f4, false, f15 >= f15, !f16 <== false];
					v86[safeIndex(10, v86.Length)] := f16;
					v86[safeIndex(10, v86.Length)] := f4;
				case DC8(cf20) =>
					var v87 := 0x37a;
					var v88: map<int, int> := map[v87 := f5];
					var v90: map<int, bool> := map[|(if (f4) then v88[p3 := 596] else map v89 : int | (-0x209 <= v89) && (v89 < 0x118) :: (safeModuloInt(v89, f5)) := (f5))| := fm0(globalState)];
					v87, r0 := |v90|, "prueqaxo";
					var v91: array<int> := new int[22](i7 => safeModuloInt(i7, f15));
					v91[safeIndex(80, v91.Length)] := f5 - p3;
					var v92: map<seq<bool>, int> := map[[f16, f4] := p3];
					v87, v91[safeIndex(80, v91.Length)] := if (f4) then if (v10 in v92) then v92[v10] else |v13| else 934, f15 * p3;
					var v93: T2 := new C2(cf20, v62, v13, f16, !f4, |(v62 + v62)|);
					v93 := v93;
					var v94 := new C1(v87, false, f5 >= p0, p2);
				case DC11(cf27) =>
					var v95 := 0xfa;
					var v96: map<bool, string> := map[v10[safeIndex(v95, |v10|)] := v13];
					var v97: map<int, bool> := map[|v13| := f16];
					var v99: array<string> := new string[20] [fm37(globalState) + v13, (seq(abs(0x309), i8  => (f25))) + v13, v13, v13 + v13, (seq(abs(0x6), i9  => (f25)))[safeIndex(-0x20c, |(seq(abs(0x6), i9  => (f25)))|) := f25] + v13, "eigk", seq(abs(0x77), i10  => (f25)), v13, v13, v13, seq(abs(0x3a1), i11  => (f25)), v13, v13[safeIndex(f15, |v13|) := f25], (seq(abs(-0x171), i12  => (f25))) + (seq(abs(911), i13  => (f25))), "fkgsb", if ((if (p2 in v97) then v97[p2] else f4) in v96) then v96[if (p2 in v97) then v97[p2] else f4] else v13, v13, v13, v13, fm52(f16, set v98 : int | (973 <= v98) && (v98 < 0xcc) :: (v98 * p2), f5, f16, globalState)];
					v99[safeIndex(492, v99.Length)] := v13;
					var v100: array<bool> := new bool[24](i14 => v13 != (seq(abs(-249), i15  => (f25))));
					v100[safeIndex(457, v100.Length)] := f4;
					var v101 := DC4(f16, safeModuloInt(f5, |v13|), p1);
					var v102 := DC5(f4, f15, "pw");
					v95, v99[safeIndex(492, v99.Length)], v100[safeIndex(457, v100.Length)], r2, v101 := p2, v102.cf17, f16, v10[safeIndex(safeDivisionInt(p2, p3), |v10|)], v101;
					r2 := false || f16;
					v100[safeIndex(457, v100.Length)] := f4;
					var v103: map<int, int> := map[p3 := p1];
					v95 := -(if (f5 in v103) then v103[f5] else |(map v104 : int | (-0x151 <= v104) && (v104 < -278) :: (v104 - p2) := (v99[safeIndex(492, v99.Length)]))|);
			}
			...
			if (f4) {
				var v107 := 0x365;
				v107 := v107 + p1;
				var v108: array<bool> := new bool[8] [f4, f4, f4, f4, f4, v10[safeIndex(p1, |v10|)], !f16, f16];
				...
				var v115: array<seq<int>> := new seq<int>[19] [v11, seq(abs(-0x50), i16  => (|[false]|)), if (f4) then [|v111|, |v113|] else v11, if (false) then v11 else v11, v11, v11, [p3, p2, -f15, -p2, |v114|], v11 + v11, [|v10|], [p0], v11, seq(abs(421), i18  => (f15)), [|v13|], v11, [f15, p3, p0, |v13|], (seq(abs(-0x62), i19  => (p3))) + v11, v11 + v11, v11, v11];
				v115[safeIndex(201, v115.Length)] := v11;
				v112[safeIndex(374, v112.Length)] := p3;
				v112[safeIndex(991, v112.Length)] := --0x162;
				...
				v115[safeIndex(201, v115.Length)], v112[safeIndex(374, v112.Length)], v112[safeIndex(991, v112.Length)] := (if (f16) then [|v13|] else fm44(v107, v118, f16, f16, globalState)) + v11, p2, fm55(p1, v10, f15 + (if (f5 in v119) then v119[f5] else v107), globalState);
			} else {
				v11 := v11;
				var v120: array<bool> := new bool[4](i20 => !f4);
				v120[safeIndex(224, v120.Length)] := p0 >= f5;
				v120[safeIndex(224, v120.Length)] := true;
				var v121: map<D1, seq<int>> := map[DC5(!fm0(globalState), f5, v13) := v11];
				var v122 := DC10(true, f4, v10);
				var v123: multiset<D4> := multiset{v122};
				var v124: set<bool> := {f16, f4, !v120[safeIndex(224, v120.Length)], v120[safeIndex(224, v120.Length)], f16};
				var v125: array<int> := new int[22] [p0, safeDivisionInt(p3, f5), p1, f15, p0, |v121|, safeModuloInt(p0, p3), -p3, p3 + 80, -fm49(v13, |v123|, v120[safeIndex(224, v120.Length)], false, globalState), |v13|, p1, p2, f15, safeDivisionInt(f15, |map[f25 := f4]|), safeDivisionInt(p3, p0), p2 + f15, |v124|, p1, 0x235, p3, f15];
				v125 := v125;
				var v126 := new C1(p0, fm49("sf", p3, false, f4, globalState) == |v10|, v120[safeIndex(224, v120.Length)], |v13|);
				var v127: array<D1> := new D1[10];
				var v128: map<int, bool> := map[|(v13 + v13)| := f4];
				v127, r2, v11, v120[safeIndex(224, v120.Length)] := v127, !(f16 && v120[safeIndex(224, v120.Length)]), [safeDivisionInt(f15, f15)], if (261 in v128) then v128[261] else f16;
			}
		...
		var v137 := DC10(f16, v10[safeIndex(f5, |v10|)], v10);
		...
		var v147: map<seq<array<bool>>, set<int>> := map[v144 := v146[safeIndex(-p2, |v146|)]];
		var v148 := DC27(if (v144 in v147) then v147[v144] else v145);
		r1 := DC1(|v148.cf51|, v10[safeIndex(-|v13|, |v10|)], p2, v141).(cf6 := f16, cf7 := p1);
		r2 := f16;
	}
}
...
class C4 extends T2, T1, T0 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v0[safeIndex(326, v0.Length)] := f4;
			v0[safeIndex(326, v0.Length)] := f18;
			var v1: set<bool> := {true, f18};
			v0[safeIndex(326, v0.Length)] := v1 > v1;
			var v2 := 'n';
			v2 := v2;
			var v3 := 0x27;
		...
		if (f4) {
			...
			f18 := (v10 * v10) >= (fm33(f23, f4, p0, false, globalState))[v9 := abs(fm32(v11, globalState))];
			var v12: array<bool> := new bool[6];
			v12[safeIndex(45, v12.Length)] := f16;
			v12[safeIndex(45, v12.Length)] := f4;
			v12[safeIndex(45, v12.Length)] := f4;
			if (f4 <==> (f18 <==> f4)) {
				var v13: seq<bool> := [-f23 <= f23, p0 > f15, v12[safeIndex(45, v12.Length)]];
				...
				v14[safeIndex(68, v14.Length)] := (fm34(f5, f23, false, |v17|, globalState))[safeIndex(p0, |fm34(f5, f23, false, |v17|, globalState)|) := f16];
				var v18: map<int, int> := map[p0 := -0x1b7 + f23];
				v13, v14[safeIndex(68, v14.Length)], v18, f18 := v13, v13, v18, v17 == v17;
				var v19: map<bool, int> := map[!v12[safeIndex(45, v12.Length)] := p0];
				var v20: map<map<bool, int>, int> := map[v19 := 0x1a5];
				var v21 := DC16(v20, f23);
				var v22 := DC17(v21);
				v22 := v22;
				var v23 := new C3(v16, 0x25f, v12[safeIndex(45, v12.Length)], f18, safeDivisionInt(fm55(f15, v13, p0, globalState), 0x1b3));
				var v24: map<string, string> := map[f17 := f17];
				v24 := v24[f17 := fm37(globalState)];
				var v25: array<D5> := new D5[24];
				v25 := v25;
			} else {
				v5[safeIndex(730, v5.Length)] := p0;
				v5[safeIndex(730, v5.Length)] := -0x147;
				var v26: map<bool, int> := map[f18 := p0];
				var v27: seq<map<bool, int>> := [v26];
				v12[safeIndex(45, v12.Length)] := v27[safeIndex(p0, |v27|)] == v26;
				var v28 := "iywbpbre";
				var v29: array<char> := new char[6];
				var v30 := 'y';
				v29[safeIndex(138, v29.Length)] := v30;
				var v31: multiset<bool> := multiset{fm0(globalState)};
				var v32: seq<bool> := [v12[safeIndex(45, v12.Length)], f18, f4];
				var v33 := DC3(v32);
				var v34: map<D1, bool> := map[v33 := f16];
				var v35: seq<bool> := [if (v33 in v34) then v34[v33] else f4, true, f24, f16];
				v28, v29[safeIndex(138, v29.Length)], v12[safeIndex(45, v12.Length)], v5[safeIndex(730, v5.Length)], v31 := seq(abs(922), i2  => (v30)), v30, f16, 0x3c2, multiset(v35);
				f18 := f24;
			...
			v38[safeIndex(492, v38.Length)] := f23 < f15;
			v38[safeIndex(492, v38.Length)] := f16;
			var v39: seq<int> := [-f5, f23];
			f18 := f15 != v39[safeIndex(f5, |v39|)];
			if (f16) {
				...
				var v46: seq<multiset<int>> := [multiset{f5, fm49(f17, f5, !v45[safeIndex(|v45|, |v45|)], true, globalState)}, v41];
				var v47 := DC23(f18, v39[safeIndex(f23, |v39|)], v41[0x35b := abs(|v44.cf66|)] < v46[safeIndex(|f17|, |v46|)]);
				...
				v47 := DC23(f16, v49.cf63, if ((map v52 : int | (0xe1 <= v52) && (v52 < 0x2) :: (safeModuloInt(v52, f23)) := (f18)) in v51) then v51[map v52 : int | (0xe1 <= v52) && (v52 < 0x2) :: (safeModuloInt(v52, f23)) := (f18)] else true);
				var v53 := -514;
				v53 := fm55(v39[safeIndex(|fm58(|f17|, v53, globalState)|, |v39|)], v45 + v45, safeModuloInt(|(seq(abs(0x18b), i3  => (v42)))|, 0x39), globalState);
				var v54 := DC3(v45);
				var v55: seq<D1> := [v54.(cf11 := v45), DC3(v45)];
				var v56: map<int, string> := map[|(v39 + [-|v55|, |v40|, f5])| := f17];
				var v57: seq<map<int, string>> := [map[|v50| := f17]];
				v56 := v57[safeIndex(-0xaa, |v57|)];
				...
				v38[safeIndex(492, v38.Length)] := f24;
			} else {
				var v58 := 0xe4;
				v58 := if (f4) then 0x51 else |f17| * v58;
				v38[safeIndex(492, v38.Length)] := f4;
			...
			var v64 := 'a';
			var v65: array<char> := new char[10] [v64, v64, v64, f17[safeIndex(v39[safeIndex(p0, |v39|)], |f17|)], v64, fm50(globalState), if (f16) then 'm' else v64, v64, v64, v64];
			v65[safeIndex(558, v65.Length)] := v64;
			v65[safeIndex(558, v65.Length)] := f17[safeIndex(f15, |f17|)];
			var v66: seq<char> := [v65[safeIndex(558, v65.Length)], v65[safeIndex(558, v65.Length)], v65[safeIndex(558, v65.Length)]];
			v66 := v66;
		}
		
		var v67: seq<int> := [f23, f15];
		var v68: map<bool, bool> := map[true := f4];
		var v69: array<bool> := new bool[9] [f24, v67[safeIndex(f23, |v67|)] == f23, if (f18 in v68) then v68[f18] else f18, f18, false, f18, f18, true, f18];
		v69[safeIndex(243, v69.Length)] := f18;
		var v70 := -0x17a;
		v69[safeIndex(243, v69.Length)], v70, v69 := f4, safeModuloInt(f15, f5), v69;
		var v71: array<int> := new int[25](i4 => i4 * |v67|);
		var v72: map<array<int>, bool> := map[v71 := v69[safeIndex(243, v69.Length)]];
		v72 := v72[v71 := v69[safeIndex(243, v69.Length)]];
		if (DC30(!(if (f24 in v68) then v68[f24] else f4), v71, f23, v69[safeIndex(243, v69.Length)]).cf61) {
			f18 := f24;
			var v73 := DC5(f18, v70, f17);
			var v74: seq<D1> := [v73.(cf16 := p0), v73];
			v70 := |v74|;
			v69[safeIndex(243, v69.Length)] := f4;
			v70 := -f23 + f23;
			var v75 := 's';
			var v76: set<bool> := {f4, f24};
			var v78 := DC22(v69[safeIndex(243, v69.Length)]);
			var v79: map<set<bool>, D9> := map[v76 := v78];
			var v80: multiset<array<bool>> := multiset{v69, v69, v69};
			var v81: map<D7, bool> := map[DC18(v80) := true];
			var v82 := DC18(v80);
			v69[safeIndex(243, v69.Length)], v70, v69[safeIndex(243, v69.Length)], f18, globalState.f0 := fm31(fm49("amkdf", |v68|, v69[safeIndex(243, v69.Length)], f18, globalState), v69[safeIndex(243, v69.Length)], f24, v75, globalState), safeModuloInt(|[f24]|, f23) * f23, f5 > (if (v69[safeIndex(243, v69.Length)]) then |v76| else |(map v77 : set<bool> | v77 in v79 :: (v77) := (multiset{v75}))|), if ((if (v82 in v81) then v81[v82] else f16) in v68) then v68[if (v82 in v81) then v81[v82] else f16] else f4, v76;
		} else {
			var v83 := 'r';
			var v84: array<string> := new seq<char>[4] [((seq(abs(0x27c), i5  => ('d'))) + f17)[safeIndex(f23, |((seq(abs(0x27c), i5  => ('d'))) + f17)|) := v83], f17, "bgtgjn", f17];
			var v85: seq<string> := [f17];
			v84[safeIndex(179, v84.Length)] := v85[safeIndex(f23, |v85|)];
			v84[safeIndex(179, v84.Length)] := f17;
			...
			var v90 := new C2(v69, multiset{-381, if ([f16] in v87) then v87[[f16]] else f5}, v84[safeIndex(179, v84.Length)] + f17, v89 > multiset{v88}, f16, f23);
			var v91: map<char, int> := map['q' := v70];
			var v92: map<char, string> := map[f17[safeIndex(|v91|, |f17|)] := f17];
			v92 := v92[v83 := "q"];
			v84[safeIndex(179, v84.Length)] := v84[safeIndex(179, v84.Length)] + v84[safeIndex(179, v84.Length)];
	...
	method m15(p0: bool, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: D0, r3: int) {
		r1 := --326;
		r1 := fm49(seq(abs(0x32f), i0  => ('d')), p1, f17 == f17, f18, globalState);
		var v0 := DC1(p1, f24, p1, f5);
		var v1: seq<bool> := [f24, p0, f16];
		f18 := if ((v0.(cf5 := f23, cf6 := f16)).cf6) then f24 else v1[safeIndex(f15, |v1|)];
		var v2 := 'r';
		...
		v4[safeIndex(761, v4.Length)] := v3;
		v4[safeIndex(761, v4.Length)] := v3;
		var v5: seq<array<bool>> := [v4[safeIndex(761, v4.Length)], v4[safeIndex(761, v4.Length)], v3];
		var v6: seq<array<bool>> := [v5[safeIndex(f5, |v5|)]];
		var v7 := DC34(v5);
		v6 := (v6 + v6) + (v7.cf71 + v6);
		if (f16) {
			var v8: map<bool, int> := map[v1[safeIndex(-p1, |v1|)] := f15];
			...
			v9 := v9[f15 := |(v11 * v11)|];
			var v12 := DC33(f18, p0, f17[safeIndex(f15, |f17|)], |"la"|);
			...
			var v19: map<string, map<map<bool, bool>, map<int, D8>>> := map[("oj")[safeIndex(f15, |"oj"|) := v12.cf69] := (fm59(f15, v13, false, globalState))[v14 := v18[|v13| := v17]]];
			var v20: map<map<bool, bool>, map<int, D8>> := map[v14 := v18];
			v19 := v19[f17 := v20];
			r0 := v2;
			var v21 := DC32(multiset{'j'});
			v21 := v21;
			var v22: multiset<int> := multiset{|(seq(abs(-845), i1  => (f23)))|, p1, f5};
			var v23 := DC4(v1[safeIndex(f15, |v1|)], f23, f15);
			var v24 := new C2(v4[safeIndex(761, v4.Length)], v22 - v22, f17 + f17[safeIndex(916, |f17|) := v2], v23.cf12, f16 ==> p0, p1);
		} else {
			...
			f18 := false;
			var v30: array<set<int>> := new set<int>[17](i2 => set v29 : int | (0x306 <= v29) && (v29 < 0x360) :: (safeDivisionInt(v29, |v1|)));
			var v31: array<array<set<int>>> := new array<set<int>>[7] [v30, v30, v30, v30, v30, v30, v30];
			v31[safeIndex(680, v31.Length)] := v30;
			v31[safeIndex(680, v31.Length)] := v30;
		...
		r0 := v2;
		r1 := f23 - f23;
		r2 := v0.(cf6 := f16, cf7 := |(f17[safeIndex(f5, |f17|) := 'k'] + f17)|);
		r3 := f15;
	}
	method m16(p0: bool, p1: int, p2: seq<int>, globalState: GlobalState) {
		...
		v12[safeIndex(82, v12.Length)] := v13;
		v12[safeIndex(82, v12.Length)] := v13 + v13[safeIndex(v1, |v13|) := f4];
	}
}
...
class C5 {
	...
	method m13(p0: int, p1: D1, globalState: GlobalState) {
		...
		if (fm27(v2, globalState)) {
			...
			if (v0) {
				...
				var v4: array<int> := new int[25](i0 => safeDivisionInt(i0, p0));
				v3[safeIndex(45, v3.Length)] := v4;
				var v5: set<int> := {p0, -p0, p0, p0};
				var v6: seq<bool> := [v0, v0, !v0];
				v0, v3[safeIndex(45, v3.Length)], v5, v1, v6 := v0, v4, v5, -p0, v6;
				v2 := v2;
				var v7: set<bool> := {v0, v0};
				globalState.f0 := v7 + v7;
				v1 := safeDivisionInt(p0, fm26(globalState));
				...
				v13 := v13;
				v1 := safeDivisionInt(v1, p0) - p0;
				var v14: map<int, int> := map[0x169 := v1];
				v1 := safeModuloInt(-|v14|, 212);
				v0 := v1 <= v1;
			}
			...
			v15 := if (!(p0 >= |v18[safeIndex(p0, |v18|)]|)) then if (|v20| in v19) then v19[|v20|] else set v23 : map<int, int> | v23 in v22.cf42 :: (v23) else v15;
			var v24: map<int, int> := map[fm26(globalState) := 221];
			v16[safeIndex(225, v16.Length)] := fm26(globalState);
			v16[safeIndex(958, v16.Length)] := p0;
			var v25: seq<int> := [v1];
			var v26: seq<map<int, int>> := [(map[v1 := p0])[|v25[safeIndex(859, |v25|) := |map[p0 := v0]|]| := |v24|], v24];
			var v27: set<bool> := {v0};
			v24, v16[safeIndex(225, v16.Length)], globalState.f0, v16[safeIndex(958, v16.Length)], v2 := map[|"jjxlrdmc"| := -|v20|] + (v26[safeIndex(v1, |v26|)])[fm26(globalState) := v1], fm26(globalState), v27 + v27, p0, 'h';
		} else {
			v0 := v0;
			...
			var v41: set<string> := {v33, fm28(seq(abs(-288), i2  => (v2)), if (true in v40) then v40[true] else v1, v1, globalState)};
		...
		var v47: set<int> := {v1, |{v0}|, |v45[safeIndex(if (v0 in v46) then v46[v0] else 0x4, |v45|) := v1]|};
		if ((v47 * v47) > v47) {
			v1 := safeModuloInt(fm26(globalState) + |(seq(abs(-616), i3  => (|v44|)))|, 0x30f);
			var v48: map<bool, int> := map[!!v0 := 0x1f5];
			var v49: seq<map<bool, int>> := [v48];
			var v50: map<seq<map<bool, int>>, int> := map[v49 + v49 := |v44|];
			v50 := v50[v49 := safeDivisionInt(p0, p0)];
			var v51 := "hrucpv";
			...
			v54[safeIndex(818, v54.Length)] := v48;
			var v55: set<array<int>> := {v53};
			v54[safeIndex(818, v54.Length)] := map[p0 != p0 := safeModuloInt(-|v55|, v1)];
			v0 := v0;
			...
			var v61: seq<bool> := [v0];
			var v62: array<seq<bool>> := new seq<bool>[17] [v61, v61, v61, v61, v61, v61, v61, v61, v61, v61 + v61, v61, v61, v61[safeIndex(0xb5, |v61|) := true], v61, v61, v61, fm30(p0, globalState)];
			v62[safeIndex(352, v62.Length)] := v61;
			v62[safeIndex(352, v62.Length)] := [v0, v0];
			var v63 := new C1(v1, v0, v0, p0);
			var v64 := "fdaxhmngh";
			var v65: seq<string> := [v64];
			v0 := (v65[safeIndex(p0, |v65|)] + v64) != (v64 + v64);
			v1 := -(p0 - p0);
			var v66: array<bool> := new bool[14];
			var v67: multiset<int> := multiset{|v47|, 104};
			v66[safeIndex(825, v66.Length)] := v64 == (fm28(fm28("yb", 0x126, p0, globalState), |v64|, if (v1 in v67) then v67[v1] else p0, globalState))[safeIndex(-(if (v0 in v46) then v46[v0] else |v64|), |fm28(fm28("yb", 0x126, p0, globalState), |v64|, if (v1 in v67) then v67[v1] else p0, globalState)|) := 'g'];
			v66[safeIndex(825, v66.Length)] := v67 < v67[p0 := abs(p0)];
		}
		...
		for i5 := -p0 to v1 {
			if (v0) {
				...
				var v71 := new C4(|v69|, v70[safeIndex(0x19a, |v70|)], v69, v0, v0, i5, |(v45[safeIndex(v1, |v45|) := v1])[safeIndex(-0x192, |v45[safeIndex(v1, |v45|) := v1]|) := |v44|]|, !v0);
				var v72: seq<seq<int>> := [v45];
				var v73: map<seq<int>, int> := map[v72[safeIndex(v1, |v72|)] := |v69|];
				v73 := v73;
				var v74 := DC9(map[v0 := p0], p0, v71.f24);
				var v75: map<int, int> := map[v1 := i5];
				var v76: multiset<int> := multiset{fm26(globalState), |v46|, p0};
				var v77: array<int> := new int[28] [p0, |v69|, safeDivisionInt(--|v69|, if (v71.f23 in v75) then v75[v71.f23] else v1), p0, v1, if (v71.f24) then v71.f23 else -p0, v71.f23, v71.f23 - i5, v1, v71.f23, 0x27b, 0x313, v1 - 446, v1, if (i5 in v76) then v76[i5] else p0, if (v71.f24) then --|[v71.f24]| else v1, v71.f23, p0, v1, fm55(v71.f23, v70, v1, globalState) - i5, v71.f23 - v71.f23, |(v45 + v45)|, fm49(v69, p0, false, v71.f24, globalState), |v45|, 629, if (v71.f24) then p0 else 470, |"uhvybudgo"|, v1];
				v77[safeIndex(855, v77.Length)] := i5;
				v74, v0, v0, v77[safeIndex(855, v77.Length)] := v74, v71.f24, !v71.f24, v1;
				v77[safeIndex(855, v77.Length)] := v1;
			} else {
				v1 := fm49(seq(abs(0x0), i6  => (v2)), i5, !false, if (false) then v0 else v0, globalState);
				v1 := v1;
				v0 := v0 ==> v0;
				var v78: map<set<int>, bool> := map[{i5} := v0];
				var v79: map<int, bool> := map[p0 := v0];
				var v81: map<bool, bool> := map[v0 := v0];
				v0 := !(if ((set v80 : int | v80 in v79 :: (safeModuloInt(v80, 0x350))) in v78) then v78[set v80 : int | v80 in v79 :: (safeModuloInt(v80, 0x350))] else |v81| < v1);
			...
			var v85 := "ulcu";
			v85 := fm28("flt", p0, -v45[safeIndex(i5, |v45|)], globalState);
			if ((!v0 <== v0) && v0) {
				v0 := if (v0) then true else v0;
				var v86: seq<string> := ["qsfss"];
				var v87: seq<bool> := [v0];
				var v88: array<int> := new int[19] [|v44|, -i5, p0, i5, |(v86 + v86)|, v1, p0, |(seq(abs(0x22e), i9  => (v2)))|, v1, v1 * p0, p0, v1, |v87|, 0x2cc + p0, 103, p0, p0, p0, 0x313];
				var v89: array<char> := new char[18];
				v89[safeIndex(695, v89.Length)] := v2;
				var v90: set<array<int>> := {v88, v88, v88};
				var v91: array<bool> := new bool[5] [fm27(v2, globalState), v0, v0, v0, 'r' in v85];
				v91[safeIndex(864, v91.Length)] := v0;
				var v92: map<int, bool> := map[v1 := fm27(v85[safeIndex(0xfe, |v85|)], globalState)];
				v88, v89[safeIndex(695, v89.Length)], v0, v90, v91[safeIndex(864, v91.Length)] := v88, v2, (map[p0 := v0] + map[p0 := v0]) == v92, v90, v0;
				v1 := -v1;
				v91[safeIndex(864, v91.Length)] := i5 == -v1;
				var v93 := new C2(v91, multiset{v1, |v85|, p0}, "ja" + v85, v91[safeIndex(864, v91.Length)], !v91[safeIndex(864, v91.Length)], 893);
			} else {
				var v94, v95, v96 := m14(globalState);
				var v97: array<int> := new int[12];
				v97[safeIndex(287, v97.Length)] := v1;
				...
				v97[safeIndex(287, v97.Length)] := if (v85 in v100) then v100[v85] else 694;
				...
				v104[safeIndex(384, v104.Length)] := v2;
				var v105: map<int, bool> := map[p0 := false];
				v104[safeIndex(384, v104.Length)], v95 := 'l', safeModuloInt(|(v105 + v105)|, v95);
				var v106: map<bool, bool> := map[v0 := v0];
				var v107 := DC0(v0, |v106|, v0, p0, v0);
				v97[safeIndex(287, v97.Length)] := fm32(v107, globalState);
			}
	...
	method m14(globalState: GlobalState) returns (r0: multiset<string>, r1: int, r2: multiset<bool>) {
		...
		var v2 := -0x29c;
		var v3 := DC22(v1[safeIndex(v2, |v1|)]);
		var v4: seq<bool> := [v0 || true, true, v0, if (v0) then v3.cf44 else v0, v0];
		var v5: seq<int> := [v2];
		var v6: map<bool, int> := map[true := v5[safeIndex(v2, |v5|)]];
		var i0 := 0;
		while (v1[safeIndex(|v6|, |v1|)])
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v7[safeIndex(620, v7.Length)] := v9;
			v7[safeIndex(620, v7.Length)] := if (v0 ==> v0) then v9 else [v8] + v9;
			var v10: array<int> := new int[19];
			var v11 := DC14(v0, v4, v10, v2 * v2, v2);
			match (v11) {
				case DC13(cf29, cf30) =>
					r1 := 0x8c;
					var v12: T0 := new C4(-v2, v0, v8, cf30, false, |v8|, v5[safeIndex(v2, |v5|)], cf29);
					var v13: multiset<T0> := multiset{v12};
					r1 := -safeModuloInt(if (v12 in v13) then v13[v12] else v2, --v12.f5);
					cf30 := cf30;
					r1 := safeModuloInt(-v12.f5, v2 * -933);
				case DC14(cf31, cf32, cf33, cf34, cf35) =>
					v2 := safeDivisionInt(cf35, v2);
					var v14 := m0(cf31, cf35, globalState);
					var v15 := 's';
					cf31 := !(if (fm27(v15, globalState)) then v0 else v14);
					v2 := cf34;
				case DC12(cf28) =>
					v10[safeIndex(670, v10.Length)] := v2;
					var v16: set<bool> := {v0, v0, !v0};
					v10[safeIndex(670, v10.Length)] := fm55(-v2, fm30(|v16|, globalState), 0x6c, globalState) * |v8|;
					v0 := v10[safeIndex(670, v10.Length)] <= v10[safeIndex(670, v10.Length)];
					...
					var v19 := 'g';
					var v20 := new C3(v19, -v10[safeIndex(670, v10.Length)], fm27(v19, globalState), v0, v2);
			}
			...
			v22[safeIndex(858, v22.Length)] := v21;
			v22[safeIndex(858, v22.Length)], v0, v0, r1, r1 := v21, v0, v0, v2, -v5[safeIndex(v2, |v5|)];
		...
		if (v0) {
			var v27 := "yeuq";
			var v28 := 'w';
			var v29: map<bool, string> := map[v0 := v27[safeIndex(v2, |v27|) := v28] + v27];
			v29 := v29[!v0 := v27];
			var v30: map<int, bool> := map[v2 := v0];
			if (-safeDivisionInt(v2, -|v30|) < v2) {
				var v32: map<string, string> := map[v27 := seq(abs(-0x1af), i2  => (v28))];
				...
				r1 := if (|v37| in v33) then v33[|v37|] else safeModuloInt(v2, v2);
				var v38 := DC24(v2);
				...
				v44[safeIndex(754, v44.Length)] := v0;
				v44[safeIndex(754, v44.Length)] := false;
				v0, r1, v2 := v44[safeIndex(754, v44.Length)], v2, v2;
				var v45 := DC19(925);
				var v46: map<seq<int>, D7> := map[v5 := v45];
				v2 := |(v46 + v46)|;
				var v47: multiset<bool> := multiset{v0};
				r1 := if (v2 in v41) then v41[v2] else safeModuloInt(v2, if (true in v47) then v47[true] else |v40|);
			}
			
			if (v0) {
				var v48: multiset<bool> := multiset{v0};
				var v49: multiset<multiset<bool>> := multiset{v48};
				v0 := v5 < ([v2, v2])[safeIndex(|(v27[safeIndex(|v5|, |v27|) := v28])[safeIndex(if (v48 in v49) then v49[v48] else |v1|, |v27[safeIndex(|v5|, |v27|) := v28]|) := v28]|, |[v2, v2]|) := v2];
				...
				var v57: array<set<array<D6>>> := new set<array<D6>>[24] [v55, v55 + v55, {v54, v54}, v55, v55 * v55, v55, v56[safeIndex(v2, |v56|)], v55, v55, v55 + {v54}, v55, v55, v55, v55, v55, v55, v55, v56[safeIndex(v2, |v56|)], v55, v55, {v54, v54, v54}, v55, v55, v55];
				v57[safeIndex(992, v57.Length)] := v55;
				v57[safeIndex(992, v57.Length)] := v55;
				var v58: multiset<int> := multiset{v2, v2, v2};
				v2 := |v58|;
				var v59 := new C4(|v27|, v0, (v27 + v27)[safeIndex(v2, |(v27 + v27)|) := v28], !(v0 <==> v0), if (v0) then v0 else v0, v2, v2, v0);
				v27 := (v27[safeIndex(|v5|, |v27|) := v28])[safeIndex(v59.f23, |v27[safeIndex(|v5|, |v27|) := v28]|) := v28] + v27;
			} else {
				v0 := v0;
				var v60: array<bool> := new bool[3](i4 => v0);
				var v61: map<bool, array<bool>> := map[false := v60];
				v61 := v61[v0 := v60];
				r1 := -safeModuloInt(v2, fm49(v27, v2, v0, v0, globalState));
				var v62 := new C3(v28, |v30|, v0 && v0, v0, safeDivisionInt(v2, --(if (v0 in v6) then v6[v0] else v2)));
				var v63 := new C4(v2, if (v0) then true else v0, v27, v0, v0, if (v0) then v2 else v2, |v1|, v2 > v2);
			}
			
			v2 := v2;
			v2 := 709 + safeDivisionInt(|v27|, v2);
		} else {
			v2 := fm55(v2, v1, v2, globalState);
			v2 := safeModuloInt(v2, v2 * v2);
			v0 := v0;
			var v64: array<int> := new int[7](i5 => i5 - v2);
			v64[safeIndex(13, v64.Length)] := v2 - |{v0, false}|;
			v64[safeIndex(13, v64.Length)] := -v2;
		...
		if (!(fm27('y', globalState) <== v0)) {
			r1 := v2;
			var v66: seq<char> := ['h'];
			var v67 := new C3(v66[safeIndex(v2, |v66|)], v2, v0, v0, v2);
			var v68: array<bool> := new bool[21];
			v68 := v68;
			var v69 := DC0(false, v2, v0, v2, v0);
			var v70: seq<string> := [v66];
			var v71: array<D0> := new D0[19] [v69, v69, v69, DC0(v0, v2, true, v2, !v0), v69, v69, if (v0) then v69 else v69, v69.(cf1 := v2, cf2 := v0), DC0(true, v2, v0, |v66|, true), DC0(!v0, v2, false, v2, v0), v69, DC0(v0, v2, v0, -v2, true), v69, fm61(v2, !v0, globalState), v69, DC0(v0, |v70[safeIndex(v2, |v70|)]|, v0, v2, v0), v69, v69, v69];
			v71[safeIndex(305, v71.Length)] := v69;
			var v72: multiset<int> := multiset{v2, -v2 + v2, v2 + -v2};
			var v73: multiset<bool> := multiset{v0, v0};
			var v74: seq<multiset<int>> := [v72, v72];
			var v75: map<int, int> := map[|v1| := |v74[safeIndex(v2, |v74|)]|];
			...
			v79[safeIndex(42, v79.Length)] := v2;
			v0, v71[safeIndex(305, v71.Length)], v72, v0, v79[safeIndex(42, v79.Length)] := v0, v69, v72 * v72, v0, v2 * v2;
			v79[safeIndex(42, v79.Length)] := v79[safeIndex(42, v79.Length)];
		} else {
			if (v0) {
				var v80 := 't';
				...
				r1 := v5[safeIndex(if (v0) then v2 else v2, |v5|)];
				var v86: array<array<bool>> := new array<bool>[28];
				var v87: array<bool> := new bool[11](i6 => true);
				v86[safeIndex(464, v86.Length)] := v87;
				v86[safeIndex(464, v86.Length)] := v87;
				var v88: map<array<bool>, bool> := map[v86[safeIndex(464, v86.Length)] := v0];
				v88 := v88[v86[safeIndex(464, v86.Length)] := fm27('t', globalState)];
				v2 := -0x162;
				v0 := v0;
			}
			...
			if (v0) {
				...
				v89[safeIndex(194, v89.Length)] := v0;
				var v90: array<int> := new int[21];
				v90[safeIndex(862, v90.Length)] := v2;
				v89[safeIndex(194, v89.Length)], v90[safeIndex(862, v90.Length)], v0, r1 := v0, v2, false, v5[safeIndex(v2, |v5|)];
				v90[safeIndex(862, v90.Length)] := v2;
				v2 := v2;
				var v91: array<string> := new string[29];
				var v92 := "e";
				v91[safeIndex(102, v91.Length)] := v92;
				v91[safeIndex(102, v91.Length)] := fm37(globalState);
				var v94: multiset<bool> := multiset{v89[safeIndex(194, v89.Length)], v0};
				var v95: set<bool> := {v89[safeIndex(194, v89.Length)]};
				var v96: set<seq<int>> := {[|v94|], v5, v5, v5[safeIndex(0x2cc, |v5|) := |v95|]};
				var v98: map<int, int> := map[v90[safeIndex(862, v90.Length)] := |v4|];
				var v99: seq<map<int, int>> := [v98, v98, v98];
				var v100: map<seq<int>, map<int, int>> := map[v5 := v98];
				var v101 := 'n';
				v91[safeIndex(102, v91.Length)] := (v91[safeIndex(102, v91.Length)][safeIndex(|((map v93 : seq<int> | v93 in v96 :: (v93) := (map v97 : int | v97 in {-0x17d, v90[safeIndex(862, v90.Length)]} :: (v97 * v5[safeIndex(v90[safeIndex(862, v90.Length)], |v5|)]) := (0x3cf)))[v5 := v99[safeIndex(|v91[safeIndex(102, v91.Length)]|, |v99|)]] + v100)|, |v91[safeIndex(102, v91.Length)]|) := v101])[safeIndex(v90[safeIndex(862, v90.Length)], |v91[safeIndex(102, v91.Length)][safeIndex(|((map v93 : seq<int> | v93 in v96 :: (v93) := (map v97 : int | v97 in {-0x17d, v90[safeIndex(862, v90.Length)]} :: (v97 * v5[safeIndex(v90[safeIndex(862, v90.Length)], |v5|)]) := (0x3cf)))[v5 := v99[safeIndex(|v91[safeIndex(102, v91.Length)]|, |v99|)]] + v100)|, |v91[safeIndex(102, v91.Length)]|) := v101]|) := v101];
			} else {
				var v102 := "ucn";
				var v103 := 'l';
				...
				var v106: map<map<string, array<bool>>, string> := map[v105 := v102[safeIndex(v2, |v102|) := v103]];
				v106 := v106[v105 := v102 + v102];
				var v107 := DC13(v0, !v0);
				var v108: map<bool, bool> := map[v5 != (seq(abs(53), i7  => (v2))) := v107.cf30];
				v108 := v108[v0 := v0];
			...
			r1, v0 := safeModuloInt(0x2ac, -|(v113 + v113)|), v0;
			...
			match (DC38(v0 <== v0)) {
				case DC37(cf73) =>
					...
					v118[safeIndex(0, v118.Length)] := if (v0) then v0 else v0;
					v115, v118[safeIndex(0, v118.Length)], v0 := v115 + v115, false ==> ([|v116|] < v5), (19 * |{v0}|) <= v2;
					v2 := |((multiset{|v116|} - multiset{v2}) - (multiset{v2} + v117))|;
					var v119: map<int, bool> := map[v2 := v0];
					r1 := safeModuloInt(-|(if (v118[safeIndex(0, v118.Length)]) then v119 else map[-0x3dd := v0])|, |(seq(abs(-0x1da), i8  => (v2)))[safeIndex(|map[v2 := false]|, |(seq(abs(-0x1da), i8  => (v2)))|) := v2]|);
					var v120 := m0(v0, |(seq(abs(0x16d), i9  => (v2)))|, globalState);
				case DC38(cf74) =>
					v0 := cf74;
					r1 := v2;
					var v121: array<char> := new char[21](i10 => 's');
					var v122 := 'h';
					v121[safeIndex(529, v121.Length)] := v122;
					v121[safeIndex(529, v121.Length)] := v122;
					v0 := v0 || v0;
				case DC36(cf72) =>
					v2 := v2;
					...
					v124[safeIndex(399, v124.Length)] := v2;
					v2, v124[safeIndex(399, v124.Length)], v0, r1, r1 := if (v0) then fm55(v2, v4, v2, globalState) else v2, v2, v0, v2, v2;
			}
...
class C6 extends T0, T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
		f21 := safeModuloInt(f5, f21);
		var v0 := "nvtpgu";
		var v1 := 'b';
		v0 := (v0 + v0)[safeIndex(f5, |(v0 + v0)|) := v1];
		var v2: multiset<bool> := multiset{f22, f4, f4, f4};
		f21 := if (v2 >= v2) then f5 else 0x1a3;
		var v3: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[24](i0 => (seq(abs(0x21b), i1  => (map[f4 := f16]))) + (seq(abs(0x2a3), i2  => (map[f4 := f16]))));
		var v4: seq<bool> := [true];
		var v5: map<bool, bool> := map[f16 := v4[safeIndex(f21, |v4|)]];
		var v6: seq<map<bool, bool>> := [v5];
		v3[safeIndex(944, v3.Length)] := v6;
		v3[safeIndex(944, v3.Length)] := v6;
		var v7 := true;
		var v8: array<bool> := new bool[24];
		v8[safeIndex(58, v8.Length)] := f4;
		var v9: array<seq<int>> := new seq<int>[8];
		var v10: seq<int> := [fm25(f5, 0x42, f22, globalState), -p0, f15];
		v9[safeIndex(625, v9.Length)] := v10;
		var v11: set<bool> := {f16};
		v7, f21, globalState.f0, v8[safeIndex(58, v8.Length)], v9[safeIndex(625, v9.Length)] := v4[safeIndex(v10[safeIndex(|v5|, |v10|)], |v4|)], p0, v11, v10 <= v10, DC15(v10).cf36;
		for i3 := |v0| - f5 to p0 {
			var v12 := new C5();
			var v13: array<array<int>> := new array<int>[5];
			var v14: array<int> := new int[22];
			v13[safeIndex(403, v13.Length)] := v14;
			v13[safeIndex(403, v13.Length)] := v14;
			v1 := v1;
			var v15: set<int> := {0xd9, f5};
			var v16: set<string> := {fm52(v8[safeIndex(58, v8.Length)], v15, i3, v7, globalState), v0, v0, v0};
			var v17 := DC12(v16);
			var v18: map<bool, int> := map[f16 := f5];
			var v19: array<D5> := new D5[13] [DC12({"uxs", seq(abs(-0x40), i4  => (DC33(f4, f16, v1, 897).cf69))}), v17, v17.(cf28 := fm62(f4, v18, f5, globalState)), DC12(fm62(f4, v18, i3, globalState)), v17, v17, v17, v17, v17, v17, v17, fm63(p0, f22, globalState), v17];
			v19[safeIndex(277, v19.Length)] := v17;
			v19[safeIndex(277, v19.Length)] := if (true) then v17 else v17;
		}
	}
	method m11(globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: int) {
		...
		if (f16) {
			...
			if (f22) {
				...
				var v4 := DC3(v0);
				var v5: array<seq<bool>> := new seq<bool>[21] [v0, v0, v0 + [f4], v0, fm34(f21, |v1|, fm27(v2, globalState), f5, globalState), v0, [f16], ([f4])[safeIndex(f5, |[f4]|) := f16] + (if (true in v3) then v3[true] else [f22, f22]), [f4] + v0, v0, v0 + v4.cf11, v0[safeIndex(f21, |v0|) := !f4], [fm0(globalState)], v0 + v0, v0 + v0, v0, v0 + v0, [f16] + [f22, true], v0, v0, fm34(f15, f21, false, f5, globalState)];
				v5[safeIndex(449, v5.Length)] := v0 + v0;
				v5[safeIndex(449, v5.Length)] := v0;
				r3 := fm26(globalState);
				...
				v15[safeIndex(946, v15.Length)] := v14 + v14;
				v15[safeIndex(946, v15.Length)] := v14;
			} else {
				...
				var v24 := 'h';
				v21, v16, v18, v18, r1 := if (v22 in v23) then v23[v22] else v21, v16, (seq(abs(293), i0  => ('l'))) + (v18 + (seq(abs(-0x65), i1  => ('j')))[safeIndex(451, |(seq(abs(-0x65), i1  => ('j')))|) := v24])[safeIndex(|"ojokswewn"|, |(v18 + (seq(abs(-0x65), i1  => ('j')))[safeIndex(451, |(seq(abs(-0x65), i1  => ('j')))|) := v24])|) := v24], v18, 0x36;
			}
			
			var v25: array<D7> := new D7[1];
			var v26: seq<array<D7>> := [v25, v25];
			var v27: array<array<D7>> := new array<D7>[12] [v25, v25, v25, v25, v25, v25, if (f16) then v25 else v25, v25, v25, v25, v26[safeIndex(f15, |v26|)], v25];
			v27[safeIndex(165, v27.Length)] := v25;
			...
			var v29: multiset<array<bool>> := multiset{v28, v28};
			var v30 := DC18(v29);
			v27[safeIndex(165, v27.Length)] := new D7[2] [v30, v30];
			...
			var v36 := new C2(v32, multiset{f5, -f21, |v33|}, v34, f21 <= f5, f4, -safeDivisionInt(-|v35|, f15));
			...
			var v40 := 'n';
			var v41: seq<int> := [f21, |("aqdw")[safeIndex(|v35|, |"aqdw"|) := v40]|];
			var v42 := DC29(f21, v36.f28, f22, if (true in v39) then v39[true] else f4);
			var v44: array<int> := new int[24] [f21, f5, |v39|, -f5, f21, |(map[f15 := f21])[|v34| := -f21]|, 0x1a4, f21, f5, 0x3de, f15, |v41|, f21, |fm46(globalState)|, fm49("uw", f21, v42.cf60, f4, globalState), |(set v43 : int | (0x10a <= v43) && (v43 < 0x1f5) :: (safeDivisionInt(v43, |v34|)))|, f5, f21, f5, -f5, |v34|, 0x250, -766, f21];
		...
		match (v53) {
			case DC22(cf44) =>
				if (f22) {
					...
					var v56: array<array<bool>> := new array<bool>[14] [v49, v49, v49, if (f4 in v54) then v54[f4] else v49, v49, v49, v49, v49, v49, v49, v55[safeIndex(f5, |v55|)], v49, v49, v49];
					...
					var v63 := new C3(v60, f21 * v48.f27, v49[safeIndex(772, v49.Length)], f4, |(v62 + v62)|);
					cf44 := f4;
					...
					v49 := new bool[22](i4 => v49[safeIndex(772, v49.Length)]);
					var v67: array<int> := new int[2];
					v67[safeIndex(288, v67.Length)] := v48.f27 + f5;
					v67[safeIndex(288, v67.Length)] := fm55(|v50|, v47 + v47, f21, globalState);
					v67[safeIndex(288, v67.Length)] := v48.f27;
					var v68 := "r";
					var v69 := 'l';
					var v70: map<string, int> := map[v68[safeIndex(f15, |v68|) := v69] := |multiset(v50)|];
					v70 := v70;
					v49[safeIndex(772, v49.Length)] := v49[safeIndex(772, v49.Length)];
				}
				...
				match (v72) {
					case DC22(cf44) =>
						...
						v49[safeIndex(772, v49.Length)] := (f15 < f21) <==> (|v73| !in v73);
						var v74: map<map<int, bool>, bool> := map[map[f5 := v49[safeIndex(772, v49.Length)]] := f4];
						...
						var v80 := 'h';
						cf44 := ((multiset{fm32(v76, globalState)})[f21 := abs(|v46|)] + v77) > (if (if (f22 in v78) then v78[f22] else cf44) then v77 else multiset{|v47|, |v79.cf17[safeIndex(v48.f27, |v79.cf17|) := v80]|, v48.f27});
						r2 := safeDivisionInt(|(v73 + v73)|, f5 + |"cjcqlkmp"|);
						r1, r1 := f21, v48.f27;
					case DC23(cf45, cf46, cf47) =>
						...
						var v91: array<int> := new int[14] [v50[safeIndex(f5, |v50|)], safeDivisionInt(|[f4, cf47, cf45, f22, f4]|, cf46), v48.f27, v48.f27, v48.f27, safeDivisionInt(|[true]|, cf46), safeModuloInt(|v83|, fm26(globalState)), f15, f15, |fm65(v48.f27, cf45, v49[safeIndex(772, v49.Length)], v86, globalState)|, if (f21 in v87) then v87[f21] else v50[safeIndex(|v88|, |v50|)], safeDivisionInt(-v48.f27, v89.cf8), |(set v90 : set<int> | v90 in {v46} :: (v90))| * v48.f27, safeDivisionInt(-|map[v49[safeIndex(772, v49.Length)] := v48.f27]|, v48.f27)];
						...
						var v98 := DC0(f4, v48.f27, cf45, |[false, cf45]|, v49[safeIndex(772, v49.Length)]);
						var v101: array<map<D4, int>> := new map<D4, int>[28] [v94, v94, map[v92 := -692], v94, v95[safeIndex(v48.f27, |v95|)], v94, map v96 : D4 | v96 in v97 :: (v96) := (DC5(f4, f5, v85).cf16), v94 + v94, v94, v94, fm66(globalState) + map[v92 := v48.f27], v94[DC10(false, f16, v47) := fm32(v98, globalState)], v94 + v94, v94[v92 := f5] + (map v99 : D4 | v99 in fm67(globalState) :: (v99) := (v48.f27)), v94, v94, v94, v94, v94, v94, v94 + v94, v94, v94, v94, map[v92 := f5], (map v100 : D4 | v100 in [v92, v92, v92] :: (v100) := (DC19(-0x330).cf41)) + v94, map[DC10(v49[safeIndex(772, v49.Length)], f16, v47) := 338], v94];
						...
						v104 := v104[v91 := cf45 ==> v49[safeIndex(772, v49.Length)]];
						var v105: set<bool> := {f22};
						var v106: map<set<bool>, bool> := map[v105 := v49[safeIndex(772, v49.Length)]];
						v82[safeIndex(489, v82.Length)] := |v106[v105 := cf47]|;
						v91[safeIndex(781, v91.Length)] := v48.f27;
						var v107: map<bool, array<int>> := map[v49[safeIndex(772, v49.Length)] := v91];
						var v108: map<int, map<bool, array<int>>> := map[f5 := v107];
						v50, cf47, r1, v82[safeIndex(489, v82.Length)], v91[safeIndex(781, v91.Length)] := v50 + (v50 + (seq(abs(0x3e0), i5  => (v48.f27)))), (multiset{v48.f27} - v87) >= (multiset(seq(abs(0x38a), i6  => (cf46))) * v87), f5, |(if (f15 in v108) then v108[f15] else v107)|, v48.f27;
						var v109 := new C3(v84, v91[safeIndex(781, v91.Length)], false, f22, v91[safeIndex(781, v91.Length)]);
					case DC24(cf48) =>
						var v110 := "r";
						var v111: array<string> := new string[17] [v110, v110, v110[safeIndex(f5, |v110|) := 't'] + v110, v110, v110, v110, v110, if (v49[safeIndex(772, v49.Length)]) then v110 else v110, "rlnqfiwu", v110, "sxbvss" + v110, v110, v110, v110, v110, v110, v110];
						v111[safeIndex(688, v111.Length)] := "ykgekgkd";
						v111[safeIndex(688, v111.Length)] := seq(abs(0x19e), i7  => ('q'));
						var v113: map<int, int> := map[v48.f27 := v48.f27];
						var v114: multiset<map<int, bool>> := multiset{map v112 : int | v112 in DC39(v113).cf75 :: (safeModuloInt(v112, v48.f27)) := (f22)};
					...
					case DC21(cf43) =>
						...
						v118 := if (v49[safeIndex(772, v49.Length)]) then v118 else v118;
						var v119: multiset<int> := multiset{f5, f15, v48.f27};
						var v120: map<multiset<int>, bool> := map[v119 := v47[safeIndex(f5, |v47|) := !v49[safeIndex(772, v49.Length)]] == v47];
						var v121: array<array<map<bool, int>>> := new array<map<bool, int>>[6];
						var v122: array<map<bool, int>> := new map<bool, int>[28];
						v121[safeIndex(812, v121.Length)] := v122;
						var v123: seq<map<bool, bool>> := [map[false := f4]];
						var v124: map<int, map<bool, bool>> := map[f15 := v123[safeIndex(|map[f21 := v48.f27]|, |v123|)]];
						var v125 := DC19(|v124|);
						var v126: map<bool, bool> := map[!f4 := f22];
						var v127: multiset<bool> := multiset{if (v47[safeIndex(v48.f27, |v47|)] in v126) then v126[v47[safeIndex(v48.f27, |v47|)]] else f16, cf44, cf44, f4};
						v120, r3, r3, v121[safeIndex(812, v121.Length)], v125 := v120, safeModuloInt(|v47|, v48.f27), if (cf44) then f21 else safeDivisionInt(-f5, |v127|), v122, v125;
						var v128 := new C5();
						r0 := |(v47 + v47)| <= f5;
					case DC25(cf49) =>
						var v129 := "eibub";
						...
						r0, v49[safeIndex(772, v49.Length)], r0 := map[v49 := f15] != (v130 + v130), f16, v131 >= (v131 + v131);
						r0 := !(v131 >= (v131 - v131));
						var v132 := 'v';
						...
						var v138: seq<map<int, D4>> := [v137[safeIndex(f15, |v137|)]];
				...
				v49[safeIndex(772, v49.Length)] := !!true;
			case DC23(cf45, cf46, cf47) =>
				cf45 := f16;
				...
				var v145: map<bool, bool> := map[cf45 := v49[safeIndex(772, v49.Length)]];
			...
			case DC24(cf48) =>
				...
				var v149: array<int> := new int[29](i8 => safeModuloInt(i8, v148.f23));
				var v150: map<seq<int>, array<int>> := map[v50 := v149];
				var v151 := 'q';
				var v152: multiset<char> := multiset{v151, v151};
				var v153: map<bool, bool> := map[v49[safeIndex(772, v49.Length)] := f22];
				...
				match (v154) {
					case DC28(cf52, cf53, cf54, cf55, cf56) =>
						...
						cf56 := v156[safeIndex(v148.f23, |v156|)] > v155;
						v49 := v49;
						var v157 := DC10(false, f4, v47);
						var v158 := DC11(v157);
						v158 := DC11(v157);
						v149[safeIndex(717, v149.Length)] := cf54;
						var v159: map<int, int> := map[f21 := |v147|];
						var v160: map<map<int, int>, seq<bool>> := map[v159 := v47];
						v49[safeIndex(772, v49.Length)], v151, r2, v149[safeIndex(717, v149.Length)], v47 := v159 in v160, if (v148.f23 == cf53) then v151 else v151, -(fm26(globalState) + (if (f4) then f5 else v148.f23)), f5 + cf54, v47;
					case DC29(cf57, cf58, cf59, cf60) =>
						var v161: array<array<int>> := new array<int>[16] [v149, v149, v149, v149, v149, v149, v149, v149, v149, v149, v149, v149, if (v47[safeIndex(v48.f27, |v47|)]) then v149 else v149, v149, v149, v149];
						v161[safeIndex(413, v161.Length)] := v149;
						v161[safeIndex(413, v161.Length)] := v149;
						cf60 := (|v47| + |v50|) != cf48;
					...
					case DC30(cf61, cf62, cf63, cf64) =>
						...
						v163[safeIndex(125, v163.Length)] := [f22];
						var v164 := DC35();
						var v165: map<D13, int> := map[v164 := v48.f27];
						v163[safeIndex(125, v163.Length)], r1, f21, v49[safeIndex(772, v49.Length)], r0 := v47, fm55(v148.f23, v47, if (v164 in v165) then v165[v164] else cf48, globalState), 0x2e9, !(|v47| < v48.f27), f22;
						var v166: map<int, array<int>> := map[f21 := v149];
						var v167 := DC21(v166[v48.f27 := cf62]);
						var v168: array<multiset<bool>> := new multiset<bool>[13];
						v168[safeIndex(313, v168.Length)] := v146;
						var v169 := DC3(v47);
						cf61, v167, v168[safeIndex(313, v168.Length)], v49[safeIndex(772, v49.Length)], v169 := !fm27(v151, globalState), v167.(cf43 := v166), v146, f16, v169;
						f21 := -v148.f23;
						f21 := safeDivisionInt(f21 * f15, -cf63);
					case DC27(cf51) =>
						...
						var v173: T1 := new C3(v151, |cf51|, v148.f24, v49[safeIndex(772, v49.Length)], v48.f27);
						...
						var v178 := new C2(v49, v171, v147, v171 <= (v176[safeIndex(|v177|, |v176|)])[f21 := abs(fm49(v147, 0x3d0, v148.f24, f4, globalState))], v148.f24, -v148.f23 * 739);
						v151 := fm50(globalState);
						var v179: map<bool, int> := map[f16 := v148.f23];
						v149[safeIndex(613, v149.Length)] := if (v148.f24 in v179) then v179[v148.f24] else v48.f27;
						v149[safeIndex(613, v149.Length)] := f21 - |v50|;
						v151 := v151;
					case DC31(cf65) =>
						var v180 := new C5();
						var v181: set<char> := {v151, v151};
						r0 := v181 !! v181;
						var v182 := new C2(v49, fm68(globalState), v147[safeIndex(f21, |v147|) := v151], !false in multiset{f4}, false, -cf48 - v48.f27);
			...
			case DC21(cf43) =>
				...
				var v187 := "jlxt";
				v186[safeIndex(613, v186.Length)] := v187;
				var v188 := 'c';
				v186[safeIndex(613, v186.Length)] := ("quwjym" + v187)[safeIndex(0x334, |("quwjym" + v187)|) := v188] + (v187 + v187);
				var v189: seq<array<bool>> := [v49, v49, v49];
				var v190: map<string, array<bool>> := map[v186[safeIndex(613, v186.Length)] := v189[safeIndex(f5, |v189|)]];
				v190 := v190[v187 := v49];
				var v191: array<int> := new int[24](i11 => safeModuloInt(i11, f5));
				v191[safeIndex(643, v191.Length)] := safeModuloInt(v48.f27, f21);
				v191[safeIndex(643, v191.Length)] := -f21;
				var v192: map<int, bool> := map[|v186[safeIndex(613, v186.Length)]| := v49[safeIndex(772, v49.Length)]];
				v192 := v192[safeDivisionInt(f15, v48.f27) := f16];
			case DC25(cf49) =>
				var v193: map<bool, bool> := map[false := v49[safeIndex(772, v49.Length)]];
				match (DC26(v193)) {
					case DC26(cf50) =>
						var v194 := "phoqoik";
						var v195: map<int, int> := map[f5 := v48.f27];
						var v196 := DC39(v195);
						var v197: map<int, bool> := map[|v194| := v49[safeIndex(772, v49.Length)]];
						var v198 := new C4(f15, v49[safeIndex(772, v49.Length)], v194, v49[safeIndex(772, v49.Length)], f4, |map[v196 := if (f21 in v197) then v197[f21] else v49[safeIndex(772, v49.Length)]]|, f15, f16);
						var v199: multiset<bool> := multiset{v47[safeIndex(v48.f27, |v47|)]};
						...
						var v205: array<map<D6, bool>> := new map<D6, bool>[10] [fm69(globalState), v204, v204, v204 + v204, v204, fm69(globalState), map[v203 := v49[safeIndex(772, v49.Length)]], v204, v204 + v204, v204];
						var v206: seq<array<map<D6, bool>>> := [v205, v205];
						v205 := v206[safeIndex(v48.f27, |v206|)];
						var v207: array<seq<array<int>>> := new seq<array<int>>[29];
						var v208: array<int> := new int[18];
						v207[safeIndex(570, v207.Length)] := [v208];
						...
						var v215: map<string, map<bool, int>> := map[seq(abs(0xc3), i12  => ('a')) := map[v49[safeIndex(772, v49.Length)] := f21]];
						var v216 := DC14(f16, v47, v208, f21, -0x109);
						var v217: multiset<array<int>> := multiset{v216.cf33, v216.cf33, v208};
						v199, r1, v207[safeIndex(570, v207.Length)], v210, v213 := v199 - v214[safeIndex(v198.f23, |v214|)], 0x85, [v208, v208, v208], if ("nsxunsv" in v215) then v215["nsxunsv"] else (map[f4 := v198.f23])[v198.f24 := |v217|], fm70(globalState);
				}
				
				var v218 := "vwsqicxej";
				var v219 := DC0(v49[safeIndex(772, v49.Length)], f21, f4, |v218|, v49[safeIndex(772, v49.Length)]);
				var v220: array<int> := new int[15];
				var v221 := DC14(v49[safeIndex(772, v49.Length)], v47[safeIndex(fm32(v219, globalState), |v47|) := f4], v220, f15, v48.f27);
				v49[safeIndex(772, v49.Length)] := v221.cf31;
				r0 := v49[safeIndex(772, v49.Length)];
				var v222: multiset<bool> := multiset{f22, v49[safeIndex(772, v49.Length)], v49[safeIndex(772, v49.Length)], f4};
				v46 := {safeDivisionInt(if (f22 in v222) then v222[f22] else v48.f27, |{f15, f21, f5, f5, v50[safeIndex(f15, |v50|)]}|)};
		}
		
		v50 := v50;
		r0 := f5 > (f15 * f15);
		r1 := safeDivisionInt(0x1f8, -f5);
		r2 := f21;
		r3 := v48.f27;
	}
	method m12(globalState: GlobalState) returns (r0: array<bool>) {
			...
			decreases 100 - i1
		{
			...
			v2[safeIndex(916, v2.Length)] := false;
			v2[safeIndex(34, v2.Length)] := f16;
			var v5: multiset<int> := multiset{648, f21};
			var v6: set<int> := {|v5|, f21};
			f21, v4, v2[safeIndex(916, v2.Length)], v2[safeIndex(34, v2.Length)], v0 := |(v5 + multiset{f21})| + f21, [fm37(globalState) + fm52(f22, v6, f21, !v0, globalState), "ojj", v3, v3 + v3, v3 + "edqujvfl"], f4, f16, v0;
			v2[safeIndex(916, v2.Length)], v2[safeIndex(916, v2.Length)], v2[safeIndex(916, v2.Length)] := v2[safeIndex(916, v2.Length)], v2[safeIndex(916, v2.Length)], f16;
			var v7 := new C5();
		...
		var v17: set<int> := {|v16|};
		var v18: array<int> := new int[27] [f5, f5, f5, f21, f21, safeModuloInt(|v11|, |v12|), -safeDivisionInt(if (fm50(globalState) in v13) then v13[fm50(globalState)] else |map[|map[f4 := v0]| := v0]|, f21), f21, -f21, -0x108 * |v14|, f21, if (true in v15) then v15[true] else f5, 12, f5, f21, f15, |v17|, f15, f5 * f21, safeDivisionInt(f5, f5), f5, if (f4) then f21 else f5, 0x180, f21, f5, f15 + 195, f5];
		forall i2 | 0 <= i2 < v18.Length {
			v18[i2] := safeDivisionInt(i2, f5);
		}
...
class C7 extends T0, T1, T2 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			match (if (v2.cf23) then DC9(v1, f15, f16) else DC9(v1, f19, f16)) {
				case DC9(cf21, cf22, cf23) =>
					...
					v3[safeIndex(273, v3.Length)] := if (f16) then v0 else v4[safeIndex(f5, |v4|)];
					v3[safeIndex(273, v3.Length)] := v0;
				...
				case DC10(cf24, cf25, cf26) =>
					...
					v9[safeIndex(603, v9.Length)] := v11;
					...
					v9[safeIndex(603, v9.Length)] := v13[safeIndex(v15[safeIndex(p0, |v15|)], |v13|)];
				case DC8(cf20) =>
					var v16 := -0x3de;
					v16 := safeModuloInt(safeDivisionInt(fm23(f20, globalState), 0x3b4), |f17|);
					...
					v21[safeIndex(28, v21.Length)] := f15;
					cf20[safeIndex(467, cf20.Length)] := f20;
					var v22: seq<bool> := [f4];
					var v23: multiset<bool> := multiset{true};
					var v24: seq<int> := [f5];
					var v25: map<seq<int>, bool> := map[v24 := false];
					f18, f18, v21[safeIndex(28, v21.Length)], cf20[safeIndex(467, cf20.Length)] := fm0(globalState), v22 <= v22, v16, v23[f16 := abs(-v16)] in map[v23 := |v25|];
					var v26 := DC0(f18, v21[safeIndex(28, v21.Length)] + f15, f4, 787, f18);
					v26 := fm24(v24, f20, f16 <==> f18, DC0(false, v16, cf20[safeIndex(467, cf20.Length)], f15, f18), globalState);
				case DC11(cf27) =>
					f18 := false;
					...
					v28[safeIndex(82, v28.Length)] := (map v29 : D3 | v29 in v32 :: (v29) := ('s')) + v34;
					v28[safeIndex(82, v28.Length)] := v34;
					var v35: array<int> := new int[21](i2 => i2 - p0);
					var v36: seq<int> := [f15];
					var v37: seq<int> := [p0, v36[safeIndex(|f17|, |v36|)], |map[p0 := f18]|];
					v35[safeIndex(584, v35.Length)] := |v37|;
					v35[safeIndex(584, v35.Length)] := f5 - -f15;
			}
		...
		var v45: map<int, int> := map[p0 := v44[safeIndex(p0, |v44|)]];
			...
			decreases 100 - i3
		{
			...
			var v52: seq<string> := [seq(abs(-595), i4  => (v50))];
			f18 := (v52[safeIndex(f15, |v52|)] + fm37(globalState)) == f17;
			v44, f18, f18, f18 := v44, f4, f16, (f17 < f17) <==> f16;
			if (!!f16) {
				var v53 := new C2(v0, v42, f17[safeIndex(f19, |f17|) := v50], f16, f18 && f16, |"apdvmcjtv"|);
				...
				v0[safeIndex(997, v0.Length)] := f20;
				v0[safeIndex(997, v0.Length)] := !f20;
				v0[safeIndex(997, v0.Length)] := ((seq(abs(601), i5  => (v51.f25))) + f17) == f17;
				var v56: seq<bool> := [f4, true];
				var v57: seq<seq<bool>> := [v56];
				var v58: seq<seq<bool>> := [v56, v57[safeIndex(v40, |v57|)], [false]];
				var v59: map<seq<seq<bool>>, bool> := map[v57 := f18];
				v0[safeIndex(997, v0.Length)] := if (f18) then if (v58 in v59) then v59[v58] else f20 else f4;
				var v60: array<int> := new int[8](i6 => i6 + f5);
				v60[safeIndex(915, v60.Length)] := v49.f27;
				v60[safeIndex(915, v60.Length)] := v49.f27 + (-v49.f27 + v40);
				v60 := v60;
			}
...
class C8 {
	...
	method m10(globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: seq<int>) {
		...
		for i0 := if (!v0) then f14 else f14 to f14 {
			...
			v3[safeIndex(945, v3.Length)] := i0;
			v3[safeIndex(945, v3.Length)] := f14;
			v3[safeIndex(945, v3.Length)] := 0x381;
			var v4: array<map<int, int>> := new map<int, int>[13];
			var v5: array<bool> := new bool[2](i1 => v0 <==> v0);
			var v6: set<seq<bool>> := {[false, v0]};
			v5[safeIndex(232, v5.Length)] := v6 >= v6;
			var v7 := DC5(v0, i0, f13);
			v3[safeIndex(945, v3.Length)], v4, v5[safeIndex(232, v5.Length)] := DC1(i0, v0, v3[safeIndex(945, v3.Length)], i0).cf8, v4, v7.cf15;
			var v8: seq<bool> := [!v0];
			var v9 := DC0(v0, f14, v5[safeIndex(232, v5.Length)], f14, v5[safeIndex(232, v5.Length)]);
			var v10: map<bool, D0> := map[v0 := v9];
			var v11: seq<int> := [fm18(v5[safeIndex(232, v5.Length)], fm17(v8, v3[safeIndex(945, v3.Length)], v0, -0x3e3, globalState), v5[safeIndex(232, v5.Length)], globalState), f14, |v10|];
			var v12: map<int, map<bool, seq<bool>>> := map[-(v11[safeIndex(v3[safeIndex(945, v3.Length)], |v11|)] * v3[safeIndex(945, v3.Length)]) := fm19(globalState)];
			var v13: seq<map<bool, seq<bool>>> := [map[v0 := v8]];
			var v14: map<bool, seq<bool>> := map[false := v8];
			v12 := v12[v3[safeIndex(945, v3.Length)] := (v13[safeIndex(|f13|, |v13|)])[v0 := [v0]] + v14];
		}
		var v15 := 'f';
		var v16: multiset<bool> := multiset{v0, !v0};
		match (fm20(!v0, v15, 0x1ae, safeModuloInt(|v16|, -|f13|), globalState)) {
			case DC4(cf12, cf13, cf14) =>
				cf13 := cf13;
				var v17 := DC4(if (cf12) then v0 else v0, cf13, safeDivisionInt(cf14, cf13));
				match (v17) {
					case DC4(cf12, cf13, cf14) =>
						r2 := v0;
						var v18: seq<bool> := [cf12, cf12, !v0];
						var v19: array<seq<bool>> := new seq<bool>[10] [v18, v18, fm21(globalState), [v0, !!v0] + [v0, cf12, v0], v18, v18, v18[safeIndex(cf14, |v18|) := v0], v18, v18[safeIndex(cf13, |v18|) := v0], v18];
						v19[safeIndex(504, v19.Length)] := v18 + v18;
						v19[safeIndex(504, v19.Length)] := [cf12] + [v0, true];
						cf13 := cf14;
						var v20: map<bool, seq<bool>> := map[cf12 := v18[safeIndex(cf14, |v18|) := v0]];
						cf13 := |v20|;
					case DC5(cf15, cf16, cf17) =>
						...
						v26[safeIndex(990, v26.Length)] := v21;
						v26[safeIndex(990, v26.Length)] := v21;
					case DC3(cf11) =>
						...
						var v34: map<int, int> := map[|(multiset(cf11))[!cf12 := abs(|f13|)]| := fm25(cf13, DC30(v0, v33, cf13, v0).cf63, cf12, globalState)];
						...
						v38[safeIndex(406, v38.Length)] := v30;
						v38[safeIndex(406, v38.Length)] := v30;
						v34 := v34;
				}
				
				var v39: array<int> := new int[29](i3 => i3 - cf13);
				v39[safeIndex(84, v39.Length)] := cf13;
				v39[safeIndex(84, v39.Length)] := f14;
				...
				match (v40) {
					case DC41(cf77, cf78) =>
						...
						var v45 := DC29(v42[safeIndex(|v43|, |v42|)], v44, cf78, false);
						v41 := v41[v45.cf57 := f14];
						var v46: array<array<int>> := new array<int>[21];
						v46[safeIndex(948, v46.Length)] := v39;
						var v47 := DC41(cf77, v0);
						r1, v15, v46[safeIndex(948, v46.Length)] := v0, v47.cf77, v39;
						v39 := v46[safeIndex(948, v46.Length)];
					case DC42(cf79, cf80) =>
						var v48 := DC9(map[true := cf14], v39[safeIndex(84, v39.Length)], cf80);
						var v49: set<string> := {"spsfcpd", f13};
						v48 := fm71(f13 + f13, v39[safeIndex(84, v39.Length)], v49, 'r', globalState);
						var v50: set<int> := {v39[safeIndex(84, v39.Length)]};
						var v51 := new C1(cf14, false, cf80, |(v50 - v50)|);
						v15 := v15;
						var v52: array<bool> := new bool[1];
						var v53: seq<int> := [v39[safeIndex(84, v39.Length)]];
						var v54 := DC29(if (cf12 in v16) then v16[cf12] else cf13, v52, v0, f14 == v53[safeIndex(v39[safeIndex(84, v39.Length)], |v53|)]);
						v39[safeIndex(84, v39.Length)], v54, r1, cf13 := f14 - f14, v54, v0, f14;
					case DC40(cf76) =>
						var v55: array<seq<bool>> := new seq<bool>[23](i4 => [v0, cf12]);
						var v56: seq<bool> := [v0, v0, v0, cf12];
						v55[safeIndex(688, v55.Length)] := v56;
						var v58: map<bool, bool> := map[v0 := true];
						var v59: seq<int> := [v39[safeIndex(84, v39.Length)], |v58|];
						cf76, v39[safeIndex(84, v39.Length)], v55[safeIndex(688, v55.Length)] := (cf76 + (map v57 : int | (0x1e7 <= v57) && (v57 < 0x228) :: (v57 + cf13) := (v56[safeIndex(cf14, |v56|)])))[safeDivisionInt(v39[safeIndex(84, v39.Length)], cf14) := !([-0x1ec] == v59)], |(f13 + f13)|, v56 + [cf12, cf12];
						var v60: array<multiset<bool>> := new multiset<bool>[3](i5 => v16);
						v60[safeIndex(221, v60.Length)] := v16;
						var v61: array<seq<int>> := new seq<int>[25];
						v60[safeIndex(221, v60.Length)], v61 := (v16 * v16) + v16, v61;
						v0 := !cf12;
						v39 := v39;
					case DC43(cf81) =>
						f13 := f13;
			...
			case DC5(cf15, cf16, cf17) =>
				...
				var v67 := DC5(cf15, 93, seq(abs(-0x364), i8  => (v15)));
				var v68: array<bool> := new bool[18] [v0, cf15, (seq(abs(711), i6  => (v15))) < cf17, fm27(v15, globalState), v0, cf15, v0, true, v0, cf15, cf15, f13 < "f", v0, fm17(v63, cf16, v0, |v66[fm72(globalState) := v65]|, globalState), cf15, v67.cf15, cf15, cf15];
				v68[safeIndex(435, v68.Length)] := fm27(v15, globalState);
				var v69: set<bool> := {!v0};
				var v70: set<int> := {|v69|, f14};
				var v71: multiset<set<int>> := multiset{v70};
				var v72: seq<multiset<bool>> := [multiset{v0}];
				v68[safeIndex(435, v68.Length)] := fm17(v63, |v71|, cf15, |v72|, globalState);
				var v73: array<int> := new int[22](i9 => i9 + f14);
				v73[safeIndex(268, v73.Length)] := |v16|;
				var v74: array<string> := new string[10] [f13, cf17, fm28(f13, -cf16, 450, globalState), f13, cf17, seq(abs(0x255), i10  => ('c')), (seq(abs(0x3b9), i11  => ('v')))[safeIndex(fm55(f14, [cf15], -cf16, globalState), |(seq(abs(0x3b9), i11  => ('v')))|) := v15], cf17, f13, f13];
				v74[safeIndex(152, v74.Length)] := cf17;
				v73[safeIndex(268, v73.Length)], v74[safeIndex(152, v74.Length)], r1, v70 := cf16, f13, v68[safeIndex(435, v68.Length)] <==> !v0, {-|v63|};
				r0 := -0x2f6;
			case DC3(cf11) =>
				...
				v77[safeIndex(475, v77.Length)] := v0 !in v80[v0 := v79];
				v77[safeIndex(475, v77.Length)] := (if (v0) then f14 else f14) < f14;
				if (f14 != f14) {
					var v81 := new C1(if (v0) then f14 else f14, v77[safeIndex(475, v77.Length)], false, -f14);
					var v82: array<multiset<string>> := new multiset<string>[15];
					var v83: multiset<string> := multiset{"qymaacj", f13};
					v82[safeIndex(846, v82.Length)] := v83;
					var v84: seq<string> := [f13 + f13, f13, f13];
					v82[safeIndex(846, v82.Length)] := multiset(v84);
					var v85: map<int, int> := map[f14 := f14];
					var v86 := DC20({v85});
					var v87: set<map<int, int>> := {map[-f14 := f14]};
					v86 := v86.(cf42 := v87);
					v77[safeIndex(475, v77.Length)] := true;
					...
					r2 := v90 in (v91 + v91);
					var v92 := new C3(v15, f14, v77[safeIndex(475, v77.Length)], true, 238);
					var v93 := DC42(v77[safeIndex(475, v77.Length)], v0 <== v0);
					v93 := v93;
					var v94: multiset<char> := multiset{v92.f25};
					v77[safeIndex(475, v77.Length)] := multiset{v15} !! v94;
					var v95: set<char> := {v92.f25};
					v92 := new C3(v92.f25, f14, v77[safeIndex(475, v77.Length)], v95 >= v95, f14 - f14);
				}
		...
		if (v97 != v97) {
			...
			v0, r0, r0, r0 := if (v0) then !v0 else v0, f14, safeModuloInt(-(f14 * |v102|), f14), f14;
			var v103 := DC8(v96);
			v101[safeIndex(392, v101.Length)] := v103;
			v101[safeIndex(392, v101.Length)] := if (f14 > -|map[v0 := v0]|) then v103 else v103;
			r0 := f14;
		} else {
			v96[safeIndex(495, v96.Length)] := v0;
			var v104: seq<bool> := [|map[v0 := f14]| > -f14];
			var v105: array<int> := new int[4];
			v105[safeIndex(93, v105.Length)] := -f14;
			var v106: map<int, int> := map[|v104| := f14];
			var v107: map<int, bool> := map[0xb0 := v0];
			v96[safeIndex(495, v96.Length)], r0, r2, v104, v105[safeIndex(93, v105.Length)] := v0, |v106|, v0 || fm27(v15, globalState), [if (f14 in v107) then v107[f14] else v0], f14;
			var v108: multiset<int> := multiset{v105[safeIndex(93, v105.Length)], -f14};
			var v109: seq<int> := [v105[safeIndex(93, v105.Length)]];
			v105[safeIndex(93, v105.Length)] := |(v108[v105[safeIndex(93, v105.Length)] := abs(|v109|)])[-0x103 := abs(v105[safeIndex(93, v105.Length)])]|;
			v109 := v109 + (v109 + v109);
			v0 := fm27(v15, globalState);
			v105, v96[safeIndex(495, v96.Length)] := v105, v104[safeIndex(|fm53(globalState)|, |v104|)];
		}
		...
		if (match v112 {
			...
			var v115: set<map<int, int>> := {map[v114[safeIndex(f14, |v114|)] := f14], map[f14 := f14]};
			var v116: seq<set<map<int, int>>> := [{v111}, v115];
			var v117 := new C0(DC20(v116[safeIndex(fm49(f13, DC24(f14).cf48, !v0, false, globalState), |v116|)]), f14);
			...
			if (v0) {
				...
				v96[safeIndex(187, v96.Length)] := v126.fm0(globalState);
				var v132: seq<string> := [seq(abs(196), i14  => (v15))];
				f13, r3, v131, v16, v96[safeIndex(187, v96.Length)] := f13, seq(abs(-0x1), i13  => (-(|multiset{v117.f27}| + v117.f27))), v131, v16, (f13 + f13)[safeIndex(0x25a, |(f13 + f13)|) := v15] != v132[safeIndex(v117.f27, |v132|)];
				f13 := "lb";
				v96[safeIndex(187, v96.Length)] := (|f13[safeIndex(-0x34f, |f13|) := v15]| >= f14) ==> v96[safeIndex(187, v96.Length)];
			} else {
				var v133: set<int> := {|v113|, v117.f27};
				var v134: seq<bool> := [v0];
				var v135: seq<seq<bool>> := [v134, v134];
				var v136: map<int, bool> := map[f14 := v0];
				var v137: array<int> := new int[22] [0x72, v117.f27, v117.f27, v117.f27, safeModuloInt(v117.f27, v114[safeIndex(f14, |v114|)]), f14, |v133|, f14, safeDivisionInt(f14, |f13|), |v135[safeIndex(|map[v15 := if (f14 in v136) then v136[f14] else false]|, |v135|)]|, |(f13 + f13)|, v117.f27, if (v0) then v117.f27 else v117.f27, |(f13 + f13)|, v117.f27, f14, safeDivisionInt(v117.f27, v117.f27), -(f14 - v117.f27), f14, -v117.f27, f14, |f13|];
				v137 := v137;
				r1 := v0;
				var v138 := new C1(v117.f27, v0, v0, 564);
				r2 := v0;
				var v139: array<array<bool>> := new array<bool>[4];
				v139[safeIndex(503, v139.Length)] := v96;
				v139[safeIndex(503, v139.Length)] := v96;
			}
			...
			match (v140) {
				case DC13(cf29, cf30) =>
					...
					var v146 := DC47(v145 < v145, v0, safeDivisionInt(v143.f23, v143.f23), 0x3b6, safeDivisionInt(v143.f23, |fm47(true, globalState)|));
					var v147 := DC41(v15, v0);
					v146 := fm75(v147.cf78, globalState);
				case DC14(cf31, cf32, cf33, cf34, cf35) =>
					var v148: array<set<int>> := new set<int>[16](i15 => {-0x1a5});
					v148[safeIndex(706, v148.Length)] := fm76(v15, v15, v0, globalState);
					var v149: set<int> := {f14, -safeModuloInt(cf34, -642), f14};
					cf35, v148[safeIndex(706, v148.Length)] := -(cf35 + cf35), v149;
					cf34 := cf35;
					v15 := v15;
					cf35 := f14;
				case DC12(cf28) =>
					...
					var v155: array<map<int, map<int, int>>> := new map<int, map<int, int>>[16] [v150, v150, fm77(globalState), map v151 : int | (0xbc <= v151) && (v151 < 987) :: (v151 - f14) := (v111), map v152 : int | v152 in (([0x1f2, f14])[safeIndex(f14, |[0x1f2, f14]|) := f14])[safeIndex(f14, |([0x1f2, f14])[safeIndex(f14, |[0x1f2, f14]|) := f14]|) := f14] :: (safeDivisionInt(v152, 752)) := (DC39(v111).cf75), map v153 : int | (0x31c <= v153) && (v153 < 0x3da) :: (safeDivisionInt(v153, |[f14]|)) := (v111), v150[f14 := v111], map[f14 := v111], v150 + v150, v150[f14 := map[f14 := f14]], v150 + v150, v150, v150, v150, map[|v111| := v111] + (map v154 : int | (0x2eb <= v154) && (v154 < 0x370) :: (v154 + f14) := (v111)), v150[f14 := v111]];
					v155[safeIndex(432, v155.Length)] := v150 + v150;
					var v156: map<int, bool> := map[f14 := v0];
					v155[safeIndex(432, v155.Length)] := v150 + map[|v156| := v111];
					...
					v158[safeIndex(831, v158.Length)] := v157;
					var v159: array<string> := new string[19] [f13, seq(abs(0x3ca), i16  => (v15)), "u" + f13, seq(abs(0x3a2), i17  => (v15)), (seq(abs(0x281), i18  => (v15))) + f13, f13, f13, f13[safeIndex(f14, |f13|) := v15], (f13 + f13)[safeIndex(f14, |(f13 + f13)|) := v15], f13 + "bopjig", f13, f13, f13, f13, if (v0) then f13 else f13, f13 + "kaakuatca", f13, "mgrlndl", f13 + "rk"];
					var v160: seq<bool> := [v0];
					var v161: array<int> := new int[2];
					var v162 := DC14(v0, v160, v161, f14, f14);
					v159[safeIndex(159, v159.Length)] := fm52(!v0, {f14}, f14, v162.cf31, globalState);
					v15, v158[safeIndex(831, v158.Length)], v159[safeIndex(159, v159.Length)] := v15, v157, "xqabmlu";
			}
			...
			var v167: array<C1> := new C1[14] [v165, v165, v165, v165, v165, v165, v165, v165, v166[safeIndex(f14, |v166|)], v165, v165, v165, v165, v165];
			v167[safeIndex(564, v167.Length)] := v165;
			var v168: map<bool, string> := map[v0 := "bbybbory" + f13];
			var v169: set<int> := {f14};
			r0, v0, v167[safeIndex(564, v167.Length)], f13 := f14, v0, v165, if (v0 in v168) then v168[v0] else fm52(v0, v169, f14, v0, globalState);
			var v170 := DC46();
			var v171: map<bool, D17> := map[v165.fm0(globalState) := v170];
			v171 := v171[v0 := v170];
			var v172: array<char> := new char[2];
			v172[safeIndex(852, v172.Length)] := v15;
			v172[safeIndex(852, v172.Length)] := f13[safeIndex(safeDivisionInt(f14, f14), |f13|)];
		}
		...
		r2 := !match DC42(true, v0) {
			...
			case DC40(cf76) => v0
			case DC43(cf81) => v173[safeIndex(f14, |v173|)]
		};
...
class C9 {
	...
	method m8(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: seq<int>) {
			...
			decreases 100 - i0
		{
			...
			f12[safeIndex(392, f12.Length)] := p0;
			f12[safeIndex(392, f12.Length)] := p0;
			v4 := v4;
		}
		var v7 := 0xe0;
		...
		v8[safeIndex(557, v8.Length)] := f12;
		v8[safeIndex(557, v8.Length)] := new bool[12];
		var v9 := true;
		...
		forall i1 | 0 <= i1 < v12.Length {
			v12[i1] := safeModuloInt(i1, |(seq(abs(0x2f2), i2  => ('e')))|);
		}
		r0 := v15;
	}
	method m9(p0: array<string>, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: int) {
		...
		for i0 := v0 to v0 * v0 {
			...
			var v8: array<int> := new int[13] [i0, i0, i0, i0, |[i0]|, i0, v0, v0, i0, |v5[safeIndex(i0, |v5|)]|, |v7|, i0, v0];
			var v9 := DC30(v1, v8, i0, v1);
			var v10: set<int> := {v9.cf63, |v3|};
			v3 := fm52(v1, v10, |(v2 + v2)|, v1, globalState);
			var v11: set<seq<char>> := {v3 + (seq(abs(0x77), i1  => ('p')))};
			v8[safeIndex(458, v8.Length)] := 580;
			var v12 := 'e';
			...
			v11, v8[safeIndex(458, v8.Length)], r3, v12 := set v14 : seq<char> | v14 in v13 :: (v14), if (false && v1) then v0 else v0, |(set v17 : int | v17 in v16 :: (v17 - |([false] + [true])|))|, v12;
		}
		var v18 := true;
		...
		v27[safeIndex(273, v27.Length)] := if (v18) then v0 else v0;
		p0[safeIndex(163, p0.Length)] := v22;
		...
		r1, v27[safeIndex(273, v27.Length)], v0, p0[safeIndex(163, p0.Length)] := v20[safeIndex(v0, |v20|)], v0, if ((v31 + v31[v0 := v0]) in v30) then v30[v31 + v31[v0 := v0]] else v0, v22 + v22;
		v25 := v25[!v18 := v18];
		if (v18) {
			r3 := v26[safeIndex(|p0[safeIndex(163, p0.Length)]|, |v26|)];
			var v32 := 'f';
			var v33: map<D0, char> := map[DC0(v18, |(seq(abs(-0x222), i2  => (v27[safeIndex(273, v27.Length)])))|, v18, |v20|, v18) := v32];
			v27[safeIndex(273, v27.Length)] := |(v33 + v33)|;
			var v34: seq<string> := [p0[safeIndex(163, p0.Length)]];
			var v35: multiset<int> := multiset{v27[safeIndex(273, v27.Length)], v0, |v34|, v27[safeIndex(273, v27.Length)]};
			v18, v24, v27[safeIndex(273, v27.Length)], r3, v27[safeIndex(273, v27.Length)] := if (v18) then false else true, v24, if (v18) then |(v25 + v25)| else v27[safeIndex(273, v27.Length)], v26[safeIndex(-|(multiset{v27[safeIndex(273, v27.Length)], 125} * v35)|, |v26|)], v27[safeIndex(273, v27.Length)];
			v0 := (if (v18) then v27[safeIndex(273, v27.Length)] else |v31|) + |p0[safeIndex(163, p0.Length)]|;
			var v36 := DC15(v26 + v26);
			match (v36) {
				case DC16(cf37, cf38) =>
					var v37: set<bool> := {v18, v20[safeIndex(v0, |v20|)]};
					globalState.f0 := v37;
					r3 := (if (v18) then v0 else v27[safeIndex(273, v27.Length)]) + |v22|;
					r2 := !v18;
					...
					v38[safeIndex(80, v38.Length)] := v25 + v25;
					var v39: seq<map<bool, bool>> := [v25 + v25];
					v38[safeIndex(80, v38.Length)] := v39[safeIndex(|(v19[v18 := abs(v0)])[v18 := abs(v27[safeIndex(273, v27.Length)])]| - fm25(v0, cf38, v18, globalState), |v39|)];
				case DC15(cf36) =>
					r0 := v0;
					v19 := v19;
					var v40 := DC32(multiset([v32]));
					var v41: seq<D12> := [v40];
					v27[safeIndex(273, v27.Length)] := |(v41 + v41)|;
					v31 := v31 + v31;
				case DC17(cf39) =>
					...
					p0[safeIndex(163, p0.Length)], r0 := p0[safeIndex(163, p0.Length)], 654 + v27[safeIndex(273, v27.Length)];
			...
			if (!!v18) {
				r2 := v18;
				var v49 := new C1(v0, false, false, v27[safeIndex(273, v27.Length)]);
				var v51: multiset<multiset<bool>> := multiset{(fm47(v18, globalState))[!v18 := abs(v0)]};
				...
				v18 := !('q' !in p0[safeIndex(163, p0.Length)]);
			}
			
			r1 := v18 <==> (v18 ==> v18);
			var v57 := 'i';
			var v58 := new C3(v57, v27[safeIndex(273, v27.Length)], !v18, v18, v27[safeIndex(273, v27.Length)]);
			f12[safeIndex(736, f12.Length)] := v18;
			var v59: map<int, bool> := map[v0 := !v18];
			var v60: map<int, bool> := map[|v59| := v18];
			var v61: map<map<int, bool>, set<bool>> := map[v59 := fm48(fm49(p0[safeIndex(163, p0.Length)], v0, v20[safeIndex(v0, |v20|)], v18, globalState), globalState)];
			var v62: seq<map<map<int, bool>, set<bool>>> := [v61, if (v18) then v61 else v61];
			f12[safeIndex(736, f12.Length)], v61 := if (v18) then v18 else v18, v62[safeIndex(v26[safeIndex(v27[safeIndex(273, v27.Length)], |v26|)], |v62|)];
			r0 := safeModuloInt(-(-v0 - v0), fm55(v27[safeIndex(273, v27.Length)], v20, v27[safeIndex(273, v27.Length)], globalState));
		}
		
		var v63: map<int, bool> := map[v27[safeIndex(273, v27.Length)] := v18];
		if (if (v0 in v63) then v63[v0] else v18) {
			if (v18) {
				var v64: set<int> := {v27[safeIndex(273, v27.Length)]};
				var v65 := DC14(v18, [v20[safeIndex(|v64|, |v20|)], v18], v27, v0, 0x49);
				var v66 := DC30(v18, v65.cf33, --|p0[safeIndex(163, p0.Length)]|, v18);
				var v67: map<D11, int> := map[v66 := if (v18) then v0 else v0];
				v67 := v67[v66 := v0 * --v0];
				r2 := v18;
				var v68: array<array<int>> := new array<int>[22];
				v68[safeIndex(136, v68.Length)] := if (v18) then v27 else v27;
				v68[safeIndex(136, v68.Length)] := v27;
				var v69: array<array<bool>> := new array<bool>[14] [f12, f12, f12, f12, f12, if (v18) then f12 else f12, if (v20[safeIndex(0xb5, |v20|)]) then f12 else f12, f12, f12, f12, f12, f12, f12, f12];
				v69 := v69;
				var v70: T2 := new C7(676, v18, v18, v27[safeIndex(273, v27.Length)], |v22|, true, v22, false);
				var v71: seq<T2> := [v70];
				var v72 := DC49(v70);
				...
				var v76: array<T2> := new T2[23] [v70, v70, v71[safeIndex(v70.f5, |v71|)], v70, v70, v70, v72.cf89, v70, v70, v70, v70, v70, if (v70.f4) then v71[safeIndex(v70.f5, |v71|)] else v70, v70, v70, v70, if (v75 in v74) then v74[v75] else v70, v70, v70, v70, v70, v70, v72.cf89];
				v76 := new T2[12];
			} else {
				v18 := v20[safeIndex(v27[safeIndex(273, v27.Length)], |v20|)];
				v27[safeIndex(273, v27.Length)] := v27[safeIndex(273, v27.Length)];
				...
				v77[safeIndex(980, v77.Length)] := v80;
				v77[safeIndex(980, v77.Length)] := v80;
			...
			v82[safeIndex(595, v82.Length)] := v31;
			v82[safeIndex(595, v82.Length)] := map[fm18(false, v18, v18, globalState) * v27[safeIndex(273, v27.Length)] := safeModuloInt(v27[safeIndex(273, v27.Length)], v27[safeIndex(273, v27.Length)])];
			var v83 := 'h';
			...
			match (v87) {
				case DC9(cf21, cf22, cf23) =>
					...
					v88 := (map v89 : string | v89 in v92 :: (v89) := (map v93 : int | (-0x1ce <= v93) && (v93 < 0x183) :: (safeDivisionInt(v93, v27[safeIndex(273, v27.Length)])) := (|cf21|))) + (v88 + v88);
					v27[safeIndex(273, v27.Length)] := safeModuloInt(v27[safeIndex(273, v27.Length)], v0);
					v25 := v25[if (cf23) then cf23 else cf23 := false];
					var v94: seq<map<int, bool>> := [v63, map[cf22 := cf23]];
					v18 := v63 !in v94;
				case DC10(cf24, cf25, cf26) =>
					var v95 := new C1(v27[safeIndex(273, v27.Length)] * v0, cf25, cf25, v0);
					v27 := v27;
					r2 := !cf25 ==> !cf24;
				...
				case DC8(cf20) =>
					...
					var v99 := new C2(cf20, v98, v22, v18, v18, v27[safeIndex(273, v27.Length)]);
					v18, v18, r1 := !((v27[safeIndex(273, v27.Length)] * v0) > v0), v18, v18;
					var v100: array<array<int>> := new array<int>[20];
					v100 := v100;
					var v101: map<bool, int> := map[v18 := v0];
					var v102: seq<map<bool, int>> := [map[v18 := if (v18 in v19) then v19[v18] else v0], v101[v18 := 432], map[v18 := v27[safeIndex(273, v27.Length)]]];
					v102 := v102;
				case DC11(cf27) =>
					var v103: map<bool, int> := map[v18 && v18 := v0];
					v103 := (map[false := v27[safeIndex(273, v27.Length)]])[v18 := v0] + v103;
					var v104: map<int, map<int, int>> := map[0xea := (map[v27[safeIndex(273, v27.Length)] := v0])[v0 := v27[safeIndex(273, v27.Length)]]];
					var v105: array<map<bool, int>> := new map<bool, int>[18] [v103, v103, map[v18 := |v22|] + v103, v103, (map[v18 := v27[safeIndex(273, v27.Length)]])[false := v0], v103, fm57(if (v0 in v104) then v104[v0] else v31, v0, globalState) + v103, v103 + v103, if (v18) then v103 else v103, if (v18) then v103 else v103, v103, v103 + v103, v103 + v103, v103[v18 := v27[safeIndex(273, v27.Length)]], v103, if (v18) then v103 else v103, v103, v103];
					v105[safeIndex(674, v105.Length)] := v103;
					var v106: array<seq<bool>> := new seq<bool>[4](i3 => [v18, v18, v18]);
					v106[safeIndex(943, v106.Length)] := v20;
					v105[safeIndex(674, v105.Length)], v106[safeIndex(943, v106.Length)] := v103, [v18] + v20;
					v0 := |v22|;
					v0 := v27[safeIndex(273, v27.Length)];
			}
			
			if (false) {
				var v107 := DC47(v20 <= v20, |[v27[safeIndex(273, v27.Length)], -0x3ca]| == v0, 0x28d, |[p0[safeIndex(163, p0.Length)], p0[safeIndex(163, p0.Length)], v22]|, v0);
				v107 := v107;
				r3 := v0 * v27[safeIndex(273, v27.Length)];
				r3 := -(v27[safeIndex(273, v27.Length)] * v27[safeIndex(273, v27.Length)]) + v0;
				var v108: map<array<bool>, bool> := map[f12 := v18];
				var v109: map<bool, int> := map[v18 := v0];
				v63 := v63[|v108| := DC9(v109, v0, v18).cf23];
				var v110 := new C1(v27[safeIndex(273, v27.Length)], if (v18 in v25) then v25[v18] else v18, v18, v0);
			} else {
				var v111: map<int, multiset<int>> := map[|(v22 + v22)| := multiset{v27[safeIndex(273, v27.Length)]}];
				...
				var v115 := m8(v18, v18, safeDivisionInt(v0, v27[safeIndex(273, v27.Length)]), globalState);
				r0 := 432;
				var v116: seq<string> := [p0[safeIndex(163, p0.Length)], v22, "jbkdelo"];
				v0 := |fm28(v22, |v116|, v0, globalState)|;
				v87 := if (v18) then DC8(f12) else v87;
			}
			
			var v117: multiset<int> := multiset{v0};
			var v118 := new C2(f12, v117, p0[safeIndex(163, p0.Length)], v18, v18, v27[safeIndex(273, v27.Length)] * v0);
			var v119: seq<array<int>> := [v27, v27, v27, v27, v27];
			var v120: multiset<array<int>> := multiset{v27, v27, v27, v27, if (v18) then v119[safeIndex(v0, |v119|)] else v27};
			var v121: map<bool, multiset<array<int>>> := map[false := v120];
			v120 := (if (v18 in v121) then v121[v18] else multiset{v27}) * (v120 - v120);
			var v122: seq<string> := [p0[safeIndex(163, p0.Length)], v22];
			var v123: map<string, bool> := map["dn" := v18];
			var v124: map<string, map<string, bool>> := map[v122[safeIndex(v0, |v122|)] := v123];
			r2 := ((if (p0[safeIndex(163, p0.Length)] in v124) then v124[p0[safeIndex(163, p0.Length)]] else map v125 : string | v125 in v123 :: (v125) := (v18)) + v123) == v123;
		}
		...
		r2 := v126 !in v127;
		r3 := v27[safeIndex(273, v27.Length)];
	}
}
...
class C10 {
	...
	method m6(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState) {
		...
		if (p1) {
			...
			v3[safeIndex(538, v3.Length)] := v4[safeIndex(p0, |v4|)];
			v3[safeIndex(538, v3.Length)] := v4[safeIndex(p2, |v4|)];
			f11[safeIndex(180, f11.Length)] := p1;
			f11[safeIndex(180, f11.Length)] := p1;
			var v5 := -0x1e6;
			v5 := (v5 - p0) * p0;
		} else {
			...
			var v13 := new C6(safeDivisionInt(-|v9[safeIndex(|v10|, |v9|)]|, |v11|), p1, false, if (p3 in v12) then v12[p3] else f10, p3 - f10, false);
			f11[safeIndex(837, f11.Length)] := false;
			f11[safeIndex(578, f11.Length)] := !p1;
			...
			var v20: set<seq<int>> := {seq(abs(0x2ed), i1  => (|(set v16 : int | (27 <= v16) && (v16 < 0x1f2) :: (safeDivisionInt(v16, p0)))|)), [p0, f10, p2], fm44(p2, v17, v0, v13.f22, globalState), v19};
			v15[safeIndex(87, v15.Length)] := v20;
			var v21: map<bool, int> := map[v0 := -p3];
			v0, f11[safeIndex(837, f11.Length)], f11[safeIndex(578, f11.Length)], v15[safeIndex(87, v15.Length)], v0 := v12 !! v12[p3 := abs(v13.f21)], !v0, v18[safeIndex(|(map[p1 := |v19|] + v21)|, |v18|)], v20 + v20, v10 !in fm51(globalState);
			v0 := !v13.f22;
			var v22: seq<string> := [v10, v10, v10, v10];
			v13.f21, v12, v22 := f10, v12, seq(abs(184), i2  => (v10 + v10));
		}
		
		if (p1) {
			f11[safeIndex(19, f11.Length)] := v0;
			var v23 := "bpgtu";
			f11[safeIndex(19, f11.Length)] := |v23| != f10;
			var v24 := DC13(true, p1);
			var v25: map<int, D5> := map[p3 := v24];
			var v26: multiset<map<int, D5>> := multiset{v25};
			f11[safeIndex(19, f11.Length)], v26 := p1, v26;
			var v27: map<int, int> := map[p2 := p3];
			v23, v27 := v23 + (v23 + "s"), map[p3 := p3];
			f11[safeIndex(19, f11.Length)] := true;
			...
			v33 := v33[[p1, p1] + [v29[safeIndex(fm25(fm49("tosehbr", if (p2 in v34) then v34[p2] else |v31|, v0, v0, globalState), p2, p1, globalState), |v29|)]] := map v35 : seq<int> | v35 in (fm33(p3, p1, p3, v0, globalState))[v30 := abs(p2)] :: (v35) := (p3)];
			...
			v38 := if (multiset{true} >= v39) then if (if (v29 in v40) then v40[v29] else v0) then v38 else f11 else v41[safeIndex(p2, |v41|)];
			var v42 := new C5();
		}
		
		var v43 := m0(p1, safeModuloInt(p0, p3), globalState);
		var v44 := 0x150;
		...
		if (fm27(v49, globalState)) {
			...
			v50[safeIndex(810, v50.Length)] := v45 + v45;
			var v51 := DC15(v45);
			var v52: map<seq<int>, bool> := map[v45 := p1];
			v45, v44, v50[safeIndex(810, v50.Length)] := v45 + v51.cf36, if (if (v45 in v52) then v52[v45] else v43) then -p3 else |"db"|, v45;
			var v53: array<int> := new int[3] [v44, safeDivisionInt(p0, p3), p3];
			v53 := v53;
			var v54: map<bool, bool> := map[v0 := false];
			var v55: multiset<bool> := multiset{p1, p1};
			v54 := v54[p2 > p3 := |v55| == v50[safeIndex(810, v50.Length)][safeIndex(v44, |v50[safeIndex(810, v50.Length)]|)]];
			var v56 := "khygymr";
			...
			if (p3 >= p0) {
				var v62: seq<bool> := [v0];
				f11[safeIndex(901, f11.Length)] := multiset{|v62|} >= v47;
				var v63: set<int> := {0xeb, fm18(v0, v0, p1, globalState)};
				v44, f11[safeIndex(901, f11.Length)], v44, v43 := safeModuloInt(safeDivisionInt(p0, v45[safeIndex(p0, |v45|)]), p3), v63 >= v63, v44, v62[safeIndex(p2 - f10, |v62|)];
				v44 := ----(0x3a8 - p3);
				f11[safeIndex(901, f11.Length)] := !!f11[safeIndex(901, f11.Length)];
				f11[safeIndex(901, f11.Length)] := v0;
				var v64: map<int, multiset<int>> := map[p0 := v47];
				v64 := map v65 : int | v65 in v45 :: (v65 + f10) := (v47);
			} else {
				var v66 := new C9(f11);
				var v67: map<char, int> := map[v49 := v45[safeIndex(|v46|, |v45|)]];
				v67 := v67[v49 := p2];
				var v68: seq<bool> := [v43, p2 <= p2];
				v0 := v68[safeIndex(620, |v68|)];
				v0 := p1;
				v44 := p3;
			}
			...
			if (!v0) {
				...
				var v72: array<string> := new string[16] [v69 + v69, v69, v69, v69, v69, v69 + "mbyu", v69 + v69, v69, v69, v69, v69, seq(abs(0x389), i4  => (v49)), v69, ((v69 + v69)[safeIndex(if (f11 in v70) then v70[f11] else v44, |(v69 + v69)|) := v49])[safeIndex(|fm68(globalState)|, |(v69 + v69)[safeIndex(if (f11 in v70) then v70[f11] else v44, |(v69 + v69)|) := v49]|) := v49], v69 + v69, (v71.(cf15 := v0, cf16 := p3)).cf17];
				v72[safeIndex(40, v72.Length)] := "v";
				v72[safeIndex(40, v72.Length)] := v69 + (seq(abs(0x1f1), i5  => ('x')));
				var v73: map<int, int> := map[0x3a1 := fm26(globalState)];
				var v74: map<map<int, int>, char> := map[v73 := 'm'];
				v74 := v74[v73 := v49];
				v44 := v45[safeIndex(v44, |v45|)];
				var v75: seq<bool> := [v43];
				var v76 := new C2(f11, multiset(seq(abs(0x387), i6  => (v44))), v69, v0, v0, v45[safeIndex(|v75|, |v45|)]);
			} else {
				v0, v43, v44, v43, v44 := !v0, v0, safeDivisionInt(safeDivisionInt(p0, v44), |(fm45(p2, globalState))[safeIndex(-p2, |fm45(p2, globalState)|) := v0]|), p2 < f10, v44;
				v43, v0 := v0, v43;
				var v77 := "awmgq";
				...
				var v85: array<int> := new int[13] [|v79|, |(if (p1) then v80 else multiset{p1})|, safeDivisionInt(if (v43 in v81) then v81[v43] else v44, fm18(true, p1, v0, globalState)), v44 * p0, f10, p2, p3, p3, if (v44 in v82) then v82[v44] else -|DC34(v83).cf71|, |v84|, v44 * --v44, |(seq(abs(0x1b7), i7  => (v49)))|, p3];
				v85 := v85;
			...
			v88[safeIndex(373, v88.Length)] := fm55(|v89|, v90, p3, globalState);
			v88[safeIndex(373, v88.Length)] := f10;
			if (!(v43 || p1)) {
				v88[safeIndex(373, v88.Length)] := v88[safeIndex(373, v88.Length)] + p0;
				v89 := v89;
				...
				v88[safeIndex(373, v88.Length)], v43 := |v92| + -0x2a9, !(v89 <= v89[safeIndex(|v93|, |v89|) := v49]);
	...
	method m7(p0: bool, globalState: GlobalState) {
		...
		match (v2) {
			case DC28(cf52, cf53, cf54, cf55, cf56) =>
				...
				if (cf56) {
					...
					var v7 := DC24(cf53);
					var v8 := "ay";
					var v9: map<D9, bool> := map[v7 := (seq(abs(129), i0  => ('x'))) < v8];
					v9 := v9[v7 := cf56];
					...
					v10[safeIndex(673, v10.Length)] := v13;
					v10[safeIndex(673, v10.Length)] := v13;
					cf55 := false;
				} else {
					cf55 := cf56;
					...
					var v16 := DC0(cf52, cf53, true, f10, v5[safeIndex(cf54, |v5|)]);
			...
			case DC29(cf57, cf58, cf59, cf60) =>
				...
				if (if (cf60 in v21) then v21[cf60] else p0) {
					...
					v26[safeIndex(857, v26.Length)] := f11;
					v26[safeIndex(857, v26.Length)] := f11;
				} else {
					f11[safeIndex(563, f11.Length)] := p0;
					var v27 := "eyli";
					var v28: map<int, char> := map[f10 := 'i'];
					var v29: seq<bool> := [p0, cf60, !p0, |v27| > |v28|];
					f11[safeIndex(563, f11.Length)], v29, cf60, cf59 := (cf60 <==> cf59) ==> cf59, v29 + v29, cf59, cf59;
					v27 := v27;
					var v30: multiset<int> := multiset{cf57, |v29[safeIndex(f10, |v29|) := fm27('w', globalState)]|, 0x219, f10};
					var v31: map<seq<bool>, bool> := map[v29[safeIndex(|v30|, |v29|) := cf59] := !cf60 || f11[safeIndex(563, f11.Length)]];
					v31 := v31[(if (cf59) then v29 else v29)[safeIndex(|v30|, |(if (cf59) then v29 else v29)|) := cf59] := if (p0) then p0 else fm27('j', globalState)];
					var v32: map<array<bool>, bool> := map[cf58 := fm15(globalState)];
					cf57 := |v32|;
					cf59 := cf59;
				}
				
				cf58[safeIndex(954, cf58.Length)] := p0;
				var v33: multiset<bool> := multiset{p0};
				var v34: C6 := new C6(cf57, cf59, cf60, cf57, |v33|, cf59);
				var v35: map<int, C6> := map[cf57 := v34];
				cf58[safeIndex(954, cf58.Length)] := v35 == v35;
				v0[safeIndex(132, v0.Length)] := cf57;
				v0[safeIndex(132, v0.Length)] := |(seq(abs(-0x39), i1  => (-cf57)))| - (f10 * cf57);
				...
				var v43: array<int> := new int[7] [-0x39, v34.f21 * cf57, safeDivisionInt(-|v36|, if (cf60 in v38) then v38[cf60] else if (cf58[safeIndex(954, cf58.Length)] in v38) then v38[cf58[safeIndex(954, cf58.Length)]] else v0[safeIndex(132, v0.Length)]), fm26(globalState), v0[safeIndex(132, v0.Length)], |v39|, fm49(v40, |v42[safeIndex(v34.f21, |v42|)]|, cf59, fm15(globalState), globalState)];
				var v44: seq<array<int>> := [v43, v43];
				v43 := v44[safeIndex(0x2f2, |v44|)];
			case DC30(cf61, cf62, cf63, cf64) =>
				cf63 := cf63;
				cf63 := safeModuloInt(---f10, cf63) * -|fm60(cf61, p0, cf64, cf63, globalState)|;
				cf63 := (cf63 + cf63) + f10;
			...
			case DC27(cf51) =>
				...
				var v57 := DC53(f10, f10, v53[safeIndex(v54[safeIndex(f10, |v54|)], |v53|)] !in v55, v52);
				match (v57) {
					case DC53(cf94, cf95, cf96, cf97) =>
						var v58: seq<map<bool, int>> := [v47];
						f11[safeIndex(226, f11.Length)] := v47 !in v58;
						f11[safeIndex(226, f11.Length)] := !(if (cf96) then !p0 else p0);
						cf94 := safeModuloInt(cf94, f10);
						var v59 := "eygk";
						cf94 := safeModuloInt(|v59|, |v55|) - 0x278;
						cf94 := f10;
					case DC52(cf93) =>
						var v60: C5 := new C5();
						...
						v52, v63, v64, v64 := p0, f11, ((if (false in v47) then v47[false] else v64) * v64) * (if ("niodqnk" in v65) then v65["niodqnk"] else |v67|), safeDivisionInt(v62.f14, fm32(DC0(true, f10, v52, v62.f14, p0), globalState));
						v0[safeIndex(975, v0.Length)] := v62.f14 + -v64;
						v0[safeIndex(975, v0.Length)] := f10;
				}
			...
			case DC31(cf65) =>
				...
				var v75 := new C2(if (v69) then f11 else f11, v70, if (p0) then seq(abs(0x4f), i2  => ('s')) else "uod", v68 !in v1, v72[safeIndex(|v72|, |v72|) := v71] in v73, |(v74 + v74)|);
				v69 := v69;
		}
		...
		for i3 := f10 to f10 {
			...
			var v79 := 'o';
			v76 := (|("ten")[safeIndex(f10, |"ten"|) := v79]| + 0x113) + i3;
		...
		match (v88) {
			case DC45() =>
				...
				v91[safeIndex(306, v91.Length)] := f11;
				v90, v89, v91[safeIndex(306, v91.Length)], v89 := v90, f10, f11, f10;
				v91[safeIndex(306, v91.Length)][safeIndex(533, v91[safeIndex(306, v91.Length)].Length)] := !p0;
				v91[safeIndex(306, v91.Length)][safeIndex(533, v91[safeIndex(306, v91.Length)].Length)] := p0;
				v89 := v89;
			case DC46() =>
				v85 := ([!p0, p0] + v85) + v85;
				f11[safeIndex(694, f11.Length)] := true;
				f11[safeIndex(694, f11.Length)] := v83;
				var v92 := "kfb";
				var v93: map<int, string> := map[f10 := v92];
				v1 := v1[f10 + |v93| := p0];
				var v94 := 'm';
				v94 := if (p0 <==> f11[safeIndex(694, f11.Length)]) then if (f11[safeIndex(694, f11.Length)]) then v94 else v94 else v94;
			case DC47(cf83, cf84, cf85, cf86, cf87) =>
				...
				var v98: seq<D4> := [v97];
				var v99 := 's';
				f11[safeIndex(657, f11.Length)] := v85[safeIndex(cf86, |v85|)];
				var v100: set<bool> := {cf83};
				var v101: seq<int> := [cf87, 877, |v100|, cf85, f10];
				v98, v85, v99, v83, f11[safeIndex(657, f11.Length)] := v98 + v98, v85, v99, cf84, v101[safeIndex(cf86, |v101|)] > cf86;
				var v102 := "dhkwkgnpv";
				v102 := "aeqlgxow";
			case DC44(cf82) =>
				v83 := v83;
				...
				f11[safeIndex(319, f11.Length)] := p0;
				var v106 := 's';
				var v107: map<bool, bool> := map[v83 := fm27(v106, globalState)];
				f11[safeIndex(319, f11.Length)] := if (v83 in v107) then v107[v83] else v83 || v83;
			case DC48(cf88) =>
				if (!!!true) {
					var v108 := "eynw";
					v108 := v108;
					...
					v83 := !(safeDivisionInt(if (f10 in v109) then v109[f10] else f10, f10) == |v110|);
					f11[safeIndex(704, f11.Length)] := v83;
					f11[safeIndex(704, f11.Length)] := v83;
					var v111 := 0x37a;
					var v112: multiset<D11> := multiset{DC30(f11[safeIndex(704, f11.Length)], v0, |v108|, f11[safeIndex(704, f11.Length)]), v2, v2, v2, v2};
					var v113: multiset<int> := multiset{|v112|};
					v111 := safeModuloInt(if (v111 in v113) then v113[v111] else 0x2b4, v111);
					v111, f11[safeIndex(704, f11.Length)] := v111, f10 != f10;
				} else {
					var v114: array<seq<bool>> := new seq<bool>[7] [v85 + v85, [v83, p0, p0], v85 + v85, v85 + [false], v85[safeIndex(-117, |v85|) := p0] + [v83, p0], v85, v85 + v85[safeIndex(f10, |v85|) := v83]];
					var v115 := "vmdclrqoy";
					var v116: array<string> := new string[19] [v115, v115, v115, "jmnbc", v115, "fkynr" + v115, v115, v115 + v115, v115 + v115, v115, v115, v115, "hit", seq(abs(-0xdd), i6  => ('p')), v115, v115, v115 + v115, v115, fm37(globalState)];
					v116[safeIndex(432, v116.Length)] := v115;
					var v117: multiset<string> := multiset{v115, v115};
					var v118: seq<multiset<string>> := [v117[v115 := abs(f10)], multiset(seq(abs(213), i7  => (v115)))];
					var v119: C4 := new C4(f10, v83, v115, v117 < v118[safeIndex(f10, |v118|)], true, f10, f10, true);
					var v120: set<string> := {"ulavauekr"};
					v83, v114, v83, v116[safeIndex(432, v116.Length)], v119 := v119.f24, v114, v120 == v120, v115, v119;
					...
					f11[safeIndex(800, f11.Length)] := v85[safeIndex(v125, |v85|)];
					f11[safeIndex(800, f11.Length)] := v119.f24;
					v0[safeIndex(822, v0.Length)] := |v122|;
					v0[safeIndex(822, v0.Length)] := 0x21d;
				}
				
				var v127 := "t";
				var v128 := new C6(f10 * f10, v83, p0, |v127|, f10, v83);
				var v129: array<array<int>> := new array<int>[15];
				v129[safeIndex(578, v129.Length)] := v0;
				v129[safeIndex(578, v129.Length)] := v0;
				var v130 := 'c';
				v130 := v130;
		}
...
class C11 extends T0 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v7 := DC4(f4, |(seq(abs(-0xa4), i1  => (746)))|, f5);
			var v8: seq<D1> := [v7, v7];
			...
			var v16: array<int> := new int[28] [v2, |[f4]|, -0x32a, p0, p0, p0, safeModuloInt(v2, |v3|), v2, |(v6 + v6[v4 := v5])|, |v3|, -|v8|, safeModuloInt(p0, f5), --p0, p0 * |v9|, p0, -p0, v10.cf8, v2, if (f4) then if (f5 in v11) then v11[f5] else p0 else 0x2c4, 0x4d, v2, safeModuloInt(v2, |v14|), p0, if (fm0(globalState)) then v2 else 0x13d, safeModuloInt(|(seq(abs(0x39c), i2  => (v5)))|, p0), |v15|, |v3|, v2];
			v4[safeIndex(182, v4.Length)] := -|v13|;
			var v17: multiset<seq<int>> := multiset{v12};
			v2, v4[safeIndex(182, v4.Length)] := if ((|v17| * -f5) in v11) then v11[|v17| * -f5] else -f5, fm13(globalState);
			var v18 := true;
			v18 := v18;
			v2 := v4[safeIndex(182, v4.Length)];
		}
		var v19 := true;
		v19 := f4;
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			v27[safeIndex(848, v27.Length)] := fm79(v24, v21.f14, globalState);
			v19, v27[safeIndex(848, v27.Length)] := fm27(DC41(fm50(globalState), v19).cf77, globalState), v22;
			var v28 := new C5();
			var v29: array<bool> := new bool[5] [f4, f4, f4, true, v19];
			var v30: set<array<bool>> := {v29, v29, v29};
			var v31: seq<array<bool>> := [v29];
			var v32: seq<set<array<bool>>> := [{v29, v29}, v30, {v31[safeIndex(p0, |v31|)]}];
			var v33: array<set<array<bool>>> := new set<array<bool>>[11] [v30, {v29, v29, v29, v29, v29}, v30 * v30, v30, v30, v32[safeIndex(v21.f14, |v32|)], v30, v30, v30, {v29} * v30, v30];
			v33[safeIndex(719, v33.Length)] := v30;
			v33[safeIndex(719, v33.Length)] := if (f4) then v30 else v30 * v30;
		}
		match (fm80(seq(abs(0x190), i4  => ('g')), globalState)) {
			case DC45() =>
				...
				v39[safeIndex(672, v39.Length)] := p0;
				v39[safeIndex(672, v39.Length)] := (if (v19) then f5 else |map[v19 := fm27(v36, globalState)]|) - |([v36])[safeIndex(|fm48(f5, globalState)|, |[v36]|) := v36]|;
				if (v19) {
					var v40: array<map<bool, bool>> := new map<bool, bool>[29];
					var v41: map<array<map<bool, bool>>, string> := map[v40 := "skprdcjb"];
					v41 := v41[v40 := seq(abs(-769), i6  => (v36))];
					v39[safeIndex(672, v39.Length)] := v39[safeIndex(672, v39.Length)];
					var v42: map<int, bool> := map[|map[p0 := f5]| := f4];
					var v43 := new C6(f5, f4, p0 != p0, f5, -safeModuloInt(|v42|, f5), v19);
					v43.f21 := -|(v37 + v37)|;
					v37 := "tasjbdod" + "fredni";
				} else {
					var v44: seq<bool> := [v19];
					var v45: map<int, seq<bool>> := map[v39[safeIndex(672, v39.Length)] := v44];
					var v46: map<int, string> := map[|v45| := "vdlq"];
					v37, v39[safeIndex(672, v39.Length)] := "lmnhqaci" + (if (f5 in v46) then v46[f5] else v37), v39[safeIndex(672, v39.Length)];
					var v47: array<map<T0, bool>> := new map<T0, bool>[20];
					v47 := v47;
					var v48 := DC22(fm27(v36, globalState));
					v48, v39[safeIndex(672, v39.Length)] := v48, p0;
					var v49: map<char, seq<bool>> := map[v36 := v44];
					var v50: seq<int> := [p0];
					var v51: multiset<seq<bool>> := multiset{if (v36 in v49) then v49[v36] else v44, v44, v44[safeIndex(|v50|, |v44|) := f4], v44};
					var v52 := m0(f4, |(v51 - multiset{fm45(v39[safeIndex(672, v39.Length)], globalState)})|, globalState);
					v39[safeIndex(672, v39.Length)] := v39[safeIndex(672, v39.Length)];
				}
				
				var v53: map<int, int> := map[f5 := f5];
				v39[safeIndex(672, v39.Length)] := if (v39[safeIndex(672, v39.Length)] in v53) then v53[v39[safeIndex(672, v39.Length)]] else 0x1e1;
			case DC46() =>
				...
				v56[safeIndex(449, v56.Length)] := v59;
				v56[safeIndex(449, v56.Length)] := v59;
			case DC47(cf83, cf84, cf85, cf86, cf87) =>
				var v60 := 'l';
				v19 := !f4 && (v60 !in "adi");
			...
			case DC44(cf82) =>
				...
				v19 := v64 in v65;
				if (f4) {
					v64 := v65[safeIndex(safeModuloInt(f5, p0), |v65|)];
					...
					v67 := if (f4) then safeDivisionInt(|v68|, |v69|) else f5 + |v65|;
					v19 := v19;
				} else {
					var v70: array<bool> := new bool[19](i7 => f4);
					v70[safeIndex(934, v70.Length)] := v19;
					var v71: map<int, int> := map[p0 := fm18(v19, v19, v19, globalState)];
					var v72: multiset<bool> := multiset{f4, !v19};
					v70[safeIndex(934, v70.Length)] := fm12(v71, v19, v19, v65, globalState) >= (v72 - v72);
					var v73 := new C5();
					var v74 := -0x1c6;
					var v75: seq<int> := [|[f5, p0]|];
					v74 := safeModuloInt(f5, |v65| - -|v75|);
					v74 := -v74;
					v74 := 186;
				}
			...
			case DC48(cf88) =>
				...
				var v84: seq<map<char, int>> := [v80, v80[v79 := v83[safeIndex(f5, |v83|)]]];
				var v86: multiset<char> := multiset{'n'};
				var v87: array<map<char, int>> := new map<char, int>[27] [v80, v80, v80, v80, map[v79 := f5], map[v79 := f5], v80, v80, v80[v79 := p0], v80, v80, v80, map v81 : char | v81 in v82 :: (v81) := (|"nn"|), v80, v80, map[v79 := f5], map[v79 := p0], v84[safeIndex(f5, |v84|)], v80, map v85 : char | v85 in v86 :: (v85) := (|"uohwx"|), v80, v80, v80, v80, v80, v80, v80];
				var v88 := DC36(v87);
				v88 := v88;
				var v89 := "onc";
				v89 := seq(abs(0x8f), i9  => (v79));
				...
				v96[safeIndex(14, v96.Length)] := f4;
				var v97: set<array<bool>> := {v96};
				v96[safeIndex(14, v96.Length)] := v97 !! v97;
				v96[safeIndex(14, v96.Length)] := |{v19}| > --0x5;
		}
		...
		match (fm41({f5}, globalState)) {
			case DC20(cf42) =>
				...
				var v108: array<int> := new int[17] [p0, |v99|, |v100|, p0, |{|v101|}|, -0x25b, |v104|, -0x138, p0, p0, |v105|, |v98|, |v106[safeIndex(p0, |v106|)]|, |v107|, f5, f5, f5];
				...
				v111[safeIndex(948, v111.Length)] := v112 != v112;
				var v113 := 0x2dc;
				v111[safeIndex(468, v111.Length)] := f4;
				var v114: array<D10> := new D10[10](i10 => DC26(map[f4 := DC22(v19).cf44]));
				var v115: map<array<D10>, int> := map[v114 := f5];
				v111[safeIndex(948, v111.Length)], v113, v111[safeIndex(468, v111.Length)] := v114 !in v115, -safeModuloInt(safeModuloInt(v113, f5), |multiset{f4, f4}|), v19;
				var v116: array<char> := new char[19];
				v116 := v116;
				v113 := -v113;
				cf42, v111[safeIndex(948, v111.Length)], v113 := (cf42 + cf42) * cf42, !v19, if (v113 in v101) then v101[v113] else -0x315;
		}
		
		v19 := safeModuloInt(f5, p0) >= 0x31b;
	}
}
...
class C12 {
	...
	function fm6(p0: bool, p1: string, p2: set<char>, globalState: GlobalState): bool {
		!!((false || true) <==> ("hethahs" <= (seq(abs(0x87), i0  => ('f')))))
	}
	method m5(p0: map<int, bool>, p1: bool, p2: map<array<bool>, bool>, globalState: GlobalState) returns (r0: seq<string>, r1: bool, r2: bool, r3: array<seq<D1>>) {
		...
		if (v2) {
			...
			v3 := v3;
			var v4 := -0x270;
			v4 := f8 + safeModuloInt(f8, f8);
			var v5: seq<bool> := [v2];
			match (DC4(if (v5[safeIndex(f8, |v5|)]) then !v2 else p1, -v4, f8)) {
				case DC4(cf12, cf13, cf14) =>
					...
					var v10: set<seq<int>> := {seq(abs(-940), i0  => (cf14))};
					var v11: multiset<int> := multiset{--797};
					var v12: array<multiset<int>> := new multiset<int>[15] [multiset{|v8.cf18|}, multiset{f8, v4}, v9[safeIndex(v3[safeIndex(-|v0|, |v3|)], |v9|)], multiset{-0x135}, fm7(v2, v10, f8, f8, globalState), v11, fm7(cf12, v10, 440, cf13, globalState), multiset(v3), v11 + v11, if (p1) then v11 else v11, v11, v11, v11, v11, v11];
					v12[safeIndex(444, v12.Length)] := if (true) then v11 else v11[f8 := abs(v4)];
					var v13: set<bool> := {p1, v2, v2, !v2, true};
					var v14: map<set<bool>, multiset<int>> := map[if (p1) then v13 else v13 := v11];
					v12[safeIndex(444, v12.Length)] := if (v13 in v14) then v14[v13] else v9[safeIndex(f8, |v9|)];
					var v15 := DC4(false, |fm8(v2, v4, 0x388, globalState)|, v4);
					var v16: seq<seq<bool>> := [v5];
					var v17 := 'b';
					var v18: array<D1> := new D1[12] [v15, v15, v15, v15, v15, v15, v15, v15, v15, v15.(cf13 := v4), v15, fm9(p1, |v16[safeIndex(-f8, |v16|)]|, v4, v17, globalState)];
					v18[safeIndex(995, v18.Length)] := v15;
					v18[safeIndex(995, v18.Length)] := v15;
				...
				case DC5(cf15, cf16, cf17) =>
					...
					cf15 := v5[safeIndex(fm10(!p1, cf16, v4, globalState), |v5|)];
					cf16 := v4;
				case DC3(cf11) =>
					...
					v26[safeIndex(602, v26.Length)] := multiset([seq(abs(866), i2  => ('b')), v27, v27]) - v28;
					v26[safeIndex(602, v26.Length)] := if (v25) then v28 + v28 else v28 * v28;
					...
					var v33: map<bool, array<int>> := map[|v29| > |v27| := v32[safeIndex(475, |v32|)]];
					var v34 := 'a';
			...
			var v37: array<int> := new int[16](i4 => safeDivisionInt(i4, f8));
			...
			if (if (v2 && v2) then !p1 else |(if ((map v42 : char | v42 in fm11(globalState) :: (v42) := (p1)) in v41) then v41[map v42 : char | v42 in fm11(globalState) :: (v42) := (p1)] else v5)| >= fm10(p1, f8, v4, globalState)) {
				...
				v43[safeIndex(818, v43.Length)] := false;
				v43[safeIndex(818, v43.Length)] := p1;
				v4 := f8;
				var v44 := new C5();
				...
				var v54: array<map<int, char>> := new map<int, char>[16] [v48, map[0x255 := v39] + v48, v48, v48, v48, v48, v48 + fm81(true, |v49|, globalState), map v50 : int | v50 in p0 :: (v50 + v4) := (v39), v48 + (map v51 : int | (0x28f <= v51) && (v51 < 413) :: (v51 - |"vqrd"|) := (v39)), v48, v48 + v52[safeIndex(f8, |v52|)], v48, v48 + v48, (map v53 : int | v53 in multiset(v3) :: (v53 - f8) := (v39)) + v48, v48 + v48, v48];
				var v55: map<bool, int> := map[v2 := f8];
				var v56: map<bool, map<int, char>> := map[v2 := ((map[f8 := v39])[|v0| := v39])[|v55| := 'w']];
				v54[safeIndex(35, v54.Length)] := if (v2 in v56) then v56[v2] else v48;
				v4, v54[safeIndex(35, v54.Length)], v4 := -v4, v48, v4;
				...
				var v60: multiset<seq<bool>> := multiset{v5[safeIndex(fm32(v59, globalState), |v5|) := v2], v5};
				var v61: map<int, bool> := map[v4 := v4 > (if (v5 in v60) then v60[v5] else v4)];
				v61 := v61[-845 := p1];
				v54[safeIndex(35, v54.Length)] := v54[safeIndex(35, v54.Length)][v4 := 'g'];
			}
			...
			var v63 := "hjw";
			var v64: seq<int> := [f8];
			var v65: C6 := new C6(f8, v2, v62[safeIndex(f8, |v62|)], |v63|, |v64|, v2);
			var v66: seq<C6> := [v65, v65, v65, v65];
			var v67: array<C6> := new C6[21] [v65, v65, v65, v65, v65, v66[safeIndex(f8, |v66|)], v65, v65, v65, v65, v65, v65, v65, v65, if (true) then v65 else v65, if (p1) then v65 else v65, v65, v65, v65, v65, v65];
			v67[safeIndex(940, v67.Length)] := v65;
			v67[safeIndex(940, v67.Length)] := v65;
			v2 := v63 == v63;
			var v68 := 'g';
			...
			if (!(v76 !! {v73})) {
				...
				var v83: set<bool> := {v2};
				var v86: array<map<int, int>> := new map<int, int>[26] [v69, v69, map[-f8 := |v63|], v69, map[v73.f5 := 0x2f6], map[|v69| := v65.f21], v69 + map[v65.f21 := |multiset{-v65.f21}|], fm58(v65.f21, v65.f21, globalState), v69, map[0x286 := v65.f21], map v81 : int | v81 in p0 :: (v81 + f8) := (v65.f21), v69, map[fm26(globalState) := fm25(v65.f21, |v63|, p1, globalState)], v69, v69, map[315 := v65.f21], v69, v69[v65.f21 := v64[safeIndex(v65.f21, |v64|)]], v82[safeIndex(|v83|, |v82|)] + v69, v69, (map v84 : int | v84 in v64 :: (v84 - |v63|) := (|map[v73.f18 := v2]|)) + v69, v69, (map v85 : int | (0x75 <= v85) && (v85 < -0x2c6) :: (safeModuloInt(v85, |multiset(v62)|)) := (v65.f21)) + v69, v69, v69, fm58(v65.f21, f8, globalState)];
				v86[safeIndex(291, v86.Length)] := v69;
				v86[safeIndex(291, v86.Length)] := v69;
				...
				v73.f18 := v73.f18;
				v65.f21 := v65.f21;
				var v94: map<int, string> := map[fm26(globalState) := ("yfdspj")[safeIndex(f8, |"yfdspj"|) := fm50(globalState)]];
				v94 := v94[f8 := seq(abs(653), i7  => (v68))];
				var v95: array<string> := new seq<char>[22](i8 => seq(abs(-0xfc), i9  => (v68)));
		...
		if (v101) {
			...
			v102[safeIndex(84, v102.Length)] := p1 ==> p1;
			v102[safeIndex(84, v102.Length)] := !v2;
			...
			v104[safeIndex(595, v104.Length)] := v103;
			var v105 := DC46();
			var v106: set<bool> := {p1, v102[safeIndex(84, v102.Length)]};
			var v107 := "gqmm";
			...
			v110[safeIndex(623, v110.Length)] := v109;
			v104[safeIndex(595, v104.Length)], v105, v110[safeIndex(623, v110.Length)], v102 := v103, DC46(), (if (p1) then v109 else v109).(cf89 := v108), v102;
			v100 := v100;
			v100 := 272;
			var v111: multiset<int> := multiset{f8, v108.f5};
			var v113: multiset<int> := multiset{|(set v112 : int | v112 in v111 :: (safeModuloInt(v112, |{|"mwaufw"|, |(seq(abs(618), i11  => (|{885}|)))|}|)))|, f8};
			v101 := |v113| < v108.f5;
		} else {
			r1 := v2;
			var v114: array<int> := new int[6];
			v114[safeIndex(770, v114.Length)] := f8 * |fm37(globalState)|;
			v114[safeIndex(770, v114.Length)] := safeDivisionInt(f8, f8);
			var v115: array<bool> := new bool[25];
			var v116 := DC34([v115]);
			var v117 := DC34(v116.cf71);
			v117 := if (p1) then v116 else v117;
			var v118 := "jelanq";
			var v119: T0 := new C7(v100, v101, !v2, |[v2, false]|, |(seq(abs(0x5a), i12  => ('u')))|, v101, v118, p1);
		...
		r0 := (if (p1) then v123 else v123)[safeIndex(f8, |(if (p1) then v123 else v123)|) := v122];
		var v124 := DC0(p1, f8, v2, f8, v101);
		r1 := (v100 + v124.cf3) >= f8;
		var v125: seq<bool> := [-v100 == v100];
		r2 := v125[safeIndex(fm18(p1, true, p1, globalState), |v125|)];
		var v126: array<seq<D1>> := new seq<D1>[3](i14 => [DC5(!p1, v100, seq(abs(702), i15  => ('k')))] + [DC5(DC1(f8, v2, |map[true := 'c']|, -v100).cf6, f8, v122), DC5(p1, v100, v122), DC5(v101, f8, v122), DC5(v2, v100, "wapwl")]);
		r3 := v126;
	}
}
...
class C13 extends T0 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (!f4) {
				...
				v0 := v0;
				var v7: array<int> := new int[26](i1 => safeModuloInt(i1, f5));
				v7[safeIndex(409, v7.Length)] := p0 - p0;
				v7[safeIndex(409, v7.Length)] := fm3(globalState);
				var v8: multiset<bool> := multiset{f4};
				var v9: multiset<multiset<bool>> := multiset{v8, v8, fm4(globalState), v8, v8};
				f6 := v9 > (v9 - v9);
				v7[safeIndex(409, v7.Length)] := p0;
				var v10: array<char> := new char[27];
				v10[safeIndex(764, v10.Length)] := v0;
				v10[safeIndex(764, v10.Length)] := v0;
			}
			
			var v11: array<int> := new int[9];
			v11[safeIndex(229, v11.Length)] := p0;
			var v12: multiset<int> := multiset{|v1|};
			v11[safeIndex(229, v11.Length)] := |v12|;
			var v13: map<array<int>, int> := map[v11 := f5];
			f7 := v11 in v13;
			v11[safeIndex(229, v11.Length)] := (f5 * p0) + f5;
		}
		var v14: seq<int> := [p0];
		...
		if (!f7) {
			...
			var v19: map<bool, seq<string>> := map[!f4 := seq(abs(0x19), i2  => (v1))];
			v18 := v18[if (f4 in v19) then v19[f4] else v16 := v17];
			var v20 := -0x46;
			v0, v20 := if (f4) then v0 else v0, p0;
			var v21: map<int, bool> := map[safeModuloInt(|v1|, |v14|) := fm10(f4, -f5, 119, globalState) < p0];
			...
			if (f5 != fm49(v1, f5, f7, f4, globalState)) {
				...
				v27[safeIndex(610, v27.Length)] := f4 ==> f7;
				var v28: C2 := new C2(v27, (fm68(globalState))[p0 := abs(-|v1|)], v1, f7, f7, f5);
				...
				v27[safeIndex(610, v27.Length)], v29, f6, v31 := v32[safeIndex(p0 * --p0, |v32|)], (map[f7 := v28] + v35[safeIndex(-v30.f14, |v35|)]) + v29, (-p0 != p0) <== (if (f6) then f7 else f7), v31;
				v1 := "ayl";
				v33 := v33[f5 := v30.f14];
				...
				var v45: map<int, bool> := map[f5 := (fm82(v0, globalState))[safeIndex(p0, |fm82(v0, globalState)|) := map[v41 := f5]] <= v44];
				v45 := v45;
				var v46 := 0x1b0;
				var v47: map<bool, bool> := map[f7 := f6];
				v46 := |{|v47| != v46, f4, f5 !in (seq(abs(0x38), i3  => (f5)))}|;
				f6, v0 := f6, 'l';
				f6 := f4;
				v46 := -(p0 * f5);
			}
		...
		match (v51) {
			case DC33(cf67, cf68, cf69, cf70) =>
				...
				cf68 := cf68;
				cf70 := if (f7) then cf70 else safeDivisionInt(f5, p0);
			...
			case DC32(cf66) =>
				...
				var v61: seq<bool> := [f6];
				var v62: array<int> := new int[22] [p0, p0, v56.cf46, |map[p0 := f4]|, safeDivisionInt(f5, f5), 0x1b4, |v14|, |v57|, p0, |v49|, -(|v60| * -0x19d), p0, |([f4, !f4, f4, f6] + v61)|, |v1|, |{map[f5 := p0]}|, p0, f5, f5, |(v1 + v1)[safeIndex(|fm48(p0, globalState)|, |(v1 + v1)|) := v0]|, 192, f5, p0];
				v62[safeIndex(819, v62.Length)] := 0x235;
				var v63: array<bool> := new bool[25];
				var v64: map<array<bool>, int> := map[v63 := p0];
				v62[safeIndex(819, v62.Length)] := -fm18(!(f5 < |v64|), f7, f7, globalState);
				v62[safeIndex(819, v62.Length)] := |multiset{p0}|;
				var v65: multiset<array<int>> := multiset{v62};
				v62[safeIndex(819, v62.Length)] := |(map[v49 := -|v65|])[v49 + v49 := safeModuloInt(|"go"|, v62[safeIndex(819, v62.Length)])]|;
		}
	...
	method m4(p0: multiset<bool>, p1: array<bool>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: set<set<bool>>, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			p1[safeIndex(757, p1.Length)] := p3;
			var v2 := 'c';
			p1[safeIndex(757, p1.Length)], v0, f6, v2 := !f7, v0 * (if (false in p0) then p0[false] else v0), f7, v2;
			v0 := v0 - f5;
			p1[safeIndex(757, p1.Length)] := fm2(v0, v0, f5, globalState);
			...
			var v8: array<int> := new int[16] [v0, v0, |v5|, v0, f5, -v0, if (p1[safeIndex(757, p1.Length)] in p0) then p0[p1[safeIndex(757, p1.Length)]] else -964, v0, v0, f5, |v6|, f5, v0, |v6|, |v7|, |v6|];
		...
		if (p2) {
			...
			var v12 := "oyelcnck";
			var v13: C2 := new C2(p1, v11, v12, !!p3, f4, -safeModuloInt(v0, v0));
			v13 := v13;
			r1 := p2;
			v0 := 0x34e;
			...
			if ({v15, v15, v15} > v16) {
				...
				v1 := v1;
				var v21 := new C12(|v12|);
				v0 := -safeModuloInt(v0, fm25(v21.f8, -0x3e2, f4, globalState));
				var v22 := DC5(p2, f5, v12);
				var v23 := 'o';
				var v24: array<string> := new string[10] [v12, v12, (v22.(cf15 := p2)).cf17, v12, v12, "kkbywo", v12[safeIndex(v0, |v12|) := v23], v12[safeIndex(f5, |v12|) := v23], v12, v12];
			...
			if (f7) {
				...
				var v37: array<string> := new string[25] [v12, v12, v12, v12, v12, v12, (seq(abs(523), i1  => (v31)))[safeIndex(v0, |(seq(abs(523), i1  => (v31)))|) := v31], v12[safeIndex(f5, |v12|) := v31], v12, v12, v12, seq(abs(0x2e3), i2  => ('f')), "idfrp", v12, v12, v12, v12, "xupvukce", v12, v12, v12, v12, fm52(fm27(v31, globalState), v36, f5, p2, globalState), v12, v12];
				...
				var v47: array<char> := new char[27] [v31, v31, 'n', v31, v31, v31, v12[safeIndex((fm83(f6, globalState)).cf46, |v12|)], v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v31, v12[safeIndex(f5, |v12|)], v31, if (f5 in v46) then v46[f5] else v31, v31, v31, v31, v31];
				v47[safeIndex(595, v47.Length)] := v31;
				v47[safeIndex(595, v47.Length)] := v31;
			} else {
				v15[safeIndex(608, v15.Length)] := f5;
				v15[safeIndex(608, v15.Length)] := |"brfnjllm"|;
				var v48: multiset<string> := multiset{v12};
				var v49 := new C11(fm84(globalState), v48 <= v48, f5 + f5);
				var v50: seq<string> := [v12, v12, v12, seq(abs(-0x1b7), i3  => ('r')), v12];
				v12 := "guado" + v50[safeIndex(f5, |v50|)];
				v15[safeIndex(608, v15.Length)] := -safeDivisionInt(-819, v15[safeIndex(608, v15.Length)]);
				v15[safeIndex(608, v15.Length)] := safeDivisionInt(v15[safeIndex(608, v15.Length)] - v0, fm25(v0, |{f4}|, f6, globalState));
			}
			...
			v10.f12[safeIndex(762, v10.f12.Length)] := f7;
			var v54: seq<int> := [fm49(v52, fm25(f5, 0xbd, f6, globalState), p3, true, globalState), v0, 0x3a1];
			v0, f7, v53, v10.f12[safeIndex(762, v10.f12.Length)] := f5, v1[safeIndex(v54[safeIndex(f5, |v54|)], |v1|)], v53, p2;
			var v55: set<bool> := {false};
			var v56: seq<set<bool>> := [v55 + v55];
			v56, v10.f12[safeIndex(762, v10.f12.Length)] := (v56[safeIndex(|v52|, |v56|) := {false}] + v56) + v56, f7;
			v0 := f5;
			var v57 := v10.m8(p2, f4, v54[safeIndex(v0, |v54|)], globalState);
			v0 := v54[safeIndex(f5, |v54|)];
		}
		...
		var v67: seq<map<int, int>> := [v63, map[-397 := 955], v63, map v64 : int | v64 in v66[safeIndex(f5, |v66|)] :: (safeDivisionInt(v64, f5)) := (v0), v63];
		v63 := v67[safeIndex(|v1|, |v67|)];
		var v68 := "mydmsn";
		var v69 := 'y';
		var v70: C8 := new C8(v68, f5);
		var v71: multiset<C8> := multiset{v70, v70};
		var v72: map<bool, bool> := map[f7 := f6];
		var v73: array<int> := new int[20] [v0, f5, |v61|, |(multiset{|v63|})[f5 := abs(v0)]|, 672, |v61|, v0, v0, v0, 0xff, -|v71[v70 := abs(f5)]|, -824, |v68|, f5, -fm10(f4, |v72|, v70.f14, globalState), fm10(p2, v70.f14, f5, globalState), v0, v0, f5, v0];
...
class C14 {
	...
	method m1(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: int) {
		...
		for i0 := f3 to |v1| {
			...
			v2[safeIndex(911, v2.Length)] := p0;
			v2[safeIndex(911, v2.Length)] := true;
			var v3: set<int> := {808};
			var v4: set<int> := {|v3|, f3};
			r2 := |{v4}|;
			var v5: seq<string> := ["k", seq(abs(-0x203), i1  => (v0)), v1, seq(abs(-0x82), i2  => (v0))];
			var v6: map<int, int> := map[i0 := |v5|];
			v2[safeIndex(911, v2.Length)] := !((i0 + f3) > |v6|);
		}
		for i3 := safeDivisionInt(512, f3) to f3 {
			...
			r3 := fm32(v11, globalState) - v12[safeIndex(|v1[safeIndex(f3, |v1|) := v0]|, |v12|)];
		}
		for i4 := 191 to f3 {
			r0 := f2;
			...
			var v17: C2 := new C2(v16, v13, v1[safeIndex(f3, |v1|) := v0], f2, p0, f3);
			...
			match (v21) {
				case DC0(cf0, cf1, cf2, cf3, cf4) =>
					...
					var v25 := DC29(|v1|, v17.f28, cf0, v24[safeIndex(|v24|, |v24|)]);
					var v26: map<int, multiset<int>> := map[|v1| := v13];
					var v27: seq<array<bool>> := [v16];
					var v28 := DC34(v27);
					var v29: map<D13, multiset<int>> := map[v28 := multiset{|v1|}];
					var v30: array<multiset<int>> := new multiset<int>[24] [v13, fm7(true, v22, |(map[true := v23])[cf4 := v23]|, -i4, globalState), v17.f29, v17.f29, v17.f29, v17.f29, v17.f29, v17.f29 + v17.f29, v17.f29, multiset(seq(abs(0x77), i5  => (i4))), fm7(cf4, v22, -cf1, cf3, globalState), v17.f29 + multiset(v15), (multiset{cf3, i4, cf3})[|{cf4, v25.cf59}| := abs(f3)], (if (cf1 in v26) then v26[cf1] else multiset(v15)) + v17.f29[327 := abs(0x7f)], v17.f29, v13 + v17.f29, v17.f29 + fm7(cf0, v22, f3, cf1, globalState), if (v28 in v29) then v29[v28] else v17.f29[0x67 := abs(fm49(v1, i4, p0, f2, globalState))], v17.f29, v13, v17.f29, v17.f29, v17.f29, v17.f29];
					v30[safeIndex(41, v30.Length)] := multiset{cf1};
					var v31: seq<multiset<int>> := [v13];
					v30[safeIndex(41, v30.Length)], cf2 := v31[safeIndex(|[-0x1e0, 246, -cf1, cf1, -i4]|, |v31|)], v1 < v1;
				...
				case DC2(cf9, cf10) =>
					...
					var v40: set<int> := {i4};
					var v41 := DC27(v40);
					v39[safeIndex(942, v39.Length)] := v41;
					v39[safeIndex(942, v39.Length)] := v41;
					cf9 := v1 < (seq(abs(701), i6  => ('l')));
					var v42: array<int> := new int[4](i7 => safeDivisionInt(i7, |[!cf9, true, p0, true, p0]|));
					var v43: map<bool, bool> := map[cf10 := cf9];
					v42[safeIndex(501, v42.Length)] := safeDivisionInt(|v43|, -i4);
					v42[safeIndex(501, v42.Length)] := 0x39b;
					v42[safeIndex(501, v42.Length)] := v42[safeIndex(501, v42.Length)];
			}
			
			var v44: array<seq<bool>> := new seq<bool>[28];
			var v45: seq<bool> := [p0, f2];
			v44[safeIndex(794, v44.Length)] := (fm34(i4, f3, v45[safeIndex(i4, |v45|)], f3, globalState))[safeIndex(i4, |fm34(i4, f3, v45[safeIndex(i4, |v45|)], f3, globalState)|) := f2] + v45;
			v44[safeIndex(794, v44.Length)] := v45;
			r3 := f3;
		}
		for i8 := f3 to f3 {
			...
			if (p0) {
				...
				v54 := (v54 + v54) + [v52];
				v1 := (v1 + "vdios")[safeIndex(0xc0, |(v1 + "vdios")|) := v0];
				var v55: array<bool> := new bool[20];
				v55 := v55;
				var v56: seq<int> := [i8, 0x71];
				r0 := v56 == v56;
				r1, r2 := f2, safeDivisionInt(-fm10(f2, f3, f3, globalState), i8);
			}
		...
		match (if (f2) then v59 else if (f2) then v59 else v59) {
			case DC50(cf90, cf91) =>
				...
				if (v64.cf31) {
					...
					v1 := if (fm10(f2, f3, f3, globalState) in multiset{-0x249, f3, f3, f3}) then if (cf91) then (seq(abs(0x36d), i10  => (v0)))[safeIndex(|v71|, |(seq(abs(0x36d), i10  => (v0)))|) := v0] else v1 else if (v75[safeIndex(-f3, |v75|)] in v73) then v73[v75[safeIndex(-f3, |v75|)]] else v1;
					v60 := v60;
				...
				v85 := v85;
				var v86: multiset<string> := multiset{seq(abs(866), i12  => (v0))};
				if (!(|(v86 * v86)| >= f3)) {
					var v87: set<int> := {-f3};
					...
					var v91: seq<seq<bool>> := [[fm27(v0, globalState)], fm8(!cf91, f3, f3, globalState), v60, v90[safeIndex(f3, |v90|)], v60];
					cf91, v60 := v85.fm0(globalState), v90[safeIndex(f3, |v90|)] + v60;
					...
					var v96: multiset<seq<int>> := multiset{v83, v83, seq(abs(267), i13  => (|multiset{f3}|))};
			...
			case DC49(cf89) =>
				...
				v106 := v106[safeDivisionInt(|v107|, cf89.f5) := v105];
			...
			case DC51(cf92) =>
				...
				if (v110.cf4) {
					...
					var v116: C1 := new C1(safeDivisionInt(f3, |v1|), !(v111 <= v111), DC33(f2, f2, v0, f3).cf67 <== p0, safeModuloInt(fm25(|v112|, f3, false, globalState), v113.f21));
					v116 := new C1(f3, f2, p0 || !v113.f22, -(0x23a * v113.f21));
					var v117: map<bool, int> := map[p0 := f3];
					var v118: map<int, bool> := map[|v117| := v113.f22];
					var v119: map<map<int, bool>, string> := map[v118 + v118 := (seq(abs(-0x23), i14  => (v0))) + v1];
					v119 := v119[v118 := v1];
					var v120: array<int> := new int[3](i15 => safeDivisionInt(i15, v113.f21));
					var v121: set<bool> := {v113.f22};
					v120[safeIndex(890, v120.Length)] := |v121|;
					...
					v120, v120[safeIndex(890, v120.Length)] := if (v125 != v125) then v120 else v120, |(v126 + v127[safeIndex(v113.f21, |v127|)])|;
					var v128 := new C12(v120[safeIndex(890, v120.Length)]);
					v120[safeIndex(890, v120.Length)] := -0x1cf;
				} else {
					r1 := f3 == f3;
					var v129: array<bool> := new bool[28];
					v129[safeIndex(868, v129.Length)] := p0;
					...
					v129[safeIndex(868, v129.Length)] := v131 !! v131;
					var v132: seq<int> := [f3, 112, f3, f3];
					v1, v129[safeIndex(868, v129.Length)], r0, f2 := if (f2) then v1[safeIndex(f3, |v1|) := v0] else v1, f2, -v132[safeIndex(f3, |v132|)] == f3, f2;
					var v133: map<int, bool> := map[481 := f2];
					var v134: C7 := new C7(-safeModuloInt(f3, f3), v129[safeIndex(868, v129.Length)], fm27(v0, globalState), f3, 0x208 * |v133|, v129[safeIndex(868, v129.Length)], "segwmrc", v129[safeIndex(868, v129.Length)]);
					...
					var v139: seq<bool> := [v129[safeIndex(868, v129.Length)]];
					var v140: array<char> := new char[14];
					var v141: map<array<char>, int> := map[v140 := v134.f19];
					var v142: array<int> := new int[27] [|(v1[safeIndex(v134.f19, |v1|) := v0] + v1)|, v134.f19, f3, -0x2b8, f3, safeDivisionInt(-v134.f19, |v136|), f3, v134.f19, v134.f19, f3, v134.f19, if (-v134.f19 in v131) then v131[-v134.f19] else v134.f19, |v137|, f3, v134.f19, safeModuloInt(|v138|, v134.f19), v134.f19, f3, |v139| * f3, if (p0) then v134.f19 else |v1|, safeDivisionInt(|v141|, 438), |(v131 - v131)|, safeModuloInt(v134.f19, f3), v134.f19, 580, |v1|, -(v134.f19 - |v133|)];
					v142[safeIndex(506, v142.Length)] := f3;
					v142[safeIndex(506, v142.Length)] := |v132| + -v134.f19;
				}
				
				var v143: array<array<seq<bool>>> := new array<seq<bool>>[28];
				var v144: array<seq<bool>> := new seq<bool>[8](i16 => [p0]);
				v143[safeIndex(104, v143.Length)] := v144;
				var v145: map<bool, bool> := map[p0 := p0];
				var v146: map<map<bool, bool>, array<seq<bool>>> := map[v145 := v144];
				v143[safeIndex(104, v143.Length)] := if (v145 in v146) then v146[v145] else v144;
				var v147: array<seq<int>> := new seq<int>[14](i17 => [f3, f3, -0x23c]);
				var v148: seq<int> := [0xe, f3, f3];
				v147[safeIndex(717, v147.Length)] := v148;
				v147[safeIndex(717, v147.Length)] := v148;
				var v149: array<char> := new char[7](i18 => if (p0) then v0 else 'e');
				v149[safeIndex(441, v149.Length)] := v0;
				var v150: array<int> := new int[18];
				v150[safeIndex(607, v150.Length)] := f3;
				...
				v149[safeIndex(441, v149.Length)], r1, r1, v150[safeIndex(607, v150.Length)], v155 := v1[safeIndex(f3, |v1|)], (v156 * v156) != v156, f2, |v158|, DC30(p0, v150, f3, !p0).(cf62 := v150);
		}
			...
			decreases 100 - i19
		{
			...
			v161[safeIndex(973, v161.Length)] := !f2;
			v161[safeIndex(973, v161.Length)] := p0;
			var v162: C6 := new C6(-|(seq(abs(0x3a2), i21  => (v160)))|, p0, p0, f3, f3, p0);
			var v163: seq<C6> := [v162, v162];
			var v164: map<char, C6> := map[v0 := v162];
			var v165: array<C6> := new C6[16] [v162, v162, if (f2) then v162 else v163[safeIndex(v162.f21, |v163|)], v162, v162, if (v0 in v164) then v164[v0] else v163[safeIndex(|v1|, |v163|)], v162, v162, v162, v162, v162, v162, v162, v162, v162, v162];
			v165[safeIndex(679, v165.Length)] := v162;
			v165[safeIndex(679, v165.Length)] := if (!v161[safeIndex(973, v161.Length)]) then v162 else v162;
			if (p0) {
				var v166: seq<bool> := [fm27(v0, globalState)];
				var v167: array<int> := new int[3] [v162.f21, |v166[safeIndex(f3, |v166|) := v161[safeIndex(973, v161.Length)]]|, v162.f21];
				...
				var v178: map<bool, bool> := map[(map v174 : int | (0xd6 <= v174) && (v174 < 0x87) :: (safeDivisionInt(v174, v162.f21)) := (v162.f21)) in v177 := v162.f22];
				var v179: C3 := new C3(v0, f3, !p0, v161[safeIndex(973, v161.Length)], |v1|);
				var v180: set<C3> := {v179};
				var v181 := DC2(!v162.f22, v162.f22);
				v161[safeIndex(973, v161.Length)], v161[safeIndex(973, v161.Length)], r3, r3 := v162.fm0(globalState), if ((v180 !! v180) in v178) then v178[v180 !! v180] else v181.cf9, v162.f21, 0x28c;
				var v182 := DC29(v162.f21, v161, v162.f22, v161[safeIndex(973, v161.Length)]);
				v161[safeIndex(973, v161.Length)] := v182.cf60;
				var v183 := new C5();
				var v184: array<D12> := new D12[25](i22 => DC33(v161[safeIndex(973, v161.Length)], f2, v179.f25, |v1|));
				var v185 := DC61(v184);
				v1, v184 := seq(abs(0x17d), i23  => (DC41(v0, v162.f22).cf77)), if (false) then v185.cf108 else v184;
			} else {
				var v186 := new C13(false, v162.f22, v161[safeIndex(973, v161.Length)], v162.f21);
				v162.f21 := safeDivisionInt(v162.f21, v162.f21);
				var v187: array<int> := new int[10];
				v187 := v187;
				var v188: C10 := new C10(v162.f21 + f3, v161);
				v188 := v188;
				var v189: multiset<int> := multiset{v160[safeIndex(f3, |v160|)]};
				var v190: map<bool, string> := map[v186.f7 := v1];
				var v191: seq<array<bool>> := [v188.f11];
				var v192: seq<seq<bool>> := [[true, !f2]];
				var v193: set<int> := {|v192[safeIndex(v188.f10, |v192|)]|};
				var v194: multiset<int> := multiset{|[|v189|]|, -v162.f21, v162.f21, |v190[v186.fm2(v162.f21, |v191|, v160[safeIndex(f3, |v160|)], globalState) := fm52(fm27(v0, globalState), v193, v162.f21, v162.f22, globalState)]|, |v189|};
	...
	method m2(p0: int, globalState: GlobalState) {
		...
		v0 := match v3 {
			case DC22(cf44) => p0
			case DC23(cf45, cf46, cf47) => safeModuloInt(v0, |[cf47, !cf47, f2]|)
			case DC24(cf48) => f3
			...
			decreases 100 - i0
		{
			...
			var v11: map<bool, int> := map[v9 <= v10[safeIndex(p0, |v10|)] := safeDivisionInt(--v0, v8.f14)];
			var v12: multiset<int> := multiset{|v8.f13|, p0};
			v11 := v11[f2 := |v12|];
			var v13: array<string> := new string[18](i1 => DC5(f2, |v12|, v8.f13).cf17);
			v13[safeIndex(16, v13.Length)] := v8.f13;
			var v14: map<bool, string> := map[f2 := "rl"];
			var v15 := DC50(f2, f2);
			var v16: set<char> := {v1};
			v13[safeIndex(16, v13.Length)], v0, v0 := if (v15.cf90 in v14) then v14[v15.cf90] else v8.f13 + (seq(abs(0x2b), i2  => (v1))), fm18(f2, v16 > v16, f2, globalState), safeModuloInt(v8.f14, |(v5 + v5)|);
			var v17: array<bool> := new bool[18];
			v17[safeIndex(980, v17.Length)] := f2;
			v17[safeIndex(980, v17.Length)] := if (!v9[safeIndex(|v7|, |v9|)]) then f2 else !f2;
		}
		var v18: map<int, int> := map[-v0 := p0];
		for i3 := |(v18 + v18)| to safeModuloInt(v0, f3) {
			f2 := f2;
			...
			v21[safeIndex(88, v21.Length)] := v19;
			var v22: map<bool, int> := map[f2 := i3];
			f2, v0, v21[safeIndex(88, v21.Length)], v0, v0 := f2, (296 * f3) - i3, v19, f3 * (|v22| * v0), f3;
			f2 := true;
			var v23 := "ulshfw";
		...
		var v31 := DC63(v30);
		var v32: multiset<int> := multiset{f3, |(v31.(cf112 := multiset(seq(abs(0x2cc), i4  => (v25))))).cf112|};
		var v33: array<bool> := new bool[29] [!(f2 !in v2), f2, false, f2, !(v25 > v25), f2, f2, f2, v26 !! v26, f2 <==> f2, f2, f2, f2, true, !f2, v27[safeIndex(-0x147, |v27|)], v28 <= "b", f2, f2, true, fm27(v1, globalState) ==> f2, !f2, p0 >= |v29|, f2, f2, !f2, v32 > v32, fm27(v1, globalState), f2];
		v33 := v33;
			...
			decreases 100 - i5
		{
			...
			v34[safeIndex(457, v34.Length)] := f3;
			globalState.f0 := v26 + ({f2, f2} - v26);
			if (f2 <==> false) {
				v34[safeIndex(457, v34.Length)] := f3;
				var v35: map<bool, int> := map[f2 := v34[safeIndex(457, v34.Length)]];
				var v36 := DC6(v35);
				v36 := v36;
				var v37 := new C5();
				v33[safeIndex(602, v33.Length)] := f2 <==> f2;
				v33[safeIndex(910, v33.Length)] := f2;
				var v38: map<int, bool> := map[|v32| := f2];
				var v39 := DC40(v38);
				var v40: seq<seq<bool>> := [v27[safeIndex(v0, |v27|) := f2]];
				var v41: map<D16, seq<bool>> := map[v39 := v40[safeIndex(fm26(globalState), |v40|)]];
				var v42: seq<map<bool, bool>> := [map[f2 := f2], map[f2 := f2]];
				var v43: seq<map<D16, seq<bool>>> := [v41, v41];
				v33[safeIndex(602, v33.Length)], v4, v0, v33[safeIndex(910, v33.Length)], v41 := !f2, v42[safeIndex(v0, |v42|)] + map[f2 := f2], fm18(false, false, f2, globalState), fm27(if (f2) then v1 else v1, globalState), v43[safeIndex(safeModuloInt(p0, f3), |v43|)];
				var v44: set<map<int, int>> := {v18, map[p0 := fm3(globalState)]};
				var v45 := DC20(v44);
				var v46 := new C0(if (!v33[safeIndex(602, v33.Length)]) then v45 else v45, |"s"|);
			} else {
				...
				v51[safeIndex(149, v51.Length)] := v52;
				v51[safeIndex(149, v51.Length)] := v52;
				var v53 := DC58(v28, v34[safeIndex(457, v34.Length)], f2);
				v28 := v53.cf102;
			}
			
			var v54: C1 := new C1(safeModuloInt(v0, 0x2c7), !!f2, f2, 0x3e0);
			var v55: array<seq<int>> := new seq<int>[8](i6 => [p0]);
			v55[safeIndex(700, v55.Length)] := v29 + v29;
			var v56: seq<C1> := [v54];
			v54, v24, v34[safeIndex(457, v34.Length)], v55[safeIndex(700, v55.Length)] := v56[safeIndex(fm25(v0, v34[safeIndex(457, v34.Length)], f2, globalState), |v56|)], v24, (p0 - f3) + -0x52, (if (f2) then [f3] else v29) + v29;
		}
	}
}

function fm3(globalState: GlobalState): int {
	-safeDivisionInt(|"vqmj"|, |[true, false]|) - |(map[0x3e := |(seq(abs(0x1f8), i0  => (set v0 : int | v0 in {0x3bc} :: (v0 - 642))))|] + map[|[|{221, |map[multiset{'x'} := |{false, false}|]|}|]| := |{0x52, 475}|])|
}
...
function fm7(p0: bool, p1: set<seq<int>>, p2: int, p3: int, globalState: GlobalState): multiset<int> {
	if (!("tpli" < "wgmxlbhfv")) then multiset{0x39b, |map[--|(seq(abs(-0x3ce), i0  => ('d')))| := true]|} * multiset([586]) else multiset{|multiset{!false, true, false}|} * DC44(multiset{0x1f9, |(seq(abs(831), i1  => ('u')))|}).cf82
}
...
function fm9(p0: bool, p1: int, p2: int, p3: char, globalState: GlobalState): D1 {
	if (multiset{|{'t', 'd', 's', 'e'}|} !! multiset{0x338, |"uqde"|}) then DC4(true, |(seq(abs(-0x21d), i0  => ('b')))|, 0x164) else DC4(false, -745, 639)
}
function fm10(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
	|("vis" + "kiygyprti")| - safeDivisionInt(631, |multiset{false}|)
}
...
function fm21(globalState: GlobalState): seq<bool> {
	[|map[|"ruhfod"| := false]| >= |[true, false]|, !(|multiset{40}| >= --|[multiset{|"hpluriwse"|, 0x3d3, |map[false := DC47(true, !true, 0xea, 0x1d1, |"vafxu"|)]|}, multiset{|{0x33e, -0x319}|, |{!true}|, |(seq(abs(442), i0  => (|{|multiset{false, true}|, -0x37, |[0x8a]|, -|multiset(seq(abs(0x7e), i1  => ("vu")))|}|)))|, 0x1d0}, multiset{0x247}]|), 0x34b == 0x9f]
}
...
function fm33(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): multiset<seq<int>> {
	(multiset{DC15([-960, |[map[DC9(map[false := 74], -771, false).cf23 := true]]|, -0x2f4]).cf36, [0x6a]} + multiset{seq(abs(28), i0  => (|multiset{|multiset{0xe3}|, -37}|)), [|{'g'}|]}) * multiset{[-403]}
}
...
function fm38(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): set<map<int, int>> {
	{map[-0x107 := |"vfkjeqf"|], map[-0x2eb := 0x199]} - (set v1 : map<int, int> | v1 in (map v0 : map<int, int> | v0 in multiset([map[|map[false := true]| := -0x3c9], map[526 := 970], map[|{true, true, true}| := |[true]|]]) :: (v0) := (-|(seq(abs(-0x2fd), i0  => ('x')))|)) :: (v1))
}
...
function fm41(p0: set<int>, globalState: GlobalState): D8 {
	match DC17(DC16(map[map[false := |map[!!!false := --|[-0x383]|]|] := |(seq(abs(0x33e), i0  => ('i')))|], |"iuwsmcdhj"|)) {
		...
		case DC15(cf36) => DC20({map v3 : int | (0x24a <= v3) && (v3 < 527) :: (safeModuloInt(v3, |multiset{false, DC33(false, false, 'g', -|[true, false]|).cf67}|)) := (|map[!true := false]|)})
...
function fm44(p0: int, p1: D0, p2: bool, p3: bool, globalState: GlobalState): seq<int> {
	[safeDivisionInt(85, |map[0x269 := 0x18a]|)]
}
...
function fm51(globalState: GlobalState): multiset<string> {
	(multiset{"rvdhuqeu"} - multiset(seq(abs(-64), i0  => ("u")))) + (multiset{"ghctjwph"} + multiset{"iruuh"})
}
...
function fm53(globalState: GlobalState): seq<string> {
	((seq(abs(-0x18d), i0  => ("c"))) + (seq(abs(125), i1  => ("hwl")))) + (["j", DC5(DC1(0x23a, false, |multiset{|"creav"|}|, 0x3cc).cf6, |{'t'}|, "yfryxfmyj").cf17, seq(abs(389), i2  => ('t')), "sxyl", "eqwwuc"] + ["dvofd", "a", "iqhinq"])
}
...
function fm61(p0: int, p1: bool, globalState: GlobalState): D0 {
	DC0(true || false, 130, false, |([|[{false}, {!true}]|] + (seq(abs(0x1fe), i0  => (0x6b))))|, |{true, false}| != 0x8d)
}
...
function fm66(globalState: GlobalState): map<D4, int> {
	map v0 : D4 | v0 in (seq(abs(0xbc), i0  => (DC10(false, true, [!false])))) :: (v0) := (0x223)
}
...
function fm68(globalState: GlobalState): multiset<int> {
	(multiset{|[true]|, |{0x3c8}|} - multiset{|map[true := false]|, |map[|(map v0 : int | (0x2d9 <= v0) && (v0 < 0x7) :: (v0 - 896) := (-|{true}|))| := "u"]|}) * multiset((seq(abs(0x38a), i0  => (649))) + [0x7f, -0x32c])
}
function fm69(globalState: GlobalState): map<D6, bool> {
	(map[DC17(DC16(map[map[false := -149] := -0x187], |"dmclfmyx"|)) := !!true] + map[DC17(DC16(map[map[true := |"wqr"|] := -0x329], 0x319)) := !true]) + map[DC17(DC17(DC15([|(seq(abs(310), i0  => (0x25e)))|, |(seq(abs(0x191), i1  => (-0x1)))|]))) := true]
}
...
function fm74(p0: int, globalState: GlobalState): set<seq<int>> {
	set v0 : seq<int> | v0 in ((seq(abs(-0x3a3), i0  => (seq(abs(0x97), i1  => (0x284))))) + [[|(seq(abs(681), i2  => (|(seq(abs(-0x11), i3  => (-0x28b)))|)))|], seq(abs(-0xd7), i4  => (0x1c2)), [|"y"|]]) :: (v0)
}
...
function fm80(p0: string, globalState: GlobalState): D17 {
	match DC3([false, !true, true]) {
		case DC4(cf12, cf13, cf14) => DC48(DC47(true, cf12, cf14, cf13, |(seq(abs(623), i0  => ('j')))|))
...
function fm82(p0: char, globalState: GlobalState): seq<map<D9, int>> {
	([map v0 : D9 | v0 in [DC23(false, -|multiset([false])|, true)] :: (v0) := (|multiset{'n'}|)] + [map[DC23(DC1(DC24(|{'t'}|).cf48, false, 348, -0xa4).cf6, |['q']|, true) := |[false, false, !!false, true, true]|]]) + ((seq(abs(-0x6a), i0  => (map[DC23(false, |(map v1 : int | v1 in map[|[false]| := |multiset{false}|] :: (v1 + |(seq(abs(0x36a), i1  => ('c')))|) := (|multiset([--|"ppcgyghvm"|])|))|, false) := |[multiset{true}]|]))) + [map v2 : D9 | v2 in [DC23(false, -0x15b, false)] :: (v2) := (0x164)])
}
function fm83(p0: bool, globalState: GlobalState): D9 {
	DC23({seq(abs(888), i0  => ('o')), seq(abs(143), i1  => ('t'))} !! {"titbebql", seq(abs(0xff), i2  => ('d'))}, 702, true <== false)
}
function fm84(globalState: GlobalState): D1 {
	DC5(true, safeDivisionInt(--939, 0x2ce), "tcbk")
}
...
function fm86(p0: bool, p1: bool, p2: int, globalState: GlobalState): set<map<bool, int>> {
	match DC28(false, |"nixa"|, 0x2ff, false, !!false) {
		case DC28(cf52, cf53, cf54, cf55, cf56) => {map[cf56 := |[cf52, false, false, cf56]|]} + (set v0 : map<bool, int> | v0 in (seq(abs(0x395), i0  => (map[true := cf54]))) :: (v0))
		case DC29(cf57, cf58, cf59, cf60) => set v1 : map<bool, int> | v1 in (seq(abs(0x1f9), i1  => (map[cf59 := 0x3d8]))) :: (v1)
...
function fm87(p0: seq<int>, p1: bool, globalState: GlobalState): multiset<D11> {
	(multiset{DC27({0x284, |"qejo"|})} + multiset{DC27({|"m"|, |multiset{false, true, false, true}|}), DC27({|[|(seq(abs(514), i0  => ('n')))|, -0x198]|, |"e"|}), DC27({|[[|multiset(DC15([|[true]|, |map[false := false]|]).cf36)|]]|}), DC27(set v0 : int | v0 in map[0x1f6 := true] :: (safeDivisionInt(v0, 0x2c6)))}) * (if (true) then multiset{DC27(set v1 : int | (0xc1 <= v1) && (v1 < -0x15a) :: (safeModuloInt(v1, -|map[|{|multiset{|(set v2 : int | v2 in (seq(abs(963), i1  => (|['y']|))) :: (safeDivisionInt(v2, |map[554 := false]|)))|}|}| := "vvf"]|)))} else multiset{DC27({|map[false := false]|}), DC27({0x20a, 0x1a8})})
}
...
method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: bool) {
	var v0 := "kcfoxtf";
	var v1 := 'r';
	if (fm49(v0, p1, p0, p0, globalState) >= |v0[safeIndex(-p1, |v0|) := v1]|) {
		...
		var v13 := DC7(v12);
		v11[safeIndex(843, v11.Length)] := v13.cf19;
		v11[safeIndex(843, v11.Length)] := if (!v3.f24) then v12 else v12;
		...
		v15 := v15[safeIndex(p1, |v15|) := if (v3.f23 in v16) then v16[v3.f23] else v14];
	} else {
		...
		match (fm88(p0, if (v17 in v18) then v18[v17] else false, |v20|, globalState)) {
			case DC28(cf52, cf53, cf54, cf55, cf56) =>
				...
				v23[safeIndex(783, v23.Length)] := |v22.f13[safeIndex(|(seq(abs(80), i1  => (|[cf52]|)))|, |v22.f13|) := v1]|;
				var v24: seq<array<bool>> := [v19, v19];
				v23[safeIndex(783, v23.Length)] := |([v19, v19, v19] + v24)|;
				var v25 := DC47(cf52, p0, v23[safeIndex(783, v23.Length)], v23[safeIndex(783, v23.Length)], 0x201);
				...
				var v30: array<D17> := new D17[19] [v25, v25.(cf87 := DC4(cf55, -0x343, 0x31c).cf14), v25, DC47(cf55, cf52, v22.f14, cf53, cf53), v25, v25, v25, DC47(DC2(p0, false).cf10, cf52, |v28|, |v18|, v23[safeIndex(783, v23.Length)]), v25, v25, v25.(cf85 := v21.f3), v25, DC47(cf55, p0, v22.f14, |v29|, v23[safeIndex(783, v23.Length)]), v25, v25, v25, v25, fm75(cf56, globalState), fm75(v26.f4, globalState).(cf84 := !cf55)];
				var v31: T1 := new C3(v1, |v29|, v21.f2, cf52, cf54);
				var v32: map<int, T1> := map[v22.f14 := v31];
				var v33: seq<map<int, T1>> := [v32, v32, v32];
				var v34: map<map<int, T1>, bool> := map[v33[safeIndex(v26.f5, |v33|)] := cf56];
			...
			case DC29(cf57, cf58, cf59, cf60) =>
				...
				v36 := v36;
				var v37 := new C5();
				v19[safeIndex(40, v19.Length)] := cf60;
				var v38: array<multiset<string>> := new multiset<string>[9];
				var v39: multiset<string> := multiset{v0, v0, seq(abs(0x1f7), i2  => (v1)), seq(abs(0x246), i3  => (v1)), v0};
				v38[safeIndex(313, v38.Length)] := v39;
				var v40: seq<bool> := [if (true) then cf60 else p0];
				v19[safeIndex(40, v19.Length)], v38[safeIndex(313, v38.Length)] := v40[safeIndex(p1, |v40|)], v39;
			case DC30(cf61, cf62, cf63, cf64) =>
				...
				v41[safeIndex(518, v41.Length)] := v43;
				var v44 := DC5(cf64, cf63, v0);
				v41[safeIndex(518, v41.Length)] := new C11(v44, !cf64, v43.f5);
			...
			case DC27(cf51) =>
				...
				v19[safeIndex(643, v19.Length)] := v46 !in v47;
				v19[safeIndex(643, v19.Length)] := !((if (p0) then p1 else p1) == -461);
				r0 := !v19[safeIndex(643, v19.Length)] && p0;
				var v48 := 242;
				v48 := p1;
			case DC31(cf65) =>
				var v49 := 18;
		...
		var v54: array<seq<bool>> := new seq<bool>[21] [(v51.(cf11 := v50)).cf11, v50 + v50, v50, v50, v50, v50 + v50, v50 + v50, v50, v50 + v50[safeIndex(|v52|, |v50|) := p0], v50, v50, v50, v50, [fm27(v1, globalState), p0, false], [p0] + v51.cf11, v50, v50, v50, v50, fm45(p1, globalState), ([p0, p0])[safeIndex(p1, |[p0, p0]|) := v53.cf96] + v50];
		v54 := v54;
		var v55: array<map<int, bool>> := new map<int, bool>[11];
		v55 := v55;
		var v56: set<int> := {p1, p1};
		var v57: seq<set<int>> := [v56, v56];
		var v58: C13 := new C13(p0, (seq(abs(0x13c), i4  => ({|"kuf"|}))) < v57, v52 != v52, p1);
		var v59: seq<C13> := [v58];
		v58 := v59[safeIndex(--(p1 - -p1), |v59|)];
		var v60: array<int> := new int[28];
		v60[safeIndex(148, v60.Length)] := if (v58.f7) then p1 else p1;
		v60[safeIndex(148, v60.Length)] := fm18(v58.f6, v58.f7, true, globalState);
	}
	...
	if ((v61 >= v61) || (p1 < p1)) {
		...
		var v78: map<T1, seq<bool>> := map[v73 := v71[safeIndex(p1, |v71|) := v71[safeIndex(|v77|, |v71|)]]];
		v78 := v78;
	}
	
	var v79: multiset<int> := multiset{p1};
	var v80 := DC15((fm44(p1, DC0(p0, p1, p0, |[p1, |v79|]|, p0), p0, p0, globalState))[safeIndex(fm3(globalState), |fm44(p1, DC0(p0, p1, p0, |[p1, |v79|]|, p0), p0, p0, globalState)|) := |v0|]);
	...
	match (v80.(cf36 := v85)) {
		case DC16(cf37, cf38) =>
			...
			var v90: C2 := new C2(v89, v79[p1 := abs(cf38)], v0, p0, fm27(v1, globalState), cf38);
			var v91: map<C2, bool> := map[v90 := p0];
			var v92: C4 := new C4(931, p0, "se", p0, p0, p1, p1, p0);
			var v93: T2 := new C7(safeDivisionInt(cf38, |v91|), p0, true, |v84| + |map[v92 := !true]|, cf38, p0 <== p0, v0 + "xakt", v92.f24);
			v93 := v93;
			var v94 := DC58(v0, v93.f5, v93.f4);
			var v95: C6 := new C6(v93.f5, v94.cf104, p0, -0x18a, |(if (p0) then multiset{v93.f18} else v84)|, p0);
			var v96: seq<string> := [(seq(abs(0x135), i6  => (v93.f17[safeIndex(v95.f21, |v93.f17|)]))) + v93.f17];
			v95, v95.f21 := v95, |v96|;
		...
		case DC15(cf36) =>
			...
			v104, v1, v104, v0 := if (false) then |"n"| else v104 - |v0|, v1, -v104 + v104, if (p0) then v105[safeIndex(p1, |v105|)] else v0;
			r0 := p0;
		case DC17(cf39) =>
			var v106 := new C5();
			if (p0) {
				...
				v117[safeIndex(558, v117.Length)] := v116;
				var v118: map<int, set<bool>> := map[|v115| := v116];
				v117[safeIndex(558, v117.Length)] := fm48(v107, globalState) - (v116 + (if (v107 in v118) then v118[v107] else v116));
				var v119 := new C5();
				v111.f18 := v111.f4;
			} else {
				var v120: array<string> := new string[7] [v0, v0, v0 + v0, v0, seq(abs(0x75), i8  => (v1)), v0 + v0, seq(abs(924), i9  => (v0[safeIndex(p1, |v0|)]))];
				v120 := v120;
	...
	v132[safeIndex(524, v132.Length)] := -p1;
	v132[safeIndex(524, v132.Length)] := |{if (!p0) then v132 else v132, v132, v132}|;
	var v133 := new C8(v0, p1);
	v132[safeIndex(524, v132.Length)] := v132[safeIndex(524, v132.Length)];
	r0 := v132[safeIndex(524, v132.Length)] != v132[safeIndex(524, v132.Length)];
}
method Main() {
	var v0 := false;
	...
	match (DC0(v0, v2, v0, v2, v0).(cf0 := v0 <== v0)) {
		case DC0(cf0, cf1, cf2, cf3, cf4) =>
			...
			if (v3.cf11 < v4[safeIndex(v2, |v4|) := cf0]) {
				cf3 := cf1;
				cf0 := v1 >= v1;
				v4 := v4;
				var v5 := "awdpjwlt";
				var v6 := m0(v5 <= (seq(abs(-482), i0  => ('i'))), cf3, globalState);
				var v7: array<int> := new int[23];
				var v8: seq<int> := [cf1, cf3];
				v7[safeIndex(26, v7.Length)] := -|(v8 + v8)|;
				var v9: multiset<int> := multiset{-v2, cf1};
				var v10 := DC0(cf4, cf1, cf0, if (v2 in v9) then v9[v2] else 0x36f, cf0);
				v7[safeIndex(26, v7.Length)] := v10.cf3;
			} else {
				var v11: array<bool> := new bool[20] [!v0, cf2, cf2, cf2, false, cf2, cf4, cf0, cf2, cf2, true, cf0, cf0, cf2, cf2, cf2, cf2, cf2, cf0, !cf4];
				var v12 := new C9(v11);
				var v13 := "o";
				var v14: seq<int> := [|v13|];
				cf4 := v14[safeIndex(|(seq(abs(0x39a), i1  => (v2)))|, |v14|)] < v2;
				var v15: array<int> := new int[15];
				v15[safeIndex(743, v15.Length)] := v2;
				v15[safeIndex(743, v15.Length)] := safeModuloInt(cf1 * |v13|, cf3);
				cf0 := v4[safeIndex(v15[safeIndex(743, v15.Length)], |v4|)];
				cf3 := cf3;
			}
		...
		case DC1(cf5, cf6, cf7, cf8) =>
			...
			var v19 := "mb";
			var v20 := 'q';
			match (DC47(cf6, v18[safeIndex(fm25(cf7, cf5, cf6, globalState), |v18|)], cf8, |v19[safeIndex(|[cf7, |(seq(abs(502), i2  => ('o')))|]|, |v19|) := v20]|, cf5).(cf85 := cf8)) {
				case DC45() =>
					...
					v23[safeIndex(992, v23.Length)] := cf6;
					var v24: set<char> := {v20, v20};
					v23[safeIndex(992, v23.Length)] := v24 >= (v24 + v24);
			...
			v57 := v57;
			var v58: array<int> := new int[19](i8 => safeDivisionInt(i8, cf5));
		...
		case DC2(cf9, cf10) =>
			...
			match (v71) {
				case DC9(cf21, cf22, cf23) =>
					...
					v74 := v74[(seq(abs(0xc9), i9  => (|multiset{!v73.f6, cf10}|))) + (seq(abs(0x10), i10  => (-cf22))) := v73];
					cf22 := |v72|;
				...
				case DC10(cf24, cf25, cf26) =>
					...
					var v90: set<T2> := {v89};
					v2, v70, v0, v2 := |(v81 + v81)| * safeModuloInt(v82.f19, |v90|), v70, cf24 && (cf24 || v88.fm0(globalState)), 0x115;
				case DC8(cf20) =>
					var v91: seq<bool> := [cf9];
					var v92 := 'j';
					var v93: map<D11, int> := map[DC29(v2, cf20, cf9, cf10) := fm18(v91[safeIndex(v2, |v91|)], cf10, fm27(v92, globalState), globalState)];
					var v94 := DC29(v2, cf20, cf10, v0);
					var v95 := "mbhvii";
					v93 := v93[v94 := safeDivisionInt(|v95|, |map[v63 := v2]|)];
					var v96 := m0(v95 < v95, v2, globalState);
					v2 := 0xcf;
					cf20[safeIndex(882, cf20.Length)] := v96;
					cf20[safeIndex(882, cf20.Length)] := v0;
				case DC11(cf27) =>
					var v97 := new C10(safeDivisionInt(|DC52(v1).cf93|, v2), v70);
					...
					v98[safeIndex(151, v98.Length)] := v103;
					v98[safeIndex(151, v98.Length)] := v103;
			...
			v2 := safeDivisionInt(v110[safeIndex(v2, |v110|)], v2);
			v2 := v2;
	}
	...
	var v113 := 't';
	v112[safeIndex(306, v112.Length)] := v113;
	v112[safeIndex(306, v112.Length)] := 'e';
	...
	match (v115) {
		case DC9(cf21, cf22, cf23) =>
			...
			v116[safeIndex(590, v116.Length)] := v117;
			v116[safeIndex(590, v116.Length)] := map[-cf22 := cf22];
		...
		case DC10(cf24, cf25, cf26) =>
			...
			v2 := v121.cf63;
			v120[safeIndex(674, v120.Length)] := v2;
			var v122: seq<seq<bool>> := [cf26];
			v120[safeIndex(674, v120.Length)] := fm25(safeModuloInt(v2, v2), v2, v122 < [cf26], globalState);
			var v123 := "faar";
			var v124: map<int, int> := map[|v123| := v120[safeIndex(674, v120.Length)]];
			var v125: set<map<int, int>> := {v124};
			var v126 := DC20(v125);
			var v127 := new C0(v126, v2);
			v2 := v120[safeIndex(674, v120.Length)];
		case DC8(cf20) =>
			v2 := v2;
			...
			v128[safeIndex(51, v128.Length)] := v129;
			v128[safeIndex(51, v128.Length)] := v129;
			var v135: C14 := new C14(v0, v2);
			var v136: map<array<int>, C14> := map[v131 := v135];
			var v137 := "an";
			v2 := safeDivisionInt(|v136|, |v137| * v2);
			var v138: map<bool, bool> := map[v111 := v111];
			v111, v135.f2 := if (v111) then fm27(fm50(globalState), globalState) else v2 < v135.f3, if (fm27(v112[safeIndex(306, v112.Length)], globalState)) then v135.f2 else if (v111 in v138) then v138[v111] else v111;
		case DC11(cf27) =>
			...
			v145 := v145[safeDivisionInt(v2, v2) := v144];
	...
	if (v111) {
		...
		v2 := safeDivisionInt(v2 - |v156|, v155.f5);
		v153.f18 := false;
		...
		v162 := v162[seq(abs(5), i15  => ('r')) := v161];
	...
	if (v0) {
		...
		var v167: T2 := new C4(v2, v111, seq(abs(0x356), i16  => (v113)), v0, v111, |v166|, v2, v0);
		var v168: seq<T2> := [v167, v167];
		var v169: C12 := new C12(|v168| - v167.f5);
		v169 := v169;
		v165 := ((seq(abs(0x2c3), i17  => (v167.f5))) + (seq(abs(-846), i18  => (v169.f8)))) + v165;
		...
		var v180: array<int> := new int[15] [|v176|, v2, v2 - v2, v2, v2, v2 + v2, v2, v2, v2 * |v177|, |v178|, v2, v2, v2 + v2, if (|v177[safeIndex(v2, |v177|) := v2]| in v179) then v179[|v177[safeIndex(v2, |v177|) := v2]|] else v2, v2];
		var v181 := "ahj";
		var v182: T0 := new C4(v2, v0, v181, false, v0, v2, v2, v0);
		var v183: multiset<T0> := multiset{v182};
		v180[safeIndex(211, v180.Length)] := -(v2 - |v183|);
		var v184 := DC0(v182.f4, |v179|, v111, v182.f5, v182.f4);
		v180[safeIndex(211, v180.Length)] := --fm32(v184, globalState);
		v114[safeIndex(644, v114.Length)] := v182.f4;
		v114[safeIndex(644, v114.Length)] := v182.fm0(globalState);
		v114[safeIndex(644, v114.Length)] := v114[safeIndex(644, v114.Length)];
	...
	v2 := v187.cf103;
	for i21 := -0x320 to -safeDivisionInt(-v2, v2) {
		...
		match (v188) {
			case DC41(cf77, cf78) =>
				...
				var v199: map<int, D1> := map[-|v198[safeIndex(v2, |v198|)]| := DC3(v193)];
				var v200 := m0(v111, |(v199 + v199)|, globalState);
				var v201 := m0(v189, safeModuloInt(v2, |v191|), globalState);
			case DC42(cf79, cf80) =>
				var v202: array<int> := new int[14](i22 => i22 + v2);
				v202[safeIndex(313, v202.Length)] := v2;
				var v203: map<array<bool>, int> := map[v114 := i21];
				v202[safeIndex(313, v202.Length)] := |((v203 + v203) + v203)|;
				v202[safeIndex(313, v202.Length)] := v202[safeIndex(313, v202.Length)];
				cf79 := v111;
			...
			case DC40(cf76) =>
				...
				v208 := v208;
				v2 := |fm57(map v209 : int | (-0x3c3 <= v209) && (v209 < 0x1ad) :: (safeDivisionInt(v209, -0x134)) := (193), i21, globalState)|;
			case DC43(cf81) =>
				...
				var v215 := new C14(true, safeModuloInt(0x3e0, |fm87(v211, v212[safeIndex(|v214[safeIndex(v2, |v214|)]|, |v212|)], globalState)|));
				v0 := v2 in multiset(v211);
		}
		
		var v216: multiset<int> := multiset{i21, safeDivisionInt(|v186|, i21), i21};
		var v217: seq<bool> := [!v111];
		v2, v216, v111, v0, globalState.f0 := v2, v216, v0, v217[safeIndex(safeDivisionInt(v2, i21), |v217|)], fm48(i21, globalState);
		v186 := fm28(fm37(globalState), v2, v2, globalState);
		var v218: C8 := new C8(seq(abs(0x40), i23  => (v113)), i21);
	...
	var v224 := new C11(v221, if (v111) then fm27(v112[safeIndex(306, v112.Length)], globalState) else v222.cf90, |v223[safeIndex(|v186|, |v223|) := v223[safeIndex(v2, |v223|)]]| + v2);
	...
	if (false) {
		...
		var v233: map<int, array<int>> := map[|(map v227 : int | (0x4c <= v227) && (v227 < 0x227) :: (safeDivisionInt(v227, v2)) := (|multiset(seq(abs(0x321), i24  => (v113)))|))| := v232];
		var v234 := DC21(v233);
		v226[safeIndex(404, v226.Length)] := v234;
		var v235: seq<string> := [v186];
		var v236: map<bool, map<int, array<int>>> := map[v111 := v233];
		v186, v226[safeIndex(404, v226.Length)], v2 := v235[safeIndex(-v2, |v235|)] + v228.f17, v234.(cf43 := if (v228.f4 in v236) then v236[v228.f4] else v233), v228.f5;
		v113 := 'f';
		...
		v239 := v239[if (!v0) then v2 else v228.f5 := v238[safeIndex(v2, |v238|) := v223]];
		if (if (v111) then v228.f4 else v0) {
			...
			v241 := new C1(|v244|, fm27(v112[safeIndex(306, v112.Length)], globalState), if (v245 in v246) then v246[v245] else v228.f18, v228.f5);
			v111 := false;
		...
		var v251 := DC15(v250);
		v249[safeIndex(472, v249.Length)] := ([v111, v0, v111, v111, !v111] + v223)[safeIndex(-v2, |([v111, v0, v111, v111, !v111] + v223)|) := v111];
		var v252 := DC52({v111, false});
		v111, v249, v251, v249[safeIndex(472, v249.Length)] := |(v252.(cf93 := v1)).cf93| != -0x355, v249, DC15(v250), v223;
	...
	print v115.cf20[6], "\n";
	print v115.cf20[7], "\n";
	print v185[0] == map[-1 := false, 239 := false], "\n";
	print v185[1] == map[-1 := false, 239 := false], "\n";
	print v186, "\n";
	print v187.cf102, "\n";
	print v187.cf103, "\n";
	print v187.cf104, "\n";
	print v220 == map[0 := false], "\n";
	print v221.cf15, "\n";
	print v221.cf16, "\n";
	print v221.cf17, "\n";
	print v222.cf90, "\n";
