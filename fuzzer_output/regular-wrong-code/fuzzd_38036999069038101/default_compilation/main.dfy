...
function fm0(globalState: GlobalState): map<int, bool> {
	(map v0 : int | (0x1a5 <= v0) && (v0 < 316) :: (safeModuloInt(v0, -0xa9)) := (false)) + map[296 := !false]
}
function fm1(globalState: GlobalState): char {
	'l'
}
function fm2(globalState: GlobalState): bool {
	!((map[0x23d := |[!!true, !true, false]|] + map[--447 := 235]) == (map[|map['q' := true]| := 0x10f] + map[|(seq(abs(-452), i0  => (0x141)))| := 0x4]))
}
function fm3(p0: bool, p1: multiset<bool>, p2: bool, p3: int, globalState: GlobalState): map<bool, bool> {
	map[(set v0 : int | v0 in [0x171] :: (safeDivisionInt(v0, 0x20e))) !! {|[0x105]|} := false]
}
...
function fm5(globalState: GlobalState): D1 {
	DC3(|map[multiset{false, false, true, true, !false} := 0x178]| < -0x1a7, true, safeDivisionInt(0x75, |"sebrnl"|), true)
}
...
function fm10(p0: map<int, int>, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D1 {
	DC2(|([0x3cc, |(map v0 : string | v0 in map[seq(abs(0x7f), i0  => ('e')) := |map[true := |{|multiset{0xd3}|, |"xom"|, 0x1a3}|]|] :: (v0) := (true))|, |(seq(abs(785), i1  => ('c')))|, -884] + [|[849]|])|, 'r', -0xf0 * |(seq(abs(534), i2  => (|(seq(abs(0x251), i3  => ('t')))|)))|, [|(map v1 : int | v1 in (seq(abs(0x3b4), i4  => (|(seq(abs(0x1f4), i5  => (0x160)))|))) :: (safeDivisionInt(v1, 0x3c7)) := (true))|, -0x21b] + DC2(0x46, 'v', |(seq(abs(0x203), i6  => (-|multiset{-0x47, 0xd5}|)))|, [0x42], 'd').cf7, 'm')
}
...
method m0(p0: int, globalState: GlobalState) returns (r0: seq<map<D1, bool>>, r1: bool, r2: bool, r3: set<bool>) {
		...
		decreases 100 - i0
	{
		...
		if (!!fm2(globalState)) {
			...
			v1 := v15[safeIndex(p0, |v15|)];
		} else {
			var v16: array<bool> := new bool[6];
			v16[safeIndex(351, v16.Length)] := p0 > p0;
			...
			v19[safeIndex(344, v19.Length)] := p0;
			var v20: array<char> := new char[1];
			var v21: map<bool, array<char>> := map[false := v20];
			var v22 := DC16(v21);
			var v23: multiset<int> := multiset{p0};
			v19[safeIndex(74, v19.Length)] := |v22.cf29| * |v23|;
			v16[safeIndex(351, v16.Length)], v19[safeIndex(344, v19.Length)], globalState.f2, v19[safeIndex(74, v19.Length)] := fm7(p0, globalState) <= v4, p0, safeDivisionInt(-0x172, p0), -p0;
			var v24: array<string> := new seq<char>[22](i1 => seq(abs(-0x12a), i2  => (v8)));
			v24, r1, v23, globalState.f11 := v24, v16[safeIndex(351, v16.Length)], v23 - v23, fm7(if (v16[safeIndex(351, v16.Length)]) then v19[safeIndex(344, v19.Length)] else v19[safeIndex(344, v19.Length)], globalState);
			var v25: seq<int> := [v19[safeIndex(344, v19.Length)]];
			var v26: seq<int> := [p0, v19[safeIndex(344, v19.Length)], |v25|];
			var v27: seq<seq<int>> := [v26, v25];
			var v28: multiset<seq<int>> := multiset{v26, v27[safeIndex(v19[safeIndex(344, v19.Length)], |v27|)]};
			var v29: map<string, multiset<seq<int>>> := map[v4 := v28];
			v29 := v29[v4 := v28];
			v1, r1, v0 := v1, v16[safeIndex(351, v16.Length)], if (v16[safeIndex(351, v16.Length)]) then !v0 else v16[safeIndex(351, v16.Length)];
			var v30 := new C0();
		}
		...
		match (DC4(v33)) {
			case DC2(cf4, cf5, cf6, cf7, cf8) =>
				...
				v34[safeIndex(407, v34.Length)] := cf4;
				var v35 := DC9(cf4);
				v34[safeIndex(407, v34.Length)] := v35.cf17;
				var v36 := new C0();
				...
				v38[safeIndex(630, v38.Length)] := v40;
				...
				v36, v38[safeIndex(630, v38.Length)], globalState.f2, v34[safeIndex(407, v34.Length)], v44 := v1, v40, |(v7 + v7)| - -p0, cf4, v44;
			case DC3(cf9, cf10, cf11, cf12) =>
				...
				v47[safeIndex(345, v47.Length)] := map v48 : int | v48 in v50 :: (v48 * |[cf10]|) := (multiset{cf10, !cf12, cf9});
				...
				var v58: array<int> := new int[23] [858, |("dnsnwbotg" + "xvnoa")|, if (cf12) then cf11 else cf11, p0, 0x3cf + 0x28f, p0, cf11, safeModuloInt(|v4|, p0), |v52|, cf11, |"j"| * p0, |v7|, p0, |v55|, p0, cf11 * p0, if (fm2(globalState)) then |(seq(abs(-0x301), i5  => (v8)))| else |v57|, cf11, cf11, safeModuloInt(--p0, |v4|), cf11, |"pjqydcgsg"|, cf11];
				v58[safeIndex(894, v58.Length)] := p0;
				var v59 := DC9(p0);
				v47[safeIndex(345, v47.Length)], v51, v58[safeIndex(894, v58.Length)] := fm11(v0 <== cf10, 0x2ed, v59, v8 !in v4, globalState), v51, safeModuloInt(cf11, cf11);
				cf9 := cf10;
			case DC1(cf3) =>
			...
			case DC4(cf13) =>
				...
				v63[safeIndex(561, v63.Length)] := "lbrfdtt";
				v63[safeIndex(561, v63.Length)] := "rkrne";
				var v64 := new C0();
				v32, v0 := v32, v0;
		}
	...
	var v65: array<bool> := new bool[17](i8 => DC17([seq(abs(0x64), i9  => ('l')), v4]).cf30 < [v4]);
	forall i7 | 0 <= i7 < v65.Length {
		v65[i7] := 613 < (|v2| - p0);
	}
	var v66: array<C0> := new C0[6];
	v66[safeIndex(503, v66.Length)] := v1;
	v66[safeIndex(503, v66.Length)] := v1;
	var v67: array<array<bool>> := new array<bool>[4] [v65, v65, v65, v65];
	v67[safeIndex(891, v67.Length)] := v65;
	var v68 := DC8(v65);
	v67[safeIndex(891, v67.Length)] := v68.cf16;
...
method Main() {
	...
	var globalState := new GlobalState(false, v0, 212, false, 0x3, true, false, 743, true, v1, 0x2bc, seq(abs(199), i1  => ('j')));
	var v2 := true;
	if (v2) {
		var v3 := 0xf9;
		...
		match (v9) {
			case DC0(cf0, cf1, cf2) =>
				...
				v11[safeIndex(126, v11.Length)] := v10;
				v11[safeIndex(126, v11.Length)] := v10;
				...
				var v19 := DC1(v2);
				v13, v14, v2, v2 := v13, if (v18[safeIndex(cf2, |v18|)] in v17) then v17[v18[safeIndex(cf2, |v18|)]] else v14, v2, if (cf2 == cf2) then v2 else v19.cf3;
				v3 := cf2;
				var v20: seq<bool> := [v2];
				var v21: map<char, bool> := map[v10 := v2];
				var v22: seq<bool> := [v20[safeIndex(v3, |v20|)], false, if (v11[safeIndex(126, v11.Length)] in v21) then v21[v11[safeIndex(126, v11.Length)]] else v2, !v2, !v2];
		...
		var v30: multiset<map<int, int>> := multiset{map v27 : int | v27 in v8 :: (v27 - v3) := (|{|[|DC5([v2, v2]).cf14|]|}|), map v28 : int | v28 in v4 :: (safeDivisionInt(v28, v3)) := (v3), v29};
		v26 := v26[v25 := v30 !! v30];
		...
		if ((seq(abs(0x217), i2  => (v32))) < "jrvkbowy") {
			...
			v40[safeIndex(731, v40.Length)] := seq(abs(0x10a), i4  => (v32));
			v40[safeIndex(731, v40.Length)] := "yjcvetkn";
			var v41: array<seq<seq<int>>> := new seq<seq<int>>[6];
			var v42: seq<seq<int>> := [[v33, v33]];
			v41[safeIndex(1, v41.Length)] := v42;
			v41[safeIndex(1, v41.Length)] := (v42 + v42) + (v42 + v42);
			v38[safeIndex(69, v38.Length)] := v33;
			v38[safeIndex(69, v38.Length)] := 0x3b;
	...
	v0[safeIndex(495, v0.Length)] := v2;
	v0[safeIndex(495, v0.Length)] := v2;
	var v47: array<D1> := new D1[2];
	forall i5 | 0 <= i5 < v47.Length {
		v47[i5] := if (v2) then DC4(DC1(v0[safeIndex(495, v0.Length)])) else DC4(DC1(v2));
	}
	if (!v0[safeIndex(495, v0.Length)]) {
		var v48 := 0x37a;
		var v49: map<int, bool> := map[v48 := fm2(globalState)];
		var v50, v51, v52, v53 := m0(|v49|, globalState);
		globalState.f2 := v48;
		var v54: array<int> := new int[15];
		v54[safeIndex(238, v54.Length)] := v48;
		var v55: set<int> := {v48, v48};
		v54[safeIndex(238, v54.Length)] := |v55| + v48;
		...
		v0[safeIndex(495, v0.Length)] := v0[safeIndex(495, v0.Length)];
		var v59, v60, v61, v62 := m0(v57, globalState);
		v0[safeIndex(495, v0.Length)] := !v2;
		var v63: map<int, bool> := map[v57 := false];
		var v64 := "ljigfrq";
		var v65: map<int, string> := map[v57 := v64];
		if (v57 >= |(v63[|(if (v57 in v65) then v65[v57] else v64)| := v0[safeIndex(495, v0.Length)]] + v63)|) {
			v60 := v2;
			...
			var v69 := 'j';
			v68[safeIndex(260, v68.Length)] := v69;
			var v70: array<D1> := new D1[8];
			v70[safeIndex(482, v70.Length)] := fm5(globalState);
			var v71: C0 := new C0();
			var v72: map<C0, int> := map[v71 := v57];
			var v73: seq<int> := [v57 + (if (v71 in v72) then v72[v71] else 0x309)];
			var v74 := DC3(v61, v61, |{v60}|, v2);
			v0[safeIndex(495, v0.Length)], v67, v68[safeIndex(260, v68.Length)], v70[safeIndex(482, v70.Length)], v73 := v0[safeIndex(495, v0.Length)], v67, v69, v74.(cf12 := v0[safeIndex(495, v0.Length)], cf9 := v57 > 0x23e), seq(abs(-0x28b), i7  => (v57));
			var v75 := DC0(v57, multiset{v57}, v57);
			var v76: seq<array<bool>> := [v0];
			var v77 := DC2(safeModuloInt(v57, v57), fm1(globalState), v75.cf0 * |v76|, v73, if (v0[safeIndex(495, v0.Length)]) then v69 else v68[safeIndex(260, v68.Length)]);
			v77 := v77;
		} else {
			var v78: map<int, int> := map[351 := v57];
			var v79: multiset<bool> := multiset{!v2, v61, v0[safeIndex(495, v0.Length)]};
			var v80: seq<bool> := [v2];
			var v81: array<int> := new int[7];
			var v82: set<array<int>> := {v81, v81, v81};
			var v83: array<int> := new int[28] [v57, -v57, v57 * |v58|, v57, v57, |v64| + 0x160, v57, v57, v57, v57, v57, v57, v57, v57, v57, v57 + (if (v57 in v58) then v58[v57] else v57), safeDivisionInt(v57, |(seq(abs(-0x17e), i8  => (0x35)))|), v57, v57, v57 - v57, safeDivisionInt(|v78|, v57), 94, v57, if (v61 in v79) then v79[v61] else v57, |(if (v60) then v80 else v80)|, 0x257 - v57, if (v0[safeIndex(495, v0.Length)] in v79) then v79[v0[safeIndex(495, v0.Length)]] else v57, |v82|];
			v81[safeIndex(703, v81.Length)] := v57;
			v61, v0[safeIndex(495, v0.Length)], v81[safeIndex(703, v81.Length)], v61 := fm2(globalState), true, 0x335, v60;
			globalState.f2 := -v81[safeIndex(703, v81.Length)];
			var v84 := DC3(!!v80[safeIndex(v57, |v80|)], v61, v81[safeIndex(703, v81.Length)], v61);
			v61 := v84.cf12;
			v81[safeIndex(703, v81.Length)] := -(if (v60) then v57 else v81[safeIndex(703, v81.Length)]);
			v57 := -0x339;
		}
	...
	var v85 := -0x34d;
	for i9 := v85 to safeDivisionInt(v85, fm6(v85, globalState)) {
		var v86 := "fjukyxth";
		var v87: map<int, string> := map[i9 := v86];
		v87 := v87[if (v0[safeIndex(495, v0.Length)]) then |{v85, v85, |fm7(i9, globalState)|}| else v85 := v86];
		var v88 := new C0();
		var v89 := DC1(v2);
		var v90: seq<bool> := [v0[safeIndex(495, v0.Length)], v0[safeIndex(495, v0.Length)]];
		v2, v0[safeIndex(495, v0.Length)], v89, v0[safeIndex(495, v0.Length)], v88 := false, v90[safeIndex(if (v2) then v85 else v85, |v90|)], DC1(v0[safeIndex(495, v0.Length)]).(cf3 := v2), v2 <==> (v0[safeIndex(495, v0.Length)] && v2), v88;
		v0[safeIndex(495, v0.Length)] := (v89.(cf3 := v0[safeIndex(495, v0.Length)])).cf3;
	}
	var v91 := "dbygq";
	...
	v98 := v98[v85 := v0];
	var v99: C0 := new C0();
	var v100: map<bool, C0> := map[v0[safeIndex(495, v0.Length)] := v99];
	...
	forall i11 | 0 <= i11 < v0.Length {
		v0[i11] := v0[safeIndex(495, v0.Length)];
	}
	for i12 := v85 to v85 {
		var v106 := 'n';
		var v107: seq<seq<int>> := [v92, v92];
		var v108 := DC2(v85, v106, i12, v107[safeIndex(|v91|, |v107|)] + v92, v106);
		...
		globalState.f11, v108, v103, v85 := v110[safeIndex(if (|v112[safeIndex(v85, |v112|)]| in v101) then v101[|v112[safeIndex(v85, |v112|)]|] else i12, |v110|)], v108, fm2(globalState), i12;
		var v113: map<int, bool> := map[fm6(0x36, globalState) := v85 < 0x94];
		var v114: map<int, int> := map[i12 := -v85];
		var v115: map<array<bool>, bool> := map[v0 := v0[safeIndex(495, v0.Length)]];
		var v116: map<array<bool>, int> := map[v0 := -|v115|];
		var v117: array<int> := new int[17] [v85, v85, v85, |(v114 + v114)|, i12, i12, i12, v85, if (v0 in v116) then v116[v0] else i12, safeDivisionInt(i12, v85), safeModuloInt(878, -v85), i12, |v91|, v85 * |v109.cf19|, v85, v85, i12];
		var v118: map<set<int>, map<int, bool>> := map[fm8(v85, v104, v2, globalState) := v113];
		var v120: seq<map<int, bool>> := [map[i12 := v104], if ({-v85} in v118) then v118[{-v85}] else v113, v113, map v119 : int | v119 in v101 :: (v119 * v85) := (true), v113 + map[-0x243 := v0[safeIndex(495, v0.Length)]]];
		v0[safeIndex(495, v0.Length)], v113, v117 := v0[safeIndex(495, v0.Length)], v120[safeIndex(i12, |v120|)], v117;
		var v121: array<array<set<bool>>> := new array<set<bool>>[17];
		var v122 := DC12(v96);
		var v123: map<bool, set<bool>> := map[!v0[safeIndex(495, v0.Length)] := v105];
		...
		v121[safeIndex(601, v121.Length)] := v124;
		var v125: map<string, array<set<bool>>> := map[seq(abs(0x2ab), i13  => (v106)) := v124];
		v121[safeIndex(601, v121.Length)] := if (v91 in v125) then v125[v91] else v124;
		globalState.f2 := i12;
	}
	if (745 >= -v85) {
		var v126: array<seq<int>> := new seq<int>[4] [v92, v92, v92, if (fm2(globalState)) then seq(abs(0x20d), i14  => (v85)) else v92];
		v126[safeIndex(508, v126.Length)] := seq(abs(0x2b0), i15  => (v85));
		v126[safeIndex(508, v126.Length)] := [-v85, v92[safeIndex(v85, |v92|)]];
		var v127 := 'u';
		...
		var v133 := DC12(v96);
		v132[safeIndex(546, v132.Length)] := v133;
		v131, v0[safeIndex(495, v0.Length)], v132[safeIndex(546, v132.Length)], globalState.f2 := v131 + v131, v2, v133.(cf22 := v105), |v91|;
		v95 := v104;
		globalState.f2 := v85;
	} else {
		if (!!v2) {
			...
			v140 := v140;
			v2 := v104;
			v0[safeIndex(495, v0.Length)] := v94;
		} else {
			...
			var v149: array<int> := new int[20] [v85, v85, v85, v85, v85, safeDivisionInt(v85, fm6(v85, globalState)), v85, v85, fm6(v85, globalState), v85, -|v146| + v85, fm6(v85, globalState), safeModuloInt(v85, fm6(|v91|, globalState)), |v147|, v85, v85, -v85, -986, |v148|, safeModuloInt(v85, v85)];
			var v150: seq<array<int>> := [v149, v149, v149, v149, v149];
			v149 := v150[safeIndex(v85 * v85, |v150|)];
		}
		
		var v151: map<int, bool> := map[v85 := v103];
		var v152: multiset<bool> := multiset{true, v104};
		var v153: map<C0, multiset<bool>> := map[v99 := v152];
		v104, globalState.f2 := !(if (safeModuloInt(v85, |(if (v99 in v153) then v153[v99] else multiset{v0[safeIndex(495, v0.Length)]})|) in v151) then v151[safeModuloInt(v85, |(if (v99 in v153) then v153[v99] else multiset{v0[safeIndex(495, v0.Length)]})|)] else v2), safeModuloInt(v85, v85);
		v85 := v85;
		globalState.f2 := |v91|;
		...
		decreases 100 - i20
	{
		...
		v154[safeIndex(240, v154.Length)] := seq(abs(0x26), i21  => ('t'));
		v154[safeIndex(240, v154.Length)] := seq(abs(-0x3e7), i22  => (if (v104) then 'm' else 'u'));
		if (|v92| >= 0x38f) {
			var v155, v156, v157, v158 := m0(fm6(v85, globalState), globalState);
			var v159: map<int, bool> := map[-(if (v95) then v85 else v85) := v156];
			v159 := v159[-(v85 - v85) := v0[safeIndex(495, v0.Length)] ==> v95];
			globalState.f2 := v85;
			var v160: multiset<string> := multiset{v154[safeIndex(240, v154.Length)]};
			var v161 := 'q';
			...
			var v170: map<bool, array<int>> := map[!v0[safeIndex(495, v0.Length)] := v169];
			var v171 := DC5([v2, v2, v0[safeIndex(495, v0.Length)]]);
			var v172 := DC7(v171);
			...
			var v177: array<int> := new int[21] [v92[safeIndex(|v170|, |v92|)], v85, v85, |v174|, |v175|, v85, -v85, v85, v85, v85, v85, v85, -0x29c, v85, v85, v85, v85, v85, |map[v167 := 288]|, |v176|, v85];
			...
			v179[safeIndex(514, v179.Length)] := v169;
			v94, v179[safeIndex(514, v179.Length)], v0[safeIndex(495, v0.Length)], v0[safeIndex(495, v0.Length)] := v94, v169, if (v85 > v85) then v166 else v95, v2;
			v0[safeIndex(495, v0.Length)] := v103;
		}
		
		if (v103) {
			var v180: multiset<bool> := multiset{v94, !v103, false, v104};
			var v181: seq<multiset<bool>> := [v180, v180, v180, v180];
			v181 := v181 + (seq(abs(0x2d9), i23  => (multiset{v95, v104})));
			v180 := v181[safeIndex(v85, |v181|)];
			v0[safeIndex(495, v0.Length)] := !(v85 >= -v85) <== v94;
			v0[safeIndex(495, v0.Length)] := false;
			v95 := v104;
		} else {
			...
			var v187: array<set<bool>> := new set<bool>[22] [v105 + v96, {false, v103} + v105, fm9(multiset{v85, v85}, true, v104, globalState), {false}, v182[safeIndex(fm6(v85, globalState), |v182|)], {v103, v104} * {true, v94, v2, v104}, v105, v183.cf22, v96 * {v2, v104}, v96, v96, v96, if ((if (v184 in v186) then v186[v184] else v184) in v185) then v185[if (v184 in v186) then v186[v184] else v184] else v96, v96, v96, v105, v96, if (v94) then v96 else v183.cf22, fm9(v101, !v104, v94, globalState), v96, v96, v105];
			v187[safeIndex(919, v187.Length)] := v105;
			var v188: map<char, multiset<int>> := map[v184 := v101];
			v187[safeIndex(919, v187.Length)] := if (v0[safeIndex(495, v0.Length)]) then v96 else fm9(if (v184 in v188) then v188[v184] else v101, v0[safeIndex(495, v0.Length)], v95, globalState);
			v0[safeIndex(495, v0.Length)] := false;
			var v189: seq<bool> := [v0[safeIndex(495, v0.Length)]];
			globalState.f2 := safeDivisionInt(v85 - 0xfe, v85 + (if (v85 in v101) then v101[v85] else |v189|));
			v2 := v94 || v0[safeIndex(495, v0.Length)];
		...
		v190[safeIndex(157, v190.Length)] := v85 * -|v192|;
		var v193: map<int, int> := map[0xc4 := v85];
		var v194 := 't';
		v190[safeIndex(157, v190.Length)] := (fm10(v193, v103, v104, false, globalState)).cf4 - safeDivisionInt(|(map[v194 := v99])[v194 := v99]|, |"dwaa"|);
	}
	print v0[0], "\n";
	print v0[1], "\n";
	print v0[2], "\n";
	...
	print globalState.f9[0] == {-34}, "\n";
	print globalState.f9[1] == {-34}, "\n";
	print globalState.f9[2] == {-34}, "\n";
	print globalState.f9[3] == {-34}, "\n";
	print globalState.f9[4] == {-34}, "\n";
	print globalState.f9[5] == {-34}, "\n";
	print globalState.f9[6] == {-34}, "\n";
	print globalState.f9[7] == {-34}, "\n";
	print globalState.f9[8] == {-34}, "\n";
	print globalState.f9[9] == {-34}, "\n";
	print globalState.f9[10] == {-34}, "\n";
	print globalState.f9[11] == {-34}, "\n";
	print globalState.f9[12] == {-34}, "\n";
	print globalState.f9[13] == {-34}, "\n";
	print globalState.f9[14] == {-34}, "\n";
	print globalState.f9[15] == {-34}, "\n";
	print globalState.f9[16] == {-34}, "\n";
	print globalState.f9[17] == {-34}, "\n";
	print globalState.f9[18] == {-34}, "\n";
	print globalState.f9[19] == {-34}, "\n";
	print globalState.f9[20] == {-34}, "\n";
	print globalState.f10, "\n";
	print globalState.f11 == ['j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j', 'j'], "\n";
	print v2, "\n";
	print v47[0].cf13.cf3, "\n";
	print v47[1].cf13.cf3, "\n";
	print v85, "\n";
	print v91, "\n";
	print v92 == [-845, -845, -845, -845, 5, -845, -845, -845, 5], "\n";
	print v93 == [map[DC3(false, false, 8, false) := false], map[DC3(false, false, 8, false) := true]], "\n";
	print v94, "\n";
	print v95, "\n";
	print v96 == {false}, "\n";
	print v97.cf16[0], "\n";
	...
	print |v98|, "\n";
	print |v100|, "\n";
	print v101 == multiset{-845}, "\n";
	print v102 == [map[DC3(false, false, 0, false) := false], map[DC3(false, false, 0, false) := true]], "\n";
	print v103, "\n";
	print v104, "\n";
	print v105 == {false}, "\n";
	print i20, "\n";
