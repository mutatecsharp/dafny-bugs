...
function fm1(p0: bool, p1: char, p2: int, globalState: GlobalState): int {
	(|{true}| / --576) - |(map[604 := true] + map[0x1d7 := true])|
}
...
function fm12(p0: int, p1: D0, globalState: GlobalState): seq<int> {
	((seq(312, i0  => (|(map v0 : int | v0 in (map v1 : int | (-0xc6 <= v1) && (v1 < -0x173) :: (v1 + |multiset{-0x6e}|) := (!false)) :: (v0 - 0x369) := (true))|))) + (seq(-0x3c2, i1  => (|[0x3db]|)))) + [--0x393]
}
...
function fm14(globalState: GlobalState): D0 {
	DC0([multiset{0x24b}, multiset(seq(-336, i0  => (0x399)))] + [multiset{0x213, 0x107}, multiset{0xf5, 950}])
}
function fm15(globalState: GlobalState): set<int> {
	{----122}
}
function fm16(p0: int, globalState: GlobalState): seq<multiset<int>> {
	[multiset{|(seq(0xb2, i0  => ('m')))|} * multiset([|multiset(DC19([|map[|map[|[151]| := 'v']| := true]|]).cf34)|]), multiset{|"vqbthl"|} + DC14(multiset{0x77, -456}, |"ty"|, DC5("ehtttxx")).cf28, multiset{|"lotvixcay"|}, multiset{0x1fc, -0x3d9}]
}
...
function fm19(globalState: GlobalState): multiset<D0> {
	multiset{DC0([multiset(seq(0x1aa, i0  => (0x1f4)))]), DC0([multiset([0x19a, 803])]), if (false) then DC0([multiset{|[true]|}]) else DC0([multiset{|map[false := 0x2d3]|}])}
}
function fm20(p0: bool, globalState: GlobalState): map<int, int> {
	(if (true) then map[|map[!true := multiset{false}]| := -0x1f1] else map[0x82 := -588]) + DC22(map[|(seq(0x32b, i0  => ('o')))| := -|multiset{|map[true := map[false := true]]|, |[true]|}|]).cf42
}
...
method m1(p0: bool, p1: int, globalState: GlobalState) returns (r0: int, r1: bool) {
	...
	match (v10) {
		case DC1(cf1) =>
			...
			v11[549] := if (p0) then v3 else v13[686];
			...
			if (v14[398]) {
				...
				var v23: seq<array<C1>> := [v18, if (v14[398] in v22) then v22[v14[398]] else v18];
				var v24: multiset<int> := multiset{v17.f27};
				var v25: seq<array<C1>> := [v23[DC10(p0, |v24|, p0).cf17], v18, v18];
				var v26: T0 := new C0();
				var v27: seq<T0> := [v26];
				var v28: multiset<T0> := multiset{v27[p1], v26};
				globalState.f23, v14[398], v19[835] := v21 < {v20}, v14[398], v25[|v28|];
				globalState.f2 := p1;
				globalState.f23 := !v14[398];
			} else {
				var v29: seq<bool> := [v14[398], v14[398]];
				var v30 := "n";
				globalState.f19 := fm1(v29[|v30|], v7, |v30|, globalState);
				var v31 := new C0();
				...
				var v36 := DC15(v35);
				var v37: set<bool> := {v14[398]};
				var v38: T0 := new C1(v37, p1);
				var v39: map<array<int>, int> := map[v11[549] := |v29|];
				var v40: map<T0, int> := map[v38 := if (v11[549] in v39) then v39[v11[549]] else cf1];
				var v41: seq<map<T0, int>> := [v40];
				v36, v14[398], globalState.f10, v7 := DC15(v35[v34 := cf1]).(cf31 := (multiset{v34})[v34 := v31.fm8(v37, globalState)]).(cf31 := v35 * v35), v14[398], |v41|, v7;
				var v42: map<int, bool> := map[p1 := if (p0 in v0) then v0[p0] else p0];
				var v43: seq<map<int, int>> := [fm20(if (p1 in v42) then v42[p1] else v14[398], globalState)];
				var v44: map<array<int>, bool> := map[v3 := p0];
				var v45: map<int, array<int>> := map[|v43[|v44|]| := v11[549]];
				globalState.f11 := if ((v31.fm8(v37, globalState) / p1) in v45) then v45[v31.fm8(v37, globalState) / p1] else v3;
			}
			
			var v46: multiset<array<int>> := multiset{v11[549], v3};
			v14[398] := v46 >= v46;
		case DC2(cf2, cf3, cf4, cf5, cf6) =>
			...
			if (!cf2) {
				...
				v3[668], globalState.f5, r1, globalState.f10 := cf6, |"mjpyri"| * |((seq(816, i1  => ('m'))) + v49)[-(if (cf5 in v56) then v56[cf5] else cf6) := v7]|, true, -(cf6 + -cf6);
				var v57 := new C0();
			} else {
				v3[250] := p1;
				v3[250] := p1;
				var v58: multiset<string> := multiset{v49};
				v3[250] := if (v49[cf6 := v7] in v58) then v58[v49[cf6 := v7]] else p1;
				...
				var v67 := DC15(v66);
				var v68: map<int, D5> := map[v5.fm8(v62, globalState) * -v3[250] := v67];
				v68 := v68;
				globalState.f22 := cf4;
			}
		...
		case DC3(cf7) =>
			...
			var v70: seq<int> := [p1];
			var v71: seq<int> := [|v69| % v70[p1], p1];
			v70 := [p1] + v71;
			v3[955] := p1;
			v3[955] := p1;
			var v72: multiset<bool> := multiset{fm0(p0, v0, globalState)};
			var v73 := DC8(p1, p0, if (p0 in v72) then v72[p0] else v3[955]);
			v73 := v73;
			v5 := v5;
		case DC0(cf0) =>
			globalState.f25 := p0;
	...
	for i2 := |v0[p0 := p0]| to p1 {
		...
		if (0x6a != i2) {
			...
			var v81: seq<bool> := [p0];
			globalState.f25, globalState.f19, globalState.f16, globalState.f23 := !!fm0(!p0, map[false := fm0(true, v0, globalState)], globalState), i2, v80, v81[p1];
			...
			v91 := v91[if (!p0) then true else fm0(p0, v0, globalState) := |fm21(p0, p0, globalState)| / p1];
			var v92 := "ldritmxh";
			v92 := "oocr";
		} else {
			...
			var v105: array<int> := new int[20] [v3[45], i2, if (true) then 0x3b8 else i2, v3[45], |v99| + -v3[45], p1, v101[p1], -v98.f27, -v98.f27, -v98.f27, v3[45], if (!fm0(p0, map[p0 := p0], globalState)) then v3[45] else |multiset{v102[-i2], p0, p0, p0}|, |"xrsul"|, v3[45], |v95|, if (p0) then v98.f27 else fm1(p0, v7, v98.f27, globalState), p1, (v103.(cf1 := fm1(p0, v7, v3[45], globalState))).cf1 + |(multiset{p0})[if (v95 in v104) then v104[v95] else p0 := i2]|, -i2, v3[45]];
	...
	r0 := -(if (p0) then fm1(p0, v7, v109, globalState) else if (p0 in v111) then v111[p0] else p1) / v109;
	r1 := p0;
}
trait T0 {
...
class C0 extends T0 {
	...
	function fm4(p0: int, p1: bool, globalState: GlobalState): int {
		(|(seq(152, i0  => ('u')))| % 0x35c) - 0x295
	}
	function fm7(p0: bool, p1: set<int>, p2: string, globalState: GlobalState): map<int, bool> {
		map v0 : int | v0 in ([-0x6c] + [DC1(0xa0).cf1, 0x33, |map[true := 574]|, |map[true := false]|]) :: (v0 * |"nhtgllpi"|) := (!(-|(seq(0x2e6, i0  => ('n')))| > |"sntppqvt"|))
	}
	function fm8(p0: set<bool>, globalState: GlobalState): int {
		|(if (true) then [-0x3a6, 0x208] else [|map[-|"papx"| := false]|])| + -(-|(seq(0x30f, i0  => (DC1(|"ua"|))))| - 826)
	}
}
...
class C1 extends T0 {
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		if (v3 >= (v3 * v3)) {
			...
			v2[892] := f27;
			globalState.f23, globalState.f19, v10, v2[892] := (0x3a3 !in {f27}) ==> p0, if (multiset([f27, f27, |v8|]) == v4) then f27 else f27, map[f27 := p0], -345;
			var v11: array<string> := new string[5] [v7, v7, ("wtybqap")[f27 := v0], v7 + v7[v2[892] := v0], "vmqrsdga"];
			v11 := v11;
			v7 := v7;
			globalState.f23 := p0;
			var v12: map<int, int> := map[f27 := |v7|];
			v12 := v12[|(seq(0x9a, i0  => (v0)))| := |f26|];
		} else {
			...
			v14[990] := p0;
			var v15 := "np";
			v14, v14[990] := v14, |v15| >= |v3|;
			f27 := -fm1(v14[990], v0, f27, globalState) / f27;
			var v16: array<char> := new char[13] [v0, v0, v0, v0, fm5(globalState), v0, v0, v0, v0, v0, v0, v0, v0];
			v16[866] := v0;
			v16[866] := if (p0) then 'l' else v0;
			var v17: multiset<bool> := multiset{!p0, v14[990], p0};
			globalState.f15 := if (true || p0) then f27 else if (!v14[990] in v17) then v17[!v14[990]] else |v15[|"sc"| := v0]|;
		}
		
		if (p0) {
			var v18: map<bool, set<seq<int>>> := map[p0 := {seq(-0x186, i1  => (--f27))}];
			...
			var v25 := DC0(v24 + [v24[f27]]);
			match (v25) {
				case DC1(cf1) =>
					var v26: array<bool> := new bool[1];
					v26[126] := p0;
					v26[126] := p0;
					v26[126], globalState.f25 := !v26[126], v26[126];
					v26[126] := if (p0 && v26[126]) then v26[126] else p0;
					var v27: T0 := new C0();
					v27 := v27;
				case DC2(cf2, cf3, cf4, cf5, cf6) =>
					var v28: map<bool, string> := map[p0 := v21];
					var v29: map<bool, int> := map[cf2 := |(if (cf5 in v28) then v28[cf5] else "g")|];
					var v30: map<int, int> := map[--|((seq(879, i2  => (v0)))[|v29| := v0] + v21)| := cf6];
			...
			if (p0) {
				...
				var v58: seq<bool> := [p0];
				var v59: seq<int> := [f27];
				v55[99][691] := v58[v59[f27]];
				var v60: map<bool, char> := map[p0 := v0];
				v55[99][691] := v60 != DC9(v60).cf15;
			}
			...
			var v63: seq<bool> := [p0];
			var v64: seq<bool> := [v63[f27], p0, p0];
			var v65 := DC7(p0);
			v64 := if (v65.cf11) then (v63[fm1(p0, v0, f27, globalState) := false])[f27 := p0] else v64;
			var v66: set<int> := {f27};
			var v67: map<bool, bool> := map[p0 := p0];
			var v68 := "eelid";
			var v69: seq<string> := [v68];
			var v70: seq<int> := [|v69[f27]|];
...
method Main() {
	...
	var globalState := new GlobalState(v3, 0xc9, -0x390, -807, false, 0x3de, seq(0x90, i0  => ('t')), 0x96, 0x3b0, true, 334, v4, set v7 : string | v7 in v6 :: (v7), v5 + v5, true, 0x352, v8, seq(0x14, i2  => ('u')), v9, -870, v5, map[v1 := v11] + v12, false, false, v5, true);
	...
	if (!fm0(if (v1 in v14) then v14[v1] else v0, v15 + v15, globalState)) {
		...
		if (v0) {
			...
			var v20: map<bool, int> := map[v0 := v4[884]];
			v0 := (if (v0 in v8) then v8[v0] else v4[884]) <= ((if (fm1(v0, v10, |map[|multiset(v2)| := v4[884]]|, globalState) in v17) then v17[fm1(v0, v10, |map[|multiset(v2)| := v4[884]]|, globalState)] else v4[884]) / -|map[|v20| := false]|);
			globalState.f2 := v1 % v4[884];
			...
			v24[210] := v25;
			v24[210] := v25.(cf19 := fm3(v4[884], v0, globalState));
			var v26 := DC4(v10);
			v26 := v26.(cf8 := v10);
		...
		var v28: C1 := new C1(v27[v1], v1);
		var v29: seq<bool> := [v0, !v0, DC11(v10, v0, v0).cf20];
		var v30: map<seq<bool>, C1> := map[v29 := v28];
		v4[884], v28 := |v2| % v1, if ((if (false) then v29 else [v0, v0, v0])[-v1 := v0] in v30) then v30[(if (false) then v29 else [v0, v0, v0])[-v1 := v0]] else v28;
	} else {
		if (v1 > |v8|) {
			var v31: T0 := new C0();
			...
			globalState.f10, globalState.f19, v31, globalState.f23, v33 := if (false) then v1 else if (v34[v1]) then v1 else v1, v1 + v1, v31, v0, v33;
			v31 := v31;
			v14 := v14[v1 := v0];
			...
			var v44: seq<C1> := [v43];
			v38, v39, v43, globalState.f19 := v38, {v43.f27, |v44| % v2[|v5|], v1}, v43, v43.f27;
			var v45: array<D4> := new D4[25](i5 => DC13(v8));
			var v46: T0 := new C1(v43.f26, v1);
			var v47: seq<T0> := [v46, v46];
			var v48: map<T0, int> := map[v47[v2[v1]] := v1];
		...
		if (v55.cf13) {
			...
			globalState.f5 := |(v57 + (seq(876, i6  => (DC11(v10, v0, v0)))))|;
			globalState.f25 := v0;
			globalState.f2 := v1 + (v1 / v1);
			var v58: array<D3> := new D3[3](i7 => DC11(v10, !v0, !!!v0));
			v58[610] := v56;
			v58[610] := fm11(v1, globalState);
			var v59 := DC1(v1);
			...
			var v67 := DC1(-0x1ec);
			var v68: array<seq<int>> := new seq<int>[13] [seq(0x1c, i8  => (|"cwxonbmhb"|)), v2 + fm12(v1, v67, globalState), v2, [v66.f27], v2, v2, v2 + (seq(0x2fa, i9  => (|v8[v0 := -v66.f27]|))), v2, v2, if (v0) then v2 else v2, v2, v2, v2];
			v68[273] := v2 + v2;
			var v69: set<int> := {v66.f27, v1};
			var v70: seq<seq<int>> := [(v2[|v69| := v66.f27])[v66.f27 := v1], seq(-788, i10  => (v1)), v2, (seq(0x179, i11  => (v66.f27))) + v2];
			v68[273] := v70[v1];
		...
		if (v8 !! multiset{v0, v0, true}) {
			...
			v4[451] := |(v5 + v5)[v1 := v10]|;
			v4[451] := v1;
			var v74: map<map<int, int>, bool> := map[map[v4[451] := -v1] := v0];
			v74, globalState.f15, v2, globalState.f25, globalState.f2 := v74 + v74, 465, (v2 + v2) + (seq(23, i12  => (v1))), fm0(v0 <==> v0, map[v0 := fm0(v0, v15, globalState)], globalState), v4[451];
			var v75: set<bool> := {v0};
			...
			var v85: set<int> := {v1};
			globalState.f11, globalState.f23, v0, v82, v83 := v4, fm0(true <==> fm0(v0, v15, globalState), v15 + v15, globalState), v8 <= (multiset(v84) + v8), {v0, v0, !v0, v84[|v85|]}, v83.(cf8 := v10);
	...
	if ((v90 - v90) >= v90) {
		if (v0 ==> v0) {
			...
			var v94 := new C0();
			var v95: map<string, string> := map[seq(-0xdd, i14  => (v10)) := v5 + "jkvceykyp"];
			v95 := v95[v5 := v5];
			...
			v9[876] := v0;
			v9[873] := v0 ==> v0;
			globalState.f23, v10, v9[876], v9[873] := v0, v10, v0, v0;
			var v98, v99 := m1(if (v9[876] in v15) then v15[v9[876]] else v0, v1 / 140, globalState);
			v9[876] := fm15(globalState) !! {v98, v1, v1, -v1};
		}
		
		var v100 := new C0();
		var v101: seq<bool> := [if (v0) then v0 else v0, v0, !v0];
		var v102: map<int, int> := map[v1 := v1];
		globalState.f10, globalState.f8, v101, globalState.f19 := v100.fm4(if (v1 in v102) then v102[v1] else v1, v1 != |v101|, globalState), -v1, v101[v1 := v1 !in v14], v1;
		var v103: set<C0> := {v100, v100, v100, v100, v100};
		var v104: multiset<set<C0>> := multiset{v103};
		var v105: seq<set<C0>> := [v103];
		v104 := multiset(v105[v1 := v103]);
		globalState.f8 := |v5|;
	} else {
		v5 := v5;
		...
		v9[924], globalState.f2, v1 := v0 <==> v0, fm1(if (v0) then v0 else v0, v10, |v5| % v1, globalState), v107.cf12;
		var v108: map<int, array<int>> := map[685 := v4];
		v108 := v108[|v5| - v1 := v4];
		var v109: set<bool> := {v9[924]};
	...
	if (v0) {
		...
		if (v90 < v90) {
			v4[641] := v111;
			v4[641] := v1 - (if (v0) then 0x2ca else -v111);
			v9[761] := (set v114 : int | (0x2d2 <= v114) && (v114 < 354) :: (v114 % -0x1c7)) > fm15(globalState);
			v9[761] := v112;
	...
	var v129: set<multiset<bool>> := {v8, v8, v8, v128[v1], v8};
	...
	v136, v111, globalState.f19, globalState.f5 := v136, (v1 * v111) % (v111 + v111), v133, -v1;
	if (v134) {
		...
		v112 := v147.cf22;
		var v149: map<int, int> := map[-(v1 / v133) := |(map v148 : int | (0x3c7 <= v148) && (v148 < 0x136) :: (v148 + v133) := (v134))|];
	...
	if (true) {
		...
		var v160: array<string> := new string[12] [v5, v5, v5, seq(0x3a1, i15  => (v10)), v5 + v5, v5, v5, v5, (v158.cf9 + (seq(0x36f, i16  => (v10))))[v133 := 'w'], v5 + v5, ((v159[v111])[|v2| := v10])[v1 := v10], v5 + v5];
		v160 := v160;
		var v161: array<T0> := new T0[23];
		v9[184] := v134;
		v161, v9[184], v5, v5 := v161, true, v5[v133 := v10], (v5 + v5) + v5;
		var v162: array<seq<int>> := new seq<int>[20](i17 => v2 + v2);
		v162[630] := seq(0x46, i18  => (-v1));
		...
		if ((v5 + v5) < v5) {
			...
			v134 := (v162[630] + v2) == ([v167, 0x10e] + v2)[|v132| := v111];
			var v169: T0 := new C0();
			...
			var v171: map<bool, seq<bool>> := map[v0 := v132[0x73 := v112]];
			var v172: map<int, map<bool, seq<bool>>> := map[|v2| := v171 + v171];
			v172 := v172[|(map[v111 := !v9[184]])[v1 := v134]| := map[v134 := v132]];
			v9[184] := !(v164.f27 <= v133);
			var v173: array<char> := new char[17];
			v173 := v173;
			var v174: C0 := new C0();
			var v175: seq<C0> := [v174];
			var v176: array<C0> := new C0[25] [v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, v174, if (v134) then v174 else v174, v174, v175[|v132|], v174, v174, v174, v174, v174, v174];
			v176[123] := v174;
			globalState.f8, v164.f27, v5, v176[123], globalState.f25 := v111, v133 * |[|v175|, |v2|, -0x1ff, v164.f27, v111]|, seq(563, i19  => (v10)), v174, v134;
		...
		if ((v181 - v181) !! v181) {
			...
			var v183 := new C0();
			v9 := v9;
			var v184: map<string, bool> := map[v5[v180.f27 := v10] := v0];
			globalState.f22 := if (v5 in v184) then v184[v5] else v112;
			var v185 := new C0();
		} else {
			var v186: map<int, string> := map[0x271 / (if (|v180.f26| in v135) then v135[|v180.f26|] else v111) := v5[v111 := v10]];
			v186 := v186;
			...
			v4[742] := v133;
			v4[742] := -fm1(true, v10, v133, globalState);
		}
		...
		if (v134 <== !(|fm12(|v5|, v193, globalState)| >= |v15|)) {
			...
			globalState.f23 := v111 == -(605 % v195.cf29);
			var v196, v197 := m1(v134, v180.f27, globalState);
			var v198: T0 := new C0();
			v1, v5, globalState.f19, v198, v198 := --((if (v133 in v135) then v135[v133] else v180.f27) / v111), ("rfeampgsi" + v5) + ((seq(0x23d, i21  => (v10))) + v194.cf9), v1 + -0x1f7, v198, v198;
			globalState.f22 := v180.fm6([v152], v5 + "u", v8, globalState);
			v9[941] := !(v10 !in v5);
			var v199: map<multiset<int>, seq<int>> := map[v135 := v2];
			var v200 := DC8(v111, v0, v133);
			v10, v111, globalState.f2, v9[941], globalState.f10 := v10, v111, |(if (v112) then v199 else v199)|, v200.cf13, v1;
		} else {
			v180, v128 := v180, v128;
		...
		var v206: seq<multiset<int>> := [((multiset(v2))[v180.f27 := v111])[v180.f27 := 154], v135];
		var v207 := DC15(multiset{v152.(cf0 := v206), v152});
		var v208: seq<multiset<D0>> := [fm19(globalState), v207.cf31];
		v205 := v205[v180 := v208[|"xbifwaa"|]];
	}
