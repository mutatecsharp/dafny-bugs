...
function fm0(p0: char, globalState: GlobalState): bool {
	(multiset{false} + multiset([false, false, false, false, false])) !in (seq(0x394, i0  => (multiset([true]))))
}
function fm1(p0: int, p1: bool, globalState: GlobalState): char {
	'm'
}
function fm2(globalState: GlobalState): D0 {
	match if (!!!false) then DC52(multiset{seq(0x2c5, i0  => (-|{|{-0x186}|}|)), [|(map v0 : D3 | v0 in (set v1 : D3 | v1 in map[DC8([false]) := true] :: (v1)) :: (v0) := (true))|, 0x78], [0x31c], [0x7e], [0x11d, |"ngfivc"|]}) else DC52(multiset([[-0x217, -0x35e], [0x239]])) {
		case DC52(cf88) => DC1()
	}
}
...
function fm4(p0: bool, p1: bool, globalState: GlobalState): seq<multiset<int>> {
	(seq(0x2c6, i0  => (multiset{|['m']|, -0x1d, -|[map[true := false]]|, |map[-0x2b3 := |multiset{true, !true}|]|, -0x9}))) + (if (true) then seq(0x13a, i1  => (multiset{|[[true, false, false, true]]|})) else [multiset{|map[|map[967 := 0x1c0]| := |(map v0 : int | (366 <= v0) && (v0 < 0xe4) :: (v0 - |DC33(false, |map[false := 734]|, multiset{false}, -|"i"|, {true}).cf54|) := ('y'))|]|}])
}
...
function fm22(globalState: GlobalState): map<multiset<int>, string> {
	map[multiset{|multiset{true}|} := "n"] + (map[multiset{0x357, |"xt"|} := seq(0x122, i0  => ('w'))] + map[multiset{-|map[false := false]|} := "pmrrdi"])
}
...
function fm30(p0: seq<int>, p1: bool, globalState: GlobalState): seq<seq<int>> {
	[[0x32c], [-0x3c8, |[false, true]|]] + (seq(573, i0  => ([|map[true := false]|, |[true, true]|, |(map v0 : int | (122 <= v0) && (v0 < -0xf) :: (v0 * -0x3d1) := (true))|])))
}
...
function fm34(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<multiset<int>, string> {
	((map v0 : multiset<int> | v0 in [multiset{|multiset{true}|, 0xec}] :: (v0) := ("e")) + map[multiset([|{299, 0x3a7, -557, |"chaced"|, 0x3a6}|, 0x177]) := "jnbkik"]) + (if (false) then map[multiset(seq(0x157, i0  => (|multiset{true}|))) := "wdpr"] else map[multiset{|map[seq(0x19, i1  => (|[true]|)) := -972]|} := seq(0x14b, i2  => ('k'))])
}
function fm35(p0: int, globalState: GlobalState): set<int> {
	({|"tghobrq"|} * {-0x32f}) * ({--|{|{false, true}|, |"d"|}|, 0xba} + {0x35a, -0x20e, DC24(!true, true, -|"tfoksstqw"|).cf38, |(seq(653, i0  => ('d')))|})
}
function fm36(p0: bool, globalState: GlobalState): seq<int> {
	([0x23] + [|multiset{!!false, true}|]) + (seq(0x396, i0  => (0x387)))
}
...
function fm39(p0: string, p1: D12, p2: bool, globalState: GlobalState): seq<int> {
	[|["tjnq", seq(462, i0  => ('n'))]| % |map[multiset{false} := 'd']|]
}
...
function fm42(p0: char, p1: set<D6>, globalState: GlobalState): map<int, int> {
	map[459 := --980] + (map v0 : int | (0x245 <= v0) && (v0 < 197) :: (v0 / 0x1f5) := (|multiset([!!!!!false, false])|))
}
...
function fm45(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState): seq<multiset<bool>> {
	[multiset{true, false}, multiset{true, false, false, true, true}, multiset{false}] + (if (!true) then [multiset{false}, multiset{true}] else seq(824, i0  => (multiset{!false})))
}
...
function fm49(p0: string, p1: seq<bool>, p2: int, globalState: GlobalState): seq<seq<int>> {
	([[191], [|{0x2e1, -741}|, 0x158]] + (seq(-224, i0  => ([|[|map[0x25e := DC16(true, false, [|map[0x240 := |map[true := false]|]|]).cf20]|]|])))) + [[|[false, true]|]]
}
...
function fm54(p0: int, globalState: GlobalState): seq<map<bool, bool>> {
	[map[true := false]] + ([map[false := true]] + (seq(0x9b, i0  => (map[true := !false]))))
}
...
function fm57(p0: int, p1: int, globalState: GlobalState): seq<int> {
	((seq(0xbd, i0  => (|[map[false := 681]]|))) + [-469]) + (seq(-0x295, i1  => (|{map['b' := false], map['x' := false]}|)))
}
...
function fm66(p0: int, globalState: GlobalState): D16 {
	DC33(true ==> false, |"gk"| % 925, DC33(false, |[false]|, multiset{!false}, 0xf9, {false}).cf54 * multiset{true}, -0x98, {false} - {false})
}
...
function fm68(globalState: GlobalState): D12 {
	DC27(if (false) then seq(0xdf, i0  => ([true])) else [[false]])
}
function fm69(globalState: GlobalState): map<int, string> {
	map[|(multiset{--3} + multiset{-0x3d6})| := "igvytirrh" + (seq(0x266, i0  => ('m')))]
}
function fm70(p0: bool, p1: int, p2: seq<bool>, p3: bool, globalState: GlobalState): seq<multiset<char>> {
	((seq(0x7, i0  => (multiset{'d'}))) + (seq(866, i1  => (multiset{'j', 'q'})))) + [multiset{'k'}, multiset{'r', 'c', 'f', 'b'}, multiset(['q']), multiset{'b', 'c'}, multiset{'h'}]
}
...
function fm72(p0: map<string, D12>, p1: multiset<int>, globalState: GlobalState): D25 {
	match DC17({0x15e, |[true, !true, true]|, |(seq(0x34e, i0  => ('m')))|}) {
		case DC17(cf23) => DC52(multiset(seq(510, i1  => ([0xb4]))))
	}
}
function fm73(globalState: GlobalState): multiset<seq<int>> {
	(multiset{[|(map v0 : int | v0 in map[0x220 := |"qkivckp"|] :: (v0 % 0x2b0) := (false))|], [|DC58(map[map[false := true] := !false]).cf97|]} * multiset([[0x2dc]])) + multiset{seq(0x207, i0  => (|map[0x25a := -700]|))}
}
method m0(p0: map<multiset<int>, string>, p1: bool, p2: multiset<int>, p3: bool, globalState: GlobalState) returns (r0: bool, r1: int) {
	if (true) {
		...
		var v10: array<bool> := new bool[19] [p3, p3, p1, |(map v2 : int | v2 in v4 :: (v2 / 0x58) := (-v3))| != 0x323, p1, p1, v5 > v5, p1, p1, v3 <= v3, v6 !! v6, v7 < fm53(v3, v9, globalState), p1, p1, p1, p1, p1 ==> p3, p3, p3];
		var v11: seq<bool> := [true];
		v10[167] := v11[v3];
		var v12 := "fku";
		v10[167] := v5 < {|v12|, v3};
		var v13: array<array<bool>> := new array<bool>[10];
		var v14: C4 := new C4(v13, --v3, v10[167]);
		v14 := v14;
		var v15: array<int> := new int[5];
		v15[173] := |v6| - v3;
		v15[173] := ((if (|v7| in p2) then p2[|v7|] else |v12|) + v3) + v3;
		var v16: C2 := new C2(v12, v11[-v15[173]]);
		var v17 := DC56(v16);
		v16 := v17.cf95;
	} else {
		var v18 := 'r';
		...
		var v24: set<T1> := {v23};
		var v25 := DC28(|v24|, v22, v23.f4, v23.f4, |"tbi"| / v23.f6);
		v25 := v25;
		var v26 := "filnlnc";
		v26 := v26;
		var v27: seq<int> := [v23.f6, v22];
		var v28: multiset<bool> := multiset{p3};
		var v29: array<seq<int>> := new seq<int>[22] [v27, v27, v27, [|v26|], v27 + v27, v27[|v26| := v23.f6], v27 + v27, v27 + v27, v27, v27, [if (p1 in v28) then v28[p1] else v22], v27 + [v27[v23.f6], |v26|, v22, if (false in v28) then v28[false] else |p2|, v22], [v22, |v26|], [v23.f6] + v27, v27, v27, v27, v27, v27, v27, v27, fm57(v23.f6, v23.f6, globalState)];
		var v30: map<bool, int> := map[p1 := v22];
		var v31 := DC21(v30[p3 := v23.f6]);
		var v32: seq<D10> := [v31];
		var v33: seq<bool> := [fm0(v18, globalState), p3];
		r0, v29, v32, r1 := !v33[v22], v29, if (false) then v32 else v32[v23.f6 := v31], v23.fm7(globalState);
		...
		var v37: C1 := new C1(-(185 / (if ((if (0x374 in v35) then v35[0x374] else p1) in v28) then v28[if (0x374 in v35) then v35[0x374] else p1] else v22)), v22, if (p1) then v21 else v23.f5, |v36|, p2 < p2);
		v37, v27, v19 := v37, v27 + (seq(0x1dc, i0  => (-v23.f6))), v19;
	}
	...
	for i1 := v38 to fm3(v38, true, globalState) {
		...
		var v39: seq<int> := [v38];
		var v40 := "etegojdr";
		r0 := if (false) then p3 else v39 != v39[|v40| := i1];
	...
	v49 := v49 + v49;
	v38 := fm3(v38, p1, globalState) / v38;
	if (p1) {
		v48[171] := 946;
		v48[171] := -0x1cf;
		...
		var v51 := 'j';
		v50[838] := v51;
		v50[838], r0, r1, r0 := v51, fm0(v51, globalState) <== p1, v48[171], !!false <== p3;
		v50[838] := 'b';
		var v52: seq<bool> := [p1];
		var v53 := "bjpsw";
		var v54: set<seq<bool>> := {v52, ([false, p3])[|v53| := p3]};
		var v55 := DC24(p1, p3, v48[171]);
		var v56 := DC3(p1);
		...
		var v62: C9 := new C9(|(seq(544, i4  => (v50[838])))| + v48[171], v54, v59[v38], v48[171], (v61.(cf45 := true, cf44 := v38)).cf46);
		var v63: seq<int> := [v62.f7];
		var v64: seq<int> := [v48[171], v62.f7, -v62.f7, v62.f7, v63[0x153]];
		var v65 := DC20(p3, v50[838], v62.f7);
		var v66: array<int> := new int[13] [v38, |map[975 := false]| % v62.f7, v62.f7, v38, v62.f7, -v38, |(v63 + (seq(0x2d9, i5  => (v48[171]))))|, v48[171], fm3(v65.cf28, p3, globalState), v62.f7, v48[171], if (p1) then v38 else 0x2cb, v62.f7];
		v62, v48[171], v66, r0 := v62, fm3(v38, p3, globalState), v66, p1;
		var v67: C6 := new C6(p3, p3, v58, -356);
		var v68: set<C6> := {v67};
		var v69: map<set<C6>, bool> := map[v68 := p1];
		v48[171], v38, v48[171], r1 := v38 * fm3(v38, false, globalState), v38 - v48[171], v48[171] + (v62.f7 % v62.f7), (if (!p1) then |v69| else -v48[171]) + (v38 + v62.f7);
	} else {
		var v70 := 'g';
		var v71: map<char, int> := map[v70 := v38];
		var v72: seq<int> := [v38, v38, if (v70 in v71) then v71[v70] else v38, |(seq(0x21c, i6  => (v38)))|];
		var v73 := DC4(v38, v38);
		var v74: map<bool, int> := map[p3 := v38];
		var v75: set<int> := {|v72| / v38, v38, v73.cf4, if (p1 in v74) then v74[p1] else v38};
		...
		var v87: C9 := new C9(-|(seq(-613, i7  => (v70)))|, v86, v81, v82.f14, p1);
	...
	if (p3) {
		...
		var v93 := "hvok";
		var v94 := DC19(v93);
		var v95: T0 := new C2(seq(-0x153, i8  => ('o')), v92 in v94.cf25);
		v95, v38 := v95, -v38;
		...
		match (DC33(v95.f4, v38, v96 - v96, v38, fm53(v38, v98, globalState))) {
			case DC33(cf52, cf53, cf54, cf55, cf56) =>
				...
				var v102: C4 := new C4(v100, v101[|v101|], p3);
				v99[60] := v102;
				var v103: seq<bool> := [!p3];
				var v106: multiset<map<int, bool>> := multiset{map v104 : int | (438 <= v104) && (v104 < 0x187) :: (v104 / |v97|) := (p1), map v105 : int | (0x163 <= v105) && (v105 < 267) :: (v105 * v38) := (p1)};
				r1, r0, v92, v99[60] := cf53, v103[|v106|], if (v102.fm8(cf53, cf52, seq(0x107, i9  => (v92)), v101, globalState)) then v92 else 'p', v102;
			...
			case DC32(cf51) =>
				...
				r0 := v111[v38] > -(if (v95.f4) then fm3(v38, v95.f4, globalState) else v38);
	...
	var v128 := DC41(v38);
	var v129 := DC22(v125, p1, p3, v127[v38], v128.cf67);
	...
	r0 := |v129.cf30| >= |v134|;
	var v135 := 't';
	r1 := |(("ewmfdfes")[|(seq(0x2ca, i12  => ('r')))| := v135] + "nv")|;
}
trait T0 {
	const f4 : bool
...
class C1 extends T1 {
	...
	function fm6(p0: D0, p1: D0, p2: map<int, char>, p3: int, globalState: GlobalState): multiset<int> {
		if (f4 || true) then multiset(seq(0x2b, i0  => (f6))) * multiset{f6, 0x1d5} else multiset{f16} + multiset{f6}
	}
	function fm7(globalState: GlobalState): int {
		match DC3(!f4) {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		...
		match (if (v1 < multiset{f6}) then v2 else v2.(cf8 := false)) {
			case DC9(cf8, cf9, cf10) =>
				...
				if (-0x33c <= (|fm37(cf8, !cf10, p0, fm0(v3, globalState), globalState)| - cf9)) {
					...
					v4[500] := v5;
					var v6 := "tqnumrpc";
					v6 := (seq(435, i1  => (v6[|DC16(f4, f4, seq(0x236, i2  => (|{0x2dc, |map[cf9 := p0]|}|))).cf22|])))[0x342 := v3];
					var v7: seq<int> := [cf9];
					...
					var v12: map<map<int, bool>, int> := map[map v10 : int | v10 in multiset{f15} :: (v10 % p0) := (f4) := fm3(cf9, v11[cf9], globalState)];
					v12 := v12 + v12;
					var v13 := new C0(cf9);
					f16 := f15 / v13.f12;
					...
					var v16 := "tplcf";
					f16 := cf9 - |(fm37(cf10, f4, if (f4 in v15) then v15[f4] else 150, f4, globalState) + v16[f16 := v3])|;
				}
			...
			case DC10(cf11) =>
				if (f4) {
					...
					var v38: array<int> := new int[14] [f16, |(v32 + (map v33 : multiset<D9> | v33 in v34 :: (v33) := ([v26.f12, -0x267])))|, p0, cf11, f6, |v35| / p0, f6, if (fm8(f6, v35[fm3(0x82, false, globalState)], v27, v31, globalState)) then f6 else |v31|, f16, p0, f16, -(if (v36 in v37) then v37[v36] else |v35|), v26.f12, cf11 / p0];
					v38[159] := -0x156 / fm3(f6, f4, globalState);
					v38[159] := fm3(f6 - v26.f12, f4, globalState);
					...
					var v42 := true;
					var v43: multiset<bool> := multiset{v42, v42, {f4, f4, v42, fm8(v38[159], f4, v27, v31, globalState), v42} > v30};
					f16, v42, v0, v43 := v26.f12, false, set v44 : int | (0x2a9 <= v44) && (v44 < 893) :: (v44 * v26.f12), (multiset{f4, false})[false <== f4 := |v27| + v26.f12];
					var v45 := DC17(v0);
					var v46: set<string> := {seq(0x2c6, i4  => ('w'))};
					...
					cf11 := fm3(f6, f4, globalState) % (if (v48 in v49) then v49[v48] else f15);
					var v50: array<int> := new int[9];
					v50[442] := -|v0|;
					var v51: set<bool> := {f4};
					v50[442] := fm7(globalState) % -|map[p0 := v51]|;
					cf11 := v50[442];
					...
					v52[258] := if (!f4) then multiset{f4} else if (f4 in v54) then v54[f4] else v53;
					v52[258] := v53 - (multiset{f4} - v53);
				}
				...
				var v59 := m11(f4, !f4, (v57[f6])[v55 := cf11], v58, globalState);
				var v60: array<string> := new string[25](i6 => v55 + v55);
				v60[910] := v55;
				var v61: map<int, int> := map[f15 := cf11];
				var v62: map<int, map<int, int>> := map[-0x57 := v61];
				v60[910] := fm37(f4, f4, p0, f15 !in (if (p0 in v62) then v62[p0] else v61[fm9(f4, true, cf11, globalState) := f15]), globalState);
			...
			case DC8(cf7) =>
				...
				v70 := v70[!f4 := if (f4) then v68 else v71[f6]];
			case DC11(cf12) =>
				match (DC24(!f4, f4, f16 % -0x271)) {
					...
					case DC25(cf39, cf40) =>
						...
						var v82 := m11(fm37(cf39, f4, f6, false, globalState) < (seq(0x38a, i8  => ('c'))), fm0(v76, globalState), v77 + (map v78 : string | v78 in v80 :: (v78) := (|{f4, cf39, cf39}|)), v81, globalState);
						v79 := seq(0x32c, i10  => (v76));
						var v83: seq<int> := [f16];
						var v84: map<multiset<int>, string> := map[multiset(v83) := v79];
						var v85, v86 := m0(v84, "lcxrsang" <= v79, v1 * v1, v76 !in v79[p0 := v76], globalState);
					...
					case DC23(cf35) =>
						...
						v99[305] := v102[seq(252, i12  => ('h')) := v101];
						v99[305] := v102;
						...
						v104[205] := f4;
						v104[205] := f4 && f4;
						var v105: map<int, bool> := map[fm3(f15, f4, globalState) := v104[205]];
			...
			decreases 100 - i13
		{
			...
			v117, f16, v118[23] := v117 + [|v120|, 798], v114.f12, f6 * |v121|;
			var v122: array<bool> := new bool[10];
			v122[6] := if (f4) then true else f4;
			v118[23], v122[6] := -(f6 * v118[23]), f4;
		}
		var v123 := 'a';
		...
		f16, v134, v129[395], v135[693], v134 := v140.cf40, v134 <==> v134, v134, p0, f4;
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		match (v7) {
			case DC1() =>
				...
				if ((v10 * v10) == v10) {
					...
					var v18: map<bool, int> := map[!([v0] < v11) := (if (v12 in v17) then v17[v12] else v15[f16]) + 0x38b];
					...
					v0[299] := p0;
					var v22 := "shvveca";
					f16, f16, v8, v0[299], v8 := --|(v22 + v22)|, fm3(f15, v8, globalState), v8, v8, v8;
					var v23: array<multiset<bool>> := new multiset<bool>[5];
					var v24: map<char, bool> := map[v9 := f4];
					var v25: seq<array<multiset<bool>>> := [v23, v23];
					var v26: array<array<multiset<bool>>> := new array<multiset<bool>>[20] [v23, v23, if (if (v9 in v24) then v24[v9] else v0[299]) then v23 else v23, v23, v23, v23, v23, v23, v23, v25[f16], v23, v23, v23, v23, v23, v23, v23, v23, v23, v23];
					v26[525] := v23;
					v26[525] := v23;
					v22 := (v22 + v22) + v22;
				} else {
			...
			case DC2(cf1) =>
				...
				var v36 := "gx";
				var v37: map<array<bool>, int> := map[v35[|"htbf"|] := fm3(|v36|, p0, globalState)];
				...
				var v46: map<string, int> := map[v36 := |(seq(0x3e, i3  => (v38)))|];
				var v47 := DC3(p0);
				var v48: map<D1, int> := map[v47 := cf1];
				var v49: array<int> := new int[26] [f16 % |v36|, f6, -f15, |v6| % fm3(|v39|, v33, globalState), -cf1 % f16, 813, |v45|, f6, f16, 0xce, f15 * f6, -0x363, f16, f15 / --cf1, cf1 / 0x393, cf1, fm9(p0, p0, if ((seq(0x376, i4  => (v42))) in v46) then v46[seq(0x376, i4  => (v42))] else f16, globalState), |v6| / f16, cf1, f15, |v48|, |"eadjey"|, cf1, |v6| % |v36|, f15, if (v33 in v41) then v41[v33] else -0xde];
				v44[987] := cf1;
				var v50: seq<int> := [676, cf1];
				v33, v33, v37, v44[987], v6 := !(f4 <==> p0), f4, v37, (if (v33 in v41) then v41[v33] else 94) + (cf1 / |v50|), v6;
				v33, v36 := v33, v36;
				var v51: map<seq<array<bool>>, bool> := map[v35 := f4];
				var v52 := m11(if (v35 in v51) then v51[v35] else v33, v50 < (seq(-0x34c, i5  => (f6))), v46 + v46, v0, globalState);
				if (p0) {
					v33 := v6[|v36|];
					v0[513] := v33;
					v0[513] := v33;
					...
					v52 := 0x274 * -(-|v38| * v44[987]);
				} else {
					v44[987] := (cf1 % f15) % v50[f16];
					v0[413] := v6[f6];
					v0[413] := if (fm0(v42, globalState)) then !v33 else !true;
					var v53: multiset<bool> := multiset{v33, v33};
					var v54 := DC25(v0[413], f16);
					v0[413], v44[987], r0 := (v53 > multiset(v6)) in ([f4, p0] + [true, f4]), f15 * v54.cf40, v42;
					v52, v52, v49, v0[413] := -|(v38 + map[v44[987] := cf1])|, v44[987], v49, !!v33;
					v33 := v0[413];
				}
			...
			case DC0(cf0) =>
				...
				var v64: array<int> := new int[4] [-v55.f12, f15, v63[cf0], cf0];
				v57[78] := v55.f12;
				var v65: multiset<bool> := multiset{p0, v56};
				v56, cf0, v57[78] := if (v56) then v65 <= v65 else f4, if (p0) then f16 else f16, cf0;
				var v66: map<int, int> := map[cf0 := v57[78]];
				var v67: multiset<int> := multiset{cf0, -806, |v6|, if (f16 in v66) then v66[f16] else v55.f12};
				var v68 := DC14(v67);
				var v69: map<D5, map<int, int>> := map[v68 := DC30(map[v57[78] := f15]).cf49 + v66];
				v69 := v69;
				v57[78] := v57[78] + |v62|;
		}
		...
		var v70 := "uehfebb";
		var v71 := 'v';
		v0[243] := if (v70 < (seq(0x110, i6  => ('i')))) then v71 !in v70 else f4;
		var v73: multiset<int> := multiset{f6};
		for i7 := -|(map v72 : int | v72 in v73 :: (v72 + -|v73|) := (if (f6 in v73) then v73[f6] else f6))| to f16 - f16 {
			var v75: array<int> := new int[6](i8 => i8 * |[{0x388}, set v74 : int | (0x2e3 <= v74) && (v74 < 0x3a2) :: (v74 / f16), {f6, f15}]|);
			v75[117] := fm9(p0, f4, i7, globalState);
			v75[117] := f15;
			var v76 := new C0(v75[117]);
			var v77: multiset<bool> := multiset{p0, v0[243]};
			var v78: seq<multiset<bool>> := [v77, multiset{true, f4, f4, v0[243], f4} * v77];
			v78 := (v78 + fm45(p0, f15, v0[243], v76.f12, globalState)) + [v77];
			var v79 := DC3(fm8(779, v0[243], v70, seq(520, i9  => (v75[117])), globalState));
	...
	method m11(p0: bool, p1: bool, p2: map<string, int>, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		var v2: seq<bool> := [v1];
		var v3 := DC4(f15, f16);
		v1, f5[595], v1, v1, v1 := v2[f15 - f6], p3, p0, match v3.(cf3 := -0x3b4) {
			case DC4(cf3, cf4) => p1
			case DC3(cf2) => p0
		}, false;
		var v4 := 'd';
		...
		if (false) {
			...
			v12[401] := v11;
			var v13: map<int, int> := map[|[f16]| / fm9(f4, p1, f15, globalState) := f15];
			var v14: seq<array<array<bool>>> := [v11, v11, v11, v11];
			var v15: multiset<bool> := multiset{p0};
			v10, v12[401], v13 := v10, v14[if (!false in v15) then v15[!false] else f15], v13 + v13;
			f16 := fm7(globalState);
			if (f4) {
				...
				v18 := (v18 * multiset{f15})[-|v0| / f15 := f15];
				f5[595][253] := f4;
				...
				f16, r0, f5[595][253] := |v19|, v22.cf44, p0;
			...
			v27, v29, r0, v1, v1 := v27, (map[v28 := f4])[v28 := !f4] + (if (f15 in v30) then v30[f15] else v29), f6, fm8(f15 * v28.f12, v31[f6] <= v28.f12, v0, v31, globalState), p1 && p0;
			...
			var v39: seq<int> := [f16];
			var v40: seq<seq<int>> := [[v35.f12], v39, v39, seq(-0x3d6, i1  => (-v35.f12)), v39];
			v38 := v38[f6 := v40 != v40];
			var v41: array<int> := new int[17](i3 => i3 - f6);
			var v42: map<string, map<bool, array<int>>> := map["wirva" + (seq(-0x3e1, i2  => ('u'))) := map[p1 := v41]];
		...
		if (v45 == (v45 + v45[v4 := 220])) {
			...
			var v55: map<int, int> := map[f6 := v46[|v0|]];
			var v56: array<int> := new int[6] [|v0| + -f6, 0x18e, 0x3e, f16 % -|v48|, if (f6 in v55) then v55[f6] else f16, v54 * f16];
			v56, v53, f16, f16 := v56, p1, f16 + (|(seq(0x137, i4  => (|"csd"|)))| + |fm46(v4, globalState)|), if (v1 in v48) then v48[v1] else f6;
			if (f4) {
				...
				var v66: map<map<bool, bool>, int> := map[v64 + v64 := |v65[-f16]|];
				v66 := v66;
			...
			v68[489] := ([f15] + v71)[876 := |v72|] + [f16, f15];
...
class C2 extends T0 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		for i0 := fm7(globalState) to p0 {
			...
			if (f4) {
				...
				var v8 := 'p';
				var v9: set<set<int>> := {v6, v6 * {i0, |v7|, |f17[v4 := v8]|, |v7[v5 := -p0]|}};
				var v10 := DC26(v5);
				...
				var v15 := DC6();
				v9, v11, v12[838], v5, v5 := if (false) then v9 else v9 - v9, (v11 + v11) + ((map v13 : D11 | v13 in v14 :: (v13) := (f17)) + v11), v15, !f4 && (v1 >= v1), f4;
				...
				v20[217], v22, v23, v4, v23 := fm7(globalState), (fm49(f17, v24, v3, globalState))[|v25[v3]| := seq(345, i3  => (i0))] + [v21], true, -(v3 + -v1), f4;
				var v26: multiset<bool> := multiset{v23, v23, false};
				v20[217] := -(if (v23 in v26) then v26[v23] else v4);
				v2 := {!f4};
		...
		match (v30) {
			case DC22(cf30, cf31, cf32, cf33, cf34) =>
				cf34 := if (cf31) then cf34 / p0 else 0x239;
			...
			case DC21(cf29) =>
				...
				match (v38) {
					case DC6() =>
						...
						v29[751] := if (f4) then f4 else f4;
						var v43: array<int> := new int[16];
						v43[437] := p0 / p0;
						var v44: array<array<int>> := new array<int>[27];
						var v45 := true;
						v29[751], v43[437], v44, v45 := f4, p0, v44, !v45;
						var v46: array<bool> := new bool[14];
						v46 := v46;
						var v47: seq<bool> := [v29[751]];
						var v48: seq<int> := [|v47|, p0];
						var v49: multiset<bool> := multiset{false, v29[751]};
						var v50: map<int, int> := map[v48[|f17|] := if (v29[751]) then -p0 else |v49|];
						var v51: set<int> := {v43[437]};
						var v52: multiset<int> := multiset{|v51|, p0};
						v50 := v50[v43[437] := if (v45) then 0x1cc else |v52|];
					case DC7(cf6) =>
						var v53: seq<set<bool>> := [{f4, f4, !true}];
						v53 := v53;
						var v54: seq<bool> := [f4];
						var v55: seq<bool> := [if (f4) then v54[-cf6] else false];
						v55 := v54;
						...
						var v60: seq<int> := [|v59|];
						var v61: seq<int> := [325, cf6, p0, v60[cf6]];
						v57 := map[seq(228, i4  => ('d')) := v61[p0] * |(seq(761, i5  => ('x')))|];
						var v62 := false;
						var v63: array<int> := new int[22](i6 => i6 / cf6);
						var v64: map<int, int> := map[p0 := p0];
						v63[0] := |[cf6]| * (if (p0 in v64) then v64[p0] else cf6);
						v62, v63[0], v62 := v62, if (cf6 in v64) then v64[cf6] else p0, "hasb" < f17;
					case DC5(cf5) =>
						var v65: array<set<map<bool, bool>>> := new set<map<bool, bool>>[10];
						var v66: map<bool, bool> := map[f4 := f4];
						var v67: set<map<bool, bool>> := {v66};
						v65[210] := if (f4) then v67 else v67;
						var v68: multiset<bool> := multiset{f4};
						v65[210] := set v69 : map<bool, bool> | v69 in (map[v66 := multiset{false}])[v66 := v68] :: (v69);
						...
						v72[918] := p0;
						v72[918] := 0x34c;
						var v73 := new C0(v72[918] * v72[918]);
				...
				v77 := DC13(p0, true, -|f17|, v78[p0]).cf17;
				...
				if ((p0 <= p0) || (p0 >= p0)) {
					...
					v82.f16, v88, v88, v88, v89[575] := if (v29 in v92) then v92[v29] else (if (-v82.f16 in v93) then v93[-v82.f16] else v83[p0]) - v82.f15, v87.f12 != v87.f12, v88, v88, seq(-0x324, i7  => (v90));
					v90 := 'x';
				} else {
					var v94 := 297;
					v94 := p0;
			...
			decreases 100 - i8
		{
			...
			var v113: map<bool, bool> := map[f4 := v29[978]];
			...
			var v115: seq<bool> := [f17 <= f17, if (f4 in v113) then v113[f4] else v29[978], v29[978], f4];
			var v116 := DC26(v29[978]);
			var v117: multiset<bool> := multiset{f4};
			var v118 := DC33(v116.cf41, v111.f12, v117, p0, v114);
			var v119 := DC13(|([v118])[p0 := v118]|, v29[978], p0, v115);
			v115 := (v119.(cf17 := v115, cf14 := p0)).cf17 + v115;
			v29[978], v29[978] := v114 >= (if (f4) then v114 else v114), !f4;
		}
		var v120 := 906;
		v120 := v120 % v111.f12;
		v120 := |f17| + v120;
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		v2[878] := v1.(cf7 := v0);
		var v3 := 0xbb;
		var v4: array<int> := new int[9] [v3 % |([v3, v3])[0x198 := v3]|, v3, v3, v3, v3, v3 + 0x241, fm3(v3, f4, globalState), v3, -|f17|];
		...
		var v14 := new C1(|fm50(if (f4 in v8) then v8[f4] else v3, |(map v9 : int | (0x141 <= v9) && (v9 < 0x179) :: (v9 / |(map v10 : int | (72 <= v10) && (v10 < 693) :: (v10 - |"cii"|) := (f4))|) := (|f17|))|, v3, fm0(v11, globalState), globalState)|, v3, v12, fm3(|(map v13 : int | (0x19c <= v13) && (v13 < -0x2a4) :: (v13 * v3) := (p0))|, p0, globalState), p0);
		var v15: set<bool> := {p0, p0, p0};
		v15 := fm53(v3 % v3, fm54(v14.f16, globalState) + (seq(644, i1  => (map[false := p0]))), globalState);
		var i2 := 0;
	...
	method m12(p0: int, p1: set<bool>, p2: map<int, int>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		for i0 := |(p1 * {f4, f4})| to |[v0, v0, v0, v0]| {
			...
			v0[964] := if (v11 in v12) then v12[v11] else v11.f4;
			var v13: seq<bool> := [v11.f4, v11.f4];
			v9[170], r0, v0[985], v10, v0[964] := v0, fm7(globalState), !(if (v11.f4) then !false else v11.f4), 'k', if (v13[p0]) then f4 <== p3 else p3;
		...
		match (v26) {
			...
			case DC7(cf6) =>
				...
				var v31: map<multiset<int>, string> := map[v30 := seq(-304, i3  => (v16))];
				var v32: seq<bool> := [p3];
				...
				var v40 := DC16(false, p3, ([cf6])[|map[v35 := v38]| := |v39|]);
			...
			case DC5(cf5) =>
				...
				cf5, r0, r1 := v0, p0, v44[p0 % p0];
				var v45 := true;
				v45 := !f4;
				var v46: map<array<int>, bool> := map[v24 := !f4];
				var v47: map<bool, map<array<int>, bool>> := map[v45 := v46];
				v47 := v47[p3 := if (v45) then v46 else v46];
				var v48: map<string, bool> := map[(f17 + "x")[298 := v16] := multiset{p3} >= v43];
				v48 := v48[if (false) then "jpo" else ("qlx")[p0 := v16] := f4];
		}
		...
		if (f4 && p3) {
			...
			var v50: seq<int> := [if (v49[-|[v0[936], p3]|] in p2) then p2[v49[-|[v0[936], p3]|]] else p0, p0];
			v50 := v49[fm7(globalState) := p0];
			var v51: array<string> := new string[19];
			v51[893] := f17;
			var v52: seq<bool> := [!v0[936]];
			v51[893] := (if (v52[p0]) then f17 else "dehlggigm") + f17;
			var v53: array<char> := new char[15] [v16, v16, v16, v16, 'e', 's', v16, v16, v51[893][p0], 'g', fm1(p0, p3, globalState), v16, v16, fm1(p0, v0[936], globalState), v16];
			v53 := v53;
			var v54: array<bool> := new bool[2](i4 => p3);
			var v55: map<int, array<bool>> := map[p0 / 0x87 := v54];
			v55 := map[p0 := v54];
		} else {
			var v56 := false;
			var v57: seq<bool> := [f4];
			...
			var v61: multiset<bool> := multiset{v57[if (p3 in v60) then v60[p3] else p0], p3};
			...
			v63[906] := v62;
			r1, v0, v56, v63[906] := -p0, v0, !f4, v62;
			var v64: array<array<bool>> := new array<bool>[20];
			var v65 := new C1(v59[p0], p0 % p0, v64, |multiset{|v57|, 0x9}| / p0, p3);
			v56 := v56;
			v56 := v59[v65.f15 := p0] != (v59 + fm57(v65.f15, -v65.f16, globalState))[v65.f16 := v65.f16];
			v56 := v65.f16 <= v65.f16;
		}
...
class C3 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		var v0: array<int> := new int[22](i1 => i1 / p0);
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := i0 - p0;
		}
		...
		for i2 := p0 to p0 - |v5| {
			var v6 := "sj";
			var v7: map<multiset<int>, string> := map[multiset(seq(871, i3  => (p0))) := v6];
			...
			match (v12) {
				case DC17(cf23) =>
					var v13: map<int, seq<int>> := map[v11.f12 := seq(832, i5  => (p0))];
					var v14: array<seq<int>> := new seq<int>[28] [seq(0x366, i4  => (v11.f12)), v4 + v4, v4 + v4, v4 + v4[0x20b := v10], (if (v11.f12 in v13) then v13[v11.f12] else v4) + v4, v4, v4 + [i2, fm7(globalState)], v4, v4, if (f4) then v4 else [i2], v4, v4, v4, v4, v4, seq(0x182, i6  => (v10)), [-v11.f12], v4, fm36(true, globalState), [|v8|, -v10], v4, [i2, v11.f12, |v1|, v10], v4, v4[-i2 := |v6|], seq(0x279, i7  => (|[f4, false]|)), (seq(0x210, i8  => (p0))) + [-466], fm36(fm8(|multiset{v9, f4, v9}|, false, v6, v4, globalState), globalState), v4];
					v14[161] := v4;
					v14[161] := v4;
					v10 := v11.f12;
					var v15: seq<string> := [v6];
					var v16: seq<string> := [v6, v15[f6], v6];
					var v17 := DC10(|v16[|[v10]|]|);
					v17 := v17;
					v9 := v9;
			}
		...
		match (DC2(-988)) {
			...
			case DC2(cf1) =>
				...
				cf1 := (if (v5 in v24) then v24[v5] else cf1) / f6;
				...
				match (v26) {
					...
					case DC21(cf29) =>
						...
						cf1, cf1, cf1, v0[483] := |map[if (f6 in v34) then v34[f6] else v33 := map[v35 := v36]]|, if (|v38| in v37) then v37[|v38|] else cf1, if ((v37 * v37) in v39) then v39[v37 * v37] else p0, cf1;
						var v40: map<int, string> := map[-194 / 0x155 := "mou"];
						v40 := v40[v0[483] := seq(0x46, i10  => (v35))];
						...
						v41 := v41[v0[483] <= (if (cf1 in v43) then v43[cf1] else |v44|) := v35];
				}
				...
				match (v3) {
					...
					case DC15(cf19) =>
						cf1 := -(fm9(v19, true, f6, globalState) % (if (f4 in v25) then v25[f4] else p0));
			...
			case DC0(cf0) =>
				...
				var v71, v72 := m0(v70 + v70, f4, multiset(v4 + (seq(68, i11  => (|map[v69 := 'i']|)))), !v19, globalState);
				if (false) {
					v71 := v19;
					v0 := v0;
					var v74 := new C1(-v72, v4[f6], f5, |(v5 + (set v73 : int | (0x30b <= v73) && (v73 < -0x1e9) :: (v73 - p0)))|, v72 > v72);
					v19 := f4;
				...
				var v86: array<set<int>> := new set<int>[6] [v5, set v83 : int | v83 in v4 :: (v83 / |(seq(-0x3a4, i12  => ('v')))|), v5, if (v71) then v5 else set v84 : int | v84 in v4 :: (v84 / --0xdf), v5, fm35(|v85|, globalState)];
				v86[869] := v5;
				var v87: multiset<int> := multiset{p0};
				v86[869] := v5 * {if (f6 in v87) then v87[f6] else f6, p0, f6, cf0, p0};
		}
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		v1[699] := f6;
		v1[699] := f6;
		var v2: map<int, array<int>> := map[v1[699] := v1];
		var v3: map<int, array<int>> := map[442 := if (f6 in v2) then v2[f6] else v1];
		var v4 := "ivk";
		var v5: seq<array<int>> := [v1, v1, v1, v1];
		var v6: array<array<int>> := new array<int>[24] [v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, if (!f4) then v1 else v1, v1, v1, if (f4) then v1 else v1, if (|v4| in v3) then v3[|v4|] else v1, v1, v1, v1, v1, v1, v5[v1[699]], v1];
		v6[463] := v1;
		var v7 := DC7(|fm37(p0, f4, f6, p0, globalState)|);
		var v8: multiset<D2> := multiset{v7, v7};
		var v9: set<bool> := {p0, p0};
		var v10: map<bool, bool> := map[|v8| == v1[699] := |v9| != v1[699]];
		var v11 := true;
		var v12 := DC32(v1);
		var v13: map<array<int>, array<int>> := map[v1 := v12.cf51];
		v6[463], v1[699], v10, v11 := if (v1 in v13) then v13[v1] else v1, f6, v10 + (v10 + v10), f4 ==> f4;
		var v14: array<array<char>> := new array<char>[18];
		var v15: seq<bool> := [f4];
		var v16: map<bool, int> := map[f4 := v1[699]];
		var v17: seq<map<bool, int>> := [v16, map[p0 := -v1[699]], v16];
		v1[699], v1[699], v11, v11, v14 := v1[699], |(if (f4) then v15 + v15 else v15 + v15)|, v16 !in (v17 + v17), v11, v14;
		var v18: T0 := new C2(seq(587, i0  => ('f')), p0);
		...
		v1[699] := |v21| - |(seq(-0x2bd, i1  => ('u')))|;
		var v22: array<string> := new string[14](i2 => "q" + "fag");
		var v23: seq<string> := [v4, seq(0x333, i3  => ('h'))];
		var v24 := 'f';
		v22[290] := (v23[f6])[f6 := v24] + "nusipv";
		v22[290] := seq(0, i4  => ('k'));
		if (fm0(v24, globalState)) {
			...
			var v29 := DC35(v28);
			var v30: seq<int> := [|(seq(0x1c3, i5  => (v24)))|, v1[699]];
			var v31: seq<int> := [v30[v1[699]]];
			var v32: map<int, map<bool, bool>> := map[|v30| := v10];
			var v33: seq<map<int, map<bool, bool>>> := [v32, v32];
			var v34 := new C1(-|v29.cf58|, |v33[|{v11}|]|, f5, v31[v1[699]] - v18.fm7(globalState), true);
			...
			var v37: set<string> := {v22[290]};
			v36[815] := v37 > v37;
			v1[699], v11, v36[815] := f6 % (v1[699] * v34.f16), p0, v18.f4;
			v11 := !DC28(fm3(|(v15[v1[699] := !p0])[v34.f16 := v36[815]]|, f4, globalState), v34.f16, v18.f4, v36[815], f6).cf46;
		} else {
			v1[699] := f6;
			v1[699] := f6;
			v11 := true;
			var v38: C2 := new C2(v22[290], v11);
			var v39: multiset<C2> := multiset{v38, v38, v38};
			var v40: array<bool> := new bool[10] [v38 !in v39[v38 := f6], true, fm0(v24, globalState), if (v18.f4) then v11 else true, v9 != v9, v0 == v0, f6 > f6, v11, f4, v18.f4];
			v40[580] := v11;
			v40[580] := v18.f4;
			var v41 := new C1(v1[699], 0x326, f5, f6 * f6, v11);
		}
	...
	method m9(p0: bool, globalState: GlobalState) returns (r0: bool) {
		r0 := !p0;
		var v0: array<string> := new seq<char>[22](i0 => (seq(773, i1  => ('p'))) + "uqvrar");
		v0[721] := "t";
		var v1 := "w";
		v0[721] := fm37(!f4, f4, |v1|, f4, globalState) + v1;
		var v2 := 'v';
		v0[721] := v1[-f6 := v2];
		...
		if (!f4) {
			...
			v5 := if (f4 in v6) then v6[f4] else v7[v4.f15];
			var v8 := new C2(v1, p0);
			v4.f16 := v4.f15;
			var v9: map<int, bool> := map[v4.f15 := f4];
			v9 := map[v4.f15 := f4] + map[v4.f15 := p0];
			var v10 := DC22(seq(0x317, i3  => (v2)), false, f4, v5, 0xb8);
			var v11 := DC4(v10.cf34, |"lroyicek"| - 0x1c7);
			v11 := v11;
		} else {
			r0 := "vtossvsa" < (v0[721] + v0[721]);
			r0 := (if (f4) then v4.f16 else f6) >= |v0[721]|;
			var v12: array<char> := new char[2] [v2, v2];
			var v13: map<bool, array<char>> := map[p0 := v12];
			var v14: seq<array<char>> := [v12];
			var v15: array<array<char>> := new array<char>[8] [v12, v12, v12, v12, v12, if (p0 in v13) then v13[p0] else v14[-v4.f15], v12, v12];
			v15[472] := v12;
			var v16: multiset<int> := multiset{v4.f16};
			v0[721], v4.f16, v15[472] := ("bsbsmmac" + "ps") + v0[721], if (v4.f16 in v16) then v16[v4.f16] else v4.f15, v12;
			...
			v19[373] := v18;
			v19[373] := if (f4) then v18 else v18;
			if (true) {
				...
				r0, v15[472], v20[655], v16 := v24 == v24, v12, v21, v16;
				...
				var v29: map<string, int> := map[seq(4, i6  => (v2)) := 0x133];
				var v30: map<bool, map<string, int>> := map[f4 := v29];
				var v31: array<bool> := new bool[16](i7 => true);
				var v32 := v4.m11(p0, p0, if (p0 in v30) then v30[p0] else map[v0[721] := v4.f16], v31, globalState);
				...
				var v36 := DC27(v35);
				v36 := v36.(cf42 := v35[|v1| := v35[v4.f16]]).(cf42 := v35);
				f5[533] := v31;
				f5[533] := v31;
				var v37: map<bool, array<bool>> := map[f4 := v31];
				var v38: map<char, array<bool>> := map[v2 := if (f4 in v37) then v37[f4] else f5[533]];
				var v39 := DC37(v38);
				r0, v38 := f4, v39.cf62;
	...
	method m10(p0: multiset<int>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: bool) {
		...
		for i1 := f6 to -0x16d {
			...
			match (v1) {
				...
				case DC32(cf51) =>
					...
					var v10: set<set<D0>> := {v7, v7, set v9 : D0 | v9 in [fm38(|(v8[f4 := i1])[f4 := i1]|, i1, p1, f6, globalState)] :: (v9)};
					var v11: multiset<int> := multiset{|({v7} - v10)|};
					v5[287], v11, r1 := f4 ==> f4, v11, |[|"skjggxj"|]|;
					v5[287] := v5[287] && (v5[287] <==> false);
		...
		if (f4) {
			...
			match (v18) {
				case DC9(cf8, cf9, cf10) =>
					...
					var v31 := DC27(v30[|v29| := v29]);
					var v32: map<bool, D12> := map[f4 := v31];
					v26[776] := if (v18 in v27) then v27[v18] else v32;
					var v33 := DC40(v32);
					v26[776] := v32 + (v32 + DC40(v33.cf66).cf66);
					var v34: map<int, bool> := map[v25 := cf10];
					var v35 := new C1(|v34| + cf9, |v19| % v25, f5, f6, v24);
				case DC10(cf11) =>
					r1 := 0x1eb;
					var v36 := "fvlmlhsge";
					r2 := |(v36 + v36)|;
					var v37 := new C1(f6, 0x2f1 % f6, f5, f6 % f6, f4);
					v0 := v0;
				case DC8(cf7) =>
					var v38 := 'e';
				...
				case DC11(cf12) =>
					...
					v48 := seq(0x388, i3  => (|([p1] + [f4, f4])|));
					var v49 := "bwcahcko";
					var v50 := 'h';
					var v51 := DC19(v49);
					v49 := (if (f4) then "ylnncpc" else v49)[f6 := v50] + v51.cf25;
					var v52 := DC28(f6, -f6, f4, p1, |(if (f4) then "iunuhhphg" else seq(651, i4  => (v50)))|);
		...
		for i5 := f6 - |v64| to f6 {
			...
			match (DC28(f6, |p0[i5 := |v66|]|, p1, true, i5).(cf43 := f6).(cf47 := |v64|)) {
				case DC28(cf43, cf44, cf45, cf46, cf47) =>
					...
					var v71: multiset<map<int, bool>> := multiset{if (cf45) then v69 else v69, map v70 : int | (0x1a0 <= v70) && (v70 < -0x1c0) :: (v70 % f6) := (cf46), v69};
					v71 := v71;
				case DC27(cf42) =>
					r3 := (|v64| <= f6) ==> f4;
					r1 := i5;
		...
		var v76: seq<int> := [f6];
		v76 := if (p1) then [-0x377, f6, f6, f6, f6] else seq(0x383, i6  => (f6));
...
class C4 extends T1, T0 {
	...
	function fm6(p0: D0, p1: D0, p2: map<int, char>, p3: int, globalState: GlobalState): multiset<int> {
		multiset{117 % 0x34a, if (f4) then f6 else f6, f6, f6 / f6, f6}
	}
	function fm7(globalState: GlobalState): int {
		|(match DC19("sxfde") {
			case DC20(cf26, cf27, cf28) => "uaimtxsem" + (seq(0x2e8, i0  => (cf27)))
			case DC19(cf25) => cf25
		})|
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		...
		var v11: array<int> := new int[22] [-0x32b, p0, |(seq(-0x1dc, i1  => (v5)))|, f6, f6, f6, |v7|, f6, f6, v3, |[p0, p0, -v3, f6]|, f6, p0, f6, |"ejh"|, fm3(v3, f4, globalState), v3, v3, if (map[v2 := f4] in v9) then v9[map[v2 := f4]] else |(map v10 : int | (374 <= v10) && (v10 < 0x132) :: (v10 - f6) := (|map[|multiset(v6)| := f4]|))|, p0, v3, f6];
		var v12: seq<array<int>> := [v11];
		var v13: multiset<array<int>> := multiset{v11, v12[v3]};
		var v14: multiset<multiset<array<int>>> := multiset{v13, v13 - v13[v11 := p0]};
		v4[290], v3, v3, v6 := v5, f6, if ((v13 + v13) in v14) then v14[v13 + v13] else if (v2) then v3 else p0, v6;
		var v15 := new C0(v3 / |v6|);
		...
		for i2 := -659 to -(v15.f12 - 281) {
			...
			v26 := v26[v23 := p0 % v15.f12];
			v11[911] := |v7|;
			var v27: seq<bool> := [f4, v2, v2, v2];
			v11[911] := |(v27[|v27| := f4] + v27)|;
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		for i1 := f6 to |v3| {
			...
			match (v6) {
				case DC13(cf14, cf15, cf16, cf17) =>
					...
					var v16: array<D0> := new D0[21] [v12, v12, DC2(cf16).(cf1 := |v5|), v12, v12, v12, v12, DC2(0x123).(cf1 := cf16), DC2(0x1af), v12.(cf1 := cf16), v12, v12, v12.(cf1 := v1[991]), v12, v12, DC2(|v15|), v12, DC2(i1), v12, v12, DC2(v8.f12)];
				...
				case DC12(cf13) =>
					...
					v18 := |(map v19 : int | (0x1bf <= v19) && (v19 < -0x11a) :: (v19 / 0x250) := (i1))| / (|v21| / f6);
			...
			var v27: seq<seq<int>> := [v4, seq(0x3d4, i3  => (i1))];
		...
		v1[485] := f6 * f6;
		var v35 := 0x3d2;
		var v36: map<int, bool> := map[v4[v35] := v34];
		var v37: map<seq<bool>, map<int, bool>> := map[[f4] := v36];
		var v38: seq<multiset<int>> := [multiset{f6}];
		var v39: multiset<bool> := multiset{p0};
		v34, v1[485], v35, v34, v34 := v37 != fm60(|v38|, f6, v35, globalState), v35, |v39| / v35, !!v34, f4;
		var v40: array<D12> := new D12[28](i4 => DC27([[false], [p0]]));
		var v41: set<bool> := {f4, f4};
		var v42 := DC27(fm61(v41, globalState));
		v40[785] := v42;
		v35, v40[785] := v35, v42;
		var v43: C1 := new C1(v35, v1[485] % v35, f5, f6, fm8(f6, f4, seq(0x236, i5  => ('g')), seq(-0x214, i6  => (v35)), globalState));
		var v44 := 'f';
		var v45 := DC20(f4, v44, v43.f16);
		var v46: seq<D9> := [v45];
		v43, v34, v34, v1[485] := if ((if (v1[485] in v0) then v0[v1[485]] else v1[485]) <= v1[485]) then v43 else v43, p0, p0, -match DC34(v46) {
...
class C5 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		...
		var v11 := "trc";
		var v12: array<int> := new int[1](i0 => i0 % f6);
		var v13: map<bool, array<int>> := map[f4 := v12];
		var v14: array<int> := new int[20] [f14, -f14, |[0x3b, v7.f12, v7.f12]|, f14 - f14, v7.f12, f6, p0, f6, |map[|multiset(v8)| := v7.f12]|, f6, f14, v7.f12, |v9|, |(set v10 : int | (0xfd <= v10) && (v10 < -0x123) :: (v10 * v7.f12))|, f6 - |v11|, |v13|, f6, 438 % f14, f6, v7.f12];
		v12[396] := f14;
		var v15 := DC21(fm28(globalState));
		var v16: seq<seq<set<bool>>> := [v3, v3];
		v12[396], v4, v3 := if (f13) then v7.f12 else v7.f12, v15.cf29, if (f14 != 0x209) then [v2] else v16[v7.f12];
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		for i1 := f6 - f6 to 0x1f0 {
			if (false && !p0) {
				...
				var v15: map<int, int> := map[|v14| := |(seq(218, i3  => (v13.f12)))|];
				v15 := v15[|(map v16 : int | (0x1bc <= v16) && (v16 < 0x203) :: (v16 * v7.f12) := (|multiset{0x262, f14}|))| := |[|(seq(0x52, i4  => (v3)))[|map[f6 := 0x21d]| := v3]|]|];
				var v17: array<int> := new int[6](i5 => i5 / v7.f12);
				v17[99] := 0x28 * f14;
			...
			if (v5) {
				...
				v27[225] := fm8(f14, p0, v1, [f14], globalState);
				var v28 := DC22(v1, p0, f13, v27, i1);
				v24, v25[656], v27[225], v27 := fm62(globalState), if (v28.cf31) then v8 else 'd', p0 <==> (i1 == v7.f12), v27;
				v27[225], v5 := p0, v6 >= (if (v5) then 909 else |v1|);
				v5 := p0;
			}
		...
		match (v33) {
			...
			case DC27(cf42) =>
				...
				var v49: array<bool> := new bool[9] [!f13, v5, fm53(v6, (seq(0x16, i9  => (map[v5 := f13])))[v7.f12 := (map[f13 := v5])[p0 := f13]], globalState) <= v48, if (p0) then f4 else fm0(v8, globalState), v31 <= v31, f13, f4, f13, false];
				v49[379] := true;
				...
				var v54 := DC35(v53);
				v50[848] := v54;
				v49[379], v50[848] := (fm37(p0, f13, v6, f13, globalState) + v1) <= v1, v54;
				var v55 := DC28(f6, v7.f12, p0, true, v6);
				f14, v5 := f6 % (if (!v5) then v6 else v6), {f13, true, v55.cf45, f4, false} >= (v48 * v48);
...
class C6 extends T0, T1 {
	...
	function fm7(globalState: GlobalState): int {
		(f6 * |multiset{|map[f11 := f6]|, f6}|) * (f6 / |map[!false := "hkuc"]|)
	}
	function fm8(p0: int, p1: bool, p2: seq<char>, p3: seq<int>, globalState: GlobalState): bool {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		...
		var v2 := DC6();
		var v3 := DC3(f11);
		var v4: array<map<bool, string>> := new map<bool, string>[17] [map[!f11 := v0], map[f11 := v0], v1, map[f11 := (fm16(f4, f4, f11, v2, globalState))[f6 := 'l']], v1, v1, v1, v1, if (v3.cf2) then v1 else map[f11 := "jwkwygjor"], v1 + v1, v1 + v1, v1, v1, v1, v1, v1, v1];
		v4[480] := v1 + v1;
		v4[480] := v1;
		for i0 := p0 to fm7(globalState) {
			...
			if (v9 !! v9) {
				...
				v19 := v18.f12 * -v19;
				var v22 := true;
				v5[426] := fm3(v19, v22, globalState) + v19;
				v5[914] := if (f4 in v8) then v8[f4] else i0;
				var v23 := DC7(v18.f12);
				v22, v5[426], v5[914], v19, v22 := v22, -(v18.f12 - (|fm16(f4, v22, f11, v2, globalState)| + p0)), p0 * v23.cf6, f6, v3.cf2;
				v19 := |v9|;
			}
		...
		if ((f6 + f6) == (p0 * (if (f4 in v32) then v32[f4] else |v33|))) {
			...
			var v37 := new C0(|v36|);
			var v38: array<string> := new string[28](i4 => (v0 + v0)[v34[0xef] := 'j']);
			v38[734] := v0;
			var v39 := 's';
			v38[734] := v0 + (v0 + v0[f6 := v39]);
			var v40: set<int> := {p0};
			...
			v43 := v43[seq(0x35f, i5  => (v39)) := |fm18(v0, |v45|, globalState)|];
		} else {
			var v46 := 0x25a;
			var v47 := 'j';
			...
			if (f4) {
				...
				var v55: array<seq<bool>> := new seq<bool>[19] [v53, [f4], fm19(f11, fm3(-|map[v47 := v54]|, f11, globalState), globalState), v53, v53, v53, v53, v53, if (f4) then v53 else v53, v53, v53, (v53[v46 := true])[f6 := false], v53 + v53, v53, v53, v53, v53, v53, v53];
				v55[737] := DC13(f6, f11, v46, v53).cf17 + v53;
				v52, v46, v46, v55[737] := v52, p0, -0x31a, v53;
				var v56 := DC10(p0);
				var v57 := DC11(v56);
				...
				v60 := v60[v57 := v59];
				var v61: multiset<int> := multiset{if (f4) then -0x85 else p0, v46, |(seq(-0x150, i7  => ('j')))|, p0};
				...
				v54[300] := if (f4) then fm3(if (v46 in v62) then v62[v46] else v46, f4, globalState) else |v64[|v0|]|;
				v54[300] := if (f11) then p0 else |DC8((fm20(f6, f4, globalState)).cf7).cf7|;
			}
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		...
		var v1: seq<bool> := [v0[f6], p0, f4];
		var v2 := DC8(v0[f6 := f11]);
		match (v2) {
			case DC9(cf8, cf9, cf10) =>
				...
				var v7 := "rmjgkq";
				cf9, v3, cf9, cf9, v4[874] := fm9(cf10, f11, cf9, globalState), v5[if (v4 in v6) then v6[v4] else |v7|], -(|v7| + (fm9(true, f11, cf9, globalState) % f6)), if (p0) then |v7| else cf9, cf10;
				if (f4) {
					cf10 := false;
					f5[333] := v4;
					f5[333] := DC5(v4).cf5;
					...
					v9[515] := v8;
					cf9 := cf9 % f6;
					var v10: map<bool, bool> := map[true := v4[874]];
					var v11: seq<map<bool, bool>> := [v10[cf10 := cf8]];
					v10 := v11[f6] + v10;
				} else {
					var v12: map<bool, int> := map[!v1[cf9] := f6];
					var v13 := new C0(if (cf10 in v12) then v12[cf10] else f6);
					var v14 := DC7(f6 % 0x1b1);
					...
					v14 := if ({f6} !in v16[v15 := v13.f12]) then DC7(|v18|) else v14;
					var v19 := 's';
					r0 := v19;
					cf10 := f4;
					cf9 := cf9;
				...
				var v20 := new C0(|v0| / f6);
				v4[874] := v20.fm17(p0, globalState);
			case DC10(cf11) =>
				var v21: map<int, bool> := map[0x89 % cf11 := if (f11) then f11 else p0];
				v21 := v21[cf11 := f11];
				var v22 := false;
			...
			case DC8(cf7) =>
				...
				v28[538] := |(fm21(--f6, v32, 0xc1, f6, globalState) - v35)|;
				var v36 := new C0(-(v28[538] - v28[538]));
				var v37: array<bool> := new bool[27];
				v37[189] := f4 || f11;
				v37[189] := !v0[0xaf + v28[538]];
				var v38 := DC13(v28[538], f11, |v34|, v1);
				var v39: set<bool> := {v38.cf15, p0, f4};
				v37[189], v28[538], v28[538] := v1[|(v39 + v39)|], if (if (p0) then f4 else p0) then f6 else v36.f12, v30[f6];
			case DC11(cf12) =>
				var v40: array<int> := new int[19](i1 => i1 % f6);
				v40[30] := 0x101;
				v40[30] := f6;
				v40[30] := f6;
				var v41 := false;
				...
				v42[420] := v45 >= v45;
				v41, v40[30], v42[420], v40[30] := true, v40[30], f11, v40[30] % (if (f11) then f6 else v40[30]);
				if (true) {
					var v46 := DC2(|[{f6, f6}]|);
					var v47: multiset<int> := multiset{v40[30], v46.cf1};
					var v48 := DC9(f11, |v47|, f11);
					var v49: seq<int> := [v48.cf9, v40[30]];
					var v50, v51 := m0(fm22(globalState), p0 <==> f4, multiset(v49) * v47, v41, globalState);
					var v52: map<int, int> := map[v40[30] + v51 := 0xc8];
					v52 := v52[fm3(v51, v41, globalState) := v49[-562]];
					var v53 := "owcvyfr";
					var v54: map<int, seq<bool>> := map[|v53| * v51 := v0];
					v54 := v54[v51 := [v42[420], f11, f11, p0]];
					var v55 := 'd';
					v42[420] := fm0(v55, globalState);
					var v56: set<bool> := {v42[420]};
					...
					var v61 := "wgpjpb";
					var v62: map<int, multiset<map<int, bool>>> := map[f6 := v59 + multiset{v58, v58, v58, v60[|v61|], v58}];
					v62 := v62[v40[30] := v59];
					v40[30] := f6 - f6;
					v42[420] := 0x323 >= (fm9(p0, p0, fm15(globalState), globalState) * (if (p0 in v43) then v43[p0] else f6));
					var v63 := 'e';
					r0 := v63;
				}
		...
		for i4 := f6 to f6 % f6 {
			...
			match (v71) {
				case DC6() =>
					var v72, v73, v74 := m8(f6 % v70, v70, globalState);
					var v75 := 'j';
					var v76 := "ftxvovkv";
					var v77 := DC0(|v76|);
				...
				case DC7(cf6) =>
					...
					var v89: map<seq<array<bool>>, seq<map<char, int>>> := map[[v83] := [v85, v85] + v88[cf6 := map[fm1(fm3(cf6, f11, globalState), f11, globalState) := -f6]]];
					var v90: seq<array<bool>> := [v83, v83, v83];
					var v91: seq<array<bool>> := [v83, v83, v90[-553], DC5(v83).cf5, v83];
					v89 := v89[v90 := seq(707, i6  => (v85))];
				...
				case DC5(cf5) =>
					...
					var v101 := "adljl";
					var v102: set<string> := {if (v0[v70]) then v101 else v101};
					v102 := v102;
		...
		if (fm0(v108, globalState)) {
			...
			var v118: array<multiset<seq<bool>>> := new multiset<seq<bool>>[22] [v115, multiset{v1, v0, [f11], v0}, v115, v115, multiset{v1}, v115, v115, multiset{v1, [f11, true], v0, v0}, if (v116.cf2) then multiset(seq(0x92, i8  => (v0))) else fm24(v109, v108, v109, globalState), v115, v115 * multiset(v117), v115, v115 * v115, v115, v115 * v115, multiset{[f4]} * v115, v115, v115, v115, v115, v115, v115];
			var v119: map<bool, seq<seq<bool>>> := map[v111 := [v1]];
			var v120 := DC15(v115);
			v118[270] := multiset(if (p0 in v119) then v119[p0] else v117) + v120.cf19;
			var v121: seq<int> := [v109, -v109];
			var v122: multiset<seq<int>> := multiset{v121};
			var v123: array<seq<bool>> := new seq<bool>[1];
			v118[270], v122, v123, v111 := v115[[false] := f6], v122, v123, f11;
			v109 := 313 / v109;
		} else {
			var v124 := DC10(f6);
			v124 := DC10(f6);
			var v125 := 0xd8;
			v125 := if (p0) then if (-103 in v69) then v69[-103] else v125 else |(v0[v125 := fm0(v108, globalState)])[0x3b4 := true]|;
			match (DC8(v0)) {
				case DC9(cf8, cf9, cf10) =>
					var v126: multiset<int> := multiset{|(seq(0x2a4, i9  => (v108)))|, |{f11, !f4, cf8}|, |fm25(cf9, f6, f4, f11, globalState)|, v125};
					var v127: seq<multiset<int>> := [v126];
					var v128: seq<int> := [cf9, f6, v125];
					v126 := v127[|(map[v125 := v128])[f6 := seq(0x327, i10  => (cf9))]|];
					...
					v124, v130, cf9, v131[258], v133 := v124, v130, --(-(0x215 / cf9) + (if (cf10) then cf9 else -614)), v132, v133;
					v125 := --cf9;
				case DC10(cf11) =>
				...
				case DC8(cf7) =>
					...
					var v143 := "sxv";
					var v144 := DC13(-v125, v141 !in v142, -|v143| % f6, v0);
					var v145 := false;
					var v146: seq<int> := [f6, v125];
					v125, v144, v125, v145 := f6 + f6, fm63(globalState), v146[v125], f4;
					var v147: multiset<bool> := multiset{f11};
					v145 := !f11 <==> (v147 > v147);
					var v148: map<char, string> := map[v108 := v143 + v143];
					v148 := v148;
					var v150: array<multiset<set<int>>> := new multiset<set<int>>[11](i14 => multiset{set v149 : int | (0x210 <= v149) && (v149 < 26) :: (v149 / v125), {f6}});
					...
					v150[763] := v153[v154[|v143|] - v152 := -(|v146| % v125)];
				case DC11(cf12) =>
					...
					v156 := v156 + (v156 + (multiset{v155})[v155 := fm3(v125, p0, globalState)]);
					v108 := v108;
					v155 := v155;
			}
	...
	method m7(globalState: GlobalState) {
		...
		v1 := |v7[if (f4) then f6 else f6]|;
		var v8: array<bool> := new bool[14];
		v8 := v8;
		var v9 := new C4(f5, v1, f4);
		v1, v0 := v1 / f6, |(if (v0) then v4 else v4[f6 := f11])| != v1;
	...
	method m8(p0: int, p1: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: D1) {
		...
		if (f11) {
			...
			var v14, v15 := m0(map[v10 := seq(0x241, i1  => (v0))], f4, fm6(v11, v11, v12, p1, globalState) + v10, false ==> (if (f11 in v13) then v13[f11] else f4), globalState);
			var v16 := "wwdadof";
			var v17: map<int, string> := map[v15 := v16];
			var v18 := DC6();
			v17 := v17[p1 / 0x1ba := (fm16(v14, f11, false, v18, globalState))[p1 := v0] + v16];
			var v19: array<array<bool>> := new array<bool>[2] [f5[951], v1];
			var v20 := DC31(v19);
...
class C7 extends T1 {
	...
	function fm8(p0: int, p1: bool, p2: seq<char>, p3: seq<int>, globalState: GlobalState): bool {
		if (if (f4) then f4 else f4) then (seq(0x31f, i0  => ('i'))) <= ['h'] else f6 == -f6
	}
	function fm9(p0: bool, p1: bool, p2: int, globalState: GlobalState): int {
		f6
	}
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
		...
		match (DC13(0xc2, !f4, f6 - v0.f16, v1)) {
			...
			case DC12(cf13) =>
				...
				v6[126], v8, v10, v18 := v7, (f4 || true) && (v0.f15 != v0.f16), v10, v18;
				v0.f16 := v0.f16;
				v0.f16, v0.f16, v5[382] := (0x3dd / v0.f15) - |"cfu"|, 0xc4, -v0.f16;
		}
		...
		var v22: multiset<int> := multiset{|v21[-p0]|, v0.f16, p0};
		...
		f10[270] := v25 != |(v27 * v27)|;
		var v28 := "lvmi";
		var v29: map<bool, bool> := map[false := f10[270]];
		var v30: seq<int> := [f6, |v1|];
		var v31: seq<int> := [v0.f16, |v30|];
		var v32: array<int> := new int[14] [fm7(globalState), v0.f15, |v28| % v0.f15, |v29|, f6, v25 % |v1|, f6 * p0, 0x22 / 0x247, |v31| / 967, v0.f16, v0.f15, v0.f16, v25, v0.f15];
		var v33: map<int, bool> := map[0x1e := f10[270]];
		...
		var v40 := DC33(if (v0.f16 in v33) then v33[v0.f16] else f10[270], v37.fm7(globalState), multiset{f10[270]}, |v22|, v39);
		var v41 := DC33(fm14(v33, f10[270], v0.f15, v35.cf32, globalState), -((if (v0.f16 in v19) then v19[v0.f16] else |v22|) + 0x1af), v36[v24 := |v38|] * v36, -(v0.f16 * v0.f16), {v24, v24, true, !v24, !v40.cf52});
		v0.f16, v25, v32, v40, f10[270] := 0x9a, 0x34a, v32, v40, f10[270];
		v0.f16, f10[270] := p0, if (v25 == v0.f16) then false else false;
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
			...
			decreases 100 - i0
		{
			...
			v4[251], v5, v0, v6[294], v8 := v1, true in v9, |(if (f10 in v11) then v11[f10] else v10 + v10)|, v7, v8;
			v0 := 0x194 / |v1|;
			var v12: map<bool, char> := map[p0 := v7];
			var v13: seq<map<bool, char>> := [(fm65(v0, 0x271, 0xd1, globalState))[true := v6[294]], v12];
			v0 := -|(v12[v5 := v6[294]] + (v12 + v13[|v1|]))|;
			v5 := p0;
		}
		...
		match (v17) {
			case DC9(cf8, cf9, cf10) =>
				...
				var v19: array<int> := new int[7](i3 => i3 % cf9);
				...
				v23[856] := fm53(cf9, fm54(|v24|, globalState), globalState);
				v23[856] := v18;
				var v25 := DC31(f5);
				...
				if (!v26.f13 || (v0 < v0)) {
					...
					v19[176] := fm3(v0, cf8, globalState);
					v27, v28, v19[176] := v27, v28, -(-v0 / 0x3d);
					var v29: multiset<array<bool>> := multiset{f10};
					v29 := multiset{f10};
					cf10 := (v0 + f6) < (--v19[176] * v26.f14);
			...
			case DC10(cf11) =>
				...
				if (v36.cf46) {
					...
					var v39: array<int> := new int[7] [154, |v1| % |(map[f4 := v0])[p0 := v0]|, fm7(globalState), |(set v38 : int | (0x24b <= v38) && (v38 < 174) :: (v38 - f6))| % cf11, f6, |multiset{v14.f4, f4, p0}|, f6];
					var v40: seq<bool> := [p0];
					v39[891] := |(v40 + v40)|;
					...
					v37, v39[891], v41[166], v42, v42 := map[f4 := v1] + (f9 + v37), v0, v39, fm0(v43, globalState), --|(v44 + v44)| == -0x201;
					...
					var v48: multiset<int> := multiset{v39[891], |v44|, cf11};
					var v49: array<char> := new char[12] [v43, fm1(v39[891], v14.f4, globalState), 'c', v43, v43, v43, v43, 'y', v43, v43, 'l', v43];
					...
					v42, v42, v0, v47[836] := p0 || v14.f4, v42, |v56|, if (p0) then v50 + v50 else v50 + v50;
					var v57: C1 := new C1(v39[891], v39[891], f5, if (p0 in v44) then v44[p0] else f6, v14.f4);
					var v58: seq<C1> := [if (f4) then v57 else v57, v57, v57, v57, v57];
					var v59: seq<seq<C1>> := [v58 + v58[|"y"| := v57]];
					v58 := v59[0x274];
					var v60 := DC20(v14.f4, v43, f6 / f6);
					var v61: map<char, array<bool>> := map[v43 := f10];
					var v62 := DC37(v61);
					v39[891], v60, v42, v62 := |(set v63 : int | (0x177 <= v63) && (v63 < 806) :: (v63 * v57.f15))| * v0, v60, v14.f4, v62;
				} else {
					cf11 := v0;
					var v64 := false;
					f10[635] := !v14.f4;
					...
					var v69 := DC30(v16);
					v64, v64, f10[635], v64 := v0 >= |v66|, !(multiset{cf11} != (multiset{f6, 0x2fa})[f6 := |v68|]), true, !((v16 != v69.cf49) ==> v14.f4);
					v0 := v0;
					f10[635] := p0 ==> (v14.f4 || p0);
					var v70: map<bool, bool> := map[p0 := f10[635]];
				...
				if (if (!v14.f4) then v74 > v74 else p0) {
					...
					var v81 := new C1(|v79[v80 := v14.f4]|, |(seq(0x190, i4  => (cf11)))|, f5, cf11, v14.f4);
					var v82: map<bool, int> := map[v77 := -f6];
					v81.f16 := v81.f16 + (|v82| % v14.fm7(globalState));
					var v83: multiset<int> := multiset{v81.f16, |map[v81.f16 := v77]|, v81.f15};
					var v84: seq<seq<bool>> := [v73];
					var v85: multiset<int> := multiset{--v81.f16 * cf11, f6 / v0, if (0xdc in v83) then v83[0xdc] else if (f4 in v82) then v82[f4] else DC13(|v16|, v77, v0, v84[v81.f16]).cf16, f6};
					var v86: map<int, bool> := map[v81.f16 := f4];
					v85 := ((multiset(v80))[|"tfiwvdm"| := |v86|])[v0 := --f6];
					...
					var v93 := 'w';
					v77, v87[101], f10[172], r0, v92 := p0, v90, v14.f4, v93, v92[v1 := v81.f16];
				}
			...
			case DC8(cf7) =>
				...
				var v100 := DC15(v99[cf7[-524 := v14.f4] := v0]);
				v0, v95, v98, f10[211], v100 := f6, v95, map[f6 := v97], p0, v100;
				var v101: array<string> := new string[4](i5 => (v1 + v1)[f6 := 's']);
				v101[642] := v1;
				var v102: seq<int> := [f6];
				var v103 := 'o';
				v101[642] := (fm37(f4, if (v14.f4) then v14.f4 else v2.fm8(v0, true, v1, v102, globalState), f6, v14.f4, globalState))[v0 := v103];
				if (p0) {
					f10[211] := (cf7[4] ==> v14.f4) && f4;
					var v104: array<bool> := new bool[6](i6 => DC3(f10[211]).cf2);
					v104 := if (v102 <= v102) then v104 else v104;
					v0 := (f6 / |cf7|) / 846;
					f10[211] := !f10[211];
					v0 := v0;
				} else {
					f10[211], v101[642], f10[211], v0 := !(v14.f4 ==> true), v101[642] + v1, if (v14.f4) then v0 <= v0 else f6 >= v0, v0;
					f10[211] := DC9(fm0(v103, globalState), f6, f10[211]).cf8 in map[true := v14.f4];
					var v105 := DC27(v96[f6 := cf7]);
					v102, v0, f10[211], f10[211] := fm39(v101[642], v105, v14.f4, globalState) + ([v0] + v102), v102[f6], v14.f4, !false;
					var v106: T1 := new C6(f10[211], f4, f5, f6);
					...
					var v111: map<bool, bool> := map[f10[211] := v14.f4];
					var v112: multiset<bool> := multiset{f10[211]};
					var v113: array<int> := new int[26] [v2.fm7(globalState), v0, fm9(true, false, f6, globalState), |(v16 + v16)|, v0, v0, |v107| * |cf7|, v0, f6 + v0, v106.f6, |(v102 + v102)|, |(v109 - v109)|, v106.f6, f6, if (v106.f4) then |v110| else f6, v0, |[false]|, f6, v106.f6, f6, |{f10[211]}| * f6, v0, |v1|, |(v101[642] + v101[642])|, |v111|, |v112|];
					var v114: map<map<int, int>, bool> := map[v16 := v14.f4];
					v113[983] := |(if (v14.f4) then [|v114|] else v102)|;
					v113[983] := v0 / f6;
				...
				var v122: seq<seq<int>> := [fm57(v0, v0, globalState), v102, seq(0x36b, i8  => (0xf6)), v102];
				v121 := new C5(v121.f4, fm3(fm3(f6, true, globalState), f10[211], globalState), v121.f5, |v122|, p0);
			case DC11(cf12) =>
				...
				var v126 := DC6();
				v125 := v125[v126 := f6 % f6];
				var v127: array<int> := new int[25](i9 => i9 / v0);
				var v128 := DC32(v127);
				match (if (p0) then v128 else v128) {
					case DC33(cf52, cf53, cf54, cf55, cf56) =>
						...
						var v135: set<seq<int>> := {[|"tm"|], seq(0x11b, i11  => (v0)), v133, v133, [0x3d6, |v134|]};
						v132[265] := v135;
						f10[963] := cf52;
						...
						var v144 := DC19("mskr");
						v132[265], f10[963], v138, v127[895] := {v133 + fm39(v1, v141, if (|v133| in v143) then v143[|v133|] else p0, globalState)}, f4, v138 + v138, |v144.cf25|;
					case DC32(cf51) =>
						var v145 := DC10(f6);
						v0 := v145.cf11 % 0x2fd;
						var v146: seq<bool> := [false, v2.fm8(v0, f4, v1, seq(133, i12  => (f6)), globalState)];
						f10[257] := v146[f6];
						var v147: array<D0> := new D0[12](i13 => DC1());
						var v148 := true;
						var v149 := 'p';
						var v150: array<string> := new string[10] [v1, "xkjwa", v1, ("tc" + v1)[-|map[v14.f4 := v149]| := 'c'], v1, "vtrm", v1, if (v14.f4) then v1 else v1, seq(0x1d7, i14  => ('h')), v1];
						v150[38] := if (f4) then v1 else v1;
						f10[257], v147, v148, v0, v150[38] := v14.f4, DC42(v147).cf68, v14.f4, v0, v1 + v1;
						var v151: map<bool, bool> := map[false := f10[257]];
						var v152: set<int> := {f6};
	...
	method m6(globalState: GlobalState) returns (r0: D1, r1: string) {
			...
			decreases 100 - i0
		{
			...
			v0[868] := v1 + v1;
			v0[868] := v1 + ((map[f10 := f4])[f10 := f4] + v1);
			var v2: array<int> := new int[10];
			v2[304] := f6;
			var v3 := 'w';
			f10[597] := fm0(v3, globalState);
			var v4 := true;
			v2[304], f10[597], v4 := f6, f4, v4;
			var v5: array<map<int, int>> := new map<int, int>[13](i1 => map[f6 := v2[304]] + DC30(map[f6 := f6]).cf49);
			var v6: seq<int> := [DC4(v2[304], v2[304]).cf3];
			var v7: map<int, int> := map[|v6| := f6];
			v5[958] := v7;
			v5[958] := v7;
			var v8 := new C6(fm0(v3, globalState), false, f5, f6 % f6);
		}
		for i2 := f6 to f6 {
			f10[324] := false || true;
			f10[324] := f6 >= i2;
			f10[324] := f10[324];
			var v9: array<map<bool, bool>> := new map<bool, bool>[24](i3 => map[true := f10[324]]);
			var v10 := DC23(v9);
			var v11: map<int, D11> := map[f6 := v10];
			var v12 := 472;
			v11, v12 := v11, i2;
			f10[324], v12, v12, f10[324] := !f10[324], --(i2 * 0x2b9), -v12 - fm7(globalState), false;
		}
		var v13 := false;
		v13 := v13;
		f10[304] := v13 || f4;
		...
		if (v15[f6] > |v18|) {
			...
			match (v21) {
				case DC22(cf30, cf31, cf32, cf33, cf34) =>
					...
					v22[968] := if (|v14| in v23) then v23[|v14|] else cf34;
					v22[968] := f6;
					var v24 := DC25(cf31, f6);
					var v25 := new C5((v24.(cf39 := v13)).cf39, -f6, f5, |"romg"|, f10[304]);
					var v26: array<multiset<bool>> := new multiset<bool>[18](i5 => multiset{cf32});
					v26 := v26;
				case DC21(cf29) =>
					var v27 := 0x173;
					v27 := v27;
					var v28: multiset<bool> := multiset{f10[304], f4, f4, v13};
					var v29: multiset<int> := multiset{v27, |v28|};
					var v30: map<multiset<int>, string> := map[v29 := v14];
					var v31, v32 := m0(v30, f10[304], v29, 0xfd > |v15[v27 := v27]|, globalState);
					v27 := f6;
					f10[304] := f4;
			}
			...
			if (v13) {
				...
				var v37: array<set<string>> := new set<string>[6](i6 => {seq(0x3a1, i7  => ('a'))} + {v14, "mj"});
				var v38: set<string> := {v14};
				v37[140] := v38;
				v37[140] := v38;
				v36 := v36;
				var v39 := new C4(f5, v15[f6], f4);
				var v40 := DC13(v36, v35, |"wdwcp"|, v16);
				var v41 := 'i';
				v36, v35, v36, v36, v36 := f6 - v40.cf14, v13, |(v14[v36 := v41] + (v14[f6 := v41] + v14))|, v36, v36 + 0x1b7;
			} else {
				var v42: array<int> := new int[26](i8 => i8 - f6);
				v42[291] := f6 - f6;
				v42[291] := f6;
				v42[291] := v42[291] * v42[291];
				var v44 := DC14(multiset(v15));
				var v45: map<D5, bool> := map[v44 := f10[304]];
			...
			var v55: map<int, bool> := map[|v54| := f10[304]];
			f10[304] := v13 <==> fm14(v55, !f4, f6, f10[304], globalState);
			var v56: array<int> := new int[13](i10 => i10 / f6);
			v56[193] := f6 + fm3(f6, true, globalState);
			v56[193] := f6;
		}
		...
		if (fm0(v57, globalState)) {
			...
			var v59 := -0x318;
			v58, f10[304], v59 := v58, fm9(v58.f11, f10[304], |v14|, globalState) == v59, v59;
			v59 := f6;
			v59 := v59;
			...
			var v65: map<bool, bool> := map[f10[304] := if ((if (v59 in v64) then v64[v59] else v61) in v62) then v62[if (v59 in v64) then v64[v59] else v61] else v58.f11];
			v60[231], v13, v59, v58 := -(v59 - (|v15| * v59)), if (v58.f11 in v65) then v65[v58.f11] else v58.f11, fm7(globalState), v58;
		} else {
			var v66 := 0x139;
			v66 := v66 / (f6 + |"gpm"|);
		...
		r0 := DC3(fm8(f6, v13, seq(-0x1ed, i12  => (v57)), v15, globalState)).(cf2 := f6 >= |v74|);
		r1 := v14;
	}
}
...
class C8 {
	...
	function fm12(p0: bool, p1: D0, p2: int, p3: bool, globalState: GlobalState): bool {
		|map[true := map[0x356 := |[true, false]|]]| !in ((seq(0x9d, i0  => (-0x278))) + [-0x151, |map[false := false]|])
	}
	method m4(p0: int, p1: int, p2: bool, globalState: GlobalState) {
		...
		v7[803] := if (true) then 0xc2 else p1;
		var v8 := DC26(p2);
		...
		var v16: array<bool> := new bool[21] [p2, p2, true, p2, p2, v8.cf41, p2, p2, p2, p2, p2, p2, p2, p2, p2, p2, if (p2 in v9) then v9[p2] else true, p2, DC20(v11.cf46, v12, v6).cf26, !v13[p0], p2];
		...
		var v21: multiset<seq<bool>> := multiset{v15[|v20| := v19.f4]};
		var v22 := DC15(v21);
		v7[803], v19, v12, v19.f5[632] := p0, v19, match v22 {
			case DC16(cf20, cf21, cf22) => v12
			case DC15(cf19) => v10[v6]
		}, v16;
		var i1 := 0;
		while (v19.f4)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			v7 := v7;
			var v23: array<string> := new seq<char>[23](i2 => seq(0xcd, i3  => (v12)));
			var v24 := DC4(v7[803], v6);
			var v25: seq<int> := [|[fm47(v19.f6, globalState)]|];
			var v26: C1 := new C1(v7[803], -616, v19.f5, |v13|, p2);
			v23[626] := fm50(v24.cf3, |v25[p1 := |[p1, v19.f6]|]|, |map[fm0(v12, globalState) := v26]|, v19.f4, globalState);
			v23[626] := (if (v19.f4) then v10 + v10 else v10)[|v10| + |v10| := v12];
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (v0) {
			...
			if (!v0) {
				...
				v14 := v14[p0 - v7[-179] := v0];
				var v15 := 'd';
				var v16: map<bool, char> := map[v0 := v15];
				var v17: map<bool, int> := map[v0 := |v16|];
				var v18 := DC21(v17);
				var v19: set<int> := {p0, 85};
				var v22: array<set<int>> := new set<int>[19] [v19 * v19, v19 - v19, fm31(|v14|, p0, p0, false, globalState), v19, {|v5|}, v19, {738, p0} - v19, v19, v19, v19, v19, set v20 : int | (0x8d <= v20) && (v20 < 0x3d6) :: (v20 - p0), {0xe6}, v19, v19, {p0} * v19, set v21 : int | (-0x81 <= v21) && (v21 < 0x2dc) :: (v21 / p0), v19, v19];
				v22[947] := v19 - v19;
				...
				v0, v18, r1, v22[947] := false ==> (v15 !in v23[p0]), DC21(v17), v26.cf52, v27.cf23;
				var v28 := 0x71;
				v28 := -p0;
			} else {
				var v29 := 0x364;
			...
			var v42: multiset<int> := multiset{v38[377]};
			v38[377] := |((v41.cf17[-(if (p0 in v42) then v42[p0] else p0) := v0] + v40) + (v40 + v40))|;
		}
		...
		if (v0) {
			...
			match (v59) {
				case DC33(cf52, cf53, cf54, cf55, cf56) =>
					...
					v53[201], cf52, v64, v65, v44 := fm1(|v55|, v0, globalState), cf52, v64, v65, if (multiset{v69} in v71) then v71[multiset{v69}] else v44;
					var v72: seq<set<bool>> := [cf56];
					var v73: map<int, int> := map[-cf55 := -0x8b];
					var v74: seq<bool> := [cf52, v68.f4];
					var v75 := DC19(v55);
					var v76: array<bool> := new bool[29] [cf52, v0, cf52, true, !cf52, v68.f4, cf52 && false, |(seq(614, i2  => (v53[201])))| < v54, cf52, cf52, v0, v54 > -p0, !v0 in v72[if (v68.f6 in v73) then v73[v68.f6] else v54], v0, fm0(v44, globalState), v74[p0], v0, false, cf52, v68.f4, v0, cf52, cf52, v0, v68.f4, (seq(0x37f, i3  => (v53[201]))) <= (v75.(cf25 := v55)).cf25, false, v68.f4, v68.f4 ==> cf52];
					v76[172] := cf52;
					...
					var v85: map<int, seq<int>> := map[625 := [|v81[cf55 := |map[v84 := |cf54|]|]|]];
					v76[172], cf52, r0, v79 := v68.fm8(v80.cf67, cf52, seq(69, i4  => (v53[201])), if (0x354 in v85) then v85[0x354] else v82, globalState), v68.f4, !v68.f4, v79 + v79;
				...
				case DC32(cf51) =>
					...
					v90[700] := fm11(globalState);
					v90[700] := v0;
					var v94: array<string> := new seq<char>[5](i5 => seq(370, i6  => (v44)));
					var v95: array<map<int, bool>> := new map<int, bool>[24](i7 => map[|map[p0 := -v54]| := v90[700]]);
					v94, v95 := v94, v95;
					var v96: seq<string> := [v55, seq(0x20d, i8  => (v44)), v55, v55];
					var v97 := DC27(seq(195, i9  => ([v0])));
					var v98: set<int> := {v54, p0};
					var v99: map<bool, set<int>> := map[!v90[700] := v98];
					r1, v91, v90[700], v54, v54 := p0 >= p0, fm39(v55[v54 := v53[201]] + v96[p0], v97, v0, globalState), fm11(globalState), |(if (false in v99) then v99[false] else v98)| + v54, v54;
			}
			...
			v101[935] := (if (v0 in v102) then v102[v0] else p0) == fm3(|v43|, v0, globalState);
			...
			v106[442] := v105;
			v106[442] := v105;
			var v107: C0 := new C0(v103[247]);
			var v108: seq<C0> := [v107, v107];
			var v109: map<int, C0> := map[|map[v0 := p0]| := v107];
			var v110 := DC48(v107);
			var v111: array<C0> := new C0[24] [v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v108[|[v107.f12, p0]|], v107, v107, if (p0 in v109) then v109[p0] else v107, v107, v110.cf82, v107, v107, v107, v107, v107, v110.cf82];
			v111 := v111;
		}
...
class C9 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: map<bool, int>) {
			...
			decreases 100 - i4
		{
			...
			var v32 := DC51(v30);
			var v33: array<T0> := new T0[18] [v30, v31[p0], v31[|v29|], if (f4) then v30 else v30, v32.cf87, v30, if (f4) then v30 else v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30, v30];
			v33[704] := v30;
			v33[704] := v30;
			match (fm68(globalState)) {
				case DC28(cf43, cf44, cf45, cf46, cf47) =>
					...
					v35[441] := {cf44};
					v35[441] := {p0, p0, |[cf46]|, cf43, fm7(globalState)} * {f6};
					cf45, cf46 := cf45, (v35[441] * v35[441]) > v35[441];
				case DC27(cf42) =>
					...
					v0[68] := v38 >= multiset{v37};
					f7 := p0;
			}
			
			var v39: map<T0, bool> := map[v30 := v30.f4];
			var v40 := DC28(f7, |v29|, v30.f4, true, |v29|);
			var v41: set<bool> := {if (v33[704] in v39) then v39[v33[704]] else v30.f4, false, v40.cf45, f4, f4};
		...
		f7, v51, v52, v46, v0[544] := if (v46) then f7 else -0x2e1, v51, "dxypm", v54 > (if (v51 in v55) then v55[v51] else v54), v46;
		var v56: map<bool, int> := map[v0[544] := v50.f12];
		r0 := v56 + map[!v0[544] := v50.f12];
	}
	method m2(p0: bool, globalState: GlobalState) returns (r0: char, r1: array<D1>) {
		var v0 := new C4(f5, fm7(globalState) / f7, !p0);
		var i0 := 0;
		while (p0)
			decreases 100 - i0
		{
			...
			v3 := fm69(globalState);
			var v4: array<int> := new int[22](i1 => i1 % |[f4, false]|);
			v4 := v4;
			f7 := f6;
		}
		...
		if (p0) {
			...
			var v9 := new C3(f5, v5[176], v6);
			var v10: array<seq<int>> := new seq<int>[24];
			v10[799] := seq(0x2ff, i2  => (v5[176]));
			var v11: seq<int> := [f7];
			var v12 := "xondmryd";
			var v13: seq<bool> := [p0, f4, f4];
			var v14 := DC27([v13[v5[176] := v6]]);
			...
			var v18: map<bool, int> := map[f4 := v5[176]];
			v17 := v17 - v17[v12 := |v18|];
		} else {
			var v19: seq<int> := [f6, f7 % f7, f7];
			v19 := v19 + (v19 + (seq(484, i3  => (f6))));
			var v20 := 'f';
			...
			v22, v21.f14, v22, v5[617], v22 := (v24 - v24) >= v24, f6 % (f6 * f7), v25 >= multiset{false, p0}, (f6 * f7) * (f6 - v21.fm7(globalState)), (p0 <== v21.f13) !in v26;
			v22 := p0;
			v5[617] := 0x2d;
		}
		...
		if (fm70(f4, 0x2e0, v28, p0, globalState) <= ([v30] + v31)) {
			...
			var v34: seq<int> := [f7];
			v5[227] := |v34| * f6;
			v5[13] := if (fm8(f7, v33, v27, v34[f7 := f7], globalState)) then |v28| else fm3(f6, false, globalState);
			var v35: map<bool, bool> := map[p0 := false];
			var v36: multiset<bool> := multiset{if (v33 in v35) then v35[v33] else v28[f7], v33, !v33};
			v5[227], v5[13], f7, v33, v33 := --(f6 / (if (v0.fm8(f7, false, v27, v34, globalState) in v36) then v36[v0.fm8(f7, false, v27, v34, globalState)] else |[p0, p0]|)), f7, fm3(f6, v33, globalState), v28[f6], p0;
			var v37: seq<seq<char>> := [v27];
			v33 := v0.fm8(f6, f4, v37[f6], v34, globalState);
		} else {
			...
			var v42: map<array<int>, array<array<C8>>> := map[v41[f7] := v40];
			v40 := if (v41[f6] in v42) then v42[v41[f6]] else v40;
			var v43: map<int, int> := map[-f6 := f7];
			var v44: seq<int> := [f6];
			f7 := (0x1e0 + (if (v44[0x385] in v43) then v43[v44[0x385]] else |v28|)) / 0x1bc;
	...
	method m3(p0: int, p1: int, p2: char, globalState: GlobalState) returns (r0: map<int, int>) {
		...
		var v9: seq<C5> := [v8];
		var v10: set<C5> := {v8, v9[f7]};
		var v11: multiset<bool> := multiset{!v0[v8.f14], f4, f4};
		var v12: array<int> := new int[15] [f6, |(v6 + v6)|, |{f4, f4, f4, f4}|, p0, p0 % |v10|, f6, p0, v8.fm9(v8.f13, v8.f13, p1, globalState), p1, v8.fm7(globalState), -(if (false in v11) then v11[false] else p0), p0 - f7, |v3| + p0, |v7|, p0];
		v12[662] := DC13(|v5|, f4, f7, v0).cf14;
		var v13 := 'r';
		var v14 := DC19("dks");
		v2, v4, v5, v12[662], v13 := v2, DC16(v8.f13, fm0(fm1(|v5|, f4, globalState), globalState), v3[p0 := p1]), (if (v0[-0x8]) then v14 else v14).cf25, |"lvpib"|, v13;
		if (false) {
			var v15 := false;
			...
			v17[990] := v19;
			v17[990], v8.f14, v15 := {map[v15 := v8.f14], v18} + {map[f4 := p0], v18, v18, v18}, (f6 - -f7) - p0, v8.f13;
		} else {
			var v20 := true;
		...
		v12[662], v12 := v12[662], v12;
		var v26: map<int, bool> := map[p0 := f4];
		var v27: multiset<array<int>> := multiset{v12};
		var v28: array<bool> := new bool[12](i0 => v8.f13);
		var v29: map<int, int> := map[|v5[|v27| := p2]| := |[v28]|];
		var v30: map<bool, int> := map[false := |v29|];
		var v31: array<bool> := new bool[16] [v8.f13, v8.f13, v8.fm8(p1, v8.f13, v5, v3, globalState), !f4, f4, v8.f13 <==> f4, !fm0(p2, globalState), f4, v8.f13, f4 || DC13(v12[662], v8.f13, p0, v0[|v0| := v8.f13]).cf15, v8.f13, v11 != multiset{if (|v30| in v26) then v26[|v30|] else v8.f13, false}, !((seq(-0x1a4, i1  => (v13))) < v5), v8.f13, f4, f4];
		v28 := v28;
		var v32 := true;
		v32 := false;
		if (f4) {
			v8.f14 := v8.f14 / -v12[662];
...
method Main() {
	...
	var v2 := 598;
	var v3: array<int> := new int[14] [v2, v2, v2, if (v0) then v2 else v2, |(seq(532, i0  => ('m')))| / 0x14e, -0x3a2, v2, v2, v2, DC2(v2).cf1 - -v2, v2, v2 - v2, --v2 * 743, v2];
	v3 := v3;
	var v4 := 'j';
	v4 := v4;
	...
	v0, v15[99] := !([DC1()] == (v17 + v17)), fm0(v4, globalState);
	var v18: multiset<int> := multiset{v2};
	var v19: map<multiset<int>, string> := map[v18 := v8];
	var v20, v21 := m0(v19, if (v15[99]) then !v0 else v15[99], v18[v2 := v2], v15[99], globalState);
	var v22: array<seq<int>> := new seq<int>[24](i3 => v14 + v14);
	v22[766] := v14;
	var v23 := DC2(v2);
	v16, v15[99], v20, v22[766], v2 := match v23 {
		case DC1() => v16
		case DC2(cf1) => v16
		case DC0(cf0) => v16
	...
	if (v15[99]) {
		...
		v3[124] := v21 * fm3(v2, v15[99], globalState);
		var v25: seq<multiset<int>> := [v18, v18 + multiset{v2, 0x2a1}];
		v20, v3[124], v25, v23 := !v0, v21 / v2, v25 + fm4(false, true, globalState), v23;
		v3[124] := 0x386;
		v15[99] := v20;
		var v26 := DC5(v15);
		v11 := v26.cf5;
	} else {
		v3[547] := |(if (v20) then v8 else v8)|;
		var v27: array<string> := new string[16];
		v27[397] := "nwenxedn";
		var v28: seq<string> := [v8, v8, "qystgqh", seq(0x27b, i4  => (v4)), v8 + v8];
		v3[547], v27[397] := |v28|, seq(912, i5  => ('w'));
		...
		v21, v18, v3[547], v3[547], v3[547] := fm3(|v34| + v33, !v15[99], globalState), v18, v21, -(v2 % -(if (v20) then v33 else |v35|)), v33;
		v0 := v32 <== v32;
	}
	
	var v36: map<D0, int> := map[v16 := v21];
	var v40: set<bool> := {fm0(v4, globalState)};
	var v41: array<map<D0, int>> := new map<D0, int>[12] [v36, v36 + v36, v36, v36, map v37 : D0 | v37 in v36 :: (v37) := (v14[v2]), v36, v36, v36, (map v38 : D0 | v38 in [v16, v16] :: (v38) := (|(map v39 : D2 | v39 in multiset([DC7(v2)]) :: (v39) := (v21))|))[DC1() := fm3(|v40|, v0, globalState)], v36, fm5(v21, v15[99], globalState), v36];
	v41 := if (!v0) then v41 else v41;
	var v42: multiset<char> := multiset{v4};
	var v43, v44 := m0(v19, false, v18, 'n' in v42, globalState);
	v3[964] := v44;
	var v45: map<array<int>, seq<int>> := map[v3 := seq(-0x2ee, i6  => (v21))];
	v3[964] := -(|(if (v20) then v45 else v45)| * v2);
	for i7 := v44 to v21 {
		v3[964] := v2 + v3[964];
		v3[964] := v2;
	...
	if (!!v20) {
		...
		v3[964] := |DC53([v54, v54, v54]).cf89|;
		var v55: set<char> := {v4, v4};
		var v56 := DC16(v54.f13, if (|v55| in v5) then v5[|v55|] else v43, v22[766]);
		var v57: seq<bool> := [true, v54.fm8(v21, v0, v8, v56.cf22, globalState)];
		v4 := v8[|v57| % v2];
		var v59: seq<array<array<bool>>> := [v53];
		var v60: T1 := new C9(v2, set v58 : seq<bool> | v58 in (seq(-0x58, i8  => (v57))) :: (v58), v59[v2], v44, v54.f13);
		var v61: set<T1> := {v60};
		v61 := v61;
		v3[964] := v60.fm9(v54.f13, v54.fm8(v3[964], v43, v8, [v54.f14, v3[964]], globalState), v21, globalState);
		v43 := v54.f13;
	} else {
		...
		if ((0x3d4 != v3[964]) && v66.cf52) {
			...
			v15[99] := v70[v2];
			v15[99] := v20;
			v0 := if (if (v64) then v0 else v64) then v0 else v15[99];
		} else {
			...
			var v74 := DC44(false);
			v74 := v74.(cf72 := v43);
			v72 := fm3(v3[964], v72, globalState) !in (v18 + multiset{-977, 547, if (v20 in v1) then v1[v20] else v44});
		}
		...
		var v82: array<D25> := new D25[25] [v76, v76, DC52(v75), v76, v76, DC52(v75), fm72(v81[v44], v18, globalState), v76, v76, DC52(fm73(globalState)), v76.(cf88 := v75), v76, v76, v76, v76, v76, v76, v76, v76, v76, DC52(multiset(seq(790, i9  => (v14)))), v76, v76, v76, v76.(cf88 := v75[v22[766] := v3[964]])];
		v82[428] := v76;
		v82[428] := v76;
		v4, v20, v2 := v4, !v15[99], |(v8 + v8)| / v21;
	}
