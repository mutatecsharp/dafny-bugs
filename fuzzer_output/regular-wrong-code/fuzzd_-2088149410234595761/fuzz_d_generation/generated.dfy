...
function fm0(p0: bool, p1: int, globalState: GlobalState): int {
	0x341 % |(map v0 : int | (0x235 <= v0) && (v0 < 0x282) :: (v0 / |"doerfd"|) := (|(map v1 : seq<char> | v1 in multiset{['f']} :: (v1) := (0x18))|))|
}
...
function fm3(p0: seq<int>, p1: bool, p2: bool, p3: bool, globalState: GlobalState): multiset<int> {
	multiset{-329, --|multiset{true}|, 696, |{true, true, !true}|} - (multiset{|(seq(982, i0  => ("omngle")))|} * multiset{|map[--597 := !false]|})
}
function fm4(p0: bool, globalState: GlobalState): bool {
	(if (true) then -0x5c else |map[!true := |multiset([|DC3(seq(605, i0  => ('c'))).cf5|])|]|) <= (|"esnepq"| / 0x19e)
}
...
method m0(p0: int, p1: int, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
	...
	var v8 := "bhpgj";
	for i1 := |v8| to 0x17c / 0x3c {
		var v9: array<int> := new int[1] [i1];
		var v10: seq<array<int>> := [v9, v9, v9];
		globalState.f2 := |v10|;
		v8 := v8 + v8;
		var v11 := 'n';
		v8 := v8 + (fm6(!false, v0, globalState))[p1 := v11];
		if (v0) {
			...
			v0 := if ((i1 % |v8[if (|v8| in v20) then v20[|v8|] else p0 := v11]|) in v19) then v19[i1 % |v8[if (|v8| in v20) then v20[|v8|] else p0 := v11]|] else v0;
			var v21: seq<int> := [fm0(v0, p0, globalState), p1];
			var v22: set<char> := {v11, v11};
			var v23: seq<seq<int>> := [v21];
			var v24 := DC1(p0, v21[|v22| := |v23|]);
		...
		decreases 100 - i3
	{
		...
		v30[252] := v31;
		var v32 := DC1(p1, v28);
		globalState.f2 := |[v0, v0]| % (p1 - v32.cf0);
		v28 := v28;
...
method Main() {
	...
	if (v2) {
		...
		v3[98] := v2;
		var v8: map<int, int> := map[v1 := |v0| % v4];
		var v9: set<int> := {v1, v4, v1};
		globalState.f2, v7, v3[98] := |v8|, v7, v9 !! (v9 * v9);
		var v10, v11 := m0(v1 / v4, v1, globalState);
		v0 := "nwstnawx";
	} else {
	...
	match (v24) {
		case DC0() =>
			...
			v28[377] := |(if (v2 in v32) then v32[v2] else map v33 : int | (0x3bb <= v33) && (v33 < 0x148) :: (v33 * v1) := (v1))|;
			v28[377] := fm0(v2, 0x15c, globalState);
			var v34 := 'o';
			var v35: array<bool> := new bool[4];
			v35[709] := v2;
			var v36: map<D0, char> := map[if (v2) then v24 else DC2(false, v23, v1) := v34];
			v2, v28[377], v34, v35[709] := v2, v28[377] % v28[377], if ((if (false) then DC2(v2, v23, v28[377]) else v24) in v36) then v36[if (false) then DC2(v2, v23, v28[377]) else v24] else fm1(globalState), (if (!v2) then v2 else v2) ==> v2;
			var v37 := new C0();
			var v38: seq<int> := [-296, v1];
			v0, globalState.f2 := v0, v38[v28[377] / v1];
		case DC1(cf0, cf1) =>
		...
		case DC2(cf2, cf3, cf4) =>
			...
			var v41: C0 := new C0();
			var v42: map<map<int, bool>, C0> := map[map v40 : int | (0x39f <= v40) && (v40 < -180) :: (v40 / v1) := (v2) := v41];
	...
	if ((v1 * |v56|) in v47) {
		v1 := if (false) then v1 else v1 + |(seq(561, i6  => ('l')))|;
		...
		if (v2) {
			var v63: array<int> := new int[25] [fm0(!v2, v1, globalState), v1, v1, v1, v62 + v1, v62 - v1, v1, v1, 0xa + v1, |"fatyy"|, v62, v1, v62, v1, v1, v1, v62 * --fm0(v2, |v22|, globalState), |v56| * 0x7, -v62, -v62, v62 % |"iasqrm"|, -v62, v1, v47[v1], v62];
			v63 := v63;
			v2 := !(v48 <= (fm3([v1], v2, v2, v2, globalState) - v48));
			v63[57] := v1;
			v63[57] := |{if (v2) then v2 else true, v48 >= v48[v62 := v1], v0 <= v0}|;
			var v64: map<bool, bool> := map[v2 := fm4(v2, globalState)];
			var v65: map<int, bool> := map[fm0(v2, v62, globalState) := v2];
			v2 := if ((|v65| >= v63[57]) in v64) then v64[|v65| >= v63[57]] else !v2;
			var v66 := new C0();
		} else {
			...
			v2, v2, v67, v68[580] := v70 != v70, v2, if (v68 in v71) then v71[v68] else v67, -v62;
			var v72: set<seq<bool>> := {v56[v1 := v2] + v56, v56 + v56};
			v72 := {v56, fm5(v68[580], v2, v2, globalState) + [v2], v56};
			var v73 := 'a';
			...
			v76[942] := v73;
			v76[942], v48, v62 := v73, v48[v68[580] := v68[580]], v68[580];
		}
	...
	if (if (v2) then v82 != v82 else !v2) {
		...
		v2 := !((seq(0x271, i10  => (v78))) != v0);
		var v85, v86 := m0(|v48| / v1, v1, globalState);
		v2 := v78 !in (v0 + v0);
		var v87 := new C0();
	} else {
		v1 := v1;
