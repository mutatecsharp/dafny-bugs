...
function fm0(p0: map<int, set<int>>, p1: bool, p2: bool, globalState: GlobalState): set<int> {
	(set v0 : int | v0 in [|[0x305, |map[true := 0x1fa]|]|] :: (v0 + 0x165)) - (if (true) then {766} else {|multiset{0x19c}|, |(seq(0x62, i0  => ('r')))|})
}
...
function fm8(p0: D1, globalState: GlobalState): D3 {
	match DC15(map[|multiset{false}| := "xtkckav"]) {
		...
		case DC15(cf25) => if (false) then DC9(map v0 : int | (974 <= v0) && (v0 < 0x59) :: (v0 * -|(seq(0x199, i0  => ('i')))|) := ({0x4a, |[|[true, true]|, 799, |"d"|]|})) else DC9(map[-232 := {822}])
	}
}
...
function fm10(p0: char, globalState: GlobalState): bool {
	"yn" < (if (false) then seq(0xe1, i0  => ('s')) else "uegdnut")
}
...
function fm16(p0: map<bool, bool>, globalState: GlobalState): bool {
	(-719 / -0x2f3) == |(if (false) then {!false} else {true, !false})|
}
function fm17(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): seq<seq<int>> {
	[seq(0x7a, i0  => (|{false}|)), [|(map v0 : char | v0 in (map v1 : char | v1 in (map v2 : char | v2 in ['b', 'h', 'f', 'p', 'm'] :: (v2) := (DC23(true).cf38)) :: (v1) := (|{-0xf4, 0x171}|)) :: (v0) := (0x362))|, |map[0x237 := -|"cpapaci"|]|]]
}
function fm18(p0: bool, p1: int, p2: char, globalState: GlobalState): string {
	DC2({|map[{0x2e3, -766} := DC7('q', "p")]|}, seq(-0x3d5, i0  => ('r'))).cf6 + "rvlldbjbx"
}
function fm21(p0: bool, p1: int, globalState: GlobalState): D0 {
	DC2({|[-|[true]|, |(seq(-0xf0, i0  => ('b')))|]|} + (set v1 : int | v1 in (set v0 : int | (0x3b7 <= v0) && (v0 < -0x3da) :: (v0 / 0x1c)) :: (v1 / -0x332)), (seq(0xd9, i1  => ('i'))) + "oiuswc")
}
function fm22(p0: bool, p1: int, globalState: GlobalState): bool {
	(|map["sxdj" := |"ypeb"|]| % --|map[false := false]|) == (if (!!false) then |"cn"| else |(seq(0x320, i0  => (|(seq(708, i1  => ('u')))|)))|)
}
function fm23(globalState: GlobalState): D1 {
	DC6(|{false}|)
}
function fm24(globalState: GlobalState): set<D1> {
	({DC6(-0x39a)} + {DC6(-0x289), DC6(|(seq(0x39a, i0  => ('d')))|), DC6(|multiset([0x290, |"qjdg"|, |[false, false]|])|)}) * (set v1 : D1 | v1 in (set v0 : D1 | v0 in [DC6(|map[0x19f := false]|)] :: (v0)) :: (v1))
}
...
function fm28(p0: int, globalState: GlobalState): map<int, string> {
	map[-0x2ca + |(seq(-0xc6, i0  => ('i')))| := "emwqfdps"]
}
...
function fm39(globalState: GlobalState): seq<D7> {
	match DC28() {
		case DC28() => seq(571, i0  => (DC15(map[0x3e3 := seq(0x59, i1  => ('c'))])))
		case DC27(cf42) => (seq(0x230, i2  => (DC15(map[881 := "rqaiipv"])))) + [DC15(map[|{true}| := "tnwkwu"]), DC15(map[|(seq(-651, i3  => ('f')))| := seq(491, i4  => ('m'))]), DC15(map[-|"qdadesapq"| := "mdilqo"]), DC15(map[-|{false, false, true}| := "cmgqbmpj"])]
	}
}
...
function fm43(p0: int, p1: D0, p2: int, p3: bool, globalState: GlobalState): map<D2, int> {
	(map[DC8([|[|(set v0 : D12 | v0 in map[DC29(map[multiset([false]) := false]) := false] :: (v0))|, -731]|]) := |(seq(0x57, i0  => ('n')))|] + DC34(map[DC8([923, |[false]|]) := 496]).cf48) + (map[DC8([-|['e']|]) := 0x1a1] + map[DC8([|map[true := false]|]) := 310])
}
...
function fm46(p0: bool, globalState: GlobalState): map<int, int> {
	(map[-|"yvjprk"| := 0x320] + map[-433 := 576]) + map[-|[|map[|(seq(-0x2ca, i0  => ('o')))| := |multiset([false])|]|]| := |(map v0 : seq<int> | v0 in [seq(270, i1  => (-|(seq(-0x3cb, i2  => ('m')))|))] :: (v0) := (0x1cc))|]
}
...
function fm49(p0: multiset<int>, globalState: GlobalState): seq<seq<bool>> {
	((seq(-0x12a, i0  => ([true, false, true, false]))) + (seq(0xfb, i1  => ([false])))) + [[false]]
}
...
function fm54(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<map<int, D8>, set<char>> {
	match if (false) then DC16(true, map[0x14a := !!true], 'h', true) else DC16(false, map v0 : int | v0 in (map v1 : int | (313 <= v1) && (v1 < -0x22c) :: (v1 * -0xd7) := (false)) :: (v0 % |map[true := -0x399]|) := (false), 'r', true) {
...
function fm55(p0: bool, globalState: GlobalState): seq<int> {
	match DC36(multiset{'j', 'm'}) {
		...
		case DC38(cf53, cf54, cf55) => [cf55] + (seq(-0x68, i0  => (cf55)))
		case DC36(cf50) => seq(-5, i1  => (|[true]|))
	}
}
...
method m0(globalState: GlobalState) returns (r0: map<int, array<bool>>, r1: int) {
	...
	var v16: array<bool> := new bool[18] [fm16(v6, globalState) || v1, v1, !v1, v1, v1, (seq(0x233, i1  => (v0))) == v9, false, v15[v0], -0x388 < |v8|, v1, v1, multiset(seq(0x3b4, i3  => (-|map[v0 := v0]|))) >= v8[v0 := |(seq(29, i4  => (v0)))|], true, v1, v1, v1, v15 < v15, if (v1) then v1 else fm22(false, v0, globalState)];
	...
	if (multiset{v18, v18} >= (multiset{(map[|[v17.f29]| := v17])[v0 := v17]} - v19)) {
		v11[582] := v17.f29;
		v11[582] := -0x24b % v17.f29;
		var v20 := 'p';
		globalState.f25 := v20;
		v0 := --(-0x235 / (if (v17.f28) then fm1(globalState) else v11[582]));
		globalState.f6 := v17.f28;
		globalState.f17 := v10 == v10;
	} else {
		v11[731] := v17.f29;
		v11[731] := -(v17.f29 % (v17.f29 - v0));
		v0 := v11[731] - |map[v17.f28 := v6]|;
		var v21 := 'u';
		var v22: C8 := new C8(v21, v16, v17.f28);
		var v23 := DC6(v11[731]);
		var v24: multiset<D1> := multiset{v23, v23, v23, v23};
		v11[731], v22, globalState.f17 := v0, v22, fm4(v24, globalState) >= v17.f29;
		var v25: C0 := new C0(v10, v11[731], v16, v17.f28);
		v25 := v25;
		var v26: set<char> := {v22.f32, fm42(|v15|, globalState)};
		globalState.f4 := v11[731] * (v17.f29 % |v26|);
	}
	
	globalState.f6 := DC13(true, v11, false).cf23;
	globalState.f4 := |(seq(291, i5  => ({v17.f29, v17.f29})))|;
...
class C1 extends T0 {
	...
	method m14(p0: bool, globalState: GlobalState) returns (r0: string, r1: seq<bool>, r2: string, r3: map<bool, bool>) {
		...
		var v3: seq<int> := [v1];
		if (v2[v1 := v1] >= (multiset(v3) - v2)) {
			f27[587] := f39;
			f27[587] := p0;
			var v4: map<int, string> := map[-|v2| / |v0| := "jj"];
			v4 := v4;
			var v5: seq<string> := [v0, seq(0xe7, i0  => ('h'))];
			var v6: array<string> := new string[4] [v5[v1] + v0, v0, v0, v0];
			var v7 := DC21(v6);
			v6 := v7.cf33;
			f27[587] := v1 <= fm36(globalState);
			var v8: seq<bool> := [p0, f27[587]];
			globalState.f5 := (|v8| - |v3|) / |(v0 + v0)|;
		} else {
			var v9 := DC18(v1);
		...
		for i1 := |v14.cf40| to |multiset{if (f39 in v13) then v13[f39] else v1}| {
			...
			var v18: map<int, map<int, int>> := map[i1 := ((map v17 : int | (-0x35b <= v17) && (v17 < 455) :: (v17 % i1) := (i1))[v1 := v1])[if (i1 in v2) then v2[i1] else v1 := i1]];
			v16[283] := v18;
			v16[283] := v18;
			globalState.f5 := if (f39) then |v13| else v1;
			var v19: array<int> := new int[21](i3 => i3 % i1);
			v19[165] := v1;
			v19[165] := (|v3| / v1) + v1;
			v19[165] := v19[165];
		}
	...
	method m15(p0: set<bool>, p1: int, p2: bool, globalState: GlobalState) returns (r0: multiset<int>, r1: bool) {
		...
		if (f28) {
			...
			if (f28) {
				...
				v22[942] := v18;
				v22[942][756] := p1;
				v22[942][756] := |{p1, |(map v23 : int | (0x244 <= v23) && (v23 < 0x2ea) :: (v23 % |[p1]|) := (f39))|, p1, -p1}| * p1;
				var v24 := "txp";
				var v25: seq<bool> := [f39];
				v24 := fm34(false && !f28, 0xde, multiset{f39, v25[v22[942][756]], p2, f28, f28}, -v22[942][756], globalState);
				v24 := v24 + v24;
				var v26: map<int, bool> := map[p1 := f28];
				var v27: seq<multiset<int>> := [v19, v19[p1 := |v26|], v19];
				v27 := (seq(-0x1f5, i0  => (v19[|map[0x9f := multiset{f39}]| := p1]))) + (seq(0x1c5, i1  => (v19)));
			} else {
				var v28: array<char> := new char[27];
				v18[572] := p1;
				var v29: map<multiset<bool>, array<int>> := map[multiset{f39} := v18];
				var v30: map<bool, bool> := map[f28 := f28];
				globalState.f5, v28, v18[572], globalState.f15, globalState.f17 := p1 / p1, v28, -|(if (p2) then v29 else v29 + v29)|, if ((p2 ==> f39) in v30) then v30[p2 ==> f39] else p2, p2;
				var v31: multiset<bool> := multiset{f39};
				var v32 := "i";
				var v33: map<set<bool>, int> := map[p0 := v18[572]];
				var v34: map<int, bool> := map[if ({p2} in v33) then v33[{p2}] else p1 := f39];
				var v35 := 'i';
				var v36 := new C0(fm34(f39, v18[572], v31, p1, globalState), |v32[|v34| := v35]|, f27, !p2);
				var v37: array<string> := new string[6];
				var v38: map<array<string>, bool> := map[v37 := p2];
				v38 := v38[v37 := f28];
				f27[911] := f39;
				v35, f27[911], globalState.f6, v18[572] := v32[v18[572]], if (f28) then p2 else !f28, f28, p1 - (if (f28) then -fm36(globalState) else p1);
				var v39: array<int> := new int[1] [p1];
				var v40: map<int, char> := map[-v18[572] := v35];
				...
				v39 := if (v41 in v42) then v42[v41] else v43[|v44|];
			}
			...
			if (p1 != (if (f28) then if (p2 in v45) then v45[p2] else p1 else p1)) {
				var v46 := "qouh";
				var v47 := 'c';
				var v48 := new C0(("nulmgbv")[|v46| := v47] + v46, p1, f27, f28 ==> f28);
				var v49 := DC1();
				var v50 := DC4(v49);
				v50 := v50;
				globalState.f21 := -(-0x5f % p1);
				...
				v56, f27[102], r1 := if (p1 in v57) then v57[p1] else v56, f39, false;
			} else {
				var v58 := "x";
				v58 := v58 + v58;
				var v59 := DC18(p1 % p1);
				...
				globalState.f5 := p1;
				var v60: map<int, int> := map[0x151 := |v19| / p1];
				var v61 := DC28();
				...
				f27[56] := v66.cf1;
				v60, globalState.f17, globalState.f4, v61, f27[56] := v60, f28, p1, fm41(v58, globalState), f39;
			}
		...
		v77 := v77;
		var v78: multiset<int> := multiset{0x1e7 / p1};
		r0 := v78;
		r1 := p2;
	}
}
...
class C2 extends T0 {
	...
	method m12(p0: int, p1: char, p2: array<string>, p3: int, globalState: GlobalState) returns (r0: bool) {
		if (f38) {
			...
			match (v10) {
				case DC6(cf12) =>
					...
					var v13 := new C0(seq(192, i0  => (f37)), cf12, f27, f38);
					var v14: seq<bool> := [cf12 < p0, f28, v8 < v8, f28, fm22(true, 979, globalState)];
					globalState.f15, v7, r0, globalState.f6, globalState.f17 := true, (fm21(f28, p3, globalState)).cf6, true, |[f28]| == p0, v14[p0];
					v9[249] := -cf12 * cf12;
					v9[249] := -cf12 / fm20(globalState);
				case DC7(cf13, cf14) =>
					globalState.f25 := p1;
					globalState.f21 := p3;
					v9[506] := p0;
				...
				case DC5(cf11) =>
					...
					f27[691] := if (f28) then fm22(true, |[f38, f38]|, globalState) else |v21| > |{true}|;
			}
		...
		if (f28) {
			...
			match (v27) {
				case DC0(cf0, cf1, cf2, cf3, cf4) =>
					...
					var v34 := DC2(v28, v32);
					globalState.f15, v28, v30 := f28, {p3 - p0, p3, -|v31[cf4 := |(if (cf4 in v33) then v33[cf4] else v34.cf6)|]|}, (v30[v29 := v28])[v29 := set v35 : int | (0x388 <= v35) && (v35 < 0x230) :: (v35 % cf2)];
					globalState.f21 := cf2;
					var v36 := DC6(p0);
					globalState.f6 := (fm24(globalState) - {v36, v36, v36, v36}) == {v36};
				case DC1() =>
					var v37: seq<int> := [p0];
					globalState.f15, globalState.f6 := f38, fm22(f28, -v37[p0], globalState);
					...
					v42 := v42[f28 := v41 - v41];
					globalState.f5 := p3 % p3;
					var v43: seq<bool> := [false, f38];
					v43 := fm25(p0, |fm26(f28, p0, 'n', globalState)|, p0 / p3, globalState);
				case DC2(cf5, cf6) =>
					var v44: seq<bool> := [f28, f28];
					v44 := if (true) then v44 else fm25(|cf6|, 689, p0, globalState);
					f27[103] := f28;
					f27[103] := f28 && ({0x22d} != cf5);
					var v45: set<bool> := {f38};
					var v46: seq<set<bool>> := [v45, v45, v45 + {f27[103], !f27[103], f38}];
					var v47 := DC12(v46);
					v46 := v47.cf20;
					globalState.f5 := -p3;
				case DC3(cf7, cf8, cf9) =>
					...
					globalState.f17, globalState.f17, f38 := fm22(f38, -(p0 - p3), globalState), fm22(fm0(v49, false, false, globalState) !! v48, p0 / cf7, globalState), f38;
				...
				case DC4(cf10) =>
					...
					globalState.f17, v61[377], globalState.f5, globalState.f25, globalState.f17 := multiset{f27} >= (if (p0 in v62) then v62[p0] else v63[f27 := |v64|]), {v59}, 19, f37, f28;
					var v65: multiset<char> := multiset{p1};
					var v66: map<int, bool> := map[|v65| := f38];
					var v68: array<map<int, bool>> := new map<int, bool>[5] [v66, (map v67 : int | (236 <= v67) && (v67 < 663) :: (v67 % p3) := (f38)) + v66, v66, map[p3 := f28], v66];
					var v69 := "osp";
			...
			if (f28) {
				...
				var v78: multiset<bool> := multiset{-p3 == p3, v77[p0], f38};
				var v79 := "gio";
				var v80: array<int> := new int[8];
				var v81: map<bool, string> := map[f38 || v77[p3] := v79[0x1da := f37]];
				v80[422] := p0;
				var v82: set<int> := {fm20(globalState)};
				var v83: seq<set<int>> := [v82, v82, {p0}, v82, v82];
				v78, v79, v80, v81, v80[422] := v78 - (v78 * fm26(v77[p3], p0, p1, globalState)), v79, v80, map[f28 := v79], |(v83 + [{p0}])| + p0;
				var v84 := new C0(v79, --36, f27, f28);
				globalState.f21 := v80[422];
				var v85 := DC14(f27);
				...
				var v92: array<map<int, string>> := new map<int, string>[15] [v87, v87, map[v80[422] := "je"], v87, map v88 : int | (0x223 <= v88) && (v88 < -19) :: (v88 % 0x1fe) := (v79), if (p3 in v89) then v89[p3] else v90[v80[422]], v87, v87 + DC15(v87).cf25, fm28(|[|map[f38 := f38]|, p3, p3]|, globalState), v87 + v87, map v91 : int | (0x238 <= v91) && (v91 < 0x181) :: (v91 + p0) := ("fnogundpk"), v87, v87[p0 := v79], if (f28) then v87 else v87, v87];
				v92[948] := v87;
				f27[241], globalState.f13, v92[948], globalState.f15 := f38, -p0 / v80[422], v87, f28 ==> f38;
			} else {
				...
				v97[275] := if (p0 in v100) then v100[p0] else seq(0x1d4, i2  => (v98));
				v97[275] := v99 + v99;
				var v101 := "jjcirftt";
				var v102 := m13(f38, f28, |fm29(f38, true, globalState)|, v101, globalState);
				var v103, v104 := m0(globalState);
				var v105 := new C0(v101 + (seq(0x274, i3  => (f37))), p3, if (!f28) then f27 else f27, fm22(false, p0, globalState));
			}
			
			var v106 := "nke";
			var v107 := new C0(("unybyg" + v106)[p0 := f37], |[fm20(globalState)]|, f27, f28);
			...
			if (!fm22(f38, p3, globalState)) {
				...
				v112 := v113[p0] + [f38, v112[p3], !f38];
			} else {
				var v114: map<int, bool> := map[p3 := !f28];
				var v115: multiset<int> := multiset{p0, p3};
				v114 := v114[p0 := v115[p3 := p3] !! v115];
				var v116: array<int> := new int[10];
				var v117: multiset<array<int>> := multiset{v116, v116, v116};
				f27[426] := v116 !in v117;
				f27[426] := f38;
				globalState.f4 := (p0 % p0) - p3;
				var v118: seq<bool> := [f27[426], f28];
				var v119: array<char> := new char[28] [p1, p1, p1, f37, f37, f37, f37, 'h', p1, f37, p1, f37, f37, f37, if (f38) then f37 else f37, p1, v107.f36[|v118|], f37, p1, f37, 'y', p1, f37, f37, f37, f37, f37, f37];
				v119 := v119;
		...
		if (f38) {
			...
			v128 := v128[v127 + (if (f38 in v129) then v129[f38] else [v126, v126]) := |(multiset{v130, v130} + v132[|v123|])|];
			v130[824] := p3;
			v130[824] := p3 / -0xf0;
		} else {
			...
			if (|v136| != p3) {
				...
				var v139 := "kkbyosc";
				v138 := new seq<bool>[15] [v136, [f38], v136, v136, fm25(-p3, -p0, p0, globalState), v136, (v136 + v136)[|v139| := f28], v136, v136 + v136, v136, v136, v136, v136 + v136, v136, [!false, f28, f28] + [f38, false]];
				var v140: multiset<int> := multiset{p0, p3};
				v133[580] := |v140|;
				var v141: array<array<int>> := new array<int>[28];
				v141[466] := v133;
				v133[580], globalState.f13, globalState.f21, globalState.f5, v141[466] := p0, p3, p3, |(if (fm22(f28, p0, globalState)) then [f28, v136[0x3be], !fm22(f28, p0, globalState)] + v136 else v136)|, v133;
				globalState.f5 := v133[580];
				var v142: T1 := new C0(v139, v133[580], f27, f28);
				var v143: map<T1, int> := map[v142 := 0x21e];
				var v144: map<map<T1, int>, bool> := map[v143 := f38];
				var v145: seq<int> := [p3];
				var v146 := DC4(DC0(v144, f28, v145[128], f37, v142.f28));
				globalState.f5, v146 := p3, v146;
			} else {
				var v147: map<bool, bool> := map[!f28 := f28];
				globalState.f21 := |v147| % p0;
				var v148: seq<array<bool>> := [f27, f27, f27, f27];
				var v149: array<map<int, bool>> := new map<int, bool>[27];
				v148, globalState.f21, globalState.f5, v149 := v148, (|[|"syuird"|, p0]| % p0) - p3, -p3, v149;
				globalState.f13 := p0;
				f38 := f38;
				globalState.f6 := f38;
			}
		...
		var v150: array<seq<D1>> := new seq<D1>[10](i7 => [DC5([[p0]])] + [DC5([seq(0x5a, i8  => (p3)), [p3, p3]]), DC5([seq(325, i9  => (p0)), [p0, p0, p3, p3, p3]]), DC5([[p0, p0]])]);
		forall i6 | 0 <= i6 < v150.Length {
			v150[i6] := seq(0x119, i10  => (DC5([[p0, p0, p3]])));
		}
		if (!f28) {
			globalState.f5 := p3;
			var v151: set<int> := {p3};
			if ((set v152 : int | v152 in v151 :: (v152 + -414)) > (set v153 : int | (-827 <= v153) && (v153 < 0x2ef) :: (v153 / p3))) {
				var v154: array<int> := new int[28](i11 => i11 + |(seq(13, i12  => (f37)))|);
				v154[401] := 0x1d;
				var v155 := "mrefi";
				...
				globalState.f4, v154[401], v154[759], v159, globalState.f4 := p3, p0, p0, v159[v158 := p3], p0;
				var v160, v161 := m0(globalState);
				globalState.f21 := p3 * v154[401];
				...
				f27[209] := f28;
				f27[209] := (p0 / -p0) < -(if (p3 in v122) then v122[p3] else p3);
				var v166: multiset<char> := multiset{'m'};
				var v167: seq<multiset<char>> := [v166, v166];
				var v168: array<bool> := new bool[13] [f38, f38, f28, f27[209], !f27[209], f38, f38, true, !f28, !f28, f27[209], f28, f38];
				var v169 := new C0(fm32(p0, f27[209], globalState), -(|v167| - -p0), v168, f28);
				globalState.f13 := p0;
				p2[825] := ("k" + v169.f36)[p3 := p1];
				p2[825] := v169.f36;
				globalState.f6 := if (f27[209]) then f38 else f38;
			}
			
			var v170 := "pteeog";
			var v171 := new C0(v170, p3 / p3, f27, f38);
			...
			if ((|v173| > 0x2b7) || f28) {
				...
				v174[907] := multiset{f38};
				v174[907] := if (f38) then v121 else if (v173[p0]) then multiset(fm25(p0, p0, p0, globalState)) else multiset{false, f38, f28, f28, f28};
				...
				globalState.f5 := |(seq(515, i14  => (v121)))|;
			} else {
				var v179: array<int> := new int[29];
				var v180: map<int, array<int>> := map[p3 := v179];
				v180 := v180[p0 % -p3 := v179];
				var v181: seq<int> := [p3, -p3, p3];
				var v182: multiset<int> := multiset{|multiset(v181)|, p3 % p3};
				var v183: array<bool> := new bool[14];
				var v184: seq<multiset<bool>> := [v121];
				var v185: array<multiset<bool>> := new multiset<bool>[18] [v121, v121, v121 - v121, v121 + v121, v121 + v121, v184[|v170|], multiset{f38, f28, fm22(f28, p0, globalState), f28} * multiset(v173), if (!f28) then (multiset(v173))[f28 := p0] else v121, if (f38) then v121 else v121, v121, multiset{f38}, v121 * v121, v121 + v121, v121, v121 - v121, v121, v121, v121 - v121];
				v185[670] := v121;
				f38, v182, globalState.f4, v183, v185[670] := f28 && f38, v182, v171.fm15(globalState), f27, v121;
				globalState.f4, v172 := p3, v172;
				globalState.f13 := (p0 - p0) % -p3;
				var v186: array<char> := new char[9](i15 => p1);
				var v187: seq<array<char>> := [v186];
				globalState.f21 := |v187|;
			}
			
			var v188: array<seq<D5>> := new seq<D5>[24](i16 => seq(0x112, i17  => (DC12(seq(458, i18  => ({f28, f28, f38}))))));
			v188 := v188;
		} else {
			var v189: seq<bool> := [f38, f28];
			var v190: multiset<int> := multiset{|v189|, p3};
			var v191: map<bool, int> := map[f38 := p3];
			var v192: seq<multiset<int>> := [v190[|v191| := p0], v190];
			globalState.f6 := ([v190, v192[p3]] + (seq(259, i19  => (v190)))) != v192;
			var v193 := "iiaprsa";
			var v194 := new C0(v193 + v193, p0, f27, f38);
			var v195: array<array<bool>> := new array<bool>[1];
			var v196: seq<array<array<bool>>> := [v195];
			var v197: array<array<array<bool>>> := new array<array<bool>>[20] [v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v195, v196[p3], if (!f38) then v196[p0] else v195, v195, v195, v195];
			v197[866] := v195;
			globalState.f17, v197[866], globalState.f6 := f28, v195, f38;
			...
			match (v199) {
				case DC8(cf15) =>
					...
					globalState.f5, globalState.f13 := p3 % |cf15|, if (f38) then p0 else -fm20(globalState) * |v206|;
					globalState.f21 := p0;
			}
			
			globalState.f13, r0 := p0, v189[0xec];
		}
	...
	method m13(p0: bool, p1: bool, p2: int, p3: string, globalState: GlobalState) returns (r0: D0) {
			...
			decreases 100 - i0
		{
			...
			v9[55] := v10[0x100];
			var v11: array<string> := new seq<char>[11](i1 => seq(503, i2  => (f37)));
			v11[80] := p3;
			...
			v4, v9[55], v11[80], globalState.f15 := v4, v5 - v5, p3[|v12| := f37], v13[p2 / |v15|];
			v4 := v4;
			globalState.f5 := -p2;
			v11[80] := p3;
		}
		if (p0) {
			if (p0) {
				var v16: seq<int> := [p2];
				var v17: seq<int> := [|v16|];
				var v18: map<bool, int> := map[p1 := v17[p2]];
				...
				var v30: array<int> := new int[25] [-p2, v21.fm15(globalState), p2, p2, p2, p2, p2, if (false) then p2 else 0x90, |fm33(-p2, f28, globalState)|, p2 + p2, -(|"sdbbk"| + p2), p2, p2, |(v27.cf30 + v28[v21.fm15(globalState)])|, p2, p2, p2, p2, v24[p2], p2, -|map[v23[p2] := f28]|, p2, p2, p2, |v29[f38 := f28]|];
				v30[406] := p2;
				var v31: multiset<int> := multiset{|v24|, p2};
				v30[406] := (-p2 % |v31|) % (p2 % p2);
				globalState.f4 := v30[406];
				var v32: T0 := new C1(f38, f27, p1);
				var v33: map<T0, map<bool, bool>> := map[v32 := v29[false := p0]];
				var v34: set<int> := {v30[406], p2, |v33|, p2};
				globalState.f15 := {p2, p2, -v30[406]} <= v34;
			}
			
			var v35: map<int, bool> := map[-p2 % p2 := p0];
			...
			match (DC12(v38).(cf20 := if (v40 in v39) then v39[v40] else v38)) {
				case DC13(cf21, cf22, cf23) =>
					...
					var v44: seq<int> := [p2];
					globalState.f13, globalState.f5, v43 := p2, |v44| / p2, v43;
					var v45: seq<array<bool>> := [f27, f27, f27];
					var v46: seq<seq<array<bool>>> := [(v45 + v45)[p2 := f27], v45 + v45, v45, v45 + v45];
					v45 := v46[p2];
					globalState.f6 := cf23;
				case DC12(cf20) =>
			...
			if (v54.f39) {
				...
				var v57: seq<int> := [p2, |"vxsf"| / p2, |v56|, p2];
				var v58 := DC8(v57);
				v57 := v58.cf15;
				var v59 := DC18(p2);
				...
				var v62 := DC8(v61);
				var v63: map<D2, int> := map[v62 := v61[0x3cb]];
				...
				var v72: array<map<D2, int>> := new map<D2, int>[25] [v65[p2], v63, v63, v63, v63 + v63[DC8(v61) := p2], fm43(p2, v66, p2, f38, globalState), v63, (map v67 : D2 | v67 in v68 :: (v67) := (p2)) + map[v62 := p2], map[v62 := 592], v63 + v63, v63, map[v62 := p2] + v63, v63 + v63, v63, v63, v63 + v63, map[DC8([|p3|, p2, |v61|]) := |v69|] + v63, v63 + v63, v63[v62 := p2], v63 + v63, map[DC8([p2, |p3|]) := p2] + v63, v63, if (p2 in v70) then v70[p2] else map v71 : D2 | v71 in v68 :: (v71) := (p2), v63 + v63, v63 + v63];
				v72[399] := v63;
				v72[399] := v63 + v63;
				...
				var v80: array<int> := new int[19] [-p2 + 922, if (f28) then p2 else p2, p2, |v61| % |v73|, p2, p2, DC0(v77, f28, |v78|, f37, p1).cf2, v75.f29, v75.f29 + |v79|, p2, v75.f29, v75.f29, p2, p2 % p2, |p3| % -|p3|, p2, p2 - v75.f29, (if (-v75.f29 in v79) then v79[-v75.f29] else v75.f29) - |v74|, |v78|];
				v80[185] := p2;
				var v81: array<set<bool>> := new set<bool>[16];
				var v82: set<bool> := {fm40(globalState), p1, !p1};
				v81[878] := v82;
				globalState.f17, globalState.f6, v80[185], v81[878] := v54.f39, p0, p2, {p1};
		...
		if (!!!p1) {
			if (f28) {
				...
				v91[477] := p2;
				v91[477] := p2 * p2;
				globalState.f4 := v91[477];
				var v92, v93 := m0(globalState);
			} else {
				var v94: set<bool> := {p1, f28};
				var v95: C0 := new C0(seq(0x101, i5  => (f37)), p2, f27, |p3| < |v94|);
				v95 := v95;
				var v96 := "cplehhjuc";
				var v97: array<int> := new int[23];
				v97[335] := 0x357;
				var v98: map<bool, int> := map[v94 >= v94 := v95.fm15(globalState)];
				globalState.f4, v96, globalState.f13, v97[335] := p2, p3 + (seq(0x4a, i6  => (f37)))[p2 := f37], if (p1 in v98) then v98[p1] else p2, p2;
				var v99 := DC23(f38);
				var v100: multiset<D9> := multiset{DC23(p0), v99, v99};
				var v101: seq<bool> := [f38];
				var v102: map<bool, bool> := map[f38 := f28];
				var v103 := new C0(v95.f36, p2 - |(multiset{v100, v100, multiset{v99, DC23(v101[p2])}})[v100 := v97[335]]|, f27, (if (f38 in v102) then v102[f38] else f28) <==> f28);
				globalState.f21 := p2;
			...
			if (p1) {
				...
				var v114: multiset<int> := multiset{-v111[p2], -v110, -0x1f8, p2 * p2, |(if (f28) then v113 else v113)|};
				...
				v120[905] := fm36(globalState) - p2;
				v120[905] := |v117| + p2;
				globalState.f13 := v120[905];
			}
			...
			var v125: set<bool> := {v124[p2]};
			v121[880] := |v123| + |map[p0 := |v125|]|;
			var v126: map<char, int> := map[f37 := |p3|];
			v121[880] := if (f37 in v126) then v126[f37] else -p2;
		} else {
			...
			f27[183] := p2 == -(0x33d * p2);
			var v131 := "cqp";
			var v132: array<bool> := new bool[8] [p1, f28, f28, p1, p1, f27[183], f27[183], p0];
			var v133: T1 := new C0("p", p2, v132, f27[183]);
			...
			match (v136) {
				case DC18(cf31) =>
					...
					var v140: seq<bool> := [v133.f28, !v133.f28, f27[183], true];
					var v141: map<string, seq<bool>> := map[p3 := v140[v133.f29 := p1]];
				...
				case DC17(cf30) =>
					...
					v144[87] := v135;
					v144[87] := v135;
					var v145: map<bool, array<int>> := map[p0 := v144[87]];
					var v146: map<int, array<int>> := map[v133.f29 := if (f27[183] in v145) then v145[f27[183]] else v135];
					v146 := v146[fm20(globalState) := v144[87]];
					var v147: seq<bool> := [v133.f28];
					var v148: set<int> := {|(v147 + v147)|, v133.f29};
					v148, globalState.f5, globalState.f25 := v148, 0x2b2 - p2, v131[p2];
					globalState.f13 := |map[v133 := |p3|]| - p2;
				case DC20(cf32) =>
					var v149: T0 := new C1(true, v133.f27, p1);
					var v150: map<bool, T0> := map[p1 := v149];
					var v151: map<int, T0> := map[p2 / v133.f29 := if (p1 in v150) then v150[p1] else v149];
					v151 := v151[v133.f29 := v149];
					var v152: array<map<set<int>, int>> := new map<set<int>, int>[29];
					var v153: set<int> := {v133.f29};
					v152[165] := map[v153 := v133.f29];
					var v154: map<bool, bool> := map[true := f28];
					var v155: map<int, int> := map[|v154| := v133.f29];
					var v156: map<bool, int> := map[true := v133.f29];
					var v157: map<set<int>, int> := map[{826, p2, |v155|, p2, -p2} + v153 := |v156| % p2];
					v152[165] := v157;
					...
					var v161: seq<string> := [v131, if (v133.f28 in v160) then v160[v133.f28] else seq(-0x132, i9  => (f37))];
					var v162: seq<int> := [p2];
					var v163 := DC7(f37, v131);
					var v164: array<string> := new string[25] [v131, fm32(-v133.f29, v133.f28, globalState), v161[|v162|], p3, v131, p3, v131, v131, v163.cf14, v131, fm32(v133.f29, p0, globalState), p3 + p3, p3, p3, fm32(v133.f29, f28, globalState) + v131, p3, v131, p3, v131, p3, v161[0x264], v131, p3, v131 + p3, v131 + v131];
					v164[792] := "obsvgeys";
					v164[792] := v131;
			}
...
class C3 extends T1 {
	...
	method m10(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: char, r3: int) {
		...
		var v4: seq<bool> := [v3[f29]];
		var v5: seq<seq<bool>> := [v4];
		var v6: seq<int> := [f34];
		var v7 := 'p';
		var v8: T1 := new C0(v2.f36, f29, f27, p0);
		var v9: map<string, T1> := map[v2.f36[v6[f29] := v7] := v8];
		...
		var v23 := DC11(v22);
		r0 := fm14(|v6|, set v24 : multiset<bool> | v24 in v23.cf19 :: (v24), globalState) <= v6[f34];
	...
	method m11(p0: bool, globalState: GlobalState) returns (r0: int, r1: string, r2: bool) {
			...
			decreases 100 - i2
		{
			...
			if (!p0) {
				...
				var v20: T0 := new C1(f28, v19[f29], p0);
				var v21 := DC14(f27);
				var v22: map<int, D6> := map[f34 := v21];
				var v23: set<map<int, D6>> := {v22, v22};
				v15, r2, f29, r1, v20 := (v15 + [p0]) + [f28, p0], !((v23 - v23) <= v23), |v14.f36|, seq(0x38c, i3  => ('o')), if (p0 ==> f28) then v20 else v20;
		...
		match (match v35 {
			...
			case DC18(cf31) =>
				...
				var v45: array<int> := new int[25] [f34, v36.cf12, fm14(|v37[|v38| := f29]|, v3, globalState), |v32| / |v33|, cf31, -cf31, cf31, f34, -|v0|, fm36(globalState), cf31, |v32|, f34, -f34, fm36(globalState), -535, |v40|, -|v32|, cf31, f34, f29 / |v11|, cf31, f34, |v42|, |fm45(877, p0, f29, if (v43 in v44) then v44[v43] else !p0, globalState)|];
				v45[679] := cf31;
				v45[679] := f29;
				globalState.f15 := f28;
				v45[679] := f29 - f34;
			...
			case DC17(cf30) =>
				...
				if (v32 != v32) {
					...
					var v57: map<int, char> := map[597 * -f34 := v32[|v56|]];
					v57 := v57[f34 := v32[f29]];
				} else {
					...
					var v61: map<map<int, bool>, seq<seq<char>>> := map[v59[f34] := v60];
					v61 := v61[v0 + v0 := seq(-0xe7, i5  => (v32))];
					v2 := v2;
					globalState.f13 := f29;
					globalState.f21 := v33[f29];
				}
			...
			case DC20(cf32) =>
				...
				var v65: seq<C1> := [v64];
				f29 := if (!(v64 in v65)) then f29 % f29 else |(v31[427] + v30)|;
				globalState.f15 := v64.f39;
				globalState.f15 := p0;
				var v66: C0 := new C0(v32, f34, f27, f28);
				var v67: seq<C0> := [v66];
				var v68: set<C0> := {v67[f34], v66};
...
class C4 {
	...
	function fm12(p0: int, p1: string, p2: bool, globalState: GlobalState): multiset<map<bool, bool>> {
		match DC6(|multiset{0xbb, |(seq(55, i0  => (-962)))|}|) {
	...
	method m8(p0: seq<int>, p1: int, p2: multiset<map<bool, int>>, p3: D3, globalState: GlobalState) returns (r0: int, r1: bool, r2: set<int>, r3: seq<int>) {
		...
		for i0 := |[|v0|, p1, v3.f29]| to if (v9.f39) then v3.f29 else p0[p1] {
			var v10 := DC3(fm36(globalState), v9.f39, v3.f28);
			v3.f27[799] := v10.cf8;
			v3.f27[799] := !v1;
			var v11: set<bool> := {v9.f39};
			var v12: multiset<set<bool>> := multiset{if (v3.f27[799]) then {v1, v3.f27[799]} else v11};
			v12 := if (DC3(v3.f29, true, false).cf9) then v12 else v12;
			globalState.f25 := v0[fm36(globalState)];
			v3.f27[799] := v11 > (v11 * v11);
		}
		var i1 := 0;
		while (v3.f28)
			decreases 100 - i1
		{
			...
			globalState.f13, v14, v18, v20[349], globalState.f17 := v3.f29, v14, map[v16 := v3.f29 != v3.f29], v21, v22.cf8;
			var v23: array<D8> := new D8[10];
			var v24: multiset<array<D8>> := multiset{v23};
			v24 := v24;
			v22 := DC3(v3.f29, v9.f39, v3.f28);
			globalState.f4 := p1 + p0[p1];
		}
		...
		v25[462], globalState.f13, v3.f27[133] := v28, p0[p1 / |(if (v3.f28 in v29) then v29[v3.f28] else v0)|], v3.f28;
		r0 := p1;
		r1 := v9.f39;
		r2 := set v30 : int | v30 in (map[-0x1bb := v9.f39])[|v0| := v3.f27[133]] :: (v30 * -(-|{true, false, true, !false, true}| - |multiset{['r']}|));
		r3 := p0[v3.f29 := p1] + p0;
	}
	method m9(p0: int, p1: array<int>, p2: bool, p3: int, globalState: GlobalState) {
		...
		if (if (v3.f36 <= v0) then (set v4 : int | (0x26f <= v4) && (v4 < 0xcf) :: (v4 / p3)) > v5 else !p2) {
			var v6 := 'r';
			var v7 := DC7(v6, v3.f36);
			match (if (p2) then v7 else v7) {
				case DC6(cf12) =>
					var v8 := new C1(p2, v2, p2);
					var v9 := DC5(seq(0x3b2, i1  => ([cf12, cf12, p3, |v3.f36|, p0])));
				...
				case DC7(cf13, cf14) =>
					...
					p1[701] := p3;
					p1[182], v17, p1[701] := p0 % p0, v17 + (v17 + [map[p0 := p3], map[p0 := -0x2c7]]), p3;
					cf13 := v6;
				case DC5(cf11) =>
					...
					var v21: seq<bool> := [p2];
					v20 := v20[v19 + {p2} := !v21[p0]];
			}
			
			var v22: seq<int> := [p0];
			var v23: set<bool> := {p2};
			var v24: multiset<int> := multiset{v22[|[v23]|]};
			var v25: map<multiset<int>, char> := map[(v24[p0 := p3])[p3 := p0] := v6];
			...
			match (v35) {
				case DC18(cf31) =>
					...
					globalState.f6 := if (p2) then v36[-p3] else !(if (635 in v37) then v37[635] else p2);
					var v38: seq<set<int>> := [v5, v5, v5];
					var v39: multiset<int> := multiset{p0, p0, p3};
					globalState.f17 := {cf31} >= v38[|v39|];
				...
				case DC19() =>
					var v48 := 'r';
					v0 := v3.f36[fm36(globalState) := v48];
					var v50: seq<set<int>> := [v5];
					v0, globalState.f17, globalState.f15 := fm32(p0, p2, globalState), p2, !((map v49 : int | v49 in v50[|v5|] :: (v49 + |"l"|) := (p0)) == ((map v51 : int | (0x267 <= v51) && (v51 < 0x325) :: (v51 / -|(seq(0x25, i2  => (v48)))|) := (-578)) + (map v52 : int | (0x313 <= v52) && (v52 < -0x49) :: (v52 % -p3) := (p3))));
					var v53: multiset<bool> := multiset{p2, p2};
					var v54: map<int, int> := map[p0 := |v53|];
					var v56: C1 := new C1((set v55 : int | v55 in v54 :: (v55 - |(seq(0x299, i3  => (|multiset{true, false}|)))|)) > v5, v2, p2);
					v56, globalState.f6 := v56, p2;
					globalState.f5 := fm36(globalState) % (v3.fm15(globalState) / p0);
				case DC17(cf30) =>
					...
					globalState.f4 := (p3 % p3) / p0;
					globalState.f5 := (fm36(globalState) - p3) / (0x271 % 0x287);
					var v59: array<char> := new char[23](i4 => 'r');
					var v60 := 'u';
					v59[456] := v60;
					var v61: seq<int> := [145];
					var v62: multiset<bool> := multiset{v61[p3] < |v3.f36|};
					var v63: seq<bool> := [p2];
					var v64: map<int, int> := map[p0 := p0];
					var v65: seq<seq<int>> := [v61];
					var v66 := DC3(|v61|, p2, p2);
					globalState.f13, globalState.f21, v59[456], v62, globalState.f5 := |(v63 + v63)| % p0, if (fm36(globalState) in v64) then v64[fm36(globalState)] else |(v65[p0] + [p0])|, if (p2) then v60 else v60, v62 + multiset{p2}, (|fm0(map[p3 := v5], p2, v66.cf8, globalState)| + p3) % p0;
				case DC20(cf32) =>
					v2 := v2;
					globalState.f6 := !p2;
					var v67: seq<array<int>> := [p1];
					var v68: set<array<int>> := {v67[p0], p1};
					var v69 := DC3(p0, !p2, p2);
					var v70: map<D0, int> := map[v69 := p3];
					var v71: T1 := new C3(|"vfeldy"|, v70, p0, v2, p2);
					var v72: map<T1, int> := map[v71 := v71.f29];
					var v73: map<int, bool> := map[|multiset(seq(324, i5  => (p0)))| := p2];
					...
					globalState.f5, v68, v2[582], v2[855], v71.f27[523] := 0x2d0, if (false) then v68 else v68, v71.f28, fm40(globalState), |(v77 + v77)| >= (v71.f29 % p3);
					var v78: multiset<bool> := multiset{v2[582]};
					v78 := v78;
			}
		...
		v2[830] := p2;
		globalState.f5, globalState.f4, v2, v2[830] := p0 * p0, p0, v2, false;
		var v80: map<map<bool, bool>, int> := map[map[v2[830] := false] := p0];
		var v81: map<bool, bool> := map[v2[830] := !v2[830]];
		for i6 := if (v81 in v80) then v80[v81] else |v3.f36| to --130 {
			var v82: map<bool, set<int>> := map[p2 := v5];
			var v83 := new C2('t', p2, v2, !(v5 !! (if (v2[830] in v82) then v82[v2[830]] else v5)));
			var v84: map<bool, int> := map[true := p3];
			var v85: map<bool, seq<map<bool, int>>> := map[false := [v84]];
			var v86: map<int, seq<map<bool, int>>> := map[|v5| := if (v2[830] in v85) then v85[v2[830]] else [v84, v84]];
			var v87: seq<map<bool, int>> := [v84];
			v86 := v86[i6 := v87];
			var v88: seq<bool> := [v83.f38, v83.f38, v83.f38];
			var v89: multiset<bool> := multiset{v83.f38};
			if (multiset((v88 + v88)[|v3.f36| := v2[830]]) > v89) {
				var v90: seq<array<bool>> := [v2];
				v2[830], v2[830], globalState.f5 := v90 != v90, -0x25d == p0, |fm18(p2, p3, v83.f37, globalState)|;
				var v91: map<map<bool, int>, int> := map[v84 := i6];
				var v92 := DC17(v91);
				var v93 := DC20(v92);
				globalState.f13, v93 := 0x37e, v93;
				globalState.f4 := p0 % p3;
				v0 := v3.f36;
				...
				globalState.f21 := (p0 / --p3) - v83.fm20(globalState);
				var v99: map<map<bool, int>, int> := map[v84 := p0];
				var v100 := DC20(DC17(v99));
				v100 := v100;
			}
			
			var v101: array<string> := new string[14] [v3.f36, "meyjff" + (seq(0x253, i7  => (v83.f37))), v0, v3.f36, "kqcgi" + v3.f36, v3.f36, v3.f36[p3 := 't'], "krlvulblo", "b", v3.f36, v0, seq(0x20d, i8  => (v83.f37)), v0 + v3.f36, seq(0x2dd, i9  => (v83.f37))];
			v101[215] := v3.f36;
			var v102 := DC21(v101);
			var v103: map<D9, string> := map[DC24(v102).(cf39 := v102) := "wgbvpofn"];
			var v104 := DC24(v102);
			v101[215] := v3.f36 + (if (v104 in v103) then v103[v104] else v0)[525 := v83.f37];
		}
		var v105: seq<map<int, bool>> := [map[p3 := p2]];
		globalState.f5 := |v105| - (p0 + p0);
		p1[726] := p3;
		p1[726] := -(p0 / |map[v2[830] := v2[830]]|);
	}
}
...
class C5 extends T1 {
	...
	method m7(p0: bool, p1: map<set<int>, string>, p2: map<bool, string>, globalState: GlobalState) returns (r0: int) {
		...
		v0[337] := |(if (p0) then v4 else v4 + v4)|;
		for i1 := v0[337] to -(f29 % v0[337]) {
			globalState.f17 := p0;
			var v8: multiset<set<int>> := multiset{set v5 : int | (-224 <= v5) && (v5 < 0x39e) :: (v5 * |(set v7 : char | v7 in (map v6 : char | v6 in map['s' := i1] :: (v6) := (|(seq(0x355, i2  => ('l')))|)) :: (v7))|), v3, v3 * v3};
			var v9: seq<set<int>> := [v3];
			v8 := (multiset(v9) - v8)[v3 := v0[337] * f29];
			var v10 := 'g';
			...
			match (fm8(if (true) then v11 else v11, globalState)) {
				...
				case DC9(cf16) =>
					...
					var v18 := "jrlr";
					v17 := fm11(v1 > v1, !(v18 <= (seq(-0x141, i3  => (v10)))), p0, globalState);
					var v19 := DC3(f29, p0, p0);
					var v20: map<D0, int> := map[v19 := i1];
					var v21 := new C3(f29 * v0[337], v20, f29, f27, p0);
					var v22: array<string> := new string[20];
					v22[199] := v18;
					v22[199] := v18 + (if (p0 in p2) then p2[p0] else v18[f29 := v10]);
			}
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v23: multiset<int> := multiset{v0[337]};
			var v24: map<int, array<int>> := map[v0[337] := v0];
			var v25: map<bool, int> := map[p0 := |v24|];
			var v26: map<bool, map<bool, int>> := map[f28 := v25];
			var v27: multiset<map<bool, int>> := multiset{(map[!p0 := v0[337]])[p0 := |map[p0 := v23]|], v25, if (f28 in v26) then v26[f28] else v25};
			globalState.f6 := v27 !! v27[v25 := 922];
			var v28: seq<int> := [v0[337], v0[337], f29, 441];
			var v29 := "mcumuyosc";
			var v30: seq<int> := [|fm25(v28[|v29|], v0[337], f29, globalState)|];
		...
		var v36: seq<int> := [-v0[337]];
		var v37: map<bool, bool> := map[{v36, v36} >= {DC8(v36).cf15} := 0xf3 != v0[337]];
		v37 := v37;
		var v38 := "g";
		globalState.f5 := |v38|;
	...
	method m6(p0: bool, p1: bool, p2: int, globalState: GlobalState) {
		...
		match (v10) {
			...
			case DC1() =>
				...
				var v20: array<int> := new int[16](i1 => i1 / |map[p0 := p1]|);
				v20[897] := f29 - v19.f34;
				...
				var v24: multiset<array<int>> := multiset{v21[v19.f34]};
				var v25: map<C5, int> := map[v23 := |v24|];
				v20[897] := (-(if (v23 in v25) then v25[v23] else v7) % v19.f34) - v7;
			case DC2(cf5, cf6) =>
			...
			case DC4(cf10) =>
				...
				var v44: multiset<array<int>> := multiset{v42, v43[v7], v42};
				v42[355] := |v44|;
				v42[355] := fm5(globalState);
				var v45: map<char, seq<array<int>>> := map[v1 := v43];
				var v46 := new C5(if ('q' in v45) then v45['q'] else v43, v7, f27, v41[v42[355]]);
				var v47: seq<int> := [v7, v39.fm15(globalState), 0x196, --0x170, fm36(globalState)];
				globalState.f13, globalState.f15, v43, globalState.f6 := v47[p2] * (v7 % fm36(globalState)), v41 <= v41, v46.f33, !p0 ==> p1;
		}
...
class C7 extends T0, T1 {
	...
	method m5(globalState: GlobalState) returns (r0: int, r1: int) {
		...
		r0, globalState.f25, globalState.f17, r0 := f29, v0, !!f28, f29 % v2[f29];
		var v3 := "yaenitp";
		...
		match (v4) {
			case DC8(cf15) =>
				...
				var v14: array<int> := new int[29] [f29, f29, fm4(v7[f29], globalState), f29, |v3|, f29, f29, |v8|, f29, f29, if (true in v1) then v1[true] else f29, f29, 0xdc, f29, |v11[f29]|, --f29, f29, f29, 0x338, f29, f29, 20, 0x168, fm4(if (f29 in v12) then v12[f29] else v6, globalState), f29, |cf15|, 660, |v3|, -|v13|];
		...
		for i0 := f29 to f29 {
			...
			match (DC27(v25)) {
				...
				case DC27(cf42) =>
					...
					var v33: seq<multiset<bool>> := [v31[v24.f39 := f29], if (i0 in v32) then v32[i0] else v31, v31];
					globalState.f6 := (if (f29 in v30) then v30[f29] else |v33[i0]|) <= i0;
					...
					var v37: multiset<array<int>> := multiset{v35, v35, v36[f29], v35, v35};
					globalState.f17 := v37[v35 := f29] > v37;
			}
...
class C8 extends T0 {
	...
	function fm3(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): seq<seq<int>> {
		DC5([seq(729, i0  => (-103))]).cf11 + [[323], [-823, |multiset{164}|], [|[f28]|], DC8([-|[-0x169]|]).cf15]
	}
	method m3(p0: int, globalState: GlobalState) returns (r0: seq<array<int>>, r1: bool) {
		...
		v4, r1, v8 := v4, if (true) then f28 else v9[p0], v8;
		v4 := v4[f28 := v0.f28];
		var i0 := 0;
		while (v0.f28 || f28)
			decreases 100 - i0
			...
			decreases 100 - i2
		{
			...
			if (v19.f39) {
				...
				v23[52] := v0.f27;
				var v24: C4 := new C4();
				r1, globalState.f6, v23[52], v24 := v19.f39, v0.f28, if (if (v0.f28) then v19.f39 else v0.f28) then v0.f27 else v0.f27, v24;
				globalState.f17 := if (f28) then v9[p0] else if (v0.f28 in v4) then v4[v0.f28] else !v19.f39;
				...
				globalState.f5 := v0.f29 % v30.fm7(f32, globalState);
				...
				v31[681], v35[614], v7, v26, globalState.f15 := f32, v34, v36[|v32|] + v7, v34.cf22, v18 !! v18;
			}
	...
	method m4(p0: int, globalState: GlobalState) {
		...
		var v3: array<int> := new int[6] [|v1.cf6|, -p0, p0, |v2|, |(seq(388, i0  => (f32)))|, p0];
		var v4 := "wuevn";
		var v5: map<string, array<int>> := map[v4 := v3];
		var v6: seq<array<int>> := [v3, v3, v3, v3, v3];
		var v7: array<array<int>> := new array<int>[16] [if (!f28) then v3 else v3, v3, v3, if ((v4[p0 := fm42(p0, globalState)])[p0 := f32] in v5) then v5[(v4[p0 := fm42(p0, globalState)])[p0 := f32]] else v3, v6[p0], if (f28) then v3 else v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3];
		v7[80] := v3;
		v7[80] := v3;
		if (f28) {
			var v8: set<bool> := {f28};
			...
			v10, globalState.f15, v13, v14 := v10, f28, v13, ((if (|(seq(0xa7, i1  => (f32)))| in v15) then v15[|(seq(0xa7, i1  => (f32)))|] else v14) + v14) + (v14 + v14);
			var v16 := new C0(seq(0x2ca, i2  => (f32)), p0 / p0, f27, f28);
			globalState.f17 := f28;
			...
			v21 := v21[v20 := v7[80][271]];
			var v22: multiset<bool> := multiset{true, !!f28};
			var v23: seq<multiset<bool>> := [v22, v22];
			var v24 := DC11(v23);
			var v25: array<D4> := new D4[25] [DC11(v23), v24, v24, v24, v24, v24, v24, if (!f28) then v24 else v24, v24, v24.(cf19 := v23), if (true) then v24 else v24, v24, v24, fm52(p0, p0, v7[80][271], globalState), v24, v24, if (f28) then v24 else DC11(v23), v24, v24, v24, v24, v24, v24, DC11(v23), v24];
			v25 := v25;
			globalState.f4 := v7[80][271];
		}
		
		var v26: map<bool, int> := map[!f28 := p0];
		var v27: map<map<bool, int>, char> := map[v26 := 'i'];
		var v28: seq<bool> := [f28, f28];
		v27 := v27[map[v28[p0] := p0] := f32];
		for i3 := p0 * p0 to |(seq(0x16, i4  => (p0)))| {
			v7[80], globalState.f13 := v3, if (!true) then i3 else p0 * p0;
			...
			match (v32) {
				case DC6(cf12) =>
					...
					v4, globalState.f15 := (v4[p0 := if (f28) then v32.cf13 else f32])[cf12 := f32], !(v34 == v34);
				...
				case DC7(cf13, cf14) =>
					...
					globalState.f15, globalState.f5, globalState.f5, globalState.f4 := (v40 == v40) <== (|v4| > p0), (0x31c / |v41|) + p0, i3, -i3;
			...
			if (fm16(if (v49.cf26) then v50 else v50, globalState)) {
				...
				var v54: multiset<int> := multiset{|(map v51 : char | v51 in v53[f32 := i3] :: (v51) := (i3))|, i3, i3, i3};
				var v55: map<map<bool, char>, int> := map[v2 := |v54|];
				globalState.f5 := if (v2 in v55) then v55[v2] else |v28| - i3;
				var v56: map<int, int> := map[p0 := -i3];
				globalState.f21 := (if (i3 in v56) then v56[i3] else p0) / p0;
				var v57 := DC23(!f28);
				var v58 := DC24(v57);
				var v59 := DC28();
				...
				v58, v59, v60, v65[626] := DC24(DC22(v7[80], !false, v67, v4)), v59, v60, map[p0 := f28] + (v29 + map[p0 := f28]);
		...
		for i6 := |v75| to p0 {
			if (f28) {
				...
				var v89: array<map<multiset<bool>, bool>> := new map<multiset<bool>, bool>[24] [v83, v83, v83 + v83, v83 + v83, v83[v84 := false] + (map v85 : multiset<bool> | v85 in v86 :: (v85) := (v81.f38)), v83, (map[v84 := DC16(v81.f38, v87, v81.f37, v81.f38).cf29])[v84 := fm22(v81.f38, i6, globalState)], v83, if (!v81.f38) then v83 else v83, v83[v84[f28 := p0] := v81.f38], if (!f28) then v83[multiset{f28} := f28] else v83, map[v84 := !v81.f38] + DC29(v83).cf43, v83, v83, v83[v84 := f28], v83, v83, v83, map[v84 := !true], v83, v83, fm53(p0, v1, globalState), v83, fm53(|v88|, v1, globalState)];
				v89[978] := map[v84[f28 := i6] := v81.f38];
				v89[978] := v83 + (map[v84 := f28] + v83);
			} else {
				f27[53] := f28;
				var v90: set<seq<bool>> := {v28};
				f27[53] := v28 !in v90;
				var v91 := DC3(p0, f27[53], f28);
				v91 := v91;
				v3[760] := p0;
				v3[760] := 470 % --(i6 * -p0);
				v3[760] := v3[760];
			...
			var v92 := new C5(v6, -|fm30(f28, seq(0x36b, i7  => (f32)), f28, globalState)|, if (f28) then f27 else f27, f28);
			var v93: map<int, int> := map[--p0 := p0];
			var v94 := DC18(i6);
			var v95: seq<int> := [p0];
			var v96 := new C5(v6, if (v94.cf31 in v93) then v93[v94.cf31] else v95[0x8b], f27, f28);
		}
		for i8 := p0 / p0 to p0 {
			globalState.f4 := i8;
			globalState.f15 := !f28;
			...
			var v102 := new C3(if (f28) then p0 else p0, v98 + v98, p0 % i8, f27, v101.cf17);
			v4, globalState.f4 := v4, (i8 % p0) + (v102.f34 * i8);
		}
	}
}
...
class C9 extends T1 {
	...
	method m1(globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: bool) {
		...
		var v4 := "hulb";
		var v5 := DC3(|v2|, f29 in v3, fm2(v4[--f29], f29, globalState));
		match (v5) {
			case DC0(cf0, cf1, cf2, cf3, cf4) =>
				globalState.f5 := f29;
				...
				globalState.f13 := (f29 / |"efreopb"|) % |v9|;
			case DC1() =>
				var v10: set<bool> := {!f30, f30, fm40(globalState), f30, fm16(v2, globalState)};
				v0[137] := |v10|;
				var v11: seq<int> := [f29 / f29];
				var v12: C0 := new C0(seq(0x1f5, i0  => ('r')), f29, f27, f30);
				var v13: map<bool, C0> := map[f30 := v12];
				var v14: set<map<bool, C0>> := {v13, v13};
				v0[137], v11 := if (v14 == v14) then f29 - f29 else f29, v11[f29 := f29];
				var v15: seq<bool> := [true];
				v0[137] := -(|v15| - (928 / f29));
				var v16 := DC6(|v2|);
				globalState.f13 := f29 % fm4(multiset{v16}, globalState);
				var v17: map<int, int> := map[if (f30) then if (v0[137] in f31) then f31[v0[137]] else v0[137] else f29 := fm1(globalState)];
				globalState.f13 := if (f29 in v17) then v17[f29] else -f29;
			case DC2(cf5, cf6) =>
				var v18: array<D10> := new D10[15];
				globalState.f13, v18 := (f29 - f29) + (f29 - f29), v18;
				var v19 := 'v';
				var v20: seq<bool> := [f29 < f29, f28, f28, |v4| < f29, !(v4[f29 := v19] < v4)];
				globalState.f15 := v20[f29];
			...
			case DC3(cf7, cf8, cf9) =>
				...
				globalState.f5 := fm36(globalState);
				var v26: array<string> := new seq<char>[2](i1 => seq(-0x139, i2  => ('h')));
				v26[774] := v4;
				var v27: multiset<array<int>> := multiset{v0};
				var v28 := 'a';
				v26[774], globalState.f21, r2, v27 := ("fs" + v4) + (v4 + fm18(cf9, f29, v28, globalState)), cf7, f28, v27 - v27;
			case DC4(cf10) =>
		...
		for i3 := |(v4 + v4)| to f29 {
			...
			v36, v37[329], globalState.f21 := v36, v3, v42[i3] - f29;
			v42 := v38;
			...
			if (f30) {
				...
				v38 := v52.cf15[-|v36.f36| := |v53|] + (seq(0x239, i5  => (|v36.f36|)));
				v0[6] := 0x136;
				v0[6] := f29;
				v43[567] := seq(775, i6  => ('s'));
				v43[567] := v36.f36;
			} else {
				f27[474] := f28;
				f27[474] := f28;
				globalState.f4 := -0x1e + |v37[329]|;
				var v54: array<bool> := new bool[24](i7 => !true);
				v54 := v54;
				r1 := !f27[474];
				var v55: seq<set<int>> := [v3, v3, v3 * v37[329]];
				v55 := [v3, v37[329]];
			}
		...
		globalState.f5, v58, f27[639] := f29, v58, v59[f29];
		for i8 := |v4| to 0x249 * f29 {
			f27[639], v4, globalState.f5, globalState.f17 := f28, v4 + v4, f29 + fm36(globalState), f27[639];
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: int) {
		...
		r0 := f29 == f29;
		var v10: set<int> := {f29};
		v10 := v10 + (set v11 : int | v11 in [f29, 250] :: (v11 / |[|map[true := false]|, 44]|));
		r0 := false;
		r1 := f29;
		r2 := (f29 != f29) <== f30;
...
method Main() {
	...
	var v8: array<int> := new int[3](i1 => i1 % |[map[|multiset{v1, v1}| := v2]]|);
	var v9: seq<array<int>> := [v8, v8];
	var v10: map<bool, array<array<int>>> := map[v2 := v5];
	var v11: seq<bool> := [v2, v2];
	var v12: seq<int> := [v1];
	var v13: seq<array<array<int>>> := [v5, if (v11[|v12|] in v10) then v10[v11[|v12|]] else v5];
	var v14 := "prvhys";
	var v15: seq<string> := ["y", v14];
	var v16: map<int, array<int>> := map[76 := v8];
	var globalState := new GlobalState(false, true, 888, true, 0x115, 0x83, true, 0x132, v0, v4, multiset{v1}, if (v3 in v6) then v6[v3] else v5, 0x141, 0x211, v7, false, v9 + v9, false, v13[v1], v15 + v15, 778, 0x1e1, v16, 726, 0x12c, 'u', 792);
	...
	if (multiset{v17} >= v18) {
		...
		v21, v0[5], v1, v0[900], v22 := v21, v2, |fm0(v24[v20], if (v0 in v25) then v25[v0] else v2, v2, globalState)|, |(v12 + v12)| <= (v20 - |v14|), v22;
		var v26 := new C4();
		v14 := (v14 + (seq(751, i2  => ('x')))) + v14;
		v17 := v17[v2 := v20];
	} else {
		v14 := v14;
		...
		v29 := if (v2) then (set v30 : int | (0x29b <= v30) && (v30 < 0x2df) :: (v30 % v1)) + v29 else if (v11[v1]) then v29 else v29;
	}
	...
	if (v2) {
		...
		var v41: multiset<int> := multiset{v1, |v39.cf5|, v12[v1] - |v40|, v1};
		v8[554] := v1 + -v1;
		var v42: map<int, set<int>> := map[v1 := v38];
		var v43: map<int, seq<bool>> := map[v1 := v11];
		v39, v41, v8[554], globalState.f15 := v39.(cf5 := {v1, -v1, v1}).(cf5 := fm0(v42, v2, v2, globalState)), v41, -((|(if (v1 in v43) then v43[v1] else [v2])| % |v11|) * (|v31| + v1)), v2;
		...
		globalState.f17, v48 := v2 in (if (v2) then v49 else v49), fm54(v1 < v8[554], false, v2 || v11[v1], v2, globalState);
		var v50 := DC3(fm36(globalState), fm2(fm42(v1, globalState), |v31|, globalState), !(v2 <==> v2));
		v50 := v50.(cf8 := v8[554] < |v17|, cf9 := v2);
	}
		...
		decreases 100 - i3
	{
		...
		i3 := i3 + 1;
		globalState.f25 := v51;
		v36.m6(v2, v2 && v2, -v58.f34 / |v11|, globalState);
	...
	var v68: map<int, int> := map[|(seq(498, i4  => (v51)))| := |map[v58.f34 := v2]|];
	...
	if (v11[v73]) {
		v1 := v58.f34 / -v58.f34;
		v8[124] := v73;
		v8[124] := fm36(globalState);
		if (false) {
			var v79: map<int, bool> := map[v58.f34 := v70];
			v79 := if (0x234 != v73) then v79 + fm30(if (v8[124] in v79) then v79[v8[124]] else v70, v14, v2, globalState) else v79;
			...
			var v86 := new C5(v85[v58.fm14(0x53, v60, globalState)] + v9[v58.f34 := v84], if (v70) then v58.f34 else -0x57, v0, v70);
			v73 := v73;
		} else {
			v72 := v72;
			v2 := !v2;
			...
			v0[690], v12, v8[124], v8[124], v89[790] := v58.f34 == 0x3bc, v12, fm4(v91, globalState), v58.f34, v0;
		}
		...
		var v96: map<multiset<multiset<int>>, char> := map[v93[v92 := |v95|] := v72];
		v96 := v96[v93 := v51];
	} else {
		...
		if (fm22(!({--179, v58.f34} <= v76), |v15[v73]|, globalState)) {
			...
			v15 := (seq(0x3de, i5  => (v14))) + [seq(0x328, i6  => ('v')), v14, "fqiqust", "uapyvflv"];
			globalState.f15 := v71;
		} else {
		...
		v1 := |((v14 + v15[v1]) + (v14 + fm32(|v97|, v70, globalState)))|;
	}
	
	var v112: map<bool, bool> := map[v70 := v2];
	v112 := v112[!v71 ==> v70 := v71];
	var v113 := new C0(v14, v1, v0, v70);
	globalState.f21 := (v73 / v1) + v1;
	if (!(v2 || v71)) {
		var v115: multiset<int> := multiset{v1};
		var v116: seq<map<int, bool>> := [map v114 : int | v114 in v115 :: (v114 - v58.f34) := (v11[-v58.f34])];
		v116 := v116;
		v68 := v68[v73 := |v113.f36|];
		v0[445] := !v2;
		v14, v0[445], v71, globalState.f15 := v15[v58.f34], v2, v1 >= (|v115| * |v11|), 'e' in v113.f36;
		v8[413] := v73;
		var v117 := DC6(v58.f34);
		var v118: multiset<D1> := multiset{DC6(|v115|), v117, v117, v117};
		v8[413] := fm4(v118, globalState) + (|v11| / v73);
		var v119: array<D9> := new D9[11];
		v119[512] := if (v0[445]) then DC21(v7) else DC21(v7);
		globalState.f6, v119[512], v2 := v2, DC21(v7).(cf33 := v7), v71;
	} else {
		v0[758] := v71;
		v0[758] := v71;
		var v120: map<int, bool> := map[0x37c / v58.f34 := v70];
		v120 := v120 + v120;
		...
		var v130: array<map<set<bool>, bool>> := new map<set<bool>, bool>[21] [v123, v123, v123, v123, v123, (map v124 : set<bool> | v124 in v125 :: (v124) := (v0[758])) + v123, fm56(v71, v72, globalState), v123, v123, v123 + v123, map v126 : set<bool> | v126 in v125 :: (v126) := (v2), map v127 : set<bool> | v127 in v123 :: (v127) := (v11[v73]), v123, v123, v123 + (map v128 : set<bool> | v128 in v129 :: (v128) := (v0[758])), (map[v31 := v2])[{v0[758]} := true], v123, fm56(v70, v113.f36[v56.cf7], globalState) + map[{v0[758], v70, v70} := true], v123, v123, v123];
		v130[896] := v123;
		var v131: multiset<int> := multiset{v1, |(v14 + (seq(873, i7  => (v51))))|};
		var v132: array<array<bool>> := new array<bool>[16];
		var v133: map<array<array<bool>>, int> := map[v132 := --0x297 % v58.f34];
		var v134 := DC22(v8, v2, v132, v113.f36);
		var v135: seq<map<set<bool>, bool>> := [v123, v123];
		v122, globalState.f13, v1, v130[896], v131 := if (v71) then v122 else v122, if (v134.cf36 in v133) then v133[v134.cf36] else v73, v1, (v123 + v135[v1]) + map[{v70} := v0[758]], v131 - v131;
	}
