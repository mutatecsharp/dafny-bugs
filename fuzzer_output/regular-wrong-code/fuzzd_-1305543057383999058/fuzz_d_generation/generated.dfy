...
function fm3(p0: set<bool>, p1: int, globalState: GlobalState): D0 {
	DC0(multiset{DC27(555, false, seq(974, i0  => (0x237)), false, 0x39d), DC27(|map[false := |{false}|]|, true, [-580], true, |[-|(seq(0x379, i1  => (|[|multiset{|(seq(-0x133, i2  => ('v')))|}|]|)))|]|)} > multiset{DC27(|(map v0 : string | v0 in map["i" := false] :: (v0) := (0x8a))|, !true, [830], !false, |map[true := !true]|)})
}
...
function fm11(p0: int, globalState: GlobalState): int {
	|((map v0 : int | (-616 <= v0) && (v0 < 137) :: (v0 + --0x1f5) := (true)) + map[0xb := true])| % DC37(692, true).cf61
}
function fm12(globalState: GlobalState): bool {
	if (false ==> true) then 'o' !in (seq(-896, i0  => ('m'))) else "ijcsvxjib" == "uxwpipcxu"
}
...
function fm16(p0: int, p1: map<bool, string>, p2: int, globalState: GlobalState): seq<int> {
	[|(seq(0x2d6, i0  => ('b')))|, 405, |"fvbnsepp"|, |[false]|, --451] + ([0xa7] + [|['m', 'm', 'o']|, 0x1be])
}
...
function fm19(p0: int, p1: D3, p2: map<bool, bool>, p3: map<char, int>, globalState: GlobalState): string {
	DC9("oijbgu").cf19 + ((seq(898, i0  => ('q'))) + "malh")
}
function fm20(globalState: GlobalState): bool {
	true
}
function fm21(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): bool {
	(if (false) then multiset{-|{'g', 'o', 'u'}|, |[true, false, false]|} else multiset{0x38c, 0x44, 0x6b, |DC27(|"ngb"|, true, seq(0x363, i0  => (|"fqdctqfb"|)), !false, |multiset(["uwbxjaad"])|).cf49|}) < multiset{-0x12c}
}
function fm22(p0: int, p1: int, globalState: GlobalState): int {
	|((if (true) then map[|[!true, !false, true, true, true]| := 0x2f3] else map[-0x5e := |[{false, false}]|]) + ((map v0 : int | (584 <= v0) && (v0 < 0x2ae) :: (v0 % 0x5b) := (519)) + map[0x37e := 0x2d8]))|
}
function fm23(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<int, bool> {
	if (false) then (map v0 : int | (0x9f <= v0) && (v0 < 0x264) :: (v0 / 0x20d) := (true)) + map[|"iyyqd"| := false] else DC68(map[0x3c9 := true]).cf100
}
...
function fm27(globalState: GlobalState): map<map<int, char>, int> {
	map[map v0 : int | v0 in [|(seq(-291, i0  => ('t')))|] :: (v0 - |(set v1 : int | v1 in [0x2b9] :: (v1 + |multiset{"axixc", "jd", "qh"}|))|) := ('e') := |(seq(0x25c, i1  => ('x')))| * --0x13]
}
...
function fm30(p0: bool, p1: seq<int>, p2: bool, p3: bool, globalState: GlobalState): multiset<int> {
	if (|(seq(1, i0  => ([!false])))| > |multiset(["ukbb", "kj", "igyr", "wkrqamxt", "eebywpg"])|) then multiset{0x57} - multiset{554} else multiset([0x12e])
}
...
function fm42(p0: int, p1: string, p2: string, globalState: GlobalState): multiset<int> {
	multiset((seq(958, i0  => (734))) + [-|{0x2dd, |multiset([-0x89])|, |"vepcry"|}|])
}
...
function fm59(p0: int, globalState: GlobalState): map<int, bool> {
	(map[0x207 := DC11(|[false, false]|, true).cf22] + map[|map[|(seq(0x13d, i0  => ('a')))| := 0xd9]| := true]) + map[|[0x7e]| := true]
}
function fm60(p0: char, globalState: GlobalState): seq<char> {
	(['k'] + ['e', 'h']) + (['i', 'd'] + (seq(0x323, i0  => ('x'))))
}
...
function fm69(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState): D4 {
	DC14(0xc3 / 619, -0x370, (seq(0x251, i0  => ('s'))) + (seq(0xb5, i1  => ('o'))))
}
...
function fm72(globalState: GlobalState): multiset<string> {
	(multiset{"gmcm"} - multiset{"yeijakydk", "wjblcuq", "xjohafh"}) + (multiset(seq(0x3c4, i0  => ("d"))) - multiset{seq(0x21e, i1  => ('s'))})
}
function fm73(p0: bool, globalState: GlobalState): D4 {
	DC13(multiset(['j', 't'] + ['g']))
}
function fm74(p0: int, globalState: GlobalState): map<int, char> {
	(map[|map[!!false := [|{{|[true, false]|}, {|{false}|}}|]]| := 'w'] + map[0x385 := 'p']) + (map[|(seq(0x73, i0  => ('v')))| := 'k'] + map[--|map[!false := |map[false := true]|]| := 'c'])
}
function fm75(p0: int, p1: D2, p2: bool, p3: int, globalState: GlobalState): D1 {
	match DC38(-0x10a, |{'o', 'r'}|) {
		...
		case DC36(cf60) => if (true) then DC1(-0xd6) else DC1(|[seq(0x1d4, i0  => (cf60))]|)
	}
}
function fm76(p0: bool, p1: bool, globalState: GlobalState): set<seq<bool>> {
	if ((map v0 : int | (-0x1de <= v0) && (v0 < 0x163) :: (v0 / |{0x2a7, |"lraieoc"|}|) := (163)) == map[767 := -0x285]) then if (!false) then {[false], [false, false, true]} else {[true, true, !false], [true, true, !!false]} else {[false], [true], [!true]} * (set v1 : seq<bool> | v1 in [[false], [true, true, true, false], [true], [!true], [true, false, true]] :: (v1))
}
function fm77(p0: bool, globalState: GlobalState): set<char> {
	({'u'} + (set v0 : char | v0 in (seq(-814, i0  => ('p'))) :: (v0))) * {'p'}
}
...
function fm79(p0: bool, p1: bool, p2: char, globalState: GlobalState): D9 {
	DC22(!(if (true) then false else true), 0x240 <= |(seq(0x173, i0  => ('o')))|, true, -76 - |{0x197}|, false)
}
function fm80(p0: int, globalState: GlobalState): seq<set<bool>> {
	((seq(0x3e0, i0  => ({false}))) + [{true}, {!true}]) + [{true, false}]
}
function fm81(globalState: GlobalState): D3 {
	DC10(-263 * 0x35d)
}
function fm82(p0: int, globalState: GlobalState): multiset<map<int, bool>> {
	multiset{map[|map["bwefsn" := 'c']| := false]} * (multiset{map[|(seq(0x17f, i0  => ('h')))| := !true], map[-0x31f := true], map[-980 := !true], DC68(map v0 : int | (0x1b9 <= v0) && (v0 < 0x5c) :: (v0 * 0x11b) := (true)).cf100, map v1 : int | (0x200 <= v1) && (v1 < 0x158) :: (v1 + -0x347) := (true)} * multiset([map[918 := true], map v2 : int | (0x1ae <= v2) && (v2 < 0xe4) :: (v2 % 0x2d4) := (true)]))
}
...
function fm85(globalState: GlobalState): seq<string> {
	["f" + "ksshwlaf", "xvfgji" + "mpdhpbtpm", "vmpe", seq(0xc2, i0  => (DC56('j', !false).cf88))]
}
function fm86(globalState: GlobalState): D21 {
	DC47(true || !true)
}
function fm87(p0: char, p1: int, globalState: GlobalState): map<seq<int>, int> {
	map[(seq(0x379, i0  => (0x29d))) + (seq(-0x319, i1  => (|map[false := |map[|"barh"| := -0x29a]|]|))) := |("rqdfe" + "pwpkitcc")|]
}
function fm88(p0: int, p1: D22, p2: string, globalState: GlobalState): set<string> {
	({seq(0x140, i0  => ('g')), "gqyfrlpg"} - {seq(993, i1  => ('i'))}) - ({seq(-454, i2  => ('o'))} + {"urci"})
}
...
function fm91(globalState: GlobalState): map<set<bool>, char> {
	map[{false, true} := 'v'] + (map v0 : set<bool> | v0 in map[{!!true, true, true} := |(seq(318, i0  => ('i')))|] :: (v0) := (DC36('w').cf60))
}
function fm92(globalState: GlobalState): map<string, int> {
	map[if (false) then seq(0xf4, i0  => ('f')) else seq(0x279, i1  => ('s')) := -|("omybsmht" + "cdqaig")|]
}
function fm93(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<char, string> {
	((map v0 : char | v0 in ['y'] :: (v0) := ("gwf")) + map['h' := seq(-0x130, i0  => ('i'))]) + (map v1 : char | v1 in ['u'] :: (v1) := (seq(0x1a7, i1  => ('l'))))
}
function fm94(p0: int, p1: int, globalState: GlobalState): D3 {
	match DC67(false) {
		case DC67(cf99) => DC9("amtvkvwow")
		case DC66(cf98) => if (!!true) then DC9("xcvmogj") else DC9(seq(0x324, i0  => ('n')))
	}
}
method m0(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: D0, r2: bool) {
	...
	if (true) {
		...
		var v18: T1 := new C11(v15[fm40("dhcr", globalState) := v3.f22], v1.f28, if (p2) then v2 else v2);
		v18 := v18;
		...
		if (v18.f20[p1]) {
			...
			v10[803] := v1.f28;
			v10[803] := v1.f28;
			var v22: array<seq<int>> := new seq<int>[13](i0 => seq(980, i1  => (0x2cf)));
			v22[573] := v14;
			v8[299] := false;
			var v23: C1 := new C1(-v1.f28, false, v2);
			var v24: set<int> := {v16.f23};
			v22[573], v8[299], v10[803], v23 := v14 + (v14 + [v1.f28, |v24|]), v18.f20[v1.f28], |v15| + v18.f21, v23;
			r0 := v16.f24;
			v22[573] := (if (v8[299]) then v22[573] else v14) + DC8(v22[573]).cf18;
		} else {
			v18.f21 := --547;
			...
			var v28 := new C5("laefvo" + (seq(0x2f9, i2  => (v5))), v27, v18.f19);
		...
		var v34: map<int, int> := map[p1 := |(seq(858, i4  => ('c')))|];
		v33[966] := fm31(p2, v34, p1, globalState);
		v1, v33[966], r0, r2 := v0[972], fm31(p2, map v35 : int | (752 <= v35) && (v35 < 0x384) :: (v35 - v1.f28) := (|DC16({|(map v36 : int | (680 <= v36) && (v36 < -0x18) :: (v36 / -p3) := (p2))|, p3}).cf29|), v1.f28, globalState), -0x29a, p2 <== p2;
		var v37: multiset<bool> := multiset{false, p2};
		var v38: seq<bool> := [v37 <= v37, v1.f28 >= v1.f28];
		if (v38[fm40(p0, globalState)]) {
			...
			var v48: array<bool> := new bool[17] [p2, {v1.f28} <= v42, p2, v1.f28 in v40, p2 <== p2, v38[v1.f28], if (p2) then p2 else p2, p2, if (p2) then false else p2, p2, |multiset(v38)| == 511, v1.f28 > v1.f28, p2, p2, fm41(globalState), (if (v46 in v47) then v47[v46] else p1) == v1.f28, p2];
			v48[71] := p2;
			v48[71] := p2;
			...
			var v52: C11 := new C11(v50[p3], |v39|, if (v48[71] in v51) then v51[v48[71]] else v45);
			var v53: multiset<C11> := multiset{v52};
			v48[71] := multiset{v52} <= (v53 - v53);
		} else {
			...
			var v57: map<char, bool> := map[v33[966] := p2];
			var v58: seq<map<char, bool>> := [v57, map[v33[966] := v55[989]]];
			var v59: map<int, bool> := map[fm57(v58, v1.f28, v1.f28, p2, globalState) := v55[989]];
			var v60: array<int> := new int[17];
			var v61: seq<array<int>> := [v60];
			var v63: map<map<int, int>, bool> := map[map v62 : int | (0x94 <= v62) && (v62 < 0) :: (v62 * v1.f28) := (v1.f28) := v55[989]];
			var v64: array<int> := new int[23] [p1, v1.f28, |p0| - v56[v1.f28], if (fm41(globalState)) then fm32(v1.f28, |v59|, globalState) else v1.f28, p3, p1, v1.f28, v1.f28, |p0|, |(v56 + v56)|, p1, v1.f28, v1.f28, |(v61 + [v60, v60])|, -v1.f28, v1.f28, v1.f28, fm18(globalState) / |v56|, p3, v1.f28, v1.f28, v1.f28, |v63|];
			v64[674] := v1.f28;
			v64[674] := -((v1.f28 - 0x279) + (524 * -v1.f28));
			var v65: array<array<bool>> := new array<bool>[27];
			var v66: map<bool, int> := map[v55[989] := v1.f28];
			var v67: T0 := new C9(p2, v65, v38 + v38, v1.f28 / |v66|);
			v67 := v67;
			r2 := p2;
			var v68: set<int> := {p3};
			v68 := v68;
	...
	var v75 := 'a';
	v71, v72[151], v74 := v71[193 := v75] + (fm48(p2, globalState) + "cnarnyc"), -p3, v74.(cf80 := v73);
	r2 := p2;
	var v76: seq<int> := [|p0|];
	var v77: map<int, bool> := map[|v76| := p2];
	for i6 := 608 to v1.f28 - |v77| {
		var v78: multiset<int> := multiset{v72[151], -0x25c};
		...
		if (v79 !! v79) {
			...
			v83 := map[v75 := set v84 : int | v84 in v78 :: (v84 / 757)];
			var v85: map<array<int>, int> := map[v72 := i6];
			var v86: map<map<array<int>, int>, bool> := map[v85 + v85 := p2];
			r2 := if (v85 in v86) then v86[v85] else |p0| >= v72[151];
			var v87: set<bool> := {p2};
			r2 := (v87 - v87) < v87;
			v72[151] := v1.f28;
		} else {
			...
			var v95: seq<bool> := [v94[v1.f28]];
			var v96: T1 := new C13(p2, v94, -|"prkk"|, v91);
			var v97: seq<T1> := [v96];
			var v98: map<map<C5, bool>, T1> := map[v93 := v97[v1.f28]];
		...
		r2, v72, v72[151], v72[151], v76 := v1.f28 !in (map v101 : int | (-0x15b <= v101) && (v101 < 0x37f) :: (v101 * v1.f28) := (map[!false := p2])), v72, v1.f28, -(p3 * (i6 % v72[151])), [v72[151], 0x3e2, p1];
		var v102: array<bool> := new bool[25];
		var v103: seq<bool> := [fm41(globalState)];
		v102[892] := v103 <= [!p2];
		v102[892] := p2;
		var v104: map<bool, int> := map[p2 := 556];
		v72[151], r0 := (v72[151] + i6) % p1, -((if (v102[892] in v104) then v104[v102[892]] else v1.f28) % p1);
	}
	var v105 := DC1(v72[151]);
	if (p3 > -v105.cf1) {
		...
		v108 := new C2((([v109])[-0x1d3 := map v110 : char | v110 in p0 :: (v110) := (p2)] + v111)[|v113| := v109], [true], v108.f21, v107);
		v109 := v109[v75 := p3 in v76];
		var v115 := DC16(set v114 : int | (0x190 <= v114) && (v114 < 0x11a) :: (v114 * v1.f28));
		var v116: seq<D6> := [v115, v115];
		v73 := v73[multiset(v116) < multiset{v115} := |("axriinark")[v1.f28 := v75]| !in {fm40("os", globalState)}];
		if (p2) {
			r2 := fm28(globalState);
			...
			r2 := p2;
			var v118 := DC9(v71);
			var v119: map<T0, string> := map[v112 := seq(0x1a3, i8  => (v75))];
			var v120: array<string> := new string[8] [p0 + (seq(0x2b5, i7  => (v71[v1.f28]))), p0, p0, p0, v118.cf19 + v71, v71, if (v112 in v119) then v119[v112] else v71[p3 := v75], v71];
			v120[483] := p0[v108.f21 := v75] + "obpji";
			v120[483] := v71;
			r2 := false;
		} else {
			r2 := fm21(-v108.f21 + v108.f21, p2, p2, v72[151], globalState);
			var v121: set<array<int>> := {v72, v72, v72, v72, v72};
			var v122 := new C13(!p2, v108.f20, |v121| - v72[151], v108.f19);
			r2 := p2;
		...
		var v127: T1 := new C13(if (p1 in v77) then v77[p1] else fm15(false, |(seq(0x361, i9  => ('b')))|, globalState), v126, |v126|, v123);
		var v128: map<T1, int> := map[v127 := |multiset{p2}|];
		var v129: multiset<bool> := multiset{p2, p2, p2, p2, p2};
		r0 := -((if (p2) then p1 else fm37(v1.f28, |v125|, |v128|, globalState)) % |v129|);
		var v130: array<seq<bool>> := new seq<bool>[1];
		v130[240] := v127.f20;
		v130[240] := v126;
		v127 := v127;
		v72[151] := v1.f28 / (v1.f28 - fm18(globalState));
		var v131: set<bool> := {false, true, p2, p2};
		r2 := if (v131 > v131) then v1.f28 <= p1 else p2;
	}
	
	r0 := p1;
	var v133 := DC0(!fm58(map v132 : int | (0x366 <= v132) && (v132 < 0x293) :: (v132 % v72[151]) := (p2), globalState));
	r1 := v133;
	r2 := p2;
}
trait T0 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		if (p1) {
			...
			if (p3) {
				...
				var v6: seq<bool> := [if (p3) then !p3 else v5[v2], p3, fm41(globalState)];
				var v7: C0 := new C0();
				var v8: set<C0> := {v7, v7, v7};
				var v9: set<string> := {v0};
				var v10: set<char> := {v1, v1, v1};
				r0, v4[791], v2, v6, r0 := v8 >= v8, p2, |((v9 + {v0}) - v9)|, v6 + v6, (v10 - v10) > v10;
				v6 := v6;
				var v11: array<int> := new int[1] [v2 % v2];
				v11[569] := f37;
				v11[569] := 0x7e;
				var v12: map<int, char> := map[v2 := 'i'];
				var v13: map<int, int> := map[v11[569] := if (!p0) then |v12| else f37];
				v13 := v13;
				var v14: array<string> := new string[13] [v0, v0 + "mbgj", v0, v0, v0, v0, "fderpfw", v0 + v0, v0, v0, v0, "g", v0];
				v14[783] := v0;
				v11[569], v4[791], v1, v14[783], v11[569] := |v0|, f38, v1, v0, fm40(v0 + v0, globalState);
			} else {
				v0 := v0;
				r0 := p3;
				...
				v15[512], v2, v2, v18 := map[p0 := v1] + v16, --|(v20 + v20[v19 := f37])|, f37, v18;
				var v21: seq<int> := [v2];
				var v22: map<int, bool> := map[-145 := p1];
				var v23: map<map<bool, int>, bool> := map[v3 := p1];
				var v24: array<seq<int>> := new seq<int>[29] [v21, v21, v21, v21, v21, v21, v21, v21, [v2] + v21, v21, v21[f37 := -v2], seq(0x94, i1  => (v2)), v21, v21, seq(0x1b6, i2  => (v2)), v21, v21, v21, [0x258], v21 + v21, (v21 + v21)[v2 := f37], v21, v21, v21, v21 + v21, (v21 + (seq(329, i3  => (|v3|))))[f37 := |v22|], v21, v21, if (if (v3 in v23) then v23[v3] else false) then v21 else v21];
				v24[805] := v21;
				v24[805] := if (v17 >= v17) then v21 else v21 + v21;
				var v25 := new C0();
			}
			...
			if (p3) {
				...
				var v37: seq<bool> := [p3];
				var v38 := DC14(f37, v26, v0[|v37| := v1]);
				var v39 := DC1(v2);
				var v40: map<D4, int> := map[v38 := v39.cf1];
				var v41: array<int> := new int[22] [if (v28) then -v26 else v2, if (p3) then |v30| else --v2, |(seq(0x264, i5  => (v1)))[v26 := v1]|, |(seq(0xa3, i6  => ('t')))|, -47, 0x15, v26, -(|v31| * |v32|), |(v34 + v34)|, fm40(v0, globalState), if (p0) then v26 else v2, v2, v26, v26 + |v35|, fm40(v0, globalState), |(if (p2) then multiset{0x137, v2, |v0|} else v36)|, v2, |v40|, f37, v2 % v2, v2, f37];
				v41[970] := 0x1d2;
				v41[970] := fm40(v0, globalState);
				...
				var v45 := DC17(v44);
				v43[688] := if (v28) then v44 else v45.cf30;
				...
				var v55: array<bool> := new bool[28] [p2, if (v41[970] in v33) then v33[v41[970]] else p2, v28, p3, p1, v28, p3 && p3, f38, p0, p1, v1 in v0, v28 ==> p0, v49 == v49, f38 || p0, p1, multiset(v51) < multiset{v50}, p2, p3, p0, p0, v28 !in v52, p2, fm41(globalState), p0 <== p3, p2, f38, false, if (v53 in v54) then v54[v53] else f38];
				var v56: seq<int> := [|{v41[970]}|, f37];
				v47, v48, v55, v26 := v47, if (v28) then v48 else v48, v55, v56[-v26];
				v55[92] := !f38;
				var v57: set<int> := {|v0|, |v0|};
				var v58 := DC16(v57);
				v55[92] := (multiset{p2} !! multiset{p1, v28}) <==> (v57 > (v58.(cf29 := v57)).cf29);
			} else {
				v28 := v28;
				...
				var v68: set<int> := {fm40(v0, globalState), |v64|, v61[352], |(multiset(v67))[v66.(cf23 := v65) := v61[352]]|};
			...
			decreases 100 - i8
		{
			...
			var v78 := "nasbjjm";
			v78 := v78;
			var v79: map<int, bool> := map[|v78[960 := v75]| := p2];
		...
		v83[110] := fm45(f37, true, !p1, fm41(globalState), globalState);
		v83[110] := fm45(v74[137], p1, f38, v74[137] <= f37, globalState);
		var v84 := DC0(p3);
		r0 := match v84 {
			case DC0(cf0) => [|"qydtqyvlu"|, |[f37, v74[137]]|] < (seq(0x129, i10  => (-0x356)))
		};
		r1 := v74;
	}
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		match (v1) {
			case DC16(cf29) =>
				...
				v8, v5[353], v8[941], v9, v5[353] := v8, f38, -f37, v9, v5[353];
				var v10: map<int, int> := map[f37 := v8[941]];
				var v11 := 'k';
				var v12: map<int, bool> := map[v8[941] := f38];
				var v13 := DC15(v7);
				var v14: seq<int> := [-|v12|, |v13.cf28|, v8[941]];
				r1 := if (v5[353]) then |(v6[if (v8[941] in v10) then v10[v8[941]] else v8[941] := v11])[|(seq(0x26c, i0  => (v8[941])))| := v11]| else if (false) then |v14| else v8[941];
				v8[941] := (if (f38) then |"jbxg"| else f37) + f37;
		}
		...
		match (v17) {
			case DC9(cf19) =>
				...
				v25[610] := if (if ('f' in v28) then v28['f'] else f38) then f37 >= |v15| else f38;
				var v29: seq<bool> := [f38, f38, f38];
				r3 := v29;
				v26[848] := f37;
				v25[610], v24, v0, v26[848] := v25[610], fm43(v29, globalState), (if (f38) then v0 else fm46(f37, f37, globalState)) + ({f37} * fm46(f37, f37, globalState)), f37;
			case DC10(cf20) =>
				...
				var v34 := DC2(if (f38) then if (0xfa in v30) then v30[0xfa] else f38 else f38, (if (f37 in v32) then v32[f37] else f37) % |(set v33 : int | (-0x248 <= v33) && (v33 < 0xc2) :: (v33 - cf20))|, 65 == f37);
				match (v34) {
					case DC2(cf2, cf3, cf4) =>
						...
						v36[802] := f19;
						v36[802] := if (cf2) then f19 else f19;
						var v37 := new C0();
					case DC3(cf5, cf6) =>
						var v38 := false;
						var v39 := "nt";
					...
					case DC4(cf7, cf8, cf9, cf10, cf11) =>
						...
						cf9 := cf7;
						var v49 := "xfnp";
						var v50: map<string, string> := map[seq(106, i2  => ('v')) := "c"];
						var v51, v52, v53 := m0("qxixrrh" + v49, f37 % 0xad, f38, fm40(v49, globalState) + |v50|, globalState);
					case DC1(cf1) =>
				...
				var v63: seq<seq<int>> := [v62, v62[cf20 := cf20]];
				v61[370] := !((seq(344, i3  => (f37))) <= v63[f37]);
				v61[370] := f38;
				if (fm41(globalState)) {
					var v64 := "k";
					var v65 := 'a';
					var v66: array<string> := new string[29] [v64, "yfvcxnfj", (seq(0xe4, i4  => ('m')))[|v64[cf20 := v65]| := v64[f37]] + "ltj", seq(41, i5  => ('y')), v64, v64, v64, v64, v64, v64, v64, seq(61, i6  => (v64[-0x240])), v64, v64[f37 := 'j'], v64, v64, v64, v64, v64, v64 + "camsuoepc", v64, v64, fm48(f38, globalState) + v64, v64, v64, v64 + v64, fm48(f38, globalState), "tnuyhlpo", v64];
					v66[531] := fm48(f38, globalState);
					var v67: seq<bool> := [f38];
					var v68: multiset<bool> := multiset{f38, f38};
					v66[531], r1, v61[370] := v64, |v67|, v68 !! v68;
					...
					var v73 := 's';
					var v74 := DC6(v72, fm41(globalState), v73, if (f37 in v30) then v30[f37] else v61[370]);
					var v75: map<bool, array<int>> := map[v61[370] := v72];
					var v76: array<array<int>> := new array<int>[21] [v72, v72, v72, v74.cf13, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, v72, if (v61[370] in v75) then v75[v61[370]] else v72, v72];
					v76[464] := if (v61[370]) then v72 else v72;
					v76[464] := v72;
					var v77: map<char, bool> := map['w' := f38];
					var v78: seq<map<char, bool>> := [v77];
					v61[370] := (cf20 + cf20) < (|v78| + f37);
					v61[370] := v61[370];
					v15 := v15[cf20 + -0xd4 := cf20 / f37];
				}
			...
			case DC11(cf21, cf22) =>
				...
				var v80 := DC18(v79);
				f19[215] := v80.cf31;
				var v81: array<int> := new int[21](i7 => i7 / |[cf22]|);
				var v82: set<array<int>> := {v81, v81, v81, v81, v81};
				var v83 := "bqvxhe";
				var v84: set<string> := {v83, v83};
				cf22, cf22, f19[215] := v82 < v82, (v84 * v84) >= {v83}, v79;
				cf21 := f37;
				var v85 := new C0();
			case DC8(cf18) =>
				var v86 := new C0();
				...
				v90[481] := if (true) then f38 else f38;
				v90[481] := f38;
			case DC12(cf23) =>
				...
				var v103: array<int> := new int[29] [f37, f37 / f37, -|v93|, |v93| % |v93|, f37, f37 % f37, |(v95 * v95[v94 := 0x16f])|, f37, |v93|, fm40(v93, globalState), |v97| % f37, f37, f37, -(f37 - |v94|), |v100|, f37, f37, f37, f37, f37, f37, f37, f37, f37, if (v102 in v101) then v101[v102] else -f37, f37, f37, -(-0x1 + |[v96, v96, v93[f37]]|), if (f38) then f37 else f37];
				v103 := v103;
				var v104 := DC15(v91);
				v104 := v104;
		}
		...
		var v105 := "m";
		for i8 := f37 % 140 to fm40(v105, globalState) {
			match (v1) {
				case DC16(cf29) =>
					...
					v107[608] := !v108.cf2 !in fm49(f38, i8, globalState);
					r1 := -i8;
					r1 := |"boultruy"|;
			}
			...
			v112[955] := if (v113 in v114) then v114[v113] else v110;
			v112[955] := v110;
			...
			match (v115) {
				case DC9(cf19) =>
					...
					var v119: seq<set<bool>> := [{v109, v109, v113[i8], v109, f38} + v118, {!true, false, false} + v118, v118];
					v117, f19[939], r1, v119 := fm50(globalState).(cf28 := fm51(v109, globalState)), v116, 0xe5, v119;
					var v121: seq<set<int>> := [v0, set v120 : int | (-0x37c <= v120) && (v120 < 0x18b) :: (v120 * 0x33c)];
					var v122, v123, v124 := m0(v105, f37, v121[-i8] > v0, i8, globalState);
					var v125 := new C0();
				case DC10(cf20) =>
					r1 := i8 + i8;
					cf20 := i8;
				...
				case DC11(cf21, cf22) =>
					...
					cf21, v131, r1, cf21, v132 := -(-f37 - -|v133[i8]|), (if (false) then v131 else multiset(v113)) * (multiset{f38, f38, cf22} - v131), cf21, f37, v132;
				case DC8(cf18) =>
					var v134 := 'u';
					v109 := v134 in v105;
				...
				case DC12(cf23) =>
					...
					var v140: multiset<int> := multiset{|(multiset(v113))[fm41(globalState) := i8]|};
					r1, r1, v109, r1 := if (v139 == v139) then f37 / f37 else i8, f37, i8 > (if (i8 in v140) then v140[i8] else |v0|), i8;
			}
			...
			decreases 100 - i12
		{
			...
			v141[121] := f38 in v142[|multiset{f38, f38, f38}| := f38];
			v141[121] := f38;
			var v143 := DC11(f37, f38);
			v141[121] := !v143.cf22;
			var v144: map<bool, int> := map[f38 := f37];
			r1 := if (v141[121] in v144) then v144[v141[121]] else f37;
			...
			if ((v146 + v146) > v146) {
				...
				var v152: map<bool, array<D3>> := map[v141[121] := v151];
				var v153 := DC2(v141[121], f37, f38);
				v152 := if (v141[121] || !v153.cf4) then v152 + v152 else v152;
				v141[121] := |(seq(0x2d5, i13  => ('o')))| <= (f37 % fm40(v105, globalState));
			} else {
				v141[121] := v141[121];
				var v154 := 'y';
				v154 := v154;
				var v155 := DC0(v141[121]);
				v141[121] := !!(if (f38) then v155 else DC0(f38)).cf0;
				var v156: array<int> := new int[29](i14 => i14 - 0x65);
				v156[488] := fm40("rqrwskn", globalState) - f37;
				var v157: set<bool> := {f38};
				v156[488], v141[121], r1 := f37, f38, |{if (f38) then -|v157| else |v105|}|;
				var v158 := DC5("johswuikt");
				v158, v141[121] := v158, v141[121];
			}
		...
		for i15 := f37 to -0x1d1 {
			...
			var v166: array<D3> := new D3[20] [v163, DC8(seq(543, i16  => (f37))), v163, v163, v163, v163, v163, v163, DC8(v164), fm53(v165, globalState), v163, v163, v163, v163, v163, v163, v163, v163, v163, v163];
			v166[620] := v163;
			var v168: seq<D6> := [v1];
			v166[620] := fm53(if (v160) then map[([v1, DC16(set v167 : int | (0x379 <= v167) && (v167 < -0x303) :: (v167 - -908)), v1, v1, DC16({i15, i15})])[f37 := v1] := i15] else v165[v168 := 630], globalState);
			if (!f38) {
				...
				var v170, v171, v172 := m0(v105, i15, f38, i15 % f37, globalState);
				var v173 := new C0();
				v172 := !(v164 == v164);
				...
				var v179: array<int> := new int[9] [f37 % i15, v170, f37 - |v174|, |v175|, -f37, fm40(v105[0x296 := v176], globalState), if (fm41(globalState)) then v170 else i15, -(|v178| % 0x361), v164[i15]];
				v179[984] := |v105|;
				v179[984] := -i15;
			}
		...
		r0 := (v180 - v180)[f37 := fm40(v105, globalState)];
		r1 := f37;
		var v181 := 'a';
...
class C2 extends T1 {
	...
	function fm1(p0: int, globalState: GlobalState): set<int> {
		match DC4(!false, true, false, true, true) {
			case DC2(cf2, cf3, cf4) => (set v0 : int | (250 <= v0) && (v0 < -0x183) :: (v0 / cf3)) + {cf3, f21, |{cf2, cf4, cf2}|}
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		var v0: seq<int> := [f21];
		var v1: seq<int> := [v0[f21], f21];
		var i0 := 0;
		while ((404 + -v0[f21]) < f21)
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v2[647] := !((v4 > (set v6 : int | v6 in (map v5 : int | (0x177 <= v5) && (v5 < -0x367) :: (v5 * f21) := (f21)) :: (v6 + |(seq(0x320, i1  => ('u')))|))) ==> (v8 !! v8));
			if (p3) {
				var v9 := 'i';
				v9 := v9;
				var v10: multiset<int> := multiset{f21, ---f21};
				var v11: map<bool, int> := map[f21 < f21 := if (0x3c4 in v10) then v10[0x3c4] else fm57(f39, f21, |(seq(0x373, i2  => (v9)))|, true, globalState)];
				...
				var v16 := DC4(v2[647], v2[647], v2[647], p0, p0);
				v2[647] := v16.cf11;
				v3 := v3[|((v0 + v0)[f21 := |v0|])[f21 := f21]| := v2];
				v2[647] := p2;
				var v17: map<set<int>, bool> := map[v4 := !v2[647]];
				r0 := if (v4 in v17) then v17[v4] else p1;
				v2[647], r0, r0, v2[647], v2[647] := v2[647], v2[647], p3, if (v7 < "lv") then p2 else true, false;
			}
		...
		for i4 := f21 + f21 to if (p0) then f21 else |v0| {
			...
			if ((v19 * v19) !! (set v20 : int | (480 <= v20) && (v20 < 0x59) :: (v20 % -|['j']|))) {
				...
				var v27: seq<bool> := [p3 || !false, p3, v23.cf40, v24[i4] >= v26, !p3 <==> false];
				v27 := v27;
				r0 := p0;
			} else {
				...
				var v30 := "jnkq";
				r1, f21, v28 := v29, |(v30 + v30)| / 597, v28;
				v29[414] := f21 + i4;
				var v31: map<int, int> := map[i4 / i4 := -i4];
				var v32: map<bool, int> := map[p2 := i4];
				v29[414] := if (i4 in v31) then v31[i4] else |v31| + (if (p2 in v32) then v32[p2] else f21);
				v29[414] := i4;
				var v33 := 'u';
			...
			if (true) {
				...
				var v41: array<int> := new int[13](i5 => i5 % f21);
				v40[537] := v41;
				v40[537] := v41;
				f21 := f21 % i4;
				var v42 := "cfoeajs";
				...
				v42, v43[114], f21, v44 := v42 + "skrmnw", !p1, f21, v44;
			} else {
				...
				var v50 := "qsfevn";
				var v51: map<bool, int> := map[p0 := -(v49.cf34 % |v50|)];
				v51 := v51;
			}
			...
			match (DC2(p0, f21, p0)) {
				case DC2(cf2, cf3, cf4) =>
					...
					var v56: map<int, array<int>> := map[if (cf2) then v1[cf3] else fm57([v53], |{-f21}|, 0xcc, p0, globalState) := v55.cf13];
					var v57: seq<array<int>> := [v55.cf13, v54];
					v56 := v56[i4 / cf3 := v57[i4]];
				...
				case DC3(cf5, cf6) =>
					...
					var v62 := "i";
					var v63 := 'g';
					var v64: map<int, string> := map[|v61[i4 := p2]| := ((seq(0x23, i9  => ('p'))) + v62)[0x9a := v63]];
					var v65: map<bool, int> := map[p1 := cf6];
					v64 := v64[|v65| := (seq(694, i10  => (v63))) + v62];
					cf6 := cf6;
					cf6 := i4 + --0x272;
				case DC4(cf7, cf8, cf9, cf10, cf11) =>
					f21 := 0x193 + i4;
				...
				case DC1(cf1) =>
					...
					v70, v18, f21, f21, r0 := v70, v18 * multiset(v0), -f21 - |v72|, -(if (-(cf1 - |v73|) in v18) then v18[-(cf1 - |v73|)] else -(0x15d / f21)), fm57([v74], f21, 315, p2, globalState) > -|v75[p3 := cf1]|;
			...
			decreases 100 - i11
		{
			...
			match (if (f21 == v87.f37) then v88 else v88) {
				case DC9(cf19) =>
					var v89: array<string> := new seq<char>[7](i12 => seq(0x155, i13  => ('x')));
					v89[90] := cf19;
					var v90: set<bool> := {p0};
					var v91: seq<set<bool>> := [v90];
					r0, v89[90], r0, r0 := !!v87.f38, (seq(0x33e, i14  => ('q'))) + ("hico" + cf19), v1[-0x201] < 876, !(v91[v87.f37] > (v90 + {p2}));
				...
				case DC10(cf20) =>
					...
					v99[987] := !(f21 in v100);
					r0, v99[987], r0, f21 := p3, p3, p1, v87.f37;
				case DC11(cf21, cf22) =>
					...
					var v105: seq<char> := [v103, v104[f21]];
					var v106: map<int, bool> := map[cf21 := p3];
					v102[252], r0, r0, v105 := fm58(v106, globalState), p0, !(if (v87.f38) then true <==> p0 else p2), v105[v87.f37 := v103];
					v101[86] := cf21;
					var v107: multiset<bool> := multiset{fm58(v106, globalState)};
					var v108 := new C1(0x166 * fm57(f39, if (v102[252] in v107) then v107[v102[252]] else |v105|, cf21, true, globalState), v86 != v86, f19);
				case DC8(cf18) =>
					f21 := |"jqredw"|;
					f21 := |f20|;
					f21 := 0x2ab % --0xca;
				...
				case DC12(cf23) =>
					...
					var v113 := "cctbphq";
					var v114 := 'e';
					var v115: array<int> := new int[21] [v87.f37, v87.f37, if (|v1| in v110) then v110[|v1|] else v87.f37, 0x82, v87.f37, v111.cf20, v87.f37, v87.f37 / v87.f37, |(v112 + map[p1 := v87.f37])|, f21, v87.f37, f21, v87.f37, 0x2b8, 0x265, -(if (true) then f21 else v87.f37), f21, f21 * 0x28e, |v113[v87.f37 := v114]|, f21, 0x288];
					v115[499] := 0x198;
					...
					v118[587] := v111;
					v118[587] := if (v87.f38) then v111 else v111;
			...
			v125[300] := if (p3) then v122 else v122;
			v125[300] := if (v120[373]) then v122 else v122;
		}
		r0 := p1;
		r0, r0 := p2, p3;
		r0 := false;
	...
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		var v8: map<char, array<bool>> := map[v6[f21] := v7];
		v8 := v8[v5 := v7];
		var v9: map<string, bool> := map[v6 := v0];
		var v10: seq<int> := [f21, f21, f21, f21];
		var v11: map<int, string> := map[|v10| := seq(658, i2  => (v5))];
		if (if ((if (fm57(f39, f21, f21, v0, globalState) in v11) then v11[fm57(f39, f21, f21, v0, globalState)] else "kx") in v9) then v9[if (fm57(f39, f21, f21, v0, globalState) in v11) then v11[fm57(f39, f21, f21, v0, globalState)] else "kx"] else v0) {
			...
			v12[699], v0, v12[366] := (f21 - fm57([map v13 : char | v13 in v15 :: (v13) := (!v0)], |v10|, |f20|, v0, globalState)) / |v14|, if (fm58(v1, globalState)) then !(v16 > fm1(f21, globalState)) else v0, f21 * (f21 * f21);
			r1 := -|"vco"|;
			...
			v0, r1, v12[699], v5, v20 := !v20, |v22|, v17 % |f20|, v6[v17], v0;
		} else {
			v6 := v6 + v6;
			var v23: C0 := new C0();
			var v24: set<C0> := {v23};
			...
			var v27 := DC16(v26);
			v25[262], r1, v27, f21, v0 := v6[-f21], f21, v27, f21, (f21 * f21) >= (f21 - 0x125);
			var v28: map<char, bool> := map[v5 := false];
			r1 := fm57(f39[f21 := v28], 0x2a9 / f21, f21, fm57(f39, f21, f21, v0, globalState) == f21, globalState);
		}
		...
		var v32 := DC23(v31);
		v32 := v32;
		v7[708] := v5 in fm60(v5, globalState);
		v7[708], f21 := !v0, -f21;
		var v33: multiset<int> := multiset{f21, |v6|, f21, |(seq(0x370, i5  => (-f21)))[f21 := f21]|};
		var v34: array<array<char>> := new array<char>[19];
		var v35 := DC17(v34);
		var v36: map<bool, D7> := map[v7[708] := v35];
		r0 := v33[-(|v36| - f21) := f21];
		r1 := f21;
		var v38: multiset<bool> := multiset{v0, v7[708]};
	...
	method m9(globalState: GlobalState) returns (r0: int, r1: char, r2: string, r3: bool) {
		...
		if (v0) {
			...
			var v1 := "iwjjaicvd";
			var v2: seq<int> := [|v1|];
			var v3: map<D8, int> := map[DC19(f21) := v2[f21] - f21];
			...
			v8[162] := v0;
			var v10 := DC1(-(f21 - f21));
			var v11: map<bool, int> := map[v8[162] := 916];
			var v12: array<seq<int>> := new seq<int>[10] [v2, fm64(f21, v8[162], fm65(f21, |map[f21 := v8[162]]|, globalState), --|v11|, globalState) + v2, v2, v2, v2[-f21 := |map[v0 := 370]|], v2, (v2 + (seq(829, i0  => (f21))))[f21 := |v1|], [fm57(f39, f21, f21, v0, globalState), |(seq(-444, i1  => (v6)))|, f21], v2 + v2, v2[f21 := f21]];
			f21, r3, v10, v8[162], v12 := f21, v0, DC1(f21).(cf1 := f21), f21 <= f21, if (v8[162]) then v12 else v12;
			v8[162] := v8[162];
		} else {
			...
			v15[229] := if (v0) then v13 else if ([v0, v0, !v0, v0, v0] in v16) then v16[[v0, v0, !v0, v0, v0]] else v13;
			var v17 := "ckegr";
			r2 := v17;
			var v18: array<bool> := new bool[27];
			v18[840] := -324 == f21;
			v18[840] := v0;
			var v19: set<bool> := {[v18[840]] <= f20, !v18[840], v0, false, v18[840]};
			v19 := v19 * v19;
			var v20 := 'n';
			r1 := v20;
		}
		
		var v21 := DC0(-f21 !in (seq(195, i3  => (|"msrywvnpb"|))));
		match (v21) {
			case DC0(cf0) =>
				...
				var v31: array<bool> := new bool[19] [v0 ==> cf0, cf0, !v0, v0, v24.cf16, v0, v23 in v25, cf0, v0 ==> cf0, v26.cf39, v0, if (v0 in v27) then v27[v0] else v0, fm66(if (cf0 in v28) then v28[cf0] else f21, 709, f21, v23, globalState) !! v29, f20[0x144], cf0, fm58(v30, globalState), v0, f21 < |v25|, v0];
				v31 := v31;
		...
		for i5 := 771 to |v35| {
			...
			match (v38) {
				case DC6(cf13, cf14, cf15, cf16) =>
					...
					v39[569] := cf14;
					var v40 := "o";
					var v41: map<char, bool> := map[cf15 := v39[569]];
					var v42: array<char> := new char[26] [cf15, fm61(0x15, f21, globalState), cf15, fm61(i5, i5, globalState), v37, v37, v37, cf15, v37, cf15, v37, v37, cf15, cf15, v37, fm61(0xf0, f21, globalState), cf15, cf15, v37, v37, v37, v40[fm57([v41], f21, f21, fm58(v35, globalState), globalState)], v37, 'c', v37, cf15];
					...
					var v47: map<bool, D1> := map[!("l" !in v45) := DC2(f20[|v46[|v35|]|], i5, cf14)];
					var v48 := DC2(v39[569], i5, cf14);
					v47 := v47[v0 := v48];
				case DC5(cf12) =>
					var v49 := new C0();
					f21 := i5;
				...
				case DC7(cf17) =>
					...
					v58 := v58[v55.f37 := v57];
					r2 := if (v21.cf0) then v56[-f21 := v37] else v56 + v56;
			}
			...
			var v73 := DC21(|v59| % f21, i5 - f21, f21, |(v35 + v35)|, v72);
			var v74: multiset<int> := multiset{i5, i5};
			var v75: set<bool> := {v0};
			var v76: multiset<set<bool>> := multiset{v75, fm67(v67, v0, globalState), v75, v75};
			v60, v36[702], v63, v73, r0 := (seq(0x2f7, i7  => (v59))) + v60, |v74| / |v76|, map[v62 := f21] + map[DC24(v61) := fm57(f39, -i5, |map[i5 := |v35|]|, v0, globalState)], DC21(|v59|, |v59| % i5, i5, i5, v72), i5;
			var v77: array<bool> := new bool[27];
			v77 := new bool[21](i8 => multiset{v36[702], f21} >= v74);
			r0 := -v36[702] * f21;
		}
		r0 := f21;
		var v78 := 'y';
...
class C3 extends T1 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		...
		var v5: array<seq<int>> := new seq<int>[23] [v0 + v0, v0, v0 + v0, v0 + [f21, f21], v0, seq(0x2ac, i1  => (f21)), v0[-|v1| := f21], [f21, f21, f21], v0, [-0x3c1, |v1|, f21], v0, v0, [f21], ([|"xfkyxl"|, |v1|] + v0)[|v2| := f21], v0 + v0, fm35(f35, f21, globalState), v0, fm35(f20[-f21], f21, globalState), [-f21] + [f21, f21, -|map[v3 := v4]|], v0, v0, v0, [v0[f21]]];
		...
		if (p1) {
			...
			v1 := (fm36(v6, globalState))[|v7| := f36] + v1;
			r1 := v3;
			var v8 := new C0();
			...
			match (DC3(f21, f21)) {
				...
				case DC1(cf1) =>
					...
					v29[287] := fm38(v2[f21 := cf1], v0, globalState);
					v29[287] := fm38(v2 + v2, fm35(false, f21, globalState), globalState);
					var v30: multiset<bool> := multiset{true};
					v4[934] := !(v30 <= multiset{p2});
					v3[622] := cf1;
					...
					v4[934], v3[622], v33, cf1, v35 := (f21 - |multiset(v36)|) == cf1, cf1 % |multiset{p1, f35, p3, p0, p2}|, v33, cf1, map[p1 := v37[cf1]];
					var v38: multiset<int> := multiset{f21};
					var v39: array<int> := new int[1] [if (f21 in v38) then v38[f21] else v3[622]];
					r0, r1 := p1 <==> f35, v39;
					var v40: map<bool, bool> := map[p1 := p2];
					var v41: map<int, bool> := map[f21 := p0];
					var v42: array<bool> := new bool[26] [v4[934], v4[934], f35, p3, p1, false, v4[934], f35, p2, v4[934], p0, f35, p2, if (p0 in v40) then v40[p0] else p0, p2, p0, true, f35, true, false, p0, false, if (v3[622] in v41) then v41[v3[622]] else !p3, p1, p3, v4[934]];
					var v43 := DC18(v42);
			...
			v3[742] := |v0|;
			var v46 := DC18(v4);
			v3[742], v12, f21, v4, r1 := f21, v12, --((|v0| + f21) + f21), v46.cf31, v3;
			v4[990] := f21 == f21;
			v4[990] := false;
			if (v1 < "fxvgloln") {
				var v47: C1 := new C1(v3[742], false, f19);
				...
				v5[733] := [v47.f37, |v50[|fm54(p0, v51, p0, globalState)| := fm41(globalState)]|, |f20|, f21, v47.f37];
				var v52: set<bool> := {p3, p0, v4[990]};
				var v53: map<bool, set<bool>> := map[v52 >= {p2} := v52];
				var v54: multiset<bool> := multiset{p0, f35};
				var v55: map<char, map<bool, set<bool>>> := map[v49 := v53[v4[990] := v52]];
				v5[733], f35, v53, f21, f35 := DC8(v0).cf18, (v54 > multiset(f20)) && p0, if (fm38(v2, v0, globalState) in v55) then v55[fm38(v2, v0, globalState)] else map[DC2(f35, |v50|, true).cf2 := v52], (v3[742] + f21) / v47.f37, p0;
				var v56: array<seq<bool>> := new seq<bool>[16];
				v56, f21 := v56, v47.f37;
				v4[990] := fm41(globalState);
			} else {
				var v57 := DC20(f19);
				var v58 := DC20(v57.cf33);
				var v59 := new C1(v3[742] * v3[742], p3, v58.cf33);
				var v60: seq<C1> := [v59, v59, if (p0) then v59 else v59];
				v60 := [v59, v59, v59, v59, v59] + v60;
				var v61: array<int> := new int[28](i3 => i3 / v3[742]);
		...
		match (v65) {
			...
			case DC10(cf20) =>
				...
				match (v65) {
					case DC9(cf19) =>
						...
						v73[583] := cf19[fm37(|v2|, |cf19|, f21, globalState) := f36] + v1;
						v73[583] := (cf19 + v1)[cf20 := fm38(v2, v0, globalState)];
						f35 := f35;
						v3[600] := cf20;
						v3[600] := cf20;
						v73[583] := (cf19 + "ootr") + v1;
					case DC10(cf20) =>
						v1 := (if (!!f35) then v1 else v1) + v1;
						var v74: array<D2> := new D2[12](i6 => if (f35) then DC5(v1[0x165 := 'm']) else DC5(v1));
						var v75 := DC5(v1);
						v74[64] := v75;
						var v76: map<seq<bool>, bool> := map[f20 := true];
						f21, cf20, v74[64], cf20, cf20 := f21, fm37(f21, f21, |("lpqyrpxnh" + v1)|, globalState), v75, |fm55(f21, v1, p0, |(v76 + v76)|, globalState)|, cf20;
						r0 := cf20 > cf20;
						var v77: map<seq<int>, bool> := map[[v0[cf20], f21] := p0];
						v77 := v77[v0 := f35];
					case DC11(cf21, cf22) =>
						var v78 := 'n';
						v78 := f36;
						...
						var v80 := new C0();
					case DC8(cf18) =>
						v4[692] := if (p1) then p0 else p0;
						var v81: multiset<bool> := multiset{fm41(globalState)};
						v3[873] := |v81|;
						var v82: map<bool, int> := map[true := f21 - f21];
						cf20, v4[692], v3[873] := if (!f35 in v82) then v82[!f35] else cf20, false, cf20;
						var v83, v84, v85 := m0(v1, v3[873], !v4[692], cf20, globalState);
					...
					case DC12(cf23) =>
						...
						var v95: map<bool, array<char>> := map[p0 := v93[|v94|]];
						v95 := v95[f35 := v64];
						var v96: set<bool> := {p0};
						v2 := v2[if (p1) then f21 else |fm56(p0, |v96|, globalState)| := cf20];
						v3[361] := cf20 + f21;
						v3[361] := |(if (!!(f21 < f21)) then fm51(f35, globalState) else f20 + [p0])|;
						v3[361] := -f21;
				}
			...
			case DC11(cf21, cf22) =>
				...
				if (v0 != (v0 + [f21])) {
					...
					v3[428] := fm37(|v100.f20|, 0x12b, cf21, globalState);
					cf22, v100, f35, v3[428], f21 := fm41(globalState), v100, !p2, |(map v101 : int | (0x389 <= v101) && (v101 < 0x24d) :: (v101 - f21) := ({f35, f35, !!p1, p2}))|, cf21;
					cf22 := p0;
					v2 := v2[v100.f21 := |v0|];
					var v102: multiset<char> := multiset{f36, f36};
					var v103 := DC13(v102);
					r0, v3[428], r0, v103 := p3, fm57([v98, v98, v98], fm57(v99, v3[428], 282, p0, globalState), cf21, p1, globalState), f35 ==> (f35 && p1), v103;
				} else {
					var v104: array<array<int>> := new array<int>[7];
					v104[550] := if (f35) then v3 else v3;
					v104[550] := v3;
					...
					var v110: map<int, seq<bool>> := map[v3[838] := f20];
					var v111 := new C2(v109 + [v108], fm63(f36, fm58(map[v3[838] := f35], globalState), globalState) + [p3], --fm37(cf21, cf21, |v110|, globalState), f19);
				}
			...
			case DC8(cf18) =>
				...
				f21, f21, v120, r0 := -v118.f21 / f21, f21, map[f36 := -|f20|] + v120, p2;
			case DC12(cf23) =>
				var v121: map<char, array<bool>> := map[f36 := v4];
				v4 := if (f36 in v121) then v121[f36] else v4;
				if (true) {
					var v122: seq<string> := [v1, v1, v1 + "cmyjyumr", seq(0x29d, i7  => (f36)), v1 + v1];
					f35, r0, v122 := p1, (f21 % f21) > f21, v122;
					...
					var v128 := new C2((seq(-0x11, i8  => (map[f36 := p2]))) + v127, f20, v3[64], f19);
				} else {
					...
					v3[604], globalState.f7, r0, v134 := DC21(v0[f21], f21, f21, -|v1|, v135).cf37, v0, f21 < 919, DC1(f21);
					v4[594] := f35;
					v4[594] := !(v3[604] > v3[604]);
					...
					var v141: array<int> := new int[18] [v3[604], 0x174, -756, f21, 0x3cd, f21, v3[604], -|v140|, v3[604], v3[604], v3[604], f21, v3[604], v3[604], 0x316, v3[604], f21, DC10(f21).cf20];
					v139[486] := v141;
					var v142 := DC6(v141, f20[|v1|], f36, p2);
					v136[584], v4[594], v138, v139[486] := v137, p0, v138, v142.cf13;
				}
		...
		match (DC13(multiset{f36})) {
			case DC14(cf25, cf26, cf27) =>
				if (p0) {
					...
					var v151: map<int, string> := map[|(seq(678, i11  => (-0x1bc)))| := v1];
					var v152: array<int> := new int[15] [f21, cf25, cf25, fm40(v1, globalState), cf26, cf25, |v150|, |v151|, f21, |cf27|, v3[800], f21, f21, cf25, 0x393];
					v149[668] := v152;
					v149[668] := v152;
				...
				if (f35) {
					...
					v156 := v156[p2 := cf25];
					var v157, v158, v159 := m0(cf27, f21, v4[293] <== !f35, cf25, globalState);
					var v160: map<bool, bool> := map[v4[293] := f35];
					v160 := v160[p3 := fm41(globalState)];
					var v161: set<int> := {f21, |"qoetb"|, f21, f21 * f21};
					v161 := if (v4[293]) then set v162 : int | (-0x4d <= v162) && (v162 < -0x16c) :: (v162 - cf25) else set v163 : int | (0x3a1 <= v163) && (v163 < 0x3c2) :: (v163 - v157);
				}
			...
			case DC13(cf24) =>
				...
				v168[499] := fm69(p1, f21, p2, f21, globalState);
				...
				match (v170) {
					case DC25() =>
						v4[193] := true;
						v4[193] := ((seq(0x1ca, i12  => (f36))) + v1) <= (seq(0x3b3, i13  => (f36)));
						var v171 := new C0();
					...
					case DC24(cf45) =>
						...
						f21, v174, v178, v3[197] := fm37(0x33c, f21, f21, globalState), v174, v178 + (v179[-f21])[|v180| := v176], f21 - f21;
						r0 := p0;
						v3[197] := |(seq(0x3d3, i14  => (v174)))|;
						v4[760] := p3;
						var v181: array<multiset<array<int>>> := new multiset<array<int>>[23];
						var v182: array<int> := new int[9](i15 => i15 % v3[197]);
						var v183: multiset<array<int>> := multiset{v182};
						v181[215] := v183;
						var v184: set<array<int>> := {v182, v182, v182};
						f35, v4[760], v181[215], r0 := p1 && (fm72(globalState) !! multiset{v1}), true || (v184 < v184), v183, p0;
				}
	...
	method m8(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: int) {
		if (p1 <== p1) {
			var v0: array<int> := new int[11](i0 => i0 % f21);
			var v1 := "lt";
			v0[85] := |v1|;
			v0[85] := |(map v2 : int | (0x3b9 <= v2) && (v2 < 0x119) :: (v2 + f21) := (0xb))| / (f21 - 0x188);
			var v3 := 'd';
			v3 := v3;
			var v4: map<bool, int> := map[p0 := v0[85]];
			...
			if (p0) {
				...
				var v20: C2 := new C2(v18[f21 := v19], f20, f21, f19);
				var v21: multiset<C2> := multiset{v20};
				var v22: multiset<int> := multiset{|f20|};
				var v23: seq<int> := [f21];
				var v24: array<int> := new int[25] [f21, f21, -|[p0]| / f21, |(v12 + map[f21 := f21])|, |map[-f21 := f35]|, 0x311, f21, 144, f21, f21, f21 / f21, f21, if (f35 in v13) then v13[f35] else |v15|, if (f35) then f21 else |(("h")[|fm66(f21, |v16|, f21, f36, globalState)| := f36])[f21 := 'r']|, |v17| / f21, f21, |v21|, f21, if (f21 in v22) then v22[f21] else f21, |v22|, |[fm37(f21, |v23|, f21, globalState), f21]| / 0xbd, f21, f21, f21, f21 - f21];
				v24[76] := f21;
				...
				v24[76], v25[956] := v30.cf36, if (true) then v27 else v27;
				var v31: map<map<bool, int>, bool> := map[v13 := p1];
				var v32: map<map<map<bool, int>, bool>, bool> := map[v31 := p1];
				var v34: set<int> := {fm40(v28, globalState), fm40(v28, globalState), f21, v24[76], f21};
				...
				var v43: array<int> := new int[24] [f21, 0x130, fm40(v39, globalState), f21 / f21, f21, f21, |"qgqhgnsk"|, 0x3b2, f21, -DC27(|"eci"|, p1, v40, p0, f21).cf47, |(map v41 : int | (485 <= v41) && (v41 < 0x1b3) :: (v41 + 0x67) := (p1))| * f21, 0x146, |v40|, f21, f21 / -fm37(-f21, f21, f21, globalState), v42.cf6, f21, f21, f21 / f21, -f21, 0x1c6 + f21, f21 + f21, |[f21]|, f21];
				v43[590] := 0x1f1;
				v43[590], r2 := f21 / f21, fm41(globalState);
				var v44: array<set<int>> := new set<int>[11];
				var v45 := DC21(v43[590], |{p0, p0}|, v43[590], 0x8b, v44);
				var v46: map<D9, set<bool>> := map[v45 := {f35}];
				var v47: set<bool> := {f35};
				var v48: array<map<D9, set<bool>>> := new map<D9, set<bool>>[16] [v46[DC21(-v43[590], v43[590], f21, v43[590], v44) := v47], v46, v46, v46 + v46, v46, map[v45 := v47] + v46, v46 + map[v45 := v47], v46 + v46, v46, v46, map[v45 := v47] + v46, v46 + map[v45 := v47], v46, v46, v46, v46];
				v48[36] := map[v45 := v47];
				v48[36] := v46;
				var v49: map<bool, int> := map[false := |f20|];
				v49 := v49[p1 := v43[590] * v43[590]];
				f35 := ((seq(0x29c, i2  => (f36))) + v39) != v39;
		...
		v55[843] := |v56|;
		var v57: map<bool, seq<bool>> := map[f35 := f20[v55[843] := f20[f21]]];
		v57 := v57[f35 := f20];
		r0 := f21;
...
class C4 extends T0 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		...
		var v4: multiset<int> := multiset{-((if (false in v3) then v3[false] else f34) % f34), f33 % f33};
		var v5 := "xbimecbt";
		var v6 := 'k';
		var v7: seq<int> := [fm32(-0x8, f34, globalState)];
		var v8 := DC11(|(v5 + v5)[f34 := v6]|, v7 <= v7);
		...
		match (v11) {
			case DC6(cf13, cf14, cf15, cf16) =>
				...
				v13 := map[seq(0x2ab, i1  => (cf15)) := fm34(globalState) + v12];
			...
			case DC5(cf12) =>
				...
				var v24: map<bool, array<seq<bool>>> := map[v22 > v23[0xd9] := v21];
			...
			case DC7(cf17) =>
				...
				v32[839] := v6;
				v32[839] := if (p0) then v6 else v6;
				var v33: map<array<int>, string> := map[v31 := v5];
				var v34 := DC6(v31, p0, v32[839], p3);
				v5, r0, v9[136], v31 := (v5 + "gpxkmp") + (if (v31 in v33) then v33[v31] else "gs"), !(-v9[136] == -(if (f33 in v4) then v4[f33] else -426)), v9[136] * f34, v34.cf13;
		}
		...
		v9[723] := |v36|;
		var v37: set<bool> := {p0};
		v9[723] := fm40(v5, globalState) / |{fm58(map[|v37| := p1], globalState), p0, !p0, false, p3}|;
		var v38: map<bool, bool> := map[fm58(v35, globalState) := p0];
		v38 := v38[!(f33 == f33) := p3];
		if (p1) {
			f34 := -f34;
			var v39 := new C1(v9[723], p0, f19);
			v9[723] := v9[723];
			...
			var v43: seq<bool> := [v39.f38, p0, v42[f33]];
			var v44 := DC20(f19);
			...
			v38 := v38[p2 := p1];
			r0 := p2;
			var v47: array<set<int>> := new set<int>[22](i2 => set v46 : int | (0x14 <= v46) && (v46 < 0xf5) :: (v46 / |v35|));
			var v48 := DC21(-f34, f33, f33, f34, v47);
			var v49: seq<bool> := [false, true];
			var v50 := new C3(f33 >= v48.cf36, v6, v49[v9[723] := p0], |v49[|v5| := p2]|, f19);
			...
			var v60: array<D1> := new D1[26] [v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, DC1(|(map[v5 := v6])[seq(0x365, i3  => (v50.f36)) := v6]|), DC1(v9[723]), fm75(v51.f37, v53, true, |v3|, globalState), DC1(v9[723]), v52, v52, v52, fm75(|(v54.(cf52 := v37)).cf52|, v53, v51.f38, if (v6 in v56) then v56[v6] else f33, globalState), DC1(f34), DC1(|v57|), v52, v52.(cf1 := f34), v52, fm75(|(if (-0xb1 in v59) then v59[-0xb1] else fm65(f34, v51.f37, globalState))|, v53, p0, f33, globalState)];
			v60[74] := DC1(f33);
			v60[74], f34, v9[723], v5 := v52, |v5|, f34, v5;
		}
		...
		for i4 := f34 to 0x207 - |map[f34 := p1]| {
			...
			v7 := v7[v9[723] := if (|v63| in v61) then v61[|v63|] else i4];
			r0 := p3;
			var v64: array<bool> := new bool[4](i5 => p3);
			f19[122] := v64;
			f19[122] := new bool[10];
			if (if (p0) then |v62| == v9[723] else !p3) {
				var v65: seq<bool> := [p1];
				var v66: seq<seq<bool>> := [v65, [p2, p1, p3], v65, fm39(|v37|, globalState), v65];
				var v67: map<int, array<bool>> := map[i4 := f19[122]];
				var v68: seq<array<bool>> := [if (f34 in v67) then v67[f34] else v64, f19[122]];
				var v69: map<bool, array<bool>> := map[p3 := f19[122]];
				var v70: array<array<bool>> := new array<bool>[14] [v68[|v65|], if (p2 in v69) then v69[p2] else f19[122], f19[122], v64, v64, f19[122], v64, f19[122], v64, v64, f19[122], f19[122], v64, f19[122]];
				var v71: T1 := new C3(p0, if (p2) then v6 else v6, v66[|{p2}|], 503, v70);
				v71 := if (v63 < v63) then if (p2) then v71 else v71 else v71;
				var v72 := DC15(v65);
				var v73: array<seq<bool>> := new seq<bool>[23] [if (p0) then v65 else v71.f20, v71.f20, [p3], v72.cf28, v71.f20 + v65, [fm58(v35, globalState)], [p1, p0, p3, p3, p2], v65 + v71.f20, v71.f20, (v71.f20 + v71.f20)[v71.f21 := p1], v65 + v65, v65 + v71.f20, v65, v71.f20, v71.f20[v9[723] := p3], v65, if (p2) then [fm58(fm59(i4, globalState), globalState)] else v65, v65, v65, v71.f20[i4 := p3], [p3, p0, p2], fm63(v6, p3, globalState), v65 + v71.f20];
				v73[477] := [p0];
				v73[477] := v65 + v71.f20;
				v5 := if (p2) then v5 else "eou" + v5[v71.f21 := v5[v71.f21]];
				var v74, v75, v76, v77 := v71.m2(globalState);
				var v78: array<string> := new string[17];
				var v79: array<array<char>> := new array<char>[13];
				var v80 := DC17(v79);
				var v81: map<D7, int> := map[v80 := v9[723]];
				var v82: map<array<string>, map<D7, int>> := map[v78 := v81];
				v82 := v82[v78 := map[DC17(v79) := v9[723]] + v81];
			} else {
				v9[723] := |v4|;
				v9[723] := -(f33 - i4);
				v38 := v38[p2 := p0 || p2];
	...
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v4 := 'r';
				var v5 := new C3(v2, v4, [v2], |([969, -f34, f34, f34])[f34 := f34]|, DC20(f19).cf33);
				var v7: map<char, bool> := map[v5.f36 := v5.f35];
				var v8: seq<map<char, bool>> := [v7, v7];
				var v9: seq<map<char, bool>> := [v7, v8[f33]];
				...
				v16 := v16[f34 % fm57(v18, f34, f33, true, globalState) := f34 % |v21|];
				v19 := v19 <==> (fm37(0x2e0, f33, f34, globalState) < -v15[fm37(f34, |v20|, f33, globalState)]);
				var v22: array<int> := new int[20](i1 => i1 + f34);
				var v23 := DC31(v18);
				var v24: multiset<bool> := multiset{v19};
				v22[860] := fm57(v23.cf54, 338, |v24|, v19, globalState);
				v22[860] := f34;
				v0 := v0;
			}
		...
		if (496 == f33) {
			...
			f19[0] := v40;
			v31, r1, v31, v32[964], f19[0] := true, f34 / f34, v31, v39, v40;
			var v41: array<int> := new int[1];
			var v42: multiset<bool> := multiset{v31, v31, v31};
			v41[896] := (if (false in v42) then v42[false] else 341) / f34;
			v41[896] := v38.f21;
			var v43: map<bool, seq<bool>> := map[v31 := v38.f20];
			var v44: map<bool, bool> := map[v31 := !v31];
			var v45: map<map<bool, bool>, int> := map[v44 := v41[896]];
			var v46: map<int, int> := map[|v43| := -(if (v44 in v45) then v45[v44] else |v33|) % v41[896]];
			var v47 := DC4(false, v31, false, v31, v31);
			var v48: map<D1, int> := map[v47 := f33];
			var v49: seq<map<D1, int>> := [v48];
			v46, v41[896], v41[896], v41[896] := v46, (v38.f21 - |v33|) - f34, |v49|, 0x49;
			v38.f21 := |v42| + v38.f21;
		}
		
		var v50: array<array<int>> := new array<int>[4];
		var v51: seq<int> := [f33, f33, f33];
		f34, v50, r1, v50 := f34, v50, v51[f33], v50;
		var v52 := false;
			...
			decreases 100 - i3
		{
			...
			var v69 := new C3(v52, v55, [!v64[510], v64[510], true, fm41(globalState)], if (v55 in v68) then v68[v55] else f33, if (v52) then f19 else v58.f19);
		}
		...
		var v72 := DC8(v51);
		var v73: map<bool, D3> := map[v64[510] := v72];
		r2 := (v71 + v71) + fm68(true, |v73|, globalState);
		r3 := (match DC22(v64[510], v52, v64[510], f33, v64[510]) {
			case DC21(cf34, cf35, cf36, cf37, cf38) => v53 + v53
			case DC22(cf39, cf40, cf41, cf42, cf43) => v53 + v53
			case DC20(cf33) => v53
		})[fm57(seq(508, i4  => (v71)), f33, f33, v52, globalState) := f33 <= 0x8e];
	}
}
...
class C5 extends T0 {
	...
	function fm25(p0: map<bool, bool>, globalState: GlobalState): int {
		|(f31 + DC9(f31).cf19)| - |((seq(0x1d3, i0  => (map[-|(seq(0x253, i1  => (DC4(false, true, false, true, false))))| := -0x1b1]))) + [map[0xbc := |f31|], map v0 : int | (0x22d <= v0) && (v0 < 0x102) :: (v0 * |{true, true}|) := (0x360), map[-|[|[DC10(-0x2f7), DC10(|{DC0(false).cf0, true}|)]|, 0x3b5]| := |(set v1 : char | v1 in {'m', 'n', 'l', 'v', 'v'} :: (v1))|]])|
	}
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		var v0 := -345;
		var v1: map<int, bool> := map[v0 % |[p2]| := p0];
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v7: array<int> := new int[6] [v0, |"tai"|, 0x23e + v0, v0 / 721, fm24(p0, globalState), v0];
			v7[552] := |(multiset{v0} - multiset{-0x14d})|;
			v7[552] := fm24(p1, globalState) % (v0 + v0);
			var v8: seq<int> := [v0, v7[552], 0x3b4, v7[552]];
			var v9 := DC8(v8 + v8);
			...
			var v16: map<bool, multiset<char>> := map[v11.cf0 := (if (|v15| in v14) then v14[|v15|] else v10)[v3 := v0]];
			v0, v9, v10, v0 := |v8| - |f31|, v9, (if (p2 in v16) then v16[p2] else v10[v3 := v7[552]]) - v10, v7[552] % (v0 / v0);
			...
			var v18: set<int> := {fm25(v17, globalState) / v0, 820, v0};
			v18 := v18;
		}
		for i1 := v0 to v0 + 0x390 {
			var v19, v20, v21 := m0(f31, i1 % v0, p2, -(i1 * i1), globalState);
			v0 := v19 * i1;
		...
		v23 := ([p2, false, p2] + (v23 + v23))[v0 := !p2];
		r0 := p2;
		var v24: array<int> := new int[2](i2 => i2 % v0);
	...
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v1: array<int> := new int[18](i1 => i1 * |(seq(130, i2  => ('r')))|);
			...
			if (v0) {
				...
				var v9: map<int, int> := map[v4 % fm24(true, globalState) := if (v4 in v8) then v8[v4] else |f31|];
				v8 := v8[|(map v10 : int | v10 in (seq(177, i3  => (v4))) :: (v10 % 0xf5) := (v0))| + |f31| := v4 % v4];
				v1 := v1;
				var v11 := new C0();
				...
				var v15 := 'h';
				v0, v14, v0, v0 := f31 == (if (v0) then f31[v4 := v15] else f31), v14, v0, v0;
			}
			
			var v16: seq<bool> := [true];
			var v17: seq<bool> := [v16[0x128], v0];
			r3 := v17;
			if (!v0) {
				...
				v1[456] := -v4;
				v1[456] := v4;
				v1[456] := fm24(v0, globalState);
				var v20: seq<int> := [v1[456], v1[456]];
				var v21, v22, v23 := m0("jnhrpt" + f31, v1[456] + v1[456], v20 <= [v4], |fm30(true, v20, v0, v0, globalState)|, globalState);
			} else {
				var v24 := DC15(v16);
				var v25: map<int, int> := map[v4 := v4 * |v24.cf28|];
				v1[501] := v4;
				var v26: multiset<bool> := multiset{v0, v0};
				v25, v1[501], r1 := v25 + v25, fm24(v0, globalState), fm24(v26 >= multiset{!v0, v0}, globalState);
				var v27 := 'd';
		...
		v33[116] := if (v0) then v0 else v0;
		var v34: seq<bool> := [v0, v0];
		var v35 := DC15(v34);
		v32[485], v33[116] := match v35 {
		...
		match (DC6(v36, v37 >= 405, v38, v0)) {
			case DC6(cf13, cf14, cf15, cf16) =>
				...
				v37, v39 := v37, v39 + v40[v37];
				var v41: T0 := new C4(v37, |f31|, f19);
				v36[700] := |map[v41 := cf16]|;
				var v42: map<bool, int> := map[v33[116] := v37];
				var v43: seq<int> := [v37, if (v0 in v42) then v42[v0] else v37];
				v36[700] := fm37(-v37, |v43|, 0x37b, globalState);
				var v44: array<map<int, int>> := new map<int, int>[24](i4 => map[|v32[485]| := v37]);
				var v45: map<set<bool>, array<map<int, int>>> := map[fm45(v37, v33[116], v0, true, globalState) := v44];
				var v46: seq<set<bool>> := [v32[485]];
				var v47 := DC32(v44);
				var v48: array<array<map<int, int>>> := new array<map<int, int>>[23] [if (v46[|map[v36[700] := f31]|] in v45) then v45[v46[|map[v36[700] := f31]|]] else v44, v44, v44, v44, v44, v44, v44, v44, v47.cf55, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44];
				v48[299] := v44;
				v48[299] := v44;
			...
			case DC7(cf17) =>
				...
				var v58: multiset<map<int, int>> := multiset{v57, fm70(v37, v38, v33[116], globalState)};
				v36[95] := if (multiset{v57, v57} < v58) then v37 - -v37 else -0x2c1;
				var v59: array<string> := new string[8];
				v59[133] := seq(524, i5  => (DC36(v38).cf60));
				v59[133] := f31;
				var v60 := new C3(v0, v38, v34, if (false) then v37 else v37, f19);
		}
		
		var v61: map<seq<bool>, bool> := map[v34 := v0];
		var v62 := new C3(if (v34 in v61) then v61[v34] else v33[116], v38, v34[v37 := v0], v37 - fm40(f31, globalState), f19);
		var v63: array<string> := new string[2] [f31, "s"];
		forall i6 | 0 <= i6 < v63.Length {
			v63[i6] := f31[v37 := if (DC2(v33[116], v37, v33[116]).cf4) then v38 else v38];
		}
		for i7 := v37 to v37 {
			r1 := |f31| + v37;
			...
			r1 := if (v33[116] in v72) then v72[v33[116]] else |f31|;
		}
		var v73: seq<int> := [v37];
		r0 := multiset(v73);
		r1 := v37 % v37;
		...
		r2 := if (v75 in v77) then v77[v75] else if (false) then v76 else v76[v62.f36 := v33[116]];
		r3 := v34 + [v33[116]];
	}
}
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
			...
			decreases 100 - i0
		{
			...
			if (v0[-0x341]) {
				...
				var v7: set<bool> := {p1};
				var v8: seq<set<bool>> := [{p2, fm21(f30, p1, !p2, v5[|v6|], globalState)}, v7];
				v3 := map[v2 := |v8[f30]|];
				var v9 := 'f';
				...
				r0 := !(0x110 <= -0x2a);
				var v18 := "fidn";
				var v19: array<bool> := new bool[24] [p1, !p2, p1, p0, !v0[|v18|], p3, p3, true, p1, p1, p3, p3, p2, p2, p2, p1, p2, p3, false, p2, p1, p3, p3, p1];
			...
			var v31 := 0x4d;
			r0, v27, v30, v31 := p0, v27, map[|"dcjpidp"| := p0] + (fm23(p1, v31, p2, p0, globalState) + v30), (v31 / |v0|) * 0x2d6;
			v31 := v31;
			...
			v27, v31 := DC6(v35, p3, v27, p3).cf15, -(f30 + (|(seq(590, i2  => ('n')))| % 0x17e));
		}
		var v36: seq<bool> := [p1, p3, p2];
		v36 := v36 + v36;
		var v37: seq<int> := [f30];
		for i3 := v37[-f30] to f30 {
			var v38 := 'o';
			...
			var v43 := "fwddxtxnb";
			var v44 := new C2((if (p2) then v40 else v40)[0x317 := v39], ([p3, p3, v36[i3]])[|v42| := false], |v43| % i3, f19);
			r0 := p0 || p2;
			var v45 := 0x193;
			var v46: array<seq<int>> := new seq<int>[22];
			v46[440] := v37;
			v45, v46[440], r0, v45, v45 := -(v45 % -i3), v37, fm21(|"gxfqufpqs"|, p0, p3, i3, globalState) && p1, fm40(v43, globalState) / v45, v45 + (|v43| % f30);
			var v47 := new C4(v46[440][-v45] % v37[f30], f30, f19);
		}
		var v48 := -955;
		...
		for i4 := v48 - v48 to if (!p3) then f30 else |v50| {
			...
			var v52: array<int> := new int[2] [v48, |v51[i4]| + 0x100];
			var v53: map<int, int> := map[f30 := fm22(0x80, i4, globalState)];
			v52[210] := |(v53 + v53)|;
			v52[210] := v48;
			globalState.f7 := v37 + (seq(0x2f8, i5  => (i4)));
			v36 := v36;
			v52[210] := DC30(|v36|).cf53;
		}
		...
		match (v18) {
			case DC9(cf19) =>
				...
				if (fm41(globalState)) {
					...
					var v23: array<seq<bool>> := new seq<bool>[27] [v14, v14, if (v15.f35 in v21) then v21[v15.f35] else v14, v14, v14, v14, v14, [v0, v15.f35, v0], v14, v14 + v14[|v22| := v15.f35], [!v15.f35, v0, !true, v15.f35, v15.f35], [false, v15.f35, v15.f35], v14, v14, v14, v14, [v15.f35], v14, v14, [v15.f35, v15.f35, v0] + v14, [v15.f35, v15.f35, v15.f35], DC15(v14).cf28, v14, [v15.f35, v0, false, v15.f35, fm21(f30, v15.f35, false, f30, globalState)], v14 + v14, [v0, v0], v14];
					v23[711] := [v15.f35];
					v23[711] := v14;
					v15.f35 := v0;
					v0 := v15.f35;
					...
					var v27: multiset<map<int, bool>> := multiset{map v25 : int | (-0x10d <= v25) && (v25 < 0x1e7) :: (v25 / f30) := (v15.f35), v26, v26[v10[f30] := false], v26};
					var v28: map<bool, int> := map[v15.f35 := if (fm59(746, globalState) in v27) then v27[fm59(746, globalState)] else f30];
					v28 := v28[v13 <= (seq(-0xf6, i4  => (v15.f36))) := f30];
					var v29 := DC5(cf19 + v13);
					var v30: array<bool> := new bool[16];
					v30[225] := v15.f35;
					var v31: map<map<int, bool>, int> := map[v26 := f30];
					v29, v30[225] := v29, f30 != ----|(v31 + v31)|;
					v15.f35 := v15.f35;
					var v32: map<int, int> := map[f30 := f30];
					var v33: array<int> := new int[7];
					var v35: set<int> := {fm40(v13, globalState)};
					v30[225], v32, v33, v15.f35 := v14 <= v14, map v34 : int | v34 in v10 :: (v34 / 0x1ec) := (f30), v33, |({-0x2e4, f30, f30} - v35)| != |v13|;
					var v36: set<bool> := {v30[225], false};
					var v37 := DC1(|v32|);
					var v38: map<bool, string> := map[!v0 := "jkbty"];
					v33 := new int[12] [f30, f30, -526, 0x360 / (if (f30 in v12) then v12[f30] else f30), f30, f30, f30, -(v10[|v36|] - |multiset{v15.f35, v15.f35, v30[225]}|), f30 * -|v14|, f30, v37.cf1 * f30, |(if (v15.f35 in v38) then v38[v15.f35] else v13)|];
				}
			...
			case DC10(cf20) =>
				...
				v46[437] := v7;
				v45, v13, r1, v46[437] := v45, v13, -0x72, v7;
			case DC11(cf21, cf22) =>
				v7 := v7[v0 := f30 <= cf21];
				var v47: array<int> := new int[28](i6 => i6 / f30);
				v47[882] := f30;
				r1, v15.f35, v47[882] := cf21, v15.f35, f30;
				var v48 := new C0();
				if (cf22) {
					var v49: multiset<bool> := multiset{v15.f35, v0};
					var v50: array<bool> := new bool[20] [v15.f35, v15.f35, cf22, v15.f35, v15.f36 in v13, if (v15.f35) then v15.f35 else v15.f35, v15.f35, v12 > multiset{cf21, f30}, v15.f35, cf22, v0, v13 <= (seq(0x3a7, i7  => ('u'))), !(multiset{v15.f35} == v49), v15.f35 ==> v15.f35, !(f30 >= cf21), false, v15.f35, v15.f35, !v15.f35, fm21(cf21, true, v15.f35, f30, globalState) <== true];
					v50[919] := DC6(v47, v15.f35, v8, cf22).cf16;
					v50[919] := cf22;
					var v51: seq<array<bool>> := [v50];
					v50[919] := v50 in v51[|[cf21]| := v50];
					var v52: set<map<bool, bool>> := {v7};
					v47 := new int[8] [v47[882], if (v15.f35) then f30 else 0x126, |v52| / |v13|, cf21, |v14|, -v47[882], f30, fm40(v13, globalState)];
					var v53: map<int, bool> := map[v47[882] := v50[919]];
					v50[919] := fm58(v53, globalState);
					var v54: map<string, bool> := map[v13 := 0x192 >= cf21];
					v54 := v54[seq(454, i8  => (v15.f36)) := true];
				} else {
					var v55: array<bool> := new bool[5];
					v55 := v55;
					v47[882] := v10[|v13|];
					v47[882] := |(seq(-0x3bc, i9  => (multiset{v15.f35, v15.f35})))| % (cf21 - v47[882]);
					v15.f35 := v14[0x306 + cf21];
					var v56: map<bool, int> := map[v15.f35 := cf21];
					var v57: set<seq<bool>> := {v14[|[|v56|]| := if (v15.f35 in v7) then v7[v15.f35] else v0], [v15.f35, false]};
			...
			case DC8(cf18) =>
				if (!(cf18 < cf18)) {
					...
					v58[213] := (if (!!false) then v59 else v60[f30]) !in v61;
					var v62: map<int, bool> := map[f30 := !(f30 == f30)];
					v62 := fm59(|map[v58[213] := f30]|, globalState);
					v59[631] := f30;
					var v63 := DC19(f30);
					var v64: seq<D8> := [v63];
					var v65: map<int, string> := map[|v64| := v13[f30 := v8]];
					v59[631] := |v65[-f30 := v13]|;
					v59 := v60[f30 + f30];
					...
					r1, v8, v66[620], v67 := fm40(if (DC37(f30, v15.f35).cf62) then v13 else "aegrnvbt", globalState), v8, v13[if (v15.f35) then f30 else |v13| := 'g'], v67;
					v15.f35 := if (if (v0 in v7) then v7[v0] else v0) then v15.f35 else v15.f35;
					var v68 := DC33(v0, v0);
					var v69 := DC34(v68);
					var v70: seq<D15> := [v69];
					var v71 := DC3(f30, f30);
					v67[819] := 0x157 * v71.cf6;
					...
					v70, v15.f35, v67[819], v72[754], v15.f35 := v70, v15.f35, if (v0 in v74) then v74[v0] else f30, v75.cf65, v76 != map[|v12| := v11];
					var v77: map<int, bool> := map[f30 := v15.f35];
					v74 := fm49(if (v15.f35 in v7) then v7[v15.f35] else if (v67[819] in v77) then v77[v67[819]] else v15.f35, v67[819], globalState);
					v66[620] := v13;
				}
				...
				if (fm21(0x26d - f30, v81 !! v81, v14[|v14|], f30, globalState)) {
					...
					var v87: array<bool> := new bool[23] [(if (v15.f35 in v78) then v78[v15.f35] else -f30) >= f30, v15.f35 || true, v15.f35, v15.f35, v0, v78 >= v78[v0 := f30], v15.f35, v15.f35, v15.f35, v14[f30], v15.f35, v15.f35, fm28(globalState) && false, v15.f35, false, !v0, v15.f35, v15.f35, fm41(globalState), if (v15.f35) then v15.f35 else true, v14[f30], true, !v15.f35];
					v87 := v87;
					v15.f35, v87 := v0, v87;
				...
				var v95: array<int> := new int[23] [f30 + f30, f30, f30, f30 - f30, |(((fm36(DC15([v0]), globalState))[f30 := v15.f36])[|multiset{v15.f35, v0}| := v15.f36])[f30 := v15.f36]| - f30, f30, |v78|, f30, if (v15.f35) then f30 else f30, f30, f30, f30, f30, f30, |("kdjxychws" + v13)|, |v94|, f30, |v14|, f30, -|v7|, fm32(f30, |v7|, globalState) % f30, |v13|, f30];
				v95[347] := -f30;
				v95[347] := (if (v0) then f30 else f30) + (if (v15.f35 in v78) then v78[v15.f35] else |v80|);
			...
			case DC12(cf23) =>
				...
				var v103 := DC21(|v13|, |v14|, v10[-0xce], |v12|, v102);
				var v104: map<int, D9> := map[f30 := v103];
				v104 := v104[v100.f37 := v103];
				r1 := v100.f37;
				r1 := (0x28e / f30) - v100.f37;
		}
...
class C7 extends T0 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		...
		var v12: array<int> := new int[28] [v0, |("yqx" + v1)|, |map[!p1 := v2]|, v0, fm18(globalState), |v3|, |v6|, -(v7.cf1 / fm18(globalState)), 0x68, v0, v0, v0, v0, 0x37f + v0, v0, v0 + v0, |(fm19(v0, v8, v9, map[v2 := -0x385], globalState))[v0 := v2]|, v0, v0, fm18(globalState), |v11| + |(seq(0x395, i1  => (v2)))|, 0x161, v0, -311, v0, v0 * v0, -219 * v0, 900];
		r1 := v12;
		if (false) {
			v10[817] := p2;
			var v13: seq<array<int>> := [v12, v12, v12];
			var v14 := DC6(v12, p2, 'x', p0);
			var v15: array<array<int>> := new array<int>[17] [v12, v12, v12, v13[v0], v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v14.cf13];
			v15[430] := v12;
			var v16 := DC5(v1);
			var v17: map<map<D2, string>, int> := map[map[v16 := seq(0xf7, i2  => (v2))] := v0];
			var v18: map<D2, string> := map[v16.(cf12 := v1) := v1];
			v10[817], v0, v15[430], v0, r0 := true, v0, v12, if (v18 in v17) then v17[v18] else v0, p1;
			if (!p2) {
				v1 := v1 + (v1 + v1);
				...
				var v22: seq<multiset<D1>> := [multiset{DC4(v10[817], p0, true, !p3, p2), v20} - v21, v21, v21, multiset{v20}];
				...
				v2 := v2;
				v10[817], r0, v0 := p2, p3, v0;
			} else {
				var v26: set<int> := {v0, v0};
				var v27 := DC4(p1, v10[817], v26 >= v26, p3, v10[817]);
				v0, r0, v3, v27 := v0, v10[817], v3, v27;
				v10[817] := v6 !! multiset{v0};
				v0 := v0 % v0;
				v10[817] := p2 && p1;
				var v28: seq<bool> := [p3];
				var v29: map<string, bool> := map[v1 := p0];
				var v30: seq<int> := [v0];
				var v31: array<bool> := new bool[18] [!true, v28[fm18(globalState)], v1 !in v29, v10[817], v10[817], p1, p3, v0 <= v0, p0, p2, v30 == [v0, v0, v0, v0], !fm20(globalState), !(v0 < |v1|), p0, p1, p1, v10[817], p3];
				v31 := new bool[10] [p3, p0, v10[817] ==> v10[817], v10[817], v10[817], p2, p2, p1, p1, p2 || p3];
			}
			...
			if (p0 <== p1) {
				...
				var v40: array<set<int>> := new set<int>[19] [v37, v37 + v37, v37, {--|map[p2 := 0x25a]|, v0}, if (p0) then v37 else v37, v37, v38[v0], v37, v37, {|v1|, v0, 220} + v37, v37, v37 * {v0}, v37, v37 - v37, v37 * (set v39 : int | (0x383 <= v39) && (v39 < 79) :: (v39 + v0)), {v0}, v37, v37, if (v10[817]) then v37 else {v0}];
				v10[817], v33, v40, v0, v10[817] := p2 && v10[817], v33 - v33, v40, v0, p2;
				var v41: seq<int> := [v0];
				var v42: map<seq<int>, string> := map[v41 := v1];
				var v43, v44, v45 := m0(v1[|v4| := 'x'], v0, fm20(globalState), |(if (v41 in v42) then v42[v41] else v1)| - v0, globalState);
			} else {
				v0 := |v9|;
				var v46: seq<int> := [v0, v0, |v1|];
				globalState.f7 := v46;
				v3 := v3[v0 % v46[v0] := -0x339];
				var v47: set<bool> := {p2};
				var v48: seq<bool> := [p3, v10[817], p2];
			...
			var v52: multiset<array<int>> := multiset{v12, v15[430], v15[430]};
			var v53: seq<bool> := [DC33(p0, v10[817]).cf56, v10[817]];
			var v54 := new C6(v52, |(v53 + v53)[v0 := v10[817]]|, f19);
			...
			var v58: seq<int> := [v0];
			v57 := v57[|((seq(-0x2ad, i3  => (v0))) + v58)| := p2];
		...
		var v66: map<T1, string> := map[v65 := seq(0xc4, i5  => (v2))];
		var v67: array<string> := new string[28] [v1, v1[-v0 := v2], fm19(|v9|, v8, v9, v62, globalState), v1 + v1, v1, v1, v1, v1 + v1, v1, v1, v1 + v1, v1, v1[v0 := v2], fm60(v2, globalState), v1, v1, "ypxxvgrag", v1, DC9(seq(80, i4  => (v2))).cf19 + (if (v65 in v66) then v66[v65] else v1), seq(-0x31e, i6  => (v2)), "ndyinkcp" + v1, v1 + v1, v1, v1, v1, "shilf", seq(-892, i7  => (v2)), v1];
		v67[657] := v1;
		var v68 := DC19(v0);
		v10[401], v67[657], v65.f21, v65.f21 := p2, match v68 {
			case DC19(cf32) => "jbdfmmag"
			case DC18(cf31) => v1
		}, |v65.f20|, v65.f21 * v0;
		var v69 := new C1(fm57(v64, 0x361, v65.f21, p0, globalState), v10[401], v65.f19);
		r0 := v67[657] == v67[657];
		r1 := v12;
	}
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		if (v0) {
			...
			var v2 := -0x342;
			var v3: map<bool, multiset<bool>> := map[if (v1[v2]) then v0 else v0 := if (v0) then multiset{v0, v0} else multiset{v0}];
			...
			v7[534] := false;
			var v8 := 'h';
			var v9: map<char, bool> := map[v8 := v7[534]];
			...
			if (v0) {
				...
				v27[437] := if (v12 in v26.f32) then v26.f32[v12] else fm21(v12, v0, v19.f35, 0xd8, globalState);
				var v29 := DC16(v20);
				...
				r1, v27[437], v12 := v12, v19.f35, if (DC12(v34) in v33) then v33[DC12(v34)] else v12;
			} else {
				v0 := v0;
				var v35: array<string> := new string[13];
				v35 := if (v18[v12]) then v35 else v35;
				var v36: array<int> := new int[7](i2 => i2 / v12);
		...
		var v43 := DC21(v41 * -v41, v41, v41, v41 - |multiset{|(seq(-0x2e5, i4  => (map[|"cjxx"| := 'v'])))|, 0x38c}|, v42);
		v43 := v43;
		var v44: map<int, string> := map[v41 := DC9("rtjk").cf19];
		r1 := |v44|;
		var v45: set<string> := {seq(0x16f, i7  => ('d'))};
		var i6 := 0;
		while (!((v45 - {seq(-0x1e9, i8  => ('o'))}) >= v45))
			decreases 100 - i6
		{
			if (i6 >= 100) {
				break;
			...
			v46[443] := v41 * |(seq(-832, i9  => ('l')))|;
			v46[443] := -v41;
			var v47 := 'w';
			v47 := v47;
			v0 := !(if (fm20(globalState)) then !v0 else !v0);
			if (v0) {
				var v48 := new C4(v41, v46[443], f19);
				v0 := false;
				var v49: array<bool> := new bool[11];
				var v50: seq<bool> := [v0];
				v49[961] := v0 !in v50;
				var v51 := "k";
				v49[961] := !(((seq(0x28f, i10  => (v47))) <= v51) <==> v0);
				var v52: map<int, int> := map[|((seq(0x2bf, i11  => (v47)))[0xa0 := v47])[v48.f34 := v47]| := |v51|];
				v52 := v52[v46[443] := v48.f34];
				v51 := (v51 + (if (false) then v51 else v51)[v48.f33 := v47])[v46[443] * v46[443] := v47];
			} else {
				var v53: C0 := new C0();
				var v54: seq<C0> := [v53, v53, v53];
				var v55: multiset<bool> := multiset{v0};
				var v56 := DC35(v54[|v55|]);
				v56 := v56;
				...
				v59 := v59;
				var v60 := "evekd";
				var v61: seq<string> := [v60[v41 := v47] + v60, if (v0) then v60 else DC9(v60).cf19, v60];
				v61 := v61 + v61;
				var v62: seq<int> := [v41];
				var v63: set<bool> := {v0};
				var v64: array<bool> := new bool[10] [v0 ==> v0, true, v0, v0, v62[v41] < v46[443], "uyi" < (seq(0x8a, i12  => (v47))), v63 >= v63, v0, !true, !(v41 != v46[443])];
				v64 := DC18(v64).cf31;
			}
		...
		r2 := v69;
		var v70: seq<bool> := [v0];
		var v71: seq<bool> := [v70[-v41], v0, v0];
		r3 := v71;
	}
}
...
class C8 {
	...
	method m6(p0: string, globalState: GlobalState) {
		...
		if (fm15(v0, f28, globalState)) {
			...
			var v9 := DC8((seq(258, i0  => (f28)))[v1 := f28]);
			var v10: set<seq<int>> := {v7 + v7[f28 := v1], fm16(v1, v8, 0x7c, globalState), v7 + v9.cf18, v7};
			v1, v3 := |v10|, v3;
			var v11 := 'j';
			var v12: array<bool> := new bool[14] [v0, p0 == p0, v0, "qxvtmom" < "yasol", v0, p0 < p0, v0, v0, true, !(p0[-0x183 := v11] < (seq(608, i1  => (v11)))), v0, v0, v0, v0 && v0];
			var v13 := DC4(v0, v0, v0, v0, fm15(v0, f28, globalState));
			v12[731] := v13.cf9;
			v12[731] := !((multiset(v7) * multiset(v7[f28 := f28])) > fm17(v0, globalState));
			var v14: seq<bool> := [v0];
			...
			var v23: set<string> := {"qsn", ("vqictoyl")[f28 := 's']};
			...
			var v25 := DC28(v24);
			var v26: seq<bool> := [v0];
			v25, v0 := DC28(v24).(cf52 := v24), v26[f28];
		}
		
		v0 := f28 == (f28 + f28);
		var v28: map<int, int> := map[682 := f28];
		var v30: seq<map<int, int>> := [map v27 : int | (0x33a <= v27) && (v27 < 0x2f5) :: (v27 - f28) := (f28), v28, map v29 : int | v29 in (seq(0x2b4, i3  => (f28))) :: (v29 + f28) := (0x2f4), v28, v28];
		var v31: set<int> := {f28, f28};
		var v32: set<int> := {|v31|, 633};
		var v33: map<seq<map<int, int>>, int> := map[v30[f28 := v28] + fm78(!false, -|v32|, globalState) := |v31|];
		v33 := v33[v30 := f28];
		var v34 := 0x237;
			...
			decreases 100 - i4
		{
			...
			var v38: array<int> := new int[23] [v35.cf21 + |(multiset{v0})[v0 := v34]|, f28, -f28, -v34, |(v36 + v36)|, v34, v34, v34, f28 / v34, f28, f28, f28 - f28, v34, v34 / v34, v34, v34, f28, v34 / v34, -f28, v34, |v37|, if (v0) then 0x240 else v34, |{-v34, -f28, f28, v34}|];
			v38 := if (true) then v38 else v38;
			var v39: seq<string> := [p0, "bnrombvo"];
			var v40: seq<bool> := [v0];
			var v41 := DC15(v40);
			var v42: array<string> := new string[14] [v39[v34], p0, fm36(v41, globalState) + "datb", p0, p0, p0, p0, p0, p0, p0, seq(338, i5  => ('i')), if (v0) then p0 else p0, p0, p0];
			var v43 := DC10(|p0|);
			var v45 := 'q';
			var v46: set<char> := {v45};
			v42[611] := fm19(-v34, v43, v36, map v44 : char | v44 in v46 :: (v44) := (f28), globalState);
			v42[611] := (p0 + "fn") + p0;
			...
			match (v47) {
				case DC2(cf2, cf3, cf4) =>
					var v48: multiset<int> := multiset{fm32(|v42[611]|, cf3, globalState) - |p0|};
					v48 := v48;
					...
					var v55 := new C6(v52[v38 := |p0|], cf3, if (f28 in v54) then v54[f28] else v53);
					var v56: map<bool, int> := map[v0 := cf3];
					v34 := if (false) then cf3 / |v56| else |[v48]| - |p0|;
				case DC3(cf5, cf6) =>
					var v57: multiset<char> := multiset{v45, v45, 'n'};
					var v58: multiset<seq<bool>> := multiset{v40};
					var v59: array<bool> := new bool[20] [v57 !! v57[v45 := |[cf6, |p0|]|], v0, v0, v0, !(false || v0), v0, v0, v0, v40 in v58, v34 >= |v42[611]|, v0 ==> v0, v0, -77 < |v42[611]|, v0, v0, v0, !v0, false, v0, true];
					v59[242] := v0;
					v59[242] := !v0;
				...
				case DC4(cf7, cf8, cf9, cf10, cf11) =>
					...
					v42[611] := p0 + "grdecqxl";
					v34 := f28;
					v28 := v28 + (map v62 : int | v62 in v37 :: (v62 / f28) := (f28));
				case DC1(cf1) =>
					v42[611] := p0;
					v0 := v0;
					var v64: array<bool> := new bool[12] [!v0, !v0, true, v0, v0, true, v0, v40[|(set v63 : int | v63 in v28 :: (v63 - 0x1e9))|], true, v0, v0, false];
					...
					v66[746] := if (v0) then v67 else v67;
					v38[84] := -f28;
					var v68: map<bool, map<bool, bool>> := map[v0 := v36];
					v65[289], v34, v66[746], v38[84] := v64, f28, v67, |(if (v0) then v36 + v36 else if (false) then if (v0 in v68) then v68[v0] else v36 else v36)|;
					v38[84] := f28;
			}
			
		}
		var v69: map<string, bool> := map[p0 := v0];
		var v70: seq<int> := [|(seq(0x139, i6  => ('s')))|, v34];
		var v71: seq<bool> := [!!v0];
		var v72: set<bool> := {false};
		var v73: multiset<set<bool>> := multiset{v72, v72, v72};
		var v74: array<int> := new int[25] [v34 / |v69|, v70[f28], 0x2cd, f28 / |p0|, fm18(globalState), v34, f28, |p0|, f28, 0x2b8, 344, if (false) then f28 else f28, f28, |v71|, v34 / v34, |v71|, f28 - v34, f28, f28, v34, v34 + f28, |v73| * v34, --(if (v0) then -|p0| else 0x2b4), f28, v34];
	...
	method m7(p0: bool, globalState: GlobalState) returns (r0: seq<bool>, r1: multiset<bool>, r2: bool) {
		...
		var v2: array<int> := new int[6] [-f28, f28, f28, if (p0 in v1) then v1[p0] else f28, f28, |(seq(-0x67, i0  => (seq(0x188, i1  => ('q')))))|];
		...
		if (fm28(globalState)) {
			...
			v9, v10, r2 := fm80(v11.cf32, globalState) + ((seq(-0x3d0, i3  => (v8))) + v9), {v6.f30, |v12|, v6.f30} + v10, p0;
			var v13: map<int, int> := map[f28 := v7];
			var v14: seq<int> := [|[|v13|]|, |v0|, v7, v6.f30];
			var v15: multiset<bool> := multiset{!p0, p0};
			v7 := -(f28 * |v14|) / (if (p0 in v15) then v15[p0] else v6.f30);
			...
			var v21: seq<multiset<int>> := [multiset(v18), multiset{v6.f30, v2[231]}, v20, v20];
			var v22 := DC22(p0, if (p0) then p0 else p0, v20 !in v21, v6.f30 % v2[231], p0);
			match (v22) {
				case DC21(cf34, cf35, cf36, cf37, cf38) =>
					...
					r2 := v24.cf50;
					r2 := (cf36 > f28) && !p0;
					var v26: array<int> := new int[18] [v2[231], cf35, cf36, -cf35, |(seq(-0x27b, i5  => ('p')))|, f28, f28, f28, -v6.f30, |(set v25 : char | v25 in v0 :: (v25))|, v6.f30, v2[231], f28, 0x1eb, cf34, |v17|, -cf35, cf37];
					...
					var v33 := DC21(|[p0]|, cf36, v6.f30, v6.f30, v32[cf37]);
					v29, v4[464], globalState.f7, cf37, r2 := [v28], v17[fm40(v0[|v0| := fm61(0x39f, v6.f30, globalState)], globalState)], v18, -(if (p0) then |v17| else |v31[v33.cf37]|), fm15(cf34 > 998, cf37, globalState);
				case DC22(cf39, cf40, cf41, cf42, cf43) =>
					...
					var v36 := DC10(|v18|);
					v35[144] := v36;
					v35[144], cf40 := fm81(globalState), true;
				case DC20(cf33) =>
					var v37 := 'b';
					...
					v38[456] := v0 + v0;
					v38[456] := (if (p0) then seq(271, i7  => (v37)) else seq(0xdc, i8  => (v37))) + "wgpc";
			}
		...
		v43 := v43[v6.f30 / f28 := p0];
		var v44: seq<int> := [f28];
		var v45: multiset<int> := multiset{f28, v44[v6.f30], -0xbb, |v0|};
...
class C9 extends T0, T1 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
			...
			decreases 100 - i2
		{
			...
			f21 := f21;
			f21 := -f21;
			var v8: map<bool, bool> := map[p3 := v3[394]];
		...
		if (p1) {
			...
			v13[478] := v14;
			v12, v0, v13[478], f21 := v12, v0 + v0, v14, -f21;
			...
			v15[197], v15[370], f21, f27, v3[394] := |"rmyxlrr"|, |((v18 + v18) + v18)|, 0x1ac - |v17|, true, p3;
			var v19 := DC0(p3);
			match (if (fm12(globalState)) then DC0(p1) else v19) {
				case DC0(cf0) =>
					var v20: map<int, int> := map[v15[197] := v15[197]];
					v15[197] := v15[197] / |v20|;
					f21 := f21 + (v15[197] / fm13(fm13(if (p1 in v12) then v12[p1] else v15[197], true, globalState), p2, globalState));
					var v21: map<string, bool> := map[v0 := cf0];
					v21 := v21[v0 := cf0];
					var v22: map<bool, array<int>> := map[f27 := v15];
					var v23 := 'i';
					var v24 := DC6(if (p3 in v22) then v22[p3] else v15, f27, v23, v3[394]);
					v24 := v24;
			}
			
			var v25 := new C4(f21, v15[197] / f21, f19);
			v3[394] := p1;
		} else {
			v3[394] := p1;
			v3[394] := v7 >= v7;
			...
			v26 := v26[f21 := f21];
			var v27: set<bool> := {p1};
			r1 := new int[23] [f21, if (f21 in v26) then v26[f21] else f21, f21, f21 * 239, f21, f21, f21, f21, -(f21 / f21), f21, f21, |(if (p2) then v0 else v0)|, f21, f21, f21, |[|v27|]|, f21, f21, |(v0 + v0)|, f21, f21, f21, f21];
			r0 := f27;
		}
		...
		if ((v28 * v28) != v28) {
			f27 := ([f27] + [p2]) < f20;
			globalState.f7 := seq(0x160, i3  => (f21 / f21));
			...
			v30 := v30;
			v4 := v4 + v4;
			var v31: map<bool, int> := map[v3[394] := f21];
			var v32: multiset<map<bool, int>> := multiset{v31, v31};
			var v33, v34, v35 := m0(seq(0xb1, i4  => ('k')), f21, f21 > (if (v31 in v32) then v32[v31] else f21), 0x1fc, globalState);
			var v36 := 'a';
			v2[575] := v36;
			var v37: array<array<int>> := new array<int>[25];
			var v38: multiset<bool> := multiset{p2};
			var v39: multiset<multiset<bool>> := multiset{v38};
			v2[575], v0, v37 := fm61(|(([v35, p2])[|f20| := f27])[f21 := p2]|, |v39|, globalState), "opbeagfxe", v37;
			var v40: C3 := new C3(v3[394], v36, f20, -v33, f19);
			var v41: set<C3> := {v40, v40, v40, v40};
			var v42: set<set<C3>> := {v41};
			var v43: seq<map<int, bool>> := [v6];
			var v44: array<int> := new int[29] [967, f21 * f21, v33, v33, |v4|, v33 / f21, -v33, f21, fm13(-f21, p0, globalState), f21, fm40(v0, globalState) - -v33, f21, |map[false := v33]| + v33, |v42|, -f21, v33, f21 % f21, v4[-f21], |v31|, f21, v33 % 0x3d5, v33, v33, f21, f21, 395, -0x17d, v33, |v43|];
			var v45: map<bool, bool> := map[f27 := true];
			var v46: map<char, int> := map[v2[575] := f21];
			v44[299] := --(f21 - |[|fm19(v33, DC10(|v45|), v45, v46, globalState)|]|);
			var v47: set<bool> := {p3};
			var v48: multiset<set<bool>> := multiset{if (!f20[v33]) then {p2} else v47, {fm12(globalState)}, v47, v47};
			v44[299] := |v48|;
		}
		
		r0 := if (p0) then f20[469] else p0;
		var v49: set<bool> := {false, p3, v3[394], v3[394]};
		r1 := new int[24] [f21, f21, f21, f21, f21, |v7|, f21, f21, f21, f21, -(f21 * f21), -f21, f21, 259, f21 % f21, f21, f21, f21, f21, f21, |(v49 + v49)|, f21 / f21, f21, f21];
	}
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		var v0 := 'm';
			...
			decreases 100 - i1
		{
			...
			var v10: array<int> := new int[16] [f21, f21, v5.cf34, f21, fm40(v6, globalState), f21, -v7.cf20, -743 + |v6|, --(f21 % f21), f21, 0x316, fm37(|v6|, f21, -|v6|, globalState) - f21, f21, |v6|, |v8| / f21, |v9|];
			v10[848] := f21;
			v10[848] := -0x28a;
			match (DC18(if (!f27) then v3 else v3)) {
				case DC19(cf32) =>
					var v11 := DC18(v3);
					v11 := v11;
					f27 := if (f27) then !fm15(f27, v10[848], globalState) else f27;
					...
					v10[848], v10[848], v8 := (v10[848] / |v12|) + v10[848], -|(v13.cf18 + [f21, cf32])|, (map v14 : int | v14 in v15 :: (v14 * f21) := (f21)) + v8;
					var v16: map<char, bool> := map[v0 := f27];
					var v17: seq<map<char, bool>> := [v16[v0 := true]];
					var v18 := new C2(v17, f20, |map[f27 := DC11(v10[848], f27)]|, f19);
				case DC18(cf31) =>
					v3[550] := f27;
					f21, v10[848], f27, v3[550] := if (f27) then f21 else v10[848], 0xc8, f27, f27;
					f21 := v10[848] % |v6|;
					v10[848] := v10[848];
					v3[550], v10[848], v8, v0 := f27, f21, map[v10[848] := -0x278], v0;
			}
			
			v3[32] := f27;
			var v19: map<int, bool> := map[v10[848] := f27];
			var v20: multiset<map<int, bool>> := multiset{v19};
			v3[32] := (v20 * v20) >= fm82(f21, globalState);
			v3[32] := v0 !in (seq(0x31f, i2  => ('y')));
		}
		var v21 := "ymiycc";
		var v22: map<int, int> := map[f21 := f21];
		var v23, v24, v25 := m0(v21, if (f21 in v22) then v22[f21] else f21, f27 in f20, f21, globalState);
		var v26: multiset<string> := multiset{seq(0x271, i3  => (DC36('s').cf60)), v21, "idhgwi", v21};
		...
		if (!f27) {
			...
			var v31 := DC36('d');
			var v32: array<D17> := new D17[5] [DC36(fm31(!v25, map[|(map v30 : int | v30 in map[f21 := f21] :: (v30 % v23) := (f27))| := v23], f21, globalState)), DC36(v0), v31, fm83(v23, true, v25, f27, globalState), v31];
			...
			v33[575] := v32;
			v33[575] := v32;
			var v34: map<bool, string> := map[f27 := seq(793, i4  => (v0))];
			var v35: map<bool, string> := map[f27 := if (v25 in v34) then v34[v25] else v21];
			var v36: map<bool, int> := map[v25 := v23];
			v21, f21, v21 := if (v25 !in f20) then v21 else (if (!v25 in v35) then v35[!v25] else "esdsslqn")[|v36| := v0], f21, v21;
			v21 := v21;
		} else {
			...
			var v44: array<int> := new int[28] [v23 * |map[f27 := f27]|, f21, fm37(|(if (f21 in v37) then v37[f21] else v39)|, f21, v23, globalState) * f21, v23, 0xa6 * v23, if (!v25) then |f20| else v23, v23 - v23, f21, f21, v23, v23, -130, v23 % |v21|, f21, f21 % f21, -(-0x18b / v40.cf25), |f20| % -v23, v23, f21, -v23, v38[f21], f21, v23, v23, if (f27 in v41) then v41[f27] else v23, |f20|, v23, |multiset{|v43|, f21}|];
			v44[466] := f21;
			v44[466] := (if (v25 in v41) then v41[v25] else v23) / f21;
			v3[189] := v44[466] >= v44[466];
			v3[189] := f27;
			var v45: array<seq<int>> := new seq<int>[12];
			v45[823] := v38[0x325 := f21];
			v45[823] := v38;
			var v46: array<bool> := new bool[25];
			v46 := v46;
			v44 := new int[11](i5 => i5 / v44[466]);
		}
		...
		r0 := multiset{if (v0 in v47) then v47[v0] else v23, v49[400], f21 - f21, v23, v23};
		r1 := -f21;
		var v50: multiset<int> := multiset{0x35a};
		var v51: map<char, bool> := map[v0 := v50 >= v50];
		r2 := v51;
		var v52: array<int> := new int[5](i6 => i6 / -|"xswme"|);
...
class C10 extends T1, T0 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		...
		var v10: array<bool> := new bool[28] [v2 > multiset(v3), f26, true, p3, v4 < v4, v4 == v4, v5 > v5, p1, p1, p3, false, p3, f21 == f21, f26 <==> p3, p2, p0, fm10(v8, f25, p3, globalState) ==> p0, f26, p1, p1, f26, f26, f26, true, p2 && f20[|v9|], true, p3, p0];
		var v11: multiset<int> := multiset{f21, f21};
		v10[895] := multiset([f21]) !! v11;
		v10[526] := p3;
		var v12 := DC2(p2, f21, f26);
		var v13 := DC4(p0, p2, p1, fm10(v8, f25, v12.cf2, globalState), p2);
		var v14: set<string> := {"f"};
		v10[895], v10[526], v13, r0, f21 := p0, p2, DC4(p1, false, f21 >= f21, if (f21 in v6) then v6[f21] else p0, v14 >= v14), f26, f21;
		...
		var v18: array<int> := new int[14] [0x258, f21, |v16.cf12|, f21 - fm11(f21, globalState), f21, f21, 0x201, -f21 + (if (v11 in v17) then v17[v11] else f21), fm11(|v4|, globalState), f21, f21 + f21, f21 % f21, -f21, f21];
		r1 := v18;
	}
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		if (DC6(v0, !f26, f25, f26).cf14 ==> f26) {
			...
			if (!(multiset{f21} == (v9 - v9))) {
				...
				var v19: array<bool> := new bool[11] [f26, f26, f26, true, f26, if (!f26) then f26 else f26, f26, f20[fm32(f21, -f21, globalState)], !fm58(v18, globalState), f26, f26];
				v19[660] := f26;
				var v20: set<set<int>> := {v8, v8 - v8};
				var v21: map<bool, string> := map[f26 := v15];
				var v22: map<set<int>, int> := map[v8 := |v21|];
				f26, v17, v19[660], v20, r1 := f26, (v17 + v17) - multiset{v16}, f21 != f21, (set v23 : set<int> | v23 in v22 :: (v23)) * v20, |v15| % f21;
				var v24: C1 := new C1(f21, f26, v11.f19);
				v24 := v24;
				var v25: seq<string> := [v15];
				var v26 := DC10(f21);
				var v27: map<bool, bool> := map[false := v24.f38];
				var v28: map<char, int> := map[v15[v24.f37] := |v15|];
				var v29: array<string> := new string[26] [v15, v15 + v15, v15, seq(0x264, i1  => (f25)), v25[|(seq(0x53, i2  => (|map[v24.f38 := f25]|)))|], v15, v15, v15, v15 + v15, v15, v15, v15, v15, if (v24.f38) then v15 else v15, v15, v15, fm19(|v15|, v26, v27, v28, globalState), v15, v15, v15, v15, v15, if (v19[660]) then v15 else v15, v15, v15, v15 + (seq(0x2bd, i3  => (f25)))];
				v29[933] := v15;
				r1, v29[933], v19[660], v19 := f21 * f21, DC14(f21, v24.f37, v15).cf27, f26, v19;
			} else {
				var v31: map<int, bool> := map[|map[set v30 : int | (-0x391 <= v30) && (v30 < -0x3d0) :: (v30 / -|[f21]|) := f26]| := f26];
				...
				var v35: seq<int> := [682];
				var v36 := DC43(v9);
				var v37: map<int, int> := map[v35[|(v36.(cf70 := multiset(v35))).cf70[f21 := f21]|] := -f21];
				v37 := v37;
			...
			var v40 := DC19(f21);
			var v41: array<bool> := new bool[24] [f26, f26, f26, f26, f26, f20[v40.cf32], f26, f26, f26, f26, f26, false, f26, f26, f26, f26, f26, f26, true, f26, f26, f26, f26, f26];
			var v42 := DC18(v41);
			v42 := DC18(v41);
			v41[358] := f26;
			v41[358] := f26;
		...
		if (fm12(globalState)) {
			...
			var v48: seq<int> := [f21];
			f25, f26, v47, f21, v0 := v43[f21], [f21, f21] <= ([|v43|] + v48), v47, -f21, v0;
			f26 := v47.f27;
			var v49: array<bool> := new bool[23];
			v49[805] := v47.f27;
			v49[805] := !(f21 > |(v43 + v43)|);
			r1 := f21 * 0x184;
			var v50: map<int, bool> := map[f21 := v49[805]];
			var v52: set<bool> := {v49[805]};
			...
			v50, r1, f21, v49[805] := v50[if (if (0x107 in v50) then v50[0x107] else f26) then f21 else f21 := !v49[805]], f21, (|(map v51 : int | (0x384 <= v51) && (v51 < 0x2fa) :: (v51 + f21) := (v49[805]))| - -f21) + f21, !(if (v53 in v55) then v55[v53] else v47.f27);
		} else {
			var v56 := DC46(v46);
			f26 := |v56.cf76| != f21;
			f26 := f26;
			...
			r3, v0[136], f26, r1 := f20[fm40(v43, globalState) := !(v43 != v43[|v43| := f25])], if (f20[f21]) then f21 else f21, f26, |(if (f26) then v57 else v57)|;
			v0[136] := f21;
		}
		...
		if (fm28(globalState)) {
			...
			v46, f26, f26, f26, f26 := v46 + (if (f26) then if (f26 in v61) then v61[f26] else v62[f21] else v46), f20[128], f26, f26, f26;
			var v63: seq<int> := [f21];
			...
			v69[10] := v64[f26 := f21] != v64;
			var v70: seq<seq<bool>> := [f20];
			f26, v69[10] := f26, |(seq(734, i6  => (f21)))| >= -|multiset([f20, f20, fm51(DC6(v0, f26, f25, f26).cf16, globalState), f20] + v70)|;
		} else {
			var v71 := DC6(v0, !f26, f25, f26);
			if (v71.cf16) {
				var v72: seq<int> := [f21];
				r1 := v72[fm18(globalState)] * f21;
				var v73 := DC25();
				...
				v0[597] := |(v78 + v78)|;
				f21 := |((if (f26) then v72 else v72) + [v0[597], v72[-0x31c]])|;
			...
			var v102: map<seq<int>, int> := map[v101 := 0x37e / -|v101|];
			f21, v0, v0[481], f21 := |v97| % |(if (f26) then v98 else map v99 : multiset<bool> | v99 in v100 :: (v99) := (false))|, v0, if (v101 in v102) then v102[v101] else |v43|, f21 % |"tlaa"|;
			var v103 := DC22(f26, f26, f26, |v91|, f26);
			var v104: map<D9, string> := map[v103 := v43];
			v0[481], v0[481], f26, f21, f26 := v0[481], v0[481], ((if (v103 in v104) then v104[v103] else v43) + v43) == (seq(0x2dc, i7  => (f25))), -v0[481], -0x1a8 >= v0[481];
		}
		
		r0 := fm17(f26, globalState) * v58[314];
		r1 := f21;
...
class C11 extends T1 {
	...
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		if (fm7(globalState)) {
			...
			match (if (p2) then v3 else v3) {
				case DC2(cf2, cf3, cf4) =>
					var v4: seq<int> := [cf3];
					var v5 := DC2(false, v4[f21], p1);
					var v6 := "edbgfxdt";
					var v7: map<int, char> := map[v5.cf3 := v6[cf3]];
					v7 := v7[0x5b := v6[v4[f21]]];
				...
				case DC3(cf5, cf6) =>
					...
					v10, v11[355], r0, v15, r0 := v10, if (f20 in v16) then v14 else v14, fm7(globalState), seq(0x13f, i1  => (v10)), p3;
				...
				case DC4(cf7, cf8, cf9, cf10, cf11) =>
					...
					var v20 := "lt";
					v19[63] := map[cf9 := v20];
					var v21: array<int> := new int[7](i2 => i2 % |v20|);
					...
					cf8, v19[63], cf11, v21[436] := cf7, map[p3 := v20 + v20], p1, if (f21 in v25) then v25[f21] else |v27|;
					var v28 := 'e';
					var v29: T0 := new C10(v28, p3, [p3], v21[436], f19);
					var v30: set<int> := {v21[436], v21[436], |v25| * v21[436], fm37(v21[436], v21[436], v21[436], globalState), if (true) then v21[436] else f21};
					var v31: seq<seq<int>> := [v27];
					v29, globalState.f7, v30 := v29, v31[-f21], v30;
					cf11 := cf8;
					f21 := f21;
				case DC1(cf1) =>
					var v32 := new C7(f19);
					...
					var v44: array<int> := new int[12] [f21 - -cf1, f21 + |v33|, f21, -cf1, -fm57(v36, cf1, cf1, p1, globalState), cf1, |(seq(114, i3  => (multiset{cf1})))|, cf1 % f21, cf1, f21, cf1, -(f21 + |v43|)];
					r1 := v40;
					r0 := !p1;
					var v45 := new C2(v36, f20, -294 / |(seq(0x262, i4  => (-f21)))|, f19);
			}
			
			var v46: array<int> := new int[17];
			var v47: set<int> := {-f21};
			var v49: array<int> := new int[16] [f21, f21, f21, f21, f21, |map[v46 := p2]|, -0x362, -f21, |v47|, |(set v48 : int | (0x1f8 <= v48) && (v48 < 25) :: (v48 % |map[f21 := f21]|))|, f21, f21, f21, f21, f21, f21];
			var v50 := 'p';
			...
			if (p1) {
				...
				v57[632], r0, r0, v59 := v62[|fm77(p3, globalState)|] / f21, !fm10(v63 * v63[v62 := f21], 'n', f21 == f21, globalState), if (v66 in v65) then v65[v66] else p1, fm38(map v67 : int | v67 in (seq(0x3e0, i6  => (f21))) :: (v67 - |v62|) := (|v60|), v60, globalState);
				r0 := p1;
				var v68 := DC22(p3, p3, false, v57[632], p0);
				f21 := v68.cf42;
			} else {
				f21 := f21;
				var v69 := 'k';
				...
				var v72 := "bux";
				var v73: seq<string> := [v72[f21 := v69]];
				var v74: seq<array<array<bool>>> := [f19, f19];
				var v75 := new C4(|v72| / |v73|, f21, v74[f21]);
				var v76: array<bool> := new bool[10](i7 => p0);
				v76[289] := v72 == fm48(p2, globalState);
				v76[289] := f20[v75.f34];
			}
		...
		var v80: set<bool> := {p2};
		var v82: seq<int> := [f21, |(set v81 : int | (0x341 <= v81) && (v81 < -358) :: (v81 / f21))|, 0x252];
		var v83: multiset<int> := multiset{f21, |v82|, f21};
		v80 := {p0, p1, f21 !in v83, !p0, p2};
		f21 := fm11(f21 / f21, globalState);
		var v84 := 'i';
		var v85 := "ryrkfh";
		var i8 := 0;
		while (v84 !in v85)
	...
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		if (match v0 {
			...
			case DC36(cf60) => {"xiyvn"} < {seq(0x252, i0  => (cf60))}
		}) {
			var v1 := 'r';
			v1 := v1;
			var v2 := false;
			...
			var v9: set<bool> := {f20[f21]};
			if (v9 > v9) {
				var v10: multiset<bool> := multiset{v2 ==> v2};
				var v11: array<bool> := new bool[7];
				v11[306] := v2;
				v2, v10, v11[306] := v2, v10, v2;
				v2 := v11[306];
				var v12: array<int> := new int[11](i1 => i1 * f21);
				var v13: seq<int> := [f21, f21];
				var v14 := new C6(multiset{v12, v12, v12} * multiset{v12}, v13[f21], f19);
				v11[306] := v11[306];
				v12 := v12;
			} else {
				r1 := f21;
				v2 := v3 <= (seq(0x3e7, i2  => (v1)));
				v1 := v1;
				...
				v17[97] := |(map v18 : seq<bool> | v18 in (map v19 : seq<bool> | v19 in v20 :: (v19) := (v16.f26)) :: (v18) := (f21))| < 126;
				v17[97] := !fm20(globalState);
			}
		...
		for i3 := f21 to 0xd3 {
			...
			var v38: map<bool, array<map<int, int>>> := map[f20[i3] := v37];
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v40 := "rm";
			var v41: seq<string> := [v40, v40, seq(0x2a6, i5  => ('a')), v40];
			var v42, v43, v44, v45 := m5(v33, v41[f21], f21, globalState);
			var v46 := 'k';
			var v48: set<char> := {v46, v46, fm61(f21, |(map v47 : int | (0x9 <= v47) && (v47 < 0x219) :: (v47 / |"ldyr"|) := (f21))|, globalState)};
			v48 := v48;
			...
			decreases 100 - i6
		{
			...
			globalState.f7 := (seq(0xde, i7  => (v50[f21]))) + (if (v51 in v52) then v52[v51] else v50);
			var v53 := new C4(f21, fm37(f21, f21, f21, globalState), f19);
			v33 := v33;
		}
		var v54: C7 := new C7(f19);
		v54 := v54;
		var v55 := DC19(v50[f21]);
	...
	method m4(p0: seq<bool>, globalState: GlobalState) returns (r0: D1, r1: array<int>, r2: bool, r3: seq<int>) {
		...
		v9 := v9[!v0 := f21];
		if (v2[|((seq(0xda, i0  => (v3[608]))) + v5)|]) {
			var v10: array<seq<array<int>>> := new seq<array<int>>[27];
			var v11: array<int> := new int[15](i1 => i1 / f21);
			var v12: seq<array<int>> := [v11];
			v10[422] := v12;
			var v13: map<int, seq<array<int>>> := map[f21 / f21 := v12];
			v10[422] := if (f21 in v13) then v13[f21] else v12 + v12;
			...
			var v19: array<multiset<bool>> := new multiset<bool>[6] [multiset{v0}, v18, multiset{v0}, v18, v18, (fm65(f21, |v5|, globalState))[v0 := f21]];
			var v20: map<char, string> := map[v3[608] := v5];
		...
		if ((v32 + v32) !in (v33 - v33)) {
			...
			globalState.f7 := v34;
			v0 := !v0;
			var v35: multiset<char> := multiset{v4, 'd', v3[608]};
			var v36 := DC13(v35);
			...
			var v44: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[27](i2 => [map[v0 := v0]] + (seq(0x2d1, i3  => (map[!v0 := false]))));
			var v45: map<bool, bool> := map[v0 := v0];
			var v46: seq<map<bool, bool>> := [v45, v45, v45[v0 := v0]];
			v44[39] := v46;
			f21, v44[39], f21 := -f21, v46, f21;
		...
		var v53: map<char, char> := map[v3[608] := v4];
		var v54: map<char, bool> := map[v3[608] := v0];
		...
		var v59: multiset<int> := multiset{f21};
		var v60: array<int> := new int[21] [f21, f21, f21, |v50[|v52| := v49]| % |v5|, f21, f21, -|v53| - f21, fm18(globalState), fm57([v54, fm68(v0, f21, globalState), map v55 : char | v55 in v56 :: (v55) := (v0), map[v3[608] := v0]], |v57|, f21, f20[f21], globalState), f21, f21, fm37(f21, |v58|, f21, globalState), |v5| - f21, f21, f21, -f21, f21, f21, |v51|, |v59|, f21 - f21];
		r1 := v60;
		r2 := v0;
		var v61: map<char, int> := map[v4 := f21];
		var v62: map<int, map<char, int>> := map[f21 := v61];
		var v63: map<int, map<char, int>> := map[|v5| := if (f21 in v62) then v62[f21] else map[v3[608] := f21]];
		var v64: C10 := new C10(v3[608], v0, f20, f21, f19);
		var v65: map<seq<C10>, int> := map[[v64, v64] := f21];
		r3 := ([|v63| + f21, f21, |v52| - f21])[if ([v64] in v65) then v65[[v64]] else 0x1ad := f21];
	}
	method m5(p0: bool, p1: string, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: seq<int>, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			r3 := fm21(p2, p0, p0, f21 / p2, globalState);
			r3 := p0;
			f21 := p2;
		...
		for i2 := f21 to if (p2 in v2) then v2[p2] else p2 {
			...
			if (0x37d == |v3|) {
				...
				var v11: C5 := new C5(p1, map[|(map v10 : int | (0x35a <= v10) && (v10 < 0x8b) :: (v10 / i2) := (p2))| := p0], f19);
				...
				var v17: seq<D3> := [v16];
				var v18 := DC19(f21);
				var v19: array<int> := new int[28] [i2, f21, 0x378 % f21, f21, |v12| - |v13|, f21, 324 % 0x133, if (p0) then |v8| else if (v15.cf18 in v14) then v14[v15.cf18] else i2, |(p1 + p1)|, f21 % |v17|, f21 * p2, i2, v18.cf32, f21, f21, p2, i2, f21, p2, 0x224, v11.fm25(v5, globalState), i2, p2, i2 * f21, v11.fm24(p0, globalState), i2, i2, -0x375];
				v19[841] := i2;
				v19[841] := --f21;
				var v20: array<bool> := new bool[3];
				var v21: map<array<int>, array<bool>> := map[v19 := v20];
				var v22: map<int, char> := map[fm22(p2, -(if (p0 in v12) then v12[p0] else v19[841]), globalState) := p1[i2]];
				var v23: map<int, int> := map[p2 := i2];
				var v24: map<int, map<int, char>> := map[v19[841] := v22];
				v19[841], v19[841], globalState.f7, v21, v22 := if (p0) then -(v19[841] % v19[841]) else if (v19[841] in v23) then v23[v19[841]] else f21, v19[841], seq(0x396, i3  => (f21)), v21[v19 := v20], if ((|v11.f32[0x294 := p0]| % |{p0}|) in v24) then v24[|v11.f32[0x294 := p0]| % |{p0}|] else if (p0) then v22 else v22;
				var v25 := new C9(p0, f19, f20, ---(-i2 % -v19[841]));
			} else {
				...
				v28[358] := p0;
				v28[358] := fm48(p0, globalState) <= p1;
				v28[358] := p0;
				var v29: set<string> := {p1};
				f21 := (i2 % p2) - fm11(|v29|, globalState);
				var v30: multiset<bool> := multiset{p0};
				var v31: map<bool, int> := map[p0 := -0x158];
				var v32: map<bool, map<bool, int>> := map[false := v31];
				var v33 := DC38(|v32|, p2);
				var v34: seq<D17> := [v33];
				var v35: map<bool, seq<D17>> := map[v30[p0 := p2] == v30 := v34[f21 := v33]];
				v35 := v35;
			}
			
			var v36: C9 := new C9(p0, f19, [true], i2);
			var v37: map<int, C9> := map[|(seq(381, i5  => (|map[v36.f27 := v36.f27]|)))| := v36];
			var v38 := 'p';
			...
			v36.f27, v42[595], v43, v44, v45 := fm41(globalState), |(v47 + v47)|, map v48 : int | (0x16 <= v48) && (v48 < 0x2fe) :: (v48 / -p2) := (v36.f27), v44, fm86(globalState);
			var v49 := new C0();
		}
		if (f21 > f21) {
			var v50 := DC0(p0);
			...
			if (v52.cf7) {
				...
				var v59: array<int> := new int[18] [p2, 0x395 - f21, fm22(f21, |"vtvqm"|, globalState), if (p0) then p2 else -p2, p2, if (f21 in v2) then v2[f21] else p2, 0xaf, v58.cf3, |v55|, if (p0 in v57) then v57[p0] else |v54|, f21, p2, |(v56 + (seq(0x342, i7  => (v51))))|, if (-|v2| in v2) then v2[-|v2|] else |v54|, 0xb3, 0x288, -f21, p2];
				v59[65] := f21 + p2;
				var v60: array<bool> := new bool[10] [p0, p0, p0, p0, !p0, p0, p0, p0, p0, p0];
				var v61: map<array<bool>, seq<bool>> := map[v60 := f20];
				v59[65] := |((if (v60 in v61) then v61[v60] else f20) + f20)|;
			} else {
				...
				f21, v64, f21, r1 := f21, v64, fm13(f21 / p2, p0, globalState), p0;
				var v65 := "sptq";
				v65 := p1;
				f21 := f21 * p2;
				var v66: array<int> := new int[12];
				var v67: map<bool, int> := map[!!false := f21];
				v66[33] := fm32(f21, -(if (!p0 in v67) then v67[!p0] else |p1|), globalState);
				r1, v66[33], v65, r0, r1 := p0, -(p2 - -f21), v65, p0, p0;
				f21 := |(p1 + p1)| + v66[33];
			}
			...
			f21, f21, r0, v79[606] := if (p0) then f21 else |v73|, -p2, v80.cf41, if ((p0 <==> p0) in v81) then v81[p0 <==> p0] else if (0xe1 in v82) then v82[0xe1] else p0;
			var v83: set<int> := {p2};
			var v84: map<bool, int> := map[v79[606] := |v83|];
			f21 := |(v84 + v84)|;
...
class C12 extends T1 {
	...
	function fm5(p0: int, p1: seq<D0>, globalState: GlobalState): int {
		|multiset{|"snopqxkws"|, f23, 0x79, DC2(true, |(seq(0x1c4, i0  => (f21)))|, true).cf3}| * -624
	}
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		var v0 := "jme";
		var v1: multiset<bool> := multiset{p3, p1, !p2, p0};
		var v2: multiset<multiset<bool>> := multiset{(multiset(f20))[p1 := |(seq(2, i1  => (|{p2}|)))|], v1, multiset{!p3}, v1, v1};
		for i0 := |v0| to |v2| {
			var v3 := DC2(!(p1 || !p0), 0x3a2, |v0| != f23);
			match (v3) {
				case DC2(cf2, cf3, cf4) =>
					var v5: array<map<seq<int>, bool>> := new map<seq<int>, bool>[2](i2 => map v4 : seq<int> | v4 in [seq(503, i3  => (|v0|)), [cf3]] :: (v4) := (p0));
					var v6 := 'g';
					var v7: seq<int> := [cf3];
					...
					v5[240] := map[v7 := p3] + map[[i0, if ((if (f21 in v14) then v14[f21] else v12) in v13) then v13[if (f21 in v14) then v14[f21] else v12] else f24] := cf4];
				...
				case DC3(cf5, cf6) =>
					...
					v23[105] := if ((map v27 : char | v27 in (seq(0x26d, i4  => (v24))) :: (v27) := (false)) in v26) then v26[map v27 : char | v27 in (seq(0x26d, i4  => (v24))) :: (v27) := (false)] else f19;
					v23[105] := f19;
				case DC4(cf7, cf8, cf9, cf10, cf11) =>
					var v28: array<D1> := new D1[4](i5 => if (cf9) then DC4(cf7, p0, p2, cf11, !p2) else DC4(cf8, p1, cf7, true, p2));
					var v29 := DC4(cf11, p3, p2, cf7, cf8);
					v28[984] := if (cf11) then v29 else DC4(false, p2, cf8, p2, p0);
					v28[984] := v29;
					var v30 := 'y';
					var v31: seq<string> := [v0];
					var v32: map<string, int> := map[((seq(-0x1d8, i6  => ('m'))) + v0)[f24 := v30] := |(v31 + v31)|];
					v32 := v32[v0 := f23];
					...
					var v39 := DC43(v38);
					f21, f21, cf11, v37, v39 := f23 - |(v0 + v0)|, (f24 / i0) % |v0|, if (p1) then p2 else cf11, v37, if (cf8) then v39 else v39;
				case DC1(cf1) =>
					...
					v47[484] := v48;
					r0, v45, v46, v47[484] := p3, if (p0) then v45 else v45, v46, v48;
		...
		v86[177] := v87;
		v85, r0, v86[177], globalState.f7 := f19, multiset{f20[f23], p2} > v1, if (p0) then v87 else v87, (v81 + (seq(0x161, i8  => (|{f21}|)))[f24 := f21]) + (v81 + v81);
		var v88: map<bool, string> := map[p3 := v79.f31];
		var v89: map<bool, int> := map[p0 := |v88|];
		var v90 := DC45(v0, f24);
		f21 := -((if (p2 in v89) then v89[p2] else |v90.cf74|) % (f23 - |multiset(f20)|));
	...
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		...
		for i1 := f24 to |fm70(|v5|, v6, v0, globalState)| {
			...
			if (v0) {
				...
				v17[85], v20[431], v0, v0, v23 := v0 && f20[f21], v18, v0, false, v23;
				v17 := v17;
				var v24 := DC28(v16);
				...
				var v33 := new C6(v31 + v31, |((seq(0x39b, i2  => (f20))) + v32)|, f19);
				var v34: seq<int> := [f24, f23, v33.f30];
				var v35: T1 := new C10(v6, v0, [v0, v0], f23, f19);
				var v36: multiset<T1> := multiset{v35, v35};
				var v37, v38, v39 := m0(v5, v34[f21], v0, DC14(|v5|, |v36|, seq(0x36c, i3  => (v6))).cf26, globalState);
				v30 := v30;
			}
		...
		if (v46 < (v46 + v46)) {
			...
			var v65: seq<int> := [f23];
			var v66: array<int> := new int[22] [|"khsewe"|, f21 * |v5|, fm40(v5, globalState), f24, f24, f21, |v54.cf80|, v50, if (v0) then v50 else f24, v50 * f21, |(f20 + f20)|, |v57|, f24, |v62[v50]|, f23, f24, |v63| - f21, f24, |v64|, f24, v65[f23], |(multiset{-213})[0x27d := f21]|];
			v66[197] := v50;
			v66[197] := 0x156;
		} else {
			...
			v0 := f23 != (f23 * f23);
			v45[258] := !(v5 < v5);
			var v70: map<bool, int> := map[f24 <= v69[667] := f21];
			...
			var v75 := DC51(v70);
			v69[667], r3, f21, v45[258], v70 := f23, if (v0) then f20 else if (0x21 in v71) then v71[0x21] else f20, |((if (v72 in v74) then v74[v72] else v73) + (v73 + v73))|, fm41(globalState), v75.cf81;
			var v76: seq<int> := [f23];
			var v77: map<int, int> := map[-v76[f24] := f24];
			v69[667] := f23 - (if (v0) then |v77| else f21);
		}
...
class C13 extends T1 {
	...
	function fm2(p0: seq<int>, globalState: GlobalState): int {
		if ([f20] < [f20, f20]) then 0x104 else f21 % |map[f21 := f22]|
	}
	method m1(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<int>) {
		var v0: multiset<int> := multiset{-0x36, f21};
		var v1 := "kukjguopf";
		for i0 := if (p3) then if (f21 in v0) then v0[f21] else f21 else f21 to |v1| / f21 {
			...
			if (p3) {
				...
				v6[484] := fm3(v7, |v9|, globalState);
				var v10: array<int> := new int[22];
				var v11 := DC33(v8.f20[-0x352], p1);
				v6[484] := if (if (p1) then DC6(v10, p3, v4, p2).cf14 else v11.cf57) then v5.(cf0 := !f22) else v5;
				v2[817] := p0 !in map[!f22 := 'p'];
				v2[817] := p3;
				var v12: array<D1> := new D1[4];
				var v13 := DC26(v12);
				var v14: seq<array<D1>> := [v12, v13.cf46, v12];
				v2[817], r0, v13 := false, p1, v13.(cf46 := v14[i0]);
				v8.f21 := (i0 % |v7|) / (i0 * f21);
			} else {
				var v15: array<C1> := new C1[7];
				v15 := v15;
				var v16: multiset<string> := multiset{seq(667, i2  => ('q'))};
				r0 := !(multiset(seq(124, i1  => (v1))) != (v16 * v16));
				r0 := (f21 >= f21) && p3;
			...
			r1 := new int[21] [191, f21, i0 % |v21|, -fm57(v22, i0, f21, p1, globalState) * |f20|, i0 - i0, f21, i0, -0x3c7, i0, i0, fm32(i0, |v25[!false := i0]|, globalState), f21, i0, f21, i0, i0, f21, -(f21 - f21), |v1|, i0, i0];
		...
		var v42: seq<C10> := [v41];
		var v43: array<int> := new int[11] [f21 - -413, v40.cf21, f21, f21, f21 % f21, |v34| * f21, f21, |v42|, 0x22, f21, f21 * f21];
		...
		for i5 := |v44| to |(if (v43 in v45) then v45[v43] else map[p0 := p1])| {
			...
			var v47 := DC39(v46);
			v47 := v47;
			var v48: T1 := new C12(i5 / |v1|, i5, f20, i5, f19);
			v48 := v48;
			f22 := v41.f26;
		}
		r0 := !!(|(v35 + [|(seq(0x381, i7  => (v30)))|])| != (f21 - f21));
		r1 := v43;
	}
	method m2(globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: map<char, bool>, r3: seq<bool>) {
		var v0 := "pqfwxuqy";
		var v1: map<int, int> := map[-f21 := f21];
		var v2: C4 := new C4(f21, |v1| / -f21, if (f22) then f19 else f19);
		v0, v2 := seq(-0x41, i0  => ('x')), v2;
		...
		var v13: array<int> := new int[13] [|v11|, v2.f34, |fm48(f22, globalState)|, v11[if (f22 in v12) then v12[f22] else v2.f34], |v11| + v8.f28, v8.f28, fm32(|[f22, false]|, |"leypqqw"|, globalState) * v8.f28, |[f21, |(seq(296, i1  => (v7)))|]| + v2.f34, v2.f33, v8.f28, v8.f28, v2.f34, f21 + v2.f34];
		r1, v6[214], v13 := v2.f34 + 994, f22, v13;
		if (f22) {
			...
			v6[214] := f22 <== (-v2.f33 == v8.f28);
			var v19: array<array<int>> := new array<int>[5];
			var v20: set<int> := {v2.f34};
			v2.f34, v3, v19, v6[214], v6[214] := 0x1, fm92(globalState) + v3, v19, (v2.f33 + -v2.f34) != (if (f22) then |v20| else v11[v2.f34]), if (v6[214]) then v6[214] else v6[214];
			var v21: map<bool, bool> := map[fm15(f22, v8.f28, globalState) := !f22];
			f22 := if ((if ((if (v6[214] in v21) then v21[v6[214]] else f22) in v21) then v21[if (v6[214] in v21) then v21[v6[214]] else f22] else v6[214]) in v21) then v21[if ((if (v6[214] in v21) then v21[v6[214]] else f22) in v21) then v21[if (v6[214] in v21) then v21[v6[214]] else f22] else v6[214]] else false;
			v6[214] := f22;
		} else {
			var v22 := DC10(v8.f28);
			var v23: map<bool, bool> := map[false := v6[214]];
			var v24: map<char, int> := map[v7 := v2.f34];
			v0 := fm19(fm18(globalState), v22, v23, v24, globalState);
			v6[214] := v6[214] <== f22;
			var v25: T1 := new C11((f20 + f20)[v2.f34 := f22], v2.f33, f19);
			v2.f34, f22, v25 := v2.f33, !(v0[v2.f34] in v0), v25;
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			var v31 := new C0();
			var v32: map<bool, bool> := map[!f22 := v6[214]];
			if (fm13(|f20|, !(if (v6[214] in v32) then v32[v6[214]] else v6[214]), globalState) <= v8.f28) {
				...
				v35[2] := v37[v2.f34] - v36;
				f21, v34, v35[2], v6[214], v6[214] := v2.f33 + v2.f34, v34, v36, (v6[214] ==> v6[214]) || true, !(v8.f28 <= (if (|v32| in v29) then v29[|v32|] else v2.f33));
				var v38 := DC8(v11);
				...
				var v47: map<int, C7> := map[|fm17(v6[214], globalState)| := v46];
				var v48: array<map<int, C7>> := new map<int, C7>[3] [v47[v2.f34 := v46], v47, v47];
				v48[627] := v47;
				var v49 := DC59(v47);
				v48[627] := v49.cf92;
				r1 := |((f20 + f20) + f20[v2.f33 := v6[214]])|;
			}
			
			v6[214] := v6[214];
			var v50 := new C3(v6[214], v7, f20, 0x1b6, f19);
		}
		var v51: seq<array<int>> := [v13];
		var v52: seq<array<bool>> := [v6];
		var v53: multiset<array<bool>> := multiset{v6, v52[v2.f34]};
		v51 := if (!(|v53| >= -0xee)) then v51 else v51;
		var v55: map<char, bool> := map[fm38(map v54 : int | (0xdc <= v54) && (v54 < -0x2a3) :: (v54 - |map[v6[214] := v7]|) := (|{f22, f22, f22}|), [|v5|], globalState) := f22];
		var v56: seq<map<char, bool>> := [v55];
		var i3 := 0;
		while ((if (f22) then f21 else f21) > fm57(v56, v2.f33, v2.f34, v6[214], globalState))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			var v58 := new C11([v6[214], fm28(globalState)], 790, v57[|v0|]);
			f21 := if (|(v0 + v0)| in v29) then v29[|(v0 + v0)|] else v2.f34;
			var v59: map<bool, bool> := map[v6[214] := v6[214]];
			globalState.f18 := v59 + v59;
			f21 := v2.f34;
		}
		r0 := multiset{v2.f33};
		var v60: map<char, string> := map['t' := v0];
		r1 := |(if (v6[214]) then fm93(v8.f28, v6[214], f22, v6[214], globalState) else v60)| + f21;
		r2 := (map[fm38(v1, v11, globalState) := v6[214]])[v7 := f22 <==> f22];
		r3 := f20;
	}
	method m3(globalState: GlobalState) returns (r0: int, r1: bool) {
		var v0: seq<int> := [0x27];
		var v1: map<bool, int> := map[f22 := f21];
		f21 := v0[if (f22 in v1) then v1[f22] else f21];
		r0 := 0x346;
		...
		if (f22) {
			...
			var v15: set<int> := {f21, f21, v0[f21], v14.cf73, f21};
			...
			match (v22) {
				...
				case DC56(cf88, cf89) =>
					...
					var v27: C3 := new C3(cf89, v12, f20, |map[v26 := seq(0x388, i2  => (v12))]|, f19);
					var v28 := DC62(v27);
				...
				case DC57(cf90) =>
					...
					var v32: array<multiset<int>> := new multiset<int>[2] [v31, v31[-f21 := |v0|]];
					v32 := v32;
					var v33: array<int> := new int[24];
					var v34: seq<array<int>> := [v33, v33];
					var v35: array<int> := new int[18] [cf90, f21, |(seq(0x4e, i3  => ('q')))|, cf90, |[-|v34|]|, f21, f21, f21, 0xf0, 0x22, cf90, cf90, cf90, -980, f21, cf90, f21, cf90];
					...
					v37[131] := v36;
					v37[131] := v36;
					var v38 := new C3(f22 <==> f20[cf90], v12, f20, fm40(seq(-0x102, i4  => (v12)), globalState), f19);
					v12 := v12;
				case DC54(cf87) =>
					r1 := !!f22;
					r1 := -f21 <= f21;
				...
				case DC58(cf91) =>
					f22 := f22;
					r1 := f21 !in (seq(0xea, i6  => (f21)));
					f21 := --(f21 - (fm40("repv", globalState) + f21));
					f22 := f22;
			}
			
			f22 := v16 == (v16 + (seq(0x294, i7  => (v12))));
			var v41: array<int> := new int[1](i8 => i8 % f21);
			v41[975] := f21 * |map[f22 := fm15(false, |"at"|, globalState)]|;
			v41[627] := -f21;
			v41[975], v41[627] := f21 + -0x76, |v16|;
		} else {
			if (f22) {
				r1 := f22;
				f22 := true;
				...
				f21, r0, v44, r1 := -f21, (|v45| * f21) / f21, f19, v46.cf57;
				var v47: array<int> := new int[8](i9 => i9 / f21);
				...
				v55[187] := f22;
				v55[187] := f22 <==> (v2 >= {f22, f22, f22});
			}
			
			r0 := if (f22) then f21 else f21;
			var v56 := 'c';
			v56 := fm31(false, (map v57 : int | v57 in v0 :: (v57 % f21) := (-0x1a4)) + (map v58 : int | (0xe1 <= v58) && (v58 < 0x1a7) :: (v58 * f21) := (|{f21, f21, f21}|)), f21, globalState);
			var v59: map<seq<int>, D3> := map[v0 := DC11(f21, f22).(cf21 := f21)];
			f22, v59, r1 := !f22, v59, true;
			var v60: array<int> := new int[5];
			v60[651] := fm2(seq(0x26e, i11  => (f21)), globalState);
			var v61 := DC57(0x320);
			v60[651] := fm32(if (f22) then f21 else v61.cf90, f21, globalState);
		}
		...
		match (v62.(cf52 := v2)) {
			case DC29() =>
				...
				v63[290] := f21;
				v63[290] := fm40("dt", globalState);
				var v64: multiset<bool> := multiset{f22};
				v63[290], f21 := -(if (f22 in v64) then v64[f22] else v63[290]) % f21, f21;
				v63[290] := (f21 - f21) + f21;
				var v65 := "ubv";
...
method Main() {
	...
	if ((if (v4) then true else v11.cf0) <==> !v4) {
		var v12: map<int, bool> := map[v1 / -0x3d9 := v4];
		v12 := v12[v1 := v4];
		...
		var v17: map<seq<int>, bool> := map[seq(0x30f, i0  => (-0x1af)) := v4];
		v17 := v17;
		var v18, v19, v20 := m0(v3, v1, false, v1 / v1, globalState);
		var v21: seq<seq<char>> := [v3];
		var v22: map<seq<char>, int> := map[v21[v18] := v1];
		v22 := v22;
		v3 := v3;
		if (v18 < v1) {
			var v23, v24, v25 := m0(v3, v18 % v1, !!v4, |v21[v18]|, globalState);
			...
			var v30 := new C1(v23, (v26[v20 := -v1])[v4 := v1] < (if (v23 in v27) then v27[v23] else v26[v4 := v18]), v29[v23]);
			var v31: array<string> := new string[28](i1 => v3 + v3);
			v31[797] := seq(-0x254, i2  => (v7));
			v1, v31[797], v18 := -(v23 / fm13(0xe3, v25, globalState)), "jradjdvg", v23 - |v26|;
			var v32 := DC60();
			v32 := v32;
			v3 := v3;
		} else {
			...
			var v35: map<bool, map<int, bool>> := map[v33[v1] := v34];
			var v36: map<map<int, bool>, int> := map[if (v4 in v35) then v35[v4] else v34 := v1];
			v36 := v36[v34 + v34 := v1];
			v0[906] := v4;
			v0[906] := v20;
			var v37: array<array<bool>> := new array<bool>[10];
			var v38 := new C10(v7, v20, v33[-|multiset(v33)| := v4] + v33, if (false) then v1 else v18, v37);
	...
	for i3 := |v44| + v1 to -(v1 / v1) {
		...
		match (v54) {
			case DC60() =>
				...
				v50 := v50;
			case DC59(cf92) =>
				var v63 := new C5(v3, map v62 : int | (0x38a <= v62) && (v62 < 0x37b) :: (v62 / |v44|) := (v4), if (true) then v51 else v51);
				v1 := v48;
				var v64, v65 := v63.m1(v2 < v2, v4, v50, v4, globalState);
				v1 := v48 / |(map v66 : multiset<int> | v66 in (seq(0x307, i4  => (v44))) :: (v66) := (i3))|;
			case DC61(cf93) =>
				globalState.f7 := [v48];
	...
	if (false) {
		...
		match (if (v74.f22) then v77 else DC49(v76)) {
			case DC49(cf79) =>
				...
				v1, v74.f22 := v2[v1], if (v4) then v74.f22 else v74.f22;
				v0 := v0;
				var v78: array<seq<string>> := new seq<string>[18];
				v78[419] := fm85(globalState);
		...
		var v81: map<int, int> := map[v1 := |(seq(210, i6  => (v1)))|];
		var v82: set<int> := {|v3|};
	...
	v0[830] := v98.cf4;
	for i7 := |((seq(-0x3b0, i8  => (v1))) + v2)| to fm37(v1, v1, v1, globalState) {
		...
		if (!(if ((if (v4) then v3 else v3[i7 := v7]) in v101) then v101[if (v4) then v3 else v3[i7 := v7]] else !v4)) {
			var v102, v103, v104 := m0(v3, i7, v0[830], |{v4, v4, v0[830], v0[830], v0[830]}|, globalState);
			var v106: set<int> := {-i7};
			var v107: seq<set<int>> := [set v105 : int | (983 <= v105) && (v105 < 0x127) :: (v105 + v102), v106];
			var v108: seq<bool> := [!!false, v107 < v107, v104, v0[830]];
			var v109: map<bool, int> := map[v4 := v1];
			v4 := v108[|v109|];
			var v110, v111, v112 := m0(v3, v102, true, v6[882], globalState);
			var v113: seq<string> := ["ubwe", seq(0x340, i9  => (v3[v1])), "mqcoq", v3];
			var v114, v115, v116 := m0(v3, v102, v0[830], |v113[|v3|]|, globalState);
			v3 := ("kcyi" + fm8(globalState)) + (v3 + v3);
		} else {
			var v117: array<string> := new string[25] [v3, v3, "sxfnnp", v3, v3, v3, v3 + v3, v3, v3, v3, "a" + v3, v3, v3[i7 := v7], v3, "qlhgc" + v3, v3, v3, "sfhe", seq(0x16a, i10  => ('r')), v3, v3, v3, v3, "mvqp", (seq(-0x33b, i11  => ('i')))[-v6[882] := v7]];
			v117 := v117;
			var v118 := DC4(v1 == v6[882], {v4} > v100, v4, v4, v0[830]);
			v118, v0[830], v6[882] := if (!(v6[882] != i7)) then v118 else DC4(v4, v4, fm20(globalState), v0[830], v4), fm7(globalState), v6[882];
			var v119 := DC10(v1);
			var v120 := DC9(v3);
			var v121: seq<D3> := [DC9(v3), v120];
			var v122: map<char, int> := map['x' := |v121|];
			v3 := fm19(v6[882], v119, v10, v122, globalState);
			...
			v123[482] := v126;
			v123[482] := if (v0[830]) then v126 else v126;
			var v127: set<int> := {v1, v1, -0x3cb, v1};
			var v128 := DC18(v0);
			var v129: array<int> := new int[15] [v1, |v2|, v6[882], v6[882] + i7, v6[882], v1, v1, v1 / -i7, 828, -0x28f, |v127|, v6[882] / i7, |v3| * v1, v1, |map[v2 := v128.(cf31 := v0)]|];
			v129 := v129;
		}
	...
	var v132: seq<bool> := [fm7(globalState), fm28(globalState), v4, v0[830]];
	var v133 := DC15(v132);
	v131 := match v133 {
		case DC15(cf28) => v131
	};
	...
	v136 := map[0x14f := v135];
	var v137: multiset<bool> := multiset{v0[830]};
	var v138: seq<seq<bool>> := [v132, v132];
	var v139: map<int, bool> := map[v1 := v0[830]];
	var v140: array<array<bool>> := new array<bool>[27];
	var v141: T0 := new C5(v3, v139, v140);
	var v142: array<multiset<bool>> := new multiset<bool>[6] [v137, v137, v137 * v137, multiset(v138[-0x2fa]), fm65(v1, |[v141, v141, v141]|, globalState), v137 * v137];
	v142 := v142;
	v141 := v141;
	var v143, v144 := v141.m1(v0[830], v4, true, v4, globalState);
	...
	v151[62] := fm73(v4, globalState);
	v6[461] := v1;
	var v152 := DC21(0x20f, -v1, v1, v1, v5);
	var v153 := DC43(v44);
	var v154: multiset<char> := multiset{v145.f25, v7, 'm'};
	var v155 := DC13(v154);
	v6[289], v1, v0[830], v151[62], v6[461] := v1, v152.cf36, multiset(v2) !! (v153.(cf70 := v44)).cf70, v155, v1 % v1;
	var v156: map<bool, string> := map[v4 := v3 + (seq(0x18f, i15  => (v7)))];
