...
function fm3(p0: seq<bool>, globalState: GlobalState): string {
	if (true) then "hgwprn" else (seq(792, i0  => ('o'))) + "tsxqnnw"
}
...
function fm7(p0: multiset<bool>, p1: string, globalState: GlobalState): map<bool, int> {
	(map[DC3(false, false, seq(627, i0  => ('f')), false, 0x2d).cf5 := 7] + map[false := 0xb1]) + (map[true := -0x78] + map[true := |multiset{false}|])
}
function fm8(p0: bool, p1: D3, p2: set<bool>, p3: int, globalState: GlobalState): map<int, bool> {
	map v0 : int | (0x3b <= v0) && (v0 < -0x3df) :: (v0 / 0x3be) := (true || true)
}
function fm9(p0: int, p1: int, globalState: GlobalState): set<int> {
	((set v0 : int | (0x1f4 <= v0) && (v0 < 122) :: (v0 * -706)) - (set v1 : int | (-0x1d9 <= v1) && (v1 < 0xdf) :: (v1 % |map[0x1cd := true]|))) + {--0x122}
}
...
function fm11(globalState: GlobalState): map<bool, D3> {
	(map[false := DC12(DC10(false, 0x20c, |map[false := 380]|))] + map[false := DC12(DC12(DC11()))]) + (map[true := DC12(DC10(false, 682, |(set v0 : int | (0x151 <= v0) && (v0 < 918) :: (v0 / 99))|))] + map[false := DC12(DC9([|multiset{|map[true := false]|}|]))])
}
...
function fm13(p0: bool, p1: bool, globalState: GlobalState): map<int, set<int>> {
	map[0xfe := {|"nk"|, |{false, true}|}] + map[0xf0 := set v0 : int | (937 <= v0) && (v0 < 0x34a) :: (v0 % -|multiset{true, true}|)]
}
...
function fm16(p0: int, p1: char, globalState: GlobalState): D4 {
	match DC20(true) {
		...
		case DC21() => DC15(true, |{-|{|{true}|, |(map v0 : int | v0 in (set v1 : int | (0x23c <= v1) && (v1 < 0xf0) :: (v1 * 0x19e)) :: (v0 % -|{0x2b3}|) := (true))|}|}|)
...
function fm17(p0: int, p1: bool, p2: int, globalState: GlobalState): set<set<int>> {
	{{|map[false := |multiset{true, false}|]|}} + {{|[0x3af]|}, {-0x37a, |(map v0 : int | v0 in [445, |map[true := |[0x369, 0x1c]|]|, |"jfd"|, |"cngsgffno"|, |"giiveerwc"|] :: (v0 + DC15(false, |(seq(112, i0  => (multiset{|multiset{true}|})))|).cf24) := (-492))|}, {|[0x364]|}, {0x1d8}, {|{DC15(false, 655).cf24}|, -0x2ad, |map[-|{|(set v1 : int | (0xe9 <= v1) && (v1 < 0x360) :: (v1 % 0x33e))|, -|map[false := true]|}| := true]|, -|multiset{false}|}}
}
function fm18(p0: int, globalState: GlobalState): char {
	'h'
}
function fm19(p0: bool, p1: int, globalState: GlobalState): seq<string> {
	seq(300, i0  => (seq(-0x2a1, i1  => ('w'))))
}
method m0(p0: bool, globalState: GlobalState) returns (r0: bool) {
	...
	while (match v0 {
		case DC0(cf0) => p0
		case DC1(cf1, cf2, cf3) => -|(seq(-575, i1  => ('j')))| == DC3(p0, true, seq(0x1af, i2  => ('r')), false, --0x14c).cf9
	})
		decreases 100 - i0
	{
		if (i0 >= 100) {
		...
		match (v4.(cf14 := v3, cf13 := p0 <==> p0)) {
			case DC6(cf12, cf13, cf14) =>
				...
				var v16: array<seq<set<int>>> := new seq<set<int>>[15] [v10 + [if (v6.f6 in v12) then v12[v6.f6] else v10[cf12]], seq(0xa9, i3  => (set v13 : int | (239 <= v13) && (v13 < 0x148) :: (v13 % cf12))), v10[v8.f6 := v9] + v10, v10, v10 + v10, v10, seq(0x34d, i4  => (v9)), [v9] + [v9, v9], v10[v6.f6 := set v14 : int | (-0x76 <= v14) && (v14 < 0x101) :: (v14 / |v7|)], v10 + v10, v10[|v15| := v9], v10, v10 + v10, v10, v10];
				v16[153] := v10;
				var v17: multiset<int> := multiset{cf12};
				var v18: C0 := new C0(v8.f6 / (if (p0 in v15) then v15[p0] else |v17|), v8.f7);
				v16[153], v18, r0 := v10, v18, p0;
			case DC7(cf15) =>
				var v19: set<int> := {602};
				r0 := if (p0) then !p0 else v19 > v19;
				r0 := fm0(true, p0, cf15 / cf15, globalState);
			...
			case DC5(cf11) =>
				...
				var v26: C0 := new C0(v1 % v1, {p0, p0});
				v26 := v26;
				var v27: set<int> := {v26.f6, v1, -816, v1};
				var v28 := new C0(|v27|, v26.f7);
				globalState.f0 := v1 - v26.f6;
			case DC8(cf16) =>
				v1 := |(map v29 : int | (0x3a5 <= v29) && (v29 < 0x377) :: (v29 / |[!p0]|) := (p0))|;
				var v31: map<int, int> := map[v1 := v1];
				var v32: map<map<int, int>, int> := map[v31 := v1];
				v3[142] := if (p0) then v1 else |(map v30 : int | v30 in multiset{|multiset{p0, p0}|} :: (v30 * 0x36d) := (p0))[|v32| := p0]|;
				v3[142] := v1;
				var v33: array<char> := new char[7];
				v33 := v33;
				v3[142] := v3[142] % v3[142];
		}
		...
		var v36: set<int> := {v1};
		var v37 := DC11();
		v34, globalState.f0, v35 := v34, (v1 % v1) % |(if (p0) then v36 else v36)|, fm15(v37, p0, globalState);
	...
	match (DC15(v40 >= 0x131, v40)) {
		...
		case DC15(cf23, cf24) =>
			var v43 := "sficpirr";
			var v44 := 'd';
			var v45 := DC3(cf23, fm0(p0, cf23, cf24, globalState), (v43 + (seq(141, i5  => ('k'))))[v40 := v44], |v43| <= |map[p0 := v40]|, -v40);
			...
			if (false) {
				...
				cf23 := fm0(p0, |v43| !in map[|v48[if (cf24 in v49) then v49[cf24] else v47 := p0]| := map[cf23 := v43[v47.f6]]], -v47.f6, globalState);
			...
			var v66: seq<bool> := [p0];
			v65[41] := [p0, cf23, cf23] == v66;
			v63[88], v64[965], globalState.f0, globalState.f0, v65[41] := v40, "ihfjckhnn", v40, (cf24 * |v43|) - 0xcd, p0;
		...
		case DC13(cf22) =>
			...
			match (v78) {
				case DC10(cf18, cf19, cf20) =>
					...
					globalState.f4 := cf22.fm1((if (v40 in v83) then v83[v40] else v82)[-cf22.f6 := cf22.f6], v0, globalState);
					v80 := v80;
				case DC11() =>
					...
					v86 := v86[cf22.fm2((fm16(v40, v88, globalState)).cf23, v85, v85, v91[v40], globalState) := v85];
					r0 := !!p0;
					var v92: map<int, bool> := map[v40 := fm0(p0, p0, cf22.f6, globalState)];
					var v93: set<int> := {v40, v40, cf22.f6, cf22.f6, v40};
					v92 := v92[cf22.f6 := v93 > (set v94 : int | (0x138 <= v94) && (v94 < 0xeb) :: (v94 % cf22.f6))];
				...
				case DC12(cf21) =>
					...
					var v102: array<bool> := new bool[15] [p0, p0, !p0 ==> p0, p0, p0, v101[cf22.f6], p0, v78.cf18, p0 <==> p0, false, p0, p0, p0, p0, fm0(!p0, false, -|v101|, globalState)];
					v102[563] := p0;
					v102[563] := !p0;
					var v103 := "pibona";
					var v104: seq<int> := [v40, |v103|];
					var v105: map<bool, C0> := map[fm0(p0, v102[563], |v104|, globalState) := cf22];
					var v106 := DC17(v105);
					var v107: array<map<bool, C0>> := new map<bool, C0>[3] [map[fm0(p0, v102[563], cf22.f6, globalState) := cf22], map[false := cf22], v106.cf29 + v105];
					v107 := v107;
			}
			...
			if (!p0) {
				...
				var v114: seq<int> := [|(set v113 : int | v113 in v112 :: (v113 / |"yr"|))|];
				v114 := v114;
	...
	var v131 := "xukko";
	if (if (v131 < (seq(0x38e, i11  => ('p')))) then -v40 == v40 else -v40 < v40) {
		r0 := p0;
		if ((v40 - v40) >= v40) {
			var v132 := DC15(p0, |"rq"|);
			...
			v146[981] := v148;
			v146[981], globalState.f4, globalState.f4, v148 := v148, v40, v148.f6, v148;
			...
			v149[685] := v150;
			v149[685] := (if (p0) then v150 else v150) + v150;
		...
		var v154: seq<int> := [v40, v152.fm2(p0, ([v40])[v40 := v40], seq(629, i14  => (v152.f6)), v153, globalState)];
		v40 := v40 % v152.fm2(true, seq(0x1b, i13  => (v152.f6)), v154, map[p0 := |fm3([p0], globalState)|], globalState);
	} else {
		globalState.f0 := v40;
		...
		var v158 := 't';
		var v159: seq<string> := ["jxrvpul", v131[|(if (v157[v40 := v155] in v156) then v156[v157[v40 := v155]] else v131)| := v158]];
		var v160: seq<bool> := [p0];
		var v161: array<seq<string>> := new seq<string>[29] [v159 + v159, v159 + v159, [v131, v131[v40 := v158]], v159, v159, [v131, seq(328, i15  => (DC19(|v131|, p0, v158).cf33))], v159, fm19(false, |(seq(-0x15f, i16  => (|map[-v40 := true]|)))|, globalState), v159, v159 + v159, v159 + v159, v159, v159, v159, v159, v159[|v131| := v131], ["qrr"] + v159, v159, v159, v159 + v159[v40 := "igyetaiv"], seq(0x389, i17  => (v131)), [fm3(v160, globalState)], v159 + v159, [v131, seq(353, i18  => (v158))], v159 + v159, v159, v159, fm19(p0, v40, globalState) + v159, [v131, v131]];
		v161[3] := [seq(0x1e0, i19  => ('o'))];
		v161[3] := v159 + v159;
		var v162: array<array<map<int, bool>>> := new array<map<int, bool>>[25];
		var v163: array<map<int, bool>> := new map<int, bool>[6];
		v162[760] := v163;
		v162[760] := new map<int, bool>[15];
		var v165: array<seq<D1>> := new seq<D1>[9](i20 => [DC3(p0, p0, v131, true, |v131|), DC3(p0, true, seq(235, i21  => (v158)), p0, v40), DC3(p0, p0, v131, !false, |(set v164 : char | v164 in [v158, v158] :: (v164))|)]);
...
method Main() {
		...
		decreases 100 - i0
	{
		...
		globalState.f4 := v0;
		var v19: set<int> := {v0, v0 - |v5|, |(v5 + v5)|, v0, v0 / v0};
		v6[693] := v0;
		v1, v19, v6[693] := v1, v19, v0;
	}
	var v20 := "ss";
	...
	match (DC0(|v20| > |v21|)) {
		case DC0(cf0) =>
			...
			v22[676], v23, globalState.f4, globalState.f0 := v1, v23, v0, |v24|;
			var v25: map<bool, int> := map[cf0 := v0 / v0];
			var v26: multiset<bool> := multiset{v22[676]};
			v25 := v25[multiset(v2) !! v26[!!true := v0] := --v0];
			v23 := v23;
			var v27: map<bool, set<bool>> := map[v22[676] := {v1, v22[676], v1, v22[676], cf0}];
			var v28: set<bool> := {false, false, cf0};
			var v29: array<int> := new int[22] [v0, v0, v0, v0, v0 - fm4(v0, cf0, globalState), v0, v0, |(v20 + v20)|, v0 / v0, v0, v0, 0xe9, v0 / v0, v0, v0 - v0, --v0, v0, |v27[v1 := v28]| * v0, v0 % v0, v0, v0, |("oywkaa" + "k")|];
			v29[342] := v0;
			v29[342] := v0 % v0;
		case DC1(cf1, cf2, cf3) =>
			globalState.f4 := v0;
			...
			var v39: array<array<bool>> := new array<bool>[28] [cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, if (v1) then cf2 else cf2, cf2, v37.cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, cf2, v38[v0]];
			var v40: multiset<bool> := multiset{false, v1};
			v34, v35[372], v1, v39, v0 := v34, v32, v1, v39, |(if (!v1) then v40 else if (v1) then v40[true := -0x2d2] else v40)|;
	...
	if (match v43 {
		...
		globalState.f4 := v0;
		var v48 := 'b';
		v45 := (map[v20[v0 := v48] := false])[seq(0x380, i2  => (v48)) := v1];
	} else {
		...
		if (|(if (v1) then v49 else v49)| <= v0) {
			...
			var v59 := new C0(v55[fm4(v0, v1, globalState)], {!v1});
			globalState.f0 := v0;
		...
		v60 := map[|v61| := v0];
		var v62: set<bool> := {!v1};
		var v63 := new C0(v0 % v0, if (v1) then v62 else v62);
		var v64 := 'u';
		...
		if (true) {
			...
			var v68: array<array<int>> := new array<int>[22] [v66, v66, v67[v63.f6], v66, v66, v66, v67[fm4(v63.f6, v65, globalState)], v66, v66, v66, v67[v63.f6], v66, v66, v66, v66, v66, v66, (DC5(v66).(cf11 := v66)).cf11, v66, v66, v66, v66];
			v68[915] := v66;
			v68[915] := v66;
			var v69: array<bool> := new bool[28] [v65, fm0(v1, DC3(v43.cf6, v65, seq(997, i3  => (v64)), v65, 0x27f).cf5, v63.f6, globalState), v1, v1, v1, v1, false, v43.cf5, v1, v1, v1, !v65, v65, v65, v1, v65, v1, v65, true, v65, v1, v65, v65, true, false, v65, v65, v1];
			...
			var v77: array<int> := new int[1](i4 => i4 % v63.f6);
			v77[378] := v63.f6;
			v77[229] := v0;
			var v78: map<set<int>, string> := map[v61 + {858} := v20[v73.f6 := v64]];
			v20, v77[378], globalState.f4, v77[229], globalState.f4 := if ((v61 + v61) in v78) then v78[v61 + v61] else (v43.(cf8 := v1, cf6 := v1)).cf7, v63.f6, fm4(v0, v20 == v20, globalState), v63.f6 + v0, v63.f6;
			var v79: set<char> := {v64};
			globalState.f4 := v77[378] * |(v79 * v79)|;
			var v80: seq<set<bool>> := [v63.f7, {v1, v1, v1}];
			var v81: map<bool, int> := map[v1 := v0];
			var v82: seq<int> := [-0x31f];
			var v83 := new C0(-0x25c, v80[-(if (v1 in v81) then v81[v1] else |v82|)]);
		}
	...
	var v89: set<bool> := {v1};
	globalState.f0, v1, v88, v1, v1 := |v89| % (v0 * 0x242), false, v88, !!v1, v1;
	var v90 := m0(v1, globalState);
	var v91: map<int, bool> := map[v0 := true];
	var v92: map<char, int> := map['v' := v0];
	var v93 := DC2(v0);
	var v94: array<multiset<bool>> := new multiset<bool>[8] [v87, v87 - v87, v87, multiset{fm0(!v1, if (v43.cf9 in v91) then v91[v43.cf9] else v90, |v92|, globalState), v1, v1, v1, v1}, v87 - v87, v87[v1 := v93.cf4], multiset{v90, v90}, v87];
	...
	match (v93) {
		case DC3(cf5, cf6, cf7, cf8, cf9) =>
			...
			v95 := v95[(map v96 : int | (0x3ba <= v96) && (v96 < -549) :: (v96 % |v95|) := (cf5)) != v91 := cf5];
			var v97 := 'r';
			v97 := v97;
		...
		case DC2(cf4) =>
			...
			var v98: seq<int> := [|v2|];
			if (!(v98[v0] != cf4)) {
				var v99: map<string, seq<bool>> := map[seq(-19, i6  => ('h')) := v2];
				var v101 := 'd';
				var v102: map<int, char> := map[v0 := v101];
				var v103: seq<map<string, seq<bool>>> := [v99, v99, v99, map v100 : string | v100 in multiset{v20, v20} :: (v100) := ([true]), map[v20 := v2[|v102| := v1]]];
				var v105: map<int, map<string, seq<bool>>> := map[v0 := if (v90) then (v103[v0])[v20 := v2] else map v104 : string | v104 in map[v20 := v1] :: (v104) := (v2)];
				v105 := v105[cf4 := v99["kb" := v2] + v99];
				v1 := v1 ==> v1;
				var v106: seq<map<bool, int>> := [v84];
				var v107: seq<map<bool, int>> := [v106[v0], v84, v84, v84];
				var v108 := new C0(|(v107[|v20|] + v84)|, v89);
				globalState.f4 := |v20| / v0;
				var v109 := DC7(cf4 * v108.f6);
				v109 := v109.(cf15 := v108.f6);
			} else {
				var v110: set<int> := {|(seq(-884, i7  => ('o')))|, v0};
				var v111: map<int, set<int>> := map[v0 := v110 + {|[v90]|, v0}];
				v111 := v111[v0 := v110];
				var v112: array<int> := new int[2] [v0, cf4];
				v112[97] := 0x12d + |v20|;
				var v113: seq<D2> := [DC5(v112)];
				v112[97], v113, v0 := -DC6(v0, v1, v112).cf12, [DC5(v112)], |v89| / v0;
	...
	match (v127) {
		case DC6(cf12, cf13, cf14) =>
			v0 := (0x2f9 * cf12) - cf12;
			v1 := v90;
			var v128: map<int, int> := map[fm4(cf12, cf13, globalState) := v0 % |v125|];
		...
		case DC7(cf15) =>
			...
			v88[921] := v130;
			v88[921], globalState.f0, v125, v130 := v130, v0, v125, v130;
			var v131 := 'a';
			v131 := v131;
			var v132 := DC7(cf15);
			...
			v134[190] := v132;
			v134[190] := fm6(globalState);
		case DC5(cf11) =>
			if (if (v1) then v90 else v1) {
				v90 := -v0 >= -fm4(-0x78, v1, globalState);
				v87 := (multiset{v1, v90, v1, v1, v90})[!!v90 := v0];
				globalState.f4 := v125[v0];
		...
		case DC8(cf16) =>
			...
			if (-((if (|v2| in v21) then v21[|v2|] else |v141|) * v0) > |(v143 + map[v142 := v142.f6])|) {
				...
				var v151 := DC9(v125);
				var v152: multiset<seq<int>> := multiset{[v0], v151.cf17[|v84| := v142.f6], v125};
				var v153 := new C0(-(if (v125[122 := |v20|] in v152) then v152[v125[122 := |v20|]] else 0x270), {v90});
				v90 := v90;
			...
			if ((v142.f6 / v142.f6) != (v142.f6 + |v20|)) {
				...
				v126[592] := |v160|;
				v126[592] := v142.f6;
				var v161: map<C0, bool> := map[v142 := if (v126[592] in v91) then v91[v126[592]] else v1];
				v161 := v161[v142 := v90];
				v142 := new C0(v142.f6 % v0, v89);
			}
	...
	match (if (if (v90) then v90 else !v90) then DC12(DC12(v162)) else fm12(v1, |fm13(v90, v90, globalState)|, v90, 49, globalState)) {
		case DC10(cf18, cf19, cf20) =>
			...
			var v168: map<C0, bool> := map[v167[cf19] := v90];
			var v169: map<map<C0, bool>, bool> := map[map[v166 := !v164] := v1];
			var v170: array<bool> := new bool[17] [cf18, v1, v1, cf18, v20 == v20, !(v1 in v165[cf19]), v1, |v125| != |v84|, v90, cf20 != -329, v164, true, map[v168 := cf18] != v169, if (v1) then cf18 else v90, v164, cf18, v90];
			v170[75] := cf18;
			var v172: set<seq<bool>> := {v2};
			var v173: set<int> := {|v172|};
			v170[75] := {v125[|v21|], v166.fm2(cf18, v125, seq(0x263, i12  => (|map[|(map v171 : int | (908 <= v171) && (v171 < -712) :: (v171 * v0) := (false))| := true]|)), v84, globalState)} !! v173;
			var v174 := 'a';
			cf19 := |v20[v166.f6 * v0 := v174]|;
		case DC11() =>
			var v175 := DC9([v0]);
			var v176: multiset<D3> := multiset{v175, v175, v175, v175.(cf17 := v125)};
			v126[608] := -|v176|;
			var v177: map<bool, bool> := map[v1 := true];
			v126[608] := fm4(v0, if (v1 in v177) then v177[v1] else v90, globalState);
			var v178: set<map<bool, int>> := {v84, map[DC0(false).cf0 := |v2|], v84};
			var v179: set<int> := {-0x294 / v0, |v178|, 0xfd};
			v179 := v179;
		...
		case DC9(cf17) =>
			...
			if (v1) {
				...
				v88[792] := v186;
				v88[792] := if (v1) then v186 else v186;
			} else {
				...
				v126[422] := (|v188| * -0x332) * |v87|;
			}
			
			var v189: array<bool> := new bool[26] [v2[v0], v1, v1, v90, false, true, !false, v1, v1, v90, v1, !fm0(v1, v1, fm4(|v2|, v1, globalState), globalState), v1, v1, v1, false, v90, v1, v90, true, v90, fm0(v1, v43.cf5, v0, globalState), !v1, v1, v1, v1];
			...
			match (v93) {
				case DC3(cf5, cf6, cf7, cf8, cf9) =>
					...
					var v194: array<set<bool>> := new set<bool>[2] [{cf8, if (v90 in v193) then v193[v90] else cf6}, {cf5, v2[|v125|], !v90}];
					v194[316] := v89;
					var v195: map<int, D3> := map[v0 := DC11()];
					globalState.f0, cf8, v192, v194[316] := cf9, multiset{v0, v0, v0} > multiset(cf17 + v125), v192, if (!(|v195| >= |v92|)) then v89 else v89;
					v189[403] := true;
					v189[403] := fm0(v1, v90, cf9, globalState);
					var v196 := new C0(cf9 / -|v190|, fm5(globalState));
					cf6 := true;
				case DC2(cf4) =>
					var v197: C0 := new C0(fm4(cf4, v1, globalState) % -v0, if (v90) then {v90} else v89);
					var v198: map<bool, bool> := map[v90 := v2[212]];
				...
				case DC4(cf10) =>
					...
					v90, v205, v206, v126 := (|map[v202.f6 := v202]| % v202.f6) != -v0, v205, v206, v126;
			}
		...
		case DC12(cf21) =>
			...
			var v209: array<bool> := new bool[23] [v90, v90, v90, !v1, v90, false, v207 && !v207, v1, v1, !true, v90, v1, v207, |multiset{v1}| < -0x1fc, v90 ==> false, v90, v1, v207, (v208.(cf20 := v0)).cf18, v90, v90, v207, v2[-0xe5]];
			v209[672] := v90;
			v209[672] := v1;
	...
	if ((v87 + v87) != v87) {
		...
		match (v215) {
			case DC6(cf12, cf13, cf14) =>
				var v216: array<bool> := new bool[6] [v0 == v125[cf12], true, !(if (cf12 in v91) then v91[cf12] else cf13), v90, v1, v1];
				v216[855] := v1;
				v216[855] := v1;
				...
				var v223: C0 := new C0(cf12, v222[|v217[2]|]);
				var v224: set<C0> := {v223};
				var v225 := DC16(v224, v213, v0, v213);
				v220[332] := if (true) then v221 else {|v221|, cf12, cf12, v225.cf27, cf12};
				v220[332] := v221;
				var v226 := DC12(v162);
			...
			case DC7(cf15) =>
				...
				var v231 := DC3(v1, fm0(fm0(v90, v1, 844, globalState), if (v213 in v230) then v230[v213] else true, |v2|, globalState), ("tim")[|v87| := 'u'], v1, v0);
				var v232 := DC4(v231);
				...
				v0 := 0xe6;
			case DC5(cf11) =>
				globalState.f0 := -(v0 / (if (v2[fm4(v0, v1, globalState)]) then v0 else v0));
				var v234: array<bool> := new bool[20];
				v234[321] := v1;
				var v235 := DC12(DC11());
				v234[321], v235, v234, v90, v90 := v90, v235, v234, fm4(v0, v1, globalState) <= (DC6(v0, v90, v126).cf12 * v0), fm0(v90, v1, v0, globalState);
				var v236 := DC10(v90, v0, v0);
				globalState.f0 := 0x2d2 + (-|v87| * v236.cf19);
				globalState.f0 := (v0 * v0) - v0;
			case DC8(cf16) =>
				globalState.f0 := v0 * (v0 / -|(multiset(v2))[v1 := v0]|);
				v90 := !true;
		...
		globalState.f0 := (|v20| % v0) * |(v239 + v239)|;
	} else {
		var v240 := new C0(|v20|, v89);
		globalState.f0 := v240.f6;
		var v241: map<string, bool> := map[v20 + v20 := v2[v240.f6]];
