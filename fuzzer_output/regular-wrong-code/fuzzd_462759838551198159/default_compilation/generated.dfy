...
function fm8(p0: bool, p1: bool, p2: bool, globalState: GlobalState): string {
	(if (!false) then seq(0x69, i0  => ('d')) else "hft") + "vmyiaonkn"
}
...
function fm10(p0: map<bool, int>, globalState: GlobalState): bool {
	(false ==> true) <== ((seq(-0xc3, i0  => ('m'))) == "tafve")
}
function fm14(p0: int, globalState: GlobalState): multiset<int> {
	DC21(|[-|DC20(map v0 : int | (557 <= v0) && (v0 < 0x27c) :: (v0 / 0x150) := (true)).cf38|, 0x1b7, -459]|, |DC17(false, "q").cf33|, multiset{-0x3e4}, |map[true := -0x113]|, !false).cf41
}
...
function fm19(p0: bool, p1: bool, p2: int, globalState: GlobalState): int {
	|"bqifudd"| / (|map[0xc1 := 'n']| - -0x2b2)
}
function fm20(p0: int, globalState: GlobalState): seq<int> {
	[|map[|multiset{|[|map[DC57(0x185) := |"kimv"|]|, 0x91]|, --|[true]|}| := DC32(|multiset{false}|, seq(-0x2f0, i0  => ('i')), true).cf56]|, |"dclnsfu"|] + [0x6f, |{false, !true}|]
}
...
function fm41(p0: int, p1: bool, globalState: GlobalState): multiset<string> {
	(if (true) then multiset{"hna", "migmfu", seq(536, i0  => ('t'))} else multiset{"ewcagdos"}) * (DC54(multiset{"tfkpdcxdj"}).cf87 - multiset{"mpirxf", "utfaodcxy"})
}
function fm42(p0: bool, globalState: GlobalState): string {
	("hd" + (seq(0x5d, i0  => ('w')))) + (seq(0x349, i1  => ('g')))
}
...
function fm47(p0: int, globalState: GlobalState): multiset<int> {
	multiset{|"fulwqy"|} - multiset([|(seq(0x30a, i0  => (61)))|])
}
...
function fm51(p0: bool, globalState: GlobalState): D0 {
	if (false) then DC2(seq(0x1cf, i0  => ('m'))) else DC2("xfe")
}
...
function fm68(p0: bool, p1: bool, globalState: GlobalState): map<int, int> {
	map[-|{false, !false, true, false}| % |{|{|map[!false := false]|, 0x87, |map[!true := true]|, |"rnc"|, 0x230}|}| := |(map[4 := 0x366] + (map v0 : int | v0 in multiset{|map[true := 603]|, |{|(set v1 : int | v1 in [-|[[true, true], [false, false]]|] :: (v1 / |"vdke"|))|}|} :: (v0 / |{true}|) := (|"bpgsbiy"|)))|]
}
function fm69(p0: seq<D2>, globalState: GlobalState): int {
	-|(({map[false := |(seq(-0x316, i0  => (735)))|], map[!true := |map[|"qx"| := false]|]} - {map[false := |map[|[seq(-0x6c, i1  => ('o')), seq(958, i2  => ('i'))]| := true]|], map[false := |multiset([0x228])|]}) * {map[false := |[!true]|], map[false := 0x33f]})|
}
...
function fm74(p0: bool, globalState: GlobalState): D4 {
	if (true) then if (true) then DC14(DC14(0x78, 557).cf29, 976) else DC14(0x136, 677) else DC14(|"if"|, |(seq(0x86, i0  => ('r')))|)
}
function fm75(globalState: GlobalState): D5 {
	match DC46(map[DC41(!false, true, 36, -0x116) := |(seq(-0x8e, i0  => (|map[|(set v0 : int | (0x2c9 <= v0) && (v0 < 0x10) :: (v0 + 231))| := |['u', 'j']|]|)))|]) {
...
function fm80(p0: set<char>, p1: char, p2: int, p3: int, globalState: GlobalState): map<seq<int>, bool> {
	map[[|map[|(set v0 : map<int, bool> | v0 in map[map[0x18e := true] := -0x54] :: (v0))| := 'u']|, -0x260] + (seq(0x37d, i0  => (|"acb"|))) := false && true]
}
...
function fm82(p0: string, p1: D2, globalState: GlobalState): seq<set<bool>> {
	(DC75(seq(0x1b9, i0  => ({true, !false, true, false}))).cf129 + [{false}, {true}]) + (seq(0x170, i1  => ({false, false})))
}
function fm83(p0: map<string, int>, p1: int, p2: int, globalState: GlobalState): D17 {
	match DC54(multiset(seq(130, i0  => (seq(0x3c0, i1  => ('s')))))) {
		case DC54(cf87) => DC38()
	}
}
function fm84(p0: bool, globalState: GlobalState): map<char, seq<int>> {
	(map['d' := [|(seq(0x216, i0  => ('s')))|, |map[true := true]|, 814]] + map['w' := [|"llkfryfe"|, |"xtb"|, 0xf3]]) + (DC76(map['s' := seq(-0x1f, i1  => (445))]).cf130 + map['u' := [0x177]])
}
...
function fm89(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState): map<int, D2> {
	(map[|{!!true, true}| := DC8(DC0(0xf1), true)] + (map v0 : int | v0 in multiset{|[!false, false, false, false, true]|} :: (v0 / -0x1e) := (DC8(DC0(|map['f' := true]|), true)))) + (map[0x271 := DC8(DC0(|[true]|), false)] + map[328 := DC8(DC0(0x257), true)])
}
...
function fm91(p0: int, p1: bool, globalState: GlobalState): map<string, map<int, bool>> {
	match DC20(map v0 : int | (-0x59 <= v0) && (v0 < 637) :: (v0 * -619) := (false)) {
		case DC21(cf39, cf40, cf41, cf42, cf43) => map[seq(0x8c, i0  => ('u')) := map[cf39 := cf43]]
		case DC20(cf38) => (map v1 : string | v1 in ["utaiclvyj", "b"] :: (v1) := (map v2 : int | (820 <= v2) && (v2 < 476) :: (v2 % |"prgfwdyg"|) := (true))) + map["ukokn" := cf38]
	}
}
function fm92(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<string> {
	["hlce", if (true) then "kpcm" else seq(0x15, i0  => ('b')), "ifd" + "psydfs"]
}
function fm93(globalState: GlobalState): multiset<D7> {
	(if (false) then multiset(DC83(seq(0x2b, i0  => (DC21(|multiset{true}|, 0x224, multiset([|map[0x154 := |"y"|]|, 0x291, |"gf"|, 584]), -0x373, false)))).cf144) else multiset{DC21(|[false, !false]|, 0x16c, multiset{|DC84(map[false := -0x27c]).cf145|}, |(seq(-552, i1  => (625)))|, !false)}) - (multiset{DC21(|map[0x133 := 0x2bd]|, -0x3e, multiset{-919}, -0x18d, true)} + multiset{DC21(0x14d, 588, multiset{0x3b5}, 487, true), DC21(|(seq(517, i2  => ('o')))|, |DC7(multiset{true}).cf14|, multiset{|{"btlrcxnrs"}|}, 146, !false)})
}
...
function fm96(p0: char, p1: string, p2: set<int>, p3: set<int>, globalState: GlobalState): D25 {
	match if (true) then DC84(map[true := |[|(map v0 : int | (-0x3ba <= v0) && (v0 < 0xf8) :: (v0 * |map[|(seq(985, i0  => (|multiset{-423}|)))| := |[true, true]|]|) := (0x354))|]|]) else DC84(map[false := |"ljhlwq"|]) {
		case DC84(cf145) => DC55(seq(0xe5, i1  => (DC23('y'))))
...
function fm98(p0: map<int, bool>, globalState: GlobalState): D16 {
	DC35(map[|"nwifwho"| := |(seq(0x1fe, i0  => ('e')))|])
}
method m0(globalState: GlobalState) {
	...
	match (v6) {
		case DC10() =>
			...
			var v11: multiset<string> := multiset{seq(0x46, i0  => ('k'))};
			var v12 := DC54(v11);
		...
		case DC11(cf18, cf19, cf20, cf21) =>
			...
			var v21 := new C14(seq(-565, i1  => ('k')), v1, v18, fm50(!v1, 0x18f, v0, globalState), |(multiset{v1})[cf20 := cf19]|, |v20|);
			var v22: multiset<bool> := multiset{v1};
			v1 := fm30(cf20 ==> cf20, v22, globalState);
			v17[785] := -cf19 / v0;
			v17[785] := (cf18 + v0) + (-cf18 + |[cf21, cf21, -cf21]|);
			cf19 := cf21;
		case DC12(cf22, cf23, cf24, cf25, cf26) =>
			var v23: set<int> := {cf22};
			var v24: map<int, set<int>> := map[v0 / |v5| := v23];
		...
		case DC9(cf17) =>
			...
			match (v31) {
				case DC45(cf76) =>
					...
					v38 := v38;
				case DC44(cf75) =>
					v0 := (if (v1) then v0 else v0) % v0;
					v1 := !(if (!v1) then false else !v1);
					v0 := v0 - (fm31(globalState) / v0);
					v1 := v1;
			}
			...
			if (false) {
				...
				v39 := (fm50(multiset{v1} !! v44, v0, v0, globalState))[v0 := v1];
			} else {
				v0 := v0;
				v1 := v1;
				...
				v0, v1, v45[331], v1 := |v47|, v1, v0 * v0, v1;
				var v48 := DC2(seq(-0x168, i5  => ('i')));
				var v49: C12 := new C12(v48, -fm19(v1, !v1, v45[331], globalState), 0x1d3);
				var v50: set<int> := {v45[331]};
				var v51: map<set<int>, int> := map[v50 := v0];
				v0, v45[331], v49, v45[331], v1 := -v0 - (v0 - v0), |map[v0 := |v51|]| * v0, v49, -v45[331], true;
				var v52 := 'r';
				var v53: multiset<char> := multiset{v52, v52, v52};
				var v54: map<int, C12> := map[v45[331] := v49];
				v0, v53, v49 := v0, multiset{v52} + v53, if (v45[331] in v54) then v54[v45[331]] else v49;
			}
	...
	for i6 := v0 to v0 {
		...
		if (v1) {
			...
			v1 := (|(seq(0x34a, i8  => ('j')))| * v55[491]) !in [|v57|, i6];
			var v58: array<bool> := new bool[22](i9 => v1);
			v58[151] := i6 < v55[491];
			v58[151] := fm18(v1, v55[491] % v0, globalState);
			v0 := v0;
			v0 := 0x32f;
		} else {
			...
			var v66 := new C2(-(if (v1) then -(if (v59 in v60) then v60[v59] else |v62|) else v55[491]), [v1], |multiset{!v1}|, |v65|);
			var v67: map<int, int> := map[v0 := v66.f29];
			v67 := map[if (false) then v55[491] else v66.f29 := i6];
			...
			v71[778], v73, v0, v1, v66.f29 := v68, v73, v0, v67 == (map v74 : int | (953 <= v74) && (v74 < 0x3cb) :: (v74 * v66.f29) := (v55[491])), |{!!v1, v1, v1, |[v1, v1, v1, v1]| < |v75[v0]|, v1}|;
		...
		var v79: set<int> := {|v56|};
		v55[491], v0, v79 := v55[491] / v55[491], fm31(globalState), v79;
		var v80 := DC62(map[v2 := i6]);
		var v81: array<string> := new string[12];
		var v82 := DC48(v55[491] * i6, v79, DC16(v81).cf31);
		var v83: map<string, int> := map["os" := v55[491]];
		v80, v1, v82 := DC62(v83), v1, v82;
	}
	var v84: seq<bool> := [v1, true, v1];
	var v85: multiset<bool> := multiset{v1};
	var v86 := DC52(|v85|, (multiset(v5))[|v5| := v0]);
	var v87: array<int> := new int[5];
	var v88: map<array<int>, bool> := map[v87 := v1];
	var v89: seq<seq<bool>> := [v84];
	var v90: T2 := new C4(!v1, v88[v87 := v1], v89[v0], -342, fm31(globalState));
	var v91 := DC5(v90.f8[v0], v90.f7, v90.f9, v84);
	var v92: map<T2, seq<bool>> := map[v90 := (v91.(cf11 := v90.f9, cf9 := v90.f9)).cf12[-v90.f7 := v1]];
		...
		decreases 100 - i11
	{
		...
		v98[7], v87, v98[856], v0, v100 := v90.f9, v87, v90.f9 <== v90.f9, v0, v100;
	}
}
trait T0 {
	const f6 : int
...
class C1 {
	...
	method m20(p0: D6, p1: D1, p2: array<set<int>>, globalState: GlobalState) returns (r0: bool, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v1 := 'd';
			r0 := fm35((("s")[f26 := v1])[f26 := fm36(f26, f27, f26, globalState)], globalState);
			if (true) {
				...
				v14 := (if (v15 in v16) then v16[v15] else |map[451 := -31]|) % (v7.f28 + v14);
			} else {
				var v17: multiset<bool> := multiset{false, p1.cf11 && true, f27};
				var v18: map<int, int> := map[|(seq(0x4e, i3  => (v1)))| := f26];
				...
				r1 := ([true, f27, f27, f27, f27] + v22) <= (v22 + (if (f27 in v23) then v23[f27] else [true, f27])[f26 := f27]);
				r0 := !f27;
				var v24: array<bool> := new bool[28](i4 => v22[|map[false := f26]|]);
				v24[557] := f27;
				var v25 := -860;
				var v26 := "fi";
				...
				v24[557], v25, v26, v29 := f27, -|v22|, v26 + v26, v29 + fm40(f27, globalState);
				var v30 := new C0(-f26);
			}
		...
		v33[436] := f27;
		v33[436] := (seq(-0x1f9, i6  => ('a'))) == (v37 + (seq(125, i7  => ('q'))));
		var v40: map<bool, int> := map[v33[436] := v36];
		var v41: multiset<int> := multiset{f26};
		var i8 := 0;
		while (multiset{if (v33[436] in v40) then v40[v33[436]] else |"suw"|, f26, v36, v36} <= v41)
			decreases 100 - i8
		{
			if (i8 >= 100) {
				break;
			...
			var v44 := 'b';
			v37 := if (multiset{v33[436], f27} in v43) then v43[multiset{v33[436], f27}] else ("eihxvs")[v36 := v44] + v37;
	...
	method m21(p0: int, p1: int, globalState: GlobalState) returns (r0: array<int>) {
			...
			decreases 100 - i1
		{
			...
			var v31: array<int> := new int[12] [if (v20 in v21) then v21[v20] else |v24[|v25|]|, 0x101, v28[v15.f28] * f26, v16 + p1, v15.f28, v15.f28, (if (v19 in v29) then v29[v19] else 130) / p1, p1 - 722, fm34(fm35(v25, globalState), globalState), |v30[p0 := !f27]| * f26, p1, p0];
			v31[11] := p1;
			v31[382] := p0;
			var v32 := DC13(v31);
			var v33 := DC15(v32);
			var v34: map<int, int> := map[83 := p0];
			v19, v16, v31[11], v31[382], v33 := v15.fm38(DC21(p0, f26, v17, if (p0 in v34) then v34[p0] else p1, f27), globalState), v15.f28, |"hdx"|, (if (f27 in v26) then v26[f27] else -0x29c) - v15.f28, v33;
			v31[11] := |fm42(v19, globalState)| + p1;
			var v35 := new C0(p1 + p0);
			v31[11] := v16 % v31[11];
		}
		var v36 := "mybb";
		var v37: seq<int> := [v15.f28, |v36|];
		var v38: map<bool, int> := map[v37[f26] >= f26 := if (|v37| in v17) then v17[|v37|] else p0];
		v38 := v38[f27 := v16];
		var v39: seq<string> := [v36];
		var v40 := new C0(|(v36 + v39[v15.f28])|);
...
class C2 extends T1 {
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		for i0 := f6 to if (v0) then |p0| else |(map v1 : char | v1 in v3 :: (v1) := (f6))| {
			...
			var v5: array<string> := new seq<char>[15] [v3, v3, v3[f7 := v2], v3, "fv", if (f6 in v4) then v4[f6] else v3[f6 := v2], "n", seq(-0x137, i1  => (v2)), v3, v3, v3, fm44(v2, globalState), fm44('l', globalState), seq(0x6d, i2  => (v2)), v3];
			var v6 := DC16(v5);
			v6 := v6;
			...
			decreases 100 - i3
		{
			...
			if (false) {
				...
				v13[625] := v0;
				v12[210], v2, v10[252], v13[625], v0 := f8 + [v0], v2, (f6 + 0x3e4) - f7, false, v0;
				var v14: array<multiset<int>> := new multiset<int>[16](i4 => multiset{-v10[252], DC18(f6, false, -0x118).cf34, f6});
				v14[792] := fm47(f29, globalState);
				var v15: seq<int> := [0x35b, f7];
				var v16: multiset<int> := multiset{f6, 0x36b / f7, 0xf3 + |v15|};
				v14[792] := v16;
				var v17 := DC25(map[v0 := f29]);
				var v18 := DC2(v3);
				var v19 := DC3(v18);
				var v20: map<bool, int> := map[v13[625] := fm45(v13[625], v19, globalState)];
				var v21: map<int, int> := map[f6 := f29];
				var v22: array<map<bool, int>> := new map<bool, int>[24] [v17.cf47, v20, v20, v20, v20, (map[fm46(v0, globalState) := |v3|])[fm46(v0, globalState) := |v3|] + fm48(v13[625], true, globalState), if (v0) then v20 else v20, fm48(v12[210][|(seq(0x3cb, i5  => (v2)))|], v0, globalState), v20 + v20, v20 + map[v0 := f6], v20 + v20, (map[v13[625] := f29])[v13[625] := v10[252]], v20, map[!v0 := |v3[v10[252] := v2]|], v20, map[v13[625] := |v21|], v20, v20, v17.cf47 + v20, v20, fm48(v0, v0, globalState), v20, map[v0 := f29], v20];
				v22[885] := v20;
				v22[885] := v20;
			} else {
				...
				v24 := v24[v25 > v25 := v23];
				f29 := 0x187;
				var v26: array<string> := new seq<char>[9](i6 => seq(-0x15b, i7  => (v2)));
				var v27: seq<string> := ["vnc", v3, v3, v3, v3];
				v26[286] := v27[f29];
				v26[286] := fm44(v2, globalState);
				var v28 := DC13(v10);
				var v29 := DC15(v28);
		...
		match (v38) {
			...
			case DC2(cf6) =>
				...
				var v52 := DC3(v51);
				var v53 := DC3(v51);
				var v54: array<int> := new int[16] [f29, f7, f29, (if (v0 in v50) then v50[v0] else fm45(v0, v53, globalState)) / f6, f29 + -f29, 0x1a6 - f6, f29, f6, -(f7 + |cf6|), f29 + |{v0, fm46(v0, globalState)}|, if (v0) then f7 else f6, 0xf5, f6, f6, f7, f7 + |p0|];
				v54 := v54;
				f29 := f29 * f6;
			case DC0(cf0) =>
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		if (p1) {
			...
			if (false) {
				...
				v0[231] := p1;
				v0[231] := v0[231];
				v0[231] := !fm46(f29 <= |fm49(globalState)|, globalState);
			} else {
				...
				var v12: seq<map<int, int>> := [v10[|f8| := |v11[f6 := f7]|], v10];
				var v13: set<bool> := {fm46(p1, globalState)};
				var v14: map<map<int, int>, int> := map[v12[f29] := |v13|];
			...
			if (v22 <= v22) {
				...
				var v29: array<int> := new int[20] [|v23|, |(seq(0x1ea, i3  => (v24)))|, -0x22b, |v3|, f29, 0x1fa, 0x3c2, |v27|, f6, |[seq(354, i4  => (v24)), seq(-0x26c, i5  => (p0))]|, |map[f7 := |v3|]|, f29, f7, f29, 0x21d, -f7, |v3|, f6, f7, f6];
				var v30: map<array<int>, int> := map[v29 := f29];
				var v31: array<int> := new int[15] [0xbf, f7 % |v3|, f7, |(if (p1) then v27 else v27)|, f6, f6, |v28| % f6, -f6, f29, |"qbn"|, |v3|, |("s" + v3)|, if (DC5(v20, -853, v20, [v20]).cf9) then f29 else f6, if (v29 in v30) then v30[v29] else f7, v27[f6]];
				v29 := v29;
				...
				v20, v33[284], v20, f29 := v35 > v35, v34, true, 0x366;
			} else {
				...
				var v41: seq<set<int>> := [set v40 : int | (0x2c8 <= v40) && (v40 < -921) :: (v40 / f6), v39, v39];
				v38 := v38[v0 := v39 >= v41[f29]];
				v0[600] := v20;
				var v42: set<bool> := {p1};
				v0[600] := 140 >= |v42|;
				v3 := v3;
			...
			match (if (p1) then v44 else v44) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					v50 := if (cf4) then v50 else {!false, cf1, cf3, if (f29 in v51) then v51[f29] else v0[605]};
					var v52: array<int> := new int[27];
					v52[30] := f7;
					var v53: map<bool, int> := map[|v49| > 581 := f6];
					v52[30] := if (cf1 in v53) then v53[cf1] else |(v49 + v49)|;
				case DC2(cf6) =>
					var v54: seq<string> := [cf6];
					var v55: multiset<bool> := multiset{p1, !p1};
					var v56: map<bool, int> := map[p1 := |v55[p1 := f6]|];
					var v57: array<seq<bool>> := new seq<bool>[27] [[p1, !true, p1], f8, ((f8 + f8)[f7 := p1])[f6 := p1], f8, f8, f8, [p1], f8, f8, f8, f8, f8, f8, f8 + fm50(true, 287, -|v54|, globalState), f8, f8, if (p1) then f8 else f8, f8, [p1], f8, f8[f6 := false], fm50(p1, if (p1 in v56) then v56[p1] else f29, f7, globalState), f8, f8, f8 + f8, f8, f8];
					v57[38] := f8;
					v57[38] := f8 + f8;
				...
				case DC0(cf0) =>
					...
					var v67 := DC13(v63);
					v65 := v65[!(v66 != v66) := v64 + v64[876 := v67.cf27]];
				...
				case DC3(cf7) =>
					...
					v0[91] := !((seq(368, i6  => ({p1, p1}))) != v75);
					var v76: seq<bool> := [p1, p1];
					var v77: multiset<bool> := multiset{v0[91]};
					var v78: map<int, multiset<bool>> := map[|v77| := multiset{!f8[f7], p1, !p1, !true}];
					var v79 := "dnjvemlmp";
					v0[91], v76, v78, v0[91], v79 := true, f8 + v76, v78, p1, fm44(p0, globalState);
					var v80 := new C1(|v77|, v0[91]);
					v0[91] := v80.f26 >= |v79|;
			}
			
			v0[868] := p1;
			var v81: set<int> := {f7};
			v0[868] := DC1(p1, f8[|v81|], false, !p1, p1).cf4;
			var v82: array<int> := new int[2];
			v82[159] := f29;
			v82[159] := f29 % f7;
			f29, v0[868] := f29, !v0[868];
			var v83 := "vbvmqhubk";
			var v84: seq<string> := [v83];
			v0[868] := (v83 + v83) < v84[f6];
		}
...
class C3 extends T0 {
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		var v21 := DC22(v12);
		var v22 := 'y';
		match (if ((seq(0x35d, i3  => (f7))) <= v14) then v20 else DC21(|map[v21 := v22]|, f24, v17, -f25, v0)) {
			case DC21(cf39, cf40, cf41, cf42, cf43) =>
				cf40 := 0x2a0;
				v11[607] := cf40 < f6;
				v11[607], cf42 := !v0, -(f25 * cf42);
				v15 := (v15 + v15) + (v15 + v15)[|v14| := v22];
				r0 := cf42 >= f24;
			case DC20(cf38) =>
				var v23 := 100;
				var v24: set<bool> := {v0};
				var v25 := DC23(v22);
				var v26: array<char> := new char[24] [v22, 'e', v22, v22, v22, 'a', v22, v22, v22, 'q', v22, v15[|v24|], v22, 'i', v22, v15[f25], v15[v23], 'j', 'l', v22, v25.cf45, v22, v22, v22];
				v26[29] := v22;
				v14, v23, v26[29] := [f24, f25] + (v14 + v14), f25, v22;
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (p1) {
				...
				v20 := v20[f7 / |(if (f24 in v21) then v21[f24] else v0)| := v15];
				var v22: multiset<char> := multiset{p0, p0};
				var v23: map<int, seq<set<D3>>> := map[|v22| := seq(0x22d, i1  => ({DC9(multiset(v15))}))];
			...
			if (false) {
				...
				v34[127] := fm32(p1, p1, [p1], v0, globalState);
				v34[127] := fm35(fm42(!p1, globalState), globalState);
				var v35: map<int, bool> := map[f24 := v34[127]];
				v34[127] := fm32(p0 !in v0, if (true) then p1 else if (v33.f28 in v35) then v35[v33.f28] else p1, v3, "yq" + v0, globalState);
			} else {
				var v36 := true;
				var v37: array<bool> := new bool[15];
				v37[364] := false;
				var v38: map<int, bool> := map[f7 := p1];
				var v39: array<int> := new int[20] [-|(seq(0x308, i3  => (p0)))|, f24, f24, f7, f25, -f7, 0xb, f7 / f7, f24, -0x197, -(-f24 - fm33(true, globalState)), |v38|, f24, 0x2f, f25 * 0xc2, f25, f6, fm33(v36, globalState), |"kfgk"|, f7];
				v39[376] := f7;
				v36, v37[364], v39[376] := p1, p1, f7;
				v39[376] := v39[376];
				var v40: map<bool, array<int>> := map[p1 := v39];
				var v41 := DC13(v39);
				v40 := v40[v37[364] := v41.cf27];
		...
		var v50: set<char> := {p0};
		var v51: array<bool> := new bool[8] [fm35(v0, globalState), if (0x3e7 in v49) then v49[0x3e7] else p1, true, p1, !(if (p1) then p1 else !p1), !v3[-f6], p1, v50 !! v50];
		...
		var v60: array<int> := new int[6] [f24, v59[f25], f7, |"qbwvawgcv"|, f24, f25];
	...
	method m18(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v4 := if (v5[f24] <= f25) then v4 else v4;
			var v6: array<int> := new int[24](i1 => i1 / -f24);
			v6[496] := f6;
			var v7: multiset<string> := multiset{v4[p0 := 'm']};
			v3, v6[496], v0 := (v3 + v3) + map[f24 := v0], |v7|, false;
			var v8: array<bool> := new bool[15];
			v8[4] := if (v0 in v1) then v1[v0] else v0;
			v8[4] := v0 ==> v0;
		}
		var v9 := 0x83;
		...
		for i2 := f25 to |v10| {
			...
			v13[854], v14, v9 := fm32(v0, |v15| <= fm33(v0, globalState), v2 + v2[|v16| := true], v10 + v10, globalState), v14.(cf29 := f7 - f24), i2;
			var v17: multiset<array<int>> := multiset{v12};
			v17 := v17;
			var v18 := DC0(f7);
			var v19: T1 := new C2(f25 * |"ra"|, if (!true) then v2 else v2, v18.cf0, v9);
			v19 := v19;
			var v20 := DC17(v13[854] && true, v10);
			match (v20) {
				case DC17(cf32, cf33) =>
					var v21 := DC3(DC1(v13[854], cf32, v0, cf32, fm35(cf33, globalState)));
					v9 := v19.f7 * fm45(cf32, v21, globalState);
					cf32 := if ("yiks" < (seq(0x76, i3  => ('k')))) then cf32 && v13[854] else true;
					v9 := -v9;
					v9 := f6;
				case DC18(cf34, cf35, cf36) =>
					...
					v25 := v25[v23 := v24];
					cf35 := if (v13[854]) then v13[854] else v0;
				case DC16(cf31) =>
					v12[243] := v19.f7;
					v12[243] := f6;
					var v26: array<int> := new int[5];
					v26 := v26;
					var v27: map<int, int> := map[v19.f6 / v19.f6 := p0 % |multiset{v2}|];
					v13[854], v27, v26, v10, v13[854] := !v13[854], map[0x16d := |[v0]| % v12[243]], v26, v10 + ("dewmuoexm" + (fm51(v0, globalState)).cf6), v13[854];
					var v29: array<set<int>> := new set<int>[1](i4 => {f24} * (set v28 : int | v28 in v11 :: (v28 % |map[true := false]|)));
					var v30: set<int> := {|v10|};
					v29[157] := v30;
					v29[157] := set v31 : int | (225 <= v31) && (v31 < 0x23f) :: (v31 * p0);
			}
	...
	method m19(p0: set<multiset<bool>>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool) {
		...
		var v3 := new C2(f6, v0 + v0, |(v2[f25] + v1)|, f24);
		var i0 := 0;
		while (true)
			decreases 100 - i0
		{
...
class C4 extends T2 {
	...
	function fm1(globalState: GlobalState): map<seq<int>, int> {
		map[(seq(0x332, i0  => (282))) + [DC18(|"ky"|, false, f6).cf34, f6] := f6]
	}
	function fm0(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<bool, bool>> {
		match DC0(f6) {
	...
	function fm55(p0: bool, p1: bool, globalState: GlobalState): int {
		|(if (map[f6 := map[|{f8, f8, f8, f8}| := 0x34c]] == map[234 := map[f7 := f6]]) then seq(518, i0  => (f6)) else [0x16b, --|{DC20(map[f7 := !f9]), DC20(map[f7 := false]), DC20(map[f6 := f9]), DC20(map[f7 := true]), DC20(map[f7 := f9])}|])|
	}
	method m3(p0: string, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		v0[951] := v2 != (seq(0x29d, i1  => (v1)));
		v0[951] := p1;
		if (p1) {
			r0 := (|p0| % 0x2ad) % p2;
			var v4: set<int> := {|(map v3 : int | (0x22c <= v3) && (v3 < 775) :: (v3 * f7) := (f9))|, p2};
			var v5: map<bool, bool> := map[true := f9];
			var v6: map<bool, bool> := map[p1 := if (v0[951] in v5) then v5[v0[951]] else v0[951]];
			var v7: set<bool> := {!v0[951], p1};
			var v8: map<int, int> := map[p2 := f6];
			var v9 := DC18(|v7|, v0[951], if (|f8| in v8) then v8[|f8|] else f7);
			v0[951] := ({p3} - v4) !! {fm54(|v6|, fm55(v9.cf35, v0[951], globalState), globalState), |v4|};
			var v10: map<int, bool> := map[f6 := true];
			v10 := v10[p3 := f9];
			var v11 := 'x';
			var v12: map<char, bool> := map[v11 := !f9];
			var v13: array<int> := new int[6] [p2, 0x306, f7, |v8| % -|v12[v11 := f9]|, f6 - 166, f6];
			v13 := v13;
			var v14: map<set<bool>, D4> := map[v7 := DC13(v13)];
			var v15 := DC13(v13);
			v14 := v14[if (v0[951]) then {f9, v0[951]} else v7 := v15];
		} else {
			var v16: seq<seq<bool>> := [f8];
			var v17: set<seq<bool>> := {v16[p3]};
			v17 := v17;
			var v18 := "pmi";
			v18 := v18;
			var v20: array<set<int>> := new set<int>[14](i2 => set v19 : int | v19 in multiset{|map[DC7(multiset{p1, v0[951]}) := v0[951]]|, f6, |multiset{p0}|} :: (v19 + |"m"|));
			v20 := v20;
			r1 := p1;
			if (f9) {
				m0(globalState);
				...
				v21 := new seq<int>[4];
				var v22: array<int> := new int[21](i3 => i3 % f6);
				v22 := v22;
				...
				var v25: map<bool, bool> := map[v0[951] := p1];
				r1 := !((v24[fm55(f9, f9, globalState)] == p0) in v25);
				var v26: seq<int> := [p2, if (f9) then f7 else f7];
				var v27 := DC18(p3, f9, f7);
				var v28 := DC24(v26[|(seq(487, i4  => ('w')))| := v27.cf34]);
				v26 := v28.cf46 + ([|v18|] + (([p3])[p2 := p2])[p3 := -|v18|]);
				var v29 := new C2(p3, f8 + f8, p2, p2);
				var v30 := 'n';
				var v32: map<int, bool> := map[f6 := p1];
				var v33: array<seq<bool>> := new seq<bool>[13] [fm56(!v0[951], p1, !v0[951], globalState), fm56(fm57(map[p2 := v0[951]], v30, fm57(map v31 : int | (-0x1b9 <= v31) && (v31 < 0x361) :: (v31 / |v18|) := (v0[951]), v30, v0[951], globalState), globalState), p1, p1, globalState) + f8, f8, f8, f8 + f8, f8, f8, f8, f8, f8 + [p1, if (|"plkukkno"| in v32) then v32[|"plkukkno"|] else p1], f8, f8 + f8, (f8[|v25| := f9] + [p1, false])[p2 := f9]];
				v33[977] := f8;
				v33[977] := f8;
				var v34: multiset<bool> := multiset{f9, f9};
				var v35: seq<multiset<bool>> := [multiset(v33[977]), multiset{v0[951]}, v34];
				v35 := v35;
			}
		...
		match (fm58(v37, globalState).(cf11 := p1)) {
			case DC5(cf9, cf10, cf11, cf12) =>
				v0[951] := f9;
				m0(globalState);
				var v38: array<int> := new int[27](i5 => i5 / DC29(|[p3]|, f9).cf50);
				v38[914] := |fm59(f9, f9, globalState)|;
				v38[914] := -p3;
				cf9 := !(!v0[951] <== cf11);
			case DC4(cf8) =>
				var v39: multiset<bool> := multiset{true};
				var v40: map<bool, multiset<bool>> := map[v0[951] && v0[951] := v39];
				v40 := v40[!f9 := v39];
				var v41 := "fejmnxtf";
				v41 := p0 + "c";
				...
				var v44: map<int, bool> := map[f7 := f9 ==> v0[951]];
				v0[951] := if (p3 in v44) then v44[p3] else false;
			case DC6(cf13) =>
				if (v0[951]) {
					var v45 := new C3(f7, f6, p3, f7);
					var v46: multiset<seq<bool>> := multiset{f8, f8};
					r0 := |(v46 - v46)|;
					var v47 := new C1(v45.f24 % f7, true);
					var v48: map<seq<bool>, bool> := map[f8 := v0[951]];
					...
					var v55: array<array<set<bool>>> := new array<set<bool>>[27] [v51, v51, v52[p2], v51, v51, v51, v51, v51, v51, v52[f6], v51, v51, v51, v51, v51, v51, v51, v51, v51, v51, v51, v51, if (p1) then v51 else v51, v51, v51, v51, v52[if (f6 in v53) then v53[f6] else v54[f6]]];
					v55[789] := v51;
					v55[789] := v51;
					r1 := 0x313 <= fm55(p1, f9, globalState);
					var v56: map<string, bool> := map[p0 := true];
					v56 := v56[p0 + "qrg" := p1];
					var v58: seq<bool> := [|(set v57 : int | v57 in v37 :: (v57 / 0x253))| > fm55(false, v0[951], globalState)];
					v58 := v58 + f8;
					var v59 := DC21(|map[v0[951] := v0[951]]|, -|f8|, v53, f6, p1);
					v0[951] := v59.cf43;
				}
				
				var v60: set<bool> := {f9};
				r1 := if (v0[951]) then f9 else |v60| <= f6;
				if (v0[951]) {
					var v61: seq<int> := [|v1|, f6];
					var v62: map<int, bool> := map[f7 := p1];
					var v63 := 'f';
					var v64: map<bool, bool> := map[p1 := fm57(v62, v63, v0[951], globalState)];
					var v65: multiset<int> := multiset{-v61[|v64|]};
					var v66: map<seq<int>, array<bool>> := map[v61 := v0];
					var v67: array<int> := new int[29] [p2, p3, f7 / p3, f7 + p2, f6 / f6, 603, p3, p3, fm54(f7, p3, globalState), p3, p2, f6, if (f6 in v65) then v65[f6] else |(v66[v61 := v0])[v61 := v0]|, p3, p2, f6 % p3, p2, fm55(false, !f9, globalState), p2, 0xf5, |map[f9 := |f8|]|, p3, f7, f7 - 0x40, f6, f6, p3, f7, |("xdofh")[f6 := p0[p2]]|];
					v67[808] := p3;
					v67[808] := |(seq(0x48, i7  => (v63)))|;
					var v68 := DC29(-0x3cf, f9);
					v64 := v64[v0[951] := v68.cf51];
					var v69 := new C0(f6 + f7);
					var v70: map<array<bool>, bool> := map[v0 := p1];
					v67[808] := |(v70 + v70[v0 := p1])|;
					...
					var v73 := DC24(v72);
					r0, r0, r1, v73 := (f7 - f7) * fm55(v0[951], p1, globalState), p3, p3 in fm61(f6, globalState), v73.(cf46 := v72);
					r1 := f9;
				}
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		v2, v3, r0, r0 := v2 + v2, v3 % f7, |[f6, f7, f7, f6, f6]| !in [|fm62(f9, globalState)|, f6, f7, -v4.cf40, f6], f9;
		...
		for i0 := |map[v7 := |map[v3 := f7]|]| to f7 {
			...
			if (fm57(if (f9) then v8 else v8, v9, f9, globalState)) {
				...
				v18[897], v19, r0, v15[294], v20 := v16, v19 * v19, f9, |(v22 + v22[0xc := v21])|, v20 - v20;
			} else {
				...
				var v32 := DC34(v31);
				v28, v23[703], r0, v29[560], v32 := v28, f9, i0 < i0, i0, v32;
				var v33: map<bool, int> := map[v23[703] := v29[560]];
				var v34 := new C0(if (f9 in v33) then v33[f9] else i0);
				v3 := v3 * -0x23;
				var v36: map<char, int> := map[v9 := v34.f28];
				v33 := v33[v23[703] := |((map v35 : char | v35 in v30 :: (v35) := (v34.f28)) + v36)|];
			}
		...
		var v39 := "jyptuyyh";
		var v40: array<string> := new string[9] [v39, v39, v39 + (seq(0xb8, i4  => ('a'))), v39, v39, "mkonbiyc", v39, v39, v39];
		...
		if (f7 > v3) {
			...
			var v50: seq<int> := [|v39|];
			var v51: seq<D14> := [v1];
			var v52 := DC14(v50[f7], v3 % |v51[f6 := v1]|);
			v52 := v52;
			var v53: multiset<seq<int>> := multiset{v50, ((v50[f7 := 0xca])[v3 := v3])[|v45| := |v0[f9 := f9]|]};
			var v54 := DC11(-v3, |v53|, true, f7);
			r0 := v54.cf20;
		} else {
			var v55: map<int, bool> := map[f7 := f9];
			var v56: seq<multiset<int>> := [v7];
			v55 := v55[f6 := f7 !in v56[fm55(true, f9, globalState)]];
			r0 := f9;
			if (f9) {
				...
				var v64: C2 := new C2(f7, v63[f6] + f8, f6 * v3, f6);
				...
				v71[267] := if (false) then v70 else v70;
				v71[267] := v70;
			}
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		v1[230] := f6 * fm55(f8[-f6], f9, globalState);
		var v2 := "kj";
		v1[498] := |v2|;
		...
		v0, v1[230], v1[498] := (-f6 / f7) / f7, v0 + v0, -(if (((if (v5 in v6) then v6[v5] else f7) + f7) in v4) then v4[(if (v5 in v6) then v6[v5] else f7) + f7] else f7);
		var v7 := true;
		v7 := v2 <= v2;
		...
		match (v10) {
			case DC10() =>
				...
				v1[230], v2, v0 := (v1[230] % f7) + (f6 - v1[230]), v2 + v2, v12[v0 / fm54(v1[230], f7, globalState)];
				var v13 := new C0(|((multiset{p1})[p1 := f7])[f9 := v0]|);
				if (p1) {
					...
					v1 := new int[20] [v13.f28, v0 / |v14|, v0, f6, v0, if (v15 in v16) then v16[v15] else v13.f28, |v2|, v1[230], f7, f7, v13.f28, v13.f28, -v13.f28, DC11(v1[230], f6, p1, f6).cf21, |v17| / v13.f28, v1[230], 488, |v19|, 0x29b, f6];
					v0 := v0;
					v12 := [v13.f28];
					v0, v0, v17 := f6, v0, (multiset(f8) + v17)[v18.f27 := f7];
					...
					var v28: array<bool> := new bool[18] [v13.fm38(v24, globalState), !(v25[v13.f28] < v2), v13.f28 <= v13.f28, v7, v7, v7, p1, (seq(138, i1  => (v20[894]))) <= v2, v23.f26 < |multiset(v26)|, p1, v27 !! {f7}, v13.fm38(v24, globalState), v20[894] in v2, f9, v7, f6 <= f6, v23.f27, !true];
					v28[234] := p1;
					v28[234] := v23.f26 > -(f6 * v0);
					var v29 := new C3(|v22|, v13.f28, v13.f28, v1[230]);
				}
				
				v1[230] := v0 - fm55(f9, v7, globalState);
			case DC11(cf18, cf19, cf20, cf21) =>
				v1[230] := f6;
				var v30: set<bool> := {p1};
				var v31: map<multiset<int>, bool> := map[(multiset([0x1c, cf18, f7, cf18, v1[230]]))[-cf21 := v1[230]] := v30 == v30];
				v31 := v31;
			...
			case DC12(cf22, cf23, cf24, cf25, cf26) =>
				...
				v33[162] := if (cf25) then if (cf24) then v7 else fm57(v34, p0, !cf25, globalState) else v7;
			case DC9(cf17) =>
				var v35: seq<int> := [v1[230]];
				v1[230] := |v35|;
				v7 := f9;
				var v36: map<int, bool> := map[v0 := v7];
				var v37: array<bool> := new bool[23] [p1, !f9, f9, f9, p1, f9, f9, f9, v7, v7, true, f9, fm57(v36, p0, p1, globalState), f9, f8[v0], p1, f9, v7, p1, false, f9, p1, p1];
		...
		v40[336] := v7;
		v0, v40[336], v1[230], v7, v0 := --f6 - (v1[230] - f6), p1, v0, !p1, v1[230];
	}
}
...
class C5 extends T3 {
	...
	function fm1(globalState: GlobalState): map<seq<int>, int> {
		if (if (f9) then f9 else true) then map[[|"gw"|, f6] := f6] + (map v0 : seq<int> | v0 in DC28(map v1 : seq<int> | v1 in (seq(0x13a, i0  => ([f6, f7, f7, f7, f6]))) :: (v1) := (f9)).cf49 :: (v0) := (f6)) else map[[f6] := f6] + (map v2 : seq<int> | v2 in {seq(-962, i1  => (f7))} :: (v2) := (0x127))
	}
	function fm0(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<bool, bool>> {
		...
		if (!(p1 <= p1) ==> v1) {
			...
			match (v3) {
				case DC14(cf28, cf29) =>
					...
					var v7 := 'p';
					var v8: seq<string> := [v0[876], f11, v0[876], f11, f11];
					var v9: set<bool> := {v5 >= v5[false := f6], fm53((seq(0xbc, i1  => ('w')))[|v6[cf28 := cf28]| := v7], 0x20d, v1, cf28, globalState) !in v8[cf29]};
					cf29 := |v9|;
				...
				case DC13(cf27) =>
					...
					var v13: array<T2> := new T2[25] [v11, v12[-v11.f7], v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11];
					v13[640] := v11;
					var v14 := 0x3ad;
					v13[640], v14, v14 := v11, |f11|, -(v11.f7 % (v11.f6 % v11.f6));
					v1 := v1 <== v1;
					var v15: seq<array<int>> := [cf27];
					var v16: array<array<int>> := new array<int>[25] [cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, cf27, v15[f7], cf27, cf27];
					v16 := v16;
					cf27 := new int[8];
				case DC15(cf30) =>
					var v17 := 0x331;
					...
					v22 := v22;
					v1 := v1;
					var v23: map<map<bool, bool>, int> := map[fm64(v1, |v0[876]|, globalState) := --|[f6, v17]|];
					var v24 := 'q';
					var v25: multiset<char> := multiset{v24, v24};
					var v26: array<int> := new int[1];
					var v27: seq<array<int>> := [v26, v26, v26];
					var v28: array<array<int>> := new array<int>[15] [v26, v26, v26, v26, v26, v26, v26, v26, v26, v26, v27[v17], v26, v26, v26, v26];
					var v29 := DC13(v26);
					v28[287] := v29.cf27;
					v23, v25, v28[287] := v23, v25, v29.cf27;
			}
			...
			var v38: array<bool> := new bool[27] [true, f9, v1, f9, !f9 <==> v1, v1, v1, v1, false, !fm2(|p0|, f8[f7], globalState), if (f9) then f9 else v1, multiset{v31} <= multiset([set v33 : int | v33 in v32 :: (v33 / 97)]), f9, f9, v1, f9, !!(v35 >= v35), false, v1, fm57(if (v1 in v37) then v37[v1] else v36, 'f', v1, globalState), !f9, true, f9, v1, f9, f9, f8[892]];
			var v39 := 'f';
			...
			var v58: array<int> := new int[14](i3 => i3 / p1);
			v58[588] := 0x3a;
			var v59: array<bool> := new bool[15];
			v59[924] := v1;
			var v60 := DC9(multiset{f7});
			v59[642] := if (!f9) then v1 else v1;
			var v61: seq<D2> := [v48];
			var v62: multiset<int> := multiset{|(seq(0x340, i4  => ('n')))|, f7, |"e"|, f7, p1};
			v58[588], v59[924], v60, v59[642] := fm69(v61, globalState), 'j' in (if (f9) then f11 else f11), DC9(v62), f9;
		}
		
		var v63: array<bool> := new bool[21](i5 => f9);
		var v64: multiset<int> := multiset{0x13};
		var v65: seq<multiset<int>> := [v64, v64];
		var v66: map<array<bool>, multiset<int>> := map[v63 := v65[p1]];
		var v67: map<bool, map<array<bool>, multiset<int>>> := map[true := v66[v63 := v64]];
		v67 := v67[v1 := v66];
		if (false) {
			var v68: multiset<seq<bool>> := multiset{f8[p1 := v1], f8, f8, f8};
			v1 := v68 > (v68 * v68);
			var v69 := -944;
			v69 := f7;
			var v70: seq<string> := [seq(0x2cd, i7  => ('h'))];
			v1 := (f11 + (seq(322, i6  => ('a')))) != (v70[f6])[|f11| := 'k'];
			...
			if (!v1) {
				...
				var v74 := new C2(v69, f8, p1, f6 % -f6);
				...
				var v86 := DC3(v85[f6]);
				var v87 := 't';
				v69, v1, v69, v79[726], v86 := -(p1 * p1), f8[497], -|p0[v1 := v87 in "bytu"]|, f6, v86;
				v69 := v79[726];
				v1 := !f9;
				v79[726] := f6;
				v79[726] := v79[726];
			...
			v63[871] := f9;
			v91, v63[871] := v91 + [p1, f7, p1], false;
			var v92: array<int> := new int[1](i8 => i8 + |map[0x269 := seq(0x193, i9  => ('o'))]|);
			f10 := f10[v92 := v63[871]];
			var v93: multiset<bool> := multiset{v1, !v90};
			v63[871], v1 := |(seq(-276, i10  => (|f11|)))| == f6, v93 !! (v93 + v93);
			var v94 := 917;
			v94 := (p1 - v94) + p1;
		}
	...
	method m3(p0: string, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v4 := 'r';
		for i0 := if (fm57(v3, v4, f9, globalState)) then f6 else -0x19f to f6 / p2 {
			r0 := -(f7 + p2);
			var v5: map<bool, seq<int>> := map[f8[|f11|] := [p3, f6, p2, p2]];
			v3 := v3[|v5| := !p1 && f9];
			if (f9) {
				var v6 := new C4(f9, f10, f8, f6, -(0x27f % |[0x1f5]|));
				var v7: array<array<int>> := new array<int>[7];
				v7 := v7;
				var v8: set<int> := {f6, 0x2a6};
				r0 := |v8|;
				var v9: set<bool> := {f9 <==> true};
				v9 := {f9, (seq(0x2b5, i1  => (v4))) == f11, v4 in p0, f9};
				...
				var v14: map<bool, string> := map[p1 := f11[|map[!p1 := f9]| := v4]];
				v11[218], r1, v12 := fm2(|v13|, f9, globalState), (p2 !in [|(if (p1 in v14) then v14[p1] else f11)|, p2]) <== p1, (("fovifcc")[-(f6 - -492) := if (fm2(i0, f9, globalState)) then v12[i0] else v4])[f6 := v4];
				v0[589] := p3;
				v0[589] := p3;
				v0[589] := f7;
				r0 := f7;
			...
			var v16 := DC7(v15);
			r0 := 0x1b7 / fm69([v16, DC7(v15), fm71(f9, globalState)], globalState);
		}
		r1 := p1;
		if (p3 == f6) {
			var v17: multiset<bool> := multiset{p1};
			...
			var v25: map<int, int> := map[|v24[p3]| := |(seq(-0x350, i3  => (p2)))|];
			v22[413] := if (f8[|v25|]) then v20 else DC12(f6, fm69(v19, globalState), p1, p1, p2);
			var v26: set<bool> := {true, p1};
			v22[413] := fm72(v26 == v26, globalState);
			var v27: seq<string> := [fm62(p1, globalState), "gh"];
			var v28: array<string> := new string[19] [f11 + f11[f6 := v4], p0, p0, f11, fm62(f9, globalState), p0, "yacupl", p0, p0, f11, p0, p0, v27[f7] + p0, f11, fm62(f9, globalState), f11, f11 + f11, f11, "rgchhjhx"];
			v28 := v28;
			r1 := f9;
			r0 := f6;
			var v29 := new C0(f7);
			...
			if (if (p1) then f9 else f9) {
				var v30 := "oifmcpxv";
				v30 := "m";
				var v31: multiset<string> := multiset{seq(0x323, i4  => (v4)), f11 + f11};
				var v32: seq<string> := [f11];
				v31 := multiset((v32 + (seq(-977, i5  => (p0)))) + (v32[f6 := f11])[f6 := p0]);
				...
				v0[619] := DC5(true, v37[|v31|], f9, f8).cf10;
				r0, v36, v0[619], r0 := 100, v36 - fm63(globalState), p2, 0x1da;
				r0 := p3 % p3;
			} else {
			...
			if (false !in f8) {
				...
				var v49: array<string> := new seq<char>[25](i7 => seq(0x3a3, i8  => (v4)));
				...
				v51[340] := v49;
				v47, v48, r0, v51[340] := v47, v48, -|{p3}|, v49;
				...
				var v55 := DC32(v0[141], "lqmekyk", true);
				v4 := fm53(v55.cf55, v0[141], p1, f7, globalState);
				var v56: map<bool, char> := map[p1 := v4];
				v56 := v56;
			} else {
				var v57: array<array<map<D0, char>>> := new array<map<D0, char>>[15];
				var v58: array<map<D0, char>> := new map<D0, char>[1](i9 => map[DC2(seq(0x1e1, i10  => (v4))) := v4]);
				v57[677] := v58;
				v57[677] := new map<D0, char>[19];
			...
			if ((seq(0x58, i11  => (v4))) != v67[f7]) {
				var v68: array<bool> := new bool[10];
				v68 := v68;
				var v69: map<array<bool>, int> := map[v68 := |fm62(f9, globalState)| % f6];
				...
				v0[141], v71, v0[141] := f6, v71[fm69(v65, globalState) := map v72 : D0 | v72 in v76[v73 := v75] :: (v72) := (f9)] + map[f6 := map v77 : D0 | v77 in v70 :: (v77) := (f9)], -(p3 - p3);
				v0[141] := f6 - p3;
				var v78: seq<int> := [f7];
				var v79: set<int> := {v78[0x2cb], f7};
				var v80 := DC19(v79);
				var v81 := DC12(|p0|, |v80.cf37|, p1, if (f6 in v3) then v3[f6] else p1, v0[141]);
				r0 := v81.cf26;
			} else {
				m0(globalState);
				var v82: map<bool, bool> := map[p1 := f9];
				v82 := v82[f9 := !fm57(v3, v4, p1, globalState)];
				var v83: map<int, int> := map[754 := v0[141]];
				...
				v86[119], v88, v89, v90[907] := if (p1) then v85 else v85, v88.(cf15 := v87), if (f7 in v93) then v93[f7] else v89, v92 * v92;
				r1 := p1;
		...
		r0 := p2;
		var i13 := 0;
		while (((seq(-520, i14  => (v4))) + "vevxak") <= (p0[|"uxqm"| := fm53(f11, 0x334, false, f6, globalState)])[p3 := v4])
			decreases 100 - i13
		{
			if (i13 >= 100) {
				break;
		...
		r0 := -(fm69(v97, globalState) - f7) + |v98[p2]|;
		r1 := p1;
	}
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		var v0 := 'a';
			...
			decreases 100 - i0
		{
			...
			var v3 := DC7(v2[false := fm69(seq(0x3af, i1  => (DC7(v2))), globalState)]);
			var v4: seq<D2> := [v3];
			...
			match (v7) {
				...
				case DC28(cf49) =>
					...
					var v14 := 261;
					v14 := f6;
					var v15 := new C1(v14 % -v14, f9);
					var v16: array<bool> := new bool[14];
					v16[537] := true;
					var v17 := DC14(-|f11[v14 := v0]|, f6);
					...
					v16[537], v18, v19[30] := (v15.f27 in fm56(true, f9, v15.f27, globalState)) !in v20, v18, f6 + v15.fm34(f9, globalState);
			}
		...
		var v30: array<seq<bool>> := new seq<bool>[24] [v26, v26, f8, v26, f8, f8, f8, f8, fm56(f9, f9, f9, globalState), f8, f8, v26, f8, f8, f8, f8, v26[-977 := v29.cf62], (v26[|"qr"| := f9])[|v28| := f9], v26, [f9, f9], f8, [f9], f8, f8];
		...
		v26, v31[260], v32, r0, v33 := v26 + v26, v34[if (f9) then f7 else f7], fm62(if (f6 in v38) then v38[f6] else f9, globalState), fm57(v38, v0, false, globalState), v33;
		var v39 := 635;
		v39 := v39;
		var v40: map<int, int> := map[|v32| := f7];
		var v41: multiset<map<bool, bool>> := multiset{v36, v35[f9 := f9]};
		v40 := v40[v39 % |v41| := 0x2fc];
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		if (f8[if (p1) then |v0| else |(map v2 : int | (0xe4 <= v2) && (v2 < 547) :: (v2 + f6) := (p1))|]) {
			...
			var v10 := 'k';
			v10 := p0;
			var v11: map<char, string> := map[v10 := f11 + (seq(-0x1c8, i0  => (p0)))];
			v11 := v11[DC23(v10).cf45 := seq(0xec, i1  => (p0))];
			var v12 := 0xc4;
			v12 := f6;
			...
			v9, globalState.f1, v12, v13[946] := f8, [v15], v12, v14;
		}
		
		var v16 := 0x33;
		v16 := -(v16 * (f6 % f6));
		var v17 := "htovn";
		v17 := (seq(0x212, i4  => (p0))) + f11;
		var v18 := true;
		v18 := f9;
		var v19: map<bool, int> := map[v18 := f6];
		var v20: seq<int> := [f6, f7, f7];
		for i5 := if (false in v19) then v19[false] else f7 to -(f6 % -v20[f6]) {
			var v21 := DC12(f7, v20[f7], v18, false, f6);
			v16 := v16 % (v21.cf23 - |f8|);
			v18 := (v20 + v20)[|v19| := i5] == (v20 + v20);
			var v22 := new C2(|{v16}|, ([f9, f9, v18])[v16 := f9] + f8, v16, |(f11 + "f")|);
			v16 := v22.f29;
		}
		v16 := v16;
	}
	method m22(p0: bool, p1: map<set<bool>, bool>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		var v0: array<string> := new string[18] [f11, f11, seq(0xf2, i0  => ('y')), f11, fm62(false, globalState), seq(0x256, i1  => (DC23(DC23('a').cf45).cf45)), f11, f11, "xfqk", fm62(false, globalState), f11, f11, f11, f11, f11, "axif", f11, f11 + (seq(-0xf1, i2  => ('j')))];
		v0[501] := f11;
		v0[501] := (f11 + "qxwfe") + f11;
		var v1: map<bool, int> := map[p0 := f7];
		var v2: map<int, bool> := map[f6 := false];
		var v3: array<map<bool, int>> := new map<bool, int>[10] [v1 + v1, v1[p2 := f6], (map[p0 := f7])[if (f7 in v2) then v2[f7] else f8[0x2] := f6], v1 + map[false := f7], v1, v1, map[p3 := f7], v1, v1, v1];
		v3[20] := v1;
		var v4 := DC17(p3, "ecfmupch");
		var v5: array<D5> := new D5[14] [v4, v4, v4, v4, v4, v4, v4, v4, fm75(globalState), v4, v4, v4.(cf32 := p3), v4, v4.(cf32 := !!p0)];
		v5[603] := v4;
		v3[20], r0, v5[603] := v1[f9 := f6], p0 <==> f9, v4;
		var v6: multiset<bool> := multiset{p0};
		var v7: seq<D2> := [DC7(v6)];
		var v8: multiset<int> := multiset{f7};
		var v9: array<int> := new int[6] [f7 % |[p3]|, fm69(v7, globalState) % |v8|, f6, f6, f7, f6];
		forall i3 | 0 <= i3 < v9.Length {
			v9[i3] := i3 / -f7;
		}
		forall i4 | 0 <= i4 < v3.Length {
			v3[i4] := if (v8 !! v8) then v3[20] else v3[20];
		}
		v9 := v9;
		var i5 := 0;
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v10: T2 := new C4(p0, f10, ([p2, p0, p3])[|(seq(0x2a9, i6  => (f6)))| := !p0] + f8, f6, f7);
			v10 := v10;
			...
			v9[882] := 0x3dc / (f6 + f7);
			var v12 := DC33(v9[882]);
			var v13 := new C3(0x117 + f6, |f11|, v10.f6 / f6, -(f6 + v12.cf57));
		}
		r0 := f9;
	}
}
...
class C6 extends T0 {
	...
	function fm28(p0: string, p1: bool, globalState: GlobalState): set<int> {
		set v0 : int | (0x362 <= v0) && (v0 < -0x30e) :: (v0 % f6)
	}
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
			...
			decreases 100 - i2
		{
			...
			var v22 := "kvg";
			var v23: array<int> := new int[19] [-f6, |(v15 + (map[f22 := f7])[f22 := f7])|, -f6, -f7, if (f22) then f6 else f6, f6, 0x25b, f6, (if (0x142 in v16) then v16[0x142] else f6) / -f6, |v19|, v21.cf19, f7, |v22|, |(if (true) then v18[f6 := 0x394] else v17)|, f7, fm31(globalState) * f7, f7, f6, f7];
			v23[739] := -f6;
			v23[739] := f7;
			r0 := f22;
			var v24 := new C3(f7, if (f22) then v23[739] else -v23[739], f6, if (f22 in v15) then v15[f22] else v23[739]);
			var v25 := DC19(p0);
		...
		r0 := f22;
		var v32 := DC24([f7]);
		r1 := fm36(v31.f26, v32.cf46 <= fm40(f22, globalState), |v28| % f6, globalState);
		r2 := v8;
	}
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			var v16: T3 := new C5("ou", p1, v12, [f22], --(f7 - |v15|), f7 / f6);
			var v17: map<int, multiset<string>> := map[fm45(f22, v9.(cf7 := v8), globalState) := multiset{v0, v16.f11[v16.f6 := p0], v0}];
			var v18: multiset<string> := multiset{"m", "mtwiop", seq(0x22b, i1  => (p0)), v0};
			var v19: map<bool, T3> := map[false := v16];
			var v20: seq<T3> := [v16, if (!!f22 in v19) then v19[!!f22] else v16, v16];
			v16 := if ((if (f7 in v17) then v17[f7] else v18) !! v18) then v20[v16.f6] else v16;
		}
		var v21 := 0x8a;
		v21 := f7 * f7;
		...
		if (true) {
			...
			v23 := v23[multiset([|(seq(0x230, i3  => (p0)))|, 0x24a]) > v25[v21] := 0x3d0];
			v21 := f6;
			var v26: map<char, char> := map[p0 := p0];
			var v27 := "ogf";
			var v28 := DC23(v27[v21]);
			v26 := v26[p0 := v28.cf45];
			if (f22) {
				...
				v29[401], v30, v21 := p1, (if (p1) then f7 else f6) != |(map v31 : int | v31 in v24 :: (v31 * f6) := (v21))[f6 := |v32|]|, fm31(globalState);
				var v33: map<int, bool> := map[f6 := f22];
				v33 := v33[f6 := false];
				var v34 := DC3(DC0(v21));
				var v35: set<D0> := {v34};
				var v36 := DC1(true, v29[401], p1, v30, f22);
				...
				var v40: map<array<bool>, string> := map[if (p1) then v39 else v39 := seq(0x2b7, i4  => (p0))];
				v40 := v40[v39 := v27 + v27];
				...
				v41 := if (f6 in v44) then v44[f6] else if (!f22) then v48[fm31(globalState)] else {v27};
				v21 := 0x3e2;
				var v49 := false;
				v49 := v49;
			...
			match (v60) {
				case DC14(cf28, cf29) =>
					...
					v55, v55, v55, cf28, v71 := fm35(if (p1 in v72) then v72[p1] else v65, globalState), p1, v73.cf54 > (f7 / -0x238), (cf29 / |v74|) + cf29, v71;
				case DC13(cf27) =>
					v22[354] := v21 * (if (!f22 in v57) then v57[!f22] else f6);
					v22[354] := (if (v55) then f6 else f6) - (f7 + f6);
				...
				case DC15(cf30) =>
					...
					v78[785] := p1;
					var v79: seq<int> := [v21];
					var v80: C1 := new C1(v79[f6], v78[785]);
					v80 := v80;
					...
					var v86: seq<seq<int>> := [v79 + v81.cf46, v79[fm31(globalState) := if (|v85| in v83) then v83[|v85|] else -v80.f26], v79, v79, (seq(948, i9  => (|v52|))) + v79];
					v86 := seq(0x38f, i10  => (seq(0x1b7, i11  => (-0x305))));
			}
			...
			var v89 := "udhvxwov";
			var v90 := DC2(v89);
			var v91 := new C2(v21, v87 + v87, f7 % |v88|, f7 % |v90.cf6|);
		}
		...
		match (v97) {
			case DC37(cf61, cf62, cf63, cf64) =>
				...
				var v103: map<int, map<int, int>> := map[|v100| := map v101 : int | v101 in v102 :: (v101 % |(seq(0x1b2, i12  => (seq(0xe3, i13  => (f6)))))|) := (cf63)];
				cf61[801] := (map v98 : int | v98 in v99 :: (v98 - cf63) := (cf63)) == (if (cf64 in v103) then v103[cf64] else v102);
				v100 := v100;
				var v104: array<string> := new string[13](i14 => if (DC8(DC0(|map[cf62 := f22]|), f22).cf16) then v100 else "nghfs");
				v22, v104, v21 := v22, if (true) then v104 else v104, (cf64 / cf64) * (v21 / v21);
				v21 := (cf63 - f7) + cf64;
			case DC38() =>
			...
			case DC36(cf60) =>
				...
				var v114 := "recapii";
				v21 := -(|(v114 + v114)| % (|v113| + v21));
				var v115: seq<bool> := [false, f22, f22, v112, v112];
				v112, v112, v112 := if (p1) then !(v115 != v115) else false, fm35(((if (f22) then v114 else v114)[f7 := p0])[v21 := p0], globalState), v112;
			case DC39(cf65) =>
				...
				match (v117) {
					case DC24(cf46) =>
						...
						var v121 := new C4(if (f22) then !!true else f22, v118, [p1, fm46(f22, globalState)], |v120| / f7, -|"lwehuwjd"|);
						var v122 := new C0(v21);
						var v125: seq<char> := [p0];
						var v126 := new C3(f6, -0x2 / |(map v123 : char | v123 in (map v124 : char | v124 in v125 :: (v124) := ({|multiset{f6, f6}|})) :: (v123) := (p1))|, v21, v21 + v122.f28);
						v22[400] := v21;
						v22[400] := -v21;
				}
				...
				if (v127) {
					...
					v129 := v129;
					v92[139] := if (f22) then f22 else p1;
					var v130: array<array<bool>> := new array<bool>[14];
					var v131: map<bool, array<array<bool>>> := map[v127 := v130];
					v92[139], v130 := v127, if ((v129[v128 := f7] >= v129) in v131) then v131[v129[v128 := f7] >= v129] else v130;
					var v132 := DC33(f7 / f6);
					var v133: C1 := new C1(v21, v127);
					var v134: seq<C1> := [v133, v133, v133, v133, v133];
					var v135: array<C1> := new C1[15] [v133, v133, v133, v134[v133.f26], v133, v133, v133, v133, v133, v133, v133, v133, v133, v133, v133];
					var v136: set<array<C1>> := {v135};
					v92[139], v132, v22 := (v136 * {v135}) > (if (v127) then v136 else v136), v132, v22;
					...
					v147, v21, v139, v139 := multiset{v146, v148[v138.f25], v146} + v147[v146 := v138.f25], v138.f24, v139 + v139, v139;
					var v149: map<array<int>, bool> := map[v22 := v127];
					var v150: map<int, string> := map[v138.f25 / |v149| := v139];
				...
				var v153: array<string> := new string[21] [v151, v151, v151[-v21 := 'x'], v151, v151, v151, v151, "espmfrlif", v151, v151, v151, v151[f7 := p0], fm44(p0, globalState), v151, v151, fm42(p1, globalState), (seq(0xc1, i15  => (p0))) + v151, v151, v151[|v152| := p0], "x", fm44(p0, globalState)];
				v153[520] := v151;
				v153[520] := v151 + v151;
		}
	...
	method m17(globalState: GlobalState) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := (map[DC18(f7, f22, |"mn"|).cf34 := 't'] + (map v1 : int | v1 in map[f7 := f6] :: (v1 % 31) := ('a'))) + map[f6 := 'i'];
		}
		var v2: seq<bool> := [false, true];
		var v3: seq<bool> := [f22, !v2[f6], false];
		var v4 := new C0(|v3|);
		var v5 := "vnshysc";
		var v6 := DC33(|v5|);
		match (DC34(v6)) {
			case DC32(cf54, cf55, cf56) =>
				...
				v8 := v8[v7 := v4.f28 / v4.f28];
				var v9: array<int> := new int[18];
				var v10: map<array<int>, bool> := map[v9 := f22];
				var v11 := 'k';
				var v12: C4 := new C4(cf56, v10, v3 + DC5(f22, cf54, f22, v2).cf12, |("sgpm")[cf54 := v11]|, f7);
				v12 := v12;
			...
			case DC33(cf57) =>
				...
				if (v3[|v5|]) {
					...
					v15[605] := -(v16.(cf57 := |(map v17 : int | v17 in v18 :: (v17 * |v3|) := (f7))|)).cf57;
					var v19: seq<string> := [fm42(f22, globalState)];
					var v20 := 'v';
					v5, v14, v5, v15[605] := v5 + (v19[|[v5, "mmta"]|] + v5), v14 - (v14 + multiset{v4.f28}), v5 + fm44(v20, globalState), f6 * f7;
					var v21 := true;
					v21 := v21;
					...
					v26 := ((map v27 : map<int, char> | v27 in (seq(0x2dd, i1  => (map[0x319 := v25]))) :: (v27) := (v5[f6])) + v26) + (map v28 : map<int, char> | v28 in v30 :: (v28) := (v25));
				...
				v32[614] := v33;
				cf57, cf57, v32[614] := v4.f28, -f6 * v4.f28, if (f22) then v33 else map[f22 := "mpytmx"];
			case DC31(cf53) =>
				...
				var v39: array<array<string>> := new array<string>[7] [v37, v37, v37, v37, v38[f6], v37, v37];
				v39[225] := v37;
				v39[225] := v37;
				var v40 := false;
				...
				var v48: array<seq<map<bool, int>>> := new seq<map<bool, int>>[12] [seq(0x91, i3  => (map[f22 := f7])), v47, v47, v47, v47 + v47, v47, [v46], v47, v47, [v46], v47, v47];
				v48[838] := v47;
				v48[838] := v47;
			case DC34(cf58) =>
				var v49 := 0x182;
				var v50: map<bool, string> := map[!f22 := seq(34, i4  => (DC23('k').cf45))];
				var v51: multiset<bool> := multiset{(if (f22 in v50) then v50[f22] else v5) < (seq(-836, i5  => ('y'))), f22, if (f22) then f22 else f22, f6 <= v4.f28, f22};
				var v52 := DC29(f6, f22);
				v49 := -(if (f22 in v51) then v51[f22] else v52.cf50);
				var v53: map<int, seq<bool>> := map[-v4.f28 := v3];
				if (!(((if (377 in v53) then v53[377] else v3) + v3) == v2[f6 := f22])) {
					v49 := v49;
					var v54 := false;
					var v55 := 'e';
				...
				v63 := v63[f6 := -|v65[|([v4.f28])[f6 := |v67|]|]| * v4.f28];
				...
				match (v70) {
					...
					case DC38() =>
						...
						var v75: map<char, array<bool>> := map[v73 := v69[|v74|]];
						var v76 := DC4(v68);
					...
					case DC36(cf60) =>
						...
						v79, v80, v5, v79 := v49 < v4.f28, v80, v81[|(v5 + v5)|], v79 || f22;
						var v82: array<D0> := new D0[13];
						var v83: array<int> := new int[13];
						v83[640] := v4.f28;
						var v84: set<bool> := {f22};
						v79, v82, v79, v83[640] := v79 <==> (v84 != v84), v82, f22, f7;
						var v85 := DC0(v83[640]);
						var v86: map<D2, string> := map[DC8(v85, !f22) := seq(-0x215, i8  => (v80))];
		...
		for i10 := |v5| to v4.f28 + f7 {
			...
			var v92 := true;
			v91, v92 := -f6, v92;
			var v94: multiset<int> := multiset{|(map v93 : int | (0x33d <= v93) && (v93 < 0x9f) :: (v93 / f7) := (f22))|, v4.f28};
			var v95: set<int> := {f7};
			...
			v98[712] := if (v92) then 0x23 else v91;
			v97, v92, v92, v98[712], v5 := v97, v92, if (DC11(i10, v4.f28, f22, v91).cf20) then false else v92, -fm31(globalState), fm62(f22, globalState);
			if (f6 < v91) {
				v98[712] := -f6;
				var v99: map<bool, bool> := map[v92 <== v92 := v92];
				v99 := v99[v92 := v92] + v99;
				var v100: multiset<bool> := multiset{f22, v92};
				v98[712] := (if (!v92 in v100) then v100[!v92] else if (f22 in v100) then v100[f22] else 0x3b9) / -v4.f28;
			...
			var v114 := new C5(v105[f6], if (v94 in v109) then v109[v94] else false, v110 + v110, v2, v4.f28, |v113|);
		}
			...
			decreases 100 - i11
		{
			...
			v127, v128[580], v129, v119, v122[999] := v127, v122, fm76(globalState), if (v119) then v119 else v119 && f22, v132 <= v132;
		}
		var v133: set<int> := {f6};
		var v134 := DC19(v133);
		match (v134) {
			case DC19(cf37) =>
				...
				v135, v136, v135 := false, v137[|fm65(v4.f28, globalState)| - 0xee], true;
				var v138: array<int> := new int[7](i13 => i13 % v4.f28);
				v138[625] := f6;
				v138[625] := v4.f28;
				v135 := v135;
				var v139: map<bool, int> := map[f22 := v137[f7]];
...
class C7 {
	...
	method m15(p0: int, p1: int, globalState: GlobalState) returns (r0: int, r1: char, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			v6[311] := fm27(p1, p0, -0x1fe, f21, globalState);
			var v7 := DC0(p0);
			v6[311] := DC3(v7);
			r0 := p1;
			var v8 := "wdhfyfud";
		...
		if ((map v9 : int | v9 in v11.cf38 :: (v9 / p1) := ([!f21])) == v13) {
			var v14 := "xmemttg";
			r2 := (v14 == v14) && true;
			var v15 := 'r';
			var v16: set<char> := {v15};
			var v17: seq<set<char>> := [v16];
			var v18: T0 := new C6(!f21, v17[|v14|], 99, -0x15b);
			v18 := v18;
			...
			var v24: array<string> := new string[6] [v22, v22, v22, v22, v22 + v22, v23[p1]];
			v24[292] := v22 + "io";
			v24[292] := "t";
		...
		for i1 := |(v1 + v1)| to |(v37 + (set v38 : seq<int> | v38 in v37 :: (v38)))| {
			...
			if (p1 < 697) {
				...
				var v41: set<int> := {p0};
				var v42: map<int, array<bool>> := map[v36[|v41|] := v32];
				v40[315] := if (|v10| in v42) then v42[|v10|] else v32;
				v40[315] := v32;
				r0 := |(v36[i1 := p0] + v34)|;
				r2 := f21;
			} else {
				r0, r0, r0 := p0 * p1, i1, (-0xe5 % p1) * p0;
				var v43 := DC33(p0);
				r0 := if (f21) then |(map[i1 := v43])[p1 := DC33(|v35|)]| else |"oij"|;
				var v44 := "uhjdddu";
				var v45 := 'x';
				v44 := (v44 + (v44 + v44))[p0 := v45];
				r2 := f21;
				var v46: multiset<seq<int>> := multiset{v34, [i1]};
				var v47 := DC36(v33[|v46| := v32]);
		...
		if (true) {
			...
			if (fm30(f21 ==> f21, v57, globalState)) {
				r0 := ((if (f21 in v0) then v0[f21] else p1) % p1) % p1;
				var v58 := "p";
				var v59: map<int, string> := map[0x3c5 := v58];
				r0 := |(if (v12[p0]) then v58 else if (-p0 in v59) then v59[-p0] else v58)|;
				r2 := f21;
				...
				v60[69], v58 := if (p1 in v62) then v62[p1] else v61, v58 + ((seq(-0x7, i4  => ('b'))) + v58);
				...
				var v66 := 't';
				r2, r0, r2 := f21, v65.cf19, false && fm35(("ytslo")[p0 := v66], globalState);
				r0 := p1;
				m0(globalState);
			}
			...
			var v78: set<array<D13>> := {v76, v76, v77[p0], v76, v76};
			var v79 := DC0(|[f21]|);
			var v80 := DC3(v79);
			...
			var v83 := DC3(v80);
			var v85: multiset<set<int>> := multiset{set v84 : int | (207 <= v84) && (v84 < 0x307) :: (v84 / p1)};
			r2 := !(multiset(v82[fm45(f21, v83, globalState) := v81]) !! v85);
			var v86 := 'g';
			...
			if (v93 >= fm79(v89.f22, v89.f22, globalState)) {
				...
				v95 := v95[v96 := |v94|];
				v86 := v94[v92.f28 / v92.f28];
				var v97: array<int> := new int[1];
				v97[981] := v92.f28;
				v97[981] := if (!true) then p1 else p1;
				var v98: map<string, int> := map[v94 := v92.f28];
				r0 := if ((v94 + v94) in v98) then v98[v94 + v94] else v97[981];
				v97 := v97;
			} else {
				r0 := p0;
				r0 := p1 % (|v12| - v92.f28);
				...
				v99[864] := v92.f28 * v100.cf19;
				v99[864] := v92.f28;
				var v101 := "xwqsanu";
				var v102: map<int, string> := map[v92.f28 := v101];
				var v103 := new C1(|v102| / v99[864], v35 < v35);
				var v104: map<int, int> := map[v103.f26 := p1];
				v104 := v104[|v101| := p1 + v99[864]];
			}
	...
	method m16(p0: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		for i0 := |(if (!f21) then v0 else v0)| to p0 {
			var v1: seq<int> := [i0];
			var v2: C0 := new C0(v1[p0]);
			var v3 := DC41(f21, !f21, |[v2, v2]|, i0);
			var v4: seq<int> := [(v3.(cf67 := !f21)).cf69, i0 % v3.cf70];
			v1 := seq(0xd5, i1  => (-v2.f28));
			var v5: seq<bool> := [f21];
			var v6: array<int> := new int[9] [p0, |v5|, i0, p0, p0, i0, v4[v2.f28], p0, v2.f28];
			var v7: map<array<int>, bool> := map[v6 := !!f21];
			var v8 := "hkg";
			var v9 := new C4(f21, v7, v5[|v8| := true], v2.f28, p0 * v1[p0]);
			var v10 := 'e';
		...
		var v19 := "ln";
		if (if (((seq(0x1ec, i2  => ('w'))) == v19) in v18) then v18[(seq(0x1ec, i2  => ('w'))) == v19] else f21) {
			var v20: multiset<int> := multiset{v17.f29};
			var v21: array<int> := new int[22];
			var v22: map<array<int>, bool> := map[v21 := f21];
			var v23 := new C5(v19, |map[f21 := v17.f29]| in v20, v22, v13 + v13, v17.f29 % 0x1d5, p0 / -v17.f29);
			var v24: T0 := new C3(|"jxvl"| / v17.f29, v17.f29, v17.f29, v17.f29 * -0xe6);
			v24 := v24;
			r1 := f21;
			...
			v27.f29 := (p0 % fm31(globalState)) - (v17.f29 + v27.f29);
		} else {
			v19 := v19 + v19;
			r1 := f21;
			v19 := "xv";
			...
			match (v32) {
				...
				case DC28(cf49) =>
					...
					v19, r1, v39, v40 := v19[v17.f29 * v17.f29 := v28], f21, if (true) then v39 else v39, if (f21 <== f21) then v40 else v40;
					v40 := v40 + map[fm53(v19, |multiset([p0])|, f21, v17.f29, globalState) := f21];
					var v41: array<int> := new int[24](i4 => i4 * v17.f29);
					v41[267] := v17.f29 % v17.f29;
					v41[7] := if (f21) then |v40| else 0x186;
					var v42 := DC1(fm46(f21, globalState), f21, f21, true, f21);
					var v43 := DC11(v17.f29, -v17.f29, f21, |v13|);
					v41, r1, r1, v41[267], v41[7] := v41, v42.cf5, !v43.cf20, |(v13 + ([f21, f21, f21, f21] + v13))|, -(v17.f29 / v17.f29);
			...
			decreases 100 - i5
		{
			...
			var v52: map<string, multiset<int>> := map[v51[v17.f29] := v50];
			v50 := if (v19 in v52) then v52[v19] else v50;
			r1 := fm35(v19, globalState);
			var v53: multiset<bool> := multiset{f21};
			var v54: multiset<bool> := multiset{fm35(v19, globalState), fm30(v13[v17.f29], v53, globalState)};
			...
			var v60: seq<int> := [p0];
			v55, v56[38], r1, v59 := if (v60 < [p0, p0]) then v55 else v55, fm30(false, v54, globalState), v58 in ("sijhbsnx" + v19), v59;
		}
		...
		var v67: array<int> := new int[14] [0x327, p0, p0, v63[-p0], -v17.f29, v17.f29, p0, p0, p0, v17.f29, |v66|, v17.f29, |v61|, v17.f29];
		...
		var v75: array<int> := new int[29] [0x48, -(p0 % p0), |(multiset{f21, f21} + v61)|, |v19|, 438, v17.f29, v17.f29, v17.f29, |(seq(0x260, i6  => ('t')))|, |v18| - p0, |(map[v67 := |v66|] + v68)|, v17.f29 % p0, v17.f29, -0x376, if (false) then p0 else -v17.f29, if (f21 in v70) then v70[f21] else -v17.f29, p0, p0 - v17.f29, v17.f29, p0, v17.f29, p0, v62[0x1ec] - v17.f29, |(map[!f21 := f21])[f21 := !true]|, v17.f29, v17.f29 / |v19|, |(if (f21) then v19 else v19[|v74| := 'y'])|, -v17.f29, p0];
		v75 := v64;
		v17.f29 := p0 / (342 % |v61|);
		r0 := |v66|;
		r1 := f21;
...
class C8 extends T0 {
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
			...
			decreases 100 - i0
		{
			...
			v12[582], v7, v14, v7, v15 := v13, v16.cf25, v14, v7, -v6.f6;
			var v17: array<string> := new seq<char>[17](i2 => (seq(-0x58, i3  => (v9))) + "hhshtychp");
			var v18 := DC16(v17);
			v17 := v18.cf31;
		...
		if (v20 <= (v20 + v20)) {
			...
			var v36: multiset<seq<bool>> := multiset{v6.f8[f7 := f19], v6.f8, v6.f8};
			var v37 := DC8(DC0(|v0|).(cf0 := v6.f6), v24);
			v28, v7, v20, v34[8], v34[221] := |v35[v20 + "adnet" := 0x33f / |(seq(477, i5  => ('q')))|]|, v36 !! (v36 - v36), v20, v7, v37.cf16;
			...
			match (if (f19) then v39 else v39) {
				case DC10() =>
					var v40 := -0x317;
					v40 := (v6.f7 / v6.f7) * v6.f6;
					var v41: array<int> := new int[10];
					v41[665] := if (v7) then f7 else f6;
					v41[665] := v6.f6;
					var v42 := DC8(v3.(cf0 := v6.f6), true);
					v5 := fm24(v6.f6 % v6.f6, v42.cf16 <==> v7, f19 || f19, {f19, f19, v7} !! {v7, f19}, globalState);
					v41[665] := f7 + v6.f7;
				case DC11(cf18, cf19, cf20, cf21) =>
				...
				case DC12(cf22, cf23, cf24, cf25, cf26) =>
					...
					v46[232] := fm22(f6, v6.f8[f7], globalState);
					v46[232] := v7;
					...
					v49 := v49;
				case DC9(cf17) =>
					var v50: map<bool, multiset<int>> := map[f19 := (multiset{f6})[|v20| := v6.f7]];
					var v51 := new C2(-|v20|, v6.f8, v6.f7, |(if (f19 in v50) then v50[f19] else cf17)| / v6.f7);
					v21[353] := if (v7) then v20 else seq(-0x93, i8  => ('f'));
			...
			if (true) {
				...
				var v57 := new C4(v7 <== v7, v56[v55 := v7], v6.f8, f6 / 0x249, --(v6.f6 * v6.f7));
				var v58 := 279;
				v58 := v6.f6;
				v58 := -0x125;
		...
		match (v77) {
			...
			case DC13(cf27) =>
				if (v7) {
					...
					var v95: array<bool> := new bool[29] [false, !f19, f19, v7, 37 < (if (v6.f7 in v91) then v91[v6.f7] else v6.f6), v7, v7, !f19, !(fm30(true, multiset(v6.f8), globalState) ==> v7), v7, !(v6.f7 < |v2|), v7, !(v6.f8[v6.f6] <== v7), f19 <==> v7, f19, f19, v92 >= v92, v7, v6.f6 < v6.f6, !!f19 in v93, p0 >= p0, f19, v94 > v94, v7, f19, v7, f19, v7, if (v7) then v7 else f19];
					v95[764] := f19;
					v95[764] := !!true;
					var v96 := 0x30e;
					v96 := v6.f6;
					...
					r0 := v92 >= (multiset(v99))[-v6.f6 := v6.f6];
					v96 := f6;
				} else {
					var v100: map<string, int> := map[seq(162, i9  => ('q')) := f7 - v6.f7];
					v100 := v100[seq(161, i10  => ('y')) := v6.f6];
					r0 := !false;
			...
			case DC15(cf30) =>
				...
				var v118: seq<int> := [v6.f6, v6.f7, |(if (f19 in v117) then v117[f19] else seq(0x3ce, i12  => ('h')))|, f6, v6.f7];
				...
				var v124: array<bool> := new bool[21] [(set v120 : int | v120 in p0 :: (v120 / 813)) >= p0, if (v7) then v7 else v7, v7, !(f19 && v7), false, !v7, !v7, f19, false, multiset{v7} == v4, !f19, !(if (f19) then v7 else f19), f19, f19, f19, v7, v121 == v122[v6.f6], !false, !(v123 !! {v20}), map[f19 := v7] == v0, DC11(v113, v113, fm46(v7, globalState), f6).cf20];
				v124[751] := f19;
				...
				v113, v124[751], v125[353], v110[621] := v6.f7, DC17(f19, v20).cf32, DC20(v121 + v121), v112.fm54(v118[-196], -|v127| + v6.f7, globalState);
		}
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		var v2: array<string> := new string[16] [v0 + v0, v0, v0, "sfxnt", fm62(p1, globalState), v0 + v0, v0, v0, v0, v0, v1.cf33 + v0, "np", v0 + v0, v0, "clvts", (seq(0x50, i1  => (p0))) + v0];
		forall i0 | 0 <= i0 < v2.Length {
			v2[i0] := seq(-0x3bb, i2  => ('f'));
		}
		for i3 := 393 to f7 {
			var v3 := 0x87;
			v3 := -(f6 * f6) + 0x222;
			if (true) {
				...
				v4[679] := if (f19) then f19 else if (v0 in v8) then v8[v0] else p1;
				v4[679] := f19;
				var v9: array<map<int, seq<bool>>> := new map<int, seq<bool>>[16];
				var v10: seq<bool> := [v4[679], v4[679], true, p1];
				var v11: map<int, seq<bool>> := map[i3 := v10];
				v9[483] := v11;
				v9[483] := map[|"mjcqwpbr"| := v10];
				var v12: array<int> := new int[26];
				v12[614] := |"tqdxuwoj"|;
				v12[614] := -0xb9 + (|v0| % f6);
				var v13: set<bool> := {v10 == v10, f19, v4[679] <== f19, true <==> v4[679]};
				v13 := v13 - v13;
				v4[679] := v4[679];
			} else {
				var v14: array<bool> := new bool[15](i5 => p1);
				v14[299] := f19;
				v14[299] := fm35(v0 + "glcakwwf", globalState);
				v14[299] := true ==> f19;
				v14[299] := f19;
				var v16: seq<bool> := [false, v14[299], p1, v14[299], f19];
				...
				var v25 := DC40(map[p1 := if (v14 in v23) then v23[v14] else v24[v3]]);
				v25 := v25;
			}
			...
			var v30 := new C4(f19, map[v27 := p1] + v28, v29, f6 % v3, f6);
		}
		var v31: seq<int> := [f6, f6];
		var v32: seq<seq<int>> := [v31];
		var v33: map<bool, int> := map[p1 := |v0[f7 := p0]|];
		var v34 := DC43(v32[|[|v33|]|], f19, f19);
		match (v34) {
			...
			case DC42(cf71) =>
				...
				v41, v42, v41, v41 := if (v41) then (if (v31 in v43) then v43[v31] else seq(0x1b3, i7  => (v31[f7]))) == v31 else v0 < (if (p1 in v44) then v44[p1] else "eewmshefj"), v42, cf71.f21, v47 == v47;
				var v48 := 0x1d2;
				var v49: multiset<bool> := multiset{cf71.f21};
				v48 := if (v33[cf71.f21 := |v49|] != v33) then |multiset(v31)| / f7 else f7 % f7;
		}
		...
		var i8 := 0;
		while (({v31[f7]} !! v54) <==> (if (f7 in v55) then v55[f7] else f19))
			decreases 100 - i8
		{
			if (i8 >= 100) {
				break;
			...
			if (f19 <== f19) {
				...
				v61[414] := DC1(f19, f19, p1, fm35(v0, globalState), true);
				v58, v59, v1, v61[414] := v58, DC35(v56), v1, v60;
				var v62 := DC0(-f7);
				var v63: multiset<bool> := multiset{f19, false, p1, f19, f19};
				var v64 := DC7(v63);
				var v65, v66, v67 := m14(v62.(cf0 := f7), v64, -|(v0 + v0)|, -0xff, globalState);
				v0 := ((seq(-0x219, i9  => (p0))) + v0) + v0;
				var v68: array<char> := new char[20];
				v68[602] := 'x';
				v68[602] := fm53(v0 + v0, v65.f6, p1, 0x3de, globalState);
				v66 := !p1;
			} else {
				v55 := v55 + (v55 + v55);
				var v69 := 0x31e;
				...
				var v73: seq<seq<map<bool, bool>>> := [v72 + (seq(-0x203, i10  => (v71))), v72, v72];
				v72 := v73[-(f7 + f6)];
			...
			var v80: array<int> := new int[11] [f7, 0x2ee, v75, |v0|, f7, |v53|, -v75, -(|v76| % f7), v75, fm45(p1, v78, globalState), |(if (v1 in v79) then v79[v1] else v0[v75 := p0])|];
			v80[408] := f6;
			var v81 := true;
			v75, v80[408], v81, v75, v81 := f6, -v75, f19, f6 + |[p0]|, fm46(f19, globalState);
			v52[765] := v54 <= v54;
			...
			v52[765] := v31 == [f7, |v82|, fm31(globalState), |v86|];
		}
		var v87 := 111;
		v87 := f6;
	}
	method m13(p0: seq<char>, p1: array<int>, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: D3, r2: int) {
		if (p2) {
			...
			if (133 > (if (p2 in v1) then v1[p2] else f7)) {
				...
				v3[789] := p2;
				var v4: seq<int> := [616];
				v3[789] := f7 > fm23(-833, p2, -|v4|, |v1|, globalState);
				var v5 := 'o';
				var v6 := DC11(f7, f6, v3[789], f6);
				var v7: map<string, multiset<int>> := map[fm44(p0[v6.cf19], globalState) := multiset{if (v3[789] in v1) then v1[v3[789]] else f6}];
				var v8: multiset<int> := multiset{p3, f7, f7, f6};
				var v9: map<bool, multiset<int>> := map[f19 := if (p0 in v7) then v7[p0] else v8];
				var v10: array<map<bool, multiset<int>>> := new map<bool, multiset<int>>[9] [v9, v9, v9, v9, v9, v9, map[v3[789] := multiset{p3}], (v9[p2 := multiset{v6.cf18}])[p2 := v8[f6 := f6]], v9];
				v10[260] := v9;
				var v11 := DC43(v4, f19, f19);
				var v12: map<array<bool>, char> := map[v3 := v5];
				v3[789], v3[789], v5, v10[260] := false || v11.cf73, false, if (v3 in v12) then v12[v3] else v5, v9;
				v3[789] := |(v0 + {f19, p2})| <= p3;
			} else {
				r0 := p3;
			...
			match (if (if (p2) then fm30(p2, v21, globalState) else true) then v22 else v22) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					var v26 := DC1(cf5, f19, f19, f19, v25[0x380]);
					var v27 := DC3(v26);
					var v28 := DC3(v27);
					var v29 := 'c';
					cf3 := p0 != p0[fm45(true, v28, globalState) := v29];
				...
				case DC2(cf6) =>
					...
					r0 := if (p3 in v34) then v34[p3] else v35[p3];
				...
				case DC3(cf7) =>
					r0 := |p0|;
					var v46: seq<int> := [p3];
					var v48: multiset<int> := multiset{v46[p3], |(map v47 : int | (0x2ac <= v47) && (v47 < 300) :: (v47 / p3) := (p2))|};
					...
					var v54 := false;
					var v55: set<int> := {f7};
					v53[208], v54 := (v55 !! v55) || v51[v52.f29], |v21| != (|[v54, p2, p2, p2, false]| % 451);
			}
			...
			p1[492] := if ({v61, v61, v61, v61} in v63) then v63[{v61, v61, v61, v61}] else f6;
		...
		var v65 := false;
		var v66: map<int, seq<int>> := map[-f7 := (seq(0x13, i1  => (p3)))[f7 := f6]];
		...
		if (if (p2) then f19 else true) {
			...
			var v75: map<bool, seq<set<bool>>> := map[f19 := v73[f6 := {v65, v65, true, true, if (f19 in v74) then v74[f19] else p2}]];
			...
			match (fm52(fm71(f19, globalState), globalState)) {
				...
				case DC11(cf18, cf19, cf20, cf21) =>
					...
					p1[53] := if (!f19) then f6 else if (v80 in v81) then v81[v80] else v83.cf64;
					v80 := v80[--0x100 := f19];
					var v84: multiset<int> := multiset{|v67|, p1[53]};
					var v85: map<int, multiset<int>> := map[p1[53] / |"smfprggym"| := v84];
					v85 := v85[p1[53] := multiset{0x58, f6}];
					var v86 := 'w';
					var v87: map<bool, int> := map[f19 := p1[53]];
					var v88: array<char> := new char[15] [v86, v86, v86, if (false) then v86 else v86, v86, fm53(p0, if (cf20 in v87) then v87[cf20] else cf19, f19, p1[53], globalState), v86, v86, v86, v86, v86, v86, v86, v86, v86];
					var v89 := DC18(p3, v65, f6);
					var v90: multiset<bool> := multiset{v89.cf35, cf20, p2};
					var v91 := DC7(v90);
					var v92: seq<D2> := [v91];
					v88[841] := fm53("kbaourria", fm69(v92, globalState), f19, f7, globalState);
					v88[841] := v86;
				case DC12(cf22, cf23, cf24, cf25, cf26) =>
			...
			v67 := (seq(0x10f, i3  => (p3))) + ([v111.cf22, v67[-0x189]] + v67);
			r0 := p3;
		}
		...
		if (v112 in v113) {
			var v114: set<char> := {'n'};
			var v115 := new C6(!v65, v114 - v114, -p1[511], -f7);
			var v116: array<int> := new int[7];
			v116 := p1;
			p1[511] := f7;
			p1[511] := p3;
			var v117: seq<bool> := [v115.f22];
			p1[511] := |(if (f19) then v117 else v117)|;
		} else {
			...
			var v126 := new C6(p2, v123, p3, if (f7 in v125) then v125[f7] else p1[511]);
			...
			decreases 100 - i5
		{
			...
			var v133: seq<seq<bool>> := [v130, v132[|v112|], v130];
			v131 := v131[false <== false := v132[f7]];
			var v134: map<bool, string> := map[!p2 := p0];
			var v135: map<bool, int> := map[v129[958] := f6];
			var v136 := new C2(f7, fm50(p2, |(if (!v65 in v134) then v134[!v65] else p0)|, p3, globalState), |v135[v65 := f6]|, -749);
		}
		var v137 := 'g';
		r0 := if (v65) then 0x336 else |p0[f6 := v137]|;
		var v138 := DC7(v112);
		r1 := match v138 {
			case DC8(cf15, cf16) => if (!f19) then DC11(v67[f7], f7, true, p3).(cf20 := f19) else DC11(f7, -f6, cf16, p1[511])
			case DC7(cf14) => DC11(p1[511], p1[511], v65, 0x26e)
		};
	...
	method m14(p0: D0, p1: D2, p2: int, p3: int, globalState: GlobalState) returns (r0: T1, r1: bool, r2: map<bool, int>) {
		for i0 := fm31(globalState) to p2 {
			...
			if (v1[v0]) {
				...
				var v10, v11, v12 := m13(v3[f6 := v2], if (fm46(f19, globalState)) then v9 else v9, true, p3, globalState);
				r1 := f19;
				r1 := (v3 != v3) <== f19;
				var v13: array<bool> := new bool[14];
				v13[705] := fm30(f19, v5, globalState);
				v13[705] := f19;
				r1 := v13[705];
			} else {
				...
				var v24 := new C5(v22, v21[20], v17, v1, v18.f29, |(v23 * multiset{v14, v14, v14})|);
			}
		...
		if (match v27 {
			...
			var v35: set<string> := {v33, v33, v33, v34[f6], v33};
			v35 := v35;
			...
			v37 := if (v38 >= v39[f6]) then 'n' else v37;
			...
			r1 := f19;
			var v50: map<bool, int> := map[false := |(seq(0xdc, i2  => (-485)))|];
			var v51 := DC25(v50);
			match (v51) {
				case DC26() =>
					...
					v53 := v53;
					var v54: map<int, int> := map[v49.f25 := 468 - |(seq(-0x362, i3  => (0xd5)))|];
					var v55: multiset<string> := multiset{seq(0x36c, i4  => (v37))};
					v54 := map[f6 := |v55|] + v54;
					r1 := f19;
					var v56 := DC4(v52);
					v52[254] := f19;
					v56, v45, v52[254] := v56, v45, f19;
				case DC25(cf47) =>
					r1 := v44 >= (v44 + v44);
					r1 := f19;
					m0(globalState);
		...
		if (f19) {
			...
			if (fm35("ebivcbe", globalState)) {
				...
				var v77: seq<int> := [v76[f7], v57, v57];
				v75[809] := v77;
				r1, v57, r1, v75[809] := f19, p3, !f19, v77;
				...
				var v83: seq<bool> := [f19, v82[v61.f28], f19, f19];
		...
		var v96: array<int> := new int[8](i11 => i11 % DC29(|[p2]|, f19).cf50);
		...
		match (fm83(if (f6 in v100) then v100[f6] else v101, p2, f6, globalState)) {
			case DC37(cf61, cf62, cf63, cf64) =>
				...
				if (if (true in v105) then v105[true] else f19) {
					...
					v107 := (v107[cf63 := cf62])[cf64 := false] + (v107[|v108| := f19] + [cf62, false, f19, v104.f22]);
					cf61[432] := f19;
					v96[424] := -p2 + p3;
					var v110: seq<D2> := [p1, p1, p1];
					var v111: map<bool, int> := map[v104.f22 := 0x11a];
					var v112: seq<map<bool, int>> := [v111];
					cf61[432], v96[424] := cf62, if (fm69(v110, globalState) != |v112|) then -|v99| else p3 - f6;
					cf61[432] := v104.f22;
					var v113: seq<string> := [v99 + v99, v99 + v99];
					v99, v102 := v113[f7], v102;
					r1 := v107[v108[p2] / f6];
				} else {
					...
					cf64 := v115.cf10;
					var v118: map<set<int>, int> := map[set v117 : int | (0x300 <= v117) && (v117 < 83) :: (v117 % p2) := cf63];
				...
				var v121 := new C0(-p2);
				var v122 := DC32(cf63, seq(-0x2c9, i12  => (v102)), v104.f22);
				var v123 := DC2("hbtppg");
				var v124 := DC3(v123);
				var v125 := DC3(v123);
			...
			case DC38() =>
				...
				var v128 := new C6(v97[355], v127, f7, p3);
				var v129: multiset<array<int>> := multiset{v96, v96, v96, v96, v96};
				var v130: multiset<bool> := multiset{v128.f22, v97[355]};
				var v131: set<multiset<bool>> := {v130};
				v97[355] := (v129 > v129) && (v131 !! v131);
			case DC36(cf60) =>
				...
				v141[909] := v142[v134.f7];
				var v143: seq<int> := [|"x"|];
				v143, v143 := v143, [|(seq(81, i13  => ('b')))|] + v143;
				v97 := v97;
			case DC39(cf65) =>
				var v144 := -0x357;
				v144 := f7;
		...
		var v150: T1 := new C2(f6, v148, -f7, v149[f7]);
		r0 := if (fm49(globalState) >= v147) then v150 else v150;
		var v151 := 'e';
		r1 := v151 in (seq(-0x1e4, i14  => (v99[391])));
...
class C9 {
	...
	method m11(globalState: GlobalState) {
		...
		match (v6) {
			case DC5(cf9, cf10, cf11, cf12) =>
				...
				v7, cf10, cf11, cf11, v10[992] := (v7 + v7) + (v7[cf10 := v1])[v0 := v1], if (cf11) then |v11| else |v12|, cf11, cf9, v9;
				v3[230] := cf9;
				v3[230] := cf11 <== (-0x184 < cf10);
				...
				var v16: array<array<int>> := new array<int>[6] [v14, v14, v14, v15[|v12|], v14, v14];
				v16[771] := v14;
				v16[771] := v14;
			case DC4(cf8) =>
				var v17 := 'p';
				v17 := 'd';
				var v18: array<int> := new int[6](i1 => i1 / v0);
				var v19: multiset<int> := multiset{v0};
				v18[762] := v0 / |v19|;
				v18[762] := v0 % v0;
				var v20: seq<array<int>> := [v18, v18, v18, v18, v18];
				v20 := v20;
				var v21: map<seq<int>, bool> := map[[v18[762], v0, v0] := v18[762] <= v0];
				v21 := v21 + v21;
			case DC6(cf13) =>
				var v22 := false;
				...
				match (v23) {
					case DC10() =>
						...
						v0 := |map[v25 := v22]| / (fm17(globalState)).cf29;
					...
					case DC11(cf18, cf19, cf20, cf21) =>
						...
						var v34: set<char> := {'o'};
						var v35: seq<int> := [fm19(v22, false, v0, globalState), v33[|v34|], cf21, cf21];
					...
					case DC12(cf22, cf23, cf24, cf25, cf26) =>
						...
						var v41: array<int> := new int[4](i2 => i2 / cf22);
						v41[885] := cf22;
						...
						v43[459] := map[v45 := !cf25];
						var v46: map<map<bool, T0>, bool> := map[map[v22 := v44] := 0x98 >= cf22];
						v41[885], v2, v42, v43[459], cf22 := v44.f6, fm68(cf25, true, globalState), v42 + map[|f18| := cf24], v46, |v1|;
						var v47: map<bool, int> := map[v22 := cf22];
						var v48: seq<map<bool, int>> := [v47 + v47, v47 + v47];
						v48 := v48;
					case DC9(cf17) =>
						var v49: array<int> := new int[16](i3 => i3 + 0x199);
						v49[170] := if (v0 in cf17) then cf17[v0] else v0;
						v49[170] := (v0 * v0) * v0;
						v0 := -(v49[170] - v0);
						v1 := v1;
						v49[170] := fm31(globalState);
				}
				
				if (v0 > v0) {
					var v50: array<int> := new int[4](i4 => i4 % v0);
					var v51 := DC13(v50);
					var v52: multiset<D4> := multiset{DC13(v50), v51};
					v52 := (v52 * v52) - v52[DC13(v50) := v0];
					...
					var v67: multiset<string> := multiset{v1, v1 + (seq(702, i5  => ('j'))), v63[|v66|]};
					v67 := v67;
					var v68: multiset<seq<int>> := multiset{seq(512, i6  => (|[v0]|))};
					var v69 := DC18(|[v60.f19, v22, v60.f19]| + 638, true, |v68|);
					v69 := v69;
					v3[337] := if (!v60.f19) then v60.f19 else v22;
					var v70: map<bool, bool> := map[v60.f19 := v22];
					var v71: map<int, bool> := map[v0 := v22];
					var v72: map<int, string> := map[v0 := seq(0x1e7, i7  => ('l'))];
					v3[337], v22, v0 := v22, (if (v60.f19 in v70) then v70[v60.f19] else v22) <== v22, (|v71| % v0) - |(v72 + v72)|;
				}
				...
				var v78 := DC5(v22, v0, v22, f18[v0 := f18[v0]]);
		...
		for i8 := v0 to |v81| - v0 {
			...
			v83[256] := --(if (!v79) then -v80.f29 else i8);
			v83[256] := v0 + v80.f29;
			v79 := v79;
		}
		var v84: seq<int> := [v0];
	...
	method m12(p0: array<int>, p1: bool, p2: array<int>, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v8: map<int, map<bool, bool>> := map[v4 / v4 := v7];
			v8 := v8[v4 := v7];
		}
		var v9 := true;
		...
		var v14 := "yvs";
		var i2 := 0;
		while ((v14 + v14)[-0x2dc := fm53(v14, --v11, !!p1, v11, globalState)] != v14)
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			match (if ({v11} !! v18) then DC38() else v19) {
				...
				case DC38() =>
					...
					var v27: array<char> := new char[19] [v0, v0, v0, v0, v0, v0, v0, if (v25 in v26) then v26[v25] else v0, v0, v0, v0, v0, 'g', v0, v0, v14[v11], v0, v0, v0];
					v27[740] := v0;
					v11, v9, v27[740] := v11, false, 'h';
					v10 := new bool[29];
					v9 := p1;
				case DC36(cf60) =>
					v10[570] := v9;
					v10[570] := v14 != (seq(868, i4  => ('m')));
					v10[570] := v9;
					...
					var v34: array<seq<int>> := new seq<int>[15] [v28, v28, [v11, if (v0 in v29) then v29[v0] else v11], v28, [v31.cf64, |v32|], v28, v28, v28, v28 + v28, v28, v28, v28, (v33[v11])[v11 := v11], fm20(v11, globalState), v28];
					v34[346] := if (v9) then [|v14|] else v28;
					var v35: multiset<bool> := multiset{p1, p1};
					v10[570], v34[346], v11, v11, v10[570] := fm30(p1, v35 * v35, globalState), v28, v11, v11, if (p1) then v10[570] else v9;
					v11 := v11;
				case DC39(cf65) =>
					var v36 := DC2(v14);
					var v37 := DC3(v36);
					...
					var v41 := DC17(p3, v14);
					v40[725] := v41;
					v40[725] := v41.(cf32 := fm46(p1, globalState));
					v11 := (v11 * v11) % v11;
			}
...
class C10 extends T1 {
	...
	function fm0(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<bool, bool>> {
		(map v0 : int | v0 in [f6, f6] :: (v0 / --f6) := (map[f17 := true])) + ((map v1 : int | (960 <= v1) && (v1 < -868) :: (v1 + f6) := (map[true := f17])) + map[f6 := map[f17 := f17]])
	}
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		if (!(f17 && true)) {
			...
			var v5 := DC0(|(seq(0x267, i1  => (|(seq(0x79, i2  => (f7)))|)))|);
			var v6 := DC3(v5);
			var v7: set<D0> := {v6, v6};
			var v8: seq<int> := [|v7|];
			...
			if (p0 > p0) {
				...
				var v15: array<array<int>> := new array<int>[18] [v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v13.cf27, v12, v12, v12, v12, v14[f16], v12, v12];
				var v16: seq<array<array<int>>> := [v15];
				f16, v15, f16, v6 := fm13(true, f7 - f7, -f6 * f7, globalState), v16[f7], f16, v6;
				f16 := f16;
				r1 := v0;
			} else {
				var v17: set<char> := {v0};
			...
			var v21: set<int> := {f7 / f16, fm19(!false, f17, f16, globalState), f7};
			v21 := p0;
			var v22: multiset<bool> := multiset{f17};
			v22 := v22;
			var v23: map<int, string> := map[f16 := v2[313]];
			v23 := v23[-fm31(globalState) := (v3 + v3)[f6 := v0]];
		}
		...
		if (f17 || f17) {
			...
			var v33: array<bool> := new bool[27] [f16 >= |v31|, f17, f17, false, false, fm15(f6, f6, f7, globalState), f17 && !f17, f17 <== f17, f8[0x2ab], f17, f17, f17, f17, true, false, !(v31 > fm12(|v32|, 703, f6, globalState)), f17, f17, true, f17, f17 <== f17, f17, !f17, [f6, f6] != [f6, -840, 0x286, f7], f17, !f17, f17 <==> f17];
			var v34: seq<int> := [f16, f16, -0x1f];
			var v35 := DC21(730, f7, multiset(v34), f16, f17);
			var v36: multiset<int> := multiset{f6, f16};
			v33[651] := v35.cf41 <= v36;
			var v37: map<bool, int> := map[f17 := f6];
			v33[651] := f17 <==> DC11(|"rtpqxxht"|, if (false in v37) then v37[false] else |v34|, f17, f6).cf20;
			var v38: map<int, bool> := map[f6 := f17];
			var v39 := DC20(v38);
			match (v39.(cf38 := v38)) {
				case DC21(cf39, cf40, cf41, cf42, cf43) =>
					var v40 := DC5(v33[651], 906, cf43, f8);
					cf43, f16, v33[651], cf42, f16 := f8 == (f8 + v40.cf12[cf42 := cf43]), cf39, f17 <== (f8 <= f8), cf40, f7;
					cf40 := cf39;
					var v41: set<string> := {v3, v2[313], v2[313]};
					cf43 := v41 >= v41;
					var v42: C1 := new C1(f16, true);
					var v43: map<int, C1> := map[cf39 := v42];
					var v44: multiset<map<int, C1>> := multiset{v43};
					var v45: array<int> := new int[7] [f7, cf40, f16 - |v2[313]|, --389, cf39, if (v43 in v44) then v44[v43] else cf40, 0x303 + -153];
					v45 := v45;
				case DC20(cf38) =>
					v36 := v36;
					var v46: set<bool> := {f17, f17, v33[651], v33[651]};
					v46 := DC27(v46).cf48;
					...
					var v51: array<array<array<int>>> := new array<array<int>>[27] [v47, v47, v47, v47, v47, v47, v47, v47, v47, if (f17) then v47 else v47, if (false) then v47 else v48[f6], v47, v47, v47, v47, v47, if (f16 in v49) then v49[f16] else v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, if (v33 in v50) then v50[v33] else v47];
					v51[907] := v47;
					v51[907] := v47;
			...
			r0, v33[651] := !false, v33[651] && (v54[f16] >= v36);
			r0 := f17;
			v33[651] := !false;
		} else {
			r0 := f17;
			...
			v56[183] := seq(-0x291, i3  => ({|v2[313]|}));
			var v57: seq<set<int>> := [p0];
			r0, f16, v55[751], v56[183], f16 := f17, if ((v24.(cf68 := f17, cf69 := f16)).cf68 ==> f17) then f6 else f16, f16, v57, f16;
			var v58: array<D13> := new D13[13];
			v58[378] := DC28(fm80({v0}, v0, f6, v55[751], globalState));
			var v59 := DC28(map[seq(0x185, i4  => (f16)) := f17]);
			v58[378] := v59;
			var v60: seq<int> := [v55[751], v55[751], f6];
			var v61: multiset<bool> := multiset{f17};
			v55[751], v3 := |((v60 + v60)[-f16 := if (f17 in v61) then v61[f17] else v55[751]] + [0x251])|, seq(-0x34a, i5  => ('j'));
			...
			v62[327] := map[v63 := fm15(v60[f6], |v65[v55[751] := f7]|, v55[751], globalState)];
		}
		...
		for i7 := f6 to -fm19(true, f17, f7, globalState) {
			...
			r0 := v0 !in v3;
			var v66: seq<int> := [i7];
			var v67: multiset<bool> := multiset{f8[0x109], f17, f17, f17, !f17};
			var v68: array<int> := new int[11] [-i7, -0x9, f6, 0x1a4, -v66[f16], 34, fm31(globalState), f6 - |v67|, f6, f7, f7];
			v68[676] := i7;
			v68[676] := fm13(f17, i7 - f6, f7, globalState);
			var v69: map<int, int> := map[|(seq(-0xc3, i8  => (-v68[676])))| := f7];
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		while (!match v1 {
			...
			case DC33(cf57) => f17
			case DC31(cf53) => f17 in {p1, f8[f16], f17}
			case DC34(cf58) => p1
		})
			decreases 100 - i0
		{
			...
			var v10: map<bool, string> := map[f17 && true := v0[-0x8e := p0]];
			v10 := v10[f17 := v0];
			v0 := v0;
		}
			...
			decreases 100 - i2
		{
			...
			var v16: map<int, int> := map[if (v14) then f16 else -f6 := |v15| / f16];
			f16 := if ((if (p1) then f16 else -f6) in v16) then v16[if (p1) then f16 else -f6] else f7;
			var v18: map<int, char> := map[-0x2ab := p0];
			var v19: seq<map<int, int>> := [map v17 : int | v17 in v18 :: (v17 % f6) := (f7), v16];
			var v20: array<bool> := new bool[26];
			var v21: map<int, bool> := map[f7 := v14];
			v20[839] := fm57(v21[f7 := false], p0, false, globalState);
			v19, f16, v20[839] := v19, f7, f17;
			var v22: set<string> := {v0[f16 := p0], v0};
			v22 := (v22 * fm86(v20[839], 'y', globalState)) + (v22 * {"tl"});
		}
		var v23 := false;
		...
		var v27 := DC16(v26);
		v25[273] := v27;
		v23, v24, v25[273], v23 := !v23, v24, v27, v23;
		var i4 := 0;
		while (!(v23 ==> p1))
			decreases 100 - i4
		{
			...
			match (v29) {
				case DC27(cf48) =>
					...
					v30 := if (p1) then f8 else v31[f16] + f8;
					v0 := v0 + (v0 + v0);
					var v32: map<char, bool> := map[p0 := !f17];
					var v33 := DC11(|v32|, f16 % 65, !f17, -f16);
					...
					var v41: array<int> := new int[19] [|v38|, if (f17) then f16 else f16, f6, fm31(globalState), f7, f6 + 0x27a, if ((if (v23 in v39) then v39[v23] else false) in v34) then v34[if (v23 in v39) then v39[v23] else false] else f6, --540 % |v39|, fm69(v13[|v0| := v12], globalState), DC5(p1, f6, f17, [f17]).cf10 % -0x125, f6, f7, |v40|, 0x25b % |v0|, f6, f7, -|fm42(p1, globalState)|, f16, f7];
					v41[622] := f16;
					...
					v23, v23, v41[622], v44, f16 := f17 <==> v23, !!v23, f7 * f16, set v46 : int | v46 in v45 :: (v46 % -0x2d8), f6;
			}
			
			var v47: array<int> := new int[2](i5 => i5 / --0x311);
			v47[812] := |(v0 + v0)|;
			v47[812] := -f6 / 0x2fc;
			...
			decreases 100 - i6
		{
			...
			if (f17) {
				...
				var v55 := new C4(v23, v54[f7] + map[v52 := f17], [!f17, p1, v23], fm13(v23, f16, -f16, globalState), f16);
				v52[586] := f6 * |map[f6 := f17]|;
				v52[586] := if (v23) then f16 else f7;
				var v56: seq<int> := [f7, f6, f6];
				var v57: map<bool, int> := map[p1 := f7];
				var v58: map<bool, map<bool, int>> := map[p1 := v57];
				var v59: seq<int> := [|v56| / f6, |v58| / |{f17, v23}|];
				...
				var v64 := new C8(v23, |v63|, fm19(v23, v23, f6, globalState) % f7);
				...
				var v68 := DC8(v67, f17);
				var v69: set<int> := {f6};
				var v71: set<set<int>> := {v69, fm43(globalState), v69, set v70 : int | (813 <= v70) && (v70 < 0xa4) :: (v70 % f7), v69};
				var v72: array<char> := new char[5];
				v72[130] := p0;
				v68, v71, v72[130] := v68, v71, 'p';
			}
			
			v23 := fm18(fm35(v0, globalState), f16, globalState);
			var v73: multiset<int> := multiset{-0xe6};
			v23, v0 := (v73 !! v73) <==> (0x2bb >= f6), v0[f6 / f6 := p0];
			...
			match (v75.(cf30 := DC15(v74))) {
				case DC14(cf28, cf29) =>
					...
					var v80 := new C4(if (v76 in v77) then v77[v76] else !f17, if (f17) then v77 else v77, v78[-|{multiset{f17, p1, f17}}|], 0x4f + 0x82, |v79| * f16);
	...
	method m9(p0: D0, globalState: GlobalState) returns (r0: multiset<int>, r1: bool, r2: bool) {
		...
		for i0 := f16 to f16 % |v0| {
			...
			r1, v2, v6, r1 := f17 && f17, v2 + v2, (if (f17 in v7) then v7[f17] else v6) + [v5], f6 > |(seq(310, i2  => (v1.f24)))|;
			var v8 := DC23('k');
			match (v8) {
				case DC23(cf45) =>
					f16 := -0x18;
		...
		v21, v22[477], v16[867], v24 := v21, v17, v18, v24;
		r2 := f17;
		for i7 := f6 to f7 {
			var v25: set<string> := {"xnps", "xvaw"};
			v25 := fm86(false, v17, globalState);
			if (multiset(v16[867]) < fm87(|f8|, false, f17, globalState)) {
				...
				r0, f16, v19, f16, r2 := (v35 * v35)[f6 := f6 - f16], -i7, v19, f6 - f6, f17;
				v22[477] := fm36(f7, f17, f7, globalState);
				r1 := f17;
			}
		...
		var v41: map<bool, string> := map[f7 != f6 := seq(0x3da, i9  => (v17))];
		v41 := v41[f17 := "jtu" + v18];
	...
	method m10(p0: string, p1: multiset<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: T2) {
		...
		var v9: array<bool> := new bool[13] [(set v3 : string | v3 in map[p0 := |v2|] :: (v3)) > v4, fm30(p2, multiset{p3}, globalState), f17, f6 != |(map v5 : int | (0x2c2 <= v5) && (v5 < 501) :: (v5 - f16) := (p3))|, v6 >= v6, v7 !in p0, p2, p3, |f8| > 617, false, f8[f6], f17, v8.cf9];
		v9[800] := f8[f6];
		var v10: seq<int> := [|f8|];
		var v11: seq<multiset<seq<int>>> := [v0, v0, v0, v0, v0[v10 := -355]];
		var v12: map<bool, bool> := map[p3 := p2];
		var v13 := DC7(v6);
		v0, v1, v9[800] := v11[f7] + fm79(p3, if (p3 in v12) then v12[p3] else p2, globalState), v1 + v1, v13.cf14 > (v6 + v6);
		for i0 := if (!v9[800]) then 106 else fm13(p3, f16, |fm56(true, p2, p3, globalState)|, globalState) to --(f6 + |v10|) {
			v6 := v6;
			v9[800] := v9[800];
		...
		if (!v9[800] <==> (f17 <== f17)) {
			...
			v15, f16, v16[69], v9[800] := v15, f6 / -(|"subnfimgl"| - |v17|), f6, p3;
			var v18: array<string> := new seq<char>[14](i1 => seq(0x358, i2  => (v7)));
			v18 := v18;
			if ((|p0| - |v10|) >= (f7 + v16[69])) {
				var v19 := DC0(f7);
				var v20 := DC8(v19, v9[800]);
				var v21: map<int, D2> := map[f6 := v20];
				var v22: map<char, map<int, D2>> := map[v7 := v21];
				var v23: map<int, int> := map[f6 := 0x236];
				v1, v9[800], f16, v21 := v1, fm18(p2, fm31(globalState), globalState), f16, if ('p' in v22) then v22['p'] else map[f7 := v20] + fm89(f17, |v23|, true, f16, globalState);
				r0 := f6 != f6;
				r0 := !(f17 ==> ({f16} > {f7}));
				var v24 := new C0(f16);
				var v25 := DC27(v2);
				...
				var v26 := new C1(-0xd, v9[800]);
				var v27: map<bool, int> := map[!true || true := f7];
				v27 := v27;
				var v28 := DC1(p2, v26.f27, v9[800], p3, p2);
				var v29, v30, v31 := m9(v28, globalState);
				var v32: map<int, D2> := map[|(seq(0x370, i3  => (v7)))| := v13];
				v32 := (map[f6 := v13])[-542 := fm24(f16, p3, p2, p2, globalState)];
				v9[800], r0, v9[800] := v31, v26.f27, v30;
			}
			
			if (!p2) {
				var v33 := DC43(v10, v9[800], v9[800]);
				f16, v16, v10, f16, r0 := fm31(globalState), v16, if (v10 <= [|v10|]) then if (f17) then v10 else fm40(v9[800], globalState) else v33.cf72, f16 % fm23(f16, v9[800], -f6, 0x2ce, globalState), f17;
				...
				var v38: C7 := new C7(v36[v35 := v37[v16[69]]], if (f16 in v1) then v1[f16] else v9[800]);
				var v39 := DC42(v38);
				v39 := v39;
				...
				var v42 := DC37(v41[|(seq(279, i4  => (v7)))|], fm35(p0, globalState), -288, v38.fm26(p3, globalState));
				v9 := v42.cf61;
				var v43 := DC32(0x325, p0, v9[800]);
				var v44: map<int, D15> := map[v16[69] := v43];
				v16[69], v9[800], v16[69] := |((v44 + v44) + (v44 + v44))|, f17, f16;
			} else {
				var v45: map<array<int>, bool> := map[v16 := fm46(v9[800], globalState)];
				var v46 := new C4(if (p3) then p3 else f17, v45, f8, v10[f16], v16[69]);
				r0 := p2;
				v16[69] := |p0|;
				var v47: seq<array<bool>> := [v9];
				var v48: set<int> := {|v6|};
				globalState.f1 := (v47 + v47[|v48| := v9]) + (v47 + v47);
				v16[69] := -0x1aa;
			}
			...
			v49, v51, v59[890] := v50[v60.cf36 / |v10|], v51, v55;
			var v61 := new C1(f6, true);
		}
		
		v9[800] := f17 in [fm35(p0, globalState)];
		f16 := 0xf * f7;
		r0 := v9[800];
		var v62: array<int> := new int[17];
		var v63: map<array<int>, bool> := map[v62 := !p2];
		var v64: set<int> := {f7, -0xb1};
		var v65: T2 := new C4(f17, v63, f8, f16, -(-fm23(|v64|, p3, f6, f16, globalState) % 0x40));
		r1 := v65;
	}
}
...
class C11 extends T0 {
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
			...
			decreases 100 - i0
		{
			...
			var v10: array<bool> := new bool[21] [false, |v0| == f6, if (true) then f15 else f15, f15, f15, f15, false, f15, true, f6 != |v5|, f15, f15, f15, fm11(f7, v0, globalState), f15, f15, true <==> !v6.cf11, if (f15) then fm11(f6, seq(0x367, i1  => ('o')), globalState) else f15, f15, f15, {v7, v7, v8[f6], v7, v7} !! v9];
			v7[208] := f15;
			v7[208] := f15;
			if (f15) {
				v4 := map[f6 := f15];
				...
				v11 := v11[-(f7 - (if (f15 in v12) then v12[f15] else 0x33a)) := seq(0xd4, i2  => ('h'))];
				var v13 := 0x22c;
				v13 := f6;
				v7[208] := f6 != f7;
				v7[208] := f15;
				...
				var v19: multiset<int> := multiset{|(if (v7[208] in v18) then v18[v7[208]] else map[v16 := f15])|};
		...
		var v24 := "rdidar";
		if (fm57(v21, v22, v23[f6], globalState) || (v24 == v24)) {
			var v25: array<string> := new string[20] [v24, seq(371, i3  => (v22)), v24, v24, v24, v24, seq(732, i4  => (v22)), v24, "onr", v24, v24, v24, v24, v24, v24, v24, v24, v24, seq(186, i5  => (v22)), v24];
			...
			v26[817], v24, v28, v29, v30 := v25, v24 + v24, v28, v29, v30 + v30;
			var v31: array<int> := new int[17](i6 => i6 + f7);
			v31[20] := 0xb0;
			var v32: T3 := new C5("kwchge", f15, map[v31 := f15], v23, f7, f6);
			var v33: map<bool, T3> := map[f15 := v32];
			var v34: map<bool, T3> := map[f15 := if (v32.f8[v32.f6] in v33) then v33[v32.f8[v32.f6]] else v32];
			...
			v31[20], v35, v36 := |((v38 * {v40.cf72}) - v41[v32.f6])|, v35, v36;
			v36 := f7;
			if (if (fm23(f6, v32.f8[|v32.f11|], v32.f6, f7, globalState) in v21) then v21[fm23(f6, v32.f8[|v32.f11|], v32.f6, f7, globalState)] else v24 != "irwicapl") {
				var v42 := DC2(fm62(false, globalState));
				v24, v24 := (v42.cf6 + (seq(-0xea, i7  => (v22)))) + v32.f11, "smdjmjdx";
				v36 := f6 / f7;
			...
			v46[870] := (if (f15) then multiset(v23) else v47) != (v47[f15 := f6] * v47);
			v46[870] := !v46[870];
			v24 := v24;
			v46[870] := !v46[870];
		...
		if (!f15) {
			...
			v52 := v52[if (f15) then v50 else [[f6, f6], v49, [|(seq(-615, i9  => (v22)))|]] := v51];
			r0 := f15;
			var v53: map<bool, int> := map[f15 := f7];
			if ((|v53| / f6) <= (if (f15) then f7 else f7)) {
				r0 := if (!f15) then f15 else false;
				var v54: array<int> := new int[12];
				v54[936] := -0x381;
				v54[936] := |(map[f6 := f15] + v21)| + f7;
				v54[936], v54[936], v54[936] := if (f15) then f7 else f7, f7, f7;
				var v55: array<bool> := new bool[13](i10 => true);
				var v56: array<D4> := new D4[19](i11 => DC14(|v49|, |(seq(0x3a4, i12  => (v54[936])))|));
				...
				var v60 := 0x2bd;
				var v61: array<seq<bool>> := new seq<bool>[27] [v23, v23, v23[|multiset(v23)| := f15] + v23, v23[0x36e := f15] + v23, v23 + v23, [!false] + v23[f6 := f15], v23, [f15, f15], v23, v23, v23, v23 + v23, ([true, f15])[if (f15 in v53) then v53[f15] else f7 := true] + v23, ([f15])[f6 := f15], fm56(f15, f15, f15, globalState), v23 + v23, (v23 + v23)[v60 := f15], v23, v23, v23, v23, v23 + [f15], v23, v23, v23, v23 + v23, [f15]];
				v61[518] := v23 + v23;
				v60, r0, v61[518] := v49[v60], !(v51 !! v51), [f15, f15];
				...
				v62[277] := v64 + v64;
				v62[277] := map[v63 := multiset{fm35(v24, globalState)}];
				var v65: set<set<int>> := {{f6, v60, f6, f6}, p0, p0};
				r0 := v65 >= v65;
				var v66 := DC5(f15, f7, f15, v61[518]);
				var v67 := DC6(v66);
				...
				r0, v60, v70[212], r0, v24 := f15, -(|v23| + -v60), v69, v69.f21, (v24 + v24) + v71[f7];
			...
			v76[512] := v75;
			v76[512], v75, r1 := f6, |v24|, v22;
		} else {
			var v77: array<int> := new int[3] [|(v24 + v24)|, -0x2cf % f7, f7];
			var v78: multiset<bool> := multiset{true, f15, f15};
			var v79 := DC7(v78);
			var v80: seq<D2> := [v79];
			v77[2] := fm69(v80, globalState);
			var v81: map<char, bool> := map[v22 := true];
			var v82: seq<map<char, bool>> := [map['m' := f15], v81, v81];
			v77[2] := fm69(fm70(f15, f15, |v82[f6]|, globalState), globalState);
			...
			var v87 := DC52(|v85|, v86[f6 := v77[2]]);
			var v88 := DC53(v87);
			var v89: multiset<string> := multiset{v24};
			var v90: map<D23, bool> := map[v88 := v89 > v89];
			v84, r0, v77[2] := v84[v24 := fm19(f15, f15, f6, globalState)], if (v88 in v90) then v90[v88] else f15, f7;
			v77[2] := -fm69(v80, globalState);
		}
		...
		if (f15) {
			...
			v93 := v93;
			v24 := (seq(-243, i13  => ('i')))[f6 := v22] + v24;
			var v94: array<array<string>> := new array<string>[16];
			var v95: array<string> := new string[12];
			v94[43] := if (f15) then v95 else v95;
			var v96: map<bool, array<string>> := map[f15 := v95];
			v94[43] := if (f15 in v96) then v96[f15] else v95;
			var v97 := 0x316;
			var v98: multiset<bool> := multiset{!f15, f15};
			v97 := (v97 / 728) * fm45(fm30(false, v98, globalState), f14, globalState);
		} else {
			var v99: map<string, bool> := map[v24 := v22 !in v24];
			v99 := v99[v24 := f15];
			var v100: seq<int> := [f7];
			var v101: map<int, int> := map[-f6 := f6];
			var v102: array<int> := new int[21] [f6 % 499, f6, f7, f6 / 0x16e, if (!f15) then -v100[f6] else f6, 0x1d2, f6 + 0x1e1, f7, f7 + f6, fm19(f15, true, f6, globalState) % f6, f6, f7, v100[-f7], f6, f7 / v100[f6], if (-f7 in v101) then v101[-f7] else f7, -f6 % f6, if (f15) then f6 else f7, f6, 358, f6];
			...
			var v108 := new C10(f6, if (f15) then v23[v104.f29] else v23[f7], if (|v24| in v107) then v107[|v24|] else v23, v100[f6], f6);
			var v109: C9 := new C9(v23);
			v109 := v109;
			var v110: array<bool> := new bool[4];
			v110[116] := true;
			v104.f29, v110[116], v23 := -|v106[v104.f29]|, v108.f17 <== f15, v109.f18[v108.f16 := fm15(f7, |v23|, v104.f29, globalState)];
		}
		
		var v111: seq<int> := [-64];
		var v112: set<char> := {v22};
		var v113: map<set<char>, bool> := map[v112 := f15];
		r0 := f7 <= (if (f15) then v111[|v113|] else f6);
		r0 := f15;
		r1 := v22;
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		for i0 := fm31(globalState) / f6 to f7 {
			var v0 := 441;
			v0 := v0 * f6;
			var v1 := "cll";
			var v2: seq<string> := [v1, v1];
			...
			v0 := if (p1 in v3) then v3[p1] else |((v4[-i0 := fm11(|v5|, v1, globalState)])[f7 := f15])[f6 := p1]|;
			var v6 := DC38();
		...
		if ((f6 - f6) != |[f7]|) {
			...
			var v13 := DC28(v12 + map[seq(0x21f, i1  => (-0x22)) := p1]);
			...
			var v21: array<int> := new int[5](i2 => i2 % f6);
		...
		match (DC47(v49)) {
			case DC48(cf79, cf80, cf81) =>
				cf79 := f6 / |multiset{true, true, f15, v45.f21}|;
				var v50 := DC45(p2);
				var v51: map<D20, int> := map[v50 := 668];
				var v52: set<C7> := {v45, v45, v45, v45};
				v51 := v51[v50 := |({v45, v45, v46[|cf80|], v45} + v52)|];
				var v53 := "imtsd";
				v53 := v53 + v53;
				cf81[729] := v53;
				cf81[729] := v53;
			case DC49() =>
				...
				if (!f15) {
					...
					v57 := v57 + [v55, v55[f6 := f7], v55[fm69(seq(-0xe5, i3  => (DC7(multiset{v45.f21}))), globalState) := 0x3e1]];
					var v58 := false;
					v58 := p1;
					v54 := f6 / (v54 + v54);
					...
					v63[61], v65[607] := (|v66['q' := v54]| % v54) * v55[v61.f25], v64;
				} else {
					var v67 := DC38();
					...
					var v72: seq<array<bool>> := [v39, v39, v71[f7]];
					v69 := v69[v70 := |v72| + f7];
					var v73 := "af";
					...
					v39[85] := v45.f21;
					v54 := f6 + v54;
					v39[85] := fm18(f15, v54, globalState) <==> v39[85];
				}
				...
				var v82: array<int> := new int[21] [0x4, |v76|, if (multiset{f7} in v77) then v77[multiset{f7}] else v54, -f6, |multiset(v76)|, -0x3da, f7, |v80|, v54, |v79|, f6, v54, f7, |v42|, f6, f7, if (p1 in v81) then v81[p1] else |v75|, |[f15, v45.f21, p1]|, f6, fm23(|v75|, p1, -0x202, v76[-f6], globalState), f6];
			...
			case DC47(cf78) =>
				...
				var v88: array<map<int, seq<bool>>> := new map<int, seq<bool>>[6] [map v86 : int | (-313 <= v86) && (v86 < 447) :: (v86 / -30) := (v42), v87, v87, v87, (map[|fm63(globalState)| := v42])[f7 := v42], v87];
				var v89 := "js";
				v88[145] := map[|v89[f6 := p0]| := v42[f6 := f15]] + v87;
				v88[145] := map[f7 * f6 := v42];
				var v90 := false;
				v90 := f15;
			...
			case DC50(cf82) =>
				...
				if ((if (f15) then v94 else v94) < v94) {
					...
					v96[255] := |v97[fm15(f7, f7, v95, globalState) := v95]|;
					var v98 := "fel";
					v96[255] := |v98|;
				} else {
					var v99 := false;
					...
					v99, v99, v100, v101 := v99, v101 >= (if (f15) then 735 else f7), v100, 0x325 % (|v94| % |v102|);
					var v103 := 'y';
					v103 := 'x';
					var v104: seq<int> := [f6];
					...
					v108 := v108;
					var v109: array<int> := new int[5] [fm19(true, v45.f21, |(seq(0x33f, i4  => (v103)))|, globalState), -f7, |v43| - f7, v101, v101];
					var v110: set<char> := {'b'};
				...
				if (if (p1) then v45.f21 else f15) {
					var v112 := -0x1f4;
					v112 := |((map v113 : int | v113 in v43 :: (v113 * |v42[f6 := p1]|) := (p1)) + map[v112 := f15])| + v112;
					var v114 := DC33(f6);
					v114 := v114;
					...
					v118[359] := v115;
					var v119 := "gdpswhejf";
					v39[332] := fm11(f7, v119, globalState);
					v39[332] := p1;
				} else {
				...
				if (f15 || (v126 !! v126)) {
					...
					var v131: array<int> := new int[13](i6 => i6 % |[f15, v45.f21]|);
					var v132: map<array<int>, bool> := map[v131 := v45.f21];
					var v133 := new C4(v45.f21, v132, v42, 634, f6);
					var v134 := "ihq";
					var v135 := new C1(|v134|, f15);
					v131[960] := v45.fm26(v45.f21, globalState);
					v131[960] := (v135.f26 - f7) * v133.fm55(fm46(p1, globalState), v45.f21, globalState);
		...
		for i7 := f6 to --(f6 + f7) {
			...
			match (v141.(cf20 := !false).(cf19 := i7 * |v142|)) {
				...
				case DC12(cf22, cf23, cf24, cf25, cf26) =>
					...
					var v157 := DC3(v156);
					v152, v153[424], v154, v39[112], v157 := v152, -0x223 + (cf26 % cf23), v154, true, f14;
					var v158: map<char, int> := map[v152 := v45.fm26(v45.f21, globalState)];
					var v159: seq<int> := [cf26, v153[424], cf23];
					v158 := v158[p0 := |v159|];
					cf26 := --747;
				case DC9(cf17) =>
					var v160 := 0x268;
					...
					v161 := v161;
					var v162: map<int, seq<bool>> := map[fm31(globalState) := v42[|[p1, p1]| := v45.f21]];
					var v163: seq<int> := [f7];
					var v164: set<bool> := {v45.f21};
					v160 := |((v162 + map[v163[|v164|] := v42]) + (v162 + v162[f6 := [v45.f21]]))|;
					var v165 := DC33(f6 * -f6);
					v165 := v165;
			}
			...
			v170 := v170[v166 := seq(0x35, i10  => (|v142[-0x320 := p0]|))];
			var v171 := 'l';
			v171 := p0;
		}
		if (f15) {
			var v172 := "bishhvva";
			v42 := fm56(v42[|v172|], f15, fm18(v45.f21, --f6, globalState), globalState);
			var v173: map<set<bool>, bool> := map[{p1} := v45.f21];
			var v174: set<bool> := {v45.f21};
			var v175: seq<array<bool>> := [v39];
			v39 := if ((if (v174 in v173) then v173[v174] else f15) <==> p1) then v39 else v175[|v172|];
			...
			v182[112] := if (p1) then |(fm44(p0, globalState))[0xb5 := p0]| else f6;
			v182[112] := -f7;
			var v183 := "u";
			...
			var v196 := true;
			v196, v182[112] := (v183 + v183) < "vmnd", f6 * |v43|;
			v39[535] := f15;
			var v197: multiset<bool> := multiset{v196, f15, !f15, v42[f6], v196};
			v39[535] := fm30(v197 !! v197, multiset(v42), globalState);
		}
		...
		if (p1) {
			...
			var v205: map<map<seq<int>, bool>, int> := map[v204 + v204 := f6 % -v198];
			var v206: seq<map<seq<int>, bool>> := [map[v203 := v199]];
			v205 := v205[v206[410] := |v203|];
			v39[969] := v45.f21;
			var v207 := "odgb";
			var v208: multiset<bool> := multiset{v45.f21, v45.f21, v45.f21};
			var v209: array<int> := new int[4] [|v207|, f7, |v208|, v45.fm26(p1, globalState)];
			v209[515] := fm19(v45.f21, p1, -f7, globalState);
			v39[969], v199, v209[515], v198, v202 := ((seq(384, i11  => (p0))) + v207) == fm62(v199, globalState), p1, f6 % f6, f7, f15;
			...
			match (if (p1) then DC41(fm46(if (0x3d1 in v47) then v47[0x3d1] else p1, globalState), f15, f6, f6) else DC41(f15, fm35(v211, globalState), f7, f7)) {
				...
				case DC40(cf66) =>
					...
					var v219: seq<seq<int>> := [seq(718, i12  => (f6)), ([|[f6, -95]|])[v216 := 0x27a], seq(0x1c5, i13  => (-f6)), v217];
			...
			if (p1) {
				...
				v42, v226, v228, v225, v231 := v42, if (v45.f21) then -v230.f7 else 0x9d, (seq(422, i14  => (v227))) + v228, v225 + map[f15 := v45.f21], v231;
				var v232 := false;
				v232 := v45.f21;
				v226 := f6 % f6;
				v226 := v226;
				...
				var v236: seq<seq<int>> := [v233 + v233[if (false in v234) then v234[false] else |v235| := f6], (seq(81, i15  => (|v233|))) + v233];
				...
				p2[49] := v238;
				v238[920] := f7;
				v236, p2[49], v238[920] := v236 + v236, v238, -(f7 / f7);
				v238[920] := f6;
				var v239: map<bool, map<bool, bool>> := map[f15 := map[v45.f21 := v45.f21]];
				var v240: map<bool, bool> := map[v45.f21 := f15];
				v238[920] := |(if (fm35("vwsaid", globalState) in v239) then v239[fm35("vwsaid", globalState)] else v240 + v240)|;
				...
				v243[608] := v242;
				var v244 := false;
				v238[920], v241, v243[608], v244, v238[920] := |v235| - -(-v238[920] % |v211|), v241, v242, v235 != (v235 - v235), (if (f6 in v43) then v43[f6] else f7) % f7;
				var v245 := 'g';
				v245 := p0;
			}
			...
			match (v247) {
				case DC35(cf59) =>
					...
					v39[393] := v248 && v248;
					v39[393] := v45.f21;
					var v250: multiset<bool> := multiset{v248, f15, v39[393]};
	...
	method m8(p0: int, p1: bool, globalState: GlobalState) returns (r0: array<multiset<bool>>, r1: array<map<int, bool>>, r2: array<int>, r3: seq<bool>) {
		...
		for i0 := |v0| to f6 {
			...
			match (v29) {
				case DC17(cf32, cf33) =>
					...
					v30 := if (f15) then v30 + (map v31 : string | v31 in v2[cf33 := |v33|] :: (v31) := (map[p1 := p1])) else v30 + map[cf33 := v34];
					var v35: array<int> := new int[25](i2 => i2 + v26);
					v35[829] := (if (cf32 in v32) then v32[cf32] else fm45(true, f14, globalState)) % i0;
					v35[829] := v26;
					var v36 := DC33(f6);
					v35[829] := (if (cf32) then v36 else v36).cf57;
					var v37 := DC7(v32);
					...
					var v45: seq<int> := [v39[f6], v39[|v42|], if (v43 in v44) then v44[v43] else v26, -f7];
				...
				case DC16(cf31) =>
					...
					v50, v26, v26, v51[557] := fm15(i0 + f6, if (f15 in v54) then v54[f15] else i0, p0, globalState), f7, v26, v50;
		...
		var v60: array<bool> := new bool[18] [p1, f15, p1, f15, p1, !(v56.(cf10 := p0, cf9 := p1)).cf9, f15, f15, f15, f15, !f15, f15, false, p1 || p1, p1, |v57| > |v58|, f15, if (0x193 in v59) then v59[0x193] else v0[-f7]];
		v60[610] := f15;
		var v61 := DC37(v60, f15, f7, f6);
		v60[610] := if (p1) then p1 else if (f15) then v61.cf62 else p1;
		for i4 := -0x322 to f7 * f7 {
			v60[610] := fm30(p1, multiset{v60[610], true}, globalState) <== v60[610];
			var v62 := "tdpdvywoh";
			v62 := v62;
			var v63 := 'r';
			v63 := v63;
		...
		var v67: seq<char> := [v65, v66[v64], v65];
		v64 := -v64 - |v67|;
		var i5 := 0;
		while (false)
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v68: set<bool> := {v60[610]};
			var v69: seq<set<bool>> := [v68];
			v68 := (if (f15) then v69[f7] else v68) * (v68 - v68);
			var v70: set<int> := {p0};
			v64 := (f7 % |v70|) * (f6 + f6);
			v66 := v66 + v66;
			var v71: array<int> := new int[17](i6 => i6 % 0x324);
			var v72: map<bool, array<int>> := map[v60[610] := v71];
			var v73 := DC40(v72 + v72);
			v73 := DC40(v72[v60[610] := v71]).(cf66 := v72 + v72);
		}
		var i7 := 0;
		while (!v60[610])
			decreases 100 - i7
		{
			...
			i7 := i7 + 1;
			var v74: array<int> := new int[22](i8 => i8 % |v67|);
			v74[163] := 724;
			var v75: set<bool> := {v60[610]};
			var v76: set<int> := {p0, f6};
			var v77: seq<D17> := [v61, DC37(v60, f15, f7, |fm78(v76, globalState)|), DC37(v60, p1, fm19(true, v60[610], f6, globalState), f7)];
			...
			var v81: map<array<D4>, bool> := map[v80 := v60[610]];
			v74[163], v79 := -|((v81 + v81) + v81)|, v79;
			var v82: seq<string> := ["ek", v66];
			var v83: array<seq<string>> := new seq<string>[4] [v82, [seq(0x68, i9  => (v65)), v67] + v82, seq(0x206, i10  => (v67)), v82];
			v83[213] := v82 + fm92(f15, v74[163], |multiset{p0}|, f15, globalState);
			var v84: seq<seq<string>> := [v82, v82, v82];
			v83[213] := if (!f15) then v82 + v82 else v84[499];
			var v85: multiset<int> := multiset{p0, v74[163], v74[163] + v64};
			var v86 := DC9(v85);
			v85 := v86.cf17;
			v74[163], v60[610] := p0 / (p0 + f7), p0 == f6;
		}
		var v87: array<multiset<bool>> := new multiset<bool>[13](i11 => multiset{v60[610]});
		r0 := v87;
		var v88 := DC20(v59);
		r1 := new map<int, bool>[20] [v59[|v67| := true] + v59, map[f6 := f15] + v59, v59, v59, v59 + v59, v88.cf38, map[-p0 := v60[610]], v59, v59 + v59, fm66(globalState), (map[|[p1, p1]| := f15])[|v66| := p1], v59, v59, (map v89 : int | (496 <= v89) && (v89 < 0x149) :: (v89 * v64) := (p1)) + v59, v59, v59, v59, v59, v59, v59 + v59];
...
class C12 extends T0 {
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		var v3 := 452;
		var v4 := "pbraq";
		v1, v2[637], v3, v3, v2 := v1, !(if (v0) then v0 else v0), f6 - f6, fm7(f6, v0, v4, globalState), v2;
		v3 := f7;
		var v5: map<int, bool> := map[f6 := v0];
		var v6: seq<string> := [v4, v4];
		var v7 := 'n';
		var v8: multiset<int> := multiset{f7};
		var v9: multiset<bool> := multiset{false, v0, v0, v0, v2[637]};
		var v10: array<int> := new int[14] [|v5| / f6, f6, |(v6[f6])[v3 := v7]|, v3, v3, |v4|, v3, |(v4 + f13.cf6)|, v3, -f6, f7, f7 % |v8|, v3, |v9|];
		v10[634] := f6;
		var v11: seq<bool> := [true];
		v10[634], v3, v3, v2, v2[637] := |(v11 + v11)|, f6, -(fm7(v3, v2[637], fm8(v2[637], v0, v0, globalState), globalState) - v3) - (|v4| - f7), DC4(v2).cf8, (if (true) then v2[637] else v2[637]) !in v11;
		v3 := if (v0 <== v2[637]) then v3 else f6;
		v0 := v0 <== true;
		r0 := if (v2[637] <==> v0) then v4 <= v4 else v2[637];
		r1 := v7;
		var v12: map<int, int> := map[f6 := f7 % v3];
		r2 := v12;
	}
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		var v0 := "xb";
		for i0 := fm7(f7, p1, v0, globalState) to f6 {
			...
			v1 := v5[if (p1 in v6) then v6[p1] else |v7|];
			var v8 := false;
			v8 := true;
		...
		if (!p1) {
			...
			var v30: T1 := new C2(v15, v17, f6, v15 / f7);
			v30 := v30;
			var v31 := true;
			...
			if (if (!v41 <== p1) then fm35(v0, globalState) || v41 else v41 <== v41) {
				var v42 := DC0(f6);
				var v43 := DC3(v42);
				v41, v38[373] := v41, -fm45(v38[373] < v38[373], v43, globalState);
				var v44: array<bool> := new bool[28](i1 => v41);
				v44[603] := p1;
				v38[373], v44[603], v41 := v38[373], false, p1;
				v41 := f7 >= f6;
				var v46: array<map<int, int>> := new map<int, int>[17](i2 => (map v45 : int | (0x90 <= v45) && (v45 < 0x2bf) :: (v45 * |[v44[603], p1]|) := (f6)) + map[f6 := f7]);
				var v47: map<int, int> := map[f7 := -v38[373]];
				v46[331] := v47;
				v38[373], v38[373], v46[331], v38[373] := -f7, 939, v47, v38[373] / |(v0 + v0)|;
				var v48: seq<bool> := [p1, v41];
				var v49: C9 := new C9(v48);
				v49 := v49;
			} else {
				var v51: array<seq<int>> := new seq<int>[25](i3 => if (p1) then [|(seq(0x5e, i4  => (|DC55([DC23(p0)]).cf88|)))|] else [-0x3d9, |(map v50 : int | (0x94 <= v50) && (v50 < -799) :: (v50 - 0xde) := (seq(578, i5  => (380))))|]);
				var v52: seq<int> := [f6];
				v51[384] := v52;
				...
				v51[384], v53, v38[373] := (v52 + (if (v41 in v54) then v54[v41] else (v55[f7])[f6 := f6])) + [f7], (v53 + v53[f7 := true]) + (if (fm15(|v56|, f6, |"cnhxt"|, globalState)) then v53 else v53), |v0|;
				...
				v58[884] := v57;
				v38[373], v58[884] := v38[373] - f7, if (p1) then v57 else v57;
				v38[373] := f6;
				var v59: map<bool, int> := map[p1 := -f7];
				var v60 := DC32(|map[p1 := v41]|, v0, p1);
				var v61 := DC1(v41, v41, p1, v41, v41);
				v38[373], v38[373], v38[373] := (|v53| * f7) + |v59|, f6 - fm45(v60.cf56, DC3(v61), globalState), (f7 * f6) * v38[373];
				var v62, v63, v64 := m7(p0, -f7 - f7, |(fm56(false, v41, p1, globalState) + [v41])[|v40| := v41]|, v41, globalState);
			}
		...
		var v71: seq<multiset<D6>> := [v70[|v0|]];
		...
		v76 := v76;
		var v77: map<int, bool> := map[|v67| % v65 := v73 > v73];
		v77 := v77[v65 := p1 && p1];
		v74[58] := f7 - v65;
		var v78 := DC14(f6, f6);
		var v79 := DC15(v78);
	...
	method m7(p0: char, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		var v0: seq<int> := [p2];
		var v1: set<bool> := {p3};
		var v2: map<int, int> := map[|v0[|v1| := f6]| := 53];
		...
		var v6: seq<char> := [p0];
		var v7: array<int> := new int[23] [p2, p1, |v3|, f7, -0x7a, f6, |v5|, p2, f7, f7, f7, p2, -0x2e3, f7, p2, |fm44(p0, globalState)|, v0[f6], 569, 854, |v6|, p1, -p2, |v1|];
		var v8: multiset<array<int>> := multiset{v7};
		if (v8 >= v8) {
			var v9: array<D23> := new D23[26](i0 => DC52(p2, multiset{-|v2|}));
			var v10: seq<array<D23>> := [v9];
			var v11: array<array<D23>> := new array<D23>[26] [v9, v10[f6], v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9];
			...
			v11[356] := if (v12 in v13) then v13[v12] else v9;
			v11[356] := v9;
			r2 := !p3 <==> p3;
			var v14: seq<bool> := [p3];
			var v15: map<bool, bool> := map[p3 := true];
			var v16: map<char, bool> := map['o' := v14[|v15|]];
			v12[303] := f6 == |v16|;
			v12[303] := fm31(globalState) >= (f7 * p1);
			v0 := v0;
			...
			if ((|v0| / (if (p1 in v2) then v2[p1] else f7)) < f7) {
				...
				var v24 := DC28(v23);
				v7[589] := |v6|;
				v21, v24, v7[589], v6, r0 := if (p3) then if (true) then v21 else v21 else v21, v24, -0x3d7, v6, f7;
				...
				v29[972] := DC12(v17.f28, v17.f28, p3, v28.f22, f6).cf24;
				v29[972] := p3;
				v7[589] := v17.f28;
			} else {
				...
				var v34: array<seq<map<bool, int>>> := new seq<map<bool, int>>[5] [v30, v30 + v31[|v32|], v30[f7 := map[p3 := p2]], v30 + v30, if (p3 in v33) then v33[p3] else seq(662, i2  => (v4))];
				v34[369] := v30;
				var v35: array<bool> := new bool[6](i3 => multiset{|v32|} == multiset(v0));
				v35[958] := fm10(v4, globalState);
				var v36: seq<multiset<int>> := [multiset{v17.f28, f7, fm23(f7, p3, 983, p1, globalState)}];
				var v37 := DC9(v36[p2]);
				v34[369], v35[958], v37, r2, r2 := v30[if (p3 in v5) then v5[p3] else p2 := v4 + fm65(|(map v38 : int | (-0x46 <= v38) && (v38 < 0x37a) :: (v38 + |map[p3 := p3]|) := (0x2cb))|, globalState)], p3, v37, p3, p3;
				var v39: map<map<bool, int>, string> := map[fm65(v17.f28, globalState) := v6 + (seq(0x2d0, i4  => (p0)))];
				var v40: map<int, string> := map[p1 := v6];
				var v41: set<string> := {v6, v6};
				v39 := v39[fm48(p3, v35[958], globalState) := if (|v41| in v40) then v40[|v41|] else v6];
				v35 := v35;
				var v42: seq<seq<bool>> := [v32];
				var v43: map<seq<seq<bool>>, bool> := map[v42 := false];
				var v44 := new C8(if ([v32, v32] in v43) then v43[[v32, v32]] else v35[958], f7, -p2);
				r0 := -v17.f28;
			}
		...
		r1, v6, v7[243], r0 := if (v59.f27 in v61) then v61[v59.f27] else v59.f27, v6, |v62[|(map v63 : int | v63 in v65[f7] :: (v63 - p2) := (203))|]| - f7, v59.f26;
		var v66: multiset<string> := multiset{v6, "lcju", v6, v6, v6};
		r1 := multiset(v62 + v62) >= v66;
		r2 := v59.f27 && v59.f27;
		var v67: seq<bool> := [v59.f27, false];
		var i5 := 0;
		while (if (v67[p2]) then p3 else v67[p2])
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			i5 := i5 + 1;
			r0 := (-|fm44(p0, globalState)| / f6) * -v7[243];
			var v68: array<bool> := new bool[3] [p3, v59.f27 && p3, fm57(v64, p0, p3, globalState)];
			var v70: set<string> := {"p", v6};
			v68[573] := (set v69 : string | v69 in v62 :: (v69)) !! v70;
			var v71 := DC18(f6, if (v7[243] in v64) then v64[v7[243]] else v59.f27, p2);
			v68[573], r1, r2 := v59.f27 && (if (v59.f27) then v59.f27 else v59.f27), v59.f27, v71.cf35;
			if (v68[573]) {
				...
				var v81: multiset<map<bool, C7>> := multiset{map[v68[573] := v80]};
				var v82: seq<D7> := [v74];
				var v83: array<multiset<D7>> := new multiset<D7>[15] [fm93(globalState), v75, (fm93(globalState))[v74 := 0x191], multiset{v74, DC21(v59.f26, |v6|, multiset{v7[243]}, |v81|, v59.f27)}, multiset{v74} + v75, v75, v75, if (v68[573]) then v75 else v75, v75, v75 - v75, multiset(v82), v75, fm93(globalState), v75, fm93(globalState)];
				v83[300] := v75;
				v83[300] := v75 + v75;
				var v84: array<map<int, D16>> := new map<int, D16>[21](i6 => map[p1 := DC35(map[f7 := -v7[243]])]);
				var v85 := DC35(v2);
				var v86: map<int, D16> := map[v7[243] := v85];
				v84[285] := v86 + v86;
				var v87 := DC56(v86);
				v84[285] := (v87.(cf89 := v86)).cf89;
				var v88: array<D13> := new D13[6](i7 => if (p3) then DC28(map[seq(0x220, i8  => (v0[|v6|])) := v59.f27]) else DC28(map[v0 := v80.f21]));
				var v89: map<seq<int>, bool> := map[v0 := v68[573]];
				var v90 := DC28(v89);
				v88[633] := v90;
				v7, v88[633], r0 := v7, v90, -v7[243];
				...
				var v94: array<array<array<int>>> := new array<array<int>>[29] [v92, v92, v92, v93[f6], v92, v92, v92, v92, v92, v92, v92, v92, v92, v92, v92, v92, v92, v93[v7[243]], v93[f7], v92, if (v68[573]) then v92 else v92, v92, v92, v92, v92, v92, v92, v92, v93[f6]];
				v94[1] := v93[f7];
				v94[1], r0, v68, v7[243], v7 := v92, -v59.f26, v68, -p2, DC13(v7).cf27;
				r0 := v59.f26;
				...
				v98 := (multiset{v96})[DC44(v97) := v7[243]];
				var v99 := DC25(v4);
				v99 := if (v68[573]) then v99 else v99;
				r2 := v67[|v6|];
			}
		...
		v100[337] := v102;
		v100[337], r0, r1 := v102, 0x146, if (p3 ==> v59.f27) then !v59.f27 else v59.f27;
		r0 := p1;
...
class C13 extends T1, T0 {
	...
	function fm0(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<bool, bool>> {
		if (false) then map[|map[f6 := false]| := map[true := true]] + map[|map[!f8[f6] := f12]| := map[false := !false]] else map[f6 := map[true := true]]
	}
	function fm5(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): bool {
		f6 <= (|map[DC1(!true, false, true, false, false) := seq(0x2ab, i0  => (0x118))]| * f7)
	}
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		v0[288] := f7;
		v0[288] := f12;
		for i0 := DC0(f6).cf0 to v0[288] * f6 {
			var v1: map<int, int> := map[-f7 := f7];
			var v2: seq<int> := [f6];
			v1 := v1[i0 := v2[i0] % v0[288]];
			var v3 := DC2("hnpcxljf");
			v3 := v3;
			var v4 := true;
			r0 := !v4;
		...
		match (v8.(cf6 := "ueiqxagn")) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				v10[128] := v11;
				v10[128] := v11;
				var v12: seq<seq<int>> := [v9, v9 + [f12, f7], [|v7|], seq(-0x67, i2  => (f7)), v9];
				v0[288] := -|v12[-v0[288]]|;
			case DC2(cf6) =>
				var v13 := true;
				...
				v15 := v15;
				v0[288] := if (!v13) then v0[288] else v0[288];
				v0[288] := 0x36d + (v0[288] * f12);
				var v16: map<array<int>, bool> := map[v0 := v13];
				var v17: multiset<int> := multiset{f6, f7};
				var v18 := DC41(v13, v13, f12, f12);
				var v19 := new C4(true, v16, fm50(v13, |v17|, v18.cf69, globalState), f12 % -767, f6);
			case DC0(cf0) =>
				v7 := v7 + "mj";
				var v20 := false;
				r0 := v20;
		...
		if (v25) {
			...
			v27 := (v27[f6 := v7])[-(if (v25) then |v7| else |v28|) := v7];
			var v29: map<array<int>, bool> := map[v0 := v25];
			var v30: T2 := new C4(v25, v29, f8, -f6, |(seq(-0x4e, i4  => ('m')))|);
			var v31: map<T2, bool> := map[v30 := v25];
			var v32: multiset<int> := multiset{f6};
			var v33 := DC13(v0);
			var v34: map<multiset<int>, array<int>> := map[v32 := v33.cf27];
			v31, v0[288], v0[288], v34 := v31, f6 - (v0[288] - v26[f12]), v0[288], (v34 + map[v32 := v0])[multiset(v26) := v0];
			...
			v0[288] := --(v0[288] / fm45(v30.f9, v38, globalState));
		} else {
			...
			match (v46) {
				case DC52(cf84, cf85) =>
					...
					v47[438] := (cf84 < |map[v25 := v25]|) <==> (map[v25 := f6] in v49);
					v0[288] := 0x158;
				...
				case DC51(cf83) =>
					...
					var v51 := DC34(DC33(v0[288]));
					var v52: set<D15> := {v51, v51, v51};
					var v53: seq<set<D15>> := [v52, v52, v52, {v51}, v52];
					var v54: map<set<D15>, seq<int>> := map[v53[|v7|] := v41];
					var v55 := DC59(v54);
					...
					var v60 := DC34(v59);
					var v61: array<map<set<D15>, seq<int>>> := new map<set<D15>, seq<int>>[24] [v54, v54 + v54, v54[v52 := [-f6, --0x227]] + v54, v54, DC59(map[v52 := v41]).cf94, v54, v55.cf94, v54, v54 + v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54[v52 := [v0[288], |v57|]] + v54, map[v52 := v41] + map[{v51, DC34(v59), DC34(v59), DC34(v59), DC34(DC33(f12))} := v41], v54 + v54, v54, v54 + map[v52 := v41], v54 + v54];
					v61[906] := v54;
					var v62: array<string> := new string[13] [v7, v7, "ecsjser", seq(0x75, i6  => (v44)), seq(-0x1f8, i7  => (v44)), "k", v7, v7, seq(76, i8  => (v44)), v7, v7, v7, v7];
					var v63 := DC48(f7, p0, v62);
					var v64 := DC50(v63);
					var v65 := DC50(v64);
					var v66: multiset<int> := multiset{v0[288]};
					...
					v61[906], r0, v25, v25, v65 := v54, v25, v66 >= v66, (if (v69 in v68) then v68[v69] else v67) != v67, v65.(cf82 := DC49());
					v7 := v7;
				case DC53(cf86) =>
					...
					v7, v0[288], v70[578], v0[288], v71[548] := if (p0 <= p0) then seq(0xdf, i10  => (v44)) else v7, f7 % |p0|, !v25, |v77[f7]|, v78 + v78;
					v0[288] := f6;
			...
			v0[288] := f7 - |{v0[288], 0x69}|;
			var v80 := DC43(v41, v25, f8[|[v0]|]);
			if (v80.cf74) {
				v0[288] := |v7| + v0[288];
				r1 := v44;
				v0 := v0;
		...
		var v97: map<int, int> := map[0x9a * f6 := fm6(v25, v96.cf62, globalState) / |v7|];
		r2 := v97;
	}
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		var v0 := true;
		var v1 := "gh";
		var v2: multiset<bool> := multiset{DC12(f6, f6, p1, v0, |v1|).cf25, v0, f8[f7], p1, v0};
		...
		v1 := if (fm35("ch", globalState)) then v1[f7 := p0] else v1;
		var v5: array<bool> := new bool[14](i1 => !p1);
		v5[318] := if (p1) then v0 else p1;
		v5[318] := v0;
	}
}
...
class C14 extends T3 {
	...
	function fm1(globalState: GlobalState): map<seq<int>, int> {
		map[[|f11|, f6, |map[f7 := |[0x369, f6, f7, f7]|]|] + (seq(-0x6d, i0  => (-0xd6))) := 0x27f]
	}
	function fm0(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, map<bool, bool>> {
	...
	method m4(p0: map<bool, bool>, p1: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v5 := new C4(f9, f10, if (0x108 in v4) then v4[0x108] else f8, -0x57, f6 % f6);
			var v6 := 915;
			v6 := (|fm68(v0, f9, globalState)| - p1) % f6;
		}
		var v7: array<bool> := new bool[16] [f9, v0, true, v0, v0, f9, v0, v0, true, v0, f9, f9, false, f9, !v0, v0];
		var v8: seq<array<bool>> := [v7, v7];
		var v9: map<string, int> := map[f11 := |multiset{p1, |v8[f6 := v7]|}|];
		...
		v7[7] := v12 < v12;
		var v13 := 'd';
		var v14: map<char, bool> := map[v13 := v7[7]];
	...
	method m3(p0: string, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v8: seq<int> := [p2];
		var v9: map<set<D15>, seq<int>> := map[v7[-v1[900]] := v8];
		var v10 := DC59(v9);
		match (v10) {
			case DC60(cf95) =>
				v8 := (if (p1) then seq(0x213, i0  => (f6)) else v8) + v8;
				r1 := !f9;
				v1[900] := p2 - (if (p1) then p2 else p3);
			...
			case DC59(cf94) =>
				...
				match (DC23('c')) {
					case DC23(cf45) =>
						...
						var v13: C1 := new C1(p2, v2[541]);
						v12[405] := v13;
						var v14: multiset<int> := multiset{p3};
						var v15 := DC58(DC31(v3), true, p1);
						var v16: C10 := new C10(|map[v14 := v15.cf93]|, !v13.f27, f8, f7, v1[900] / p3);
						var v17: map<bool, int> := map[f9 := f7];
						var v18: set<bool> := {v2[541], p1};
						v12[405], v2[541], v16, v16.f16, r0 := v13, p1, v16, fm19(if (v13.f27) then v16.f17 else v2[541], v13.f27, |fm44(p0[v16.f16], globalState)|, globalState), f7 + (p3 - (if (f9 in v17) then v17[f9] else -|v18|));
						var v19: map<int, bool> := map[v16.f16 := !v13.f27];
						var v20 := DC33(f6);
						var v21: array<D15> := new D15[5] [DC33(|v19|).(cf57 := -|(seq(602, i1  => (v1[900])))|), DC33(v1[900]), v20, v20, v20];
						v21[688] := v20;
						v21[688] := v20;
						var v22: map<bool, char> := map[v2[541] := fm53(p0, p2, p1, |[201, f6]|, globalState)];
						v2[541], v1[900], r0 := !(v2[541] in f8[|v22| := f9]), p3, (if (v13.f27) then 0x2e6 else p2) / v8[v1[900]];
						v1[900] := fm23(v1[900] * v16.f16, !v13.f27, v16.f16, 0x29c, globalState);
				}
				
				if (p1) {
					var v23: map<bool, int> := map[v2[541] := |v0|];
					v1[900] := |v23[v2[541] := |(multiset{|v23|, |f8|})[p2 := p2]|]| / f6;
					var v24: set<bool> := {p1};
					v24 := v24;
					var v25: map<int, multiset<bool>> := map[v1[900] := v0];
					v2[541] := v0 != (if (p3 in v25) then v25[p3] else v0);
					r0 := if (|{fm10(v23, globalState)}| !in v8) then f6 else f6;
					v1[900] := -f6;
				} else {
					v8 := seq(0x340, i2  => (|(f11 + p0)|));
					var v26: map<int, int> := map[p3 := if (f9 in v0) then v0[f9] else f6];
					var v27 := 'c';
					var v28: map<char, string> := map[v27 := f11];
					var v29: C2 := new C2(-f6, f8, p3 / -f7, |v26| * |v28|);
					v29 := if (false) then if (f9) then v29 else v29 else v29;
					var v30 := DC7(v0);
					var v31: seq<D2> := [v30];
					v29.f29 := fm69(v31, globalState);
					r1 := (p2 >= f6) <== f9;
					var v32: set<int> := {v1[900]};
			...
			case DC61(cf96) =>
				if (|((seq(0x2b7, i3  => (|map[f9 := p1]|)))[v1[900] := |map[f7 := v8]|])[p2 := f6]| <= fm7(f7, f9, f11, globalState)) {
					v2 := v2;
					...
					v36 := v36[(fm40(p1, globalState))[p2 := p2] := multiset{v1}];
					var v37: map<int, bool> := map[|v8| * |p0| := f6 != f7];
					v37 := v37[p3 := p1];
				} else {
					var v38 := 'y';
					r1 := |(p0[|(seq(-863, i4  => (v1[900])))| := v38] + p0)| != p2;
					var v39: map<bool, seq<bool>> := map[p1 := [false]];
					var v40: map<int, bool> := map[p2 := p1];
					var v41: set<int> := {v1[900], p2, |f8|, p3, v8[|v40|]};
					var v42 := new C10(p3, p1, f8 + (if (p1 in v39) then v39[p1] else [p1]), |v41|, p2);
					var v43: map<bool, int> := map[true := v1[900]];
					r1 := !((f6 <= |map[fm10(v43, globalState) := false]|) && (if (v42.f17) then f8[v1[900]] else v42.f17));
				...
				if (false) {
					...
					var v48 := 't';
					v1[900], r1, v46[871] := v1[900], fm18(f9, -fm69([v47.(cf14 := v0), v47, DC7(v0), v47], globalState), globalState), (fm44(v48, globalState))[p2 := v48];
					r1 := p1 <== !(f9 ==> p1);
					r0 := if (p1) then fm23(p2, f9, -0x125, -p3, globalState) else p2;
				} else {
					v2[190] := f9;
					v2[190] := fm18(f9, -p3, globalState);
					var v49: map<bool, bool> := map[f9 := v2[190]];
					v1[900] := (f7 * -p2) * (f7 - |v49|);
					var v50: multiset<string> := multiset{f11};
					var v51 := DC54(v50);
					var v52 := 'v';
					v51, r1, v1[900], v52, r1 := v51, f8[f6], p3, v52, !(!f9 <== (v1[900] < f6));
					var v53 := DC32(f6, p0, f9);
					r0 := v53.cf54;
					var v54 := "ulcjfdgi";
					var v55 := DC2(f11);
					var v56 := DC3(v55);
					v54, v2[190] := p0, fm45(p1, v56, globalState) != 878;
				}
				...
				var v59 := 'o';
				v57 := (p0 + v58[f7])[p3 := v59];
		}
		
		v2[535] := if (f9) then p1 else f9;
		v2[535] := p2 <= p3;
		var v60 := 'q';
		...
		var v68 := DC31(v3);
		var v69: map<bool, int> := map[v2[535] := -f7];
	...
	method m1(p0: set<int>, globalState: GlobalState) returns (r0: bool, r1: char, r2: map<int, int>) {
		...
		r1, v0, r0, v1[380], v3 := v4, match v5 {
			case DC57(cf90) => v0
			case DC58(cf91, cf92, cf93) => -0x209
			case DC56(cf89) => -0x1fe
		}, false, p0, v6[if (false in v7) then v7[false] else v0];
		...
		var v17: array<bool> := new bool[20] [!false && f9, fm46(f9, globalState), f9, v4 in "guuucdgjt", !(if (v7 in v8) then v8[v7] else f9), f9, f9, f9, f9, !(f6 < v0), if (f7 in v9) then v9[f7] else f9, false, v12 !! multiset{fm19(false, f9, |f11|, globalState)}, f9, v13.cf3, v15.cf16, true !in v16, f9, f8[|v9|], f9];
		var v18: array<int> := new int[3] [f6, |v12|, f6];
		var v19: multiset<array<int>> := multiset{v18};
		r1, v17, v0, v19 := v4, v17, f7 - f6, v19[v18 := 0x197];
	...
	method m2(p0: char, p1: bool, p2: array<array<int>>, globalState: GlobalState) {
		...
		var v10 := 0x7c;
		v10 := v10;
		v0[22] := if (false) then v10 else |{p0}|;
		v0[22] := |fm95(false, v9[645], !f9, p0, globalState)|;
		for i0 := f6 to v10 {
			var v11: map<int, bool> := map[v0[22] := v6.f19];
			var v12: multiset<bool> := multiset{p1, f11 <= f11, v11 != map[v0[22] := true], p1};
			var v13: C10 := new C10(v10, v6.f19, fm56(f9, f9, p1, globalState), |(seq(0x163, i1  => (p0)))[|f11| := 'g']|, v10);
			var v14 := DC5(v13.f17, v0[22], v9[645], f8);
			var v15: map<D1, bool> := map[DC5(f9, v0[22], v9[645], f8) := v9[645]];
			...
			if (!!(f6 >= v13.f16)) {
				v16 := 0x138;
				v16 := v16 % (fm31(globalState) / v13.f16);
				var v19: seq<int> := [i0, v10, v16, f6, |v1|];
				var v20 := new C4(v6.f19, f10, f8 + f8, v13.f16 % |v19|, v0[22]);
				...
				v22[407] := v23;
				var v24 := "ifwr";
				v21, v22[407], v24 := v21, [v9, v9], f11;
				v0 := v0;
			} else {
				var v25: set<char> := {p0};
				var v26: C6 := new C6(v13.f17, v25, |((multiset(f8))[v6.f19 := v13.f16])[p1 := |[p0, 'i']|]|, i0);
				v26 := v26;
				v9 := v9;
				v17 := v9[645];
				var v27: array<map<map<bool, D28>, int>> := new map<map<bool, D28>, int>[11](i2 => map[map[v9[645] := DC62(map[seq(-0xf4, i3  => (p0)) := v10])] := f6]);
				var v29 := DC7(v12);
				var v30: seq<D2> := [v29];
				...
				v27[947] := map v28 : map<bool, D28> | v28 in v34 :: (v28) := (-(if (v13.f16 in v5) then v5[v13.f16] else 0x242));
				var v35: map<char, map<bool, D28>> := map[p0 := map[v6.f19 := v32]];
				var v36: map<map<bool, D28>, int> := map[if (p0 in v35) then v35[p0] else v33 := f6];
				v27[947] := v36;
				var v37: map<int, int> := map[0xa9 := v0[22]];
				var v38: set<int> := {v0[22], i0, fm3(v13.f16, fm63(globalState), |v37|, v26.f22, globalState), v0[22] + -f7, -351};
				v38 := {v0[22], -v13.f16, -0x1cf, |(seq(-0xa9, i4  => (map v39 : int | (-685 <= v39) && (v39 < 451) :: (v39 % f7) := (v13.f16))))[v0[22] := v37]|, v16};
			}
			
		}
		v9[645] := if (v9[645]) then v6.f19 else v9[645];
		if (v9[645]) {
			var v40: map<bool, bool> := map[v9[645] := f9];
			var v41 := DC30(v40);
			v2.m4(v41.cf52, v10 - v0[22], globalState);
			var v42: seq<string> := [f11];
			var v43: map<multiset<seq<bool>>, int> := map[multiset{f8, f8, f8, f8, f8[f7 := v6.f19]} := |v42[v0[22]]|];
			var v44: multiset<seq<bool>> := multiset{f8, f8};
			v43 := v43[v44 - v44 := f6];
			var v45: map<bool, int> := map[v9[645] := v0[22]];
			var v46 := DC37(v9, v6.f19, v0[22], v10);
			v10, v0, v9[645], v9[645] := (if (p1) then v10 else f7) - |v45|, v0, v46.cf62, v6.f19;
			v9[645] := !(f8 != (f8 + [v6.f19]));
			v9 := v9;
		} else {
			var v47 := DC45(p2);
			match (v47.(cf76 := p2)) {
				case DC45(cf76) =>
					var v48: set<int> := {v0[22]};
					var v49: T0 := new C3(f7, |[v6.f19]|, |v48|, v0[22]);
					var v50: seq<T0> := [v49];
					var v51: map<string, seq<T0>> := map[f11 := v50];
					v51 := v51;
					v0[22] := |f11|;
					v9 := new bool[13] [v6.f19, !v9[645], p1, v9[645], v9[645], fm2(v0[22], v6.f19, globalState), f9, v6.f19, v49.f7 < |f8|, f7 >= v0[22], v9[645], f9, !v6.f19];
					var v52 := DC4(v9);
					var v53 := DC6(v52);
				...
				case DC44(cf75) =>
					...
					v0[22] := if (fm57(v59, p0, v9[645], globalState)) then f6 / fm23(f7, v9[645], f6, f6, globalState) else f6;
					var v60: multiset<char> := multiset{p0, p0};
					var v62 := DC51(set v61 : char | v61 in v60 :: (v61));
					var v63: map<bool, D23> := map[p1 := v62];
					v63 := v63 + (v63[v9[645] := v62] + v63);
					var v64: multiset<bool> := multiset{v6.f19};
					var v65: map<int, multiset<bool>> := map[v0[22] := v64];
					var v66 := DC12(0x10f, v0[22], v6.f19, v57.f18[|v65|], 0x2e2);
	...
	method m5(p0: seq<int>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: set<int>, r3: int) {
		...
		match (fm96(v0, DC2(f11).cf6, v1, v1 - v1, globalState)) {
			case DC55(cf88) =>
				...
				r0, v9, r3, v10[132], v2[777] := v9.f12 > -v9.f12, v9, |(p0 + (seq(217, i3  => (0x10e))))|, v11, fm2(|v12|, p2, globalState);
		}
		...
		for i4 := f6 to f7 {
			...
			r1, v22[328], v25, v27 := p2, (v20 + v20) + v20, v25, v27;
		}
		var v28: map<bool, string> := map[f9 := f11];
		var v29: array<int> := new int[20];
		var v30: T3 := new C5((if (f9 in v28) then v28[f9] else (f11[f7 := v0])[f7 := v0]) + "vwbnqinay", p2, map[v29 := f9], f8, -|f11| / f7, f7);
		...
		var v37 := DC64(|multiset{v30.f9, f9}|, v30.f7, seq(0x56, i6  => (v0)), if (v30.f9) then p0 else p0[v30.f7 := if (f9 in v32) then v32[f9] else v30.f6], v36.cf107);
		match (v37) {
			case DC63(cf98, cf99, cf100, cf101, cf102) =>
				...
				var v39: array<char> := new char[7] [v30.f11[v30.f6], v0, v0, v0, v0, v0, fm53(v30.f11, v37.cf103, v30.f9, fm3(0x2b3, multiset{0xe8}, v30.f7, v30.f9, globalState), globalState)];
				v39[935] := v0;
				v39[935] := if (p1) then v0 else 'u';
				if (v30.f9) {
					var v40: map<int, int> := map[v30.f6 % -0xd1 := 0x212];
					v40 := v40 + v40;
					cf101 := f9;
					...
					v41, v29[16] := v30.f8 + v41, v30.f7 / -fm3(v30.f6, v42, if (v30.f6 in v40) then v40[v30.f6] else p0[f7], p2, globalState);
				} else {
					var v43: multiset<int> := multiset{f7};
					var v44: array<bool> := new bool[19] [v30.f9, |v30.f11| != |v30.f8|, v43 !! v43, cf101, false, p2, cf101, v30.f9, f9, f9, v30.f9, v30.f8[v30.f7], !fm30(true, multiset{p2}, globalState), true, false, fm30(v30.f9, multiset(v30.f8), globalState), fm78(v1, globalState) !! v38, v30.f9, p1];
					v44 := v44;
					cf100 := v30.f7;
					r3 := fm31(globalState);
			...
			case DC64(cf103, cf104, cf105, cf106, cf107) =>
				...
				v45[42] := fm4(|multiset{fm69(v47, globalState), cf103}|, globalState);
				v45[42] := v30.f9;
				var v48 := DC5(f9, v30.f6, f9, v30.f8);
				r3 := if ((seq(0x267, i7  => (v30.f7))) <= cf106) then -(v48.cf10 / cf103) else v30.f6 - 0x343;
			...
			case DC65(cf108) =>
				...
				var v61: map<array<T1>, int> := map[if (v30.f11[v30.f6 := v0] in v60) then v60[v30.f11[v30.f6 := v0]] else v59 := f6 / v30.f7];
				...
				v62 := v62;
				var v63 := new C13(v30.f7 + f7, v58.f8 + fm50(v30.f9, v30.f6, |f11|, globalState), -(|(seq(0x235, i9  => (v0)))| - v30.f6), f7);
		}
	...
	method m6(p0: bool, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<bool>, r1: bool, r2: bool) {
		var v0 := "cys";
		v0 := "dtry" + (v0 + f11);
		var v1, v2, v3, v4 := m5(seq(435, i0  => (f6)), p3, p2, globalState);
		...
		match (match v6 {
			...
			case DC29(cf50, cf51) =>
				...
				v7 := v7 + (map v8 : int | v8 in (map v9 : int | (0xbf <= v9) && (v9 < 0x9a) :: (v9 * cf50) := (true)) :: (v8 / |f8[|v0| := v1]|) := (p2));
			...
			case DC28(cf49) =>
				...
				var v15 := new C2(|fm50(p3, v4, f7, globalState)|, ([p2])[0x2d7 := v1] + f8, f6, if (v13 in v14) then v14[v13] else |f11|);
		...
		r2 := v22 !! (multiset(if (v3 in v23) then v23[v3] else f8))[v2 := f6];
	}
}
...
method Main() {
	...
	var globalState := new GlobalState(0x267, v3, 693, v6[|(map[v0 := v5[v4]])[v0 := v0]| := v5], 0x16f, v8 + v8);
	m0(globalState);
	v4 := v4;
	m0(globalState);
	var v9 := "dglddevro";
	...
	var v14: map<multiset<string>, seq<bool>> := map[v10 := v11[|v13|]];
	...
	for i0 := v12.f6 to |v18[v16.f24 := v0]| {
		if (!v0) {
			...
			var v31: array<int> := new int[29] [|"n"|, |v9|, v12.f7, |v29|, v16.f25, v16.f24, -0x100, v23.f29, v12.f6, 0x259, v16.f24, v16.f24, v12.f7, v28.f7, v12.f6, v16.f25, v12.f7, |(fm20(v16.f24, globalState))[0x2f7 := v16.f24]|, v23.f29, |v9|, v7[v28.f7], v12.f7, if (v16.f24 in v30) then v30[v16.f24] else v16.f25, 523, v16.f25, v28.f6, 0xcc, |v9|, v12.f7];
			...
			v0, v1[182], v24, v33, v30 := v0 ==> v28.f9, v39 >= v39, if (v28.f9) then (map[v40[|(seq(0x14f, i1  => (v38)))|] := v0])[v23 := v0] else v24, v33, (fm98(map[v16.f24 := v41.cf51], globalState)).cf59;
			v23.f29 := |((map v42 : int | (-713 <= v42) && (v42 < 0x281) :: (v42 * 795) := (true))[v12.f6 := false] + v18)|;
			v4 := -v4;
		} else {
			var v43 := DC37(v1, v0, |v7[v16.f25 := 0x355]|, v12.f6);
			...
			v43 := DC37(v1, v0, v16.f24 % v16.f24, |(v46 * v46)|);
		...
		var v57: array<string> := new string[29] [fm62(v54.f15, globalState) + (seq(0x19e, i2  => ('k'))), seq(-0x192, i3  => ('c')), v9, "m", v9, ("jrewvl")[v12.f6 := 'i'] + v9, v9 + "sjiwcd", v9 + v9, v9 + v9, v9, seq(794, i4  => ('e')), v9, seq(312, i5  => ('x')), "mnhcyoshk", fm8(v0, v0, v0, globalState), v9 + v9, "yjgnuiu", v9 + v9, v9, v9, v9, v9, v9, v9, v56[-168], "yvnatyolu", v9 + v9, v9, v9];
		v57[864] := "xktuuhtgi" + v9;
		v57[864] := v9 + v9;
		var v58: C1 := new C1(0x31f, v54.f15);
		var v59: seq<C1> := [v58];
		var v60: set<C1> := {v59[v16.f24], v58};
		...
		v64[775] := v65;
		v18, v63, v0, v64[775] := v18, v63, v54.f15, v65;
	}
	var v66: set<int> := {v16.f24, v16.f24};
	var v67, v68, v69 := v16.m1(v66, globalState);
	var v71: map<bool, int> := map[!v0 := |v9|];
	var v73: seq<map<int, bool>> := [v18, (map v70 : int | (0x1c1 <= v70) && (v70 < 0x3a1) :: (v70 % |map[v68 := v67]|) := (v0))[|v71| := v67], map v72 : int | v72 in v66 :: (v72 / v16.f24) := (v67), v18];
	...
	var v80 := DC0(v12.f6);
	var v81 := DC3(v80);
	v73, v67, v1[687], v4 := v75.cf109, v12.f8[|v76|], v79 != v79, --fm45(v67, v81, globalState);
	v7 := v7 + (seq(0xd9, i7  => (v12.f6)));
	var v82: C8 := new C8(v67, -v16.f25, v4 * v12.f6);
	v82 := v82;
	v9 := v9;
	v9 := v9;
	var v83: map<array<int>, bool> := map[v77 := v1[687]];
	...
	var v87: seq<T2> := [v84];
	var v88: set<multiset<T2>> := {v86, (multiset(v87))[v84 := |v76|], v86, v86};
	if ((|v88| / v7[v84.f6]) > 744) {
		v77[309] := v12.f7;
		v77[309] := v16.f24 % v4;
		if (v68 in (v9 + v9)) {
			var v89: array<D28> := new D28[10];
			var v90: map<string, int> := map[v9[v4 := v68] := |v9|];
			var v91 := DC62(v90);
			v89[411] := v91;
			v89[411] := v91;
			...
			v92[133] := v94.cf80 - v66;
			v77[309], v92[133] := v16.f24, {v84.f7, v16.f25 * v12.f7, v12.f6 + v16.f25, v84.f7 % v84.f7, v16.f25};
			v68 := v68;
			v9 := v9;
			var v95 := DC2(v9);
			var v96 := new C12(v95, v4, v16.f25);
		} else {
			var v97: C5 := new C5(v9, v16.fm32(v82.f19, v82.f19, v12.f8, seq(0x2b9, i9  => (v68)), globalState), v84.f10, v84.f8, -v84.f7, -256);
			...
			v98.m2(v9[|v74|], v84.f9, v101, globalState);
			v4 := v16.fm33(v84.f9, globalState);
		}
		
		var v102 := DC2(v9);
		var v103 := new C12(v102, v4, fm31(globalState) * |(seq(0x317, i10  => (v68)))|);
		var v104 := new C11(DC3(v81.cf7), v12.f8 <= v12.f8, v4 * |[v1[687], v82.f19]|, v84.f6);
		var v105: map<bool, string> := map[v0 := "ttna"];
		v0 := ((if (v82.f19 in v105) then v105[v82.f19] else v9) + (seq(984, i11  => (v68)))) != v9;
	} else {
		var v106 := DC4(v1);
		var v107 := DC6(v106);
		var v108 := DC6(v107);
		...
		v1[687], v117 := !v84.f9, v117;
		v77[710] := v84.f7;
		v77[710] := -(v16.f24 + 0x1ed) + v12.f7;
		v76 := (v76 - v76) - {fm30(v82.f19, v74, globalState)};
		var v118 := DC20(map[0x20b := v82.f19]);
		var v119: set<D7> := {v118};
		var v120 := DC47(v119);
		v120 := v120;
		v1[687] := !fm10(v71, globalState);
	}
	
	for i12 := v84.f6 % v12.f7 to v16.f25 {
		...
		v123[708] := v9;
		v123[708] := v9 + fm8(v84.f9, v1[687], v84.f9, globalState);
		v67 := v82.f19;
		v4 := -(v84.f6 * i12);
	}
	v4 := v12.f6;
