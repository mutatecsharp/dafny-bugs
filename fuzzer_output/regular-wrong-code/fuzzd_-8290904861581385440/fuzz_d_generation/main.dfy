...
class C1 extends T0 {
	...
	function fm14(p0: seq<int>, globalState: GlobalState): map<D1, bool> {
		map[DC4(seq(abs(0x30c), i0  => (DC2(f20, |map[f20 := |f27|]|, [!f20, f20], 0x23c, |map[293 := DC3(map[multiset([f20, f20]) := |multiset{f20, f20, f20, f20}|])]|)))) := f20] + (map[DC4(seq(abs(398), i1  => (DC2(f20, 0x2f4, [f20], |[0x13f]|, 449)))) := f20] + map[DC4(seq(abs(0x322), i2  => (DC2(f20, |map[f20 := DC1(f20, |[|map[|f27| := |multiset{f20}|]|, -0x58]|, |f27|).cf1]|, [false], |map[951 := |"yhnf"|]|, |map[f20 := f20]|)))) := !f20])
	}
}
...
class C2 extends T0 {
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: int) {
		...
		var v13: array<D1> := new D1[2] [if (f20) then DC4(v9[safeIndex(f25.f24, |v9|) := v8]) else v12, v12];
		v13[safeIndex(549, v13.Length)] := v12.(cf10 := v9);
		v13[safeIndex(549, v13.Length)] := v12;
		if (f20) {
			r0 := fm9(v5[safeIndex(-0x1df, |v5|)], globalState);
			...
			var v20: map<map<set<bool>, multiset<D1>>, array<string>> := map[v17 := v19[safeIndex(0x2ae, |v19|)]];
			...
			v23[safeIndex(629, v23.Length)] := v22.f24;
			v23[safeIndex(629, v23.Length)] := f25.f24;
		} else {
			var v24: array<map<bool, bool>> := new map<bool, bool>[28];
			var v25: map<bool, bool> := map[f20 := f20];
			v24[safeIndex(576, v24.Length)] := map[p0 := f26] + v25;
			...
			var v32 := "r";
			v24[safeIndex(576, v24.Length)] := v26[safeIndex(|v31| * |v32|, |v26|)];
			v10 := v10 + (if (p0) then v10 else v10[|([f25.f24])[safeIndex(f25.f24, |[f25.f24]|) := f25.f24]| := f25.f24]);
			var v33 := DC7([f25.f24]);
			var v34: set<D2> := {v33};
			var v35: seq<set<D2>> := [v34, v34];
			f26 := {v33, v33} !! v35[safeIndex(|v32|, |v35|)];
		...
		v37[safeIndex(296, v37.Length)] := |fm11(f25.f24, globalState)|;
		v37[safeIndex(296, v37.Length)] := f25.f24;
		var v38 := "nmahe";
		var v39 := 'm';
		var v40 := DC9(v38);
		var v42: set<int> := {v37[safeIndex(296, v37.Length)]};
		var v43: array<string> := new string[17] [v38, v38, v38 + v38, v38, v38, "cnp", ("iqfjf")[safeIndex(f25.f24, |"iqfjf"|) := v39] + v38, v38, v40.cf16, v38 + v38, v38[safeIndex(f25.f24, |v38|) := v39], "cbiytnt", v38, v38, "uc" + "b", "uusrltbmy", fm8(seq(abs(0x58), i4  => (v39)), (map v41 : int | v41 in v0 :: (v41 * f25.f24) := (f20))[|v42| := f26], v37[safeIndex(296, v37.Length)], globalState)];
		forall i3 | 0 <= i3 < v43.Length {
			v43[i3] := ("u" + v38) + (seq(abs(0x28), i5  => (v39)));
		}
		for i6 := f25.f24 - f25.f24 to v37[safeIndex(296, v37.Length)] {
			r0 := f26;
			...
			v45[safeIndex(716, v45.Length)] := f19;
			var v46: set<bool> := {p0};
			var v47: map<bool, bool> := map[p0 := p0];
			var v48: map<int, map<bool, bool>> := map[|v0| := v47];
			v45[safeIndex(716, v45.Length)] := new bool[7] [f26, v46 > v46, v39 in v38, f20, f20, v42 !! {|(if (0x78 in v48) then v48[0x78] else v47)|}, p0];
		...
		r3 := v37[safeIndex(296, v37.Length)];
	}
	method m5(globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: int) {
		...
		match (v2.(cf10 := v1)) {
			...
			case DC4(cf10) =>
				...
				v9[safeIndex(508, v9.Length)] := v12;
				v9[safeIndex(508, v9.Length)] := v12;
				var v13: array<string> := new string[28];
				v13 := v13;
				var v14 := "w";
				var v15 := DC9(v14);
				var v16 := DC9((seq(abs(0x111), i0  => (v10))) + v15.cf16);
				match (v15) {
					case DC10(cf17, cf18, cf19, cf20) =>
						var v17: seq<int> := [|(seq(abs(0x84), i1  => (v10)))|, f25.f24];
						...
						f19[safeIndex(103, f19.Length)] := f20;
						f19[safeIndex(103, f19.Length)] := !f20;
						var v21: set<bool> := {v10 in v14, f20 && f19[safeIndex(103, f19.Length)]};
						v21 := {f19[safeIndex(103, f19.Length)], v0[safeIndex(f25.f24, |v0|)], true};
					case DC11(cf21, cf22, cf23) =>
						cf22 := |v0[safeIndex(safeModuloInt(cf21, f25.f24), |v0|) := cf22 <= f25.f24]|;
						f19[safeIndex(317, f19.Length)] := f20 && f26;
						...
						f19[safeIndex(317, f19.Length)] := v27 != v27;
					...
					case DC9(cf16) =>
						...
						f19[safeIndex(666, f19.Length)] := !(0x29e != (if (f20 in v11) then v11[f20] else |v35|));
						...
						globalState.f18, f19[safeIndex(666, f19.Length)], globalState.f18, v36 := fm0(v11 <= v11, f26, globalState), f20, f25.f24, if (f25.f24 in v38) then v38[f25.f24] else if (["mti"] in v40) then v40[["mti"]] else v36;
				}
				
				globalState.f0 := f26;
			case DC6(cf12) =>
				f19[safeIndex(597, f19.Length)] := f20;
				var v41: seq<int> := [f25.f24];
				f19[safeIndex(597, f19.Length)] := v41 < v41;
				var v42: map<bool, C0> := map[f19[safeIndex(597, f19.Length)] := f25];
				var v43: map<bool, map<bool, C0>> := map[f26 := (map[f19[safeIndex(597, f19.Length)] := f25])[f20 := f25]];
				var v44: array<map<bool, C0>> := new map<bool, C0>[28] [v42, v42, v42, v42, map[true := f25], v42, v42, v42, v42, v42, v42, v42, v42, v42[f19[safeIndex(597, f19.Length)] := f25], v42, v42, map[f20 := f25], v42, if (f20 in v43) then v43[f20] else v42, map[f19[safeIndex(597, f19.Length)] := f25], v42, v42, v42, v42, v42, v42, map[v0[safeIndex(f25.f24, |v0|)] := f25], map[f20 := f25]];
				var v45: map<bool, int> := map[f19[safeIndex(597, f19.Length)] := fm0(f26, f19[safeIndex(597, f19.Length)], globalState)];
				var v46: seq<map<bool, int>> := [v45];
				var v47 := DC10(v44, v46[safeIndex(-0x207, |v46|)], {v2}, 0x3a4 - f25.f24);
				var v48 := 'l';
				var v49: seq<char> := [if (f26) then v48 else v48, v48];
				var v50: multiset<bool> := multiset{f19[safeIndex(597, f19.Length)]};
				var v51: set<multiset<bool>> := {v50 * v50};
				var v52: multiset<D1> := multiset{v2, v2};
				var v53: multiset<int> := multiset{-f25.f24, f25.f24};
				var v54: array<int> := new int[24] [if (v2 in v52) then v52[v2] else f25.f24, -f25.f24, safeModuloInt(f25.f24, f25.f24), -safeModuloInt(-f25.f24, -f25.f24), f25.f24, f25.f24, 0x28, 670, safeDivisionInt(-f25.f24, f25.f24), |v49|, 0x151, f25.f24, f25.f24 + f25.f24, f25.f24, |v49|, f25.f24, if (f19[safeIndex(597, f19.Length)]) then |"mxgapglw"| else f25.f24, f25.f24, if (f26) then 0x263 else -fm0(f26, f26, globalState), f25.f24 * f25.f24, |"x"|, 0x11b - f25.f24, f25.f24, |v50| + |v53|];
				v54[safeIndex(929, v54.Length)] := f25.f24;
				var v55: seq<array<map<bool, C0>>> := [v44];
				var v56 := DC2(f20, 682, v0, |v49|, f25.f24);
				var v57: map<int, bool> := map[v56.cf7 := f19[safeIndex(597, f19.Length)]];
				var v58: map<int, seq<char>> := map[|v57| := [v48, v48, v48]];
				v47, v49, v51, v54[safeIndex(929, v54.Length)] := v47.(cf17 := v55[safeIndex(f25.f24, |v55|)], cf18 := v45), if (|v0| in v58) then v58[|v0|] else ['e'] + [v48, v48], v51, -f25.f24;
				var v59 := DC11(f25.f24, f25.f24, f19[safeIndex(597, f19.Length)] <== f19[safeIndex(597, f19.Length)]);
				match (v59) {
					case DC10(cf17, cf18, cf19, cf20) =>
						var v60 := DC12(v48);
						var v61: map<D4, int> := map[v60.(cf24 := v48) := f25.f24];
						v61 := v61[v60 := safeModuloInt(f25.f24, f25.f24)];
						globalState.f0 := !(if (-(|v0| + |multiset{f25.f24}|) in v57) then v57[-(|v0| + |multiset{f25.f24}|)] else f20);
						f26 := f19[safeIndex(597, f19.Length)];
						var v62: set<bool> := {f26, v50[f26 := abs(f25.f24)] != v50, f20, f25.f24 >= f25.f24};
						var v63 := DC14(f19[safeIndex(597, f19.Length)], v62);
						v62 := (v63.(cf26 := v62)).cf26;
					case DC11(cf21, cf22, cf23) =>
						var v64: array<bool> := new bool[14](i2 => f25.f24 > cf22);
						v64 := v64;
						globalState.f18 := v54[safeIndex(929, v54.Length)];
		...
		if (f26) {
			...
			var v78: map<bool, multiset<int>> := map[f20 := v77[|multiset(v0)| := abs(|v0|)]];
			v77 := (if (f26 in v78) then v78[f26] else v77) - v77;
			var v79: C1 := new C1(seq(abs(0x114), i4  => ('j')), f19, f26);
			var v80: seq<C1> := [v79];
			...
			if (!(f26 || (f26 || !f20))) {
				...
				globalState.f18 := safeDivisionInt(f25.f24, |fm12(v77, |v90[|v79.f27| := f20]|, globalState)|);
			} else {
				f19[safeIndex(291, f19.Length)] := f26;
				var v91 := DC5(true);
				var v92 := 'o';
				var v93: T0 := new C1(v79.f27[safeIndex(-f25.f24, |v79.f27|) := v92], f19, f26);
				var v94: seq<T0> := [v93, v93];
				var v95: multiset<T0> := multiset{v93, v94[safeIndex(f25.f24, |v94|)], v93};
				f19[safeIndex(291, f19.Length)], r3, v91 := |v95| != (f25.f24 * f25.f24), f25.f24, if (f26) then DC5(v93.f20) else v91;
				r3 := safeModuloInt(|v75|, -f25.f24) - f25.f24;
				var v96: set<bool> := {f20};
				var v97 := new C0(safeDivisionInt(|v96|, f25.f24));
				var v98: array<D1> := new D1[26];
				v98[safeIndex(378, v98.Length)] := DC4(v1);
				v98[safeIndex(378, v98.Length)] := v2;
				globalState.f10 := v83;
			}
			
			f19[safeIndex(534, f19.Length)] := f20;
			f19[safeIndex(534, f19.Length)] := f20;
		} else {
			f19[safeIndex(329, f19.Length)] := true;
			f19[safeIndex(329, f19.Length)] := f26;
			...
			var v101: array<D0> := new D0[16](i5 => DC3(map[multiset{f19[safeIndex(329, f19.Length)], f20, f20, f19[safeIndex(329, f19.Length)]} := 0x76]));
			v100[safeIndex(174, v100.Length)] := v101;
			v100[safeIndex(174, v100.Length)] := v101;
			var v102: array<map<bool, bool>> := new map<bool, bool>[11](i6 => map[f19[safeIndex(329, f19.Length)] := f20] + map[f20 := f19[safeIndex(329, f19.Length)]]);
			v102 := v102;
		...
		v107[safeIndex(856, v107.Length)] := v108;
		v107[safeIndex(856, v107.Length)] := v108;
		r3 := f25.f24 - (f25.f24 + f25.f24);
		r0 := f26;
		r1 := if (false) then f20 else f26;
		r2 := |(v75 + (seq(abs(0x38e), i7  => ('c'))))|;
		r3 := |(v75 + (v75 + v75))|;
	}
}
...
class C3 {
	...
	function fm5(p0: bool, globalState: GlobalState): int {
		match DC3(map[multiset([false, true]) := |[true, false, true]|]) {
			...
			case DC3(cf9) => 0x4
			case DC0(cf0) => safeModuloInt(0xce, -0x3a7)
		}
	}
	function fm6(p0: bool, p1: map<int, int>, p2: string, p3: bool, globalState: GlobalState): int {
		|((seq(abs(0xd), i0  => (DC2(!true, |map[0x11b := !true]|, [true], 0x4e, 0xe7)))) + ([DC2(!true, 872, [false, true], 945, |{true}|)] + DC4(seq(abs(0x1ce), i1  => (DC2(false, |multiset{|map[true := |[!false, false]|]|}|, [false], -264, |[428]|)))).cf10))|
	}
	method m2(globalState: GlobalState) returns (r0: seq<bool>, r1: bool) {
		...
		var v5: array<int> := new int[4] [v0, 581 + v0, v4[safeIndex(-v0, |v4|)], v0];
		forall i0 | 0 <= i0 < v5.Length {
			v5[i0] := safeDivisionInt(i0, v0);
		}
		var v6 := new C0(safeModuloInt(v0, v0));
		var v7: multiset<bool> := multiset{v1};
		var v8 := DC0(v7);
		v8 := DC0(v7);
		var v9 := DC7(seq(abs(0x16), i1  => (|f22|)));
		v4 := v9.cf13;
		globalState.f18 := v0 - v0;
		r1 := |v2| < |[false, v1, true, v1, v1]|;
		var v10: seq<bool> := [fm7(v0, -v0, v0, globalState), v4 < (seq(abs(0x253), i2  => (v0)))];
		r0 := v10;
		r1 := v1;
	}
	method m3(globalState: GlobalState) {
		...
		var v10: map<map<bool, int>, map<bool, int>> := map[v8 := v9[safeIndex(v7, |v9|)]];
		var v11: map<bool, map<bool, int>> := map[false := v8];
		var v12: array<map<bool, C0>> := new map<bool, C0>[8];
		var v13: set<D1> := {DC4(seq(abs(0x2d4), i1  => (DC2(!v3.f20, v7, [v1[safeIndex(v7, |v1|)]], v7, v7))))};
		...
		if (v3.f20) {
			...
			var v25: seq<int> := [v7];
			var v26: seq<seq<int>> := [[if (|v8| in v24) then v24[|v8|] else v7, v7, |v25|], seq(abs(453), i3  => (|v8|))];
			var v27: seq<D0> := [DC2(v3.f20, v7, v1, v7, |f22|).(cf6 := v1, cf8 := v7)];
			var v28 := DC4(v27);
			var v29: seq<string> := [f22];
			var v30: multiset<D1> := multiset{v28.(cf10 := [DC2(!v3.f20, v7, v1, v7, |v29[safeIndex(v7, |v29|)]|)]), v28};
			var v31: array<int> := new int[27] [|v16|, |f22|, if (v0) then v7 else 0x353, fm0(false, v3.f20, globalState) * v7, -v7, v7 + v7, -v7, 0x18e, |({v3.f20} - fm17(|f22|, globalState))|, v7, |"qnxjphmtm"|, |v19|, v7, fm0(v3.f20, v21.cf33, globalState), safeModuloInt(v7, v7), -(-v7 * v7), v7, v7, |v26[safeIndex(v7, |v26|)]|, v7, v7, v7, v7, v7, v7 * |v30|, |(f22 + "w")|, v7];
			v22[safeIndex(209, v22.Length)] := v7;
			var v32: array<seq<D3>> := new seq<D3>[13];
			var v33 := DC19(|v24|, v3.f20, v32, v3.f20, v17);
			v22[safeIndex(209, v22.Length)], globalState.f0, globalState.f0, globalState.f13 := v7 - v7, v1[safeIndex(v7, |v1|)], v33.cf36, v7;
		} else {
			globalState.f0 := (multiset{v3.f20})[v3.f20 := abs(v7)] !! multiset{v0, !v3.f20, v0};
			if (v0) {
				...
				v38[safeIndex(621, v38.Length)] := |[v39]|;
				v38[safeIndex(621, v38.Length)] := v7;
				v7 := safeModuloInt(v7 + v34.f24, v38[safeIndex(621, v38.Length)]);
				v3.f19[safeIndex(300, v3.f19.Length)] := !(v3.f20 || v3.f20);
				v3.f19[safeIndex(300, v3.f19.Length)] := false;
				var v40: seq<int> := [v38[safeIndex(621, v38.Length)] * v38[safeIndex(621, v38.Length)], v7];
				globalState.f13 := v40[safeIndex(v34.f24, |v40|)];
			} else {
				var v41 := DC9(f22);
				...
				v51[safeIndex(56, v51.Length)] := v49;
				v51[safeIndex(56, v51.Length)] := v49;
		...
		if (!v0) {
			...
			var v57 := 'p';
			globalState.f13 := |((f22 + f22[safeIndex(v7, |f22|) := v57]) + "usturyl")|;
			if (v3.f20) {
				var v58 := DC13();
				v58 := v58;
				...
				var v69 := new C1("sjlkirkt", if (v67 in v68) then v68[v67] else v3.f19, v1[safeIndex(v7, |v1|)]);
			} else {
				...
				var v72: C1 := new C1(seq(abs(38), i4  => (v57)), f23, v3.f20);
				...
				var v80: array<int> := new int[16] [v7, v7, v7, v7, v7, v75[safeIndex(v7, |v75|)], v7, -safeDivisionInt(v7, v7), v7 - v7, |v79|, fm5(v3.f20, globalState), |v1| + v76.f24, v7, |(if (v3.f20) then v1 else v1)|, |(f22 + f22)[safeIndex(v76.f24, |(f22 + f22)|) := v57]|, v7 * -v76.f24];
				v80[safeIndex(546, v80.Length)] := v76.f24;
				v80[safeIndex(825, v80.Length)] := safeDivisionInt(v76.f24, |[v3.f20, v0]|);
				globalState.f13, v80[safeIndex(546, v80.Length)], v80[safeIndex(825, v80.Length)] := v7 - v76.f24, v7, v7;
			...
			var v84: seq<int> := [|v83|];
			var v85: map<set<bool>, int> := map[v82 := v84[safeIndex(v7, |v84|)]];
			var v86: map<int, int> := map[v7 := v7];
			var v87: map<map<int, int>, bool> := map[v86 := true];
			if ((if (v82 in v85) then v85[v82] else v7) < -|v87|) {
				var v88: set<int> := {safeModuloInt(v7, v7), v7, fm0(v3.f20, v3.f20, globalState), v7};
				v88 := (set v89 : int | v89 in multiset{|f22|} :: (safeModuloInt(v89, |multiset([[true], [false]])|))) * v88;
				var v90 := 'p';
				...
				var v96: array<seq<D0>> := new seq<D0>[23](i5 => [DC0(multiset(v1[safeIndex(|v1|, |v1|) := v3.f20])), DC0(multiset{v3.f20, v3.f20, v3.f20, !v3.f20, v3.f20}), DC0(multiset(v1))]);
				var v97: multiset<bool> := multiset{v0};
				var v98 := DC0(v97);
				var v99: seq<D0> := [DC0(v97), v98];
				v96[safeIndex(420, v96.Length)] := if (v3.f20) then v99 else v99;
				v96[safeIndex(420, v96.Length)] := (v99[safeIndex(-v7, |v99|) := DC0(fm20(v3.f20, v7, globalState))])[safeIndex(v7, |v99[safeIndex(-v7, |v99|) := DC0(fm20(v3.f20, v7, globalState))]|) := if (v3.f20) then v98 else fm21(v7, globalState)];
			} else {
				...
				var v110: array<int> := new int[28] [|f22|, v7, if (v3.f20) then v7 else -v7, safeModuloInt(-v7, 0x285), -v7, v7, -0x171, |map["brlgftm" := false]|, v7, 0x7a, v7, v7 * -v7, safeDivisionInt(-v7, v7), v7, v7 * |(set v101 : string | v101 in v100 :: (v101))|, --(if (v3.f20) then v7 else v7), safeModuloInt(|f22|, |v11|), v7, |v100|, v7, 0x3ae - -v7, v7, safeModuloInt(406, v7), v7, if (v109 in v104) then v104[v109] else v7, v7 - v7, v7, v7 * v7];
				v110[safeIndex(266, v110.Length)] := v7;
				v110[safeIndex(266, v110.Length)] := v7;
				var v111 := new C1(v102.f27, f23, v3.f20);
				var v112: map<int, bool> := map[v110[safeIndex(266, v110.Length)] + v110[safeIndex(266, v110.Length)] := false];
				v112 := v112[v7 * v110[safeIndex(266, v110.Length)] := v3.f20];
				v82 := (v82 * v82) * v82;
				v8 := v8[v3.f20 := v110[safeIndex(266, v110.Length)]];
			}
			...
			var v119: map<int, set<bool>> := map[v7 := {!(if (-341 in v118) then v118[-341] else v1[safeIndex(v7, |v1|)])}];
			var v120: array<set<bool>> := new set<bool>[19] [v114[safeIndex(-v7, |v114|)], {v3.f20, if ('w' in v116) then v116['w'] else v3.f20}, v82, v82, v82, v82, v82, fm17(|v117|, globalState), v82 - v82, {v3.f20, v3.f20, v3.f20}, v82 + (if (|f22| in v119) then v119[|f22|] else v82), v82, v82, fm17(v7, globalState) - {v3.f20, v3.f20, v3.f20, v3.f20, v3.f20}, v82, v114[safeIndex(v7, |v114|)], v82, v82 - v82, v82 - v82];
			v120[safeIndex(274, v120.Length)] := v82;
			v120[safeIndex(274, v120.Length)] := (v82 + v82) * {v3.f20, v0};
			var v121: array<seq<D3>> := new seq<D3>[24](i6 => [DC11(v7, |v118|, v3.f20), DC11(|v84|, |v117|, v3.f20), DC11(|(seq(abs(-0x281), i7  => (|v117|)))|, |(seq(abs(830), i8  => ('a')))|, v3.f20), DC11(v7, v7, true), DC11(v7, v7, v3.f20)]);
			var v122 := DC19(v7, v3.f20, v121, v0, v115);
			v117 := v117[v122.cf38 := !true];
			globalState.f18, globalState.f0 := v7, v1[safeIndex(|f22|, |v1|)];
			v7 := v7;
		}
...
class C4 extends T0 {
	...
	method m0(p0: bool, p1: set<bool>, globalState: GlobalState) {
		...
		if (match v2 {
			...
			if (p0) {
				...
				var v9: seq<int> := [f21];
				var v10: array<multiset<bool>> := new multiset<bool>[26] [multiset{p0, f20, p0}, (if (f21 in v7) then v7[f21] else v1)[!f20 := abs(0x8a)], v1 - v1, (multiset(v5))[p0 := abs(f21)], v1, v1, multiset(v5), v1, v1, v1, (multiset{p0})[p0 := abs(f21)] - v1, v1, if (f20) then v1 else v1, v8[safeIndex(|v9|, |v8|)], multiset{fm2(f20, f21, f21, globalState)} + v1, fm1(f21, f21, f20, globalState), fm1(f21, |p1|, true, globalState) * multiset{f20, false}, v2.cf0, multiset(v5), fm1(f21, f21, p0, globalState), fm1(f21, f21, f20, globalState), multiset{f20, f20, !true, false, p0}, multiset{false, f20} + v1, v8[safeIndex(|v1|, |v8|)], v1, v2.cf0];
				v10[safeIndex(580, v10.Length)] := fm1(-f21, f21, fm2(p0, f21, f21, globalState), globalState);
				v10[safeIndex(580, v10.Length)] := v1;
			} else {
				var v11: map<bool, bool> := map[p0 := p0];
				f19[safeIndex(883, f19.Length)] := p0;
				v11, globalState.f0, globalState.f0, f19[safeIndex(883, f19.Length)] := v11, v0 == (v0 + v0), true, f20 ==> !f20;
				var v12: seq<int> := [f21];
				var v13: map<bool, seq<int>> := map[f19[safeIndex(883, f19.Length)] := v12];
				var v14: set<seq<int>> := {(if (p0 in v13) then v13[p0] else [f21, f21]) + v12, (seq(abs(292), i0  => (0x1ae)))[safeIndex(f21, |(seq(abs(292), i0  => (0x1ae)))|) := f21] + v12};
				globalState.f0, v14, globalState.f13 := |(v11 + v11)| > (-f21 - f21), {fm3(globalState)}, safeDivisionInt(f21, |v3|);
				var v15: array<int> := new int[5];
				v15[safeIndex(320, v15.Length)] := 0x315;
				globalState.f0, v15[safeIndex(320, v15.Length)] := p0, f21;
				globalState.f0 := f20;
				v0 := v0;
			}
			...
			globalState.f3 := v24;
			if (f20) {
				f19[safeIndex(410, f19.Length)] := true <==> !p0;
				var v25: map<bool, int> := map[f20 := f21];
				globalState.f0, f19[safeIndex(410, f19.Length)], v22 := p0, v25 != v25, [f20] + v22;
				var v26: array<bool> := new bool[23] [f19[safeIndex(410, f19.Length)], f20, false, true, false, p0, false, f20, f20, f19[safeIndex(410, f19.Length)], p0, p0, f19[safeIndex(410, f19.Length)], f19[safeIndex(410, f19.Length)], f20, true, f20, f20, f19[safeIndex(410, f19.Length)], p0, f19[safeIndex(410, f19.Length)], p0, f20];
				...
				var v32 := new C2(v31, f19[safeIndex(410, f19.Length)], v26, f20);
			} else {
				var v33: multiset<int> := multiset{f21};
				var v34: map<int, bool> := map[-|v33[f21 := abs(f21)]| := f20];
				...
				v40 := v40[f20 := v36.f24];
				v24[safeIndex(978, v24.Length)] := safeModuloInt(f21, f21);
				v37.f19[safeIndex(627, v37.f19.Length)] := p0;
				var v41: map<bool, string> := map[v37.f20 := v0];
				globalState.f18, globalState.f13, v24[safeIndex(978, v24.Length)], v37.f19[safeIndex(627, v37.f19.Length)], globalState.f18 := 948, 0x21e, f21, fm7(safeDivisionInt(-|(if (fm7(f21, f21, f21, globalState) in v41) then v41[fm7(f21, f21, f21, globalState)] else "bxledcrb")|, if (f21 in v35) then v35[f21] else f21), v36.f24, f21, globalState), -f21;
				var v42 := DC9(v0);
				var v43: array<int> := new int[17] [fm0(v37.f19[safeIndex(627, v37.f19.Length)], f20, globalState), |"xw"|, 0x344, 0x15e, f21, |v0|, v24[safeIndex(978, v24.Length)], f21, f21, --|(seq(abs(0xe9), i1  => (v18)))|, |"yqgtfnndn"|, safeModuloInt(v36.f24, v36.f24), |v42.cf16| + |p1|, v24[safeIndex(978, v24.Length)], -f21, v36.f24, f21 - v24[safeIndex(978, v24.Length)]];
				globalState.f10 := v43;
				v37.f19[safeIndex(627, v37.f19.Length)] := !(p0 <==> fm7(f21, |{v37.f20, v37.f20, false}|, v36.f24, globalState));
			}
			
			var v44 := DC9(seq(abs(0x3de), i2  => (v18)));
			var v45: array<D3> := new D3[22] [v44, v44, v44, v44, v44, v44, DC9(v0), v44, v44, v44.(cf16 := v44.cf16), v44, v44, v44, v44, v44, v44, v44, if (p0) then v44 else v44, v44, v44, v44.(cf16 := v0[safeIndex(f21, |v0|) := v18]), v44];
			v45 := v45;
		}
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		for i0 := f21 to f21 {
			...
			v4[safeIndex(86, v4.Length)] := i0;
			v4[safeIndex(722, v4.Length)] := i0;
			var v5: seq<bool> := [f20, f20];
			var v6: multiset<int> := multiset{f21};
			globalState.f13, v3, v4[safeIndex(86, v4.Length)], v4[safeIndex(722, v4.Length)], globalState.f0 := -|[v5, v5]|, fm23(globalState).(cf15 := |(v6 + multiset{0x1c})|), |v2.f22|, safeModuloInt(i0, f21), f20;
			if (f20) {
				var v7: map<bool, bool> := map[f20 := f20];
				var v8: seq<int> := [v4[safeIndex(86, v4.Length)], f21, f21, f21, v4[safeIndex(86, v4.Length)]];
				var v9: array<bool> := new bool[28] [f20, !(if (f20 in v7) then v7[f20] else f20), v2.f22 != (seq(abs(563), i1  => ('u'))), f20, f20, !true, f20, !(multiset{v4[safeIndex(86, v4.Length)]} >= multiset(v8)), f20, f20, f20, false, v1.fm13(globalState), f20, f20, f20, v6 !! v6, f21 > i0, f20, f20, f20, f20, f20, f20, f20, !true, f20, f20];
				v9 := f19;
				var v10 := 'q';
				var v12: seq<map<int, bool>> := [map v11 : int | v11 in v8 :: (safeModuloInt(v11, v4[safeIndex(86, v4.Length)])) := (f20)];
				var v13: map<int, bool> := map[f21 := f20];
				var v14 := new C3(fm8(fm8([v10], v12[safeIndex(i0, |v12|)], |v2.f22|, globalState), v13, f21, globalState), v9);
				var v15: set<int> := {v4[safeIndex(86, v4.Length)]};
				var v16: map<char, bool> := map[v10 := v15 !! {v4[safeIndex(86, v4.Length)], |v2.f22|}];
				v16 := v16;
				v4[safeIndex(86, v4.Length)] := --0xb2;
				var v17: array<D1> := new D1[2];
				var v18 := DC5(f20);
				v17[safeIndex(29, v17.Length)] := v18;
				var v19 := DC2(f20, f21, v5, safeDivisionInt(v4[safeIndex(86, v4.Length)], 0x355), -|v2.f22|);
				var v20: map<int, int> := map[v4[safeIndex(86, v4.Length)] := i0];
				var v21: multiset<bool> := multiset{v1.f27 != v2.f22, v5[safeIndex(i0, |v5|)], !f20, i0 == v4[safeIndex(86, v4.Length)], f20};
				var v22: multiset<char> := multiset{v10, v10};
				v17[safeIndex(29, v17.Length)], v19, v20, globalState.f0, v21 := DC5(f20), v19, v20 + map[if (v10 in v22) then v22[v10] else 0x331 := i0], f20, v21 * (v21 * v21);
			} else {
				r0 := i0;
				v5, globalState.f0 := v5, f20;
				v2.m3(globalState);
				var v23: map<string, int> := map["iqw" := v4[safeIndex(86, v4.Length)]];
				var v24: map<int, string> := map[f21 := v1.f27];
				var v25: map<bool, int> := map[false := v4[safeIndex(86, v4.Length)]];
				var v26: multiset<map<bool, int>> := multiset{map[f20 := v4[safeIndex(86, v4.Length)]], v25[f20 := i0]};
				var v27: map<int, int> := map[-0x33f := if (v25 in v26) then v26[v25] else -0x393];
				v23 := v23[v0 + (if (i0 in v24) then v24[i0] else v0) := |v27[v4[safeIndex(86, v4.Length)] := v4[safeIndex(86, v4.Length)]]|];
				var v28 := 'y';
				v28 := v28;
			}
		...
		v29[safeIndex(183, v29.Length)] := f21;
		v29[safeIndex(183, v29.Length)] := f21;
		var v30 := 'a';
		var v31 := DC12(v30);
		...
		var v35 := DC1(true, f21, v29[safeIndex(183, v29.Length)]);
		v34 := new C1(v32, if (DC17(v29[safeIndex(183, v29.Length)], |"qedpt"|, v35, f20, true).cf32) then v34.f19 else f19, v34.f20);
		for i2 := |(seq(abs(-0x20f), i3  => (v30)))| - f21 to v29[safeIndex(183, v29.Length)] {
			var v36: multiset<int> := multiset{v29[safeIndex(183, v29.Length)], fm0(v34.f20, f20, globalState)};
			var v37: map<bool, multiset<int>> := map[fm7(v29[safeIndex(183, v29.Length)], v29[safeIndex(183, v29.Length)], i2, globalState) := v36];
			v37 := map[f20 := v36 + v36];
			globalState.f0 := f20;
			var v38: multiset<string> := multiset{v32 + (seq(abs(42), i4  => (v30))), v32 + v32, v32, v32, (if (v34.f20) then v32 else v32)[safeIndex(f21, |(if (v34.f20) then v32 else v32)|) := v30]};
			v38 := v38;
			var v39: array<bool> := new bool[12];
			v34.f19[safeIndex(306, v34.f19.Length)] := !f20;
			var v40: multiset<bool> := multiset{v34.f20, v34.f20, false};
			globalState.f0, v39, v29[safeIndex(183, v29.Length)], v34.f19[safeIndex(306, v34.f19.Length)] := v34.f20, v34.f19, safeDivisionInt(f21, v29[safeIndex(183, v29.Length)]), v40 !! v40[v34.f20 := abs(i2)];
		}
		for i5 := v29[safeIndex(183, v29.Length)] to v29[safeIndex(183, v29.Length)] {
			if ((f21 <= v29[safeIndex(183, v29.Length)]) <==> f20) {
				var v41: map<bool, int> := map[v34.f20 := v29[safeIndex(183, v29.Length)]];
				...
				v29[safeIndex(183, v29.Length)] := safeDivisionInt(-v29[safeIndex(183, v29.Length)], -v29[safeIndex(183, v29.Length)]);
				globalState.f0 := f20;
				...
				v48[safeIndex(250, v48.Length)] := v47;
				v43, v45, v29[safeIndex(183, v29.Length)], v48[safeIndex(250, v48.Length)] := v43, v45, f21, v47;
				...
				v51 := v51;
				var v52: map<bool, int> := map[v34.f20 := -v29[safeIndex(183, v29.Length)]];
				v49 := v49[v34.f20 := abs(|v52|)] + v49;
			...
			var v57: map<seq<string>, string> := map[v56 := seq(abs(0xb6), i7  => (v30))];
			v57 := v57[if (fm9(f20, globalState)) then v56 else v56 := seq(abs(-291), i8  => (v30))];
			if (f20) {
				...
				globalState.f18 := -(-fm0(v34.f20, true, globalState) - v29[safeIndex(183, v29.Length)]);
				v29[safeIndex(183, v29.Length)] := 260;
				var v62: array<map<bool, C0>> := new map<bool, C0>[24];
				var v63: map<bool, int> := map[fm9(v34.f20, globalState) := i5];
				var v64 := DC2(f20, i5, v54, v29[safeIndex(183, v29.Length)], |[f20]|);
				var v65: seq<D0> := [v64];
				var v66: set<D1> := {DC4(v65)};
				var v67: set<bool> := {f20, f20, v34.f20};
				var v68 := DC14(!false, v67);
				v33 := v33[DC10(v62, v63, v66, f21).cf20 := v68.cf25];
				var v69: array<char> := new char[5] [v30, v30, 'o', v30, v32[safeIndex(v29[safeIndex(183, v29.Length)], |v32|)]];
				v69[safeIndex(855, v69.Length)] := v30;
				v69[safeIndex(855, v69.Length)] := 'u';
			} else {
				var v70: multiset<bool> := multiset{i5 < 0x224, v34.f20, v34.f20, v34.f20 <==> f20};
				v70 := v70 + (if (v34.f20) then v70 else v70);
				var v71: C0 := new C0(v29[safeIndex(183, v29.Length)]);
				var v72: map<bool, C0> := map[v34.f20 := v71];
				var v73: seq<C0> := [v71];
				var v74: map<bool, int> := map[f20 := v29[safeIndex(183, v29.Length)]];
				var v75: array<map<bool, C0>> := new map<bool, C0>[17] [v72, v72, v72, v72, v72, v72, v72, v72, map[v34.f20 := v73[safeIndex(|v74|, |v73|)]], v72, v72, v72, v72, v72, v72, v72, v72];
				var v76 := DC4(fm24(globalState));
				var v77 := DC2(v34.f20, v71.f24, v54, 0x25c, v29[safeIndex(183, v29.Length)]);
				var v78: seq<D0> := [v77];
				var v79: set<D1> := {v76.(cf10 := v78), DC4(v78)};
				var v80 := DC10(v75, map[true := f21], v79, -0x2d7);
				v29[safeIndex(183, v29.Length)] := v80.cf20;
				globalState.f0 := if ((map v81 : int | (0x20f <= v81) && (v81 < 0x75) :: (v81 * v71.f24) := (v34.f20)) !in [fm25(globalState)]) then v34.f20 else v34.f20;
				v29[safeIndex(183, v29.Length)] := v29[safeIndex(183, v29.Length)];
				v70 := multiset{f20};
			}
			
		}
		r0 := safeModuloInt(f21 + v29[safeIndex(183, v29.Length)], f21);
	}
}
...
function fm19(p0: bool, globalState: GlobalState): map<int, int> {
	(map v0 : int | v0 in (seq(abs(818), i0  => (|[true]|))) :: (safeModuloInt(v0, |"pkhneayht"|)) := (0x247)) + (map[-379 := 887] + map[|map[false := DC17(-|multiset{true}|, |multiset{-0x101, 187, 0x38f, 0x15}|, DC1(true, |[|[|map[|map[|[false, false, false]| := false]| := 'w']|]|, 0x2d9]|, 0x31e), false, true)]| := |multiset([false])|])
}
...
function fm24(globalState: GlobalState): seq<D0> {
	[DC2(true, |multiset{false, true, true, true, !false}|, [false], 74, |"nrcsueoj"|)] + (seq(abs(0x2fa), i0  => (DC2(false, -|[-536, |"jva"|]|, [false, false], 0x222, -596))))
}
...
method Main() {
	...
	var v8: array<array<int>> := new array<int>[3] [v3, v3, v7[safeIndex(491, |v7|)]];
	...
	for i2 := v0 * |v16[safeIndex(v0, |v16|) := v15]| to |v4| {
		...
		decreases 100 - i3
	{
		...
		v24 := v24;
		v15.f23[safeIndex(254, v15.f23.Length)] := v9 <==> v22.f20;
		var v25: map<int, bool> := map[v0 := v9];
		v15.f23[safeIndex(254, v15.f23.Length)] := v14 != fm8(v14, v25, v24.f21, globalState);
		var v26: array<string> := new string[2];
		v26[safeIndex(233, v26.Length)] := v15.f22;
		v26[safeIndex(233, v26.Length)] := v15.f22;
	}
		...
		decreases 100 - i5
	{
		...
		i5 := i5 + 1;
		globalState.f0 := safeModuloInt(v0, 155) <= 0x34d;
		var v29: map<bool, bool> := map[v28 := v28];
		globalState.f18 := safeDivisionInt(v0, v15.fm5(if (v28 in v29) then v29[v28] else v9, globalState));
		if (v0 !in v1) {
			globalState.f13 := v0;
			var v30: T0 := new C1(seq(abs(0x3c3), i6  => (v13)), v15.f23, v9);
			var v31: seq<T0> := [v30, v30];
			v31, globalState.f18 := [v30, v30, v30] + v31, -v0;
			var v32, v33 := v15.m2(globalState);
			globalState.f18 := fm0(v9, v9, globalState) * safeModuloInt(v0, v0);
	...
	v44[safeIndex(957, v44.Length)] := v45;
	v44[safeIndex(957, v44.Length)] := v45 * (v45 - v45);
	...
	v4 := match v48 {
		case DC5(cf11) => v4
		case DC4(cf10) => v4
		case DC6(cf12) => v4 + (set v49 : int | v49 in v44[safeIndex(957, v44.Length)] :: (v49 * |[258]|))
	};
	v15.f23[safeIndex(23, v15.f23.Length)] := false;
	...
	v15.f23[safeIndex(23, v15.f23.Length)] := |v52| != |v53|;
	match (fm27(!v28, map v54 : int | (0x2c8 <= v54) && (v54 < 0x2c9) :: (safeDivisionInt(v54, --v0)) := (DC11(v0, v0, v28)), globalState)) {
		case DC1(cf1, cf2, cf3) =>
			v1 := v2 + (v2 + [648, |(map v55 : int | (828 <= v55) && (v55 < 0x307) :: (v55 - v50.f24) := ({v13}))|]);
			cf3 := cf2;
			var v56 := new C2(v50, v51.f20, v15.f23, v15.f23[safeIndex(23, v15.f23.Length)]);
			if (v56.f26 <==> v51.f20) {
				var v57: multiset<bool> := multiset{v51.f20};
				cf2 := -safeDivisionInt(|v57[v56.f26 := abs(v1[safeIndex(|map[cf1 := true]|, |v1|)])]|, v50.f24);
				...
				v60[safeIndex(725, v60.Length)] := v4;
				var v61 := DC26({v0});
				cf3, globalState.f13, v15.f23[safeIndex(23, v15.f23.Length)], v60[safeIndex(725, v60.Length)] := safeModuloInt(v50.f24, v0), v50.f24, v51.f20, v61.cf49;
				var v62: seq<array<bool>> := [v15.f23];
				var v63 := new C3("kfcjm", v62[safeIndex(v0, |v62|)]);
				var v64: C1 := new C1(v15.f22, v15.f23, true);
				var v65: seq<seq<C1>> := [[v64, v64]];
				v4 := v60[safeIndex(725, v60.Length)] - {|v65[safeIndex(v50.f24, |v65|)]|};
			} else {
				var v66: array<string> := new string[21](i8 => v15.f22);
				v66[safeIndex(746, v66.Length)] := v14;
				v66[safeIndex(746, v66.Length)] := v15.f22;
				var v67: set<array<bool>> := {v6};
				v67 := v67 * v67;
				v9 := v9;
				v56.f26 := !(!([cf2, v50.f24] <= v1) !in {v51.f20, cf1, v56.f26});
				var v68: array<seq<bool>> := new seq<bool>[1](i9 => v27[safeIndex(v50.f24, |v27|) := true]);
				v68 := v68;
			}
			
		case DC2(cf4, cf5, cf6, cf7, cf8) =>
			globalState.f0 := cf4;
			v3[safeIndex(447, v3.Length)] := v50.f24;
			v3[safeIndex(447, v3.Length)] := v50.f24;
		...
		case DC3(cf9) =>
			...
			v70, globalState.f0, v15.f23[safeIndex(23, v15.f23.Length)], v15.f23[safeIndex(23, v15.f23.Length)], v9 := v70, v51.f20, !v9, true, v15.f23[safeIndex(23, v15.f23.Length)];
			var v71 := new C0(v0 - v0);
			v15.m3(globalState);
		case DC0(cf0) =>
			var v72: map<int, bool> := map[safeModuloInt(|fm19(v9, globalState)|, v50.f24) := false];
			v72 := v72[|v14[safeIndex(v15.fm5(v51.f20, globalState), |v14|) := v13]| := !v28];
			...
			v3[safeIndex(897, v3.Length)] := v50.f24;
			var v76: set<C3> := {v15};
			v3[safeIndex(897, v3.Length)] := ((if (v9 in cf0) then cf0[v9] else |v4|) + |v76|) + -v0;
	}
	
	v2 := v1;
	v15.m3(globalState);
	var v77: map<map<string, T0>, bool> := map[map[v15.f22 := v51] := v15.f23[safeIndex(23, v15.f23.Length)]];
	var v78: map<bool, T0> := map[v51.f20 := v51];
	var v79: map<string, T0> := map["sqqlffck" := if (v51.f20 in v78) then v78[v51.f20] else v51];
	var v80: C4 := new C4(safeModuloInt(v0, v0), v6, if (v79 in v77) then v77[v79] else v28);
	v13, globalState.f13, v80, v15.f23[safeIndex(23, v15.f23.Length)] := v13, v0, v80, v28;
	v3 := v3;
	for i10 := v0 to v0 {
		...
		v84 := [[v81], v82, v82, v82, v84[safeIndex(v0, |v84|)]] + (v84 + v84);
		var v85 := DC2(v81.f26, |{v15}|, [v15.f23[safeIndex(23, v15.f23.Length)]], v80.f21, 0x3b1);
		var v86 := DC2(v85.cf4, i10, v27[safeIndex(i10, |v27|) := v9], v80.f21, v50.f24);
		var v87: map<C3, C2> := map[v15 := v81];
		var v88: seq<D0> := [v85, v85, v85, DC2(v15.f23[safeIndex(23, v15.f23.Length)], i10, v27, -|v14|, i10), DC2(v81.f26, i10, [false], |v87|, |v2|)];
		match (DC4(v88)) {
			case DC5(cf11) =>
				v8 := new array<int>[10];
				globalState.f13 := if (v51.f20) then v15.fm6(v51.f20, (map[|v27| := 0x28])[v80.f21 := v80.f21], seq(abs(0x1b1), i11  => (v13)), false, globalState) else v50.f24;
				var v89: C1 := new C1(v15.f22, v6, v15.f23[safeIndex(23, v15.f23.Length)]);
				var v90: map<int, C1> := map[DC23(v28, |v2|, v80.f21, v9).cf45 := v89];
				globalState.f18 := (v50.f24 * |v90|) * v0;
				v0 := 0x4b;
			case DC4(cf10) =>
				var v91: seq<C4> := [v80];
				var v92: array<C4> := new C4[8] [v80, v80, v80, v80, v80, v80, v91[safeIndex(v50.f24, |v91|)], v80];
				v92[safeIndex(949, v92.Length)] := v80;
				v92[safeIndex(949, v92.Length)] := v80;
				globalState.f0 := v15.f23[safeIndex(23, v15.f23.Length)];
				var v93, v94, v95, v96 := v81.m4(v51.f20, globalState);
				v9 := v51.f20;
			case DC6(cf12) =>
				v15.f23[safeIndex(23, v15.f23.Length)] := v28;
				var v97 := new C2(v81.f25, v51.f20, v51.f19, v81.f26);
				var v98: set<bool> := {v51.f20};
				var v99: set<set<bool>> := {{v51.f20} - v98};
				v99 := fm28(i10, safeModuloInt(fm0(v51.f20, v97.f26, globalState), v80.f21), globalState);
				globalState.f13 := v0;
		}
		
		var v100, v101, v102, v103 := v81.m4(v28 ==> v81.f26, globalState);
		v3[safeIndex(659, v3.Length)] := v103;
		v15, v3[safeIndex(659, v3.Length)] := DC27(v15).cf50, v103;
	}
	var v104: map<int, bool> := map[v0 := fm7(v0, v0, |v14|, globalState)];
	var v107 := DC1(true, v80.f21, v50.f24);
	var v108: multiset<map<int, bool>> := multiset{v104 + map[v50.f24 := v28], map v105 : int | (0x3a1 <= v105) && (v105 < 0x126) :: (v105 + v80.f21) := (v15.f23[safeIndex(23, v15.f23.Length)]), (map v106 : int | v106 in v1 :: (v106 * v80.f21) := (v28)) + v104[v50.f24 := v107.cf1]};
	globalState.f13 := if ((map[-v50.f24 := !v28] + v104) in v108) then v108[map[-v50.f24 := !v28] + v104] else v80.f21;
	print v0, "\n";
	print v1 == [888, 2, 888, 2, 648, 0], "\n";
	print v2 == [888, 2, 888, 2, 648, 0], "\n";
	print v4 == {888}, "\n";
	print v5 == map[{888} := 888], "\n";
	print v6[0], "\n";
	print v6[1], "\n";
	print v6[2], "\n";
	print v6[3], "\n";
	...
	print globalState.f1 == [888, 2], "\n";
	print globalState.f2, "\n";
	print globalState.f4 == map[{888} := 888], "\n";
	...
	print v13, "\n";
	print v14 == ['j'], "\n";
	print v15.f22 == ['h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'd'], "\n";
	print v15.f23[0], "\n";
	print v15.f23[1], "\n";
	print v15.f23[2], "\n";
	print v15.f23[3], "\n";
	...
	print |v16|, "\n";
	print i3, "\n";
	print v27 == [true, false], "\n";
	print v28, "\n";
	print i5, "\n";
	print v44[0] == multiset{}, "\n";
	print v45 == multiset{888, -409}, "\n";
	print v46 == map[true := 888], "\n";
	print v47.cf12.cf11, "\n";
	print v48.cf12.cf12.cf11, "\n";
	print v50.f24, "\n";
	print v51.f19[0], "\n";
	print v51.f19[1], "\n";
	print v51.f19[2], "\n";
	...
	print v51.f20, "\n";
	print |v52|, "\n";
	print v53 == multiset{'j', 'o', 'y'}, "\n";
	print |v77|, "\n";
	print |v78|, "\n";
	print |v79|, "\n";
	print v80.f21, "\n";
	print v104 == map[888 := true], "\n";
	print v107.cf1, "\n";
	print v107.cf2, "\n";
	print v107.cf3, "\n";
	print v108 == multiset{map[888 := true], map[], map[0 := true, 888 := true]}, "\n";
}