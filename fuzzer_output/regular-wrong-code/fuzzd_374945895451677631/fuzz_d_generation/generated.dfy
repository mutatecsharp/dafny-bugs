...
function fm10(p0: bool, p1: int, p2: int, p3: seq<int>, globalState: GlobalState): seq<int> {
	[|"debwyw"|] + (if (true) then seq(0x4d, i0  => (929)) else [-0x108])
}
function fm11(p0: bool, p1: int, globalState: GlobalState): map<int, int> {
	map[|"fvmces"| := |map[-0x97 := false]|] + (map[0x1cb := |(seq(-0x2cf, i0  => ('l')))|] + (map v0 : int | v0 in multiset{-0x2f2} :: (v0 % |"lld"|) := (|(seq(610, i1  => (-0x1f9)))|)))
}
function fm12(p0: bool, p1: int, globalState: GlobalState): multiset<char> {
	(multiset(seq(0x255, i0  => ('n'))) + multiset{'h'}) * (multiset{'l'} * multiset{'r', 'e', 'x', 'o', 'g'})
}
...
function fm17(p0: bool, globalState: GlobalState): D0 {
	DC0(|(set v0 : int | v0 in multiset{0x11} :: (v0 / |multiset{0x1e1}|))| - |[false, true, false, true]|, |"vkhhpk"| > |map[false := false]|)
}
...
function fm19(p0: bool, globalState: GlobalState): map<int, bool> {
	map[-|[234]| / 6 := !(-0x88 < |multiset(seq(0x214, i0  => (|"tpbjm"|)))|)]
}
function fm20(globalState: GlobalState): set<int> {
	((set v0 : int | v0 in multiset{0x16d} :: (v0 - |(seq(484, i0  => (0x25)))|)) - {0x2f2, |[|map[false := |map[seq(0x373, i1  => (-0x165)) := true]|]|]|}) - ({-0xe0, |map[|(set v1 : int | v1 in map[0xe0 := false] :: (v1 + |multiset([|multiset{map[true := 0x163]}|, 0x31c])|))| := false]|} * (set v2 : int | (0x81 <= v2) && (v2 < 0x168) :: (v2 % |multiset{803}|)))
}
...
function fm27(globalState: GlobalState): set<multiset<int>> {
	({multiset{|"nqjba"|, |"xdy"|}, multiset{-0xeb}, multiset{0x3c3}} + {multiset{-956}, multiset([358])}) * {multiset{0x251, 0x7d, |(seq(-0x396, i0  => ('f')))|, 0x270}, multiset{0x2f4}, multiset{0x15b}}
}
...
class C0 extends T0 {
	...
	function fm1(p0: int, globalState: GlobalState): bool {
		!DC0(|f39[|multiset{false, f30}| := f30]|, f30).cf1
	}
}
...
class C1 extends T2 {
	...
	function fm3(p0: char, p1: string, p2: bool, globalState: GlobalState): string {
		DC1(seq(0x3b1, i0  => ('d'))).cf2 + "uobrcmi"
	}
	function fm4(globalState: GlobalState): seq<bool> {
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: T0, r2: int, r3: char) {
		...
		var v8: array<int> := new int[23] [if (f32) then f38 else f38, f38, 0x132 + f38, |v3|, -(f38 % f38), f38 * f38, -f38, f38, f38, f38, if (v1 in v4) then v4[v1] else fm0(v1, globalState), |map[(map[f38 := f38])[|v6| := |fm8(v7, globalState)|] := f32]|, 860, fm0(v1, globalState), f38, f38, -f38, f38, f38, if (f32) then f38 else f38, f38, 0x132, 0x15e];
		var v9: map<int, int> := map[f38 := f38];
		v8[723] := -f38 + |v9|;
		v0[960], v8[723], v0 := f32, f38, v0;
		var v10: seq<int> := [if (f32) then v8[723] else f38, f38, f38];
		var v11: map<bool, int> := map[v0[960] := f38];
		var v12 := DC3(v8[723], if (f32 in v11) then v11[f32] else v8[723]);
		v10 := match v12 {
			case DC2(cf3) => v10 + v10[v8[723] := f38]
			case DC3(cf4, cf5) => v10
			case DC1(cf2) => v10
			case DC4(cf6) => seq(443, i1  => (v8[723]))
		};
		v8 := v8;
		var v13: set<bool> := {v0[960]};
		f32 := v13 !! v13;
		var v14: multiset<bool> := multiset{f32};
		var v15 := DC1(v5);
		var v16: map<multiset<bool>, int> := map[v14 := |v15.cf2|];
		var v17 := DC0(v8[723], true);
		v16 := v16[v14 * multiset{f32, v0[960], fm7(true, v17, -f38, globalState)} := (if (!v0[960] in v14) then v14[!v0[960]] else f38) / v8[723]];
		v8[723] := |v5|;
		r0 := 0xb;
		var v18: seq<bool> := [f32];
		var v19: T0 := new C0(v18, v0, (seq(367, i2  => (DC7(v1).cf9))) != (seq(0x20d, i3  => (v1))));
		r1 := v19;
		r2 := f38;
		r3 := v1;
	}
	method m3(p0: int, p1: bool, p2: bool, p3: string, globalState: GlobalState) returns (r0: multiset<multiset<bool>>) {
		...
		v0[515] := multiset{false, !p1} > v1;
		v0[515] := f32;
		var v2: seq<bool> := [v0[515], f32, p2];
		var v3 := DC8(f38, f32);
		...
		for i0 := p0 + p0 to |v6.cf13| * p0 {
			...
			v9[723] := v4;
			v9[723] := new C0(v4.f39, v0, !p2);
			v0[515] := v0[515];
		}
		globalState.f0 := p0 + |fm9(0xab, globalState)|;
		for i1 := p0 to p0 {
			globalState.f0 := -((if (!!p1) then f38 else p0) / i1);
			var v10 := DC0(p0, p1);
			...
			var v24: array<int> := new int[28] [253, v15[0x13], (if (f38 in v5) then v5[f38] else v15[v12]) * i1, v12 + |p3|, if (true) then v12 else -i1, p0 - v12, v12 / |p3|, v15[fm0(v16, globalState)], |v18[p1 := v17]|, v12, f38, v12, f38 * |multiset(v4.f39)|, -|v4.f39| - f38, p0, |v15|, -(p0 - i1), f38, f38, p0, |fm3('c', p3, v13, globalState)| / |v20.cf14|, v12, f38, f38, f38, p0 % |v21|, i1 * |p3|, |v23|];
			v17[373] := f38;
			v17[373] := -0xca;
			v0[515] := p2;
		}
		var v25: multiset<multiset<bool>> := multiset{multiset(v4.f39)};
		r0 := multiset([v1]) - v25[v1 := p0];
	}
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: set<bool>) {
		...
		var v2: seq<bool> := [p1];
		var v3 := DC13(p1);
		var v4: array<bool> := new bool[28] [f32, p1, f32, p1, p1, p1, false, true, f32, p1, p1, f32, p1, fm7(!p1, v0, |v1|, globalState), v2[p0], p1, p1, v3.cf15, f32, fm7(false, v0, p0, globalState), f32, p1, p1, p1, true, f32, !true, f32];
		var v5: seq<array<bool>> := [v4, v4, v4];
		var v6: seq<array<bool>> := [v4, v4, v5[f38], v4, v4];
		var v7: array<seq<array<bool>>> := new seq<array<bool>>[7] [v5[p0 := v4], v5 + v5, (v6 + v5)[p0 := v4], v6, v5, v6 + v6, v5];
		v7[647] := v6;
		var v8 := DC14(v6);
		v7[647] := v8.cf16;
		...
		var v9: seq<string> := [seq(-0x3cb, i3  => ('q')), v1, "vjyygh", v1];
		var v10 := 'n';
		var v11: map<int, char> := map[p0 := v10];
		for i1 := |((seq(0x209, i2  => ('i'))) + v9[f38])| to |v11| {
			...
			globalState.f0, v12, globalState.f20 := fm0(v10, globalState), v14[p0], p1;
		}
		var v15: array<int> := new int[13](i4 => i4 + f38);
		var v16 := DC16(v15, p1);
		match (v16) {
			case DC15(cf17, cf18, cf19, cf20) =>
				var v17: array<string> := new seq<char>[19](i5 => (seq(0x2e3, i6  => (v10))) + v1);
				v17 := v17;
			...
			case DC16(cf21, cf22) =>
				v4[306] := p1;
				v4[306] := fm7(true <==> cf22, v0, |multiset(v2)| % p0, globalState);
				...
				if ((p1 !in v24) <==> v4[306]) {
					v15 := cf21;
					v15, v4[306] := cf21, true && cf22;
					var v25: array<char> := new char[9](i7 => v10);
					v25[931] := v10;
					v15[934] := f38 / |v1|;
					v15[677] := |v1|;
					var v26 := DC20();
					v25[931], v15[934], v15[677], v26 := v10, fm0('e', globalState), f38 % p0, v26;
					var v27: map<string, int> := map[v1 := f38];
					var v29 := DC1(v1);
					var v30: map<string, D1> := map[v1 := v29];
					r1 := fm0(v25[931], globalState) / |(v27[v1 := f38] + (map v28 : string | v28 in v30 :: (v28) := (p0)))|;
					...
					v31[727] := v23;
					globalState.f3 := f38;
					globalState.f0 := 0x73 * |(seq(732, i8  => ('p')))|;
					var v32: map<int, D5> := map[-p0 := DC13(true).(cf15 := false)];
					var v33: map<bool, map<int, D5>> := map[v4[306] := if (cf22) then v32 else v32];
			...
			case DC14(cf16) =>
				...
				var v40: array<map<int, int>> := new map<int, int>[7] [map[f38 := if (|v1| in v35) then v35[|v1|] else p0] + (map v36 : int | v36 in (seq(0x3bb, i9  => (f38))) :: (v36 / 521) := (p0)), v35, (map v37 : int | (137 <= v37) && (v37 < 0x289) :: (v37 + f38) := (f38))[0x264 := f38], v35 + fm11(f32, -|v38|, globalState), map v39 : int | (-0x17a <= v39) && (v39 < 0x1a3) :: (v39 - f38) := (|v1|), v35, v35];
				v40[581] := map[f38 := p0];
				var v41: seq<array<int>> := [v15, v15, v15];
				v40[581] := map[0x216 := |v41|] + map[f38 := f38];
				globalState.f21 := f32;
				var v42: array<set<bool>> := new set<bool>[6];
				var v43: set<bool> := {p1};
				v42[54] := v43;
				v42[54] := v43 + (v43 * {f32, p1, f32, p1, f32});
				r1 := f38;
			case DC17(cf23) =>
			...
			decreases 100 - i10
		{
			...
			var v49: seq<int> := [|v1|, f38, f38, |v48[p0 := f38]|];
			var v50: multiset<D6> := multiset{v16, v16};
			globalState.f20, v16, globalState.f22, v4[809], v15 := 0x130 !in v49, v16.(cf21 := v15), p1, !(multiset{v16, v16} >= v50), v15;
			var v51: array<bool> := new bool[19] [p1, p1, v4[809], p1, v4[809], v4[809], p1, v4[809], p1, v4[809], p1, v4[809], p1, f32, p1, f32, f32, fm7(p1, v0, 0x28, globalState), p1];
			var v52 := DC19(v0.cf1, v51, |"hpbqtxuac"|);
			var v53 := DC21(f32, v15, p0, v10, v4[809]);
			var v54: array<char> := new char[28] [v10, v10, v10, v10, v10, 'j', v10, v1[p0], v10, v10, v10, v10, v10, v10, v53.cf31, v10, v10, v10, v10, v10, 'r', v10, v10, v10, v10, v10, v10, v10];
			var v55: map<int, array<char>> := map[v52.cf27 := v54];
			var v56: map<int, bool> := map[f38 := v4[809]];
			v55 := v55[|fm3(v10, v1, if (-f38 in v56) then v56[-f38] else v4[809], globalState)| := v54];
			globalState.f3, r2, globalState.f21 := --|v56|, p1, v4[809];
		}
		r0 := !p1 <== f32;
		var v57: multiset<string> := multiset{("yht")[f38 := v10]};
...
class C2 {
	...
	function fm5(p0: int, p1: int, p2: char, globalState: GlobalState): int {
		(|map[-0xc6 := 0x198]| + -|(seq(0x343, i0  => ('g')))|) / |"t"|
	}
	method m1(p0: D0, p1: bool, p2: bool, p3: bool, globalState: GlobalState) {
		...
		var v11: seq<int> := [v0];
		var v12: array<int> := new int[28] [v0, |v1|, --v0, |v2|, |v3|, |fm6(|v5[v0]|, v0, v6, globalState)|, v0, v0, |v9|, v0, v0, -v0 - v0, v0 + v0, v0, -0x29c + |v10|, v0, 0x1c5, if (p2) then v0 else v0, v0, v0, |v11[v0 := v0]|, v0, |"tci"|, v0, v0, 903, |v3|, v0];
		var v13 := DC8(v0, false);
		var v14: map<bool, D3> := map[p2 := v13];
		var v15: map<map<bool, D3>, bool> := map[v14 := p2];
		v12[698] := |v15[map[p3 := v13] := p2]|;
		v12[698] := v0;
		var i0 := 0;
		while (p1)
			decreases 100 - i0
		{
			...
			var v21: array<bool> := new bool[13] [v12[698] == |v3|, !f36, v3 != v3, if (false) then !v8.f32 else f36, f36, p1, !(-|v3| > -358), v8.f32, p3, f36, v19.cf17, --v0 < |(seq(-0x28f, i1  => (v17)))|, if (!f36 in v20) then v20[!f36] else p3];
			v21[733] := v1 != v1;
			var v22: set<bool> := {p2};
			var v23: map<int, set<bool>> := map[v12[698] := v22];
			var v24: array<multiset<char>> := new multiset<char>[18](i2 => multiset(v3) * multiset{v17});
			var v25: multiset<array<int>> := multiset{v12};
			v24[515] := fm12(fm13(true, false, |v25|, globalState), -v0, globalState);
			var v26: multiset<char> := multiset{v17};
			v3, v21[733], globalState.f22, v23, v24[515] := v3 + v3, (v0 != fm0(v17, globalState)) <== v8.f32, v8.f32, (v23 + fm14(globalState)) + (v23 + v23), v26[if (fm13(p3, fm13(!v8.f32, v8.f32, v12[698], globalState), v12[698], globalState)) then v17 else v17 := v12[698]];
			var v27: array<array<bool>> := new array<bool>[2];
			v27 := v27;
			var v28: multiset<string> := multiset{v3[|v3| := v17], v3, v3, v3 + v3};
			v8.f32, v0 := p3, -|v28|;
			var v29 := new C1(v0, v8.f32, v7[v0 := v6]);
		}
		v8.f32 := p1;
		var v30 := DC1("dvpd");
		var v31 := DC4(v30);
		...
		v0 := |v37| % (v12[698] % v12[698]);
		v2 := v2[v12[698] := v12[698]];
	}
	method m2(p0: bool, globalState: GlobalState) returns (r0: seq<bool>) {
		...
		var v11 := new C0(if (v4.f39[v1]) then v2 else [false, f36, true], v3, if (false) then f36 else f36);
		v1 := v1;
		...
		r0 := (v10.f39 + v11.f39)[v1 := if (f36) then p0 else true];
	}
}
...
class C3 extends T1, T2 {
	...
	function fm3(p0: char, p1: string, p2: bool, globalState: GlobalState): string {
		"rxxbvym" + (if (f35.f30) then seq(0x273, i0  => ('s')) else "hrrbst")
	}
	function fm4(globalState: GlobalState): seq<bool> {
	...
	method m0(globalState: GlobalState) returns (r0: int, r1: T0, r2: int, r3: char) {
			...
			decreases 100 - i2
		{
			...
			v19 := v19;
			var v20: C0 := new C0(v0[929], f35.f29, f32);
			var v21: map<array<int>, C0> := map[v19 := v20];
			globalState.f3 := |v21| / fm0(v18, globalState);
			if (f32) {
				v19[35] := v2;
				v19[35] := (v2 - v2) / v2;
				f35.f29[997] := f30;
				var v22: set<int> := {|"kmron"|};
				var v23: T2 := new C1(v2, f35.f30, f33[v19[35] := v22]);
				var v24: seq<T2> := [v23];
				var v25: multiset<bool> := multiset{f35.f30};
				var v26: map<bool, bool> := map[f32 := f35.f30];
				f35.f30, f35.f29[997], v23 := !((multiset{f30, f35.f30})[f35.f30 := |v24|] < v25), f35.f30, v24[|v26| * v19[35]];
				var v27 := DC2(v5);
				var v28 := DC4(v27);
				var v29 := DC4(v28);
				...
				var v37: seq<array<bool>> := [f29, if (v34 in v35) then v35[v34] else f35.f29, f35.f29, f35.f29, v36[v2]];
				var v38: map<bool, array<bool>> := map[f35.f30 := f35.f29];
				var v39: array<array<bool>> := new array<bool>[26] [f35.f29, v37[v2], f35.f29, f35.f29, if (f32) then f29 else v37[v2], f35.f29, f35.f29, f35.f29, v36[v2], f35.f29, f35.f29, f35.f29, f35.f29, if (v1[v2] in v38) then v38[v1[v2]] else f35.f29, f29, f29, f35.f29, f35.f29, f29, f35.f29, if (f35.f30) then f35.f29 else f35.f29, v36[v2], f35.f29, f29, f35.f29, f29];
				v39[585] := f35.f29;
				v39[585] := if (!f30) then f35.f29 else f35.f29;
				var v40: seq<int> := [v2, v2];
				var v41 := DC3(0x2d7, v40[v2]);
			...
			var v55: map<char, bool> := map[v53[v2] := v54 == v54];
		...
		if ((v61 + v61) == v61) {
			...
			v62[741] := v2;
			v62[741] := v2 - v2;
			v62[741] := (v62[741] * |v61[v2 := v18]|) % 0x235;
			...
			v64, v65 := v64, v65;
			var v66 := DC2(v5);
			globalState.f21, f30, v66 := v2 < (|v61| % v62[741]), fm13(v62[741] > |"tsykju"|, f32 <== f32, v2, globalState), v66;
		} else {
			globalState.f3 := 413;
			var v67: map<bool, bool> := map[false := f32];
			f29[738] := if ((if (f35.f30 in v67) then v67[f35.f30] else f30) in v67) then v67[if (f35.f30 in v67) then v67[f35.f30] else f30] else f30;
			f29[738] := f35.f30;
			...
			var v73: map<bool, seq<bool>> := map[f30 := v0[929]];
			v73 := v73;
		}
		
		r0 := v2;
		r1 := new C0(v0[929], f35.f29, f30);
		r2 := fm0(v18, globalState) / -v2;
		r3 := v18;
	}
}
...
method Main() {
	...
	var v4 := true;
	var v5: seq<bool> := [!v4];
	var v6: array<seq<bool>> := new seq<bool>[11] [[v5[v1]], v5, v5, v5, v5, [v4], v5, [v4], v5, [v4], v5];
		...
		decreases 100 - i0
	{
		...
		v15 := v15;
		globalState.f0 := 0x3;
		v0 := (if (v4) then v0 else v0) + (seq(-0x3a6, i1  => (v13)));
	...
	if (v4 ==> v4) {
		...
		v20 := v20[v4 := v19];
		var v21 := DC6(-v1);
		var v22: map<int, D2> := map[v1 / v1 := v21];
		...
		if (!!v4) {
			...
			var v28: array<map<bool, bool>> := new map<bool, bool>[23] [v8, v8, v8, map[v27.f36 := v27.f36], v8, v8, v8, v8, v8, v8, v8, v8, fm18(globalState), v8, v8, v8, v8, map[false := v4], DC18(v8).cf24, v8, v8, v9[-v1], v8];
			...
			var v36: seq<set<int>> := [set v34 : int | v34 in v25 :: (v34 / -209), set v35 : int | (0x389 <= v35) && (v35 < 0x43) :: (v35 + v1)];
			...
			var v53 := new C3(v41, v49, v44, v42, |v5| >= |v51|, v43.f30, (v46[v1 := set v52 : int | (0x2c3 <= v52) && (v52 < 0x124) :: (v52 * v1)])[-0x26e := {v1}]);
		...
		v58[245] := {v59} >= (v60 + (if (v59.f30 in v61) then v61[v59.f30] else v60));
		v58[245] := v4;
		...
		var v65 := new C3(v62, v59, v63, v59.f29, v57.f36, v58[245], v64);
		var v66: multiset<bool> := multiset{v4, false, v4, v59.f30, v4};
		v58[245] := (multiset(v5) - (multiset{v57.f36})[v59.f30 := |fm19(v58[245], globalState)|]) !! v66;
	}
		...
		decreases 100 - i3
	{
		...
		globalState.f20 := fm13({v1, |{v75, map[v73 := v74]}|} != (set v76 : int | (0xe0 <= v76) && (v76 < 0x1c) :: (v76 / v1)), v73.f32, |{v69.f30, v69.f30, v69.fm1(483, globalState), v4, v69.fm1(v1, globalState)}|, globalState);
		globalState.f20 := !v4;
		...
		decreases 100 - i6
	{
		...
		if (!(fm13(v4, v4, v85, globalState) <== v4)) {
			...
			var v88 := new C1(v83 - -|([v1])[v82 := |v5|]|, false, v87);
			...
			v92[263], v98, globalState.f22, globalState.f0 := false, |v99|, (if (v4) then -v83 else v82) <= |v100|, v85;
			var v101, v102, v103, v104 := v88.m0(globalState);
		} else {
			v6[265] := v5[v82 := v4] + v5;
			v6[265] := [v4, v4, v4, v4, v4];
	...
	var v112: seq<string> := [v0, seq(0x1c8, i8  => (v13))];
		...
		decreases 100 - i9
	{
		...
		i9 := i9 + 1;
		v6[794] := v5;
		v6[794] := (v5 + v5) + v5[v1 := v4];
		globalState.f0 := |v5| / -v1;
		...
		if (v4) {
			...
			var v122: C1 := new C1(v115 / 811, v4, v121);
			var v123: map<string, bool> := map[v0 := v119 > v122.f38];
			v122, globalState.f22, v123 := if (v4) then v122 else v122, !v4, fm22(globalState);
			var v125: array<map<int, int>> := new map<int, int>[3] [v2, v2, map v124 : int | (0x326 <= v124) && (v124 < 0xdc) :: (v124 / v115) := (561)];
			v125 := v125;
		} else {
			...
			var v140: T1 := new C3(if (v133 in v135) then v135[v133] else v134, v137, v138, v137.f29, v130.fm7(v4, v139, -|(seq(0x2eb, i11  => (v13)))|, globalState), v4, v129);
			...
			v142[514] := v140;
			var v143 := DC4(DC1(v0[fm0(v13, globalState) := 'c']));
			var v144: seq<array<bool>> := [v136];
			v142[514], globalState.f20, v136, v6[794], v143 := v140, v130.f38 >= -v130.f38, v144[|v130.fm3(v13, ("ldym")[0xfa := v13], v140.f30, globalState)|], v6[794], v143;
			v8 := v8[v137.f30 := !!v4];
			var v145 := v130.m3(-v130.f38, !v137.f30, v140.f30, v0[v1 := v13] + v0, globalState);
			var v146 := DC7(v13);
	...
	var v151: array<bool> := new bool[15] [v4, v5[-0x266], !v4, v4, fm0(v13, globalState) in [|v148|], v149.cf15, v4, v4, !(if (false) then v4 else v4), !v4, v4, v4, !(v1 != v1), v150 > v150, v4];
	v151 := v151;
	...
	if ((v150 < multiset{(v153.(cf38 := v1)).cf41, |multiset{v4}|, v1}) <== (v154 !! v154)) {
		...
		match (v155) {
			case DC19(cf25, cf26, cf27) =>
				...
				var v159: multiset<char> := multiset{v0[v1], v13};
				var v160: C0 := new C0(v5, v157.f29, !v5[cf27]);
				...
				v170[837] := v165 - {if (v13 in v171) then v171[v13] else v157.f30, v157.f30};
				v151, globalState.f3, globalState.f3, globalState.f3 := v151, v1, |(v150 * v150[|v2| := |v0|])|, cf27;
			...
			case DC20() =>
				...
				var v178: array<char> := new char[10] [v13, v0[v1], 'f', v0[|v177|], v13, v13, v13, v13, v13, v13];
			...
			case DC22(cf33) =>
				...
				var v209: set<int> := {v1, |(seq(0x37, i14  => (v13)))|};
		...
		var v221: seq<set<int>> := [set v220 : int | (-0x368 <= v220) && (v220 < 149) :: (v220 % 0x4f)];
		...
		var v229: set<string> := {seq(308, i15  => (v13)), "ojv"};
		...
		globalState.f28, v152, v13, v219[318] := v12, if (v216 in v232) then v232[v216] else [v1, v1], v13, v13;
		...
		decreases 100 - i16
	{
		...
		v8 := v8[-v239 == -v1 := v4];
		var v240: map<int, string> := map[|v150| := v0[v238 := v13]];
		var v241: multiset<bool> := multiset{v4};
		var v242: array<map<D0, int>> := new map<D0, int>[4];
		var v243: C2 := new C2(v4, v242);
		var v244: T0 := new C0(v5, v151, fm24(v4, v240, globalState) < v241[v4 := |[v243]|]);
		var v245: seq<map<bool, int>> := [v12[v4 := v238], v12, v12, v12, v12];
		v244, globalState.f0, v0, globalState.f3 := v244, v152[-|v0|] + v1, fm25(v238, (v245 + v245)[v1 := v12], v244.f30, globalState), |v0|;
		var v246: map<string, int> := map[v0 + v0[v238 := v13] := v239];
	...
	if (v4) {
		var v249: map<bool, seq<bool>> := map[!v4 := v5[0x1d0 := v4]];
		var v250: set<int> := {v1};
		var v251: map<seq<bool>, int> := map[if (v4 in v249) then v249[v4] else v5 := |v250|];
		v251 := v251[v5 + v5 := v1];
		globalState.f3 := (v1 / v1) / |fm23(globalState)|;
		globalState.f20 := v4;
		...
		if (v4) {
			...
			var v266 := DC18(v8);
			var v267: array<map<bool, bool>> := new map<bool, bool>[26] [v8, v8, v8, v8, v8, v8, map[v4 := v4], map[fm13(v4, v4, |v8|, globalState) := v4], if (v1 in v265) then v265[v1] else v8, v8, v8, v8, v8, v8, v266.cf24, fm18(globalState), v8, v8, v8, map[v4 := v4], v9[v1], map[v4 := v4], v8, map[true := v4], v8, map[v4 := v4]];
		...
		if (-v1 >= (v1 - v1)) {
			globalState.f0 := (fm0(v13, globalState) / (v153.(cf38 := |v0|)).cf39) % v1;
			var v272, v273, v274 := m5(globalState);
			var v275: seq<set<bool>> := [fm23(globalState)];
			var v276: map<int, set<bool>> := map[v273 := v275[v1]];
			...
			var v287: array<map<D0, int>> := new map<D0, int>[8] [map v282 : D0 | v282 in v284 :: (v282) := (DC8(|v0|, v4).cf10), map[fm17(v4, globalState) := v1], map v285 : D0 | v285 in v286 :: (v285) := (|map[v4 := DC20()]|), v284, map[v283 := v1], v284, map[v283 := |(seq(-0x24b, i20  => (v13)))|], map[v283 := v1]];
			var v288 := new C2(v4, v287);
			globalState.f0, globalState.f0 := 0x161, v1 - v1;
			var v289: array<T0> := new T0[12];
			v4, v289, globalState.f0, globalState.f0 := !((v288.f36 <==> true) <== v4), v289, (-|v8| % v1) % (if (v4) then v1 else 0x16a), |(v14 + v14)|;
		...
		var v296: map<int, seq<int>> := map[v293 := seq(0x33f, i21  => (v1))];
	...
	match (v312) {
		case DC27(cf38, cf39, cf40, cf41, cf42) =>
			...
			var v318: seq<C2> := [v316, v317[v310.f38]];
			globalState.f20, v0, globalState.f21, v151[871] := v4, v112[-(fm0(v13, globalState) - fm0(v13, globalState))], [v316] < v318, v4 && (v4 && cf40);
			var v319: map<int, string> := map[|v5| := v0[cf41 := v13]];
			v4, v1, v151[871], v310, v150 := if (v316.f36) then false else v151[871], cf41, cf42 !in v319, v310, fm8((set v320 : int | v320 in v14 :: (v320 + |{!true, true, !true}|)) - v308, globalState);
			var v321, v322, v323 := m5(globalState);
			var v324 := DC16(v321, v4);
			var v325: array<D6> := new D6[17] [v324, DC16(v7, !v151[871]), v324, v324, v324, v324.(cf21 := v321), v324, v324, v324, v324, v324, v324, DC16(v321, cf40), DC16(v321, false), DC16(v7, !v4), v324, v324];
			v325[720] := v324;
			v325[720] := v324;
		case DC26(cf37) =>
			var v326: seq<map<bool, int>> := [v12];
			var v327 := DC37(v0, v4, |v0|);
			var v328: array<string> := new string[24] [v0 + (seq(674, i24  => (v13))), v0, v0[v310.f38 := v13], v0, v0, fm25(v310.f38, v326, v4, globalState), v0 + v327.cf57, v0 + v0, v0, "ol", v0, "ugcx" + v0, (v0[v310.f38 := v13])[v310.f38 := v13], v0, v0, "mkidb", v0, v0, seq(0x6f, i25  => (v13)), v0, v0, "hyk", v0, DC1(v0).cf2];
			v328[28] := v0 + v0;
			v328[28] := v0;
			var v329 := DC26(v310);
			var v330: map<map<int, bool>, D11> := map[v14 := v329];
			v330 := v330[v14 := v329];
			globalState.f3 := (if (v4) then v310.f38 else v310.f38) % v310.f38;
			globalState.f22 := v5[v310.f38];
		case DC28(cf43) =>
			var v331 := DC21(!v4, v7, v310.f38, 't', v4);
			match (v331) {
				case DC19(cf25, cf26, cf27) =>
					var v332: set<string> := {v0};
					cf25 := {v0} > (v332 + {v0, seq(0x15b, i26  => (v13))});
					v7[873] := fm0(v13, globalState) + v1;
					v7[873] := 0xcb;
				...
				case DC18(cf24) =>
					...
					var v353 := DC0(|v0|, v4);
					var v354 := DC0(v310.f38, v310.fm7(v4, v353, -fm0(v0[v310.f38], globalState), globalState));
					var v355 := v310.m3(v310.f38 % 0xa2, v352 !! v352, v4 <== v310.fm7(!true, v354, v310.f38, globalState), v0, globalState);
					globalState.f20, globalState.f3 := v4, -0x1ac;
					var v356: T0 := new C0(v5[v1 := v4], v151, v4);
					var v357: map<T0, int> := map[v356 := v310.f38];
					var v358: array<set<multiset<int>>> := new set<multiset<int>>[5];
					v358[317] := fm27(globalState);
					var v359 := DC41(v357);
					var v360: set<multiset<int>> := {v150};
					v5, v357, globalState.f3, v358[317] := ([v4] + [v356.f30]) + v5, v359.cf63, v152[v310.f38], v360;
				...
				case DC22(cf33) =>
					...
					v151[677] := v365 !! multiset{v4};
					v151[677] := !v4;
					var v366 := new C1(-v310.f38, v151[677], [v308, v308]);
					globalState.f20 := v151[677];
			}
			
			var v367, v368, v369, v370 := v310.m4(-(v310.f38 / v310.f38), v4, globalState);
			v151[522] := v367;
			var v371: multiset<bool> := multiset{v369};
			v151[522] := v1 <= (if (v369 in v371) then v371[v369] else |multiset([v310.f38, |v154|])|);
			var v372 := DC34(v112 + v112, v151[522]);
			...
			v372, v1, globalState.f21, v373[573], globalState.f0 := v372.(cf54 := v152 < ([v1, |v14|])[fm0(v13, globalState) := v1]), 0x3a0, v367, v374, if (true) then v368 else |(v376 + v376)|;
	}
