...
function fm0(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState): seq<map<int, bool>> {
	[map[874 := true], map[-|[false, false]| := false], map[773 := !true]] + ([map[0x1af := false], map v0 : int | (0xa0 <= v0) && (v0 < 0x1f1) :: (v0 + |multiset([false, false, false, true, true])|) := (false)] + [map[416 := true], map v1 : int | v1 in map[|(seq(0x39e, i0  => ('k')))| := !true] :: (v1 % |[0x14e, |[false]|, -0x89, 0x360, 0xf2]|) := (true)])
}
...
function fm28(p0: int, p1: string, p2: int, globalState: GlobalState): map<bool, D1> {
	map[true := DC5(!false, map[false := !true], |[0x39]|, |map[true := |multiset{true}|]|, map[false := 0x35b])] + (map[!true := DC5(true, map[false := true], |"np"|, 0x2b4, map[false := |multiset{!false}|])] + map[true := DC5(true, map[false := true], |(set v0 : int | (0x162 <= v0) && (v0 < 0x2e5) :: (v0 % 0xa8))|, -0x30e, map[true := 0x28c])])
}
function fm29(p0: int, p1: int, p2: bool, globalState: GlobalState): bool {
	false <== (|"eaasr"| > DC37(false, map[true := true], |(seq(-0x272, i0  => (0xda)))|).cf67)
}
...
function fm31(p0: bool, p1: bool, globalState: GlobalState): seq<int> {
	[0x1b5, |(seq(-733, i0  => ('q')))|] + DC28([|{false}|, |[true]|]).cf52
}
...
function fm41(globalState: GlobalState): set<int> {
	{|DC19(multiset([false, false])).cf34|, -751, |(seq(146, i0  => ('j')))|, |multiset(seq(0x1d3, i1  => (|DC28([|map[0xfe := false]|]).cf52|)))|, 0xc0} + (DC23(0x13f, {|"hm"|}, |multiset{|"tcggd"|}|, 0x245, -312).cf41 + (set v0 : int | (-0x34a <= v0) && (v0 < 0x141) :: (v0 % 0x286)))
}
trait T0 {
	const f23 : int
...
class C0 extends T0 {
	...
	method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: bool) {
		...
		var v9: map<bool, string> := map[v3[21] := v1];
		var v10: map<bool, int> := map[fm3(v1, p0, f31, v8, globalState) := f23];
		var v11: seq<bool> := [p0];
		var v12 := DC12(f23, f31);
		var v13: array<int> := new int[26] [f23, --f31, f31, f31, f23, f23, -|v8|, |v9|, f23, v8[f23], f23, f23, 0x290, f23, if (p0 in v10) then v10[p0] else f31, fm1(|v1|, p0, globalState), 678, |"ft"|, f31, f23, -f31, f31, f31, |v11|, 970, |map[v12.cf19 := |v7|]|];
		var v14: seq<array<int>> := [v13, v13];
		r1, v7, globalState.f17, globalState.f14, globalState.f14 := v14[f31], v7 * multiset([p1] + [v3[21]]), |(map v15 : int | (0x3d <= v15) && (v15 < 0x29f) :: (v15 - 0x2f6) := (multiset{v0, v0}))| - (f31 + f23), |(if (p1) then v10 else v10)| % (f31 * f31), f23;
		r0 := -f31 + f23;
		r1 := v13;
	...
	method m10(p0: bool, p1: set<int>, p2: int, p3: int, globalState: GlobalState) returns (r0: multiset<int>, r1: array<bool>, r2: int, r3: bool) {
		r2 := p2;
		var v0 := "mevk";
		v0 := (seq(0x2cd, i0  => ('u'))) + (v0 + v0);
		var v1 := 'w';
		var v2: seq<bool> := [p0];
		var v3: map<int, bool> := map[p3 := p0];
		var v4: map<bool, bool> := map[p0 := p0];
		var v5 := DC10(p0, v4);
		var v6: array<string> := new string[26] [v0 + v0, v0, v0[f31 := v1], "rkd", v0, "aai", v0, v0, v0, fm25(p0, p0, v1, globalState), v0, seq(0x3a, i1  => (v1)), v0 + v0, v0, v0, (seq(285, i2  => (v1))) + v0, v0, fm25(v2[-p2], p0, fm26(|v3|, p0, globalState), globalState), v0, v0, fm25(if (p0 in v4) then v4[p0] else !p0, !v5.cf16, v1, globalState), v0, v0, v0, v0, v0];
		...
		for i3 := |"hk"| + (if ((if (false in v4) then v4[false] else !p0) in v10) then v10[if (false in v4) then v4[false] else !p0] else f23) to |v11| {
			...
			v2, v12[869], v0, v13 := v2, p0, v0 + (if (p0) then v0 else v0), v13;
			globalState.f15, v12[869], globalState.f1, v12[869] := !(v2[|"ahkl"|] !in v2), p0, v12[869], (false <== v12[869]) && v12[869];
			globalState.f8 := -(f31 / i3);
...
class C1 extends T1 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
		...
		match (v1) {
			case DC9(cf15) =>
				...
				var v5: set<bool> := {f24};
				var v6 := 'l';
				globalState.f6, v2[856], v0, globalState.f1, v0 := ((seq(0x8b, i0  => (cf15))) + v4) <= ([|v4|, cf15, cf15] + v4), v5 > (v5 + v5), v0[cf15 := v6], f24 <== f25, v0;
				var v7: array<multiset<int>> := new multiset<int>[11];
				v7[559] := multiset{cf15};
				var v8: multiset<int> := multiset{cf15};
				var v9: map<bool, int> := map[f24 := cf15];
				v7[559] := (v8 + v8) - (multiset{|map[|v9| := f24]|} + v8);
				if (false) {
					globalState.f8 := cf15;
					var v10: array<int> := new int[14];
					v10[521] := cf15;
					v10[521] := --cf15;
					globalState.f17 := fm1(v10[521] - 582, f25 <==> f25, globalState);
					var v11: multiset<seq<int>> := multiset{v4 + v4};
					v11 := v11;
					var v12: multiset<bool> := multiset{v2[856], f24};
					r2 := (v12 * fm22(cf15, v2[856], f24, v10[521], globalState)) !! multiset{v2[856], f24, f25, true};
				} else {
					globalState.f1 := f24;
					f24 := (0x267 % cf15) > (cf15 + cf15);
					r2 := v2[856];
					v0 := (seq(0x205, i1  => (v6))) + v0;
					v2[856] := false || f25;
				}
			...
			case DC10(cf16, cf17) =>
				...
				var v14 := DC7(v13);
				v14 := v14;
				var v16: array<set<int>> := new set<int>[9](i2 => set v15 : int | (0x17c <= v15) && (v15 < 0x2cf) :: (v15 / |map[cf16 := multiset{f24}]|));
				var v17 := 0x2d1;
				...
				var v23: seq<array<multiset<bool>>> := [v20, v20, v21[|(map v22 : int | (0x274 <= v22) && (v22 < 0x92) :: (v22 / |[cf16]|) := (cf16))|]];
				v20 := v23[v17 + 0x9b];
			...
			case DC8(cf14) =>
				...
				var v31: set<int> := {v27};
				m9(v25, f25 ==> !f24, v29[v27], |v30| % |v31|, globalState);
				var v32: array<bool> := new bool[25] [f24, true, f24, f24, f25, f24, f25, f25, f24, !f24, !f25, f24, f25, true, v29[v27], f24, f25, f25, f25, f25, f24, f25, f25, f24, f25];
		...
		var v39 := DC5(v35[v36], v37, v36, v36, v38);
			...
			decreases 100 - i5
		{
			...
			var v45 := new C0(v43, v36, v36 / |v44|);
			var v46: seq<int> := [v36];
			var v47: set<int> := {|v46|};
			...
			r3 := v45.f31;
			var v53 := DC1(f24, v36);
			var v54: map<seq<int>, bool> := map[v46[v53.cf2 := v45.f31] := f25];
		...
		if (f24) {
			...
			var v59 := 'a';
			v58[72] := if (f25) then v59 else v59;
			var v60: seq<int> := [973];
			var v61: multiset<seq<int>> := multiset{v60 + v60};
			globalState.f8, v58[72], v56[621] := if ((v60 + v60) in v61) then v61[v60 + v60] else v36, v59, v56[621];
			var v62: array<int> := new int[21];
			globalState.f14, v62, globalState.f9 := |v35| * (v36 + v36), v62, v35[fm1(v36, f25, globalState)];
			globalState.f8 := v36;
			var v63 := DC4(f25, f24);
			...
			var v80: array<int> := new int[25] [v72.f23, v69.f31, 966, v69.f31, v72.f23, |v35|, v36, v36, v69.f31, |v74|, v36, |v75|, v72.f23, v36, if (f25 in v76) then v76[f25] else |v77|, v72.f23, |v77|, |map[|multiset{set v78 : int | v78 in v77 :: (v78 - 0x1a5), v79}| := f24]|, v77[v36], v36, v69.f31, |v0|, v36, v36, v36];
			var v81 := DC22(v80);
			...
			if (fm22(v72.f23, f25, !f25, v72.f23, globalState) < v76) {
				...
				v88[872] := if (f24) then DC15(v36, v66, v71, v84.cf28[DC9(v36) := v80]) else v84;
				v88[872] := v83;
				v87 := v87[0x1be := |v35| % v72.f23];
			} else {
				v80[908] := v69.f31;
				v80[908] := -|v69.f30|;
				var v89: array<int> := new int[1];
				var v90: seq<array<int>> := [v89];
				var v91: array<array<int>> := new array<int>[9] [v89, v89, v89, v89, v89, v89, v90[v77[v72.f23]], v89, v89];
				v91[82] := v89;
				v91[82] := v89;
				r3 := -v69.f31;
		...
		r1 := v97;
		r2 := !f24;
		var v98: map<int, int> := map[-0xae := v36 / -0x257];
		var v99: map<seq<bool>, set<bool>> := map[v35 := {f25, f25}];
		r3 := --(if (v36 in v98) then v98[v36] else |v99| % v36);
	}
	method m8(p0: bool, p1: int, p2: map<map<bool, char>, bool>, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v4 := "helwwm";
			var v5: seq<string> := [seq(-0x29f, i1  => ('n'))];
			var v6: map<bool, int> := map[f24 := p1];
			var v7: seq<int> := [|v6|];
			v0[659] := v4 == v5[|v7|];
			v0[659] := true;
			globalState.f9 := !!f24;
			globalState.f15 := v0[659];
		...
		match (DC1(!(v10 == v10), p1)) {
			...
			case DC0(cf0) =>
				...
				v0[451] := fm29(v2.f31, |v10|, !cf0, globalState);
				var v17: set<int> := {v2.f31, v2.f31, -p1};
				var v18: map<int, int> := map[v2.f31 := |v17|];
				var v19: seq<bool> := [f25];
				v16, globalState.f6, globalState.f14, v0[451], globalState.f8 := v16 + v16, f24, p1 / v2.f31, (if (f24) then p0 else false) <==> (0x14f >= (if (|v19| in v18) then v18[|v19|] else -0x1d3)), v2.f31;
				var v20: array<bool> := new bool[11];
				var v21 := 'd';
				var v22 := new C0({v20}, |fm25(v19[|v18|], f24, v21, globalState)|, p1);
				globalState.f6 := v19[p1 - v22.f31];
			...
			case DC2(cf3) =>
				...
				var v38: array<int> := new int[10] [v2.f31, -v2.f31, v2.f31 / v2.f31, if (v30.f31 in v35) then v35[v30.f31] else -v30.f31, v30.f31 + v2.f31, v2.f31 + -v2.f31, p1 * p1, v2.fm2(globalState), |v3|, |(v37 + v37)|];
				v38 := v38;
				v33 := v33;
		}
	...
	method m9(p0: char, p1: bool, p2: bool, p3: int, globalState: GlobalState) {
		...
		for i0 := |(v0 + v0)| to v2.cf15 {
			var v3: seq<bool> := [f25];
			globalState.f9 := fm29(0x1bc, i0, v3[i0], globalState);
		...
		v12[378] := v12[378];
		var v14: seq<int> := [p3];
		var v15: multiset<int> := multiset{p3, v12[378], v12[378]};
		...
		var v20: seq<int> := [v14[p3], v12[378]];
		globalState.f14, globalState.f8, f24, v0, globalState.f15 := -p3, -v12[378] % p3, p1, seq(0x32c, i1  => (p0)), (if (!fm29(0x2d4, p3, f25, globalState)) then v20 else DC28(seq(0x334, i2  => (|"a"|))).cf52[p3 := p3]) <= v14;
		globalState.f15 := fm29(p3, p3 * v12[378], f25, globalState);
	}
}
...
class C2 extends T0 {
	...
	method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: bool) {
		...
		if (p0 || p0) {
			...
			v0[90] := p0;
			var v1 := "qbhsiypk";
			globalState.f8, v0[90], globalState.f1, v1 := f23 / 0x3d6, p0, false, v1;
			var v2 := DC8(seq(-0x205, i1  => (DC3('m').cf4)));
			var v3: map<bool, bool> := map[p1 := v0[90]];
			var v4: set<bool> := {p0, p0};
			globalState.f17, v2, globalState.f14, globalState.f6, globalState.f17 := |(v3 + v3)| - f23, v2, f23 - f23, p1 && p0, |(v4 - {false})| / f23;
			globalState.f14 := f23;
			var v5: map<string, bool> := map[v1 := |"oqfaosxj"| < f23];
			var v6: set<int> := {f23};
			var v7: seq<bool> := [v0[90], v0[90]];
			v5, globalState.f17, globalState.f14, globalState.f17 := v5, f23 / (f23 + f23), if (v6 < v6) then f23 else |v7|, f23;
			...
			var v13: multiset<string> := multiset{v11, if (p1 in v12) then v12[p1] else seq(-0x1f9, i2  => ('n')), v11};
			var v14: seq<multiset<string>> := [v13, v13, v13];
			var v15: map<int, int> := map[0x155 := |v14[|(seq(0x35d, i3  => ('i')))|]|];
			...
			var v20 := DC5(p0, v18, f23, if (f23 in v15) then v15[f23] else v17[406], v19);
			var v21: map<int, D1> := map[v17[406] := v20];
			v21 := v21[v17[406] := v20];
		}
		...
		var v29 := "ngg";
		globalState.f8, globalState.f15, v23, v24 := |v27.cf21|, v28[f23] && !(v29 < v29), v23, v24;
		...
		var v37: set<int> := {|v36|};
		r2, globalState.f6, v34 := fm3(if (p1) then v29 else v29, true, f23, v35[f23], globalState), v37 <= v37, multiset{p0, p1} + (multiset{p1, p0})[!p0 := |[p0]|];
		r0 := 0x1e / f23;
	...
	method m6(p0: bool, p1: seq<int>, p2: bool, p3: int, globalState: GlobalState) returns (r0: D0, r1: int, r2: int) {
		...
		for i0 := -|v0| + |multiset{DC9(p3)}| to fm2(globalState) {
			...
			var v7: map<int, seq<map<D1, int>>> := map[|v3| := v6[i0] + v6[i0]];
			v7 := v7[f23 := v5];
			v1 := v1[!p2 := i0];
			var v8 := DC8(v0);
			var v9 := 'i';
			...
			var v13: array<bool> := new bool[29] [p2, fm3(v8.cf14, p0, i0, p1, globalState), p2, p2, v0 <= v0[i0 := v9], p0, p0, p0, p0, !p0, v10 < [v10[fm1(f23, !p0, globalState)], p2], p0, !p2, !(p3 < f23), v11 <= v11, if (p2) then !v10[i0] else !!p0, p2, p0, p2, p2, fm3(v0, p0, i0, p1, globalState), p0, true, p2, p0, p0, p0, v12 !! v12, p0];
			v13[748] := true;
			v13[748] := p2;
			var v14: set<int> := {-0x246, i0, |(seq(0x16e, i1  => (i0)))|, p3};
			...
			if (if ((|v0| <= |v0|) in v15) then v15[|v0| <= |v0|] else p0) {
				...
				var v23 := DC15(0x124, if (v13[748]) then v0[f23] else v9, v19, v22 + v22);
				var v24: array<seq<bool>> := new seq<bool>[21](i2 => [p0]);
				var v25 := DC16(v10);
				v24[186] := v25.cf29;
				var v26: map<int, char> := map[if (p2) then -0x3d2 else p1[-0x297] := v9];
				v23, v13, v13, v24[186], v26 := v23.(cf25 := p3 - f23, cf27 := v19 + v19), v13, v13, v10, v26 + v26;
				globalState.f5 := fm1(p3, true, globalState);
				globalState.f1 := v11 <= v11;
				globalState.f9 := !v13[748];
			} else {
				var v27 := DC16(v10);
				v27 := v27;
				v13[748] := p2;
				var v28: map<bool, multiset<bool>> := map[p2 := multiset{v10[-p3]}];
				v28 := v28[v13[748] := fm21(p2, true, f23, globalState)];
				var v29: map<int, int> := map[i0 - f23 := if (v13[748]) then p3 else i0];
				v29 := v29[p3 := f23];
	...
	method m7(p0: array<bool>, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		p0[901] := p2;
		var v0 := "qiu";
		p0[901] := if (true) then "mseqsel" != v0 else p1;
		globalState.f17 := f23;
		...
		var v11 := DC9(f23);
		var v12: array<int> := new int[9](i2 => i2 / f23);
		var v13 := DC15(|v0[|v8| := v7]|, v7, v10, map[v11 := v12]);
		var v14: array<int> := new int[15] [|(seq(223, i0  => ('r')))|, f23, f23, if (p2 in v1) then v1[p2] else f23, |v2|, |fm21(true, p2, f23, globalState)|, f23, -|fm20(p0[901], globalState)|, |v0| * f23, f23, f23, fm2(globalState), |(v3 + (if (v0 in v6) then v6[v0] else v3))|, v13.cf25, f23];
		v12[726] := f23 / f23;
		var v15: map<int, array<bool>> := map[fm2(globalState) := p0];
		var v16: set<array<bool>> := {if (f23 in v15) then v15[f23] else p0};
		v12[726] := -(|(if (p3) then {p0} else v16)| - f23);
		var i3 := 0;
		while (v7 !in v0)
			decreases 100 - i3
		{
			...
			if (p2 ==> p2) {
				...
				var v18 := new C0(v16 - v16, v12[726], 0x106);
				var v19: map<bool, bool> := map[p1 := p3];
				globalState.f1 := |(map[fm29(v18.f31, f23, p0[901], globalState) := p3] + v19)| <= v12[726];
				var v20: array<string> := new string[19];
				v20[595] := v0 + v0;
				v20[595] := v0 + fm20(p0[901], globalState);
				var v21: seq<int> := [v18.f31, 715];
				var v22: set<bool> := {p0[901]};
				var v23: map<seq<int>, bool> := map[v21[f23 := v12[726]] := v22 !! v22];
				var v25: seq<seq<int>> := [v21, v21];
				v23 := ((map v24 : seq<int> | v24 in v25 :: (v24) := (p0[901])) + (map v26 : seq<int> | v26 in v23 :: (v26) := (p1))) + map[v21 := p1];
			} else {
				var v27: map<int, int> := map[-(v12[726] % -120) := |multiset{p0[901], p3, p1, true, p3}|];
				v27 := map[|map[if (f23 in v2) then v2[f23] else -0x109 := 'p']| := fm1(fm1(|multiset(v3)|, p2, globalState), p2, globalState)] + map[f23 := f23];
				r0 := !(v7 !in (v0 + (seq(511, i4  => ('m')))));
				globalState.f17 := (f23 + v12[726]) / f23;
				globalState.f17 := 0x170;
				var v30: array<map<int, int>> := new map<int, int>[18](i5 => map v28 : int | v28 in (set v29 : int | v29 in v4 :: (v29 % |"qnqjr"|)) :: (v28 / v12[726]) := (|map[v7 := v7]|));
				v30 := new map<int, int>[24](i6 => v27);
			}
			
			var v31: map<bool, bool> := map[p3 := p0[901]];
			var v32: set<int> := {f23};
			var v33: map<bool, int> := map[false := |v32|];
			var v34 := DC5(p0[901], v31, -0x381, |(fm30(if (p2 in v1) then v1[p2] else -629, v0, p3, if (true in v1) then v1[true] else if (p0[901] in v33) then v33[p0[901]] else |v0|, globalState))[v12[726] := p0[901]]|, v33 + v33);
			v34 := v34;
			globalState.f8 := v12[726];
			globalState.f8 := f23;
		}
		var v35: seq<multiset<int>> := [v2];
		var v36: seq<seq<multiset<int>>> := [v35, v35, seq(-187, i7  => (v2))];
		globalState.f9 := v35 < v36[v12[726]];
		var v37: C0 := new C0(v16, f23, -v12[726]);
		var v38: seq<C0> := [v37, v37];
		r0 := p3 in (map[p3 := v38])[p0[901] := v38];
	}
}
...
class C3 extends T1, T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
		...
		v0[581] := v6[f23] - (if (0x14 in v7) then v7[0x14] else v5);
		...
		v17[346], v4[90], v19[52], globalState.f8 := v4, fm16(f25, f28, f24, globalState), fm1(-f23, f24, globalState) % (f29 - |v21|), -f29;
		...
		r0 := match DC3(if (v1 in v22) then v22[v1] else 'k') {
			...
			case DC3(cf4) => map[v9[v19[52]] := f28] == map[f28 := v4[90]]
			case DC6(cf12) => f28
		};
	...
	method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			var v8 := new C0(v7, f23, f23 / -f23);
			var v9: array<int> := new int[1];
			var v10: set<array<int>> := {v9};
			var v11: set<bool> := {f28};
			var v12: map<int, int> := map[|{f23, f29, |(seq(0x34d, i1  => ('r')))|, |v10|, |v11|}| := f23];
			var v13 := new C1(false, v12 == v12);
			var v14: seq<bool> := [f24, p1];
			v6[550] := v14 <= v14;
			v6[550] := true;
			var v15: map<string, int> := map[v3 := |(seq(0x350, i2  => ('h')))|];
		...
		for i3 := f29 to -0x192 {
			...
			var v35: array<set<bool>> := new set<bool>[22] [v20, v20, {true}, v20, v20, fm32(f24, v5, v22[f29], set v25 : D1 | v25 in v24 :: (v25), globalState), v20, v20, fm32(if ((if (!p0 in v28) then v28[!p0] else v26) in v27) then v27[if (!p0 in v28) then v28[!p0] else v26] else p1, v5, v21, v29, globalState), fm32(f28, v5, v21, set v30 : D1 | v30 in fm33(f28, v3, 846, f28, globalState) :: (v30), globalState), v20, if (|map[v21[|v3|] := f28]| in v31) then v31[|map[v21[|v3|] := f28]|] else v20, v32[|v33|] * v20, {f24, f24, v21[-f29]}, if (true) then v20 else {f24}, {!p1}, v20, v20, v20, {!fm17(v34, globalState), f25, !p0}, v20, fm32(f24, v5, v21, v29, globalState)];
			v35[696] := v20;
			v26[820] := f24;
			v35[696], v26[820], globalState.f17, globalState.f14 := v20 + v20, (|v3| / f23) <= 0x182, -f23, --(f23 % f23);
			globalState.f5 := if ((v26[820] <==> f24) in v17) then v17[v26[820] <==> f24] else f29 - |v3|;
			var v36: multiset<string> := multiset{seq(0x229, i5  => ('u'))};
		...
		if (p0) {
			if (fm16(true, f28, f24, globalState)) {
				...
				var v39 := 'g';
				v3 := v3 + DC8(v3[f29 := v39]).cf14[f23 := v39];
				...
				globalState.f1, globalState.f17 := v42[v41 := f29] !! v42, -0x30b / |(v44 + v44)|;
				...
				var v50: array<int> := new int[8] [f23, |(seq(156, i6  => (|map[0x35a := true]|)))|, f23, v48.cf10, f23, f29, |v49|, f23];
				...
				var v53: map<int, bool> := map[|(seq(-899, i7  => ('n')))| + |v52| := f25];
				v53 := v53[f29 := p1];
				globalState.f5 := f29 / f29;
				var v54 := 'm';
				v54 := v54;
	...
	method m5(p0: bool, p1: int, globalState: GlobalState) {
			...
			decreases 100 - i3
		{
			...
			v0[726] := v5 != [f24, f28, f24, f25, f24];
			v4, v0[726], globalState.f14 := v4, f24, f29;
			var v6: seq<int> := [f29];
			var v7 := DC28(v6);
			var v8: map<bool, int> := map[f25 := f23];
			var v9: map<seq<int>, int> := map[v7.cf52 := |v8|];
			var v10: map<map<seq<int>, int>, int> := map[v9 := f29];
			var v11: seq<int> := [-(f29 % -f29), 0x44, |v6|, 0x320, if (v9 in v10) then v10[v9] else f29];
			v11 := seq(0x245, i4  => (f23));
			var v12 := new C1(f24 || f24, p0);
			var v13: seq<array<int>> := [v1, v1];
			var v14: map<bool, array<int>> := map[true := v1];
			var v15: seq<array<int>> := [if (v0[726]) then v13[f29] else v1, if (f25) then v1 else if (f24 in v14) then v14[f24] else v1, v1, v1];
			var v16 := DC0(p0);
			var v17 := 'e';
			var v18: set<bool> := {f24, v0[726], f28};
			globalState.f17, globalState.f6, globalState.f8, v15 := -|(fm25(v16.cf0, f28, v17, globalState) + (seq(0x18, i5  => (v17))))|, v18 < v18, f29, v13;
		}
		var v19 := 'v';
...
class C4 extends T1 {
	...
	function fm5(p0: int, p1: int, globalState: GlobalState): int {
		|(map[--0x303 := multiset{0xe9}] + (map v0 : int | (0x39b <= v0) && (v0 < 0x23b) :: (v0 - 248) := (multiset{|"mpuhcuieu"|, |(set v1 : int | v1 in [|{362}|] :: (v1 / |"t"|))|, 0xdc})))|
	}
	...
	function fm15(p0: int, p1: int, p2: bool, globalState: GlobalState): int {
		match DC4(f27, f24) {
			...
			case DC3(cf4) => 810
			case DC6(cf12) => |("caeqeee" + (seq(945, i0  => ('l'))))|
		}
	}
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
		var v0 := 0x1ac;
		for i0 := v0 * v0 to v0 {
			...
			v9[144] := v11;
			var v12 := DC7(v1);
			v8[275], globalState.f14, v9[144], globalState.f14 := (v12.(cf13 := v1)).cf13, i0, v11, v0;
		}
		var v13: array<bool> := new bool[26](i2 => f24);
		v13[226] := f25;
		var v14: map<int, int> := map[v0 := v0];
		var v16: multiset<map<int, int>> := multiset{v14, map v15 : int | (-0x253 <= v15) && (v15 < 0x1b9) :: (v15 % v0) := (v0), v14};
		var v17: map<multiset<map<int, int>>, int> := map[v16 := v0];
		globalState.f9, f24, v13[226], globalState.f5 := (v0 < v0) ==> f24, f24, f24, if (v16 in v17) then v17[v16] else v0 - v0;
		var v18: seq<bool> := [v13[226], false];
		...
		var v23: set<int> := {v0};
		var v24: array<int> := new int[19] [v0, v0, v0, v0, v0, v0, |v18[v0 := f24]|, v0, v0, |v20|, |"x"|, v0, v0, |v21|, if (v0 in v22) then v22[v0] else --v0, v0, |v23|, v0, v0];
		var v25: seq<array<int>> := [v24];
		var v26: seq<int> := [0x296, v0, |v21|];
		var v27: seq<int> := [v26[v0]];
		for i3 := v0 to |v25[|v26| := v25[v0]]| - 845 {
			if (f25) {
				v21 := v21;
				v18 := v18;
				...
				v28[716] := v30;
				v28[716] := (map[v29 := v0])[v29 := i3];
				v29 := if (i3 < v0) then v21[v0] else v29;
				var v31 := DC1(v13[226], v0);
				var v32 := DC2(v31);
			...
			globalState.f14, v40[901] := fm15(|v41| + v0, 0x177, fm14(globalState), globalState), v36;
			if (f27) {
				r0 := f25;
				var v42 := 'o';
				...
				globalState.f8 := -(i3 % -(i3 - i3));
				v13[226] := fm14(globalState);
				r0 := f27;
				var v47 := new C1(f24, true);
				var v48 := 'c';
				var v49: array<seq<int>> := new seq<int>[10];
				var v50: array<map<bool, int>> := new map<bool, int>[22];
				v48, globalState.f8, v49, v21, v50 := v21[v0], -(i3 / |v18|), v49, v21, if (v13[226]) then v50 else v50;
			}
			...
			decreases 100 - i6
		{
			...
			i6 := i6 + 1;
			var v53 := 'd';
			var v54: seq<string> := [v21, v21[v0 := v53]];
			v54 := v54;
			v24 := new int[15];
			var v55: set<bool> := {!f24, true};
			var v56: map<set<bool>, bool> := map[v55 := v13[226]];
			var v58: seq<map<set<bool>, bool>> := [v56];
			var v59: map<int, map<set<bool>, bool>> := map[v0 := v56];
			var v61: array<map<set<bool>, bool>> := new map<set<bool>, bool>[14] [v56, v56, if (f27) then map v57 : set<bool> | v57 in multiset(seq(0x293, i7  => (v55))) :: (v57) := (f27) else v56, v56 + v58[v0], if (v0 in v59) then v59[v0] else fm35(globalState), v56, v56 + map[{v13[226], f25} := f24], v56, v56 + v56, v56, v56, if (v13[226]) then map v60 : set<bool> | v60 in (seq(0x250, i8  => (v55))) :: (v60) := (f27) else v56, v56, v56];
			v61[802] := v56;
			v61[802] := v56;
			globalState.f1 := f24;
		}
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
		...
		for i0 := v0 to |(v2 + [v1, v1])| {
			...
			if (!f24) {
				...
				var v15: multiset<bool> := multiset{f25, f24, f25 && !f24, v14[v3.fm2(globalState)], f25};
				v8, v12[677], globalState.f17, v13[181], v5[740] := v8, v1, if (('n' in fm25(true, f24, v1, globalState)) in v15) then v15['n' in fm25(true, f24, v1, globalState)] else 0xbf, v12, fm29(|v2|, v6.f31, fm29(v6.f31, v6.f31, f24, globalState), globalState);
				r0 := v5[740];
			} else {
				var v16: multiset<bool> := multiset{!f24};
				var v17: seq<bool> := [v16 !! v16, f25];
				var v18: map<char, int> := map[v1 := v0];
				globalState.f15 := v17[|v18| % v0];
				globalState.f14 := v0;
				var v19: array<seq<char>> := new seq<char>[6];
				v19[195] := if (v17[281]) then v2 else v2;
				v19[195] := (v2 + v2) + v2;
				var v20: map<int, int> := map[|v17| := |v19[195]|];
				var v21: T0 := new C2(|v20|);
				var v22 := DC30(v21);
				v22 := v22;
				var v23: array<bool> := new bool[1] [f25];
				var v24: array<int> := new int[18];
				var v25 := DC31(v24, v0, v17[v21.f23]);
				v23[340] := v25.cf59;
				v23[340] := f25;
			}
			...
			if (f25) {
				...
				globalState.f17, globalState.f9, v26[787], globalState.f1, globalState.f14 := v0, i0 >= -(-0x9e / 0x20e), |v27|, f25, i0;
				var v28: map<bool, char> := map[f25 := v1];
				var v29: multiset<map<bool, char>> := multiset{v28, v28};
				globalState.f15 := v29 > v29;
				v27, v26[787], v0 := v27, i0, v0;
				globalState.f8 := v0 + i0;
				globalState.f1, globalState.f1, globalState.f14, globalState.f17 := true, !f25, v26[787], i0;
			} else {
				globalState.f1 := f24;
				globalState.f17 := v0;
				var v30: array<bool> := new bool[26];
				var v31: seq<array<bool>> := [v30, v30, if (f25) then v30 else v30];
				v31 := (v31 + v31)[i0 := v30] + v31;
				globalState.f8 := (v0 / -i0) - i0;
				...
				var v42 := DC4(f25, f24);
				var v43: set<D1> := {v42};
				v33[775] := v32 * (fm32(f25, v40, v41, v43, globalState) + v32);
			}
		...
		var v53: array<int> := new int[18] [v0 - -v0, |v51|, v0, v0, v0, |v52|, v0, v0, v0, |v2|, v0, -v0, v0, v0 % v0, -v0, v0, |v50|, if (f24) then v0 else v0];
		...
		var v58: array<bool> := new bool[28] [f25, f24, v48[--v50[v0]] <==> !f24, f24, v54 == v54, f25 || true, f24, f25, f24, f25, true, f25, f25, f25, fm29(|(map v55 : int | (0x142 <= v55) && (v55 < 0x100) :: (v55 + v0) := (f24))|, |(map v56 : int | v56 in v50[674 := |v49|] :: (v56 - v0) := (f25))|, f25, globalState), f24, f24, (if (v0 in v57) then v57[v0] else -v0) != -v0, v49 > v49, f24, !f25, f25, fm29(v0, v0, f24, globalState), !f24, !(v0 <= v0), |v50| < v0, false, f25];
		v58[344] := true;
		v58[344] := f24;
		var v59: C1 := new C1(f24, true);
		var v60: map<int, C1> := map[v0 := v59];
		v49, globalState.f9 := multiset{v58[344], f25, v48[v0]}, fm29(v0, v0, v0 == |v60|, globalState);
		r0 := v0 >= -v0;
		r1 := new C3(f24, v0, v58[344], v58[344], --v0);
		r2 := f24;
		r3 := v0;
	}
}
...
class C6 extends T1, T0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
			...
			decreases 100 - i0
		{
			...
			v7[785] := if (v11 in v12) then v12[v11] else f23;
			var v13 := DC5(f24, v10, |v9|, |map[f23 := f25]|, v5);
			v7[785] := v13.cf9;
			v3 := fm12(f25, globalState);
			var v14: T1 := new C5(f24, f25);
			var v15 := m4(v2, f23, fm3(v0, f24, |map[v14 := v10]|, seq(0x3a2, i2  => (f23)), globalState), 'a', globalState);
		}
		v4[911] := f24;
		v4[911] := false;
		var v16: seq<int> := [f23];
		...
		var v22: array<int> := new int[8](i3 => i3 % f23);
		var v23: map<D3, array<int>> := map[DC9(f23) := v22];
		var v24: array<int> := new int[13] [|v16|, f23 + 0x3c8, fm1(-|(map v17 : int | v17 in v18 :: (v17 % 0x211) := (f24))|, f25, globalState), f23, -(f23 + f23), f23 % DC15(f23, v3, map[v21 := v3], v23).cf25, f23, f23, f23, f23, f23 - f23, f23, f23];
		var v25: map<array<int>, bool> := map[v24 := f24];
		v4[911], v22, v25 := v4[911], if (0x8c != 0x39e) then v24 else v22, v25;
		for i4 := 0x339 to f23 {
			v5 := ((fm36(globalState))[f25 := |map[f24 := f24]|])[f25 := |(map[!f25 := 285] + v5)|];
			var v26 := new C4(!f25, f24, !f25);
			r3 := f23;
			var v27: C4 := new C4(f25 && !f25, f25, v4[911] ==> f24);
			var v28: seq<bool> := [v27.f27, v26.f27, v4[911]];
			r0, globalState.f6, v27, f24, v4 := f24, v28[i4 / f23], v26, v27.f27, v4;
		}
		var v29: seq<bool> := [v4[911], f25, f24];
		r0 := v4[911] in v29;
		var v30: T0 := new C2(f23);
		r1 := v30;
		r2 := f25;
		var v31: map<bool, bool> := map[false := v4[911]];
		var v32 := DC5(f24, v31, f23, f23, v5);
		var v33: map<int, int> := map[v30.f23 := v32.cf9];
		var v34: map<int, int> := map[v30.f23 := |v33|];
		r3 := v30.f23 / |(v34 + map[v30.f23 := f23])|;
	}
	method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: bool) {
		var v0: seq<int> := [f23];
		var v1 := DC28(([f23, f23])[f23 := 0x3b8]);
		var v2 := "itfta";
		var v3: array<seq<int>> := new seq<int>[18] [v0, v0, v0, [-0x2ba], v0, v0, v1.cf52, v0, v0[|v2| := f23], fm31(p1, true, globalState), seq(0xb4, i1  => (f23)), v0, v0, v0, v0, v0 + v0, v0, [f23]];
		forall i0 | 0 <= i0 < v3.Length {
			v3[i0] := (v0 + v0[f23 := f23])[f23 := f23];
		}
		...
		var v9: seq<bool> := [f25];
		var v10: array<int> := new int[22](i4 => i4 % |"sl"|);
		...
		var v15: array<int> := new int[21] [-v0[|v2|], f23, f23, f23, f23, f23, -v0[|map[p1 := v5]|], f23, -|v7|, f23, f23 % -|v8[f23]|, f23 / f23, fm1(f23, f25, globalState), |(if (v9[f23]) then v11 else v11)|, f23 - f23, f23, |v2| % 0x3e4, if (v9 in v12) then v12[v9] else f23, f23 / f23, |v14|, f23];
		forall i3 | 0 <= i3 < v10.Length {
			v10[i3] := i3 * (f23 + |v0|);
		}
		for i5 := |v6| + f23 to v0[f23] {
			globalState.f14 := (i5 / i5) + f23;
			var v16: map<char, bool> := map['i' := p0];
			var v17: multiset<int> := multiset{|(seq(0x2f5, i6  => ('q')))|, |fm37(f25, |v16|, globalState)|, i5, i5, f23};
			var v18: set<multiset<int>> := {v17[f23 := f23]};
			...
			v20[234] := v6;
			v18, globalState.f8, v20[234] := v18, i5 / -fm1(-i5, p0, globalState), {p1, i5 < i5, !false};
			if (p0) {
				var v21 := 'y';
				...
				v26[214] := v10;
				v26[214] := new int[28](i7 => i7 * -v25.f31);
				v4 := v4;
			} else {
				v2 := v2 + v2;
				var v27: set<set<bool>> := {v6, v6};
				globalState.f9 := (if (p1) then {v20[234], v20[234]} else fm38(f23, -i5, globalState)) !! v27;
				globalState.f6 := v9[0x3d5];
				globalState.f15 := fm3("gvwh", p0, |v0| / i5, v0, globalState);
	...
	method m4(p0: array<array<char>>, p1: int, p2: bool, p3: char, globalState: GlobalState) returns (r0: array<bool>) {
		...
		globalState.f8, globalState.f9 := fm2(globalState), |"u"| <= (|(map v0 : int | (-489 <= v0) && (v0 < -153) :: (v0 + |[f23, p1, p1]|) := (f25))| - |v1[f23 := 'q']|);
		...
		var v7 := DC21(v6);
		var v8: seq<int> := [p1];
		var v9: map<D7, int> := map[v7 := v8[p1]];
		var v10: seq<int> := [if (v7 in v9) then v9[v7] else f23];
		globalState.f1 := fm3(v1 + v1[fm5(p1, |v2|, globalState) := p3], f25, |v3|, v10, globalState);
		if (0x2f2 == f23) {
			...
			v3, globalState.f1, globalState.f1 := v27[f23] - v3, p2, p2;
			globalState.f17 := f23;
			var v28 := 'm';
			v28 := v28;
		} else {
			...
			globalState.f8 := f23;
			globalState.f8 := 129;
			globalState.f8 := |(multiset{f25, f25, !true})[f25 := f23 / f23]|;
		}
...
class C7 {
	...
	method m2(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: D0) {
		...
		v7[220] := v9;
		v3[117] := p1;
		v3[117] := if (false) then p1 else fm9(p1, globalState) ==> fm9(true, globalState);
		r0 := p1;
	...
	method m3(p0: int, p1: int, p2: int, p3: array<int>, globalState: GlobalState) returns (r0: map<int, T1>, r1: array<bool>) {
		...
		v4[219], globalState.f15, globalState.f8, globalState.f1 := v1, match DC3(v1) {
			case DC4(cf5, cf6) => v0
			...
			decreases 100 - i0
		{
			...
			match (v8) {
				case DC4(cf5, cf6) =>
					...
					var v12: seq<bool> := [v9[|v11|], cf5];
					v12 := v12;
					v1 := if (!(cf5 && v0)) then v1 else 'b';
					var v13: map<int, int> := map[p0 := p2];
					v13 := v13[|v6| := p1];
					globalState.f14 := if (cf6) then |fm10(v0, |v12|, v1, v4[219], globalState)| else p1;
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					...
					globalState.f14, v1 := (-321 + p2) / (cf9 % 0x13f), v1;
					var v20: seq<int> := [cf9];
					...
					v23 := map v24 : int | v24 in v25[v21.fm13(cf10, v0, globalState) := |v6|] :: (v24 + cf9) := (p0 % p0);
				case DC3(cf4) =>
				...
				case DC6(cf12) =>
					...
					var v37: array<bool> := new bool[25] [v0, (set v33 : string | v33 in multiset(v32) :: (v33)) !! {v6}, !true, v0, true, v0, v0 || true, false, v0, v34[p1], v0, v0, v0, v0, true, v0, v0, v0, map[|v6[p2 := v4[219]]| := v0] != map[p2 := v0], !v0, v0, v0, v0, !v0, v35 !in v36];
					v37[741] := v0;
					v37[741] := (|v34| % p2) != (p1 - p0);
		...
		var v56: seq<int> := [p2];
		var v57 := DC28(v56);
		if (map[p0 := 0x30a] != DC35(map v55 : int | v55 in v57.cf52 :: (v55 % p2) := (|map[p2 := v0]|)).cf63) {
			var v58 := new C2(p1);
			...
			globalState.f8 := p1;
			globalState.f1, globalState.f6, globalState.f6, v54, globalState.f5 := !v0, v0 <==> (v0 || v0), v0, seq(879, i5  => (v1)), 0x108;
		} else {
			if (true) {
				v54 := [v1];
				...
				v73 := v73[!!v72.f27 := p0];
				var v74: seq<bool> := [v0];
				var v75: array<seq<int>> := new seq<int>[8] [v56, (seq(0x1ac, i6  => (p2))) + (seq(787, i7  => (p1))), v56, [|v74|, p1] + v56, v57.cf52, v56, v56, v56 + v56];
				v75[475] := v56;
				...
				v92 := new C5(v0, v0);
				v4[219] := v1;
				globalState.f17, v54 := if (false) then 0x2ba % p2 else |v54|, v54;
				v4[219] := v1;
			}
			...
			match (v95) {
				case DC1(cf1, cf2) =>
					...
					var v104: multiset<char> := multiset{v1, v4[219], v1};
					var v105 := DC0(v104 < v104);
					var v106 := DC36(v100);
					v52[507], v100, v54, v103, v105 := cf2, v100 + v106.cf64, v54, fm8(|map[cf2 := |v93[|(map v107 : int | (0x6d <= v107) && (v107 < 642) :: (v107 * p1) := (cf1))| := cf1]|]|, globalState) + (v103 + v103), v105;
					cf2 := v52[507];
				case DC0(cf0) =>
					p3[889] := p0;
					p3[889] := fm1(p0, cf0, globalState);
			...
			if (fm29(|v119|, --p2, v118.f24 <== v118.f25, globalState)) {
				...
				v124 := v124[v54 := v123[v52 := p0]];
				globalState.f5 := |v54| / |v120|;
				v1 := v4[219];
				v54 := (v54 + (seq(151, i8  => (v1))))[p0 := v4[219]];
			} else {
				...
				v0, globalState.f6, v52[884], r1 := if (v129 in v130) then v130[v129] else v118.f25, v0, p0 * v56[p0], v131;
				globalState.f15 := v0;
				var v132 := DC7(v131);
				...
				v134[95] := if (v118.f25 in v133) then v133[v118.f25] else v131;
				v134[95], globalState.f17, globalState.f15 := v131, v52[884], !!!fm29(v52[884], p2, v118.f25, globalState);
				var v135: array<map<int, bool>> := new map<int, bool>[8](i10 => v93 + v93);
				var v136: multiset<int> := multiset{p2};
				globalState.f5, v135, globalState.f1, v52[884] := 0x1e1, v135, v118.f25, v52[884] * |(v136 * v136)|;
			}
...
class C8 extends T0, T1 {
	...
	method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			var v1: seq<int> := [|v0|];
			var v2 := DC0(p0);
			var v3: array<bool> := new bool[22] [fm6(|[f23]|, multiset{seq(0x2c, i2  => (|[p1, true]|)), v1}, f25, f23, globalState), f25, f25, true, p1, f25, true, false, f25, p1, v2.cf0, false, f24, f25, v2.cf0, true, p0, p0, p1, p0, f25, true];
			var v4: map<array<bool>, int> := map[v3 := f23];
			globalState.f8 := -|(seq(0x258, i1  => ('y')))| - |v4|;
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: T0, r2: bool, r3: int) {
			...
			decreases 100 - i0
		{
			...
			var v9: seq<bool> := [f25];
			var v10: C5 := new C5(!f25, v9[v3.f31]);
			v10 := v10;
			globalState.f8 := v3.f31;
		}
		var v11: multiset<int> := multiset{f23};
		var v12: seq<bool> := [f25, f25, f24];
		var v13: seq<bool> := [true, v11 == v11, v12[v3.f31], !fm29(v3.f31, if (f23 in v11) then v11[f23] else f23, f25, globalState)];
		globalState.f5, f24 := f23, v13[f23 % v3.f31];
		...
		match (v15) {
			case DC23(cf40, cf41, cf42, cf43, cf44) =>
				...
				if (f24 || f24) {
					...
					globalState.f1 := DC29(f25, f25, |(map v18 : int | v18 in v19 :: (v18 / cf44) := (f25))|).cf54;
					var v20 := "wrebo";
					...
					globalState.f15 := if (if (v21.f27) then f24 else f25) then v21.f27 else if (((multiset(v25[cf44]))[cf42 := f23])[cf40 := v3.f31] in v24) then v24[((multiset(v25[cf44]))[cf42 := f23])[cf40 := v3.f31]] else f24;
					var v26: array<T1> := new T1[25];
					var v27: T1 := new C4(v21.f27, f25, v21.f27);
					var v28: seq<T1> := [v27];
					v26 := new T1[21] [v27, v27, v27, v27, if (fm3(v20, v27.f25, v3.f31, v19, globalState)) then v27 else v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v27, v28[|cf41|], v27];
				} else {
					var v29 := "gigjdhnxs";
					var v30 := 'p';
					v29 := v29 + (v29 + v29)[|v12| := v30];
					...
					v0[675], v0[413], globalState.f15, globalState.f15 := f24, !true, cf41 >= cf41, fm3(v29, !f24, |v32|, v33, globalState);
					var v34: array<string> := new string[15](i1 => v29);
					v34[899] := v29 + v29;
					v34[899] := v29;
					var v35: map<array<int>, string> := map[v14 := v34[899]];
				...
				v36[196] := 'l';
				var v37 := 'm';
				v36[196] := if (false) then v37 else v37;
			case DC24(cf45, cf46, cf47, cf48, cf49) =>
				...
				v40, v12, v38, globalState.f1 := v40, v12, fm25(!cf48, cf49.f31 > -cf45, cf46, globalState), fm31(f25, v41.cf59, globalState) <= (if (cf48) then v40[cf45 := v3.f31] else v40);
			...
			case DC22(cf39) =>
				if (f24) {
					...
					v11, globalState.f5, r3, v42 := if (v48[v3.f31] in v47) then v47[v48[v3.f31]] else multiset{-|v49|}, v44[v3.f31], v3.f31 - v3.f31, v42;
					var v50 := 'v';
					...
					var v59 := "qqj";
					globalState.f5 := |v2[v3.f31 := f23]| % (if (cf39 in v58) then v58[cf39] else |v59|);
					...
					v0[910] := v3.f31 > (if (v65 in v66) then v66[v65] else f23);
					v0[910] := f24;
					v50 := v50;
					globalState.f15 := !!f25;
				} else {
					cf39[793] := v3.f31 * 0x110;
					var v67 := 'g';
					var v68: map<bool, bool> := map[f25 := f25];
					cf39[793] := |(map[f24 := false] + (fm10(f24, v3.f31, fm12(false, globalState), v67, globalState) + v68))|;
					var v69 := new C5(0x6 == v3.f31, f25);
					var v70: set<bool> := {v12[fm1(v3.f31, f25, globalState)], !f24, f24, f25};
					v70 := v70 * {f25, f24, !f24};
					var v71: set<int> := {v3.f31, f23};
					globalState.f15 := !((v71 * v71) != v71);
					var v72: array<set<int>> := new set<int>[11];
					v72 := new set<int>[4] [v71, set v73 : int | (988 <= v73) && (v73 < 0x144) :: (v73 / |v70|), v71 - v71, v71 + v71];
				}
				...
				v0[66] := (if (v12 in v76) then v76[v12] else v12) <= v12;
				v0[66] := f25;
				globalState.f6 := f24;
				if (v74.f25) {
					...
					v77[939] := v82;
					v0[66], v77[939] := v82.cf54, v82;
					var v83: multiset<bool> := multiset{v74.f25};
					v14[169] := |v83|;
					v79, globalState.f1, globalState.f5, v14[169] := v79, f23 == f23, if ((v74.f25 ==> f25) in v83) then v83[v74.f25 ==> f25] else v3.f31, v3.f31;
					var v84 := new C4(v0[66], v74.f24, f24);
					globalState.f15, globalState.f1, v12, globalState.f8 := if (!(v83 <= v83)) then v11 <= v11 else v0[66], v84.f27, v12 + v12, v3.f31;
					...
					v85[886] := if (v74.f24) then v86 else v86;
					v85[886] := v86;
					v2 := v2;
					var v87 := 'f';
		...
		if (f24) {
			...
			v110 := v110.(cf22 := v111[v3.f31], cf23 := f24);
			var v113: map<int, bool> := map[0x3e7 := v96.f28];
			var v114: seq<map<int, int>> := [v2, map v112 : int | v112 in v113 :: (v112 % v96.f29) := (v3.f31), v2, map[v3.f31 := v96.f29], map[f23 := v3.f31]];
			v114 := ([v2])[v96.f29 := v2] + (v114 + v114);
			var v115: array<seq<bool>> := new seq<bool>[8];
			v115[470] := v12;
			v115[470] := [f25, !v12[v96.f29], if (v96.f28) then v96.f28 else v96.f28, v96.f28];
			var v116: array<array<bool>> := new array<bool>[3];
			var v117: C1 := new C1(v96.f28, true);
			var v118: map<C1, char> := map[v117 := v98];
			v14[955] := v96.f29 * v3.f31;
			globalState.f14, v116, globalState.f8, v118, v14[955] := v96.fm5(v3.f31, f23, globalState), v116, v3.f31, v118, v3.f31;
		} else {
			var v119 := 'd';
			...
			v122, v119 := v122 + v123[v3.f31], v119;
			var v124: C7 := new C7();
			var v125: multiset<C7> := multiset{v124, v124};
			var v126: seq<int> := [f23, v3.f31 * |v125|, if (!f24) then v3.f31 else v3.f31, v3.f31, v3.f31 + f23];
			v126 := [f23];
			if (v3.f31 < |v11|) {
				var v127, v128, v129 := v124.m2(f23, v11[0x2e9 := |v2|] < v11, globalState);
				var v130 := new C7();
				globalState.f1 := f24;
				v127 := f24;
				v128 := f24;
			} else {
				v14[461] := |(map v131 : int | (421 <= v131) && (v131 < 0xb6) :: (v131 / |v94|) := (f24))[v3.f31 := f25]|;
				v14[461] := f23 % f23;
				v0[531] := f25;
				v0[531] := f24;
				var v132: C3 := new C3(v0[531], v3.f31, v0[531], v0[531], v3.f31);
				var v133: seq<C3> := [v132];
				var v134: seq<seq<C3>> := [v133, v133];
				var v135: array<seq<C3>> := new seq<C3>[12] [v133 + v133, v133, v134[f23], v133 + [v132], v133, v133, v133, if (v132.f28) then v133 else [v132], v133, v133, v133, v133[v3.f31 := v132]];
				var v136: C1 := new C1(v132.f28, !v132.f28);
				globalState.f5, v135, globalState.f5, v136 := v3.f31, v135, (v3.f31 - v3.f31) * v3.f31, v136;
				var v137: T1 := new C5(v0[531], v0[531]);
				var v138: map<T1, bool> := map[v137 := v137.f24];
				var v139: map<bool, map<T1, bool>> := map[v0[531] := v138];
				var v140: array<D0> := new D0[3];
				var v141: map<array<D0>, char> := map[v140 := v119];
				var v142 := DC9(v14[461]);
				...
				v145 := if (v12[|v146|]) then v145 else v145;
				var v147 := DC0(v132.f28);
				var v148 := DC2(v147);
				var v149: map<int, bool> := map[v132.f29 := f24];
				var v150 := new C6(if (v0[531]) then v148 else DC2(DC0(if (v132.f29 in v149) then v149[v132.f29] else f24)), v132.f28, v137.f25, v3.f31);
			}
		...
		r0 := v3.fm3(seq(-0x123, i7  => ('w')), f24, |v151|, if (!f25) then v151 else v151[--0x271 := f23], globalState);
...
method Main() {
	...
	var v9: seq<int> := [|v7|];
	for i1 := v4 - |v7| to if (v0) then v9[v4] else v4 {
		var v10 := 'v';
		var v11: map<char, map<int, bool>> := map[v10 := map[-829 := v0]];
		var v13: map<int, bool> := map[v4 := v0];
		var v14: seq<map<int, bool>> := [map v12 : int | v12 in v13 :: (v12 / v4) := (v0)];
		var v16: seq<map<int, bool>> := [if (v10 in v11) then v11[v10] else v14[|v9|], map v15 : int | (0x385 <= v15) && (v15 < 437) :: (v15 - -|{v0, v0}|) := (v0)];
		var v17: set<bool> := {!v0};
	...
	if (v0) {
		...
		var v21: seq<bool> := [v0];
		globalState.f6 := if (v21[v4] in v20) then v20[v21[v4]] else !v0;
		globalState.f14 := v4;
		...
		if (!((v22 - v22) >= v22)) {
			...
			v23[536], v1, globalState.f5 := v25 - (if ((if (v27 in v28) then v28[v27] else v0) in v26) then v26[if (v27 in v28) then v28[v27] else v0] else v25), v1, |((v32 * v32) + v32)|;
			var v33: array<array<int>> := new array<int>[5];
			v33, globalState.f17 := if (v21[0x7d]) then v33 else v33, v4 - v4;
			var v34 := new C2(v4);
			v33[727] := if (v0) then v27 else v27;
			globalState.f1, globalState.f1, globalState.f0, v33[727] := !v0, v0, v1, v27;
			...
			v42[919] := if (v0) then v45 else v45;
			v42[919] := v45 + (v45 + v45[v40 := v44]);
			var v46: array<C5> := new C5[19];
			var v47: set<array<C5>> := {v46};
			var v48: array<C4> := new C4[17];
			var v49: C4 := new C4(v43.f24, v43.f24, v0);
			v48[574] := v49;
			globalState.f15, v47, v40.f31, v48[574] := (if (v43.f25) then |{v40.f31}| else v40.f31) < v4, v47, v40.f31, v49;
		}
		
		var v50: set<array<bool>> := {v3, v3, v3};
		var v51 := new C0(v50, v4, v4 % v4);
		var v52: map<char, seq<bool>> := map[v7[v51.f31] := [false, v0]];
		...
		var v56: multiset<string> := multiset{seq(0x272, i4  => ('r'))};
		v3, v55, v4 := v3, v55, |(((multiset{seq(0x2b1, i3  => ('k'))})[v7 := v4] + v56) - v56)|;
	...
	var v73: map<int, bool> := map[v66[328] := v0];
	...
	var v76: map<bool, bool> := map[v3[621] := v3[621]];
	var v77: map<map<bool, bool>, int> := map[v76 := |v5|];
	var v78: map<map<map<bool, bool>, int>, bool> := map[v77 := v62.f25];
	var v79 := new C1(true, if (v77 in v78) then v78[v77] else v3[621]);
	var i5 := 0;
	while (v3[621])
		decreases 100 - i5
	{
		...
		i5 := i5 + 1;
		var v80: C0 := new C0(v69, v70.f23, v66[328]);
		var v81: map<int, C0> := map[v70.f23 % |multiset(v74)| := v80];
		v81 := v81[v66[328] / v4 := v80];
		v3[621] := false;
		var v82: multiset<int> := multiset{v70.f23, v80.f31, |v7|};
		var v83: C7 := new C7();
		var v84: map<C7, bool> := map[v83 := v3[621]];
		globalState.f9 := v82 != multiset{v66[328], |v9[if (v80.f31 in v5) then v5[v80.f31] else if (v66[328] in v5) then v5[v66[328]] else v80.f31 := |v84|]|};
		if (v66[328] >= v70.f23) {
			v66[328] := (if (v62.f25) then v4 else v70.f23) - v70.f23;
			var v85 := 'a';
			v85 := v85;
			...
			v88 := v88;
			var v91: multiset<map<int, bool>> := multiset{v73, (map v89 : int | (391 <= v89) && (v89 < 0x1cf) :: (v89 / v66[328]) := (v62.f25)) + (map v90 : int | v90 in v73 :: (v90 / v4) := (true)), v73, v73, v73};
			v91, globalState.f1 := v91, v0;
		} else {
			var v92: C3 := new C3(v62.f25, |(seq(0x120, i6  => (map['s' := v62.f25])))|, v3[621], v62.f24, v80.f31);
			var v93: seq<C3> := [v92, v92];
			v93 := v93 + (v93 + v93);
			var v94: map<C0, multiset<bool>> := map[v80 := v71];
			v62.f24, v94 := v62.f24, (v94 + v94) + v94;
			var v95 := DC43(v92);
			v3[621], globalState.f6, v92, v3 := v62.f25, false, v95.cf74, v3;
	...
	var v102: seq<array<C3>> := [v101[v66[328]]];
	var v103 := DC10(v62.f25, v76);
	var v104: seq<D3> := [DC10(v3[621], v76).(cf17 := v76), v103];
	var v105: seq<T1> := [v62, v62, v62];
	var v106: set<seq<T1>> := {v105};
	v3[621], v66[328], v3[621], globalState.f8, v101 := v70.f23 > |v104|, |(if (v3[621]) then v106 else v106)|, v0, v4, v102 + v101;
	var v107 := 'd';
	var v108: map<bool, char> := map[v3[621] := v107];
	var v109: map<map<bool, char>, bool> := map[v108 := v0];
	v79.m8(!(if (v3[621]) then v62.f25 else !v0), v70.fm2(globalState), v109, false, globalState);
	if (v0) {
		if (v107 !in v7) {
			var v110, v111, v112, v113 := v62.m1(globalState);
			var v114 := new C5(v7 == (fm25(v62.f25, v62.f25, v107, globalState))[v66[328] := 't'], v110);
			var v115: C0 := new C0(v69, v66[328], v70.f23);
			v115 := v115;
			var v116: seq<array<int>> := [v66];
			v66 := v116[v4 * v9[v66[328]]];
			var v117: seq<seq<T1>> := [v105];
			var v118: multiset<int> := multiset{v111.f23, v115.f31};
			var v119: map<int, seq<T1>> := map[v113 % v4 := v117[|v118|]];
			v119 := v119[v4 := v105[v111.f23 := v62]];
		} else {
			v7 := (v7 + v7) + v7;
			v3[621] := v62.f25;
			var v120: C0 := new C0(v69, v70.f23, v70.f23);
			globalState.f8, v120 := (v70.f23 / v70.f23) / v70.f23, v120;
			var v121: set<bool> := {!v62.f24, if (v62.f24) then v3[621] else !!!v3[621]};
			v121 := v121;
			var v122: multiset<string> := multiset{v7, "guaqmlf"};
			v0 := !((v66[328] + |v7|) == (if (v7 in v122) then v122[v7] else v66[328]));
		}
		...
		globalState.f5 := -v66[328] % |v7|;
		var v125: array<array<bool>> := new array<bool>[21];
		v125[511] := v3;
		var v126: seq<array<bool>> := [v3];
		v125[511] := if (true) then if (v0) then v3 else v3 else v126[v70.f23];
		var v127: C7 := new C7();
		var v128: seq<C7> := [v127];
		v127 := v128[v66[328]];
		var v129: map<bool, set<array<bool>>> := map[v3[621] := v69];
		...
		globalState.f8, v3[621], globalState.f9 := (v70.f23 % v130.f31) + v70.f23, v3[621], (v131 + [v66]) <= v131;
	}
