...
function fm12(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<int, char> {
	map[-|map[true := |map[|multiset{[|[false, false]|]}| := -|(seq(-0x3e0, i0  => (0x3ca)))|]|]| / 782 := DC6('u').cf10]
}
...
function fm16(p0: int, p1: int, p2: int, globalState: GlobalState): seq<set<bool>> {
	([{false}, {false, true, false, true, false}] + [{true}, {!!false}, {false}]) + DC84(seq(0x81, i0  => ({true, true}))).cf145
}
...
function fm21(globalState: GlobalState): D1 {
	match DC4(false, !true, |"jee"|) {
		case DC3(cf5) => DC2(seq(126, i0  => (|cf5|)))
...
function fm26(p0: char, globalState: GlobalState): char {
	match if (true) then DC25(map[|"alriycn"| := 463]) else DC25(map[|(seq(896, i0  => ('d')))| := 0x1e6]) {
		case DC25(cf45) => 'c'
	}
}
...
function fm33(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): int {
	match DC18('p', |{-0x212}|, |multiset{false}|) {
		...
		case DC19(cf37, cf38) => |[map v0 : int | (-0x32f <= v0) && (v0 < 0x2ad) :: (v0 % 371) := (DC11(|"fv"|, {|map[847 := cf38]|}, cf37).cf18)]| / 0x26a
...
function fm35(p0: bool, globalState: GlobalState): D3 {
	match DC34(map v0 : seq<D4> | v0 in map[seq(0x119, i0  => (DC11(-0x1ad, {0x2b6, 0x35b}, true))) := 'q'] :: (v0) := (-0x26e)) {
...
function fm37(globalState: GlobalState): seq<int> {
	(if (false) then seq(0x3cc, i0  => (0x3a1)) else [342, 642]) + [0xd0]
}
...
function fm39(p0: bool, p1: int, p2: bool, globalState: GlobalState): map<int, int> {
	map[|[true, false, true, !true, true]| % |map[0x14f := !true]| := if (false) then -|{-0x397}| else 247]
}
function fm40(p0: seq<int>, p1: D5, p2: int, globalState: GlobalState): seq<map<int, int>> {
	[map[0xbc := -0x380], map[0x37e := 0x1ff]] + ((seq(0x2ba, i0  => (map v0 : int | v0 in map[|multiset{631}| := |(seq(575, i1  => ('v')))|] :: (v0 * |map[true := !true]|) := (0x2b8)))) + [map[0x24b := |"cldmyuqk"|], map[|[false]| := 0xb3]])
}
...
function fm44(p0: bool, globalState: GlobalState): map<int, bool> {
	(map v0 : int | v0 in multiset{DC44(0x165, [false], 't', true, 983).cf84} :: (v0 + -17) := (!true)) + DC87(map[|DC38(false, seq(0x14b, i0  => ('x')), true, !true, DC6('i')).cf70| := true]).cf149
}
function fm45(p0: bool, p1: int, p2: bool, globalState: GlobalState): string {
	("m" + "wgb") + ("lkwgqmac" + (seq(0x36e, i0  => ('d'))))
}
...
function fm47(p0: bool, globalState: GlobalState): seq<string> {
	if (!true) then ["bvpnsv", "f"] else [seq(0x1a4, i0  => ('p')), "ch"]
}
...
function fm49(p0: bool, globalState: GlobalState): D6 {
	DC17(true, multiset([|(map v0 : string | v0 in map[seq(0x336, i0  => ('d')) := |(map v1 : seq<char> | v1 in [['r']] :: (v1) := (false))|] :: (v0) := (-0x2e4))|]) >= multiset{-0x2db}, 330, 3 * 0x11d, -0x155 / |"sn"|)
}
...
function fm51(globalState: GlobalState): D14 {
	if ((seq(106, i0  => (-0xb5))) <= [|[|multiset{DC6('d').cf10}|]|, |[|multiset(seq(0x204, i1  => ('u')))|]|]) then DC34(map[seq(-0x82, i2  => (DC11(-0x22c, {253}, true))) := |(seq(0x5, i3  => ('e')))|]) else DC34(map[[DC11(0x27c, set v0 : int | (0x2c8 <= v0) && (v0 < 679) :: (v0 - |"iqsvf"|), true)] := |{|[false, true, true, !true]|}|])
}
function fm52(p0: bool, globalState: GlobalState): D8 {
	if (!(|(map v0 : int | v0 in (map v1 : int | v1 in (map v2 : int | (0x1a3 <= v2) && (v2 < 0x243) :: (v2 / |"sfqi"|) := (0x3cb)) :: (v1 % |(seq(0x2b1, i0  => ('f')))|) := (true)) :: (v0 % |multiset{!false}|) := (-0x14e))| < |[true]|)) then DC23([true]) else DC23([!!true])
}
function fm53(p0: int, globalState: GlobalState): map<bool, D4> {
	map[if (!!false) then !true else false := if (false) then DC11(0x35b, set v0 : int | (845 <= v0) && (v0 < 0x26f) :: (v0 / -0x2d2), false) else DC11(|{!false, true, !!!false}|, set v1 : int | (-0x1d9 <= v1) && (v1 < 423) :: (v1 + 0x1d6), !true)]
}
function fm54(globalState: GlobalState): set<char> {
	set v0 : char | v0 in multiset(seq(0x2ec, i0  => ('e'))) :: (v0)
}
...
function fm56(p0: bool, globalState: GlobalState): seq<D14> {
	((seq(-0x57, i0  => (DC36(false, "mpbldi", "dccddbi")))) + [DC36(false, seq(108, i1  => ('i')), "xdxoru"), DC36(true, "igbltr", seq(0x3d6, i2  => ('n')))]) + [DC36(!!true, "d", "kwqsarg")]
}
...
function fm61(p0: map<int, int>, globalState: GlobalState): D31 {
	match DC85('p') {
		...
		case DC86(cf147, cf148) => if (cf147) then DC77(multiset([cf148, |(seq(0xd6, i0  => ("ey")))|])) else DC77(multiset{cf148, cf148})
...
class C0 {
	...
	function fm5(p0: bool, p1: int, p2: int, p3: multiset<bool>, globalState: GlobalState): bool {
		(-952 - 834) >= (|map[false := "aiohhcmxm"]| / -0x1ba)
	}
}
...
class C1 extends T0 {
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		...
		v2 := v2[fm33(f12, f12, v1, true, globalState) * v0[609] := f12 <==> !f12];
		var v3 := 'm';
		if (fm32(v0[609], v3, globalState)) {
			r0 := "tsoaubs";
			var v4 := new C0();
			if (v0[609] != v0[609]) {
				globalState.f8 := !f12;
				var v5: array<bool> := new bool[27];
				v5[180] := if (v0[609] in v2) then v2[v0[609]] else false;
				var v6: multiset<seq<bool>> := multiset{[f12]};
				v5[180] := v6 > v6;
				v0 := new int[23];
				globalState.f8 := v5[180];
				...
				v1 := fm33(f12, !v8.fm5(f12, v1, v0[609], v9, globalState), v1 % v1, f12, globalState);
				var v10: map<char, string> := map[v3 := f13];
				var v11: map<int, int> := map[v0[609] := v1];
				v10, v1, globalState.f8 := v10 + v10[f13[|v11|] := f13], v1 + v1, f12;
				var v12: array<bool> := new bool[5](i0 => f12);
				var v13: multiset<array<bool>> := multiset{v12};
				v13 := (v13 + v13) * v13;
			}
			
			var v14: multiset<int> := multiset{0x16f, fm33(f12, f12, v0[609], f12, globalState)};
			var v15: array<string> := new string[14];
			v15[272] := f13 + "ejfjtu";
			v14, v1, v15[272] := (v14 * multiset{v1, v1}) * v14, v0[609], if (true) then f13 else if (f12) then f13 else f13;
			r1 := false;
		} else {
			var v16 := DC7(v0);
			v16 := if (f12 ==> f12) then if (f12) then DC7(v0) else v16 else v16;
			var v17: set<int> := {v1, fm33(f12, f12, v0[609], f12, globalState)};
			var v18: map<bool, int> := map[v17 !! v17 := v1 - v0[609]];
			v18 := v18[f12 := v0[609]];
			v0[609] := -v1;
			...
			v20 := new array<int>[28] [v16.cf11, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, if (v19[193]) then v0 else v0, v0, v0, v0, if (v19[193]) then v0 else v0, v0, if (v19[193]) then v0 else v0, v0, v0, v0, v0, v0, v0, DC7(v0).cf11];
		}
		
		v0[609] := v1;
		v0[609] := v1;
		r0 := (f13 + (f13 + f13))[-935 := v3];
		r1 := if (f12) then f12 else f12;
		var v21: set<bool> := {fm32(v1, v3, globalState), f12, false};
		var v22: seq<set<bool>> := [v21];
		var v23: map<array<int>, int> := map[v0 := v0[609]];
		r2 := [v21, v22[v1]] + [v21, v21, fm34(|v23|, f12, f12, f12, globalState), {false}];
		r3 := f13 + f13;
	}
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		var v0 := 0x308;
		...
		var v5: map<int, int> := map[|(seq(620, i0  => (0x2a2)))| := 0x36];
		...
		match (v9) {
			...
			case DC4(cf6, cf7, cf8) =>
				...
				if (cf6 || (v8 >= multiset(v17))) {
					...
					v21[222] := v6;
					globalState.f8 := cf6;
					var v22: seq<int> := [cf8, fm33(cf6, f12, cf8, f12, globalState) - cf8, |v20| % v0];
			...
			case DC2(cf4) =>
				...
				if (f12) {
					...
					var v26: array<seq<bool>> := new seq<bool>[18] [v23 + v23, fm38(if (f12 in v24) then v24[f12] else f12, globalState), v23, v23 + v25[v0], if (f12) then v23 else v23, v23, [f12, !f12], v23, v23 + v23, v23 + v23, v23 + v23, v23, fm38(f12, globalState), v23, v23 + v23, v23, [f12, !v6.fm5(f12, v0, v0, v8, globalState), f12], v23];
					v26[226] := v23[-v0 := f12];
					v26[226] := (v23 + v23)[v0 := f12];
					globalState.f8 := v26[226][v0];
					globalState.f8 := f12;
					var v27 := new C0();
					v0 := v0;
				} else {
					...
					var v33 := DC16(v32);
					var v34: map<bool, int> := map[v31[|v33.cf28|] := -724];
					v34 := v34[!f12 := v0];
			...
			case DC5(cf9) =>
				...
				v37 := v37 - v37;
				if (v0 != v0) {
					v1 := v1 + (map v38 : int | v38 in v37 :: (v38 % |f13|) := (f12))[v0 := f12];
					...
					globalState.f8, v0 := f12, |v36| * (v0 % |v40|);
					var v41 := "rax";
					v41 := f13;
					v1 := v1[v0 := true];
				} else {
					...
					var v46: set<int> := {-0x2aa % fm33(f12, f12, |v45|, DC4(f12, f12, v0).cf6, globalState)};
		...
		if (f12) {
			if ((|"xplooehy"| / v0) < v0) {
				...
				var v52: map<map<int, bool>, int> := map[(v51[|f13|])[-24 := f12] := v0];
				v0 := |v52[v1 := if (f12) then v0 else -0x10e]|;
				globalState.f8 := v6.fm5(f12, -v0, v0 / v0, v8, globalState);
				var v53 := new C0();
				...
				v57, r1, v58[319] := v57, f12, if (v60 in v61) then v61[v60] else v0;
				var v62: set<array<int>> := {v58, v58};
				var v63 := DC24(f12, v62, -247 * v58[319]);
				v63 := v63;
				var v65: multiset<int> := multiset{|"igpmkqt"|, v58[319]};
				var v66: seq<map<int, int>> := [fm39(f12, -v58[319], true, globalState), map v64 : int | v64 in v65 :: (v64 * v58[319]) := (v58[319]), v5, map[v58[319] := 0x5a]];
				v57[478] := false || true;
				var v67: seq<int> := [v0];
				var v68 := DC14(v58[319], f12);
				var v69: set<bool> := {f12, f12};
				var v70: seq<bool> := [v49.fm5(f12, v58[319], |v69|, v8, globalState)];
				var v71: seq<seq<bool>> := [v70];
				v0, v66, v57[478] := v58[319], fm40(v67, v68, |f13|, globalState), (v70 + v70) <= v71[-736];
				v58[319] := 0x87 / v0;
				var v72 := new C0();
			}
...
class C2 extends T1 {
	...
	function fm0(p0: seq<bool>, p1: bool, p2: int, p3: bool, globalState: GlobalState): bool {
		|DC25(map v0 : int | v0 in map[|"dnq"| := f9] :: (v0 * 0x2b0) := (DC1(|{f14, f10}|, f14, -|map[false := |(seq(0x121, i0  => ('m')))|]|).cf3)).cf45| != 0x12d
	}
	function fm1(p0: map<bool, bool>, globalState: GlobalState): int {
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		...
		var v1: seq<bool> := [f14];
		var v2 := 0x2b1;
		var v3: map<bool, int> := map[v0 !! multiset(v1[fm42(v2, v2, v2, globalState) := f10]) := v2];
		...
		v5[353] := 'd';
		f15[59] := fm0(v1, f10, |(seq(-427, i1  => (v2)))|, f14, globalState);
		var v7: seq<int> := [v2];
		var v8 := DC17(f14, f10, -0x9b, ---|(map v6 : int | v6 in v7 :: (v6 / v2) := (f14))|, fm1(f9, globalState));
		var v9 := DC13(f15);
		v2, v5[353], v3, f15[59], v2 := v8.cf33, fm43(|[v9]| - 170, globalState), v3, f10 ==> f10, v2;
		var i2 := 0;
		while (!f15[59])
			decreases 100 - i2
		{
		...
		var v10: map<int, bool> := map[v2 := f15[59]];
		v10 := fm44(false, globalState);
		if (f15[59]) {
			var v11 := "wem";
			var v12: seq<string> := [v11];
			var v13 := new C1(f15[59], v12[|v11|]);
			var v14: array<array<string>> := new array<string>[17];
			var v15: map<bool, seq<bool>> := map[f10 := v1];
			var v16: array<string> := new string[22] [v13.f13, v11, fm45(!f14, v2, v13.f12, globalState), v11, fm45(v1[v2], v2, f14, globalState), v13.f13, v11, v11, ("cmnxwuk")[v2 := v5[353]], v11, seq(0x1e6, i3  => (v5[353])), v13.f13, v13.f13, v13.f13[|v15| := v5[353]], v13.f13, seq(202, i4  => (v5[353])), seq(0x1f, i5  => (v5[353])), v11, ((v11[|v13.f13| := 'o'])[v2 := v5[353]])[v2 := v5[353]], v11, v13.f13, seq(591, i6  => ('u'))];
			v14[918] := v16;
			v14[918] := v16;
			globalState.f8 := fm0(v1[|v1| := f14], v13.f12, v2, v1 == v1, globalState);
			var v17 := new C1(!f14, v13.f13);
			var v18 := DC18(v5[353], v2, v2 + v2);
			v18, f14 := v18, DC18(v17.f13[|v7|], v2, v2) !in {v18};
		} else {
			match (DC5(DC3("n"))) {
				case DC3(cf5) =>
					globalState.f8, f14, v2 := f10, f15[59], v2;
					var v19 := new C1(f14, cf5[v2 := v5[353]]);
					var v20: set<int> := {v2, v2};
					f15[59], f15[59] := f14, v20 < v20;
					var v21: array<bool> := new bool[23] [f14, f10, v19.f12, v19.f12, f15[59], v19.f12, v19.fm32(v2, 'i', globalState), true, f15[59], false, f14, !v19.f12, !f10, !true, f14, f15[59], f15[59], v19.f12, f14, f15[59], v19.f12, f15[59], f10];
					var v22: map<bool, array<bool>> := map[!v19.f12 := v21];
					v22 := (if (f15[59]) then v22 else v22) + DC26(v22).cf46;
				case DC4(cf6, cf7, cf8) =>
					var v23 := DC11(fm1(f9, globalState), {cf8, v2}, cf7);
					cf8 := v2 * v23.cf16;
					cf8, globalState.f8 := -0x23b, cf7;
					var v24: map<int, int> := map[v2 := |{cf8, cf8}| % cf8];
					v24 := v24[fm42(v2, --380, v2, globalState) := cf8 % cf8];
					var v25: array<int> := new int[7];
					v25[405] := cf8;
					v25[405] := fm1((map[fm0(v1, !cf6, v2, cf7, globalState) := f14])[true := cf6], globalState);
				case DC2(cf4) =>
					globalState.f8 := v2 >= v2;
					var v26 := new C0();
					var v27: array<int> := new int[8](i7 => i7 / -v2);
					var v28: map<int, int> := map[fm1(f9, globalState) := -0xbe];
					var v29 := "rnvidwis";
					var v30: map<string, int> := map[v29 := v2];
					v27[935] := (if (|v29| in v28) then v28[|v29|] else v2) - (if (v29 in v30) then v30[v29] else v2);
					v27[935] := v2;
					var v31: map<bool, bool> := map[v2 != v2 := f15[59]];
					v31 := v31[f15[59] := f15[59]];
				case DC5(cf9) =>
					v0 := v0 - v0;
					var v32 := DC0(f14);
					...
					var v36: seq<D8> := [v35];
					var v37: multiset<seq<D8>> := multiset{v36 + v36[949 := v35]};
					v37 := v37 * v37;
					var v38, v39, v40 := m7(0x1ff, v2, globalState);
			}
			
			var v41: array<array<bool>> := new array<bool>[15];
			var v42: array<bool> := new bool[6](i8 => f15[59]);
			v41[651] := v42;
			var v43 := "lueejueq";
			var v44: array<string> := new string[8] [(fm45(f14, |v0|, f15[59], globalState))[-v2 := v5[353]], seq(690, i9  => (v5[353])), v43, v43 + v43, (seq(0x248, i10  => (v5[353]))) + v43, v43, "cafhh", "wgxv" + v43];
			v44[86] := v43;
			v41[651], v44[86], f15[59], v2 := if (f15[59]) then v42 else v42, "j" + fm45(fm0(v1, f14, v2, false, globalState), v2, f14, globalState), f10, -|v43| + (v2 + v2);
			if (if (v2 in v10) then v10[v2] else v2 == v2) {
				...
				v47[636] := DC4(!f15[59], f14, v2);
				var v48: seq<array<bool>> := [v42, v41[651]];
				var v49 := DC4(f15[59], f15[59] <==> (if (f15[59] in f9) then f9[f15[59]] else false), v2);
				v2, v41[651], v46[108], v47[636], v2 := fm1(f9, globalState), v48[|{v5[353], v5[353], 'r'}|], v2, v49, |v1|;
				v2 := |v1| / (-fm42(v46[108], |map[-|v44[86]| := v46[108]]|, -0x1ae, globalState) + v2);
				var v50, v51, v52 := m7(|"ou"| / |v44[86]|, v2, globalState);
			} else {
				var v53: set<char> := {v5[353]};
				var v54: map<int, int> := map[v2 := v2];
				var v55 := DC4(fm0([f15[59]], f10, 0x1bd, f10, globalState), f14, v2);
				var v56 := DC14(v2, f14);
				var v57: array<int> := new int[12] [v2, |v7|, v2 * v2, v2, |v54| % v2, -(if (f14) then v2 else v2), v2, v2, v55.cf8, v2, v56.cf25, |(seq(0x16c, i12  => (v5[353])))|];
				v57[698] := v2;
				var v58: map<map<bool, bool>, bool> := map[f9 := f15[59]];
				var v59: map<int, map<map<bool, bool>, bool>> := map[|multiset{f15[59]}| := v58];
				var v61: multiset<map<bool, bool>> := multiset{f9};
				v2, v53, v2, v57[698] := -v2 % (|(if (v2 in v59) then v59[v2] else map v60 : map<bool, bool> | v60 in v61 :: (v60) := (f15[59]))| / v2), (v53 - v53) + ({v5[353]} - (set v62 : char | v62 in v43 :: (v62))), v2, -|v0|;
				r0 := seq(67, i13  => (v5[353]));
				var v63 := DC24(!f15[59], {v57}, v57[698]);
				var v64: seq<D8> := [v63, v63, v63];
				var v65: set<array<int>> := {v57};
				var v66: map<int, seq<D8>> := map[v57[698] := v64];
				var v67: array<seq<D8>> := new seq<D8>[21] [v64, v64 + [v63], v64, v64, v64, v64, [v63, v63, v63, DC24(f14, v65, v57[698]), v63], [v63, v63], if (true) then v64 else v64, v64, if (f15[59]) then [v63, v63, v63] else v64, v64[v57[698] := v63], v64, v64, v64, [v63, v63, v63], v64 + [v63, v63], v64, v64, if (v2 in v66) then v66[v2] else v64, v64];
				v67[663] := v64;
				var v68: map<multiset<bool>, seq<D8>> := map[v0 := [v63]];
				v67[663] := if (v0[(v55.(cf6 := fm0(v1, f10, |v4|, f14, globalState), cf7 := f10)).cf6 := fm1(f9, globalState)] in v68) then v68[v0[(v55.(cf6 := fm0(v1, f10, |v4|, f14, globalState), cf7 := f10)).cf6 := fm1(f9, globalState)]] else v64;
			...
			f15[59], v2 := f10, 0xb0 - |f9|;
			v2 := -((v2 / v2) - (if (f15[59]) then v2 else v2));
		}
	...
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		...
		if (f14 && (f14 <== f14)) {
			...
			f15[575], v1, globalState.f8, v0 := true, v1, f10, fm42(v0, -v0 + v0, |v2|, globalState);
			v0 := v0 - v0;
			var v3 := "ll";
			var v4: array<int> := new int[6](i0 => i0 * v0);
			v4[727] := -v0;
			v0, f14, globalState.f8, v3, v4[727] := v0, f14, f10, v3, (v0 * 0x348) * (v0 % v0);
			v4[727] := v4[727] - v0;
			var v5 := new C0();
		} else {
			var v6: array<int> := new int[26](i1 => i1 / DC14(v0, f10).cf25);
			v6 := v6;
			var v7: seq<int> := [v0, v0, 0x35a];
			var v8: map<bool, int> := map[f14 := v0 / |v7|];
			...
			v9[193][282] := v0;
			v0, v15, v9[193][282], v9[193] := -(v0 * v0) * v0, v15, 0xc3 * v0, v10.cf11;
			globalState.f8 := v0 < (if (f10) then v9[193][282] else |fm46(f10, f10, f10, globalState)|);
		}
		...
		r0 := v24[v22 := v23];
		var v25 := DC3(seq(0x272, i4  => (p0)));
		r1 := (seq(322, i3  => (p0))) <= v25.cf5;
	}
	method m7(p0: int, p1: int, globalState: GlobalState) returns (r0: bool, r1: map<bool, int>, r2: D7) {
		...
		forall i1 | 0 <= i1 < v9.Length {
			v9[i1] := (|(set v10 : int | v10 in {p1} :: (v10 - |map[!!!true := ----|(seq(0x144, i2  => (|multiset{|map[false := true]|}|)))|]|))| == p0) ==> f10;
		}
		r0 := f14;
		r1 := v6;
		var v11 := DC22();
...
class C3 extends T0 {
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		...
		v3, globalState.f8, v4, v1[968] := |(v9 - multiset{true})|, v0, v5[v3], v3 - v3;
		var v10: array<bool> := new bool[10](i0 => v0);
		v10[470] := v0;
		var v11: multiset<int> := multiset{v1[968], v1[968]};
		var v12: seq<multiset<int>> := [multiset{|v5|, v3}, v11];
		v10[470] := v3 !in v12[v3];
		for i1 := v1[968] - |(set v13 : int | (-59 <= v13) && (v13 < 0x369) :: (v13 * -v1[968]))| to v3 + v3 {
			...
			if (v14.cf7) {
				...
				v16, v0, v3, v5 := v16, v0, -(v1[968] + v1[968]), v5 + v5;
				var v17 := new C0();
				v10[470] := fm27(i1 <= v1[968], false, v8, globalState);
			} else {
				...
				var v22: set<int> := {i1};
				var v23: set<bool> := {v10[470], v10[470]};
				var v24: seq<bool> := [true, false];
				var v25: seq<bool> := [v24[i1]];
				var v26: array<map<bool, multiset<char>>> := new map<bool, multiset<char>>[19] [v21 + v21, v21, v21, v21 + v21, v21, v21, v21, v21, map[v0 := v20], fm29(v0, true, fm30(globalState), v22, globalState), fm29(v0, v0, v23, v22, globalState), v21[v0 := v20], if (v10[470]) then map[!v25[i1] := v20] else map[v0 := v20], fm29(v10[470], v0, v23, v22, globalState) + v21, v21 + map[v10[470] := v20], v21, DC10(map[v0 := v20]).cf15, v21, v21];
				v26[489] := map[true := multiset{v4}];
				v26[489] := v21;
				v4 := v4;
			}
			...
			var v27 := new C0();
			var v28 := new C0();
			var v29: seq<bool> := [v10[470]];
			var v30: map<int, seq<bool>> := map[-0x100 := v29];
			v30 := v30[|v11| := v29];
		}
		for i3 := -|(seq(0x346, i4  => (v4)))| to v1[968] {
			v9 := v9;
			v10[470] := v10[470];
			globalState.f8 := -i3 >= v1[968];
			var v31: set<int> := {v3, i3};
			var v32 := DC12(|(seq(-0x1c2, i5  => (v4)))| !in v31, 303 / i3, v4, v3, 0x2f2);
			var v33: map<string, bool> := map[seq(0x152, i6  => (v4)) := false];
			var v34 := DC4(v0, v0, -|v33|);
			v32, v1[968], v1[968], v1[968] := v32, i3 * fm28(v10[470], v34, v3, -0x6c, globalState), 261 / (fm28(v0, v34, v1[968], i3, globalState) - i3), v3;
		}
		r0 := (v5 + v5)[v1[968] := v4];
		r1 := v0;
		var v35: set<bool> := {false, v10[470]};
		r2 := [v35];
		r3 := v5 + "letpy";
	}
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		...
		if (match v4 {
			...
			var v7 := new C0();
			var v8: seq<bool> := [v1];
			if (v8[v2] || (if (v6[306]) then v1 else v6[306])) {
				v6[306] := !v1;
				var v9 := "ewyay";
				v9 := v9 + (v9 + (seq(-365, i1  => (p0))));
				var v10: map<array<bool>, bool> := map[v6 := v1];
				var v11 := DC13(v6);
				v10 := v10[v11.cf24 := v6[306]];
				var v12: multiset<bool> := multiset{false, v1, true, v6[306], -v2 == v2};
				v12 := multiset(v8 + v8) * v12;
				var v13: map<int, C0> := map[v2 := v0];
				var v14: map<int, int> := map[v2 := |v13|];
				var v15 := DC14(v2, v6[306]);
				var v16: map<map<bool, set<C0>>, map<int, int>> := map[map[v6[306] := {v7, v0}] := map[v15.cf25 := v2]];
				var v17: set<C0> := {v0};
				var v18: map<bool, set<C0>> := map[v6[306] := v17];
				var v19 := DC4(v1, v6[306], v2);
				var v20: multiset<int> := multiset{v2, v2};
				var v21: array<map<int, int>> := new map<int, int>[13] [v14, if (v18 in v16) then v16[v18] else v14, v14, (v14[v2 := v2])[v2 := v2], v14, v14, v14[fm28(v6[306], v19, |v20|, v2, globalState) := v2], map[v2 := v2], v14 + map[0x88 := 457], v14, v14, v14, v14];
				v21 := v21;
			} else {
				var v22 := "nhxyjlt";
				v6[306] := (|v22| % v2) < |{v2}|;
				...
				v22 := v22 + v23[-v2];
				var v24: set<string> := {seq(0x2e3, i2  => (p0))};
				...
				var v29: map<bool, bool> := map[v6[306] := !v1];
				var v30: seq<int> := [v2];
				var v31: array<int> := new int[24] [--v2 / v2, v2 / v2, 0x2c1, v2, 0x22f, v2, v2, v2 - v2, |v24|, v2, |(v25 + v25)|, if (|v28| in v27) then v27[|v28|] else v2, v2, -v2 * v2, 0x30b, |v8|, -(|v29| + v30[v2]), |"qryuduwux"|, v2, -|v30|, v2, v2, v2, |"loerye"| % v2];
				var v32: seq<array<int>> := [v31, v31, v31];
				v31 := v32[v2 - v2];
				v31[212] := v2;
				var v33: set<bool> := {v6[306], false};
				var v34: map<int, set<bool>> := map[v2 := v33];
				v22, v31[212], v6[306], v34, v2 := v22, v2 * (if (v1) then v2 else 0x361), !v6[306], v34, v2;
				var v35: map<char, int> := map[p0 := v2];
				v31[212] := if (fm31(!true, v3, globalState) in v35) then v35[fm31(!true, v3, globalState)] else 0x6f;
			}
			...
			globalState.f8 := v1;
			globalState.f8 := v1;
			var v37: T0 := new C1(v1, seq(0xad, i3  => ('f')));
		...
		r1 := v44[v2];
		var v45: array<int> := new int[12](i6 => i6 % -|map[v2 := |v44|]|);
...
class C4 extends T1 {
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		...
		var v2: seq<bool> := [f10];
		var v3 := 0x1e;
		var v4: array<D1> := new D1[19] [v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1.(cf5 := fm22(|(seq(0x24c, i0  => ('a')))|, f10, fm0(v2, false, |(seq(-0x2e0, i1  => ('g')))|, f10, globalState), v3, globalState)), v1, DC3(v0), v1, v1, v1, v1, DC3(v0), v1];
	...
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v8: map<int, multiset<bool>> := map[v5[5] := v6];
			v7 := v7[v8 + v8 := v1];
			var v10: set<char> := {p0};
			v1 := v5[5] - (fm1(f9, globalState) + |(map v9 : char | v9 in v10 :: (v9) := (|(seq(0xba, i1  => (p0)))|))[p0 := v5[5]]|);
		}
		...
		if (v11[v12] != v13) {
			...
			if ((|v16| != v12) <==> f10) {
				...
				v19[846] := v22;
				v19[846] := map[v20 := fm1(f9, globalState)] + v22;
				...
				v25, v25[728], v12, globalState.f8, v27 := v25, if (f10) then fm0(v26, false, v12, f10, globalState) else f10, v12 % v12, fm24(f10, globalState) !! v28, v27;
				var v29 := new C0();
				var v30 := 'h';
				var v32: map<bool, map<int, int>> := map[v25[728] := map[|fm25(-v12, |v16|, globalState)| := v12] + (map[v12 := v12])[|v16| := |(map v31 : int | v31 in map[v12 := -v12] :: (v31 % v12) := (|map[v12 := v12]|))|]];
				var v33: array<int> := new int[9];
				var v34: map<int, int> := map[323 := v12];
				v30, v32, v33 := v30, map[v25[728] := v34 + v34], v33;
				var v35: map<char, bool> := map[v30 := f10];
				var v36: map<bool, bool> := map[fm0(v26, false, v12, fm0(v26, f10, v12, f10, globalState), globalState) := DC4(f10, if (v30 in v35) then v35[v30] else v25[728], -|"pojq"|).cf7];
				v36 := v36[f10 := true];
				var v37: seq<string> := [v16];
				v25[728] := v37[v12 := seq(-0x1d0, i3  => (v30))] == v37;
			}
			
			var v38: multiset<int> := multiset{-(v12 % 391)};
			v38 := v38 + v38;
		} else {
			var v39: C0 := new C0();
			...
			v42[765] := v44 == v44;
			globalState.f8, v42[765], globalState.f8 := f10, f10, f10;
			v12 := (if (v42[765]) then v12 else v12) / -(0x143 / v12);
			var v45: array<char> := new char[12] [p0, p0, p0, p0, p0, p0, p0, p0, 'c', if (v42[765]) then fm26(p0, globalState) else p0, p0, p0];
			v45 := if (!f10) then v45 else v45;
			var v46: map<bool, string> := map[f10 := "kxm"];
			var v47: seq<string> := [if (v42[765] in v46) then v46[v42[765]] else v43, v43];
			globalState.f8 := p0 !in v47[v12];
		}
	...
	method m5(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (f10) {
				...
				v12[684] := !v0[v11];
				var v13 := "xum";
				v13 := seq(-0x27c, i2  => (DC12(v12[684], 0x165, 'd', -v11, v11).cf21));
				var v14 := new C1((seq(0x318, i3  => ('a'))) == "sixbvx", v13);
				var v15: seq<int> := [v11, v11, v11, 0x171, |{v11}|];
				var v16: seq<seq<int>> := [v15];
				var v17: seq<seq<int>> := [v16[v11]];
				var v18: seq<int> := [|v16[|v14.f13|]| - 650];
				v15 := v18;
			}
			
			var v19 := 0x2e9;
			var v20: set<bool> := {true};
			v19 := if (v20 < v20) then v19 / 0x1aa else v19;
			globalState.f8 := f10;
			...
			v21[103] := v22 <= [if (f10 in v23) then v23[f10] else -128, 0x19b, |v24|, v19];
		}
		var i4 := 0;
		while (f10)
			decreases 100 - i4
		{
			...
			if (f10 <==> !f10) {
				...
				v29 := v29[v28 := v27 % (if (f10 in v30) then v30[f10] else v27)];
				...
				v33, v35, v36, v34, v34 := v33, (v35 + [v34, v34]) + (seq(0x2ee, i6  => (v34))), v36, v34 / v34, v34 / |(v37 * v37)|;
				globalState.f8 := f10;
				...
				var v44: array<int> := new int[25] [v34, v34 * |v33|, v34, v34, |v39[0x213]|, v34, v34, v34, v34 - 915, v34, v34, if (f10) then |v40| else v34, v34 % v34, -v34, if (f10) then --v34 else v34, |v41|, v34 * -334, v34, v34, if (-v34 in v37) then v37[-v34] else v34, v34 * v34, -v34, |(if (f10) then v43 else v43)|, v34, 0xec];
				v44[163] := v34 % v34;
				var v45 := 'u';
				v44[163] := -|v33[0x11c := v45]| - -v34;
				v42[232] := f10;
				v42[232], globalState.f8 := v37 >= fm46(f10, v0[v34], !f10, globalState), f10;
			...
			v49[479] := v51;
			var v52: map<seq<int>, T1> := map[seq(-0x311, i7  => (|"krxj"|)) := v51];
			var v54: set<bool> := {v51.f10};
			var v55: seq<int> := [|(set v53 : int | (0x20d <= v53) && (v53 < 392) :: (v53 * v48))|, |v54|];
			var v56: seq<seq<int>> := [v55];
			v49[479] := if (v56[v47[505]] in v52) then v52[v56[v47[505]]] else v51;
		...
		if (f10) {
			...
			if (v63.cf47 >= multiset{v60}) {
				...
				var v69 := DC30(v67);
				var v70: array<array<D8>> := new array<D8>[26] [v67, v67, v67, v67, v67, v67, v67, v67, v67, v68[v62], if (f10) then v67 else v67, if (false) then v67 else v67, v67, v69.cf54, if (f10) then v67 else v67, v67, v67, v67, v67, v67, v67, v67, if (f10) then v67 else v67, v67, v67, v67];
				v70 := v70;
				globalState.f8 := f10;
				...
				globalState.f8, globalState.f8, v71[722], globalState.f8 := if (v60 in v72) then v72[v60] else f10, !f10, f10, !(|(v74 + map[v62 := v62])| >= v62);
				var v75: multiset<bool> := multiset{v71[722], f10};
				v64[14] := if (fm0(v0, f10, v62, f10, globalState) in v75) then v75[fm0(v0, f10, v62, f10, globalState)] else 819;
				var v76 := 'a';
				var v77: map<array<int>, int> := map[v64 := v62];
				v64[14] := DC18(v76, |v60|, 0x8e).cf36 % |(v77 + v77)|;
			} else {
				...
				var v80: array<seq<bool>> := new seq<bool>[7] [v0, v0 + [f10, v79.f10], v0, v0[--0x1f := !v79.f10], v0 + v0, v0 + v0, v0 + v0];
				v80[812] := v0;
				v80[812], v60, globalState.f8 := v0, v60, if (f10) then false else v79.f10;
				var v81: seq<seq<bool>> := [v80[812]];
				var v82: C1 := new C1(!f10, v60);
				var v83 := 'b';
				globalState.f8, globalState.f8, globalState.f8 := (v0 + v81[|[v82, v82]|]) < (v80[812] + fm38(v82.f12, globalState)), !fm0(v80[812], v79.f10, v62, v79.f10, globalState), v82.fm32(v62, v83, globalState);
			...
			var v103: array<C3> := new C3[15] [v100, v100, v101[v99], v100, v100, v100, v100, if (f10) then v100 else v100, v100, v100, if (f10 in v102) then v102[f10] else v100, v100, v100, v100, v100];
			v103[975] := v100;
			v103[975] := v100;
			var v104 := "smnhcyhf";
	...
	method m6(p0: int, p1: array<int>, p2: int, globalState: GlobalState) returns (r0: seq<int>, r1: int, r2: seq<int>, r3: int) {
		var v0: map<string, int> := map[seq(0x1d3, i0  => ('m')) := -p2 + p0];
		var v1 := "veytmuod";
		v0 := v0["kxkg" + v1[fm1(map[!f10 := f10], globalState) := 'u'] := p2];
		if (!(if (f10) then f10 else f10)) {
			...
			match (v12) {
				case DC17(cf29, cf30, cf31, cf32, cf33) =>
					...
					cf30 := (|v17[p0]| * |v19|) == (v21.(cf23 := p2, cf19 := cf29)).cf20;
				...
				case DC18(cf34, cf35, cf36) =>
					...
					v25 := new set<int>[5];
					globalState.f8 := p0 < (|(seq(0x14b, i3  => (p0)))| - p2);
					v1 := ((fm22(cf35, v9.f12, f10, p0, globalState))[0x3bf := cf34] + v9.f13) + (seq(0x1ad, i4  => (cf34)));
				case DC19(cf37, cf38) =>
					r1 := p2;
					var v26: seq<int> := [p2];
					globalState.f8 := (p0 != v26[|v10|]) || v9.fm32(fm1(f9[cf37 := v9.f12], globalState), cf38, globalState);
					var v27 := new C1(f10, v9.f13[p0 := cf38]);
				...
				case DC16(cf28) =>
					...
					v29[129] := v9.f12;
					p1[262] := p0;
					v29[129], r3, r3, p1[262], globalState.f8 := p2 < p0, --fm1(cf28, globalState), p2, p0, v9.f12;
				case DC20(cf39) =>
		...
		var v62: map<bool, seq<int>> := map[f10 := v60 + ([-p0, if (|v60| in v61) then v61[|v60|] else p2, p2, |"vyqvooyef"|])[v59.fm42(p0, p2, p2, globalState) := p0]];
		r1 := |v62|;
		r2 := fm37(globalState);
		r3 := p2;
	}
...
class C5 extends T1 {
	...
	function fm18(p0: set<bool>, p1: string, globalState: GlobalState): bool {
		-(-0x12a - |map[133 := "n"]|) < -(|map[-447 := f10]| % 0x2ae)
	}
	function fm19(p0: int, p1: int, globalState: GlobalState): int {
		|(if (f10) then map[[DC5(DC2([0x2d5])), DC5(DC4(f10, f10, 0x67))] := map[f10 := DC3("pppcgeiju")]] + map[seq(0x142, i0  => (DC5(DC3("wjqjefffv")))) := map[f10 := DC3("ojakub")]] else map[[DC5(DC3("vlvw"))] := map[f10 := DC3("i")]] + map[[DC5(DC3("oa")), DC5(DC3("lualcqxw"))] := map[f10 := DC3("jlo")]])|
	}
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		var v0 := "avx";
		var v1 := 0x289;
		for i0 := |v0| to v1 % v1 {
			...
			if (f10) {
				...
				v2[880] := v11[v2[880]];
				r0 := v0 + v0;
				globalState.f8 := v4[331];
			}
			
		}
		v1 := v1;
		var v13: array<bool> := new bool[24](i1 => f10 !in [f10, f10, f10]);
		v13[795] := if (f10 in f9) then f9[f10] else true;
		v13[795] := true;
		var v14: set<string> := {v0, v0, v0};
		var v15: map<int, int> := map[|v14| := -|v0|];
		var v16: T1 := new C2(f10, v13, map[f10 := v13[795]], v13[795]);
		...
		var v20: C1 := new C1(v13[795], v0);
		v13[795], v1, v1, v20, globalState.f8 := !v13[795], if (v13[795]) then v1 else v1, -v1, v20, v13[795];
		var i2 := 0;
		while (v20.f12)
			decreases 100 - i2
		{
			...
			if (v20.f12) {
				...
				var v27: seq<int> := [|(seq(0x71, i3  => ('v')))|];
				var v28: set<int> := {|v27|};
				var v29 := DC17(v16.f10, true, v1, v1, |v15|);
				var v30 := DC11(|map[v26 := v1]|, v28, !v29.cf30);
				var v31: seq<D4> := [v30, v30, DC11(|v16.f9|, v28, v13[795])];
				var v32 := DC33(v31);
				v32 := v32;
				...
				var v35 := DC4(v13[795], v16.f10, v1);
				...
				var v44: map<bool, T1> := map[v13[795] := v16];
				var v45: array<int> := new int[23] [v1, v1, v1, -fm19(v1, v1, globalState), v1, v1, v1, v1, v1, v1, |v43[v1]|, -273, v1, |v44|, v1, v1, v1, -0x11b, v1, |v15|, v1, v1, 0x1e5];
		...
		r2 := (v56 + (seq(0x3bc, i4  => (v55)))) + v56[0x1c := {v16.fm0(v57, v16.f10, v1, v13[795], globalState)}];
	...
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		...
		v0 := -|(v5[!true := v0] - multiset{f10})|;
		globalState.f8 := f10;
		var v6: seq<int> := [v0, v0];
		if ((v6 + [v0]) <= (v6 + v6)) {
			v0 := |((v6 + v6) + v6)|;
			var v8 := "edykaowmo";
			var v9: array<int> := new int[15] [v0, v0, v0, v0, v0, |map[v0 := f10]|, v0, -0x239, v0, |(set v7 : int | (0x62 <= v7) && (v7 < 0x393) :: (v7 % |[f10]|))|, v0, |v8|, v0, v0, v0];
		...
		var v18: array<int> := new int[15](i5 => i5 / |"kradmkld"|);
		...
		if (f10) {
			if (f10) {
				...
				var v23: map<bool, int> := map[f10 := v6[0x125]];
				var v24: T1 := new C2(DC4(fm0(v19, true, v0, f10, globalState), !f10, |v6|).cf6, v22, f9, fm0(v19, f10, if (false in v23) then v23[false] else v6[v0], f10, globalState));
				v18[160], v24, v21 := v0 + v0, if (f10 <==> f10) then v24 else v24, (seq(7, i6  => (p0))) + v21;
				v18[160], globalState.f8, v18[160], v21, v21 := v0, f10, v0 / -fm19(|(seq(347, i7  => (|(map v25 : int | v25 in (map v26 : int | (0x24a <= v26) && (v26 < 0x3c2) :: (v26 - v18[160]) := (false)) :: (v25 % v0) := (v24.f10))|)))|, v18[160], globalState), v21, "cxs";
				var v27 := new C3();
				v22[686] := v24.f10 <== v24.f10;
				...
				var v37 := "x";
				v37 := (seq(-0x16, i8  => ('n'))) + v37;
				var v38: array<bool> := new bool[3];
				v38[295] := fm18(v36, v37, globalState);
				v38[295] := f10;
				v38[295] := fm18(v36, v37, globalState) in fm48(f10, globalState);
			}
			...
			var v42 := "ksbootweo";
			v40[946] := fm18(v41, v42, globalState) <==> f10;
			var v43: seq<bool> := [false, f10];
			var v44: multiset<int> := multiset{v0, 55, v0};
			var v45: map<int, char> := map[|multiset{v0, v0}| := p0];
			v40[946] := |v42| <= DC17(fm0(v43, f10, |v44|, f10, globalState), true, |v45|, v0, v0).cf31;
			if (DC1(v0, if (v40[946] in f9) then f9[v40[946]] else v40[946], v0).cf2) {
				globalState.f8 := !v40[946];
				var v46: array<multiset<bool>> := new multiset<bool>[12](i9 => if (v40[946]) then v5 else multiset{v40[946], v40[946]});
				var v47: array<seq<bool>> := new seq<bool>[27](i10 => v43);
				v47[134] := v43 + v43[v0 := v40[946]];
				var v48: array<array<bool>> := new array<bool>[29];
				v48[341] := v40;
				v46, v47[134], v48[341], globalState.f8, v0 := v46, v43, v40, f10 || f10, v0;
				v0 := 345 * v0;
				var v49: set<int> := {v0, v0};
				var v50 := DC11(v0, v49, v40[946]);
				var v51: seq<D4> := [v50, v50, v50];
				var v52 := DC33(v51 + v51);
				v52 := DC33([v50, v50, v50, v50, v50]);
				v39[495][998] := v0 % |v42|;
				v39[495][998] := (|f9| * -|v42|) + v0;
			} else {
				var v53: seq<seq<int>> := [v6[v0 := v0]];
				var v54 := new C2((seq(0x107, i11  => (v0))) in v53, v40, f9 + f9, f10);
				v0, v0, v0, globalState.f8, v54.f14 := --v0, v0, v0, "tm" <= v42, false;
				v18[469] := v0;
				v18[469] := v0;
				var v55: seq<multiset<bool>> := [fm50(-|multiset{v18[469]}|, v18[469], globalState)];
				v55 := v55;
			...
			match (v61) {
				...
				case DC4(cf6, cf7, cf8) =>
					...
					v18 := v79[fm1(f9[false := !(if (false in f9) then f9[false] else true)], globalState)];
					globalState.f8 := cf7;
				case DC2(cf4) =>
					globalState.f8, r1 := f10, f10;
					var v80 := new C0();
					v18[683] := -fm19(v0, -v0, globalState);
					v18[683] := -0x16e;
					var v81 := 'o';
					v81 := v81;
				case DC5(cf9) =>
	...
	method m4(p0: bool, p1: bool, globalState: GlobalState) returns (r0: array<bool>, r1: seq<D0>, r2: set<int>) {
		...
		for i0 := v0 / 146 to v0 {
			var v1 := "itssvdb";
			v1 := "mfa";
			match (DC17(p1, f10, i0, v0, 576 / i0)) {
				case DC17(cf29, cf30, cf31, cf32, cf33) =>
					cf31 := i0 + v0;
					var v2 := 't';
					v2 := v2;
				...
				case DC19(cf37, cf38) =>
					...
					var v23 := DC28(v0, cf37, map[|v18| := v22], f10, v1[i0 := cf38]);
				...
				case DC16(cf28) =>
					...
					v27 := DC21(v28);
					var v29: seq<multiset<int>> := [v26, multiset(seq(-0x237, i2  => (-v0)))];
				...
				case DC20(cf39) =>
					var v34: seq<bool> := [p1];
					globalState.f8 := fm0(v34, v34[|"axewyqwhx"|], v0, f10, globalState) && p0;
					...
					v38[494] := 0x21f % |v37[v0 := i0]|;
					var v39 := DC14(v0, p1);
					var v40: seq<D5> := [v39];
					globalState.f8, globalState.f8, v38[494] := p0, f10, fm33(p0, (seq(868, i3  => (DC14(i0, p0)))) <= v40, (if (f10 in v36) then v36[f10] else v0) * -i0, fm0(v34, p0, i0, f10, globalState), globalState);
					var v41 := 'o';
					v41 := v41;
					var v42: array<seq<char>> := new string[11] [v1, [v41, v41, v41], v1, [v41], v1, v1 + v1, v1, fm20(753, p1, !false, v38[494], globalState), v1, [v41], v1];
					v42[397] := v1;
					v42[397] := v1 + v1;
			}
			...
			if (false) {
				...
				var v46 := DC40(v45);
				v45 := (([v43] + v46.cf76) + (v45 + v45))[-i0 := v43];
				var v47: seq<bool> := [f10, p0, p1];
				globalState.f8 := !fm0(v47, p1 <==> f10, |multiset{-0x1ee}| / v0, p0, globalState);
				...
				v55, v0, v0 := v55, if (v0 >= i0) then v0 / |v57| else if (-v0 in v58) then v58[-v0] else i0, -i0;
		...
		var v75 := 'e';
		var v76: array<int> := new int[27] [v0, |map[-v69.cf25 := |v71|]|, v0, v0, -0x32d, v0, -|(v72 + v72)|, v0, |v73|, |v74|, -v0, v0 * 0xb8, v0, v0, v0, v0, v0 - v0, v72[v0], v0, v0 % v0, 0x336, -(v0 % v0), |v73|, 0x68, v0, v0 - 0x1d0, |map[v75 := ("nbqhra")[v0 := v75]]|];
		v70[655] := v0;
		...
		r1 := v80;
		var v82 := DC11(919, set v81 : int | (0x2e6 <= v81) && (v81 < -453) :: (v81 - v70[655]), true);
...
class C6 extends T1 {
	...
	function fm8(globalState: GlobalState): int {
		match DC4(f10, f10, -0x3cb) {
			...
			case DC2(cf4) => |(seq(0x35e, i0  => (|[multiset{f10, DC1(0x240, f10, |"qfvjs"|).cf2}, multiset([f10])]|)))| + |[f10, true, f10, f10, f10]|
			case DC5(cf9) => -|(seq(753, i1  => ({0x1ce, 0x3})))|
		}
	}
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		if (!(true <== f10)) {
			...
			var v2 := -316;
			v0[333] := v2 * v2;
			var v4: array<set<int>> := new set<int>[19](i1 => (set v3 : int | (0xf9 <= v3) && (v3 < 0x3d) :: (v3 * v0[333])) - {v0[333]});
			v4 := v4;
			...
			var v7 := new C0();
			var v8 := "qbbn";
			var v9: map<int, int> := map[v0[333] := v2];
			var v10: multiset<int> := multiset{v0[333], 0x138};
			...
			if ((if (v13 in v15) then v15[v13] else f9) == f9) {
				...
				var v17: multiset<bool> := multiset{f10, v12[294], v12[294], v12[294], v12[294]};
				v13 := v13 * (if (|v17| in v16) then v16[|v17|] else v13);
				var v18: map<int, bool> := map[v13 := v12[294]];
				var v19: multiset<int> := multiset{v13};
				var v20: set<multiset<int>> := {v19};
				var v22: seq<int> := [v13, v13];
				var v23: array<map<int, bool>> := new map<int, bool>[21] [map[v13 := v12[294]] + v18, v18, fm11(|v20|, v13, false, v13, globalState) + v18, v18 + v18, v18, v18, v18, v18, v18, v18, map v21 : int | (0 <= v21) && (v21 < 0x1bd) :: (v21 * 351) := (v12[294]), fm11(v22[|v16|], 439, v12[294], v13, globalState), v18, v18, v18 + v18, map[v13 := v12[294]], v18, v18, fm11(-251, v13, f10, v13, globalState), v18, v18];
				v23[985] := if (f10) then v18 else v18;
				var v24: map<bool, map<int, bool>> := map[f10 := v18 + v18];
				var v25 := "tnx";
				var v26: set<string> := {v25};
				v13, r1, v23[985], r1 := -0x1d0, v12[294], if (!(v26 <= v26) in v24) then v24[!(v26 <= v26)] else map[v13 := v12[294]], v25 != "xiesenboe";
				var v27 := new C0();
				var v28 := new C0();
				globalState.f8 := v12[294];
			} else {
				...
				var v37: array<map<int, char>> := new map<int, char>[19] [fm12(v12[294], v13, -v13, v12[294], globalState) + v29, v29, v29 + map[v13 := v30], v29, v29 + map[v13 := v30], v29, map v31 : int | (0x7b <= v31) && (v31 < -0x293) :: (v31 + v13) := (v30), v29 + v29, map v32 : int | v32 in (seq(0x210, i4  => (360))) :: (v32 * |multiset{f10}|) := (v30), v29, fm12(!f10, v13, |v33|, f10, globalState) + v29, v29, v29 + map[v13 := v30], v29[v13 := v30] + (if (v13 in v35) then v35[v13] else fm12(true, v13, v13, f10, globalState)), fm12(f10, |v33|, |v36|, f10, globalState), map[v13 := v30], v29, v29, v29];
				v37 := v37;
				v33 := v33;
				...
				v38[758] := 607 - v13;
				globalState.f8 := v12[294];
				var v39: map<int, bool> := map[0x2b8 := v12[294]];
				var v40: map<bool, seq<char>> := map[f10 := fm13(v13, globalState)];
				globalState.f8, v39 := fm9(v38[758], v13, v13, v40, globalState) <== (f10 || v12[294]), if (f10) then v39 else v39;
			}
			
			globalState.f8 := !v12[294] ==> f10;
		}
			...
			decreases 100 - i6
		{
			...
			var v48: seq<int> := [|v47|];
			var v49: map<int, int> := map[v42 := v48[806]];
			...
			var v55: multiset<array<bool>> := multiset{v54[|v48|], if (f10) then v53 else v54[|map[v42 := v49]|], v53, v53, v53};
		...
		v60 := v60[if (f10) then v57 else set v61 : int | v61 in [v42] :: (v61 / |[true, true, false, false]|) := [v58] + v59];
		var v62 := DC1(0x2fd % v42, f10, v42);
		match (v62) {
			case DC1(cf1, cf2, cf3) =>
				var v63: array<int> := new int[4];
				var v64 := DC4(false, cf2, |v41|);
				v63[44] := v64.cf8;
				v42, cf2, v63[44] := cf3, f10, v42;
			...
			case DC0(cf0) =>
				...
				v67[723] := v58 + v58;
				v67[723] := fm15(f10, f10, v42 * |(map v68 : int | (-0xc0 <= v68) && (v68 < 379) :: (v68 + v42) := (cf0))|, 'k', globalState);
				var v69 := new C0();
		...
		r0 := (v41 + (seq(0x16b, i10  => ('d'))))[if (true) then v42 else -v42 := v41[v42]];
		r1 := f10;
	...
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		...
		var v9: array<int> := new int[19] [-961, v1, 0x32a / v1, |(v3 - v3)|, 139, |(v4 + v4)|, -0x357 + v5.cf8, |v6|, v1, |v7|, -393 - v1, v1, -(v1 % v1), 0x365 / v1, v1, v1, v1, |(v6[|v8| := p0] + v6)|, v1];
		...
		for i1 := v1 - v1 to -v1 {
			...
			var v12: array<string> := new string[25] [v6 + (seq(0x36d, i2  => ('x'))), v6, "amb" + v6, v6, "xmfr" + v6[v1 := p0], "bk", (v6 + "bac")[v1 := p0], v6 + v6, v6, v6, v6, v6, v6, v6, v6, if (v9 in v11) then v11[v9] else v6, fm13(0x250, globalState), v6 + v6, v6 + v6, v6 + (seq(0x284, i3  => (v6[|{v1, v1}|]))), v6, v6 + v6, v6 + "om", "lsvc", "ldunu"];
			v12[106] := seq(786, i4  => (p0));
			v9[757] := i1;
			v1, v12[106], r1, v9[757] := v1, v6 + ("gpkthj" + v6)[v1 := 'i'], f10, -0x229 * (i1 * 0x247);
			var v13 := new C0();
		}
		var v14 := 'j';
		v14 := v14;
		var v15 := DC2(v4[v1 := -v1]);
		match (v15) {
			case DC3(cf5) =>
				var v16: map<char, bool> := map['d' := f10];
				var v17: seq<bool> := [f10];
				v4 := if (if (f10 in f9) then f9[f10] else !(if (v14 in v16) then v16[v14] else v17[v1])) then (seq(0x95, i5  => (-v1))) + [|[f10, f10]|] else v4;
				v9[393] := v1;
				v9[393] := --v1;
				v8 := v8;
				...
				v18[158] := true;
				var v19: set<int> := {v1};
				v18[158] := (v19 - v19) >= fm17(true, globalState);
			case DC4(cf6, cf7, cf8) =>
				var v20 := DC5(v2);
				...
				cf7, v21, cf8 := v1 > |(v23 + v23)|, v21, if (cf6) then cf8 else if (v25[v1] in v24) then v24[v25[v1]] else |v7|;
				var v26 := new C0();
				var v27: seq<array<int>> := [v9];
				cf8 := |v27| + v1;
				var v28 := DC6(v14);
				var v29 := DC3(v6[v1 := v28.cf10]);
				match (v29) {
					case DC3(cf5) =>
						var v30 := new C0();
						v28 := DC6(v14);
						...
						v31[138], v9, cf8, v14 := cf6, if (false in v32) then v32[false] else v27[v1], |("fnhqhubuo" + v6)|, fm14(globalState);
						v8 := v8;
					case DC4(cf6, cf7, cf8) =>
						v8 := v8[cf8 % 0x1d8 := cf6];
						var v33: set<int> := {|{v24}|};
						...
						var v45: array<set<int>> := new set<int>[13] [v33, v33, v33, set v34 : int | (0x258 <= v34) && (v34 < -0x27c) :: (v34 % |(map v35 : string | v35 in (map v36 : string | v36 in multiset{v6} :: (v36) := (|v6|)) :: (v35) := (cf6))|), set v37 : int | v37 in v3 :: (v37 * 0x1e5), if (cf7) then v33 else v33, v33, v33, v33, set v38 : int | v38 in v4 :: (v38 / |(map v39 : int | (0x131 <= v39) && (v39 < 0x115) :: (v39 % -|(seq(0x14a, i7  => (809)))|) := (set v40 : int | (0x186 <= v40) && (v40 < 962) :: (v40 - |"h"|)))|), v44[307], v33, fm17(f10, globalState)];
						v45[739] := v33;
						v45[739] := v33;
						var v46: map<int, int> := map[-0x197 := cf8];
						var v47: T1 := new C4(f9, cf6);
						var v48: seq<T1> := [v47];
						var v49: map<bool, multiset<T1>> := map[cf6 := multiset(v48[v1 := v47])];
					...
					case DC5(cf9) =>
						...
						v63[304] := !fm0(DC23([cf6]).cf41, false, v1, cf7, globalState);
						v63[304] := !cf7;
						var v65: map<map<int, bool>, map<int, int>> := map[v8 := map v64 : int | (-0x37c <= v64) && (v64 < 0x3de) :: (v64 / 0x223) := (DC35(v1, cf6, p0).cf62)];
						v1 := |v65|;
						v25 := ([v63[304], f10] + v25) + v25;
				}
			...
			case DC2(cf4) =>
				...
				if (v66[v1]) {
					...
					globalState.f8, v69[88] := v3 < fm10(f10, -v1, v6, v74, globalState), p0;
					...
					v82[941] := [v1];
					v82[941] := cf4[0x24f := v1] + fm37(globalState);
					v14 := v14;
					...
					v86[860] := v87 + v87;
					globalState.f8, v86[860] := if (v1 in v8) then v8[v1] else v6 < v6, fm25(|v6|, v1, globalState);
				}
			...
			case DC5(cf9) =>
				v9[863] := v1;
				var v91: set<string> := {v6, "yp", v6, seq(-425, i12  => (v14)), v6};
				v1, v9[863] := |v91| - v1, v1 + v1;
				if (f10) {
					var v92 := DC23([f10, f10]);
					var v93: array<bool> := new bool[16];
					v93[442] := f10;
					var v94: seq<bool> := [f10, v1 == 91];
					v92, v93[442], globalState.f8, v9[863], globalState.f8 := v92, v1 < (v1 / v1), v1 in (seq(0x3d7, i13  => (v1))), v1, v94[|v6|];
					var v95 := DC35(v1, f10, v14);
					v14 := v95.cf64;
					globalState.f8 := v6 != (v6 + v6);
					var v96: C3 := new C3();
					var v97: map<map<bool, D4>, C3> := map[fm53(v1, globalState) := v96];
					v93[442], globalState.f8, globalState.f8, v9[863], v9[863] := f10 ==> f10, (v9[863] % v1) < v9[863], v97 != v97, v9[863] - 0x1d7, v9[863];
					var v98: map<int, map<bool, bool>> := map[v1 := f9];
					var v99: map<bool, seq<int>> := map[f10 := v4];
					var v100 := new C2(v93[442], v93, map[f10 := v93[442]] + (if (|(if (!v93[442] in v99) then v99[!v93[442]] else v4)| in v98) then v98[|(if (!v93[442] in v99) then v99[!v93[442]] else v4)|] else f9), f10);
				} else {
					var v101 := new C3();
					v9[863] := v9[863] - v9[863];
					v3 := v3 + (v3 + v3);
					var v102: C4 := new C4(f9, v1 > v9[863]);
					v102 := v102;
					v9[863] := v9[863];
				}
				...
				var v106: map<set<array<int>>, bool> := map[v105 := v103[734]];
				v106 := v106[if (v103[734]) then v105 else v105 := !v103[734]];
		}
...
class C7 extends T1 {
	...
	function fm2(globalState: GlobalState): bool {
		(-|f11| / |multiset{|map[false := 73]|, --305, --142}|) <= |[DC0(!!f10).cf0]|
	}
	...
	method m0(globalState: GlobalState) returns (r0: string, r1: bool, r2: seq<set<bool>>, r3: string) {
		...
		for i0 := -(|v1| / -0x5d) to if (f10) then |v2| else -v0 {
			var v3 := "bt";
			...
			var v8: map<seq<int>, bool> := map[seq(0x2d9, i1  => (|multiset([v3, "ywcvn"])|)) := f10];
			v7[414] := |(v8 + v8)|;
			var v9: array<char> := new char[10];
			var v10: seq<bool> := [f10, f10];
			var v11: map<array<char>, seq<bool>> := map[v9 := v10[-v0 := f10]];
			var v12 := 'c';
			var v13: seq<map<array<char>, seq<bool>>> := [v11 + v11[v9 := fm4(v12, globalState)]];
			var v14: seq<seq<int>> := [[i0]];
			globalState.f8, v4, v7[414] := true, v4, |v13[-|v14|]|;
			var v15: seq<int> := [v7[414]];
			var v16 := DC2(v15);
			match (DC5(v16)) {
				case DC3(cf5) =>
					globalState.f8 := v1 <= (v1 + v1);
					globalState.f8 := (-v0 / -v15[v0]) <= v0;
					var v17 := new C0();
					var v18 := new C0();
				case DC4(cf6, cf7, cf8) =>
					v7[414] := v0;
					...
					var v20 := DC3(v3);
					v19[769] := v20.cf5;
					v19[769] := (if (!f10) then v3 else v3) + v3;
					globalState.f8 := cf7;
				...
				case DC2(cf4) =>
					...
					r1, v7[414], globalState.f8, v0 := v10[v0], i0, (|v10| < |v24|) <== f10, v0 * v0;
					var v25 := DC4(fm2(globalState), v1 == v1, i0);
					v25 := if (f10) then v25 else v25;
					v9[812] := v12;
					var v26: map<set<bool>, bool> := map[f11 := f10];
					r0, v0, v7[414], v9[812], v7[414] := fm6(v0, v0, v26, globalState), v7[414] / (-v7[414] * 0x2a6), i0, fm7(v0, globalState), -v7[414];
				case DC5(cf9) =>
					var v27 := DC5(v16);
					v27 := v27;
					...
					var v32: map<multiset<T1>, seq<int>> := map[v31[v30 := |v10|] := v15];
					v0, v28, v7, globalState.f8 := |(v32 + (map[v31 := v15])[multiset{v30, v30} := v15])| + -v7[414], v28 * v28, v7, !v30.f10;
					...
					v33[136] := fm6(v0, i0, if (true in v34) then v34[true] else v35, globalState) + v3;
					...
					var v42 := DC46(v41);
					v33[136], v36[710], v39, r1 := v3, map v40 : char | v40 in v42.cf89 :: (v40) := (i0 + 0x33), v39, f10;
					var v43 := DC6(v12);
					var v44: map<D2, string> := map[if (f10) then v43 else v43 := v33[136]];
					v44 := map[v43 := v33[136]] + v44;
			}
			
			var v45: array<seq<bool>> := new seq<bool>[7](i4 => v10);
			v45[503] := v10;
			v0, v12, v45[503] := v0 % fm33(f10, f10, i0, f10, globalState), 'w', v10 + [fm2(globalState), f10, f10];
			var v46 := new C0();
		}
		var v47: T0 := new C3();
		...
		for i5 := v0 / v0 to |v49| {
			...
			if (f10 <==> f10) {
				...
				v50[216] := -(if (!(f10 <== f10)) then i5 else v50[216]);
				var v51: seq<int> := [v50[216]];
				var v52 := "p";
				v51 := [v0 * |v52|];
				globalState.f8 := f10;
			} else {
			...
			if (f10) {
				r1 := f10;
				var v61: array<int> := new int[9](i6 => i6 * |(seq(-602, i7  => ('i')))|);
				var v62: seq<array<int>> := [v61];
				var v63 := DC32(v61, v62[0x353 := v61]);
				v63 := v63;
				...
				var v71: array<bool> := new bool[20] [f10, f10, i5 <= v0, f10, f10 <== f10, f10, i5 >= (if (true in v64) then v64[true] else v0), f10, f10, f10, !(v65 > v65), v67 < v67, v66 !in (if (i5 in v69) then v69[i5] else v70[-v0]), f10, f10, !true, !f10, f10, true, if (false) then f10 else f10];
				v71[298] := f10;
				var v72 := DC31(f10, v68, seq(0x11f, i8  => (v66)));
				var v73: T1 := new C2(true, v71, f9, (v72.(cf56 := ("cguqrqn")[v0 := v66], cf57 := v68)).cf55);
				var v74 := DC41(v73.f10, 0x233, f10);
				var v75: seq<int> := [0x240, v74.cf78];
				var v76: seq<multiset<seq<int>>> := [multiset([v75, seq(0xc2, i9  => (|"i"|))])];
				var v77: multiset<seq<int>> := multiset{v75, v75};
				v71[298], v73 := v76[if (i5 in v65) then v65[i5] else v0] > v77, v73;
				var v78: C2 := new C2(v71[298], v71, v73.f9, v71[298]);
				...
				v82[176] := f10;
				v82[176] := f10 || f10;
				v0, v82, globalState.f8, v82 := i5, v82, v82[176], v82;
				v0 := |fm54(globalState)|;
			}
			
			var v83 := 'f';
			var v84: seq<int> := [fm1(map[f10 := f10], globalState)];
			var v85: array<int> := new int[4] [v84[v0], i5, v0, v0];
			var v86: map<array<int>, bool> := map[v85 := f10];
			var v87: seq<map<array<int>, bool>> := [v86];
			var v88: map<char, map<array<int>, bool>> := map[v83 := v87[v0]];
			var v89: map<bool, array<int>> := map[f10 := v85];
			var v90: seq<bool> := [!f10, f10, !f10, true, f10];
			var v91 := "uqmwx";
			var v92: map<int, map<array<int>, bool>> := map[i5 := v86[if (f10 in v89) then v89[f10] else v85 := v90[|v91|]]];
			...
			if (((if (v83 in v88) then v88[v83] else v86) + (if (v96.cf44 in v92) then v92[v96.cf44] else v86)) == (v86 + v86)) {
				...
				v97[212] := (if (if (v1 in v98) then v98[v1] else f10) then v99 else v99).cf80;
				var v101: C2 := new C2(v97[212], v97, f9, v90[-fm3(|(set v100 : int | (47 <= v100) && (v100 < 0x279) :: (v100 + v0))|, 113, v83, v0, globalState)]);
				var v102: map<bool, C2> := map[v97[212] := v101];
				v102 := v102;
				v0 := i5;
				v0 := i5 / v0;
			} else {
				...
				v107, v0, v0, v84 := v107, |(v84 + (seq(0x139, i10  => (v84[v0]))))|, fm1(f9, globalState), [13];
				v85[136] := i5 - v0;
				v85[136] := -v0;
			}
			...
			decreases 100 - i12
		{
			...
			var v115 := "fie";
			v114[571] := v115;
			var v116 := DC36(f10, v115, seq(425, i13  => (v113)));
			v114[571] := v115 + (if (true) then fm20(v0, v112.f14, !f10, v0, globalState) else v116.cf66);
			v0 := v0;
			if (f10) {
				v0 := 0x261;
				...
				v112.f15[982] := v119 > multiset{v0, v0};
				v112.f15[982] := true;
				var v120: array<int> := new int[22](i14 => i14 / v0);
				v120[894] := -|(seq(0x2af, i15  => (v113)))|;
				var v121: array<map<int, map<D13, int>>> := new map<int, map<D13, int>>[3](i16 => map[v0 := map[DC33([DC11(v0, v1, v112.f14), DC11(v0, v1, v112.f15[982]), DC11(|(seq(0x34f, i17  => (v113)))|, v1, true)]) := v0]]);
				var v122 := DC33(seq(-0x290, i18  => (DC11(v0, v1, v112.f14))));
				var v123: map<D13, int> := map[v122 := v0];
				var v124: map<int, map<D13, int>> := map[v0 := v123];
				v121[524] := v124;
				v120[894], v113, v121[524] := v0 + v0, v113, v124 + v124;
				var v125: map<int, int> := map[313 := v0];
				var v126: seq<int> := [|[if (v120[894] in v125) then v125[v120[894]] else v0, v0]|];
				var v127: map<int, bool> := map[v126[|v108|] := true];
				v112.f14 := (v127 + v127) != v127;
				var v128 := DC19(f10, v113);
				var v129: multiset<D6> := multiset{v128, v128, v128};
				var v130: seq<multiset<D6>> := [v129];
				v115, v129 := v114[571], v130[v0];
			} else {
		...
		var v144: seq<seq<set<bool>>> := [seq(0x177, i19  => (f11)), (v143 + v143)[|map[true := f9]| := f11], v143, [f11, f11], [f11, {f10}, f11, f11]];
		r2 := v144[v0 % |v138|];
		r3 := "xjnxgcyay";
	}
	method m1(p0: char, globalState: GlobalState) returns (r0: map<array<int>, string>, r1: bool) {
		...
		if (f10) {
			...
			if (f10) {
				...
				v7, v6[517], globalState.f8, v5 := v7, v9.cf65, !f10, -820;
				v5 := 557;
				r1 := f10;
				var v10: seq<bool> := [v6[517]];
				globalState.f8 := map[v5 := v10[v5 := fm2(globalState)]] == map[fm1(f9, globalState) := v10[v5 := f10]];
				...
				v11[655] := 0xe0;
				var v12 := "uppopviv";
				globalState.f8 := !((|v12| % |{f10, !f10}|) < |v12|);
			}
			...
			if (f10 <== !!(v13 <= [f10])) {
				var v14: array<int> := new int[13](i2 => i2 % |"eqk"|);
				v14 := v14;
				var v15 := DC0(f10);
				var v16: map<bool, int> := map[!v15.cf0 := v5];
				var v17: map<int, bool> := map[v5 := true];
				v16 := v16[!(if (v5 in v17) then v17[v5] else f10) := fm33(f10, v13[v5], 0x2c0, !f10, globalState)];
				var v18: C3 := new C3();
				...
				var v25 := DC6(v22);
				var v26 := DC38(!f10, v24[v5], true, f10, v25);
				...
				var v32 := DC12(f10, v5, fm31(f10, v27[|v31|], globalState), -v5, |v23|);
				var v33: map<D15, D4> := map[v26 := v32];
				var v34 := DC18(p0, v5, v5);
				var v35 := DC20(v34);
				var v36: seq<D6> := [fm55(f10, globalState)];
				var v37: array<bool> := new bool[22] [f10, f10, f10, !f10, f10, !f10, f10, f10, f10, v33 != map[v26 := v32], f10, f10, v5 > |f9|, !(v30.f14 || f10), f10, v30.f14 || v30.f14, DC20(v35) !in v36, f10, !(false !in (multiset(v13))[v30.f14 := v5]), v30.f14, f10, v30.f14];
				var v38: multiset<int> := multiset{v5};
				v37[123] := v38 !! v38;
				v37[123] := fm0(fm4('o', globalState), v30.f14, v5, f10, globalState);
			} else {
				...
				v39[893] := if (f10 in v41) then v41[f10] else v40;
				var v42 := DC18(p0, v5, |f9|);
				v39[893][675] := v42.cf35;
				...
				v45[202] := v43;
				globalState.f8, v39[893][675], v45[202] := f10, v5, v43;
				var v46: array<bool> := new bool[2](i4 => !f10);
				v46[976] := f10;
				v46[976] := 210 <= v39[893][675];
				r1 := v46[976];
				v46 := new bool[19](i5 => 671 !in (map v47 : int | v47 in (seq(0xef, i6  => (v5))) :: (v47 % v39[893][675]) := (|"cxlqhjcb"|)));
			}
		...
		if (v49[v48]) {
			...
			v50[191], r1, v52[181], v48 := f10 <== f10, f10 <==> (v48 > |v54|), (v53 + v53[!fm2(globalState) := v49]) + v53[f10 := v49], v48 - v48;
			var v55 := DC16(f9);
			var v56: array<map<bool, bool>> := new map<bool, bool>[15] [f9, f9 + f9, (fm48(v50[191], globalState))[v50[191] := f10], map[v50[191] := v50[191]], f9[v50[191] := v50[191]], f9, f9 + f9, v55.cf28, f9, f9[v50[191] := f10], f9, f9, f9 + f9, map[!v50[191] := v50[191]], f9];
			var v57: seq<map<bool, bool>> := [f9];
			v56[801] := v57[v48] + f9;
			v56[801] := f9;
			var v58 := DC39(!v50[191] <== f10, v50[191]);
			match (v58) {
				...
				case DC39(cf74, cf75) =>
					...
					v63[295] := ((if (p0 in v64) then v64[p0] else seq(-651, i9  => (p0))) + v61) + v62.f13;
					var v65, v66, v67, v68 := v62.m0(globalState);
				case DC37(cf68) =>
					var v69 := 'r';
					var v70: map<int, bool> := map[v48 := f10];
					v69 := fm31(v50[191], v70, globalState);
			...
			if (v82 <= v82) {
				...
				var v86: map<multiset<int>, seq<bool>> := map[v85[v48 := v48] := v49];
				v80[524] := (v48 <= v48) || !!((if (v85 in v86) then v86[v85] else v49) <= v49);
				var v87: seq<int> := [v48, v48];
				var v88: array<multiset<int>> := new multiset<int>[15] [v85, v85, v85, multiset(v87), fm46(v80[524], f10, v80[524], globalState), v85, v85, v85, v85, multiset{v48}, v85, v85, multiset{v48, v48}, v85, multiset(v87)];
				var v89: map<bool, array<multiset<int>>> := map[f10 := v88];
				var v90 := DC51(v88);
				var v91: array<array<multiset<int>>> := new array<multiset<int>>[14] [if (f10 in v89) then v89[f10] else v88, v90.cf97, v88, if (true in v89) then v89[true] else v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, if (v80[524]) then v88 else v88];
				v91[45] := v88;
				var v92: seq<array<multiset<int>>> := [v88];
				v91[45] := v92[84 - |v49|];
			} else {
				var v93: map<bool, bool> := map[v80[524] := true];
				v93 := f9 + DC16(f9).cf28;
				var v94: seq<int> := [v48];
				...
				var v101: array<int> := new int[6] [|{fm17(v80[524], globalState)}|, v94[v48], |v97| * (if (v99 in v98) then v98[v99] else v48), v48, -0x157, |((seq(0x147, i12  => (v94))) + v100)|];
				v95[571] := |(v82 + v82)|;
				var v102: multiset<bool> := multiset{v80[524]};
				var v103: multiset<int> := multiset{v48, |v82[-v48 := v81]|, v48};
				var v104: seq<multiset<int>> := [v103, v103];
				var v105: seq<multiset<int>> := [v103, v103, v104[|v82|], fm46(v80[524], true, v80[524], globalState)];
				v82, v80[524], v48, v81, v95[571] := v82 + (v82 + v82), true, if (f10) then if (799 in v96) then v96[799] else -|v94[0xe8 := -|v102|]| else v48 / fm3(|"fscb"|, v48, v81, |v105|, globalState), p0, if (f10) then v48 else 0x51;
				var v106 := DC13(v80);
				...
				v101 := if ((0x23a / v48) in v110) then v110[0x23a / v48] else v95;
			}
			
			var v111: map<bool, int> := map[v80[524] := v48];
			v111 := v111[f10 := v48];
			v80[524] := f10;
		}
	...
	method m2(globalState: GlobalState) returns (r0: int, r1: string) {
		...
		if (f10) {
			...
			var v8 := 'm';
			var v9 := DC19(true, v8);
			v5, globalState.f8, v7[962], v9 := if (v0 >= v0) then v5 else v5, !f10 <==> false, v5, v9;
			...
			v10[347] := |[f10, f10, f10]| / |v12|;
			var v13: T1 := new C4(f9, f10);
			var v14: array<T1> := new T1[4] [v13, DC56(v13).cf104, if (f10) then v13 else v13, v13];
			v14[884] := v13;
			var v15: seq<bool> := [f10];
			v10[347], v0, r0, globalState.f8, v14[884] := v3.fm1(f9, globalState) * 0x7a, v0, fm1(v13.f9[v13.f10 := v13.f10], globalState), 0x25c == |v15|, v13;
			globalState.f8 := false;
			v4 := v4[v10[347] := v8];
		} else {
			...
			var v19: seq<D14> := [v18];
			var v20 := 'e';
			var v21: array<seq<D14>> := new seq<D14>[17] [[v18, v18, v18], fm56(f10, globalState) + fm56(true, globalState), v19, v19, [v18, DC36(f10, v17, seq(0x275, i2  => ('v')))], [v18], [v18] + v19, v19, v19, v19, v19, v19, v19, fm56(f10, globalState), v19, v19, [DC36(f10, v17[|"lmmm"| := v20], v17)]];
			v16[237], v21 := v16[237], if (f10) then (DC58(v21).(cf105 := v21)).cf105 else v21;
			var v22: array<D15> := new D15[6];
			var v23 := DC49(false);
			var v24: seq<bool> := [f10, v23.cf93, f10, f10, f10];
			var v25 := DC39(f10, v24[v16[237]]);
			v22[13] := v25;
			var v26: multiset<bool> := multiset{f10, f10, f10, f10};
			v22[13], globalState.f8, v16[237], v16[237] := v25.(cf74 := v26 !! multiset(v24)), f10, |f9|, v0;
		...
		if (!!!((v29 + "nhghrw") <= v29)) {
			...
			if (v30[412]) {
				...
				v33[696] := |(v34 + v34)[v34[v0] := v0]|;
				v33[696] := v34[v0];
				v33[696] := |((v34 + v34) + v34)|;
				var v35: set<int> := {v33[696], 815};
				var v36: map<int, int> := map[|v35| := v33[696]];
				var v37: seq<bool> := [v30[412]];
				var v38 := 'v';
				var v40: seq<set<int>> := [v35];
				globalState.f8 := v36[-|fm15(f10, !v37[-0x112], |v35|, v38, globalState)| := v0] != (map v39 : int | v39 in v40[|"ykixtfsa"|] :: (v39 + v33[696]) := (v0));
				var v41: C4 := new C4(f9, f10);
				var v42: seq<C4> := [v41];
				var v43: map<int, C4> := map[if (v0 in v36) then v36[v0] else v33[696] := v42[v0]];
				v43 := v43;
				var v44: C2 := new C2(v30[412], v30, f9, fm0(v37, v30[412], v0, v41.fm0(v37, v30[412], 0x3ab, false, globalState), globalState));
				v44 := v44;
			} else {
				...
				var v47 := new C1(v30[412], (if (v30[412] in v46) then v46[v30[412]] else v29) + v29);
				var v48: array<int> := new int[11];
				v48[767] := v0;
				v48[767] := v0;
				var v49 := new C5(v45 + map[true := v30[412]], v48[767] == v48[767]);
			}
			
			var v50: array<int> := new int[10] [fm33(v30[412], f10, v0, f10, globalState), v0 * v0, v0, v0, v0, -v0, v0 % v0, v0, v0, fm33(v30[412], f10, v0, true, globalState)];
			v50 := v50;
		} else {
			...
			var v59 := 'c';
			v55 := ((v29 + v29)[|v58| := DC35(v0, v53, v59).cf64])[v54 := 'a'];
			var v60: array<bool> := new bool[1](i3 => f10);
			var v61: seq<bool> := [false, v53];
			var v62 := new C2(false, v60, f9, fm2(globalState) || v61[-v54]);
		}
		
		var v63: map<multiset<int>, int> := map[v2 := |(seq(0x2f9, i5  => ('x')))|];
		for i4 := v0 to |v63| {
			...
			var v64 := 'b';
			var v65 := DC3(v29);
			var v66: array<seq<char>> := new string[19] [v29, v29, v29, v29, v29, (v29[v0 := 'q'])[i4 := v64], ['t'], v29 + v29, v29, v29 + v29, fm13(v0, globalState), v65.cf5, v29 + v29, v29, v29 + [v64], [v64], seq(0x20c, i6  => ('h')), v29 + v29, v29];
			v66[90] := v29;
			var v67: T1 := new C6(map[f10 := false], !f10);
			var v68: set<int> := {i4, i4};
			v2, v0, v66[90], globalState.f8, v64 := multiset{v0, |[!f10, f10]|, if (f10) then |map[v67 := !f10]| else i4, i4, |v68|}, i4 / -i4, v29[i4 := 'x'], f10, v64;
		}
		...
		var v73 := DC13(v71[|v72|]);
		match (v73) {
			case DC14(cf25, cf26) =>
				var v74: seq<set<bool>> := [f11, f11, f11, f11];
				var v75: array<set<bool>> := new set<bool>[17] [fm30(globalState), {cf26, fm0(v69, cf26, 0x1f1, f10, globalState), cf26, cf26, cf26} * {f10, false, cf26}, {cf26, cf26, cf26}, v74[cf25] - f11, f11 + f11, f11, f11, f11, f11, f11, f11, f11, {f10}, f11, f11 - f11, f11, f11];
				v75 := v75;
			...
			case DC13(cf24) =>
				...
				if (fm2(globalState)) {
					...
					v84[576], v78, v85, v0 := if (f10) then map[v0 := v82] else v83, v78, v85, v0;
					cf24[690] := false;
					var v86: map<array<int>, bool> := map[v85 := true];
					var v87: map<seq<char>, bool> := map[seq(0x1ab, i7  => (v78)) := if (v85 in v86) then v86[v85] else f10];
					cf24[690], globalState.f8, r0, globalState.f8 := if (DC3(v29).cf5[v0 := 'd'] in v87) then v87[DC3(v29).cf5[v0 := 'd']] else f10, !(!f10 || f10), v0, f10;
					var v88 := new C6(f9, f10);
					v85[384] := -(v0 / v0);
					var v89: map<bool, int> := map[false := |map[f10 := v29]|];
					v85[384] := if (f10 in v89) then v89[f10] else v0;
				} else {
					...
					var v93: set<seq<C1>> := {v92[v0 := v91] + v92, v92 + v92[|v29| := v91]};
					v93 := v93;
					v0 := --|(v81 + v81)|;
				}
		...
		var v98 := new C2(v69[v0], v70, map[f10 := f10] + f9, f10);
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: bool, r2: int, r3: string) {
		...
		var v2 := DC47(f10, v1);
		var v3: map<int, D18> := map[-(p0 % 0x3be) := v2];
			...
			decreases 100 - i0
		{
			...
			v9 := v9[-(p0 % p0) := if (f10) then v8 else v8];
			r2 := -0x105 - p0;
			r1 := f10;
			var v10 := new C5(f9, false);
		}
		r2 := (if (f10) then p0 else p0) % (p0 / p0);
		if (f10) {
			...
			v11, v12[484], v13, v11[311] := v11, v15, v13, (if (!false) then p0 else p0) * (if (p0 in v6) then v6[p0] else p0);
			var v16: map<bool, char> := map[0x9b <= -v11[311] := v0];
		...
		for i4 := p0 to 643 {
			...
			match (DC42(f10, |map[f10 := !false]|, if (f10) then |multiset(v33)| else i4)) {
				case DC41(cf77, cf78, cf79) =>
					...
					var v40: map<bool, map<bool, int>> := map[v34[545] := v32];
					var v41: array<array<char>> := new array<char>[13] [v37, v38.cf111, v37, v37, v37, v39[|v40|], v37, v37, v37, v37, v37, v37, if (v35.f10) then v37 else v37];
					v41[758] := if (cf79) then v37 else v37;
					r2, v41[758] := i4, v37;
				...
				case DC42(cf80, cf81, cf82) =>
					...
					var v47: array<bool> := new bool[25] [f10 && f10, cf80, cf80, cf80 <== cf80, true, v45 !! {v43}, false, f10, v43.f12, true, f10, (set v46 : int | (0x2c3 <= v46) && (v46 < 0x2ab) :: (v46 % i4)) <= fm25(cf81, cf82, globalState), cf82 <= p0, cf80, v43.f12, cf80 <== cf80, cf81 == fm1(map[v43.f12 := cf80], globalState), f10, cf80, v43.f12, cf80, if (cf80) then f10 else !f10, cf80, f10, cf80 || f10];
					v47 := v47;
					globalState.f8 := cf80;
					var v48: map<int, array<bool>> := map[if (!v43.fm32(i4, v0, globalState)) then 630 else cf81 := v47];
					v47 := if ((0x20c % p0) in v48) then v48[0x20c % p0] else v47;
					...
					var v53: T0 := new C1(cf81 in {cf81, v33[|v49|], ---(if (v43.f13 in v52) then v52[v43.f13] else p0)}, v43.f13);
					var v54: map<bool, array<bool>> := map[v43.f12 := v47];
					var v55: map<int, string> := map[|v43.f13| := v43.f13];
					v51, v53, v6, cf81, v54 := v51, v53, (multiset{cf81, i4, |(if (v33[cf82] in v55) then v55[v33[cf82]] else v43.f13)|, i4} + multiset{i4}) * fm46(cf80, v43.f12, !v43.f12, globalState), (if (v51.fm0(v49, v43.f12, i4, v43.f12, globalState)) then i4 else cf82) * (p0 / |v43.f13|), v54;
				case DC40(cf76) =>
					var v56 := new C0();
					v5 := v5;
					var v57 := new C0();
			...
			if (!f10) {
				...
				var v64 := DC66(v58);
				var v65: array<multiset<char>> := new multiset<char>[28] [multiset{v0, v0, v0} - v58, multiset(v59), v58, if (p0 in v60) then v60[p0] else if (i4 in v60) then v60[i4] else v58, multiset{v0, v0}, v58, v58, v58, v58['i' := i4], v61[|v63|], v58[v0 := 0x112], v58, v58, v64.cf118, v58 - multiset(v59), v58, v58 + multiset(v59), v58, v58, v58, v58, v58, v58, v58, v58, v58 + v58, v58, v58];
				var v66: seq<bool> := [f10];
				v65[999] := v58 * fm57(|v66|, globalState);
				v65[999] := (v58 * v58) - (if (f10) then v61[p0] else v58);
				var v67 := DC16(f9);
				var v68: C5 := new C5(v67.cf28, f10);
				var v69: array<string> := new string[10];
				var v70: map<int, string> := map[p0 := v59];
				var v71: map<array<string>, string> := map[v69 := (seq(733, i5  => (v0))) + (if (p0 in v70) then v70[p0] else v59)];
			...
			var v79: set<int> := {p0};
			var v80: map<int, seq<set<int>>> := map[p0 := DC67(([{p0}, set v78 : int | (-0x2ff <= v78) && (v78 < 0x3e2) :: (v78 % i4), v79, v79, v79])[i4 := v79]).cf119];
			...
			if (fm58(globalState) != (if (-0x267 in v80) then v80[-0x267] else v81)) {
				...
				var v89: array<bool> := new bool[22] [!f10, f10, f10, f10, f10, f10, !f10 ==> f10, i4 == |v86|, f10, !f10, f10, v88 > v88, f10, !f10, f10, !f10, f10, f10, f10, v86[i4], f10, f10];
				v89[184] := f10;
				v89[184] := f10;
				globalState.f8 := v89[184] <==> v89[184];
				var v90 := DC21(f11);
				var v91 := DC21(v90.cf40);
				var v92: map<bool, bool> := map[if (v89[184]) then f10 else f10 := v91.cf40 < f11];
				v92 := v92;
				v89[184] := f10 <== v89[184];
			}
		...
		var v94: array<int> := new int[10] [864, p0, p0, v93[-fm33(!f10, f10, p0, f10, globalState)], p0, p0, p0, p0, p0, p0];
		...
		for i7 := -|v95| to p0 - p0 {
			...
			r1, r2, globalState.f8 := v96.fm18(f11, v97 + v97[p0 := fm31(f10, v98, globalState)], globalState), i7, f10;
			v94[130] := i7;
			var v99: map<bool, int> := map[f10 := v93[p0]];
			v94[130] := i7 - (|v99| - -i7);
			var v100 := new C0();
		}
		var v101 := "gbx";
		...
		r2 := |([if (f10) then !f10 else false])[p0 := !f10 in v102]|;
		r3 := v101;
	}
}
...
method Main() {
	...
	var v3 := new C1(v1, seq(0x370, i1  => ('n')));
	var v4: array<array<D15>> := new array<D15>[10];
	var v5 := DC43(v4);
	var v6: multiset<D17> := multiset{v5};
	var v7: map<multiset<D17>, int> := map[v6 := |[v1]|];
	var v8 := 0x39d;
	if (v3.fm32(if (v6[v5 := |"rdlthb"|] in v7) then v7[v6[v5 := |"rdlthb"|]] else v8, if (v1) then 'j' else 'l', globalState)) {
		var v9 := new C0();
		var v10 := 'v';
		v8 := |("pc")[|v3.f13| := v10]|;
		globalState.f8 := !(v8 != (v8 / 0x43));
		...
		v19 := v19[v1 := v8 / -|v20|];
		if (v3.f12) {
			v8 := v8 - (v8 % fm33(v3.f12, v3.f12, v8, v3.f12, globalState));
			...
			var v28: T0 := new C3();
			var v29 := 'o';
			globalState.f8, v1, v28, v8 := !((v8 + v8) != (v8 % v8)), if (!v3.fm32(v8, v29, globalState)) then v1 else v1, v28, v8 / v8;
			v8 := -(v8 % v8);
		...
		v30[402] := |("mlch" + v3.f13)|;
		v30[402] := v8 - fm33(v1, v3.f12, -v8, !true, globalState);
		var v32: array<map<seq<char>, int>> := new map<seq<char>, int>[7](i3 => map v31 : seq<char> | v31 in (seq(0x10f, i4  => (seq(0x262, i5  => ('s'))))) :: (v31) := (|v3.f13|));
		var v33: map<seq<char>, int> := map[v3.f13 := v30[402]];
		var v34 := 'p';
		v32[362] := (v33[[v34, v34] := |multiset{v8}|])[v3.f13 := v8];
		var v35: map<array<int>, int> := map[v30 := v8];
		var v36: multiset<bool> := multiset{v3.f12};
		v8, v32[362], v34 := if (DC72(v35).cf126 == v35) then v8 else |multiset{|v36|}|, v33[v3.f13 := v30[402]] + (map[v3.f13 := v30[402]] + v33[seq(697, i6  => (v34)) := v30[402]]), v34;
	}
	...
	v0[701] := v3.fm32(|v3.f13|, v37, globalState);
	v0[701] := v3.f12;
	if (v39.f10 <== v1) {
		if (v39.f10) {
			...
			v52[199] := v51;
			v47[133] := v8;
			v52[199], v47[133], v8, v0[701] := v51 + v51, if (v8 in map[v8 := v37]) then v8 else v8, v45[|map[v8 := v8]|] % DC24(true, {v47, v47, v47}, v8).cf44, v1;
			...
			var v61: multiset<int> := multiset{|v60|, |fm15(true, v39.f10, v8, v37, globalState)|, v47[133]};
			var v62: seq<C1> := [v3];
			var v63: map<multiset<int>, seq<C1>> := map[v61 * fm46(v39.f10, v3.f12, v3.f12, globalState) := v62];
			var v64 := DC77(v61);
			globalState.f8, v56[307], v1, v58, v63 := v0[701] <== v1, v55, v3.f12, v58, map[v64.cf131 := [v3]] + map[v61 := v62];
			var v65: map<int, int> := map[0x361 := |v53[198][v8 := v37]|];
			...
			v71[126] := -v8;
			v71[126] := 299;
			var v72: multiset<int> := multiset{v71[126], v71[126], v71[126], 0xb2};
			var v73: set<int> := {v8, |v72[|v3.f13| := v71[126]]|};
			v73 := v73 + v73;
		}
		...
		v84[825] := v8;
		v8, v0[701], v83, v8, v84[825] := v8 - v8, v39.f10, v83, v8, v8;
		var v85: seq<array<int>> := [DC7(v84).cf11, v84];
		var v86: set<array<int>> := {v85[v8], v84, v84};
		if (!(v86 !! v86)) {
			v1 := if (v39.f10 in v39.f9) then v39.f9[v39.f10] else -v84[825] > |"nlwuecg"|;
			v8 := -v8;
			v84[825] := |(seq(0x13, i9  => (v37)))|;
			...
			var v96: multiset<int> := multiset{v84[825]};
			var v98: array<map<int, seq<int>>> := new map<int, seq<int>>[16] [v89, (map v90 : int | v90 in v92 :: (v90 - v8) := (v45)) + v89, v89, map[0x17c := v45], v89, v89 + DC81(v89).cf139, (map v93 : int | v93 in v45 :: (v93 % v84[825]) := (v45)) + v89, map v94 : int | (-33 <= v94) && (v94 < -393) :: (v94 + |(seq(603, i10  => (v37)))|) := (v45), v89, v89, map v95 : int | v95 in v96 :: (v95 * v84[825]) := ([v8, v84[825]]), v89, v89, map v97 : int | v97 in v96 :: (v97 % |"fvnf"|) := (v45), v89, v89];
			v98[633] := v89;
			v98[633] := if (false) then v89 + v89 else (map[v8 := v45])[v84[825] := v45[v84[825] := |v42|]];
			v8, globalState.f8, v84 := -v8, !v3.f12, v84;
			v0[701] := v39.f10;
			globalState.f8 := v39.f10;
			var v99: set<bool> := {v39.f10};
			var v100 := new C7(v99, v39.f9, v3.fm32(v84[825], v37, globalState));
		}
		
		var v101: seq<bool> := [v0[701]];
	...
	if (v0[701]) {
		...
		v37 := v37;
		var v103 := "elcmh";
		v0[701], v103 := !(0x285 < v8), v3.f13 + v3.f13;
		v43.m5(globalState);
		var v104: seq<map<int, bool>> := [v2];
		v104 := seq(0x18b, i11  => (v2 + v2));
	} else {
		v8 := v8 - v8;
		var v105 := new C0();
		var v106: seq<array<bool>> := [v0];
		var v107: array<array<bool>> := new array<bool>[26] [v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v106[-v8], v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
		v107[934] := v0;
		v107[934] := v0;
		...
		v109[974] := v106;
		v109[974] := [v107[934]] + (v106 + v106);
	}
	
	globalState.f8 := !v39.f10;
	var v110: multiset<bool> := multiset{v3.f12, v3.f12};
	var v111: T0 := new C1(0x3b4 != |v110|, v3.f13 + v3.f13);
	var v112: C5 := new C5(map[v1 := true], v0[701]);
	var v113: map<C5, int> := map[v112 := v8];
	globalState.f8, v111, v0[701], v8 := v3.fm32(v8, v37, globalState), v111, v1, (v8 % (if (v112 in v113) then v113[v112] else v8)) % v8;
	if (v39.f10) {
		v0[701] := v0[701];
		var v114: map<bool, multiset<int>> := map[v1 := multiset(v45)];
		var v115: multiset<int> := multiset{v8, |[v39.f10, v3.f12]|};
		var v116: seq<multiset<int>> := [v115, v115, v115[v8 := v8], v115, v115];
		globalState.f8 := (if (v0[701]) then v0[701] else true) in v114[v0[701] := v116[v8]];
		var v117: array<array<bool>> := new array<bool>[24];
		var v118 := DC78(v117);
		match (v118) {
			case DC79(cf133, cf134, cf135) =>
				var v119: seq<bool> := [v1];
				var v120: set<bool> := {v3.f12, v39.fm0(v119, v3.f12, v8, v0[701], globalState)};
				v120 := fm34(v8, false, v39.f10, true, globalState) + v120;
				var v121 := DC1(v8, v0[701], v8);
			...
			case DC80(cf136, cf137, cf138) =>
				...
				var v131: seq<map<int, bool>> := [v2, (fm11(|v115|, |v45|, v39.f10, |(map[v39.f10 := v41[846]])[v3.f12 := v41[846]]|, globalState))[cf137 := v1]];
				var v132 := DC40(v131);
		...
		match (v144) {
			case DC41(cf77, cf78, cf79) =>
				v1 := |(v38[v39.f10 := v0[701]] + v39.f9)| != (-v8 + cf78);
				v43.m5(globalState);
				var v145 := DC53(v111);
				v145 := v145.(cf99 := v111);
			...
			case DC42(cf80, cf81, cf82) =>
				...
				globalState.f8, v146, globalState.f8 := v0[701], v146, (!v3.f12 <== v3.f12) ==> (v39.f10 <== v0[701]);
				v8 := cf82;
				var v147: set<array<bool>> := {v0};
				v0[701], cf81, v147 := v39.f10, cf82 + v43.fm1(v39.f9, globalState), v147;
				var v148 := "kspfey";
				v148 := v3.f13 + (seq(0x310, i12  => (v37)));
			case DC40(cf76) =>
				v0[701] := v39.f10;
		...
		var v169: array<string> := new string[23] [fm22(v8, v1, v39.f10, v8, globalState), v158, v161, v3.f13[|v3.f13| := v37], v3.f13, "yieoik", v161, v3.f13 + v158, v3.f13[|v164| := v37], fm13(v165.cf138, globalState), v161, v3.f13[v8 := 'p'], seq(476, i13  => (v37)), "a", fm45(v3.f12, if (v8 in v166) then v166[v8] else v8, v3.f12, globalState), v158, v3.f13[|v158| := 'p'], "iybtk", fm45(v159, fm33(v1, v159, -v8, v0[701], globalState), !!!v3.f12, globalState), if (v39.f10) then "wgwipapdd" else v3.f13, v158, v158 + v158, if (v167 in v168) then v168[v167] else v3.f13];
		var v170: map<int, array<string>> := map[v8 := v169];
		v8, v161, v169, v159 := v162.fm1(map[v39.f10 := v0[701]], globalState), v3.f13, if (|v3.f13| in v170) then v170[|v3.f13|] else v169, v1;
		var v171: map<bool, array<bool>> := map[v3.f12 := v0];
		v171 := map[v1 <== v39.f10 := v0];
		v1 := v39.f10;
	}
	
	var v172: seq<bool> := [v39.f10, if (v1) then v39.f10 else !v1, (seq(0x216, i14  => (v37))) <= v3.f13];
	if (v172[v8]) {
		var v173, v174 := v111.m1(v37, globalState);
		v43.m5(globalState);
		var v175, v176, v177, v178 := v112.m0(globalState);
		var v179 := new C0();
		var v181 := DC81(map v180 : int | (0x223 <= v180) && (v180 < 232) :: (v180 * |(seq(7, i15  => (v37)))|) := (v45));
		var v182 := DC83(v181);
		var v183 := DC83(v181);
		v183 := v183;
	} else {
		var v184 := "jytbikv";
		v184 := (v3.f13[v8 := v37])[v8 := v37];
		var v185: multiset<int> := multiset{v8};
		v185 := (fm61(map[986 := v8], globalState)).cf131;
		v0[701] := !(v3.f12 <==> v172[v8]) <== v3.f12;
		v8 := |(v184 + v184)| - |(seq(-69, i16  => (v37)))|;
		...
		match (v186) {
			case DC35(cf62, cf63, cf64) =>
				...
				v0[701], globalState.f8, v0, v188[7] := v3.f12, |v3.f13| !in v185, v0, -|(v190 + (map v191 : int | (0x1ec <= v191) && (v191 < 0xb7) :: (v191 / -0x303) := (seq(996, i18  => (cf62)))))|;
				cf62 := (cf62 % 270) / cf62;
			...
			case DC34(cf61) =>
				...
				var v198: set<int> := {v8, -v8, |([v3.f12])[|v197| := !v3.f12]|};
	...
	match (DC41(v0[701] <== v1, -v8, v0[701])) {
		case DC41(cf77, cf78, cf79) =>
			globalState.f8 := true;
		...
		case DC40(cf76) =>
			...
			v8 := fm33(v0[701], |(if (-0x31b in v219) then v219[-0x31b] else if (v8 in v219) then v219[v8] else v172)| <= v8, v8 * v8, v3.f12, globalState);
	}
