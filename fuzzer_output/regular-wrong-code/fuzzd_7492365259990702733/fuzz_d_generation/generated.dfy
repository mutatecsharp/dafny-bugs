...
function fm2(globalState: GlobalState): map<map<int, D0>, int> {
	((map v0 : map<int, D0> | v0 in map[map[|{multiset{true, true}, multiset(DC15([true]).cf31), multiset{true}}| := DC2(true)] := |(seq(0x17c, i0  => ('i')))|] :: (v0) := (329)) + map[map[|[true]| := DC2(false)] := |[false, true, false, false, false]|]) + (map[map[-0xde := DC2(true)] := |"swxgyamao"|] + map[map[|multiset{679}| := DC2(true)] := |[0x111, |[|[0x1ff]|]|, |map[127 := !false]|]|])
}
...
function fm11(p0: bool, globalState: GlobalState): map<string, int> {
	map v0 : string | v0 in ["bb", "mwmmnrp", "obby", seq(247, i0  => ('o'))] :: (v0) := (0x195 + 0x399)
}
...
function fm15(p0: int, p1: bool, p2: int, globalState: GlobalState): map<int, int> {
	if (0x213 !in map[0x303 := false]) then map v0 : int | v0 in (seq(0x3ae, i0  => (-0x36a))) :: (v0 * 0x367) := (|(map v1 : int | v1 in DC16(map[0x2f8 := map v2 : int | (0x3d0 <= v2) && (v2 < 0x2e9) :: (v2 % 0x2c6) := (|[!false, false]|)]).cf32 :: (v1 - |map[|(set v3 : char | v3 in multiset{'y', 'x'} :: (v3))| := |(seq(228, i1  => (|"mamhl"|)))|]|) := (map[|multiset{false}| := true]))|) else map[0x5f := -232] + map[|{967}| := -0x2b9]
}
...
method m0(p0: int, globalState: GlobalState) returns (r0: array<int>) {
	for i0 := |"r"| to p0 {
		...
		v0, v5 := set v6 : int | v6 in (v0 + v0) :: (v6 + (201 + |multiset(seq(-511, i1  => (-128)))|)), v5;
		globalState.f11 := -i0;
	...
	var v17: set<int> := {p0};
	var v18: array<bool> := new bool[16] [v15, false, v15, false, v15, v15, v15, if (p0 in v14) then v14[p0] else v15, !v15, v15, v15, !v15, v15, !v15, !v15, v16[-|v17|]];
	...
	match (v19) {
		...
		case DC3(cf7, cf8, cf9, cf10) =>
			...
			var v26 := DC0(|v25|);
			v26 := v26;
			globalState.f12 := v25 <= ((fm8(globalState))[cf7 := 'l'] + v25);
			var v27: set<bool> := {v15, v16[cf7], cf8, v15, v15};
			var v28 := 's';
		...
		case DC0(cf0) =>
			...
			if (v16[105] <==> (v29 in v30)) {
				...
				v18, v48[291], v50 := v18, v49, v50 * v50;
				var v51: array<int> := new int[21](i4 => i4 + p0);
				v51[4] := cf0 % cf0;
				globalState.f11, cf0, globalState.f11, v51[4], globalState.f10 := p0, |v16|, cf0, (if (v15) then -722 else cf0) + fm0(globalState), v31[p0] / v31[|v29|];
			} else {
				globalState.f12 := DC8([p0], fm1(v15, !v15, cf0, globalState), v15, (seq(0x110, i5  => ('m')))[cf0 := v29[p0]], true).cf20;
				globalState.f12 := v15;
	...
	if (true && v15) {
		...
		v18[708] := if (fm17(v15, globalState) in v57) then v57[fm17(v15, globalState)] else v15;
		var v58: multiset<int> := multiset{p0};
		var v59: seq<int> := [p0];
		var v60: map<bool, bool> := map[v15 := v15];
		v18[708] := (if (p0 in v58) then v58[p0] else p0) <= v59[|v60|];
		var v61: multiset<bool> := multiset{v18[708]};
		var v62 := "fjuprfrne";
		var v63: set<multiset<bool>> := {v61[true := |v62|], v61, v61};
		...
		match (v67.(cf28 := v15 && v15, cf29 := v55)) {
			case DC14(cf28, cf29, cf30) =>
				...
				v68[394] := v62;
				cf29, v68[394] := v55, ("jgxwsdkj")[v65.f18 := cf29];
			...
			case DC13(cf27) =>
				...
				v71[425], v72, v73[371] := v70, v72, if (v75 > v75) then v74 else v74;
				...
				var v79: map<bool, int> := map[v18[708] := p0];
				v70[205] := if (v72.fm7(v15, |[v55, v55]|, v79, v62, globalState) in v78) then v78[v72.fm7(v15, |[v55, v55]|, v79, v62, globalState)] else -|v61|;
				var v81: map<set<int>, int> := map[set v80 : int | (-0x3ba <= v80) && (v80 < 990) :: (v80 * v65.f18) := p0];
				var v83 := DC13(cf27);
				var v84: multiset<D6> := multiset{v83};
				var v85: map<multiset<D6>, bool> := map[v84 := v18[708]];
				v59, v18[708], globalState.f10, v70[205], v62 := v59, !v15, if ((set v82 : int | v82 in v14 :: (v82 % |map[|[false]| := 420]|)) in v81) then v81[set v82 : int | v82 in v14 :: (v82 % |map[|[false]| := 420]|)] else p0, v65.f18 - (|v85| % |{v15}|), v62 + v62;
		}
		...
		v90 := if (v16[p0]) then v90[v89 := p0] else v90 + v90;
		...
		var v94 := DC6(v93);
		var v95 := 'c';
		v91[130] := new string[5] [("lksj" + v93)[p0 := v93[p0]], v94.cf14, v93 + v93, seq(0x74, i9  => ('p')), (v93 + v93)[fm0(globalState) := v95]];
		globalState.f12, v95, globalState.f10, globalState.f3 := v15, v95, p0, fm8(globalState) + v93[p0 := v95];
	}
		...
		decreases 100 - i10
	{
		...
		var v105: array<int> := new int[23] [if (v15) then p0 else 0x383, p0 * p0, 586, 120, p0, p0, p0, p0, p0, p0, fm0(globalState), |v99[p0 := -p0]|, p0, p0, |v99[p0 := 0x1d8]| * |v104|, v100.f18, v100.f18, p0, |v103[p0 := v103[p0]]|, v100.f18, if (fm1(v15, v15, |v103|, globalState)) then fm0(globalState) else v99[v100.f18], v100.f18, p0];
		r0 := v105;
		globalState.f12 := !v15;
	}
	v18 := v18;
...
class C1 {
	...
	method m1(p0: int, p1: bool, p2: array<D0>, p3: int, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
		...
		if (fm1(p1, "rrme" < fm8(globalState), p3, globalState)) {
			...
			globalState.f11 := p0;
			globalState.f12 := p1;
			var v12 := DC0(|(seq(-0x39f, i2  => ('j')))|);
			var v13: set<D0> := {DC0(p3), v12, DC0(537)};
			v2[916] := v13 > v13;
			globalState.f12, v2[916] := false, p1;
		} else {
			var v14: seq<char> := [v0[96], v0[96]];
			var v15 := DC6(v14);
	...
	method m2(p0: array<bool>, p1: seq<char>, p2: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v2: array<seq<int>> := new seq<int>[25](i1 => if (v1) then seq(145, i2  => (|multiset([v1, v1, v1])|)) else seq(0x9a, i3  => (p2)));
			var v3: seq<int> := [p2];
			v2[869] := v3;
			v2[869] := v3;
			...
			p0[864] := !v1;
			var v6 := DC7(v5);
			var v7 := DC1(|(seq(0x38c, i4  => (f18)))|, f18, p2, f18, p0);
			var v8: seq<D0> := [DC1(0xfa, |"mocct"|, -f18, f18, p0)];
			v5, p0[864], v1, globalState.f10 := v6.cf15, v1, v7 !in v8, |(p1 + (seq(0x19, i5  => ('x'))))|;
			var v9 := DC2(v1);
			var v10: map<bool, D0> := map[p0[864] := v9];
			var v11: map<map<bool, D0>, int> := map[v10 := f18];
			var v12 := 'c';
			var v13: multiset<int> := multiset{|p1[p2 := v12]|};
			var v15: set<map<bool, D0>> := {v10, v10};
			globalState.f12 := v11 == (map[v10 := |v13|] + (map v14 : map<bool, D0> | v14 in v15 :: (v14) := (0x2)));
		}
		var v16: array<D3> := new D3[17](i7 => DC8([0x380, |multiset([|p1[505 := 'v']|, p2])|], v1, v1, p1, v1));
		forall i6 | 0 <= i6 < v16.Length {
			v16[i6] := if (false) then DC8(seq(0x3e6, i8  => (|map[v1 := f18]|)), v1, v1, p1, v1) else DC8(seq(0x31, i9  => (p2)), !v1, v1, p1, v1);
		}
		if (false) {
			if (p2 >= p2) {
				var v17 := new C0();
				...
				var v22: array<string> := new string[29] ["lglnyxquc", p1, if (v1 in v18) then v18[v1] else p1, seq(-0x9c, i10  => ('u')), p1, p1, (v19.(cf14 := p1)).cf14, p1, seq(0x2e2, i11  => (DC4('l').cf11)), p1, p1, p1 + v21.cf19, p1, "hfqwixbp", p1, p1, p1, p1 + p1, p1, "kyqwj", v21.cf19, p1, "aqevck", p1, p1 + p1, p1, p1, seq(307, i12  => ('c')), "mgyrwllh"];
				v22[767] := p1;
				v22[767] := seq(360, i13  => ('k'));
				var v23: seq<C0> := [v17];
				v17 := v23[f18 - -f18];
				var v24: array<seq<array<int>>> := new seq<array<int>>[7];
				var v25: seq<array<int>> := [v0, v0, v0, v0];
				v24[798] := ([v0, v0, v0])[p2 := v0] + v25;
				v24[798] := v25 + [v0, v0];
			} else {
				v0 := v0;
			...
			var v28 := 'h';
			var v29: map<string, char> := map[seq(0x15e, i15  => ('f')) := v28];
			v29 := v29[p1 + p1 := v28];
			var v30: C0 := new C0();
			var v31: map<C0, int> := map[v30 := -p2];
			v31 := v31[v30 := f18];
			var v32 := DC1(|p1|, p2, p2, -(-f18 / p2), p0);
			match (v32) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					globalState.f12 := (cf4 % f18) <= cf3;
					cf5[843] := v1;
					var v33: multiset<multiset<int>> := multiset{multiset(seq(-0x134, i16  => (cf1)))};
					...
					cf5[843], v1, globalState.f3, globalState.f10 := v33 == (v33[v34[p2 := |map[!v1 := v1]|] := p2] + v33), multiset(v35 + v35) >= v37, v30.fm7(v1, f18, v38, p1, globalState) + p1, -(cf4 / cf1);
					globalState.f3 := p1;
					var v39 := DC0(|v38|);
					var v40: seq<D0> := [v39];
					v40 := fm10(v1, v28, globalState) + v40;
				case DC2(cf6) =>
					v1, globalState.f11, globalState.f10 := false, fm0(globalState) - f18, (p2 / |p1|) % f18;
					var v41: map<bool, bool> := map[cf6 := cf6];
					v41 := v41[v1 := cf6] + v41;
					p0[647] := cf6;
					p0[647] := false;
					var v42: seq<bool> := [p0[647], p0[647], cf6];
					v42 := v42;
				case DC3(cf7, cf8, cf9, cf10) =>
					p0[301] := v1;
					p0[301] := v1 <== v1;
					...
					var v45: array<C0> := new C0[17] [v30, v30, v43.cf21, v30, v30, v30, v30, v30, v30, v30, v30, v30, if (v1) then v30 else v30, v30, v30, v30, if (p0[301] in v44) then v44[p0[301]] else v30];
					v45[135] := v30;
					p0[301], v45[135] := cf8 || cf8, v30;
					globalState.f10 := cf7;
				case DC0(cf0) =>
			...
			v67[589] := new multiset<int>[15] [v71[p2], v64.fm6(|v66|, v1, globalState) - v70, v70, multiset(v66[-p2 := 0x2c2] + v66), v70, v70, v70 * v70, v70, v70[p2 := p2], v70, v70, v70 - v70, v70, multiset{p2, f18}, v70 + (multiset{p2, f18})[p2 := f18]];
		...
		if (v1 || (v1 <== v1)) {
			...
			var v76: map<int, array<int>> := map[|v75[p2]| := v0];
			var v77 := DC13(v76);
			match (DC3(p2, fm1(v1, v1, |v77.cf27|, globalState), p2, p2)) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					v0[463] := (cf2 - (if (v1 in v78) then v78[v1] else p2)) * |fm13(v1, v79, globalState)|;
					var v80 := new C0();
					var v81 := new C0();
				...
				case DC2(cf6) =>
					...
					p0[849] := (multiset(v87) * v88) < v88;
					var v89: map<seq<int>, int> := map[seq(0x4f, i18  => (p2)) := f18];
					v89 := v89[v87 := p2 - p2];
					var v90: array<bool> := new bool[18] [p0[849], !v1, p0[849], false, p0[849], false, false, cf6, cf6, p0[849], p0[849], cf6, p0[849], cf6, v1, cf6, cf6, true];
				...
				case DC3(cf7, cf8, cf9, cf10) =>
					...
					v94 := if (v1) then seq(0x1ad, i19  => (|{cf7}|)) else v94;
					var v95: multiset<char> := multiset{v74};
					var v96: map<int, multiset<char>> := map[fm0(globalState) / p2 := v95];
					v96 := v96[cf9 := v95];
					v0 := new int[12];
					globalState.f10 := f18;
				case DC0(cf0) =>
			...
			match (v107) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					cf5[173] := fm1(v1, v1, fm0(globalState), globalState) && v1;
					var v108: seq<int> := [cf1];
					var v109: map<array<int>, bool> := map[v0 := v1];
					var v110: multiset<int> := multiset{0x312};
					cf5[173] := (multiset(v108))[cf3 := |v109|] !! v110;
					var v111: seq<bool> := [cf5[173]];
					v111 := v111;
					var v112 := new C0();
					v1 := v111[fm0(globalState)];
				case DC2(cf6) =>
					...
					v118[94] := v107;
					v117, globalState.f3, v118[94], globalState.f12 := v117, [v105], v107, cf6;
					var v119 := new C0();
					var v120 := new C0();
				case DC3(cf7, cf8, cf9, cf10) =>
					var v121 := new C0();
				...
				case DC0(cf0) =>
					...
					var v133: array<map<int, int>> := new map<int, int>[21] [v126 + v126, map[f18 := f18], v126, if (v127[f18]) then v126 else v126, v126, v126, map v128 : int | (0xf1 <= v128) && (v128 < 378) :: (v128 % -|v127|) := (f18), v126, (map v129 : int | v129 in v126 :: (v129 + -p2) := (f18)) + (map v130 : int | (0x2df <= v130) && (v130 < 0x1fb) :: (v130 / cf0) := (|multiset{cf0}|)), fm15(|v132|, v1, cf0, globalState), v126, v126, map[cf0 := 650], v126, v126 + v126, v126, map[f18 := cf0], v126, v126, v126, v126];
			...
			match (if (if (v1 in v138) then v138[v1] else v1) then DC12(v139) else v140) {
				case DC12(cf26) =>
					...
					var v141 := new C0();
					globalState.f11 := f18;
					var v142: seq<bool> := [v1, v1, p0[125]];
					var v143: seq<array<char>> := [v104];
					var v144 := DC14(false, v105, v143[p2]);
					var v145: map<seq<bool>, bool> := map[v142 + v142 := if (p0[125]) then true else v144.cf28];
					v145 := v145[[v1] := !v1];
			}
			...
			if (v1 ==> !(if (v1) then v1 else v1)) {
				...
				v0[146] := if (fm1(!v1, true, f18, globalState)) then f18 else f18;
				v0[146] := (-f18 - f18) * -(p2 * f18);
				var v148: map<bool, int> := map[v1 := -|"cudbn"|];
				globalState.f3 := v146.fm7(v1, |(seq(0x22a, i23  => (v105)))|, v148, p1, globalState);
...
method Main() {
	...
	for i0 := -0x2df to v5 {
		...
		v9, globalState.f12, globalState.f12, globalState.f12, v5 := if (-0x1b6 > 880) then v9 else v9, !(v0 != v0), if (v10) then v10 else v11[v5], if (716 in v12) then v12[716] else v10, -i0 - (|v0| * --fm0(globalState));
	...
	if (if (v5 in v19) then v19[v5] else v5 == v5) {
		...
		v20[972] := if (if (v5 in v19) then v19[v5] else v21.cf8) then fm1(v17, v17, v5, globalState) else v17;
		var v22: set<bool> := {v17, !v17};
		v20[972] := fm1(false, v22 !! v22, v5 % v5, globalState);
		var v23: array<map<map<int, D0>, int>> := new map<map<int, D0>, int>[21];
		var v25: map<int, int> := map[v5 := v5];
		var v26: map<map<int, D0>, int> := map[map v24 : int | v24 in v25 :: (v24 * v5) := (DC2(v20[972])) := v5];
		v23[397] := v26;
		v23[397] := fm2(globalState);
		match (fm3(|v0|, globalState)) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				var v27 := m0(if (v20[972]) then cf2 else cf4, globalState);
				globalState.f10 := --cf4;
				...
				v20[972] := !(v2 in v0);
			case DC2(cf6) =>
				var v31: seq<bool> := [v20[972]];
				v31 := v31 + v31;
				globalState.f10, globalState.f10 := v5 % v5, -v5 - v5;
				globalState.f12 := false;
				var v32: array<int> := new int[4](i1 => i1 + v5);
				v32[302] := v5;
				var v33: map<multiset<bool>, bool> := map[multiset{cf6} := v20[972]];
				v32[302], v0 := if (cf6) then v5 else v5 % |v33|, v0 + (seq(0x191, i2  => (v2)));
			case DC3(cf7, cf8, cf9, cf10) =>
				...
				var v38: array<int> := new int[29] [v5 % cf7, -(if (cf8) then v5 else cf10), 0xb, cf7 + cf9, cf9, fm0(globalState) * |v34|, v5, v5, |(seq(0x2b5, i3  => (cf9)))|, cf9 * 0x1a3, 0x1b5, |v35[v2 := v5]| - cf7, cf7, |(fm4(globalState) + v36)|, cf7, -0x21c, cf10, if (cf10 in v37) then v37[cf10] else cf10, v5, cf10, v5, v5, -(-|v0| - |fm5(cf10, globalState)|), cf10, v5 * -0x212, |[v5, -|v0|]|, cf10, v5, cf10];
				v38[882] := cf9 + cf7;
				v38[882] := |v0|;
				var v39 := DC4(v2);
		...
		if (v47.cf8) {
			...
			v46[421] := v5;
			v5, v17, v46[421], globalState.f12 := v5, v17, |v0| - v5, (v0 + v0) < v0;
			var v49 := m0(v46[421], globalState);
			var v50 := DC2(v17);
			var v51: seq<D0> := [v50.(cf6 := !v17), v50];
			v51 := seq(0x158, i4  => (v50));
		...
		var v60: array<bool> := new bool[8] [v17, v5 > v5, v17, v17, v17, !(if (v5 in v19) then v19[v5] else v17), !v59[v5], v17];
		v60[694] := v17;
		var v61: multiset<bool> := multiset{v17};
		v60[694] := fm1(v17, multiset{|v61|, v5, v5} != (multiset{v5, v5})[v5 := v5], -(|"wbxk"| % v5), globalState);
		var v62 := m0(0x5, globalState);
		v60[694] := (v60[694] <== v60[694]) <== !v60[694];
	}
	
	var v63: array<bool> := new bool[7];
	forall i5 | 0 <= i5 < v63.Length {
		v63[i5] := |(multiset{DC6(v0), DC6(v0), DC6(seq(0x369, i6  => (v2)))} * multiset{DC6(v0)})| !in multiset{v5};
	}
	...
	for i7 := -|v69| to 0x42 {
		...
		if (v17 ==> v17) {
			...
			var v73: seq<map<int, C1>> := [v72[v70.f18]];
			globalState.f12 := v73[i7] == v71;
			...
			globalState.f10, v74, v5, globalState.f12 := if (v78 in v79) then v79[v78] else 0x6e, v74, v70.f18 / v5, v17;
			...
			v70.f18 := |(map[v84 := v70.f18] + v85)| / |v0|;
			var v86: multiset<C0> := multiset{v82, v82};
			var v87 := new C1(|v86|);
			v63[948] := v17;
			v63[948] := v70.f18 >= v87.f18;
			var v88 := new C0();
	...
	for i8 := |v89| to v5 {
		...
		var v92 := new C1(0x2e5 / |v91|);
		var v93: map<bool, array<bool>> := map[v17 := v63];
		v93 := v93;
	}
	var v94: array<string> := new string[7](i9 => v0 + v0[|v0| := v2]);
	v94 := v94;
	globalState.f12 := false;
