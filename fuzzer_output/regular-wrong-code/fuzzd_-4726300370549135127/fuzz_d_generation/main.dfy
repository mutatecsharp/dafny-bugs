...
class C0 {
	...
	method m0(p0: bool, p1: int, globalState: GlobalState) returns (r0: bool, r1: seq<multiset<int>>) {
		...
		var v3: map<bool, seq<int>> := map[p1 < p1 := v2[safeIndex(-|(seq(abs(0x214), i0  => ('a')))|, |v2|)]];
		var v4: array<string> := new string[15];
		var v5 := "ylwodeou";
		v4[safeIndex(306, v4.Length)] := v5;
		var v6: seq<bool> := [f26, !f26, f26];
		globalState.f15, r0, v3, v4[safeIndex(306, v4.Length)] := |(v0 + (v0 + v0))|, v6[safeIndex(p1, |v6|)], v3 + map[f26 := v0], v5;
		r0 := v1.cf0;
		for i1 := -p1 to p1 {
			var v7: array<int> := new int[1];
			v7[safeIndex(318, v7.Length)] := i1;
			var v8: map<bool, int> := map[p0 := p1];
			var v9: map<int, bool> := map[i1 := f26];
			var v10: multiset<int> := multiset{i1};
			globalState.f5, r0, v7[safeIndex(318, v7.Length)], v5, globalState.f19 := v7, !false, safeDivisionInt(p1, safeDivisionInt(p1, |v8[true := p1]|)), seq(abs(848), i2  => ('t')), if ((p1 < fm3(i1, v9, i1, globalState)) in v8) then v8[p1 < fm3(i1, v9, i1, globalState)] else |v10|;
			f26 := f26;
			var v11: map<bool, bool> := map[if (p0) then p0 else p0 := f26];
			v11 := v11[if (p0) then p0 else !f26 := f26];
			var v12: map<int, array<int>> := map[i1 := v7];
			r0, r0, globalState.f15, globalState.f15, f26 := f26, v6[safeIndex(p1 * |v9|, |v6|)], i1 * |v12|, -|v0|, (|map[f26 := f26]| * v7[safeIndex(318, v7.Length)]) >= v7[safeIndex(318, v7.Length)];
		}
		var v13: map<bool, int> := map[f26 := p1];
		var v14: set<bool> := {p0, f26, p0};
		var v15: map<int, bool> := map[|(seq(abs(0x1c8), i3  => ('j')))| := f26];
		...
		var v18 := DC2(|v4[safeIndex(306, v4.Length)]|, p1, -594, v17);
...
function fm4(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): set<char> {
	set v2 : char | v2 in (map['o' := [|map[false := true]|]] + (map v0 : char | v0 in (map v1 : char | v1 in (seq(abs(0x2c5), i0  => ('e'))) :: (v1) := (0x388)) :: (v0) := ([0x24b]))) :: (v2)
}
function fm5(p0: bool, p1: bool, p2: bool, globalState: GlobalState): multiset<int> {
	multiset{-|multiset{!false, false}|} - (if (false) then multiset{|[0x34c]|} else multiset{|map[true := false]|, |(seq(abs(0x76), i0  => ('m')))|})
}
...
method Main() {
	...
	var v5 := DC0(false);
	var v6: array<bool> := new bool[12] [true, v5.cf0, false, v2[safeIndex(v3, |v2|)], v1, v1, !v1, v1, v1, v1, !v1, v1];
	var v7 := 'l';
	...
	if (safeDivisionInt(v3, v3) >= |[v1, v1, v1]|) {
		v6 := v6;
		var v13 := "shmbaf";
		var v14: multiset<string> := multiset{v13, v13, v13};
		var v15: map<bool, int> := map[fm0([v3], v3, -|v13|, globalState) := -|v4|];
		v3 := if ((seq(abs(-0x34d), i0  => (v7))) in v14) then v14[seq(abs(-0x34d), i0  => (v7))] else if (v1) then |v15| else -872;
		v1 := v7 !in v13;
		if (v4 > v4) {
			globalState.f15 := v3;
			v1 := v1;
			var v16 := new C0(v1);
			v16.f26 := !(v3 > safeDivisionInt(v3, -0x16d));
			...
			v22[safeIndex(333, v22.Length)] := v0;
			v13, globalState.f19, v22[safeIndex(333, v22.Length)], v19.f26, globalState.f19 := v13, v3, v0, v19.f26, 850;
			v13 := v13;
			var v23 := DC3(v3);
			v23 := v23;
		}
		...
		v31[safeIndex(434, v31.Length)] := v32;
		var v33: multiset<string> := multiset{v27};
		globalState.f19, v27, v31[safeIndex(434, v31.Length)] := |(v33 - v33)|, v27, v32;
	}
	...
	var v58 := "xseuq";
	v0[safeIndex(126, v0.Length)] := |v58|;
	v0[safeIndex(126, v0.Length)] := -v3;
	for i4 := 0xd2 to v3 {
		var v59, v60 := v34.m0(v34.f26, v0[safeIndex(126, v0.Length)] * v3, globalState);
		var v61: map<char, set<int>> := map['v' := v4];
		v61 := v61[v7 := v4];
		var v62: seq<string> := [v58];
		if (v58 != (v62[safeIndex(v0[safeIndex(126, v0.Length)], |v62|)] + v58)) {
			globalState.f5 := v0;
			var v63: array<array<D1>> := new array<D1>[8];
			var v64: map<array<array<D1>>, array<int>> := map[v63 := v0];
			v64 := v64[v63 := v0];
			var v65: seq<array<bool>> := [v6];
			var v66 := DC5(v0, v65, -v0[safeIndex(126, v0.Length)]);
		...
		var v77 := DC7(v2);
		var v78: multiset<int> := multiset{v0[safeIndex(126, v0.Length)]};
		var v79: map<multiset<int>, seq<bool>> := map[v78 := [v1]];
		var v80: array<seq<bool>> := new seq<bool>[28] [v2, v2, v2, v2 + v2, [v34.f26, v1, true, v59, !v34.f26], v2, if (true) then v2 else v2, v2 + v76[safeIndex(v3, |v76|)], v2 + v2, v2, [v34.f26] + [v34.f26], v2, ([v1, v34.f26])[safeIndex(|(seq(abs(574), i5  => (v0[safeIndex(126, v0.Length)])))|, |[v1, v34.f26]|) := v34.f26], v77.cf11, v2, v2[safeIndex(-|v34.fm1(v59, globalState)|, |v2|) := v34.f26], v2, v2, if (v1) then v2 else v2, v2, v2, v76[safeIndex(-260, |v76|)], v2 + v2, v2, v2 + v2, if (multiset{v3} in v79) then v79[multiset{v3}] else [v34.f26, v1], v2, v2];
		v80[safeIndex(414, v80.Length)] := v2[safeIndex(v3, |v2|) := v34.f26] + v2;
		v80[safeIndex(414, v80.Length)] := [!false, v1, v34.f26];
	}
	if (v1) {
		if (v5.cf0) {
			v34.f26 := v34.f26;
			var v81, v82 := v34.m0(v34.f26, v0[safeIndex(126, v0.Length)], globalState);
			globalState.f15 := v0[safeIndex(126, v0.Length)];
			globalState.f15 := 0x18e;
			v34.f26 := v81;
		} else {
			var v83, v84 := v34.m0(v34.f26, v3, globalState);
			v6[safeIndex(320, v6.Length)] := v7 !in "aqoumw";
			...
			var v88 := DC9(v0[safeIndex(126, v0.Length)]);
			var v89 := DC10(v88);
			v6[safeIndex(320, v6.Length)], v87, v89, v0[safeIndex(126, v0.Length)] := v5.cf0, v87, if (!v34.f26) then v89 else v89, v0[safeIndex(126, v0.Length)];
			globalState.f19, v6[safeIndex(320, v6.Length)] := v0[safeIndex(126, v0.Length)], fm0(seq(abs(-0x36f), i6  => (v3)), safeDivisionInt(v0[safeIndex(126, v0.Length)], v0[safeIndex(126, v0.Length)]), v0[safeIndex(126, v0.Length)], globalState);
			v0[safeIndex(126, v0.Length)] := v0[safeIndex(126, v0.Length)];
			var v90: seq<C0> := [v34, v34];
			var v91: seq<int> := [-|v90|];
			var v92: map<bool, int> := map[v34.f26 := v0[safeIndex(126, v0.Length)]];
			var v93: map<int, map<bool, int>> := map[v3 := v92];
			var v94: multiset<bool> := multiset{fm0(v91, -v3, v3, globalState), v34.f26 !in (if (v0[safeIndex(126, v0.Length)] in v93) then v93[v0[safeIndex(126, v0.Length)]] else v92)};
			var v95: map<int, bool> := map[v0[safeIndex(126, v0.Length)] := v6[safeIndex(320, v6.Length)]];
			var v96: map<char, multiset<bool>> := map[v7 := multiset{v6[safeIndex(320, v6.Length)], v6[safeIndex(320, v6.Length)]}];
			v0[safeIndex(126, v0.Length)], v7, v34.f26, v94 := fm3(82, v95, v0[safeIndex(126, v0.Length)], globalState) + safeDivisionInt(v3, v0[safeIndex(126, v0.Length)]), v7, v6[safeIndex(320, v6.Length)], if (v7 in v96) then v96[v7] else v94;
		}
		
		if (v1) {
			v0[safeIndex(126, v0.Length)] := v3;
			var v97: seq<int> := [v0[safeIndex(126, v0.Length)]];
			...
			var v102 := DC11(v101[safeIndex(v0[safeIndex(126, v0.Length)], |v101|)]);
			v100 := v102.cf14;
			...
			v109, globalState.f19 := v109, |v111| + (v0[safeIndex(126, v0.Length)] - |multiset{v107.f26}|);
			var v112: seq<string> := [v58];
			var v113: multiset<string> := multiset{"d"};
			var v114: array<multiset<string>> := new multiset<string>[7] [multiset{v58, v58, "cbpcgr"} * multiset(v112), v113, v113 + fm8(globalState), (multiset{v58})["ihs" := abs(v3)], fm8(globalState), v113, multiset{v58, v58} + v113];
			v114[safeIndex(223, v114.Length)] := v113;
			v114[safeIndex(223, v114.Length)] := v113;
		}
		...
		var v117 := DC5(v0, v116, v0[safeIndex(126, v0.Length)]);
		var v118: seq<seq<array<bool>>> := [v116];
		v117 := DC5(v0, v118[safeIndex(|[v0, v0, v0]|, |v118|)], v0[safeIndex(126, v0.Length)]);
		var v119: seq<int> := [0xc3];
		var v120: map<bool, int> := map[v2[safeIndex(v119[safeIndex(v3, |v119|)], |v2|)] := v3];
		var v121: multiset<int> := multiset{v0[safeIndex(126, v0.Length)]};
		var v122: map<int, int> := map[v0[safeIndex(126, v0.Length)] := |v121|];
		var v123: multiset<map<int, int>> := multiset{v122};
		v120 := v120[v34.f26 := |v123|];
		var v124: map<bool, bool> := map[!v1 := v34.f26];
		v124 := v124[v34.f26 := v2[safeIndex(v3, |v2|)]];
	...
	v34.f26 := safeDivisionInt(|map[false := v1]|, v0[safeIndex(126, v0.Length)]) != (v0[safeIndex(126, v0.Length)] - -|v127|);
	globalState.f19 := v0[safeIndex(126, v0.Length)];
	...
	v132 := DC13(v131);
	var v133 := new C0(v1);
	v0[safeIndex(126, v0.Length)], v2, globalState.f19, v2 := 0x368, v2 + v2, (v3 * 165) * v0[safeIndex(126, v0.Length)], [v1, v133.f26, v34.f26];
	if (v34.f26) {
		v34.f26 := v34.f26;
		var v134 := new C0(v34.f26);
		v0[safeIndex(126, v0.Length)] := safeModuloInt(v0[safeIndex(126, v0.Length)], v3);
		var v135: map<bool, bool> := map[v34.f26 := v134.f26];
		var v136, v137 := v134.m0(v1 <==> v2[safeIndex(v3, |v2|)], |v135|, globalState);
		v3 := v3;
	} else {
		...
		var v142: map<string, int> := map[v58[safeIndex(fm3(v3, v140.cf19, v3, globalState), |v58|) := v7] := |v141|];
		v142 := v142[v58 := v3 + v3];
		if (!v34.f26 <==> !v133.f26) {
			v0[safeIndex(126, v0.Length)] := -v3;
			globalState.f5 := v0;
			...
			v144 := v144;
			var v145, v146 := v34.m0(v34.f26, safeModuloInt(v3, v3), globalState);
		} else {
			v138 := v0[safeIndex(126, v0.Length)] > v0[safeIndex(126, v0.Length)];
			var v147 := DC6();
			v147 := v147;
			v133.f26 := v34.f26;
			var v148, v149 := v34.m0(v34.f26, v3, globalState);
			var v150: array<string> := new string[15](i7 => v58);
			v150[safeIndex(269, v150.Length)] := v58;
			v150[safeIndex(269, v150.Length)] := (if (v34.f26) then v58 else "faxxuf") + v58;
		}
		
	}
	
	forall i8 | 0 <= i8 < v9.Length {
		v9[i8] := {v0[safeIndex(126, v0.Length)] - v0[safeIndex(126, v0.Length)], |([[-379], seq(abs(-899), i9  => (0xd4))] + [[v0[safeIndex(126, v0.Length)], v3, v0[safeIndex(126, v0.Length)]]])|, 0x3a6, -v3};
	}
	v1 := !v34.f26;
	print v0[0], "\n";
	print v1, "\n";
	print v2 == [true, true, true], "\n";
	print v3, "\n";
	print v4 == {861}, "\n";
	print v5.cf0, "\n";
	print v6[0], "\n";
	...
	print v7, "\n";
	print v8 == map[861 := 'l'], "\n";
	print v9[0] == {0, 3, 934, -1}, "\n";
	print v9[1] == {0, 3, 934, -1}, "\n";
	print v9[2] == {0, 3, 934, -1}, "\n";
	print v9[3] == {0, 3, 934, -1}, "\n";
	print v9[4] == {0, 3, 934, -1}, "\n";
	print v10 == map[true := 'l'], "\n";
	print v11 == multiset{map[true := 'l'], map[true := 'l']}, "\n";
	print v12.cf1[0], "\n";
	print globalState.f0[0], "\n";
	print globalState.f1 == [false, true, false, true], "\n";
	print globalState.f2, "\n";
	print globalState.f3 == {861}, "\n";
	...
	print globalState.f6 == map[861 := 'l'], "\n";
	print globalState.f7, "\n";
	print globalState.f8, "\n";
	print globalState.f9[0] == {0, 3, 934, -1}, "\n";
	print globalState.f9[1] == {0, 3, 934, -1}, "\n";
	print globalState.f9[2] == {0, 3, 934, -1}, "\n";
	print globalState.f9[3] == {0, 3, 934, -1}, "\n";
	print globalState.f9[4] == {0, 3, 934, -1}, "\n";
	...
	print globalState.f20 == multiset{map[true := 'l'], map[true := 'l'], map[true := 'l'], map[true := 'l']}, "\n";
	...
	print v58, "\n";
	print |v127|, "\n";
	print v128 == multiset{true, true}, "\n";
	print v129 == map[10 := true, 1 := true], "\n";
	print v131.cf16[0], "\n";
	print v131.cf16[1], "\n";
	print v131.cf16[2], "\n";
	print v131.cf16[3], "\n";
	...
	print v131.cf16[11], "\n";
	print v131.cf17, "\n";
	print v132.cf18.cf16[0], "\n";
	print v132.cf18.cf16[1], "\n";
	print v132.cf18.cf16[2], "\n";
	print v132.cf18.cf16[3], "\n";
	print v132.cf18.cf16[4], "\n";
	print v132.cf18.cf16[5], "\n";
	print v132.cf18.cf16[6], "\n";
	print v132.cf18.cf16[7], "\n";
	print v132.cf18.cf16[8], "\n";
	print v132.cf18.cf16[9], "\n";
	print v132.cf18.cf16[10], "\n";
	print v132.cf18.cf16[11], "\n";
	print v132.cf18.cf17, "\n";
	print v133.f26, "\n";
}