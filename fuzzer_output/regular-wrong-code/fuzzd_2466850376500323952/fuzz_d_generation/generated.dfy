...
function fm7(p0: int, globalState: GlobalState): int {
	|[DC24(DC21(multiset{0xc6})), DC24(DC21(multiset{|(map v0 : string | v0 in (seq(155, i0  => ("crncpbwhy"))) :: (v0) := (0x113))|})), DC24(DC22(-556)), DC24(DC21(multiset{0xf5, |[map v1 : int | v1 in [|[754, -0x24e, 0x17e, |map[false := 't']|, |{|map[true := true]|}|]|] :: (v1 / -0xc7) := (false)]|}))]|
}
...
function fm9(globalState: GlobalState): seq<int> {
	if (!true || true) then [0x114] else (seq(0x8e, i0  => (|[false, false]|))) + (seq(571, i1  => (|map[true := |[44]|]|)))
}
...
function fm18(p0: bool, globalState: GlobalState): string {
	((seq(0x123, i0  => ('x'))) + "luposje") + ((seq(0x270, i1  => ('q'))) + "yiwbhd")
}
function fm19(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<string, int> {
	map["thuvag" := -0x128] + (map["njhdgt" := -|"sgehlao"|] + (map v0 : string | v0 in [seq(0x3de, i0  => ('a')), "em"] :: (v0) := (0x142)))
}
function fm20(p0: bool, p1: char, p2: int, p3: bool, globalState: GlobalState): map<int, bool> {
	match if (true) then DC23(true, -860, !true) else DC23(true, 663, true) {
		case DC22(cf36) => map[cf36 := true] + (map v0 : int | (0xb4 <= v0) && (v0 < 0x356) :: (v0 % cf36) := (false))
		case DC23(cf37, cf38, cf39) => (map v1 : int | v1 in map[cf38 := cf37] :: (v1 * cf38) := (cf37)) + map[cf38 := cf37]
		case DC21(cf35) => map v2 : int | v2 in (set v3 : int | v3 in cf35 :: (v3 - |multiset{true, true, true}|)) :: (v2 % |"udnqqbuso"|) := (!!false)
...
function fm23(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): set<int> {
	({|[|multiset{-|"xunsdlrj"|}|]|} * {-|"e"|}) + ((set v0 : int | v0 in {|map[|"pqwo"| := false]|} :: (v0 / |map[0x128 := |{0x114, |multiset([0x9d, |map[|"pvxtdfslh"| := |"mlkshnmc"|]|, 0x3c8, 0x294, 0x3ac])|}|]|)) + {723})
}
function fm24(p0: multiset<bool>, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<int> {
	([-|(seq(0x266, i0  => ('y')))|] + [0x2e7, 349, 0xe4, -0x6c]) + [|multiset{|"gw"|, -0x1e}|]
}
function fm25(p0: int, p1: int, globalState: GlobalState): set<D3> {
	(set v2 : D3 | v2 in map[DC10(map v0 : int | v0 in (map v1 : int | v1 in [-|map[0x43 := 98]|, 0x24b] :: (v1 / 0x37a) := (true)) :: (v0 % |map[true := {-|map['f' := false]|}]|) := (|[-|[false, true]|]|)) := |(seq(0x3e0, i0  => ('s')))|] :: (v2)) + {DC10(map[0x23f := 899])}
}
function fm26(p0: int, p1: map<char, D5>, p2: bool, p3: bool, globalState: GlobalState): set<seq<int>> {
	{[0x1d2, 0xcb], [0x6b, |"udohgqy"|], if (false) then [0x24f] else [|(seq(326, i0  => ('b')))|, |[true]|, DC23(false, 174, false).cf38, 0x3ae], [|(seq(0xef, i1  => (-0x205)))|, |{false}|], (seq(0x2ad, i2  => (0x357))) + [-|"mogyijfrl"|]}
}
function fm27(p0: int, globalState: GlobalState): map<bool, int> {
	map[false := 0x229] + (map[false := |(seq(0x2f3, i0  => ("sf")))|] + map[!true := -0x127])
}
function fm28(p0: bool, p1: bool, p2: bool, p3: map<bool, int>, globalState: GlobalState): map<int, int> {
	match DC17(map["eql" := -|multiset{true, true, false, true, !true}|]) {
		...
		case DC20(cf34) => map v2 : int | (-0x3cf <= v2) && (v2 < 332) :: (v2 / -0x3ce) := (-753)
	}
}
...
function fm30(globalState: GlobalState): string {
	(if (true) then seq(0x11f, i0  => ('r')) else "wuqb") + "nfp"
}
...
function fm40(p0: int, p1: int, p2: char, globalState: GlobalState): map<int, bool> {
	if (|multiset{--647, |(seq(0x1ba, i0  => ('d')))|, |map[-0x342 := false]|, 0x102}| > |[false]|) then map[337 := true] else map[-0x2fd := true]
}
...
function fm43(p0: char, p1: D0, p2: bool, p3: multiset<bool>, globalState: GlobalState): D11 {
	DC36(if (true) then seq(0x36c, i0  => (multiset{-360})) else [multiset{-909}])
}
...
function fm46(globalState: GlobalState): multiset<D6> {
	if (false && false) then multiset{DC22(-0x94)} else multiset{DC22(|"mko"|), DC22(|(seq(858, i0  => ('v')))|), DC22(|multiset{false, false, true}|), DC22(|"xh"|), DC22(0x3a8)}
}
function fm47(p0: char, p1: bool, globalState: GlobalState): map<bool, map<int, int>> {
	map[true := map[|[21, 456]| := |"aridp"|]] + map[false := map v0 : int | (329 <= v0) && (v0 < -0x286) :: (v0 / |map[false := !true]|) := (-0x64)]
}
function fm48(globalState: GlobalState): seq<seq<bool>> {
	[[true, false, true, false]] + [[DC7([DC6(--604).cf9, |DC61(map v0 : string | v0 in ["me", "uwx"] :: (v0) := (true)).cf93|], !false, !!!!false, |multiset{|{true, !false}|, -983, |map[!true := true]|, 480, |(map v1 : int | (-0x327 <= v1) && (v1 < 0x2c0) :: (v1 / 0x35d) := (|(seq(0x3, i0  => ('s')))|))|}|).cf11], [!false], [true], [!false], [true]]
}
...
function fm50(p0: int, globalState: GlobalState): multiset<seq<bool>> {
	multiset(match DC15(|[|multiset([|[0x1d9, |map[false := |map[true := -0xc5]|]|]|])|, |[false]|]|, 0x32) {
		...
		case DC15(cf26, cf27) => [[false], [false, DC51(DC23(false, cf27, true).cf39, !false).cf83], [false], [true, true], [false, true]] + (seq(565, i0  => ([false])))
...
function fm53(globalState: GlobalState): seq<string> {
	seq(0x36f, i0  => (seq(0x128, i1  => ('y'))))
}
function fm54(p0: D15, p1: int, p2: char, p3: int, globalState: GlobalState): seq<seq<int>> {
	(if (false) then seq(0xe, i0  => ([|"vslhotx"|])) else [[|"ctbyue"|], seq(554, i1  => (767))]) + (if (!false) then seq(754, i2  => ([-0x1fb])) else [[|"rvii"|], [-0x103, |[{|(seq(0x323, i3  => ('r')))|}]|], [|"rqnhvr"|]])
}
function fm55(p0: bool, p1: int, p2: char, globalState: GlobalState): set<string> {
	if ({0x3b8, 130, |map[true := false]|} >= (set v0 : int | (73 <= v0) && (v0 < 0x2bf) :: (v0 * 697))) then {"lnfrahgri", seq(-769, i0  => ('f')), "as", "jkaix", "ujnwkx"} else {seq(175, i1  => ('h')), seq(751, i2  => ('g'))}
}
function fm56(p0: int, globalState: GlobalState): D0 {
	DC1(-0x25d / -71, true, map[!false := map[-|"sg"| := -|"xxkfrh"|]], |[true, false]|, 'k')
}
trait T0 {
...
class C1 extends T0 {
	...
	function fm35(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): int {
		|(map['y' := f30] + ((map v0 : char | v0 in (seq(141, i0  => ('g'))) :: (v0) := (f30)) + (map v1 : char | v1 in ['m', 'n'] :: (v1) := (|map[|multiset([true, true, true, true])| := false]|))))|
	}
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
		...
		globalState.f0, globalState.f0, v0[722] := !p0, match v1 {
			case DC11(cf19, cf20) => cf20
			case DC10(cf18) => p0
		}, (if (p0) then f30 else v5.cf3) != |v6|;
		v0[722] := if (p0) then false else v0[722] && p0;
		var v7 := DC29(|"jn"| <= |v2|, f30 <= f30, v4);
		v7 := if (v0[722]) then DC29(p0, v0[722], v4) else v7;
		globalState.f16 := (f30 % f30) * f30;
		var v8: set<int> := {f30};
		...
		var v13 := "aipcn";
		var v14: map<seq<int>, char> := map[v12[|v13| := f30] := if (v0[722]) then v4 else 'y'];
		r2 := v14;
		var v15 := DC22(-f30);
	...
	method m6(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: int, r1: set<int>, r2: int, r3: int) {
		...
		v0 := v0[|v2| / |multiset(v3)| := p2 - fm35(0xdc, p2, false, -p0, globalState)];
		...
		var v6: set<seq<bool>> := {v3, [p1, !p1, !(if (v1 in v5) then v5[v1] else v1[191])], v3, v3};
		v6 := (v6 + v6) - (v6 + {v3, v3[fm0(v4, p3, seq(773, i0  => ({p0})), p1, globalState) := p1], v3});
		var v7: map<bool, int> := map[v1[191] := f30];
		v7 := DC30(v7).cf50;
		r0 := -0x1a9;
	...
	method m7(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: set<int>) {
		...
		var v5: seq<seq<int>> := [v4, v4 + (seq(0x388, i0  => (f30))), v4];
		v4 := v5[f30];
		var v6 := 'i';
			...
			decreases 100 - i1
		{
			...
			if (p0) {
				...
				globalState.f6 := f30;
				var v12 := DC7(v4[f30 := f30], p0, p0, 0x1b);
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			globalState.f6 := (|"pcye"| - -f30) % (f30 - f30);
			var v18: array<char> := new char[8];
			v18[792] := fm38(p0, f30, globalState);
			v18[792] := v6;
			var v19 := "whqyh";
			v19 := v19;
			...
			var v23: array<string> := new string[24] [v19, "mx", v19, if (p0) then v19 else v19, v19, v19, v19 + "foa", fm36(p0, v21, |v19|, f30, globalState), v19, v19, v19, ("k")[f30 := v18[792]], v19, v19, fm36(p0, v21, if (p0 in v22) then v22[p0] else f30, f30, globalState), v19, v19, if (p0) then "ohl" else v19, v19 + v19, v19, v19 + ("wdespalc")[-f30 := v18[792]], v19, "n" + (seq(0x1b1, i3  => (v6))), v19];
			v23[9] := v19;
			v23[9] := v19 + v19;
		}
		globalState.f16 := f30;
		...
		var v26 := "gewwn";
		r0 := fm37(v24, v25, v26[|v24| := v6], globalState) ==> !p0;
		r1 := f30;
		r2 := !p0;
		r3 := {|v26|, 0xa9} * {f30};
	}
...
class C2 extends T0 {
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
			...
			case DC11(cf19, cf20) =>
				...
				match (v7) {
					case DC13(cf22) =>
						...
						var v16: seq<seq<int>> := [v13, fm24(v14, 0x3b4, f29, v15[f29], globalState), v13];
						v12[685] := |v16|;
						var v17: array<bool> := new bool[3](i0 => false);
						v17[162] := !cf20;
						var v18 := DC10(map[f29 := f29]);
						var v20: set<D3> := {v18, v18, DC10(map v19 : int | (5 <= v19) && (v19 < 0x7c) :: (v19 % f29) := (f29))};
						...
						var v30 := DC25(v29);
						v12[685], cf19, v17[162], globalState.f6 := v13[f29] - (if (cf20 in v14) then v14[cf20] else f29), v20 >= fm25(f29, f29, globalState), (fm26(|v22.cf35|, v27, p0, cf19, globalState) - fm26(f29, v27, cf19, fm21(v28, f29, globalState), globalState)) !! v30.cf41, 0x35c;
						var v31 := DC3(v8);
						var v32: array<D1> := new D1[26] [if (p0) then v31 else v31, v31, DC3(v8), v31, v31, v31, v31, v31, DC3((seq(-0x24d, i1  => (v5)))[f29 := v5]), DC3(v1.fm17(v8, |"uwe"|, cf19, |fm27(|"gu"|, globalState)|, globalState)), v31, v31, v31, v31, v31, v31, v31.(cf6 := v8), v31, v31, v31, v31, v31, v31.(cf6 := v8), v31, v31, v31];
						v32[453] := v31;
						v32[453] := v31;
						var v33 := new C0();
					case DC14(cf23, cf24, cf25) =>
						v3 := v3[(seq(975, i2  => ('a'))) < cf25 := p0];
						var v34: map<int, bool> := map[f29 := (seq(0x307, i3  => (cf23))) <= "xeuvryom"];
						...
						var v39: array<int> := new int[7] [|((seq(991, i4  => (cf23))) + cf25)|, fm0(v36, f29, v38, p0, globalState) % -f29, f29, -0x20f, if (cf20) then f29 else f29, |v36|, f29];
						var v40: map<bool, int> := map[cf20 := f29];
						v39[638] := if (cf19 in v40) then v40[cf19] else |multiset((seq(0x3b9, i5  => (cf25)))[f29 := cf25])|;
						globalState.f11, globalState.f10, globalState.f10, v39[638], cf24 := f29 / -f29, cf20, cf19 ==> p0, f29, cf24;
					...
					case DC15(cf26, cf27) =>
						...
						globalState.f6 := cf26 / (cf26 % cf26);
						var v48: multiset<int> := multiset{cf26};
						var v49: array<bool> := new bool[22];
						var v50: map<bool, int> := map[cf19 := f29];
						var v51 := DC14(v5, v49, (v1.fm17(seq(0x381, i6  => (v5)), 496, cf20, cf26, globalState))[|v50| := v5]);
						var v52 := DC16(v51);
						var v53: map<bool, D4> := map[false := v52];
						var v55: set<int> := {0x7c};
						globalState.f11 := fm0(v48, |v53|, (seq(0x240, i7  => (set v54 : int | (0x2e6 <= v54) && (v54 < -0x94) :: (v54 % cf26)))) + [v55, v55], p0, globalState);
					case DC12(cf21) =>
						globalState.f10 := cf19;
						var v56: map<string, int> := map[seq(960, i8  => ('d')) := f29];
						var v57 := "delahctx";
						...
						v62[249] := v64;
						var v65: set<D0> := {v6};
						var v66: map<string, bool> := map[v57 := v60[296]];
						var v67: set<int> := {|v66|};
						var v68: map<bool, int> := map[p0 := f29];
						var v69: seq<bool> := [p0, true];
						v62[249], globalState.f0, cf19 := DC10(fm28(cf20, cf19, !fm21(v65, |v67|, globalState), v68, globalState)), p0, !v69[f29];
					case DC16(cf28) =>
				...
				var v75: seq<bool> := [p0];
				var v76: map<array<array<T0>>, bool> := map[v74 := !(p0 <== v75[f29])];
				v76 := v76[v74 := p0];
				var v77: array<bool> := new bool[26];
				v77[762] := if (p0) then cf20 else false;
				var v78 := "xljlu";
				globalState.f11, v77[762] := |v78|, cf19;
			case DC10(cf18) =>
				var v79 := DC6(f29);
				var v80 := DC9(v79);
				var v81 := 'j';
				...
				var v85: map<D2, multiset<array<D2>>> := map[v80 := if (v81 in v84) then v84[v81] else v83[v82 := f29]];
				var v86: seq<multiset<array<D2>>> := [v83];
				v85 := v85[v80 := v86[f29] * v83];
				var v87: map<int, bool> := map[f29 := p0];
				var v88: seq<bool> := [if (f29 in v87) then v87[f29] else p0];
				var v89 := "lklrnmhq";
				var v90: array<bool> := new bool[14] [p0, v88[|multiset{|v89|}|], !p0, true, p0, v88[f29], p0, p0, true, p0, p0, p0, p0, p0];
				var v91: array<array<bool>> := new array<bool>[6] [v90, v90, v90, if (p0) then v90 else v90, v90, v90];
				v91[37] := v90;
				v91[37] := new bool[14](i10 => p0);
				var v92: multiset<bool> := multiset{p0};
				var v93, v94, v95, v96 := m5(-f29, -((if (|v92| in cf18) then cf18[|v92|] else |multiset{p0}|) % f29), globalState);
		...
		v100 := new array<bool>[7] [v101, v101, v101, v101, f22[f29], v101, v101];
		r3 := (f29 / |fm29(p0, 0x115, p0, f29, globalState)|) - 0x27e;
		for i12 := if (p0) then f29 else f29 to 0x184 {
			...
			var v111: set<int> := {0xc, i12, v107[|v107|]};
		...
		if (v121 <= v121) {
			...
			var v127: map<bool, array<int>> := map[(set v126 : int | (-0x10a <= v126) && (v126 < 398) :: (v126 % -f29)) in {{f29}} := v125];
			...
			if (p0 ==> p0) {
				...
				var v135 := DC22(f29);
				v125[720], globalState.f11, v101[569], v125[748] := |v134|, (fm31(false, globalState)).cf27, p0, (if (p0) then v135 else v135).cf36;
				...
				v141[303] := v138;
				v141[303] := (v138 + [v137, v137, v137, v137, v137]) + [v137, v137, v137, v137, if (p0 in v127) then v127[p0] else v137];
			} else {
				globalState.f8 := f29;
				...
				v142[662] := v147[if (p0 in v123) then v123[p0] else -113];
				var v148 := DC6(f29);
				var v149: map<int, int> := map[f29 * -50 := v148.cf9 * f29];
				v149 := v149[f29 % |v122| := f29];
				v101[152] := p0;
				var v150: multiset<int> := multiset{f29, f29};
				var v151: seq<set<int>> := [{|v122|}];
				v101[152] := (|v122| >= fm0(v150, |v122|, v151[f29 := {|fm33(globalState)|}], !p0, globalState)) <==> true;
			...
			v155[779] := if (p0 in v158) then v158[p0] else -((if (f29 in v159) then v159[f29] else |v161|) / f29);
			var v162: map<map<bool, seq<int>>, seq<int>> := map[map[p0 := v161[v155[779] := v155[779]]] := v161];
			var v163: multiset<bool> := multiset{false};
			var v164: seq<seq<int>> := [fm24(v163, v155[779], |[v155[779]]|, p0, globalState), v161, [f29], v161, v161];
			var v165: map<bool, seq<int>> := map[p0 := v164[v155[779]]];
			var v166: map<int, map<bool, seq<int>>> := map[f29 := v165];
			v161 := if (((if (f29 in v166) then v166[f29] else v165) + v165) in v162) then v162[(if (f29 in v166) then v166[f29] else v165) + v165] else v161 + (seq(244, i13  => (f29)));
			var v167: array<D3> := new D3[7](i14 => DC10(v159));
			var v168 := DC10(v159);
			v167[730] := v168;
			var v170: multiset<int> := multiset{|v156|};
			v167[730] := DC10(v159 + (map v169 : int | v169 in v170 :: (v169 / v155[779]) := (f29)));
			var v171 := 's';
			var v172: map<bool, string> := map[p0 := seq(-994, i15  => (v171))];
			var v173: array<string> := new string[6] [v156[|v156| := v171], v156, if (p0 in v172) then v172[p0] else v156, v156, v156, v156 + "jwtvlaj"];
			v173[639] := v156;
			var v174: map<bool, map<int, int>> := map[p0 := v159];
			var v175: map<int, bool> := map[f29 := p0];
			var v176 := DC1(v155[779], p0, v174, |v175|, v171);
			var v177 := DC13(v176);
			var v178 := DC16(v177);
			var v179: map<bool, bool> := map[true := p0];
			var v180: map<D4, bool> := map[v178 := if (false in v179) then v179[false] else p0];
			var v181 := DC33(v180);
			v173[639] := (fm30(globalState))[-|v181.cf54| := v171];
			r3 := (|{v155}| - f29) + -(f29 - f29);
		}
		...
		match (v187) {
			case DC31(cf51, cf52) =>
				...
				var v201 := DC29(p0, if (v121 in v200) then v200[v121] else p0, v183[f29]);
				v201 := v201;
				v194 := v194;
			case DC30(cf50) =>
				r0 := p0;
				...
				v101[80] := (if (v202 in v208) then v208[v202] else v207) != fm39(f29, v209, globalState);
				v183, globalState.f11, v121, v101[80], v183 := seq(961, i16  => (if (p0) then 't' else 'l')), |(multiset{737, 0x2d2, f29, |['b']|})[v202 := -0x27f]|, v121, !v204, v183;
				if (fm37(v209, v182, v183, globalState)) {
					v101[80] := p0;
					var v210: set<int> := {-0x204, f29};
					var v212: seq<int> := [|v183|];
					var v213: array<set<int>> := new set<int>[22] [v210, v210 - {|v183|}, v210, v210, {f29, v205, 60, |v183|, v202}, v210, {v202}, set v211 : int | (-0x38b <= v211) && (v211 < -883) :: (v211 * |v121|), v210 - v210, {v205} + v210, v210, v210 - v210, v210, fm23(v202, v202, p0, v101[80], globalState), v210, v210 - v210, v210, v210, fm23(|v210|, v212[f29], true, v204, globalState) * v210, v210, v210, v210];
					...
					var v217 := DC20(v216);
					var v218 := 'h';
					var v219 := DC34(v218, v101[80], v204, p0, false);
					v213, globalState.f6, v217, v101[80] := v213, v205 % v202, v217, v219.cf57;
					v101[80] := "f" != v183;
					var v220: map<bool, bool> := map[v204 := v101[80]];
					globalState.f10 := v202 < |v220|;
					globalState.f8 := (|v212| % v202) % (if (p0 in cf50) then cf50[p0] else f29);
				} else {
					v183 := v183;
					v203 := v204;
					globalState.f0 := true ==> v101[80];
					var v221 := new C0();
			...
			case DC32(cf53) =>
				...
				globalState.f6, v230, globalState.f0, v231, globalState.f10 := |((v233.cf62 + v232) + v232)|, v230[v101 := v229[f29 := f29]], p0, fm22(p0, v234[f29], 0x29b, -(f29 / |[p0, p0]|), globalState), p0 <== !p0;
		}
		...
		r3 := f29 / v235.fm0(v242, |v243|, v245, p0, globalState);
	}
	method m5(p0: int, p1: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: int) {
		...
		if (v0) {
			...
			var v14: seq<seq<bool>> := [v13, ([v0, v0, v0, v0, v0])[p1 := v0], v13, v13];
			var v15: map<multiset<int>, bool> := map[v3 := v0];
			var v16: array<int> := new int[20] [|(map v12 : int | v12 in v4 :: (v12 * p0) := (v11[f29]))|, 0x113 + p0, |(v14 + [v13])|, if (v0 in v1) then v1[v0] else |v1|, p1 + p1, |"wudmpyivk"| + -|(seq(0x10d, i0  => ('g')))|, p1, p1, p0, if (v0) then p1 else p0, f29, |v3|, p0, p1, 0x3d7, p1, p1, |v15|, f29, 0x64 - p1];
			v16[898] := f29;
			v16[898] := |(seq(0x15e, i1  => (if (!v0) then v11[0x155] else 'h')))|;
			var v17: T0 := new C1(v16[898], f22);
			...
			var v21: map<int, int> := map[p0 := |v4| % |v20|];
			v8[591] := v0;
			var v23: map<int, bool> := map[|v3| := v0];
			globalState.f6, v21, r1, v8[591] := 0x1f3, map v22 : int | (-0xf4 <= v22) && (v22 < -0xd2) :: (v22 % f29) := (|v21|), if (v0) then v20[0x339] else |v4| > |v20|, if (f29 in v23) then v23[f29] else !v0;
			globalState.f16 := 614;
			if (f29 in (if (!false) then fm40(f29, p0, v11[p0], globalState) else v23)) {
				globalState.f0 := v0;
				var v24: multiset<seq<int>> := multiset{v6, [f29]};
				var v25: set<bool> := {v8[591], v0};
			...
			var v36 := DC41(v35);
			var v37 := new C1(if (v8[591]) then fm0(v3, |v36.cf68|, v5, false, globalState) else p1, f22);
			v0 := if ((p0 - f29) in v23) then v23[p0 - f29] else v8[591];
		}
			...
			decreases 100 - i5
		{
			...
			var v40: set<D12> := {v38, v38, if (v39[|v11|]) then v38 else DC42(|"agnqcr"|)};
			v40 := v40;
			globalState.f0 := !(if (v0) then v0 else v0) <== v39[p1];
			var v41: map<string, int> := map[seq(0x2dc, i6  => ('m')) := p0];
			var v42 := DC17(v41 + v41);
			v8[313] := v0;
			var v43: map<int, bool> := map[p1 := v0];
			var v44: map<int, bool> := map[|v43| := v0];
			v42, globalState.f10, v6, v8[313] := fm42(globalState), fm37([v0], v44, v11, globalState) <== (-p1 < p1), v6 + [0x2b8], !v0;
			globalState.f11 := -412 - 0x26d;
		}
		var v45: seq<bool> := [v0];
		globalState.f5 := (v45[f29 := v0] + v45) + v45;
		var v46 := 'c';
		var v47: map<int, char> := map[f29 := v46];
		r0 := v6[p1] * (|v47| - p0);
		r1 := v0;
		r2 := (v1 * v1) in (seq(0x1f3, i7  => (v1)));
...
class C3 extends T0 {
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
		...
		globalState.f10 := v4[fm0((multiset{v0})[v0 := v0], v0, v6, p0, globalState)];
		var i0 := 0;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v10: map<int, seq<bool>> := map[v2[v0] := v4];
			globalState.f11 := |(map[v0 := v4] + (map[0x41 := v4] + v10))|;
			var v11 := 's';
			var v12 := DC14(v11, f22[v0], v1);
			var v13 := DC16(v12);
			var v14 := DC16(v12);
			v14 := v14;
			globalState.f10 := p0;
			if ((if (p0) then p0 else p0) && v4[0x78]) {
				v1 := "hdmeaxjx";
				r3 := 284;
				...
				r0 := p0 in (v4 + v4);
				var v19 := new C0();
				var v20: array<int> := new int[26](i2 => i2 / 0x90);
				var v21: array<bool> := new bool[6];
				var v22: map<bool, bool> := map[p0 := p0];
				v21[541] := if (p0 in v22) then v22[p0] else false;
				...
				v20, v21[541], v23[873] := if ((v0 % |v2|) in v26) then v26[v0 % |v2|] else v20, if (map[v0 := v0] in v28) then v28[map[v0 := v0]] else p0, v24;
				var v29: multiset<bool> := multiset{p0, p0};
				var v30: seq<multiset<bool>> := [v29];
				var v31 := DC14(v11, v21, ((seq(0x2e0, i3  => (v11)))[v0 := v11])[688 := v11]);
				var v32: map<D4, int> := map[v31 := -v0];
				v21[541] := (if (!fm15(p0, globalState)) then multiset{p0, v21[541], v21[541]} else v29) !! v30[|v32|];
				var v33: map<C0, bool> := map[v19 := v21[541]];
				v33 := v33 + v33;
			}
		...
		if ((if (p0) then DC8(v34, v35, p0) else v36).cf16) {
			...
			v35[440], v37, globalState.f0, globalState.f11 := v0, if (p0) then v37 else v37, v35[440] <= |v38|, v0;
			var v39 := DC6(v0 % v0);
			v39 := v39;
			if (v4[|v2|]) {
				globalState.f10, v1, globalState.f10, r0 := -v0 !in v5, fm18(p0, globalState), fm15(-v35[440] > v0, globalState), p0;
				globalState.f16 := -(v0 - v35[440]);
				var v40: array<char> := new char[15] [v37, 'e', v37, v37, v37, v37, if (true) then v37 else v37, if (p0) then v37 else v37, v37, v1[v0], v37, v37, v37, 'g', v37];
				v40[455] := v37;
				v40[455] := v37;
				...
				v37 := 'l';
				v35[440] := |fm18(p0, globalState)|;
				var v43: map<string, int> := map[v1 := v35[440]];
				var v45: set<string> := {v1};
				var v46 := DC17(v43);
				var v47: array<map<string, int>> := new map<string, int>[20] [v43, v43, map[v1 := v0], v43, map[("ucufv")[v35[440] := v37] := v0], v43, if (v4[v0]) then (map v44 : string | v44 in v45 :: (v44) := (v35[440]))[v1 := |v2|] else v43, fm19(p0, v0, v35[440], true, globalState), v43, v43, v43, v43, v43 + map[v1 := |v4|], v43, v43, map[v1 := v0], v43, v43, v46.cf29, if (p0) then v43 else map[v1 := v0]];
				v47[885] := v43;
				var v48: multiset<bool> := multiset{p0, false};
				var v50: map<bool, map<int, int>> := map[p0 := map v49 : int | (0x2dd <= v49) && (v49 < -844) :: (v49 * v2[v0]) := (859)];
				var v51 := DC1(v35[440], p0, v50, v0, v37);
				v47[885], v35[440], r3 := fm19(v35[440] > (if (p0 in v48) then v48[p0] else v35[440]), v0 * v0, 829, v51.cf1, globalState), v35[440] / (0x22d / v35[440]), -0xe6;
				var v52: array<map<array<int>, bool>> := new map<array<int>, bool>[8];
				var v53: array<int> := new int[9] [v35[440], v35[440], v0, |fm20(p0, v37, v0, p0, globalState)|, v0, v0, v0, v35[440], v35[440]];
				var v54: map<array<int>, bool> := map[v53 := p0];
				v52[183] := v54;
				var v55: C0 := new C0();
				v52[183], v55 := v54, v55;
				var v56: map<bool, bool> := map[p0 := p0];
				globalState.f0 := v4[-(|v56| / -v0)];
			}
			
			v35[440], globalState.f0 := v0, p0;
		} else {
			...
			r0, v57[873] := v58 > {v59}, fm15(p0, globalState) <== (v0 in v5);
			var v60 := new C0();
			var v61 := DC9(DC6(v0));
			var v62 := DC9(v61);
			var v63: set<D2> := {v62};
		...
		match (v75) {
			case DC13(cf22) =>
				if (p0) {
					globalState.f0 := v4[|v9|];
					var v76: array<seq<int>> := new seq<int>[16](i5 => v2);
					v76[192] := v2;
					v35[326] := v0;
					v76[192], v35[326] := ((seq(0x3c, i6  => (-v0))) + (v2 + v2))[-v0 := v0], v0 + (v0 - v0);
					var v77, v78 := m4(globalState);
					globalState.f5 := ([false, p0] + v4) + v4;
					v74[974] := !!(v35[326] < v0);
					v74[974] := fm15(true, globalState);
				} else {
				...
				v35[749] := fm0(v81, -|v82|, [set v83 : int | (623 <= v83) && (v83 < 0x16e) :: (v83 / v0)], p0, globalState);
				...
				if (p0) {
					...
					var v89: map<bool, set<seq<T0>>> := map[v4[fm0(multiset{v35[749], v0, v0}, v35[749], v6, p0, globalState)] := v88];
					globalState.f11, r3 := |(v88 - (if (p0 in v89) then v89[p0] else {([v86])[|map[v35[749] := v35[749]]| := v86]}))| + (v0 * v35[749]), v0 / v0;
					var v90: multiset<bool> := multiset{p0};
					var v91: map<int, bool> := map[v35[749] := p0];
					var v92: map<int, int> := map[if (p0) then v35[749] else if ((if (v0 in v91) then v91[v0] else p0) in v90) then v90[if (v0 in v91) then v91[v0] else p0] else v0 := v35[749] / v35[749]];
					...
					var v98: map<int, bool> := map[v35[749] := p0];
					var v100: map<bool, map<int, bool>> := map[p0 := (map v97 : int | v97 in v98 :: (v97 / v35[749]) := (false)) + (map v99 : int | v99 in v98 :: (v99 - v0) := (p0))[v0 := true]];
					v35[749] := |(if (!(true && p0) in v100) then v100[!(true && p0)] else v98 + v98)|;
					v98 := (v98 + v98) + v98;
					var v101: array<string> := new string[20](i7 => v1 + v95.cf5);
					v101[386] := v1;
					var v102 := DC42(v0);
					var v103: map<bool, char> := map[p0 := 'f'];
					globalState.f0, globalState.f11, v1, v101[386], globalState.f10 := p0, -v102.cf69, v1 + v1, v1[-v0 := if (p0 in v103) then v103[p0] else v73], p0;
			...
			case DC14(cf23, cf24, cf25) =>
				...
				if (!(v0 <= (v0 / v107))) {
					...
					v115 := v115.(cf53 := v113);
					r0 := false;
					var v116: seq<multiset<int>> := [fm29(p0, |(seq(0xdc, i8  => (v73)))|, p0, v0, globalState)];
					var v117 := DC36(v116);
					v74[250] := p0;
					...
					var v121: map<int, int> := map[|(seq(-940, i9  => ('e')))| := |v120|];
					var v122: map<bool, map<int, int>> := map[p0 := v121];
					globalState.f6, v117, v74[250] := fm0(if (p0 in v119) then v119[p0] else v118, |multiset{!p0, p0, p0}|, [{v107}, {v0, v107}], v4[v0], globalState), fm43('v', DC1(v0, p0, v122, v0, cf23), p0, (multiset{p0})[p0 := v107], globalState), p0;
				} else {
					...
					var v126: array<seq<array<bool>>> := new seq<array<bool>>[8] [[v123.cf52], f22, f22, [cf24], f22, f22, f22 + f22, f22[|v125| := cf24] + f22];
					v126[20] := [v106];
					v126[20] := f22;
					var v127 := new C1(-v0, f22 + v126[20]);
			...
			case DC12(cf21) =>
				...
				match (v131.(cf42 := v2)) {
					...
					case DC25(cf41) =>
						...
						var v133 := DC31(v0 / v0, v74);
						v133 := v133;
						globalState.f11 := v0;
						globalState.f6 := -|v9| % (v0 % v0);
					case DC27(cf45) =>
						v74[99] := p0;
						var v134: multiset<array<bool>> := multiset{v74, v74};
						v74[99] := !((v134 * v134) <= (v134 + v134));
						globalState.f11 := v0;
						var v135: C2 := new C2(v0, f22);
						var v136: map<int, int> := map[v135.f29 := v0];
						var v137 := DC1(v135.f29, v74[99], map[!v74[99] := v136], v0, v73);
						var v138: set<D0> := {v137};
						globalState.f11, globalState.f10, v135, v74[99], globalState.f10 := |([v73, v73] + v1)[v0 := v73]| + v0, v4[v135.f29], v135, v135.fm21(v138, v0, globalState), p0;
						v74[99] := p0;
				}
			...
			case DC16(cf28) =>
				...
				var v152 := DC41(v151);
				v149[646] := v152;
				v35[80], v149[646], globalState.f0, globalState.f0, v35[80] := v35[80], v152, p0, p0, fm0(v148 * v148, |(v1 + v1)|, v6, p0, globalState);
		}
		...
		r2 := match v154 {
			case DC18(cf30, cf31) => map[v2 := v73] + (map[v2 := v73])[seq(0x225, i11  => (v0)) := 't']
			case DC19(cf32, cf33) => if (p0) then map[seq(0x353, i12  => (|"k"|)) := v73] else map[v2 := v73]
			case DC17(cf29) => map[v2 := v73] + map[v2 := v73]
			case DC20(cf34) => (map[v2 := v73])[v2 := v73] + map[v2[v0 := v0] := v73]
		};
		r3 := v0;
	}
	method m4(globalState: GlobalState) returns (r0: array<bool>, r1: int) {
		...
		var v12: array<int> := new int[12] [|(multiset{v3} * v4)|, |v6|, if (v0 in v7) then v7[v0] else |v8|, if (!v0) then |v8| else v2, fm0(v3, |v5|, v9, v0, globalState), fm0(multiset{|v8|}, -0x2a1, v9, false, globalState), v2 % v2, |(if (v0) then v11 else v11)|, v2 % v2, |v5|, v2, v2];
		v12[67] := v2 * v2;
		...
		v1, v12[67], v10[85], globalState.f0, v0 := {if (v15 in v14) then v14[v15] else v0}, 0x3cb, (v2 <= |{v17, v17.(cf47 := v0), v17}|) in v8, v5 == fm18(v0, globalState), fm37(v18.cf71, v19 + fm40(v2, -v2, fm38(true, v2, globalState), globalState), v5, globalState);
		var v20: multiset<D8> := multiset{v17};
		var v21 := DC36([v3]);
		var v22: seq<int> := [v12[67]];
		var v23 := DC7(v22, v10[85], v10[85], v2);
		v10[85], v2, v16, v20 := !match v21 {
			case DC37(cf63) => true || v0
			case DC38(cf64, cf65) => if (v10[85]) then v0 else v10[85]
			case DC39(cf66) => v0
			case DC36(cf62) => false ==> v10[85]
			case DC40(cf67) => v10[85]
		}, v12[67], fm22(v2 < v23.cf13, v10[85], v2, v2, globalState), v20;
		var v24 := DC31(0x26a, v10);
		var v25 := DC32(v24);
		match (v25) {
			case DC31(cf51, cf52) =>
				globalState.f0, globalState.f0, r1 := !v0, v10[85], 0x345;
				v10[85] := v10[85];
				var v26: map<map<bool, int>, bool> := map[v7 := v0];
				v26 := v26[v7 := v0];
				var v27: map<string, bool> := map["y" := v10[85]];
				if (if (v5 in v27) then v27[v5] else if (v10[85]) then !!v10[85] else v0) {
					v8 := v8;
					var v28: map<int, int> := map[v12[67] := v12[67]];
					var v29 := DC19(v28, v0);
					var v30: seq<D5> := [v29, v29, v29];
					var v31: map<set<bool>, seq<D5>> := map[{v0, v10[85]} := v30];
					v12, r0, v0, v31 := v12, v10, v10[85] || v0, map[v1 := v30] + v31;
					v10[85] := v0;
					var v32: array<string> := new string[18];
					var v33: map<bool, string> := map[v0 := v5];
					v32[153] := if (v0 in v33) then v33[v0] else v5;
					v32[153] := (v5 + v5) + v5[v2 := v16];
					v32[153] := fm18(v0, globalState);
				} else {
					globalState.f0 := v0 || true;
					globalState.f10 := v0;
					var v34: map<seq<int>, int> := map[v22 := cf51];
					var v35: map<bool, map<int, bool>> := map[v0 := v19];
					var v36: map<string, int> := map[v5 := v12[67]];
					v0, v10[85], v12[67] := (map[v22 := |v5[v12[67] := 'b']|] == v34) in v35, v0, (if ((seq(0x284, i1  => (v16))) in v36) then v36[seq(0x284, i1  => (v16))] else -v2) % (if (v0) then cf51 else cf51);
					var v37 := DC3(v5);
					var v38 := DC8(v37, v12, v10[85]);
					var v39: seq<array<int>> := [v12, v12, v12, v12];
					var v40: array<array<int>> := new array<int>[20] [v12, v12, v12, v12, v12, v12, v12, v38.cf15, v12, v12, v12, v12, v12, v12, v39[v12[67]], v12, v12, v12, v12, v12];
					v40[903] := v38.cf15;
					var v41: array<map<int, array<int>>> := new map<int, array<int>>[15];
					var v42: map<int, array<int>> := map[-cf51 := v12];
					v41[588] := v42;
					var v43: map<bool, map<int, array<int>>> := map[v0 := map[cf51 := v39[cf51]]];
					var v44: map<bool, bool> := map[v0 := v8[cf51]];
					v40[903], globalState.f0, v41[588], cf51 := v12, v0, v42 + ((if (v10[85] in v43) then v43[v10[85]] else map[cf51 := v12]) + v42), --((cf51 / 47) / |v44|);
					globalState.f8 := v12[67];
				}
			...
			case DC32(cf53) =>
				v2 := v2;
				globalState.f16, v10[85] := |v6| - |v22|, v0;
				globalState.f10, v12[67] := v0, v12[67] * v12[67];
				v5 := "ia";
		}
		
		var v48: map<int, int> := map[v2 * v2 := v12[67] % v2];
		v48 := map[v2 := v12[67]];
		if (v2 >= (v12[67] + -0x220)) {
			...
			match (v50) {
				case DC37(cf63) =>
					globalState.f0, globalState.f0, globalState.f6, globalState.f6, globalState.f11 := v10[85], v0, 212 * v2, if (fm0(v3, 0x1d3, seq(-0x347, i2  => (v6)), !v0, globalState) in v3) then v3[fm0(v3, 0x1d3, seq(-0x347, i2  => (v6)), !v0, globalState)] else 0x2ee, v2 - v12[67];
					r1, v10[85], globalState.f16 := v2, v12[67] == v2, v12[67] * v12[67];
					v10[85] := fm37(v8, v19[v2 := v0], v5, globalState);
					globalState.f10, v12[67], v12[67] := v10[85], v2, v12[67];
				case DC38(cf64, cf65) =>
					v19 := map v51 : int | v51 in [0x39d, cf65] :: (v51 + v12[67]) := (v10[85]);
					v10[85] := v0;
					v11 := v11[v10[85] := v10];
					globalState.f10, globalState.f11, v12[67], globalState.f6 := v2 > cf64, cf65, if (cf64 in v48) then v48[cf64] else v12[67] - cf64, v12[67];
				case DC39(cf66) =>
					var v52: map<bool, bool> := map[cf66 := v0];
					var v53: seq<seq<bool>> := [v8];
					var v54: map<map<bool, bool>, bool> := map[v52 := [v8] != v53];
					var v55: seq<D6> := [DC24(DC21(multiset{v12[67], |v8|, v12[67]}))];
					var v56: T0 := new C2(|v5|, f22);
					var v57 := DC23(cf66, |map[0x23 := v56]|, v0);
					var v58 := DC24(v57);
					globalState.f0, globalState.f8, v22, v54, v5 := v55 == (v55 + v55)[v12[67] := v58], if (if (v2 in v19) then v19[v2] else v8[v2]) then v12[67] else v2, v22, map v59 : map<bool, bool> | v59 in v54 :: (v59) := (v0), v5;
					v52 := v52[v10[85] := v10[85] <== v10[85]];
					var v60: array<multiset<int>> := new multiset<int>[28];
					var v61: seq<array<multiset<int>>> := [v60, v60, v60];
					v60 := v61[v2 / v12[67]];
					var v62 := DC18(v2, v12[67]);
					var v63: seq<seq<D5>> := [[v62, v62, v62]];
					globalState.f0 := !(v63 <= v63);
				case DC36(cf62) =>
					r1 := if (v0) then -v2 else fm0(multiset{v12[67], v2}, -|[v0, false]|, seq(-26, i3  => (v6)), v0, globalState);
				...
				case DC40(cf67) =>
					...
					globalState.f0 := v0;
					v12[67] := 0x19b;
					v10[85], globalState.f16, v1, v22, globalState.f0 := v10[85], v2, if (v10[85]) then v1 else if (v0) then {v10[85], v10[85]} else v1, [if (v0) then v12[67] else v2, v12[67]], v8[-182];
			}
			
			if (v12[67] >= v2) {
				globalState.f11 := v2 - (v12[67] + fm0(v3, |v8|, v9, fm15(v0, globalState), globalState));
				var v64 := new C2(-v12[67], f22 + [v10]);
				v5 := v5;
				var v65: array<char> := new char[26];
				v65 := v65;
				var v66 := new C2(|(seq(543, i4  => (v16)))| / v12[67], f22);
			} else {
				v5 := v5;
				globalState.f11 := v2;
				globalState.f16 := -93;
			...
			if (if (v12[67] < |v5|) then v2 > v12[67] else v10[85]) {
				globalState.f6 := v12[67];
				v12[67] := v12[67];
				v12[67] := fm0(v3, v2, v9, true, globalState) / 0x1ff;
				var v68: array<char> := new char[21](i5 => v16);
				var v69: multiset<array<char>> := multiset{v68, v68};
				globalState.f10, globalState.f0, globalState.f8, globalState.f10 := v0, v0, -v12[67], (if (v10[85]) then v69 else (v69[v68 := 0x3de])[v68 := v12[67]]) !! v69[v68 := v12[67]];
				v19 := v19[|v3| := v0];
			} else {
				var v70 := DC6(v2);
				var v71: map<bool, multiset<int>> := map[v10[85] := multiset{v12[67], 0x3a0}];
				var v72: map<multiset<bool>, bool> := map[v13[v10[85] := fm0(if (v0 in v71) then v71[v0] else multiset(v22), v2, seq(0x332, i6  => (v6)), v10[85], globalState)] := true];
				globalState.f11, globalState.f16, globalState.f11, globalState.f6, v70 := 0x82, v12[67], |v72|, v12[67], fm45(v10[85], v12[67], globalState).(cf9 := |v22|);
			...
			match (v76) {
				...
				case DC19(cf32, cf33) =>
					...
					v2 := |(v5 + v5)| - v12[67];
				case DC17(cf29) =>
					globalState.f0 := v10[85];
					v0 := false;
					globalState.f0 := v0;
					var v80: set<string> := {"xbtvyab"};
					v10[85] := v80 > v80;
				case DC20(cf34) =>
					globalState.f11 := -v12[67];
					var v81 := DC34(v16, v0, v0, false, v0);
					var v82: map<string, bool> := map[seq(164, i7  => (v16)) := v81.cf56];
					globalState.f6 := |v82| % v12[67];
					v5 := ((seq(0x36e, i8  => (v16)))[v12[67] + v12[67] := v16])[v12[67] := v16];
					v12, v10[85] := v12, v0 <== !v10[85];
			}
			
			var v83: map<int, map<bool, int>> := map[|v8| := v7];
			globalState.f8 := |(v83[|v5| := v7] + v83)|;
			var v84 := DC23(!v10[85], v12[67], v10[85]);
			v84 := v84;
			var v85: seq<array<int>> := [v12, v12];
			var v86 := DC28(v85 + [v12]);
			globalState.f16, globalState.f16, v86, v12[67] := v12[67], v12[67], v86, v12[67] * v12[67];
		}
		
		var i9 := 0;
		while (fm37(v8, v19, (seq(0x3c4, i10  => ('q')))[0xa8 := v16], globalState))
			decreases 100 - i9
		{
			if (i9 >= 100) {
				break;
			...
			v87 := v87;
			globalState.f0 := true;
			globalState.f10 := v10[85];
			var v88: map<bool, bool> := map[v0 := v10[85]];
			var v89 := DC42(v2);
			v88 := map[v0 := v12[67] > fm0(multiset{v89.cf69}, v12[67], v9, v10[85], globalState)];
		}
		r0 := v10;
		r1 := (v12[67] - 0x41) - |"nlauvedc"|;
	}
}
...
class C4 extends T0 {
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
		...
		globalState.f5 := (v0 + v0[v1 := fm13(seq(0xaa, i0  => (v1)), p0, |v2|, globalState)]) + (if (f28) then v0 else [f28]);
...
class C5 {
	...
	method m2(p0: int, p1: string, p2: int, globalState: GlobalState) {
		...
		match (v0) {
			case DC0() =>
				...
				if (fm5(!(v1 <== true), globalState)) {
					...
					globalState.f0, v4, globalState.f8 := v3[p0] || v1, map[v2 := v3] + v4, p2;
					...
					var v11 := DC1(-(|(seq(0x1f0, i0  => (v2)))| / p2), if (v1) then v1 else v1, v9 + v9, |v10|, v2);
					var v12: array<array<array<bool>>> := new array<array<bool>>[6];
					var v13: array<array<bool>> := new array<bool>[7];
					v12[814] := v13;
					globalState.f10, v7[141], v11, v12[814] := (p0 / |"e"|) != p2, v6, v11.(cf2 := map[v1 := v8], cf0 := p0, cf3 := if (v1) then p2 else -302), v13;
					var v14 := "hcvvsgggf";
					var v15: multiset<int> := multiset{f27, p0};
					v14, globalState.f8, globalState.f0 := v14, (|v15| % p0) * p2, v1;
					var v16, v17 := m3(seq(0x372, i1  => (v2)), !(v1 <== v1), globalState);
					...
					var v20 := 'e';
					var v21: set<string> := {p1, v19[p2 := v20]};
					...
					var v27: map<bool, map<int, int>> := map[!v24[p0] := v26];
				...
				if (v1) {
					...
					v30[866] := v31;
					v30[866] := new bool[7] [v1, false, fm7(p0, globalState) == f27, v1, v1, v1, v1];
					var v32: seq<map<int, bool>> := [f26, f26, f26];
					var v35: seq<int> := [0x2e2];
					var v36: array<map<int, bool>> := new map<int, bool>[20] [f26, f26, v32[p2], f26, f26[p0 := false] + f26, f26, f26, f26 + map[|multiset{v1, !v1}| := v1], map[f27 := v1], f26, f26, if (v1) then v32[p0] else map[f27 := v1], f26 + f26, f26, f26, map v33 : int | (0xf3 <= v33) && (v33 < 987) :: (v33 - -0x1ec) := (v1), f26, (map v34 : int | v34 in v35 :: (v34 + f27) := (v1)) + fm8(p1, v1, p2, globalState), map[653 := v1], f26];
					v36 := v36;
					var v37: set<bool> := {v1};
				...
				match (v54) {
					case DC0() =>
						globalState.f0 := v53 !in ((seq(-337, i4  => (v53))) + "qewbkgcot");
					...
					case DC1(cf0, cf1, cf2, cf3, cf4) =>
						...
						v61 := v61;
						var v62 := "kgfnnee";
						v62 := p1[|multiset(fm9(globalState))| := cf4];
						...
						globalState.f10, cf1, v65[461], v66[73] := v1, v1, v63 + v63, [v1] + [DC1(if (cf3 in v69) then v69[cf3] else |fm10(|v62|, v1, cf3, globalState)|, false, cf2, fm7(p0, globalState), v53).cf1, cf1, v1];
				}
			...
			case DC1(cf0, cf1, cf2, cf3, cf4) =>
				...
				var v77: array<int> := new int[25] [|v71|, -|v74|, -0x52, cf3, 191, cf3, cf3, p2, p0, p2, v71[322], cf0, p0, p0, cf0, f27, f27, 65, cf3, 0x2ee, v75.cf3, f27, if (v73 in v76) then v76[v73] else p2, |v72|, p0];
				var v78 := DC5(v77);
				...
				v79[273] := v77;
				v79[273], globalState.f16, cf4, globalState.f16 := v77, |fm6(globalState)| + -cf3, cf4, f27;
		...
		for i8 := -|p1| to p0 {
			var v81: seq<int> := [617 / fm7(i8, globalState)];
			var v82: map<int, seq<int>> := map[p2 + f27 := [p0, -f27, i8, f27] + v81];
			v81 := (if (-p2 in v82) then v82[-p2] else v81)[p2 := p0 - p2];
			...
			if (fm5(v84, globalState) <==> v84) {
				...
				v86[169] := DC5(v85);
				v86[169] := DC5(v85).(cf8 := v85);
				globalState.f11 := fm7(f27, globalState);
			} else {
				var v87 := 'h';
				v87 := fm12(v84 in map[!v84 := v81[p0]], 287, globalState);
				var v88, v89 := m3(p1, v84, globalState);
				var v90: map<string, int> := map[fm6(globalState) := |p1|];
				v90 := v90[p1 := p2];
				var v91: array<bool> := new bool[17](i9 => |p1[p2 := 'u']| == p2);
				v91[651] := v84;
				v91[481] := v84;
				var v92 := "a";
				...
				v91[651], v91[481], globalState.f11, v87, v92 := v95 < v95, v99.cf1, 0x1d, p1[f27], p1;
				var v100: map<char, int> := map[v87 := v88];
				v100 := v100[fm12(v91[651], |v92|, globalState) := i8];
			}
			...
			match (v102) {
				case DC11(cf19, cf20) =>
					...
					v103 := v104[v106.cf0] + (seq(-0x7a, i10  => ('w')));
				case DC10(cf18) =>
					var v107: seq<bool> := [v84];
					var v108 := DC11(v84, v107[f27]);
					...
					var v113: map<int, bool> := map[-(|(if (v84 in v110) then v110[v84] else p1)| / |{if (v111 in v112) then v112[v111] else i8}|) := true];
					v113 := f26;
					v111 := v111;
		...
		if (v120) {
			...
			v141 := v141[(p1 + "kceepx")[p0 := 'j'] := |multiset{p2, |v142|, p0}|];
	...
	method m3(p0: string, p1: bool, globalState: GlobalState) returns (r0: int, r1: D0) {
		...
		v12[879] := v11;
		var v13 := DC22(f27);
		for i1 := f27 to f27 / v13.cf36 {
			var v14: C0 := new C0();
			var v15: seq<C0> := [v14, v14];
			var v16: array<C0> := new C0[21] [v14, v14, v14, v14, v14, v14, v15[i1], v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14];
		...
		r0 := |v8| / -(if (p1) then |p0| else v21[259]);
		r1 := DC0();
	}
}
...
class C6 extends T0 {
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := if (p0) then "tri" else seq(0x10c, i1  => ('y'));
		}
		globalState.f0 := f24;
		var v1 := DC0();
		match (v1) {
			case DC0() =>
				...
				if (p0) {
					...
					v5[817] := v6;
					var v7 := "kfs";
					var v8: array<int> := new int[17](i3 => i3 / v4.f29);
					...
					var v13 := DC5(v8);
					v9 := v9[|{v2, v2, v12[v2], |fm33(globalState)|}| := v13.cf8];
					var v14 := 'q';
					var v15: multiset<bool> := multiset{f24};
					var v16: map<bool, multiset<int>> := map[p0 ==> f24 := (multiset{0x1f6, |map[v14 := v4.f29]|})[|v15| := v2]];
					v16 := v16[f24 := multiset(v10) * multiset{v4.f29}];
					var v17: multiset<int> := multiset{v4.f29, v2, |v7|, v2};
					var v21: seq<set<int>> := [set v19 : int | v19 in (map v18 : int | (0x145 <= v18) && (v18 < -867) :: (v18 * v2) := (p0)) :: (v19 * |(map v20 : int | v20 in map[0xdb := |{!false, false, false, true, false}|] :: (v20 / |{|multiset([!false, true])|}|) := (multiset{|map[true := --324]|, |map[|"kqmipstkb"| := 'g']|}))|)];
					var v22: set<int> := {v2};
					globalState.f11 := v4.fm0(v17, 574, (v21[0x330 := {v4.f29, |v12|, v2, v4.f29}])[-v4.f29 := v22], p0, globalState);
				} else {
					var v23: seq<int> := [v2];
			...
			case DC1(cf0, cf1, cf2, cf3, cf4) =>
				...
				if (v30) {
					...
					var v40: set<int> := {|v37[|v38| := map v39 : int | (-0x17f <= v39) && (v39 < -0x171) :: (v39 % v32[784]) := (cf0)]|, v32[784], cf0, -fm7(cf0, globalState), cf3};
					v35[773] := v40;
					v35[773] := (set v41 : int | (0x1cc <= v41) && (v41 < -0x1b8) :: (v41 * v32[784])) + v40;
					globalState.f13 := v35[773];
				} else {
					globalState.f6 := -cf0;
					...
					var v48: array<array<string>> := new array<string>[20] [v0, v47[cf3], v0, v0, v47[v32[784]], v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
					v48[567] := v0;
					v48[567] := if (if (v30) then f24 else v30) then v0 else v0;
				}
		...
		if (fm15(multiset{v50} >= multiset{v50}, globalState)) {
			...
			v57[378] := if (if (false) then false else f24) then false <== f24 else v50 < |v61|;
			...
			match (v62) {
				case DC13(cf22) =>
					...
					v63[668] := v64;
					v63[668] := fm46(globalState);
				case DC14(cf23, cf24, cf25) =>
					cf23 := cf23;
					v57[378] := p0;
					var v65: array<int> := new int[5];
					v65, globalState.f10 := v65, v57[378];
					v65[367] := v59.f30 % -v59.f30;
					v65[367] := v59.f30;
				case DC15(cf26, cf27) =>
				...
				case DC12(cf21) =>
					...
					v72[394] := v73;
					v72[394] := v73;
					var v74 := DC14(v58, v57, seq(0x30a, i9  => (v58)));
				...
				case DC16(cf28) =>
					...
					var v79: map<int, bool> := map[v50 := !v57[378]];
					var v80: map<map<int, bool>, bool> := map[v79 := !v57[378]];
					var v81: map<bool, multiset<bool>> := map[p0 := v55];
					var v82: seq<int> := [v50, v59.f30, v59.f30, v59.f30, |v81|];
					var v83: seq<map<int, bool>> := [v79];
					var v84: array<int> := new int[24] [v59.f30, v59.fm35(-v59.f30, |v77|, p0, 0x299, globalState), |v78|, v59.f30, v59.f30, v59.f30, v59.f30, v59.f30, v59.f30, v59.f30, v59.f30, v59.f30, v50, -0x233, v59.f30, |v80|, v59.f30, v82[--v59.f30], v59.f30, v59.f30, |multiset(v82)|, |v83|, 0x270, v59.f30];
					var v85: map<array<int>, bool> := map[v84 := v57[378]];
					var v86 := DC34(v58, f24, DC29(!p0, p0, 'l').cf48, f24, true);
					var v87: T0 := new C4(v57[378], f22);
					var v88: set<array<int>> := {v76};
					var v89 := DC46(f24, v87, v50, v88);
					var v90: seq<map<array<int>, bool>> := [map[v84 := v57[378]], v85];
					var v91: array<map<array<int>, bool>> := new map<array<int>, bool>[17] [v85, map[v76 := false], map[v76 := fm15(v57[378], globalState)] + v85, v85, v85, v85, map[v76 := v86.cf57] + v85, map[v76 := f24], v85, v85, v85, if (v89.cf73) then map[v84 := v57[378]] else v90[|v82|], v85 + v85, v85, v85, v85, v85[v76 := p0]];
					v91[235] := map[v84 := v57[378]];
					v91[235] := v85;
			...
			v53 := v53[!(v59.f30 >= v93[|v93|]) := v57[378]];
			var v94: map<bool, int> := map[v57[378] := v59.f30];
			...
			if (v96[v50]) {
				...
				v98[446] := v97.f30;
				v98[446] := fm7(v97.f30, globalState);
				var v99 := 'y';
				v98[446], v99, globalState.f6, r3, v98[446] := v97.f30, fm38(true, v50, globalState), (v50 % |v96|) % (v50 * v97.f30), v97.f30 * v50, v98[446];
				v98[446] := v50;
			} else {
				...
				var v104: map<bool, int> := map[f24 := |(seq(0x248, i13  => (v50)))|];
			...
			match (v122) {
				case DC34(cf55, cf56, cf57, cf58, cf59) =>
					var v123 := "n";
					var v124: map<bool, int> := map[v96[v50 := cf59] != v96 := v50 + -|v123|];
					globalState.f8, cf58, v124 := ---(-v50 / v50), !(v123 <= v123), (v124 + v124) + v124;
					var v125: array<int> := new int[7](i14 => i14 % v50);
					v125 := new int[1] [-0xcc];
					globalState.f16 := v50;
					r3 := v50;
				case DC35(cf60, cf61) =>
					...
					var v136: map<string, D9> := map[v132 := v134.(cf50 := v135[cf61])];
					v136 := v136;
					...
					v132, globalState.f10, r3, v138[516] := (v132 + "q") + (v132 + v132), f24, fm0(v139, if (p0) then v50 else -|v140|, v142, f24, globalState), v127[-cf61];
				case DC33(cf54) =>
			...
			match (v158) {
				...
				case DC35(cf60, cf61) =>
					...
					v168, globalState.f16, globalState.f10, v169[157] := v168, v50, v171 <= v171, !f24;
					globalState.f5 := (v96 + v96) + ([v169[157], p0, v169[157], f24, f24] + v96);
					var v172: seq<seq<bool>> := [[fm15(f24, globalState)]];
					var v173: multiset<bool> := multiset{p0};
					v172 := ((v172 + fm48(globalState)) + [v96])[v50 * |v173| := v96];
					var v174: seq<int> := [cf61];
					v174 := v174;
				case DC33(cf54) =>
					r0, globalState.f10 := fm3(v154, p0, v96[0x7c], globalState) <== (if (p0) then p0 else p0), v96 <= v96;
					...
					v176[360] := v180.cf11;
					v176[360] := v96[|(if (false) then "on" else v154)|];
					v154 := "hrcsc";
					...
					var v184: array<array<int>> := new array<int>[29] [v183[-v50], v182, if (v176[360]) then v182 else v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182, v182];
					v184[50] := v182;
					v184[50] := v182;
			}
		...
		if (!!(v187 != v187)) {
			...
			var v194: multiset<set<int>> := multiset{if (p0) then v192 else set v193 : int | (0x3c5 <= v193) && (v193 < 0x350) :: (v193 % v50), v192, v192, if (p0) then v192 else v192};
			v0[383] := v187;
			var v196: map<string, int> := map[v187 := |(set v195 : int | (0x179 <= v195) && (v195 < -477) :: (v195 / v50))|];
			v194, v0[383], globalState.f0, v187, globalState.f16 := v194, seq(0x262, i17  => ('h')), v189.f28, v187, if (f24) then |(v196 + v196)| else v50 * 0x349;
		} else {
			var v197 := 'd';
			if (!(v197 in "emuwsan")) {
				v0[65] := v187;
				v0[65] := v187;
				var v198: array<int> := new int[3](i18 => i18 % v50);
				var v199: set<int> := {-0x3ce};
				var v200: map<bool, int> := map[true := -|v199|];
				v198[409] := |(v200 + map[p0 := -0x337])|;
				var v201: set<bool> := {p0, true};
				var v202: seq<int> := [v50, |(v201 - v201)|, v50];
				var v203: array<bool> := new bool[26](i19 => 417 >= v50);
				v198[409], r1, globalState.f0 := -|v202|, v203, v187 <= v187;
				var v204: seq<bool> := [p0, f24];
				var v205: seq<seq<bool>> := [v204 + v204];
				v205 := v205;
				var v206: array<multiset<int>> := new multiset<int>[29];
				var v207: multiset<int> := multiset{v198[409]};
				v206[899] := v207;
				v206[899] := v207;
				var v208 := DC6(v198[409]);
				...
				v213[683] := DC39(f24);
				var v214 := DC3(seq(-0x160, i20  => (v197)));
				var v215: seq<D1> := [v214, DC3(v187).(cf6 := "ujsmsmjoj")];
				var v216: array<char> := new char[4] ['i', v197, v187[v50], v197];
				...
				r3, v213[683], v215, v216[8], v220 := v50, v212, seq(0x5a, i21  => (v214)), v197, v220;
				globalState.f11, v197 := v50, v216[8];
				...
				v221[650] := v225;
				v221[650] := (v225 + v225[v222 := v223]) + (map[v222 := v223] + v225);
				var v226: array<C1> := new C1[7];
				var v227 := DC37(v226);
				var v228: array<int> := new int[10] [v50, |v187|, v50, v50, |v187[|v187| := v216[8]]|, |v217[|v223| := f24]|, v50, v50, 0x17c, v50];
			...
			v235[46] := p0;
			v235[46] := p0;
			var v236: T0 := new C4(v235[46], f22);
			var v237: set<int> := {v50};
			var v238: seq<set<int>> := [v237];
			var v239: set<bool> := {true, f24, p0};
			var v240: array<int> := new int[9] [-0x36c, -|v187|, -v50, v50, v50, v50, v50, v236.fm0(f25[v50], v50, v238, f24, globalState), |v239|];
			var v241: set<array<int>> := {v240};
			globalState.f10 := DC46(f24, v236, v50, v241).cf73;
			var v242: seq<bool> := [v235[46]];
			var v243: multiset<seq<bool>> := multiset{v242 + [f24]};
			var v244: multiset<bool> := multiset{v235[46], f24};
			v243 := fm50(|v244| * v50, globalState);
			globalState.f0 := v235[46];
		}
		...
		r1 := new bool[21];
		r2 := map v250 : seq<int> | v250 in (seq(0x393, i22  => (seq(822, i23  => (|("jfkcni")[v50 := v245]|))))) :: (v250) := (v245);
		r3 := v50 % v50;
	}
	method m1(globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		if (f24) {
			...
			var v3: array<int> := new int[23](i0 => i0 % |{v0, |map[f24 := v0]|}|);
			...
			v3[731] := v0;
			v10, v3, v3[731], v7, globalState.f8 := v10, v3, v0, (v7[v0 := f24])[-v0 := f24] + [f24, f24, f24], v0;
			var v11: map<int, int> := map[v3[731] := fm7(-|v2|, globalState)];
			var v12: map<bool, bool> := map[f24 := f24];
			v11 := v11[v0 / v3[731] := -(|[v12, v12]| - v3[731])];
			var v13: map<seq<char>, bool> := map[v5 := f24];
			var v14: map<bool, map<seq<char>, bool>> := map[!f24 := v13];
			v13, globalState.f0 := v13 + (if (f24 in v14) then v14[f24] else v13), |v5| == v3[731];
			v0 := v0;
		} else {
			var v15: array<bool> := new bool[2](i1 => f24);
			var v16 := new C1(v0 / 0x331, [v15, v15, v15, v15, v15] + f22);
			if (fm15(true, globalState)) {
				var v17, v18, v19, v20 := v16.m6(v0, v16.f30 == v16.f30, v0 % v0, v16.f30, globalState);
				var v21 := 'q';
				v21 := v21;
				var v22: set<bool> := {f24, f24, false};
				var v23: seq<bool> := [f24];
				var v24: array<set<bool>> := new set<bool>[23] [v22 * v22, v22, if (f24) then v22 else v22, v22, v22 * v22, {f24}, v22, v22, v22, v22, v22 * v22, {f24, f24, f24}, v22, v22, {v23[v16.f30]} - v22, v22, v22 + v22, v22, v22, v22, v22, fm11(v20, v21, f24, globalState) + v22, {!f24, false}];
				v24[226] := v22;
				v24[226] := v22;
				var v25 := DC45(v19);
				v25 := v25.(cf72 := v17);
				...
				var v28: array<int> := new int[11] [v16.f30, -0x2f3, |v27|, 0x3d2, v16.f30, |(seq(0x2b4, i2  => (v21)))|, v19, v26.f29, v19, v16.f30, v0];
				...
				var v31 := "iyldgbb";
				var v32 := 'i';
				var v33: seq<int> := [|(v31[0x15a := v32] + v31)|];
				var v34 := DC7(v33, f24, f24, v16.f30);
				var v35: map<int, seq<int>> := map[-395 := v34.cf10];
				v33 := v33[v16.fm34(false, globalState) := |v31|] + (if (v16.f30 in v35) then v35[v16.f30] else v33);
				var v36 := new C1(v16.f30, f22[v16.f30 := v15] + [v15]);
			...
			var v50: array<array<int>> := new array<int>[19] [v46, v46, v46, v47[908], v46, v46, v46, v46, if (f24) then v46 else v46, v46, v46, v46, v46, v46, if (f24) then v46 else v46, v46, if (v16.f30 in v48) then v48[v16.f30] else v46, if (f24) then if (|v49| in v48) then v48[|v49|] else v46 else v46, v46];
			v50[494] := v46;
			var v51 := DC15(0xee, v0);
			v45, globalState.f6, v50[494], globalState.f10 := v45 + v45, v0, v46, (v51.cf26 >= v0) <==> f24;
		...
		if (!f24) {
			...
			v63[492] := fm36(f24, v65 - (set v66 : int | (9 <= v66) && (v66 < 0x1ef) :: (v66 % v0)), v0, |v67|, globalState);
			...
			var v74: multiset<int> := multiset{0x26a, |v73|, -|v63[492]|};
			var v75: map<bool, bool> := map[f24 := f24];
			var v76: array<int> := new int[13] [|v71|, |(v72 + [f24, f24, f24, false])|, |v65| - 0x3d7, -v0, v0, |v64|, v0 / v0, v0 * (if (|"qrhauoaod"| in v74) then v74[|"qrhauoaod"|] else v0), v0, -0x1fc, |(v75 + v75)|, v0, v0];
			var v77 := DC6(v0);
			v76[711] := v77.cf9;
			v76[711], r0 := v0 + |v63[492]|, f24 || !f24;
			v68[283] := !f24 || f24;
			v68[283], r1, globalState.f8 := v72[v0] in ((fm52(globalState))[|v73| := f24] + v72), v76[711] - v0, v0;
			v68 := v68;
		} else {
			r0 := f24;
			if (f24) {
				...
				var v82 := new C2(v0 / v0, f22);
			} else {
				var v83: array<array<map<int, int>>> := new array<map<int, int>>[28];
				var v85: array<map<int, int>> := new map<int, int>[18](i6 => map v84 : int | v84 in [|map[v0 := f24]|, v0, --0x32b, |[-v0]|, v0] :: (v84 % v0) := (v0));
				v83[156] := v85;
				var v86 := 'i';
				var v87: array<bool> := new bool[28];
				v87[171] := f24;
				v83[156], v86, v87[171] := v85, fm22(f24, !f24, |(fm52(globalState) + fm52(globalState))|, 684 * v0, globalState), f24;
				var v88: set<int> := {v0, v0};
				var v89: multiset<int> := multiset{v0, v0};
				var v90 := DC23(f24, v0, v87[171]);
				var v91: seq<set<int>> := [v88];
				var v92: map<string, int> := map[fm36(f24, v88, v0, -fm0(v89, v90.cf38, v91, v87[171], globalState), globalState) := v0 + v0];
				var v93 := "uji";
				v92 := v92[v93 := -v0];
				var v94: array<int> := new int[16](i7 => i7 % |map[v87[171] := true]|);
				v94[528] := 713 + |fm27(v0, globalState)|;
				v94[528] := v0 * v0;
				v94 := v94;
				var v95: map<bool, int> := map[v87[171] := |v93|];
				var v96: set<bool> := {fm15(false, globalState)};
				var v97: map<int, set<bool>> := map[|v95| := v96];
				r0, globalState.f10, v97, v93 := !f24, v93 <= v93, (v97 + v97)[v94[528] := v96], v93 + (seq(-0x2ec, i8  => (v86)));
			}
			...
			v98[42] := if (f24 in v100) then v100[f24] else v99;
			v98[42] := v99;
		...
		match (if (f24) then v104 else v104) {
			case DC50() =>
				...
				var v112 := DC54(v111);
				var v113 := "lsxnhwfp";
				var v114: array<bool> := new bool[22] [v105[if (f24 in v106) then v106[f24] else v0], f24, f24, f24, if (f24) then f24 else f24, if (f24) then f24 else f24, true, f24, f24, f24, f24, f24, !v108.cf57, f24, v0 < v0, v109.cf66, !f24, v0 <= -636, if (f24) then f24 else f24, true, fm37(v105, v112.cf85, v113, globalState), true];
				v114[184] := !f24;
				v114[184] := v110 >= v110;
			...
			case DC52() =>
				...
				var v125 := "elp";
				var v126 := 'd';
				var v127: map<bool, char> := map[v124[939] := v126];
				...
				var v131: seq<map<bool, char>> := [map[!v124[939] := v126]];
				var v132: multiset<int> := multiset{v0, v0};
				v128 := v128[v130 := v131[|v132|]];
				if (f24) {
					var v133 := new C3(f22[v0 := v124]);
					var v134: array<int> := new int[3];
					v134[199] := v0 - v0;
					var v135: seq<bool> := [f24];
					var v136: map<int, bool> := map[v0 := v124[939]];
					globalState.f5, v134[199], globalState.f8, v124, v0 := [if (false) then v124[939] else fm37(v135, v136, v125, globalState), f24 || f24], v0 - v0, v0, v124, v0;
					v126 := v126;
					r1 := v130[v134[199]];
					v126 := v126;
				} else {
					var v137: seq<bool> := [v124[939]];
					...
					var v142: map<int, bool> := map[0x16f := v124[939]];
					globalState.f5, v138, v139[802], r0 := v137, v138 + map[v0 := v137], |v141[v0]| % |v142|, |v132| != (|v125| / v0);
					var v143: seq<string> := [v125, v125];
					var v144: map<bool, bool> := map[v124[939] := f24];
					...
					v126 := v125[if (v124[939] in v152) then v152[v124[939]] else v139[802]];
					v125 := v125;
					var v153: set<int> := {v0};
			...
			case DC49(cf81) =>
				...
				var v160: seq<string> := [seq(0x3ce, i13  => ('f'))];
				globalState.f6 := (v0 / v157.fm0(v159, v0, seq(0x35d, i12  => ({v0, v0})), f24, globalState)) - |v160|;
			case DC53(cf84) =>
				...
				match (v163) {
					...
					case DC2(cf5) =>
						...
						v173[697] := f24 <== fm37([f24, false, f24], v175, "a", globalState);
						v173[697] := f24;
						var v176: map<map<int, bool>, bool> := map[v175 := if (f24) then v173[697] else fm15(false, globalState)];
						v176 := v176[v175 := v173[697]];
						v167[689] := v161.f30;
						var v177: multiset<int> := multiset{v0};
						var v178: seq<seq<int>> := [seq(-0x169, i14  => (v161.f30))];
						var v179: set<int> := {v161.f30};
						var v180: seq<set<int>> := [v179];
						var v181 := 'k';
						globalState.f0, v167[689], globalState.f11, globalState.f6, v173[697] := f24 || v173[697], -v166.fm0(v177, |v178|, v180, f24, globalState), v0, v0, v181 in cf5;
					case DC4(cf7) =>
						globalState.f8 := v0;
						var v182 := DC3("cokvtw");
						var v183 := DC4(v182);
						...
						var v187 := 'y';
						v186[293] := (v162[v161.f30 := v187])[v0 := v187];
						var v188: array<int> := new int[16](i15 => i15 - v161.f30);
						v188[345] := |"krpsp"|;
						var v189: multiset<int> := multiset{|v162|, 999, v0};
						var v190: map<bool, int> := map[f24 := |(seq(391, i16  => (v187)))|];
						var v191: map<int, map<bool, int>> := map[if (232 in v189) then v189[232] else v161.f30 := v190];
						globalState.f16, v185, v186[293], v188[345], v191 := v161.f30 / v161.f30, DC4(v183), "cbjw", v161.f30, map v192 : int | (249 <= v192) && (v192 < 0x3d) :: (v192 / v161.f30) := (v190[f24 := v0] + v190);
						var v193 := DC36(f25);
						var v194 := DC40(v193);
						var v195: seq<D11> := [v194];
						var v196: map<seq<D11>, int> := map[v195 + v195 := v0];
						v196 := v196[v195 + [v194] := v161.f30];
						var v197, v198, v199, v200 := v161.m6(104, f24, v188[345] * v161.f30, v161.f30, globalState);
				}
...
class C7 extends T0 {
	...
	function fm0(p0: multiset<int>, p1: int, p2: seq<set<int>>, p3: bool, globalState: GlobalState): int {
		-((|f23| * |map[false := [44]]|) * |([|f23|, |map[0x86 := false]|, -|[|(seq(-0x144, i0  => ('h')))|, |map[false := !true]|]|] + [|(seq(0x139, i1  => (176)))|])|)
	}
	...
	method m0(p0: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: map<seq<int>, char>, r3: int) {
		...
		if ((if (fm2(globalState) in v2) then v2[fm2(globalState)] else {v1, v1}) != f23) {
			...
			var v4: seq<multiset<int>> := [v3, v3, multiset{v1, 0x11d}, v3[v1 := v1]];
			var v5 := new C6(p0, v4, f22);
			var v6: multiset<string> := multiset{seq(-446, i0  => ('s'))};
			var v7 := "wp";
			...
			var v19 := DC42(|v12|);
			var v20: seq<seq<string>> := [seq(-0x38, i2  => (v7)), v17, if (v19.cf69 in v18) then v18[v19.cf69] else v17, seq(42, i3  => (v7)), v17];
			var v21: array<seq<string>> := new seq<string>[8] [v17, v17, if (v1 in v18) then v18[v1] else v17, v20[|f23|] + [seq(0x1b0, i4  => ('h')), v7], v17, v17 + v17, v17 + v17, v17];
			v21[216] := v17;
			v12, v21[216] := if (p0) then v12 else v12, fm53(globalState);
			globalState.f16 := -(if (v1 in v15) then v15[v1] else -fm7(|multiset{v5.f24}|, globalState));
		} else {
			globalState.f10 := !p0;
			var v23: seq<int> := [|(set v22 : int | (-0x7f <= v22) && (v22 < 0xc1) :: (v22 % -v1))|];
			var v24: seq<seq<int>> := [v23];
			globalState.f16 := v1 - |v24|;
			globalState.f16 := v1 % 0x1d7;
			globalState.f11 := v1;
		...
		for i6 := v1 to v1 + v29.cf13 {
			if (p0) {
				...
				globalState.f0, v30[976], globalState.f6, v28 := false <==> p0, (set v32 : int | v32 in v28[v1 := v1] :: (v32 % -|map[false := |"kkgbxwxpm"|]|)) >= f23, if (multiset{i6} >= v35) then 0x259 else v1, v28 + (v28 + v28);
				var v36: map<bool, int> := map[p0 := |v0|];
				var v37: C1 := new C1(|v36| * v1, f22);
				v37 := v37;
				var v38: map<bool, bool> := map[v30[976] := v0[v37.f30]];
				v38 := v38;
				var v39: multiset<array<bool>> := multiset{v30};
				var v40: array<multiset<char>> := new multiset<char>[24](i7 => multiset{v33} * multiset{v33});
				v40[6] := multiset{v33, v33};
				var v41: array<int> := new int[23];
				v41[720] := |"r"|;
				var v42: T0 := new C2(|v35|, f22);
				var v43: seq<seq<int>> := [v28, seq(-0x2f3, i8  => (v37.f30))];
				var v44: set<bool> := {v30[976]};
				var v45: map<T0, int> := map[v42 := v1 % |(v43[|v44|])[i6 := v37.f30]|];
				var v46: map<int, bool> := map[|fm23(|v28|, v1, p0, v30[976], globalState)| := v30[976]];
				var v47: multiset<char> := multiset{v33, 'd', v33};
				var v48 := DC48(i6, map[v30 := -950], p0);
				v39, v40[6], v41[720], v45, globalState.f16 := v39[v30 := -v37.fm34(if (v1 in v46) then v46[v1] else p0, globalState)], v47, -v1, (if (v30[976]) then v45 else v45) + v45, if ((v31 > v31) in v31) then v31[v31 > v31] else v48.cf78 / -v1;
				var v49: array<string> := new string[1];
				v49[715] := v27;
				v49[715] := v27;
			} else {
				globalState.f16 := i6 % 0x2e1;
			...
			v54 := (seq(25, i9  => (v53))) + v54;
			if (p0) {
				globalState.f10 := p0;
				var v55: map<bool, int> := map[p0 := -|v27| % i6];
				v55 := v55[p0 := |v27|];
				globalState.f11 := v28[v1];
				var v56: array<bool> := new bool[3] [p0, p0 && p0, p0];
				v56[862] := true;
				var v57: T0 := new C3(f22);
				var v58: map<bool, bool> := map[v1 == 0x1a3 := p0];
				globalState.f0, v56[862], v57, r0, globalState.f5 := fm7(v1, globalState) < |multiset{v56}|, if (p0 in v58) then v58[p0] else p0, v57, p0 ==> p0, v0 + v0;
				var v59 := new C4(p0, f22);
			} else {
				var v60: map<bool, int> := map[p0 := --i6];
				var v61: array<bool> := new bool[6];
				var v62: C4 := new C4(v28 != [|v60|, i6], [v61] + f22[v1 := v61]);
				v62 := v62;
				var v63 := DC35(i6, i6);
				...
				v65[424] := if (v62.f28) then v64 else v64;
				var v66: multiset<bool> := multiset{v62.f28, !v62.f28, p0};
				globalState.f16, globalState.f16, v65[424], globalState.f10, globalState.f0 := 0x322 * (v1 % |v66|), |v66|, if (v62.f28) then v64 else v64, p0, p0;
		...
		for i11 := 0x26d to --0x25f + (if (p0 in v67) then v67[p0] else v1) {
			...
			v70[231] := v28;
			v70[231] := (v28[fm7(v1, globalState) := i11])[|(seq(0x30d, i13  => (if (|v69| in v69) then v69[|v69|] else v1)))| := -v1];
			if (p0) {
				r3 := v1;
				v70[231] := v28;
				globalState.f11 := i11;
				...
				var v72: array<bool> := new bool[26] [p0, p0, p0, p0, p0, fm37(v0, v71, (seq(0x3a0, i14  => ('d')))[i11 := 'n'], globalState), !p0 <==> false, p0, v1 <= v1, v1 == v1, p0, p0, p0, if (v0[|"awkmh"|]) then p0 else true, p0 || p0, v1 == |v0|, if (p0) then p0 else p0, p0 && p0, p0, !!p0, p0, v1 >= i11, v1 > i11, p0, p0, p0];
				v72[392] := p0 <== p0;
				var v73: map<multiset<bool>, seq<bool>> := map[v67 := v0];
				var v75: set<multiset<bool>> := {v67};
				v72[392] := (set v74 : multiset<bool> | v74 in v73 :: (v74)) !! (v75 + v75);
				globalState.f8 := i11;
		...
		for i15 := v1 to |v0| * |v79| {
			...
			globalState.f0, v80[200], globalState.f11, globalState.f6 := !true, true, -|v81|, -|([v0, v0, v0, v0, v0[|v82| := p0]])[v1 := v0]|;
			if (false) {
				var v83: map<bool, bool> := map[p0 := p0];
				v83 := v83[v80[200] := v80[200]];
				r1 := v80;
				...
				var v91 := DC40(v90);
				var v92: seq<D11> := [v90];
				var v93: map<int, bool> := map[v87[334] := v80[200]];
				var v94: C5 := new C5(v93, v1);
				var v95: array<D11> := new D11[19] [v91.(cf67 := v90), v91, DC40(v90), v91, v91, v91, v91, v91, v91, v91.(cf67 := v90), v91, v91, v91, v91.(cf67 := v90), if (v80[200]) then v91 else v91, DC40(v92[|{v94}|]), v91, DC40(v90), v91];
				v95[573] := v91;
				var v96: set<bool> := {p0};
				globalState.f10, v95[573], r1 := v80[200] ==> (v96 > v96), v91, v80;
				v87[334] := 625;
		...
		var v98: array<seq<seq<int>>> := new seq<seq<int>>[7](i16 => seq(0x5d, i17  => (v28)));
		...
		v98[770] := (fm54(v101, v1, v102, |v106|, globalState) + [v28])[0x40 := v28] + v100;
		r0 := p0;
...
method Main() {
	...
	var v9: seq<multiset<int>> := [v8[v4]];
	var v10: array<bool> := new bool[10](i0 => true);
	var v11: array<int> := new int[7] [--v4, |(seq(656, i1  => ('p')))|, v4, v4, v4, v4, v4];
	var globalState := new GlobalState(true, v1, [v2], v3 + v3, false, [v2], 301, true, 794, 616, false, 0x14d, 349, {v4}, 0x242, v9[v4], 0x3d6, -0x235, v10, v11, v7, v10);
	...
	var v19: map<bool, bool> := map[v13.f28 in v17 := v13.fm13(v18[v4 := 731], v2, |v18|, globalState)];
	...
	match (match v24 {
		...
		case DC20(cf34) =>
			...
			match (v44) {
				...
				case DC47(cf77) =>
					var v49: map<bool, int> := map[DC11(v3[v4], v13.f28).cf19 := -v4];
					var v50: seq<set<int>> := [v23];
					var v51: seq<seq<set<int>>> := [v50];
					v49 := v49[true := v13.fm0(v7, v4, v51[0x268], v13.f28, globalState)];
					var v52 := new C5(map[v4 := v13.f28], v4);
					var v53 := new C2(DC42(v4).cf69, v12);
					var v54: set<string> := {v5, v5};
					var v56: T0 := new C7(v23, [v10, v10, v10, v10, v12[|cf77|]]);
					...
					var v63: array<set<string>> := new set<string>[15] [v54, v54, (set v55 : string | v55 in v54 :: (v55)) - (if (v58.cf74 in v57) then v57[v58.cf74] else v54), v54, v54, set v60 : string | v60 in v59 :: (v60), v54, fm55(v13.f28, |v3|, v15, globalState) + v54, {v5, v5, v5}, v54, v54, v54 * v54, fm55(v13.f28, |v5|, v15, globalState), (set v61 : string | v61 in v54 :: (v61)) + v62[v53.f29], v54];
					v63[259] := v54 + v54;
					v63[259] := v54 - v54;
			}
			...
			v10[323] := v65 != v65;
			globalState.f0, v5, v10[323], globalState.f16, v15 := |v5| == (v4 + |v5|), v5, v17 == (v17 + v17), v4, v15;
			var v66: C3 := new C3(v12);
			v66 := if (v10[323]) then v66 else v66;
			var v67: array<D15> := new D15[3](i4 => DC52());
			var v68 := DC52();
			v67[193] := v68;
			var v69: array<bool> := new bool[27](i5 => v13.f28);
			var v70: C2 := new C2(-v4, [v69, v69]);
			v13.f28, v67[193], v70 := |v0| >= v70.f29, v68, v70;
	}
	...
	if (v4 == v4) {
		...
		v78 := v78[v10 := v11];
		globalState.f16 := (|v5| * |map[v4 := v2]|) / v4;
		...
		v4, v86 := (v4 / |v5[-282 := v15]|) * 0xd0, v86;
		v5 := v5;
		var v87: map<seq<bool>, int> := map[v3 := v4];
		var v88: seq<map<seq<bool>, int>> := [v87, v87, v87];
		globalState.f8 := 0x11f * |v88[v4]|;
		v10[698] := fm15(v2, globalState);
		v10[698] := v13.f28;
	}
	...
	for i6 := -v4 to 465 {
		...
		if (true) {
			...
			v10[463] := multiset{v100, v100} > v101;
			v10[463] := !v13.f28;
		} else {
	...
	if (!v3[0xfe]) {
		...
		v11[318] := |(v127 + (if (v92 in v128) then v128[v92] else v127))|;
		v11[318] := 0xaa;
		...
		decreases 100 - i7
	{
		...
		i7 := i7 + 1;
		v11[845] := v4;
		v11[845] := |"xxxok"| * (v133 % v133);
		globalState.f11 := v11[845];
		var v135: seq<set<int>> := [v23, v23];
		globalState.f0 := 0x13e == v13.fm0(v6, v11[845], v135, v13.f28, globalState);
		v73[306] := v73[306];
	}
	var v136, v137 := v134.m4(globalState);
	var v138: map<int, bool> := map[|(seq(0xbc, i8  => (v15)))| := v89];
	var v139 := new C5(v138, v4 * -v133);
	var v140: multiset<char> := multiset{v15, 'd'};
	var v141: map<multiset<char>, int> := map[v140 := v92];
	v141 := v141[v140[v15 := v139.f27] := |v18| / v137];
}