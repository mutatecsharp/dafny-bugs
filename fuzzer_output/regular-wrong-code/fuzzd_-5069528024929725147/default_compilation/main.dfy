...
class C1 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: string, r1: D0, r2: bool, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			var v6 := true;
			v5[safeIndex(736, v5.Length)] := v6;
			v5[safeIndex(736, v5.Length)] := v6;
			if (v5[safeIndex(736, v5.Length)]) {
				globalState.f14, r2, v5[safeIndex(736, v5.Length)], v5 := p0, v5[safeIndex(736, v5.Length)], v6, v5;
				var v7: seq<int> := [p0];
				globalState.f9 := fm5(p0, v7 + (seq(abs(993), i1  => (-0x47))), globalState);
				...
				var v14 := DC2(v5[safeIndex(736, v5.Length)], |v11|, v13);
				var v15: multiset<D0> := multiset{v14.(cf6 := p0)};
				v15 := if (v6 || v5[safeIndex(736, v5.Length)]) then multiset{v14, DC2(v5[safeIndex(736, v5.Length)], p0, v13), v14} - multiset{DC2(v5[safeIndex(736, v5.Length)], -p0, v13), v14} else v15;
				var v16: array<map<int, bool>> := new map<int, bool>[2];
				var v17: map<int, bool> := map[140 := v5[safeIndex(736, v5.Length)]];
				v16[safeIndex(782, v16.Length)] := v17;
				var v18: seq<seq<char>> := [v10];
				v16[safeIndex(782, v16.Length)] := v17[if (v6) then 169 else |v18| := false];
				var v19: seq<int> := [p0, p0];
				var v20: map<map<int, int>, bool> := map[map[|v19| := p0] := v5[safeIndex(736, v5.Length)]];
				globalState.f14 := |(fm6(v5[safeIndex(736, v5.Length)], if (p0 in v17) then v17[p0] else v6, p0, globalState) + v20)|;
				r0, globalState.f3 := v10, v6;
				var v21: map<bool, bool> := map[false := p0 <= p0];
				v21 := v21[v6 := v5[safeIndex(736, v5.Length)]];
			}
			
			v5 := if (v5[safeIndex(736, v5.Length)]) then v5 else v5;
			var v22: set<bool> := {v6};
			v22 := v22 + ({v6, v5[safeIndex(736, v5.Length)]} * v22);
		}
		var v23 := "cmpkw";
		var v24: seq<int> := [p0];
		var v25: multiset<int> := multiset{safeModuloInt(|v23|, |v24|), p0};
		var v26 := false;
		...
		for i2 := p0 to -p0 {
			...
			var v35: array<int> := new int[28](i4 => safeModuloInt(i4, i2));
			var v36 := DC2(v26, i2, v35);
			var v37: array<int> := new int[25] [i2 + i2, fm7(i2, v30, v31.(cf0 := v26), globalState), p0, safeDivisionInt(|map[fm5(|v32|, v24, globalState) := fm5(|multiset(seq(abs(-495), i3  => (multiset{|v23|})))|, v24, globalState)]|, i2), |v28|, |v30|, p0 - p0, safeModuloInt(669, i2), p0, -(if (v26) then p0 else p0), v33.cf2, |fm8(v26, v26, if (|v23| in v34) then v34[|v23|] else v0, globalState)| * |v4|, -v36.cf6, i2, 0xc1, i2, -p0, i2, i2 * p0, 0x228, p0, safeDivisionInt(p0, |v23|), |(v4 + v4)|, i2, p0];
			var v38: multiset<bool> := multiset{v26};
			var v39 := DC5(v38);
			v37[safeIndex(750, v37.Length)] := fm7(fm7(|v30|, v30, v31, globalState), map[v26 := |v39.cf12|], v31, globalState);
			var v40: set<int> := {p0, p0};
			var v41: map<int, int> := map[|v40| := |fm9(v0, globalState)|];
			v37[safeIndex(750, v37.Length)] := -(i2 - -(if (813 in v41) then v41[813] else 0x18a));
			r3 := !fm5(v37[safeIndex(750, v37.Length)], [i2], globalState);
			globalState.f14 := -p0;
			var v42 := new C0();
		}
		var v43: seq<string> := [fm10(globalState) + v23];
		globalState.f9, globalState.f14, globalState.f15, v43 := v26, safeDivisionInt(v24[safeIndex(p0, |v24|)], p0), (v25 * v25[|"ug"| := abs(p0)]) + v25, v43;
		var v44: array<bool> := new bool[2];
		forall i5 | 0 <= i5 < v44.Length {
			v44[i5] := (p0 - -p0) <= |{v26, v26, v26, v26}|;
		}
		if (v4[safeIndex(0x33, |v4|)]) {
			v26 := (multiset{p0})[p0 := abs(|v4|)] >= v25;
			if (!(v26 in (v4 + v4))) {
				...
				globalState.f14 := safeModuloInt(safeModuloInt(p0, |v48|), p0);
				var v49: array<int> := new int[27];
				v49[safeIndex(28, v49.Length)] := p0;
				v49[safeIndex(28, v49.Length)] := p0;
				v44[safeIndex(771, v44.Length)] := false;
				v44[safeIndex(771, v44.Length)] := v26;
			} else {
				globalState.f3 := v26;
				...
				v27 := (if (p0 in v50) then v50[p0] else v27) + (if (v51.cf0) then map v52 : map<int, bool> | v52 in v54[safeIndex(-468, |v54|) := v53] :: (v52) := (p0) else v27);
				var v55: map<bool, int> := map[v26 := v24[safeIndex(p0, |v24|)]];
				var v56: array<int> := new int[9] [122, p0, |v4|, 930 - p0, fm7(p0, v55, v51, globalState), p0, p0 * p0, 693, 0xb7];
				v56[safeIndex(323, v56.Length)] := p0;
				v56[safeIndex(323, v56.Length)] := safeModuloInt(p0, p0);
			...
			var v60 := new C0();
			globalState.f9 := v23 == v23[safeIndex(0x2df, |v23|) := v0];
		...
		r0 := v23 + ((seq(abs(0x2e1), i6  => (v0))) + v23);
		...
		r1 := v73;
		var v74: map<int, seq<set<int>>> := map[p0 := seq(abs(0x359), i8  => ({-0x1ac}))];
		var v75: set<int> := {-0x2e, p0};
		var v76: seq<set<int>> := [v75, v75, v75];
		r2 := (seq(abs(0x3c6), i7  => ({p0, |v4|}))) <= (if (p0 in v74) then v74[p0] else v76);
		r3 := v26;
	}
}
...
class C3 extends T1 {
	...
	method m0(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v16: seq<D3> := [v15];
		var v17 := DC11(v16);
		var v18 := DC13(p1, v14[safeIndex(p2, |v14|)], v17);
		if ((if (p1) then v12 else DC2(p1, v18.cf24, v11)).cf5) {
			...
			if (-p0 != (p0 + |v10|)) {
				...
				v25[safeIndex(34, v25.Length)] := v6[safeIndex(p2, |v6|) := p1];
				v25[safeIndex(34, v25.Length)] := v6;
				r0, globalState.f14 := false, safeModuloInt(p0, -p0) - p2;
				var v26: array<char> := new char[8];
				v26[safeIndex(634, v26.Length)] := v13;
				var v27 := DC10(v10, p1, v10, v10 + v10, p2);
				globalState.f14, v26[safeIndex(634, v26.Length)], globalState.f14, globalState.f15, v27 := p0, v13, safeDivisionInt(p2 - p0, p0), multiset{p2}, v27;
		...
		if (false) {
			globalState.f3 := p1;
			globalState.f3 := f18;
			f19[safeIndex(466, f19.Length)] := p1;
			var v36: map<int, multiset<array<int>>> := map[p2 := multiset{v11, v11, v11}];
			var v37: multiset<array<int>> := multiset{v11, v11};
			f19[safeIndex(466, f19.Length)] := if (p1 || false) then f18 else -|(if (p2 in v36) then v36[p2] else v37)| != 0x22e;
			var v38: map<int, int> := map[|v10| := --p0];
			var v39: multiset<bool> := multiset{p1};
			var v40: array<bool> := new bool[22] [true, false, f19[safeIndex(466, f19.Length)], f19[safeIndex(466, f19.Length)], f18, p1, f18, f18, f18, f18, f19[safeIndex(466, f19.Length)], f19[safeIndex(466, f19.Length)], !f19[safeIndex(466, f19.Length)], f18, f18, f19[safeIndex(466, f19.Length)], f18, p1, f18, f19[safeIndex(466, f19.Length)], p1, f18];
			var v41: map<int, seq<D3>> := map[p0 := [DC10(v10, f18, v10, v10, |(seq(abs(0x151), i1  => (0x298)))|), fm18('d', f19[safeIndex(466, f19.Length)], p2, p1, globalState), DC10(v10, p1, v10, v10, p0)]];
			var v42: map<bool, int> := map[true := |v6|];
			var v44: set<int> := {if (f19[safeIndex(466, f19.Length)] in v42) then v42[f19[safeIndex(466, f19.Length)]] else |(map v43 : int | (0x1ea <= v43) && (v43 < 49) :: (safeModuloInt(v43, p0)) := (v3.cf9))|, p2};
			var v45: T0 := new C2(f17, f18);
			var v46: map<int, T0> := map[|v44| := v45];
			var v47: map<set<bool>, map<int, T0>> := map[{v0.fm5(|(seq(abs(-0x15d), i2  => (p2)))|, v14, globalState), true} := v46];
			globalState.f7 := new int[27] [-(if (p0 in v38) then v38[p0] else p0), p2, p0, p0 * p2, p0, p2, p2, p2, p0, fm0(|v10[safeIndex(p2, |v10|) := v13]|, v13, globalState), p2, |map[|v39| := v40]|, fm0(p2, v13, globalState), safeDivisionInt(|v6|, p0), -(|v41| - p0), fm0(p2, v13, globalState), p0, p2, |v47|, p2, safeModuloInt(|v10|, fm0(|"pwulprhlu"|, 'g', globalState)), 738, p2, |"ytgmpt"|, p2, p2, safeModuloInt(p2, |v6|)];
			var v48, v49, v50, v51 := v0.m5(p2, globalState);
		} else {
			if (f18) {
				var v52 := new C2(f17, if (f18) then p1 else p1);
				var v53: map<bool, int> := map[f18 := p2];
				globalState.f14, v10 := p0, (v52.fm20(globalState))[safeIndex(if (f18) then if (p1 in v53) then v53[p1] else p0 else -p0, |v52.fm20(globalState)|) := v13];
				globalState.f3 := p1;
				...
				var v62: map<bool, set<char>> := map[p1 := {v10[safeIndex(p0, |v10|)], v13, 'h'}];
				var v63: seq<set<char>> := [v61, {v13, v13}];
				var v65: array<set<char>> := new set<char>[15] [v61, if (true in v62) then v62[true] else v61, v61, v61, v61, v61, v61, v63[safeIndex(fm0(p0, v13, globalState), |v63|)], set v64 : char | v64 in v10 :: (v64), v61, v61, v61, v61, v61, v61];
				v60[safeIndex(538, v60.Length)] := v65;
				v60[safeIndex(538, v60.Length)] := v65;
				var v66: set<int> := {p2};
				globalState.f9 := p0 !in v66;
			}
			
			v11[safeIndex(596, v11.Length)] := safeDivisionInt(-0x2e5, p0);
			v11[safeIndex(596, v11.Length)] := p2;
			var v67: array<string> := new string[28](i3 => v10[safeIndex(v11[safeIndex(596, v11.Length)], |v10|) := 'q']);
			v67[safeIndex(993, v67.Length)] := v10 + v10;
			v67[safeIndex(744, v67.Length)] := v10;
			v1, v67[safeIndex(993, v67.Length)], v11[safeIndex(596, v11.Length)], v67[safeIndex(744, v67.Length)] := fm21([v11[safeIndex(596, v11.Length)], p0, p0, -p0, p2], globalState), "nosuekq", fm0(v11[safeIndex(596, v11.Length)], v13, globalState), fm22(p0, globalState);
			f19[safeIndex(65, f19.Length)] := f18;
			f19[safeIndex(65, f19.Length)] := !f18;
			var v68 := new C1();
		}
		...
		match (v70) {
			case DC6(cf13) =>
				...
				v71[safeIndex(729, v71.Length)] := v72;
				v71[safeIndex(729, v71.Length)] := v72;
			...
			case DC5(cf12) =>
				...
				var v75: map<int, int> := map[v14[safeIndex(p0, |v14|)] := p0];
				...
				if (!f18) {
					...
					v78[safeIndex(465, v78.Length)] := if (p1) then v13 else v13;
					var v79: seq<array<C1>> := [if (v0.fm5(p2, seq(abs(0x392), i5  => (p0)), globalState)) then v77 else v77];
					v77, v78[safeIndex(465, v78.Length)] := v79[safeIndex(p2, |v79|)], v13;
					globalState.f3 := f18;
				} else {
					v11[safeIndex(605, v11.Length)] := p0 + 0xcd;
					var v80: set<string> := {v10};
					var v81: array<string> := new string[26] [v10, v10, v10 + v10, seq(abs(0x64), i6  => (v13)), v10 + v10, v10, v10, v10[safeIndex(|v80|, |v10|) := v13], "gdic", v10, fm22(|cf12|, globalState) + "fe", v10, v10, v10, (seq(abs(0x2fe), i7  => (v13))) + v10, v10 + "su", v10, seq(abs(0x23b), i8  => (v13)), v10, v10, v10, "wfxv", seq(abs(0x395), i9  => (v13)), v10, fm22(p2, globalState), v10 + v10];
					v81[safeIndex(75, v81.Length)] := v10;
					globalState.f3, globalState.f3, v11[safeIndex(605, v11.Length)], v81[safeIndex(75, v81.Length)] := p1 && f18, p1, p0 - (if (f18) then 394 else p2), v10;
					globalState.f14 := |(v81[safeIndex(75, v81.Length)] + ("yh" + v81[safeIndex(75, v81.Length)]))|;
					...
					v11[safeIndex(605, v11.Length)] := |((v85 + [v84, v84]) + v85)|;
					var v86 := DC1(v81[safeIndex(75, v81.Length)], v11[safeIndex(605, v11.Length)], v11[safeIndex(605, v11.Length)], v81[safeIndex(75, v81.Length)][safeIndex(|v81[safeIndex(75, v81.Length)]|, |v81[safeIndex(75, v81.Length)]|)]);
					v86 := if (f18) then v86 else v86;
					f19[safeIndex(809, f19.Length)] := true;
					var v87: array<int> := new int[24];
					var v88: seq<array<int>> := [v87, v87];
					var v89: map<int, array<int>> := map[-0x228 := v87];
					globalState.f7, globalState.f3, f19[safeIndex(809, f19.Length)], globalState.f9 := if (v81[safeIndex(75, v81.Length)] < "g") then v88[safeIndex(v11[safeIndex(605, v11.Length)], |v88|)] else if (v11[safeIndex(605, v11.Length)] in v89) then v89[v11[safeIndex(605, v11.Length)]] else v87, p1, f18, if (f18) then p1 else f18;
				}
				
				v11[safeIndex(136, v11.Length)] := safeDivisionInt(|{|v6|, |v14|}|, p0);
				v11[safeIndex(136, v11.Length)] := p0;
			case DC7(cf14) =>
		...
		r1 := v0.fm5(safeDivisionInt(p2, p0), v14 + [p0], globalState);
		r2 := p2;
	}
}
...
class C4 extends T0 {
	...
	method m3(p0: char, p1: bool, p2: bool, globalState: GlobalState) returns (r0: int) {
		...
		v6 := v6[safeIndex(v2, |v6|) := v5 + "aiiyumo"];
		f26 := f25 * v2;
		f26 := f26;
		r0 := 0x27c;
	}
	method m4(globalState: GlobalState) returns (r0: bool, r1: map<array<bool>, int>, r2: int) {
		...
		match (DC2(f18, f25, v0).(cf7 := v0, cf6 := f26)) {
			case DC0(cf0) =>
				v0[safeIndex(268, v0.Length)] := safeDivisionInt(f25, f26);
				v0[safeIndex(268, v0.Length)] := 646;
				var v1: map<bool, bool> := map[v0[safeIndex(268, v0.Length)] >= f26 := false];
				...
				match (DC0(f18)) {
					case DC0(cf0) =>
						...
						var v5 := 'w';
						v5 := v5;
						v0[safeIndex(268, v0.Length)] := safeModuloInt(fm4(v0[safeIndex(268, v0.Length)], globalState), f26);
						var v6: set<bool> := {cf0};
						var v7: array<int> := new int[5] [v0[safeIndex(268, v0.Length)], v0[safeIndex(268, v0.Length)], f25, f26, |v6|];
						var v8 := DC2(cf0, v0[safeIndex(268, v0.Length)], v7);
					...
					case DC1(cf1, cf2, cf3, cf4) =>
						...
						v14 := v14;
						cf2, v0[safeIndex(268, v0.Length)], cf3 := f26, f26, v0[safeIndex(268, v0.Length)];
						var v15: array<string> := new string[18];
						v15[safeIndex(98, v15.Length)] := cf1 + cf1;
						var v16: map<bool, char> := map[!cf0 := cf4];
						v15[safeIndex(98, v15.Length)] := cf1[safeIndex(v0[safeIndex(268, v0.Length)], |cf1|) := if (f18 in v16) then v16[f18] else 'p'];
						var v17 := new C0();
					case DC2(cf5, cf6, cf7) =>
						var v18: array<bool> := new bool[27](i1 => if (true) then cf0 else cf0);
						v18[safeIndex(260, v18.Length)] := false;
						v18[safeIndex(260, v18.Length)] := cf5;
						var v19: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[24](i2 => [v1] + DC8([v1]).cf15);
						var v20: seq<map<bool, bool>> := [v1];
						v19[safeIndex(327, v19.Length)] := v20 + (seq(abs(-0x323), i3  => (v1)));
						v19[safeIndex(327, v19.Length)] := v20;
						var v21 := DC0(cf5);
						var v22: map<bool, D0> := map[fm13(globalState) := v21];
						v22 := v22[cf0 := v21];
						globalState.f14 := safeModuloInt(cf6, cf6 + f25);
				}
				
				var v23 := 'c';
				var v24: seq<char> := [v23, v23];
				match (DC10((seq(abs(0x16f), i4  => ('q'))) + v24, cf0, v24 + v24, v24, fm4(|v1|, globalState))) {
					case DC9() =>
						globalState.f14 := safeModuloInt(v0[safeIndex(268, v0.Length)], f25);
						v0[safeIndex(268, v0.Length)] := f25 - (v0[safeIndex(268, v0.Length)] * v0[safeIndex(268, v0.Length)]);
						var v25: array<bool> := new bool[15];
						var v26: map<array<bool>, char> := map[v25 := v23];
						v26 := v26[v25 := v23];
						globalState.f3 := v23 !in (seq(abs(-0x73), i5  => (v23)));
					case DC10(cf16, cf17, cf18, cf19, cf20) =>
						globalState.f3 := cf17;
						var v27: array<int> := new int[6](i6 => i6 * v0[safeIndex(268, v0.Length)]);
						var v28: set<array<int>> := {v27, v27, v27};
						var v29 := DC9();
						var v30: seq<D3> := [v29];
						var v31 := DC11(seq(abs(0x13c), i8  => (v29)));
						var v32: seq<seq<D3>> := [v30, v30, v30];
						var v33: array<seq<D3>> := new seq<D3>[26] [v30, v30, [v29], v30 + v30, v30 + v30, v30, v30 + (seq(abs(0x36), i7  => (v29))), v31.cf21, v30 + [v29], v32[safeIndex(f25, |v32|)], v30, v30, [v29], v30, v30, v30 + v30, v30, (seq(abs(0x293), i9  => (v29))) + v30, fm14(cf17, f18, -325, globalState), v30, [v29], v30 + v30, v30 + [v29, DC9(), v29], v30, seq(abs(118), i10  => (v29)), v30];
						v33[safeIndex(253, v33.Length)] := seq(abs(0x18a), i11  => (v29));
						cf0, v28, v33[safeIndex(253, v33.Length)] := fm13(globalState), v28, v30[safeIndex(f26, |v30|) := v29];
						cf17 := !(cf17 && (if (cf0) then !cf17 else cf17));
						var v34: seq<bool> := [f18];
						var v35 := DC10(v24, cf0, cf16, cf16, f25);
						var v36: map<bool, D3> := map[v34[safeIndex(f26, |v34|)] := v35];
						var v37: map<int, int> := map[|v36| := v0[safeIndex(268, v0.Length)]];
						r2 := f25 - |v37|;
					case DC8(cf15) =>
						var v38: array<int> := new int[7] [f25, f25, f25, v0[safeIndex(268, v0.Length)], f26, f26, 244];
						var v39 := DC2(f18, v0[safeIndex(268, v0.Length)], v38);
			...
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				v45[safeIndex(923, v45.Length)] := f18;
				...
				var v49: array<multiset<array<int>>> := new multiset<array<int>>[20] [v46, v46, v46[v0 := abs(f26)], v46, v46 + multiset{v0, v0, v0}, v46, if (f18 in v47) then v47[f18] else v46, v46 - v46, v46, v46, v46 * v46, v48[safeIndex(cf3, |v48|)], v46[v0 := abs(fm4(f26, globalState))], v46, multiset{v0, v0}, multiset{v0} + v46, v46, v46, v46, v46];
				v49[safeIndex(408, v49.Length)] := v46;
				var v50 := DC0(f18);
				var v51: seq<bool> := [f18];
				cf4, v45[safeIndex(923, v45.Length)], cf4, globalState.f3, v49[safeIndex(408, v49.Length)] := cf4, cf2 < |([f18])[safeIndex(cf3, |[f18]|) := v50.cf0]|, cf4, v51[safeIndex(if (v0 in v46) then v46[v0] else cf3, |v51|)], v46 + multiset{v0};
				if (v45[safeIndex(923, v45.Length)]) {
					v0[safeIndex(930, v0.Length)] := |((seq(abs(0x145), i13  => (cf4))) + cf1)|;
					var v52: set<bool> := {v45[safeIndex(923, v45.Length)]};
					var v53: map<string, int> := map[cf1 := cf3];
					var v54: seq<int> := [cf2, cf2];
					globalState.f3, v45[safeIndex(923, v45.Length)], globalState.f9, v45[safeIndex(923, v45.Length)], v0[safeIndex(930, v0.Length)] := !(f25 != (|v52| * f25)), false, |v53| != (|v54| - 536), v45[safeIndex(923, v45.Length)] && fm13(globalState), 647;
					var v55: multiset<bool> := multiset{false, v45[safeIndex(923, v45.Length)]};
					var v56 := DC7(DC5(v55));
					var v57 := DC7(v56);
					v57 := v57;
					var v58: array<int> := new int[14](i14 => i14 - f25);
					var v59 := DC2(v45[safeIndex(923, v45.Length)], cf2, v58);
					globalState.f9, globalState.f3 := v59.cf6 >= 0x267, f18;
					globalState.f3 := v45[safeIndex(923, v45.Length)];
					var v60 := DC5(v55);
					var v61: set<D2> := {v60, fm15(v45[safeIndex(923, v45.Length)], cf1, cf1, globalState)};
					globalState.f3 := v45[safeIndex(923, v45.Length)] ==> (v61 <= v61);
				} else {
					globalState.f9 := cf2 > |(seq(abs(824), i15  => (cf4)))|;
					var v62: array<seq<bool>> := new seq<bool>[6](i16 => DC15(v51).cf29);
					v62[safeIndex(630, v62.Length)] := v51[safeIndex(f26, |v51|) := f18] + fm16(globalState);
					var v63: seq<int> := [cf2];
					v62[safeIndex(630, v62.Length)] := ((v51 + (v51 + ([false])[safeIndex(f26, |[false]|) := f18]))[safeIndex(|(v63 + v63)|, |(v51 + (v51 + ([false])[safeIndex(f26, |[false]|) := f18]))|) := false])[safeIndex(f26, |(v51 + (v51 + ([false])[safeIndex(f26, |[false]|) := f18]))[safeIndex(|(v63 + v63)|, |(v51 + (v51 + ([false])[safeIndex(f26, |[false]|) := f18]))|) := false]|) := v45[safeIndex(923, v45.Length)]];
					var v64: set<D6> := {fm17(globalState)};
					var v65 := DC15([!f18, v45[safeIndex(923, v45.Length)]]);
					v64 := if (f18) then v64 else {v65, v65};
					globalState.f9, globalState.f14, globalState.f14 := fm13(globalState) ==> v45[safeIndex(923, v45.Length)], f26, cf2 - cf3;
					globalState.f14 := cf3;
				}
			...
			case DC2(cf5, cf6, cf7) =>
				...
				var v68: set<int> := {v67[safeIndex(cf6, |v67|)]};
				globalState.f9 := v68 > v68;
				var v69 := 'q';
				cf7[safeIndex(337, cf7.Length)] := f25 * -cf6;
				...
				var v75 := "ayplhylwi";
				v69, cf7[safeIndex(337, cf7.Length)], v71, f26, r2 := 'c', -0x1d8, v72, safeModuloInt(f26, cf6), |v74| - |(v75 + (seq(abs(412), i17  => ('r'))))|;
				cf7[safeIndex(337, cf7.Length)] := f26;
				var v76: array<seq<array<int>>> := new seq<array<int>>[13];
				var v77: seq<array<int>> := [cf7];
				v76[safeIndex(526, v76.Length)] := if (cf5) then v77 else v77;
				v76[safeIndex(526, v76.Length)] := v77 + v77[safeIndex(cf7[safeIndex(337, cf7.Length)], |v77|) := v0];
		}
		...
		if ((|v78| * f26) in (v79 + v79)) {
			...
			if ((v80 + v80) < v80) {
				...
				f26 := safeModuloInt(-f25, -safeDivisionInt(f25, |map[f18 := v82]|));
				var v83 := 'y';
				...
				v81[safeIndex(735, v81.Length)] := (if (|"vcaginhv"| in v86) then v86[|"vcaginhv"|] else -392) != -|v79|;
				v81[safeIndex(735, v81.Length)] := f18 <==> f18;
				var v88: T0 := new C2(v82.f17, !f18);
				var v89: map<bool, T0> := map[v81[safeIndex(735, v81.Length)] := v88];
				var v90, v91, v92 := v82.m0(f25, v85 >= (set v87 : int | v87 in (seq(abs(-119), i19  => (f26))) :: (v87 + -|map[|{false}| := DC11(seq(abs(0x21), i20  => (DC9())))]|)), |(if (v81[safeIndex(735, v81.Length)]) then v89 else v89)|, globalState);
			} else {
			...
			var v102 := "gwvqrarpx";
			v101[safeIndex(808, v101.Length)] := v102;
			v101[safeIndex(808, v101.Length)] := v102;
		...
		v0[safeIndex(718, v0.Length)] := v79[safeIndex(|v107|, |v79|)];
		v0[safeIndex(718, v0.Length)] := f26;
		var i23 := 0;
		while (f18)
			decreases 100 - i23
		{
			...
			v108 := v108[[-0x245] + v79[safeIndex(v0[safeIndex(718, v0.Length)], |v79|) := |v109|] := f18];
			var v110: map<map<bool, int>, bool> := map[map[f18 := f25] := f18];
			var v111: map<bool, int> := map[f18 := v0[safeIndex(718, v0.Length)]];
			v110 := v110[v111 + v111 := f18];
			var v112 := "hn";
			f26 := safeModuloInt(safeModuloInt(f25, f26), |((seq(abs(0x3cc), i24  => ('a'))) + v112)|);
			var v113: map<int, string> := map[0xa := v112];
			var v114: seq<seq<int>> := [[|v112|, f25]];
			var v115 := 'c';
			v112 := (v112 + (v112 + (if (v79[safeIndex(|v114|, |v79|)] in v113) then v113[v79[safeIndex(|v114|, |v79|)]] else "ptbvpe")))[safeIndex(v0[safeIndex(718, v0.Length)], |(v112 + (v112 + (if (v79[safeIndex(|v114|, |v79|)] in v113) then v113[v79[safeIndex(|v114|, |v79|)]] else "ptbvpe")))|) := if (f18) then 'p' else v115];
		}
		var i25 := 0;
		while (f26 > f25)
			decreases 100 - i25
		{
			...
			v116[safeIndex(385, v116.Length)] := v117;
			v116[safeIndex(385, v116.Length)] := v117;
			var v118 := new C0();
			v0[safeIndex(718, v0.Length)] := f26;
		}
		for i27 := f26 to f25 {
			...
			var v121: map<int, int> := map[v0[safeIndex(718, v0.Length)] := f26];
			var v122 := DC10(v120, f18, "yivqbw", v120, |v121|);
			globalState.f9 := |map[v122 := f18]| != i27;
			var v123: map<bool, string> := map[f18 := seq(abs(-0x390), i28  => (v119))];
			v123 := map[f18 := seq(abs(0x67), i29  => (v119))];
			if (f18) {
				var v124: map<bool, int> := map[f26 > |([f18, f18])[safeIndex(f26, |[f18, f18]|) := false]| := f25];
				v124 := v124[!f18 := v0[safeIndex(718, v0.Length)]];
				var v125 := new C0();
				var v126: array<multiset<seq<int>>> := new multiset<seq<int>>[27];
				v126[safeIndex(168, v126.Length)] := multiset(seq(abs(528), i30  => ([|multiset{262, |[true]|, f26, |multiset{f18}|}|, 0x2cb])));
				v126[safeIndex(168, v126.Length)] := multiset{v79} - multiset{v79, v79, v79};
				var v127 := new C0();
				globalState.f9 := safeDivisionInt(f26, v0[safeIndex(718, v0.Length)]) <= (-298 - |v78|);
			} else {
				globalState.f9 := !f18;
				var v128 := new C1();
				...
				var v136: multiset<string> := multiset{seq(abs(81), i31  => (v119))};
				var v137: multiset<int> := multiset{i27};
				var v138: array<bool> := new bool[14] [if (f18) then f18 else f18, f18 <== f18, f18, fm24(v135.cf5, v0[safeIndex(718, v0.Length)], globalState) >= (multiset{i27})[f25 := abs(f26)], f18, f18, (if (v120 in v136) then v136[v120] else v0[safeIndex(718, v0.Length)]) > |v120|, f18, f25 > v0[safeIndex(718, v0.Length)], v128.fm5(f26, v79, globalState), !f18, f18, f18, |v120| >= (if (f26 in v137) then v137[f26] else i27)];
				v138[safeIndex(295, v138.Length)] := f18;
				v138[safeIndex(295, v138.Length)], v119 := f18, v119;
			}
		...
		r2 := safeModuloInt(safeModuloInt(v0[safeIndex(718, v0.Length)], v0[safeIndex(718, v0.Length)]), |(if (!f18 in v141) then v141[!f18] else v107)|);
	}
}
...
class C5 extends T2 {
	...
	method m0(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			f19[safeIndex(319, f19.Length)] := f18;
			var v2 := 'v';
			f19[safeIndex(774, f19.Length)] := false !in [f18, p1, !p1];
			var v3: seq<bool> := [f18];
			globalState.f14, f19[safeIndex(319, f19.Length)], v2, f19[safeIndex(774, f19.Length)] := |f29|, if (false) then f30 else true, v2, !(v3 < v3);
			var v4: array<seq<int>> := new seq<int>[12];
			var v5: map<char, array<seq<int>>> := map[v2 := v4];
			var v6: seq<array<seq<int>>> := [v4, v4];
			var v7: map<string, array<seq<int>>> := map[f29 := v6[safeIndex(0x76, |v6|)]];
		...
		v11[safeIndex(511, v11.Length)] := v13;
		var v14: set<string> := {f29};
		v11[safeIndex(511, v11.Length)] := if (v14 < v14) then v13 else v13;
		f19[safeIndex(575, f19.Length)] := f30;
		var v15: seq<bool> := [f30];
		var v16 := DC15(v15);
		f19[safeIndex(575, f19.Length)] := (v16.cf29 + v15) != (if (f30) then v15 else v15);
		var v17: map<int, int> := map[|(seq(abs(0x31), i4  => ('u')))| := -|f29|];
		var v18: map<string, bool> := map[f29 := f18];
		for i3 := if (|v18| in v17) then v17[|v18|] else |map[f29 := p1]| to f20 {
			var v19: array<D5> := new D5[26];
			var v20 := DC10(f29, f19[safeIndex(575, f19.Length)], f29, f29, |v17|);
			...
			f19[safeIndex(575, f19.Length)], globalState.f14, globalState.f14 := f30, 652, p0;
			var v24: seq<multiset<bool>> := [v23, v23, v23];
			v23 := v24[safeIndex(|v1| + |v1|, |v24|)];
		}
		r0 := f30;
		var v25: set<int> := {f20};
		...
		var v29: map<bool, bool> := map[false := f19[safeIndex(575, f19.Length)]];
		var v30: seq<int> := [f20];
...
class C6 extends T2 {
	...
	method m0(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		for i0 := -(if (p1) then p2 else p0) to f28 {
			...
			var v4: seq<bool> := [p1];
			r2, r2 := safeDivisionInt(safeDivisionInt(i0, f28), |v3| - |v4|), |v0|;
			var v5 := DC0(f18);
			...
			match (DC8(v7)) {
				case DC9() =>
					...
					var v12 := 'i';
					var v13 := "jovhhqucn";
					var v14: seq<char> := [v12, v12, v13[safeIndex(0x363, |v13|)]];
					v13 := v13;
				case DC10(cf16, cf17, cf18, cf19, cf20) =>
					var v15 := new C1();
					globalState.f9 := true;
					var v16: set<int> := {f20};
					f19[safeIndex(497, f19.Length)] := v16 !! (set v17 : int | (-267 <= v17) && (v17 < 0x1d3) :: (safeDivisionInt(v17, f20)));
					f19[safeIndex(497, f19.Length)] := cf17;
				...
				case DC8(cf15) =>
					...
					globalState.f9, r1, globalState.f3, globalState.f14 := p1, v21 >= v21, !p1, safeModuloInt(if (i0 in v23) then v23[i0] else f20, i0 * p0);
		...
		var v42 := 'm';
		var v43 := DC25(f17);
		var v44 := new C4(safeDivisionInt(|v41|, |v41[safeIndex(-751, |v41|) := v42]|), p2, v43.cf47, f28 == -0x239);
		if (p1) {
			var v45: array<array<string>> := new array<string>[3];
			var v46: array<string> := new string[9];
			v45[safeIndex(316, v45.Length)] := v46;
			var v47: map<bool, array<string>> := map[p1 := v46];
			v45[safeIndex(316, v45.Length)] := if (p1 in v47) then v47[p1] else v46;
			...
			v52.f19[safeIndex(449, v52.f19.Length)] := p0 < |v53|;
			var v54: set<bool> := {f18};
			var v55 := DC23(!v52.f18, p1, v52);
			globalState.f14, globalState.f14, v52, v52.f19[safeIndex(449, v52.f19.Length)], v54 := 0x82, 0x3da, v55.cf45, !(v52.f18 || (-p0 == p0)), {v52.f18};
		} else {
			v41 := v41;
			...
			v41 := if ((v57 + v57) in v59) then v59[v57 + v57] else seq(abs(0xf3), i3  => (v42));
		}
		
		var v60: seq<int> := [v44.f25];
		var v62: seq<int> := [|v60[safeIndex(|(map v61 : int | (-896 <= v61) && (v61 < 0x1f) :: (safeDivisionInt(v61, |multiset{0x32a, 797}|)) := (v60))|, |v60|) := p2]|, f20, p2];
		v62 := seq(abs(-0x24), i4  => (p0));
		if (f18) {
			r1 := f18;
			...
			v69[safeIndex(945, v69.Length)] := v44.f26;
			var v70 := DC2(v66, v44.f25, v69);
			v69[safeIndex(945, v69.Length)], v44.f26, v68, v69 := v44.f26, 0x340, v60[safeIndex(safeDivisionInt(f28, v44.f26), |v60|)], v70.cf7;
		} else {
			var v71: array<C4> := new C4[2];
			var v72: map<array<C4>, bool> := map[v71 := f18];
			v72 := v72 + v72;
			var v73: array<string> := new string[1];
			v73[safeIndex(254, v73.Length)] := v41 + v41;
			v73[safeIndex(254, v73.Length)] := v41;
			var v74: array<int> := new int[11](i6 => i6 - p2);
			v74[safeIndex(477, v74.Length)] := v44.f25;
			v74[safeIndex(477, v74.Length)] := f20;
			globalState.f9 := f18;
			v74[safeIndex(477, v74.Length)] := v44.f26 * safeDivisionInt(f28, v44.f26);
		}
		
		r0 := p1;
		r1 := f18;
		var v75: seq<bool> := [true];
		r2 := safeDivisionInt(p0 + (if (f18 in f27) then f27[f18] else fm0(|v75|, v42, globalState)), 0x75);
	}
	method m6(p0: int, p1: array<int>, p2: set<bool>, p3: int, globalState: GlobalState) returns (r0: int, r1: seq<int>, r2: seq<bool>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			p1[safeIndex(206, p1.Length)] := f28;
			var v0: array<char> := new char[16];
			var v1: set<array<char>> := {v0, v0};
			p1[safeIndex(206, p1.Length)] := safeModuloInt(0x2ba, |v1|);
			var v2: array<set<D11>> := new set<D11>[4];
			var v3: map<array<set<D11>>, map<int, int>> := map[v2 := map[p0 := p1[safeIndex(206, p1.Length)]]];
			var v4: map<int, int> := map[p0 := p1[safeIndex(206, p1.Length)]];
			v3 := v3[v2 := map[p3 := f20] + v4];
			var v5: map<int, bool> := map[p0 := f18];
			r2 := [p0 <= |v5|, f18];
			var v6: seq<int> := [p0];
			var v7 := new C4(p3, safeModuloInt(p1[safeIndex(206, p1.Length)], f28), f17, DC20(v5, |v6|, f18, map[p0 := p0], 'h').cf38 <== f18);
		}
		var i1 := 0;
		while (p0 < f28)
			decreases 100 - i1
		{
			...
			var v12 := "bimux";
			match (fm35(safeModuloInt(p0, f20), (seq(abs(0x2a0), i2  => (p0))) + v11, |v12|, globalState)) {
				case DC11(cf21) =>
					var v13 := DC6(f28);
					globalState.f14 := p3 + v13.cf13;
					v12 := v12;
					var v14: map<bool, bool> := map[!f18 := f18];
					globalState.f14 := safeModuloInt(|v14| + f20, |f27| - f28);
					f19[safeIndex(88, f19.Length)] := false;
					var v15: multiset<bool> := multiset{f18, f18, f18, !f18, f18};
					f19[safeIndex(88, f19.Length)] := v8[safeIndex(|v15|, |v8|)];
			}
			
			var v16: T0 := new C2(f17, f18);
			var v17: map<string, T0> := map[v12 := v16];
			globalState.f14 := if (f18) then p3 else safeDivisionInt(|v17|, f28);
			var v18 := 'x';
		...
		if (f18) {
			if (f18) {
				...
				globalState.f7 := v23[safeIndex(137, |v23|)];
				...
				var v26 := "kfekrwy";
				v26 := v26;
				p1[safeIndex(517, p1.Length)] := p3;
				var v27 := 'k';
				p1[safeIndex(517, p1.Length)] := fm0(f20, v27, globalState);
			} else {
				var v28 := 'd';
				var v29: seq<char> := [v28, v28, v28, 'm'];
				var v30: array<char> := new char[15] [v28, v28, v28, v28, fm33(p3, f18, globalState), v28, v28, v29[safeIndex(f28, |v29|)], v28, v28, v28, v28, v28, v28, 'l'];
				globalState.f16 := v30;
				var v31: seq<int> := [p0];
				...
				var v34: seq<multiset<int>> := [multiset(v31[safeIndex(f28, |v31|) := f20]), multiset{|v29|}, v33, v33 - v33, multiset{500}];
				v34 := v34;
			...
			v38[safeIndex(596, v38.Length)] := v39;
			var v40 := "uqjs";
			var v41 := DC2(f18, |v40|, p1);
			v38[safeIndex(596, v38.Length)] := map[v40 + "dsssjt" := v41.cf7];
			if (f18) {
				globalState.f14 := p3;
				...
				var v45 := 's';
				f21 := map[v45 := f18] + f21;
				p1[safeIndex(290, p1.Length)] := f20;
				p1[safeIndex(290, p1.Length)] := |v40[safeIndex(f20, |v40|) := v45]|;
				var v46: array<char> := new char[21] [v45, v45, v45, v45, v45, v45, v45, v45, v45, 'a', v45, v45, v45, v45, 'v', v40[safeIndex(|v40|, |v40|)], v45, v45, v45, v45, v45];
			...
			globalState.f14 := -|(seq(abs(0xa8), i3  => ('e')))|;
		...
		if (f18) {
			...
			globalState.f9, globalState.f9, p1[safeIndex(487, p1.Length)], v63 := p3 > fm28(p3, f20, v67, globalState), f18, -p3, v63;
			var v68 := "hifw";
			...
			v68, v69, globalState.f3 := v68, v70[safeIndex(|(if (!!f18 in v71) then v71[!!f18] else v64)|, |v70|)], f18;
			f19[safeIndex(105, f19.Length)] := f18;
			f19[safeIndex(105, f19.Length)] := !(if (if (!f18) then f18 else f18) then !f18 else f18);
			...
			v80 := v80[v76 := f18];
			var v81: set<int> := {p3, -safeDivisionInt(-0x62, f28), |[f27[f18 := f28]]|};
			v81 := v81 + v81;
			if (v78[safeIndex(f20, |v78|)]) {
				...
				var v86: map<map<int, int>, int> := map[map v85 : int | v85 in [p0, f28] :: (safeModuloInt(v85, f28)) := (0xda) := |v75|];
				v84 := if (if (f18) then f18 else fm1(v86, globalState)) then v84 + v84 else if (f18) then v84 else v84;
				f19[safeIndex(923, f19.Length)] := f18;
				f19[safeIndex(923, f19.Length)] := fm27(globalState) !in fm39(p3, globalState);
				var v87: multiset<bool> := multiset{f18, f18, f18};
				globalState.f9, f19[safeIndex(923, f19.Length)], globalState.f7 := v87 != multiset([true] + v78), fm27(globalState), p1;
				var v88: map<bool, bool> := map[f19[safeIndex(923, f19.Length)] := true];
				globalState.f7, globalState.f3, v75, globalState.f3, globalState.f9 := p1, !(if ((!f19[safeIndex(923, f19.Length)] || f18) in v88) then v88[!f19[safeIndex(923, f19.Length)] || f18] else f18), "mfq", v77 in v75, f18;
				var v90: map<seq<bool>, map<int, int>> := map[v78 := map v89 : int | v89 in map[f28 := f19[safeIndex(923, f19.Length)]] :: (v89 - p0) := (p3)];
				globalState.f14, globalState.f3, globalState.f14, globalState.f3, globalState.f14 := f28, f18, fm28(f20, p0 - p0, v90, globalState), f19[safeIndex(923, f19.Length)], p3;
			} else {
				var v91: seq<string> := [v75];
				var v92: map<bool, bool> := map[f18 := v91 < v91];
				v92 := v92[f18 := if (f18) then f18 else v78[safeIndex(p3, |v78|)]];
				v81 := v81;
				var v93: seq<int> := [|({false, f18, f18} + p2)|, f20];
				r0 := v93[safeIndex(p0, |v93|)];
				f19 := f19;
		...
		f19[safeIndex(1, f19.Length)] := v95[safeIndex(|v96|, |v95|)];
		f19[safeIndex(1, f19.Length)] := f18;
		r0 := |v96|;
		var v97: seq<int> := [p0];
		var v98: set<int> := {f20};
		var v99 := "dsaa";
		...
		var v102 := DC18(v97[safeIndex(|v98|, |v97|) := fm28(|v99|, p3, v101, globalState)]);
		r1 := (v97 + (v97 + v102.cf34))[safeIndex(|(v99 + "o")|, |(v97 + (v97 + v102.cf34))|) := f20];
		r2 := v95;
	}
	method m7(p0: int, globalState: GlobalState) returns (r0: seq<T0>, r1: int, r2: bool, r3: seq<int>) {
		var v0 := "beccgqvi";
		globalState.f14 := -|((seq(abs(0x207), i0  => ('d'))) + v0)|;
			...
			decreases 100 - i1
		{
			...
			v6 := v6[f18 := !f18];
			v0 := if (f18) then seq(abs(0x114), i2  => (v3)) else v0;
			var v7 := new C1();
		}
		var v8: T0 := new C4(f28, |v5|, f17, f18);
		var v9: seq<T0> := [v8];
		var v10 := DC29(v9);
		var v11: seq<seq<T0>> := [v9[safeIndex(if (v8.f18 in f27) then f27[v8.f18] else f28, |v9|) := v8] + v9, v9, v10.cf54];
		r0 := v11[safeIndex(f28, |v11|)];
		r1 := if (f18) then if (f18) then f28 else p0 else f20;
		var v12 := DC10(v0, v8.f18, "hym", seq(abs(0x22), i3  => (v3)), -p0);
	...
	method m0(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		match (v2) {
			case DC4(cf9, cf10, cf11) =>
				...
				v6 := v6[v7[safeIndex(p2, |v7|)] := f19];
			case DC3(cf8) =>
				var v8 := "k";
				var v9: map<bool, string> := map[p1 := v8 + v8];
				var v10: seq<map<bool, string>> := [v9];
				globalState.f3, v9, r2, f19, cf8 := !!p1, v10[safeIndex(p0, |v10|)], DC6(-752).cf13, f19, cf8;
				var v11: array<int> := new int[2](i0 => safeModuloInt(i0, |[|{p2, |{false}|, f20}|, p2]|));
				v11[safeIndex(704, v11.Length)] := safeModuloInt(p0, 336);
				v11[safeIndex(704, v11.Length)] := f20;
				var v12 := 'v';
				f19[safeIndex(379, f19.Length)] := p1;
				var v13: map<int, int> := map[f20 := p2];
				var v14: seq<seq<int>> := [[|v8|, p0]];
				v12, f19[safeIndex(379, f19.Length)] := if (p1) then v12 else v12, (if (|v14| in v13) then v13[|v14|] else 0xf9) < safeModuloInt(v11[safeIndex(704, v11.Length)], v11[safeIndex(704, v11.Length)]);
				var v15 := DC1("aw", p0, 155, v12);
				var v16: seq<string> := [v8, v15.cf1 + v8, seq(abs(557), i1  => ('o')), v8];
				v16 := v16 + (seq(abs(0x182), i2  => (v8)));
		}
		...
		if (fm1(map[v18 := p0], globalState)) {
			...
			if (false) {
				...
				v19[safeIndex(334, v19.Length)] := f20;
				v19[safeIndex(334, v19.Length)] := f20;
			} else {
				f19[safeIndex(523, f19.Length)] := false ==> f18;
				f19[safeIndex(523, f19.Length)] := v23.f30;
				...
				var v30: array<array<array<bool>>> := new array<array<bool>>[18] [v26, v26, v26, v26, v26, v26, v26, v26, v27[safeIndex(p0, |v27|)], if (p0 in v28) then v28[p0] else v26, v26, v26, if (p1 in v29) then v29[p1] else v26, v26, v26, v26, v26, v26];
				v30[safeIndex(510, v30.Length)] := v26;
				v30[safeIndex(510, v30.Length)] := v26;
				v19 := v19;
				var v31: map<map<int, int>, int> := map[v18 := p0];
				var v35: array<map<int, int>> := new map<int, int>[14] [v18 + v18, v18 + v18, v18, if (v23.fm1(v31, globalState)) then map[p2 := p2] else map v32 : int | (0x3d6 <= v32) && (v32 < 808) :: (v32 + p0) := (p2), v18, v18 + (map v33 : int | v33 in multiset{f20, p0} :: (safeModuloInt(v33, p2)) := (f20)), v18, v18, map[f20 := -p0], map[p0 := p0], v18 + v18, v18, v18 + (map v34 : int | (163 <= v34) && (v34 < 0x3c7) :: (v34 + f20) := (p2)), v18];
				v35[safeIndex(803, v35.Length)] := v18;
				v35[safeIndex(803, v35.Length)] := v18;
				v0 := v0[0x121 := p1];
			}
			...
			var v41: map<char, int> := map[v38 := |v40[safeIndex(fm0(f20, fm33(|v39|, f18, globalState), globalState), |v40|)]|];
			var v42: map<map<int, int>, int> := map[v18 := |v41|];
			if (!fm1(map[fm30(p1, globalState) := f20] + v42, globalState)) {
				f19[safeIndex(434, f19.Length)] := if (f18) then true else f18;
				...
				f19[safeIndex(434, f19.Length)] := (if (v46 in v48) then v48[v46] else 0x2ec) >= p0;
				globalState.f14 := f20;
				var v49: array<char> := new char[3];
				v49[safeIndex(696, v49.Length)] := v38;
				var v51: set<char> := {v38, v38, v38, v38, v38};
				var v52: multiset<set<char>> := multiset{set v50 : char | v50 in f21 :: (v50), v51};
				v49[safeIndex(696, v49.Length)] := fm33(if (v51 in v52) then v52[v51] else p2, f19[safeIndex(434, f19.Length)], globalState);
				f19[safeIndex(434, f19.Length)] := f19[safeIndex(434, f19.Length)];
				var v53 := DC26(p1, p2);
				var v54: array<bool> := new bool[19] [p1, true, true, f18, true, f18, f18, f19[safeIndex(434, f19.Length)], f18, true, f19[safeIndex(434, f19.Length)], p1, !p1, f18, v53.cf48, f18, p1, f19[safeIndex(434, f19.Length)], p1];
				...
				v59[safeIndex(695, v59.Length)] := -|(v60[safeIndex(p2, |v60|)])[f18 := p1]|;
				v57, v59[safeIndex(695, v59.Length)], r1 := seq(abs(22), i3  => (|v57|)), p0, p2 < f20;
				var v61 := DC25({f19});
				var v62: set<D11> := {v61, v61, DC25(f17), v61};
				v62, v59[safeIndex(695, v59.Length)] := v62 - v62, safeModuloInt(f20, v59[safeIndex(695, v59.Length)]);
				f19[safeIndex(240, f19.Length)] := f18;
				var v63: C3 := new C3(f19, f17, f18);
				var v64: map<C3, int> := map[v63 := f20];
				f19[safeIndex(240, f19.Length)] := v63 !in (v64 + map[v63 := |v56|]);
				var v65: map<array<int>, map<bool, bool>> := map[v59 := map[p1 := f18]];
				globalState.f3, r2, globalState.f7, v39 := f19[safeIndex(240, f19.Length)], v59[safeIndex(695, v59.Length)] * f20, v59, (v39[safeIndex(v63.fm0(|fm40(f18, p1, globalState)|, v38, globalState), |v39|) := v38])[safeIndex(|((if (v59 in v65) then v65[v59] else v58) + v58)|, |v39[safeIndex(v63.fm0(|fm40(f18, p1, globalState)|, v38, globalState), |v39|) := v38]|) := v38];
				r2 := safeDivisionInt(p2, |v57|);
			}
			...
			v70[safeIndex(523, v70.Length)] := v71;
			var v72: set<bool> := {f18, true, p1};
			v39, v69, r2, r1, v70[safeIndex(523, v70.Length)] := (v39 + v39) + v39, v69, if (0x227 in v18) then v18[0x227] else p0, fm1(v42, globalState), DC20(v0, p2, v72 <= {p1}, v18, v38);
			v0 := v0[p2 := v66 >= v66];
		...
		var v73 := 'g';
		var v74 := "xiu";
		var v75 := DC10(seq(abs(0x3bb), i5  => ('s')), v73 in "xwn", v74, v74, |v74|);
		match (v75) {
			case DC9() =>
				if (true) {
					var v76: seq<int> := [p0, p0];
					var v77 := new C5(seq(abs(0x3b4), i6  => ('p')), f18, -v76[safeIndex(f20, |v76|)], map[v73 := f18], f19, f17, p1);
					f19[safeIndex(238, f19.Length)] := p2 <= p0;
					var v78: map<map<int, int>, int> := map[v18 := p0];
					f19[safeIndex(238, f19.Length)] := fm1(v78, globalState);
					var v79: array<seq<int>> := new seq<int>[13](i7 => [|map[v77.f30 := |multiset([v77.f30, if (p0 in v0) then v0[p0] else true])|]|] + v76);
					v79[safeIndex(366, v79.Length)] := seq(abs(607), i8  => (0x3ac));
					var v80: set<int> := {f20};
					var v81: array<D10> := new D10[9];
					var v82: seq<bool> := [!false];
					v79[safeIndex(366, v79.Length)], v80, v81, globalState.f14, globalState.f9 := v76, v80, v81, p0 - safeModuloInt(p0, p0), v82[safeIndex(p2, |v82|)];
					var v83: map<bool, string> := map[true := (("mjn")[safeIndex(p2, |"mjn"|) := v73])[safeIndex(p0, |("mjn")[safeIndex(p2, |"mjn"|) := v73]|) := v73] + v74];
					v83, globalState.f14, v82, globalState.f3 := (v83 + v83) + map[false := v77.f29], p0 * p0, fm25(f18, p1, p2, p1 <==> f18, globalState), if (f19[safeIndex(238, f19.Length)]) then f18 else v77.fm1(v78, globalState);
					var v84 := DC9();
					var v85: seq<D3> := [v84];
					var v86 := DC13(!fm1(v78, globalState), --f20, DC11(v85));
					var v87: array<D5> := new D5[8] [fm41(p2, f18, v77.f29, v73, globalState), fm41(|v77.f29|, f18, "c", 'g', globalState), v86, v86, fm41(f20, p1, seq(abs(-486), i9  => (v73)), 'x', globalState), v86, v86, v86];
					var v88 := DC11(v85);
					v87[safeIndex(268, v87.Length)] := DC13(p1, p2, v88);
					var v89: map<bool, bool> := map[f18 := v77.f30];
					var v90: array<int> := new int[12] [p2, fm0(p0, 'g', globalState), -|v89|, f20, f20, p2, 193, |v77.f29[safeIndex(f20, |v77.f29|) := v73]|, p0, f20, p2, 18];
					var v91: multiset<array<int>> := multiset{v90, v90};
					v87[safeIndex(268, v87.Length)] := v86.(cf25 := v88, cf24 := safeModuloInt(f20, if (v90 in v91) then v91[v90] else 0x391));
				} else {
					v74 := seq(abs(0x28e), i10  => (DC1("gf", p2, -503, DC1(v74, f20, p2, v73).cf4).cf4));
					f19[safeIndex(772, f19.Length)] := p0 != f20;
					f19[safeIndex(772, f19.Length)] := p1;
					var v92: set<bool> := {p1};
					var v93: map<bool, bool> := map[false := !p1];
					var v94: map<bool, int> := map[p1 := |v93|];
					var v95: seq<int> := [f20];
					var v96: seq<int> := [p0, |v94[f18 := |[[f18, f18]]|]|, |v95|];
					var v97: seq<int> := [|v74|, v96[safeIndex(fm0(f20, v73, globalState), |v96|)]];
					...
					var v102: array<bool> := new bool[20] [p1, p1, f18, false, f19[safeIndex(772, f19.Length)], p1, f19[safeIndex(772, f19.Length)], f19[safeIndex(772, f19.Length)], f19[safeIndex(772, f19.Length)], true, true, f19[safeIndex(772, f19.Length)], f19[safeIndex(772, f19.Length)], f19[safeIndex(772, f19.Length)], f19[safeIndex(772, f19.Length)], !false, p1, f18, f19[safeIndex(772, f19.Length)], v101.cf5];
					var v103: seq<array<bool>> := [v102, v102];
					var v104: array<int> := new int[6] [|v99|, |v96|, v98.f25, f20, |v103|, |"uosnx"|];
					var v105 := DC2(f19[safeIndex(772, f19.Length)], |v92|, v104);
					r2, globalState.f7, v92, v97, f19[safeIndex(772, f19.Length)] := p2, v101.cf7, v92, v95, !f19[safeIndex(772, f19.Length)];
					f19[safeIndex(772, f19.Length)] := f18;
					var v106: array<char> := new char[12];
					v106[safeIndex(386, v106.Length)] := v73;
					v106[safeIndex(386, v106.Length)] := v73;
				}
				
				globalState.f9 := f18;
				var v107: array<int> := new int[10];
				v107[safeIndex(55, v107.Length)] := p0 - p0;
				var v108: multiset<bool> := multiset{p1};
				v107[safeIndex(55, v107.Length)] := |v108|;
				var v109: map<bool, array<bool>> := map[f18 := f19];
				var v110 := DC12(v109);
				var v111: seq<D5> := [v110, DC12(v109)];
				globalState.f3, v107[safeIndex(55, v107.Length)], r2, v73, v73 := p1, p0 + |(v111 + v111[safeIndex(f20, |v111|) := v110])|, safeModuloInt(p0, -f20), v73, v73;
			case DC10(cf16, cf17, cf18, cf19, cf20) =>
				globalState.f14 := safeModuloInt(617, p2);
				var v112 := new C0();
				var v113: seq<map<int, int>> := [fm30(p1, globalState), v18, fm30(f18, globalState)];
				var v114: seq<int> := [safeDivisionInt(|v113[safeIndex(p2, |v113|)]|, 944), p0, fm0(f20, v73, globalState)];
				cf20 := |v114|;
			...
			case DC8(cf15) =>
				...
				v124[safeIndex(837, v124.Length)] := f19;
				v124[safeIndex(837, v124.Length)] := f19;
		...
		v126 := v128[safeIndex(p0, |v128|)];
		var v129: seq<bool> := [f18];
		var v130: C1 := new C1();
		var v131: set<C1> := {v130, v130};
		var v132: map<bool, set<C1>> := map[f18 := v131];
		var v133: map<string, set<C1>> := map[v74[safeIndex(|v129|, |v74|) := v73] := if (f18 in v132) then v132[f18] else v131];
		var i14 := 0;
			...
			decreases 100 - i14
		{
			...
			v134[safeIndex(93, v134.Length)] := v73;
			v134[safeIndex(93, v134.Length)] := v73;
			r2 := p2;
			var v135 := DC9();
			...
			match (DC13(p1, f20 * p2, v137)) {
				case DC13(cf23, cf24, cf25) =>
					...
					var v139: C0 := new C0();
					var v140: seq<int> := [|v0|];
					var v141: map<int, C0> := map[v140[safeIndex(p0, |v140|)] := v139];
					var v142: T0 := new C2(f17, cf23);
					var v143: seq<T0> := [v142];
					var v144: seq<T0> := [v142, v142, v142, v143[safeIndex(p2, |v143|)]];
					var v145: seq<C0> := [v139, v139];
					var v146: array<C0> := new C0[29] [v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, if (|multiset(v143)| in v141) then v141[|multiset(v143)|] else v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, v139, if (f18) then v139 else v139, v139, v145[safeIndex(-0x16a, |v145|)]];
					v146 := v146;
					var v147: map<int, seq<char>> := map[p0 := v74];
					var v148: array<int> := new int[15] [p2, f20, p2, f20, f20, p2, |v147|, |(v126 * v126)|, cf24, f20, cf24, --cf24, v140[safeIndex(|(seq(abs(-78), i15  => (v74)))|, |v140|)], f20, if (v142.f18) then p2 else -p0];
					v148[safeIndex(707, v148.Length)] := |v74|;
					var v149: multiset<string> := multiset{v74, v74, v74};
					v148[safeIndex(707, v148.Length)] := f20 * (0xbb - |v149|);
				case DC14(cf26, cf27, cf28) =>
					f19 := f19;
					f19[safeIndex(194, f19.Length)] := f18;
					f19[safeIndex(194, f19.Length)] := true;
					...
					globalState.f14 := fm0(|v152|, v134[safeIndex(93, v134.Length)], globalState);
				case DC12(cf22) =>
					globalState.f14 := -p2;
					var v153: array<map<int, int>> := new map<int, int>[16];
					var v154 := DC17(v153, f18, p2);
					var v155: map<D3, D7> := map[v135 := v154];
					var v156: array<int> := new int[23](i16 => i16 + |{v73, v134[safeIndex(93, v134.Length)]}|);
					v156[safeIndex(642, v156.Length)] := p0;
					v156[safeIndex(289, v156.Length)] := f20;
					var v157: seq<map<D3, D7>> := [v155];
					v155, globalState.f14, v156[safeIndex(642, v156.Length)], v156[safeIndex(289, v156.Length)] := v157[safeIndex(|v129|, |v157|)] + v155, -p2, safeModuloInt(p0, p0), p0;
					var v158: array<array<bool>> := new array<bool>[14];
					v158[safeIndex(646, v158.Length)] := f19;
					v158[safeIndex(646, v158.Length)] := f19;
					var v160: map<bool, map<int, bool>> := map[p1 := (map v159 : int | v159 in v0 :: (v159 - |(seq(abs(0x74), i17  => ('q')))|) := (p1)) + v0];
...
class C8 extends T1, T2 {
	...
	method m1(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: int) {
		globalState.f14 := safeDivisionInt(p2, --0xb5);
			...
			decreases 100 - i1
		{
			...
			var v17: array<int> := new int[8] [fm7(0x394, v9, DC0(v14.cf5), globalState), f20, |[p1, p3]| - -|v9|, p0, p2, |((set v15 : int | (0x3c <= v15) && (v15 < 957) :: (v15 * |{p2, f20}|)) - {|v16[f20 := abs(f23)]|})|, f23 + f20, safeDivisionInt(-p0, p2)];
			v7, globalState.f9, globalState.f7, globalState.f9 := (if (f24) then v7 else v8[safeIndex(f23, |v8|)]) + v7, f18, v17, f18;
			var v18 := new C0();
		}
		f19[safeIndex(17, f19.Length)] := multiset{p3} >= fm29(globalState);
		...
		f19[safeIndex(17, f19.Length)], globalState.f9, v21 := f20 < (|v22| + |"dn"|), if (p3) then p2 >= f23 else f24, map[if (f23 in v23) then v23[f23] else p3 := f23] + v21;
		var i2 := 0;
		while (f19[safeIndex(17, f19.Length)])
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			if (f18) {
				...
				v26 := v26;
				f19[safeIndex(17, f19.Length)] := p1;
				var v27 := "kme";
				var v28: T0 := new C4(|v23|, p2, f17, p1);
				var v29: seq<T0> := [v28, v28];
				var v30: array<int> := new int[4] [p2 - p2, p2 - |v27|, v20[safeIndex(|v29|, |v20|)], safeDivisionInt(f20, f20)];
				v30[safeIndex(668, v30.Length)] := p2;
				v30[safeIndex(668, v30.Length)] := -p0;
				v23 := v23[v30[safeIndex(668, v30.Length)] := if (f19[safeIndex(17, f19.Length)]) then p3 else p3];
			} else {
				var v31 := 'w';
				globalState.f14, globalState.f14 := fm0(-p0, v31, globalState) * p0, p0;
				globalState.f14 := f20 + p2;
				var v32: array<int> := new int[16](i4 => i4 - p2);
				v32[safeIndex(816, v32.Length)] := f23;
				v32[safeIndex(816, v32.Length)] := (f20 - p0) * 586;
				v32[safeIndex(816, v32.Length)] := p2;
				globalState.f3 := true !in fm16(globalState);
			}
			
			r0 := safeModuloInt(f20, -|v23| + |map[p3 := f19[safeIndex(17, f19.Length)]]|);
		...
		var v42 := DC9();
		var v44: set<map<int, bool>> := {v23, map v43 : int | (0x296 <= v43) && (v43 < 0x3c0) :: (v43 - p0) := (f19[safeIndex(17, f19.Length)])};
		var v45 := DC0(true);
		var v46 := DC4(!true, v44, fm7(f20, v21[f19[safeIndex(17, f19.Length)] := p2], v45, globalState));
		var v47: map<bool, bool> := map[f24 := v22[safeIndex(f23, |v22|)]];
		...
		var v53: array<int> := new int[24] [|(v39 * v39)|, |v22|, |v41|, f23, p0, p0, |fm34(v42, f18, v40, p1, globalState)|, -p2 * (v46.(cf9 := p1)).cf11, -f23, p2, |v47|, |v50|, |map[f18 := !f19[safeIndex(17, f19.Length)]]|, |(map[p0 := v40] + v48)|, f23, f20, p2, f20, f20, f23, |(if (!f18) then v20 else v20)|, |v52|, p0 * f20, p0];
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		...
		var v7: map<int, bool> := map[|v3| := v4[safeIndex(|v6|, |v4|)]];
		f19[safeIndex(79, f19.Length)] := v0 != {-|v1|};
		f19[safeIndex(79, f19.Length)] := v2.f18;
		var i0 := 0;
		while (true)
			decreases 100 - i0
		{
			...
			if (v2.f18) {
				...
				v17[safeIndex(325, v17.Length)] := f23;
				v17[safeIndex(325, v17.Length)] := -p0;
				v17 := v17;
			} else {
				globalState.f14 := f23;
				var v18 := new C2(f17 * v2.f17, f20 == f20);
				var v19: map<bool, int> := map[f19[safeIndex(79, f19.Length)] := f20];
				...
				var v25 := DC26(f19[safeIndex(79, f19.Length)], |v5|);
				var v26: array<multiset<bool>> := new multiset<bool>[9] [multiset{v2.f18}, multiset([true]) + v22, multiset{v24.cf17, true, v2.f18, v2.f18}, v22, v22, (multiset(v4))[v2.f18 := abs(f23)], fm29(globalState) * v22, v22 - v22, multiset{v25.cf48}];
				v26[safeIndex(531, v26.Length)] := v22;
				var v27: seq<multiset<bool>> := [fm29(globalState), fm29(globalState)];
				v26[safeIndex(531, v26.Length)] := v27[safeIndex(f23, |v27|)];
			}
			
			v1 := v1[f20 := v2.f18];
			var v28 := 'h';
			var v29: map<int, set<int>> := map[f20 := {|v6|, f23}];
			var v30: set<bool> := {f19[safeIndex(79, f19.Length)], f19[safeIndex(79, f19.Length)]};
			var v31: seq<int> := [fm0(|v6|, v28, globalState), safeDivisionInt(f20, f20), safeModuloInt(f20, |(if (p0 in v29) then v29[p0] else {|v30|})|)];
			var v32: map<bool, int> := map[f24 := p0];
			var v33 := DC0(fm13(globalState));
			var v34 := DC9();
			var v35: seq<D3> := [v34, v34];
			var v36 := DC11(v35);
			var v38: array<int> := new int[16] [f23, fm7(f20, v32, v33, globalState), f20, p0 - 0x2b8, safeModuloInt(-f20, f20), safeModuloInt(f23, 0x1b8), -p0, |v30|, DC13(f24, p0, v36).cf24, p0, p0, if (f19[safeIndex(79, f19.Length)] in v32) then v32[f19[safeIndex(79, f19.Length)]] else p0, safeDivisionInt(|(map v37 : int | v37 in v1 :: (v37 - -p0) := (v28))|, |v4|), safeModuloInt(p0, f23), f20, if (v2.f18 in v32) then v32[v2.f18] else -f23];
			v38[safeIndex(352, v38.Length)] := f23 + f23;
			v31, v38[safeIndex(352, v38.Length)], globalState.f14 := v31 + v31, safeDivisionInt(-f20, f20), p0;
		}
		var v39 := DC27(v4[safeIndex(f23, |v4|) := f19[safeIndex(79, f19.Length)]], p0, f20);
		...
		var v46: array<int> := new int[16] [p0 + -p0, p0, f23, -(if (f23 in v6) then v6[f23] else f20), v39.cf52, f20, f20, p0 + f20, safeDivisionInt(0x24c, -132), 0x143, |map[v40[safeIndex(f20, |v40|)] := f20]|, safeModuloInt(|v41|, f20), p0, f23, fm0(f23, v42, globalState), if ((v45.(cf10 := v43)).cf9) then f20 else |v0|];
		v46[safeIndex(610, v46.Length)] := 358;
		v46[safeIndex(610, v46.Length)] := -|(v5 + v5)|;
		globalState.f3, v4 := f24, v4;
		var v47: map<char, int> := map[v42 := v46[safeIndex(610, v46.Length)]];
		...
		v51[safeIndex(608, v51.Length)] := v46;
		v51[safeIndex(608, v51.Length)] := v46;
		r0 := f23;
		r1 := !f18;
		r2 := fm4(v46[safeIndex(610, v46.Length)] + |(seq(abs(0x289), i2  => (v42)))|, globalState);
	}
}
...
class C9 extends T2 {
	...
	method m0(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		var v0 := 't';
		var v1: set<string> := {("x")[safeIndex(p0, |"x"|) := v0]};
		v1 := v1;
		var v2: seq<bool> := [!f18];
		var v3: seq<seq<bool>> := [v2, v2];
		var v4: array<seq<seq<bool>>> := new seq<seq<bool>>[6] [v3, v3, v3, v3, v3, v3 + v3];
		v4[safeIndex(92, v4.Length)] := v3;
		f19[safeIndex(965, f19.Length)] := p1;
		var v5: multiset<bool> := multiset{!p1};
		var v7: map<int, bool> := map[f22 := f18];
		var v8: seq<int> := [p2, f22, p0];
		r0, r0, v4[safeIndex(92, v4.Length)], f19[safeIndex(965, f19.Length)] := !(if (f18) then p1 else !f18), !((if (f18) then multiset([f18]) else v5) !! v5), seq(abs(-0x8c), i0  => ([p1, f18, p1, !p1, f18])), fm1(map[map v6 : int | v6 in v7 :: (v6 * -f22) := (f22) := |v8|], globalState);
		var i1 := 0;
		while (f19[safeIndex(965, f19.Length)])
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			v9[safeIndex(102, v9.Length)] := v0;
			var v10 := "bmfhaq";
			var v11: multiset<char> := multiset{v0};
			var v12: map<int, int> := map[|v11| := p2];
			var v13: map<map<int, int>, int> := map[v12 := p0];
			f22, r0, v9[safeIndex(102, v9.Length)], r2 := |(v10 + v10)|, fm1(v13, globalState), v0, 0x31b;
			var v14: map<bool, bool> := map[f19[safeIndex(965, f19.Length)] := true];
			if (!f19[safeIndex(965, f19.Length)] in v14) {
				globalState.f3 := p1;
				r2, globalState.f3, r1, globalState.f14, f19[safeIndex(965, f19.Length)] := f22, v9[safeIndex(102, v9.Length)] !in v10, f19[safeIndex(965, f19.Length)], fm0(v8[safeIndex(f20, |v8|)], v0, globalState), f20 in v12;
				v10 := "jdrmxxf";
				r0 := !p1 || (if (p1) then f19[safeIndex(965, f19.Length)] else v2[safeIndex(f20, |v2|)]);
				f19[safeIndex(965, f19.Length)] := v0 !in (v10 + v10);
			} else {
				var v15: array<bool> := new bool[15](i3 => f19[safeIndex(965, f19.Length)]);
				var v16: T2 := new C6(map[f19[safeIndex(965, f19.Length)] := f20], f20, f20, f21, v15, f17, f18);
				var v17: set<T2> := {v16, v16};
				globalState.f14 := if (f19[safeIndex(965, f19.Length)]) then |v10| else f20 * |v17|;
				globalState.f14 := f22;
				var v18 := new C3(v15, {v15} + f17, v16.f20 !in v7);
				v9[safeIndex(102, v9.Length)] := v9[safeIndex(102, v9.Length)];
				f19[safeIndex(965, f19.Length)] := !f19[safeIndex(965, f19.Length)];
			}
			...
			if (p1) {
				...
				var v23 := DC27(v2[safeIndex(f20, |v2|) := f18], p0, p2);
				var v24 := DC1(v10 + ("hcpfqafh")[safeIndex(p2, |"hcpfqafh"|) := v9[safeIndex(102, v9.Length)]], safeDivisionInt(-v23.cf51, p0), p0, v0);
				v24 := v24;
				globalState.f9 := p1;
			} else {
				var v25: array<bool> := new bool[11] [f18, f18, f18, fm13(globalState), !fm1(v13, globalState), f18, false, f19[safeIndex(965, f19.Length)], f18, p1, f18];
				...
				var v28: C0 := new C0();
				v28 := v28;
				var v29: set<bool> := {f19[safeIndex(965, f19.Length)]};
				var v30 := DC15(v2);
				var v31: multiset<int> := multiset{f20};
				var v32: array<seq<bool>> := new seq<bool>[17] [v2 + v2[safeIndex(p0, |v2|) := false], if (v27.f24) then v2 else v2, v2, v2[safeIndex(0x1fa, |v2|) := v27.f24], v30.cf29, v2, v2, v2[safeIndex(p0, |v2|) := false], v2 + fm16(globalState), v2, fm16(globalState), v2, [f18, f18, f18, p1, p1] + v2, v2, fm16(globalState), v2, v2[safeIndex(|v31|, |v2|) := f18] + v2];
				v32[safeIndex(2, v32.Length)] := v2;
				var v33: seq<set<bool>> := [fm37(f18, f22, f18, v27.f24, globalState)];
				var v34: multiset<set<bool>> := multiset{v33[safeIndex(|v14|, |v33|)] * v29};
				v29, f22, v32[safeIndex(2, v32.Length)], v34 := {|v10| == p2}, |v8| * |fm40(p1, f19[safeIndex(965, f19.Length)], globalState)|, v2 + v2, v34;
		...
		var v42 := DC4(f19[safeIndex(965, f19.Length)], v41, -445);
		var v43: seq<D1> := [v42];
		...
		v36, v38, globalState.f14, v36, r2 := v36, v38, p0, ((v36[safeIndex(p0, |v36|) := v0] + ((if (v47 in v48) then v48[v47] else v36) + v36))[safeIndex(|(v2 + v2[safeIndex(100, |v2|) := f19[safeIndex(965, f19.Length)]])|, |(v36[safeIndex(p0, |v36|) := v0] + ((if (v47 in v48) then v48[v47] else v36) + v36))|) := v0])[safeIndex(|v36|, |(v36[safeIndex(p0, |v36|) := v0] + ((if (v47 in v48) then v48[v47] else v36) + v36))[safeIndex(|(v2 + v2[safeIndex(100, |v2|) := f19[safeIndex(965, f19.Length)]])|, |(v36[safeIndex(p0, |v36|) := v0] + ((if (v47 in v48) then v48[v47] else v36) + v36))|) := v0]|) := v0], p0;
		var i4 := 0;
		while (p1 ==> f18)
			decreases 100 - i4
		{
			...
			v50[safeIndex(82, v50.Length)] := v49;
			globalState.f9, v45, v50[safeIndex(82, v50.Length)], globalState.f3 := f18, v45 - v45, map[v2 := v0], f19[safeIndex(965, f19.Length)];
			...
			decreases 100 - i5
		{
			...
			r0 := !f18;
			if (false) {
				var v51: map<bool, bool> := map[f19[safeIndex(965, f19.Length)] ==> f18 := !v42.cf9];
				var v52: T0 := new C2(f17, p1);
				var v53: multiset<T0> := multiset{v52};
				v51 := v51[v42.cf9 := multiset{v52} !! v53];
				v0 := v0;
				v2 := v2[safeIndex(|v36[safeIndex(f20, |v36|) := v0]|, |v2|) := f19[safeIndex(965, f19.Length)]] + ([f19[safeIndex(965, f19.Length)]])[safeIndex(f22, |[f19[safeIndex(965, f19.Length)]]|) := v52.f18];
				...
				var v55 := DC0(f19[safeIndex(965, f19.Length)]);
				v0 := fm33(fm7(p2, map[p1 := f22], v55.(cf0 := f18), globalState), f19[safeIndex(965, f19.Length)], globalState);
				...
				var v62: map<bool, bool> := map[true := f19[safeIndex(965, f19.Length)]];
				v59[safeIndex(900, v59.Length)] := (map[v61 := v62])[v61 := v62];
				var v63: map<multiset<bool>, C5> := map[v5 := v61];
				var v64: map<C5, map<bool, bool>> := map[if (v5 in v63) then v63[v5] else v61 := v62];
				v59[safeIndex(900, v59.Length)] := v64;
			...
			var v68: array<bool> := new bool[8](i6 => f19[safeIndex(965, f19.Length)]);
			var v70: C8 := new C8(p0, f19[safeIndex(965, f19.Length)], v68, f17, f18, p2, map v69 : char | v69 in v46 :: (v69) := (p1));
			var v71: array<C8> := new C8[10] [v70, v70, v70, v70, v70, v70, v70, v70, v70, v70];
			var v72: set<array<C8>> := {v71};
			v72 := v72;
			f22 := p2;
		}
		var v73: set<bool> := {f19[safeIndex(965, f19.Length)], f18};
		r0 := |v36| > |v73|;
...
function fm4(p0: int, globalState: GlobalState): int {
	safeDivisionInt(997, safeDivisionInt(DC26(true, 0xd4).cf49, |(seq(abs(897), i0  => (-0x1e6)))|))
}
...
function fm8(p0: bool, p1: bool, p2: char, globalState: GlobalState): map<map<int, int>, D0> {
	if ([true] == [true, true]) then map[map[-0x312 := -0x15c] := DC0(false)] else map[map v0 : int | v0 in multiset{|"kgxwf"|} :: (v0 + |map[false := DC3(multiset{|(seq(abs(-0x3ad), i0  => ('b')))|, |map[true := false]|})]|) := (-0x18) := DC0(true)] + map[map v1 : int | (0x360 <= v1) && (v1 < 366) :: (v1 - |map[490 := false]|) := (|[!true, false, true]|) := DC0(false)]
}
function fm9(p0: char, globalState: GlobalState): map<int, bool> {
	map[|(seq(abs(-0x3e3), i0  => ('y')))| := {true} !! {false, true}]
}
function fm10(globalState: GlobalState): string {
	"csqbv"
}
function fm11(p0: int, p1: bool, p2: D2, globalState: GlobalState): set<map<int, bool>> {
	({map v0 : int | (939 <= v0) && (v0 < 0x8) :: (v0 + |map['a' := true]|) := (false), map[-|"ymwukergo"| := false], map[|"aax"| := true], map[-|"ahojjj"| := false]} + (set v3 : map<int, bool> | v3 in [map v1 : int | (0x204 <= v1) && (v1 < 408) :: (v1 + 531) := (false), map[|{true, false}| := true], map v2 : int | v2 in (seq(abs(0x269), i0  => (-0x3e3))) :: (safeModuloInt(v2, |"agsobcif"|)) := (!false)] :: (v3))) + (set v4 : map<int, bool> | v4 in multiset{map[899 := false]} :: (v4))
}
function fm12(p0: D0, globalState: GlobalState): char {
	'j'
}
function fm13(globalState: GlobalState): bool {
	(map v0 : seq<int> | v0 in map[[|[0xbd]|] := seq(abs(744), i0  => ('r'))] :: (v0) := (false)) != (map v1 : seq<int> | v1 in [[|"ogphrbwfb"|, |multiset{0x197, -|{true}|}|]] :: (v1) := (!true))
}
...
function fm18(p0: char, p1: bool, p2: int, p3: bool, globalState: GlobalState): D3 {
	DC10(['v', 'l'], true, "mlnbv", seq(abs(0x268), i0  => ('k')), safeModuloInt(0x303, -|"vojrh"|))
}
...
function fm24(p0: bool, p1: int, globalState: GlobalState): multiset<int> {
	(multiset([-244]) - multiset{|(set v0 : seq<int> | v0 in {[0xdc], [|multiset{true}|, 0x94]} :: (v0))|}) - (multiset{|DC15([false]).cf29|, 0xcf} * multiset{|[|multiset{|[true]|}|, |map[true := 0x368]|]|, |(seq(abs(0xb1), i0  => (0xe2)))|})
}
...
function fm32(globalState: GlobalState): map<seq<bool>, map<int, int>> {
	map[[false, !true, true, false] := map[-0x172 := |multiset{true}|]] + map[[!false] := map v0 : int | (0xd7 <= v0) && (v0 < 0x343) :: (v0 * |(set v1 : int | (-54 <= v1) && (v1 < 615) :: (v1 + |[|"vrmfs"|]|))|) := (|{|map[false := -|(seq(abs(0x30a), i0  => (|"gavh"|)))|]|, |"hdtu"|, |multiset{|map['d' := true]|}|}|)]
}
...
function fm36(globalState: GlobalState): map<int, string> {
	if (|['m']| in {|map[0x2a1 := {-|[|"cwaejs"|]|, 0xd5, |(seq(abs(-0x39f), i0  => (|map[true := |[false]|]|)))|}]|, 732, |{true}|}) then map[0x203 := seq(abs(0x33), i1  => ('y'))] else map[-|multiset{!false, true}| := "y"] + map[|{false, false}| := "ay"]
}
function fm37(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): set<bool> {
	{false} + ({false, false} - {DC13(!!false, |(seq(abs(546), i0  => ('g')))|, DC11([DC9()])).cf23, false})
}
function fm38(p0: int, p1: bool, globalState: GlobalState): map<int, bool> {
	(map v0 : int | v0 in multiset{|multiset{'s'}|} :: (v0 * |multiset{'q'}|) := (!!!false)) + (if (false) then map v1 : int | (715 <= v1) && (v1 < 0xcb) :: (safeDivisionInt(v1, -0x202)) := (true) else map[|multiset{'p', 'm'}| := true])
}
...
function fm40(p0: bool, p1: bool, globalState: GlobalState): seq<int> {
	(seq(abs(0x20c), i0  => (-|"dce"|))) + [|[|"oeo"|, |(seq(abs(0x350), i1  => ('b')))|]|, 0x9d]
}
function fm41(p0: int, p1: bool, p2: string, p3: char, globalState: GlobalState): D5 {
	DC13(!(false <== !!true), safeModuloInt(0x22c, 0x296), DC11([DC9()]))
}
function fm42(p0: multiset<bool>, p1: bool, p2: seq<bool>, globalState: GlobalState): set<int> {
	(set v0 : int | (0x25c <= v0) && (v0 < 271) :: (safeModuloInt(v0, |"po"|))) * ({|{!!false}|} + {|map[|(seq(abs(946), i0  => (|[true, true]|)))| := false]|, |{true, true}|})
}
function fm43(globalState: GlobalState): map<bool, int> {
	(map[false := |map[false := true]|] + map[true := |(seq(abs(72), i0  => ('d')))|]) + map[true := 993]
}
function fm44(p0: int, globalState: GlobalState): D5 {
	DC14(multiset{|{false}|} <= multiset([|"dwcbpk"|]), |map[false := seq(abs(518), i0  => ('x'))]| * |"evt"|, |map[|map[!false := false]| := !false]| - 0x131)
}
...
method Main() {
	...
	var v10 := "yvxdaq";
	var v11 := 'v';
	var v12: map<map<int, int>, string> := map[v9 := v10[safeIndex(|v7|, |v10|) := v11]];
	v1[safeIndex(749, v1.Length)] := if (v9 in v12) then v12[v9] else "angrdqnc";
	globalState.f3, v1[safeIndex(749, v1.Length)], globalState.f9 := v3, "wagfakwvy", v3;
	if (v3) {
		...
		var v17 := new C5(seq(abs(0x1be), i1  => (v1[safeIndex(749, v1.Length)][safeIndex(|map[v2 := v3]|, |v1[safeIndex(749, v1.Length)]|)])), v3, safeModuloInt(0x3c9, -v2), v13, v15, v16 - v16, v3);
		v0[safeIndex(676, v0.Length)] := 0x374;
		v0[safeIndex(676, v0.Length)] := 0x7;
		var v18 := DC26(v3, |{v0[safeIndex(676, v0.Length)]}|);
		var v19 := DC28(v18);
		var v20 := DC28(v19);
		var v21 := DC28(v20);
		v21 := v21.(cf53 := v19);
		if (v3) {
			...
			v0[safeIndex(676, v0.Length)] := -|((v22 - v22) - (v22 + v22))|;
			v10 := seq(abs(0x323), i2  => (v11));
			var v23: map<set<int>, seq<bool>> := map[v7 - v7 := if (v3) then v4 else v4];
			v23 := v23[v7 - v7 := [v17.f30, v17.f30, v3, !v3, !!v17.f30]];
			var v24 := DC14(if (v17.f30) then v3 else v17.f30, safeDivisionInt(0x1d3, v2), v0[safeIndex(676, v0.Length)]);
			v24 := v24;
			var v25: seq<int> := [v0[safeIndex(676, v0.Length)]];
			var v26: multiset<char> := multiset{v11};
			globalState.f14 := v25[safeIndex(|(v10 + v1[safeIndex(749, v1.Length)])[safeIndex(|v26|, |(v10 + v1[safeIndex(749, v1.Length)])|) := v11]|, |v25|)];
		} else {
			var v27: C9 := new C9(|v5|, v2, map[v11 := v17.f30], v15, v16, v17.f30);
			var v28: map<C9, int> := map[v27 := -v27.f22];
			var v29, v30, v31 := v17.m0(if (v3) then if (v27 in v28) then v28[v27] else v0[safeIndex(676, v0.Length)] else v2, v3, v27.f22, globalState);
			...
			var v42: array<seq<int>> := new seq<int>[25] [v37, v37, [v27.f22, v27.f22], fm40(!v30, v30, globalState), v37, v37, v37, v37 + v37, v38[safeIndex(v27.f22, |v38|)], if (v29) then v37 else v37, v37, v37, v37, v37, [v2, v2, v2], v37, (seq(abs(0x85), i3  => (-v31))) + v37, v37, v37, seq(abs(-0x22e), i4  => (|v37|)), v37, v37 + [v40.cf6], seq(abs(0x22e), i5  => (v27.f22)), v37, [v2, |v41|] + [v27.f22]];
			v42 := v42;
			var v45: array<map<int, int>> := new map<int, int>[26] [v9, map v43 : int | (-0x340 <= v43) && (v43 < 0x37f) :: (safeDivisionInt(v43, v31)) := (v2), map[0xc1 := v27.f22], v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, map v44 : int | (0x2fd <= v44) && (v44 < 0x4) :: (safeModuloInt(v44, v27.f22)) := (|[v0[safeIndex(676, v0.Length)]]|), v9, v9, v9, v9, v9, v9, v9];
			var v46 := DC17(v45, v29, v0[safeIndex(676, v0.Length)]);
			var v47 := DC14(v34 !! v34, v46.cf33, 0x1c5);
			var v48 := DC9();
			var v49: seq<D3> := [v48, v48, v48];
			var v50 := DC11(v49);
			v15[safeIndex(501, v15.Length)] := v30;
			globalState.f9, v47, v50, v15[safeIndex(501, v15.Length)] := false, fm44(safeDivisionInt(v2, v17.fm0(0x3a2, v11, globalState)), globalState), v50, !v17.f30;
		}
		
		var v51: seq<int> := [v0[safeIndex(676, v0.Length)]];
		var v52: C1 := new C1();
		...
		v53[safeIndex(209, v53.Length)] := v52;
		var v54: T2 := new C8(|v5|, v3, v15, v16 + v16, v4 <= v4, v0[safeIndex(676, v0.Length)] + v2, map['l' := v17.f30]);
		var v55: seq<string> := [v10, v1[safeIndex(749, v1.Length)], seq(abs(0x24d), i6  => ('v')), v17.f29, "geplenmxg"];
		var v56: seq<multiset<int>> := [v5];
		globalState.f3, globalState.f14, v51, v53[safeIndex(209, v53.Length)], v54 := v17.f30, v54.f20, [|("xwcwqwn" + v1[safeIndex(749, v1.Length)])[safeIndex(|v55|, |("xwcwqwn" + v1[safeIndex(749, v1.Length)])|) := v17.f29[safeIndex(if (|v56| in v9) then v9[|v56|] else v54.f20, |v17.f29|)]]|], v52, v54;
	} else {
		var v57: array<bool> := new bool[28](i7 => v3);
		v57[safeIndex(154, v57.Length)] := v3 && v3;
		...
		v57[safeIndex(154, v57.Length)] := v62 > v62;
		if (v4[safeIndex(v60.f23, |v4|)]) {
			var v63 := DC22(v7);
			var v64: map<bool, D10> := map[v57[safeIndex(154, v57.Length)] := v63];
			var v65, v66, v67 := v60.m2(|v64[v3 := v63.(cf42 := v7)]|, globalState);
			v6[safeIndex(705, v6.Length)] := 'o';
			v6[safeIndex(705, v6.Length)] := v11;
			...
			var v81: map<bool, multiset<D14>> := map[502 > v2 := v80[v79 := abs(v60.f23)]];
			v78, globalState.f9, v81, v60.f23 := v78, v60.f24, v81, 0x2ec;
			var v82: multiset<bool> := multiset{v57[safeIndex(154, v57.Length)]};
			...
			var v86, v87, v88 := v60.m0(if (v84.cf32 in v82) then v82[v84.cf32] else v2, (seq(abs(0xc9), i8  => (v73.f21))) == v85, v60.f23, globalState);
			v87 := v73.f18;
			var v89: T0 := new C2({v73.f19, v73.f19, v73.f19, v57, v57}, false);
			var v90: C2 := new C2(v58, 0x232 == |map[|v10| := v89]|);
			var v91: seq<C2> := [v90];
			v90 := v91[safeIndex(v2 + |v10|, |v91|)];
			var v92, v93, v94 := v60.m0(safeDivisionInt(|v1[safeIndex(749, v1.Length)]|, -v73.f20), v73.f18 && v60.f24, v2, globalState);
		}
		
		var v95: map<int, bool> := map[v2 := v57[safeIndex(154, v57.Length)]];
		var v96: multiset<string> := multiset{v10};
		var v98: map<set<string>, bool> := map[set v97 : string | v97 in v96 :: (v97) := v57[safeIndex(154, v57.Length)]];
		v95 := v95[-0x4e := if ({v1[safeIndex(749, v1.Length)]} in v98) then v98[{v1[safeIndex(749, v1.Length)]}] else v3];
		v60.f23 := safeModuloInt(v60.f23, safeDivisionInt(v2, 797));
		var v99 := new C1();
	}
	...
	for i9 := v2 to v2 {
		...
		v108[safeIndex(618, v108.Length)] := v103.f24;
		var v109: map<int, char> := map[i9 := v11];
		var v110: C4 := new C4(|v109|, -0x2b0, v101, true);
		var v111: seq<C4> := [v110];
		v108[safeIndex(618, v108.Length)] := !(v111 < (v111 + v111));
		var v112 := DC10(v1[safeIndex(749, v1.Length)], v3, v1[safeIndex(749, v1.Length)], seq(abs(0x265), i11  => (v11)), v110.f25);
		...
		decreases 100 - i12
	{
		...
		match (DC19(v114)) {
			...
			case DC19(cf35) =>
				...
				v129[safeIndex(450, v129.Length)] := v1;
				var v130: map<seq<bool>, seq<bool>> := map[v4 := [v3, v3, v3]];
				v4, v129[safeIndex(450, v129.Length)], globalState.f3 := v4 + (if (v4 in v130) then v130[v4] else v4), v1, !!v3;
				globalState.f14 := v2;
				var v131 := DC19(cf35);
				var v132 := DC21(v131);
				var v133 := DC21(v131);
			...
			case DC21(cf41) =>
				...
				v134[safeIndex(584, v134.Length)] := if (v137.cf23) then v141 else v141;
				v134[safeIndex(584, v134.Length)] := v141;
				v1[safeIndex(749, v1.Length)] := v1[safeIndex(749, v1.Length)];
				v9 := v9[v2 := v2 + v2];
		...
		var v145: map<int, D2> := map[safeDivisionInt(v2, |v1[safeIndex(749, v1.Length)]|) := DC5(v144)];
		var v146 := DC5(v144);
		v145 := v145[-v2 := v146];
		...
		v148[safeIndex(198, v148.Length)] := v149;
		v148[safeIndex(198, v148.Length)] := v149;
	}
	if (v3) {
		if (!((if (v3) then v2 else v2) <= v2)) {
			...
			v150 := v150[safeIndex(v2, |v150|) := v1[safeIndex(749, v1.Length)]];
			var v151: array<array<seq<int>>> := new array<seq<int>>[24];
			var v152: seq<int> := [v2];
			var v153: seq<seq<int>> := [v152, v152];
			var v154: array<seq<int>> := new seq<int>[10] [v152, v152, v153[safeIndex(|v4|, |v153|)], v152, v152, v152, v152, v152, v152, DC18(v152).cf34];
			v151[safeIndex(16, v151.Length)] := v154;
			v151[safeIndex(16, v151.Length)] := new seq<int>[5];
			...
			var v159: C7 := new C7(v152[safeIndex(-841, |v152|)], fm45(v5, |v158|, v3, globalState), v155, v157.f17, fm13(globalState));
			v159 := v159;
		} else {
			...
			v161[safeIndex(504, v161.Length)] := v3;
			var v162 := DC0(fm13(globalState));
			v161[safeIndex(504, v161.Length)] := safeModuloInt(v2, v2) < (if (false) then |v10[safeIndex(v2, |v10|) := fm12(v162, globalState)]| else -v2);
			var v163: multiset<array<bool>> := multiset{v161};
			v161[safeIndex(504, v161.Length)] := v163 != v163;
			globalState.f14 := v2;
		}
		...
		var v165: map<int, bool> := map[v2 := 341 <= |v1[safeIndex(749, v1.Length)]|];
		v165 := v165[|[v3]| := !(v1[safeIndex(749, v1.Length)] < "kpts")];
		globalState.f14 := |v1[safeIndex(749, v1.Length)]|;
		globalState.f3 := v3 && v3;
		v6[safeIndex(782, v6.Length)] := v11;
		v6[safeIndex(782, v6.Length)] := 'r';
		var v166 := DC6(|v1[safeIndex(749, v1.Length)]|);
		var v167 := DC7(v166);
		match (v167) {
			case DC6(cf13) =>
				v0[safeIndex(839, v0.Length)] := cf13;
				v0[safeIndex(839, v0.Length)] := cf13;
				...
				v172 := v172[v171 := v0[safeIndex(839, v0.Length)]];
				v0[safeIndex(839, v0.Length)] := cf13;
			...
			case DC5(cf12) =>
				...
				var v178 := new C8(fm7(v2, map[!v3 := 274], v174.(cf0 := true), globalState), v3, v175, v176, v6[safeIndex(782, v6.Length)] !in v10, if (v2 in v9) then v9[v2] else v2, v177);
				var v179: C5 := new C5(v10, v178.f24, v2, v177, v175, v176, v3);
				v179 := v179;
				v175[safeIndex(475, v175.Length)] := v178.f24;
				v175[safeIndex(66, v175.Length)] := !v179.f30;
				var v180: map<bool, bool> := map[v179.f30 := v178.f24];
				var v181 := DC1(v1[safeIndex(749, v1.Length)], |v180|, v178.f23, v11);
				v175[safeIndex(475, v175.Length)], v2, globalState.f14, v175[safeIndex(66, v175.Length)] := v178.f24, v2 - (v181.(cf3 := v2, cf4 := v6[safeIndex(782, v6.Length)])).cf3, v178.f23, !(v178.f23 > v2);
			case DC7(cf14) =>
				var v183: map<char, int> := map[v11 := v2];
				var v184: array<bool> := new bool[20](i20 => DC10(v10, v3, v1[safeIndex(749, v1.Length)], "go", v2).cf17);
				var v185: C7 := new C7(0x384, map v182 : char | v182 in v183 :: (v182) := (false), v184, {v184, v184, v184, v184, v184}, v3);
				v185 := v185;
				var v186: map<bool, set<int>> := map[v4[safeIndex(v2, |v4|)] := v7];
				var v187: map<char, char> := map[v6[safeIndex(782, v6.Length)] := v11];
				...
				v195[safeIndex(774, v195.Length)] := v186;
				v195[safeIndex(774, v195.Length)] := v186 + v186;
				v6[safeIndex(782, v6.Length)] := 'r';
				var v196: seq<int> := [0x31c];
				var v197: seq<seq<int>> := [v196, [v2]];
				globalState.f14 := -fm7(v2, map[true := |v197[safeIndex(|v5|, |v197|)]|], DC0(!fm13(globalState)), globalState);
		}
		...
		decreases 100 - i23
	{
		...
		v212 := v212;
		var v215 := DC22(set v214 : int | v214 in v201 :: (safeModuloInt(v214, 0xee)));
		var v216: map<int, D10> := map[|v9| := v215];
		var v217, v218, v219, v220 := v199.m5(|((map v213 : int | (-0x260 <= v213) && (v213 < 634) :: (safeModuloInt(v213, v2)) := (DC22(v7))) + v216)|, globalState);
	}
		...
		decreases 100 - i25
	{
		...
		v237[safeIndex(733, v237.Length)] := v236;
		v198[safeIndex(837, v198.Length)] := v3;
		v237[safeIndex(733, v237.Length)], globalState.f14, v198[safeIndex(837, v198.Length)], globalState.f3, v2 := v236, v236.f20, v227, !v224, safeModuloInt(0x393, v2);
		var v238 := new C3(v236.f19, v234 + v236.f17, v223);
		var v239: array<set<array<int>>> := new set<array<int>>[28];
		var v240: set<array<int>> := {v0};
		v239[safeIndex(785, v239.Length)] := v240;
		var v241: T1 := new C3(v236.f19, v236.f17, v236.f18);
		var v242: map<int, T1> := map[v2 := v241];
		v239[safeIndex(785, v239.Length)], v2 := (v240 * v240) - v240, |v242|;
		...
		var v253: array<map<D2, bool>> := new map<D2, bool>[24] [v243, fm47(v228, globalState), fm47(v3, globalState) + map[v244 := v227], if (v236.f18) then v243 else map[v244 := false], v243, v243 + v243, map v245 : D2 | v245 in v246[safeIndex(v236.f20, |v246|) := DC5(multiset{!v3})] :: (v245) := (v224), (map v247 : D2 | v247 in (seq(abs(0x33e), i26  => (v244))) :: (v247) := (v236.f18))[v244 := v3], v243, v243 + v243, v243, map[v244 := v3], v243 + v248[safeIndex(0x9d, |v248|)], map v249 : D2 | v249 in v246 :: (v249) := (DC14(false, |{v236.f20, v236.f20}|, v236.f20).cf26), map v250 : D2 | v250 in v246[safeIndex(v2, |v246|) := v244] :: (v250) := (v232), v243 + v243, v243, fm47(v3, globalState), v243, map v251 : D2 | v251 in v252 :: (v251) := (v236.f18), v243, fm47(v224, globalState), v243, v243];
		v253[safeIndex(115, v253.Length)] := map v254 : D2 | v254 in v252 :: (v254) := (v241.f18);
		var v255: array<seq<int>> := new seq<int>[25](i27 => v201);
		v255[safeIndex(688, v255.Length)] := v201 + v201;
		var v256: map<int, bool> := map[v236.f20 := v231];
		v225, globalState.f14, v253[safeIndex(115, v253.Length)], v255[safeIndex(688, v255.Length)] := v221, v236.f20, (if (false) then map[v244 := if (-278 in v256) then v256[-278] else v227] else fm47(false, globalState)) + v243, v201[safeIndex(v236.f20, |v201|) := -v2];
	}
	globalState.f3 := v232;
	print v1[9], "\n";
	print v2, "\n";
	print v3, "\n";
	print v4 == [false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false], "\n";
	print v5 == multiset{-548, 2}, "\n";
	print v6[0], "\n";
	print v6[1], "\n";
	print v6[2], "\n";
	print v6[3], "\n";
	...
	print globalState.f15 == multiset{0, 0, 3288, 3288}, "\n";
	...
	print v7 == {548}, "\n";
	print v8 == [{548}, {548}, {548}], "\n";
	print v9 == map[3 := 1], "\n";
	print v10, "\n";
	print v11, "\n";
	print v12 == map[map[3 := 1] := "yvxdaq"], "\n";
	print i12, "\n";
	print v198[0], "\n";
	print v198[1], "\n";
	print v198[2], "\n";
	...
	print v231, "\n";
	print v232, "\n";
	print v233 == multiset{false, false}, "\n";
	print i25, "\n";
}