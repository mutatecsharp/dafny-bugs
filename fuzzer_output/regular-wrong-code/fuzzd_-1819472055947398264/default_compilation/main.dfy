...
class C1 extends T0 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
			...
			decreases 100 - i0
		{
			...
			var v10 := DC24(v9);
			globalState.f9 := safeDivisionInt(|v10.cf39|, p0 * f45);
		...
		v13[safeIndex(448, v13.Length)] := v12;
		v13[safeIndex(448, v13.Length)] := (v12 + (seq(abs(411), i2  => (v4))))[safeIndex(p0, |(v12 + (seq(abs(411), i2  => (v4))))|) := -f45] + v12;
		...
		for i3 := if ((if (v17 in v18) then v18[v17] else v4) in v18) then v18[if (v17 in v18) then v18[v17] else v4] else |v18| to 0x1ed - -0x2da {
			...
			match (v20) {
				case DC4(cf4, cf5, cf6) =>
					...
					v21[safeIndex(680, v21.Length)] := !cf6;
					cf6, v18, v21[safeIndex(680, v21.Length)] := v16, v18[cf5 := |map[cf6 := v21]|] + map[v4 := cf5], !(v13[safeIndex(448, v13.Length)] != (v12 + v12));
					var v22: map<int, array<int>> := map[i3 := p1];
					v22 := v22;
					globalState.f3 := new int[23](i5 => i5 - |multiset{v17}|);
					globalState.f26 := (if (v16) then -v12[safeIndex(p0, |v12|)] else f45) * (cf5 * f45);
				...
				case DC6(cf10, cf11, cf12) =>
					...
					v26[safeIndex(16, v26.Length)] := v16;
					p1[safeIndex(860, p1.Length)] := i3;
					globalState.f1, v26[safeIndex(16, v26.Length)], p1[safeIndex(860, p1.Length)] := v3, f44, safeModuloInt(i3, fm0(cf11, v3, globalState));
					var v27: map<int, D8> := map[|cf12| := DC19(p0)];
					var v28: multiset<map<int, D8>> := multiset{v27};
					var v29: array<multiset<map<int, D8>>> := new multiset<map<int, D8>>[9] [v28 + v28, v28, v28, v28, multiset([v27, v27]), v28, v28, v28[v27 := abs(fm0(p0, f44, globalState))], v28 * v28];
					v29[safeIndex(242, v29.Length)] := v28;
					v29[safeIndex(242, v29.Length)] := v28;
					var v30: multiset<bool> := multiset{v26[safeIndex(16, v26.Length)]};
					v26[safeIndex(16, v26.Length)] := fm35(-i3, v30, v26[safeIndex(16, v26.Length)], set v31 : int | v31 in (seq(abs(0xf9), i7  => (|v18|))) :: (safeModuloInt(v31, |(seq(abs(-459), i8  => ('l')))|)), globalState);
					v17 := cf10;
				case DC3(cf3) =>
					globalState.f3 := p1;
					var v32: array<bool> := new bool[21](i9 => {false, v3} >= DC25({f44}).cf40);
					var v33: map<bool, bool> := map[v16 := v3];
					v32[safeIndex(73, v32.Length)] := !(v3 in v33);
					v32[safeIndex(792, v32.Length)] := v3;
					var v34: multiset<int> := multiset{v17};
					var v35: map<seq<int>, bool> := map[v13[safeIndex(448, v13.Length)] := f44];
					var v36: set<bool> := {v16};
					v3, v32[safeIndex(73, v32.Length)], v32[safeIndex(792, v32.Length)] := f44, ((if (i3 in v34) then v34[i3] else p0) != |v35|) && f44, fm35(p0 * p0, multiset{f44}, v3, (set v37 : int | v37 in map[|v36| := v19] :: (v37 - -|(map v38 : int | v38 in (seq(abs(0x369), i10  => (--0x3db))) :: (v38 - 0x2f8) := (true))|)) + v1, globalState);
					v32[safeIndex(73, v32.Length)] := v16;
					...
					v39[safeIndex(284, v39.Length)] := v40 + (map v41 : int | v41 in v13[safeIndex(448, v13.Length)] :: (v41 * v17) := (v32[safeIndex(73, v32.Length)]));
					v39[safeIndex(284, v39.Length)] := v40;
			}
			...
			v45 := v45[if (f44) then v16 else v16 := |v47[safeIndex(-v17, |v47|)]|];
			v4 := fm0(safeDivisionInt(f45, 0x30f), v16, globalState);
		}
		r0 := |v14| != -v4;
		r0 := {p1} !! {p1};
	...
	method m19(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: set<int>, r1: string, r2: bool, r3: int) {
		...
		globalState.f1 := !(((if (f44 in v2) then v2[f44] else multiset(v3[safeIndex(p1, |v3|) := "xlcatpicu"])) + multiset{v0}) !! (v1 + multiset(seq(abs(-0x18), i0  => (v0)))));
			...
			decreases 100 - i1
		{
			...
			var v11: map<multiset<int>, bool> := map[v10[fm0(f45, f44, globalState) := abs(p1)] := p2];
			v11 := v11 + v11;
			globalState.f1 := p0;
		}
	...
	method m20(p0: int, p1: bool, p2: bool, globalState: GlobalState) {
		...
		v1[safeIndex(589, v1.Length)] := f45;
		v1[safeIndex(589, v1.Length)] := -(p0 - p0);
		...
		v1 := new int[21] [v1[safeIndex(589, v1.Length)], |v0|, if (p1) then -p0 else p0, v1[safeIndex(589, v1.Length)], p0, |(v3 + map[v2 := 879])|, v1[safeIndex(589, v1.Length)], f45, 55, p0, f45, if (f44) then p0 else p0, v1[safeIndex(589, v1.Length)], p0, f45, f45 * v1[safeIndex(589, v1.Length)], p0, |v5|, p0, safeModuloInt(|v6|, -fm0(|v0|, f44, globalState)), v1[safeIndex(589, v1.Length)]];
		var v7: multiset<array<int>> := multiset{v1, v1};
		var v8 := DC11(v7);
		match (v8) {
			case DC12(cf21, cf22, cf23, cf24, cf25) =>
				cf21 := p2;
				var v9: multiset<int> := multiset{v6[safeIndex(-373, |v6|)], p0, p0};
				v9 := v9;
				globalState.f6, v4 := cf24, v4;
				var v10: multiset<bool> := multiset{p2, cf23};
				cf23 := f45 <= safeDivisionInt(-cf25, |v10|);
			case DC11(cf20) =>
				...
				v18 := if (p1) then v18 else v18[v1[safeIndex(589, v1.Length)] := "pfndmro"];
				globalState.f1 := f44;
		}
		
		var v19: array<bool> := new bool[5] [f44, f44, p2, false, p2];
		v19[safeIndex(913, v19.Length)] := p2;
		var v20: map<int, int> := map[v1[safeIndex(589, v1.Length)] := -857];
		var v21: multiset<bool> := multiset{p2, p2, f44, f44};
		var v22: set<int> := {|v21|};
		globalState.f1, v1[safeIndex(589, v1.Length)], globalState.f7, v19[safeIndex(913, v19.Length)] := v1[safeIndex(589, v1.Length)] < (if (p0 in v20) then v20[p0] else --p0), safeDivisionInt(|v0|, f45), (v22 - v22) - v22, false;
	}
}
...
class C2 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
		...
		if (!(p0 == 0x34e)) {
			...
			var v5: seq<int> := [p0];
			var v6 := "ormkj";
			globalState.f9 := safeDivisionInt(-|v4|, |v5| - v3.fm0(|v6|, f28, globalState));
			var v7: array<bool> := new bool[3];
			v7[safeIndex(136, v7.Length)] := f28;
			v7[safeIndex(136, v7.Length)] := v3.f44;
			var v8: multiset<bool> := multiset{f28, f28, f28, v7[safeIndex(136, v7.Length)], v7[safeIndex(136, v7.Length)]};
			var v9: seq<multiset<bool>> := [v8];
			v9 := seq(abs(0x148), i0  => (v8));
		} else {
			...
			if (v11.f44) {
				...
				globalState.f11 := -p0;
				r3 := v11.f44;
				v1[safeIndex(967, v1.Length)] := -0x1d5 + v11.f45;
				v1[safeIndex(967, v1.Length)] := p0;
				v1[safeIndex(967, v1.Length)] := p0;
			} else {
				var v16 := "gggrd";
				...
				v18 := v18[!((seq(abs(0x3db), i1  => (f47))) <= "jfw") := v16];
				...
				var v26 := DC13(v25);
				globalState.f7 := set v27 : int | v27 in (([370])[safeIndex(|v20|, |[370]|) := v11.f45] + v26.cf26) :: (safeModuloInt(v27, 0x281));
				v1[safeIndex(632, v1.Length)] := v11.f45;
				v1[safeIndex(632, v1.Length)] := safeDivisionInt(-447, v11.f45);
				globalState.f6 := v11.f45;
			}
			
			var v28: seq<array<int>> := [v0[safeIndex(371, v0.Length)], v0[safeIndex(371, v0.Length)], v0[safeIndex(371, v0.Length)]];
			if (v28 != v28) {
				v0[safeIndex(371, v0.Length)][safeIndex(243, v0[safeIndex(371, v0.Length)].Length)] := p0;
				var v29: seq<seq<bool>> := [[f28, f28]];
				var v30: seq<bool> := [v11.f44];
				v1[safeIndex(678, v1.Length)] := |(v29 + [v30])|;
				...
				v0[safeIndex(371, v0.Length)][safeIndex(243, v0[safeIndex(371, v0.Length)].Length)], globalState.f21, r3, v1[safeIndex(678, v1.Length)] := 222, v33, v11.f45 > p0, 0x5a;
				globalState.f1 := !(v11.f44 <==> (multiset{true} <= v31));
				globalState.f26 := safeDivisionInt(v11.fm0(v11.f45, f28, globalState), v11.f45);
				globalState.f26 := v1[safeIndex(678, v1.Length)];
				globalState.f1 := v11.f44;
			} else {
				var v34: seq<seq<char>> := [seq(abs(-0x17d), i2  => (f47))];
				var v35 := DC35(v34);
				v1[safeIndex(954, v1.Length)] := |(set v36 : seq<char> | v36 in multiset(v35.cf55) :: (v36))|;
				v0[safeIndex(371, v0.Length)][safeIndex(524, v0[safeIndex(371, v0.Length)].Length)] := safeModuloInt(v11.f45, v11.f45);
				var v37: array<D0> := new D0[8];
				var v38: map<array<int>, bool> := map[v1 := f28];
				v37[safeIndex(647, v37.Length)] := fm46(if (v1 in v38) then v38[v1] else v11.f44, globalState);
				var v39 := DC0(893);
				var v40: array<bool> := new bool[8];
				v1[safeIndex(954, v1.Length)], v0[safeIndex(371, v0.Length)][safeIndex(524, v0[safeIndex(371, v0.Length)].Length)], v37[safeIndex(647, v37.Length)], globalState.f26, globalState.f21 := v11.f45, p0, v39.(cf0 := v11.f45), --safeModuloInt(v11.f45, p0), v40;
				globalState.f11 := safeModuloInt(p0, if (v11.f44) then v11.f45 else -0x2be);
				var v41 := "iwknl";
				v41 := v41;
			...
			v1[safeIndex(853, v1.Length)] := -0x24e;
			v1[safeIndex(853, v1.Length)] := p0;
			r3 := true;
		}
		...
		if (fm47(p0, f28, v44[safeIndex(p0, |v44|)], !(v46 >= v46), globalState)) {
			...
			var v52 := DC7(v0[safeIndex(371, v0.Length)]);
			...
			v57[safeIndex(436, v57.Length)] := if (f28) then !f28 else !f28;
			var v58: seq<bool> := [f28];
			v57[safeIndex(436, v57.Length)] := !(v58[safeIndex(p0, |v58|)] <== !(p0 >= p0));
			globalState.f11 := v44[safeIndex(p0, |v44|)];
			v44 := seq(abs(0x395), i3  => (p0));
			globalState.f1 := !false;
			var v59 := DC38(safeDivisionInt(p0, p0), p0);
			v59 := v59.(cf64 := p0);
		}
		
		r0 := f47;
		v1 := v0[safeIndex(371, v0.Length)];
		if (f28) {
			if (f28) {
				globalState.f26 := safeDivisionInt(p0, p0);
				var v60: array<bool> := new bool[28];
				v60[safeIndex(57, v60.Length)] := f28 <== f28;
				v60[safeIndex(57, v60.Length)] := f28;
				var v61: map<bool, int> := map[v60[safeIndex(57, v60.Length)] := p0];
				v61 := v61[v60[safeIndex(57, v60.Length)] || false := p0];
				v43 := v43[p0 := |(seq(abs(0x246), i4  => (p0)))|];
				globalState.f11 := p0;
			} else {
				v1[safeIndex(976, v1.Length)] := |[fm48(p0, f28, globalState)]|;
				v1[safeIndex(976, v1.Length)] := p0;
				var v62: array<D2> := new D2[14];
				var v63: multiset<int> := multiset{v1[safeIndex(976, v1.Length)]};
				var v64 := DC5(f28, v63, v1[safeIndex(976, v1.Length)]);
				v62[safeIndex(725, v62.Length)] := v64;
				v62[safeIndex(725, v62.Length)] := v64;
				var v65: array<char> := new char[19];
				v65 := new char[5] [f47, f47, f47, f47, 'g'];
				globalState.f1 := f28;
				v1[safeIndex(976, v1.Length)] := v1[safeIndex(976, v1.Length)] + -p0;
			}
			
			r2 := p0;
			v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)] := safeModuloInt(p0, fm48(p0, true, globalState));
			v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)] := |"pbxv"|;
			var v66: map<bool, int> := map[f28 := p0];
			var v67 := DC15(v66);
			match (v67) {
				case DC15(cf28) =>
					var v68: seq<bool> := [f28];
					var v69: map<int, bool> := map[v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)] := v68[safeIndex(0x364, |v68|)]];
					var v71: map<set<int>, bool> := map[set v70 : int | (663 <= v70) && (v70 < 573) :: (safeModuloInt(v70, |{|(seq(abs(0xe7), i5  => (f47)))|}|)) := !f28];
					var v73: array<bool> := new bool[7];
					var v74: seq<array<bool>> := [v73];
					var v75: multiset<set<int>> := multiset{{|v74|}};
					var v76 := DC40(v75);
					var v77: map<bool, map<set<int>, bool>> := map[if (v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)] in v69) then v69[v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)]] else f28 := v71 + (map v72 : set<int> | v72 in (v76.(cf66 := v75)).cf66 :: (v72) := (f28))];
					v77 := v77[fm47(v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], f28, v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], f28, globalState) := map[set v78 : int | v78 in v44 :: (v78 * -0x1c3) := f28]];
					v73[safeIndex(631, v73.Length)] := f28;
					v73[safeIndex(631, v73.Length)] := fm47(p0, true, v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], !f28, globalState) || false;
					var v79 := DC18(v73[safeIndex(631, v73.Length)], v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)]);
					var v80: multiset<string> := multiset{v45, v45, fm50(v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)], true, globalState)};
					v79, r2 := fm49(v80, v73[safeIndex(631, v73.Length)], "kvq", globalState), v0[safeIndex(371, v0.Length)][safeIndex(829, v0[safeIndex(371, v0.Length)].Length)];
					globalState.f3 := v1;
			}
			...
			match (fm51(f28, map[v82 := p0], p0, globalState)) {
				case DC24(cf39) =>
					...
					v43 := (map[p0 := p0] + v83[safeIndex(p0, |v83|)]) + v43[p0 := p0];
					var v84 := new C0(true);
					var v85: array<string> := new string[5];
					v85 := v85;
					v0[safeIndex(371, v0.Length)][safeIndex(524, v0[safeIndex(371, v0.Length)].Length)] := safeDivisionInt(p0, p0);
					var v86: seq<bool> := [v84.f46];
					v0[safeIndex(371, v0.Length)][safeIndex(524, v0[safeIndex(371, v0.Length)].Length)] := |(v86 + v86[safeIndex(|v44|, |v86|) := v84.f46])|;
			}
			
			var v87: set<int> := {p0};
			globalState.f7 := v87;
			globalState.f9 := if (f28 <== f28) then p0 else safeDivisionInt(p0, p0);
			var v88: map<bool, bool> := map[f28 := f28];
			globalState.f11 := |{safeModuloInt(|v88|, p0), p0, if (f28) then p0 else p0, p0}|;
		...
		r0 := f47;
		r1 := p0;
		r2 := -safeDivisionInt(p0, -0x10f);
		r3 := f28;
	}
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		var v1: array<seq<int>> := new seq<int>[18](i1 => [-0x306, 925, |{f28, f28}|, 0x2c, 0x310] + DC13(seq(abs(0x21f), i2  => (|[DC37(|(map v0 : int | (-0x1f5 <= v0) && (v0 < 0x28e) :: (safeDivisionInt(v0, -364)) := (|map[f28 := f28]|))|, f28, -|map[f28 := f28]|, ["ltlyayts"]).cf60, f28]|))).cf26);
		forall i0 | 0 <= i0 < v1.Length {
			v1[i0] := seq(abs(0x136), i3  => (-(|(seq(abs(0x166), i4  => ('j')))| + 0x3e0)));
		}
		var v2 := 808;
		var v3: set<int> := {v2};
		var v4: seq<bool> := [f28];
		var v5: multiset<bool> := multiset{f28, v4[safeIndex(v2, |v4|)]};
		var v6: seq<multiset<bool>> := [v5];
		if (v3 <= {|v6|, v2}) {
			var v7: array<char> := new char[7];
			v7[safeIndex(755, v7.Length)] := f47;
			v7[safeIndex(755, v7.Length)] := if (!true) then f47 else 'f';
			r1 := f28;
			var v8: array<int> := new int[15];
			v8[safeIndex(691, v8.Length)] := v2;
			...
			v8[safeIndex(691, v8.Length)], globalState.f1, v14, globalState.f9, v16 := safeDivisionInt(|(seq(abs(0x27d), i6  => (map[!f28 := f28])))| + v2, v2), v4[safeIndex(827, |v4|)], v14[v12 := v13], v2, fm54(DC1(f28), v18[safeIndex(-v2, |v18|)], globalState);
			...
			if (f28) {
				...
				var v24 := DC6(v21[safeIndex(if (v22 in v23) then v23[v22] else v2, |v21|)], v2, v4 + v4);
				v24 := v24;
				var v25: array<multiset<char>> := new multiset<char>[9];
				v25 := new multiset<char>[14](i7 => multiset{f47, 'r'} + multiset{f47, f47, f47});
				globalState.f11 := safeDivisionInt(fm48(v2, f28, globalState), v2);
				globalState.f1 := f28;
				...
				v29[safeIndex(677, v29.Length)] := v31;
				var v33 := "gwslxf";
				var v34: seq<string> := ["hgqyejms"];
				r0, v29[safeIndex(677, v29.Length)], globalState.f1, globalState.f1 := f47, map v32 : int | (-0x330 <= v32) && (v32 < 0x15c) :: (safeDivisionInt(v32, |v4|)) := (v30), (v33[safeIndex(0x35b, |v33|) := f47] + v34[safeIndex(v2, |v34|)]) == v33, f28;
				...
				var v40: multiset<seq<bool>> := multiset{v4, [f28], v4[safeIndex(v2, |v4|) := f28], v4};
				var v41: array<bool> := new bool[13] [f28, f28, v2 != v2, f28, f47 in v33, f28, f28, f28, v38.cf16, true, multiset(v39) < v40, f28, !f28];
				v41[safeIndex(880, v41.Length)] := false;
				v41[safeIndex(880, v41.Length)] := f28;
			}
			...
			var v46: array<int> := new int[28] [|v4|, v2, v2, |v42|, v2, v2, v2 * v2, v2 + 0x129, v2, v2, v2 - v2, v2, |v43|, v2, v2, v2, v2, v2, safeDivisionInt(v2, -v2), v2, -v2, v2, if (f28 in v44) then v44[f28] else v45[safeIndex(v2, |v45|)], v2, v2, v2, v2, v2];
			v46[safeIndex(269, v46.Length)] := v2;
			var v47: map<string, multiset<bool>> := map[v43 := v5];
			var v49: seq<string> := [v43];
			var v50: seq<array<int>> := [v46, v46];
			globalState.f9, v46[safeIndex(269, v46.Length)], v47, globalState.f1 := v2, |(v43 + v43)|, map v48 : string | v48 in v49 :: (v48) := (v5), v46 !in v50;
			...
			globalState.f21 := new bool[21] [f28, f28, multiset{f28} >= v5, false, false, true, false, !!true, f28, f28, f28, !true, v4 == v4, |v3| != v2, f28, false, f28 && f28, v51 < v51, f28, false, if (v46[safeIndex(269, v46.Length)] in v53) then v53[v46[safeIndex(269, v46.Length)]] else f28];
			var v54: map<seq<int>, multiset<bool>> := map[v45 := multiset(v4) - multiset(fm42(v4, globalState))];
			v54, v1, globalState.f6 := v54, if (v2 >= v46[safeIndex(269, v46.Length)]) then v1 else v1, fm48(v2, f28, globalState);
			var v55: map<int, int> := map[v46[safeIndex(269, v46.Length)] := v2];
			v55 := v55[v2 := v2];
		}
			...
			decreases 100 - i9
		{
			...
			if (fm47(v2, f28, v2, f47 in v65, globalState)) {
				...
				v71[safeIndex(58, v71.Length)] := v69 >= (multiset{v2, v2})[v2 := abs(v2)];
				v71[safeIndex(58, v71.Length)] := v67.f46;
				globalState.f1 := -v2 > v2;
			} else {
				globalState.f6 := -0x47;
				var v72: map<bool, seq<bool>> := map[f28 := v4];
				v72 := v72[v2 == |"jkgfdv"| := v4[safeIndex(882, |v4|) := f28]];
				v2 := |v4|;
		...
		var v73: array<int> := new int[12] [v2, |(seq(abs(0x13c), i10  => (f47)))|, 909, v2, |(multiset{{v2}, v3})[v3 := abs(v2)]|, v2, v2, v2, v2, v2, v2, v2];
			...
			decreases 100 - i11
		{
			...
			v77[safeIndex(609, v77.Length)] := if (f28) then v73 else v73;
			v77[safeIndex(609, v77.Length)] := v73;
			if (f28) {
				var v78 := "wqqxvdddt";
				v78 := v78;
				...
				globalState.f9 := if (f28) then -safeModuloInt(0x1bd, v2) else v2;
				var v84 := "dhoa";
				globalState.f1 := f47 !in (v84 + v84[safeIndex(v2, |v84|) := f47]);
				var v85: seq<int> := [v2, v2];
				v1[safeIndex(939, v1.Length)] := v85 + v85[safeIndex(v2, |v85|) := v2];
				v1[safeIndex(939, v1.Length)] := v85;
				v74 := v74;
				var v86 := new C1(v4[safeIndex(-v2, |v4|)], |(v5[f28 := abs(v2)] - v5)|);
			}
			...
			match (v87) {
				case DC28(cf43, cf44, cf45, cf46, cf47) =>
					...
					v90[safeIndex(571, v90.Length)] := cf44;
					globalState.f6, globalState.f1, globalState.f26, v90[safeIndex(571, v90.Length)] := -v2, cf46, cf47, cf46;
					var v91: map<int, array<int>> := map[cf45 := v77[safeIndex(609, v77.Length)]];
				...
				case DC27(cf42) =>
					...
					globalState.f11, globalState.f11, r0, globalState.f1, globalState.f1 := v2, safeModuloInt(v2, v2), f47, if (!f28) then {false, true, f28, f28, f28} !! v98 else false, (v94 + v94) < "be";
					var v99: multiset<int> := multiset{v2, 0x50};
					v73[safeIndex(719, v73.Length)] := |v99|;
					v73[safeIndex(719, v73.Length)] := v2;
				case DC29(cf48) =>
					var v100 := "a";
					globalState.f1, v100, globalState.f11, globalState.f11 := v2 <= v2, (seq(abs(312), i12  => (f47)))[safeIndex(262, |(seq(abs(312), i12  => (f47)))|) := f47] + v100, v2, fm48(if (false) then v2 else v2, !(v2 >= v2), globalState);
					globalState.f6 := v2 * -0x201;
					globalState.f15 := f47;
					var v101: seq<array<array<int>>> := [v77, v77];
					var v102: map<bool, array<array<int>>> := map[f28 := v77];
					var v103: array<array<array<int>>> := new array<array<int>>[16] [v77, v77, v77, v77, v77, v101[safeIndex(|v4|, |v101|)], if (!f28 in v102) then v102[!f28] else v77, v77, v77, v77, if (f28) then v77 else v77, v77, v77, v77, v77, v77];
					v103[safeIndex(933, v103.Length)] := if (f28) then v77 else v77;
					var v104: seq<string> := [v100, ("kjtegf")[safeIndex(v2, |"kjtegf"|) := f47]];
					v103[safeIndex(933, v103.Length)] := if ((v100 <= v104[safeIndex(v2, |v104|)]) in v102) then v102[v100 <= v104[safeIndex(v2, |v104|)]] else v77;
			}
			
			var v105: array<map<string, seq<int>>> := new map<string, seq<int>>[10];
			var v106: seq<int> := [v2, v2, v2];
			var v107: map<string, seq<int>> := map[seq(abs(0x255), i13  => (f47)) := v106];
			v105[safeIndex(147, v105.Length)] := v107;
			var v108: map<int, bool> := map[v2 := f28];
			var v109 := "pttlgrj";
			v105[safeIndex(147, v105.Length)] := v107[fm50(v2, fm48(v2, f28, globalState), if (|v109| in v108) then v108[|v109|] else f28, globalState) := [v2]];
		}
		r0 := f47;
		r1 := f28;
		r2 := v2;
...
class C3 extends T0 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		if (f42) {
			...
			v0[safeIndex(949, v0.Length)] := "tkaqyfpk";
			var v1: seq<string> := [seq(abs(0x88), i1  => ('u'))];
			var v2: multiset<int> := multiset{p0};
			v0[safeIndex(949, v0.Length)] := v1[safeIndex(if (p0 in v2) then v2[p0] else p0, |v1|)] + (p2 + p2);
			if (v0[safeIndex(949, v0.Length)] < p2) {
				globalState.f6 := p0;
				var v3: seq<bool> := [f42, f42, false, true, f42];
				p1[safeIndex(17, p1.Length)] := |v3|;
				p1[safeIndex(17, p1.Length)] := fm0(p0, false, globalState);
				var v4: map<int, int> := map[|v0[safeIndex(949, v0.Length)]| := f43];
				var v5: seq<int> := [|p2|];
				var v6: seq<int> := [|v4|, f43, 704, -|v5|, f43];
				var v7: array<int> := new int[26] [|v3|, p0, p1[safeIndex(17, p1.Length)], f43, p0, p1[safeIndex(17, p1.Length)], |v3|, f43, p0, p0, f43, f43, 343, 0x6f, -0x21d, f43, p1[safeIndex(17, p1.Length)], f43, 74, p1[safeIndex(17, p1.Length)], f43, -0x269, p1[safeIndex(17, p1.Length)], |(multiset(v6))[f43 := abs(fm0(|v0[safeIndex(949, v0.Length)]|, f42, globalState))]|, p1[safeIndex(17, p1.Length)], p0];
				var v8: multiset<array<int>> := multiset{v7};
				var v9 := DC11(v8);
				var v10 := DC11(v9.cf20 + v8);
				var v11 := DC2(p1[safeIndex(17, p1.Length)]);
				var v12: set<bool> := {f42, f42};
				var v13: set<int> := {f43, p0, p0};
				var v14: set<set<int>> := {v13, v13, fm27(globalState), {p1[safeIndex(17, p1.Length)], f43, f43}};
				var v15 := DC1(f42);
				...
				var v19 := DC17(v0[safeIndex(949, v0.Length)]);
				var v20 := DC9(f43, f42);
				var v21: map<int, int> := map[|v17| := p0];
				var v22 := 'a';
				var v23: seq<bool> := [f42];
				var v24: map<char, bool> := map[v22 := v23[safeIndex(p0, |v23|)]];
				...
				var v29: set<bool> := {fm29(v0[safeIndex(949, v0.Length)], p2, p0, p0, globalState)};
				var v30: map<bool, bool> := map[f42 := f42];
				var v31: array<bool> := new bool[29] [f42, !(v17 <= v17), f42, f42, f42, f42, fm28(f43, v17[safeIndex(|v17|, |v17|)], seq(abs(0x1a6), i2  => ('e')), globalState) == fm28(|map[!v18.cf16 := f42]|, p0, v19.cf30, globalState), f42, f43 < f43, v20.cf18, !f42, f42 || f42, f42, f42, f42, f42, f42, 0x2cb <= f43, v21 != map[0x1d1 := f43], v25 < (if (v21 in v28) then v28[v21] else v25), true in v29, f42, f42, f42 in v30, f42, f42, f42, true, [f43, f43] < v17];
				v31[safeIndex(296, v31.Length)] := !false;
				var v32: multiset<array<bool>> := multiset{v31, v31, v31, v31};
				v31[safeIndex(296, v31.Length)] := fm30(f42, |v32|, globalState) < (v0[safeIndex(949, v0.Length)] + "kra");
				globalState.f1 := f42;
				globalState.f11 := safeModuloInt(p0, p0);
				p1[safeIndex(416, p1.Length)] := f43;
				p1[safeIndex(416, p1.Length)] := -(if (f42) then f43 else 852);
				var v33 := DC13(v17);
				p1[safeIndex(416, p1.Length)] := if (fm31(f42, fm32(globalState), globalState) == v33.cf26) then p1[safeIndex(416, p1.Length)] else f43;
			}
			...
			match (if (if (!!f42) then false else false) then DC8(p0, -|v1|, f42) else v34) {
				case DC8(cf14, cf15, cf16) =>
					...
					globalState.f6 := |v36| * |(v0[safeIndex(949, v0.Length)] + "ehxeriwod")|;
					p1[safeIndex(66, p1.Length)] := cf14;
					...
					var v43: array<bool> := new bool[5] [!(if (v40 in v41) then v41[v40] else cf16), cf16, v42[safeIndex(f43, |v42|)], f42, true];
					var v44: map<map<int, int>, array<bool>> := map[(map v37 : int | (0xb3 <= v37) && (v37 < 0x25f) :: (safeModuloInt(v37, 0x36f)) := (cf15)) + (map v38 : int | v38 in v39 :: (v38 - cf15) := (f43)) := v43];
					p1[safeIndex(66, p1.Length)] := |v44|;
					var v45: multiset<seq<int>> := multiset{v39};
					var v46 := 'v';
					var v47: seq<multiset<seq<int>>> := [multiset{v39}];
					var v48: seq<seq<int>> := [v39];
					var v49: map<bool, int> := map[f42 := if (p1[safeIndex(66, p1.Length)] in v2) then v2[p1[safeIndex(66, p1.Length)]] else cf14];
					var v50: array<multiset<seq<int>>> := new multiset<seq<int>>[22] [v45, multiset{fm31(cf16, v46, globalState), fm31(!f42, v46, globalState), seq(abs(939), i3  => (|map[cf16 := f42]|)), fm31(cf16, 'n', globalState)}, v45, multiset{v39}, fm33(!fm29(v0[safeIndex(949, v0.Length)], v0[safeIndex(949, v0.Length)], |v0[safeIndex(949, v0.Length)]|, f43, globalState), cf14, f42, cf16, globalState) * v45, v45, v45, v45 - v45, multiset{[f43], [cf15, |v2|, |v40|, f43], [cf15]}, v45, v47[safeIndex(cf15, |v47|)], v45 - v45, v45, v47[safeIndex(fm0(|p2|, f42, globalState), |v47|)], multiset{[269, p1[safeIndex(66, p1.Length)], f43]}, v45, multiset(if (cf16) then v48 else v48), v45, v45[v39 := abs(|v49|)], v45, multiset{v39}, v45];
					v50[safeIndex(764, v50.Length)] := v45;
					v50[safeIndex(764, v50.Length)] := v45 + multiset(v48);
				case DC9(cf17, cf18) =>
					var v51: map<int, array<int>> := map[f43 := p1];
					var v52 := DC21(v51);
					v0[safeIndex(949, v0.Length)], v0[safeIndex(949, v0.Length)], globalState.f6 := v0[safeIndex(949, v0.Length)], (seq(abs(-0x22d), i4  => ('l'))) + p2, safeDivisionInt(p0, |v52.cf36|);
					v2 := v2[-f43 := abs(-(if (cf18) then cf17 else cf17))];
					...
					v53[safeIndex(306, v53.Length)] := v56;
					v53[safeIndex(306, v53.Length)] := v56;
					var v57: array<bool> := new bool[16](i6 => cf18);
					v57[safeIndex(318, v57.Length)] := !false;
					v57[safeIndex(318, v57.Length)] := f42;
				case DC7(cf13) =>
					p1[safeIndex(27, p1.Length)] := f43 - 90;
					var v58: seq<bool> := [true];
					var v59: map<bool, int> := map[f42 := f43];
					var v60: multiset<bool> := multiset{f42};
					p1[safeIndex(27, p1.Length)] := |(v58 + v58)| - (if (f42 in v59) then v59[f42] else if (!f42 in v60) then v60[!f42] else 0x2e1);
					var v61 := DC5(!f42, multiset{-p1[safeIndex(27, p1.Length)]}, fm0(f43, false, globalState));
					v61 := if (f42) then v61 else v61;
					p1[safeIndex(27, p1.Length)] := fm0(0x2b0, f42, globalState) + f43;
					var v62: array<bool> := new bool[11] [f42, f42 <== f42, f42, f42, f42, if (f42) then f42 else f42, p0 > p1[safeIndex(27, p1.Length)], false, f42, !f42, if (f42) then f42 else f42];
					v62[safeIndex(712, v62.Length)] := false;
					var v63 := DC9(|v58|, f42);
					var v64: seq<D3> := [v63, v63, DC9(|p2|, f42)];
					var v65: seq<map<bool, int>> := [fm34(f42, p0, |v64|, globalState)];
					var v66: map<int, int> := map[|map[f42 := f42]| := p1[safeIndex(27, p1.Length)]];
					var v67 := DC12(f42, v66, !!f42, p0, p0);
					var v68: seq<D4> := [v67, v67];
					var v69 := 'r';
					var v70: set<int> := {f43};
					var v71: map<char, set<int>> := map[v69 := v70];
					globalState.f9, globalState.f7, v62[safeIndex(712, v62.Length)], v65 := |v68| - f43, if (v69 in v71) then v71[v69] else v70, f42, (seq(abs(337), i7  => (v59)))[safeIndex(f43, |(seq(abs(337), i7  => (v59)))|) := map[false := |v59|]];
				case DC10(cf19) =>
					var v72: array<set<int>> := new set<int>[19];
					var v73: array<D0> := new D0[10](i8 => DC0(-p0));
					v73[safeIndex(972, v73.Length)] := DC0(f43);
					var v74 := DC5(f42, v2, p0);
					var v75 := DC0(f43 - |v74.cf8|);
					v72, v73[safeIndex(972, v73.Length)], globalState.f9 := v72, v75, f43;
					var v76 := DC1(f42);
					v76 := v76;
					globalState.f1 := f42;
					globalState.f1 := f42;
			...
			if (f42) {
				...
				var v82: set<bool> := {v81[safeIndex(p0, |v81|)], f42};
				globalState.f11 := (if (f42) then |v82| else p0) - safeModuloInt(p0, p0);
				var v83 := new C0(true);
				var v84: set<char> := {v78, p2[safeIndex(f43, |p2|)]};
				var v85: seq<int> := [if (!v83.f46) then p0 else |v84|, f43];
				globalState.f11 := v85[safeIndex(safeDivisionInt(p0, f43), |v85|)];
				globalState.f26 := |(p2[safeIndex(f43, |p2|) := v78] + (seq(abs(517), i9  => (v78))))|;
				var v86 := DC2(f43);
			...
			decreases 100 - i10
		{
			...
			if (true) {
				...
				v91[safeIndex(438, v91.Length)] := true;
				...
				v96[safeIndex(359, v96.Length)] := p1;
				var v97: array<seq<string>> := new seq<string>[11];
				var v98: seq<string> := [p2];
				v97[safeIndex(444, v97.Length)] := v98 + v98;
				...
				v91[safeIndex(438, v91.Length)], v93, v96[safeIndex(359, v96.Length)], v97[safeIndex(444, v97.Length)], globalState.f1 := !((v99 + [f42, f42, f42, f42, f42]) == v99), [v92] + v93, p1, [p2], v101.cf42[f42 := abs(|v103|)] < v100;
				...
				v110[safeIndex(407, v110.Length)] := v108;
				var v111: array<bool> := new bool[29](i11 => f42);
				var v112: array<array<bool>> := new array<bool>[3] [v111, v111, v111];
				v112[safeIndex(681, v112.Length)] := v111;
				v110[safeIndex(407, v110.Length)], v112[safeIndex(681, v112.Length)] := v108, v111;
				var v113 := DC3(v89);
				v113 := v113;
				var v114: set<bool> := {f42, f42};
				v114 := v114;
				var v115: seq<bool> := [f42, f42, f42, f42, f42];
				p1[safeIndex(674, p1.Length)] := |v115|;
				p1[safeIndex(674, p1.Length)] := safeDivisionInt(safeDivisionInt(p0, f43), safeModuloInt(|(map[f42 := f42])[f42 := f42]|, |p2|));
			}
			
			var v116: array<seq<int>> := new seq<int>[29];
			var v117: seq<int> := [p0];
			v116[safeIndex(341, v116.Length)] := v117;
			v116[safeIndex(341, v116.Length)] := (v117 + v117) + v117;
			var v118: array<string> := new string[16];
			v118[safeIndex(354, v118.Length)] := (seq(abs(20), i12  => (v89))) + p2;
			v118[safeIndex(354, v118.Length)] := "flix";
		}
		var v119: multiset<int> := multiset{p0};
		globalState.f11 := safeModuloInt(p0 + |p2|, safeModuloInt(|v119|, f43));
		var i13 := 0;
			...
			decreases 100 - i13
		{
			...
			globalState.f6, r0, globalState.f1, globalState.f1, r0 := safeModuloInt(p0, f43), f42, fm29("jym", p2[safeIndex(v120[safeIndex(f43, |v120|)], |p2|) := fm32(globalState)], safeDivisionInt(p0, |p2|), f43, globalState), !(p0 >= (p0 + p0)), [f42] <= v121;
			var v122 := 'w';
			var v123: map<bool, array<int>> := map[f42 := p1];
			if (fm29("djdkx", p2[safeIndex(p0, |p2|) := v122], |v120|, safeModuloInt(|v123|, p0), globalState)) {
				var v124: array<bool> := new bool[17];
				v124[safeIndex(307, v124.Length)] := true;
				v124[safeIndex(307, v124.Length)] := DC5(f42, v119, fm0(-p0, f42, globalState)).cf7;
				globalState.f1 := f42;
				var v125: map<array<bool>, bool> := map[if (v124[safeIndex(307, v124.Length)]) then v124 else v124 := f42];
				var v126: multiset<char> := multiset{v122};
				v125 := v125[v124 := f43 <= |v126|];
				var v127 := "bi";
				v127 := "xcme";
				var v128 := new C0(v124[safeIndex(307, v124.Length)]);
			} else {
				var v129: array<bool> := new bool[18](i14 => f42);
				v129[safeIndex(342, v129.Length)] := f42;
				v129[safeIndex(342, v129.Length)] := f42;
				var v130: map<int, bool> := map[-248 := v129[safeIndex(342, v129.Length)]];
				globalState.f1 := if (safeDivisionInt(f43, f43) in v130) then v130[safeDivisionInt(f43, f43)] else v129[safeIndex(342, v129.Length)];
				v129[safeIndex(342, v129.Length)] := f42;
				var v131: array<D12> := new D12[18](i15 => DC27(multiset{f42}));
				var v132: multiset<bool> := multiset{v129[safeIndex(342, v129.Length)]};
				var v133 := DC27(v132);
				v131[safeIndex(400, v131.Length)] := v133;
				v131[safeIndex(400, v131.Length)] := v133;
				p1[safeIndex(588, p1.Length)] := safeModuloInt(f43, f43);
				p1[safeIndex(588, p1.Length)] := safeDivisionInt(p0, f43);
			}
			...
			v134[safeIndex(172, v134.Length)] := v138 + map[v135 := v137];
			...
			globalState.f6, v134[safeIndex(172, v134.Length)], v139 := 0x3c5, v138, if (v143 in v144) then v144[v143] else v139;
			var v145 := "wfu";
			v145 := v145 + v145[safeIndex(0x12f, |v145|) := 'd'];
		}
		var v146 := 'd';
		var v147: map<bool, char> := map[f42 := v146];
		if (fm29(fm30(f42, p0, globalState), p2 + p2, |map[v119 := f42]|, |v147| * f43, globalState)) {
			globalState.f11 := safeDivisionInt(f43, p0);
			globalState.f1 := f42;
			var v148: array<bool> := new bool[14](i16 => f42);
			v148[safeIndex(57, v148.Length)] := f42;
			v148[safeIndex(57, v148.Length)] := (f43 > f43) || f42;
			globalState.f1 := fm0(f43, v148[safeIndex(57, v148.Length)], globalState) <= fm0(|v88|, !f42, globalState);
			...
			p1[safeIndex(724, p1.Length)] := f43;
			p1[safeIndex(724, p1.Length)] := f43 - 0x111;
			var v150: set<bool> := {f42, f42, f42};
			var v151: map<int, bool> := map[|v150| := !f42];
			var v152: seq<set<bool>> := [v150];
			var v153: array<set<bool>> := new set<bool>[23] [v150, v150 * v150, {f42}, v150, v150, v150, v150, v150, v150, v150, {fm29(p2, p2, p1[safeIndex(724, p1.Length)], 0xf4, globalState), if (|[f42, !f42]| in v151) then v151[|[f42, !f42]|] else f42, true}, v152[safeIndex(-p0, |v152|)], v150, {f42, f42}, v150, v150, v150, v150, v150, v150, v150 + v150, {f42}, v150];
			v153[safeIndex(295, v153.Length)] := v150 + v150;
			v153[safeIndex(295, v153.Length)] := v150;
			var v154: seq<bool> := [f42];
			var v155: array<bool> := new bool[7] [false, f42 || f42, f42, f42, f42, f43 < |v154|, false];
			v155[safeIndex(726, v155.Length)] := f42;
			v155[safeIndex(726, v155.Length)] := -0x11b != p0;
		}
	...
	method m18(globalState: GlobalState) returns (r0: bool, r1: D2) {
		...
		var v1 := "heuget";
		var v2: seq<int> := [f43];
		globalState.f11, globalState.f1, v1, r0, globalState.f1 := f43 * f43, f42, v1, v2[safeIndex(f43, |v2|)] > f43, f42;
		var i0 := 0;
		while (f42)
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v4: map<int, seq<int>> := map[|multiset{|{|v3|}|}| := seq(abs(-0x16), i1  => (|map[|map[|v1| := v1]| := f43]|))];
				globalState.f1 := safeModuloInt(f43, |v1|) !in v4;
				...
				v15[safeIndex(203, v15.Length)] := f42 || f42;
				v15[safeIndex(203, v15.Length)] := f42;
				globalState.f26 := f43;
				var v16 := DC19(f43);
				v16, globalState.f9, globalState.f26 := v16, f43, f43;
				var v17 := 't';
				var v18: T1 := new C2(v17, v15[safeIndex(203, v15.Length)]);
				var v19: multiset<set<T1>> := multiset{{v18, v18}};
				var v20 := new C1(f42, safeModuloInt(|v19|, 0x288));
				v15[safeIndex(203, v15.Length)] := true;
			}
		...
		var i3 := 0;
		while (fm48(f43, f42, globalState) < safeModuloInt(|v1|, f43))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			i3 := i3 + 1;
			var v22 := 'y';
			var v23 := DC17(v1[safeIndex(-f43, |v1|) := v22]);
			match (v23) {
				case DC18(cf31, cf32, cf33) =>
					...
					v24[safeIndex(466, v24.Length)] := cf31;
					v24[safeIndex(466, v24.Length)], cf32, globalState.f6 := cf31, cf32, cf33;
					r0 := v24[safeIndex(466, v24.Length)];
					var v25 := DC36(cf33, cf32, 0x20c);
					var v26: multiset<int> := multiset{0x24d};
					var v27: map<bool, bool> := map[f42 := v24[safeIndex(466, v24.Length)]];
					var v28 := DC28(v22, f42, -cf32, cf31, cf33);
					var v29: array<int> := new int[25] [|v1|, cf33, fm0(cf33, f42, globalState), safeDivisionInt(f43, cf32), f43, cf33, cf33, cf32, safeDivisionInt(|v1|, v25.cf56), cf33, -|v26|, cf33, -cf33, 107, |v27|, f43, |v1|, cf32, -(if (cf31) then cf32 else f43), if (cf31) then f43 else f43, safeDivisionInt(cf33, |fm53(!f42, f42, f42, |v2|, globalState)|), cf32, f43, if (v28.cf44) then |v1| else cf32, 716];
					globalState.f3 := v29;
					var v30 := DC31(true, v24[safeIndex(466, v24.Length)], v22);
					var v31 := new C2(v30.cf52, cf31);
				case DC19(cf34) =>
					globalState.f11 := safeDivisionInt(f43, cf34) + safeDivisionInt(f43, |v2|);
					var v32: map<bool, int> := map[true := -fm48(0x34a, f42, globalState)];
					globalState.f26 := v2[safeIndex(if (fm29(v1, v1, f43, cf34, globalState) in v32) then v32[fm29(v1, v1, f43, cf34, globalState)] else f43, |v2|)];
					var v33: multiset<char> := multiset{'a', v22};
					var v34: multiset<int> := multiset{f43};
					var v35 := DC0(cf34);
					var v36: array<int> := new int[26] [cf34, cf34, f43, |v33|, cf34, 463, cf34, |v34|, v2[safeIndex(f43, |v2|)], -f43, cf34, |v32|, f43, |v0|, f43, f43, |v34|, cf34, v35.cf0, f43, cf34, f43, f43, cf34, f43, cf34];
				...
				case DC17(cf30) =>
					...
					var v46: map<bool, D12> := map[v44[safeIndex(f43, |v44|)] := v45];
				...
				case DC20(cf35) =>
					...
					v50[safeIndex(804, v50.Length)] := f42;
					v50[safeIndex(804, v50.Length)] := if (f42) then f42 else f42;
					f43 := f43 + f43;
					var v51: map<array<bool>, bool> := map[if (true) then v50 else v50 := f42];
					v51 := v51[v50 := true];
					var v52: map<seq<int>, bool> := map[v2 := f42];
					globalState.f1, v1, v1, r0 := v50[safeIndex(804, v50.Length)], v1 + v1, v1[safeIndex(f43, |v1|) := v22], if ([f43] in v52) then v52[[f43]] else v50[safeIndex(804, v50.Length)];
			}
			...
			globalState.f11 := (if (f42) then f43 else fm0(f43, v53[safeIndex(f43, |v53|)], globalState)) + safeDivisionInt(|v54|, |v1|);
		}
		var v55 := DC2(f43);
		match (v55) {
			case DC2(cf2) =>
				...
				v61[safeIndex(799, v61.Length)] := |v2|;
				v61[safeIndex(799, v61.Length)] := f43;
				v56 := v56;
			case DC1(cf1) =>
		...
		if (match DC31(true, f42, v65).(cf52 := v65, cf51 := f42).(cf52 := v65, cf50 := f42) {
			...
			var v66: map<string, int> := map[v1 + v1 := v2[safeIndex(fm48(f43, f42, globalState), |v2|)]];
			v66 := v66["wesspiy" := -f43];
			var v67: array<bool> := new bool[29];
			v67[safeIndex(283, v67.Length)] := f42;
			v67[safeIndex(283, v67.Length)] := f42;
			v1 := "kdb";
			var v68: multiset<bool> := multiset{f42};
			v67[safeIndex(283, v67.Length)] := !fm29(v1[safeIndex(fm0(f43, v67[safeIndex(283, v67.Length)], globalState), |v1|) := v65], (seq(abs(0x220), i7  => (v65))) + v1, f43, |v68| - f43, globalState);
			globalState.f1 := f42;
		} else {
			var v69: array<array<int>> := new array<int>[20];
			var v70: array<int> := new int[10];
			v69[safeIndex(647, v69.Length)] := v70;
			v70[safeIndex(969, v70.Length)] := 642;
			var v71: multiset<bool> := multiset{f42, f42, f42};
			var v72 := DC27(v71);
			v69[safeIndex(647, v69.Length)], v70[safeIndex(969, v70.Length)], globalState.f1, globalState.f6, v72 := v70, -((if (f42 in v71) then v71[f42] else f43) + (f43 - -f43)), f42, -(-(if (!f42) then f43 else 0x196) + f43), v72.(cf42 := v71);
			if (f42) {
				var v73 := new C2(fm32(globalState), !f42);
				globalState.f1 := f42;
				globalState.f1 := f42;
				globalState.f3 := v69[safeIndex(647, v69.Length)];
				var v74: set<char> := {v73.f47};
				var v75 := DC41(v74);
				v74 := (v74 + {v65, v65, v73.f47, v73.f47}) - (v74 - v75.cf67);
			} else {
				var v76: set<int> := {-759, f43};
				var v77 := new C1(v76 == v76, safeDivisionInt(-0xef, v70[safeIndex(969, v70.Length)]));
				var v78: array<map<bool, bool>> := new map<bool, bool>[20];
				v78 := if (v77.f44) then v78 else v78;
				v70[safeIndex(969, v70.Length)] := v77.f45;
				globalState.f6 := f43;
				var v79: map<int, int> := map[if (v77.f44) then v70[safeIndex(969, v70.Length)] else |v76| := v70[safeIndex(969, v70.Length)] - v77.f45];
			...
			globalState.f11 := |((if (true in v81) then v81[true] else v1) + (v1[safeIndex(v70[safeIndex(969, v70.Length)], |v1|) := v65] + v1))[safeIndex(|"clyswao"|, |((if (true in v81) then v81[true] else v1) + (v1[safeIndex(v70[safeIndex(969, v70.Length)], |v1|) := v65] + v1))|) := v65]|;
			var v82 := DC7(v70);
			var v83: map<bool, D3> := map[f42 := v82];
			var v84 := DC10(if (f42 in v83) then v83[f42] else DC10(v82));
			var v85 := DC10(v82);
			var v86: map<bool, char> := map[fm47(f43, f42, v70[safeIndex(969, v70.Length)], f42, globalState) := v1[safeIndex(f43, |v1|)]];
			var v87: array<char> := new char[17] [v1[safeIndex(-f43, |v1|)], 'r', v65, v65, v65, v65, v65, v65, if (f42) then DC42(v65).cf68 else v65, v65, v65, v65, v65, v65, if (f42 in v86) then v86[f42] else v65, v65, v65];
			v87[safeIndex(135, v87.Length)] := v65;
			...
			r0, v85, globalState.f21, globalState.f1, v87[safeIndex(135, v87.Length)] := f42, v85, v88, v90[safeIndex(f43, |v90|)], v65;
			var v91 := DC36(v70[safeIndex(969, v70.Length)], f43, --v70[safeIndex(969, v70.Length)]);
			match (v91) {
				case DC36(cf56, cf57, cf58) =>
					...
					var v96: map<map<int, int>, seq<string>> := map[map[|(map v93 : int | v93 in v2 :: (safeModuloInt(v93, cf57)) := (f43))| := if (v70[safeIndex(969, v70.Length)] in v94) then v94[v70[safeIndex(969, v70.Length)]] else |v0|] := v95];
					var v97: map<bool, map<int, int>> := map[true := map[v70[safeIndex(969, v70.Length)] := f43]];
				...
				case DC37(cf59, cf60, cf61, cf62) =>
					...
					globalState.f15 := v87[safeIndex(135, v87.Length)];
					globalState.f1 := v99.f46;
					globalState.f1, globalState.f1 := cf59 < (cf59 - v70[safeIndex(969, v70.Length)]), !cf60;
				case DC38(cf63, cf64) =>
					r0 := f42;
					v88[safeIndex(880, v88.Length)] := f42;
					v88[safeIndex(880, v88.Length)] := !f42;
					var v100: set<map<bool, bool>> := {v89};
					var v102: map<int, map<bool, bool>> := map[|map[cf64 := |(set v101 : string | v101 in map[("n")[safeIndex(v70[safeIndex(969, v70.Length)], |"n"|) := v87[safeIndex(135, v87.Length)]] := v65] :: (v101))|]| := fm53(v88[safeIndex(880, v88.Length)], f42, if (-0x2f2 in v0) then v0[-0x2f2] else f42, f43, globalState)];
					var v104: array<set<map<bool, bool>>> := new set<map<bool, bool>>[22] [v100, v100, v100 + v100, v100 - v100, {if (cf64 in v102) then v102[cf64] else v89}, v100, v100, v100, v100, v100, v100 + v100, v100 - v100, v100, v100, fm60(globalState), v100, v100, v100, {fm53(v88[safeIndex(880, v88.Length)], f42, !f42, f43, globalState)}, v100, (set v103 : map<bool, bool> | v103 in v100 :: (v103)) + v100, {map[f42 := v88[safeIndex(880, v88.Length)]]}];
					v104[safeIndex(511, v104.Length)] := v100;
					var v105: map<array<int>, bool> := map[v70 := v88[safeIndex(880, v88.Length)]];
					globalState.f26, v70[safeIndex(969, v70.Length)], v104[safeIndex(511, v104.Length)], v70[safeIndex(969, v70.Length)] := safeModuloInt(cf63 + v70[safeIndex(969, v70.Length)], |v90|), |(v105 + (v105[v69[safeIndex(647, v69.Length)] := v88[safeIndex(880, v88.Length)]])[v70 := f42])|, if (v88[safeIndex(880, v88.Length)]) then v100 else v100, safeDivisionInt(cf63, safeModuloInt(cf63, v70[safeIndex(969, v70.Length)]));
					globalState.f15 := v65;
				case DC35(cf55) =>
					...
					var v108: map<map<int, int>, int> := map[(map[|v2| := f43])[|"v"| := v70[safeIndex(969, v70.Length)]] := v70[safeIndex(969, v70.Length)]];
					var v109 := new C1(f42, |v108|);
					v89 := (v89 + v89) + v89;
				case DC39(cf65) =>
					var v110: multiset<int> := multiset{v70[safeIndex(969, v70.Length)]};
					var v111 := DC5(!f42, v110, f43);
					globalState.f11, globalState.f1 := v111.cf9, f42;
					globalState.f9 := f43;
					globalState.f1 := f42;
					globalState.f1 := |(v1 + v1)| > v2[safeIndex(v70[safeIndex(969, v70.Length)], |v2|)];
			}
...
class C4 extends T0 {
	...
	function fm0(p0: int, p1: bool, globalState: GlobalState): int {
		safeDivisionInt(if (f41) then 0x11e else 0xb8, 0x41)
	}
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		if (match DC9(p0, true) {
			...
			p1[safeIndex(131, p1.Length)] := fm0(|p2|, f41, globalState);
			var v0: array<bool> := new bool[20];
			v0[safeIndex(417, v0.Length)] := f41 || false;
			var v1 := 'd';
			globalState.f26, p1[safeIndex(131, p1.Length)], v0[safeIndex(417, v0.Length)], r0 := p0 + p0, -p0, f41, (v1 in p2) || (v1 !in p2);
			var v3: multiset<bool> := multiset{f41};
			var v4: multiset<multiset<bool>> := multiset{v3, v3};
			match (DC16((map v2 : multiset<bool> | v2 in v4 :: (v2) := ({f41, true})) + fm25(p2, v0[safeIndex(417, v0.Length)], globalState))) {
				case DC16(cf29) =>
					globalState.f1 := v0[safeIndex(417, v0.Length)];
					var v5: set<bool> := {v0[safeIndex(417, v0.Length)], f41};
					var v6 := new C3(v5 >= {f41}, p1[safeIndex(131, p1.Length)]);
					var v7: multiset<array<bool>> := multiset{v0};
					globalState.f1 := !((v7[v0 := abs(p0)])[v0 := abs(v6.fm0(-p0, f41, globalState))] <= v7);
					var v8, v9 := v6.m18(globalState);
			}
			
			var v10: set<bool> := {if (v0[safeIndex(417, v0.Length)]) then v0[safeIndex(417, v0.Length)] else f41, p1[safeIndex(131, p1.Length)] > -p0, v0[safeIndex(417, v0.Length)]};
			v10 := v10 - {f41, false, false, f41, v0[safeIndex(417, v0.Length)]};
			globalState.f9 := p0 * p0;
			var v11 := new C2(v1, fm47(-0x2ea, !v0[safeIndex(417, v0.Length)], p0, v0[safeIndex(417, v0.Length)], globalState));
		} else {
			globalState.f1 := f41;
			var v12: array<array<int>> := new array<int>[21];
			v12[safeIndex(734, v12.Length)] := p1;
			v12[safeIndex(734, v12.Length)] := new int[28];
			if (f41 || f41) {
				var v13 := 'i';
				...
				var v17 := "wjcvqwgi";
				v17 := p2 + p2;
				v12[safeIndex(734, v12.Length)][safeIndex(81, v12[safeIndex(734, v12.Length)].Length)] := p0;
				var v18 := 'n';
				var v19: map<bool, char> := map[f41 := v18];
				v12[safeIndex(734, v12.Length)][safeIndex(81, v12[safeIndex(734, v12.Length)].Length)] := p0 * safeDivisionInt(p0, |v19[f41 := p2[safeIndex(p0, |p2|)]]|);
				...
				var v24: seq<int> := [if (v18 in v23) then v23[v18] else p0, v12[safeIndex(734, v12.Length)][safeIndex(81, v12[safeIndex(734, v12.Length)].Length)], v12[safeIndex(734, v12.Length)][safeIndex(81, v12[safeIndex(734, v12.Length)].Length)]];
				var v25: seq<int> := [|v22|, |v24|, p0];
				v21 := map[v20[f41 := abs(-p0)] := fm61(|v25|, globalState)];
				var v26: set<bool> := {f41};
				globalState.f11, v12[safeIndex(734, v12.Length)][safeIndex(81, v12[safeIndex(734, v12.Length)].Length)] := p0, |((v26 - v26) - {!true})|;
			}
		...
		var v35: array<bool> := new bool[13] [(if (p2 in v31) then v31[p2] else v32[safeIndex(442, |v32|)]) == p0, f41, f41, f41, f41, f41, !f41, f41, f41, !(p0 == |v33|), f41, (if (!f41 in v34) then v34[!f41] else p0) == |fm36(v28, globalState)|, false];
		...
		if (f41 || f41) {
			...
			v35[safeIndex(971, v35.Length)] := f41;
			v35[safeIndex(971, v35.Length)] := f41;
			var v37 := DC5(f41, multiset{p0, p0, -0xe9}, p0);
			v35[safeIndex(971, v35.Length)] := v37.cf7;
			var v38: array<array<bool>> := new array<bool>[27];
			var v39: array<bool> := new bool[8];
			v38[safeIndex(977, v38.Length)] := v39;
			v38[safeIndex(977, v38.Length)] := v39;
			globalState.f9 := --(|(p2 + p2)[safeIndex(p0, |(p2 + p2)|) := v29.f47]| - p0);
		} else {
	...
	method m16(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: seq<int>) {
		...
		for i0 := p1 to p1 {
			...
			if (i0 >= -p1) {
				...
				globalState.f26 := if (f41) then i0 else if (v1 in v2) then v2[v1] else |v3[i0 := abs(p1)]|;
				...
				v13 := v13;
				globalState.f1 := fm47(i0, v0.f46, safeDivisionInt(501, 516), !v0.f46, globalState);
				...
				v19 := v19[v15 := v18[p0 := abs(|fm63(v10, v0.f46, |map[v21 := p1]|, globalState)|)]];
				var v22: multiset<string> := multiset{"qlus"};
				globalState.f11 := if (p0) then i0 else |(v22[p2 := abs(i0)])[p2 := abs(p1)]|;
				var v23: array<array<int>> := new array<int>[14];
				var v24: array<int> := new int[29];
				v23[safeIndex(534, v23.Length)] := v24;
				var v25 := "id";
				var v26: set<bool> := {f41, f41};
				v23[safeIndex(534, v23.Length)], v25, r1, globalState.f15 := v24, (p2 + (seq(abs(-0xe7), i2  => (v10)))) + p2, v26 >= (if (f41) then v26 else v26), 's';
			}
			...
			v27[safeIndex(791, v27.Length)] := i0;
			var v28: seq<int> := [i0];
			v27[safeIndex(791, v27.Length)] := |{p1, v28[safeIndex(p1, |v28|)]}|;
		}
		var v29 := "ggheeatr";
		v29 := "a";
			...
			decreases 100 - i5
		{
			...
			if ((p1 + |v32|) <= |(v33 + v33)|) {
				globalState.f6 := safeModuloInt(safeDivisionInt(p1, -p1), p1);
				var v35: seq<bool> := [p0];
				var v36: map<int, seq<bool>> := map[p1 := if (f41) then [f41] else v35];
				var v39: map<int, seq<int>> := map[p1 := v32];
				v36 := ((map v37 : int | (0x290 <= v37) && (v37 < 911) :: (v37 * |v32|) := (v35)) + (map v38 : int | v38 in v39 :: (safeModuloInt(v38, p1)) := ([true]))) + v36;
				r1 := f41;
				...
				var v44: map<array<bool>, map<array<bool>, bool>> := map[v30 := v43[safeIndex(|v35|, |v43|)]];
				...
				v32 := v32;
				globalState.f26 := safeModuloInt(p1, p1);
			...
			if (false) {
				...
				var v51: array<int> := new int[20] [p1, 834, 300, p1, safeModuloInt(p1, p1), --p1, |v47| - 130, p1, p1, -0x6e - p1, |v48|, p1, safeModuloInt(p1, p1), p1, p1, -p1, |(v50[p1 := f41] + v50)|, p1, -0x2b1, p1];
				v51[safeIndex(666, v51.Length)] := p1 + -834;
				var v52: map<array<int>, int> := map[v51 := p1];
				v51[safeIndex(666, v51.Length)] := |(v52 + v52)|;
				globalState.f1 := f41;
				v30[safeIndex(257, v30.Length)] := p0;
				v30[safeIndex(257, v30.Length)] := false;
				globalState.f9 := safeModuloInt(0x20f, safeDivisionInt(-739, p1));
			} else {
				...
				v61[safeIndex(591, v61.Length)] := p1;
				v61[safeIndex(591, v61.Length)] := -231;
			}
		...
		globalState.f11 := -p1;
		r0 := [p1, |[seq(abs(287), i6  => (p1))]| - p1, safeModuloInt(--887, p1), p1, p1];
		var v63: seq<int> := [p1];
	...
	method m17(p0: int, p1: int, p2: bool, globalState: GlobalState) {
		...
		globalState.f6 := |v2[safeIndex(safeModuloInt(p1, p0), |v2|)]|;
		var v3 := 'k';
		var v4: set<char> := {v3, v3, v3};
		var v5: array<int> := new int[8];
		v5[safeIndex(274, v5.Length)] := safeModuloInt(692, p1);
		v4, v5[safeIndex(274, v5.Length)], globalState.f9, globalState.f6, globalState.f26 := {v3, v3, v3}, safeModuloInt(if (p2) then p0 else p0, p1), safeDivisionInt(safeDivisionInt(p0, p1), 0x18), p1, -p0;
		var v6: set<string> := {seq(abs(0x30a), i0  => (v3)), v0};
		if (v6 >= v6) {
			if (p2) {
				var v7 := DC9(p0, false);
				...
				v9[safeIndex(533, v9.Length)] := if (f41) then v10 else v10;
				v9[safeIndex(533, v9.Length)] := v10;
				var v11: array<map<bool, int>> := new map<bool, int>[15];
				v11[safeIndex(491, v11.Length)] := if (p2) then (map[true := -730])[f41 := v5[safeIndex(274, v5.Length)]] else v8;
				v10[safeIndex(839, v10.Length)] := !(v1[safeIndex(p0, |v1|)] != p1);
				var v12 := DC26(true);
				var v13: seq<D11> := [v12, v12, DC26(p2), v12];
				var v14: multiset<array<bool>> := multiset{v9[safeIndex(533, v9.Length)]};
				v11[safeIndex(491, v11.Length)], v10[safeIndex(839, v10.Length)], v13, globalState.f1 := v8 + v8, f41, ([v12])[safeIndex(|(v14[v10 := abs(v5[safeIndex(274, v5.Length)])] + multiset{v10, v9[safeIndex(533, v9.Length)]})|, |[v12]|) := v12], false;
				v5[safeIndex(274, v5.Length)] := p0;
			} else {
				var v15: array<bool> := new bool[9];
				v15[safeIndex(717, v15.Length)] := f41;
				var v16: array<seq<bool>> := new seq<bool>[21];
				globalState.f26, v0, v15[safeIndex(717, v15.Length)], globalState.f9, v16 := safeModuloInt(p0, p1), ("lae" + v0) + ((seq(abs(0x3c0), i1  => (v3))) + v0), v0 < (v0 + "hsfcgecvk"), -v5[safeIndex(274, v5.Length)], v16;
				var v17: array<set<bool>> := new set<bool>[13];
				var v18: set<bool> := {v15[safeIndex(717, v15.Length)]};
				v17[safeIndex(725, v17.Length)] := v18;
				v17[safeIndex(725, v17.Length)] := v18;
				var v19: map<bool, bool> := map[v15[safeIndex(717, v15.Length)] := p2];
				v19 := v19[p2 := f41];
				var v20: multiset<char> := multiset{v3};
				var v21 := DC17(v0 + (seq(abs(0x21c), i2  => (v3))));
				globalState.f1, v20, v21, v0, v6 := fm29(v0 + v0, "fufusjobx", p1, fm48(|map[|map[p1 := p2]| := !v15[safeIndex(717, v15.Length)]]|, v15[safeIndex(717, v15.Length)], globalState), globalState), v20, fm41(seq(abs(0x2a4), i3  => (v3)), fm48(v5[safeIndex(274, v5.Length)], v15[safeIndex(717, v15.Length)], globalState), v15[safeIndex(717, v15.Length)], globalState), "snvueblyh" + v0, v6 * v6;
				var v22 := DC18(true, 0x1db, p0);
				var v23: map<int, array<bool>> := map[p1 := v15];
				var v24: map<int, bool> := map[|v23| := p2];
				var v25: seq<map<int, bool>> := [fm64(!v15[safeIndex(717, v15.Length)], v22.cf33, globalState), v24 + map[v5[safeIndex(274, v5.Length)] := p2], v24];
				globalState.f1, globalState.f6, globalState.f9, v25, globalState.f1 := f41, v5[safeIndex(274, v5.Length)], p1, v25, v15[safeIndex(717, v15.Length)];
			}
			...
			v27 := v27;
			var v28: set<int> := {p0};
			var v29: map<int, bool> := map[v5[safeIndex(274, v5.Length)] := p2];
			var v30: seq<bool> := [!p2, f41, p2];
			var v31: array<bool> := new bool[23] [p2, !p2, !!f41, f41, if (f41) then f41 else p2, !(p2 <==> f41), f41, p2, v28 !! v28, f41, f41 <==> !(if (p1 in v29) then v29[p1] else f41), !true, fm47(p1, f41, |map[p0 := p2]|, true, globalState) <==> f41, p2, p2, p2, p1 == p1, f41, p0 >= v5[safeIndex(274, v5.Length)], p2, v30[safeIndex(881, |v30|)], p2, v30[safeIndex(v5[safeIndex(274, v5.Length)], |v30|)]];
			v31[safeIndex(738, v31.Length)] := p2;
			v31[safeIndex(738, v31.Length)] := (v1 + (seq(abs(0x64), i4  => (|map['e' := p2]|)))) < ([p1] + [v5[safeIndex(274, v5.Length)]]);
			v29 := v29[p1 := v31[safeIndex(738, v31.Length)]];
			var v32: map<bool, int> := map[p2 <==> v31[safeIndex(738, v31.Length)] := p1];
			var v33 := DC6(p1, p0, v30);
			v32 := v32[v31[safeIndex(738, v31.Length)] := v33.cf11];
		} else {
			var v34 := new C0(f41 && !p2);
			if (f41) {
				v0 := v0;
				var v35: map<int, array<int>> := map[p1 := v5];
				globalState.f9 := safeModuloInt(|v35|, p1);
				var v36: seq<array<int>> := [v5];
				v36 := v36 + (v36 + [v5, v5]);
				var v37: seq<bool> := [v34.f46];
				v0, v37 := v0 + v0, v37;
				globalState.f1 := v5[safeIndex(274, v5.Length)] == v5[safeIndex(274, v5.Length)];
			} else {
				var v38: map<bool, int> := map[!!true := p1 + p1];
				v38 := v38[v0 != "yukp" := safeDivisionInt(p0, v5[safeIndex(274, v5.Length)])];
				var v39: seq<bool> := [v34.f46];
				var v40 := DC6(p0, v5[safeIndex(274, v5.Length)], v39);
				var v41 := DC9(|v40.cf12|, v34.f46);
				var v42: map<D3, bool> := map[v41 := p2];
				globalState.f1 := (v42 + fm65('k', globalState)) == (v42 + v42);
				var v43 := DC28(v3, v34.f46, p1, v34.f46, v1[safeIndex(p0, |v1|)]);
				var v44 := DC29(v43);
				...
				v46[safeIndex(3, v46.Length)] := v44;
				v46[safeIndex(3, v46.Length)] := v44;
				globalState.f6 := p1;
				v0 := v0;
			}
			...
			v48[safeIndex(201, v48.Length)] := v50;
			var v51 := DC11(v49);
			...
			var v55: seq<map<D4, bool>> := [v54[safeIndex(p0, |v54|)], map[v51 := p2], map[v51 := p2] + v50];
			v48[safeIndex(201, v48.Length)], globalState.f26, globalState.f9, globalState.f1, v5[safeIndex(274, v5.Length)] := v54[safeIndex(|v0|, |v54|)], -0x15d, v5[safeIndex(274, v5.Length)], v34.f46, p1;
			var v56: array<array<set<int>>> := new array<set<int>>[22];
			var v57: array<set<int>> := new set<int>[8](i5 => {v5[safeIndex(274, v5.Length)], p1});
			v56[safeIndex(685, v56.Length)] := v57;
			var v58 := DC43(v57);
			v56[safeIndex(685, v56.Length)] := v58.cf69;
		}
		
		var v59: array<set<char>> := new set<char>[2];
		globalState.f1, v1, v59, globalState.f9 := f41, v1 + v1, v59, -0xd2;
		var i6 := 0;
		while (v5[safeIndex(274, v5.Length)] >= 0x2cd)
			decreases 100 - i6
		{
			if (i6 >= 100) {
				break;
			...
			globalState.f26 := -safeDivisionInt(p1, p1 + p1);
			...
			if (!(if (|map[v5[safeIndex(274, v5.Length)] := p2]| > 0x322) then if (f41 in v64) then v64[f41] else f41 else p2)) {
				var v65: map<bool, char> := map[true := fm32(globalState)];
				var v66: seq<string> := [v0];
				var v67: map<seq<string>, array<int>> := map[if (v62.f42) then fm67(if ((if (false in v64) then v64[false] else p2) in v65) then v65[if (false in v64) then v64[false] else p2] else 'n', v62.f43, 'd', v5[safeIndex(274, v5.Length)], globalState) else v66 := v5];
				...
				var v73: map<bool, array<bool>> := map[v72[safeIndex(p0, |v72|)] := v70];
				v71 := [v70, v70, if (p2 in v73) then v73[p2] else v70];
				globalState.f1 := v62.f42;
				globalState.f26 := v62.f43 * v5[safeIndex(274, v5.Length)];
				var v74: map<int, int> := map[v62.f43 := safeDivisionInt(|v72|, v62.f43)];
				v74 := v74[160 := safeDivisionInt(v62.f43, v5[safeIndex(274, v5.Length)])];
			...
			if (f41) {
				...
				var v79: set<int> := {v5[safeIndex(274, v5.Length)], v62.f43, 127};
				var v80: map<set<int>, bool> := map[v79 := v62.f42];
				v78[safeIndex(293, v78.Length)] := v80;
				var v81: array<bool> := new bool[21](i10 => !v62.f42);
				var v82 := DC23(v81, p2);
				var v83: map<array<bool>, array<seq<int>>> := map[v81 := v76];
				v76, globalState.f21, v78[safeIndex(293, v78.Length)], globalState.f26, v82 := if (v81 in v83) then v83[v81] else v76, v81, (v80 + v80) + v80, safeModuloInt(p0, v62.f43), v82;
				globalState.f6 := v62.f43;
				var v84 := new C2(v3, v62.f42);
				var v85: array<string> := new string[5];
				v85[safeIndex(201, v85.Length)] := v0;
				v85[safeIndex(201, v85.Length)] := v0[safeIndex(v5[safeIndex(274, v5.Length)], |v0|) := v3];
				var v86: multiset<string> := multiset{v0, seq(abs(0x11a), i11  => (v84.f47))};
				var v87: seq<multiset<string>> := [v86];
				v5[safeIndex(274, v5.Length)] := |v87[safeIndex(0x2db, |v87|)]|;
			} else {
				globalState.f11 := -v5[safeIndex(274, v5.Length)];
				var v88: map<int, seq<int>> := map[safeModuloInt(v5[safeIndex(274, v5.Length)], -p0) := [fm0(v62.f43, f41, globalState)]];
				var v89: set<map<int, bool>> := {v60[p0 := v62.f42]};
				v88 := v88[v62.f43 := [p1, |v89|, 0x49, v5[safeIndex(274, v5.Length)]]];
				v5[safeIndex(274, v5.Length)] := v62.f43;
				globalState.f3 := v5;
				...
				globalState.f26, v5[safeIndex(274, v5.Length)], globalState.f1 := -(if ((f41 && !v62.f42) in v90) then v90[f41 && !v62.f42] else p1), |v91|, |v93| >= v62.f43;
			}
			
		}
		var v94: map<int, bool> := map[p0 := f41];
		var v95: seq<string> := [v0];
		var v96 := DC37(v5[safeIndex(274, v5.Length)], p2, |v94|, v95);
		match (if (p2) then v96 else v96.(cf60 := p2, cf62 := v95, cf61 := -505)) {
			case DC36(cf56, cf57, cf58) =>
				var v97: map<bool, int> := map[f41 := cf58];
				if (!((if (p2 in v97) then v97[p2] else v5[safeIndex(274, v5.Length)]) == v5[safeIndex(274, v5.Length)])) {
					var v98 := new C3(p2, if (f41) then v1[safeIndex(cf56, |v1|)] else -cf57);
					globalState.f1 := (cf56 * -0x128) in v1;
					globalState.f1, globalState.f9, globalState.f3, globalState.f1, v5[safeIndex(274, v5.Length)] := p2 ==> false, (if (p2) then cf57 else -0x229) - -|multiset(v2)|, v5, f41, cf56;
					var v99: array<bool> := new bool[21](i12 => !(if (f41) then f41 else !v98.f42));
					v99[safeIndex(832, v99.Length)] := p2;
					var v100: set<bool> := {f41};
					v99[safeIndex(832, v99.Length)] := v100 < v100;
					cf57 := v5[safeIndex(274, v5.Length)];
				} else {
					v0 := v0;
				...
				v5[safeIndex(274, v5.Length)] := cf56;
				globalState.f11 := cf58;
			case DC37(cf59, cf60, cf61, cf62) =>
				var v104: map<seq<int>, array<int>> := map[v1 := v5];
				var v105: map<int, int> := map[v5[safeIndex(274, v5.Length)] := v5[safeIndex(274, v5.Length)]];
				var v107 := DC44(v104);
				var v108: seq<map<seq<int>, array<int>>> := [v107.cf70];
				var v109: seq<bool> := [true];
				var v110: array<map<seq<int>, array<int>>> := new map<seq<int>, array<int>>[27] [if (cf60) then v104 else v104, map[v1 := v5], map[v1 := v5], v104, v104 + v104, (map[v1[safeIndex(|(set v106 : int | v106 in v105 :: (safeModuloInt(v106, -0x2f)))|, |v1|) := p1] := v5])[v1 := v5], v104[v1 := v5], v104, v104[[|v1|] := v5], v104, map[v1 := v5] + v104, v104, v104, v104 + v104, map[v1 := v5], if (p2) then v104 else v104, map[v1 := v5], v104, v108[safeIndex(|v109|, |v108|)], v104, v104, v104 + map[v1 := v5], if (f41) then map[v1 := v5] else v104, v104, v104, v104, v104];
				v110[safeIndex(338, v110.Length)] := v104;
				var v111: set<int> := {cf61, cf61, p0, |"alwg"|};
				cf60, v110[safeIndex(338, v110.Length)], globalState.f26, cf60 := f41, v104 + v104, v5[safeIndex(274, v5.Length)], (p0 + |v111|) >= p0;
				var v112: map<string, int> := map[v0 + "tplisdmqt" := p0 * p1];
				var v113: multiset<bool> := multiset{p2, cf60, f41};
				globalState.f26, v3, globalState.f26, cf61 := v5[safeIndex(274, v5.Length)], fm32(globalState), if (v0 in v112) then v112[v0] else safeModuloInt(p0, v5[safeIndex(274, v5.Length)]), |v113| + safeDivisionInt(0x263, p1);
				globalState.f9, cf60, globalState.f1, globalState.f1 := p1 - safeModuloInt(cf59, -0x22e), cf61 < cf61, cf60, cf60;
				...
				var v117: array<seq<bool>> := new seq<bool>[20] [[false, f41], [f41], v109, [cf60, cf60, p2, p2], v114.cf12, v109, v109, v109, [cf60, f41], [if (v115 in v116) then v116[v115] else cf60], v109[safeIndex(-v5[safeIndex(274, v5.Length)], |v109|) := cf60], fm63(v3, f41, p0, globalState), [p2], ([true])[safeIndex(p0, |[true]|) := if (p0 in v94) then v94[p0] else true], v109, v109, [cf60], v109, v109, [f41]];
				var v118: map<int, array<seq<bool>>> := map[v1[safeIndex(v5[safeIndex(274, v5.Length)], |v1|)] := v117];
			...
			case DC38(cf63, cf64) =>
				...
				globalState.f1 := v5[safeIndex(274, v5.Length)] != safeDivisionInt(0x2a5, if (v120 in v121) then v121[v120] else p1);
			case DC35(cf55) =>
				var v122 := new C0(f41);
				...
				match (v124.(cf27 := p0)) {
					case DC14(cf27) =>
						var v125: map<char, bool> := map[v0[safeIndex(cf27, |v0|)] := f41];
						v125 := v125['x' := p2];
						var v126: map<int, string> := map[|v94| + |map[v3 := f41]| := if (v122.f46) then v0 else v0[safeIndex(|v0|, |v0|) := v3]];
						v126 := v126[cf27 := fm30(v122.f46, 0x326, globalState)];
						var v127: array<array<int>> := new array<int>[5];
						v127[safeIndex(291, v127.Length)] := v5;
						v127[safeIndex(291, v127.Length)] := v5;
						globalState.f1 := false;
					case DC13(cf26) =>
						var v128: map<string, array<bool>> := map[if (f41) then v0 else seq(abs(840), i13  => (v3)) := v123];
						globalState.f21 := if (v0 in v128) then v128[v0] else v123;
						globalState.f1 := -0x1cf == v5[safeIndex(274, v5.Length)];
						globalState.f6 := -p1;
			...
			case DC39(cf65) =>
				globalState.f1 := !p2;
				globalState.f6, v0, globalState.f11, globalState.f1, v5[safeIndex(274, v5.Length)] := p0 - p0, v0, -(p1 - v5[safeIndex(274, v5.Length)]), f41, p1;
				if (!p2) {
					var v129: map<int, int> := map[p0 := p1];
					var v130 := DC12(f41, v129, p2, p0, v5[safeIndex(274, v5.Length)]);
					var v131: seq<D4> := [v130, v130];
					var v132 := DC38(p1, p0);
					var v133: map<bool, D15> := map[f41 := v132];
					var v134 := DC35(v95);
					var v135: seq<D15> := [v134, DC35((seq(abs(635), i14  => (v0)))[safeIndex(p0, |(seq(abs(635), i14  => (v0)))|) := v0]), v134, v134, v134];
					v5[safeIndex(274, v5.Length)], v131, v133, globalState.f1, v135 := p0, v131, v133 + map[p2 := v132], p2, v135;
					globalState.f1 := (fm68(f41, |v0|, p2, globalState)).cf46;
					globalState.f26 := v5[safeIndex(274, v5.Length)];
					globalState.f1 := {p2, !f41} >= {fm29(seq(abs(0x357), i15  => (v3)), v0, 910, --v5[safeIndex(274, v5.Length)], globalState)};
					var v136: map<array<int>, char> := map[v5 := v3];
					globalState.f1 := p1 >= (|v136| + p0);
				} else {
					var v137 := new C2(v3, false);
					globalState.f9 := v5[safeIndex(274, v5.Length)];
					...
					v141[safeIndex(902, v141.Length)] := p2;
					var v142: map<bool, bool> := map[p2 := p2];
					v140, globalState.f11, v141[safeIndex(902, v141.Length)] := fm69(v142, globalState), v5[safeIndex(274, v5.Length)] + |v0|, f41;
					var v147: array<set<D14>> := new set<D14>[1](i16 => {DC33({multiset{v141[safeIndex(902, v141.Length)], f41}, multiset([f41, p2]), multiset{f41, f41}})} + {DC33({multiset{f41}}), DC33({multiset{true, p2, f41}, multiset{v141[safeIndex(902, v141.Length)]}}), DC33({multiset{p2, p2}}), DC33(set v144 : multiset<bool> | v144 in (set v143 : multiset<bool> | v143 in {multiset{f41}} :: (v143)) :: (v144)), DC33(set v146 : multiset<bool> | v146 in (map v145 : multiset<bool> | v145 in {multiset{p2, p2}} :: (v145) := (v141[safeIndex(902, v141.Length)])) :: (v146))});
					...
					v151[safeIndex(582, v151.Length)] := v153;
					v151[safeIndex(582, v151.Length)] := DC9(p1, f41 <==> v141[safeIndex(902, v141.Length)]);
				}
				...
				var v159: array<bool> := new bool[13] [f41, f41, f41, f41 <== f41, if (if (p1 in v94) then v94[p1] else f41) then false else f41, !f41, fm70(!fm47(|v154.cf30|, !f41, p0, f41, globalState), v155, globalState) <= v156, true, v156 >= v156, f41, v158 >= v158, !p2, (seq(abs(-0x4d), i18  => (v5[safeIndex(274, v5.Length)]))) <= v1];
				v159[safeIndex(313, v159.Length)] := f41 ==> f41;
				var v160 := DC9(p1, p2);
				var v161 := DC10(v160);
				var v162: seq<D3> := [v161];
				v159[safeIndex(313, v159.Length)] := if (f41) then !(v161 in v162) else f41;
		}
...
class C5 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
		...
		for i0 := p0 to p0 {
			...
			v0[safeIndex(11, v0.Length)] := f40;
			v0[safeIndex(11, v0.Length)] := !f40;
			r2 := safeDivisionInt(safeModuloInt(-i0, i0), -0x1e0);
			globalState.f1 := f40;
			globalState.f26 := safeDivisionInt(i0, p0);
		}
		var v1 := "vq";
		...
		v4[safeIndex(885, v4.Length)] := "ewiu";
		var v5: seq<string> := [if (f40) then "ev" else v1, "qeliq"];
		v4[safeIndex(885, v4.Length)] := v5[safeIndex(|v1|, |v5|)];
		globalState.f1 := !(if (f40) then if (false) then f28 else true else true);
		for i2 := --|v4[safeIndex(885, v4.Length)]| to fm24(f40, p0, globalState) {
			var v6: T0 := new C3(f28, p0);
			var v7: map<T0, int> := map[v6 := p0];
			r2 := safeModuloInt(if (v6 in v7) then v7[v6] else p0, p0);
			globalState.f1 := f28;
		...
		r1 := p0 * p0;
		r2 := p0 - (p0 - 549);
		r3 := v4[safeIndex(885, v4.Length)] <= ((seq(abs(-409), i3  => ('k'))) + v1);
	}
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		r1 := f40;
		...
		var v7: map<string, seq<bool>> := map[v1 := v6[safeIndex(0x386, |v6|) := f28]];
		v6 := if ((v1 + (seq(abs(0x45), i0  => ('s')))) in v7) then v7[v1 + (seq(abs(0x45), i0  => ('s')))] else v6;
		var v8: array<array<int>> := new array<int>[28];
		var v9: array<int> := new int[19];
		v8[safeIndex(89, v8.Length)] := v9;
		v8[safeIndex(89, v8.Length)] := v9;
		v9[safeIndex(453, v9.Length)] := v4;
		var v10 := 't';
		...
		v9[safeIndex(453, v9.Length)] := if (v12 in v13) then v13[v12] else -safeDivisionInt(v4, -|{f28}|);
		var v14 := new C1(v11.f28, v4 - v4);
		v1 := v1 + (seq(abs(689), i1  => (v10)))[safeIndex(-v4, |(seq(abs(689), i1  => (v10)))|) := 'n'];
		r0 := v10;
		r1 := (if (f40 in v0) then v0[f40] else v14.f45) > -fm24(true, v4, globalState);
		var v15: seq<string> := [v1, v1];
		var v16: map<string, string> := map[v1 := v15[safeIndex(|v1|, |v15|)]];
		r2 := |(v16 + v16)|;
	}
	method m14(p0: int, p1: map<int, multiset<int>>, p2: map<string, array<bool>>, p3: int, globalState: GlobalState) returns (r0: int) {
		var v1: array<map<int, bool>> := new map<int, bool>[22](i0 => map[p0 := f28] + (map v0 : int | (-0x277 <= v0) && (v0 < 0x3ab) :: (safeModuloInt(v0, p3)) := (f40)));
		v1 := v1;
		for i1 := p3 to p0 + p3 {
			var v2 := "alwlr";
			...
			match (v3) {
				case DC8(cf14, cf15, cf16) =>
					...
					var v6: array<int> := new int[4](i2 => safeModuloInt(i2, 860));
					var v7: map<int, bool> := map[p3 := f40];
					globalState.f11, globalState.f3, cf16, globalState.f26 := safeDivisionInt(cf15, i1 - |v5|), if (f28) then v6 else v6, !(DC17(v2).cf30 == v2[safeIndex(0xdd, |v2|) := 'a']), if (fm23(f40, true, -p3, globalState)) then |v7| else p3;
				...
				case DC9(cf17, cf18) =>
					...
					var v13: set<string> := {seq(abs(0x308), i3  => ('i'))};
					v13 := v13;
					globalState.f1 := f28;
				...
				case DC7(cf13) =>
					...
					v20[safeIndex(351, v20.Length)] := f28;
					v20[safeIndex(351, v20.Length)] := fm23(f40, f28, -p3, globalState);
					globalState.f11 := p0 * p0;
					var v21 := new C4(f40);
				case DC10(cf19) =>
					var v22 := 'n';
					var v23 := DC3(v22);
					var v24: array<char> := new char[17] ['e', v22, v22, v2[safeIndex(i1, |v2|)], fm32(globalState), v22, v22, if (f28) then v22 else v2[safeIndex(p3, |v2|)], v22, v22, v22, v23.cf3, 'i', v22, v22, v22, v22];
					v24[safeIndex(360, v24.Length)] := fm32(globalState);
					v24[safeIndex(360, v24.Length)] := 'g';
					var v25: seq<int> := [i1];
					globalState.f1 := v25 < v25;
					globalState.f11 := -(p0 + p3);
					var v26: set<string> := {v2, v2, v2[safeIndex(p0, |v2|) := v24[safeIndex(360, v24.Length)]], v2};
					globalState.f1 := !(v2 !in v26);
			}
			
			var v27: seq<bool> := [f40];
			var v28: array<bool> := new bool[7] [fm23(f40, f28, i1, globalState), true, f28, v27[safeIndex(p0, |v27|)], f40, f40, f40];
			var v29: map<array<bool>, int> := map[v28 := i1];
			var v30: array<int> := new int[3] [|v29|, p3, fm24(f28, i1, globalState)];
			var v31: multiset<bool> := multiset{fm29(seq(abs(0x147), i5  => ('n')), v2, p3, |v2|, globalState)};
			v30[safeIndex(564, v30.Length)] := if (f40 in v31) then v31[f40] else i1;
			v30[safeIndex(564, v30.Length)] := 569;
			var v32: map<bool, bool> := map[f40 := f28];
			if (if (f40 in v32) then v32[f40] else f28) {
				globalState.f6 := i1;
				globalState.f1 := (fm71(i1, v31, f40, globalState)).cf50;
				v31 := v31 - v31;
				v28[safeIndex(495, v28.Length)] := true;
				var v33: map<int, bool> := map[-p3 := f40];
				var v34: seq<string> := [v2, v2];
				v28[safeIndex(495, v28.Length)] := if (if (|v34[safeIndex(p0, |v34|)]| in v33) then v33[|v34[safeIndex(p0, |v34|)]|] else fm29(v2, v2, p3, v30[safeIndex(564, v30.Length)], globalState)) then v27 <= [f40, f28] else f40;
				var v35 := new C3(f28, i1);
			} else {
				globalState.f3 := DC7(v30).cf13;
				v28[safeIndex(13, v28.Length)] := f40;
				v28[safeIndex(13, v28.Length)] := f40;
				var v36 := 'p';
				v2 := (if (f40) then seq(abs(0x29c), i6  => ('b')) else v2)[safeIndex(p3, |(if (f40) then seq(abs(0x29c), i6  => ('b')) else v2)|) := v36];
				var v37 := new C1(f40, if (v27[safeIndex(v30[safeIndex(564, v30.Length)], |v27|)]) then |v31| else |"nhhwkykj"|);
				globalState.f26 := p3;
			}
			...
			decreases 100 - i7
		{
			...
			if (fm29(v39 + "hyak", v39, p0, p3, globalState)) {
				...
				v43[safeIndex(330, v43.Length)] := p0 > p0;
				v43[safeIndex(330, v43.Length)] := p3 < p3;
				var v44 := 'e';
				v39 := ((v39 + "gwjouoxin") + (v39 + v39))[safeIndex(|fm63(v44, f40, -317, globalState)|, |((v39 + "gwjouoxin") + (v39 + v39))|) := v44];
				v43[safeIndex(330, v43.Length)] := safeModuloInt(p3, 711) >= |v39|;
				globalState.f26 := p3 + p0;
			} else {
				var v45: array<int> := new int[8](i9 => safeModuloInt(i9, p3));
				v45[safeIndex(873, v45.Length)] := p3;
				var v46: seq<bool> := [!f28];
				v45[safeIndex(873, v45.Length)], globalState.f11, globalState.f1, v39 := |v46| * p0, p0, f28, fm30(f28, p3, globalState) + v39;
				...
				v49[safeIndex(512, v49.Length)] := if (f40) then v47 else v47;
				var v50: multiset<int> := multiset{p3, v45[safeIndex(873, v45.Length)], p0};
				var v51 := DC5(f40, v50, p0);
				globalState.f1, v49[safeIndex(512, v49.Length)], globalState.f1 := fm29(v39, seq(abs(0x243), i10  => ('r')), v45[safeIndex(873, v45.Length)], v45[safeIndex(873, v45.Length)], globalState), v47, v51.cf7;
				var v52: map<bool, int> := map[f40 := v45[safeIndex(873, v45.Length)]];
				v52 := v52[f28 <== f28 := safeModuloInt(p0, -p0)];
				var v53: map<int, int> := map[v45[safeIndex(873, v45.Length)] := p0];
				v53 := v53;
				var v54: array<seq<seq<int>>> := new seq<seq<int>>[4];
				v54[safeIndex(947, v54.Length)] := seq(abs(737), i11  => ([v45[safeIndex(873, v45.Length)], p0, v45[safeIndex(873, v45.Length)]]));
				var v55: seq<int> := [v45[safeIndex(873, v45.Length)]];
				var v56: seq<seq<int>> := [v55];
				v54[safeIndex(947, v54.Length)] := v56;
			}
			
			var v57: map<bool, bool> := map[f40 := f40];
			var v58 := DC24(v57);
			var v59: multiset<D10> := multiset{v58, if (f40) then v58 else v58, if (f40) then v58 else v58};
			v59 := (v59 * v59)[v58 := abs(p3)];
		...
		for i12 := p0 - p3 to p0 {
			...
			r0 := safeDivisionInt(i12, |v64.cf12|);
			var v65: seq<int> := [p3];
			globalState.f11, v65 := i12 + p3, v65;
			var v66: array<D13> := new D13[13];
			var v67 := "tk";
			var v68: map<array<D13>, string> := map[v66 := v67];
			v68 := v68[v66 := if (f28) then seq(abs(0x3e0), i13  => ('e')) else "pscwigjl"];
			var v69: array<bool> := new bool[12] [!!f40, f28, f28, f40, f28, f40, false, f40, f40, f28, fm47(v65[safeIndex(|v65|, |v65|)], f40, p3, f28, globalState), f28];
	...
	method m15(p0: array<D2>, p1: int, p2: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
		for i0 := -88 to p1 {
			...
			v1 := v1;
			var v2 := "wfokarivo";
			var v3 := new C4(fm29(seq(abs(0x32e), i1  => ('s')), v2, p1, i0, globalState) ==> !f28);
			var v4: seq<bool> := [f40, !!f40];
			var v5 := DC9(i0, p2);
			var v6 := DC1(p2);
			var v7: map<int, int> := map[0x225 := |v2|];
			var v8: array<D3> := new D3[16] [DC9(i0, v4[safeIndex(p1, |v4|)]), v5, v5, v5, DC9(i0, v6.cf1), v5, v5, v5, v5, v5, v5, v5, v5, DC9(|v7|, p2), v5, if (!p2) then v5 else DC9(i0, v3.f41)];
			v8[safeIndex(613, v8.Length)] := v5;
			var v9: seq<int> := [|"gyg"|];
			var v10: seq<seq<int>> := [[p1], v9, v9];
			var v12: seq<string> := [v2];
			globalState.f15, globalState.f11, v8[safeIndex(613, v8.Length)], globalState.f9 := v0, i0, if (v9 < v10[safeIndex(i0, |v10|)]) then v5 else v5, safeModuloInt(i0, |(map v11 : string | v11 in v12 :: (v11) := (multiset{v3.f41, v3.f41}))|);
			globalState.f6 := p1;
		}
		var v13 := "o";
		...
		match (DC36(p1, p1, p1).(cf57 := v14.cf58, cf56 := p1)) {
			case DC36(cf56, cf57, cf58) =>
				...
				var v19: array<int> := new int[15] [safeDivisionInt(fm24(true, cf57, globalState), p1), cf56, cf56, cf56, fm48(0x3da, p2, globalState), |(map[!f40 := f40] + map[false := false])|, safeModuloInt(cf56, |v13|), cf58, cf56, |v15|, p1, cf56, if (fm48(-p1, f28, globalState) in v17) then v17[fm48(-p1, f28, globalState)] else |v18|, |"lwvxaic"|, |fm31(p2, v13[safeIndex(cf56, |v13|)], globalState)|];
				v19[safeIndex(908, v19.Length)] := 860;
				v19[safeIndex(908, v19.Length)] := |(seq(abs(0x3ad), i2  => ('w')))|;
				v19[safeIndex(908, v19.Length)] := p1;
				var v20 := 'i';
				var v21: seq<string> := [("sv")[safeIndex(p1, |"sv"|) := v20], v13];
				v21 := [v13 + v13, v13, v13];
				...
				match (v23) {
					case DC18(cf31, cf32, cf33) =>
						...
						v24[safeIndex(97, v24.Length)] := false;
						globalState.f1, v24[safeIndex(97, v24.Length)], globalState.f1, globalState.f11 := f28, cf31, if (cf31) then !f40 else fm47(p1, p2, p1, false, globalState), safeDivisionInt(safeModuloInt(p1, cf33), cf33);
						var v25: array<D15> := new D15[18](i4 => DC39(DC39(DC36(p1, v19[safeIndex(908, v19.Length)], p1))));
						var v26: multiset<string> := multiset{"fnplqmpb", v13};
						v25[safeIndex(646, v25.Length)] := fm72(DC45(p1, 0xc, cf31, p1).(cf73 := f28, cf71 := |v26|), cf32, v19[safeIndex(908, v19.Length)], 0x32d, globalState);
						var v27: map<int, bool> := map[|(seq(abs(0x189), i5  => (cf32)))| := cf31];
						var v28: map<int, bool> := map[|v27| := true];
						var v29: seq<bool> := [p2, v24[safeIndex(97, v24.Length)]];
						var v30 := DC6(|v28|, cf33, v29);
						var v31 := DC36(p1, v30.cf11, |map[cf57 := v15]|);
						var v32 := DC39(v31);
						globalState.f11, v25[safeIndex(646, v25.Length)] := p1, v32;
						var v33: set<char> := {v20};
						var v34 := DC41(v33);
						var v35: seq<D17> := [v34];
						v24[safeIndex(97, v24.Length)] := if (true) then if (f28) then f28 else !v24[safeIndex(97, v24.Length)] else v35 < v35;
						var v36 := new C1(f40, cf33);
					case DC19(cf34) =>
						globalState.f1 := !p2;
						globalState.f11 := cf57;
						v19[safeIndex(908, v19.Length)] := |fm33(true, p1 - cf56, f40, f28, globalState)|;
						var v37: map<int, int> := map[cf57 := v19[safeIndex(908, v19.Length)]];
						globalState.f6 := v19[safeIndex(908, v19.Length)] - (if (cf58 in v37) then v37[cf58] else p1);
					case DC17(cf30) =>
						globalState.f15 := v20;
						var v38: seq<seq<int>> := [v15];
						cf57, globalState.f1, globalState.f6, v38 := -v19[safeIndex(908, v19.Length)], if (p2) then !p2 else f28 ==> f40, cf56, v38;
						v19[safeIndex(908, v19.Length)] := safeDivisionInt(cf56, |(v13 + (seq(abs(0x23b), i6  => (v20)))[safeIndex(cf57, |(seq(abs(0x23b), i6  => (v20)))|) := v20])|);
						...
						v39[safeIndex(257, v39.Length)] := v41;
						v39[safeIndex(257, v39.Length)] := v41;
					case DC20(cf35) =>
						globalState.f9 := cf57;
						globalState.f6 := if (f28) then |v13| else safeDivisionInt(cf58, p1);
						var v42: set<bool> := {false};
						var v43: map<int, int> := map[|v42| := v19[safeIndex(908, v19.Length)]];
						var v45 := DC12(false, v43, f40, |(map v44 : int | v44 in [cf56, cf56] :: (v44 + v19[safeIndex(908, v19.Length)]) := (cf56))|, |v18|);
						...
						v48 := v48[v47 + (map v49 : seq<bool> | v49 in [v50, v50] :: (v49) := (f40)) := v19[safeIndex(908, v19.Length)]];
				}
				
			case DC37(cf59, cf60, cf61, cf62) =>
				var v51: array<int> := new int[22];
				v51[safeIndex(807, v51.Length)] := p1;
				var v52: seq<bool> := [f28];
				var v53 := 'e';
				v51[safeIndex(807, v51.Length)] := |v13[safeIndex(cf59 * |v52|, |v13|) := v53]|;
				var v54: map<bool, int> := map[p2 := v51[safeIndex(807, v51.Length)]];
				v54 := v54[p2 := cf61];
				var v55: set<int> := {fm24(cf60, 206, globalState)};
				cf60 := cf60 && (v55 >= {-668});
				var v56: seq<int> := [v51[safeIndex(807, v51.Length)]];
				var v57: seq<seq<int>> := [v56];
				globalState.f26, v56, globalState.f1 := if (f40) then cf59 else v51[safeIndex(807, v51.Length)], (if (p2) then (v57[safeIndex(-v51[safeIndex(807, v51.Length)], |v57|)])[safeIndex(v51[safeIndex(807, v51.Length)], |v57[safeIndex(-v51[safeIndex(807, v51.Length)], |v57|)]|) := v51[safeIndex(807, v51.Length)]] else v56) + (seq(abs(0x1b), i7  => (v51[safeIndex(807, v51.Length)]))), f28;
			case DC38(cf63, cf64) =>
				...
				v60[safeIndex(585, v60.Length)] := cf63;
				v60[safeIndex(585, v60.Length)] := cf64;
				globalState.f15 := v13[safeIndex(p1, |v13|)];
				if (p2) {
					...
					v61[safeIndex(804, v61.Length)] := v63;
					v61[safeIndex(804, v61.Length)], globalState.f1, globalState.f1, globalState.f1, globalState.f1 := v63 - (v63 + v63), p2, f28, v13 != v13, !(v13 < "xmciy");
					v58 := v58;
					cf63 := v60[safeIndex(585, v60.Length)];
					globalState.f11 := fm24(p2, safeModuloInt(p1, cf64), globalState);
					var v64: array<D13> := new D13[21];
					var v65 := 'm';
					var v66 := DC32(DC31(!f40, p2, v65));
					v64[safeIndex(293, v64.Length)] := v66;
					v64[safeIndex(293, v64.Length)] := v66;
				} else {
					globalState.f1 := f40;
					...
					var v74 := DC43(v73);
					v72[safeIndex(610, v72.Length)] := if (p2) then v74.(cf69 := v73) else v74;
					v72[safeIndex(610, v72.Length)] := DC43(v73);
				}
			...
			case DC39(cf65) =>
				...
				v77[safeIndex(54, v77.Length)] := f28;
				var v78: map<string, bool> := map[v13 := true];
				var v79: multiset<bool> := multiset{f40, false, if (v13 in v78) then v78[v13] else true};
				v77[safeIndex(54, v77.Length)] := (if (f28 in v79) then v79[f28] else |(seq(abs(680), i8  => ('a')))|) < safeModuloInt(p1, p1);
				v13 := v13 + v13;
		}
		...
		match (v81) {
			case DC18(cf31, cf32, cf33) =>
				...
				v87[safeIndex(646, v87.Length)] := v88;
				...
				v86, globalState.f1, v87[safeIndex(646, v87.Length)] := if ((if (f28) then v89 else v89) in v90) then v90[if (f28) then v89 else v89] else v86, v92 == v92, v88 * v88[v93 := abs(|fm27(globalState)|)];
				cf31 := f28;
				...
				if ((v94 > v94) && f40) {
					...
					var v99, v100, v101, v102 := v96.m1(-safeDivisionInt(|map[false := 0x3ca]|, -cf33), globalState);
				} else {
					cf31 := p2;
					...
					var v107 := m14(p1, v104[safeIndex(-|v13|, |v104|)], v106, cf32, globalState);
					globalState.f15 := v82;
					var v108: array<D11> := new D11[22];
					var v109 := DC26(p2);
					v108[safeIndex(136, v108.Length)] := v109;
					v108[safeIndex(136, v108.Length)] := if (f40) then v109 else DC26(f40);
				}
			...
			case DC19(cf34) =>
				...
				match (v112) {
					case DC43(cf69) =>
						...
						globalState.f9 := safeModuloInt(p1 - |v114|, cf34);
						globalState.f1 := true;
			...
			case DC17(cf30) =>
				...
				v121[safeIndex(703, v121.Length)] := if (f40) then v80 else v80;
				var v122: array<bool> := new bool[2](i12 => f40);
				v122[safeIndex(923, v122.Length)] := p2;
				v80[safeIndex(286, v80.Length)] := |fm30(p2, p1, globalState)|;
				var v123: multiset<int> := multiset{p1, 0x1fe};
				globalState.f26, v121[safeIndex(703, v121.Length)], v122[safeIndex(923, v122.Length)], v80[safeIndex(286, v80.Length)] := 0x4a + safeDivisionInt(|v123|, |v13|), v80, if (true) then f40 else f28, p1;
				if (f40) {
					var v124: map<int, bool> := map[p1 := v122[safeIndex(923, v122.Length)]];
					var v125: map<string, int> := map[cf30 := |v124|];
					v125 := v125;
					globalState.f9 := 0x2f5 + 0x187;
					v122[safeIndex(923, v122.Length)] := fm47(|[p2, f40]|, map[p1 := p2] != v124, v80[safeIndex(286, v80.Length)], f40, globalState);
					var v126: map<int, array<int>> := map[p1 := v121[safeIndex(703, v121.Length)]];
					var v127 := DC21(v126);
					v127 := DC21(v126 + v126);
					var v128 := DC9(fm48(v80[safeIndex(286, v80.Length)], f28, globalState), f40);
					var v129: array<array<bool>> := new array<bool>[3];
					var v130: multiset<bool> := multiset{f40, f28};
					var v131: map<bool, string> := map[v122[safeIndex(923, v122.Length)] := cf30];
					v122[safeIndex(923, v122.Length)], globalState.f21, v128, globalState.f1, v129 := f40, v122, v128, v80[safeIndex(286, v80.Length)] <= -(|v130| * |(if (true in v131) then v131[true] else cf30)|), v129;
				} else {
					var v132: map<int, bool> := map[p1 := !v122[safeIndex(923, v122.Length)]];
					v132 := v132 + fm64(f40, -v80[safeIndex(286, v80.Length)], globalState);
					var v133: seq<int> := [v80[safeIndex(286, v80.Length)], p1];
					var v134 := 'd';
					var v135: map<seq<int>, char> := map[v133 := v134];
					globalState.f1 := (fm74(v80[safeIndex(286, v80.Length)], p2, false, fm32(globalState), globalState)).cf78 == v135;
					v13 := (v13 + cf30) + cf30;
					globalState.f15 := v134;
					v133 := (v133 + v133) + (seq(abs(-417), i13  => (p1)));
				}
				
				var v136: map<D7, bool> := map[DC16(fm25(cf30, f28, globalState)) := p2];
				var v137: multiset<bool> := multiset{f40, p2, f28, p2, true};
				var v138: seq<set<bool>> := [{v122[safeIndex(923, v122.Length)], p2}];
				var v139: seq<int> := [p1];
				var v140: map<multiset<bool>, set<bool>> := map[v137 := v138[safeIndex(|v139|, |v138|)]];
				var v141 := DC16(v140);
				var v142: multiset<bool> := multiset{p2, v122[safeIndex(923, v122.Length)], if (v141 in v136) then v136[v141] else p2};
				v122[safeIndex(923, v122.Length)] := v137 <= v137;
				var v143: set<bool> := {true};
				var v144: map<int, multiset<int>> := map[v80[safeIndex(286, v80.Length)] := multiset{p1}];
			...
			case DC20(cf35) =>
				...
				v147 := v147[safeModuloInt(p1, p1) := v13];
		...
		r1 := safeModuloInt(|multiset{v157, v157, v157, v157}|, p1) + (p1 + p1);
		r2 := 0x2b0;
	}
}
...
class C6 extends T0 {
	...
	function fm19(p0: bool, p1: int, p2: set<D1>, p3: string, globalState: GlobalState): bool {
		--safeDivisionInt(f39, f39) in (set v0 : int | (671 <= v0) && (v0 < 0x3d) :: (v0 + |multiset{true}|))
	}
	function fm20(p0: map<int, string>, globalState: GlobalState): seq<int> {
		(seq(abs(0x231), i0  => (f39))) + ([f39] + (seq(abs(-567), i1  => (f39))))
	}
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		var v0 := false;
		...
		match (v2) {
			case DC8(cf14, cf15, cf16) =>
				...
				globalState.f26 := safeDivisionInt(f39 + cf14, safeDivisionInt(f39, -cf14));
			...
			case DC9(cf17, cf18) =>
				...
				match (v11) {
					case DC2(cf2) =>
						globalState.f3 := p1;
						p1[safeIndex(151, p1.Length)] := p0;
						p1[safeIndex(151, p1.Length)] := -safeModuloInt(|p2| * cf17, 0xae);
						v0 := cf18;
						...
						var v16: seq<int> := [996];
						var v17: array<int> := new int[11] [cf2, p0, p1[safeIndex(151, p1.Length)], cf17, cf17, |v12|, |v13|, |v15|, cf2, |v16|, cf2];
					...
					case DC1(cf1) =>
						...
						p1[safeIndex(484, p1.Length)] := 0x1ce;
						p1[safeIndex(484, p1.Length)] := fm0(safeDivisionInt(0x337, cf17), cf18, globalState);
						var v25: set<int> := {f39, p1[safeIndex(484, p1.Length)]};
						globalState.f26, globalState.f7 := |fm22(0x29b, seq(abs(0x105), i1  => (0x334)), cf1, p0, globalState)| - -0x148, v25 * {-f39};
						cf17 := f39;
				}
				...
				if (true) {
					...
					globalState.f9 := safeModuloInt(f39, f39);
					globalState.f1 := !false;
					var v28 := "axcdv";
					v28 := ("gvgkpbq" + p2) + (seq(abs(47), i2  => (v26)));
					var v29: set<int> := {0x187, p0, f39, cf17};
					var v30: array<set<int>> := new set<int>[7] [v29, v29, v29, v29, v29, v29, v29];
					var v31: seq<int> := [p0];
					v30[safeIndex(961, v30.Length)] := (set v32 : int | v32 in v31 :: (v32 - 0x124)) + v29;
					v30[safeIndex(961, v30.Length)] := v29;
				} else {
					var v33 := DC14(f39);
					v33 := v33;
			...
			case DC7(cf13) =>
				...
				v37[safeIndex(977, v37.Length)] := fm19(v0, |p2|, set v40 : D1 | v40 in v39 :: (v40), p2, globalState);
				v37[safeIndex(977, v37.Length)] := v0;
				var v41 := 'a';
			...
			case DC10(cf19) =>
				if (p2 != (p2 + p2)) {
					var v42 := "mjvn";
					var v43 := 'v';
					v42 := (p2 + "imdvaqw")[safeIndex(p0, |(p2 + "imdvaqw")|) := v43];
					...
					v54[safeIndex(195, v54.Length)] := {v0, v0, v0, v0};
					v54[safeIndex(195, v54.Length)] := v51 * (v51 + v51);
				}
				
				var v55: array<string> := new string[29];
				v55[safeIndex(128, v55.Length)] := p2;
				v55[safeIndex(128, v55.Length)] := seq(abs(0x74), i5  => ('r'));
				var v56: map<bool, bool> := map[v0 := v0];
				var v57: map<bool, int> := map[v0 := fm0(DC2(p0).cf2, v0, globalState)];
				var v58: multiset<int> := multiset{p0, |v57|, f39, 797, |v55[safeIndex(128, v55.Length)]|};
				if (fm29(seq(abs(0x1e0), i6  => ('e')), v55[safeIndex(128, v55.Length)], |v56|, |v58[p0 := abs(p0)]| * f39, globalState)) {
					v56 := v56;
					...
					var v67 := DC43(v66[safeIndex(0x289, |v66|)]);
					v61[safeIndex(857, v61.Length)] := v67;
					v60, v61[safeIndex(857, v61.Length)], r0, globalState.f1 := if (v0) then v60 else multiset{v0}, v67, v0, v0;
					globalState.f11 := 0x2b3;
					globalState.f1 := v0;
				} else {
					var v68: multiset<string> := multiset{v55[safeIndex(128, v55.Length)]};
					...
					v69[safeIndex(733, v69.Length)] := v57;
					globalState.f1, v69[safeIndex(733, v69.Length)] := v0, v57;
					globalState.f1 := !v0;
				...
				var v73: seq<string> := [v55[safeIndex(128, v55.Length)]];
				var v74 := DC37(f39, v0, 0x1cf, v73);
				p1[safeIndex(969, p1.Length)] := v74.cf61;
				p1[safeIndex(969, p1.Length)] := fm24(v0, p0, globalState);
		}
		
		var v75: array<bool> := new bool[19];
		forall i7 | 0 <= i7 < v75.Length {
			v75[i7] := {[68], [f39, f39, p0]} > ({[f39], seq(abs(0x19f), i8  => (f39))} + {[p0], [|{v0, v0}|], [p0, f39, f39, p0, p0]});
		}
		var v76 := 'm';
		...
		match (fm75(!v0, globalState)) {
			case DC14(cf27) =>
				...
				cf27, globalState.f1, v79, v80 := safeDivisionInt(|map[v80.f28 := v77.f47]|, p0 * cf27), fm19(!v80.f28, p0, v82, p2, globalState), v79, v80;
				...
				if (!(v78 in v83)) {
					...
					v75[safeIndex(931, v75.Length)] := v80.f28;
					v75[safeIndex(931, v75.Length)] := v80.f28;
					var v84: array<set<seq<bool>>> := new set<seq<bool>>[11](i9 => {v1});
					v84[safeIndex(614, v84.Length)] := fm76(v77.f47, v78, -p0, globalState);
					var v85: set<seq<bool>> := {v1 + [fm19(v0, 0x2dc, v82, seq(abs(455), i10  => (v77.f47)), globalState)], v1, v1 + v1};
					v84[safeIndex(614, v84.Length)] := v85;
				} else {
					var v87: map<D5, bool> := map[DC13(seq(abs(0x2b7), i11  => (|(map v86 : int | v86 in map[p0 := v80.f28] :: (v86 * -|{|multiset(v1)|}|) := (f39))|))) := false];
					...
					v94[safeIndex(386, v94.Length)] := v95 + v95;
					var v96: set<map<int, bool>> := {v92[98 := v0], map[0x39 := v80.f28]};
					var v97: multiset<int> := multiset{501};
					v93, globalState.f1, globalState.f9, v0, v94[safeIndex(386, v94.Length)] := v93, v96 !! v96, safeModuloInt(-p0, p0), !fm19(v80.f28, 0x3cc * cf27, v82, v78, globalState), v95[v80.f28 := safeDivisionInt(|v97|, p0)];
				...
				globalState.f9 := p0;
			case DC13(cf26) =>
				p1[safeIndex(624, p1.Length)] := safeDivisionInt(f39, f39);
				v75, p1[safeIndex(624, p1.Length)], globalState.f1 := v75, p0, !v0;
				var v99 := new C5(v0, v0);
				var v100: array<D2> := new D2[24](i13 => DC5(v0, multiset{|multiset{v0, v99.f40}|}, p1[safeIndex(624, p1.Length)]));
				var v101 := DC28(v76, v99.f40, p0, v0, p1[safeIndex(624, p1.Length)]);
				var v102: multiset<int> := multiset{p0, p0};
				v100[safeIndex(372, v100.Length)] := DC5(v101.cf46, v102, p0);
				var v103 := DC5(v0 <== false, v102 - v102[p0 := abs(|p2|)], safeModuloInt(f39, f39));
				v100[safeIndex(372, v100.Length)] := v103;
				var v104: array<int> := new int[14](i14 => safeModuloInt(i14, f39));
...
class C7 extends T0, T1 {
		...
		if (f37) {
			...
			match (v3) {
				case DC8(cf14, cf15, cf16) =>
					...
					var v5 := 'k';
					v4[safeIndex(959, v4.Length)] := v5;
					v4[safeIndex(959, v4.Length)] := fm15(globalState);
					var v6: array<array<bool>> := new array<bool>[21];
					var v7: array<bool> := new bool[9] [cf16, f38, f28, cf16, cf16, f38, f38, f37, f28];
					v6[safeIndex(26, v6.Length)] := v7;
					v6[safeIndex(26, v6.Length)] := v7;
					p1[safeIndex(393, p1.Length)] := 0x147;
					p1[safeIndex(393, p1.Length)] := p0;
					cf15 := safeDivisionInt(-(p1[safeIndex(393, p1.Length)] * p1[safeIndex(393, p1.Length)]), p1[safeIndex(393, p1.Length)] * cf15);
				case DC9(cf17, cf18) =>
					...
					p1[safeIndex(633, p1.Length)] := |p2| + p0;
					var v11 := DC9(|map[cf18 := f38]|, f37);
					var v12 := DC10(v11);
					var v13 := DC10(v12);
					var v14: map<string, D3> := map[p2 := v13];
					p1[safeIndex(633, p1.Length)] := if (f37) then |v0| else |v14|;
					globalState.f6 := cf17;
				case DC7(cf13) =>
				...
				case DC10(cf19) =>
					...
					globalState.f6, globalState.f1, v25 := p0, f37, v25[p0 := abs(safeDivisionInt(p0, -p0))];
					var v26: array<bool> := new bool[15];
					v26[safeIndex(650, v26.Length)] := !f38;
					v26[safeIndex(650, v26.Length)] := (f37 <==> true) || f38;
					var v27: array<array<int>> := new array<int>[12];
					v27[safeIndex(546, v27.Length)] := p1;
					v27[safeIndex(546, v27.Length)] := p1;
					var v28 := 'm';
					var v29: map<int, D2> := map[p0 := DC4(f38, |p2[safeIndex(|v0|, |p2|) := v28]|, true)];
			...
			var v32 := 'k';
			v31[safeIndex(871, v31.Length)] := ("ierapk" + ((fm18(globalState))[safeIndex(p0, |fm18(globalState)|) := v32])[safeIndex(p0, |(fm18(globalState))[safeIndex(p0, |fm18(globalState)|) := v32]|) := v32])[safeIndex(-0x1d3, |("ierapk" + ((fm18(globalState))[safeIndex(p0, |fm18(globalState)|) := v32])[safeIndex(p0, |(fm18(globalState))[safeIndex(p0, |fm18(globalState)|) := v32]|) := v32])|) := v32];
			...
			v35[safeIndex(425, v35.Length)] := v0;
			var v36: array<bool> := new bool[22](i3 => f28);
			v31[safeIndex(871, v31.Length)], r1, v35[safeIndex(425, v35.Length)] := p2, v36, v0 + v0;
			...
			v42[safeIndex(498, v42.Length)] := v47 >= v47;
			v46, v42[safeIndex(498, v42.Length)] := v46, f38 <==> (0xc1 != p0);
		}
		
		p1[safeIndex(584, p1.Length)] := p0;
		var v48 := DC0(p0);
		var v49 := DC14(p0);
		var v50: seq<int> := [v49.cf27, p0];
		var v51: map<int, seq<int>> := map[p0 := v50];
		p1[safeIndex(584, p1.Length)], r0, r0, r0 := p0, match v48 {
			case DC0(cf0) => f28
		}, fm16(p0, f28, if (p0 in v51) then v51[p0] else v50, globalState), f28;
		var v52: map<int, int> := map[|fm22(p1[safeIndex(584, p1.Length)], v50, f38, p1[safeIndex(584, p1.Length)], globalState)| + p0 := |map[fm24(true, 0x30a, globalState) := v50]|];
		v52 := v52[p1[safeIndex(584, p1.Length)] := safeDivisionInt(p1[safeIndex(584, p1.Length)], p1[safeIndex(584, p1.Length)])];
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			v11[safeIndex(469, v11.Length)] := f37;
			v11[safeIndex(469, v11.Length)], r3, globalState.f1, r3 := f38, f28, f38, true <== f37;
			var v12: map<bool, bool> := map[f28 := f28];
			if (fm16(if (f37) then |v8| else p0, !(if (v11[safeIndex(469, v11.Length)] in v12) then v12[v11[safeIndex(469, v11.Length)]] else v11[safeIndex(469, v11.Length)]), v1, globalState)) {
				var v13 := new C4(f38);
				var v14: array<array<bool>> := new array<bool>[26];
				v14[safeIndex(936, v14.Length)] := v11;
				v14[safeIndex(936, v14.Length)] := v11;
				globalState.f1 := !(if (true) then v11[safeIndex(469, v11.Length)] else f37);
				var v15: seq<string> := [(v9[safeIndex(p0, |v9|) := v2])[safeIndex(p0, |v9[safeIndex(p0, |v9|) := v2]|) := v2], v9, v9 + v9];
				v15 := v15 + v15;
				var v16: map<seq<bool>, int> := map[v5 := 0x109];
				v16 := v16[v5 := -(p0 - p0)];
			} else {
				var v17: multiset<int> := multiset{p0};
				var v19: array<int> := new int[22] [safeDivisionInt(p0, p0), safeDivisionInt(p0, 822), |v9|, p0, |v8| - p0, p0 - p0, p0 - p0, p0, |v5| * p0, safeModuloInt(v1[safeIndex(|{f37}|, |v1|)], p0), p0, p0, 0x212 * |("aijjomxns")[safeIndex(p0, |"aijjomxns"|) := if (v11[safeIndex(469, v11.Length)] in v3) then v3[v11[safeIndex(469, v11.Length)]] else v2]|, |({p0} - {p0, p0})|, --p0, --899, safeDivisionInt(p0, p0), p0 + |v5|, p0, p0 - p0, p0, p0 + |(set v18 : int | v18 in v17 :: (safeModuloInt(v18, 0x151)))|];
				v19[safeIndex(780, v19.Length)] := p0;
				var v20: set<int> := {-p0, p0};
				globalState.f1, v17, v19[safeIndex(780, v19.Length)] := v11[safeIndex(469, v11.Length)], fm22(p0, v1, |v4| == p0, p0, globalState), |({p0} * v20)|;
				var v21 := DC13([p0, p0]);
				globalState.f1, v21, globalState.f1 := (multiset([v19[safeIndex(780, v19.Length)], |[f38]|, 0x10]) + v17) >= v17, v21, v11[safeIndex(469, v11.Length)] || f28;
				globalState.f9 := |(v9 + v9)|;
				globalState.f1 := v11[safeIndex(469, v11.Length)];
				v7 := v7[safeModuloInt(v19[safeIndex(780, v19.Length)], p0) := f28];
			}
			
		}
		var v22: seq<bool> := [f37, if (f28) then f38 else f38];
		var v23: seq<int> := [p0];
		if (v22[safeIndex(v23[safeIndex(p0, |v23|)], |v22|)]) {
			...
			if (v30 > (v30 * v30)) {
				...
				var v32 := DC7(v24);
				var v33 := DC10(v32);
				v31[safeIndex(944, v31.Length)] := v33;
				globalState.f15, v31[safeIndex(944, v31.Length)] := v26, v33;
				...
				var v39 := DC39(v38);
				v36 := fm77(p0, v39, safeDivisionInt(|multiset{v26}|, p0), v35, globalState);
				var v40: array<bool> := new bool[29](i2 => f38);
				v40[safeIndex(812, v40.Length)] := v25.f46;
				var v41 := DC6(p0, 0x3a4, ((v22 + v22)[safeIndex(490, |(v22 + v22)|) := v25.f46])[safeIndex(|"ctlvduag"|, |(v22 + v22)[safeIndex(490, |(v22 + v22)|) := v25.f46]|) := fm16(p0, v25.f46, v23, globalState)]);
				v24[safeIndex(769, v24.Length)] := safeModuloInt(p0, p0);
				var v42: map<int, bool> := map[p0 := v25.f46];
				var v43: set<array<int>> := {v24};
				v40[safeIndex(812, v40.Length)], globalState.f26, v41, v24[safeIndex(769, v24.Length)] := !f38, (-|v42| - p0) + |v43|, v41, |v23|;
				globalState.f6 := if (!v40[safeIndex(812, v40.Length)]) then safeDivisionInt(p0, 0x236) else |(if (f38) then (map[|v35| := v25.f46])[-816 := f37] else v42)|;
				var v44: array<D2> := new D2[27];
				v44[safeIndex(849, v44.Length)] := v41;
				r2, globalState.f1, v40[safeIndex(812, v40.Length)], v44[safeIndex(849, v44.Length)], v40[safeIndex(812, v40.Length)] := v24[safeIndex(769, v24.Length)], v24[safeIndex(769, v24.Length)] !in (v23[safeIndex(|[v25.f46]|, |v23|) := fm0(p0, !f38, globalState)] + [p0]), f38, DC6(safeModuloInt(v24[safeIndex(769, v24.Length)], -0x3ad), p0, v22 + [f37, v25.f46]), !v22[safeIndex(-p0, |v22|)];
			}
			...
			var v48 := "kv";
			var v49: multiset<string> := multiset{v48, v48, seq(abs(0x103), i3  => ('t')), v48, v48};
			...
			var v58: array<set<int>> := new set<int>[21] [{p0}, v54 - v54, v54, {p0, 0x2d9}, v54, v54, v54, v54, v54, v54, {p0}, v54 - fm27(globalState), v54 - v54, v54 * v54, v54, v54, {|v56|, |v48|, 0x1f2, |v48|} * v54, v54, set v57 : int | v57 in v55 :: (safeDivisionInt(v57, 0x34b)), v54, v54];
			v58[safeIndex(984, v58.Length)] := v54;
			var v59 := 'a';
			...
			v58[safeIndex(984, v58.Length)], globalState.f1, r1, v61, globalState.f1 := {p0, if (f38) then if (v50 in v62) then v62[v50] else p0 else |v63.cf30|}, !fm29(v48 + v48, v63.cf30, p0, p0, globalState), (v65.(cf25 := p0)).cf25, v61[v22[safeIndex(|map[v66 := f38]|, |v22|)] := f37 !in v22], v48 < (v48 + v48);
		}
		
		var v67: array<array<int>> := new array<int>[22];
		var v68: array<int> := new int[26];
		v67[safeIndex(734, v67.Length)] := if (f37) then v68 else v68;
		v67[safeIndex(734, v67.Length)] := v68;
		v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] := p0;
		v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] := p0;
		var v69: array<char> := new char[11](i5 => 'r');
		var v70 := 'v';
		v69[safeIndex(294, v69.Length)] := v70;
		v69[safeIndex(294, v69.Length)] := 'n';
		if (v23 != v23) {
			var v71 := "yruxbmrx";
			var v72: map<string, char> := map[v71 := v69[safeIndex(294, v69.Length)]];
			var v73: set<char> := {'l', if (v71 in v72) then v72[v71] else v70, fm15(globalState)};
			var v74: map<int, int> := map[v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] := |v73|];
			v74 := (v74 + (map v75 : int | (0x143 <= v75) && (v75 < 0x6d) :: (v75 * p0) := (|v71|))) + v74;
			globalState.f11 := v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] * v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)];
			globalState.f11 := v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] + p0;
			globalState.f9 := |(seq(abs(0x366), i6  => (v69[safeIndex(294, v69.Length)])))|;
			var v76 := DC26(f38);
			var v77: map<D11, int> := map[v76 := v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)]];
			globalState.f9 := safeDivisionInt(v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)], |v77|);
		} else {
			var v78: multiset<int> := multiset{v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)]};
			...
			v82 := v82;
			v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] := |(if (fm47(v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)], f28, v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)], f28, globalState)) then "al" else "laucjpqm")| - (p0 * v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)]);
			v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)] := v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)];
		}
		
		r0 := v69[safeIndex(294, v69.Length)];
		r1 := fm24(!f28, p0, globalState);
		r2 := p0;
		var v83: multiset<int> := multiset{p0, p0};
		r3 := safeModuloInt(p0, if (p0 in v83) then v83[p0] else p0) > v67[safeIndex(734, v67.Length)][safeIndex(739, v67[safeIndex(734, v67.Length)].Length)];
	}
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		var v0 := "ye";
		var v1 := 0xb8;
		...
		match (fm49(v5 + v5, f37, v0, globalState)) {
			case DC18(cf31, cf32, cf33) =>
				...
				var v8: map<int, bool> := map[|(seq(abs(-0x164), i0  => ('u')))| := f28];
			...
			case DC19(cf34) =>
				...
				var v12: array<int> := new int[3](i1 => safeModuloInt(i1, v1));
				v12[safeIndex(651, v12.Length)] := v1;
				...
				v12[safeIndex(651, v12.Length)], globalState.f11, globalState.f1, globalState.f1 := -cf34, fm24(f38, |v17|, globalState), f37, v2 == v2;
				var v18: array<bool> := new bool[11] [!f37, f38, f38, f28, f38, v11.f39 in v15, f28, f38, f38, f28, fm16(v11.f39, f28, v15, globalState)];
				v18[safeIndex(860, v18.Length)] := f37;
				v18[safeIndex(860, v18.Length)] := (if (!f38) then f28 else f28) || f37;
				v18[safeIndex(860, v18.Length)] := if (v18[safeIndex(860, v18.Length)] ==> f37) then v13 >= v13 else f38;
			case DC17(cf30) =>
				...
				match (v21) {
					case DC26(cf41) =>
						...
						var v25: map<int, int> := map[fm0(v1, true, globalState) := safeModuloInt(v24.cf25, -0x28f)];
						v25 := (map v26 : int | v26 in v19 :: (v26 + v1) := (v1)) + v25;
						var v27: array<string> := new string[25](i2 => cf30);
						v27 := v27;
						v2 := v2;
						var v28: array<bool> := new bool[11](i3 => f28);
						v28[safeIndex(893, v28.Length)] := f37;
						v28[safeIndex(893, v28.Length)] := f28;
					case DC25(cf40) =>
						var v29 := 'b';
						...
						v19 := seq(abs(0x77), i5  => (v31.f45 + v31.f45));
				...
				v37 := v37 + v37;
				var v38 := 'x';
				var v39: map<seq<int>, char> := map[seq(abs(-0x57), i6  => (v1)) := v38];
				var v40 := DC48(v39);
				var v42: set<seq<int>> := {[v1], v19, v19[safeIndex(14, |v19|) := v1], v19};
				...
				v43[safeIndex(334, v43.Length)] := v40;
				v43[safeIndex(334, v43.Length)] := v40;
			case DC20(cf35) =>
				...
				var v47 := DC11(multiset{v46[safeIndex(-0x2be, |v46|)]});
				var v48: multiset<bool> := multiset{false};
				v47, r1, r1 := v47, f38, f37 && (v48 !! v48);
				v45[safeIndex(39, v45.Length)] := 210;
				v45[safeIndex(39, v45.Length)] := safeDivisionInt(v1, v1);
				globalState.f1 := f38;
		}
		...
		for i8 := if (v49 in v50) then v50[v49] else v1 to |(v51 + v51[multiset{true} := v1])| {
			...
			match (fm78(f37 <==> f37, -0x13c, |(if (f28 in v53) then v53[f28] else v52)| != 0x174, globalState)) {
				case DC18(cf31, cf32, cf33) =>
					var v54: array<string> := new string[8] ["uokgkbwc", v0, v0, v0 + "lchhgxdq", v0, seq(abs(0x10b), i9  => ('q')), v0, v0];
					v54[safeIndex(121, v54.Length)] := v0;
					var v55: multiset<int> := multiset{v1};
					var v56 := 'y';
					v54[safeIndex(121, v54.Length)] := ((v0[safeIndex(|v55[-v1 := abs(v1)]|, |v0|) := v56])[safeIndex(cf33, |v0[safeIndex(|v55[-v1 := abs(v1)]|, |v0|) := v56]|) := 'j'] + v0[safeIndex(i8, |v0|) := v56]) + (v0 + v0);
					var v57: map<bool, seq<map<int, bool>>> := map[f28 := seq(abs(-0x2e8), i10  => (v52))];
					...
					var v65: array<seq<map<bool, int>>> := new seq<map<bool, int>>[10] [v59, v59, if (cf33 in v61) then v61[cf33] else v59, v64[safeIndex(|fm67(v56, i8, v56, v1, globalState)|, |v64|)], v59, v59, seq(abs(0x33b), i11  => (v4)), v59 + v59, [v4, v4, v4, (map[v2[safeIndex(|v55|, |v2|)] := fm48(cf33, f37, globalState)])[true := cf33]], (seq(abs(0x16d), i12  => (v4))) + (seq(abs(0x62), i13  => (v4)))];
					v65[safeIndex(901, v65.Length)] := v59 + [v4, v4];
					v65[safeIndex(901, v65.Length)] := v59 + fm79(cf32, globalState);
					r1 := cf31 ==> fm47(|v2|, f28, cf33, f37, globalState);
				case DC19(cf34) =>
					var v66: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[20](i14 => [map[f28 := f38]]);
					v66[safeIndex(427, v66.Length)] := seq(abs(0x1c8), i15  => (DC24(map[f28 := f38]).cf39));
					v66[safeIndex(427, v66.Length)] := seq(abs(-0x302), i16  => (map[false := f28] + map[f28 := f28]));
					v2 := v2;
					var v67: seq<string> := [seq(abs(-0x34), i17  => ('g')), seq(abs(0x249), i18  => ('s')), v0];
					var v68: set<string> := {v67[safeIndex(cf34, |v67|)]};
					var v69: array<int> := new int[24](i19 => i19 - v1);
					v69[safeIndex(474, v69.Length)] := |v0|;
					var v70: seq<int> := [-cf34];
					var v71: set<seq<int>> := {(v70 + v70)[safeIndex(cf34, |(v70 + v70)|) := v70[safeIndex(cf34, |v70|)]], v70, seq(abs(-387), i20  => (|[f28]|)), v70 + fm31(f37, 'p', globalState)};
					v69[safeIndex(130, v69.Length)] := |(v0 + v0)|;
					var v72 := 'n';
					var v73: map<char, int> := map[v72 := i8];
					var v74: map<array<int>, int> := map[v69 := v3.cf11];
					v68, v69[safeIndex(474, v69.Length)], v71, v69[safeIndex(130, v69.Length)], r2 := v68 - v68, safeDivisionInt((if ('c' in v73) then v73['c'] else |v0|) - (if (v69 in v74) then v74[v69] else 0x3ba), if (f37) then v1 else cf34), (v71 + v71) * v71, v70[safeIndex(-cf34, |v70|)], i8;
				...
				case DC17(cf30) =>
					...
					v78[safeIndex(841, v78.Length)] := v77;
					v77[safeIndex(105, v77.Length)] := f28;
					var v79: set<string> := {v0, v0, v0, v0};
					var v80: seq<map<bool, bool>> := [v76];
					var v81: seq<int> := [i8];
					r2, v78[safeIndex(841, v78.Length)], v77[safeIndex(105, v77.Length)], v79, v80 := -v81[safeIndex(v1, |v81|)], v77, fm29(fm30(f38, v1, globalState), v0, |fm31(v2[safeIndex(i8, |v2|)], fm32(globalState), globalState)|, v1, globalState), v79, v80;
				...
				case DC20(cf35) =>
					...
					r1 := fm29(("a")[safeIndex(v1, |"a"|) := v83], "k", v1, -|v85|, globalState);
					var v86: multiset<int> := multiset{0x3e3};
					var v87: seq<multiset<int>> := [multiset{v1, i8}, v86];
					var v88: map<int, int> := map[i8 := i8];
					var v89 := new C3(v86 > v87[safeIndex(v1, |v87|)], fm48(if (v1 in v88) then v88[v1] else 282, f38, globalState));
					v0 := v0 + v0;
					var v91: array<map<int, bool>> := new map<int, bool>[2] [v52 + v52, map v90 : int | (-60 <= v90) && (v90 < 0x1d4) :: (v90 * v89.f43) := (!f28)];
					v91 := v91;
			}
			
			var v92: array<seq<bool>> := new seq<bool>[6] [v2[safeIndex(i8, |v2|) := !f28], v2, ([f38, f38])[safeIndex(v1, |[f38, f38]|) := f37] + v2, v2, v2, v2];
			var v93 := 'x';
			v92[safeIndex(761, v92.Length)] := fm63(v93, f37, i8, globalState) + v2;
			v92[safeIndex(761, v92.Length)] := v2 + [f28, f28];
		}
		for i23 := safeDivisionInt(v1, -v1) to v1 {
			var v94: set<bool> := {f37};
			v1 := -|DC25(v94).cf40|;
			var v95: array<int> := new int[6];
			v95[safeIndex(18, v95.Length)] := i23;
			globalState.f6, globalState.f6, v95[safeIndex(18, v95.Length)] := -0x381, (i23 - v1) * v1, v1;
			var v96 := new C3(f28, i23);
			v95[safeIndex(18, v95.Length)] := v95[safeIndex(18, v95.Length)];
		}
		var v97: set<int> := {v1};
		...
		match (match v100.(cf66 := multiset{v97, v97}) {
			...
			case DC36(cf56, cf57, cf58) =>
				var v101 := DC4(fm47(-0x2ab, true, cf56, false, globalState), safeDivisionInt(|v0|, -cf56), !(!f28 || f28));
				v101 := v101;
				var v102 := new C6(0x39);
				var v103: map<int, bool> := map[cf56 := f28];
				if (fm16(|v103|, f38, seq(abs(0x35e), i24  => (|v2|)), globalState) && f38) {
					var v104: multiset<int> := multiset{cf57};
					var v105: map<multiset<int>, bool> := map[v104 + v104 := f37];
					v105 := v105 + v105;
					globalState.f11 := safeDivisionInt(-cf56, v1) * |(v104 - v104)|;
					var v106: array<seq<string>> := new seq<string>[12];
					var v107: seq<string> := [v0];
					v106[safeIndex(797, v106.Length)] := v107;
					v106[safeIndex(797, v106.Length)] := v107;
					var v108: map<int, int> := map[v102.f39 := cf57];
					cf58, globalState.f9, cf56 := v102.f39, safeDivisionInt(--(if (-v102.f39 in v108) then v108[-v102.f39] else cf56), cf56), |v3.cf12|;
					var v109: array<int> := new int[23];
					v109[safeIndex(152, v109.Length)] := v102.f39;
					v109[safeIndex(152, v109.Length)] := |v2|;
				} else {
					...
					var v115 := 'f';
					r1, globalState.f6, r1, r1 := fm47(fm0(v1, !f37, globalState), f38, v102.f39, f37, globalState), fm0(cf56, |v0| !in v114, globalState), v115 in (DC17(v0).(cf30 := seq(abs(0x290), i26  => ('b')))).cf30, f28;
					...
					v117[safeIndex(151, v117.Length)] := fm48(|(v0[safeIndex(v110[safeIndex(v102.f39, |v110|)], |v0|) := v115])[safeIndex(cf58, |v0[safeIndex(v110[safeIndex(v102.f39, |v110|)], |v0|) := v115]|) := v115]|, f28, globalState);
					v117[safeIndex(151, v117.Length)] := v1;
				}
				...
				var v130 := DC26(f37);
				var v131: array<int> := new int[25] [cf58, v119.cf0, safeModuloInt(fm48(|(if (v102.f39 in v123) then v123[v102.f39] else v122)|, f38, globalState), v102.f39), if (v124 in v125) then v125[v124] else |{true}|, if (if (DC2(v1).cf2 in v103) then v103[DC2(v1).cf2] else f28) then v102.f39 else -cf57, -(cf57 * v102.f39), safeModuloInt(v1, cf57), 978, cf58, cf56, cf58, cf57, fm48(-0x87, f38, globalState), cf56, cf56, cf58, v1, 337, cf56, v102.f39, cf57, fm48(|v129|, v130.cf41, globalState), v102.fm0(-cf57, f37, globalState), 0x2c1, cf57];
				v128[safeIndex(538, v128.Length)] := cf56 * v102.f39;
				var v132 := DC45(cf56, |v118|, f28, |v0|);
				v128[safeIndex(538, v128.Length)] := v132.cf72;
			case DC37(cf59, cf60, cf61, cf62) =>
				match (fm41(v0, cf61, cf60, globalState)) {
					case DC18(cf31, cf32, cf33) =>
						...
						v134[safeIndex(142, v134.Length)] := v135;
						v134[safeIndex(142, v134.Length)] := v135;
					...
					case DC19(cf34) =>
						...
						v137[safeIndex(837, v137.Length)] := {|v2|};
						v137[safeIndex(837, v137.Length)] := v97;
						var v138 := 'h';
					...
					case DC17(cf30) =>
						...
						v143[safeIndex(231, v143.Length)] := f37;
						v143[safeIndex(231, v143.Length)] := cf60;
						globalState.f1 := f28;
					case DC20(cf35) =>
						...
						v144[safeIndex(965, v144.Length)] := cf61;
						v144[safeIndex(965, v144.Length)] := v1;
						globalState.f1 := cf60;
						var v148 := DC17(v0);
						var v149: array<string> := new string[3] [v0 + v0, v148.cf30, v0];
						v149[safeIndex(183, v149.Length)] := "bkuvgmhv" + v0;
						v149[safeIndex(183, v149.Length)] := v0 + ("okyif" + (seq(abs(540), i29  => (v146))));
				}
				...
				v155 := v155;
				var v156: seq<int> := [|(seq(abs(0x21e), i30  => (v151)))|];
			...
			case DC38(cf63, cf64) =>
				...
				if (fm47(cf64, f38, cf64, fm47(cf64, f38, v1, f28, globalState), globalState)) {
					...
					v166[safeIndex(804, v166.Length)] := cf64 * fm48(cf64, f28, globalState);
					v166[safeIndex(804, v166.Length)] := 0x1e9;
					globalState.f11 := cf64;
					var v167: map<bool, bool> := map[f37 := f37];
					var v168: array<map<char, int>> := new map<char, int>[8];
					var v169: map<bool, D13> := map[!fm47(cf64, fm29(v0[safeIndex(v1, |v0|) := v162], v0, |v161|, |v167|, globalState), v166[safeIndex(804, v166.Length)], f28, globalState) := DC30(v168)];
					var v170 := DC30(v168);
					...
					v173[safeIndex(755, v173.Length)] := v172;
					var v174: map<bool, array<map<D11, bool>>> := map[fm16(cf64, f28, v165, globalState) := v172];
					v173[safeIndex(755, v173.Length)] := if (f28) then if (f37 in v174) then v174[f37] else v172 else v172;
				} else {
					var v175: map<string, bool> := map[v0 := v97 >= v97];
					v175 := v175["iija" := f38];
					globalState.f1 := f38;
					r1 := if (f37) then !f28 else f38;
					globalState.f26 := cf63 + safeModuloInt(cf63, cf64);
					globalState.f9 := v165[safeIndex(cf64, |v165|)];
				}
				
				cf63 := cf63;
			case DC35(cf55) =>
				var v176: array<bool> := new bool[11](i32 => f38);
				v176[safeIndex(291, v176.Length)] := f37;
				...
				v176[safeIndex(291, v176.Length)] := {map v177 : int | v177 in v178 :: (v177 + v1) := (f37), v179, v179} < (if (f38) then v180 else v180);
				var v181 := 'q';
				var v182 := DC3(v181);
				...
				v183[safeIndex(216, v183.Length)] := v181;
				var v184: array<D2> := new D2[26];
				v184[safeIndex(44, v184.Length)] := v3;
				var v185 := DC31(!f38, !f28, v181);
				var v186: multiset<bool> := multiset{f38, v176[safeIndex(291, v176.Length)], !f37};
				var v187: array<D13> := new D13[10] [v185, v185, v185, v185, DC31(fm29(v0, v0, v1, |v0|, globalState), v176[safeIndex(291, v176.Length)], v181), DC31(f37, !f28, v181), DC31(true, true, 'r'), fm71(v1, v186, f37, globalState), DC31(f28, true, v181), v185];
				v187[safeIndex(932, v187.Length)] := v185.(cf51 := true);
				v183[safeIndex(216, v183.Length)], v0, globalState.f1, v184[safeIndex(44, v184.Length)], v187[safeIndex(932, v187.Length)] := 'g', v0, v176[safeIndex(291, v176.Length)], v3, v185.(cf52 := v181);
				v176[safeIndex(291, v176.Length)] := !(if (v176[safeIndex(291, v176.Length)]) then f28 else f37) ==> f37;
				var v188: set<bool> := {f28};
				v188 := (v188 * v188) + {v176[safeIndex(291, v176.Length)]};
			case DC39(cf65) =>
				globalState.f1 := !!(safeDivisionInt(v1, v1) == safeModuloInt(v1, 0x73));
				match (fm58(globalState)) {
					case DC4(cf4, cf5, cf6) =>
						cf6 := !v2[safeIndex(v1, |v2|)];
					...
					case DC5(cf7, cf8, cf9) =>
						...
						cf7 := !(multiset(v2) < (multiset{cf7, false} - v195[safeIndex(cf9, |v195|)]));
						var v196: array<bool> := new bool[11];
						globalState.f21 := v196;
						var v197: array<int> := new int[26](i33 => i33 + cf9);
						v197[safeIndex(150, v197.Length)] := cf9;
						...
						var v203: array<array<array<C4>>> := new array<array<C4>>[14] [v199, v199, v199, v199, if (f37 in v200) then v200[f37] else v199, v201[safeIndex(|v202[safeIndex(cf9, |v202|) := 0x30c]|, |v201|)], v199, v199, v199, v199, v199, v199, v199, v199];
						v203[safeIndex(642, v203.Length)] := v199;
						var v204: set<bool> := {f28, f37};
						v197[safeIndex(150, v197.Length)], v203[safeIndex(642, v203.Length)], globalState.f3, cf7 := safeModuloInt(cf9, cf9 - |v204|), v199, v197, cf7;
						var v205 := 'q';
						var v206: array<char> := new char[17] [v205, v0[safeIndex(|v204|, |v0|)], 'v', v205, v205, v205, v205, v205, v205, if (f37) then v205 else v205, v205, v205, v205, v205, v205, v205, v205];
						var v207: map<bool, char> := map[f28 := v205];
						v206[safeIndex(529, v206.Length)] := if (false in v207) then v207[false] else v205;
						v206[safeIndex(529, v206.Length)], v197[safeIndex(150, v197.Length)], globalState.f1, globalState.f26, globalState.f6 := v205, -(cf9 + -(if (f37 in v194) then v194[f37] else -v1)), cf7, -cf9, v197[safeIndex(150, v197.Length)] * -0x35f;
					case DC6(cf10, cf11, cf12) =>
						var v208: array<int> := new int[18];
						v208[safeIndex(605, v208.Length)] := 757;
						v208[safeIndex(605, v208.Length)] := 0x299 - 0x2c9;
						var v209: map<bool, bool> := map[f28 := f28];
						var v210: multiset<bool> := multiset{f28};
						var v211: map<map<int, int>, bool> := map[map[-|v209| := |v210|] := f28];
						var v212: map<int, int> := map[|v97| := v208[safeIndex(605, v208.Length)]];
						globalState.f9 := fm0(cf10, if (v212 in v211) then v211[v212] else f37, globalState);
						var v213: seq<string> := [v0];
						globalState.f1 := "datyxad" == (v213[safeIndex(cf11, |v213|)] + v0);
				...
				if (f28) {
					...
					v220[safeIndex(323, v220.Length)] := f28;
					var v221: seq<int> := [v1];
					var v222: set<array<bool>> := {v220};
					globalState.f1, v219, v220[safeIndex(323, v220.Length)], v221, v1 := false, v219, fm16(v218.f45, {v220, v220} >= v222, v221, globalState), v221 + [v1, 0x37, 0x1fe, v218.f45, v218.f45], safeModuloInt(v218.f45, -v218.f45);
				} else {
					...
					v1 := safeModuloInt(safeModuloInt(v1, v1), fm48(|v225|, true, globalState));
					r1 := f38;
					...
					v226[safeIndex(132, v226.Length)] := v227;
					var v228: array<int> := new int[17](i35 => i35 + |v0|);
					var v229 := DC9(v1, true);
					v228[safeIndex(384, v228.Length)] := v229.cf17;
					var v230 := DC34();
					var v231: array<bool> := new bool[21];
					v231[safeIndex(752, v231.Length)] := f38;
					var v232 := DC49(v227);
					v226[safeIndex(132, v226.Length)], v228[safeIndex(384, v228.Length)], v230, v231[safeIndex(752, v231.Length)], globalState.f1 := v232.cf79, fm0(0x75, f37, globalState), v230, if (f38) then v1 > v1 else f38 ==> f37, 0x18e == |v0|;
				}
		...
		if (false) {
			...
			var v234: seq<int> := [v1];
			v233[safeIndex(640, v233.Length)] := fm16(v1, f38, v234, globalState);
			v233[safeIndex(640, v233.Length)] := f38;
			var v235 := 'e';
			r0 := v235;
			match (fm68(f28, v1, f38, globalState)) {
				case DC28(cf43, cf44, cf45, cf46, cf47) =>
					var v236: array<string> := new string[10] [v0 + v0, seq(abs(0x2f6), i36  => (cf43)), v0[safeIndex(fm24(cf44, v1, globalState), |v0|) := cf43], v0, seq(abs(-0x272), i37  => (cf43)), v0, v0, v0 + v0[safeIndex(v1, |v0|) := cf43], "axjyn", v0];
				...
				case DC27(cf42) =>
					...
					var v239: map<set<bool>, int> := map[{f37, v233[safeIndex(640, v233.Length)], v238.f41, v233[safeIndex(640, v233.Length)]} := v1 + v1];
					var v240: set<bool> := {v238.f41};
					var v242: map<int, int> := map[|[v1, v1]| := v1];
					var v243: map<int, int> := map[if (v1 in v242) then v242[v1] else v1 := |map[v233[safeIndex(640, v233.Length)] := v1]|];
				...
				case DC29(cf48) =>
					globalState.f6 := v1;
					var v244 := new C6(v1);
					var v245: set<bool> := {f37, f28, v233[safeIndex(640, v233.Length)], !f37};
					var v246 := DC12({f38} >= v245, map[-555 := v1], true, v1, v244.f39);
					v246 := v246;
					var v247: map<int, int> := map[|multiset{f38, v233[safeIndex(640, v233.Length)], f28, true}| := v244.f39];
			...
			v250[safeIndex(50, v250.Length)] := v1;
			v250[safeIndex(50, v250.Length)] := 0x126;
			v4 := v4 + v4;
			var v251: map<int, int> := map[v1 := v250[safeIndex(50, v250.Length)]];
			globalState.f9 := v250[safeIndex(50, v250.Length)] * |v251|;
		...
		r1 := |v254| >= 0x25b;
		r2 := safeDivisionInt(v1, if (f37) then v1 else v1);
	}
}
...
class C8 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
		...
		if (v0.cf18) {
			...
			v3 := v3[v5[safeIndex(0x28, |v5|)] := p0];
			var v6: array<int> := new int[28](i0 => safeDivisionInt(i0, |f36|));
			var v7: multiset<array<int>> := multiset{v6};
			var v8 := DC11(v7);
			globalState.f1 := v8.cf20 !! (v7 - v7);
			var v9: seq<int> := [p0, safeDivisionInt(p0, -p0), p0];
			...
			v12 := if ((seq(abs(-589), i1  => ('f'))) == f36) then v12 else v12;
			v6[safeIndex(169, v6.Length)] := -p0;
			var v13: map<int, bool> := map[p0 := f28];
			var v14 := 'h';
			var v15: multiset<char> := multiset{v14};
			var v16: set<D3> := {v0};
			var v17: map<multiset<char>, int> := map[v15 := |v16|];
			v6[safeIndex(169, v6.Length)] := fm14(if (|{v14, 'w'}| in v13) then v13[|{v14, 'w'}|] else f28, v17, f28, globalState) - p0;
		} else {
			var v18: map<bool, bool> := map[f28 := f28];
			var v19: seq<int> := [|v18|, 0x0];
			var v20 := new C6(|(v19 + (seq(abs(-964), i2  => (p0))))|);
			...
			v26[safeIndex(601, v26.Length)] := v25;
			r3, v26[safeIndex(601, v26.Length)] := if (f28) then f28 else f28, v25.(cf36 := v24);
			if (p0 == p0) {
		...
		var v37: seq<int> := [p0];
		var v38: set<int> := {610, v37[safeIndex(p0, |v37|)]};
		for i3 := |v36| to |(v38 - v38)| {
			if (|f36| < -|(v38 - v38)|) {
				var v39 := new C0(f28);
				var v40: array<bool> := new bool[17](i4 => false);
				v40[safeIndex(113, v40.Length)] := f28;
				var v41: map<bool, int> := map[f28 := |"k"|];
				var v42 := DC8(v37[safeIndex(i3, |v37|)], p0, true);
				var v43: multiset<array<bool>> := multiset{v40};
				var v44 := DC53(v43);
				var v45: seq<multiset<array<bool>>> := [v43];
				var v46: array<int> := new int[29](i6 => safeModuloInt(i6, |map[v39.f46 := i3]|));
				globalState.f1, v40[safeIndex(113, v40.Length)], globalState.f3, globalState.f21, globalState.f1 := p0 >= -(if (v42.cf16 in v41) then v41[v42.cf16] else |(seq(abs(0x36b), i5  => ('o')))|), !((v44.cf91 * v45[safeIndex(i3, |v45|)]) > v43), v46, v40, f28;
				globalState.f1 := false;
				v46 := f35.cf13;
				...
				v51[safeIndex(196, v51.Length)] := f28;
				var v52 := 'f';
				var v53 := DC42(v52);
				v51[safeIndex(196, v51.Length)], v53, v37 := (fm13(!f28, |"eea"|, f28, globalState)).cf4, v53, v37;
			...
			if (([true] + v54) < v54) {
				...
				var v60: array<bool> := new bool[24] [f28, f28, f28, i3 <= |v56|, f28, f28, false, i3 != i3, v54[safeIndex(-p0, |v54|)], !f28, !f28, f28, f28, f28, false, f28, f28, f28, fm12(0x2a3, globalState), (set v57 : char | v57 in f36 :: (v57)) > (set v58 : char | v58 in multiset(f36) :: (v58)), f28 || f28, f28, f28, v59 == v59];
				v60[safeIndex(563, v60.Length)] := p0 < p0;
				var v61 := 'l';
				var v62 := DC42(v61);
				globalState.f9, globalState.f1, globalState.f1, v60[safeIndex(563, v60.Length)] := i3, v62.cf68 in f36, f28, 0x37f != --0x15a;
				globalState.f1 := !v60[safeIndex(563, v60.Length)];
				r3 := f36 < f36;
				v60[safeIndex(563, v60.Length)] := v60[safeIndex(563, v60.Length)];
				globalState.f15 := if (false) then v61 else v61;
			} else {
				globalState.f6 := i3;
				var v63: C5 := new C5(false, v54 < [f28]);
				var v64: array<int> := new int[19](i8 => i8 + p0);
				v64[safeIndex(63, v64.Length)] := fm48(p0, f28, globalState);
				var v65: array<D8> := new D8[12];
				var v66 := DC18(v63.f40, i3, p0);
				v65[safeIndex(173, v65.Length)] := v66;
				var v67: array<bool> := new bool[13](i9 => !f28);
				v67[safeIndex(619, v67.Length)] := v63.f40;
				r2, v63, v64[safeIndex(63, v64.Length)], v65[safeIndex(173, v65.Length)], v67[safeIndex(619, v67.Length)] := p0, v63, safeModuloInt(p0, 0x287), v66, (if (f28) then p0 else |v54[safeIndex(p0, |v54|) := f28]|) != p0;
				...
				var v74: map<map<bool, int>, multiset<array<bool>>> := map[v72 := v73[safeIndex(0x28d, |v73|)]];
				var v75: seq<array<bool>> := [v67, v67];
				var v76: array<multiset<array<bool>>> := new multiset<array<bool>>[17] [v71, v71, v71, v71, v71, multiset{v67, v67}, v71 + v71, multiset{v67, v67}, multiset{v67}, if (map[v68.f41 := p0] in v74) then v74[map[v68.f41 := p0]] else multiset{v67}, v71, multiset{v67, v67}, v71, v71, v71, v71 * multiset{v75[safeIndex(-p0, |v75|)]}, v71];
				v76[safeIndex(53, v76.Length)] := v71;
				var v77: map<int, array<bool>> := map[p0 := v67];
				v76[safeIndex(53, v76.Length)] := multiset{if (i3 in v77) then v77[i3] else v67};
			}
			
			var v78 := DC18(false, p0, i3);
			var v79 := DC20(v78);
			var v80: array<bool> := new bool[24];
			v80[safeIndex(950, v80.Length)] := f28;
			var v81 := 'w';
			r0, r3, v79, v80[safeIndex(950, v80.Length)] := v81, !!(f28 <== f28), fm80(globalState), f28;
			globalState.f9 := |(fm30(!v80[safeIndex(950, v80.Length)], -fm48(|v37|, v80[safeIndex(950, v80.Length)], globalState), globalState) + f36)|;
		}
		if (f28) {
			v37 := v37;
			...
			v82[safeIndex(236, v82.Length)] := |v84|;
			v82[safeIndex(236, v82.Length)] := p0 - p0;
			globalState.f1 := f28 <== f28;
			var v85 := 'y';
			var v86: map<int, char> := map[-0x234 := v85];
			var v87 := DC5(f28, v83, |v86|);
			if (v87.cf7) {
				globalState.f1 := safeDivisionInt(-p0, p0) < p0;
				v82[safeIndex(236, v82.Length)] := v82[safeIndex(236, v82.Length)];
				var v88: map<bool, int> := map[false := v82[safeIndex(236, v82.Length)]];
				var v89 := DC45(v82[safeIndex(236, v82.Length)], v82[safeIndex(236, v82.Length)], fm16(v82[safeIndex(236, v82.Length)], f28, v37, globalState), if (false in v88) then v88[false] else p0);
				var v90: seq<D15> := [fm72(v89, v82[safeIndex(236, v82.Length)], p0, |[seq(abs(0x2b1), i10  => (v85)), f36, f36]|, globalState)];
				...
				var v99: array<bool> := new bool[24] [false, !f28, f28 in v96, if (f28) then f28 else false, !f28, !true, f28, f28, f28, f36 != "mdundhsm", v85 !in f36, |v97| > p0, f28, f28, f28, f28, f28, f28, f28, !f28, f28, !(|v98[safeIndex(p0, |v98|)]| <= v37[safeIndex(p0, |v37|)]), f28, f28];
				var v100: multiset<bool> := multiset{f28};
				var v101: map<int, D8> := map[-|v100| := DC19(p0)];
				var v102 := DC19(p0);
				v99[safeIndex(21, v99.Length)] := ([v82[safeIndex(236, v82.Length)], |v101|, p0])[safeIndex(p0, |[v82[safeIndex(236, v82.Length)], |v101|, p0]|) := v102.cf34] <= v37;
				var v103 := DC36(v82[safeIndex(236, v82.Length)], |v97|, p0);
				var v104 := DC39(v103);
				v90, globalState.f11, v95, v99[safeIndex(21, v99.Length)] := ((v90 + v90[safeIndex(p0, |v90|) := v104]) + (v90 + v90))[safeIndex(-0x338 * v82[safeIndex(236, v82.Length)], |((v90 + v90[safeIndex(p0, |v90|) := v104]) + (v90 + v90))|) := DC39(v103)], -p0, v95, v97[safeIndex(p0, |v97|)];
				var v105 := new C1(fm47(p0, v99[safeIndex(21, v99.Length)], v82[safeIndex(236, v82.Length)], v99[safeIndex(21, v99.Length)], globalState), p0 * v82[safeIndex(236, v82.Length)]);
				var v106 := DC17("hprmph");
				var v107: array<string> := new string[15] ["l", f36, f36, "dtqd" + "dwhavowpr", "wxfbax" + f36, f36 + f36, f36, f36, f36, seq(abs(-0x2a5), i12  => (v85)), if (f28) then f36 else v106.cf30, f36 + f36, "p", f36, "tc" + fm18(globalState)];
				v107[safeIndex(927, v107.Length)] := f36;
				v107[safeIndex(927, v107.Length)] := fm18(globalState);
			} else {
				v82[safeIndex(236, v82.Length)] := safeModuloInt(|(seq(abs(0xaa), i13  => (p0)))| * |v83|, v82[safeIndex(236, v82.Length)]);
				var v108: seq<array<int>> := [v82, v82];
				v108 := v108[safeIndex(p0, |v108|) := v82];
				var v109: array<array<int>> := new array<int>[1] [v82];
				v109[safeIndex(787, v109.Length)] := v82;
				var v110: map<int, int> := map[p0 := -0xad];
				var v111: map<int, array<int>> := map[if (v82[safeIndex(236, v82.Length)] in v110) then v110[v82[safeIndex(236, v82.Length)]] else p0 := v82];
				globalState.f3, globalState.f3, globalState.f1, v109[safeIndex(787, v109.Length)] := v82, if (|f36| in v111) then v111[|f36|] else if (f28) then v82 else v82, fm16(209, !fm29(f36, f36, |v110|, |(seq(abs(0x3c3), i14  => (v85)))|, globalState), v37, globalState), v82;
				r1 := v82[safeIndex(236, v82.Length)];
				var v112: seq<map<int, int>> := [v110[fm24(if (v82[safeIndex(236, v82.Length)] in v36) then v36[v82[safeIndex(236, v82.Length)]] else f28, v82[safeIndex(236, v82.Length)], globalState) := p0]];
				v112 := v112 + v112;
			}
			
			var v113: array<bool> := new bool[16](i15 => f28);
			v113[safeIndex(682, v113.Length)] := v82[safeIndex(236, v82.Length)] >= v82[safeIndex(236, v82.Length)];
			v113[safeIndex(682, v113.Length)] := f28;
		} else {
			globalState.f1 := f28;
			...
			if (if (!(f28 && !f28)) then f28 else !(if (|map[v114 := p0]| in v36) then v36[|map[v114 := p0]|] else f28)) {
				...
				v122[safeIndex(594, v122.Length)] := f28;
				v122[safeIndex(594, v122.Length)] := f28;
				globalState.f21 := v122;
				globalState.f9 := -p0 - safeModuloInt(p0, p0);
				globalState.f1 := f28;
				globalState.f1 := f28;
			} else {
				var v123: array<string> := new string[17];
				var v124: seq<array<string>> := [v123, v123];
				v123 := v124[safeIndex(p0, |v124|)];
				...
				v127 := v127[v126 := v37[safeIndex(0x194, |v37|)]];
				var v128 := DC14(p0);
				...
				var v131: array<array<bool>> := new array<bool>[16] [v129, v129, v129, v129, v130[safeIndex(p0, |v130|)], v129, v129, v129, v129, v129, v129, v129, v129, v129, v129, v129];
			...
			v36 := v36[safeDivisionInt(|{v133.cf43}|, |v134|) := {p0} > v38];
			v37 := (((seq(abs(-472), i17  => (|map[f28 := |map[!f28 := p0]|]|))) + v37[safeIndex(p0, |v37|) := p0]) + (v37 + (seq(abs(-0x77), i18  => (p0)))))[safeIndex(p0, |(((seq(abs(-472), i17  => (|map[f28 := |map[!f28 := p0]|]|))) + v37[safeIndex(p0, |v37|) := p0]) + (v37 + (seq(abs(-0x77), i18  => (p0)))))|) := p0];
			var v135: array<bool> := new bool[5];
			v135[safeIndex(397, v135.Length)] := f28;
			var v136: multiset<bool> := multiset{f28, f28};
			v135[safeIndex(397, v135.Length)] := !fm16(|v134|, v136 >= v136, v37, globalState);
		}
		
		for i19 := p0 to 783 {
			globalState.f26 := safeDivisionInt(p0, i19) * p0;
			...
			globalState.f1 := f28;
			v137[safeIndex(250, v137.Length)] := i19;
			v137[safeIndex(250, v137.Length)] := p0 * p0;
		}
		var i20 := 0;
		while (f28)
			decreases 100 - i20
		{
			...
			v145[safeIndex(436, v145.Length)] := v146;
			globalState.f9, v145[safeIndex(436, v145.Length)] := p0, v146;
		...
		var v153 := 'a';
		r2 := |(((v150[safeIndex(p0, |v150|)])[safeIndex(p0, |v150[safeIndex(p0, |v150|)]|) := fm15(globalState)] + f36[safeIndex(-v152.cf5, |f36|) := v153]) + f36)|;
		r0 := v153;
		...
		r3 := fm47(p0, v156 >= v156, |(seq(abs(0x2c9), i21  => (v153)))|, fm12(p0, globalState), globalState);
	}
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		...
		match (v7) {
			...
			case DC5(cf7, cf8, cf9) =>
				...
				v10[safeIndex(162, v10.Length)] := f28 ==> cf7;
				v10[safeIndex(162, v10.Length)] := cf7;
				if (v10[safeIndex(162, v10.Length)]) {
					v10[safeIndex(162, v10.Length)] := if (f28) then [true, cf7] <= v7.cf12[safeIndex(|f36|, |v7.cf12|) := v10[safeIndex(162, v10.Length)]] else v10[safeIndex(162, v10.Length)];
					var v11: map<bool, int> := map[cf7 := v1];
					v11 := fm34(v10[safeIndex(162, v10.Length)], cf9, v1, globalState);
					var v12 := 'w';
					var v13: map<int, char> := map[safeModuloInt(v1, cf9) := v12];
					...
					globalState.f11, globalState.f9, v10[safeIndex(162, v10.Length)], v13, v6 := safeModuloInt(v1, v1), -(|(v16 + v16)| - (v1 * cf9)), (v18.(cf61 := cf9)).cf60 <==> cf7, v13, [!v19.cf16, v10[safeIndex(162, v10.Length)]] + v6;
					...
					var v27 := DC51(v10[safeIndex(162, v10.Length)], v23, v26, cf9, v10[safeIndex(162, v10.Length)]);
					var v28 := DC52(v27);
					...
					var v35: array<int> := new int[27] [v30.fm0(v1, f28, globalState), |("cx" + "dby")|, v1, v1, cf9 + v1, v30.f45, |v6|, safeDivisionInt(cf9, cf9), safeModuloInt(v1, 169), |v31[v29 := v1]|, |v32|, v30.f45, v1, cf9, safeDivisionInt(v30.f45, v30.f45), -v1, 0x1c6, |f36|, if (v33 in v34) then v34[v33] else cf9, fm24(cf7, v30.f45, globalState), v30.f45, v30.f45, v1, |f36|, safeDivisionInt(|v3|, cf9), v30.f45, v30.f45];
					v35[safeIndex(154, v35.Length)] := v30.f45;
					var v36: map<int, bool> := map[v1 := v30.f44];
					var v37: seq<map<int, bool>> := [v36 + v36, v36];
					var v38 := "gatbqs";
					v35[safeIndex(154, v35.Length)], v37, globalState.f1, globalState.f9, v38 := |(v3 * cf8)[v30.f45 := abs(cf9)]|, v37 + [v36], v10[safeIndex(162, v10.Length)], -0xb8, v38;
				}
				
				var v39 := 'n';
				globalState.f1 := v6 <= fm63(v39, cf7, |f36|, globalState);
				var v40: multiset<bool> := multiset{v10[safeIndex(162, v10.Length)], f28};
				var v41: map<bool, bool> := map[false := v10[safeIndex(162, v10.Length)]];
				var v42: seq<int> := [cf9];
				var v43 := DC36(if ((if (v10[safeIndex(162, v10.Length)] in v41) then v41[v10[safeIndex(162, v10.Length)]] else DC5(true, multiset(v42), v1).cf7) in v40) then v40[if (v10[safeIndex(162, v10.Length)] in v41) then v41[v10[safeIndex(162, v10.Length)]] else DC5(true, multiset(v42), v1).cf7] else |v42|, cf9, v1);
				match (v43) {
					case DC36(cf56, cf57, cf58) =>
						var v44: map<int, bool> := map[645 := !v10[safeIndex(162, v10.Length)]];
						...
						v47 := v47;
					case DC37(cf59, cf60, cf61, cf62) =>
						var v48: map<string, bool> := map[f36 := v10[safeIndex(162, v10.Length)]];
						v48 := v48[f36 := f28];
						var v49: map<char, bool> := map[v39 := false];
						v49 := v49;
						globalState.f1 := v10[safeIndex(162, v10.Length)];
						var v51: map<int, int> := map[cf59 := cf9];
						var v52: array<map<int, int>> := new map<int, int>[2] [fm28(cf9, cf61, "ouskruike", globalState), (map v50 : int | v50 in v3 :: (v50 - |(seq(abs(0x1d1), i0  => (cf61)))|) := (cf59)) + v51];
						v52[safeIndex(688, v52.Length)] := v51 + v51;
						v52[safeIndex(688, v52.Length)] := v51;
					case DC38(cf63, cf64) =>
						r0 := if (v40 >= v40) then f36[safeIndex(-0x146, |f36|)] else v39;
						var v53 := new C7(v10[safeIndex(162, v10.Length)], cf7, cf7);
						globalState.f1 := v10[safeIndex(162, v10.Length)];
						globalState.f1 := false in v41;
					case DC35(cf55) =>
						v10[safeIndex(162, v10.Length)] := cf7;
						var v54: set<bool> := {v10[safeIndex(162, v10.Length)], f28};
						v10[safeIndex(162, v10.Length)], v10, v54 := true, v10, v54;
						var v55: array<seq<map<bool, int>>> := new seq<map<bool, int>>[20](i1 => DC59([map[v10[safeIndex(162, v10.Length)] := cf9], map[cf7 := |map[f28 := cf9]|]]).cf101 + [map[cf7 := cf9], map[cf7 := v1], map[v10[safeIndex(162, v10.Length)] := v1], map[f28 := v1]]);
						var v56: map<bool, int> := map[false := cf9];
						var v57: seq<map<bool, int>> := [v56];
						var v58: map<int, seq<map<bool, int>>> := map[0x68 := v57];
						v55[safeIndex(334, v55.Length)] := (if (cf9 in v58) then v58[cf9] else v57) + [v56, v56, map[!cf7 := v1]];
						var v59: map<bool, seq<map<bool, int>>> := map[cf7 := fm79(cf9, globalState)];
						var v60: seq<seq<map<bool, int>>> := [if (f28) then v57[safeIndex(v1, |v57|) := v56] else v57, v57 + v57, v57, v57 + v57, (if (f28 in v59) then v59[f28] else v57)[safeIndex(cf9, |(if (f28 in v59) then v59[f28] else v57)|) := v57[safeIndex(-cf9, |v57|)]] + v57];
						v55[safeIndex(334, v55.Length)] := (v60[safeIndex(-cf9, |v60|)])[safeIndex(if (v1 in v3) then v3[v1] else v1, |v60[safeIndex(-cf9, |v60|)]|) := fm34(v6[safeIndex(v1, |v6|)], cf9, v1, globalState)];
						var v61: array<int> := new int[10](i2 => safeDivisionInt(i2, v1));
						var v62: map<bool, seq<char>> := map[v10[safeIndex(162, v10.Length)] := fm30(f28, if (cf9 in cf8) then cf8[cf9] else |v42|, globalState)];
						v61[safeIndex(49, v61.Length)] := |(if (!cf7 in v62) then v62[!cf7] else f36)|;
						v61[safeIndex(49, v61.Length)] := cf9;
					case DC39(cf65) =>
						var v63: multiset<char> := multiset{v39, v39};
						v10[safeIndex(162, v10.Length)] := v63 !! v63[v39 := abs(fm14(cf7, map[multiset(f36) := |v6|], cf7, globalState))];
						var v64: set<bool> := {cf7, cf7};
						var v65: map<int, bool> := map[|(v64 - v64)| := !(v40 >= v40)];
						v65 := v65[v1 := v10[safeIndex(162, v10.Length)]];
						var v66: array<int> := new int[18];
						var v67: seq<array<int>> := [v66];
						globalState.f3 := if (cf7) then v67[safeIndex(v1, |v67|)] else if (false) then v66 else v66;
			...
			case DC6(cf10, cf11, cf12) =>
				...
				if (fm18(globalState) != f36) {
					...
					globalState.f1 := !f28;
					cf10 := safeModuloInt(cf11, v1);
					var v71: set<bool> := {false, f28};
					var v72: seq<int> := [v1, -safeDivisionInt(cf11, |v71|), cf11];
					r2 := v72[safeIndex(v1, |v72|)];
					var v73 := "wbxq";
					...
					v80[safeIndex(153, v80.Length)] := if (f28 in v81) then v81[f28] else f28;
					var v82: T0 := new C6(v1);
					var v83: map<T0, bool> := map[v82 := f28];
					var v84 := 'i';
					v80[safeIndex(153, v80.Length)], globalState.f15 := v83 == v83, v84;
					v6 := cf12 + cf12;
					var v85: map<int, int> := map[v1 := v1];
					var v86: map<int, int> := map[v79[safeIndex(-467, |v79|)] := |v85|];
					var v87: seq<map<int, int>> := [v86];
					v87 := v87;
					v74 := v74[v80[safeIndex(153, v80.Length)] := -cf11];
				}
				
				var v88: map<int, bool> := map[safeDivisionInt(cf10, |f36|) := f28];
			...
			case DC3(cf3) =>
				...
				var v94: array<int> := new int[13] [v1, safeDivisionInt(|{f28}|, |v90|), -v1, v1 + ---v91[safeIndex(|v92|, |v91|)], v1, v1, |(v93 + v93)|, v1, v1, v1, v1, safeModuloInt(v1, -0x4c), v1];
				globalState.f3, globalState.f11 := v94, (v1 * -v1) - v1;
				globalState.f1 := (|f36| + v1) < v1;
				if (v91 != (seq(abs(161), i3  => (DC38(v1, -v1).cf64)))) {
					globalState.f6 := v1;
					var v95: map<int, array<int>> := map[0x35a := v94];
					globalState.f1, globalState.f9, globalState.f6, globalState.f26, globalState.f1 := f28, v1 - -|v95|, v1, safeDivisionInt(v1, 840), f28;
					v94[safeIndex(349, v94.Length)] := v1;
					...
					var v100: array<bool> := new bool[18] [multiset{v96, v96} !! v97, v6[safeIndex(0x2f8, |v6|)], f28, f28, if (v1 in v98) then v98[v1] else f28, f28, f28, |f36| <= v1, f28, f28, f28, -|v6| > |"cm"|, f28, f28, !f28, f28, map[v3 := f36] == v99, f28];
					globalState.f26, globalState.f21, v94[safeIndex(349, v94.Length)] := v1, v96, safeModuloInt(v1, if (f28) then |v91| else |v98|);
					...
					v102[safeIndex(576, v102.Length)] := cf3;
					var v103: map<int, int> := map[v1 := -|v92|];
					var v104: map<char, int> := map['f' := |v103|];
					r2, v101, globalState.f6, globalState.f15, v102[safeIndex(576, v102.Length)] := if (fm32(globalState) in v104) then v104[fm32(globalState)] else v1, (map[f28 := v1])[true := safeDivisionInt(-|f36|, -v1)], v1, cf3, 'e';
				...
				var v107 := DC46(v1, v1);
				var v108: array<bool> := new bool[29] [f28, v106.cf60, !f28, v93 > v93, v3 > v3, f28, f28, if (f28) then f28 else false, f28, f28, f28, f28, false, f28, f28, true, v93 <= v93, f28 || false, f28 && f28, v6[safeIndex(|[v107, v107, DC46(v1, v1), v107]|, |v6|)], f28, fm12(|{|v3|, 0x3ad}|, globalState), f28 || f28, f28, v1 <= |f36|, 'd' in f36, v93 >= fm21(true, globalState), f36 != f36, f28];
				v108[safeIndex(177, v108.Length)] := f28;
				v108[safeIndex(177, v108.Length)] := f28;
		}
		...
		r2 := safeDivisionInt(v1 + (if ([v113, v113, v113] in v114) then v114[[v113, v113, v113]] else 0xa7), v1);
	}
}
...
class C9 {
	...
	method m12(p0: map<int, D3>, p1: set<bool>, p2: bool, globalState: GlobalState) {
		if (p2) {
			if (p2) {
				...
				var v2 := 0x297;
				globalState.f9 := v2;
				var v3: array<int> := new int[7](i0 => safeDivisionInt(i0, v2));
				var v4: map<bool, bool> := map[p2 := true];
				v3[safeIndex(215, v3.Length)] := v2 * -|v4|;
				v0, v3[safeIndex(215, v3.Length)] := ("wrkvm" + v0)[safeIndex(v2, |("wrkvm" + v0)|) := v0[safeIndex(v2, |v0|)]] + v0, v2;
				globalState.f1 := p2;
				var v5: array<map<set<bool>, int>> := new map<set<bool>, int>[15](i1 => map[p1 := v2] + map[p1 := v3[safeIndex(215, v3.Length)]]);
				var v6: map<set<bool>, int> := map[p1 := v3[safeIndex(215, v3.Length)]];
				v5[safeIndex(446, v5.Length)] := v6;
				var v7: array<array<int>> := new array<int>[16];
				v7[safeIndex(638, v7.Length)] := v3;
				v3[safeIndex(215, v3.Length)], v5[safeIndex(446, v5.Length)], v7[safeIndex(638, v7.Length)], globalState.f11 := v2, v6, if (p2) then v3 else if (f34) then v3 else v3, v2;
			} else {
				...
				var v18 := DC7(v15);
				v17 := v17[f34 := (v16[safeIndex(v9, |v16|) := v18.cf13])[safeIndex(v9, |v16[safeIndex(v9, |v16|) := v18.cf13]|) := v15] + v16];
			...
			if (f34) {
				...
				v25[safeIndex(923, v25.Length)] := v20;
				var v26: seq<array<int>> := [v25];
				v25[safeIndex(923, v25.Length)] := |v26|;
				f34, v20 := p2, v25[safeIndex(923, v25.Length)];
			} else {
				var v27 := 'w';
				var v28 := -0x114;
			...
			v36[safeIndex(267, v36.Length)] := v37;
			v36[safeIndex(267, v36.Length)] := v37;
			if (v37.f41) {
				var v38: multiset<string> := multiset{seq(abs(0x350), i2  => ('r'))};
				...
				v55[safeIndex(141, v55.Length)] := |(if (v62) then p1 else p1)|;
				var v68: multiset<bool> := multiset{f34, v67};
				var v69: seq<set<bool>> := [p1];
				var v70: map<bool, int> := map[v37.f41 := safeDivisionInt(if (v67 in v68) then v68[v67] else |v69|, v65)];
				v55[safeIndex(141, v55.Length)] := if (v62 in v70) then v70[v62] else v66;
			}
			...
			v75 := v75[v37.f41 && p2 := v74[safeIndex(-v71, |v74|) := |(if (v37.f41 in v75) then v75[v37.f41] else v74)|]];
			if (!(|p1| != v71)) {
				globalState.f1 := !!!!(f34 <==> f34);
				globalState.f26 := -v71;
				var v76: array<bool> := new bool[24](i3 => v37.f41);
				var v77: map<int, bool> := map[v71 := f34];
				v76[safeIndex(638, v76.Length)] := -|v77| >= v71;
				var v78: seq<seq<int>> := [v74];
				v76[safeIndex(638, v76.Length)] := |v78[safeIndex(0x31f, |v78|)]| < 242;
				f34 := p2;
				var v79: multiset<bool> := multiset{v37.f41};
				v79 := (multiset{v37.f41})[f34 !in multiset{v37.f41, v37.f41} := abs(-(v71 - v71))];
			} else {
				var v80: map<bool, seq<bool>> := map[v37.f41 := v73];
				v80 := v80[f34 := v73 + v73];
				var v81: array<bool> := new bool[1](i4 => multiset{p2, v37.f41} == multiset{!!p2});
				v81[safeIndex(435, v81.Length)] := v73[safeIndex(v71, |v73|)];
				v81[safeIndex(435, v81.Length)] := v37.f41;
				v71 := v71;
				globalState.f11 := v71;
				var v82: array<int> := new int[15](i5 => safeDivisionInt(i5, |v72|));
				v82[safeIndex(256, v82.Length)] := v71 - 803;
				v82[safeIndex(256, v82.Length)] := safeDivisionInt(v71, v71);
			}
		...
		for i6 := v83 to v83 {
			if (!f34 || p2) {
				var v84 := "vutvtk";
				var v85: map<string, bool> := map[(seq(abs(0x366), i7  => ('t'))) + v84 := f34];
				v85 := v85[seq(abs(0xe1), i8  => ('r')) := p2];
				globalState.f6 := i6;
				f34, f34, v84, globalState.f1 := p2, p2, v84, p2;
				var v86: array<bool> := new bool[9];
				v86[safeIndex(353, v86.Length)] := if (f34) then f34 else f34;
				var v87: seq<bool> := [false, f34];
				var v88: multiset<bool> := multiset{f34};
				v86[safeIndex(353, v86.Length)] := v87[safeIndex(-|v88|, |v87|)];
				var v89: seq<int> := [v83];
				var v90 := DC8(|multiset{v86[safeIndex(353, v86.Length)]}|, v83, p2);
				var v91: map<array<bool>, int> := map[v86 := v90.cf15];
				var v92: map<bool, int> := map[p2 := v83];
				var v93: array<int> := new int[24] [0x2f5, fm9(globalState) * v83, v83, v83, i6, v83, i6, 0x288, fm9(globalState), |v89|, safeDivisionInt(-i6, |v84|), |(v84 + v84)|, safeDivisionInt(-(if (v86 in v91) then v91[v86] else i6), v83), |v92|, i6 * i6, v83, v83, i6, i6, |{f34, v86[safeIndex(353, v86.Length)], f34, false}|, v83, v83, v83, |fm70(p2, [f34], globalState)| + v83];
				v93[safeIndex(252, v93.Length)] := i6;
				v93[safeIndex(252, v93.Length)] := v83;
			} else {
				...
				v97[safeIndex(9, v97.Length)] := v95;
				var v98 := "gt";
				var v99: map<int, string> := map[i6 := v98];
				var v100 := 'y';
				var v101: array<string> := new string[29] [if (i6 in v99) then v99[i6] else v98, v98[safeIndex(v83, |v98|) := v100], seq(abs(-0x2f6), i9  => (v100)), "bynhig", "roo", v98, seq(abs(-0x164), i10  => (v100)), v98, "w", v98, v98, v98, v98, v98, fm30(v95.f38, --|map[i6 := v95.f38]|, globalState), v98, v98, v98, v98, v98, v98, v98, v98, v98, v98, v98, seq(abs(0x1a1), i11  => (v100)), "wwlcb", "pu"];
				var v102: map<array<string>, C7> := map[v101 := v95];
				v97[safeIndex(9, v97.Length)] := if (v101 in v102) then v102[v101] else v95;
				var v103 := DC22();
				v103 := v103;
				var v104: map<bool, int> := map[f34 := safeDivisionInt(--i6, v83)];
				v104 := v104;
			}
			...
			v107[safeIndex(863, v107.Length)] := v83;
			var v108: array<bool> := new bool[15](i13 => p2);
			var v109: seq<bool> := [f34];
			v106, globalState.f21, v107[safeIndex(863, v107.Length)] := v106, v108, i6 + (if (f34) then |v109| else v83);
			v108[safeIndex(572, v108.Length)] := false;
			v108[safeIndex(572, v108.Length)] := !false;
			if (f34) {
				var v110 := DC60();
				v110 := if (f34) then v110 else v110;
				var v111: seq<int> := [i6];
				globalState.f11 := safeModuloInt(|v111|, 0x397) - i6;
				var v112: map<bool, int> := map[f34 := v83];
				var v113 := "janea";
				var v114: map<int, string> := map[safeModuloInt(v107[safeIndex(863, v107.Length)], |v112|) := v113];
				v114 := v114[v107[safeIndex(863, v107.Length)] := DC17(seq(abs(612), i14  => ('b'))).cf30];
				var v115: map<int, int> := map[v83 + i6 := safeModuloInt(i6, |map[f34 := p2]|)];
				var v116: seq<string> := [seq(abs(-0x29c), i15  => ('t'))];
				v115 := v115[|v116| := v83];
				var v117: multiset<int> := multiset{0x120};
				var v118: multiset<int> := multiset{|v117|};
				var v119 := DC5(fm29(v113, seq(abs(0x14e), i16  => ('m')), i6, v83, globalState), v117, |v113|);
				var v120: multiset<int> := multiset{if (p2) then i6 else i6, v83, v83, if (v119.cf7) then i6 else v83};
				v120 := multiset(seq(abs(651), i17  => (|v116[safeIndex(|(map v121 : int | (578 <= v121) && (v121 < 0x3be) :: (v121 * v107[safeIndex(863, v107.Length)]) := (v108[safeIndex(572, v108.Length)]))|, |v116|)]|)));
			} else {
				...
				var v125 := "csxac";
				var v126 := DC17(v125);
				v124[safeIndex(469, v124.Length)] := v126.cf30;
				globalState.f9, v124[safeIndex(469, v124.Length)], globalState.f26 := v107[safeIndex(863, v107.Length)], v125 + v125, v123.f39;
			}
		...
		for i18 := v83 to v83 {
			...
			v136, globalState.f15, v141, globalState.f11 := (v136 + v136) + v136, v127[safeIndex(fm24(p2, v83, globalState), |v127|)], (v141 + v141) + map[i18 := v140], v83;
			globalState.f1 := p2;
			v127 := "ihsur";
		}
		var v142 := DC22();
		match (v142) {
			case DC22() =>
				...
				v144[safeIndex(544, v144.Length)] := v83;
				var v145: array<bool> := new bool[14];
				v144[safeIndex(544, v144.Length)], globalState.f21 := v83, v145;
				...
				var v148 := 'r';
				globalState.f1, globalState.f1 := (v147 - multiset(fm63(v148, f34, v144[safeIndex(544, v144.Length)], globalState))) > v147, f34;
			case DC23(cf37, cf38) =>
				var v149 := 'r';
				var v150: map<bool, char> := map[true := v149];
				var v151: seq<string> := [v127, v127[safeIndex(v83, |v127|) := v149] + v127, v127, v127 + v127];
				var v152: seq<seq<string>> := [v151];
				var v153: seq<bool> := [cf38];
				cf37, globalState.f1, v150, v151, f34 := cf37, "iitmn" != v127, v150 + (v150 + v150), v152[safeIndex(0x21e, |v152|)], v153[safeIndex(v83, |v153|)];
				globalState.f9 := v83;
				var v154: array<int> := new int[11];
				v154[safeIndex(148, v154.Length)] := v83;
				var v155: set<int> := {v83, v83};
				v154[safeIndex(148, v154.Length)] := |v155|;
				var v156: multiset<bool> := multiset{p2, f34, f34};
				if (fm47(v154[safeIndex(148, v154.Length)] + v83, !(p2 in v156), v154[safeIndex(148, v154.Length)], cf38, globalState)) {
					globalState.f9, globalState.f1 := v154[safeIndex(148, v154.Length)], v149 !in v127;
					cf38 := v156 < v156;
					globalState.f1 := f34;
					cf37[safeIndex(526, cf37.Length)] := p2;
					cf37[safeIndex(526, cf37.Length)] := !f34;
					var v157: map<int, bool> := map[safeModuloInt(|"vicevagft"|, v154[safeIndex(148, v154.Length)]) := cf37[safeIndex(526, cf37.Length)]];
					v157 := v157[v83 * v83 := f34];
				} else {
					cf38 := cf38;
					globalState.f1, v154[safeIndex(148, v154.Length)], globalState.f26 := f34, safeModuloInt(safeModuloInt(179, v83), 0xc9 - v83), v83;
					cf38 := if (f34) then f34 else cf38;
					globalState.f9 := v83;
					var v159: map<multiset<bool>, bool> := map[v156 := cf38];
					var v161: map<int, int> := map[v154[safeIndex(148, v154.Length)] := v83];
					var v162: map<multiset<bool>, char> := map[(multiset([p2]))[false := abs(|v161|)] := v149];
					...
					var v165 := DC16((map v158 : multiset<bool> | v158 in v159 :: (v158) := (p1)) + v164[safeIndex(463, |v164|)]);
					cf38, v165, globalState.f26, globalState.f26 := p2, v165, v154[safeIndex(148, v154.Length)], if (f34 ==> f34) then -(if (|{cf38}| in v161) then v161[|{cf38}|] else -0xf2) else v83;
				}
			...
			case DC21(cf36) =>
				...
				if (p2) {
					...
					v167[safeIndex(825, v167.Length)] := v83;
					...
					globalState.f1, v167[safeIndex(825, v167.Length)], v168, v83, v169 := p2, v171.cf88, map[-0x27b := f34] + map[v83 := fm47(v83, f34, |v173[safeIndex(if (p2 in v174) then v174[p2] else v83, |v173|)]|, p2, globalState)], 0x109, v169;
					globalState.f1 := p2;
					...
					v177[safeIndex(322, v177.Length)] := fm71(0x8d, v174, p2, globalState);
					var v178 := DC0(v83);
					var v179: seq<D0> := [v178, v178, v178];
					var v180 := DC57(v179);
					var v181: set<D23> := {v180, v180, v180, v180, v180};
					var v182: seq<set<D23>> := [v181];
					v177[safeIndex(322, v177.Length)], globalState.f1, globalState.f15, v182 := DC31(true, f34 <==> !f34, v166), false <== f34, v166, seq(abs(-0xd3), i20  => (v181 + v181));
					var v183 := DC3(v166);
					var v184: seq<set<char>> := [{v166, v166}];
					var v185 := new C2(v183.cf3, v184 != (seq(abs(0x10b), i21  => ({'d', v166}))));
				} else {
					globalState.f1 := p2;
					var v186: array<bool> := new bool[2](i22 => p2);
					v186[safeIndex(180, v186.Length)] := f34;
					var v187: array<int> := new int[12](i23 => i23 + v83);
					var v188: map<int, int> := map[-v83 := v83];
					globalState.f3, v186[safeIndex(180, v186.Length)], globalState.f1, globalState.f26 := v187, !!p2, DC31(false, false, v166).cf51, if (v83 in v188) then v188[v83] else v83;
					m13(globalState);
				...
				globalState.f11 := v190[safeIndex(v83, |v190|)];
				m13(globalState);
		}
		
		var v191: map<int, int> := map[v83 := v83];
		var v192: array<int> := new int[19] [v83, v83, v83, v83, 0x3d4, v83, v83, v83, 0x131, v83, 215, |v191|, |(seq(abs(0x1c9), i24  => (-v83)))|, v83, v83, v83, v83, v83, v83];
		var v193: map<int, array<int>> := map[v83 := v192];
		var v194: seq<map<int, array<int>>> := [v193, v193, map[v83 := v192]];
		v193 := map[v83 := v192] + v194[safeIndex(v83, |v194|)];
	}
	method m13(globalState: GlobalState) {
		...
		v1[safeIndex(482, v1.Length)] := 0x12f;
		v1[safeIndex(482, v1.Length)] := safeModuloInt(v0, v0);
		var v11: array<seq<bool>> := new seq<bool>[2](i1 => [f34, DC45(v0, 0x18, f34, v0).cf73] + [f34]);
		var v12: seq<bool> := [false];
		v11[safeIndex(169, v11.Length)] := v12 + v12;
		v11[safeIndex(169, v11.Length)] := v12 + v12;
		v1[safeIndex(482, v1.Length)] := v1[safeIndex(482, v1.Length)];
		for i2 := fm48(v1[safeIndex(482, v1.Length)], f34, globalState) to if (f34) then v1[safeIndex(482, v1.Length)] else v0 {
			var v13 := new C6(i2 - v0);
			var v14 := "r";
			var v15 := 't';
			globalState.f1 := if (f34) then fm29(v14[safeIndex(fm24(f34, v1[safeIndex(482, v1.Length)], globalState), |v14|) := v15], v14, i2, v1[safeIndex(482, v1.Length)], globalState) else f34;
			globalState.f11 := v0;
			...
			globalState.f1 := fm45(globalState) < v20[safeIndex(0x26b, |v20|)];
		}
		var v21 := DC7(v1);
		var v22 := "g";
		...
		v25[safeIndex(867, v25.Length)] := v24 * v24;
		var v26: map<bool, bool> := map[f34 := f34];
		v25[safeIndex(867, v25.Length)] := (if (if (v23.f28 in v26) then v26[v23.f28] else f34) then v24 else v24) + v24;
	}
}
...
class C10 extends T0 {
	...
	function fm0(p0: int, p1: bool, globalState: GlobalState): int {
		safeModuloInt(|((seq(abs(-0x1ea), i0  => ('a'))) + "ariyiofo")|, safeModuloInt(|"pwx"|, 0xda))
	}
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		...
		var i3 := 0;
		while (if (safeDivisionInt(v13.cf5, p0) in v2) then v2[safeDivisionInt(v13.cf5, p0)] else v1)
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
	...
	method m10(p0: int, globalState: GlobalState) {
		...
		v4[safeIndex(363, v4.Length)] := v5;
		var v6: multiset<bool> := multiset{!v3.f34};
		var v7 := DC27(v6);
		v0, v4[safeIndex(363, v4.Length)], v6 := match v7 {
		...
		if (v3.f34) {
			...
			var v13: array<multiset<int>> := new multiset<int>[19] [v2 * v2, v2, v2 * v2, multiset{p0}, multiset{p0}, v2 * v2, multiset{p0}, fm22(p0, [p0], v3.f34, |(multiset(v8))[v3.f34 := abs(p0)]|, globalState), multiset([p0]), if (v3.f34) then v2 else v2, multiset{p0, p0, p0}, v2 + v2, v2, v2, v9.cf8, v2, v2, multiset{|v8[safeIndex(fm14(false, v12, v0, globalState), |v8|) := v0]|}, multiset{v3.fm9(globalState)}];
			var v14: seq<int> := [p0];
			v13[safeIndex(884, v13.Length)] := multiset(v14) + v2;
			var v15 := "trieobt";
			var v16: array<int> := new int[12];
			v13[safeIndex(884, v13.Length)], globalState.f3, globalState.f11, globalState.f26 := multiset{|v2|, if (true) then p0 else p0, |v15|}, v16, -0xfa, -p0;
			...
			var v26 := new C8(v23, v25[safeIndex(-p0, |v25|)] + v24, v3.f34);
			var v27: seq<bool> := [v3.f34];
			var v28: seq<bool> := [v27[safeIndex(p0, |v27|)], false];
			var v29: array<multiset<bool>> := new multiset<bool>[21] [v6 - fm21(v3.f34, globalState), v6, v6, v6, multiset(if (false) then v28 else [v3.f34, v0, v3.f34, v0, v0]), multiset{v3.f34, v3.f34, v0}, v6 * v6, multiset(v27) - v6, v6, v6, v6, v6, v6 * v6, v6 - v6, v6, v6, multiset(v27), multiset(([true, v0, v0, v3.f34])[safeIndex(p0, |[true, v0, v0, v3.f34]|) := !!v3.f34]) + v6, v6, v6, v6];
			v29[safeIndex(690, v29.Length)] := v6;
			v29[safeIndex(690, v29.Length)] := v6;
			v20[safeIndex(9, v20.Length)] := v3.fm10(globalState);
			var v30: array<seq<int>> := new seq<int>[18];
			globalState.f9, v4[safeIndex(363, v4.Length)], globalState.f26, v20[safeIndex(9, v20.Length)], v30 := 0x2e8, v5, p0, p0, if (v3.f34) then if (v3.f34) then v30 else v30 else v30;
			var v31: map<int, bool> := map[v20[safeIndex(9, v20.Length)] := if (v3.f34) then v0 else v28[safeIndex(v20[safeIndex(9, v20.Length)], |v28|)]];
			v31 := v31[v20[safeIndex(9, v20.Length)] := !v3.f34 <==> v3.f34];
		}
		...
		match (v33) {
			...
			case DC1(cf1) =>
				globalState.f6 := p0;
				var v38: array<int> := new int[21](i1 => safeModuloInt(i1, p0));
				v38[safeIndex(872, v38.Length)] := p0;
				v38[safeIndex(872, v38.Length)] := p0;
				v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)] := false;
				v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)] := (0x1b9 != 0x294) <== v32.f46;
				var v39 := DC38(p0, -p0);
				match (v39) {
					case DC36(cf56, cf57, cf58) =>
						globalState.f6 := fm48(safeDivisionInt(v38[safeIndex(872, v38.Length)], p0), v32.f46, globalState);
						globalState.f6 := safeModuloInt(0x300 * -cf57, cf57);
						var v40 := "w";
						v40, v3.f34 := v40 + ("fi" + v40), v32.f46;
						var v41: array<seq<int>> := new seq<int>[9](i2 => [|v2|] + [v38[safeIndex(872, v38.Length)], cf57]);
						var v42: seq<int> := [cf58, |multiset{v3.f34}|];
						v41[safeIndex(93, v41.Length)] := v42;
						var v43 := 'x';
						globalState.f6, globalState.f11, v41[safeIndex(93, v41.Length)], globalState.f6 := safeDivisionInt(0xe, cf57) + (|v6| * |multiset{!v32.f46}|), safeModuloInt(cf58, v38[safeIndex(872, v38.Length)]), (fm31(v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)], v43, globalState))[safeIndex(cf57, |fm31(v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)], v43, globalState)|) := safeModuloInt(cf57, p0)], v38[safeIndex(872, v38.Length)];
					case DC37(cf59, cf60, cf61, cf62) =>
						...
						v0 := v32.f46;
					case DC38(cf63, cf64) =>
						var v51 := new C6(v38[safeIndex(872, v38.Length)]);
						globalState.f6 := v38[safeIndex(872, v38.Length)];
						globalState.f3 := new int[1];
						var v52: map<int, bool> := map[v38[safeIndex(872, v38.Length)] := v3.f34];
						v52 := v52[cf64 := v3.f34];
					case DC35(cf55) =>
						globalState.f26 := p0 - 0x2f3;
						var v53: seq<array<int>> := [v38, v38, v38];
						var v54: array<seq<array<int>>> := new seq<array<int>>[3] [v53[safeIndex(p0, |v53|) := v38], v53, v53[safeIndex(fm24(v32.f46, p0, globalState), |v53|) := v38]];
						v54[safeIndex(149, v54.Length)] := v53;
						v54[safeIndex(149, v54.Length)] := v53;
						...
						var v61 := DC0(v38[safeIndex(872, v38.Length)]);
						var v62: array<D24> := new D24[4] [v57, DC59(v60), v57, v57.(cf101 := [v56, v56, map[v32.f46 := v61.cf0], map[v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)] := -p0]])];
						v62[safeIndex(717, v62.Length)] := v58;
						var v63: seq<bool> := [v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)]];
						cf1, v38[safeIndex(872, v38.Length)], globalState.f11, v62[safeIndex(717, v62.Length)] := v63[safeIndex(v38[safeIndex(872, v38.Length)], |v63|)], v38[safeIndex(872, v38.Length)], v38[safeIndex(872, v38.Length)], v57;
						var v64: map<int, bool> := map[v38[safeIndex(872, v38.Length)] := v32.f46];
						v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)] := if (p0 in v64) then v64[p0] else true;
					case DC39(cf65) =>
						var v65 := 'j';
						var v66 := DC42(v65);
						...
						v67[safeIndex(330, v67.Length)] := v65;
						v67[safeIndex(330, v67.Length)] := fm32(globalState);
						...
						var v72: set<seq<bool>> := {[cf1, v4[safeIndex(363, v4.Length)][safeIndex(311, v4[safeIndex(363, v4.Length)].Length)]], v71};
						var v73: seq<char> := [v67[safeIndex(330, v67.Length)]];
		...
		match (v77.(cf53 := if (v0) then v76 else v76)) {
			case DC31(cf50, cf51, cf52) =>
				var v80: array<D16> := new D16[15](i3 => DC40(multiset{set v79 : int | v79 in (map v78 : int | (-698 <= v78) && (v78 < 0x16e) :: (safeDivisionInt(v78, p0)) := (v3.f34)) :: (safeDivisionInt(v79, |"beh"|))}));
				var v81: set<int> := {p0};
				var v82: multiset<set<int>> := multiset{v81};
				var v83 := DC40(v82);
				v80[safeIndex(530, v80.Length)] := v83;
				var v84: map<bool, int> := map[v3.f34 := -p0];
				v80[safeIndex(530, v80.Length)] := v83.(cf66 := v82 - multiset{{if (cf50 in v84) then v84[cf50] else p0, -0x34e}, v81, v81});
				...
				v85[safeIndex(236, v85.Length)] := v86;
				var v88: map<int, int> := map[p0 := -p0];
				var v89: seq<map<int, bool>> := [map v87 : int | v87 in v88 :: (safeDivisionInt(v87, |{cf51, v32.f46}|)) := (v32.f46)];
				var v90: map<int, array<map<int, bool>>> := map[|v89[safeIndex(p0, |v89|)]| := v86];
				v85[safeIndex(236, v85.Length)] := if (-p0 in v90) then v90[-p0] else v86;
				cf51 := v32.f46;
				var v91: array<array<int>> := new array<int>[16];
				var v92: array<int> := new int[17];
				v91[safeIndex(938, v91.Length)] := v92;
				v91[safeIndex(938, v91.Length)] := v92;
			case DC30(cf49) =>
				...
				if (v3.f34) {
					...
					var v95 := "gdveyttl";
					v95 := "ocu" + v95;
					v5[safeIndex(561, v5.Length)] := p0 >= p0;
					v5[safeIndex(561, v5.Length)] := v0;
					...
					globalState.f9 := safeDivisionInt(-155, |v103|);
					var v104 := new C5(if (v3.f34) then v3.f34 else v32.f46, v3.f34);
					var v105: seq<int> := [p0];
					globalState.f1 := fm24(v3.f34, v105[safeIndex(p0, |v105|)], globalState) > p0;
				}
				...
				if (v32.f46) {
					...
					globalState.f1 := p0 <= safeModuloInt(p0, p0);
					var v114: map<multiset<int>, bool> := map[multiset{p0} := v32.f46];
					var v115: array<int> := new int[13] [p0 * 0x276, |((map v113 : int | (0x345 <= v113) && (v113 < 0x1cb) :: (v113 + p0) := (p0)) + v93)|, p0, p0, p0, -|v114|, p0, -p0, p0, safeDivisionInt(p0, 765), p0, p0, p0];
					v115[safeIndex(349, v115.Length)] := p0 - p0;
					v115[safeIndex(349, v115.Length)] := safeModuloInt(p0, p0);
					var v116: map<int, bool> := map[v115[safeIndex(349, v115.Length)] := v32.f46];
					var v117 := DC28(v109, fm8(v116, globalState), v115[safeIndex(349, v115.Length)], v32.f46, v115[safeIndex(349, v115.Length)]);
					v3.f34 := v117.cf44;
				} else {
					var v118: set<bool> := {true};
					var v119: set<set<bool>> := {v118};
					var v120: seq<map<int, int>> := [map[p0 := |v119|], v93 + map[|(seq(abs(751), i5  => (p0)))| := p0], v93];
					var v121 := "qbkfibfod";
					var v122: map<map<array<bool>, multiset<int>>, seq<map<int, int>>> := map[map[v4[safeIndex(363, v4.Length)] := fm43(globalState)] := v120];
					var v123: seq<multiset<int>> := [v2, v2];
					var v124: map<array<bool>, multiset<int>> := map[v5 := v123[safeIndex(p0, |v123|)]];
					globalState.f9, v120 := if (-(p0 + 0x368) in v2) then v2[-(p0 + 0x368)] else |v121|, (if (v124 in v122) then v122[v124] else [v93, v93])[safeIndex(p0, |(if (v124 in v122) then v122[v124] else [v93, v93])|) := v93 + v93];
					var v125: seq<array<bool>> := [v4[safeIndex(363, v4.Length)]];
					globalState.f21 := v125[safeIndex(p0, |v125|)];
					v121 := v121;
					var v126: array<map<int, bool>> := new map<int, bool>[8];
					v126 := v126;
					var v127: C7 := new C7(v3.f34, v32.f46, if (v3.f34) then true else v32.f46);
					var v129 := DC41(set v128 : char | v128 in (seq(abs(316), i6  => ('n'))) :: (v128));
					var v130: map<D17, C7> := map[v129 := v127];
					var v131: seq<C7> := [if (v129 in v130) then v130[v129] else v127];
					globalState.f11, v127 := safeModuloInt(p0, |v121|), v131[safeIndex(p0, |v131|)];
				}
			...
			case DC32(cf53) =>
				...
				var v138 := "i";
				var v140: seq<int> := [-p0];
				var v141: array<set<int>> := new set<int>[24] [v132, v132, v132, v132, {p0}, v132, v132, set v133 : int | (-551 <= v133) && (v133 < -0xf3) :: (v133 - p0), v137.cf83, v132, {p0}, {p0}, v132, v132, {|v138|, p0}, v132, v132, v132, {p0}, v132, v132, {p0, |(set v139 : int | (0x111 <= v139) && (v139 < 0x2a9) :: (safeDivisionInt(v139, p0)))|, |v140|, p0}, v132, v132];
				var v142 := DC43(v141);
				v142 := v142;
				var v143 := new C7(v3.f34, v0, v3.f34);
				var v144: set<bool> := {v32.f46, v3.f34};
				var v145: seq<array<bool>> := [v4[safeIndex(363, v4.Length)]];
				var v146: map<bool, int> := map[v2[v140[safeIndex(p0, |v140|)] := abs(|v144|)] < multiset(v140) := |v145|];
				...
				var v151: array<seq<map<int, int>>> := new seq<map<int, int>>[7] [v148[safeIndex(-836, |v148|)], [v147, v147, v147, map v149 : int | (0x139 <= v149) && (v149 < -14) :: (safeDivisionInt(v149, |v146|)) := (-|v140|), v147], v150[safeIndex(p0, |v150|) := v147] + v150, v150, [v147, v147], v150, v150];
				v151[safeIndex(87, v151.Length)] := v150 + v150;
				v151[safeIndex(87, v151.Length)] := (v150 + (seq(abs(171), i7  => (v147)))) + v150;
		}
	...
	method m11(p0: array<char>, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: multiset<set<bool>>, r3: set<string>) {
		...
		var v4: array<multiset<bool>> := new multiset<bool>[9] [v0, v0, if (p1) then v0 else v0, v0, v0, v0, v0 - v0, v0, if (false) then v1[safeIndex(|v3|, |v1|)] else v0];
		v4[safeIndex(528, v4.Length)] := v0;
		v4[safeIndex(528, v4.Length)] := v0;
		var v5: map<int, bool> := map[|{fm47(p2, p1, p2, p1, globalState)}| := p1];
		var v6 := "wrfwi";
		var v7: set<string> := {v6};
		var v8: seq<set<string>> := [v7];
		var v9: map<map<int, bool>, bool> := map[v5 := v8[safeIndex(p2, |v8|)] > v7];
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v10 := new C4(p1);
			globalState.f6 := safeDivisionInt(p2, p2);
			var v11: seq<int> := [p2, p2];
			globalState.f6 := p2 * safeModuloInt(|v11|, |"y"|);
			var v12: array<array<array<bool>>> := new array<array<bool>>[28];
			var v13: seq<array<bool>> := [v2];
			var v14: array<array<bool>> := new array<bool>[12] [v2, v13[safeIndex(p2, |v13|)], v2, v2, v2, v2, v2, v2, v2, v2, v2, v2];
			v12[safeIndex(745, v12.Length)] := v14;
			v12[safeIndex(745, v12.Length)] := v14;
		}
		...
		match (v18) {
			case DC18(cf31, cf32, cf33) =>
				...
				v19[safeIndex(727, v19.Length)] := cf32;
				v19[safeIndex(727, v19.Length)] := cf32;
				var v20 := new C0(fm29(v6, fm30(cf31, cf32, globalState), v19[safeIndex(727, v19.Length)], cf33, globalState));
				globalState.f1 := false;
			case DC19(cf34) =>
				...
				v25 := v25[p1 := false];
			case DC17(cf30) =>
				var v26: seq<int> := [p2, |v4[safeIndex(528, v4.Length)]|, 0x2, p2];
				var v27: multiset<int> := multiset{0x3d5, p2};
				var v28: multiset<int> := multiset{|v27|};
				var v29: seq<multiset<int>> := [v27, multiset{p2}, v28, v27];
				if ((multiset(v26))[|v29| := abs(p2)] !! v27) {
					globalState.f1 := |(v28 + v27)| != p2;
					v2[safeIndex(4, v2.Length)] := fm47(p2, !p1, p2, p1, globalState);
					v2[safeIndex(4, v2.Length)] := p1;
					var v30 := 'u';
					var v31 := new C1(v2[safeIndex(4, v2.Length)], |v6[safeIndex(p2, |v6|) := v30]|);
					var v32: map<map<int, bool>, char> := map[v5 := 'g'];
					v32 := v32[v5 := v30];
					var v33: seq<bool> := [v31.f44];
					globalState.f11, v6, v6 := safeDivisionInt(if (true) then p2 else |{-|v33|}|, v31.f45), v6, cf30;
				} else {
					var v34 := 'p';
					...
					v42[safeIndex(728, v42.Length)] := v43 + v44[safeIndex(p2, |v44|)];
					v42[safeIndex(728, v42.Length)] := v43;
					var v45 := DC9(p2, true);
					var v46: array<D3> := new D3[4] [v45, v45, DC9(p2, v43[safeIndex(p2, |v43|)]), v45];
					v46[safeIndex(278, v46.Length)] := v45;
					v2[safeIndex(177, v2.Length)] := fm16(p2, !false, v26, globalState);
					var v47: set<bool> := {p1};
					v46[safeIndex(278, v46.Length)], globalState.f1, v2[safeIndex(177, v2.Length)] := v45, p1, p1 in v47;
					var v48 := new C3(v2[safeIndex(177, v2.Length)], p2);
				}
				
				var v49: map<int, seq<int>> := map[|cf30| := v26];
				v26 := (if (safeDivisionInt(p2, p2) in v49) then v49[safeDivisionInt(p2, p2)] else [p2])[safeIndex(safeModuloInt(p2, p2), |(if (safeDivisionInt(p2, p2) in v49) then v49[safeDivisionInt(p2, p2)] else [p2])|) := if (p1) then p2 else p2];
				if (p1) {
					var v50: C9 := new C9(p1);
					v50 := v50;
					var v51 := new C1(v50.f34, p2);
					v2[safeIndex(456, v2.Length)] := p1;
					var v52: seq<bool> := [!v51.f44, v51.f44, v51.f44];
					v2[safeIndex(456, v2.Length)] := fm29(cf30, v6, |v52|, |v6|, globalState);
					v51.m20(0x53, v51.f44, v50.f34 <==> v2[safeIndex(456, v2.Length)], globalState);
					...
					var v61: array<seq<int>> := new seq<int>[7] [([|v60|, p2])[safeIndex(v58.fm0(fm24(v58.f41, p2, globalState), v56.f46, globalState), |[|v60|, p2]|) := p2] + v26, (seq(abs(0x344), i3  => (p2)))[safeIndex(p2, |(seq(abs(0x344), i3  => (p2)))|) := p2], v26, if (p2 in v49) then v49[p2] else v26, v26, v26, (seq(abs(0xa2), i4  => (|[v58.f41, v56.f46, v58.f41, if (p2 in v5) then v5[p2] else v56.f46]|)))[safeIndex(p2, |(seq(abs(0xa2), i4  => (|[v58.f41, v56.f46, v58.f41, if (p2 in v5) then v5[p2] else v56.f46]|)))|) := p2] + v26];
					v61 := v61;
					r1 := v58.f41;
			...
			case DC20(cf35) =>
				...
				var v65: seq<int> := [p2];
				var v66: array<int> := new int[19] [p2, p2, 0x258, -543, 0x31e, |v6|, 0x2b1, p2, -p2, p2, v65[safeIndex(p2, |v65|)], p2, 0x11, p2, |v6|, p2, p2, p2, 0x2af];
				...
				v66[safeIndex(14, v66.Length)] := p2;
				v66[safeIndex(14, v66.Length)] := --|v6|;
				var v72: map<bool, seq<int>> := map[false := v65 + v65];
				v65 := if (false in v72) then v72[false] else if (p1) then [v66[safeIndex(14, v66.Length)], v66[safeIndex(14, v66.Length)], |fm40(!p1, globalState)|, p2] else v65;
		}
		...
		match (fm83(v73, p2, v75 - v75, globalState)) {
			case DC36(cf56, cf57, cf58) =>
				globalState.f26 := p2;
				var v76: seq<bool> := [p1];
				var v77: array<int> := new int[4] [|(DC6(|v6|, cf57, v76).cf12 + v76)[safeIndex(cf57, |(DC6(|v6|, cf57, v76).cf12 + v76)|) := p1]|, cf58, safeDivisionInt(0x319, p2), safeDivisionInt(-p2, cf56)];
				v77[safeIndex(910, v77.Length)] := p2;
				var v78: C6 := new C6(382);
				var v79: map<bool, C6> := map[p1 := v78];
				v77[safeIndex(910, v77.Length)] := |((v79 + v79) + v79)|;
				r1 := p1;
				var v80: array<seq<set<char>>> := new seq<set<char>>[8];
				var v81 := 'p';
				var v82: set<char> := {v81};
				var v83: seq<set<char>> := [v82, v82, {v81}];
				v80[safeIndex(661, v80.Length)] := v83;
				var v84 := DC41(v82);
				v80[safeIndex(661, v80.Length)] := (v83 + v83)[safeIndex(cf58, |(v83 + v83)|) := v84.cf67];
			case DC37(cf59, cf60, cf61, cf62) =>
				cf60 := cf60;
				var v85 := new C0(cf60);
			...
			case DC38(cf63, cf64) =>
				...
				var v88 := DC37(|v87|, p1, p2, [seq(abs(0x1e9), i5  => ('d'))]);
				...
				var v92: array<string> := new seq<char>[8] [seq(abs(-0x32f), i6  => (v91)), v6, v6, "muryj", v6, v6, v6, v6];
			...
			case DC35(cf55) =>
				...
				v94[safeIndex(868, v94.Length)] := p2;
				var v95: multiset<array<bool>> := multiset{v2, v2, v2, v2};
				var v96: array<multiset<array<bool>>> := new multiset<array<bool>>[17] [v95 + multiset{v2}, if (p1) then DC53(v95).cf91 else v95, v95, v95, v95 + v95, v95 + v95, multiset{v2, v2}, multiset{v2}, v95, v95, v95, v95, v95[v2 := abs(|v6|)], v95, v95, v95, v95];
				v96[safeIndex(918, v96.Length)] := v95[v2 := abs(p2)];
				var v97: map<bool, int> := map[p1 := p2];
				globalState.f1, globalState.f21, v94[safeIndex(868, v94.Length)], v96[safeIndex(918, v96.Length)], globalState.f6 := fm16(safeDivisionInt(|[|v6|, |v6|, |v97|]|, --|v75|), p1, v74, globalState), v2, |map[map v98 : int | v98 in v74 :: (v98 * |v75|) := (p1) := p1]| * safeDivisionInt(p2, p2), (if (p1) then v95 else v95) * v95, if (p1) then p2 else --p2;
				globalState.f1 := -v94[safeIndex(868, v94.Length)] > p2;
				var v99: array<set<bool>> := new set<bool>[29];
				var v100 := 'p';
				v99[safeIndex(832, v99.Length)] := fm36(v100, globalState);
				v2[safeIndex(751, v2.Length)] := v73 !! v73;
				var v101: set<bool> := {p1, !p1};
				v99[safeIndex(832, v99.Length)], r1, v2[safeIndex(751, v2.Length)], r0 := v101 - v101, fm47(v94[safeIndex(868, v94.Length)], p1, p2, p1, globalState), false, p1;
				v94[safeIndex(868, v94.Length)] := p2;
			case DC39(cf65) =>
				globalState.f1 := p2 < (fm48(|v9|, p1, globalState) * p2);
				var v102 := 'b';
				p0[safeIndex(438, p0.Length)] := v102;
				p0[safeIndex(438, p0.Length)] := v102;
				v2[safeIndex(901, v2.Length)] := p1;
				var v103: map<bool, bool> := map[fm11((seq(abs(84), i8  => (v102)))[safeIndex(|fm30(p1, p2, globalState)|, |(seq(abs(84), i8  => (v102)))|) := p0[safeIndex(438, p0.Length)]], globalState) := !p1];
				var v104 := DC18(p1, p2, 239);
				var v105: seq<bool> := [p1, p1, p1];
				v2[safeIndex(901, v2.Length)] := if ((true <==> v104.cf31) in v103) then v103[true <==> v104.cf31] else v105[safeIndex(p2, |v105|)];
				v6 := v6;
		}
		...
		if (fm63(v107, p1, p2, globalState) < (v108 + v108)) {
			...
			if (if (v106.f40) then v110 >= {v109, v109, v109, v109, v109} else v106.f40) {
				...
				v111[safeIndex(539, v111.Length)] := v5;
				v109[safeIndex(472, v109.Length)] := p2;
				v109[safeIndex(262, v109.Length)] := p2;
				globalState.f11, v111[safeIndex(539, v111.Length)], globalState.f1, v109[safeIndex(472, v109.Length)], v109[safeIndex(262, v109.Length)] := p2 * 0x22, v5 + v5, v107 !in "gr", if (v106.f40) then p2 else safeDivisionInt(p2, -0x373), p2 + p2;
				var v112: map<int, int> := map[if (v109[safeIndex(472, v109.Length)] in v75) then v75[v109[safeIndex(472, v109.Length)]] else p2 := p2];
				r0 := v108[safeIndex(if (p2 in v112) then v112[p2] else p2, |v108|)];
				v2[safeIndex(794, v2.Length)] := v106.f40;
				var v113 := DC3(v107);
				v2[safeIndex(794, v2.Length)] := !(v107 !in (v6 + v6)[safeIndex(p2, |(v6 + v6)|) := v113.cf3]);
				v6 := v6[safeIndex(v109[safeIndex(472, v109.Length)], |v6|) := v107] + v6;
				v74 := [p2, -(v109[safeIndex(472, v109.Length)] * |v0|), p2];
			} else {
				...
				r1, globalState.f26 := v106.f40, safeDivisionInt(p2, p2) - -p2;
				...
				globalState.f1 := map[p1 := 879] in ((set v118 : map<bool, int> | v118 in v117 :: (v118)) - v119[safeIndex(p2, |v119|)]);
				v4[safeIndex(528, v4.Length)] := v4[safeIndex(528, v4.Length)];
				globalState.f9 := -p2;
			}
			...
			var v126: multiset<set<int>> := multiset{set v125 : int | v125 in v74 :: (safeModuloInt(v125, 0x3c9))};
			var v127 := DC40(v126);
			var v128 := new C6(|(if (p2 in v124) then v124[p2] else [DC40(v126), v127])[safeIndex(p2, |(if (p2 in v124) then v124[p2] else [DC40(v126), v127])|) := v127]|);
			...
			v129[safeIndex(719, v129.Length)] := v130;
			v129[safeIndex(719, v129.Length)] := v130;
			r1 := p2 >= v128.f39;
			globalState.f6 := p2;
		} else {
			...
			if (v108[safeIndex(|v132|, |v108|)]) {
				...
				v137[safeIndex(810, v137.Length)] := v138;
				var v139 := DC14(p2);
				globalState.f21, globalState.f26, v6, v137[safeIndex(810, v137.Length)], globalState.f1 := v2, safeModuloInt(v135.f39, v135.f39), "fugvwl" + v6, map[v139.cf27 := v136.f43], true;
			} else {
				var v140: array<int> := new int[25];
				v140[safeIndex(383, v140.Length)] := 0x11a;
				v140[safeIndex(383, v140.Length)] := safeModuloInt(p2 + |v4[safeIndex(528, v4.Length)]|, 0x1a0);
				globalState.f26 := p2;
				var v141: map<char, bool> := map[v107 := v106.f40];
				var v142: seq<seq<bool>> := [v108, v108, fm63(v107, v106.f40, v140[safeIndex(383, v140.Length)], globalState)];
			...
			v146 := v146;
			v144[safeIndex(371, v144.Length)] := p2;
			v144[safeIndex(371, v144.Length)] := p2 - p2;
			if (v106.f40) {
				v144 := v144;
				var v147 := new C5(v106.f40, v106.f40 && v106.f40);
				v2[safeIndex(146, v2.Length)] := v108[safeIndex(v144[safeIndex(371, v144.Length)], |v108|)];
				v2[safeIndex(146, v2.Length)], v75, globalState.f3, v6, v74 := true, v75, v144, "ajsmgruhy", v74;
				var v148 := DC11(multiset{v144});
				var v149: map<D4, int> := map[v148 := p2];
				v2[safeIndex(146, v2.Length)], v144[safeIndex(371, v144.Length)], globalState.f15, globalState.f3 := v106.f40, |(v149 + v149)|, fm32(globalState), v144;
				v2[safeIndex(146, v2.Length)] := v106.f40;
			} else {
...
class C11 extends T0 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		var v0 := 'q';
		var v1: set<char> := {v0};
		if (safeModuloInt(0x3dc, |v1|) != (p0 * |"jjbaobk"|)) {
			var v2: array<bool> := new bool[11](i0 => false);
			v2[safeIndex(434, v2.Length)] := false;
			var v3 := false;
			globalState.f1, v2[safeIndex(434, v2.Length)] := v3, v3;
			globalState.f1, globalState.f1, v2[safeIndex(434, v2.Length)], globalState.f11 := v3, v2[safeIndex(434, v2.Length)], v3, p0;
			r0 := v3;
			if (v3) {
				var v4: seq<int> := [p0, p0, p0];
				v4 := v4;
				var v5: map<bool, char> := map[v3 := fm7(v3, v3, v2[safeIndex(434, v2.Length)], globalState)];
				...
				var v8: map<int, string> := map[|(seq(abs(878), i1  => (v0)))| := p2];
				var v9 := DC0(|(if (p0 in v8) then v8[p0] else "qni")| * p0);
				v9 := v9;
				globalState.f1 := p2 <= (seq(abs(198), i2  => ('a')));
			} else {
				var v10: multiset<bool> := multiset{v3};
				var v11: map<bool, int> := map[v3 := safeDivisionInt(p0, |v10|)];
				globalState.f26 := if (v2[safeIndex(434, v2.Length)] in v11) then v11[v2[safeIndex(434, v2.Length)]] else p0;
				v2[safeIndex(434, v2.Length)] := p0 >= p0;
				...
				var v17 := DC2(safeDivisionInt(p0, p0));
				globalState.f26, v16, globalState.f21, v17, v10 := p0, v16, v2, v17, v10;
				v2[safeIndex(434, v2.Length)] := v3;
			}
			...
			var v21 := DC7(v20[safeIndex(p0, |v20|)]);
			...
			if (v23) {
				...
				v29[safeIndex(850, v29.Length)] := v31;
				var v32: array<bool> := new bool[4](i4 => v27.f28);
				v32[safeIndex(797, v32.Length)] := v23;
				var v33: seq<int> := [p0];
				var v34: map<int, map<string, int>> := map[p0 := map[p2 := 82]];
				globalState.f1, v29[safeIndex(850, v29.Length)], v32[safeIndex(797, v32.Length)] := |v33| > p0, (if (p0 in v34) then v34[p0] else map["kmjyo" := |fm22(p0, v33, v27.f28, p0, globalState)|])[(p2 + (seq(abs(0xbc), i5  => (v0))))[safeIndex(|p2|, |(p2 + (seq(abs(0xbc), i5  => (v0))))|) := v0] := 849], if (v23) then false else v27.f28;
			} else {
				globalState.f1 := !v23;
				var v35: map<int, char> := map[p0 := p2[safeIndex(p0, |p2|)]];
			...
			globalState.f1 := safeModuloInt(p0, p0) > safeDivisionInt(-|v39|, p0);
			globalState.f3 := p1;
			...
			if ((v40 + {v23, true}) != {v23}) {
				...
				var v42 := DC10(v41);
				v38[safeIndex(712, v38.Length)] := v23;
				var v43: C5 := new C5(false, v23 <== v23);
				var v44: multiset<int> := multiset{-78};
				var v45: map<int, string> := map[|v44| := "v"];
				v42, v38[safeIndex(712, v38.Length)], v43, globalState.f1, globalState.f1 := v42, fm11(p2, globalState), v43, v43.f40, p2 == (p2 + (if (p0 in v45) then v45[p0] else p2));
				globalState.f26 := p0;
				v38[safeIndex(712, v38.Length)], globalState.f1 := v23, f32[safeIndex(p0, |f32|)];
				var v46: multiset<map<bool, int>> := multiset{map[v38[safeIndex(712, v38.Length)] := p0]};
				var v47: set<string> := {p2 + "o", fm50(p0, |v46|, v43.f40, globalState), p2};
				var v48: map<bool, string> := map[v23 := seq(abs(-0x22c), i6  => (v0))];
				v47 := {p2 + (if (v23 in v48) then v48[v23] else seq(abs(0x26e), i7  => (v0))), p2[safeIndex(p0, |p2|) := v0] + fm30(v43.f40, p0, globalState)};
			} else {
				globalState.f26 := -p0;
				var v49: map<bool, string> := map[if (v23) then v23 else true := p2[safeIndex(p0, |p2|) := 'q']];
				v49 := v49;
				var v50: multiset<bool> := multiset{v23, !v23};
				var v51: seq<int> := [|v50|];
				var v52 := DC13(v51);
				var v53: set<D5> := {v52};
				r0 := f32[safeIndex(|v53|, |f32|)];
				globalState.f11 := p0;
			...
			match (fm44(|("nhavsa" + p2)|, v23, -p0 + -p0, globalState)) {
				...
				case DC27(cf42) =>
					...
					var v65: map<array<int>, string> := map[if (v23 in v63) then v63[v23] else p1 := v64[safeIndex(p0, |v64|)]];
					v62 := if (p1 in v65) then v65[p1] else v62;
					p1[safeIndex(996, p1.Length)] := p0;
					...
					v67[safeIndex(41, v67.Length)] := v40;
					p1[safeIndex(996, p1.Length)], v67[safeIndex(41, v67.Length)] := p0, {!!!v23, v23};
					var v68: set<int> := {p0};
		...
		if (0x12a !in (v76 + (if (-p0 in v77) then v77[-p0] else v76))) {
			p1[safeIndex(271, p1.Length)] := safeDivisionInt(p0, -p0);
			...
			var v83: seq<D21> := [v82];
			var v84 := DC52(v83[safeIndex(|(seq(abs(0x121), i8  => (v0)))|, |v83|)]);
			var v85 := DC8(p0, p0, v75);
			var v86: seq<D3> := [v85, DC8(|f32[safeIndex(p0, |f32|) := v75]|, p0, v75), v85];
			var v87: array<seq<D3>> := new seq<D3>[3] [v86, v86, v86];
			v87[safeIndex(52, v87.Length)] := v86;
			var v88: array<bool> := new bool[4];
			p1[safeIndex(271, p1.Length)], v84, v87[safeIndex(52, v87.Length)], globalState.f26, r1 := safeDivisionInt(p0, p0), (if (v75) then v84 else v84).(cf90 := v82), v86, p0, v88;
			globalState.f26 := p1[safeIndex(271, p1.Length)];
			var v89 := new C10();
			var v90 := new C0(v75);
			var v91: set<int> := {p1[safeIndex(271, p1.Length)]};
			var v92: map<bool, int> := map[v75 := p1[safeIndex(271, p1.Length)]];
			var v93: multiset<int> := multiset{|v92|};
			var v95: map<int, seq<bool>> := map[p1[safeIndex(271, p1.Length)] := f32];
			var v97: multiset<set<int>> := multiset{v91, {p0, p1[safeIndex(271, p1.Length)]}, v91, (set v94 : int | v94 in v93 :: (safeDivisionInt(v94, |[false, false]|))) * (set v96 : int | v96 in v95 :: (v96 - |"aig"|)), v91};
			v97 := if (!v90.f46) then f33 else v97 - multiset(seq(abs(219), i9  => (v91)));
		} else {
			var v98 := "fmgpeukaw";
			var v99: seq<seq<char>> := [[v0, v0], seq(abs(-0x1b8), i10  => (v0))];
			var v100 := DC35(v99);
			...
			if (v75) {
				...
				var v104: map<D2, bool> := map[DC5(v75, fm22(p0, seq(abs(0x1a8), i11  => (p0)), v75, p0, globalState), p0) := v102 !in v103];
				v104 := map v105 : D2 | v105 in v104 :: (v105) := (v75);
				globalState.f26 := p0;
				var v106: multiset<int> := multiset{safeModuloInt(p0, 0x211), -0x229, |(v76 + v76)|, p0, p0};
				var v107: array<map<bool, bool>> := new map<bool, bool>[23];
				var v108 := DC6(0xc, p0, f32);
				var v109 := DC50(v107, v108, v75, {p0}, v106);
				v106 := v109.cf84[safeModuloInt(p0, v76[safeIndex(760, |v76|)]) := abs(p0)];
				...
				p1[safeIndex(735, p1.Length)] := |v112[safeIndex(p0, |v112|)]|;
				p1[safeIndex(735, p1.Length)] := p0;
				var v113: set<int> := {p0, p1[safeIndex(735, p1.Length)]};
				globalState.f26, globalState.f6, globalState.f26, p1[safeIndex(735, p1.Length)] := p0 - p1[safeIndex(735, p1.Length)], -safeModuloInt(p0, p1[safeIndex(735, p1.Length)]), -safeDivisionInt(p1[safeIndex(735, p1.Length)], --|(fm45(globalState) - v113)|), 583;
			} else {
				var v114: map<bool, string> := map[v75 := p2 + v98[safeIndex(p0, |v98|) := v0]];
				v114 := v114[v75 := p2];
				var v115: array<C4> := new C4[29];
				var v116: set<array<C4>> := {v115, v115, v115};
				globalState.f26, v116 := -0x309, v116;
				var v117: multiset<bool> := multiset{fm16(p0, v75, seq(abs(-0x21a), i13  => (p0)), globalState)};
			...
			v122[safeIndex(177, v122.Length)] := map[|(multiset{v75})[!v75 := abs(|v124|)]| := |v125|];
			var v126: map<int, int> := map[p0 := p0];
			var v127: multiset<char> := multiset{p2[safeIndex(p0, |p2|)], 'v', fm32(globalState), 'm', v0};
			var v128: map<multiset<char>, int> := map[v127 := p0];
			v122[safeIndex(177, v122.Length)] := DC12(false, map[|v126| := p0], false, fm14(v75, v128, v75, globalState), |map[v75 := v75]|).cf22;
			var v129: multiset<bool> := multiset{v75, v75, true, v75, false};
			var v130: map<int, multiset<bool>> := map[0x178 := v129];
			var v131: multiset<multiset<bool>> := multiset{(if (|f32| in v130) then v130[|f32|] else v129) * v129, v129[v75 := abs(p0)], multiset{v75, v75, v75, v75, v75}, v129, v129};
			...
			if (fm11(p2, globalState)) {
				...
				v133[safeIndex(119, v133.Length)] := v134;
				var v135 := DC64(v134);
				v133[safeIndex(119, v133.Length)] := v135.cf109;
				var v136 := DC38(p0, p0);
				...
				v138[safeIndex(259, v138.Length)] := DC38(p0, p0);
				v138[safeIndex(259, v138.Length)] := v136;
				var v139: map<bool, bool> := map[false := v75];
				var v140 := new C3(|v139| != p0, p0);
				var v141: seq<seq<bool>> := [f32];
				var v142: array<seq<bool>> := new seq<bool>[2] [v141[safeIndex(p0, |v141|)], f32];
				v142[safeIndex(748, v142.Length)] := f32 + f32;
				v142[safeIndex(748, v142.Length)] := [!(v140.f43 <= p0)];
			} else {
				...
				globalState.f26 := p0;
				r0 := v75;
				p1[safeIndex(136, p1.Length)] := p0;
				var v144: map<bool, map<int, int>> := map[!v75 := v122[safeIndex(177, v122.Length)]];
				var v145: map<bool, int> := map[!fm29(p2, "lnphahmxn", p0, p0, globalState) := 0x21f];
				var v146: set<int> := {0xf4};
				globalState.f26, p1[safeIndex(136, p1.Length)], globalState.f1, globalState.f9 := p0, safeModuloInt(|v144|, if (!v75 in v129) then v129[!v75] else p0), (map[false := 0x31f] != v145) <==> v75, |((if (v75) then v146 else {|{--0x301}|, 0x2e5, p0}) * v146)|;
			}
		...
		p1[safeIndex(345, p1.Length)] := p0;
		var v150 := "ld";
		var v151: C0 := new C0(v148.f28);
		var v152: array<map<char, int>> := new map<char, int>[9](i14 => map[v0 := p0]);
		var v153 := DC30(v152);
		var v154: seq<D13> := [v153, v153];
		var v155 := DC32(v154[safeIndex(p0, |v154|)]);
		var v156: map<C0, D13> := map[v151 := v155];
		var v157 := DC17(p2[safeIndex(p0, |p2|) := v0]);
		var v158: map<int, string> := map[p0 := v150];
		p1[safeIndex(345, p1.Length)], v150, globalState.f26, v156 := p0, (v157.(cf30 := if (p0 in v158) then v158[p0] else p2)).cf30, 305, v156 + (v156[v151 := v155] + map[v151 := DC32(v153)]);
	...
	method m8(p0: map<int, array<int>>, globalState: GlobalState) returns (r0: multiset<D0>, r1: multiset<bool>, r2: bool, r3: char) {
			...
			decreases 100 - i0
		{
			...
			v5 := v5[v6[safeIndex(v1.f43, |v6|)] := if (v1.f42 in v7) then v7[v1.f42] else v1.f42];
		...
		if (|([v1.f42] + ([v1.f42, v1.f42, false])[safeIndex(v1.f43, |[v1.f42, v1.f42, false]|) := v1.f42])[safeIndex(|v17|, |([v1.f42] + ([v1.f42, v1.f42, false])[safeIndex(v1.f43, |[v1.f42, v1.f42, false]|) := v1.f42])|) := v1.f42]| != v1.f43) {
			v13[safeIndex(84, v13.Length)] := v1.f43;
			var v18 := 'h';
			v13[safeIndex(84, v13.Length)], globalState.f1, globalState.f3, globalState.f1 := v0, v18 !in v15.f36, v13, "cxa" <= fm18(globalState);
			r2 := v1.f42;
			if (v1.f42) {
				...
				var v23: map<int, int> := map[|(v20 - v20)| := safeDivisionInt(|v22|, v0)];
				v23 := map v24 : int | (0x3a5 <= v24) && (v24 < 621) :: (v24 * |"waa"|) := (v1.f43 + (if (true in v21) then v21[true] else DC6(v1.f43, v13[safeIndex(84, v13.Length)], f32).cf10));
				var v25: seq<string> := [v15.f36];
				v21 := v21[v1.f42 := safeDivisionInt(v19.fm0(v1.f43, !false, globalState), |v25[safeIndex(v0, |v25|)]|)];
				var v26 := "rwvayoq";
				var v27: array<int> := new int[2](i1 => i1 * v1.f43);
				var v28: map<bool, char> := map[v1.f42 := v18];
				globalState.f3, v0, v26, f32 := v27, safeDivisionInt(v1.f43, |v28|), "yuejfgt", f32;
				var v29: map<int, array<int>> := map[safeModuloInt(v1.f43, v1.f43) := v27];
				var v30: multiset<bool> := multiset{v1.f42, v1.f42, v1.f42, v1.f42, false};
				v29 := v29[safeModuloInt(|v30|, v1.f43) := v27];
			} else {
				v13[safeIndex(84, v13.Length)] := |v15.f36|;
				var v31: array<bool> := new bool[16];
				v31[safeIndex(346, v31.Length)] := v1.f42;
				v31[safeIndex(346, v31.Length)] := v1.f43 == v1.f43;
				globalState.f9 := -v1.f43;
				var v32: array<array<string>> := new array<string>[27];
				var v33: array<string> := new string[15];
				v32[safeIndex(469, v32.Length)] := if (v31[safeIndex(346, v31.Length)]) then v33 else v33;
				var v34: multiset<char> := multiset{v18, v18};
				var v35: map<int, int> := map[v13[safeIndex(84, v13.Length)] := v1.f43];
				v0, v13[safeIndex(84, v13.Length)], v32[safeIndex(469, v32.Length)], globalState.f6, v1.f43 := -v1.f43 * (if (v1.f42) then fm14(v1.f42, map[v34 := v1.f43], f32[safeIndex(v0, |f32|)], globalState) else v13[safeIndex(84, v13.Length)]), if (v0 in v35) then v35[v0] else v13[safeIndex(84, v13.Length)], v33, -fm24(v1.f42, v0, globalState), fm0(v1.f43, v1.f42, globalState);
				var v36: map<int, string> := map[v13[safeIndex(84, v13.Length)] - v1.f43 := "jmsyhfhru"];
				v36 := fm85(globalState);
			}
			
			var v37: array<bool> := new bool[22];
			v37[safeIndex(343, v37.Length)] := if (!v1.f42) then v1.f42 else v1.f42;
			var v38 := "vqtgyef";
			var v39: C10 := new C10();
			var v40: seq<C10> := [v39];
			var v41: map<bool, int> := map[!v1.f42 := v1.f43];
			var v42: seq<string> := [v15.f36, seq(abs(0x1b1), i2  => ('g')), v38];
			v37[safeIndex(343, v37.Length)], v38, v1.f43 := [v39] <= v40, v15.f36 + v15.f36, --(if (v1.f42) then |v41| else |v42|);
			var v43: map<int, seq<int>> := map[v0 := v16];
			var v44: map<int, int> := map[v0 := v13[safeIndex(84, v13.Length)]];
			globalState.f1, v1.f43, v43, v13[safeIndex(84, v13.Length)], v37[safeIndex(343, v37.Length)] := false, 0x255 + v16[safeIndex(if (|v38| in v44) then v44[|v38|] else v1.fm0(v13[safeIndex(84, v13.Length)], v1.f42, globalState), |v16|)], (if (v1.f42) then map[-v1.f43 := v17] else v43) + (v43 + v43), |(seq(abs(0x349), i3  => (v18)))|, v1.f42 ==> v37[safeIndex(343, v37.Length)];
		} else {
			...
			if (!(v49.cf84 != multiset((seq(abs(499), i4  => (v1.f43))) + v17))) {
				var v50: map<bool, int> := map[v1.f42 := |v15.f36|];
				var v51 := DC15(v50);
				m9(|v51.cf28| - v1.f43, globalState);
				v13[safeIndex(935, v13.Length)] := |v16| * v1.f43;
				v13[safeIndex(935, v13.Length)] := |map[v1.f42 := v1.f42]|;
				...
				globalState.f1 := v55 in (v56[safeIndex(v1.f43, |v56|)] + v15.f36)[safeIndex(v1.f43, |(v56[safeIndex(v1.f43, |v56|)] + v15.f36)|) := v55];
			...
			var v61 := 'a';
			v60[safeIndex(546, v60.Length)] := ((seq(abs(0x34b), i5  => ('s')))[safeIndex(v0, |(seq(abs(0x34b), i5  => ('s')))|) := v61])[safeIndex(|v15.f36[safeIndex(|v48|, |v15.f36|) := v61]|, |(seq(abs(0x34b), i5  => ('s')))[safeIndex(v0, |(seq(abs(0x34b), i5  => ('s')))|) := v61]|) := v61];
			v60[safeIndex(546, v60.Length)] := v15.f36;
			var v62: multiset<multiset<int>> := multiset{v2[v1.f43 := abs(-11)], v2};
			...
			match (v63) {
				case DC18(cf31, cf32, cf33) =>
					...
					v64[safeIndex(587, v64.Length)] := !(v1.f43 < -fm14(v1.f42, v66, v1.f42, globalState));
					v64[safeIndex(587, v64.Length)] := v1.f42;
					var v67 := DC17(v15.f36);
					globalState.f11 := |[if (cf31) then DC17(v60[safeIndex(546, v60.Length)]) else v67]|;
					v64[safeIndex(587, v64.Length)] := v1.f42;
					var v68: map<bool, int> := map[v64[safeIndex(587, v64.Length)] := v1.f43];
				...
				case DC17(cf30) =>
					...
					v75[safeIndex(1, v75.Length)] := v13;
					v75[safeIndex(1, v75.Length)] := new int[11] [safeDivisionInt(-0x82, |{v0}|), -v1.f43, v0, v0, v1.f43, 0x16c, v0, v1.f43, v1.f43, v0, v1.f43];
					...
					v86[safeIndex(329, v86.Length)] := v1.f42;
					v80, v83, globalState.f3, v86[safeIndex(329, v86.Length)] := v80, v83, v75[safeIndex(1, v75.Length)], v0 >= (v0 * v1.f43);
					var v87: C6 := new C6(v0);
					v87 := new C6(fm24(v86[safeIndex(329, v86.Length)], v0, globalState));
				...
				case DC20(cf35) =>
					...
					v92[safeIndex(744, v92.Length)] := v1.f42;
					v92[safeIndex(744, v92.Length)] := !fm16(-439, v1.f42, v16, globalState);
			}
			
			var v93: array<seq<int>> := new seq<int>[10] [v17, v16 + (seq(abs(0x10d), i6  => (v1.f43))), v16 + v17, (if (v1.f42) then v16 else v16)[safeIndex(v0, |(if (v1.f42) then v16 else v16)|) := v0], if (v1.f42) then v17 else v16, v16, v17, v17, v17, v16[safeIndex(v1.f43, |v16|) := v0]];
			v93[safeIndex(82, v93.Length)] := v17;
			v93[safeIndex(82, v93.Length)] := v16;
		}
		...
		for i7 := |v96| to v1.f43 {
			...
			var v99: multiset<seq<bool>> := multiset{f32, [v95.f28, v95.f28], (if (v1.f42 in v98) then v98[v1.f42] else f32)[safeIndex(v1.f43, |(if (v1.f42 in v98) then v98[v1.f42] else f32)|) := v95.f28]};
			...
			v105[safeIndex(999, v105.Length)] := v95.f28;
			v105[safeIndex(999, v105.Length)] := v95.f28;
			v100 := v100[|(v98 + map[v1.f42 := f32])| := v103.cf9];
			var v106 := new C6(safeDivisionInt(v1.f43, v1.f43));
			r2 := !v95.f28;
		}
		...
		r0 := v109;
		var v110: multiset<bool> := multiset{f32[safeIndex(-545, |f32|)], v95.f28};
		r1 := v110;
		r2 := true;
		var v111 := 'i';
		r3 := v111;
	...
	method m9(p0: int, globalState: GlobalState) {
		var v0 := true;
		if (v0) {
			var v1: array<int> := new int[8](i0 => safeModuloInt(i0, p0));
			globalState.f3 := v1;
			if (!v0) {
				var v2: array<array<bool>> := new array<bool>[14];
				var v3: array<bool> := new bool[28];
				v2[safeIndex(339, v2.Length)] := v3;
				v2[safeIndex(339, v2.Length)] := v3;
				var v4 := "iptsimob";
				var v5: seq<string> := [v4, v4];
				var v6 := DC23(v2[safeIndex(339, v2.Length)], false);
				var v7 := 'a';
				...
				v10 := v10;
				v2[safeIndex(339, v2.Length)][safeIndex(465, v2[safeIndex(339, v2.Length)].Length)] := v0;
				v2[safeIndex(339, v2.Length)][safeIndex(465, v2[safeIndex(339, v2.Length)].Length)] := !true;
			} else {
				var v11 := new C10();
				var v12: array<char> := new char[1];
				var v13 := 'a';
				v12[safeIndex(311, v12.Length)] := v13;
				v12[safeIndex(311, v12.Length)] := v13;
				...
				v20[safeIndex(845, v20.Length)] := !true;
				v20[safeIndex(845, v20.Length)] := !v14.f41;
				v0 := v20[safeIndex(845, v20.Length)];
			}
			
			var v21: array<bool> := new bool[12];
			v21[safeIndex(185, v21.Length)] := v0;
			var v22 := "dfqeu";
			v21[safeIndex(185, v21.Length)] := "bv" <= v22;
			v1[safeIndex(552, v1.Length)] := -p0;
			v1[safeIndex(552, v1.Length)] := (-0x156 * -0x26e) * p0;
			var v23 := 'l';
			...
			v33[safeIndex(114, v33.Length)] := v36 !! v36;
			v32, v33[safeIndex(114, v33.Length)], globalState.f11 := v32, v0, p0;
			v32 := v32;
		}
		...
		if (true) {
			...
			globalState.f15 := v37[safeIndex(p0, |v37|)];
			f32 := f32;
		} else {
			var v42 := 'e';
			globalState.f15 := v42;
			...
			decreases 100 - i2
		{
			...
			if (v47 !! multiset{v46}) {
				globalState.f15 := v44[safeIndex(p0 - -p0, |v44|)];
				...
				v56[safeIndex(952, v56.Length)] := p0;
				var v57: multiset<int> := multiset{-p0};
				globalState.f1, globalState.f1, globalState.f1, v54, v56[safeIndex(952, v56.Length)] := f32[safeIndex(p0, |f32|)], v0, v0, v54, (if (v0 in v55) then v55[v0] else |{-|v57|}|) - p0;
				v53 := (v53 + v53) + v53;
			} else {
				var v58: map<bool, int> := map[v0 := p0];
				var v59: map<int, bool> := map[v45[safeIndex(|v58|, |v45|)] := v0];
				v59 := v59[p0 := !!v0];
				var v60: array<seq<int>> := new seq<int>[20];
				v60 := v60;
				var v61: map<int, array<bool>> := map[p0 := v46];
				v61 := v61[-safeDivisionInt(|v44|, p0) := v46];
				var v62: array<T0> := new T0[12];
				var v63: seq<array<T0>> := [v62, v62];
				var v64: map<int, array<T0>> := map[p0 := v63[safeIndex(p0, |v63|)]];
				...
				var v69: array<seq<bool>> := new seq<bool>[29] [[v0], f32, f32, f32, f32, f32 + f32, f32, [v0, v0], f32, f32, f32, f32, f32 + f32, f32, v67[safeIndex(p0, |v67|)], if (v0) then [true, false] else f32, f32, f32 + f32, f32 + f32, f32 + f32, f32 + ((f32[safeIndex(p0, |f32|) := v0])[safeIndex(p0, |f32[safeIndex(p0, |f32|) := v0]|) := v0])[safeIndex(|f32|, |(f32[safeIndex(p0, |f32|) := v0])[safeIndex(p0, |f32[safeIndex(p0, |f32|) := v0]|) := v0]|) := v0], f32, f32, [v0], f32 + f32, if (p0 in v68) then v68[p0] else [v0, v0], f32[safeIndex(p0, |f32|) := v0], f32, (f32 + f32[safeIndex(|v44|, |f32|) := v0])[safeIndex(p0, |(f32 + f32[safeIndex(|v44|, |f32|) := v0])|) := v0]];
				v69[safeIndex(246, v69.Length)] := [v0, v0, v0, false];
				var v70: C6 := new C6(p0);
				var v71: map<C6, char> := map[v70 := v66];
				v69[safeIndex(246, v69.Length)] := fm63(if (v70 in v71) then v71[v70] else v66, v0, v70.f39, globalState);
			}
			
			var v72: map<bool, int> := map[v44 != v44 := p0];
			var v73 := 'k';
			v72 := v72 + map[v0 := |("rbjtyxq")[safeIndex(|v44|, |"rbjtyxq"|) := v73]|];
			globalState.f1 := true;
		}
	}
}
...
class C12 extends T0 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		...
		match (DC0(|p2|)) {
			case DC0(cf0) =>
				...
				var v5: map<map<int, bool>, int> := map[v4[safeIndex(-p0, |v4|)] := cf0];
				...
				v11[safeIndex(417, v11.Length)] := f30;
				v11[safeIndex(417, v11.Length)] := false || f30;
		}
		...
		var v16 := DC45(--p0, f31, !f30, |(seq(abs(-0x28f), i2  => ('w')))|);
		var v17 := 'q';
		...
		v28[safeIndex(315, v28.Length)] := p1;
		var v29: map<char, int> := map[p2[safeIndex(p0, |p2|)] := p0];
		var v30 := DC3(v17);
		globalState.f26, v28[safeIndex(315, v28.Length)] := safeDivisionInt(if (v30.cf3 in v29) then v29[v30.cf3] else |v13|, safeDivisionInt(|map[v17 := v17]|, p0)), p1;
		var v31 := new C6(f31);
		r0 := f30 <== (v19 > v19);
		r1 := new bool[8];
	}
	method m6(p0: int, p1: bool, p2: array<multiset<int>>, globalState: GlobalState) returns (r0: bool) {
		...
		match (v1.(cf113 := v0)) {
			case DC68() =>
				...
				v2[safeIndex(906, v2.Length)] := fm30(f30, |v3|, globalState);
				var v4 := "xswbpru";
				v2[safeIndex(906, v2.Length)] := v4;
			...
			case DC67(cf113) =>
				...
				if (f30) {
					...
					globalState.f11 := f31 * safeDivisionInt(p0, p0);
					globalState.f1, globalState.f9 := !(v0.f41 && cf113.f41), p0;
					var v16 := "enykvjqbr";
					var v17 := 'c';
					var v18: array<string> := new string[19] [v16[safeIndex(0x1a3, |v16|) := v17], v16, v16, "bdbsxi", seq(abs(366), i1  => (v17)), v16, v16, v16, v16, "drgoxrdgs", "godysis", "kuhqc", v16, v16, v16[safeIndex(f31, |v16|) := v17], v16, "iqfywcphq", seq(abs(-0x10c), i2  => (v17)), seq(abs(0x1b6), i3  => (v17))];
					var v19 := DC49(v18);
					...
					v20[safeIndex(493, v20.Length)] := v19;
					var v21: seq<int> := [p0, p0];
					v20[safeIndex(493, v20.Length)], globalState.f1 := v19.(cf79 := v18), !!fm16(p0, cf113.f41, v21 + v21, globalState);
					v18[safeIndex(866, v18.Length)] := v16;
					var v22: array<int> := new int[22](i4 => safeDivisionInt(i4, f31));
					v22[safeIndex(828, v22.Length)] := f31;
					var v23: map<bool, bool> := map[v0.f41 := v0.f41];
					var v24: map<bool, seq<int>> := map[false := v21[safeIndex(p0, |v21|) := |v23|]];
					...
					globalState.f6, v18[safeIndex(866, v18.Length)], r0, v22[safeIndex(828, v22.Length)], globalState.f6 := fm6(f30, cf113.f41, cf113.f41, v0.fm0(f31, v0.f41, globalState), globalState), "c", true <==> (v24 == v24), p0 - 0x3d7, -(|(if (v26 in v28) then v28[v26] else v30)| - f31);
				...
				var v34: array<bool> := new bool[29] [f30, v0.f41 && f30, v0.f41, cf113.f41, v0.f41, !f30, fm8(v31, globalState), v0.f41, DC37(f31, p1, p0, v33).cf60, f31 < f31, if (|v32| in v31) then v31[|v32|] else cf113.f41, false, p1, p1, v0.f41, fm47(f31, cf113.f41, f31, cf113.f41, globalState), p1, v0.f41, cf113.f41, if (f31 in v31) then v31[f31] else v0.f41, !v0.f41, v32 == (seq(abs(0x12f), i5  => ('e'))), v0.f41, f30, cf113.f41, cf113.f41, f30, v7[safeIndex(p0, |v7|)], v0.f41];
				v34[safeIndex(366, v34.Length)] := true;
				var v35: map<int, int> := map[|{f30, fm8(v31, globalState)}| := 0x30a];
				var v36: map<seq<bool>, int> := map[v7 := f31];
				v34[safeIndex(366, v34.Length)] := fm16(f31, v7[safeIndex(f31, |v7|)], [if (0x3ce in v35) then v35[0x3ce] else |v7|, |v36|], globalState);
				var v37: multiset<bool> := multiset{f30, false && v0.f41, if (p0 in v31) then v31[p0] else v7[safeIndex(0xcd, |v7|)], true, true};
				v37 := multiset{f30};
		}
			...
			decreases 100 - i6
		{
			...
			var v41: array<char> := new char[4] [v40[safeIndex(f31, |v40|)], v38, fm7(!v0.f41, v0.f41, !v0.f41, globalState), v38];
			v41[safeIndex(114, v41.Length)] := v38;
			v41[safeIndex(114, v41.Length)] := v38;
			v40 := (seq(abs(0x3cd), i7  => (v38))) + v40;
			globalState.f15 := 'v';
		}
		...
		var v49: seq<int> := [f31];
		v43, globalState.f11, r0, globalState.f9, globalState.f11 := set v45 : map<int, bool> | v45 in v44 :: (v45), fm0(p0, p1, globalState) - (if (p1 in v46) then v46[p1] else f31), v48[safeIndex(p0, |v48|)], fm6(f30, fm47(|v48|, f30, -692, v0.f41, globalState), p1, -p0, globalState), safeDivisionInt(0x374, 0x79) - |v49|;
		var v50: map<bool, set<int>> := map[fm16(-f31, p1, v49, globalState) := {f31, 493}];
		var v51: multiset<int> := multiset{p0};
		var v52: set<int> := {|v51|};
		globalState.f1 := safeModuloInt(f31, |(if (!p1 in v50) then v50[!p1] else v52)|) != p0;
		r0 := p1;
		r0 := safeDivisionInt(0x392, f31) >= fm24(v0.f41, 0xf7, globalState);
	}
	method m7(p0: int, p1: int, p2: set<seq<int>>, p3: map<bool, seq<int>>, globalState: GlobalState) returns (r0: D0, r1: D0, r2: map<bool, bool>) {
		...
		if (!f30) {
			...
			v4[safeIndex(712, v4.Length)] := v2.f28;
			v4[safeIndex(712, v4.Length)] := !((seq(abs(0x33c), i1  => (p1))) < ((seq(abs(0x17), i2  => (|"hnunnyre"|))) + [753, p1]));
			v4[safeIndex(712, v4.Length)] := true;
		} else {
			var v5: array<multiset<int>> := new multiset<int>[8](i3 => multiset{p0, DC2(f31).cf2});
			var v6 := m6(-p1, f30, v5, globalState);
			var v7 := new C1(v6, p1);
			var v8 := "ecrtckft";
			var v9: multiset<bool> := multiset{f30, v7.f45 >= v7.f45, v8 != (seq(abs(0x3dc), i4  => ('n'))), f30, p0 > v7.f45};
			v9 := v9 - v9;
			v6 := true;
			globalState.f26 := p0;
		}
		...
		match (v18) {
			case DC24(cf39) =>
				...
				v19[safeIndex(966, v19.Length)] := f30;
				var v20: map<int, int> := map[-0x337 := p0];
				v19[safeIndex(966, v19.Length)], globalState.f1, v17 := f30, !(|v20| < p0), (set v21 : int | (0x7a <= v21) && (v21 < 0xab) :: (v21 * p0)) + v17;
				globalState.f9 := 0x3e4 * f31;
				v19[safeIndex(966, v19.Length)] := v19[safeIndex(966, v19.Length)];
				var v22 := "fqskggib";
				v22 := v22;
		}
		...
		forall i5 | 0 <= i5 < v23.Length {
			v23[i5] := safeDivisionInt(i5, |(v10 + v10)|);
		}
		globalState.f11 := p0;
		r0 := DC0(p0).(cf0 := safeDivisionInt(fm48(f31, f30, globalState), |(seq(abs(0x343), i6  => (|v15|)))|));
		var v24 := DC0(p1);
		r1 := v24;
		r2 := v10;
	}
...
class C13 extends T0, T1 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
			...
			decreases 100 - i0
		{
			...
			var v11: seq<int> := [safeDivisionInt(p0, p0), |v10[safeIndex(0x29e, |v10|)]|, 0x14e, p0 * |v8[p0 := abs(p0)]|, p0];
			v11 := (seq(abs(634), i1  => (-p0))) + v11;
			var v12: map<bool, string> := map[f28 := v0];
			var v13: set<bool> := {v2.f34};
			var v14 := DC25(v13);
			match (if ((if (f28 in v12) then v12[f28] else "lsfi") == (seq(abs(0x14a), i2  => (v1)))) then DC25(v13) else v14) {
				case DC26(cf41) =>
					var v15 := new C6(-p0);
					var v16: array<array<bool>> := new array<bool>[20];
					var v17: array<bool> := new bool[1] [cf41];
					v16[safeIndex(840, v16.Length)] := v17;
					var v18: seq<multiset<char>> := [multiset{v1} * multiset{v1}];
					var v19: seq<seq<char>> := [v0[safeIndex(p0, |v0|) := v1]];
					var v20 := DC35(v19);
					var v21: multiset<bool> := multiset{v2.f34};
					v16[safeIndex(840, v16.Length)], v18, f29, v20 := v17, (seq(abs(0x3e6), i3  => (multiset(DC17(p2).cf30)))) + fm87(p0, v11, p0, v1, globalState), cf41 !in v21, v20;
					var v22: seq<array<bool>> := [v17, v16[safeIndex(840, v16.Length)], v17];
					v0, globalState.f9 := (fm18(globalState))[safeIndex(v15.f39, |fm18(globalState)|) := v1], |(v22 + v22)|;
					globalState.f9 := |v19|;
				case DC25(cf40) =>
					...
					v12 := v12[if (|p2| in v25) then v25[|p2|] else f28 := v0[safeIndex(p0, |v0|) := v1]];
			}
			
			p1[safeIndex(987, p1.Length)] := p0 + |v8|;
			p1[safeIndex(987, p1.Length)] := p0;
		}
		...
		match (v28) {
			case DC31(cf50, cf51, cf52) =>
				...
				var v31: set<bool> := {v29[safeIndex(|v30|, |v29|)], true, true, f28};
				var v32: seq<set<bool>> := [v31 * v31];
				v31 := v32[safeIndex(p0, |v32|)];
				var v33: array<C8> := new C8[24];
				var v34 := DC7(p1);
				var v35: C8 := new C8(v34, p2, cf51);
				v33[safeIndex(904, v33.Length)] := v35;
				v33[safeIndex(904, v33.Length)] := v35;
				if (f28) {
					...
					globalState.f26 := safeModuloInt(0x1a1, fm14(!f28, map[v39 := p0], f28, globalState));
					cf51 := cf50;
					...
					p1[safeIndex(676, p1.Length)] := -|(v43 * v43)|;
					var v44: seq<int> := [p0];
					var v45: set<int> := {v44[safeIndex(486, |v44|)], |p2|};
					var v46: map<int, set<int>> := map[|v44| := v45];
					var v47: seq<int> := [|v46|];
					globalState.f6, p1[safeIndex(676, p1.Length)] := p0 * |v44|, p0;
					globalState.f6 := safeDivisionInt(p1[safeIndex(676, p1.Length)], p0);
					var v48: map<bool, bool> := map[cf51 := cf50];
					p1[safeIndex(676, p1.Length)] := (|p2| + |v48|) - p1[safeIndex(676, p1.Length)];
					var v49: array<string> := new string[22];
					v49[safeIndex(985, v49.Length)] := "ptcya";
					v49[safeIndex(985, v49.Length)] := p2;
					var v50: array<T0> := new T0[9];
					v50, v29, globalState.f15, globalState.f26, globalState.f15 := v50, v29, v1, p1[safeIndex(676, p1.Length)], cf52;
				}
			...
			case DC30(cf49) =>
				...
				globalState.f6 := p0;
				v52[safeIndex(692, v52.Length)] := f28;
				v52[safeIndex(692, v52.Length)] := v53 !! v53;
			case DC32(cf53) =>
				...
				if (!({p1, p1} > (v60 + v60))) {
					...
					v61[safeIndex(908, v61.Length)] := f29;
					var v62: array<seq<D19>> := new seq<D19>[4];
					var v63: map<seq<int>, array<int>> := map[[fm48(-|(seq(abs(0x172), i6  => (v1)))|, f29, globalState)] := p1];
					var v64 := DC44(v63);
					var v65 := DC47(v64);
					var v66: seq<D19> := [DC47(v64)];
					v62[safeIndex(330, v62.Length)] := v66;
					var v67 := DC7(p1);
					var v68 := DC10(v67);
					var v69 := DC47(v64);
					v61[safeIndex(908, v61.Length)], globalState.f6, v62[safeIndex(330, v62.Length)] := v68 !in map[v68 := p0], p0, ([DC47(v65), DC47(v64), v69, v69])[safeIndex(p0, |[DC47(v65), DC47(v64), v69, v69]|) := v69] + (v66 + v66);
					v57 := v57;
					var v70 := new C10();
					var v71: seq<string> := [("svraaof" + "muy")[safeIndex(|"sfbva"|, |("svraaof" + "muy")|) := v1]];
					v0 := v71[safeIndex(v58, |v71|)];
				} else {
					p1[safeIndex(492, p1.Length)] := p0;
					var v72 := DC7(p1);
					var v73: seq<int> := [v56, p0];
					var v74: C8 := new C8(v72, seq(abs(0x390), i7  => (v1)), fm16(v56, f29, v73, globalState));
					...
					v82[safeIndex(374, v82.Length)] := v76;
					var v83: array<array<bool>> := new array<bool>[10] [v80, v80, v80, v80, v80, v80, v80, v80, v80, v80];
					v83[safeIndex(764, v83.Length)] := v80;
					var v84: map<multiset<bool>, array<bool>> := map[multiset([f29, f28]) := v80];
					var v85: seq<bool> := [f29];
					var v86: multiset<bool> := multiset{v85[safeIndex(v56, |v85|)]};
					p1[safeIndex(492, p1.Length)], globalState.f1, v82[safeIndex(374, v82.Length)], v83[safeIndex(764, v83.Length)] := -p0, f29, {seq(abs(0xd6), i8  => (v1)), p2} - v76, if (v86 in v84) then v84[v86] else v80;
					globalState.f1, v58, globalState.f11 := f28, 798, safeModuloInt(v56 - p0, v56);
					var v87: map<seq<bool>, bool> := map[[!false, f28] := f29];
					var v88: set<bool> := {f28, !(if (v85 in v87) then v87[v85] else f28)};
					v54[safeIndex(288, v54.Length)] := v88;
					var v89: seq<array<bool>> := [v83[safeIndex(764, v83.Length)], v83[safeIndex(764, v83.Length)]];
					v57, f29, v1, v54[safeIndex(288, v54.Length)] := fm50(|v57|, v58, |v89| > p1[safeIndex(492, p1.Length)], globalState), v85[safeIndex(|"hiys"|, |v85|)], v1, v88;
					f29 := f28;
					var v90: set<seq<bool>> := {v85};
					v83[safeIndex(764, v83.Length)][safeIndex(263, v83[safeIndex(764, v83.Length)].Length)] := !(p0 > v58);
					v90, p1[safeIndex(492, p1.Length)], v83[safeIndex(764, v83.Length)][safeIndex(263, v83[safeIndex(764, v83.Length)].Length)] := v90, p0 + |v57|, !f28;
				}
		...
		for i10 := p0 to p0 - p0 {
			...
			v95[safeIndex(38, v95.Length)] := v96 == v96;
			var v97: seq<int> := [i10];
			var v98: multiset<char> := multiset{v1};
			var v99: map<multiset<char>, int> := map[v98 := i10];
			var v100: map<bool, bool> := map[f29 := f29];
			v95[safeIndex(38, v95.Length)] := v97 < ([v92.f45, fm14(f29, v99, v92.f44, globalState), |v100|, i10, |p2|] + [i10]);
			globalState.f9 := p0;
		}
		for i11 := p0 to safeModuloInt(p0, p0) {
			var v101: multiset<bool> := multiset{f28, f29};
			var v102 := DC26(f28);
			var v103: seq<bool> := [!f29, f29, f29, f29];
			var v104: multiset<int> := multiset{p0};
			var v105: array<bool> := new bool[24] [v101 > v101, f28, true, if (false) then f29 else !false, |[|v0|]| > i11, f29, v102.cf41, v103[safeIndex(p0, |v103|)], f29, f29, false || f28, f28, !f29, f29, false, i11 != i11, f28, f28, fm47(15, f28, |v0|, f28, globalState), f29, !(v104 < v104), false, if (f28) then f28 else f29, !f29];
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			r2 := -p0;
			if (f28) {
				r1, r1 := p0, safeDivisionInt(|map[p0 := f29]|, 43);
				...
				v8 := v8[if (f29) then v6 else v6 := seq(abs(721), i1  => (p0))];
				...
				var v15 := DC23(v14[safeIndex(p0, |v14|)], f29);
				var v16 := 'd';
				...
				v21[safeIndex(831, v21.Length)] := p0 - p0;
				...
				v21[safeIndex(831, v21.Length)] := v24[safeIndex(p0, |v24|)] * -(|v1| + p0);
			}
			...
			var v30: array<seq<bool>> := new seq<bool>[23] [fm63(v26, f29, -p0, globalState) + v1, v1, v1 + v1, ([!f28])[safeIndex(-0x2d2, |[!f28]|) := true] + v1, fm63(v26, f28, -|{f29}|, globalState) + v1, v1, v1, v27[safeIndex(p0, |v27|)], v1 + [f28], v1, v1, v1, v1, v1, v27[safeIndex(p0, |v27|)], v1, [f28], if (fm4(v29, f28, globalState)) then [f28, f28] else v1, v1, v1, v1, v1, v1];
			v30 := v30;
		}
		var v31: map<bool, bool> := map[f29 := f28];
		var v32, v33, v34, v35 := m5(v31, globalState);
		var v36: map<bool, string> := map[f29 := seq(abs(981), i4  => ('p'))];
		var v37 := 'x';
		var v38: seq<string> := [(if (f29 in v36) then v36[f29] else v33)[safeIndex(v32, |(if (f29 in v36) then v36[f29] else v33)|) := v37] + v33];
		v38 := v38 + v38;
		...
		for i5 := v34 to |(v40 - v40)| {
			...
			v33, v42 := v33 + (seq(abs(0x9e), i6  => (v37)))[safeIndex(p0, |(seq(abs(0x9e), i6  => (v37)))|) := v37], v42;
			var v43: array<bool> := new bool[25];
			globalState.f21 := v43;
		}
		var v44: array<array<bool>> := new array<bool>[6];
		var v45: array<bool> := new bool[17];
		v44[safeIndex(629, v44.Length)] := v45;
		v44[safeIndex(629, v44.Length)] := v45;
		var v46: map<array<bool>, int> := map[v44[safeIndex(629, v44.Length)] := v32];
		if ((v46 + v46) != v46) {
			var v47: multiset<bool> := multiset{f28};
			var v48: map<int, multiset<bool>> := map[v34 := v47];
			var v49 := DC24(fm53(f29, f28, false, |v48|, globalState));
			var v50: seq<int> := [v32];
			var v51: seq<int> := [p0, 0x334, v50[safeIndex(|(seq(abs(743), i7  => (p0)))|, |v50|)], p0, p0];
			v34 := safeModuloInt(|(v49.cf39 + v31)|, v50[safeIndex(-v32, |v50|)]);
			...
			match (v54) {
				case DC60() =>
					...
					var v62: array<set<array<bool>>> := new set<array<bool>>[19] [v60 - v60, v60, {v45, v44[safeIndex(629, v44.Length)]}, v60, v60 - v61[safeIndex(p0, |v61|)], {v44[safeIndex(629, v44.Length)]}, {v45, v45}, v60, {v44[safeIndex(629, v44.Length)], v44[safeIndex(629, v44.Length)]}, v60 + v60, v60 + v60, v60, v60, v60, v60 - v60, v60, {v44[safeIndex(629, v44.Length)]}, v60, v60];
					v62[safeIndex(992, v62.Length)] := v60 + {v45, v45};
					v58, v59, v62[safeIndex(992, v62.Length)], v33 := v58, map[multiset(v1 + v1) := |(v1[safeIndex(v32, |v1|) := f28] + v1)|], v60, if (if (if (f29 in v31) then v31[f29] else fm29(v33, v33, p0, v34, globalState)) then f28 else f29) then v33 else seq(abs(146), i8  => (v37));
					globalState.f26 := v34;
				...
				case DC59(cf101) =>
					...
					v32 := safeModuloInt(926, 0x177) - safeModuloInt(v32, if (--v34 in v35) then v35[--v34] else p0);
					...
					var v69 := DC50(v64, v66, f29, set v67 : int | (-679 <= v67) && (v67 < 389) :: (safeDivisionInt(v67, |multiset{p0, v34}|)), v68);
			...
			var v72: map<array<bool>, bool> := map[v44[safeIndex(629, v44.Length)] := f29];
			...
			v74[safeIndex(805, v74.Length)] := v71;
			v74[safeIndex(805, v74.Length)], globalState.f26, r3, v31, r1 := multiset(v51) - v71, safeDivisionInt(0x7a, v32), !true && f28, v31 + v31[f28 := f28], v32;
			globalState.f1 := f29;
			var v75: array<seq<multiset<bool>>> := new seq<multiset<bool>>[8];
			var v76: seq<multiset<bool>> := [v47];
			v75[safeIndex(468, v75.Length)] := v76;
			var v77 := DC35(v38);
			var v78: map<D15, bool> := map[v77 := f29];
			var v79 := DC28(v37, f29, v34, !(if (v77 in v78) then v78[v77] else false), |v47|);
			v75[safeIndex(468, v75.Length)] := fm89(|v35| - v79.cf47, globalState);
		} else {
			...
			if (fm4(map[v85 := !f29], f29, globalState)) {
				...
				v88 := v88[v84.f41 := v32];
				var v89: T1 := new C5(v1[safeIndex(p0, |v1|)], v84.f41);
				...
				v82 := if (safeDivisionInt(p0, -0xe4) in v35) then v35[safeDivisionInt(p0, -0xe4)] else |(if (v80 in v93) then v93[v80] else map[true := v80])|;
			} else {
				...
				r2 := if (v96.f30) then v98[safeIndex(v80, |v98|)] else v80 * v34;
			}
	...
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		...
		if (f28) {
			...
			var v7: array<D15> := new D15[27] [v4, DC36(v3, v5[safeIndex(0x327, |v5|)], v3), v4, v4, DC36(|v6|, v3, v3), DC36(|{f28}|, v3, |map[v0.f46 := v3]|), v4, v4, v4, v4, v4, v4, v4, v4.(cf58 := v3), v4, v4, DC36(v3, 886, -|v5|), v4, v4, v4, DC36(v3, v3, -v3), v4, DC36(v3, v3, v3), v4, v4, v4, v4];
			var v8 := DC17(v2);
			var v9 := 'n';
			...
			v16[safeIndex(51, v16.Length)] := f28;
			var v17: seq<bool> := [v12.f40, v0.f46];
			v16[safeIndex(51, v16.Length)] := v17[safeIndex(0x230, |v17|)] <==> false;
			var v18: multiset<bool> := multiset{false, v0.f46, v16[safeIndex(51, v16.Length)]};
			var v19 := DC27(v18);
			v1, v2, v19 := v1, ("uyvv" + v2)[safeIndex(v3, |("uyvv" + v2)|) := v9] + (v2 + fm30(v0.f46, v3, globalState)), v19;
			v3 := 0x27f;
		} else {
			var v20 := 0x1a1;
			globalState.f26 := v20;
			var v21: map<int, string> := map[v20 := seq(abs(0x15c), i2  => ('n'))];
			var v22 := DC72(v21);
			v21 := v22.cf121;
			...
			var v26 := 'q';
			v25 := v25[v20 := (v24[safeIndex(v0.fm37(v26, f28, -0xc6, globalState), |v24|) := v0.f46] + v24)[safeIndex(-v20, |(v24[safeIndex(v0.fm37(v26, f28, -0xc6, globalState), |v24|) := v0.f46] + v24)|) := f28]];
		...
		var v31 := "kiirmeymj";
		var v32: multiset<seq<bool>> := multiset{v29, v30[safeIndex(-|v31|, |v30|)]};
		globalState.f11 := |v32|;
		var v33 := 0x219;
		...
		for i3 := |v34[f28 := v33]| to v33 {
			var v35 := 'n';
			globalState.f15 := v35;
			var v36: map<seq<bool>, int> := map[v29[safeIndex(|(seq(abs(-799), i4  => ('j')))|, |v29|) := f29] := v33];
			...
			v38, r1, globalState.f1 := if (f28) then v38 - v38 else v39[safeIndex(|v40|, |v39|)] + v38, v42.cf21, if (f29) then f28 else i3 == |(seq(abs(0x2e7), i5  => (v33)))|;
	...
	method m5(p0: map<bool, bool>, globalState: GlobalState) returns (r0: int, r1: string, r2: int, r3: map<int, int>) {
		if (f29) {
			...
			r0 := v6 - safeDivisionInt(|v13|, v6);
			globalState.f3 := new int[1] [v6];
			var v14: array<int> := new int[12](i1 => safeDivisionInt(i1, v6));
			v14[safeIndex(104, v14.Length)] := v6;
			var v15: map<bool, int> := map[f28 := 87];
			var v16 := DC18(f29, if (f28 in v15) then v15[f28] else v6, -v6);
			globalState.f1, globalState.f9, v14[safeIndex(104, v14.Length)], globalState.f26 := v16.cf31, --0x276, v6, v6;
		} else {
			var v17 := 250;
			...
			if (f29 ==> (v18 !! {v17})) {
				...
				var v23: map<bool, int> := map[v21[safeIndex(|v22|, |v21|)] := v17];
				v19 := v19[|[v20]| := |map[v23 := f29]|];
				var v24: set<bool> := {v21[safeIndex(v17, |v21|)], true};
				globalState.f9 := |(v24 + (v24 + {f28, f29}))|;
				f29 := true;
				var v25 := new C5(false, f28 && !f29);
				var v26: multiset<set<int>> := multiset{v18};
				var v27 := new C11((v21 + [false])[safeIndex(v17, |(v21 + [false])|) := f28], v26);
			} else {
				...
				v31[safeIndex(501, v31.Length)] := v28;
				v31[safeIndex(501, v31.Length)] := v28;
				var v32: seq<int> := [v17];
			...
			if (-0x3d9 == v17) {
				...
				var v46 := 'i';
				v45 := [(fm31(f29, v46, globalState))[safeIndex(v17, |fm31(f29, v46, globalState)|) := |(seq(abs(0x333), i3  => (v44)))|]] + v45;
				globalState.f15 := v46;
				...
				var v50 := 'a';
				v49[safeIndex(258, v49.Length)] := ("onjr")[safeIndex(v17, |"onjr"|) := v50];
				var v51 := "js";
				var v52: seq<string> := [v51];
				var v53 := DC37(v17, false, v17, v52);
				v49[safeIndex(258, v49.Length)] := fm50(if (v53.cf60) then v17 else |map[f29 := v17]|, |v51[safeIndex(0x3a8, |v51|) := v50]| + |fm30(f28, v17, globalState)|, -v17 <= v17, globalState);
				globalState.f11 := -v17;
			...
			var v57 := "qbxgy";
			v56[safeIndex(462, v56.Length)] := v57 != v57;
			v56[safeIndex(462, v56.Length)] := -v17 == v17;
		}
		...
		if (fm29(v70, v70, v58, |fm30(f29, v58, globalState)|, globalState)) {
			v58 := v58;
			r0 := 0x3d5 + safeDivisionInt(v58, v58);
			var v71: seq<bool> := [f28];
			var v72: seq<bool> := [f28, |map[f28 := v71[safeIndex(v58, |v71|)]]| == v58, (multiset{v58})[v58 := abs(if (v58 in v60) then v60[v58] else v58)] !! multiset{v58, -fm24(f29, v58, globalState)}, f28];
			v72 := v72;
			...
			var v78: map<map<array<int>, array<bool>>, set<bool>> := map[v75 + v76[safeIndex(|v72|, |v76|)] := v77];
			...
			if (f29) {
				...
				v80[safeIndex(551, v80.Length)] := v69;
				v80[safeIndex(551, v80.Length)] := v69;
			...
			if (f29) {
				...
				var v98 := 'o';
				var v99: map<int, map<bool, bool>> := map[v58 := v97[safeIndex(|fm63(v98, f29, v58, globalState)|, |v97|)]];
				var v100: array<int> := new int[11] [v58, v58, safeDivisionInt(v58, v58), v58, |v91|, v58, v58, v58, if (f28) then v58 else v58, -|(v95 * v96.cf130)|, |v99|];
				globalState.f3 := v100;
				...
				v104 := (v104 + v104) + v104[safeIndex(v58, |v104|) := v103];
				var v105: array<int> := new int[19];
				v105[safeIndex(877, v105.Length)] := v58;
				var v106: seq<bool> := [f28];
				v105[safeIndex(877, v105.Length)] := |((if (!!f28) then v106 else [f29]) + v106)|;
				var v107: array<C9> := new C9[25];
				var v108 := 'n';
				var v109: C9 := new C9(fm47(0x1e6, false, |multiset{v108}|, f29, globalState));
				v107[safeIndex(145, v107.Length)] := v109;
				var v110: set<array<int>> := {v105, v105, v105, v105, v105};
				var v111 := DC51(f29, v108, v64, v58, false);
				v107[safeIndex(145, v107.Length)], v110, v60, v105[safeIndex(877, v105.Length)] := v109, v110, v60 + multiset(fm31(!f29, 'f', globalState)), v111.cf88;
				globalState.f7 := v62 - v62;
				var v112: array<multiset<int>> := new multiset<int>[16];
				v112[safeIndex(464, v112.Length)] := v60[v58 := abs(0x289)] - v60;
				v112[safeIndex(464, v112.Length)] := v60;
			}
		...
		if (f29) {
			...
			r0 := safeDivisionInt(fm14(f28, map[fm90(seq(abs(-0x2d0), i8  => ('p')), fm32(globalState), globalState) := |(if (f28 in v117) then v117[f28] else v70)|], f28, globalState), |multiset{!f29}| - -v58);
			if (if (f28 in p0) then p0[f28] else f28) {
				...
				v120[safeIndex(146, v120.Length)] := v121[safeIndex(|v70|, |v121|)];
				v120[safeIndex(146, v120.Length)] := if (f28 in p0) then p0[f28] else f29;
				var v122 := new C10();
				var v123: array<int> := new int[10];
				v123[safeIndex(248, v123.Length)] := v58;
				v123[safeIndex(248, v123.Length)] := v58;
			} else {
				var v124: seq<seq<int>> := [v69 + v69, v69, DC13(v69).cf26 + v69];
				v69 := v124[safeIndex(v58, |v124|)];
				...
				globalState.f11 := fm14(f28, if (v58 in v134) then v134[v58] else if (v58 in v134) then v134[v58] else v133, f28, globalState) - -safeDivisionInt(|v69|, v58);
				globalState.f1 := f28;
			}
			
		} else {
			var v135: array<bool> := new bool[21];
			v135[safeIndex(155, v135.Length)] := f29;
			v135[safeIndex(155, v135.Length)] := !f28;
			var v136 := 'e';
			...
			v137 := v137;
			var v138: set<bool> := {!v135[safeIndex(155, v135.Length)]};
			var v139 := DC55(v135[safeIndex(155, v135.Length)], v135[safeIndex(155, v135.Length)], f28, f29);
			var v140 := DC12(true, (map[|v70| := v58])[v58 := |v138|], v139.cf97, v58, -v58);
			var v141: seq<bool> := [true, f28, f29];
			v140 := if (f28) then fm91(v135[safeIndex(155, v135.Length)], v60, v141[safeIndex(v58, |v141|)], v135[safeIndex(155, v135.Length)], globalState) else v140;
		}
		
		var v142: array<int> := new int[8](i9 => i9 - v58);
		v142[safeIndex(150, v142.Length)] := v58;
		v142[safeIndex(401, v142.Length)] := |("rrxt")[safeIndex(v58, |"rrxt"|) := 'e']|;
		var v143: seq<bool> := [f28, f28, f29];
		v142[safeIndex(756, v142.Length)] := -|(v143 + v143)|;
		v142[safeIndex(150, v142.Length)], globalState.f7, v142[safeIndex(401, v142.Length)], globalState.f26, v142[safeIndex(756, v142.Length)] := v58, v62, safeDivisionInt(if (v58 in v68) then v68[v58] else -|p0|, 0xe6), (v69[safeIndex(v58, |v69|)] - v58) + (v58 * v58), v58 - |p0|;
		var v144: seq<string> := [v70];
		var v145: map<bool, int> := map[!f29 := |(v144 + v144)|];
		var v146 := 'n';
		r0 := if ((v146 in v70) in v145) then v145[v146 in v70] else v58;
		r1 := seq(abs(850), i10  => (v146));
		r2 := safeDivisionInt(v58, v142[safeIndex(150, v142.Length)]);
		var v147: seq<map<int, int>> := [v68, v68];
		r3 := v147[safeIndex(v142[safeIndex(150, v142.Length)], |v147|)];
	}
}
...
class C14 extends T0, T1 {
	...
	function fm0(p0: int, p1: bool, globalState: GlobalState): int {
		0x1ba - safeModuloInt(|(seq(abs(0x2ed), i0  => (|map[map[|['y']| := 0x80] := f28]|)))|, 0x2be)
	}
	function fm3(globalState: GlobalState): int {
		|multiset{0x31c, |{0x3a5}|, -83}| - |(seq(abs(0x364), i0  => ('o')))|
	}
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		globalState.f6 := -0x29f;
		var v0 := DC0(-DC0(|(seq(abs(0x31f), i0  => ('l')))|).cf0);
		v0 := v0;
		var v1 := 't';
		...
		for i1 := p0 + |"ffgggcbs"| to 0x35e {
			...
			v7[safeIndex(525, v7.Length)] := v2.f47;
			var v8: set<seq<bool>> := {[v3.f46, v3.f46, v3.f46]};
			globalState.f1, v5, globalState.f1, v6, v7[safeIndex(525, v7.Length)] := v3.f46, (v5 + v5) + (v5 + v5), v8 >= v8, p2, v1;
			var v9: seq<bool> := [true];
			var v10: map<int, int> := map[p0 := safeDivisionInt(i1, |v9|)];
			...
			v10 := v10[safeDivisionInt(DC9(p0, f28).cf17, p0) := safeModuloInt(p0, |v13|)];
			var v14: map<int, bool> := map[i1 := true];
			var v15: seq<int> := [|v14|];
			if (if (f28) then !(if (f28) then v12.f32[safeIndex(i1, |v12.f32|)] else v3.f46) else fm16(p0, f28, v15, globalState)) {
				var v16 := DC28(v2.f47, v3.f46, -fm48(|v6|, v3.f46, globalState), v3.f46, i1);
				globalState.f11 := v16.cf47 * p0;
				var v17 := DC59(seq(abs(0x5b), i2  => (map[DC45(p0, p0, v3.f46, |(seq(abs(0x371), i3  => (p0)))|).cf73 := i1])));
				...
				v23[safeIndex(846, v23.Length)] := v6;
				globalState.f6, v23[safeIndex(846, v23.Length)] := v21 - i1, p2;
				var v24: multiset<array<int>> := multiset{p1};
				var v25 := DC11(multiset{p1} * v24);
				var v26: array<bool> := new bool[5](i4 => v3.f46);
				v26[safeIndex(613, v26.Length)] := f28;
				v6, v25, v26[safeIndex(613, v26.Length)], globalState.f1 := seq(abs(0x1f5), i5  => (v2.f47)), v25, v3.f46, v3.f46;
				var v27: map<bool, int> := map[v3.f46 := v21];
				var v28 := new C5(v27 != v27, v26[safeIndex(613, v26.Length)]);
				var v29 := DC18(v22, i1, v15[safeIndex(i1, |v15|)]);
				globalState.f9, globalState.f9, v6, v20 := v29.cf33, -p0 * safeDivisionInt(|map[i1 := p0]|, v20), "vysftie", v21;
			}
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
		...
		for i0 := p0 to 633 {
			...
			globalState.f26 := -(if (true in v1) then v1[true] else safeDivisionInt(-p0, if (v0 in v3) then v3[v0] else fm0(i0, f28, globalState)));
			var v4: set<bool> := {!f28};
			v4 := v4 - v4;
			var v5 := DC54(|(seq(abs(0x1fa), i1  => (v0)))|, 0x2a5);
		...
		var v16 := DC47(v15);
		v16 := v16;
		v13[safeIndex(667, v13.Length)] := p0;
		v13[safeIndex(667, v13.Length)] := -p0;
		var v17: seq<array<int>> := [v13];
		globalState.f1 := v17 == [v13, v13];
		var i2 := 0;
		while ((if (f28) then p0 else p0) == (v13[safeIndex(667, v13.Length)] - p0))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			i2 := i2 + 1;
			var v18: set<seq<int>> := {v8[safeIndex(v13[safeIndex(667, v13.Length)], |v8|) := p0]};
			var v19 := DC69(v18);
			match (v19) {
				case DC70(cf115, cf116, cf117, cf118, cf119) =>
					...
					var v23: array<D25> := new D25[26] [DC62(v13[safeIndex(667, v13.Length)], v21, false, f28, v11), v22, DC62(-v13[safeIndex(667, v13.Length)], v21, cf117, cf119, v11), v22, v22, v22, v22, v22, v22.(cf107 := v11, cf106 := cf117), v22, v22, if (f28) then v22 else v22, v22, DC62(p0, v21, cf119, cf117, v11), v22, v22, v22, v22, v22, v22, DC62(v13[safeIndex(667, v13.Length)], v21, cf117, cf117, v11).(cf105 := cf119), v22, v22, v22.(cf105 := f28, cf107 := v11, cf103 := v13[safeIndex(667, v13.Length)]), v22, v22];
					var v24: map<bool, int> := map[cf119 := v13[safeIndex(667, v13.Length)]];
					var v25: map<bool, string> := map[fm11(seq(abs(900), i3  => (v11)), globalState) := v7];
					v23, cf117, globalState.f21, globalState.f26 := v23, !f28, v20, (if (cf119 in v24) then v24[cf119] else -0x20) * (if (cf119) then |v25| else v13[safeIndex(667, v13.Length)]);
					var v26: map<bool, bool> := map[f28 := cf119];
					var v27: multiset<int> := multiset{-p0, p0};
					v26 := v26[DC5(cf117, v27, -|[v13[safeIndex(667, v13.Length)], |"fa"|]|).cf7 := true];
					v13[safeIndex(667, v13.Length)] := --((if (p0 in v27) then v27[p0] else p0) - v13[safeIndex(667, v13.Length)]);
					v24 := v24[cf117 := p0];
				case DC69(cf114) =>
					v11 := v11;
					var v28: array<char> := new char[5] [v11, v11, v11, v11, v11];
					v28[safeIndex(354, v28.Length)] := v11;
					v28[safeIndex(354, v28.Length)] := v11;
					var v29: map<int, int> := map[v13[safeIndex(667, v13.Length)] := p0];
					v13[safeIndex(667, v13.Length)] := if (p0 in v29) then v29[p0] else -v13[safeIndex(667, v13.Length)];
					globalState.f1 := !f28;
			}
			...
			v33 := v33;
			v7 := (v7 + v7[safeIndex(|map[f28 := f28]|, |v7|) := v11]) + "ce";
		}
		r0 := v11;
		r1 := p0;
		r2 := v8[safeIndex(v13[safeIndex(667, v13.Length)] + v13[safeIndex(667, v13.Length)], |v8|)];
		r3 := f28;
	}
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			var v4 := -0x286;
			v0[safeIndex(369, v0.Length)] := v3[safeIndex(v4, |v3|)];
			v0[safeIndex(369, v0.Length)] := v2;
			globalState.f15 := v1;
			var v5: seq<bool> := [f28, false];
			var v6: set<seq<bool>> := {[f28, false], v5};
			var v7: array<bool> := new bool[2] [v6 > v6, !f28];
			v7[safeIndex(657, v7.Length)] := if (false) then f28 else !f28;
			...
			v7[safeIndex(657, v7.Length)] := if (v8 in v10) then v10[v8] else f28;
		}
		var v11 := 0x378;
		var v12: multiset<int> := multiset{v11};
		match (DC5(f28, v12, v11)) {
			case DC4(cf4, cf5, cf6) =>
				var v13: array<int> := new int[15](i2 => safeDivisionInt(i2, v11));
				...
				match (v15) {
					case DC12(cf21, cf22, cf23, cf24, cf25) =>
						...
						v16 := v16;
						var v17 := "xh";
						v17 := v17 + v17[safeIndex(cf25, |v17|) := 'o'];
						var v18 := 'k';
						v17 := ("pbxwgmosb")[safeIndex(|"mqyrecur"|, |"pbxwgmosb"|) := v18];
					...
					case DC11(cf20) =>
						...
						var v26: array<bool> := new bool[17] [cf6, cf4, f28, false, cf6, (set v20 : int | (0x2cb <= v20) && (v20 < 0xff) :: (safeDivisionInt(v20, v11))) > v21, !f28, f28, cf4, v22 !in v23, cf4, v23 != v23, cf4, v23 <= v23, !(v24 <= v24), multiset{v21, {-cf5}} <= v25, cf4];
						var v27: map<char, bool> := map[v22 := cf4];
						v26[safeIndex(462, v26.Length)] := if ('o' in v27) then v27['o'] else cf4;
						v26[safeIndex(462, v26.Length)] := cf6;
						v26[safeIndex(462, v26.Length)] := cf4;
						...
						globalState.f26, v26[safeIndex(462, v26.Length)], v13 := |((v30[safeIndex(cf5, |v30|)] * v29) - v29)|, cf4, v13;
						var v31: multiset<bool> := multiset{v26[safeIndex(462, v26.Length)], cf4};
				...
				globalState.f3 := new int[22] [if (f28) then 318 else cf5, 0xda, |(v38 + v38)|, 0xfc, if (cf4 in v42) then v42[cf4] else |v43|, v11, v11, cf5, DC38(0x18f, v11).cf63 * v11, safeDivisionInt(cf5, |v33[safeIndex(|v48|, |v33|) := cf4]|), v44.f39, v11 + v44.f39, |(v50 + v50)|, if (cf6) then v11 else cf5, if (cf6) then cf5 else v44.f39, safeModuloInt(v11, cf5), v34[safeIndex(-v44.f39, |v34|)], v11, if (f28) then cf5 else |v33|, if (cf5 in v12) then v12[cf5] else |"odxgfftl"|, 0x130, if (f28) then |v51| else -v11];
			case DC5(cf7, cf8, cf9) =>
				if (!cf7) {
					var v52: array<int> := new int[15](i4 => i4 + v11);
					var v53: seq<array<int>> := [v52];
					var v54: map<bool, array<int>> := map[f28 := v52];
					var v55: set<array<int>> := {v53[safeIndex(if (v11 in cf8) then cf8[v11] else v11, |v53|)], if (cf7 in v54) then v54[cf7] else v52, if (!cf7) then v52 else v52, v52};
					var v56: map<bool, set<array<int>>> := map[cf7 := v55];
					v55 := {v52, v52} - (v55 + (if (cf7 in v56) then v56[cf7] else v55));
					v52[safeIndex(124, v52.Length)] := safeModuloInt(v11, cf9);
					var v57: seq<int> := [v11];
					v52[safeIndex(307, v52.Length)] := fm24(fm16(cf9, cf7, v57, globalState), v11, globalState);
					var v58: C5 := new C5(cf7, f28);
					var v59: map<C5, bool> := map[v58 := cf7];
					var v60: seq<map<C5, bool>> := [v59];
					v52[safeIndex(124, v52.Length)], cf7, globalState.f1, globalState.f1, v52[safeIndex(307, v52.Length)] := v11, v60 == v60, cf7, cf7, -(safeDivisionInt(-cf9, cf9) * v11);
					var v61 := new C4(v57 != v57);
					var v62: seq<bool> := [f28];
					var v63 := 'e';
					var v64: map<char, int> := map[v63 := v52[safeIndex(124, v52.Length)]];
					var v65 := "aj";
					var v66: seq<string> := [v65, seq(abs(953), i5  => (v63))];
					var v67: seq<string> := [v66[safeIndex(v52[safeIndex(124, v52.Length)], |v66|)]];
					var v69: set<seq<int>> := {v57, v57};
					v52[safeIndex(124, v52.Length)], v62, cf9, globalState.f26, globalState.f1 := if (!v58.f40) then v52[safeIndex(124, v52.Length)] else v57[safeIndex(v11, |v57|)], v62, v57[safeIndex(cf9, |v57|)], (if (v63 in v64) then v64[v63] else v11) + v11, -|v67[safeIndex(|(map v68 : seq<int> | v68 in v69 :: (v68) := (v58.f40))|, |v67|)]| < |cf8|;
					var v70 := new C3(f28, safeModuloInt(v52[safeIndex(124, v52.Length)], v11));
				} else {
					...
					v77[safeIndex(383, v77.Length)] := map[fm8(v74, globalState) := f28];
					v77[safeIndex(383, v77.Length)] := v73;
				...
				if (cf7) {
					...
					v80[safeIndex(439, v80.Length)] := fm3(globalState) - fm24(f28, v11, globalState);
					v80[safeIndex(439, v80.Length)] := 0x262;
					var v81: array<bool> := new bool[6];
					var v82: seq<int> := [v80[safeIndex(439, v80.Length)]];
					var v84: set<int> := {cf9};
					v81[safeIndex(468, v81.Length)] := (set v83 : int | v83 in v82 :: (v83 + |"wfaqdjsjo"|)) > v84;
					v81[safeIndex(468, v81.Length)] := cf7;
					var v85 := new C0(v81[safeIndex(468, v81.Length)]);
					var v86 := new C0(cf7);
				} else {
					var v87 := 'h';
					var v88 := "pdtd";
					...
					v91[safeIndex(834, v91.Length)] := v92;
					v91[safeIndex(834, v91.Length)] := v92;
				...
				if (cf7) {
					...
					v96[safeIndex(690, v96.Length)] := v11;
					v96[safeIndex(690, v96.Length)] := cf9;
					v95 := ((seq(abs(723), i7  => (|"dxlekrauc"|))) + (if (f28) then v95 else v95))[safeIndex(v96[safeIndex(690, v96.Length)], |((seq(abs(723), i7  => (|"dxlekrauc"|))) + (if (f28) then v95 else v95))|) := v96[safeIndex(690, v96.Length)]];
					var v97 := 'x';
					var v98: map<char, array<int>> := map[v97 := v96];
					v96[safeIndex(690, v96.Length)], r2 := safeDivisionInt(cf9, v11), safeDivisionInt(cf9 - |v98|, cf9);
					globalState.f11 := cf9;
				} else {
					...
					var v105 := DC45(|v101|, -|v102.cf30|, f28, |(map v103 : int | v103 in v104 :: (safeDivisionInt(v103, |v100|)) := (cf7))|);
					var v106: map<int, bool> := map[v11 := f28];
					var v107: array<bool> := new bool[23](i8 => false);
					var v108: map<array<bool>, int> := map[v107 := v11];
					var v109: array<bool> := new bool[12] [v11 <= cf9, cf7, cf7, v12 !! multiset{|v99|, |v100|}, cf7, v101 == v101, f28, !f28, !((v105.(cf71 := cf9, cf72 := |v106|, cf74 := v11)).cf71 >= |v108|), cf7, f28, v99[safeIndex(v11, |v99|)]];
					v109[safeIndex(500, v109.Length)] := true;
					v109[safeIndex(500, v109.Length)] := f28;
					var v110: array<seq<bool>> := new seq<bool>[1](i9 => v99 + DC6(-v11, cf9, v99).cf12);
					v110[safeIndex(142, v110.Length)] := [false];
					var v111 := "elbec";
					var v112 := 'v';
					v110[safeIndex(142, v110.Length)], v111, globalState.f11 := v99, ("dxx" + (seq(abs(-0x2ed), i10  => ('u'))))[safeIndex(v104[safeIndex(cf9, |v104|)], |("dxx" + (seq(abs(-0x2ed), i10  => ('u'))))|) := v112], cf9;
					var v113: multiset<multiset<int>> := multiset{v12, v12[0x39d := abs(v11)], cf8, v12};
					var v114: map<int, int> := map[|v113| := -v11];
					r2 := if (cf7 <==> v99[safeIndex(v11, |v99|)]) then if (cf9 in v114) then v114[cf9] else v11 else v11;
					var v115: T1 := new C7(f28, cf7, v109[safeIndex(500, v109.Length)]);
					var v116: map<T1, bool> := map[v115 := f28];
					var v117: map<set<int>, bool> := map[{v11} := v109[safeIndex(500, v109.Length)]];
					v116 := v116[v115 := v99[safeIndex(|v117|, |v99|)]];
					v111 := v111;
				}
				...
				var v121: array<bool> := new bool[28] [f28, cf7, cf7, f28, cf7, false, f28, cf7, fm16(0x10, cf7, v118, globalState), cf7, true, f28, f28, cf7, f28, f28, f28, cf7, cf7, f28, cf7, f28, cf7, if (f28 in v119) then v119[f28] else cf7, cf7, v120[safeIndex(v11, |v120|)], f28, cf7];
				var v122 := DC23(v121, f28);
				cf7 := v122.cf38 ==> cf7;
			case DC6(cf10, cf11, cf12) =>
				var v123 := "scy";
				var v124 := 'a';
				globalState.f9, v123, globalState.f1, globalState.f1 := 0x2f1, v123[safeIndex(|v123|, |v123|) := v124], if (f28) then f28 else f28, if (f28) then f28 else f28;
				v123 := v123;
				...
				if (v127.cf18 <== f28) {
					...
					globalState.f26 := -cf10;
					var v131: seq<int> := [safeDivisionInt(cf10, cf10)];
					r2 := |v131|;
					var v132: map<multiset<bool>, bool> := map[multiset{f28} := f28];
					var v133: multiset<bool> := multiset{false, f28, f28};
					v132 := v132[v133 - v133[f28 := abs(v11)] := if (!f28) then f28 else f28];
					...
					v136[safeIndex(936, v136.Length)] := "glocpffx" + (seq(abs(0x1e5), i12  => (v124)));
					v136[safeIndex(936, v136.Length)] := v123;
					var v137: array<bool> := new bool[2];
					v137[safeIndex(545, v137.Length)] := v134.f40;
					var v139: set<char> := {'h'};
					var v140: T0 := new C12(v134.f40, v11);
					var v141: multiset<T0> := multiset{v140, v140};
					var v142: map<bool, multiset<T0>> := map[f28 := v141];
					globalState.f1, v137[safeIndex(545, v137.Length)] := if (!v134.f40 in v125) then v125[!v134.f40] else (set v138 : char | v138 in [v124] :: (v138)) > v139, v142 == v142;
					globalState.f26 := v11;
				}
			...
			case DC3(cf3) =>
				...
				if (f28) {
					...
					var v148 := "y";
					var v149: multiset<char> := multiset{v148[safeIndex(v11, |v148|)], cf3, cf3};
					...
					var v155: array<int> := new int[27] [v11, v11, v11, 0x28, |v143[safeIndex(v11, |v143|) := f28]|, v11, |(set v145 : D33 | v145 in {v144, v144} :: (v145))| + 0x2a9, v11 - |v146|, v147[safeIndex(v11, |v147|)], |v149|, v11, v11, |v148|, if (v143 in v150) then v150[v143] else v11, fm24(f28, -v11, globalState), |(if (false) then v152[safeIndex(v11, |v152|)] else [v148])|, v11, |v153|, |({[f28, f28], v143} - v154)|, v11, v11, v11 + v11, -903, v11, v11, |[f28, f28, !f28, f28]|, |(seq(abs(0x3cb), i13  => (cf3)))|];
					v155[safeIndex(759, v155.Length)] := fm14(f28, map[v149 := v11], f28, globalState);
					v155[safeIndex(759, v155.Length)] := v11;
					var v156: array<bool> := new bool[12] [f28, f28, f28, f28, f28, true, f28, f28, f28, f28, fm8(map[v155[safeIndex(759, v155.Length)] := f28], globalState), f28];
					var v157: map<int, array<bool>> := map[v11 := v156];
					globalState.f6 := |(v157 + (v157 + v157))|;
					r1 := fm29(v148[safeIndex(v155[safeIndex(759, v155.Length)], |v148|) := 'c'] + v148, v148 + v148, v155[safeIndex(759, v155.Length)], |v148|, globalState);
					var v158: array<string> := new string[14];
					v158[safeIndex(141, v158.Length)] := v148;
					v158[safeIndex(141, v158.Length)] := (v148 + (seq(abs(207), i14  => (cf3)))) + v148;
					var v159: map<bool, int> := map[f28 := v155[safeIndex(759, v155.Length)]];
					globalState.f1 := v143[safeIndex(safeDivisionInt(|v159|, v11), |v143|)];
				} else {
					globalState.f1 := !(if (v11 < v11) then f28 else f28);
					var v160: array<int> := new int[20](i15 => i15 * v11);
					v160[safeIndex(820, v160.Length)] := -v11;
					v160[safeIndex(820, v160.Length)] := v11;
					globalState.f1 := f28;
					var v161: array<char> := new char[12](i16 => cf3);
					v161[safeIndex(915, v161.Length)] := cf3;
					var v162 := "xiuhawu";
					var v163: multiset<string> := multiset{v162};
					var v164: seq<int> := [v11];
					var v165 := DC17(v162);
					var v166: set<int> := {v160[safeIndex(820, v160.Length)]};
					var v167: multiset<set<int>> := multiset{{v160[safeIndex(820, v160.Length)]}, v166};
					var v168: set<seq<int>> := {v164, [v160[safeIndex(820, v160.Length)]], [|v165.cf30|, |v167|], v164 + [v11, v160[safeIndex(820, v160.Length)], fm3(globalState)], v164};
					v161[safeIndex(915, v161.Length)], globalState.f26, v163, globalState.f15, globalState.f9 := cf3, v160[safeIndex(820, v160.Length)] + v160[safeIndex(820, v160.Length)], (v163 + v163) * v163, 'c', |v168|;
					r1 := f28;
				}
				...
				if (f28) {
					...
					v181 := v181[safeDivisionInt(fm3(globalState), v11) := v180];
				} else {
					globalState.f1 := f28;
					var v182 := DC34();
					...
					v185[safeIndex(123, v185.Length)] := v11;
					var v186 := "kmijhivdb";
					var v187: array<char> := new char[19] [cf3, cf3, cf3, cf3, cf3, cf3, cf3, cf3, v186[safeIndex(|v186|, |v186|)], cf3, cf3, cf3, if (f28) then cf3 else cf3, cf3, cf3, cf3, cf3, cf3, fm32(globalState)];
					v187[safeIndex(143, v187.Length)] := cf3;
					...
					cf3, v185[safeIndex(123, v185.Length)], globalState.f6, globalState.f26, v187[safeIndex(143, v187.Length)] := 'k', v11, v11 * v11, if (fm14(f28, v188, v189.cf50, globalState) in v12) then v12[fm14(f28, v188, v189.cf50, globalState)] else if (!f28 in v190) then v190[!f28] else v11, cf3;
					r1 := f28;
					globalState.f9, r1 := |v186|, f28;
					var v191 := new C12(false, v185[safeIndex(123, v185.Length)]);
				}
		...
		for i19 := v11 to v11 * v11 {
			...
			if (v195 > v195) {
				...
				var v202: array<map<int, map<bool, D20>>> := new map<int, map<bool, D20>>[19](i20 => if (f28) then map[i19 := map[f28 := DC48(map v201 : seq<int> | v201 in [v192] :: (v201) := ('q'))]] else map[v11 := map[f28 := DC48(map[seq(abs(-0x2fa), i21  => (v11)) := 's'])]]);
				var v203 := "rfg";
				...
				var v220: array<int> := new int[27] [|v203|, i19 + v11, -(v11 - i19), i19, |[f28, false]|, -0x226, v11 + |v211|, v11, i19, |v212|, i19, v11, safeModuloInt(i19, |[v213]|), |(v203 + v203)|, i19, i19, i19, if (v206 in v214) then v214[v206] else i19, fm14(f28, v216, f28, globalState), |v211|, i19, -|v218|, safeModuloInt(v11, v11), v11, v11, -|v219|, safeDivisionInt(fm48(v11, f28, globalState), |v203|)];
				v220[safeIndex(520, v220.Length)] := 0x2d5;
				v220[safeIndex(520, v220.Length)] := v11;
				var v221 := new C0(f28);
				globalState.f1 := v221.f46 ==> f28;
				var v222: array<string> := new seq<char>[7](i23 => (seq(abs(97), i24  => (v206))) + v203);
				v222[safeIndex(729, v222.Length)] := v203;
				v222[safeIndex(729, v222.Length)] := v203[safeIndex(if (f28) then i19 else v220[safeIndex(520, v220.Length)], |v203|) := v206];
			}
...
class C15 extends T0, T1 {
	...
	method m0(p0: int, p1: array<int>, p2: string, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		...
		if (if (|v1| > p0) then f28 else f28) {
			if (f28) {
				...
				p1[safeIndex(935, p1.Length)] := |v2|;
				r0, globalState.f9, globalState.f11, p1[safeIndex(935, p1.Length)], globalState.f1 := f28, p0, p0 - p0, |p2|, true;
				var v3: map<int, bool> := map[p0 := fm1(p1[safeIndex(935, p1.Length)], globalState)];
				var v4: set<int> := {p1[safeIndex(935, p1.Length)]};
				var v5 := DC0(p1[safeIndex(935, p1.Length)]);
				var v6: map<int, int> := map[v5.cf0 := 0x2b7];
				var v7: multiset<bool> := multiset{f28};
				var v8: array<int> := new int[13] [p1[safeIndex(935, p1.Length)], |p2|, p1[safeIndex(935, p1.Length)], |v4|, p1[safeIndex(935, p1.Length)], |v1|, if (v5.cf0 in v6) then v6[v5.cf0] else p0, -p0, 338, p1[safeIndex(935, p1.Length)], if (fm1(p1[safeIndex(935, p1.Length)], globalState) in v7) then v7[fm1(p1[safeIndex(935, p1.Length)], globalState)] else p0, p0, p0];
				var v9: map<array<int>, int> := map[v8 := -0x1e2];
				v3 := v3[if (v8 in v9) then v9[v8] else |(seq(abs(0xef), i2  => (|v6|)))| := f28];
			} else {
				r0 := f28;
				...
				globalState.f9 := safeModuloInt(|v16|, 753);
			...
			var v26: map<string, bool> := map[seq(abs(0x29a), i3  => (v21)) := p0 !in v25[safeIndex(p0, |v25|)]];
			v26 := v26;
			var v27 := DC0(|v20|);
			...
			var v32: C3 := new C3(p0 < p0, fm48(if (v30 in v31) then v31[v30] else |(seq(abs(136), i4  => (v21)))|, f28, globalState) + p0);
			v32 := v32;
		} else {
			v0[safeIndex(600, v0.Length)] := true;
			var v33: array<set<int>> := new set<int>[14];
			var v34: map<bool, bool> := map[f28 := f28];
			var v35: set<int> := {|v34|, p0, p0};
			v33[safeIndex(635, v33.Length)] := v35;
			var v36: map<bool, int> := map[f28 := p0];
			var v37: array<C9> := new C9[10];
			var v38: C9 := new C9(f28);
			v37[safeIndex(71, v37.Length)] := v38;
			var v39: array<map<bool, bool>> := new map<bool, bool>[26];
			var v40 := DC6(|(seq(abs(-0x368), i5  => (p0)))|, p0, [v38.f34, v38.f34]);
			var v41: multiset<int> := multiset{p0};
			var v42 := DC50(v39, v40, !!false, v35, v41);
			var v43: seq<set<int>> := [v35, v35, fm40(false, globalState), v35];
			globalState.f9, v0[safeIndex(600, v0.Length)], v33[safeIndex(635, v33.Length)], v36, v37[safeIndex(71, v37.Length)] := safeModuloInt(0x22e, 0x10a), v35 > fm27(globalState), (v42.cf83 * fm27(globalState)) + v43[safeIndex(|v1|, |v43|)], if (v38.f34) then v36 else v36, v38;
			globalState.f11 := p0 - -p0;
			r0 := v0[safeIndex(600, v0.Length)];
		...
		if (!f28) {
			...
			globalState.f26 := -p0;
			p1[safeIndex(941, p1.Length)] := -v46.f45;
			var v47: set<int> := {p0};
			r0, globalState.f1, p1[safeIndex(941, p1.Length)] := v46.f44 ==> f28, |v1| < p0, safeModuloInt(|v47|, safeModuloInt(-p0, v46.f45));
			var v48: array<array<int>> := new array<int>[13];
			var v49: array<int> := new int[2];
			v48[safeIndex(274, v48.Length)] := v49;
			v48[safeIndex(274, v48.Length)] := v49;
			var v50: array<seq<bool>> := new seq<bool>[3];
			v50[safeIndex(193, v50.Length)] := v1;
			var v51: multiset<bool> := multiset{v46.f44, v46.f44, true, false, f28};
			v50[safeIndex(193, v50.Length)], r0 := v1, v46.fm35(229, v51, v51 > v51, v47, globalState);
		} else {
			p1[safeIndex(712, p1.Length)] := p0;
			var v52 := 'o';
			var v53: map<seq<bool>, string> := map[v1 := p2];
			globalState.f6, globalState.f15, p1[safeIndex(712, p1.Length)], r1, r0 := 0x111, v52, -p0, v0, v52 !in ((if (v1 in v53) then v53[v1] else p2) + p2);
			if (true) {
				globalState.f1 := !f28 <==> f28;
				r0 := f28;
				var v54 := new C9(f28);
				...
				v55 := new string[15];
				v0[safeIndex(421, v0.Length)] := f28;
				v0[safeIndex(421, v0.Length)] := v54.f34;
			} else {
				globalState.f15 := v52;
				p1[safeIndex(712, p1.Length)] := p1[safeIndex(712, p1.Length)];
				p1[safeIndex(712, p1.Length)] := p1[safeIndex(712, p1.Length)];
				r0 := f28;
				var v56 := new C14(!f28);
			}
			
			globalState.f26 := -(p1[safeIndex(712, p1.Length)] - p1[safeIndex(712, p1.Length)]);
			var v57 := "yjddi";
			v57 := p2;
			var v58: map<bool, bool> := map[f28 := f28];
			var v59 := DC46(p0, p1[safeIndex(712, p1.Length)]);
		...
		if (true) {
			...
			var v62: seq<seq<bool>> := [(([!f28, true, f28])[safeIndex(p0, |[!f28, true, f28]|) := f28])[safeIndex(|p2|, |([!f28, true, f28])[safeIndex(p0, |[!f28, true, f28]|) := f28]|) := !!f28], v1, fm63(fm15(globalState), f28, p0, globalState), v1[safeIndex(|p2|, |v1|) := f28], fm63(fm32(globalState), f28, p0, globalState)];
			var v63 := 'f';
			var v64 := DC62(|v62[safeIndex(p0, |v62|)]|, v60.(cf37 := v0), !f28, f28, v63);
			match (v64) {
				...
				case DC61(cf102) =>
					v0[safeIndex(842, v0.Length)] := |fm28(0x207, -p0, p2, globalState)| <= p0;
					v0[safeIndex(842, v0.Length)] := f28;
					var v67 := "anckpywoq";
					v67, v0[safeIndex(842, v0.Length)] := p2, f28;
					r0 := true;
					var v68: array<string> := new string[21](i6 => p2[safeIndex(-928, |p2|) := 's']);
					v68[safeIndex(603, v68.Length)] := "vl";
					var v69: array<seq<int>> := new seq<int>[1](i7 => [0x98] + [|v1|, 0x141]);
					v69[safeIndex(207, v69.Length)] := seq(abs(67), i8  => (p0));
					var v70: seq<int> := [|v1|];
					var v72: seq<int> := [p0, |v70|, p0, |(map v71 : int | (-0x1be <= v71) && (v71 < 0x39f) :: (v71 + |map[false := 0x251]|) := (p0))|, p0];
					v68[safeIndex(603, v68.Length)], v69[safeIndex(207, v69.Length)] := fm18(globalState), v72 + v72;
				case DC63(cf108) =>
					var v73: array<map<bool, bool>> := new map<bool, bool>[24](i9 => map[f28 := f28]);
					var v74: map<char, bool> := map[v63 := !f28];
					var v75: seq<int> := [|v74|, p0, |(seq(abs(0x1d8), i10  => (|(seq(abs(0x324), i11  => (v63)))|)))|];
					var v76 := DC6(v75[safeIndex(p0, |v75|)], p0, v1);
			...
			if (f28) {
				...
				var v83 := DC0(if ((seq(abs(-0x140), i12  => (v63))) in v82) then v82[seq(abs(-0x140), i12  => (v63))] else p0);
				var v84: set<D0> := {v83, v83};
				var v85: map<int, set<D0>> := map[p0 := v84];
				v0[safeIndex(675, v0.Length)] := 0x8f !in v85;
				var v86: map<int, bool> := map[p0 := f28];
				var v87: seq<map<int, bool>> := [((map[p0 := f28])[|"qlr"| := f28])[|"qdiwp"| := f28], v86];
				v0[safeIndex(675, v0.Length)] := fm8(v87[safeIndex(p0, |v87|)], globalState);
				globalState.f1 := f28;
				var v88: map<bool, bool> := map[f28 := if (p0 in v86) then v86[p0] else v0[safeIndex(675, v0.Length)]];
				globalState.f1 := |v88| == |v1[safeIndex(0x160, |v1|) := f28]|;
				...
				v94[safeIndex(144, v94.Length)] := v96;
				v94[safeIndex(144, v94.Length)] := v96;
			}
			...
			if (p0 < p0) {
				...
				var v114: array<D30> := new D30[27] [fm94(fm16(p0, false, v106, globalState), globalState), v111, v111, v111, v111, v111, v111, v111, v111, v111, DC75(v108, {true, v99.f28, v99.f28, v104.f42}), v111, v111, v111, DC75(set v113 : map<bool, bool> | v113 in v112[v107 := abs(fm24(v99.f28, |v100|, globalState))] :: (v113), v109), v111, v111, v111, v111, v111, DC75({v107}, {v104.f42, v104.f42, v99.f28}), v111, v111, v111, v111, v111, v111];
				v114[safeIndex(640, v114.Length)] := v111;
				p1[safeIndex(552, p1.Length)] := safeDivisionInt(-0x29a, |p2|);
				v114[safeIndex(640, v114.Length)], p1[safeIndex(552, p1.Length)], r0, globalState.f9 := fm94(f28, globalState), fm0(v104.f43, v99.f28, globalState), (if (v104.f42) then v99.f28 else false) !in (multiset{f28, !v99.f28, false} + v100), safeDivisionInt(|p2| + |p2|, safeModuloInt(v104.f43, p0));
				p1[safeIndex(552, p1.Length)] := |v98| + v104.f43;
			} else {
				...
				v0[safeIndex(256, v0.Length)] := f28;
				v0[safeIndex(256, v0.Length)] := f28;
				var v118 := DC24(map[v0[safeIndex(256, v0.Length)] := v0[safeIndex(256, v0.Length)]]);
				var v119: set<map<bool, bool>> := {v116, v118.cf39};
				globalState.f6 := |(if (f28) then v119 else v119)|;
				var v120 := new C0(f28);
				var v121: set<bool> := {v0[safeIndex(256, v0.Length)]};
				var v122: C6 := new C6(|v121|);
				var v123: set<C6> := {v122, v122, v122};
				var v124: map<bool, int> := map[f28 := p0];
				v115 := {safeDivisionInt(|v123|, 0x1b3), DC45(|DC15(v124).cf28|, p0, !f28, -p0).cf71};
			}
			...
			v130 := v131[safeIndex(safeModuloInt(p0, p0), |v131|)];
		...
		var v134 := DC17("urgt");
		r0 := (seq(abs(799), i13  => ('h'))) != (v134.cf30 + p2);
		var v135: seq<array<bool>> := [v0, v0, v0];
		r1 := v135[safeIndex(p0, |v135|)];
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: char, r1: int, r2: int, r3: bool) {
		...
		if (!!match DC75(set v2 : map<bool, bool> | v2 in v1 :: (v2), v3) {
			...
			v7[safeIndex(329, v7.Length)] := v8[p0 := p0] + map[p0 := |v8|];
			v7[safeIndex(329, v7.Length)] := v8;
			v0 := v0[f28 := true];
			...
			v16 := (v16 + v16) + v16[safeIndex(|v17|, |v16|) := f28];
			...
			v28[safeIndex(963, v28.Length)] := f28;
			v28[safeIndex(963, v28.Length)] := if (f28) then f28 else f28;
			globalState.f1 := f28;
			globalState.f1, v28[safeIndex(963, v28.Length)] := !!f28, !v28[safeIndex(963, v28.Length)];
		}
			...
			decreases 100 - i2
		{
			...
			var v36: array<int> := new int[9](i4 => safeModuloInt(i4, p0));
			v36[safeIndex(116, v36.Length)] := p0;
			var v37: seq<seq<bool>> := [[f28], v35[safeIndex(p0, |v35|) := v35[safeIndex(p0, |v35|)]]];
			...
			var v42: seq<int> := [p0, |(seq(abs(0x9e), i5  => (v32)))|];
			var v43 := "cwubgrfo";
			...
			v35, v36[safeIndex(116, v36.Length)], globalState.f11, r3, globalState.f1 := v37[safeIndex(|(if (p0 in v38) then v38[p0] else v0)|, |v37|)], p0, if (f28) then 0x30 else p0, if (p0 in v39) then v39[p0] else !f28, if ((if ((if (562 in v47) then v47[562] else |v42|) in v46) then v46[if (562 in v47) then v47[562] else |v42|] else v41) in v45) then v45[if ((if (562 in v47) then v47[562] else |v42|) in v46) then v46[if (562 in v47) then v47[562] else |v42|] else v41] else f28 <== f28;
			var v48: array<map<bool, bool>> := new map<bool, bool>[1];
			var v49 := DC6(p0, 0x16c, [f28, f28]);
			var v50: map<string, bool> := map[v43 := f28];
			var v51 := DC50(v48, v49, if (v43 in v50) then v50[v43] else f28, {v36[safeIndex(116, v36.Length)]}, v47);
		...
		v54 := v54;
		var v55 := 'l';
		v52 := ("joepgh" + v52)[safeIndex(p0, |("joepgh" + v52)|) := v55];
		r0 := if (fm16(p0, f28, v54, globalState)) then v55 else v55;
		var v56: map<int, bool> := map[p0 := f28];
		r1 := p0 + (if (f28) then |v56| else |(set v57 : int | (415 <= v57) && (v57 < 0x309) :: (safeModuloInt(v57, -513)))|);
	...
	method m2(globalState: GlobalState) returns (r0: char, r1: bool, r2: int) {
			...
			decreases 100 - i0
		{
			...
			var v2: map<string, multiset<bool>> := map[seq(abs(0x1c1), i1  => ('h')) := v1];
			var v3 := "ivjpa";
			...
			v10[safeIndex(827, v10.Length)] := v4.f45;
			var v15: seq<string> := [v3, v3];
			v2, globalState.f1, r1, v10[safeIndex(827, v10.Length)] := (map v14 : string | v14 in v15 :: (v14) := (v1)) + (map v16 : string | v16 in [v3] :: (v16) := (v1)), v4.f44, f28, if (-0xf2 in v8) then v8[-0xf2] else v4.f45;
			var v17: set<bool> := {f28};
			if (v17 == v17) {
				var v18: seq<int> := [v4.f45, v4.f45];
				var v19: seq<seq<int>> := [v18, v18 + ([v0, v10[safeIndex(827, v10.Length)]])[safeIndex(|v18|, |[v0, v10[safeIndex(827, v10.Length)]]|) := v0], v18];
				globalState.f11, v10[safeIndex(827, v10.Length)], v18, globalState.f1 := 0x178 * v0, |v19|, v18, v4.f44;
				var v20: array<map<int, bool>> := new map<int, bool>[14];
				var v21: map<int, bool> := map[v4.f45 := v4.f44];
				v20[safeIndex(973, v20.Length)] := v21;
				v20[safeIndex(973, v20.Length)] := v21;
				var v22 := 'd';
				var v23 := DC42(v22);
				...
				v0 := safeModuloInt(v4.f45, |v31|);
				r1 := f28;
				globalState.f3 := new int[10](i2 => safeDivisionInt(i2, v4.f45));
			}
		...
		match (fm95(v0 * v0, !f28, f28, v0, globalState)) {
			case DC58(cf100) =>
				...
				if ((if (v0 in v33) then v33[v0] else v32) in v34) {
					...
					v41[safeIndex(695, v41.Length)] := v42;
					v41[safeIndex(695, v41.Length)] := new char[12];
					...
					v47[safeIndex(685, v47.Length)] := if (fm11(v34, globalState)) then v43 else v43;
					v47[safeIndex(685, v47.Length)] := DC49(v43).cf79;
				} else {
					...
					v54[safeIndex(896, v54.Length)] := v55[safeIndex(|v34|, |v55|)];
					v54[safeIndex(896, v54.Length)] := f28;
					var v57: seq<int> := [cf100, |{v52}|];
					var v58 := DC51(v54[safeIndex(896, v54.Length)], v32, map v56 : int | v56 in v57 :: (safeModuloInt(v56, cf100)) := (v53.f39), v0, v54[safeIndex(896, v54.Length)]);
				...
				if (fm11(v34, globalState) || (|"yyg"| in (if (v60 in v64) then v64[v60] else map[v0 := v62]))) {
					...
					v66[safeIndex(959, v66.Length)] := v59;
					v66[safeIndex(959, v66.Length)] := v59;
					v59[safeIndex(805, v59.Length)] := cf100;
					v59[safeIndex(805, v59.Length)] := v62[safeIndex(v0, |v62|)];
					globalState.f9 := cf100;
				} else {
					var v67: map<int, int> := map[v0 := v0];
					v67 := map[cf100 := |v62|] + (map v68 : int | (0x1a <= v68) && (v68 < 0x33f) :: (safeDivisionInt(v68, -cf100)) := (|(seq(abs(0x1a1), i5  => (|{v0}|)))|));
					...
					v77 := v77[cf100 := v76];
					globalState.f6 := v0 + safeDivisionInt(-(if (cf100 in v67) then v67[cf100] else |(seq(abs(0x133), i6  => (v32)))|), 0x178);
					var v78 := DC17(v34);
					cf100 := v62[safeIndex(|(v34 + v78.cf30)|, |v62|)];
				}
			...
			case DC57(cf99) =>
				...
				match (v82) {
					case DC54(cf92, cf93) =>
						...
						v89 := v89;
						v79[safeIndex(676, v79.Length)] := v0 !in v89;
						v79[safeIndex(676, v79.Length)] := fm29((seq(abs(23), i7  => (v84)))[safeIndex(cf93, |(seq(abs(23), i7  => (v84)))|) := v84], v83, v0, cf92, globalState);
					case DC55(cf94, cf95, cf96, cf97) =>
						...
						globalState.f6 := |v91| + safeModuloInt(|v93|, v0);
						var v94: seq<int> := [v0, v0];
						globalState.f1 := false && (v0 !in v94[safeIndex(v0, |v94|) := v0]);
					case DC53(cf91) =>
						var v95 := "q";
						...
						v103[safeIndex(842, v103.Length)] := v104;
						v103[safeIndex(842, v103.Length)] := v104;
					case DC56(cf98) =>
						...
						v106 := new C13((set v107 : int | (-251 <= v107) && (v107 < 377) :: (safeDivisionInt(v107, v0))) !! v108, f28 || v106.f29);
						r2 := v105.fm0(v0 - v0, v106.f29, globalState);
				}
				
				var v109 := "yxcnda";
				var v110 := 'k';
				var v111: array<string> := new string[20] [v109, if (f28) then v109 else fm18(globalState), v109 + "rfm", v109, "lkdfbgba", v109, v109 + (seq(abs(-0x2ac), i9  => ('v'))), (v109 + v109)[safeIndex(v0, |(v109 + v109)|) := v110], v109 + v109[safeIndex(v0, |v109|) := v110], v109[safeIndex(v0, |v109|) := v110], if (true) then fm18(globalState) else v109, v109 + (seq(abs(0x38), i10  => (v110))), v109, "nwnrao", "wkfjioc", v109, v109, v109, fm30(f28, fm48(-174, f28, globalState), globalState), v109];
				v111[safeIndex(713, v111.Length)] := "sl";
				v111[safeIndex(713, v111.Length)] := v109;
				var v112: map<bool, string> := map[DC26(f28).cf41 := "dcpgpqqx"];
				var v113: seq<bool> := [f28, fm29(if (f28 in v112) then v112[f28] else "y", v111[safeIndex(713, v111.Length)], v0, fm14(f28, map[multiset(v109) := v0], f28, globalState), globalState)];
				var v114: array<int> := new int[8] [v0, |("rlcm" + v111[safeIndex(713, v111.Length)])|, v0, 0x1bf, |map[f28 := v0]|, -|(v113 + v113)|, v0, 605];
				v114[safeIndex(52, v114.Length)] := -v0;
				v114[safeIndex(52, v114.Length)] := if (v0 >= v0) then v0 else v0;
				globalState.f9 := v0;
		}
		
		globalState.f9 := v0 * v0;
		var v115: multiset<int> := multiset{v0};
		var v116: map<multiset<int>, bool> := map[v115 - multiset(seq(abs(792), i11  => (v0))) := !f28];
		...
		var v128: seq<set<char>> := [v124, v124, v124, v127[safeIndex(v0, |v127|)], v124];
		v116, v117, v120, globalState.f1, globalState.f1 := v116, v117, fm68(!!fm47(|multiset(v122)|, f28, v0, f28, globalState), v0, f28, globalState), v0 >= v0, {v118} !! ((if (v123 in v125) then v125[v123] else v124) * v127[safeIndex(v0, |v127|)]);
		...
		for i13 := 0x2c6 to v0 + 0x35 {
			...
			v141[safeIndex(930, v141.Length)] := v140;
			...
			v147[safeIndex(399, v147.Length)] := v143;
			v141[safeIndex(930, v141.Length)], v147[safeIndex(399, v147.Length)], globalState.f26 := v140, v143, i13;
		}
		r0 := v119[safeIndex(v0, |v119|)];
		r1 := v123.f29;
		r2 := v0;
	}
	method m3(globalState: GlobalState) returns (r0: int) {
		...
		var v2 := -0x7d;
		var v3: seq<int> := [v2];
		for i0 := |v0| + |v1| to v3[safeIndex(fm0(v2, f28, globalState), |v3|)] {
			var v4: map<bool, int> := map[!f28 := if (f28) then v2 else i0];
			v4 := v4[fm16(v2, f28, v3, globalState) := -(i0 * |(seq(abs(-0x1f2), i1  => (i0)))|)];
			var v5: seq<bool> := [f28, f28, true];
			v1 := fm21(v5[safeIndex(i0, |v5|)], globalState);
			var v6 := new C4(f28);
		...
		var v11: map<set<int>, char> := map[v9 - (set v10 : int | (450 <= v10) && (v10 < 0x38c) :: (safeModuloInt(v10, -v2))) := 'd'];
			...
			decreases 100 - i4
		{
			...
			v14[safeIndex(835, v14.Length)] := |"aile"|;
			var v15: multiset<int> := multiset{v2};
			var v17: map<bool, int> := map[f28 := v2];
			var v18: set<map<bool, int>> := {v17};
			v14[safeIndex(835, v14.Length)] := -safeDivisionInt(if (v2 in v15) then v15[v2] else -0x2e8, |(map v16 : map<bool, int> | v16 in v18 :: (v16) := (false))|);
			globalState.f9, globalState.f1, globalState.f1 := fm0(v2, f28, globalState), !!f28, safeModuloInt(v3[safeIndex(v14[safeIndex(835, v14.Length)], |v3|)], v2) > v14[safeIndex(835, v14.Length)];
			v0 := v0 + ("tykywr" + v0);
		...
		var v22: map<int, int> := map[if (v19 in v21) then v21[v19] else -634 := safeModuloInt(|multiset{v2}|, v2)];
	...
	method m4(p0: multiset<map<char, int>>, p1: int, p2: int, globalState: GlobalState) returns (r0: int, r1: array<bool>) {
		var v0 := "po";
		var v1: seq<int> := [|(seq(abs(-0x230), i0  => (v0)))|];
		if (fm29(v0, v0 + "wmvgabsy", p1, v1[safeIndex(p1, |v1|)], globalState)) {
			var v2: seq<bool> := [f28];
			...
			var v17: array<map<int, int>> := new map<int, int>[24] [map[p2 := p1] + v7[p2 := p2], v7, (map v8 : int | (0x3be <= v8) && (v8 < 129) :: (v8 + p2) := (p1)) + v7, map[|v2| := 101] + fm28(p1, p2, seq(abs(566), i1  => ('t')), globalState), if (|v2| in v9) then v9[|v2|] else v7, v7 + v7, v7[p2 := |(set v11 : string | v11 in v10 :: (v11))|], map v12 : int | v12 in v3 :: (v12 * |map[|"fad"| := DC28('m', f28, -p1, f28, p1)]|) := (|map[v5.f32[safeIndex(p2, |v5.f32|)] := f28]|), v7, v7, map v13 : int | v13 in v7 :: (safeModuloInt(v13, p2)) := (p2), v7, v7 + v7, v7, if (f28) then map v14 : int | (-531 <= v14) && (v14 < 0x395) :: (safeModuloInt(v14, 0x384)) := (p1) else v7, v7, v7, v7, v15.cf22, v7, if (!f28 in v16) then v16[!f28] else v7, v7, v7, v7];
			v17[safeIndex(778, v17.Length)] := v7;
			v17[safeIndex(778, v17.Length)] := v7;
			var v18: array<D13> := new D13[24](i2 => DC31(f28, f28, 's'));
			var v19 := 'l';
			var v20 := DC31(!f28, f28, v19);
			v18[safeIndex(931, v18.Length)] := v20;
			v18[safeIndex(931, v18.Length)] := v20;
		...
		if (f28) {
			var v31: array<int> := new int[25](i3 => safeModuloInt(i3, p1));
			var v32 := DC7(v31);
			var v33: seq<array<int>> := [v31, v31, v31];
			var v34: set<string> := {v0};
			var v35: T1 := new C8(v32.(cf13 := v33[safeIndex(|v34|, |v33|)]), v0, f28);
			v35 := v35;
			var v36 := DC0(p2);
			var v37: map<int, bool> := map[fm48(v36.cf0, f28, globalState) := false];
			globalState.f6 := fm0(safeModuloInt(v30, |v1|), if (v30 in v37) then v37[v30] else f28, globalState);
			v31[safeIndex(226, v31.Length)] := p1;
			v31[safeIndex(226, v31.Length)] := --p2;
			globalState.f1 := if (p1 in v37) then v37[p1] else f28;
			if (f28) {
				v31 := if (v35.f28) then v33[safeIndex(p2, |v33|)] else v31;
				globalState.f6 := --safeDivisionInt(safeModuloInt(p2, |v1|), p2);
				var v38: array<multiset<bool>> := new multiset<bool>[16];
				var v39: multiset<bool> := multiset{v35.f28};
				var v40: seq<multiset<bool>> := [v39];
				v38[safeIndex(725, v38.Length)] := v40[safeIndex(p1, |v40|)] - v39;
				v38[safeIndex(725, v38.Length)] := v39 - v39;
				var v41: multiset<array<int>> := multiset{v31};
				var v42 := DC11(v41 - multiset{v31, v31, v31});
				v42 := v42;
				var v43: array<char> := new char[15];
				var v44 := 'r';
				v43[safeIndex(951, v43.Length)] := v44;
				v43[safeIndex(951, v43.Length)] := v44;
			} else {
				var v45: array<char> := new char[28](i4 => 'x');
				var v46 := 'f';
				v45[safeIndex(179, v45.Length)] := v46;
				v45[safeIndex(179, v45.Length)] := v46;
				globalState.f26 := p2 * 0x35f;
				globalState.f1 := v35.f28;
				var v47: map<int, int> := map[0xc1 := |[v35.f28, false]|];
				var v48: seq<bool> := [v35.f28, v35.f28];
				globalState.f1 := (v30 >= |v47|) || v48[safeIndex(|fm50(p2, v30, false, globalState)|, |v48|)];
			...
			match (v53) {
				case DC28(cf43, cf44, cf45, cf46, cf47) =>
					...
					v56 := v56[v54 := v55[p2 := abs(v30)]];
					var v57: array<int> := new int[20];
					v57[safeIndex(871, v57.Length)] := v30 * p2;
					var v58: C2 := new C2(cf43, cf44 in v50);
					var v59: seq<bool> := [f28];
					var v60: seq<seq<bool>> := [v59, v59[safeIndex(v30, |v59|) := true]];
					v57[safeIndex(559, v57.Length)] := |v60|;
					var v63: array<set<int>> := new set<int>[1](i5 => set v62 : int | v62 in (set v61 : int | (0x26d <= v61) && (v61 < 974) :: (v61 + cf45)) :: (safeModuloInt(v62, -0x27)));
					var v64: set<int> := {v30, cf47};
					var v65: array<map<bool, bool>> := new map<bool, bool>[12];
					var v66 := DC6(fm24(cf44, 383, globalState), |v50|, v59);
					var v68 := DC50(v65, v66, cf46, set v67 : int | (480 <= v67) && (v67 < 0x2d0) :: (safeDivisionInt(v67, if (|{f28, v59[safeIndex(v30, |v59|)]}| in v55) then v55[|{f28, v59[safeIndex(v30, |v59|)]}|] else p1)), multiset(v1));
					v63[safeIndex(711, v63.Length)] := v64 + v68.cf83;
					var v69 := DC4(cf46, cf45, !cf46);
					v57[safeIndex(871, v57.Length)], v58, v57[safeIndex(559, v57.Length)], v63[safeIndex(711, v63.Length)] := cf47, v58, fm24(v69.cf6, -v30 * p2, globalState), v64;
					var v70: map<int, bool> := map[v57[safeIndex(871, v57.Length)] := true];
					v54[safeIndex(958, v54.Length)] := f28 && !fm8(v70, globalState);
					v58, v54[safeIndex(958, v54.Length)], globalState.f26 := v58, cf46, v30;
					globalState.f1 := f28;
				case DC27(cf42) =>
					...
					v71 := v71[f28 := v72];
					var v73 := 'n';
					var v74: multiset<string> := multiset{v0, (fm18(globalState))[safeIndex(|(seq(abs(0x10c), i6  => ('f')))|, |fm18(globalState)|) := v73]};
					v74 := (if (f28) then v74[v0 := abs(v30)] else v74) * (v74 * v74);
					var v75: map<int, int> := map[p1 := v1[safeIndex(p1, |v1|)]];
					var v76: seq<map<int, int>> := [v75, v75, v75];
					v76 := v76;
					v0 := (v0 + v0) + ("vxudtpv")[safeIndex(-0x17f, |"vxudtpv"|) := v73];
				case DC29(cf48) =>
					...
					var v84: array<int> := new int[22] [p2 * 0x2ff, 102, |v79.cf137|, p1, safeDivisionInt(-p1, |v80|), |v82|, v30, p1, v30, 838, 0x13d - v30, 455, v30, 238, p2, p2, |v83|, p1, -v30, p1 + -0x2f1, |(v1 + (seq(abs(366), i7  => (|{"jxuoc", v0}|))))|, -v30];
					v84[safeIndex(259, v84.Length)] := -p1;
					var v85 := DC9(p2, v77.f40);
					v84[safeIndex(751, v84.Length)] := v85.cf17;
					v0, globalState.f11, v84[safeIndex(259, v84.Length)], v84[safeIndex(751, v84.Length)] := v0 + v0, 588, p2, -safeDivisionInt(|fm45(globalState)| * p1, if (f28) then v30 else v30);
					var v86 := 'f';
					...
					v90[safeIndex(755, v90.Length)] := v86;
					v90[safeIndex(755, v90.Length)] := v86;
		...
		var v97: set<int> := {v30};
		var v98: map<bool, bool> := map[f28 := fm11(seq(abs(0x3df), i9  => ('w')), globalState)];
		var v99: array<int> := new int[19] [fm14(f28, map v93 : multiset<char> | v93 in v95 :: (v93) := (|{v30}|), f28, globalState), p1, if (f28) then |v96| else v30, v30, p1, |v97|, p1, safeModuloInt(|fm18(globalState)|, v30), v30, -p1, -p1, -|({p1, -v30} + v97)|, p2, p1, p1, if (f28) then p1 else v30, p2, -|(v98 + v98)|, v30 * -0x111];
...
function fm8(p0: map<int, bool>, globalState: GlobalState): bool {
	(multiset{|"tc"|, -|[true]|, |map[0x17d := true]|, 0x1b7} - multiset{|(map v0 : int | v0 in map[259 := 'o'] :: (safeDivisionInt(v0, |"k"|)) := (!false))|, 310}) !! multiset([0x2ad, 903])
}
...
function fm14(p0: bool, p1: map<multiset<char>, int>, p2: bool, globalState: GlobalState): int {
	|((seq(abs(-0x1f7), i0  => ([0x1db, |"icix"|]))) + ([[|DC17("vmhnimpua").cf30|]] + (seq(abs(0x2ed), i1  => ([|map[true := seq(abs(980), i2  => ('k'))]|])))))|
}
function fm15(globalState: GlobalState): char {
	'b'
}
function fm16(p0: int, p1: bool, p2: seq<int>, globalState: GlobalState): bool {
	match if (!false) then DC84(DC84(multiset([DC40(multiset{{|map[0x3dd := 47]|}}), DC40(multiset{{|{547}|}})])).cf136) else DC84(multiset([DC40(multiset{{|[set v0 : int | v0 in (seq(abs(0x316), i0  => (|multiset{|"lhgo"|}|))) :: (safeModuloInt(v0, 587)), {|[true]|, |[true]|}]|}})])) {
...
function fm18(globalState: GlobalState): string {
	(seq(abs(0xf0), i0  => ('t'))) + ("tlrxcnl" + "cviys")
}
...
function fm27(globalState: GlobalState): set<int> {
	(set v0 : int | v0 in multiset{-0x3db} :: (safeModuloInt(v0, |multiset{true, false, false, false, false}|))) + (set v1 : int | (0x2f2 <= v1) && (v1 < -0x1c8) :: (safeDivisionInt(v1, |multiset{false, !false, false}|)))
}
...
function fm31(p0: bool, p1: char, globalState: GlobalState): seq<int> {
	[safeModuloInt(-0xb4, |multiset{|map[true := false]|}|)]
}
...
function fm33(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): multiset<seq<int>> {
	if ((seq(abs(0x5a), i0  => ('a'))) != "rnkitly") then multiset{[|multiset{|[0x281]|}|, |[|DC17(DC17("ejmcddo").cf30).cf30|, DC5(true, multiset{0x1c7}, 38).cf9, 0xcd]|]} - multiset{seq(abs(0x272), i1  => (|multiset{DC20(DC20(DC17("curhbhkiw")))}|)), [-0x35b, 0x39, |"py"|, 0x217, |{false}|]} else multiset{[|{'j', 'q'}|], [-|map[!true := 0x88]|, --|"tkxhe"|, -|[true, false]|, -|[true, true]|]} + multiset([[|{false}|, 701]])
}
...
function fm40(p0: bool, globalState: GlobalState): set<int> {
	{|map[0x21d := true]|} + ({|(seq(abs(764), i0  => (|[true]|)))|, |multiset{|[!false, true]|}|, |map[|"e"| := -0x174]|, 0x4d} + {0x215})
}
...
function fm44(p0: int, p1: bool, p2: int, globalState: GlobalState): D12 {
	if ([|map[-|map[true := |multiset{|multiset{true}|}|]| := true]|] != (seq(abs(0xf6), i0  => (-|(seq(abs(0x1b9), i1  => ([false])))|)))) then if (false) then DC29(DC27(multiset{false})) else DC29(DC27(multiset{true, true})) else DC29(DC29(DC28('h', false, 0x32a, false, 0x4e)))
}
...
function fm46(p0: bool, globalState: GlobalState): D0 {
	DC0(safeModuloInt(-|[|map[|(seq(abs(0x2d), i0  => (map[false := DC8(0x1fb, 0x16c, true)])))| := false]|]|, 0xf1))
}
...
function fm49(p0: multiset<string>, p1: bool, p2: string, globalState: GlobalState): D8 {
	DC18(true && true, safeDivisionInt(0x191, |"smowmh"|), safeModuloInt(-0x267, |[!true, false, true, false, true]|))
}
...
function fm52(p0: bool, globalState: GlobalState): map<int, int> {
	map[|[DC2(|multiset{0x63}|), DC2(|{0x3da}|), DC2(0x93), DC2(-|"eabolpw"|), DC2(|map[0x1ae := |map[false := -0x32f]|]|)]| := |"akpsctrcj"|] + (map v0 : int | (0x11c <= v0) && (v0 < 0x113) :: (safeModuloInt(v0, -|[false, false, false, !false, false]|)) := (-92))
}
function fm53(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): map<bool, bool> {
	map[|[0x25d]| <= -|map[|map[true := |"xjfr"|]| := !!!!false]| := "cpxyr" < (seq(abs(918), i0  => ('i')))]
}
function fm54(p0: D1, p1: map<string, bool>, globalState: GlobalState): set<map<int, bool>> {
	({map[678 := true], map[|map[!false := 0x1f8]| := true]} + {map v0 : int | (0x212 <= v0) && (v0 < 0x1ab) :: (v0 + |multiset{false}|) := (false), map[|"qkp"| := true]}) - ({map[-136 := false]} + {map v1 : int | v1 in (seq(abs(362), i0  => (311))) :: (v1 - -0x189) := (false)})
}
function fm55(p0: bool, p1: int, p2: bool, globalState: GlobalState): D15 {
	DC35([seq(abs(762), i0  => ('w')), ['n', 'h', 'w']])
}
function fm56(globalState: GlobalState): map<int, char> {
	(map[|(seq(abs(755), i0  => ('y')))| := 'x'] + map[0x4a := 'j']) + (map[|"r"| := 'j'] + map[141 := 'o'])
}
function fm57(globalState: GlobalState): D14 {
	DC34()
}
function fm58(globalState: GlobalState): D2 {
	match DC18(!false, |(seq(abs(488), i0  => ('w')))|, |(seq(abs(288), i1  => (|map[false := !true]|)))|) {
...
function fm63(p0: char, p1: bool, p2: int, globalState: GlobalState): seq<bool> {
	match DC2(|[false, true, DC37(0x22c, false, |multiset(DC6(730, |[0x9e, 0x390]|, [true, true]).cf12)|, seq(abs(872), i0  => ("rjlydn"))).cf60]|) {
		case DC2(cf2) => [true]
		case DC1(cf1) => [cf1]
	}
}
function fm64(p0: bool, p1: int, globalState: GlobalState): map<int, bool> {
	(map[0x2e4 := true] + map[-0x178 := true]) + (map[|(seq(abs(0x36f), i0  => ('k')))| := false] + map[0x1eb := false])
}
...
function fm68(p0: bool, p1: int, p2: bool, globalState: GlobalState): D12 {
	match DC12(!true, map[0x3c5 := -0x2dc], false, -0x385, -0x49) {
		case DC12(cf21, cf22, cf23, cf24, cf25) => DC28('o', cf21, |(seq(abs(948), i0  => (cf25)))|, cf21, cf24)
...
function fm73(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): D19 {
	DC46(DC12(false, map[|"dvqmmpi"| := |map[true := 0x27a]|], true, |(map v0 : int | v0 in map[226 := false] :: (safeDivisionInt(v0, |[true, !!false]|)) := (|map[|[{true, true}]| := false]|))|, 0x3a6).cf25, -safeDivisionInt(|{false}|, |map[|"skgjf"| := |"gix"|]|))
}
...
function fm75(p0: bool, globalState: GlobalState): D5 {
	if (if (false) then true else true) then DC13(DC13([--0x98]).cf26) else DC13(seq(abs(0x303), i0  => (|"dpaftteo"|)))
}
...
function fm77(p0: int, p1: D15, p2: int, p3: string, globalState: GlobalState): D19 {
	DC45(|(multiset{0x37c, |[false, false, !true]|} + multiset{-|map[|"guutv"| := "t"]|, |(seq(abs(760), i0  => (0x284)))|})|, safeModuloInt(|[false, !true, true, !true, true]|, -|map[!true := true]|), !!(multiset([909, -0x260]) >= multiset{0x30b}), |DC89(map[!false := [694]]).cf146|)
}
...
function fm79(p0: int, globalState: GlobalState): seq<map<bool, int>> {
	seq(abs(0x3dd), i0  => (map[false := |multiset{true}|]))
}
...
function fm82(p0: char, globalState: GlobalState): seq<D5> {
	seq(abs(492), i0  => (DC13([-|(seq(abs(-0x121), i1  => ('r')))|, -0x288])))
}
...
function fm85(globalState: GlobalState): map<int, string> {
	map[|[false]| := seq(abs(0x228), i0  => ('k'))] + map[0x20e := "rsc"]
}
...
function fm87(p0: int, p1: seq<int>, p2: int, p3: char, globalState: GlobalState): seq<multiset<char>> {
	[multiset(seq(abs(0xc4), i0  => ('w'))), multiset{'t', 'k', 'b', 'e'}] + ([multiset{'u', 'o', 't'}] + [multiset{'x'}, multiset{'g'}])
}
function fm88(globalState: GlobalState): set<string> {
	set v0 : string | v0 in [seq(abs(0x3a0), i0  => ('n'))] :: (v0)
}
function fm89(p0: int, globalState: GlobalState): seq<multiset<bool>> {
	([multiset([false, false, false]), multiset{!true}] + (seq(abs(0x3d7), i0  => (multiset([false, true]))))) + (if (!!true) then [multiset{true}, multiset([true])] else [multiset{true, true}])
}
...
function fm91(p0: bool, p1: multiset<int>, p2: bool, p3: bool, globalState: GlobalState): D4 {
	DC12(--861 == |"qxuravwq"|, map[|"vlotlv"| := -0xcd] + map[|"yrrpqxk"| := |{true, !!true}|], !(true && false), |[0x7b]|, safeDivisionInt(0x33d, 0x8))
}
function fm92(p0: map<int, int>, p1: int, p2: int, globalState: GlobalState): multiset<D24> {
	(multiset{DC59([map[true := 790]])} * multiset{DC59([map[true := 0x235], map[true := |multiset([false, true])|]])}) * multiset(seq(abs(576), i0  => (DC59(seq(abs(0x107), i1  => (map[false := |"dq"|]))))))
}
function fm93(p0: bool, globalState: GlobalState): D33 {
	match DC14(0x2d0) {
		case DC14(cf27) => DC81(map v0 : int | v0 in map[cf27 := seq(abs(0x12f), i0  => (cf27))] :: (v0 - cf27) := (DC40(multiset{set v1 : int | (0x331 <= v1) && (v1 < 0x178) :: (safeDivisionInt(v1, cf27))})))
...
function fm94(p0: bool, globalState: GlobalState): D30 {
	match DC37(--|"bukwjeiv"|, false, 0x86, seq(abs(0x1f1), i0  => ("nfls"))) {
...
method Main() {
	var v0 := false;
	var v1: array<int> := new int[5](i0 => safeDivisionInt(i0, 0xbf));
	var v3 := 200;
	var v4: set<int> := {-v3};
	...
	var v12: map<int, multiset<bool>> := map[-safeDivisionInt(v10.f45, v10.f45) := v11];
	var v13 := DC7(v1);
	...
	for i2 := v10.f45 to v3 {
		...
		var v21 := 'u';
		v19[safeIndex(450, v19.Length)] := v20 + fm63(v21, v0, -i2, globalState);
		v19[safeIndex(450, v19.Length)] := (v20 + v20) + (v20 + v20);
		v8[safeIndex(33, v8.Length)] := v17.f46 <==> v0;
		v8[safeIndex(33, v8.Length)] := v0;
	}
	for i4 := |"vumcccpy"| to v3 {
		v0 := v0;
		var v22: C0 := new C0(v10.f44);
		v22 := v22;
		var v23: multiset<string> := multiset{v14.f36, v7 + (seq(abs(804), i5  => ('k'))), v7, "dosseam"};
		v23 := v23;
		var v24: array<C8> := new C8[17];
		v24[safeIndex(363, v24.Length)] := v14;
		var v25: map<int, C8> := map[i4 - v3 := v14];
		globalState.f6, v24[safeIndex(363, v24.Length)] := if (v0) then v10.f45 else v3, if (i4 in v25) then v25[i4] else v14;
	}
	globalState.f1 := v14.f36[safeIndex(v10.f45, |v14.f36|)] in v14.f36;
	var v26 := 'm';
	...
	match (if (v10.f44) then v28 else v28) {
		case DC42(cf68) =>
			if (false) {
				...
				var v35: seq<int> := [|v34[safeIndex(v10.f45, |v34|) := v3]|];
				var v36: seq<bool> := [v0];
				...
				v1[safeIndex(731, v1.Length)] := v10.f45;
				var v46: seq<multiset<bool>> := [multiset{v10.f44}];
				v1[safeIndex(731, v1.Length)] := (-|v14.f36| * v10.f45) * |(v11[v10.f44 := abs(v10.f45)] + v46[safeIndex(v3, |v46|)])|;
				...
				v51 := [v16.fm0(v1[safeIndex(731, v1.Length)], v10.f44, globalState), -74 * v10.f45, v3, v10.f45];
				v7 := if (v10.f44 ==> true) then v14.f36 else "mlqst";
				var v52: map<int, int> := map[v10.f45 := v1[safeIndex(731, v1.Length)]];
				var v53: map<array<bool>, int> := map[v8 := |v52|];
				var v54: map<array<bool>, int> := map[v8 := |v53|];
				v1[safeIndex(731, v1.Length)], v0 := -(if (v8 in v53) then v53[v8] else if (!v0) then v10.f45 else |v47|), v10.f44 && v10.f44;
			}
			...
			v1[safeIndex(33, v1.Length)] := v10.f45;
			v1[safeIndex(33, v1.Length)] := v10.f45;
			var v59: T1 := new C14(v0);
			var v60: map<T1, int> := map[v59 := v10.f45];
			var v61: map<bool, string> := map[v0 := v14.f36];
			if (fm29(fm50(if (v59 in v60) then v60[v59] else v10.f45, v10.f45, v10.f44, globalState), v14.f36 + v14.f36, |v61|, DC14(v1[safeIndex(33, v1.Length)]).cf27, globalState)) {
				...
				var v65: seq<int> := [v1[safeIndex(33, v1.Length)]];
				var v66: C15 := new C15(fm16(v10.f45, v59.f28, v65, globalState));
				v64[safeIndex(740, v64.Length)] := v66;
				v64[safeIndex(740, v64.Length)] := v66;
				globalState.f1 := v62.f41;
				var v67 := new C6(v10.f45);
				v65 := [v10.f45 + v1[safeIndex(33, v1.Length)]];
			} else {
		...
		case DC41(cf67) =>
			...
			v1[safeIndex(944, v1.Length)] := v10.f45 * -|v7|;
			v1[safeIndex(944, v1.Length)] := --safeModuloInt(v3 - -v10.f45, v3);
			var v78: array<T1> := new T1[5];
			var v79: T1 := new C14(!fm16(-v1[safeIndex(944, v1.Length)], v76, [v10.f45], globalState));
			v78[safeIndex(982, v78.Length)] := v79;
			v78[safeIndex(982, v78.Length)] := v79;
	...
	for i6 := v10.f45 * -v3 to v3 - v10.f45 {
		...
		v8[safeIndex(72, v8.Length)] := false;
		v83, v0, v8[safeIndex(72, v8.Length)] := v83, v10.f45 > v10.f45, v0;
	...
	var v87: array<array<C14>> := new array<C14>[23] [v85, v85, v85, v85, v85, v85, v85, if (v0) then v85 else v85, v85, v85, v85, v85, v85, v85, v85, v86[safeIndex(v3, |v86|)], v85, v85, v85, v85, v85, v85, v85];
	v87[safeIndex(627, v87.Length)] := v85;
	v1[safeIndex(674, v1.Length)] := v3;
	v7, v87[safeIndex(627, v87.Length)], v1[safeIndex(674, v1.Length)], v0 := seq(abs(713), i7  => (v26)), v85, v10.f45, v14.fm12(if (v10.f44) then v3 else v3, globalState);
	...
	var v90: map<int, array<bool>> := map[|(seq(abs(0x1fa), i8  => (v26)))| := v8];
	...
	v91[safeIndex(967, v91.Length)] := v8;
	...
	var v94 := DC6(|[v10.f44, v0, v10.f44, false, v10.f44]|, v1[safeIndex(674, v1.Length)], [v10.f44]);
	var v95: multiset<int> := multiset{v1[safeIndex(674, v1.Length)]};
	var v96 := DC50(v93, v94, v10.f44, {|v4|}, v95);
	var v97: map<D21, array<bool>> := map[v96 := v8];
	var v98: C9 := new C9(v0);
	var v99: seq<C9> := [v98];
	v91[safeIndex(967, v91.Length)] := new bool[18] [v3 <= |v11|, false <==> v10.f44, v97 == v97, !v0, v10.f44, v10.f44, if (v0) then v10.f44 else true, !v10.f44, !v10.f44, v10.f45 <= v1[safeIndex(674, v1.Length)], v0, !false, v10.f44 <== v0, v10.f44, v0, v0, v1[safeIndex(674, v1.Length)] != |v99|, v98.f34];
	v98.m13(globalState);
	for i9 := v3 to safeModuloInt(117, |v14.f36|) {
		globalState.f6 := if (!v10.f44) then safeDivisionInt(v3, v1[safeIndex(674, v1.Length)]) else -v1[safeIndex(674, v1.Length)];
		...
		if (if ((if (v98.f34) then -v1[safeIndex(674, v1.Length)] else v10.f45) in v103) then v103[if (v98.f34) then -v1[safeIndex(674, v1.Length)] else v10.f45] else v98.f34) {
			var v104 := new C8(v13, (v14.f36 + (seq(abs(405), i10  => (v26))))[safeIndex(|map[v98.f34 := 0x3d3]|, |(v14.f36 + (seq(abs(405), i10  => (v26))))|) := v26], false);
			v91[safeIndex(967, v91.Length)] := v8;
			v1[safeIndex(674, v1.Length)] := 0x29b - v1[safeIndex(674, v1.Length)];
			v98 := v98;
			var v105 := new C6(v84.fm3(globalState));
		} else {
			var v106: seq<int> := [v10.f45];
			globalState.f9 := |(v106 + v106)|;
			v106 := [|(multiset(v7))[fm15(globalState) := abs(v10.f45)]|, v3] + (if (v10.f44) then v106 else [i9]);
	...
	v0, v3, v110, v3 := v98.f34 <== v110.f28, safeDivisionInt(v10.f45, |multiset{|v112|, v3}|), v110, v1[safeIndex(674, v1.Length)];
	var v113 := new C9(v0);
	print v0, "\n";
	print v1[0], "\n";
	print v1[1], "\n";
	...
	print v3, "\n";
	print v4 == {-200}, "\n";
	print v5 == map[[false, false, false, false] := 1], "\n";
	print v6 == map[false := map[[false, false, false, false] := 1]], "\n";
	print v7 == ['m', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm'], "\n";
	print v8[0], "\n";
	...
	print v12 == map[-1 := multiset{true}, 3 := multiset{true}], "\n";
	print v13.cf13[0], "\n";
	print v13.cf13[1], "\n";
	print v13.cf13[2], "\n";
	print v13.cf13[3], "\n";
	print v13.cf13[4], "\n";
	print v14.f35.cf13[0], "\n";
	print v14.f35.cf13[1], "\n";
	print v14.f35.cf13[2], "\n";
	print v14.f35.cf13[3], "\n";
	print v14.f35.cf13[4], "\n";
	print v14.f36, "\n";
	print |v15|, "\n";
	print v26, "\n";
	print v27 == {'m'}, "\n";
	...
	print v91[4][0], "\n";
	print v91[5][0], "\n";
	print v92 == map[false := false], "\n";
	print v93[0] == map[false := false], "\n";
	print v93[1] == map[false := false], "\n";
	print v93[2] == map[false := false], "\n";
	print v93[3] == map[false := false], "\n";
	print v93[4] == map[false := false], "\n";
	print v93[5] == map[false := false], "\n";
	print v93[6] == map[false := false], "\n";
	print v93[7] == map[false := false], "\n";
	print v93[8] == map[false := true], "\n";
	print v93[9] == map[true := false], "\n";
	print v93[10] == map[false := false], "\n";
	print v93[11] == map[false := false], "\n";
	print v93[12] == map[false := false], "\n";
	print v93[13] == map[false := false], "\n";
	print v93[14] == map[false := true], "\n";
	print v93[15] == map[false := false], "\n";
	print v93[16] == map[false := false], "\n";
	print v93[17] == map[false := false], "\n";
	print v93[18] == map[false := false], "\n";
	print v93[19] == map[false := false], "\n";
	print v93[20] == map[false := false], "\n";
	print v93[21] == map[false := false], "\n";
	print v93[22] == map[false := false], "\n";
	print v94.cf10, "\n";
	print v94.cf11, "\n";
	print v94.cf12 == [false], "\n";
	print v95 == multiset{2}, "\n";
	print v96.cf80[0] == map[false := false], "\n";
	print v96.cf80[1] == map[false := false], "\n";
	print v96.cf80[2] == map[false := false], "\n";
	print v96.cf80[3] == map[false := false], "\n";
	print v96.cf80[4] == map[false := false], "\n";
	print v96.cf80[5] == map[false := false], "\n";
	print v96.cf80[6] == map[false := false], "\n";
	print v96.cf80[7] == map[false := false], "\n";
	print v96.cf80[8] == map[false := true], "\n";
	print v96.cf80[9] == map[true := false], "\n";
	print v96.cf80[10] == map[false := false], "\n";
	print v96.cf80[11] == map[false := false], "\n";
	print v96.cf80[12] == map[false := false], "\n";
	print v96.cf80[13] == map[false := false], "\n";
	print v96.cf80[14] == map[false := true], "\n";
	print v96.cf80[15] == map[false := false], "\n";
	print v96.cf80[16] == map[false := false], "\n";
	print v96.cf80[17] == map[false := false], "\n";
	print v96.cf80[18] == map[false := false], "\n";
	print v96.cf80[19] == map[false := false], "\n";
	print v96.cf80[20] == map[false := false], "\n";
	print v96.cf80[21] == map[false := false], "\n";
	print v96.cf80[22] == map[false := false], "\n";
	print v96.cf81.cf10, "\n";
	print v96.cf81.cf11, "\n";
	print v96.cf81.cf12 == [false], "\n";
	print v96.cf82, "\n";
	print v96.cf83 == {1}, "\n";
	print v96.cf84 == multiset{2}, "\n";
	print |v97|, "\n";
	print v98.f34, "\n";
	print |v99|, "\n";
	print v109[0] == {false}, "\n";
