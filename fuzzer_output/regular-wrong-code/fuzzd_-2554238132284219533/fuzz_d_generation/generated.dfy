...
function fm10(p0: bool, globalState: GlobalState): int {
	|(match DC3(!!false, DC0(0x12)) {
		case DC2(cf2) => multiset{-0xe, |(seq(0x21d, i0  => ('m')))|, 0x3be, |(map v0 : int | (892 <= v0) && (v0 < 185) :: (v0 + 0x2c8) := (|[cf2, cf2]|))|} * multiset(seq(-0x8e, i1  => (-0x2bd)))
		case DC3(cf3, cf4) => multiset((seq(911, i2  => (944))) + [0x122, 0x2a2])
		case DC1(cf1) => multiset([|[cf1, cf1, true]|]) - multiset{|[cf1]|}
	})|
}
function fm11(globalState: GlobalState): seq<multiset<bool>> {
	seq(756, i0  => (multiset{!!false, !!true} + multiset{true}))
}
...
function fm16(globalState: GlobalState): D3 {
	DC8(false, 0x279 * DC39(true, |map[|multiset{[DC18(), DC18()], [DC18()]}| := true]|, !!false, 981, |(seq(0x1d6, i0  => (|[0x107]|)))|).cf59, |("lriyttbrc" + "jftuf")|)
}
function fm17(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState): int {
	(|multiset{false, false, false, true, true}| + |(seq(-45, i0  => (---|[|map[false := true]|]|)))|) % (|['w', 'j']| + 0x10f)
}
...
function fm20(globalState: GlobalState): map<int, seq<int>> {
	if (false <== !!false) then map v0 : int | v0 in (map v1 : int | (0x28a <= v1) && (v1 < 0x3c8) :: (v1 / |"ubretlxf"|) := (!true)) :: (v0 % |[false]|) := ([0x329]) else map[|{!false, !false}| := [|[true, true, true, false]|, |"kjccwlgyi"|, 0xc]]
}
function fm21(p0: int, p1: bool, p2: int, globalState: GlobalState): multiset<bool> {
	multiset{!(if (true) then !false else true), false, DC11(seq(309, i0  => ('f'))).cf20 != (seq(613, i1  => ('j')))}
}
...
function fm24(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState): multiset<int> {
	match DC6(|[|multiset{"ap", DC11("mthdwg").cf20}|, -0x29a]|, true, false, |(map v0 : int | (188 <= v0) && (v0 < 0x299) :: (v0 * |(seq(-0x3c0, i0  => ('y')))|) := (|(seq(0x3ba, i1  => ('x')))|))|, false) {
...
function fm27(globalState: GlobalState): map<int, bool> {
	map[-319 := !true] + map[-|multiset{|map[|multiset{true}| := seq(36, i0  => ('f'))]|}| := false]
}
...
method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: map<bool, int>) {
	...
	var v5 := 188;
	if (if (v0) then v0 else fm0(v5, v5, seq(0x27b, i0  => (multiset{v4.f16})), map["rkrihtkwb" := !v4.f16], globalState)) {
		...
		if ((if (v4.f16) then false else fm0(v5, v5, v7, v10, globalState)) <==> v4.f16) {
			...
			v17 := v17[184 := v16];
			v10 := v10[seq(0x250, i1  => (v9)) := v4.f16];
			var v18: multiset<char> := multiset{v9};
			var v19 := DC39(v4.f16, |v18|, false, |(seq(768, i2  => (v9)))|, v5);
		...
		if (v4.f16) {
			...
			var v25: C0 := new C0(fm0(fm19(|v22|, globalState), v21[731], v7, v10, globalState), |v24| - v5);
			var v26: T0 := new C2(v0, v25.f12 && true);
			v2[678][136] := v4.f16;
			v21[731], v25, v26, r1, v2[678][136] := v21[731], v25, v26, !v4.f16, v26.fm4(994, !false, 'h', globalState);
			var v27: array<map<string, bool>> := new map<string, bool>[23];
			v27[852] := v10;
			var v28: seq<int> := [v25.f13, v5];
			v21[731], v27[852], v0, v21[731], v5 := if (v25.f12) then v21[731] else v21[731], v10, if (if (false) then fm0(v21[731], v5, v7, v10, globalState) else v4.f16) then v4.f16 else !(v5 < v21[731]), v25.f13 + (|(seq(0xcc, i4  => (v9)))| - v21[731]), v21[731] + v28[-v25.f13];
		} else {
			v8 := v8;
			...
			var v33 := new C1(v8 < v32[|v8|], v4.f17);
			v9 := v9;
		}
		
		var v34: map<bool, bool> := map[v0 := v21[731] >= v5];
		...
		var v40 := DC42(v39[36], v4.f16);
		var v41 := 'a';
		var v42: map<int, string> := map[v5 := seq(0x23b, i5  => (v41))];
		...
		if (v0) {
			...
			var v44: map<string, int> := map[v38 := v5 / v5];
			var v45: seq<T0> := [v43, v43, v43];
			var v47: set<string> := {v38};
			v43, globalState.f2, v3, globalState.f2, v44 := v45[v5], v5, v3, v5, (map v46 : string | v46 in v47 :: (v46) := (-|{-v5}|))[seq(-0x2de, i6  => (v41)) := v5];
			var v48: multiset<T0> := multiset{v43};
			var v49: seq<bool> := [v4.f16, v35.fm12(true, if (v43 in v48) then v48[v43] else v5, multiset{v5}, |(seq(786, i7  => (v41)))|, globalState)];
			...
			v58[82] := |v51.f11|;
			v49, globalState.f2, v51, v58[82], v5 := (v49[v51.f10 := v35.f14])[|v54| := v38 < v38], v51.f10, v51, v5, v51.f10;
			v39 := v39;
			r0 := -v39[-v5];
			var v59: multiset<array<int>> := multiset{v58, v58};
			v1[830] := v58[82] == |v59|;
			v1, v5, v1[830], r0 := v1, |(map[DC8(v4.f16, v51.f10, -v51.f10).cf13 := v4.f16])[false := !DC6(v58[82], v0, v4.f16, v51.f10, v35.f15).cf8]|, v35.f14, v51.f10 / v51.f10;
		} else {
			...
			v4, v0, v62[333], v66[928] := v4, v35.f14 <==> ((if (v5 in v67) then v67[v5] else v35.f14) <== v0), fm19(v5, globalState), v65;
	...
	globalState.f4, v5, v1[991] := v71, fm10(v0, globalState) + (v69.f13 - v72[v69.f13]), v0;
	r0 := 0x329;
	var v73 := 'c';
	var v74: seq<char> := [v73];
	r1 := |v74| < v5;
	r2 := !(if (v69.f12) then v1[991] <==> v0 else v0);
	var v75: map<bool, int> := map[v1[991] := v69.f13];
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		match (match v0 {
			...
			case DC9(cf16) =>
				...
				var v15: seq<bool> := [fm0(p0, p0, seq(0x2a, i0  => (cf16)), map v13 : string | v13 in v14[p0 := v8] :: (v13) := (f16), globalState), v7];
				var v16: array<bool> := new bool[22] [f16, if (!f16) then f16 else f16, f16, f16, v8 == "qmuiq", v10 !! v10, f16, !v7, v12 >= v12, v7 <==> v7, v7, v7, v7, v7, !!(f16 && v7), v7, v7, f16, v7, f16, v15 == v15[p0 := f16], v7];
				v16[295] := f16;
				v16[295] := true;
				var v17: seq<multiset<bool>> := [cf16];
				var v18: map<string, bool> := map[v8 := v7];
				var v19: map<char, map<string, bool>> := map[v9 := v18];
				var v20: map<bool, bool> := map[v16[295] := fm0(p0, |fm18(p0, f16, p0, globalState)|, v17, if ('b' in v19) then v19['b'] else v18, globalState)];
				var v21: set<bool> := {v16[295]};
				var v22: seq<set<bool>> := [{v16[295], false}, v21, {v16[295], !f16}];
				v20 := map[fm0(|v22[p0]|, p0, v17, v18, globalState) := f16];
			...
			decreases 100 - i1
		{
			...
			var v39 := DC4(v38);
			var v40: seq<int> := [|v35|];
			v24, v24, v25, v39 := v24, false, multiset(v40) - (v25[|v35| := p0] * v25), DC4(v27);
			globalState.f2 := p0;
		}
		var i2 := 0;
		while (!(f16 && !f16))
			decreases 100 - i2
		{
			...
			if (f16) {
				...
				var v46: seq<int> := [v45[p0], fm19(v41.f13, globalState), p0, fm19(v41.f13, globalState)];
				...
				v48[898] := v49 + fm21(v41.f13, false, v41.f13, globalState);
				var v50: set<int> := {0x35};
				v42, v45, v47[556], v48[898] := !(v50 !! v50), (v45 + v45) + v46, fm19(|v43| - |v49|, globalState), v49;
				var v51 := new C0(v41.f12, -v47[556]);
			...
			if (v41.f12) {
				...
				v62[867] := v63;
				v59 := v41.f12;
				globalState.f2, v59, globalState.f2, r1 := p0 * v41.f13, fm19(v41.f13, globalState) >= p0, v41.f13, (v41.f13 % v41.f13) + v41.f13;
			} else {
				var v64 := true;
				v64 := v64;
				...
				v74[832], v76 := p0 < p0, (if (v64) then v76 else v76) + (v76 + (map v77 : int | v77 in v79 :: (v77 + 0x2ec) := (v67)));
		...
		for i6 := p0 to p0 {
			...
			v82, v86[246], globalState.f2, globalState.f2, v87[487] := v97.cf7, i6, |(v98 + (if (v84) then v98 else v98))|, p0, v89;
			v84 := p0 >= (v82 / 0x3c5);
			var v99 := 'e';
...
class C2 extends T0 {
	...
	function fm3(globalState: GlobalState): map<int, map<bool, int>> {
		map[0x213 + |[f15, f14, false]| := map[f14 := |(seq(0x376, i0  => ('j')))|] + map[f14 := 0x2da]]
	}
	function fm4(p0: int, p1: bool, p2: char, globalState: GlobalState): bool {
		f14
	}
	function fm12(p0: bool, p1: int, p2: multiset<int>, p3: int, globalState: GlobalState): bool {
		multiset{|(seq(766, i0  => (|{[|{f14}|]}|)))|} >= multiset{|multiset{f14}|, 73}
	}
	...
	method m3(p0: seq<bool>, globalState: GlobalState) returns (r0: bool, r1: array<bool>) {
		...
		var v13: array<int> := new int[26] [v0 - v0, v0, v0, -0x1c9, v0, -v0, v0, v0 - 452, v0, |(map[v2[v1.f13] := v1.f13] + map[v1 := v0])|, |v3[v1.f12 := v0]|, v1.f13, |fm14(v5, f14, v6, f15, globalState)|, v0, |multiset{f15, f15}| + |v7|, -v0, v1.f13, |(v8[v1.f13 := v1.f13])[|(map v9 : seq<bool> | v9 in map[p0 := v1.f13] :: (v9) := (false))| := -0x130]|, v1.f13, v1.f13, v1.f13 - |v12|, -752, 117 / v1.f13, |(if (f15) then v3 else v3)|, v0, if (f14) then 0x125 else v0];
		forall i0 | 0 <= i0 < v13.Length {
			v13[i0] := i0 - -v0;
		}
		var v14: array<C0> := new C0[13];
		v14 := v14;
		var v15 := new C0(true, v0 / v0);
		var v16: map<int, bool> := map[v15.f13 := false];
		var v17: seq<map<int, bool>> := [v16, v16 + v16, v16];
		v17 := v17;
		var v18: map<bool, D3> := map[f15 := DC8(f14, |v12[v15.f13 := v1.f13]|, v0)];
	...
	method m4(p0: bool, p1: int, globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			v19[66] := if (!f14) then f14 else v20.cf24 <= p1;
			var v21: map<int, int> := map[v16.f13 := |(seq(-0x1c9, i2  => (v0)))|];
...
class C3 extends T1 {
	...
	function fm5(p0: char, p1: seq<map<bool, int>>, p2: bool, globalState: GlobalState): bool {
		true ==> ((set v0 : int | v0 in {f10} :: (v0 % 0x309)) > {0xf6})
	}
	function fm6(p0: set<bool>, globalState: GlobalState): D1 {
		match DC2(!true) {
	...
	method m1(globalState: GlobalState) returns (r0: int) {
		...
		if (if (v0) then v1[|v2|] <= f10 else v0) {
			...
			if (v0 || v3.f12) {
				...
				v8 := v8;
				var v9: array<int> := new int[29](i1 => i1 % |v1|);
				var v10: array<C0> := new C0[23];
				var v11: map<array<C0>, array<int>> := map[v10 := v9];
				var v12 := DC4(v9);
				var v13: seq<array<int>> := [v9, v9, v9, v9, v9];
				var v14: array<array<int>> := new array<int>[29] [if (v6) then v9 else v9, v9, v9, v9, v9, v9, v9, v9, v9, if (v10 in v11) then v11[v10] else v9, v9, if (v3.f12) then v9 else v9, v9, v9, v9, v9, v9, v9, v12.cf5, v9, v9, v9, v9, v9, v9, v9, v9, v9, v13[v4]];
				v14[339] := v9;
				v14[339] := v9;
				v8[781] := v5;
				...
				v15[255] := fm9(v0, v17, v4, 'u', globalState);
				var v18: array<array<bool>> := new array<bool>[3];
				var v19: seq<array<array<bool>>> := [v18];
				var v20: array<array<array<bool>>> := new array<array<bool>>[12] [DC5(v18).cf6, v18, v18, v19[v3.f13], v18, v18, v18, v18, v18, v18, if (true) then v18 else v18, v18];
				v20[868] := v18;
				var v21 := 'm';
				...
				var v25 := DC9(v24);
				var v26: array<char> := new char[20] [v21, v21, v21, v22[v3.f13], v21, v22[if ((if (v3.f12 in v7) then v7[v3.f12] else |v25.cf16|) in v23) then v23[if (v3.f12 in v7) then v7[v3.f12] else |v25.cf16|] else v3.f13], v21, v21, v21, v21, if (v5) then v21 else v21, 'p', 'y', v21, v21, v21, v21, v21, 'c', v21];
				v26[563] := v21;
				...
				v8[781], v4, v15[255], v20[868], v26[563] := if (v5) then fm0(-|v29|, f10, fm11(globalState), v32[v3.f13], globalState) else v0, v3.f13 * f10, v2, v18, v22[v4];
			} else {
				v1 := v1;
				r0 := v3.f13 - -909;
				var v33: array<bool> := new bool[3];
				r0, v33 := (v3.f13 / v3.f13) % (v3.f13 % f10), v33;
				var v34 := "ajenxyshb";
				r0 := v1[v3.f13] % |v34|;
				var v35 := DC11(v34);
			...
			if (DC8(!v3.f12, |v2|, v3.f13).cf13) {
				...
				v38[887] := v0;
				v38[887] := v0;
				var v39 := DC8(v38[887], f10, 704);
				v38[887] := |v1| > (v39.cf15 % |v37|);
				v0 := !v0;
				var v40 := DC11(v37);
				...
				v3 := v3;
				v0 := v42[117];
				v0, v37, v42[117], v42[117] := v3.f12, (seq(0x179, i4  => ('e'))) + v37, v3.f12, (v3.f12 && v42[117]) || v3.f12;
				var v43: array<int> := new int[6](i5 => i5 - f10);
				var v44: map<bool, bool> := map[v42[117] := v42[117]];
			...
			match (v47) {
				case DC2(cf2) =>
					f10 := -(if (v2 > v2) then |(v1 + [v1[-0x145]])| else fm10(v3.f12, globalState));
				...
				case DC3(cf3, cf4) =>
					...
					v56 := v56[v55[v3.f12 := |v2|] := if (v0) then v57.cf8 else v3.f12];
					v0 := v3.f12;
				case DC1(cf1) =>
					...
					var v61: map<bool, bool> := map[v60[-f10] := !v3.f12];
					cf1 := fm7(map[v3.f12 := v59], cf1, v3.f13, globalState) || (|v61| != f10);
					globalState.f2 := |v37|;
					var v62: array<int> := new int[15](i6 => i6 / 850);
			...
			var v65: array<int> := new int[5](i7 => i7 / |[false, v0]|);
			v65[275] := f10;
			var v66: set<bool> := {v0, v0, v0};
			var v67: map<bool, int> := map[v0 := f10];
			v0, v0, v65[275], globalState.f2 := v0, v66 > v66, f10 + -305, -|v67|;
			...
			var v77: map<int, multiset<int>> := map[|v75| := multiset{v65[275], |v76|}];
			var v78: map<map<int, multiset<int>>, array<string>> := map[v77 := v70];
			var v81: map<int, int> := map[f10 := |v69|];
			var v82 := 'a';
			var v83: set<char> := {v82};
			v68[628], r0, v70, v0, v0 := v2 !! v2, if (v72 in v73) then v73[v72] else 0x109, if (((map v79 : int | (-398 <= v79) && (v79 < 0x1f0) :: (v79 - f10) := (multiset{|v66|, v65[275]})) + (map v80 : int | v80 in v81 :: (v80 % -0x11c) := (multiset{f10}))) in v78) then v78[(map v79 : int | (-398 <= v79) && (v79 < 0x1f0) :: (v79 - f10) := (multiset{|v66|, v65[275]})) + (map v80 : int | v80 in v81 :: (v80 % -0x11c) := (multiset{f10}))] else v70, v83 > (if (v0) then v83 else {v82, 'i'}), fm23(v81, v0, globalState) !! v66;
			v68[628] := (|"ethwsioyp"| - v65[275]) > |(fm24(v0, v76, v68[628], globalState) + multiset(v1))|;
		...
		var v91: C2 := new C2(v0, fm0(|(map v87 : int | v87 in v2 :: (v87 / f10) := (|multiset{|['g']|}|))|, f10, v88, v90, globalState));
		var v92: seq<C2> := [v91, v91];
		v86 := v86[v85 := |(v92 + v92)|];
		var v93: multiset<int> := multiset{|v85|};
		var v94: multiset<int> := multiset{f10, f10, |v89|, |v93|};
		var v95: multiset<multiset<int>> := multiset{multiset(seq(0x237, i9  => (|{'i'}|)))};
		var v96: array<multiset<int>> := new multiset<int>[15] [multiset((seq(0x153, i8  => (22))) + v1), v94, v94, multiset{f10, |f11|, |multiset{v91.f15}|, |v2|}, if (false) then v94 else v94, v93[f10 := f10], v94 * v93, fm24(v91.f15, v85, v91.f14, globalState), v94 * (multiset{f10})[|v95| := f10], v94 * v93, fm24(v91.f15, fm18(f10, v91.f15, |([v91.f15])[0x102 := true]|, globalState), v91.f15, globalState) * v94, multiset{f10, -f10}, v93, v93, v93];
		v96[259] := multiset(v1);
		v96[259] := (multiset{f10, 0x228} * v94) * v93;
		var v97 := DC11(v89);
		var v98: array<int> := new int[15](i10 => i10 % f10);
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
			...
			case DC13(cf22) =>
				...
				match (v2.(cf23 := v3)) {
					...
					case DC14(cf23) =>
						...
						var v22: map<map<int, map<int, bool>>, int> := map[v20 := v21[f10]];
						v22 := v22[map v23 : int | v23 in f11 :: (v23 - f10) := (f11) := f10];
						var v24 := "d";
						var v25: array<seq<int>> := new seq<int>[18] [v21, fm25(f10, f10, |v24|, f10, globalState), v21, v21, v21, v21, [f10], [f10], v21, v21, v21, v21, [f10, 0x2f6], seq(0x387, i0  => (f10)), v21, [f10], [f10], v21];
						var v26: C2 := new C2(v18.f16, if (-f10 in f11) then f11[-f10] else v18.f16);
						var v27: map<array<seq<int>>, C2> := map[v25 := v26];
						v27 := v27[v25 := v26];
						var v28: array<int> := new int[26](i1 => i1 - v21[f10]);
						v28[324] := f10 * |"dq"|;
						var v29: seq<bool> := [cf22];
						v28[324] := if (v21[f10] < -f10) then fm10(v26.f15, globalState) + |v29| else |v24|;
					case DC16(cf26) =>
						r2 := !(cf22 && cf22);
						globalState.f2 := 0xbb * f10;
						var v30 := new C2(cf22, false);
						var v31: seq<bool> := [v30.f15];
						var v32, v33 := v30.m3(v31[f10 := cf22] + [!v30.f15], globalState);
				}
				...
				var v40: map<int, int> := map[f10 := |(seq(-0x2fd, i2  => (v37)))|];
				r1 := |(v38 + v38[0x269 := v37])| * ((if (cf22 in v39) then v39[cf22] else f10) * (if (|v36| in v40) then v40[|v36|] else f10));
			case DC12(cf21) =>
		...
		var v57: array<map<bool, int>> := new map<bool, int>[13] [v55, v55, v55, v55, v55, v56[v49.f13] + v55, v55, map[v48 := v49.f13], v55 + map[!v48 := f10], v55 + v55, map[v51.f15 := |v53|], v55 + map[v51.f15 := v49.f13], v55];
		v57[456] := v55;
		var v58: array<char> := new char[5];
		var v59 := 'g';
		v58[966] := v59;
		var v60 := DC19(v55);
		r0, v57[456], v58[966], f10 := match if (v48) then v60 else v60 {
		...
		var v62 := DC0(-v49.f13);
		match (DC3((seq(0x39c, i3  => (DC25(v58[966]).cf37))) != v61[f10], v62)) {
			case DC2(cf2) =>
				v48 := v49.f12;
		...
		r3 := v51.fm13(|([v51.f14] + ([v48, !v51.f14, !v49.f12, v51.f15])[-v49.f13 := v51.f15])|, v73 >= v73, 0x16, globalState);
	}
}
...
method Main() {
	...
	var v8 := DC0(v1);
	var v9 := "joueqk";
	var v10: array<int> := new int[29] [-0x336, v1, v1, v1, v1, v1, -v1, 0x120, v1, v1, |v3|, |([v5, map[0x37 := v4], map[v1 := v4]])[|v7| := v5]|, v1, v1, |v5|, v1, v1, v1, v8.cf0, v1, v1, 576, v1, |v9|, v1, -713, v1, v1, v1];
	...
	if (fm0(v1, v1, v14, v15, globalState)) {
		...
		v20[428] := v1 <= |v6|;
		v17, v17, globalState.f2, v20[428] := false, v18, 0x105, v16 >= v1;
		var v21 := DC2(v17);
		v21 := DC2(true);
		v18 := v3 == [v16];
		...
		if (fm0(v1, v1, v14, v15 + v15, globalState)) {
			...
			v32[58] := v27;
			v10[317], v31[94], v32[58], v1 := v26 * v26, v8, fm0(|v5|, v1, v14, map[v9 := v4], globalState), v26;
			...
			v28, v10[553], v4, v28, v10[553] := v4, 0x89, (-0x1e5 * v26) <= v26, true, |v40| * -|"d"|;
		}
	...
	for i2 := v1 to v1 {
		match (v8) {
			case DC0(cf0) =>
				...
				globalState.f4, v41, v4 := v42[|map[v6[|fm2(!v4, cf0, |v43|, v4, globalState)|] := false]|], v41, false;
				v43 := v43[v4 := v4];
				v9 := v9;
		}
	...
	if (v4) {
		...
		var v61: map<map<char, int>, int> := map[v60 + v60 := -347 % v1];
		v61 := v61 + v61;
	...
	for i3 := fm17(!false, v1, v4, v1, globalState) to v1 % v1 {
		...
		v10[971] := i3;
		v10[971] := i3;
		v9, globalState.f2, globalState.f2 := fm2(v4, -v10[971], v1, !v4, globalState), 0x381 / i3, v10[971];
	}
	if (v4) {
		...
		match (v69) {
			case DC10(cf17, cf18, cf19) =>
				...
				var v72 := 'a';
				v4, v71, v4 := if (DC11("bonxg").cf20 < v9[v1 := v72]) then v51.f16 else v51.f16, v71, v1 >= (cf19 - v1);
			...
			case DC9(cf16) =>
				...
				var v77, v78 := v51.m5(v3[v1], globalState);
		}
		
		var v79: array<bool> := new bool[6];
		v79[399] := if (v51.f16) then v51.f16 else v51.f16;
		v79[399] := !v51.f16;
		globalState.f2 := v1;
		match (DC26()) {
			case DC25(cf37) =>
				var v80 := DC13(v79[399]);
				...
				v82[852] := set v85 : seq<int> | v85 in v83[v3 := |v84|] :: (v85);
				v82[852] := {v3, v3[v1 := |(seq(0x241, i4  => (cf37)))|] + v3, fm25(v1, v1, v1, |v7|, globalState)};
			case DC26() =>
				v10[896] := |v9|;
				v10[896] := v1;
				v79[399] := v51.f16;
				var v86 := 'b';
				v4 := if (v79[399]) then !!v51.fm4(v1, v51.f16, v86, globalState) else v79[399];
				var v87: array<string> := new string[1] [v9];
				v87[818] := v9;
				var v88: C2 := new C2(v51.f16, v79[399]);
				var v89: map<C2, bool> := map[v88 := v88.f14];
				var v90 := DC11(v9);
				var v91 := DC28(v89);
				var v92: map<int, C1> := map[v1 := v51];
				v87[818], v89, globalState.f2, v51, v86 := (v9 + v90.cf20) + v9, v91.cf39, v10[896], if (v4) then v51 else if (--|v6| in v92) then v92[--|v6|] else v51, v86;
			case DC24(cf36) =>
				var v93: set<bool> := {v51.f16};
				var v94: map<int, int> := map[v1 := v1];
				v79[399] := v93 > (fm23(v94, v51.f16, globalState) + {true, v51.f16});
				var v95: map<bool, int> := map[false := v1];
				v95 := v95[if (v51.f16) then v4 else v51.f16 := --v1 % v1];
				globalState.f2 := |v5|;
				globalState.f2 := v1;
			case DC27(cf38) =>
				var v96 := 'y';
				...
				v79[399], v79[399], v97 := fm19(v97.f10, globalState) == v97.f10, v97.f10 >= v1, v97;
				v79[399] := v51.f16;
				v10[765] := v1;
				v10[765] := v97.f10;
		}
		
		var v98: map<bool, int> := map[v79[399] := |v3[v1 := v1]|];
		var v99 := 'e';
		v4, v4, v9, v79[399], v98 := v1 <= v1, v79[399], v9, v68.fm4(-v1, v9 == v9, v99, globalState), v98;
	} else {
		var v100: array<bool> := new bool[29];
		var v101 := DC29(v100, v4);
		v4 := v101.cf41;
		var v102: T0 := new C2(|v3[|v9| := v1]| >= v1, v1 <= v1);
		...
		var v105: C2 := new C2(v4, v6[v104.f10]);
		...
		if (!v51.f16) {
			...
			var v109 := 's';
			globalState.f2, v9, v9 := v104.f10, ((seq(111, i5  => ('o'))) + fm2(v51.f16, v108.f13, -v108.f13, v105.f14, globalState))[|v6| := v109], v9;
			v100[892] := !true;
			v100[892] := v105.f15;
			var v110: C3 := new C3(v3[v108.f13], v104.f11[v108.f13 := v4]);
			v110 := v110;
		...
		decreases 100 - i6
	{
		...
		var v130 := DC9(fm14(v128, v4, v129, v121[366], globalState));
		v130 := v130;
		var v131: set<seq<bool>> := {v6 + v6, v6};
		var v132: seq<map<bool, int>> := [v129];
		var v133: map<bool, seq<bool>> := map[v4 := v6[v1 := v121[366]]];
		...
		var v137: map<int, int> := map[v10[884] := v10[884]];
		var v138: map<bool, map<int, int>> := map[v51.f16 := v137];
		v131 := v136[|(v138 + v138)|];
		var v139: multiset<multiset<int>> := multiset{multiset{|map[v3[v1] := v120]|}, v2, v2};
		v139 := v139;
	}
	v121[366] := true;
	...
	if (|v141| <= v1) {
		var v142 := DC35([v51]);
		var v143: seq<C1> := [v51];
		v4 := !((v7 * {|(v142.(cf50 := v143)).cf50[v1 := v51]|}) >= (v7 - v7));
		v10[884] := |(set v144 : int | (0x3f <= v144) && (v144 < 0x3e0) :: (v144 % |v9|))|;
		var v145 := DC26();
		v145 := v145;
		...
		if (v51.f16) {
			...
			var v150: map<int, C3> := map[v10[884] := v149[v10[884]]];
			v150 := v150[fm10(v51.f16, globalState) := v118];
			v4 := true;
			var v151: seq<string> := [v9[v146 := v120]];
			v1 := if (v1 in v2) then v2[v1] else |v151[v146]|;
		} else {
			var v152, v153 := v51.m5(v10[884], globalState);
		...
		v4 := v167 != (v167 * v167);
		if (v6[v1 * |multiset{!fm0(v10[884], v1, v14, map[v9 := fm0(v3[-0x31d], |v9|, v14, v15, globalState)], globalState), v51.f16, v4}|]) {
			var v168 := new C1(!!(v2 != multiset{v1}), v50);
			var v169: array<set<string>> := new set<string>[19];
			var v170: set<string> := {v9};
			v169[741] := v170 * {v9};
			v169[741] := v170;
			v1 := fm17(v4, v1, v51.f16, |map[v10[884] := false]|, globalState);
			v121 := v121;
			var v171: seq<C3> := [v118, v118, v118, v118, v118];
			var v172: set<seq<C3>> := {v171};
			var v173: map<int, int> := map[v10[884] * --v1 := -|v172|];
			v173 := map v174 : int | v174 in v3 :: (v174 - v10[884]) := (39);
		} else {
			v4 := "yx" < v9;
			v4 := v121[366];
			var v175 := DC41(v14);
			...
			var v177: map<int, int> := map[v10[884] := |v176| - |v3|];
		...
		match (DC28(v183 + v183)) {
			case DC29(cf40, cf41) =>
				globalState.f2, globalState.f2 := v1, v10[884];
				v118 := v118;
				var v184, v185 := v51.m5(-0x35f, globalState);
				v182.m4(v182.f15, v184, globalState);
			case DC28(cf39) =>
				var v186 := new C1(-0x3d5 == fm17(!v182.f15, -0x193, v51.f16, v10[884], globalState), v51.f17);
				v182 := v182;
				globalState.f2 := v1;
				var v187 := DC4(v10);
				...
				v188[628], v10[884], v190, v13, globalState.f2 := if (!v182.f15) then v187 else v187, 0x11e, v190, v13, v1;
			case DC30(cf42) =>
				var v191: T0 := new C1(if (0x80 in v5) then v5[0x80] else true, v51.f17);
				v191, globalState.f2, globalState.f2, v7 := v191, v1 / -v10[884], (v1 - v10[884]) * v1, v7;
				var v192: C0 := new C0(v182.f14, v1);
				var v193: map<bool, C0> := map[v182.f14 := v192];
				var v194 := DC33(v121, v182, v193, v51.f16);
				var v195: map<int, array<bool>> := map[--(if (v10[884] in v2) then v2[v10[884]] else fm19(v1, globalState)) := v194.cf45];
				v195 := v195[v1 := v121];
				var v196, v197, v198, v199 := v118.m2(globalState);
				globalState.f2 := -v10[884];
		}
		...
		decreases 100 - i7
	{
		...
		var v201 := DC6(v10[884], v51.f16, v51.f16, v1, v51.f16);
		v200[522] := v201;
		v200[522] := v201;
		v4 := v121[366];
