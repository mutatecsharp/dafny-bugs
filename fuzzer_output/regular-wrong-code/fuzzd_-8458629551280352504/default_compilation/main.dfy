...
class C0 {
	...
	function fm16(p0: int, globalState: GlobalState): int {
		safeModuloInt(safeModuloInt(|[true]|, |"qb"|), |(if (true) then [false, true] else [false, !false, true, !!!!false, true])|)
	}
}
...
class C1 extends T0 {
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		if (p0 < p0) {
			...
			var v1: C0 := new C0(seq(abs(-0x2c5), i0  => (p0)), v0);
			v1 := v1;
			...
			v5[safeIndex(865, v5.Length)] := fm38(true, globalState);
			var v6 := true;
			var v7: set<bool> := {v6};
			v5[safeIndex(770, v5.Length)] := v6 in v7;
			var v8: multiset<bool> := multiset{v6, v6, v6, v6};
			r1, v5[safeIndex(865, v5.Length)], r1, v5[safeIndex(770, v5.Length)] := 106, !!(v8[v6 := abs(p0)] >= v8), p0, -0x34d >= 0x169;
			var v9 := "bji";
			var v10: array<int> := new int[2];
			var v11: map<string, array<int>> := map[v9 := v10];
			v11 := v11[seq(abs(851), i3  => ('r')) := v10];
			var v12: array<multiset<bool>> := new multiset<bool>[19](i4 => v8);
			v12[safeIndex(929, v12.Length)] := v8;
			v5[safeIndex(865, v5.Length)], v12[safeIndex(929, v12.Length)] := v5[safeIndex(865, v5.Length)] && (v7 < v7), (multiset{v6, v5[safeIndex(865, v5.Length)]} * v8) + multiset{v5[safeIndex(865, v5.Length)]};
			var v13: map<int, bool> := map[p0 := v5[safeIndex(865, v5.Length)]];
			var v14: map<bool, int> := map[v5[safeIndex(865, v5.Length)] := fm37(p0, p0, [-0x2bd], v13, globalState)];
			...
			if (if (v18 in v19) then v19[v18] else v5[safeIndex(865, v5.Length)]) {
				var v20: multiset<int> := multiset{p0};
				var v21: map<bool, multiset<int>> := map[v5[safeIndex(865, v5.Length)] := v20];
				var v22: seq<seq<int>> := [v15, [-|v21|, p0], v17.f16[safeIndex(p0, |v17.f16|) := p0]];
				var v23 := new C0(v22[safeIndex(p0, |v22|)], v17.f17);
				v5 := v5;
				var v24: array<D8> := new D8[13];
				var v25: map<bool, array<D8>> := map[v5[safeIndex(865, v5.Length)] := v24];
				...
				var v31: seq<map<int, bool>> := [map v30 : int | (0xee <= v30) && (v30 < 858) :: (safeModuloInt(v30, p0)) := (v6)];
				v28 := v28[v26 := map v29 : map<int, bool> | v29 in v31 :: (v29) := (v6)];
				v5 := v5;
				var v32: array<array<multiset<bool>>> := new array<multiset<bool>>[2];
				v32[safeIndex(236, v32.Length)] := v12;
				v32[safeIndex(236, v32.Length)] := new multiset<bool>[25];
			} else {
				v5[safeIndex(865, v5.Length)] := !v6;
				v9 := (v9 + v9) + v9;
				var v33: seq<multiset<bool>> := [v8];
				v33 := v33 + v33;
				var v34: map<int, seq<int>> := map[p0 := v17.f16];
				v34 := v34[-p0 := v17.f16];
				globalState.f8 := !v5[safeIndex(865, v5.Length)];
			}
		...
		var v41: array<char> := new char[27] [v35, 'w', v35, v35, v35, v35, 'l', v35, v35, v35, 'w', v35, v35, v35, v35, 'b', v35, if (v36) then v35 else v35, v35, v35, if (v36) then v37[safeIndex(p0, |v37|)] else v35, v35, v35, v37[safeIndex(fm37(p0, p0, seq(abs(0x7d), i5  => (|map[v36 := DC4({v37}, -0x1ca, !v36, -p0)]|)), v38, globalState), |v37|)], if (v40[safeIndex(p0, |v40|)] in v39) then v39[v40[safeIndex(p0, |v40|)]] else v35, v35, v35];
		var v42: array<bool> := new bool[10];
		var v43: map<int, string> := map[p0 := "ot"];
		var v44 := DC10(v42, v43, p0, v36);
		v41[safeIndex(425, v41.Length)] := v37[safeIndex(v44.cf19, |v37|)];
		var v45: set<bool> := {v36, v36, v36};
		v41[safeIndex(425, v41.Length)] := fm40(if (v36) then v45 else v45, globalState);
		r1 := p0;
		var v46: set<int> := {p0};
		...
		if (false) {
			...
			globalState.f8 := p0 in (if (v36) then v51 else seq(abs(401), i6  => (p0)));
			var v52 := DC14(v51);
			r1, v52 := p0, DC14(v51);
			...
			var v59: array<int> := new int[7](i7 => safeDivisionInt(i7, p0));
			var v60: map<bool, array<int>> := map[v36 := v59];
			var v61: map<bool, bool> := map[v36 := v36];
			var v62: map<int, map<bool, bool>> := map[p0 := v61];
			var v63: map<bool, bool> := map[v40[safeIndex(|v62|, |v40|)] := v36];
			var v64 := DC16(p0);
			var v65: multiset<bool> := multiset{!true};
			var v66: array<int> := new int[27] [p0 + p0, p0, p0, v57[safeIndex(p0, |v57|)], p0, p0 * --|v37|, p0, |v60|, p0, |v37|, p0, p0, fm2(p0, p0, globalState), |v37| * p0, p0, p0 * p0, p0, p0, 921, |v61| - p0, p0, safeDivisionInt(p0, p0), p0, if (v36) then p0 else p0, v64.cf26, |v65|, p0];
			v66[safeIndex(206, v66.Length)] := safeModuloInt(p0, p0);
			var v67: map<int, seq<bool>> := map[|(seq(abs(0x303), i8  => (v41[safeIndex(425, v41.Length)])))| := [fm38(v40[safeIndex(p0, |v40|)], globalState)]];
			r1, v40, v66[safeIndex(206, v66.Length)] := if (v36 in v65) then v65[v36] else p0, if (p0 in v67) then v67[p0] else v40, p0 * 0x2d;
			v66[safeIndex(206, v66.Length)] := -v66[safeIndex(206, v66.Length)] - v66[safeIndex(206, v66.Length)];
			globalState.f8 := v36;
			var v68 := DC0(v36);
			globalState.f8, v66[safeIndex(206, v66.Length)], r1 := v68.cf0, p0, 0x27a;
			v59 := v59;
		}
	...
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		...
		var v8: seq<bool> := [p0];
		v4[safeIndex(137, v4.Length)] := v7 + map[v5 := v8[safeIndex(v0, |v8|)]];
		v4[safeIndex(137, v4.Length)] := v7;
		var v9: map<int, bool> := map[v0 := p1];
		var v10: map<bool, bool> := map[if (v0 in v9) then v9[v0] else p0 := p0];
		for i1 := -v0 to |v10| {
			v0 := -0x1c6;
			var v11: array<int> := new int[12](i2 => safeDivisionInt(i2, i1));
			v11[safeIndex(202, v11.Length)] := v3.fm16(v0, globalState);
			v11[safeIndex(202, v11.Length)] := safeModuloInt(0x57, safeDivisionInt(i1, v0));
			var v12 := DC16(-v11[safeIndex(202, v11.Length)]);
			var v13: multiset<D7> := multiset{v12, v12, v12};
			v0 := |v13|;
			var v14 := 'c';
			var v15: array<string> := new string[7] [v6 + v6, (seq(abs(0x70), i3  => ('o'))) + v6, v6[safeIndex(v11[safeIndex(202, v11.Length)], |v6|) := 't'], v6 + (seq(abs(0x268), i4  => ('l'))), v6[safeIndex(v0, |v6|) := v14], v6, v6 + "houjs"];
			v15 := v15;
		}
		...
		if (p0 || p0) {
			if ((p0 || true) <== (v0 >= v0)) {
				...
				v24[safeIndex(299, v24.Length)] := v20;
				...
				globalState.f4, globalState.f8, v20, v24[safeIndex(299, v24.Length)], globalState.f8 := v6, v25 >= (if (p0 in v28) then v28[p0] else v25), v20, DC6(v20).cf13, v22;
			} else {
				globalState.f8 := p0;
				var v29: set<int> := {0x75};
				var v30: set<bool> := {!p1, p1};
				var v31 := new C0(([--|v29|, v0, v0])[safeIndex(v0, |[--|v29|, v0, v0]|) := fm5(true, v30, p1, p1, globalState)], v16.f17);
				v0 := v0;
				...
				v35, v0, v39 := "oxyk" <= v6[safeIndex(v0, |v6|) := v33], 199, v39;
			}
			...
			v41[safeIndex(399, v41.Length)] := v40;
			v41[safeIndex(399, v41.Length)] := v40;
			if (false) {
				...
				var v44 := 'f';
				v0 := -safeModuloInt(-|fm41(false, |v6[safeIndex(v0, |v6|) := v44]|, |(map v45 : int | v45 in ([|v6|, |v6|, v0, v0, v0])[safeIndex(-fm2(v0, v0, globalState), |[|v6|, |v6|, v0, v0, v0]|) := v0] :: (v45 * v0) := (p0))|, p0, globalState)|, v0);
			...
			globalState.f8 := v0 >= safeModuloInt(v0, v0);
			v5[safeIndex(336, v5.Length)] := p0;
			v5[safeIndex(336, v5.Length)] := false;
			globalState.f8 := p1;
			...
			v53[safeIndex(93, v53.Length)] := v8 + v54[safeIndex(v0, |v54|)];
			var v55: map<int, int> := map[v0 := 0x3a0];
			var v56 := DC1(|v8|, v8, multiset{v5[safeIndex(336, v5.Length)]}, v5[safeIndex(336, v5.Length)], |v55|);
			var v57: multiset<bool> := multiset{p0, !v56.cf4};
			var v58: seq<map<int, int>> := [v55, v55];
			v53[safeIndex(93, v53.Length)], v0, v5[safeIndex(336, v5.Length)], v0, globalState.f8 := v54[safeIndex(|v57|, |v54|)], v0, v5[safeIndex(336, v5.Length)], v0, v58 < v58;
		}
	...
	method m12(p0: bool, p1: bool, p2: int, p3: seq<bool>, globalState: GlobalState) returns (r0: char, r1: array<map<D2, bool>>, r2: bool, r3: seq<int>) {
		...
		var v8: set<int> := {-p2};
		var v9: array<int> := new int[14] [p2, p2, p2, |v6|, p2, p2, p2, p2, fm37(p2, p2, v3, v2, globalState), p2, fm5(p1, v7, p1, p1, globalState), p2, p2, -|(multiset(p3))[p1 := abs(|v8|)]|];
		...
		if (p0) {
			...
			var v14 := 'o';
			var v15: map<int, string> := map[|{v11, p2, v11}| + p2 := if (v12 in v13) then v13[v12] else v0[safeIndex(|v5.f16|, |v0|) := v14]];
			v15 := v15;
			...
			var v19 := DC14(seq(abs(0xd7), i0  => (p2)));
			v9[safeIndex(816, v9.Length)] := safeModuloInt(p2, fm37(0x44, p2, v19.cf24, v2, globalState));
			v9[safeIndex(816, v9.Length)] := safeModuloInt(p2, |v8|);
			v7 := v7 * v7;
			var v20 := DC24(v4);
			...
			if (p0 || p0) {
				...
				v23[safeIndex(787, v23.Length)] := v24;
				v23[safeIndex(787, v23.Length)] := v24;
				v9[safeIndex(816, v9.Length)] := p2;
				var v25 := new C0(seq(abs(-86), i1  => (|map['p' := v9[safeIndex(816, v9.Length)]]|)), v21.f17);
				var v26 := DC12(v23);
				var v27: map<D5, bool> := map[v26 := v9[safeIndex(816, v9.Length)] >= -p2];
				v27 := v27[v26 := p1];
				v9[safeIndex(816, v9.Length)] := -(|map[v0 := p2]| * v9[safeIndex(816, v9.Length)]);
			} else {
				v9[safeIndex(816, v9.Length)] := p2;
				var v28: map<bool, int> := map[false := p2];
				var v29: multiset<map<bool, int>> := multiset{map[if (v9[safeIndex(816, v9.Length)] in v2) then v2[v9[safeIndex(816, v9.Length)]] else false := v9[safeIndex(816, v9.Length)]] + v28};
				v29 := multiset{v28[p0 := 816]} - (v29[v28 := abs(0x3aa)] * multiset{map[p1 := v9[safeIndex(816, v9.Length)]]});
				var v30: array<bool> := new bool[16];
				var v31: map<bool, array<bool>> := map[p1 := v30];
				v9[safeIndex(816, v9.Length)] := (|(seq(abs(-0x3b5), i2  => ('e')))| + 668) + |(v31 + v31)|;
				var v32: array<map<D2, int>> := new map<D2, int>[26];
				var v33: map<int, array<map<D2, int>>> := map[v9[safeIndex(816, v9.Length)] := v32];
				v33 := v33[v9[safeIndex(816, v9.Length)] := v32];
				v9[safeIndex(816, v9.Length)] := |v0|;
			}
			
		}
		
		r3 := fm44(safeModuloInt(-|map[p2 := v0]|, 0x1d7), globalState);
		for i3 := p2 to safeModuloInt(0x3d0, 360) {
			var v34: array<bool> := new bool[17];
			v34[safeIndex(457, v34.Length)] := p1;
			v34[safeIndex(457, v34.Length)] := p0;
			var v35: array<seq<seq<int>>> := new seq<seq<int>>[24](i4 => seq(abs(0x34), i5  => (v5.f16)));
			v35[safeIndex(122, v35.Length)] := [v3];
			r2, v35[safeIndex(122, v35.Length)] := p1, fm45(p2, globalState);
		...
		if (fm0(|multiset(p3)|, v0, globalState)) {
			var v37 := 0x33d;
			v37 := v37;
			v9[safeIndex(337, v9.Length)] := v37;
			var v38: array<set<bool>> := new set<bool>[12](i6 => {false, true, p0});
			v9[safeIndex(337, v9.Length)], v37, v38 := --p2, p2, v38;
			var v39: map<bool, bool> := map[p0 := true];
			v39 := v39;
			var v40: array<string> := new string[29];
			v40[safeIndex(615, v40.Length)] := v0;
			v40[safeIndex(615, v40.Length)] := v0;
			v37 := v5.fm16(v9[safeIndex(337, v9.Length)], globalState);
		} else {
			var v41 := DC13(p2);
			...
			v3 := if ((p2 <= v43) in v44) then v44[p2 <= v43] else seq(abs(0x149), i7  => (p2));
			r2 := p1;
		}
		...
		r2 := |(p3[safeIndex(|v60|, |p3|) := false] + p3)| == p2;
		r3 := v5.f16 + (v5.f16 + (seq(abs(0xfd), i8  => (p2))));
	}
}
...
class C2 extends T3 {
	...
	method m2(globalState: GlobalState) {
		...
		match (v1) {
			case DC4(cf8, cf9, cf10, cf11) =>
				...
				cf9, cf10, v6 := safeDivisionInt(v9.cf11, |(v0 + v0)|), f10, v10.cf28;
				...
				v16[safeIndex(50, v16.Length)] := cf10;
				v16[safeIndex(50, v16.Length)] := cf10;
			case DC3(cf7) =>
				var v17: map<int, int> := map[f20 := |cf7|];
				var v18: multiset<string> := multiset{seq(abs(-0x38e), i0  => ('k'))};
				...
				var v26: array<int> := new int[18] [f20, f20, |v19| + f20, safeDivisionInt(f20, f20), f20 - f20, 0x334 - f20, safeDivisionInt(0x112, -0x1af), f20, f20, f20, |v21|, |(v22 * {|(seq(abs(0x5e), i2  => ('l')))|, |v17|, |[f10]|, f20, f20})|, |v24| - 0x205, f20, |v25| * -|v0|, f20, f20, f20];
				var v27: seq<string> := [v0];
				var v28: map<bool, seq<string>> := map[false := v27];
				v26[safeIndex(803, v26.Length)] := |multiset((seq(abs(23), i3  => (v0))) + (if (fm34(|{f20}|, false, |cf7|, globalState) in v28) then v28[fm34(|{f20}|, false, |cf7|, globalState)] else v27))|;
				v26[safeIndex(803, v26.Length)] := f20;
				var v29: seq<int> := [f20];
				var v30: array<map<bool, bool>> := new map<bool, bool>[18];
				var v31: C0 := new C0(v29, v30);
				var v32: map<C0, string> := map[v31 := cf7 + cf7];
				var v33: seq<C0> := [v31];
				v32 := v32[v33[safeIndex(0xa6, |v33|)] := cf7[safeIndex(v26[safeIndex(803, v26.Length)], |cf7|) := v23]];
				v0 := cf7;
			case DC5(cf12) =>
				var v34 := 'r';
				...
				var v41: seq<int> := [|v0|];
				var v42: array<int> := new int[20] [f20, f20, |v35| * |(if (!true in v36) then v36[!true] else v39)|, f20, |v40|, safeDivisionInt(0x3e0, f20), f20, -safeModuloInt(|v0|, f20), f20 - f20, f20, |v0|, safeModuloInt(|v41|, f20), |v0|, safeModuloInt(|v35|, f20), f20, 61, -0x8b, f20 * f20, f20, 289];
				...
				var v49: map<int, int> := map[523 := |multiset{|v0|, |v47[safeIndex(|v48|, |v47|)]|, f20, f20}|];
				v34, v42, globalState.f8 := if (fm5(f10, v43, f10, f10, globalState) != f20) then v34 else fm36(v0, globalState), v42, safeDivisionInt(f20, f20) !in v49;
				var v50 := 0xd9;
				var v51: T0 := new C1();
				var v52: seq<T0> := [v51, v51];
				var v53: map<array<int>, T0> := map[v42 := v52[safeIndex(f20, |v52|)]];
				v50 := |v53|;
				var v54: array<char> := new char[22] [if (v35[safeIndex(f20, |v35|)]) then 'y' else v34, v34, fm40(v43, globalState), v34, 'b', fm40(v43, globalState), v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34, v34];
				var v55 := DC6(DC6(v34).cf13);
				v54[safeIndex(222, v54.Length)] := v55.cf13;
				v54[safeIndex(222, v54.Length)] := v34;
				v50 := v50;
		}
		...
		v58[safeIndex(480, v58.Length)] := f10;
		var v59 := -0x2b6;
		var v60: seq<bool> := [f10];
		var v61: map<bool, int> := map[f10 := |v60|];
		var v62: multiset<bool> := multiset{f10};
		globalState.f8, v58[safeIndex(480, v58.Length)], v59, globalState.f5, v60 := f10, v0 != fm1(|v61|, globalState), |fm33(globalState)|, v62 - (v62 + v62), v60;
		var v63 := DC1(v59, v60[safeIndex(f20, |v60|) := f10], v62, v58[safeIndex(480, v58.Length)], v59);
		for i5 := if (v58[safeIndex(480, v58.Length)] in v61) then v61[v58[safeIndex(480, v58.Length)]] else --0x9a to v63.cf1 {
			if ((fm48(globalState)).cf31) {
				...
				v69[safeIndex(698, v69.Length)] := v70;
				v69[safeIndex(698, v69.Length)] := v70;
				globalState.f8 := v58[safeIndex(480, v58.Length)];
				globalState.f8 := f10;
				var v71 := new C1();
			} else {
				...
				var v75 := DC18(v74[safeIndex(-167, |v74|)]);
				var v76: array<char> := new char[18](i6 => 'o');
				var v77: multiset<array<char>> := multiset{v76};
				v75, v59, globalState.f8 := v75, if (f10) then |(multiset{v76, v76} * v77[v76 := abs(v59)])| else f20, v58[safeIndex(480, v58.Length)];
				var v78: array<multiset<bool>> := new multiset<bool>[4](i7 => v62);
				v78[safeIndex(685, v78.Length)] := v62;
				v78[safeIndex(685, v78.Length)] := v62;
				v58[safeIndex(480, v58.Length)] := safeModuloInt(v59, v59) > v63.cf1;
				var v79 := new C1();
				globalState.f8 := (v60 <= v60) || v58[safeIndex(480, v58.Length)];
			}
			
			var v80: array<int> := new int[5] [i5, fm2(v59, |{v59, f20, v59}|, globalState), i5, v59, fm5(v58[safeIndex(480, v58.Length)], {true, v58[safeIndex(480, v58.Length)]}, f10, f10, globalState)];
		...
		forall i8 | 0 <= i8 < v58.Length {
			v58[i8] := (multiset{f20, |v0|} + multiset{f20, f20, |map[true := 'j']|, v59}) >= multiset{if (v58[safeIndex(480, v58.Length)] in v61) then v61[v58[safeIndex(480, v58.Length)]] else v59, f20, v59};
		}
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
		...
		for i0 := fm2(f20, p0, globalState) to -|v0| {
			...
			v11 := (v11 + v11)[safeIndex(safeDivisionInt(|v12|, |v4.f16|), |(v11 + v11)|) := v10 - v11[safeIndex(f20, |v11|)]];
		}
		for i3 := f20 to f20 {
			var v13 := 0x2b1;
			var v14 := "irliahq";
			...
			var v18 := 'k';
			globalState.f8, v13, v15, globalState.f8, v13 := !f10, fm5(fm34(|v15|, f10, v15[safeIndex(353, |v15|)], globalState), v16, |fm42(f10, f10, fm49(globalState), globalState)| <= -666, if (v18 in v17) then v17[v18] else f10, globalState), v15 + v15, !f10, fm2(-f20, i3 + -v13, globalState);
			var v19: C1 := new C1();
			v19 := v19;
			globalState.f8 := f10;
			v13 := -safeDivisionInt(-v13, v13);
		}
		var i4 := 0;
		while (f10)
			decreases 100 - i4
		{
			...
			var v26: array<int> := new int[19] [p0, |v23[safeIndex(|v24|, |v23|)]|, f20, p0, p0, f20, p0, -72, f20, f20, |v22|, DC25(f20, [f10, false, f10, f10]).cf38, f20, p0, 589, p0, p0, f20, |v25|];
			...
			var v32: C1 := new C1();
			var v33: seq<C1> := [v32];
			var v34: set<C1> := {v33[safeIndex(v21[safeIndex(f20, |v21|)], |v33|)], v32};
			v34 := v34;
		}
		var v35: array<bool> := new bool[1](i5 => f10 && f10);
		v35[safeIndex(194, v35.Length)] := false;
		v35[safeIndex(194, v35.Length)] := true;
		var v36: seq<string> := [seq(abs(0xc1), i6  => ('a'))];
		...
		if (v40 <= v40) {
			...
			if (v41 > v41) {
				...
				v35[safeIndex(194, v35.Length)] := if ((|v42| + f20) in v38) then v38[|v42| + f20] else f10;
				var v43: array<int> := new int[25];
				v43[safeIndex(837, v43.Length)] := -p0;
				v43[safeIndex(837, v43.Length)] := |(v37 + v37)|;
				var v44 := DC3("otdhx");
				v44, v43[safeIndex(837, v43.Length)] := fm50(v43[safeIndex(837, v43.Length)], globalState), -704;
				var v45: array<string> := new string[16](i7 => "igphq");
				v45[safeIndex(627, v45.Length)] := "ttxj" + "yghwc";
				var v46 := "u";
				var v47 := 'e';
				v45[safeIndex(627, v45.Length)] := ((if (f10) then v46 else v46) + (v46 + v46))[safeIndex(safeModuloInt(v43[safeIndex(837, v43.Length)], -|(seq(abs(942), i8  => ('a')))|), |((if (f10) then v46 else v46) + (v46 + v46))|) := v47];
				v35[safeIndex(194, v35.Length)], v43[safeIndex(837, v43.Length)] := f10, v43[safeIndex(837, v43.Length)];
			} else {
				var v48 := "ws";
				globalState.f4 := v48;
				v35[safeIndex(194, v35.Length)] := v48 < (v48 + (seq(abs(0x83), i9  => ('d'))));
				var v49: seq<int> := [f20];
				var v50: array<map<bool, bool>> := new map<bool, bool>[11](i10 => map[v35[safeIndex(194, v35.Length)] := v35[safeIndex(194, v35.Length)]]);
				var v51 := new C0(v49, v50);
				r1 := v48[safeIndex(|v48|, |v48|)];
				var v52 := DC1(f20, v0, fm51(f20, globalState), v35[safeIndex(194, v35.Length)], p0);
				var v53 := DC2(v52);
				var v54 := DC2(v53);
				var v55 := DC2(v53);
				v55 := v55;
			...
			v56[safeIndex(572, v56.Length)] := set v60 : seq<bool> | v60 in v59 :: (v60);
			var v61 := 0x3b0;
			var v62: array<int> := new int[8](i11 => safeDivisionInt(i11, v61));
			v62[safeIndex(703, v62.Length)] := v61;
			var v63: seq<array<int>> := [v62, v62, v62];
			var v64: map<array<int>, array<int>> := map[v62 := v63[safeIndex(p0, |v63|)]];
			var v65: map<seq<bool>, bool> := map[[v35[safeIndex(194, v35.Length)]] := fm0(fm2(0x22c, fm2(-f20, p0, globalState), globalState), "lpsg", globalState)];
			var v66: map<int, int> := map[-|v65| := f20];
			var v67: seq<int> := [|v66|];
			globalState.f8, v56[safeIndex(572, v56.Length)], v61, v62[safeIndex(703, v62.Length)] := |v64| > v61, v59 - v59, if (f10) then |v67| - -0x387 else v61 - v61, fm5(f10, {v35[safeIndex(194, v35.Length)], f10}, f10, f10 || v35[safeIndex(194, v35.Length)], globalState);
			var v68: array<array<bool>> := new array<bool>[16];
			v68[safeIndex(371, v68.Length)] := v35;
			v68[safeIndex(371, v68.Length)] := v35;
			var v69 := 'b';
			var v70 := DC6(v69);
			var v71 := "qegervaat";
			var v72: seq<char> := [fm36(v71, globalState), v69, v69];
			var v73: array<char> := new char[14] [v70.cf13, v69, v69, v69, v69, v69, v69, v69, v71[safeIndex(|v72|, |v71|)], v69, v69, v69, v69, v69];
			globalState.f8, v73, globalState.f8 := f10, v73, f10;
			var v74, v75, v76, v77 := m11(globalState);
		} else {
			r1 := 'm';
			var v78: array<int> := new int[19];
			v78[safeIndex(739, v78.Length)] := f20;
			v78[safeIndex(739, v78.Length)] := safeModuloInt(p0, f20);
			v35[safeIndex(194, v35.Length)] := v35[safeIndex(194, v35.Length)];
			v35[safeIndex(194, v35.Length)] := (v35[safeIndex(194, v35.Length)] <== !f10) && f10;
			var v79: seq<int> := [v78[safeIndex(739, v78.Length)]];
			globalState.f8 := fm6(v79 + (seq(abs(232), i12  => (p0))), globalState);
		}
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		...
		v4[safeIndex(628, v4.Length)] := |v5|;
		var v6 := "oe";
		v4[safeIndex(628, v4.Length)] := -fm2(--(f20 * |fm52(fm0(p0, v6, globalState), |map[f10 := f20]|, globalState)|), f20, globalState);
		v4[safeIndex(628, v4.Length)] := v4[safeIndex(628, v4.Length)];
		var v7 := DC8(DC6(v0));
		if (match v7 {
			case DC7(cf14) => !({[v4[safeIndex(628, v4.Length)]], [p0]} < {seq(abs(-723), i1  => (p0)), DC19(seq(abs(598), i2  => (0x82)), f20, f10, DC1(f20, [f10], multiset{f10}, f10, |v6|)).cf29})
			...
			if (f10) {
				...
				v9[safeIndex(458, v9.Length)] := f10;
				v9[safeIndex(458, v9.Length)] := f10;
				...
				var v16: set<bool> := {!!v9[safeIndex(458, v9.Length)]};
				var v17: map<bool, int> := map[false := |v16|];
				v4[safeIndex(628, v4.Length)], v4[safeIndex(628, v4.Length)], r1, v13, v4[safeIndex(628, v4.Length)] := |(if ((f20 * p0) in v15) then v15[f20 * p0] else v6)|, -f20, safeModuloInt(p0 * p0, f20), v13, -(if (v9[safeIndex(458, v9.Length)]) then if (false in v17) then v17[false] else |{v0, v0, v0, v0, v0}| else -f20) - (f20 - f20);
				var v18 := new C0(seq(abs(0x327), i3  => (|v14|)), v12.f17);
				v9 := new bool[21];
			} else {
				var v19 := new C1();
				var v20: map<C1, bool> := map[v19 := f10];
				var v21: map<bool, int> := map[false := if (f10) then v4[safeIndex(628, v4.Length)] else |v20[v19 := f10]|];
				v21 := v21[f10 := v4[safeIndex(628, v4.Length)]];
				var v22: map<array<int>, int> := map[v4 := v4[safeIndex(628, v4.Length)]];
				v22 := v22 + v22;
				var v23: map<int, bool> := map[f20 := f10];
				var v24 := DC15(v23[v4[safeIndex(628, v4.Length)] := f10]);
				v24 := v24;
			...
			match (v26.(cf12 := v25).(cf12 := v25)) {
				case DC4(cf8, cf9, cf10, cf11) =>
					...
					v27[safeIndex(391, v27.Length)] := v28 !! v28;
					v27[safeIndex(391, v27.Length)] := !f10;
					var v29: map<bool, int> := map[true := p0];
					var v30: seq<map<bool, int>> := [v29, v29];
					cf11 := -safeDivisionInt(v4[safeIndex(628, v4.Length)], safeDivisionInt(|map[|(set v31 : map<bool, int> | v31 in v30[safeIndex(f20, |v30|) := v29] :: (v31))| := |v5|]|, fm2(|v28|, v4[safeIndex(628, v4.Length)], globalState)));
					globalState.f8 := v27[safeIndex(391, v27.Length)];
					var v32: seq<array<int>> := [v4];
					var v33: seq<int> := [|fm44(v4[safeIndex(628, v4.Length)], globalState)|];
					var v34: multiset<bool> := multiset{v27[safeIndex(391, v27.Length)]};
					var v35: map<int, bool> := map[|v34| := f10];
					v4 := v32[safeIndex(fm2(cf11, v33[safeIndex(|v35|, |v33|)], globalState), |v32|)];
				case DC3(cf7) =>
					v0 := v0;
					var v36 := new C1();
					var v37: seq<int> := [v4[safeIndex(628, v4.Length)], v4[safeIndex(628, v4.Length)], f20];
					var v38: array<map<bool, bool>> := new map<bool, bool>[10];
					var v39 := new C0(v37, v38);
					var v40: seq<bool> := [f10, f10];
					var v41: map<bool, int> := map[v40[safeIndex(|v39.f16|, |v40|)] := -f20 - v4[safeIndex(628, v4.Length)]];
					r1 := |v41|;
				case DC5(cf12) =>
					globalState.f8 := f10;
					var v42: map<int, int> := map[f20 := v4[safeIndex(628, v4.Length)]];
					var v43: seq<int> := [p0];
					...
					r1, globalState.f8, globalState.f8 := safeDivisionInt(|([|v42|, f20, p0] + v43)|, |v45|), f10 <==> f10, v47 !! v47;
					globalState.f4 := v6;
					var v48: map<bool, int> := map[f10 := p0];
					r1 := safeModuloInt(|v43|, |v48|);
			}
			
			var v49: array<map<int, C1>> := new map<int, C1>[11];
			var v50: C1 := new C1();
			var v51: map<int, C1> := map[f20 := v50];
			v49[safeIndex(9, v49.Length)] := v51 + v51[p0 := v50];
			var v52: array<bool> := new bool[13](i5 => f10);
			var v53: set<int> := {v4[safeIndex(628, v4.Length)]};
			v52[safeIndex(686, v52.Length)] := v53 >= v53;
			var v54: array<string> := new string[9](i6 => v6);
			v54[safeIndex(487, v54.Length)] := seq(abs(0x21d), i7  => (v0));
			var v55: map<bool, string> := map[f10 := v6];
			var v56: seq<string> := ["knrsifkx", ("fxeqn")[safeIndex(v4[safeIndex(628, v4.Length)], |"fxeqn"|) := v0] + v6, if (f10) then "wu" else v6, (seq(abs(0xc5), i8  => (v0))) + v6, v6 + (seq(abs(-0x36), i9  => (v0)))];
			globalState.f8, r1, v49[safeIndex(9, v49.Length)], v52[safeIndex(686, v52.Length)], v54[safeIndex(487, v54.Length)] := f10, safeDivisionInt(|v55|, |v5|), v51, f10, v56[safeIndex(f20, |v56|)];
		} else {
			if (false) {
				v0 := v0;
				var v57 := DC13(|(seq(abs(0x26f), i10  => (v0)))|);
				var v58: seq<D5> := [v57, v57, v57, v57, v57];
				v58 := seq(abs(0x1c1), i11  => (v57));
				v4[safeIndex(628, v4.Length)] := safeDivisionInt(v4[safeIndex(628, v4.Length)], fm5(true, {f10}, f10, true, globalState));
				var v59: set<bool> := {f10, f10, f10};
				globalState.f8 := !(v59 > v59);
				var v60: map<string, map<bool, bool>> := map[v6 := v5];
				var v61: seq<string> := [v6];
				v60 := map[v61[safeIndex(f20, |v61|)] := v5] + v60;
			} else {
				var v62: set<array<int>> := {v4};
				var v63: set<string> := {seq(abs(-485), i12  => (v0)), v6};
				var v64: multiset<bool> := multiset{f10};
				v62, v4[safeIndex(628, v4.Length)], globalState.f8, globalState.f8 := v62 - {v4, v4}, safeModuloInt(p0, f20), (v63 >= v63) <== !f10, (if (f10 in v64) then v64[f10] else |{v4[safeIndex(628, v4.Length)]}|) < safeModuloInt(v4[safeIndex(628, v4.Length)], f20);
				...
				v70[safeIndex(119, v70.Length)] := v0;
				v70[safeIndex(119, v70.Length)] := v0;
			}
			
			var v71: array<bool> := new bool[2](i14 => false);
			v71[safeIndex(816, v71.Length)] := f10;
			var v72: seq<bool> := [false, f10];
			var v73: set<bool> := {f10, fm0(p0, seq(abs(63), i15  => (DC6(v0).cf13)), globalState)};
			var v74: map<seq<bool>, bool> := map[v72 := v73 != v73];
			v71[safeIndex(816, v71.Length)] := !!!(if (v72 in v74) then v74[v72] else v72[safeIndex(v4[safeIndex(628, v4.Length)], |v72|)]);
			var v75: seq<int> := [v4[safeIndex(628, v4.Length)], f20];
			r2, globalState.f8 := v75 + [v4[safeIndex(628, v4.Length)]], f10;
			var v76 := new C1();
			var v77: multiset<bool> := multiset{v71[safeIndex(816, v71.Length)], v71[safeIndex(816, v71.Length)]};
			globalState.f8 := fm0(v4[safeIndex(628, v4.Length)], v6, globalState) || (|v77| <= p0);
		}
		
		var v79: map<bool, int> := map[f10 := v4[safeIndex(628, v4.Length)]];
		var v80: set<int> := {p0, -|v79|};
		var v81: multiset<map<bool, int>> := multiset{v79, v79};
		var v83 := DC4(set v82 : string | v82 in map[v6 := v5] :: (v82), v4[safeIndex(628, v4.Length)], f10, f20);
		var v84: set<bool> := {!f10, f10};
		var v85: seq<string> := ["nsdckpdk", v6, v6, v6];
		var v86: array<bool> := new bool[21] [f10, true, (set v78 : int | (0x3c7 <= v78) && (v78 < 0x2fa) :: (safeDivisionInt(v78, v4[safeIndex(628, v4.Length)]))) < v80, f10, v79 in v81, f10, multiset(v6) !! fm53(v0, v83, f10, v84, globalState), f10, f10, f10, f10, f10 ==> f10, f10, f10, f10, 'n' !in v85[safeIndex(f20, |v85|)], f10, f10, f10, if (f10) then false else f10, false];
		var v87: set<string> := {"mipdnrh"};
		var v88: multiset<bool> := multiset{f10, f10, false};
		var v89: seq<set<int>> := [v80];
		globalState.f8, v86, globalState.f8, v80 := ({v6} + {v6}) > (if (f10) then {seq(abs(-287), i16  => (v0))} else v87), v86, (if (f10) then |map[p0 := v0]| else f20) == (if (f10 in v88) then v88[f10] else f20), v89[safeIndex(safeModuloInt(-0x30a, p0), |v89|)];
		var v90: seq<int> := [f20];
		v4 := new int[6] [|v6|, -p0, v90[safeIndex(-f20, |v90|)], v83.cf9, p0 * 34, v4[safeIndex(628, v4.Length)]];
		var v91: map<int, bool> := map[v4[safeIndex(628, v4.Length)] := f10];
	...
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			if (p1) {
				...
				v10[safeIndex(775, v10.Length)] := v12 > (v12 + (if (p1 in v16) then v16[p1] else v12));
				v10[safeIndex(775, v10.Length)] := p0;
				var v17: array<string> := new string[26];
				v17[safeIndex(681, v17.Length)] := v5;
				var v18 := 'b';
				var v19: array<int> := new int[25](i2 => i2 * v8);
				v17[safeIndex(681, v17.Length)], v18, v10[safeIndex(775, v10.Length)], v10[safeIndex(775, v10.Length)], v19 := "jph", v18, f10, p0, v19;
				var v20 := new C0(v4.f16, v4.f17);
			} else {
				var v21 := 143;
				v21 := v2[safeIndex(f20, |v2|)] + -(if (f10) then f20 else -v21);
				v21 := -894;
				...
				v22[safeIndex(903, v22.Length)] := |v28[v25 := DC16(|v30|)]|;
				var v31: array<bool> := new bool[26](i3 => f10);
				v31[safeIndex(249, v31.Length)] := false;
				var v32: array<D10> := new D10[4];
				var v33: map<bool, set<int>> := map[p0 := v25];
				v32[safeIndex(529, v32.Length)] := DC23(v33);
				var v34 := DC23(v33 + v33);
				v21, v22[safeIndex(903, v22.Length)], v31[safeIndex(249, v31.Length)], v32[safeIndex(529, v32.Length)] := v21 * v4.fm16(|[f10]|, globalState), |((multiset{f10, true})[f10 := abs(v21)])[p0 := abs(safeModuloInt(v21, v21))]|, p0, v34;
			}
			...
			v39[safeIndex(236, v39.Length)] := v40[safeIndex(f20, |v40|)];
			v39[safeIndex(236, v39.Length)] := !f10;
			v39 := v39;
		}
		var i4 := 0;
		while (!f10)
			decreases 100 - i4
		{
			...
			v48 := safeDivisionInt(|(v49[safeIndex(|v50|, |v49|) := p1] + v49)|, fm2(|v46|, f20, globalState));
		}
		var v51: multiset<int> := multiset{f20, f20};
		var v52: multiset<multiset<int>> := multiset{v51};
		var i5 := 0;
		while (f10 <==> (v52 >= v52[v51 := abs(0x62)]))
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			i5 := i5 + 1;
			globalState.f4 := seq(abs(-0x2aa), i6  => ('m'));
			var v53: map<bool, int> := map['n' in "nmboct" := f20];
			var v54: seq<bool> := [f10];
			var v55: seq<int> := [f20];
			var v56: array<seq<bool>> := new seq<bool>[4] [v54, v54[safeIndex(f20, |v54|) := p1], v54, if (p0) then v54 else fm41(p1, f20, v55[safeIndex(f20, |v55|)], p1, globalState)];
			var v57: array<D5> := new D5[6];
			var v58 := DC13(f20);
			v57[safeIndex(473, v57.Length)] := v58;
			var v59 := "fmn";
			v53, globalState.f8, globalState.f4, v56, v57[safeIndex(473, v57.Length)] := v53, p1, "qlkydpiff" + v59, v56, v58;
			globalState.f8 := f10;
		...
		if (p1) {
			if (true <==> !(f20 < |map[p0 := f20]|)) {
				...
				globalState.f8 := (v66[safeIndex(f20, |v66|)] + v65) != v65;
				globalState.f8 := f10;
				var v67 := 'g';
				var v68 := "ppfns";
				...
				var v73: map<int, string> := map[|(seq(abs(0x215), i7  => ('e')))| := v69];
				var v74: seq<string> := [v69, "celby", v69, v69, v69];
				var v75: map<int, int> := map[f20 := f20];
				var v76: map<int, int> := map[|"taiiyorh"| := |v75|];
				v72 := DC4({if (f20 in v73) then v73[f20] else v69, v74[safeIndex(|v69|, |v74|)], v69, v69, v69}, f20, !f10, if (!p1) then |v71| else -|v76|);
				globalState.f8 := f10;
				var v77: set<bool> := {p1};
			...
			var v95: array<bool> := new bool[28] [p0, p0, p1, f10, p1, p1, p0, p0, f10, fm34(f20, p0, |(set v90 : int | v90 in v89 :: (safeModuloInt(v90, |[true]|)))|, globalState), p0, f10, v94.cf41, p0, p1, p1, p0, fm0(f20, v92, globalState), f10, true, false, p0, p1, f10, p0, p0, p1, p0];
			var v96: map<int, string> := map[|(seq(abs(0x38), i9  => (f20)))| := v92];
			var v97: set<bool> := {p0};
	...
	method m10(p0: bool, p1: int, p2: D1, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v1[safeIndex(475, v1.Length)] := -f20;
			var v2: map<bool, int> := map[p0 := p1];
			v1[safeIndex(475, v1.Length)] := p1 * |v2|;
			var v3 := new C1();
			var v4 := 'i';
			var v5: map<bool, char> := map[f10 := v4];
			var v6: seq<map<bool, char>> := [v5, v5];
			var v7: map<int, map<bool, char>> := map[p1 := v6[safeIndex(-v0, |v6|)]];
			v0 := safeModuloInt(|v7|, if (f10) then f20 else p1);
		}
			...
			decreases 100 - i1
		{
			...
			var v13 := 'y';
			v12[safeIndex(466, v12.Length)] := v13;
			var v14 := "lqcr";
			v12[safeIndex(466, v12.Length)] := v14[safeIndex(fm2(f20, f20, globalState), |v14|)];
			var v15: map<bool, int> := map[f10 := p1];
			v15 := v15[f10 := safeDivisionInt(f20, p1)];
			v12[safeIndex(466, v12.Length)] := v13;
			var v16 := 943;
			var v17 := DC25(f20, v8);
			v16 := f20 * safeDivisionInt(p1, v17.cf38);
		}
		var v18 := 'u';
		var v19: set<bool> := {f10};
		var v20 := "cpyvnvj";
		var v21: array<char> := new char[29] [v18, v18, v18, v18, 'c', fm40(v19, globalState), v18, v18, v18, v18, v18, 'h', v18, v18, v18, v18, v18, v18, v18, 'v', v18, v20[safeIndex(f20, |v20|)], v18, v18, v18, v18, v18, v18, v18];
		...
		v29[safeIndex(864, v29.Length)] := v25;
		v29[safeIndex(864, v29.Length)] := v25;
		var v30: map<int, array<array<bool>>> := map[|(seq(abs(-0x13e), i3  => (-p1)))| := v29];
		v30 := v30[p1 := v29];
		globalState.f8 := p0;
	}
	method m11(globalState: GlobalState) returns (r0: map<int, char>, r1: bool, r2: bool, r3: string) {
		if (f10) {
			...
			var v8 := 'e';
			var v9: array<D6> := new D6[19] [v4, v4.(cf24 := v3), v4, v4, v4, v4, v4, DC14(v3), v4, v4, v4, v4, DC14(v3), v4, DC14(v3), v4, fm56(f10, v2, globalState), DC14((seq(abs(-0x174), i0  => (f20)))[safeIndex(|v5[safeIndex(|v7|, |v5|) := v8]|, |(seq(abs(-0x174), i0  => (f20)))|) := |(seq(abs(-0x28b), i1  => (v8)))|]), v4];
			v9[safeIndex(408, v9.Length)] := DC14([|"guqo"|]);
			v1, v2, v9[safeIndex(408, v9.Length)] := v1[map[f10 := !f10] := abs(fm5(f10, {!f10, f10}, f10, f10, globalState))] + v1, v2, DC14(v3 + v3);
			var v10 := new C1();
			var v11: seq<bool> := [!fm0(v2, DC3(v5).cf7, globalState), v2 < 138, f10, f10];
			r2 := v11[safeIndex(|multiset{f10}| - f20, |v11|)];
			globalState.f8 := false;
		} else {
			var v12: array<seq<bool>> := new seq<bool>[19](i2 => [f10] + [f10, false, f10, f10, f10]);
			var v13: seq<bool> := [f10];
			v12[safeIndex(549, v12.Length)] := v13;
			v12[safeIndex(549, v12.Length)] := v13;
			var v14: array<bool> := new bool[9];
			v14[safeIndex(286, v14.Length)] := f10;
			v14[safeIndex(286, v14.Length)] := v12[safeIndex(549, v12.Length)][safeIndex(f20, |v12[safeIndex(549, v12.Length)]|)];
			...
			v15[safeIndex(995, v15.Length)] := v16;
			v15[safeIndex(995, v15.Length)] := new array<bool>[24];
			...
			var v28: array<int> := new int[15] [v22, |v13|, f20, safeModuloInt(fm5(f10, {v14[safeIndex(286, v14.Length)]}, v14[safeIndex(286, v14.Length)], !v25.cf20, globalState), f20), v22, v22, v22, f20 - f20, 16, v22 - v22, v22, (if (v14[safeIndex(286, v14.Length)] in v27) then v27[v14[safeIndex(286, v14.Length)]] else v22) + v22, 0x3a, v22, f20];
			v28[safeIndex(202, v28.Length)] := v22;
			v28[safeIndex(202, v28.Length)] := -(v22 + fm2(fm2(v22, v22, globalState), f20, globalState));
		}
		...
		for i4 := if (f10) then -f20 else f20 to f20 {
			...
			var v34: seq<int> := [f20 - |v31|, |(v33[safeIndex(|"jkcbgct"|, |v33|)])[safeIndex(v29, |v33[safeIndex(|"jkcbgct"|, |v33|)]|) := true]|, f20 * i4, f20];
			v29 := |v34|;
			if (f10) {
				var v35 := new C1();
				var v36: map<bool, bool> := map[f10 := f10];
				var v37: array<bool> := new bool[17] [f10, f10, f10, true, f10, f10, f10, f10, f10, f10, v32[safeIndex(|v36|, |v32|)], f10, f10, f10, f10, f10, f10];
				...
				v42 := v42[v43[safeIndex(|fm57(f10, |v38|, f10, globalState)|, |v43|)] := map[{f10} := v39]];
				var v44: array<map<bool, bool>> := new map<bool, bool>[17](i5 => v36);
				var v45 := new C0(v34, v44);
				v37[safeIndex(527, v37.Length)] := true;
				var v46: array<array<int>> := new array<int>[10];
				var v47: map<bool, array<array<int>>> := map[f10 := v46];
				globalState.f8, v37[safeIndex(527, v37.Length)], v46 := fm6(v34, globalState), f20 > -safeModuloInt(f20, v34[safeIndex(|v30|, |v34|)]), if (!fm34(v29, f10, i4, globalState) in v47) then v47[!fm34(v29, f10, i4, globalState)] else v46;
				v36 := v36;
			} else {
				r1 := fm0(f20, v30 + (seq(abs(0x1ec), i6  => ('l'))), globalState);
				var v48: map<seq<bool>, bool> := map[v32 := f10];
				v48 := v48[v32 + v32 := f10];
				globalState.f8 := !true;
				v29 := safeDivisionInt(v29 + v34[safeIndex(i4, |v34|)], v29);
				globalState.f8 := f10;
			}
			...
			var v53 := new C0([v29] + v49[safeIndex(|v50|, |v49|)], if (f10 in v52) then v52[f10] else v51);
		...
		for i7 := v61.fm5(false, v63, f10, false, globalState) to v62 - -f20 {
			...
			var v67: array<int> := new int[10] [-safeModuloInt(i7, f20), -f20, f20, i7, v62, |(v55 + v60.f16)|, |v65|, f20, 0x3aa, |(map v66 : int | v66 in v60.f16 :: (v66 + i7) := (|multiset{multiset{f10, f10}, multiset{true}, multiset(v56), multiset{f10}, multiset{f10}}|))|];
			var v68 := "yse";
			v67[safeIndex(152, v67.Length)] := safeDivisionInt(f20, |v68|);
			v67[safeIndex(152, v67.Length)] := v62 + v60.fm16(0x71, globalState);
			var v69: multiset<int> := multiset{v67[safeIndex(152, v67.Length)]};
			var v70: map<bool, multiset<int>> := map[f10 := v69];
			v70 := v70[f10 := v69];
			if (v63 >= fm58(f10, fm0(|"wsninvfd"|, v68, globalState), globalState)) {
				v67[safeIndex(152, v67.Length)] := v62 - (|v56| - f20);
				var v71: array<seq<int>> := new seq<int>[5](i8 => v60.f16);
				v71[safeIndex(955, v71.Length)] := v60.f16;
				v71[safeIndex(955, v71.Length)] := v60.f16;
				v67[safeIndex(152, v67.Length)] := v62;
				v64[safeIndex(195, v64.Length)] := f10;
				v64[safeIndex(195, v64.Length)] := v67[safeIndex(152, v67.Length)] >= |v68|;
				r1 := !v64[safeIndex(195, v64.Length)];
			} else {
				...
				v67[safeIndex(152, v67.Length)] := |v76|;
				var v77: array<array<bool>> := new array<bool>[12] [v64, v64, v64, v65[safeIndex(f20, |v65|)], v64, if (f10) then v64 else v64, v64, v64, v64, v64, v64, v64];
				v77, v67[safeIndex(152, v67.Length)], r2 := v77, f20, f10;
				var v78 := new C0(v60.f16[safeIndex(|v55|, |v60.f16|) := i7], v60.f17);
				globalState.f8, v64 := !(v62 <= 357), v64;
			}
			
			v64[safeIndex(741, v64.Length)] := f10;
			v64[safeIndex(741, v64.Length)] := f10;
		}
		var v79 := 'c';
...
class C3 extends T3 {
	...
	method m2(globalState: GlobalState) {
		var v0: array<D1> := new D1[21](i0 => DC4({"tohg", "gihks", seq(abs(-108), i1  => ('q'))}, f18, f10, 286));
		var v1 := "bxvesmtd";
		var v3 := DC4(set v2 : string | v2 in multiset{v1} :: (v2), f18, f10, f18);
		v0[safeIndex(35, v0.Length)] := v3;
		v0[safeIndex(35, v0.Length)] := v3;
		...
		var v10 := 'f';
		var v11 := DC6(v10);
		globalState.f8, v11, globalState.f8 := true, v11.(cf13 := fm19(DC1(f18, v4, v5[!f19 := abs(f18)], f10, f18), f19, globalState)), true;
		var v12 := 0x1b3;
		var v13: map<int, int> := map[0x322 := v12];
		var v14: map<int, bool> := map[v12 := f10];
		v12 := -safeDivisionInt(|{v13, map[v12 := f18]}|, if (if (f18 in v14) then v14[f18] else f19) then v12 else v12);
		for i2 := v12 to v12 {
			v12, v3 := f18, v0[safeIndex(35, v0.Length)];
			var v15: array<bool> := new bool[27](i3 => f10);
			v15[safeIndex(580, v15.Length)] := true;
			var v16: multiset<int> := multiset{0x3db};
			var v17: set<int> := {v12, |v16|};
			v15[safeIndex(580, v15.Length)] := !(v17 !! v17);
			var v18: array<map<bool, bool>> := new map<bool, bool>[24];
			var v19: C0 := new C0([-i2], v18);
			v19 := v19;
			var v20: map<bool, int> := map[v4[safeIndex(i2, |v4|)] := i2];
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
		...
		forall i0 | 0 <= i0 < v7.Length {
			v7[i0] := v0[safeIndex(|{f19}|, |v0|)] ==> !v0[safeIndex(f18, |v0|)];
		}
			...
			decreases 100 - i2
		{
			...
			v13 := v13;
			v11[safeIndex(28, v11.Length)] := v13;
			v11[safeIndex(28, v11.Length)] := f18;
		}
		var v16 := 166;
		v16 := safeModuloInt(f18, f18 + v16);
		...
		r1 := match v21 {
			...
			case DC3(cf7) => v5
			case DC5(cf12) => if (|v18[safeIndex(p0, |v18|) := 'i']| in v8) then v8[|v18[safeIndex(p0, |v18|) := 'i']|] else v18[safeIndex(v16, |v18|)]
		};
	}
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		var v0 := "ofesk";
		var v1: set<string> := {v0, seq(abs(-0x315), i0  => ('r'))};
		...
		match (v2) {
			...
			case DC3(cf7) =>
				...
				if (p0 in v7) {
					...
					v8[safeIndex(478, v8.Length)] := f10;
					var v9: multiset<string> := multiset{cf7, cf7, v0, "al"};
					var v10: multiset<int> := multiset{|v9|, f18, f18};
					v8[safeIndex(478, v8.Length)] := v10 == fm22(true, f18, globalState);
					var v11: seq<int> := [p0];
					var v12: map<int, string> := map[f18 := seq(abs(0x126), i3  => ('d'))];
					var v13: map<set<bool>, int> := map[{!f10, false, f19, f10} := -v11[safeIndex(p0, |v11|)] - |(if (0x2b in v12) then v12[0x2b] else v0)|];
					var v14: set<bool> := {v8[safeIndex(478, v8.Length)]};
					v13 := v13[v14 * v14 := p0];
					...
					var v18: array<bool> := new bool[10] [f19, f10, f10, v17[safeIndex(p0, |v17|)], f10, f19, f19, f10, f19, f19];
					var v19: map<string, array<bool>> := map[cf7 := v18];
					var v20: array<string> := new string[18];
					v20[safeIndex(387, v20.Length)] := cf7;
					v19, globalState.f8, v20[safeIndex(387, v20.Length)] := v19, f19, cf7;
					var v21: multiset<string> := multiset{v20[safeIndex(387, v20.Length)], v20[safeIndex(387, v20.Length)]};
					var v22: map<int, int> := map[0x1cb := |v21|];
					v22 := v22[p0 + f18 := safeDivisionInt(p0, p0)];
					globalState.f5 := fm23(set v23 : multiset<bool> | v23 in map[multiset{f19, f19} := f18] :: (v23), 'p', seq(abs(307), i4  => ('q')), globalState);
					var v24 := 't';
					v24 := v24;
				}
				
				var v25: seq<string> := [v0];
				if (fm0(f18, v25[safeIndex(p0, |v25|)], globalState)) {
					...
					var v32 := new C0(((seq(abs(455), i5  => (f18))) + v30)[safeIndex(f18, |((seq(abs(455), i5  => (f18))) + v30)|) := p0], v31);
					globalState.f4 := cf7;
					var v33: array<bool> := new bool[27](i6 => v0[safeIndex(-0x1dd, |v0|) := 'q'] != cf7);
					v33[safeIndex(276, v33.Length)] := f10;
					var v34: map<bool, bool> := map[f10 := f10];
					v33[safeIndex(276, v33.Length)] := fm0(if (f10) then |v34| else f18, v0, globalState);
					var v35 := 'm';
				...
				var v55: array<int> := new int[20] [p0, p0, f18, safeDivisionInt(if (v43 in v45) then v45[v43] else -377, f18), -f18, p0, safeModuloInt(p0, |v49[v48 := abs(f18)]|), p0, fm5(true, fm24(v50, v50, globalState), f10, f19, globalState), f18, p0, f18, safeDivisionInt(f18, |v7|), f18, |v51|, |v54|, |(cf7 + v0)|, p0, fm5(false, {!f10, !f10, true, !f10, false}, f10, f19, globalState), p0];
				v55[safeIndex(738, v55.Length)] := f18;
				v55[safeIndex(738, v55.Length)] := safeDivisionInt(p0, -f18);
			...
			case DC5(cf12) =>
				...
				var v58: array<int> := new int[22](i7 => safeModuloInt(i7, |(seq(abs(0x25f), i8  => ('w')))|));
				v58[safeIndex(50, v58.Length)] := f18;
				...
				globalState.f8, r1, v58[safeIndex(50, v58.Length)] := (if (f19 in v59) then v59[f19] else v61) <= v61, p0, p0;
		}
		
		var v62: seq<bool> := [f10, f19, f19, f19];
		var v63: seq<int> := [|v62|, p0, f18, 258, |v62|];
		for i9 := 270 to v63[safeIndex(f18, |v63|)] {
			r1 := i9;
			...
			var v67: seq<string> := [v0, seq(abs(0x241), i10  => ('v'))];
			r1 := |(v67 + v67)|;
			var v68: seq<seq<int>> := [v63 + v63];
			r1 := -|v68[safeIndex(f18, |v68|)]|;
		}
		var v69: array<int> := new int[8](i11 => i11 * p0);
		v69[safeIndex(107, v69.Length)] := f18;
		var v70: multiset<bool> := multiset{f19};
		v69[safeIndex(107, v69.Length)] := 0x10a * safeDivisionInt(f18, if (f19 in v70) then v70[f19] else f18);
		globalState.f8 := f19;
		var v71 := DC3("aaotxwmcd");
		var v72: set<D1> := {v71};
		v69[safeIndex(107, v69.Length)] := safeDivisionInt(-f18, |(v72 - v72)|);
		var v73: multiset<int> := multiset{-p0};
		globalState.f8 := v62[safeIndex(if (f18 in v73) then v73[f18] else p0, |v62|)];
		r0 := v73;
		r1 := f18;
		r2 := [f18];
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			var v6 := "ilcxbh";
			v4, globalState.f8 := |(v5[safeIndex(v4, |v5|)] + v6)|, p0;
			if (f10) {
				...
				var v10: seq<seq<int>> := [seq(abs(0x263), i1  => (0xd8))];
				var v11: set<string> := {"sdnx"};
				var v12: map<int, bool> := map[v4 := p0];
				var v13 := DC4(v11, f18, f19, |v12|);
				var v14: set<C0> := {v3};
				globalState.f8 := v9 < (multiset{v7, multiset(v10[safeIndex(f18, |v10|)])} + multiset{multiset{|[v13.(cf10 := p0, cf9 := v4)]|, v4, |v14|}, v7});
				var v15: array<string> := new string[12](i2 => v6);
				v15[safeIndex(92, v15.Length)] := v6;
				var v16 := DC3(v6);
				v15[safeIndex(92, v15.Length)] := v16.cf7;
				var v17: set<int> := {f18};
				v17, v4 := v17 + ((set v18 : int | v18 in [f18] :: (safeDivisionInt(v18, 0x13d))) * {f18, v3.fm16(f18, globalState), 0x19a}), v4;
				var v19: set<bool> := {!p0};
				...
				var v26: map<bool, int> := map[f10 := v3.f16[safeIndex(|v25|, |v3.f16|)]];
				v25 := v25[f19 := v4 * -309];
				var v27: array<array<bool>> := new array<bool>[28];
				var v28 := DC12(v27);
				v27 := v28.cf22;
				var v29 := new C0(seq(abs(-0x4b), i3  => (|{f19}|)), v2);
			}
		...
		var v40 := DC3(seq(abs(0x389), i5  => ('n')));
		var v41 := DC5(v40);
		v41 := v41;
		...
		var v47 := DC4(v44, -f18, v45[safeIndex(-(if (f18 in v46) then v46[f18] else f18), |v45|)], if (-f18 in v46) then v46[-f18] else f18);
		if (match v47 {
			...
			globalState.f8 := !(if (v51[safeIndex(f18, |v51|)] in v49) then v49[v51[safeIndex(f18, |v51|)]] else !f10);
			...
			v58[safeIndex(434, v58.Length)] := fm2(|v45[safeIndex(-f18, |v45|) := !p0]|, |[f10]|, globalState);
			v58[safeIndex(434, v58.Length)] := f18;
			v42[safeIndex(673, v42.Length)] := p0;
			var v59: set<array<bool>> := {v42, v42, v42};
			v42[safeIndex(673, v42.Length)] := if (p1) then if (p1) then false else true else v59 >= {v42};
			...
			if (fm6(v61, globalState)) {
				...
				v58[safeIndex(434, v58.Length)], v58[safeIndex(434, v58.Length)], globalState.f8 := -0x1ea + -(|[v58[safeIndex(434, v58.Length)], |v63|]| - f18), f18, v42[safeIndex(673, v42.Length)];
				globalState.f4 := v43 + v43;
				v58[safeIndex(434, v58.Length)] := v58[safeIndex(434, v58.Length)];
				v42[safeIndex(673, v42.Length)] := v42[safeIndex(673, v42.Length)];
			} else {
				globalState.f8 := v42[safeIndex(673, v42.Length)];
				var v64 := DC14(v61);
				var v65: map<bool, seq<int>> := map[fm18(globalState) := v64.cf24];
				v58[safeIndex(434, v58.Length)] := |(if (p1 in v65) then v65[p1] else v61)|;
				var v66: array<D6> := new D6[2](i7 => v64);
				v66[safeIndex(322, v66.Length)] := v64;
				var v67 := 'u';
				v58[safeIndex(434, v58.Length)], v66[safeIndex(322, v66.Length)], v67, v42[safeIndex(673, v42.Length)], globalState.f8 := 91 * v58[safeIndex(434, v58.Length)], v64, v67, p1, v46 < multiset{v58[safeIndex(434, v58.Length)]};
				v58[safeIndex(434, v58.Length)] := safeDivisionInt(-0x23f, 0x1c4);
				globalState.f8, globalState.f8, globalState.f8 := f10, false <== (if (!p0) then f19 else f10), p1;
			}
			
			var v68: map<bool, int> := map[p0 := v58[safeIndex(434, v58.Length)]];
			if ((v58[safeIndex(434, v58.Length)] + |v68|) == v58[safeIndex(434, v58.Length)]) {
				v58[safeIndex(434, v58.Length)] := |v61| + (-0x2f2 - 407);
				v58[safeIndex(434, v58.Length)] := v58[safeIndex(434, v58.Length)];
				var v69 := 's';
				v69 := v69;
				var v70: map<int, bool> := map[f18 := !f10 <== f10];
				v70 := v70[f18 := p0];
				var v71: set<int> := {v58[safeIndex(434, v58.Length)]};
	...
	method m8(p0: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		for i0 := f18 to if (f10 in v0) then v0[f10] else |v1| {
			...
			match (v4.(cf9 := i0, cf8 := v3, cf10 := p0)) {
				case DC4(cf8, cf9, cf10, cf11) =>
					...
					var v6 := DC14([cf11]);
					v6 := v6;
					var v7: map<int, seq<int>> := map[|(seq(abs(383), i1  => ('u')))| := ([|{true, f19}|])[safeIndex(f18, |[|{true, f19}|]|) := 0x1ce]];
				...
				case DC3(cf7) =>
					...
					v13[safeIndex(437, v13.Length)] := p0;
					v13[safeIndex(437, v13.Length)] := f19;
					var v14: seq<string> := [cf7];
					var v15: set<int> := {|v14|, f18, -0x26};
					var v16: map<int, int> := map[i0 := i0];
					var v17: array<int> := new int[8] [|v12.f16|, |v15|, f18, f18, v12.f16[safeIndex(f18, |v12.f16|)], i0 * |v16|, |multiset{f10, f10, v13[safeIndex(437, v13.Length)], f19, v13[safeIndex(437, v13.Length)]}|, f18];
					v17[safeIndex(818, v17.Length)] := i0;
					v17[safeIndex(818, v17.Length)] := f18 * safeDivisionInt(f18, |"g"|);
				case DC5(cf12) =>
					var v18 := 's';
					var v19 := DC6(v18);
					var v20: seq<bool> := [f19];
					var v21 := DC1(f18, v20, v0, p0, |v1|);
					var v22: array<char> := new char[25] [v18, v18, 'm', v18, v18, v19.cf13, v18, 'y', v18, v18, v18, v18, v18, v18, v18, v18, v18, 'v', fm19(v21, f10, globalState), v18, v18, v1[safeIndex(i0, |v1|)], v18, v1[safeIndex(i0, |v1|)], v18];
					...
					v28[safeIndex(510, v28.Length)] := v27;
					var v37: map<string, int> := map[v1 := f18];
					v27, v18, r0, v28[safeIndex(510, v28.Length)] := f18, v1[safeIndex(v27, |v1|)], !false, safeModuloInt(if ((seq(abs(0x62), i3  => (v18))) in v37) then v37[seq(abs(0x62), i3  => (v18))] else f18, i0);
			}
			
			r1 := i0;
			r1 := safeDivisionInt(safeModuloInt(f18, |(seq(abs(656), i4  => ('q')))|), i0 - 0x28d);
		}
		for i5 := f18 to f18 {
			...
			if (v39.cf25 == v38) {
				...
				var v48: array<int> := new int[26] [f18, 466, i5, |fm29(f18, i5, |v40|, v41, globalState)|, i5, v42.cf23, fm5(p0, v43, true, f10, globalState), i5, |v41|, if (f19 in v0) then v0[f19] else i5, -safeDivisionInt(i5, f18), if (v1 in v44) then v44[v1] else i5, i5, f18, i5, |v45|, if (p0) then i5 else |v47[i5 := v46]|, i5, f18, safeModuloInt(f18, -0x25c), f18, 0x4f - i5, |{f18, i5, i5}| * fm5(f10, {!f19, f10, f10, false, p0}, false, false, globalState), 0x164 - f18, f18, i5];
				v46[safeIndex(540, v46.Length)] := i5;
				var v49: map<set<int>, int> := map[v40 - v40 := f18];
				v46[safeIndex(540, v46.Length)] := if (v40 in v49) then v49[v40] else |v38|;
				var v50: array<bool> := new bool[23](i6 => f10);
				var v51: map<int, string> := map[v46[safeIndex(540, v46.Length)] := seq(abs(0x1ea), i7  => ('n'))];
				var v52: map<bool, int> := map[f10 := |fm26(if (!p0 in v0) then v0[!p0] else i5, f19, globalState)|];
				var v53 := DC10(v50, map[v46[safeIndex(540, v46.Length)] := "kuyjhch"], -0x12d, f19);
				...
				r1, v55 := |v45|, v55;
				var v56 := 'w';
				var v57: array<string> := new seq<char>[15] [seq(abs(0x3bf), i8  => ('y')), v1[safeIndex(v46[safeIndex(540, v46.Length)], |v1|) := v56], seq(abs(-722), i9  => (v56)), v1, fm1(i5, globalState), (seq(abs(0x221), i10  => (v56))) + v1, v1, v1, v1 + v1, v1, v1, v1 + (seq(abs(0x3a6), i11  => (v56))), (seq(abs(-171), i12  => ('s'))) + v1, v1, v1];
				v57[safeIndex(879, v57.Length)] := v1;
				globalState.f8, v57[safeIndex(879, v57.Length)], globalState.f4 := f10, "ebbomc", v1[safeIndex(f18, |v1|) := v56] + ([v56] + v1);
				v50[safeIndex(791, v50.Length)] := f19;
				v50[safeIndex(791, v50.Length)] := f10;
			} else {
				var v58: map<string, bool> := map[v1 := f10];
				v58 := v58["c" := false <==> fm6(seq(abs(64), i13  => (i5)), globalState)];
				var v59: array<array<bool>> := new array<bool>[29];
				var v60: array<bool> := new bool[6] [f10, f19, f19, p0, f10, f19];
				v59[safeIndex(742, v59.Length)] := v60;
				v59[safeIndex(742, v59.Length)] := v60;
				var v61: set<int> := {i5};
				r1 := safeModuloInt(|v61| - 0x1b5, i5 - i5);
				var v62: array<int> := new int[17] [f18, |v61|, i5, i5, -i5, |v1|, i5, f18, f18, f18, f18, f18, i5, -i5, f18, i5, i5];
				var v63: map<bool, int> := map[f10 := f18];
				var v64 := DC1(if (f10 in v0) then v0[f10] else |v63|, [f19, p0, f19], v0, f19, |(seq(abs(-0x31a), i14  => ('a')))|);
				var v65, v66, v67 := m9(v62, v64, f18 != f18, globalState);
				var v68: array<set<int>> := new set<int>[9](i15 => v61);
				v68[safeIndex(687, v68.Length)] := v61;
				var v69: seq<int> := [v66, 912];
				var v72: multiset<int> := multiset{f18};
				v68[safeIndex(687, v68.Length)] := ((set v70 : int | v70 in v69 :: (v70 - 354)) * (set v71 : int | v71 in v61 :: (safeModuloInt(v71, 882)))) * (v61 * fm30(|v72|, v66, p0, f19, globalState));
			}
			
			var v73: array<int> := new int[5];
			v73[safeIndex(555, v73.Length)] := 104;
			v73[safeIndex(555, v73.Length)] := i5;
			if (if (p0) then if (p0) then f19 else !f10 else if (f10) then false else f10) {
				var v74: seq<int> := [safeModuloInt(468, i5), i5, safeDivisionInt(-f18, i5), 0x375, f18];
				v74 := v74;
				var v75: set<int> := {f18};
				var v76 := DC7(|v75|);
				var v77 := 'q';
				...
				v79 := v79[v73[safeIndex(555, v73.Length)] := v73[safeIndex(555, v73.Length)]];
				var v80: map<bool, bool> := map[f10 := f10];
				var v81: seq<map<bool, bool>> := [v80];
				var v82: array<map<bool, bool>> := new map<bool, bool>[29] [v80, v80, v80, v80[f10 := p0], v80[f19 := f19], v80, v80, v80, v80, v80, map[fm18(globalState) := !fm0(|v38|, fm1(v73[safeIndex(555, v73.Length)], globalState), globalState)], v80, v80, v80, v80, v80, map[p0 := f10], v80, v80, v80, fm26(f18, p0, globalState), v81[safeIndex(|"cwoqnvpwv"|, |v81|)], v80, v80, v80, v80, v80, map[!!p0 := f19], map[p0 := !f19]];
				var v83 := new C0(v74[safeIndex(f18, |v74|) := v73[safeIndex(555, v73.Length)]], v82);
				var v84 := new C0(v74, v83.f17);
				globalState.f8 := f10;
			} else {
				var v85: seq<int> := [v73[safeIndex(555, v73.Length)]];
				var v86: array<map<bool, bool>> := new map<bool, bool>[24](i16 => map[p0 := f19]);
				var v87: C0 := new C0(v85, v86);
				v87 := v87;
				v73[safeIndex(555, v73.Length)] := |(v1 + (seq(abs(0x13f), i17  => ('t'))))|;
				var v88 := 'u';
				var v89: map<char, string> := map[v88 := v1];
				v89 := v89[v88 := v1];
				var v90 := new C0(fm31(-i5, i5, -v73[safeIndex(555, v73.Length)], globalState), v87.f17);
				var v91: set<int> := {v73[safeIndex(555, v73.Length)], v73[safeIndex(555, v73.Length)], v73[safeIndex(555, v73.Length)]};
				var v92: seq<bool> := [f10];
				var v93: set<bool> := {p0};
				var v94: seq<set<int>> := [v91, {--|v92|, v73[safeIndex(555, v73.Length)], (fm32(false, |v38|, false, v93, globalState)).cf14, f18}];
				globalState.f8 := 601 < |v94[safeIndex(fm5(f19, v93, f10, f19, globalState), |v94|)]|;
			}
		...
		var v100: array<map<bool, bool>> := new map<bool, bool>[18] [v98, map[f10 := f10] + v98, v98, v98, v98, fm26(f18, f10, globalState), fm26(f18, v99[safeIndex(f18, |v99|)], globalState), v98, v98, fm26(f18, p0, globalState), v98[f19 := fm6([|[f18, f18]|], globalState)], v98, v98, v98 + v98[f10 := f10], v98 + v98, v98, v98, v98];
			...
			decreases 100 - i19
		{
			...
			v102 := new int[3](i20 => safeDivisionInt(i20, f18));
			if (f19) {
				var v103: seq<int> := [f18];
				var v104 := new C0(v103, v100);
				r1 := f18;
				r1 := f18;
				var v105 := new C0(seq(abs(0x244), i21  => (339)), if (false) then v104.f17 else v104.f17);
				...
				r2, globalState.f8, r2, v113, v114 := v95 !in v1, (if (fm6(v115[safeIndex(|v111|, |v115|) := |v115|], globalState)) then multiset{f18, |v116|} else multiset{f18}) != v110[|v99| := abs(|{f10, p0}|)], p0, DC24(v100).(cf37 := if (f10) then v100 else v100), v114;
				...
				v124 := v124[v122 := v126[safeIndex(v123.f20, |v126|)]];
				globalState.f4 := "mpmeediof";
			}
			
			var v127 := new C0(fm31(f18, f18, f18, globalState), v100);
			var v128: array<string> := new string[9] [v1 + "abskh", v1, v1 + v1, v1, fm1(0x39b, globalState) + v1, if (f19) then v1 else v1, "fahpquyd" + "rhdtdtndf", v1, v1[safeIndex(f18, |v1|) := v95] + (seq(abs(597), i23  => (v95)))];
			var v129: map<bool, int> := map[f19 := f18];
			var v130: multiset<int> := multiset{f18, f18, f18, if (f19 in v129) then v129[f19] else |v1|};
			v128[safeIndex(585, v128.Length)] := fm1(|v130|, globalState);
			v128[safeIndex(585, v128.Length)] := v1 + ((v1 + v1)[safeIndex(f18, |(v1 + v1)|) := v95])[safeIndex(f18, |(v1 + v1)[safeIndex(f18, |(v1 + v1)|) := v95]|) := v95];
		}
		r0 := f10;
		r1 := if (f19) then |"fup"| else f18;
		r2 := v99[safeIndex(f18, |v99|)];
	}
	method m9(p0: array<int>, p1: D0, p2: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: array<int>) {
		...
		if (v3.f16 < (seq(abs(-0x394), i2  => (f18)))) {
			var v7: array<bool> := new bool[26];
			v7[safeIndex(854, v7.Length)] := p2;
			v7[safeIndex(854, v7.Length)] := f10;
			r2 := p0;
		...
		v18 := v18[|(seq(abs(0x2be), i3  => ('k')))| !in multiset(v3.f16) := v19];
		r1 := --f18;
		r1 := f18;
		r0 := p2;
		r1 := f18;
...
class C4 extends T1 {
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		...
		v0[safeIndex(660, v0.Length)] := fm60(globalState);
		var v1: multiset<bool> := multiset{f21, false};
		v0[safeIndex(660, v0.Length)] := v1[f21 := abs(|fm61(f21, f21, !f21, globalState)|)];
		if (f21) {
			var v2 := 'd';
			v2 := v2;
			v2 := fm62(globalState);
			...
			v3[safeIndex(964, v3.Length)] := v4;
			var v5: seq<map<int, int>> := [v4, v4, v4];
			v3[safeIndex(964, v3.Length)] := v5[safeIndex(p0, |v5|)];
			...
			var v7 := DC0(f21);
			var v8: seq<bool> := [f21];
			var v9: set<bool> := {v8[safeIndex(p0, |v8|)], true};
			var v10: map<bool, int> := map[v7.cf0 <== f21 := fm5(f21, v9, !f21, f21, globalState)];
			var v11: map<int, int> := map[p0 := p0];
			var v12 := "q";
			var v13: array<int> := new int[12] [-p0, if (true) then p0 else p0, -(if (p0 in v11) then v11[p0] else p0), p0, p0, p0, p0, safeModuloInt(p0, p0), p0, if (!f21 in v10) then v10[!f21] else p0, p0, |v12| + p0];
			v13[safeIndex(981, v13.Length)] := p0;
			var v14: seq<int> := [-p0, p0, 177, p0];
			v10, v13[safeIndex(981, v13.Length)], r1, globalState.f8 := map[f21 := p0] + v10, -p0, -safeDivisionInt(p0, |v14|), true;
			var v15 := DC31(multiset{!f21, f21, f21});
			var v16: map<int, seq<D14>> := map[if (f21) then p0 else |"vt"| := [v15, v15, v15, DC31(v0[safeIndex(660, v0.Length)])] + [DC31(v1)]];
			var v17: multiset<int> := multiset{|v0[safeIndex(660, v0.Length)]|, v13[safeIndex(981, v13.Length)]};
			var v18 := DC37({v17, multiset{v13[safeIndex(981, v13.Length)]}, multiset{v13[safeIndex(981, v13.Length)], p0}, v17});
			var v19: set<multiset<int>> := {v17, v17};
			var v20: array<set<multiset<int>>> := new set<multiset<int>>[3] [v18.cf57, v19, {v17}];
			v20[safeIndex(724, v20.Length)] := fm63(p0, true, v12, globalState);
			v16, v15, v13, v20[safeIndex(724, v20.Length)], v13[safeIndex(981, v13.Length)] := v16 + v16, v15.(cf47 := v1 * v0[safeIndex(660, v0.Length)]), v13, if (f21) then v19 * v19 else v19 - v19, --safeModuloInt(p0, v13[safeIndex(981, v13.Length)]);
			r1 := if (!f21) then v13[safeIndex(981, v13.Length)] else v13[safeIndex(981, v13.Length)];
			globalState.f8 := f21;
		...
		r0 := v28;
		r1 := v27.f20;
		r2 := v24 + (seq(abs(0x1eb), i0  => (v27.f20)));
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		var v0 := -0x2dd;
		var v1: set<bool> := {f21, f21};
		var v2: seq<set<bool>> := [v1];
		for i0 := v0 to fm5(false, v2[safeIndex(-v0, |v2|)], p1, f21, globalState) {
			...
			var v13: array<int> := new int[12] [-safeModuloInt(v0, i0), safeModuloInt(|v4|, 0x172), if (p0) then i0 else i0, fm2(-v0, v0, globalState), i0, i0, v0, (if (|v7| in v5) then v5[|v7|] else |v11|) - v0, |v12|, safeModuloInt(i0, v0), v10.fm16(|v4|, globalState) * |multiset{v3.fm6(seq(abs(0x18f), i1  => (v0)), globalState)}|, -|"u"|];
			v13[safeIndex(809, v13.Length)] := i0;
			v13[safeIndex(809, v13.Length)] := v0;
		}
		var i2 := 0;
		while (v0 != v0)
			decreases 100 - i2
		{
			...
			v14[safeIndex(9, v14.Length)] := |(seq(abs(-65), i4  => ('m')))|;
			v14[safeIndex(9, v14.Length)] := v0;
			var v15 := "suatmwvae";
			...
			match (v17) {
				case DC27(cf41, cf42, cf43) =>
					...
					v14[safeIndex(9, v14.Length)], v14[safeIndex(9, v14.Length)], cf43, v21, v23 := -0x2a6 + v14[safeIndex(9, v14.Length)], -|v25[safeIndex(v14[safeIndex(9, v14.Length)] + v26.cf26, |v25|)]|, v23.fm16(cf43, globalState), if (p1 in v27) then v27[p1] else v21, v23;
					globalState.f8 := !fm0(|(v15 + "sbhwfdjjw")|, v15, globalState);
				case DC26(cf40) =>
					var v28: multiset<int> := multiset{v14[safeIndex(9, v14.Length)]};
				...
				case DC28(cf44) =>
					...
					var v39 := new C3(v0 + |v38|, v14[safeIndex(9, v14.Length)] == v14[safeIndex(9, v14.Length)], f21 && p1);
					v14[safeIndex(9, v14.Length)] := |"gwtaesuy"|;
			...
			var v42: seq<int> := [0x280, v14[safeIndex(9, v14.Length)]];
			var v43: seq<bool> := [false];
			var v44: map<bool, bool> := map[p1 := !false];
			v14[safeIndex(9, v14.Length)], globalState.f8, v14[safeIndex(9, v14.Length)] := v42[safeIndex(v0, |v42|)], p1, |(v43 + v43)[safeIndex(v14[safeIndex(9, v14.Length)], |(v43 + v43)|) := if (v43[safeIndex(v0, |v43|)] in v44) then v44[v43[safeIndex(v0, |v43|)]] else p0]|;
		}
		...
		var v50 := "cragpy";
		var v51: seq<bool> := [p0];
		var v52: array<bool> := new bool[16] [false, f21, v47[safeIndex(|v48|, |v47|)] >= v46, v49 in v50, p1 <==> !p1, p1, f21, true <== false, p1, v51[safeIndex(|v1|, |v51|)], !f21, f21, p1, f21, p0, fm5(!p0, v1, f21, p0, globalState) <= v0];
		v52[safeIndex(707, v52.Length)] := p0;
		var v53: map<bool, int> := map[f21 := -507];
		var v54: multiset<int> := multiset{v0, |v53|};
		v52[safeIndex(707, v52.Length)], globalState.f8, globalState.f8, v0 := p0, f21, !p1, |v54| + safeDivisionInt(v0, v0);
		v52 := new bool[9](i7 => v52[safeIndex(707, v52.Length)]);
		var v55: seq<int> := [v0];
		var v56: map<int, int> := map[-v0 := v55[safeIndex(v0, |v55|)]];
		v56 := v56[v0 := v0];
		globalState.f8 := false;
		var v57: multiset<bool> := multiset{v52[safeIndex(707, v52.Length)], v52[safeIndex(707, v52.Length)]};
		r0 := multiset(v51) + v57;
	}
	method m13(p0: bool, p1: string, p2: D7, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: bool, r3: bool) {
		...
		v1[safeIndex(943, v1.Length)] := f21;
		v1[safeIndex(943, v1.Length)] := !p0;
		r3 := !p0;
		var v3 := DC3(p1);
		var v4: seq<D1> := [v3];
		var v5: map<int, seq<D1>> := map[v0.f20 := v4];
		var v6: set<bool> := {v1[safeIndex(943, v1.Length)], true};
		var v7: set<string> := {p1};
		var v8: array<int> := new int[9] [|(seq(abs(-0x250), i1  => (map v2 : int | v2 in {0x132} :: (v2 + |[v1[safeIndex(943, v1.Length)], v1[safeIndex(943, v1.Length)], f21]|) := (p0))))|, v0.f20, v0.f20, v0.f20, -v0.f20, v0.f20, |(if (399 in v5) then v5[399] else fm64(v0.f20, p0, v0.f20, true, globalState))|, fm5(f21, v6, f21, p0, globalState), -DC4(v7, v0.f20, true, v0.f20).cf9];
		v8[safeIndex(861, v8.Length)] := v0.f20;
		var v9: set<int> := {|map[p0 := v8]|};
		v8[safeIndex(861, v8.Length)] := fm5(p0, {p0, p0} + v6, v0.f20 !in v9, f21, globalState);
		r0 := !v1[safeIndex(943, v1.Length)];
		var v10: multiset<array<bool>> := multiset{v1};
		var v11: seq<int> := [v0.f20, v8[safeIndex(861, v8.Length)], |v10|, v0.f20];
		var v12: map<bool, bool> := map[p0 := p0];
		var v13: seq<seq<int>> := [[v8[safeIndex(861, v8.Length)]], [-0x1e3], v11, [506, v0.f20, v8[safeIndex(861, v8.Length)], -|v12|]];
		var v14: seq<bool> := [f21, v1[safeIndex(943, v1.Length)]];
		var v15: multiset<bool> := multiset{v14[safeIndex(v8[safeIndex(861, v8.Length)], |v14|)]};
		v8[safeIndex(861, v8.Length)] := |(v13[safeIndex(safeDivisionInt(v0.f20, v8[safeIndex(861, v8.Length)]), |v13|)])[safeIndex(|multiset{v8[safeIndex(861, v8.Length)]}|, |v13[safeIndex(safeDivisionInt(v0.f20, v8[safeIndex(861, v8.Length)]), |v13|)]|) := |v15|]|;
		r0 := f21;
		r1 := v1;
		r2 := v1[safeIndex(943, v1.Length)];
		var v16: set<map<bool, int>> := {(map[p0 := v8[safeIndex(861, v8.Length)]])[f21 := v8[safeIndex(861, v8.Length)]]};
		r3 := -|v16| > v0.f20;
	}
	method m14(p0: int, p1: multiset<int>, p2: array<int>, globalState: GlobalState) {
		if (f21) {
			...
			globalState.f8 := v0[safeIndex(p0 * p0, |v0|)];
			var v1: set<bool> := {f21};
			var v2 := "heoekeae";
			p2[safeIndex(109, p2.Length)] := p0 + fm5(f21, v1, f21, fm0(|v2|, v2, globalState), globalState);
			var v3 := 0x175;
			var v4: map<bool, int> := map[f21 := |multiset(v0)|];
			var v5: map<bool, bool> := map[!false := f21];
			var v6: map<bool, bool> := map[fm0(|v4|, seq(abs(527), i0  => ('a')), globalState) := if (f21 in v5) then v5[f21] else f21];
			var v7: seq<int> := [safeDivisionInt(fm2(v3, 0x7, globalState), |v5|)];
			var v8: multiset<bool> := multiset{f21};
			var v9: map<int, bool> := map[|map[v7[safeIndex(p0, |v7|) := v3] := v8]| := false];
			p2[safeIndex(109, p2.Length)], v3, globalState.f8, globalState.f8 := |map[if (f21 in v6) then v6[f21] else !f21 := f21]|, v7[safeIndex(|v2|, |v7|)], f21, if (p0 in v9) then v9[p0] else v0[safeIndex(v3, |v0|)];
			p2[safeIndex(109, p2.Length)] := p0;
			var v10 := new C1();
			var v11: map<bool, map<bool, seq<int>>> := map[f21 := map[f21 := v7]];
			var v12: map<bool, seq<int>> := map[f21 := v7];
			v3 := safeDivisionInt(|((if (f21 in v11) then v11[f21] else map[f21 := v7]) + v12)|, p2[safeIndex(109, p2.Length)]);
		} else {
			var v13 := 'v';
			...
			var v24: map<string, map<char, int>> := map[seq(abs(-718), i1  => (v13)) := v23];
		...
		match (DC18(v35[v33 := v34])) {
			case DC19(cf29, cf30, cf31, cf32) =>
				...
				v39 := v39;
				globalState.f4 := v36;
				p2[safeIndex(704, p2.Length)] := cf29[safeIndex(p0, |cf29|)];
				p2[safeIndex(704, p2.Length)] := cf30;
			case DC20(cf33) =>
				var v40 := 220;
				var v41 := DC0(f21);
				var v42 := DC2(v41);
				...
				v48 := map[v40 := v47] + ((map v49 : int | v49 in {0x17c, if (f21 in v52) then v52[f21] else v40} :: (v49 - v40) := ('l')) + map[-|(seq(abs(0x1da), i3  => (v40)))| := 'e']);
			...
			case DC18(cf28) =>
				...
				var v56: C2 := new C2(p0, v55[safeIndex(v54, |v55|)]);
				var v57: set<C2> := {v56};
				...
				var v60 := "faculmwfu";
				v59[safeIndex(935, v59.Length)] := fm0(p0, v60, globalState);
				v59[safeIndex(935, v59.Length)] := v53.fm38(if (f21 in v34) then v34[f21] else f21, globalState);
				var v61: seq<string> := [v60, v60 + v60];
				v54 := |v61[safeIndex(v54, |v61|)]|;
			case DC21(cf34) =>
				...
				if (|v63| < p0) {
					...
					var v66: array<char> := new char[13] [v64, v64, v64, 'i', v64, v64, fm62(globalState), v64, v64, v65[safeIndex(p0, |v65|)], v65[safeIndex(p0, |v65|)], v64, v64];
					v66[safeIndex(563, v66.Length)] := if (f21) then v64 else v65[safeIndex(p0, |v65|)];
					v66[safeIndex(563, v66.Length)] := v64;
					var v67 := 0x1fb;
					v67 := p0 + safeModuloInt(-fm2(p0, |v62|, globalState), p0);
					...
					v71 := DC18(v35);
					p2[safeIndex(614, p2.Length)] := -0x102 + v67;
					p2[safeIndex(614, p2.Length)] := v67;
				} else {
					var v72: seq<int> := [p0];
					var v73: seq<bool> := [f21];
					var v74 := new C3(safeDivisionInt(p0, |v72|), true, v73[safeIndex(p0, |v73|)]);
					...
					globalState.f8 := true;
					var v76 := DC3(seq(abs(0x300), i4  => ('n')));
					var v77 := 'l';
					globalState.f4 := v76.cf7[safeIndex(p0, |v76.cf7|) := v77];
					var v78 := "qt";
				...
				var v82: seq<int> := [p0];
				var v83: map<string, array<bool>> := map[v79 := v81[safeIndex(v82[safeIndex(p0, |v82|)], |v81|)]];
				p2[safeIndex(899, p2.Length)] := |v79|;
				var v84 := 'c';
				v83, globalState.f8, p2[safeIndex(899, p2.Length)], v84 := (if (f21) then v83 else v83)["fpuhdvi" := v80], f21, safeDivisionInt(p0, p0), v79[safeIndex(p0, |v79|)];
				var v85: array<map<bool, bool>> := new map<bool, bool>[6];
				var v86 := new C0(v82, v85);
				p2[safeIndex(899, p2.Length)] := p0 - -p0;
		}
		
		var v87: array<set<int>> := new set<int>[25];
		var v88: set<int> := {p0, p0};
		v87[safeIndex(780, v87.Length)] := v88;
		v87[safeIndex(780, v87.Length)] := {p0} * v88;
		globalState.f8 := f21;
...
class C5 extends T4 {
	...
	function fm8(p0: bool, globalState: GlobalState): char {
		match DC28(DC28(DC26(map[seq(abs(0xc2), i0  => ('j')) := |multiset{!f10}|]))) {
	...
	function fm7(p0: seq<int>, p1: bool, p2: string, p3: bool, globalState: GlobalState): map<int, int> {
		match DC26(map[seq(abs(741), i0  => ('b')) := |[f10, f11]|]) {
			case DC27(cf41, cf42, cf43) => map[cf43 := cf43] + map[|map['w' := cf43]| := -0x80]
			case DC26(cf40) => map[|(seq(abs(0x9e), i1  => ('i')))| := |"u"|]
			case DC28(cf44) => (map v0 : int | (0x33d <= v0) && (v0 < 604) :: (safeModuloInt(v0, |[f11]|)) := (|(seq(abs(-910), i2  => ('v')))|)) + (map v1 : int | v1 in map[409 := f10] :: (v1 * |map[f10 := 115]|) := (|"fean"|))
		}
	}
	function fm5(p0: bool, p1: set<bool>, p2: bool, p3: bool, globalState: GlobalState): int {
	...
	method m2(globalState: GlobalState) {
		...
		for i0 := v0 to v0 {
			...
			var v3: seq<array<bool>> := [v2[safeIndex(0x7c, |v2|)], v1];
			var v4: array<array<bool>> := new array<bool>[25] [v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v3[safeIndex(i0, |v3|)], v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1];
			var v5 := DC12(v4);
			var v6 := "gpvrq";
			...
			if (i0 < |v8.cf7|) {
				...
				v1[safeIndex(576, v1.Length)] := v12.cf41;
				v1[safeIndex(576, v1.Length)] := (v0 * 0x224) >= i0;
				globalState.f8 := v1[safeIndex(576, v1.Length)] <==> v1[safeIndex(576, v1.Length)];
				var v13 := new C2(|(seq(abs(0x149), i1  => (if (|map[i0 := -i0]| in v10) then v10[|map[i0 := -i0]|] else |v10|)))|, v6 <= v6);
				var v14: array<char> := new char[27];
				v14[safeIndex(533, v14.Length)] := v9;
				v14[safeIndex(533, v14.Length)] := v9;
				globalState.f8 := !f11;
			} else {
				var v15: set<int> := {v0};
				...
				v1[safeIndex(422, v1.Length)] := |(if (|v18| in v16) then v16[|v18|] else v15)| > i0;
				var v19: array<array<seq<int>>> := new array<seq<int>>[11];
				var v20: array<seq<int>> := new seq<int>[20];
				v19[safeIndex(139, v19.Length)] := v20;
				var v21 := 'k';
				v1[safeIndex(422, v1.Length)], v0, v19[safeIndex(139, v19.Length)], v21 := f11 || f11, i0, v20, v21;
				var v22: map<int, char> := map[if (v1[safeIndex(422, v1.Length)]) then 360 else |map[v0 := 0x75]| := v21];
				var v23: multiset<int> := multiset{v0, v0};
				v22 := v22[if (v0 in v23) then v23[v0] else i0 := v21];
				v0 := v0;
				v21 := v21;
				v0 := safeModuloInt(--i0, |v6|);
			}
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			v0 := safeModuloInt(v0, safeModuloInt(v0, v0));
			...
			var v34: seq<int> := [|v29|];
			var v35: map<int, char> := map[|v34[safeIndex(v27, |v34|) := |fm1(v27, globalState)|]| := v31];
			...
			v36[safeIndex(707, v36.Length)] := v31;
			v36[safeIndex(707, v36.Length)] := v31;
		}
		globalState.f8 := f10 <== f10;
		var v37: array<char> := new char[14](i3 => 'g');
		var v38 := 'n';
		v37[safeIndex(340, v37.Length)] := v38;
		var v39: map<int, int> := map[safeDivisionInt(v0, |v25|) := v0];
		var v40 := DC0(f10);
		v37[safeIndex(340, v37.Length)], v39, v40, v38 := v38, map[v0 := v0 - v0], v40, v38;
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
			...
			decreases 100 - i0
		{
			...
			if ("ud" in v2) {
				...
				var v10 := DC38(map[v9[safeIndex(p0, |v9|)] := v3]);
				var v11: seq<map<bool, int>> := [v5, v5, v10.cf58];
				v8 := v8[v11[safeIndex(p0, |v11|)] := v7];
				v4[safeIndex(25, v4.Length)] := true;
				var v12: set<bool> := {!f10};
				v4[safeIndex(25, v4.Length)] := (v12 !! v12) !in [f10, f11];
				var v13: map<bool, bool> := map[v4[safeIndex(25, v4.Length)] := f11];
				var v14 := DC29(v13);
				v3, globalState.f8, v4[safeIndex(25, v4.Length)], v4[safeIndex(25, v4.Length)], v14 := -v3, f11 <==> v4[safeIndex(25, v4.Length)], f11, f11, v14;
				...
				v18[safeIndex(974, v18.Length)] := f11;
				globalState.f8, v17, v18[safeIndex(974, v18.Length)], globalState.f8 := f10, v17, f11, f11;
				var v19: array<D2> := new D2[25](i2 => DC7(0x18a));
				var v20 := DC7(p0);
				v19[safeIndex(890, v19.Length)] := v20;
				v19[safeIndex(890, v19.Length)] := v20.(cf14 := p0);
			}
		...
		v31[safeIndex(887, v31.Length)] := f10;
		var v32 := 'u';
		var v33: set<char> := {v32};
		v29, v31[safeIndex(887, v31.Length)], v29 := fm2(p0, v29, globalState), f10, fm2(|v1|, |v33|, globalState);
		var v37: array<set<int>> := new set<int>[21] [fm66(p0, p0, globalState), v27, v27, v27, v27 + v27, v27, if (f11) then v27 else v27, v27 * v27, set v34 : int | (-515 <= v34) && (v34 < 0xdc) :: (safeModuloInt(v34, if (f10 in v23) then v23[f10] else v29)), v27, v27, v27, {p0, p0} + v27, v27, {v29}, v27 * (set v35 : int | (0x84 <= v35) && (v35 < -0x157) :: (v35 + v29)), {v29, p0, if (v31[safeIndex(887, v31.Length)] in v23) then v23[v31[safeIndex(887, v31.Length)]] else p0, v29} - {p0, p0}, (set v36 : int | (0x147 <= v36) && (v36 < 71) :: (v36 + |v26|)) - v27, {p0, p0, v29, -v29, 386}, v27, v27];
		forall i3 | 0 <= i3 < v37.Length {
			v37[i3] := v27 * (v27 + v27);
		}
		var v38: seq<bool> := [f10, f10];
		r1, globalState.f8 := v32, (v38 + fm67(f11, v31[safeIndex(887, v31.Length)], true, f10, globalState)) != [false, v0.cf54, v31[safeIndex(887, v31.Length)], f11, false];
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		...
		for i0 := fm5(fm0(p0, "tnexv", globalState), v1, f11, f11, globalState) to fm2(p0, |v2.cf59|, globalState) {
			...
			var v5 := 'k';
			r1, globalState.f4, r1 := safeDivisionInt(|v0|, p0 - p0), v0 + (("rwkin" + v0)[safeIndex(if (f10 in v4) then v4[f10] else i0, |("rwkin" + v0)|) := v5])[safeIndex(p0, |("rwkin" + v0)[safeIndex(if (f10 in v4) then v4[f10] else i0, |("rwkin" + v0)|) := v5]|) := v0[safeIndex(p0, |v0|)]], i0;
			var v6: array<int> := new int[5];
			v6[safeIndex(614, v6.Length)] := i0;
			var v7: array<seq<int>> := new seq<int>[4];
			var v8: array<set<int>> := new set<int>[2];
			var v9: set<int> := {i0, i0};
			v8[safeIndex(218, v8.Length)] := v9;
			var v10: seq<int> := [0x384, i0];
			v6[safeIndex(614, v6.Length)], r1, v7, globalState.f8, v8[safeIndex(218, v8.Length)] := p0 + (|v10| + i0), i0, v7, f11 <==> (v9 == (set v11 : int | (-0x3aa <= v11) && (v11 < 0x95) :: (v11 + 0x1a9))), if (f10) then v9 else v9 + v9;
			var v12: multiset<bool> := multiset{f11, f11};
			var v13: seq<multiset<bool>> := [v12];
			v6[safeIndex(614, v6.Length)] := |v13|;
		}
		...
		match (v15) {
			case DC4(cf8, cf9, cf10, cf11) =>
				...
				var v22 := 'e';
				v19 := v19[v20 > fm66(fm2(|(map v21 : char | v21 in v0 :: (v21) := (p0))|, |v0[safeIndex(cf11, |v0|) := v22]|, globalState), cf11, globalState) := v18];
				...
				var v32: array<string> := new string[14] [v0, v0, v0 + v0, v0, "ku", "sjtsflogy", "w" + v31[safeIndex(p0, |v31|)], v31[safeIndex(cf11, |v31|)] + v0, v0, v0 + v0, v0, v0, v0 + "l", v0];
				v32 := v32;
			case DC3(cf7) =>
				...
				if (p0 == |v33|) {
					...
					var v35 := new C3(safeModuloInt(p0, |v34|), f10, f11);
					...
					r1 := |v44|;
					v42[safeIndex(729, v42.Length)] := |[seq(abs(467), i2  => ('x'))]| + |cf7|;
					var v45: array<bool> := new bool[4](i3 => !f10);
					var v46: seq<int> := [p0];
					v42[safeIndex(729, v42.Length)], globalState.f8, v45 := |(v46 + [p0])|, f10, v45;
					var v47: array<array<bool>> := new array<bool>[23];
					v47[safeIndex(895, v47.Length)] := v45;
					v47[safeIndex(895, v47.Length)] := v45;
					var v48 := 'b';
					v48 := v48;
				}
				...
				v50, r1 := if (p0 in v51) then v51[p0] else v52[safeIndex(|v53|, |v52|)], -|(v54 + (v54[false := abs(p0)] * v54))|;
				...
				var v60: multiset<int> := multiset{p0, |v56|, p0, fm5(v57[safeIndex(p0, |v57|)], v1, f10, f10, globalState), |v59|};
				...
				if (f10) {
					...
					v62[safeIndex(906, v62.Length)] := p0;
					v62[safeIndex(906, v62.Length)] := p0;
					...
					v62[safeIndex(906, v62.Length)], globalState.f8, v62[safeIndex(906, v62.Length)] := |v65|, v58.f21, if (f11) then p0 else v62[safeIndex(906, v62.Length)];
					v62 := new int[1];
				} else {
					r1 := p0;
			...
			case DC5(cf12) =>
				var v67: seq<int> := [p0];
				r1 := if (f11) then p0 else |v67[safeIndex(|v0|, |v67|) := 0x1f9]|;
				...
				var v71 := DC3(seq(abs(0x10d), i4  => ('y')));
				var v72 := DC5(v71);
				var v73 := DC5(v72);
				...
				v77[safeIndex(182, v77.Length)] := v73.(cf12 := v72);
				v77[safeIndex(182, v77.Length)] := fm68([f11, f10], if (f11) then f10 else f11, p0, |(v75 * multiset{f11})|, globalState);
		...
		var v79 := DC16(|v78|);
		r1 := safeDivisionInt(p0, v79.cf26);
		...
		var v90: array<int> := new int[27] [p0, p0, p0, p0, fm2(p0, p0, globalState), |v83|, v81.fm5(v81.f10, v1, v81.f10, f10, globalState), p0, |v85| * p0, p0, v87[safeIndex(p0, |v87|)], if (f10) then v81.fm5(false, v1, f10, v81.f10, globalState) else p0, p0, if (!v81.f10) then p0 else p0, p0, |v0|, p0 + p0, -v81.fm5(v81.f10, {f10}, f10, v81.f10, globalState), p0, if (!v81.f10) then p0 else v87[safeIndex(p0, |v87|)], p0, -|v88|, p0, p0, p0, |v0[safeIndex(-p0, |v0|) := v84]| * fm2(|[v84, v84]|, p0, globalState), v81.fm5(v81.f10, v1, v89.cf49, f10, globalState)];
		forall i5 | 0 <= i5 < v90.Length {
			v90[i5] := i5 + p0;
		}
		forall i6 | 0 <= i6 < v90.Length {
			v90[i6] := safeModuloInt(i6, p0);
		}
		var v91: multiset<int> := multiset{p0, 0x1e1};
		r0 := v91;
		r1 := -0x27c;
		r2 := seq(abs(0x3a1), i7  => (p0));
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		...
		v5[safeIndex(77, v5.Length)] := f11 <==> v0[safeIndex(v1, |v0|)];
		var v6: map<bool, bool> := map[!p0 := f10];
		var v7: array<map<bool, bool>> := new map<bool, bool>[4] [v6, v6, v6, v6];
		v7[safeIndex(626, v7.Length)] := if (false) then v6 else v6;
		v5[safeIndex(77, v5.Length)], globalState.f8, v7[safeIndex(626, v7.Length)] := v0[safeIndex(v1, |v0|)], f11, v6;
		var v8 := DC29(v7[safeIndex(626, v7.Length)]);
		var v9: seq<D13> := [v8, v8];
		globalState.f8 := p1 <== (v9 == v9);
		var v10 := "fwffa";
		v5[safeIndex(77, v5.Length)], globalState.f4 := p0 <== f11, v10;
		var v11 := DC40(p0, f10, v1);
		var v12: C4 := new C4(f10);
		var v13: multiset<C4> := multiset{v12};
		var v14: seq<string> := [v10, "rgshrpa"];
		var v15: map<int, int> := map[v1 := v3[safeIndex(-v1, |v3|)]];
		var v16: map<array<bool>, int> := map[v5 := |v10|];
		var v17: multiset<int> := multiset{|v10|, v3[safeIndex(v3[safeIndex(v1, |v3|)], |v3|)], 0x222};
		var v18: set<int> := {v1, 0x261, |v3|};
		var v19: seq<set<int>> := [v18];
		var v20: map<string, bool> := map[v10 := p0];
		var v21: array<int> := new int[22] [safeDivisionInt(|[p1]|, v1), v1 * 0x30e, v11.cf62, |v10|, safeDivisionInt(v1, v1), v1 * -v1, -633, v1, if (p0) then if (v12 in v13) then v13[v12] else v1 else v1, v1, |v14[safeIndex(v1, |v14|)]|, -560, safeModuloInt(v1, v1), -316, |v15|, |v16| + v1, if (p1) then v1 else v1, v1, if (v1 in v17) then v17[v1] else v1, |v19|, |v20|, v1 * v3[safeIndex(v1, |v3|)]];
		var v22: set<bool> := {v12.f21};
		var v23: multiset<bool> := multiset{false};
		var v24: map<bool, string> := map[v23 !! v23 := seq(abs(66), i0  => ('c'))];
		var v25 := 'l';
		var v26: multiset<char> := multiset{v25, fm8(f11, globalState)};
		globalState.f8, v1, v21, v10, v1 := v12.f21, fm5(p1 || false, v22 - {f11}, f11, f10, globalState), v21, if (!v5[safeIndex(77, v5.Length)] in v24) then v24[!v5[safeIndex(77, v5.Length)]] else v10, if (v25 in v26) then v26[v25] else -v1;
		forall i1 | 0 <= i1 < v21.Length {
			v21[i1] := i1 - v1;
		}
		var v27: map<bool, int> := map[p1 := v1];
		var v28: seq<map<bool, int>> := [map[true := |v6|], v27[v5[safeIndex(77, v5.Length)] := v1], map[p1 := |v10|]];
		v5[safeIndex(77, v5.Length)] := |v28[safeIndex(v1, |v28|)]| >= v1;
		r0 := v23 * v23;
	}
	method m15(p0: bool, p1: map<bool, int>, p2: string, globalState: GlobalState) returns (r0: int, r1: seq<array<bool>>) {
			...
			decreases 100 - i0
		{
			...
			match (v5) {
				case DC4(cf8, cf9, cf10, cf11) =>
					...
					v6[safeIndex(580, v6.Length)] := v9;
					var v10: seq<bool> := [p0, p0];
					var v11: seq<seq<bool>> := [v10, v10];
					v6[safeIndex(580, v6.Length)] := v9[v7 := abs(-|v11[safeIndex(|(v10[safeIndex(cf11, |v10|) := f11])[safeIndex(--0x353, |v10[safeIndex(cf11, |v10|) := f11]|) := p0]|, |v11|)]|)] - multiset{v7};
					globalState.f8 := cf10;
					var v12: map<bool, multiset<int>> := map[cf10 := v7];
					var v13: seq<multiset<int>> := [v7];
					v1 := |(if (cf10 in v12) then v12[cf10] else v13[safeIndex(0x12b, |v13|)])| * 0x1b6;
					var v14: set<bool> := {f11};
					v1 := (if (false) then -v1 else v1) + |v14|;
				case DC3(cf7) =>
					var v15: seq<multiset<bool>> := [v0];
					globalState.f8 := ((seq(abs(-901), i2  => (v0))) + v15) != (seq(abs(0x32c), i3  => (v0)));
					var v16: map<bool, bool> := map[if (f11) then !p0 else !f10 := fm0(-v1, p2, globalState)];
					v16 := v16[f10 := p0];
					r0 := v1;
					var v17: array<int> := new int[17](i4 => i4 - v1);
					var v18: map<array<int>, int> := map[if (!f10) then v17 else v17 := safeModuloInt(v1, v1)];
					v18 := v18[v17 := v1];
				case DC5(cf12) =>
					...
					var v25: map<int, int> := map[|(seq(abs(-295), i5  => (v1)))| := |v24|];
					var v26: seq<int> := [if (v1 in v24) then v24[v1] else |p2|, v1, 0x2f2];
					var v27: array<bool> := new bool[20] [false, p0, f10, v20.cf54, true, v21[safeIndex(0x1e0, |v21|)], p0, |v22| > v23.cf14, f10, p0, f10, v26[safeIndex(v1, |v26|)] >= |(seq(abs(-972), i6  => (v2)))|, f11, true, f11 <==> f10, f10, p0, p0, f11, f11];
					globalState.f4, v27 := p2 + p2, v27;
					globalState.f8 := f11;
					var v28: array<seq<int>> := new seq<int>[16];
					v28[safeIndex(666, v28.Length)] := v26;
					v28[safeIndex(666, v28.Length)] := [|v26|, v1];
			}
			...
			if (true) {
				...
				globalState.f8 := v30[safeIndex(fm5(p0, v31, p0, f10, globalState), |v30|)];
				globalState.f8 := if (false) then p0 else p0;
				var v32: array<int> := new int[3](i7 => i7 - v1);
				v32[safeIndex(150, v32.Length)] := v1;
				v32[safeIndex(150, v32.Length)] := -|fm69(fm5(f10, v31, true, f10, globalState) < v1, v1, globalState)|;
				...
				r0 := safeDivisionInt(safeDivisionInt(v1, |(seq(abs(0x68), i8  => (v2)))|), |v37| + v1);
				r0 := v1;
				v1 := (v1 - v1) * v1;
				v29 := v29[v1 := -v1];
				v1 := v1;
		...
		globalState.f4 := p2 + (seq(abs(-0x1fa), i9  => ('r')));
		if (p0) {
			...
			var v43: array<array<bool>> := new array<bool>[4] [v38, v38, v42[safeIndex(v1, |v42|)], v38];
			match (DC12(v43)) {
				case DC13(cf23) =>
				...
				case DC12(cf22) =>
					...
					v51[safeIndex(511, v51.Length)] := v50;
					v51[safeIndex(511, v51.Length)] := v50;
					var v52 := 't';
					v52 := v52;
					var v53: array<int> := new int[6](i11 => i11 + v1);
					v53[safeIndex(537, v53.Length)] := 0x350;
					...
					globalState.f8, globalState.f8, globalState.f4, v53[safeIndex(537, v53.Length)], v54 := f10, p2 <= (p2[safeIndex(v1, |p2|) := 'f'] + "many"), p2, |(v56 + v56)|, v57[safeIndex(safeDivisionInt(|v58|, 0x1f9), |v57|)];
					var v59 := new C1();
			}
			
			r0 := v1;
			var v60 := new C4(p2 == (seq(abs(0x3e4), i12  => ('k'))));
			...
			var v63: set<bool> := {f10};
			globalState.f8 := ([v1, v1] + v62) == ((seq(abs(0x2a0), i14  => (|map[p0 := !f11]|))) + [fm5(p0, v63, p0, false, globalState), v1]);
			var v64 := new C4(f10);
			...
			var v69: seq<bool> := [v64.f21, fm0(|(seq(abs(0x357), i16  => ('u')))|, p2, globalState), v68.cf31, v66[safeIndex(0x143, |v66|)], f11];
			var v70: set<int> := {v1};
			v65[safeIndex(505, v65.Length)] := v69[safeIndex(|v70|, |v69|)] !in v66;
			var v71: multiset<int> := multiset{|v69|};
			var v72: map<bool, int> := map[f11 := -0xc * |v71|];
			var v73: array<int> := new int[17](i17 => safeDivisionInt(i17, v1));
			r0, globalState.f8, v65[safeIndex(505, v65.Length)], v72, v73 := v1, (if (f11) then v1 else v1) >= (v1 - v1), v63 != v63, v72, v73;
			if (v64.f21) {
				r0 := v1;
				v73[safeIndex(634, v73.Length)] := v1;
				v73[safeIndex(634, v73.Length)] := v1;
				globalState.f8 := v62 < fm70(v73[safeIndex(634, v73.Length)], f11, globalState);
				r0 := v73[safeIndex(634, v73.Length)];
				v65[safeIndex(505, v65.Length)] := v65[safeIndex(505, v65.Length)];
			} else {
				var v74 := DC41(|p2|, v1, f10, p2, v62[safeIndex(-v1, |v62|)]);
				var v75 := 'u';
				var v76: array<string> := new string[11] [v74.cf66, p2, p2[safeIndex(v1, |p2|) := 'k'], p2, (p2 + p2)[safeIndex(725, |(p2 + p2)|) := v75], p2, p2 + p2, p2 + fm1(v1, globalState), p2, p2, p2 + p2];
				var v77 := DC3(p2);
				v76[safeIndex(259, v76.Length)] := v77.cf7;
				v76[safeIndex(259, v76.Length)] := "egfbl";
				...
				var v81: array<map<bool, bool>> := new map<bool, bool>[20] [v80, v80, map[!!false := v64.f21], map[!true := f10], v80, v80, v80, map[v65[safeIndex(505, v65.Length)] := v66[safeIndex(|v71|, |v66|)]], v80, v80, v80, v80, v80, v80, map[p0 := v65[safeIndex(505, v65.Length)]], v80, v80, v80, v80, v80];
...
class C6 extends T3 {
	...
	method m2(globalState: GlobalState) {
		...
		v0[safeIndex(752, v0.Length)] := v2[safeIndex(f15, |v2|)];
		v0[safeIndex(752, v0.Length)] := if (f10) then v1 else v1;
		var v3: seq<int> := [f14];
		var v4: array<map<bool, bool>> := new map<bool, bool>[14](i1 => map[!f10 := f10]);
		var v5 := new C0(v3, v4);
		if (false) {
			f15 := if (false) then f15 else f15;
			var v6: seq<seq<int>> := [(seq(abs(362), i2  => (f15)))[safeIndex(|map[f10 := f10]|, |(seq(abs(362), i2  => (f15)))|) := f14], [f14], [f15, f14], v5.f16, v5.f16];
			var v7 := new C0(v5.f16 + v6[safeIndex(f14, |v6|)], v5.f17);
			var v8 := 'k';
			var v9 := "oauxa";
			...
			if (v14 >= {f15, f14}) {
				...
				v15[safeIndex(33, v15.Length)] := f15;
				var v16: map<bool, bool> := map[f10 := true];
				v15[safeIndex(33, v15.Length)] := |(v14 * v14)| - |v16|;
				var v17: multiset<bool> := multiset{f10, f10, f10};
				var v18: seq<D0> := [DC1(v15[safeIndex(33, v15.Length)], [true], v17, f10, 265)];
				f15 := |v18|;
				...
				v19, globalState.f8, v15[safeIndex(33, v15.Length)], v15[safeIndex(33, v15.Length)], globalState.f8 := v19 + v19, |v20| >= (v15[safeIndex(33, v15.Length)] * v15[safeIndex(33, v15.Length)]), -|v22|, fm2(safeModuloInt(|v9|, |v9|), safeDivisionInt(f14, v15[safeIndex(33, v15.Length)]), globalState), !(v23 !in v25);
				v15[safeIndex(33, v15.Length)] := f14;
				var v26: array<bool> := new bool[23];
				v26[safeIndex(257, v26.Length)] := !!f10;
				var v27: set<array<int>> := {v15};
				v26[safeIndex(257, v26.Length)] := v27 != v27;
			} else {
				globalState.f8 := f10;
				var v28: array<int> := new int[25];
				v28[safeIndex(970, v28.Length)] := 739;
				v28[safeIndex(970, v28.Length)] := |"hvsvl"|;
				var v29, v30, v31 := m7(globalState);
				var v32: array<bool> := new bool[19](i3 => !f10);
				var v33: set<array<bool>> := {v32, v32};
				var v34: seq<bool> := [f10];
				var v35: multiset<bool> := multiset{!f10, f10, f10, v34[safeIndex(f15, |v34|)], f10};
				v8, globalState.f8, v28[safeIndex(970, v28.Length)], globalState.f8 := 'k', !(|(v33 - v33)| == v28[safeIndex(970, v28.Length)]), |((v9 + v9) + v9)|, v35 >= (v35 + v35);
				...
				v37, globalState.f8, v31, v28[safeIndex(970, v28.Length)] := v37 + (v37 + map[f10 := v36]), f10, |v38| * v7.fm16(|v29|, globalState), (0x175 + 0xa2) + -v28[safeIndex(970, v28.Length)];
			}
			...
			v41[safeIndex(86, v41.Length)] := v39;
			v41[safeIndex(86, v41.Length)] := v39;
		} else {
			var v42: array<int> := new int[9](i4 => i4 + f15);
			var v43: map<bool, int> := map[f10 := f15];
			v42[safeIndex(189, v42.Length)] := -f14 - |v43|;
			var v44 := 'i';
			var v45: array<char> := new char[17] [v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, 'f', v44, v44, v44];
			var v46 := "vjmdk";
			v45[safeIndex(901, v45.Length)] := v46[safeIndex(f14, |v46|)];
			var v47: seq<bool> := [f10, f10];
			v42[safeIndex(189, v42.Length)], globalState.f4, globalState.f8, f15, v45[safeIndex(901, v45.Length)] := (-0x29e + -0x1ce) * f15, v46, |(v43[f10 := f14])[f10 := f14]| != fm2(f15, -|v47|, globalState), f15, v44;
			var v48 := new C0([0xc1], v4);
			v45[safeIndex(901, v45.Length)] := v44;
			if (f10 || f10) {
				var v49: multiset<bool> := multiset{fm0(v42[safeIndex(189, v42.Length)], v46, globalState), f10, true};
				globalState.f8 := -|(v49 * v49)| == safeDivisionInt(f14, 272);
				var v50: array<bool> := new bool[22](i5 => false);
				var v51: map<char, array<bool>> := map[v44 := v50];
				var v52: seq<map<char, array<bool>>> := [v51];
				var v53: seq<map<char, array<bool>>> := [v52[safeIndex(v42[safeIndex(189, v42.Length)], |v52|)], v51, v51, v51, v51];
				var v54: map<map<char, array<bool>>, char> := map[(v52[safeIndex(f15, |v52|)])[v44 := v50] := v45[safeIndex(901, v45.Length)]];
				v42[safeIndex(189, v42.Length)], v42[safeIndex(189, v42.Length)], v44 := v42[safeIndex(189, v42.Length)], 0x2d3, if (map[v45[safeIndex(901, v45.Length)] := v50] in v54) then v54[map[v45[safeIndex(901, v45.Length)] := v50]] else v44;
				var v55 := new C0([|"skfyrjygn"|, v5.fm16(v42[safeIndex(189, v42.Length)], globalState)], v5.f17);
				v46 := v46;
				var v56: array<D2> := new D2[11];
				var v57 := DC7(v42[safeIndex(189, v42.Length)]);
				v56[safeIndex(430, v56.Length)] := v57;
				v56[safeIndex(430, v56.Length)], v42[safeIndex(189, v42.Length)], v42[safeIndex(189, v42.Length)], globalState.f8 := v57, (f14 - f14) - f15, DC1(f15, v47, v49, f10, v42[safeIndex(189, v42.Length)]).cf5, (f10 <==> f10) <== f10;
			} else {
				var v58: array<string> := new string[22];
				v58 := v58;
				globalState.f8 := false;
				var v59: map<int, bool> := map[safeModuloInt(v42[safeIndex(189, v42.Length)], 0x28e) := f10];
				v59 := v59[f15 := f10];
				v44 := v45[safeIndex(901, v45.Length)];
				f15 := v42[safeIndex(189, v42.Length)];
			}
			
			var v60 := DC3(v46);
			var v61: map<D1, int> := map[v60 := 0x245];
			var v62: seq<array<int>> := [v42];
			var v63: map<char, bool> := map[v45[safeIndex(901, v45.Length)] := f10];
			var v64: map<int, array<int>> := map[if (v60 in v61) then v61[v60] else fm2(v42[safeIndex(189, v42.Length)], 0x2b, globalState) := v62[safeIndex(|v63|, |v62|)]];
			v64 := v64[0x30 := v42];
		}
		...
		match (DC10(v65, v68, -f15, f10).(cf18 := v68[0xd2 := "mkufrcngm"])) {
			case DC10(cf17, cf18, cf19, cf20) =>
				...
				if (!f10) {
					...
					v65[safeIndex(103, v65.Length)] := v74 !! v74;
					...
					v65[safeIndex(103, v65.Length)], globalState.f8, cf19, f15 := v75 < v75, v77 != v78[safeIndex(cf19, |v78|)], if (!f10 in v80) then v80[!f10] else cf19, f14;
					...
					v65[safeIndex(979, v65.Length)] := v69.f10;
					v65[safeIndex(979, v65.Length)] := f10;
					...
					var v92 := DC1(f14, [true, v65[safeIndex(979, v65.Length)]], v91, v65[safeIndex(979, v65.Length)], |v66|);
					var v93 := DC19(v5.f16, cf19, v86.f10, v92);
					globalState.f8 := if (v90.cf41 || v69.f10) then v93.cf30 >= -cf19 else fm15(globalState);
				}
				
				f15 := -(cf19 + safeDivisionInt(|v67|, |v67|));
				var v94: map<bool, int> := map[f10 := v5.fm16(f15, globalState)];
				v94 := v94[!f10 := -f15];
			case DC9(cf16) =>
				v65[safeIndex(778, v65.Length)] := if (f10) then !fm0(f15, v67, globalState) else true;
				v65[safeIndex(778, v65.Length)] := f10;
				v65[safeIndex(778, v65.Length)] := f10;
				var v95: multiset<bool> := multiset{v65[safeIndex(778, v65.Length)], f10};
				globalState.f8 := !(f10 !in v95[f10 := abs(f15)]) !in v66;
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
		...
		var v2 := new C3(safeDivisionInt(-0xaf, f15), f10 !in v1, f10);
		...
		v0[safeIndex(733, v0.Length)] := |v4|;
		var v7 := DC15(v4);
		var v8: seq<int> := [f15];
		v4, v6, globalState.f8, v0[safeIndex(733, v0.Length)], f15 := if (true) then fm69(v2.f19, p0, globalState) else v7.cf25, v6[v2.f19 := v5], f15 < -0x27d, match DC14(v8) {
			case DC14(cf24) => safeModuloInt(-f14, -0xe8)
		}, p0;
		var v9 := DC35(v2.f19, v2.f18);
		match (DC36(v9)) {
			case DC35(cf54, cf55) =>
				var v10: set<int> := {-0xb0 * f14, v2.f18, -f14, v2.f18};
				v10 := {p0, safeModuloInt(-cf55, v0[safeIndex(733, v0.Length)])};
				var v11: T3 := new C2(v8[safeIndex(v2.f18, |v8|)], v2.f19);
				var v12: seq<T3> := [v11];
				cf54 := |v12| != p0;
				var v13: array<bool> := new bool[26](i0 => v2.f19);
				var v14 := DC32(p0, cf54, v2.f19, v13);
				cf55, v0[safeIndex(733, v0.Length)], v8, v0[safeIndex(733, v0.Length)] := v2.f18, v14.cf48, v8, p0;
				var v15 := "yv";
				var v16: multiset<int> := multiset{-|v15|};
				var v17: seq<bool> := [v16 !! v16, f10, true];
				globalState.f8 := v17[safeIndex(f15, |v17|)];
			case DC34(cf53) =>
				var v18 := DC35(v2.f19, 137);
				var v19 := "aehtlax";
				var v20: map<int, int> := map[333 * 0x266 := -(-v18.cf55 * |v19|)];
				v20 := v20[p0 := safeModuloInt(v0[safeIndex(733, v0.Length)], -v2.f18)];
				...
				v0[safeIndex(733, v0.Length)] := v2.fm5(v21 !! v21, v24, f10, if (v2.f19) then v2.f19 else f10, globalState);
				...
				match (v26.(cf35 := v26.cf35)) {
					case DC22(cf35) =>
						...
						v0[safeIndex(733, v0.Length)] := safeModuloInt(90, if (v29 in v30) then v30[v29] else f14);
						...
						v32[safeIndex(838, v32.Length)] := v34;
						var v35 := DC32(v2.f18, v2.f19, v2.f19, v33);
						v32[safeIndex(838, v32.Length)] := {v35.cf51, v33} + {v33, v33, v33};
						globalState.f8 := !v2.f19;
				}
			...
			case DC36(cf56) =>
				...
				if (!(|v36| !in v8)) {
					...
					var v41 := DC27(f10, (map v37 : seq<char> | v37 in v39 :: (v37) := (map[v0[safeIndex(733, v0.Length)] := v2.f18]))[seq(abs(0xd7), i3  => (v38)) := v40], v2.f18);
					...
					v45[safeIndex(518, v45.Length)] := |[true, v2.f19]| < |v40|;
					var v46: seq<bool> := [!v2.f19, v2.f19, f10, v2.f19];
					var v47: set<int> := {v2.f18, p0, |(seq(abs(0xfa), i4  => (f14)))[safeIndex(-0x213, |(seq(abs(0xfa), i4  => (f14)))|) := v0[safeIndex(733, v0.Length)]]|, p0, -v0[safeIndex(733, v0.Length)]};
					var v48: set<set<int>> := {v47, v47, v47};
					var v49: seq<set<set<int>>> := [v48, DC42(v48).cf68];
					v41, v44, v45, v0[safeIndex(733, v0.Length)], v45[safeIndex(518, v45.Length)] := fm71(v46 + v46, f15, globalState), DC16(v2.f18).(cf26 := p0), v45, safeDivisionInt(v2.f18, 0x19e), v48 >= (v49[safeIndex(v2.f18, |v49|)] - v48);
					globalState.f8 := v2.f18 < v8[safeIndex(v2.f18, |v8|)];
					globalState.f8 := (v2.f18 - |v3|) >= p0;
					var v50 := new C5(v2.f19, v2.f19);
				} else {
					var v51: set<bool> := {f10};
					var v52: set<int> := {safeDivisionInt(f15, v2.f18), |multiset{v2.f18}|, v2.fm5(v2.f19, v51, v2.f19, v2.f19, globalState)};
					v52 := v52;
					v0[safeIndex(733, v0.Length)] := p0;
					v0[safeIndex(733, v0.Length)] := safeDivisionInt(v2.f18, v2.f18);
					f15 := (|[DC35(v2.f19, |v5|).cf54, v2.f19]| - v0[safeIndex(733, v0.Length)]) - f14;
					var v53: multiset<int> := multiset{|v36|, |v51|};
					var v54 := 'x';
					var v55: map<int, int> := map[v2.f18 := |v36[safeIndex(|v53|, |v36|) := v54]|];
					var v56: map<int, map<int, int>> := map[f15 := v55];
					globalState.f8 := !(safeDivisionInt(|v56|, -0x379) < p0);
				}
				
				globalState.f8 := !v2.f19;
				globalState.f8 := fm0(-v0[safeIndex(733, v0.Length)] - 481, v36, globalState);
				var v57: set<bool> := {v2.f19, v2.f19};
				var v58: set<set<bool>> := {v57, v57};
				var v59 := 'i';
				var v60: array<string> := new string[21] [v36 + v36, "ndjgabc", v36 + v36, "ebchet", v36, v36, v36[safeIndex(|v58|, |v36|) := v59] + v36, seq(abs(0x105), i5  => (v59)), "orymqh", v36, if (f10) then v36 else v36, v36, v36 + "orvnx", v36 + v36, "ob", v36, v36, v36, v36, v36, v36 + v36];
				v60[safeIndex(433, v60.Length)] := v36;
				var v61: seq<string> := [seq(abs(0x1e5), i7  => (v36[safeIndex(v2.f18, |v36|)])), v36];
				v60[safeIndex(433, v60.Length)] := ((seq(abs(0x1e3), i6  => (v59))) + v36) + v61[safeIndex(f15, |v61|)];
		}
		
		var v62 := "nwimlnat";
		for i8 := 0x38f to safeModuloInt(|v62|, v0[safeIndex(733, v0.Length)]) {
			v0[safeIndex(733, v0.Length)] := v2.f18 + (v2.f18 - f15);
			var v63: T0 := new C1();
			var v64 := DC45(v63);
			var v65: set<T0> := {v63, v64.cf71, v63, v63};
			v0[safeIndex(733, v0.Length)] := |v65|;
			globalState.f8 := false;
		...
		globalState.f8 := v67 < (if (v2.f19) then [fm0(|v68|, seq(abs(0x359), i9  => ('e')), globalState), f10] else v67);
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		...
		v6[safeIndex(137, v6.Length)] := v8;
		v6[safeIndex(137, v6.Length)] := v8;
		var v9: array<char> := new char[22] [v0, v0, v0, 's', v0, v0, v0, v0, 'l', v0, 'g', v0, v0, v0, v0, v0, v1[safeIndex(v7[safeIndex(f14, |v7|)], |v1|)], v0, v0, v0, v0, fm36(v1, globalState)];
		var v10 := DC48(v9);
		var v11: seq<array<char>> := [v9, v9, v9];
		var v12: map<bool, array<char>> := map[f10 := v9];
		var v13: array<array<char>> := new array<char>[29] [v9, v9, v10.cf75, v9, v9, if (f10) then v9 else v9, v11[safeIndex(f14, |v11|)], v9, v9, v9, v9, v9, if (f10) then v9 else v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, DC48(v11[safeIndex(p0, |v11|)]).cf75, v9, v9, v9, v9, if (f10 in v12) then v12[f10] else v9, v9];
		v13[safeIndex(532, v13.Length)] := v9;
		v13[safeIndex(532, v13.Length)] := v9;
		if (f10) {
			...
			var v20 := DC50(v14);
			r1, globalState.f8, globalState.f8, r1, r0 := f14, fm0(p0, v1, globalState), v14 !! v14, -safeModuloInt(|v19|, f14), v20.cf79;
			v2 := map[-f15 - f15 := 0x46];
			globalState.f8 := fm6(v7 + (seq(abs(0x354), i1  => (if (p0 in v14) then v14[p0] else p0))), globalState);
			...
			match (v26) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					v27[safeIndex(921, v27.Length)] := p0;
					v27[safeIndex(921, v27.Length)] := if (0x23a > p0) then cf1 else cf5;
					v8[safeIndex(165, v8.Length)] := cf4;
					var v28: array<map<bool, bool>> := new map<bool, bool>[4](i2 => map[cf4 := cf4]);
					var v29 := DC24(v28);
					var v30: set<seq<bool>> := {cf2, ([f10])[safeIndex(f14, |[f10]|) := cf4]};
					globalState.f8, v8[safeIndex(165, v8.Length)], v29 := !(v30 > (v30 * v30)), |cf2| <= cf1, v29;
					globalState.f8 := cf4;
					v27 := v27;
				case DC0(cf0) =>
			...
			r1, globalState.f8, v7, v6[safeIndex(137, v6.Length)], globalState.f8 := v7[safeIndex(fm2(f14, p0, globalState), |v7|)] * f14, f10, [f15, p0, p0], v6[safeIndex(137, v6.Length)], f10;
			var v34: array<int> := new int[3];
			var v36: set<int> := {p0, p0, f14, 0xc2};
			v34[safeIndex(626, v34.Length)] := |((set v35 : int | (272 <= v35) && (v35 < -0x4d) :: (safeModuloInt(v35, f15))) + v36)|;
			v34[safeIndex(626, v34.Length)] := f14;
			v34[safeIndex(626, v34.Length)] := if (f10) then f15 else v34[safeIndex(626, v34.Length)];
			v6[safeIndex(137, v6.Length)][safeIndex(408, v6[safeIndex(137, v6.Length)].Length)] := f10;
			v6[safeIndex(137, v6.Length)][safeIndex(408, v6[safeIndex(137, v6.Length)].Length)] := f10;
		}
	...
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		if (f10) {
			...
			v0[safeIndex(662, v0.Length)] := f15;
			var v1 := "jsjro";
			v0[safeIndex(662, v0.Length)] := safeModuloInt(|(if (true) then v1 else v1)|, f15);
			...
			match (DC31((v3.(cf47 := multiset{f10})).cf47)) {
				case DC31(cf47) =>
					...
					globalState.f8 := v4[safeIndex(safeDivisionInt(v0[safeIndex(662, v0.Length)], |v1|), |v4|)];
					var v5: set<char> := {fm36(v1, globalState)};
					v0[safeIndex(662, v0.Length)] := |v5|;
					var v6 := DC3("kjk");
				...
				case DC33(cf52) =>
					...
					var v25: seq<int> := [f15];
					var v26 := DC14(v25);
					f15 := --safeModuloInt(|v26.cf24|, v0[safeIndex(662, v0.Length)]);
					var v27: set<int> := {v0[safeIndex(662, v0.Length)]};
					var v28 := 'h';
					var v29: map<int, int> := map[f15 := |(("c")[safeIndex(|v27|, |"c"|) := v28] + v1)|];
					v29 := v29[safeModuloInt(|(seq(abs(776), i0  => (v28)))|, |v24|) := f15];
					var v30: seq<bool> := [f10, false];
					var v31: map<bool, int> := map[p1 := |(v30 + v30[safeIndex(f15, |v30|) := f10])|];
					var v32: seq<string> := [v1];
					v31 := v31[v32[safeIndex(-f14, |v32|)] != v1 := f15];
			}
			...
			v39[safeIndex(624, v39.Length)] := !(v41[safeIndex(if (|v42| in v40) then v40[|v42|] else |v42|, |v41|)] > v40);
			v39[safeIndex(624, v39.Length)] := p0;
			if (v39[safeIndex(624, v39.Length)] && (f10 ==> f10)) {
				globalState.f8 := !true;
				v39[safeIndex(624, v39.Length)] := p0;
				globalState.f8 := p1;
				var v43: array<map<bool, bool>> := new map<bool, bool>[6];
				var v44 := new C0(v42, v43);
				var v45: multiset<bool> := multiset{!v39[safeIndex(624, v39.Length)], v39[safeIndex(624, v39.Length)]};
				var v46: set<multiset<bool>> := {multiset{f10, v39[safeIndex(624, v39.Length)], p0}, v45, v45};
				var v47 := 'e';
				var v48: seq<char> := [v47, v47];
				var v49: map<int, bool> := map[f14 := true];
				var v50 := DC41(f14, f15, f10, v48, |v49|);
				var v51: array<int> := new int[13] [f14, f14, safeDivisionInt(|fm23(v46, v47, v48, globalState)|, f15), v38 * v38, |"wjiupijak"|, f14 * |v42|, f14, v38, safeModuloInt(f15, f15), f15, 535, 0x270 - |multiset{v39[safeIndex(624, v39.Length)], v50.cf65, f10}|, f14];
				v51[safeIndex(591, v51.Length)] := f15;
				v51[safeIndex(591, v51.Length)] := safeDivisionInt(safeDivisionInt(f14, v38), f15);
			} else {
				var v52 := new C3(v38, p1, f10);
				v39[safeIndex(624, v39.Length)] := p0;
				v42 := v42;
				var v53: set<bool> := {!false, v39[safeIndex(624, v39.Length)], p0, !f10, true <==> f10};
				v53 := v53 - v53;
		...
		var v58 := 'x';
		v55[safeIndex(751, v55.Length)] := fm36("uqsjkm", globalState) in ("y")[safeIndex(|v57[safeIndex(f15, |v57|)]|, |"y"|) := v58];
		var v59: array<int> := new int[23](i3 => safeModuloInt(i3, |"jiqm"|));
		v59[safeIndex(120, v59.Length)] := if (p0) then f14 else fm2(f15, f14, globalState);
		var v60: seq<int> := [if (p1) then f14 else --54];
		var v61: seq<bool> := [!f10, f10, p1];
		var v62 := "av";
		var v63: multiset<bool> := multiset{v61[safeIndex(|v62|, |v61|)], f10, !f10};
		var v64: set<multiset<bool>> := {v63};
		var v65: seq<set<multiset<bool>>> := [v64, v64, v64];
		v55[safeIndex(751, v55.Length)], v59[safeIndex(120, v59.Length)], f15 := p1, v60[safeIndex(f14, |v60|)], |v65[safeIndex(safeDivisionInt(f15, f15), |v65|)]|;
		v55[safeIndex(751, v55.Length)] := p0;
		if (v55[safeIndex(751, v55.Length)]) {
			if (f10) {
				var v66 := DC14(v60);
				var v67: array<D6> := new D6[2] [v66, v66];
				var v68: map<int, bool> := map[f14 := v55[safeIndex(751, v55.Length)]];
				...
				v59[safeIndex(120, v59.Length)] := f14;
				v55[safeIndex(751, v55.Length)] := p0;
			} else {
				...
				v59[safeIndex(120, v59.Length)] := -fm2(-v75.f18, f15, globalState);
			}
			
			var v76 := DC35(f10, f15);
			var v77: map<bool, D15> := map[p0 := v76];
			v77 := v77[v55[safeIndex(751, v55.Length)] := v76];
			globalState.f8 := f10;
			var v78: seq<seq<bool>> := [v61];
			var v79: map<seq<bool>, int> := map[v78[safeIndex(0x2db, |v78|)] := f15];
			...
			v82[safeIndex(485, v82.Length)] := v62[safeIndex(|(set v83 : int | (467 <= v83) && (v83 < 0x2b0) :: (v83 - -|multiset(seq(abs(0x285), i4  => (-f15)))|))|, |v62|)];
			v82[safeIndex(485, v82.Length)] := v58;
		} else {
			if ((v59[safeIndex(120, v59.Length)] * v59[safeIndex(120, v59.Length)]) > f15) {
				f15 := |v62|;
				v55[safeIndex(751, v55.Length)] := v59[safeIndex(120, v59.Length)] == f15;
				globalState.f8 := f10;
				var v84: array<char> := new char[10];
				v84[safeIndex(865, v84.Length)] := v58;
				var v85: C3 := new C3(v59[safeIndex(120, v59.Length)] - f15, f10, p0);
				var v86: array<map<bool, bool>> := new map<bool, bool>[14];
				var v87: C0 := new C0((v60 + [v59[safeIndex(120, v59.Length)]])[safeIndex(v85.f18, |(v60 + [v59[safeIndex(120, v59.Length)]])|) := v59[safeIndex(120, v59.Length)]], v86);
				v84[safeIndex(865, v84.Length)], v85, v87, f15 := 't', v85, v87, -0x1bf * f14;
				var v88: array<string> := new string[24](i5 => v62);
				v88[safeIndex(467, v88.Length)] := v62;
				v55[safeIndex(751, v55.Length)], v87.f16, v88[safeIndex(467, v88.Length)] := v55[safeIndex(751, v55.Length)], v87.f16, fm1(v85.f18, globalState) + v62[safeIndex(-260, |v62|) := v84[safeIndex(865, v84.Length)]];
			} else {
				var v89: map<bool, string> := map[p0 := v62];
				var v90: array<string> := new string[25] [v62 + v62, "q", v62, "y", v62 + "wcrbejx", v62[safeIndex(v59[safeIndex(120, v59.Length)], |v62|) := v58], v62 + v62, v62, "gxhvojb", if (p0 in v89) then v89[p0] else v62, (seq(abs(-0xdf), i6  => (v58))) + v62, v62[safeIndex(v59[safeIndex(120, v59.Length)], |v62|) := v58], v62, "ul" + v62, v62, v62 + v62, v62, v62, v62, v62 + v62, v62, v62, v62, "ve", "iawffi"];
				v90[safeIndex(514, v90.Length)] := ("vif")[safeIndex(f15, |"vif"|) := v58];
				var v91: seq<seq<bool>> := [v61];
				var v92 := DC53(v91);
				var v93: seq<seq<seq<bool>>> := [v91, v91, v92.cf84];
				v59[safeIndex(120, v59.Length)], f15, v90[safeIndex(514, v90.Length)] := f15 + |v93[safeIndex(|v62|, |v93|)]|, 0x3d7 - (-f15 - f14), v62;
				v59[safeIndex(120, v59.Length)] := f15 * f14;
				var v94: array<multiset<bool>> := new multiset<bool>[10](i7 => multiset{p0, v55[safeIndex(751, v55.Length)]});
				v94[safeIndex(71, v94.Length)] := multiset{p1, fm0(f14, "dyua", globalState), fm0(v59[safeIndex(120, v59.Length)], v90[safeIndex(514, v90.Length)], globalState)};
				v94[safeIndex(71, v94.Length)] := multiset(v91[safeIndex(f14, |v91|)]);
				globalState.f8 := f10;
				f15 := v59[safeIndex(120, v59.Length)];
			}
			
			var v95: map<int, bool> := map[-0x2d2 := !p0];
			var v96: set<bool> := {false, f10};
			var v97 := DC14((seq(abs(969), i8  => (f15)))[safeIndex(|v95|, |(seq(abs(969), i8  => (f15)))|) := fm5(f10, v96, v55[safeIndex(751, v55.Length)], true, globalState)]);
			v97 := v97;
			var v98: multiset<char> := multiset{v58};
			v59[safeIndex(120, v59.Length)], v98 := v59[safeIndex(120, v59.Length)], v98;
			globalState.f8 := true;
		...
		for i9 := |(v102 + v102)| to f15 {
			globalState.f8 := f10;
			globalState.f8 := fm0(v59[safeIndex(120, v59.Length)], fm1(0x1a9, globalState), globalState);
			globalState.f8 := fm15(globalState);
			var v103: map<int, int> := map[0x213 := v59[safeIndex(120, v59.Length)]];
			var v104: map<bool, map<bool, int>> := map[f10 := v56];
			f15 := fm2(i9, |(v103[|(if (v55[safeIndex(751, v55.Length)] in v104) then v104[v55[safeIndex(751, v55.Length)]] else v56)| := f15] + v103)|, globalState);
		}
	...
	method m7(globalState: GlobalState) returns (r0: map<bool, bool>, r1: multiset<array<D0>>, r2: int) {
		...
		for i0 := f14 to |v1| {
			...
			var v3 := "k";
			globalState.f8 := if (f14 == i0) then f10 else fm0(v2[safeIndex(f15, |v2|)], v3, globalState);
		...
		if (!f10) {
			...
			v9[safeIndex(849, v9.Length)] := v8;
			var v10: T0 := new C1();
			var v11: array<bool> := new bool[8](i1 => f10);
			var v12 := 'c';
			var v13: set<string> := {"drph", "amawbr", ("getpw")[safeIndex(f14, |"getpw"|) := v12]};
			v11[safeIndex(517, v11.Length)] := v13 == (set v14 : string | v14 in map[seq(abs(-0x20e), i2  => (v12)) := f15] :: (v14));
			var v15 := "bavdygke";
			var v16: map<seq<int>, string> := map[[f15] := v15];
			var v17 := DC9(v0);
			var v18 := DC49(-f14, v12, v17);
			var v19: map<D21, bool> := map[v18 := f10];
			v9[safeIndex(849, v9.Length)], v10, v11[safeIndex(517, v11.Length)], v0, v16 := v8, DC45(v10).cf71, if (v18 in v19) then v19[v18] else !true, v0, v16;
			if (true) {
				var v20: array<C3> := new C3[4];
				var v21: C3 := new C3(f15, f10, f10);
				v20[safeIndex(156, v20.Length)] := v21;
				...
				v20[safeIndex(156, v20.Length)], f15, f15 := v21, |((map[f14 := f14])[f15 := -f15] + v22)|, -v25.f16[safeIndex(f14, |v25.f16|)] + |multiset{v11[safeIndex(517, v11.Length)], f10}|;
				var v28 := DC3(v15);
				var v29: seq<bool> := [v11[safeIndex(517, v11.Length)]];
				v28 := fm68(v29, true, |([v21.f19, f10] + v29)|, v21.f18, globalState);
				var v30: array<seq<array<int>>> := new seq<array<int>>[1];
				v30[safeIndex(600, v30.Length)] := [v0];
				v30[safeIndex(600, v30.Length)] := v1;
				var v31 := DC51(v15, |v15|);
				globalState.f4 := v31.cf80;
				v0[safeIndex(773, v0.Length)] := |(if (false) then v15 else v15)|;
				v0[safeIndex(773, v0.Length)] := f15;
			} else {
				globalState.f8 := v11[safeIndex(517, v11.Length)];
				var v32 := new C1();
				r2 := f15 * -(f14 + f14);
				v11[safeIndex(517, v11.Length)] := f10;
				globalState.f8 := f10;
			}
			...
			var v38: array<map<string, int>> := new map<string, int>[15] [v33, v33, v33, v33, v33, v33, map[v15 := f15], v33, map["nftols" := f15] + v33, map v34 : string | v34 in {v15, v15} :: (v34) := (f15), map[v15[safeIndex(316, |v15|) := v12] := |(if (|[f10]| in v37) then v37[|[f10]|] else v36)|], v33, if (fm15(globalState)) then v33 else v33, v33[v15 := -f15], v33];
			v38[safeIndex(973, v38.Length)] := v33;
			var v39: map<bool, bool> := map[v11[safeIndex(517, v11.Length)] := false];
			var v40: map<bool, array<int>> := map[v11[safeIndex(517, v11.Length)] := v0];
			var v43: seq<map<string, int>> := [v33 + (map v41 : string | v41 in v33 :: (v41) := (f14)), map[v15 := |(seq(abs(0xf2), i3  => (|(map v42 : set<bool> | v42 in [{v11[safeIndex(517, v11.Length)]}, {true}] :: (v42) := ([f10, v11[safeIndex(517, v11.Length)]]))|)))|]];
			var v44: seq<int> := [f14];
			...
			globalState.f8, v0, v38[safeIndex(973, v38.Length)], r2 := v11[safeIndex(517, v11.Length)], if (v11[safeIndex(517, v11.Length)] in v39) then v0 else if (v11[safeIndex(517, v11.Length)] in v40) then v40[v11[safeIndex(517, v11.Length)]] else v0, v43[safeIndex(|v46|, |v43|)], if (f10 in v49) then v49[f10] else f15;
			r0 := map[f10 := v11[safeIndex(517, v11.Length)]];
			var v50: map<bool, char> := map[if (v11[safeIndex(517, v11.Length)] in v39) then v39[v11[safeIndex(517, v11.Length)]] else v11[safeIndex(517, v11.Length)] := v12];
			v50 := v50[f10 ==> !f10 := v12];
		} else {
			r2 := f14;
			r2 := safeModuloInt(-f15, 950);
			if (f10) {
				r2 := 0x36b;
				...
				var v62: seq<int> := [f14];
				var v63: multiset<int> := multiset{v62[safeIndex(f14, |v62|)]};
			...
			var v70: map<int, bool> := map[v67[safeIndex(f15, |v67|)] := DC7(f14) !in v69];
			...
			if (if ((if (f10 in v71) then v71[f10] else f15) in v70) then v70[if (f10 in v71) then v71[f10] else f15] else f10) {
				...
				v74[safeIndex(215, v74.Length)] := v75;
				var v76 := DC56(v75);
				v74[safeIndex(215, v74.Length)] := (v76.(cf87 := v75)).cf87;
				f15 := fm2(f15, v67[safeIndex(f14, |v67|)], globalState);
				var v77: multiset<bool> := multiset{f10, f10};
				var v78: seq<bool> := [f10];
				var v79: set<int> := {f14};
				var v80: map<string, bool> := map["pbsr" := true];
				var v81: array<bool> := new bool[8] [v78[safeIndex(f14, |v78|)], v75.fm6([0x131, |v79|], globalState), f10, f10, f10, if ("hnqv" in v80) then v80["hnqv"] else f10, f10, f10];
				var v82: seq<array<bool>> := [v81, v81];
				var v83: map<bool, array<bool>> := map[!(v77 != multiset(fm61(true, false, f10, globalState))) := v82[safeIndex(f14, |v82|)]];
				v83 := v83 + v83;
				var v84 := 'b';
				v84 := v84;
			} else {
				...
				var v86 := "xfi";
				var v87: map<D9, bool> := map[DC22(v1[safeIndex(|{f15, f15}|, |v1|) := v0]) := fm0(f15, v86, globalState)];
				var v88: multiset<bool> := multiset{f10, v85[safeIndex(-|v87|, |v85|)], f10};
				...
				var v97: array<map<map<D12, bool>, bool>> := new map<map<D12, bool>, bool>[6] [v95, v95[v94 := f10], v95, v95, map[v94 := f10], v96[safeIndex(-0x95, |v96|)]];
				v97[safeIndex(438, v97.Length)] := v95;
				var v98: map<array<int>, seq<int>> := map[v0 := v67];
				f15, v97[safeIndex(438, v97.Length)], f15 := f15, v95, |(v98 + (v98 + v98))|;
			}
		...
		if (f10) {
			...
			if (fm6(v101, globalState)) {
				var v102 := 'k';
				v100 := DC3(v100[safeIndex(f15, |v100|) := v102]).cf7;
				...
				v105 := seq(abs(0xa8), i6  => (v105[safeIndex(-f14, |v105|)]));
				r2 := |v100|;
				v0[safeIndex(674, v0.Length)] := f15 * |v101|;
				var v106: seq<bool> := [f10, !f10];
				var v107: map<int, bool> := map[f14 := f10];
				var v108 := DC40(f10, !!v106[safeIndex(0x8, |v106|)], if (f10) then f15 else |v107|);
				v0[safeIndex(674, v0.Length)], v108 := f14, fm73(|(seq(abs(-197), i7  => (v101[safeIndex(f15, |v101|)])))|, f14, v106, globalState);
			} else {
				v0[safeIndex(441, v0.Length)] := |map[true := f10]|;
				v0[safeIndex(441, v0.Length)] := f14;
				var v109: array<D12> := new D12[26];
				var v110: seq<bool> := [f10, f10, f10, f10, f10];
				var v111: map<string, int> := map["kvaek" := |v110|];
				var v112 := DC26(v111);
				v109[safeIndex(747, v109.Length)] := v112;
				v109[safeIndex(747, v109.Length)] := DC26(v111);
				var v113: multiset<int> := multiset{f15};
				v113 := v113 - (v113 + v113);
				v0[safeIndex(441, v0.Length)] := v0[safeIndex(441, v0.Length)];
				var v115 := DC35(f10, v0[safeIndex(441, v0.Length)]);
				var v116 := DC0(f10);
				var v117: array<bool> := new bool[17] [f10, f14 < |(set v114 : int | v114 in v101 :: (safeDivisionInt(v114, 0x2e3)))|, f10, f10, f10, v115.cf54, false, !(v0[safeIndex(441, v0.Length)] != f15), true && false, f10, f10, f10, true, f10, v116.cf0, |v110| == f14, f14 > f15];
				v117[safeIndex(279, v117.Length)] := f10;
				var v118: seq<seq<int>> := [seq(abs(0xcc), i8  => (|v100|))];
				var v119 := DC59(v118);
				v117[safeIndex(279, v117.Length)] := v119.cf91 != [[v0[safeIndex(441, v0.Length)], |v100|, -f15, f15, if (f15 in v113) then v113[f15] else 0x1c4]];
			}
			
			globalState.f8 := v100 == ((seq(abs(0x1a1), i9  => ('x'))) + v100);
			v0[safeIndex(999, v0.Length)] := -f14;
			v0[safeIndex(999, v0.Length)] := -0x203;
			globalState.f8 := f10;
		} else {
			...
			v126[safeIndex(617, v126.Length)] := v120.f21;
			var v127: map<bool, string> := map[v120.f21 := "f"];
			var v128: map<bool, int> := map[v120.f21 := |v127|];
			v126[safeIndex(617, v126.Length)] := !((|v128| + |v121|) != f15);
			var v129: seq<int> := [f15];
			var v130: seq<seq<int>> := [v129];
			var v131: map<int, string> := map[f15 := v125];
			var v132: map<seq<seq<int>>, string> := map[v130 := "pc" + (if (0x242 in v131) then v131[0x242] else seq(abs(0x1af), i10  => (v124)))];
			v132 := v132[v130 + v130 := seq(abs(0x2bb), i11  => (v124))];
			f15 := |(if (fm0(f14, v125, globalState)) then v125 else seq(abs(304), i12  => (v124)))|;
			v126[safeIndex(617, v126.Length)] := f14 == f15;
		}
...
class C7 extends T0 {
	...
	function fm5(p0: bool, p1: set<bool>, p2: bool, p3: bool, globalState: GlobalState): int {
		safeDivisionInt(-(0x29c * 0x309), -|multiset{|map[0x39e := f13]|, |DC3("x").cf7|}|)
	}
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
			...
			decreases 100 - i0
		{
			...
			var v0: array<int> := new int[28];
			r1 := -(|map[f13 := v0]| + p0);
			v0 := new int[27](i1 => safeDivisionInt(i1, p0));
			var v1: seq<bool> := [f13];
			if (v1 != [f13]) {
				var v2 := "nnddspry";
				r1 := |v1[safeIndex(|v2|, |v1|) := f13]|;
				r1 := p0;
				...
				var v16 := 'o';
				globalState.f4 := ((v12 + v12) + v12)[safeIndex(|(map[f13 := map v13 : int | (-0x2d9 <= v13) && (v13 < 0x2fb) :: (safeModuloInt(v13, p0)) := (true)] + v15[v10.f10 := v14])|, |((v12 + v12) + v12)|) := v16];
				r1 := -p0;
				v0[safeIndex(431, v0.Length)] := |v14|;
				v0[safeIndex(431, v0.Length)] := p0;
				var v17: array<seq<string>> := new seq<string>[27](i2 => (seq(abs(0x23d), i3  => (v12))) + [v12, v12, v12]);
				v17[safeIndex(187, v17.Length)] := seq(abs(0x1f1), i4  => (v12));
				var v18 := DC47(v0[safeIndex(431, v0.Length)]);
				var v19: map<bool, string> := map[true := v12];
				var v20: seq<string> := ["fhcm", if (f13 in v19) then v19[f13] else v12];
				v17[safeIndex(187, v17.Length)], v18, globalState.f8 := v20 + v20, v18, !v10.f10;
			}
		...
		if (f13) {
			...
			v21[safeIndex(548, v21.Length)] := p0;
			v21[safeIndex(548, v21.Length)] := 516;
			v21[safeIndex(548, v21.Length)] := v21[safeIndex(548, v21.Length)];
			var v22 := DC40(f13, f13, v21[safeIndex(548, v21.Length)]);
			v22 := v22;
			var v23 := 'x';
			v23 := v23;
		} else {
			...
			v27[safeIndex(594, v27.Length)] := -p0;
			var v28: map<int, bool> := map[p0 := false];
			v27[safeIndex(594, v27.Length)] := |(v28 + (v28 + v28))|;
			var v29: multiset<int> := multiset{--(if (f13) then p0 else 463), p0};
			r0 := v29;
			v27[safeIndex(594, v27.Length)] := v27[safeIndex(594, v27.Length)];
		}
		
		r2 := seq(abs(335), i5  => (safeDivisionInt(p0, p0)));
	...
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		if (p0) {
			...
			globalState.f8, globalState.f8, v7 := fm13(globalState), p0, v8[safeIndex(0x3b3 + v7, |v8|)];
			...
			v9[safeIndex(640, v9.Length)] := v17;
			v9[safeIndex(640, v9.Length)] := v17;
			v13[safeIndex(173, v13.Length)] := 0x32c + v7;
			v13[safeIndex(173, v13.Length)] := if (p1) then v7 else safeModuloInt(v7, |{p0}|);
			var v18 := DC41(v13[safeIndex(173, v13.Length)], -v13[safeIndex(173, v13.Length)], p1, fm1(v13[safeIndex(173, v13.Length)], globalState), v13[safeIndex(173, v13.Length)]);
			if (v18.cf65) {
				v8 := v8;
				v13[safeIndex(173, v13.Length)] := v7;
				var v19: multiset<bool> := multiset{f13};
				var v20 := "xvxg";
				var v21: array<bool> := new bool[13];
				var v22 := DC32(fm2(v13[safeIndex(173, v13.Length)], |[|v20|, v13[safeIndex(173, v13.Length)]]|, globalState), f13, p1, v21);
				var v23, v24, v25, v26 := m5(v19, -v13[safeIndex(173, v13.Length)], v22.cf49, globalState);
				var v27: seq<bool> := [fm0(v25, v20, globalState), v23, v24, p1];
				v27 := v27[safeIndex(v13[safeIndex(173, v13.Length)], |v27|) := f13] + v27;
				var v28 := DC64(v23);
				var v29: set<D26> := {v28, DC64(false), v28};
				v29 := v29;
			} else {
				var v30: multiset<bool> := multiset{p1, p0, false};
				var v31, v32, v33, v34 := m5(v30, -v13[safeIndex(173, v13.Length)], p1, globalState);
				...
				v36[safeIndex(297, v36.Length)] := v10 - v10;
				v36[safeIndex(297, v36.Length)] := v10 * {f13, v31};
				var v37: array<bool> := new bool[14](i1 => !v32);
				v37[safeIndex(597, v37.Length)] := p0;
				v37[safeIndex(597, v37.Length)] := v13[safeIndex(173, v13.Length)] >= v7;
				v37[safeIndex(597, v37.Length)] := v7 < 0x1e0;
			}
			
			var v38: map<multiset<bool>, int> := map[multiset{p1} := v7];
			var v39: multiset<bool> := multiset{p1};
			var v40: set<int> := {v13[safeIndex(173, v13.Length)], |v38[v39 := v13[safeIndex(173, v13.Length)]]|, 221};
			var v41 := "pi";
			...
			v42 := (v42 + (map[fm66(v13[safeIndex(173, v13.Length)], v13[safeIndex(173, v13.Length)], globalState) := "vcxcnccg"])[{|v44|, v7, v7, v7, v13[safeIndex(173, v13.Length)]} := seq(abs(533), i2  => (v12))]) + v42;
		}
			...
			decreases 100 - i3
		{
			...
			var v52: array<multiset<bool>> := new multiset<bool>[6] [v46, fm23(v47, v48, v49[safeIndex(v50, |v49|) := v48], globalState), v51[safeIndex(v50, |v51|)], v46, v46 + v46, multiset{f13} + multiset{p1}];
			var v53: C5 := new C5(f13, f13);
			var v54 := DC56(v53);
			var v55: map<D24, bool> := map[v54 := true];
			var v56: seq<array<multiset<bool>>> := [v52, v52, v52];
			var v57: seq<int> := [v50];
			v52 := if (if (v54 in v55) then v55[v54] else v45[safeIndex(v50, |v45|)]) then v56[safeIndex(|v57|, |v56|)] else v52;
			var v58: array<map<bool, bool>> := new map<bool, bool>[15](i4 => map[true := true]);
			var v59 := new C0(v57[safeIndex(v50, |v57|) := v50], v58);
		...
		var v64 := 'h';
		v63[safeIndex(53, v63.Length)] := v64;
		...
		v65[safeIndex(343, v65.Length)] := v71;
		var v72: multiset<char> := multiset{v64, 'v', v64};
		v63[safeIndex(53, v63.Length)], globalState.f8, v64, v65[safeIndex(343, v65.Length)] := v64, v66 <= v67[safeIndex(v66, |v67|)], fm19(DC1(|v72|, v45, v68, p0, v66), if (false) then true else f13, globalState), v71[fm0(v66, v61, globalState) := v66];
		for i5 := v66 to v66 {
			v66 := -v66;
			v61 := "afugysgje";
			var v73 := DC3(v61);
			match (v73) {
				case DC4(cf8, cf9, cf10, cf11) =>
					...
					globalState.f4 := v61;
					v66 := safeModuloInt(v69.cf5, v66 * v66);
				case DC3(cf7) =>
					v66 := 0x131;
					globalState.f8 := f13;
					globalState.f8 := if (f13) then p1 else p0;
					var v74: array<int> := new int[3];
					v74[safeIndex(246, v74.Length)] := safeDivisionInt(v66, i5);
					var v75: map<bool, bool> := map[f13 := f13];
					v74[safeIndex(246, v74.Length)], globalState.f4, v74 := |((v45 + v45) + v45[safeIndex(-fm2(v66, |v75|, globalState), |v45|) := p1])|, v61, v74;
				case DC5(cf12) =>
					var v76 := new C1();
					var v77: array<int> := new int[22];
					v77[safeIndex(320, v77.Length)] := -i5;
					globalState.f4, v77[safeIndex(320, v77.Length)] := "afjpkbut", i5;
					var v78: map<bool, bool> := map[p1 := p1];
					v78 := (v78 + v78) + v78;
					var v79: array<string> := new string[5](i6 => DC41(i5, v66, f13, v61, v66).cf66);
					v79[safeIndex(669, v79.Length)] := v61;
					...
					v66, globalState.f8, globalState.f8, v79[safeIndex(669, v79.Length)] := v76.fm5(f13, v80, f13, |{v82}| in v83, globalState), p1, (v77[safeIndex(320, v77.Length)] + 0xc7) > v77[safeIndex(320, v77.Length)], ((seq(abs(751), i7  => (v64))) + v61) + v61;
			}
	...
	method m5(p0: multiset<bool>, p1: int, p2: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: char) {
		...
		if (f13) {
			...
			v6 := v6[p1 := v5[safeIndex(p1, |v5|) := p1]];
			var v7 := "crhontd";
			var v8: array<int> := new int[16] [p1, p1, p1 - p1, --p1, p1 + p1, p1, p1 + p1, p1, p1, p1, |v7| - p1, if (v2.f10) then p1 else p1, fm2(|(seq(abs(864), i0  => ('f')))|, p1, globalState), p1, if (v1.f21) then p1 else 0x18f, fm12(v7[safeIndex(p1, |v7|)], p1, p1, globalState)];
			v8[safeIndex(674, v8.Length)] := p1 + p1;
			v8[safeIndex(674, v8.Length)] := -safeDivisionInt(p1, p1);
			r2 := p1 - v8[safeIndex(674, v8.Length)];
			...
			var v15: array<set<int>> := new set<int>[6] [v11, v11, v11, v11, {v8[safeIndex(674, v8.Length)], p1}, if (DC60(v12, v8) in v14) then v14[DC60(v12, v8)] else {v8[safeIndex(674, v8.Length)]}];
			v10[safeIndex(799, v10.Length)] := v15;
			v8[safeIndex(674, v8.Length)], v10[safeIndex(799, v10.Length)] := p1 + (-0xdd - p1), v15;
		} else {
			if (!f13) {
				var v16 := "wch";
				r2 := |v16| * |p0|;
				...
				var v27: array<int> := new int[12](i1 => safeDivisionInt(i1, p1));
				...
				r2 := if (v33 < {p1, p1}) then p1 else safeModuloInt(p1, |v31|);
				r2 := p1;
				globalState.f8 := p2;
			}
			...
			var v37 := DC30(v36);
			var v38: map<D14, int> := map[v37 := safeDivisionInt(v36.f20, p1)];
			v38 := v38[v37 := -v0.cf55];
			...
			var v44 := 'f';
			var v45: set<string> := {seq(abs(0x28), i2  => ('e'))};
			var v46 := DC4(v45, v36.f20, true, v36.f20);
			var v47: array<int> := new int[26] [safeModuloInt(p1, p1), v36.f20, |(if (p2 in v40) then v40[p2] else v34)|, p1, 0x387, |v42|, |multiset{f13}|, p1 + 0x1de, safeModuloInt(-0x3d3, v36.f20), fm2(|v43|, |"urm"|, globalState), v36.f20, v36.f20 * p1, safeDivisionInt(|fm53(v44, v46, f13, {f13}, globalState)|, v36.f20), p1, 873 - p1, p1, p1, 2, v36.f20, -|v34| * -0x30e, v36.f20, v36.f20, fm2(|multiset(v41)|, -v36.f20, globalState), v36.f20, p1, v36.f20];
			v47[safeIndex(871, v47.Length)] := fm12(v44, |v34|, v36.f20, globalState);
			...
			v48[safeIndex(35, v48.Length)] := if (f13) then v51 else v51;
			v39, v47[safeIndex(871, v47.Length)], v48[safeIndex(35, v48.Length)], r2 := v39, p1, v51, 0x6d;
			if (if (v47[safeIndex(871, v47.Length)] in v49) then v49[v47[safeIndex(871, v47.Length)]] else p2) {
				globalState.f4 := "lqachqnm" + v34;
				r2 := 0x51;
				var v52 := new C4(p2);
				v36.m2(globalState);
				var v53: array<array<int>> := new array<int>[5];
				v53[safeIndex(167, v53.Length)] := v47;
				var v54 := DC35(f13, v47[safeIndex(871, v47.Length)]);
				var v55 := DC36(v54);
				var v56: map<D15, int> := map[DC36(v55) := p1];
				var v57 := DC36(v54);
				var v58: array<map<D15, int>> := new map<D15, int>[14] [v56 + map[v57 := v36.f20], v56 + v56, (map[v57.(cf56 := v54) := v47[safeIndex(871, v47.Length)]])[v57 := v36.f20], v56 + v56, v56 + v56, v56, v56, v56, v56, v56, map[v57 := v36.f20] + v56, v56, v56, v56];
				var v59 := DC60(v44, v47);
				var v60: array<char> := new char[27] [v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, 'j', v44, v34[safeIndex(p1, |v34|)], v44, v59.cf92, v44, v44, v44, v44, v44, v44, v44];
				v60[safeIndex(207, v60.Length)] := v44;
				v53[safeIndex(167, v53.Length)], r2, v58, v60[safeIndex(207, v60.Length)] := v47, |v34|, v58, v44;
			} else {
				...
				v63[safeIndex(716, v63.Length)] := if (f13) then f13 else p2;
				var v64: set<bool> := {f13, false};
				var v65: multiset<int> := multiset{p1, -|v64|};
				v63[safeIndex(716, v63.Length)] := v65 >= (v65 + multiset(DC19(v50, 0x1d8, f13, DC1(fm2(v47[safeIndex(871, v47.Length)], v36.f20, globalState), [f13, p2, true], p0, f13, v36.f20)).cf29));
				var v66: map<string, seq<int>> := map[v34 := v50];
				v66 := v66 + v66;
				v47[safeIndex(871, v47.Length)] := p1;
			}
			
			var v67: seq<array<int>> := [v47];
			var v68 := DC47(|v67|);
			r2 := v47[safeIndex(871, v47.Length)] * (v68.cf74 + v36.f20);
		}
		...
		for i3 := p1 to 202 {
			...
			r1 := i3 >= |v74|;
			var v75: array<bool> := new bool[19] [p2, true, fm0(i3, v73, globalState), p2, f13, 591 >= i3, (seq(abs(0x46), i4  => ('b'))) < v73, p2, f13, f13, true, f13, false, if (p2) then f13 else f13, p2, if (f13) then f13 else f13, p2, p2, p1 in v71];
			v75[safeIndex(381, v75.Length)] := !p2;
			v75[safeIndex(381, v75.Length)] := p2 <==> f13;
			var v76: map<bool, map<bool, string>> := map[p2 := map[p2 := "u"]];
			var v77: seq<map<bool, string>> := [v74[p2 := "ldhn"], v74, v74];
			v76 := v76[v75[safeIndex(381, v75.Length)] := v77[safeIndex(-i3, |v77|)]];
			var v78: map<bool, array<bool>> := map[v75[safeIndex(381, v75.Length)] := v75];
			v78 := v78[f13 !in v69 := v75];
		}
		var v79: seq<bool> := [p2, p2];
		var v80: array<bool> := new bool[24] [f13, false, f13, f13, p2, p2, f13, f13, f13, f13, p2, p2, p2, p2, f13, f13, v79[safeIndex(p1, |v79|)], false, f13, false, f13, p2, p2, false];
		var v81: map<array<bool>, bool> := map[v80 := p1 >= p1];
		v81 := if (f13) then v81 else v81;
		r0 := true <== f13;
		var v82 := "xtpu";
		var v83 := 'a';
		r1 := v82 == v82[safeIndex(p1, |v82|) := v83];
		r2 := -p1;
		r3 := v83;
	}
	method m6(p0: bool, p1: map<bool, T3>, globalState: GlobalState) returns (r0: string) {
		...
		if ((-v0 - v0) <= |(v5 + v5)|) {
			...
			var v9: map<int, int> := map[|v7[v3.f20 := abs(|v8|)]| := v3.f20];
			...
			v12[safeIndex(449, v12.Length)] := f13;
			var v13: map<string, bool> := map[v2 := v6.f21];
			v12[safeIndex(449, v12.Length)] := fm74(v3.f20, globalState) != v13;
			var v14: array<string> := new string[21](i0 => DC51(v2, -v3.f20).cf80);
			v14 := v14;
			var v15: array<int> := new int[23];
			v15[safeIndex(212, v15.Length)] := v0;
			v15[safeIndex(212, v15.Length)] := |v11[safeIndex(v3.f20, |v11|) := -v3.f20]|;
			v9 := v9[v11[safeIndex(v0, |v11|)] := v0];
		} else {
			globalState.f8 := f13;
			globalState.f8 := p0;
			v0 := -v3.f20 - v3.f20;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v16: array<int> := new int[5](i2 => safeModuloInt(i2, v3.f20));
			v16[safeIndex(444, v16.Length)] := v0;
			...
			v16[safeIndex(444, v16.Length)], v17 := |v21|, v17;
			v16[safeIndex(444, v16.Length)] := v3.f20;
			v3.m2(globalState);
			var v22: map<char, bool> := map[v1 := p0];
			var v23: set<int> := {v3.f20};
			var v24: multiset<int> := multiset{fm2(v3.f20, |v23|, globalState), v0, v0};
			var v25: map<int, seq<multiset<int>>> := map[safeDivisionInt(|v22|, v0) := (seq(abs(240), i3  => (multiset{v0}))) + [v24]];
		...
		v28[safeIndex(781, v28.Length)] := v29;
		v28[safeIndex(781, v28.Length)] := v29;
		for i4 := -v0 to v3.f20 {
			var v30 := DC64(p0);
			...
			var v34: array<bool> := new bool[18] [p0, p0, p0, f13, p0, p0, f13, f13, p0, v33[safeIndex(|"nnobj"|, |v33|)], p0, p0, true, !false, false, f13, f13, f13];
			var v35: map<array<bool>, int> := map[v34 := |(seq(abs(0xe8), i5  => (v1)))|];
			v32[safeIndex(500, v32.Length)] := v35;
			var v36 := DC66(v35);
			v32[safeIndex(500, v32.Length)] := v36.cf101;
			v29 := v28[safeIndex(781, v28.Length)];
			if (p0) {
				var v37: set<array<int>> := {v29, v29, v29, v28[safeIndex(781, v28.Length)], v29};
				globalState.f8 := v37 < v37;
				var v38: array<seq<bool>> := new seq<bool>[5] [[false] + v33, [f13, p0, false] + v33, v33, v33 + ([f13])[safeIndex(v3.f20, |[f13]|) := p0], v33];
				v38 := v38;
				...
				v34[safeIndex(211, v34.Length)] := f13 <== (if (true in v44) then v44[true] else f13);
				var v45: map<bool, int> := map[p0 := i4];
				v34[safeIndex(211, v34.Length)] := v45 == v45;
				v34[safeIndex(211, v34.Length)] := f13;
			}
		...
		for i6 := v0 * v3.f20 to v46.cf82 {
			...
			match (if (false) then v48 else v48) {
				case DC40(cf60, cf61, cf62) =>
					...
					v50[safeIndex(835, v50.Length)] := !(map[cf60 := p0] == (map[cf60 := p0])[p0 := p0]);
					v50[safeIndex(835, v50.Length)] := if (v3.f20 <= i6) then cf61 else v3.fm34(i6, !f13, |{f13}|, globalState);
					cf62 := cf62;
				case DC41(cf63, cf64, cf65, cf66, cf67) =>
					v3.m2(globalState);
					globalState.f8 := false;
					var v62: seq<bool> := [cf65, f13];
					var v63: set<bool> := {v62[safeIndex(-cf63, |v62|)], f13};
					var v64: seq<int> := [|v63|];
				...
				case DC39(cf59) =>
					...
					globalState.f8, cf59, v69, v0 := fm0(|v70|, v2, globalState) ==> f13, cf59, (seq(abs(0x285), i8  => (v68))) + v69, (v3.f20 * |v71|) * (|v70[safeIndex(-i6, |v70|) := i6]| - v0);
			...
			v76[safeIndex(599, v76.Length)] := f13;
			v76[safeIndex(599, v76.Length)] := v2 == v2;
			var v77: seq<bool> := [v76[safeIndex(599, v76.Length)]];
			v77 := (v77 + v77)[safeIndex(v3.f20, |(v77 + v77)|) := p0] + v77;
			var v78: array<seq<bool>> := new seq<bool>[12](i9 => [f13, f13]);
			var v79: map<bool, array<seq<bool>>> := map[v76[safeIndex(599, v76.Length)] := v78];
			v79 := v79[f13 := v78];
		}
		var v80: seq<int> := [safeDivisionInt(v3.f20, v0)];
		v80 := v80;
		var v81: seq<string> := [v2[safeIndex(v3.f20, |v2|) := v1]];
		r0 := v81[safeIndex(v3.f20, |v81|)];
	}
}
...
class C8 extends T2 {
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		...
		if (v0) {
			...
			v7[safeIndex(825, v7.Length)] := f23;
			v7[safeIndex(825, v7.Length)] := seq(abs(-434), i1  => (v6));
		} else {
			var v8: array<seq<D14>> := new seq<D14>[23];
			v8 := v8;
			var v9: array<int> := new int[1];
			v9[safeIndex(978, v9.Length)] := safeDivisionInt(p0, f24);
			...
			r0, v9[safeIndex(978, v9.Length)], f24 := v10[f24 := abs(f24 - |v14|)], p0, v14[safeIndex(if (v0 in v15) then v15[v0] else f24, |v14|)];
			v9[safeIndex(978, v9.Length)] := v9[safeIndex(978, v9.Length)];
			var v16: map<bool, string> := map[v0 := seq(abs(0x166), i2  => ('s'))];
			var v17: map<map<bool, string>, multiset<multiset<bool>>> := map[v16 + v16 := fm78(f24, globalState)];
			var v18: multiset<multiset<bool>> := multiset{v15[v0 := abs(f24)]};
			v17 := v17[v16 + v16 := v18];
			...
			v21[safeIndex(297, v21.Length)] := v0;
			var v22 := 's';
			var v23: set<bool> := {v0, v0, v0};
			globalState.f8, v0, v21[safeIndex(297, v21.Length)], v22 := v0, 0x3aa < |(v13 - v10)|, {true, v0} <= v23, v22;
		}
		
		var v24: array<int> := new int[20];
		v24[safeIndex(980, v24.Length)] := f24;
		v24[safeIndex(980, v24.Length)] := safeModuloInt(-(f24 + f24), safeModuloInt(f24, p0));
		if (false) {
			var v25: array<string> := new string[5];
			v25 := v25;
			var v26: array<char> := new char[7];
			var v27 := 's';
			v26[safeIndex(41, v26.Length)] := v27;
			v26[safeIndex(41, v26.Length)] := v27;
			v25[safeIndex(12, v25.Length)] := f23 + f23;
			v25[safeIndex(12, v25.Length)] := f23 + f23;
			v26[safeIndex(41, v26.Length)] := v27;
			var v28: set<int> := {f24};
			var v29: seq<bool> := [v0];
			...
			if (v0) {
				v24[safeIndex(980, v24.Length)] := v24[safeIndex(980, v24.Length)];
				var v32: set<bool> := {false};
				v32 := v32;
				var v33: multiset<bool> := multiset{v0, v0};
				r1 := |v33|;
				var v34: seq<bool> := [false];
				var v35: array<bool> := new bool[9] [v34[safeIndex(v24[safeIndex(980, v24.Length)], |v34|)], v0, v0, fm0(p0, "yjk", globalState), v0, v0, fm0(p0, f23, globalState), v0, v0];
				var v36: map<bool, array<bool>> := map[v0 := v35];
				v24[safeIndex(980, v24.Length)] := |[v35, if (v0 in v36) then v36[v0] else v35, v35]|;
				var v37 := DC64(v0);
				var v38: map<int, bool> := map[v24[safeIndex(980, v24.Length)] := v37.cf99];
				var v39: seq<seq<bool>> := [[v0, v0, v0]];
				var v40: array<seq<bool>> := new seq<bool>[16] [v34, v34, [true, v0, v0, if (v24[safeIndex(980, v24.Length)] in v38) then v38[v24[safeIndex(980, v24.Length)]] else v0], v34, v34, v34 + v34, v34 + v39[safeIndex(p0, |v39|)], v34, v34, [v0, !v0], v34, v34, v34, [v0] + v34, [v0], v34];
				v40[safeIndex(70, v40.Length)] := v34 + v34;
				v40[safeIndex(70, v40.Length)] := (if (v0) then v34 else v34) + v34;
			} else {
				v24[safeIndex(980, v24.Length)] := safeModuloInt(v24[safeIndex(980, v24.Length)], f24);
				...
				var v43 := DC29(v42);
				var v44 := 'm';
				globalState.f4 := f23[safeIndex(|v41[|v43.cf45| := abs(|fm79(v0, v24[safeIndex(980, v24.Length)], |f23|, globalState)|)]|, |f23|) := v44];
				var v45 := new C6(f24 - |v42|, 0x341, v41 >= multiset(seq(abs(0x90), i3  => (v24[safeIndex(980, v24.Length)]))));
			}
			...
			if (!(if (!v51 && v51) then v51 else v0 && v51)) {
				v24[safeIndex(980, v24.Length)] := 760;
				var v54: array<bool> := new bool[2];
				v54[safeIndex(5, v54.Length)] := v0;
				v54[safeIndex(5, v54.Length)] := if (v53) then f23 <= f23 else v53;
				v24[safeIndex(980, v24.Length)] := |f23|;
				var v55: set<bool> := {v51};
				v55 := v55;
				var v56: multiset<array<int>> := multiset{v24};
				v56 := multiset{v24, v24, v24};
			} else {
				var v57: map<bool, array<int>> := map[v47.f18 < v24[safeIndex(980, v24.Length)] := v24];
				var v58: map<int, bool> := map[v24[safeIndex(980, v24.Length)] := v53];
				var v59: seq<map<bool, array<int>>> := [(v57[!v53 := v24])[if (p0 in v58) then v58[p0] else v51 := v24], v57];
				v57 := v59[safeIndex(v24[safeIndex(980, v24.Length)], |v59|)];
				var v60 := 'e';
				v60 := if (if (v47.f19) then false else v0) then v60 else v60;
				v60 := v60;
				v46 := v46;
				var v61 := DC71(f23, v47.f19, v24[safeIndex(980, v24.Length)], -v47.f18, f23);
				var v62: map<D29, string> := map[v61.(cf108 := seq(abs(0x1ce), i4  => (v60))) := f23];
		...
		var v72 := DC36(v70);
		v71 := v71[v0 := v72];
		globalState.f8, globalState.f4, r1 := fm0(p0, seq(abs(-667), i5  => ('t')), globalState), f23, f24;
		globalState.f8 := f24 < f24;
		var v73: multiset<int> := multiset{|v63|};
		var v74: seq<multiset<int>> := [v73, v73, v73];
		r0 := v74[safeIndex(0x1b2, |v74|)];
		r1 := match DC52(p0, p0) {
			case DC51(cf80, cf81) => -(|"ikpep"| - cf81)
			case DC52(cf82, cf83) => safeDivisionInt(f24, v24[safeIndex(980, v24.Length)])
			case DC50(cf79) => f24
		};
		r2 := ([f24] + [0x135, p0, f24, |fm1(v24[safeIndex(980, v24.Length)], globalState)|]) + [v64[safeIndex(p0, |v64|)]];
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		var i0 := 0;
		while (p1)
			decreases 100 - i0
		{
			...
			if (fm0(f24, "uvnmaei" + f23, globalState)) {
				...
				v5[safeIndex(910, v5.Length)] := "mxyhrm";
				v5[safeIndex(910, v5.Length)] := f23 + f23;
				...
				var v14: array<int> := new int[29] [f24, -577, f24, f24, f24, f24, f24, f24, |v7|, |v9|, f24, f24, 0x46, f24, |v10|, f24, f24, |map[f24 := p1]|, -(if (!p0 in v11) then v11[!p0] else f24), if (fm0(f24, v5[safeIndex(910, v5.Length)], globalState) in v3) then v3[fm0(f24, v5[safeIndex(910, v5.Length)], globalState)] else 0x2df, if (!p1 in v3) then v3[!p1] else f24, f24, f24, f24, if (v12 in v13) then v13[v12] else f24, f24, |v7|, f24, |map[p0 := v5[safeIndex(910, v5.Length)]]|];
				v6[safeIndex(815, v6.Length)] := v14;
				v6[safeIndex(815, v6.Length)] := v14;
				v10 := (v10 - v10) - v10;
			} else {
				f24 := f24;
				f24 := safeModuloInt(|map[p0 := p1]| - f24, if (p0) then f24 else f24);
				var v15 := 's';
				...
				globalState.f8 := p1;
				f24 := safeDivisionInt(v20.f20 - f24, v20.f20);
			}
			...
			f24 := safeModuloInt(f24 * f24, v29.f18);
		}
		f24 := f24;
		globalState.f4 := f23;
		var v33: C1 := new C1();
...
class C9 extends T2 {
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		var v0 := DC11(seq(abs(0x4e), i0  => (map[p0 := !true])));
		match (match v0 {
			case DC11(cf21) => DC47(|{{p0}}|)
		}) {
			case DC46(cf72, cf73) =>
				var v1 := 'b';
				var v2: array<string> := new string[5] [f22[safeIndex(p0, |f22|) := v1], "ml", seq(abs(0x30f), i1  => (v1)), if (cf73) then f22 else f22, f22];
				v2[safeIndex(854, v2.Length)] := f22;
				var v3: seq<int> := [p0];
				...
				v2[safeIndex(854, v2.Length)], v8, globalState.f8 := f22 + f22, v8[v7 := abs(p0 + p0)], !(cf72 <==> (f22 < (seq(abs(0x32e), i3  => (v1)))));
				v2[safeIndex(854, v2.Length)] := "cgvqnsq";
				v1 := v1;
				if ((v2[safeIndex(854, v2.Length)] + v2[safeIndex(854, v2.Length)][safeIndex(-0x19e, |v2[safeIndex(854, v2.Length)]|) := v1]) != (seq(abs(-51), i4  => ('q')))) {
					var v9: seq<bool> := [cf72];
					var v10: map<int, bool> := map[-safeModuloInt(p0, |v9|) := cf72 && cf72];
					...
					v13[safeIndex(684, v13.Length)] := v14;
					v13[safeIndex(684, v13.Length)] := v14;
					cf72 := cf73;
					var v15: set<int> := {p0};
					...
					v19[safeIndex(553, v19.Length)] := v20 <= v20;
					v19[safeIndex(553, v19.Length)] := cf72;
					var v21: array<int> := new int[16];
					r1 := p0 + |map[v21 := p0]|;
					var v22: array<seq<bool>> := new seq<bool>[27];
					v22 := v22;
					cf73 := v19[safeIndex(553, v19.Length)];
					var v23: map<bool, int> := map[v19[safeIndex(553, v19.Length)] := v5.fm16(p0, globalState)];
					globalState.f8 := cf72 <==> ((if (v19[safeIndex(553, v19.Length)] in v23) then v23[v19[safeIndex(553, v19.Length)]] else p0) != 0x210);
				}
				
			case DC47(cf74) =>
				r1 := cf74;
				var v24: map<int, int> := map[cf74 := safeDivisionInt(cf74, cf74)];
				v24 := v24[cf74 := |f22|];
				var v25 := true;
				...
				if (v26 in f22) {
					...
					v28[safeIndex(652, v28.Length)] := v25;
					var v29: seq<bool> := [v25, v25, v25, v25, v25];
					v28[safeIndex(652, v28.Length)] := v29 == (if (v25) then v29 else v29);
					var v30: seq<string> := [("px")[safeIndex(cf74, |"px"|) := v26], f22];
					var v31: multiset<bool> := multiset{v28[safeIndex(652, v28.Length)]};
					var v32 := DC1(0x3b8, v29, v31, v25, cf74);
					globalState.f4 := v30[safeIndex(v32.cf1, |v30|)];
				} else {
					globalState.f8 := v25;
					...
					v34[safeIndex(813, v34.Length)] := f22[safeIndex(cf74, |f22|)];
					v34[safeIndex(813, v34.Length)] := v26;
				}
			...
			case DC45(cf71) =>
				...
				if (v35) {
					...
					globalState.f8 := DC19(([p0])[safeIndex(p0, |[p0]|) := p0], p0, v35, DC1(|v36[safeIndex(p0, |v36|) := seq(abs(-0x203), i7  => ('b'))]|, v37, v38, v35, p0)).cf31;
					v37 := v37 + (v37 + v37);
					globalState.f8 := v35 || v35;
					var v39: seq<int> := [p0];
					var v40: T1 := new C4(true);
					var v41: set<T1> := {v40, v40};
					r1 := p0 + safeDivisionInt(|v39|, fm2(|v41|, p0, globalState));
					...
					var v44: T2 := new C8((seq(abs(649), i8  => ('l'))) + "rottl", p0);
					var v45: map<int, bool> := map[p0 := v35];
					v35, v44 := !(p0 > safeModuloInt(|v45|, p0)), v44;
					var v46: array<bool> := new bool[7] [v35, true, v35, v35, v35, !v35, v35];
					v46[safeIndex(935, v46.Length)] := v35;
					v46[safeIndex(935, v46.Length)], r1 := v35, -p0;
					var v47: array<set<int>> := new set<int>[8];
					var v48: map<array<set<int>>, bool> := map[if (v46[safeIndex(935, v46.Length)]) then v47 else v47 := v35];
					v48 := v48[v47 := v46[safeIndex(935, v46.Length)]];
				}
				
				var v49: array<int> := new int[24];
				v49[safeIndex(333, v49.Length)] := p0;
				v49[safeIndex(333, v49.Length)] := p0;
				var v50 := cf71.m1(false, v35, globalState);
				var v51: array<seq<int>> := new seq<int>[3];
				var v52: seq<int> := [v49[safeIndex(333, v49.Length)]];
				v51[safeIndex(907, v51.Length)] := fm82(v49[safeIndex(333, v49.Length)], v35, globalState) + v52;
				v51[safeIndex(907, v51.Length)] := [v49[safeIndex(333, v49.Length)]];
		}
		...
		r1 := v58[safeIndex(p0, |v58|)];
		var v59: seq<bool> := [v53, v53];
		var v60: map<bool, bool> := map[true := v59[safeIndex(p0, |v59|)]];
		v60 := v60[true := v53];
		v53 := !!v53;
		var v61 := 'd';
		...
		r0 := multiset{safeDivisionInt(p0, p0), -safeModuloInt(|v64|, p0), -261};
		r1 := p0;
		r2 := v58;
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		...
		if (if (p0) then v1.cf60 else p0) {
			...
			var v11 := 'q';
			v10[safeIndex(17, v10.Length)] := v11;
			v10[safeIndex(17, v10.Length)] := v11;
			v10[safeIndex(17, v10.Length)] := if (!p1) then v11 else v10[safeIndex(17, v10.Length)];
			var v12: map<string, int> := map[seq(abs(998), i1  => ('q')) := v0];
			v12 := v12[f22 := v0];
			if (fm0(v0, f22, globalState)) {
				...
				v15[safeIndex(47, v15.Length)] := v13.f18 + |f22|;
				v15[safeIndex(47, v15.Length)] := v13.f18;
				var v19: seq<int> := [v0];
				var v20: seq<bool> := [v13.fm6(v19, globalState), p0];
				var v21: multiset<seq<bool>> := multiset{[v13.fm6([v15[safeIndex(47, v15.Length)]], globalState)], v20};
				var v22: map<int, int> := map[|(v21 + v21)| := v15[safeIndex(47, v15.Length)]];
				var v23: multiset<bool> := multiset{p0, p0, true};
				v22 := v22[fm2(v13.f18, |multiset(v20)|, globalState) - |v23| := |f22|];
				v11, globalState.f4, globalState.f4 := v10[safeIndex(17, v10.Length)], f22, f22;
			} else {
				var v24 := DC62(p0);
				...
				var v31: map<int, string> := map[|v30| := f22[safeIndex(v0, |f22|) := v11]];
				...
				var v40: multiset<string> := multiset{f22[safeIndex(0x12e, |f22|) := v11], f22, f22};
				var v41: array<int> := new int[29] [-v0 * |v26|, -v0, v27.cf111, v0 * v0, v32.cf19, v0 * |v30|, safeDivisionInt(-|v30|, v0), |v29|, v0, v0, v0, v0, v0, v0, |(v29 + ([v0, |(seq(abs(0xb8), i3  => (v11)))|])[safeIndex(fm5(p0, v33, p0, p1, globalState), |[v0, |(seq(abs(0xb8), i3  => (v11)))|]|) := 0x171])[safeIndex(|v34|, |(v29 + ([v0, |(seq(abs(0xb8), i3  => (v11)))|])[safeIndex(fm5(p0, v33, p0, p1, globalState), |[v0, |(seq(abs(0xb8), i3  => (v11)))|]|) := 0x171])|) := 0x38a]|, v0, v0, v0 + v0, v0, |f22|, -|v39|, v0, |(if (p1) then v25 else v25)[safeIndex(v0, |(if (p1) then v25 else v25)|) := p0]|, v0, -(if (p0) then -v0 else v0), v0 + v0, v0, v0, -|v40|];
				v41 := v41;
				v0 := -safeModuloInt(|"fh"|, safeModuloInt(v0, v0));
			}
			
			var v42: array<int> := new int[5](i4 => i4 + v0);
			v42[safeIndex(835, v42.Length)] := v0 * v0;
			v42[safeIndex(835, v42.Length)] := v0;
		}
		
		var v43: array<bool> := new bool[12];
		v43[safeIndex(670, v43.Length)] := p0;
		var v44: seq<int> := [|f22|, v0];
		var v45: set<bool> := {p1};
		var v46 := DC39(v45);
		var v47: set<int> := {|v45|, fm5(false, v45, p1, p0, globalState), -|multiset{p0}|};
		var v48: map<D18, int> := map[v46 := |v47|];
		v0, v0, v0, v43[safeIndex(670, v43.Length)] := v0, v0 * v44[safeIndex(v0, |v44|)], v0, v48 == v48;
		var v49: map<string, bool> := map[f22 := p1];
		var v50 := 'j';
		var v51: map<bool, string> := map[fm0(|v49|, f22, globalState) := f22[safeIndex(172, |f22|) := v50]];
		v43[safeIndex(670, v43.Length)] := (if (p1 in v51) then v51[p1] else f22) < f22;
		var i5 := 0;
		while (v43[safeIndex(670, v43.Length)])
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			if ((if (p0) then v52 else v52) == fm84(globalState)) {
				...
				var v59: map<int, bool> := map[|(v45 - v45)| := v43[safeIndex(670, v43.Length)]];
				globalState.f8 := if (-(if (v0 in v52) then v52[v0] else v0) in v59) then v59[-(if (v0 in v52) then v52[v0] else v0)] else p1;
				var v60: multiset<bool> := multiset{v43[safeIndex(670, v43.Length)]};
				var v61: seq<multiset<bool>> := [v60];
				var v62: map<bool, int> := map[p0 in v61[safeIndex(v0, |v61|)] := v0];
				var v63: map<array<bool>, bool> := map[v43 := p0];
				v62 := v62[p0 := |v63|];
				var v65: set<string> := {f22, f22, f22, f22, f22};
				var v66: array<int> := new int[16] [v0, v0 - |v60|, v0, v0, v0, safeModuloInt(822, v0), |((set v64 : int | (0x35e <= v64) && (v64 < 0x1d4) :: (v64 * v0)) * v47)|, v0, v0 - -v0, v0, v0 + -v0, v0, v0, |v65| * v0, v0, |(seq(abs(0xe0), i6  => (multiset(v44))))|];
				var v67: T2 := new C8(f22, v0);
				var v68: multiset<T2> := multiset{v67};
				v66[safeIndex(857, v66.Length)] := safeDivisionInt(v0, |v68|);
				v66[safeIndex(857, v66.Length)] := v0;
				var v69: seq<array<bool>> := [v43];
				var v70: map<bool, bool> := map[v43[safeIndex(670, v43.Length)] := v43[safeIndex(670, v43.Length)]];
				var v71: array<map<bool, bool>> := new map<bool, bool>[4] [v70, v70, v70, v70];
				var v72 := DC61(v43, v71, |(seq(abs(0x146), i7  => ('q')))|);
				var v73: seq<array<int>> := [v66];
				var v74 := DC22(v73);
				var v75: map<int, array<int>> := map[v66[safeIndex(857, v66.Length)] := v66];
				...
				var v77: map<bool, array<D9>> := map[v43[safeIndex(670, v43.Length)] := v76];
				v69, f22, v66[safeIndex(857, v66.Length)], v66[safeIndex(857, v66.Length)] := (if (v43[safeIndex(670, v43.Length)]) then v69 else v69) + [v43, v72.cf94], f22, safeDivisionInt(|f22|, v66[safeIndex(857, v66.Length)]), -|(v77 + v77)|;
			}
			
			var v78: array<multiset<int>> := new multiset<int>[6](i8 => multiset{v0} + multiset(v44));
			var v79: multiset<int> := multiset{0x250};
			v78[safeIndex(943, v78.Length)] := v79;
			v78[safeIndex(943, v78.Length)] := v79 - v79;
...
class C10 extends T4 {
	...
	method m2(globalState: GlobalState) {
		...
		var v2 := 769;
		var v3: map<array<bool>, array<bool>> := map[v0 := v1[safeIndex(v2, |v1|)]];
		v3 := v3[v0 := v0];
		...
		var v7: seq<int> := [|v6[safeIndex(v2, |v6|)]|];
			...
			decreases 100 - i2
		{
			...
			match (if (false) then v15 else v15) {
				case DC64(cf99) =>
					var v16: set<array<int>> := {v4, if (v12[safeIndex(|v5|, |v12|)]) then v4 else v4, v4, v4};
					v16 := v16;
					v2 := v2;
				...
				case DC63(cf98) =>
					v4[safeIndex(710, v4.Length)] := v2;
					v4[safeIndex(710, v4.Length)] := -|(v11.f16 + v7)|;
					globalState.f8 := f10;
			...
			if (f12) {
				...
				v25[safeIndex(23, v25.Length)] := v26;
				v25[safeIndex(23, v25.Length)] := v26;
				var v27 := DC3(seq(abs(0x2c8), i5  => ('i')));
				var v28: array<string> := new string[18] [v5, seq(abs(-129), i3  => ('t')), seq(abs(591), i4  => ('t')), v5, "lrglbyxo", "jffv", v5, v5 + v5, v5, v5, v5, v5, v5, v5, if (false) then v5 else v27.cf7, v5, v5, v5];
				v28[safeIndex(126, v28.Length)] := v5;
				var v29: multiset<bool> := multiset{f10, f12, f12};
				globalState.f8, v2, globalState.f8, v28[safeIndex(126, v28.Length)] := (v14.f20 != v2) !in v29, v14.f20, v14.f20 < v14.fm5(f11, v9, f10, true, globalState), "nl" + (seq(abs(976), i6  => ('w')));
				var v30 := new C7(f11);
				v2 := v14.f20 * v2;
			} else {
				v0[safeIndex(879, v0.Length)] := f11;
				...
				v0[safeIndex(879, v0.Length)] := v34 < v34;
				var v35 := DC16(0x396);
				var v36 := DC17(v35);
				...
				var v40 := 't';
				v39[safeIndex(833, v39.Length)] := v40;
				v39[safeIndex(833, v39.Length)] := v40;
		...
		if (!((v42 * v42) in v44)) {
			...
			globalState.f8 := f10;
			var v49 := new C0(if (!f11) then seq(abs(796), i7  => (v2)) else v7, if (!f10) then v10 else v11.f17);
			...
			match (v51.(cf24 := v11.f16 + v11.f16)) {
				case DC14(cf24) =>
					...
					v4[safeIndex(549, v4.Length)] := v50.f14;
					globalState.f8, v2, v4, v4[safeIndex(549, v4.Length)] := v50.f15 > |v1|, v50.f14, v4, safeModuloInt(v50.f14, |v5|);
					var v52: multiset<int> := multiset{v4[safeIndex(549, v4.Length)], v2};
					var v53: multiset<multiset<int>> := multiset{v52};
					var v54: seq<bool> := [f11, f10];
					var v55: map<multiset<multiset<int>>, seq<bool>> := map[v53[v52[v7[safeIndex(v50.f15, |v7|)] := abs(v4[safeIndex(549, v4.Length)])] := abs(v50.f14)] := v54];
					v55 := v55[v53[v52 := abs(v50.f14)] + fm25(globalState) := v54];
					v0 := v0;
			}
			
			var v56: array<set<bool>> := new set<bool>[9];
			v56[safeIndex(44, v56.Length)] := {if (f12 in v8) then v8[f12] else f10, false, f11, f12, !f12};
			v56[safeIndex(44, v56.Length)] := {f12} - v9;
		...
		if (!(true && f12)) {
			...
			v0[safeIndex(669, v0.Length)] := !(f11 ==> f12);
			v0[safeIndex(669, v0.Length)] := fm0(-534, v5, globalState);
			if (f11) {
				var v57: seq<bool> := [f11, v0[safeIndex(669, v0.Length)] ==> f11];
				v57 := [f11, !f11, f11];
				v4 := v4;
				...
				v2 := v2 + |(v61 - v61)|;
				v2 := v2;
				v2 := |(map[v0[safeIndex(669, v0.Length)] := f11] + v8)|;
			} else {
				var v62: multiset<bool> := multiset{f10, f12, fm6(seq(abs(-866), i8  => (v2)), globalState), !f11};
				var v63: array<bool> := new bool[12](i9 => f10);
				var v64: multiset<array<bool>> := multiset{v63, v63, v63};
				v0[safeIndex(669, v0.Length)], v0[safeIndex(669, v0.Length)], v2, globalState.f8, globalState.f8 := fm51(v2, globalState) !! (v62 - v62), !f12, |(if (|fm1(v2, globalState)| != v2) then fm26(|"drdca"|, false, globalState) + v8 else v8 + v8)|, f11, v64 >= v64;
				var v65 := 'i';
				v65 := v65;
				var v66: set<array<bool>> := {v63};
				v63, v65, v66 := v63, v65, v66;
				v0[safeIndex(669, v0.Length)] := f10 <== !f11;
				globalState.f8 := true;
			}
			...
			if (!(safeDivisionInt(v2, |v67|) <= v2)) {
				var v68 := DC52(v2, 0x236);
				v0[safeIndex(686, v0.Length)] := f11;
				var v69: map<bool, int> := map[fm0(|v5|, v5, globalState) := -v2];
				globalState.f4, globalState.f8, v68, v0[safeIndex(686, v0.Length)], v2 := v5, -0x26b <= v2, v68, (if (f12 in v69) then v69[f12] else v2) < |v5|, v2;
				var v70: array<array<int>> := new array<int>[26];
				var v71: seq<array<int>> := [v4, v4];
				v70[safeIndex(945, v70.Length)] := v71[safeIndex(v2, |v71|)];
				var v72 := DC9(v4);
				v70[safeIndex(945, v70.Length)] := v72.cf16;
				var v73 := 'o';
				v73 := v73;
				...
				v0[safeIndex(233, v0.Length)] := v76 <= v76;
				v0[safeIndex(233, v0.Length)] := f10;
				var v77: map<bool, set<int>> := map[f12 := v42];
				var v78 := DC23(v77);
				var v79: map<D10, int> := map[v78 := safeDivisionInt(v2, v2)];
				v79 := v79[v78 := 0x22d];
			...
			var v83: seq<C5> := [v82];
			v0[safeIndex(57, v0.Length)] := f10 <==> true;
			var v84 := DC16(v2);
			var v85: seq<bool> := [f12];
			var v86: multiset<int> := multiset{-537, |v85|};
			v83, v0[safeIndex(57, v0.Length)], globalState.f8, v2, v84 := if (f10 && f10) then v83 else v83, f11, (v86[v2 := abs(v2)] * multiset{v2}) >= multiset(v11.f16), v11.fm16(v2, globalState) * v2, v84;
			v0[safeIndex(57, v0.Length)] := f11 || f12;
	...
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
		...
		if (v0[safeIndex(|(multiset(seq(abs(248), i0  => (DC29(map[f10 := f10])))) * v3)|, |v0|)]) {
			var v4 := new C1();
			var v5 := 250;
			v5 := safeDivisionInt(if (f10) then v5 else -p0, p0);
			var v6 := "je";
			globalState.f4 := v6 + (seq(abs(0x339), i1  => ('j')));
			...
			var v11 := DC15(v10);
			var v13: seq<int> := [p0];
			var v15: array<map<int, bool>> := new map<int, bool>[29] [if (f10) then v10 else v11.cf25, v10, v10, v10, map[v9 := f11], v10, (map[p0 := true])[v9 := f10], v10 + map[p0 := false], v10, v10 + v10, v10, v10, v10, v10, v10, v10, v10, v10, map[p0 := true], v10, map v12 : int | v12 in v13 :: (safeDivisionInt(v12, v9)) := (f11), if (f10) then v10 else v10, v10, v10, v10, v10, v10, map v14 : int | (0x239 <= v14) && (v14 < 294) :: (v14 * p0) := (f10), v10];
			v15[safeIndex(950, v15.Length)] := v10 + v10;
			var v16: array<int> := new int[16](i2 => i2 - p0);
			var v17 := "v";
			globalState.f8, v9, v9, v15[safeIndex(950, v15.Length)], v16 := fm0(|[v9]|, "khw", globalState), p0 + v9, if (f11) then v9 else v9, map[|v17| := f12] + v10, v16;
			var v18: map<bool, seq<bool>> := map[false := v0];
			var v19: seq<seq<bool>> := [v0, if (v0[safeIndex(p0, |v0|)] in v18) then v18[v0[safeIndex(p0, |v0|)]] else v0];
			var v20 := DC53(v19);
			match (DC55(DC53(v19)).(cf86 := v20)) {
				case DC54(cf85) =>
					...
					v22[safeIndex(885, v22.Length)] := v23;
					v22[safeIndex(885, v22.Length)] := v23;
				...
				case DC53(cf84) =>
					...
					v16[safeIndex(755, v16.Length)] := if (v25 in v26) then v26[v25] else v9;
					var v27: multiset<bool> := multiset{f10};
					var v28 := 'c';
					var v29: set<char> := {v28, 'y'};
					var v30: multiset<multiset<bool>> := multiset{v27, v27, v27[f11 := abs(|v29|)], multiset{f10, f11}};
					v16[safeIndex(755, v16.Length)] := |fm86(v30, v9, globalState)|;
					v9 := safeModuloInt(p0, p0);
					var v31: multiset<string> := multiset{v17};
					var v32 := new C6(-v9, |v31|, if (v9 in v15[safeIndex(950, v15.Length)]) then v15[safeIndex(950, v15.Length)][v9] else f10);
					v16[safeIndex(755, v16.Length)] := -v32.f15;
				case DC55(cf86) =>
					globalState.f8 := f11;
					globalState.f4 := "luaf";
					globalState.f8 := f12;
			...
			v17 := (seq(abs(-0x246), i4  => ('t'))) + v17;
		}
		
		var v34: array<bool> := new bool[11];
		v34[safeIndex(824, v34.Length)] := f11;
		v34[safeIndex(824, v34.Length)] := f12;
		var v35: set<bool> := {f11, f10};
		var v36: map<array<bool>, int> := map[v34 := safeDivisionInt(p0, fm5(f10, v35, v34[safeIndex(824, v34.Length)], v34[safeIndex(824, v34.Length)], globalState))];
		v36 := v36[v34 := p0];
		var v37 := "cnkqakw";
		var v38: seq<string> := [v37];
		globalState.f8 := fm0(p0 + p0, v38[safeIndex(p0, |v38|)], globalState);
		var v39 := DC16(p0);
		match (v39) {
			case DC16(cf26) =>
				...
				if (f10) {
					...
					var v43 := DC12(v42);
					v41[safeIndex(789, v41.Length)] := v43;
					v41[safeIndex(789, v41.Length)] := v43;
					v34 := v34;
					var v44: array<int> := new int[29];
					var v45: array<string> := new string[25];
					v45[safeIndex(38, v45.Length)] := v37;
					...
					v44, v45[safeIndex(38, v45.Length)], v0, v46 := v44, v37, v0, if ((if (-cf26 in v48) then v48[-cf26] else v37) in v47) then v47[if (-cf26 in v48) then v48[-cf26] else v37] else v46;
					var v49: set<int> := {p0};
					var v50: map<int, int> := map[cf26 := p0];
					var v51: seq<int> := [0x28e];
					var v52 := 'g';
					var v53: map<char, map<int, int>> := map[v52 := map[cf26 := cf26]];
					var v54: map<bool, int> := map[true := |(seq(abs(0x253), i7  => ('g')))|];
					var v55: array<map<int, int>> := new map<int, int>[27] [v50, v50, fm7(v51, fm6(seq(abs(986), i6  => (cf26)), globalState), "bgckhq", f10, globalState), v50 + fm84(globalState), v50 + v50, v50 + fm84(globalState), v50, fm84(globalState), v50, v50, v50, v50, v50 + v50, v50 + v50, v50, (if (v52 in v53) then v53[v52] else v50)[p0 := |v54|], v50, v50, v50, fm84(globalState) + v50, v50, fm7(v51, false, v37, f12, globalState), v50, v50 + fm7(v51, v34[safeIndex(824, v34.Length)], v37, v34[safeIndex(824, v34.Length)], globalState), fm84(globalState), v50 + v50, map[-fm2(cf26, p0, globalState) := p0]];
					v55[safeIndex(646, v55.Length)] := v50;
					v34[safeIndex(824, v34.Length)], v49, v55[safeIndex(646, v55.Length)] := v1 == v1, (set v56 : int | (0x124 <= v56) && (v56 < -0x7e) :: (safeDivisionInt(v56, |"poju"|))) + v49, v50;
				} else {
					cf26 := safeDivisionInt(p0, -cf26);
					var v57: seq<int> := [cf26];
					var v58: set<int> := {p0 * cf26};
					var v59 := 'm';
					var v60: set<char> := {v59, v59};
					v57, v58, globalState.f4, cf26 := v57 + v57, (v58 - v58) * v58, [v59], if (v34[safeIndex(824, v34.Length)]) then |v60| else cf26;
					globalState.f8 := !f12;
					...
					globalState.f4 := if (cf26 < cf26) then seq(abs(0xa), i8  => (v59)) else seq(abs(-0x12), i9  => ('k'));
				}
				
				var v64: multiset<int> := multiset{p0};
				var v65: map<bool, int> := map[f12 := cf26];
				var v66: set<multiset<int>> := {v64 * v64, multiset{p0} - fm42(v34[safeIndex(824, v34.Length)], v34[safeIndex(824, v34.Length)], map[f10 := p0], globalState), fm42(f11, f12, v65, globalState), v64 - v64};
				var v67: map<seq<bool>, int> := map[v0 := cf26];
				var v68: map<map<seq<bool>, int>, bool> := map[v67 := f11];
				var v69: set<string> := {v37, v37, "bppejb", seq(abs(-0x11a), i10  => ('h')), v37};
				globalState.f8, v66, cf26, v34[safeIndex(824, v34.Length)] := !false, fm63(0x367, f11, fm1(155, globalState), globalState) - v66, cf26, if (v67 in v68) then v68[v67] else v69 < v69;
				var v70 := 'b';
				...
				v72[safeIndex(607, v72.Length)] := [v74, v74];
				...
				v71, v72[safeIndex(607, v72.Length)], v65 := (v71 + (if ((if (v77 in v78) then v78[v77] else p0) in v76) then v76[if (v77 in v78) then v78[v77] else p0] else map v79 : char | v79 in (map v80 : char | v80 in v37[safeIndex(|v0|, |v37|) := v70] :: (v80) := (f11)) :: (v79) := (cf26))) + (v71 + v71), v81 + ((seq(abs(0x1d5), i11  => (DC1(cf26, v0, v73, v34[safeIndex(824, v34.Length)], cf26)))) + v81), v65;
			case DC15(cf25) =>
				var v82: seq<int> := [|v0|, -p0, p0, p0, p0];
				var v83: array<map<bool, bool>> := new map<bool, bool>[14];
				var v84: C0 := new C0(v82, v83);
				var v85: map<bool, C0> := map[v34[safeIndex(824, v34.Length)] := v84];
				var v86 := DC34(v85);
				match (v86.(cf53 := v85[v34[safeIndex(824, v34.Length)] := v84])) {
					case DC35(cf54, cf55) =>
						v34[safeIndex(824, v34.Length)] := f11;
						cf55 := cf55;
						cf54 := if (v37 <= v37) then f12 else v34[safeIndex(824, v34.Length)];
						var v87 := 'b';
						var v88: array<string> := new string[8] [v37, v37, v37, v37[safeIndex(cf55, |v37|) := v87], v37, v37, v37, "dxpdqe"];
						v88[safeIndex(470, v88.Length)] := v37;
						v88[safeIndex(470, v88.Length)] := "oywtngc";
					case DC34(cf53) =>
						r1 := 'h';
						var v89: set<int> := {|v35|, p0};
						v89 := v89;
						var v90: multiset<bool> := multiset{f11, f11, v34[safeIndex(824, v34.Length)]};
						var v91: seq<multiset<bool>> := [v90, multiset{f11, f10}, multiset{false}, v90];
						var v92: set<multiset<bool>> := {multiset{f11, f11}, v91[safeIndex(p0, |v91|)]};
						var v93 := 'h';
						var v94: seq<set<multiset<bool>>> := [fm87(globalState)];
						var v95: map<int, set<multiset<bool>>> := map[p0 := fm87(globalState)];
						r1, v92 := if (f10) then v93 else v93, v94[safeIndex(p0, |v94|)] + (if (p0 in v95) then v95[p0] else set v96 : multiset<bool> | v96 in v91 :: (v96));
						var v97 := 263;
						v97 := v97 - v97;
					case DC36(cf56) =>
						var v98: array<int> := new int[2](i12 => safeDivisionInt(i12, p0));
						var v99: multiset<array<int>> := multiset{v98, v98};
						var v100 := 'w';
						var v101: map<multiset<array<int>>, bool> := map[v99 := fm0(p0, ("twrswkumd")[safeIndex(p0, |"twrswkumd"|) := v100], globalState)];
				...
				match (DC42(v103)) {
					case DC43(cf69) =>
						...
						var v106: map<string, array<char>> := map[v37 := v105[safeIndex(cf69, |v105|)]];
						v106 := v106;
						var v107 := new C9(v37);
						var v108 := 'y';
						r1 := v108;
						var v109: T2 := new C8(v37, 801);
						var v110: C3 := new C3(cf69, v34[safeIndex(824, v34.Length)], false);
					...
					case DC42(cf68) =>
						...
						var v119 := DC78(v118);
						v115[safeIndex(250, v115.Length)] := multiset(v117) - v119.cf120;
						var v120: multiset<bool> := multiset{v34[safeIndex(824, v34.Length)]};
						var v121 := DC46(false, v34[safeIndex(824, v34.Length)]);
						v34[safeIndex(824, v34.Length)], v115[safeIndex(250, v115.Length)], globalState.f8, globalState.f8 := !f12, if (f12) then v118 else v118 - fm88(-v114, v114, globalState), if (f10) then f10 else v114 != |v120|, !((multiset(fm61(f12, v121.cf72, v34[safeIndex(824, v34.Length)], globalState)) - v120) !! v120);
						var v122 := 'e';
					...
					case DC44(cf70) =>
						...
						globalState.f4 := ((v37 + v37) + (v37 + v123.cf80))[safeIndex(|(v127 + multiset{v124})|, |((v37 + v37) + (v37 + v123.cf80))|) := if (v34[safeIndex(824, v34.Length)]) then v124 else v124];
						var v128: seq<array<bool>> := [v34];
						v128 := v128;
						var v129: seq<seq<int>> := [[p0]];
						var v130 := DC59(v129);
						var v131 := DC49(p0, v124, DC9(v125));
						var v132: array<D25> := new D25[13] [DC59(v129), v130, DC59(v129), v130, v130, v130, v130, fm89(v131.cf77, globalState), v130, v130, v130, DC59(v129), DC59(v129[safeIndex(p0, |v129|) := v82])];
						v132[safeIndex(110, v132.Length)] := v130;
						var v133: map<int, seq<seq<int>>> := map[p0 := seq(abs(656), i13  => (seq(abs(0x35e), i14  => (p0))))];
						v132[safeIndex(110, v132.Length)] := DC59(if (fm2(-|v84.f16|, -p0, globalState) in v133) then v133[fm2(-|v84.f16|, -p0, globalState)] else seq(abs(693), i15  => (DC19(seq(abs(-0x17f), i16  => (p0)), |multiset{p0}|, v34[safeIndex(824, v34.Length)], DC1(p0, [v34[safeIndex(824, v34.Length)], v34[safeIndex(824, v34.Length)]], multiset(v0), f10, p0)).cf29)));
						var v134 := -177;
						v134 := -v134 + p0;
				}
			...
			case DC17(cf27) =>
				...
				v136[safeIndex(225, v136.Length)] := v144;
				var v145: multiset<bool> := multiset{v34[safeIndex(824, v34.Length)], if (v34[safeIndex(824, v34.Length)]) then f10 else !f12, if (f11) then f11 else f11, !v34[safeIndex(824, v34.Length)]};
				v136[safeIndex(225, v136.Length)], globalState.f5 := v144, v145;
				var v146 := 861;
				v146 := v146;
				var v147: set<array<int>> := {v144};
				if (v147 > v147) {
					v143 := v143;
					v34[safeIndex(824, v34.Length)] := if (v146 != v146) then v146 > p0 else v34[safeIndex(824, v34.Length)];
					var v148 := new C7(fm0(p0, v37, globalState));
					v34[safeIndex(824, v34.Length)], globalState.f8 := fm0(safeDivisionInt(v146, p0), v37, globalState), !f11;
					var v149: map<map<char, string>, int> := map[map['x' := "cwtgljtrm"] := |multiset{false}|];
					var v150: map<char, string> := map[v37[safeIndex(fm5(f11, v35, f12, v34[safeIndex(824, v34.Length)], globalState), |v37|)] := v37];
					var v151: seq<map<char, string>> := [v150];
					v146 := if (v151[safeIndex(|v0|, |v151|)] in v149) then v149[v151[safeIndex(|v0|, |v151|)]] else v146;
				} else {
					...
					var v158: array<map<bool, bool>> := new map<bool, bool>[13] [v1, v1, map[v34[safeIndex(824, v34.Length)] := f11], v1, map[v34[safeIndex(824, v34.Length)] := f11], v1, v1, v1, v1, v1, map[f10 := v34[safeIndex(824, v34.Length)]], v1, v1];
					var v159 := new C0(v143[safeIndex(|multiset(if (v155 in v156) then v156[v155] else v143)|, |v143|) := |v157|], v158);
					var v160 := new C1();
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		for i0 := p0 * p0 to p0 {
			...
			v1[safeIndex(18, v1.Length)] := |"fxdpsha"|;
			var v2: array<bool> := new bool[19];
			var v3: seq<array<bool>> := [v2, v2, v2];
			var v5: array<array<bool>> := new array<bool>[8] [v2, v2, v2, v2, v2, v2, v3[safeIndex(|(map v4 : int | (950 <= v4) && (v4 < -569) :: (safeDivisionInt(v4, |map[f10 := |map['k' := false]|]|)) := (f10))|, |v3|)], v2];
			var v6 := DC12(v5);
			var v7: seq<D5> := [v6, v6];
			var v8: map<bool, int> := map[f11 := p0];
			v1[safeIndex(18, v1.Length)] := |([DC12(v5)] + v7)[safeIndex(|v8|, |([DC12(v5)] + v7)|) := v6]|;
			globalState.f8 := f11;
		}
		var v9 := "vwmla";
		match (DC71(v9, f12, 178, p0, v9).(cf111 := p0)) {
			case DC71(cf108, cf109, cf110, cf111, cf112) =>
				...
				if (cf109) {
					r1 := p0 + cf110;
					var v14: map<int, string> := map[safeModuloInt(cf110, cf111) := v9];
					var v15: seq<int> := [p0, cf110, |v11|, |{cf109}|];
					var v16: multiset<bool> := multiset{f11, f11};
					var v17 := 'h';
					cf108 := if (|(v15 + v15)| in v14) then v14[|(v15 + v15)|] else cf112[safeIndex(|v16|, |cf112|) := v17];
					var v18: array<bool> := new bool[28](i1 => f11);
					var v19 := DC32(cf110, true, f11, v18);
					var v20 := new C2(|map[cf110 := v19]|, f12);
					v18[safeIndex(526, v18.Length)] := !(v9 != ("lj")[safeIndex(560, |"lj"|) := v17]);
					v18[safeIndex(526, v18.Length)] := {v20.f20} !! {v20.f20, v20.f20, v20.f20};
					var v21: set<string> := {cf108, cf108};
					var v22: seq<set<string>> := [v21, v21];
					cf111 := -(|v22[safeIndex(-p0, |v22|)]| + cf110);
				} else {
					globalState.f8 := cf109;
					var v23: array<bool> := new bool[12] [!f11, true, fm0(p0, seq(abs(0x16f), i2  => ('v')), globalState), cf109, f11, cf109, true, !(cf110 <= cf111), f11, cf109, f11, f11];
					v23[safeIndex(196, v23.Length)] := f12;
					v23[safeIndex(196, v23.Length)] := f10;
					var v24 := new C3(-0x301, f10, v23[safeIndex(196, v23.Length)]);
					var v25: map<array<bool>, bool> := map[v23 := v23[safeIndex(196, v23.Length)]];
			...
			case DC70(cf107) =>
				...
				var v31 := DC4(v28, safeDivisionInt(p0, p0), v30 != v30, p0);
				match (v31) {
					case DC4(cf8, cf9, cf10, cf11) =>
						...
						v34[safeIndex(850, v34.Length)] := v33;
						var v36 := DC40(cf10, f11, -p0);
						var v37: multiset<int> := multiset{v36.cf62};
						var v38: map<multiset<int>, bool> := map[v37 := false];
						v34[safeIndex(850, v34.Length)] := DC70(map v35 : multiset<int> | v35 in v38 :: (v35) := (cf9));
						...
						v39, globalState.f8, v40, globalState.f8 := v39, f12, v40, v43[safeIndex(p0, |v43|)] == v42;
					case DC3(cf7) =>
						var v44: array<bool> := new bool[20];
						v44[safeIndex(334, v44.Length)] := f10;
						v44[safeIndex(334, v44.Length)] := f10;
					...
					case DC5(cf12) =>
						var v50: seq<int> := [p0];
						globalState.f8 := v50[safeIndex(p0, |v50|)] >= p0;
						...
						v56[safeIndex(50, v56.Length)] := (seq(abs(0x21a), i4  => (|v55|))) < v50;
						v56[safeIndex(50, v56.Length)] := f11 <==> f10;
						var v57: array<map<map<char, int>, int>> := new map<map<char, int>, int>[27];
						var v58: map<map<char, int>, int> := map[v30 := p0];
						v57[safeIndex(314, v57.Length)] := v58;
						v57[safeIndex(314, v57.Length)] := v58;
						var v59: map<bool, int> := map[false := 0x143];
						var v60: array<seq<int>> := new seq<int>[11] [v50, v50, [p0], v50, v50 + (seq(abs(0x84), i5  => (p0))), v50 + v50, if (f10) then fm82(|v59|, f10, globalState) else seq(abs(-0x300), i6  => (p0)), v50, if (f11) then v50 else v50, v50, v50 + v50];
						var v61: seq<seq<int>> := [v50];
						v60[safeIndex(650, v60.Length)] := if (f11) then v50 else v61[safeIndex(p0, |v61|)];
						v60[safeIndex(650, v60.Length)] := (v50 + v50[safeIndex(|{v56[safeIndex(50, v56.Length)]}|, |v50|) := p0])[safeIndex(p0, |(v50 + v50[safeIndex(|{v56[safeIndex(50, v56.Length)]}|, |v50|) := p0])|) := p0];
				}
				
				globalState.f5 := multiset{f10, f10, f12, f11};
				var v62: set<bool> := {f12};
				var v63: map<seq<char>, set<bool>> := map[v9 := v62 + {f12}];
				var v65: seq<seq<char>> := [seq(abs(745), i7  => (v29)), [v9[safeIndex(p0, |v9|)], v29]];
		...
		var v68: T2 := new C8(seq(abs(0x24d), i8  => ('x')), p0);
		...
		v71[safeIndex(131, v71.Length)] := !!f11;
		var v72: set<bool> := {f10};
		v71[safeIndex(131, v71.Length)] := |fm1(-713, globalState)| < |v72|;
		globalState.f4 := v9 + v9;
		var v73: array<int> := new int[2];
		v73[safeIndex(247, v73.Length)] := |v9|;
		v73[safeIndex(247, v73.Length)] := p0 + ---(-p0 + p0);
		var v74 := DC80(map[v70 := p0]);
		var v75: multiset<int> := multiset{|v70|, |v74.cf126|, safeModuloInt(-0x217, v73[safeIndex(247, v73.Length)])};
		r0 := v75;
		r1 := p0;
		var v76: seq<int> := [p0];
		r2 := v76;
	...
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			match (if (p1) then DC64(f10) else v1) {
				case DC64(cf99) =>
					...
					var v19: array<int> := new int[21] [safeModuloInt(|[v0, v0]|, 619), v0, |v9|, v0, if (!f12) then 0x226 else v0, |(v14 + v14)|, |v3|, v0, v0, |(fm92(0xa9, !cf99, globalState) + v16)|, |v17| - v0, v0, v0, v0 + v0, v0, fm2(v0, fm2(v0, v0, globalState), globalState) - v0, v0, |v18| + v0, --v0, 0x106, v0];
					v19[safeIndex(957, v19.Length)] := v0;
					v19[safeIndex(957, v19.Length)] := v0;
					var v20: map<int, bool> := map[v19[safeIndex(957, v19.Length)] := cf99];
				...
				case DC63(cf98) =>
					...
					var v25 := DC14(v24);
					var v26: set<int> := {v0};
					v0, globalState.f4, v0, v0, globalState.f8 := 984, ((v21 + (v21 + "xtfxxd"))[safeIndex(v0, |(v21 + (v21 + "xtfxxd"))|) := if (p1) then v22 else v22])[safeIndex(safeModuloInt(-|v25.cf24|, fm2(v0, |v24|, globalState)), |(v21 + (v21 + "xtfxxd"))[safeIndex(v0, |(v21 + (v21 + "xtfxxd"))|) := if (p1) then v22 else v22]|) := v22], v0, v0, v26 >= v26;
					var v27 := new C5(f12, |("esmwmoxn")[safeIndex(526, |"esmwmoxn"|) := 'k']| < v0);
			...
			var v42: array<map<bool, int>> := new map<bool, int>[22] [v38, map[true := v0], v38, map[true := v0], v39[safeIndex(v0, |v39|)], v38, v38, v38 + v38, fm49(globalState), v38 + v38, v38, v38, map[v40[safeIndex(v0, |v40|)] := v0], map[p1 := v0], v38, v38, v38, fm49(globalState), v38, v38, if (p1 in v41) then v41[p1] else v38, v38];
			v42[safeIndex(849, v42.Length)] := v38;
			v42[safeIndex(849, v42.Length)] := fm49(globalState);
			var v43 := "uegjfyx";
			var v44 := 'u';
			var v45: array<string> := new seq<char>[10] [seq(abs(0x305), i3  => ('n')), v43, fm1(v0, globalState) + (seq(abs(-0x318), i4  => ('n'))), v43, fm1(v0, globalState), "lkrsosn" + v43[safeIndex(v0, |v43|) := v44], v43, "tavt", v43, "lm"];
			v45[safeIndex(593, v45.Length)] := v43;
			var v46: multiset<bool> := multiset{f11};
			var v47: map<char, char> := map[v44 := v44];
			var v48: seq<int> := [v0];
			var v49: set<bool> := {p1, f11, f12, f10};
			var v50: array<int> := new int[22] [v0 * v0, safeModuloInt(v0, v0), if (f10 in v46) then v46[f10] else v0, v0, |(seq(abs(-0x117), i5  => (v44)))| - v0, safeModuloInt(-|v43|, v0), |(v40 + v40)|, fm2(v0, v0, globalState), v0, 981, |(v47 + v47)|, v0, v0, v48[safeIndex(-fm5(fm6(v48, globalState), v49, f10, f12, globalState), |v48|)], -(-v0 + v0), if (f12 in v42[safeIndex(849, v42.Length)]) then v42[safeIndex(849, v42.Length)][f12] else |{f10}|, v0, v0, v0 * v0, |v48|, v0, fm5(f11, {f12}, p0, p0, globalState)];
			v50[safeIndex(580, v50.Length)] := v0;
			var v51: multiset<seq<int>> := multiset{v48 + [v0, fm2(v0, v0, globalState), 0x31e], v48, [|v43|, v0, v0]};
			v0, v45[safeIndex(593, v45.Length)], v44, globalState.f8, v50[safeIndex(580, v50.Length)] := if (v48 in v51) then v51[v48] else v0, v43, v44, f11, 0x2a3 - v0;
		}
		var v52 := 0x1b9;
		...
		}, safeModuloInt(v52, |v53|), f11;
		v52 := safeDivisionInt(v52, v52) - -v52;
...
class C11 extends T4 {
	...
	function fm7(p0: seq<int>, p1: bool, p2: string, p3: bool, globalState: GlobalState): map<int, int> {
		((map v0 : int | (0x2b9 <= v0) && (v0 < -0x2fa) :: (safeModuloInt(v0, |map[true := f11]|)) := (|"xp"|)) + (map v1 : int | (0x227 <= v1) && (v1 < -268) :: (v1 * 0xf5) := (-0x133))) + map[-|map[-0x30a := f10]| := 159]
	}
	function fm5(p0: bool, p1: set<bool>, p2: bool, p3: bool, globalState: GlobalState): int {
		-0x2b7 - 957
	}
	function fm9(p0: set<int>, p1: bool, p2: bool, p3: map<bool, int>, globalState: GlobalState): int {
		safeModuloInt(0x1be, -|map[{-0x31d, 0x183, 0x201, |multiset{0x1f6, 0x1d4, 186, 0x87}|, 0x1c5} := map[f11 := !true]]| - |[{f11}]|)
	}
	...
	method m2(globalState: GlobalState) {
		...
		v7[safeIndex(607, v7.Length)] := {393};
		v7[safeIndex(607, v7.Length)] := if (f11) then v3 else v3;
		...
		var v14: array<int> := new int[14] [v0 * |fm1(v0, globalState)|, v0, v0, v0 + |v9|, fm2(v0, v0, globalState) * (if (f11 in v10) then v10[f11] else -fm2(-0x20e, v0, globalState)), --|v2|, 0x5b, v0, safeDivisionInt(v0, |(set v11 : int | (0x2ca <= v11) && (v11 < -0x17) :: (v11 * v0))|), v0, |map[v12 := v12.f11]|, -v0, v0, safeModuloInt(v0, v12.fm5(v12.f10, v13, f10, !v12.f10, globalState))];
		v14[safeIndex(406, v14.Length)] := v0;
		v14[safeIndex(406, v14.Length)] := v0;
		var v15 := 'm';
		var v16: seq<map<bool, int>> := [v2 + v2, v2, v2 + v2];
		v15, v16, v5 := v15, v16, v5;
		for i1 := v14[safeIndex(406, v14.Length)] to v0 {
			v15 := v15;
			globalState.f8 := f11;
			v14[safeIndex(406, v14.Length)] := 0xbd * |(map v17 : int | (0x16c <= v17) && (v17 < 0x3ce) :: (safeModuloInt(v17, |map[v13 := 'k']|)) := (map[false := DC70(map[multiset{i1, i1, v0, v14[safeIndex(406, v14.Length)]} := |(seq(abs(0x3b), i2  => (|v3|)))|])]))|;
			var v18: C5 := new C5(v12.f10, !v12.f10);
			var v19: seq<C5> := [v18, v18, v18];
			v1 := v1[safeIndex(if (v12.f11) then i1 else |v19|, |v1|) := v14[safeIndex(406, v14.Length)]];
		}
	}
	method m3(p0: int, globalState: GlobalState) returns (r0: array<array<bool>>, r1: char) {
		for i0 := p0 to -safeModuloInt(-p0, -p0) {
			var v0 := -0x6c;
			...
			var v8 := new C0((seq(abs(0x67), i1  => (i0))) + [v0, i0], v7);
			var v9 := 'p';
			var v10: seq<char> := [v9];
			...
			v17[safeIndex(559, v17.Length)] := v15;
			var v18: seq<bool> := [false];
			v17[safeIndex(559, v17.Length)] := map[v14 := |v18|] + v15;
		}
		var i3 := 0;
		while (f11)
			decreases 100 - i3
		{
			...
			globalState.f8 := safeModuloInt(p0, p0) !in v22;
			if (f10) {
				var v23 := 110;
				var v24: map<bool, bool> := map[f10 := f10];
				var v25: map<bool, map<bool, bool>> := map[f11 := v24];
				v23 := safeModuloInt(v23, p0) - |(v25[f10 := v24] + v25)|;
				v23 := |v19| * v23;
				var v26 := DC64(f11);
				var v27 := DC65(v26);
				...
				var v33 := DC61(v28, v32[safeIndex(p0, |v32|)], p0);
				v33 := v33;
				var v34 := 'l';
				var v35 := DC71(v19, f11, p0, p0, v19[safeIndex(p0, |v19|) := v34]);
				var v36: seq<seq<char>> := [v35.cf108];
				var v37, v38, v39 := m4(v36[safeIndex(p0, |v36|)], globalState);
			} else {
				var v40 := 813;
				...
				v40, globalState.f8, v43, v40 := -(v46[safeIndex(|v19|, |v46|)] + v40) + p0, (fm2(p0, p0, globalState) + |v41|) != -p0, if (f11) then v47[safeIndex(0x76, |v47|)] else v43, -v40;
			...
			match (DC5(v50)) {
				case DC4(cf8, cf9, cf10, cf11) =>
					...
					v55[safeIndex(434, v55.Length)] := safeDivisionInt(0x3d, p0);
					v55[safeIndex(434, v55.Length)] := |(v19 + "gmn")|;
				...
				case DC5(cf12) =>
					...
					v67[safeIndex(128, v67.Length)] := p0;
					v67[safeIndex(128, v67.Length)] := --p0;
					var v68: array<map<bool, bool>> := new map<bool, bool>[6];
					v68 := v68;
					var v69: seq<string> := [v19, "cjhqhmj"];
					var v70: set<int> := {p0};
					var v71: map<bool, int> := map[v64 := v67[safeIndex(128, v67.Length)]];
					v67[safeIndex(128, v67.Length)], globalState.f4, v67[safeIndex(128, v67.Length)] := v67[safeIndex(128, v67.Length)], (seq(abs(136), i5  => ('n'))) + (v69[safeIndex(fm9(v70, v65, v64, v71, globalState), |v69|)] + v19), v67[safeIndex(128, v67.Length)];
			}
			...
			v75[safeIndex(118, v75.Length)] := DC66(map[v72 := |v19|]);
			v75[safeIndex(118, v75.Length)] := v74;
		}
		...
		if (f10) {
			...
			v89[safeIndex(157, v89.Length)] := f10;
			v89[safeIndex(157, v89.Length)], v82, globalState.f8 := v85.f12 ==> v85.f12, safeModuloInt(0xdb, p0), !f10;
			var v90 := "k";
			var v91: seq<string> := [v90];
			v91 := seq(abs(0x3af), i7  => (v90 + v90));
		} else {
			var v92: map<bool, bool> := map[f11 := f10];
			var v93: seq<map<bool, bool>> := [v92];
			var v94: seq<seq<map<bool, bool>>> := [v93, v93];
			var v95 := DC82(seq(abs(-0x44), i9  => (v92)));
			var v96: seq<bool> := [f11, f10, f10, f10];
			var v97: map<bool, seq<map<bool, bool>>> := map[f11 := v93];
			var v98: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[26] [v94[safeIndex(p0, |v94|)], v93, seq(abs(0x248), i8  => (map[f10 := f10])), v95.cf132, v93, v93 + [v92], v93, [v92, ((map[f10 := f10])[f10 := false])[f10 := f11], map[f11 := f10]], v93, v93, (seq(abs(0x392), i10  => (v92)))[safeIndex(|v96|, |(seq(abs(0x392), i10  => (v92)))|) := v92], v93, seq(abs(0xb3), i11  => (v92)), v93, v93, v93, [((map[!f10 := f10])[f11 := f11])[f11 := f11], map[f10 := !f11], v92], v93, if (f10 in v97) then v97[f10] else v93, if (!f10 in v97) then v97[!f10] else v95.cf132[safeIndex(p0, |v95.cf132|) := v92], [v92], v93 + v93, seq(abs(0xaf), i12  => (v92)), v93 + v93, if (f11 in v97) then v97[f11] else v93, v93 + (seq(abs(807), i13  => (v92)))];
			v98[safeIndex(901, v98.Length)] := [map[f10 := f10], v92];
			v98[safeIndex(901, v98.Length)] := v93 + v93;
			var v99: array<seq<seq<int>>> := new seq<seq<int>>[13](i14 => [[p0], [p0, |"ykyrgp"|], seq(abs(0x18f), i15  => (p0)), [p0]]);
			v99[safeIndex(2, v99.Length)] := fm45(p0, globalState);
			...
			var v105: seq<int> := [|(map v100 : map<int, int> | v100 in map[v102[safeIndex(p0, |v102|)] := -v104.cf1] :: (v100) := (f10))|, p0];
			var v106: seq<seq<int>> := [v105, v105 + v105, fm11(f11, globalState)];
			v99[safeIndex(2, v99.Length)] := v106[safeIndex(p0, |v106|) := seq(abs(82), i16  => (p0))];
			var v107 := 0xea;
			...
			v114 := v114;
			var v115: array<bool> := new bool[14](i18 => [v111.f21, f10] != v96[safeIndex(v107, |v96|) := false]);
			v115[safeIndex(133, v115.Length)] := v111.f21;
			v115[safeIndex(133, v115.Length)] := f10;
		}
	...
	method m0(p0: int, globalState: GlobalState) returns (r0: multiset<int>, r1: int, r2: seq<int>) {
		for i0 := p0 to p0 * p0 {
			if (f10) {
				...
				v7 := v8[safeIndex(i0, |v8|)];
				globalState.f4 := "eqokkkt";
				var v9: set<int> := {p0, p0, i0, p0};
				var v10 := new C5(v9 > {204}, true);
				r2 := (v3 + fm70(i0, f10, globalState)) + (v3[safeIndex(-p0, |v3|) := 0x85] + v3);
			} else {
				...
				v11 := new int[17] [i0, i0, |(v12[i0 := f10] + (map v13 : int | (555 <= v13) && (v13 < 565) :: (safeModuloInt(v13, i0)) := (f11)))|, p0, p0 * i0, i0 + p0, i0, 0x375 - 0x385, i0, |v18|, safeModuloInt(v21[safeIndex(i0, |v21|)], DC32(352, f11, f10, v14).cf48), p0 + v19.f20, p0, |(v22 + v22)|, 0x12, fm2(p0, -v19.f20, globalState), v19.f20];
				...
				var v35: map<char, bool> := map[v30[safeIndex(|v31|, |v30|)] := (v34.(cf3 := v33)).cf4];
				var v36: array<string> := new seq<char>[5] [(seq(abs(0xb1), i3  => ('c')))[safeIndex(|v35|, |(seq(abs(0xb1), i3  => ('c')))|) := v29] + v30, v30, (seq(abs(194), i4  => (v29))) + v30, "o", "ialiqinou"];
				v36 := new string[10];
				var v37: map<int, string> := map[p0 := v30];
				var v38 := DC10(v14, v37, p0, f11);
				var v39: seq<seq<int>> := [v21, v21, [i0]];
				var v40: seq<seq<int>> := [[p0, v38.cf19], v21, v39[safeIndex(v19.f20, |v39|)]];
				v16[safeIndex(917, v16.Length)] := v14;
				var v41: set<bool> := {f10, f10};
				globalState.f8, v40, v16[safeIndex(917, v16.Length)], v41 := f10, fm45(i0 + p0, globalState), v14, v41;
			...
			r1 := |(v47[safeIndex(i0, |v47|)] + (v46 + (v46[v44 := "trugfwxv"])[v44 := v45]))|;
		}
		r1 := p0;
		r1 := -(p0 + |(multiset{f10, f10})[f10 := abs(p0)]|);
		var v48 := new C4(!f10);
		var v49: seq<int> := [p0];
		var v50: array<int> := new int[26](i5 => safeModuloInt(i5, |(seq(abs(-0xba), i6  => ('w')))|));
		...
		v53[safeIndex(958, v53.Length)] := f11;
		var v54: seq<bool> := [v48.f21, f10, f10];
		v53[safeIndex(958, v53.Length)] := p0 < -|(v54 + v54)|;
		r0 := match DC13(p0) {
			case DC13(cf23) => multiset{v49[safeIndex(cf23, |v49|)]}
			case DC12(cf22) => (multiset{|map[p0 := p0]|})[p0 := abs(p0)] - multiset(v49)
		};
		var v55 := "ekmejhvlk";
		var v56 := 'f';
		r1 := |((v55 + v55) + v55[safeIndex(p0, |v55|) := v56])|;
		r2 := v49 + v49;
	}
	method m1(p0: bool, p1: bool, globalState: GlobalState) returns (r0: multiset<bool>) {
		var v0: array<bool> := new bool[11];
		v0[safeIndex(398, v0.Length)] := p0 || p0;
		var v1 := 0x1c7;
		var v2 := DC85(map[v1 := v0]);
		var v3: map<int, array<bool>> := map[v1 := v0];
		v0[safeIndex(398, v0.Length)] := v2.cf136 != v3;
		var v4: array<int> := new int[7](i0 => i0 - v1);
		v4[safeIndex(529, v4.Length)] := -0x2b1;
		v4[safeIndex(529, v4.Length)] := v1;
		v0 := v0;
		forall i1 | 0 <= i1 < v4.Length {
			v4[i1] := safeDivisionInt(i1, safeModuloInt(0x2f9, v1));
		}
		var v5 := "eunb";
		var v6: map<bool, int> := map[true := 0xa0];
		var v7: seq<int> := [v4[safeIndex(529, v4.Length)], |v5|, |v6|];
		v4[safeIndex(529, v4.Length)] := safeDivisionInt(v4[safeIndex(529, v4.Length)], v7[safeIndex(v1, |v7|)]);
		var v8 := DC41(v4[safeIndex(529, v4.Length)], v1, f11, v5 + v5, v1);
		match (v8) {
			case DC40(cf60, cf61, cf62) =>
				var v9 := DC35(p1, v1);
				v9 := v9;
				if (f10) {
					...
					v4, v1, v0[safeIndex(398, v0.Length)], v14, v15 := v4, cf62, p1, map[v13 := cf62], v16[safeIndex(fm2(v4[safeIndex(529, v4.Length)], v4[safeIndex(529, v4.Length)], globalState), |v16|)];
					var v17: set<seq<bool>> := {[true], [cf61]};
					var v18: array<set<seq<bool>>> := new set<seq<bool>>[8] [v17, v17, v17, {[cf60]}, v17 - v17, v17, v17, v17];
					v18[safeIndex(133, v18.Length)] := v17;
					var v19: map<seq<bool>, bool> := map[v15 := p0];
					v18[safeIndex(133, v18.Length)] := set v20 : seq<bool> | v20 in v19 :: (v20);
					var v21: map<bool, bool> := map[!cf61 := f11];
					v21 := v21[p0 && v0[safeIndex(398, v0.Length)] := !cf60];
				} else {
					var v22: map<bool, bool> := map[f11 := f11 ==> cf60];
					v22 := v22[v0[safeIndex(398, v0.Length)] || !p0 := p0];
					v1 := |v5|;
					globalState.f8 := !!f11;
					globalState.f8 := v0[safeIndex(398, v0.Length)];
					v0 := v0;
				}
				...
				v4[safeIndex(529, v4.Length)] := cf62 - |v24|;
			case DC41(cf63, cf64, cf65, cf66, cf67) =>
				...
				v31[safeIndex(375, v31.Length)] := v33 + v33;
				v31[safeIndex(375, v31.Length)] := v33 + fm96(globalState);
			...
			case DC39(cf59) =>
				var v36 := 'w';
				v36 := v36;
				v4[safeIndex(529, v4.Length)] := safeModuloInt(v4[safeIndex(529, v4.Length)], -v1) + (if (fm6(v7, globalState)) then v1 else v1);
				var v37: set<int> := {v1, v4[safeIndex(529, v4.Length)]};
				var v38: set<int> := {-|[v4[safeIndex(529, v4.Length)]]|, --|v37|};
				var v39: map<bool, set<int>> := map[p0 := v37];
				var v40 := DC23(v39);
				var v41: set<D10> := {v40, v40, v40, v40};
				v1 := safeDivisionInt(v4[safeIndex(529, v4.Length)], |v41|);
				var v42: array<char> := new char[1] [v5[safeIndex(|v5|, |v5|)]];
				v42[safeIndex(389, v42.Length)] := v36;
				v42[safeIndex(389, v42.Length)] := 's';
		}
		
		r0 := (multiset{p1, v0[safeIndex(398, v0.Length)], f11})[true := abs(v4[safeIndex(529, v4.Length)])];
	}
	method m4(p0: seq<char>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool) {
		...
		var v12: array<array<bool>> := new array<bool>[26] [v2, v2, v2, v2, v2, v4.cf17, v2, v2, v2, v2, v10.cf138, v2, v2, v2, v2, v2, v2, v11[safeIndex(-v3, |v11|)], v2, v2, v2, v2, if (f11) then v2 else v2, v2, v2, if (v0.f13) then v11[safeIndex(-v3, |v11|)] else v2];
		v12[safeIndex(188, v12.Length)] := v2;
		v12[safeIndex(188, v12.Length)] := new bool[14];
		var v13 := DC68(true);
			...
			decreases 100 - i0
		{
			...
			if ((v16 + {f11, v0.f13}) >= v16) {
				v12[safeIndex(188, v12.Length)] := v12[safeIndex(188, v12.Length)];
				v2 := v12[safeIndex(188, v12.Length)];
				r2 := v0.f13;
				v3 := safeDivisionInt(v3, -v0.fm5(v0.f13, v16, v0.f13, v0.f13, globalState));
			...
			var v27 := DC90(v24);
			var v28: array<map<C8, int>> := new map<C8, int>[23] [v24, v24, map[v23 := |v25|], v24 + v24, v24 + v24, v24 + v24, v24, v24 + v24, v26[safeIndex(v3, |v26|)] + v24, v24[v23 := v23.f24], v27.cf142, v24, v24, map[v23 := v23.f24] + v24, v24, v24, v24, v24 + v24, v24, v24, v24, v24[v23 := -0x139], map[v23 := v23.f24]];
			v28[safeIndex(570, v28.Length)] := (map[v23 := v3])[v23 := v23.f24] + v24;
			v28[safeIndex(570, v28.Length)] := v24;
			if (!(if (!f11) then f10 else f11)) {
				...
				v35 := v35;
				globalState.f8 := p0 < ((seq(abs(278), i3  => (v8))) + p0);
				v2[safeIndex(453, v2.Length)] := v0.f13;
				v2[safeIndex(453, v2.Length)] := f11;
				globalState.f4 := p0;
...
function fm1(p0: int, globalState: GlobalState): string {
	("rilhhw" + (seq(abs(-0x1b9), i0  => ('p')))) + "p"
}
function fm2(p0: int, p1: int, globalState: GlobalState): int {
	-(safeDivisionInt(-389, -0x1a1) + safeDivisionInt(|map[|multiset{true, false, false, false}| := true]|, 352))
}
...
function fm11(p0: bool, globalState: GlobalState): seq<int> {
	[DC52(-0x26c, |(map v0 : int | (0x1fa <= v0) && (v0 < -0x311) :: (safeModuloInt(v0, 0x25e)) := (true))|).cf83, |[|{false}|]|] + (seq(abs(0x3d7), i0  => (-287)))
}
...
function fm25(globalState: GlobalState): multiset<multiset<int>> {
	multiset{multiset{-0x6a, |"sacxa"|}, multiset{0x109, 0x119}, multiset([597]), multiset{-0x222}, multiset{-436, |map[0x3c7 := true]|, -|(seq(abs(78), i0  => (0x2fb)))|}} + (multiset{multiset{-0x3e4, 0x3af}} - multiset([multiset{|{0x225}|, 0x24e}, multiset([146])]))
}
function fm26(p0: int, p1: bool, globalState: GlobalState): map<bool, bool> {
	(map[DC64(false).cf99 := true] + map[false := false]) + (if (!DC19(seq(abs(636), i0  => (875)), |[674]|, false, DC1(-|"sbkdmm"|, [false], multiset{false}, false, |"pd"|)).cf31) then map[true := false] else map[false := true])
}
...
function fm30(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): set<int> {
	if (true) then {145, |"wxngq"|, |"l"|} + {|multiset{true}|, |(map v0 : int | v0 in map[-|(seq(abs(898), i0  => (0x221)))| := |[|(seq(abs(563), i1  => (0x7c)))|]|] :: (v0 - 76) := (true))|} else {-0xe1, 0x69, |[!!false]|}
}
...
function fm32(p0: bool, p1: int, p2: bool, p3: set<bool>, globalState: GlobalState): D2 {
	DC7(|map[|DC71("a", !true, 975, |[false, false, false, true]|, "s").cf112| := true]| * |(seq(abs(0x3cc), i0  => ('m')))|)
}
...
function fm41(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<bool> {
	[!((seq(abs(-0x341), i0  => ('b'))) <= (seq(abs(-0x3a3), i1  => ('l')))), false, [0x366, 0x12f] <= (seq(abs(719), i2  => (|"ky"|)))]
}
function fm42(p0: bool, p1: bool, p2: map<bool, int>, globalState: GlobalState): multiset<int> {
	if ({0x31} !! (set v0 : int | (-0x1a5 <= v0) && (v0 < 0x9) :: (v0 + 638))) then multiset{546, 132, |"kxe"|, |{-|(map v1 : set<bool> | v1 in (seq(abs(-0x213), i0  => ({false}))) :: (v1) := ('b'))|, 0x21f}|, -0x3c9} else multiset{|[[false, false], [true]]|} + multiset{0xd2}
}
...
function fm44(p0: int, globalState: GlobalState): seq<int> {
	[safeDivisionInt(-0x30f, 289), 95]
}
function fm45(p0: int, globalState: GlobalState): seq<seq<int>> {
	[[0x6b] + [|map[false := 0x3e]|], [-0x1fb, -0x367], seq(abs(0x285), i0  => (0x1fd))]
}
function fm46(globalState: GlobalState): D0 {
	DC1(|['g', 'd', 'i']|, [false], multiset{true} + multiset{true, false, !!!true}, if (false) then true else true, safeDivisionInt(-0x2bd, |map[false := -854]|))
}
...
function fm48(globalState: GlobalState): D8 {
	DC19([|multiset{|"qrabe"|}|] + (seq(abs(0x27a), i0  => (|"odmkr"|))), safeDivisionInt(|map[|"hdggsk"| := -0x35d]|, |"f"|), true, if (true) then DC1(-0x231, [false], multiset{!false, true}, !false, |[!false]|) else DC1(|"ceqjgvts"|, [true, true, !false, false, false], multiset{true}, false, |(map v0 : int | v0 in [106] :: (v0 * |"bmyp"|) := (|"rgstsoprr"|))|))
}
function fm49(globalState: GlobalState): map<bool, int> {
	map[!true := |{722, |(map v0 : int | v0 in (seq(abs(729), i0  => (|map[false := 0x4]|))) :: (v0 - |map[0x39b := 0x8c]|) := (725))|, -|"pqecww"|, |[|multiset{"aakyh", seq(abs(368), i1  => ('p'))}|, |map['y' := false]|, 98]|}|] + map[true := -0x228]
}
...
function fm54(p0: int, p1: bool, p2: int, globalState: GlobalState): map<int, string> {
	(map v0 : int | (-0x11e <= v0) && (v0 < 0x140) :: (safeDivisionInt(v0, |(seq(abs(-520), i0  => (|{false}|)))|)) := (DC93("yjstba").cf146)) + (map[|[false]| := seq(abs(0x299), i1  => ('h'))] + map[|{true, false}| := "ekrtcgaul"])
}
function fm55(globalState: GlobalState): D10 {
	DC23(map[!false := {|[|[-832]|]|, |(seq(abs(0x376), i0  => ('o')))|, |(seq(abs(0x348), i1  => (|(seq(abs(-0xf2), i2  => ('a')))|)))|, -0x2fe, 131}])
}
function fm56(p0: bool, p1: int, globalState: GlobalState): D6 {
	if (!false) then DC14(seq(abs(470), i0  => (0x35e))) else DC14(DC19([610], 0x30a, !!true, DC1(-0x1e2, [false], multiset([true]), true, |{|map[false := map[false := false]]|}|)).cf29)
}
...
function fm60(globalState: GlobalState): multiset<bool> {
	multiset{if (false) then false else !DC95(|"r"|, |[|{-0x1a5}|, |(seq(abs(-496), i0  => ('j')))|]|, false, false).cf150}
}
...
function fm63(p0: int, p1: bool, p2: string, globalState: GlobalState): set<multiset<int>> {
	({multiset{|(seq(abs(917), i0  => ('w')))|}} * {multiset{-55}, multiset{|{multiset{true}}|, |map[-|{true}| := false]|, -0x2ae}, multiset{0x36}}) * {multiset{910}, multiset{|multiset{true}|, |[-0x3be]|, -219}}
}
...
function fm65(p0: bool, p1: bool, p2: seq<bool>, p3: bool, globalState: GlobalState): D4 {
	DC11([map[|(map v0 : char | v0 in map['l' := !false] :: (v0) := (map[0x202 := 'r']))| := !false], map v1 : int | (956 <= v1) && (v1 < 75) :: (safeDivisionInt(v1, -0x265)) := (true), map[0x146 := false]])
}
function fm66(p0: int, p1: int, globalState: GlobalState): set<int> {
	{-|map[false := |(map v0 : D17 | v0 in map[DC38(map[false := |"l"|]) := false] :: (v0) := (!true))|]| - 0x303, 0x1ca, --safeDivisionInt(|multiset{0x298}|, |[0x20c]|), |"aasjebor"| - 0, 0x2a8}
}
...
function fm68(p0: seq<bool>, p1: bool, p2: int, p3: int, globalState: GlobalState): D1 {
	DC4({seq(abs(181), i0  => ('b'))} * {"fcatv"}, safeModuloInt(-|[false]|, |(seq(abs(0x1c9), i1  => (|"hv"|)))|), multiset{|map[seq(abs(0xe5), i2  => ('e')) := !false]|, 0x166} >= multiset{-0x57, 0x338, -|(seq(abs(512), i3  => (0x17e)))|}, 0x2ce * |"twfgd"|)
}
...
function fm72(globalState: GlobalState): map<map<D12, bool>, bool> {
	(map[map[DC28(DC27(!!!false, map[['w', 'd'] := map v0 : int | (0x368 <= v0) && (v0 < 0x1af) :: (v0 - 780) := (0x3be)], -0x298)) := true] := true] + map[map v1 : D12 | v1 in map[DC28(DC27(false, map[['c'] := map[964 := -0x89]], |(seq(abs(0x287), i0  => (DC69(false, false, false))))|)) := true] :: (v1) := (true) := !true]) + (map v2 : map<D12, bool> | v2 in (set v3 : map<D12, bool> | v3 in map[map[DC28(DC27(!true, map[seq(abs(0x21b), i1  => ('y')) := map[|map[|map[-776 := true]| := 717]| := |[|{true}|, 481]|]], 0xe0)) := true] := |[false]|] :: (v3)) :: (v2) := (true))
}
function fm73(p0: int, p1: int, p2: seq<bool>, globalState: GlobalState): D18 {
	DC40(!false, "ekbfb" < "gdlbtwjds", safeModuloInt(-149, 0x3b1))
}
...
function fm80(p0: int, p1: bool, p2: char, p3: seq<bool>, globalState: GlobalState): map<D29, string> {
	(map[DC71("fmxb", true, 603, |[false, false]|, seq(abs(395), i0  => ('c'))) := "qt"] + map[DC71("rmkb", false, 0x2f1, -|(seq(abs(650), i1  => (|multiset{419}|)))|, "xisyq") := "rnks"]) + (map v0 : D29 | v0 in {DC71("pvwhjqxp", true, -0x99, 0x1d7, "toolbjwt"), DC71(seq(abs(0x145), i2  => ('o')), false, --0x3c8, |"opahjnh"|, "q")} :: (v0) := ("fpnwos"))
}
...
function fm83(p0: bool, globalState: GlobalState): seq<bool> {
	match if (!true) then DC80(map v0 : map<int, bool> | v0 in multiset([map[|[0x169, 487]| := !false], map v1 : int | v1 in (seq(abs(0x1f5), i0  => (0x3af))) :: (v1 + |"j"|) := (!true)]) :: (v0) := (|[false]|)) else DC80(map[map v2 : int | (860 <= v2) && (v2 < 888) :: (v2 + 12) := (false) := 654]) {
...
function fm86(p0: multiset<multiset<bool>>, p1: int, globalState: GlobalState): seq<map<bool, int>> {
	(if (true) then [map[true := 0x93]] else seq(abs(-0x2b8), i0  => (map[true := |[false]|]))) + (seq(abs(0x2c1), i1  => (map[!true := 0x38f])))
}
...
function fm89(p0: char, globalState: GlobalState): D25 {
	DC59((seq(abs(0x399), i0  => ([342]))) + [[0x55]])
}
...
function fm91(globalState: GlobalState): D13 {
	if ("bvgy" != (seq(abs(0x5), i0  => ('h')))) then DC29(map[false := false]) else DC29(map[false := true])
}
function fm92(p0: int, p1: bool, globalState: GlobalState): map<seq<int>, bool> {
	map[[0x1df, 416, -0x33a, 0x17f] := false] + (map[seq(abs(-0x2b3), i0  => (0x290)) := true] + map[[|map[|map[373 := !true]| := false]|] := false])
}
...
function fm94(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, D33> {
	map[|map[false := false]| := DC78(multiset{DC13(|"ejvq"|), DC13(|(map v0 : int | v0 in map[-0x67 := 207] :: (safeModuloInt(v0, 0x1d0)) := (seq(abs(891), i0  => (|"yenfhson"|))))|), DC13(0x269), DC13(|(seq(abs(-287), i1  => (|"jsrbmtdr"|)))|)})] + (map v1 : int | (0x389 <= v1) && (v1 < 0x203) :: (v1 * |map[!false := false]|) := (DC78(DC78(multiset{DC13(-|map[true := false]|)}).cf120)))
}
...
function fm96(globalState: GlobalState): map<string, int> {
	map["khgdtnnc" := |[true, false, !false]|] + DC26(map[seq(abs(0x333), i0  => ('n')) := 567]).cf40
}
method Main() {
	var v0 := 0x13e;
	var v1: set<int> := {v0};
	var v2: seq<int> := [|v1|];
	var v3: set<seq<int>> := {v2[safeIndex(v0, |v2|) := v0]};
	var v4 := "x";
	var v5 := false;
	...
	if (v5) {
		...
		v18[safeIndex(56, v18.Length)] := v0;
		v0, v18[safeIndex(56, v18.Length)], v0, v5, v0 := v0, v0, 634, !fm0(safeDivisionInt(0x11e, v0), v4, globalState), if (v5) then v0 else fm2(v0, v0, globalState);
		var v19 := 'c';
		var v20: multiset<seq<char>> := multiset{['x', v19, v19]};
		var v21: multiset<int> := multiset{v0};
		v20 := fm3(v4, v9[safeIndex(fm2(|v21|, v0, globalState), |v9|) := v5] <= v9, v19, v5, globalState);
		...
		globalState.f5, globalState.f8, v25, v11, v18[safeIndex(56, v18.Length)] := v26[safeIndex(|v9[safeIndex(|v1|, |v9|) := v5]|, |v26|)], (v21 * multiset([v18[safeIndex(56, v18.Length)], |v1|, v0, 0xc3])) >= v21, fm4({v5}, globalState), v11, -v0;
		v0 := |v9|;
	}
	...
	for i0 := -755 to v0 {
		...
		globalState.f8, globalState.f4, v0, v27 := v5, (v4 + v4) + ((seq(abs(548), i2  => ('c'))) + v4), safeDivisionInt(i0, v0), v27;
		...
		v33[safeIndex(837, v33.Length)] := v31;
		var v34: seq<array<int>> := [v31];
		v33[safeIndex(837, v33.Length)] := v34[safeIndex(|fm3(v4, v28.fm34(v28.f20, false, v0, globalState), v29, true, globalState)|, |v34|)];
	}
	v0 := safeModuloInt(v0, |fm26(v0, v5, globalState)|);
	var v35: map<int, int> := map[v0 := v0];
	var v36: map<seq<char>, map<int, int>> := map[v4 := v35];
	var v37 := DC27(v5, v36, v0);
	var v38 := DC28(v37);
	var v39 := DC28(v37);
	var v40: C9 := new C9(seq(abs(189), i3  => ('a')));
	...
	var v49: array<seq<T0>> := new seq<T0>[28] [v44, v44 + v44, v45[safeIndex(v0, |v45|)] + v44, if (v11 in v46) then v46[v11] else v44, v44, v44, v44 + v44, (v44 + [v42, v42])[safeIndex(-0x317, |(v44 + [v42, v42])|) := v42], v44, (v44 + [v42])[safeIndex(v0, |(v44 + [v42])|) := v42], v44, v44 + v44, v44 + v44, v44, v44, v44 + v44, v44, v44, v44, v44, v44 + v44, v44, (if (v48.cf43 in v47) then v47[v48.cf43] else v44) + v44, v44, v44, v44, v44, v44];
	v49[safeIndex(367, v49.Length)] := v44;
	v49[safeIndex(367, v49.Length)] := v44;
	var v50: set<bool> := {v5, v5};
	v0 := |(v50 - v50)|;
	var v51 := 'r';
	var v52: seq<string> := [(v4[safeIndex(790, |v4|) := v51])[safeIndex(v0, |v4[safeIndex(790, |v4|) := v51]|) := v51]];
	var v53: map<bool, bool> := map[v5 := v5];
	var v54: map<bool, int> := map[true := v2[safeIndex(-0x144, |v2|)]];
	var v55: map<int, map<bool, int>> := map[v0 := v54];
	var v56: array<int> := new int[17] [v0, |v52[safeIndex(|v6|, |v52|)]|, v0, v40.fm5(v5, {if (v5 in v53) then v53[v5] else v5}, v5, !v5, globalState), |(map[v5 := v0] + (if (v0 in v55) then v55[v0] else v54))|, |("m" + v4)[safeIndex(v0, |("m" + v4)|) := v51]|, v0 + 424, v0, v0 + v0, |[-v0, v0]|, |v53[v5 := !!v5]|, 0x235, v0, v0, |(seq(abs(-437), i4  => (v51)))|, v0, v0];
	v56[safeIndex(535, v56.Length)] := |fm11(v5, globalState)|;
	var v57: array<seq<C9>> := new seq<C9>[25];
	var v58 := DC43(|(seq(abs(0x2e7), i5  => (v0)))|);
	v56[safeIndex(535, v56.Length)], v57, v58, globalState.f8 := v2[safeIndex(-(v0 * v0), |v2|)], v57, DC43(v0), (v0 * v0) < v0;
	var v59: C3 := new C3(v0, v5, v5);
	var v60: seq<C3> := [v59, v59, v59, v59, if (v5) then v59 else v59];
	v56[safeIndex(535, v56.Length)] := |v60|;
	var v61: C5 := new C5(v59.f19, v5);
	var v62: map<C5, int> := map[v61 := v56[safeIndex(535, v56.Length)]];
	v62 := v62[v61 := v59.f18];
	var v63 := DC14(v2);
	...
	for i6 := v0 to |v64| {
		...
		var v68 := new C3(if (v9 in v67) then v67[v9] else v59.f18, (seq(abs(0x18e), i7  => (v56[safeIndex(535, v56.Length)]))) <= v2, v59.f19 || v5);
		v11 := v11;
	}
	var v69: map<array<int>, char> := map[v56 := v51];
	var v70 := DC41(if (v0 in v35) then v35[v0] else v56[safeIndex(535, v56.Length)], -99, v5, "duxjfceu", |v9|);
	v69 := v69[v56 := if (v70.cf65) then fm36(v4, globalState) else v51];
	var v71: array<D22> := new D22[25](i8 => DC51(v40.f22[safeIndex(v59.f18, |v40.f22|) := v51], 0x36d));
	var v72: map<map<int, bool>, bool> := map[map[0x220 := v59.f19] := v59.f19];
	var v73: map<int, bool> := map[v0 := v59.f19];
	v71[safeIndex(751, v71.Length)] := DC51(v40.f22, -|fm70(v56[safeIndex(535, v56.Length)], if (v73 in v72) then v72[v73] else v5, globalState)|);
	var v74 := DC31(multiset{!v5});
	v71[safeIndex(751, v71.Length)] := match v74 {
		...
		case DC33(cf52) => DC51(v40.f22, v56[safeIndex(535, v56.Length)])
	};
	var v75 := DC68(v59.f19);
	globalState.f8 := (v75.(cf103 := !v5)).cf103;
	v11[safeIndex(140, v11.Length)] := !v59.f19;
	v11[safeIndex(140, v11.Length)] := v51 !in "ysmcwopd";
	print v0, "\n";
	print v1 == {318}, "\n";
	print v2 == [1], "\n";
	print v3 == {[318]}, "\n";
	print v4, "\n";
	print v5, "\n";
	print v6 == multiset{false, false}, "\n";
	print v7 == map[multiset{false, false} := 318], "\n";
	print v8 == map[955 := map[multiset{false, false} := 318]], "\n";
	print v9 == [true, false], "\n";
	print v10 == map[[true, false] := "k"], "\n";
	print globalState.f0, "\n";
	print globalState.f1, "\n";
	print globalState.f2, "\n";
	print globalState.f3 == {[318]}, "\n";
	print globalState.f4, "\n";
	print globalState.f5 == multiset{false, false}, "\n";
	print globalState.f6 == map[multiset{false, false} := 318], "\n";
	print globalState.f7, "\n";
	print globalState.f8, "\n";
	print globalState.f9 == map[[true, false] := "k"], "\n";
	print v11[5], "\n";
	print v35 == map[1 := 1], "\n";
	print v36 == map["x" := map[1 := 1]], "\n";
	print v37.cf41, "\n";
	print v37.cf42 == map["x" := map[1 := 1]], "\n";
	print v37.cf43, "\n";
	print v38.cf44.cf41, "\n";
	print v38.cf44.cf42 == map["x" := map[1 := 1]], "\n";
	print v38.cf44.cf43, "\n";
	print v39.cf44.cf41, "\n";
	print v39.cf44.cf42 == map["x" := map[1 := 1]], "\n";
	print v39.cf44.cf43, "\n";
	print v40.f22 == ['a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print |v41|, "\n";
	print |v43|, "\n";
	print |v44|, "\n";
	print |v45|, "\n";
	...
	print v51, "\n";
	print v52 == ["r"], "\n";
	print v53 == map[false := false], "\n";
	print v54 == map[true := 1], "\n";
	print v55 == map[0 := map[true := 1]], "\n";
	print v56[0], "\n";
	print v56[1], "\n";
	print v56[2], "\n";
	print v56[3], "\n";
	...
	print v70.cf66, "\n";
	print v70.cf67, "\n";
	print v71[0].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[0].cf81, "\n";
	print v71[1].cf80 == ['a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[1].cf81, "\n";
	print v71[2].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[2].cf81, "\n";
	print v71[3].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[3].cf81, "\n";
	print v71[4].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[4].cf81, "\n";
	print v71[5].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[5].cf81, "\n";
	print v71[6].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[6].cf81, "\n";
	print v71[7].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[7].cf81, "\n";
	print v71[8].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[8].cf81, "\n";
	print v71[9].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[9].cf81, "\n";
	print v71[10].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[10].cf81, "\n";
	print v71[11].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[11].cf81, "\n";
	print v71[12].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[12].cf81, "\n";
	print v71[13].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[13].cf81, "\n";
	print v71[14].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[14].cf81, "\n";
	print v71[15].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[15].cf81, "\n";
	print v71[16].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[16].cf81, "\n";
	print v71[17].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[17].cf81, "\n";
	print v71[18].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[18].cf81, "\n";
	print v71[19].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[19].cf81, "\n";
	print v71[20].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[20].cf81, "\n";
	print v71[21].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[21].cf81, "\n";
	print v71[22].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[22].cf81, "\n";
	print v71[23].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[23].cf81, "\n";
	print v71[24].cf80 == ['r', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'], "\n";
	print v71[24].cf81, "\n";
	print v72 == map[map[544 := false] := false], "\n";
	print v73 == map[0 := false], "\n";
	print v74.cf47 == multiset{true}, "\n";
	print v75.cf103, "\n";
}