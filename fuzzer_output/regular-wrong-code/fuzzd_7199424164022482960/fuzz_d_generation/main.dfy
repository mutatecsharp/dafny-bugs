...
function fm1(p0: bool, globalState: GlobalState): bool {
	DC0(|{map[true := |(seq(abs(918), i0  => (137)))|], map[true := |[true]|]}|, map["tq" := -0x164], multiset{-192, |map[true := true]|}).cf0 <= (----610 - |map[true := true]|)
}
...
function fm8(globalState: GlobalState): map<int, bool> {
	(if (false) then DC11(map v0 : int | v0 in (seq(abs(0x289), i0  => (-|{0xcc, 26}|))) :: (safeDivisionInt(v0, 0x134)) := (true)) else DC11(map v1 : int | v1 in (map v2 : int | v2 in map[|"t"| := |{|[false]|}|] :: (v2 + |"qc"|) := (|"mrjysrs"|)) :: (v1 - 0x1b0) := (true))).cf19
}
method m0(p0: D0, p1: int, globalState: GlobalState) returns (r0: int, r1: seq<int>, r2: set<int>, r3: bool) {
	var v0 := "hkx";
	var v1: seq<string> := [v0];
	var v2 := true;
	var v3: map<bool, int> := map[v2 := |(seq(abs(0x386), i0  => ('f')))|];
	...
	var v14: array<string> := new string[28] [v1[safeIndex(p1, |v1|)] + v0, v0, fm5(|v0|, p1, p1, |v3|, globalState), v0, v0, v0 + v0, seq(abs(713), i1  => (v0[safeIndex(0x275, |v0|)])), "hrekd", v0, v0, v0, v0, if (v2 in v12) then v12[v2] else v0[safeIndex(385, |v0|) := v13.cf10], v0, v0, v0 + v0, v0, v0, v0, v0, v0, v0, "mxsg", v0 + v0, v0, v0, v0, v0];
	v14 := v14;
	...
	for i4 := v15.f18 to v15.f18 {
		v18[safeIndex(580, v18.Length)] := v15.f18;
		v18[safeIndex(580, v18.Length)] := if (v2) then v15.f18 else p1 * p1;
		v0 := v0 + v0;
		...
		v5 := (v5 + (v5 + v5))[safeIndex(v10.cf0, |(v5 + (v5 + v5))|) := |v19| < -|v21|];
		match (v13) {
			case DC3(cf5) =>
			...
			case DC4(cf6, cf7, cf8, cf9, cf10) =>
				...
				v18[safeIndex(580, v18.Length)], v23, globalState.f4 := safeDivisionInt(v15.f18, -fm0(v10, globalState)), v23, |(((seq(abs(-273), i5  => (|{if (v15.f18 in v9) then v9[v15.f18] else |v0|}|))) + v19) + (v19 + v19))|;
				v18[safeIndex(580, v18.Length)] := i4;
				var v24: array<char> := new char[25](i6 => v0[safeIndex(-0x147, |v0|)]);
			...
			case DC2(cf4) =>
				...
				v28[safeIndex(487, v28.Length)] := map[v26 := v5[safeIndex(|v29|, |v5|)]] + v27;
				v28[safeIndex(487, v28.Length)] := v27;
				var v30: map<int, int> := map[v15.f18 := v15.f18];
				var v31: array<int> := new int[14] [i4, v18[safeIndex(580, v18.Length)], v26.f18, v15.f18, v26.f18, v18[safeIndex(580, v18.Length)], -v15.f18, v18[safeIndex(580, v18.Length)], -v15.f18, v15.f18, v15.f18, |v30[p1 := |v5|]|, v18[safeIndex(580, v18.Length)], v15.f18];
				var v32 := DC10(if (v2) then true else v2, v31, v0 + v0);
				v32 := v32;
			case DC5(cf11) =>
				globalState.f0 := i4;
				v20[safeIndex(960, v20.Length)] := v2;
				v20[safeIndex(960, v20.Length)] := v2;
				var v33: array<char> := new char[18](i7 => v7);
				v33 := v33;
				v20[safeIndex(960, v20.Length)] := v20[safeIndex(960, v20.Length)] ==> v20[safeIndex(960, v20.Length)];
		}
		
	}
	match (v13.(cf6 := seq(abs(335), i8  => (v7)), cf8 := v1)) {
		case DC3(cf5) =>
			var v34: array<bool> := new bool[5];
			var v35 := DC7(v34);
			var v36 := DC8(v35);
			v36 := v36;
			v34[safeIndex(898, v34.Length)] := v2 ==> v2;
			v34[safeIndex(898, v34.Length)] := v2;
			v34 := if (v2) then v34 else v34;
			var v37 := DC1(fm3(globalState));
			v37 := p0;
		case DC4(cf6, cf7, cf8, cf9, cf10) =>
			var v38: array<bool> := new bool[27](i9 => v5[safeIndex(|map[|{v15.f18, v15.f18, |v3|}| := p1]|, |v5|)] !in v3);
			v15, v38 := v15, v38;
			var v39: multiset<bool> := multiset{cf7, cf7};
			v18[safeIndex(62, v18.Length)] := |(if (v2) then v39 else fm7(p1, v5, v2, globalState))|;
			v18[safeIndex(62, v18.Length)] := p1;
		...
		case DC2(cf4) =>
			...
			if (v2) {
				...
				var v47: array<seq<array<bool>>> := new seq<array<bool>>[9] [v43, v43 + (if (v15 in v44) then v44[v15] else v43), v43[safeIndex(p1, |v43|) := v42] + v43, v43, if (p1 in v46) then v46[p1] else v43, v43, v43, v43, v43 + v43];
				v47[safeIndex(565, v47.Length)] := [v42, v42] + v43;
				v18[safeIndex(368, v18.Length)] := --|v16|;
				var v48 := DC10(v2 ==> false, v18, ((seq(abs(-28), i10  => (v7))) + "i")[safeIndex(v15.f18, |((seq(abs(-28), i10  => (v7))) + "i")|) := v7]);
				var v49: map<bool, C0> := map[v2 := v15];
				v47[safeIndex(565, v47.Length)], v0, v18[safeIndex(368, v18.Length)], v48 := v43 + v43, v0, |(v49 + v49)|, v48;
				var v50: map<int, int> := map[v18[safeIndex(368, v18.Length)] := v15.f18];
				v50 := v50[v18[safeIndex(368, v18.Length)] := v15.f18];
				globalState.f0 := p1;
				v42 := v42;
				...
				v58[safeIndex(781, v58.Length)] := true;
				v58[safeIndex(781, v58.Length)] := v2;
				globalState.f15 := v15.f18;
			}
			
			var v59: multiset<bool> := multiset{false};
			r3 := (v59 - multiset{!fm1(v2, globalState), v2}) >= (multiset{v2})[!v2 := abs(p1)];
		...
		case DC5(cf11) =>
			...
			var v66: array<bool> := new bool[22] [true, v13.cf7, v2, fm1(v2, globalState), v61 <= [v5], !true, v2, v2, v15.f18 != v15.f18, fm1(v2, globalState), v2, v62 == map[v64[safeIndex(|v0|, |v64|)] := v7], !v2, true, v5[safeIndex(p1, |v5|)], v2, v15.f18 > p1, !v2, v65.cf16, v2, v2, fm1(!false, globalState)];
			v66 := v66;
...
method Main() {
	...
	var v8 := "mgx";
	var globalState := new GlobalState(-0xce, v1 * v1, false, false, 633, 0x301, true, v2, v6[safeIndex(v3, |v6|) := v3] + v6, v4, -0x2e2, 0x2ca, 'r', false, 0x2f8, 0x28e, v7, v8);
	...
	match (v12) {
		case DC0(cf0, cf1, cf2) =>
			...
			if (fm1(v0, globalState)) {
				var v19 := DC1(v13);
				var v20, v21, v22, v23 := m0(if (v0) then v19 else v19, safeModuloInt(|v8|, cf0), globalState);
				...
				v3 := safeModuloInt(0x1d8, |v8|);
				var v29 := new C0(v25);
			}
			
			var v30: array<int> := new int[6];
			v30[safeIndex(841, v30.Length)] := v3 - cf0;
			v30[safeIndex(841, v30.Length)], v3, v0 := cf0, v3, !((cf0 * v15) > |v9|);
		case DC1(cf3) =>
			match (if (false) then v12 else v12) {
				case DC0(cf0, cf1, cf2) =>
					...
					var v34 := DC0(cf0, map v32 : string | v32 in v33 :: (v32) := (v12.cf0), v4[if (cf0 in v4) then v4[cf0] else v3 := abs(v3)]);
					var v35 := DC1(v34);
					var v36 := DC1(v35);
					var v37 := DC1(v36);
					var v38: set<string> := {v8};
					var v39, v40, v41, v42 := m0(v37, |[---cf0, v3, -|(seq(abs(0x33e), i1  => (v8[safeIndex(v3, |v8|)])))|, v3, -|v38|]|, globalState);
			...
			v59 := multiset(v60 + (seq(abs(-680), i2  => (multiset([v0, false, v0])))));
			globalState.f0 := 0xc;
			globalState.f10 := v3;
	}
	...
	var v66: array<int> := new int[14] [fm0(fm3(globalState), globalState), v3, v3 + v3, v3, v3, -0x1b5, v6[safeIndex(fm0(DC0(v3, map[v8 := v3], v4), globalState), |v6|)], -|(map v61 : multiset<int> | v61 in v62 :: (v61) := (v3))|, v3, |(v8 + v8)|, |v64|, |v65.cf4|, |v10| + v63.f18, v3];
	v66[safeIndex(580, v66.Length)] := v63.f18 * |v8|;
	v66[safeIndex(831, v66.Length)] := v63.f18 * v3;
	var v67: set<int> := {v63.f18, v63.f18};
	var v68: seq<bool> := [v0];
	globalState.f10, v66[safeIndex(580, v66.Length)], v66[safeIndex(831, v66.Length)] := if (v0) then v3 else |v67|, safeModuloInt(v63.f18 - |v8|, |v68|), v63.f18;
	var v69 := new C0(v3);
	v4 := v4;
	var v70: map<int, bool> := map[v63.f18 := !v0];
	if (if (safeModuloInt(v63.f18, -0x389) in v70) then v70[safeModuloInt(v63.f18, -0x389)] else !fm1(v0, globalState)) {
		var v71: array<map<bool, int>> := new map<bool, int>[4](i3 => if (v0) then v10 else v10);
		v71[safeIndex(584, v71.Length)] := v10;
		v71[safeIndex(584, v71.Length)] := v10;
		var v72: array<multiset<array<D1>>> := new multiset<array<D1>>[13];
		var v73: array<D1> := new D1[2] [v65, v65];
		v72[safeIndex(458, v72.Length)] := multiset{v73, v73, v73, v73, v73};
		var v74: multiset<array<D1>> := multiset{v73, v73};
		v72[safeIndex(458, v72.Length)] := (v74 - multiset{v73, v73}) * (v74 * v74);
		var v75: array<C0> := new C0[25];
		v75[safeIndex(299, v75.Length)] := v63;
		v75[safeIndex(299, v75.Length)] := v63;
		var v76: array<map<int, C0>> := new map<int, C0>[17];
		v76 := v76;
		var v77 := DC3(v1);
		var v78: array<D1> := new D1[16] [DC3(v1), v77, v77, v77, v77, v77, DC3(v1), DC3(v1), v77, v77, if (true) then v77 else v77, v77, v77, DC3(fm4(v63.f18, v69.f18, v66[safeIndex(580, v66.Length)], v63.f18, globalState)), DC3(v1), v77];
		v78[safeIndex(53, v78.Length)] := v77;
		v78[safeIndex(53, v78.Length)] := v77;
	} else {
		v7[safeIndex(826, v7.Length)] := v0;
		v7[safeIndex(826, v7.Length)] := v0;
		...
		var v86 := new C0(v3);
		var v87: map<bool, D0> := map[v7[safeIndex(826, v7.Length)] := v81];
		v87 := v87[v85 := DC1(v79)];
		globalState.f13 := v0;
	}
	...
	var v88 := 'j';
	var v89: map<multiset<int>, char> := map[multiset{v69.f18, v66[safeIndex(580, v66.Length)], v3, v3, -242} := v88];
	...
	v91[safeIndex(747, v91.Length)] := v6;
	v91[safeIndex(747, v91.Length)] := v6 + v6;
	v7 := v7;
	v0 := v0;
	if (v66[safeIndex(580, v66.Length)] == |v8|) {
		...
		if (v0) {
			...
			v66[safeIndex(580, v66.Length)] := |(v107 * v107)| - |"tprjqefl"|;
			v92 := v92;
		} else {
			globalState.f13 := |v92| < v69.f18;
			var v108: seq<string> := [v8, v8];
			var v109 := DC4("cs", v0, v108, fm5(|v4|, v91[safeIndex(747, v91.Length)][safeIndex(fm0(v12, globalState), |v91[safeIndex(747, v91.Length)]|)], v69.f18, v63.f18, globalState), v88);
			globalState.f15, v63, v70, globalState.f13, v66[safeIndex(580, v66.Length)] := |(v8 + ((seq(abs(650), i4  => (v88))) + v8))|, v69, v70, v109.cf7, v63.f18;
			var v110 := DC6(v69);
			var v111: array<C0> := new C0[29] [v69, if (!v0) then v69 else v110.cf12, v69, v63, v63, v63, v63, v63, v63, v63, v69, v92[safeIndex(v66[safeIndex(580, v66.Length)], |v92|)], v63, v63, v69, v69, v63, v63, v92[safeIndex(v69.f18, |v92|)], v63, v92[safeIndex(917, |v92|)], v69, v69, v63, v69, v63, v63, v69, v69];
			v111[safeIndex(892, v111.Length)] := v69;
			v111[safeIndex(892, v111.Length)] := v69;
			v12 := if (v0) then v12 else v12;
			v7[safeIndex(51, v7.Length)] := v0 ==> v0;
			v7[safeIndex(51, v7.Length)] := v0;
		}
		
		var v112 := DC0(v66[safeIndex(580, v66.Length)], v11[v8 := v63.f18], multiset{-v3, v69.f18});
		var v113 := DC1(v112);
		var v114, v115, v116, v117 := m0(DC1(v113), v69.f18 - v69.f18, globalState);
		v0 := v0;
		v7[safeIndex(708, v7.Length)] := "eqmqr" <= v8;
		v7[safeIndex(708, v7.Length)] := v117;
	} else {
		...
		var v120: map<int, string> := map[v69.f18 := seq(abs(-0x94), i5  => (v88))];
		var v121 := DC9(v120);
		var v123: array<map<int, string>> := new map<int, string>[7] [v120, if (v0) then map[0x2b8 := v8] else v120, v121.cf15, map v122 : int | (905 <= v122) && (v122 < 0x2ca) :: (safeDivisionInt(v122, |v68|)) := (v8), map[v66[safeIndex(580, v66.Length)] := v8], v120, v120];
		v123[safeIndex(856, v123.Length)] := v120;
		v123[safeIndex(856, v123.Length)] := if (v0) then map[v69.f18 := v8] else map[-|v8| := seq(abs(-0x10a), i6  => (v88))];
	}
	
	v88 := fm6(v67 < v67, globalState);
	v10 := v10[v0 <==> !v0 := v63.f18];
	if (v0) {
		v66[safeIndex(580, v66.Length)] := safeModuloInt(if (v0) then v69.f18 else 706, v63.f18);
		globalState.f4, globalState.f4 := v63.f18, fm0(v12, globalState);
		var v124 := new C0(|(seq(abs(51), i7  => (v68)))[safeIndex(v66[safeIndex(580, v66.Length)], |(seq(abs(51), i7  => (v68)))|) := v68]|);
		v11 := v11[v8 := 0x2f7];
		globalState.f4 := safeModuloInt(safeDivisionInt(v69.f18, v6[safeIndex(v124.f18, |v6|)]), fm0(v12, globalState));
	} else {
		...
		v66[safeIndex(580, v66.Length)] := (-v3 + v63.f18) - |v129|;
	...
	print v1 == {true}, "\n";
	print v3, "\n";
	print v4 == multiset{639, -408}, "\n";
	print v5 == multiset{true, true}, "\n";
	print v6 == [2, 2], "\n";
	print v7[0], "\n";
	print v7[1], "\n";
	print v7[2], "\n";
	...
	print globalState.f8 == [2, 639, 2, 2], "\n";
	print globalState.f9 == multiset{639, -408}, "\n";
	...
	print v9 == map[639 := 639, 2 := 2], "\n";
	print v10 == map[true := 639, false := 2], "\n";
	print v11 == map["mgx" := 759], "\n";
	print v12.cf0, "\n";
	print v12.cf1 == map["mgx" := 1], "\n";
	print v12.cf2 == multiset{639, -408}, "\n";
	print v62 == [multiset{2, 2}, multiset{639, -408}, multiset{639, -408}, multiset{639, -408}], "\n";
	print v63.f18, "\n";
	print |v64|, "\n";
	print v65.cf4 == map[false := 639], "\n";
	print v66[0], "\n";
	print v66[1], "\n";
	print v66[2], "\n";
	print v66[3], "\n";
	...
	print v68 == [true], "\n";
	print v69.f18, "\n";
	print v70 == map[2 := false], "\n";
	print v88, "\n";
	print v89 == map[multiset{639, 639, 639, 0, -242} := 'j'], "\n";
	print v90 == map[true := map[multiset{639, 639, 639, 0, -242} := 'j']], "\n";
	print v91[9] == [2, 2, 2, 2], "\n";
}