...
class C1 extends T2 {
	...
	method m2(p0: bool, p1: T0, p2: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		...
		f37, v2, v3[safeIndex(845, v3.Length)] := (-0x152 - |v5|) + fm4(fm19(f36, |v8|, globalState), -0x90, f36, globalState), v2, v4;
		...
		for i2 := f37 to |{v11}| {
			...
			v12[safeIndex(100, v12.Length)] := safeModuloInt(0x31c, f36);
			v12[safeIndex(100, v12.Length)] := safeModuloInt(i2, i2);
			var v13 := 'a';
			var v14: array<char> := new char[3] [v13, v13, v13];
			var v15: map<int, array<char>> := map[v12[safeIndex(100, v12.Length)] := v14];
			v15 := v15[i2 := if (p0) then v14 else v14];
			v6[safeIndex(955, v6.Length)] := f26;
			var v16 := "tniumeoec";
			var v17: map<int, multiset<int>> := map[-|v16| := v7];
			v6[safeIndex(955, v6.Length)] := v12[safeIndex(100, v12.Length)] > -|((if (f36 in v17) then v17[f36] else v7) * v7)|;
		}
		f37 := f37;
		...
		var v26: seq<multiset<D2>> := [v24, multiset(([v23])[safeIndex(-|v25|, |[v23]|) := fm20(f36, p2, f36, v9.cf17, globalState)])];
		v22[safeIndex(193, v22.Length)] := v26 + (seq(abs(0x3e), i4  => (v24)));
		var v27: map<int, multiset<D2>> := map[f37 := v24];
		var v28 := DC0(f26);
		v21, v22[safeIndex(193, v22.Length)] := v21, v26[safeIndex(-0x2cc, |v26|) := if (f37 in v27) then v27[f37] else v24] + ((v26[safeIndex(fm4(v28, f37, f36, globalState), |v26|) := v24])[safeIndex(f36, |v26[safeIndex(fm4(v28, f37, f36, globalState), |v26|) := v24]|) := v24] + [v24, v24]);
	...
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		v0[safeIndex(254, v0.Length)] := f26;
		var v1: array<int> := new int[11];
		var v2: set<bool> := {f26};
		var v3: seq<set<bool>> := [v2];
		var v4: map<int, bool> := map[|v3[safeIndex(0x352, |v3|)]| := f26];
		var v5: map<bool, int> := map[f26 := -|v4|];
		var v6: multiset<int> := multiset{if (p0 in v5) then v5[p0] else f37, f37};
		var v7 := "k";
		var v8 := 't';
		v1[safeIndex(592, v1.Length)] := if (|v7[safeIndex(561, |v7|) := v8]| in v6) then v6[|v7[safeIndex(561, |v7|) := v8]|] else fm1(globalState);
		var v9: array<char> := new char[24](i0 => v8);
		v0[safeIndex(254, v0.Length)], v1[safeIndex(592, v1.Length)], v9 := p0, f37, v9;
		var v10: multiset<bool> := multiset{p0, f27};
		var v11: seq<int> := [f37, |v7|];
		v1[safeIndex(592, v1.Length)], v1[safeIndex(592, v1.Length)], v1[safeIndex(592, v1.Length)], globalState.f22, v0[safeIndex(254, v0.Length)] := f37, |((v10 + v10) + v10)|, -0x2ce, if (if (p0) then p0 else !p0) then v11 != v11 else (if (f26 in v5) then v5[f26] else |v5|) < 349, f26;
		for i1 := f37 to v1[safeIndex(592, v1.Length)] {
			var v12 := new C0(fm21(f37, globalState) >= v10);
			var v13: set<int> := {f37, v1[safeIndex(592, v1.Length)], f36, v1[safeIndex(592, v1.Length)]};
			var v14: map<set<int>, array<bool>> := map[v13 := v0];
			v14 := v14;
			v1[safeIndex(592, v1.Length)] := i1;
			globalState.f15 := p2[safeIndex(safeDivisionInt(f37, |v2|), |p2|)];
		}
		var v15: map<set<bool>, bool> := map[v2 := !f26];
		v15 := if (p0) then map[v2 := v0[safeIndex(254, v0.Length)]] else v15;
		for i2 := v1[safeIndex(592, v1.Length)] to f37 * -v1[safeIndex(592, v1.Length)] {
			var v16 := new C0(f27);
			globalState.f12 := v1[safeIndex(592, v1.Length)] + i2;
			var v17 := DC4(v9, v1[safeIndex(592, v1.Length)], |multiset{v8, v8}|, fm22(|(seq(abs(0x158), i3  => (v8)))|, f27, globalState), seq(abs(0xd1), i4  => (v8)));
			v17 := if (f26) then v17 else DC4(v9, |v17.cf11|, f37, v7, v7);
			globalState.f15 := false;
		}
		v1[safeIndex(592, v1.Length)] := f37;
	}
}
...
class C2 extends T2 {
	...
	function fm3(p0: string, p1: seq<bool>, p2: int, globalState: GlobalState): seq<bool> {
		if ({|map[{|map[|multiset{|(set v0 : int | v0 in (seq(abs(0x225), i0  => (-|map[0x24d := true]|))) :: (safeDivisionInt(v0, |[|{false, false}|]|)))|}| := f27]|, |{true}|} := |[f26, f27, f26]|]|} == {DC1(false, f26, 0x340, f26).cf3}) then [f26, f27] else [f26, f26]
	}
	function fm4(p0: D0, p1: int, p2: int, globalState: GlobalState): int {
		|(match DC8() {
	...
	function fm1(globalState: GlobalState): int {
		|multiset{[DC19(|[f26]|, multiset{f27}, f27, map[f27 := |(seq(abs(-0x2ec), i0  => (DC12({f26}))))|]).cf36, -153]}|
	}
	function fm2(p0: bool, p1: int, globalState: GlobalState): bool {
		false
	}
	...
	method m2(p0: bool, p1: T0, p2: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		...
		var v3: seq<bool> := [p0];
		var v4: seq<seq<bool>> := [v3[safeIndex(|v3|, |v3|) := p2], v3 + v3];
		v4 := (v4 + v4) + (seq(abs(0x237), i0  => (v3)))[safeIndex(v1, |(seq(abs(0x237), i0  => (v3)))|) := v3];
		var v5: array<bool> := new bool[18];
		v5[safeIndex(800, v5.Length)] := true;
		...
		v5[safeIndex(800, v5.Length)] := if ((v7 + multiset{|v9|}) in v6) then v6[v7 + multiset{|v9|}] else f26;
		var v10 := 'p';
		var v11: map<char, char> := map[v2[safeIndex(v1, |v2|)] := v10];
		var v12: seq<map<char, char>> := [v11];
		v12 := v12;
		var v13: seq<int> := [-0x120, |v7|, 0xb4, v1, |"flhymnjo"|];
		var v15: array<seq<int>> := new seq<int>[18] [v13, seq(abs(220), i1  => (v1)), v13 + v13, v13, v13, (if (!v5[safeIndex(800, v5.Length)]) then v13 else v13)[safeIndex(v1, |(if (!v5[safeIndex(800, v5.Length)]) then v13 else v13)|) := v1], v13 + v13, seq(abs(0x29f), i2  => (|v7|)), v13, ([|v2|])[safeIndex(|(set v14 : char | v14 in v11 :: (v14))|, |[|v2|]|) := v1], v13, v13, v13, seq(abs(0x1bc), i3  => (v1)), v13, v13[safeIndex(v1, |v13|) := v1], v13, v13];
		var v16: set<int> := {|v7|};
	...
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		var v9: array<multiset<array<int>>> := new multiset<array<int>>[28] [v1, multiset{if (fm4(v4, v2, |v6|, globalState) in v3) then v3[fm4(v4, v2, |v6|, globalState)] else v0}, v1, v1, v1, v1, v1, multiset{v0, v0}, v1, v1, v1, v1[v0 := abs(892)] - v1, v1 * v1, v1, v1, v1, v1, v1 + v1, v1, v1, v1 + multiset{v0, v0, v0, v0, v0}, v1, v1 - v1, v1, v1, v1, if (--v2 in v8) then v8[--v2] else multiset{v0, v0, v0}, v1];
		v9[safeIndex(532, v9.Length)] := v1;
		v9[safeIndex(532, v9.Length)] := v1;
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			v10 := v10[f27 := v2];
			var v11 := new C0(p0);
			v0[safeIndex(433, v0.Length)] := -safeDivisionInt(-fm1(globalState), v2);
			v0[safeIndex(433, v0.Length)] := v2;
			var v12: array<int> := new int[23](i1 => safeModuloInt(i1, v0[safeIndex(433, v0.Length)]));
			var v13 := DC10(v12);
			v13 := DC10(v12);
		}
		var v14: set<int> := {v2};
		...
		match (v19) {
			...
			case DC18(cf35) =>
				...
				v25[safeIndex(648, v25.Length)] := set v26 : int | v26 in multiset(fm23(v5, globalState)) :: (safeDivisionInt(v26, |{false}|));
				v25[safeIndex(648, v25.Length)] := v14;
				globalState.f16 := -v2;
		}
	...
	method m11(p0: seq<D1>, p1: array<bool>, globalState: GlobalState) returns (r0: string) {
		...
		for i0 := |v6| to v3 {
			...
			v4[safeIndex(234, v4.Length)] := v3;
			var v13 := DC16(v1 + v1);
			var v14 := DC9(i0, i0, f27);
			var v15: multiset<set<int>> := multiset{{v3, 201}};
			globalState.f12, v4[safeIndex(234, v4.Length)], v13, globalState.f2 := i0, i0, if (v14.cf19 != v3) then v13 else DC16(v1), fm17(i0, -i0, v3, v15, globalState);
		...
		p1[safeIndex(156, p1.Length)] := v21 < multiset{|v22|, v3};
		...
		p1[safeIndex(156, p1.Length)], v24, globalState.f15, v25, v3 := f26, if (v3 in v26) then v26[v3] else multiset{true, f27}, f27 && f26, if (true) then v25 else if ({f27} in v27) then v27[{f27}] else v25, -v3;
		var v28: set<int> := {v3};
		var i4 := 0;
		while ((v3 + v3) !in v28)
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			v4[safeIndex(960, v4.Length)] := v3;
			var v29 := DC12(v22);
			var v30 := 'c';
			var v31: seq<bool> := [f26, false, true];
			var v32: map<bool, seq<bool>> := map[f26 := v31];
			globalState.f16, v4[safeIndex(960, v4.Length)], v29 := fm4(v0, |map[p1[safeIndex(156, p1.Length)] := v30]|, |v32|, globalState) - v3, v3, v29;
			var v33: C1 := new C1(v3, v3, f27, p1[safeIndex(156, p1.Length)]);
			var v34: seq<C1> := [v33, v33, v33];
			globalState.f22, v33, globalState.f22, v30 := fm22(v3, f26, globalState) <= (v1 + v1), v34[safeIndex(v3, |v34|)], v30 in v1, v30;
			var v35 := new C0(p1[safeIndex(156, p1.Length)]);
			var v36 := new C1(v33.f36, v3, v35.f32, p1[safeIndex(156, p1.Length)]);
		}
		for i5 := v3 to fm1(globalState) {
			globalState.f19 := v1[safeIndex(if (f27) then v3 else i5, |v1|)];
			var v37 := 'n';
			if (-0x11f <= |(("lbthv")[safeIndex(i5, |"lbthv"|) := v37] + v1)|) {
				...
				var v42: map<int, seq<bool>> := map[v41.f36 := [true, p1[safeIndex(156, p1.Length)]]];
				var v43: seq<bool> := [true];
				var v44: map<seq<bool>, array<bool>> := map[if (v41.f36 in v42) then v42[v41.f36] else v43 := p1];
				v44, globalState.f12 := DC21(v44).cf41 + v44, (if (f26) then i5 else v3) * safeDivisionInt(v41.f36, i5);
				var v45 := new C1(v41.f37, v41.f37 - i5, !f27, false && f26);
				var v46: map<bool, int> := map[f26 := v41.f36];
				v23 := v23[|v46| != v41.f37 := p1[safeIndex(156, p1.Length)]];
				...
				globalState.f16 := fm4(v0, |(fm3(v1, v50, |map[v3 := p1[safeIndex(156, p1.Length)]]|, globalState) + v50)|, 0x360, globalState);
				globalState.f16 := -fm4(v0, v3, 400, globalState);
				globalState.f12 := safeModuloInt(-(if (p1[safeIndex(156, p1.Length)]) then v3 else v3), |(v28 * v28)|);
				globalState.f12 := i5;
				globalState.f24 := p1[safeIndex(156, p1.Length)];
			}
			
			var v51: seq<bool> := [!false, p1[safeIndex(156, p1.Length)], true];
			var v52: map<seq<bool>, bool> := map[v51 + [p1[safeIndex(156, p1.Length)], p1[safeIndex(156, p1.Length)]] := f26];
			v52 := v52;
			v51 := [f27] + (v51 + [!f26]);
		}
		r0 := "bmiwf";
	...
	method m12(p0: int, p1: int, globalState: GlobalState) {
		...
		var v6 := "adlk";
		for i1 := |v6| to safeDivisionInt(v1.f37, -|v3|) {
			globalState.f12 := i1;
			var v7: array<int> := new int[12](i2 => safeDivisionInt(i2, v1.f36));
			v7[safeIndex(313, v7.Length)] := v1.f37;
			var v8 := 's';
			var v9: seq<array<bool>> := [v2, v2];
			globalState.f6, v7[safeIndex(313, v7.Length)], globalState.f22, globalState.f24, globalState.f2 := v6[safeIndex(|v3|, |v6|) := v8], --|v9|, f26, f27, !v1.fm2(f26, if (true) then v1.f37 else v1.f37, globalState);
			...
			globalState.f22, globalState.f5 := f27 <==> f26, v12[safeIndex(v1.f36, |v12|)];
		}
		v2[safeIndex(575, v2.Length)] := f27;
		v2[safeIndex(575, v2.Length)] := ((seq(abs(0x32f), i3  => ('r'))) + v6) < v6;
		globalState.f16 := -p0;
		v1.f37 := |(v6 + v6)|;
	}
}
...
class C3 extends T1 {
	...
	function fm12(p0: int, globalState: GlobalState): int {
		(if (f27) then 84 else 719) + safeModuloInt(|[f26]|, 676)
	}
	function fm13(p0: seq<multiset<char>>, p1: char, p2: int, globalState: GlobalState): int {
		|(seq(abs(0x6d), i0  => (|DC16("r").cf29|)))| - (|map[f27 := map[956 := f26]]| * -|map[false := 'k']|)
	}
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		v3[safeIndex(142, v3.Length)] := v0;
		var v4: seq<array<int>> := [v0, v0];
		v3[safeIndex(142, v3.Length)] := v4[safeIndex(0x396, |v4|)];
		...
		for i0 := -(if (v1 in v14) then v14[v1] else v1) to v1 {
			...
			v21[safeIndex(318, v21.Length)] := map[v19 := 196];
			v21[safeIndex(318, v21.Length)] := map[v19 := i0] + (v20 + v20);
		}
	}
}
...
class C4 extends T1 {
	...
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		for i0 := v0 to v0 {
			if (true) {
				...
				v11 := map[v8 := if (v9.f32 in v12) then v12[v9.f32] else f27] + (v13[safeIndex(i0, |v13|)] + (map v14 : D1 | v14 in v15 :: (v14) := (v9.f32)));
			...
			var v28: array<int> := new int[14] [i0 * |"yghsv"|, |(map[v20 := |v23|] + map[v20 := i0])|, v0, v0, -v0, -i0, i0, |(v24 + v24)|, |map[seq(abs(546), i3  => (v0)) := v27]|, i0, v0, i0, i0, v0];
			var v29 := DC10(v28);
			v20 := v29.cf21;
			var v30 := DC19(i0, multiset{!p0, f26}, false, map[false := v0]);
			var v31: multiset<bool> := multiset{v27.f27};
			var v32: array<D7> := new D7[12] [if (f27) then v30 else v30, v30.(cf37 := v31, cf38 := f26, cf36 := |(seq(abs(0xe6), i4  => (v21)))|), v30, v30, v30, v30, v30, v30, v30, v30, if (p0) then v30 else v30, v30];
			var v33: map<bool, int> := map[v27.f26 := 0x27d];
			v32[safeIndex(896, v32.Length)] := DC19(v0, v31, p0, v33);
			v32[safeIndex(896, v32.Length)] := v30;
			var v34: array<bool> := new bool[4] [v27.f26, v27.f27, false, v27.f26];
			v34[safeIndex(510, v34.Length)] := if (true) then v27.fm2(v27.f26, i0, globalState) else v27.f27;
			...
			v34[safeIndex(510, v34.Length)], globalState.f6, globalState.f12, globalState.f22 := (v0 != i0) ==> f26, "fxf", safeModuloInt(v0, v0), (v0 != (if (v36 in v38) then v38[v36] else v25[safeIndex(i0, |v25|)])) || (i0 <= v0);
		}
		var v39 := 'q';
		...
		var v47 := "baa";
		var v48 := DC4(v41, v0, if (v46 in v45) then v45[v46] else v0, v47, v47[safeIndex(-|map[v0 := v0]|, |v47|) := v39]);
		match (v48) {
			case DC4(cf7, cf8, cf9, cf10, cf11) =>
				var v49: seq<int> := [v0, cf8, cf9];
				var v50: seq<seq<int>> := [v49, v49, v49[safeIndex(|v49|, |v49|) := cf8], [v0], v49];
				var v51: C2 := new C2(v50, false, f26);
				var v52: seq<C2> := [v51];
				globalState.f12 := if (f26) then safeDivisionInt(|p2[safeIndex(-fm1(globalState), |p2|) := !f26]|, cf9) else |(v52 + v52)|;
				...
				if (!f27) {
					...
					v55[safeIndex(59, v55.Length)] := fm15(globalState) + (seq(abs(0xbf), i5  => (cf8)));
					cf9, globalState.f15, globalState.f6, v55[safeIndex(59, v55.Length)] := -v51.fm4(v54, cf9, v0, globalState), p2[safeIndex(v0, |p2|)], cf10, fm23(v39, globalState);
					globalState.f19 := v39;
					globalState.f6 := v47[safeIndex(-v0, |v47|) := v39] + (seq(abs(472), i6  => (v39)));
					...
					var v61: array<array<char>> := new array<char>[15] [v41, cf7, cf7, cf7, cf7, v41, v41, cf7, v41, cf7, if (true) then cf7 else v41, cf7, if (true in v59) then v59[true] else cf7, cf7, v60[safeIndex(-0x217, |v60|)]];
					v61[safeIndex(966, v61.Length)] := v41;
					v57, v58, v61[safeIndex(966, v61.Length)] := if (p0) then v57 else v57, v58, v41;
					...
					var v66: array<int> := new int[12] [cf8, v63.cf18, |v64|, -cf9, |multiset{f27, p0, p0, false}|, v0, cf8, cf8, |cf11|, v0, |(p2 + v65[safeIndex(v51.fm1(globalState), |v65|)])|, v0];
					v66[safeIndex(232, v66.Length)] := v0 * cf9;
					globalState.f16, v66, globalState.f15, globalState.f2, v66[safeIndex(232, v66.Length)] := cf9, v66, !(if (f26) then p0 else if (cf8 in v42) then v42[cf8] else p0) ==> (-cf9 < cf8), p0, safeModuloInt(cf9, v0);
					var v67: seq<bool> := [p0];
					v67 := v67;
					var v68 := DC19(v0, v64[f27 := abs(cf9)], f26, map[p0 := cf9]);
					...
					v71[safeIndex(0, v71.Length)] := false;
					var v72: map<bool, int> := map[f27 := v66[safeIndex(232, v66.Length)]];
					globalState.f22, globalState.f16, globalState.f19, v71[safeIndex(0, v71.Length)] := p0, fm1(globalState), v39, (if (v51.fm2(!f27, v66[safeIndex(232, v66.Length)], globalState)) then p0 else f27) || (|v72| != v0);
				}
			...
			case DC5(cf12) =>
				if (f26) {
					...
					var v76: C3 := new C3(v75, p2[safeIndex(cf12, |p2|)], f27);
					var v77: seq<int> := [cf12, v0];
					var v78: map<int, int> := map[|(seq(abs(-0x3cb), i7  => (|[v0, v0, -v0]|)))| := v77[safeIndex(v76.fm12(|v47|, globalState), |v77|)]];
					var v79: map<C3, int> := map[v76 := |v78|];
					var v80: map<map<C3, int>, char> := map[v79 := v39];
					var v81: map<int, map<int, int>> := map[v0 := v78];
					var v82: array<seq<bool>> := new seq<bool>[19] [p2 + p2[safeIndex(cf12, |p2|) := f26], p2, [!p0], p2, fm25(true, f26, v39, globalState), p2, p2, p2 + p2, fm25(f27, f26, if (v79 in v80) then v80[v79] else v39, globalState), p2, p2, p2, (if (f26) then p2 else [false])[safeIndex(|map[v76.fm12(cf12, globalState) := if (|multiset(fm15(globalState))| in v81) then v81[|multiset(fm15(globalState))|] else map[cf12 := v0]]|, |(if (f26) then p2 else [false])|) := f27], p2, p2, p2[safeIndex(cf12, |p2|) := f27], p2, p2, fm25(f26, f27, v39, globalState)];
					v82[safeIndex(171, v82.Length)] := p2;
					v82[safeIndex(171, v82.Length)] := p2;
					var v83: array<int> := new int[20];
					var v84 := DC10(v83);
					var v85: seq<array<int>> := [v84.cf21];
					var v86 := DC9(0x79, v0, false);
					var v87: array<array<int>> := new array<int>[27] [v83, v85[safeIndex(v0, |v85|)], v83, v83, v83, v83, v83, v83, v83, v83, v83, if (v86.cf20) then v83 else v83, v83, v83, v83, v83, if (f26) then v83 else v83, v83, v83, v83, v83, v83, v83, v84.cf21, v83, v83, v83];
					v87 := v87;
					var v88: multiset<bool> := multiset{f27, f27};
					var v89: array<bool> := new bool[25] [!p0 <== !!p0, f27, f26, p0, !p0, p0, f27, f26, p0, false, f27, f27, f27, !(v88 !! multiset{fm2(p0, v0, globalState)}), p0, f26, p0, p0, !f26, f27, f27, f27, p0 && false, f27, |v82[safeIndex(171, v82.Length)]| < v0];
					v89[safeIndex(422, v89.Length)] := fm2(p0, -cf12, globalState);
					v89[safeIndex(422, v89.Length)] := p0;
					var v90: seq<seq<bool>> := [[fm2(p0, v0, globalState), v89[safeIndex(422, v89.Length)]], p2, v82[safeIndex(171, v82.Length)]];
					var v91: array<map<int, char>> := new map<int, char>[9];
					v91[safeIndex(651, v91.Length)] := v73;
					v90, v89[safeIndex(422, v89.Length)], globalState.f12, v91[safeIndex(651, v91.Length)] := v90, true, if (cf12 in v78) then v78[cf12] else 953, v73;
				} else {
					var v92: map<bool, int> := map[true := v0];
					var v93: seq<map<bool, int>> := [v92];
					var v94: array<bool> := new bool[26] [f27, p0, v47[safeIndex(cf12, |v47|) := 'e'] < "urnk", p0 ==> fm2(f27, v0, globalState), f27, fm2(p0, cf12, globalState), f27, !f27, !DC14(v0, cf12, f26).cf27, p0, -cf12 >= |p2|, p0, f26, f27, p0, p0, f26, f27, p2[safeIndex(v0, |p2|)], f26, p0, f26, true, p0, f27, v93 != v93];
					v94[safeIndex(26, v94.Length)] := p2[safeIndex(v0, |p2|)];
					v94[safeIndex(26, v94.Length)] := f27;
					var v95: array<int> := new int[8];
					var v96: map<array<int>, bool> := map[v95 := v94[safeIndex(26, v94.Length)]];
					globalState.f22 := |(v96 + map[v95 := p0])| < cf12;
					var v97 := new C1(safeModuloInt(|v47[safeIndex(v0, |v47|) := v39]|, v0), fm1(globalState), v94[safeIndex(26, v94.Length)], f27);
					var v98 := DC11(v39);
					var v99: seq<int> := [|v40|, v97.f36];
					var v100: map<array<bool>, bool> := map[v94 := fm23(v98.cf22, globalState) <= v99];
					v100 := v100[v94 := !false];
					var v101: T2 := new C1(|[false, f26]|, v97.f37, v94[safeIndex(26, v94.Length)], p0);
					var v102 := DC18(v101);
					v95[safeIndex(63, v95.Length)] := v0;
					v102, v95[safeIndex(63, v95.Length)], v94[safeIndex(26, v94.Length)], globalState.f2, v101 := v102, v97.f37, f26, [v0] < v99, v101;
				}
				...
				if (!(true ==> p0)) {
					...
					v103[safeIndex(369, v103.Length)] := fm26(fm2(f26, cf12, globalState), p0, p0, globalState);
					var v104: map<int, int> := map[v0 := cf12];
					var v105: multiset<map<int, int>> := multiset{map[cf12 := v0], v104 + map[-0x105 := cf12], v104};
					v103[safeIndex(369, v103.Length)] := v105;
				} else {
					...
					v107[safeIndex(74, v107.Length)] := p2;
					v0, globalState.f24, v107[safeIndex(74, v107.Length)] := cf12, cf12 != v0, (if (true) then p2 else p2) + p2;
					var v108 := DC8();
					var v109: set<D2> := {v108};
					v109 := v109;
					globalState.f15 := f26;
					var v110: array<bool> := new bool[17](i10 => p0);
					var v111: map<seq<bool>, array<bool>> := map[v107[safeIndex(74, v107.Length)] := v110];
					var v112 := DC21(v111);
				...
				globalState.f15, v115, globalState.f12, v116 := f27 && f26, v115, -safeDivisionInt((v44.(cf16 := |v117|, cf15 := p0)).cf17, v118[safeIndex(-0x114, |v118|)]), v116;
			...
			case DC3(cf6) =>
				...
				if (if (!f26) then if (p0) then false else fm2(f26, v0, globalState) else p0) {
					...
					globalState.f5 := v129;
					v127[safeIndex(492, v127.Length)] := p0;
					globalState.f19, v127[safeIndex(492, v127.Length)], globalState.f12, v122, globalState.f15 := v121, !p0, v0 * -v0, v122 + (p2 + v122), f26;
				} else {
					...
					v132[safeIndex(305, v132.Length)] := v0;
					v132[safeIndex(305, v132.Length)] := -(v0 + v0);
					globalState.f24 := false;
					var v133 := DC19(v0, fm21(v132[safeIndex(305, v132.Length)], globalState), true, map[f27 := v0]);
			...
			decreases 100 - i13
		{
			...
			i13 := i13 + 1;
			globalState.f12 := v0;
			globalState.f12 := safeDivisionInt(safeModuloInt(v0, v0), |(if (f27) then p2 else p2)|);
			var v138: array<int> := new int[18];
			var v139: seq<array<int>> := [v138];
			globalState.f12, globalState.f15 := safeDivisionInt(v0, -0x158), f27 && (v139 == v139);
			var v140 := DC14(0x323, v0, f27);
			var v141: seq<int> := [v140.cf26, fm1(globalState)];
			v0 := v141[safeIndex(0x123, |v141|)];
		}
		var v142: array<bool> := new bool[14];
		v142[safeIndex(866, v142.Length)] := f27;
		v142[safeIndex(866, v142.Length)] := v0 >= v0;
		globalState.f6, globalState.f16, v142[safeIndex(866, v142.Length)], globalState.f24 := v47, v0 - safeDivisionInt(-402, |v40|), p0, !f26;
	}
	method m9(p0: bool, p1: array<bool>, p2: map<bool, bool>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: bool) {
		...
		v7[safeIndex(644, v7.Length)] := p1;
		v0[safeIndex(584, v0.Length)], v6, v7[safeIndex(644, v7.Length)] := v3, v6, p1;
		v1 := v1;
		globalState.f2 := p0;
		r0 := f26;
		...
		v8[safeIndex(34, v8.Length)] := if (v1 in v10) then v10[v1] else v9;
		var v11: array<int> := new int[23];
		p1[safeIndex(427, p1.Length)] := f27;
		v8[safeIndex(34, v8.Length)], v11, p1[safeIndex(427, p1.Length)], v7[safeIndex(644, v7.Length)] := v9, v11, p0, p1;
		p1[safeIndex(427, p1.Length)] := !f27;
		var v12 := 'e';
		var v13: map<int, char> := map[v1 := v12];
		var v14: set<map<int, char>> := {v13};
		r0 := !(v14 >= (v14 - (set v15 : map<int, char> | v15 in v14 :: (v15))));
		r1 := !((seq(abs(0x212), i0  => (-v1))) != v4);
		var v16 := DC22(f27);
		r2 := if (v16.cf42) then -v1 else |fm15(globalState)|;
		var v17 := DC8();
		r3 := match v17 {
			case DC7(cf14, cf15, cf16, cf17) => p1[safeIndex(427, p1.Length)]
			case DC8() => p1[safeIndex(427, p1.Length)]
			case DC9(cf18, cf19, cf20) => if (v6[safeIndex(cf18, |v6|)] in p2) then p2[v6[safeIndex(cf18, |v6|)]] else DC14(0x2f0, 0x1cf, cf20).cf27
	...
	method m10(p0: bool, p1: int, p2: map<int, seq<int>>, globalState: GlobalState) returns (r0: int, r1: int, r2: int, r3: char) {
		...
		for i0 := |v0| to |(v1 + v1)| {
			...
			v2[safeIndex(649, v2.Length)] := [v1] + [v1];
			var v3: seq<seq<bool>> := [v1, v1];
			v2[safeIndex(649, v2.Length)] := v3 + [[p0], v1];
			var v4 := "usmgaxt";
			var v5: multiset<int> := multiset{|(seq(abs(0x202), i2  => (p1)))|, 123, p1, i0, |(seq(abs(0x376), i3  => ('j')))|};
			var v6: set<int> := {p1, |v5|};
			var v7: map<set<int>, bool> := map[v6 := f27];
			var v8: seq<int> := [-0xfc, |v6|];
			var v9: multiset<bool> := multiset{f26};
			var v10: array<int> := new int[20] [|fm29(false, i0, globalState)|, safeDivisionInt(|fm22(|v4|, v1[safeIndex(p1, |v1|)], globalState)|, i0), |v6|, |(v6 - v6)|, i0, p1 - p1, -|(v7 + v7)|, safeDivisionInt(p1, i0), i0 + p1, safeDivisionInt(|fm30(i0, p0, globalState)|, |v1|), i0, fm1(globalState), i0, i0, -(if (f27) then p1 else i0), p1, safeModuloInt(i0, v8[safeIndex(i0, |v8|)]), p1, |v4|, |v9|];
			v10[safeIndex(625, v10.Length)] := p1;
			v10[safeIndex(625, v10.Length)] := p1 - i0;
			var v11 := new C1(fm1(globalState), |v1|, f26, p0);
			v11.f37 := |(v9 - v9)|;
		}
		var v12: multiset<bool> := multiset{f26, f27, fm2(f27, p1, globalState)};
		globalState.f22 := v1[safeIndex(|v12|, |v1|)];
		var v13: array<seq<int>> := new seq<int>[13](i4 => [-DC14(p1, |[-0x156, |(seq(abs(671), i5  => ('k')))|]|, p0).cf26]);
		v13 := v13;
		var v14 := "vgkdg";
		...
		if (|v14| !in (if (p0) then map v15 : int | (-648 <= v15) && (v15 < 0x207) :: (v15 * p1) := ({f26}) else v16)) {
			...
			v17[safeIndex(104, v17.Length)] := f26;
			v17[safeIndex(104, v17.Length)] := !true;
			var v18: seq<seq<bool>> := [v1];
			v18 := v18;
			var v19: C0 := new C0(f27);
			var v20: map<string, C0> := map["ettqukfnq" := v19];
			var v21: array<C0> := new C0[16] [v19, v19, v19, v19, v19, v19, v19, v19, v19, if (v17[safeIndex(104, v17.Length)]) then v19 else v19, v19, v19, if (v14 in v20) then v20[v14] else v19, v19, v19, v19];
			v21[safeIndex(78, v21.Length)] := v19;
			v21[safeIndex(78, v21.Length)] := v19;
			var v22: array<C3> := new C3[4];
			var v23: seq<int> := [p1, p1];
			var v24: multiset<seq<int>> := multiset{v23, v23, v23};
			var v25: C3 := new C3(v24, v17[safeIndex(104, v17.Length)], f26);
			v22[safeIndex(905, v22.Length)] := v25;
			v22[safeIndex(905, v22.Length)] := v25;
			...
			r2, r2, globalState.f22, r2, v13 := p1, |(v1 + (v1 + v1))|, f26, if (false) then p1 else if (p1 in v28) then v28[p1] else p1, v29[safeIndex(fm1(globalState), |v29|)];
			...
			if (DC14(v38.f37, |v12|, v41).cf27) {
				...
				v47 := new C2(seq(abs(-0x78), i6  => (v43)), v14 <= v14, v47.f26);
				v30 := v30;
				...
				v53 := v53[v52 := v33];
				r0 := safeDivisionInt(if (v41) then v38.f36 else |v47.fm3(v14, v1, v38.f36, globalState)|, v38.f36);
			} else {
				var v54: array<int> := new int[7] [safeDivisionInt(v38.f36, v38.f37), v38.f36, v38.f37, p1, v38.f37, v38.f36, v38.f37 + v38.f36];
				var v55: array<array<int>> := new array<int>[4] [v54, v54, v54, v54];
				globalState.f2, v54, v38.f37, v55 := v35, v54, 0x59, v55;
				var v56 := DC0(f26);
				globalState.f12 := v38.fm4(v56, -(v38.f36 * v38.f37), safeDivisionInt(v38.f37, v38.f36), globalState);
				globalState.f22 := !true;
				var v57: array<char> := new char[3];
				var v58: array<C1> := new C1[5] [v38, v38, v38, v38, v38];
				v58[safeIndex(832, v58.Length)] := v38;
				v57, globalState.f22, globalState.f16, globalState.f16, v58[safeIndex(832, v58.Length)] := v57, f27, 826 * v38.f36, v38.f36, v38;
				globalState.f22 := f26;
			}
...
class C5 extends T1 {
	...
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		match (v9) {
			case DC7(cf14, cf15, cf16, cf17) =>
				...
				var v11 := "m";
				v10[safeIndex(397, v10.Length)] := v11;
				v10[safeIndex(397, v10.Length)] := v11 + v11;
				globalState.f22 := fm2(cf14, -v4, globalState);
				var v12: array<bool> := new bool[20];
				v12[safeIndex(461, v12.Length)] := v10[safeIndex(397, v10.Length)] <= v10[safeIndex(397, v10.Length)];
				v12[safeIndex(461, v12.Length)] := false;
				globalState.f2 := f27;
			case DC8() =>
				...
				var v19 := "sksvlyg";
				globalState.f6 := v19[safeIndex(v4, |v19|) := v16] + v19;
			...
			case DC9(cf18, cf19, cf20) =>
				...
				var v25 := 'l';
				var v26: map<string, char> := map[v21[safeIndex(if (fm1(globalState) in v24) then v24[fm1(globalState)] else cf19, |v21|) := v25] := v25];
				v26 := v26["ja" := v25];
				globalState.f16 := v4;
				...
				cf18 := |v28|;
			case DC6(cf13) =>
				globalState.f16 := |(seq(abs(0x217), i0  => ('g')))|;
				var v29 := "cc";
				var v30: map<bool, int> := map[v8.f32 := v4];
				var v31: seq<int> := [v4, v4, v4];
				var v32: map<int, bool> := map[v4 := v8.f32];
				var v33 := DC5(v4);
				var v34: array<int> := new int[21] [v4, 41, v4, v4, v4, v4, v4, 0x377, v4, v4, |v29|, v4, v4, v4, if (v0.f32 in v30) then v30[v0.f32] else v4, v4, v31[safeIndex(v4, |v31|)], |v29|, v4, |v32|, v33.cf12];
				var v35 := DC10(v34);
				...
				var v38: multiset<bool> := multiset{p0, v0.fm6('j', v8.f32, globalState), v0.f32, p2[safeIndex(|v37[v29 := v4]|, |p2|)], v8.f32};
				...
				if (f26) {
					...
					v45[safeIndex(752, v45.Length)] := f26;
					var v46 := DC0(v0.f32);
					v45[safeIndex(752, v45.Length)], globalState.f24 := !p0, if (v46.cf0) then v0.f32 else !f27;
					v34 := v34;
					globalState.f12 := safeModuloInt(-v4, v4);
				} else {
					var v47: array<bool> := new bool[14];
					v47[safeIndex(358, v47.Length)] := v39 < v39;
					var v48 := 'd';
					v47[safeIndex(358, v47.Length)] := v8.fm6(v48, v8.f32, globalState);
					var v49 := DC8();
					v49, globalState.f24 := v49, true;
					var v50 := DC0(true);
					var v51 := m8(v50, f27, (multiset{v0.f32})[v0.f32 := abs(v4)], v4, globalState);
					v34[safeIndex(616, v34.Length)] := v4;
					v34[safeIndex(616, v34.Length)] := (if (v47[safeIndex(358, v47.Length)]) then v4 else v4) - |v29|;
					v48 := v48;
				}
		...
		match (v53.(cf6 := p2[safeIndex(v4, |p2|) := v0.f32])) {
			case DC4(cf7, cf8, cf9, cf10, cf11) =>
				...
				match (v59) {
					case DC7(cf14, cf15, cf16, cf17) =>
						var v60: array<int> := new int[18](i1 => safeModuloInt(i1, |p2|));
						var v61: map<array<int>, int> := map[v60 := fm1(globalState)];
						v61 := v61[v60 := cf17 - |cf10|];
						globalState.f6 := (seq(abs(45), i2  => (v52))) + cf11;
						v8 := v8;
						globalState.f6 := seq(abs(0x33e), i3  => (v52));
					case DC8() =>
						var v62: seq<int> := [|(multiset{v52})[v52 := abs(0xcc)]|];
						var v63: array<bool> := new bool[23];
						var v64: map<array<bool>, seq<int>> := map[v63 := v62[safeIndex(v4, |v62|) := cf9]];
						...
						v66 := v66[v4 := ((seq(abs(0x32e), i4  => (cf9))) + v62)[safeIndex(v4, |((seq(abs(0x32e), i4  => (cf9))) + v62)|) := v4]];
						var v67: map<int, int> := map[v4 := cf8];
						v67 := v67[-0x3b0 := v4];
						globalState.f2 := v0.f32;
					case DC9(cf18, cf19, cf20) =>
						globalState.f2 := (cf18 < cf8) <== cf20;
						cf7[safeIndex(114, cf7.Length)] := if (v8.f32) then v52 else v52;
						var v68: map<bool, bool> := map[cf20 := v0.f32];
						var v69: multiset<int> := multiset{v4, -(cf8 - v4), -(if (false) then |v68| else cf18), cf9 * 194};
						cf7[safeIndex(114, cf7.Length)], v69, globalState.f12 := v52, (v69 * v69) + (v69 * multiset{|map[v4 := p0]|}), cf18;
						var v70: array<int> := new int[1](i5 => safeDivisionInt(i5, v4));
						var v71 := DC10(v70);
			...
			case DC5(cf12) =>
				...
				match (v81) {
					case DC14(cf25, cf26, cf27) =>
						...
						v82[safeIndex(247, v82.Length)] := DC8();
						var v83: seq<char> := [v52];
						var v84: set<bool> := {p0, false};
						var v85: map<seq<char>, int> := map[v83 := |v84|];
						v82[safeIndex(247, v82.Length)] := fm33(-(if (f26) then 743 else cf25), |(v85 + v85[v83 := cf12])|, globalState);
					...
					case DC13(cf24) =>
						...
						v86[safeIndex(522, v86.Length)] := v88;
						v86[safeIndex(522, v86.Length)] := v88;
						var v89: array<int> := new int[12];
						v89 := v89;
						cf12 := v4;
						var v90 := "priuoxrge";
						var v91: multiset<string> := multiset{p1[safeIndex(v4, |p1|)], v90};
						v91 := v91;
					case DC15(cf28) =>
						...
						var v96 := "dq";
						var v97: seq<int> := [|v96|];
						var v98: set<bool> := {v0.f32, f26, false, 609 == |v92[p2 := abs(if (v93 in v94) then v94[v93] else v4)]|, v0.fm7(v95, v97, fm2(f26, -|v96|, globalState), globalState)};
						v98, v9, v97 := v98, v9, v97;
						var v99: multiset<seq<int>> := multiset{v97, v97, v97};
						var v100 := new C3(v99[v97 := abs(v4)], v4 <= cf12, v8.f32 <==> !v8.f32);
				...
				match (DC3([true, f26, v0.f32])) {
					case DC4(cf7, cf8, cf9, cf10, cf11) =>
						...
						var v108: multiset<seq<int>> := multiset{seq(abs(231), i8  => (v4))};
						var v109: C3 := new C3(v108, v8.f32, !p0);
						var v110: map<bool, C3> := map[{|v105|, cf8} <= v107 := v109];
						v110 := v110;
						globalState.f22 := !(|(cf11 + cf11)| == (if (v8.f32) then -|(seq(abs(0x4d), i9  => (v52)))| else v4));
						var v111: array<seq<bool>> := new seq<bool>[17](i10 => p2 + [v0.f32, f27]);
						v111[safeIndex(267, v111.Length)] := p2 + p2;
						v111[safeIndex(267, v111.Length)] := p2;
						var v112: map<string, int> := map[seq(abs(0x78), i11  => (v52)) := cf8];
					...
					case DC5(cf12) =>
						...
						var v117: map<seq<int>, seq<D2>> := map[v113[safeIndex(|v115|, |v113|) := cf12] := v116];
						var v118: map<bool, map<seq<int>, seq<D2>>> := map[v8.f32 := map[v113 := v116]];
						var v119 := DC23(map[v113 := v116]);
						var v120: array<map<seq<int>, seq<D2>>> := new map<seq<int>, seq<D2>>[23] [v117, if (true in v118) then v118[true] else v117, v117, v117, v117, v117, v117[fm15(globalState) := [v7]], v117 + v117, (fm34(globalState))[[v4] := v116], v117 + v117, v117, map[v113 := v116], v117, v117[v113 := seq(abs(0x2d1), i12  => (v7))], v117, v119.cf43, v117, v117, map[seq(abs(0x37c), i13  => (cf12)) := v116], v117 + v117, v117[[cf12] := v116], v117, v117 + v117];
						v120[safeIndex(891, v120.Length)] := map[v113 := v116];
						var v122: map<seq<int>, int> := map[v113 := v4];
						v120[safeIndex(891, v120.Length)] := (v117 + (map v121 : seq<int> | v121 in v122 :: (v121) := (v116))[[cf12] := v116]) + v117;
					...
					case DC3(cf6) =>
						...
						var v129: array<int> := new int[15] [v126[safeIndex(cf12, |v126|)], -cf12, -v4, fm1(globalState), cf12, |v127|, 0x2ba, v4, |v128|, v4, cf12, -v4, cf12, v4, cf12];
				...
				if (v8.f32) {
					...
					var v145: array<int> := new int[24] [cf12, |v136|, v4 * v4, |(if (255 in v138) then v138[255] else {v8.f32})|, |(set v139 : int | (158 <= v139) && (v139 < 0x2ea) :: (safeModuloInt(v139, |(seq(abs(0x35a), i14  => (-|"cuhflyu"|)))|)))|, -v4, cf12, v4, cf12, cf12, v4, v4 - v4, v4, safeDivisionInt(cf12, cf12), cf12, cf12, cf12 - |v143|, cf12, |v144|, v4, |v142|, v4, fm1(globalState) * v4, -v4 * cf12];
					v145[safeIndex(854, v145.Length)] := cf12;
					v145[safeIndex(854, v145.Length)] := if (!(f27 <==> f27)) then |v134| else v4;
					globalState.f16 := v4;
					var v146: map<bool, int> := map[v0.f32 := cf12];
					var v147 := DC14(v145[safeIndex(854, v145.Length)], cf12, !v0.f32);
					var v148: seq<D5> := [v147, v147];
					var v149: map<bool, bool> := map[v0.f32 := v8.f32];
					var v150: seq<bool> := [(fm35(if (v0.f32 in v146) then v146[v0.f32] else v145[safeIndex(854, v145.Length)], globalState))[safeIndex(v4, |fm35(if (v0.f32 in v146) then v146[v0.f32] else v145[safeIndex(854, v145.Length)], globalState)|) := v147] == v148, v149 != map[f27 := v0.f32], v8.f32, v8.f32];
					v150 := p2 + ([v0.f32, v8.f32] + v53.cf6);
					var v151: multiset<string> := multiset{v134};
					v145[safeIndex(854, v145.Length)] := if (v134 in v151) then v151[v134] else v145[safeIndex(854, v145.Length)];
					var v152 := new C1(-v145[safeIndex(854, v145.Length)], cf12, v0.f32, f27);
				} else {
					cf12 := -safeDivisionInt(cf12, cf12);
					var v153: multiset<int> := multiset{0x36e, v4};
					var v154 := m8(DC0(v0.f32), v8.f32, multiset{v0.f32, v0.f32, p0}, safeModuloInt(cf12, |v153[cf12 := abs(v4)]|), globalState);
					...
					v159[safeIndex(780, v159.Length)] := v162[safeIndex(cf12, |v162|)] + v161;
					var v163 := DC13(v80[f26 := [v0.f32]]);
					var v164 := DC15(v163);
					var v165 := DC15(DC15(v164));
					var v166 := DC15(v164);
					var v167: array<D5> := new D5[6] [DC15(v163), v166, v166, v166, v166, v166];
					v159[safeIndex(780, v159.Length)], v154, v167, globalState.f2 := (map v168 : int | v168 in v7.cf13 :: (v168 + 0x2d5) := (v160)) + (v161 + map[-v4 := v160]), p0, v167, !v0.f32;
				}
				...
				if (f26) {
					...
					var v172 := DC0(f27);
					v171[safeIndex(95, v171.Length)] := v172;
					var v173: map<bool, bool> := map[f27 := v8.f32];
					v171[safeIndex(95, v171.Length)], globalState.f16 := DC0(if (v8.f32 in v173) then v173[v8.f32] else v0.f32), v4;
					var v174: seq<int> := [cf12, v4];
					var v175 := DC20(v174);
					var v176: seq<D8> := [v175, v175];
					var v177 := "iywdtfdjg";
					var v178 := DC17(cf12, cf12, v4, |v177[safeIndex(-0x4b, |v177|) := v52]|, v4);
					...
					v186[safeIndex(947, v186.Length)] := v8.f32;
					v186[safeIndex(947, v186.Length)] := !v0.f32;
					...
					var v191: T2 := new C2(v190, v0.f32, p2[safeIndex(v4, |p2|)]);
					var v192 := DC18(v191);
					var v193: multiset<D7> := multiset{v192};
					var v194: seq<multiset<D7>> := [v193];
					var v195: seq<D7> := [v192, v192];
					globalState.f24 := !(v194[safeIndex(38, |v194|)] >= (multiset(v195))[v192 := abs(cf12)]);
					...
					v197[safeIndex(581, v197.Length)] := cf12;
					v197[safeIndex(581, v197.Length)] := cf12;
			...
			case DC3(cf6) =>
				...
				globalState.f15 := if (f27 in v199) then v199[f27] else p2[safeIndex(0x1c2, |p2|)];
				var v200: map<bool, int> := map[v8.f32 := v4];
				var v201: seq<int> := [v4];
				var v202: map<bool, map<int, int>> := map[v0.fm7(v200, v201, p2[safeIndex(v4, |p2|)], globalState) := map[v4 := -0x2d]];
				...
				var v214: array<int> := new int[29] [v4, -0x368, v4, |(v202 + map[v0.f32 := v203])|, v4, -0x22d, safeDivisionInt(-248, v4), v4, v4, -|(if (f26) then v205[safeIndex(|v199|, |v205|) := v52] else v205)|, -v4 - v4, 0x162 - v201[safeIndex(v4, |v201|)], -safeDivisionInt(v4, |v206|), v4, |v205[safeIndex(v4, |v205|) := v52]|, 0x352, 0x3ae, v4, v4, -|(v212 + v212)|, v4, |v213|, if (v8.f32) then 0xc4 else 0x298, safeModuloInt(v4, v4), v4, v4, v4, v4, 0x1e0];
				v214 := v209;
				v212 := v212;
				var v215: array<seq<bool>> := new seq<bool>[8](i17 => [f26, f27]);
				v215[safeIndex(769, v215.Length)] := cf6;
				v215[safeIndex(769, v215.Length)] := p2 + cf6;
		}
	...
	method m7(p0: bool, p1: bool, p2: int, p3: multiset<int>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3 := "jn";
			var v4: set<string> := {(seq(abs(0x339), i1  => ('c'))) + "yknlqwi", v3};
			v0.f37 := |v4|;
			var v5: seq<string> := [v3];
			v5 := ((v5 + (seq(abs(0x14a), i2  => (v3)))) + v5)[safeIndex(v0.f37, |((v5 + (seq(abs(0x14a), i2  => (v3)))) + v5)|) := v3];
			var v6: array<array<map<T0, bool>>> := new array<map<T0, bool>>[5];
			var v7: array<map<T0, bool>> := new map<T0, bool>[26];
			v6[safeIndex(961, v6.Length)] := v7;
			v6[safeIndex(961, v6.Length)] := v7;
		}
		var v8: array<bool> := new bool[6](i3 => f26);
		v8[safeIndex(477, v8.Length)] := f26;
		var v9: array<int> := new int[4];
		v8[safeIndex(234, v8.Length)] := f26;
		var v10: seq<int> := [p2];
		var v11: multiset<seq<int>> := multiset{v10, (seq(abs(-0x18c), i4  => (p2)))[safeIndex(p2, |(seq(abs(-0x18c), i4  => (p2)))|) := p2]};
		globalState.f15, v8[safeIndex(477, v8.Length)], v9, v8[safeIndex(234, v8.Length)], globalState.f2 := false, f27, v9, p1, v11 >= (v11 + v11);
		for i5 := safeDivisionInt(-fm1(globalState), p2) to p2 {
			globalState.f12 := p2;
			var v12: map<bool, int> := map[fm2(v8[safeIndex(477, v8.Length)], fm1(globalState), globalState) := p2];
			globalState.f16 := if (i5 <= p2) then |(seq(abs(0x1cf), i6  => ('i')))| + |v12| else 0x377;
			var v13: seq<bool> := [!p1, f26];
			globalState.f15 := if (!!true) then v13[safeIndex(p2, |v13|)] else p0;
			if (p1) {
				...
				v8[safeIndex(477, v8.Length)] := (if (f26) then multiset{v17[safeIndex(0x2bc, |v17|) := v16]} else fm36(p2, v8[safeIndex(477, v8.Length)], !fm2(p1, p2, globalState), f26, globalState)) >= v18;
				var v19 := DC10(v9);
				...
				var v24: seq<seq<int>> := [seq(abs(0x75), i7  => (p2)), [p2], [-|v15|, i5], v10, [i5, i5]];
				var v25: C2 := new C2(v24, v8[safeIndex(477, v8.Length)], f27);
				var v26: map<seq<int>, C2> := map[v10 := v25];
				var v27: array<map<seq<int>, C2>> := new map<seq<int>, C2>[3] [v26 + v26, v26, v26];
				v27[safeIndex(450, v27.Length)] := v26;
				v27[safeIndex(450, v27.Length)] := v26;
				var v28 := DC0(f26);
				v9[safeIndex(821, v9.Length)] := v25.fm4(v28, i5, p2, globalState) - i5;
				globalState.f12, v9[safeIndex(821, v9.Length)] := -(if (v13[safeIndex(i5, |v13|)]) then 606 else i5 - p2), i5;
			} else {
				var v29: array<array<int>> := new array<int>[6] [v9, v9, v9, v9, v9, v9];
				v29[safeIndex(699, v29.Length)] := v9;
				v29[safeIndex(699, v29.Length)] := v9;
				var v30 := "ctfdse";
				var v31: seq<array<int>> := [v29[safeIndex(699, v29.Length)], v9, v9];
				v9, globalState.f6, globalState.f16, v9 := v29[safeIndex(699, v29.Length)], v30, 0x32c, v31[safeIndex(p2, |v31|)];
				...
				v32[safeIndex(349, v32.Length)] := v34;
				var v35: multiset<multiset<int>> := multiset{p3, p3};
				v32[safeIndex(349, v32.Length)], globalState.f16, globalState.f15 := v34 + v34, i5, v35 >= v35;
				var v36 := new C1(p2, i5, --0x7d == |p3|, v8[safeIndex(477, v8.Length)]);
			}
		...
		if (f26) {
			...
			var v39: multiset<int> := multiset{safeDivisionInt(p2, |v38|), p2};
			v39 := v39 - (v39 - v39);
			globalState.f16 := |v10|;
			...
			v9[safeIndex(478, v9.Length)] := p2;
			v9[safeIndex(478, v9.Length)] := p2;
			var v42 := DC0(p0);
			var v43: seq<bool> := [true];
			var v44: multiset<bool> := multiset{p1};
			var v45 := m8(v42, v43[safeIndex(fm1(globalState), |v43|)], v44, v9[safeIndex(478, v9.Length)], globalState);
			var v46: multiset<array<bool>> := multiset{v8, v8};
			var v47 := "nhfpskf";
			var v48: map<int, string> := map[|(v46 * v46)| := if (f27) then v47 else v47];
			v48 := v48[v9[safeIndex(478, v9.Length)] := "t" + fm22(p2, fm2(p0, v9[safeIndex(478, v9.Length)], globalState), globalState)];
			var v49: map<bool, int> := map[p1 := v9[safeIndex(478, v9.Length)]];
			var v50 := DC19(v9[safeIndex(478, v9.Length)], v44, f27, v49);
			if (v50.cf38) {
				v9[safeIndex(478, v9.Length)] := v9[safeIndex(478, v9.Length)];
				globalState.f12 := p2;
				var v51: map<int, seq<bool>> := map[v9[safeIndex(478, v9.Length)] := [v50.cf38]];
				var v52 := 'h';
				v51 := v51[fm1(globalState) := fm11(v8[safeIndex(477, v8.Length)], v8[safeIndex(477, v8.Length)], v52, globalState)];
				var v53: array<array<string>> := new array<string>[23];
				var v54: array<string> := new string[25] ["fbnprm", v47, v47, v47, v47, v47, "c", v47, v47, v47, v47, fm22(p2, v45, globalState), "hluwry", v47, v47, v47, v47, v47, v47, v47, v47, ("pkxwgoox")[safeIndex(v9[safeIndex(478, v9.Length)], |"pkxwgoox"|) := v52], v47, seq(abs(773), i8  => (v52)), v47];
				var v55: seq<array<string>> := [v54, v54];
				v53[safeIndex(192, v53.Length)] := if (fm2(true, v9[safeIndex(478, v9.Length)], globalState)) then v54 else v55[safeIndex(p2, |v55|)];
				v53[safeIndex(192, v53.Length)] := v54;
				var v56: map<bool, seq<bool>> := map[f26 := [f27, v45]];
				var v57 := DC13(v56);
				v57 := v57;
			} else {
				var v58 := 'a';
				var v59: array<int> := new int[25] [p2, v9[safeIndex(478, v9.Length)], p2, v9[safeIndex(478, v9.Length)], p2, v9[safeIndex(478, v9.Length)], v9[safeIndex(478, v9.Length)], -v9[safeIndex(478, v9.Length)], |v10|, p2, p2, p2, 0x25e, p2, v9[safeIndex(478, v9.Length)], v9[safeIndex(478, v9.Length)], p2, |[v58]|, p2, p2, v9[safeIndex(478, v9.Length)], p2, |v47|, p2, p2];
				var v60: map<array<int>, int> := map[v59 := |v47|];
				var v61: map<multiset<bool>, set<bool>> := map[v44 := {f27}];
				var v62 := DC14(|(if (v44 in v61) then v61[v44] else {f26, f26})|, p2, v43[safeIndex(v9[safeIndex(478, v9.Length)], |v43|)]);
				globalState.f12, v9[safeIndex(478, v9.Length)], globalState.f24 := if (f27) then |(v60 + map[v59 := v9[safeIndex(478, v9.Length)]])| else p2, v62.cf26, if (!(p2 <= p2)) then v45 else v8[safeIndex(477, v8.Length)];
				var v63: C0 := new C0(f26);
				var v64: set<bool> := {f26};
				var v65: map<seq<D3>, C0> := map[seq(abs(0x106), i9  => (DC11(v58))) := v63];
				var v66 := DC11(v58);
				...
				globalState.f6 := v47;
				var v67: array<string> := new string[18] ["mxwll" + v47, v47, v47, v47[safeIndex(v9[safeIndex(478, v9.Length)], |v47|) := v58], v47, v47, v47 + v47, v47, "lawmo", v47, fm22(v9[safeIndex(478, v9.Length)], p0, globalState), seq(abs(0x2cc), i10  => (v58)), v47, seq(abs(715), i11  => ('u')), v47, v47, v47, v47];
				v67 := new seq<char>[3](i12 => seq(abs(0x2de), i13  => (v58)));
				var v68 := DC26(v8);
				var v69: seq<array<bool>> := [v8, v68.cf47, v8, v8];
				var v70: map<string, seq<array<bool>>> := map["hnkb" := [v8]];
				var v71: array<seq<array<bool>>> := new seq<array<bool>>[5] [v69, v69, v69 + v69, v69 + v69, v69 + (if (fm22(v9[safeIndex(478, v9.Length)], v63.fm6(v58, v63.f32, globalState), globalState) in v70) then v70[fm22(v9[safeIndex(478, v9.Length)], v63.fm6(v58, v63.f32, globalState), globalState)] else v69)[safeIndex(p2, |(if (fm22(v9[safeIndex(478, v9.Length)], v63.fm6(v58, v63.f32, globalState), globalState) in v70) then v70[fm22(v9[safeIndex(478, v9.Length)], v63.fm6(v58, v63.f32, globalState), globalState)] else v69)|) := v8]];
				v71[safeIndex(573, v71.Length)] := v69;
				v71[safeIndex(573, v71.Length)] := v69 + (v69 + v69);
			}
			
			if (p1) {
				var v72: map<string, array<bool>> := map[v47 := v8];
				v72 := v72[seq(abs(0xa2), i14  => ('l')) := v8];
				var v73 := new C3(v11, p1 <==> v45, v45 ==> v45);
				var v74 := m8(v42, f26, multiset{v8[safeIndex(477, v8.Length)]}, safeDivisionInt(0x229, |v47|), globalState);
				globalState.f12 := safeDivisionInt(-v9[safeIndex(478, v9.Length)], p2);
				var v75 := 'h';
				globalState.f19 := v75;
			} else {
				...
				var v89 := DC10(v83);
				var v90: C4 := new C4(map[v89 := -v9[safeIndex(478, v9.Length)]], p0, true);
				var v91: seq<C4> := [v90, v90, v90];
				var v92: map<int, int> := map[|v91| := v77.f37];
				var v93 := DC6(map v88 : int | v88 in v92 :: (v88 * -0x320) := (p2));
				var v94: map<seq<int>, seq<D2>> := map[v10 := (seq(abs(0x2cf), i15  => (DC6(map[v77.f37 := |[[v9[safeIndex(478, v9.Length)]]]|]))))[safeIndex(|v47|, |(seq(abs(0x2cf), i15  => (DC6(map[v77.f37 := |[[v9[safeIndex(478, v9.Length)]]]|]))))|) := v93]];
				var v95 := DC23(v94);
				globalState.f16, v83, v8, v87, globalState.f16 := v77.f37, v83, v8, {fm37(v45, v77.fm1(globalState), p2, v95, globalState) + v86}, 569;
				v8[safeIndex(477, v8.Length)] := v90.fm1(globalState) <= (|[v8[safeIndex(477, v8.Length)]]| - v77.f36);
				var v96: set<int> := {|v47|};
				v8[safeIndex(477, v8.Length)] := (|v96| - p2) < p2;
			}
	...
	method m8(p0: D0, p1: bool, p2: multiset<bool>, p3: int, globalState: GlobalState) returns (r0: bool) {
		...
		var v1 := 'h';
		v0[safeIndex(371, v0.Length)] := ("qsnm")[safeIndex(p3, |"qsnm"|) := v1];
		var v2 := "yxuu";
		v0[safeIndex(371, v0.Length)] := v2;
		...
		var v5 := DC6(v4);
		var v7: set<int> := {p3};
		var v8: array<D2> := new D2[18] [v5, v5, v5, v5, v5.(cf13 := map v6 : int | v6 in v7 :: (safeDivisionInt(v6, 0x10e)) := (p3)), DC6(map[p3 := p3]), DC6(v4), v5, v5, v5, v5, DC6(v4), v5, v5, v5, DC6(v4), v5, DC6(map[p3 := p3])];
		var v9: map<bool, array<D2>> := map[fm5(v3, v3, p0, !false, globalState) !in (seq(abs(0x3e7), i0  => ('c'))) := v8];
		v9 := v9[f26 := v8];
		for i1 := p3 to -p3 {
			var v10: array<bool> := new bool[28];
			var v11: map<bool, set<int>> := map[p1 := v7];
			v10[safeIndex(653, v10.Length)] := !((if (f27 in v11) then v11[f27] else v7) >= {p3, i1});
			var v12: map<int, bool> := map[p3 := p1];
			var v13: multiset<array<bool>> := multiset{v10};
			globalState.f22, v10[safeIndex(653, v10.Length)] := safeModuloInt(|v12|, i1) != 0x129, v13 > (v13 - multiset{v10, v10});
			globalState.f16 := p3;
			var v14: multiset<seq<bool>> := multiset{fm25(v10[safeIndex(653, v10.Length)], v10[safeIndex(653, v10.Length)], 'q', globalState) + v3};
			v14 := v14 + multiset{v3, v3, [v10[safeIndex(653, v10.Length)], fm2(p1, p3, globalState)], [f26, v10[safeIndex(653, v10.Length)], f26]};
			globalState.f16 := i1;
		}
		var v15: seq<int> := [fm1(globalState)];
		var i2 := 0;
		while (if (!v3[safeIndex(|v15[safeIndex(p3, |v15|) := 0x3c]|, |v3|)]) then f26 else false)
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			match (DC2(v17)) {
				case DC1(cf1, cf2, cf3, cf4) =>
					...
					v19[safeIndex(419, v19.Length)] := v1;
					v19[safeIndex(419, v19.Length)] := v1;
					...
					v21[safeIndex(404, v21.Length)] := cf1;
					v21[safeIndex(404, v21.Length)] := !cf1;
				case DC0(cf0) =>
					var v22: array<int> := new int[6](i4 => safeModuloInt(i4, p3));
					...
					v24[safeIndex(175, v24.Length)] := v22;
					v24[safeIndex(175, v24.Length)] := v22;
					var v25: multiset<int> := multiset{p3, p3, p3, p3, p3};
					var v26: array<bool> := new bool[11] [0x2d8 > p3, cf0, cf0, cf0, !(v0[safeIndex(371, v0.Length)] != v2), !(v25 >= v25), fm2(false, p3, globalState), f26, f27, p1, true];
					v26[safeIndex(717, v26.Length)] := p1;
					var v27 := DC16("oqncb");
					var v28: array<D6> := new D6[28] [DC16(seq(abs(0x31a), i5  => ('b'))), v27, v27, fm38(true, p3, v0[safeIndex(371, v0.Length)], globalState), v27, v27, v27, v27, v27, v27, DC16(v2).(cf29 := v2), v27, DC16(v2), v27.(cf29 := v2), v27, v27, v27, v27, DC16(v2), v27, v27, v27, v27, v27, v27, DC16(v0[safeIndex(371, v0.Length)]), v27, v27];
					v28[safeIndex(485, v28.Length)] := v27;
					v26[safeIndex(717, v26.Length)], v28[safeIndex(485, v28.Length)] := !f27, v27;
					var v29: map<D1, char> := map[DC5(p3) := v1];
					var v30: seq<map<D1, char>> := [v29];
					var v31: map<seq<map<D1, char>>, seq<bool>> := map[v30 + (seq(abs(68), i6  => (map[DC5(p3) := v1]))) := v3];
					v31 := v31[[map v32 : D1 | v32 in map[DC5(p3) := p3] :: (v32) := (v1)] + v30 := v3];
					globalState.f6 := (v27.(cf29 := v0[safeIndex(371, v0.Length)])).cf29;
				case DC2(cf5) =>
					var v33: array<bool> := new bool[6](i7 => f26);
					var v34: map<array<bool>, int> := map[v33 := p3];
					v34 := v34[v33 := p3];
					var v35: map<bool, int> := map[f27 := |v0[safeIndex(371, v0.Length)]|];
					var v36: multiset<map<bool, int>> := multiset{v35, v35};
					globalState.f6, globalState.f24, globalState.f15, globalState.f24, globalState.f19 := v0[safeIndex(371, v0.Length)], p1, |v36| > p3, f27, v1;
					globalState.f2 := p1;
					globalState.f16 := p3;
			}
			...
			v41[safeIndex(894, v41.Length)] := v42;
			var v43: T2 := new C1(p3, p3, true, false);
			var v44: seq<T2> := [v43];
			v41[safeIndex(894, v41.Length)], v44, globalState.f12, globalState.f24 := if (f27 || p1) then v42 else v42, v44, -(p3 + p3), v43.f26;
			var v45 := DC10(v41[safeIndex(894, v41.Length)]);
...
class C6 extends T0 {
	...
	function fm1(globalState: GlobalState): int {
		(f40 - |(seq(abs(0x71), i0  => (f40)))|) - f40
	}
	function fm2(p0: bool, p1: int, globalState: GlobalState): bool {
		((set v0 : int | v0 in multiset([f40, |map[false := !false]|, -f40]) :: (safeModuloInt(v0, |multiset([!true, false, false, !false, true])|))) - {-f40, |multiset{|multiset{f40}|}|, |multiset{true, !true}|, f40}) == ({|(seq(abs(0x190), i0  => ('x')))|, -f40, f40} - {f40, |[set v1 : int | (0xb2 <= v1) && (v1 < 0x3c7) :: (v1 * f40)]|})
	}
	...
	method m15(p0: int, p1: D14, p2: bool, p3: bool, globalState: GlobalState) returns (r0: D1, r1: map<multiset<bool>, bool>, r2: int) {
			...
			decreases 100 - i0
		{
			...
			var v5 := DC35(p2);
			v5 := v5;
			var v6: array<int> := new int[25](i1 => safeDivisionInt(i1, 0x29d));
			v6[safeIndex(182, v6.Length)] := f40;
			v6[safeIndex(182, v6.Length)] := 0x86;
			...
			v9[safeIndex(743, v9.Length)] := v8;
			v9[safeIndex(743, v9.Length)] := v8;
			var v10: array<bool> := new bool[7];
			v10[safeIndex(263, v10.Length)] := v7.f26;
			v10[safeIndex(263, v10.Length)] := p2;
		}
		var i2 := 0;
		while (p2)
			decreases 100 - i2
		{
			...
			var v13: array<bool> := new bool[8] [p3, v11[safeIndex(|v12|, |v11|)], true, fm2(p2, p0, globalState), true, p3, p2, p2];
			v13[safeIndex(147, v13.Length)] := fm44(globalState);
			v13[safeIndex(147, v13.Length)] := f40 > (fm1(globalState) + -p0);
			r2 := p0;
			...
			var v16 := new C3(v15, if (v13[safeIndex(147, v13.Length)]) then p3 else true, v13[safeIndex(147, v13.Length)]);
		}
		r0 := DC5(safeModuloInt(p0, p0));
		var v17: seq<bool> := [p3];
		var v18: map<multiset<bool>, bool> := map[v0 := v17[safeIndex(f40, |v17|)]];
		r1 := v18;
		r2 := f40 * f40;
	}
	method m16(p0: int, globalState: GlobalState) returns (r0: seq<bool>) {
		...
		v10[safeIndex(385, v10.Length)] := v4;
		var v11: array<bool> := new bool[27];
		var v12: seq<array<bool>> := [v11, v11];
		var v13: seq<seq<array<bool>>> := [v12];
		var v14: array<seq<array<bool>>> := new seq<array<bool>>[25] [v12 + v12, v12, v12, v12, v12, v12, v12 + v13[safeIndex(490, |v13|)], v12, [v11, v11], ([v11])[safeIndex(|[|"ajrpp"|]|, |[v11]|) := v11] + v12, v12, v12, v12, v12, v12, [v11, v11, v11], v12, v12[safeIndex(p0, |v12|) := v11], v12 + v12[safeIndex(f40, |v12|) := v11], v12, v12, v12, v12 + v12, v12, v12];
		v14[safeIndex(119, v14.Length)] := v12;
		var v15 := 'k';
		var v16: map<multiset<int>, char> := map[multiset{p0} := v15];
		var v17: map<char, bool> := map[if (v7 in v16) then v16[v7] else v5[safeIndex(-p0, |v5|)] := v2];
		v3[safeIndex(946, v3.Length)], globalState.f24, v10[safeIndex(385, v10.Length)], v14[safeIndex(119, v14.Length)], v17 := p0, if (v2) then v2 else if (!false) then v2 else v2, v4, v12[safeIndex(p0, |v12|) := v11], v17;
		globalState.f24 := !!v2;
		var v18 := DC16(seq(abs(0x3d1), i0  => (v15)));
		if (match if (v2) then v18 else v18 {
			case DC17(cf30, cf31, cf32, cf33, cf34) => v2
			case DC16(cf29) => v2
		}) {
			var v19: seq<bool> := [v2];
			v3[safeIndex(946, v3.Length)] := |(v19 + (v19[safeIndex(f40, |v19|) := v2] + v19))|;
			globalState.f24 := v2;
			v3 := v3;
			v3 := v3;
			var v20 := DC5(-f40);
			...
			var v26: array<string> := new string[20] [v5, v5, v5, v5, v23[safeIndex(f40, |v23|)], "p", v5, v5, v5, v5, "agk", v25.cf10, v5 + v5, seq(abs(566), i1  => (v15)), v5, "lwu", v5 + v5, "gdid", v5 + v5, v5];
			v26[safeIndex(141, v26.Length)] := v5;
			var v27: set<bool> := {v2};
			var v28: multiset<bool> := multiset{true};
			v26[safeIndex(141, v26.Length)] := v5 + (if (true) then v5 else v5[safeIndex(|v27|, |v5|) := v15])[safeIndex(if (false in v28) then v28[false] else |map[|v7| := v2]|, |(if (true) then v5 else v5[safeIndex(|v27|, |v5|) := v15])|) := v15];
			...
			var v34 := DC19(-v3[safeIndex(946, v3.Length)], v28, v2, map[v2 := v3[safeIndex(946, v3.Length)]]);
			...
			v12 := v12 + v14[safeIndex(119, v14.Length)];
			var v36: array<array<int>> := new array<int>[2] [v3, v3];
			v36[safeIndex(542, v36.Length)] := v3;
			v36[safeIndex(542, v36.Length)] := if (true) then v3 else v3;
		}
		
		var v37: set<int> := {v3[safeIndex(946, v3.Length)], |v5|, p0, v3[safeIndex(946, v3.Length)]};
...
class C7 extends T0 {
	...
	function fm2(p0: bool, p1: int, globalState: GlobalState): bool {
		({multiset([699, -0x22, -0x2b, |"vqgjwd"|, |map[!f38 := true]|]), multiset{|"jhuvf"|}} - {multiset{|"ihdf"|, |[|(seq(abs(-0x237), i0  => ("ro")))|, 0x367]|}}) > (set v0 : multiset<int> | v0 in [multiset{--0xc9, |"imnioove"|, 0x70}, multiset([373]), multiset([|multiset{f38, f38}|]), multiset{987}] :: (v0))
	}
	method m13(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		for i0 := |[v1, v1, v1, v1.(cf49 := v0).(cf49 := v0), v1]| to if (f38 in v2) then v2[f38] else v0 {
			...
			v7[safeIndex(53, v7.Length)] := if (!!f38) then v6 else v6;
			v7[safeIndex(53, v7.Length)] := DC15(DC14(-v0, i0, f38)).(cf28 := v5).(cf28 := v5);
			var v8: seq<int> := [v0];
			var v9: seq<seq<int>> := [v8[safeIndex(i0, |v8|) := v0]];
			var v10: C2 := new C2(v9[safeIndex(v0, |v9|) := [v0, 250, v0, i0]], !f38, f38);
			var v11: multiset<int> := multiset{-248};
			var v12: seq<bool> := [f38, f38];
			var v13: array<int> := new int[19] [i0, |v11|, i0, 0x32c, 0x295, i0, i0, i0, |v12|, i0, i0, v0, v0, v8[safeIndex(i0, |v8|)], v0, i0, i0, i0, i0];
			...
			v17[safeIndex(687, v17.Length)] := f38;
			var v18 := "mhjfmmfl";
			var v19 := DC11(v18[safeIndex(i0, |v18|)]);
			var v20: map<bool, D3> := map[false := v19];
			var v21: map<seq<int>, seq<D2>> := map[v8 := seq(abs(726), i1  => (DC6(v3)))];
			var v22 := DC23(v21);
			var v23: map<D10, bool> := map[v22 := f38];
			v10, v16, globalState.f16, globalState.f12, v17[safeIndex(687, v17.Length)] := if (f38) then v10 else v10, v16, |v20|, i0, if (v22 in v23) then v23[v22] else f38;
			v17[safeIndex(687, v17.Length)] := v17[safeIndex(687, v17.Length)];
		}
		var v24 := 'l';
		var v25, v26, v27, v28 := m0(v24, globalState);
		var v29: map<char, int> := map[v25 := 0x171];
		globalState.f24, r1 := !(safeDivisionInt(v0, fm1(globalState)) >= v0), safeModuloInt(0x329, 846) * (if (fm40(v0, fm2(v27, v0, globalState), v27, globalState) in v29) then v29[fm40(v0, fm2(v27, v0, globalState), v27, globalState)] else v0);
	...
	method m14(p0: bool, p1: bool, p2: char, globalState: GlobalState) returns (r0: bool, r1: multiset<map<bool, int>>, r2: map<seq<bool>, int>, r3: bool) {
		...
		match (v4) {
			case DC4(cf7, cf8, cf9, cf10, cf11) =>
				...
				var v8 := DC12(v6);
				globalState.f22, v3, v3, cf9, globalState.f22 := (v6 * {true}) >= (v6 - v6), v3, v3, -safeModuloInt(|v6|, cf8), if (v8 in v7) then v7[v8] else f38;
				var v9: seq<set<bool>> := [v6];
				var v10 := DC31([v6]);
				var v11: map<bool, seq<set<bool>>> := map[p1 := [v6]];
				var v12: array<seq<set<bool>>> := new seq<set<bool>>[18] [v9, v9 + v9[safeIndex(0x2ff, |v9|) := {p0, true}], v9, v9[safeIndex(cf8, |v9|) := v6] + v9, v9, v9 + v9, [v6, v6, v6] + v9, [v6], v9 + (seq(abs(0x31f), i0  => (v6))), v9, v9, v9[safeIndex(v0, |v9|) := v6], v10.cf55 + v9, if (p0 in v11) then v11[p0] else v9, v10.cf55, seq(abs(785), i1  => (v6)), if (f38) then v9 else seq(abs(104), i2  => (v6)), v9 + v9];
				v12[safeIndex(645, v12.Length)] := v9;
				var v13 := DC11('a');
				var v14: seq<seq<set<bool>>> := [fm41(!f38, v13, cf9, p0, globalState)];
				var v15: C5 := new C5(v3[safeIndex(cf9, |v3|)], true);
				var v16: map<C5, bool> := map[v15 := p1];
				var v17 := DC33(v16);
				globalState.f16, v12[safeIndex(645, v12.Length)] := cf8, v9 + v14[safeIndex(|cf10[safeIndex(v2.fm4(DC0(p1), v0, |(v17.(cf61 := v16)).cf61|, globalState), |cf10|) := p2]|, |v14|)];
				var v18: map<int, int> := map[v0 := cf9];
				if (-(if (p0) then cf8 else v0) == |v18[v0 := cf8]|) {
					v18 := v18[0x237 := cf8];
					var v19: array<int> := new int[21](i3 => safeDivisionInt(i3, -cf9));
					v19[safeIndex(658, v19.Length)] := v15.fm1(globalState);
					v19[safeIndex(658, v19.Length)] := v1[safeIndex(v15.fm1(globalState), |v1|)];
					var v20: C0 := new C0(cf8 <= v19[safeIndex(658, v19.Length)]);
					v20, v19, v1 := v20, v19, v2.f35[safeIndex(v0, |v2.f35|)];
					var v21 := DC34(cf8, p0, |cf11|);
					v21 := DC34(v19[safeIndex(658, v19.Length)], false, safeDivisionInt(v0, cf9));
					var v22 := new C5(true, true || true);
				} else {
					var v23: array<bool> := new bool[1];
					v23 := v23;
					var v24: array<int> := new int[9] [safeDivisionInt(cf9, cf8), if (p1) then cf9 else cf9, cf9, -safeModuloInt(|v3|, cf9), 0x344, cf8, v0, -cf8 * |cf10|, cf9];
					v24[safeIndex(563, v24.Length)] := |v3[safeIndex(v0, |v3|) := f38]|;
					v24[safeIndex(563, v24.Length)] := v0;
					var v25: map<array<bool>, int> := map[v23 := cf9];
					var v26: map<bool, int> := map[p0 := |v25|];
					globalState.f12 := |(v26 + (if (p1) then v26 else map[p0 := v24[safeIndex(563, v24.Length)]]))|;
					var v27: multiset<bool> := multiset{p1, !p1, f38};
					var v28: set<int> := {v24[safeIndex(563, v24.Length)]};
			...
			case DC5(cf12) =>
				...
				var v38: array<int> := new int[24] [-v0, cf12, v33.cf8, cf12, -v0, v0, |(v34 + v34)|, cf12, cf12, cf12, v2.fm1(globalState), safeModuloInt(cf12, cf12), v0, |fm42(v0, globalState)|, cf12, v0, |"j"|, cf12, safeModuloInt(|v35|, |v36|), |multiset{cf12, v0}|, v0, v0 * -|v37|, v0, v0];
				v38[safeIndex(662, v38.Length)] := |(v1 + v1)|;
				v30, v1, globalState.f15, globalState.f16, v38[safeIndex(662, v38.Length)] := v30 - v30, fm43(v0, 0x38d, |(v3 + v3)|, map[p1 := p2], globalState), p0 && !p0, v0, cf12 + cf12;
				var v39: array<multiset<D11>> := new multiset<D11>[8];
				v39 := v39;
				var v40 := DC0(f38);
				cf12 := v2.fm4(v40.(cf0 := p0), safeModuloInt(v0, cf12), cf12 - cf12, globalState);
			case DC3(cf6) =>
				...
				if (p1) {
					...
					globalState.f22 := p0;
					globalState.f6 := "qx";
					v55[safeIndex(868, v55.Length)] := v0;
					v55[safeIndex(868, v55.Length)] := DC5(-v43).cf12;
					globalState.f15 := v51 <= (seq(abs(0x291), i4  => ('u')));
				}
				...
				var v64: array<int> := new int[8] [if (p0) then |v1| else v43, v43, |v59|, v43, |cf6|, 405, safeModuloInt(if (v58.f26 in v61) then v61[v58.f26] else |v62|, v0), |(fm48(|[v0]|, globalState) + v63)|];
				v64[safeIndex(347, v64.Length)] := v43;
				var v65 := DC0(cf6[safeIndex(|(seq(abs(0x16a), i5  => (p2)))|, |cf6|)]);
				v64[safeIndex(347, v64.Length)], v43 := -v2.fm4(v65, v43, v43, globalState), |cf6|;
				var v66: multiset<int> := multiset{-0x292};
				var v67: multiset<multiset<int>> := multiset{v66 - v66};
				v67 := fm49(v66[v43 := abs(-0x3b4)], |cf6[safeIndex(v0, |cf6|) := p1]|, v58.f27, globalState);
		}
		...
		for i6 := |map[0xce := v0]| to v0 {
			...
			var v75: array<bool> := new bool[21] [p0, p0, p1, true, p0, p0, v3[safeIndex(if (f38 in v73) then v73[f38] else v0, |v3|)], f38, f38, p0, !true, p1, f38, f38, v2.fm2(if (f38 in v74) then v74[f38] else f38, |(seq(abs(-0x1ff), i7  => (p2)))|, globalState), p1, p1, p1, p0, true, !DC7(p1, true, v0, v0).cf14];
			var v76 := DC32(v73, p1, p0, p1, |v69|);
			var v77: map<D14, bool> := map[v76 := f38];
			v75[safeIndex(329, v75.Length)] := v2.fm17(v0, i6, |v77|, fm50(globalState), globalState);
			v75[safeIndex(329, v75.Length)], globalState.f16 := p1, i6;
			var v78: T0 := new C6(|v68|);
			var v79, v80 := v2.m2(p0, v78, !(if (p1) then f38 else p0), globalState);
			var v81: map<bool, int> := map[p0 := v0];
			var v82 := DC19(v0, multiset{p1, p0}, v75[safeIndex(329, v75.Length)], v81);
			var v83: map<map<bool, bool>, int> := map[map[p1 := f38] := v82.cf36];
			v75[safeIndex(329, v75.Length)] := if (safeModuloInt(0x281, -|v83|) in v70) then v70[safeModuloInt(0x281, -|v83|)] else p0;
		}
		globalState.f16 := v0;
		...
		if ("tixwcfv" <= v85) {
			...
			var v91: map<char, string> := map['w' := seq(abs(0x3cb), i8  => ('q'))];
			...
			var v96: array<int> := new int[18] [v0, |v93| - 647, --|v85|, v0, v0, safeDivisionInt(v0, v0), 834, v0, v0 + v0, if (v84 in v94) then v94[v84] else v0, v0, DC38(v0, v0, f38).cf70 - -v0, 0xae, v0, |v95|, v0, v0, if (!f38) then v0 else v0];
			v96[safeIndex(907, v96.Length)] := safeDivisionInt(-v0, v0);
			var v97 := DC0(p0);
			var v98 := DC2(v97);
			var v99: seq<D0> := [v98];
			v0, globalState.f12, v96[safeIndex(907, v96.Length)], v99, globalState.f12 := v0, safeModuloInt(safeDivisionInt(-v0, -14), v0), -|(v85 + v85)| * v2.fm1(globalState), seq(abs(63), i9  => (v98)), v0;
			globalState.f22 := p1;
			var v100: array<array<int>> := new array<int>[15];
			v100[safeIndex(144, v100.Length)] := v96;
			v100[safeIndex(144, v100.Length)] := v96;
			v95 := v95 + {p1};
			var v101: map<bool, int> := map[false := v96[safeIndex(907, v96.Length)]];
			if (if (true) then v101 == v101 else f38) {
				globalState.f24 := (f38 && false) || p1;
				globalState.f15 := f38;
				var v102: map<bool, bool> := map[p1 := p0];
				var v103: map<array<int>, bool> := map[v100[safeIndex(144, v100.Length)] := p0];
				v102 := v102[if (v96 in v103) then v103[v96] else p0 := f38];
				v84 := v84;
				v96[safeIndex(907, v96.Length)] := if (true) then v96[safeIndex(907, v96.Length)] else v0 - v0;
			} else {
				var v104: set<int> := {v96[safeIndex(907, v96.Length)] * v96[safeIndex(907, v96.Length)], v0, 177, 0x3da, v96[safeIndex(907, v96.Length)]};
				var v105: seq<seq<char>> := [v85, v85, v85];
				var v106: map<multiset<seq<char>>, set<int>> := map[multiset(v105 + v105) := {v96[safeIndex(907, v96.Length)], v0}];
				var v107: multiset<seq<char>> := multiset{v85};
				v104 := if (v107[v85 := abs(v0)] in v106) then v106[v107[v85 := abs(v0)]] else v104;
				var v108 := DC40(v2.f35);
				var v109: map<char, seq<int>> := map[p2 := [v96[safeIndex(907, v96.Length)], v0]];
				var v110: multiset<seq<int>> := multiset{v1};
				var v111: seq<multiset<seq<int>>> := [multiset(v108.cf73[safeIndex(v96[safeIndex(907, v96.Length)], |v108.cf73|) := [|(if (p2 in v109) then v109[p2] else v1)|]]), v110, multiset(seq(abs(777), i10  => (v2.f35[safeIndex(v0, |v2.f35|)]))), v110, v110];
				var v112 := new C3(v111[safeIndex(v0, |v111|)], f38, p1);
				var v113: seq<map<int, int>> := [v93, v93];
				v113 := v113;
				globalState.f16 := safeDivisionInt(v0, v96[safeIndex(907, v96.Length)]);
		...
		var v117 := DC5(226);
		r1 := v116[v115 := abs(v117.cf12)] * (multiset{v115} - multiset{v115, v115});
...
class C8 extends T3 {
	...
	method m3(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: T0) {
		...
		for i0 := p0 to p0 {
			var v0 := 'y';
			if (safeDivisionInt(p3, -589) == -|p2[safeIndex(p1, |p2|) := v0]|) {
				var v1 := false;
				var v3: map<int, int> := map[p0 := i0];
				var v4: set<int> := {-207, |map[p0 := |(map v2 : int | v2 in v3 :: (safeDivisionInt(v2, i0)) := (i0))|]|, p3};
				...
				v7[safeIndex(905, v7.Length)] := -p3;
				var v8: array<bool> := new bool[7](i2 => v1);
				v8[safeIndex(931, v8.Length)] := !(v1 && v1);
				var v9: map<bool, bool> := map[false := true];
				var v10 := DC29(v9);
				var v11: seq<int> := [i0, |p2|, i0, p3, p0];
				v7[safeIndex(905, v7.Length)], v8[safeIndex(931, v8.Length)], globalState.f16, globalState.f15, globalState.f12 := 109 * (|v10.cf50| * i0), v1, p0 * p0, if (!v1) then p3 in v11 else v1 && v1, (i0 + p1) + (if (v1) then 0x242 else i0);
				globalState.f22 := v8[safeIndex(931, v8.Length)];
				var v12 := new C0(!v8[safeIndex(931, v8.Length)]);
			} else {
				var v13 := true;
				...
				v16[safeIndex(829, v16.Length)] := true;
				v16[safeIndex(829, v16.Length)] := !v13;
		...
		var v20 := DC10(v19[safeIndex(p0, |v19|)]);
		...
		for i4 := |p2| - p1 to |v30| {
			...
			v35 := v35[v34[v33 := f29] := v27[safeIndex(v33.fm1(globalState), |v27|)]];
		}
		var v36: set<bool> := {v28};
		r0, globalState.f16 := (v36 * v36) < v36, p0;
		r0 := v23 ==> v23;
		r1 := !(v23 || v23);
		r2 := v19[safeIndex(p0, |v19|)];
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v9 := DC17(if (v6 in v7) then v7[v6] else v2.f40, v2.f40, 51, |multiset(v8[safeIndex(v0, |v8|) := v5])|, v0);
		var v10 := 'v';
		...
		v13[safeIndex(913, v13.Length)] := DC17(v0, v0, v0, 0x42, v0);
		v13[safeIndex(913, v13.Length)] := DC17(|[v10, v10]| + v2.f40, v2.f40, v2.f40, v0, -v2.f40);
		globalState.f12 := v0;
		...
		if (!!(v8 <= [v5])) {
			...
			var v18: array<int> := new int[19] [v2.f40, v0, 0x9e, v2.f40, v2.fm1(globalState), fm39(globalState), |v16|, v2.f40, safeModuloInt(v2.f40, |v17|), v2.f40 + v2.f40, v2.fm1(globalState) * v0, v0, v2.f40, v2.f40 + |v14|, safeDivisionInt(v0, v0), -336, |(v17 + multiset{v5})|, 416, safeDivisionInt(v1[safeIndex(|f29|, |v1|)], v0)];
			v18 := v18;
			...
			var v24: map<array<int>, bool> := map[if (v5 in v23) then v23[v5] else v18 := fm40(0x175, v5, true, globalState) !in v16[safeIndex(v2.f40, |v16|) := v16[safeIndex(v2.f40, |v16|)]]];
			v24 := v24[v18 := v2.fm44(globalState)];
			var v25 := DC32(v17, v8[safeIndex(v2.f40, |v8|)], v5, v5, v2.f40);
			var v26 := DC11(v10);
			...
			var v31: array<bool> := new bool[22] [v5, v5, v5, v5, false, !v5, if (v25.cf58) then v5 else false, false, v28.cf10 < "kyjjbux", v5, v5, v5, v5, v5 || v5, v5, v20 <= v30[safeIndex(v2.f40, |v30|)], !true && v5, v5, v5 && v5, false, false, !v5];
			v31[safeIndex(536, v31.Length)] := v5;
			v31[safeIndex(536, v31.Length)] := !(v2.f40 != (if (v5) then -v0 else v0));
			v18[safeIndex(663, v18.Length)] := v2.f40;
			v18[safeIndex(663, v18.Length)] := v2.f40;
		} else {
			...
			v33[safeIndex(192, v33.Length)] := -728;
			var v34: map<int, map<bool, int>> := map[0x1e0 := map[v5 := v0]];
			var v35: T0 := new C7(v5, v34);
			var v36: set<T0> := {v35};
			v33[safeIndex(192, v33.Length)] := |(if (!(v5 && v5)) then v36 + v36 else v36 - v36)|;
			var v37 := DC10(v33);
			var v38: map<D3, int> := map[v37 := v2.f40];
			var v39: multiset<bool> := multiset{v5, v5};
			var v40 := DC32(v39, v5, !v5, v5, v2.f40);
			var v41: C1 := new C1(|f29|, |fm52(v5, v33[safeIndex(192, v33.Length)], globalState)|, v40.cf57, v5);
			var v42: seq<C1> := [v41];
			var v43 := new C4(v38, v5, v42[safeIndex(v41.f36, |v42|) := v41] != [v41, v41]);
			var v44: seq<string> := [v32];
			var v45: array<string> := new string[25] [v32, v32, v32, v44[safeIndex(v33[safeIndex(192, v33.Length)], |v44|)], v32, v32, v32, "hiqyfxr", v32, v32[safeIndex(-0x190, |v32|) := v10] + "mfc", "bsbqonwkb", v32, v32, v32, v32, v32[safeIndex(v2.f40, |v32|) := v10], v32, v32, v32, v32, "kasxjomfh", v32, v44[safeIndex(v2.f40, |v44|)], v32, v32];
			v45[safeIndex(935, v45.Length)] := v32 + (seq(abs(0x11b), i0  => ('c')));
			v45[safeIndex(935, v45.Length)] := v32;
		}
...
class C9 extends T2, T3 {
	...
	method m2(p0: bool, p1: T0, p2: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		...
		v0[safeIndex(333, v0.Length)] := v1;
		globalState.f12, v0[safeIndex(333, v0.Length)] := if (f30) then -f31 else safeDivisionInt(f31, f31), v1 + (v1 + v1);
		var v2: seq<bool> := [if (f27 in v0[safeIndex(333, v0.Length)]) then v0[safeIndex(333, v0.Length)][f27] else p0, !f30, fm2(true, |map[f27 := f31]|, globalState)];
		var v3 := 'v';
			...
			decreases 100 - i0
		{
			...
			match (v7.(cf0 := map[fm1(globalState) := f31] != v8)) {
				case DC1(cf1, cf2, cf3, cf4) =>
					...
					v9[safeIndex(924, v9.Length)] := if (true) then f26 else f30;
					v9[safeIndex(924, v9.Length)] := cf4;
				...
				case DC0(cf0) =>
					...
					globalState.f2 := true;
					v13[safeIndex(971, v13.Length)] := f31;
					v13[safeIndex(971, v13.Length)] := f31;
				case DC2(cf5) =>
					var v17: array<string> := new string[15];
					var v18 := "dbooou";
					v17[safeIndex(893, v17.Length)] := v18;
					var v19: set<bool> := {f30};
					v17[safeIndex(893, v17.Length)] := if (v19 > v19) then v18 else v18 + v18;
					var v20: set<int> := {f31, f31};
					var v21: array<char> := new char[20];
					var v22 := DC4(v21, 0x2db, 0x117, seq(abs(60), i3  => (v3)), "l");
					globalState.f12 := safeModuloInt(-safeModuloInt(|v18|, |v20|), v22.cf8);
			...
			var v25: seq<seq<char>> := [v24, seq(abs(0xa5), i4  => (v3))];
			v25 := v25;
			if (f30) {
				var v26: array<bool> := new bool[4];
				v26[safeIndex(357, v26.Length)] := !p1.fm2(f26, f31, globalState);
				v26[safeIndex(357, v26.Length)] := fm2(f26, f31, globalState);
				var v27: seq<array<bool>> := [v26];
				var v28: array<int> := new int[17](i5 => i5 + f31);
				v27, globalState.f24, v28, globalState.f16 := v27, p1.fm2(v26[safeIndex(357, v26.Length)], f31, globalState), v28, safeModuloInt(f31, f31);
				var v29: seq<int> := [|[f31]|];
				v28[safeIndex(292, v28.Length)] := if (p0) then f31 else |v29|;
				var v30: seq<seq<array<bool>>> := [v27, v27];
				globalState.f12, f30, v28[safeIndex(292, v28.Length)], globalState.f15 := -f31, p1.fm2(v26 in v30[safeIndex(0xae, |v30|)], 0x16, globalState), f31, f30;
				v26 := v26;
				var v31: map<D3, int> := map[DC10(v28) := v28[safeIndex(292, v28.Length)]];
			...
			var v40: set<map<bool, bool>> := {v1, v0[safeIndex(333, v0.Length)][p0 := f26], v1};
			v40 := v40 + v40;
		}
		var v41 := DC28(0xe5);
		match (v41) {
			case DC28(cf49) =>
				...
				globalState.f2 := v2[safeIndex(0xed, |v2|)];
			...
			case DC27(cf48) =>
				...
				if (f26) {
					...
					var v51 := DC0(p2);
					var v52: set<bool> := {v2[safeIndex(f31, |v2|)]};
					var v53: T2 := new C1(|v48|, 0x320, f27, p0);
					var v54: seq<T2> := [v53, v53];
					var v55: map<seq<T2>, int> := map[v54 := f31];
					var v56: array<bool> := new bool[25] [v49 > v49, f27, f26, v50 >= v50, v51.cf0, f27 || f30, f31 <= f31, p0, !f26, !({f30, p2} < v52), cf48.fm2(f27, f31, globalState), !!(f30 || f27), p0, p0, f30, fm2(f27, |v55|, globalState), v53.f26, !(f27 <==> f27), !({379} !! v47), p2, f27 <== fm2(v53.f26, f31, globalState), f27, f30, v53.f26, v2[safeIndex(f31, |v2|)]];
					v56[safeIndex(56, v56.Length)] := !v46.fm2(v53.f27, f31, globalState);
					v56[safeIndex(56, v56.Length)] := v53.f26;
					globalState.f16 := |(v48 + (v48 + (seq(abs(-0x364), i8  => (v3)))))|;
					var v57: seq<int> := [f31];
					globalState.f2 := v2[safeIndex(|v57| + f31, |v2|)];
				} else {
					...
					v63 := v63[v60 := v62];
					v43[safeIndex(435, v43.Length)] := f31;
					v43[safeIndex(435, v43.Length)], globalState.f22, globalState.f12, globalState.f12, globalState.f22 := f31, true, 0x303 - f31, f31, f27;
					var v64: multiset<int> := multiset{v43[safeIndex(435, v43.Length)]};
					v64 := v64;
					var v65: multiset<map<int, bool>> := multiset{v5};
					var v66 := DC44(v65);
					globalState.f12, v43[safeIndex(435, v43.Length)], globalState.f15, v64 := v46.fm1(globalState), |v66.cf82| * (if (f30) then f31 else |v59|), p0, v60.f29 * (v60.f29 - v64);
					var v67: multiset<char> := multiset{v3, v3, 'u', v3};
					var v68: array<bool> := new bool[7] [v67 >= multiset{v3}, p0, p2 <== true, !!f26, p2, f30, p0 || f27];
					v68[safeIndex(355, v68.Length)] := f26;
					v68[safeIndex(355, v68.Length)] := f27;
				}
				
				var v69 := DC7(p2, false, f31, |f29| - f31);
				globalState.f15, v69 := if (!p2) then p2 else p0, v69;
				var v70: array<bool> := new bool[23](i9 => f26);
				v70[safeIndex(795, v70.Length)] := cf48.fm2(f26, f31, globalState);
				v70[safeIndex(795, v70.Length)] := p0;
		}
		...
		for i11 := f31 to f31 {
			var v72 := "eobm";
			globalState.f6 := (v72[safeIndex(f31, |v72|) := 'e'] + v72)[safeIndex(i11, |(v72[safeIndex(f31, |v72|) := 'e'] + v72)|) := v3] + v72;
			globalState.f6 := v72;
	...
	method m1(p0: bool, p1: seq<string>, p2: seq<bool>, globalState: GlobalState) {
		...
		for i0 := v3.fm12(|v6|, globalState) + f31 to v9.cf8 {
			...
			v10[safeIndex(745, v10.Length)] := f31 * |"sw"|;
			v10[safeIndex(745, v10.Length)] := f31;
			...
			match (v12) {
				case DC14(cf25, cf26, cf27) =>
					...
					v16 := v16;
					globalState.f12 := safeModuloInt(f31, cf26);
				...
				case DC13(cf24) =>
					globalState.f15 := f27;
					var v22: map<seq<int>, int> := map[v1 := -v10[safeIndex(745, v10.Length)]];
					v22 := v22[v1 := v10[safeIndex(745, v10.Length)]];
					v4 := v4;
					var v23 := DC16(v8);
					var v24: map<bool, int> := map[f26 := v10[safeIndex(745, v10.Length)]];
					var v25: map<seq<int>, bool> := map[([i0] + v1)[safeIndex(v10[safeIndex(745, v10.Length)], |([i0] + v1)|) := |v23.cf29|] := v24 != v24];
					v10[safeIndex(745, v10.Length)] := |v25|;
				case DC15(cf28) =>
					var v26: map<int, bool> := map[i0 := fm2(p2[safeIndex(f31, |p2|)], i0, globalState)];
					var v27 := DC37(v26[f31 := p0]);
					var v28: map<int, int> := map[-f31 := v10[safeIndex(745, v10.Length)]];
					var v29: map<map<int, bool>, map<int, int>> := map[v27.cf68 := v28];
					var v31: map<map<int, bool>, int> := map[map[0x67 := f26] := v10[safeIndex(745, v10.Length)]];
					var v32 := DC45(v31);
					v29 := v29 + (map v30 : map<int, bool> | v30 in v32.cf83 :: (v30) := (map[|map[false := f26]| := v10[safeIndex(745, v10.Length)]]));
					var v33: map<int, seq<bool>> := map[|v8| := p2];
					var v34: map<bool, int> := map[p0 := |v8|];
					var v35 := DC34(v10[safeIndex(745, v10.Length)], f26, f31);
					var v36: multiset<D15> := multiset{v35};
					var v37: map<seq<bool>, multiset<D15>> := map[if (|v34| in v33) then v33[|v34|] else p2 := v36 + v36];
					v37 := map[p2[safeIndex(v10[safeIndex(745, v10.Length)], |p2|) := f27] := v36];
					var v38: C0 := new C0(true);
					var v39: map<bool, multiset<int>> := map[v38.f32 := f29];
					var v40: multiset<bool> := multiset{p0};
					globalState.f19, v38, globalState.f16, globalState.f6, globalState.f15 := if (f30) then v4 else v4, v38, |(v39 + map[fm2(p0, v10[safeIndex(745, v10.Length)], globalState) := f29])| * |[f26]|, v8, !(v40 >= v40);
					var v41: array<map<bool, bool>> := new map<bool, bool>[2];
					var v42: map<bool, bool> := map[f27 := f26];
					var v43 := DC29(v42);
					v41[safeIndex(893, v41.Length)] := v43.cf50 + v42;
					v41[safeIndex(893, v41.Length)] := v42;
			}
			
			var v44: map<array<int>, bool> := map[v10 := p2[safeIndex(|p2|, |p2|)]];
		...
		var v48 := DC1(p0, false, |v8|, p2[safeIndex(|v47|, |p2|)]);
		var v49 := DC2(v48);
		...
		var v50: map<bool, bool> := map[(DC19(f31, v45, v3.fm2(false, f31, globalState), map[f26 := |(seq(abs(0x167), i4  => (v4)))|]).(cf36 := f31, cf37 := v45)).cf38 := f27];
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			globalState.f2 := safeModuloInt(|(seq(abs(0x264), i5  => (f31)))|, -f31) > -(if (f27) then |{f29, v51[safeIndex(f31, |v51|)]}| else if (f26 in v52) then v52[f26] else f31);
			var v53: T1 := new C3(multiset{[f31], v1[safeIndex(f31, |v1|) := -0x1d9]}, false, p0);
			var v54 := DC46(v53);
			...
			v55[safeIndex(309, v55.Length)] := v53;
			v55[safeIndex(309, v55.Length)] := v53;
			...
			var v60: map<seq<bool>, array<bool>> := map[[p2[safeIndex(f31, |p2|)]] := v57];
			v3, v58, v59, globalState.f12 := v3, DC21(v60), v59, 110;
			var v61 := DC5(f31);
			v61 := v61;
		}
		var v62: array<int> := new int[15](i7 => safeDivisionInt(i7, f31));
		v62[safeIndex(335, v62.Length)] := f31;
		var v63: array<array<int>> := new array<int>[3];
		v63[safeIndex(174, v63.Length)] := v62;
		var v64: seq<set<bool>> := [{f27}];
		v62[safeIndex(335, v62.Length)], globalState.f15, v63[safeIndex(174, v63.Length)], v62 := |v64[safeIndex(f31, |v64|)]| - f31, f26, v62, v62;
		globalState.f15 := f27;
	}
	method m3(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: T0) {
		var v0: seq<int> := [p3];
		globalState.f16 := v0[safeIndex(f31, |v0|)];
		for i0 := p3 to -0x16c {
			...
			v3[safeIndex(913, v3.Length)] := f27;
			globalState.f6, globalState.f2, v3[safeIndex(913, v3.Length)] := (seq(abs(-0x1d), i2  => ('a'))) + p2, (p2 + fm22(-f31, f30, globalState)) == p2, f26;
			globalState.f16 := 763;
		}
		var i3 := 0;
		while (!(p3 <= -0x18f))
			decreases 100 - i3
		{
			...
			v12[safeIndex(919, v12.Length)] := if (v11 in v7) then v7[v11] else |v16|;
			var v17: map<int, int> := map[|v5| := |p2|];
			var v18: map<bool, map<int, int>> := map[v11 := v17];
			var v19 := DC49(v18);
			v12[safeIndex(919, v12.Length)] := safeModuloInt(v9, p0) - safeDivisionInt(v10, |v19.cf86|);
			v15[safeIndex(586, v15.Length)] := v11;
			var v20: map<bool, char> := map[f26 := v8];
			v15[safeIndex(586, v15.Length)] := |v20| > p1;
			v15[safeIndex(586, v15.Length)] := f27 !in multiset{f27, fm2(f27, v12[safeIndex(919, v12.Length)], globalState), false};
		}
		if (f27) {
			...
			v30[safeIndex(247, v30.Length)] := 952 + |v31|;
			v30[safeIndex(247, v30.Length)] := p0;
			var v32: array<map<int, int>> := new map<int, int>[8];
			var v33: map<int, int> := map[p1 := v30[safeIndex(247, v30.Length)]];
			v32[safeIndex(462, v32.Length)] := v33 + v33;
			v21[safeIndex(441, v21.Length)] := !f30;
			var v34 := DC1(v23[safeIndex(|[f26]|, |v23|)], true, p1, f26);
			var v35 := DC2(v34);
			v32[safeIndex(462, v32.Length)], r0, v21[safeIndex(441, v21.Length)], globalState.f12, globalState.f22 := v33, f27, v30[safeIndex(247, v30.Length)] <= (if (f26 in v28) then v28[f26] else |v33|), f31, !(fm10(f31, p3, DC2(v35), globalState) >= multiset{p3, p3});
			var v36 := DC10(v30);
			var v37: map<D3, int> := map[v36 := p0];
			var v38: C4 := new C4(v37, v21[safeIndex(441, v21.Length)], f27);
			var v39: multiset<array<int>> := multiset{v30};
			f30, globalState.f12, v38, globalState.f12 := v39 <= v39, v0[safeIndex(v24.fm1(globalState), |v0|)], if (f27) then v38 else v38, p1;
			var v40: set<int> := {v24.fm1(globalState)};
			var v41: set<bool> := {!f26, v21[safeIndex(441, v21.Length)]};
			var v42: map<int, set<bool>> := map[p3 := v41];
			var v43 := DC50(f26, |v40|, v21[safeIndex(441, v21.Length)], |v42|);
			match (v43) {
				case DC50(cf87, cf88, cf89, cf90) =>
					var v44: array<array<bool>> := new array<bool>[12];
					v44[safeIndex(562, v44.Length)] := v21;
					v21[safeIndex(441, v21.Length)], v44[safeIndex(562, v44.Length)], v30[safeIndex(247, v30.Length)], globalState.f6, globalState.f6 := cf89, v29, cf88, p2 + p2, p2;
					var v45: array<C4> := new C4[1];
					v45[safeIndex(519, v45.Length)] := v38;
					r0, v30[safeIndex(247, v30.Length)], globalState.f6, v45[safeIndex(519, v45.Length)] := !(p2 < p2), f31, "icsw", v38;
					var v46: array<seq<int>> := new seq<int>[15](i6 => [p3]);
					v46[safeIndex(401, v46.Length)] := seq(abs(0x33b), i7  => (-|p2|));
					var v47 := DC28(p3);
					v46[safeIndex(401, v46.Length)] := v0 + ([p0])[safeIndex(v0[safeIndex(v47.cf49, |v0|)], |[p0]|) := p3];
				...
				case DC51(cf91, cf92, cf93, cf94) =>
					...
					v30[safeIndex(247, v30.Length)] := DC42(|v53|, p1, p3).cf79;
					globalState.f6 := if (p2 <= p2) then if (!f30) then p2 else "hsr" else p2;
					v30[safeIndex(247, v30.Length)] := p1 + cf94;
					var v54: C1 := new C1(safeModuloInt(p3, f31), cf93, v21[safeIndex(441, v21.Length)], p0 == cf93);
					v54 := new C1(v54.f37 * p3, p0, !v21[safeIndex(441, v21.Length)], cf92.f26);
				case DC52(cf95, cf96) =>
					globalState.f12 := p1;
					v0 := v0 + (v0 + v0[safeIndex(-p0, |v0|) := p0])[safeIndex(p1, |(v0 + v0[safeIndex(-p0, |v0|) := p0])|) := f31];
					...
					v57[safeIndex(36, v57.Length)] := v58;
					globalState.f16, v57[safeIndex(36, v57.Length)], v30, globalState.f16 := (v0[safeIndex(p1, |v0|)] + p0) - -v0[safeIndex(-797, |v0|)], v58, v30, |({|v28|} * {p1, f31, p3})|;
				case DC49(cf86) =>
					var v59 := new C4(v38.f33 + v38.f33, p2 != p2, f30);
					var v60: map<bool, bool> := map[v21[safeIndex(441, v21.Length)] := v21[safeIndex(441, v21.Length)]];
					var v61 := new C4(if (f30) then v38.f33 else v59.f33, v21[safeIndex(441, v21.Length)], if (!v21[safeIndex(441, v21.Length)] in v60) then v60[!v21[safeIndex(441, v21.Length)]] else f26);
					var v62: T1 := new C4(v59.f33, f27, f26);
					var v63 := DC51(f31, v62, 875, f31);
					v30[safeIndex(247, v30.Length)] := v63.cf91;
					var v64 := 'r';
					...
					var v72 := DC32(multiset{v62.f27}, f26, f27, v21[safeIndex(441, v21.Length)], |v71[v62.f27 := v64]|);
					...
					v75[safeIndex(341, v75.Length)] := v31;
					v75[safeIndex(341, v75.Length)] := if (v21[safeIndex(441, v21.Length)]) then v31 else v31 + v31;
			}
			...
			var v86: seq<seq<int>> := [seq(abs(0x2c0), i9  => (p1))];
			var v87 := new C2(v86[safeIndex(-f31, |v86|) := [p0]], f27, f27);
		}
		
		var v88: array<string> := new string[20];
		forall i10 | 0 <= i10 < v88.Length {
			v88[i10] := seq(abs(0x2a8), i11  => (if (f30) then 'u' else 'e'));
		}
		var v89 := DC0(f30);
		var v90: seq<bool> := [!!false];
		var v91: map<bool, int> := map[f30 := f31];
		var v92: array<bool> := new bool[26] [true, fm2(f26, f31, globalState), f30, -0x21f > p1, f30 <== f27, v89.cf0, v90[safeIndex(|v91|, |v90|)], v0 <= v0, fm1(globalState) <= -p1, f27, f27, f26, "o" <= (seq(abs(0xe), i13  => ('y'))), f30, true, f27, f27, f27, f26, f30, f26, f30 <== f27, f30, f30, f30, false];
	...
	method m4(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (f27) {
			...
			match (v14) {
				case DC38(cf69, cf70, cf71) =>
					...
					v17[safeIndex(77, v17.Length)] := f30;
					var v18 := 'f';
					...
					v16, v17[safeIndex(77, v17.Length)], cf69, globalState.f16 := DC11(v18), v13 < (v13 - {f30, f30, f26}), v12.f40, |v22|;
					v12.f40 := v12.f40;
				...
				case DC37(cf68) =>
					...
					v24[safeIndex(1, v24.Length)] := !(|[v27, v27]| <= f31);
					v24[safeIndex(1, v24.Length)] := f27;
					globalState.f2 := !v12.fm44(globalState);
					v27[safeIndex(117, v27.Length)] := safeModuloInt(f31, -0x301);
					v27[safeIndex(117, v27.Length)] := v12.f40;
					globalState.f2 := v24[safeIndex(1, v24.Length)] <==> !f30;
				case DC39(cf72) =>
					var v28 := "veta";
					var v29: map<bool, int> := map[f26 := |v28|];
					var v30 := 't';
					var v31: multiset<char> := multiset{'q', v30};
					v29 := v29[multiset{v30, v30, v30} >= v31 := safeModuloInt(v12.f40, -v12.f40)];
					...
					v32 := new int[4] [-v34[safeIndex(fm39(globalState), |v34|)], -|v35| - f31, |v28|, f31];
					var v36: array<bool> := new bool[10];
					v36[safeIndex(902, v36.Length)] := f30;
					v36[safeIndex(902, v36.Length)] := if (f26) then !f27 else f27;
			}
			
			var v37: seq<int> := [v12.f40, safeModuloInt(v12.f40, |f29|)];
			var v38 := "ivqetbs";
			globalState.f12 := v37[safeIndex(|v38|, |v37|)];
			var v39: array<bool> := new bool[2](i5 => |v38| <= f31);
			v39[safeIndex(191, v39.Length)] := v12.f40 <= 0x314;
			v39[safeIndex(191, v39.Length)] := if (f31 > |f29|) then f30 else f26;
			...
			v41 := v41;
			globalState.f16 := safeDivisionInt(v12.f40, v12.f40 + 844);
			...
			if (f26) {
				...
				v45[safeIndex(166, v45.Length)] := f31;
				v45[safeIndex(166, v45.Length)] := 0x219;
				var v46 := "ohnwk";
				...
				var v53: seq<int> := [|v52|];
				var v54 := DC0(!true);
				var v55: multiset<seq<int>> := multiset{v52[safeIndex(fm4(v54, 0x2c9, 0x1c5, globalState), |v52|) := v12.f40], [-0x38f], v52};
				var v56: C3 := new C3(v55, f27, f26);
				var v57: map<bool, C3> := map[f26 := v56];
				var v58 := 's';
				var v59 := DC55(v56);
				v56 := if ((v58 !in v46[safeIndex(v12.f40, |v46|) := v58]) in v57) then v57[v58 !in v46[safeIndex(v12.f40, |v46|) := v58]] else if (f26 in v57) then v57[f26] else v59.cf103;
				globalState.f2 := f27 && f30;
				globalState.f12 := safeModuloInt(safeDivisionInt(v45[safeIndex(166, v45.Length)], v12.f40), v12.f40);
			} else {
				...
				var v67 := DC59(v61);
				var v68: array<multiset<D1>> := new multiset<D1>[27] [v61, v61 + v61, v61, v61[v63 := abs(|v62|)], v61[v63 := abs(v12.f40)] * v61, v61, multiset([v63, v63, v63]) + v61, v61, multiset{v63.(cf6 := v62)} + v61, multiset(v64), v61 + v61, multiset{v63, v63.(cf6 := v62)}, multiset(v64) + v61, v61, v61[v63 := abs(|v66|)], v61 - v67.cf109, v61, v61, v61, (multiset{v63})[v63 := abs(f31)], multiset{v63, v63, v63, v63}, v61 * v61, v61, multiset{v63, DC3(v62[safeIndex(f31, |v62|) := f26])}, v61, v61, v61];
				v68[safeIndex(641, v68.Length)] := multiset(v64);
				var v69: map<int, bool> := map[|map[v12.f40 := f30]| := f26];
				v68[safeIndex(641, v68.Length)], globalState.f12, globalState.f16, globalState.f16, v12.f40 := v61[DC3(v62) := abs(if (v41.fm2(f27, |v69|, globalState)) then v12.f40 else 120)], -safeModuloInt(v12.f40, v12.f40), v12.f40, v12.f40 + v12.f40, if (f27) then fm39(globalState) else v12.f40;
				...
				var v75: array<multiset<bool>> := new multiset<bool>[15] [v71, v71, v71, fm21(f31, globalState), v72[safeIndex(v12.f40, |v72|)], v71 - v71, if (f30 in v73) then v73[f30] else v71, v74.cf56, v71, v71, multiset(if (f27) then v62 else v62), v71, v72[safeIndex(v12.f40, |v72|)], multiset([fm2(f27, 0x31, globalState)]), v71];
				var v76: array<int> := new int[19](i6 => i6 * -v12.f40);
				var v77: seq<array<int>> := [v76];
				v75[safeIndex(434, v75.Length)] := fm21(|v77|, globalState);
				var v78: seq<int> := [v12.f40 + v12.f40];
				var v79: map<int, int> := map[v12.f40 := v12.f40];
				globalState.f16, v12.f40, v75[safeIndex(434, v75.Length)], globalState.f22 := if (f30) then v12.f40 else safeModuloInt(f31, v12.f40), v78[safeIndex(fm1(globalState), |v78|)], v71, fm2(v12.fm2(f27, v12.f40, globalState), safeDivisionInt(v12.f40, |v79|), globalState);
			}
			
			var v80: seq<seq<int>> := [[f31, f31]];
			var v81: seq<seq<seq<int>>> := [v80];
			var v82: T2 := new C2(if (f30) then v81[safeIndex(v12.f40, |v81|)] else v80, !f26 <== true, f27);
			v82 := v82;
		}
		...
		v87[safeIndex(537, v87.Length)] := f31;
		...
		v87[safeIndex(537, v87.Length)] := |(v90[safeIndex(-v12.f40, |v90|)] + (if (v12.f40 in v91) then v91[v12.f40] else v89))|;
		var v92: seq<bool> := [f26];
		var v93 := DC38(0x2ce, |v92|, f26);
		r0 := match v93 {
			case DC38(cf69, cf70, cf71) => f26
			case DC37(cf68) => !(v87[safeIndex(537, v87.Length)] < |v92|)
	...
	method m5(p0: int, p1: int, p2: bool, globalState: GlobalState) returns (r0: string, r1: int, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			var v10: map<seq<bool>, int> := map[v9[safeIndex(p1, |v9|) := true] := p0];
			...
			r1 := fm4(DC0(f26), if ([f27, f30] in v10) then v10[[f27, f30]] else p1, safeModuloInt(|v9|, |v17|), globalState);
		...
		if (fm2(p2, p1, globalState)) {
			...
			var v23 := DC47();
			v22[safeIndex(120, v22.Length)] := v23;
			globalState.f6, v21, v2, v22[safeIndex(120, v22.Length)] := v0 + (seq(abs(-0x18b), i2  => ('k'))), v21, v2, v23;
			...
			if (|(if (p2) then v24 else map[p1 := f26])| > fm4(v25, |v26|, p0, globalState)) {
				...
				v28[safeIndex(654, v28.Length)] := f29;
				var v29 := 'p';
				var v30 := DC16(v0);
				var v31: array<string> := new string[16] [v0, v0, v0, v0, v0, (seq(abs(0x371), i3  => ('h'))) + v0, "gixiulo", seq(abs(0x209), i4  => ('f')), "gxxceu", if (f30) then "qkrwt" else v0, v0[safeIndex(|v0|, |v0|) := v29], v0, v0, v0 + v0, v0, v30.cf29];
				v31[safeIndex(172, v31.Length)] := v0 + fm22(|"aj"|, f30, globalState);
				var v32: seq<multiset<bool>> := [multiset(v26), (v4[true := abs(v1[safeIndex(0x2f5, |v1|)])])[f27 := abs(p1)]];
				var v33: seq<string> := [fm22(p0, f26, globalState)];
				v4, v28[safeIndex(654, v28.Length)], v31[safeIndex(172, v31.Length)] := v32[safeIndex(if (f26 in v4) then v4[f26] else p1, |v32|)], (f29 - fm42(|f29|, globalState)) - f29, "pyblpod" + (v33[safeIndex(p1, |v33|)] + v0);
				globalState.f16 := p1;
				...
				var v47 := new C2(seq(abs(0x1b5), i6  => (v1)), f26, v46.f32);
			...
			var v55 := DC4(v54, p1, |v4|, v0, seq(abs(-896), i9  => ('k')));
			v53[safeIndex(67, v53.Length)] := DC16(v55.cf11);
			var v56: array<string> := new string[17](i10 => v0);
			v56[safeIndex(547, v56.Length)] := seq(abs(0x2c0), i11  => ('u'));
			var v57 := DC50(f30, -f31, f30, f31);
			v52, globalState.f2, globalState.f22, v53[safeIndex(67, v53.Length)], v56[safeIndex(547, v56.Length)] := v52, p1 == (p1 + ---0x382), f30, fm38(v57.cf89, -fm1(globalState), v0, globalState), seq(abs(0x278), i12  => (if (false) then 'f' else 'e'));
			...
			r0 := "ofrmiv" + v56[safeIndex(547, v56.Length)];
			globalState.f16 := f31;
			var v61: set<string> := {fm22(p0, f30, globalState), v56[safeIndex(547, v56.Length)], if (p2) then v56[safeIndex(547, v56.Length)] else "x"};
			var v62: map<string, int> := map[v56[safeIndex(547, v56.Length)] := p0];
			v61, globalState.f2 := {v56[safeIndex(547, v56.Length)]} + (set v63 : string | v63 in v62 :: (v63)), f26;
		}
	...
	method m6(p0: map<bool, int>, p1: int, p2: char, p3: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		for i0 := p1 to |(v0 + v0)| {
			var v1: array<bool> := new bool[7](i1 => [|v0|, i0] == [p1, f31, |(seq(abs(734), i2  => (p3)))|]);
			v1[safeIndex(908, v1.Length)] := if (!f26) then f30 else f26;
			var v2: map<int, bool> := map[p1 := !f26];
			v1[safeIndex(908, v1.Length)] := if (p3 in v2) then v2[p3] else true;
			var v3 := DC3([!f30]);
			var v5: seq<set<int>> := [set v4 : int | (435 <= v4) && (v4 < 0xb3) :: (safeModuloInt(v4, |p0|))];
			var v6: set<int> := {0x221, -0x21b, fm1(globalState), 0x2eb, p3};
			var v7: set<bool> := {f26, true, fm2(v1[safeIndex(908, v1.Length)], i0, globalState)};
			var v8 := DC17(|map[[v1[safeIndex(908, v1.Length)], f27] := f31]|, f31, p3, -624, p1);
			globalState.f24, globalState.f15, v1[safeIndex(908, v1.Length)], globalState.f12, v3 := fm55(globalState) != v5[safeIndex(p1, |v5|) := v6], (|v7| + |[v1[safeIndex(908, v1.Length)]]|) < f31, f30, v8.cf34, v3;
		...
		if (match v13 {
			...
			if (!((p3 * 737) > -p1)) {
				...
				var v16: map<int, char> := map[safeDivisionInt(-0x43, p3) := p2];
				v16 := v16[p1 := p2];
				var v17: multiset<int> := multiset{safeModuloInt(p3, f31), p1};
				v17 := f29;
				...
				v22[safeIndex(780, v22.Length)] := v23;
				var v24: seq<map<bool, int>> := [p0, p0];
				var v25 := DC24(v11, v24, f30);
				v21, globalState.f12, globalState.f15, globalState.f15, v22[safeIndex(780, v22.Length)] := v21, safeDivisionInt(f31, f31) - (p3 * p1), p2 in v25.cf44, f26, v23;
				var v26: map<char, bool> := map[p2 := f27];
				v26 := v26[p2 := f30];
				globalState.f12, globalState.f2, v22[safeIndex(780, v22.Length)] := f31, f26, v23;
				globalState.f15 := !false;
				globalState.f16 := p3;
			}
			...
			v27 := v27;
			var v28: map<string, string> := map[v11 := seq(abs(0x3a4), i4  => (p2))];
			globalState.f12 := |(v28 + v28[v11 := v11])|;
			v27[safeIndex(926, v27.Length)] := false;
			v27[safeIndex(926, v27.Length)] := "ioovj" != v11;
			var v29: seq<int> := [-f31, f31, p1];
			var v30: map<seq<int>, int> := map[v29 := p3];
			var v32 := DC20(seq(abs(0x28), i5  => (p1)));
			...
			var v36: map<int, map<bool, int>> := map[v35[safeIndex(p3, |v35|)] := p0];
			var v37: T0 := new C7(true, v36);
			var v38: set<int> := {p1};
			v34, globalState.f22, v37 := v34[f26 := abs(|v38|)], v35 <= v35, v37;
...
function fm0(p0: bool, globalState: GlobalState): multiset<string> {
	multiset{"cfbosyfj", seq(abs(0x3de), i0  => ('u')), "w", "u" + (seq(abs(0x37a), i1  => ('y')))}
}
function fm8(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): map<int, int> {
	map[|multiset{|(seq(abs(0x1a8), i0  => ('t')))|, |map[|map[--0x3d5 := !false]| := DC3([!true])]|}| * |(set v3 : int | v3 in map[|(map v0 : set<int> | v0 in {set v2 : int | v2 in map[|multiset{multiset{|(map v1 : int | (0x118 <= v1) && (v1 < 0x78) :: (v1 * -118) := (|{map[|"cth"| := |map[0x154 := 0x5a]|], map[|{true, true}| := 0x26e]}|))|, |[|{true}|, |{-625}|]|}}| := |multiset{|[-0xea, |"qpmel"|]|}|] :: (v2 * |(seq(abs(751), i1  => (-|(seq(abs(0x3b1), i2  => (|[false]|)))|)))|)} :: (v0) := (0x5a))| := !true] :: (v3 + |{-0x398}|))| := |map[|(set v4 : int | v4 in map[|(seq(abs(0x2e3), i3  => ('f')))| := |{false}|] :: (v4 * 0x1b6))| := |"jiwdrv"|]| - 0x276]
}
...
function fm15(globalState: GlobalState): seq<int> {
	((seq(abs(835), i0  => (|{false}|))) + [0xd7]) + (seq(abs(0xb), i1  => (0x258)))
}
...
function fm26(p0: bool, p1: bool, p2: bool, globalState: GlobalState): multiset<map<int, int>> {
	multiset{map[|['o']| := |map[327 := true]|], map[|"jsiwka"| := |"vjgqe"|]} * (multiset([map v0 : int | v0 in map[0x14e := |map[true := |{false, true}|]|] :: (safeModuloInt(v0, |{true}|)) := (0x3c9), map[0xf3 := |multiset{DC54('u', DC22(false), true, true, true).cf98, 'x'}|], map[|map[true := true]| := |[|[|(map v1 : int | (-0x2a <= v1) && (v1 < 0x257) :: (safeModuloInt(v1, 0x0)) := (335))|]|]|], map[0x30 := 0x315]]) + multiset{map[0xa2 := |"bwfgndon"|]})
}
function fm27(p0: int, p1: int, globalState: GlobalState): map<string, bool> {
	match DC54('r', DC22(true), false, true, !false) {
		...
		case DC53(cf97) => map["smnurn" := !false] + map[seq(abs(0x275), i0  => ('j')) := !true]
	}
}
...
function fm34(globalState: GlobalState): map<seq<int>, seq<D2>> {
	(map[[|"ovj"|, 0x39] := [DC6(map[|multiset{false}| := 362])]] + map[[|[true]|] := [DC6(map[|"vwg"| := 725])]]) + (map[seq(abs(412), i0  => (|"uxbg"|)) := seq(abs(0x16c), i1  => (DC6(map[|"jlhmrsu"| := |[|[false, false]|]|])))] + map[[|map[{|map[|map[|map[|map[false := |map[|map[false := 0x3e0]| := -660]|]| := true]| := false]| := |(seq(abs(-63), i2  => ('j')))|]|} := |[true]|]|] := [DC6(map v0 : int | v0 in {0x11b} :: (v0 * -|(seq(abs(980), i3  => ('g')))|) := (---0xfe))]])
}
function fm35(p0: int, globalState: GlobalState): seq<D5> {
	if (true) then seq(abs(0x44), i0  => (DC14(-|map[false := {false, true, true}]|, |map[true := |(seq(abs(161), i1  => (|map[true := true]|)))|]|, true))) else [DC14(219, |{0x112}|, false)]
}
function fm36(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): multiset<seq<D2>> {
	multiset{[DC6(map[-0x44 := -0x1e0])], seq(abs(-0xff), i0  => (DC6(map[--0xf8 := 0x1b4]))), [DC6(map[282 := 0x37f]), DC6(map v0 : int | (691 <= v0) && (v0 < 0x3d5) :: (v0 - 0xca) := (-438)), DC6(map v1 : int | (-193 <= v1) && (v1 < 0x26a) :: (safeDivisionInt(v1, 560)) := (|"ao"|))] + [DC6(map[|multiset{-0x289}| := 384])]}
}
...
function fm38(p0: bool, p1: int, p2: string, globalState: GlobalState): D6 {
	DC16((seq(abs(0x1a7), i0  => ('x'))) + (seq(abs(0x87), i1  => ('h'))))
}
function fm39(globalState: GlobalState): int {
	0x1df
}
function fm40(p0: int, p1: bool, p2: bool, globalState: GlobalState): char {
	match DC31([{!true}, {false}, {!true}, {DC24("hy", seq(abs(846), i0  => (map[true := 0x357])), true).cf46}]) {
...
function fm43(p0: int, p1: int, p2: int, p3: map<bool, char>, globalState: GlobalState): seq<int> {
	[-safeDivisionInt(|(seq(abs(0x398), i0  => ('s')))|, 0x181)]
}
...
function fm46(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<int, map<int, bool>> {
	(map[528 := map[|[true]| := false]] + map[117 := map[|map[|multiset{false}| := |multiset([|"chdvwyj"|, |(map v0 : int | v0 in [|DC19(|{'v'}|, multiset{true}, true, map[true := 794]).cf37|, |(seq(abs(0x2a8), i0  => ('t')))|] :: (v0 - 0x1a7) := (0x38d))|, |map[false := 612]|])|]| := !!true]]) + ((map v1 : int | (0x1ba <= v1) && (v1 < 367) :: (v1 + -0x160) := (map[0x1ec := false])) + map[|map[|(seq(abs(0x1bf), i1  => (0x1d1)))| := false]| := map v2 : int | (812 <= v2) && (v2 < 557) :: (v2 * 0x37e) := (true)])
}
function fm47(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<int, bool> {
	match DC37(map[610 := true]) {
		...
		case DC37(cf68) => map[|map["vtfmeu" := false]| := true] + (map v0 : int | v0 in cf68 :: (safeModuloInt(v0, -0x304)) := (true))
		case DC39(cf72) => map[|"tqifsibhn"| := true]
	}
}
function fm48(p0: int, globalState: GlobalState): multiset<char> {
	multiset{'o'} - multiset(seq(abs(460), i0  => (DC11('t').cf22)))
}
...
function fm50(globalState: GlobalState): multiset<set<int>> {
	multiset{{-0x180}} - (multiset{set v0 : int | v0 in [0x153, 982] :: (v0 - |[|(map v1 : int | (-0x170 <= v1) && (v1 < 0x64) :: (safeDivisionInt(v1, |map[|(seq(abs(-0xaf), i0  => ('i')))| := |{|map[0x3a4 := multiset{733}]|}|]|)) := (0x3dc))|, |"xnb"|]|)} * multiset{{|map[true := 0xf6]|}})
}
...
function fm53(p0: int, p1: int, p2: set<int>, p3: map<int, int>, globalState: GlobalState): D6 {
	match DC23(map[[|(map v0 : set<int> | v0 in [{|multiset{-916}|, 671}, {|map[false := true]|}, set v1 : int | v1 in [|map[true := true]|] :: (safeModuloInt(v1, |{!false}|)), {|[true, true]|}] :: (v0) := (-|(seq(abs(64), i0  => ('s')))|))|, 660] := [DC6(map v2 : int | (0x36a <= v2) && (v2 < 0x1ef) :: (v2 * -0x74) := (823)), DC6(map[461 := 0x183])]]) {
		case DC24(cf44, cf45, cf46) => DC17(-489, |map[cf46 := false]|, 0x3cd, 0x11f, 0x110)
		case DC25() => DC17(|"tu"|, |map[false := false]|, -503, 0x1a, -|"grxj"|)
		case DC23(cf43) => if (false) then DC17(|[true]|, -0xb2, -617, 0x374, |(map v3 : map<int, bool> | v3 in [map v4 : int | (0x290 <= v4) && (v4 < 0x2e8) :: (v4 + -|[true]|) := (false)] :: (v3) := (map[|map[-0x34b := !false]| := 0x21a]))|) else DC17(|(seq(abs(0x108), i1  => ('w')))|, --|"vghjbcr"|, -0x3db, |"rfqfeded"|, |['g']|)
	}
}
function fm54(p0: bool, p1: int, p2: int, globalState: GlobalState): D16 {
	DC38(-|(map v0 : int | (-0x162 <= v0) && (v0 < 574) :: (safeModuloInt(v0, -0xad)) := (false))| - 0x1bb, if (true) then |map[map[0x1b0 := -|{614, -|(map v1 : int | v1 in multiset{0x2ea, -|"wwtt"|} :: (v1 - |[0x2da]|) := ([true]))|, |"g"|}|] := [true, true, true]]| else --0x310, false)
}
function fm55(globalState: GlobalState): seq<set<int>> {
	[(set v0 : int | (284 <= v0) && (v0 < -0x62) :: (safeModuloInt(v0, 210))) + (set v1 : int | (0x13a <= v1) && (v1 < 0x241) :: (safeDivisionInt(v1, -0x11f)))]
}
...
method m0(p0: char, globalState: GlobalState) returns (r0: char, r1: seq<bool>, r2: bool, r3: map<multiset<bool>, bool>) {
	...
	if (v1[safeIndex(v2, |v1|)]) {
		...
		var v5 := DC0(v0);
		var v6: seq<D0> := [v5, v5];
		var v7 := DC2(v6[safeIndex(v2, |v6|)]);
		v4 := v4[fm10(v2, v2, v7, globalState) := v0];
		globalState.f15 := !v0;
		var v8: array<int> := new int[29];
		v8[safeIndex(61, v8.Length)] := safeDivisionInt(v2, v2);
		v8[safeIndex(61, v8.Length)] := fm39(globalState);
		globalState.f22 := v0;
		globalState.f12 := |fm22(v8[safeIndex(61, v8.Length)], v0, globalState)|;
	} else {
		...
		var v19 := DC1(true, v0, v12[safeIndex(|v18|, |v12|)], !v0);
		v15 := v15[v19.cf1 := v14];
		globalState.f2 := v0;
		var v20: array<bool> := new bool[28](i0 => true);
		v20[safeIndex(414, v20.Length)] := v0;
		v20[safeIndex(414, v20.Length)] := false;
		var v21: array<multiset<bool>> := new multiset<bool>[15] [v16, v16, v16 + v16, multiset(v1), multiset{false} + v16[v0 := abs(-v2)], v16, multiset{v20[safeIndex(414, v20.Length)]}, fm9(true, v17.f40, v0, globalState), fm21(v17.f40, globalState), v16, v16, v16 - multiset([v20[safeIndex(414, v20.Length)]]), multiset{v0, v20[safeIndex(414, v20.Length)]}, v16 - fm9(v0, v2, v20[safeIndex(414, v20.Length)], globalState), v16];
		v21[safeIndex(416, v21.Length)] := v16;
		v21[safeIndex(416, v21.Length)] := v16;
		var v22: seq<char> := [p0];
		if (|(v22 + [p0])| == 365) {
			...
			var v23 := DC25();
			v23 := DC25();
			var v24: array<int> := new int[21](i1 => safeDivisionInt(i1, |{v17.f40, -v2, |map[v20[safeIndex(414, v20.Length)] := v0]|}|));
			v24[safeIndex(201, v24.Length)] := v17.f40;
			v24[safeIndex(338, v24.Length)] := fm39(globalState);
			var v25 := DC22(v20[safeIndex(414, v20.Length)]);
			var v26: map<seq<bool>, array<bool>> := map[v1 := v20];
			var v27 := DC21(v26);
			var v28: seq<D9> := [v27];
			v17.f40, v24[safeIndex(201, v24.Length)], v0, v24[safeIndex(338, v24.Length)] := v17.f40, |(v12 + v12)|, v25.cf42, |(if (v20[safeIndex(414, v20.Length)]) then v28 else v28)|;
			globalState.f2 := v20[safeIndex(414, v20.Length)] !in v1;
			v9 := v9 + map[v17.f40 := v20[safeIndex(414, v20.Length)]];
		} else {
			var v29: set<int> := {|v11|};
			var v30 := DC22(if (v14.fm16(|v22|, [DC9(v2, |v29|, v0)], v17.f40, v17.f40, globalState)) then v20[safeIndex(414, v20.Length)] else v0);
			v30 := v30;
			r1 := v1;
			var v31 := DC9(v17.f40, v2, if (v17.f40 in v9) then v9[v17.f40] else v20[safeIndex(414, v20.Length)]);
			var v32: seq<D2> := [v31];
			var v33: map<int, int> := map[v2 := v17.f40];
			globalState.f12 := if (if (v0) then v0 else v14.fm16(v17.f40, v32, |v33|, v17.f40, globalState)) then 0x26e else safeModuloInt(v14.fm1(globalState), |multiset{v17.fm2(v0, v2, globalState)}|);
	...
	var v34: array<set<bool>> := new set<bool>[8](i2 => {true, v1[safeIndex(v2, |v1|)]} * {true, v0});
	var v35: set<bool> := {v0};
	v34[safeIndex(683, v34.Length)] := v35 + v35;
	...
	v34[safeIndex(683, v34.Length)], v39 := fm18(if (v0 in v40) then v40[v0] else v35, globalState), v39 * multiset(v41);
	...
	globalState.f16 := -v2;
	v34[safeIndex(683, v34.Length)] := fm52(true <== v0, -(|v34[safeIndex(683, v34.Length)]| - v2), globalState);
	for i3 := v2 to v2 {
		globalState.f2 := v0;
		v2 := safeModuloInt(v2, -safeDivisionInt(|multiset{i3}|, v2));
		...
		match (DC64(v46)) {
			case DC63(cf116, cf117, cf118) =>
				...
				v50 := v50[v49[safeIndex(v2, |v49|) := v48] := v0];
			...
			case DC62(cf115) =>
				...
				var v55 := DC10(v54);
				v54 := v55.cf21;
				globalState.f6 := fm22(i3, v0, globalState) + (seq(abs(219), i4  => ('v')));
				var v56: array<bool> := new bool[7](i5 => v0);
				v56[safeIndex(919, v56.Length)] := v0;
				v56[safeIndex(919, v56.Length)], globalState.f2, globalState.f2, globalState.f15 := v0, v0, v0, v0;
				var v57: multiset<array<int>> := multiset{v54, v54};
				var v58: map<bool, multiset<array<int>>> := map[true := v57];
				var v59 := DC65(v57);
				var v60: map<int, multiset<array<int>>> := map[|"hmiq"| := v57[v54 := abs(|(if (v56[safeIndex(919, v56.Length)] in v58) then v58[v56[safeIndex(919, v56.Length)]] else v59.cf120)|)] - multiset{v54, v54, v54}];
				var v61: map<D3, int> := map[v55 := v2];
				var v62: C4 := new C4(v61, v56[safeIndex(919, v56.Length)], v0);
		...
		var v66: array<int> := new int[12](i6 => safeDivisionInt(i6, v2));
		var v67: map<bool, int> := map[v0 := 0x29c];
		v66[safeIndex(78, v66.Length)] := v2 + (if (v0 in v67) then v67[v0] else v2);
		v66[safeIndex(78, v66.Length)] := -fm39(globalState) + safeModuloInt(fm39(globalState), v2);
	}
	r0 := p0;
	r1 := fm25(v0, v0 ==> v0, p0, globalState);
	r2 := v2 > v2;
	var v68: multiset<bool> := multiset{true, v0};
	r3 := map[v68 + v68 := !(v1[safeIndex(v2, |v1|) := v0] < v1)];
}
method Main() {
	var v0 := 0x3d3;
	var v1 := "ovdhmu";
	...
	var v6: map<string, array<int>> := map[seq(abs(0x1b2), i0  => ('j')) := v5];
	var v8 := 'v';
	var v9: set<char> := {v8};
	...
	if (fm0(false, globalState) > v3) {
		...
		var v38: map<int, int> := map[v0 + |v34[safeIndex(v32.f36, |v34|)]| := |v37|];
		v38 := v38[v0 := v0 + v0];
		var v39 := DC11('b');
	...
	v41[safeIndex(434, v41.Length)] := v14;
	v41[safeIndex(434, v41.Length)] := v14;
	var v42: seq<int> := [v0, v0, v0, v0];
	var v43: map<array<bool>, bool> := map[v41 := v14];
	var v44: map<bool, bool> := map[v41[safeIndex(434, v41.Length)] := v41[safeIndex(434, v41.Length)]];
	var v45: seq<bool> := [v14];
	var v46: multiset<int> := multiset{|v45|, v0, v0};
	var v47: T2 := new C9(v14, |v44|, !v41[safeIndex(434, v41.Length)], !v14, v46);
	var v48: seq<T2> := [v47];
	var v49: multiset<int> := multiset{|v43|, v0, |v48|};
	var v50: C8 := new C8(multiset{|v42[safeIndex(|v49|, |v42|) := -790]|});
	var v51: array<C8> := new C8[2] [v50, v50];
	v51[safeIndex(758, v51.Length)] := v50;
	v51[safeIndex(758, v51.Length)] := v50;
	...
	var v59, v60 := v47.m2(v41[safeIndex(434, v41.Length)], v58, v41[safeIndex(434, v41.Length)], globalState);
	var v61, v62, v63, v64 := m0(v59, globalState);
	var v65: multiset<bool> := multiset{v41[safeIndex(434, v41.Length)]};
	if ((multiset{v41[safeIndex(434, v41.Length)]} - v65) !! v65[v63 := abs(v60)]) {
		var v66, v67 := v47.m2(v47.f27, v58, v47.f27, globalState);
		v5[safeIndex(49, v5.Length)] := v0;
		var v68: multiset<seq<int>> := multiset{v42};
		var v69: C3 := new C3(if (true) then multiset{v42, [v67]} else v68, v58.fm2(v47.f27, v0, globalState), v41[safeIndex(434, v41.Length)]);
		v5[safeIndex(49, v5.Length)], v69 := v67 * (v0 + |"nhcidbx"|), v69;
		v44 := v44[v42[safeIndex(v0, |v42|)] == -v5[safeIndex(49, v5.Length)] := v47.f26];
		var v70: seq<string> := ["oujjykne", v1];
		v69.m1(v47.f26, v70[safeIndex(-v0, |v70|) := v1], fm25(v47.f26, v47.f26, v66, globalState), globalState);
		var v71: map<int, array<bool>> := map[370 := v41];
		v71 := v71[v5[safeIndex(49, v5.Length)] := v41];
	} else {
		globalState.f2 := v47.f26 ==> v41[safeIndex(434, v41.Length)];
		...
		var v78: array<map<int, bool>> := new map<int, bool>[12] [v72, v72, map[v0 := v47.f27], map[|v1| := v47.f26] + map[|v42| := v47.fm2(v41[safeIndex(434, v41.Length)], v60, globalState)], if (v63 in v73) then v73[v63] else v72, map v74 : int | (0x64 <= v74) && (v74 < 0x8) :: (v74 + v60) := (v47.f27), v72, v72, v72, v72, (map[v0 := v47.f26])[|v76| := v41[safeIndex(434, v41.Length)]], map v77 : int | v77 in v49 :: (safeModuloInt(v77, v60)) := (v41[safeIndex(434, v41.Length)])];
		v78[safeIndex(490, v78.Length)] := v72;
		v78[safeIndex(490, v78.Length)] := v72 + v72;
		v47.m1(v47.f27, [v1, v1], v62, globalState);
		v5[safeIndex(742, v5.Length)] := v0 + |"rodtn"|;
		v5[safeIndex(742, v5.Length)] := v0 + v0;
		var v79: C5 := new C5(v47.f27, v58.fm2(true, 0x90, globalState));
		var v80 := DC62(v51[safeIndex(758, v51.Length)]);
		...
		v5[safeIndex(742, v5.Length)], v79, v51[safeIndex(758, v51.Length)], v62, v0 := -755 - 0x8, v79, v80.cf115, v62, safeDivisionInt(v0, v85.cf112);
	}
	
	globalState.f2 := v41[safeIndex(434, v41.Length)];
	var v86: array<C5> := new C5[27];
	var v87: C5 := new C5(v63, v14);
	v86[safeIndex(461, v86.Length)] := v87;
	var v88: seq<T0> := [v58, v58];
	globalState.f19, globalState.f12, v86[safeIndex(461, v86.Length)], globalState.f15, globalState.f22 := v59, v0, v87, !v14, [v58, v58, v58, v58, v58] <= (v88 + v88);
	var v89: seq<array<int>> := [v5, v5, v5];
	v5 := v89[safeIndex(|v16|, |v89|)];
	match (DC18(v47)) {
		case DC19(cf36, cf37, cf38, cf39) =>
			v41[safeIndex(434, v41.Length)] := v58.fm2(v47.f26, cf36, globalState);
			v87.m7(multiset(v42) >= v46, v47.f26, -safeDivisionInt(cf36, v60), v46, globalState);
			v5 := v5;
		...
		case DC18(cf35) =>
			...
			var v93: map<int, bool> := map[|v52| := v41[safeIndex(434, v41.Length)]];
			globalState.f16 := if ((seq(abs(-0x73), i3  => (v8))) in v92) then v92[seq(abs(-0x73), i3  => (v8))] else |v93|;
			if (multiset(v1 + v1) != multiset([v61])) {
				var v94 := DC0(cf35.f26);
				globalState.f16 := -safeDivisionInt(safeDivisionInt(0x2f1, v47.fm4(v94, v0, v0, globalState)), 0x7b);
				globalState.f24 := v41[safeIndex(434, v41.Length)];
				v41[safeIndex(434, v41.Length)] := if (cf35.f26) then v41[safeIndex(434, v41.Length)] else 's' !in v1;
				v41[safeIndex(434, v41.Length)] := cf35.f27;
				...
				var v98 := new C9(false, v0, v47.f27, v97[safeIndex(v0, |v97|)] != v1, v49);
				var v99: T1 := new C5(!cf35.f26, v47.f27);
				v99 := v99;
				globalState.f22 := v58.fm2(v14 ==> !cf35.f26, v60, globalState);
				var v100 := DC0(false);
				globalState.f16 := cf35.fm4(v100, safeModuloInt(|v45|, v42[safeIndex(v98.f31, |v42|)]), if (v41[safeIndex(434, v41.Length)]) then v0 else v0, globalState);
			}
			...
			var v104 := DC15(v103);
			v104 := if (if (v41[safeIndex(434, v41.Length)]) then cf35.f27 else true) then if (v63) then v104.(cf28 := v103) else v104 else v104;
	}
		...
		decreases 100 - i4
	{
		...
		i4 := i4 + 1;
		var v105: map<int, bool> := map[563 := v41[safeIndex(434, v41.Length)]];
		var v106 := DC37(v105);
		...
		match (v108) {
			case DC44(cf82) =>
				...
				v16 := v16;
				v60 := safeDivisionInt(v0, v58.fm1(globalState));
				var v109: map<array<int>, bool> := map[v5 := v41[safeIndex(434, v41.Length)]];
				v63, globalState.f12 := v47.f27, |((v109 + map[v5 := v47.f27]) + v109)|;
		}
		
		if (v41[safeIndex(434, v41.Length)]) {
			globalState.f22 := true;
			var v110: array<string> := new string[1](i5 => "glxoh" + v1);
			var v111: map<int, string> := map[v60 := v1];
			v110[safeIndex(626, v110.Length)] := (seq(abs(-0x46), i6  => ('b'))) + (if (v0 in v111) then v111[v0] else v1);
			v110[safeIndex(626, v110.Length)] := v1 + v1;
			var v112 := DC10(v5);
			...
			v115 := v115;
			globalState.f6 := v1;
			globalState.f6 := v110[safeIndex(626, v110.Length)];
		} else {
			globalState.f24 := v47.f27;
			var v116 := new C1(|v42|, v60, v0 in v2, v47.f26);
			var v117: array<char> := new char[8](i7 => v61);
			v117[safeIndex(346, v117.Length)] := v59;
			v117[safeIndex(346, v117.Length)] := v61;
			v41[safeIndex(434, v41.Length)] := v14;
			var v118: map<int, char> := map[v42[safeIndex(-v116.f37, |v42|)] := v8];
			v118 := v118[v60 := v117[safeIndex(346, v117.Length)]];
		}
		
		var v119: map<seq<int>, int> := map[v42 := v0];
		var v120: set<C5> := {v86[safeIndex(461, v86.Length)]};
		var v121: seq<set<C5>> := [v120, v120, v120, v120];
		v119 := v119[v42 + v42 := |v121[safeIndex(v0, |v121|)]|];
		var v122: array<T1> := new T1[8];
		v122 := v122;
	}
	for i8 := |{false, v41[safeIndex(434, v41.Length)], v47.f26, v14}| to v60 {
		v41 := v41;
		var v123: set<bool> := {v47.f26, v47.f26, v41[safeIndex(434, v41.Length)]};
		var v124 := DC5(-|v123|);
		globalState.f16, globalState.f12, globalState.f12, globalState.f24 := i8 - v124.cf12, v0, 855, v2 !! {i8};
		globalState.f12, v41[safeIndex(434, v41.Length)] := -0x1c7, v47.fm2(false, |map[v60 := --0x3a4]|, globalState);
	...
	print v8, "\n";
	print v9 == {'v'}, "\n";
	print v10 == map[979 := map['v' := -441]], "\n";
	print v11 == map['v' := 979], "\n";
	print v12 == map[map['v' := -441] := 979], "\n";
	print globalState.f0 == {979, -6}, "\n";
	print globalState.f1 == multiset{"ovdhmu"}, "\n";
	...
	print globalState.f25 == map[map['v' := -441] := 979], "\n";
	print v14, "\n";
	print v15 == multiset{map[false := 979]}, "\n";
	print v16 == map[false := 979], "\n";
	print v17 == map[map[false := 979] := false], "\n";
	print v41[0], "\n";
	print v41[1], "\n";
	print v41[2], "\n";
	print v41[3], "\n";
	print v42 == [979, 979, 979, 979], "\n";
	print |v43|, "\n";
	print v44 == map[false := true], "\n";
	print v45 == [false], "\n";
	print v46 == multiset{1, 979, 979}, "\n";
	print v47.f26, "\n";
	print v47.f27, "\n";
	print |v48|, "\n";
	print v49 == multiset{1, 1, 979}, "\n";
	print v51[0].f29 == multiset{4}, "\n";
	print v51[1].f29 == multiset{4}, "\n";
	print v52 == map[979 := 979], "\n";
	print v55[0] == map[979 := 979], "\n";
	print v55[1] == map[979 := 979], "\n";
	print v55[2] == map[979 := 979], "\n";
	print v55[3] == map[979 := 979], "\n";
	print v55[4] == map[1 := 979], "\n";
	print v55[5] == map[979 := 979], "\n";
	print v55[6] == map[979 := 979], "\n";
	print v55[7] == map[1958 := 979], "\n";
	print v55[8] == map[979 := 979, 6 := 2], "\n";
	print v55[9] == map[979 := 979], "\n";
	print v55[10] == map[979 := 6], "\n";
	print v55[11] == map[1 := 979, 979 := 979], "\n";
	print v55[12] == map[979 := 979], "\n";
	print v55[13] == map[979 := 979], "\n";
	print v55[14] == map[979 := 979], "\n";
	print v55[15] == map[979 := 979], "\n";
	print v55[16] == map[9 := 1], "\n";
	print v55[17] == map[979 := 979], "\n";
	print v55[18] == map[979 := 979], "\n";
	print v55[19] == map[979 := 979], "\n";
	print v55[20] == map[979 := 979], "\n";
	print v55[21] == map[979 := 979], "\n";
	print v55[22] == map[979 := 979], "\n";
	print v56.cf29, "\n";
	print |v57|, "\n";
	print v59, "\n";
	print v60, "\n";
	print v61, "\n";
	print v62 == [false, true], "\n";
	print v63, "\n";
	print v64 == map[multiset{true, true, true, true} := true], "\n";
	print v65 == multiset{false}, "\n";
	print v86[2].f26, "\n";
	print v86[2].f27, "\n";
	print |v88|, "\n";
	print |v89|, "\n";
