...
method m0(p0: bool, p1: bool, globalState: GlobalState) returns (r0: seq<int>, r1: int, r2: bool) {
	...
	match (fm2(v7.cf5, globalState)) {
		case DC1() =>
			...
			var v9: map<bool, int> := map[v8[v1] := v1];
			...
			var v16: array<string> := new string[16] [v13, v13 + v13, v13, v13, v13 + v13, if (p1 in v15) then v15[p1] else v13[v1 := 'w'], v13, seq(0x1ea, i1  => ('m')), v13, if (p0) then v13 else v13, v13, v13 + v13, "rwsgvn", fm3(globalState), v13 + v13, v13];
			var v17 := 'v';
			var v18: array<char> := new char[4] [v17, v17, v17, v17];
			var v19: seq<C0> := [v3];
			var v20: array<C0> := new C0[10] [v19[v1], v3, v3, v3, v3, v3, v3, v3, v3, v3];
			...
			var v25: array<map<array<bool>, array<C0>>> := new map<array<bool>, array<C0>>[23] [if (v18 in v23) then v23[v18] else map[v0 := v20], v22, v22 + v22, v22, v22, v22, v22, v22, v22 + map[v0 := v20], DC6(map[v0 := v20]).cf7, v22, v22, v22, v22, v22, v22 + map[v0 := v20], v22, map[v0 := v20], v24[v1], v22 + v22, v22 + v22, v22, v22[v0 := v20]];
			v25[548] := v22;
			r2, v12, v16, v25[548] := p0, v12, v16, v22 + v22;
			...
			var v30: map<bool, array<int>> := map[(if (p0 in v27) then v27[p0] else multiset{v1, |v28|, 0x39, v1}) > v11 := v29[v1]];
			var v31 := DC8(v10);
			v26[132] := if (p1 in v30) then v30[p1] else v31.cf10;
			r2 := !!!p0;
		case DC0(cf0) =>
			var v32 := DC5(seq(-0x32, i2  => (v1)));
			v2 := v3.f0 + v32.cf6;
			var v33 := 'y';
			v33 := v33;
			r1 := v1 - -0x26;
	...
	r2, r2, v0[314], v37 := p0, (v38 <= v38) !in v39, v40 > v40, v37;
	var v41 := new C0(v2 + v3.f0);
	var v42: array<map<bool, D0>> := new map<bool, D0>[9](i3 => if (false) then map[v0[314] := DC1()] else map[v0[314] := DC1()]);
	var v43 := DC1();
	var v44: map<bool, D0> := map[p0 := v43];
	v42[646] := v44;
	v42[646] := match fm7(v0[314], globalState) {
		case DC1() => v44
		case DC0(cf0) => v44
	};
...
method Main() {
	...
	var v6 := DC0(false);
	v2, v4, v3 := v2, (map v5 : int | (-0x2d5 <= v5) && (v5 < -518) :: (v5 % v2) := (--v2)) + v4, v3 <==> v6.cf0;
	forall i0 | 0 <= i0 < v0.Length {
		v0[i0] := v3;
	}
	var v7 := 'y';
	...
	if (!v3) {
		...
		if (v3) {
			...
			v28[611] := if (v2 in v32) then v32[v2] else 850 / -v2;
			...
			var v37, v38, v39 := m0(v3, !(-|v36| < v34.fm5(v3, v3, v3, v28[611], globalState)), globalState);
		} else {
			var v40: set<bool> := {!v3};
			...
			var v45: map<bool, int> := map[v43[v2] := if (DC1() in v44) then v44[DC1()] else v2];
			v2 := (|v45| % v2) + v2;
		}
	...
	if (v6.cf0) {
		...
		v2, v3, v55[637], v2, v55[597] := -v2, v6.cf0, v2, 0xf6, -(|v14| / DC4(v60, v2).cf5) - v58.fm5(false, v3, v3, fm4(v2, v2, v3, v3, globalState), globalState);
		v3 := multiset(v52) >= v53;
		v3 := true;
	} else {
		v4 := v4[v2 := -v2];
	...
	v75 := if (v3) then -0x226 else -v2 % -v75;
}