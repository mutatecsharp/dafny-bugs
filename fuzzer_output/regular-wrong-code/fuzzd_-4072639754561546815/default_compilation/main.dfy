...
class C1 extends T1 {
	...
	function fm16(p0: seq<int>, p1: bool, p2: bool, p3: bool, globalState: GlobalState): string {
		(seq(abs(0x213), i0  => ('m'))) + ((seq(abs(0x1b0), i1  => ('h'))) + "lriggcwfc")
	}
	...
	method m2(p0: bool, p1: multiset<bool>, p2: multiset<bool>, globalState: GlobalState) returns (r0: int, r1: array<multiset<bool>>, r2: string, r3: int) {
		...
		r0 := |([v0[safeIndex(|v1|, |v0|)]] + ([f31, f31, f31] + v0))[safeIndex(f32 - |(seq(abs(-955), i0  => ('o')))|, |([v0[safeIndex(|v1|, |v0|)]] + ([f31, f31, f31] + v0))|) := p0]|;
			...
			decreases 100 - i1
		{
			...
			if (fm17(v10, globalState)) {
				...
				var v14 := DC7(v10, v13);
				var v15 := "hxuqqi";
				var v16: map<set<bool>, bool> := map[v14.cf10 := v15 == (seq(abs(0x2d6), i2  => (v10)))];
				v16 := v16;
				var v17 := new C0(f31);
			} else {
				...
				var v22: map<multiset<bool>, bool> := map[v18[safeIndex(|v21|, |v18|)] := f31];
				...
				v25[safeIndex(509, v25.Length)] := map v26 : multiset<bool> | v26 in [p2] :: (v26) := (!p0);
				var v27 := DC19(v22);
				v25[safeIndex(509, v25.Length)] := (if (p0) then v27 else v27).cf29;
				var v28 := "kyqocej";
				var v29 := DC10(v28, 0x18e, false);
				var v30: map<string, bool> := map[v29.cf13 := p0];
				var v31: array<bool> := new bool[18] [f31, false, f31, p0, f31, if (v28 in v30) then v30[v28] else !p0, f31, f31, f31, f31, f31, false, multiset(v1) !! (multiset(seq(abs(360), i3  => (|map[f32 := p0]|))))[f32 := abs(f32)], p0, f31 <==> p0, p0, p0, p0];
				v31[safeIndex(928, v31.Length)] := f31 && f31;
				v31[safeIndex(928, v31.Length)] := false;
				globalState.f16 := v31[safeIndex(928, v31.Length)];
				v31[safeIndex(928, v31.Length)] := if (f31) then f32 <= 0x129 else |v1| == |p1|;
				r0 := f32;
			}
		...
		v33[safeIndex(109, v33.Length)] := f32;
		var v34: map<int, bool> := map[f32 := !f31];
		v33[safeIndex(109, v33.Length)] := |(v34 + (v34 + v34))|;
		var v35: multiset<int> := multiset{f32};
		var v36: array<bool> := new bool[4] [f31, v33[safeIndex(109, v33.Length)] <= f32, f31, p0];
		v36[safeIndex(564, v36.Length)] := false;
		var v37 := DC10("cjaamgms", f32, f31);
		var v38: seq<multiset<int>> := [v35, v35];
		r2, v35, v36[safeIndex(564, v36.Length)] := v37.cf13, v38[safeIndex(|v1|, |v38|)] + v35[f32 := abs(f32)], true;
		r0 := f32;
		r1 := new multiset<bool>[14];
		var v39 := "kip";
		r2 := v39;
		r3 := -safeDivisionInt(f32, (if (f31 in p2) then p2[f31] else f32) + v33[safeIndex(109, v33.Length)]);
	}
	method m5(globalState: GlobalState) returns (r0: int, r1: bool, r2: multiset<set<int>>, r3: bool) {
		...
		var v2: seq<seq<int>> := [v1, [f32] + v1, v1 + (seq(abs(0x253), i0  => (f32)))];
		var v3: array<int> := new int[2];
		v3[safeIndex(373, v3.Length)] := 291;
		var v4 := 'o';
		var v5: seq<bool> := [f31];
		var v6: set<seq<bool>> := {v5, [f31, f31], v5, v5, [f31]};
		r0, v2, r0, r0, v3[safeIndex(373, v3.Length)] := f32, v2, f32, fm18(fm17(v4, globalState), f31, globalState), |(v6 + v6)| * f32;
		r1 := f31;
		var i1 := 0;
		while (f31)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v7: map<int, seq<bool>> := map[v3[safeIndex(373, v3.Length)] := v5];
			var v10: array<map<int, seq<bool>>> := new map<int, seq<bool>>[14] [v7, v7 + v7, map[f32 := [f31]], v7[v3[safeIndex(373, v3.Length)] := v5] + (map[f32 := v5])[v3[safeIndex(373, v3.Length)] := v5], map[-0x309 := v5], v7, map v8 : int | (0xbd <= v8) && (v8 < 0x25) :: (safeModuloInt(v8, 58)) := (v5), v7, map v9 : int | (0x2cf <= v9) && (v9 < 0x289) :: (v9 + v3[safeIndex(373, v3.Length)]) := (v5), v7, map[v3[safeIndex(373, v3.Length)] := v5], if (f31) then v7 else v7, v7, v7];
			v10[safeIndex(778, v10.Length)] := v7;
			v10[safeIndex(778, v10.Length)] := v7;
			v1 := v1;
			var v11 := "smv";
			v11 := v11;
		...
		var v12 := "cxidk";
		for i2 := v3[safeIndex(373, v3.Length)] to |v12| {
			...
			match (DC10(v12, 0x179, f31).(cf14 := f32, cf15 := true)) {
				case DC10(cf13, cf14, cf15) =>
					r0 := cf14;
					v3[safeIndex(373, v3.Length)] := f32;
					var v16: array<array<int>> := new array<int>[15];
					v16[safeIndex(136, v16.Length)] := v3;
					v16[safeIndex(136, v16.Length)] := v3;
				...
				case DC9(cf12) =>
					r0 := if (v15 && v15) then v3[safeIndex(373, v3.Length)] else i2;
					var v22: array<bool> := new bool[12];
					v22[safeIndex(865, v22.Length)] := v15;
					var v23: map<bool, int> := map[v15 := v3[safeIndex(373, v3.Length)]];
					v3[safeIndex(373, v3.Length)], globalState.f16, v22[safeIndex(865, v22.Length)], v3[safeIndex(373, v3.Length)], v13 := f32, v13, if (v14 !in v23) then v13 else f31, f32, f31;
					var v24: array<seq<bool>> := new seq<bool>[6] [v5, v5, v5, v5, [v13], v5];
					v24[safeIndex(295, v24.Length)] := v5 + v5;
					r0, v24[safeIndex(295, v24.Length)], globalState.f16, v13, r0 := v3[safeIndex(373, v3.Length)], v5, v14, v15, safeDivisionInt(f32, i2);
					var v25, v26, v27 := m6(v14, globalState);
				case DC11(cf16) =>
					var v28: set<int> := {v3[safeIndex(373, v3.Length)]};
					var v29: array<bool> := new bool[20];
					var v30 := DC14(v28, i2, true, v29);
					r0 := v30.cf20;
					v3[safeIndex(373, v3.Length)] := i2;
					v3[safeIndex(373, v3.Length)] := -f32;
					var v31 := new C0(!v13);
			}
			
			v3[safeIndex(373, v3.Length)] := v3[safeIndex(373, v3.Length)];
			if (v13) {
				v12 := seq(abs(0x1d4), i3  => (v4));
				r0 := f32;
				var v32: set<char> := {v4};
				v32 := v32;
				var v33 := DC1(v4, f31, false);
				v33 := v33.(cf3 := |v12| > v3[safeIndex(373, v3.Length)], cf1 := v4);
				var v34 := new C0(v15);
			} else {
				var v35: map<int, bool> := map[|v0| := f31];
				var v36: array<set<int>> := new set<int>[14](i4 => {i2, i2});
				var v37 := DC17(v15, v36, i2);
				var v38: map<map<int, bool>, seq<bool>> := map[v35 := [v5[safeIndex(f32, |v5|)], v37.cf25, v13]];
				var v39: array<char> := new char[5](i5 => 'r');
				v39[safeIndex(392, v39.Length)] := v4;
				var v40 := DC2(f31);
				var v41: map<D0, char> := map[v40 := v4];
				v4, v13, v38, v39[safeIndex(392, v39.Length)] := fm20("gswdyire" + (seq(abs(0x234), i6  => (v4))), v0, f31, f32, globalState), v14 <==> (v13 <== true), v38[v35 := v5], if (v40 in v41) then v41[v40] else 'o';
				v4, globalState.f16 := v4, v13;
				v36 := (if (true) then v37.(cf26 := v36) else v37).cf26;
				var v42 := DC10("rpccqjlr", |v12[safeIndex(847, |v12|) := v39[safeIndex(392, v39.Length)]]|, v13);
				v12 := v42.cf13;
				v35, v3[safeIndex(373, v3.Length)] := fm21(v0, v14, v12[safeIndex(f32, |v12|) := fm20(fm16(v1, v15, v13, v14, globalState), v0, f31, |v0|, globalState)] != v12, globalState), i2;
			}
			
		}
		globalState.f28 := v3[safeIndex(373, v3.Length)] == (f32 - 0x8d);
		r0 := f32;
		...
		r2 := if (f31) then multiset(fm22(f32, globalState)) - v44 else v44 + v44[v43 := abs(|fm23(v46, map[false := |v12|], "lqta", globalState)|)];
		r3 := f31;
	}
	method m6(p0: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool) {
		...
		var v5 := DC10((seq(abs(162), i0  => ('q'))) + v1, |multiset(v4)|, f31);
		match (v5) {
			case DC10(cf13, cf14, cf15) =>
				cf14 := cf14;
				...
				match (v11) {
					case DC1(cf1, cf2, cf3) =>
						...
						var v15: array<seq<array<D3>>> := new seq<array<D3>>[4] [([v13] + [v13, v13])[safeIndex(cf14, |([v13] + [v13, v13])|) := v13], v14, v14, v14];
						v15[safeIndex(97, v15.Length)] := v14;
						v15[safeIndex(97, v15.Length)] := v14;
						var v16: map<int, int> := map[0x200 := |v1|];
						var v17: set<map<int, int>> := {v16};
						var v18: map<bool, set<map<int, int>>> := map[|cf13| == f32 := v17 + v17];
						var v21: seq<set<map<int, int>>> := [set v20 : map<int, int> | v20 in (set v19 : map<int, int> | v19 in (seq(abs(0x2aa), i1  => (map[cf14 := |cf13|]))) :: (v19)) :: (v20), if (p0 in v18) then v18[p0] else v17];
						v18 := v18[p0 := v21[safeIndex(f32, |v21|)]];
						cf13 := cf13;
					case DC2(cf4) =>
						var v22 := 'w';
						...
						v28 := v28[multiset{v1, seq(abs(0x2df), i2  => (v22))} := v27];
					...
					case DC3(cf5) =>
						...
						v31[safeIndex(865, v31.Length)] := cf15;
						var v32: map<D0, int> := map[v9 := cf14];
						v31[safeIndex(865, v31.Length)] := v6[safeIndex(if (v9 in v32) then v32[v9] else 0x2f7, |v6|)];
						v0[safeIndex(395, v0.Length)] := |(cf13 + cf13)|;
						var v33: seq<string> := [cf13, "ufldtem", cf13];
						var v34: array<string> := new string[21] ["eohrqs", v1, v1, v1, cf13, v5.cf13 + cf13, v1, "vet", v1 + v1, "et", cf13, v33[safeIndex(0x197, |v33|)], cf13, v1, v1, v1 + v1, cf13 + "fvmafgib", cf13, v1, v5.cf13, seq(abs(0x386), i3  => (cf5))];
						v34[safeIndex(44, v34.Length)] := v1;
						cf14, cf14, v0[safeIndex(395, v0.Length)], v34[safeIndex(44, v34.Length)] := f32, f32, cf14 * -720, cf13;
						var v35 := DC6(f32);
						var v36 := DC12({v35});
						var v37: map<int, char> := map[cf14 := cf5];
						var v38: array<char> := new char[13] [cf5, 'u', cf5, cf5, if (v0[safeIndex(395, v0.Length)] in v37) then v37[v0[safeIndex(395, v0.Length)]] else cf5, cf5, cf5, cf5, cf5, cf5, 'v', cf5, cf5];
					...
					case DC0(cf0) =>
						...
						v43[safeIndex(339, v43.Length)] := v44;
						v43[safeIndex(339, v43.Length)] := v44;
					case DC4(cf6) =>
						var v45: multiset<bool> := multiset{p0};
						var v46: map<bool, bool> := map[v6[safeIndex(|v45|, |v6|)] := f31];
						var v47: array<bool> := new bool[4] [cf15, cf15, if (true in v46) then v46[true] else v11.cf4, f31];
						var v48: map<array<bool>, bool> := map[v47 := 693 <= fm18(v6[safeIndex(0x1ee, |v6|)], cf15, globalState)];
						v48 := v48[v47 := cf15];
						...
						var v52 := 'u';
						v49, v46, globalState.f28, r0 := v50[safeIndex(|v51|, |v50|)], v46, (v45 - v45) < (v45 - v45), fm17(v52, globalState);
						cf14 := -842;
						cf15 := v5.cf15;
				}
				
				var v53: seq<array<seq<bool>>> := [v7, v7];
				var v54 := DC0(v53[safeIndex(cf14, |v53|)]);
			...
			case DC11(cf16) =>
				...
				var v68 := 'd';
				v67[safeIndex(803, v67.Length)] := [v68];
				var v69: seq<int> := [f32, f32];
				v66, r2, v67[safeIndex(803, v67.Length)], r2 := (v66 + v66) + (v66[v0 := f32] + v66), v63 <= v69[safeIndex(873, |v69|)], v1, p0;
				var v70: map<bool, int> := map[f31 := -f32];
				v0[safeIndex(531, v0.Length)] := if (f31) then v63 else |v70|;
				v0[safeIndex(531, v0.Length)] := f32;
				m0(v0[safeIndex(531, v0.Length)], globalState);
		}
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			v1 := v1;
			var v75: array<string> := new seq<char>[1](i5 => seq(abs(-0x21f), i6  => (v74)));
			var v76: array<array<string>> := new array<string>[6] [v75, v75, v75, v75, v75, v75];
			v76[safeIndex(243, v76.Length)] := v75;
			v76[safeIndex(243, v76.Length)] := v75;
...
class C2 extends T0 {
	...
	method m4(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool, r1: array<map<D2, bool>>) {
		...
		for i1 := p1 to p1 {
			var v24: map<int, bool> := map[safeModuloInt(p1, |map[i1 := i1]|) := f31];
			v24 := v24[p1 := f31];
			var v25: array<seq<bool>> := new seq<bool>[20];
			var v26: map<array<seq<bool>>, int> := map[v25 := p1];
			v26 := v26[v25 := safeModuloInt(p0, --0x2b2)];
			var v27 := new C0(f31);
			var v28: array<int> := new int[8](i2 => safeDivisionInt(i2, p1));
			var v29 := DC5(v28);
			match (v29) {
				case DC5(cf7) =>
					...
					v31, v32, v33, v33, globalState.f28 := v31[safeIndex(|fm15(p2, globalState)|, |v31|) := v30 + v30], v32, -|((v0 + v0) + v0)|, fm12(|[true, f31, p2, f31, p2]|, fm13(p0, globalState), p0, {i1} - v35, globalState), p2;
					var v36: multiset<bool> := multiset{f31};
					var v37: map<bool, string> := map[f31 := ("jhpbetysj" + fm0(v36, globalState))[safeIndex(fm13(p1, globalState), |("jhpbetysj" + fm0(v36, globalState))|) := 'p']];
					v37 := v37[true := v0];
		...
		v0 := (seq(abs(0x37b), i3  => (if (p3) then v1 else v1)))[safeIndex(|v0|, |(seq(abs(0x37b), i3  => (if (p3) then v1 else v1)))|) := v1];
		var i4 := 0;
		while (f31)
			decreases 100 - i4
		{
			...
			var v42: seq<int> := [p0, |(if (p3) then v0 else v0)|, safeDivisionInt(|v41|, p0), p0];
			v42 := v42;
			...
			if ((p1 !in multiset(v42)) !in f38) {
				...
				v45 := |v48[safeIndex(if (v50 in v51) then v51[v50] else p1, |v48|) := v40]|;
				var v52: map<int, bool> := map[-v50.f32 := fm26(f31, p2, p3, -v50.f32, globalState)];
				v52 := v52[v50.f32 := p2];
			} else {
				var v53: seq<string> := [v0];
				v0 := ("xyaujnuy" + v0) + v53[safeIndex(p0, |v53|)];
				var v54: map<int, array<bool>> := map[safeModuloInt(|v3|, -p0) := v43];
...
class C3 extends T0 {
	...
	method m3(p0: D0, p1: seq<bool>, p2: int, p3: bool, globalState: GlobalState) {
		var v0 := -523;
		v0 := safeModuloInt(p2, p2);
		if (p3) {
			var v1 := "uda";
			var v2: array<string> := new string[10] [v1, v1 + v1, v1, v1, (seq(abs(0x3c), i0  => ('y'))) + v1, v1, v1, v1, v1 + "j", "qviqoktq"];
			v2[safeIndex(410, v2.Length)] := v1;
			v2[safeIndex(410, v2.Length)] := "ldgnc";
			var v4: map<int, int> := map[v0 := v0];
			var v5: multiset<int> := multiset{|(map v3 : int | v3 in v4 :: (v3 * |("h")[safeIndex(p2, |"h"|) := 'o']|) := (f31))|};
			...
			v9[safeIndex(270, v9.Length)] := v15;
			var v16 := DC13(v7);
			v8[safeIndex(736, v8.Length)], v9[safeIndex(270, v9.Length)] := v16.cf18, v15;
			v9[safeIndex(270, v9.Length)][safeIndex(843, v9[safeIndex(270, v9.Length)].Length)] := -p2;
			var v17: seq<int> := [p2];
			var v18: map<array<int>, seq<int>> := map[v15 := fm11(globalState) + v17];
			var v19: map<bool, int> := map[f31 := p2];
			v0, v0, v9[safeIndex(270, v9.Length)][safeIndex(843, v9[safeIndex(270, v9.Length)].Length)], v2[safeIndex(410, v2.Length)] := |(if ((if (p3) then v15 else v15) in v18) then v18[if (p3) then v15 else v15] else if (p3) then v17 else v17)|, p2, v0 * v0, v2[safeIndex(410, v2.Length)][safeIndex(safeDivisionInt(p2, v0), |v2[safeIndex(410, v2.Length)]|) := v2[safeIndex(410, v2.Length)][safeIndex(|v19|, |v2[safeIndex(410, v2.Length)]|)]];
		} else {
			...
			var v23 := "eys";
			var v24: seq<int> := [v0];
			var v25: array<bool> := new bool[10] [f31, v22 != v22, p2 < |multiset(seq(abs(0x396), i1  => (-p2)))|, v22[v0 := abs(v0)] <= v22, false, true, v0 < v0, f31, v23 == v23, v24 == v24];
			v25[safeIndex(758, v25.Length)] := !p3;
			...
			var v33: array<int> := new int[7] [|v27|, fm9(977, v24, v0, f31, globalState), fm9(fm9(557, v24, v0, p3, globalState), (seq(abs(-0x1db), i3  => (-0x2e9)))[safeIndex(|v29|, |(seq(abs(-0x1db), i3  => (-0x2e9)))|) := |v31|], p2, f31, globalState), v0, |(v32 + map[p2 := v30])|, -|p1|, v0];
			v30[safeIndex(905, v30.Length)] := v0;
			globalState.f27, v0, v25[safeIndex(758, v25.Length)], v30[safeIndex(905, v30.Length)] := v25, p2, if (f31) then f31 else f31, v0 - fm9(v0, v24, 0x39f, f31, globalState);
			var v34 := new C0(v25[safeIndex(758, v25.Length)]);
			var v35: array<array<int>> := new array<int>[1] [v33];
			v35[safeIndex(8, v35.Length)] := v33;
			var v36: map<int, int> := map[p2 := v30[safeIndex(905, v30.Length)]];
			var v37: seq<multiset<int>> := [v22 * multiset{|v36[p2 := 0x3cf]|}, multiset(v24), v22];
			var v38: multiset<bool> := multiset{f31};
			var v39 := DC21(p3, f31, v30[safeIndex(905, v30.Length)]);
			v0, v35[safeIndex(8, v35.Length)], v28, v30[safeIndex(905, v30.Length)], v23 := -|v37|, if (p3) then v33 else v33, if (v25[safeIndex(758, v25.Length)]) then v28 else v28, p2, fm0(v38[v25[safeIndex(758, v25.Length)] := abs((v39.(cf31 := v25[safeIndex(758, v25.Length)])).cf33)], globalState);
			var v40: array<array<bool>> := new array<bool>[9];
			var v41 := DC14(v20, v0, p3, v25);
			v40[safeIndex(256, v40.Length)] := if (p3) then v41.cf22 else v25;
			v40[safeIndex(256, v40.Length)] := v25;
			var v42: seq<string> := [v23];
			var v43: seq<seq<int>> := [v24[safeIndex(v30[safeIndex(905, v30.Length)], |v24|) := v30[safeIndex(905, v30.Length)]], v24];
		...
		if (p2 >= (v0 * -p2)) {
			...
			match (v56) {
				case DC12(cf17) =>
					...
					v0 := if ((v61[safeIndex(v0, |v61|)] + v59) in v60) then v60[v61[safeIndex(v0, |v61|)] + v59] else v0;
					...
					var v67 := 'k';
					var v68: array<string> := new string[27] [v49 + (if (p2 in v65) then v65[p2] else v49), "lyh", v49, v49, if (v47[safeIndex(p2, |v47|)] in v66) then v66[v47[safeIndex(p2, |v47|)]] else v49, v49, v49 + v49, v49, if (p3) then v49 else "icxd", v49, v49, fm0(v46, globalState) + v49, v49, v49 + v49, v49, v49, v49 + v49, v49, "eghuqqi", v49, v49[safeIndex(v0, |v49|) := v67], v49 + v49, v49, v49, v49 + v49, ("s")[safeIndex(0x23d, |"s"|) := v67] + v49, seq(abs(0x1ed), i5  => (v67))];
					v68 := v68;
			}
			
			var v69: array<bool> := new bool[20](i6 => f31);
			var v70: set<int> := {|v49|, |[p3]|};
			v69[safeIndex(93, v69.Length)] := v70 <= v70;
			v69[safeIndex(93, v69.Length)] := f31;
		} else {
			var v71: array<multiset<int>> := new multiset<int>[2](i7 => multiset([v0, p2]) + multiset{v0, 0xd5, p2});
			var v72: multiset<int> := multiset{p2, p2};
			v71[safeIndex(849, v71.Length)] := v72 + multiset{|v47|, v0};
			v71[safeIndex(849, v71.Length)] := v72[p2 := abs(955)];
			v0 := p2 - -0x16f;
			v49 := (v49 + v49) + v49;
			var v73: map<char, int> := map[v49[safeIndex(v0, |v49|)] := v0];
			var v74 := 'n';
...
class C4 extends T1 {
	...
	method m2(p0: bool, p1: multiset<bool>, p2: multiset<bool>, globalState: GlobalState) returns (r0: int, r1: array<multiset<bool>>, r2: string, r3: int) {
		var i0 := 0;
		while (!(safeModuloInt(f32, f32) < f32))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
		...
		var v6: seq<int> := [if ((seq(abs(0x36c), i1  => ('w'))) in v3) then v3[seq(abs(0x36c), i1  => ('w'))] else |v4|, |v5|, f32, f32, 0xd6];
		...
		if ((v7 - v7) >= (v7 - v7)) {
			...
			v11[safeIndex(888, v11.Length)] := fm8(p0, 989, globalState);
			v11[safeIndex(888, v11.Length)] := f31;
			var v12: multiset<int> := multiset{-0x337, f32, f32};
			var v13: array<int> := new int[5] [|(v12 * v12)|, f32, -f32, 0x250, -0xc];
			v13[safeIndex(592, v13.Length)] := f32 - 0x1b7;
			v13[safeIndex(592, v13.Length)] := fm7(p0, v11[safeIndex(888, v11.Length)], globalState) + |([f35, p0] + v4)|;
		} else {
			globalState.f28 := f31;
			var v14 := DC10(seq(abs(0x1c7), i3  => ('b')), f32, p0);
		...
		var v16: array<bool> := new bool[22] [!p0, f31, p0, p0, f35, !p0, p0, f31, !false, f31, f31, f35, f35, true, !f31, fm8(p0, |(seq(abs(79), i4  => ('p')))|, globalState), p0, p0, p0, f35, p0, f31];
		var v17: seq<array<bool>> := [v16, v16];
		globalState.f20 := v17[safeIndex(-safeModuloInt(f32, f32), |v17|)];
...
class C5 {
	...
	method m1(p0: seq<int>, p1: int, p2: D0, globalState: GlobalState) returns (r0: bool, r1: bool) {
		if (f29) {
			...
			var v2 := "s";
			var v3: seq<string> := [(v2[safeIndex(-p1, |v2|) := v1] + v2)[safeIndex(|[0x33a]|, |(v2[safeIndex(-p1, |v2|) := v1] + v2)|) := v1]];
			v3 := v3 + v3;
			var v4: array<int> := new int[14](i0 => i0 + v0);
			v4[safeIndex(133, v4.Length)] := v0;
			v4[safeIndex(133, v4.Length)] := p1;
			v0 := v4[safeIndex(133, v4.Length)];
			v4[safeIndex(133, v4.Length)] := p1;
		} else {
			...
			if (f30 <== (if (p1 in v6) then v6[p1] else f29)) {
				...
				v16[safeIndex(117, v16.Length)] := p1;
				v16[safeIndex(117, v16.Length)] := -p1;
			} else {
				globalState.f28 := p1 == p1;
				...
				var v19 := DC9(v18);
				var v20 := DC2(true);
				var v21: array<seq<multiset<bool>>> := new seq<multiset<bool>>[12] [v18, v18, v18, v18 + fm4(f30, 0x2bc, globalState), (fm4(!f30, p1, globalState))[safeIndex(p1, |fm4(!f30, p1, globalState)|) := v17], fm4(f30, p1, globalState), (seq(abs(0x28e), i1  => (v17))) + v18, v19.cf12, fm4(v20.cf4, -70, globalState), [v17, v17] + v18, v18, v18 + v18];
				v21[safeIndex(438, v21.Length)] := v18[safeIndex(p1, |v18|) := v17];
				v21[safeIndex(438, v21.Length)] := [v17, v17, v17 * v17, v17, v17];
				var v22 := "fudavpasx";
				var v23: set<bool> := {f30};
				var v24 := DC7(v22[safeIndex(p1, |v22|)], v23);
				var v25: array<int> := new int[2];
				globalState.f28, v24, globalState.f16, r0, globalState.f24 := f30 || f29, v24, -0x351 < (p1 + -p1), safeModuloInt(p1, p1) != p1, v25;
			...
			v30 := v30[v28 := v31[safeIndex(p1, |v31|)]];
			globalState.f16 := f29;
			var v32 := 0x115;
			v32 := p1;
		}
		...
		match (v41) {
			case DC10(cf13, cf14, cf15) =>
				...
				cf15 := v43 !! v43;
				var v44: array<int> := new int[28](i3 => safeDivisionInt(i3, cf14));
				var v45 := DC5(v44);
				match (v45) {
					case DC5(cf7) =>
						...
						var v48 := DC10(v47[safeIndex(p1, |v47|)], p1, cf15);
				...
				globalState.f28, v53, cf14, v54, globalState.f28 := f29, multiset{p0 + p0}, p1 - safeModuloInt(|map[v55 := f29]|, p0[safeIndex(--p1, |p0|)]), map v56 : char | v56 in v57 :: (v56) := (false), 0x183 < cf14;
			case DC9(cf12) =>
			...
			case DC11(cf16) =>
				...
				var v70: map<multiset<bool>, int> := map[v69 := p0[safeIndex(v68, |p0|)]];
				...
				v73[safeIndex(848, v73.Length)] := !f30;
				v78[safeIndex(264, v78.Length)] := v73;
				...
				v73[safeIndex(848, v73.Length)], globalState.f16, v78[safeIndex(264, v78.Length)], v81.f35, v38 := v35 !in v38, v82 !! v82, if (v83 in v84) then v84[v83] else v73, safeModuloInt(|p0|, 0x6) > -safeDivisionInt(v68, 0x1e4), v38;
				v68 := p1;
		}
			...
			decreases 100 - i6
		{
			...
			v87[safeIndex(956, v87.Length)] := v90;
			v87[safeIndex(956, v87.Length)] := v90;
			var v91 := DC0(v33);
			var v92 := DC4(v91);
			...
			var v96: seq<map<int, bool>> := [v85, v85 + v85, map[p1 := f30], map[|v94| := v95[safeIndex(0x6f, |v95|)]], v85];
			v85 := v96[safeIndex(-p1, |v96|)];
			var v97: array<bool> := new bool[28];
			v97[safeIndex(556, v97.Length)] := fm10(v35, false, globalState);
			v97[safeIndex(556, v97.Length)] := f29;
		}
		...
		match (v99) {
			case DC24(cf40) =>
				...
				var v103: array<array<bool>> := new array<bool>[28] [v101, v101, v101, v101, v101, v101, v101, v102[safeIndex(|p0|, |v102|)], v101, v101, v101, v101, v101, v101, v101, v101, v101, v101, v101, v101, v101, v101, v102[safeIndex(p1, |v102|)], v101, v101, v101, v101, v101];
			...
			case DC25(cf41, cf42, cf43, cf44) =>
				...
				match (v109) {
					case DC28(cf51) =>
						...
						var v112 := DC5(v111);
						v112 := v112;
						var v113: map<bool, int> := map[f30 := safeDivisionInt(cf51, cf51)];
						v113 := v113[f29 := cf51];
						v38 := v38;
					case DC27(cf50) =>
						var v114: array<int> := new int[3] [430, -0x161, -0x156];
						v114[safeIndex(357, v114.Length)] := if (f30) then cf41 else cf41;
						v114[safeIndex(357, v114.Length)] := |(v38 + (v98[safeIndex(-p1, |v98|)] + v38))|;
						var v115: seq<bool> := [true];
						v115 := v115;
						globalState.f16 := cf44;
						var v116: map<bool, int> := map[f29 := p1];
						v114[safeIndex(357, v114.Length)] := (if (cf43) then |v116| else |v38|) * (cf41 * fm18(if (p1 in v85) then v85[p1] else f30, f29, globalState));
					case DC29(cf52) =>
				...
				var v123 := DC14(set v121 : int | (-0x366 <= v121) && (v121 < 990) :: (safeModuloInt(v121, p1)), cf41, !cf44, v122);
				...
				var v130: array<set<int>> := new set<int>[29] [v125, v125, v125, v125, v125, {p1, p1}, v125, {cf41, p1, cf41}, v125, v125, v125, v125, {cf41, p1}, v125, v123.cf19, v125, v125, {p1, -cf41}, {--0x49}, if (cf41 in v126) then v126[cf41] else set v128 : int | v128 in (set v127 : int | (0x1d0 <= v127) && (v127 < 0x1a4) :: (safeDivisionInt(v127, p1))) :: (safeModuloInt(v128, |"r"|)), v125, {cf41}, {p1}, v125, v125, fm28(|v86|, false, cf44, globalState), v125, v125, set v129 : int | (0xa0 <= v129) && (v129 < -0x132) :: (v129 * cf41)];
				var v131 := DC17(cf44, v130, p1);
				cf44 := v131.cf25;
				var v132: map<char, int> := map[v35 := p0[safeIndex(p1, |p0|)]];
				var v133: multiset<int> := multiset{p1};
				v132 := v132[fm20(v38, v133, false, -0x26, globalState) := safeModuloInt(cf41, 0x96)];
			case DC26(cf45, cf46, cf47, cf48, cf49) =>
				if ((v36 + v36) == {cf49}) {
					var v134: multiset<bool> := multiset{!cf49};
					var v135: array<bool> := new bool[17] [true, cf49, true, if (cf49) then f29 else f30, cf45 <==> (if (f30 in v86) then v86[f30] else cf45), f30, cf49, f30, cf45, cf45, f29, multiset{cf47, p1} <= multiset{cf47}, if (f29) then !f29 else cf45, |cf46[safeIndex(|v134|, |cf46|) := v35]| >= p1, "vu" != v38, cf49, false];
					v135[safeIndex(338, v135.Length)] := cf49;
					v135[safeIndex(338, v135.Length)] := if (cf45) then cf47 >= cf47 else cf49;
					var v136: array<char> := new char[5];
					v136[safeIndex(825, v136.Length)] := v35;
					...
					v140[safeIndex(296, v140.Length)] := v138;
					...
					var v148: map<D0, int> := map[fm29(cf47, cf49, globalState) := p0[safeIndex(cf47, |p0|)]];
					v135[safeIndex(338, v135.Length)], cf47, v38, v136[safeIndex(825, v136.Length)], v140[safeIndex(296, v140.Length)] := if (v146 in v147) then v147[v146] else |p0| != p1, if (p2 in v148) then v148[p2] else cf47, cf46, v35, if (cf49) then v138 else if (f29) then v138 else v138;
					...
					var v157: map<int, map<int, set<int>>> := map[safeModuloInt(0x25f, |v156|) := v155];
					v135[safeIndex(338, v135.Length)], v155, v134, globalState.f20 := !((cf49 || v135[safeIndex(338, v135.Length)]) !in v151.f38), if (|(cf46 + cf46)| in v157) then v157[|(cf46 + cf46)|] else v155, v134[!cf45 := abs(safeModuloInt(--p1, p1))], v135;
				} else {
					...
					v158[safeIndex(132, v158.Length)] := f30;
					var v162: array<set<char>> := new set<char>[23];
					var v163: set<char> := {v35};
					v162[safeIndex(386, v162.Length)] := v163 + v163;
					var v164: seq<set<char>> := [{'k', v35, v35}];
					cf47, cf47, v161, v158[safeIndex(132, v158.Length)], v162[safeIndex(386, v162.Length)] := |(v159 + (if (f29) then v159 else v159))[safeIndex(p1, |(v159 + (if (f29) then v159 else v159))|) := f30 ==> cf49]|, -0x2f4 + p1, v161, f29, v164[safeIndex(|p0|, |v164|)];
					v158[safeIndex(132, v158.Length)], cf47 := if (if (f29 in v86) then v86[f29] else v158[safeIndex(132, v158.Length)]) then true else f29, cf47 + -(cf47 - cf47);
				}
				
				var v165: array<bool> := new bool[18];
				v165[safeIndex(590, v165.Length)] := cf49;
				v165[safeIndex(590, v165.Length)] := f29;
				var v166: seq<bool> := [f30];
				v165[safeIndex(590, v165.Length)], v165[safeIndex(590, v165.Length)], v166, globalState.f16 := v166[safeIndex(p1, |v166|)] !in v36, v165[safeIndex(590, v165.Length)], v166, fm3(globalState);
				...
				v169[safeIndex(870, v169.Length)] := v35;
				v169[safeIndex(870, v169.Length)] := v35;
			case DC23(cf39) =>
				var v170 := 0x12;
				var v171: set<int> := {p1};
				...
				v172[safeIndex(445, v172.Length)] := f29 !in v36;
				v172[safeIndex(445, v172.Length)] := f30;
				globalState.f16 := safeDivisionInt(-0x264, v170) >= v170;
		}
		
		r0 := f29;
		r1 := !(safeDivisionInt(p1, p1) != p1);
	}
}

function fm0(p0: multiset<bool>, globalState: GlobalState): string {
	if (!false) then (seq(abs(0x35f), i0  => ('e'))) + "qy" else seq(abs(108), i1  => ('d'))
}
...
function fm5(p0: bool, p1: int, globalState: GlobalState): char {
	if (|(seq(abs(528), i0  => ('n')))| <= |{false, false}|) then 'q' else 'v'
}
...
function fm15(p0: bool, globalState: GlobalState): seq<int> {
	[-|[|DC46(map[|(seq(abs(-338), i0  => ('d')))| := |multiset{true, false}|]).cf80|]|, |map[|(set v0 : int | v0 in map[0x35d := true] :: (safeModuloInt(v0, 0x3f)))| := !true]|, 0xbe, |(map v1 : int | v1 in map[-462 := 'g'] :: (v1 * |[0x67]|) := (map[|(map v2 : char | v2 in map['q' := false] :: (v2) := (|"xgonjaa"|))| := 0x6a]))|, |(seq(abs(867), i1  => ('r')))|] + [|multiset(['p'])|, 0x3e, |(seq(abs(0x2c1), i2  => (|(seq(abs(0x171), i3  => ('l')))|)))|, |"jbdseslwf"|, |"v"|]
}
...
function fm22(p0: int, globalState: GlobalState): seq<set<int>> {
	if (true) then (seq(abs(0x19e), i0  => ({|map[-0x21c := false]|}))) + [set v0 : int | (680 <= v0) && (v0 < 0x4) :: (v0 + |multiset{|"dqm"|}|)] else seq(abs(0x30f), i1  => ({0x142, --0x142, |multiset{-0xad}|, --996, -776}))
}
function fm23(p0: map<bool, map<int, bool>>, p1: map<bool, int>, p2: string, globalState: GlobalState): seq<int> {
	([-110, -249] + (seq(abs(-0x4a), i0  => (|[0x394]|)))) + [0x17a, |map[0xb := "ucvrgkh"]|, |map[|(seq(abs(0xb2), i1  => ('m')))| := 't']|, 0x3a5]
}
...
function fm25(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): set<D2> {
	{DC6(-|multiset([!false])|)} * {DC6(|"msuhavx"|), DC6(-218), DC6(|(map v0 : int | (783 <= v0) && (v0 < -172) :: (safeDivisionInt(v0, |(seq(abs(0xd0), i0  => (|[0x2aa, -|"jlnaqhjk"|]|)))|)) := (false))|), DC6(0x213)}
}
function fm26(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): bool {
	0x357 == safeModuloInt(|"bfehftfco"|, -|{'u', 'n'}|)
}
function fm27(p0: bool, p1: int, p2: bool, globalState: GlobalState): D9 {
	if (multiset{false, true, true} !! multiset{true, false, false, !!false}) then DC23([seq(abs(0x3d8), i0  => ('w'))]) else DC23(["nttb"])
}
function fm28(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<int> {
	{|map[false := -0x2eb]|, -663, safeDivisionInt(-0x332, |map[DC25(0x3a5, false, true, false) := |multiset([|map[-790 := false]|, 0x50])|]|)}
}
...
function fm32(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<int, int> {
	(map v0 : int | (-687 <= v0) && (v0 < 0x280) :: (v0 - |(seq(abs(0x17b), i0  => (|[0x25c]|)))|) := (-0x3d7)) + map[|multiset{-585}| := -0x344]
}
...
function fm34(p0: map<map<int, bool>, int>, globalState: GlobalState): multiset<multiset<int>> {
	DC52(multiset{multiset{|{!false, true, true}|}, multiset{|map[|(map v0 : char | v0 in ['d', 'j'] :: (v0) := (false))| := 0x3c5]|, |multiset{0x2cf}|, -|(seq(abs(461), i0  => ('q')))|}, multiset{|"vo"|}, multiset{0x45}, multiset{0x358, |multiset{true}|}}).cf91
}
function fm35(p0: int, p1: string, p2: int, globalState: GlobalState): multiset<map<bool, int>> {
	match DC47(false, 0x381) {
		...
		case DC46(cf80) => multiset{map[true := |(map v0 : set<int> | v0 in map[set v1 : int | (0x365 <= v1) && (v1 < 577) :: (safeModuloInt(v1, |map[true := 0x239]|)) := 89] :: (v0) := (!false))|]} * multiset{map[true := |map[false := false]|]}
	}
}
...
method m0(p0: int, globalState: GlobalState) {
	...
	var i0 := 0;
	while (v7 != [DC10(seq(abs(-571), i1  => ('m')), p0, v5)])
		decreases 100 - i0
	{
		if (i0 >= 100) {
			break;
		...
		match (v12) {
			case DC40(cf69, cf70, cf71) =>
				...
				v14[safeIndex(837, v14.Length)] := p0;
				var v15: multiset<int> := multiset{p0};
				v14[safeIndex(837, v14.Length)] := (-|v15| - p0) + -p0;
			...
			case DC41(cf72, cf73) =>
				...
				v19 := v19[v17 := v18[v4 := abs(-699)]];
				cf73 := 0x138;
				var v20: array<int> := new int[12];
				v20[safeIndex(636, v20.Length)] := -0x29e;
				v20[safeIndex(636, v20.Length)] := cf73;
			...
			case DC39(cf68) =>
				...
				var v26: C3 := new C3(cf68, v23, fm26(v5, v5, v5, if (p0 in v24) then v24[p0] else |v25[safeIndex(p0, |v25|)]|, globalState));
				var v27: set<int> := {p0};
			...
			case DC42(cf74) =>
				...
				var v37 := DC44(v36);
				var v38: array<int> := new int[23] [-58, p0, |fm36(globalState)|, p0, p0, p0, |v35|, p0, |v37.cf76|, p0, |v4|, p0, p0, p0, |v4|, p0, p0, |v36|, p0, p0, p0, p0, -|(seq(abs(635), i3  => ('g')))|];
				var v39 := DC5(v38);
				...
				v46[safeIndex(10, v46.Length)] := v41;
				v46[safeIndex(10, v46.Length)] := if (!v41.f31) then v41 else v41;
				var v47 := -0x147;
				v47 := 774;
		}
	...
	var v56 := 'm';
	v55[safeIndex(887, v55.Length)] := v56;
	var v57: multiset<bool> := multiset{v5};
	v55[safeIndex(887, v55.Length)] := fm5(v5, |v57| * 0x1df, globalState);
...
method Main() {
	...
	v7 := v19[safeIndex(v7, |v19|)];
	for i1 := safeModuloInt(v7, v7) to v7 * |v2| {
		...
		match (if (v3) then v15 else DC5(v5)) {
			case DC5(cf7) =>
				v3 := (|v9| * i1) == v7;
				v13 := v13;
				cf7[safeIndex(697, cf7.Length)] := v7;
				cf7[safeIndex(697, cf7.Length)] := v7;
				v3 := v3 <== v3;
		}
		
		var v23 := DC6(v7);
		globalState.f28 := v8[safeIndex(|(v2[safeIndex(v7, |v2|) := 'q'])[safeIndex(v23.cf8, |v2[safeIndex(v7, |v2|) := 'q']|) := v0]|, |v8|) := v5] <= (v8 + v8);
	}
	...
	if (false) {
		...
		v7 := |v26|;
		v5[safeIndex(86, v5.Length)] := v7;
		v3, v7, v10, v5[safeIndex(86, v5.Length)] := v3 ==> v3, -v7, v10, --v7;
		var v27: map<bool, char> := map[v7 >= v5[safeIndex(86, v5.Length)] := 'u'];
		v27 := v27[v3 := v0];
		v7 := safeDivisionInt(|fm0(multiset([false, !v3]), globalState)|, |multiset{true}|) + (if (v3) then -660 else v7);
		var v28: array<array<seq<int>>> := new array<seq<int>>[13];
		var v29: array<seq<int>> := new seq<int>[7] [v19, v19, v19, v19, v19, v19, [v7, v5[safeIndex(86, v5.Length)]]];
		v28[safeIndex(363, v28.Length)] := v29;
		v28[safeIndex(363, v28.Length)] := v29;
	} else {
		v3 := v3;
		...
		if (!({v7} > v31)) {
			...
			v14[safeIndex(33, v14.Length)] := v36[safeIndex(v7, |v36|)] >= multiset([v37]);
			v14[safeIndex(33, v14.Length)] := v7 >= safeDivisionInt(v7, v7);
		} else {
			...
			v42 := v42;
			v5[safeIndex(507, v5.Length)] := if (v3) then v7 else |v2|;
			v5[safeIndex(507, v5.Length)] := v38.fm13(v7, globalState);
			globalState.f28 := false;
			v3 := v42.f31;
		}
		
		var v43: seq<seq<bool>> := [v10];
		var v44: seq<seq<bool>> := [v10, v43[safeIndex(v7, |v43|)], v10, [v3]];
		v7 := safeModuloInt(|v44|, v7);
		if (v3) {
			v9 := v9[v3 && v3 := 0x3e];
			m0(v7, globalState);
			v7 := safeDivisionInt(v7, v7);
			m0(v7, globalState);
			var v45: array<string> := new string[1] [v2[safeIndex(v7, |v2|) := v2[safeIndex(|v2|, |v2|)]]];
			v45 := v45;
		} else {
			v7 := v7;
			...
			var v53 := new C5(fm20(v2, if (v50 in v51) then v51[v50] else v52, !!v10[safeIndex(v7, |v10|)], |v52|, globalState) !in "cf", v3);
			v7 := |(map[v53.f29 := v0] + map[v3 := v0])|;
		}
		
		var v54: multiset<int> := multiset{v7};
		v14[safeIndex(792, v14.Length)] := v7 in v54;
		v14[safeIndex(858, v14.Length)] := v3;
		var v55: C5 := new C5(v3, v3);
		var v56: map<bool, C5> := map[v3 := v55];
		v14[safeIndex(792, v14.Length)], v7, v14[safeIndex(858, v14.Length)], globalState.f20 := (v7 - |v2|) < safeModuloInt(v7, v7), |((v56 + v56[v55.f30 := v55]) + (map[fm10(v0, v55.f30, globalState) := v55] + v56))|, v55.f29, v14;
	}
	
	m0(safeDivisionInt(v7, v7), globalState);
	var i3 := 0;
	while (v3)
		decreases 100 - i3
	{
		...
		decreases 100 - i5
	{
		...
		var v60 := DC31(v10);
		globalState.f16, globalState.f24, v3, v10, globalState.f16 := v59[safeIndex(v7, |v59|)] >= multiset{v7}, v5, v3, (v60.(cf54 := [!v3])).cf54, v3;
		v7 := v7;
		v14[safeIndex(259, v14.Length)] := v7 > v7;
		v10, v14[safeIndex(259, v14.Length)], globalState.f28 := v10 + (v10 + [v3, true]), v3, v3;
		m0(v7, globalState);
	}
	var v61: multiset<bool> := multiset{v3};
	var v62: seq<multiset<bool>> := [multiset{v3, v3, v3, v3}, v61[v3 := abs(v7)]];
	var v63 := DC13(v62[safeIndex(v7, |v62|)]);
	match (v63) {
		case DC14(cf19, cf20, cf21, cf22) =>
			cf20 := |v19| * fm7(cf21, v3, globalState);
			var v64: C2 := new C2(v10[safeIndex(0x2bf, |v10|) := v3], false);
			v64 := v64;
		...
		case DC13(cf18) =>
			...
			v72[safeIndex(842, v72.Length)] := v75[safeIndex(v19[safeIndex(v7, |v19|)], |v75|)];
			v72[safeIndex(842, v72.Length)] := v74;
			v10 := v10;
			v73[safeIndex(684, v73.Length)] := v14;
			v73[safeIndex(684, v73.Length)] := v14;
		case DC15(cf23) =>
			var v76 := DC2(v3);
			var v77 := DC1(v0, v76.cf4, v3);
			var v78: seq<D0> := [v77];
			var v79: map<seq<int>, seq<int>> := map[[v7] := seq(abs(106), i6  => (|[v19[safeIndex(|map[DC2(v3) := v7]|, |v19|)], |(seq(abs(0x3cb), i7  => (v0)))|]|))];
			var v80: seq<seq<int>> := [v19];
			var v81: array<array<bool>> := new array<bool>[25];
			var v82: C4 := new C4(v78 + v78, v3, |(if (v80[safeIndex(v7, |v80|)] in v79) then v79[v80[safeIndex(v7, |v80|)]] else v19)|, v81, v3 <== false);
			var v83: set<int> := {fm1(v0, globalState)};
			var v84: map<bool, bool> := map[v3 := v82.f35];
			v7, v82, globalState.f28, v83, v2 := fm7(v3 <== v82.f35, if (!v3 in v84) then v84[!v3] else v82.f35, globalState), if (v3) then v82 else v82, v82.f35, v83, if (v3) then seq(abs(0x2a2), i8  => (v0)) else v2;
			v14[safeIndex(209, v14.Length)] := v2 != ("w")[safeIndex(|fm32(v7, v82.f35, v82.f35, v82.f35, globalState)|, |"w"|) := v0];
			v14[safeIndex(209, v14.Length)] := v82.f35;
			var v85, v86, v87, v88 := v82.m2(if (v14[safeIndex(209, v14.Length)]) then v82.f35 else v3, v61 + v61, v61, globalState);
	...
	m0(if (|v99[v3 := seq(abs(0x260), i9  => (|[DC36(v3, v3)]|))]| in v25) then v25[|v99[v3 := seq(abs(0x260), i9  => (|[DC36(v3, v3)]|))]|] else v7, globalState);
	for i10 := v7 to v7 {
		...
		v5[safeIndex(456, v5.Length)] := v7;
		var v106: array<array<bool>> := new array<bool>[6] [v14, v14, v14, v14, v14, v14];
		var v107: T1 := new C1(v7, v106, v3);
		v5[safeIndex(456, v5.Length)] := |{v107}|;
		v5[safeIndex(456, v5.Length)] := |v2|;
	}
	var v108 := new C5(v10[safeIndex(v7, |v10|)], v3);
	var v109 := DC16(v1);
	match (v109) {
		case DC17(cf25, cf26, cf27) =>
			...
			v111 := v111[v7 := v110];
			cf27 := safeDivisionInt(v7 - |v10|, cf27);
			m0(v7, globalState);
		...
		case DC18(cf28) =>
			...
			var v132: array<C0> := new C0[29] [v129, v129, v129, v129, v129, v129, v129, v129, v129, v129, v129, v129, v130.cf75, v129, v129, v129, v129, v129, v129, v131[safeIndex(-v7, |v131|)], v129, v129, v129, v129, v131[safeIndex(v7, |v131|)], v130.cf75, v129, v129, v129];
			v7 := |[v132, v132, v132, v132, v132]|;
			globalState.f16, v7, v7 := v10[safeIndex(v7, |v10|)], safeDivisionInt(safeModuloInt(v7, v7), v7 + |v10|), fm1(v0, globalState);
			if (v3) {
				var v133: array<seq<array<bool>>> := new seq<array<bool>>[21];
				v133[safeIndex(629, v133.Length)] := [v14];
				v5[safeIndex(963, v5.Length)] := safeDivisionInt(|v96|, -0x236);
				var v134: set<bool> := {v108.f30};
				var v135: map<int, set<bool>> := map[v7 := v134];
				v133[safeIndex(629, v133.Length)], v7, v5[safeIndex(963, v5.Length)], v7, v3 := v95 + v95, safeModuloInt(v7, |(if (v7 in v135) then v135[v7] else {true})|) + (v7 + (if (v108.f30 in v9) then v9[v108.f30] else 0x375)), fm7(v108.f29, v3, globalState), 0x283, v108.f29;
				...
				v7, globalState.f27, v2, v2 := v7, v133[safeIndex(629, v133.Length)][safeIndex(v7, |v133[safeIndex(629, v133.Length)]|)], v2, v2[safeIndex(-|v9|, |v2|) := v0];
			} else {
				var v137 := DC10(v2, v7, v3);
				v7 := v137.cf14;
				v7 := 0x393;
				m0(v7, globalState);
				var v138: seq<string> := [seq(abs(-0x30b), i12  => (v0))];
				v7 := |((if (v108.f29) then v138 else v138) + v138)[safeIndex(v7, |((if (v108.f29) then v138 else v138) + v138)|) := v2 + v2]|;
		...
		decreases 100 - i13
	{
		...
		i13 := i13 + 1;
		if (v10[safeIndex(v7, |v10|)]) {
			v5[safeIndex(148, v5.Length)] := safeDivisionInt(v7, v7);
			var v139: array<array<bool>> := new array<bool>[2];
			v139[safeIndex(349, v139.Length)] := v14;
			var v140: seq<seq<bool>> := [fm14(v7, v7, v7, v108.f29, globalState), ([v108.f29])[safeIndex(-0x35, |[v108.f29]|) := v108.f30] + v10];
			v5[safeIndex(148, v5.Length)], v2, v139[safeIndex(349, v139.Length)], v140, v7 := |map[v19 := v108.f30]|, v2 + v2, v14, v140 + v140, 101;
			v5[safeIndex(148, v5.Length)] := v7;
			globalState.f16 := v108.f30;
			var v141: C1 := new C1(v5[safeIndex(148, v5.Length)], v139, !v108.f30);
			v141 := v141;
			v5[safeIndex(148, v5.Length)] := v7 * (v5[safeIndex(148, v5.Length)] - v19[safeIndex(v7, |v19|)]);
		} else {
			var v142 := new C5(v108.f29, v108.f30);
			var v143 := DC1(v0, v108.f30, true);
			var v144, v145 := v142.m1(v19, safeDivisionInt(v7, |map[v10 := v7]|), v143, globalState);
			var v146, v147 := v142.m1((seq(abs(0x36d), i14  => (v7))) + v19, v7, v143, globalState);
			v146 := v108.f30;
			...
			v149[safeIndex(558, v149.Length)] := v148;
			v149[safeIndex(558, v149.Length)] := v148;
		}
		
		if (v10[safeIndex(|v92|, |v10|)] && !fm26(v108.f29, v108.f29, v10[safeIndex(v7, |v10|)], if (fm1(v0, globalState) in v25) then v25[fm1(v0, globalState)] else v7, globalState)) {
			var v150: set<char> := {v0};
			var v151: map<set<char>, seq<char>> := map[v150 := v2];
			v151 := v151[v150 * v150 := v2];
			v14[safeIndex(810, v14.Length)] := v108.f29;
			v14[safeIndex(810, v14.Length)] := v7 > -safeDivisionInt(|v10|, v7);
			v7 := 0x3a1;
		...
		globalState.f28, v2, globalState.f28, v0 := v108.f29, if (v3) then v2 else (fm0(v61, globalState))[safeIndex(v7, |fm0(v61, globalState)|) := v0], fm10(v0, v7 == v7, globalState), if (v108.f30) then 'k' else v0;
		var v160: array<D14> := new D14[22](i15 => DC40(v108.f29, v108.f29, v7));
		var v161 := DC40(!v108.f30, v3, v7);
		v160[safeIndex(601, v160.Length)] := v161;
		v160[safeIndex(601, v160.Length)] := if (v108.f29) then v161 else v161;
	}
	print v0, "\n";
	print v1[0], "\n";
	print v1[1], "\n";
	...
	print v7, "\n";
	print |v8|, "\n";
	print v9 == map[false := 159, true := 62], "\n";
	print v10 == [false, false, true, true], "\n";
	print v11 == map[[159, 159] := 2], "\n";
	print v12[0] == [true, false], "\n";
	print v12[1] == [true, false], "\n";
	print v12[2] == [true, false], "\n";
	print v12[3] == [true, false], "\n";
	print v12[4] == [true, false], "\n";
	print v12[5] == [true, false], "\n";
	print v13.cf0[0] == [true, false], "\n";
	print v13.cf0[1] == [true, false], "\n";
	print v13.cf0[2] == [true, false], "\n";
	print v13.cf0[3] == [true, false], "\n";
	print v13.cf0[4] == [true, false], "\n";
	print v13.cf0[5] == [true, false], "\n";
	print v14[0], "\n";
	print v14[1], "\n";
	print v14[2], "\n";
	print v14[3], "\n";
	...
	print globalState.f3 == map["mau" := false], "\n";
	...
	print globalState.f12 == map[[159, 159] := 2], "\n";
	print globalState.f13, "\n";
	print globalState.f14, "\n";
	print globalState.f15, "\n";
	print globalState.f16, "\n";
	print globalState.f17, "\n";
	print globalState.f18[0] == [true, false], "\n";
	print globalState.f18[1] == [true, false], "\n";
	print globalState.f18[2] == [true, false], "\n";
	print globalState.f18[3] == [true, false], "\n";
	print globalState.f18[4] == [true, false], "\n";
	print globalState.f18[5] == [true, false], "\n";
	...
	print globalState.f21[26], "\n";
	print globalState.f22, "\n";
	print globalState.f23 == map[false := {false}], "\n";
	print globalState.f24[0], "\n";
	print globalState.f24[1], "\n";
	print globalState.f24[2], "\n";
	print globalState.f24[3], "\n";
	print globalState.f24[4], "\n";
	print globalState.f24[5], "\n";
	print globalState.f24[6], "\n";
	print globalState.f24[7], "\n";
	print globalState.f24[8], "\n";
	print globalState.f24[9], "\n";
	print globalState.f24[10], "\n";
	print globalState.f24[11], "\n";
	print globalState.f24[12], "\n";
	print globalState.f24[13], "\n";
	print globalState.f24[14], "\n";
	print globalState.f24[15], "\n";
	print globalState.f24[16], "\n";
	print globalState.f24[17], "\n";
	print globalState.f24[18], "\n";
	print globalState.f24[19], "\n";
	print globalState.f24[20], "\n";
	print globalState.f24[21], "\n";
	print globalState.f24[22], "\n";
	print globalState.f25, "\n";
	print globalState.f26, "\n";
	print globalState.f27[0], "\n";
	print globalState.f27[1], "\n";
	print globalState.f27[2], "\n";
	print globalState.f27[3], "\n";
	print globalState.f27[4], "\n";
	print globalState.f27[5], "\n";
	print globalState.f27[6], "\n";
	print globalState.f27[7], "\n";
	print globalState.f27[8], "\n";
	print globalState.f27[9], "\n";
	print globalState.f27[10], "\n";
	print globalState.f27[11], "\n";
	print globalState.f28, "\n";
	print v17.cf5, "\n";
	print v18 == {DC3('v')}, "\n";
	print v19 == [159, 159, 159, 159], "\n";
	print v24 == map[159 := 159], "\n";
	print v25 == map[159 := 159], "\n";
	print i3, "\n";
	print i5, "\n";
	print v61 == multiset{true}, "\n";
	print v62 == [multiset{true, true, true, true}, multiset{true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}], "\n";
	print v63.cf18 == multiset{true, true, true, true}, "\n";
	print v91 == map[3 := true, 1 := true, 2 := true], "\n";
	print v92 == map[map[3 := true, 796 := true] := 796], "\n";
	print v93.cf61 == map[map[3 := true, 796 := true] := 796], "\n";
	print |v94|, "\n";
	print |v95|, "\n";
	print v96 == multiset{1}, "\n";
	print v97 == [multiset{1}], "\n";
	print v98 == multiset{multiset{1}, multiset{1}, multiset{1}}, "\n";
	print v99 == map[true := [159, 159, 159, 159]], "\n";
	print v108.f29, "\n";
	print v108.f30, "\n";
	print v109.cf24[0], "\n";
	print v109.cf24[1], "\n";
