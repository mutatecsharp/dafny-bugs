...
function fm17(p0: set<seq<D4>>, p1: int, p2: bool, globalState: GlobalState): D3 {
	DC9(map[true := [DC3(|[!false, false]|, false, 978), DC3(-0x38e, true, |{true}|)]] + map[true := seq(0x373, i0  => (DC3(-0x398, true, -0x17e)))])
}
...
function fm22(p0: bool, p1: bool, p2: string, globalState: GlobalState): seq<D3> {
	seq(0x68, i0  => (if (!!!true) then DC11() else DC11()))
}
...
function fm24(p0: int, p1: int, p2: int, p3: string, globalState: GlobalState): seq<int> {
	[-0x30e] + ((seq(-0x1ba, i0  => (0x22))) + [0x2b7, 458])
}
...
function fm32(p0: map<bool, bool>, p1: bool, p2: bool, globalState: GlobalState): map<string, int> {
	DC79(map[seq(968, i0  => ('e')) := ---|[0xc8]|]).cf126
}
function fm33(p0: set<map<int, int>>, globalState: GlobalState): seq<int> {
	[43, 0x1bf] + (seq(-0x96, i0  => (|map[true := |map[227 := false]|]|)))
}
...
function fm38(globalState: GlobalState): multiset<int> {
	multiset{0xdf - -417, -(0xba - |map[|map[|multiset{true}| := |multiset([|(seq(0x18, i0  => (|multiset{-559}|)))|, 0x149])|]| := !true]|), |([false, true] + [false, false])|, if (!true) then 936 else |(seq(223, i1  => (|map[seq(0x163, i2  => (0x21e)) := !false]|)))|, -0x6e}
}
...
function fm40(p0: int, p1: bool, p2: bool, globalState: GlobalState): set<int> {
	((set v0 : int | v0 in multiset{62} :: (v0 / |"f"|)) - {|(seq(0x27c, i0  => ('q')))|, 0x33}) + (if (true) then set v1 : int | v1 in map[0x23f := true] :: (v1 + -491) else set v2 : int | (0x287 <= v2) && (v2 < -0x373) :: (v2 % -0xc1))
}
function fm41(p0: bool, p1: bool, p2: D6, globalState: GlobalState): seq<multiset<char>> {
	if (219 == |map[seq(0x2eb, i0  => (-817)) := false]|) then [multiset{'u', 'a'}] + [multiset{'d', 'd'}] else [multiset{'h'}, multiset{'l', 'n'}] + [multiset(['v', 'q'])]
}
function fm42(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): D13 {
	match DC27(true, DC27(!true, true, true).cf45, true) {
		case DC26(cf42, cf43) => DC33(seq(0x3b7, i0  => (map[|[-0x103]| := false])))
...
function fm43(globalState: GlobalState): D0 {
	DC3(0x1f - |(seq(541, i0  => ('q')))|, if (!true) then true else true, 0x329)
}
...
function fm50(p0: char, p1: bool, p2: multiset<bool>, globalState: GlobalState): map<bool, seq<int>> {
	match DC65({"jkke", "se", "vlwluj"}) {
		...
		case DC65(cf109) => map[true := [|map[|[|[false, true]|, -0x19c, |(map v0 : int | (0x1c9 <= v0) && (v0 < 977) :: (v0 % |(seq(0x12, i0  => ('a')))|) := (0x2a1))|]| := [false]]|, |[false]|]]
	}
}
...
function fm57(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D14 {
	DC36(0x135 % |"dfl"|, false ==> true, false, !("esc" != "cysxf"), multiset{false, false} > multiset{false})
}
...
function fm59(p0: bool, p1: int, p2: bool, globalState: GlobalState): seq<D23> {
	([DC63(true), DC63(false)] + (seq(0x145, i0  => (DC63(false))))) + (if (true) then [DC63(!true)] else [DC63(false), DC63(!true)])
}
...
function fm64(p0: bool, globalState: GlobalState): D1 {
	DC6(map[DC2(|multiset{-0x48, |"dsd"|}|, "fpb", --|[-0x24c, 0x29b]|) := multiset([!true])] + (map v0 : D0 | v0 in [DC2(0x37b, "eavoftcx", |{|multiset{true, false}|}|), DC2(-|[|"mwbnr"|]|, "w", |"ftg"|), DC2(|"ujkra"|, "ojnu", |"uvjcymewx"|), DC2(-|map[418 := 0x239]|, seq(-0x22, i0  => ('g')), -852)] :: (v0) := (multiset{false})))
}
method m0(p0: map<bool, char>, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: int, r1: D0, r2: bool) {
	...
	if (|v0| < fm2(p3, globalState)) {
		...
		match (fm63(globalState)) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				v9[445] := p1;
				var v24: array<int> := new int[9] [cf1 + cf3, cf3, cf3 * cf3, cf1 + cf3, p2, -0x1f3 / -cf1, p2, p2, cf1 + cf3];
				v24[989] := |cf4|;
				v9[93] := p1 || p3;
				v9[445], v24[989], cf2, v9[93], globalState.f21 := v15.f34, cf1, (cf2 + (cf2[cf3 := -0x279])[|cf4| := cf3]) + cf2, v15.f34, p1;
			...
			case DC0(cf0) =>
				...
				globalState.f11 := p2;
			case DC4(cf12) =>
				var v37: map<int, int> := map[p2 % |multiset(v0)| := p2];
				var v38 := "crvutwd";
				v37 := v37[p2 := |v38|];
				...
				var v42 := DC51(p2);
				var v43: array<int> := new int[22] [0x1b1, p2, p2, 793, |"pxiouqu"|, p2, p2, p2, 0x14d, |v41|, p2, p2, p2, p2, -p2, p2, |(seq(328, i2  => (v40)))|, v42.cf88, p2, fm2(p1, globalState), p2, |v37|];
				var v44: map<array<int>, bool> := map[v43 := false];
				var v45 := DC28(v44);
				var v46: seq<D10> := [v45];
				var v47: array<seq<D10>> := new seq<D10>[17] [v46, [DC28(v44)], v46[p2 := v45], v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46, v46];
				v39[390] := v47;
				v39[390] := v47;
				globalState.f19 := -p2;
	...
	v71[939], r2, v71[212], v0, v74 := -fm2(p3, globalState), p3, 268, v0 + v0, v74;
	if (p3) {
		var v75: map<seq<int>, bool> := map[seq(-0xb9, i6  => (p2)) := p3];
		var v76: seq<bool> := [if ((seq(0x5d, i7  => (p2))) in v75) then v75[seq(0x5d, i7  => (p2))] else v74.f29, v74.f29, p3, p1, p1];
		var v77: map<int, bool> := map[p2 * v71[939] := v76[p2]];
		var v78 := DC7();
		...
		globalState.f19 := DC52(v71[939], -|v83|).cf89;
		if (v74.f29) {
			var v84: map<bool, int> := map[false := if (!false) then v71[939] else v79.f31];
			...
			v89[696] := if (v74.f29) then v87 else v87;
			var v90: map<bool, C3> := map[p1 := v87];
			v89[696] := if (!v87.f34 in v90) then v90[!v87.f34] else v87;
			v54 := v54;
			v89[696] := v87;
			...
			var v94: C6 := new C6(v71[939], v74.f29, v79.f31);
			var v95: map<C6, int> := map[v94 := p2];
			var v96 := DC62(0x3b, p3, |v95|, v74.f29);
			var v97: map<int, D23> := map[-v79.f31 := v96.(cf106 := v79.f30)];
			v93 := v93.(cf28 := v74.fm7(false, globalState), cf24 := v76[p2], cf25 := if (|v97| in v77) then v77[|v97|] else v74.f29);
		...
		if (!(v100.cf58 <== v74.f29)) {
			var v101: set<int> := {v71[939], -v79.f31, v79.f31};
			var v102 := DC50(v101);
			var v104: seq<seq<int>> := [[v79.f31]];
			var v105: array<set<int>> := new set<int>[13] [{v79.f31}, v101, v101, v102.cf87, set v103 : int | (0x34c <= v103) && (v103 < 0x203) :: (v103 * v79.f31), v101, v101 * v101, v101 - v101, fm40(|multiset(v104[v0[v79.f31]])|, v74.f29, v74.f29, globalState), v101, v101, v101, {v79.f31, 0x1a2} * {p2}];
			v105[322] := v101;
			v105[322] := v101 * v101;
			v71[939] := v79.f31;
			globalState.f21 := if (p3) then p3 else v79.f31 > v71[939];
			globalState.f19 := -((v79.f31 / v71[939]) + (v79.f31 % p2));
			globalState.f11 := -v74.fm7(p1, globalState);
		} else {
			var v106 := DC62(v71[939], p3, |{-v79.f31}|, v79.f30);
			...
			var v111 := "qylu";
			globalState.f21, globalState.f21, globalState.f25, globalState.f19 := !(if (v79.f31 in v77) then v77[v79.f31] else !v74.f29), v106.cf106, p2, if ((v79.f31 * (if (v74.f29 in v109) then v109[v74.f29] else |v110|)) in v108) then v108[v79.f31 * (if (v74.f29 in v109) then v109[v74.f29] else |v110|)] else |v111| / v79.f31;
			var v112: map<char, int> := map[v54 := v79.f31];
			globalState.f11 := v79.f31 - ((if (v54 in v112) then v112[v54] else |v109|) % v79.f31);
		...
		decreases 100 - i9
	{
		...
		if (!v74.f29) {
			globalState.f19 := p2;
			var v123 := "yhljni";
			var v124: map<string, int> := map[v123 := v71[939]];
			...
			var v130: T1 := new C3(if (v71[939] in v128) then v128[v71[939]] else set v129 : map<int, int> | v129 in (map[map[v71[939] := |v123|] := v74.f29])[v126 := true] :: (v129), p3, v74.f29, -p2);
			...
			var v138: seq<seq<int>> := [[v71[939]] + v0];
			v138 := v138;
			var v139 := "k";
			var v140: map<int, bool> := map[p2 := p1];
			var v141: map<bool, bool> := map[v139 != v139 := v74.f29 || (if (v71[939] in v140) then v140[v71[939]] else v74.f29)];
			var v142: multiset<bool> := multiset{v74.f29};
			v141 := v141[p3 := multiset{!v74.f29, p1} == v142];
			globalState.f19 := -p2;
			globalState.f21 := v74.f29;
			r2 := if (p2 > |v142|) then v74.f29 <==> false else p2 == v71[939];
		}
		
		var v143 := "pmwgakvj";
		var v144: multiset<int> := multiset{0x138};
		var v145 := DC2(v71[939], v143 + v143, |v144|);
		var v146: seq<bool> := [true, p3];
		v71[939], globalState.f11, v145 := v0[p2], if (v74.f29) then p2 else |(multiset(v146) - multiset(v146))|, v145;
		globalState.f21 := p3;
		var v147: map<bool, int> := map[v74.f29 := 0xbe];
		globalState.f19 := -(v71[939] * |v147|);
	}
	r0 := v71[939];
	var v148 := "rggis";
	...
	var v152 := DC3(|v148|, (if (v74.fm6(v149, globalState) in v150) then v150[v74.fm6(v149, globalState)] else v148)[v71[939] := v54] in v151, |v149| / p2);
	r1 := v152;
	r2 := p3;
}
trait T0 {
...
class C0 {
	...
	method m13(p0: bool, globalState: GlobalState) returns (r0: int) {
		...
		v8[757] := if (v9 in v10) then v10[v9] else f36;
		v6[142], v8[757] := v7 + v7, f36;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			globalState.f15 := v6[142];
			var v12: map<int, string> := map[v0 := seq(0x9f, i2  => (v9))];
			var v13: map<int, bool> := map[v0 := !(v6[142] < (if (v0 in v12) then v12[v0] else "grxrbkmhl"))];
			v13 := v13;
			v0 := fm2(v11[477], globalState);
...
class C1 extends T1 {
	...
	method m5(p0: map<map<bool, char>, string>, p1: int, p2: set<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (!!f30) {
			...
			v10[664] := f31;
			globalState.f15, v9, globalState.f24, globalState.f21, v10[664] := v0, v9 * v9, p1, f30, p1;
		} else {
			var v11 := DC0(v2);
		...
		globalState.f21 := |v18| <= v4[|v21|];
		var v22: multiset<bool> := multiset{f30, f30, f30, f30, f30};
		if (false in v22) {
			globalState.f15 := seq(0x3b2, i1  => ('g'));
			v19[581] := -310;
			v19[581] := -p1;
			v2[682] := f30;
			v2[682] := f30;
			...
			globalState.f1 := -(fm2(f30, globalState) % p1);
			v5 := v5 * v5;
			var v23 := 'x';
			...
			var v30: map<bool, array<bool>> := map[v29[p1] := v2];
		...
		var v40 := 'v';
		r1, v33, r1, globalState.f21 := v35 >= v35, v36.cf19, (fm11(f30, f30, "m", v39, globalState) + v0[p1 := v40]) == v0, f30;
	...
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		v10 := if (!v11[0x37d]) then v10 else v10;
		for i0 := f31 to f31 {
			var v12 := 'm';
			v12 := 'j';
			...
			if (v15.cf17) {
				globalState.f19 := v1[f31 * f31];
				v8 := v8;
				var v16: seq<D0> := [DC3(i0, f30, v14[170])];
				var v17: map<bool, seq<D0>> := map[f30 := v16];
				var v18 := DC9(v17);
				var v19: seq<D4> := [DC13()];
				var v20: set<seq<D4>> := {v19};
				v18 := fm17(v20, i0 % v14[170], f30, globalState);
				var v21 := DC5(v14);
				v21 := v21;
				...
				v8[965] := if (f30 in v23) then v23[f30] else true;
				v14[170] := -v14[170];
				v14[170] := |(("nhkgm" + v0) + (v0 + "xyapktedr"))|;
				...
				r0, v14[170], v24[104], v14[170] := |v26| < (if (v14 in v27) then v27[v14] else if (v28 in v29) then v29[v28] else |v1|), f31, v11 + (v11 + v11), 349;
				v28 := v28;
			}
			
		}
		var v31: array<map<int, bool>> := new map<int, bool>[5](i1 => map v30 : int | v30 in {|[map[f30 := f31], map[f30 := |multiset{false, f30, f30}|], map[f30 := f31], map[f30 := |"ph"|]]|, 11, f31, -f31} :: (v30 / f31) := (true));
		var v32: map<int, bool> := map[f31 := v11[f31]];
		v31[950] := v32;
		v31[950] := fm18(globalState);
	...
	method m11(p0: array<bool>, p1: bool, p2: D0, globalState: GlobalState) {
		...
		globalState.f24 := fm2(v5.cf24, globalState) / f31;
		globalState.f21 := p1;
		var v6: map<bool, seq<bool>> := map[p1 := [f30, p1]];
		var v7: seq<bool> := [f30, p1, f30];
		var v8: array<seq<bool>> := new seq<bool>[16] [if (p1 in v6) then v6[p1] else v7, v7, v7, v7, v7, v7, [!p1], v7, [p1], v7, v7, [v7[f31], p1] + v7, v7, v7, if (p1 in v6) then v6[p1] else v7, v7[f31 := p1]];
		v8[958] := v7;
		v8[958], globalState.f19, globalState.f24, globalState.f21 := [p1] + (v7 + v7), -f31, f31, p1;
		var v9: array<array<bool>> := new array<bool>[2] [p0, p0];
		var v10: map<array<array<bool>>, bool> := map[v9 := f30];
		var v11: set<int> := {f31};
		var v12: seq<set<int>> := [v11];
		var v13: map<set<int>, bool> := map[v12[f31] := p1];
		var v14: map<bool, map<set<int>, bool>> := map[p1 := v13];
		var v16 := 'k';
		globalState.f15 := (fm11(f30, if (v9 in v10) then v10[v9] else if (|v2| in v4) then v4[|v2|] else f30, v2, if (p1 in v14) then v14[p1] else map v15 : set<int> | v15 in v13 :: (v15) := (f30), globalState))[f31 * f31 := v16];
	...
	method m12(p0: bool, p1: array<bool>, p2: int, globalState: GlobalState) {
		...
		if (f30) {
			...
			if (f31 == (|v16| / f31)) {
				...
				var v21: seq<int> := [p2];
				p1[898] := |v19| in {|v20|, f31, |v21|, f31, -p2};
				v18[977], p1[898], globalState.f1 := p1, false, f31 % p2;
				var v22: array<int> := new int[17](i0 => i0 % |v1|);
				v22 := v22;
				...
				var v28: seq<int> := [|v24|];
				var v29: map<string, seq<multiset<D2>>> := map[v16[p2 := v3] := [v27[v26 := |v28|], v27, (multiset{v26})[v26 := |(if (p2 in v8) then v8[p2] else v16)|], v27]];
				var v30: map<bool, int> := map[false := fm2(p0, globalState)];
				var v31: seq<multiset<D2>> := [v27, v27[DC8(v25) := -|v30|]];
				...
				var v35 := DC20(true, |v32.cf4|, v33[v6 := f31], if (p2 in v34) then v34[p2] else fm1(f31, p2, v3, globalState), p2);
			...
			if (!f30) {
				v16 := ((seq(0xeb, i1  => ('f')))[|"qqvkmq"| := v3] + v16) + "fyevadcsw";
				var v37 := DC14(f31);
				v37 := v37;
				...
				globalState.f11 := |(if (p0 in v40) then v40[p0] else v16[p2 := v3] + "cdc")|;
				globalState.f24 := p2;
			} else {
				...
				var v42 := DC0(p1);
				v42 := v42;
				var v43: array<string> := new string[5] [v16[-0x15b := v3], "fqlscxi", v16 + v16, v16, (v16 + "eywbetu")[|[p0, p0]| := v6[759]]];
				v43[26] := v16 + v16;
				var v44: set<string> := {v16};
				v43[26], v6[759], v44 := v16[p2 := v6[759]] + v16, v3, v44;
			}
		...
		match (f35) {
			case DC6(cf14) =>
				...
				v46[377] := |(if (p0) then v47 else v47)|;
				v46 := v46;
				var v48: multiset<bool> := multiset{f30, f30};
				p1[322] := fm1(|v48|, |[|v48|]|, v3, globalState);
				p1[322] := p0;
				globalState.f21 := p1[322] <==> f30;
			case DC7() =>
				var v49 := DC0(p1);
				...
				v51 := v51;
				var v52: set<string> := {seq(0x3c3, i2  => (v6[759]))};
			...
			case DC5(cf13) =>
				...
				v54, globalState.f19, globalState.f21, globalState.f21 := v54, -(|(multiset(v1))[f30 := 0x234]| % |v57|), v58.cf10, !(if (f30) then !p0 else -0x37d < f31);
				var v59 := DC0(p1);
...
class C2 extends T0 {
	...
	function fm27(p0: bool, p1: int, p2: bool, globalState: GlobalState): bool {
		!((if (!true) then seq(0x9f, i0  => ('b')) else "yptycmo") < (seq(0x2a5, i1  => ('g'))))
	}
	method m3(p0: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		var v0 := 'j';
		var v1 := DC16(v0, f27);
		var v2: seq<char> := [v0, v0, v0, v0, v0];
		var v3: array<char> := new char[28] [v0, v0, v1.cf22, v0, v0, v0, v2[0xf8], v0, v0, v0, v0, v0, v0, v0, 'i', v0, v0, v0, v1.cf22, v0, v0, v0, v0, v0, v0, v0, v0, v0];
		v3[828] := v0;
		var v4: set<int> := {f27, |v2|};
		var v5: set<bool> := {fm27(p0, |v4|, true, globalState), p0};
		v3[828], globalState.f19 := v0, if ("kb" == "mmcpop") then |v5| else f27;
		if (p0) {
			v2 := v2;
			var v6: multiset<int> := multiset{-f27, f27, f27};
			var v7: set<multiset<int>> := {multiset(([f27])[fm7(false, globalState) := |v2|]), v6};
			var v8: array<bool> := new bool[12] [p0, p0, fm1(f27, -|v7|, 'e', globalState), p0, p0, p0, fm1(|v6|, |v2|, v3[828], globalState), p0, f27 < f27, p0, f27 > f27, v3[828] in v2];
			...
			v8 := new bool[8] [if (p0 in v9) then v9[p0] else p0, p0, !p0, fm1(f27, f27, v3[828], globalState), !v12.cf31, p0, p0, p0];
			var v13: seq<string> := [v2];
			var v14: map<bool, seq<string>> := map[p0 := v13 + v13];
			v14 := v14[p0 && p0 := (seq(783, i0  => (v2))) + v13];
			v3[828] := 'k';
			if (!(p0 || p0)) {
				...
				v15[222] := v17;
				v15[222] := v17;
				v13 := v13[f27 := "dgajvkgme"];
				r1 := !(p0 <== p0);
				var v18: map<string, int> := map["ucmv" + (seq(464, i1  => (v3[828]))) := 0x2cd];
				v18 := v18[v2 := |v6|];
			} else {
				var v19: map<int, bool> := map[-f27 := false];
				var v20: map<map<int, bool>, int> := map[v19 := f27];
				globalState.f25 := |v20| % (f27 * f27);
			...
			var v23: array<int> := new int[4](i2 => i2 % f27);
			...
			if (f27 != f27) {
				var v27 := DC5(v23);
				var v28: array<array<int>> := new array<int>[20] [v26.f36, v23, v23, v26.f36, v23, v26.f36, v26.f36, v26.f36, v26.f36, if (fm1(|"mvfbfssm"|, f27, v0, globalState)) then v26.f36 else v23, v27.cf13, v26.f36, v26.f36, v23, v24[f27], v23, v23, v26.f36, v26.f36, v23];
				v28 := v28;
				v23[414] := f27 / f27;
				var v29: seq<int> := [|v2|, 0x23c];
				v23[414] := |(v2 + v2)| % |v29|;
				var v30: multiset<int> := multiset{v23[414]};
				var v31: map<int, bool> := map[-154 := p0];
				globalState.f19 := if (v23[414] in v30) then v30[v23[414]] else if (p0) then f27 else |v31|;
				globalState.f21 := p0;
				globalState.f19, globalState.f21, globalState.f21 := -((f27 / f27) - v23[414]), if (!(p0 && p0)) then p0 else v2 < "vswtjyfr", p0;
			} else {
		...
		for i3 := if (multiset{p0, p0} in v38) then v38[multiset{p0, p0}] else f27 to f27 {
			...
			match (fm28(globalState)) {
				case DC10(cf17, cf18) =>
					v3[828] := fm29(false, globalState);
					var v47: array<string> := new seq<char>[3](i4 => v2);
					var v48: map<char, array<string>> := map[v3[828] := v47];
					v48 := v48[v3[828] := v47];
					var v49 := DC0(f38);
					v49 := DC0(f38);
					v47[24] := v2;
				...
				case DC11() =>
					...
					var v53: seq<int> := [i3];
					var v54: array<bool> := new bool[18] [p0, p0, !p0, !p0, p0, p0, p0 ==> p0, p0 <== p0, v50 !! v50, v0 in v51, true, v44 !! v44, p0, v52[v53[-i3]], 0x62 != |v52|, p0, false, p0];
					var v55: array<array<bool>> := new array<bool>[26];
					var v56: seq<array<array<bool>>> := [v55, v55];
					v54, v55, globalState.f21 := f38, v56[i3], p0;
					var v57: array<int> := new int[5] [f27, f27, f27, f27, i3];
					var v58: map<string, int> := map[seq(797, i5  => (v0)) := 493];
				...
				case DC9(cf16) =>
					...
					v68 := v68;
					globalState.f19 := fm6(v44, globalState) / (i3 + -i3);
			}
			...
			match (v69) {
				...
				case DC23(cf40) =>
					...
					var v72: seq<map<bool, bool>> := [map[p0 := p0], v39, v71[f27]];
					var v73: seq<bool> := [p0];
					var v74: map<seq<bool>, D5> := map[v73 := v1];
					var v75: map<map<bool, bool>, D7> := map[v72[f27] := DC21(v74)];
					var v77: seq<bool> := [v75 != (map v76 : map<bool, bool> | v76 in (seq(235, i6  => (v39))) :: (v76) := (DC21(v74))), p0, p0, p0];
					...
					globalState.f21, globalState.f21, globalState.f21 := false, p0, fm1(f27 / i3, i3, v3[828], globalState);
			}
	...
	method m4(globalState: GlobalState) returns (r0: array<string>, r1: int, r2: int, r3: D0) {
		if (false) {
			...
			f38[521] := v8 > v8;
			globalState.f21 := v7;
			var v9: array<int> := new int[21](i0 => i0 % f27);
			var v10: map<bool, bool> := map[f38[521] := v7];
			var v11 := new C0(v9, fm32(v10, v7, f38[521], globalState));
			globalState.f21 := !f38[521];
			if (f38[521]) {
				var v12: map<int, bool> := map[f27 := v7];
				var v13 := DC3(f27 / f27, !!v7, |v12|);
				v13 := v13;
				...
				var v17: seq<int> := [|v16|];
				v11.f36[532] := if ((f27 - f27) in v15) then v15[f27 - f27] else |v17|;
				var v18: seq<bool> := [f38[521], f38[521]];
				var v19: map<int, seq<bool>> := map[fm7(f38[521], globalState) := v18];
				v19 := v19[v11.f36[532] % f27 := v18];
				var v20: set<map<int, int>> := {v15, v15};
				var v21: array<bool> := new bool[21](i1 => v7);
				var v22 := DC1(v11.f36[532], fm33(v20, globalState), v11.f36[532], "rreomjoi", v21);
				var v23: map<bool, int> := map[v7 := v22.cf1];
				var v24 := DC1(|v16|, v17, v17[|v23|], fm34(f27, f27, v7, f27, globalState), v21);
				...
				v11.f36[330] := f27;
				v11.f36[330] := -f27;
				var v30: map<int, set<int>> := map[v11.f36[330] := {f27}];
				v30 := v30;
			}
		...
		var v36: set<int> := {f27};
		var v37: array<int> := new int[19] [f27, f27, f27, f27, f27, -f27, |v35|, f27, |v33|, f27, v35[f27], f27, f27, f27, f27, f27, f27, |v36|, |v33|];
			...
			decreases 100 - i2
		{
			...
			if (v34) {
				...
				globalState.f21, v37[888] := !((multiset{(fm35(true, f27, globalState))[true := f27]} > multiset(v41)) <==> v34), |v42[|map[v35[fm2(v34, globalState)] := false]|]|;
				...
				var v50: seq<set<int>> := [set v47 : int | (0x1b4 <= v47) && (v47 < 0x2b0) :: (v47 % v35[v37[888]]), v36, {if (v48 in v49) then v49[v48] else |v35|, |v31|}];
				var v51: seq<seq<set<int>>> := [seq(337, i3  => (v36)), [{|v36|}]];
				globalState.f21, globalState.f21, v44[85], v46, v50 := v34, v34, v43, v46, v51[v37[888]] + v50;
				v40 := v40[v34 := |v35|];
				var v52: set<string> := {v33};
				var v53: seq<set<string>> := [v52, v52];
				v52 := v53[|fm31(false, globalState)|];
			} else {
				var v54 := DC7();
				...
				f38[136] := !v34;
				f38[136] := fm27(v34, f27, true, globalState);
		...
		r0 := v61;
		r1 := f27 * f27;
		var v62: set<string> := {v33[f27 := 'n'], v33};
		r2 := |v62|;
		var v63 := DC1(f27, seq(654, i5  => (f27)), -f27, "toghgusi", f38);
		r3 := v63;
	}
	method m14(p0: bool, p1: bool, p2: bool, p3: string, globalState: GlobalState) returns (r0: char, r1: map<bool, map<int, int>>, r2: string) {
			...
			decreases 100 - i0
		{
			...
			if (!p1) {
				var v0: seq<int> := [f27];
				globalState.f19 := v0[f27];
				var v1: seq<bool> := [false, p2, p0, true, p0];
				var v2: map<bool, string> := map[v1[f27] := p3 + p3];
				v2 := v2[p2 := p3];
				var v3: array<int> := new int[25];
				v3[307] := f27;
				var v4: multiset<bool> := multiset{p0, p2, p2, false, fm1(f27, f27, 'a', globalState)};
				globalState.f11, v3[307], globalState.f24, v1, globalState.f1 := f27, 0x2ac, f27, fm36(v4, globalState) + ([p1] + v1)[f27 := p0], f27;
				globalState.f1 := |v0|;
				...
				v11 := v11[v10 := seq(-0x3dd, i1  => (p3[-f27]))];
			} else {
				globalState.f15, globalState.f24, globalState.f24 := if (DC10(true, true).cf18) then p3 else "uet" + p3, f27 * (f27 % f27), -fm7(false ==> p0, globalState);
				r0 := 'e';
				var v12: set<bool> := {p1};
				...
				var v15 := new C0(v14, (map[p3[f27 := 'n'] := f27])[p3 := -0x32e]);
			}
		...
		match (v23) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				v24[263] := if (cf3 in v27) then v27[cf3] else v26;
				v24[263] := v26 + v26;
				...
				if (!(if (cf1 != cf3) then !!p1 !in v28 else p0)) {
					...
					var v35: map<multiset<int>, bool> := map[(multiset(cf2))[cf3 := 397] := v34 !! v34];
				...
				match (v54) {
					case DC22(cf37, cf38, cf39) =>
						...
						var v59: array<int> := new int[3](i2 => i2 % cf3);
						var v60: map<array<int>, array<bool>> := map[v59 := cf5];
						var v61: array<int> := new int[27] [fm7(p1, globalState), f27, cf3 - |cf4|, f27, cf1 / cf1, cf1, 343, cf1 % |cf4|, -cf1, f27, -|cf4[0x15a := cf37]|, v55.cf3, cf3 + cf3, f27 - cf3, f27, f27 / cf3, |v51| + f27, v58.cf27, |p3|, cf3, f27, 0x20c, cf3, -cf3, f27, cf3, |v60|];
						v61[163] := cf3 - cf3;
						v61[163] := cf1;
						cf5[693] := p2;
						var v62: map<bool, map<bool, bool>> := map[cf39 := v25];
						var v63: map<int, int> := map[cf1 := 0x3d9];
						var v64: set<int> := {if (f27 in v63) then v63[f27] else cf2[v61[163]], |"jtaybfs"|};
						cf5[693] := {f27, v61[163], cf1, |(if (p0 in v62) then v62[p0] else v25)|, cf1} != v64;
						globalState.f21 := cf5[693];
						globalState.f11 := cf3;
					case DC21(cf36) =>
						var v65: map<int, bool> := map[0x3aa := p1];
						var v66: array<int> := new int[3] [|cf2|, |v65|, cf2[cf3]];
						var v67 := DC5(v66);
						...
						v67, v68[981] := v67, v69;
						f38[818] := true;
						globalState.f21, f38[818] := p1, p2;
						v69[221] := seq(582, i3  => (cf3));
						var v70: array<D12> := new D12[25];
						var v71 := DC32(cf5, cf1, f27);
						v70[580] := v71;
						var v72: map<int, int> := map[cf3 := f27];
						var v73: set<map<int, int>> := {v72};
						var v74: seq<seq<int>> := [fm33(v73, globalState) + (seq(-780, i4  => (0x35a)))];
						v69[221], globalState.f1, v70[580] := v74[fm2(p2, globalState)], -(-(f27 - --cf2[cf3]) % cf3), v71;
				...
				v77 := v77[-(cf1 / cf1) := p3[0x12b]];
			case DC2(cf6, cf7, cf8) =>
				globalState.f1 := cf6;
				cf6 := -527;
				globalState.f25 := f27;
				var v79: array<string> := new string[9](i5 => ("vmwfwufq")[|[f27, |(map v78 : int | (0x286 <= v78) && (v78 < 0x10e) :: (v78 + cf6) := (cf7))|]| := 'h']);
				v79[345] := cf7;
				...
				var v85: set<C1> := {v84};
				var v86: map<int, int> := map[|v81[cf6 := |v82|]| := |v85|];
				...
				v79[345], v88, globalState.f25, v89[355], globalState.f25 := cf7 + ("vnvimmbdc")[|[p2]| := v91], DC10(p1, p2), cf8, v94, cf6;
			case DC3(cf9, cf10, cf11) =>
				...
				match (DC6(v99).(cf14 := map[v23 := multiset{p1}])) {
					case DC6(cf14) =>
						f38[260] := {p1, p1} !! fm37(|map[p1 := cf11]|, cf9, globalState);
						f38[260] := !p1;
						cf10 := p1;
						f38[260] := (-cf9 * cf9) <= f27;
					...
					case DC7() =>
						...
						var v110: array<string> := new seq<char>[27] [(seq(976, i6  => (v97))) + p3, "pt", p3, p3, p3, ("yievvslm" + p3)[v109.cf3 := 'm'], p3, p3 + p3, p3, seq(826, i7  => (v97)), p3, p3 + p3, p3 + p3, (seq(0x222, i8  => ('q'))) + "b", p3 + p3, p3, p3, p3, p3, "owbiy" + p3, "rlnltu", p3, "knewlvu" + p3, p3, p3, p3 + p3, p3 + (seq(627, i9  => (v97)))];
						v110, globalState.f25 := v110, cf11;
						globalState.f11 := cf11;
					case DC5(cf13) =>
						var v111: multiset<int> := multiset{|fm40(f27, p0, true, globalState)|, cf9};
						f38[617] := cf9 <= |v111|;
						f38[617] := v111 > multiset{cf9, f27, f27};
						globalState.f21 := p2;
						v97 := v97;
			...
			case DC0(cf0) =>
				...
				v113[28] := if (f27 in v115) then v115[f27] else if (f27 in v115) then v115[f27] else v114;
				...
				var v128: map<bool, set<int>> := map[p2 := set v127 : int | v127 in v126 :: (v127 % 0x35f)];
				...
				v118[552], globalState.f21, globalState.f21, globalState.f11, globalState.f19 := v125.(cf2 := seq(-0x183, i10  => (-f27)), cf3 := -|(if (p2 in v128) then v128[p2] else v130)|, cf4 := if (p0) then p3 else "wgpibho"), false ==> p0, false, |v131| % f27, (if (f27 in v132) then v132[f27] else -f27) - (f27 / f27);
				f38[486] := p1;
				var v133: multiset<char> := multiset{v119, v119, v119};
				f38[486] := v119 !in (v133 - v133);
			case DC4(cf12) =>
				...
				if (if (p0) then p1 ==> p0 else f27 <= f27) {
					...
					v136.f36[982] := v146[f27];
					v136.f36[982] := f27;
					f38[129] := p1;
					f38[129] := p2;
					v134 := v134;
					var v147: map<bool, bool> := map[f38[129] := !p0];
					var v148: multiset<int> := multiset{v136.f36[982], v146[f27] % |v147|, v136.f36[982]};
					f38[129], v136.f36[982], globalState.f15 := f38[129], ---(if (f27 in v148) then v148[f27] else f27), ("sg" + p3) + (seq(0x95, i12  => ('i')));
					f38[129] := p1;
				}
		...
		globalState.f25 := if (p0) then v149[f27] else |p3|;
...
class C3 extends T1 {
	...
	function fm11(p0: bool, p1: bool, p2: string, p3: map<set<int>, bool>, globalState: GlobalState): string {
		((seq(0x84, i0  => ('v'))) + "onqwl") + ("bqvrxhm" + (seq(598, i1  => ('r'))))
	}
	function fm12(globalState: GlobalState): seq<bool> {
	...
	method m5(p0: map<map<bool, char>, string>, p1: int, p2: set<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		match (v8) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				v9 := new array<char>[19] [v10, v10, v10, v10, v10, v10, v10, v10, v11[cf1], v10, v10, v10, v10, v10, v10, if (cf2[cf3] in v13) then v13[cf2[cf3]] else v10, v10, v10, v10];
				globalState.f21 := f30;
				globalState.f15 := "xw";
				cf2 := cf2 + [cf1];
			case DC2(cf6, cf7, cf8) =>
				var v14: map<seq<bool>, bool> := map[([f30, f34])[483 := f30] := f34];
				var v15: seq<bool> := [f34];
				v14 := v14[v15 := f30];
				var v16: multiset<int> := multiset{cf6};
				var v17: map<int, int> := map[cf6 := |v16|];
				globalState.f1 := |(v17 + v17)| % (cf6 % p1);
				var v18 := 'f';
				v18 := v18;
			...
			case DC3(cf9, cf10, cf11) =>
				...
				var v28 := "fygwi";
				globalState.f19, v22, globalState.f21, v23[965], globalState.f19 := p1 + cf9, v22, v22.f30, p2 - (p2 - p2), if ((map[v24 := |[false]|])[fm21(v28, 449, f34, p1, globalState) := v22.f31] in v27) then v27[(map[v24 := |[false]|])[fm21(v28, 449, f34, p1, globalState) := v22.f31]] else 0x29c;
				...
				var v31 := 'm';
				var v32: seq<string> := [v28[cf11 := v31]];
				...
				var v36: array<int> := new int[28] [cf9, f31, cf11, f31 + p1, p1, p1, v22.f31, v22.f31, p1, cf11, f31, f31, if (v22.f30) then |v28| else v30[0x334], f31, f31, cf11, |v32[f31]|, v22.f31, cf9, f31, p1, cf11 + f31, v22.f31, |v34|, |fm3(fm1(|map[f30 := f31]|, f31, 'h', globalState), globalState)|, cf9, if (cf10 in v35) then v35[cf10] else cf9, |("lo" + v28)|];
				v36[485] := -v22.f31 / -0x1c6;
				v36[485] := p1 % p1;
			case DC0(cf0) =>
				globalState.f25 := f31;
				globalState.f21 := f34;
				...
				var v42: array<int> := new int[13] [0x166, |v38| / (if ((if (f34 in v40) then v40[f34] else f30) in v39) then v39[if (f34 in v40) then v40[f34] else f30] else -f31), p1, if (f30 in v41) then v41[f30] else p1, p1, |[f34]|, p1, f31, f31, f31, f31, 0x88, f31];
				v42[405] := p1;
				var v43 := "lajb";
				v42[405], r0, v42, globalState.f25 := 0x2db, -268 % p1, v42, |(v43 + v43)|;
			case DC4(cf12) =>
				var v44: seq<int> := [p1];
				var v45 := 'o';
				...
				if (v48 != v48) {
					...
					r1, v44 := f34, v44;
					v47[78] := v44[v47[78]];
					globalState.f25 := v47[78] + (v47[78] * fm2(f30, globalState));
				} else {
					r0 := f31;
					var v50: map<int, bool> := map[310 := f34];
					f34 := map[f31 := f34] == v50;
					var v51: seq<char> := [v45];
					var v52 := DC15(v51[fm2(f34, globalState)]);
				...
				var v55: array<array<bool>> := new array<bool>[13] [v54[f31], v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6];
				v55 := v55;
		...
		if (false) {
			...
			v72 := fm22(true, f34, v63, globalState) + (seq(-0x3c0, i3  => (v71)));
			if (!f34) {
				...
				v75 := v79[|v80|];
				v6[206] := DC22(v67, f34, f30).cf38;
				v6[206] := "qqq" < DC1(f31, v64, f31, v63, v6).cf4;
				var v82: multiset<set<int>> := multiset{set v81 : int | v81 in v64[f31 := f31] :: (v81 % |map[0x225 := true]|), {p1}};
			...
			match (v85) {
				case DC16(cf22, cf23) =>
					...
					v65[902] := if (f30 in v61) then v61[f30] else -p1;
					var v90: seq<D1> := [v66, v66];
					v65[902], globalState.f21, v90 := |("xogjggyd" + v63)|, f30, v90;
				case DC17(cf24, cf25, cf26, cf27, cf28) =>
					var v91: seq<array<bool>> := [v6, v6];
					var v92: array<array<bool>> := new array<bool>[24] [v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v91[cf28], v6];
					v92[732] := v6;
					v92[732] := v6;
					v92[732][920] := f30;
					var v93: map<char, int> := map['h' := -f31];
					var v94: array<char> := new char[3] [v67, v67, v67];
					v92[732][920] := fm1(|v93[v67 := -cf27]|, |map[cf26 := v94]|, 'j', globalState);
					globalState.f15 := (v63 + "f") + v63[p1 := v67];
					v70.f36[240] := cf28;
					v70.f36[240] := p1;
				case DC15(cf21) =>
					var v95: set<char> := {v67};
					var v96 := DC17(f34, true, f34, p1, p1 % --|v95|);
					v96 := v96;
					v67 := v67;
					var v97 := DC14(f31);
					v97 := v97;
				...
				case DC18(cf29) =>
					...
					v102 := v102[v63[p1 := v67] := fm1(-815, p1, fm19(!v103[|v63|], f30, !f30, v104, globalState), globalState)];
					var v105: set<bool> := {!f34};
					var v106: seq<set<bool>> := [{f30}, v105];
					var v107 := DC19(v106[|v103|]);
					v107 := v107;
			...
			v6[991] := f30;
			v6[991] := f30;
			var v111 := DC23(map[0x107 := |(seq(0x28c, i4  => (-p1)))|]);
			v111 := DC23(fm23(globalState));
			f34 := false;
			r0 := 546;
			if (false) {
				var v112 := 'i';
				var v113: map<bool, char> := map[v6[991] := v112];
		...
		if (f34) {
			...
			var v129: multiset<bool> := multiset{v128[p1], f34, !f30, f34};
			v129 := v129;
			var v130: array<int> := new int[6](i5 => i5 + f31);
			var v131 := "emixmsb";
			var v132: seq<string> := [v131, v131, "jfieruxr"];
			var v133: map<string, int> := map[v132[f31] := f31];
			...
			match (v136) {
				...
				case DC17(cf24, cf25, cf26, cf27, cf28) =>
					...
					var v147: array<string> := new string[22] [(v131 + v131)[cf28 := v136.cf21], "n" + v131, v131, v131, v131, "lwcuxbqy", v131, v131, v131, v131[cf27 := v135], "tcaora", v131, v131, v131, seq(0xd7, i7  => (v135)), v131 + v131, v131, "cpjpg" + "laihcys", v131, "tqx", "qpuvs", v131];
					v147[222] := v131;
					v144[889], globalState.f24, v146, v147[222] := v145, fm2(cf24, globalState), DC25(v146).cf41, seq(0x12e, i8  => (v135));
					v147[222] := v131 + v131;
					var v148: map<int, bool> := map[cf28 := f34];
					v148 := v148[cf27 := true];
					var v149: set<bool> := {!cf24, f30};
					var v150 := DC19(v149);
					v150 := fm25(v131 + v131, p1, -819 % p1, fm26(f30, globalState), globalState);
				case DC15(cf21) =>
					globalState.f21 := f34;
					v134.f36[57] := f31;
					var v151: seq<multiset<bool>> := [fm3(f30, globalState), v129, v129, v129, v129];
					var v152: map<int, int> := map[f31 := p1];
					v134.f36[57], v151 := -|(v131 + v131)| / |v152|, v151[|v132| := v129 + v129];
					var v153: seq<array<int>> := [v130];
					var v154: array<array<int>> := new array<int>[25] [v130, v153[f31], v134.f36, v130, v134.f36, v134.f36, v130, v130, v134.f36, v130, v130, v134.f36, v134.f36, v153[p1], v130, v130, v130, v130, v130, v130, v130, v134.f36, v134.f36, v134.f36, v134.f36];
					v154[580] := v134.f36;
					v154[580] := v134.f36;
				...
				case DC18(cf29) =>
					...
					var v162, v163, v164, v165 := m10(v131, {f30}, f31, v161[f31], globalState);
			}
			...
			match (v169) {
				case DC26(cf42, cf43) =>
					...
					var v173: map<set<set<char>>, multiset<bool>> := map[v171 * v172[p1] := v129 + v129];
					v173 := v173[v171 := v129];
					globalState.f1 := f31;
					var v174: seq<array<int>> := [v130, v134.f36];
					v134.f36[378] := p1 / -|v174|;
					var v175: map<int, int> := map[f31 := f31];
					var v176: map<int, int> := map[f31 := |v175|];
					v134.f36[378] := f31 - (if (p1 in v175) then v175[p1] else 0x3cb);
				...
				case DC27(cf44, cf45, cf46) =>
					...
					var v182: map<int, int> := map[|v129| / p1 := -|v181| + p1];
					v182 := v182[p1 * p1 := f31];
				case DC25(cf41) =>
					v135 := v135;
					globalState.f21 := !f34;
			...
			if (f34) {
				...
				var v189: array<int> := new int[2](i10 => i10 % f31);
				var v190 := 'k';
				...
				v194[361], v195 := v191 + v191[v192.cf13 := false], v195;
				var v196 := "yspbbk";
				...
				v198[498], globalState.f21, globalState.f15, globalState.f21 := |v206[-0x3d5]| / |v184|, v207 <= v207, "onbyucb", f30;
				var v208: seq<int> := [|(v202 + v202)|, v198[498]];
				v208 := v208;
			}
	...
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		for i0 := f31 to f31 {
			...
			if (f30) {
				var v6: set<int> := {-f31};
				var v7: set<int> := {|v6|, 0xeb / -f31, i0 - f31, i0};
				var v8 := "tkjwkyort";
				...
				var v14 := DC13();
				var v15 := DC26(v14, seq(0x2d3, i3  => (v5)));
				var v17: set<set<int>> := {{f31, i0}};
				var v18: seq<string> := [(v15.(cf42 := DC13())).cf43, fm11(f34, f30, v8[i0 := v5], map v16 : set<int> | v16 in v17 :: (v16) := (f34), globalState), v8, v8];
				var v20: array<int> := new int[16] [|v13|, i0, i0, i0, f31, -f31, i0, f31, f31, |(seq(94, i2  => (v5)))|, f31, |v18[f31]|, |(map v19 : int | (0x264 <= v19) && (v19 < 0x8d) :: (v19 / |[f34]|) := (f34))|, i0, i0, f31];
				var v21: seq<array<int>> := [v20, v20, v20];
				var v22: map<string, int> := map["u" := f31];
				var v23: C0 := new C0(v21[i0], v22);
				...
				var v33: array<seq<int>> := new seq<int>[23] [v32, v32, v32, v32, v32, [f31], v32, seq(0x7f, i4  => (f31)), v32, v32, v32, seq(117, i5  => (|v25|)), v32, seq(0x252, i6  => (v26.f27)), v32, v32, v32, v32, v32, v32, [v26.f27], v32, seq(0x2a0, i7  => (|v4|))];
				var v34 := DC30(v33);
		...
		var v42: map<string, int> := map[seq(706, i9  => ('a')) := f31];
		var v43 := new C0(v41, v42);
		globalState.f21 := !f30;
		var v44: multiset<char> := multiset{v39};
		globalState.f19 := (f31 % f31) % (if (v39 in v44) then v44[v39] else f31);
	...
	method m9(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		match (if (true) then v6 else v6) {
			case DC13() =>
				...
				v0[519] := |map[v1 := v8.cf24]|;
				var v10: map<map<int, bool>, int> := map[map v9 : int | (176 <= v9) && (v9 < -457) :: (v9 % -f31) := (f30) := f31];
				var v11: seq<int> := [f31];
				var v12: map<int, bool> := map[|v11| := f34];
				globalState.f25, v0[519] := f31 * f31, if (v12[f31 := fm1(f31, f31, 'a', globalState)] in v10) then v10[v12[f31 := fm1(f31, f31, 'a', globalState)]] else f31 + v8.cf27;
			case DC14(cf20) =>
				...
				if (f34) {
					...
					var v19: array<bool> := new bool[19] [!f30, f34, false, false, f34, f30, f30, !f34, f34, f34, f30, f34, f34, f34, f34, fm1(cf20, |fm11(f34, f34, v1[cf20 := v14], v18, globalState)|, v14, globalState), !f34, f34, false];
					var v20: map<bool, char> := map[f30 := v14];
					cf20 := DC32(v19, |v20|, f31).cf54;
					var v21 := new C2(v19, cf20);
					v4.f36[339] := cf20;
					r1, v4.f36[339], globalState.f21, globalState.f21, globalState.f19 := (v2 * v2) !! (if (f30) then multiset{fm1(cf20, f31, v14, globalState), f30} else v2), |(v1 + fm11(f34, f34, v1, v18, globalState))|, f34, !f30 || f34, f31;
					var v22: map<multiset<bool>, int> := map[v2 := fm2(f34, globalState)];
					v22 := v22[v2 := v4.f36[339]];
					var v23: multiset<char> := multiset{v14};
					var v24: seq<multiset<char>> := [v23];
					var v25: map<seq<multiset<char>>, seq<int>> := map[v24[v4.f36[339] := v23] := v15];
					...
					globalState.f21, v29, globalState.f21 := (cf20 >= fm2(f30, globalState)) <== false, v30[|v31|], !(f31 < cf20);
					...
					v4.f36[412] := f31;
					v2, v35, v4.f36[412] := v2, {f34}, fm2(f34, globalState);
					...
					v37 := v37[v4.f36[412] := if (v38[|(if (cf20 in v39) then v39[cf20] else [f34, f30])|]) then v36 else v36];
					var v40 := DC7();
					var v41: T1 := new C1(v40, f30, if (f34) then v4.f36[412] else v4.f36[412]);
					v41 := v41;
			...
			case DC12(cf19) =>
				...
				var v49: array<string> := new string[8] ["bwes", fm11(f34, f30, "fvnfpqfw", v48, globalState) + "mo", v1, v1, v1, "csveffbvu" + v1, v1, seq(474, i0  => (v47))];
				v49[509] := v1 + v1;
				v49[509] := v1;
				f34 := f30;
		...
		if (f30 <==> (f31 <= f31)) {
			...
			v51[261] := DC10(f30, f30);
			var v52 := DC10(f30, f30);
			v51[261] := v52.(cf17 := if (f34) then f34 else f30);
			...
			v62 := v62;
			v4.f36[626] := f31;
			v4.f36[626] := (|(seq(0x31a, i1  => ('p')))| - 0x3b5) - (f31 * f31);
			globalState.f21 := f34;
			var v63 := 'o';
			var v64 := DC16(v63, v4.f36[626]);
			match (v64) {
				case DC16(cf22, cf23) =>
					v4.f36[626] := v4.f36[626];
					v4.f36[626] := f31;
				...
				case DC17(cf24, cf25, cf26, cf27, cf28) =>
					...
					v69 := v69[cf24 := |[v59[cf27], v4.f36]|];
					globalState.f11 := v4.f36[626];
					...
					v75[169] := v76;
					v74, cf24, globalState.f21, v75[169], v68 := v74 + (v74 + v74), cf25, f30, v76, (v68 - v68) + ((set v77 : int | (0x381 <= v77) && (v77 < 0x2da) :: (v77 * v4.f36[626])) * v68);
				case DC15(cf21) =>
					var v78: seq<int> := [v4.f36[626]];
				...
				case DC18(cf29) =>
					...
					v84[899], v4.f36[626] := (if (f30) then |v85| else v4.f36[626]) < (v4.f36[626] / 0x155), f31;
					globalState.f1 := v4.f36[626] / v4.f36[626];
			}
			...
			var v91: array<string> := new string[12] [v1 + v1, fm34(f31, |(if (-f31 in v86) then v86[-f31] else v87)|, f34, f31, globalState), v1 + "shq", fm11(f30, f34, seq(-618, i4  => (v63)), v90, globalState) + v1, "quys", v1 + v1, "hudxv", "s", "ejalgpr", "a", "wlkt", v1];
			v91[614] := v1;
			v91[614] := "hpekrk";
		}
			...
			decreases 100 - i5
		{
			...
			var v99: seq<int> := [0x214, |(v94[0x1d])[|v98| := f31]|];
			var v100: map<seq<int>, int> := map[v93[0xba := f31] := 0x351];
			v100 := v100[[f31] := f31];
			v1 := "tebpwva";
		}
		var v101: array<seq<int>> := new seq<int>[24](i6 => (seq(-0x190, i7  => (|v1|))) + [f31]);
		var v102 := DC13();
		...
		r1 := (if (v105[0x1]) then v105 else [f34, f34, f34, f30]) in v106;
	}
	method m10(p0: string, p1: set<bool>, p2: int, p3: int, globalState: GlobalState) returns (r0: D2, r1: array<map<char, int>>, r2: int, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v3: array<int> := new int[9](i1 => i1 % p3);
			var v4: map<bool, int> := map[f30 := p3];
			var v5: map<bool, map<bool, int>> := map[f34 := v4];
			v3[977] := |(v4 + (if (f34 in v5) then v5[f34] else v4))|;
			v3[977] := p2;
			var v6: map<string, int> := map["nsamxw" := |p0|];
			var v7 := new C0(v3, v6);
			var v8: multiset<int> := multiset{p3 % p2, f31};
			v8 := v8 + v8;
			var v9: map<int, bool> := map[|p0| := f30];
			var v10: seq<int> := [|(seq(-0x3e4, i2  => ('l')))|];
			...
			if (!((if (p2 in v9) then v9[p2] else f34) in v11[f30 := v10])) {
				...
				var v14: multiset<string> := multiset{p0, if (f30) then "rgvpacxer" else p0, p0 + p0, v12[if (f31 in v13) then v13[f31] else p3]};
				globalState.f11 := if (p0 in v14) then v14[p0] else fm2(f30, globalState);
				globalState.f1 := v3[977];
				var v15: set<string> := {"fexnuc", p0};
				var v16 := 'w';
				var v17: map<int, char> := map[p3 := v16];
				var v18: map<char, map<int, char>> := map[v16 := v17];
				globalState.f25, globalState.f15, v15, globalState.f15, f34 := p3 + p2, p0, v15, fm34(|v8|, p3, fm1(|v18|, p2, v16, globalState), p3 / p2, globalState), f30;
				...
				var v32 := DC20(f34, v3[977], v31, false, |v8|);
				var v33: map<set<bool>, int> := map[p1 := v3[977]];
				globalState.f19, v27.f38[735], v3 := -(v32.cf35 * f31), ([|v33|])[v3[977] := f31] < v10, v7.f36;
				v3[977] := p3;
			}
		...
		v34[921] := p3;
		var v35 := 'g';
		var v36 := DC2(|map[p3 := DC2(f31, p0, p2)]|, ("nvowlhkk")[|"ndjwuy"| := v35], p3);
		var v37: multiset<bool> := multiset{f30};
		v34[921] := match DC6(map[v36 := v37]) {
		...
		if (fm1(fm2(f30, globalState), f31, v35, globalState)) {
			if (!f30) {
				...
				var v41: map<int, int> := map[p2 := v34[921]];
				var v42: C0 := new C0(v40[0x318], map[p0 := |v41|]);
				var v43: multiset<C0> := multiset{v42};
				var v44 := DC12(v43[v42 := p3]);
				v44 := if (f34) then v44 else DC12(v43);
				var v45: array<bool> := new bool[24](i4 => !f34);
				var v46 := new C2(v45, f31);
				var v47: array<string> := new seq<char>[6] [seq(-0x306, i5  => (v35)), DC2(p3, p0, f31).cf7, seq(464, i6  => ('d')), p0, p0, "ygkoqeljg"];
				v47 := new string[3];
			} else {
				...
				v52[684] := v54 * v54;
				v52[684] := multiset{v53, v53};
			}
			
			var v55: multiset<int> := multiset{p3, v34[921]};
			var v56: set<int> := {|p0[if (p3 in v55) then v55[p3] else p2 := v35]|, |p0|, p2};
			if (({v34[921]} * {p2, v34[921]}) < v56) {
				v35 := v35;
				f34 := true;
				...
				globalState.f24 := -p2;
				var v59 := DC14(p3);
				var v60 := new C2(v58.f38, v59.cf20 / |[f34]|);
			} else {
				globalState.f15 := seq(0x224, i7  => (v35));
				globalState.f21 := f34;
				var v61: map<int, string> := map[v34[921] := p0];
				v61 := v61[v34[921] := p0];
				...
				var v66 := DC36(fm2(f34, globalState), if (f30) then !f34 else f34, !(v65 > {v64, DC35(v63)}), -f31 !in multiset{f31}, f31 == v34[921]);
				var v67 := DC3(f31, f30, f31);
				var v68: seq<D0> := [v67, fm43(globalState)];
				var v69: map<bool, seq<D0>> := map[f34 := v68[-f31 := v67]];
				var v70 := DC9(v69);
				...
				v71[459] := v70;
				v62[537] := f30;
				v66, v71[459], v55, v62[537] := v66, v70, v55 * multiset(([f31])[v34[921] := |fm11(true, f30, p0[|multiset([f30])| := 'b'], fm44(0x2d8, f34, v34[921], globalState), globalState)|]), f34;
			}
			
			var v72: seq<int> := [|p0|, p3];
			if (v72 == (v72 + [p2, p3])[f31 := p3]) {
				var v73 := new C0(v34, map[p0 := p2] + map[p0 := -p2]);
				var v74: map<int, int> := map[v34[921] := 747];
				var v75: seq<bool> := [f30];
				var v76 := DC38(v75);
				globalState.f1, v34[921], globalState.f21, r3 := if ((fm2(f34, globalState) % -f31) in v74) then v74[fm2(f34, globalState) % -f31] else --p3, -p2, v76.cf66 <= v75, !!f34;
				var v77 := DC13();
				...
				v72, globalState.f19, f34 := v72, |(seq(0x38e, i11  => (v35)))|, !f30;
				var v87: seq<array<int>> := [v34, v34, v34];
				var v88: map<bool, int> := map[v87 != v87 := v34[921]];
				var v89: map<int, char> := map[-v34[921] := v35];
				var v90 := DC3(|p0|, f34, fm2(!f34, globalState));
				var v91: map<int, set<bool>> := map[v90.cf9 := {true, f34}];
				globalState.f1 := -(if ((p3 == |v89|) in v88) then v88[p3 == |v89|] else |(if (v34[921] in v91) then v91[v34[921]] else p1)| * p2);
			...
			var v95 := DC17(f34, f34, false, p3, v34[921]);
			...
			var v106: map<bool, seq<D0>> := map[f30 := v105[v34[921]]];
			var v107 := DC9(v106);
			var v108: set<D3> := {DC9(v106), v107};
			globalState.f21 := v108 >= v108;
			globalState.f24 := v101.fm6(multiset{fm1(v34[921], p2, v35, globalState)}, globalState) * f31;
		}
		...
		var v111: seq<int> := [if (true) then v34[921] else v34[921]];
		r2 := v111[p3];
...
class C4 extends T0, T1 {
	...
	function fm15(p0: D0, p1: seq<bool>, p2: bool, p3: D1, globalState: GlobalState): map<bool, seq<D0>> {
		(map[f30 := [DC3(f31, f30, |"tgd"|)]] + DC9(map[f30 := [DC3(|[f31, f27]|, f30, |map[false := f30]|), DC3(0x2b6, f30, |multiset{f30, f30}|), DC3(|map[f30 := false]|, true, f31)]]).cf16) + (map[f30 := [DC3(f31, f30, 0x3c5), DC3(f31, false, |map[|map[f30 := f27]| := f30]|)]] + map[f30 := [DC3(0x3cd, f30, 329), DC3(|(seq(0x13d, i0  => ('c')))|, false, f27)]])
	}
	method m3(p0: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		...
		var v7: array<seq<int>> := new seq<int>[29] [v2, v2, v2 + [|v3|], v2 + (if (f30 in v4) then v4[f30] else [f27]), (v2[|v3| := f27])[f31 := f27], v2 + (seq(394, i0  => (f27))), v2 + [f27, |v5|], v2, v2, v2, v2, v2, [f31, f27], v2, v2, v2, v2, v2, v2, v2, v2, v2, [|"fkynb"|], [|v2|], v2, v2, v6[f31], v2, v2 + v6[f27]];
		v7 := v7;
		var v8 := DC3(f27, p0, fm7(false, globalState));
		match (fm16(if (p0) then v8.cf11 else f31, 0x274, globalState)) {
			case DC6(cf14) =>
				var v9: map<string, int> := map[v3 + v3 := f27 / f27];
				v9 := v9[v3 := f31];
				var v10 := DC6(cf14);
				match (v10) {
					case DC6(cf14) =>
					...
					case DC7() =>
						...
						var v17: map<multiset<bool>, bool> := map[v16 := v16 >= v16[f30 := f27]];
						var v18: array<int> := new int[13](i1 => i1 - f27);
						v18[706] := f27;
						var v19: map<int, int> := map[f27 := f27];
						globalState.f21, v17, v18[706] := p0, map[v16 := !!v8.cf10], if (-861 in v19) then v19[-861] else f31;
						var v20 := 'u';
			...
			case DC7() =>
				...
				v42[61] := (f31 - f27) + |v44|;
				if (!f30) {
					v42[61], globalState.f21, v0, globalState.f21 := v42[61], !false, v38.f38, fm1(f27, f27, v43, globalState);
					var v45: map<int, int> := map[v42[61] := f31];
					var v46: seq<map<int, int>> := [map[f31 := v42[61]], map[v42[61] := v42[61]], v45];
					var v47: set<map<int, int>> := {v46[f31], v45[0xbd := f31], v45};
					var v48 := new C3(v47, p0, f30, if (v42[61] in v45) then v45[v42[61]] else |v2|);
					var v49: set<C2> := {v38, v38};
					v38.f38[18] := v49 !! v49;
					v38.f38[18] := p0;
					globalState.f15 := v3;
					globalState.f11 := |([fm1(f27, |v3|, v3[f27], globalState), v48.f34] + (v5 + v5))|;
				} else {
					globalState.f1 := v42[61];
					globalState.f25 := -(|v2[f31 := v42[61]]| / f27);
					var v50: array<array<int>> := new array<int>[17];
					v50 := v50;
					v38.f38[684] := p0;
					var v51: map<int, int> := map[f27 := f31];
					var v52: multiset<bool> := multiset{p0};
					v42[61], globalState.f21, v38.f38[684], globalState.f21 := f31, -f31 != |(v51 + v51)|, !(f27 !in v2) || (f31 <= -|v3|), |v51| <= (f31 % |v52|);
					v38.f38[684] := f27 <= f27;
				}
			...
			case DC5(cf13) =>
				...
				if (p0) {
					...
					v56 := multiset{0x30a, if (f27 in v56) then v56[f27] else |v57[f27]|, f27, |v3|} * v56;
					var v58: array<T0> := new T0[6];
					v58 := v58;
				} else {
					cf13[38] := f27 + 0x3b8;
					var v59 := DC17(!p0, p0, !false, f31, |(seq(0xe0, i3  => (f27)))|);
					v3, cf13[38], globalState.f19 := v3, f31, -(v59.cf28 % f27);
					var v60 := 't';
					v60 := v60;
				...
				var v68 := 'v';
				globalState.f25 := if (fm1(|v3|, |v66[|v67|]|, v68, globalState)) then f27 else if (f30) then |v2| else f31;
				globalState.f1 := |((seq(0x137, i4  => (v68))) + v3)|;
		}
		
		for i5 := f27 to f27 {
			globalState.f15 := v3 + (v3 + v3);
			var v69: set<bool> := {p0};
			globalState.f11 := (f27 + i5) % |v69|;
			...
			var v77: map<bool, int> := map[f31 <= |v71| := |v76| % f27];
			v77 := v77[p0 := |v3|];
		...
		match (v79) {
			case DC31(cf50, cf51, cf52) =>
				...
				var v85 := DC1(f31, v2, v2[684], v3, v1[cf52]);
				v2 := (v85.(cf1 := |v3|)).cf2;
			...
			case DC30(cf49) =>
				...
				match (v96) {
					case DC24() =>
						v0[552] := p0;
						v0[552] := f30;
						var v97: map<bool, bool> := map[v0[552] := f30];
						globalState.f24, globalState.f24, v97, r1 := 0x3a4, f31, map[f30 := false], -f31 == (f31 / f31);
						globalState.f21 := f30;
						var v98: array<array<bool>> := new array<bool>[19];
						var v99: array<bool> := new bool[15];
						v98[29] := v99;
						var v100: set<int> := {f31, |map[v0[552] := f27]|, |v97|};
						var v102: seq<set<int>> := [v100, v100, set v101 : int | v101 in map[f31 := f31] :: (v101 + 864), v100];
						var v103: map<int, array<bool>> := map[|v102[f31]| / -f31 := v99];
						v98[29] := if (f27 in v103) then v103[f27] else v99;
					case DC23(cf40) =>
						var v104 := DC7();
						...
						v110 := map[|v112| := v108];
						var v113 := new C1(v104, p0, v2[-|{f30}|]);
				}
				...
				if (p0) {
					...
					v117[744] := |(seq(0xcf, i6  => (v114)))|;
					var v118: map<int, int> := map[f27 := f31];
					var v119: set<int> := {f27};
					v117[744] := if ((|multiset{v119}| - |v3[|v118| := v114]|) in v118) then v118[|multiset{v119}| - |v3[|v118| := v114]|] else f27;
					globalState.f25 := v117[744] - (f31 + f27);
					...
					v0[757] := f30;
					globalState.f21, v120, globalState.f21, v122, v0[757] := f30 ==> f30, v120[v117[744] * f27 := v115], f30 && f30, v122, p0;
				} else {
					globalState.f11 := f31;
		...
		for i7 := f27 to 0x28c {
			...
			v126[822] := if (v127 in v129) then v129[v127] else v128;
			globalState.f21, globalState.f21, v125[859], v126[822] := !!(f31 >= (f31 % f31)), v8.cf10, if (false) then -(f27 + -f31) else i7 / i7, v128;
			var v130: set<string> := {"xpxid", v3 + v3};
			var v131: seq<string> := [v3];
			v130, globalState.f1 := set v132 : string | v132 in v131 :: (v132), f27 - (v125[859] - i7);
			var v133 := DC38(v5);
			var v134 := 'w';
			var v135 := DC2(f27, v3, |fm24(f27, |map[v133 := v134]|, v125[859], seq(0x15d, i8  => ('w')), globalState)|);
			var v136 := DC1(f31 - i7, v2, f31 / f31, v135.cf7 + v3, v0);
	...
	method m4(globalState: GlobalState) returns (r0: array<string>, r1: int, r2: int, r3: D0) {
		...
		var v8: seq<char> := [v5[|v7|]];
		var v9: set<char> := {v8[|v5|]};
		var v10: array<int> := new int[28];
		v10[36] := 0x2e;
		var v11 := DC45(v9);
		var v12: seq<int> := [f31];
		globalState.f11, v9, globalState.f19, r2, v10[36] := fm2(v3.f34, globalState), v11.cf78, f31 - f31, f31, fm7(fm1(v12[|v12|], f27, v4, globalState), globalState) + f27;
		var v14: map<string, bool> := map[v8 := f30];
		var v15 := new C0(v10, map v13 : string | v13 in v14 :: (v13) := (if (f27 in v2) then v2[f27] else f31));
		globalState.f19 := |"m"| % f31;
		forall i0 | 0 <= i0 < v10.Length {
			v10[i0] := i0 % (v10[36] + v10[36]);
		}
		for i1 := fm2(!f30, globalState) to f31 {
			...
			v18 := new C2(v17, |v5[if (v5 in v15.f37) then v15.f37[v5] else i1 := v4]|);
			globalState.f21 := v3.f34;
			globalState.f11 := 0x3b;
		}
		var v19: map<bool, char> := map[v3.f34 := v4];
		var v20: seq<string> := [v5[v10[36] := if (f30 in v19) then v19[f30] else v4], v5, v5];
		...
		var v24: array<string> := new seq<char>[24] [v5, v8, v5, v5, v8, v5 + v8, seq(485, i2  => (v4)), v8, v5, v5[v10[36] := v4], v8, v8[f31 := v4], v8 + v5, v5, v20[f27], seq(841, i3  => (v4)), v5, v8, (if (v15.f36 in v21) then v21[v15.f36] else v8) + v5, v3.fm11(f30, v3.f34, v5, v23, globalState), v8, v8 + "ieyysmop", "sl", v8];
		r0 := v24;
		r1 := f27;
		r2 := f27;
		var v25: map<char, string> := map[v4 := v5];
		var v26 := DC16(v4, v10[36]);
		var v27: array<bool> := new bool[17](i5 => f30);
		var v28 := DC1(|(seq(-0x1d0, i4  => ('b')))|, v12, |(if (v26.cf22 in v25) then v25[v26.cf22] else v8)[f31 := v4]|, v5[f31 := v4], v27);
		...
		var v33: seq<multiset<bool>> := [v30[f30 := |v32|]];
		var v34 := DC2(|v33|, v8, f31);
		r3 := v28.(cf4 := v8, cf2 := (([fm2(f30, globalState)])[-f31 := v10[36]])[if (multiset{seq(236, i6  => (v4))} in v29) then v29[multiset{seq(236, i6  => (v4))}] else |v6| := v34.cf8], cf5 := v27);
	}
	method m5(p0: map<map<bool, char>, string>, p1: int, p2: set<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		var v0 := "irusk";
		...
		if (0x312 > f31) {
			...
			var v13: T0 := new C2(v11, f31 % |v12|);
			v13 := v13;
			var v14: map<bool, int> := map[v10.f34 := f27];
			var v15: array<int> := new int[16] [|v12|, -0x4a, v5[v13.f27], v13.f27, f31, v13.f27, f31, p1, v13.f27, f27, v13.f27, 0x16, f31, f31 - |v7|, v5[if (f30 in v14) then v14[f30] else v13.f27], |map[f31 := !f30]|];
			v15[175] := f31 / v13.f27;
			v15[175] := v13.f27;
			var v16: map<seq<int>, D9> := map[seq(-0x3bb, i0  => (f27)) := DC27(!f30, f30, true)];
			var v17 := DC27(v10.f34, v10.f34, v10.f34);
			v16 := v16[v5 + (seq(0x144, i1  => (f31))) := v17];
		} else {
			...
			globalState.f21 := !v22[f27];
			if ((f27 % f27) < f31) {
				globalState.f1, globalState.f15 := p1, seq(290, i2  => (v19));
				...
				var v33: seq<int> := [f27];
				v32[575] := v33;
				v32[575] := v33[f27 := p1] + v33;
				var v34: map<int, int> := map[f31 := |v0|];
				var v35: multiset<array<bool>> := multiset{v20};
				globalState.f21 := v22[if (|v1[f30 := !f30]| in v34) then v34[|v1[f30 := !f30]|] else |v35|];
				...
				globalState.f24, v36[596], v37, v39, globalState.f25 := DC46(f31, f30, f31).cf79, (v40 + v40) + v40, v37, v39, (if (true) then 786 else p1) + fm2(f30, globalState);
				v20[197] := f30;
		...
		globalState.f1, v55[576], r1, r1 := p1 % |v62|, v56 + v56, v63 !! v63, (v0 == (seq(-0xbd, i5  => ('m')))) && f30;
		var v64: multiset<bool> := multiset{f30, f30, f30, f30, if (f30 in v1) then v1[f30] else f30};
		v59[108] := if (!f30) then f30 else fm1(fm6(v64, globalState), f31, 's', globalState);
		...
		if (f30 && (-f31 >= f27)) {
			...
			v69 := seq(0xf8, i6  => (v68[p1 := p1] * v68));
			globalState.f21 := (|v1| * f31) == v57[f31];
			...
			v71[241] := v65;
			v71[241] := if (f30) then v65 else v65;
			if (v59[108] in v1) {
				var v72: seq<bool> := [f30];
				var v73 := DC1(f31, v57, p1, v0, v70.f38);
				var v74: map<int, D0> := map[-p1 * |v72| := v73];
				v74 := v74[fm2(!v70.fm27(v59[108], |v72|, f30, globalState), globalState) := v73];
				var v75, v76, v77, v78 := v70.m4(globalState);
				var v79 := 'g';
				var v80: map<int, string> := map[|v72| := v0];
				var v81: map<int, char> := map[v77 := fm19(v59[108], f30, f30, v80, globalState)];
				...
				var v84 := DC25(v83);
				v84, globalState.f21, globalState.f21, globalState.f19 := v84.(cf41 := v83), f30, (p1 != p1) <== (if (v59[108]) then true else f30), if (v59[108]) then v58[v77] else f27 + p1;
				v65 := v71[241];
				v77 := 563 % 0x319;
			} else {
				v71[241] := v71[241];
				v59[108] := f30;
				var v85: seq<seq<int>> := [v57, v57, v57, v57, (v57[|[v59[108], !v59[108]]| := f31])[-0x1c0 := f31]];
				v59[108] := v64[v59[108] := |multiset(v85)|] >= (v64 * v64);
				globalState.f21 := !v59[108];
				v59[108] := f30;
			}
			
			globalState.f19 := if (v59[108]) then f31 * f31 else f31;
		}
		
		r0 := f27;
		var v86: seq<set<bool>> := [{f30, false}];
		r1 := v86[fm6(v64, globalState)] !! (v63 - v63);
	}
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		for i0 := |{f30}| to |v0| {
			...
			var v4: array<char> := new char[13] [v1, v1, v1, v1, v2[|v3|], v1, v1, v1, v1, v1, v1, v1, v1];
			...
			var v10: seq<seq<array<bool>>> := [v9, v9[|v2| := v8], v9, v9, [v8]];
			var v11, v12 := m8(v7, 'b', fm1(|v10[f27]|, f27, v1, globalState), !f30, globalState);
		...
		for i1 := f31 - f27 to |v17| {
			var v18 := "vfogvxse";
			globalState.f15 := (v18 + v18)[0x191 := v18[i1]] + v18;
			var v19 := DC36(f31, v18 != (seq(0x1d, i2  => ('h'))), f30, f30, f30);
			var v20: map<C2, int> := map[v16 := -f31];
			v19 := v19.(cf61 := |(map[v16 := f31] + v20)|, cf64 := false);
			var v21: map<int, int> := map[|v18| / i1 := |v18|];
		...
		for i3 := f31 to 792 - |v23| {
			...
			match (v26) {
				case DC36(cf61, cf62, cf63, cf64, cf65) =>
					...
					globalState.f21, cf63, v28[51] := cf64, f30, v16.fm6(multiset([cf62]) - (if (!!cf62 in v30) then v30[!!cf62] else v29), globalState);
				...
				case DC37() =>
					...
					var v37 := DC47(v36);
					var v38: array<multiset<D5>> := new multiset<D5>[10] [if (v23[f31]) then multiset{v34, v34} else v35, v35, v35, multiset([v34]), v35 * v35, multiset(v37.cf82), v35, v35 + v35, v35, multiset([v34, v34, DC15(v24).(cf21 := fm19(f30, f30, f30, map[f31 := seq(0x143, i4  => ('o'))], globalState))])];
					v38[1] := multiset{v34.(cf21 := v24)};
					...
					v38[1], v39, v40[216], v15[285] := if (f30) then v35 else v35, v43.cf84, ---(i3 % |[f30]|), f30;
					var v44: map<bool, bool> := map[if (true) then v15[285] else f30 := v15[285]];
					v15[285] := if (v15[285] in v44) then v44[v15[285]] else f30 ==> false;
					var v45: array<seq<bool>> := new seq<bool>[8];
					v45[995] := v23 + v23;
					var v46: set<int> := {f31, v40[216]};
					var v47 := DC50(v46);
					globalState.f24, v45[995], globalState.f19, v40[216] := 0x184, v23 + v23, |v47.cf87|, i3 + 0x1b;
				case DC35(cf60) =>
					v24 := v24;
					var v48: seq<multiset<int>> := [multiset{fm2(f30, globalState)}];
					var v49: map<array<bool>, multiset<int>> := map[v16.f38 := v0];
					v0 := v48[i3] * (if (v16.f38 in v49) then v49[v16.f38] else v0);
					var v50: multiset<bool> := multiset{f30, f30, f30, f30};
					v16.f38[162] := v50 > multiset(v23);
					v16.f38[162] := v23[f27];
		...
		v15[306] := f30;
		var v54 := 'v';
		v15[306] := fm1(f31 - f27, f31, v54, globalState);
		r0 := !f30;
		r1 := (fm49(v15[306], f30, globalState)).cf46;
	}
	method m7(globalState: GlobalState) {
		...
		for i1 := |(if (f30) then v1 else v1)| to v1[f31] {
			var v2 := 'w';
			if (!fm1(0x3da, f27, v2, globalState)) {
				var v3: multiset<int> := multiset{-f27};
				var v4: map<int, char> := map[f27 := v2];
				globalState.f24 := (i1 / (if (|v4| in v3) then v3[|v4|] else |"rxfvmklc"|)) / f31;
				...
				var v11: map<int, int> := map[i1 := |v9[|v10|]|];
				var v12 := "xg";
				...
				v18 := v18[i1 := seq(-0x20a, i2  => (v16[f27 := f30]))];
				var v19: set<bool> := {f30, false, f30};
				v19 := v19;
			}
			
			var v20 := DC3(-|v1[i1 := f27]|, f30, i1);
			var v21: seq<bool> := [f30, fm1(f27, f27, 'd', globalState), f30];
			var v22, v23 := m8(v20, v2, v20.cf10, !v21[0x396], globalState);
			...
			decreases 100 - i4
		{
			...
			globalState.f25, v33[338], v32 := (if (true) then |v37| else f27) / f27, -f27, v32 + v32;
			v33[338] := |(v29 + ("saahmi" + v29))|;
		...
		var v45: multiset<int> := multiset{|(seq(0x141, i6  => (f27)))|};
		...
		globalState.f21, v41, globalState.f21, globalState.f11, globalState.f21 := -0x93 <= |v42|, fm50(v43, v44 > v44, v46, globalState), !f30, f27, f30 <==> (f27 <= fm6(v46[f30 := f31], globalState));
	}
	method m8(p0: D0, p1: char, p2: bool, p3: bool, globalState: GlobalState) returns (r0: array<bool>, r1: int) {
			...
			decreases 100 - i0
		{
			...
			v6 := v7.cf93;
			var v8: seq<bool> := [true];
			globalState.f21 := if (f30) then p2 else v8[0x1c6];
		}
		var i1 := 0;
		while (!p2)
			decreases 100 - i1
		{
			...
			var v13: map<int, int> := map[v9[279] := |v12|];
			var v14: set<map<int, int>> := {v13};
			var v15 := DC57(v14);
			var v16 := new C3(v15.cf95, !(v9[279] == 0x21b), f30, f27);
			var v17: array<seq<bool>> := new seq<bool>[18](i2 => [v16.f34, p2] + [v16.f34, v11[232], true, f30]);
			v17 := v17;
		}
		var v18: map<bool, int> := map[p2 := 0x1b9];
		var i3 := 0;
		while (fm1(f31, (if (f30 in v18) then v18[f30] else f31) % 649, p1, globalState))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			match (v19) {
				case DC41() =>
					...
					var v22: map<int, int> := map[|(seq(-0x193, i4  => (p1)))| := f27];
				...
				case DC42(cf72, cf73, cf74) =>
					var v28: array<int> := new int[11](i5 => i5 % cf72.f27);
					v28[984] := f27 + 0x1b1;
					v28[984] := cf73;
					var v29: map<bool, bool> := map[!p2 := p3];
					v29 := v29 + v29[f30 := !p2];
					var v30: array<bool> := new bool[2] [p3, p2];
					var v31: map<int, bool> := map[v28[984] := p3];
					var v33: seq<int> := [0x310, |map[p3 := v28[984]]|];
					var v34: map<seq<int>, bool> := map[v33 := f30];
					var v35: seq<map<seq<int>, bool>> := [map v32 : seq<int> | v32 in [v33, v33] :: (v32) := (true), v34];
					v30[867] := if (if (p2 in v29) then v29[p2] else p3) then !(if (-|v35[0x23a]| in v31) then v31[-|v35[0x23a]|] else p2) else true;
					var v36: map<char, int> := map[p1 := if (f30) then f27 else f27];
					var v37: map<int, int> := map[cf73 := v28[984]];
					var v38 := "mp";
					var v39: seq<map<char, int>> := [v36, map[p1 := cf73]];
					v28[984], v28[984], v30[867], cf73, v36 := -cf73, (-v28[984] % f31) - (cf73 - (if (v28[984] in v37) then v37[v28[984]] else v28[984])), p3, |(if (f30) then v38[f27 := p1] else v38)|, v39[cf73 + cf73];
					v37 := v37[|v38| := |v33[f27 := v28[984]]|];
				case DC43(cf75, cf76) =>
					...
					v47, r1, globalState.f25, r0 := v47 + (v47 + [v46]), |multiset{!v43, v43, v48[|v48|]}|, v41, v49;
				case DC40(cf71) =>
					var v50: seq<int> := [f31, f31];
					var v51: map<map<set<int>, multiset<int>>, bool> := map[fm51(v50, globalState) := p3];
					var v52: set<int> := {|(seq(-0x34a, i7  => (f31)))|, f31};
					var v53 := "letgtwrg";
					...
					v57[707] := fm29(false, globalState);
					v57[707] := 'm';
					r0 := new bool[1];
				case DC44(cf77) =>
					globalState.f25 := f31;
		...
		var v62 := DC11();
		v62 := v62;
		globalState.f1 := f27 / fm7(p2, globalState);
		...
		var v70: seq<bool> := [p2 ==> p3, if (v63[f27]) then p3 else fm1(f31, f27, p1, globalState), fm1(|[f30, p2, p2]|, |v68|, v69[--f31], globalState), f30, false];
		globalState.f21 := v70[|multiset{p3}|];
...
class C5 extends T1 {
		...
		for i0 := 160 to p1 - fm14(f30, 't', globalState) {
			...
			match (DC0(v4)) {
				case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					var v13: map<map<bool, int>, int> := map[map[f30 := |v12[p1]|] := |cf4|];
				...
				case DC3(cf9, cf10, cf11) =>
					...
					var v22 := DC5(f32);
					var v23 := new C3((set v18 : map<int, int> | v18 in v17 :: (v18)) - v20, if (f30) then cf10 else f30, if (false) then false else f30, if (v22.cf13 in v21) then v21[v22.cf13] else |(seq(0x367, i1  => (v3)))|);
					r1 := v23.f34;
				case DC0(cf0) =>
					...
					v28 := ((map v29 : int | (788 <= v29) && (v29 < 655) :: (v29 % 375) := (-i0)) + v28)[p1 := p1];
					v3 := v3;
				...
				case DC4(cf12) =>
					globalState.f24 := p1;
					var v31 := "gallhcsh";
					globalState.f24 := |((seq(0x114, i2  => (v3))) + v31)[fm14(true, v3, globalState) := v3]| % p1;
			...
			if (v36[i0] >= v0) {
				...
				globalState.f19, globalState.f21, globalState.f21 := DC36(p1, f30, f30, f30, f30).cf61, f30, i0 >= (fm14(f30, v3, globalState) % -i0);
				var v42: array<int> := new int[15];
				v42 := f32;
				var v43 := "hkfqvtdtu";
				var v44: map<string, int> := map[v43 := p1];
				var v45: C0 := new C0(v42, v44);
				globalState.f24 := -(--(|"apshvrh"| - p1) / |[v45]|);
				var v46: set<array<bool>> := {v4, v4, v4};
				globalState.f25 := i0 % |v46|;
				r1 := f30;
			}
			
			if (f30) {
				var v47 := "fugdxyhi";
				globalState.f25 := |v47[p1 := v3]|;
				globalState.f21 := f30;
	...
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool) {
		if ((f31 + f31) <= f31) {
			...
			match (v5.(cf78 := v4 * v4)) {
				case DC46(cf79, cf80, cf81) =>
					...
					var v15: array<seq<bool>> := new seq<bool>[22] [v8, [cf80] + [f30, v2.f34], v8, v8, if (fm1(0x394, |"jjvpb"|, v11.cf75, globalState)) then v8 else v8, v8, v8, v8[v14.cf8 := v2.f34], v8 + [v8[0x8d], v2.f34], v8, v8 + [f30, v2.f34, cf80, f30], v8, v8 + v8, v8 + v8, v8, v8, [cf80, f30, fm1(f32[341], |v8|, v3, globalState)], v2.fm12(globalState), v8, v8, fm12(globalState), v8 + v8];
					v15[98] := if (v2.f34) then v8 else v8;
					var v16: seq<int> := [cf81];
					r1, cf80, v15[98] := (cf81 % f32[341]) <= v16[cf81], if (v2.f34 && f30) then v2.f34 else v2.f34, [cf80, v16 <= v16, cf80];
					var v17 := new C4(f31, cf80, f32[341]);
				case DC45(cf78) =>
					...
					var v22 := new C0(f32, if (v3 in v20) then v20[v3] else map[seq(-0x42, i0  => (v3)) := |v21|]);
					v2.f34 := f30;
					...
					v24[417] := v23;
					v24[417], globalState.f25, globalState.f25 := v23, f31, f31 - (f31 / f31);
			}
			
			var v25 := DC10(!f30, true);
			var v26: set<D3> := {v25, v25};
			var v28: seq<bool> := [v2.f34, f30, f30];
			var v29: map<bool, set<D3>> := map[v28[f31] := v26];
			...
			if (v32 == v32) {
				...
				v37 := v37[if (v28[f31]) then v33 else v33 := v36];
				var v38 := "doqrf";
				globalState.f15 := v38[-f31 := v3] + ((seq(0x16e, i2  => (v3))) + v38);
				...
				v42 := v42;
				var v43 := "w";
				globalState.f11, globalState.f21, globalState.f25, v41 := f31 % |(v43 + v43)|, f30, if (v2.f34) then v42.f27 else f31 / -402, if (f31 < f31) then v41 else v41;
			...
			if (f30) {
				...
				var v51 := 'i';
				var v52: seq<int> := [|(seq(0x1ed, i3  => (v51)))|];
				var v53: map<bool, bool> := map[f30 := f30];
				var v54: multiset<int> := multiset{|v53|, f31};
				var v55: set<bool> := {f30, f30};
				var v56: array<bool> := new bool[25] [f30, {f31, if (f31 in v48) then v48[f31] else |v49|, f31, f31} > v50, v49[-f31], f30, f30, f30, true, f30, false <==> f30, f30, f30, f30 && f30, false, fm1(f31, if (f31 in v48) then v48[f31] else f31, v51, globalState), f30, f30, false, v52 < [f31], f30, f30, multiset{f31, f31} >= v54, f30, f30, f31 != |v55|, f30];
				var v57: map<bool, int> := map[f30 := f31];
				v56[605] := f30 !in v57;
				var v58: multiset<map<bool, int>> := multiset{if (f30) then v57 else v57};
				var v59 := "bdvhs";
				globalState.f24, v56[605], v58, v55, globalState.f15 := f31, f30, v58, v55 + v55, v59;
				v53 := v53[f30 := v56[605]];
				var v60 := DC0(v56);
				var v61: seq<array<bool>> := [v56, v56];
				var v62: multiset<bool> := multiset{f30};
				var v63: array<multiset<bool>> := new multiset<bool>[29] [v62, v62, v62, multiset{f30}, v62, v62, v62, v62, multiset(v49), v62, v62, (multiset(v49))[!v56[605] := |v49|], v62, v62, v62, v62, v62, v62, v62, v62, fm3(f30, globalState), v62, v62, v62, v62, v62, v62, v62, v62];
				var v64: map<bool, array<multiset<bool>>> := map[true := v63];
				var v65: map<array<multiset<bool>>, array<bool>> := map[if (v56[605] in v64) then v64[v56[605]] else v63 := v56];
				var v66: array<char> := new char[27];
				var v67 := DC48(fm1(f31, 828, 'l', globalState), v66, v56);
				var v68: array<array<bool>> := new array<bool>[19] [v56, v56, v56, v56, v56, v60.cf0, v56, v56, v61[f31], v56, v56, if (v63 in v65) then v65[v63] else v56, v56, v56, v56, v56, v56, v56, v67.cf85];
				var v69: map<int, array<bool>> := map[f31 := v56];
				v68 := new array<bool>[25] [v56, v56, v56, v56, v56, v56, v56, v56, v56, v56, v56, if (v56[605]) then v56 else v56, v56, v56, v56, v56, v56, v56, v56, v56, v56, v56, if (|v59| in v69) then v69[|v59|] else v56, v56, v56];
				globalState.f11 := v52[|map[v56[605] := |[v61[f31], v56]|]|];
				v56[605] := f30;
			} else {
				var v70 := 'a';
				var v71 := "brs";
				...
				var v72: seq<bool> := [f30];
				var v73: set<int> := {f31};
				globalState.f24 := if (f30) then |v72| % |v73| else f31;
				r1 := f30;
				var v74: map<bool, bool> := map[f30 := f30];
				var v75: seq<map<bool, bool>> := [v74, v74];
				var v76 := new C0(f32, fm32(v75[f31], v72[|v71|], f30, globalState));
			}
			
			var v77 := 'j';
			var v78: seq<bool> := [f30, !f30 ==> f30, fm1(f31, f31, v77, globalState), f30 || f30];
			var v79: map<int, int> := map[f31 := f31];
			globalState.f21 := v78[if (f31 in v79) then v79[f31] else f31];
			var v80: array<bool> := new bool[7];
			v80[46] := f30;
			r1, v80[46] := !f30 <== f30, f30;
			globalState.f21 := v80[46] <== f30;
		}
		
		var v81 := "jorxifm";
		var v82 := 's';
		var v83: multiset<string> := multiset{v81 + (v81[f31 := v82])[f31 := v82], v81 + "lccbqwqu", if (!false) then v81 else v81};
		globalState.f11 := if ((seq(0x1f2, i4  => (v82))) in v83) then v83[seq(0x1f2, i4  => (v82))] else -|v81|;
		...
		match (DC25(v85)) {
			case DC26(cf42, cf43) =>
				if (|(v81 + cf43)| == (f31 - |v81|)) {
					...
					var v87: map<bool, bool> := map[v86[f31] := f30];
					...
					globalState.f21, v89 := (if (f30) then v81 else cf43) < (if (-f31 in v90) then v90[-f31] else seq(877, i6  => (v82))), v89;
					...
					var v93: set<string> := {v91[f31], fm34(f31, |v92|, f30, f31, globalState)};
					...
					var v98: map<int, seq<map<int, bool>>> := map[if (f30) then f31 else -0x2d9 := v97[f31 := v96]];
					...
					var v105: map<int, int> := map[|(if (|v104| in v103) then v103[|v104|] else seq(-0x85, i8  => (f31)))| := f31];
					v102 := ((seq(0x1c2, i7  => (f31))) + ((if (|cf43| in v103) then v103[|cf43|] else v102) + v102))[-f31 := |v105|];
				...
				globalState.f11, v109, globalState.f19, r0 := f31, v109, v110[f31], f30;
				var v111: map<char, int> := map['n' := f31];
				var v112: multiset<int> := multiset{f31, f31};
				var v113: map<string, multiset<int>> := map[seq(-0x28, i9  => (v82)) := v112];
				v111 := v111[v82 := |v113|];
				var v114 := DC7();
			...
			case DC27(cf44, cf45, cf46) =>
				...
				var v131: array<bool> := new bool[28] [!cf44, cf45, f31 >= |([!f30])[f31 := cf46]|, cf44, cf44, cf45, cf46, f30, !f30, f30, true, cf45, cf44, multiset{cf45} > v122, !f30, if (v124 in v125) then v125[v124] else cf44, fm3(cf45, globalState) >= v122, cf44, cf46, v129 >= v129, if (f31 in v130) then v130[f31] else cf45, f30, cf44, cf45, f30, cf44, f30, cf44];
				var v132: map<int, int> := map[f31 := |{|v81|}|];
				var v133: set<map<int, int>> := {v132, v132};
				var v134: C3 := new C3(v133, true, cf46, f31);
				v123[51] := {v134, v134} < {v134, v134};
				v123[51] := (f31 + f31) < (if (false) then |v126| else f31);
				var v135: array<D16> := new D16[21];
				var v136: T0 := new C4(f31, cf46, -628);
				var v137 := DC42(v136, f31, v122);
				v135[956] := v137;
				v135[956] := v137.(cf72 := v136);
				var v138: seq<bool> := [v123[51]];
				v123[51] := v138[v136.f27 + f31];
			case DC25(cf41) =>
				globalState.f21 := f30;
				globalState.f21 := f30;
				f32[635] := -0x394;
				var v139: seq<int> := [f31];
				f32[635], globalState.f1, globalState.f21, globalState.f21 := v139[f31], 0x9d, f30 <==> (if (f30) then f30 else f30), f30;
				var v140: array<bool> := new bool[13](i11 => f30);
				var v141: seq<array<bool>> := [v140];
				var v142: array<array<bool>> := new array<bool>[7] [v141[f31], v140, v140, v140, v140, v140, v140];
				v142[558] := v140;
				v142[558] := v140;
		}
		...
		match (v147) {
			case DC41() =>
				if (f31 < -v144.f27) {
					...
					v150 := v150[fm13(-0x321, globalState) := v82 in v81[v144.f27 := v82]];
					...
					globalState.f21 := f30;
					v81 := v81;
					var v156: set<map<int, int>> := {v145, (map v153 : int | (198 <= v153) && (v153 < 0x44) :: (v153 * |(set v154 : int | v154 in multiset([v144.f27, v144.f27]) :: (v154 % 0xed))|) := (v144.f27))[v144.f27 := v144.f27], map v155 : int | v155 in v149 :: (v155 / |v148|) := (357)};
					...
					var v161: map<C4, int> := map[v160 := |(seq(0x2f8, i13  => (v82)))[v144.f27 := v82]|];
					var v162: map<bool, bool> := map[f30 := f30];
					v158 := v159[(if (v160 in v161) then v161[v160] else |v162[f30 := f30]|) * f31];
				...
				if (true <== f30) {
					var v166: C0 := new C0(f32, map[v81[v144.f27 := v82] := v144.f27]);
					var v167: map<C0, int> := map[v166 := f31 % 0x2b8];
					v167 := v167;
					var v168 := DC37();
					...
					var v174: map<bool, D9> := map[(set v170 : D14 | v170 in v169[f31 := v168] :: (v170)) !! v171 := v173];
					...
					var v180 := new C3({v145}, f30, f30, -(v144.f27 % f31));
				} else {
					var v181: T1 := new C1(fm21(seq(0xd3, i14  => (v82)), v144.f27, f30, v144.f27, globalState), f30, v144.f27);
					v181 := v181;
					v82 := v82;
				...
				var v189: map<string, int> := map[seq(0x212, i16  => (v82)) := v144.f27];
				...
				var v197: set<set<int>> := {set v194 : int | v194 in v193 :: (v194 / |(set v195 : int | v195 in [0x3a5] :: (v195 + -0x2e2))|), v196, v196, v196};
				var v198 := DC1(-|[f30]|, v193, f31, "gvxu", v143);
				var v199: array<string> := new string[22] [v81, v81, v81, "u", v81, v81, v81, v81, v81 + v81, seq(0x169, i15  => (v82)), (v81 + "kx")[v144.f27 := v82], v81, v81 + fm34(v144.f27, -f31, f30, |v187|, globalState), v81, "qcmorqiwn", fm11(true, f30, "ngmqef", map v188 : set<int> | v188 in v197 :: (v188) := (f30), globalState), v81 + v81, v81, (seq(0x20d, i17  => (v82))) + v81, "sxwfwoqa", v198.cf4, v81];
				v199[278] := v81 + v81;
				var v200: map<bool, string> := map[f30 := v81];
				v199[278] := if (f30 in v200) then v200[f30] else fm11(f30, f30, v81, map[{v144.f27} := f30], globalState) + v81;
				var v201 := DC11();
				v201 := if (false) then DC11() else v201;
			case DC42(cf72, cf73, cf74) =>
				var v202 := DC1(v144.f27, seq(0x5b, i18  => (v144.f27)), v144.f27, v81, v143);
				var v203 := DC4(v202);
				match (v203) {
					case DC1(cf1, cf2, cf3, cf4, cf5) =>
					...
					case DC3(cf9, cf10, cf11) =>
						...
						var v213 := DC7();
						var v214 := new C1(v213, f30, |(([cf10])[v144.f27 := f30] + v212)|);
						var v216: multiset<int> := multiset{cf73};
						var v217: set<map<int, int>> := {map v215 : int | (0x2e0 <= v215) && (v215 < 300) :: (v215 / cf73) := (cf72.f27), v145, map[cf72.f27 := f31], (map[0x1e := cf72.f27])[-|v216| := v144.f27]};
					...
					case DC4(cf12) =>
						...
						var v233: map<int, bool> := map[|v232| := v143[721] <==> f30];
						globalState.f21, globalState.f21, globalState.f21, globalState.f1, v231 := !true, v143[721], if ((|fm34(cf72.f27, v144.f27, fm1(|v232|, cf72.f27, v82, globalState), cf73, globalState)| - -0x1e4) in v233) then v233[|fm34(cf72.f27, v144.f27, fm1(|v232|, cf72.f27, v82, globalState), cf73, globalState)| - -0x1e4] else v143[721], cf72.f27, f32;
				}
				
				var v234: multiset<int> := multiset{v144.f27, |multiset{cf73, cf73}|};
				globalState.f24 := (0x208 % |v234|) + cf73;
				var v235: map<array<int>, bool> := map[f32 := f30];
				var v236 := DC28(v235);
				var v237: map<D10, bool> := map[v236 := f30];
				v237 := v237[v236 := f30];
				var v238: array<string> := new string[15];
				var v239 := DC2(cf72.fm6((multiset{f30})[f30 := v144.f27], globalState), v81, cf73);
				v238[601] := v239.cf7;
				v238[601] := v81;
			case DC43(cf75, cf76) =>
				f32[915] := f31;
				...
				if (v81 <= (v240[|v241|] + v81)) {
					globalState.f15 := v81 + ("jxvbgl" + v81[f32[915] := cf75]);
					globalState.f1 := v144.fm7(f30, globalState) + f32[915];
					var v242: map<bool, int> := map[!f30 := -f32[915]];
					var v243 := DC14(|v241|);
					...
					var v255 := new C3(v252 * {map v253 : int | (0x208 <= v253) && (v253 < 0x35c) :: (v253 % v144.f27) := (v144.f27), map[|v254| := v144.f27]}, f30, f30, v144.f27);
					f32[915] := -v144.f27 / 310;
				}
			...
			case DC40(cf71) =>
				...
				if ((!f30 in v256) ==> (v257 >= v257)) {
					...
					globalState.f1 := f31;
					r1 := !(v146[f30 := v144.f27] !! (v146 - v146));
					...
					globalState.f25 := -(|v81| + v261[f31]);
					f32[103] := v144.f27;
					var v262: C2 := new C2(v143, v144.f27);
					var v263: map<multiset<C2>, int> := map[multiset{v262, v262} := v144.f27];
					f32[103] := if (multiset([v262, v262] + [v262]) in v263) then v263[multiset([v262, v262] + [v262])] else v144.f27;
				...
				var v270: array<C3> := new C3[13] [v269[|v81|], v268, v268, v268, v268, v268, v268, v268, v268, if (true) then v268 else v268, v268, v268, v268];
				v270[138] := v268;
				var v272: seq<array<int>> := [f32, f32];
				var v273: set<int> := {v144.f27};
				var v274: multiset<set<int>> := multiset{{v144.f27, |v272|, f31}, v273};
				v270[138], globalState.f15 := v268, (fm11(!v268.f34, fm1(v144.f27, v144.f27, v82, globalState), v81, map v271 : set<int> | v271 in v274 :: (v271) := (true), globalState) + v81)[f31 := v82];
				if (f30) {
					...
					var v279: map<char, char> := map[v82 := v81[v144.f27]];
					v275, v82, globalState.f1, v257 := multiset(v276) * v275, v82, |v278| / -|v279|, v257;
					var v280: map<int, bool> := map[v144.f27 := f30];
					v280 := v280[v144.f27 := f30 <== f30];
					globalState.f11 := v144.f27 % f31;
					var v281: seq<string> := [v81];
					var v282: map<seq<string>, array<int>> := map[[v81[f31 := 'k']] + v281 := f32];
					v282 := v282[v281 := f32];
					v82 := v82;
				} else {
					globalState.f11 := fm2(f30, globalState);
					var v283: map<seq<bool>, bool> := map[v256 := v256[-v144.f27]];
					var v285: seq<seq<bool>> := [[v268.f34], fm12(globalState)];
					v283 := (v283 + v283) + (map v284 : seq<bool> | v284 in v285 :: (v284) := (true));
					f32[5] := v144.f27 % v144.f27;
					f32[5] := fm14(f31 != -|v81|, v82, globalState);
			...
			case DC44(cf77) =>
				...
				if (f30) {
					...
					v300[914] := new bool[25] [fm1(v144.f27, v144.f27, v82, globalState), f30, f30, f30, f30, f30, true, v144.f27 >= |map[v143 := !f30]|, v302 in v303, !f30, f30, f30, !!f30, !f30, f30, if (f31 in v304) then v304[f31] else f30, f30, f30 <== f30, f30, f30, f30, v305.cf96 >= |(v307[v308.cf1])[v144.f27 := v143]|, false, if (f30 in v309) then v309[f30] else f30, f30];
				} else {
		...
		var v317: set<map<int, int>> := {map v316 : int | (0x255 <= v316) && (v316 < 0x323) :: (v316 / 0x108) := (v144.f27), v145, v145};
		var v318 := new C3(v317, true, f30, v144.f27);
		r0 := f30;
		var v319: seq<bool> := [v318.f34, fm1(v144.f27, -f31, v82, globalState)];
		var v320: seq<bool> := [f30, v81 < v81, v319[f31], !v318.f34];
		r1 := !v320[v144.f27];
	}
}
...
class C6 extends T0, T1 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		...
		v0[852], globalState.f21, v0, r1, r1 := v4[--f31], fm1(|(v6 + v6)|, f31, if (p0) then v7 else v7, globalState), if (v8 in v9) then v9[v8] else v0, v5 < (v5 - v5), v13 !! (if (f30) then v13 else v13);
		if (f30) {
			...
			if (f30) {
				...
				var v19: map<int, int> := map[v18[if (|(seq(0x2b8, i1  => (v7)))| in v14) then v14[|(seq(0x2b8, i1  => (v7)))|] else |(seq(0x1e6, i2  => (f27)))|] := fm2(f30, globalState)];
				var v21: set<int> := {f31, f31};
				v19 := if (p0) then map v20 : int | v20 in v21 :: (v20 * f27) := (|v2|) else v19;
				globalState.f21 := (v18[|v4|] % f31) <= f27;
				...
				v26[12] := v28;
				globalState.f19, v0[852], v26[12], globalState.f25, globalState.f24 := f27 - (if (f27 in v14) then v14[f27] else f31), true, v28, --(f27 % 0x3af), v8.cf9;
				var v29: seq<int> := [f31 - f27];
				v29 := seq(0xd2, i4  => (f27));
				var v30 := DC35(map[v0 := v7]);
				var v31: map<D14, bool> := map[v30 := !(0x4c == f31)];
				v31, globalState.f21, globalState.f1, globalState.f15, globalState.f24 := v31, v0[852], f31, v2, |v4|;
			...
			v33 := (v33 + v33) + [v0, v0];
			var v34 := DC16(v7, if (v0[852]) then -80 else -f31);
			match (v34) {
				case DC16(cf22, cf23) =>
					var v35: multiset<bool> := multiset{f30};
					var v36: multiset<multiset<bool>> := multiset{v35 * (multiset(v4))[p0 := 0x17a]};
					v36 := (multiset{v35} * multiset{multiset(v4)}) + multiset{fm3(p0, globalState), multiset{p0, f30, v0[852]}};
					var v37: array<int> := new int[29];
					var v38 := new C5(v37, v0[852], f27);
					...
					v39[561], v41, v42, globalState.f19, globalState.f1 := v0, v41, DC58(if (p0) then |"tw"| else cf23, v2 + (if (v0 in v43) then v43[v0] else "qintmcha"), cf23), |map[f30 := "b"]|, -|v44|;
					var v45, v46 := v38.m6(globalState);
				case DC17(cf24, cf25, cf26, cf27, cf28) =>
					globalState.f11 := (if (cf25) then 0x24b else f27) / f27;
					var v47: map<bool, bool> := map[cf24 := v4[-cf28]];
				...
				case DC15(cf21) =>
					...
					globalState.f24, v53[347], v56[79], globalState.f19, globalState.f24 := f27, v7, -f31, f31, |v57| % f27;
				case DC18(cf29) =>
					globalState.f15 := fm34(f31 % f31, 0x39, v0[852], f31, globalState);
					...
					globalState.f19 := f31;
					var v62: map<bool, char> := map[v0[852] := v7];
			...
			var v68: map<map<seq<int>, int>, char> := map[v67 := fm29(v0[852], globalState)];
			v7 := if ((map[v66 := f27] + map[[821, -f31, f27] := f31]) in v68) then v68[map[v66 := f27] + map[[821, -f31, f27] := f31]] else 's';
			globalState.f21 := p0;
			v0[852] := p0;
			var v69: array<int> := new int[20](i5 => i5 - |(seq(0x26c, i6  => (v7)))[f31 := v7]|);
			v69[693] := f31;
			globalState.f24, v69[693], globalState.f24, v2 := f27 + f27, f27, f27, v2 + v2;
			v66 := seq(0x15a, i7  => (f31));
		}
		...
		if (match v72 {
			case DC41() => v0[852]
			case DC42(cf72, cf73, cf74) => v4 < v4[f27 := f30]
			...
			if (v0[852]) {
				...
				var v75: map<int, bool> := map[f27 := v0[852]];
				globalState.f21 := fm1(f27 / f27, |(if (if (f31 in v75) then v75[f31] else !p0) then "tprb" else v2)|, v7, globalState);
				...
				var v79, v80, v81 := m0(v78, 0x270 > v70[217], fm2(p0, globalState), v0[852], globalState);
			...
			var v85: seq<C4> := [if (v0[852]) then v84 else v84, v84];
			v85 := v85;
			var v86: multiset<int> := multiset{f27};
			var v87: multiset<int> := multiset{if (f27 in v86) then v86[f27] else f27};
			var v88: map<map<bool, int>, int> := map[v1 := v70[217] - -|v86|];
			v88 := v88;
			if (true) {
				var v89: multiset<array<int>> := multiset{v70};
				v89 := v89 + (v89 * v89);
				var v90: seq<array<int>> := [v70, v70, v70, v70, v70];
				var v91: map<array<int>, int> := map[v90[v70[217]] := |v2|];
				v70[217], globalState.f21, globalState.f19, v91 := 0x1f5, p0, f27, v91 + v91;
				var v92: seq<string> := ["jersvkyhb"];
				v92 := v92;
				globalState.f1 := v70[217];
				var v93: seq<int> := [if (p0) then f31 else -0x1e1, f27];
				v93 := seq(0x247, i9  => (v70[217]));
			} else {
				var v94 := DC51(v70[217]);
				var v95: set<char> := {v7, 'g', v7, v7};
				v94 := DC51(f31 * |v95|);
				v70[217] := v70[217];
				globalState.f21 := !(v5 > (v5 + v5));
				var v96: set<array<bool>> := {v0, v0};
				var v97: seq<int> := [v70[217]];
				var v98: seq<seq<int>> := [[f27], v97 + v97, v97];
				v96, v98, globalState.f21, globalState.f1 := v96, v98[f27 := v97], (if (v0[852]) then f27 else 558) <= f27, f31 + (f31 + v70[217]);
				var v99: map<string, int> := map[seq(0x162, i10  => (v7)) := v70[217]];
				var v100: T0 := new C2(v0, -0x323);
				var v101: map<int, T0> := map[v70[217] := v100];
				var v102: map<int, int> := map[f31 := |[f31, DC42(if (|v2| in v101) then v101[|v2|] else v100, v70[217], multiset(v4)).cf73, v70[217]]|];
			...
			if (!v0[852]) {
				v0[852] := if (p0) then f30 else v0[852];
				var v104: multiset<array<bool>> := multiset{v0};
				v104 := v104;
				globalState.f15 := (seq(286, i11  => (v7))) + v2;
				var v105 := new C5(v70, v0[852], f31);
				var v106: T0 := new C4(f31, !f30, f31);
				var v107: multiset<bool> := multiset{v0[852]};
				...
				v7 := v7;
				var v111: seq<int> := [v70[217]];
				var v112: map<seq<int>, string> := map[v111 := v2];
				v112 := v112[v111 + v111 := v2[f31 := 'm']];
			...
			v118[24] := v117;
			v118[24] := if (true) then v117.(cf0 := v0) else v117.(cf0 := v0);
			var v119: map<D5, bool> := map[DC15('d') := !f30];
			var v120: map<int, map<D5, bool>> := map[f31 := v119];
			v120 := v120[v70[217] := v119 + v119];
			var v121 := new C2(v0, f27);
			var v122: multiset<int> := multiset{v70[217], fm2(v4[f31], globalState), f31};
			var v123: map<int, multiset<int>> := map[f31 - f31 := v122 * v122];
			var v124: map<bool, set<bool>> := map[f30 := v5];
			v123 := v123[v70[217] := multiset{|v124|, f27}];
			if (p0) {
				globalState.f21 := p0;
				var v125 := DC15(v7);
				v125 := DC15(v7);
				v0[852] := true;
				var v126: multiset<bool> := multiset{fm1(f31, v70[217], v7, globalState)};
				globalState.f25 := -fm6(v126 + v126, globalState);
				var v127: map<int, int> := map[f27 := v70[217]];
				...
				var v134 := new C3(v133, p0, p0, v70[217]);
				globalState.f21, r1, globalState.f11 := v134.f34, p0, fm2(if (!v134.f34) then f30 else p0, globalState);
				var v135: array<set<bool>> := new set<bool>[10] [fm26(p0, globalState), fm26(v0[852], globalState), v5, v5, v5, v5, v5, v5, {v0[852]}, v5 * {f30}];
				v135[456] := v5;
				globalState.f25, v70[217], v135[456] := f27, f31, v5;
				globalState.f19 := f31 - f31;
				var v136: T0 := new C4(v70[217], f30, v70[217]);
				var v137: map<T0, bool> := map[v136 := f30];
				var v138: map<int, bool> := map[f27 := true];
				globalState.f1 := -v121.fm7(fm1(|v137|, f27, v2[|v138[f27 := p0]|], globalState), globalState);
			}
		...
		var i12 := 0;
		while (v139[v70[217] := f31] !! fm38(globalState))
			decreases 100 - i12
		{
			if (i12 >= 100) {
				break;
			...
			i12 := i12 + 1;
			var v140: map<string, int> := map["qdxsv" := v70[217]];
	...
	method m4(globalState: GlobalState) returns (r0: array<string>, r1: int, r2: int, r3: D0) {
		...
		var v1 := 'n';
		var v2 := "dgkoq";
		var v3 := DC58(f31, v2[|(seq(0x208, i1  => (v1)))| := 'q'], f27);
		v0[584], r1 := fm1(f27, 533 % f27, v1, globalState), v3.cf96;
		var v4: seq<bool> := [v0[584]];
		var v5: set<int> := {f31, f27};
		var v6: map<bool, string> := map[v0[584] := v2];
		var v7: array<int> := new int[6] [f31 / f27, |v4|, f31, f31 - |v5|, -|multiset{|(if (f30 in v6) then v6[f30] else v2)|, f31}| * f27, f31];
		forall i2 | 0 <= i2 < v7.Length {
			v7[i2] := i2 - f31;
		}
		var v8: set<bool> := {true, f31 != -f31};
		v8 := v8;
		var v9 := DC22(v2[f27], v0[584], v0[584]);
		var i3 := 0;
		while (v9.cf39)
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			var v10: map<bool, bool> := map[false := v0[584]];
			var v11: map<int, string> := map[f31 := v2];
			v10 := v10[f30 := fm1(-f31, |v2|, fm19(v0[584], v0[584], v0[584], v11, globalState), globalState)];
			...
			v14[7] := (v16.(cf15 := multiset{fm6(v17, globalState)})).cf15;
			var v18: T0 := new C2(v0, f27);
			v13, v14[7], globalState.f11, v18 := v13, v15, f31, v18;
			...
			decreases 100 - i4
		{
			...
			globalState.f21 := if (v0 in v25) then v25[v0] else v0[584];
			...
			var v29: map<bool, array<int>> := map[v0[584] := v7];
			v27[988], v7[982], v28, v7 := v7, f27, v28, if (f30 in v29) then v29[f30] else v7;
		}
		var v30: set<char> := {v1};
		var i5 := 0;
		while (v1 in v30)
			decreases 100 - i5
		{
			...
			match (if (!(v2 < v2)) then DC50(v5) else v31) {
				case DC51(cf88) =>
					...
					v33 := v33[if (v0[584]) then v0[584] else false := f31];
					var v34: multiset<bool> := multiset{f30};
					var v35: map<string, seq<bool>> := map[v2 := v4];
					var v36 := DC38(if (v2 in v35) then v35[v2] else v4);
					var v37: map<bool, seq<bool>> := map[v0[584] := [!v0[584], v0[584]]];
					var v38: array<seq<bool>> := new seq<bool>[26] [fm36(v34, globalState), v4, [v0[584]], [f30] + [v0[584], v0[584], f30], v4, if (v0[584]) then v4 else (v4[cf88 := v4[cf88]])[|v4| := true], v4 + v4, v4, v4 + [f30, true], v4, [v0[584]], v4, v4, v36.cf66, v4, v4 + (if (v0[584] in v37) then v37[v0[584]] else [fm1(|[v0[584]]|, |multiset{f30, f30, v0[584], v0[584], v0[584]}|, v1, globalState)]), v4, v4, v4, v4, v4 + v4, v4, v4, v4, v4, v4];
					v0[584], r2, v38 := v0[584], f31 % f27, if (f30) then v38 else v38;
					var v39 := DC11();
					v39 := v39;
				case DC52(cf89, cf90) =>
					var v40: map<int, bool> := map[f27 := f30];
					var v41 := DC47(seq(796, i6  => (DC15(v1))));
					var v42: map<D18, int> := map[v41 := f31];
					globalState.f24, v0[584], globalState.f24, globalState.f19, globalState.f1 := f31, fm1(if (if (f31 in v40) then v40[f31] else v0[584]) then f27 else cf89, cf90, v1, globalState), (if (v41 in v42) then v42[v41] else f31) + f31, f31, fm7(f30, globalState);
					var v43 := DC7();
					...
					v43, v50, cf89, globalState.f25 := v43, v50, |(v2 + v2[cf89 := v1])|, -(cf89 / f27);
					globalState.f24 := -(cf90 % fm7(v47.f34, globalState));
				...
				case DC50(cf87) =>
					...
					var v55: map<bool, int> := map[v0[584] := -|v54|];
					var v56: seq<map<bool, int>> := [v55, v55, v55, v55, v55];
					var v57 := DC14(f27);
					var v58: map<map<bool, int>, bool> := map[v56[v57.cf20] := !f30];
					var v59 := new C3(if (v0[584] in v53) then v53[v0[584]] else v52, false, f30, |v58|);
					globalState.f21 := v0[584];
					v0[584] := v59.f34;
					var v60: C4 := new C4(f31, v0[584], 612);
					var v61: array<C4> := new C4[6] [v60, v60, v60, v60, v60, v60];
					globalState.f11, v61, globalState.f25 := f31 * |(seq(-605, i7  => (v2[|v4|])))[f27 := v1]|, v61, |"vrdpjhqd"|;
				case DC53(cf91) =>
					globalState.f1 := f31;
					var v62: T0 := new C2(v0, f31);
					v62 := v62;
					var v63: multiset<int> := multiset{f27, v62.f27, f27, 0x253, v62.f27};
					v7[431] := v62.fm7(f30, globalState) / (if (f27 in v63) then v63[f27] else f31);
					var v64: array<array<int>> := new array<int>[6];
					v64[376] := v7;
					globalState.f21, v7[431], v64[376], v0[584], v0[584] := v0[584], f27 - -(if (f30) then v62.f27 else f27), v7, !f30, v0[584] || v0[584];
					globalState.f24 := f31;
			}
			
			var v65 := DC51(f31);
			v65 := DC51(f31);
			v0[584] := fm1(-f27, f27, v1, globalState);
			v7[928] := f31;
			var v66: multiset<int> := multiset{f31};
			var v67: seq<multiset<int>> := [v66, v66];
			var v68: map<int, string> := map[f31 := seq(136, i8  => (v1))];
			globalState.f11, globalState.f21, v0[584], globalState.f21, v7[928] := f27, fm1(|v67| - f27, fm7(f30, globalState), fm19(f30, f30, !!f30, v68, globalState), globalState), f30, v4[0x322] && f30, f31 % f31;
		}
		...
		r1 := |v2| - |(v71 + v72[|v73|])[f27 := f27]|;
		r2 := fm6(multiset(v4), globalState);
		var v74: multiset<bool> := multiset{true, f30, f30, v0[584]};
		var v75 := DC1(if (f30 in v74) then v74[f30] else f27, [-f27], -0x374, seq(0x190, i9  => ('m')), v0);
		r3 := v75;
	}
	method m5(p0: map<map<bool, char>, string>, p1: int, p2: set<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		var v0 := "xmkpfqvik";
		for i0 := f31 to |v0| {
			...
			if (!f30) {
				...
				var v12 := DC42(v10, v7[337], v11);
				var v13 := DC5(v7);
				var v14: map<D1, multiset<bool>> := map[v13 := fm3(f30, globalState)];
				var v15: multiset<multiset<int>> := multiset{multiset{f31, f27}, multiset(seq(0x1c8, i2  => (f27)))};
				var v16: map<array<int>, int> := map[v7 := |v15|];
				r1, globalState.f21, v12 := p2 <= {v10.f27}, (if (v13 in v14) then v14[v13] else v11) >= ((multiset{f30, f30})[f30 := |v16|] - fm3(f30, globalState)), v12;
				...
				v18 := v18[f30 := fm1(v7[337], |v11|, v1, globalState)];
			}
		...
		var v25: seq<int> := [|v24|];
		globalState.f11 := f31 * (if (v19 in v20) then v20[v19] else v25[p1]);
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			if (!((seq(0xe1, i4  => (v22))) < v0)) {
				v23[398] := f30;
				v23[398] := f30;
				var v31: array<int> := new int[2];
				var v32 := new C5(v31, v23[398], 0x2d9);
				...
				var v39: array<bool> := new bool[10] [f30, fm1(f27, f31, v22, globalState), true, v23[398] <== f30, v36 <= v36, f30, false, v38 >= v38, v23[398], f31 <= f31];
				v39 := v37;
				v23[398] := fm1(f27 + f27, f31 % fm2(false, globalState), v22, globalState);
				...
				v23[297] := f30;
				globalState.f25, r1, v23[297] := (if (f30) then -p1 else f27) % p1, !f30, fm1(f31, v25[f27], v22, globalState);
				var v43: map<int, bool> := map[0x277 := v23[297]];
				v43 := v43[f27 := f30];
				globalState.f21 := false;
				var v44, v45, v46 := m0(map[f30 := v22], f30, p1, v23[297], globalState);
				v46 := !f30 || true;
			}
			...
			if (!f30) {
				...
				globalState.f1 := |(v25 + v25)| * (p1 % 0x335);
				v58 := v58[f30 := f27];
				...
				var v66: C0 := new C0(v64[f27], v65);
				var v67: array<C0> := new C0[14] [v66, v66, v66, v66, v66, v66, v66, v66, v66, v66, v66, v66, v66, v66];
				var v68: map<array<C0>, int> := map[v67 := |("pbwt")[DC31(831, v0, |v25|).cf50 := v22]|];
				var v69 := DC52(|(seq(-0x31d, i7  => (p1)))|, f27);
				var v70: map<int, map<array<C0>, int>> := map[-v25[f31] := (map[v67 := p1])[v67 := -v69.cf90]];
				...
				globalState.f21, v72[132], v63, v66.f36[632], globalState.f25 := f30, v68 + (map[v73[f31] := f27] + v68), if (true) then if (f30) then v63 else v63 else v66.f36, p1, -p1;
				...
				v66.f36[632] := v66.f36[632] - p1;
				globalState.f21, v57, v23, globalState.f21 := v66.f36[632] < (if (f30 in v58) then v58[f30] else v66.f36[632]), {f30}, v23, f30;
			}
		...
		r0 := if ((fm1(v77.f27, v25[|v84.cf111|], v22, globalState) && v80.f30) in v83) then v83[fm1(v77.f27, v25[|v84.cf111|], v22, globalState) && v80.f30] else |(v0 + "anuffch")|;
		r1 := fm34(v77.f27, p1, v80.f30, |v26|, globalState) < (v0 + (v0[-|(map[f30 := v22])[v80.f30 := v22]| := v22])[-211 := v22]);
	}
	method m6(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		v0[809] := v1;
		v0[809] := v1;
		var v2: seq<bool> := [fm1(f27, f31, v0[809], globalState), f30, f30, f30];
		if (v2[f27]) {
			var v3: array<int> := new int[28](i1 => i1 % f31);
			v3[18] := 953;
			...
			v0[809], v3[18] := v0[809], fm6(if (f30 in v7) then v7[f30] else if (false in v7) then v7[false] else v6, globalState);
			var v8: map<seq<bool>, int> := map[fm36((multiset{f30})[f30 := f31], globalState) := v3[18]];
			v8 := v8[[f30] := v3[18]];
			var v9: array<multiset<char>> := new multiset<char>[13](i2 => multiset([v1]));
			var v10 := "qgwurmhm";
			var v11 := DC2(v3[18], v10, v3[18]);
			var v12 := DC4(v11);
			var v13 := DC4(v12);
			var v14: set<bool> := {f30};
			v9, r1, globalState.f24, v13, v3 := v9, f30, |v14|, DC4(v11), v3;
			if (f30) {
				var v15 := new C4(v5[f31] * f27, f30, v3[18]);
				var v16: multiset<seq<bool>> := multiset{fm12(globalState), v2, v2};
				globalState.f21 := v16 !! v16;
				globalState.f25 := v3[18];
				...
				var v18: map<string, int> := map[v10[v3[18] := if (-v3[18] in v17) then v17[-v3[18]] else v1] + v10 := v5[v3[18]]];
				var v19: seq<string> := [v10];
				var v20: multiset<int> := multiset{f31};
				v18 := v18[v19[f27] := |(v20 * v20)|];
			...
			var v30: array<int> := new int[8] [f27 / f27, f31, f31, |(v29 - v29)|, 115, f27, if (f30) then f31 else -f31, f31];
			v30[772] := f27;
			var v31: seq<char> := [v1];
			var v32 := DC67(f31);
			v30[772] := |v31| * v32.cf110;
			var v33: array<map<string, string>> := new map<string, string>[3];
			var v34: map<string, string> := map[("qt")[f31 := v1] := seq(641, i3  => (v1))];
			v33[494] := v34 + v34;
			v33[494] := v34 + v34;
			var v35: array<bool> := new bool[12](i4 => v2[f27]);
			var v36: set<array<bool>> := {v35, v35};
			match (fm56(-|v36|, v31, f30, globalState).(cf21 := v0[809])) {
				case DC16(cf22, cf23) =>
					var v37 := DC71(v30[772], f30);
				...
				case DC17(cf24, cf25, cf26, cf27, cf28) =>
					...
					v47[910] := v49;
					var v50: map<string, seq<multiset<bool>>> := map[v31 := (seq(0x177, i5  => (multiset(v2)))) + v49];
					v47[910] := if ("cghlpd" in v50) then v50["cghlpd"] else v49;
					globalState.f21 := cf24 <==> cf25;
					cf25 := f27 > cf28;
					var v51: set<bool> := {false, false};
					var v52: set<int> := {cf27};
					var v53, v54, v55 := m0(map[cf26 := v0[809]], {cf25} > v51, f27, v52 > v52, globalState);
				case DC15(cf21) =>
					var v56: map<int, bool> := map[-0x2f2 := f30];
					var v57 := DC56(if (fm1(|v56|, f31, v0[809], globalState)) then f30 else true);
					v57 := v57;
					var v58 := new C1(DC7(), f30, v30[772]);
					var v59: seq<int> := [v30[772], fm7(f30, globalState)];
					var v60 := new C2(v35, |v59|);
					v60.f38[274] := f30;
					v60.f38[274] := v2[f27];
				case DC18(cf29) =>
					globalState.f21 := f27 < v30[772];
					var v61: map<string, int> := map[seq(0x295, i6  => (v0[809])) := fm2(f30, globalState)];
					var v62 := new C0(v30, v61);
					v2 := v2;
					var v63: seq<int> := [f31, f31];
					globalState.f21 := fm1(v63[fm2(f30, globalState)], v30[772], v0[809], globalState);
			}
			...
			if (!v2[f27]) {
				...
				var v66: multiset<int> := multiset{-0x376, f27 % f27, 271, fm2(if (f30 in v64) then v64[f30] else false, globalState), |(v65 + map[v2 := v30[772]])|};
				v66 := v66;
				var v67: map<int, multiset<int>> := map[f31 := v66];
				v67 := v67[v30[772] := v66];
				var v68: seq<int> := [v30[772]];
				var v69: map<bool, seq<int>> := map[f30 := [v30[772]] + v68[v30[772] := f27]];
				v69 := v69[f30 := v68];
				globalState.f21 := fm1(v30[772], -(f27 - |fm24(f31, v30[772], f27, v31, globalState)|), v1, globalState);
			} else {
				var v70: map<string, int> := map[v31 := v30[772]];
				var v71 := new C0(v30, v70);
				v35[636] := !f30;
				v35[636] := fm1(496 / v30[772], -v30[772], 'q', globalState);
				v35[636] := !fm1(f27, 680, v0[809], globalState) ==> f30;
				var v72: array<string> := new seq<char>[13](i7 => v31[0x2bc := v0[809]] + v31[|map[DC22('b', v35[636], f30) := f31]| := v1]);
				v72 := v72;
				var v73: multiset<int> := multiset{f31};
				v35[636] := v73 > v73[f27 := 0x313];
			}
		...
		match (DC43(if (f30) then v1 else v1, v78)) {
			case DC41() =>
				...
				v82 := v82[fm2(fm1(f27, f31, v0[809], globalState), globalState) := v80];
				var v83: map<int, bool> := map[f27 := fm1(fm2(false, globalState), f31, v0[809], globalState)];
			...
			case DC42(cf72, cf73, cf74) =>
				v76[84] := v76[84];
				v0[809] := v0[809];
				var v85 := DC52(if (v2[f27]) then fm7(f30, globalState) else cf72.f27, 0x127 % f31);
				var v86: set<bool> := {v76[84]};
				var v87: array<set<bool>> := new set<bool>[2] [v86, v86];
				var v88: seq<string> := [v77, v77];
				var v89: map<bool, string> := map[f30 := v88[cf72.f27]];
				var v90: set<string> := {v77, if (v76[84] in v89) then v89[v76[84]] else v77};
				v85, v87, globalState.f25, v76[84], globalState.f21 := v85, v87, cf72.fm6(cf74, globalState), v77 in v90, f30;
				var v91: map<int, string> := map[|[f30]| := v77];
				v1 := fm19(v76[84], f31 < f27, f30, v91, globalState);
			case DC43(cf75, cf76) =>
				globalState.f25 := f27 * f31;
				if (f30) {
					var v92 := new C1(DC7(), v76[84] in v2, f31);
					...
					v94 := v96.cf74;
					globalState.f24 := f27;
					globalState.f19 := f31 * (f27 / v95.f27);
				} else {
					var v97 := DC7();
					var v98 := new C1(v97, f30, -f31 / f27);
					globalState.f21, r0 := v76[84], false;
					var v99 := new C4(f27, !f30, f31 * f31);
					var v100 := new C1(v97, !f30, f31);
					v98.m12(v76[84], v76, f31, globalState);
				}
				
				globalState.f21 := !v76[84];
				var v101: seq<int> := [793, f31];
				var v102 := DC13();
				var v103: multiset<bool> := multiset{f30, v76[84], v76[84]};
				var v104: array<int> := new int[23] [f31, f31, f31, -f27, f31, f27 * |multiset(v101)|, f27, f27 + |map[f31 := v102]|, f31, -0x275, |multiset{v76[84], f30}| * f27, f27 + f27, -(777 / -|v103|), f31, f27 / f27, |v77|, f31, f31, f27, f27, f31, f31 / |v103|, 0x157];
				var v105: seq<array<int>> := [v104, v104, v104];
				v104 := v105[f31];
			case DC40(cf71) =>
				var v106: map<char, bool> := map[v0[809] := f30];
				v106 := v106;
				var v107: set<int> := {241};
				if (v107 > v107) {
					globalState.f1 := 0x3ca;
					var v108: map<bool, int> := map[v76[84] := f31];
					...
					var v112: map<int, bool> := map[f27 % -f31 := false];
					v112 := v112;
					globalState.f11 := f27 + (if (v76[84] in v110) then v110[v76[84]] else f27);
					...
					v116 := v116[v76[84] := v115];
					var v117: map<int, int> := map[f31 := f27];
					var v118: multiset<int> := multiset{f27};
					var v119: map<map<int, multiset<int>>, bool> := map[map[f27 := v118] := v76[84]];
					var v121 := DC36(|v117|, v76[84], v76[84], if ((map v120 : int | v120 in v118 :: (v120 + f31) := (v118)) in v119) then v119[map v120 : int | v120 in v118 :: (v120 + f31) := (v118)] else f30, f30);
					var v122: array<D14> := new D14[8] [v121, v121, v121, v121, v121, v121, fm57(f27, f30, fm1(f31, f27, v0[809], globalState), f30, globalState), v121];
					v122[306] := v121;
					v122[306] := v121;
					var v123: array<int> := new int[19](i10 => i10 + |v2|);
					var v124: map<string, int> := map["vpo" := f27];
					var v125 := new C0(v123, v124 + map[seq(986, i11  => (v0[809])) := f27]);
					globalState.f11 := |(map v126 : int | (0x30d <= v126) && (v126 < 252) :: (v126 * 651) := (f27))|;
					var v127 := DC70(f31, v76[84], v0[809]);
					var v128 := DC72(v127);
					var v129: map<D25, bool> := map[if (f30) then v128 else v128 := f30];
					var v130: set<bool> := {v76[84], v76[84], f30};
					v129 := v129[if (v76[84]) then v128 else v128 := f30 !in v130];
				}
		...
		var v139: multiset<bool> := multiset{v76[84]};
		globalState.f25 := fm2(fm1(fm6(v139, globalState), f31, v0[809], globalState), globalState);
		var v140: map<int, int> := map[f27 := f31];
		var v142: seq<int> := [|map[f27 := f27]|, f27, f31, f27, f27];
		var v143: multiset<int> := multiset{v142[f31], f31};
		var v144: set<map<int, int>> := {v140[|map[f30 := f30]| := |map[v76[84] := v76[84]]|], v140, map v141 : int | v141 in v143 :: (v141 + f27) := (f31)};
		v76[84] := v144 <= v144;
		r0 := v76[84];
		r1 := v139 !! v139;
	}
...
class C7 extends T0 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		...
		match (v8) {
			case DC8(cf15) =>
				...
				var v16: set<seq<int>> := {(fm24(f27, |v13|, |{v14, v14}|, v13, globalState))[|cf15| := f27], v14, [f27], v15.cf2};
				v11[766], r1, globalState.f21, v12 := if (p0) then v0 else v0, p0 ==> f29, fm1(f27, |v16|, v1, globalState), v12.(cf0 := v9).(cf0 := if (f29) then v9 else v9);
				...
				match (v18) {
					case DC24() =>
						...
						globalState.f21 := (v20[f27] + v19) < v19;
						var v21: array<C2> := new C2[4] [v10, v10, v10, v10];
						v21[226] := v10;
						globalState.f1, globalState.f15, globalState.f15, v21[226] := f27 * f27, "jb", v13, if (f29) then v10 else v10;
						...
						v22[444] := v28 + v28;
						v22[444] := map[v23 := fm42(f27, f29, f27, f29, globalState)];
						var v29 := new C6(f27, p0, |v15.cf2|);
					case DC23(cf40) =>
						var v30: map<multiset<bool>, bool> := map[multiset{p0} := f29];
						globalState.f19 := |fm8(v13, v13, v30, globalState)| / (if (f27 in cf15) then cf15[f27] else f27);
	...
	method m4(globalState: GlobalState) returns (r0: array<string>, r1: int, r2: int, r3: D0) {
		...
		if (!!f29) {
			...
			var v23 := "mwl";
			var v24: set<string> := {seq(540, i3  => (v1)), seq(0x3d, i4  => ('y'))};
			globalState.f24 := |({seq(-0x17a, i1  => (v1)), v23, seq(0x11a, i2  => (v1))} + (v24 + v24))|;
			v22 := fm1(f27, v20, v1, globalState);
		}
		
		var v25: map<bool, char> := map[f29 := 'v'];
		var v26: seq<seq<bool>> := [[f29]];
		var v27, v28, v29 := m0(v25 + v25, fm2(f29, globalState) == fm6(multiset(v26[f27]), globalState), 0x3d4, f29, globalState);
		...
		if (v31.fm27(v29, --0x236, v29, globalState)) {
			...
			if (f29 <== fm1(f27, if (v33 in v34) then v34[v33] else f27, v1, globalState)) {
				...
				v41 := v41[fm2(true, globalState) := v41[|v33|]];
			...
			v29 := f29;
			var v50: seq<string> := [v44 + v44[f27 := v1]];
			v50 := v50;
		}
...
class C8 {
	...
	method m1(p0: bool, globalState: GlobalState) {
		...
		var v5 := "rjcivm";
		var v6 := DC1(|v1|, if (v2 in v4) then v4[v2] else seq(0x1f2, i1  => (v2)), -v2, v5, v0);
		v0 := v6.cf5;
		var v7: array<int> := new int[17](i2 => i2 / v2);
		v7[896] := v2;
		v7[896] := v2 / v2;
		globalState.f21 := p0;
		var v8 := 'w';
		var v9: map<bool, int> := map[true := fm4(true, v7[896], v5, v8, globalState)];
		var v10: map<set<map<bool, int>>, bool> := map[{map[p0 := v2], v9} := p0];
		var v11: set<map<bool, int>> := {map[p0 := v7[896]]};
		if (multiset{p0} > multiset{true, if (v11 in v10) then v10[v11] else p0}) {
			...
			var v14: set<bool> := {if (v7[896] in v13) then v13[v7[896]] else p0, p0, fm1(|{p0}|, v2, v8, globalState), !p0};
			v14 := v14;
			var v15: array<D0> := new D0[20];
			var v16 := DC1(v7[896], v3, fm2(p0, globalState), v5, v0);
			var v17 := DC4(v16);
			var v18 := DC4(v17);
			var v19 := DC4(v17);
			var v20 := DC4(v19);
			v15[516] := v20.(cf12 := v18);
			v15[516] := v20;
			globalState.f21 := p0;
			var v21 := DC7();
			match (v21) {
				case DC6(cf14) =>
					globalState.f21 := p0;
					v0[158] := p0 && p0;
					var v22 := DC3(v7[896], p0, v7[896]);
					v0[158] := -fm2(!p0, globalState) >= (v2 / v22.cf9);
					var v23: map<bool, map<int, bool>> := map[false := v13];
					v7[896] := |(v23 + v23)|;
					var v24: set<int> := {v7[896] % v2, v2 % |v1|, v7[896] - v2, v7[896] + v2};
					var v25: map<int, int> := map[v2 := v2];
					var v26: seq<bool> := [fm1(v6.cf1, v2, v8, globalState)];
					v0[158], v7[896], v24, v0[158], globalState.f25 := v0[158] && p0, 0x281, v24 * v24, if (|(v14 + v14)| in v13) then v13[|(v14 + v14)|] else p0, |v25| * -|v26|;
				case DC7() =>
					v2 := v7[896];
					globalState.f21 := v2 == (v7[896] / v2);
					globalState.f24 := v2;
				...
				case DC5(cf13) =>
					...
					v27[579] := cf13;
					v27[579] := cf13;
					var v28: multiset<int> := multiset{v7[896]};
					v28 := multiset{v2 % v7[896], fm2(p0, globalState), v7[896], 840};
					globalState.f21 := !!p0;
			}
			
			globalState.f21, v15[516] := "e" <= v5, v20.(cf12 := DC2(|v14|, v5, v2)).(cf12 := v17);
		} else {
			globalState.f11 := -v7[896];
			...
			if (p0) {
				...
				var v36: seq<bool> := [p0];
				v35 := v35[0x29 := v36[v2]];
				globalState.f19 := v7[896] % v2;
				v7[896], v3, globalState.f25 := |"dyxbqeym"|, v3 + v3, v7[896] * v6.cf1;
				v7[896] := v7[896] * v7[896];
			} else {
				var v37: array<array<bool>> := new array<bool>[13];
				v37[356] := v0;
				v0[314] := fm1(v7[896], v2, v8, globalState);
				v7[896], v37[356], v7[896], v0[314] := v2, v0, fm2(p0, globalState), !p0;
				var v38: map<int, bool> := map[-v2 := false];
				v38 := v38[0x1c6 := p0];
				var v39: seq<bool> := [p0];
				var v40: seq<bool> := [v0[314], v39[-840], p0, v0[314]];
				var v41: map<bool, seq<bool>> := map[true := v40];
				v41 := if (v0[314]) then v41 else v41 + v41;
				var v42: multiset<int> := multiset{v2, v2};
				v38 := v38[v7[896] := v7[896] >= |v42|];
				var v43: array<multiset<bool>> := new multiset<bool>[13];
				var v44: map<bool, bool> := map[v0[314] := p0];
				v0[314], v7[896], v43, globalState.f21 := v0[314], v2 / v2, v43, v7[896] != |v44|;
			}
			
			var v46: map<int, int> := map[fm4(p0, v2, v5[v7[896] := v8], v8, globalState) := v2];
			var v47: set<map<int, int>> := {map v45 : int | (0x269 <= v45) && (v45 < 0x1dc) :: (v45 % v2) := (0x34e), v46};
			var v48 := new C3(v47, v5 < (seq(0x50, i3  => (v8))), p0, if (p0 in v9) then v9[p0] else |v5|);
			var v49: seq<map<bool, int>> := [v9];
			globalState.f21 := |v49| <= v7[896];
		}
		
		var v50: map<bool, bool> := map[p0 in v1 := p0];
		v50, v8 := v50, v8;
		v0, v5, globalState.f19 := v0, v5, -(fm2(p0, globalState) + (v2 / v2));
	}
	method m2(p0: seq<bool>, p1: bool, p2: string, globalState: GlobalState) returns (r0: string, r1: seq<bool>) {
		var v0: array<int> := new int[23](i0 => i0 / |map[p1 := p2]|);
		v0[567] := |"ry"|;
		var v1: array<char> := new char[4];
		var v2 := 'k';
		v1[689] := v2;
		var v3 := -371;
		v0[567], v1[689], globalState.f25, globalState.f21, globalState.f15 := v3, 'd', v3, p1, (seq(0x3da, i1  => (v2)))[v3 := v2];
		var v4: set<int> := {v0[567]};
		var v5 := DC14(|p2|);
		var v6: seq<int> := [|p2|, v0[567]];
		var v7: map<seq<char>, bool> := map[fm34(v5.cf20, v0[567], !p1, v6[|p2|], globalState) := p1];
		globalState.f19 := if (fm1(|v4|, |"ijnklh"|, v1[689], globalState)) then |(if (p1) then v7 else v7)| else v3;
		var v8: T1 := new C6(v0[567], p1, v3);
		var v9: map<char, T1> := map[v2 := if (p1) then v8 else v8];
		v9 := map[fm10(globalState) := v8];
		var v10: array<bool> := new bool[5];
		v10[646] := v8.f30;
		v10[646] := p1 || v8.f30;
		var v11: multiset<bool> := multiset{fm1(v3, v8.f31, v1[689], globalState)};
		var v12: map<int, multiset<bool>> := map[-v0[567] := v11];
		if (v11 <= (if (v8.f31 in v12) then v12[v8.f31] else multiset(p0))) {
			...
			var v14 := DC11();
			v14 := v14;
			var v15: map<int, bool> := map[v0[567] := v8.f30];
			var v16: map<bool, int> := map[if (v0[567] in v15) then v15[v0[567]] else p1 := -(v8.f31 - v3)];
			v16 := v16[v11 >= multiset([!v10[646], false]) := v8.f31];
			v0[567] := v0[567] - |p2|;
		} else {
			if (!v10[646]) {
				var v17: map<bool, bool> := map[v8.f30 := !v10[646]];
				v17 := v17[p2 != p2 := (if (v8.f30 in v11) then v11[v8.f30] else v8.f31) != v8.f31];
				globalState.f19 := v6[|(p2 + p2)|];
				var v18: map<int, int> := map[|(seq(0x26e, i2  => (|p2|)))| := |[p1, v8.f30, p1]|];
				globalState.f24 := -(v8.f31 - ((if (v8.f31 in v18) then v18[v8.f31] else 0x1ab) / v8.f31));
				var v19: map<string, int> := map[p2 := -|"q"|];
				var v20: C0 := new C0(v0, v19);
				var v21: seq<C0> := [v20, v20];
				var v22: set<map<int, int>> := {map[-|v21| := v3], v18, v18};
				var v23 := new C3(v22, v8.f30, v10[646], -v3 * v8.f31);
				var v24 := DC7();
				var v25 := new C1(v24, p2 <= p2, |(p2 + p2)|);
			} else {
				v2 := v1[689];
				var v26: map<bool, char> := map[v8.f30 := v1[689]];
				var v27: seq<string> := [p2];
				var v28: map<map<bool, char>, string> := map[v26 := v27[v8.f31]];
				var v29, v30 := v8.m5(v28, v8.f31, v4, globalState);
				var v31 := DC63(p1);
				var v32: seq<D23> := [v31, v31, v31];
				v32 := (fm59(fm1(fm2(v8.f30, globalState), v29, v2, globalState), 0x14, v8.f30, globalState))[v8.f31 := v31];
				var v33 := new C6(-|p2|, p1, v8.f31);
				globalState.f21 := false && !v30;
			}
			
			var v34 := DC36(v0[567], false, v8.f30, p1, v8.f30);
			var v35: map<bool, char> := map[v34.cf63 := 'g'];
			var v36: seq<map<bool, char>> := [v35];
			v36 := v36;
			if (fm1(|v6[v8.f31 := |multiset{v8.f30, p1}|]|, |v6|, v2, globalState)) {
				var v37: multiset<array<bool>> := multiset{v10, v10, v10, v10, v10};
				var v38 := new C7(v37, v10[646], v0[567] % fm2(v8.f30, globalState));
				var v39: array<set<int>> := new set<int>[27](i3 => v4);
				v39[932] := v4;
				v39[932] := v4 - (v4 * (set v40 : int | (66 <= v40) && (v40 < 0x50) :: (v40 / v8.f31)));
				var v41: C6 := new C6(v0[567], if (true) then v8.f30 else fm1(v8.f31, v3, fm19(p1, p1, v8.f30, fm60(v8.f30, v8.f30, v8.f30, 0x238, globalState), globalState), globalState), v0[567]);
				v41 := v41;
				...
				globalState.f15, globalState.f21, v45, v46, v47 := p2, v8.f30, fm37(v8.f31, v8.f31, globalState), map[p0[|p2|] := p2], v47;
				v1[689] := if (false) then v2 else v1[689];
				var v48: map<bool, bool> := map[v10[646] := v8.f30];
				var v49 := new C6(v8.f31, if (v8.f30 in v48) then v48[v8.f30] else v8.f30, 500);
				globalState.f21, globalState.f21 := if (!v10[646]) then p0 != p0 else v8.f30, v8.f30;
			}
			...
			match (DC55(v50)) {
				case DC56(cf94) =>
					globalState.f1 := v8.f31 - (if (p1) then |p2| else v0[567]);
					globalState.f21 := false;
					v10[646] := v10[646];
					var v51: map<bool, bool> := map[v8.f30 := p1];
					var v52: map<map<int, bool>, int> := map[map[|v11| := fm1(v3, |v51|, v2, globalState)] := v8.f31];
					v0[567], globalState.f24, v6 := (v0[567] % v8.f31) % v8.f31, v8.f31, v6[|([cf94] + p0)| := |(v52 + v52)|];
				case DC55(cf93) =>
					v10[646] := true;
					globalState.f21 := v8.f30;
					globalState.f21 := !(v8.f30 <==> v8.f30);
					v0[567] := v6[v8.f31] + v0[567];
			}
			
		}
		
		if (v10[646]) {
			globalState.f21 := v10[646];
			var v53: map<int, char> := map[v3 := v1[689]];
			v1[689] := if (-v3 in v53) then v53[-v3] else v2;
			var v54: array<seq<bool>> := new seq<bool>[3];
			v54[999] := fm36(v11, globalState) + p0;
			v54[999] := p0 + p0;
			var v55: set<map<int, int>> := {map[200 := v3]};
			var v56: array<seq<int>> := new seq<int>[3] [(fm33(v55, globalState))[fm2(v8.f30, globalState) := v8.f31], v6 + v6, seq(0x310, i5  => (v8.f31))];
			var v57: map<bool, char> := map[false := v1[689]];
			v56[364] := [v0[567], |v57|];
			var v58: multiset<array<bool>> := multiset{v10, v10};
			globalState.f21, v56[364] := v58 <= v58, v6;
			if ((p2 + p2) == (p2 + p2)) {
				var v59 := DC10(v10[646], true);
				var v60: map<int, bool> := map[-v3 := v59.cf18];
				v60 := v60[-v8.f31 % v3 := v8.f30];
				var v61 := DC67(v8.f31);
				var v62: map<bool, D24> := map[v10[646] := v61];
				v62 := v62[DC36(v0[567], v10[646], false, v10[646], !p1).cf62 := v61];
				...
				v63 := v63[v0[567] * v3 := v64];
				v10[646] := v8.f31 > v8.f31;
			} else {
				var v65: map<string, int> := map[p2 + (seq(98, i6  => (v2))) := v8.f31];
				v65 := v65[p2 := v3 + 0x2d5];
				globalState.f21 := v8.f30;
				var v66: array<map<int, int>> := new map<int, int>[23];
				var v67: seq<array<map<int, int>>> := [v66, v66, v66];
				v66 := v67[v0[567]];
				globalState.f11 := fm2(if (v8.f30) then v10[646] else false, globalState);
				var v68 := DC7();
				var v69: C1 := new C1(v68, (fm61(globalState)).cf94, v8.f31);
				var v70: map<int, C1> := map[v8.f31 := v69];
				var v71: multiset<int> := multiset{v8.f31, v0[567], v0[567], v8.f31, v0[567]};
				v70 := v70[|(v71 + v71)| := v69];
			}
			
		} else {
			var v72: multiset<array<bool>> := multiset{v10, v10, v10, v10, v10};
			var v73: C7 := new C7(v72[v10 := v8.f31], v3 == v3, v8.f31);
		...
		r0 := seq(0x199, i7  => (p2[|p2|]));
		r1 := p0 + (p0 + p0);
	}
}

method Main() {
	var v1: array<map<char, bool>> := new map<char, bool>[2](i0 => map v0 : char | v0 in (seq(0x5c, i1  => ('u'))) :: (v0) := (false));
	var v2 := false;
		...
		decreases 100 - i5
	{
		...
		match (v18) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				globalState.f15 := (seq(0x350, i6  => (v11))) + ((seq(453, i7  => (v11))) + cf4);
				var v19: array<array<bool>> := new array<bool>[25];
				v19[98] := v7;
				var v20: multiset<array<int>> := multiset{v3};
				var v21 := DC1(0x28d, cf2, cf1, cf4, cf5);
				v19[98], globalState.f1, cf3, v5 := cf5, if (v3 in v20) then v20[v3] else -v15 - cf3, v15 * v21.cf1, (seq(887, i8  => (v11))) + v5;
			...
			case DC3(cf9, cf10, cf11) =>
				...
				var v40: set<bool> := {v39[v8]};
				v35, v17, v17, v11 := fm3(true, globalState), if (v7 in v36) then v36[v7] else v37 > v37, v16.cf10, v5[if (v2) then |v38| else |v40|];
				v3 := DC5(v3).cf13;
				var v41: seq<seq<bool>> := [v39, v39];
				var v42: seq<seq<bool>> := [v41[cf9]];
				var v43 := new C8([[v2]] + v42);
				globalState.f21 := v5 == v5;
			case DC0(cf0) =>
				v3[377] := v15;
				v3[377] := v8 % v15;
				globalState.f21, globalState.f21, v3[377] := true, v2, (0x269 - fm2(v2, globalState)) % (v8 / -fm2(v17, globalState));
				...
				var v53: seq<D1> := [DC7()];
				var v55: array<set<D1>> := new set<D1>[24] [v48, v48, v48, v48 + v48, v48, v48, v52[v3[377]], v48, v48, {v47, DC7(), fm21("pgx", v3[377], v2, v3[377], globalState)} * v48, v48, v48, v48, {v47}, v48, v48, v48 + (set v54 : D1 | v54 in v53 :: (v54)), v48, v48 * fm62(globalState), {v47, v47}, v48, v48, fm62(globalState), v48];
				v55 := v55;
			case DC4(cf12) =>
				globalState.f1 := 806;
				...
				var v64: set<map<int, int>> := {if (v3[990] in v63) then v63[v3[990]] else v9, v9};
	...
	var v79 := DC32(v78[v75.f31], |v74|, v75.f31);
		...
		decreases 100 - i9
	{
		...
		v81[588] := v75.fm11(v75.f30, if (v75.f30) then v2 else v75.f30, v5, v83, globalState);
		v79 := v79;
	...
	if (v8 <= v75.f31) {
		...
		v9 := v9[|v93| := v75.f31 / |v94[v75 := v75.f30]|];
		var v95, v96 := v75.m6(globalState);
		v2 := v74 !! v74;
	} else {
		v3[308] := v8;
		var v97: seq<int> := [v75.f31];
		var v98: seq<seq<int>> := [seq(0x23b, i10  => (v8))];
		var v99: seq<seq<int>> := [v97, v98[-|([v75.f30, v75.f30])[v8 := v75.f30]|], v97 + v97, v97[v75.f31 := fm2(!v75.f30, globalState)], fm24(|v12|, v75.f31, 0xef, v5, globalState)];
		v3[308] := |v99|;
		...
		var v106: multiset<bool> := multiset{v2, v75.f30, fm1(v3[308], v75.f31, v11, globalState)};
		var v107: seq<bool> := [v75.f30];
		var v108: map<seq<bool>, bool> := map[v107 := v75.f30];
		globalState.f19, globalState.f25, v7[9], v3[308] := |(if ([v3[308]] in v105) then v105[[v3[308]]] else (seq(0x132, i11  => (v11)))[v75.f31 := v11])|, v75.f31 * 0x28, ((fm36(v106, globalState))[fm2(v75.f30, globalState) := v2] + [v75.f30]) in (v108 + v108), |v5|;
		var v109: map<map<int, int>, multiset<int>> := map[v9 := v71];
		var v111: C3 := new C3(set v110 : map<int, int> | v110 in v109[v9 := v71] :: (v110), v75.f30, v7[9], -942);
		var v112: map<int, C3> := map[760 := v111];
		var v113 := DC17(v75.f30, v75.f30, v75.f30, v75.f31, v3[308]);
		var v114 := DC73(v111);
		...
		v115[391] := v111;
		v115[391] := v111;
		var v116: array<char> := new char[11] [v11, v5[v75.f31], v11, v11, v11, v11, 'r', v11, v11, v11, v11];
		match (DC20(v111.f34, 0xf9, multiset{v116, v116}, v2, v75.f31)) {
			case DC20(cf31, cf32, cf33, cf34, cf35) =>
				var v117: array<bool> := new bool[5] [fm1(if (v2 in v106) then v106[v2] else v3[308], v8, v11, globalState), !v111.f34, v75.f30, cf34, v111.f34];
				...
				var v121 := new C8(v120[v75.f31 := v107]);
				var v122: map<int, bool> := map[cf32 := v107[cf32]];
				v122 := v122[v3[308] - v75.f31 := cf34];
				globalState.f25 := -(if (fm1(v3[308], v75.f31, v11, globalState)) then cf32 else cf32);
			case DC19(cf30) =>
				var v123: C1 := new C1(v73, v111.f34, v3[308]);
				v123 := v123;
				v111.f34, v107, v2, v7[9] := v75.f31 >= |v107|, [fm1(v75.f31, v3[308], v11, globalState), v111.f34] + v107, v75.f30 ==> !v75.f30, !v75.f30;
				globalState.f24 := v75.f31;
				var v124: array<map<bool, int>> := new map<bool, int>[6];
				var v125 := DC14(v3[308]);
				var v126: map<char, multiset<bool>> := map[v11 := v106];
				v124[9] := ((map[v75.f30 := v125.cf20])[v111.f34 := |(if (v11 in v126) then v126[v11] else multiset(v107))|])[v75.f30 := v75.f31];
				var v127: map<bool, int> := map[v111.f34 := v75.f31];
				v7[9], v124[9], v2 := v7[9], v127, v75.f30 ==> v2;
		}
	...
	v5 := (v5 + v5)[v8 := v11];
	globalState.f25 := v8;
	var v131: T0 := new C4(v8, DC34(!v75.f30, v75.f30, v2).cf59, v75.f31 % v8);
	v131 := v131;
	...
	var v139 := DC38([v2, v75.f30] + v138[0x3a1]);
	v139 := v139;
	v3[686] := v75.f31 + v131.f27;
	v3[686] := v8;
	var v140: seq<int> := [fm2(v75.f30, globalState)];
	v8 := v140[v75.f31];
	v3 := v3;
	v3[686] := v131.fm6(multiset{false, v2}, globalState);
	match (DC41()) {
		case DC41() =>
			var v141: array<seq<bool>> := new seq<bool>[5];
			var v142: C5 := new C5(v3, v75.f30, 0x3dd);
			var v143: map<C5, seq<bool>> := map[v142 := v137];
			v141[847] := (if (v142 in v143) then v143[v142] else v138[v75.f31]) + v137;
			v141[847], v131, globalState.f21 := v137[v75.f31 := !true], v131, v137 < v137;
			globalState.f15 := (seq(0x170, i13  => (v11))) + (v12[|v141[847]|] + v5);
		...
		case DC42(cf72, cf73, cf74) =>
			...
			v148[879] := v149;
			v148[879] := v149;
			v7 := if (v75.f31 != cf72.fm6(cf74, globalState)) then v130[140] else v130[140];
			var v150: map<seq<int>, int> := map[v140 := v131.f27];
			var v151 := new C6(|v150|, v75.f31 < cf73, v8 + v131.f27);
			var v152 := DC56(v75.f30 <== v2);
			v3[686], v152, globalState.f21, globalState.f24, cf73 := v151.fm7(v75.f30, globalState) - cf73, v152.(cf94 := v2), v2, v131.f27 % v131.f27, (if (v2 in cf74) then cf74[v2] else cf73) * (if (v137[|v140|]) then cf72.f27 else v131.f27);
		case DC43(cf75, cf76) =>
			v130[140][79] := v75.f30;
			v130[140][79] := v2;
			if (v5 == v5) {
				v140 := fm24(v3[686], -v75.f31, fm2(v130[140][79], globalState), v5 + (seq(311, i14  => (cf75))), globalState);
				...
				v3[686] := v155.cf73 + (v131.f27 - v131.f27);
				var v156 := DC36(|v5|, v2, v75.f30, false, v75.f30);
				globalState.f21 := v137[v156.cf61 + v131.f27];
				var v157: array<D10> := new D10[27];
				v157[835] := DC28(map[v3 := v2]);
				var v158: map<array<int>, bool> := map[v3 := v130[140][79]];
				var v159 := DC28(v158);
				v157[835] := if (v130[140][79]) then DC28(v158) else if (v75.f30) then v159 else DC28(v158);
			} else {
				globalState.f25 := 283;
				var v160, v161, v162, v163 := v131.m4(globalState);
				v2 := v137[v75.f31];
				v74 := {if (!v130[140][79]) then v75.f30 else v75.f30};
				var v164 := DC2(v131.f27, v5, v3[686]);
				var v165 := DC4(v164);
				v165 := v165;
			}
			
			var v166 := new C1(v73, v75.f30, v8 / v8);
			globalState.f25 := v131.f27;
		case DC40(cf71) =>
			var v167: multiset<bool> := multiset{v2, v2};
			globalState.f21 := !((v167[fm1(|v4|, v3[686], v11, globalState) := |v74|])[true := |v5|] < v167);
			...
			var v172: map<D22, array<T0>> := map[DC58(v75.f31, seq(0x2dc, i16  => (v11)), v131.f27) := v168];
			var v173: map<bool, string> := map[v75.f30 := v5];
			var v174: seq<array<T0>> := [v168, v168, v168];
			var v175: array<array<T0>> := new array<T0>[22] [v168, v168, v168, v168, v168, v168, v168, v168, v168, v168, v168, v168, v168, v168, if (v169 in v170) then v170[v169] else if ((seq(0x2e1, i15  => (v11))) in v171) then v171[seq(0x2e1, i15  => (v11))] else v168, if (DC58(v131.f27, if (v75.f30 in v173) then v173[v75.f30] else v5, |v137|) in v172) then v172[DC58(v131.f27, if (v75.f30 in v173) then v173[v75.f30] else v5, |v137|)] else v168, v168, v168, v168, v168, v168, v174[0x2e0]];
			v175 := v175;
			v8 := 0x39d;
			var v177: map<map<int, bool>, int> := map[map v176 : int | (-728 <= v176) && (v176 < 686) :: (v176 * v131.f27) := (v75.f30) := |v9|];
			globalState.f19, v3[686] := -(|(v177 + map[map v178 : int | (0xe1 <= v178) && (v178 < 0x172) :: (v178 % v75.f31) := (v2) := v131.f27])| % (v3[686] - v131.f27)), v75.f31;
		case DC44(cf77) =>
			globalState.f21 := v137[|v140| + v3[686]];
			var v179: multiset<char> := multiset{v11};
			var v180: set<int> := {|v140|, 774};
			v8 := |(v140[|v137| := if (v11 in v179) then v179[v11] else |v137|])[v75.f31 := |v180|]| % (v75.f31 + v75.f31);
			v11 := v11;
