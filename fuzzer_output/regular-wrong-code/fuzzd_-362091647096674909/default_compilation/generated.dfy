...
function fm0(p0: bool, p1: int, globalState: GlobalState): int {
	-0x2e3 % (if (false) then 0x79 else |multiset{false}|)
}
function fm1(p0: bool, globalState: GlobalState): string {
	("cww" + "g") + (if (true) then "iekbdyjkt" else seq(-0x28d, i0  => ('c')))
}
...
function fm21(p0: set<bool>, p1: multiset<int>, globalState: GlobalState): seq<string> {
	[seq(0xe6, i0  => ('c')), "vtjpii"] + ["nnq"]
}
function fm27(p0: bool, p1: bool, globalState: GlobalState): set<seq<D5>> {
	(set v0 : seq<D5> | v0 in {[DC13(|multiset{|"epbtsmm"|, |"upj"|, |(seq(0x1b3, i0  => (-0x2de)))|}|, false, false)], [DC13(|"ju"|, false, true)], [DC13(-703, true, false), DC13(|multiset{'m'}|, true, false)], [DC13(|(seq(0xc2, i1  => ('f')))|, true, true)]} :: (v0)) * {[DC13(-|map[false := 'n']|, true, false)], [DC13(-0x1f9, true, !false)], [DC13(0x3b9, true, false)]}
}
function fm28(p0: string, p1: seq<int>, p2: bool, p3: set<map<bool, int>>, globalState: GlobalState): D0 {
	DC2(!(multiset{|"dhgmuljeq"|} >= multiset([|map[true := |"teghdwfgg"|]|])), |{false}| / |map[false := |[false, true]|]|, if (true) then true else !true)
}
...
function fm30(p0: D2, p1: seq<string>, globalState: GlobalState): set<multiset<int>> {
	{multiset{|(seq(0x3c6, i0  => (-0x2a9)))|}, multiset{-454}, multiset{-0x3cc}, multiset{0x2f4, 0x18f, |(set v0 : map<int, bool> | v0 in {map[|[|(seq(0x14, i1  => (|[|"umygtlqs"|, 0x1f7]|)))|]| := false]} :: (v0))|}, multiset{817, |map[!!true := true]|}} * ({multiset{529, 0x39e}} + (set v1 : multiset<int> | v1 in [multiset{--43}, multiset{|[false, false]|}] :: (v1)))
}
function fm31(p0: bool, p1: bool, p2: bool, p3: D0, globalState: GlobalState): seq<multiset<int>> {
	[multiset([|[DC60(multiset{|(map v0 : int | (0x22a <= v0) && (v0 < 0x27a) :: (v0 + 0x2c3) := (!false))|})]|, |DC67(map[|[!true, true]| := seq(0x319, i0  => (-|['j', 'q', 'v']|))]).cf111|]), multiset{|"iytbot"|} * multiset{|(map v1 : int | (0x251 <= v1) && (v1 < -0x96) :: (v1 * 680) := (0x227))|}, multiset(seq(-0x2dc, i1  => (|map[!true := !false]|)))]
}
...
function fm42(p0: bool, p1: int, globalState: GlobalState): multiset<int> {
	(if (false) then multiset{898, |(seq(-0x308, i0  => ('d')))|} else multiset{0x33b}) * multiset{-0x22}
}
...
function fm44(p0: int, globalState: GlobalState): D4 {
	if (false) then DC10(seq(0x246, i0  => ('n'))) else DC10(seq(370, i1  => ('n')))
}
function fm45(p0: bool, p1: D2, p2: int, globalState: GlobalState): seq<int> {
	(seq(0x3d6, i0  => (|['r']|))) + ((seq(0x59, i1  => (|"kqu"|))) + [|"ehybm"|, |(seq(0x1e5, i2  => (588)))|])
}
...
function fm47(p0: int, globalState: GlobalState): map<int, seq<int>> {
	map[|[map[542 := false]]| % 0x18c := [-0x3ab, -|[false, false]|]]
}
...
function fm51(p0: map<map<bool, bool>, seq<bool>>, p1: int, p2: int, p3: bool, globalState: GlobalState): set<map<int, int>> {
	set v2 : map<int, int> | v2 in ((map v0 : map<int, int> | v0 in [map v1 : int | (297 <= v1) && (v1 < 0x3a8) :: (v1 % -0x362) := (|multiset{|[0x124]|, |map[false := false]|}|), map[|multiset{false}| := DC23(!true, -234, map[true := true], DC14(false)).cf37]] :: (v0) := ("ccyc")) + map[map[|[true]| := 0x3cd] := seq(-0x1cd, i0  => ('n'))]) :: (v2)
}
...
function fm53(globalState: GlobalState): set<string> {
	{"ttv", "ctxpl", "ljm"} + {seq(505, i0  => ('p'))}
}
function fm54(p0: set<bool>, globalState: GlobalState): set<set<int>> {
	set v2 : set<int> | v2 in (map v0 : set<int> | v0 in [{|[false]|}, {|(map v1 : int | v1 in {|(seq(0x201, i0  => ('p')))|, |map[true := 47]|} :: (v1 * 666) := (!true))|}, {0x128}, {|[false, !true]|}] :: (v0) := ("bgfnoiq")) :: (v2)
}
...
function fm56(p0: bool, p1: int, globalState: GlobalState): map<int, bool> {
	(map v0 : int | v0 in map[784 := |multiset{[-0x13], [0x1ac], [|{true, true, false}|, |{false}|, 437]}|] :: (v0 / 0x245) := (true)) + (map[|multiset{false, true}| := true] + map[|(map v1 : int | v1 in {|multiset{true}|, |(set v2 : int | v2 in map[0x58 := true] :: (v2 * --|[|"ss"|]|))|, |"wqn"|, |"dltidiom"|, 399} :: (v1 * |(seq(0xb9, i0  => ('p')))|) := (multiset{148, |map[false := false]|, 10, 0x32d, -879}))| := true])
}
...
function fm60(p0: bool, globalState: GlobalState): seq<seq<int>> {
	([seq(0xdb, i0  => (0x1e6))] + (seq(449, i1  => (seq(0xab, i2  => (-574)))))) + ([seq(78, i3  => (0x151))] + (seq(974, i4  => ([-0xb9, |multiset{false}|, 0x2de, |(seq(0x391, i5  => (0x30d)))|, -302]))))
}
function fm61(p0: int, p1: string, p2: D0, p3: int, globalState: GlobalState): set<seq<int>> {
	((set v1 : seq<int> | v1 in multiset{[|[false, false]|, |(seq(-0xfc, i0  => (|(set v0 : int | v0 in {-448, 0x7c} :: (v0 + 0xd4))|)))|]} :: (v1)) + {[|{|"faysnx"|, -0x3b, |(seq(-0x8d, i1  => ('x')))|, |map[false := true]|, 494}|, |[|[|[-0x304, |(seq(-0x1de, i2  => ('t')))|]|, |"qs"|, 0x3e3]|]|]}) - ({[0x58], [|{false, true, false}|], [|multiset{false, true, false, false}|], [-0x2c7, |[true]|, |"eavsgwtj"|], [-|map[map['j' := |[true]|] := -0x29]|, 753]} + (set v2 : seq<int> | v2 in map[[837] := DC14(false)] :: (v2)))
}
...
method m0(p0: int, p1: multiset<bool>, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
	...
	if (if (v0 in v1) then v1[v0] else p2 ==> !p2) {
		...
		var v7: map<int, int> := map[|v4| := |v5[-|v6| := false]|];
		...
		var v11: seq<seq<int>> := [v4, v4, seq(0x3d9, i2  => (p0)), v4];
		...
		var v16: array<D1> := new D1[17] [DC5(p3, p3, seq(0x34c, i1  => (v4)), v8, 0x2ad), v13, v13, v13, v13.(cf9 := v11), v13, if (p2) then v13 else v13, if (p2) then v13 else DC5(p0, p3, v11, v8, -p3), DC5(p3, 0x326, v11, v8, p0), DC5(p0, p3, [[|p1|, p3, p0, p3, |v14|]], if (p2 in v15) then v15[p2] else v8, p3), DC5(p3, p3, v11, v8, p0), v13, v13, v13, v13, v13, v13.(cf11 := p3)];
		v16[593] := v13;
		var v17: seq<seq<array<bool>>> := [[v8], v9, v9, v9, v9];
		var v18: map<int, seq<array<bool>>> := map[p0 := v17[p3]];
		var v19 := "tlsyfds";
		v9, v16[593] := v9 + (if (|v19| in v18) then v18[|v19|] else v9), v13;
		var v20 := DC0(p1);
		var v21 := DC0(p1 + v20.cf0);
		match (v21) {
			case DC1(cf1) =>
				var v22 := DC20(seq(0x56, i3  => ('s')), p2, p3);
				var v23: multiset<D9> := multiset{v22};
				var v24 := DC50(v23);
				var v25: map<bool, bool> := map[v5[p0] := p2];
				var v26 := DC14(p2);
				var v27 := DC23(p2, cf1, map[p2 := p2], v26);
				var v28: array<map<bool, bool>> := new map<bool, bool>[15] [map[p2 := p2], map[p2 := p2], v25, v25, v25, v25, v25, v25, v25, v27.cf38, v25, v27.cf38, map[v5[p3] := p2], v25, v25];
				var v29: multiset<string> := multiset{v19};
				var v30 := DC49(v29);
				r0 := cf1 - -DC55(v24, v28, v30, p2, |map[p2 := p2]|).cf89;
				globalState.f13, v26, v19, r0 := p2, v26.(cf23 := v2 <= v2), v19, (p3 - |v5|) / p0;
				v8[212] := !p2 || p2;
				var v31: array<string> := new string[25];
				v19, globalState.f7, r1, v8[212], v31 := (((seq(-0x176, i4  => (v19[p0]))) + v19) + (v19 + "cnqxtfmaj"))[p3 / cf1 := 'q'], cf1 + p0, if (p2) then p2 else p2, p2, v31;
				var v32 := 'q';
				var v33: T1 := new C6(v32, v5[p0]);
				var v34: array<char> := new char[4] [v33.f23, v33.f23, v32, v33.f23];
				v33 := new C10(p2, 872 / p0, v32, p2, v34, fm2(globalState));
			...
			case DC3(cf5) =>
				...
				v53[588] := (set v56 : char | v56 in (map v54 : char | v54 in v55 :: (v54) := (!v51.f24)) :: (v56)) * v55;
				v53[588] := v55;
		...
		r2 := -599 / |fm62(p0, globalState)|;
		r0 := p0;
		var v64: array<bool> := new bool[23];
		v64[7] := false;
		v64[7] := p2;
		var v65: seq<bool> := [!v64[7]];
		...
		var v71: set<bool> := {v64[7], v64[7]};
		var v72: multiset<set<bool>> := multiset{v71};
		var v74: array<int> := new int[29] [p3 * |v66|, |v67|, p3, -0x162, -0x25, p3 % p3, p3, |v68|, 641, |v69| - (if (!v64[7] in v69) then v69[!v64[7]] else p3), p3, |v70|, p0 / p0, if (true) then p3 else -p3, p3, if (v71 in v72) then v72[v71] else 0xb8, p3, p0, p0, p3, p0, p3, p0, p3, p3, -0x1a8, p3, |((set v73 : int | (0x289 <= v73) && (v73 < 0x3e) :: (v73 / 234)) * v67)|, p0];
		v74[319] := p0;
		v74[319], globalState.f7 := p0, p0 * p3;
		var v75: array<set<bool>> := new set<bool>[28];
		v75[809] := v71;
		var v76: seq<set<bool>> := [v71];
		var v77 := 'h';
		var v78: map<bool, bool> := map[v64[7] := p2];
		r1, v75[809] := fm2(globalState), (v71 + v71) * (v76[fm0(p2, |{v77}|, globalState)] - {if (v64[7] in v78) then v78[v64[7]] else v64[7], p2});
	}
	...
	v87[776] := (if (v89 in v90) then v90[v89] else p1) !! p1[p2 := |v92|];
...
class C1 extends T3 {
	...
	function fm9(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState): int {
		-(|multiset{"snfxoe", seq(0x3bd, i0  => ('s')), seq(-0x2b4, i1  => ('h'))}| * |multiset{f39, f27, f27}|) / 934
	}
	...
	function fm33(globalState: GlobalState): int {
		506 % |((set v0 : D5 | v0 in [DC14(f39)] :: (v0)) + {DC14(f39), DC14(f27)})|
	}
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool) {
		var i0 := 0;
		while (true)
			decreases 100 - i0
		{
			...
			if (f39) {
				...
				var v4: map<bool, string> := map[f39 := ("dr")[v1 := 'h']];
				var v5 := DC6(v4);
				var v6: map<D2, bool> := map[v5 := p0];
				var v7: map<int, bool> := map[v1 := true];
				var v8 := "nubq";
				var v9: map<bool, bool> := map[f39 := p0];
				var v10: array<int> := new int[18] [v1, v1, |v2| % fm33(globalState), |v3|, |v6|, -|multiset{if (0x1e3 in v7) then v7[0x1e3] else p0}|, |"jovube"|, fm9(v2, v1, f27, globalState), fm33(globalState), v1, v1, v1, v1, -64, |(v8 + v8)|, if (f39) then v1 else v1, |v3|, |v9|];
				globalState.f22 := v10;
				v0 := fm34(v1 - v1, p0, globalState);
				globalState.f7 := v1;
				var v11: set<int> := {v1};
				var v12: seq<set<int>> := [v11];
				var v13: multiset<set<int>> := multiset{{v1}, v12[v1], {v1}, v11, fm35(f27, globalState)};
				v2 := (([|"hrwmpm"|, v1] + v2) + ([fm9(v2, v1, f27, globalState), v1, |v7|] + [|v13|, v1]))[v1 - fm9(v2, |("ulr")[v1 := v0]|, p0, globalState) := |v2|];
				v1 := -v1;
			} else {
				var v14 := 0x2bb;
				var v15: seq<int> := [v14];
...
class C2 extends T2 {
	...
	function fm7(globalState: GlobalState): seq<int> {
		[|[f24]| / |[f24]|, |({!f24, f24} + {f24})|, 0x3e6 + 0x366]
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): map<bool, string> {
	...
	function fm24(p0: int, p1: bool, globalState: GlobalState): int {
		-|(({-|"l"|} + (set v0 : int | (0x248 <= v0) && (v0 < -980) :: (v0 % 0x3d6))) + DC12({|map[f24 := |"jayht"|]|}).cf19)|
	}
	...
	method m3(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		match (v2) {
			case DC13(cf20, cf21, cf22) =>
				...
				v4 := v4[if (v5[fm0(f24, v0, globalState)]) then cf21 else cf22 := -|v5|];
			...
			case DC14(cf23) =>
				...
				var v8: seq<bool> := [f24];
				var v9: array<bool> := new bool[12] [p0, p0, cf23, p0, cf23, p0, v0 != -v0, f24, fm2(globalState), if (true) then fm4(v0, v8[-415 := p0], globalState) else p0, p0, if (cf23) then f24 else p0];
				v9[32] := true;
				v9[32] := f24;
				var v10 := "yf";
				var v11: seq<int> := [v0];
				...
				v9 := (v13.(cf9 := v12, cf10 := v9, cf7 := v0).(cf8 := v11[|(seq(-0x107, i0  => (v0)))|], cf7 := v0)).cf10;
				v10 := v10[v0 := f23];
			case DC12(cf19) =>
				globalState.f13 := f24;
				var v14: seq<bool> := [f24, !p0];
				var v15: array<bool> := new bool[21] [p0, p0, fm2(globalState), f24, p0, p0, p0, v14[v0], f24, p0, !f24, false, f24, false, f24, p0, f24, f24, !p0, f24, !false];
				...
				var v18 := "t";
				v16[261][146] := p0 && p0;
				var v19: set<seq<bool>> := {v14[v0 := f24]};
				v18, v16[261][146] := "eeheeq", {v14} != v19;
		}
		
		var v20 := "mcs";
		var v21: map<int, bool> := map[v0 := false];
		var v22: seq<int> := [|v20|, |v21|];
		var v23: seq<seq<int>> := [seq(-728, i2  => (DC11(v0).cf18)), v22];
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v28: seq<string> := [v20[v0 := f23], v20];
			if (v28[v0] == v20) {
				globalState.f13 := f24;
				v22 := v22;
				...
				v29[9] := v0;
				v29[9] := 553;
				var v30: map<bool, int> := map[f24 := v29[9]];
				var v31: map<map<bool, int>, bool> := map[v30 := p0];
				v31 := v31[v30 := v0 != |v22|];
				r0 := (v0 + v0) > (v29[9] - fm24(0x3cf, f24, globalState));
			} else {
				...
				v33[939] := |fm1(p0, globalState)|;
				v33[415], r0, v34, globalState.f7, v33[939] := v0 + (v0 - v0), f24, v34, |v20|, v0;
				var v35: map<string, int> := map[seq(389, i4  => ('u')) := 0x1d8];
				v35 := v35["cjl" := v33[415]];
			}
			...
			if (!!p0) {
				...
				v38, v40, v43, v44[306] := v38, map[v0 < |v46| := v0 - v0], v43, v45;
				v0 := v0;
				globalState.f7 := v0;
				...
				v47[359] := v49;
				r2, v47[359] := p0, (if (fm2(globalState)) then (v49[v48 := |v46|])[v48 := v0] else v49) + v49;
			}
		...
		v52[944] := multiset{v0} * v54;
		v52[944] := multiset(v22) * v54;
	...
	method m12(p0: array<map<bool, bool>>, p1: int, globalState: GlobalState) returns (r0: int, r1: string, r2: int) {
		...
		match (v2) {
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				var v3: seq<int> := [cf11];
				var v4: set<int> := {cf7, -p1, v3[cf11]};
				cf11, globalState.f7, globalState.f13 := fm0(f24, cf7, globalState), -|v4| / |v1|, p1 < -cf8;
				...
				match (fm28(v0, v3, v1[|v0[|v0| := f23]|], v10, globalState)) {
					case DC1(cf1) =>
						var v11 := new C0(v7, DC2(true, cf7, f24).cf4, f23, f24);
						var v12: seq<array<bool>> := [cf10];
						var v13: map<int, array<bool>> := map[fm0(v11.f38, cf8, globalState) := v12[|v4|]];
						v13 := v13[v3[cf11] := cf10];
						var v14: map<int, int> := map[|v0| := cf11];
						v14 := v14[0x34b - p1 := 0x1da];
						var v15: map<int, seq<bool>> := map[|v9| := v1];
						v15 := v15[-cf8 := v1 + v1];
					case DC2(cf2, cf3, cf4) =>
						globalState.f7 := (cf7 + cf11) % cf7;
						globalState.f7 := cf3;
						var v16: map<int, int> := map[p1 := cf11];
						f23, v16 := if ((v5.(cf4 := cf2, cf3 := p1)).cf4) then f23 else fm29(cf3, cf4, cf2, cf11, globalState), (map v17 : int | v17 in v3 :: (v17 % cf3) := (cf11)) + (v16 + map[cf8 := cf11]);
						r1, f23 := v0 + (v0 + v0)[cf8 := 'v'], f23;
					case DC0(cf0) =>
						v0 := v0[cf8 := 'a'];
						var v18: array<int> := new int[11](i1 => i1 * |{v2.cf6, f23}|);
						globalState.f7, globalState.f13, globalState.f7, globalState.f22 := -cf8 * -(cf11 % cf11), false in (v1 + v1), cf7 - -cf7, v18;
						var v19 := DC7(f24, f24);
					...
					case DC3(cf5) =>
						...
						var v26 := DC12({p1});
						var v27: array<int> := new int[15] [|("ogv" + v0)|, cf8, |v4|, |"mcybk"|, |v26.cf19| + (if (cf7 in v24) then v24[cf7] else |v0|), 0x114, cf8, |v3| + (if (v1[|v3|] in v9) then v9[v1[|v3|]] else p1), p1, cf7, p1, -(p1 + p1), fm0(false, cf8, globalState), cf11, |DC10(v0).cf17|];
						v27[36] := p1;
						var v28 := DC13(cf11, true, f24);
						cf10[578] := (v28.(cf21 := f24)).cf21;
						var v29: map<bool, array<bool>> := map[f24 := cf10];
						var v30: set<bool> := {f24};
						v25, v27[36], cf10[578] := fm31(f24, !f24, f24, v5, globalState), (cf7 / cf7) * (|v29| - cf11), v30 !! (v30 * {v1[cf8]});
						var v31: array<string> := new string[8];
						v31[445] := v0;
						v31[445] := "qxxltvc";
						var v32: map<multiset<int>, int> := map[v24 := cf11];
						var v33: map<int, int> := map[cf11 := cf11];
						v32 := v32[v24 := fm0(!cf10[578], |v33|, globalState)];
				}
			...
			case DC4(cf6) =>
				match (DC7(f24, f24)) {
					case DC7(cf13, cf14) =>
						...
						var v40: array<seq<bool>> := new seq<bool>[18] [v1, if (cf13) then v1 else [v37.f27], v1, v1, v1, v1, v1, v1, v1, [v37.f27, f24] + [cf14], ([f24])[p1 := v37.f27], [fm2(globalState)] + v1, [true, cf13] + v1, v1, v1 + v1, fm36(globalState), v1, v1 + [v37.f27]];
						...
						v40, globalState.f13, v45 := if ((675 / p1) in v46) then v46[675 / p1] else v40, true, v45;
					case DC6(cf12) =>
					...
					case DC8(cf15) =>
						...
						var v52: array<int> := new int[16] [p1, -p1, p1, p1, if (f24 in f36) then f36[f24] else -0x1e9, |v49|, p1, p1, fm0(true, |v0|, globalState), 0x211, if (map[f24 := true] in v51) then v51[map[f24 := true]] else 0x1bc, p1, -|multiset{v1[p1]}|, p1, p1, p1];
				...
				v62[249] := v0;
				var v63 := DC10(v0);
				v62[249] := (if (f24) then v63 else v63).cf17;
				if (fm2(globalState)) {
					var v64: array<int> := new int[23](i3 => i3 / p1);
					var v65: map<int, array<int>> := map[p1 := v64];
					v65 := v65[p1 := v64];
					globalState.f13 := v61.f39 !in f36;
					var v66: array<bool> := new bool[24];
					var v67: set<int> := {p1};
					v66[1] := !v61.fm32(v61.f39, |v67|, globalState);
					var v68: seq<string> := ["sn", v62[249]];
					globalState.f13, r2, r1, v66[1], globalState.f7 := v61.f39, p1 % p1, v68[|v0|], p1 <= p1, p1;
					...
					v66[1] := if (v66[1]) then f24 else v70 >= v70;
				} else {
					globalState.f13 := if (v62[249] == v62[249]) then v1[p1] else !f24;
					...
					var v75: seq<int> := [p1];
					var v76: seq<int> := [-v75[p1]];
					v73, globalState.f13, globalState.f13, r2, globalState.f13 := v73, v61.f39, f24, -(p1 * (|v74| % v76[p1])), true;
				}
		...
		if (f23 in v0) {
			...
			var v83 := new C0(v82, !f24, v0[-0x1b7], p1 >= |v0|);
			...
			var v88 := DC6(v82 + v82);
			v88 := v88;
			var v89: seq<int> := [-|(seq(-0x2a6, i8  => (0x22c)))|];
			...
			if (if (v93 in v94) then v94[v93] else v78.f27) {
				...
				globalState.f7 := -(p1 * |v96|) / p1;
				var v97: set<bool> := {v78.f27, v78.f27};
				v95 := v95[|v97| := v96 == [|"vbav"|, p1, |v97|]];
			} else {
				var v98: seq<string> := [v0, v0, (v0 + v0)[p1 := f23], v0 + v0];
				r1 := v98[p1];
...
class C3 extends T2 {
	...
	function fm7(globalState: GlobalState): seq<int> {
		if (f24 || false) then seq(0x39e, i0  => (|"er"|)) else [278]
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): map<bool, string> {
		map[false := "n"] + map[f24 := "f"]
	}
	function fm4(p0: int, p1: seq<bool>, globalState: GlobalState): bool {
		(538 - |(seq(0x3b3, i0  => (f23)))|) <= |(if (f24) then {"qkrmexiw"} else {"aaucpfakq", "hrrodm", "qgsjiaqub"})|
	}
	method m3(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		var v0 := 331;
		globalState.f7 := v0 - v0;
	...
	method m11(p0: bool, globalState: GlobalState) returns (r0: bool, r1: char, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			match (v0) {
				case DC13(cf20, cf21, cf22) =>
					...
					globalState.f7 := |(v2 + v3[|(seq(0x2b2, i1  => (f23)))|])|;
					f23 := f23;
				...
				case DC12(cf19) =>
					...
					var v13: seq<int> := [v1];
					var v14 := "cemw";
					var v15: map<int, int> := map[v1 := -v13[fm0(p0, |v14|, globalState)]];
					var v16: map<bool, int> := map[v12 > v12 := |v15|];
					v16 := v16[p0 := v1];
					var v18 := DC9(v15 + (map v17 : int | v17 in v13 :: (v17 / v1) := (v1)));
					v18 := v18.(cf16 := v15);
					var v19: seq<bool> := [p0];
					var v20 := DC0(multiset(v19));
					var v21: map<bool, bool> := map[p0 := f24];
					var v22: array<bool> := new bool[26] [p0, v1 < fm0(!f24, v1, globalState), f24, v19 < v19, f24, p0, f24, !false, p0 || p0, p0, f24, p0, v20.cf0 !! multiset{p0, f24}, |v21| <= |v21|, p0, fm2(globalState), p0, p0, v19[v1], p0, f24, f24, |v14| == v1, p0, f24, f24];
					var v23: map<int, bool> := map[-0x244 := f24];
					v22[140] := if (|v13| in v23) then v23[|v13|] else !f24;
					v22[140] := f24;
		...
		var v28 := "plwsf";
		var v29 := 0x29d;
		var v30: array<string> := new string[24] [v28, v28, v28, v28, v28, v28, v28, v28, v28, seq(0x306, i4  => (f23)), v28, v28, v28, v28 + (seq(-90, i5  => (f23)))[v29 := f23], v28, v28 + v28, seq(0x1b7, i6  => ('g')), seq(0x301, i7  => (f23)), if (f24) then "lti" else v28, v28, v28, v28, v28, v28];
		var v31: seq<bool> := [p0];
...
class C4 extends T2 {
	...
	method m3(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		if (p0) {
			...
			var v1: multiset<bool> := multiset{!f24, p0, v0[f33]};
			...
			match (DC6(v6)) {
				case DC7(cf13, cf14) =>
					...
					cf13, v0, v9, globalState.f7 := cf14, [cf14, v4.f39], map v10 : int | (0x1c4 <= v10) && (v10 < 0x2ce) :: (v10 / f33) := (|{cf13, v4.f39}| + |v3|), f33 - (|map[false := v12]| + |(seq(662, i0  => (f33)))|);
					...
					v16[257] := v2.fm25(cf13, globalState);
					var v17: multiset<int> := multiset{f33};
					var v18: set<multiset<int>> := {v17, v17, fm42(f24, |v5|, globalState)};
					v14, v15, globalState.f13, globalState.f13, v16[257] := v14 + v14, v15, v4.fm32(cf13, f33, globalState), !(v18 <= (set v19 : multiset<int> | v19 in map[v17 := f33] :: (v19))), v0;
					var v20: array<bool> := new bool[20];
					v20[360] := v4.f39;
					globalState.f7, v20[360] := f33 / -(-f33 - f33), v4.f39;
					r0 := true;
				case DC6(cf12) =>
					r2 := p0;
				...
				case DC8(cf15) =>
					...
					r0 := v4.f39;
					var v29 := new C2(v1[v4.f39 := f33], f25, 'f', v5 < "i");
			}
			...
			globalState.f22, r1, v30, r1 := v32, f33, v30, ((if (f33 in v34) then v34[f33] else -963) * |v35|) % f33;
		...
		if (p0 || p0) {
			...
			var v44 := "jp";
			var v45: multiset<string> := multiset{seq(13, i2  => (f23))};
			var v46: map<string, multiset<string>> := map[v44 := v45];
			v46 := v46[v44 := v45];
			var v47: seq<bool> := [false, p0, !f24, f24];
			var v48: map<bool, bool> := map[f24 := f24];
			var v49: array<bool> := new bool[28] [f24, p0, p0, p0, p0, f24, p0, p0, p0, f24, p0, !v47[f33], p0, f24, f24, false, f24, p0, true, if (true in v48) then v48[true] else true, f24, v47[-f33], fm4(f33, v47, globalState), p0, false, f24, f24, true];
			var v50: map<array<bool>, char> := map[v49 := f23];
			var v51: set<char> := {v44[f33], f23};
			...
			v63[144] := f33 == -f33;
			var v64: seq<bool> := [p0];
			globalState.f13 := v64[f33 / f33];
			var v65 := m10(v63[144], globalState);
		}
		...
		for i3 := f33 to fm0(f24, f33, globalState) {
			if (i3 > i3) {
				...
				v73[53] := fm23(f33, v74, v66, globalState);
				v73[53] := fm23(i3, v74, v66 + v66, globalState);
				...
				var v78 := "jctwmpljq";
				v78 := v78 + v78[-|[p0, p0, f24, true, p0]| := f23];
				...
				var v82 := DC0(v81);
				v80[918] := v82;
				v80[918] := fm43(p0, f24, p0, globalState);
	...
	method m10(p0: bool, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := f33 to f33 {
			...
			globalState.f13 := !p0;
			var v3: seq<bool> := [f24];
			var v4: multiset<seq<bool>> := multiset{[v2[772]] + v3};
			v4 := v4;
		}
		var i1 := 0;
		while (f33 == f33)
			decreases 100 - i1
		{
			...
			v12[225] := fm7(globalState);
			v9[677] := f33 + f33;
			var v13 := "xfjecqwws";
			v12[225], globalState.f7, v9[677] := v6, (0x1f2 - -|{f33, |v13|}|) % (-0x3b + f33), f33 % f33;
		}
		r0 := f33;
		var v14: multiset<bool> := multiset{p0};
		r0 := --((if (f24 in v14) then v14[f24] else f33) / f33);
	}
}
...
class C5 {
	...
	method m8(globalState: GlobalState) returns (r0: array<bool>) {
		...
		var v4: map<int, string> := map[|[v0, v0, v0]| := seq(-0x270, i0  => ('r'))];
		globalState.f13 := v3[|(if (v2 in v4) then v4[v2] else "rnfuhyqq")| := v2] > (fm18(globalState) - v3);
		var v5: set<int> := {0xa4};
		...
		for i1 := v2 to v2 {
			if (v0) {
				...
				var v9 := 'k';
				var v10: array<int> := new int[6] [v2, fm0(v0, v2, globalState), fm17(|v7[|v8| := v9]|, 'g', fm2(globalState), globalState), i1, i1 - i1, fm0(v0, i1, globalState)];
				v10[716] := 0x1c6;
				v10[716] := fm17(i1, v9, v0, globalState) / i1;
				globalState.f7 := i1;
				var v11: map<bool, bool> := map[v0 := v0];
				var v12: map<map<bool, seq<bool>>, map<bool, bool>> := map[map[v0 := v1[i1 := v0]] := v11 + fm19(globalState)];
				var v13: map<bool, seq<bool>> := map[v0 := v1];
				v12 := v12[if (v0) then v13 else v13 := v11];
				f32[295] := v0;
				var v14: seq<int> := [v10[716], -537];
				f32[295] := multiset{v14} > multiset{v14, v14};
				globalState.f7 := v10[716];
			} else {
				var v15 := m9(-814 <= v2, v0, globalState);
				globalState.f13 := v0;
				globalState.f7 := v2;
				var v16: seq<int> := [v2, v2];
				globalState.f7 := fm0(false, i1 / |v16|, globalState);
				var v17: array<seq<int>> := new seq<int>[29] [seq(-0x170, i2  => (i1)), [i1, i1, v2], seq(182, i3  => (v2)), v16, v16, v16, v16, v16, [v2, i1], seq(-0x285, i4  => (-v2)), seq(14, i5  => (i1)), v16, v16, v16, v16, v16, v16, v16, v16, [i1, v2], v16, v16, v16, v16, [i1], v16, [|v1|, v2], v16, v16];
				...
				v21, globalState.f22, globalState.f7, globalState.f13, v22 := v21, v23, -((v2 % i1) % i1), v0, v22;
			}
		...
		v26[505], v31, globalState.f7, globalState.f13, globalState.f7 := v2, v30, v2 + |(if (v0) then v1 else [v0])[-v2 := v0]|, v0, v2 / (v2 * 304);
		globalState.f13 := v0;
		r0 := f32;
	}
	method m9(p0: bool, p1: bool, globalState: GlobalState) returns (r0: array<array<int>>) {
		...
		if (p0) {
			var v5 := 'v';
			var v6: map<bool, string> := map[p1 := ("av")[v3 := v5]];
			...
			v5, v9[686], globalState.f13, globalState.f13 := v5, ([p0] + v8) + v8[if (true in v10) then v10[true] else v3 := p1], false, v11 !! v11;
			globalState.f7 := v3;
			if (v7.f38) {
				var v12: seq<int> := [-(v3 / v3)];
				v12 := v7.fm26(|v0|, if (p0) then v9[686] else v9[686], set v13 : int | (0x375 <= v13) && (v13 < 0x3c5) :: (v13 % v3), v7.f38, globalState);
				globalState.f13 := p1;
				...
				var v17: seq<int> := [fm17(v3, v5, v7.f38, globalState) / v3];
			...
			f32[534] := !(if (false) then v3 < |v20| else true);
			f32[534] := f32[534];
			...
			var v23 := DC19(v22);
			v21[497] := v23.cf30;
			v21[497], globalState.f13, globalState.f13, f32[534] := v22, p0, v19.f39, p0;
			if (v20 <= v20) {
				var v24 := new C1(if (p1) then f32[534] else p1, p1);
				globalState.f13 := f32[534] <==> v24.f39;
				globalState.f7 := v3;
				globalState.f7 := v3 + -v3;
				var v25: array<multiset<D6>> := new multiset<D6>[25](i1 => multiset{DC16(map[f32[534] := f32[534]], v19.f39, p1), DC16(map[!p0 := p0], v19.f39, v24.f39)} * multiset{DC16(map[f32[534] := v19.f39], v24.f39, !v19.f39)});
				var v26: map<bool, bool> := map[p0 := p1];
				var v27 := DC16(v26, true, p1);
				var v28: multiset<D6> := multiset{v27, v27};
				v25[840] := v28 + v28[v27 := v3];
				v25[840] := v28;
			} else {
				...
				var v36 := DC10(seq(198, i2  => (v31)));
				var v37: set<int> := {-0x319};
				v36 := fm44(|v37|, globalState).(cf17 := "qrk");
				var v38: map<bool, int> := map[v19.f39 := 899];
				var v39: seq<int> := [|v38|];
				var v40: array<int> := new int[15](i3 => i3 / v3);
				var v41: map<array<int>, string> := map[v40 := (v0[v3 := v31])[v3 := v31]];
				var v42: map<int, map<array<int>, string>> := map[v19.fm9(v39, v3, v19.f39, globalState) := v41];
				v42 := v42[v19.fm9(v39, |(seq(-0x296, i4  => (v3)))|, v19.f39, globalState) := v41];
			}
		...
		for i5 := 56 + 0x1af to if (v3 in v43) then v43[v3] else v3 {
			...
			v44 := v44;
			globalState.f13 := !(((seq(0x23f, i6  => ('k'))) + v0) == v0);
			globalState.f13 := p0;
			v4 := v4 * v4;
		}
		...
		v45[817] := v47;
		v45[817] := if (!p1) then v47 else v47;
		...
		r0 := if ((|v1[-248 := v0]| >= v3) in v52) then v52[|v1[-248 := v0]| >= v3] else v51;
	}
}
...
class C6 extends T1 {
	...
	function fm6(globalState: GlobalState): int {
		|(map[f24 := seq(0xd9, i0  => ('g'))] + map[true := "gt"])|
	}
	function fm4(p0: int, p1: seq<bool>, globalState: GlobalState): bool {
	...
	method m1(p0: char, p1: bool, globalState: GlobalState) returns (r0: string, r1: D0, r2: bool) {
		...
		for i0 := v0 to v0 {
			...
			var v3 := "c";
			globalState.f7 := |v3|;
			globalState.f7, v0 := i0 / v0, v0;
			var v4: seq<bool> := [f24, f24];
			if (if (v2.f38) then if (f24) then !p1 else true else v4[v0]) {
				globalState.f7 := -v0 % (v0 - |v4|);
				var v5: array<bool> := new bool[23];
				var v6: map<array<bool>, int> := map[v5 := v0];
				var v7: seq<map<array<bool>, int>> := [v6, v6];
				var v8: map<bool, int> := map[f24 := |v7[-i0]|];
				...
				globalState.f7 := -(v0 % i0) / (|multiset{v12}| % v0);
				globalState.f7 := i0;
				globalState.f13 := f24;
		...
		var v14: array<int> := new int[23](i2 => i2 % v0);
		var v15: seq<array<int>> := [v14];
		var v16: seq<array<int>> := [v15[v0], v14];
		var v17 := "bniwatogj";
			...
			decreases 100 - i3
		{
			...
			v26 := v26[0x1af := p1];
			var v27: seq<seq<int>> := [seq(0x99, i4  => (-v0))];
			...
			match (v29) {
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					...
					cf10[455] := if (v20.f39 in v30) then v30[v20.f39] else v31 > multiset(v32);
					var v33 := DC22(v14);
		...
		if (v42[0x15e]) {
			...
			globalState.f7 := |((seq(-258, i6  => (p0))) + v17)| / -|v43|;
			v23 := v23;
			v15 := v16;
			v0 := v0;
			...
			v44[245], f23, globalState.f7 := if (fm47(|fm18(globalState)|, globalState) in v47) then v47[fm47(|fm18(globalState)|, globalState)] else v48 > {fm0(p1, v0, globalState)}, 'i', v0;
		} else {
			v0 := |(seq(0x2e8, i7  => ([v0])))|;
			r2, globalState.f7, v42 := v20.f39, v0 * (if (f24) then v0 else -78), v42;
			var v49: array<D6> := new D6[18];
			var v51 := DC15(map v50 : int | (0x147 <= v50) && (v50 < 336) :: (v50 / v0) := (v42));
			v49[738] := v51;
			v49[738] := fm39(v0, globalState);
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		match (DC6(map[f24 := "hin"])) {
			case DC7(cf13, cf14) =>
				...
				var v2 := 0x1e6;
				r2 := v2 <= -v2;
				globalState.f7 := |(seq(0x2c7, i0  => ('b')))[-0x164 := f23]| * -v2;
			case DC6(cf12) =>
			...
			case DC8(cf15) =>
				...
				match (v14.(cf28 := v15[v16])) {
					case DC17(cf28) =>
						...
						v24[24] := v22;
						var v25: seq<int> := [v21];
						v24[527], v20, v24[24] := f24, v20 + [v19], if (v22) then v25 != v25 else true;
				...
				match (v32) {
					case DC7(cf13, cf14) =>
						...
						var v38: seq<int> := [v16];
						var v39: set<bool> := {f24, DC13(v16, v13.f39, v33[v16]).cf21};
						var v40: seq<set<bool>> := [{v13.f39, v13.f39}, v39];
						var v41: array<int> := new int[23] [v16, v16, -v16 % v16, v16, v16, v16, v16, v16, v16 % (if (|v38| in v37) then v37[|v38|] else v16), v16, fm6(globalState), v16 * |v40[v16]|, v16, -v16, v16, v16, v38[v16], |v36|, --v16, v16, v16, -(|map[cf13 := v16]| % v16), v16 + |v30|];
						v41[684] := |v37|;
						...
						var v45: multiset<multiset<map<bool, bool>>> := multiset{v44, v44, (multiset{v43})[v43 := v16], v44, v44};
						v41[684], globalState.f7, globalState.f7 := v16, if (f23 in v42) then v42[f23] else if (v44 in v45) then v45[v44] else v16, (0x335 * fm0(v13.f39, v16, globalState)) * v16;
					...
					case DC6(cf12) =>
						...
						globalState.f22 := new int[19] [v16, 31, v16 + v16, |v48|, v16, if (v16 in v49) then v49[v16] else v16, v16, v16, v16 - v16, v16, v16 / v16, v16 + fm0(v13.f39, v16, globalState), v16, v16, v16 + -v16, v16, v16, fm0(f24, |v50|, globalState), v16];
					...
					case DC8(cf15) =>
						...
						var v59: map<int, string> := map[|(map v57 : int | (0xb7 <= v57) && (v57 < 311) :: (v57 * |(map v58 : int | (-0x9b <= v58) && (v58 < 0x125) :: (v58 / v16) := (v56))|) := (v16))| := (fm1(f24, globalState))[v16 := f23]];
...
class C7 extends T2, T3 {
	...
	function fm7(globalState: GlobalState): seq<int> {
		([0x234] + [|(seq(0x37c, i0  => (f23)))|]) + ([|multiset([f24])|, -|[!f30]|] + (seq(0x3a5, i1  => (0x322))))
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): map<bool, string> {
		DC6(map[f30 := seq(0x4, i0  => (f23))]).cf12 + (map[f24 := "y"] + map[f24 := "sufkeaph"])
	}
	function fm4(p0: int, p1: seq<bool>, globalState: GlobalState): bool {
		0xfc > |[!!f30]|
	}
	function fm9(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState): int {
		--(if (f30) then -0xc8 else -0x62) % (|[|{0x37b}|]| % |map[|"ych"| := |DC9(map[-903 := -0x12a]).cf16|]|)
	}
	...
	method m3(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		v9[97] := if (v10 in v11) then v11[v10] else v0;
		...
		v12[476], v0[567], v14 := if (f30) then if (f30) then v13 else v13 else v13, v1 < 0x48, v14;
		var v15: set<int> := {v1};
		var v16 := DC12(v15 + v15);
		match (v16) {
			case DC13(cf20, cf21, cf22) =>
				var v17: multiset<bool> := multiset{p0};
				r1 := v1 % (|(seq(0x28a, i1  => (0x30)))[cf20 := |{cf20, |v17|, cf20}|]| * v14.fm6(globalState));
				if (!f24) {
					v3 := v3;
					...
					globalState.f13, globalState.f7, globalState.f22, v3[355] := v1 == -cf20, cf20 + fm0(cf21, v1, globalState), if (|v31| in v30) then v30[|v31|] else if (false) then v3 else v3, -v1;
					cf21 := cf20 != v3[355];
				}
				...
				v0[567] := v0[567];
			case DC14(cf23) =>
				v3[191] := v1 % fm0(f24, 0x106, globalState);
				var v32: multiset<bool> := multiset{f24};
				v3[191] := if (false in v32) then v32[false] else v1;
				var v33 := "dqbli";
				v33 := v33 + v33;
				var v34: array<map<int, array<char>>> := new map<int, array<char>>[26];
				var v35: map<int, array<char>> := map[v3[191] := f25];
				v34[383] := v35;
				v34[383] := v35;
				v33 := (fm1(v0[567], globalState))[v3[191] % v1 := v14.f23];
			case DC12(cf19) =>
				var v36: seq<array<bool>> := [v9[97], v0, v9[97], v9[97]];
				v36 := [v0, if (v14.f24) then v36[v1] else v0, v9[97]];
				v0[567] := v14.f24;
				var v37: seq<int> := [v1];
				v37 := v37;
				var v38: seq<bool> := [f24, !f31, v14.f24, f24];
				var v39 := DC11(v1);
				globalState.f13, v1, globalState.f13, r2 := fm4(|"dupgk"| * v1, v38, globalState), v39.cf18, v38[v1], p0;
		}
		
		v6 := v6[v1 := v1];
		if (if (v0[567]) then if (-678 in v10) then v10[-678] else v14.f24 else p0) {
			globalState.f7 := v1;
		...
		r0 := {v53[|v54|], multiset{v14.f24}} !! (set v55 : multiset<bool> | v55 in multiset(v53) :: (v55));
		var v57: set<D5> := {DC12(set v56 : int | (-0x29c <= v56) && (v56 < -0x1fa) :: (v56 - |(seq(0x3b4, i2  => ('f')))|)), v16};
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			var v5 := 0x39c;
			var v6: seq<bool> := [f24];
			v3[47] := v4[fm0(f27, v5, globalState) * |v6| := f23];
			var v7: seq<int> := [fm0(true, v5, globalState)];
			var v8: seq<int> := [v7[|v7|]];
		...
		if (f31) {
			...
			match (v18) {
				case DC21(cf34) =>
					...
					var v25: map<int, int> := map[v14 := v13[360]];
					v14, v14, globalState.f13 := fm9(v21, v13[360], v15.f39, globalState), |v24| - v14, f31 || (-v13[360] !in v25);
					var v26: map<char, int> := map[f23 := v13[360]];
					globalState.f7 := |v26| * (v14 / v14);
					globalState.f7 := v13[360];
			}
			...
			if (v28 > |v29|) {
				...
				v37[26] := |(v38 + (set v40 : int | v40 in v39 :: (v40 % 0x141)))|;
				v37[26] := v28;
				...
				var v45: map<char, bool> := map[v29[v28] := v44 < v44];
			...
			var v59: array<C3> := new C3[27] [v55, v55, v55, v55, if (v28 in v57) then v57[v28] else v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v58[v28], v55, v55, v55, v55, v55, v55, v55, v55, v55, v58[v28], v55, v55];
			v59[936] := v55;
			v59[936] := v55;
			var v60 := DC7(p0, p0);
			...
			if (DC10(fm1(p0, globalState)).cf17 !in (map v62 : string | v62 in v63 :: (v62) := (DC20(v29, p0, v28).cf31))[v29 := v29]) {
				...
				var v75: array<map<bool, char>> := new map<bool, char>[8] [v70[f24 := f23], v71.cf44, v70[f27 := f23], map[v74[v28] := f23], v70, v70, v70, v70];
				var v76: array<int> := new int[15];
				var v77: seq<array<map<bool, char>>> := [v75, v75, v75, v75, v75];
				var v78: map<array<int>, array<map<bool, char>>> := map[v76 := v77[v28]];
				var v79 := DC30(v75);
		...
		v90[317] := v87;
		var v91 := "oaniuldr";
		var v92: map<bool, string> := map[f30 := v91[v87 := f23]];
		globalState.f13, v90[317] := v92 == (v92 + v92), v87;
		r0 := f27 && f24;
	}
	method m7(p0: int, p1: bool, globalState: GlobalState) {
		...
		}, if (v1) then (seq(0x2e8, i0  => ('t')))[v2 := f23] else v4 + v4;
		for i1 := p0 to p0 + v2 {
			var v7: map<int, bool> := map[if (p1) then v0 else p0 := !f27];
			var v8: seq<bool> := [p1, f27];
			var v9: seq<bool> := [false, fm4(p0, [f30], globalState), v8[v2], f30, f27];
			v7 := v7[v2 / v2 := |v9| >= v0];
			v1 := p1;
			globalState.f13 := p1;
		...
		for i2 := 743 to DC2(!v1, v0, v1).cf3 / v2 {
			if (!(v5 > v5)) {
				...
				var v26: array<int> := new int[17] [|v4|, p0, -i2 - 862, v2, 788 * |v24|, if (f24 in v24) then v24[f24] else p0, -929, p0, i2, -0x3b, |(seq(851, i3  => (f23)))| + v0, v2, p0 - -i2, p0, --v2, p0, if (v2 in v25) then v25[v2] else v0];
				v26[816] := v0;
				v26[816] := if (!v14.f24 in v24) then v24[!v14.f24] else -v17[0x163];
				...
				var v31 := new C0(v29[f30 := seq(0x2d8, i4  => (v14.f23))] + map[p1 := v4], v0 >= |v30|, v14.f23, f24);
			}
...
class C8 extends T3 {
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool) {
		if (f27) {
			...
			var v5 := 0x39;
			globalState.f13 := v3 != (v4[v5] + {0x27f, v5});
			var v6 := 'y';
			v6 := v6;
			...
			var v13: seq<seq<bool>> := [v12[|v2| := f27]];
			v8, globalState.f7, globalState.f13, v7 := [([v5, |v11|, v5])[v5 := |v2|], v7] + v8, v5, (if (p0) then v13 else v13) < [[p0, !!f27]], v7;
			...
			if (if (0xa6 in v17) then v17[0xa6] else p0) {
				var v18: array<int> := new int[24](i0 => i0 / v16);
				...
				var v27: seq<int> := [v16];
				var v28 := "lwpgw";
				var v29: array<int> := new int[10] [v16, v16, if (f27) then 0x89 else v16, v16, v16, v16, -|v27| % v16, v16, fm0(p0, v16, globalState), |(v28 + (seq(0x2, i3  => ('a'))))|];
				globalState.f22 := v29;
				...
				v32, globalState.f7 := fm13(fm14(f27, globalState), !(v33 < v33[0x3cf := [v16]]), v16, if (v37 in v38) then v38[v37] else v37.f27, globalState), v27[v16] / v16;
				v28 := v28 + v28;
				v29 := new int[21];
			...
			v16 := |v44[v42 := 0x65]| % (if (p0) then |v45| else v16);
			globalState.f7 := 363 - (v16 / v16);
			...
			match (DC23(f27, v16 * v16, v46, DC14(p0))) {
				case DC23(cf36, cf37, cf38, cf39) =>
					...
					globalState.f10 := v55;
					v47[986] := 0x3b * fm0(p0, -cf37, globalState);
					v47[833] := v16;
					var v56: seq<int> := [v16, v16, v16];
					var v57: map<int, int> := map[cf37 := cf37];
					var v58: map<int, map<int, int>> := map[|v56| % |v51| := v57];
					...
					v47[986], v47[833], v50, v51 := |v58|, cf37 - -fm0(f27, v16, globalState), if ((v60 + v65.cf54) in v61) then v61[v60 + v65.cf54] else v50, if (!cf36) then (fm36(globalState))[v16 := f27] else v51 + v51;
				case DC22(cf35) =>
		...
		for i7 := v76 to v76 {
			...
			var v83 := new C7(true, !p0, v77, v78, !!((seq(0x1b0, i8  => (i7))) != v81), p0 <== fm2(globalState));
...
class C9 extends T1 {
	...
	function fm4(p0: int, p1: seq<bool>, globalState: GlobalState): bool {
		-|((map v0 : int | (0x1c8 <= v0) && (v0 < 0x2fa) :: (v0 + 36) := (false)) + map[0x265 := f24])| > (|[f24]| % |(seq(0x2f8, i0  => (DC3(DC1(0x3db)))))|)
	}
	...
	method m1(p0: char, p1: bool, globalState: GlobalState) returns (r0: string, r1: D0, r2: bool) {
		...
		if (v1.cf2) {
			...
			v5, v6[607], v7 := if (p1) then v5 else v5, v0, v7;
			v0 := (fm12(f23, p1, v0, globalState)).cf1;
			v4 := v4;
			v5[698] := f24;
			var v8: set<int> := {v6[607]};
			v5[698] := v8 !! v8;
		} else {
			...
			if (p1) {
				...
				var v24 := new C7(false, v12.f27, v22[-v0], 'w', f24, v23.cf52);
			...
			var v34: array<array<int>> := new array<int>[17] [v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v32, v33[v0]];
		...
		match (v39) {
			...
			case DC14(cf23) =>
				...
				if ((if (p1) then fm11(v0, f24, globalState) else p1) && f24) {
					...
					var v52: map<bool, bool> := map[v50[|v51|] := cf23];
					...
					var v55, v56, v57 := m0(v0, multiset{p1, f24} * v54, p1, v0 / 0x36e, globalState);
				} else {
					var v58: array<bool> := new bool[4](i2 => false);
					var v59: map<array<bool>, char> := map[v58 := p0];
					var v60: map<int, map<array<bool>, char>> := map[v0 / v0 := v59];
					v60 := v60[v0 := v59];
					var v61: array<int> := new int[8](i3 => i3 % v0);
					var v62: seq<bool> := [p1];
					v61[247] := v0 * fm0(cf23, |v62|, globalState);
					v61[247] := v0;
					globalState.f7 := v0;
					var v63: seq<char> := [p0, p0];
					var v64: array<char> := new char[27] [p0, f23, v63[|v63|], f23, p0, p0, v63[v0], f23, f23, f23, p0, p0, f23, 'u', p0, f23, f23, p0, f23, p0, p0, v63[v61[247]], p0, p0, fm29(v61[247], p1, cf23, v0, globalState), p0, p0];
					var v65 := DC24(v64);
					var v66 := new C7(if (true) then f24 else true, f24, v65.cf40, f23, !(v61[247] > v0), p1);
			...
			case DC12(cf19) =>
				...
				var v76: map<int, array<bool>> := map[|v74| % |v75| := v71];
		...
		if (p1) {
			...
			match (v84) {
				case DC38(cf62, cf63, cf64) =>
					...
					v89[466], globalState.f7, globalState.f13 := v0, v92.cf37, f24;
					v90 := v90[f24 := f24];
				case DC37(cf61) =>
					...
					v93[374] := v0 * v0;
					f23 := p0;
					v0 := fm0(!(v0 >= fm0(true, 0x16c, globalState)), v93[374], globalState);
				...
				case DC39(cf65) =>
					...
					var v96: seq<int> := [v0];
					var v97: array<int> := new int[25] [-|v81|, v96[0x291], v0, 521, -v0, |multiset(v96)|, v0, -v0, v1.cf3, v0, v0, v0, v0, v0, fm0(!p1, v0, globalState), v0, v0, v0, v0, v0, v0, v0 * v0, v0, v0, v0 + |v81|];
					var v98 := DC14(p1);
					var v99 := DC23(p1, v0, map[p1 := p1], v98);
					var v100: seq<D11> := [v99, v99, v99, v99, v99];
					v97[119] := |((multiset(v100))[v99 := v0] * multiset{v99})|;
					v97[119] := v0 / (-v0 - v0);
					v0 := 0x177;
					v97[119] := v0;
			}
			...
			globalState.f7, v101[378] := if (f24 in v102) then v102[f24] else |v103|, v0;
			var v104 := new C8(f24);
			var v105: seq<int> := [v0, v101[378]];
			var v106: seq<int> := [v0, v105[v101[378]]];
			var v107: multiset<int> := multiset{v0, |v106|, v0, v0};
			r2 := if (!f24) then multiset{v101[378]} !! v107 else f24;
		}
		...
		if (f24) {
			...
			r2, v118, globalState.f7, globalState.f13, v111 := fm4(fm6(globalState), v119, globalState) || p1, v118, v0 - |[v120]|, f24, v122[v0 % |v125|];
			...
			if (v130 >= (v130 - multiset{fm6(globalState), v0})) {
				...
				var v139: map<bool, string> := map[fm4(|v135|, v136, globalState) := if (v0 in v138) then v138[v0] else seq(-0x14a, i9  => (f23))];
				...
				var v145 := new C0(v139, f24, fm29(v128[172], p1, p1, v128[172], globalState), v144 == map[map[f24 := |v136|] := v140.f39]);
				f23 := v137[v0];
				var v146: seq<int> := [v128[172], v128[172] - v128[172], v0, v128[172]];
				globalState.f7 := v146[v128[172]];
				var v147: multiset<bool> := multiset{v145.f38};
				globalState.f7 := if (!!v140.f39 !in v147) then v128[172] else v128[172] % v128[172];
			}
		...
		for i10 := v0 to if (f24) then |v149| else v0 {
			...
			var v154: T0 := new C0(v152, v153[i10], f23, !f24);
			var v155: multiset<int> := multiset{i10};
			v151[802], v0, v154, v155, v153 := false, -i10, v154, v155 * multiset{i10, i10, v0}, (v153 + [true]) + (v153 + v153);
			var v156: C8 := new C8(p1);
			var v157: multiset<C8> := multiset{v156};
			var v158: set<int> := {|"lufwkuo"|, i10, |v157[v156 := i10]|};
			var v159: set<int> := {|v158|, i10, |(seq(0x72, i11  => (v154.f23)))|};
			globalState.f7 := if (p1) then v0 / |v159| else i10;
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		match (DC27(map[f24 := f23])) {
			case DC28(cf45, cf46, cf47, cf48) =>
				...
				var v1 := "ig";
				var v2: map<array<bool>, char> := map[v0 := v1[cf47]];
				...
				if (if (cf45) then f24 else v9.cf41) {
					...
					var v17: array<int> := new int[19] [cf46, |v1| % cf48, cf48, fm6(globalState), cf48, cf47, cf48 % |v1|, 310, 0x250, (if (cf46 in v14) then v14[cf46] else |v16|) / cf47, cf46 / cf47, |{cf48, |v1|, --cf48, cf46, cf47}|, cf46, cf47, cf48, 0x84, cf47, cf46, cf48 % cf47];
					v17[827] := -225;
					var v18: array<map<bool, int>> := new map<bool, int>[22];
					v18[260] := fm49(globalState);
					var v19 := DC41(v13);
					var v20: seq<bool> := [v11.f24];
					globalState.f7, v13, v17[827], globalState.f13, v18[260] := -cf47, v19.cf67, |("adnjjpgt" + v1)| % cf48, fm4(cf47, v20, globalState) && f24, v15;
					v17[827] := -cf46;
					...
					var v31: map<string, map<seq<bool>, int>> := map[v1[|v26| := f23] := v30];
					...
					var v35 := new C2(v33, v34[cf48], f23, cf45);
					cf45 := f24;
					globalState.f13 := f24;
				}
			...
			case DC27(cf44) =>
				...
				if (v46.f24 || f24) {
					...
					v48[346] := |(v49 + (if (f24) then v49 else v49))|;
					var v50: multiset<map<bool, bool>> := multiset{map[v46.f24 := v46.f24]};
					var v51: multiset<bool> := multiset{f24};
					var v52: set<int> := {v44};
					var v53, v54, v55 := m0(|v50|, v51[true := |v52|], v46.f24, v44, globalState);
				...
				var v65 := new C3(v62, v63, v45[v44], {v44} == (set v64 : int | (0xa4 <= v64) && (v64 < 0x269) :: (v64 - v44)));
		}
		...
		var v74: array<int> := new int[21] [v66, v66, v66 * |v67|, v66, v66 - 0x1b2, v66, v66, |v67|, |v68|, v66, v66 - v66, v66, v66 - |v72|, v66, v66, v66, v66 + v66, v66, |v73| % v66, v66, 139];
		...
		var v80: seq<T2> := [v79[v66], v78];
		var v81: map<bool, seq<T2>> := map[f24 := v80];
		v74[906] := |(if (v78.f24 in v81) then v81[v78.f24] else v80)|;
		var v82: map<bool, int> := map[v78.f24 := |[f24, f24]|];
		v74[906] := v66 / (if (v78.f24 in v82) then v82[v78.f24] else -751);
		r1 := v74[906];
		var v83: map<array<char>, int> := map[v78.f25 := v74[906] - v74[906]];
		v83 := v83[v77 := v66];
		v78.f23, f23 := v78.f23, fm34(|v68| % v66, v78.f24, globalState);
		var v84: array<set<int>> := new set<int>[18](i5 => v68);
		v84[676] := DC12(v68).cf19;
		v84[676] := v68;
		r0 := (v67 + "ebhil") <= v67;
		r1 := v66;
		r2 := DC34(true).cf55;
	...
	method m5(p0: seq<D0>, p1: bool, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := p3 to p3 / -|v0| {
			if (false) {
				...
				var v8: map<bool, int> := map[v5 !! v5[|v6| := p3] := |v7|];
				v8 := v8;
			...
			var v10: map<bool, int> := map[f24 := |(seq(0x1bd, i3  => (635)))|];
			...
			v14[126] := v13;
			v14[126] := if (p1) then v13 else v13;
		}
		var v15: array<bool> := new bool[18](i4 => p1);
		v15[159] := p2;
		v15[159] := f24;
		var v16: array<char> := new char[5] [f23, v0[p3], f23, fm34(p3, f24, globalState), f23];
		match (DC24(v16)) {
			case DC25(cf41, cf42) =>
				globalState.f13 := p1;
				r0 := cf41;
				...
				if ({cf41} == v17) {
					...
					v18[313] := DC41(v23).(cf67 := v23);
					var v24 := DC41(v23);
					v18[313] := v24.(cf67 := v23);
					...
					v28 := multiset{(set v29 : int | (0x2ff <= v29) && (v29 < 0x33c) :: (v29 / p3)) !! (set v30 : int | (0x211 <= v30) && (v30 < 0x1f3) :: (v30 - p3))};
				} else {
					var v31: map<int, int> := map[p3 := p3];
					var v32 := new C4(p3, DC9(v31), v16, f23, !p1);
					var v33: array<multiset<C7>> := new multiset<C7>[10];
					var v34: C7 := new C7(f24, v15[159], v16, cf42, p1, p1);
					...
					v17, v33[944], v37 := v17, (multiset{v34} * v35) - v35, multiset{v32.f33, -p3 + v32.f33, |multiset{v38}| - |v39|};
			...
			case DC24(cf40) =>
				...
				var v47: set<bool> := {if (p3 in v46) then v46[p3] else f24, v15[159]};
				var v48: map<int, set<bool>> := map[p3 := v47 + v47];
				v48 := v48[p3 := {p1, false}];
				if (p1) {
					var v49 := DC25(f24, f23);
					v16[12] := v49.cf42;
					v16[12], globalState.f13, globalState.f13 := f23, !f24 <== f24, p2;
					globalState.f7 := (p3 + -p3) % (if (v15[159]) then p3 else p3);
					globalState.f13 := p2;
					...
					globalState.f7 := fm0(v15[159], if (p2 in v51) then v51[p2] else |v46|, globalState);
					...
					v0 := v0 + v0[p3 := 'o'];
					var v55: seq<set<bool>> := [{!v15[159], p2, p1, v15[159]}];
			...
			case DC26(cf43) =>
				...
				var v63: set<bool> := {p1, p2, v15[159]};
				var v64: C8 := new C8(v63 != v63);
				v64 := v64;
				var v65: set<int> := {v60 * v58[|v63|], v62, p3, v60, v60};
				v65 := {p3};
		}
		
		for i6 := -p3 to p3 {
			if (if (v15[159]) then p1 else p1) {
				var v66: seq<bool> := [p1, v15[159], p1];
				globalState.f7 := |v66| * p3;
				var v67: map<array<bool>, int> := map[v15 := p3];
				var v68: multiset<bool> := multiset{p2};
				v67 := v67[v15 := i6 % |v68|];
				v15[159] := v68 == (v68 + v68);
				globalState.f13 := p1 ==> v15[159];
				var v69: map<array<bool>, char> := map[v15 := f23];
				var v70 := new C3(v69, v16, f23, v15[159] ==> p2);
			} else {
				...
				v71[257] := v71[257];
				var v74: multiset<int> := multiset{v71[257]};
			...
			v16[247] := f23;
			globalState.f7, v16[247], v15, f23 := i6 / |((seq(341, i7  => (v0[p3])))[p3 := f23] + v0)|, 'n', v15, f23;
			r0 := !true;
			var v78: seq<bool> := [p1];
		...
		if (p2) {
			...
			v85 := fm50(v15[159], v81, globalState);
			var v86: seq<int> := [|(seq(0x257, i8  => (|v0|)))|];
			var v87: map<int, char> := map[|v86[v81 := v83]| := f23];
		...
		if (if (true) then f24 else f24) {
			var v95: map<int, int> := map[fm0(v15[159], |v0|, globalState) := p3];
			var v96: set<map<int, int>> := {v95};
			var v97: map<bool, bool> := map[v15[159] := v15[159]];
			var v98: seq<bool> := [f24, f24];
			var v99: C8 := new C8(p2);
			var v100: map<bool, C8> := map[v15[159] := v99];
			v96 := fm51(map[v97 := v98], p3, p3, if (p1) then v98[|v100|] else p1, globalState);
			var v101: multiset<bool> := multiset{p2, v15[159], v98[p3]};
			if (fm0(!f24, p3, globalState) !in (multiset{p3})[|v101| := p3]) {
				...
				v105[635] := v106;
				v105[635] := v106;
				var v107 := DC28(v0 < v0, -(|(v0[|v98| := f23])[-v102 := f23]| * p3), v104 + 0x398, v104 * 0x250);
				...
				var v110: map<C5, bool> := map[v109 := v15[159]];
				var v111: map<int, bool> := map[|v110| := p1];
				v108 := fm52(|v111|, [f23] != v0, p3, p3, globalState);
				var v112: T1 := new C6(f23, v15[159]);
				var v113 := DC13(-(p3 % (if (f24 in v101) then v101[f24] else |fm1(v112.f24, globalState)|)), v112.f24, v112.f24);
				var v114: map<bool, int> := map[v112.f24 := 522];
				var v115: map<array<bool>, bool> := map[v15 := v15[159]];
				var v116: map<char, int> := map['t' := |v115|];
				var v117: C6 := new C6(v112.f23, p2);
				var v118: map<C6, int> := map[v117 := p3];
				var v119: array<int> := new int[29] [p3, 565, p3, p3, p3, |(map[p2 := f23] + v108)|, 0xd8 / |v114|, p3, p3, p3 * |v0|, p3, |(map[f23 := fm6(globalState)] + v116)|, p3, p3, if (v15[159] in v101) then v101[v15[159]] else 0xda, p3 - p3, |v118| / p3, p3, p3, 0x1cf, p3 / p3, |v0|, 0x11f / p3, -90, |v98|, p3, p3, 420, p3];
				v119[187] := |[p3, p3, p3]|;
				var v120: multiset<int> := multiset{p3};
				var v121 := DC23(f24, |v120|, v97, DC14(v112.f24));
				v112, globalState.f13, v113, v119[187], globalState.f7 := v112, !(if (v15[159]) then f24 else p1), v113.(cf20 := p3), fm0(p2, |v101|, globalState), if (v121.cf36) then 390 else if (p3 in v120) then v120[p3] else |v114|;
				globalState.f13 := p1;
				v119[187] := v112.fm6(globalState);
				v15[159] := (p1 <== true) ==> (v15[159] <== v112.f24);
			}
	...
	method m6(p0: bool, p1: D0, p2: string, p3: bool, globalState: GlobalState) returns (r0: bool) {
		if (p3) {
			...
			var v11: array<int> := new int[22] [v2, v2, v2, v2, v2, v2 + v2, v2, v2, if (f24 in v0) then v0[f24] else v2, 0x288, v2, v2, if (v3[v2]) then v2 else if (v6 in v7) then v7[v6] else v2, v2 + |(multiset{v8})[DC20(p2, f24, |v10|) := v2]|, v2 / |p2|, -v2, v2, v2 + |"xhna"|, v2, v2, v2, if (f24) then v2 else v2];
			v11[583] := v2;
			v11[583] := -p1.cf3 / v2;
			var v12: set<multiset<bool>> := {v0, v0, v0, multiset{f24} * multiset(v3)};
			v12 := {fm3(p3, globalState), v0[f24 := v11[583]]};
			var v13 := "d";
			var v14: map<int, char> := map[v2 := f23];
			v13 := (fm1(if (f24) then p3 else f24, globalState))[v11[583] := if (0x2be in v14) then v14[0x2be] else f23];
			...
			globalState.f7, globalState.f7, r0, v15[808] := |v22[v13 := v21]|, --745 - |v13|, v18.f24, v20.f27;
		} else {
			var v23 := 0x35d;
			...
			r0, v23, globalState.f13, v30[39] := -|(([f24] + v33)[0x390 := f24])[|v34| := p0]| in v35, if (f24 <== p0) then |v36| else v23, -0x1eb > |v39[|v40| := v41.cf74]|, if (f24) then v37.f39 else fm4(v23, v33, globalState);
		}
		...
		if (!(if (v42 in v43) then v43[v42] else p3)) {
			...
			var v47: set<bool> := {f24, !v46[v42], f24, p3, f24};
			...
			match (v56) {
				case DC34(cf55) =>
					...
					v57[727] := fm55(cf55, v58, seq(0x194, i0  => (v42)), globalState) + v60;
					var v61: array<string> := new string[14];
					v61[97] := p2;
					var v62: array<int> := new int[6](i1 => i1 * v42);
					v62[665] := fm6(globalState) + |v44|;
					var v63: multiset<string> := multiset{p2, seq(0x377, i2  => (f23)), p2, p2, p2};
					var v64 := DC49(v63);
					var v65: map<char, multiset<string>> := map[f23 := multiset{p2}];
					v57[727], cf55, v61[97], v62[665] := v60, p3 ==> (v64.cf79 < (if ('j' in v65) then v65['j'] else v63)), (p2 + p2) + (p2 + p2), v42;
					var v66: map<seq<int>, int> := map[v55.fm26(v62[665], v46, v54, v55.f38, globalState) := v62[665]];
				...
				case DC35(cf56, cf57, cf58) =>
					...
					v43 := v43[v42 / |(if (cf58 in v72) then v72[cf58] else multiset{v55.f38, p3})| := p3 <== v55.f38];
					var v73: map<int, seq<int>> := map[v42 := seq(0x3cc, i3  => (cf57))];
					v73 := v73[|v68| - v42 := v44];
				...
				case DC36(cf59, cf60) =>
					...
					globalState.f7, v76[228], globalState.f7, globalState.f13 := |(fm1(cf59, globalState) + (p2 + "qyif"))|, f23, if (v77 in v78) then v78[v77] else cf60, p3;
					v76[228] := f23;
					cf60 := v42;
					var v79: array<int> := new int[5];
					var v80: set<array<int>> := {v79, v79};
					globalState.f7 := ---(|v80| % v42);
				case DC33(cf54) =>
					var v81: array<int> := new int[20];
					v81[181] := -0x17a;
					var v82: multiset<map<bool, int>> := multiset{v53};
					v81[181] := |(v82 * (v82 - v82[v53 := v42]))|;
			...
			v90 := (map v91 : int | v91 in multiset{v42} :: (v91 % v42) := (v43)) + v90;
		}
			...
			decreases 100 - i5
		{
			...
			if ((if (f24) then v100 else v100) > v100) {
				...
				v103[987] := v102;
				v101, globalState.f13, r0, globalState.f7, v103[987] := v101, f24, p2 <= ((seq(0x2d9, i6  => (p2[v42]))) + p2), v42, v102;
		...
		r0 := v125[-(if (f24) then v42 else v42)];
	}
}
...
class C10 extends T1, T2, T3 {
	...
	function fm7(globalState: GlobalState): seq<int> {
		if (f29 >= |[f27]|) then [|multiset([f29])|] + (seq(0x36a, i0  => (f29))) else [f29]
	}
	function fm8(p0: bool, p1: bool, globalState: GlobalState): map<bool, string> {
	...
	method m1(p0: char, p1: bool, globalState: GlobalState) returns (r0: string, r1: D0, r2: bool) {
		var v0: array<string> := new string[13](i0 => ("qccj")[f29 := p0]);
		var v1 := "nbcmfn";
		v0[454] := v1;
		v0[454] := v1[f29 / -f29 := p0];
		var v2 := new C1(!f24 && p1, f28);
		var v3: seq<string> := [fm1(f28, globalState) + (seq(679, i1  => (f23))), v1, v1, v1 + v1, v0[454]];
		...
		v4[731] := if (f23 in v7) then v7[f23] else v6;
		v4[731] := new C7[4] [v5, v5, if (v5.f30) then v5 else v5, v5];
		forall i2 | 0 <= i2 < v0.Length {
			v0[i2] := (v0[454] + "rmtvniulv") + (seq(310, i3  => ('g')));
		}
		var v8 := DC20(v0[454], fm2(globalState), |v1|);
		var v9: multiset<D9> := multiset{v8};
		var v10 := DC50(v9 - v9);
		match (v10) {
			case DC51(cf81) =>
				v1 := if (v5.f30 <== cf81) then seq(43, i4  => (p0)) else fm1(f24, globalState) + v1;
				var v11 := v5.m4(v5.f30, globalState);
				var v12: seq<bool> := [v5.f30, !v5.f30, v8.cf32];
				v11 := |v12| < f29;
				var v13: seq<int> := [f29];
				var v14: map<int, int> := map[843 := v13[f29]];
				v12 := v12[if (157 in v14) then v14[157] else f29 := v11];
			case DC50(cf80) =>
				var v15 := new C9(f23, f28);
				var v16: seq<bool> := [v5.f30, false];
				var v17: array<bool> := new bool[26] [f27, v5.f30, fm4(f29, v16, globalState), true, f28, p1, v5.f30, true, f28, f24, false, f28, v2.f39, v2.f39, !!v2.f39, v5.f30, p1, !v2.f39, true, v5.f31, f27, p1, v5.f31, v5.fm4(f29, ([false, f24, v2.f39])[f29 := v2.f39], globalState), v2.f39, v5.f31];
				var v18 := new C5(v17);
				if (f29 >= f29) {
					globalState.f7 := f29;
					globalState.f7 := f29;
					var v19: multiset<int> := multiset{|v0[454]|, f29, f29, --f29, f29};
					...
					v24[748], f23, v25, globalState.f7 := -f29, f23, (([f29])[f29 := f29] + v25) + (v25 + v25), -f29;
					var v26 := DC51(true);
					var v27: map<bool, bool> := map[v26.cf81 := v5.f31];
					v27 := v27[v5.f30 := v16[|v1|]];
					globalState.f13 := (v1 + v0[454]) < v1;
				}
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		for i0 := -f29 to f29 {
			v4[609] := i0;
			var v19: seq<int> := [f29];
			v4[609] := (f29 / v19[f29]) * (i0 - i0);
			var v20 := DC25(f24, v6[f29]);
			var v21 := DC26(v20);
			var v22 := DC26(v20);
			match (v22) {
				case DC25(cf41, cf42) =>
					var v23: multiset<bool> := multiset{f28, f24, f27};
					var v24, v25, v26 := m0(|v6|, v23, cf41, v4[609] + v4[609], globalState);
					r2 := f28;
					var v27 := DC2(f24, v4[609], f24);
					cf41 := v27.cf4;
					f25[654] := cf42;
					f25[654] := f23;
				case DC24(cf40) =>
					...
					var v32: map<int, C3> := map[v4[609] := v31];
					v28[535] := v32;
					...
					var v43: set<string> := {v6, v6[f29 := 'u'], "aeorvcm" + v6, v6};
					...
					v29[868] := fm0(f28, f29, globalState) >= f29;
				...
				case DC26(cf43) =>
					...
					var v51, v52, v53 := m0(-i0 / i0, v50, if (f28) then f28 else f28, f29, globalState);
					var v54: T3 := new C8(v52);
					var v55 := DC53(v54);
					var v56: map<int, T3> := map[|map[0x12a := v4[609]]| := v54];
					var v57: map<bool, string> := map[f27 := v6];
					var v58 := DC6(v57);
					var v59: multiset<int> := multiset{v51, |fm45(f27, v58, v4[609], globalState)|};
					var v60: array<T3> := new T3[19] [v54, v54, v54, v54, v54, v55.cf83, v54, v55.cf83, v54, v54, v54, v54, v54, if ((if (v53 in v59) then v59[v53] else v4[609]) in v56) then v56[if (v53 in v59) then v59[v53] else v4[609]] else v54, v55.cf83, v54, v54, v54, v54];
					v60[707] := v54;
					var v61: map<bool, bool> := map[v54.f27 := false];
					var v62: map<map<bool, bool>, string> := map[v61 := v6];
					var v63: seq<string> := [v6, if (v61 in v62) then v62[v61] else v6, seq(0x137, i1  => (f23))];
					var v64: multiset<seq<int>> := multiset{v19};
					var v65: seq<bool> := [v52, f24, f27, false];
					var v67: map<char, char> := map[f23 := f23];
					var v68: map<int, int> := map[v4[609] := |v67|];
					var v69: map<int, bool> := map[|v68| := f27];
					var v70: map<seq<bool>, map<int, int>> := map[v65 := v68];
					var v71: map<map<seq<bool>, map<int, int>>, T3> := map[map[v65 := map v66 : int | v66 in v69 :: (v66 % f29) := (|v65|)] + v70 := v54];
					globalState.f7, v60[707] := |v63| * (if (v19 in v64) then v64[v19] else v51), if (v70 in v71) then v71[v70] else v54;
			}
	...
	method m3(p0: bool, p1: char, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		for i0 := f29 to f29 {
			...
			var v2, v3, v4 := m0(f29, v0 - v0[p0 := i0], f28, fm0(f27, v1[f29], globalState), globalState);
			...
			var v12: seq<C4> := [v11];
			var v13: seq<bool> := [p0];
			v8, f29, r1, globalState.f13 := map[f23 := {687}] + (v8 + v8), |multiset(v1)|, |v12| % |(v13 + v13)|, v3;
		}
		for i1 := 186 to f29 {
		...
		v17[958] := v19;
		v17[958] := (if (f27) then v19 else {v18, v18}) * v19;
		r2 := f24;
		...
		v20[655] := v22 + map[f27 := v21];
		v20[655] := (map[!p0 := v21] + v22) + map[f27 := v21];
		for i3 := f29 to f29 {
			...
			var v34 := DC6(v33);
			v26, f23, v28[378], v29, v32 := [i3] + fm45(f28, v34, 0x279, globalState), v27.f23, v27, v29 + v29, if (fm2(globalState)) then v32 else v32;
			if (false ==> f27) {
				f23 := v27.f23;
				f29 := -i3;
				var v35 := DC4(v27.f23);
			...
			var v45: map<array<int>, map<bool, bool>> := map[v21 := v44[|v23|]];
			v24.f32[619] := f28;
			var v46: map<array<bool>, char> := map[v24.f32 := p1];
			var v47: C3 := new C3(v46, f25, f23, f27);
			var v48: set<C3> := {v47, v47, v47, v47, v47};
			v18[766], v45, v24.f32[619] := !(916 != (f29 + i3)), v45, v27.fm4(|v48|, fm36(globalState), globalState);
		}
		r0 := f28;
		r1 := f29;
	...
	method m4(p0: bool, globalState: GlobalState) returns (r0: bool) {
		...
		var v9: array<array<C7>> := new array<C7>[13] [v7, v8[f29], v7, v7, v7, v7, v7, v7, v7, v7, v7, v7, v7];
		v9[380] := v7;
		r0, v9[380] := f24, v7;
		...
		var v16: set<bool> := {v15[f29]};
		var v17 := DC2(f28, |v3|, !fm2(globalState));
		v11, v12, globalState.f7, v13[244], v16 := v11[-f29 := f29] + map[f29 := f29], fm57(globalState), v17.cf3, v14, v16 * v16;
		r0 := f24;
	}
}
...
method Main() {
	...
	var v10 := "wjoqku";
	var v11: array<int> := new int[26] [v2, |v4|, v2, if (v2 in v5) then v5[v2] else v2, v2, |v6|, v2, v2, -0x34e, v2, 379, v2, v2, v2, v2, -v2, |v7[|v7| := v0]|, v2, -v2, v2, -|v8|, |v9|, |v10|, v2, |v4|, v2];
	var v12: set<array<bool>> := {v1};
	var v13 := 'a';
	var v14: map<int, map<bool, bool>> := map[-v2 := v8];
	var globalState := new GlobalState(v1, 986, v3[v2], true, v11, false, v1, 0x3da, v10, true, v12, 0x2e1, v10[v2 := v13], false, 'a', v8 + (if (v2 in v14) then v14[v2] else v8), 108, v10 + v10, "n", false, -0x89, v11, v11);
	for i0 := 0x1a9 to -(if (true) then -v2 else fm0(v0, v2, globalState)) {
		if (true) {
			...
			v1[240] := v20[-v2] == v19;
			v1[240] := (|fm1(fm2(globalState), globalState)| + v2) <= 591;
			var v21: multiset<bool> := multiset{v0, !v0, false, v0, v0};
			var v22, v23, v24 := m0(v2, v21, v1[240], i0, globalState);
		...
		v30[561] := fm1(v2 <= (if (!v0 in v31) then v31[!v0] else i0), globalState);
		var v32: array<D0> := new D0[5];
		v32[95] := DC2(v0, i0, v0);
		var v34: set<int> := {v2};
		var v35 := DC2(!v0, |(map v33 : int | v33 in v34 :: (v33 / i0) := (v13))|, v0);
		v32[95] := v35.(cf2 := !v0);
		globalState.f7, v2, v31, globalState.f13 := i0, fm0(false, i0, globalState), (multiset{v0, v0} + multiset{v0, v0}) * multiset{v0, !v0, true}, v0;
	}
	globalState.f13 := (v2 >= v2) ==> !(v10 <= (seq(215, i3  => (v13))));
	var v36: set<bool> := {v0};
	var v37: set<int> := {fm0(v0, v2, globalState), v2};
	var v38: set<int> := {0x1ce, |v37|, v2, v2, v2};
	v2 := v2 - (|v5[|v36| := |v37|]| % fm0(v0, |[v0]|, globalState));
	var v39: multiset<int> := multiset{-(v2 % -v2)};
	v39 := v39 * v39;
	v11[95] := v2;
	v11[95] := v2;
	...
	v40[357] := v41;
	var v42 := DC1(v2);
	v40[357], globalState.f13 := match v42 {
		case DC1(cf1) => v41[v10 := |v7|]
		case DC2(cf2, cf3, cf4) => v41
		case DC0(cf0) => multiset{"nt"}
		case DC3(cf5) => v41
	}, -v11[95] == (v11[95] % v2);
	var v43: map<array<bool>, char> := map[v1 := v10[v2]];
	var v44: array<char> := new char[5](i4 => v13);
	var v45 := new C3(v43, v44, fm29(v11[95], v0, v0, v11[95], globalState), v11[95] != v11[95]);
	var v46 := DC14(v0);
	var v47: set<D5> := {v46, v46, DC14(v0), DC14(v0).(cf23 := true), v46};
	var v49: map<set<D5>, map<int, int>> := map[v47 := map v48 : int | (0x238 <= v48) && (v48 < 0x51) :: (v48 % |"vlhwkla"|) := (if (0x18b in v39) then v39[0x18b] else v11[95])];
	...
	for i5 := v2 / v2 to v2 {
		...
		globalState.f13 := v7[fm0(v57.f39, |v5|, globalState)];
		if (0x3e == (i5 - v11[95])) {
			var v60: C10 := new C10(true <==> v57.f39, v11[95], 'j', v2 <= v2, v44, v0);
			var v61: seq<int> := [if (v57.f39) then v60.f29 else v60.f29];
			v60, v61, v61, globalState.f7, globalState.f7 := v60, ((if (v0) then seq(238, i7  => (v60.f29)) else v61) + v61)[|v10| := i5], v61 + v61, v2, i5;
			...
			v64, v62, globalState.f7, v45, v11[95] := v64, v62, v2 % v60.f29, v45, if (v0) then |fm3(!v57.f39, globalState)| else v60.fm9(v61, v60.f29, v57.f39, globalState);
			v0 := v64.f38;
		} else {
			...
			v67 := v67[v10 := v66];
			var v68: seq<int> := [i5, v11[95]];
			var v69: map<bool, map<int, bool>> := map[v66.f24 := map[|v5| := v66.f24]];
			var v71: seq<seq<int>> := [(seq(0x3a5, i8  => (i5)))[|(if (v57.f39 in v69) then v69[v57.f39] else map v70 : int | (-632 <= v70) && (v70 < 0x27b) :: (v70 + |v4|) := (DC16(v8, v57.f39, false).cf27))| := |v10|] + v68, v68, seq(0x3a2, i9  => (v11[95])), v68, v68];
			v68 := v71[v57.fm33(globalState) - i5];
	...
	match (v76) {
		case DC51(cf81) =>
			...
			if (v11[95] >= -0x199) {
				...
				var v78: multiset<bool> := multiset{v77.fm32(cf81, v2, globalState), v7[v11[95]]};
				var v79, v80, v81 := m0(|map[v77 := 'p']| + |v39|, v78, v0, v2, globalState);
				var v82: array<array<int>> := new array<int>[7];
				v82[259] := v11;
				v4, v80, v82[259], v11[95], v0 := v4 + v4, v80, v11, v2 / v2, v80;
				var v83 := new C2(v78, v44, if (v77.f39) then v13 else v13, v80);
				cf81 := v80;
				var v84: C4 := new C4(v83.fm24(v83.fm24(v81, cf81, globalState), v77.f39, globalState), DC9(v5), v44, v13, v11[95] >= v79);
				...
				var v95 := DC56(v94);
				var v96: map<set<int>, C4> := map[set v93 : int | (-0xcc <= v93) && (v93 < 551) :: (v93 * v11[95]) := v95.cf90];
				globalState.f7, v91, cf81 := v2 % (v11[95] - v11[95]), fm3(v87, globalState), (set v92 : int | (0x261 <= v92) && (v92 < -0x3a1) :: (v92 - -v2)) in v96;
				var v97: map<string, array<int>> := map["b" := v11];
				var v98: array<array<int>> := new array<int>[4] [v11, if (v87) then v11 else v11, if (v10[fm0(v87, v94.f33, globalState) := v13] in v97) then v97[v10[fm0(v87, v94.f33, globalState) := v13]] else v11, v11];
				var v99 := DC58(v98);
				v98 := v99.cf96;
			}
			...
			if (|(if (cf81 in v101) then v101[cf81] else v100)| >= (v11[95] / v11[95])) {
				v1[777] := v0;
				v13, globalState.f13, v1[777], globalState.f13, v11[95] := v13, v0, (seq(0x319, i10  => (v13))) != v10, !cf81, v11[95];
				var v102 := DC60(v39);
				var v103: seq<int> := [v11[95], v11[95]];
				v11 := new int[27] [v2, v2, v2 % |"fghnvwo"|, v42.cf1, v11[95] * v11[95], 0x3b2, v2 / v11[95], -|v7[0x1e0 := v1[777]]|, v2 + v2, v11[95], v2, v11[95], fm0(v1[777], v2, globalState), |fm21(v36, (v102.(cf98 := v39)).cf98, globalState)|, v2 / (if (v11[95] in v5) then v5[v11[95]] else v2), v11[95], v11[95], 86, v11[95], v2, v11[95], v2, v2, v11[95], fm0(v0, |v4|, globalState), |(seq(0x11c, i11  => (v13)))| / v103[v11[95]], v2];
				globalState.f7 := (v103[v2] + -v11[95]) % -0x65;
				v11[95] := v11[95] / -(v11[95] - v2);
				globalState.f13 := cf81;
			} else {
				var v104: seq<int> := [v11[95] / v2];
				var v105: set<seq<int>> := {seq(0x361, i12  => (v2))};
				var v107: map<seq<int>, bool> := map[seq(0x2cb, i13  => (0x2a0)) := cf81];
				var v109: seq<set<seq<int>>> := [v105];
				var v110: map<seq<int>, char> := map[v104 := v13];
				var v112 := DC28(cf81, v11[95], v11[95], v2);
				var v114: map<bool, string> := map[v0 := v10];
				var v115 := DC6(v114);
				var v116: array<set<seq<int>>> := new set<seq<int>>[22] [set v106 : seq<int> | v106 in v105 :: (v106), v105 * v105, v105, {v104}, if (cf81) then v105 else v105, v105, (set v108 : seq<int> | v108 in v107 :: (v108)) * v105, v109[v2], v109[v2], v105, v109[v11[95]] * v105, set v111 : seq<int> | v111 in v110 :: (v111), v105, v105 - v105, v105, if (v112.cf45) then set v113 : seq<int> | v113 in [v45.fm7(globalState)] :: (v113) else v105, {v104, fm45(v0, v115, if (0x24f in v5) then v5[0x24f] else v2, globalState)}, {v104}, v109[v2], v105, v105, v105];
				v116[785] := {v104};
				var v117: T1 := new C10(v0, v11[95], v13, v0, v44, cf81);
				...
				globalState.f13, v104, v7, v116[785], v118 := true, v104 + (v104 + ([|multiset{v120}|])[v2 := v2]), v7, fm61(v121.cf37, fm1(v0, globalState), if (!false) then v122 else v122, v2, globalState), v124[v2 + v11[95]];
			...
			v0 := v0;
		case DC50(cf80) =>
			var v130 := new C10(41 >= v11[95], v2, v13, false, v44, v0);
		...
		case DC52(cf82) =>
			...
			v132[144] := v11;
			var v133: map<int, array<int>> := map[v11[95] := v11];
			v132[144], v2, v11[95], v133 := v11, |"xy"|, v2, v133;
			var v134 := new C7(!(if (v0) then v0 else v0), false, v44, v13, v7 < v7, v45.fm4(v2, v7, globalState));
			v10 := "f";
			v10 := v10[v11[95] := v13] + v10;
	}
	
	globalState.f7, v0 := -v2, ("kbtyeu" + v10) != (fm1(v0, globalState))[v2 := v13];
	v1[261] := if (v0) then v0 else v0;
	var v135 := DC42(v11[95], v0);
	var v136: set<D18> := {v135};
	var v137: map<D18, int> := map[v135 := |v36|];
	v1[261] := v136 != (set v138 : D18 | v138 in v137 :: (v138));
	forall i14 | 0 <= i14 < v1.Length {
		v1[i14] := v1[261];
	}
	var v139 := DC20(v10, v0, v11[95]);
	var v140 := DC10(("jnm")[v11[95] := v13] + v139.cf31);
	match (v140) {
		case DC11(cf18) =>
			var v141: seq<int> := [v11[95], cf18, v11[95]];
			var v142 := DC9(v5);
			var v143: C4 := new C4(|v141|, v142, v44, v13, v45.fm4(if (v2 in v5) then v5[v2] else v11[95], v7, globalState));
			var v144 := DC56(v143);
			v1[261], v144, v1[261], globalState.f13 := v1[261], v144, v0, v1[261];
			globalState.f7 := -v11[95];
			var v145, v146, v147 := v45.m11(if (v1[261]) then v0 else v0, globalState);
			v1[261] := !((v7 + [v7[cf18]]) == (v7 + v7));
		case DC10(cf17) =>
			var v148: array<map<bool, char>> := new map<bool, char>[5](i15 => map[v0 := v13]);
			var v149 := DC30(v148);
			var v150 := DC32(v149);
			var v151 := DC32(if (v0) then v150 else DC31(v0));
			var v152 := DC9(map[v11[95] := v2]);
			var v153: C4 := new C4(v2, v152, v44, v13, true);
			var v155: map<int, D18> := map[v2 := v135];
			var v156: seq<int> := [fm0(v1[261], v153.f33, globalState)];
			globalState.f13, v151, globalState.f13, globalState.f7, globalState.f13 := v45.fm4(v2 + |multiset{v153, v153}|, v7, globalState), v151, v1[261], |(map v154 : int | v154 in v155[v11[95] := v135] :: (v154 % v153.f33) := (v13))|, (if (!v1[261]) then v156 else v156) < v156[v153.f33 := v11[95]];
			if ('a' !in (cf17 + v10)) {
				v1[261] := v1[261];
				globalState.f7 := (v2 * |v7[|cf17| := v0]|) % v11[95];
				...
				var v161 := DC30(v148);
				v161 := v161;
				var v162, v163, v164 := v153.m3(v2 > v11[95], v13, globalState);
				globalState.f13 := v7[v2];
			}
			
			var v165: multiset<bool> := multiset{v0};
			var v166 := new C2(v165, if (v1[261]) then v44 else v44, v13, v0);
			globalState.f7 := |map[[v11[95], v2] + [v11[95]] := !v0]|;
	}
	
	var v167 := DC9(v5);
	match (v167) {
		case DC9(cf16) =>
			var v168, v169, v170 := m0(v11[95], multiset{v1[261]}, v1[261] <==> true, v2, globalState);
			var v171: multiset<array<int>> := multiset{v11, v11};
			v171 := v171;
			globalState.f7 := |map[fm2(globalState) := v0]|;
			var v172: multiset<bool> := multiset{v1[261], v169, v0};
