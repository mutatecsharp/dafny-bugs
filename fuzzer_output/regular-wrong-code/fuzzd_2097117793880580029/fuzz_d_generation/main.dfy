...
class C1 {
	...
	function fm0(p0: string, p1: int, p2: int, p3: int, globalState: GlobalState): bool {
		false ==> f21[safeIndex(|(seq(abs(0x234), i0  => ('j')))|, |f21|)]
	}
	...
	method m1(globalState: GlobalState) {
		...
		var v6 := DC0(map v4 : int | v4 in v5 :: (safeDivisionInt(v4, f20)) := (v0));
		var v7 := DC0(v6.cf0);
		var v9: seq<map<int, bool>> := [map v8 : int | (0xcf <= v8) && (v8 < 0x191) :: (safeDivisionInt(v8, f20)) := (v0)];
		var v10: array<map<int, bool>> := new map<int, bool>[20] [v1 + v1, v1 + v1, map v2 : int | v2 in v3 :: (v2 + f20) := (v0), v1 + v1[f20 := v0], v1, v1, v1, v1[f20 := true], v1, map[0x45 := v0], map[f20 := v0], v1, v1, v7.cf0, v9[safeIndex(f20, |v9|)], v1, v1, v1, v1 + v1, v1];
		var v11 := "mjg";
		...
		var v15: map<array<map<bool, bool>>, map<bool, int>> := map[v13[safeIndex(|map[v0 := v0]|, |v13|)] := v14 + v14];
		v15 := v15[v12 := v14];
		var i1 := 0;
		while (v0)
			decreases 100 - i1
		...
		if (v20) {
			...
			v12[safeIndex(192, v12.Length)] := v22;
			v12[safeIndex(192, v12.Length)] := v22[v20 := v20] + v22;
			v7 := v6;
			var v23 := 's';
			...
			match (v6) {
				case DC0(cf0) =>
					...
					v26[safeIndex(144, v26.Length)] := v20;
					v26[safeIndex(144, v26.Length)] := !((v25.f22 + |(seq(abs(311), i2  => ('p')))|) > -390);
					var v27: seq<C0> := [v25, v25, v25];
					v25, globalState.f7, globalState.f5, v20 := v27[safeIndex(v25.f22 - v25.f22, |v27|)], !fm0("rdmtla", v25.f22 + -v25.f22, f20, -0x1f6, globalState), true, v0;
			}
			
			v21 := (map v28 : int | (0x63 <= v28) && (v28 < -193) :: (v28 + f20) := (v0)) + v9[safeIndex(f20, |v9|)];
		} else {
			v20 := v0;
			if (v20 ==> (if (v20) then true else v20)) {
				var v29: array<int> := new int[25];
				v29 := new int[1];
				globalState.f11 := v0 ==> f21[safeIndex(|fm5(f20, v20, f20, globalState)|, |f21|)];
				v29 := v29;
				globalState.f3 := f20;
				var v30 := 'f';
				...
				var v33 := 's';
				v33 := v33;
				v11 := v11[safeIndex(f20, |v11|) := v33] + v11;
			}
			
			globalState.f5 := v20;
			var v34: seq<D0> := [v6];
			v0, globalState.f7 := v20, (v7 in v34) && v20;
			globalState.f3 := safeModuloInt(f20, f20);
		}
		
		match (v6.(cf0 := v1)) {
			case DC0(cf0) =>
				var v35 := new C0(-f20);
				var v36: array<int> := new int[17](i3 => safeDivisionInt(i3, -0x2a9));
				var v37: seq<array<int>> := [v36];
				var v38: map<multiset<int>, array<int>> := map[v18 := v37[safeIndex(f20, |v37|)]];
				var v39: array<array<int>> := new array<int>[8] [v36, if (multiset(v3) in v38) then v38[multiset(v3)] else v36, v36, v36, v36, v36, v36, v37[safeIndex(v35.f22, |v37|)]];
				v39[safeIndex(926, v39.Length)] := v36;
				v39[safeIndex(926, v39.Length)], v6, globalState.f3 := v36, v7, -|v3|;
				var v40: array<D0> := new D0[14];
				v40[safeIndex(673, v40.Length)] := v6;
				v40[safeIndex(673, v40.Length)] := v6;
				v39[safeIndex(926, v39.Length)][safeIndex(929, v39[safeIndex(926, v39.Length)].Length)] := f20;
				var v41: set<int> := {|[v0]|};
				var v42: map<D0, set<int>> := map[v6 := v41];
				globalState.f3, v39[safeIndex(926, v39.Length)][safeIndex(929, v39[safeIndex(926, v39.Length)].Length)], v42, v41 := f20, --safeDivisionInt(f20 * f20, v35.f22), v42, v41;
		}
...
function fm7(p0: int, p1: int, globalState: GlobalState): int {
	--(safeDivisionInt(0x3b7, |[|(map v0 : int | v0 in (seq(abs(-0x1bc), i0  => (|[true]|))) :: (v0 + |{true}|) := (0x186))|]|) * (DC16(|"bmlkxdin"|, true, true).cf22 * |map[|"l"| := 'f']|))
}
...
function fm12(p0: int, p1: int, p2: string, globalState: GlobalState): set<string> {
	({"suuupmma", "ogyyc"} + {"bgrjnfjl"}) * (set v0 : string | v0 in multiset{"hjljvpj", "imkj", seq(abs(0xd0), i0  => ('k'))} :: (v0))
}
...
method m0(p0: multiset<int>, globalState: GlobalState) returns (r0: set<bool>, r1: bool, r2: map<int, bool>) {
	...
	var v8: array<map<int, bool>> := new map<int, bool>[16](i0 => map v7 : int | (0x33a <= v7) && (v7 < 649) :: (safeModuloInt(v7, |map[true := v1]|)) := (false));
	v6[safeIndex(37, v6.Length)] := v8;
	var v9 := true;
	var v10 := "kngri";
	var v11 := DC10(v8);
	v0, v5, globalState.f3, v6[safeIndex(37, v6.Length)], globalState.f14 := |{!v9, v9, v9}| - (v0 - fm7(-v4.f22, -v0, globalState)), v5, safeModuloInt(fm7(v4.f22, v0, globalState), |(v10 + v10)|), (v11.(cf14 := v8)).cf14, v9;
	v10 := v10;
		...
		decreases 100 - i1
	{
		...
		globalState.f14 := |(v16[safeIndex(0x25f, |v16|)] + v5[false := v4])| >= v4.f22;
		var v17: seq<bool> := [v9, v9];
		var v18: C1 := new C1(929, v17);
		var v19: set<C1> := {v18, v18};
		v19 := v19;
		var v20: map<seq<int>, int> := map[fm13(v1, v9, globalState) := safeDivisionInt(0x228, v4.f22)];
		var v21: seq<int> := [v4.f22];
		v20 := v20[v21 := v4.f22];
		var v22: array<string> := new string[6];
		v22[safeIndex(484, v22.Length)] := v10;
		v22[safeIndex(484, v22.Length)] := v10;
	}
	if (!v9) {
		if (v9) {
			var v23: seq<bool> := [v9];
			var v24 := new C1(|(seq(abs(0x2a2), i2  => ('i')))| + v4.f22, v23);
			...
			v27[safeIndex(532, v27.Length)] := if (v9) then v28 else v28;
			v26, v27[safeIndex(532, v27.Length)], globalState.f14, globalState.f14 := multiset{v25}, v28, v9 ==> !v9, v1 !in v10;
			globalState.f7 := v9;
			var v30 := DC7(-v4.f22, |(map v29 : int | (0x29b <= v29) && (v29 < 0x227) :: (safeDivisionInt(v29, v4.f22)) := (v9))|);
			...
			v41[safeIndex(294, v41.Length)] := |v10|;
			v41[safeIndex(294, v41.Length)] := -fm7(safeDivisionInt(v36.f20, v4.f22), v4.f22, globalState);
			var v42: array<bool> := new bool[5];
			v42[safeIndex(573, v42.Length)] := v9;
			v42[safeIndex(573, v42.Length)] := v36.fm0("lsnskptul" + (seq(abs(893), i4  => (v1))), v4.f22, v4.f22, 994, globalState);
			v42[safeIndex(573, v42.Length)] := !v9;
			var v43: map<bool, bool> := map[v9 := v42[safeIndex(573, v42.Length)]];
			v41[safeIndex(294, v41.Length)] := safeModuloInt(safeModuloInt(v3.cf9, v36.f20), safeDivisionInt(v36.f20, |v43|));
			globalState.f11 := v35[safeIndex(v0, |v35|)];
		}
		
		var v44: array<int> := new int[14];
		v44[safeIndex(577, v44.Length)] := v0;
		var v45: multiset<bool> := multiset{v9};
		v44[safeIndex(577, v44.Length)] := if (v9) then v4.f22 else safeDivisionInt(|v45|, v0);
		globalState.f14 := v9;
		globalState.f3 := v44[safeIndex(577, v44.Length)];
		v44[safeIndex(577, v44.Length)] := v4.f22 + v44[safeIndex(577, v44.Length)];
	} else {
		...
		if (if (v0 !in (if (v48 in v49) then v49[v48] else v50)) then v48.f20 > |"ihliafrys"| else v9) {
			...
			var v54 := DC17(v1);
			globalState.f3, v10, globalState.f3 := -(v4.f22 + 0x33e), DC14(v52[safeIndex(|v53|, |v52|)]).cf19 + v10[safeIndex(v0, |v10|) := v54.cf25], v4.f22;
			...
			var v66 := DC20(v4);
			var v67: array<C0> := new C0[23] [v65[safeIndex(|v10|, |v65|)], v66.cf33, v4, v4, v4, v4, v4, v4, if (v9) then v4 else v4, v4, v4, v4, v4, v4, v4, v4, v65[safeIndex(v4.f22, |v65|)], v4, v4, v4, v4, v4, v4];
			v67[safeIndex(918, v67.Length)] := v4;
			v67[safeIndex(918, v67.Length)] := v4;
		} else {
			var v68: array<bool> := new bool[13];
			v68[safeIndex(108, v68.Length)] := v9;
			v68[safeIndex(108, v68.Length)] := v0 < -v48.f20;
			var v69: array<int> := new int[1] [--659];
			var v70: multiset<bool> := multiset{v68[safeIndex(108, v68.Length)], v68[safeIndex(108, v68.Length)]};
			var v71: map<bool, char> := map[v9 := v4.fm4(|v70|, globalState)];
			var v72: map<map<bool, char>, seq<bool>> := map[v71 := v48.f21];
			v69[safeIndex(28, v69.Length)] := v48.fm1(v72, globalState);
			v69[safeIndex(28, v69.Length)] := v48.f20;
			globalState.f3 := safeDivisionInt(if (v9) then -49 else 0x122, v4.f22);
			var v73 := DC14(v10);
			var v74: map<bool, string> := map[v68[safeIndex(108, v68.Length)] := "btkawurs"];
			var v75: array<string> := new string[19] [v10, v10, v10, v73.cf19 + v10, v10 + v10, (v10 + v10)[safeIndex(v50[safeIndex(988, |v50|)], |(v10 + v10)|) := v1], v10, v10, v10, v10, "kspjtwcah" + fm14(globalState), v10, v10[safeIndex(v4.f22, |v10|) := 'j'], v10, v10, v10, v10, v10, if (v9 in v74) then v74[v9] else v10];
			v75[safeIndex(56, v75.Length)] := v10;
			v75[safeIndex(56, v75.Length)] := if (false) then v10 else v10;
			var v76: map<array<int>, bool> := map[v69 := v9];
			var v77: map<int, map<array<int>, bool>> := map[safeDivisionInt(v69[safeIndex(28, v69.Length)], v4.f22) := v76];
			v77 := v77[v48.f20 := v76];
		}
		...
		v82 := v82[v47[safeIndex(v4.f22, |v47|) := if (v9 in v79) then v79[v9] else v9] := v15];
		var v83: array<int> := new int[3](i5 => safeModuloInt(i5, |v15|));
		v83[safeIndex(959, v83.Length)] := v4.f22;
		globalState.f3, v83[safeIndex(959, v83.Length)] := safeDivisionInt(safeModuloInt(v4.f22, v4.f22), 0x5), v48.f20;
	}
	
	var v84: multiset<string> := multiset{v10, v10};
	for i6 := |v84| to v4.f22 {
		var v85: array<int> := new int[20];
		v85[safeIndex(12, v85.Length)] := v4.f22;
		v85[safeIndex(12, v85.Length)] := safeModuloInt(i6, v4.f22);
		var v86: seq<int> := [i6];
		var v87: map<bool, seq<int>> := map[v9 := v86];
		var v88 := new C0(safeModuloInt(|v87|, i6));
		var v89: array<bool> := new bool[25](i7 => true);
		v89[safeIndex(64, v89.Length)] := v9;
		v89[safeIndex(64, v89.Length)] := v9 || v9;
		var v90: C1 := new C1(i6, [true]);
		var v91: map<D3, bool> := map[DC8(v90) := true];
		var v92 := DC8(v90);
		v91 := v91[v92 := if (v89[safeIndex(64, v89.Length)]) then true else v89[safeIndex(64, v89.Length)]];
	}
...
method Main() {
	...
	var v7: seq<bool> := [v0, v5[safeIndex(|v6|, |v5|)]];
	var v8: set<int> := {v2};
	var v9: set<bool> := {v0};
	...
	var v12 := "skhwrlhb";
	v11[safeIndex(804, v11.Length)] := v12 + (seq(abs(-0x1de), i0  => (v12[safeIndex(v2, |v12|)])));
	v11[safeIndex(804, v11.Length)] := v12;
	if (v0) {
		var v13: array<int> := new int[21](i1 => i1 * 553);
		var v14: seq<string> := [v12];
		v13, globalState.f3, v0 := v13, -safeModuloInt(|v14|, v2 + v2), !true;
		...
		v21 := v21[-v2 := |v11[safeIndex(804, v11.Length)]|];
		...
		v2 := safeModuloInt(safeModuloInt(v24.f20, v24.f20), |v9|);
		globalState.f11 := safeDivisionInt(v2, v24.f20) != v24.f20;
		var v30: array<int> := new int[21](i2 => i2 * -99);
		globalState.f7 := v24.fm0(v12, v24.f20, safeDivisionInt(v2, |{v30, v30, v30, v30, v30}|), v2, globalState);
	}
	
	var v31: multiset<bool> := multiset{v0, v0, v0};
	var i3 := 0;
	while (v5[safeIndex(if (v0 in v31) then v31[v0] else v2, |v5|)])
		decreases 100 - i3
	{
		if (i3 >= 100) {
			break;
		...
		v36 := v36;
		globalState.f14 := safeModuloInt(v2, -v2) == (fm8(globalState)).cf2;
	}
	var v37: array<int> := new int[7];
	v37[safeIndex(792, v37.Length)] := v2;
	var v38: seq<string> := [v12, "qsf", v11[safeIndex(804, v11.Length)] + v12, v12, v12];
	v11[safeIndex(804, v11.Length)], v37[safeIndex(792, v37.Length)] := v38[safeIndex(-v2, |v38|)], safeDivisionInt(v2, v2);
	var v39 := DC2(v2, v0);
	globalState.f7 := match v39 {
		case DC2(cf2, cf3) => v0 ==> cf3
		case DC1(cf1) => v37[safeIndex(792, v37.Length)] <= v2
		case DC3(cf4) => v2 >= v37[safeIndex(792, v37.Length)]
	};
	var v40: map<int, bool> := map[v37[safeIndex(792, v37.Length)] := v0];
	var v41 := DC0(v40);
	...
	var v45: multiset<int> := multiset{v37[safeIndex(792, v37.Length)], |v9|, v37[safeIndex(792, v37.Length)], 0x1a, |v11[safeIndex(804, v11.Length)]|};
	globalState.f3 := safeModuloInt(v2, v37[safeIndex(792, v37.Length)]) * fm7(|(if ((if (v0 in v31) then v31[v0] else v37[safeIndex(792, v37.Length)]) in v44) then v44[if (v0 in v31) then v31[v0] else v37[safeIndex(792, v37.Length)]] else v43)|, if (|v11[safeIndex(804, v11.Length)]| in v45) then v45[|v11[safeIndex(804, v11.Length)]|] else v37[safeIndex(792, v37.Length)], globalState);
	...
	globalState.f14 := (v45 + v45) != (if (v0 in v46) then v46[v0] else v49[safeIndex(|(if (v0 in v50) then v50[v0] else v11[safeIndex(804, v11.Length)])|, |v49|)]);
	for i4 := v37[safeIndex(792, v37.Length)] to if (v0 in v6) then v6[v0] else v2 {
		var v51: map<map<int, bool>, int> := map[v40 := v37[safeIndex(792, v37.Length)]];
		var v52: seq<map<map<int, bool>, int>> := [v51];
		var v53: map<int, int> := map[v2 := v2];
		var v54, v55, v56 := m0(fm9(false, v12[safeIndex(v37[safeIndex(792, v37.Length)], |v12|)], v52[safeIndex(v2, |v52|)], v53, globalState), globalState);
		globalState.f3 := -fm7(v2, |v11[safeIndex(804, v11.Length)]|, globalState);
		globalState.f7 := !v0;
		var v57: map<bool, bool> := map[true := |"skjwiqufa"| != v37[safeIndex(792, v37.Length)]];
		v57 := v57[v0 := v0];
	}
	var v58 := DC2(fm7(v2, v2, globalState), v5[safeIndex(v37[safeIndex(792, v37.Length)], |v5|)]);
	var v59 := DC3(v58);
	...
	for i5 := v2 to |v62| {
		...
		match (v64) {
			case DC2(cf2, cf3) =>
				var v65 := DC6(v63.f20);
				var v66: map<C1, int> := map[v63 := v37[safeIndex(792, v37.Length)]];
				...
				v70[safeIndex(658, v70.Length)] := {!cf3} - v9;
				var v71: array<array<string>> := new array<string>[18];
				v71[safeIndex(735, v71.Length)] := v11;
				globalState.f3, v37[safeIndex(792, v37.Length)], v70[safeIndex(658, v70.Length)], v71[safeIndex(735, v71.Length)] := v37[safeIndex(792, v37.Length)], -v63.f20 + 0x6b, v9, v11;
				v6 := v6[v0 := cf2] + v6;
				globalState.f7 := v0;
				globalState.f14 := v63.fm0(v11[safeIndex(804, v11.Length)], 0x11 * v2, v2, |v45| + v63.f20, globalState);
			case DC1(cf1) =>
				v48 := v48;
				var v72: map<D1, seq<int>> := map[DC1(|[v3, v3]|) := v47];
				v72 := v72[v64 := v47 + v47];
				globalState.f11 := (v9 * v9) != (v9 + v9);
				v11[safeIndex(804, v11.Length)] := v11[safeIndex(804, v11.Length)];
			case DC3(cf4) =>
				v40 := v40;
				globalState.f7, v37[safeIndex(792, v37.Length)], v0, globalState.f3 := v0, i5, v0 && (v42 !in v12), -(|v40| * |v12|);
				v7 := v5;
				v7 := v7;
		}
	...
	var v74, v75, v76 := m0(multiset{0x359, -v37[safeIndex(792, v37.Length)], v37[safeIndex(792, v37.Length)], |v38|, v2}, globalState);
	var v77: C1 := new C1(fm7(v37[safeIndex(792, v37.Length)], -0xb1, globalState), v5);
	var v78 := DC8(v77);
	var v79: set<C1> := {v78.cf12};
	v0, v2, globalState.f3 := true, v37[safeIndex(792, v37.Length)] + v2, -(if (v0 in v31) then v31[v0] else |v79|);
	print v0, "\n";
	print v2, "\n";
	print |v4|, "\n";
	print v5 == [true], "\n";
	print v6 == map[false := 204], "\n";
	print v7 == [false, true], "\n";
	print v8 == {204}, "\n";
	print v9 == {false}, "\n";
	...
	print globalState.f12 == [false, true], "\n";
	print globalState.f13 == {204}, "\n";
	print globalState.f14, "\n";
	print globalState.f15, "\n";
	print globalState.f16 == {false}, "\n";
	print globalState.f17, "\n";
	print globalState.f18, "\n";
	print v11[4], "\n";
	print v12, "\n";
	print v31 == multiset{false, false, false}, "\n";
	print i3, "\n";
	print v37[1], "\n";
	print v38 == ["skhwrlhb", "qsf", "skhwrlhbskhwrlhb", "skhwrlhb", "skhwrlhb"], "\n";
	print v39.cf2, "\n";
	print v39.cf3, "\n";
	print v40 == map[0 := false], "\n";
	print v41.cf0 == map[0 := false], "\n";
	print v42, "\n";
	print v43 == {'d'}, "\n";
	print v44 == map[0 := {'d'}], "\n";
	print v45 == multiset{0, 0, 1, 26, 8}, "\n";
	print v46 == map[false := multiset{0, 0, 1, 26, 8}], "\n";
	print v47 == [0], "\n";
	print v48.cf5 == multiset{0}, "\n";
	print v49 == [multiset{0, 765}, multiset{0, 0, 1, 26, 8}], "\n";
	print v50 == map[false := "skhwrlhb"], "\n";
	print v58.cf2, "\n";
	print v58.cf3, "\n";
	print v59.cf4.cf2, "\n";
	print v59.cf4.cf3, "\n";
	print v60 == map[DC3(DC2(7608, true)) := 'd'], "\n";
	print v61 == map[map[DC3(DC2(7608, true)) := 'd'] := false], "\n";
	print |v62|, "\n";
	print v74 == {false, true}, "\n";
	print v75, "\n";
	print v76 == map[7257 := true], "\n";
	print v77.f20, "\n";
	print v77.f21 == [true], "\n";
	print v78.cf12.f20, "\n";
	print v78.cf12.f21 == [true], "\n";
	print |v79|, "\n";
}