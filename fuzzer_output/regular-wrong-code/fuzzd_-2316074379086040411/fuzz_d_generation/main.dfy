...
class C0 {
	...
	method m0(p0: seq<bool>, p1: int, globalState: GlobalState) {
		...
		var v5: array<int> := new int[14] [p1, p1, p1, -v0.cf4, |v4|, p1, v0.cf4, p1, p1, p1, p1, |p0| * p1, p1, safeModuloInt(-p1, p1)];
		v5[safeIndex(192, v5.Length)] := p1 * p1;
		var v6: map<seq<bool>, int> := map[p0 := p1];
		v5[safeIndex(192, v5.Length)] := fm4(v6, globalState);
		var v7: map<int, bool> := map[-v5[safeIndex(192, v5.Length)] := v1];
		var v8: set<map<int, bool>> := {v7};
		var v9: map<int, int> := map[|v8| := p1];
		var v10: set<bool> := {v1};
		var v11: seq<set<bool>> := [v10, v10];
		v9 := v9[safeModuloInt(v5[safeIndex(192, v5.Length)], |"t"|) := -|v11|];
		var v12: map<bool, array<int>> := map[v1 := v5];
		v5[safeIndex(192, v5.Length)] := |(v12 + v12)| - 0x320;
		var v13: array<bool> := new bool[15];
		v13[safeIndex(904, v13.Length)] := true;
		v13[safeIndex(904, v13.Length)] := v1;
		for i0 := p1 to v5[safeIndex(192, v5.Length)] {
			globalState.f0 := safeModuloInt(if (v1) then p1 else v5[safeIndex(192, v5.Length)], -v5[safeIndex(192, v5.Length)]);
			var v14 := "cshphu";
			globalState.f9, v13[safeIndex(904, v13.Length)], v5[safeIndex(192, v5.Length)] := if ((|v10| * v5[safeIndex(192, v5.Length)]) in v9) then v9[|v10| * v5[safeIndex(192, v5.Length)]] else safeModuloInt(i0, v5[safeIndex(192, v5.Length)]), v14 == v14, 686;
			globalState.f13 := false;
			globalState.f0 := -0x3d5;
		}
		forall i1 | 0 <= i1 < v5.Length {
			v5[i1] := i1 * safeDivisionInt(|(seq(abs(0x17d), i2  => ('t')))|, v5[safeIndex(192, v5.Length)]);
		}
	}
}

function fm0(p0: seq<int>, p1: int, globalState: GlobalState): seq<int> {
	((seq(abs(573), i0  => (|multiset{false}|))) + [|map[!!true := true]|]) + ([-708] + [0xe0, |multiset{!true}|])
}
...
function fm4(p0: map<seq<bool>, int>, globalState: GlobalState): int {
	match DC11(multiset{seq(abs(0x24c), i0  => ('b'))}) {
		case DC12(cf17) => cf17
...
function fm6(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): map<int, int> {
	(map[0xf5 := |[true]|] + map[0x1de := |(seq(abs(0x1e), i0  => ('c')))|]) + DC6(map[|multiset{true}| := 0xf7]).cf11
}
function fm7(p0: int, p1: int, globalState: GlobalState): map<seq<bool>, int> {
	(map v0 : seq<bool> | v0 in map[[!true] := 0x3e2] :: (v0) := (|"af"|)) + ((map v1 : seq<bool> | v1 in multiset(seq(abs(625), i0  => ([false]))) :: (v1) := (467)) + map[[!false, false, false, false, true] := 461])
}
...
function fm12(globalState: GlobalState): bool {
	true ==> (|map[false := DC6(map v0 : int | (0x349 <= v0) && (v0 < 0x386) :: (v0 - |multiset{true}|) := (|(seq(abs(-948), i0  => ('w')))|))]| >= -0x2c7)
}
...
method m1(p0: char, p1: seq<D0>, p2: bool, p3: seq<int>, globalState: GlobalState) returns (r0: C0, r1: array<seq<bool>>, r2: int, r3: int) {
	...
	var v1 := 0x3b8;
	var v4: map<set<int>, bool> := map[set v2 : int | (0x147 <= v2) && (v2 < 247) :: (v2 * |(set v3 : int | v3 in multiset(p3) :: (safeDivisionInt(v3, 0x299)))|) := p2];
		...
		decreases 100 - i0
	{
		...
		i0 := i0 + 1;
		globalState.f2 := v1;
		v5 := v5[v1 := safeModuloInt(v1, 196)];
		var v6 := DC9(|(seq(abs(0xea), i1  => (|map[true := v1]|)))|, p2);
		match (if (p2) then v6 else v6) {
			case DC9(cf14, cf15) =>
				...
				var v10 := DC11(v9);
				v7[safeIndex(961, v7.Length)] := |(v9 + v10.cf16)|;
				v7[safeIndex(961, v7.Length)] := if (cf14 in v5) then v5[cf14] else v1;
				globalState.f10 := p2;
				var v11: C0 := new C0();
				r0 := v11;
				var v12: array<string> := new string[18];
				v12[safeIndex(253, v12.Length)] := v8;
				v12[safeIndex(253, v12.Length)] := v8 + v8;
			case DC10() =>
				...
				globalState.f9 := -423;
				var v18: seq<bool> := [p2];
				var v19: array<seq<bool>> := new seq<bool>[4] [v18, [v18[safeIndex(-v1, |v18|)]], [p2, !p2], v18 + v18];
				r1 := v19;
				var v20 := new C0();
			case DC8(cf13) =>
				var v21: C0 := new C0();
				...
				globalState.f9 := v1;
				globalState.f2 := p3[safeIndex(v1, |p3|)];
		}
		
		var v22 := "cnyebc";
		v1 := safeModuloInt(|v22|, -0x328 + 0x85);
	}
	var v23: C0 := new C0();
	...
	v41[safeIndex(789, v41.Length)] := map[p2 := 0x34a];
	v41[safeIndex(789, v41.Length)] := v38 + (v38 + v38);
	r0 := new C0();
	var v42: array<seq<bool>> := new seq<bool>[14] [v25, [p2], v25, v25, v25, fm9(globalState), v25, v25, v25, fm9(globalState), v25, v25, (v25[safeIndex(-v1, |v25|) := fm12(globalState)])[safeIndex(v1, |v25[safeIndex(-v1, |v25|) := fm12(globalState)]|) := !p2], v25];
	var v43: map<C0, array<seq<bool>>> := map[v23 := v42];
	r1 := if (v23 in v43) then v43[v23] else v42;
	r2 := safeModuloInt(v1, v1);
	r3 := v1;
}
method Main() {
	var v0: array<bool> := new bool[20];
	var v1 := "uwjfy";
	var globalState := new GlobalState(0x1ff, 'o', -937, 29, v0, false, seq(abs(0xdc), i0  => ('u')), seq(abs(0x192), i1  => ('i')), 'y', 0x3b5, false, 'j', 0x334, true, v1 + v1, false);
	var v2 := false;
	var v3 := 0x18d;
	if ((v2 <==> v2) <==> !(v3 >= v3)) {
		var v4: seq<int> := [v3, 92, v3, v3, |multiset{v2}|];
		globalState.f0 := -|fm0(v4, safeModuloInt(v3, v3), globalState)|;
		...
		if (v2) {
			...
			v26[safeIndex(168, v26.Length)] := v25;
			v26[safeIndex(168, v26.Length)] := v25;
			var v27: array<string> := new string[26];
			v27 := new string[1];
			var v28: seq<bool> := [v2];
			globalState.f0 := --safeModuloInt(|v1|, |v28|);
		}
		...
		var v37: array<string> := new seq<char>[1](i3 => seq(abs(0xa8), i4  => (v29)));
		v37[safeIndex(191, v37.Length)] := v1;
		var v38: seq<string> := ["alnbjixe", v1];
		var v39: map<bool, bool> := map[v2 := v2];
		var v40: map<int, string> := map[|v39| := v1];
		var v41: seq<bool> := [v2, v2];
		globalState.f15, globalState.f7, v37[safeIndex(191, v37.Length)] := v38[safeIndex(0x4, |v38|)] <= (fm5(v2, v2, globalState) + v1[safeIndex(|v5|, |v1|) := v29]), (seq(abs(-0x11a), i5  => (v29))) + (if (-|v41| in v40) then v40[-|v41|] else v1), v1;
	} else {
		var v42: map<bool, int> := map[v2 := 726];
		var v43: seq<int> := [if (v2 in v42) then v42[v2] else -0x2c4, |v1|, -0x31d, v3];
		var v44: seq<seq<int>> := [v43, v43, seq(abs(0x29f), i6  => (v3))];
		v44 := v44;
		v0[safeIndex(47, v0.Length)] := v2;
		v0[safeIndex(47, v0.Length)] := true;
		var v45 := DC4(v0[safeIndex(47, v0.Length)], v3, v1);
	...
	if (v2) {
		...
		if (!v53.cf6) {
			...
			v55 := new map<int, int>[17] [v57, v57, v57, map[v3 := v58.cf8], v57[v3 := v3] + v57, fm6(false, v2, v3, 702, globalState), v57 + v59[safeIndex(-0x1e8, |v59|)], v57, v57[v3 := |v60|], v61.cf11, v57, map v63 : int | (-0x346 <= v63) && (v63 < -0x107) :: (v63 - v3) := (v3), v57, v57[v3 := v3], map[0x1be := v3], v57, map v64 : int | v64 in v52 :: (safeModuloInt(v64, v3)) := (0x3df)];
			var v65: map<bool, int> := map[v2 := |v52[safeIndex(v3, |v52|) := v3]|];
			...
			v0[safeIndex(355, v0.Length)] := false;
		} else {
			v0 := v0;
			var v67 := new C0();
			globalState.f0 := v3;
		...
		var v71: array<multiset<bool>> := new multiset<bool>[4] [v70, v70 - v70, v70, v70[v2 := abs(v3)]];
		v71[safeIndex(947, v71.Length)] := v70 * v70;
		v71[safeIndex(947, v71.Length)] := multiset{v2} + v70;
		var v72: C0 := new C0();
		var v73 := DC7(v72);
		v72 := if (v2) then v72 else if (v2) then v73.cf12 else v72;
		if (v2) {
			v72.m0(v68, v3, globalState);
			var v74: array<int> := new int[18](i7 => safeDivisionInt(i7, |{'y'}|));
			...
			var v78: map<map<string, array<int>>, int> := map[v76[safeIndex(|v1|, |v76|)] := safeDivisionInt(v3, v77[safeIndex(-|{v2, v2}|, |v77|)])];
			v78 := v78[v75 + v75 := -0x31e];
			globalState.f13 := v2;
			v74[safeIndex(549, v74.Length)] := v3;
			var v79: multiset<int> := multiset{v3, v3};
			var v80: map<C0, multiset<int>> := map[v72 := v79];
			v74[safeIndex(549, v74.Length)] := 0x26a + (|v80| * v3);
			var v81: set<int> := {|multiset([v2, v2])|};
			var v82: map<bool, int> := map[v2 := v74[safeIndex(549, v74.Length)]];
			var v83: map<bool, char> := map[v81 >= v81 := v1[safeIndex(fm4(fm7(|fm5(true, false, globalState)|, |v82|, globalState), globalState), |v1|)]];
			...
			var v88 := 's';
			v83 := v83[v86[safeIndex(0x3d0, |v86|)] !! multiset{v87[safeIndex(v3, |v87|)], v84, v84} := v88];
		} else {
			var v89: seq<int> := [v3];
			var v90: multiset<int> := multiset{v3};
			var v91: map<seq<bool>, int> := map[[v2] := v3];
			var v92 := 'r';
			var v93: multiset<char> := multiset{fm8(v89, v90[-0x21a := abs(|multiset{v3, v3, v3, v3}|)], v2, fm4(v91, globalState), globalState), v92, v92, v92};
			var v94: seq<int> := [v3, |v93|, fm4(map[[true] := v3], globalState), v3];
			v3 := -v94[safeIndex(-v3, |v94|)];
			var v95: set<bool> := {v2};
			var v96: seq<set<bool>> := [v95, v95, v95, v95];
			var v97: map<seq<int>, C0> := map[[|v96[safeIndex(v3, |v96|)]|] := v72];
			var v98, v99, v100, v101 := m1(v92, seq(abs(981), i9  => (DC0(v92))), v2, v89[safeIndex(v3, |v89|) := |v97|], globalState);
			...
			v72.m0(v102[safeIndex(|v104|, |v102|)], fm4(v91, globalState), globalState);
			var v105 := DC0(v92);
	...
	if (v2) {
		...
		v115[safeIndex(789, v115.Length)] := v3;
		v115[safeIndex(789, v115.Length)] := safeDivisionInt(v3, v3);
		if ((!v2 && v2) <== v2) {
			...
			v115[safeIndex(789, v115.Length)] := -safeModuloInt(safeDivisionInt(0x8e, 898), v115[safeIndex(789, v115.Length)]);
			globalState.f2 := -(if (v2) then -v115[safeIndex(789, v115.Length)] else v3);
		} else {
			v1 := "jkgtl";
			v114 := v114;
			v115[safeIndex(789, v115.Length)] := v115[safeIndex(789, v115.Length)];
		...
		if (v2) {
			...
			v114.m0(v126, v115[safeIndex(789, v115.Length)], globalState);
			var v127: set<bool> := {v2, v2};
			var v128: map<int, int> := map[v115[safeIndex(789, v115.Length)] := |v127|];
			...
			var v133 := DC4(false, v115[safeIndex(789, v115.Length)], v1);
			...
			v137 := map[v115[safeIndex(789, v115.Length)] := v136] + v137;
			globalState.f10 := v2;
		} else {
			var v139: seq<int> := [|(map v138 : int | (-420 <= v138) && (v138 < 0x3c0) :: (v138 + |map[v115[safeIndex(789, v115.Length)] := v2]|) := (multiset{v2, v2, v2, v2, !v2}))|, |v1|];
			var v140 := DC3(v139, v2);
			globalState.f10 := v140.cf6;
			var v141 := new C0();
			globalState.f15 := false;
			var v142: array<string> := new string[23](i10 => v1[safeIndex(v115[safeIndex(789, v115.Length)], |v1|) := 'm']);
			var v143: map<bool, string> := map[!v2 := v1];
			v142[safeIndex(242, v142.Length)] := if (v2 in v143) then v143[v2] else "pojsssw";
			v142[safeIndex(242, v142.Length)] := v1;
			var v144 := DC2(v3);
			v115[safeIndex(789, v115.Length)] := v144.cf4;
		}
		...
		v114.m0(v148, safeDivisionInt(v3, v3), globalState);
		v112[safeIndex(911, v112.Length)] := v114;
		var v149: map<string, C0> := map[v1 := v114];
		globalState.f13, v112[safeIndex(911, v112.Length)] := true, if ("ucwu" in v149) then v149["ucwu"] else v114;
		var v150: map<int, int> := map[v3 := |"dioapv"|];
		v150 := v150[v3 := v3];
		var v151 := 'v';
		v151, v0 := v151, v0;
		globalState.f10 := if (v3 < v3) then v2 ==> v148[safeIndex(-|v1|, |v148|)] else v2;
	}
		...
		decreases 100 - i11
	{
		...
		v152[safeIndex(815, v152.Length)] := [v2];
		var v153: seq<bool> := [v2, !v2];
		v152[safeIndex(881, v152.Length)] := v153 + v153;
		var v154: map<seq<bool>, int> := map[v153 := |v1|];
		var v155: set<bool> := {false};
		v3, globalState.f0, v152[safeIndex(815, v152.Length)], globalState.f9, v152[safeIndex(881, v152.Length)] := v3, v3, v153, fm4(v154, globalState), if (v155 > {true, v2, v2, v2}) then v153 else v153;
		globalState.f9 := safeDivisionInt(if (v2) then v3 else v3, -safeDivisionInt(v3, v3));
		globalState.f2 := v3;
		var v156 := DC2(v3);
		var v157 := DC2(--(if (v2) then v156.cf4 else |v155|));
		match (v156) {
			case DC3(cf5, cf6) =>
				globalState.f10 := (v1 == (seq(abs(0x2a7), i13  => ('m')))) <== cf6;
				...
				v0[safeIndex(333, v0.Length)] := cf6;
				var v162: array<set<bool>> := new set<bool>[2](i14 => v155);
				v162[safeIndex(821, v162.Length)] := v155 * {cf6, v2};
				v0[safeIndex(333, v0.Length)], globalState.f2, v162[safeIndex(821, v162.Length)], cf5 := v2, safeDivisionInt(|"rugsxcnc"|, |cf5|), v155 - fm10(v2, cf6, v3, v161, globalState), cf5;
				v114, globalState.f15, v0[safeIndex(333, v0.Length)] := v114, cf6, v0[safeIndex(333, v0.Length)];
			case DC4(cf7, cf8, cf9) =>
				...
				var v169: seq<int> := [|v165|, safeDivisionInt(-|"mfd"|, v3), cf8 - |v168|];
				globalState.f7, globalState.f9, globalState.f2, v163 := ([v164, v164] + cf9[safeIndex(cf8, |cf9|) := v164]) + (if (!v2) then v1 else v1), v169[safeIndex(v3, |v169|)], cf8, multiset{cf8, cf8, v3, -cf8} * (v163 * v163);
				var v170: array<string> := new string[8] [v1 + v1, v1, "ws", v1 + cf9, ((seq(abs(741), i15  => (v164))) + cf9)[safeIndex(v3, |((seq(abs(741), i15  => (v164))) + cf9)|) := v164], seq(abs(-212), i16  => ('f')), cf9, v1];
				v170[safeIndex(58, v170.Length)] := cf9;
				var v171: seq<multiset<bool>> := [v166];
				v170[safeIndex(58, v170.Length)] := if (v114.fm3(cf7, v2, v171[safeIndex(0x22d, |v171|)], v153, globalState)) then cf9 + cf9 else fm5((DC1(v114.fm3(true, v2, v166, v153, globalState), v2, v2).(cf2 := v2)).cf2, v114.fm3(!cf7, v2, v166, v152[safeIndex(815, v152.Length)], globalState), globalState);
			...
			case DC2(cf4) =>
				...
				v174[safeIndex(947, v174.Length)] := v176;
				v174[safeIndex(947, v174.Length)] := v176;
				var v177 := DC4(v155 !! v155, v3, v1);
				v177 := v177;
				globalState.f9 := fm4(v154, globalState);
			case DC5(cf10) =>
				v114.m0([v2], safeModuloInt(v3, v3), globalState);
	...
	var i17 := 0;
	while (v114.fm3("ipj" < v1, (v195[safeIndex(v3, |v195|) := v190])[safeIndex(v3, |v195[safeIndex(v3, |v195|) := v190]|) := v190] == ([v190])[safeIndex(v3, |[v190]|) := fm11(multiset{v2}, v3, v2, globalState)], v192 * multiset{v2, v2}, v194, globalState))
		decreases 100 - i17
	{
		if (i17 >= 100) {
			break;
		...
		v196[safeIndex(676, v196.Length)] := v1;
		v196[safeIndex(676, v196.Length)] := v1;
		...
		v198[safeIndex(331, v198.Length)] := v197;
		v198[safeIndex(331, v198.Length)] := v197;
		v0 := v0;
		var v199 := new C0();
	}
	var v200: seq<int> := [v3];
	v114.m0(v194, v200[safeIndex(|v1|, |v200|)], globalState);
		...
		decreases 100 - i20
	{
		...
		v114, v202, globalState.f10, v204 := v114, v202, (seq(abs(-0x1e0), i21  => (v189))) !in v205[v1 := fm5(v2, v2, globalState)], v204;
		if (v3 <= v3) {
			globalState.f9 := |v1[safeIndex(793, |v1|) := v189]|;
			var v206: array<array<int>> := new array<int>[5];
			v206[safeIndex(989, v206.Length)] := v202;
			v206[safeIndex(989, v206.Length)] := v202;
			var v207: map<int, int> := map[0x48 := v3];
			var v208: seq<map<int, int>> := [v207];
			var v209: multiset<int> := multiset{v3, |v208[safeIndex(v3, |v208|)]| + v3, v3 + v3, safeModuloInt(v3, v3), v3};
			...
			var v217: seq<map<map<int, bool>, bool>> := [map v214 : map<int, bool> | v214 in v216[safeIndex(v3, |v216|)] :: (v214) := (v2)];
			var v218: set<bool> := {v2};
			var v219 := DC8(v212);
			var v220: array<map<map<int, bool>, bool>> := new map<map<int, bool>, bool>[20] [(map v210 : map<int, bool> | v210 in (seq(abs(-0x294), i22  => (map[v3 := v2]))) :: (v210) := (v2)) + v212, v212, v212, v212, v212, v212, v212[map v213 : int | v213 in v211 :: (v213 + |"t"|) := (true) := v2], v212, v212, v212[v211 := v2], v212[v211 := !v2], v217[safeIndex(v3, |v217|)] + map[(map[v3 := v2])[v3 := v2] := v114.fm3(v2, v2, multiset{v2}, v194, globalState)], v212, v212, v212 + v212, v212, map[map[-|v218| := false] := if (|v191| in v211) then v211[|v191|] else true], v212, v219.cf13, v212];
			v220[safeIndex(351, v220.Length)] := map[v211 := v2] + v212[map v221 : int | (-0x280 <= v221) && (v221 < 0x17) :: (v221 - |v203|) := (v2) := v2];
			v209, v114, v220[safeIndex(351, v220.Length)], v114 := multiset{v3 - -(if (v2 in v203) then v203[v2] else v3)}, v114, if (!v2) then v212 else v217[safeIndex(v3, |v217|)] + (map v222 : map<int, bool> | v222 in {v211} :: (v222) := (false)), v114;
			var v223: array<D1> := new D1[3];
			v0[safeIndex(972, v0.Length)] := v2;
			globalState.f2, v189, v223, v0[safeIndex(972, v0.Length)] := -(v3 * v3), 'v', v223, v2 && v193[safeIndex(v3, |v193|)];
			var v224, v225, v226, v227 := m1(v189, seq(abs(-33), i23  => (DC0(v189))), v2, v200, globalState);
		} else {
			...
			globalState.f2 := safeModuloInt(v3, v3 * v3);
		}
		
	}
	v3 := v3;
	var v232: array<int> := new int[20](i24 => safeModuloInt(i24, -v3));
	v232 := v232;
	v2, globalState.f7 := v2, v1 + v1[safeIndex(v3, |v1|) := v189];
	v2 := multiset{v2} >= v192;
	v232 := v232;
	print v0[7], "\n";
	print v0[12], "\n";
	...
	print globalState.f6 == ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u'], "\n";
	...
	print i11, "\n";
	print v189, "\n";
	print v190 == map['p' := 890], "\n";
	print v191 == map[false := false], "\n";
	print v192 == multiset{false, false}, "\n";
	print v193 == [false], "\n";
	print v194 == [false, false, false, false, true, false], "\n";
	print v195 == [map['p' := 890], map['u' := 2, 'v' := 46, 'k' := 1, 'n' := 1]], "\n";
	print i17, "\n";
	print v200 == [890], "\n";
	print i19, "\n";
	print i20, "\n";
