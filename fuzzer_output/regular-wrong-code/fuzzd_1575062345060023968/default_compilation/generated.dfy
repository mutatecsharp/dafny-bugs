...
function fm6(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<int, int> {
	map[|"otwus"| / -|multiset{|map[false := false]|}| := 342 + |map[-0x291 := false]|]
}
...
function fm10(p0: bool, globalState: GlobalState): bool {
	(map[|map[-|{|{-780}|}| := false]| := 'w'] != (map v0 : int | (-0x147 <= v0) && (v0 < 0x322) :: (v0 % 0xa6) := ('a'))) || (map[false := {|multiset([-0x38e, 0x94])|}] == map[true := {|"rqgqkvonk"|, |(seq(-0xbb, i0  => ('l')))|}])
}
...
function fm17(p0: int, p1: bool, p2: bool, globalState: GlobalState): int {
	(-0x2c5 / |DC68(!false, [0x383]).cf103|) / -152
}
...
function fm25(globalState: GlobalState): seq<int> {
	([|map[-0x385 := true]|, |(seq(-0x3c0, i0  => (|{false}|)))|] + [0x216]) + DC12([-0x268]).cf16
}
function fm26(p0: int, globalState: GlobalState): bool {
	!(false <== !([DC57(map v0 : int | (-0x2cf <= v0) && (v0 < 655) :: (v0 / -0x21f) := (|map['k' := seq(709, i0  => ('q'))]|), 0x377, true).cf88, false, true] < [true]))
}
function fm29(p0: bool, globalState: GlobalState): seq<int> {
	[|map[575 := |(seq(0x3a2, i0  => ('l')))|]|, |[[|multiset{726}|, |map[true := |"nnevjrct"|]|]]|, |(seq(0x2c, i1  => ('p')))|, --0x3be] + ([743] + [-0x20b, 0x18c])
}
function fm30(p0: map<bool, bool>, p1: bool, globalState: GlobalState): D3 {
	DC7(|(multiset(seq(0x97, i0  => (0x3e6))) - multiset{|map[false := |['v', 'a']|]|, --227})|, |("odqpqg" + "ifemlixi")|, 0x163 / -0x200)
}
...
function fm36(globalState: GlobalState): seq<string> {
	match DC94(false, seq(0x148, i0  => ('q'))) {
		case DC93(cf141, cf142) => ["kihmcwi"]
		case DC94(cf143, cf144) => [cf144, cf144, seq(0x2af, i1  => ('s')), "nc"]
		case DC92(cf140) => if (true) then [DC94(false, "bx").cf144, DC35(seq(-0x2d7, i2  => ('i'))).cf51, "nstsb", "sy", seq(229, i3  => ('f'))] else ["ibhcpk"]
	}
}
function fm37(globalState: GlobalState): multiset<set<int>> {
	multiset((seq(646, i0  => ({0x25c, 481, 0xa3, |[-|(seq(0x1d8, i1  => ('c')))|, -0x3d5]|, |(map v0 : int | (0x1e4 <= v0) && (v0 < 0x359) :: (v0 + 0x65) := (DC67(map[false := !false])))|}))) + [{|"eqsuh"|}, {-DC5(-0x2a1).cf6}])
}
function fm38(p0: bool, globalState: GlobalState): string {
	match DC11(DC11(DC11(DC11(DC10()))).cf15) {
		case DC10() => "gxrfo" + (seq(0x106, i0  => ('u')))
		case DC9(cf14) => "ech"
		case DC11(cf15) => DC35(seq(0xc4, i1  => ('q'))).cf51 + (seq(0x27e, i2  => ('p')))
	}
}
...
function fm41(globalState: GlobalState): seq<int> {
	[--|"m"|, -227, |{false, true}|, |(seq(0x15, i0  => ('b')))|, 0xc0] + ((seq(0x133, i1  => (0x2ff))) + (seq(0x28f, i2  => (0x1d7))))
}
...
function fm51(p0: bool, p1: char, p2: int, p3: bool, globalState: GlobalState): map<int, int> {
	map[|"nrmn"| := -(|multiset{!false, false, true, true}| / 332)]
}
function fm52(p0: int, globalState: GlobalState): set<int> {
	{|{true, false}|, |(map[|map[|"lsqwd"| := true]| := -0x32c] + map[-|(seq(16, i0  => ('w')))| := 0x3b8])|}
}
...
function fm54(globalState: GlobalState): D5 {
	match DC60(multiset{-0x104, -0x355, |"cvh"|}) {
		...
		case DC62(cf93, cf94, cf95, cf96) => DC13(cf95, DC2(cf94), |(seq(0x3ca, i0  => (cf93)))|)
...
function fm56(p0: bool, p1: int, globalState: GlobalState): bool {
	(|(seq(0x2e1, i0  => ('r')))| >= 0x1e5) <==> !(if (!false) then DC15(!!!!!true, 'c', |['k', 'c']|, 'h').cf21 else true)
}
...
function fm59(globalState: GlobalState): multiset<int> {
	(multiset{-0x180, |{-|map[false := true]|, 0x30a, |{false}|}|} + multiset([|{|(map v0 : int | (-0x184 <= v0) && (v0 < 649) :: (v0 / |"flgqcg"|) := (220))|, 0x1a}|])) * (multiset{0x9e} + multiset{|multiset{true}|})
}
...
function fm62(globalState: GlobalState): seq<seq<bool>> {
	([[false]] + [[true], [true, true, false, false, false], [!false]]) + (seq(-0x2b4, i0  => ([true])))
}
function fm63(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): set<D5> {
	match DC28(multiset([[512]])) {
		...
		case DC30(cf46) => {DC13(0x2e1, DC2(true), |map[|[false]| := |[false]|]|), DC13(0x16a, DC2(true), DC74(-0x2e9).cf109)} + (set v0 : D5 | v0 in (seq(0x1fb, i0  => (DC13(|map[true := 'b']|, DC2(false), 997)))) :: (v0))
	}
}
...
function fm65(p0: int, globalState: GlobalState): map<multiset<int>, set<int>> {
	map[multiset{|{-697, -0x328, |(seq(-999, i0  => ('p')))|, -0x1de}|} := {-520, -139}]
}
...
function fm72(p0: map<int, bool>, globalState: GlobalState): map<map<int, int>, int> {
	map v0 : map<int, int> | v0 in map[map[-0xba := |[-263]|] := multiset{true, false, true, true}] :: (v0) := (-(0x2c6 / |[false]|))
}
function fm73(globalState: GlobalState): D3 {
	DC6(|(seq(-0x13e, i0  => ('t')))|, if (true) then --0x218 else |[[|{false}|]]|, --432 % |{false, true}|)
}
...
function fm80(p0: int, globalState: GlobalState): D15 {
	if ('n' !in "edkhfawu") then DC36(|"oekr"|, false, 0x1d3, !false, 0x313) else DC36(0x130, true, |multiset{false}|, false, |(map v0 : int | (526 <= v0) && (v0 < 0x61) :: (v0 % 0x2cf) := (false))|)
}
function fm81(p0: int, p1: int, p2: string, globalState: GlobalState): D15 {
	match DC11(DC11(DC9({[-0x2db, |[-304]|], [0x137]}))) {
		...
		case DC11(cf15) => DC37(DC37(DC35(seq(0x3b4, i0  => ('g')))))
	}
}
...
function fm84(p0: set<int>, p1: int, p2: map<int, int>, p3: bool, globalState: GlobalState): multiset<string> {
	multiset(match DC20(-0x131, |(seq(211, i0  => ('t')))|) {
		case DC20(cf28, cf29) => ["k"]
		case DC19(cf27) => cf27
	})
}
function fm85(globalState: GlobalState): seq<multiset<int>> {
	if ('b' !in "iacnyll") then [multiset([|multiset{false}|])] else [multiset{|(seq(0x2e9, i0  => ("qann")))|, 0x25a}, multiset{|multiset{true, !true}|, 0x32f, -0x278}] + [multiset{0x1f1}]
}
function fm86(p0: int, p1: bool, p2: set<bool>, globalState: GlobalState): D18 {
	match DC4({-296}) {
		case DC4(cf5) => DC41(|multiset{false}|, seq(0xd7, i0  => ('s')), true)
	}
}
...
function fm88(globalState: GlobalState): D4 {
	match DC7(-0x1f2, |{|(seq(0x260, i0  => (694)))|}|, |(seq(0x24e, i1  => ('b')))|) {
...
function fm89(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D12 {
	DC28(multiset([seq(91, i0  => (|map[false := false]|)), seq(0x2df, i1  => (-0x2e0))] + [[-0x1fe], [|map[true := 'd']|]]))
}
function fm90(globalState: GlobalState): D26 {
	match if (true) then DC0() else DC0() {
		case DC0() => DC62('k', !true, |(map v0 : int | v0 in (map v1 : int | (0x2cd <= v1) && (v1 < 0x210) :: (v1 * |multiset{!!true}|) := (true)) :: (v0 - |(map v2 : int | (0x2d6 <= v2) && (v2 < 0x110) :: (v2 - |multiset{|map[true := |(seq(0x169, i0  => ('t')))|]|}|) := (0x35c))|) := (true))|, [false])
...
function fm91(p0: bool, p1: bool, globalState: GlobalState): D15 {
	DC35("dshx" + (seq(0x3ae, i0  => ('b'))))
}
function fm92(p0: int, p1: int, p2: bool, globalState: GlobalState): map<seq<bool>, bool> {
	map v0 : seq<bool> | v0 in (seq(0x399, i0  => ([false]))) :: (v0) := (|map["rbomiycjd" := 0xf6]| >= |"rcibkmjpl"|)
}
...
function fm94(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): D19 {
	match if (false) then DC9({[|"yqda"|, 753]}) else DC9(set v1 : seq<int> | v1 in (map v0 : seq<int> | v0 in multiset{[-0x18f], [|(seq(0x28, i0  => (0x187)))|, 0x94]} :: (v0) := ('f')) :: (v1)) {
...
function fm96(p0: int, p1: int, p2: bool, globalState: GlobalState): seq<seq<int>> {
	[seq(0x3a3, i0  => (|[|"nlc"|, |"mta"|]|)), [|map[true := -0xe]|], [|multiset([true])|]] + ([[0x2df, 0x1bc]] + [[|"s"|]])
}
...
function fm98(globalState: GlobalState): map<bool, map<int, bool>> {
	match DC8(DC8(DC6(0x3a2, |(seq(0x27d, i0  => (61)))|, -0x360))) {
		case DC6(cf7, cf8, cf9) => map[!false := map[cf9 := true]] + map[true := map v0 : int | (-574 <= v0) && (v0 < 820) :: (v0 / cf9) := (false)]
...
function fm99(p0: int, p1: bool, globalState: GlobalState): set<seq<int>> {
	set v2 : seq<int> | v2 in ({seq(0x65, i0  => (-|map[0x16a := !false]|))} * (set v1 : seq<int> | v1 in (set v0 : seq<int> | v0 in multiset{seq(977, i1  => (0x64))} :: (v0)) :: (v1))) :: (v2)
}
function fm100(globalState: GlobalState): D26 {
	DC60(if (!!true) then multiset{|map[|map[-0x2db := false]| := |map[false := false]|]|, |"aewhfcqn"|, |[|map[!true := false]|]|, 0, |map[|map[true := |[!false]|]| := |multiset([0xc])|]|} else multiset{|"x"|, |(seq(0x33d, i0  => (554)))|})
}
function fm101(p0: string, globalState: GlobalState): seq<set<bool>> {
	match DC74(|[true]|) {
		case DC74(cf109) => seq(0x54, i0  => ({!true, false}))
		case DC73(cf108) => [{true}, {false, true}] + [{false, true}, {false}]
	}
}
function fm102(globalState: GlobalState): D21 {
	if (-0x28 != -|(seq(-0x2, i0  => ('e')))|) then DC50(multiset{'h'}) else DC50(multiset{'d'})
}
trait T0 {
	var f2 : bool
	var f3 : bool
...
class C0 {
	...
	function fm44(p0: D3, p1: int, p2: bool, globalState: GlobalState): bool {
		(multiset(seq(0x1b7, i0  => (DC9({[|map[true := |multiset{false}|]|]})))) + multiset([DC9({[961, 0x3e4]})])) == multiset{DC9({seq(-0x13c, i1  => (|map[true := !false]|))})}
	}
...
class C1 extends T1 {
	...
	function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		-|(((seq(-0x350, i0  => (f24))) + (seq(0x8d, i1  => (|"uoddq"|)))) + ((seq(0x261, i2  => (f24))) + [f24]))|
	}
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		for i0 := -f24 to f24 {
			var v0 := new C0();
			if (p1.f2) {
				...
				var v11 := "sqndayga";
				p1.f3, globalState.f0, v8[476] := v10 > (multiset{v9} - multiset(seq(0xd8, i3  => (v9)))), |v11|, v7;
				globalState.f0 := i0;
			} else {
				var v12 := new C0();
				var v13 := new C0();
				var v14: multiset<bool> := multiset{p1.f2};
				var v15: multiset<int> := multiset{if (p0[f24] in v14) then v14[p0[f24]] else i0, f24 * -399};
			...
			globalState.f0 := f24 * (i0 / |(seq(-0x39d, i4  => (f25)))|);
			var v17: set<int> := {0x31f % f24, f24};
			v17 := v17;
		}
		var v18 := new C0();
		f3 := f3;
		...
		if ((if (f5 in v19) then v19[f5] else false) <==> p1.f2) {
			...
			var v25 := "kyhkdj";
			v24[615] := v25;
			v24[615] := seq(260, i5  => (v20));
			var v26: seq<string> := [v25];
			v24[615] := v26[p2[333]] + v24[615];
		...
		var v50: seq<int> := [f24];
		var v51: array<int> := new int[13] [f24 * f24, 0x39b, -0x83 - f24, if (p1.f2) then f24 else f24, f24 / |v49|, --f24, v50[f24], f24, f24 % v50[f24], f24, f24, f24, |v19|];
		p2[869] := -f24;
		var v52: map<string, array<map<D6, bool>>> := map[fm49(f25, !p1.f3, globalState) := v48];
		v48, v51, p2[869], f3 := if ("uj" in v52) then v52["uj"] else v48, v51, f24, p1.f3;
		if (p1.f2) {
			...
			if (p0[f24 - p2[869]]) {
				...
				v58 := if (!p0[f24]) then v58 else v58;
				var v59: seq<array<bool>> := [v58, v58];
				var v60: multiset<bool> := multiset{p1.f2, f4, f4};
				v58 := v59[|multiset{!p1.f3}| % (if (f2 in v60) then v60[f2] else p2[869])];
				var v61 := 'k';
				v61 := fm48(f3, globalState);
				var v62: map<int, int> := map[p2[869] := -p2[869]];
				p1.f2, v62, p1.f2 := !v18.fm44(v47, -f24 - f24, p2[869] >= -p2[869], globalState), map[|(p0 + p0)| := |(p0 + p0)|], v18.fm44(v47, p2[869] % p2[869], p1.f3, globalState);
			} else {
				var v63: map<int, bool> := map[|v50| := p1.f3];
				var v64 := "bf";
				var v65: map<set<map<int, int>>, seq<bool>> := map[fm50(p1.f3, |v63|, v64[f24], globalState) := p0];
				var v66: map<int, int> := map[p2[869] := p2[869]];
				v65 := v65[{v66, fm51(f3, f25, |v64|, !false, globalState)} := [v18.fm44(v47, f24, p1.f3, globalState)]];
				var v67: array<bool> := new bool[8];
				v67[163] := p1.f3;
				v67[163] := !(fm52(|v64|, globalState) >= (v49 + v49));
				...
				v19, p2[869], v67[163], p2[869], p2[869] := (if (p1.f3) then v19 else v19) + v19, fm0(p1.f3 <==> p1.f3, |[f3, f5, !f5, p1.f2]|, p2[869], globalState), (v69 + v69) >= v69, p2[869], (p2[869] - f24) / (|v50| % 0x251);
				p2[869] := p2[869];
			}
			
			var v70: multiset<bool> := multiset{f4, p1.f2, f4, p1.f2};
			globalState.f0 := f24 * (if (f4 in v70) then v70[f4] else p2[869]);
			if (f2) {
				var v71: array<bool> := new bool[8](i6 => false);
				v71[945] := f2;
				v71[945], v19, p2[869] := p1.f2, v19[p1.f3 <==> f4 := f3], f24;
				var v72: map<char, char> := map[fm48(f3, globalState) := f25];
				p2[869] := -|(fm53(-f24, f5, f3, globalState) + v72)|;
				p1.f3 := (v70 - v70) > (multiset(p0) - v70);
				var v73: map<int, int> := map[p2[869] := p2[869]];
				var v74: seq<char> := ['e', f25, f25];
				var v75: map<map<int, int>, seq<char>> := map[v73 := v74];
				globalState.f0 := |v75[map v76 : int | (0x398 <= v76) && (v76 < 0x3e0) :: (v76 + p2[869]) := (p2[869]) := v74]|;
				globalState.f0, p1.f3, globalState.f0 := f24, f4, f24;
			} else {
				var v77: multiset<int> := multiset{-256, p2[869], v47.cf6};
				var v78 := "kctbyse";
				var v79 := DC2(p1.f2);
				var v80 := DC13(|v78|, v79, p2[869]);
				...
				v78 := "rkrdx" + ((if (p1.f3) then "bwqpo" else v78[p2[869] := f25])[f24 := f25])[f24 := f25];
				var v83: array<set<char>> := new set<char>[26](i7 => {v78[p2[869]]});
				var v84: set<char> := {'r', f25};
				v83[338] := v84;
				globalState.f0, v83[338], globalState.f0 := (|(map v85 : int | (0x35f <= v85) && (v85 < 0x2f4) :: (v85 + |v49|) := (p2[869]))| - p2[869]) / p2[869], v84, |(seq(0x105, i8  => (f25)))|;
				globalState.f0, f3 := f24 * f24, f4;
				var v86: multiset<D10> := multiset{v54, v54, v54, DC22(v53), v54};
				var v87: map<int, multiset<D10>> := map[f24 := v86[v54 := f24]];
				v87 := map[fm0(f2, v50[p2[869]], f24, globalState) := multiset{v54}] + map[f24 := v86[v54 := 0x12d]];
			}
			
			var v88: array<array<int>> := new array<int>[2];
			var v89 := DC23(f3, v88, f4);
			p2[869] := if (v89.cf32 in v70) then v70[v89.cf32] else fm0(f2, f24, -0x313, globalState);
		} else {
			var v90 := "j";
			v90 := v90;
			f2 := f3;
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			match (v3) {
				case DC13(cf17, cf18, cf19) =>
					...
					var v11: array<array<bool>> := new array<bool>[29] [v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, if (f25 in v7) then v7[f25] else v6, v6, v6, v6, v6, v6, v6, v6, v6, v6, if (cf19 in v8) then v8[cf19] else v6, v10[cf19], v6, v6];
					var v12 := DC24(v6);
				...
				case DC12(cf16) =>
					...
					var v17: array<bool> := new bool[10] [f5, p3, p3, v15[f24] !in v16[f25 := f5], p3, !false, f3, f2, f2, f3];
					v17[603] := fm56(!fm56(!f2, 777, globalState), f24, globalState);
					p1[428] := 0x3cb;
					var v18: seq<bool> := [if (f24 in v1) then v1[f24] else f5];
					var v19: array<int> := new int[4] [f24 * f24, |(fm57(seq(987, i3  => (|{v15[f24 := f25]}|)), globalState) + v18)|, f24, f24];
					...
					f2, v17[603], p1[428], v19 := v0 <= (if (|v21| in v20) then v20[|v21|] else if (f5 in v22) then v22[f5] else v0), v23 == {f24, f24, f24, f24, f24}, |(v23 + (v23 * {f24, f24, |v26|}))|, p1;
					f3 := p3;
					v17[603] := f5;
					var v27: map<seq<int>, bool> := map[cf16 := fm56(f4, p1[428], globalState)];
					var v28: map<map<seq<int>, bool>, array<bool>> := map[v27 := v17];
					v17 := if (map[cf16 := v17[603]] in v28) then v28[map[cf16 := v17[603]]] else v17;
			}
			...
			if (f4) {
				...
				var v32: multiset<int> := multiset{p1[879], p1[879], |multiset{true, f2, true, p2}|};
				v29[771], p1[879], globalState.f0, v31, globalState.f0 := !f4 && p3, fm0(f24 < p1[879], f24 * -f24, p1[879], globalState), p1[879] / |v32|, v31, |v2| * p1[879];
				v29[771] := fm56(p2, f24, globalState);
				var v33: set<int> := {p1[879]};
				var v34: set<int> := {|v33|};
				var v35: seq<set<int>> := [v33];
				v29[771] := fm52(-p1[879], globalState) !in v35[|v33| := v34];
			} else {
				r1 := f24 == f24;
				r1 := f2;
				var v36: array<string> := new string[9];
				var v37 := "ybfcu";
				v36[275] := v37 + "olrhuiljo";
				var v38: array<bool> := new bool[16](i4 => f3);
				v38[873] := f3;
				p1[447] := f24;
				var v39 := DC28(multiset{v2});
				v36[275], v38[873], globalState.f0, p1[447] := v37, f5, 0x252, |v39.cf45[seq(-872, i5  => (f24)) := f24]|;
				var v40: array<int> := new int[11];
				var v41: seq<array<int>> := [v40];
				v38[873] := fm56([v40] < v41, -0x316, globalState);
				v38[873] := !f2;
			}
		...
		if (f5) {
			...
			v58[544] := (seq(107, i6  => ('i'))) + fm49(if (f3 in v59) then v59[f3] else f25, f4, globalState);
			...
			if (f3) {
				...
				v73[182] := f3;
				v73[182] := f2;
				r0 := (if (f2) then f24 else --f24) / f24;
			}
			
		} else {
			var v74: array<bool> := new bool[10];
			v74[12] := f2;
			var v75: seq<int> := [|v45| * f24, -(f24 / f24), |v45|, f24 * f24];
			v74[12], v75, v49 := f5 <==> f4, v75, (v49 * (set v76 : int | v76 in v75 :: (v76 * |multiset([true, false, false])|))) - v49;
			var v77 := DC1(v43, v74[12], f24);
			match (v77) {
				case DC0() =>
					var v78: multiset<char> := multiset{f25};
					v74[12] := v53 == map[|v78| := f24];
					var v79 := DC32();
					v79 := if (!f4) then v79 else v79;
					globalState.f0 := (v77.(cf1 := f3)).cf2;
					var v80 := new C0();
				case DC1(cf0, cf1, cf2) =>
					var v81: multiset<int> := multiset{v75[|fm58(globalState)|]};
					...
					var v90: map<set<int>, array<bool>> := map[v89[f24] := v74];
					v90 := v90[v49 := v74];
				case DC2(cf3) =>
					f2 := f4;
			...
			v74[12] := (23 - f24) > fm0(p3, f24, f24, globalState);
		...
		for i7 := 0x311 - f24 to |(if (p2 in v95) then v95[p2] else v94)| {
			...
			v98[374] := p2;
			v98[374] := (if (f3 in v54) then v54[f3] else f2) <==> p3;
			var v99: seq<int> := [i7, i7];
			var v100: array<array<int>> := new array<int>[1];
			var v101 := DC23(fm56(v98[374], |v99|, globalState), v100, v98[374]);
...
class C2 extends T2, T0 {
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		...
		if (true) {
			...
			v7[162] := v8 != (map v9 : int | (0x14a <= v9) && (v9 < 0x2d9) :: (v9 * |multiset{f7}|) := (f7));
			var v10: multiset<int> := multiset{f6};
			var v11 := "nlshvadk";
			var v12: multiset<multiset<int>> := multiset{v10[f7 := |v11|], v10 * v10};
			v12 := (multiset{v10} - v12) + v12;
			globalState.f0 := -(f7 * |v5|);
			if ((|v11| % -f7) != (f6 * v0[f7])) {
				var v13: array<int> := new int[27](i1 => i1 % f7);
				v13[207] := f7;
				v13[207] := f6 - fm43(f7, globalState);
				var v14: map<bool, bool> := map[true in map[f4 := f6] := f5];
				v7[162] := if (v7[162] in v14) then v14[v7[162]] else false;
				var v15 := DC6(|v0|, f6, v13[207]);
				v7[162] := -v15.cf9 <= f6;
				globalState.f0, v13[207], v13[207] := f6 - (|map[f6 := 0x159]| - f6), f7, f7;
				r0 := f4;
			} else {
				f2 := v5[f6];
				var v16 := new C0();
				globalState.f0 := -(|"cnnvlkmrv"| % f6);
				...
				v21[170] := f7;
				var v22 := 't';
				v18, globalState.f0, r0, v19, v21[170] := v18, f7, f3, fm46(v22, v11, 0x97, globalState), |(v0 + v0)|;
				globalState.f0 := f7 / v21[170];
			}
			
			v11 := v11;
		} else {
			globalState.f0 := fm0(f4, 0x398, f6 / 0x22d, globalState);
			var v23 := 'j';
			...
			var v34 := "nse";
			var v35: array<bool> := new bool[20] [if (f4) then f3 else f3, f3, v29.cf3, f5, f3, f23, f4, f5, !f2, f5, f2, v30 > v30, v25.fm44(v33, f6, f5, globalState), f4, f4, !(v34 <= "r"), !f3, v25.fm44(v33, f7, f4, globalState), f23, v5[f7]];
			v35[424] := v5[f7];
			v35[424] := f6 < fm2(f6, globalState);
		}
			...
			decreases 100 - i2
		{
			...
			if (f5) {
				...
				v44[209] := !(f6 > f6);
				v44[209], globalState.f0, globalState.f0 := ("fenusdws" == (seq(125, i4  => ('s')))) && (f7 == f6), f7, if (f2) then f7 else 0xee;
				var v45: map<bool, int> := map[true := f6];
				var v46: set<array<bool>> := {v44};
				var v47: multiset<int> := multiset{|v46|};
				var v48: array<int> := new int[25] [fm1(f6, globalState), 0xf5, 400, -f7, f7, f7 % 499, f6, f6, f7 + |v0|, f6, f7 + -0x1d4, -f6, if (f4) then f6 else f6, f7 % f6, -f6, -f7, f7 % f7, |v0|, |v45| * f6, |v47| * f6, -(f6 / 679), f6, f7, f6, f6];
				v48[550] := f7 * fm43(f7, globalState);
				var v49 := "jtuoceiue";
				v48[550] := |v49| / f7;
				var v50 := DC5(DC6(|v5|, -0x6b, f6).cf8);
				var v51: map<int, seq<bool>> := map[|map[v43.fm44(v50, 0x3d4, f2, globalState) := 0x1bd]| := v5];
				var v52 := DC2(f3);
				var v53: set<bool> := {f3, v44[209]};
				var v54: map<bool, bool> := map[f4 := !v44[209]];
				var v55: map<set<bool>, map<bool, bool>> := map[v53 := v54];
				var v56 := DC16(v5);
				var v57: array<seq<bool>> := new seq<bool>[21] [v5 + v5, if (f6 in v51) then v51[f6] else v5, v5, v40.fm45(f2, DC13(f6, v52, f6).cf17, v55, globalState), [v44[209], v44[209], f4, f4] + v5, v5, v5, v5[v48[550] := f4], v5 + v5, [f2, f2] + v5, v56.cf25, v5, v5, v5, v5 + v5, [f3], v5, v5 + [f23], if (f4) then v5 else v5, v5, [f3, f23, v43.fm44(v50, f7, f2, globalState)]];
				v57[755] := [f5] + [!f3];
				v57[755] := (v5 + v5) + v5;
				v48[550] := f6;
			}
		...
		var v63 := 'i';
		r1 := v63;
		var v64: array<int> := new int[21](i6 => i6 / |"ft"|);
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		if (!(v6 in v7)) {
			...
			match (v8) {
				case DC10() =>
					...
					v7 := if (fm56(v12.f5, p2[659], globalState)) then v7 else v7;
					var v15: map<int, bool> := map[fm1(p2[659], globalState) := v12.f2];
					var v16: map<int, int> := map[if (f3) then f6 else |v15| := fm43(p2[659], globalState)];
					v16 := v16 + (v16 + v16);
				case DC9(cf14) =>
					p2[659] := f6;
					v7 := v7;
				...
				case DC11(cf15) =>
					...
					v20[310] := v21;
					v7, p1.f2, globalState.f0, v20[310], globalState.f0 := "duwvvkxsl" + ("ympham")[p2[659] := v6], p1.f3, -p2[659], v21, f7;
					var v22: set<bool> := {f4};
					var v23: seq<string> := [v7];
					var v24: map<bool, D8> := map[{f5} >= v22 := DC19(v23)];
					v21[45] := f5 && f4;
					v24, v21[45] := v24, p1.f2 || f3;
					v21[45] := fm56(v6 in v7, -|v3|, globalState);
			}
			
			var v25: map<int, bool> := map[p2[659] := f2];
			var v26: seq<map<int, bool>> := [v25 + v25];
			var v28: set<int> := {344, p2[659], -|v3|, |(map v27 : char | v27 in v7 :: (v27) := (f7))|, 0x31e};
			var v29: array<string> := new string[20];
			v29[550] := fm49('j', f4, globalState) + v7;
			v26, f3, v28, v29[550], p1.f3 := [v25, map[f6 := f3], v25] + (seq(0x70, i1  => (v25))), f5, set v30 : int | (0x2c0 <= v30) && (v30 < -0x21a) :: (v30 * f7), if (p1.f3) then v7[f7 := v6] else "clar", v28 >= v28;
			var v31: array<array<bool>> := new array<bool>[29];
			var v32: array<bool> := new bool[22];
			v31[562] := v32;
			var v33: map<bool, seq<bool>> := map[f4 := p0];
			v31[562], p2[659] := v32, (|map[v6 := if (|v33| in v2) then v2[|v33|] else 936]| % 0x1bf) / f6;
			var v34: map<bool, bool> := map[p2[659] != f6 := f3];
			p1.f2 := if (f5 in v34) then v34[f5] else p2[659] != |map[f7 := f6]|;
			var v35: array<set<bool>> := new set<bool>[27](i2 => {f23, p1.f2} * {f5});
			v35 := v35;
		} else {
			var v37: array<multiset<map<int, int>>> := new multiset<map<int, int>>[24](i3 => multiset{map[|map[v7 := f7]| := f7], map v36 : int | (-0x1b <= v36) && (v36 < 0x62) :: (v36 + f7) := (f6), map[f7 := p2[659]]} * multiset{map[p2[659] := p2[659]]});
			var v38: map<bool, bool> := map[f3 := p1.f2];
			var v39: seq<map<bool, bool>> := [v38, v38];
			var v40: map<int, int> := map[p2[659] := |v39|];
			var v41: multiset<map<int, int>> := multiset{v40};
			v37[498] := v41 * v41;
			var v42: seq<map<int, int>> := [v40];
			f3, p2[659], v37[498], p1.f2 := !fm56(f2, f7, globalState), 0xc7, multiset(v42 + v42) * multiset{v40}, p1.f2;
			globalState.f0 := f7;
			...
			v45[178] := fm56(f23, f7, globalState);
			v44, globalState.f0, globalState.f0, p1.f2, v45[178] := v44 + v44, p2[659] - -0x204, f7 + (f6 - |p0|), p2[659] !in (if (p1.f3) then [p2[659], -0x2dd] else v3[f6 := -f7]), !f3 || p1.f2;
			var v46: multiset<bool> := multiset{true, f23};
			var v47: map<bool, multiset<bool>> := map[f23 := v46];
			var v48 := DC2(f3);
			var v49 := new C1(|(if (f5 in v47) then v47[f5] else v46)|, v6, p2[659] == 0x1db, p1.f3, f3, v48.cf3);
			var v50: array<D8> := new D8[27];
			var v51: seq<string> := [v7];
			var v52 := DC19(v51);
			v50[130] := v52;
			v50[130] := if (v45[178]) then v52 else DC19(v51);
		}
			...
			decreases 100 - i4
		{
			...
			v53 := (v53 + v53) + v53;
			p2[659] := f7;
			p2[659], p1.f2 := fm42(fm42(f6, f4, globalState) - p2[659], p1.f3, globalState), !(p1.f3 ==> f3);
			...
			decreases 100 - i6
		{
			...
			p1.f2 := p0[|v7| + f6];
			v6 := 'f';
			var v55: array<D7> := new D7[28](i7 => DC16(p0[f7 := p1.f2]));
			var v56 := DC16(p0);
			v55[556] := v56;
			v55[556] := DC16(p0[f6 := f5]);
			globalState.f0 := 727 + p2[659];
		}
	}
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		f2 := !!(|(v1[v0 := f7] - multiset(v2))| !in (v3 + v3));
		for i0 := f6 to f7 {
			var v4 := "smdntxgu";
			v4 := v4 + (v4 + v4);
		...
		for i3 := f6 to f7 {
			...
			f2 := !(v15 != v15);
			p1[138] := i3;
			p1[138] := -(if (p2) then -f6 / 0x1ad else i3);
			globalState.f0 := i3;
	...
	method m18(globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: array<map<int, int>>) {
		...
		v0[280] := if (f7 in v4) then v4[f7] else v1;
		f3 := f3;
		if (fm56(f5, f6, globalState)) {
			...
			if (f4) {
				...
				var v12: array<array<array<int>>> := new array<array<int>>[23] [v9, v9, v9, v9, v9, v9, v9, v9, if (f6 in v10) then v10[f6] else v9, v9, v9, v9, v9, v9, v9, v9, v11[f6], v9, v9, v9, v9, v9, v9];
				v12[295] := v9;
				v12[295], globalState.f0 := v9, f7;
				var v13: seq<bool> := [f3];
				...
				var v26: array<multiset<D0>> := new multiset<D0>[16] [v18 - (v19[134])[v17 := |v21.cf51|], if (true) then v18[v17 := f7] else multiset{v17}, v18[fm60(globalState) := |v20|], v18, v18, v18, v18, v18, v18 - v18, v18, v18, v18[DC2(f23) := f7], v18, v18, v18[v17 := f7], fm61(f6, f2, |(map v22 : multiset<bool> | v22 in v25 :: (v22) := (true))|, globalState)];
				v26[505] := v18;
				v16[810], f3, v26[505] := f7, f23, multiset{DC2(true)} + v18;
				var v27: seq<array<int>> := [v16, v16, v16, v16];
				v27 := v27 + (v27 + v27);
				r0, v13 := !f5, v13 + v14;
			} else {
				var v28 := "px";
				var v29: seq<int> := [-|v28|, f6, f7, |(seq(0x10c, i0  => ('f')))|];
				var v30: set<bool> := {f3};
				var v31: map<set<bool>, char> := map[v30 := v28[f6]];
			...
			var v48: array<int> := new int[21](i1 => i1 % |map[f23 := DC2(!f5).cf3]|);
		...
		for i5 := f7 to f6 {
			match (DC26(f6, v62, f3, f3, 18)) {
				...
				case DC26(cf39, cf40, cf41, cf42, cf43) =>
					...
					var v73 := "nxutc";
					var v74 := 'v';
					var v75: map<int, string> := map[i5 := v73[cf39 := v74]];
					v73, v62[984], globalState.f0 := (if (i5 in v75) then v75[i5] else v73) + v73, v62[984], cf43 + (f7 % cf43);
					...
					globalState.f0 := v62[984];
				case DC24(cf35) =>
					var v78: map<bool, bool> := map[f3 := f4];
					var v79 := DC26(|v78|, v62, f2, f5, i5);
					globalState.f0 := v79.cf43;
					var v81: array<seq<int>> := new seq<int>[13](i7 => [DC36(|(map v80 : char | v80 in (seq(0xc9, i8  => ('k'))) :: (v80) := (f5))|, f5, i5, f2, |['p']|).cf56, -f7, -0xf3, 0x216]);
					var v82: seq<int> := [f6];
					var v83: seq<int> := [|v82|, f6, f6];
					v81[956] := if (f5) then v82 else [f7];
					globalState.f0, v81[956], f3 := f7 - -f6, v83[106 := i5 - --i5], (f6 * -0x240) <= f6;
					var v84 := 'd';
				...
				case DC27(cf44) =>
					var v86 := 'x';
					var v87: seq<bool> := [f5];
					var v88: seq<seq<bool>> := [v87, v87, (v87[0x28d := false])[f6 := f4], v87];
					var v89 := new C1(f7, v86, true, fm56(false, 0x27c, globalState), true, fm62(globalState) < v88[f6 := v87]);
					f2 := f2;
...
class C3 extends T2 {
	...
	function fm1(p0: int, globalState: GlobalState): int {
		|("qfl" + (seq(0x98, i0  => ('i'))))| * 0xc9
	}
	function fm2(p0: int, globalState: GlobalState): int {
		--(|(["dkh"] + DC19(["yj"]).cf27)| / |("mnu" + "waoyux")|)
	}
	function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		f7 - f6
	}
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		var v0: array<int> := new int[13](i0 => i0 % 992);
		...
		if (match DC19([v2]) {
			...
			if (f5) {
				...
				v3[788] := !!f5;
				var v4 := 'o';
				var v5 := DC15(true, v4, v0[866], v4);
				f2, v3[788] := v5.cf23 < (v0[866] * f6), f5;
				v0[866] := if (false) then -f7 else v0[866];
				...
				v1 := v1[v0[866] / f7 := (if (f4 in v11) then v11[f4] else -912) - |"auokjjf"|];
				f3 := !(fm2(f7, globalState) < (v0[866] / f6));
			}
			...
			r2 := f5 && f5;
			if (f4) {
				var v14: multiset<int> := multiset{v0[866], |(seq(232, i2  => ('u')))|, f6};
				var v15: array<bool> := new bool[11] [v14 >= v14, !f4, f3, f4, f4 && f2, f2, true, f2, f5, false, f4];
				v15[186] := fm40(globalState);
				var v16: set<bool> := {f4};
				var v17: map<bool, int> := map[f4 := v0[866]];
				var v18: seq<int> := [|v16|];
				v15, v15[186], v0[866], r0 := v15, (v16 * {f5}) > v16, -v0[866], !([0x18d, if (f5 in v17) then v17[f5] else f7] <= (v18 + fm41(globalState)));
				f2 := !(v14 < v14);
				v0[866] := |v2|;
				f2, v0[866] := f3, v0[866];
				var v19 := new C0();
				...
				v21 := v21[f2 := f7];
				var v23 := 'h';
				var v24: map<char, seq<int>> := map[v23 := seq(0x10a, i3  => (f7))];
				var v25: map<char, map<char, seq<int>>> := map[v23 := v24];
				var v26: map<char, int> := map[v23 := f7];
				v0[866], globalState.f0, v0[866], f3 := v0[866], |((map v22 : char | v22 in (if ('p' in v25) then v25['p'] else v24) :: (v22) := (f7)) + v26)[v23 := v0[866]]|, -f7, f4;
				var v27: multiset<int> := multiset{f6 - fm0(f2, f7, v0[866], globalState), f6};
				v0[866], v27 := f7, fm59(globalState);
				var v28: map<int, string> := map[f6 := v2[v0[866] := v23]];
				var v29: set<bool> := {(if (-f6 in v28) then v28[-f6] else "l") < v2};
				v29 := v29 + v29;
			}
			
			if (f2) {
				var v30 := DC20(f6, v0[866]);
				...
				v0[866] := fm0(f5, f6 % |v36|, fm0(f3, f6, f7, globalState), globalState);
				var v37: seq<int> := [if (v0[866] in v1) then v1[v0[866]] else f7, f7];
				var v38 := DC12(v37);
				var v39: map<bool, seq<int>> := map[f4 := v37];
				var v40: multiset<bool> := multiset{f2};
				var v41: map<int, seq<int>> := map[-v0[866] := seq(-0x3c9, i5  => (|v2|))];
				var v43: array<seq<int>> := new seq<int>[29] [fm41(globalState), v37, v37, v37, v37, v37, v37, v37, fm41(globalState), v37, v38.cf16, if (f2 in v39) then v39[f2] else [f7, |v40|], [|v2|], v37, v37, v37, v37, v37, v38.cf16, v37, if (f6 in v41) then v41[f6] else v37, [v0[866]], v37, v37, (seq(0x257, i6  => (f6)))[fm2(v0[866], globalState) := |map[f7 := |(map v42 : int | v42 in {f7} :: (v42 - |[f2, f4, f3, f3, f3]|) := (-0x3b8))|]|], v37, v37, [|v2|, f6, -|v2|], (if (f7 in v41) then v41[f7] else seq(-712, i7  => (f6))) + v37];
				v43[590] := v37;
				v43[590] := v37;
			} else {
				var v44 := DC17();
				...
				var v47: map<bool, bool> := map[if (v45 in v46) then v46[v45] else true := fm0(f2, v0[866], v0[866], globalState) == f6];
				v47 := v47[f4 := f3];
				f2 := !f4;
			}
			
			v0 := v0;
			v0[866] := |(seq(0x7f, i8  => (f6)))|;
		}
		...
		r2 := (if (f3) then v50 else DC25(f2, v0[866], f5)).cf36;
			...
			decreases 100 - i9
		{
			...
			i9 := i9 + 1;
			r2 := f4;
			globalState.f0 := -f6 / (|{f3, f5, false}| / f6);
			var v54 := DC2(f3);
			var v55 := DC13(f6, v54, v0[866]);
			var v56: set<D5> := {v55};
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		v4[744], f2, p1.f2, v5 := v1, match v6 {
			...
			case DC34(cf50) =>
				...
				match (v9) {
					case DC17() =>
						...
						globalState.f0, f3, globalState.f0, globalState.f0, v10 := -(if (v11 in v12) then v12[v11] else f6), f2, f6, f6 - (-0x3a8 % (if (v10 in v14) then v14[v10] else f6)), v10;
						p1.f2 := v7.f4 <== f2;
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		for i1 := f7 to fm0(p3, |v11|, f6, globalState) {
			...
			var v13 := 'r';
			var v14 := DC35(v6);
			var v15: array<string> := new string[20] [v6, fm49(v13, f2, globalState), v6[f7 := v13] + v6, fm49(v13, p2, globalState), fm49(v13, v10.f23, globalState), "p", v6, v6, v14.cf51, "imj", v6 + "u", "qahobvk", v6, v6 + "wqcpqxqd", v6 + v6, v6, v6, v6, v6, "bdrkcy"];
			v15[883] := "jiqxmrjsh" + v6;
			...
			v18[561] := p1;
			v4, v15[883], v16, v18[561], v6 := (v4 + v4)[i1 := !f2], "cneb", [p1], p1, seq(0x3db, i2  => (v13));
		}
		globalState.f0 := f7;
...
class C4 extends T2, T1 {
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
			...
			decreases 100 - i0
		{
			...
			if (f4) {
				...
				v12 := v12[{f7, |v13|} <= (set v14 : int | (0xd3 <= v14) && (v14 < 0x32c) :: (v14 / -699)) := v11];
				var v15 := "vvt";
		...
		var v25: map<array<int>, int> := map[v24[f6] := f6];
		...
		for i1 := f6 - f6 to f6 {
			...
			var v33: multiset<set<int>> := multiset{if (i1 in v31) then v31[i1] else v32, {f6, |(seq(-0x18a, i3  => ('e')))|, f7}, v32, v32 * {f6, i1}};
			v33 := fm37(globalState);
		}
		var v34: seq<bool> := [f4];
		var v35: multiset<bool> := multiset{f2};
		v0[812] := |(multiset(v34) + v35)|;
		...
		v0[812], v36[65], r2, v39[857], globalState.f0 := (f7 % 0x2f8) - |v42|, v38, f4 && f2, fm35(f5, v43 + v43, f5, globalState), 0x1d3;
		globalState.f0 := -((f6 - v0[812]) * f6);
		r0 := true;
		var v44 := 'c';
		r1 := v44;
		var v45: map<int, bool> := map[f6 := f2];
		r2 := if (if (v0[812] in v45) then v45[v0[812]] else f3) then true else !(if (f5) then v39[857] else true);
		var v46 := "l";
		r3 := (if (v24 == v24) then seq(0xe5, i5  => (v44)) else v46 + v46)[f7 / |v46| := v44];
	}
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		var v0: array<bool> := new bool[14](i0 => f4);
		v0[212] := if (f3) then f3 else f4;
		v0[212] := false;
		if ((f6 <= f7) || false) {
			...
			match (v1) {
				...
				case DC9(cf14) =>
					...
					var v5: seq<int> := [|p0|];
					var v6: array<int> := new int[20] [f6, f6, f7, 28 * f6, f6, 0x6d, |[p1.f2]|, f7, f6, f7, f6 + f6, f6, f7, |(v4 + v4)|, f6, f7, |v5|, if (p1.f3) then 0x152 else |(seq(585, i1  => ('g')))|, f6, f7 % f7];
					v6 := v6;
				...
				case DC11(cf15) =>
					...
					var v13 := "jxpdrp";
					v12, globalState.f0 := v12, |v13| / f7;
					var v14: seq<int> := [f7];
					v14 := [f7, f6] + (seq(0x32f, i2  => (|{f7}|)));
			...
			if (|v17.cf60| != fm2(f6, globalState)) {
				...
				v0[212] := !v0[212] ==> (v21 != v21);
				var v22: array<array<map<int, int>>> := new array<map<int, int>>[17];
				var v23: map<int, int> := map[f6 := 590];
				var v24 := DC43(v23);
				var v25: array<map<int, int>> := new map<int, int>[19] [v23, v23, v23, v23[f6 := f6], v23, v23, map[f6 := f7], map[v19[f6] := f7], map[f6 := f7], v23, v23, map[0x7f := 0x32f], v23, v23, v24.cf65, v23, v23, v23, map[0x2e5 := f7]];
				v22[456] := v25;
				var v26: map<int, bool> := map[f6 := true];
				v0[212], p1.f2, v22[456] := f3 <==> f4, if (if (f7 in v26) then v26[f7] else p1.f2) then !p1.f3 else f2, v25;
			} else {
				v0[212] := v0[212];
				...
				var v34 := new C3(v33, fm0(p1.f3, f6, |fm58(globalState)|, globalState), if (f2) then f7 else f7, p1.f2 <== f4, f2, f2, v0[212]);
			}
		...
		if (if (false) then v0[212] ==> p1.f2 else if (0x1d2 in v44) then v44[0x1d2] else f2) {
			v0[212] := f5;
			...
			var v53 := DC26(|p0[f7 := v0[212]]|, p2, f2, p1.f3, f7);
			...
			if (p1.f3) {
				...
				v69 := v69;
				globalState.f0 := f7 + v62[|v62|];
				p2[241] := f6;
				p2[241] := f6;
			} else {
				var v70: map<bool, bool> := map[p1.f2 := v0[212]];
				globalState.f0, v0[212] := -0x24a / |v70|, f7 > 0x15c;
				var v71 := new C0();
				globalState.f0 := f6;
				...
				globalState.f0 := (|v81| + |map[p2 := |v83|]|) % |[multiset{v82.f7}]|;
			}
			...
			p1.f2 := p1.f3;
			var v92 := DC5(f6);
			var v93 := DC48(set v91 : int | v91 in v88 :: (v91 * 0x18b), v0, v88, v92.(cf6 := v88[f7]));
			v93 := v93;
		}
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (v0 > v0) {
			...
			var v9: seq<bool> := [f5];
			var v10 := DC26(f6, p1, v9[f6], f3, |v4|);
			...
			if (p2) {
				...
				v20[220] := !f4;
				v20[687] := f5;
				var v22: array<set<D16>> := new set<D16>[8](i0 => {DC38(map v21 : string | v21 in {seq(627, i1  => (v17))} :: (v21) := (v16))});
				var v23: map<string, seq<int>> := map["e" := v16];
				var v24 := DC38(v23);
				var v25: set<D16> := {v24, v24, v24, v24};
				v22[246] := v25 * v25;
				v20[220], v20[687], v22[246] := f4 <== f5, fm40(globalState), v25 - v25;
				...
				v20[220] := !(v26 in (v29 + v29[|[|v16|, f7]| := v26]));
				p1[449] := f7;
				p1[449] := f6;
			} else {
				r1 := p2;
			...
			decreases 100 - i3
		{
			...
			if (true) {
				...
				var v47: T2 := new C2(v41["qsijaxuek" := v42[fm0(p3, |v44|, -0x151, globalState) := -f7]], true, if (f7 in v45) then v45[f7] else |v42|, DC15(f4, v43, 0x108, v43).cf23 % f6, "vohwcvvf" != v38, if (f7 in v46) then v46[f7] else !!f4, p2 <==> !f3, p2);
				v47 := v47;
				var v48 := DC2(v47.f5);
				...
				r1, f3, v43, globalState.f0 := if (!false) then v45 == multiset([|v46|, |v50|, |v51|, v47.f7, v42[v47.f7]]) else f5, p2, v43, f6;
				var v52: set<multiset<int>> := {v45};
				var v53: map<bool, string> := map[v47.f5 := v38];
				var v54 := new C2(v41 + v41, !f5, f7 * f7, f7 % v47.f7, !!p3, v52 >= v52, v43 !in (if (v47.f2 in v53) then v53[v47.f2] else "ywwlysyc"), f6 > |v50|);
				v47.f2 := (if (v54.f23) then v47.f7 else -f6) in v39;
			}
			
			var v55: array<bool> := new bool[1];
			v55[780] := false;
			v55[780], r0, f2 := fm40(globalState), -f7, fm56(f2, f7, globalState);
			...
			var v61 := "gd";
			v58, v60, r0, v55[780] := {p1}, v60, |{|v61|}|, if (f7 > 0x209) then if (!f2) then f3 else !f3 else f3;
		}
		var v62: seq<bool> := [f5];
		var i5 := 0;
	...
	method m17(p0: char, p1: bool, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: array<string>) {
		...
		var v8 := DC50(v7);
		var v9 := new C3(v0, if (f3 in v1) then v1[f3] else f6, -(|v2| % |(if (f7 in v4) then v4[f7] else v5)|), fm40(globalState), fm35(f2, v6, f2, globalState), !(multiset{p0} <= v8.cf77), !p2);
		...
		for i3 := f7 to |(map v15 : int | (999 <= v15) && (v15 < 861) :: (v15 * |v6|) := (0x1c3))| {
			...
			if (f3) {
				...
				var v22: array<string> := new string[17] [v5, "wxmoov", v5, v5, v5, v5, v5, "jsfqn" + (seq(-349, i4  => (p0))), v5, v5, v5, v5, seq(0x84, i5  => ('f')), ("lvnmc")[f7 := p0], fm49('m', f2, globalState), v21[i3] + (seq(185, i6  => (p0))), v5];
				v22[551] := (seq(0x65, i7  => (p0))) + v5;
				v22[551] := v5;
				var v23: set<bool> := {v19.f23};
				var v24: seq<set<bool>> := [v23, v23, v23];
				v12[945] := f7 * |v24|;
				v12[945] := -f6;
				v12[945] := -(|(v3 + ([f2, f5])[f7 := !f5])| % -0x167);
				v2 := v2[!v19.f23 := -0x374];
				var v25: multiset<int> := multiset{|(v22[551] + v5)|, |v23|};
				var v26: seq<multiset<int>> := [v25];
				v25 := v25 * (v26[f6])[f7 := f7];
			} else {
				v10[720] := f5;
				v10[720] := v19.f23;
				...
				v10[720] := (if (-f6 in v30) then v30[-f6] else v31[i3]) != v3;
			}
		...
		var v36: map<char, int> := map[p0 := v35[f7]];
...
class C5 {
	...
	function fm32(p0: char, p1: bool, globalState: GlobalState): int {
		(0x2da / 677) - (|[false]| / |map[true := |map[0x176 := 'd']|]|)
	}
	method m15(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v2 := DC8(v1);
		var v3: seq<D3> := [v2];
		var v4 := DC12(seq(0x22b, i0  => (p2)));
		v0[757], r0, r1, r1 := fm33(v3[p2 := v2], globalState), fm33(v3, globalState), p1, match v4 {
		...
		var v9: array<seq<bool>> := new seq<bool>[24] [v6.cf25, [!p0], v5 + v5, v5, v5, if (p0) then v5 else v5, v5, v5, v5 + v5, v5, [p0], fm34(globalState), v5 + v5, if (v7 in v8) then v8[v7] else DC16(v5).cf25, v5 + [v5[p2]], v5, v5, v5, DC16(v5).cf25[p2 := false], v5, v5, v5, [!!p0], v5];
		v9[886] := v5 + v5;
		v9[886] := [p1];
		globalState.f0 := p2;
		r0 := v0[757];
		var v10: map<bool, bool> := map[p1 := v0[757]];
		var i1 := 0;
		while (p1 in (v10 + v10))
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v11: multiset<seq<bool>> := multiset{v9[886]};
			var v12: multiset<bool> := multiset{v0[757]};
			var v13: set<int> := {|v12|};
			globalState.f0 := if (v9[886] in v11) then v11[v9[886]] else |v13|;
			var v14: array<int> := new int[26];
			var v15: map<bool, int> := map[p1 := |v10|];
			var v16: seq<map<bool, int>> := [v15];
			var v17 := "glmhqi";
			var v18: set<map<bool, int>> := {v16[|v17|], v15};
			v14[549] := -|v18|;
			var v19: set<array<bool>> := {v0, v0};
			var v20: seq<int> := [p2];
			var v22 := DC4(set v21 : int | v21 in v20 :: (v21 - 291));
			v14[549], v19, v0[757], v17, v22 := (|v17| + -p2) - p2, v19, p1, seq(-0x3da, i2  => (if (p0) then 'r' else 'r')), v22;
			var v23 := DC7(p2 / |v17|, p2, p2);
			var v24 := 'o';
			var v25: multiset<char> := multiset{v24, v24, v24, v24};
			v23 := DC7(|[v25, v25, multiset{v24}, v25, multiset{v24}]|, p2, v14[549]).(cf11 := v14[549]).(cf12 := v14[549]);
			r1 := p0;
		}
		var v26 := "pksc";
		...
		v26, v27[800], v31, globalState.f0, globalState.f0 := "tjw", v28 * ({v0[757], p1} - v28), v31, (|v29| + p2) * (0x186 * p2), p2 + (p2 + p2);
		r0 := p0;
		r1 := |v29| <= (-0x1ff - --|{v10}|);
	}
	method m16(p0: int, p1: seq<int>, p2: int, p3: bool, globalState: GlobalState) {
		...
		var v3: array<multiset<int>> := new multiset<int>[1] [(multiset{p2, |v1|})[|v2| := p2]];
			...
			decreases 100 - i0
		{
			...
			if (p3) {
				...
				var v12: seq<bool> := [p3];
				var v13 := new C3(if (v0 in v11) then v11[v0] else v4.f21, p2, 0x2ef, v10, p3, v12[p0], !v10);
				var v14: array<bool> := new bool[24];
				var v15: map<array<bool>, int> := map[v14 := |map[p3 := 'n']|];
				v15 := v15;
				v5[80] := p2;
				var v16 := "ylpjfvr";
				v5[80] := if (v10) then |v16| else -p0;
				v5[80] := v4.fm0(p3, |fm38(p3, globalState)|, v5[80] - p2, globalState);
			} else {
				v0 := v0;
				globalState.f0 := p2;
				var v17 := "nximsitn";
				var v18: map<bool, string> := map[p3 := seq(0x32f, i3  => (v0))];
				var v19: array<string> := new string[29] ["mpsvkii" + "vjniwuarb", v17[p0 := v0], if (p3) then "r" else v17, v17, v17, v17 + v17, seq(-0x381, i1  => (v0)), seq(0x284, i2  => (v0)), "jqkfl" + (if (p3 in v18) then v18[p3] else "sxeuiuoy"), v17 + "otpa", v17, ("xpmrnbcse")[p2 := v0] + v17, v17 + v17, (v17 + v17[p2 := v0])[p0 := v0], v17, v17, v17, seq(757, i4  => (v0)), v17, v17, if (p3) then v17 else v17, v17, fm49(v0, p3, globalState), seq(175, i5  => (v0)), v17 + v17, v17 + v17, v17 + v17, v17, v17];
				v19[839] := fm38(true, globalState);
				v19[839] := seq(904, i6  => (v0));
				globalState.f0 := -p2 - p0;
				v5[374] := |p1| * |multiset{true}|;
				var v20: set<int> := {p2};
				var v21: multiset<set<int>> := multiset{v20};
				var v22: map<int, bool> := map[p2 := false];
				var v23: seq<bool> := [if (p2 in v22) then v22[p2] else p3];
				var v24: array<bool> := new bool[22] [!p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, 141 > p0, fm40(globalState), p3, v21 != multiset{v20}, p3, true, p3, p3, v0 in v17, true, v23[p2]];
				v24[898] := p3;
				var v25 := true;
				v5, v5[374], v24[898], v25 := v5, -304 * p0, v23[p1[p0]], v25;
			}
		...
		var v34: map<seq<bool>, int> := map[v33 + v33 := -(p2 % p0)];
		v34 := v34;
		var v35 := true;
		...
		var v39 := DC50((multiset{v0, 'k'})[v0 := v38.cf70]);
		var v40: multiset<bool> := multiset{v35, v35, v35, p3};
		var v41: map<bool, int> := map[p3 := if (v5[226] in f20) then f20[v5[226]] else p2];
		var v42 := DC6(p0, p2, if (p3 in v40) then v40[p3] else if (false in v41) then v41[false] else p2);
		v35, v36[463], globalState.f0, v37[703], v35 := !match v39.(cf77 := multiset(seq(556, i8  => (v0)))) {
			case DC51(cf78, cf79) => v35 <==> !p3
			case DC50(cf77) => v35
			case DC52(cf80) => v35
		}, if (p3) then v35 ==> !p3 else v35 && p3, if (v5[226] <= p0) then v5[226] else |fm57(p1, globalState)|, match v42 {
...
class C6 extends T1 {
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		match (v4) {
			case DC13(cf17, cf18, cf19) =>
				globalState.f0 := cf17;
				var v6: map<bool, set<int>> := map[f2 := set v5 : int | (0x160 <= v5) && (v5 < 942) :: (v5 % cf19)];
				if (fm27(v6, f19, if (fm27(v6, f19, v1, globalState)) then v1 else seq(0x3be, i2  => ('p')), globalState)) {
					var v7 := DC5(cf19 + cf17);
					var v8: array<map<bool, seq<int>>> := new map<bool, seq<int>>[14];
					v8[230] := map[p1.f3 := v3[f19 := f19]];
					var v9: map<bool, seq<int>> := map[p1.f2 := [cf19, cf19, cf17]];
					v7, v8[230], f2 := v7, v9, f3;
					f3 := p1.f3;
					f2 := (f19 + -|v1|) > (if (f5) then f19 else f19);
					var v10: array<D3> := new D3[24](i3 => DC7(cf17, f19, cf19));
					var v11 := DC7(f19, cf17, -0x2bb);
					v10[419] := v11;
					globalState.f0, v10[419], globalState.f0 := cf19, v11, fm0(f3, 0x387, cf19 / cf19, globalState);
					...
					var v18: seq<D3> := [v17];
					v15[8] := map v16 : D3 | v16 in v18 :: (v16) := (p1.f2);
					var v19: array<string> := new string[2](i5 => v1);
					v19[707] := v1;
					var v20: map<D3, bool> := map[v17 := false];
					v13[926], p2[707], v15[8], p1.f3, v19[707] := v14, f19, v20, p0[|v1|], v1;
					globalState.f0 := fm0(p1.f3, cf19, cf19 * cf19, globalState);
					globalState.f0 := cf17;
					v2 := v2[cf19 := p2[707]];
					var v21: map<bool, int> := map[true := p2[707]];
					v21 := v21[f2 := f19];
				}
				
				p2[68] := 0x348 - fm0(f4, cf17, -744, globalState);
				var v22: map<seq<seq<bool>>, seq<int>> := map[[[f4, true, f2]] := fm29(f2, globalState)];
				var v23: seq<seq<bool>> := [p0];
				var v24 := DC14(v23);
				p2[68] := -|(if (v24.cf20 in v22) then v22[v24.cf20] else v3)[(fm30(fm31(globalState), false, globalState)).cf10 := 0x1eb]|;
				var v25: set<int> := {p2[68], 0x200};
				var v26: map<int, bool> := map[|(seq(-484, i6  => (DC13(755, cf18, cf19))))| := !fm27(map[!!true := v25], cf17, v1, globalState)];
				v26 := v26[cf19 := f3];
			case DC12(cf16) =>
				var v27 := 'n';
				var v28: set<bool> := {f4};
		...
		for i8 := 0x320 to f19 - (if (v2 in v33) then v33[v2] else f19) {
			...
			if ((v2 !! v2) ==> f4) {
				...
				var v41: map<bool, int> := map[p0[v36.f24] := v36.f24];
				var v42 := DC31(v41);
				v39, v40, f2, v0, v42 := v39, (if (f3) then v40 else v40) + v40, !p1.f3 && f5, v0, v42;
				var v43: set<int> := {i8};
				globalState.f0, p1.f3, globalState.f0 := |((p0 + p0) + p0[i8 := f5])|, f2, |v43| / (-f19 * i8);
			} else {
				var v44: multiset<bool> := multiset{p1.f2};
				var v45: seq<bool> := [v44 != multiset(p0[|v32[985]| := f2]), f3];
				var v46: array<seq<map<int, char>>> := new seq<map<int, char>>[10];
				var v47: map<int, char> := map[i8 := 'x'];
				var v49: multiset<string> := multiset{v32[985], v1, v32[985], v1, v32[985]};
				var v50: set<int> := {if (v32[985] in v49) then v49[v32[985]] else 0x16c};
				...
				v0, v45, globalState.f0, v46[226] := v0, [v52.cf67], |fm49(v36.f25, !f2, globalState)|, [v47, v47, map v53 : int | (0x30e <= v53) && (v53 < -380) :: (v53 / v36.f24) := (v36.f25), if (v36.f24 in v54) then v54[v36.f24] else v47, v47[|v32[985]| := v36.f25]];
				globalState.f0 := i8 / fm0(p1.f2, v36.f24, v36.f24, globalState);
				globalState.f0 := |v1| % f19;
				v0[520] := fm40(globalState);
				v0[520] := !(v36.f24 <= v36.f24);
		...
		for i9 := f19 to if (|v69| in v68) then v68[|v69|] else |v70| {
			...
			globalState.f0 := i9;
			var v72 := 'g';
			v32[985] := (v1 + (seq(0x2c3, i10  => ('a')))) + (if (p1.f2) then v32[985][0x2de := v72] else v32[985][i9 := 'n']);
			f3 := p1.f3;
		}
		var v73: map<bool, set<int>> := map[f4 := {|(seq(0x35, i11  => (f19)))|, f19}];
		var v74: set<bool> := {fm27(v73, f19, seq(0x36f, i12  => ('p')), globalState), !f5};
		v0[67] := v74 >= v74;
		...
		v0[67], globalState.f0, globalState.f0, v77, v83 := p1.f3, f19 * -0x3c7, f19, v77[f19 - f19 := v76], v83;
	}
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		globalState.f0 := f19;
		...
		for i0 := f19 to f19 {
			...
			var v14 := DC33(v11, if (f4) then f3 else fm27(v13, |v12|, seq(0xd6, i1  => ('k')), globalState));
			...
			v20[366] := v21;
			v20[366] := v21;
			p1[403] := -(fm0(p2, f19, i0, globalState) * 376);
			p1[403] := f19;
		}
		var v22 := "d";
		var v23 := DC41(f19, v22, true);
		var v24 := 'b';
		var v25: set<string> := {v23.cf62[0x29b := v24]};
		...
		v28 := v28[--(|(seq(0x8e, i2  => (v24)))| - f19) := v27[f19 := v26[f19 := 0xa0]]];
...
class C7 {
	...
	method m13(p0: bool, p1: bool, globalState: GlobalState) returns (r0: array<int>) {
		...
		var v2 := 't';
		var v3: seq<char> := [v2];
		v0[208] := map v1 : char | v1 in v3 :: (v1) := (p0);
		v0[208] := (map[v2 := p1])[v2 := p0];
		if (p1) {
			var v4: array<int> := new int[13];
			var v5 := 736;
			v4[375] := v5;
			var v6: multiset<int> := multiset{-v5};
			v4[375] := fm23(p1, v6 + v6, v5, v5, globalState);
			var v7: array<bool> := new bool[29];
			v7 := v7;
			if (multiset{v5, v4[375]} == multiset(fm25(globalState))) {
				v7[449] := !true;
				var v8: set<string> := {v3};
				var v9 := false;
				v7[449], v8, v9 := if (v9 <== fm26(v4[375], globalState)) then v9 else p0, v8 + (if (v9) then v8 else v8), (v3 != (seq(0x2b3, i0  => (v2)))) ==> v9;
				var v10: array<seq<int>> := new seq<int>[16](i1 => [|{v9}|, |map[v4[375] := !v9]|] + [v5, -v4[375], v5]);
				var v11: seq<int> := [v4[375], v4[375], v4[375], v5];
				v10[630] := v11;
				v10[630] := v11 + fm25(globalState);
				var v12: set<int> := {v4[375], v4[375]};
				var v13: seq<set<int>> := [{v5, |v3|} + v12];
				v13 := v13;
				v4[375] := v4[375];
				var v14: map<seq<int>, int> := map[v10[630] := v4[375]];
				var v15: map<int, map<seq<int>, int>> := map[v5 * v4[375] := v14];
				v15 := v15[-0x1d6 := map v16 : seq<int> | v16 in {v10[630], v11} :: (v16) := (v4[375])];
			} else {
				var v17: map<array<bool>, char> := map[v7 := 'c'];
				globalState.f0 := v4[375] + (if (p0) then |v17[v7 := v2]| else v4[375]);
				var v18 := new C0();
				var v19 := new C0();
				var v20: array<multiset<int>> := new multiset<int>[28];
				var v21: seq<int> := [|"ylkvcx"|, v5];
				var v22: map<int, int> := map[|v3| := |v3|];
				var v23: set<seq<int>> := {v21, v21[v4[375] := -(if (v4[375] in v22) then v22[v4[375]] else v4[375])], v21};
				var v25: set<int> := {v5, |f18|, v5};
				var v26 := new C3(v20, v5, |v23|, !p1, p1 <==> p1, v6 !! v6, fm35(p1, map v24 : int | v24 in v25 :: (v24 * v4[375]) := (v4[375]), p0, globalState));
				var v27: map<bool, int> := map[p1 := v4[375] % v4[375]];
				v27 := v27;
			}
			...
			if (p0) {
				...
				v29[824] := v3;
				v28, v29[824] := fm57(fm41(globalState), globalState) != (f18 + f18), v3;
				v4[375] := v5 * v4[375];
				v4[375] := v4[375];
			} else {
				v3 := "rxiv";
				...
				v30, v4[375], v30, v31[949], v4[375] := false, |map[fm58(globalState) := v4]|, true, v3, |(v32 + v32)|;
				globalState.f0 := |v32| * v5;
				var v33 := m14(globalState);
				var v34: seq<int> := [|v6|, |[v4[375]]|];
			...
			match (v44) {
				case DC41(cf61, cf62, cf63) =>
					...
					globalState.f0 := if (p1 in v50) then v50[p1] else fm23(p0, multiset(seq(293, i4  => (cf61))), cf61, cf61, globalState);
				...
				case DC40(cf60) =>
					...
					var v54 := -261;
					v52[149] := if (true in v53) then v53[true] else v54;
					v51, v51, v52[149] := v54 < |v3|, !v51, 0x97;
					v51 := (v52[149] - v52[149]) != v54;
					v51 := p0;
					var v55 := DC32();
					var v56: set<D13> := {v55};
					...
					v58 := [v51, !p1] + (v58 + (if (p1 in v59) then v59[p1] else v60[|fm64(v52[149], if ((if (v51 in v62) then v62[v51] else v54) in v61) then v61[if (v51 in v62) then v62[v51] else v54] else !p0, v52[149], v54, globalState)|]));
				case DC42(cf64) =>
					var v63 := false;
					var v64 := 595;
					...
					var v73: map<bool, seq<bool>> := map[p0 := ([p1])[v64 := p0]];
					v73 := v73[p1 := [v63, p1, p0]];
					var v74: multiset<int> := multiset{v64};
					var v75: multiset<array<int>> := multiset{v66, v66};
					v66[572] := fm23(p1, v74[v64 := v64], v64, v71[if (v66 in v75) then v75[v66] else if (v64 in v74) then v74[v64] else 0x111], globalState);
					var v76: multiset<bool> := multiset{!p0, !p1};
					v66[572] := fm24(v76 !! multiset(f18), f18, v2, globalState);
					var v77: map<int, int> := map[v66[572] := 0x372];
					v77 := v77 + map[v66[572] := v66[572]];
			}
			...
			var v82 := new C1(v78 * |(seq(315, i6  => (v2)))|, if (fm23(p0, v80, -404, v78, globalState) in v79) then v79[fm23(p0, v80, -404, v78, globalState)] else v2, p0, p0 ==> v81.cf36, if (p1) then p1 else p0, fm26(-v78, globalState) ==> p1);
			if (p1) {
				v3 := v3;
				var v83 := true;
				var v84: set<string> := {seq(0x125, i7  => (v82.f25)), v3, "ivr"};
				...
				var v92: seq<int> := [|(seq(0xc, i8  => (v2)))|, 451, v82.f24, |v3|, v82.f24];
				...
				v94[83] := v41;
				v90, v94[83], globalState.f0, v90 := !v90, v41, -v78, p0;
			...
			var v98: set<bool> := {p1};
			var v99 := new C1(v82.f24, v3[|v79|], |v3| != |multiset{p1, true}|, v78 != v82.f24, p0, |v98| !in v80);
			var v100 := true;
			v100 := p1;
		}
		...
		var v108: seq<map<int, int>> := [if (p0) then v103[v101] else v102, map v104 : int | (366 <= v104) && (v104 < 147) :: (v104 * v101) := (v101), map[|v107| := |v3|], map[v101 := v101], v103[v101]];
	...
	method m14(globalState: GlobalState) returns (r0: string) {
		...
		if (!v0) {
			...
			var v5: map<int, int> := map[v2[372] := v2[372]];
			...
			var v10 := DC5(v2[372]);
			var v11 := DC8(v10);
			var v12: seq<D3> := [fm70(v0, v0, globalState), DC8(DC5(v2[372])), v11, v11];
			var v13 := DC33({v0}, v0);
			var v14: map<seq<bool>, bool> := map[f18 := v0];
			var v15: array<bool> := new bool[22] [false, v0, fm33(v12, globalState), !!v0, v0, !v13.cf49, v0, if (f18 in v14) then v14[f18] else v0, v0, v0, false, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, f18[v2[372]]];
			...
			decreases 100 - i1
		{
			...
			var v27: seq<map<bool, bool>> := [v23, v23 + map[!true := f18[|v26|]], v23 + fm31(globalState)];
			v27 := [map[false := v0], v23[true := v0] + v23, map[false := !v0], v23];
			var v28 := DC45(v0);
			globalState.f0 := -|(multiset{v28, DC45(v0)})[v28 := |v22|]|;
		}
		var v29: array<int> := new int[11](i4 => i4 % |map['n' := |"kt"|]|);
		forall i3 | 0 <= i3 < v29.Length {
			v29[i3] := i3 * (0x322 / 0x259);
		}
		var v30 := 0x2c4;
		var i5 := 0;
		while (v30 >= (v30 - 0x248))
			decreases 100 - i5
		{
			...
			var v32: multiset<int> := multiset{|(seq(479, i6  => (v30)))|};
...
class C8 extends T2, T0 {
	...
	function fm1(p0: int, globalState: GlobalState): int {
		|(({f7} + {f7}) - {--|{seq(-0x118, i0  => ('y'))}|})|
	}
	function fm2(p0: int, globalState: GlobalState): int {
		f7
	}
	function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		--(|multiset{f7}| - 0x2d7) / |(if (f3) then multiset{f6, f6, |[f7, f6]|} else multiset{f7})|
	}
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		...
		var v1 := "dr";
		var i0 := 0;
		while (fm2(f7, globalState) <= (fm1(|v1|, globalState) % 0x367))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
		...
		var v6: map<int, multiset<bool>> := map[f6 * f6 := v4[fm21(globalState) := |v5|] * v4];
		v6, r0, globalState.f0 := v6, f5, |fm22(globalState)|;
		var v7 := 'q';
		var v8: map<int, bool> := map[f6 := f3];
		var v9: seq<bool> := [f4];
		var v10: map<int, char> := map[f7 := v7];
		var v11 := new C4(|fm49(v7, f4, globalState)|, f7, f4, v8 == v8, f3, fm0(!v9[f6], f7, f6, globalState) == -|v10|);
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		for i0 := |v0| to f7 / |v1| {
			...
			p2[154] := if (v6 in v5) then v5[v6] else -f6;
			var v7 := DC2(true);
			...
			p2[154], v8, v11 := f7 * i0, v8, {|v12|} - v11;
			var v13: multiset<string> := multiset{v1 + v1};
			var v14: map<int, multiset<string>> := map[i0 := v13];
			var v15 := DC41(p2[154], v1, false);
			v13, v1, globalState.f0 := (v13 - v13) - (if (f7 in v14) then v14[f7] else v13), fm49(v2, f4, globalState) + v15.cf62, if (if (f5) then false else p1.f2) then i0 else p2[154];
		...
		var v24: seq<bool> := [f2, v18 !! v18, fm20(p0[f6], p1.f3, v21, map[|v23| := v22], globalState) == p0];
		v24 := p0;
		v19 := seq(0x23e, i1  => (|v1|));
		p2[348] := f6;
		p2[348] := -959;
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			var v26 := new C2(map v25 : string | v25 in map[v1 := p1.f2] :: (v25) := (v19), p1.f3, f7, p2[348], f5, p1.f3, p1.f2, true);
			var v27: map<int, bool> := map[|v1| % |(seq(0x20, i3  => ('a')))| := p1.f3];
			v27 := v27 + (v27 + v27);
		...
		var v31 := DC1(p2, f3, p2[348]);
		var v32: map<int, bool> := map[p2[348] := f3];
		var v33: map<int, int> := map[|[-0x2d2, |v32|]| := 0xa1];
		var v35: array<D0> := new D0[20] [v31, v31, v31.(cf2 := p2[348], cf1 := f3), DC1(p2, f5, |v24|), v31, v31, v31.(cf0 := p2), v31, v31, v31, v31, v31, DC1(p2, if (|(set v34 : int | v34 in v33 :: (v34 / |[|map[0x43 := 914]|]|))| in v32) then v32[|(set v34 : int | v34 in v33 :: (v34 / |[|map[0x43 := 914]|]|))|] else true, -p2[348]), v31, v31, DC1(p2, p1.f2, f6), v31.(cf2 := 0x26a), v31, v31.(cf1 := f5, cf2 := p2[348]), v31];
		v35[843] := v31;
		var v36 := DC5(p2[348]);
		...
		p1.f3, f2, f2, v35[843], p1.f2 := fm35(f2 in v37, (map v38 : int | (0x1c1 <= v38) && (v38 < 0x39e) :: (v38 * f6) := (f6)) + map[p2[348] := |v1|], f4, globalState), (p2[348] * -|v1[f6 := v39]|) <= p2[348], f4, v31.(cf1 := f2), --(f6 * |v1|) > (p2[348] + |v41|);
	}
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (false) {
			var v0 := "bcq";
			v0 := if (f4) then v0 else (seq(0x50, i0  => ('f'))) + v0;
			var v1: set<bool> := {f4};
			var v2: seq<bool> := [f3];
			var v3: array<bool> := new bool[17] [false, f7 != f7, !(if (f5) then p3 else f3), f3, true, -f7 >= f6, f5 && f3, if (true) then f5 else f5, f2, v1 < v1, f5, true, f5, p3, p3, p2, v2 <= v2[-f6 := false]];
			v3[306] := 0x13a <= f7;
			r0, v3[306] := fm2(f6 % f7, globalState), f6 >= |v1|;
			v1 := {f5, true, f2};
			v2, globalState.f0 := v2 + v2[f6 := p2], f7 - f7;
			var v4: array<set<int>> := new set<int>[20];
			var v6: set<int> := {f6};
			v4[777] := (set v5 : int | (839 <= v5) && (v5 < 0x5c) :: (v5 % |[f6]|)) + v6;
			v4[777] := {0x326, -0x1f8};
		} else {
			var v7: set<int> := {0x179, f7, -f6 % f6};
			var v8 := "ymms";
			var v9 := DC35(seq(60, i1  => ('a')));
			...
			var v14, v15, v16, v17 := m12(v11, v13[f7], v10, globalState);
			if (f2) {
				var v18 := DC24(v10);
				...
				v10, globalState.f0, v28, v12 := v17, if (true) then 854 else f7, map[v11 := if (f2) then map v29 : int | (0x1dd <= v29) && (v29 < 342) :: (v29 - v15) := (v15) else v27], map[p3 := f6] + map[v10[222] := f7];
				v10[222], v8, r0, globalState.f0 := f5, seq(0x25a, i2  => (v11)), v15 - f7, v16;
				var v30: seq<bool> := [f3, f5];
				var v31: set<bool> := {p2, v30[f7]};
			...
			var v38: map<int, bool> := map[-v15 % f7 := f3];
			var v39 := DC2(v14);
			...
			decreases 100 - i3
		{
			...
			var v41 := DC5(f7);
			v40[425] := v41;
			v40[425] := fm71(globalState);
			var v44 := "yjcrlun";
			var v45 := 's';
			var v46: map<string, char> := map[v44 := v45];
			var v47: seq<bool> := [p3, f4, f3];
			var v48: T0 := new C2(map v42 : string | v42 in (map v43 : string | v43 in v46 :: (v43) := ({p2})) :: (v42) := (seq(0x91, i5  => (f6))), f4, -|v47|, f6, true, f3, v47[f7], p3);
			...
			var v55: array<bool> := new bool[18] [|v50[f6]| == |v51|, v48.f2, v53 != v53, true, !(fm56(v48.f2, |v44|, globalState) <== v48.f3), p2 && f3, f2, v48.f2, v54 !! v54, f7 !in v53, f5, p2 || f5, v48.f3, f6 <= (if (f6 in v52) then v52[f6] else f6), f3, p2, f2, v48.f3];
			v55[907] := f5;
			var v56 := DC1(p1, v48.f3, |v44|);
			var v57: set<int> := {|v44|};
			var v58: map<bool, seq<set<int>>> := map[f3 := [{v56.cf2, f6}, v57]];
			var v59: seq<set<int>> := [v57, v57];
			globalState.f0, v55[907], v48.f3 := f7, ((seq(0x291, i6  => ({f7, f6})))[f7 := {fm2(f7, globalState), |v44|, 0x202, |{v48.f2}|}] + (if (f3 in v58) then v58[f3] else v59)) < v59, f5;
			p1[206] := f6;
			globalState.f0, p1[206] := f6, v53[fm1(f6, globalState)];
			var v60 := new C0();
		}
		r0 := -(0x118 * f6);
		globalState.f0, r0 := -fm2(-f6, globalState), |(seq(856, i7  => ([f3, f3] + [f5])))|;
		var v61: array<bool> := new bool[17](i8 => f5);
		var v62 := 'd';
		v61[82] := |multiset{v62, v62}| != f7;
		v61[82] := true;
		var v63: multiset<char> := multiset{v62, v62, v62, v62, v62};
		var v65: set<bool> := {f5};
		var v66: seq<int> := [0x20c, |v65|];
		var v67 := new C6(f6 - f7, multiset(fm22(globalState)) <= v63, fm35(p2, map v64 : int | v64 in v66 :: (v64 + f7) := (f6), false, globalState), true, v61[82]);
		r0 := v67.f19;
		r1 := !false;
	}
	method m12(p0: char, p1: int, p2: array<bool>, globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: array<bool>) {
		for i0 := f6 % fm1(f7, globalState) to f6 {
			var v0 := "vrmuidxj";
			globalState.f0 := |v0|;
			if (false) {
				...
				v4[993] := |(seq(89, i1  => (|[f3, f3]|)))[i0 := |v0|]|;
				v4[993] := f6;
				var v5: map<int, map<int, int>> := map[f6 := v3];
				var v6: seq<map<int, int>> := [if (v4[993] in v5) then v5[v4[993]] else v3];
				var v7 := 'r';
				var v8: seq<int> := [0x1a9];
				v6, r0, v7 := ([v3] + v6)[f7 := map[0x22d := v4[993]]] + v6, v8 < (v8 + v8), p0;
				...
				r1 := -(-f7 * i0);
				globalState.f0 := fm2(f7 % -|(seq(0x195, i2  => (p0)))|, globalState);
			}
			
			var v15: seq<int> := [p1];
			var v16: seq<bool> := [f2];
			var v17: map<int, bool> := map[f7 := f4];
			var v18: array<int> := new int[19] [|v15|, -464, |v15|, f6, f6, i0, fm1(p1, globalState), f6, |((seq(0xd3, i3  => (p0))) + v0)|, 0x2ee % fm0(false, |"adeautjk"|, f7, globalState), |v16|, p1, p1 / f7, i0, v15[|v17|], f6, |(v0 + "evbut")|, -219, v15[--130]];
			v18 := v18;
			var v19: map<string, int> := map["jynjr" := f7];
			var v20 := DC7(0x2df, i0, -0x354);
			var v21: multiset<bool> := multiset{true};
			var v22: map<int, int> := map[-|v21| := p1];
			var v23 := new C4(|v19|, |v16|, f5, |v0[f7 := p0]| > v20.cf11, f2, |v22| <= p1);
		}
		var v24 := "xpolhha";
		...
		p2[372] := fm33(v28[|v24| := v27], globalState);
		p2[372] := !!(false <== f2);
		...
		var v38: array<int> := new int[25] [-p1, v29.f24, -p1, f6, v29.f24, p1, v29.f24, f6, |v35|, f6, p1, p1, f7, p1, f6, |[f7]|, v29.f24, p1, |v37|, 0x61, v29.f24, f7, v29.f24, v29.f24, |(seq(250, i4  => (p0)))|];
		var v39: multiset<bool> := multiset{f3, p2[372]};
		...
		v24, v31, f3, v32, r2 := v24 + v25[p1], v34.cf84, f3, v32 + v32, (if (|[p2[372]]| in v41) then v41[|[p2[372]]|] else f6) / f6;
		var v43: map<string, seq<int>> := map[v24 := v35];
		var v44 := new C2(if (f2) then v43 else v43, false, fm0(f2, p1, f7, globalState), -(fm0(p2[372], f7, -f6, globalState) + f7), f4 && false, f4, p2[372], f4);
		v25 := v25;
		v38[906] := 0x121;
		var v45 := DC25(f4, -0x309, f3);
		v38[906] := match v45 {
			case DC25(cf36, cf37, cf38) => -v29.f24 % 0x307
			case DC26(cf39, cf40, cf41, cf42, cf43) => |map[v35 := v29.f24]|
			case DC24(cf35) => p1
			case DC27(cf44) => -(v29.f24 / v29.f24)
		};
		r0 := f3;
		r1 := |v42| - v29.f24;
		r2 := v29.f24 - f6;
...
class C9 extends T0 {
	...
	function fm18(p0: seq<map<bool, bool>>, p1: string, p2: int, globalState: GlobalState): string {
		(seq(0x84, i0  => ('n'))) + ("rkwfeuby" + "xamdvit")
	}
	...
	method m11(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		...
		for i0 := |v4| + v3.f24 to -v0 {
			...
			v5[867] := fm19(globalState);
			var v6: seq<int> := [v3.f24];
			var v7: seq<int> := [v6[-i0]];
			var v8: map<bool, array<bool>> := map[f2 := v5];
			var v9 := DC40(v8);
			v5[867], v7, v9 := p0, v6 + v7, v9;
			var v10: multiset<int> := multiset{v3.f24};
			r2 := (if (p0) then i0 else 0xc5) / |v10|;
			if (!f2) {
				var v11: map<bool, seq<int>> := map[v5[867] := v7];
				var v12 := new C1(v3.f24, v3.f25, v11 != v11, f3, f3, v5[867]);
				var v13: map<bool, int> := map[f3 := i0];
				var v14 := DC15(!v5[867], v3.f25, v3.f24, v3.f25);
				var v15: array<int> := new int[3] [if (v5[867] in v13) then v13[v5[867]] else i0, v14.cf23, v12.f24 % v0];
				v15[812] := v3.f24;
				v15[812] := -746 % v0;
				var v16: map<bool, bool> := map[false := f3];
				r0 := |(((seq(0x285, i2  => (v3.f25))) + (seq(0xe3, i3  => (v12.f25)))) + fm18([v16, map[f3 := f3], v16, v16], v2, v3.f24, globalState))|;
				var v17 := DC8(DC5(|"eqmaxox"|));
				var v18 := DC8(v17);
				var v19: seq<D3> := [v18, v18];
				var v20: array<char> := new char[12] [v3.f25, v12.f25, fm48(f3, globalState), v3.f25, v2[895], v12.f25, v3.f25, v1, v3.f25, v3.f25, fm48(!fm33(v19, globalState), globalState), v12.f25];
				v20[221] := v3.f25;
				v20[221] := v1;
				var v21: map<array<char>, int> := map[v20 := 0x3c8];
				var v22, v23 := v3.m1(v21, v15, -i0 >= |v2|, f3, globalState);
			} else {
				var v24: array<int> := new int[15](i4 => i4 / 0x378);
				v24 := v24;
				v1 := v3.f25;
				var v25: array<D5> := new D5[16];
				v24[384] := v3.f24;
				v25, f3, v24[384], f3 := v25, f3, |[v5, v5]|, false;
		...
		var v32 := DC23(f3, v31[v3.f24], true);
		...
		var v39: array<bool> := new bool[21] [p0, if (f3) then f3 else p0, v0 < v3.fm0(f3, v3.f24, v3.f24, globalState), true, f3, f2, 0x1bf == (if (f3 in v28) then v28[f3] else v0), fm56(f2, v29.cf29, globalState), f2, !f3, v4[v3.f24], {v1} > (set v36 : char | v36 in v35 :: (v36)), p0, f2, p0, p0, f3, fm26(v3.f24, globalState), f2, |v28| in v38, !(0x41 > v0)];
		...
		v2, v39, v40[41], v43[906], r0 := v2, v39, v41, if ((multiset{f2} < multiset([f3, false, false])) in v44) then v44[multiset{f2} < multiset([f3, false, false])] else v42, v3.f24;
		...
		for i7 := |v2| to if (f3) then v0 else v3.fm0(f2, v0, v0, globalState) {
			...
			v55[612] := v56[v3.f24] * (if (f2 in v57) then v57[f2] else v37);
			if (f2 in v41) {
				globalState.f0 := |(if (p0) then v2 else v2)|;
				var v59: array<array<bool>> := new array<bool>[1];
				var v60: map<int, array<array<bool>>> := map[|(set v58 : int | (0x9a <= v58) && (v58 < 0x185) :: (v58 / v54.f19))| := v59];
				v60 := v60[|v45| := v59];
				var v61: array<int> := new int[2] [v0 / 0x2d2, 388];
				v61[67] := --v54.f19;
...
class C10 {
	...
	method m9(p0: bool, p1: seq<bool>, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			v6 := v6;
			var v7 := "xa";
			globalState.f0 := |map[|v7[f17 := v3]| := v0]| * fm17(606, false, p0, globalState);
		}
		...
		if (v0) {
			...
			v8 := new int[8] [f17, f17, f17, f17, f17, f17 + |(seq(-0x19e, i2  => ('p')))|, f17, f17];
			var v17: map<bool, bool> := map[p1[f17] := false];
			var v18 := new C7([if (false in v17) then v17[false] else v0]);
			var v19: map<int, bool> := map[f17 := v16.f23];
			v19 := v19;
			var v20: map<int, int> := map[f17 / f17 := f17];
			v20 := v20;
		} else {
			var v21 := DC2(!p0);
			...
			match (v22.(cf19 := f17, cf17 := f17)) {
				case DC13(cf17, cf18, cf19) =>
					...
					v0 := p0;
					var v26: array<bool> := new bool[9] [p1[--cf17], v0, p0, cf19 == cf17, true, v0, v0 ==> false, v0, p0];
					v26[509] := !v0;
					var v27: set<int> := {cf17};
					v26[509] := v25.fm27(map[p0 := v27], cf19, (seq(0x2c2, i3  => ('f'))) + fm49('t', true, globalState), globalState);
				case DC12(cf16) =>
			...
			v34[202] := v35 > v35;
			v34[202] := v0;
			var v36 := DC40(map[v34[202] := v34] + map[v0 := v34]);
			match (v36) {
				case DC41(cf61, cf62, cf63) =>
					...
					var v43: map<bool, int> := map[fm33(v42, globalState) := 0xa4 % f17];
					v43 := v43;
					var v44: array<string> := new string[5];
					v44[688] := if (v34[202]) then cf62 else cf62;
					globalState.f0, cf63, v44[688] := f17, v34[202], DC41(cf61, seq(399, i5  => ('t')), v0).cf62 + (seq(0xb3, i6  => ('w')));
					r0 := (cf61 / f17) + -(f17 % |cf62|);
				case DC40(cf60) =>
					var v45: multiset<int> := multiset{f17, f17, f17, f17};
					v0 := f17 >= (if (-f17 in v45) then v45[-f17] else 438);
					r0 := f17;
					v34[202], v8 := !(f17 != |p1|), v8;
					v0, v0 := (if (v0) then p0 else false) ==> p0, p0;
				case DC42(cf64) =>
					var v46: array<string> := new string[9];
					v46[565] := "x";
					var v47 := 'm';
					v46[565] := fm49(v47, v34[202], globalState) + (seq(0x29a, i7  => (v47)));
					var v48 := new C5(multiset{62});
					var v49: map<int, int> := map[v48.fm32(v47, p0, globalState) := f17];
					var v50: map<string, bool> := map[v46[565] := fm35(p0, v49, v34[202], globalState)];
					var v51 := DC46(true, f17, v34[202], f17);
					var v52: seq<array<bool>> := [v34];
					globalState.f0, globalState.f0, v34[202], v0 := -|v46[565]|, --(if (v34[202]) then |(seq(0x379, i8  => (f17)))| - |v50| else v51.cf68), v34[202], v52 != v52;
					globalState.f0 := |("uop")[f17 := v47]| * f17;
			}
			
			var v53 := 'c';
			var v54 := new C1(f17, v53, v34[202], v34[202], v34[202], v0);
			match (v22) {
				case DC13(cf17, cf18, cf19) =>
					...
					v8[422] := if (v57 in v55) then v55[v57] else f17;
					v8[422] := if (p0) then v54.f24 else v54.f24;
					globalState.f0 := cf19;
					v0 := !v0;
				...
				case DC12(cf16) =>
					var v59 := "fwiftlfv";
					var v61: map<map<int, bool>, int> := map[map v60 : int | v60 in (seq(-0x3a3, i9  => (v54.f24))) :: (v60 * |v59|) := (true) := v54.f24];
					var v62 := DC41(v54.f24, v59, p1[v54.f24]);
					var v63: map<int, bool> := map[v62.cf61 := v34[202]];
					var v64 := new C8(v54.f24 / v54.f24, -|(if (v34[202]) then v59 else v59)|, v0, p1[if (v63 in v61) then v61[v63] else f17], p0, v54.f24 !in cf16);
					...
					var v72: map<bool, map<D22, bool>> := map[v34[202] := v71];
					var v73: seq<map<D22, bool>> := [v71, v71, v71];
					var v74: array<map<bool, map<D22, bool>>> := new map<bool, map<D22, bool>>[13] [v72, v72 + v72, v72, v72, v72, v72, (map[v0 := v71])[p0 := v71], map[v0 := map[DC53(v69) := true]] + v72, v72, v72[v34[202] := map[v70 := v0]] + map[v0 := v73[v54.f24]], v72, map[v0 := v71] + v72, v72 + map[v34[202] := v71]];
					v74[625] := if (p0) then map[true := map[v70 := v34[202]]] else map[true := v71[v70 := v0]];
		...
		match (v79.(cf88 := p0)) {
			case DC57(cf86, cf87, cf88) =>
				...
				var v87: multiset<bool> := multiset{!(|v83| < fm17(|v86[f17]|, p0, fm40(globalState), globalState))};
				v84 := v87 * multiset{p0};
				var v88: map<bool, string> := map[cf88 := seq(0xff, i10  => (v77))];
				var v89 := "nbcdn";
			...
			case DC56(cf85) =>
				...
				var v99: T0 := new C2(v94 + map[v95 := v93], p0 || p0, |(map[v77 := |fm74(v96, globalState)|] + v97)|, f17 * f17, p1[f17], p1[f17], v98 !! v98, v0);
				v99, v0 := v99, v99.f3;
				var v100: map<int, bool> := map[f17 := 398 != f17];
				v99.f2 := if (f17 in v100) then v100[f17] else true && p0;
				globalState.f0 := |(p1 + DC16(p1).cf25)[|(p1 + p1)| := v99.f2]|;
				v99.f2, v77, v95, v99.f3 := p1[f17], v77, v95[0x59 := v77] + v95, true;
		}
	...
	method m10(p0: int, p1: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		var v4: map<set<bool>, bool> := map[v3 := (seq(0xe8, i0  => ('e'))) <= v1];
		v4 := v4;
		...
		var v9: array<bool> := new bool[25] [-f17 < --0x3a4, fm40(globalState), p1, v7.cf79, p1, p1, p1, p1, p1 <== p1, true, p1, if (p1) then p1 else v8[0xaf], p1, p1, p1, p1, false, p0 < 467, p1, p1 && !p1, p1 && p1, p1, p1, p1, p1];
			...
			decreases 100 - i1
		{
			...
			match (v15) {
				...
				case DC9(cf14) =>
					...
					v1 := v1[v0[|"g"|] := fm48(p1, globalState)];
				...
				case DC11(cf15) =>
					...
					v27 := multiset(v0[0x2a4 := 0x31e]) * (v27 * v27);
			...
			if (fm21(globalState)) {
				...
				var v33 := new C3(v32, p0, p0 / f17, |v0| <= -f17, p1, p1 <== true, p1);
			} else {
				r1 := p1;
				r1 := p1;
				var v34: array<int> := new int[3] [f17, f17 - |v1|, f17];
				v34[950] := p0 / p0;
				r1, v34[950] := p1, (f17 / f17) / p0;
				v9[691] := p1;
				var v35 := DC6(fm17(|v1|, p1, p1, globalState), p0, |fm58(globalState)|);
				var v37: set<D3> := {v35, v35, v35};
				r1, v9[691], v34[950], v34 := !(v35 in (map v36 : D3 | v36 in v37 :: (v36) := (multiset{p0}))), p1, v34[950], v34;
				v9[691] := p1;
			}
...
class C11 extends T1, T0 {
	...
	function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		(|(seq(497, i0  => ('y')))| - |"pmxyqdo"|) % (|map[true := |{false, f2, f3}|]| / |(seq(715, i1  => ([|map[true := f4]|])))|)
	}
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		var v0 := 0xdd;
		var v1 := "cdnmq";
		var v2: seq<int> := [v0, v0, fm0(!p1.f3, |v1|, v0, globalState)];
		var v3: multiset<int> := multiset{v2[v0]};
		var i0 := 0;
		while (v3 > v3)
			decreases 100 - i0
		{
			...
			if (f5) {
				...
				var v9 := DC5(|(if (f2 in v8) then v8[f2] else map[p1.f3 := "yytickf"])[p1.f3 := seq(0x109, i1  => (v6))]|);
				v9 := v9;
				var v10 := DC0();
				...
				globalState.f0, v13[83], p1.f3, f2, p1.f3 := -DC7(v0, 988, v0).cf10, v2, (multiset{v5, v5})[v5 := v0] <= v14, v0 == v0, |(v2 + v2)| <= v0;
			...
			var v18: multiset<bool> := multiset{false, p0[v0]};
			...
			v30[24] := v29;
			var v31: array<D21> := new D21[28](i4 => DC51(v0, v28[338]));
			var v32 := 'r';
			v31[811] := fm77(p1.f2, v0, v32, globalState);
			var v33: multiset<array<bool>> := multiset{v28};
			var v34 := DC51(v0, v32 !in v1);
			v28[338], v30[24], f3, v31[811] := fm56(if (f4) then p1.f2 else f2, v0, globalState), v29, v33 !! multiset{v28}, v34;
		...
		for i5 := --v0 to v0 % fm0(fm40(globalState), |v40[v39 := v0]|, v0, globalState) {
			...
			v42[24] := v2;
			p2[131] := v0;
			p2[131] := -((|"feibgxbi"| * i5) - v0);
		}
		var v43: map<int, bool> := map[v0 := f5];
		v0, p1.f2 := v0, fm40(globalState) ==> (if (|(seq(0x286, i6  => ('i')))| in v43) then v43[|(seq(0x286, i6  => ('i')))|] else false);
		if (f2) {
			...
			var v49: multiset<bool> := multiset{p0[|v1|]};
			v48 := v48[v47 := -(if (f3 in v49) then v49[f3] else |(seq(-0x2d0, i7  => ('j')))|)];
			var v50 := 'f';
			...
			var v54 := new C4(|(seq(-0x181, i8  => (v0)))| - v0, |p0|, f2, p1.f3, v53.fm0(p1.f2, v53.f24, |v2|, globalState) != v0, f3);
			f2 := p1.f2;
		} else {
			v39[185] := p1.f3 && p1.f2;
			var v55: map<int, int> := map[-0xfa := 0x3d7];
			globalState.f0, f2, v39[185] := (|v1| / |v55|) % |fm25(globalState)|, !(v2 < (v2 + v2)), true;
			var v56: map<map<int, bool>, int> := map[v43 + v43 := v0];
			v56 := v56[v43 := v0];
			var v57: multiset<bool> := multiset{true};
			p1.f2 := v57 >= (multiset{p1.f3, f3} + v57[p1.f2 := v0]);
			v39[185] := f2;
			globalState.f0 := v0;
		}
		
		globalState.f0 := v0;
		p2[159] := fm17(v0, p1.f2, !f4, globalState);
		p2[159] := v0;
	}
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (f2) {
			...
			if (f2) {
				var v8 := "d";
				var v9 := 'v';
				var v10: set<string> := {v8 + v8, seq(-0x39b, i0  => ('v')), v8 + v8[v0 := v9], v8};
				r0 := |v10|;
				globalState.f0 := v0;
				v8 := seq(0xee, i1  => (v9));
				f3 := f4;
				...
				var v17 := new C4(|(v16 + v16)|, v0, !!p3, v16[v0], !(v16 == v16), f3);
			}
			...
			v24[263], v23, v25, f2, v24 := v23 > fm17(v23, f4, p3, globalState), v23 * -(v23 - |(seq(511, i2  => ('c')))|), v25, ((seq(399, i3  => ('d'))) <= v26[v23 := v27]) <==> (fm17(v23, true, p2, globalState) > v23), if (p2) then v24 else v33.cf73;
			f3 := (if (!f5) then fm33(seq(0x376, i4  => (DC8(DC5(v23)))), globalState) else f4) || p2;
			if (!!f5) {
				v23 := v23;
				globalState.f0 := |((v28 * v28) - v28)|;
				var v35: array<map<seq<bool>, seq<bool>>> := new map<seq<bool>, seq<bool>>[22](i5 => map[[f2] := [!v24[263]]] + (map v34 : seq<bool> | v34 in {[v24[263]], [f3], [p3, f5]} :: (v34) := ([p2])));
				var v36: seq<bool> := [false];
				v35[747] := map[v36 := v36];
				v35[747] := (fm78(v27, globalState)).cf98;
				...
				var v41: map<seq<int>, map<bool, D26>> := map[[v30[v23], v23, |v30|, v23] := v40[v23]];
				var v42: map<bool, array<bool>> := map[f4 := v24];
				var v43 := DC40(v42);
				var v44 := DC42(v43);
				var v45: seq<multiset<int>> := [multiset{v23, v23}];
				var v46 := DC62(v27, f2, |v45[v23]|, v36);
				var v47: map<bool, D26> := map[f2 := v46];
				v39[704], v23, v41, v24[263], v44 := v37.(cf36 := {v23, |[v26, v26]|} !! v28), -v23, (map[v30 := v47] + v41) + (v41 + v41), !f2, v44;
				v27 := v27;
			} else {
				...
				v49[712] := v23 + |fm25(globalState)|;
				var v51: array<map<char, int>> := new map<char, int>[19];
				var v52: map<char, int> := map[fm39(f5, v30, globalState) := v23];
				v51[960] := v52;
				var v53: seq<bool> := [f3];
				v23, v50, v49[712], v51[960] := v23, (if (v53[v23]) then v50 else v50) + ((seq(0x379, i6  => (v29))) + v50), -|v26| % 0x137, v52 + v52;
				var v54 := DC54(f5, v49[712]);
				var v55: map<bool, D22> := map[v53[v49[712]] := v54];
				var v56: map<bool, seq<bool>> := map[p2 := [p2, f3]];
				var v57: map<int, bool> := map[|(if (p3 in v56) then v56[p3] else v53)| := f2];
				v55 := v55[f4 <==> (if (v23 in v57) then v57[v23] else v24[263]) := if (p2) then v54 else DC54(fm26(v49[712], globalState), v49[712])];
				globalState.f0 := --v49[712];
			}
		...
		if (fm17(v59, f3, p3, globalState) != |(v60 + v60)|) {
			...
			if (p2) {
				...
				var v69: map<bool, int> := map[f3 := v60[fm17(fm17(fm0(p3, v59, -fm17(0x181, f4, f2, globalState), globalState), true, f3, globalState), p2, p3, globalState)]];
				v69 := v69[f3 := v59];
				...
				var v74: array<array<seq<int>>> := new array<seq<int>>[19] [v72, v72, v72, v72, v72, v72, v72, v72, v72, if (f2) then v72 else v72, v72, v72, v72, v72, v72, v72, v73[v59], v72, v72];
				v74[888] := v72;
				var v75: multiset<int> := multiset{v59, fm0(p3, v59, v59, globalState), v59, v59};
				var v76 := DC25(f2, |v75|, f4);
				var v77: map<bool, int> := map[p3 := v59 % fm17(v59, p3, f2, globalState)];
				v71, v65, v74[888], v65, v59 := if (true) then v71 + map[v59 := v65] else v71 + v71, v65, v72, fm48(v76.cf36, globalState), if (f2 in v77) then v77[f2] else 0xc5 * -v59;
				var v78 := new C0();
				...
				v83[392] := p3;
				v84, v83[392] := v84[f4 := !(v65 in v64[|v64| := v65])], f2;
			...
			match (fm80(|v88|, globalState).(cf56 := -v59, cf52 := |v89|, cf53 := f2)) {
				case DC36(cf52, cf53, cf54, cf55, cf56) =>
					...
					var v101: multiset<int> := multiset{v59 / |v100|, cf52, fm17(cf54, f3, f4, globalState)};
					var v102: seq<bool> := [cf53, f3];
					var v103: map<int, seq<bool>> := map[cf54 * cf52 := v102[cf52 := cf55] + v102];
					v99[617], globalState.f0, r1, v90, v101 := v94 in "xl", |(if (cf56 in v103) then v103[cf56] else v102)|, true, v90, v101;
					var v104: seq<multiset<int>> := [(multiset{cf52, cf56})[0x226 := |v89|], v101, multiset{-|v100|, cf54}, v101, fm59(globalState)];
					v104 := v104;
				case DC35(cf51) =>
				...
				case DC37(cf57) =>
					var v109 := "rvdqv";
					var v110: multiset<string> := multiset{seq(0x3b6, i9  => ('l')), v109, v109};
					f2 := multiset{v109} > v110;
					var v111 := 'i';
					v111 := v111;
					var v112: array<string> := new string[28] [v109, if (p3) then "ajqyhuwi" else "uv", v109, v109 + "biwog", v109 + v109, "xlv", v109, "w", v109, v109 + ("w")[v59 := v111], if (!p3) then v109 else v109, v109, seq(962, i10  => (v111)), seq(0xe9, i11  => (v111)), v109, (seq(546, i12  => (v111))) + v109, "kn", v109, v109, v109, v109, (v109[v59 := v111])[v59 := v111], v109, v109[|v109| := v111] + "ucfc", v109, seq(0x35c, i13  => ('c')), v109, v109];
					v112[334] := "k";
					v112[334] := seq(0x14, i14  => (v111));
					r0 := -0x380;
			}
		...
		match (v125) {
			case DC34(cf50) =>
				...
				if (|v62[fm0(v124.f5, v59, v59, globalState) := 0x2cc]| < (|v127| % (if ('o' in v128) then v128['o'] else |v126|))) {
					var v129: array<seq<int>> := new seq<int>[1] [seq(811, i15  => (v59))];
					v129 := v129;
					v121 := v121[v59 := v122];
					var v130: array<bool> := new bool[6] [v124.f3, cf50.f4, !p2, (seq(0x130, i16  => (v59))) != v60, v124.f5, true];
					v130 := v130;
					v130[936] := v124.f2;
					v130[936] := false;
					globalState.f0 := v59;
					...
					var v132: map<int, array<int>> := map[|v121| := if (v124.f2) then p1 else v131[|v121|]];
					v132 := map[v59 + v59 := p1];
		...
		if (!f5) {
			...
			v122, v59, v136, globalState.f0, v59 := v121[v59], |v121| / (|v135| - |v60[v59 := v59]|), v136 + v136, v59, v59;
			if (p2) {
				var v137: array<bool> := new bool[3];
				v137[127] := v135[v59];
				var v138: array<char> := new char[26];
				v138[354] := if (f2) then v122 else v122;
				...
				v139[222] := v141;
				v137[127], v138[354], v59, globalState.f0, v139[222] := p2, v122, v59, v59, v141;
				globalState.f0 := v59;
				v125 := v125;
				p1[951] := v59;
				p1[951] := 0x1bb - v59;
				...
				var v144 := new C4(v59 / v59, v59 + |v142|, v124.f2, v124.f3, v143.cf36, f3);
			} else {
			...
			if (!(if (p2) then v124.f4 else v124.f3)) {
				...
				p1[592] := fm0(v124.f2, v59, v59 / |v155|, globalState);
				v124.f3 := v124.f4;
				globalState.f0 := p1[592];
			}
			
			var v156: map<int, bool> := map[v59 := p3];
			var v157: array<bool> := new bool[4];
			var v158: array<seq<char>> := new string[24](i18 => v121);
			v158[62] := if (f4) then v121 else v121;
			v156, v157, v124.f2, v158[62], f3 := map[v59 := f2], v157, p3 || !false, v121, v124.f3;
		} else {
			...
			v164 := v166[v124.fm0(v124.f5, v59, 0x3e1, globalState)];
			...
			v169[272] := v172[[v170] := v171];
			var v173: array<D21> := new D21[13];
			v173[557] := DC51(v59, true);
			var v174: array<char> := new char[27](i19 => 'i');
			v174[446] := v168.f25;
			var v175: seq<C4> := [v170];
			var v176 := DC51(v59, v124.f4);
			v124.f2, v169[272], v173[557], v174[446] := v124.f4, if (v60[v59] >= v59) then map[v175 := v171] else v172 + v172, v176, v168.f25;
		}
	...
	method m7(p0: D3, p1: bool, p2: int, p3: bool, globalState: GlobalState) returns (r0: char, r1: map<int, int>) {
			...
			decreases 100 - i0
		{
			...
			var v14: seq<int> := [p2];
			var v15: array<bool> := new bool[14] [v0[p2], if (v3 in v4) then v4[v3] else p3, p1, f2, |v6.cf62| >= p2, f5, true, !!(if (v7 in v8) then v8[v7] else fm35(p1, v9, f3, globalState)), p1, v13 >= v13, v14 == v14, f3, p3, p1];
			v15 := v15;
			var v16: map<int, bool> := map[-0x28e := f5];
			v16 := v16[-0x2fc * p2 := v0[p2]];
		...
		if (v0[p2]) {
			...
			v19[793] := p2;
			v19[793] := v19[793];
			var v20: seq<int> := [0x16f / v19[793]];
			v20 := v20;
			var v21: array<bool> := new bool[25];
			var v22 := DC5(-590);
			var v23: set<int> := {p2, fm0(f4, v22.cf6, v19[793], globalState)};
			v21[634] := v23 >= v23;
			v21[634] := p3;
			var v24 := 'h';
			var v25 := "wnwnmqbj";
			var v26 := DC62(v24, f2, -(|v25| / v19[793]), v0);
			var v27 := DC35(v25);
			var v28 := DC37(v27);
			var v29 := DC37(v28);
			var v30: multiset<int> := multiset{v19[793], 0x162};
			var v31: map<int, bool> := map[|{p3, p3, v21[634], !v21[634], p3}| := f4];
			v19[793], v26, v19[793], v29, globalState.f0 := |(v30 * v30)| - p2, if (if (v19[793] in v31) then v31[v19[793]] else p3) then v26 else v26, p2, fm81(|v0|, v19[793], (fm49(v24, true, globalState))[p2 := v24], globalState), p2;
		} else {
			globalState.f0 := p2 + |(map v32 : int | (0x2e9 <= v32) && (v32 < 0x54) :: (v32 % 0x1) := (f5))|;
		...
		match (v40) {
			case DC25(cf36, cf37, cf38) =>
				...
				v41[812] := v42;
				v41[812] := v42;
				var v43: array<seq<int>> := new seq<int>[20](i1 => [cf37, 0x239, cf37, |"ohmvl"|, p2] + (seq(0x83, i2  => (|{cf37}|))));
				var v44 := "vnnrfsk";
				...
				v43[792], v46, r0, v48, globalState.f0 := if (cf37 in v49) then v48 else [cf37], v46, 'q', v48, fm0(cf36, cf37, cf37, globalState) % (0x205 + cf37);
			...
			case DC26(cf39, cf40, cf41, cf42, cf43) =>
				...
				r0 := fm39(f2, ([cf43, 966])[|v54| := cf43] + [cf43, cf43, cf43, cf43, cf39], globalState);
				var v55 := "xbplr";
				var v56 := DC45((seq(0x273, i4  => ('f'))) != v55);
				var v57: seq<int> := [p2, -cf39, p2];
				cf40[582] := |v57|;
				v56, globalState.f0, cf40[582], cf41 := v56, p2, |v57|, !f3;
				var v58: set<int> := {cf40[582]};
				var v59: map<int, bool> := map[cf43 - cf43 := v58 >= v58];
				v59 := v59;
				var v60: array<map<seq<bool>, int>> := new map<seq<bool>, int>[2];
				v60[442] := map[v0 := cf40[582]];
				var v61: array<map<int, array<int>>> := new map<int, array<int>>[20];
				var v62: map<int, array<int>> := map[cf39 := cf40];
				v61[141] := v62 + v62;
				var v63: set<map<int, bool>> := {v59, map[|(seq(-0x5d, i5  => ('w')))| := false] + map[cf40[582] := cf41], fm58(globalState)};
				var v64: map<seq<bool>, int> := map[v0 := -cf39];
				v60[442], v61[141], v63, cf41 := v64, v62, v63, fm39(f3, v57, globalState) !in (seq(-289, i6  => ('r')));
			case DC24(cf35) =>
				f3 := p2 == p2;
			...
			case DC27(cf44) =>
				...
				v66[351] := p2 % p2;
				v66[351] := fm17(fm17(p2, p3, f3, globalState), p1, p3 ==> f3, globalState);
				var v67 := "xfll";
				var v68 := DC35(v67);
				v68 := v68;
				if (p1) {
					...
					v71[9] := (seq(0x1a8, i7  => (v66[351]))) != [v66[351], v66[351]];
					globalState.f0, v0, v0, v71[9] := v66[351], v0, v0, -(p2 / v66[351]) <= v66[351];
					v71 := v71;
					var v72 := 'b';
					f3 := v67 < (("tjya")[0x2da := v72] + v67);
					var v73: array<char> := new char[25](i8 => v72);
					var v74: map<int, array<char>> := map[p2 := v73];
					var v75: set<array<char>> := {if (v66[351] in v74) then v74[v66[351]] else v73, v73};
					var v76 := new C9(f4, v75 == {v73, v73});
				} else {
					v66[351] := v66[351];
					f2 := f3;
					var v77 := new C4(-p2, -p2, if (f4) then p1 else p3, f4, f5, |"yjviewma"| < v66[351]);
					var v78: array<string> := new string[11];
					v78[702] := v67 + (seq(174, i9  => ('p')));
					v78[702] := if (if (p1) then f2 else p1) then v67 else v67;
					var v79: multiset<int> := multiset{v66[351], p2, v66[351]};
					var v80: map<int, array<int>> := map[|v79| := v66];
					var v81: map<array<int>, map<int, array<int>>> := map[v66 := v80];
					globalState.f0, globalState.f0 := 0x2c6, |(if (v66 in v81) then v81[v66] else map[v66[351] := v66] + v80)|;
				}
				
				var v82: array<bool> := new bool[1] [!true];
				v82[613] := !(if (f2) then false else p1);
				v82[613] := f2;
		}
		...
		v0 := match v85 {
			case DC51(cf78, cf79) => v0[0x317 := f4]
			case DC50(cf77) => v0
		...
		if (f4) {
			...
			var v95: map<map<bool, bool>, set<bool>> := map[v86 := v94[p2]];
			...
			var v96 := new C7(v0);
			var v97 := new C1(-(p2 / p2), v83, false, !(f4 ==> p1), f3, f2);
		} else {
			...
			match (v103) {
				case DC61(cf92) =>
					...
					var v107: map<seq<char>, map<int, bool>> := map[v84 := map v105 : int | v105 in v106 :: (v105 / cf92) := (p3)];
					v104[508] := v107;
					var v108: multiset<bool> := multiset{DC46(true, cf92, f2, cf92).cf69, p1};
					var v109: map<bool, bool> := map[v108 !! fm66(globalState) := f2];
					f2, v99, v104[508] := if (v0[p2] in v109) then v109[v0[p2]] else true, v99, v107;
					v100[511] := if (cf92 in v106) then v106[cf92] else 0xf7;
					v100[82] := cf92;
					v100[511], v100[82] := p2 + p2, (v102[cf92] + p2) * (if (false) then |v0| else p2);
					v99[362] := f3;
				...
				case DC62(cf93, cf94, cf95, cf96) =>
					var v112 := DC7(p2, cf95 % cf95, cf95 % p2);
					var v113: multiset<bool> := multiset{cf94, p3};
					v112 := DC7(p2 / cf95, p2, |v113|);
					var v114: map<bool, seq<multiset<int>>> := map[f2 := seq(259, i10  => (multiset{-0x22a, cf95}))];
				...
				case DC63(cf97) =>
					...
					v127[726] := fm34(globalState);
					v125, v123[31], v127[726] := v125 + map[!p1 := v124[p2 := p2]], v100, [f4];
					f2 := !!true;
					v127[726] := v127[726] + [f4];
			}
			
			v99[169] := if (f3) then p3 else f5;
			v99[169] := f2;
		}
	...
	method m8(p0: seq<seq<bool>>, p1: int, globalState: GlobalState) {
		...
		for i0 := p1 to |v0| % |v1| {
			...
			if ((map v2 : map<int, int> | v2 in multiset(v3) :: (v2) := (p1)) != v4) {
				...
				v11[233] := (fm0(f2, i0, p1, globalState) / p1) * |v14|;
				var v15 := 'l';
				v12 := if (v15 in v12) then v12 + v12 else v12;
				v12 := v12[p1 := v15];
				var v16: seq<bool> := [f4];
				var v17: seq<int> := [|v16|, i0];
				var v18 := new C8(p1, if (!f4) then i0 else v11[233], v17 in multiset{v17}, f5, fm21(globalState), !(!f5 && f4));
				v12 := v12;
			}
			...
			var v20 := 'f';
			var v21 := "kwhjfg";
			var v22 := new C8(fm17(p1, !f4, true, globalState), i0, v20 !in v21, v21[p1 := 'o'] < "fmn", true, f5 <== fm40(globalState));
			globalState.f0 := p1 / (if (f3) then p1 else 0x2b);
		}
		if (|p0| >= p1) {
			...
			var v25, v26 := m7(DC7(p1, p1, p1), f2, p1, !(v24[v23[914] := p1] <= v24), globalState);
			...
			var v36: seq<bool> := [f5];
			globalState.f0 := v35[if (|v36| in v0) then v0[|v36|] else 623] / p1;
			if (false) {
				var v37 := 'a';
				var v38: map<bool, char> := map[true := v37];
				var v39: map<map<bool, char>, bool> := map[v38 := f5];
				var v40: map<map<map<bool, char>, bool>, int> := map[v39 := p1 % |(seq(-176, i3  => (v37)))|];
				...
				v45[395] := if (f5 in v46) then v46[f5] else v42;
				f2 := f5;
				v36 := v36 + v36;
			} else {
				...
				v48 := fm83(seq(569, i4  => ('w')), globalState);
			...
			v61[521] := p1;
			var v62 := 'x';
			globalState.f0, f3, v53, v53, v61[521] := v35[|(v50[p1 := v62])[|v0| := v62]|] % (p1 - p1), f2, v53, v53, |(v50 + v50)|;
		}
...
class C12 extends T2, T1 {
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		...
		var i0 := 0;
		while (!fm11(v0 * v0[f5 := 0xc], v1, v0, globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v2[546] := v3;
			r1 := v2[546];
			var v5: set<seq<int>> := {seq(0xa5, i1  => (f6))};
			var v6 := DC9(v5);
			if (if (f2) then f2 else v5 !! v6.cf14) {
				var v7: array<int> := new int[21](i2 => i2 / -f7);
				v7[659] := f6 % f6;
				v7[659] := |("f" + v4)|;
				globalState.f0 := 544;
				globalState.f0 := f7;
				...
				var v8: seq<bool> := [f16];
				globalState.f0 := |(v8 + ([false, f3])[|v8| := f3])| * f7;
				var v9: map<int, int> := map[f6 := f6];
				var v10: map<int, bool> := map[|v4| := v8[if (|(seq(0x9e, i3  => (|v4|)))| in v9) then v9[|(seq(0x9e, i3  => (|v4|)))|] else -934]];
				var v11: multiset<map<int, bool>> := multiset{v10, v10, v10};
				v11 := v11;
				var v12: map<bool, seq<bool>> := map[f4 || f16 := v8];
				v12 := v12[fm11(v0[f5 := f6], v1, multiset{f5, false}, globalState) := v8];
		...
		var v19: array<seq<int>> := new seq<int>[25] [v16, v16, v16, v16 + v16, seq(0x210, i4  => (-482)), v16, seq(0x255, i5  => (|[f6]|)), [f6, f6, v16[f7]], [f6], v16 + v16, v16, ((seq(547, i6  => (|map[f3 := 'u']|))) + v16)[f6 := f7], v16 + v17.cf16, v16 + (seq(0x3c6, i7  => (f7))), v17.cf16, v16, v16, [f7] + v16, v16, if (f3) then [f7] else v16, v16, v16 + v16[f6 := 0x2d1], v16 + v16, v16, v18[f6]];
		v19[86] := seq(0x325, i8  => (|{true, v15[|{f7, 29}|]}|));
		v19[86] := v16;
		var v20 := "vsc";
		var v21: multiset<int> := multiset{|v20[f7 := 'v']|};
		var v22: map<bool, multiset<int>> := map[f4 := v21];
		var v23: set<int> := {f6, |v22|, |(seq(284, i9  => ('l')))|, f7, |v15|};
		v23 := v23;
		var v24: map<int, bool> := map[|map[f6 := f7]| := f4];
		for i10 := fm0(true, --|v24|, f7, globalState) to |(v20 + (seq(0xe1, i11  => ('a'))))| {
			var v25: array<int> := new int[20];
			var v26: seq<array<int>> := [v25];
			var v27: array<array<int>> := new array<int>[12] [v25, v25, v26[f6], v25, v25, v25, v25, v25, v25, v25, if (f4) then v25 else v25, v25];
			var v28: seq<array<array<int>>> := [v27, if (f2) then v27 else v27];
			v27 := v28[|map[f16 := (seq(0x2c4, i12  => (f6)))[v19[86][f7] := -0x166]]|];
			var v29 := DC10();
			match (v29) {
				case DC10() =>
					...
					var v32: set<seq<int>> := {v18[-0x188], seq(-988, i14  => (f6))};
					var v33 := DC9(v32);
					var v34: array<bool> := new bool[7];
					v34[72] := f4;
					v33, globalState.f0, r2, v34[72] := v33, 34 + |fm12(globalState)|, if (f4) then f4 else f16, fm11(v0, fm13(fm11(v0, v1, v0, globalState), globalState), fm14(globalState), globalState);
					globalState.f0 := |(v19[86] + (v19[86] + [f7, -0x10f]))|;
					var v35: map<char, bool> := map['j' := v34[72]];
					var v36 := 'f';
				...
				case DC9(cf14) =>
					...
					v38[418] := if (|v20| in v40) then v40[|v20|] else v39;
					v38[418] := v39;
				...
				case DC11(cf15) =>
					...
					var v48 := new C4(if (v46 in v47) then v47[v46] else -i10, i10, v15[|"wpodhjkmn"|], if (false) then f16 else f16, f16, f4);
					var v49: set<bool> := {false};
					var v50 := new C11(v49 !! v49, f3, fm26(|fm85(globalState)|, globalState), f4);
					var v51: array<seq<bool>> := new seq<bool>[14] [[fm26(|v20|, globalState)], v15, v15, v15, v15, [f2], [f3], v15, v15 + v15, v15 + v15, (v15[i10 := f2])[f6 := true], v15, v15, DC16(fm57(v19[86], globalState)).cf25];
					v51[569] := [f16] + v15;
					v51[569] := v15 + v15;
			}
			...
			var v53: map<string, seq<int>> := map[v20 := seq(0x13b, i15  => (f6))];
			...
			var v58 := new C3(v52, i10, i10, f3, f2, v57[f6] in [v56, v56], f16);
			var v59: map<int, int> := map[|(seq(0x26e, i16  => ('o')))| := f6];
			...
			var v67: array<D18> := new D18[16] [v60, v60, v60, DC41(f6, seq(0x8b, i17  => ('r')), f3), v60, v60, DC41(f6, "sqcqkpmpn", f16).(cf61 := -i10), v60, fm86(f7, true, v66, globalState), v60, v60, v60, v60, v60, if (true) then v60 else v60, v60];
			v67[649] := v60.(cf62 := (fm22(globalState))[f7 := 'x'], cf61 := i10);
			v67[649] := if (f5) then fm86(f7, f5, {f3}, globalState) else v60;
		}
		r0 := f3;
		var v68 := 'y';
		r1 := v68;
		r2 := if ((f7 + f7) in v24) then v24[f7 + f7] else v15[f6] ==> f4;
		r3 := seq(0x20e, i18  => (v68));
	}
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		var v6: array<bool> := new bool[29] [f16, if (f16 in v0) then v0[f16] else p1.f2, true, f7 == 0x26f, true, v1 > multiset(v3), p1.f3, f2, f5, f6 <= |v2|, fm26(f6, globalState), p0[f6], p1.f2, f5, f4, f4, f16, !!p1.f2, p1.f3 in map[f3 := f6], if (p1.f3) then true else !p1.f3, f6 <= f7, f16, !f16, f3, v4.cf3 ==> !p0[if (|multiset(p0)| in v1) then v1[|multiset(p0)|] else |v2|], fm35(f3, v5, p1.f2, globalState), f3, f4, p1.f2];
		v6[789] := if (false) then !f5 else f3;
		var v7: set<bool> := {f3, p1.f3};
		var v8: map<bool, set<bool>> := map[p1.f3 := v7];
		f2, v6, v6[789] := (if (fm26(|v5|, globalState) in v8) then v8[fm26(|v5|, globalState)] else v7) > v7, v6, p1.f2;
		var v9 := "ffcnsb";
		var v10 := DC35(v9);
		v6[789], globalState.f0 := fm40(globalState), match v10 {
		...
		if (if (p1.f2) then false else fm26(f6, globalState)) {
			...
			p2[773] := if (f3) then f7 else f6;
			p2[773] := 616 + f6;
			globalState.f0 := |(seq(397, i1  => (if (f2) then 'l' else 'r')))|;
			v7 := {true, f2};
		...
		var v18: map<int, seq<bool>> := map[|p0[f7 := f5]| := p0];
		...
		if (match v19 {
			...
			var v20: C10 := new C10(f6 / f6);
			v20 := v20;
			if (p1.f3 || p1.f2) {
				var v21 := 'l';
				var v22: array<char> := new char[3] [v21, v21, v21];
				var v23: map<string, array<char>> := map[fm22(globalState) := v22];
				v23 := v23[((if (!v6[789]) then v9 else v9)[fm0(p1.f3, |p0|, v20.f17, globalState) := v21])[|fm87(p1.f2, globalState)| := v21] := v22];
				...
				var v30: map<seq<int>, map<int, D11>> := map[v3 + [f6] := if (v6 in v28) then v28[v6] else if (p2[918] in v29) then v29[p2[918]] else v27];
				var v31 := DC57(v5, -|v9|, f4);
				globalState.f0, v6, v30, p1.f2 := f7 / (fm1(|v9|, globalState) % -p2[918]), v6, v30, v31.cf88;
			} else {
				...
				p2[169], p1.f3, v33[893], v34 := if (f3) then f7 else f7, false, (seq(-0x1b0, i2  => (v20.f17)))[|v3| := |v9|], v34;
				var v35: array<multiset<bool>> := new multiset<bool>[7];
				var v36: map<int, array<multiset<bool>>> := map[-(f6 % p2[169]) := v35];
				var v37: seq<array<multiset<bool>>> := [v35, v35, DC71(v35).cf106];
				v35 := if (f7 in v36) then v36[f7] else v37[p2[169]];
				var v38: array<seq<bool>> := new seq<bool>[11] [p0 + (if (v20.f17 in v18) then v18[v20.f17] else p0), ([p1.f2, f16, f5, true])[f6 := v6[789]], p0 + p0, fm34(globalState) + p0, [f16] + fm34(globalState), p0, p0 + p0, p0 + p0, p0, p0 + p0, [f5, f5, p1.f3]];
				v38[615] := [p1.f2, p1.f3, f3];
				v38[615] := p0;
				v33 := v33;
			}
			...
			if (v40.cf21) {
				...
				var v46 := new C1(|v5|, v9[|v43|], true, v45 > v45, !false, p1.f2 in fm34(globalState));
				v9 := v9;
				globalState.f0 := f6;
			} else {
				var v47: multiset<bool> := multiset{p1.f3};
				p2[226] := |(v47 - v47)|;
				p1.f3, p2[226], globalState.f0 := !p1.f3, -0x2ab, |(v3 + v3)|;
				var v48: set<int> := {0x289};
				var v49: set<int> := {p2[226] + p2[226], v20.f17, |v48|};
				var v50: seq<set<int>> := [v48 + v48, v48, v48 * {v20.f17, p2[226]}];
				v48, v9 := v50[v20.f17], v9 + v9;
				p2[226] := v20.f17;
			...
			var v58 := DC39(v57);
			v58 := v58;
			globalState.f0 := fm17(f6, !v6[789], p1.f2, globalState);
			...
			match (v61) {
				case DC41(cf61, cf62, cf63) =>
					...
					v64[891] := map[f6 := f7];
					v6, v64[891] := v6, if (f4) then v5[fm2(-|v0|, globalState) := cf61] + (map v65 : int | v65 in v3 :: (v65 - -cf61) := (0x9b)) else v5;
				...
				case DC40(cf60) =>
					...
					p2[360] := |v67|;
					p2[360] := |v61.cf62| + fm2(|p0|, globalState);
					p2[360] := p2[360];
					var v68: array<string> := new string[17];
					var v69: map<int, array<string>> := map[-f7 := v68];
					var v70: seq<array<string>> := [v68, v68, v68, v68];
					var v71: array<array<string>> := new array<string>[20] [v68, v68, v68, v68, if (p2[360] in v69) then v69[p2[360]] else v68, v68, v68, v68, v68, v70[f7], v68, v68, v68, v68, v68, v68, v68, v68, v68, v68];
					v71[271] := v68;
					v71[271] := v68;
				case DC42(cf64) =>
					var v72 := 'p';
					var v73: map<char, bool> := map[v72 := v59];
					var v74: multiset<bool> := multiset{v6[789], p1.f3, p1.f3, if (v72 in v73) then v73[v72] else p1.f3, p1.f3};
					var v75: map<bool, int> := map[p1.f3 := f6];
					var v76: set<int> := {f6};
					var v77: array<int> := new int[8] [-f7 % f6, f6 % f7, |v74|, f6, f6, f6, if (v6[789] in v75) then v75[v6[789]] else f6, |v76| / f7];
					v77 := p2;
					v0 := v0[p1.f2 := p1.f2 && f2];
					globalState.f0 := f6;
					var v78 := DC60(v1);
					var v79: map<D26, seq<bool>> := map[v78 := p0];
					v59, globalState.f0, globalState.f0, v77, f2 := (p0 + p0) == (p0[f7 := p1.f3] + (if (v78 in v79) then v79[v78] else p0)), f6 - (f7 + -|v9|), -0x340, p2, p1.f3 ==> (|v9| != |v74|);
			}
			
			p2[133] := fm2(f7, globalState);
			p2[133] := fm17(f7, f7 in (map v80 : int | (580 <= v80) && (v80 < 0x28c) :: (v80 % f6) := (p1.f3)), f6 < f6, globalState);
		}
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (false <==> f3) {
			...
			var v4: map<bool, bool> := map[!(v2[f6] in v3[f7]) := true];
			v4 := v4[f6 < f6 := f5];
			var v5 := 'f';
			...
			var v11: array<bool> := new bool[24] [!v10[f7], f16, f3, f3, !p2, f3, f4, f3, f4, f5, f5, f5, !p3, !f4, f5, f16, false, !f4, f2, true, !f3, p3, f2, f2];
			...
			if (v12 >= v12) {
				...
				v11[982] := f7 != |v2|;
				v11[982] := !p3;
				var v15: array<multiset<int>> := new multiset<int>[1](i0 => multiset{|(seq(0x16d, i1  => ('s')))|});
				var v16 := new C3(v15, v0[-f6], f7, p3, p2, p3, p2);
			} else {
			...
			match (v30) {
				case DC10() =>
					...
					v34[508] := ((if (f16 in v33) then v33[f16] else multiset{f6})[f7 := f7])[-0x34e := |v37[f7 := v36]|] + multiset(v27);
					...
					var v42: array<int> := new int[26](i3 => i3 % f7);
					var v43 := "gjbktj";
					var v44: array<char> := new char[29];
					v44[521] := fm48(f2, globalState);
					var v45 := 'p';
					var v46: array<bool> := new bool[17](i4 => p2);
					v46[297] := v31 !! v31;
					var v47: map<bool, char> := map[!!false := v45];
					v42, v43, v44[521], v45, v46[297] := p1, v43, v45, if (f2 in v47) then v47[f2] else 'u', f3;
					globalState.f0 := f6;
				case DC9(cf14) =>
			...
			var v54: set<bool> := {p2};
			v53[559] := ([f7])[|v54| := f6];
			v53[559] := v27 + (fm25(globalState) + v27);
			...
			decreases 100 - i7
		{
			...
			var v64: map<string, seq<int>> := map[seq(0x2c3, i9  => (v63.f25)) := v62 + v62];
			var v65 := "u";
			v64 := map[v65 + v65 := v62];
	...
	method m6(p0: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		for i0 := v0.cf9 to |multiset{f16, f5, f2}| {
			...
			v3[240] := f2;
			var v4 := 'k';
			v1, v1, v2, r0, v3[240] := v1 + v1, (fm15(f16, i0, f4, v4, globalState) + v1) + ("yskcxot" + v1), DC7(f7 % f6, p0, i0), false, v4 !in "vubei";
			globalState.f0 := f6;
		...
		if (f16) {
			...
			match (v10) {
				case DC20(cf28, cf29) =>
					...
					v12[876] := f5;
					v12[876] := f4;
					var v13: set<int> := {f7, |([v12[876], f4])[0xba := f4]|};
				...
				case DC19(cf27) =>
					...
					v22[35] := if (f2) then v9 else cf27;
					globalState.f0, v8, r0, v22[35] := p0 / p0, fm22(globalState), p0 != 0xe7, ([seq(-254, i2  => ('t')), v8, v8])[-p0 := v8] + v9;
					var v23: map<bool, string> := map[f3 := "uguisvkse"];
					v8 := if (f2 in v23) then v23[f2] else v8;
					globalState.f0 := p0;
			}
			
			globalState.f0 := if (f2) then p0 % p0 else f7;
			...
			var v29: array<int> := new int[26] [|multiset(v24)|, p0, f6, |map[f3 := !!f16]|, (if (f7 in v25) then v25[f7] else f7) / |v8|, f7 - f6, p0, f7, f7, f7, |v24|, f7, f7, if (f4 in v26) then v26[f4] else f7, if (p0 in v25) then v25[p0] else f7, |multiset([p0, 0x2cf, f7, p0])|, |v28|, f6, p0, p0, p0, p0, f7, p0, f6, 227];
			v29[490] := f7 / f7;
			v29[490] := 0x1e0 * -p0;
			if (!(f6 >= v29[490])) {
				var v30 := new C0();
				var v31: multiset<int> := multiset{v29[490]};
				var v32 := new C5(v31);
				var v33: set<int> := {v29[490]};
				v33 := v33;
				v27[187] := f16;
				var v34 := DC20(v29[490], f6);
				v27[187] := fm35(v34.cf28 != f7, v25, f3, globalState);
				v29[490] := -|(fm91(!true, f2, globalState)).cf51|;
			} else {
				v27, f2, r0, r1, globalState.f0 := v27, f2, f16, ("pguab" + v8) != v8, -372;
				var v35: multiset<int> := multiset{-v29[490], f6, p0};
				globalState.f0 := (if (f5) then f7 else f6) * (if (f7 in v35) then v35[f7] else 209);
				v26 := v26[v29[490] == p0 := v29[490]];
				v29 := v29;
				v27[272] := f2;
				v27[272] := !((v29[490] - 0x141) <= v29[490]);
			}
			...
			v27[261], v27[905], v36[859], r1 := !f3, if ((if (f3) then v29 else v29) in v37) then v37[if (f3) then v29 else v29] else f2, (v6 + (seq(0x1b, i4  => (p0))))[p0 := v29[490]] + (v6 + v6), true;
		} else {
			...
			if (fm56(false, f7, globalState)) {
				...
				v55[881] := map[if (f7 in v56) then v56[f7] else |v57| := -(if (v39 in v58) then v58[v39] else p0)];
				var v59: array<int> := new int[7](i6 => i6 % f7);
				v59[421] := fm0(f3, -p0, f6, globalState);
				v59[178] := f6;
				v55[881], v59[421], v59[178] := v56, f7, f7;
				var v60: map<char, bool> := map[v40 := true];
				var v61: map<map<char, bool>, string> := map[v60 + v60 := v39];
				v61 := v61;
				var v62: array<bool> := new bool[11] [f5, f4, f16, f16, f4, f16, v38[v59[421]], f2, f4, f5, v40 in (seq(0x39d, i7  => (v40)))[f7 := v40]];
				v62[108] := f3;
				v62[108] := f4;
				var v63: map<bool, int> := map[f5 := v59[421]];
				var v64: map<int, bool> := map[f6 := v62[108]];
...
class C13 {
	...
	method m5(p0: string, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v4 := 0x10b;
		var v5: seq<int> := [v4];
		var v6: array<multiset<bool>> := new multiset<bool>[29] [v1, multiset{v0}, multiset{v0}, v1 - v1, v1, v1, v1, v1, v1[v0 := |p0|], v1 * v1, v1, v1, v1 - multiset(v2), v1 - v1, multiset{fm10(v0, globalState), v0}, v1, v1, v1, multiset{if (|multiset(v5)| in v3) then v3[|multiset(v5)|] else v0}, v1[v0 := v4], v1, v1 - v1[true := |v2|], v1, multiset{v0, v0, v0, v0}, multiset(v2 + v2), multiset(v2[611 := v0]), multiset(v2), multiset{false} * v1, v1 + v1];
		forall i0 | 0 <= i0 < v6.Length {
			v6[i0] := if (v0) then v1[v0 := v4] else v1;
		}
		var v7: array<int> := new int[6] [v4, v4 - |v2|, v4 % v4, v4, v4, v4 - v4];
		v7 := v7;
		var v8 := DC3(v1);
			...
			decreases 100 - i2
		{
			...
			if (v0) {
				...
				var v20 := new C2(v19, v0, fm17(v4, v0, v0, globalState), v5[v4], v0, v0, v0, v0);
				globalState.f0 := (v4 + v4) % v4;
			} else {
				r0 := v4 / |{v0, !v0}|;
				v4 := v4;
...
class C14 extends T0, T1 {
	...
	function fm0(p0: bool, p1: int, p2: int, globalState: GlobalState): int {
		-((if (true) then |"my"| else |map[f4 := [f4]]|) / DC6(|{f5, true, f4}|, 0x3d2, -855).cf9)
	}
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		var v11: seq<int> := [v3, |v8[|v6| := v3]|, v10.cf7];
		var v12: array<int> := new int[17] [v3 + |(seq(-348, i2  => (v3)))|, v3, if (v4 in v5) then v5[v4] else v3, v3 * v3, v3, |p0|, v3, v3, |v6|, v3, |v8| / v3, v3, fm0(f3, 0x3c8, v3, globalState), v3, -v3, -|p0|, v3];
		...
		match (v15) {
			case DC0() =>
				if (p1.f3) {
					...
					var v19: array<string> := new string[16] [if (p1.f3 in v16) then v16[p1.f3] else if (!p1.f2 in v16) then v16[!p1.f2] else seq(0xdd, i3  => ('s')), "vrbjswmt", fm7(511, v3, v3, globalState), seq(467, i4  => ('r')), v6, v6, seq(-0x2f7, i5  => ('l')), v6, v6, v6, v6, v6, v6, v6, v6[v3 := fm8([v8[|(if (v3 in v18) then v18[v3] else v17)|], v3], p1.f3, fm9(v3, map[v3 := v6], v3, globalState), p1.f2, globalState)], v6];
					v19[925] := v6;
					v19[925] := v6;
					p1.f3, f2, v8, v16 := if (true) then false ==> !f5 else v3 != v3, f5, v8, v16;
					globalState.f0 := (v3 % v3) - (v3 - fm0(f3, v3, v3, globalState));
					globalState.f0 := v3;
			...
			case DC1(cf0, cf1, cf2) =>
				...
				v25[119] := v4 + (map v26 : int | v26 in v27 :: (v26 + v3) := (f5));
				v25[119] := v4;
				if (cf1 <== false) {
					var v28: map<bool, string> := map[p1.f3 := v6];
					var v29: seq<string> := [if (f4 in v28) then v28[f4] else seq(-609, i9  => ('i'))];
					var v30: array<string> := new seq<char>[16] [seq(0x29b, i7  => ('b')), v6 + v6, v6, v6, v6, v6, v6, "jsrsqjcre" + v6, if (f2) then v6 else "htamhukl", v6, seq(172, i8  => ('q')), v6, v6, v29[fm0(p1.f3, 0x6, cf2, globalState)], v6, "yrotjt"];
					v30[548] := v6;
					v30[548] := (v6 + (seq(0x6, i10  => ('i')))) + v6;
					var v31 := DC57(v27, -0x1a2, p1.f3);
					var v32 := new C6(v3, p1.f3 <== f2, true, !v31.cf88, p1.f2 || p1.f2);
					f2 := p1.f3;
					var v33: set<map<int, bool>> := {v25[119], v25[119], v25[119], map[cf2 := p1.f2], v25[119]};
					var v34 := DC35(v30[548]);
					var v35: map<int, string> := map[|v33| := v34.cf51];
					var v36: multiset<int> := multiset{v3, v3, |v30[548]|};
					var v37: array<multiset<int>> := new multiset<int>[5] [v36, v36[-cf2 := v3], multiset{cf2} + v36, v36, multiset{v32.f19, cf2, |v7|, v32.f19}];
					var v39: seq<array<bool>> := [v2];
					var v40: map<bool, array<bool>> := map[p1.f2 := v39[v3]];
					var v41 := DC40(v40);
					var v42: map<D18, int> := map[v41 := v32.f19];
					var v43: seq<map<D18, int>> := [v42, v42[DC40(v40) := v3]];
					f3, v35, f3, v37, globalState.f0 := !p1.f2, map v38 : int | (0xc0 <= v38) && (v38 < -502) :: (v38 * v3) := ((v30[548] + v6)[cf2 := 'c']), v43 <= v43[v32.f19 := v42], if (f5) then v37 else if (f5) then v37 else v37, v3 + v32.f19;
					var v44: array<char> := new char[20];
					var v45: map<array<char>, int> := map[v44 := -v32.f19];
					var v46, v47 := v32.m1(v45, cf0, p1.f2, f4, globalState);
				} else {
					p1.f3 := true;
					var v49: T1 := new C12(p1.f2, cf2, fm0(false, -0x2fd, cf2, globalState), p1.f2, p1.f2, p1.f2, v4 != (map v48 : int | v48 in {cf2} :: (v48 % v3) := (p1.f2)));
					var v50 := 'r';
				...
				v58[966] := cf0;
				var v59: array<multiset<char>> := new multiset<char>[24](i11 => multiset(seq(575, i12  => ('u'))) - multiset{v57});
				v2[851], v58[966], v3, v59, globalState.f0 := cf1, cf0, cf2, v59, |"ttpkdfawh"|;
			case DC2(cf3) =>
				var v60 := 'l';
				v60 := v60;
				f3 := !p1.f2;
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		var v1: array<D19> := new D19[1](i1 => DC43(map v0 : int | (-0x266 <= v0) && (v0 < 0x341) :: (v0 % 0x18d) := (0x1b5)));
		...
		v2[112] := v11 + map[v4 := f3];
		v2[112] := map[|(v3 + "tiqtpq")| := v9.f3];
		v3 := v3;
		v8 := (v8 + v8) + v8;
		var v12 := 'g';
		if (v12 in v3) {
			v8 := v8 + v8;
			globalState.f0 := fm0(p2, v4, v4, globalState) % v4;
			v9.f3 := p2;
			var v13: seq<seq<int>> := [v5];
			var v14: map<seq<int>, int> := map[v13[v4] := v4];
			...
			match (DC18(v18)) {
				case DC17() =>
					...
					var v22 := DC76(v21, v4);
					v20[546] := v4 <= -v22.cf112;
					var v23: multiset<bool> := multiset{v9.f2, v9.f2, v9.f3, false, v9.f3};
					v20[546] := (fm14(globalState) - v23) !! (v23 * multiset{f5, v9.f3});
					...
					var v31: array<set<int>> := new set<int>[22] [{v4, -v5[|v26|], v4, v4, v4} * v27, {v4}, v27, fm52(v4, globalState), {v4}, v27, v27, v27, {v28.cf39}, v27, {v4, v4, -|v29|, v4, if (false in v8) then v8[false] else v4}, fm52(|v30|, globalState), v27, v27 - v27, {v4}, v27, v27, {v4}, v27 * {v4}, v27, v27, {v4, v4} * fm52(v4, globalState)];
					var v33 := DC5(v4);
					v20[546], v31, globalState.f0, v4 := !!(v9.f2 ==> (p3 <== v9.f3)), v31, v4 + |(v3 + v3)|, -|DC48(set v32 : int | (0x388 <= v32) && (v32 < 0xd) :: (v32 - -v4), v20, v5, v33).cf72| - v4;
				case DC16(cf25) =>
					...
					v40 := if (v9.f2 !in v8) then v41[v4] else v40 * v40;
					var v42: map<bool, bool> := map[true := false];
					var v43 := DC25(if (true in v42) then v42[true] else v9.f3, 0x148, fm33(seq(-0x2a4, i4  => (DC8(DC8(DC8(DC7(v4, v4, v4)))))), globalState));
				...
				case DC18(cf26) =>
					...
					var v49: map<map<int, int>, char> := map[map v47 : int | v47 in v48[v4 := v4] :: (v47 * v4) := (v4) := fm8([v4, |v8|], true, v9.f2, v9.f3, globalState)];
					var v51: map<int, char> := map[v4 := v12];
					var v52: array<map<map<int, int>, char>> := new map<map<int, int>, char>[16] [map[v46 := v12], v49, v49, v49, v49, v49, v49, v49[v46 := v12], v49 + v49, map[v46 := 'o'], map[v46 := v12], if (true) then map[v46 := 'e'] else map[map v50 : int | v50 in v51 :: (v50 % v4) := (v4) := v12], v49, v49, v49, v49[map[v4 := v4] := v12]];
					v52[890] := v49;
					var v53: seq<bool> := [!f5];
					v52[890] := if (v53[v4]) then v49 else v49[map[|(seq(0x22f, i5  => (v4)))| := v4] := v12];
					var v54: array<seq<int>> := new seq<int>[8] [v5, [v4, v4, |v3|], (seq(0x4, i6  => (v4))) + v5, v5, [v4] + v5, v5, (seq(0x329, i7  => (v4))) + v5, v5[v4 := v4]];
					v54[392] := v5 + (seq(0x1b9, i8  => (v4)));
					v54[392] := v5;
					var v55: multiset<array<int>> := multiset{p1, p1, p1};
					var v57 := DC4(set v56 : int | (0x3a <= v56) && (v56 < -0x17b) :: (v56 % v4));
					var v58: map<string, D2> := map[v3 := v57];
					v9.f3, v5, v12, globalState.f0, v55 := if (false) then v58 == v58 else p3, (v54[392] + (fm29(fm26(-700, globalState), globalState) + fm29(p3, globalState)))[|(v3 + "pswmpecn")| := if (f4) then v4 else fm17(v4, true, true, globalState)], v12, v4 + |v54[392]|, multiset{p1, p1, p1};
					v9.f2 := (-0x366 - -v4) >= fm0(v9.f2, v4, v4, globalState);
			}
			
		} else {
			f3 := v9.f2;
			f3 := fm56(v9.f2, |((seq(151, i9  => ('w'))) + "wxnlqp")|, globalState);
			v9.f2 := !f5;
...
class C15 extends T0, T2 {
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		if (!(if (f5) then 0x36d > fm2(f7, globalState) else false)) {
			...
			var v4 := "nqup";
			var v5 := 'c';
			var v6: map<bool, int> := map[f3 := |v4[f6 := v5]|];
			var v7: set<int> := {|v6|};
			var v8: array<bool> := new bool[18];
			var v9 := DC5(f15);
			v7 := v7 - (v7 * DC48(v7, v8, seq(273, i0  => (f15)), v9).cf72);
			...
			match (v12) {
				case DC76(cf111, cf112) =>
					...
					var v15: set<bool> := {f2};
					globalState.f0 := (if (f5) then f7 else |v13|) % fm17(|v15|, f2, !f4, globalState);
					v13 := seq(-958, i1  => (DC57(map[-DC74(|cf111|).cf109 := f6], f6, f4).cf87));
				case DC75(cf110) =>
					...
					var v25: C5 := new C5(v24[v20.f24 := f15]);
					var v26: seq<C5> := [v25];
					var v27: C13 := new C13();
					var v28: seq<C13> := [v27, v27, v27];
					globalState.f0, f3, globalState.f0, globalState.f0 := -|(v26 + v26)|, f4, f7 / f14, |v28|;
					var v29: multiset<bool> := multiset{fm21(globalState), f4};
					var v30: seq<int> := [|multiset{f7, |v29[f3 := f14]|}|, v20.f24];
					var v31: map<char, seq<int>> := map[v20.f25 := v30];
					var v32: set<seq<int>> := {v30, fm41(globalState), v30};
					var v33 := new C12(f2, |v31| / f6, |v32|, f2, f5, f5, f2);
			}
			...
			if (f3) {
				...
				v34[521] := !f4;
				v34[521] := !!f4;
				var v35 := new C10(fm2(|(seq(0xc3, i2  => ('s')))|, globalState) % f15);
				v34[521] := false;
				f15 := f14;
				...
				var v39: array<int> := new int[14](i3 => i3 % f7);
				v39[231] := f6;
				v39[231] := if (f3) then f14 else f6;
				v39[231] := f15 % f7;
				globalState.f0 := f7;
				var v40: array<bool> := new bool[9];
				var v41 := "wonrbrh";
				v40[102] := |v41| > f14;
				var v42: seq<int> := [v39[231], v39[231]];
				v40[102] := f6 >= v42[|v41|];
			...
			if (!f5 <==> f2) {
				...
				var v53: set<int> := {f15};
				f15, v51, f15, f3 := f15, v51[v46 := f14 % -|v52|], |(v53 + v53)|, f3;
			} else {
				...
				var v61 := DC68(f2, v60);
				var v62: array<bool> := new bool[19] [true, v61.cf102, f3, fm21(globalState), fm33(seq(900, i4  => (DC8(DC8(DC5(f15))))), globalState), f2, f4, f3, false, false, fm10(f3, globalState), f3, f5, true, fm10(f4, globalState), fm10(f5, globalState), f2, true, f5];
				var v63 := DC24(v62);
			...
			if (f3) {
				...
				v72 := v72[f15 := !f4];
				var v73 := "ora";
				var v74 := DC41(521, seq(0x3da, i9  => ('r')), f3);
				var v75: array<string> := new string[13] [fm12(globalState), seq(-0xea, i5  => ('g')), v73, v73, v73, v73 + v73, v73, (seq(0x7a, i6  => ('i'))) + (seq(-714, i7  => ('y'))), seq(0x3a9, i8  => ('l')), v73 + "hi", v74.cf62 + v73, v73, seq(930, i10  => ('g'))];
				v75 := v75;
				v72 := v72;
				...
				var v84: array<int> := new int[27] [f15, f15, f14, f6, |v77|, |v80|, |v73|, f15, |(seq(0x2af, i11  => ('v')))|, -f7, f7, f15, |multiset([f5])|, |v81|, f15, f6, f7, |v82|, f15, f14, |v83|, v79.f19, |v82|, v79.f19, f7, f6, f15];
				var v85: map<int, string> := map[f7 := "ugjqbiol"];
				var v86 := DC26(|v77|, v84, f4, fm9(v79.f19, v85, |v77|, globalState), f6);
				v76[209] := if (v86.cf41) then f2 else (fm93(f6, globalState)).cf82 !in v77;
				f15 := f7 * f14;
			} else {
				var v87 := "fuptcbryq";
				...
				v91[442] := 0x1a1;
				v91[442] := -f6;
				var v92: multiset<int> := multiset{|(seq(710, i12  => (f6)))|};
				var v93: map<bool, string> := map[v92 !! v92 := seq(0x285, i13  => ('a'))];
				var v94: map<int, bool> := map[|multiset{v91[442], f7, |(seq(0x3a6, i14  => ('r')))|, f14}| := f5];
				v93 := v93[if (f15 in v94) then v94[f15] else f5 := "ckhgljym"];
				globalState.f0 := v91[442];
			}
			...
			v95[498], v98, v100 := v96, v98 + (map[v97 := v97] + v98), v100;
		}
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		for i0 := f6 to f15 {
			if (if (f3) then f5 else f3) {
				...
				globalState.f0, v0[339] := f15, !((multiset{|"s"|} + v1) !! (multiset{f6} * v1));
				p1.f3 := p1.f2;
				...
				v14[991], v15[571], p1.f2, p1.f2, v20 := v13, v16, !p1.f2, !(-f6 >= f6), DC23(p1.f2, v18, 0x1a3 != f15);
				f15 := f15 + f14;
				var v21 := 'f';
				var v22 := "xwlgmrj";
			...
			var v29: map<int, seq<int>> := map[--|(seq(162, i2  => (v27)))| := fm41(globalState)];
		...
		if (f2) {
			...
			v35 := v35;
			var v36: array<int> := new int[17](i3 => i3 % f6);
			var v37 := DC46(p1.f2, f7, f4, |v34|);
			var v38: map<int, int> := map[f14 := f6];
			var v39: seq<map<int, int>> := [v38];
			var v40: map<int, int> := map[-997 := |v39[f15]|];
			var v41: map<bool, map<int, int>> := map[p1.f3 := v40];
			var v42: seq<int> := [f7];
			var v43 := 'l';
			var v44: map<char, bool> := map[v43 := f4];
			var v45: set<int> := {f7, f6};
			var v46: array<bool> := new bool[24](i4 => p0[f15]);
			var v47 := DC5(f7);
			var v48 := DC48(v45, v46, v42, v47);
			var v49: seq<set<int>> := [v48.cf72, {f6, f14}];
			var v50 := DC82(v49);
			var v51: map<bool, int> := map[f4 := f14];
			v36 := new int[25] [f6, f6, f7, f15, v37.cf68, |(if (f4 in v41) then v41[f4] else v40)|, v42[595], 0xca, -f7, f6, |v44| % f6, |v42|, f14, f15, v42[|v50.cf126|], f7, |v51|, f15, f14, f6, -0x84, f6, f7, f7, fm2(|v51|, globalState)];
		} else {
			...
			v53[354] := !f4;
			var v54 := "vswpum";
			v53[354] := f15 == fm17(|v54|, false, p1.f3, globalState);
			var v55 := DC10();
			var v56: set<int> := {0x3c3};
			var v57: seq<bool> := [{f6} >= v56, p1.f2];
			v55, v57, globalState.f0, globalState.f0 := v55, v57 + p0, f6, |(v54 + v54)| / -0x25c;
			if (p1.f3) {
				var v58 := 'x';
				...
				var v67: array<string> := new seq<char>[7](i5 => seq(0x21e, i6  => (v58)));
				var v68: multiset<array<string>> := multiset{v67};
				v53[354] := v57[if (v67 in v68) then v68[v67] else f6];
			} else {
				p2[886] := f14;
				p2[886] := f7;
				...
				var v71 := 't';
				var v72 := DC63(DC62(v71, p1.f3, p2[886], [v53[354]]));
				var v73: seq<D26> := [v72];
				var v74: seq<int> := [f6, -f7];
				var v75: map<bool, bool> := map[f3 := p1.f2];
				var v76: map<int, int> := map[--0x29c := 324];
				var v77: array<int> := new int[26] [p2[886], f15, 0x3d5, f6, |v73|, f6, |"ix"|, |v54|, f15, f7, v74[0x0], f14, |v75|, f7, f15, -p2[886], f14, f15, p2[886], |v69|, p2[886], f6, |v76|, f15, p2[886], f7];
				p1.f2 := (if (f3) then v70 else map[|v57| := fm56(v57[f7], |map[-|"jp"| := v77]|, globalState)]) != v70;
				v53[354] := f5;
				v69 := v69;
				v71 := v54[f7];
			}
		...
		if (f7 > |v83|) {
			...
			v87[395] := if (p1.f3) then v88.cf4 else v89;
			v87[395] := v88.cf4;
			globalState.f0 := f15;
			var v90: seq<D3> := [v85];
			...
			if (f6 in (v95 * v95)) {
				...
				var v102: seq<int> := [f7];
				var v103: array<bool> := new bool[18] [p1.f2, p1.f3, fm10(f2, globalState), fm33(v96, globalState), f2, if (v99 in v100) then v100[v99] else !p1.f3, p1.f3, p1.f2, (set v101 : int | (442 <= v101) && (v101 < 0x259) :: (v101 / f14)) < v95, f5, f5, f5, f3, f7 in v102, p1.f3, fm2(|p0|, globalState) != |v102|, p1.f3 <==> p1.f2, fm40(globalState)];
				v97[491] := !!p1.f3;
				v97[824] := p1.f3 || f5;
				var v104: array<int> := new int[19];
				v97[491], v97[824], globalState.f0, v104 := fm10(f5, globalState), if (!p1.f3) then f3 else f14 == f15, f7 - -113, v104;
				...
				v108 := v108;
				v97[491], v97[491], globalState.f0 := -(-f6 + f6) > f14, v97[491], f14;
			} else {
				...
				v109, f3, p2[794] := (map[f15 := p2] + v109) + (map[f6 := p2] + v109), f5, if (f6 in v113) then v113[f6] else -|p0|;
				globalState.f0 := f15;
				globalState.f0 := f7;
				var v114: array<D30> := new D30[23](i8 => DC72(|v83|));
				var v115 := DC72(|p0|);
				v114[473] := v115.(cf107 := |{f2, p1.f3}|);
				v114[473] := v115;
			...
			decreases 100 - i9
		{
			...
			p1.f2, v118, p1.f3 := f2, v122[f6], p1.f2;
			var v123 := DC17();
			var v124 := DC18(v123);
			var v125 := DC18(v124);
			v125 := v125;
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (f5) {
			...
			p1[391] := if (p2 in v7) then v7[p2] else f7;
			var v8: array<multiset<int>> := new multiset<int>[28];
			var v9: seq<bool> := [p2];
			var v10: T2 := new C3(v8, 453, |v1|, f5, fm56(f5, |v9|, globalState), !f3, v9[-f6]);
			var v11: map<int, bool> := map[v10.f6 := v10.f2];
			var v12: map<T2, int> := map[v10 := |v11|];
			p1[391], r0 := -fm2(f15, globalState) + f14, -((0x1ec * f14) % |v12|);
			v5 := v5;
		} else {
			var v13 := 'w';
			var v14 := "vils";
			...
			p1[950] := 292;
			r1, p1[950], globalState.f0 := !!f3, -f14, -f14;
			var v16 := new C10(fm0(f4, p1[950], f6, globalState));
			var v17: multiset<char> := multiset{v13, v13};
			v17 := v17;
			if (!!f2) {
				var v18: map<bool, int> := map[f5 := p1[950]];
				p1[950] := if (v18 == v18) then -v16.f17 else f6 - p1[950];
				r1 := f5;
				...
				v19 := v19[fm0(v20[f6], |v22|, f6, globalState) % |v23| := v15 + (map v24 : char | v24 in map[if (|v20| in v25) then v25[|v20|] else v13 := f4] :: (v24) := (f15))];
				var v26: map<bool, bool> := map[p3 := (if (f4 in v23) then v23[f4] else f14) < -f7];
				var v27: array<string> := new string[13];
				v27[348] := v14;
				v26, v14, v27[348] := v26 + v26[f4 := f4], v14 + v14, v14 + fm15(v20[p1[950]], f15, f3, v13, globalState);
				f3 := f15 < f15;
			} else {
		...
		if (f2) {
			...
			v37[373] := v32 !! {f3, p3};
			v37[205] := f5;
			var v38: seq<int> := [0x24e, p1[535], p1[535], |(seq(0x2ca, i2  => (f6)))|, p1[535]];
			var v39: multiset<bool> := multiset{fm10(f4, globalState), f3};
			v37[373], r1, v37[205] := DC1(v35, p3, v38[p1[535]]).cf1, f4, (v39 + v39) == v39;
		} else {
			if (true) {
				p1[773] := 0x3b9;
				p1[773] := f6;
				...
				var v44 := DC31(v43);
				var v45: array<array<int>> := new array<int>[29] [v40, if (p2) then v40 else v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, v40, if (true) then v40 else v40, v40, v40, v40, v40, v40, v40, v41[--f6], v40, v42.cf40, v41[|v44.cf47|], v40, v40];
				v45[245] := v40;
				var v46 := "aft";
				var v47: seq<string> := [v46, "jhygmtrqx", v46, v46];
				var v48: multiset<array<int>> := multiset{v40};
				var v49 := DC80(f5, 528, f2, p2, {p3});
				v45[245], v47, r0, v48 := v40, ([v46])[f6 := seq(0x379, i3  => ('b'))], v49.cf117, v48 * v48;
				r0 := f6;
				v46 := v46;
				...
				var v56 := 'u';
				var v57 := DC15(f5, fm39(p3, v55, globalState), p1[747], v56);
				var v58: multiset<int> := multiset{v57.cf23};
				p1[747] := fm0(f4, |v54|, |v58| - 0x27d, globalState);
				...
				f2, f3, v59, globalState.f0, f2 := f3, v65.cf32, fm51((multiset{p3, true})[p3 := p1[747]] < v66, v56, |v68| * f6, !p2, globalState), |(v69[f7 := v67] + [v67, v67])[f6 := v67]|, p3;
				f3 := f2;
			}
		...
		for i5 := |v32| to f15 {
			...
			r1 := p2;
			var v79 := DC64(map[v73 := (v73[|"opjblgkqq"| := p3])[f7 := p3]]);
			match (v79) {
				case DC65(cf99, cf100) =>
					var v80: map<int, int> := map[cf99 := |v74|];
					var v81: T2 := new C8(|v74[f6 := 0x1e6]|, f14, p2, true, p2, f2);
					...
					v85[455] := if (v78 in v87) then v87[v78] else false;
					f3 := v32 > v32;
				...
				case DC66() =>
					...
					v76 := v76;
					var v89 := 'b';
					var v90: array<seq<char>> := new string[8] [fm22(globalState), v76, v76, v76, v76, [v76[f15], v89], v76, v76 + v76];
					var v91 := DC35(v76);
					v90[882] := v76 + v91.cf51;
					var v92: map<bool, seq<char>> := map[!f2 := v76];
					v90[882] := if (p2 in v92) then v92[p2] else v76;
					globalState.f0 := i5;
				case DC64(cf98) =>
					f15 := f7 * f14;
					f3 := f5;
...
class C16 {
	...
	method m4(p0: bool, p1: map<bool, multiset<bool>>, p2: array<int>, p3: seq<int>, globalState: GlobalState) returns (r0: array<bool>) {
			...
			decreases 100 - i0
		{
			...
			var v2 := DC2(false);
			var v3: seq<D0> := [v2];
			if ((seq(0x73, i1  => (DC2(p0)))) != v3) {
				var v4 := false;
				var v5: array<bool> := new bool[7](i2 => false);
				v5[9] := v4;
				var v7 := "guvc";
				globalState.f0, globalState.f0, v4, v5[9], v4 := |({-v0} + (set v6 : int | (738 <= v6) && (v6 < 0x135) :: (v6 % 279)))|, v0, true, p0 ==> !false, fm4(v0, v7 + "ll", fm6(v4, v4, v0, globalState), !v4, globalState);
				v7 := v7[v0 := f12];
				v0 := -v0;
				var v8: multiset<int> := multiset{0x17d};
				globalState.f0 := |v8| + v0;
				var v9: map<bool, string> := map[v4 := v7];
				var v10 := new C5(v8[|v9| := v0]);
			} else {
				var v11: seq<bool> := [p0];
				var v12 := DC16(v11);
				...
				var v18: seq<int> := [v0, fm17(v0, p0, !fm56(p0, |v16|, globalState), globalState), |(map v17 : int | (0x338 <= v17) && (v17 < -0x35e) :: (v17 + v0) := (p0))| % -v0, if (v0 in v16) then v16[v0] else v0];
				v18 := v18;
			}
			...
			if (0x89 != 476) {
				...
				v0, globalState.f0, v21 := |(seq(343, i4  => (f12)))| * (|v22| - v0), v0, v21;
			...
			var v35 := "ygm";
			var v37: set<bool> := {p0};
			var v38: array<int> := new int[16] [v0, v0, if (0xc4 in v34) then v34[0xc4] else 0x196, |v35| * |(map v36 : int | (0x129 <= v36) && (v36 < -0x1ea) :: (v36 + v0) := (v0))|, v0, -(p3[v0] - v0), v0, |v35| % v0, v0, v0, v0, v0 - v0, |(v37 + v37)|, v0 * v0, p3[v0], v0];
		...
		if (-(v0 - v0) >= v0) {
			...
			match (v41) {
				case DC36(cf52, cf53, cf54, cf55, cf56) =>
					...
					v40 := ((if (!!false in v42) then v42[!!false] else cf52) % |v43|) <= v44.cf7;
					cf56 := v0;
					var v45: C0 := new C0();
			...
			var v59: array<array<int>> := new array<int>[18] [p2, p2, p2, p2, v58[v0], p2, p2, p2, p2, p2, p2, p2, p2, p2, p2, p2, p2, p2];
			...
			var v63: map<bool, int> := map[p0 := |(seq(0x1b5, i5  => (v0)))|];
			v63 := v63[p0 <==> true := v0];
			...
			var v67: map<bool, multiset<set<int>>> := map[p0 := multiset(v66 + (seq(414, i6  => ({v0, v0}))))];
			var v68 := "gm";
			...
			p2[229] := fm17(|v79|, p0, p0, globalState);
			p2[229] := -939;
		}
		...
		match (v81) {
			case DC25(cf36, cf37, cf38) =>
				...
				var v83: set<bool> := {v82[v0], fm21(globalState)};
				var v84: map<int, int> := map[v0 := -|v83|];
				v84 := v84[v0 := fm17(|(seq(-0x3c9, i8  => (f12)))|, cf36, p0, globalState) + v0];
				var v85: map<bool, bool> := map[cf38 := fm56(cf38, cf37, globalState)];
				v85 := v85;
				var v86 := "qsxnykiy";
				globalState.f0, v86 := --cf37, (if (!p0) then v86 else v86)[|"forft"| := f12];
				var v87: seq<string> := [v86];
				cf36 := v86[cf37 := f12] in v87;
			case DC26(cf39, cf40, cf41, cf42, cf43) =>
				if (fm5(globalState)) {
					var v88 := "pd";
					var v89: seq<string> := [v88[fm17(|{cf42, !cf41, p0, cf42}|, false, !cf42, globalState) := f12], v88];
					cf39 := -cf43 - |v89[cf43]|;
					var v90 := DC35(v88);
					var v91: array<string> := new string[24] [v88, v88, v88, v88, v88, v90.cf51, v88 + v88, v88, v88, v88, v88, "byognadg", v88, if (cf41) then v88 else v88, v88 + v88, v88 + v88, v88, v88, v88, v88, seq(0x220, i9  => (f12)), "k", v88, "dmbkxw"];
					v91 := new string[20];
					var v92: set<bool> := {!true};
					var v93: multiset<string> := multiset{"twudnnyc", v88};
					var v94: map<int, bool> := map[-cf39 % |v92| := !(v93 >= multiset{v88})];
					...
					cf42 := cf39 in (set v104 : int | (0x1bf <= v104) && (v104 < 786) :: (v104 / v0));
					cf42 := cf42;
				}
				...
				if (fm40(globalState)) {
					...
					var v116: T1 := new C4(v0, v106.f24, p0, cf41, v80[845], cf42);
					v115[249] := v116;
					var v117: seq<T1> := [v116];
					globalState.f0, v115[249] := cf39, v117[v106.f24];
				} else {
					cf42 := !!p0;
					v80[845] := cf42;
					v80[845] := if (cf42) then cf41 else v106.f24 in p3;
					var v118 := DC69(v0);
					var v119 := DC36((v118.(cf104 := cf39)).cf104, cf42, |p3|, v80[845], v0);
					v119 := DC36(if (cf42) then fm17(-cf39, !false, p0, globalState) else v106.f24, cf39 < v0, v106.f24, !true, cf39);
					var v120 := "vtqdapu";
					globalState.f0 := |((seq(179, i10  => (v106.f25))) + v120)|;
				}
			...
			case DC24(cf35) =>
				...
				if ((if (p0) then |multiset{p2}| else v0) >= |v123|) {
					...
					var v133: seq<seq<int>> := [p3, v132[v0]];
					var v134 := DC36(971, p0, v0, v131, v0);
					v130, v131, v80[448], globalState.f0 := v130, true, if (v132 < fm96(|v121|, -v0, v131, globalState)) then !p0 else v134.cf53, (v0 % 0x69) / |v121|;
					var v135: seq<string> := [v121];
					var v136: seq<string> := [v135[|p3|], v121, fm15(true, v0, v131, f12, globalState)];
					var v137: multiset<bool> := multiset{v80[448], p0, p0, true};
					var v138: seq<multiset<bool>> := [v137, multiset{v131, v131}];
					v131, v80[448], v121, v131 := !false, fm56(v131, |p3|, globalState) && v131, v136[v0], multiset{p0} in v138;
				} else {
					...
					cf35[231], v144[905], cf35[84], v146, v146 := v146, map[v0 := v0], v146, fm33(v150 + v150, globalState), p0;
					globalState.f0 := (|p3| % v0) % v0;
					globalState.f0 := v0;
					var v151: set<bool> := {p0, v146};
					var v152: C15 := new C15(v0, |v151|, cf35[231], true, -v0, v0, v146, v146);
				...
				if ((if (p0) then p0 else p0) || !p0) {
					...
					globalState.f0 := if (v154) then fm17(v0, p0, p0, globalState) / v0 else |v157[|v158| := v159]| % p3[v0];
					v80[183] := v154;
					v80[183] := p0;
					var v160: array<map<int, set<int>>> := new map<int, set<int>>[23];
					v160[484] := map[|v158| := v123];
					var v161 := DC74(v0);
					var v162: map<int, set<int>> := map[v0 := v123];
					globalState.f0, r0, v160[484] := v161.cf109, cf35, v162 + map[|map[|map[v80[183] := f12]| := v80[183]]| := v123];
				} else {
					cf35[580] := !p0;
					...
					cf35[580], v164, globalState.f0, v165, v166 := p0, v164, v0, p0 || p0, v166;
					v0 := v0;
					var v167: map<bool, int> := map[cf35[580] := v0 + v0];
					v167 := v167;
					var v168: seq<bool> := [v165, cf35[580]];
					p2[472] := |v168|;
					p2[472] := v0;
					v121 := (v121 + v121)[|v121| := f12];
				}
			...
			case DC27(cf44) =>
				...
				var v179 := DC81(v171[v0] in v171, v174, v177, v80, v178);
				match (v179) {
					case DC80(cf116, cf117, cf118, cf119, cf120) =>
						...
						v80[936], v80[392], cf116, cf117 := cf119, v174 && v174, v186 >= ((set v187 : char | v187 in v171[cf117 := f12] :: (v187)) - v186), v0 + cf117;
					...
					case DC79(cf115) =>
						...
						v80[219] := p0;
						v80[219] := v174;
						var v189: map<int, bool> := map[v0 := v80[219]];
						v80[219], v80[219], v189, v170 := p0, if (v174) then 0x317 > v0 else v174, v189[-0x2df := fm10(!v174, globalState)], v170;
						var v190: seq<seq<bool>> := [[v174], v177];
						var v191: set<bool> := {v174};
						var v192: map<int, set<bool>> := map[|v190[|cf115.f18|]| := v191];
						var v193: seq<int> := [v0, |(v192 + v192)|, 0x2e0];
						var v194: multiset<int> := multiset{|fm59(globalState)|};
						v193 := v193[v0 := |v194| + v0];
				}
				
				var v195: array<map<bool, int>> := new map<bool, int>[22];
				var v196: map<array<map<bool, int>>, bool> := map[v195 := p0];
				v196 := v196[v195 := v174];
				p2[207] := fm17(v0, p0, true, globalState);
		...
		for i12 := v0 to |v201| {
			...
			var v215 := DC41(|v211|, if (|v208| in v212) then v212[|v208|] else v213[|v214|], v210);
...
class C17 extends T2 {
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		...
		var v7: C4 := new C4(|v5|, f6, v6[v2.f19], f4, f10, f10);
		var v8: multiset<C4> := multiset{v7, v7};
		v4[635] := multiset([v7, v7]) + v8;
		v4[635] := v8;
		...
		for i0 := f7 to |v16| {
			...
			v32 := v32 + (map v33 : int | v33 in v16 :: (v33 / |[v2.f19]|) := ((multiset{f3, f4, f4})[f4 := f7]));
		}
		r0 := f2;
		var v34 := 'n';
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
		...
		globalState.f0, v2, globalState.f0, v3, globalState.f0 := f7, multiset{f6, if (false) then if (0x302 in v2) then v2[0x302] else -f11 else |v4|, f11 * |v4|, f7}, v0.fm0(f4, f7, f11 % |v5|, globalState), v3, f11;
		...
		match (DC54(!f10, f6).(cf82 := v9.f16)) {
			case DC54(cf82, cf83) =>
				...
				p2[583], cf83, cf83 := f6 * (if (f2 in v5) then v5[f2] else f11), |v7|, fm2(fm17(|v12|, f3, p1.f2, globalState), globalState);
				p1.f3 := (f6 + f7) <= -(-0x285 / f11);
				...
				if ((v13 + v13) != v13) {
					...
					var v23 := DC31(v22);
					var v24: array<int> := new int[13] [f6, p2[583], f11, cf83, cf83, p2[583], 0x37e, 0xe, p2[583], f6, |"pmeyr"|, |v12|, f7];
					var v25: set<bool> := {false, p1.f2};
					var v26 := DC54(v9.f16, -|v25|);
					var v27 := DC26(|v7|, v24, false, v26.cf82, p2[583]);
					var v28: multiset<seq<int>> := multiset{v13};
					var v29: array<D12> := new D12[16] [v20, v20, fm97(v21, v23, f11, globalState), v20, v20.(cf46 := v18), v20, fm97(v4[cf83], v23, v27.cf39, globalState), v20, DC30(v19), v20, v20, v20, v20, v20, DC30(DC28(v28)), fm97(v21, v23, -p2[583], globalState)];
					v29[702] := v20.(cf46 := DC28(v28));
					p1.f3, p1.f3, v29[702], f3 := v26.cf82, f2, v20, p1.f2;
					p2[583] := f6;
					p1.f3 := v9.f16;
			...
			case DC53(cf81) =>
				...
				v39[924] := v38;
				if (p1.f2) {
					p1.f3, globalState.f0 := v9.f16, (if (p1.f2 in v5) then v5[p1.f2] else f7) % v35.f24;
		...
		if ((f6 in v52) && p1.f3) {
			...
			f2 := f5;
			p1.f3 := v9.f16;
			var v53: set<bool> := {p1.f3, p1.f3, p0[f11], f5, p1.f2};
			...
			var v63: map<int, D27> := map[|map[|map[p1.f2 := f11]| := v9.f16]| := v55.(cf98 := v62[f11])];
			if (|v63[f6 := v55]| != -f6) {
				...
				p1.f3, v67[209], v66.f3, v68, v4 := true, v66, p1.f3, v68, v71.cf51;
			...
			p2[494] := f11;
			var v76 := 's';
			p2[494] := |fm49(v76, !p1.f2, globalState)|;
			var v77 := new C7([p1.f2] + p0);
			if (p1.f3) {
				var v78: seq<int> := [p2[494]];
				var v79: map<bool, int> := map[false := |v78|];
				globalState.f0 := (if (false) then |v79| else f7) * (f7 / p2[494]);
				v8 := v8[p2[494] := v4 + (seq(0x34, i4  => (v76)))];
				var v80: map<string, seq<int>> := map[v4 := v78];
				var v81: set<int> := {|v52|};
				var v82: C2 := new C2(map[v4 := seq(-0x36b, i5  => (|p0|))] + v80, p1.f3, f7, f6, true, !(f11 >= |v4|), -|v81| < -0xcb, f4);
				v82 := v82;
				var v83: seq<string> := [v4];
				var v84 := new C14(v83[f7] <= v4, f5, true, v9.f16);
				globalState.f0 := f11;
			} else {
				globalState.f0 := f6;
				v3[489] := true;
				...
				v86[562] := fm91(v9.f16, f5, globalState);
				var v87 := DC35(v4);
				v86[562] := v87;
				globalState.f0 := f6 + --p2[494];
				var v88: set<bool> := {|v6[f11 := |[p2[494]]|]| <= f6, v9.f16};
				v88 := {f2};
			}
		...
		for i7 := f6 to f11 {
			...
			var v96: seq<set<int>> := [(set v89 : int | (329 <= v89) && (v89 < -0x206) :: (v89 % f11)) * {|v92|, f7}, v95, v95];
			var v97: C0 := new C0();
			var v98 := 's';
			var v100: map<char, map<int, int>> := map[v98 := v6 + (map v99 : int | (747 <= v99) && (v99 < 11) :: (v99 / f6) := (-f6))];
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v3 := 'f';
		r0, r1, r0, f3, p1[968] := |v0[if (false) then |v1| else |v2| := v3]|, f10, -f7, f2, f11;
		var v4: array<bool> := new bool[17];
		v4[790] := f5;
		v4[790] := ([f4] + [f10]) != [f3, p2, f2, f10, true];
		var i0 := 0;
		while (if (v4[790]) then f2 else if (!f3) then false else v4[790])
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			var v7 := DC90(v6);
			var v8: array<map<C7, int>> := new map<C7, int>[14] [v6, map[v5 := |v5.f18|] + v6, v6, v6, map[v5 := |v5.f18|], v6, map[v5 := f11], v6 + v6, v6 + v7.cf138, v6 + v6, v6, map[v5 := f6], (map[v5 := f7])[v5 := p1[968]], v6];
			v8 := v8;
			p1[968] := f11;
			f2 := f4;
			f2 := p3;
		...
		if (v4[790]) {
			...
			var v11: multiset<int> := multiset{v9[-f7] % f11, |v10|};
			v11 := v11;
			f2 := p2;
			var v12: seq<map<int, int>> := [map[f11 := |(seq(291, i1  => (v0)))|], v2, v2];
			var v14: array<seq<map<int, int>>> := new seq<map<int, int>>[3] [v12, v12 + v12, seq(0x356, i2  => (map v13 : int | (0x340 <= v13) && (v13 < 0x1ae) :: (v13 % v9[f6]) := (|v1|)))];
			v14[352] := v12 + v12;
			v3, r0, v14[352] := v3, -p1[968], [v2 + v2, map[f6 := v9[0x21]], v2, v2];
			v4[790] := f5;
			...
			p1[968], v18 := (p1[968] % p1[968]) % (f7 / f6), v18;
			f3 := f3;
			p1[968] := f7;
			var v19: multiset<bool> := multiset{p3};
			globalState.f0 := |v19| % f6;
			...
			v23[622] := 'p';
			var v24: multiset<int> := multiset{p1[968], f11};
			var v25: seq<map<int, int>> := [map[-|v24| := 162]];
			v21, v22, p1[968], v23[622] := v21, v22, |(v25 + (v25 + (seq(0x1bd, i3  => (v2)))))|, v3;
		}
		
		var v26: multiset<bool> := multiset{f4};
		var v27: map<bool, bool> := map[!f10 := f2];
		var v28: multiset<int> := multiset{|v0|, f7, 0x28c, p1[968]};
		var v29 := DC3(v26);
		var v30: seq<multiset<bool>> := [v26, v26];
		var v32: seq<int> := [f11];
		var v33: array<multiset<bool>> := new multiset<bool>[29] [multiset(v1), v26, v26, v26, multiset{v4[790], f5, true}, multiset(v1), multiset{if (v1[f6] in v27) then v27[v1[f6]] else v4[790]}, v26[false := p1[968]], multiset(v1), v26, multiset{f2, true}, v26, multiset{f5, f3}, (multiset{p3, f10})[!false := f6], multiset{f4, !p2} * v26, v26 * v26, multiset{p3, f10} * v26, v26 - v26, v26, v26, v26, fm14(globalState), v26[p3 := |v1|], multiset(v1) * v26[f4 := if (873 in v28) then v28[873] else f11], v26 - v29.cf4, v26, v30[|(map v31 : int | v31 in v32 :: (v31 % f6) := (false))|], v26, multiset{p2}];
		v33 := v33;
		...
		var v39: seq<seq<D3>> := [v37[f6], if (f7 in v38) then v38[f7] else seq(0x1a2, i4  => (DC8(v34)))];
		if (!fm33(v39[p1[968]], globalState)) {
			p1[968], globalState.f0 := fm2(if (f10 in v26) then v26[f10] else f6, globalState), -791;
			if (p2) {
				var v40: map<string, seq<int>> := map[v0 := v32];
				var v41: set<bool> := {f3};
				var v42 := DC26(f11, p1, p3, f10, if (-f11 in v2) then v2[-f11] else p1[968]);
				...
				v0, r1 := v0, p3;
				var v46: seq<map<bool, bool>> := [map[true := f2], v27 + v27, v27, map[true := v4[790]]];
				p1[968] := |v46|;
				var v47 := DC2(fm21(globalState));
				var v48 := new C12(v4[790], f6, |v0|, v45.f23, if (f3) then v47.cf3 else f3, p3, p2);
				p1[968] := |v0|;
			} else {
				v4[790] := !(f4 <==> ({0x307, |v1|} !! {p1[968]}));
				var v49: seq<array<bool>> := [v4, v4];
				var v50: map<int, array<bool>> := map[|v1| := v4];
				var v51: array<array<bool>> := new array<bool>[24] [v4, v4, v4, v4, v49[p1[968]], v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, v4, if (|v0| in v50) then v50[|v0|] else v4, v4, v4, v4, v4, v49[f6], v4];
				v51 := v51;
				var v52: set<bool> := {p2};
				p1[968] := fm17(f11, fm64(|"qja"|, p3, p1[968], f11, globalState) < v52, v1[f11] !in v1[f11 := f2], globalState);
				p1[968] := p1[968];
				v4[790] := p3;
			}
			...
			var v53: map<int, bool> := map[f6 % p1[968] := f10];
			v0, v0, f2, p1[968] := "pks", v0, !fm21(globalState), |v53|;
		} else {
			globalState.f0 := p1[968];
			var v54 := DC60(multiset{0x13a, f11, -0x372});
			v54 := v54;
			r1 := p2;
			globalState.f0 := f7;
			p1[968] := DC65(p1[968], f11).cf100;
		}
		
		r0 := fm1(|v32| / |v0|, globalState);
		r1 := f3 ==> p2;
	}
}
...
class C18 extends T2 {
	...
	function fm1(p0: int, globalState: GlobalState): int {
		if (false || f2) then -f7 else |(set v0 : int | (0xe3 <= v0) && (v0 < 0x1cb) :: (v0 / f9))|
	}
	function fm2(p0: int, globalState: GlobalState): int {
		0x1ce
	}
	...
	method m2(globalState: GlobalState) returns (r0: bool, r1: char, r2: bool, r3: string) {
		var v0: array<int> := new int[20](i0 => i0 / f8);
		...
		match (v1) {
			case DC0() =>
				...
				if (f8 > |v3|) {
					...
					var v17 := new C3(v16, |(seq(0xdf, i3  => (v2)))|, f8, v5.f16, f5, f2, f2);
					f9 := f9;
					...
					v18[721] := map[v21[f5 := v20] := map[f7 := f3]];
				...
				var v27: array<seq<bool>> := new seq<bool>[22] [v25 + v25, v25[f6 := f2] + v25, v25, v25, v25, [true, fm35(f5, v26, f2, globalState), v5.f16, f5], v25, v25, v25, v25, v25 + v25, v25, [f3, f3, false] + [true], [v5.f16, f3], fm34(globalState), (v25[f6 := v5.f16])[f9 := false], v25, v25, v25[f6 := f2], v25, v25 + [f2, f5], v25];
				var v28: T1 := new C14(f9 > f8, f4, f5, f2);
				var v29: array<char> := new char[1];
				var v30 := 'k';
				v29[707] := v30;
				f3, v27, v28, globalState.f0, v29[707] := f3 && v28.f5, v27, v28, f6, 'u';
			...
			case DC1(cf0, cf1, cf2) =>
				...
				var v38: seq<bool> := [f4];
				f2, v35[692], f3 := f5, if (fm17(f9, v38[f8], f5, globalState) in v37) then v37[fm17(f9, v38[f8], f5, globalState)] else v36, f8 < f8;
				var v39 := "vsbxct";
				var v40, v41 := v32.m5(v39[0x3d4 := v36], globalState);
			case DC2(cf3) =>
				var v42 := 'm';
				var v43 := "mooyi";
				...
				match (v46) {
					...
					case DC14(cf20) =>
						...
						var v52: multiset<bool> := multiset{if (f4) then !true else f5, v51[f9]};
						v0[404] := if (f2 in v52) then v52[f2] else f8;
						var v53: seq<D11> := [DC24(v44)];
						v53 := v53;
						f2 := !(if (false) then f3 else f2);
						v44[832] := fm21(globalState);
						v44[832] := f5;
				}
		...
		for i5 := f7 to f7 {
			if (f4) {
				...
				var v65: array<C11> := new C11[28] [v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, v63, if (v56[713] in v64) then v64[v56[713]] else v63, v63, v63, v63, v63, v63, v63, v63, v63, v63];
				var v66 := 'q';
				...
				f2 := (|v69| - |multiset(v70)|) <= (163 / f7);
				globalState.f0 := if (f3) then i5 / f6 else f8;
				var v71 := 'h';
				var v72: map<char, bool> := map[v71 := f3];
				f2 := v72 != v72[v68[f9] := f3];
				var v73: multiset<int> := multiset{f6};
				var v74: map<int, string> := map[|v73| := seq(0x357, i6  => (v71))];
				var v75: seq<string> := [if (f9 in v74) then v74[f9] else "ke"];
				var v76: map<bool, int> := map[fm21(globalState) := |v75[|v68|]|];
				f8 := (f8 * f8) / |v76|;
				var v77: array<map<bool, bool>> := new map<bool, bool>[25];
				v77[398] := map[false := f2];
				var v78: map<bool, bool> := map[fm10(f4, globalState) := f3];
				var v79: seq<bool> := [f5];
				var v80 := DC62(v71, f4, f6, v79);
				v77[398], f8, f2 := v78[f5 := f3] + v78, v80.cf95, f6 <= |v79|;
			}
			...
			var v83: set<int> := {i5 + f7, f8, f9 % f8};
	...
	method m0(p0: seq<bool>, p1: T0, p2: array<int>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			match (fm100(globalState)) {
				case DC61(cf92) =>
					...
					var v10: map<int, array<int>> := map[v9.cf52 := v4[-f6]];
				...
				case DC60(cf91) =>
					...
					v17[802], v33, f3, p1.f2 := f2, v33, v37.cf122, false;
					var v38: set<bool> := {p1.f3, !f5};
					v0 := (v0 + v0) + ((v0[f9 := v21])[|[p1.f2]| := 'j'])[|v38| := v21];
				case DC63(cf97) =>
					var v39 := 'g';
					var v40: array<array<char>> := new array<char>[8];
					var v41: seq<array<array<char>>> := [v40];
					var v42: map<array<array<char>>, int> := map[v41[|v5|] := f6];
			...
			var v56: multiset<bool> := multiset{p0[f9]};
			v54[194] := p0 + v55[|v56|];
			v54[194] := [false, p1.f3, p1.f2] + [p1.f3];
			var v57 := DC82(seq(0x53, i2  => ({0x30c, f9})));
		...
		if (f3) {
			...
			var v73 := new C5(v72);
			var v75: map<map<int, int>, int> := map[map v74 : int | (-0x37 <= v74) && (v74 < 0x209) :: (v74 / |map[-151 := f9]|) := (f8) := |v1[v70.f16 := "stmmopctw"]|];
			...
			var v80 := DC92([map v79 : int | (0x2de <= v79) && (v79 < 754) :: (v79 / f6) := (f9)]);
			p1.f2 := v78[f9 := f6] in v80.cf140;
			f2 := f7 >= -|p0|;
			var v81: set<int> := {f8, -f8};
			var v82: array<int> := new int[7] [f8, 976, f9 % f8, f9, |v81|, |(v0 + v0)|, f6];
			v82, f8, f2 := v82, -0x2ba, f8 != f9;
			var v83: array<bool> := new bool[24] [f2, f3, p1.f3, p1.f3, true, p1.f3, true, true, p1.f2, fm9(v2[f7], map[f8 := v0], f8, globalState), p1.f2, f3, p1.f2, f4, f2, p1.f2, p1.f2, p1.f2, true, true, p1.f2, f5, DC1(v82, p1.f2, f9).cf1, p1.f3];
			var v84: seq<array<bool>> := [v83];
			var v85: T1 := new C12(f5, f6, f6 % f8, fm26(f8, globalState), v84 == [v83, v83, v83], f5, f3);
			v85 := v85;
		}
		...
		if (f3) {
			...
			var v88: map<int, bool> := map[f9 % |v2| := f5];
			v88 := (v88 + v88)[0xbe % f8 := p1.f2];
			...
			v92, p1.f3 := v92.(cf76 := DC48(fm52(f9, globalState), v89, v2, v93)).(cf76 := DC47(v90)), if (p0[if (|v95| in v94) then v94[|v95|] else |[p1.f3, p1.f2, p1.f2]|]) then f6 <= -f6 else |v2| > f9;
			...
			match (v97) {
				case DC80(cf116, cf117, cf118, cf119, cf120) =>
					...
					var v105 := DC95(v102);
					var v106: array<map<int, array<D18>>> := new map<int, array<D18>>[19] [v103[v104.cf117], v102 + v102, v102, v102, v105.cf145, v102, v102, v102, v102, map[f9 := v101], v102, v102, v102, v102[|v96.f18| := v101], v102, v102, v102 + map[|cf120| := v101], v102, v102];
					v106[823] := v102 + v102;
					...
					p2[587], v95, v106[823], v109[252] := cf117, v95, v102 + v102, if (p1.f2) then v110[v87.f11] else v89;
					var v111: seq<seq<bool>> := [p0 + v96.f18, ([if (p1.f3 in v95) then v95[p1.f3] else !p1.f2, cf116, p1.f3, p1.f2])[v87.f11 := cf116], fm34(globalState) + p0];
					p2[587], cf118, v111 := v87.f11, f4, v111;
				...
				case DC81(cf121, cf122, cf123, cf124, cf125) =>
					...
					globalState.f0, v0, globalState.f0, cf122 := f6, seq(153, i5  => ('d')), f7, cf121;
				...
				case DC79(cf115) =>
					...
					var v126: map<set<bool>, C1> := map[v120 := if (p1.f3) then v125[v87.f11] else v124];
	...
	method m1(p0: map<array<char>, int>, p1: array<int>, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (!p2) {
			...
			v7 := (v8[0x95] + v7)[!!f5 := |"msalvdtrd"|];
			var v9: multiset<bool> := multiset{!f2};
			var v10 := 'a';
			var v11: seq<bool> := [fm35(f4, (fm51(p2, v10, f6, f5, globalState))[f7 := |v5[f9 := v10]|], p2, globalState), f2];
			var v12 := DC3(multiset(v11));
			if (v9 !! v12.cf4) {
				var v13: seq<int> := [f6, f7];
				v6.m16(0x2b1, v13 + v13, f7, f5 ==> false, globalState);
				var v14: map<seq<multiset<bool>>, bool> := map[([v9] + [v9, multiset{f5}])[f9 := v9] := f4];
			...
			if (f3) {
				...
				r1, p1[637], f3, v24[635], p1[453] := v28 != v28, (f8 + |v5|) / f6, (multiset{!p3, p2, p3} + multiset(v11)) > (multiset{f3})[!f3 := fm0(true, -953, f7, globalState)], v27, f9;
				var v29: set<int> := {|v11|};
				p1[637], v21, v29, globalState.f0 := p1[637], v21, v29, -f6 - f7;
				var v30 := DC35(v5);
				v5 := v30.cf51 + "aeoqesvg";
			} else {
				f9 := f7;
				var v31: T1 := new C4(|v7| / f6, |v5| - (if (f8 in v19) then v19[f8] else -f9), if (false) then f5 else f3, fm35(f5, v19, f2, globalState), true, p2 || p2);
				v31 := v31;
				...
				var v39: array<array<int>> := new array<int>[23] [p1, v35.cf0, p1, p1, p1, p1, p1, p1, p1, v36[f7], p1, p1, p1, p1, p1, p1, if (|v38| in v37) then v37[|v38|] else p1, p1, p1, p1, p1, p1, p1];
				v39[126] := p1;
				v39[126] := new int[8] [0x3c4, f9 + f7, fm0(v31.f3, v34.f24, v34.f24, globalState), f8, f7, v34.f24, f9, f6];
			}
			...
			var v44: map<map<int, bool>, array<bool>> := map[v42[|(multiset(v43))[p2 := f8]| := f2] := v41];
			var v45: set<int> := {f9};
			var v46: seq<int> := [f9];
			...
			v40[608] := v49;
			if (p3) {
				var v50: array<int> := new int[27](i3 => i3 / f6);
				var v51 := "h";
				var v52: set<bool> := {f5};
				...
				v50, f2, f9, f3, r0 := p1, multiset(fm101(v51, globalState)) !! v54.cf154[v52 := f8], |(if ((if ([p2, f2, f2] in v58) then v58[[p2, f2, f2]] else v55) in v57) then v57[if ([p2, f2, f2] in v58) then v58[[p2, f2, f2]] else v55] else v56 + v56)|, v59 > v59, if (f2 || f5) then |v51| - -|v51| else f9;
				...
				v41[72] := true;
				v62, v41[72], f2 := v62, f3, fm21(globalState);
				var v63 := 'g';
				var v64: multiset<char> := multiset{v63, 'c', v63};
				var v65 := DC50(v64);
				var v66 := DC50(v65.cf77);
				var v67: array<D21> := new D21[12] [v65, v66, DC50(multiset{v63}), if (v41[72]) then v65 else v65, fm102(globalState), fm102(globalState), v65, v66, fm102(globalState), v66, v66, v65];
				v67 := v67;
				var v68: array<array<char>> := new array<char>[4] [v0, v0, v0, DC105(v0).cf158];
				v68[22] := v0;
				var v69 := DC51(f9, !p3);
				f3, v68[22] := !((seq(410, i4  => (v63))) < fm7(f6, f7, v69.cf78, globalState)), v0;
				var v70 := "dcprj";
				var v71: array<D19> := new D19[26](i5 => DC43(map[|multiset{f8}| := 0x270]));
				var v72: seq<string> := ["vwgpeuapu"];
				var v73: map<bool, bool> := map[p3 := p3];
				var v74: array<bool> := new bool[21] [f3, f5, p2, v41[72], p3, p2, !f4, if (f4 in v73) then v73[f4] else f3, f5, f5, p2, true, f3, !v41[72], f5, f2, true, true, f2, true, f2];
				var v75: array<array<int>> := new array<int>[27];
				var v76 := DC81(f4, !v41[72], v43, v74, v75);
				v70, f3, v71 := (v70 + fm49(v63, v41[72], globalState)) + v72[f8], v76.cf122, v71;
				f2 := fm40(globalState);
			}
		...
		f8, globalState.f0 := 0x2d7 * v100.cf19, (f8 % |v102|) / -fm17(fm2(f9, globalState), v94[|v93|], f5, globalState);
		r0 := f7;
		r1 := !f2;
	}
	method m3(p0: bool, p1: set<array<int>>, globalState: GlobalState) returns (r0: int, r1: array<int>, r2: T0) {
		...
		for i1 := f9 to -(f8 * f6) {
			...
			var v3 := "fm";
			var v4: seq<int> := [f8];
			if (!(v3 != (("pv")[f6 := v2])[f6 := fm39(true, v4, globalState)])) {
				...
				globalState.f0 := (f8 - f6) / f7;
				var v14: array<bool> := new bool[5];
				var v15 := DC104(v14, f6);
				var v16: seq<array<bool>> := [v14, v15.cf156];
				var v17: array<array<bool>> := new array<bool>[11] [v14, v14, v14, v16[f6], v14, v14, if (f5) then v14 else v14, v14, v14, v14, v14];
				v17[772] := v14;
				v14[51] := p0;
				...
				v17[772], globalState.f0, v14[51], r1 := DC48(v22, v14, seq(-0xa0, i2  => (f8)), v23).cf73, |v24|, fm21(globalState), v25;
				...
				var v28 := DC107(v26);
				r2.f3, v26, v25[299] := v14[51], if (f6 in v27) then v27[f6] else v28.cf159, f7;
				r2.f3 := true;
			}
		...
		r2 := if ((|v32| % --619) in v38) then v38[|v32| % --619] else v37;
	}
}
...
method Main() {
	...
	v2, v0, v7, v0 := |v5| / v4.f19, (v4.f19 % 0x14) == |v3|, v7, [-0x3c9] != [-v4.f19, v2, |v8|];
	...
	var v18 := DC96(v4.fm0(v0, v4.f19, fm17(v4.f19, v0, v0, globalState), globalState) - |(set v9 : int | (691 <= v9) && (v9 < 815) :: (v9 / v2))|, v17);
	var v19: array<int> := new int[2] [v15[v2], v2];
	v19[135] := v4.f19;
	var v20 := DC54(v0, -v2);
	var v21 := DC104(v10, v4.f19);
	var v22: multiset<array<bool>> := multiset{v21.cf156};
	v0, v18, v19[135] := v0, DC96(v20.cf83, v17), if (v10 in v22) then v22[v10] else |v11|;
		...
		decreases 100 - i0
	{
		...
		if (v17.f3) {
			...
			v19[135] := -fm17(v19[135], !(v17.f3 <== v17.f2), v0, globalState);
			...
			var v29: array<string> := new string[11] [(v3 + v3)[|v27[v17.f3 := v26]| := v7], v3, v3, v3, v3 + v3, v3, v3, v3, v3, v3, (fm86(|(seq(81, i1  => (v26.f25)))|, v17.f3, v28, globalState)).cf62];
			v3, v24, v29, v29, v17.f2 := "bgsyddllg" + v3, v24, v29, v29, v17.f3;
		} else {
			var v30 := new C11(v5 < v5[|v15| := false], true, 0x3d3 >= |fm59(globalState)|, v17.f3);
		...
		v3, v3, v38 := if (v19[135] in v6) then v6[v19[135]] else if (v17.f3) then seq(0x52, i2  => ('k')) else v3, v3 + (seq(0x368, i3  => (v13.f12))), v38;
		var v39 := new C6(v19[135], v17.f2, true, v17.f2, v17.f2);
	}
	...
	if (!v17.f2) {
		...
		match (fm86(v2, v17.f3, v42, globalState)) {
			...
			case DC40(cf60) =>
				...
				v48 := v48[v17.f2 := v19[135]];
				var v49: array<array<int>> := new array<int>[2] [v19, v19];
				var v50 := DC26(v2, v19, v17.f3, true, v19[135]);
				v49[567] := v50.cf40;
				var v51: array<map<bool, int>> := new map<bool, int>[6](i4 => v48 + v48);
				v49[567], v51 := v19, v51;
				v5 := v5 + [v17.f2];
				var v52 := DC1(v49[567], v41.fm19(globalState), v4.f19);
				var v53: set<D0> := {v52};
				v53 := v53;
			case DC42(cf64) =>
				var v54: map<int, seq<int>> := map[v4.f19 := v15];
				var v55: map<int, map<int, seq<int>>> := map[|v16| * v19[135] := v54[-v4.f19 := v15]];
				v55 := v55[|(v3 + v3)| := v54];
				v4.m0(v5 + [v17.f2], v17, v19, globalState);
				var v56 := DC15(v17.f2, v7, v4.f19, v13.f12);
				var v57 := new C8(|v3| / v4.f19, v4.f19, v0, v56.cf21, v17.f3, v17.f3);
				globalState.f0 := (v4.f19 * v4.f19) % v15[v4.f19];
		}
		
		v19[135] := v4.f19;
		var v58: map<array<bool>, char> := map[if (v17.f2) then v10 else v10 := v7];
		globalState.f0, v58, v19[135] := if (v17.f3) then v2 else v19[135], v58, v19[135];
		globalState.f0 := v4.f19;
	} else {
		var v59: map<string, int> := map[v3 + v3 := v19[135]];
		v59 := v59[v3 := v19[135]];
		v5 := v5;
	...
	v10[510] := v3 == v3;
	v65, v2, v10[510] := v65, v4.f19, v17.f2;
