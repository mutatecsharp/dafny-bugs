...
function fm8(globalState: GlobalState): int {
	-(if (false) then -(if (true) then -0x280 else |map[false := true]|) else 0x348 % 0x111)
}
...
function fm14(globalState: GlobalState): multiset<int> {
	(multiset{-|{true}|, 0x14} + multiset{0x29a}) * multiset{0x3d0, |(seq(0xc3, i0  => ('w')))|, |multiset([false, true])|, -0x393, 0x42}
}
function fm17(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<multiset<int>, string> {
	if (DC44(true, seq(0x1ce, i0  => ('b'))).cf62 in {!true}) then (map v0 : multiset<int> | v0 in (seq(0x1a9, i1  => (multiset{730}))) :: (v0) := ("gylpbdqx")) + map[multiset{-387, -0x2d6} := "lkyku"] else map[multiset{0x2fe} := "psfuts"]
}
function fm18(p0: int, p1: int, p2: int, globalState: GlobalState): bool {
	(if (true) then |map[true := true]| else |(seq(953, i0  => ('e')))|) <= |DC44(true, "dk").cf63|
}
function fm19(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): seq<int> {
	[DC60(863, true, false, [|map[|[|{true}|, |(seq(0x194, i0  => ('u')))|]| := false]|]).cf86, |multiset(seq(368, i1  => (|map[|multiset{|(map v0 : int | (0xfe <= v0) && (v0 < 0x5a) :: (v0 + 0x283) := (0x95))|}| := map[!false := -450]]|)))|, |multiset{{-0x227, |(seq(0x1f3, i2  => (|(map v1 : int | v1 in {|(map v2 : int | (0x199 <= v2) && (v2 < 475) :: (v2 + -0x298) := (|(seq(0x168, i3  => ('y')))|))|} :: (v1 + |"hmttox"|) := (false))|)))|}}|] + [|(seq(0x5b, i4  => ('h')))|, |multiset{0xc}|]
}
function fm20(p0: bool, globalState: GlobalState): multiset<string> {
	multiset{"nsgjti", seq(0x170, i0  => ('g')), "boxkrn", "sk"} * multiset{"lrtacxhux", "jqnbx", seq(113, i1  => ('q')), "jdx"}
}
function fm23(p0: int, p1: char, p2: int, globalState: GlobalState): seq<seq<int>> {
	[[0x11], [0x1e0]] + ([[|map[|map[-0x2a6 := 'e']| := map[true := |"fxootepfd"|]]|]] + (seq(-0x137, i0  => ([|[0x1a, 0x5f]|]))))
}
...
function fm25(p0: int, p1: int, globalState: GlobalState): int {
	|(map[0xc6 := 0x210] + (map v0 : int | v0 in [-0x309] :: (v0 % 0x3d4) := (-731)))| + -769
}
...
function fm27(p0: int, p1: char, p2: int, globalState: GlobalState): int {
	(|map[|map[|map[true := false]| := true]| := false]| / 0xa) / |(map[false := 0x1a8] + map[DC83(true).cf132 := 0x228])|
}
function fm28(p0: D4, p1: int, p2: char, p3: int, globalState: GlobalState): seq<string> {
	match if (false) then DC33(DC31({0x33, |[true]|})) else DC33(DC31({-0x30b, |[false]|})) {
		case DC32() => [seq(0x361, i0  => ('m')), "jssfxmpcl", "qdgwhlntb", "uebuddcnv", "fbepvkl"] + [seq(0x22f, i1  => ('s')), "bkrixrc"]
		case DC31(cf48) => ["jeaff"] + [seq(0x348, i2  => ('f')), "jr", "cxoqh", "alotwajny"]
		case DC33(cf49) => ["mdut"]
	}
}
...
function fm35(globalState: GlobalState): set<int> {
	{--0x352 + -176, |map[|(map v0 : char | v0 in ['a', 'n'] :: (v0) := ("nydoscix"))| := 0x3ca]|, |({|[map[|(seq(0x2cf, i0  => ('y')))| := 'q']]|, --0x2b7} - {0x114})|}
}
...
function fm45(globalState: GlobalState): map<int, bool> {
	DC26(map v0 : int | v0 in (map v1 : int | (361 <= v1) && (v1 < 0x47) :: (v1 / |multiset{true, false}|) := (-|map[true := false]|)) :: (v0 / -298) := (false)).cf39
}
function fm46(p0: bool, globalState: GlobalState): seq<seq<bool>> {
	match if (false) then DC53(DC52()) else DC53(DC50(seq(0x1a3, i0  => (DC29(DC27(false, false, false, -0x183, true)))))) {
		case DC51(cf75, cf76, cf77) => [[cf77], [cf76]] + DC92(seq(0x3d, i1  => ([cf76, cf77]))).cf148
...
function fm48(p0: multiset<bool>, p1: bool, p2: int, globalState: GlobalState): seq<map<int, bool>> {
	([map[|map[false := {0x28d}]| := !true], map[0x294 := true]] + (seq(193, i0  => (map v0 : int | v0 in [|"bcbb"|] :: (v0 + 54) := (false))))) + [map[-0x5d := DC5(false).cf8], map[|multiset{-0x67, -347}| := false]]
}
function fm49(globalState: GlobalState): D7 {
	if (|map[false := false]| != 0x1b7) then DC19(!false, false) else DC19(true, !DC2(0x39c, |(set v1 : int | v1 in (set v0 : int | (847 <= v0) && (v0 < 343) :: (v0 + |multiset{|map[true := |(seq(0x1ee, i0  => ('h')))|]|}|)) :: (v1 + -0x3a))|, "dwlvydblv", true).cf5)
}
...
function fm54(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<int, int> {
	map[-0x10a := 0x170] + (map v0 : int | (-0x1d0 <= v0) && (v0 < 680) :: (v0 % |{true, false, false, false, true}|) := (0x3d))
}
...
function fm64(p0: int, p1: int, globalState: GlobalState): map<int, char> {
	match DC33(DC32()) {
		...
		case DC31(cf48) => map[|(map v0 : int | (0x2ea <= v0) && (v0 < 0x327) :: (v0 % 0x1f5) := (0x3b))| := 'o']
		case DC33(cf49) => map[0x202 := 'l']
	}
}
function fm65(p0: bool, p1: bool, globalState: GlobalState): D6 {
	DC15(!(|map[false := |(seq(-0x174, i0  => (--|multiset{true}|)))|]| <= -|[|[false, false]|, 0x188, 372, 0x1ee]|))
}
...
function fm67(p0: bool, globalState: GlobalState): D7 {
	DC16(multiset{DC2(|(seq(3, i0  => ('v')))|, 0x1ae, "hj", true)} + multiset{DC2(-|(seq(0x144, i1  => ('j')))|, |[|map[false := false]|]|, "edkowsg", false)})
}
...
function fm69(globalState: GlobalState): D15 {
	DC41(if (!true) then DC38(true, |(seq(0xca, i0  => ('e')))|, |[0x148, 381, |"uutnpr"|]|) else DC41(DC41(DC38(true, |multiset{|[0x229]|, 351}|, 0xf5))))
}
function fm70(p0: int, globalState: GlobalState): seq<D10> {
	([DC29(DC29(DC27(false, false, false, 0xf9, false)))] + [DC29(DC28(map[false := true]))]) + ((seq(0x2a2, i0  => (DC29(DC28(map[false := true]))))) + [DC29(DC29(DC28(map[true := true]))), DC29(DC26(map[517 := false])), DC29(DC27(false, true, true, -975, false)), DC29(DC29(DC28(map[true := false]))), DC29(DC27(false, false, !true, |multiset{[-718]}|, false))])
}
...
function fm73(globalState: GlobalState): map<seq<char>, bool> {
	map v0 : seq<char> | v0 in multiset([['y', 'k']] + (seq(0x103, i0  => (['i', 't'])))) :: (v0) := ({0x177, 115} > {|(seq(-0x28e, i1  => ('u')))|, -|map[DC40(!false, true) := map[true := |{true, false}|]]|})
}
function fm74(p0: set<bool>, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D10 {
	DC27([true] < [true, false, false], true, !false, 0x196 % -|multiset{|map[|"e"| := false]|, 0x2c4, |map[|[-0x74, |map[true := |"cg"|]|, 0x202, |multiset{true}|]| := false]|}|, multiset{--0x28f} >= multiset{593, 338, 0x1bc, 452})
}
...
function fm78(p0: bool, p1: int, p2: set<bool>, p3: bool, globalState: GlobalState): D22 {
	DC59(false, "venkdua", 0x3b1 % |map[|"doga"| := |map[!false := 103]|]|)
}
...
function fm83(p0: char, p1: bool, globalState: GlobalState): seq<map<bool, bool>> {
	match DC51(|map[false := false]|, true, false) {
		...
		case DC52() => [map[!true := true]] + (seq(0x209, i0  => (map[true := false])))
		case DC50(cf74) => (seq(-0x2e5, i1  => (map[false := false]))) + [map[false := false], map[true := true], map[true := false]]
		case DC53(cf78) => seq(-506, i2  => (map[false := false]))
	}
}
...
method m0(p0: map<bool, bool>, p1: int, p2: bool, globalState: GlobalState) {
	var v0 := "chpsjrs";
	var v1 := DC44(p2, v0);
	var v2: array<string> := new string[10] [v0 + v0, (v0 + v0)[p1 := fm42(p1, p1, globalState)], v0 + "inmioisg", v0, v0, v0, v0, v0, seq(-0x94, i0  => ('h')), v0[p1 := 't'] + v1.cf63];
	v2[763] := v0;
	v2[763] := v0;
	for i1 := p1 to p1 {
	...
	if (p2 <==> (p1 != p1)) {
		...
		var v25: array<array<map<char, bool>>> := new array<map<char, bool>>[9] [if (p2) then v23 else v23, if (false) then v23 else v23, if (p2) then v24[p1] else v23, v23, v23, v23, v23, v23, v23];
		v25[333] := v23;
		var v26 := 'w';
		...
		if (v31.f28) {
			...
			var v44: map<multiset<multiset<T1>>, array<array<bool>>> := map[(multiset{v38})[v38 := fm3(v39[v29[30]], v31.f29, v29[30], globalState)] := v43];
			v44 := v44[multiset{v38, v38} := v43];
			var v45: array<T2> := new T2[16];
			var v46 := DC78(v45);
			v46 := v46;
			var v47: map<int, string> := map[-0xe1 := v0];
			var v48: C6 := new C6(v43, seq(31, i4  => (v0)), v31.f29, v31.f29);
			var v49: seq<C6> := [v48, v48, v48, v48, v48];
			globalState.f27 := !!(v26 !in (if (|v49| in v47) then v47[|v49|] else seq(0x190, i5  => (v26))));
			var v50: multiset<int> := multiset{v29[30]};
			var v51: set<bool> := {v31.f29, v31.f28};
			var v52: seq<int> := [-p1, |v51|];
			var v53 := new C9(v50 != multiset(v52), !false);
			globalState.f24 := fm27(-(v29[30] % v29[30]), v26, v29[30], globalState);
		} else {
			globalState.f1 := p1;
			var v54: map<int, array<int>> := map[v29[30] := v29];
			v54 := v54[|map[v37 := v26]| * v29[30] := v29];
			var v55: seq<T1> := [v27];
			var v56: array<T1> := new T1[18] [v27, v27, v27, v27, v27, v27, v27, if (v31.f28) then v27 else v27, v27, v27, v27, v27, v55[|v0|], v27, v55[p1], v27, v27, v27];
			var v57 := DC68(v27);
			v56[778] := v57.cf105;
			v56[778] := v27;
		...
		var v62: set<int> := {0x5};
		if (!!(v62 >= v62)) {
			var v63: set<string> := {v0, seq(0x3d6, i6  => ('x')), v0 + v2[763]};
			var v64: map<bool, int> := map[false := p1 - v29[30]];
			v63, globalState.f21, v64, globalState.f1 := v63, !v31.f28, v64, v29[30];
			v31.f28 := [|v0|] == [v29[30], v29[30], |[v62]|];
			...
			var v69: C3 := new C3(v31.f29, !p2, v31.f28, v29[30]);
			var v70: map<int, C3> := map[p1 := v69];
			var v71: array<C3> := new C3[17] [v69, v69, if (v29[30] in v70) then v70[v29[30]] else v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69];
			v71[534] := v69;
			v71[534] := v69;
			var v72: C7 := new C7(if (v31.f28) then v31.f28 else v69.f40, v31.f29);
			v72 := v72;
			var v73: seq<bool> := [v31.f29, v31.f29];
			var v74: map<int, bool> := map[p1 := v73[957]];
			var v75 := DC27(v31.f28, v69.f40, v31.f28, 0x1c, true);
			var v76: map<map<int, bool>, D10> := map[v74 := v75.(cf43 := v29[30])];
			v76 := v76[v74 := v75];
			v29[30] := fm27(811, v26, p1, globalState);
		}
	...
	if (p2) {
		...
		globalState.f1 := if (if (p2) then p2 else p2) then |(seq(0x22d, i8  => (map[p1 := p2])))| else fm3(p2, !p2, |(if (p2 in v78) then v78[p2] else map[p2 := p1])|, globalState);
		var v79: array<int> := new int[5];
		v79[519] := p1;
		var v80: map<int, int> := map[p1 := p1];
		var v81: multiset<int> := multiset{|v80|};
		v79[519] := p1 / (if (p1 in v81) then v81[p1] else p1);
	} else {
		var v82 := 'n';
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		match (v1) {
			case DC2(cf2, cf3, cf4, cf5) =>
				...
				v10[979], v13[925] := f29, v14[if (f29) then -0x1d9 else cf3];
				cf2 := cf2;
			case DC1(cf1) =>
				var v15 := new C0();
				globalState.f24 := -p0;
				...
				match (v23) {
					case DC0(cf0) =>
						...
						var v27 := 't';
						var v29: array<set<int>> := new set<int>[8] [v24 + {p0}, if (f28) then set v25 : int | (-0xc <= v25) && (v25 < 0x3ac) :: (v25 * p0) else set v26 : int | (0x36e <= v26) && (v26 < 820) :: (v26 * DC10(false, |multiset{f29, f28}|, p0).cf14), v24 + v24, fm37(-p0, f29, f28, globalState), v24 + (set v28 : int | v28 in [-|multiset{v27}|, p0] :: (v28 % |(seq(0x197, i1  => (0x14b)))|)), v24 - v24, v24, v24];
						v29[666] := v24;
						...
						globalState.f21, globalState.f23, v29[666], v21, v30 := f28 <==> false, v27, {p0, p0 * |(seq(0x33b, i2  => (v27)))|, |v0| + |(if (DC9(v21) in v33) then v33[DC9(v21)] else map[f28 := p0])|}, v21 + v21, (v30 + v30) + v34[p0];
						v18 := cf0;
						globalState.f1 := p0;
						globalState.f1 := |v0| / (p0 + p0);
				}
		...
		if (f29 <==> f29) {
			...
			match (v42) {
				case DC10(cf13, cf14, cf15) =>
					globalState.f1 := -(p0 - (-p0 * -|DC8(seq(0x1a0, i6  => ('p'))).cf11|));
					v0 := ("yxrbrj" + v0) + (v0 + v0);
					cf14 := cf15 % p0;
				...
				case DC9(cf12) =>
					...
					v44 := v44[v45 + v45 := v46[504]];
					var v47: array<bool> := new bool[13];
					v47 := v47;
					var v48 := DC5(f28);
					var v49: map<D2, bool> := map[v48 := f28];
					var v50: map<int, map<D2, bool>> := map[-(p0 / p0) := v49];
				...
				case DC11(cf16) =>
					...
					globalState.f24 := --|(v54[v53 := |v56|])[{f29} := p0 + -p0]|;
					globalState.f1 := p0;
			}
			
			var v57: seq<array<int>> := [v41];
			var v58: array<array<int>> := new array<int>[18] [v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v57[p0]];
			v58 := v58;
			var v59: C0 := new C0();
			v59 := new C0();
			globalState.f1 := p0;
			...
			var v62: map<bool, int> := map[v60 in (if (|v0| in v61) then v61[|v0|] else seq(0x39a, i7  => (v60))) := p0];
			v62 := v62;
		} else {
			globalState.f1 := 0x93 % (p0 + p0);
			f28 := f29;
			if (f28) {
				globalState.f1, globalState.f24, globalState.f1, globalState.f24 := -0x274 / |(v0 + "jf")|, p0, p0, |(v0 + v0)| * p0;
				...
				var v72 := 'g';
				var v73: array<bool> := new bool[11] [f28, !fm38(globalState), f28, v70[p0], f28, v0[v71[p0] := v72] < "g", f29, true, f28, if (f28) then f29 else f29, fm38(globalState)];
				v73 := v73;
				...
				v76 := [v74, multiset(v77), v74[v1 := 0x17c] - v74, v74 * (if (f29 in v78) then v78[f29] else if (p0 in v79) then v79[p0] else v74), v74];
				var v80: map<bool, bool> := map[f29 := f29];
				globalState.f1 := -(p0 / |v80|);
				m0(v80 + v80, -(p0 % -|map[f28 := f29]|), f29, globalState);
			}
			...
			match (v82) {
				...
				case DC12(cf17) =>
					...
					v41[601], globalState.f24, v86[63] := v88.cf14 - p0, p0, v87;
					var v89 := new C0();
					var v90: array<multiset<char>> := new multiset<char>[28];
					var v91 := 'j';
					var v92: multiset<char> := multiset{v91, v91, v91, v91, v0[-v41[601]]};
					v90[288] := v92;
					var v93: map<bool, int> := map[f28 := v41[601]];
					var v94: map<bool, map<bool, int>> := map[false <== false := v93 + v93];
					var v95: set<int> := {p0, v41[601]};
					var v96: set<string> := {"wx"};
					v90[288], v94, v0 := fm41(f29, globalState) * multiset{fm42(fm36(|v95|, v96, globalState), |v86[63]|, globalState)}, v94, v0;
			}
...
class C2 extends T1 {
	...
	function fm53(globalState: GlobalState): bool {
		(multiset{map v0 : int | (0xe2 <= v0) && (v0 < 776) :: (v0 % 0x201) := (false)} - multiset(seq(0x1d4, i0  => (DC26(map v1 : int | v1 in [|multiset{false, false}|, |map[|[0x329]| := 'g']|] :: (v1 * 377) := (false)).cf39)))) !! multiset{map[|multiset{true}| := true]}
	}
	method m13(p0: bool, p1: set<int>, p2: string, p3: bool, globalState: GlobalState) {
		...
		if (v8.cf27) {
			...
			var v15: array<int> := new int[17] [v5, v5, v5, v5, |v9|, v5 / -v5, v5, if (p3) then v5 else v5, v5, v5 / v5, -v5, |v10|, if (p0 in v11) then v11[p0] else v5, |v12|, |(v13 + v13[v5 := p3])|, v5, v14[v5]];
			v15[855] := v5 / |"hfidqb"|;
			v15[855] := |(map v16 : int | (0x3dd <= v16) && (v16 < 565) :: (v16 % -0x2ea) := (v5))|;
			globalState.f1 := v5;
			...
			v18[792] := v19 >= (multiset([v5, -0x8d]))[|v21| := v5];
			v18[792] := v5 > |v19|;
			v5 := v5;
			v5 := v5;
			var v22: map<int, bool> := map[v5 := v18[792]];
...
class C3 extends T1, T0, T2 {
	...
	method m13(p0: bool, p1: set<int>, p2: string, p3: bool, globalState: GlobalState) {
		if (f29) {
			...
			v4 := v4[v3 := -f39];
			var v5 := new C0();
			var v8: array<set<int>> := new set<int>[1](i0 => (set v6 : int | (567 <= v6) && (v6 < 0x126) :: (v6 % f39)) * (set v7 : int | v7 in multiset{f39, f39} :: (v7 / 0x202)));
			v8[711] := p1;
			v8[711] := fm35(globalState);
			...
			if (f28) {
				...
				var v15: seq<string> := [seq(819, i1  => (v12)), v14[f39]];
				var v16: map<string, bool> := map[p2 := f39 > |v15|];
				v16 := v16[p2 := !p0];
				globalState.f1 := f39;
				var v17: seq<bool> := [p0, f28];
				globalState.f1 := fm30(p1, globalState) % -|v17|;
			} else {
			...
			v26 := v26;
			var v27: seq<bool> := [p3];
			var v28: map<int, bool> := map[f39 := v27[-0x2af]];
		...
		var v37: seq<int> := [f39];
		v34, globalState.f23, globalState.f1, globalState.f24 := v34[[v33.fm33("nbpbcjqon", v36, multiset{504}, globalState), p3, f29, false] := v33], fm42(f39, f39, globalState), v37[f39 * f39], 0x1b0;
		...
		match (fm39(p0, globalState)) {
			case DC10(cf13, cf14, cf15) =>
				...
				match (v40) {
					case DC21(cf27) =>
						...
						var v43: multiset<string> := multiset{seq(0x314, i2  => (v35)), p2};
						v42[111] := multiset{"g", p2, p2, p2} * v43;
						var v44: set<bool> := {f28, f40, fm31(globalState), f28};
						var v45: map<int, multiset<string>> := map[|v44| := v43["pxwqrag" := cf15]];
						var v46: array<int> := new int[12];
						var v47 := DC0(v46);
						var v48: multiset<D0> := multiset{v47};
						var v49: map<multiset<D0>, multiset<string>> := map[v48 := v43];
						v42[111] := (if (|p2| in v45) then v45[|p2|] else v43) - (if (multiset{v47, v47} in v49) then v49[multiset{v47, v47}] else v43);
						globalState.f1 := -cf14;
						var v50: seq<bool> := [cf13, p0];
						var v51: map<seq<bool>, int> := map[v50 := f39];
						var v52: map<int, C0> := map[cf14 := v33];
						var v53: map<int, int> := map[v37[|v52|] := cf15];
					...
					case DC22() =>
						...
						var v58: array<bool> := new bool[25] [true, p3, f29, cf13, p3, f40, v57[cf15], p0, p0, fm38(globalState), p0, f29, f40, f29, f28, p0, cf13, f28, f29, p0, cf13, cf13, f29, f28, p0];
						var v59: map<array<bool>, bool> := map[v58 := f40];
						v59 := v59[v58 := !cf13];
						cf13 := v57[cf14 := f28] in (seq(0x3c0, i3  => ([f29, p3, true, p3])));
						...
						v61 := v61[if (f28) then f40 else f40 := multiset(seq(0x2ca, i4  => (f39)))];
					case DC20(cf26) =>
						...
						globalState.f1, globalState.f27, v63[362] := |v65|, f39 > (if (f28) then cf14 else cf15), |v66|;
				...
				v68[438] := f39 * cf14;
				v68[438] := |fm40(globalState)|;
				if (f28) {
					globalState.f21 := cf13;
					globalState.f1 := v68[438];
					...
					var v72 := DC15(f28);
					var v73: seq<D6> := [v72];
					var v74: seq<map<D6, char>> := [map v71 : D6 | v71 in v73[0xc9 := v72] :: (v71) := (v35)];
					var v75: seq<map<D6, char>> := [v74[350]];
					var v76: map<D6, char> := map[v72 := v35];
					var v77: multiset<map<D6, char>> := multiset{v76, v76};
					globalState.f27, v70, v68 := (multiset(v74))[v76 := 0x2c0] < v77, v70 + v70, (DC0(v68).(cf0 := v68)).cf0;
			...
			case DC9(cf12) =>
				...
				var v85: array<array<set<int>>> := new array<set<int>>[19] [v83, v83, v83, v83, v83, v83, v83, v84[f39], v83, v83, v83, v83, v83, v83, v83, v83, v83, v83, v83];
				v85[28] := v83;
				v85[28] := v83;
				globalState.f24 := f39;
				globalState.f24 := f39;
				var v86 := DC15(p2[f39 := v35] == p2);
				match (v86) {
					case DC15(cf20) =>
						globalState.f24 := -f39;
		...
		match (v108) {
			case DC17(cf22) =>
				...
				f28 := (cf22 || f40) ==> v112[0x146];
			case DC18(cf23) =>
				globalState.f1 := |multiset{f39, f39, v37[f39]}|;
				var v113 := "lwnrxndg";
				...
				var v118: array<int> := new int[15] [|v115|, f39, f39, f39, f39, f39, |v113| * 179, (if (f29 in v117) then v117[f29] else f39) / f39, f39, 917, f39, f39, fm30(p1, globalState), f39, fm30(p1, globalState)];
				v118[285] := f39 % 602;
				v113, v118[285], cf23 := p2 + p2, f39, cf23;
			...
			case DC19(cf24, cf25) =>
				...
				if (p0) {
					...
					v125 := v125;
					globalState.f1 := f39 % f39;
					globalState.f22 := f40;
					var v126: array<int> := new int[12];
					var v127: multiset<bool> := multiset{!!!cf24};
					v126[786] := if (true in v127) then v127[true] else f39;
					...
					v126[470] := f39;
					v126[39] := f39 - f39;
					v126[786], v133[62], v126[470], v126[39] := (f39 * |p2|) % -0x362, cf24, f39, |(p2 + p2)|;
					...
					v137 := v137;
					var v138: array<int> := new int[24](i8 => i8 / f39);
					v138[329] := f39;
					v138[329] := f39;
				}
				...
				globalState.f27 := (if (f29 in v148) then v148[f29] else p1) > ((set v149 : int | (-0x275 <= v149) && (v149 < 870) :: (v149 % f39)) + p1);
			case DC16(cf21) =>
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		if (f40) {
			...
			v7[332] := [!!!f40, f28];
			var v8: seq<bool> := [f29];
			v7[332], globalState.f24 := ([f29, true, f28] + [f29, f29, f29]) + v8, fm30({p0}, globalState);
			globalState.f1 := p0;
		} else {
			var v9 := "rgq";
			globalState.f24 := (f39 + f39) % |(v9 + v9)|;
			globalState.f21 := !f40;
			...
			if ((v11 == v11) in v12[f40 := fm30(v13, globalState)]) {
				var v14: seq<array<int>> := [v10];
				var v15: map<array<int>, bool> := map[v14[p0] := f29 && !f28];
				r0 := !(if (v10 in v15) then v15[v10] else f28);
				globalState.f21 := f40;
				var v16: multiset<int> := multiset{p0};
				var v17: array<bool> := new bool[19] [f40, fm30(fm35(globalState), globalState) < f39, f28, true, f28, |v16| == |v12[f29 := f39]|, f28, v9[f39] in v9, f40, fm31(globalState), v0 !in v9, f40, f40, !f29, f40, f40, f40, f29, f28];
				var v18: seq<int> := [p0];
				var v19: seq<bool> := [f28, f40];
				v17 := new bool[27] [f40, f28, f29, v18 == (seq(0x2dc, i1  => (f39))), v19[p0] || f40, v19[f39], f28, f29, v12 !! multiset(v19), f28, f28, p0 >= f39, f40, f39 == f39, f40 <==> false, true, f28, f28, f40, true, true, f28 !in v1, !f29, v1 > v1, v9 <= v9, |v19| <= p0, f40];
				globalState.f24 := f39 / --(|map[!f40 := true]| * p0);
				...
				v2[936] := v0;
				globalState.f27, v2, v22, globalState.f24, v2[936] := (v1 + v1) > v1, v2, v22, p0 - p0, v0;
				...
				globalState.f24 := |v24| / (f39 * fm30(set v27 : int | v27 in v26 :: (v27 * 0x375), globalState));
			}
			...
			v30 := v30.(cf28 := v12[f29 := p0]).(cf28 := v12 - v12);
		}
		...
		var v36: seq<int> := [p0];
		globalState.f27 := |(if (f28) then "tsm" else "nbyelp")| >= (|v36| / p0);
		r0 := f40;
	}
	method m15(p0: bool, globalState: GlobalState) {
		match (DC21(true)) {
			...
			case DC22() =>
				...
				globalState.f22, globalState.f13, globalState.f22, globalState.f24, globalState.f17 := f29, f29, f29, f39, ([f39, |v8|])[f39 := f39] + v9;
				globalState.f1 := f39;
				globalState.f1 := -((f39 + 0x350) % (f39 * 919));
			...
			case DC20(cf26) =>
				...
				var v16: seq<int> := [f39, |(if (f28) then seq(-170, i1  => (-|multiset{!f40, cf26.f28}|)) else v15)|, f39 / f39];
				v10[315], cf26.f28, globalState.f24, globalState.f24, v12 := v11 + v11, v13[if (|v13| in v14) then v14[|v13|] else |v11|], f39 / |v13|, v15[if (!!p0) then f39 else |v15|], multiset{v11};
				globalState.f13 := f29;
				var v17 := 'i';
		...
		var v23: set<int> := {f39};
		var v24 := DC31(v23);
		v22[684] := fm30(v24.cf48, globalState);
		...
		match (v29) {
			case DC17(cf22) =>
				cf22 := f40;
				var v30: seq<int> := [f39, v22[684], v22[684], f39, f39];
				globalState.f17 := if (f29) then v30 else v30;
				var v31: map<int, bool> := map[v22[684] := p0];
				var v33: seq<bool> := [cf22];
				var v34: seq<seq<bool>> := [v33];
				var v37: array<map<int, bool>> := new map<int, bool>[21] [v31, v31, v31 + v31, v31, map[f39 := f28], v31, map[f39 := false], v31, map v32 : int | (0x28e <= v32) && (v32 < 570) :: (v32 / f39) := (false), map[-f39 := f28], v31 + v31, v31, v31, v31[|v34| := f28], v31, map[f39 := f29], v31, v31[f39 := true], map v35 : int | (599 <= v35) && (v35 < 425) :: (v35 % |map[cf22 := v22[684]]|) := (false), (map v36 : int | v36 in (seq(0xca, i3  => (-v22[684]))) :: (v36 / v22[684]) := (f40))[f39 := false] + v31[|v26| := f40], map[|v25[51]| := true] + v31];
				v37[942] := v31;
				v37[942] := v31;
				var v38 := 'i';
			...
			case DC19(cf24, cf25) =>
				match (DC15(cf24)) {
					case DC15(cf20) =>
						var v45: map<bool, int> := map[f29 := v22[684]];
						...
						var v48: seq<int> := [v22[684], v22[684], v22[684], v22[684]];
						globalState.f21 := (if (!f29) then |v46| else v22[684]) in v48;
						var v49 := new C0();
						...
						v51 := v51[v50 + v50 := multiset([|v25[51]|]) < v52];
						globalState.f1 := v22[684] * |(v26 + (seq(-0xc4, i4  => ('u'))))|;
					case DC14(cf19) =>
						...
						var v55: seq<int> := [f39];
						var v56: map<int, int> := map[v22[684] := |v55|];
						...
						var v64 := DC6(v60);
						var v65 := DC6(v63);
						var v67: array<map<int, int>> := new map<int, int>[27] [v56, fm54(cf24, f39, |v57|, f40, globalState), v56 + v56, v56, v56 + v56, v56, v56, v56, map[|{f40, f40, f29, false, f40}| := if (v22[684] in v56) then v56[v22[684]] else v22[684]], fm54(f40, v22[684], v22[684], f29, globalState), v56, (map[f39 := f39])[f39 := f39], map v58 : int | v58 in map[f39 := p0] :: (v58 % v22[684]) := (v22[684]), v56, v56[|"scfyumh"| := -v22[684]], v56 + fm54(fm31(globalState), f39, -f39, cf24, globalState), map[v22[684] := f39] + v56, fm54(f29, |[v65]|, v22[684], false, globalState), map v66 : int | (0x37b <= v66) && (v66 < -20) :: (v66 - v22[684]) := (349), v56 + v56, v56, v56, v56, map[896 := v22[684]], v56, v56, v56];
						v67[731] := fm54(cf25, v22[684], v22[684], !cf25, globalState);
						v67[731] := map[f39 := |map[cf25 := |fm55(cf24, cf24, globalState)|]|] + (v56 + v56);
						globalState.f21 := f29;
				}
		...
		if (f29) {
			...
			if (f29) {
				...
				globalState.f27, globalState.f27, v91, v92 := if (f28) then f29 else f29, v25[51] <= ("gucpxn" + v26), (multiset{v89, v89} + v91) * v91[v89 := v22[684]], v92;
				globalState.f1 := f39;
				var v93: map<bool, bool> := map[f40 := true];
				var v94: map<bool, bool> := map[f40 := if (true in v93) then v93[true] else fm31(globalState)];
				globalState.f1 := 110 / -(fm30(v23, globalState) % |v93|);
				v87 := v22[684];
				...
				v85 := if (408 !in v96[|(map v97 : D8 | v97 in (if (v87 in v100) then v100[v87] else v99) :: (v97) := (649))|]) then v85 else 0x9b;
			} else {
				var v101: map<bool, bool> := map[f29 := v88];
				var v102: set<map<bool, bool>> := {v101};
				var v103: array<D2> := new D2[15] [v83, DC4(v82), v83, v83, v83, DC4(v82), v83, v83, DC4(fm42(f39, v22[684], globalState)), v83, DC4(v82), v83, v83, v83, DC4(v82)];
				v103[814] := if (f29) then v83 else v83;
				f28, v102, v103[814], globalState.f23 := false <== p0, v102, v83, if (p0) then 'w' else if (if (f40 in v101) then v101[f40] else f29) then v82 else v25[51][v85];
				...
				v87, globalState.f22, globalState.f27, globalState.f1, v25[51] := f39, (seq(0x3b, i7  => (v82))) < v26, v88, |v106|, v26;
				v86, globalState.f1, v87, v85, globalState.f13 := v85, 0x233, v87, ---v22[684], f29;
				var v107: seq<bool> := [p0];
				v107 := [v85 in v23];
				var v108 := new C2();
			}
			
			v22[684] := fm30(v23, globalState);
			if (f40) {
				...
				v117[317] := v88;
				v117[317] := f28;
				var v118: seq<string> := [seq(870, i10  => (v82))];
				var v119: multiset<int> := multiset{v85, v87};
				v22[684] := if (f28) then v86 else if (f28) then |v118[if (v85 in v119) then v119[v85] else f39]| else v86;
				var v120: multiset<bool> := multiset{f40};
				v117[317] := v120 >= (v120[p0 := |v25[51]|] - v120);
				v22[684] := v85;
				v22[684] := 766;
			}
	...
	method m16(p0: bool, p1: bool, p2: seq<char>, p3: array<seq<bool>>, globalState: GlobalState) returns (r0: int, r1: char, r2: bool) {
		if (true) {
			...
			globalState.f21 := !(|(if (p0) then v6 else v6)| == (-f39 / |v4|));
			v5 := 'i';
			...
			v10 := v10[f39 < f39 := (if (true in v11) then v11[true] else |(seq(-800, i0  => ('x')))|) - f39];
			...
			var v17: array<bool> := new bool[27] [p0, f39 >= f39, f39 <= 0x6, fm32(v14, v15[f39], f28, globalState) ==> f40, p1, f39 != f39, p0 <== p1, f29, fm32({f28}, f39, f40, globalState), p0, f40, p1, f40, p0, f40, p1, false, f29, v16 < v16, p1, p2 == fm51(f39, f39, globalState), f29, f40, f29, p0, f28, true];
			v17[249] := f29;
			v13[286], v17, v17[249], globalState.f27 := f39, v17, f29, p0;
		}
		
		for i1 := f39 % f39 to f39 {
			var v18: array<bool> := new bool[25];
			v18[175] := f29;
			var v19: multiset<int> := multiset{i1};
			v18[175] := (f39 - f39) !in fm37(|v19|, p0, p1, globalState);
			var v20: seq<bool> := [f29];
			v20 := v20;
			globalState.f27 := v20[0x3dc];
			if (v18[175]) {
				globalState.f24 := -((i1 * 0x32e) / i1);
				...
				r0 := f39;
				var v30: seq<int> := [i1];
				globalState.f24 := v30[i1];
				var v31: map<bool, seq<bool>> := map[p1 := [v18[175], v18[175], v18[175]]];
				...
				v32[70], v19, globalState.f24, v32 := |p2|, multiset{i1, i1, f39, i1}, fm30(if (!fm38(globalState)) then v37 else v37, globalState), v32;
			}
		...
		if (true) {
			if (p0) {
				...
				globalState.f27, globalState.f1, globalState.f1, v39 := v42 != (seq(581, i3  => (DC6(v40)))), f39, 751, v39;
				var v43: array<int> := new int[18];
				var v44 := 'l';
				var v45: set<int> := {f39, f39};
				v43 := new int[7] [f39, f39, |(p2 + p2)|, -|[fm42(f39, |p2|, globalState), v44]|, f39 % 0x7, fm30(v45, globalState), f39 % 0x1a8];
				...
				v48[64], globalState.f1, v49, globalState.f1 := p1, |(if (fm32(v53, f39, false, globalState) in v52) then v52[fm32(v53, f39, false, globalState)] else v51 - v51)|, v49, (|p2| / f39) / -(if (f28 in v56) then v56[f28] else |v58[f39]|);
				var v59 := 'v';
			...
			if (f28) {
				...
				var v70: array<map<int, multiset<int>>> := new map<int, multiset<int>>[7] [map v62 : int | (656 <= v62) && (v62 < 0x1c1) :: (v62 % f39) := (multiset([0x2be, |{f40}|])), DC34(v64).cf50, v64 + v64, v64 + v64, v64, v64, if (v68 in v69) then v69[v68] else map[f39 := v63]];
				v70[462] := v64;
				v70[462] := v64;
				...
				var v81: map<bool, seq<int>> := map[v80.cf5 := seq(0x1fa, i4  => (f39))];
				r2 := !v79[|v81|];
				var v82 := 'o';
			...
			globalState.f27, globalState.f13, globalState.f1 := v86 > (v86 - fm35(globalState)), f28, -(f39 % f39) + f39;
			var v87 := "oexdvydna";
			v87 := p2;
			var v88: array<char> := new char[18];
			var v89: seq<array<char>> := [v88, v88, v88, v88];
			var v90: array<array<char>> := new array<char>[24] [v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v88, v89[f39], v88, v88, v88, v88, v88];
			v90 := v90;
		} else {
			globalState.f1 := -f39;
			r0 := f39;
			...
			var v93: multiset<int> := multiset{f39 + f39, f39, f39, 0x2fe, 0x154 / 0x119};
			globalState.f24 := |v93|;
			if (false) {
				...
				v95[668] := f40;
				v95[668] := f29 ==> f29;
				var v96: seq<int> := [-|(seq(0x1c4, i7  => ('x')))|, f39];
				var v97: map<bool, seq<int>> := map[f39 > |map[f39 := |(seq(0x354, i6  => ('w')))|]| := v96 + v96];
				var v98: multiset<bool> := multiset{f28};
				var v99: array<int> := new int[17] [f39, |(seq(106, i8  => ('v')))|, f39, f39, f39, f39, f39, f39, f39, f39, f39, |v98|, |v92|, -f39, f39, 0xd5, f39];
				...
				var v108: set<multiset<int>> := {v93[fm30({|v106|, fm30(v107, globalState)}, globalState) := |(seq(-0xa4, i11  => (0x17e)))|]};
				...
				var v111: map<array<map<bool, bool>>, int> := map[v109 := f39 * v110[f39]];
				var v112: seq<array<map<bool, bool>>> := [v109];
				v111 := v111[v112[f39] := f39];
				...
				v113[548] := if (v107 in v115) then v115[v107] else f39;
				v113[548] := f39;
				var v116: multiset<bool> := multiset{p0, !p1, p1, p1, f40};
				var v117: array<multiset<bool>> := new multiset<bool>[1] [v116 - v116[f29 := v113[548]]];
				v117[310] := v116;
				v117[310] := (v116 - v116) * v116;
				globalState.f27 := !f40;
			}
		...
		r2 := p1;
		var v118: array<int> := new int[25](i12 => i12 / f39);
		v118[651] := f39;
		v118[651] := 0xdd;
		r0 := f39;
		var v119 := 'x';
		r1 := v119;
		var v120: seq<int> := [v118[651], v118[651], f39, |"ixtb"|, 0x240];
		r2 := DC25(f28, f39, fm30(set v121 : int | v121 in v120 :: (v121 % |[false]|), globalState), p0, -v118[651]).cf37;
	}
	method m17(p0: bool, p1: D5, p2: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: int, r3: bool) {
		...
		globalState.f22, r1, v3, globalState.f1 := !f29, 901, match v5 {
			case DC32() => ((v3 + (seq(0xcc, i2  => (v2))))[|v0| := map[f28 := f29]])[f39 := v2]
			case DC31(cf48) => v3
			...
			decreases 100 - i3
		{
			...
			v0, r2, globalState.f21, v8, globalState.f27 := v0[-0x3d9 := if (|(seq(0x314, i4  => (v10)))| in v11) then v11[|(seq(0x314, i4  => (v10)))|] else v10], (-f39 % f39) - f39, v12 !! v12, v8, !false <==> f29;
			...
			if (p2) {
				...
				var v20 := DC30(v18);
				globalState.f22, v17, v18, globalState.f23 := p0, map v19 : char | v19 in (v0[-f39 := v10] + v0) :: (v19) := (f40), v20.cf47, v10;
				var v21 := new C0();
				var v22: map<int, bool> := map[f39 := !f29];
				var v23: multiset<int> := multiset{--411 * |v22|, -f39 % -0x2b2, f39, 88, fm30(v4, globalState)};
				v23 := v23 - multiset{|v2|, f39};
				var v24: array<array<seq<int>>> := new array<seq<int>>[6];
				var v25: seq<int> := [f39, -834, |(seq(-310, i7  => (v10)))|];
				var v26: array<seq<int>> := new seq<int>[7] [[f39], v25, v25[f39 := f39], v25, v25, v25, v25];
				v24[701] := v26;
				v24[701] := v26;
				...
				v28[994] := v29[f39] * (set v31 : int | v31 in v30 :: (v31 - 537));
				v28[994] := v4;
				v1[557] := -f39;
				v1[557] := f39;
				v1[557] := v1[557];
		...
		r2 := f39 / ((if (p2 in v34) then v34[p2] else f39) - f39);
		r3 := match DC35() {
			case DC35() => p2
	...
	method m18(p0: char, p1: string, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: int) {
		...
		v2[665] := f28 ==> fm38(globalState);
		v2[665] := f29;
		var v3: multiset<int> := multiset{f39};
		var v4: seq<int> := [0xd3];
		v2[665], r0, r2, globalState.f23 := f39 == f39, if (v2[665]) then |v3| % |v4| else f39, fm51(f39, f39, globalState), p0;
		var v5 := DC28(fm59(v2[665], [f40], globalState));
		var v6 := DC29(v5);
		...
		r1 := fm31(globalState);
		r2 := p1;
		var v8: seq<bool> := [v2[665], f28];
		var v9: map<int, bool> := map[0x306 := true];
		var v10 := DC27(v8[f39], f29, f28, |v9|, false);
		r3 := v10.cf43;
	}
}
...
class C4 extends T0, T1 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := p0 to p0 {
			...
			var v13 := "qr";
			var v14: array<int> := new int[23](i1 => i1 % i0);
			var v15: map<string, bool> := map[v13 := f38];
			var v17 := DC10(f29, p0, -p0);
			var v18: map<bool, bool> := map[f28 := f29];
			var v19: array<int> := new int[25] [i0, i0, p0, |(v12 + v12)|, p0 * i0, |v13| + i0, i0, 0x1d8 + |(map[-0x370 := v14])[0x3ba := v14]|, |(v15 + (map v16 : string | v16 in (seq(0x98, i2  => (v13))) :: (v16) := (f28)))|, i0, -i0, |v6|, |fm28(v17.(cf15 := p0), p0, v4, i0, globalState)|, |(multiset(v6) - v11)|, p0 * i0, |("bodqajyph" + v13)|, fm27(p0, v4, i0, globalState), p0, |multiset{i0}|, p0, p0, i0, -444, p0 + |v18|, -0x307];
			v14[647] := i0;
			v10, v14[647], globalState.f27, v11 := v10, i0, false, v11;
	...
	method m13(p0: bool, p1: set<int>, p2: string, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			if (f37) {
				...
				globalState.f22 := fm29(v23, |((map v24 : int | (987 <= v24) && (v24 < 0x262) :: (v24 % v1) := (f29)) + v25)|, globalState);
				...
				var v33: array<int> := new int[10](i3 => i3 + |multiset{map[|map[|map[f37 := v1]| := v1]| := true], map[v1 := v31[579]]}|);
				var v34: map<bool, array<int>> := map[v31[579] := v33];
				var v35 := DC7(v34);
				var v36: map<D3, char> := map[v35 := v2];
				var v37: array<char> := new char[10] [v2, p2[609], fm42(-0xa0, v1, globalState), if (v32[|p2|]) then v2 else v2, v2, v2, v2, v2, if (v35 in v36) then v36[v35] else v2, v2];
				v37[196] := v2;
				v37[196] := v2;
				v31[579] := f28;
			...
			v0, globalState.f1, v0, v39[627] := if (p2 in v42) then v42[p2] else p3, fm27(v1, 'w', v1, globalState), f38, v41;
			if (!f28) {
				v0 := !f37;
				...
				v44, v45[447], globalState.f23, v46, v51 := fm60("neq", v40 < v40, !f37, v1 * |multiset{p1, p1}|, globalState), p2, v2, v46, map[v1 := v50] + v51;
				var v52: set<bool> := {f29};
				globalState.f24, globalState.f26 := v1 / v1, v52;
				...
				v55[703] := fm29(v57, v1, globalState);
				var v58: array<array<bool>> := new array<bool>[12];
				var v59: multiset<bool> := multiset{f28, v0};
				globalState.f1, globalState.f23, v54, v55[703], v58 := fm27(|v59|, v2, v1 + |fm61(v1, v1, f38, v0, globalState)|, globalState), 'b', v54, v0, v58;
				v42 := v42[p2 := p0];
				v55[703] := f37;
			}
			
		}
		globalState.f1 := v1 / (697 * v1);
		...
		if ((v61 !! v61) !in (v62 + v62)) {
			...
			match (DC7(v65[p3 := v64])) {
				...
				case DC7(cf10) =>
					...
					v73, globalState.f22, globalState.f13, globalState.f24, globalState.f1 := p2, (v0 <== p3) ==> v0, v62[if (true) then v1 else v1], |v74| - v1, v1;
					globalState.f1 := -v1;
					var v75 := new C2();
			}
			...
			var v80 := new C2();
			globalState.f13 := !(-v1 > (if (v62[v1]) then v1 else v1));
			globalState.f1 := v1;
			var v81 := DC18(|p2| > v1);
			v81 := DC18(p0);
			v62 := v62 + v62;
	...
	method m14(p0: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			if (!!(p0 ==> f38)) {
				...
				var v17: map<bool, set<int>> := map[f29 := set v16 : int | (-0xef <= v16) && (v16 < 0x161) :: (v16 / v6[627])];
			...
			if (v26.cf8) {
				...
				v34[277] := v35;
				var v36 := 'k';
				var v37: map<int, int> := map[|("i")[|(seq(620, i2  => ('t')))| := v36]| := v21];
		...
		globalState.f27 := v39[|v42|];
		var v43 := "w";
		var v44 := 0x252;
		globalState.f1 := |(v43 + "arnimlkw")| - (v44 % v44);
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			var v48: array<int> := new int[7] [v44, v44, |(v46 + v46)|, |(v43 + ("ucjrhmfa")[-v44 := v40])|, if (f38 in v47) then v47[f38] else -0x6b, v44, v44];
			v48[465] := v44;
			v48[465] := v44 / v44;
			var v49: array<bool> := new bool[13](i4 => f29);
			var v50: seq<array<bool>> := [v49, v49, v49];
			var v51: map<array<bool>, bool> := map[if (f38) then v49 else v50[v44] := -240 != v44];
			var v52: map<int, bool> := map[v44 := f38];
			v51 := v51[if (if (v48[465] in v52) then v52[v48[465]] else p0) then v49 else v49 := p0];
			...
			v53[11], v58, f28, v43, globalState.f1 := v39, v58, if (v44 in v52) then v52[v44] else v54.fm53(globalState), v43, v48[465];
		}
		var v59: set<bool> := {f28, f28, f28};
		globalState.f1 := |v59|;
		var v60: array<seq<char>> := new string[15] [if (f38) then v43 else fm51(v44, v44, globalState), v43, v43, v43 + v43, [v40], v43[v44 := v40], v43, (v43 + v43)[v44 := v40], v43 + fm51(v44, v44, globalState), v43, seq(0x249, i6  => (v40)), [v40] + v43, v43, v43, v43];
...
class C5 extends T0 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		v0, v1, f35, v2 := if (f35 in v3) then v3[f35] else v0, match v4 {
			...
			case DC7(cf10) => [f35] + [false, v1[p0]]
		}, f28, map[|v5| >= p0 := f28];
		var v6: array<char> := new char[5];
		v6 := v6;
		var v7: array<seq<seq<int>>> := new seq<seq<int>>[8](i0 => [[p0, p0], seq(603, i1  => (|[p0, p0, |multiset{p0}|, p0, |map[f28 := f35]|]|))]);
		v7[158] := fm23(if (f28 in v5) then v5[f28] else p0, f36, p0, globalState);
		var v8: seq<int> := [p0];
		...
		if (v12 > v12) {
			v8 := v8;
			var v13: array<bool> := new bool[16] [f35, f29, f29, false, v1[|v1|], f29, f29, f35, f35, f35, f35, f28, f29, f29, f35, f29];
			v13[105] := f35;
			var v14: array<int> := new int[4](i2 => i2 % -p0);
			var v15 := DC0(v14);
			...
			if (f28) {
				...
				var v19 := DC5(f35);
				var v20: set<bool> := {fm26(p0, globalState), v13[105]};
				var v21: seq<set<bool>> := [{v13[105]}, v20];
				...
				v18[806], v24, r0 := v23 * (multiset{v20} + v23), v24, !!(({[f28]} + {v1}) !! v25);
				m0(v2 + v2, v8[0x1a9], f29, globalState);
				v24 := v24;
				globalState.f13 := f35;
			} else {
				var v26 := new C3(p0 < p0, !f29, p0 <= p0, p0);
				globalState.f22 := if (p0 == p0) then v13[105] else if (f28) then true else f28;
				f35 := f28;
			...
			if (true) {
				...
				var v31: array<int> := new int[3] [-p0, |v30[p0]|, p0];
				var v32 := DC2(p0, |v8|, v0, !f35);
				v31[148] := v32.cf3;
				v31[148] := p0;
				globalState.f23 := f36;
				var v33: map<char, int> := map[f36 := v31[148]];
				v33 := v33[f36 := v31[148] / p0];
				var v34: map<int, int> := map[v31[148] := p0];
				globalState.f1 := |(v34 + v34)|;
				var v35: map<int, multiset<int>> := map[v31[148] := multiset{v31[148], v31[148]}];
			...
			match (DC4(f36)) {
				case DC5(cf8) =>
					...
					f28, v39[611], globalState.f17, globalState.f21 := f28, if (f29) then v41 + (map v42 : int | (564 <= v42) && (v42 < 621) :: (v42 / p0) := (|v2|)) else fm54(f35, -p0, p0, cf8, globalState), ((v8 + v8) + v8)[p0 % -p0 := p0], f35;
					globalState.f23 := f36;
					globalState.f1 := p0 % 0x3d3;
					var v43: set<string> := {v0, seq(0x38f, i3  => (f36)), v0, v0};
					v43 := {v0 + v0};
				case DC4(cf7) =>
					var v44: multiset<seq<int>> := multiset{v8 + v8};
					globalState.f24 := if (v8 in v44) then v44[v8] else |v0| % p0;
					...
					var v56 := new C3(f28, f29 ==> f28, v1[p0], v45.fm36(|fm45(globalState)|, set v55 : string | v55 in v54 :: (v55), globalState) - p0);
				case DC6(cf9) =>
					var v57: array<bool> := new bool[7] [f28, f29, false, f29, f35, f35, f29];
					var v58: map<seq<int>, int> := map[seq(-0x1d7, i4  => (0x2c0)) := p0];
		...
		var v63: map<string, char> := map["ajggj" := v0[|v10|]];
		var v65: seq<string> := ["vyscfksv"];
		v2 := v2[v63 != (map v64 : string | v64 in v65 :: (v64) := (f36)) := v1[|v0|]];
	...
	method m12(p0: int, p1: int, globalState: GlobalState) {
		...
		for i1 := p1 to if (f35) then p1 else p0 {
			...
			var v5: multiset<bool> := multiset{fm26(v4[-0x36b], globalState), f28, f35};
			v0[91] := p1;
			v5, v0[91], v1, globalState.f23, globalState.f24 := v5, p0 - i1, v1 + v1, 'k', --fm25(i1, p0, globalState);
			if (f35 && f35) {
				var v6 := "sxo";
				globalState.f1 := |(v6 + (if (f28) then seq(0x9a, i2  => (f36)) else v6))|;
				var v7: set<bool> := {f35, f28, f28, f28, f35};
				globalState.f1 := |v7|;
				globalState.f27 := f35;
				var v8: seq<set<bool>> := [v7, if (f28) then v7 else v7, v7];
				v8 := (seq(-0x308, i3  => (v7))) + v8;
				var v9: array<map<bool, map<bool, int>>> := new map<bool, map<bool, int>>[14](i4 => map[f29 := map[true := v0[91]]] + map[f29 := map[f28 := |{f28}|]]);
				...
				var v24: map<string, bool> := map[fm51(p0, v0[91], globalState) := f28];
				v0[91] := if (!(if (v12 in v24) then v24[v12] else v23.f37)) then v0[91] else p0;
				globalState.f24 := p1;
			}
		...
		var v31: seq<map<bool, bool>> := [v30[p0]];
		...
		for i5 := 0x18d to |(v32 + v32)| {
			...
			m0(map[f35 := f28], p0 / fm25(p1, 0x1e5, globalState), p0 <= |v33|, globalState);
			var v34: map<int, bool> := map[p1 + -i5 := (fm65(f29, f35, globalState)).cf20];
			var v35: array<bool> := new bool[27](i6 => !f35);
			v35[916] := !fm38(globalState);
			v0[406] := i5;
			var v36: array<D2> := new D2[10](i7 => DC4(f36));
			var v37 := DC4(f36);
			v36[763] := v37;
			var v39: seq<bool> := [f28];
			v34, v35[916], globalState.f13, v0[406], v36[763] := map v38 : int | (0x266 <= v38) && (v38 < -847) :: (v38 - p1) := (f35), !f35, v39 != (v39 + v39), p1, v37;
			v0[406], globalState.f1, globalState.f22 := p0, i5, v35[916];
			match (DC28(v29)) {
				case DC27(cf40, cf41, cf42, cf43, cf44) =>
					...
					var v42: array<int> := new int[26](i8 => i8 % |v34|);
					v42 := v42;
					globalState.f22 := f36 in (seq(0x1a1, i9  => ('h')));
				case DC28(cf45) =>
					var v43: C1 := new C1(fm38(globalState), !v35[916]);
					var v44: set<C1> := {v43};
					var v45: seq<set<C1>> := [v44, v44];
					var v46: map<bool, set<C1>> := map[f28 := v44];
					globalState.f22 := (v44 + v44) in v45[i5 := if (v35[916] in v46) then v46[v35[916]] else v44];
					v35[916] := if (true && f29) then f29 else f29;
					var v47: array<D14> := new D14[5];
					var v48 := DC36(v39);
					v47[944] := v48;
					var v49 := "kytrfhqy";
					v47[944] := fm66(f36, p0, |([v49])[-p1 := v49]|, -0x7b, globalState);
					var v50: array<D7> := new D7[22];
					v50[487] := fm67(f35, globalState);
					var v51: map<char, bool> := map[f36 := f35];
					v50[487] := fm67(if (true) then false else if (f36 in v51) then v51[f36] else f29, globalState);
				case DC26(cf39) =>
					var v52: array<D15> := new D15[1](i10 => DC41(DC40(v35[916], f29)));
					var v53: array<array<bool>> := new array<bool>[18];
					var v54: map<array<D15>, array<array<bool>>> := map[v52 := v53];
					v54 := v54[v52 := v53];
					var v55 := "i";
					var v56: seq<string> := [v55];
					var v57: array<seq<string>> := new seq<string>[5] [v56, if (f29) then v56 else v56, [v55] + [v55, v55, "dsuxt", ("vevqhheot")[fm27(i5, f36, i5, globalState) := f36], v55], v56, [v55[i5 := f36]]];
					v57[195] := seq(0x0, i11  => (v55));
					v57[195] := v56;
					var v64: array<map<int, int>> := new map<int, int>[24] [fm54(f28, v0[406], i5, false, globalState), (map v58 : int | v58 in (seq(0x41, i12  => (p0))) :: (v58 + p0) := (v0[406])) + v27, v27, if (fm26(p0, globalState)) then v27 else map v59 : int | (-141 <= v59) && (v59 < 0x99) :: (v59 + p0) := (|[|v39|, i5]|), v27, map[p1 := p0], map v60 : int | (0x10f <= v60) && (v60 < 917) :: (v60 + i5) := (p0), v27, v27, v27, if (v35[916]) then map v61 : int | v61 in (map v62 : int | (-0x265 <= v62) && (v62 < -196) :: (v62 + i5) := (v55)) :: (v61 - |v39|) := (p0) else v27, v27, map[p0 := |v55|], v27 + v27, v27, v27, v27, v27, v27, v27, map v63 : int | (-0x1da <= v63) && (v63 < 0x3b5) :: (v63 % v0[406]) := (0x1f3), v27, v27, map[-i5 := p0]];
					v64, v0[406], globalState.f1, globalState.f1, globalState.f23 := v64, i5, p0, p0, f36;
					var v65: multiset<bool> := multiset{fm26(0x200, globalState), true, true, v35[916], f28};
					v65 := v65;
				case DC29(cf46) =>
					var v66: seq<int> := [i5, 0x18];
					globalState.f17 := v66 + (seq(0x350, i13  => (i5)));
					var v67 := "ayjrff";
					...
					var v77: array<array<bool>> := new array<bool>[9] [v35, if (v72 in v73) then v73[v72] else v35, if (v35[916] in v74) then v74[v35[916]] else v35, v35, v35, v35, v35, if (p0 in v76) then v76[p0] else v35, v35];
					v77[71] := v35;
					v77[71] := v35;
			}
		...
		if (fm29(if (p0 in v81) then v81[p0] else v80, p0, globalState)) {
			...
			match (v95) {
				...
				case DC22() =>
					...
					var v101 := DC12(v100);
					globalState.f1, globalState.f1, f35, v30, globalState.f13 := p1, (|v99| % |[v101, DC12(v100)]|) + |([f29, f29, false, f29] + [f28])|, (if (f35) then f35 else f28) ==> false, v30 + v30, f29;
					...
					v103[197] := (v79 + v79)[0xae := false];
					var v104: map<int, seq<bool>> := map[--0x228 := v79];
					var v105: map<bool, int> := map[false := p1];
					v102, v103[197], f35, globalState.f27 := v102, (if ((if (f29 in v105) then v105[f29] else p0) in v104) then v104[if (f29 in v105) then v105[f29] else p0] else v79)[p0 := !f35] + v79, !fm38(globalState), f29;
				...
				case DC20(cf26) =>
					...
					v109[935] := (if (f36 in v112) then v112[f36] else v111) <= v111;
			...
			if (!(if (f29 in v29) then v29[f29] else false)) {
				...
				var v120: map<map<bool, bool>, array<bool>> := map[v29[v117[196] := f28] := v117];
				...
				globalState.f24 := |(if ((v122 + (seq(576, i19  => (f36)))) in v123) then v123[v122 + (seq(576, i19  => (f36)))] else v122 + (seq(0x267, i20  => (f36))))|;
...
class C6 extends T0 {
	...
	function fm21(p0: D2, p1: int, globalState: GlobalState): bool {
		{|map[f29 := -0xdd]|} !! {|(seq(527, i0  => (|map[0x228 := 0x100]|)))|, |{f28}|}
	}
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := p0 to p0 {
			...
			if ((v1 + v1) <= (v3.cf60 - v1)) {
				...
				globalState.f17 := v7 + (seq(0x304, i1  => (i0)));
				var v8 := DC5(f28);
				var v9 := DC10(f28, p0, p0);
				var v10 := DC11(v9);
				v8, v10, v3 := v8.(cf8 := f29), v10, v3.(cf60 := v1);
				var v11: array<bool> := new bool[18];
				v11[454] := fm25(i0, p0, globalState) > 0x99;
				v11[454] := f29;
			} else {
				var v12: seq<bool> := [f29];
				var v13: map<bool, bool> := map[f29 := v12[i0]];
				m0(v13, p0 * p0, f29, globalState);
				v12 := v12;
				var v14 := DC27(f29, f28, false, 613, f28);
				var v15: map<char, int> := map[v2[v14.cf43] := p0];
				var v16 := 'n';
				v15 := v15[v16 := i0];
				var v17: seq<string> := ["l"];
				v17 := (seq(0x4b, i2  => (v2))) + f34;
				globalState.f21 := f28;
			}
			
			var v18: seq<int> := [|v2|, i0];
			var v19: seq<bool> := [f29, f28];
			globalState.f1 := |map[|v18| := i0]| % |v19|;
			var v20: set<bool> := {false, f29, fm26(0x5d, globalState)};
			var v21: map<int, bool> := map[p0 := f29];
			var v22: array<bool> := new bool[24] [false, if (f28) then f29 else false, (seq(0x3ba, i3  => ('s'))) == v2, p0 > i0, f28, f28, i0 > p0, f29, v20 !! v20, f29, false, if (i0 in v21) then v21[i0] else f28, f29, !f28, f29, f28, f29, f29, f28, if (f28) then f29 else !true, f29, f29 ==> f29, f29, f28 !in v19];
			v22[860] := f29;
			v22[860] := f29 ==> (true && f28);
			var v23: map<int, seq<char>> := map[i0 := v2];
			var v24: multiset<int> := multiset{p0};
			var v25 := new C5(v0.fm33(v2, v23, v24, globalState), v2[0x20c], f28, v22[860]);
		}
		var v26: array<map<int, bool>> := new map<int, bool>[28];
		var v27: map<int, bool> := map[p0 := f28];
		v26[458] := v27[p0 := f28] + v27;
		v26[458] := if (f28) then v27[p0 := f28] + (map[p0 := false])[p0 := f28] else map v28 : int | (240 <= v28) && (v28 < 641) :: (v28 % |"ocdte"|) := (true);
		var v29 := 't';
		globalState.f24 := if (f29) then fm27(p0, v29, p0, globalState) / p0 else p0 - |"ktfofded"|;
		if (if (f28) then false && f28 else p0 <= 0x128) {
			...
			globalState.f24, globalState.f23 := if (v30 in v31) then v31[v30] else -|v32|, v33[|v32|];
			...
			match (v35) {
				case DC24(cf29, cf30, cf31, cf32, cf33) =>
					...
					v39[613] := v0.fm34(fm22(v40, globalState), v34 != v34, globalState);
				...
				case DC25(cf34, cf35, cf36, cf37, cf38) =>
					...
					v42[727] := v43[f34[|map[true := |v32|]|] := v29];
					v42[727] := v43 + v43;
					var v44: array<multiset<string>> := new multiset<string>[25](i6 => multiset{v33[cf35 := v29], v33, v33} + multiset{seq(0x159, i7  => (v29))});
					var v45: multiset<string> := multiset{v33, v33, f34[cf35], v33};
					v44[642] := v45;
					v44[642] := v45 * v45;
					var v47: seq<int> := [|v33|];
					var v48: multiset<int> := multiset{|v47|, 0x1f2};
					var v49: seq<multiset<int>> := [v48];
					var v50 := new C4(p0 <= cf38, cf34, v0.fm33(v33, map v46 : int | (-877 <= v46) && (v46 < 0x265) :: (v46 / cf38) := (v33), v49[cf35], globalState), cf34);
					var v51 := new C2();
				case DC23(cf28) =>
					...
					v57[396] := v33;
					v57[396] := seq(0x165, i9  => (v29));
					var v58: map<bool, bool> := map[v52.f28 := f28];
					var v59: seq<map<bool, bool>> := [v58];
					var v60: map<string, bool> := map[v57[396] := v59[p0] == v58[false := v56[959]]];
					v60 := DC43(v60).cf61;
			}
			...
			var v65: multiset<map<int, bool>> := multiset{v26[458], map v63 : int | v63 in v64 :: (v63 + -p0) := (f29)};
			...
			var v71 := DC33(DC32());
			v71, globalState.f24, globalState.f23 := v71, p0 / -v69, v29;
			if (!v70) {
				globalState.f22 := v70;
				v67[480] := if (f28) then f28 else f29;
				var v72 := "k";
				globalState.f23, v67[480], globalState.f1, v72, v69 := v29, (p0 == |multiset{p0}|) <==> f28, p0, if (f29) then v72 + v72 else v72, v69 / -(if (f29) then |"empckknky"| else v69);
				v72 := v72;
				var v73: map<int, seq<char>> := map[v69 := v72];
				var v74: multiset<int> := multiset{p0};
				var v75: seq<bool> := [v70, v67[480], f28, v0.fm33("hpfjt", v73, (v74[|v72| := v69])[p0 := p0], globalState)];
				var v76: map<string, bool> := map[v72 := f29];
				globalState.f24, globalState.f24, globalState.f27, v75 := 0x3a - |map[|v76| := f28]|, if (!f29) then p0 / -v69 else v69, v70, [fm22(v74, globalState), f29, if (v69 in v26[458]) then v26[458][v69] else true, v67[480], if (v70) then false else !f28];
				var v77: array<char> := new char[4] [v29, v29, 'o', v29];
				var v78: T0 := new C4(f28, v67[480], v70, !v70);
				var v79: map<array<char>, D9> := map[v77 := DC24('k', v70, v69, DC20(v78), v78.f28)];
				var v80 := DC20(v78);
				var v81 := DC24(v29, f28, -p0, v80, !v67[480]);
				v79 := v79[v77 := v81];
			} else {
				v67[70] := v69 < v69;
				var v82: set<array<bool>> := {v67};
				v67[70] := v82 <= {v67};
				var v83: seq<bool> := [v67[70]];
				var v84 := new C1(v67[70], v83[v69] || !f29);
				globalState.f27 := f28;
	...
	method m11(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: set<string>, r1: int, r2: bool) {
		...
		v5[690] := p0;
		var v6 := "p";
		v5[690] := match fm68(v6, globalState) {
			case DC24(cf29, cf30, cf31, cf32, cf33) => p2
			case DC25(cf34, cf35, cf36, cf37, cf38) => cf36 % |map[p3 := !cf37]|
			case DC23(cf28) => 901
		};
		v5[690] := p0;
		var v7 := new C3(f28, fm26(p2, globalState), f29 || !p1, v5[690]);
		var v8 := 'g';
		var v9: set<int> := {p2, p2};
		var v10: set<string> := {(("fgg")[|map[p1 := f28]| := v8])[p2 := fm42(-874, fm27(p2, v8, |v9|, globalState), globalState)], v6};
		r0 := v10 * {(fm51(p3, v5[690], globalState))[p3 := v8]};
		...
		for i0 := -p0 to p0 {
			...
			match (v4) {
				case DC5(cf8) =>
					...
					v6[742] := v9;
					var v10: seq<int> := [i0];
					v6[742] := (v9 + v9) + (fm17(fm16(p0, |v10|, seq(0x3df, i2  => (v1)), i0, globalState), cf8, !f29, globalState) + v9);
				...
				case DC4(cf7) =>
					...
					v0[258] := |v14|;
					v0[258] := fm16(p0, fm16(i0, p0, v11[p0 := cf7], 746, globalState), v11, -p0, globalState);
					var v15: multiset<int> := multiset{p0, |v11|};
					var v16 := DC2(0x14, p0, v11[p0 := cf7], true);
					var v17: set<bool> := {v16.cf5, f28};
					var v18: map<multiset<int>, int> := map[v15 := |v17|];
					var v19: seq<int> := [i0, v0[258]];
					f28, globalState.f24, r0, globalState.f27 := fm18(|map[v0[258] := false]|, p0, (if (v15 in v18) then v18[v15] else i0) % v0[258], globalState), -p0 * v19[v0[258]], f28, f29 || f28;
		...
		if (f29) {
			...
			match (v30) {
				case DC2(cf2, cf3, cf4, cf5) =>
					...
					var v34: seq<int> := [v26[869]];
					var v35: map<bool, seq<int>> := map[f28 := v34];
					globalState.f1, globalState.f1, v26[869], globalState.f24, globalState.f17 := cf2, |v33|, p0 + cf3, cf2, ((if (cf5 in v35) then v35[cf5] else v34) + (seq(860, i5  => (p0)))) + v34;
					var v36 := 's';
				...
				case DC1(cf1) =>
					var v40 := "fvfftmt";
					v27 := v27[f29 ==> fm18(v26[869], -0x13f, p0, globalState) := |(v40 + v40)|];
					var v41: map<seq<int>, bool> := map[fm19(0x222, f28, f28, f29, globalState) := f28];
					var v42: multiset<int> := multiset{v26[869], v26[869], v26[869]};
					...
					var v48: seq<int> := [if (v26[869] in v42) then v42[v26[869]] else p0, |v47|];
					v41 := v41[v48 := true];
					v26 := v26;
					globalState.f13 := f28;
				case DC3(cf6) =>
					...
					var v53 := 'g';
					var v54: seq<string> := [v51.cf11, v50, "ayic", (fm51(|v52|, |v50|, globalState))[v26[869] := v53]];
					...
					globalState.f13 := (v57[286] - {v26[869], |v50|, |v58|}) !! v56;
					var v59: map<string, int> := map[v50 + v50 := 271];
					var v60 := DC4(v53);
					var v61: set<bool> := {v55.fm21(v60, |(seq(0x167, i6  => (v26[869])))|, globalState)};
					var v62: map<char, seq<char>> := map[v53 := v50];
					var v63: map<seq<char>, string> := map[if (v53 in v62) then v62[v53] else v50 := v50 + v50];
					globalState.f13, globalState.f26, v50, v59, globalState.f27 := false, v61, if ((seq(0x9e, i7  => (v50[p0]))) in v63) then v63[seq(0x9e, i7  => (v50[p0]))] else v50, v59, if (f29) then f28 else f29 || true;
			}
			...
			globalState.f23 := v64;
			var v65 := "dlxtec";
			var v66: multiset<int> := multiset{|"buumhtlxo"|, v26[869], |v65|};
			...
			var v76: set<bool> := {p0 == v26[869], f29 !in v71, if (!f28 in v75) then v75[!f28] else true};
			globalState.f26 := v71;
			var v77 := "nbjjtmai";
			var v78: multiset<string> := multiset{v77};
			v26[869] := v26[869] / (if (v77 in v78) then v78[v77] else |v77|);
			var v79 := new C0();
			globalState.f21 := p0 > (v26[869] - p0);
...
class C8 {
	...
	method m9(p0: seq<int>, p1: int, globalState: GlobalState) returns (r0: map<bool, bool>) {
		...
		var v3 := true;
		v0[907] := (p1 < |v2[0x10a := v1]|) && v3;
		var v4: array<int> := new int[29](i0 => i0 - p1);
		v4[62] := p1;
		var v5: seq<bool> := [v0[907]];
		var v6: map<seq<bool>, bool> := map[v5 := !v3];
		globalState.f1, globalState.f13, v0[907], globalState.f1, v4[62] := -(p1 * p1), v0[907], fm13(globalState) ==> !true, p1 / p1, |v6|;
		globalState.f1 := v4[62] - |fm14(globalState)|;
		var v7 := 'o';
		var v8: C3 := new C3(v0[907], v0[907], v0[907], |p0|);
		var v9: seq<C3> := [v8, v8, v8];
		var v10: seq<char> := ['e', v7];
		var v11 := DC25(v3, v4[62], p1, v0[907], |v10|);
		...
		if (false) {
			match (fm69(globalState)) {
				...
				case DC39(cf56) =>
					var v18: set<bool> := {!v3};
					v4[62] := |(set v17 : int | (44 <= v17) && (v17 < 0x40) :: (v17 % -p0[p1]))| / (0x2fb / -|v18|);
					cf56 := cf56 + "yp";
					var v19 := new C7(v0[907], v3);
					var v20 := new C7(v0[907] <==> v3, v0[907]);
				case DC40(cf57, cf58) =>
					var v21: map<bool, int> := map[v8.f40 := p1];
					var v22: map<bool, bool> := map[cf57 := !v8.f40];
					v21 := v21[v8.f40 := |v22[v0[907] := false]|];
					var v23: map<int, bool> := map[v4[62] * p1 := v0[907]];
					v23 := v23;
					v21 := v21[v8.f40 := p1];
					...
					v24[7] := v0;
				case DC37(cf52) =>
					var v25: map<string, int> := map[v10 := v4[62]];
					var v26 := DC40(v8.f40, v0[907]);
					var v27: set<D15> := {v26};
					globalState.f13 := (p1 % |v10|) > (|v25| % |v27|);
					var v28: set<int> := {v4[62]};
					globalState.f1 := -(|v5| - (if (v8.fm30(v28, globalState) in v1) then v1[v8.fm30(v28, globalState)] else v4[62]));
					globalState.f24 := v4[62];
					globalState.f27 := (if (false) then v1[-v4[62] := -|v1|] else v1) < multiset{p1};
				case DC41(cf59) =>
					globalState.f24 := p0[p1];
					globalState.f1 := p1 * v4[62];
					globalState.f13 := v3;
					var v29: set<bool> := {v0[907]};
					globalState.f1, v4[62] := v4[62], |v29| * p1;
			}
			
			var v30: seq<seq<bool>> := [v5];
			var v31: map<int, seq<bool>> := map[p1 := v5];
			var v32: set<string> := {v10};
			var v33: array<seq<bool>> := new seq<bool>[9] [v5, v5, v5, v5, v30[v4[62]], fm62(globalState), v5, if (v8.f40) then v30[p1] else v5, if (v12.fm36(v4[62], v32, globalState) in v31) then v31[v12.fm36(v4[62], v32, globalState)] else v5];
			v33[624] := v5 + v5;
			v33[624] := [p1 >= v4[62]];
			var v34 := DC5(v3);
			var v35 := DC6(v34);
			...
			match (v36) {
				case DC5(cf8) =>
					var v38: map<int, int> := map[-p1 := v12.fm36(v4[62], set v37 : string | v37 in ["mdk"] :: (v37), globalState)];
					var v39 := DC47(map[v4[62] := v38]);
					globalState.f24 := |v39.cf67|;
					var v40 := new C1(v3, v4[62] != |v10|);
					var v41 := DC44(cf8, "bknklrvx");
					var v42: seq<D17> := [v41];
					var v43: map<bool, seq<D17>> := map[v33[624][p1] := [v41] + v42];
					v42 := if (v8.f40 in v43) then v43[v8.f40] else v42 + v42;
					v4[62], v4[62], globalState.f1, globalState.f22 := v4[62] - p1, v4[62], p1 * p1, cf8;
				case DC4(cf7) =>
					var v44: array<array<int>> := new array<int>[22];
					v44[287] := v4;
					var v45: map<bool, bool> := map[true := v8.f40];
					var v46: seq<map<bool, bool>> := [map[v3 := v3] + fm59(v8.f40, v33[624], globalState), v45];
					var v47: map<int, bool> := map[|(seq(0xae, i1  => (cf7)))| := fm13(globalState)];
					var v49: multiset<bool> := multiset{v8.f40, v3, v8.f40, v8.f40, v8.f40};
					var v50: map<bool, int> := map[v0[907] := fm25(|v47[p1 := v8.f40]|, |(map v48 : multiset<bool> | v48 in map[v49 := p1] :: (v48) := (|map[cf7 := v4[62]]|))|, globalState)];
					globalState.f22, v4[62], v44[287] := |v10| <= fm27(-p1, cf7, p1, globalState), |v46[if (v3 in v50) then v50[v3] else |p0| := v45]|, v4;
					var v51: seq<array<bool>> := [v0, v0];
					v0 := v51[0x193];
					var v52: seq<multiset<bool>> := [multiset{v3}, v49, v49];
					var v53 := new C4(v4[62] > p1, v52[v4[62]] == v49, v0[907], v8.f40);
					var v54: map<int, array<bool>> := map[v4[62] := v0];
					v54 := v54[v4[62] := v0];
				case DC6(cf9) =>
					var v55 := DC4(v7);
					v55 := v55;
					var v56 := new C0();
					var v57, v58, v59 := v8.m16(v0[907], v8.f40, v10, v33, globalState);
					globalState.f24, v0[907] := v4[62] - v4[62], v59;
			}
			
			var v60: multiset<bool> := multiset{if (v8.f40) then v0[907] else v8.f40, v8.f40};
			v60, globalState.f1, v4[62], globalState.f13 := multiset(([v8.f40] + v5) + v33[624]), p1, if (v0[907]) then -v4[62] else p1 % p1, !v0[907];
			var v61: map<int, bool> := map[p1 := v3];
			var v62: map<string, bool> := map[v10 := if (p1 in v61) then v61[p1] else v8.f40];
			var v63 := DC43(v62);
			v63 := v63;
		} else {
			v7 := fm42(v4[62], p1, globalState);
			var v64: map<char, bool> := map[v7 := v8.f40];
			v64 := v64;
			var v65: array<array<bool>> := new array<bool>[2];
			var v66 := DC48(!v3 ==> v3, v4[62], v65, if (v8.f40) then !v3 else v3, v7);
			...
			var v71: map<int, int> := map[275 := p0[p1]];
			v66, v67, globalState.f24, v69 := v66, if (v69.f28) then v67 else v67, (--p1 / -|v70|) / (if (p1 in v71) then v71[p1] else v4[62]), v69;
			globalState.f22 := v69.f28;
			match (DC21(if (v69.f28) then v8.f40 else v8.f40)) {
				case DC21(cf27) =>
					v0[907] := v5[--v4[62]];
					v4[62] := p1;
					v68 := fm28(DC10(v69.f29, p1, |v10|), p1, v7, v4[62], globalState);
					var v72: map<multiset<int>, int> := map[DC9(v1[|p0| := p1]).cf12 := v4[62]];
					v4[62] := fm27(if (v1 in v72) then v72[v1] else v4[62], 'h', p1, globalState);
				case DC22() =>
					globalState.f1 := v4[62];
					v10 := v10 + v10;
					var v73: set<char> := {v7, 'v', v7, v7};
					var v74: map<array<bool>, bool> := map[v0 := v3];
					v4[62] := if ((|v73| - |v74|) in v71) then v71[|v73| - |v74|] else p1;
		...
		v80 := v80;
		var v81 := DC36(v5);
		r0 := fm59(v0[907], v81.cf51, globalState);
	}
	method m10(p0: int, p1: bool, globalState: GlobalState) {
		...
		v7[81] := v8;
		var v9 := 'h';
		v7[81] := v8[|v8| + fm25(p0, p0, globalState) := v9];
		...
		globalState.f24 := |(v14 + ([v10])[p0 := v10])|;
	}
}
...
class C9 extends T0 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		if (f29) {
			...
			if (p0 <= -(if (f28 in v0[661]) then v0[661][f28] else |v2|)) {
				var v3: map<bool, bool> := map[f28 := f29];
				v3 := v3[f28 := true];
				var v4 := "ikj";
				var v5: seq<seq<string>> := [(seq(65, i1  => ("b")))[0x1d3 := v4]];
				var v6: seq<bool> := [f29, f29];
				v3 := v3[f29 := fm11(f28, v5[|v1|], p0, globalState) in v6];
				var v7 := 'e';
				...
				v10[135] := p0 + p0;
				var v12 := DC7(v11);
				v9, v11, v10[135] := v9, v12.cf10 + (v11 + v11), p0;
			} else {
				var v13 := "ngv";
				...
				v14 := v14;
				globalState.f1 := |(v1 + v0[661][f29 := p0])|;
				var v22: array<bool> := new bool[27] [f29, false, f28, f28, !f29, f28, f28, true, f28, !f29, f28, !f29, false, f28, !f29, f28, f28, f28, f28, f28, f28, f29, v15[p0], f28, f29, !f29, f29];
			...
			globalState.f13 := f29;
			var v27: array<int> := new int[19](i2 => i2 / 0x224);
			v27[722] := p0;
			var v28: seq<int> := [fm12(p0, false, globalState), p0];
			v27[722] := |(v28 + v28)[0x15 % 605 := -(p0 / p0)]|;
			var v29 := new C2();
		} else {
			globalState.f27 := f28;
			globalState.f13 := fm38(globalState);
			var v30: multiset<bool> := multiset{f29, f28};
			var v31: array<int> := new int[9](i3 => i3 / p0);
			var v32: set<array<int>> := {v31};
			var v33: set<int> := {128};
			var v34 := "bdwiwcd";
			var v35: array<bool> := new bool[15] [f29, v30 <= v30, f28, v32 !! v32, f28, f29, true, v33 < v33, !!(v34 == (seq(-0xd, i4  => ('g')))), f29, f29, f28, f29, f28, f28 && f29];
			var v36: seq<string> := [v34, v34];
			v35[293] := fm11(!!f28, v36, p0, globalState);
			v31[45] := p0 + p0;
			...
			v35[293], v31[45], globalState.f22, globalState.f1, v38 := p0 > p0, p0, (if (v39 in v42) then v42[v39] else v41) <= v41, -fm27(p0, fm42(375, p0, globalState), -p0, globalState), v38 + (fm46(f28, globalState) + v38[---p0 := [f28, f29]]);
			v35 := v35;
			v31[45] := fm25(-v40[-413], v31[45], globalState) / (v31[45] - p0);
		}
		...
		match (v44) {
			...
			case DC40(cf57, cf58) =>
				...
				var v58 := 'd';
				var v59: set<int> := {p0, |("xvyfwjsi")[p0 := v58]|};
				var v60 := DC31(v59);
				match (if (f29) then v60.(cf48 := v59) else v60) {
					case DC32() =>
						var v61: array<int> := new int[12](i6 => i6 / -p0);
					...
					case DC33(cf49) =>
						...
						var v71: array<bool> := new bool[17] [if (!f28) then !cf57 else cf58, v69.cf34, if (cf58) then f29 else cf57, f28, f28, cf57, fm18(p0, fm25(p0, |v43|, globalState), p0, globalState), p0 <= p0, !(v70[0x364 := p0] !! fm24(v59, cf58, globalState)), cf58, cf57, !!cf58, f28, false, v43[p0], f29, f29];
						v71[593] := cf57;
						v71[593] := v43[p0];
						var v72: seq<int> := [0x12f, |v68|];
						var v73 := DC8(v68);
						var v74: map<int, int> := map[v72[p0] := |v73.cf11|];
						globalState.f1 := p0 - |v74[p0 := |v68|]|;
						var v75 := new C4(if (true) then !cf57 else v71[593], !f28, cf57, !(multiset{f29, f29, cf58} > multiset(v43)));
						var v76: array<int> := new int[25] [p0 % -0x19e, p0, -p0, p0, p0, -fm12(p0, !v75.f38, globalState), 0x250, |v72| % p0, p0, if (true) then DC2(p0, |map[true := p0]|, v68, !cf57).cf3 else p0, p0 + p0, p0, p0, p0, p0 + p0, p0 + |multiset{|v72|, 398}|, fm25(p0, p0, globalState) - |v68|, p0, p0, |v68[0x13f := v68[p0]]|, p0, p0, p0, p0, p0 * p0];
						v76[86] := p0;
						var v77: map<array<int>, int> := map[v76 := if (|multiset(fm19(-0x1d1, f29, v71[593], v75.f38, globalState))| in v74) then v74[|multiset(fm19(-0x1d1, f29, v71[593], v75.f38, globalState))|] else p0];
						v76[86] := |(v77 + v77)|;
				}
			...
			case DC37(cf52) =>
				...
				globalState.f24 := if (f29) then -(p0 % (if (f28 in v80) then v80[f28] else |fm57(v81, |v82|, p0, globalState)|)) else |v84|;
			...
			case DC41(cf59) =>
				...
				if ((v87 * v87) >= v87) {
					...
					globalState.f24 := if (fm11(f28, v89, -p0, globalState)) then p0 else p0 - |(seq(99, i7  => ('q')))|;
					...
					var v98: array<string> := new string[13] [v96 + (seq(0x237, i8  => ('b'))), v96, v96, v96, v96 + v96, "hqq", fm51(p0, 0x9c, globalState), v96, v96, v96, "uacmegsp", if (f28 in v97) then v97[f28] else v96, v96];
					v98[500] := "du";
					v98[500] := "lu";
					var v99: array<map<bool, bool>> := new map<bool, bool>[22](i9 => v95);
					v99[738] := v95;
					var v100: set<bool> := {f29};
					v99[738] := map[f28 := v100 !! v100];
				...
				var v104 := "nqpf";
				var v105: seq<string> := [seq(0x21b, i10  => ('c')), seq(0x91, i11  => ('q')), v104];
				var v106: C6 := new C6(v103, v105, f29, f28);
				var v107: map<C6, bool> := map[v106 := f29];
				var v108: multiset<int> := multiset{p0};
				globalState.f1 := |v107| / -(if (p0 in v108) then v108[p0] else p0);
				var v109 := 'q';
				...
				var v114: map<int, set<bool>> := map[p0 := v113[|v110|]];
		...
		if (DC17(false).cf22) {
			...
			var v133: array<seq<D10>> := new seq<D10>[28] [v131, v131, v131, v131, v131, fm70(p0, globalState), v131, [v130, v130, v130, v130, v130.(cf46 := v128)] + v131, v131, v131, seq(0x38e, i13  => (v130)), v131, v131 + DC50(v131).cf74, v131, v131, fm70(|v132|, globalState), v131, [v130], if (f29) then v131 else [v130, v130], v131, v131 + v131, v131, v131 + v131, v131, v131, seq(0x35, i14  => (v130)), if (true) then fm70(269, globalState) else v131, v131];
			v133 := v133;
			var v134: multiset<bool> := multiset{f29};
			var v135: map<array<bool>, bool> := map[v124 := v134[f29 := v117.f39] > v134];
			v135 := v135;
			var v136 := 'o';
			...
			globalState.f24 := v152.cf14 % (0x34a * v117.f39);
			var v153 := 'v';
...
class C10 {
	...
	method m7(p0: int, p1: int, p2: bool, p3: map<bool, D1>, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool, r3: bool) {
		...
		var v1: seq<bool> := [p2];
		var v2: multiset<seq<int>> := multiset{[|(seq(819, i0  => (|map[p2 := 0x13c]|)))|, f32, |v1|]};
		v0[587] := v2;
		v0[587] := v2;
		if (p2) {
			...
			var v13 := DC2(|v12|, -0x23e, seq(-692, i1  => ('v')), p2);
			var v14 := DC2(v13.cf2, |v1|, f31, p2);
			v3, globalState.f24, v4, globalState.f24, globalState.f24 := if (v5 in v6) then v6[v5] else v3, (0x1b6 - p1) - f32, (f31 + (v4 + "yd"))[f32 := v7], if (p1 in v11) then v11[p1] else f32, |v4| - v13.cf3;
			globalState.f1 := p0;
			...
			var v19: array<int> := new int[22] [if (p2) then |v16| else p1, |(v16 + map[-p1 := p2])|, f32, 0xb4 * fm8(globalState), p0, p0, -f32, |v4|, |map[p2 := -|"raidwy"|]| % p1, 0x38b, |v17| * p0, 670, p0, |(v18 + [v9, v9, v9])|, 169, fm8(globalState), p0, p0, |[false, false, p2]|, 0x335, p1, |multiset(v17)|];
			var v20: multiset<bool> := multiset{p2};
			var v21: map<set<int>, int> := map[{|v20|} := p1];
			v19[662] := |(map[fm9(fm10(p2, f32, p2, globalState), globalState) := f32] + v21)|;
			globalState.f13, v19[662] := fm10(p2, fm8(globalState), p2, globalState) <==> p2, p1;
		} else {
			var v22 := new C8();
			var v23: array<bool> := new bool[24](i2 => !p2);
			v23[536] := p2;
			v23[536] := (f31 + "khxjcw") < f31;
			var v24: array<int> := new int[3];
			v24 := v24;
			var v25: array<array<int>> := new array<int>[7] [v24, v24, v24, v24, v24, if (v23[536]) then v24 else v24, v24];
			v24[318] := |f31|;
			var v26 := DC18(p0 >= |f31|);
			...
			v27[175] := v29;
			var v30 := 'b';
			v25, globalState.f24, v24[318], v26, v27[175] := v25, |(if (v23[536] <== false) then f31 + f31 else f31[p1 := v30] + f31)|, -806 / p0, if (v23[536]) then DC18(p2) else v26, v29;
			globalState.f1 := (p1 % v24[318]) % p1;
		}
			...
			decreases 100 - i4
		{
			...
			match (v33) {
				case DC35() =>
					...
					v35[17] := |{v36[p1], |fm72([v37, v37], globalState)|}|;
					v35[17] := f32;
					v35[17] := 0x141;
					var v38: map<bool, bool> := map[p2 := p2];
					var v39: map<int, map<bool, bool>> := map[-|v34| := v38];
					var v40: map<int, int> := map[v35[17] := p0];
					m0(if (fm27(f32, fm42(v35[17], f32, globalState), p0, globalState) in v39) then v39[fm27(f32, fm42(v35[17], f32, globalState), p0, globalState)] else v38, -(if (f32 in v40) then v40[f32] else p1), p2, globalState);
					var v41: map<int, bool> := map[0x23b := p2];
					globalState.f27 := v41 != v41;
				case DC34(cf50) =>
					globalState.f1 := p0 % 383;
					var v42: array<bool> := new bool[15] [p2, p2, p2, p2, p2, p2, p2, p2, false, p2, p2, p2, p2, p2, p2];
					var v43: seq<array<bool>> := [v42, v42];
					var v44: array<array<bool>> := new array<bool>[23] [v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v42, v43[fm27(f32, 'k', f32, globalState)], v42];
					var v45 := 'p';
		...
		var v56: seq<int> := [f32, v55[p1]];
		globalState.f24 := fm27(p0, v53, |v55[f32 := p1]|, globalState) - f32;
		r0 := v56;
		r1 := p2;
		r2 := true;
		r3 := p2;
	...
	method m8(p0: int, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: array<int>) {
		...
		r0, globalState.f1, r1, r0, v5 := (|fm73(globalState)| - |v3|) + (fm8(globalState) % v0.f39), f32, if (p1) then p1 else false, f32, v5;
		...
		match (v7) {
			case DC21(cf27) =>
				...
				r0, v10, r0, globalState.f13 := f32, DC23(v11[|v12|]), v0.f39, !(v13 != v13);
				globalState.f21 := p1;
			...
			case DC22() =>
				if (v6.f29) {
					globalState.f17 := seq(0x1bc, i1  => (|(multiset{v0.f39} + multiset([|v4|]))|));
					...
					var v23: array<char> := new char[23] [v21, v21, v21, 'h', fm42(|[v21]|, 0x3b6, globalState), v21, v21, v21, v21, v21, v21, 'c', f31[p0], v21, 'w', v21, v21, v21, v21, v21, 'b', fm42(v0.f39, |f31|, globalState), v22.cf29];
					...
					globalState.f24, globalState.f24, v23, v28, v6.f28 := 0x21f % (if (v6.f29 in v30) then v30[v6.f29] else f32), |(v31 + v31)|, if (v33 in v34) then v34[v33] else v23, v28, fm38(globalState);
				...
				v41[561] := |v44|;
				var v45 := 'b';
				globalState.f24, v40, v40, v41[561], r2 := if (v6.f28) then f32 else |f31|, ((v40 + f31) + f31[v0.fm30(v44, globalState) := v45])[-v0.f39 := v45], "cgatqfqj" + v40, |(v40 + (seq(0x332, i3  => (v40[-v0.f39]))))| * v0.f39, v6.f28;
			case DC20(cf26) =>
				var v46 := 's';
				if (v46 !in (seq(116, i4  => (v46)))) {
					...
					v48[811] := v49 + v49;
					v48[811] := {v0.f39} - fm35(globalState);
				} else {
					var v50: array<bool> := new bool[4] [cf26.f29, v6.f29, p1, v6.f28];
					var v51: seq<array<bool>> := [v50, v50];
					var v52 := DC12(v50);
					var v53: array<array<bool>> := new array<bool>[27] [v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v50, v51[-422], v50, v50, v50, v52.cf17, v50, v50, v50, v50];
					...
					var v57 := DC56();
					var v58 := DC57(v57);
					var v59: array<int> := new int[23](i6 => i6 / v0.f39);
					var v60: seq<array<int>> := [v59, v59, v59, v59, v59];
					var v61: map<array<int>, array<int>> := map[v59 := v60[f32]];
					r3, v58 := if (v59 in v61) then v61[v59] else v59, v58;
					var v62: multiset<int> := multiset{v0.f39, 404};
					var v63 := DC9(v62[p0 := p0]);
					var v64 := new C6(if (!cf26.f28) then v53 else v55.f33, (seq(-0x22d, i7  => (f31))) + v54, v6.f28, !v55.fm22(v63.cf12, globalState));
				}
				
				var v65: map<int, string> := map[0xc8 := "blawixpn"];
				var v66: array<string> := new string[5](i8 => (f31 + f31)[v0.f39 := v46]);
				v66[372] := f31;
				var v67: array<set<int>> := new set<int>[16];
				var v68: map<array<set<int>>, map<int, string>> := map[v67 := v65];
				v65, v66[372] := if (v67 in v68) then v68[v67] else map[v0.f39 := f31] + (map v69 : int | (0x1f2 <= v69) && (v69 < 0x7c) :: (v69 % f32) := (seq(0x2b5, i9  => (v46)))), (f31 + f31) + fm51(v0.f39, f32, globalState);
				var v70: array<int> := new int[16];
				v70[377] := 0xcf;
				var v71 := DC44(p1, seq(0x3af, i10  => (v46)));
				var v72: map<int, bool> := map[|fm62(globalState)| := true];
				var v73: set<map<int, bool>> := {v72, v72};
				globalState.f23, v66[372], cf26.f28, v70[377], v66[372] := v46, v71.cf63[-v0.fm30({v0.f39}, globalState) - v0.f39 := v46], |v73| != v0.f39, p0, DC39(v66[372][v0.f39 := 'j']).cf56;
				var v74: map<array<int>, bool> := map[v70 := v4[v0.f39]];
				v74 := v74[v70 := v6.f28];
		}
		
		r0 := p0;
		var v75: array<int> := new int[20](i11 => i11 / v0.f39);
		var v76: set<int> := {f32, f32};
		v75[290] := v0.fm30(v76, globalState);
		v75[290] := f32;
		r0 := -(|v76| - (v75[290] * f32));
		r1 := ((seq(-786, i12  => ('w'))) != f31) <==> v6.f29;
		r2 := p1;
		r3 := v75;
	}
}
...
class C11 extends T0 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		v2[338] := f28;
		v2[338] := if (f29) then f29 else f29;
		globalState.f24 := p0;
		var v3 := "gp";
			...
			decreases 100 - i0
		{
			...
			if (v2[338]) {
				...
				v14[327] := p0;
				v14[896] := -p0;
				var v18: seq<bool> := [v2[338], v2[338]];
				var v19: map<bool, int> := map[fm29(multiset{v18, v18, v18, v18}, p0, globalState) := p0];
				v14[327], globalState.f24, globalState.f13, v14[896], globalState.f27 := if (f29 in v19) then v19[f29] else p0 + p0, p0 * p0, false, p0, f29;
			} else {
				globalState.f27 := 0x367 <= p0;
				r0 := v2[338];
				globalState.f13 := v2[338];
				v2 := v2;
				globalState.f1, globalState.f24, v2[338] := p0, p0, f29;
			}
			
			var v20: array<int> := new int[7];
			var v21: map<int, array<int>> := map[p0 := v20];
			var v22: multiset<bool> := multiset{f29 ==> !!f29};
			var v23: set<bool> := {f28, f28, v2[338]};
			var v24: set<int> := {p0};
			v21, globalState.f21, v22, globalState.f1, globalState.f21 := DC62(v21).cf91 + (v21 + v21), (v23 - {false, fm13(globalState)}) !! v23, if (if (!!v2[338]) then f29 else v2[338]) then v22 else v22, p0 % p0, (p0 / p0) in v24;
			...
			v25[319] := (if (fm38(globalState)) then fm57(v26, p0, |v27[|v28| := p0]|, globalState) else v22[v29[|v3|] := 0x32]) * (if (v2[338]) then multiset{v2[338]} else multiset(v29));
			v26 := v26;
		}
		var v30: C9 := new C9(f28, f29);
		v30 := new C9(v2[338], false);
		var v31 := DC12(v2);
		v31 := v31;
		r0 := f29;
	}
	method m6(p0: string, p1: array<bool>, p2: array<bool>, p3: bool, globalState: GlobalState) returns (r0: bool, r1: multiset<int>, r2: seq<bool>, r3: D1) {
		if (p3) {
			...
			v3, v0, globalState.f23, v4[173], v4[255] := v3, v0, v5, v0 % |v6|, |("fg")[v0 := v5]|;
			var v7: seq<string> := [p0];
			v4[173] := |(v7[v0] + p0)|;
			if (p2[966]) {
				globalState.f22, p2[966], globalState.f23 := f29, -v0 != v4[173], v5;
				var v8: map<string, bool> := map[p0 := f29];
				p2[966], v4[173] := if ((fm51(v4[173], 0x131, globalState) + p0) in v8) then v8[fm51(v4[173], 0x131, globalState) + p0] else f29, v0;
				r2 := v6;
				var v9: seq<int> := [|p0|, |v6| / v4[173]];
				globalState.f17 := v9;
				var v10 := new C8();
			} else {
				v4[173] := v0;
				globalState.f1 := v0;
				var v11: map<int, bool> := map[v4[173] := false];
				var v12 := new C3(f28, if (fm27(|f30|, 'v', v4[173], globalState) in v11) then v11[fm27(|f30|, 'v', v4[173], globalState)] else f28, if (-207 in v11) then v11[-207] else f28, -(fm74(fm47(globalState), f29, f28, true, globalState)).cf43);
				f28 := !p3;
				globalState.f22 := f29;
			}
			...
			match (DC51(|v33| * fm25(997, |p0|, globalState), p3 <== !f28, f28 || f29)) {
				...
				case DC53(cf78) =>
					...
					v49 := v49[v48 := if (f28) then |map[v32 := fm18(v32, |multiset{f28, p3}|, |v50[0xf9]|, globalState)]| else v32];
			...
			p2[247] := p3;
			p2[247] := if (f29) then f28 else f28;
		}
		...
		if (multiset{true, p3} > (v52 - v52)) {
			...
			var v54: seq<int> := [|p0|];
			v53[103] := v54;
			v53[103] := if (false) then v54 else v54;
			f28 := f28;
		...
		var v71: seq<bool> := [v70[v63]];
		v66[529] := (set v72 : int | v72 in (map v68 : int | v68 in multiset{|v69|, |v70|, -425, |p0|} :: (v68 - v63) := (p3)) :: (v72 + 307)) - (v67 - {v63, v63});
		p1[678] := true;
		var v73: array<int> := new int[3];
		v73[557] := 0x3d4;
		p1[678], v73[557] := v63 > |p0|, v63 - v63;
		v73[557] := |fm51(if (f28) then v73[557] else v63, |fm14(globalState)|, globalState)|;
		r0 := f28;
		var v74: seq<int> := [v73[557]];
		var v75: multiset<int> := multiset{v73[557], v73[557], |v69|, if (f28) then v63 else v63, |v74| + v73[557]};
		r1 := v75;
		r2 := v71 + ([p3] + v70);
...
class C12 {
	...
	method m3(p0: set<int>, p1: int, globalState: GlobalState) returns (r0: bool, r1: map<int, bool>) {
		...
		globalState.f13 := match v1 {
			...
			case DC6(cf9) => map[false := |multiset(seq(812, i0  => (p1)))|] == map[true := p1]
		};
		...
		if (v3) {
			...
			var v9: multiset<int> := multiset{-0x2bf, v8[v2[457]]};
			var v10: seq<multiset<int>> := [multiset{p1, p1, p1, v2[457]}];
			v2[457] := -fm5(|v9|, v10, globalState);
			globalState.f23 := v1.cf7;
			var v11 := "vq";
			var v12: map<map<bool, int>, string> := map[map[v3 := v2[457]] := v11];
			match (fm6(v12 + v12, fm5(v2[457], seq(0x45, i1  => (v9)), globalState) > |v8|, 0x355, v3, globalState)) {
				case DC5(cf8) =>
					var v13: seq<array<int>> := [v2, v2, v2, v2, v2];
					var v14: seq<array<int>> := [v13[v2[457]]];
					var v15 := new C11(v14, v11 <= v11, cf8);
					globalState.f1, r0, globalState.f13, v2[457] := p1, v3, cf8 <==> v3, p1;
					...
					v17[481] := |v11| == (fm75(v2[457], globalState)).cf55;
					v17[481] := v3;
					var v18: seq<array<bool>> := [v17];
					var v19: array<array<bool>> := new array<bool>[16] [v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, v17, v18[|v11|], v17];
					var v20 := DC48(false, |"pycci"|, v19, v3, v0);
					var v21: map<int, D18> := map[v2[457] := v20];
					globalState.f21 := fm18(v2[457], -|v21|, p1, globalState);
				case DC4(cf7) =>
					...
					var v25 := DC49(v8);
					var v26 := DC38(v24.f37, v2[457], v2[457]);
					globalState.f17 := (if (v3) then v25 else v25).cf73[p1 := -v26.cf55];
					var v27: array<bool> := new bool[23](i2 => false);
					var v28: seq<array<bool>> := [v27, v27];
					v28 := v28;
				case DC6(cf9) =>
					globalState.f1 := |(v9[v2[457] := if (p1 in v9) then v9[p1] else v2[457]] + v9)|;
					v2[457] := v2[457];
					var v29: map<int, int> := map[v2[457] := v2[457]];
					v29 := v29[fm5(v2[457], v10, globalState) := |"etsix"|];
			...
			var v31: map<int, bool> := map[-v2[457] := false];
			var v32: multiset<map<int, bool>> := multiset{map[p1 := v3], v31, v31, v31, v31};
			var v34: seq<map<int, bool>> := [(map v33 : int | (-0x347 <= v33) && (v33 < 0x303) :: (v33 % v2[457]) := (v3))[0x289 := v3], v31];
			...
			var v41: seq<multiset<bool>> := [v39, v39, v39, (v39[v3 := v2[457]])[v3 := 0x2a3]];
			v38[483] := if (v41 in v40) then v40[v41] else !true;
			var v42: map<bool, bool> := map[v3 := v3];
			m0(map[v3 := v38[483]] + v42, v2[457], true <== v35[p1], globalState);
		}
		
		if (fm38(globalState)) {
			globalState.f1 := if (v3) then -(|p0| % p1) else |(v4 + v4)|;
			globalState.f1 := p1;
			v2[457] := --(0x2cb * v2[457]);
			v2[457] := fm27(|v4|, 'r', if (v3) then v2[457] else -0x48, globalState);
			var v43: seq<int> := [v2[457], v2[457], v2[457]];
			var v44: set<seq<int>> := {v43};
			globalState.f13 := v44 !! v44;
		} else {
			var v45: seq<bool> := [v3];
			var v46: seq<bool> := [v45[v2[457]]];
			var v47: map<bool, int> := map[v3 := p1];
			var v48 := "ndogeuhko";
			globalState.f27 := (v2[457] + |v46|) > (|v47| % |v48|);
			globalState.f24 := v2[457];
			v46 := v46 + v46;
			var v49 := DC51(p1, v3, v3);
			v2[457] := (v49.(cf75 := v2[457])).cf75 - |(seq(0x1f4, i3  => (v2[457])))|;
			var v50: map<bool, bool> := map[v3 := v48 != v48];
			if (if ((v3 <== v3) in v50) then v50[v3 <== v3] else v3) {
				var v51: seq<seq<bool>> := [v46, v46];
				v2[457] := -|([v46, v46, [v3, fm26(v2[457], globalState)], [v3, v3, v3]] + v51)|;
				var v52 := new C9(true, v3);
				var v53 := new C0();
				var v54: map<int, int> := map[p1 - p1 := v2[457] + -p1];
				v54 := v54[|v45| % v2[457] := p1];
				globalState.f22 := v3;
			} else {
				var v55: array<char> := new char[19](i4 => v0);
				v55[933] := v0;
				v55[933] := 'g';
				globalState.f22 := p1 >= (-v2[457] - p1);
				...
				var v59: multiset<int> := multiset{v2[457]};
				v59, globalState.f13 := v59, (-v2[457] == p1) && v3;
		...
		for i6 := if (v3) then v2[457] else v2[457] to p1 {
			globalState.f13 := v3;
			var v63: set<array<int>> := {v2};
			v63 := v63;
			var v64: multiset<int> := multiset{i6, v2[457]};
			var v65: seq<int> := [i6];
			var v66: seq<int> := [|multiset(v65)|, i6];
			var v67 := DC10(v3, p1, v66[v2[457]]);
			var v68: seq<bool> := [!false];
			var v69: multiset<bool> := multiset{v3, v3};
			var v70: array<bool> := new bool[17] [!(true || v3), v3, v3, p1 !in v64, v3, v3, v3, v3, !true, v67.cf13, v68[0x76], v3, v3, v3, v3, v3, v69 >= v69];
			v70[482] := v3;
			v70[482] := (v2[457] * i6) == |p0|;
			var v71: map<int, int> := map[|map[v70[482] := p1]| := p1];
			var v72: map<int, seq<int>> := map[p1 := v66];
			var v73: seq<map<int, int>> := [v71];
			v70[482], v71, globalState.f1 := [p1, v2[457]] <= ((if (i6 in v72) then v72[i6] else v65)[p1 := 718] + v65), v73[v2[457]], -i6;
		}
		for i7 := v2[457] to v2[457] - p1 {
			var v74: seq<int> := [p1];
			var v75: map<int, int> := map[p1 := i7];
			var v76: multiset<int> := multiset{|v75|};
			var v77: multiset<bool> := multiset{!true};
			globalState.f17 := if (v3) then (seq(0x117, i8  => (v2[457]))) + v74 else [p1, |v76|, v2[457], |fm57(v0, v2[457], i7, globalState)|, i7] + [|v77|, p1];
			var v78: array<C9> := new C9[28];
			var v79: C9 := new C9(v3, v3);
			v78[864] := v79;
			v78[864] := v79;
			var v80 := "ghbkroay";
			v2[457] := fm27(-i7, fm42(|v80|, i7, globalState), -(v2[457] % v2[457]), globalState);
	...
	method m4(globalState: GlobalState) returns (r0: seq<D1>, r1: array<int>) {
		...
		var v3: array<multiset<bool>> := new multiset<bool>[13] [v1, v1, v2[-0x220], v1, v1, v1, v1, v1, v1, v1, v1, v1, v1];
		var v4 := DC63(v3);
		match (v4) {
			case DC63(cf92) =>
				var v5 := "hoytvc";
				...
				var v8: set<string> := {"pywf", seq(-495, i0  => (v5[|map[v0 := -0x90]|]))};
				var v9 := DC42(v8);
				...
				match (DC9(v7).(cf12 := v7 * multiset{|v10|})) {
					case DC10(cf13, cf14, cf15) =>
						...
						globalState.f24 := (|v13[v6]| * cf15) + |{cf13, cf13, cf13}|;
						cf15 := cf15;
					case DC9(cf12) =>
						var v14: array<seq<bool>> := new seq<bool>[25](i1 => [v0, v0, DC40(v0, !v0).cf58] + [v0]);
						var v15: seq<bool> := [true];
						var v16: seq<bool> := [v15[v6]];
						v14[7] := v16;
						var v17: array<string> := new string[6] [v5, "nkeimlfqp", v5, v5, (seq(0x16b, i2  => ('h')))[v6 := v5[v6]], seq(-882, i3  => ('k'))];
						var v18: map<array<string>, seq<bool>> := map[v17 := v16];
						v14[7] := if (v17 in v18) then v18[v17] else v15 + v15;
						...
						globalState.f22, v0, v19[914], globalState.f21, v22 := v0, DC64(fm25(v6, v6, globalState), |v5|, true, v6, v6).cf95, v20, |v5| > v6, (if (v0 in v25) then v25[v0] else v22) * v22;
					...
					case DC11(cf16) =>
						...
						v35[773] := if ((|v31| - v6) in v37) then v37[|v31| - v6] else v30;
						var v38: array<bool> := new bool[4];
						v38 := v38;
						var v39: seq<multiset<int>> := [v7];
						globalState.f1 := fm5(0x62, v39[v6 := multiset(v32)], globalState);
						v31 := v31;
				}
			...
			case DC64(cf93, cf94, cf95, cf96, cf97) =>
				...
				var v45: seq<seq<bool>> := [v44, (v44[840 := v0])[cf97 := v0]];
			...
			case DC62(cf91) =>
				...
				v55[904] := v56;
				globalState.f27 := v0;
				var v57: array<int> := new int[9](i6 => i6 / -0x26e);
				var v58 := 796;
				var v59: seq<int> := [v58, v58, v58];
				v57[705] := |multiset(v59)| * v58;
				v57[705] := v58;
			case DC65(cf98) =>
		...
		for i7 := v64 to v64 {
			...
			globalState.f22 := --(704 % i7) != v66[fm5(if ((seq(736, i8  => ('d'))) in v67) then v67[seq(736, i8  => ('d'))] else v64, v71, globalState)];
			var v72: array<bool> := new bool[9](i9 => v1 > v1);
			v72[107] := v0;
			v72[107] := v0 || v0;
			var v73: C9 := new C9(v72[107], v72[107]);
			var v74: map<int, C9> := map[i7 := v73];
			v74 := v74[i7 := v73];
			var v75: seq<seq<char>> := [v63];
			var v76: seq<bool> := [v72[107]];
			var v77: map<int, seq<bool>> := map[|([seq(531, i10  => ('m'))] + v75)| := v76];
			var v78: multiset<seq<bool>> := multiset{v76, v76};
			var v79 := DC37(v78);
			var v80: map<char, string> := map[fm42(i7, i7, globalState) := seq(-0xf4, i11  => ('a'))];
			v77, v65, globalState.f22, globalState.f1 := fm76(v63 == v63, fm29(v79.cf52, v64, globalState), v72[107], globalState), map[v72[107] := v64 + |v80|], false, -0x2e0 - i7;
		}
		for i12 := v64 * v64 to v64 {
			...
			var v83: map<multiset<string>, bool> := map[v81 * (if (v0 in v82) then v82[v0] else (fm20(DC55(v0).cf80, globalState))[v63 := i12]) := v0];
			var v84: seq<string> := [v63];
			v83 := v83[multiset(v84[i12 := v63]) := !v0];
			globalState.f24 := v64;
			var v85: set<int> := {|v63|};
...
class C13 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: array<bool>, r1: int, r2: int, r3: bool) {
		...
		v3 := v3[v1 := v0[696] <= v0[696]];
		var v4: seq<seq<int>> := [v2, v2, v2];
		v4 := if (v1 <== v1) then [v2, v2] else v4 + v4;
		if (v1) {
			var v5: array<array<bool>> := new array<bool>[7];
			var v6: map<bool, array<array<bool>>> := map[v1 := if (fm0(v1, seq(108, i0  => ('x')), globalState)) then v5 else v5];
			v6 := v6[v1 := v5];
			...
			v14[821] := v9;
			var v15: map<bool, int> := map[v1 := v0[696]];
			var v16: multiset<seq<int>> := multiset{([v0[696]])[v2[|v15|] := v0[696]], v2, fm2(seq(0x44, i1  => (p0)), v1, globalState), v2};
			var v17: map<int, int> := map[0x238 := v0[696]];
			var v18: map<int, array<array<int>>> := map[|v16| % |v17| := v9];
			var v19 := "logqeu";
			v7, globalState.f22, globalState.f22, v14[821] := v7, v1, if (v1) then v1 else v1, if ((v2[p0] - fm3(v1, fm0(v1, v19, globalState), p0, globalState)) in v18) then v18[v2[p0] - fm3(v1, fm0(v1, v19, globalState), p0, globalState)] else if (false) then v9 else v9;
			var v20: multiset<map<bool, bool>> := multiset{v3, map[v1 := v1]};
			var v21: seq<multiset<map<bool, bool>>> := [multiset{v3}, v20, v20];
			r3 := v20 !! v21[p0];
			if (v1) {
				globalState.f27 := v1;
				globalState.f24 := -v2[p0] * p0;
				var v22 := DC4(fm1(globalState));
				var v23: array<char> := new char[5] [v11, v22.cf7, v11, 'v', v11];
				v23[769] := v11;
				var v24: seq<array<array<int>>> := [v9, v10.cf1];
				var v25: array<D1> := new D1[26] [DC1(v9).(cf1 := v14[821]), v10, DC1(v9), v10, v10, v10, v10, DC1(v14[821]), v10, DC1(v14[821]).(cf1 := v14[821]), v10, DC1(v24[|(seq(-0x24, i2  => (v11)))|]), v10, DC1(v14[821]), v10, DC1(v14[821]), v10, v10, v10, v10, v10, v10, v10, DC1(v14[821]), v10, v10];
				var v26: multiset<array<D1>> := multiset{v25, v25, v25};
				var v27: map<char, multiset<array<D1>>> := map[v11 := v26[v25 := p0]];
				globalState.f27, globalState.f24, v23[769], v1, globalState.f1 := v1 ==> (p0 >= p0), p0, v11, v26 > (if (v11 in v27) then v27[v11] else v26), v0[696];
				var v28: seq<array<int>> := [v0];
				var v29: seq<bool> := [v1];
				var v30 := new C11(v28, |multiset{v0[696], v0[696]}| < |v29|, v1);
				...
				globalState.f24 := |v34| - v0[696];
			} else {
				globalState.f21 := v1;
				globalState.f1 := p0;
				v19 := "yhjmmdhm" + (seq(0x242, i3  => (v19[|(map v35 : int | v35 in DC60(p0, v1, v1, v2).cf89 :: (v35 * p0) := (v19))|])));
			...
			if (v0[696] >= |(if (v0[696] in v40) then v40[v0[696]] else v39)|) {
				var v41: T2 := new C3(v1, v1, v1, v0[696]);
				...
				r1 := v0[696];
				globalState.f1 := v2[p0];
				v3 := v3[v1 := v1 <== v1];
			}
			
		} else {
			globalState.f1 := v0[696] - v0[696];
			var v49 := "h";
			var v50: array<D2> := new D2[5](i4 => DC6(DC4('h')));
			var v51: C8 := new C8();
			var v52: map<array<int>, int> := map[v0 := p0];
			globalState.f24, v49, v50, v51, v0[696] := v0[696], v49, v50, v51, |v52| + v0[696];
			...
			v54[136] := v56;
			var v57 := DC55(v1);
			var v58: map<D21, int> := map[v57 := |map[v0[696] := p0]|];
			globalState.f27, v54[136], v58 := v1, v56, v58;
			v53[147] := v1;
			var v59: map<int, bool> := map[fm12(p0, true, globalState) := v1];
			var v60: seq<bool> := [v1];
			var v61 := DC36(v60);
			v53[147] := !((if (v0[696] in v59) then v59[v0[696]] else !v1) in v61.cf51);
		}
		...
		if (v1) {
			...
			var v66: multiset<int> := multiset{p0, 0x100, p0, v0[696]};
			var v67: map<bool, int> := map[v1 := |"ygscpwya"|];
			var v68: T2 := new C3(v1, v1, v65[if (|{v67, v67}| in v66) then v66[|{v67, v67}|] else p0], p0);
			var v69: map<int, T2> := map[-p0 + |v64| := v68];
			v69 := (v69 + v69) + v69;
			globalState.f21 := v1;
			var v70 := new C3(v1, v1, v1, v0[696] / 0xf5);
			globalState.f21 := v1;
		} else {
			var v71 := "jrgdvbry";
			...
			match (v73) {
				case DC44(cf62, cf63) =>
					...
					var v75 := 'j';
					var v76: C5 := new C5(!fm18(v0[696], p0, |v71|, globalState), v75, cf62, fm13(globalState));
					var v77 := DC66(v76);
					v77 := v77;
					globalState.f17 := v2;
				case DC45(cf64, cf65) =>
					var v78: seq<bool> := [v1];
					var v79: T2 := new C3(v1, v78[0x187], v1, 629);
					v79 := v79;
					v0[696] := v79.f39 + p0;
					...
					globalState.f13, v82[657], v89 := v1 ==> v1, v88, v89;
				case DC43(cf61) =>
					globalState.f24 := v0[696];
					globalState.f22 := !v1;
					v0[696] := p0;
					var v90: seq<bool> := [false, v1];
					m0(fm59(true, v90, globalState), |v71| + p0, |v3| >= p0, globalState);
				case DC46(cf66) =>
					globalState.f21 := (|v2| / v0[696]) == -v0[696];
					globalState.f22 := v1;
					var v91: array<bool> := new bool[18];
					var v92: seq<bool> := [v1, v1];
					v91[908] := v92[v0[696]];
					v91[908] := fm10(v1, p0, v1, globalState) <== v1;
					globalState.f24 := v0[696];
			}
			...
			v0[696] := v0[696] / p0;
			var v95: T0 := new C3(fm0(v1, v71, globalState), v1, v1, v0[696]);
			var v96: map<bool, T0> := map[v1 := v95];
			var v97: set<int> := {fm8(globalState)};
			v96 := v96[v97 >= v97 := v95];
			var v98 := new C10(v71, |v3| / p0);
		}
		...
		match (v100) {
			case DC17(cf22) =>
				v0[696] := -fm3(v1, v1, p0 % |v2|, globalState);
				var v101 := "sf";
			...
			case DC18(cf23) =>
				...
				if (v107[v0[696]] > (v106 * v106)) {
					globalState.f13 := v1;
					var v108: map<bool, int> := map[cf23 := |(seq(-0x292, i7  => (v99)))|];
					var v109: map<int, map<bool, int>> := map[0x2a5 := v108];
					var v110 := new C7(v1, |v109| <= v0[696]);
					...
					v111[782] := multiset{v112, v112, DC12(v112).cf17, v112, v112} * multiset{v112, v112, v112};
					var v113: multiset<array<bool>> := multiset{v112, v112};
					v111[782] := (v113 * v113[v112 := v0[696]])[v112 := v0[696]];
					v0[696], r1, globalState.f21 := -v0[696], 0x12d, v1;
					v112[444] := if (cf23) then cf23 else cf23;
					v0[696], v112[444] := -0x2ff, v1;
				} else {
					v102 := v102 + v102;
					...
					var v118: multiset<int> := multiset{v0[696]};
					var v119: seq<map<bool, bool>> := [v117[|v118|], v3, v3];
					var v120: set<bool> := {!DC59(v116.f29, v102, |v119[v0[696]]|).cf83};
					globalState.f24, globalState.f27 := v0[696], !(v120 > v120) || v116.f29;
					globalState.f22 := cf23 && v116.f28;
					var v121: array<bool> := new bool[16];
					v121[216] := cf23 <== v116.f28;
					var v122: C1 := new C1(v116.f29, v116.f29);
					var v123: seq<C1> := [v122];
					var v124: map<seq<C1>, int> := map[v123 := v0[696]];
					var v125: set<int> := {fm3(false, v116.f28, -445, globalState)};
					v121[216] := |(v124 + map[v123 := -v0[696]])| < |v125|;
				}
				
				v1 := cf23;
				var v126: array<D22> := new D22[25](i8 => DC59(v1, (seq(0x329, i9  => (v99)))[|v3| := v99], p0));
				var v127 := DC59(true, v102, -203);
				v126[862] := v127;
				var v128: set<bool> := {v1};
				globalState.f23, v126[862], globalState.f22 := 'j', fm78(false, -955, {cf23} * v128, cf23, globalState), v1;
			case DC19(cf24, cf25) =>
				var v129 := new C2();
				var v130: map<bool, int> := map[v0[696] >= |fm51(|(seq(353, i10  => (v99)))|, p0, globalState)| := -929];
				var v131 := "c";
				v130 := v130[v131 <= v131 := v0[696]];
				var v132: seq<bool> := [v1, v1];
				var v133: array<array<bool>> := new array<bool>[20];
				var v134 := DC48(false, |multiset{cf25}|, v133, false, v99);
				if (!fm0(v132[p0], v131 + v131[v0[696] := v134.cf72], globalState)) {
					var v135: map<int, bool> := map[p0 := v1];
					var v136: multiset<map<int, bool>> := multiset{v135};
					v1 := (v136[v135 := v0[696]] + multiset{v135}) !! v136;
					var v137: array<bool> := new bool[4];
					v137[781] := cf24;
					var v138 := DC40(cf24, cf24);
					v137[781] := (v138 in [v138]) <==> cf24;
					globalState.f1 := p0;
					var v139: multiset<seq<int>> := multiset{v2, v2, [v0[696], p0]};
					globalState.f1 := |v139| / p0;
					r2 := if (!!v1) then p0 - v0[696] else v0[696] % 0x1c8;
				} else {
					globalState.f13 := fm26(v0[696], globalState);
					v130 := v130;
					var v140: multiset<int> := multiset{|v132|};
					cf24 := v140 > v140[|v131| := -p0];
					r2 := v0[696];
				...
				globalState.f24 := v0[696] / (|{v147.(cf104 := false, cf103 := v1), v147}| * p0);
			case DC16(cf21) =>
				if (v1) {
					var v148: map<int, bool> := map[v0[696] := v1];
					var v149 := DC26(v148);
					var v150 := DC29(v149);
					var v151: seq<D10> := [v150, v150, v150, v150, v150];
					var v152 := DC53(DC50(v151));
					var v153 := DC53(v152);
					var v154: array<D20> := new D20[15] [v153, v153, v153, v153, v153, fm79(v0[696], v1, fm3(v1, v1, p0, globalState), p0, globalState), v153, DC53(v152).(cf78 := v152), v153, v153, DC53(v152), v153, v153, v153, v153];
					v154[790] := v153;
					v154[790] := v153;
					var v155: seq<bool> := [v1, v1, v1];
					var v156: map<int, seq<bool>> := map[-v0[696] := v155[|"neaexvxqb"| := v1]];
					v156 := v156[p0 / v0[696] := v155 + fm62(globalState)];
					globalState.f24 := p0 + v0[696];
					var v157 := "hidqd";
					v157 := v157;
					...
					var v164: map<string, array<T1>> := map[v160 + v160[v0[696] := 'o'] := v163];
					v164 := v164;
				...
				match (v100) {
					...
					case DC18(cf23) =>
						...
						v173 := v173;
						var v174 := v173.m5(v0[696], globalState);
						v0[696] := p0;
						var v175 := "mloh";
						var v176: multiset<bool> := multiset{cf23};
						var v177: map<int, bool> := map[if (cf23 in v176) then v176[cf23] else v0[696] := v174];
						var v178: map<bool, int> := map[if (p0 in v177) then v177[p0] else false := v0[696]];
						globalState.f24 := |(v175 + fm51(if (v1 in v178) then v178[v1] else v0[696], p0, globalState))|;
					case DC19(cf24, cf25) =>
						globalState.f13 := false;
						v0[696] := 0x25c;
						globalState.f27 := cf24;
						var v179 := DC64(-654, p0, cf24, -p0, v0[696]);
						globalState.f22 := if (-|map[v99 := v0[696]]| <= p0) then |map[cf24 := !cf24]| == p0 else (v179.(cf96 := v0[696], cf93 := p0, cf97 := p0)).cf97 >= fm27(-v0[696], v99, v0[696], globalState);
					case DC16(cf21) =>
						var v180: array<multiset<int>> := new multiset<int>[9];
						v180 := v180;
						var v181: seq<bool> := [v1];
						v0[696] := p0 - |(v181 + v181)|;
						globalState.f24, globalState.f24, globalState.f22, globalState.f17 := 0x34e, --0x7a, v1, seq(382, i12  => (p0 % |"jhtsfluwm"|));
						r2 := -v0[696];
				}
		...
		var v183 := DC12(v182);
		r0 := v183.cf17;
		var v184: C5 := new C5(false, fm42(p0, v0[696], globalState), v1, v1);
	...
	method m2(globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: int) {
		...
		v6[508] := v4[|(if (true in v10) then v10[true] else v9)|];
		var v11 := 'd';
		v6[508] := if (!v7) then v11 else v11;
		var v12: set<bool> := {!v7};
		if (v12 == {v7, fm26(v1, globalState), false}) {
			...
			if (if (v7) then fm0(false, fm51(|v14|, v1, globalState), globalState) else v7) {
				var v15: T1 := new C3(v7, !!v2[0x2b], v7 ==> false, fm27(|v4|, v11, v1, globalState));
				v15 := v15;
				globalState.f27 := v7;
				var v16: C9 := new C9(v7, v7);
				var v17: seq<C9> := [v16, v16];
				var v18: map<int, bool> := map[v1 := v7];
				var v19: array<C9> := new C9[18] [v16, v16, v16, v16, v17[v1], v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, if (if (v1 in v18) then v18[v1] else fm29(v13, fm27(-v1, v11, v1, globalState), globalState)) then v16 else v16, if (v7) then v16 else v17[v1]];
				v19 := v19;
				...
				v21[700] := v22;
				v21[700] := if (v7) then v22 + v22 else map[v7 := v1];
				...
				v23 := v23[v24 + map[v7 := v7] := v25[v1] + v14];
				var v26: array<bool> := new bool[16];
				v26[387] := v22 == v21[700][v7 := -0x99];
				v26[958] := v7;
				var v27: C2 := new C2();
				v26[387], v26[958], v4, v27 := !(-0x1e5 == fm12(v1, v7, globalState)), v7, v4, v27;
				globalState.f24 := v1;
				v5[198] := v1;
				v5[198] := v1;
			}
			...
			match (v29) {
				case DC32() =>
					v2 := [v7];
					var v30: map<char, int> := map[v6[508] := v1];
					v30 := v30[v6[508] := v1];
					r2 := v1 < v1;
					var v31: seq<array<int>> := [v0[7]];
					var v32 := new C11(v31[v1 := v5], !v7 <==> v7, if (v7) then v7 else v7);
				case DC31(cf48) =>
					globalState.f24 := -v1;
				...
				case DC33(cf49) =>
					globalState.f22 := v7;
					var v35: map<string, bool> := map[seq(0x65, i0  => (v11)) := v7];
					var v36 := DC43(v35);
					v36 := v36;
					r2 := v7;
					var v37 := new C0();
			...
			v38[787] := fm18(fm8(globalState), v1, v1, globalState) <==> v7;
			v38[787] := v7;
			...
			v5[461] := v1;
			v5[461], v2 := --479, fm62(globalState);
			globalState.f23 := if (v7) then v11 else v6[508];
			if (fm26(-0x29c, globalState)) {
				globalState.f1 := 0x344;
				var v48: map<bool, int> := map[v7 := |v2[v1 := v7]|];
				var v49: map<bool, int> := map[v9 <= v9 := if (v7 in v48) then v48[v7] else v5[461]];
				var v50: array<bool> := new bool[25](i2 => v7);
				v50[155] := v7;
				var v51: map<C9, bool> := map[v47 := v7];
				v50[643] := if (v47 in v51) then v51[v47] else v7;
				...
				v48, v50[155], v50[643], r2 := (if (v7) then v49 else map[v7 := v5[461]]) + v52[v5[461]], v11 in (v4 + v4), v6[508] in (if (v53.cf37 in v54) then v54[v53.cf37] else v4), if (false in v55) then v55[false] else v7;
				var v56: map<int, bool> := map[v5[461] / --v1 := !v50[155]];
				v56 := v56[|v12| + v5[461] := v7];
				globalState.f21 := v7;
				var v57 := DC45(v55, v7);
				var v58: array<D17> := new D17[15] [v57, v57, v57, v57, DC45(v55, v50[155]), v57, v57, v57, DC45(v55, v50[155]), v57, v57, v57, DC45(map[v50[155] := v7], v50[155]), v57, v57];
				var v59 := DC58(v58);
				var v60: map<D22, bool> := map[v59 := v7];
				v60 := v60[v59 := v7];
			} else {
				var v61 := DC38(v7, v1, v5[461]);
				...
				var v67: seq<multiset<array<bool>>> := [v65[v64 := |v66|], v65, v65];
				var v68 := DC71(v65);
				var v69: array<multiset<array<bool>>> := new multiset<array<bool>>[21] [v65, multiset{v64, v64} * v65[v64 := v1], v65, v65, v65, v65, multiset{v64}, v65, v65 - v65, if (v7) then (multiset{v64})[v64 := v5[461]] else v65, multiset{v64, v64}, v65 * v65, v65, v67[v62.f32], v65[v64 := v5[461]], v65, multiset{v64}, v68.cf110, v65, v65, v65 - v65];
				v69[452] := v65 * v65;
				v69[452] := v65 - v65;
				var v70: set<array<bool>> := {v64, v64};
				var v71: seq<set<array<bool>>> := [v70, {v64, v64}, v70, v70, v70];
				globalState.f23, v5[461] := v6[508], -fm25(v62.f32, |v71[v5[461]]|, globalState);
				v11 := v11;
		...
		forall i3 | 0 <= i3 < v0[7].Length {
			v0[7][i3] := i3 % (if (v7) then v1 else |v9|);
		}
		var v73: seq<array<int>> := [v5];
		var v74 := DC74(v73);
		var v75: T0 := new C11((v73 + v74.cf115)[346 := v0[7]], v1 != v1, v7);
		...
		r3 := 0x28c + ((if (v75.f28 in v77) then v77[v75.f28] else -0x53) % |(if (v1 in v79) then v79[v1] else v78)|);
	}
}
...
method Main() {
	...
	for i0 := v7 to -0xa6 {
		...
		v0[317] := v7;
		v0[317] := if (v1) then v7 else -0x14a % -i0;
		globalState.f1 := v0[317];
		var v12: map<bool, int> := map[false := v7];
		v12 := v12[v1 := v0[317]];
	}
	if ((v7 != v7) <==> v1) {
		globalState.f26, globalState.f24 := (if (v1) then v6 else v6) * (v6 * v6), 0x3e7;
		var v13 := new C6(v4, (seq(169, i1  => (seq(617, i2  => ('t'))))) + (seq(582, i3  => (seq(0x2f8, i4  => ('i'))))), v1, v1);
		var v14 := 'd';
		globalState.f23 := v14;
		...
		var v21: array<T0> := new T0[15] [v18, DC20(v18).cf26, v18, v18, v18, v18, v18, v19.cf26, v18, v20[0x1cd], v18, v18, v18, v18, v18];
		v17[605] := v21;
		var v22: multiset<int> := multiset{fm25(-v7, v7, globalState)};
		v15[708], globalState.f13, v17[605], v22 := v16, !v18.f29, v21, v22;
		...
		var v27: seq<set<int>> := [v26[0x328], v25];
	...
	if (v1) {
		...
		var v32: set<seq<int>> := {seq(-0x16f, i6  => (|"dek"|)), if (v1 in v31) then v31[v1] else v8};
		globalState.f1 := |v32| / 125;
		...
		match (v36) {
			case DC32() =>
				...
				var v38: C7 := new C7(v5[|v9|], !fm10(fm38(globalState), v7, v1, globalState));
				v38 := new C7(v1, v1);
				var v39: C0 := new C0();
				var v40 := 'n';
				var v41: map<int, char> := map[|v37| := v40];
				var v42: array<char> := new char[14] ['c', v40, v40, 'b', v40, v34[v7], v40, if (v7 in v41) then v41[v7] else v40, 'k', v40, v34[fm12(v7, v1, globalState)], v40, v40, 'c'];
				v42[851] := v40;
				var v43: seq<D12> := [v36, v36];
				var v44: map<seq<D12>, bool> := map[if (v1) then v43 else seq(477, i7  => (v36)) := v1];
				v39, globalState.f22, v42[851], globalState.f27, v5 := v39, v1, v40, if (v43 in v44) then v44[v43] else v5[if (v7 in v37) then v37[v7] else fm12(|v34|, v1, globalState)], (v5 + v5) + (v5 + v5);
			case DC31(cf48) =>
				cf48 := v35;
				v0[241] := 0x243;
				var v45 := 's';
				var v46: map<array<bool>, map<bool, bool>> := map[v2 := v33];
				globalState.f23, v2, v0[241], globalState.f24, v1 := v45, v2, --v8[v7], v7 * |v34|, v5[|v46|];
				globalState.f1 := v7;
				globalState.f1 := -(|v34| + 0x68) % (if (v1) then v0[241] else v0[241]);
			case DC33(cf49) =>
		...
		v7 := fm27(v7, v54, v7, globalState) / |v55|;
		v2[747] := v1 && v1;
		v2[747] := v1 <==> v1;
		var v56: C8 := new C8();
		v56 := v56;
		...
		var v59 := DC8(seq(-0x22, i8  => (v54)));
		v58 := map[v7 := v59];
	}
	
	if (if (true) then false else v5[v7 := v1] < v5) {
		if (!v1) {
			var v60 := "nnhiys";
			v60 := v60;
			...
			v65[445] := [v67[v7]];
			v65[445], globalState.f24 := v67 + v67, v7;
			...
			v68[744], globalState.f13 := if (v1) then v69 else v69, v70 == (if (!v69.f29) then v70 else if (v69.f29 in v71) then v71[v69.f29] else map[v69.f28 := v7]);
		} else {
			var v72: array<char> := new char[18];
			v72[292] := (fm80(v1, globalState)).cf7;
			var v73 := "r";
			var v74: map<string, bool> := map[v73 := v1];
			var v75: map<bool, bool> := map[v1 := v1];
			v2[56] := if (v73 in v74) then v74[v73] else fm10(v1, v7, if (v1 in v75) then v75[v1] else false, globalState);
			v4[104] := v2;
			var v76 := 'q';
			v72[292], v2[56], v4[104] := v76, v1, v2;
			v7 := v7 / v7;
			globalState.f27 := v1;
			var v77: seq<array<int>> := [v0];
			var v78: T0 := new C11(v77, v2[56], v1);
			var v79 := DC20(v78);
			globalState.f1 := (if (v2[56]) then v7 else v7) + (DC24(v76, v2[56], 0x119, v79, v78.f29).cf31 - 0x15b);
		...
		globalState.f24 := v83.cf85 % v7;
		var v84: seq<array<int>> := [v0];
		var v85: multiset<int> := multiset{|v84[v7 := v0]|};
		var v86: map<int, int> := map[|v8[v7 := v7]| := |v85|];
	...
	v97 := v97 + (map v98 : int | (-394 <= v98) && (v98 < 0x312) :: (v98 % v7) := (v1));
	var i9 := 0;
	while (!v1)
		decreases 100 - i9
	{
		...
		v101[669] := v99;
		v101[669] := (v99 - v99) - v99;
		var v102: T2 := new C3(v1, v1, v5[v7], v7);
		...
		v7, globalState.f21, v107 := if (true ==> v106.f28) then |v5| else if (v1 in v108) then v108[v1] else if (v103 in v109) then v109[v103] else v102.f39, v7 <= (|"ncwjvnjw"| * v7), if (v106.f28) then v107[v7 := v106] + v107 else v107;
		...
		v114, v115, v1, globalState.f1 := v114, fm81(v106.f28, v102.f39 / v7, globalState), v116 != (v116 - multiset{v102.f39}), v102.fm30(if (12 in v120) then v120[12] else {v7}, globalState);
	}
	if (v1) {
		var v121: map<set<bool>, bool> := map[v6 := v1];
		var v122: map<bool, int> := map[if (v6 in v121) then v121[v6] else v1 := if (v1) then v7 else -v7];
		v122 := v122[-v7 != v7 := -v7];
		globalState.f22 := v5[v7];
		v2[817] := v1;
		v2[817] := fm10(v1, v8[411], v1 <==> v1, globalState);
		var v123: multiset<seq<bool>> := multiset{v5};
		var v124 := DC37(v123);
		globalState.f1 := |v124.cf52|;
		var v125: array<array<seq<int>>> := new array<seq<int>>[2];
		var v126 := "reijvxd";
		var v127: array<seq<int>> := new seq<int>[5] [DC60(|v126|, v1, v2[817], [|v5|, v7]).cf89, v8, seq(0x44, i10  => (v7)), v8, seq(0x1c7, i11  => (v7))];
		v125[554] := v127;
		v125[554] := v127;
	} else {
		globalState.f1 := v7 / |v6|;
		var v128 := "njytyjmu";
		...
		if ((v7 % v7) >= v7) {
			...
			globalState.f22 := fm10(if (v131.cf8) then fm29(v132, v7, globalState) else v5[v7], |v6| + v7, v1, globalState);
			var v133 := new C12();
			var v134 := 'n';
			...
			var v138 := DC2(v8[v7], v7, v128, !v1);
			var v139: set<D1> := {DC2(fm27(v7, v134, |v137|, globalState), v7, "x", false), v138, v138, v138, v138};
			v136[326], globalState.f24, globalState.f24 := v135, |v139|, v7;
			var v140: seq<string> := [v128];
			var v141: map<string, bool> := map[v140[v7] := v135.f29];
			var v142 := DC43(v141);
	...
	for i12 := v150.cf94 to if (v1 in v151) then v151[v1] else v7 {
		...
		var v155 := DC43(if (v1) then v153 else v154[v7]);
		var v156: C8 := new C8();
		...
		var v162 := 'u';
		v155, v156, v158[150], globalState.f21, globalState.f23 := v155, v156, v157, |(if (v1) then v161 else map[v160 := v1])| >= v7, if (v1) then if (v1) then v162 else v162 else fm42(0x1d, i12, globalState);
		v151 := v151[v1 := i12];
		v0 := new int[19];
	}
		...
		case DC11(cf16) =>
			...
			match (v178) {
				case DC55(cf80) =>
					...
					var v186: seq<seq<D30>> := [[v184, v184], seq(835, i13  => (DC83(v176.f40))), v185];
					var v187: multiset<seq<D30>> := multiset{v186[v7], v185};
					globalState.f24, v7, v182, v183 := v7, -(if (v187 != v187) then v180.f32 * v180.f32 else |(v5 + v5)|), v182, fm20(v1, globalState);
					var v188 := DC2(v7, v180.f32, seq(736, i14  => ('h')), v176.f40);
				...
				case DC56() =>
					...
					var v198 := new C3(!v176.f40, v176.f40, v176.f40, v8[0xfd]);
					...
					var v204 := 'f';
					var v205, v206, v207, v208 := v176.m18(v204, seq(-0x2ef, i15  => (v204)), globalState);
				case DC54(cf79) =>
					...
					var v214 := "wc";
					globalState.f1 := v7 % (|v213[v7 := v212]| / |v214|);
				case DC57(cf81) =>
					var v215 := 'q';
					var v216 := "jwyssicy";
					...
					v221[894] := v164 * {|v216|};
					v221[894] := (if (false) then v164 else v164) - v164;
			...
			if (v1) {
				...
				v2[112] := fm29(multiset(v226), v7, globalState);
				v225, v2[112] := v225, v176.f40;
			} else {
				globalState.f24 := v7;
				v0[999] := v7;
				...
				globalState.f22, v0[999], v227, globalState.f24 := v7 == (v7 - v7), -0x1ae + (if ((seq(-0x1fe, i17  => ('y'))) in v229) then v229[seq(-0x1fe, i17  => ('y'))] else v7), v227, |((v228 + v228)[v7 := fm42(|v231|, v7, globalState)] + v228)|;
				var v232 := new C0();
				v0[999] := |multiset(v8)| - 94;
				globalState.f17 := (seq(0x2ac, i18  => (v7))) + v8;
			}
	...
	if (true) {
		...
		var v235 := DC49(v8);
		var v236 := "aqtenen";
		v234 := v234[v235 := if (v5[|v236[v7 := v233]|]) then v2 else v2];
		...
		if (!((if (v1) then !v1 else !fm29(v246, v7, globalState)) <==> v1)) {
			...
			v2[299] := v247 !! v247;
			var v248: multiset<bool> := multiset{v2[299]};
			v2[299] := !((v248 - v248) > multiset(v5 + [v2[299], v2[299]]));
		} else {
			v0 := v0;
			...
			var v252: map<int, multiset<int>> := map[|map[v1 := v1]| := v166[v7 := |v240|]];
		...
		if ((multiset([v7]) * v165) > v165) {
			...
			var v258: array<char> := new char[26] [v257.cf29, 'b', v233, v233, fm42(v7, v7, globalState), v233, v233, v233, v233, v233, v233, v233, v233, v233, v233, v233, v233, v233, v233, if (v255.f29) then v233 else v233, v233, v236[v7], v233, v233, v233, v233];
			v0[764] := v7 / v7;
			var v259: map<map<int, int>, char> := map[v237 := fm42(v7, v7, globalState)];
			v258, globalState.f24, globalState.f1, v0[764], v259 := v258, (v7 * v7) * v7, (v7 % |v236|) - v7, |v8| - v150.cf96, v259;
			globalState.f27 := v1 ==> v255.f28;
			var v260: multiset<bool> := multiset{false};
			var v261: T2 := new C3(v255.f29, v255.f29, v255.f28, v0[764]);
			...
			v264 := v264;
			var v265 := new C3(v1, v1, v1, if (!v1) then v0[656] else -v7);
			globalState.f17 := v8;
			v8 := v8 + (v8 + v8);
		}
		...
		globalState.f13 := v1;
		var v266: seq<seq<bool>> := [v5[v7 := v1]];
		var v267: map<bool, set<bool>> := map[fm29(multiset{fm62(globalState), v266[v7], v5}, v7, globalState) := v6];
	...
	var v269 := new C9(v1, v5[if (v7 in v166) then v166[v7] else v7]);
	var v270 := "y";
	var v271 := DC2(0x3f, v7, v270, v1);
	var v273 := DC16(multiset{v271, v271, v271, v271, fm85(v1, map v272 : int | (0x5f <= v272) && (v272 < 0x392) :: (v272 + |(seq(785, i19  => ('i')))|) := (v7), globalState)} * multiset{v271, v271, DC2(v7, v7, v270, v1), v271, v271});
	match (v273) {
		case DC17(cf22) =>
			var v274, v275 := v163.m4(globalState);
			var v276 := 'x';
			var v277: seq<seq<char>> := [v270, v270, v270, v270, [v276, v276, v276]];
			if (v277 < (seq(0x203, i20  => (v270)))) {
		...
		case DC18(cf23) =>
			...
			var v291: array<array<int>> := new array<int>[14] [v0, v0, v0, v290[-v7], v0, v0, v0, v0, v0, if (v1) then v0 else v0, v0, v0, v0, v0];
			v291[227] := v0;
			v291[227] := v0;
			var v292 := 'v';
		...
		case DC19(cf24, cf25) =>
			if (cf24) {
				...
				globalState.f24 := |((v270 + (seq(0x355, i22  => ('o')))) + v270)|;
		...
		case DC16(cf21) =>
			...
			match (v322) {
				case DC5(cf8) =>
					...
					globalState.f1 := (if (v319.f35) then v7 else |v270|) % (v7 - 291);
					v8 := v8 + fm19(-v7, cf8, v319.f35, v1, globalState);
					v323.m13(if (fm26(|v164|, globalState)) then v319.f35 else v319.f35, v164, "pwgq" + (seq(0x23a, i23  => ('w'))), !cf8 ==> cf8, globalState);
				case DC4(cf7) =>
					v1 := v319.f35;
					globalState.f1 := v7;
				...
				case DC6(cf9) =>
					...
					v0[690] := v7;
					globalState.f1, globalState.f1, v0[690] := if (v5 != ([v1, v1])[v7 := v319.f35]) then v7 else 493, 0x26d, if (v319.f35) then if (v7 in v165) then v165[v7] else |"jdhhsof"| else v7;
					v0[690], v7, v319.f35 := v7, v0[690], v319.f35;
	...
	match (v338) {
		...
		case DC45(cf64, cf65) =>
			...
			v0[722] := v7 * -0x5;
			v2[91] := v1;
			var v344: seq<string> := [v270[v7 := v332]];
			globalState.f24, globalState.f24, v0[722], v2[91] := v7, v7, -(if (v269.fm11(true, v344, v7, globalState)) then -v7 else v7 / v7), v6 != v6;
			v0[722] := fm8(globalState);
			globalState.f1 := v8[--|v270|] + v7;
		case DC43(cf61) =>
			...
			var v354: array<T2> := new T2[28] [v350, v350, v350, v350, v350, v350, v350, v351[v7], v350, v350, v350, v350, v350, v352.cf138, v350, v350, v350, v350, v350, v350, v350, v350, v350, v350, v350, if (v1 in v353) then v353[v1] else v350, v350, v350];
			var v355: map<array<T2>, bool> := map[v354 := v1];
			var v356: C4 := new C4(v1, v5[v350.f39], v1, v1);
			v355 := v355[v354 := v5[|map[|v270| := v356]|]];
			globalState.f13, v270 := v356.f37, ((v270 + v270) + (v270 + "seiep"))[-v7 := v332];
			globalState.f21 := v350.f39 >= |(map[v356.f38 := v7] + v151)|;
		case DC46(cf66) =>
			var v357: seq<C7> := [v148];
			var v358: map<int, int> := map[-(-0xb5 * v7) := |v357|];
			globalState.f24 := if ((|("a")[v7 := v332]| + |v270|) in v358) then v358[|("a")[v7 := v332]| + |v270|] else v7;
			if (v7 < v7) {
				globalState.f21 := v5[if (v1) then --v7 else |v270[v7 := v332]|];
				var v359 := new C3(v1 <== fm26(v7, globalState), v1, v1, v7);
				globalState.f24 := 878;
				var v360 := v269.m5(v7, globalState);
				var v361 := DC5(v360);
				var v362: multiset<bool> := multiset{v359.f40, !v359.f40, v359.fm32(v6, if (v360 in v151) then v151[v360] else |v164|, v359.f40, globalState) && fm10(v1, |(seq(163, i24  => (multiset{v359.f40, v1, v359.f40, v360})))|, v359.f40, globalState), v361.cf8};
				var v364 := DC4(v332);
				var v365 := DC13(v364);
				...
				globalState.f27, v335, v362, globalState.f24 := 0xf6 != v7, map[fm13(globalState) := v1], fm57(v332, 0x27, v7, globalState), ---(v7 % |v368|);
			} else {
				var v369: map<seq<int>, char> := map[[v7] + (seq(631, i25  => (|v5|))) := 'p'];
				v0[616] := fm25(0x2fc, |v270|, globalState);
				var v370 := DC59(if (fm29(multiset{[v1, v1]}, 0x11d, globalState)) then v1 else !v1, v270 + v270, -v7);
				v369, v0[616], v370 := v369, v7, v370.(cf83 := !(if (fm12(v7, !false, globalState) in v97) then v97[fm12(v7, !false, globalState)] else v1));
				globalState.f1 := v0[616];
				var v371 := v148.m5(fm8(globalState), globalState);
				var v372: array<C3> := new C3[14];
				var v373 := DC54(v372);
				v373 := v373;
				v270 := (seq(16, i26  => (v332)))[v7 := v332] + ((seq(-0x24e, i27  => (v332))) + v270);
			}
