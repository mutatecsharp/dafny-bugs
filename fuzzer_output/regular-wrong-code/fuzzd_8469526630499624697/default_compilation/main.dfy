...
class C0 extends T1 {
	...
	function fm9(p0: int, p1: seq<bool>, globalState: GlobalState): int {
		|(map v0 : multiset<bool> | v0 in (seq(abs(0x2f7), i0  => (multiset{DC2(0x335, f6, seq(abs(755), i1  => (0x13e))).cf5, f6}))) :: (v0) := ([DC7(f7), DC7(f6)]))|
	}
}
...
class C1 extends T2 {
	...
	function fm2(globalState: GlobalState): seq<int> {
		match DC12(DC12(DC11(f9, f8, {f9}))) {
			...
			case DC10(cf19) => (seq(abs(-0x398), i0  => (f8))) + [0x219]
	...
	function fm20(p0: bool, globalState: GlobalState): D4 {
		DC13((seq(abs(0x27f), i0  => (DC5(f8)))) + [DC5(f8), DC5(f8), DC5(f8)])
	}
	method m1(p0: bool, p1: bool, p2: multiset<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: array<array<int>>) {
		var v0 := DC7(p1);
		...
		var v3: seq<int> := [-|v2|];
		var v4: seq<int> := [|v3|];
		var v5 := DC2(f8, v1[safeIndex(f8, |v1|)], v3);
		...
		var v12: array<int> := new int[9] [fm1(f6, v6, f6, globalState), f8, if (f6) then f8 else 0x1f, f8, |v1[safeIndex(531, |v1|) := f7]|, -(if (fm19(false, p0, v7, globalState)) then 0x251 else f8), f8, |v11[v10 := abs(f8)]|, f8];
		v12[safeIndex(696, v12.Length)] := f8 * f8;
		var v13: array<bool> := new bool[16];
		v13[safeIndex(378, v13.Length)] := if (p0) then f7 else p3;
		v12[safeIndex(696, v12.Length)], v13[safeIndex(378, v13.Length)], r1 := match fm21(f6, true, f9, p0, globalState).(cf6 := v4, cf5 := p3) {
			case DC0() => f8
			case DC1(cf0, cf1, cf2, cf3) => |f5|
			case DC2(cf4, cf5, cf6) => f8
		}, true, safeDivisionInt(f8, f8);
		v13[safeIndex(378, v13.Length)] := false;
		var v14 := new C0(!p3, p0, f4, if (v13[safeIndex(378, v13.Length)]) then f5 else f5);
		var v15: set<seq<char>> := {f5, f5};
		var v16: set<int> := {v12[safeIndex(696, v12.Length)], f8};
		var v17: map<set<seq<char>>, bool> := map[{f5, f5[safeIndex(|(seq(abs(0x29c), i0  => ('f')))[safeIndex(|f5|, |(seq(abs(0x29c), i0  => ('f')))|) := f4]|, |f5|) := f4], [f4], f5, f5} * v15 := v16 !! {f8, f8}];
		v17 := v17[v15 - {f5} := f7];
		var v18: set<array<bool>> := {v13, v13};
		v12[safeIndex(696, v12.Length)] := |v18|;
	...
	method m8(p0: bool, p1: bool, globalState: GlobalState) returns (r0: set<map<bool, bool>>, r1: array<bool>, r2: int, r3: array<bool>) {
			...
			decreases 100 - i1
		{
			...
			v2 := f5[safeIndex(safeModuloInt(-f8, f8), |f5|) := f4];
			var v3 := false;
			v3 := f6;
			globalState.f1 := 76;
			var v4 := DC10(v2);
		...
		var v11: array<seq<int>> := new seq<int>[23] [[f8], v7, v7, (v7 + v7)[safeIndex(f8, |(v7 + v7)|) := f8], v7, v7, (if (false) then if (p1 in v8) then v8[p1] else v10[safeIndex(|f5|, |v10|)] else v7)[safeIndex(-f8, |(if (false) then if (p1 in v8) then v8[p1] else v10[safeIndex(|f5|, |v10|)] else v7)|) := f8], [f8, f8, f8, f8, f8], v7, v7, v7, v7, [f8, f8, f8, f8], v7 + v7, v7, v7 + v7, v7, v7, fm2(globalState), v7, v7, v7, v7 + v7];
		var v12: seq<bool> := [v6];
		v11[safeIndex(491, v11.Length)] := fm2(globalState) + v7[safeIndex(v7[safeIndex(f8, |v7|)], |v7|) := |v12[safeIndex(|v7|, |v12|) := p1]|];
		var v13 := DC2(0x3d5, f7, v7);
		v11[safeIndex(491, v11.Length)] := v13.cf6;
		var v14: map<bool, string> := map[v6 := seq(abs(697), i2  => (f4))];
		...
		r0 := if (v6 in v14) then if (f6) then v17[safeIndex(f8, |v17|)] else fm22(globalState) else v16 * (set v19 : map<bool, bool> | v19 in v18 :: (v19));
...
class C2 {
	...
	method m6(globalState: GlobalState) returns (r0: int, r1: D1, r2: array<int>, r3: D1) {
			...
			decreases 100 - i0
		{
			...
			v0 := ("aetllib" + v0[safeIndex(fm8(|[v7]|, v1, v1, globalState), |v0|) := 'o']) + v0[safeIndex(|v13[safeIndex(v2, |v13|) := v15.cf5]|, |v0|) := v7];
		}
		if (true) {
			var v16 := false;
			var v17 := 'j';
			...
			var v25: array<seq<int>> := new seq<int>[4] [v23 + v23, v23, v23 + [v20, |v24|, v20, |multiset{v16, v16}|, 0x30e], v23[safeIndex(v20, |v23|) := v20]];
			v25 := v25;
		} else {
			var v26 := 0x28a;
			...
			if (!v29.cf5) {
				...
				v30[safeIndex(333, v30.Length)] := |v32| * v26;
				...
				v30[safeIndex(333, v30.Length)] := |v37|;
				f14[safeIndex(310, f14.Length)] := true;
				var v38: multiset<bool> := multiset{v27, v29.cf5, v27};
				f14[safeIndex(310, f14.Length)] := 0xb5 > (if (v27 in v38) then v38[v27] else v30[safeIndex(333, v30.Length)]);
				var v39 := 'h';
				var v40: C0 := new C0(f14[safeIndex(310, f14.Length)], if (v27) then v27 else f14[safeIndex(310, f14.Length)], v39, v0);
				v40 := v40;
				v27, v30[safeIndex(333, v30.Length)], f14[safeIndex(310, f14.Length)], v39 := f14[safeIndex(310, f14.Length)], v26, f14[safeIndex(310, f14.Length)], v39;
				r0 := v26;
			} else {
				var v41: set<bool> := {v27};
				var v42 := DC8(v26 + v26, v26);
				var v43: seq<bool> := [v27, v27, v27, false];
				var v44: multiset<int> := multiset{|(if (!v27) then v43 else v43)[safeIndex(|"ibbeoyt"|, |(if (!v27) then v43 else v43)|) := v27]|, |"vjhcwwr"|, v26};
				globalState.f1, v41, v42, v28, v43 := if (v26 in v44) then v44[v26] else -v26, v41 + v41, v42, seq(abs(0x0), i2  => (v26)), v43 + v43;
				var v45: array<char> := new char[15];
				v45 := v45;
				f14[safeIndex(550, f14.Length)] := v27;
				f14[safeIndex(550, f14.Length)] := v27;
				globalState.f1 := v26;
				var v46: set<int> := {v26, 0x29a};
				var v47: seq<set<int>> := [v46, {|v0|, fm8(0x2b0, v27, !v27, globalState)}];
				v27 := v47[safeIndex(v26, |v47|)] !! {|v44|};
			}
		...
		forall i3 | 0 <= i3 < v51.Length {
			v51[i3] := ([v50] + [v50]) == ([v50, v50, |{v50, v50}|, 0x96] + (seq(abs(0x18d), i4  => (v50))));
		}
		var v52: array<string> := new string[25];
		forall i5 | 0 <= i5 < v52.Length {
			v52[i5] := v0[safeIndex(v50, |v0|) := 'r'];
		}
		var v53 := false;
		if (if (v53) then v53 else v0 <= v0) {
			var v54: seq<bool> := [v53, v53];
			var v55: set<bool> := {v53, v54[safeIndex(|v54|, |v54|)]};
			v52[safeIndex(86, v52.Length)] := "ptockx";
			v55, v52[safeIndex(86, v52.Length)] := v55, v0;
			var v56: array<int> := new int[13];
			v56[safeIndex(760, v56.Length)] := v50 + |v52[safeIndex(86, v52.Length)]|;
			var v57: map<bool, int> := map[v53 := |v55|];
			v56[safeIndex(760, v56.Length)] := if (v53) then safeModuloInt(|v57|, v50) else v50 * v50;
			var v58: map<int, bool> := map[v56[safeIndex(760, v56.Length)] := !v53];
			var v59: seq<map<int, bool>> := [v58[v50 := v53]];
			var v60: seq<seq<map<int, bool>>> := [v59];
			var v61: seq<int> := [-869, v56[safeIndex(760, v56.Length)]];
			var v62 := 'n';
			v53, v56[safeIndex(760, v56.Length)], v59, v53, v56[safeIndex(760, v56.Length)] := v53, v56[safeIndex(760, v56.Length)], v60[safeIndex(|("jmbaqsn")[safeIndex(v61[safeIndex(576, |v61|)], |"jmbaqsn"|) := v62]|, |v60|)], v53, -0x1f6;
			var v63 := new C0(v53, if (v53) then v53 else false, 'c', v0 + v0);
			v62 := v62;
		} else {
			var v64: array<array<bool>> := new array<bool>[2] [v51, f14];
			v64[safeIndex(590, v64.Length)] := f14;
			v64[safeIndex(590, v64.Length)] := v51;
			var v65 := 'p';
		...
		var v73: seq<int> := [v50];
		var v74: array<int> := new int[16] [v50 - v50, v50, v50, |(map v70 : string | v70 in v72 :: (v70) := (v50))|, safeDivisionInt(v50, 0x2cf), v50, if (v53) then 0xe9 else v50, v50, v73[safeIndex(v50, |v73|)], v50, if (v53) then v50 else v50, |v0|, v50, v73[safeIndex(0x356, |v73|)], v50, |v0|];
		r2 := v74;
		r3 := v69.(cf7 := v68);
	}
	method m7(p0: D1, p1: map<set<int>, string>, p2: map<bool, D1>, globalState: GlobalState) returns (r0: int, r1: bool, r2: int) {
		...
		match (v2) {
			case DC0() =>
				if (v1 == v1) {
					...
					var v4: multiset<int> := multiset{v1, |v3|, safeModuloInt(v1, fm8(-0x15f, v0, v0, globalState))};
					v3 := v3;
					r2 := v1;
					var v5 := "vcmororjs";
					...
					r2 := safeModuloInt(v1, fm8(v1, v0, v0, globalState));
					var v7: array<int> := new int[2];
					v7 := new int[20](i0 => safeDivisionInt(i0, 696));
				...
				var v14: seq<bool> := [v0, v13[safeIndex(v1, |v13|)] in v13];
				v0 := v14[safeIndex(v1, |v14|)];
				globalState.f1 := v1;
			...
			case DC1(cf0, cf1, cf2, cf3) =>
				...
				v20[safeIndex(35, v20.Length)] := seq(abs(0x3c1), i1  => (v17));
				var v21 := "elp";
				v20[safeIndex(35, v20.Length)] := (v21 + v21) + v21;
				if (cf2) {
					var v22: C0 := new C0(cf0, v0, v17, seq(abs(0x318), i2  => (v17)));
					var v23 := DC7(cf2);
					var v24: map<C0, array<bool>> := map[v22 := f14];
					var v25: array<seq<bool>> := new seq<bool>[2];
					var v26: seq<bool> := [cf0];
					v25[safeIndex(410, v25.Length)] := v26;
					v22, v23, v24, v25[safeIndex(410, v25.Length)] := if (0x3c6 == v1) then v22 else v22, fm11(fm12(cf0, v21, cf2, globalState), cf2, -v1 - 810, v0, globalState), v24, v26[safeIndex(cf3, |v26|) := cf0];
					cf0 := v0;
					var v27: seq<int> := [cf1];
					var v28: map<bool, bool> := map[v0 := cf0];
					var v29: set<string> := {v20[safeIndex(35, v20.Length)]};
					var v30: array<int> := new int[21] [cf1, v27[safeIndex(cf3, |v27|)] + cf3, cf1, cf3, cf3, |v21|, v1, if (if (v0 in v28) then v28[v0] else cf0) then v1 else cf1, |v29|, cf1 * cf1, safeDivisionInt(cf3, cf3), cf1, if (cf2) then v1 else |v16|, cf1, cf3, cf1 - v1, -cf1, fm8(-cf1, v0, v0, globalState), |multiset{false}|, cf1, cf3];
					v30[safeIndex(193, v30.Length)] := cf3;
					var v31: multiset<char> := multiset{v17};
					var v32: map<char, bool> := map[v17 := cf2];
					r1, v0, v30[safeIndex(193, v30.Length)], r2 := fm7(v17, if (DC4('j', v1, v17, cf3, true).cf10 in v31) then v31[DC4('j', v1, v17, cf3, true).cf10] else 204, !(v1 > cf1), globalState), (|v32| + cf3) >= cf3, -v27[safeIndex(v1, |v27|)], cf3;
					v30[safeIndex(193, v30.Length)] := cf1;
					v1 := safeModuloInt(|(v20[safeIndex(35, v20.Length)] + v21)|, v1);
				} else {
					v20[safeIndex(35, v20.Length)] := v20[safeIndex(35, v20.Length)];
					r1 := v0;
					v21 := v21 + v21[safeIndex(|[cf3]|, |v21|) := v17];
					var v33: C0 := new C0(cf0, cf3 == fm8(cf3, cf2, !cf2, globalState), v17, v20[safeIndex(35, v20.Length)]);
		...
		if (v0 && v0) {
			...
			if (v0) {
				...
				var v50: seq<seq<D1>> := [v46 + [v45], if (v1 in v48) then v48[v1] else v46, v49[safeIndex(v1, |v49|)]];
				v50 := v49;
				var v51: array<int> := new int[23];
				v51[safeIndex(742, v51.Length)] := v1;
				var v52: map<char, bool> := map[v40 := v0];
				var v53: map<bool, bool> := map[v0 := v0];
				v51[safeIndex(742, v51.Length)], v52, v40, v0, globalState.f1 := v1, fm17(v1, globalState), 'j', (v1 - |v53|) == v1, v1;
			} else {
				r1 := v0;
			...
			match (v60) {
				case DC4(cf8, cf9, cf10, cf11, cf12) =>
					...
					var v68: array<int> := new int[22] [cf9, cf9, v1, v1, cf11, cf11, cf11, cf11, cf11, cf9, |v63[seq(abs(0x232), i3  => (cf10)) := cf12]|, cf9, -|v62|, v1, cf11, |v62|, v1, v1, |v65|, |v66|, cf11, |v67|];
					var v69: map<array<string>, array<int>> := map[v61 := v68];
					v69 := v69[v61 := v68];
					v68[safeIndex(349, v68.Length)] := v1;
					v68[safeIndex(349, v68.Length)] := v1;
					cf10 := cf10;
				...
				case DC5(cf13) =>
					...
					v71 := v71;
					var v72: map<int, array<bool>> := map[safeDivisionInt(cf13, cf13) := f14];
					...
					var v77: array<int> := new int[4](i4 => safeModuloInt(i4, -|(seq(abs(0xa9), i5  => (v40)))|));
			...
			var v87 := "jtb";
			var v88: multiset<seq<bool>> := multiset{v85, fm18(v1, if (v0 in v86) then v86[v0] else true, globalState), v85[safeIndex(|fm18(|v87|, v0, globalState)|, |v85|) := false], v85, v85};
			...
			var v96: seq<int> := [if (v1 in v94) then v94[v1] else v90.f8, safeModuloInt(v90.f8, v90.f8), safeModuloInt(v90.f8, |v95|), -v1, v90.f8];
			v96 := [safeModuloInt(v1, 977)];
			if (v90.f8 == v90.fm1(v0, map[v90.f7 := v90.f6], v0, globalState)) {
				r1 := v90.f9;
				var v97: seq<string> := [v90.f5, "nravm", "uqwbaqax"];
				var v98 := new C0(fm7(v90.f4, v90.f8, false, globalState), true, v90.f4, v97[safeIndex(276, |v97|)]);
				var v99 := DC4('n', v90.f8, v40, -v90.f8, v90.f9 ==> true);
				var v100: array<string> := new string[17];
				v100[safeIndex(343, v100.Length)] := v90.f5;
				var v101: map<int, bool> := map[v90.f8 := v90.f6];
				var v102: set<map<int, bool>> := {v101};
				v0, v1, v99, v100[safeIndex(343, v100.Length)], globalState.f1 := fm7(v40, |{v90.f8, v90.f8, |v102|}|, v0, globalState) ==> v90.f7, v1, p0.(cf11 := v90.f8, cf10 := v90.f4, cf8 := v90.f4, cf9 := v1), v87 + (v87[safeIndex(--v90.f8, |v87|) := v40] + "agc"), -|(v85 + [true, v90.f9])|;
				var v103 := new C0(v90.f9, v90.f9, v90.f4, v90.f5);
				globalState.f1 := v90.f8;
			} else {
				v93[safeIndex(634, v93.Length)] := true !in map[v90.f7 := v90.f8];
				...
				v104[safeIndex(842, v104.Length)] := v106;
				var v107: multiset<string> := multiset{"sd", v90.f5};
				v93[safeIndex(634, v93.Length)], v0, v104[safeIndex(842, v104.Length)] := !!(v107 !! v107), v90.f9, v106;
				r1 := !v90.f6;
			...
			decreases 100 - i6
		{
			...
			f14[safeIndex(975, f14.Length)] := !v0;
			f14[safeIndex(975, f14.Length)] := v0;
			var v112: map<bool, bool> := map[true := f14[safeIndex(975, f14.Length)]];
			var v113 := new C1(873, if (f14[safeIndex(975, f14.Length)]) then !(if (v0 in v112) then v112[v0] else v0) else v0, v0, f14[safeIndex(975, f14.Length)], v40, v110);
		}
		r0 := v1;
		r1 := v0;
		r2 := v1;
...
class C3 extends T2 {
	...
	function fm2(globalState: GlobalState): seq<int> {
		(seq(abs(0x22f), i0  => (|(seq(abs(329), i1  => (f8)))|))) + DC2(f8, !true, seq(abs(951), i2  => (f8))).cf6
	}
	...
	method m1(p0: bool, p1: bool, p2: multiset<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: array<array<int>>) {
		...
		var v5: array<seq<bool>> := new seq<bool>[16] [v3, [p0], [false, p3, f9], v3, v3, v4[safeIndex(f8, |v4|)], [f7], v3, v3, v3, v3, v3, v3, v3, v3, v3];
		var v6 := DC3(v5);
		...
		v9[safeIndex(912, v9.Length)] := -f8;
		var v10: multiset<int> := multiset{|p2|};
		var v11: map<bool, multiset<int>> := map[f12 := v10];
		var v12: multiset<multiset<int>> := multiset{if (f6 in v11) then v11[f6] else v10[f8 := abs(f8)], v10};
		v9[safeIndex(912, v9.Length)] := -(if (true) then f8 + f8 else |v12|);
		f12 := f9;
		for i1 := v9[safeIndex(912, v9.Length)] to |multiset{p1}| {
			var v13 := new C0(p3, f13, f4, f5);
			v10 := multiset{490, v9[safeIndex(912, v9.Length)]} * v10;
			r0 := i1;
			f12 := p1;
		}
		var v14: set<int> := {v9[safeIndex(912, v9.Length)], f8};
		r0 := (362 * -|v14|) + -0x1a3;
		var v15: map<bool, int> := map[p1 := f8];
		r1 := if (!(f5 <= "n")) then |f5| else safeModuloInt(v9[safeIndex(912, v9.Length)], if (p0 in v15) then v15[p0] else |map[f6 := 0x2c0]|);
		var v16: seq<array<int>> := [v9, v9];
		var v17: array<array<int>> := new array<int>[20] [v9, v9, v16[safeIndex(v9[safeIndex(912, v9.Length)], |v16|)], v16[safeIndex(v9[safeIndex(912, v9.Length)], |v16|)], v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, if (f9) then v9 else v9, v9, v9, v9];
		r2 := v17;
	}
	method m5(p0: bool, p1: map<bool, bool>, p2: array<bool>, p3: char, globalState: GlobalState) returns (r0: array<int>) {
		...
		v0 := v0[f8 := safeModuloInt(-f8, f8)];
		p2[safeIndex(570, p2.Length)] := p0;
		var v1: array<string> := new string[2];
		v1[safeIndex(685, v1.Length)] := f5 + f5;
		globalState.f1, p2[safeIndex(570, p2.Length)], v1[safeIndex(685, v1.Length)] := f8, p0, f5;
		var v2: seq<int> := [f8, f8];
		var v3: seq<bool> := [f6 <== !p0, v2[safeIndex(0x65, |v2|) := f8] < v2, f13];
		p2[safeIndex(570, p2.Length)] := v3[safeIndex(f8, |v3|)];
		for i0 := f8 to f8 + f8 {
			v3 := v3;
			...
			v4[safeIndex(534, v4.Length)] := v7;
			v4[safeIndex(534, v4.Length)] := v7;
			globalState.f1 := |f5[safeIndex(if (true) then f8 else |v1[safeIndex(685, v1.Length)]|, |f5|) := p3]|;
			...
			if (!v10.cf20) {
				...
				v11[safeIndex(601, v11.Length)] := v12;
				v11[safeIndex(601, v11.Length)] := v12;
				...
				globalState.f1 := |(if ((if (v14 in v15) then v15[v14] else f8) in v13) then v13[if (v14 in v15) then v15[v14] else f8] else seq(abs(0x123), i1  => (f4)))|;
				v14[safeIndex(220, v14.Length)] := safeDivisionInt(v10.cf21, fm8(|f5|, f9, true, globalState));
				...
				globalState.f1, v14[safeIndex(220, v14.Length)], v18, globalState.f1, v1[safeIndex(685, v1.Length)] := f8, f8, v18 + (v18 + v18), -(v2[safeIndex(|v1[safeIndex(685, v1.Length)]|, |v2|)] + i0), (v1[safeIndex(685, v1.Length)] + f5)[safeIndex(i0, |(v1[safeIndex(685, v1.Length)] + f5)|) := p3];
				var v19: map<int, char> := map[i0 := p3];
				v19 := v19[-0x1ee := if (p0) then f4 else p3];
				p2[safeIndex(570, p2.Length)] := false;
				globalState.f1 := -f8 * v14[safeIndex(220, v14.Length)];
			}
			
		}
		var v20: array<int> := new int[26];
		v20[safeIndex(470, v20.Length)] := f8;
		...
		v1[safeIndex(685, v1.Length)], p2[safeIndex(570, p2.Length)], v20[safeIndex(470, v20.Length)], v21 := if (v23.cf1 == f8) then "a" + "dbviiq" else f5, f13, safeModuloInt(f8, safeModuloInt(f8, f8)), v21;
		var v24: T2 := new C1(if (f8 in v0) then v0[f8] else 0x1bc, f13, true, f6, f4, v1[safeIndex(685, v1.Length)]);
		var v25: map<bool, T2> := map[p2[safeIndex(570, p2.Length)] := v24];
		var v26: array<map<bool, T2>> := new map<bool, T2>[14] [v25, map[f12 := v24], map[v24.f6 := v24], v25, v25, v25, v25, v25, v25, map[v24.f7 := v24], v25[f9 := v24], v25, v25, v25[p2[safeIndex(570, p2.Length)] := v24]];
		var v27: map<array<map<bool, T2>>, bool> := map[v26 := v3[safeIndex(f8, |v3|)]];
...
class C4 extends T2, T0, T3 {
	...
	method m1(p0: bool, p1: bool, p2: multiset<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: array<array<int>>) {
		...
		for i0 := f8 + f8 to f8 {
			...
			v9[safeIndex(900, v9.Length)] := v13;
			v9[safeIndex(900, v9.Length)] := v13[-0x37e := v12];
			var v14: array<array<int>> := new array<int>[5];
			var v15: array<int> := new int[6] [f8, i0, f8, 0x2cc, i0, f8];
			v14[safeIndex(244, v14.Length)] := v15;
			v14[safeIndex(244, v14.Length)], v15 := v15, v15;
			globalState.f1 := if (f6) then i0 else i0;
		}
		v1 := (v1 * v1[0x5e := abs(f8)]) - v1;
		f4 := f4;
		r0 := f8;
		r0 := f8;
		r1 := f8;
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: map<int, int>) {
		...
		if ((v0 - multiset{f9}) !! multiset(v1)) {
			...
			v3[safeIndex(688, v3.Length)] := -|(if (v6 in v7) then v7[v6] else v8)|;
			v3[safeIndex(688, v3.Length)], globalState.f1, v2 := -f8, f8, !(if (-p0 < p0) then v2 else f9);
			var v9 := new C1(safeModuloInt(v3[safeIndex(688, v3.Length)], f8), v2, v2, f7, f4, f5);
			f4 := f4;
		} else {
			var v10 := false;
			...
			match (v13) {
				case DC13(cf24) =>
					...
					v10 := (f8 + v17.cf11) < safeModuloInt(f8, p0);
					var v18 := "euaygar";
					var v19: array<multiset<string>> := new multiset<string>[5];
					v19[safeIndex(227, v19.Length)] := multiset{"pas"};
					var v20: array<bool> := new bool[4];
					var v21: array<array<bool>> := new array<bool>[18] [v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, if (fm27(p0, false, fm27(p0, v1[safeIndex(0x27b, |v1|)], f6, globalState), globalState)) then v20 else v20, v20];
					v21[safeIndex(0, v21.Length)] := v20;
					var v22: set<bool> := {f7, f7};
					var v23 := DC11(f7, p0, v22);
					v10, v18, v19[safeIndex(227, v19.Length)], v21[safeIndex(0, v21.Length)] := false <==> f9, "wxeov" + fm28(|v14|, v10, v1, DC11(false, f8, v22), globalState), multiset{fm28(f8, f9, v1, v23, globalState) + "nservh"}, v20;
					...
					var v28 := new C3(false, v10, -|v27|, f7, f7, f7, f4, seq(abs(0x291), i0  => (f4)));
			}
			...
			v32[safeIndex(971, v32.Length)] := -p0;
			v32[safeIndex(971, v32.Length)] := -p0;
			v32[safeIndex(971, v32.Length)] := f8;
		}
		
		for i2 := -f8 to safeDivisionInt(-p0, p0) {
			m0(globalState);
			var v33 := "mm";
			v33 := v33[safeIndex(safeModuloInt(p0, p0), |v33|) := f4];
			...
			v38 := v39[safeIndex(safeModuloInt(p0, p0), |v39|)];
			if (f7) {
				...
				v41 := v41[(map[|v0| := p0])[-i2 := |v42[!f7 := f7]|] := i2 - v43[safeIndex(p0, |v43|)]];
				var v44 := true;
				var v45: set<bool> := {f7};
				var v46 := DC11(false, p0, v45);
				var v47: multiset<int> := multiset{-safeModuloInt(|v43|, 0x286)};
				...
				v38.f14[safeIndex(59, v38.f14.Length)] := p0 == i2;
				var v53 := DC4(f4, i2, f4, p0, f6);
				var v54: set<D1> := {v53};
				v38.f14[safeIndex(59, v38.f14.Length)] := v54 != v54;
				v38.f14[safeIndex(59, v38.f14.Length)] := f4 in (if (!v52) then f5 else f5);
				var v55: C0 := new C0(v38.f14[safeIndex(59, v38.f14.Length)], v38.f14[safeIndex(59, v38.f14.Length)], f4, f5);
				var v56: map<C0, char> := map[v55 := 'm'];
				globalState.f1 := safeModuloInt(f8, |(v56 + v56)|);
				var v57: map<int, bool> := map[f8 := v52];
				var v58 := new C3(f8 in [p0], if (i2 in v57) then v57[i2] else f6, -(p0 - f8), f7, f7, f7, f4, seq(abs(665), i3  => ('t')));
			}
			
		}
		var v59: array<D6> := new D6[19];
		var v60 := DC17(f5, f5);
		v59[safeIndex(553, v59.Length)] := if (f7) then v60 else DC17(f5, f5);
		var v61: map<int, seq<bool>> := map[-p0 := v1[safeIndex(p0, |v1|) := f9]];
		globalState.f1, v59[safeIndex(553, v59.Length)], globalState.f1, v0 := f8, v60, 26, multiset(v1 + (if (p0 in v61) then v61[p0] else v1));
		for i4 := if (f7) then p0 else f8 to -f8 {
			if (v1[safeIndex(-i4, |v1|)]) {
				var v62: array<int> := new int[28];
				v62[safeIndex(883, v62.Length)] := -i4;
				v62[safeIndex(883, v62.Length)] := p0;
				var v63: map<bool, char> := map[f6 := f4];
				globalState.f1 := if (f6) then i4 else v62[safeIndex(883, v62.Length)] * |v63|;
				...
				globalState.f1 := i4;
				var v71 := true;
				v71, v62[safeIndex(883, v62.Length)] := p0 > |map[f4 := v64]|, safeDivisionInt(i4, f8);
			} else {
				...
				v74[safeIndex(174, v74.Length)] := v72;
				v74[safeIndex(174, v74.Length)] := f7;
				var v75 := DC8(p0, p0);
				var v76 := DC9(v75);
				v76 := if (true) then v76 else v76;
				v74 := new bool[20](i5 => v74[safeIndex(174, v74.Length)]);
			}
			...
			var v84: array<int> := new int[28](i6 => safeDivisionInt(i6, |v82|));
			var v85: multiset<array<int>> := multiset{v84, v84, v84, v84, v84};
			var v86: array<int> := new int[24] [i4, (if (f6 in v81) then v81[f6] else |f5|) - 456, 280, fm1(f7, map[f7 := f9], f7, globalState) * p0, f8, fm1(v80, v82[f6 := f7], f7, globalState), f8, i4, v83.cf21, -i4, f8, if (f6) then |f5| else i4, -p0, |v85| * f8, i4, i4 + p0, -p0, i4, |f5|, f8, -safeModuloInt(i4, |f5|), i4, f8, -0x365];
			globalState.f1, v86, globalState.f1, globalState.f1 := 777 - f8, v84, safeDivisionInt(0x242, i4), p0;
		}
		globalState.f1 := f8;
		var i7 := 0;
		while (p0 < |f5|)
			decreases 100 - i7
		{
			...
			v95[safeIndex(422, v95.Length)] := v97;
			var v98: array<D0> := new D0[4](i9 => DC1(v94.f6, p0, v87, f8));
			var v99 := DC1(f9, -f8, v94.f7, |v94.f5|);
			v98[safeIndex(25, v98.Length)] := v99;
			v94, v95[safeIndex(422, v95.Length)], v98[safeIndex(25, v98.Length)] := if (f6) then v94 else v94, v97, v99;
		}
...
class C5 extends T1, T2, T3 {
	...
	function fm2(globalState: GlobalState): seq<int> {
		[|[f6]|, f8] + ([f8] + (seq(abs(0x156), i0  => (f8))))
	}
	method m1(p0: bool, p1: bool, p2: multiset<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: array<array<int>>) {
		var v0 := DC0();
		match (match v0 {
			case DC0() => DC1(f6, f8, f9, f8)
			case DC1(cf0, cf1, cf2, cf3) => DC1(f9, |[|(seq(abs(0x210), i0  => (f8)))|, |f5|]|, cf0, |map[false := f9]|)
			...
			case DC0() =>
				...
				var v8: array<seq<bool>> := new seq<bool>[22] [v3[safeIndex(|v5|, |v3|)] + v2, v2, v2, v2, v2, v2, v3[safeIndex(|v6|, |v3|)] + v2, v2, [f7] + [true], v2, v2, v2[safeIndex(0x66, |v2|) := v1] + [p0, p0], v2 + v2, v2, [f9, !false] + v2, v2, [p1, if (f8 in v7) then v7[f8] else p1, fm3(globalState)], v2, [f6], v2, v2 + v2, [f6, p0] + v2];
				var v9: seq<array<int>> := [f11];
				var v10: array<array<int>> := new array<int>[26] [f11, f11, f11, f11, f11, f11, f11, f11, f11, v9[safeIndex(f8, |v9|)], f11, f11, f11, f11, f11, f11, f11, v9[safeIndex(f8, |v9|)], f11, v9[safeIndex(f8, |v9|)], f11, f11, f11, f11, f11, f11];
				var v11: map<int, array<int>> := map[f8 := f11];
				v10[safeIndex(395, v10.Length)] := if (|fm4(p0, f8, f7, |v6|, globalState)| in v11) then v11[|fm4(p0, f8, f7, |v6|, globalState)|] else f11;
				v8, v10[safeIndex(395, v10.Length)] := DC3(v8).cf7, f11;
				v1 := !!v1;
			case DC1(cf0, cf1, cf2, cf3) =>
				cf2 := !cf2;
				var v12: seq<bool> := [p1];
				f10[safeIndex(385, f10.Length)] := v12[safeIndex(f8, |v12|)];
				f10[safeIndex(385, f10.Length)] := p0;
				var v13: set<bool> := {!cf0};
				var v14: array<bool> := new bool[19] [p1, fm7(f4, |v13|, p0, globalState), p3, f10[safeIndex(385, f10.Length)], !fm3(globalState), f9, f10[safeIndex(385, f10.Length)], p1, cf0, f9, f9, !cf2, v12[safeIndex(-|(seq(abs(561), i1  => (f4)))|, |v12|)], cf2, cf0, f10[safeIndex(385, f10.Length)], f10[safeIndex(385, f10.Length)], fm3(globalState), f7];
				...
				if ((|f5| - -0x1d2) > -f8) {
					...
					v20[safeIndex(792, v20.Length)] := v19;
					var v21: seq<C0> := [v19];
					var v22: seq<seq<bool>> := [[true, false], v12];
					cf3, v20[safeIndex(792, v20.Length)], f10[safeIndex(385, f10.Length)] := f8 - cf3, v21[safeIndex(f8 * v19.fm9(cf1, v22[safeIndex(f8, |v22|)], globalState), |v21|)], f7 !in (v12 + v12);
					var v23 := "muet";
					var v24: map<bool, bool> := map[!cf0 := false];
					v23 := (f5 + v23) + (f5 + fm14(fm1(f10[safeIndex(385, f10.Length)], v24, !cf0, globalState), f8, false, p1, globalState));
					v20[safeIndex(792, v20.Length)] := v20[safeIndex(792, v20.Length)];
					f10[safeIndex(385, f10.Length)] := p1;
					globalState.f1 := cf1;
				} else {
					var v25: array<char> := new char[7];
					var v26: map<bool, bool> := map[f7 := f9];
					f10[safeIndex(385, f10.Length)], v25, v26, globalState.f1, globalState.f1 := cf0, v25, (map[f10[safeIndex(385, f10.Length)] := p0] + v26) + (v26 + v26[f7 := f7]), safeDivisionInt(cf1, |[cf3]|), cf3 - cf1;
					f10[safeIndex(385, f10.Length)] := cf2;
					var v27 := "vsc";
					v27 := v27[safeIndex(cf1, |v27|) := f4];
					cf3 := cf3;
					var v28 := DC5(cf1);
					var v29: seq<D1> := [v28, v28];
					var v30 := DC13(v29 + v29);
					v30 := v30.(cf24 := [DC5(cf3)]).(cf24 := (v29[safeIndex(635, |v29|) := v28])[safeIndex(f8, |v29[safeIndex(635, |v29|) := v28]|) := fm25(globalState)]);
				}
			...
			case DC2(cf4, cf5, cf6) =>
				...
				v33[safeIndex(891, v33.Length)] := fm14(cf4, f8, f7, p0, globalState);
				v33[safeIndex(891, v33.Length)] := f5[safeIndex(safeDivisionInt(|v31|, |p2|), |f5|) := f4];
				if ((|(map v34 : int | v34 in v32 :: (safeDivisionInt(v34, |[f9, true]|)) := (f4))| * f8) != f8) {
					cf5 := p0;
					r1 := f8;
					var v35 := DC5(cf4);
					var v36: seq<D1> := [v35];
					...
					v37[safeIndex(695, v37.Length)] := v32;
					v37[safeIndex(695, v37.Length)] := v32;
				} else {
					var v38: map<int, char> := map[|{cf5}| := 'k'];
					f4 := if (safeModuloInt(cf4, |f5|) in v38) then v38[safeModuloInt(cf4, |f5|)] else f4;
					globalState.f1 := ----(cf4 - f8);
					var v39 := new C1(|[p1]|, !p1, fm3(globalState), p1, fm13(globalState), v33[safeIndex(891, v33.Length)]);
					f10[safeIndex(54, f10.Length)] := p1;
					f10[safeIndex(54, f10.Length)] := p3;
		...
		if (false) {
			...
			if (fm3(globalState)) {
				...
				f4, v51 := f4, f7;
				r1 := f8;
				f11[safeIndex(107, f11.Length)] := f8;
				f11[safeIndex(107, f11.Length)] := f8;
				var v52 := DC10(f5);
				var v53: multiset<string> := multiset{f5, v52.cf19 + f5, f5};
				v53 := v53;
			} else {
				r1 := safeModuloInt(|f5|, 134) + safeModuloInt(f8, f8);
				f11[safeIndex(694, f11.Length)] := f8;
				f11[safeIndex(694, f11.Length)] := f8 + (f8 + f8);
				var v54 := false;
				var v55: set<int> := {f11[safeIndex(694, f11.Length)]};
				var v56: seq<int> := [f11[safeIndex(694, f11.Length)], f11[safeIndex(694, f11.Length)], f8, |v55|];
				var v57: seq<bool> := [fm3(globalState)];
				var v58: set<seq<int>> := {v56};
				v54, v54, globalState.f1, f11[safeIndex(694, f11.Length)], v54 := !(if (!fm7('u', f11[safeIndex(694, f11.Length)], p0, globalState)) then f9 else v56[safeIndex(f8, |v56|)] < -0x226), fm7(f4, --|(v57 + v57[safeIndex(|v57|, |v57|) := !f6])|, !f6, globalState), f8, f11[safeIndex(694, f11.Length)], v58 == v58;
				v54 := v55 >= v55;
				v54 := p0;
			}
			
			var v59: seq<bool> := [f9, f9, f6, f6];
			if (v59[safeIndex(f8, |v59|)]) {
				m0(globalState);
				...
				var v68: map<int, map<bool, bool>> := map[237 := v67[safeIndex(v62.f8, |v67|)]];
				var v69: array<int> := new int[29] [f8, fm1(p0, v60, p3, globalState) + f8, f8, f8, f8, f8, f8, f8, safeDivisionInt(f8, |v61|), f8, f8 + |v65|, |(f5[safeIndex(f8, |f5|) := v62.f4] + f5)|, f8, -v62.f8, v62.f8, if (v62.f8 in v66) then v66[v62.f8] else 0x151, fm1(f6, v60, f7, globalState), f8, f8 * f8, |(if (f8 in v68) then v68[f8] else v60)[!!f6 := v62.f7]|, v62.f8, |(p2 - multiset(v59))|, v62.f8, f8, f8 * v62.f8, |(v65 + v65)|, -f8, f8, v62.f8];
				v69 := v69;
				...
				v72[safeIndex(398, v72.Length)] := v71;
				v72[safeIndex(398, v72.Length)] := v71 + v71;
				var v73: array<multiset<int>> := new multiset<int>[29];
				v73 := v73;
				var v74: map<int, bool> := map[f8 := f9];
				var v75: map<map<int, bool>, bool> := map[v74 := p1];
				f11[safeIndex(223, f11.Length)] := v62.f8;
				r0, globalState.f1, v75, f11[safeIndex(223, f11.Length)], r0 := fm8(safeDivisionInt(f8, f8), false, v62.f8 >= v62.f8, globalState), v62.f8, v75, safeModuloInt(fm1(p3, map[v62.f9 := v62.f6], f9, globalState), v62.f8), safeModuloInt(f8 * v62.f8, f8);
			} else {
				var v76 := true;
				v76 := true;
				v76 := !(f5 < f5);
				f10[safeIndex(463, f10.Length)] := p1;
				f10[safeIndex(463, f10.Length)] := false;
				var v77: C0 := new C0(v76, f10[safeIndex(463, f10.Length)], f4, seq(abs(0x26), i2  => (f4)));
				var v78: map<C0, bool> := map[v77 := v76];
				var v79: map<int, bool> := map[f8 := if (v77 in v78) then v78[v77] else !f7];
				m4(f8, v79, globalState);
				f10[safeIndex(463, f10.Length)] := !v59[safeIndex(f8, |v59|)];
			}
		...
		if (p2 !! p2) {
			...
			v88[safeIndex(828, v88.Length)] := if (f6) then fm0(f9, 0x39c, |p2|, p3, globalState) else v89;
			var v90 := false;
			...
			v93[safeIndex(451, v93.Length)] := f11;
			var v94: C0 := new C0(p1, p1, v91.f4, v91.f5 + f5);
			v88[safeIndex(828, v88.Length)], f4, v90, v93[safeIndex(451, v93.Length)], v94 := v89, v91.f4, !f7, if (f8 >= f8) then f11 else f11, v94;
			v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] := f8;
			var v95: map<multiset<int>, bool> := map[v86 := v91.f9];
			v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] := |(v95 + v95)|;
			globalState.f1 := f8 * v91.f8;
			if (v91.f9) {
				v91.f4 := f4;
				var v96 := DC4(v91.f4, f8, v91.f4, f8, v91.f6);
				var v97: seq<int> := [f8];
				var v98 := new C4(-v91.f8, v91.f9 && false, v96.cf12, multiset{v91.f8, f8} >= v86, v91.f5[safeIndex(|v97|, |v91.f5|)], f5);
				var v99: seq<array<bool>> := [f10];
				f10[safeIndex(492, f10.Length)] := v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] > v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)];
				var v100: seq<bool> := [f9];
				var v101: T2 := new C1(f8, v100[safeIndex(f8, |v100|)], f6, p3, v91.f4, f5);
				var v102 := DC1(!p1, v91.f8, p0, v91.f8);
				var v103: set<D0> := {v102, v102};
				var v104: set<int> := {f8};
				var v105: map<T2, int> := map[if (p0) then v101 else v101 := |(fm14(|v103|, |v101.f5|, v91.f6, v101.f9, globalState) + v101.f5[safeIndex(0x2ce, |v101.f5|) := f5[safeIndex(|v104|, |f5|)]])|];
				v99, f10[safeIndex(492, f10.Length)], v105, v93[safeIndex(451, v93.Length)], globalState.f1 := v99, v101.f6, v105 + v105, v93[safeIndex(451, v93.Length)], |(v100 + v100)| * v91.f8;
				f4 := v101.f4;
				...
				f10[safeIndex(492, f10.Length)], v110 := v111 <= (if (true) then {"lhuqmt", seq(abs(0x2e1), i4  => (v91.f4))} else v111), v110;
			} else {
				...
				var v116: array<map<D1, int>> := new map<D1, int>[1](i5 => map[DC4(v91.f4, v91.f8, v91.f4, f8, v91.f7) := v91.f8] + map[DC4(v91.f4, v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)], f4, v91.f8, v91.f6) := v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)]]);
				var v117 := DC4(v91.f4, f8, v91.f4, f8, false);
				var v118: map<D1, int> := map[v117 := v91.f8];
				v116[safeIndex(893, v116.Length)] := v118;
				var v119 := "ciyeo";
				var v121: T1 := new C0(fm3(globalState), v90, 'f', v91.f5);
				var v122: multiset<T1> := multiset{v121};
				var v123: map<int, string> := map[v91.f8 * v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] := f5];
				v116[safeIndex(893, v116.Length)], v90, v119 := if (p0) then map v120 : D1 | v120 in multiset{DC4(f4, |v122|, v121.f4, |v91.f5|, p0)} :: (v120) := (v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)]) else map[v117 := f8], (f8 + v91.f8) >= (|v91.f5| * v91.f8), if (v91.f8 in v123) then v123[v91.f8] else v121.f5;
				f10[safeIndex(653, f10.Length)] := !(if (f9) then v91.f7 else v91.f9);
				f10[safeIndex(653, f10.Length)] := v91.f6;
				var v124: map<array<int>, int> := map[v93[safeIndex(451, v93.Length)] := -v91.f8];
				f10[safeIndex(653, f10.Length)], v90, v119, v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] := v121.f7, |v91.f5| > |v124|, v119, 0x153;
			}
			
			v93[safeIndex(451, v93.Length)][safeIndex(341, v93[safeIndex(451, v93.Length)].Length)] := v91.f8;
		} else {
			var v125: multiset<bool> := multiset{f9};
			v125 := multiset{(DC23(0x3a9, p3).(cf43 := true)).cf43};
			var v126 := true;
			v126 := p1;
			f10[safeIndex(757, f10.Length)] := f5 == f5;
			var v127: array<array<bool>> := new array<bool>[9] [f10, f10, f10, f10, f10, f10, f10, f10, f10];
			var v128: array<D6> := new D6[1];
			v128[safeIndex(432, v128.Length)] := v87;
			var v129: seq<int> := [safeDivisionInt(-f8, f8)];
			f10[safeIndex(757, f10.Length)], v127, v128[safeIndex(432, v128.Length)], v129 := !(0x2ce == f8), v127, v87, v129 + v129;
			...
			f10[safeIndex(757, f10.Length)] := if ((f8 - f8) in v130) then v130[f8 - f8] else v133.cf27;
			var v134: map<int, int> := map[f8 := -0xe5];
			var v135: C3 := new C3(f10[safeIndex(757, f10.Length)], p1, if (f8 in v134) then v134[f8] else |v86|, f6, v126, f7, f4, f5);
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: map<int, int>) {
		var v0: seq<bool> := [f7];
		var v1: seq<bool> := [false, f6, v0[safeIndex(p0, |v0|)], true];
		var v2: multiset<bool> := multiset{f7, f9, f6, f9, true};
		if (fm27(safeDivisionInt(|v1|, |v2|), f6, f7, globalState)) {
			var v3 := "bgo";
			var v4: set<bool> := {f9};
			var v5 := DC11(f6, f8, v4);
			var v6: map<bool, string> := map[f6 := seq(abs(281), i0  => (f4))];
			...
			v8.f14[safeIndex(111, v8.f14.Length)] := f7;
			var v9: array<D6> := new D6[6](i1 => DC17("xy", seq(abs(-640), i2  => (f4))));
			var v10: map<array<D6>, C2> := map[v9 := v8];
			var v11: seq<array<D6>> := [v9];
			var v12: map<bool, int> := map[f6 := |f5|];
			v8, v8.f14[safeIndex(111, v8.f14.Length)] := if (v11[safeIndex(|v12|, |v11|)] in v10) then v10[v11[safeIndex(|v12|, |v11|)]] else v8, f9;
			var v13: map<string, bool> := map[v3 := f6];
			v8.f14[safeIndex(111, v8.f14.Length)] := if ((v3 + v3) in v13) then v13[v3 + v3] else f9;
		} else {
			var v14 := false;
			v14 := v14;
			...
			match (v20) {
				...
				case DC10(cf19) =>
					...
					f10[safeIndex(273, f10.Length)] := f9;
					f10[safeIndex(273, f10.Length)] := v15 >= v15[f8 := abs(f8)];
					var v27 := new C4(-331, f6, f10[safeIndex(273, f10.Length)], f8 == 629, f4, seq(abs(112), i3  => (f4)));
					var v28 := DC2(|v16|, f6, [f8, p0]);
					var v29: map<seq<int>, map<int, int>> := map[v28.cf6 := map[|v15| := p0]];
					f11[safeIndex(662, f11.Length)] := |v29| * f8;
					var v30: set<multiset<bool>> := {multiset(v0), v2, v2};
					f11[safeIndex(662, f11.Length)] := |v30| - f8;
				case DC12(cf23) =>
					...
					var v35: seq<D1> := [v34];
					var v36 := DC24(v35);
					var v37: array<seq<D1>> := new seq<D1>[23] [(v35 + v35)[safeIndex(f8, |(v35 + v35)|) := v34], v35, v35, v35, v35[safeIndex(f8, |v35|) := v34], v35 + v35, v35, v35, v35, ([v34, DC3(v33), v34, v34])[safeIndex(f8, |[v34, DC3(v33), v34, v34]|) := DC3(v33)] + v35, v35 + v35, [v34], [v34], v35, v35, v35, v35, v35, v35 + v35, v35, v35, v35 + v35, v36.cf44 + v35];
					v37 := v37;
					v14 := !false;
					f10[safeIndex(771, f10.Length)] := f6;
					f10[safeIndex(771, f10.Length)] := f9;
			}
		...
		if (f7) {
			...
			match (v40) {
				case DC4(cf8, cf9, cf10, cf11, cf12) =>
					...
					v42.f14[safeIndex(769, v42.f14.Length)] := v44 !! v44;
					v42.f14[safeIndex(769, v42.f14.Length)] := f7;
					var v45: C4 := new C4(f8, f6, f9, !v42.f14[safeIndex(769, v42.f14.Length)], cf8, f5);
					...
					var v50: seq<int> := [f8];
					globalState.f1 := safeDivisionInt(safeDivisionInt(cf9, cf9), |v50|);
				case DC5(cf13) =>
					var v51: seq<int> := [f8];
					var v52: seq<map<int, int>> := [map[p0 := |v0|], v43];
					var v53 := DC17(f5[safeIndex(0x22b, |f5|) := f4], f5);
					var v54: seq<int> := [v51[safeIndex(p0, |v51|)], |v52[safeIndex(|v53.cf31|, |v52|)]|];
					...
					v57[safeIndex(347, v57.Length)] := v64;
					v57[safeIndex(347, v57.Length)] := v64;
					f11[safeIndex(54, f11.Length)] := |f5|;
					var v65: map<bool, bool> := map[f6 := !v56];
					f4, f11[safeIndex(54, f11.Length)], cf13, f4, v56 := f4, 0xdf, safeDivisionInt(f8, safeModuloInt(f8, f8)), f4, fm7('v', |v65|, {|fm24(cf13, f9, f7, p0, globalState)|} !! fm30(f6, globalState), globalState);
				case DC3(cf7) =>
					globalState.f1 := p0;
					globalState.f1 := -f8;
			...
			v72 := v72;
			f10[safeIndex(136, f10.Length)] := f7;
			f10[safeIndex(136, f10.Length)] := !v70;
		...
		if (match DC7(f6).(cf15 := f9) {
			...
			if (f8 == |v74|) {
				...
				globalState.f1, v75, v75, v76 := safeModuloInt(-556, p0), v75 || f7, v75, v76;
				globalState.f1 := f8;
				var v77 := "rc";
				v77 := "jdhcdkvjy";
				...
				v84[safeIndex(915, v84.Length)] := v74;
				var v85 := true;
				v84[safeIndex(915, v84.Length)], globalState.f1, v85, globalState.f1 := v74, (p0 * f8) + f8, !(if (f6) then v85 else !f7), p0;
				var v86: seq<seq<bool>> := [v0];
				var v87: array<seq<bool>> := new seq<bool>[11] [v1, v1, v86[safeIndex(p0, |v86|)], [f9], v0, v1, v0, v0, v1, v1, v1];
				var v88 := DC3(v87);
			...
			var v94 := false;
			v94 := p0 == p0;
			f10[safeIndex(782, f10.Length)] := true;
			f10[safeIndex(782, f10.Length)] := v94;
			var v95: array<bool> := new bool[16](i5 => f6);
			var v96: array<D1> := new D1[20];
			var v97 := new C2(v95, v96);
		} else {
			var v98: seq<seq<bool>> := [v1];
			var v99: array<seq<bool>> := new seq<bool>[23] [v0, v1, v1, v1, v1, v1, v0, v1, [f7, f9], v0, v1, v0, v0, v1, v1, v0, v1, v0, [f9], [f6, f7], v0, v0, v98[safeIndex(f8, |v98|)]];
			...
			var v105: seq<int> := [|fm28(|(seq(abs(66), i6  => (f4)))|, f6, v1, v104, globalState)|];
			var v106: set<int> := {f8, v105[safeIndex(p0, |v105|)]};
			var v107: map<bool, seq<int>> := map[!f6 := v105[safeIndex(v105[safeIndex(-|v106|, |v105|)], |v105|) := f8]];
			v107 := v107 + v107;
			v102 := f6 in v103;
		...
		if (match v113 {
			...
			globalState.f1 := v122[safeIndex(f8, |v122|)] - (p0 - p0);
		} else {
			...
			var v128: map<int, int> := map[f8 := |(seq(abs(0x1a8), i7  => (0x1ce)))|];
			var v129: map<bool, bool> := map[f9 := f9];
			globalState.f1 := safeDivisionInt(if (p0 in v128) then v128[p0] else |(seq(abs(-0x33e), i8  => ("tfpkek")))|, fm1(fm3(globalState), v129, f7, globalState));
			var v130 := new C0(v127, f9, f4, f5);
			f10[safeIndex(21, f10.Length)] := f9;
			f10[safeIndex(739, f10.Length)] := v2 > v2;
			f10[safeIndex(21, f10.Length)], f10[safeIndex(739, f10.Length)], v127, v127, v1 := !((f9 ==> f7) || f6), f8 > f8, f9, f7, v0 + (v0 + v1);
		}
		...
		if (f9) {
			...
			v132[safeIndex(348, v132.Length)] := f10;
			v132[safeIndex(348, v132.Length)] := f10;
			var v133: map<bool, bool> := map[f9 := f9];
			var v134 := DC11(f7, |f5|, v131);
			var v135: C3 := new C3(0x1ac !in [p0], f6 !in v131, fm1(f6, v133, f6, globalState), false && fm7(fm13(globalState), fm8(f8, f6, v1[safeIndex(f8, |v1|)], globalState), true, globalState), f6, f9, f4, fm28(p0, f6, v0, v134.(cf20 := f7, cf22 := v131), globalState));
			v135 := v135;
			...
			v140[safeIndex(856, v140.Length)] := f10;
			f10[safeIndex(461, f10.Length)] := f4 in f5;
			v139, f4, v140[safeIndex(856, v140.Length)], globalState.f1, f10[safeIndex(461, f10.Length)] := fm3(globalState) ==> f6, f4, f10, f8, f9;
			globalState.f1 := f8;
			var v141: array<int> := new int[29](i9 => i9 - |map[f8 := f9]|);
			f11[safeIndex(162, f11.Length)] := -|map[f11 := f6]|;
			v141, v139, v139, v139, f11[safeIndex(162, f11.Length)] := v141, v139, f6, f6, |v0|;
			var v142: seq<int> := [f8];
			if (v142 <= (if (f6) then [f11[safeIndex(162, f11.Length)], f11[safeIndex(162, f11.Length)], p0] else v142)) {
				var v143: map<int, bool> := map[f8 := f9];
				m4(-|fm18(p0, !f10[safeIndex(461, f10.Length)], globalState)|, v143, globalState);
				var v144: array<array<char>> := new array<char>[17];
				var v145: array<char> := new char[17];
				v144[safeIndex(20, v144.Length)] := v145;
				var v146: array<D1> := new D1[22];
				var v147: C2 := new C2(v140[safeIndex(856, v140.Length)], v146);
				var v148: multiset<int> := multiset{f11[safeIndex(162, f11.Length)]};
				v144[safeIndex(20, v144.Length)], globalState.f1, f11[safeIndex(162, f11.Length)], v147 := v145, -f8, p0, if (p0 <= |v148|) then v147 else v147;
				f11[safeIndex(162, f11.Length)] := p0;
				v1 := v1;
				var v149 := DC4(fm13(globalState), p0, f4, f8, f9);
				var v150: array<seq<bool>> := new seq<bool>[21] [v0, v0, v0, v1[safeIndex(p0, |v1|) := f7], v0, [f10[safeIndex(461, f10.Length)], f6, f7, v139], [v139, f7], v1, v1, v0, [f7], [f10[safeIndex(461, f10.Length)]], v1, v1, [f9], v0, v1, v0, v1, v0, v0];
				var v151: map<bool, D1> := map[v139 := DC3(v150)];
				var v152, v153, v154 := v147.m7(v149, fm32(v0[safeIndex(0x2ff, |v0|) := v139], true, globalState), v151, globalState);
			} else {
				f4 := f4;
				v139 := f9;
				var v155 := "cklypmb";
				...
				var v159: map<int, string> := map[-|v157| := v158[safeIndex(f8, |v158|)]];
				v159 := v159[|v0| := v155];
				var v160 := DC25(fm27(f8, f6, !f10[safeIndex(461, f10.Length)], globalState), f7, |fm33(globalState)|);
				f10[safeIndex(461, f10.Length)] := -f11[safeIndex(162, f11.Length)] <= (v160.cf47 * p0);
			}
			
			var v161: map<bool, int> := map[v139 := f11[safeIndex(162, f11.Length)]];
			var v162 := DC15(v140[safeIndex(856, v140.Length)], false, v161, f11[safeIndex(162, f11.Length)]);
			var v163: map<bool, bool> := map[v139 := v1[safeIndex(f11[safeIndex(162, f11.Length)], |v1|)]];
			var v164: array<D5> := new D5[22] [v162, v162, v162, v162, DC15(v140[safeIndex(856, v140.Length)], f7, v161, f11[safeIndex(162, f11.Length)]), DC15(v140[safeIndex(856, v140.Length)], f7, v161, f8), v162, v162, v162, DC15(v140[safeIndex(856, v140.Length)], v139, map[v1[safeIndex(fm1(f9, v163, f10[safeIndex(461, f10.Length)], globalState), |v1|)] := p0], f11[safeIndex(162, f11.Length)]), DC15(v140[safeIndex(856, v140.Length)], f7, v161, 0x33f), v162, v162, v162, v162, DC15(v140[safeIndex(856, v140.Length)], f10[safeIndex(461, f10.Length)], v161, |f5|), DC15(v140[safeIndex(856, v140.Length)], fm3(globalState), v161, 0x240), v162, v162, v162, v162, v162];
			v164[safeIndex(457, v164.Length)] := v162;
			var v165 := DC11(f10[safeIndex(461, f10.Length)], f11[safeIndex(162, f11.Length)], {f7});
			v164[safeIndex(457, v164.Length)] := v162.(cf28 := v161).(cf28 := (map[v165.cf20 := f11[safeIndex(162, f11.Length)]])[!f10[safeIndex(461, f10.Length)] := p0], cf27 := !f6);
		}
	...
	method m3(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool) {
		...
		var v2: map<bool, char> := map[v1[safeIndex(p1, |v1|)] > v0 := f4];
		v2 := v2[f7 <== f9 := f4];
		for i0 := p2 to p0 {
			var v3: set<bool> := {f9};
			var v4: seq<set<bool>> := [v3, v3];
			var v5: seq<bool> := [f7];
			var v6: seq<bool> := [!(v4[safeIndex(|v5|, |v4|)] > v3)];
			v5 := (v6 + (if (f7) then v6 else [f6]))[safeIndex(0x27d, |(v6 + (if (f7) then v6 else [f6]))|) := f6];
			r0 := fm7(f4, i0, f9, globalState);
			var v7 := DC4(f4, 0x1f5, f4, p2, f6);
			var v8 := new C0(v7.cf12, v6[safeIndex(p0, |v6|)], f4, f5);
			var v9 := "jne";
			f11[safeIndex(596, f11.Length)] := p1;
			var v10: multiset<bool> := multiset{f9};
			v9, r0, f11[safeIndex(596, f11.Length)], v9 := f5 + f5, true, |map[v10 > fm4(f9, |v9|, f9, p0, globalState) := v5 + [f7, f9]]|, "qxofl" + (seq(abs(951), i1  => (f4)));
		}
		r0 := (seq(abs(0x19e), i2  => (f4))) < f5;
		for i3 := p1 to |[f8]| {
			...
			globalState.f1 := |v15[safeIndex(i3, |v15|)]|;
			var v16: seq<bool> := [f9, f5 < f5];
			v16 := v16[safeIndex(i3 - f8, |v16|) := fm27(p2, !f7, f9, globalState)];
		}
		...
		globalState.f1 := -safeDivisionInt(|v19|, p1);
		var i4 := 0;
		while (f7)
			decreases 100 - i4
		{
			...
			v20[safeIndex(67, v20.Length)] := v22;
			var v23: set<bool> := {f9, f6, f7, f9, f9};
			var v24 := DC22(v21);
			v20[safeIndex(67, v20.Length)], globalState.f1, v23, r0 := fm34(!f9, v24, safeDivisionInt(f8, fm8(p2, f7, f6, globalState)), globalState), |v21| + p2, v23, f6;
			var v25 := "etoajigf";
			v25 := "a";
			f4 := f4;
			var v26: seq<multiset<bool>> := [(multiset{f9})[f9 := abs(p0)], multiset{f6, f7, f6}];
			var v27 := DC11(f9, p0, v23);
			var v28: array<char> := new char[28](i5 => f4);
			v28[safeIndex(133, v28.Length)] := f5[safeIndex(p0, |f5|)];
			...
			r0, v26, v27, v28[safeIndex(133, v28.Length)], v30 := !f6, (v26 + [multiset(v21), v32])[safeIndex(p0, |(v26 + [multiset(v21), v32])|) := v32], DC11(f9, |v33|, v23).(cf22 := v23).(cf20 := fm3(globalState)), f4, v30;
		}
	...
	method m4(p0: int, p1: map<int, bool>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			globalState.f1 := safeModuloInt(fm1(f6, v5.cf60, v0.f6, globalState), safeModuloInt(|{true}|, f8));
			var v6: seq<int> := [f8, v0.fm1(v0.f9, v4, f7, globalState), safeModuloInt(|v4|, v0.f8), v0.f8 * p0, f8];
			v6 := (v6 + v6) + v6;
			f10[safeIndex(374, f10.Length)] := v0.f7;
			f10[safeIndex(374, f10.Length)] := v0.f9;
			var v7: map<seq<int>, bool> := map[v6 := true];
			f10[safeIndex(374, f10.Length)] := v7 != (if (fm27(v0.f8, f9, false, globalState)) then map[v6 := v0.f7] else v7);
		}
		...
		for i1 := |v10| to 104 {
			...
			if (v0.f6) {
				...
				v12 := v12;
				v18[safeIndex(737, v18.Length)] := f7;
				v18[safeIndex(737, v18.Length)] := v0.f7;
			} else {
				var v20 := true;
				...
				v22 := v22[|(v11 + v11)| := v23[safeIndex(-|v11|, |v23|)] || !v0.f7];
			}
			
			globalState.f1 := -safeModuloInt(|(v10 - v10)|, |(seq(abs(0x25b), i2  => (v0.f4)))[safeIndex(fm8(f8, f9, v0.f6, globalState), |(seq(abs(0x25b), i2  => (v0.f4)))|) := v0.f4]|);
			f10[safeIndex(446, f10.Length)] := |"bhpixis"| != i1;
			var v24 := true;
			...
			var v30: array<array<bool>> := new array<bool>[29] [f10, f10, f10, f10, v28.cf26, f10, f10, f10, f10, v29[safeIndex(f8, |v29|)], f10, f10, f10, f10, f10, f10, f10, v29[safeIndex(f8, |v29|)], f10, f10, f10, f10, f10, f10, f10, f10, f10, f10, f10];
			v25[safeIndex(901, v25.Length)] := v30;
			var v31: seq<int> := [f8];
			var v32: seq<seq<int>> := [v31];
			f11[safeIndex(779, f11.Length)] := |([p0, f8])[safeIndex(f8, |[p0, f8]|) := |v32|]|;
			var v33: map<bool, bool> := map[f6 := false];
			var v34 := DC23(v9.fm1(v0.f9, v33, v0.f6, globalState), f9);
			var v35: set<int> := {f8};
			f10[safeIndex(446, f10.Length)], v24, v25[safeIndex(901, v25.Length)], f11[safeIndex(779, f11.Length)] := if (false) then v0.f9 else v34.cf43, fm27(-|v10|, v35 >= v35, f7, globalState), v30, --822;
		}
		f11[safeIndex(340, f11.Length)] := -p0 + f8;
		...
		f11[safeIndex(340, f11.Length)] := if ({f8, v0.f8, f8, |f5|, p0} in v38) then v38[{f8, v0.f8, f8, |f5|, p0}] else safeModuloInt(p0, v0.f8);
		var v39 := false;
		v39 := !f6;
	}
}
...
function fm8(p0: int, p1: bool, p2: bool, globalState: GlobalState): int {
	safeModuloInt(544, |(map[false := |"agf"|] + map[true := |"ufyke"|])|)
}
...
function fm12(p0: bool, p1: string, p2: bool, globalState: GlobalState): D3 {
	if (false) then DC12(DC12(DC12(DC12(DC11(false, 0x2c3, {false}))))) else DC12(DC11(false, |(seq(abs(-0x1f8), i0  => ('h')))|, {false}))
}
...
function fm21(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D0 {
	DC2(0x2af + |[true]|, 818 <= |(seq(abs(-0x141), i0  => ("qyetl")))|, if (true) then seq(abs(0x266), i1  => (0x8)) else seq(abs(0x332), i2  => (-0x12e)))
}
function fm22(globalState: GlobalState): set<map<bool, bool>> {
	(set v1 : map<bool, bool> | v1 in (map v0 : map<bool, bool> | v0 in map[map[false := true] := |map[true := map[|(seq(abs(-0x3b7), i0  => ('v')))| := 0xa8]]|] :: (v0) := (!true)) :: (v1)) + (if (true) then {map[true := true]} else set v2 : map<bool, bool> | v2 in map[map[!true := true] := --0x190] :: (v2))
}
...
function fm25(globalState: GlobalState): D1 {
	match DC13(seq(abs(0x17d), i0  => (DC5(928)))) {
		case DC13(cf24) => DC5(752)
	}
}
function fm26(p0: bool, p1: int, p2: char, globalState: GlobalState): D1 {
	DC4('a', -(|[true]| * -|"bfmrgm"|), 'q', |map[|[|{false}|]| := seq(abs(-0x47), i0  => ('a'))]| * 0x3c1, multiset([true, true]) >= multiset{!true, true})
}
...
function fm31(globalState: GlobalState): D6 {
	DC17((seq(abs(992), i0  => ('d'))) + "eanbpr", (seq(abs(0x9c), i1  => ('s'))) + "xm")
}
function fm32(p0: seq<bool>, p1: bool, globalState: GlobalState): map<set<int>, string> {
	(if (false) then map[{|map[!false := |multiset{|{!false}|}|]|} := "sorttx"] else map[{|{|map[true := seq(abs(0x257), i0  => ('v'))]|, |"rkbghw"|}|, 559} := "yhnnprjd"]) + map[{|[!true, true]|, 0x43} := "ug"]
}
...
method m0(globalState: GlobalState) {
	...
	if (v0) {
		...
		v1, v2, v4, globalState.f1, globalState.f1 := v1, v2[82 := abs(397)], v4 + v4, if (safeDivisionInt(|v5|, v1) in v2) then v2[safeDivisionInt(|v5|, v1)] else v1, safeDivisionInt(|[|v8|]|, safeModuloInt(v1, v1));
		if (!v0) {
			globalState.f1 := v1 * v1;
			var v9 := DC16(v2);
			var v10: seq<D6> := [v9, v9, v9];
			var v11: seq<bool> := [v0, true, v0];
			v10 := v10[safeIndex(|multiset(v11)|, |v10|) := v9] + v10;
			v5 := if (v0) then v7.f5 else v7.f5;
			var v12: array<multiset<bool>> := new multiset<bool>[18];
			var v13: multiset<bool> := multiset{v0};
			v12[safeIndex(430, v12.Length)] := v13;
			v12[safeIndex(430, v12.Length)] := v13;
			...
			var v20: array<int> := new int[18](i0 => safeDivisionInt(i0, |(set v19 : int | (-674 <= v19) && (v19 < -208) :: (v19 + 382))|));
			v20[safeIndex(243, v20.Length)] := if (v0) then v1 else v1;
			var v21: array<array<bool>> := new array<bool>[8];
			var v22: array<bool> := new bool[17];
			v22[safeIndex(657, v22.Length)] := v2 == v2;
			v6, v20[safeIndex(243, v20.Length)], v21, v22[safeIndex(657, v22.Length)] := v7.f4, -977, if (if (v0) then fm7(v7.f4, v1, v0, globalState) else v0) then v21 else v21, false ==> !(v0 ==> v0);
			v6 := v7.f4;
			v0 := v0;
			var v23: array<map<string, char>> := new map<string, char>[3](i1 => map["itjlfvghe" := v7.f4]);
			var v24: map<string, char> := map["dtgg" := v7.f4];
			v23[safeIndex(463, v23.Length)] := v24 + v24;
			v23[safeIndex(463, v23.Length)] := v24;
			v22 := v22;
		}
		...
		var v29 := 0x50;
		var v30: array<D1> := new D1[24] [v27, v27, v27, v27, v27, DC3(v28[safeIndex(v29, |v28|)]), v27, v27, v27, v27, v27, v27, v27, v27, DC3(v26), v27, v27, v27.(cf7 := v26), v27, v27, DC3(v26), v27, DC3(v26), v27];
		...
		v33[safeIndex(824, v33.Length)] := v29;
		v29, v32, v33[safeIndex(824, v33.Length)] := v29 + v29, (v32 + v32) * (v32 + fm33(globalState)), v29;
		var v34 := "vejr";
		v34 := v34;
	}
	...
	var v36 := -0xd6;
	v35[safeIndex(91, v35.Length)] := v36;
	v35[safeIndex(91, v35.Length)] := v36;
	v35[safeIndex(91, v35.Length)] := v36 + v36;
	v36 := v35[safeIndex(91, v35.Length)];
	v35[safeIndex(91, v35.Length)] := v36;
	var v37: seq<int> := [v36];
	var v38 := 'x';
	var v39: T1 := new C0(v0, v0, v38, seq(abs(407), i5  => (v38)));
	var v40: multiset<T1> := multiset{v39, v39};
	var v41: seq<bool> := [v0];
	var v42: set<int> := {|v40|, 733, |v41[safeIndex(688, |v41|) := v0]|};
	...
	v45 := v45[v46.(cf39 := v37[safeIndex(v44.f8, |v37|) := v36]) := 0x3bd];
}
method Main() {
	var v0 := true;
		...
		decreases 100 - i0
	{
		...
		var v14: array<bool> := new bool[29] [v0, v12.f13, v12.f13, v12.f12, v12.f13, v0, v12.f13, v0, v12.f13, v12.f13, fm3(globalState), v12.f13, v13[safeIndex(v3, |v13|)], !v0, v0, v0, v12.f13, !v12.f13, v12.f12, v0, v12.f12, v0, v12.f13, v12.f12, v12.f12, !v12.f12, v0, v12.f12, !v12.f12];
		...
		var v18: array<seq<bool>> := new seq<bool>[29] [v13, v13, v13, v13, if (false in v17) then v17[false] else v13, v13, v13, v13, v13, v13, [true, v12.f12], v13, v13, v13, v13, v13, v13, v13, v13, v13, fm18(|(seq(abs(0x280), i2  => (v10)))[safeIndex(|"vqt"|, |(seq(abs(0x280), i2  => (v10)))|) := v10]|, v12.f12, globalState), v13, v13, v13, v13, v13, v13, v13, v13];
		var v19 := DC3(v18);
	...
	var v30: C5 := new C5(v29, v1, !v0, true, v4[safeIndex(|(seq(abs(-922), i3  => ('u')))|, |v4|)], v4, v3, v0);
	...
	var v35: array<multiset<int>> := new multiset<int>[28] [multiset(v25), v24 * multiset{v3}, v24, v26[safeIndex(v3, |v26|)] * v24, v24[v3 := abs(|(map[v28 := |v24[v3 := abs(v3)]|])[v28 := v3]|)], v24, v24, v24 - v24, v24, v24, v24, v24, v24, v24, v24, v24, v24, fm33(globalState), v24, multiset{|v31|, v3} - v24, multiset((seq(abs(0x260), i4  => (-v3))) + [v3, |v25|, v3]), v24, v24, multiset{|v4|} + v24, v24, v24, multiset{v3} * v24, multiset{|v33|, |[v32.f6, v32.f7, v32.f7, v34.cf5, v0]|, -0x19f, v3, v3}];
	v35[safeIndex(124, v35.Length)] := v24;
	v35[safeIndex(124, v35.Length)] := v24 * v24;
	match (fm26(v32.f7, 0x93, v32.f4, globalState)) {
		case DC4(cf8, cf9, cf10, cf11, cf12) =>
			var v36: multiset<bool> := multiset{v0, v32.f6};
			var v37, v38, v39 := v30.m1(v32.f6, v32.f6, v36[v32.f6 := abs(71)], v32.f6, globalState);
			...
			var v46: T2 := new C3(!v32.f7, v32.f7 && v0, cf9, v45.cf27, false, false, cf8, v32.f5 + (seq(abs(519), i5  => (v32.f4))));
			v46 := v43;
			cf12 := v43.f5 <= v43.f5;
			v46.f4 := cf10;
		case DC5(cf13) =>
			...
			var v49: map<int, seq<bool>> := map[safeDivisionInt(cf13, v32.f8) := v48];
			v49 := v49;
			var v50 := DC7(v32.f9);
		...
		case DC3(cf7) =>
			...
			if (!!(if (v51 in v53) then v53[v51] else v32.f9)) {
				var v54: T2 := new C3(v32.f9, v32.f7, v32.f8, v32.f6, v32.f6, v0, v32.f4, seq(abs(424), i6  => (v32.f4)));
				var v55 := DC21(v25, v54);
				v0 := safeModuloInt(|v55.cf39|, v3) <= v32.f8;
				...
				v30.f10[safeIndex(265, v30.f10.Length)] := v32.f7;
				v30.f10[safeIndex(265, v30.f10.Length)] := !!v32.f7;
				var v64: map<int, bool> := map[v32.f8 := v32.f7];
				var v65: T1 := new C0(if (v32.f8 in v64) then v64[v32.f8] else !v32.f6, v30.f10[safeIndex(265, v30.f10.Length)], v32.f4, v32.f5);
				v65 := v65;
				var v66: map<C5, int> := map[v30 := v32.f8];
				var v67: seq<C5> := [v30];
				globalState.f1 := v25[safeIndex(-((if (v67[safeIndex(v3, |v67|)] in v66) then v66[v67[safeIndex(v3, |v67|)]] else v3) - v32.f8), |v25|)];
				var v68 := DC34(v32.f6);
				var v69 := new C4(v32.f8, v32.f7, false, v68.cf65, v32.f4, v32.f5 + (seq(abs(0x20), i7  => (v32.f4))));
				var v70: array<string> := new seq<char>[20](i8 => seq(abs(0x3cb), i9  => (v32.f4)));
				v70[safeIndex(134, v70.Length)] := "dlgmycrna";
				v70[safeIndex(134, v70.Length)] := v32.f5 + (seq(abs(211), i10  => ('b')));
			}
	...
	if (if (safeModuloInt(v32.f8, |v32.f5|) in v86) then v86[safeModuloInt(v32.f8, |v32.f5|)] else v80[safeIndex(|v4|, |v80|)]) {
		if (v0) {
			var v87: C0 := new C0(if (v32.f9) then v32.f7 else v32.f9, v32.f6, v83.f5[safeIndex(v3, |v83.f5|)], v32.f5);
			v87 := v87;
			v32.f4 := v83.f4;
			...
			v90 := v90[v89 := multiset{v32.f8, |v92[safeIndex(v32.f8, |v92|)]|, v3} > v35[safeIndex(124, v35.Length)]];
			...
			v0 := v99.cf65;
			v0 := v32.f9;
			v30.f11[safeIndex(738, v30.f11.Length)] := 0x55 * v3;
			v30.f11[safeIndex(738, v30.f11.Length)] := 0x2fe;
			var v100 := new C3(false, v32.f7, v30.f11[safeIndex(738, v30.f11.Length)], true, v0, v32.f7 ==> true, v32.f4, v83.f5);
		}
		
		var v101 := DC20();
		match (v101) {
			case DC19(cf34, cf35, cf36, cf37, cf38) =>
				v30.f10[safeIndex(147, v30.f10.Length)] := v0;
				var v102: map<seq<bool>, bool> := map[v80 := v32.f9];
				v30.f10[safeIndex(147, v30.f10.Length)] := (v32.f5 == v83.f5[safeIndex(|v102|, |v83.f5|) := v83.f4]) <== (cf34 <== v32.f6);
				v81 := v81;
			...
			case DC20() =>
				...
				v106[safeIndex(233, v106.Length)] := v4;
				v106[safeIndex(233, v106.Length)] := v83.f5;
				var v107 := new C5(v29, v30.f11, v32.f7, v32.f9, v83.f4, v4, v3 - -v32.f8, v32.f6);
				var v108: map<int, int> := map[v3 := 0x3bc];
				var v109: map<bool, int> := map[|v108[|v25| := v32.f8]| > 0x388 := v28.fm1(!v32.f7, fm23(|(seq(abs(0x3df), i11  => (0x33b)))|, -v32.f8, v32.f4, v32.f9, globalState), v32.f7, globalState)];
			...
			case DC21(cf39, cf40) =>
				...
				var v111 := new C4(|v24|, v80 != v80, !v32.f9, fm3(globalState), cf40.f4, DC10(v32.f5).cf19[safeIndex(v3, |DC10(v32.f5).cf19|) := v27]);
				v80 := v80 + (v80 + v80)[safeIndex(|v79|, |(v80 + v80)|) := false];
		...
		v0, v3 := v32.f6, safeDivisionInt(v3 + |v126[v0 := |v128|]|, safeModuloInt(v3, -(if (v124 in v129) then v129[v124] else v32.f8)));
		...
		if (v32.f9) {
			...
			v86 := v86[safeDivisionInt(v3, |(if (|v80| in v136) then v136[|v80|] else v135)|) := v32.f7];
			var v137 := new C3(v32.f9, v32.f6, |v80| - |(seq(abs(0x172), i12  => (v27)))|, v32.f6 <== v80[safeIndex(v32.f8, |v80|)], v32.f9, false, v27, v83.f5 + v32.f5);
			...
			v145[safeIndex(39, v145.Length)] := v83.f5;
			v145[safeIndex(39, v145.Length)] := (seq(abs(183), i13  => (v32.f4))) + v4;
		...
		var v160: map<int, set<int>> := map[|v157[safeIndex(if (v0 in v158) then v158[v0] else v32.f8, |v157|)]| := set v159 : int | v159 in v35[safeIndex(124, v35.Length)] :: (v159 * |multiset(seq(abs(0x354), i14  => (-0x2f0)))|)];
		var v161: array<set<int>> := new set<int>[15] [set v150 : int | (0x17d <= v150) && (v150 < -403) :: (safeModuloInt(v150, -v32.f8)), v151, v151, v151, v151, set v154 : int | v154 in v153 :: (safeModuloInt(v154, |map[false := |"ucmoqf"|]|)), v151, {v32.f8}, {v32.f8}, v151, v151, v151, v151, if (v32.f8 in v160) then v160[v32.f8] else v151, v151];
		var v162 := DC39(v161);
		match (v162) {
			case DC40(cf73, cf74, cf75) =>
				m0(globalState);
				v0 := v32.f8 != safeModuloInt(v3, cf73);
				cf74 := v32.f9;
				v0, globalState.f1, cf74, v3 := v32.f6, v32.f8, cf74 || !v32.f6, v32.f8 - cf73;
			case DC39(cf72) =>
				m0(globalState);
				var v163: seq<C1> := [v28];
				var v164: array<C1> := new C1[14] [v28, v28, v28, v28, v163[safeIndex(v32.f8, |v163|)], v28, v28, v28, if (v32.f9) then v28 else v28, v28, v28, v28, DC28(v32.f9, v32.f8, v0, v32.f7, v28).cf54, v28];
				v164[safeIndex(259, v164.Length)] := v28;
				v164[safeIndex(259, v164.Length)] := v28;
				globalState.f1 := v3;
				v162 := v162;
			case DC41(cf76) =>
				...
				v80 := ((if (v32.f8 in v166) then v166[v32.f8] else v80)[safeIndex(|v83.f5|, |(if (v32.f8 in v166) then v166[v32.f8] else v80)|) := v32.f9] + v80) + v80;
				v0 := v32.f9;
		}
	...
	print v3, "\n";
	print v4, "\n";
	print v5 == multiset{{true, false}}, "\n";
	print v6 == {"ikmk"}, "\n";
	print v7 == ["ikmk"], "\n";
	print i0, "\n";
	print v24 == multiset{287}, "\n";
	print v25 == [372, 287], "\n";
	print v26 == [multiset{372, 287}], "\n";
	print v27, "\n";
	print v29[1], "\n";
	print v30.f10[1], "\n";
	print v30.f11[7], "\n";
	...
	print v34.cf4, "\n";
	print v34.cf5, "\n";
	print v34.cf6 == [372, 287], "\n";
	print v35[0] == multiset{372, 287}, "\n";
	print v35[1] == multiset{287}, "\n";
	print v35[2] == multiset{287}, "\n";
	print v35[3] == multiset{287}, "\n";
	print v35[4] == multiset{287}, "\n";
	print v35[5] == multiset{287}, "\n";
	print v35[6] == multiset{287}, "\n";
	print v35[7] == multiset{}, "\n";
	print v35[8] == multiset{287}, "\n";
	print v35[9] == multiset{287}, "\n";
	print v35[10] == multiset{287}, "\n";
	print v35[11] == multiset{287}, "\n";
	print v35[12] == multiset{287}, "\n";
	print v35[13] == multiset{287}, "\n";
	print v35[14] == multiset{287}, "\n";
	print v35[15] == multiset{287}, "\n";
	print v35[16] == multiset{287}, "\n";
	print v35[17] == multiset{-78}, "\n";
	print v35[18] == multiset{287}, "\n";
	print v35[19] == multiset{1}, "\n";
	print v35[20] == multiset{-287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, -287, 287, 287, 2}, "\n";
	print v35[21] == multiset{287}, "\n";
	print v35[22] == multiset{287}, "\n";
	print v35[23] == multiset{4, 287}, "\n";
	print v35[24] == multiset{287}, "\n";
	print v35[25] == multiset{287}, "\n";
	print v35[26] == multiset{287}, "\n";
	print v35[27] == multiset{1, 5, -415, 287, 287}, "\n";
	print v79 == {false}, "\n";
	print v80 == [true, false, false, true, false, false], "\n";
	print |v82|, "\n";
	print v83.f4, "\n";
	print v83.f5, "\n";
	print v84 == map[false := false], "\n";
	print v86 == map[287 := true], "\n";
	print v172 == map[DC0() := 763], "\n";
}