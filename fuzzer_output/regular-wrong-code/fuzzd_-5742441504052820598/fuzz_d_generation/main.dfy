...
class C0 {
	...
	function fm15(p0: multiset<int>, p1: seq<bool>, p2: bool, p3: set<multiset<int>>, globalState: GlobalState): seq<int> {
		[f18, -f18] + ((seq(abs(0x39e), i0  => (|multiset{false}|))) + (seq(abs(-543), i1  => (--413))))
	}
}
...
class C1 extends T1, T0, T2 {
	...
	function fm5(p0: string, p1: bool, globalState: GlobalState): bool {
		{f17, f17} < ({f4} * (set v0 : int | (755 <= v0) && (v0 < 0x2e0) :: (safeModuloInt(v0, -f4))))
	}
	method m7(p0: int, p1: string, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: array<array<bool>>, r2: array<int>, r3: int) {
		var i0 := 0;
		while (f16)
			decreases 100 - i0
		{
			...
			v0[safeIndex(253, v0.Length)] := f15 + f15;
			v0[safeIndex(253, v0.Length)] := fm1(globalState);
		...
		for i1 := p0 to if (true in v4) then v4[true] else v5.cf1 {
			if (if (!(v3 ==> v3)) then true else v3 && p3) {
				...
				v10[safeIndex(21, v10.Length)] := p2;
				var v11: multiset<int> := multiset{p0};
				var v12: seq<string> := [p1, v6];
				v3, v9, v10[safeIndex(21, v10.Length)] := v11 !! v11, fm16(0x357 < |p1|, v12, p3, v7.f18, globalState), (p0 == v7.f18) <==> p3;
				var v13: seq<array<bool>> := [v10];
				v13 := [v10, v10];
			} else {
				var v14: multiset<int> := multiset{f17};
				var v15: seq<int> := [f4];
				var v16: array<int> := new int[18] [safeDivisionInt(f15, f4), i1, |v14|, p0, -|p1|, f4, i1, f17, f15, f17, 0x40, -i1, f17, i1, safeDivisionInt(v15[safeIndex(f17, |v15|)], f15), p0 * 0x216, i1, -|(p1 + p1)|];
				v16[safeIndex(235, v16.Length)] := p0;
				var v17: map<int, int> := map[|map[f4 := {if (f15 in v14) then v14[f15] else i1, -0x269, f17}]| := i1 * f15];
				f4, r3, v16[safeIndex(235, v16.Length)] := safeDivisionInt(f15 - |v14|, |(seq(abs(0x30c), i2  => (|(seq(abs(0x1a2), i3  => (p1)))|)))|), |v17|, p0;
				var v18: map<int, bool> := map[0x8 := p3];
				v18 := map v19 : int | (-0x28c <= v19) && (v19 < -0x6) :: (safeModuloInt(v19, |v15|)) := (p1 != p1);
				r3 := p0;
				var v20: set<int> := {972};
				var v21 := DC7(v20);
				v3 := (v20 * v21.cf12) !! v20;
				v16[safeIndex(235, v16.Length)] := i1;
			}
			
			r3, v3, r0 := f15, v3, f4;
			r0 := p0;
			var v22: array<bool> := new bool[10](i4 => f16);
			v22[safeIndex(468, v22.Length)] := f16 ==> f16;
			var v23: seq<int> := [f17];
			v22[safeIndex(468, v22.Length)] := (p0 * |p1|) < (--0xda - |v23|);
		}
		var v24 := 'g';
		var v25: seq<seq<char>> := [['i', v24]];
		var v26: set<bool> := {v24 !in "dhrfx", f16, v25 <= v25[safeIndex(-0x2a2, |v25|) := p1]};
		...
		if (p2) {
			...
			var v33: array<int> := new int[28] [|{v28, v28}|, -0x3d4, f17, f15, |p1|, |p1|, p0, |v26|, f4, f15, p0, |v4[p2 := abs(|v29|)]|, f17, |v30|, f17, f4, f15, f17, f4, p0, |v31[safeIndex(-|p1|, |v31|) := !p2]|, fm1(globalState), f17, |v32|, f15, f4, |p1|, f17];
			...
			f17 := if (safeModuloInt(f15, f17) in v36) then v36[safeModuloInt(f15, f17)] else f15;
			var v37: array<D1> := new D1[8](i5 => DC4(f17, v31, f17));
			var v38 := DC4(|v35|, v31, f4);
			v37[safeIndex(360, v37.Length)] := v38;
			v37[safeIndex(360, v37.Length)] := v38;
		} else {
			var v39: array<int> := new int[10](i6 => safeDivisionInt(i6, f4));
			var v40: seq<array<int>> := [v39, v39, v39];
			var v41: seq<array<int>> := [v40[safeIndex(p0, |v40|)]];
			v41 := v41;
			var v42: array<bool> := new bool[19];
			v42[safeIndex(996, v42.Length)] := p2;
			var v43: multiset<array<bool>> := multiset{v42};
			v42[safeIndex(996, v42.Length)], v26 := v43 > multiset{v42}, v26;
			var v44: array<char> := new char[5](i7 => 'm');
			v44[safeIndex(906, v44.Length)] := v24;
			v44[safeIndex(906, v44.Length)] := p1[safeIndex(f15, |p1|)];
	...
	method m8(p0: array<bool>, globalState: GlobalState) {
		...
		var v1 := DC4(-(|(seq(abs(-0x21), i0  => (f15)))| * f15), v0, 0x369);
		v1 := v1;
		for i1 := |fm18(f17, f15, f17, globalState)| to f4 {
			...
			var v5 := false;
			f4, v4, v5 := |"onsmmxab"|, fm19(seq(abs(188), i2  => (f15)), f15, globalState), f16;
			f17 := i1;
		}
		...
		v8[safeIndex(119, v8.Length)] := |v6|;
		v8[safeIndex(119, v8.Length)] := DC10(0x1f7, f15, f16, f15, v0[safeIndex(f17, |v0|)]).cf18;
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			v8[safeIndex(119, v8.Length)] := v8[safeIndex(119, v8.Length)];
			var v11 := true;
			v11 := safeDivisionInt(f15, f15) > f4;
			var v12: array<seq<char>> := new seq<char>[10];
			f4, v12 := -safeDivisionInt(f17, safeModuloInt(|(seq(abs(0x38d), i4  => ('f')))|, 0xe0)), v12;
			var v13 := new C0(safeModuloInt(v8[safeIndex(119, v8.Length)], -f17));
		}
		f4 := (f15 * -f4) - f17;
	}
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		match (v2) {
			case DC8(cf13, cf14) =>
				...
				f4 := |(v5[safeIndex(p1, |v5|) := v4.(cf10 := fm1(globalState))])[safeIndex(if (p2 in v6) then v6[p2] else fm1(globalState), |v5[safeIndex(p1, |v5|) := v4.(cf10 := fm1(globalState))]|) := v4]|;
				r0 := f16;
				f4 := (f4 * f4) - f17;
				v3 := v3;
			case DC9(cf15, cf16) =>
				...
				if (p2) {
					...
					v21 := seq(abs(0x2fb), i2  => (if (p3) then f15 else 229));
					var v22 := new C0(f17);
			...
			case DC10(cf17, cf18, cf19, cf20, cf21) =>
				...
				if (f16 <==> !(v28 < v28)) {
					...
					var v31: seq<multiset<seq<int>>> := [multiset(seq(abs(0x1cd), i4  => ([0x3be]))), v30];
					r0 := if (p3) then p2 else v30 <= v31[safeIndex(f17, |v31|)];
					...
					var v36: array<D3> := new D3[18] [fm20(fm5(seq(abs(0x366), i5  => (v0)), p0, globalState), v32, globalState), v33, v33, v33, v33, v33, v33.(cf19 := v34[safeIndex(p1, |v34|)], cf20 := cf20).(cf20 := cf20, cf18 := f15), v33.(cf21 := p0, cf19 := cf19), v33, DC10(|v35|, |v35|, p2, cf20, cf21).(cf19 := p2, cf21 := p3, cf17 := |v34|, cf18 := 0x207), v33, v33, DC10(-0x341, p1, f16, f4, fm0(cf17, |v28|, globalState)), v33, v33, v33, v33, v33];
					var v37: map<bool, bool> := map[false := cf21];
					var v38: map<bool, int> := map[p2 := |map[v37 := v34[safeIndex(f4, |v34|)]]|];
					v36[safeIndex(346, v36.Length)] := DC10(f17, -cf17, p2, |v38|, p2);
					v36[safeIndex(346, v36.Length)] := v33;
					cf17 := safeDivisionInt(cf20, cf17);
					...
					var v45: array<map<int, char>> := new map<int, char>[6] [map v41 : int | v41 in v42 :: (v41 - p1) := ('d'), v43[p1 := v0], map v44 : int | (0x201 <= v44) && (v44 < 0x1fc) :: (safeModuloInt(v44, p1)) := ('w'), v43, v43, v43];
					v40[safeIndex(987, v40.Length)] := v45;
					v40[safeIndex(987, v40.Length)] := v45;
					var v46: set<int> := {cf17, f4, p1};
					v46 := v46;
					v0 := v0;
					var v47: seq<bool> := [!cf19, cf21, cf21, !p0];
					v1[safeIndex(693, v1.Length)] := v47[safeIndex(f15, |v47|)];
				...
				v49 := v49[v50[safeIndex(cf20, |v50|)] := cf18];
				var v51: map<int, array<bool>> := map[f17 := v1];
				cf20 := safeModuloInt(0x1c6 - f15, safeDivisionInt(|v51|, f4));
				...
				v52 := v52 + (v52 + fm21(|v50[safeIndex(f17, |v50|) := fm5(v28, v55.cf25, globalState)]|, cf19, p0, set v57 : multiset<bool> | v57 in {v56} :: (v57), globalState));
			case DC7(cf12) =>
				var v58 := "nkuxq";
				v58 := (seq(abs(0x30d), i6  => (v0)))[safeIndex(0x10f, |(seq(abs(0x30d), i6  => (v0)))|) := v0] + v58;
				...
				if (p3) {
					...
					var v62: map<int, bool> := map[safeDivisionInt(f17, p1) := {p1} == v61[safeIndex(f4, |v61|)]];
					v62 := map v63 : int | (-0x1bd <= v63) && (v63 < -0x39b) :: (safeDivisionInt(v63, p1)) := (p3 && f16);
					...
					f4 := (if (p1 in v66) then v66[p1] else f4) - safeModuloInt(f4, 0x2a7);
					v58 := v58;
					var v67: array<set<int>> := new set<int>[18];
					v67[safeIndex(0, v67.Length)] := cf12;
					var v68: array<D5> := new D5[7];
					var v69 := DC16(f16, !p0, p2, p1, !true);
					v68[safeIndex(113, v68.Length)] := v69;
					r0, f17, v67[safeIndex(0, v67.Length)], v1, v68[safeIndex(113, v68.Length)] := true, p1, cf12, v1, v69;
					...
					var v73: array<array<bool>> := new array<bool>[26] [v1, v1, v1, v1, v1, if (f16) then v1 else v1, v1, v1, if (p0) then v1 else v1, if (v70 in v71) then v71[v70] else v1, v1, v1, v1, v1, v1, v1, v72[safeIndex(f17, |v72|)], v1, if (p0) then v1 else v1, v1, DC8(v0, v1).cf14, v1, v1, v1, v1, v1];
					v73[safeIndex(166, v73.Length)] := v1;
					v73[safeIndex(166, v73.Length)] := v1;
					f17 := f17;
				}
			...
			case DC11(cf22) =>
				...
				var v80 := "rmirrqiph";
				var v81: seq<int> := [f15];
				r0 := (v78[|v79| := abs(|v80|)] + multiset{p1, f17}) !! v77[f15 := abs(v81[safeIndex(|v80|, |v81|)])];
				r0 := f16;
		}
		...
		v85[safeIndex(640, v85.Length)] := v84;
		v85[safeIndex(640, v85.Length)] := new int[14](i7 => i7 - f15);
		var v86: seq<bool> := [p0];
		...
		for i8 := f17 to p1 {
			var v88: seq<int> := [f4];
			v84[safeIndex(563, v84.Length)] := |multiset(v88)| * f15;
			var v89: set<char> := {v0, 'b', v0};
			v84[safeIndex(563, v84.Length)], r0, v82 := if (if (f16) then p3 else p3) then safeModuloInt(|"g"|, p1) else i8, (-f17 - p1) < (if (f16) then |v89| else f17), v82[p0 := f16];
			var v90: map<string, int> := map["htlnukccc" := v84[safeIndex(563, v84.Length)]];
			var v91: map<seq<int>, int> := map[v88 := -|(multiset{f4})[|v90| := abs(0x79)]| * -0x1a1];
	...
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		...
		v5[safeIndex(357, v5.Length)] := f15;
		v5[safeIndex(357, v5.Length)] := f15;
			...
			decreases 100 - i3
		{
			...
			v8 := -(|v14| - |({f16} - v3)|);
			v8 := safeModuloInt(f17, p0) - f17;
		}
		var v15: seq<seq<int>> := [v2];
		var v16 := DC0(v15[safeIndex(|"hx"|, |v15|)]);
		var v17: seq<D0> := [DC0(v2), v16];
		r0 := (v17 + v17) + v17;
		var v18 := "aaab";
		var v19: seq<string> := [v18 + v18];
		r1 := v19[safeIndex(-fm1(globalState), |v19|)];
	...
	method m11(globalState: GlobalState) returns (r0: array<char>, r1: set<array<bool>>) {
		...
		if (!fm0(f4, f4, globalState)) {
			...
			if (v13 !! v13[v12 := abs(-f4)]) {
				...
				var v20: array<int> := new int[17] [0x36b, v2.f18, -v2.f18, |(v11 - v11)|, f4, v2.f18, v2.f18, v2.f18, fm1(globalState), v2.f18, v2.f18, |v19|, 0x213, f4, safeDivisionInt(f4, f17), v2.f18, f17];
				v20[safeIndex(450, v20.Length)] := -v2.f18;
				v20[safeIndex(450, v20.Length)] := f4;
				v2.f18 := v20[safeIndex(450, v20.Length)];
			...
			var v38: array<int> := new int[23] [safeDivisionInt(v26.f18, f15), f15, f15, v26.f18, |(v28 * v28)|, f4, f4, fm1(globalState), safeModuloInt(|v29|, v30.cf10), safeModuloInt(f4, f4), f15, if (!v0 in v32) then v32[!v0] else |v36|, v26.f18, v26.f18, v26.f18, safeDivisionInt(f15, |v25|), v26.f18, f15, if (v23 in v37) then v37[v23] else v26.f18, f4, f17, safeDivisionInt(f17, v26.f18), 0x10e];
			v38[safeIndex(887, v38.Length)] := f15 + f4;
			var v39 := DC21(f15, f16);
			v38[safeIndex(887, v38.Length)] := v39.cf41;
		}
		...
		var v47: array<int> := new int[22] [|map[v0 := v40]|, |map[f16 := f4]|, f4, 153, |v42|, f17, |v43|, |(seq(abs(370), i3  => (f15)))|, f17, f4, f4, f17, f17, f4, f17, f17, -|v44|, f4, f15, |v44|, f4, |v46|];
		var v48: seq<array<int>> := [v47];
		for i2 := f4 to |v48| {
			v47[safeIndex(367, v47.Length)] := -(f17 - f17);
			v47[safeIndex(367, v47.Length)] := -(f4 + f15);
		...
		forall i4 | 0 <= i4 < v52.Length {
			v52[i4] := (v44 + (seq(abs(0x1bd), i5  => ('q')))) in (map v53 : string | v53 in (map v54 : string | v54 in multiset([v44]) :: (v54) := (DC24(map[false := f16]).cf44)) :: (v53) := ('o'));
		}
		var v55: set<int> := {f15, f17};
		for i6 := -|v55| to f15 + |v44| {
			v52[safeIndex(495, v52.Length)] := f16;
			var v56 := DC5((multiset{v0, v0})[f16 := abs(|v42|)]);
			var v57: set<bool> := {!f16, v0};
			var v58: map<int, set<bool>> := map[f15 := v57];
			var v59 := DC4(v51.f18, v41, f17);
			v0, v52[safeIndex(495, v52.Length)], v56, v0, v41 := (v0 <==> v0) && false, v0, fm22((if (v51.f18 in v58) then v58[v51.f18] else v57) > v57, -f4, f4, DC25(v0, !f16, f17).cf46, globalState), f16, DC13(v59, f16, v41).cf26;
			v47[safeIndex(131, v47.Length)] := f15;
			v47[safeIndex(131, v47.Length)] := v51.f18;
			f17 := v47[safeIndex(131, v47.Length)];
			v52[safeIndex(495, v52.Length)] := false;
		}
	...
	method m12(p0: bool, p1: bool, p2: int, p3: array<string>, globalState: GlobalState) returns (r0: multiset<seq<int>>, r1: int) {
		var v0 := true;
		v0 := p0;
		var v1: array<int> := new int[5] [f4, fm1(globalState), safeModuloInt(p2, f4), f4, p2];
		v1[safeIndex(926, v1.Length)] := |(map v2 : int | v2 in multiset{p2} :: (safeModuloInt(v2, |map[p1 := f15]|)) := (true))|;
		var v3: multiset<bool> := multiset{p0};
		v1[safeIndex(926, v1.Length)] := if (p1) then if (p1 in v3) then v3[p1] else fm1(globalState) else f15;
		if (!v0) {
			...
			if (v0 in v3) {
				...
				var v8: seq<C0> := [v4];
				var v9: map<int, C0> := map[v1[safeIndex(926, v1.Length)] := v8[safeIndex(f15, |v8|)]];
				...
				var v13: array<bool> := new bool[26] [p1, v0, !!fm0(v5[safeIndex(v4.f18, |v5|)], f17, globalState), p0, !fm5(v6, p1, globalState), p0, !v0, p1, v0, p1, fm5(seq(abs(0x196), i0  => ('j')), f16, globalState), -7 == f17, p0, v0, f16, !p1, true, multiset{v1, v1} <= v7, p1, p0, if (v9 in v10) then v10[v9] else v0, p1, v12 !! v12, f15 != v4.f18, !p1, p0];
				v13[safeIndex(512, v13.Length)] := f16;
				var v14: map<int, bool> := map[|v3| := f16];
				v13[safeIndex(512, v13.Length)] := f16 || (if (v0) then f16 else if (v4.f18 in v14) then v14[v4.f18] else p1);
				var v15, v16 := m14(globalState);
				var v17: seq<string> := [v6, v15, "olg", "tudfubgu"];
				var v18: seq<string> := [v17[safeIndex(0x23, |v17|)], v15];
				var v19: array<seq<string>> := new seq<string>[13] [v17, v17, [v15, v6, v15, "qymygl"], v18, v18 + v18, v18, v18, v18, v17 + v17, v18, v17, v18, v18];
				v19[safeIndex(921, v19.Length)] := v17 + v18;
				v19[safeIndex(921, v19.Length)] := v18;
				var v20 := DC24(map[v0 := p1]);
				var v21: map<bool, bool> := map[true := v13[safeIndex(512, v13.Length)]];
				...
				var v24: set<bool> := {!p0, f16, v13[safeIndex(512, v13.Length)]};
				v13[safeIndex(512, v13.Length)] := (f16 <==> p0) in v24;
			} else {
				...
				var v27: map<int, bool> := map[-v1[safeIndex(926, v1.Length)] := v0];
			...
			if (false <==> v34.cf3) {
				...
				var v39: seq<map<int, bool>> := [map[f15 := p0], v37, map v38 : int | (927 <= v38) && (v38 < 656) :: (safeModuloInt(v38, 630)) := (true), v37, v37];
				...
				var v46: seq<int> := [f15, |[402, v1[safeIndex(926, v1.Length)], |v45|, v4.f18, v1[safeIndex(926, v1.Length)]]|];
				var v47: multiset<int> := multiset{v4.f18};
				var v48: seq<seq<int>> := [[|v47|, v4.f18, p2, v4.f18], v46, v46];
				f4, v0, v41 := -(v1[safeIndex(926, v1.Length)] - |v46|) * |((v48[safeIndex(v1[safeIndex(926, v1.Length)], |v48|)])[safeIndex(v1[safeIndex(926, v1.Length)], |v48[safeIndex(v1[safeIndex(926, v1.Length)], |v48|)]|) := |v3|])[safeIndex(f17, |(v48[safeIndex(v1[safeIndex(926, v1.Length)], |v48|)])[safeIndex(v1[safeIndex(926, v1.Length)], |v48[safeIndex(v1[safeIndex(926, v1.Length)], |v48|)]|) := |v3|]|) := v4.f18]|, p0, p0;
				var v49: set<int> := {|multiset{v1[safeIndex(926, v1.Length)], -p2}|};
				v4.f18 := if (v49 > (set v50 : int | (99 <= v50) && (v50 < 0xc6) :: (safeModuloInt(v50, if (v4.f18 in v47) then v47[v4.f18] else |map[v0 := f4]|)))) then f4 else safeDivisionInt(v4.f18, f4);
				var v51 := 'g';
				var v52: seq<char> := [v51];
				v0, v52, v51 := fm1(globalState) != p2, if (v41) then (seq(abs(0x21), i1  => ('j')))[safeIndex(p2, |(seq(abs(0x21), i1  => ('j')))|) := v51] else v52 + v52, v51;
			} else {
				var v53 := "vdp";
				...
				v55 := if (p0) then v56[safeIndex(v4.f18, |v56|)] else v55;
				v1[safeIndex(926, v1.Length)] := f17;
				var v57: map<bool, int> := map[p0 := f15];
				v57 := v57[!v0 ==> !p0 := f4];
				var v58: array<D1> := new D1[28];
				var v59 := DC4(v4.f18, [v0], f17);
				v58[safeIndex(48, v58.Length)] := v59;
				var v60 := 'e';
				var v61: array<char> := new char[13](i2 => v60);
				var v62: seq<array<char>> := [v61];
				v58[safeIndex(48, v58.Length)], r1, v60, v61, v1[safeIndex(926, v1.Length)] := v59, v4.f18, v60, v62[safeIndex(v4.f18 + v4.f18, |v62|)], v1[safeIndex(926, v1.Length)] * safeDivisionInt(p2, f15);
			}
			...
			var v66: seq<set<bool>> := [v65[safeIndex(f17, |v65|)], v64, v64];
			var v67: array<set<bool>> := new set<bool>[23] [{fm0(f15, f15, globalState), v0, true, true} + v64, v64, v64, v64 + v64, v64, {!p1, f16}, {v0}, {v0} * v64, v64 + fm17(v0, p2, globalState), v64, v64 - v64, v64, v64, v66[safeIndex(f15, |v66|)], {f16}, v64, v64, v64, {v0}, v64, v64, v64, if (p0) then v64 else {p0}];
			v67 := v67;
			var v68 := 't';
			...
			var v74, v75, v76, v77 := m0(map[v1[safeIndex(926, v1.Length)] := p0], v72, v73, globalState);
			var v78: array<array<bool>> := new array<bool>[28];
			var v79: array<bool> := new bool[8];
			v78[safeIndex(924, v78.Length)] := v79;
			var v80 := "nxtwfsnhl";
			var v81: set<int> := {v74};
			var v82 := DC4(f17, [v0], f15);
			var v83 := DC13(v82, f16, [v77, v0]);
			var v84: map<char, bool> := map[v80[safeIndex(|v83.cf26|, |v80|)] := p1];
			v78[safeIndex(924, v78.Length)] := new bool[22] [f17 >= v75, p1, p0, v77, v3 >= v3, v77, !f16, v0, f16, !p1, v0 || p1, !(v80 <= v80), v80 <= v80, !false, v0, p0 && v0, v0, {f17, p2} >= v81, p1, !(if (false) then p0 else v0), if (v68 in v84) then v84[v68] else v0, !p1];
			var v85: map<int, char> := map[p2 := v68];
			var v86: map<int, set<bool>> := map[v1[safeIndex(926, v1.Length)] := {p0, p0}];
			v85 := v85[|v86| := v80[safeIndex(v75, |v80|)]];
		}
		...
		if (f16) {
			...
			v88 := v88[v87.f18 := v87];
			v87.f18 := v1[safeIndex(926, v1.Length)];
			var v89: set<bool> := {p1, p1};
			var v90: map<int, int> := map[f17 := |(v89 - v89)|];
			v90 := v90[f15 - f17 := if (v0) then -v1[safeIndex(926, v1.Length)] else fm1(globalState)];
			v0 := v0;
			v1[safeIndex(926, v1.Length)] := safeModuloInt(f15, -p2);
		} else {
			if (!f16) {
				var v91 := new C0(v1[safeIndex(926, v1.Length)]);
				r1 := v91.f18;
				var v92: array<array<string>> := new array<string>[18];
				v92[safeIndex(543, v92.Length)] := p3;
				var v93 := DC30(0x2fa, p3, p1);
				v92[safeIndex(543, v92.Length)] := v93.cf55;
				...
				var v102 := new C0(|(set v101 : string | v101 in (map v99 : string | v99 in [v100[safeIndex(|v95|, |v100|)]] :: (v99) := (false)) :: (v101))|);
			}
			...
			if (v0) {
				...
				var v106 := DC7(set v105 : int | v105 in v104 :: (safeModuloInt(v105, |map[false := [536]]|)));
				var v107: multiset<D3> := multiset{v106};
				f17 := (if (v106 in v107) then v107[v106] else -v1[safeIndex(926, v1.Length)]) * (if (!true) then 0x2ca else |"gxd"|);
				var v108: array<bool> := new bool[14];
				v108[safeIndex(107, v108.Length)] := true;
				v108[safeIndex(107, v108.Length)] := !p0;
				var v109: map<bool, int> := map[false := v1[safeIndex(926, v1.Length)]];
				v109 := v109[v0 := f4];
				v108[safeIndex(107, v108.Length)] := f16;
			} else {
				...
				v112[safeIndex(453, v112.Length)] := v115 + v115;
				v112[safeIndex(453, v112.Length)] := v115;
				v0 := p0;
				var v116: multiset<int> := multiset{f17};
				v0 := v116 > DC32(v116).cf58;
				var v117: seq<int> := [f4];
				var v118: seq<int> := [v1[safeIndex(926, v1.Length)], p2, v1[safeIndex(926, v1.Length)], v117[safeIndex(f4, |v117|)], f4];
				r1 := if (p1 in v113) then v113[p1] else safeModuloInt(|v117|, f15);
			}
			
			var v119 := new C0(v1[safeIndex(926, v1.Length)]);
			var v120: seq<int> := [p2];
			var v121: seq<seq<int>> := [v120, v120, v120, v120];
			var v122: map<bool, bool> := map[true := p0];
			var v123: map<bool, seq<int>> := map[p1 := v121[safeIndex(|v122|, |v121|)]];
			v123 := v123[p1 := v120];
			var v124 := "up";
			var v125 := 'c';
			f17 := |(if (p1) then (v124 + v124)[safeIndex(v1[safeIndex(926, v1.Length)], |(v124 + v124)|) := v125] else v124)|;
		}
		
		var v126: array<multiset<bool>> := new multiset<bool>[17];
		forall i4 | 0 <= i4 < v126.Length {
			v126[i4] := (v3 - v3)[p1 := abs(|("wtjosb" + "tplfnqn")|)];
		}
		var v127: seq<int> := [f15];
		v127 := (seq(abs(0x184), i5  => (DC4(f4, [f16], p2).cf6))) + (v127 + [f17, v1[safeIndex(926, v1.Length)]]);
		var v128: multiset<seq<int>> := multiset{v127, v127[safeIndex(|v127|, |v127|) := f4], v127, v127, v127};
	...
	method m13(p0: int, p1: multiset<map<int, bool>>, p2: bool, globalState: GlobalState) returns (r0: bool, r1: seq<set<bool>>, r2: array<array<int>>) {
		...
		var v1: seq<bool> := [p2];
		v0[safeIndex(331, v0.Length)] := v1;
		v0[safeIndex(331, v0.Length)] := (if (p2) then [!f16] else v1) + [f16];
		var v2: array<int> := new int[24];
		v2[safeIndex(274, v2.Length)] := 0x147;
		var v3: seq<int> := [-f15, p0, f4 + 690, p0, 0x24];
		v2[safeIndex(274, v2.Length)] := v3[safeIndex(f4, |v3|)];
		var v4 := DC33(v2);
		v2 := v4.cf59;
		var v6: array<map<int, D6>> := new map<int, D6>[17](i2 => map[|(map v5 : char | v5 in {'n', 'd'} :: (v5) := (f16))| := DC21(f15, f16)]);
		forall i1 | 0 <= i1 < v6.Length {
			v6[i1] := (map[|map[[f15] := p2]| := DC21(v2[safeIndex(274, v2.Length)], p2)] + map[f4 := DC21(f4, true)]) + ((map v7 : int | v7 in multiset{f17} :: (safeModuloInt(v7, f4)) := (DC21(f17, f16))) + map[p0 := DC21(p0, p2)]);
		}
		var v8 := "qrgi";
		var v9 := DC21(|v8|, f16);
		...
		forall i3 | 0 <= i3 < v12.Length {
			v12[i3] := ((seq(abs(0x376), i5  => ('m'))) + v8) + v8;
		}
		r0 := v2[safeIndex(274, v2.Length)] <= v2[safeIndex(274, v2.Length)];
	...
	method m14(globalState: GlobalState) returns (r0: string, r1: map<int, set<int>>) {
		...
		v3 := if (fm0(f4, f15, globalState)) then v3 else v3[safeIndex(0xe6, |v3|) := v2];
		if (f16 ==> f16) {
			var v4: map<int, bool> := map[f4 := f16];
			var v5: seq<int> := [-0x16f];
			var v6: array<int> := new int[22](i0 => safeModuloInt(i0, f4));
			...
			v12[safeIndex(825, v12.Length)] := v13;
			v12[safeIndex(825, v12.Length)] := v13;
			var v14: seq<seq<int>> := [v5];
			v6[safeIndex(954, v6.Length)] := |(if (v11) then v14[safeIndex(f4, |v14|)] else v5)|;
			v6[safeIndex(954, v6.Length)] := -(fm1(globalState) * (f17 + f15));
			v8 := f4;
			var v15: multiset<bool> := multiset{f16, v11, v11};
			v6[safeIndex(954, v6.Length)] := v5[safeIndex(f4, |v5|)] * (if (true in v15) then v15[true] else -v6[safeIndex(954, v6.Length)]);
		} else {
			var v16 := "huaylrld";
			f17 := |((v16 + v16) + ("dv" + v16))|;
			var v17: map<int, bool> := map[|v16| := fm0(f4, -0x99, globalState)];
			var v18: seq<int> := [941];
			var v19: array<int> := new int[10] [f4, f17, |v17|, f17, f17, f17, |v16[safeIndex(f4, |v16|) := v1]|, v18[safeIndex(f15, |v18|)], f15, f17];
			var v20: set<array<int>> := {v19};
			f17 := -safeDivisionInt(|v20| * f15, 0x35f);
			var v21 := new C0(fm1(globalState));
			v21.f18 := v21.f18;
			var v22: array<D9> := new D9[16];
			var v23: seq<array<D9>> := [v22, v22, v22, v22];
			var v24: array<array<D9>> := new array<D9>[10] [v23[safeIndex(--f4, |v23|)], v22, v22, v22, v23[safeIndex(|fm25(globalState)|, |v23|)], v22, v22, v22, v22, v22];
			...
			v24, v21.f18, v25, f17, v26 := v24, v21.f18, v25, safeModuloInt((DC4(|v29|, [f16], |v30|).(cf8 := -0x3b)).cf8, f4 * f4), fm26(|map[!!f16 := f15]|, false, v31[v18 := v21.f18], f16, globalState) + (v26 + v26);
		}
		...
		for i2 := 140 to v33.f18 {
			...
			v36[safeIndex(892, v36.Length)] := v33.f18 in v37;
			v36[safeIndex(892, v36.Length)] := f16;
			var v38: array<multiset<int>> := new multiset<int>[14];
			v38 := new multiset<int>[14];
		}
		r0 := if (v32) then "eqo" else seq(abs(0x2e5), i3  => (v1));
...
class C2 {
	...
	method m10(p0: array<D0>, p1: string, p2: map<string, set<bool>>, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			var v3, v4, v5, v6 := m0(v0, seq(abs(-0x3c5), i1  => (f14)), v2, globalState);
		...
		for i2 := -(|v12| - v10.f18) to v10.f18 {
			...
			var v18: map<multiset<D0>, bool> := map[if (fm0(|[v14]|, f14, globalState)) then (v17[v15 := abs(v10.f18)])[v15 := abs(v10.f18)] else v17 := (seq(abs(429), i3  => (|p1|))) <= v11];
			...
			decreases 100 - i4
		{
			...
			v25 := v26.cf64[v10.f18 := v24[safeIndex(|v28|, |v24|) := f13]];
			var v29: array<bool> := new bool[15];
			v29[safeIndex(147, v29.Length)] := true;
			v29[safeIndex(147, v29.Length)] := f13;
		}
		var v30: array<string> := new string[1](i5 => "djlrxsrs" + p1);
		v30[safeIndex(108, v30.Length)] := p1;
		v30[safeIndex(108, v30.Length)] := p1 + p1;
		var v31 := 'k';
...
class C3 extends T0 {
	...
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		if (fm0(p1 * p1, f11, globalState)) {
			var v0: seq<bool> := [p0];
			var v1: seq<bool> := [v0[safeIndex(f4, |v0|)], p0];
			...
			v4[safeIndex(472, v4.Length)] := v2;
			v4[safeIndex(472, v4.Length)] := (v2[p0 := v0] + v2) + fm13(globalState);
			...
			if (p2) {
				...
				var v15 := DC12(f12);
				var v16: set<bool> := {p2};
				var v17: array<string> := new seq<char>[28] [f12, f12, v15.cf23, f12, f12, "a", f12[safeIndex(|v16|, |f12|) := v12], f12, f12, "tnnmncn", f12, seq(abs(0x29f), i1  => (v12)), f12, f12, seq(abs(0x1d3), i2  => (v12)), f12, fm23(p2, globalState), f12, f12, "e", f12, "gkj", f12, f12, f12, f12, f12, "beajp"];
				...
				r0 := v21.f16;
				r0 := p3;
				var v22 := new C0(safeModuloInt(f4, |(seq(abs(0xd), i3  => (v12)))|));
			} else {
				r0, r0 := p0, p2;
				f4 := p1;
				...
				v26[safeIndex(460, v26.Length)] := p0;
				var v27: seq<bool> := [p3];
				v26[safeIndex(460, v26.Length)] := v27[safeIndex(f11, |v27|)] <==> p2;
			}
			
			var v28 := DC4(|f12|, [p0, p0], f11);
			var v29: array<int> := new int[1] [p1];
			v29[safeIndex(42, v29.Length)] := f11;
			...
			var v37: seq<seq<bool>> := [v32, [p3], [v34.fm5(f12[safeIndex(0x194, |f12|) := v33], p2, globalState), p2], v32];
			var v38: array<seq<bool>> := new seq<bool>[26] [v32, fm2(v33, 0xcc, p1, globalState), [p2, p0] + v32, if (v34 in v35) then v35[v34] else v32, v32, v32, v32, v32, v32, v32 + v32, v32, v32, v32, v32, fm2(fm27(p0, globalState), v34.f4, |v36|, globalState), v32, v32, v32, v32, v32, v32 + v32[safeIndex(|f12|, |v32|) := p3], [p2], v32 + v32, v37[safeIndex(f4, |v37|)], v32, v32];
			v38[safeIndex(897, v38.Length)] := v32;
			f4, v28, v29[safeIndex(42, v29.Length)], v38[safeIndex(897, v38.Length)] := |map[-|f12| := v34.f4]|, v28.(cf7 := v37[safeIndex(f11, |v37|)]), safeDivisionInt(|"ciegxmx"|, f4), [v32[safeIndex(v34.f4, |v32|)]];
			...
			var v46: map<seq<map<C2, bool>>, int> := map[if (|f12[safeIndex(|[p0]|, |f12|) := v33]| in v43) then v43[|f12[safeIndex(|[p0]|, |f12|) := v33]|] else v44.cf69 := v45[safeIndex(v40.f14, |v45|)]];
			...
			v40.f13, v34.f4, v49, f4 := v34.fm5(f12, p2, globalState), -fm11(v51, p3, globalState), v49, |map[v34.f4 := -v45[safeIndex(f4, |v45|)]]|;
			var v52 := DC17(v47, p2);
			var v53: map<int, D5> := map[v29[safeIndex(42, v29.Length)] := v52];
			var v54: set<map<int, D5>> := {v53};
			var v56: map<map<int, D5>, int> := map[map v55 : int | (0x2d6 <= v55) && (v55 < -0x329) :: (safeDivisionInt(v55, v40.f14)) := (v52) := v34.f4];
			v40.f13 := v54 < (set v57 : map<int, D5> | v57 in v56 :: (v57));
		}
		
		if (p0) {
			var v58: seq<bool> := [p2, p0];
			r0 := if (p0) then false else !v58[safeIndex(f4, |v58|)];
			var v59 := 'f';
			...
			v75[safeIndex(910, v75.Length)] := p1;
			v75[safeIndex(910, v75.Length)] := |f12|;
		}
		
		for i6 := p1 to p1 {
			f4, r0 := |((seq(abs(-0x1a), i7  => ('e'))) + f12)|, p3;
			if (!true) {
				...
				v79[safeIndex(24, v79.Length)] := v81 + v81;
				v79[safeIndex(24, v79.Length)] := v81;
				...
				v86[safeIndex(361, v86.Length)] := v84 * v84;
				var v87: array<int> := new int[10](i8 => safeDivisionInt(i8, i6));
				var v88 := 'v';
				var v89 := DC8(v88, v80);
				var v90: array<char> := new char[15] ['l', v88, v88, v88, v88, v88, v89.cf13, v88, f12[safeIndex(v76[safeIndex(i6, |v76|)], |f12|)], 'p', v88, 'f', v88, v88, v88];
				var v91: map<array<int>, array<char>> := map[v87 := v90];
				v86[safeIndex(361, v86.Length)] := DC42(|v91|, p0, v84, p1).cf74 - v84;
				var v92: array<array<bool>> := new array<bool>[13];
				v92[safeIndex(690, v92.Length)] := v80;
				var v93: multiset<bool> := multiset{p3};
				f4, v77, v92[safeIndex(690, v92.Length)], r0, v93 := f4 * (|v82| + f4), v77 + v77, v80, !(i6 !in (v77 - v77)), v93;
			} else {
				...
				v96[safeIndex(359, v96.Length)] := |(if (v97.cf63) then {p3} else v98)|;
				v96[safeIndex(359, v96.Length)] := p1;
				var v99 := 'a';
				var v100: seq<bool> := [p2, p2, p0];
				var v101: seq<bool> := [!v100[safeIndex(f4, |v100|)]];
				var v102: set<int> := {i6};
				var v103: map<set<int>, bool> := map[v102 := p3];
				var v104: seq<int> := [v96[safeIndex(359, v96.Length)], v96[safeIndex(359, v96.Length)]];
				var v105: array<bool> := new bool[22] [p3, v99 !in f12, p3, !(p2 && p0), p3, p2, p3, p3, !p2, p2, p3, p0, p0 <== p0, p3, p0, !v100[safeIndex(|v103|, |v100|)], v104 < [p1, |f12|], p2, true, p2, p2, p3];
				v105 := v105;
				r0 := v100[safeIndex(f11, |v100|)];
			}
			
			var v106: seq<bool> := [p3];
			r0 := v106[safeIndex(-f11, |v106|)];
			var v107: array<bool> := new bool[1](i9 => p0);
			v107 := new bool[10] [p2, !p2, p3, false, p0, p2, !false, p3, !!true, p2];
		}
		var v108 := 'i';
		var v109: array<char> := new char[15] [v108, v108, f12[safeIndex(f4, |f12|)], fm27(p3, globalState), v108, if (fm0(f4, 0x1bc, globalState)) then 'e' else v108, v108, v108, v108, v108, v108, v108, v108, v108, v108];
		v109[safeIndex(942, v109.Length)] := v108;
		v109[safeIndex(942, v109.Length)] := v108;
		var v110: set<string> := {seq(abs(0x259), i10  => (v109[safeIndex(942, v109.Length)]))};
		if (fm5(f12, {f12, f12} >= v110, globalState)) {
			f4 := f4;
			v109[safeIndex(942, v109.Length)] := v109[safeIndex(942, v109.Length)];
			v109 := v109;
			var v111: seq<bool> := [p2, p3, p0];
			var v112 := new C2(v111[safeIndex(f4, |v111|)], f11);
			var v113: set<char> := {v109[safeIndex(942, v109.Length)], v109[safeIndex(942, v109.Length)], v109[safeIndex(942, v109.Length)]};
			...
			var v118: multiset<char> := multiset{v108, v109[safeIndex(942, v109.Length)], f12[safeIndex(f11, |f12|)], v109[safeIndex(942, v109.Length)]};
			var v119: map<int, int> := map[f11 := f4];
			var v120: seq<map<int, int>> := [v119[0x3e := f4]];
			var v121: array<int> := new int[23] [if (|v116| in v115) then v115[|v116|] else p1, p1, fm1(globalState), f11, f4, v117[safeIndex(|v118|, |v117|)], f4 - p1, fm1(globalState), 925, p1, f11, p1, f11, |f12|, if (p0) then f4 else |v120|, f4, f11, f11 * |v119|, f4, f4, |[p0]|, f11, fm1(globalState)];
			v121[safeIndex(889, v121.Length)] := fm1(globalState);
			v121[safeIndex(889, v121.Length)], r0 := f4, !false;
			v121[safeIndex(889, v121.Length)] := p1;
			...
			if (if (f11 in v122) then v122[f11] else !(false && false)) {
				...
				f4, r0 := safeModuloInt(fm11(v125, p2, globalState), f4), v126.cf31;
				r0 := p0;
				r0 := p0;
			} else {
				...
				v127[safeIndex(657, v127.Length)] := v128 + (map v129 : char | v129 in {v108, v109[safeIndex(942, v109.Length)], v109[safeIndex(942, v109.Length)], v109[safeIndex(942, v109.Length)]} :: (v129) := (298));
				var v130 := "xdr";
				var v131: map<bool, int> := map[p2 := safeDivisionInt(f11, v121[safeIndex(889, v121.Length)])];
				v127[safeIndex(657, v127.Length)], v130, v121[safeIndex(889, v121.Length)], v131 := v128, "amrqusko" + f12, -f4, v131 + map[p3 := p1];
				v130 := (seq(abs(0x1a3), i12  => ('n'))) + f12;
				var v132 := new C2(!p2, safeModuloInt(f11, 0x176));
				var v133: seq<string> := [v130];
				v130 := f12 + v133[safeIndex(f11, |v133|)];
				v121[safeIndex(889, v121.Length)] := f11;
			}
			
			var v134: multiset<bool> := multiset{p3};
			f4 := if (p2 in v134) then v134[p2] else f11;
			f4, v115, v109[safeIndex(942, v109.Length)] := v121[safeIndex(889, v121.Length)], (multiset(v117) * v115) * v115, v108;
		}
		
		r0, v109[safeIndex(942, v109.Length)] := p2, v109[safeIndex(942, v109.Length)];
	...
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		...
		for i0 := if (if (p0 in v0) then v0[p0] else p1) then f4 else p0 to -770 {
			...
			match (v2) {
				case DC42(cf72, cf73, cf74, cf75) =>
					...
					var v7: array<int> := new int[23] [if (cf73) then cf75 else 0x1f8, cf72 * f11, f4, f4, cf75, f4, fm1(globalState), |{p1}|, |"ixctxti"|, f11, -(i0 * p0), cf72, v4[safeIndex(cf72, |v4|)], |fm29(p1, globalState)|, |[cf75]|, 0x119, 0x3, f4, cf72, cf72, f11 - DC27(f11, p0, |v6|).cf51, 211, -0x2b7];
					var v8: seq<map<int, bool>> := [v0];
					v7[safeIndex(113, v7.Length)] := |{-|v8[safeIndex(p0, |v8|)]|, cf72, 406}|;
					var v9: array<bool> := new bool[13];
					v9[safeIndex(958, v9.Length)] := cf73;
					var v10: array<string> := new string[27];
					v10[safeIndex(887, v10.Length)] := f12;
					var v11: multiset<bool> := multiset{p1, true, cf73};
					v7[safeIndex(113, v7.Length)], v9[safeIndex(958, v9.Length)], v10[safeIndex(887, v10.Length)] := (if (true) then -f11 else -f11) * (if (p1 in v11) then v11[p1] else cf75), (if (p1) then cf75 else f11) == i0, f12;
					cf72 := cf72;
				...
				case DC41(cf71) =>
					...
					f4 := safeModuloInt(|v14|, fm11((fm31(false, p1, p0, globalState))[p1 := v15], p1, globalState));
					var v16 := 'x';
					var v17: map<int, char> := map[f4 := v16];
					var v18: seq<string> := [f12, seq(abs(0x95), i1  => (v16)), f12];
					var v19: array<char> := new char[23] [v16, v16, v16, v16, v16, v16, if (p1) then v16 else v16, v16, v16, v16, v16, v16, v16, v16, if (f11 in v17) then v17[f11] else 's', v16, v16, v16, fm27(p1, globalState), v16, f12[safeIndex(|fm16(p1, v18, p1, p0, globalState)|, |f12|)], v16, 'x'];
					...
					v26[safeIndex(338, v26.Length)] := v21;
					v26[safeIndex(338, v26.Length)] := fm32(v16, if (p1) then v22 else v22, globalState);
					var v27 := true;
					var v28 := DC42(|v24|, p1, cf71, i0);
					var v29: seq<set<bool>> := [{p1}, {true}, v28.cf74, {v27, p1}];
					var v30: map<int, string> := map[f11 := f12];
					v27, f4, v27, v27 := v27, |v14|, v29 <= (seq(abs(954), i2  => (cf71))), v30 == map[p0 := f12];
			}
		...
		var v37 := DC8('h', v36);
		var v38: array<string> := new seq<char>[7] [f12, f12 + (seq(abs(-0x320), i4  => ('p')))[safeIndex(f4, |(seq(abs(-0x320), i4  => ('p')))|) := v37.cf13], f12, f12, f12, f12, f12];
		forall i3 | 0 <= i3 < v38.Length {
			v38[i3] := f12 + f12[safeIndex(p0, |f12|) := 'q'];
		}
		var v39 := DC9(p1, f4);
		var v40: seq<int> := [p0];
		var v41: array<int> := new int[4] [if (p1) then -v39.cf16 else f4, -0xf1, -safeModuloInt(f4, p0), v40[safeIndex(f4, |v40|)]];
		v41[safeIndex(628, v41.Length)] := f4;
		v41[safeIndex(628, v41.Length)] := fm1(globalState);
		var v42 := DC33(v41);
		var v43: map<int, array<int>> := map[|f12| := v42.cf59];
		for i5 := safeDivisionInt(f11, v41[safeIndex(628, v41.Length)]) to |v43| {
			var v44: seq<bool> := [p1, !p1];
			v44 := v44 + ([p1, p1, p1, p1])[safeIndex(|f12|, |[p1, p1, p1, p1]|) := p1];
			var v45 := false;
			var v46 := DC21(f11, v45);
			v45 := v46.cf42;
			f4 := v41[safeIndex(628, v41.Length)];
			var v47 := 'n';
			var v48: seq<string> := [f12 + f12, seq(abs(0x49), i6  => ('r')), f12[safeIndex(f4, |f12|) := v47] + (seq(abs(0xa9), i7  => ('n'))), f12];
			v48 := v48;
		}
		var v49 := new C0(f4);
		var i8 := 0;
			...
			decreases 100 - i8
		{
			...
			if (p1) {
				...
				var v53: map<bool, map<bool, bool>> := map[v51[safeIndex(v41[safeIndex(628, v41.Length)], |v51|)] := v52];
				var v54 := DC24(if (p1 in v53) then v53[p1] else v52);
				v54 := DC24(v52);
				v41[safeIndex(628, v41.Length)] := |(seq(abs(0x1c3), i9  => (f12)))|;
				...
				v36[safeIndex(947, v36.Length)] := v62 != v62;
				v36[safeIndex(947, v36.Length)] := p1;
				var v63: map<bool, set<int>> := map[v36[safeIndex(947, v36.Length)] := v62];
				var v64 := DC12(f12);
				var v65: set<bool> := {fm11(v63, p1, globalState) <= f11, !(if (v50) then v36[safeIndex(947, v36.Length)] else true), fm5(v64.cf23, !v36[safeIndex(947, v36.Length)], globalState), p1};
				v65 := {v36[safeIndex(947, v36.Length)], !p1, v36[safeIndex(947, v36.Length)], v36[safeIndex(947, v36.Length)]};
				var v66 := new C2(p1, f11);
				var v67: multiset<int> := multiset{v49.f18, v66.f14, v66.f14};
				var v68: map<bool, int> := map[v36[safeIndex(947, v36.Length)] := |f12|];
				var v69 := 'p';
				var v70: seq<seq<int>> := [[v49.f18], seq(abs(0x270), i10  => (v41[safeIndex(628, v41.Length)]))];
				f4 := -(if (p1) then -|v67| else v49.f18) + (if (v50) then |f12[safeIndex(|v68|, |f12|) := v69]| else |v70|);
			}
			
			var v71: seq<bool> := [false];
			var v72: map<bool, int> := map[p1 := |v71|];
			var v73: map<int, int> := map[-0x34f + v41[safeIndex(628, v41.Length)] := |v72|];
			v73 := v73[p0 := p0 + 0xfd];
			f4 := f11;
		}
		var v74 := DC0(v40);
...
class C4 extends T0, T1 {
	...
	function fm5(p0: string, p1: bool, globalState: GlobalState): bool {
		if (true <== !false) then (set v0 : seq<char> | v0 in multiset{['m', 'e']} :: (v0)) !! {seq(abs(-0x143), i0  => ('x')), ['v', 'o'], ['e', 't']} else true
	}
	function fm10(p0: int, p1: bool, p2: bool, p3: D2, globalState: GlobalState): char {
		'b'
	}
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		for i0 := safeDivisionInt(p1, p1) to f4 {
			f4 := fm1(globalState);
			...
			if (!p0) {
				var v5 := "poldhr";
				f4 := |(v5 + v5)|;
				var v6: array<int> := new int[23](i1 => safeModuloInt(i1, |v5[safeIndex(f4, |v5|) := 't']|));
				...
				v6[safeIndex(594, v6.Length)] := fm1(globalState);
				v8[safeIndex(946, v8.Length)] := p2;
				v13, v6[safeIndex(594, v6.Length)], v8[safeIndex(946, v8.Length)], v12, r0 := v13, f4, p2, v12, p2 <==> p2;
				var v14: map<array<bool>, int> := map[v8 := 0x17a];
				var v15: map<string, bool> := map[seq(abs(-0x37f), i2  => (v12)) := p2];
				v14 := v14[v8 := |(v15 + v15)|];
			} else {
				f4 := i0;
				var v16 := "wljqfik";
				...
				var v20: map<seq<bool>, string> := map[v19[safeIndex(866, |v19|) := p2] := v16];
				var v21: multiset<int> := multiset{v17.f4};
				var v22: set<bool> := {!!p2};
				var v23: seq<multiset<int>> := [multiset{|v22|}];
				var v24 := 's';
				var v25: array<bool> := new bool[22] [p2, !p2, !v17.fm5(if (v19 in v20) then v20[v19] else "r", !p3, globalState), p0, !p2, p0, p0, p0, v17.fm5(v16, p3, globalState), p0, p3, 0x305 >= p1, !!p3, p3, p0, v17.f4 < v17.f4, false, p0, p0, p3, p0, v21 != v23[safeIndex(-|multiset{v24}|, |v23|)]];
				var v26 := DC40(p0);
				v25[safeIndex(589, v25.Length)] := if (p2 in v1) then v1[p2] else v26.cf70;
				v25[safeIndex(589, v25.Length)] := v19[safeIndex(|v16|, |v19|)];
			}
		...
		if (match DC32(v29) {
			...
			if (DC35(|v30|, p0, p3).cf62) {
				r0 := p0;
				f4 := safeModuloInt(f4, if (p0) then p1 else p1);
				f4 := p1;
				var v31 := DC9(p2, p1);
				var v32 := DC6(f4, p0);
				...
				var v37 := DC8(v35, v36);
				v34 := (v34[safeIndex(v33.f14, |v34|) := v35] + (v34 + "coyuqojaw"))[safeIndex(|v30|, |(v34[safeIndex(v33.f14, |v34|) := v35] + (v34 + "coyuqojaw"))|) := v37.cf13];
			} else {
				var v38: array<int> := new int[22];
				var v41: array<map<char, int>> := new map<char, int>[8](i3 => map v39 : char | v39 in (set v40 : char | v40 in {'e'} :: (v40)) :: (v39) := (|(seq(abs(0x2a0), i4  => ('w')))|));
				var v42: seq<bool> := [p3, p0, p3, p2, p3];
				var v43 := "vrtblnli";
				var v44 := 'e';
				var v45: array<string> := new string[28] ["yv", seq(abs(0x4c), i5  => ('u')), v43, v43, "qjvnief", v43, v43, v43, v43, v43, v43[safeIndex(f4, |v43|) := v44], v43, "wtmo", v43, v43, v43, DC12(v43).cf23, "aiywbb", v43, v43, v43, v43, v43, v43, v43, v43, v43, v43];
				var v46 := DC30(p1, v45, p0);
				var v47 := DC31(v46);
				var v48: set<D8> := {v47, v47, v47};
				var v49: array<bool> := new bool[16] [p3, v42[safeIndex(p1, |v42|)], fm0(p1, p1, globalState), p0, p3, p0, p3, p2, p2, p3, p0, v48 >= {v47}, p3, true, p3, f4 > p1];
				v49[safeIndex(776, v49.Length)] := p3;
				r0, v38, v41, v49[safeIndex(776, v49.Length)], r0 := p2 && true, v38, v41, p2, safeModuloInt(f4, fm1(globalState)) < (f4 * p1);
				...
				v52 := v52[p1 > p1 := v38];
				var v53: map<bool, bool> := map[v49[safeIndex(776, v49.Length)] := true];
				var v54 := DC24(v53);
			...
			var v63: set<bool> := {p0};
			var v64: map<seq<array<D8>>, string> := map[v60 := v62[safeIndex(|v63|, |v62|)] + v61];
			v64 := v64[v60 := v61];
			...
			if (p2) {
				...
				var v75 := 'v';
				v74[safeIndex(353, v74.Length)] := v75;
				var v76: multiset<seq<int>> := multiset{v71};
				var v77 := DC10(p1, |v71|, p3, |v76|, p0);
				var v78 := DC6(0x2eb, p2);
				v74[safeIndex(353, v74.Length)] := if (p0) then v75 else v69.fm10(p1, v77.cf19, p0, v78, globalState);
				...
				var v82 := DC13(v81, !v58[safeIndex(f4, |v58|)], fm2(v75, v69.f17, f4, globalState));
				v79[safeIndex(364, v79.Length)] := v82;
				v79[safeIndex(364, v79.Length)] := fm35(fm1(globalState), [f4, 0x206, f4, p1, f4], globalState);
			} else {
				f4 := p1;
				var v83 := 'x';
				...
				r0 := true;
				f4 := p1;
				f4 := safeModuloInt(p1 - p1, p1);
			}
			
		} else {
			var v85: array<bool> := new bool[4];
			v85[safeIndex(0, v85.Length)] := p0;
			v85[safeIndex(0, v85.Length)] := p3;
			var v86: map<int, int> := map[p1 := p1];
			var v87: map<bool, int> := map[v85[safeIndex(0, v85.Length)] := |v86|];
			var v88: multiset<map<bool, int>> := multiset{v87, v87};
			var v89 := new C2(p0, -|(v88 * v88)|);
			f4 := safeModuloInt(p1, f4);
			f4 := (v89.f14 * p1) * p1;
			f4 := v89.f14;
		}
		...
		if (v91 !! v91) {
			...
			var v95 := DC8(v93, v94);
			v92[safeIndex(252, v92.Length)] := DC11(v95);
			var v96 := DC11(v95);
			v92[safeIndex(252, v92.Length)] := v96;
			var v97: seq<bool> := [false];
			var v98: map<bool, int> := map[p0 := p1];
			var v99: array<int> := new int[5] [0x323, p1, |multiset{|v97|, p1}|, |v98|, p1];
			v99[safeIndex(908, v99.Length)] := f4;
			v99[safeIndex(908, v99.Length)] := safeDivisionInt(f4 + p1, safeDivisionInt(f4, p1));
			r0 := (!p3 ==> !p3) <==> !p3;
			v99[safeIndex(908, v99.Length)] := safeDivisionInt(f4, f4);
			r0 := p3;
		} else {
			...
			if (v100 == v100) {
				...
				v103[safeIndex(923, v103.Length)] := "cvdgjyj" !in v100[safeIndex(|v90|, |v100|) := v90];
				var v104: map<int, int> := map[p1 := p1];
				v103[safeIndex(923, v103.Length)] := (v104 + v104) != (v104 + map[p1 := f4]);
				v103[safeIndex(923, v103.Length)] := true;
				v90 := v90;
				v103[safeIndex(923, v103.Length)] := v103[safeIndex(923, v103.Length)];
			} else {
				...
				var v108: map<int, int> := map[p1 := safeModuloInt(if (v27 in v107) then v107[v27] else p1, f4)];
				v108 := v108[p1 := p1];
				f4 := p1;
			}
			...
			v112[safeIndex(222, v112.Length)] := p1;
			v112[safeIndex(222, v112.Length)] := p1;
			v112[safeIndex(222, v112.Length)] := -(safeDivisionInt(p1, f4) + p1);
			r0 := !!(!p2 && !p2);
		}
		
		var v113: array<bool> := new bool[11](i10 => p3);
		var v114: set<bool> := {p0, p3};
		v113[safeIndex(97, v113.Length)] := fm17(!p3, f4, globalState) >= v114;
		var v115: seq<int> := [p1];
		var v116: map<int, int> := map[v115[safeIndex(p1, |v115|)] := f4];
		var v117: C1 := new C1(|v116|, f4, f4, p0);
		var v118: multiset<C1> := multiset{v117, v117};
		var v119 := DC25(p3, fm0(p1, |v118|, globalState), p1);
		v113[safeIndex(97, v113.Length)] := safeDivisionInt(v119.cf47, v117.f17) !in v116;
		r0 := p3;
	}
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		var v0 := 'w';
		...
		v2 := map[v1 := safeModuloInt(f4, p0)];
		var v3: array<int> := new int[14];
		v3[safeIndex(960, v3.Length)] := p0;
		var v4 := DC29();
		v3[safeIndex(960, v3.Length)], v4, v1, f4 := f4 + f4, v4, v1, -(f4 * f4);
		...
		var v9 := DC19(v8);
		v9 := v9;
		v3[safeIndex(960, v3.Length)] := v3[safeIndex(960, v3.Length)];
		var v10 := true;
		var v11 := "axuvbeb";
		v10 := fm5(v11, v10 ==> p1, globalState);
		var v12: seq<int> := [v3[safeIndex(960, v3.Length)], v3[safeIndex(960, v3.Length)]];
		var v13 := DC0(v12);
		var v14: seq<D0> := [v13];
		r0 := v14;
		var v15: seq<string> := [seq(abs(0x29d), i1  => (v0))];
		r1 := v15[safeIndex(p0, |v15|)];
		r2 := v3;
	}
	method m7(p0: int, p1: string, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: array<array<bool>>, r2: array<int>, r3: int) {
		var v0: map<int, seq<set<bool>>> := map[p0 := seq(abs(552), i0  => ({p2}))];
		var v1: set<bool> := {p2};
		var v2: seq<set<bool>> := [v1, {p2}];
		var v3: seq<int> := [|(if (f4 in v0) then v0[f4] else v2[safeIndex(f4, |v2|) := v1])[safeIndex(-p0, |(if (f4 in v0) then v0[f4] else v2[safeIndex(f4, |v2|) := v1])|) := v1]|];
		var v4 := new C0(safeDivisionInt(f4, |v3|));
		var v5: array<int> := new int[26];
		var v6: map<array<int>, bool> := map[v5 := p2];
		for i1 := f4 to |map[p3 := p3]| - |v6| {
			var v7 := "vemqmita";
			v7 := "ukdvqvx";
			var v8: array<map<int, string>> := new map<int, string>[2](i2 => map[f4 := v7[safeIndex(v4.f18, |v7|) := 'm']]);
			var v9: map<int, string> := map[v4.f18 := "mblbnj"];
			v8[safeIndex(932, v8.Length)] := v9 + v9;
			v8[safeIndex(932, v8.Length)] := map v10 : int | v10 in (seq(abs(528), i3  => (v4.f18)))[safeIndex(v4.f18, |(seq(abs(528), i3  => (v4.f18)))|) := |v7|] :: (safeModuloInt(v10, 0x100)) := (p1);
			var v11 := true;
			v11 := p3;
			var v12 := 'l';
		...
		v5[safeIndex(358, v5.Length)] := p0;
		v5[safeIndex(358, v5.Length)] := v4.f18;
		var v16 := DC1(|fm17(p2, |p1|, globalState)|, v5[safeIndex(358, v5.Length)], p3);
		f4 := v16.cf2;
		f4 := 0x1ee + p0;
		if (p3) {
			var v17 := DC41({p2});
			match (v17.(cf71 := {!p3, p3})) {
				...
				case DC41(cf71) =>
					...
					var v26 := DC42(safeDivisionInt(v5[safeIndex(358, v5.Length)], f4), v23, cf71 + cf71, f4);
			...
			match (v17.(cf71 := v1)) {
				case DC42(cf72, cf73, cf74, cf75) =>
					...
					v42[safeIndex(267, v42.Length)] := v39.f12;
					...
					v43[safeIndex(793, v43.Length)] := v44 >= {cf72, |v46|};
					v42[safeIndex(267, v42.Length)], cf73, v43[safeIndex(793, v43.Length)] := "nikmu", v36, v4.f18 >= |v39.f12|;
					r3 := f4;
				case DC41(cf71) =>
					var v47: map<bool, int> := map[v37.f13 := -v4.f18];
					var v48: map<array<int>, int> := map[v5 := if (true in v47) then v47[true] else p0];
					v48 := v48[v5 := v4.f18];
					var v49 := new C1(|p1|, safeModuloInt(v5[safeIndex(358, v5.Length)], v5[safeIndex(358, v5.Length)]), f4, p3);
			...
			if (!!fm0(-v5[safeIndex(358, v5.Length)], if (v51 in v52) then v52[v51] else v5[safeIndex(358, v5.Length)], globalState)) {
				v4.f18 := fm1(globalState);
				v51 := !(true && v51);
				v51 := true;
				var v53 := m9(globalState);
				var v54: array<map<string, seq<int>>> := new map<string, seq<int>>[3];
				v54[safeIndex(149, v54.Length)] := map[p1 := v3];
				var v55: map<string, seq<int>> := map[p1 := v3];
				v54[safeIndex(149, v54.Length)] := v55 + v55;
			} else {
				...
				var v68: array<map<bool, int>> := new map<bool, int>[16] [map[p2 := if (p0 in v63) then v63[p0] else v4.f18], map[v51 := |v63|] + v64, v64, v64 + map[p3 := v4.f18], map[v51 := v4.f18], v64 + v64, if (p3) then v64 else v64, (map[p3 := v4.f18])[v66.cf63 := -0x3f] + v67[safeIndex(|p1|, |v67|)], v64, if (p2) then v64 else v64, v64 + v64, v64, v64, v64, v64 + v64, map[v51 := v4.f18] + map[p3 := if (|p1[safeIndex(|p1|, |p1|) := v61]| in v63) then v63[|p1[safeIndex(|p1|, |p1|) := v61]|] else v5[safeIndex(358, v5.Length)]]];
				v68 := new map<bool, int>[19];
				v51 := p2;
				var v69: set<int> := {-f4, p0, f4, v5[safeIndex(358, v5.Length)] - v4.f18};
				var v70: map<bool, string> := map[p3 := "cp"];
				var v71: seq<string> := [if (false in v70) then v70[false] else seq(abs(0x105), i5  => ('s'))];
				v69 := fm16(p1 < p1, v71, p3, p0, globalState);
				var v72: map<array<bool>, int> := map[v57[safeIndex(p0, |v57|)] := |v65|];
				v4.f18 := if (v72 == v72) then -v5[safeIndex(358, v5.Length)] else 512 * |v69|;
			}
			
			var v73 := 'k';
			var v74: seq<bool> := [v51, p3, p2, p3, true];
			var v75: map<bool, bool> := map[v51 := p3];
			var v76: map<int, int> := map[|v75| := v5[safeIndex(358, v5.Length)]];
			var v77 := DC6(0x218, p3);
			var v78: set<char> := {v73, fm10(v5[safeIndex(358, v5.Length)], p3, v74[safeIndex(|v76|, |v74|)], v77, globalState)};
			var v79: array<bool> := new bool[6];
			v79[safeIndex(237, v79.Length)] := p2;
			v5[safeIndex(358, v5.Length)], v51, v78, v79[safeIndex(237, v79.Length)] := v4.f18, v51, v78, !v74[safeIndex(|p1[safeIndex(fm1(globalState), |p1|) := v73]|, |v74|)];
			v1, v4.f18 := v1, v4.f18;
		}
		...
		r1 := new array<bool>[13] [v80, v80, v80, if (p2) then v80 else v80, v80, v80, v80, v80, v80, v80, v80, v81[safeIndex(-p0, |v81|)], if (p3) then v80 else v80];
		r2 := v5;
		r3 := p0;
	}
	method m8(p0: array<bool>, globalState: GlobalState) {
		...
		if (v0) {
			if (v0) {
				...
				var v2: seq<bool> := [v0];
				var v3: array<multiset<bool>> := new multiset<bool>[13] [v1, v1, v1, v1 + v1, v1 - v1, v1, v1, v1 * multiset(v2), multiset{true, v0}, v1, (multiset{v0})[v2[safeIndex(f4, |v2|)] := abs(f4)], v1, fm25(globalState)];
				v3[safeIndex(828, v3.Length)] := v1 + multiset{true};
				v3[safeIndex(828, v3.Length)] := v1;
				f4 := (if (v0) then f4 else f4) + (-|[v0, v0]| + f4);
				var v4 := new C0(530);
				p0[safeIndex(486, p0.Length)] := v4.f18 >= v4.f18;
				p0[safeIndex(486, p0.Length)] := f4 <= f4;
			} else {
				...
				var v10 := DC45(v8);
				var v11 := 'r';
				v5, v6, f4, v8, v0 := v5, v9[safeIndex(f4, |v9|)], f4, v10.cf78, ({v11, v11} > {'w'}) <==> false;
			...
			var v16 := new C1(if (v0) then |v15| else f4, f4, safeDivisionInt(f4, f4), -0x3b1 > f4);
			var v17 := "y";
			if ((v17 + v17) < v17) {
				v0 := v0;
				v0 := v0;
				...
				var v20: array<int> := new int[12] [v16.f17 * v16.f17, -v16.f17, v16.f17, fm1(globalState), v16.f17 - v16.f17, f4 - |[p0]|, f4, v16.f17, v16.f17, v16.f17, v16.f17, |fm23(v19[safeIndex(v16.f17, |v19|)], globalState)|];
				v20[safeIndex(493, v20.Length)] := f4;
				v20[safeIndex(493, v20.Length)] := safeModuloInt(safeDivisionInt(v16.f17, v16.f17), safeModuloInt(v16.f17, -0x4a));
				p0[safeIndex(25, p0.Length)] := v0;
				var v21: seq<int> := [|v15|];
				p0[safeIndex(25, p0.Length)] := fm0(v21[safeIndex(0x1a8, |v21|)], v16.f17, globalState);
			} else {
				v0 := true;
			...
			match (DC36(v33)) {
				...
				case DC38(cf68) =>
					p0[safeIndex(128, p0.Length)] := true;
					var v38 := "vejy";
					var v39: set<seq<bool>> := {v32};
					cf68, p0[safeIndex(128, p0.Length)], cf68, v38 := safeModuloInt(v30.f14, v30.f14), v39 >= (v39 * v39), cf68, (seq(abs(0x388), i1  => ('u'))) + fm23(v0, globalState);
					var v40 := new C2(p0[safeIndex(128, p0.Length)], v30.f14);
					var v41 := 'j';
					var v42: map<bool, string> := map[v30.f13 := v38[safeIndex(f4, |v38|) := v41]];
					var v43: map<int, string> := map[f4 := v38];
					var v44: map<bool, int> := map[true := f4];
					v30.f13 := fm5(if (v30.f13) then if (p0[safeIndex(128, p0.Length)] in v42) then v42[p0[safeIndex(128, p0.Length)]] else if (|v38| in v43) then v43[|v38|] else v38 else v38, v30.f14 != (if (false in v44) then v44[false] else v30.f14), globalState);
					v38 := (v38 + v38) + [v41, v41];
				case DC36(cf64) =>
					var v45: array<int> := new int[21];
					v45[safeIndex(731, v45.Length)] := safeModuloInt(f4, v30.f14);
					v45[safeIndex(731, v45.Length)] := safeModuloInt(f4, v30.f14);
					var v46 := "namqbvvvj";
					v46 := v46;
					var v47 := DC25(v0, v0, v45[safeIndex(731, v45.Length)]);
					...
					var v54 := DC26(|v53|, v45[safeIndex(731, v45.Length)]);
					var v55 := DC40(v30.f13);
					var v56: array<D7> := new D7[14] [v54, fm32(v46[safeIndex(v30.f14, |v46|)], v55, globalState), v54, v54, v54, v54, v54, DC26(v45[safeIndex(731, v45.Length)], 747), v54, v54, v54, DC26(0x62, v30.f14), v54, v54];
					v56[safeIndex(83, v56.Length)] := v54;
					v56[safeIndex(83, v56.Length)] := v54;
			}
			
			f4 := safeDivisionInt(safeDivisionInt(v30.f14, v30.f14), v30.f14);
		...
		if (v0) {
			...
			if (f4 >= |v59|) {
				...
				v60 := v60;
				v0 := v0;
				var v61: seq<string> := ["alysl", v59[safeIndex(-f4, |v59|) := 'g']];
				var v62: map<int, string> := map[f4 := v59];
				var v63: array<string> := new string[23] [v59, if (v0) then v59 else v59, "o" + "yjgfl", "rrhfbmkka" + v59, v59, v59, v59, v61[safeIndex(f4, |v61|)], if (v0) then v59 else seq(abs(0x3d1), i3  => (v60)), v59, v59, v59, fm23(v0, globalState), if (f4 in v62) then v62[f4] else v59, v59, if (false) then v59 else v59, "y", ("ylipchha" + v59)[safeIndex(fm1(globalState), |("ylipchha" + v59)|) := v60], v59, v59, v59, (seq(abs(0x2e8), i4  => (v60))) + v59, v59];
				v63[safeIndex(878, v63.Length)] := v59;
				...
				var v69: array<array<seq<bool>>> := new array<seq<bool>>[25] [v66, v66, v66, v66, v66, v66, v66, v66, v66, v66, if (false) then v66 else v66, v67.cf83, v66, v66, v66, v66, v66, v66, v68[safeIndex(-656, |v68|)], v66, v66, v66, v66, v66, v66];
				v69[safeIndex(784, v69.Length)] := v66;
				var v70: set<int> := {f4, if (v0) then f4 else fm1(globalState), f4};
				var v71: array<char> := new char[13](i5 => v59[safeIndex(f4, |v59|)]);
				var v72: multiset<array<char>> := multiset{v71, v71};
				var v73 := DC10(f4, -f4, v0, f4, v0);
				v63[safeIndex(878, v63.Length)], v0, v69[safeIndex(784, v69.Length)], v70 := v59 + v59, v0, v66, {(if (v71 in v72) then v72[v71] else f4) - v73.cf18};
				var v74: multiset<int> := multiset{f4, -0x82, f4};
				var v75: array<int> := new int[10] [|v74|, fm1(globalState), safeDivisionInt(f4, f4), safeModuloInt(f4, f4), f4, f4, |v59|, fm1(globalState), f4 - f4, |v59[safeIndex(f4, |v59|) := v60]|];
				v75[safeIndex(326, v75.Length)] := f4;
				var v76: array<bool> := new bool[8] [false, v0, v0, v0, v0, v64[safeIndex(|v70|, |v64|)], true, v0];
				v75[safeIndex(326, v75.Length)], v63[safeIndex(878, v63.Length)], v76 := ---0x1c0, ((seq(abs(0x297), i6  => (v60)))[safeIndex(f4, |(seq(abs(0x297), i6  => (v60)))|) := v60])[safeIndex(|v63[safeIndex(878, v63.Length)]|, |(seq(abs(0x297), i6  => (v60)))[safeIndex(f4, |(seq(abs(0x297), i6  => (v60)))|) := v60]|) := v60], if (fm0(f4, |v70|, globalState)) then p0 else v76;
				v0 := v0 <== v0;
			} else {
				var v77 := new C1(f4, f4, |(v59 + fm23(v0, globalState))|, v0);
				v0 := false;
				v0 := v0;
				f4 := safeModuloInt(f4, if (v0) then f4 else f4);
				var v78 := 'd';
				var v79: array<int> := new int[24](i7 => safeDivisionInt(i7, v77.f17));
				v79[safeIndex(375, v79.Length)] := -0x3c1;
				var v80: multiset<bool> := multiset{v0};
				var v81 := DC17(v80, v0);
				var v82: seq<D5> := [v81];
				v0, v77.f17, v78, v79[safeIndex(375, v79.Length)], f4 := [v81] != v82, f4, 't', fm1(globalState), safeDivisionInt(0x18d, -v77.f17 - f4);
			}
			
			if (v0) {
				var v83: array<T1> := new T1[4];
				var v84: multiset<bool> := multiset{v0};
				var v85: T1 := new C1(if (true in v84) then v84[true] else |(seq(abs(459), i8  => ('b')))|, |v59|, f4, v0);
				v83[safeIndex(261, v83.Length)] := v85;
				var v86 := 'y';
				var v87: set<char> := {v86, v86};
				var v88: set<bool> := {v0, v0};
				v0, v59, v0, v0, v83[safeIndex(261, v83.Length)] := v0, v59 + v59, {v86, v86} >= v87, (f4 - |v88|) != f4, if (v0) then v85 else v85;
				v59 := (v59 + "sdxe") + (v59 + "vat");
				v0 := safeDivisionInt(fm1(globalState), f4) <= -f4;
				var v89: seq<int> := [-|"wiu"|];
				...
				var v97: array<int> := new int[23] [v85.f4, v85.f4, v85.f4, v89[safeIndex(f4, |v89|)], |v59|, -(f4 * |v59|), |v91|, v85.f4, f4, safeModuloInt(v85.f4, f4), v85.f4, v85.f4, -(if (|map[|{v0}| := v95]| in v92) then v92[|map[|{v0}| := v95]|] else v85.f4), safeModuloInt(f4, v85.f4), safeDivisionInt(-|v59|, v95.f15), f4, v95.f15, v85.f4, safeDivisionInt(0x20e, 0x20c), |v89|, v85.f4, v96.cf41, v95.f15];
				var v98: map<bool, int> := map[v0 := v85.f4];
				v97[safeIndex(9, v97.Length)] := |v98|;
				p0[safeIndex(326, p0.Length)] := v93 < v93;
				v97[safeIndex(9, v97.Length)], p0[safeIndex(326, p0.Length)] := safeDivisionInt(v85.f4, f4), v0;
				...
				var v104 := DC50(v100);
				var v105: array<array<D8>> := new array<D8>[23] [v100, v100, v100, v100, v100, v101[safeIndex(|v102|, |v101|)], v100, v100, v100, if (v97[safeIndex(9, v97.Length)] in v103) then v103[v97[safeIndex(9, v97.Length)]] else v100, v100, v100, v100, if (v95.f16) then v100 else v100, v104.cf89, v100, v100, v100, v100, v100, v100, v100, v100];
				v105[safeIndex(338, v105.Length)] := v104.cf89;
				v105[safeIndex(338, v105.Length)] := v100;
			} else {
				...
				var v111 := 'o';
				var v112: array<int> := new int[21] [v106.f18, -v108.f11, -0x347, v108.f11, |v109[safeIndex(f4, |v109|) := v108.f11]|, |v110|, -|v109|, |"mfumfjre"|, v108.f11, |(seq(abs(0x144), i9  => (f4)))|, 0x20f, v108.f11, -v108.f11, |fm2(v111, v106.f18, |v108.f12|, globalState)|, f4, f4, v108.f11, v108.f11, v106.f18, f4, v108.f11];
				...
				v113[safeIndex(977, v113.Length)] := v112;
				var v114: array<D11> := new D11[1];
				var v115 := DC35(v108.f11, v0, v0);
				v114[safeIndex(927, v114.Length)] := v115;
				v0, v113[safeIndex(977, v113.Length)], v114[safeIndex(927, v114.Length)], v0 := !!v0, v112, if (fm0(-f4, v106.f18, globalState)) then v115.(cf63 := v0, cf62 := v0) else v115, v0 && v0;
				var v116: map<bool, array<int>> := map[v0 := v113[safeIndex(977, v113.Length)]];
				v112 := if (v0 in v116) then v116[v0] else v113[safeIndex(977, v113.Length)];
				var v117: map<bool, bool> := map[v0 := v0];
				var v118: seq<map<bool, bool>> := [v117];
				var v119: seq<seq<map<bool, bool>>> := [v118, v118];
				var v120 := new C1(v106.f18, |v119[safeIndex(-v106.f18, |v119|)]|, safeDivisionInt(v106.f18, 0x165), true);
				v120.f17 := f4;
			}
			
			var v121: map<string, int> := map[seq(abs(700), i10  => ('b')) := f4];
			v121 := v121[v59 := f4];
			...
			v128[safeIndex(87, v128.Length)] := p0;
			...
			v128[safeIndex(87, v128.Length)], v129, v131 := v132[safeIndex(fm1(globalState), |v132|)], v129, v131;
		...
		f4 := f4;
		f4 := -(f4 + f4);
		if (v139[safeIndex(f4, |v139|)]) {
			var v141 := "eijm";
			p0[safeIndex(669, p0.Length)] := v0;
			var v142: array<int> := new int[18];
			v142[safeIndex(891, v142.Length)] := f4;
			var v143: map<string, int> := map[v141 := f4];
			var v144 := 'h';
			var v145: multiset<char> := multiset{v144};
			var v146: map<int, char> := map[f4 := v144];
			v141, f4, p0[safeIndex(669, p0.Length)], v142[safeIndex(891, v142.Length)], f4 := "quc" + v141, 0x258, !(v141 !in v143), f4, |v141| + |(if (v0) then v145 else multiset{if (f4 in v146) then v146[f4] else 'h'})|;
			var v147: map<int, bool> := map[safeModuloInt(v142[safeIndex(891, v142.Length)], f4) := v0];
			v0 := if (-0x377 in v147) then v147[-0x377] else if (p0[safeIndex(669, p0.Length)]) then v0 else v0;
			v142[safeIndex(891, v142.Length)] := v142[safeIndex(891, v142.Length)];
			v142[safeIndex(891, v142.Length)] := v142[safeIndex(891, v142.Length)] - f4;
			...
			var v153 := DC45(map v150 : char | v150 in (if (f4 in v151) then v151[f4] else v152) :: (v150) := (multiset{v0, p0[safeIndex(669, p0.Length)]}));
			var v154: multiset<bool> := multiset{p0[safeIndex(669, p0.Length)], p0[safeIndex(669, p0.Length)], v0, p0[safeIndex(669, p0.Length)], false};
			var v155: map<char, multiset<bool>> := map[v144 := v154];
			var v156: map<int, D17> := map[f4 := v153.(cf78 := v155)];
			v149[safeIndex(293, v149.Length)] := v156 + v156;
			var v157: multiset<int> := multiset{v142[safeIndex(891, v142.Length)], v142[safeIndex(891, v142.Length)], f4, v142[safeIndex(891, v142.Length)], v142[safeIndex(891, v142.Length)]};
			var v158: map<int, array<int>> := map[f4 := v142];
			var v159: map<bool, array<int>> := map[p0[safeIndex(669, p0.Length)] := v142];
			var v160: array<array<int>> := new array<int>[22] [v142, v142, v142, if (v142[safeIndex(891, v142.Length)] in v158) then v158[v142[safeIndex(891, v142.Length)]] else v142, v142, v142, v142, v142, v142, if (p0[safeIndex(669, p0.Length)]) then v142 else v142, v142, v142, if (p0[safeIndex(669, p0.Length)] in v159) then v159[p0[safeIndex(669, p0.Length)]] else v142, v142, v142, v142, v142, v142, v142, v142, v142, v142];
			var v161: map<bool, bool> := map[v0 := false];
			var v162 := DC4(0x3a7, v139, v142[safeIndex(891, v142.Length)]);
			var v163: C0 := new C0(v142[safeIndex(891, v142.Length)]);
			v148, v149[safeIndex(293, v149.Length)], v157, v160 := if (p0[safeIndex(669, p0.Length)]) then v148 else v148, v156, v157 - (if (if (false in v161) then v161[false] else DC48(p0[safeIndex(669, p0.Length)], false, v162, v163).cf84) then v157 else v157), v160;
		} else {
			var v164 := 'a';
			...
			var v170: seq<int> := [0x259, |v167|, |v169[safeIndex(f4, |v169|)]|, f4, -0x17f];
			var v171 := new C1(v170[safeIndex(f4, |v170|)], f4, f4, v0);
			var v172: seq<char> := ['a'];
			var v173 := DC38(v171.f17);
			var v174: seq<D12> := [v173, DC38(f4)];
			var v175 := new C3(|v169[safeIndex(|v139|, |v169|)]|, (['g'])[safeIndex(v171.f17, |['g']|) := v164] + v172, |v174| + f4);
	...
	method m9(globalState: GlobalState) returns (r0: char) {
		...
		v0[safeIndex(908, v0.Length)] := v3;
		v3[safeIndex(699, v3.Length)] := v1;
		var v4 := 'j';
		v0[safeIndex(908, v0.Length)], v3[safeIndex(699, v3.Length)] := DC8(v4, v3).cf14, !v1;
		var v5: set<bool> := {v1};
		var v6: map<int, bool> := map[|v5| := v1];
		var v7 := "ttanqrjm";
		var v8: map<int, int> := map[|v6| := |v7|];
		var v9: map<bool, bool> := map[v3[safeIndex(699, v3.Length)] := v3[safeIndex(699, v3.Length)]];
		var v10: seq<int> := [|v9|, |v6|];
		var v11: set<int> := {|v7|, v10[safeIndex(f4, |v10|)], f4, f4, f4};
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v13: multiset<bool> := multiset{v3[safeIndex(699, v3.Length)]};
			match (DC17(v13, true)) {
				case DC16(cf29, cf30, cf31, cf32, cf33) =>
					var v14: array<int> := new int[9](i1 => i1 - f4);
					v14[safeIndex(180, v14.Length)] := f4;
					v14[safeIndex(180, v14.Length)] := 0x384;
					var v15: map<bool, int> := map[cf29 := v14[safeIndex(180, v14.Length)]];
					var v16 := DC51(f4, cf32);
					var v17 := DC38(cf32);
					var v18: array<D12> := new D12[15] [DC38(if (v1 in v15) then v15[v1] else v14[safeIndex(180, v14.Length)]), fm38(v16, v7, v1, globalState), v17, v17, if (cf30) then v17 else v17, v17, v17, v17, v17, v17, v17, v17, fm38(DC51(-cf32, |v7|), v7, v3[safeIndex(699, v3.Length)], globalState), fm38(v16, fm23(true, globalState), fm0(f4, f4, globalState), globalState), v17.(cf68 := |v7|)];
					v18[safeIndex(343, v18.Length)] := v17;
					var v19: multiset<int> := multiset{v14[safeIndex(180, v14.Length)]};
					var v20 := DC33(v14);
					var v21: seq<D10> := [v20];
					var v22: seq<multiset<int>> := [multiset{v14[safeIndex(180, v14.Length)], f4} * v19, v19, multiset{v14[safeIndex(180, v14.Length)], |v21|, |v6|}];
					var v23 := DC6(-0x359, cf33);
					var v24: seq<bool> := [cf30, v23.cf11, v3[safeIndex(699, v3.Length)], cf33];
					v18[safeIndex(343, v18.Length)], cf33, f4, v22 := v17, (v24 + v24) <= v24, f4, seq(abs(-0x35e), i2  => (v19 * v19));
					var v25: seq<seq<int>> := [seq(abs(0x1a9), i3  => (|multiset{v4, v4}|)), v10];
					var v26: map<int, seq<seq<int>>> := map[f4 := v25];
					var v27 := DC53(if (f4 in v26) then v26[f4] else v25);
					v25 := (v25 + v27.cf96) + v25;
					v14[safeIndex(180, v14.Length)] := safeDivisionInt(0x1de, safeDivisionInt(v14[safeIndex(180, v14.Length)], cf32));
				case DC17(cf34, cf35) =>
					v1 := cf35;
					v3[safeIndex(699, v3.Length)], v4, cf35, v8, f4 := cf35, v4, (f4 > f4) <== cf35, if (v13 > multiset{v3[safeIndex(699, v3.Length)], true}) then v8 else map v28 : int | (0x26d <= v28) && (v28 < 0x1f0) :: (safeModuloInt(v28, -f4)) := (|v11|), v10[safeIndex(f4, |v10|)];
					var v29: array<int> := new int[27](i4 => i4 - |v8|);
					v29 := if (v1) then v29 else v29;
					f4 := 0x8d;
				case DC18(cf36, cf37, cf38) =>
					v6 := v6[cf36.f18 := v3[safeIndex(699, v3.Length)]];
					var v30 := DC8(v4, v0[safeIndex(908, v0.Length)]);
					var v31: map<map<int, int>, seq<int>> := map[map[-f4 := f4] := seq(abs(0x1a7), i5  => (cf36.f18))];
					...
					var v36: array<multiset<int>> := new multiset<int>[8] [v34, v35[safeIndex(cf36.f18, |v35|)], v34, v34, v34, v34, v34, v34];
					var v37 := DC15(v36);
					var v38 := DC19(v37);
					var v39 := DC19(v37);
					var v40: seq<D5> := [v39];
					v40 := ([v39])[safeIndex(cf36.f18, |[v39]|) := v39];
				case DC15(cf28) =>
					var v41: array<string> := new string[4];
					v41[safeIndex(185, v41.Length)] := fm23(false, globalState);
					...
					var v49: array<D16> := new D16[16] [v45, v45, DC44(map[911 := v43]).(cf77 := v46[safeIndex(|v7|, |v46|)]), v45, v45, v45, DC44(v44), v45, v45.(cf77 := map[f4 := v48[safeIndex(f4, |v48|)]]), v45, v45, v45.(cf77 := v44), v45, v45, v45, v45];
					v41[safeIndex(185, v41.Length)], f4, v49 := v7, -379 - 265, v49;
					var v50: seq<string> := [v7];
					f4 := |(v50 + v50)|;
					v3[safeIndex(699, v3.Length)] := v3[safeIndex(699, v3.Length)];
				...
				case DC19(cf39) =>
					...
					v52[safeIndex(418, v52.Length)] := v53;
					v3[safeIndex(699, v3.Length)], f4, v52[safeIndex(418, v52.Length)] := v3[safeIndex(699, v3.Length)], 531, (v53 - fm39(f4, globalState)) + v53[seq(abs(-77), i6  => (v4)) := abs(f4)];
					v7 := v7 + "mcpxtxnu";
			}
			
			v5 := v5 - ({v3[safeIndex(699, v3.Length)]} - v5);
			if (v1) {
				var v54: array<int> := new int[13];
				v54[safeIndex(834, v54.Length)] := f4;
				v54[safeIndex(834, v54.Length)] := |v5|;
				...
				var v60: seq<bool> := [v3[safeIndex(699, v3.Length)], v3[safeIndex(699, v3.Length)], (set v57 : map<char, int> | v57 in v56 :: (v57)) >= DC58(v59).cf106];
				v1, v3, v60, v1, v1 := fm5(v7, v3[safeIndex(699, v3.Length)], globalState), v0[safeIndex(908, v0.Length)], ([v3[safeIndex(699, v3.Length)], v1] + [v1, v1]) + v60, false, v1;
				v3 := v0[safeIndex(908, v0.Length)];
				var v61: set<array<bool>> := {v0[safeIndex(908, v0.Length)]};
				var v62: map<array<int>, set<array<bool>>> := map[v54 := v61];
				v62 := v62[v54 := v61];
				v54[safeIndex(834, v54.Length)] := -(403 + (-f4 * v54[safeIndex(834, v54.Length)]));
			} else {
				v1, v11, v1, v1, f4 := v3[safeIndex(699, v3.Length)], v11, v1, v1, safeModuloInt(f4, f4);
				v6 := v6[f4 := v3[safeIndex(699, v3.Length)]];
				f4 := -f4;
				var v63: seq<array<bool>> := [v3];
				v63 := v63;
				v3[safeIndex(699, v3.Length)] := DC37(v1, v3[safeIndex(699, v3.Length)], v1).cf65 && v3[safeIndex(699, v3.Length)];
			}
			
			var v64: map<bool, map<int, bool>> := map[v1 := map[f4 := v3[safeIndex(699, v3.Length)]]];
			v1 := v3[safeIndex(699, v3.Length)] !in (v64 + v64);
		}
		f4 := -0x89;
		...
		for i7 := |(v65 * multiset(v10))| to f4 - f4 {
			...
			f4 := safeModuloInt(safeModuloInt(v66.f14, f4), f4);
			var v67 := new C0(i7);
		}
		for i8 := f4 * |v8| to -0x204 {
			var v68 := new C2(v3[safeIndex(699, v3.Length)], f4);
			var v72: array<map<int, bool>> := new map<int, bool>[23] [map[0x265 := true], v6, fm37(v1, v68.f13, 0x313, globalState), v6, v6, v6, v6, v6, fm37(v3[safeIndex(699, v3.Length)], v3[safeIndex(699, v3.Length)], v68.f14, globalState), v6, v6, v6, v6, v6, v6, v6, map v69 : int | (0x77 <= v69) && (v69 < 0x57) :: (safeDivisionInt(v69, f4)) := (true), map v70 : int | (356 <= v70) && (v70 < 0x390) :: (safeModuloInt(v70, |(seq(abs(0x15d), i9  => (v4)))|)) := (v68.f13), v6, map v71 : int | v71 in v10 :: (safeModuloInt(v71, 0x19a)) := (v3[safeIndex(699, v3.Length)]), v6, v6, v6];
			var v73: map<array<map<int, bool>>, bool> := map[v72 := v3[safeIndex(699, v3.Length)]];
			v3[safeIndex(699, v3.Length)] := if (v72 in v73) then v73[v72] else v1 <== false;
			var v74 := new C1(f4, v68.f14, 865, v1);
			var v75: array<int> := new int[7](i10 => safeModuloInt(i10, f4));
			var v76: map<set<bool>, array<int>> := map[{v3[safeIndex(699, v3.Length)], v3[safeIndex(699, v3.Length)], v1, v1, true} := v75];
			v76 := v76;
		}
		var v77: map<bool, int> := map[fm2(v4, f4, 135, globalState) < [v3[safeIndex(699, v3.Length)]] := f4];
		v77 := map[v1 := -f4 + f4];
		r0 := v4;
	}
}
...
class C5 extends T0 {
	...
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		if (p3) {
			...
			if (v1 > v1) {
				...
				var v10: array<int> := new int[16](i0 => safeModuloInt(i0, f4));
				var v11: map<D0, int> := map[v7 := safeDivisionInt(p1, |v9[safeIndex(|{v10}|, |v9|)]|)];
				v11 := v11[v7 := f4];
				...
				v19[safeIndex(191, v19.Length)] := v13;
				v19[safeIndex(191, v19.Length)] := v13[safeModuloInt(p1, -0x1f5) := if (p3) then v12.f13 else p0];
				var v20: array<bool> := new bool[5](i1 => -|v2| >= v12.f14);
				v20[safeIndex(758, v20.Length)] := p0;
				v20[safeIndex(758, v20.Length)] := v12.f13;
				v20 := if (p3) then v20 else v20;
			} else {
				var v21: array<bool> := new bool[29];
				var v22: map<bool, map<bool, int>> := map[p3 := v0];
				var v23: array<map<bool, int>> := new map<bool, int>[29] [v0, v0, v0, v0, v0, v0, v0 + map[p0 := f4], v0, map[p2 := |(seq(abs(-0x80), i2  => (|{p0}|)))|], v0, v0, v0, v0, map[p3 := -|multiset{-f4}|] + v0, v0[!p0 := p1], v0, if (p0 in v22) then v22[p0] else v0, v0[!p0 := 245], v0 + v0, v0, v0[true := f4] + v0, v0, v0 + map[p0 := f4], v0, v0, v0, v0, if (p3) then v0 else v0, map[p2 := p1]];
				...
				r0 := !(v32 == (seq(abs(0x1e3), i3  => ([|map[478 := 'e']|]))));
				f4 := -f4;
			}
			
			var v33: multiset<bool> := multiset{p0};
			var v34: seq<bool> := [p2, true, false];
			var v35: set<int> := {safeDivisionInt(if (p3 in v33) then v33[p3] else |v34|, p1)};
			var v37 := "vkng";
			var v38 := 'f';
			var v39: map<int, int> := map[p1 := |fm14(|v37|, f4, false, v38, globalState)|];
			v35, f4 := set v36 : int | (0x1ec <= v36) && (v36 < 0x34f) :: (safeDivisionInt(v36, p1)), f4 * (|v0| - |v39|);
			...
			if (p3) {
				f4 := p1 + f4;
				var v42 := new C0(-safeDivisionInt(p1, p1));
				var v43: seq<int> := [f4, 0x2b7, f4, v42.f18];
				var v44 := DC51(f4, v43[safeIndex(v42.f18, |v43|)]);
				var v45 := 'a';
				...
				f4 := v42.f18;
				v42.f18 := safeDivisionInt(|fm40(globalState)|, |v43|);
			} else {
				f4 := safeDivisionInt(p1, -f4);
				var v49: array<int> := new int[16];
				v49[safeIndex(646, v49.Length)] := f4;
				var v50: multiset<int> := multiset{f4};
				v49[safeIndex(646, v49.Length)], r0, r0 := -f4, v50 <= v50, p0;
				r0 := if (p2) then p3 else p0;
				v49[safeIndex(646, v49.Length)] := p1;
				var v51 := "qcx";
			...
			var v55: array<map<int, bool>> := new map<int, bool>[1](i5 => if (p2) then map[f4 := p3] else map v54 : int | v54 in multiset([f4]) :: (safeModuloInt(v54, |multiset{f4, f4, p1}|)) := (true));
			v55 := new map<int, bool>[13](i6 => map[f4 := p2]);
			var v56: array<seq<D1>> := new seq<D1>[15];
			var v57: map<bool, int> := map[p2 := f4];
			var v58 := DC3(v57);
			var v59: seq<D1> := [v58];
			v56[safeIndex(816, v56.Length)] := v59 + v59;
			v56[safeIndex(816, v56.Length)] := fm41(globalState);
			v57 := v57[!p2 := f4];
			var v60 := "qx";
			var v61 := 'u';
			v60 := (v60 + v60[safeIndex(f4, |v60|) := v61]) + v60;
		}
		...
		match (v67) {
			case DC54(cf97, cf98, cf99, cf100) =>
				...
				match (v69) {
					case DC8(cf13, cf14) =>
						...
						var v72: array<int> := new int[27] [p1, safeModuloInt(v62.f18, f4), v62.f18, p1 * |v66|, v62.f18, v62.f18, if (p2) then v62.f18 else v62.f18, safeModuloInt(v62.f18, p1), fm1(globalState), f4, fm1(globalState), v62.f18, v62.f18, -v62.f18, cf99 + v62.f18, v71[safeIndex(-466, |v71|)], safeDivisionInt(fm1(globalState), v62.f18), safeModuloInt(p1, p1), v62.f18, p1, v62.f18, cf99, f4, f4, safeDivisionInt(|v71|, v62.f18), -v62.f18, safeDivisionInt(v62.f18, 0x373)];
						v72[safeIndex(803, v72.Length)] := p1 - 0x111;
						v72[safeIndex(803, v72.Length)] := safeModuloInt(v62.f18, fm1(globalState)) * f4;
						...
						v62.f18 := p1;
						var v76: map<int, bool> := map[v72[safeIndex(803, v72.Length)] := cf98];
					...
					case DC9(cf15, cf16) =>
						...
						v82 := v82;
						var v83: array<int> := new int[7](i9 => safeModuloInt(i9, -0x146));
						v83 := new int[7];
						cf98 := !p0;
					...
					case DC10(cf17, cf18, cf19, cf20, cf21) =>
						...
						v86[safeIndex(628, v86.Length)] := p1;
						var v87: map<int, int> := map[-29 * cf18 := cf17 + cf18];
						var v88: set<int> := {|multiset{p3}|};
						v86[safeIndex(628, v86.Length)], v66, cf20 := -(if (-|(v88 - v88)| in v87) then v87[-|(v88 - v88)|] else cf18), seq(abs(800), i10  => (v63)), -f4;
					...
					case DC7(cf12) =>
						...
						r0, f4, v63 := {cf98, p2, p3, p3, fm0(p1, |v93|, globalState)} !! v94, safeModuloInt(v62.f18, cf99), v63;
						...
						v62.f18 := safeDivisionInt(cf99, -v62.f18);
						v64[safeIndex(710, v64.Length)] := cf100;
						v64[safeIndex(710, v64.Length)] := cf97;
					case DC11(cf22) =>
						v64[safeIndex(943, v64.Length)] := p2;
						var v100: multiset<char> := multiset{v63};
						v64[safeIndex(943, v64.Length)] := v100 > multiset(v66 + [v63, v63, v63, v63]);
						var v101 := DC12(v66);
						var v102: array<multiset<char>> := new multiset<char>[23] [v100, v100[v63 := abs(--v62.f18)], v100, multiset{v63, v63}, v100, if (p0) then v100[v63 := abs(v62.f18)] else multiset(v66), v100, v100, v100, v100 * v100, multiset{v63}, v100, v100, v100, multiset(v66) - v100, v100, multiset(v101.cf23), v100 + v100, v100 * v100, v100, v100, multiset{v63}, if (p0) then v100[v63 := abs(|v66|)] else v100];
						...
						v66 := ((v66 + fm23(true, globalState))[safeIndex(cf99 * |multiset{v62.f18}|, |(v66 + fm23(true, globalState))|) := v63])[safeIndex(safeDivisionInt(v62.f18, if (f4 in v103) then v103[f4] else if (v104 in v105) then v105[v104] else 737), |(v66 + fm23(true, globalState))[safeIndex(cf99 * |multiset{v62.f18}|, |(v66 + fm23(true, globalState))|) := v63]|) := fm27(if (cf98 in v106) then v106[cf98] else cf100, globalState)];
						var v107: array<seq<bool>> := new seq<bool>[17];
						var v108: seq<bool> := [p2];
						v107[safeIndex(8, v107.Length)] := v108;
						var v109: seq<int> := [v62.f18];
						var v110: map<bool, int> := map[p0 := |v109|];
						var v111 := DC3(v110);
						var v112: map<char, seq<bool>> := map[v63 := v108];
						v107[safeIndex(8, v107.Length)], v111, v66 := (if (v63 in v112) then v112[v63] else v108) + v108, v111.(cf5 := v110), "pevlxxv";
				}
				
				v66 := ((seq(abs(-0x120), i11  => (v63))) + (v66 + (seq(abs(0x1da), i12  => (v63)))))[safeIndex(--v62.f18, |((seq(abs(-0x120), i11  => (v63))) + (v66 + (seq(abs(0x1da), i12  => (v63)))))|) := 'm'];
				v62.f18 := -(f4 - f4);
				var v113: seq<bool> := [p2];
				var v114: set<int> := {f4};
				var v115: map<bool, D5> := map[!(p0 ==> cf97) := fm42(v113[safeIndex(f4, |v113|)], v114, true, cf98, globalState)];
			...
			case DC55(cf101, cf102, cf103) =>
				...
				var v121: array<seq<bool>> := new seq<bool>[21] [v118, v118[safeIndex(cf102.f18, |v118|) := p2], v118, v118, v118, v119.cf7[safeIndex(|v120|, |v119.cf7|) := p0], fm2(v63, f4, v62.f18, globalState), v118, ([!p2])[safeIndex(f4, |[!p2]|) := p0], v118, v118, fm2(v63, f4, f4, globalState), v118, [p0, p3], v118, v118, [v118[safeIndex(cf102.f18, |v118|)]], v118, v118, [p0], v118];
				var v122: seq<array<seq<bool>>> := [v121];
				var v123 := DC49(DC47(v122[safeIndex(p1, |v122|)]));
			...
			case DC53(cf96) =>
				v62.f18 := p1 + (f4 * f4);
				v64[safeIndex(629, v64.Length)] := p3;
				v64[safeIndex(36, v64.Length)] := p2;
				v62.f18, v62.f18, v64[safeIndex(629, v64.Length)], v64[safeIndex(36, v64.Length)] := v62.f18, p1, !false, p3;
				var v126: array<array<int>> := new array<int>[29];
				var v127 := DC21(f4, p3);
				var v128: map<bool, int> := map[p0 := v62.f18];
				var v129: set<map<bool, int>> := {v128, v128[v64[safeIndex(629, v64.Length)] := p1], map[p0 := |v66|], fm28(v62.f18, globalState)};
				v62.f18, v126, v127 := v62.f18 * -|(v129 + v129)|, v126, v127;
				var v130: seq<int> := [p1];
				v64[safeIndex(629, v64.Length)] := !(v130 <= v130) ==> !v64[safeIndex(629, v64.Length)];
			case DC56(cf104) =>
	...
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		...
		match (match v3 {
			...
			case DC25(cf45, cf46, cf47) =>
				if (p0 < cf47) {
					...
					v4[safeIndex(243, v4.Length)] := p0;
					v4[safeIndex(243, v4.Length)] := cf47;
					cf47 := v4[safeIndex(243, v4.Length)];
					var v5: array<multiset<bool>> := new multiset<bool>[6];
					var v6: array<array<multiset<bool>>> := new array<multiset<bool>>[4] [v5, v5, v5, v5];
					v6[safeIndex(472, v6.Length)] := v5;
					v6[safeIndex(472, v6.Length)] := v5;
					f4 := cf47;
				} else {
					...
					v10 := v10[0x192 := p1];
					var v11 := new C4(cf47);
					var v12: seq<seq<char>> := [[v8, v8, fm27(false, globalState), v8], v9, v9, seq(abs(368), i1  => (v8))];
					var v13 := new C3(f4, v9 + v12[safeIndex(cf47, |v12|)], fm1(globalState));
					cf46 := fm8(globalState);
					var v14: array<bool> := new bool[23](i2 => cf45);
					v14[safeIndex(100, v14.Length)] := cf45;
					var v15: map<bool, bool> := map[p1 := cf46];
					var v16: map<int, int> := map[|v13.f12| := cf47];
					cf47, cf46, v14[safeIndex(100, v14.Length)], cf45, f4 := safeModuloInt(v13.f11 + |v15|, f4), v9 < v9, cf45, (cf45 <== cf45) <==> cf45, safeModuloInt(v13.f11, |v16|);
				}
				
				f4 := f4;
				var v17: array<int> := new int[26](i3 => i3 - p0);
				v17[safeIndex(669, v17.Length)] := -0x130;
				v17[safeIndex(669, v17.Length)] := if (p1) then p0 else safeModuloInt(f4, f4);
				var v18: array<bool> := new bool[11];
				v18[safeIndex(292, v18.Length)] := f4 < p0;
				v18[safeIndex(292, v18.Length)] := p1 || p1;
			case DC26(cf48, cf49) =>
				var v19: array<bool> := new bool[10];
				v19[safeIndex(857, v19.Length)] := p1 <==> p1;
				v19[safeIndex(857, v19.Length)] := !p1;
				v19[safeIndex(857, v19.Length)] := if (if (v19[safeIndex(857, v19.Length)]) then true else v19[safeIndex(857, v19.Length)]) then p1 else v19[safeIndex(857, v19.Length)];
				if (v19[safeIndex(857, v19.Length)]) {
					cf49 := f4;
					var v20 := "knpddun";
					var v21: multiset<int> := multiset{|v20|, p0, -0x1eb, f4 * cf48, cf48};
					var v22: map<string, bool> := map[v20 := true];
					v21, cf48 := v21 + v21, safeModuloInt(|(v22 + v22)|, |v2|);
					cf49 := |v22| + cf48;
					cf48 := f4;
					var v23: array<int> := new int[24];
					r2 := if (v19[safeIndex(857, v19.Length)]) then v23 else v23;
				} else {
					var v24: array<D1> := new D1[3];
					var v25: array<int> := new int[2] [|v2|, cf49];
					v25[safeIndex(940, v25.Length)] := p0;
					var v26: map<int, bool> := map[cf48 := true];
					var v27: map<int, map<int, bool>> := map[cf49 := v26];
					v24, v19, v25[safeIndex(940, v25.Length)], v27 := v24, v19, cf48, v27;
					var v28: array<map<string, T0>> := new map<string, T0>[26];
					var v29: T0 := new C1(0x134, v25[safeIndex(940, v25.Length)], |(seq(abs(-0x3b8), i4  => (v2)))|, p1);
					var v30: map<string, T0> := map["bv" := v29];
					var v31 := "pxdxutayt";
					v28[safeIndex(380, v28.Length)] := v30[v31 := v29];
					v28[safeIndex(380, v28.Length)] := v30[v31 := if (v19[safeIndex(857, v19.Length)]) then v29 else v29];
					var v32: multiset<int> := multiset{-0xb3, 0x144};
					var v33: map<bool, multiset<int>> := map[p1 := v32];
					v29.f4, v19[safeIndex(857, v19.Length)], cf48, v25 := |(v33 + v33)|, v19[safeIndex(857, v19.Length)], fm1(globalState), v25;
			...
			case DC27(cf50, cf51, cf52) =>
				if (p1) {
					...
					cf51 := |v39[safeIndex(cf50, |v39|) := v44.cf13]| * (if (-|"bsfeide"| in v42) then v42[-|"bsfeide"|] else cf52);
					v2 := v2 + v2;
					cf50 := -safeDivisionInt(p0, p0);
					var v45 := true;
					var v46: array<seq<bool>> := new seq<bool>[22] [[fm0(cf52, p0, globalState)], v2[safeIndex(fm1(globalState), |v2|) := p1], if (false) then [p1] else v2, v2, [p1] + v2, v2[safeIndex(cf51, |v2|) := false] + fm2(v40, f4, p0, globalState), v2, v2, v2, v2 + v2, v2, (v2 + v2)[safeIndex(|v2|, |(v2 + v2)|) := v45], v2 + fm2(v40, f4, p0, globalState), v2, v2, if (!p1) then v2 else ([false, true])[safeIndex(cf50, |[false, true]|) := p1], v2, v2, v2, v2, v2, v2];
					v46[safeIndex(847, v46.Length)] := v2;
					var v47: C0 := new C0(cf50);
					var v48 := DC55(seq(abs(0x3a8), i5  => (v40)), v47, f4);
					v45, v46[safeIndex(847, v46.Length)] := (if (v45) then p1 else v45) <== (|v2| != -|v48.cf101|), v2;
					v45 := p1;
				} else {
					...
					v56[safeIndex(49, v56.Length)] := p1;
					v56[safeIndex(49, v56.Length)] := !(safeModuloInt(cf51, cf50) > p0);
				}
				
				var v60 := new C0(cf50 + cf50);
				var v61 := "qovo";
				var v62: map<string, bool> := map[v61 := true];
				cf51, cf52, v2 := |v62| * cf50, cf50 * cf50, [p1, v2[safeIndex(|multiset{f4}|, |v2|)]];
				var v63: array<bool> := new bool[3](i6 => !p1);
				v63[safeIndex(786, v63.Length)] := p1;
				var v64 := 'v';
				var v65: multiset<char> := multiset{v64};
				v63[safeIndex(786, v63.Length)] := fm5(v61 + (seq(abs(0x181), i7  => ('v'))), v65 <= multiset{'q'}, globalState);
			case DC24(cf44) =>
				var v66 := DC6(p0, false);
				var v67: array<seq<bool>> := new seq<bool>[23];
				v67[safeIndex(633, v67.Length)] := v2 + v2[safeIndex(f4, |v2|) := false];
				var v68 := 'n';
				var v69 := "cdug";
				var v70: array<bool> := new bool[17];
				var v71 := DC8(v68, v70);
				var v72: array<char> := new char[19] [v68, v68, v68, if (fm5(v69, p1, globalState)) then 'k' else v68, v71.cf13, if (p1) then v68 else v68, fm27(p1, globalState), v68, if (p1) then v68 else v68, v68, v68, v68, v68, v69[safeIndex(p0, |v69|)], v68, v68, v68, v68, v68];
				v72[safeIndex(651, v72.Length)] := v68;
				...
				v66, v67[safeIndex(633, v67.Length)], f4, v72[safeIndex(651, v72.Length)], v75 := v66, v2, fm1(globalState), v68, v75;
		...
		v84[safeIndex(628, v84.Length)] := p1;
		v84[safeIndex(628, v84.Length)] := v83;
		f4 := p0;
		var v85 := 'i';
		...
		if (p0 !in (v87 + v87[f4 := v86])) {
			...
			v88 := v88[true := v83];
			var v89: map<int, int> := map[-safeDivisionInt(p0, |(seq(abs(929), i10  => (v85)))|) := f4];
			var v90: array<int> := new int[2];
			v90[safeIndex(897, v90.Length)] := f4;
			var v91: set<bool> := {v83, p1, true, p1};
			var v92: multiset<int> := multiset{|v91|};
			v89, v83, r2, v90[safeIndex(897, v90.Length)], v92 := (v89 + map[f4 := p0]) + (v89 + v89), v83, v90, safeDivisionInt(f4, f4), v92;
			v84[safeIndex(628, v84.Length)] := v83;
			if (!p1) {
				v83 := false;
				v90[safeIndex(897, v90.Length)] := p0;
				v90 := v90;
				var v93: map<int, array<int>> := map[p0 := v90];
				v93 := v93[0xb2 := v90];
				v84[safeIndex(628, v84.Length)] := v2[safeIndex(0x296, |v2|)];
			} else {
				var v94: seq<int> := [f4 + v90[safeIndex(897, v90.Length)], p0, p0 * p0, p0, v90[safeIndex(897, v90.Length)] * f4];
				v94 := v94;
				var v95: map<int, array<int>> := map[v90[safeIndex(897, v90.Length)] := v90];
				var v96, v97, v98, v99 := m0(map[v90[safeIndex(897, v90.Length)] := v83], [p0, v90[safeIndex(897, v90.Length)]], v95, globalState);
				var v100: map<int, bool> := map[v97 := p1];
				var v101: multiset<set<bool>> := multiset{{if (v90[safeIndex(897, v90.Length)] in v100) then v100[v90[safeIndex(897, v90.Length)]] else p1}, v91};
				v96 := (if (v91 in v101) then v101[v91] else v90[safeIndex(897, v90.Length)]) + v97;
				var v102 := DC0(v94);
				var v103, v104, v105, v106 := m0(v100, v102.cf0, map[0x13d := v98], globalState);
				var v107 := "u";
				var v108: map<int, string> := map[-v97 := v107];
				var v109: map<string, char> := map[if (v103 in v108) then v108[v103] else seq(abs(0x13c), i11  => ('j')) := 'h'];
				v109 := v109 + v109;
			}
			...
			if (v110 > v110) {
				...
				f4, v85, v84[safeIndex(628, v84.Length)] := p0, fm27(v84[safeIndex(628, v84.Length)], globalState), if (fm1(globalState) < f4) then p1 else v111.cf31;
				var v112 := new C1(p0, --0x3ad, p0, p1);
				v84[safeIndex(628, v84.Length)] := v83;
				var v113 := "dyttigb";
				var v114: seq<int> := [f4];
				var v115: array<int> := new int[27] [p0, |map[v2 := p0]|, p0, p0, -p0, -v112.f17 * p0, f4, safeDivisionInt(f4, p0), p0, f4, -(if (v84[safeIndex(628, v84.Length)] in v0) then v0[v84[safeIndex(628, v84.Length)]] else v112.f17), v112.f17, f4, v112.f17 + p0, |v113|, -p0, 0x2e * |(seq(abs(757), i12  => (f4)))|, f4, f4, v112.f17, v112.f17 * p0, v112.f17, |fm23(p1, globalState)|, |v110|, v112.f17, p0, |v114| - p0];
				v115[safeIndex(715, v115.Length)] := f4;
				v115[safeIndex(715, v115.Length)] := fm1(globalState);
				...
				var v121 := DC17(v0, v2[safeIndex(f4, |v2|)]);
				v120[safeIndex(580, v120.Length)] := v121.cf34 - multiset{p1};
				v116[safeIndex(174, v116.Length)] := f4;
				v85, v118, v119, v120[safeIndex(580, v120.Length)], v116[safeIndex(174, v116.Length)] := v85, v118, v119, multiset{v84[safeIndex(628, v84.Length)], v83, !p1} * (v0 - v0), f4;
				var v122: seq<int> := [-f4 * v116[safeIndex(174, v116.Length)], v116[safeIndex(174, v116.Length)], f4];
				v122 := v122;
				v116[safeIndex(174, v116.Length)] := if (p1) then 0x2b2 else v116[safeIndex(174, v116.Length)];
				var v123 := new C2(v83, v116[safeIndex(174, v116.Length)]);
				var v124 := "u";
				r1 := v124;
			}
			...
			v127 := v127[v125 := {v2}];
			var v128 := DC35(p0, !v84[safeIndex(628, v84.Length)], p1);
			v84[safeIndex(628, v84.Length)] := v128.cf63;
			var v129: seq<int> := [p0];
		...
		forall i13 | 0 <= i13 < v131.Length {
			v131[i13] := (("vouab")[safeIndex(p0, |"vouab"|) := v85] + ("ufou")[safeIndex(p0, |"ufou"|) := 'f']) + ((seq(abs(604), i14  => (v85))) + "jihww");
		}
		r0 := seq(abs(0x388), i15  => (if (v84[safeIndex(628, v84.Length)]) then DC0(seq(abs(0x29c), i16  => (|multiset{p0}|))) else DC0([f4])));
		var v132 := "pxwsh";
		r1 := v132;
		var v133: C1 := new C1(p0, -p0, p0, v83);
		var v134: array<int> := new int[9] [f4, p0, p0, 0x2ca, f4 + p0, |[v133]|, -f4 + f4, v133.f17, safeDivisionInt(p0, v133.f17)];
		r2 := v134;
	}
}
	...
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		match (v2) {
			case DC4(cf6, cf7, cf8) =>
				var v3: seq<int> := [cf6, safeDivisionInt(f4, f4), -939, f4];
				v3 := (DC0(v3).cf0 + v3) + v3;
				var v4: map<bool, int> := map[f8 := |(seq(abs(0xd3), i0  => (cf6)))|];
				var v5 := DC3(v4);
				var v6 := DC3(v5.cf5 + v4);
				v5 := if (p3) then v6 else v5;
				if (p2) {
					var v7 := DC1(v3[safeIndex(cf6, |v3|)], -(0x33d + |[false]|), p3);
					var v8: map<bool, bool> := map[f8 := false];
					cf6, v7 := fm1(globalState), DC1(safeModuloInt(p1, |v8|), cf8, true);
					var v9 := new C0(cf8);
					var v10 := new C0(v9.f18);
					r0 := p2;
					var v11: array<int> := new int[26];
					v11[safeIndex(477, v11.Length)] := --cf6 * p1;
					v11[safeIndex(477, v11.Length)] := v10.f18;
				} else {
					var v12: map<int, int> := map[-cf6 := cf8];
					v12 := v12[cf6 := cf6];
					r0 := fm0(safeDivisionInt(p1, -896), cf8, globalState);
					var v13 := 'k';
					var v14: set<char> := {'y', v13, v13};
					var v15 := new C1(safeModuloInt(|v12|, p1), |v14| + f4, f4, p0);
					r0 := p3;
				...
				v16[safeIndex(633, v16.Length)] := [v17, v17] + v18;
				v16[safeIndex(633, v16.Length)] := fm23(f8, globalState);
			case DC3(cf5) =>
				...
				v23[safeIndex(369, v23.Length)] := v20;
				var v24: multiset<bool> := multiset{p3};
				f4, v23[safeIndex(369, v23.Length)], f4 := f4, v20, (if (p2 in v24) then v24[p2] else -0x1ba) - (if (p3) then f4 else f4);
				var v25: array<seq<bool>> := new seq<bool>[19];
				var v26 := DC47(v25);
				match (if (p3) then v26 else v26) {
					case DC48(cf84, cf85, cf86, cf87) =>
						v23[safeIndex(369, v23.Length)][safeIndex(745, v23[safeIndex(369, v23.Length)].Length)] := v19;
						v23[safeIndex(369, v23.Length)][safeIndex(745, v23[safeIndex(369, v23.Length)].Length)] := v19;
					...
					case DC47(cf83) =>
						f4 := f4 - 0x156;
						r0 := p0;
						v19[safeIndex(399, v19.Length)] := f4;
						v19[safeIndex(399, v19.Length)] := fm1(globalState) * f4;
						var v29 := "yhnuhtivm";
						var v30: map<bool, string> := map[f8 := v29];
						var v31: map<int, string> := map[v19[safeIndex(399, v19.Length)] := v29];
						var v32: set<multiset<bool>> := {multiset(v1), v24};
						var v33: array<map<bool, string>> := new map<bool, string>[26] [v30, v30, map[false := if (-v19[safeIndex(399, v19.Length)] in v31) then v31[-v19[safeIndex(399, v19.Length)]] else "r"] + v30, v30, v30, v30[p0 := fm23(f8, globalState)], map[p0 := seq(abs(0x2c7), i3  => ('x'))], v30, v30 + v30, v30, map[p3 := "oaaxwb"], map[f8 := v29], v30 + v30, v30 + v30, v30, v30, v30, v30, v30, v30, fm19(v22, |v29|, globalState) + fm19(v22, f4, globalState), if (f8) then (map[p2 := v29])[p2 := v29] else v30, fm19(fm21(f4, p3, p3, v32, globalState), 0x2da, globalState), v30, map[!p0 := v29], v30];
						v33[safeIndex(883, v33.Length)] := v30[p3 := "t"] + v30;
						v33[safeIndex(883, v33.Length)] := v30 + v30;
					case DC49(cf88) =>
						var v34: array<bool> := new bool[11](i4 => p3);
						v34[safeIndex(747, v34.Length)] := false;
						var v35: map<bool, bool> := map[fm0(|"tbh"|, p1, globalState) := p0];
						var v36: multiset<map<bool, bool>> := multiset{v35};
						v34[safeIndex(747, v34.Length)] := (p2 <==> p2) <==> (v36 != v36);
						var v37 := 'w';
						var v38 := "erx";
						var v39: set<int> := {-p1};
						var v40 := DC38(f4);
						...
						var v43: array<D12> := new D12[18] [DC38(|v39|), v40, v40.(cf68 := f4), v40, v40, v40, v40.(cf68 := f4), v40.(cf68 := f4), v40, fm38(v41, "a", v1[safeIndex(v42.cf50, |v1|)], globalState), DC38(p1), v40, v40, v40, v40, v40, v40, v40];
						v43[safeIndex(22, v43.Length)] := v40;
						v37, v38, v43[safeIndex(22, v43.Length)] := v37, v38 + (v38 + (seq(abs(629), i5  => (v37)))[safeIndex(p1, |(seq(abs(629), i5  => (v37)))|) := v37]), v40;
						var v44: multiset<char> := multiset{v37, v37};
						var v45: seq<multiset<char>> := [v44, if (p3) then v44 else v44, v44];
						v44 := v45[safeIndex(safeModuloInt(f4, -f4), |v45|)];
						var v46, v47 := m6(globalState);
				}
				
				v19[safeIndex(373, v19.Length)] := if (p0 in cf5) then cf5[p0] else p1;
				v19[safeIndex(373, v19.Length)] := 0x5d;
				v19[safeIndex(373, v19.Length)] := p1;
		}
		...
		if (fm0(f4, p1, globalState)) {
			...
			v50 := v50[v49 := v51[safeIndex(|v1|, |v51|)] != v1];
			var v52 := 's';
			...
			if (if (!(v56 > v56)) then p3 else f8) {
				...
				v58 := v58[fm27(true, globalState) := v60 >= v60["yjggffb" := abs(p1)]];
				...
				v61[safeIndex(790, v61.Length)] := if (v62 in v66) then v66[v62] else v65;
				var v67: array<bool> := new bool[27];
				v67[safeIndex(592, v67.Length)] := |v56| > f4;
				r0, v61[safeIndex(790, v61.Length)], v67[safeIndex(592, v67.Length)] := p3, v65, p3;
				var v69: set<int> := {f4};
				...
				var v73 := new C3(p1, v72, safeModuloInt(p1, p1));
				var v74: map<bool, int> := map[p0 := p1];
				r0, f4 := v1[safeIndex(f4, |v1|)], f4 + |v74|;
			...
			v78[safeIndex(595, v78.Length)] := false;
			var v79: array<int> := new int[22](i6 => i6 * p1);
			var v80: map<bool, int> := map[!f8 := fm1(globalState)];
			var v81: seq<int> := [f4, f4, f4];
			v79[safeIndex(700, v79.Length)] := if (p3 in v80) then v80[p3] else |v81|;
			var v82 := DC1(f4, 0x11b, p2);
			var v83 := DC13(v2.(cf7 := v1, cf6 := p1), f8, v1);
			v78[safeIndex(595, v78.Length)], r0, v79[safeIndex(700, v79.Length)] := f8, v82.cf3, -|v83.cf26|;
			var v84: array<array<bool>> := new array<bool>[4];
			v84[safeIndex(445, v84.Length)] := v78;
			var v85: map<bool, array<bool>> := map[p2 := v78];
			v84[safeIndex(445, v84.Length)] := if (f8 in v85) then v85[f8] else v78;
			r0, r0, f4, v79[safeIndex(700, v79.Length)] := p2, p0, p1, |(seq(abs(-0xe8), i7  => ('b')))| - v79[safeIndex(700, v79.Length)];
			var v86 := "uvhcfih";
		...
		if (p0) {
			...
			var v92 := new C3(p1, (['h', v90] + v91)[safeIndex(p1, |(['h', v90] + v91)|) := v90], f4);
			var v93: array<C4> := new C4[29];
			var v94: map<int, int> := map[f4 := 0x31d];
			var v95: C4 := new C4(-|v94|);
			var v96 := DC65(v95);
			v93[safeIndex(867, v93.Length)] := v96.cf112;
			var v97: map<bool, bool> := map[!p0 := f8];
			var v98: set<int> := {f4};
			var v99: multiset<int> := multiset{|v98|};
			f4, v90, v91, r0, v93[safeIndex(867, v93.Length)] := p1, v90, v91 + v91, !((|fm14(|v97|, f4, f8, v90, globalState)| + |map[if (p1 in v99) then v99[p1] else f4 := !f8]|) >= v92.f11), v95;
			var v100 := new C5(p1);
			r0 := v100.fm8(globalState);
			var v101: seq<int> := [v92.f11];
			var v102: multiset<bool> := multiset{p3};
			var v103 := new C1(f4, |((v101[safeIndex(f4, |v101|) := p1])[safeIndex(p1, |v101[safeIndex(f4, |v101|) := p1]|) := |v102|] + v101)|, p1 * |v101|, (seq(abs(0x216), i8  => (v90))) < v92.f12);
		} else {
			var v104 := 'c';
			...
			f4 := -(v107[safeIndex(0x236, |v107|)] - v105.f11);
			if (p3) {
				f4 := v105.f11;
				f4 := p1;
				...
				v109 := v109[v108 := v106];
				var v110: array<string> := new seq<char>[11] [if (p3) then v105.f12 else fm23(p2, globalState), seq(abs(0x1e4), i9  => (v104)), v105.f12, v105.f12, v105.f12, "ajiofkj", seq(abs(-0x1d6), i10  => (v104)), v105.f12, v105.f12, "gjgc", DC12(v105.f12).cf23];
				v110[safeIndex(513, v110.Length)] := v105.f12;
				v110[safeIndex(513, v110.Length)] := "irbhrutbv";
				...
				v115[safeIndex(899, v115.Length)] := p3;
				v115[safeIndex(899, v115.Length)] := p0;
				var v116: array<int> := new int[17](i11 => i11 + v105.f11);
				v116[safeIndex(277, v116.Length)] := v105.f11;
				v116[safeIndex(277, v116.Length)] := f4 * (p1 - v105.f11);
				var v117: map<int, array<bool>> := map[p1 := v115];
				var v118: seq<array<bool>> := [v115, v115];
				var v119 := DC8(v104, if (f4 in v117) then v117[f4] else v118[safeIndex(f4, |v118|)]);
				var v120: array<char> := new char[9] [v104, v104, (DC8(v104, v115).(cf14 := v115)).cf13, v104, v104, v104, v104, v119.cf13, v104];
				v120 := v120;
				v116[safeIndex(277, v116.Length)] := v116[safeIndex(277, v116.Length)];
			}
			...
			match (v125.(cf110 := v124)) {
				case DC61(cf109) =>
					...
					v126[safeIndex(165, v126.Length)] := p1;
					v126[safeIndex(165, v126.Length)] := p1;
					cf109[safeIndex(678, cf109.Length)] := p3;
					cf109[safeIndex(367, cf109.Length)] := false;
					cf109[safeIndex(678, cf109.Length)], cf109[safeIndex(367, cf109.Length)], v126[safeIndex(165, v126.Length)], r0, r0 := p0, f8, 0x2f5, v105.f11 >= (|v106| * v105.f11), p3;
					v126[safeIndex(165, v126.Length)] := safeModuloInt(|v105.f12|, f4);
					var v127: array<D12> := new D12[27](i13 => DC37(f8, cf109[safeIndex(678, cf109.Length)], false));
					var v128: set<array<D12>> := {v127};
					var v129: map<int, int> := map[|({v127, v127, v127} + v128)| := f4];
					var v130: map<int, map<int, int>> := map[v105.f11 := v129];
					v126, cf109[safeIndex(678, cf109.Length)], v129, v126[safeIndex(165, v126.Length)] := v126, p2, if (p1 in v130) then v130[p1] else map[667 := p1], p1;
				case DC60(cf108) =>
				...
				case DC62(cf110) =>
					...
					v123[safeIndex(558, v123.Length)] := v141 == (set v142 : map<char, int> | v142 in v141 :: (v142));
					v123[safeIndex(558, v123.Length)] := p3;
					var v143: multiset<bool> := multiset{v123[safeIndex(558, v123.Length)], f8, p2};
					var v144: map<bool, seq<bool>> := map[v143 !! v143 := v1];
					var v145: seq<map<bool, seq<bool>>> := [v144];
					v144 := if (p3) then v144 + map[p0 := [p2]] else v145[safeIndex(p1, |v145|)];
			}
			
			var v146: multiset<bool> := multiset{true, !p3};
			var v147: set<multiset<bool>> := {v146, v146};
			var v148 := DC0(v107);
			var v149: array<seq<int>> := new seq<int>[15] [v107, seq(abs(0x312), i14  => (v105.f11)), v107, seq(abs(0x30e), i15  => (v105.f11)), v107 + v107, fm21(p1, p2, f8, v147, globalState), v107 + v107, v148.cf0, v107, [p1], v107 + v107, v107, v107, [v105.f11] + (seq(abs(337), i16  => (v105.f11))), v107];
			v149[safeIndex(356, v149.Length)] := [0x2b, p1];
			var v150: map<bool, int> := map[true := |multiset(v107)|];
			f4, r0, f4, v149[safeIndex(356, v149.Length)] := safeModuloInt(f4, |(v150 + v150)|), p3, v105.f11, (v107 + v107)[safeIndex(-p1, |(v107 + v107)|) := v105.f11];
		}
		...
		v153[safeIndex(643, v153.Length)] := v151;
		v153[safeIndex(643, v153.Length)] := v151;
		if (p3) {
			...
			match (v155) {
				case DC43(cf76) =>
					...
					var v158: map<bool, seq<char>> := map[fm0(f4, p1, globalState) := (seq(abs(-514), i18  => (v156)))[safeIndex(p1, |(seq(abs(-514), i18  => (v156)))|) := v156]];
					v157[safeIndex(147, v157.Length)] := |v158|;
					...
					v157[safeIndex(147, v157.Length)], f4, v156, f4 := p1, f4, v156, |fm2(if (p3 in v159) then v159[p3] else fm27(f8, globalState), if (p3) then v160.cf20 else p1, f4 - p1, globalState)|;
					var v164 := "gss";
					var v165: seq<int> := [p1, -|v164|];
					var v166: seq<int> := [v165[safeIndex(f4, |v165|)], f4, v157[safeIndex(147, v157.Length)], p1, p1];
					v157[safeIndex(147, v157.Length)] := p1 * |v166|;
			}
			
			var v167: seq<char> := ['e'];
			var v168: seq<int> := [0x2e1, p1];
			var v169: map<int, int> := map[f4 := -|v168|];
			var v170 := new C3(safeModuloInt(p1, f4), v167, if (f4 in v169) then v169[f4] else p1);
			var v171: array<char> := new char[8];
			var v172: map<array<char>, array<bool>> := map[v171 := v151];
			v172 := v172;
			var v173: array<int> := new int[10];
			v173 := new int[8] [f4, -|(v168 + v168)|, safeModuloInt(p1, f4), p1, |v1|, -f4, safeDivisionInt(-|v168[safeIndex(p1, |v168|) := -f4]|, v170.f11), p1];
			f4 := p1 + v170.f11;
		} else {
			r0 := p3 && (p3 <==> p0);
			var v174 := "oyoltakt";
			...
			var v176 := 'l';
			var v177 := DC12(v174);
			var v178: array<string> := new string[12] [v174[safeIndex(|v175|, |v174|) := v176], v177.cf23, "sol", v174, v174, v174, fm23(p3, globalState), seq(abs(0x13b), i19  => (v176)), v174, DC12(v174).cf23, v174, seq(abs(0x28b), i20  => ('y'))];
			var v179 := DC30(f4, v178, p0);
			var v180 := DC41(v0);
			f4, v174, v179, f4, f4 := safeModuloInt(f4 - f4, f4 - -f4), if (p0) then v174[safeIndex(-p1, |v174|) := v176] else v174, v179, |(v180.cf71 * v0)|, fm1(globalState);
			var v181: array<int> := new int[3](i21 => safeModuloInt(i21, f4));
			...
			if (p2) {
				...
				v189[safeIndex(574, v189.Length)] := {p2, p0};
				v189[safeIndex(574, v189.Length)] := {p2};
				var v190 := DC9(p2, p1);
				v151[safeIndex(357, v151.Length)] := p2;
				var v191: seq<set<bool>> := [v189[safeIndex(574, v189.Length)], v189[safeIndex(574, v189.Length)]];
				var v192: map<seq<bool>, bool> := map[v1 := f8];
				r0, v190, f4, v151[safeIndex(357, v151.Length)], r0 := p3, DC9(p0, |v1|), p1, if (p3) then f8 else f4 < |v191[safeIndex(p1, |v191|)]|, if ((v1 + v1) in v192) then v192[v1 + v1] else true;
				v0 := v189[safeIndex(574, v189.Length)];
				...
				v194[safeIndex(604, v194.Length)] := {f4, p1, fm1(globalState), f4, v175[safeIndex(p1, |v175|)]};
				v194[safeIndex(604, v194.Length)] := (v182 * v182) * v182;
			} else {
				v182 := {f4, safeDivisionInt(-0x337, f4)};
				v151[safeIndex(373, v151.Length)] := p0;
				v151[safeIndex(373, v151.Length)] := p3;
				f4 := safeModuloInt(f4, fm1(globalState));
				v151[safeIndex(373, v151.Length)] := !fm0(safeDivisionInt(p1, 0x28e), p1 - p1, globalState);
		...
		match (v198) {
			case DC61(cf109) =>
				...
				var v200: map<int, int> := map[safeModuloInt(v199.cf61, f4) := -f4];
				v200 := v200[0x3de := safeModuloInt(p1, p1)];
				v151[safeIndex(173, v151.Length)] := p2;
				v151[safeIndex(173, v151.Length)] := p2;
				var v201: map<int, seq<bool>> := map[p1 := v1];
				var v202 := DC36(v201);
				match (v202) {
					case DC37(cf65, cf66, cf67) =>
						var v203: seq<array<bool>> := [cf109, v153[safeIndex(643, v153.Length)]];
						...
						f4 := if (!p0) then |v205[safeIndex(p1, |v205|) := v204]| else 525;
						var v206 := new C5(0x39d);
						cf109 := v153[safeIndex(643, v153.Length)];
						var v207 := 's';
					...
					case DC38(cf68) =>
						...
						v210 := (seq(abs(0x188), i23  => ('s'))) + (v210 + v210);
						var v212: map<bool, bool> := map[false := p3];
						var v213 := new C3(p1, v210, |v212| * cf68);
						var v214: array<seq<int>> := new seq<int>[19](i24 => [|v1|, 290, |map[v151[safeIndex(173, v151.Length)] := v213.f12]|] + [v213.f11, |[true]|]);
					...
					case DC36(cf64) =>
						...
						v217 := v217[f4 := p0 ==> p3];
						f4 := p1;
						v151[safeIndex(173, v151.Length)] := p3;
						var v218: map<bool, bool> := map[v151[safeIndex(173, v151.Length)] := true];
				...
				var v220 := 'b';
				var v221 := "anjxjeynf";
				var v222: array<string> := new string[19] [v221, v221, v221, "wwdemlm", v221, seq(abs(0x2ae), i26  => (v220)), v221, v221, v221, seq(abs(0x93), i27  => (v220)), v221, seq(abs(0x3a5), i28  => (v220)), "lufi", v221, v221, v221, v221, "wigod", v221];
				var v223 := DC30(f4, v222, f8);
				var v224: array<char> := new char[28] [v219.cf13, v220, v220, v220, if (v151[safeIndex(173, v151.Length)]) then v220 else v220, 'u', v221[safeIndex(v223.cf54, |v221|)], fm27(v151[safeIndex(173, v151.Length)], globalState), v220, 'r', v220, v220, v220, v220, v220, v220, v221[safeIndex(-p1, |v221|)], v220, v220, v220, v220, v220, v220, v220, 'c', 'r', v220, v220];
				v224[safeIndex(205, v224.Length)] := v220;
				v224[safeIndex(205, v224.Length)] := v220;
			case DC60(cf108) =>
				var v225 := "fdypxqjbb";
				var v226: seq<int> := [f4];
				var v227: array<int> := new int[24] [f4, |v225|, p1, p1, f4, p1, f4, p1, |v225|, p1, p1, p1, |v225|, v226[safeIndex(f4, |v226|)], f4, |(seq(abs(824), i29  => (f4)))|, f4, f4, f4, -|multiset{p1}|, p1, p1, p1, p1];
				var v228: multiset<array<int>> := multiset{v227};
				v228, f4, r0, f4 := v228, safeDivisionInt(|"hsxqsgq"|, p1) * safeModuloInt(f4, -0x14d), p0, f4;
				var v229: map<bool, int> := map[true := p1];
				f4 := (if (fm5(v225, p0, globalState)) then f4 else f4) - (if (p2 in v229) then v229[p2] else |v226|);
				v227[safeIndex(398, v227.Length)] := p1 - p1;
				v227[safeIndex(398, v227.Length)], f4, r0 := -f4, if (f8) then |v225| - p1 else fm1(globalState), p3;
				v227[safeIndex(398, v227.Length)] := f4;
			case DC62(cf110) =>
				...
				match (v231) {
					case DC40(cf70) =>
						...
						f4 := safeDivisionInt(v233.cf94, if (f8) then |v234| else p1);
						var v235 := 'e';
						var v236 := DC8(v235, v153[safeIndex(643, v153.Length)]);
						v235 := v236.cf13;
						v151 := new bool[28];
						var v237: array<int> := new int[6] [p1, p1, p1, fm1(globalState), f4, p1];
						v237[safeIndex(501, v237.Length)] := f4;
						v237[safeIndex(501, v237.Length)] := p1;
					case DC39(cf69) =>
						...
						v239[safeIndex(690, v239.Length)] := if (p3 in v244) then v244[p3] else [v242];
						v239[safeIndex(690, v239.Length)] := v243 + v243;
						var v245 := "fxu";
						var v246 := DC6(|v245|, !true);
						var v247 := 'g';
						var v248: seq<string> := [(v245 + (seq(abs(0x21d), i30  => ('t'))))[safeIndex(f4, |(v245 + (seq(abs(0x21d), i30  => ('t'))))|) := v247], (seq(abs(0x31b), i31  => (v247))) + v245, v245];
						v246, v248, f4 := v246.(cf11 := p0), v248, p1;
				}
				
				var v249: seq<int> := [-|map[p1 := p1]|];
				var v250 := "fxfq";
				var v251: array<int> := new int[27] [p1, fm1(globalState), p1, 722, -0x298, p1, |v249[safeIndex(p1, |v249|) := p1]|, f4, 0x20f, f4, p1, f4, p1, 430, f4, f4, -0x397, |v250|, f4, f4, |v1|, |v250|, |v249|, p1, |v230|, |"xedjbel"|, |"xllxo"|];
				...
				var v254 := DC34(v253[safeIndex(--0x1c3, |v253|)]);
				match (v254.(cf60 := v252)) {
					case DC35(cf61, cf62, cf63) =>
						var v255: array<multiset<int>> := new multiset<int>[20];
						var v256 := 'p';
						v255[safeIndex(604, v255.Length)] := multiset(fm14(-DC51(f4, |v1|).cf91, p1, p2, v256, globalState));
						...
						v255[safeIndex(604, v255.Length)] := v259[v261.cf10 := abs(|v250| - f4)];
						var v262: C0 := new C0(0x2ca);
						var v263 := DC18(v262, true, p2);
						var v264 := DC55(v250, v263.cf36, v262.f18);
						var v265: multiset<string> := multiset{v264.cf101[safeIndex(f4, |v264.cf101|) := v256], v250, fm23(cf62, globalState), v250};
						v265 := v265;
						var v266: set<int> := {p1, f4};
						var v267: seq<string> := [v250, v250];
						v266 := fm16(!p0, v267, true, v262.f18, globalState);
						cf61 := safeDivisionInt(cf61 + p1, v249[safeIndex(f4, |v249|)]);
					case DC34(cf60) =>
						v153[safeIndex(643, v153.Length)] := v153[safeIndex(643, v153.Length)];
						r0, r0, f4 := fm5(v250 + v250, v1 != v1, globalState), p2, f4;
						var v268 := 't';
						v268 := v268;
						f4 := -safeDivisionInt(f4, 0x206);
				}
				
				var v269: map<bool, bool> := map[f4 != p1 := !p0];
				if (if (p2 in v269) then v269[p2] else v249 != v249) {
					var v270: map<int, int> := map[v249[safeIndex(f4, |v249|)] := p1];
					var v271: seq<map<int, int>> := [v270, v270];
					var v272: array<seq<map<int, int>>> := new seq<map<int, int>>[21] [v271 + v271, v271, seq(abs(-0xe3), i32  => (v270)), v271, v271, v271, seq(abs(0x251), i33  => ((map[p1 := f4])[p1 := |[p2]|])), seq(abs(0x71), i34  => (v270)), v271, [map[p1 := |v250|], v270, v270], [v270, fm45(p3, p2, globalState), v270[p1 := f4], v270, v270], if (p2) then v271 else v271, v271, v271, seq(abs(-0x245), i35  => (v270)), if (p0) then v271 else v271, v271, v271, v271, v271 + (seq(abs(0xf), i36  => (v270))), v271];
					var v273: map<int, seq<map<int, int>>> := map[f4 := v271];
					v272[safeIndex(616, v272.Length)] := if (p1 in v273) then v273[p1] else v271;
					v272[safeIndex(616, v272.Length)] := v271;
					var v274: multiset<int> := multiset{p1};
					var v275: map<multiset<int>, array<int>> := map[v274 := v251];
					var v276: map<int, map<multiset<int>, array<int>>> := map[safeDivisionInt(f4, p1) := v275 + v275];
					v276 := v276[p1 := v275];
					...
					v279 := v279[p1 := v278];
					v252[safeIndex(859, v252.Length)] := v251;
					var v280 := DC64();
					f4, v252[safeIndex(859, v252.Length)], v280 := p1, v251, v280;
					var v281 := new C2(f8, fm1(globalState) * p1);
					var v282: array<string> := new string[26] [v250, v250, "gct", v250, v250, v250, v250, v250, seq(abs(24), i37  => ('x')), v250, v250, fm23(f8, globalState), v250, v250, v250, seq(abs(0x387), i38  => ('x')), v250, v250, v250, "ebbox", v250, seq(abs(-0x184), i39  => ('s')), "dlam", v250, v250, v250];
					var v283 := DC28(v282);
				...
				if (!v288.cf73) {
					...
					var v291: multiset<string> := multiset{v250, v250, v250, v290[safeIndex(0x15b, |v290|)], seq(abs(0x4c), i40  => ('e'))};
					var v292 := DC68(v153);
					v153, r0, v289, v291, v251 := v292.cf114, (f4 <= 0x98) || p3, v289, v291 + v291, v251;
					r0 := fm0(-f4, f4, globalState) || !(p3 || p2);
					v252[safeIndex(683, v252.Length)] := v251;
					v251[safeIndex(213, v251.Length)] := p1 - p1;
					f4, v252[safeIndex(683, v252.Length)], v251[safeIndex(213, v251.Length)] := if (fm5(v250, f8, globalState)) then safeDivisionInt(p1, p1) else fm1(globalState), v251, f4;
					...
					var v297: set<set<int>> := {v294, {|(if (v251 in v296) then v296[v251] else v295)[f4 := abs(p1)]|}};
					f4 := |(v297 - v297)|;
					var v298 := 'v';
					v298, r0, v250 := v250[safeIndex(|{p0}|, |v250|)], !false, (v250[safeIndex(|v250|, |v250|) := v298] + v250) + "uvuta";
					var v299 := DC64();
					v299 := v299;
					v250 := v250;
				}
	...
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		...
		match (if (!!f8) then v2 else v2) {
			case DC25(cf45, cf46, cf47) =>
				...
				if (v5[safeIndex(DC10(f4, -cf47, false, p0, f8).cf20, |v5|)]) {
					...
					f4 := f4;
					var v14 := new C4(cf47);
					var v15: map<bool, int> := map[!(v4 >= v4) := safeModuloInt(f4, cf47)];
					v15 := v15[cf46 ==> p1 := f4];
					cf45 := p1;
				}
			...
			case DC26(cf48, cf49) =>
				...
				v26 := !(f4 < (|(map v30 : int | (878 <= v30) && (v30 < 0x1b9) :: (safeDivisionInt(v30, cf48)) := (false))| * |v31|));
			case DC27(cf50, cf51, cf52) =>
				var v32 := new C0(0x38);
				var v33 := DC9(p1, 959);
				...
				var v39: map<char, int> := map[v37 := v38[safeIndex(cf52, |v38|)]];
				var v40: set<int> := {|v39|};
				var v41: set<bool> := {p1};
				...
				v46[safeIndex(744, v46.Length)] := p1;
				v46[safeIndex(744, v46.Length)] := f8;
			case DC24(cf44) =>
				...
				v49[safeIndex(395, v49.Length)] := v47;
				var v50: array<int> := new int[14];
				var v51 := DC47(v47);
				r2, r1, v49[safeIndex(395, v49.Length)] := v50, (v1 + (seq(abs(0x255), i2  => ('l')))) + (v1 + v1), v51.cf83;
				var v52 := false;
				var v53: seq<bool> := [v52, f8, p1, v52];
				var v54: seq<seq<bool>> := [v53, v53];
				var v56: set<seq<bool>> := {v53, v53, v53[safeIndex(f4, |v53|) := f8]};
				...
				v58[safeIndex(841, v58.Length)] := p1;
				v58[safeIndex(841, v58.Length)] := v53 < v53;
				var v59 := DC6(f4, v52);
				v52 := v59.cf11;
		}
		...
		for i3 := if (true) then |[p1]| else --p0 to p0 {
			...
			v60[safeIndex(195, v60.Length)] := v61[safeIndex(i3, |v61|)];
			v60[safeIndex(195, v60.Length)] := f8;
			var v62: seq<int> := [f4];
			var v63 := 'v';
			var v64 := new C3(|v61| + |v62|, [v63], p0);
			var v65 := new C3(-DC35(v64.f11, v60[safeIndex(195, v60.Length)], fm5(v1, true, globalState)).cf61 * 875, v64.f12, v64.f11);
		}
		var v66: seq<int> := [p0];
		...
		var v77: set<bool> := {f8};
		var v78: array<int> := new int[8] [|((seq(abs(0x3b2), i4  => ('t'))) + v1)|, |v76| - f4, |v77| + f4, p0, p0, -f4, |v1|, 0x186];
		r2 := v78;
	}
	method m6(globalState: GlobalState) returns (r0: seq<seq<int>>, r1: int) {
		...
		match (v0) {
			case DC29() =>
				...
				v2[safeIndex(7, v2.Length)] := if (|v6| in v5) then v5[|v6|] else f4;
				v1, v2[safeIndex(7, v2.Length)] := f8, |(seq(abs(0x143), i0  => ('s')))| * 288;
				v2[safeIndex(7, v2.Length)] := v2[safeIndex(7, v2.Length)];
				r1 := safeDivisionInt(f4 - f4, v2[safeIndex(7, v2.Length)]);
				f4 := -882;
			case DC30(cf54, cf55, cf56) =>
				cf56 := f8;
				var v7 := "qlevhtgt";
				cf56 := fm5(v7 + v7, cf56, globalState);
				var v8: array<int> := new int[4](i1 => safeModuloInt(i1, cf54));
				var v9: seq<int> := [f4, |v7|];
				var v10: map<int, bool> := map[v9[safeIndex(cf54, |v9|)] := f8];
				v8[safeIndex(693, v8.Length)] := safeModuloInt(fm1(globalState), |v10|);
				var v11: multiset<int> := multiset{cf54, f4, cf54};
				var v12: set<bool> := {cf56, f8, cf56, f8, false};
				v8[safeIndex(693, v8.Length)] := |(v11 * (multiset{|v7|, |v12|} * multiset(v9)))|;
				cf55 := cf55;
			case DC28(cf53) =>
				var v13 := true;
			...
			case DC31(cf57) =>
				...
				if (safeModuloInt(|v20|, f4) >= f4) {
					var v21: array<map<int, bool>> := new map<int, bool>[8];
					v21[safeIndex(904, v21.Length)] := map[f4 := f8];
					...
					v21[safeIndex(904, v21.Length)] := if (0x7c !in map[f4 := |[f4, v24.cf32]|]) then v22 + v22 else map[f4 := v19];
					v19 := f8;
					r1 := (f4 * f4) + safeModuloInt(f4, f4);
					var v25 := new C4(f4);
					...
					v20 := v20[v27[safeIndex(159, v27.Length)] := v19];
					var v40: array<map<D3, bool>> := new map<D3, bool>[1](i2 => (map v39 : D3 | v39 in {DC10(|v32|, |[v30.f13]|, v19, v30.f14, v27[safeIndex(159, v27.Length)])} :: (v39) := (v30.f13)) + map[DC10(v30.f14, |{f4}|, v30.f13, f4, v27[safeIndex(159, v27.Length)]) := v27[safeIndex(159, v27.Length)]]);
					var v41: map<bool, int> := map[v27[safeIndex(159, v27.Length)] := f4];
					var v42 := DC10(|v41|, f4, v27[safeIndex(159, v27.Length)], f4, v27[safeIndex(159, v27.Length)]);
					var v43: map<D3, bool> := map[v42 := v19];
					v40[safeIndex(46, v40.Length)] := v43;
					v40[safeIndex(46, v40.Length)] := fm46(f4, v30.f13, f4, globalState);
				}
				
				v19 := f8;
				var v44 := 'w';
				var v45: seq<char> := [v44, v44];
				var v46: array<char> := new char[3] [v44, v44, v45[safeIndex(f4, |v45|)]];
				v46 := v46;
		}
		...
		match (v47) {
			case DC51(cf90, cf91) =>
				...
				var v55: array<int> := new int[17] [safeDivisionInt(|multiset{f4}|, cf91), |(v48 + v48)|, DC46(f8, f4, -cf90, f8).cf81, v51[safeIndex(cf90, |v51|)], cf90, |(v48 + "aupng")|, cf91, safeDivisionInt(-0x2fd, f4), safeModuloInt(cf91, cf91), v51[safeIndex(if (cf90 in v52) then v52[cf90] else 0x3be, |v51|)], f4, cf91 * 235, f4, cf91, safeDivisionInt(|v53|, -|v48|), -|v54|, cf91];
				v55[safeIndex(633, v55.Length)] := safeModuloInt(-f4, f4);
				var v56: multiset<string> := multiset{seq(abs(180), i3  => ('m'))};
				v55[safeIndex(633, v55.Length)] := |v56|;
				var v57 := true;
				v57 := f8;
				cf90 := cf91;
				...
				var v60 := DC47(v59);
				var v61: map<int, array<seq<bool>>> := map[v55[safeIndex(633, v55.Length)] := v59];
				...
				v62[safeIndex(368, v62.Length)] := v59;
				var v63: map<bool, array<seq<bool>>> := map[f8 := v59];
				var v64: set<bool> := {!v57, v57};
				var v65: seq<set<bool>> := [v64];
				v62[safeIndex(368, v62.Length)] := if ((v65[safeIndex(-v55[safeIndex(633, v55.Length)], |v65|)] > {v57}) in v63) then v63[v65[safeIndex(-v55[safeIndex(633, v55.Length)], |v65|)] > {v57}] else v59;
			case DC52(cf92, cf93, cf94, cf95) =>
				f4 := fm1(globalState);
				var v66 := "rvvfgyry";
				cf92 := -safeModuloInt(|v66|, cf94);
				r1 := f4;
				if (!cf95) {
					var v67: seq<bool> := [cf95, f8, f8, f8, false];
					cf95 := !v67[safeIndex(-0x34f, |v67|)];
					cf95 := f8;
					var v68: map<char, bool> := map['w' := !f8];
					var v69: T0 := new C1(f4 * f4, safeModuloInt(|v68|, |v66|), f4, !f8);
					v69 := if (f8) then v69 else v69;
					var v70: multiset<int> := multiset{f4, --|v66|};
					var v71: seq<int> := [|(seq(abs(-0x282), i4  => ('n')))|, cf92, |v70|, -0x153, cf94];
					var v72: set<int> := {cf93};
					var v73: map<int, char> := map[|v72| := 'r'];
					var v74 := 'j';
					var v75: map<int, bool> := map[--cf92 := cf95];
					var v76: map<bool, bool> := map[f8 := !cf95];
					cf95 := if (v66[safeIndex(|v71|, |v66|) := if (v69.f4 in v73) then v73[v69.f4] else v74] == v66) then f8 else if (-|v76| in v75) then v75[-|v76|] else f8;
					var v77 := new C4(cf92);
				} else {
					var v78: seq<int> := [f4];
					...
					f4 := if (f8) then 0x27e else safeDivisionInt(f4, |(seq(abs(-0x220), i6  => ('x')))|);
					...
					var v88 := DC3(v87);
					v85[safeIndex(309, v85.Length)] := v88;
					v85[safeIndex(309, v85.Length)] := v88;
					cf95 := f8;
					v66 := v66;
				}
			...
			case DC50(cf89) =>
				...
				var v96 := DC13(v94, f8, v95[safeIndex(f4, |v95|)]);
				v92 := v92[false && f8 := v96.cf25];
				var v97: array<bool> := new bool[19](i8 => f8);
				v97 := v97;
				var v98: array<array<int>> := new array<int>[1];
				var v99 := false;
				var v100 := DC0(seq(abs(0x332), i9  => (f4)));
				var v101: set<int> := {f4};
				v91, v98, v99 := v100.cf0[safeIndex(f4 + f4, |v100.cf0|) := f4], v98, v101 > v101;
		}
		...
		if (f8) {
			...
			var v107: seq<D5> := [DC18(v106[safeIndex(f4, |v106|)], v102, f8)];
			...
			v103 := if (v102) then v103 else v103 - v113[safeIndex(f4, |v113|)];
			v102 := f8;
			if (f8) {
				...
				var v119: array<map<int, int>> := new map<int, int>[10](i10 => map[f4 := f4] + (map v118 : int | (347 <= v118) && (v118 < 0x22e) :: (safeDivisionInt(v118, |v108|)) := (v105.f18)));
				var v120: map<int, int> := map[v105.f18 := v105.f18];
				v119[safeIndex(101, v119.Length)] := v120;
				v119[safeIndex(101, v119.Length)] := (map v121 : int | v121 in v111 :: (v121 * v105.f18) := (|v108|)) + v120;
				v105.f18 := f4;
				r1 := safeModuloInt(v105.f18, f4);
				...
				v131[safeIndex(808, v131.Length)] := DC11(v130);
				var v132: set<string> := {v108 + v108};
				v127[safeIndex(527, v127.Length)] := v102;
				var v133: map<int, multiset<int>> := map[0x204 := v126 - v126];
				var v134: seq<multiset<int>> := [v126];
				v131[safeIndex(808, v131.Length)], v126, v132, f4, v127[safeIndex(527, v127.Length)] := v128, if (f4 in v133) then v133[f4] else v126, v132 + v132, |v134[safeIndex(-v105.f18, |v134|)]|, fm0(f4, v105.f18, globalState);
				var v135: map<bool, string> := map[v127[safeIndex(527, v127.Length)] := "rocniknf"];
				var v136: array<string> := new string[29] ["hegdluem" + v108, v108, (seq(abs(0x2b0), i11  => ('m'))) + "iytidt", v108, v108, v108, "ja", (seq(abs(0x6b), i12  => (v108[safeIndex(0x215, |v108|)]))) + v108, seq(abs(969), i13  => ('n')), v108, v108, v108 + "rbowqac", v108, v108 + (if (v127[safeIndex(527, v127.Length)] in v135) then v135[v127[safeIndex(527, v127.Length)]] else v108), seq(abs(0x133), i14  => ('v')), v108, v108, v108, v108 + v108, v108, v108, seq(abs(0x147), i15  => ('r')), v108, seq(abs(-0x292), i16  => ('v')), (seq(abs(0x2a9), i17  => ('m'))) + v108, v108, v108, v108 + (seq(abs(373), i18  => ('s'))), seq(abs(0x3cc), i19  => ('w'))];
				var v137: seq<string> := [v108];
				v136[safeIndex(593, v136.Length)] := v137[safeIndex(f4, |v137|)];
				v136[safeIndex(593, v136.Length)] := v108;
				...
				var v142: map<T1, bool> := map[v141 := v127[safeIndex(527, v127.Length)]];
				var v143: array<D2> := new D2[17] [v138, v138, v138, v138, v138, fm47("l", DC10(|v139|, v105.f18, f8, f4, true), "r", v102, globalState).(cf11 := f8), v138, v138, v138, v138, v138, fm47(v136[safeIndex(593, v136.Length)], fm20(false, v129, globalState), v137[safeIndex(v105.f18, |v137|)], v127[safeIndex(527, v127.Length)], globalState), v138, v138, v138, DC6(f4, !fm0(|v142|, f4, globalState)), v138];
				v143[safeIndex(525, v143.Length)] := v138;
				var v144 := DC10(f4, f4, true, fm1(globalState), v127[safeIndex(527, v127.Length)]);
				v127[safeIndex(527, v127.Length)], v111, v105.f18, v136[safeIndex(593, v136.Length)], v143[safeIndex(525, v143.Length)] := f8, v111 + v111[safeIndex(v141.f4, |v111|) := -v141.f4], v111[safeIndex(fm1(globalState), |v111|)] + |"w"|, fm23(v102, globalState), if (v144.cf21) then v138 else fm47(fm23(f8, globalState), v144, v108, f8, globalState);
			}
			...
			v147 := (multiset{v146, v146.(cf58 := v145), DC32(v145), v146.(cf58 := v145)} + v147)[fm48(globalState) := abs(f4)];
			r1 := -fm1(globalState);
			v102 := f8;
			var v148: array<int> := new int[14];
			v148[safeIndex(770, v148.Length)] := fm1(globalState);
			var v149: seq<int> := [f4];
			v148[safeIndex(770, v148.Length)] := v149[safeIndex(f4, |v149|)] - f4;
		}
		...
		var v154: array<char> := new char[29] [v150, v150, 'c', 'i', if (v102) then v150 else v150, v150, v150, v150, v151[safeIndex(833, |v151|)], v150, if (f4 in v152) then v152[f4] else fm27(v102, globalState), v150, 'i', v150, v150, 'c', 'y', v150, v150, v151[safeIndex(|v153|, |v151|)], v150, v150, v150, v150, v150, 'g', v150, v150, v150];
		forall i20 | 0 <= i20 < v154.Length {
			v154[i20] := if (f8) then v151[safeIndex(f4, |v151|)] else v150;
		}
...
class C7 extends T0 {
	...
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
		...
		var v18: array<bool> := new bool[18] [(seq(abs(0x2ba), i2  => ('s')))[safeIndex(if (|v9| in v8) then v8[|v9|] else f4, |(seq(abs(0x2ba), i2  => ('s')))|) := v10] != f7, p2, false, true, fm5(f7, p3, globalState), !(v11 in v12[v11 := p2]), v13 > (v14.(cf34 := v13)).cf34, p0, p2 <== true, v11.f4 <= -v11.f4, p3, p3, p0, v11.f4 == f4, p3, !([p0] <= v15), p0, if (fm28(f4, globalState) in v17) then v17[fm28(f4, globalState)] else p0];
		v18[safeIndex(82, v18.Length)] := v11.f4 > |f7|;
		v18[safeIndex(82, v18.Length)] := p3;
		v18[safeIndex(82, v18.Length)] := p0;
		v8 := v8[p1 := |[p1]|];
		var i3 := 0;
		while (p0)
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			var v19: seq<int> := [|{v18[safeIndex(82, v18.Length)], p0}|, p1];
			var v20: seq<int> := [v11.f4, -p1, v19[safeIndex(v11.f4, |v19|)], |v16|];
			var v21 := DC0(v19);
			match (v21) {
				case DC1(cf1, cf2, cf3) =>
					cf1 := -f4 + safeDivisionInt(v11.f4, |v16|);
					var v22: seq<seq<char>> := [f7];
					r0 := fm0(safeDivisionInt(|v13|, |v22[safeIndex(cf1, |v22|)]|), safeDivisionInt(-v11.f4, v11.f4), globalState);
					var v23: seq<seq<bool>> := [v15];
					v18[safeIndex(82, v18.Length)], v15, v18[safeIndex(82, v18.Length)], v18[safeIndex(82, v18.Length)], v18[safeIndex(82, v18.Length)] := false, v23[safeIndex(-|v9|, |v23|)] + v15[safeIndex(f4, |v15|) := p3], p3, !p3, !(if (p0) then true else v18[safeIndex(82, v18.Length)]);
					v10 := v10;
				case DC0(cf0) =>
					var v24: T2 := new C1(v11.f4, safeModuloInt(0xcd, v11.f4), f4, true);
					v24 := if (!(if (p2) then fm0(0x16d, |v19|, globalState) else p0)) then if (p2) then v24 else v24 else v24;
					v11.f4 := v11.f4;
					v15 := v15;
					var v25: seq<seq<int>> := [v19, v20];
					var v26 := new C2(v24.f16, |(v25[safeIndex(v24.f15, |v25|)] + (seq(abs(-835), i4  => (f4))))|);
				case DC2(cf4) =>
					var v27: seq<seq<bool>> := [v15, v15, v15];
					var v28 := new C0(|(v27[safeIndex(0x399, |v27|)] + [v18[safeIndex(82, v18.Length)]])|);
					var v29: map<bool, char> := map[p2 := v10];
					v18[safeIndex(82, v18.Length)] := false in (v29 + v29);
					var v30: map<string, int> := map[f7 := fm1(globalState)];
					var v31: set<int> := {|v15|, |v15|, v11.f4};
					v30, v11.f4, v11.f4, r0 := v30, safeDivisionInt(if (v18[safeIndex(82, v18.Length)] in v16) then v16[v18[safeIndex(82, v18.Length)]] else |v31|, p1), p1, p0;
					r0 := p3;
			}
			
			v13 := v13;
			var v32: map<string, multiset<char>> := map["cmjfifo" := multiset(f7)];
			var v33: map<bool, bool> := map[v18[safeIndex(82, v18.Length)] := v15[safeIndex(|v32|, |v15|)]];
			var v34: map<int, bool> := map[safeDivisionInt(v11.f4, v11.f4) := if (!false in v33) then v33[!false] else p2];
			v34 := v34[f4 + v11.f4 := v18[safeIndex(82, v18.Length)]];
			...
			v35[safeIndex(928, v35.Length)] := v38;
			v35[safeIndex(928, v35.Length)] := v38;
		}
		var v39: array<int> := new int[2] [|f7|, p1];
		forall i5 | 0 <= i5 < v39.Length {
			v39[i5] := safeModuloInt(i5, f4);
		}
		r0 := !(v18[safeIndex(82, v18.Length)] && p0);
	}
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		for i0 := 0x2c3 to p0 {
			var v0: seq<int> := [fm1(globalState)];
			if (safeModuloInt(|v0|, f4) < 0x20b) {
				...
				var v4 := 'n';
				v4 := f7[safeIndex(|f7|, |f7|)];
				var v5: array<map<bool, bool>> := new map<bool, bool>[8];
				var v6: multiset<bool> := multiset{p1, p1 <==> p1, p1, 857 in v0};
				v5, v6, f4 := if (p1) then v5 else v5, v6 * multiset{true}, -v0[safeIndex(fm1(globalState), |v0|)];
				var v7: multiset<string> := multiset{f7, f7[safeIndex(p0, |f7|) := v4]};
				var v8: T2 := new C1(p0, i0, i0, p1);
				var v9: map<T2, string> := map[v8 := f7];
				var v10: map<bool, string> := map[v8.f16 := f7];
				var v11: array<string> := new string[26] [f7, if (v8 in v9) then v9[v8] else f7, fm23(v8.f16, globalState), "jmdbnb", f7, f7, f7, f7, f7, f7, f7, f7, fm23(p1, globalState), seq(abs(0x12), i1  => ('a')), "gkid", f7, f7, f7, seq(abs(-0x3be), i2  => (v4)), seq(abs(-0x291), i3  => (v4)), f7, "lqxsea", f7, "r", f7, if (!false in v10) then v10[!false] else f7];
				var v12 := DC30(|v7|, v11, fm0(f4, |f7|, globalState));
				var v13 := DC8(if (v12.cf56) then v4 else v4, v1);
				v13 := v13;
				var v14: array<D24> := new D24[6];
				var v15 := DC64();
				v14[safeIndex(327, v14.Length)] := v15;
				v14[safeIndex(327, v14.Length)] := v15;
			} else {
				f4 := f4;
			...
			var v21 := DC54(p1, p1, v0[safeIndex(i0, |v0|)], p1);
		...
		var v26 := DC61(v25);
		v24[safeIndex(356, v24.Length)] := if (!p1) then v26 else v26;
		v24[safeIndex(356, v24.Length)] := v26;
		var v27 := true;
		v27 := p1;
		var v28: array<int> := new int[7](i5 => i5 + f4);
		var v29: seq<array<int>> := [v28];
		var v30: map<bool, bool> := map[p1 := v27];
		var v31: array<array<int>> := new array<int>[9] [v29[safeIndex(|v30|, |v29|)], v28, v28, v28, v28, v28, v28, v28, v28];
		v31[safeIndex(423, v31.Length)] := v28;
		v31[safeIndex(423, v31.Length)] := v28;
		var v32: seq<string> := [f7];
		for i6 := safeDivisionInt(0x76, |v32|) to p0 + f4 {
			f4 := safeModuloInt(i6, i6);
			if (if (v27) then p1 else v27) {
				f4 := i6;
				v30, v27 := v30, false;
				v27 := v27;
				var v33: map<array<int>, int> := map[v31[safeIndex(423, v31.Length)] := p0];
				var v34: map<bool, int> := map[p1 := f4];
				var v35: seq<map<array<int>, int>> := [map[v28 := p0], v33];
				var v36: array<map<array<int>, int>> := new map<array<int>, int>[28] [v33, v33 + map[v31[safeIndex(423, v31.Length)] := |v34|], v33, v33, map[v28 := p0], v33, v33, v33, v33 + v33, v33, map[v28 := i6], map[v28 := p0] + v33, v33, v33, v33 + v35[safeIndex(|(seq(abs(0xf3), i7  => (p0)))|, |v35|)], v33, v33, v33, v33, v33 + v33, v33, map[v31[safeIndex(423, v31.Length)] := -726], v33, map[v28 := i6] + v33, map[v31[safeIndex(423, v31.Length)] := p0], v33, v33, v33];
				v36[safeIndex(183, v36.Length)] := v33;
				v25[safeIndex(594, v25.Length)] := v27;
				...
				v27, f4, v36[safeIndex(183, v36.Length)], v25[safeIndex(594, v25.Length)] := v39[safeIndex(f4, |v39|)], p0, (if (v40[safeIndex(fm1(globalState), |v40|)] in v42) then v42[v40[safeIndex(fm1(globalState), |v40|)]] else v33) + map[v31[safeIndex(423, v31.Length)] := -0x7e], v27;
				...
				var v49: multiset<bool> := multiset{v48[safeIndex(p0, |v48|)]};
				...
				var v53 := 'f';
				v25[safeIndex(346, v25.Length)] := v52.f13;
				v52.f13, v53, v53, v52.f13, v25[safeIndex(346, v25.Length)] := v27, v53, if (if (v50.f18 in v51) then v51[v50.f18] else v27) then 'm' else v53, v52.f13, v52.f14 >= f4;
				var v54: map<bool, int> := map[v52.f13 := 740];
				var v55: seq<map<bool, int>> := [v54, map[true := p0], v54];
				var v56: seq<int> := [if (v25[safeIndex(346, v25.Length)] in v49) then v49[v25[safeIndex(346, v25.Length)]] else f4, f4];
				v27 := p1 !in v55[safeIndex(|v56|, |v55|)];
			}
			...
			var v61: map<bool, C0> := map[v57[safeIndex(f4, |v57|)] := v60];
			...
			match (if (true) then v63 else DC11(v62)) {
				case DC8(cf13, cf14) =>
					v27 := p1;
					v60.f18 := 0x374;
					var v65 := new C5(-|((seq(abs(899), i8  => (cf13))) + f7)|);
					var v66: multiset<bool> := multiset{false, cf13 in f7, v27};
					var v67: seq<int> := [f4, f4, safeModuloInt(562, v60.f18)];
					var v68: seq<seq<bool>> := [v57, [v27, v27, p1, p1, p1], v57, v57, v57];
					var v69: array<seq<bool>> := new seq<bool>[10] [v68[safeIndex(p0, |v68|)], v57, v57, v57 + [p1], ([!v27])[safeIndex(|f7|, |[!v27]|) := false], v68[safeIndex(i6, |v68|)], v57, v68[safeIndex(0xb1, |v68|)], v57, v57];
					v69[safeIndex(268, v69.Length)] := v57;
					v66, v67, v69[safeIndex(268, v69.Length)], f4, v27 := v66 + v66, [0x375, f4], v57 + [p1], i6, v27 ==> v27;
				case DC9(cf15, cf16) =>
					v27 := cf15 <==> fm5(f7, v27, globalState);
					r1 := ((seq(abs(-14), i9  => ('b')))[safeIndex(i6, |(seq(abs(-14), i9  => ('b')))|) := 'k'] + f7) + f7;
					v28[safeIndex(414, v28.Length)] := |multiset{0x269}|;
					v28[safeIndex(414, v28.Length)] := p0;
					v25[safeIndex(828, v25.Length)] := cf15;
					var v70: map<int, bool> := map[623 := v28[safeIndex(414, v28.Length)] <= |v58|];
					var v71 := DC22();
					var v72 := DC23(v71);
					...
					v28[safeIndex(414, v28.Length)], v27, v25[safeIndex(828, v25.Length)], v70, v27 := p0, multiset{v72, v72} > v73, false, ((map v74 : int | v74 in v75 :: (v74 + v28[safeIndex(414, v28.Length)]) := (cf15))[|v77| := v27] + v70)[f4 := cf15], v57[safeIndex(v60.f18, |v57|)];
				case DC10(cf17, cf18, cf19, cf20, cf21) =>
					cf19 := true;
				...
				case DC7(cf12) =>
					var v79 := DC12(f7);
					var v80: array<string> := new string[6] [f7 + f7, f7, f7, v79.cf23, v32[safeIndex(196, |v32|)], f7];
					v80[safeIndex(733, v80.Length)] := f7;
					v80[safeIndex(733, v80.Length)] := f7;
					var v81 := DC35(i6, v27, p1);
					f4 := -v81.cf61;
					var v82 := new C1(f4, f4, safeDivisionInt(v60.f18, p0), !p1);
					var v83: array<seq<bool>> := new seq<bool>[13](i10 => v57);
					var v84 := DC47(v83);
					var v85: seq<D18> := [v84];
					var v86: seq<seq<D18>> := [v85];
					v28[safeIndex(481, v28.Length)] := |(v86 + v86)|;
					...
					v91[safeIndex(249, v91.Length)] := map[p1 := f4];
					v28[safeIndex(481, v28.Length)], v27, v90, v91[safeIndex(249, v91.Length)], v60.f18 := -v82.f17, p1, DC49(DC49(v89).cf88), v58, if (v27) then v60.f18 else p0;
				case DC11(cf22) =>
					v27 := p1;
					var v92: map<int, bool> := map[fm1(globalState) := p1];
					var v93: seq<int> := [|f7|, v60.f18, f4, i6];
					var v94 := DC33(v31[safeIndex(423, v31.Length)]);
					var v95, v96, v97, v98 := m0(v92, v93, map[0x17a := v28] + map[v60.f18 := v94.cf59], globalState);
					var v99: multiset<seq<int>> := multiset{v93};
					v27 := v99 >= v99;
					var v100 := new C1(-v60.f18, |(seq(abs(828), i11  => ('e')))| - v60.f18, safeDivisionInt(v60.f18, 0x3b5), v98);
			}
		...
		r0 := ((fm51(multiset{|v101|, f4, |v102|} !! v103, v27, globalState))[safeIndex(if (v27) then p0 else -987, |fm51(multiset{|v101|, f4, |v102|} !! v103, v27, globalState)|) := v106])[safeIndex(p0, |(fm51(multiset{|v101|, f4, |v102|} !! v103, v27, globalState))[safeIndex(if (v27) then p0 else -987, |fm51(multiset{|v101|, f4, |v102|} !! v103, v27, globalState)|) := v106]|) := v106.(cf0 := v104)];
		r1 := f7;
		r2 := v31[safeIndex(423, v31.Length)];
	}
}
...
class C8 {
	...
	method m5(p0: seq<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		v7 := v7;
		v4 := "rdyiu" <= v0;
		for i0 := v5 to safeModuloInt(v5, v5) {
			r1 := v4;
			var v8 := new C2(v4, v5);
			var v9: array<int> := new int[19];
			v9[safeIndex(956, v9.Length)] := safeModuloInt(|p0|, 0xa9);
			v9[safeIndex(956, v9.Length)] := v5;
			var v10: C1 := new C1(v9[safeIndex(956, v9.Length)], i0, v8.f14, v4);
			var v11: array<C1> := new C1[7] [v10, v10, v10, v10, v10, v10, v10];
			var v12: map<bool, array<C1>> := map[v8.f13 := v11];
			v12 := v12;
		}
		v7[safeIndex(29, v7.Length)] := v4;
		v0, v0, v0, v7[safeIndex(29, v7.Length)] := fm23(v4, globalState), v0, v0 + (v0 + v0), v4;
		for i1 := v5 * v5 to v5 {
			var v13 := new C2(!v7[safeIndex(29, v7.Length)], -v5);
			r0 := v13.f14;
			r0 := -(i1 + v13.f14);
			var v14: seq<bool> := [fm0(|v6|, |map[v7[safeIndex(29, v7.Length)] := v13.f14]|, globalState), v13.f13];
			if (!([v4, v7[safeIndex(29, v7.Length)]] != v14)) {
				...
				v22[safeIndex(459, v22.Length)] := v20;
				var v23: map<int, char> := map[|map[v14 := v13.f13]| := v1];
				v22[safeIndex(459, v22.Length)] := if (!v7[safeIndex(29, v7.Length)]) then DC10(|(seq(abs(0x357), i2  => (v1)))[safeIndex(i1, |(seq(abs(0x357), i2  => (v1)))|) := v1]|, v13.f14, v7[safeIndex(29, v7.Length)], |v23[v13.f14 := v1]|, v7[safeIndex(29, v7.Length)]) else v20;
				var v24 := new C0(216);
			} else {
				v2 := {v1};
				var v25: array<string> := new string[4] [v0, v0 + "q", "nwkn", "cwvxgkcp"];
				v25[safeIndex(462, v25.Length)] := v0;
				v25[safeIndex(462, v25.Length)] := v0;
				var v26: multiset<array<bool>> := multiset{v7};
				var v27 := new C6(fm0(i1, v13.f14, globalState), v26 + v26, -safeModuloInt(i1, v5));
				var v28 := new C3(v13.f14, ([v1, v1, v1])[safeIndex(v5, |[v1, v1, v1]|) := v1], |v0|);
				v1 := v1;
			}
			
		}
		var v29: array<int> := new int[16](i3 => i3 * v5);
		v29[safeIndex(818, v29.Length)] := v5;
		v29[safeIndex(818, v29.Length)] := v5;
		r0 := v29[safeIndex(818, v29.Length)];
		r1 := v4;
	}
}
...
class C9 extends T0 {
	...
	method m3(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			f6 := p3 <==> (f5 <= p1);
			var v3 := 'j';
			v2.f7 := if (p3) then v2.f7[safeIndex(fm1(globalState), |v2.f7|) := v3] + v2.f7 else seq(abs(0x1ae), i1  => (v3));
			var v4: array<int> := new int[4](i2 => i2 + f4);
			v4[safeIndex(261, v4.Length)] := |v0|;
			v4[safeIndex(261, v4.Length)], v1 := f5, v1;
			var v5: seq<array<bool>> := [v1];
			if ((v5 + v5) < v5) {
				var v6: multiset<array<bool>> := multiset{v1};
				var v7 := new C6(p2, v6 - v6, f5);
				var v8 := new C4(v4[safeIndex(261, v4.Length)]);
				r0 := if (true) then p3 else f6;
				var v9 := DC16(f6, !p3, p2, f5, !(p1 == f4));
				v9 := v9;
				v1[safeIndex(380, v1.Length)] := !p3;
				v1[safeIndex(380, v1.Length)] := v7.f8;
			} else {
				var v10 := DC33(v4);
				v4 := v10.cf59;
				var v11 := DC37(p2, f6, p2);
				v4[safeIndex(261, v4.Length)] := -197 - |fm16(p2, [v2.f7, v2.f7], v11.cf65, f4, globalState)|;
				f5 := safeDivisionInt(0x2ee, p1);
				v1[safeIndex(867, v1.Length)] := p3 ==> p0;
				var v12: multiset<bool> := multiset{p0, p3};
				var v13: multiset<int> := multiset{p1 + f4, v4[safeIndex(261, v4.Length)], safeDivisionInt(|v12|, f4), f5, f5};
				v1[safeIndex(867, v1.Length)], v4[safeIndex(261, v4.Length)], r0, v4[safeIndex(261, v4.Length)], f5 := !p0, f5 - f4, p2, if (f4 in v13) then v13[f4] else p1, p1 * f5;
				var v14: array<bool> := new bool[16] [f6, v1[safeIndex(867, v1.Length)], p3, p3, p3, p0, !f6, !v1[safeIndex(867, v1.Length)], f6, f6, false, p2, true, v1[safeIndex(867, v1.Length)], p0, p2];
		...
		var v22: set<map<int, int>> := {if (f6) then v19 else map[|v20| := f4], v21[safeIndex(f5, |v21|)]};
		...
		v28[safeIndex(531, v28.Length)] := v24;
		v28[safeIndex(531, v28.Length)] := if (true) then v24.(cf20 := f4, cf18 := f5) else v24;
		if (!f6) {
			f4 := -safeDivisionInt(f5 + f5, |(seq(abs(632), i4  => ('c')))|);
			if (p1 <= f5) {
				v1 := v1;
				...
				var v30 := DC38(f5);
				var v31 := 'q';
				var v32 := new C3(v30.cf68, [v31] + v2.f7, safeDivisionInt(p1, f4));
				...
				v25[safeIndex(175, v25.Length)] := v43.cf47;
				var v44: map<bool, int> := map[f6 := f4];
				f4, v25[safeIndex(175, v25.Length)] := f4, if (p3 in v44) then v44[p3] else f4;
				f5 := -fm1(globalState);
			...
			var v68: array<map<bool, int>> := new map<bool, int>[14] [v64, v64, v65[safeIndex(|v66|, |v65|)], v64, if (true in v67) then v67[true] else v64, v64, v64, v64, v64, v64, v64, v64[true := p1], v64, v64];
			var v69 := DC60(v68);
			var v70: seq<D23> := [v69.(cf108 := v68)];
			if (if ((v63 + map[v61 := p0]) in v62) then v62[v63 + map[v61 := p0]] else v69 in v70) {
				v1[safeIndex(490, v1.Length)] := p2;
				v1[safeIndex(490, v1.Length)] := true;
				var v71: array<seq<bool>> := new seq<bool>[24];
				v71 := v71;
				var v72 := DC12(v2.f7);
				var v73: seq<string> := [v2.f7, v72.cf23];
				var v74: array<string> := new string[14] [v2.f7, v2.f7 + "wo", v2.f7 + v0, seq(abs(0xde), i5  => ('i')), "fuwrnbxif" + v2.f7, v0, v2.f7, v0, v2.f7, v73[safeIndex(f5, |v73|)], seq(abs(-990), i6  => ('e')), v2.f7 + v2.f7, v2.f7 + "qdw", fm23(!false, globalState)];
				v74[safeIndex(632, v74.Length)] := v2.f7;
				var v75: seq<bool> := [p3, p2 && p3, f6, p0, p0];
				var v76 := DC35(-safeDivisionInt(-p1, fm1(globalState)), p3, p3);
				var v77: multiset<map<int, int>> := multiset{v19};
				v74[safeIndex(632, v74.Length)], f5, f5, v75, v76 := v0 + (v2.f7 + v0), safeModuloInt(158 + |v2.f7|, safeDivisionInt(-f5, if (map[f4 := f4] in v77) then v77[map[f4 := f4]] else f4)), -(if (p3) then |v75| + p1 else p1), v75, DC35(if (|fm23(p3, globalState)| in v23) then v23[|fm23(p3, globalState)|] else p1, p3 <==> f6, p2);
				...
				var v85: seq<D7> := [v84];
				v85 := v85 + v85;
				v1[safeIndex(254, v1.Length)] := f6;
				v1[safeIndex(254, v1.Length)] := false;
			}
			...
			if (p2) {
				...
				v91[safeIndex(944, v91.Length)] := v25;
				v91[safeIndex(944, v91.Length)] := v25;
				f5 := f4;
				var v92: map<char, int> := map[v88 := -0x289];
				var v93: seq<map<char, int>> := [v92, v92];
				v93 := ((v93 + v93) + (v93 + v93))[safeIndex(f5, |((v93 + v93) + (v93 + v93))|) := map[v88 := f5] + v92];
			} else {
				...
				v94[safeIndex(992, v94.Length)] := v97;
				v94[safeIndex(992, v94.Length)] := v97;
				var v98 := new C4(p1);
				var v99 := new C0(f4);
			...
			v107 := v107;
			v25[safeIndex(760, v25.Length)] := fm1(globalState);
			var v108: seq<string> := [v0];
			var v109: set<int> := {f4};
			v25[safeIndex(760, v25.Length)], r0, f5, f5 := f5 * |(v108 + v108)|, v109 == (v109 + v109), -safeDivisionInt(f5, 495), p1 - p1;
			if (false) {
				v2.f7 := "mku";
				v25[safeIndex(760, v25.Length)] := -f4;
				f4 := |(v2.f7 + v2.f7)|;
				var v110: map<array<bool>, set<bool>> := map[v1 := v20];
				v110 := v110;
				var v111: map<int, map<int, int>> := map[f4 := map[-0x382 := v25[safeIndex(760, v25.Length)]]];
			...
			var v118 := new C7(v2.f7, |[|v117|, f4, v25[safeIndex(760, v25.Length)]]|);
		}
	...
	method m4(p0: int, p1: bool, globalState: GlobalState) returns (r0: seq<D0>, r1: string, r2: array<int>) {
		...
		v2 := v2[v0 + "q" := v1];
		f6 := f6;
		f4 := safeModuloInt(0x6c + f4, |((seq(abs(0x3c1), i0  => ('f'))) + fm23(p1, globalState))|);
		var v3: array<string> := new string[28];
		v3[safeIndex(6, v3.Length)] := v0 + v0;
		v3[safeIndex(6, v3.Length)] := v0[safeIndex(f5, |v0|) := v1];
		f5 := f5;
		var v4: seq<bool> := [f6];
		...
		var v11: map<int, string> := map[p0 := v3[safeIndex(6, v3.Length)]];
		var v12: T1 := new C1(p0, |v11|, f4, false);
		var v13: multiset<T1> := multiset{v12, v12};
		var v14: map<multiset<int>, multiset<T1>> := map[multiset{f5, |v0|, |v10|, |fm23(f6, globalState)|, f4} := v13[v12 := abs(f4)]];
...
class C10 {
	...
	method m1(globalState: GlobalState) returns (r0: set<bool>, r1: int, r2: bool) {
		...
		if (!(v5 in (map v6 : D0 | v6 in v7 :: (v6) := (v0)))) {
			...
			v14 := v14[0x249 := -|v11[f3 := abs(v0)]|];
			var v15: array<int> := new int[15];
			v15 := v15;
			var v16: seq<bool> := [f3];
			f3 := !v16[safeIndex(v0, |v16|)];
		} else {
			...
			v20[safeIndex(588, v20.Length)] := "yewpd";
			var v21: multiset<int> := multiset{0x3a7, -381};
			var v22: array<int> := new int[8];
			v22[safeIndex(724, v22.Length)] := v0;
			var v23: seq<bool> := [f3];
			var v24: array<seq<bool>> := new seq<bool>[6] [v23, [f3] + v23, v23, v23, v23[safeIndex(|v1|, |v23|) := f3], v23];
			var v25 := "juvstfji";
			v20[safeIndex(588, v20.Length)], v21, v22[safeIndex(724, v22.Length)], v24 := (v25 + v25) + (v25 + v25), v21, -v0, v24;
			var v26: map<bool, int> := map[true := |"bsd"|];
			var v27: set<int> := {-v0};
			var v28 := DC1(|v27|, v0, f3);
			v26 := if (if (f3) then v28.cf3 else f3) then v26 else v26 + v26;
			if (v27 > v27) {
				v0 := if (f3) then v22[safeIndex(724, v22.Length)] else v22[safeIndex(724, v22.Length)];
				...
				var v31: map<int, int> := map[-v22[safeIndex(724, v22.Length)] := v0];
				var v32: multiset<map<int, int>> := multiset{v31, v31, v31};
				v30[safeIndex(96, v30.Length)] := v32;
				v30[safeIndex(96, v30.Length)] := multiset{map[v22[safeIndex(724, v22.Length)] := v0], map[v22[safeIndex(724, v22.Length)] := v1[safeIndex(v0, |v1|)]]};
				f3 := v23[safeIndex(v22[safeIndex(724, v22.Length)], |v23|)];
			} else {
				v17 := v17;
				v18 := v20[safeIndex(588, v20.Length)][safeIndex(v0, |v20[safeIndex(588, v20.Length)]|)];
				f3 := (v22[safeIndex(724, v22.Length)] < 0x2a) <== f3;
				r1 := safeDivisionInt(v22[safeIndex(724, v22.Length)], v0);
				var v33: map<int, bool> := map[-|v1| := f3];
				var v34: set<map<int, bool>> := {v33, v33};
				var v36: set<char> := {v18, v18};
				v22[safeIndex(724, v22.Length)], r2, f3, v34 := v22[safeIndex(724, v22.Length)], f3, (set v35 : char | v35 in fm3(v22[safeIndex(724, v22.Length)], f3, v22[safeIndex(724, v22.Length)], globalState) :: (v35)) > ((set v37 : char | v37 in v36 :: (v37)) - v36), fm4(globalState);
			}
			
			v17[safeIndex(37, v17.Length)] := f3;
			v22, v17[safeIndex(37, v17.Length)], f3 := v22, fm0(v0, v22[safeIndex(724, v22.Length)], globalState), f3;
		}
			...
			decreases 100 - i0
		{
			...
			match (v4) {
				...
				case DC0(cf0) =>
					...
					v48[safeIndex(163, v48.Length)] := v0;
					v48[safeIndex(163, v48.Length)] := -v47.f11;
					v46 := v46;
				...
				case DC2(cf4) =>
					var v51 := "mso";
					var v52: map<int, string> := map[v1[safeIndex(v0, |v1|)] := v51];
					v52 := v52[v0 := "v"];
			...
			v63[safeIndex(411, v63.Length)] := v64;
			var v65 := "krgduhkps";
			var v66 := 'e';
			var v67: seq<array<bool>> := [v54, v54, v54];
			var v68: multiset<array<bool>> := multiset{v54, v54, v67[safeIndex(v59, |v67|)]};
			v63[safeIndex(411, v63.Length)] := new C6(|v65[safeIndex(v60, |v65|) := v66]| <= v60, v68, v59);
		}
		var v69: multiset<bool> := multiset{fm0(v0, v0, globalState)};
		var v70 := "vejkvyf";
		var v71: seq<bool> := [f3, f3, f3];
		var v72: set<bool> := {f3, f3};
		var v73: array<int> := new int[25] [|v69|, fm1(globalState), v0, |v70|, v0, v0, v0, v0, v0, fm1(globalState), v0, fm1(globalState), v0, v0, v0, v0, DC51(v0, -v0).cf90, v0, |v71|, v0, v1[safeIndex(v0, |v1|)], v0, |v71|, v0, |v72|];
		var v74 := DC33(v73);
		v74 := v74;
		var v75 := 'm';
		v75 := v75;
		...
		match (v77) {
			case DC8(cf13, cf14) =>
				...
				v78[safeIndex(696, v78.Length)] := v82;
				v78[safeIndex(696, v78.Length)] := v82;
				v70, v79.f4, r2 := v70 + "rbjxp", v79.f4 * -v79.f4, v71[safeIndex(0x134, |v71|)];
			...
			case DC9(cf15, cf16) =>
				...
				r2 := cf15 !in v84;
				cf16 := |(v1 + (seq(abs(-241), i3  => (|(set v85 : D14 | v85 in map[DC41({cf15, DC1(|v1|, cf16, cf15).cf3, cf15}) := DC46(false, cf16, v0, f3)] :: (v85))|))))|;
			...
			case DC10(cf17, cf18, cf19, cf20, cf21) =>
				v73[safeIndex(356, v73.Length)] := 0x2bd * cf17;
				v73[safeIndex(356, v73.Length)], v76 := cf18, v76;
				var v88 := DC12(v70);
				var v89 := DC14(v88);
				match (v89.(cf27 := DC12(v70))) {
					case DC13(cf24, cf25, cf26) =>
						cf21 := !cf25;
						v76[safeIndex(759, v76.Length)] := v69 !! v69;
						var v90: map<bool, int> := map[f3 := -0x3a6 - cf20];
						r1, v76[safeIndex(759, v76.Length)], cf21, f3, v90 := safeModuloInt(0x394, cf17), f3, cf19, f3, v90;
						v76[safeIndex(759, v76.Length)] := v76[safeIndex(759, v76.Length)];
						var v91: C7 := new C7("aax", |multiset{cf25, cf21}|);
						var v92: map<bool, C7> := map[f3 := v91];
						var v93: seq<C7> := [v91, if (v76[safeIndex(759, v76.Length)] in v92) then v92[v76[safeIndex(759, v76.Length)]] else v91];
						v73[safeIndex(356, v73.Length)] := v1[safeIndex(|([v91, v91] + v93)|, |v1|)];
					case DC12(cf23) =>
						f3 := f3;
					...
					case DC14(cf27) =>
						...
						cf18, v102, cf18 := |[v103]| + safeDivisionInt(-|v70|, cf20), v102, -|(v70 + v70)|;
						var v104: array<int> := new int[23];
						var v105: map<bool, array<int>> := map[cf21 := v104];
						var v106: map<set<string>, array<int>> := map[{seq(abs(203), i4  => (v70[safeIndex(v103.f4, |v70|)])), "qfpctmww"} := v104];
						...
						v108[safeIndex(702, v108.Length)] := v104;
						v108[safeIndex(702, v108.Length)] := v104;
				}
			...
			case DC7(cf12) =>
				...
				var v112 := DC30(v1[safeIndex(0x35f, |v1|)], if (fm0(-0x18b, v0, globalState)) then v110 else v111[safeIndex(|"xfoc"|, |v111|)], f3);
			...
			case DC11(cf22) =>
				...
				v118[safeIndex(99, v118.Length)] := v119;
				var v120: map<int, array<C3>> := map[0x3a6 := v118];
				var v121: seq<array<C3>> := [v118];
				var v122: array<array<C3>> := new array<C3>[13] [v118, if (|v119.f12| in v120) then v120[|v119.f12|] else v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v118, v121[safeIndex(v116.f15, |v121|)]];
				v122[safeIndex(850, v122.Length)] := v118;
				var v123: array<set<int>> := new set<int>[18];
				v117, r1, v118[safeIndex(99, v118.Length)], v122[safeIndex(850, v122.Length)], v123 := v117, v119.f11, v119, if (v119.f11 in v120) then v120[v119.f11] else v118, v123;
				v76[safeIndex(828, v76.Length)] := v0 > |v70|;
				v76[safeIndex(828, v76.Length)] := f3;
				var v124: map<int, bool> := map[v119.f11 := true];
				r1 := |v124|;
		}
		
		r0 := v72;
		var v125: map<bool, seq<int>> := map[f3 := seq(abs(-0x2a6), i6  => (v0))];
		r1 := |(fm53(f3, v0, globalState))[if (v71[safeIndex(v0, |v71|)] in v125) then v125[v71[safeIndex(v0, |v71|)]] else [v0] := v0]|;
		r2 := f3;
	}
	method m2(p0: string, p1: bool, globalState: GlobalState) {
		...
		if (p1 ==> (v0 !in v1)) {
			...
			v3[safeIndex(421, v3.Length)] := v4;
			v3[safeIndex(421, v3.Length)] := if (p1) then v4 else v4;
			if (f3) {
				var v5: C0 := new C0(v2);
				v5 := v5;
				var v6 := new C3(v2, p0, safeModuloInt(v2, v2));
				var v7: array<int> := new int[18](i1 => safeModuloInt(i1, v6.f11));
				v7[safeIndex(517, v7.Length)] := v2;
				v7[safeIndex(517, v7.Length)] := if (f3) then v2 else fm1(globalState);
				var v8: multiset<array<bool>> := multiset{v3[safeIndex(421, v3.Length)], v3[safeIndex(421, v3.Length)]};
				var v9: C6 := new C6(false, v8, v2);
				var v10: map<int, C6> := map[v7[safeIndex(517, v7.Length)] := v9];
				var v11: array<string> := new string[14];
				v11[safeIndex(357, v11.Length)] := "om";
				var v12: set<bool> := {false};
				var v13: map<int, int> := map[|v12| := v2];
				var v14: map<map<int, int>, bool> := map[v13 := p1];
				v7[safeIndex(517, v7.Length)], v10, f3, v11[safeIndex(357, v11.Length)], v7[safeIndex(517, v7.Length)] := v6.f11 * (if (v9.f8) then v6.f11 else v2), v10, p1, v6.f12, safeModuloInt(v7[safeIndex(517, v7.Length)], |v14|);
				var v15: array<map<string, bool>> := new map<string, bool>[11](i2 => map[v11[safeIndex(357, v11.Length)] := v9.f8]);
				var v16: map<string, bool> := map[p0 := !p1];
				v15[safeIndex(103, v15.Length)] := v16 + v16;
				var v17: seq<map<string, bool>> := [v16 + v16];
				var v18: seq<int> := [v6.f11, v6.f11];
				v15[safeIndex(103, v15.Length)] := v17[safeIndex(|v18|, |v17|)];
			} else {
				var v19: seq<multiset<char>> := [(multiset{v0})[v0 := abs(v2)]];
				var v20 := DC63(v19[safeIndex(v2, |v19|)]);
				v20, v2, v3 := v20, (v2 * v2) + (if (f3) then DC27(v2, v2, v2).cf51 else v2), v3;
				var v21: multiset<array<bool>> := multiset{v4};
				var v22: array<int> := new int[22](i3 => safeModuloInt(i3, v2));
				var v23: multiset<array<int>> := multiset{v22};
				var v24 := new C6(p1, v21, if (v22 in v23) then v23[v22] else fm1(globalState));
				v4[safeIndex(319, v4.Length)] := v24.f8;
				var v25: seq<int> := [v2];
				var v26: seq<bool> := [v24.f8, p1, v25 <= v25, false];
				f3, v4, v4[safeIndex(319, v4.Length)], v2, v26 := p0 < (p0 + p0)[safeIndex(v2, |(p0 + p0)|) := v0], v4, p1, -v2, fm2(v0, safeModuloInt(v2, v2), v2, globalState);
				v4[safeIndex(319, v4.Length)] := v24.f8;
				var v27: set<bool> := {!v24.f8};
				var v28: map<set<bool>, int> := map[v27 := |(seq(abs(877), i4  => (v0)))| - 0x263];
				v28 := v28[v27 := v2];
			}
			...
			var v32: seq<seq<int>> := [v31, [v2], seq(abs(0x2d7), i7  => (|{v2, v2, 708, -v2}|)), v31];
			var v33: seq<seq<int>> := [v31, seq(abs(816), i5  => (v2)), seq(abs(568), i6  => (v2)), v32[safeIndex(v2, |v32|)], v31];
			var v34 := new C6(v29.cf3, v30, |v33[safeIndex(|p0|, |v33|)]| + |{p1, true}|);
			f3 := true;
		} else {
			var v35: set<bool> := {p1};
			...
			var v39 := 0x11;
			v37 := v37[p0 < "knydbf" := (v36[p1 := v38[safeIndex(-v39, |v38|)]])[p1 := {!true}]];
			v39 := v39;
			f3 := p1;
			f3 := false;
			f3, v39, v39 := f3, 0x201 * v39, safeModuloInt(safeDivisionInt(v39, v39), v39);
		}
		
		var v41 := 0x2fd;
		var v42: array<int> := new int[5];
		var v43: map<int, array<int>> := map[v41 := v42];
		var v44, v45, v46, v47 := m0(map v40 : int | (-0x280 <= v40) && (v40 < 87) :: (v40 + |p0|) := (p1), seq(abs(-814), i8  => (0xbd)), v43, globalState);
		if (true && v47) {
			var v48 := "v";
			v48 := p0;
			var v49: array<bool> := new bool[4];
			v49[safeIndex(362, v49.Length)] := p1;
			var v50 := DC35(v44, p1, f3);
			var v51: multiset<bool> := multiset{!p1, true};
			v44, v41, v49[safeIndex(362, v49.Length)], v50, v47 := v44, v45, !(v51 > v51), if (v47 || v50.cf62) then DC35(v41, v47, f3) else v50, !((v41 - v44) == v44);
			...
			if (!false) {
				...
				v55 := new C0(safeDivisionInt(v41, v44));
				...
				var v59: map<char, string> := map[v0 := ("gwwwqmca")[safeIndex(v41, |"gwwwqmca"|) := p0[safeIndex(v45, |p0|)]]];
				v58 := (fm54(0x2ba + v55.f18, v0, v59, globalState))[safeIndex(v41, |fm54(0x2ba + v55.f18, v0, v59, globalState)|) := if (v52[safeIndex(v44, |v52|)]) then v48 else p0];
				var v60: array<D16> := new D16[21];
				var v61: array<C0> := new C0[18];
				var v62: map<int, array<C0>> := map[v45 := v61];
				v60[safeIndex(39, v60.Length)] := DC44(v62);
				var v63 := DC44(v62);
				v60[safeIndex(39, v60.Length)] := if (v47) then DC44(v62) else v63;
			} else {
				v49[safeIndex(362, v49.Length)] := v47;
				var v64: map<int, int> := map[v45 := v44];
				v64 := map v65 : int | (562 <= v65) && (v65 < 0x2d8) :: (safeDivisionInt(v65, -|map[f3 := v44]|)) := (v45);
				f3 := v49[safeIndex(362, v49.Length)] || v49[safeIndex(362, v49.Length)];
				var v66: map<bool, bool> := map[v49[safeIndex(362, v49.Length)] := v47];
				var v67: set<map<bool, bool>> := {v66, v66, v66, v66, map[p1 := v49[safeIndex(362, v49.Length)]]};
			...
			v46[safeIndex(606, v46.Length)] := |v76| - v44;
			v74, v46[safeIndex(606, v46.Length)], v0, v47 := v74, fm1(globalState), v0, -safeDivisionInt(v45, v45) > v44;
			var v77: array<D19> := new D19[19](i9 => DC52(v46[safeIndex(606, v46.Length)], v41, DC52(v41, v41, v45, p1).cf94, f3));
			var v78: C1 := new C1(v46[safeIndex(606, v46.Length)], 0x183, v44, true);
			var v79: map<C1, bool> := map[v78 := v47];
			var v80 := DC52(633, fm1(globalState), |v79|, !f3);
			v77[safeIndex(540, v77.Length)] := v80;
			v77[safeIndex(540, v77.Length)] := DC52(|p0[safeIndex(|map[v47 := v45]|, |p0|) := v0]|, |[v45]|, safeModuloInt(v78.f17, v41), p1);
			var v81 := DC1(v78.f17, v41, v47);
			var v82 := DC2(v81);
			var v83 := DC2(v82);
			var v84: seq<D0> := [v83, v83];
			var v85: map<int, int> := map[v78.f17 := -v41];
			f3, v41, v84 := v47, |map[(if (v44 in v85) then v85[v44] else fm1(globalState)) <= v78.f17 := v46[safeIndex(606, v46.Length)]]|, seq(abs(0x3d0), i10  => (v83));
			var v86: map<int, bool> := map[v46[safeIndex(606, v46.Length)] := v47];
			v86 := v86[v44 := v47];
		}
		...
		var v89: set<seq<char>> := {(['r'])[safeIndex(v45, |['r']|) := v0]};
		var i11 := 0;
...
function fm1(globalState: GlobalState): int {
	safeDivisionInt(720, |"r"|) + safeDivisionInt(|{false}|, |{false}|)
}
...
function fm14(p0: int, p1: int, p2: bool, p3: char, globalState: GlobalState): seq<int> {
	match if (true) then DC37(true, true, false) else DC37(false, !true, true) {
		...
		case DC36(cf64) => [|map[true := |(seq(abs(0x2b1), i0  => ('h')))|]|] + [0x2ce]
	}
}
...
function fm18(p0: int, p1: int, p2: int, globalState: GlobalState): map<string, int> {
	map[seq(abs(352), i0  => ('b')) := |[true, !false]|] + map["txtdxytq" := 0x339]
}
...
function fm20(p0: bool, p1: set<int>, globalState: GlobalState): D3 {
	DC10(-0x382, safeModuloInt(0x12d, -0x2cb), |[513, 745, -|[!!true]|, |multiset{true, false}|, -0x2d1]| != |map[0xe := |(seq(abs(0x2fe), i0  => ('i')))|]|, safeModuloInt(|"daknbvfwa"|, |"svirrblg"|), 0x1fd > 924)
}
...
function fm24(globalState: GlobalState): multiset<seq<int>> {
	(multiset([[--0x34d, |"qhpo"|, -0x2ab, |[!true, !true]|], [|(seq(abs(0x33c), i0  => (|[|[true, false]|]|)))|]]) - multiset{seq(abs(-0x1c2), i1  => (0x179)), [0x2bb, |"yycq"|]}) + (if (!false) then multiset{seq(abs(418), i2  => (-|map[!false := 'm']|))} else multiset{[|(seq(abs(0x17d), i3  => ('k')))|, 0x146, |[false]|, -|multiset{"j", "gpcwyeyi"}|, |[true]|], [266, 0x226]})
}
...
function fm30(globalState: GlobalState): D12 {
	match DC54(false, true, |map[|"pdadbgu"| := |(seq(abs(0x2d0), i0  => (map[0x365 := !true])))|]|, true) {
...
function fm31(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<bool, set<int>> {
	DC70(map[true := {|multiset{!true}|, |{map[|(seq(abs(231), i0  => ('l')))| := !false], map[-0x111 := true], map v0 : int | v0 in [0x63] :: (safeModuloInt(v0, |map[0x2d4 := true]|)) := (true), map[|[false]| := true]}|}]).cf116
}
function fm32(p0: char, p1: D13, globalState: GlobalState): D7 {
	DC26(-0x1c1 * --|"ewkrdwrs"|, |((seq(abs(584), i0  => (-0x163))) + [|[true, !true]|])|)
}
...
function fm38(p0: D19, p1: string, p2: bool, globalState: GlobalState): D12 {
	DC38(safeDivisionInt(0xea, |multiset{false}|))
}
...
function fm43(globalState: GlobalState): seq<multiset<char>> {
	([multiset(['q', 'f'])] + (seq(abs(0x3c1), i0  => (multiset{'m'})))) + ([multiset{'y', 'd', 'b', 'l', 'h'}] + [multiset{'d'}])
}
...
function fm45(p0: bool, p1: bool, globalState: GlobalState): map<int, int> {
	if (false) then map[601 := -0x15f] + (map v0 : int | (-0x39d <= v0) && (v0 < 0x2f5) :: (v0 * 0x161) := (-712)) else map[|[map[false := 'e'], map[false := 'p']]| := |[true]|] + (map v1 : int | v1 in multiset([|multiset{seq(abs(0x11a), i0  => (444))}|]) :: (safeModuloInt(v1, 0x392)) := (-0x127))
}
function fm46(p0: int, p1: bool, p2: int, globalState: GlobalState): map<D3, bool> {
	(map v0 : D3 | v0 in {DC10(962, 0x2e7, false, 0x7f, !true)} :: (v0) := (true)) + (map[DC10(-|(map v1 : int | v1 in (seq(abs(876), i0  => (0x1d4))) :: (safeModuloInt(v1, |[true, false]|)) := (67))|, 0x3cb, true, -0xb0, !false) := false] + (map v2 : D3 | v2 in (seq(abs(0x2d7), i1  => (DC10(|[false, true]|, -|map[false := true]|, false, |"b"|, false)))) :: (v2) := (false)))
}
...
function fm48(globalState: GlobalState): D9 {
	DC32(multiset{|"oshom"|, |(seq(abs(847), i0  => ('i')))|} + multiset{0x2f3})
}
function fm49(p0: bool, p1: bool, p2: int, globalState: GlobalState): seq<seq<int>> {
	([[-982, |"c"|]] + (seq(abs(0xcf), i0  => ([|(seq(abs(166), i1  => ('i')))|, |"ourm"|])))) + (seq(abs(0x31b), i2  => (seq(abs(-0x28b), i3  => (|[!false, !true, true, !false]|)))))
}
...
function fm51(p0: bool, p1: bool, globalState: GlobalState): seq<D0> {
	[DC0([0xd6, 168, -0x80, -|"vx"|]), DC0([-0x225, |"eurutqjd"|]), if (!true) then DC0([|"ioa"|]) else DC0(seq(abs(0x123), i0  => (0x399))), DC0([318]), DC0([|(seq(abs(0x4), i1  => (479)))|])]
}
function fm52(p0: int, globalState: GlobalState): set<map<int, int>> {
	(set v4 : map<int, int> | v4 in (set v3 : map<int, int> | v3 in (set v2 : map<int, int> | v2 in multiset{map[0x2a8 := -0x8], map v0 : int | (0x1c0 <= v0) && (v0 < -932) :: (safeModuloInt(v0, |(seq(abs(0x109), i0  => ('f')))|)) := (-0x35a), map v1 : int | (0x1ba <= v1) && (v1 < -0x374) :: (v1 - |[false]|) := (|"sdy"|)} :: (v2)) :: (v3)) :: (v4)) - ((set v8 : map<int, int> | v8 in multiset([map v5 : int | (0x3a2 <= v5) && (v5 < 503) :: (v5 + 369) := (0x32), map v6 : int | v6 in [|"tu"|, 0x1ee] :: (safeDivisionInt(v6, -0x384)) := (595), map v7 : int | (210 <= v7) && (v7 < 130) :: (safeDivisionInt(v7, |['v', 'i']|)) := (327)]) :: (v8)) * DC83(set v9 : map<int, int> | v9 in multiset([map[-|"sxrucrnd"| := |"wrre"|]]) :: (v9)).cf139)
}
...
function fm54(p0: int, p1: char, p2: map<char, string>, globalState: GlobalState): seq<string> {
	match DC25(true, true, 36) {
		...
		case DC24(cf44) => if (!true) then ["xxwbaqyk"] else seq(abs(0x240), i0  => (seq(abs(0x1a3), i1  => ('y'))))
	}
}
...
method m0(p0: map<int, bool>, p1: seq<int>, p2: map<int, array<int>>, globalState: GlobalState) returns (r0: int, r1: int, r2: array<int>, r3: bool) {
	...
	if (!!fm0(v0, v0 - v0, globalState)) {
		...
		var v10: map<seq<D14>, seq<bool>> := map[v8 := ([v1, v1] + v9)[safeIndex(v0, |([v1, v1] + v9)|) := v4.f8]];
		...
		v13 := new C1(v13.f17, v13.f17, v0, v14[safeIndex(v0, |v14|)]);
		var v15 := "mq";
		var v16: seq<string> := [seq(abs(958), i1  => ('w'))];
		var v17: seq<string> := [seq(abs(602), i0  => ('a')), v15, v16[safeIndex(v13.f17, |v16|)]];
		r3 := v11 <== (v17 < v16);
		r0 := fm1(globalState);
		v15 := v15;
	...
	var v31: array<int> := new int[23] [safeModuloInt(fm1(globalState), v0), |v23|, |({v24} + v25)|, v0, v0, --0x280, |(v27[safeIndex(0x10c, |v27|)])[safeIndex(v0, |v27[safeIndex(0x10c, |v27|)]|) := v20]|, v0, |v23|, if (v20) then v0 else v0, v24.fm6(v0, v28, v20, |v23|, globalState), v0, v0, v0, |v19|, v0, -v0 * v0, v0, v0, |(v19 + v29[safeIndex(v0, |v29|)])|, -0x2fb, |v30|, v0];
	r2 := v31;
	var v32, v33 := v24.m5(p1 + p1, globalState);
	v23 := v23[safeIndex(v0, |v23|) := 'v'];
	r0 := -safeModuloInt(v0, safeDivisionInt(v32, if (v0 in v19) then v19[v0] else 550));
	var v34 := DC10(v32, v0, false, v32, v20);
	r0 := match v34 {
		case DC8(cf13, cf14) => v0
		case DC9(cf15, cf16) => v0
		case DC10(cf17, cf18, cf19, cf20, cf21) => safeDivisionInt(cf18, cf20)
		case DC7(cf12) => safeDivisionInt(0xd5, v0)
...
method Main() {
		...
		decreases 100 - i0
	{
		...
		var v3 := "mkfno";
		var v4 := 'b';
		v3 := ((v3 + (seq(abs(0x25b), i1  => ('j')))) + v3)[safeIndex(fm1(globalState), |((v3 + (seq(abs(0x25b), i1  => ('j')))) + v3)|) := v4];
		...
		v11 := v10;
		v12[safeIndex(304, v12.Length)] := -77;
		v6, v12[safeIndex(304, v12.Length)] := seq(abs(191), i2  => (v2)), v11;
	}
	...
	v0, v19, v22, v23, v0 := v19 == |v24|, v20 + 0x108, v26 < v26, v23, v28 >= (multiset(v30))[v27 := abs(v19)];
	var v31 := DC1(v19, v19, v0);
	var v32 := DC2(v31);
	var v33 := DC2(v31);
	v33 := DC2(v31);
	var v34 := new C1(if (v27[safeIndex(v19, |v27|)]) then v20 else -733, v19, v19, !v0);
	var v35: map<int, bool> := map[v2 := v0];
	var v36 := DC6(v19, v22);
	var v37: map<int, string> := map[safeModuloInt(-v19, |v35|) := ("nyrdn")[safeIndex(|v15|, |"nyrdn"|) := v34.fm10(-0xf9, v0, v22, v36, globalState)]];
		...
		decreases 100 - i3
	{
		...
		i3 := i3 + 1;
		v34.f17 := |(v24 - v24)[v34.f17 := abs(v34.f17)]|;
		var v39: C7 := new C7(v23, v19);
		v39 := new C7(seq(abs(-0x32a), i4  => (v29)), v34.f17);
		...
		if (if (v40 in v41) then v41[v40] else !v22) {
			...
			v42[safeIndex(174, v42.Length)] := v39.f7;
			v42[safeIndex(174, v42.Length)] := v39.f7;
			v0 := (v39.f7 + v39.f7) < v42[safeIndex(174, v42.Length)];
			v22 := v22;
			var v43: C8 := new C8();
			var v44: set<C8> := {v43, v43};
			var v45: map<int, set<C8>> := map[v2 := v44];
			v17[safeIndex(968, v17.Length)] := |(if (v2 in v45) then v45[v2] else v44)|;
			v17[safeIndex(968, v17.Length)] := safeDivisionInt(|v24|, safeDivisionInt(v34.f17, v34.f17));
	...
	v58[safeIndex(297, v58.Length)] := !v0;
	var v59: set<array<bool>> := {v58};
	v58[safeIndex(297, v58.Length)] := v0 <== (v34.f17 == |v59|);
	...
	var v67: array<map<int, char>> := new map<int, char>[29] [v60, v60 + map[|map[v62 := v63]| := v29], map[v2 := v29], map[v57.f18 := v29] + v60, v60, v60 + v60, v60, v60, v60, (map[|v14| := v29])[|v64| := v29], v60, v60, v60, v60, v60, v60[v19 := v29], v60, v60, (map v65 : int | (0x140 <= v65) && (v65 < 0x3a2) :: (safeDivisionInt(v65, v34.f17)) := (v29)) + v60, fm55(-817, v34.f17, v61.f11, globalState), v60, v60[v34.f17 := 'b'], v66[safeIndex(|fm37(v0, !v0, v57.f18, globalState)|, |v66|)], fm55(-v19, 0x23f, v19, globalState), v60, v60 + v60, v60, v60[|v27| := 'e'], v60];
	v67 := v67;
	var v68 := DC63(multiset(v23));
	v0, v22 := match v68 {
		case DC64() => !v58[safeIndex(297, v58.Length)]
		case DC63(cf111) => v0
	}, (fm23(v58[safeIndex(297, v58.Length)], globalState))[safeIndex(v61.f11, |fm23(v58[safeIndex(297, v58.Length)], globalState)|) := v29] == "rtmcb";
	var v69 := new C8();
	var v70: T1 := new C4(safeDivisionInt(|multiset{|v61.f12|, |v61.f12|}|, v19));
	v70 := v70;
	var v71: C5 := new C5(v20);
	for i7 := |(map[DC22() := v71])[fm58(v0, globalState) := v71]| to v34.f17 {
		v21[safeIndex(554, v21.Length)] := -v61.f11;
		var v72: map<C5, bool> := map[v71 := v58[safeIndex(297, v58.Length)]];
		v21[safeIndex(554, v21.Length)] := |(if (v61.f12 <= v61.f12) then v72 else v72)|;
		var v73: C9 := new C9(v57.f18, true, v21[safeIndex(554, v21.Length)]);
		var v74: map<C9, string> := map[v73 := v23];
		var v75: array<string> := new seq<char>[18] [v61.f12 + v23, if (v58[safeIndex(297, v58.Length)]) then "uyi" else seq(abs(0xe6), i8  => (v29)), seq(abs(0x1b1), i9  => (v29)), v61.f12, v61.f12, v61.f12 + v61.f12, "yndayr", if (v73 in v74) then v74[v73] else v23, "ntmnqxyon", v61.f12 + v61.f12, v23 + v23, "lggkiehv", v61.f12, v61.f12, v61.f12, v23, v23, "b"];
		v75[safeIndex(636, v75.Length)] := v61.f12[safeIndex(v61.f11, |v61.f12|) := v29];
		v75[safeIndex(636, v75.Length)], v21[safeIndex(554, v21.Length)], v24 := v61.f12, v69.fm6(v73.f5, v38, v22 && v73.f6, v34.f17 + v34.f17, globalState), v24;
		var v76: array<seq<map<bool, bool>>> := new seq<map<bool, bool>>[14];
		var v77: seq<map<bool, bool>> := [v1, map[false := true]];
		v76[safeIndex(664, v76.Length)] := v77 + v77;
		v76[safeIndex(664, v76.Length)] := (seq(abs(-0x7a), i10  => (map[true := v0]))) + v77[safeIndex(-478, |v77|) := map[v58[safeIndex(297, v58.Length)] := v22]];
		v2 := v21[safeIndex(554, v21.Length)];
	}
	...
	print i0, "\n";
	print v14 == {false}, "\n";
	print v15 == [229, 229, 229, 1], "\n";
	print v16.cf0 == [229, 229, 229, 1], "\n";
	print |v18|, "\n";
	print v19, "\n";
	print v20, "\n";
	print v21[0], "\n";
	...
	print v22, "\n";
	print v23, "\n";
	print v24 == multiset{955}, "\n";
	print |v26|, "\n";
	print v27 == [false], "\n";
	print v28 == multiset{[false, false], [false], [false]}, "\n";
	print v29, "\n";
	print v30 == [[true, true, false]], "\n";
	print v31.cf1, "\n";
	print v31.cf2, "\n";
	print v31.cf3, "\n";
	print v32.cf4.cf1, "\n";
	...
	print v33.cf4.cf3, "\n";
	print v34.f17, "\n";
	print v35 == map[229 := false], "\n";
	print v36.cf10, "\n";
	print v36.cf11, "\n";
	print v37 == map[0 := "nyrdh", 800 := "sc"], "\n";
	print v38 == {-490, -99}, "\n";
	print i3, "\n";
	print v57.f18, "\n";
	print v58[0], "\n";
	...
	print v63.cf14[20], "\n";
	print v63.cf14[21], "\n";
	print v64 == map[[229, 229, 229, 1] := -226], "\n";
	print v66 == [map[721 := 'w']], "\n";
	print v67[0] == map[721 := 'w'], "\n";
	print v67[1] == map[721 := 'w', 1 := 'w'], "\n";
	print v67[2] == map[229 := 'w'], "\n";
	print v67[3] == map[229 := 'w', 721 := 'w'], "\n";
	print v67[4] == map[721 := 'w'], "\n";
	print v67[5] == map[721 := 'w'], "\n";
	print v67[6] == map[721 := 'w'], "\n";
	print v67[7] == map[721 := 'w'], "\n";
	print v67[8] == map[721 := 'w'], "\n";
	print v67[9] == map[1 := 'w'], "\n";
	print v67[10] == map[721 := 'w'], "\n";
	print v67[11] == map[721 := 'w'], "\n";
	print v67[12] == map[721 := 'w'], "\n";
	print v67[13] == map[721 := 'w'], "\n";
	print v67[14] == map[721 := 'w'], "\n";
	print v67[15] == map[721 := 'w', -226 := 'w'], "\n";
	print v67[16] == map[721 := 'w'], "\n";
	print v67[17] == map[721 := 'w'], "\n";
	print v67[18] == map[0 := 'w', 1 := 'w', 721 := 'w'], "\n";
	print v67[19] == map[-244 := 'p', 693 := 'a'], "\n";
	print v67[20] == map[721 := 'w'], "\n";
	print v67[21] == map[721 := 'b'], "\n";
	print v67[22] == map[721 := 'w'], "\n";
	print v67[23] == map[-244 := 'p', 693 := 'a'], "\n";
	print v67[24] == map[721 := 'w'], "\n";
	print v67[25] == map[721 := 'w'], "\n";
	print v67[26] == map[721 := 'w'], "\n";
	print v67[27] == map[721 := 'w', 1 := 'e'], "\n";
	print v67[28] == map[721 := 'w'], "\n";
	print v68.cf111 == multiset{'s', 'c'}, "\n";
	print v70.f4, "\n";
}