...
function fm0(p0: bool, p1: string, p2: bool, p3: int, globalState: GlobalState): int {
	|map[-469 := false]| * (-0x19b / |{|multiset(seq(94, i0  => (0x16e)))|}|)
}
function fm1(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): set<int> {
	({|[map v0 : int | (0x352 <= v0) && (v0 < 668) :: (v0 % -0x364) := (|(set v1 : char | v1 in map['b' := false] :: (v1))|)]|} + {0xb0}) + ({0xa6} + {-|[-|"henpihgvp"|, |(seq(0x5b, i0  => ('u')))|, 0x3a8]|})
}
function fm3(p0: int, p1: bool, p2: seq<bool>, p3: map<bool, int>, globalState: GlobalState): seq<D1> {
	seq(0x4c, i0  => (DC4(DC3(true, true, false, !!!true))))
}
function fm4(p0: bool, globalState: GlobalState): multiset<bool> {
	multiset{DC11('b', true, multiset{'t'}, true, seq(-0x343, i0  => (multiset{493}))).cf20}
}
...
function fm8(p0: bool, globalState: GlobalState): seq<int> {
	(if (false) then [|{false, false}|] else [|(map v0 : int | (0x3ab <= v0) && (v0 < 0x1d2) :: (v0 * |map[false := false]|) := (false))|, 0x34c, 0x206]) + (seq(681, i0  => (0xf4)))
}
...
function fm10(p0: int, p1: int, p2: multiset<map<int, int>>, p3: int, globalState: GlobalState): multiset<map<bool, bool>> {
	match DC11('h', false, multiset{'m', 'f', 'p', 'd', 'd'}, true, seq(0x10f, i0  => (multiset{|(map v0 : int | (0x1a5 <= v0) && (v0 < 0x227) :: (v0 - |"dxbtxxe"|) := (|"gi"|))|}))) {
		...
		case DC9(cf15) => multiset([map[false := true]] + (seq(0x278, i1  => (map[true := false]))))
	}
}
method m0(p0: int, p1: bool, p2: bool, p3: string, globalState: GlobalState) returns (r0: set<set<int>>, r1: bool, r2: multiset<map<bool, bool>>) {
	if (p1) {
		globalState.f15 := p0 % (p0 / 0x27f);
		var v0: seq<int> := [p0, p0, -fm0(p1, p3, p2, p0, globalState), p0 - p0];
		var v1 := 'y';
		var v2: C0 := new C0(p0, v1);
		var v3 := "deyue";
		var v4 := DC0(v3);
		v0, globalState.f6, globalState.f13, v2, v3 := fm8(p2 ==> p2, globalState), (fm7(false, v2.f19, |v0|, globalState) + v3) == (if (!p2) then v3 else v4.cf0), v2.f19, v2, "hkykdidt" + (seq(0x4a, i0  => (v1)));
		var v5: array<int> := new int[8](i1 => i1 % v2.f19);
		...
		v9 := v9 + v9;
		var v10: array<char> := new char[14] [v1, v1, p3[v2.f19], v2.f20, v2.f20, v2.f20, v1, 'c', v1, v1, v2.f20, v2.f20, v1, v2.f20];
		v10[614] := v1;
		v10[614] := v2.f20;
	} else {
		var v11 := 'a';
	...
	for i5 := p0 to p0 {
		...
		match (fm9(true, |(v23 + v23)|, globalState)) {
			case DC7() =>
				globalState.f6 := true;
				var v24: seq<bool> := [p1];
				var v25: seq<string> := [(p3[p0 := 'i'])[i5 := fm5(globalState)], p3, p3 + p3, fm7(!v24[i5], p0, p0, globalState)];
				v25 := v25 + v25;
			...
			case DC8(cf14) =>
				...
				v35, r1 := v36[cf14], |v38[v37 := cf14]| < 0x38c;
		...
		var v49 := 'c';
		v19[518] := i5 / fm0(p1, p3, fm6(|v48|, v49, |[p2]|, globalState), p0, globalState);
		v19[518] := -p0;
	}
	...
	var v56: set<set<int>> := {v54, v54 + (set v55 : int | (-0x91 <= v55) && (v55 < 464) :: (v55 / |[p2, p1, true, p1, p1]|)), fm1(p1, v53.f19, p0, 503, globalState)};
	r0 := v56;
	r1 := p1;
...
method Main() {
	...
	var v8: set<int> := {v0, v7[-857], v0, v0, v0};
	var v9: multiset<set<int>> := multiset{fm1(v2, -|[true, v2, true, v2, v2]|, v0, -v0, globalState), v8};
	var v11: map<int, int> := map[v0 := -v0];
	var v12: array<int> := new int[14] [|map[v0 := v2]|, v0 % v0, v0, -0x1f2, |v1[fm0(v2, v1, v2, |map[v2 := v6]|, globalState) := 'q']|, v0, v0, if ((set v10 : int | (0xda <= v10) && (v10 < 0x1c3) :: (v10 / -|v8|)) in v9) then v9[set v10 : int | (0xda <= v10) && (v10 < 0x1c3) :: (v10 / -|v8|)] else 157, v0, v0 - v0, v0, v0 / v0, -v0 % v0, -(if (v2) then |v11| else -v0)];
		...
		decreases 100 - i3
	{
		...
		v12[686] := -|fm3(if (false) then if (v2 in v20) then v20[v2] else -524 else v19.f19, v5[514] || v5[514], v3, v20, globalState)|;
		var v21: map<bool, bool> := map[v5[514] := !v15];
		match (DC3(v15, true !in v3, v15, v7[fm0(v15, v17[564], v15, v0, globalState) := v19.f19] <= [|v21|])) {
			case DC3(cf7, cf8, cf9, cf10) =>
				globalState.f5 := v19.f19;
				var v22, v23, v24 := m0(v12[686] / v12[686], v5[514], v5[514], v17[564] + v1, globalState);
				var v25 := new C0(v0, v6);
				var v26: multiset<C0> := multiset{v19};
				var v27: array<int> := new int[27] [v25.f19, |{v23}|, v19.f19, v12[686], v19.f19, v19.f19, v19.f19, v12[686], 0xb3, v0, v0, v19.f19, v19.f19, |v21|, v0, v25.f19, |v17[564]|, v19.f19, v19.f19, v0, -124, v19.f19, v19.f19, v12[686], if (|v26| in v13) then v13[|v26|] else v19.f19, v19.f19, -0x381];
				var v28: map<char, array<int>> := map[v19.f20 := v27];
				var v29, v30, v31 := m0(v0, v28 != DC5(v28).cf12, v15, v17[564], globalState);
			case DC2(cf6) =>
				var v32: seq<seq<int>> := [v7];
				var v33: map<seq<int>, string> := map[v32[v12[686]] := v17[564]];
				...
				v12[686], v34, v36, v12[686] := |v37[v12[686] := v19]| % v0, v38[|v3|], fm4(v15, globalState), v19.f19;
				v0 := v0;
				v8 := set v39 : int | v39 in v7 :: (v39 / -0x22d);
				var v40: array<C0> := new C0[4];
				v40 := v40;
			case DC4(cf11) =>
				globalState.f15 := v12[686];
		...
		var v44, v45, v46 := m0(v19.f19, v2, v15, v17[564] + v1, globalState);
	}
	forall i5 | 0 <= i5 < v12.Length {
		v12[i5] := i5 - (if (v15) then v0 else v0);
	}
	var v47 := DC3(v5[514], v2, v2, v15);
	...
	for i6 := v0 to |{v0, v0}| {
		...
		match (v48) {
			...
			case DC0(cf0) =>
				...
				var v53 := DC0(v1);
				v52[106] := v53;
				cf0, globalState.f13, globalState.f6, globalState.f6, v52[106] := v17[564], v0, v5[514], !false, DC0(cf0 + "fy");
				var v54: map<char, array<int>> := map[v6 := v12];
				var v55 := DC5(v54);
				var v56: map<int, D2> := map[v0 := v55];
				v2 := i6 >= |v56[i6 := v55]|;
				var v57, v58, v59 := m0(0x351, v5[514] <==> v5[514], v5[514], v1, globalState);
		}
		
		var v60: array<seq<int>> := new seq<int>[5](i9 => v7[180 := i6]);
		v60 := v60;
		globalState.f6 := !!!v15;
		var v61: C0 := new C0(204, v6);
		var v62: array<D1> := new D1[29](i10 => DC3(v5[514], v5[514], true, v5[514]));
		var v63: map<C0, array<D1>> := map[v61 := v62];
		v0, v5[514], v0, v17, globalState.f15 := (v0 / |v63|) / i6, v2, v0, v17, 827;
	}
	for i11 := v0 / v0 to v0 {
		if (v2) {
			...
			v67[456] := v68 - multiset{v5[514], v5[514], v15, v2};
			v67[456] := v68;
			v12[807] := v64.f19;
			var v69: map<int, bool> := map[|v68| := v15];
			v12[807], globalState.f6 := |v69| % i11, v2;
			var v70: seq<array<bool>> := [v5];
			v70 := v70[v12[807] := v5];
			globalState.f5 := i11 / i11;
		} else {
			globalState.f6 := v5[514];
			var v71 := DC1(v12, v5, v4, v0, v7[|v1|]);
			var v72: seq<D0> := [v71];
			v17[564], globalState.f6, v72, v6 := ("vw")[i11 := v6] + "pmpe", v15 ==> v15, (v72 + v72) + v72, fm5(globalState);
			globalState.f15 := i11;
			globalState.f6 := v2;
		...
		decreases 100 - i13
	{
		...
		i13 := i13 + 1;
		var v78, v79, v80 := m0(if (|v17[564]| in v11) then v11[|v17[564]|] else v0, !v15, v0 != v0, v1, globalState);
		var v81 := new C0(v0, v6);
		var v82: seq<set<int>> := [v8, fm1(v5[514], |"vityokux"|, |v7|, v0, globalState)];
		var v83: map<bool, bool> := map[[{0x2cf, v81.f19}, v8] <= v82 := !(v0 < v0)];
		v83 := v83[v79 := v5[514]];
		v12[550] := v0;
		v12[550] := v0;
	}
	var v84: set<bool> := {v15, v5[514]};
	for i14 := |(v84 + v84)| to v0 % v0 {
		if (v15) {
			v47 := v47;
		...
		globalState.f15 := (v0 / i14) / |v3|;
		var v90: map<bool, array<bool>> := map[true := DC1(v12, v5, v4, v0, i14).cf2];
		var v91: map<char, seq<char>> := map[v6 := v17[564]];
		var v92: map<int, bool> := map[i14 := v15];
		var v93 := DC1(v12, if (v5[514] in v90) then v90[v5[514]] else v5, multiset{seq(592, i15  => (v6)), if (v6 in v91) then v91[v6] else fm7(v5[514], i14, fm0(if (fm0(v5[514], v1, v5[514], i14, globalState) in v92) then v92[fm0(v5[514], v1, v5[514], i14, globalState)] else !v2, "ytn", v15, v0, globalState), globalState), v17[564], v17[564]}, i14, v0);
		v93 := v93;
		var v94, v95, v96 := m0(-(i14 / v0), v15, 0xe8 !in v8, "ckhhe", globalState);
	}
	var v97: array<C0> := new C0[4];
	var v98: C0 := new C0(v0, v6);
	v97[411] := v98;
	v97[411] := v98;
	var v99: seq<C0> := [v97[411]];
	var i16 := 0;
	while (v99 != v99)
		decreases 100 - i16
	{
		...
		i16 := i16 + 1;
		v17[564] := v17[564] + v17[564];
		var v100, v101, v102 := m0(if (v0 in v13) then v13[v0] else v98.f19, !true <== v15, v2, (v1 + v1[v98.f19 := v6])[v98.f19 := v6], globalState);
		v101 := v2;
		if (v2) {
			...
			v103[196] := v107;
			var v108: map<bool, map<map<D3, int>, bool>> := map[v5[514] := v107];
			v103[196], globalState.f6 := (if (false in v108) then v108[false] else v107) + v107, 0x8a == 0x3e;
			v17 := v17;
			globalState.f5 := (v98.f19 + v98.f19) % v98.f19;
			var v109 := DC2(v98.f20);
			v109 := v109.(cf6 := v6);
			globalState.f15 := --((-v98.f19 + 0x103) / v98.fm2(v0, v98.f19, v98.f19, globalState));
		} else {
			v11 := v11[|v3| := v98.f19];
			v7 := fm8(v5[514], globalState) + v7;
			v1 := v1 + (seq(0x170, i17  => (v98.f20)));
			var v110: array<map<bool, bool>> := new map<bool, bool>[21](i18 => map[v2 := v101]);
			v5[514], v110 := v98.f19 < v0, v110;
			var v111, v112, v113 := m0(v98.f19, v101, !v5[514], "svi", globalState);
		}
