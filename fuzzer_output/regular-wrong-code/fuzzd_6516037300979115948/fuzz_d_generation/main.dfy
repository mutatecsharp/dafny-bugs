...
class C0 extends T0 {
	...
	function fm5(p0: int, p1: int, globalState: GlobalState): int {
		|(multiset{|f9|, 0x9d, |map[f25 := f25]|, 0x1fb, 0xcf} * multiset{|f9|, |f9|, |multiset{f9, seq(abs(339), i0  => ('j'))}|})|
	}
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		var i0 := 0;
		while (f26)
			decreases 100 - i0
		{
			...
			var v3: set<int> := {|v2|};
			var v4: array<bool> := new bool[27] [!!(f25 <==> !f25), f26, f25, fm38(p1, globalState), f25, f26, v0[safeIndex(p1, |v0|)] <==> f26, f26, f25 && f25, fm38(0x2, globalState), f26, !f26, false, f26, f25, fm38(p2, globalState), f25 ==> f25, f25, if (f25) then false else f26, !(p2 <= |v1|), if (!f25) then fm38(p1, globalState) else false, v3 > v3, false <== f26, !f26, f26, f25, f26];
			v4 := v4;
		...
		forall i2 | 0 <= i2 < v8.Length {
			v8[i2] := DC29(f26, if (f25) then p0 else p2, [DC29(f26, p0, seq(abs(0x82), i3  => (p1)), true, -940).cf36, p2, p0, |(seq(abs(266), i4  => ('i')))|, p1], f25, |[0x3af]|);
		}
		var v9: array<seq<char>> := new seq<char>[6];
		v9[safeIndex(487, v9.Length)] := f9;
		v9[safeIndex(487, v9.Length)] := f9;
		var v10: map<bool, string> := map[f26 := f9];
		var i5 := 0;
		while (!(((if (f25 in v10) then v10[f25] else f9) <= v9[safeIndex(487, v9.Length)]) ==> f25))
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
			...
			var v15: array<array<int>> := new array<int>[28] [v11, if (p1 in v12) then v12[p1] else v13.cf17, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v14[safeIndex(p0, |v14|)], v14[safeIndex(p2, |v14|)], v11, v11, v11, v11, v11, v11, v11, v11, v11, v14[safeIndex(p0, |v14|)], v11];
			v15[safeIndex(514, v15.Length)] := v11;
			v15[safeIndex(514, v15.Length)] := if (f25 <== f26) then v11 else v11;
			var v16: array<bool> := new bool[2];
			v16 := v16;
			r1 := f26 ==> f25;
		}
		v9[safeIndex(487, v9.Length)] := v9[safeIndex(487, v9.Length)];
		if (f26) {
			r1 := p1 < p0;
			...
			var v19: map<int, int> := map[safeDivisionInt(|v18|, p0) := 0x3cf];
			globalState.f3 := |v19|;
			var v20 := 'w';
			var v21: seq<int> := [p2];
			var v22: multiset<int> := multiset{p2, v21[safeIndex(p0, |v21|)]};
			var v23 := DC15(v22);
			v20 := fm39(v23, -p0 in fm40(p2, p2, globalState), globalState);
		} else {
			r0 := f25;
			var v24: map<int, string> := map[p0 := v9[safeIndex(487, v9.Length)]];
			var v25: seq<string> := [f9, f9, if (p2 in v24) then v24[p2] else v9[safeIndex(487, v9.Length)]];
			r3 := safeDivisionInt(|v25[safeIndex(p1, |v25|)]|, p0);
			var v26: array<map<int, seq<int>>> := new map<int, seq<int>>[29];
			v26[safeIndex(59, v26.Length)] := map v27 : int | (0x12a <= v27) && (v27 < 0x7c) :: (safeDivisionInt(v27, 0x142)) := ([p0, p1]);
			var v28: seq<int> := [p1, p1];
			var v29: map<int, seq<int>> := map[safeModuloInt(p2, p1) := v28];
			v26[safeIndex(59, v26.Length)] := v29;
			var v30: array<int> := new int[18](i7 => i7 * p0);
			r2 := v30;
			var v31: array<bool> := new bool[5];
			v31[safeIndex(658, v31.Length)] := f26;
			v31[safeIndex(658, v31.Length)] := false;
		}
		
		r0 := false;
		r1 := (p2 >= fm5(p1, p1, globalState)) ==> fm38(|[v9[safeIndex(487, v9.Length)]]|, globalState);
		var v32: array<int> := new int[15](i8 => i8 - p2);
		r2 := v32;
		var v33: seq<bool> := [f26, f26, fm38(909, globalState)];
		var v34: map<int, string> := map[p2 := v9[safeIndex(487, v9.Length)]];
...
class C1 extends T1 {
	...
	function fm5(p0: int, p1: int, globalState: GlobalState): int {
		|("rtoj" + "qunejed")| - -safeDivisionInt(f24, f23)
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
		var v0 := true;
		r2 := v0;
		...
		var v9: array<int> := new int[14] [f24, p0, p0, f23, p0, |((seq(abs(-0x149), i0  => ('i'))) + "dnqrwgvj")|, -f23, if (f24 in v4) then v4[f24] else |fm35(|v5|, f23, globalState)|, p0, p0, f24, f24, |(map[v6 := true] + v7)|, safeModuloInt(f11, v8[safeIndex(f23, |v8|)])];
		v9[safeIndex(518, v9.Length)] := f11;
		v9[safeIndex(518, v9.Length)] := f24;
		var v10: array<set<int>> := new set<int>[11];
		var v12: set<int> := {p0};
		v10[safeIndex(167, v10.Length)] := if (v0) then set v11 : int | v11 in DC28((seq(abs(0x27c), i1  => (f23)))[safeIndex(v9[safeIndex(518, v9.Length)], |(seq(abs(0x27c), i1  => (f23)))|) := p0]).cf31 :: (v11 * |map[!true := |{true, !true}|]|) else v12;
		v10[safeIndex(167, v10.Length)] := {v9[safeIndex(518, v9.Length)], -p0} * (v12 + {fm0(0x3ce, |v3|, globalState)});
		v9[safeIndex(518, v9.Length)] := safeDivisionInt(|"httgemkqe"|, 0x64 + f24);
		r2 := v0;
		...
		match (v14.(cf16 := v13)) {
			case DC14(cf17) =>
				...
				var v16: map<int, map<int, char>> := map[v9[safeIndex(518, v9.Length)] := v15[f23 := 't']];
				v16 := v16[f23 := v15];
				r2 := (-0x139 + f23) > v9[safeIndex(518, v9.Length)];
				v9[safeIndex(518, v9.Length)] := safeModuloInt(-fm0(v9[safeIndex(518, v9.Length)], v9[safeIndex(518, v9.Length)], globalState) + f24, -f24);
				v0, cf17, r0, globalState.f3 := v5[safeIndex(f24 + f11, |v5|)], if (v0) then cf17 else cf17, -(if (false) then |v8| else f24) * p0, f11;
			case DC13(cf16) =>
				v0 := !(if (f24 in v1) then v1[f24] else v0 || !v0);
				if (v0) {
					v9[safeIndex(518, v9.Length)] := 0x38d;
					var v17: set<bool> := {!v0};
					v17 := v17;
					v9[safeIndex(518, v9.Length)], globalState.f3, r0 := f23 * p0, f11, v9[safeIndex(518, v9.Length)];
					globalState.f3 := f11;
					var v18 := DC16();
					var v19: seq<D7> := [v18];
					var v20: seq<seq<D7>> := [v19, v19];
					var v21: set<seq<D7>> := {(v20[safeIndex(f23, |v20|)])[safeIndex(p0, |v20[safeIndex(f23, |v20|)]|) := v18], seq(abs(0x1ae), i2  => (v18))};
					v21 := v21;
				} else {
					...
					v24[safeIndex(528, v24.Length)] := v0;
					v24[safeIndex(528, v24.Length)] := v0;
					v0 := (v9[safeIndex(518, v9.Length)] <= f23) <== v0;
					var v25 := "oyenj";
					v25 := f9;
					var v26: map<string, string> := map[v25 := v25];
					var v27: multiset<bool> := multiset{v0};
					v26 := v26[fm37(fm5(p0, |map[v6 := v9[safeIndex(518, v9.Length)]]|, globalState), |v27|, v0, v9[safeIndex(518, v9.Length)], globalState) := (seq(abs(-0x149), i3  => ('x'))) + f9];
					v24[safeIndex(528, v24.Length)] := v0;
				}
				
				v0 := if (v0) then !((seq(abs(-0x19d), i4  => (|v4|))) != v8) else v0;
				if (v0 <==> !v0) {
					r3 := v9[safeIndex(518, v9.Length)];
					var v28: set<string> := {f9, seq(abs(0xf), i5  => ('w')), f9 + "gps"};
					var v29: seq<string> := [f9, f9];
					v28 := {v29[safeIndex(f11, |v29|)]};
					v9[safeIndex(518, v9.Length)] := -((if (false) then p0 else p0) * (if (v0) then p0 else f11));
					v0 := !v0;
					var v30 := DC0(f9 + f9);
					v30 := v30.(cf0 := f9);
				} else {
					v12 := (v10[safeIndex(167, v10.Length)] * (set v31 : int | (0xa2 <= v31) && (v31 < 296) :: (v31 - v9[safeIndex(518, v9.Length)]))) - (v12 * v12);
					var v32: array<D10> := new D10[24](i6 => DC23('g', {multiset{v9[safeIndex(518, v9.Length)]}}));
					var v33: map<bool, array<D10>> := map[if (v0) then v0 else !v0 := v32];
					v33 := if (v9[safeIndex(518, v9.Length)] >= |v5|) then v33[v0 := v32] else v33;
					r2 := false;
					r2 := true;
					var v34 := DC29(v0, fm5(p0, f23, globalState), v8, v0, |f9|);
					var v35: seq<seq<seq<int>>> := [f10, f10, seq(abs(-0x3c9), i7  => (v8)), [v8, v8]];
					var v36: map<bool, bool> := map[v0 := v0];
					var v37 := new C0(v5[safeIndex(f24, |v5|)], if (!v0) then v34.cf35 else false, f9, v35[safeIndex(|v36|, |v35|)]);
				}
				
		}
		
		r0 := fm0(-|v8|, safeModuloInt(p0, |fm37(f11, |f9|, false, v9[safeIndex(518, v9.Length)], globalState)|), globalState);
		var v38: map<bool, string> := map[v0 := f9];
		r1 := (v38 + v38) + v38;
		r2 := v0;
		var v39 := DC11(!v0, f11);
		r3 := fm0(f24, safeModuloInt(p0, v39.cf14), globalState);
	}
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := safeModuloInt(i0, DC29(v1, p2, [f23, p0], v1, f23).cf33);
		}
		if (v1) {
			if (fm38(p2, globalState)) {
				var v4: array<string> := new string[5](i1 => f9 + "hrhjt");
				v4[safeIndex(321, v4.Length)] := (seq(abs(0x2df), i2  => ('o'))) + "bmpip";
				v4[safeIndex(321, v4.Length)] := p1 + f9;
				v0[safeIndex(633, v0.Length)] := f23;
				var v5: map<bool, int> := map[v1 := -f23];
				v0[safeIndex(633, v0.Length)] := |p1| + |v5|;
				var v7 := 'p';
				var v8: multiset<int> := multiset{v0[safeIndex(633, v0.Length)]};
				var v9: seq<multiset<int>> := [multiset{p0, v0[safeIndex(633, v0.Length)]}, v8];
				...
				var v15 := DC31(v14);
				var v16: array<bool> := new bool[20] [p0 > |(set v6 : int | v6 in map[p2 := v1] :: (v6 + |{true}|))|, v1, v1, v7 !in "ldwpvxod", v2.cf1, !(v1 && v1), if (v1) then v1 else !v1, v8 > v9[safeIndex(0x30, |v9|)], fm38(f23, globalState), !v1, v1, v1, v1, v1 || v1, v1, v1, v11 <= v11, multiset{v12, (map v13 : int | (0x3ce <= v13) && (v13 < -0xc6) :: (safeModuloInt(v13, f23)) := (f11))[p0 := f24]} != v15.cf38, fm38(p0, globalState), v1];
				var v17: set<array<bool>> := {v16, v16};
				var v18: set<bool> := {true};
				var v19: map<bool, bool> := map[v17 !! v17 := v18 == v18];
				v16, globalState.f3, v19, v1, v4[safeIndex(321, v4.Length)] := v16, -(v0[safeIndex(633, v0.Length)] * f11), v19, v1, (seq(abs(207), i3  => (p1[safeIndex(592, |p1|)])))[safeIndex(f11, |(seq(abs(207), i3  => (p1[safeIndex(592, |p1|)])))|) := v7];
				var v20: array<int> := new int[25];
				r1 := v20;
				v1 := v1;
			} else {
				var v21: C0 := new C0(false, false, seq(abs(0x1df), i4  => ('r')), f10);
				var v22: map<C0, int> := map[v21 := safeDivisionInt(0x38e, p2)];
				var v23 := DC32(v21);
				...
				v29[safeIndex(171, v29.Length)] := multiset(v30) !! v31;
				v29[safeIndex(171, v29.Length)] := v1;
			}
			...
			v34[safeIndex(928, v34.Length)] := v33;
			var v35 := 'i';
			...
			v40[safeIndex(614, v40.Length)] := v1;
			var v41: seq<int> := [p0, f24, f24];
			v34[safeIndex(928, v34.Length)], v1, f23, v40[safeIndex(614, v40.Length)] := v33, v1, p0, fm38(-|(v41 + (seq(abs(0x1d1), i5  => (f24))))|, globalState);
			var v42 := new C0(if (v1) then v40[safeIndex(614, v40.Length)] else v1, v1, "vqwrup" + p1, fm41(v1, v40[safeIndex(614, v40.Length)], v40[safeIndex(614, v40.Length)], globalState));
			var v43 := DC11(v42.f25, p2);
			globalState.f3 := -v43.cf14;
		} else {
			if (v1) {
				v0[safeIndex(194, v0.Length)] := f24;
				v0[safeIndex(194, v0.Length)] := f24;
				var v44: map<int, int> := map[f11 := |(seq(abs(0x369), i6  => ('p')))|];
				var v45: multiset<map<int, int>> := multiset{v44, v44, map[|{v1}| := |f9|]};
				var v46: map<D13, int> := map[DC31(v45) := v0[safeIndex(194, v0.Length)]];
				var v47 := DC31(multiset{v44});
				v0[safeIndex(194, v0.Length)] := if (v47 in v46) then v46[v47] else p2;
				var v48: multiset<int> := multiset{f23, p0, f23};
				var v49: multiset<int> := multiset{|v48|, f24, f11, f11, f24};
				var v50: set<bool> := {v1};
				var v51: map<bool, int> := map[true := v0[safeIndex(194, v0.Length)]];
				var v52: multiset<map<bool, int>> := multiset{fm42(v51, false, p0, false, globalState)};
				var v53: seq<map<bool, int>> := [map[v1 := f24], v51];
				var v54 := 'q';
				var v55: array<int> := new int[21] [0x22f, |v48|, p2, f24, fm5(|v50|, p0, globalState), p2, p0 * p0, safeDivisionInt(if (v53[safeIndex(|map[f24 := p0]|, |v53|)] in v52) then v52[v53[safeIndex(|map[f24 := p0]|, |v53|)]] else v0[safeIndex(194, v0.Length)], -p2), f23, p2, f24, f23, f23, f24, p2, if (v1) then v0[safeIndex(194, v0.Length)] else |p1[safeIndex(f23, |p1|) := v54]|, -f11, safeDivisionInt(-p0, v0[safeIndex(194, v0.Length)]), f11, f24, v0[safeIndex(194, v0.Length)]];
				r1 := v55;
				...
				var v59: map<int, map<bool, bool>> := map[|v57| := v58[safeIndex(-386, |v58|)]];
				f23 := |((map[324 := v56])[0x1f5 := v56] + ((fm43(globalState))[-|v50| := v56] + v59))|;
				var v60: seq<int> := [p0];
				v0[safeIndex(194, v0.Length)] := if (fm38(f11, globalState)) then p2 else v60[safeIndex(fm0(v0[safeIndex(194, v0.Length)], v0[safeIndex(194, v0.Length)], globalState), |v60|)] - f24;
			} else {
				var v61: array<bool> := new bool[4];
				v61[safeIndex(898, v61.Length)] := !v1;
				globalState.f3, v61[safeIndex(898, v61.Length)], v61, globalState.f3 := p2, v1, if (if (!v1) then v1 else v1) then v61 else v61, f23;
				v61[safeIndex(898, v61.Length)] := v61[safeIndex(898, v61.Length)];
				var v62: seq<int> := [p2];
				var v63 := DC29(v1, fm0(p2, f24, globalState), v62, v61[safeIndex(898, v61.Length)], f11);
				var v64: seq<bool> := [!v63.cf35];
				v1, globalState.f3, v64 := v61[safeIndex(898, v61.Length)], -0x4d + f23, v64 + (if (true) then v64 else v64);
				var v65: set<bool> := {true, v1, v61[safeIndex(898, v61.Length)]};
				var v66: array<map<array<int>, string>> := new map<array<int>, string>[7];
				var v67: map<array<int>, string> := map[v0 := p1];
				v66[safeIndex(237, v66.Length)] := v67;
				var v68: seq<map<array<int>, string>> := [v67, v67 + v67];
				v65, v66[safeIndex(237, v66.Length)] := v65, v68[safeIndex(p0, |v68|)];
				var v69: map<bool, int> := map[!!v61[safeIndex(898, v61.Length)] := f24];
				f23 := safeModuloInt(if (v1 in v69) then v69[v1] else f23, f11);
			}
		...
		var v83: T0 := new C0(v1, v1, p1, seq(abs(712), i7  => (v81)));
		var v84: map<bool, bool> := map[!v1 := false];
		var v85: set<map<bool, bool>> := {v84, v84, fm45(0x291, map[p1 := v1], f24, v1, globalState), v84};
		r1 := new int[22] [if (v0 in v77) then v77[v0] else f11, |v78| - f24, f23, |v79|, f11, f24, f23, p2, f11, 689, safeDivisionInt(f24, f24), |(fm44(v1, |v81|, v1, globalState) + v81)|, f23, |v82|, f11, |map[|p1| := v83]|, -0x49, safeModuloInt(f11, p2), safeDivisionInt(492, |v85|), 0xa2, safeModuloInt(784, -985), v83.fm5(0x38, -p2, globalState)];
	}
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		var v0: array<bool> := new bool[16](i0 => !('k' in f9));
		var v1 := false;
		v0[safeIndex(138, v0.Length)] := v1;
		v0[safeIndex(138, v0.Length)] := v1;
		var v2: map<int, int> := map[p2 := f11];
		var v3: seq<bool> := [v0[safeIndex(138, v0.Length)], v1, v0[safeIndex(138, v0.Length)], !v0[safeIndex(138, v0.Length)], v1];
		var v4: multiset<int> := multiset{p2, f24, f24, if (|v3| in v2) then v2[|v3|] else |(seq(abs(0x214), i2  => (p0)))|, p0};
		var v5: set<map<int, int>> := {v2};
		var v6: array<int> := new int[14] [p1, |v4|, f23, |v4|, f24, |v5|, if (fm0(0x30f, f24, globalState) in v2) then v2[fm0(0x30f, f24, globalState)] else p2, p0, f11, 27, safeDivisionInt(f11, f11), f24, |f9|, p1 + p0];
		forall i1 | 0 <= i1 < v6.Length {
			v6[i1] := safeModuloInt(i1, |(map[true := f24] + map[v3[safeIndex(p0, |v3|)] := -f24])|);
		}
		var v7 := DC14(v6);
		var v8: multiset<array<int>> := multiset{v7.cf17, v6};
		var v9 := DC35(v8);
		if ((v8 + v8[v6 := abs(p2)]) > (v8 * v9.cf47)) {
			var v10 := new C0(!v0[safeIndex(138, v0.Length)], v1, f9, f10 + f10);
			v7 := v7;
			var v11: map<bool, int> := map[v0[safeIndex(138, v0.Length)] := f24];
			v11 := fm42(v11, v0[safeIndex(138, v0.Length)], p1, v10.f26, globalState);
			if (!v1) {
				r3 := f23;
				globalState.f3 := |f9|;
				...
				var v16 := DC15(v4);
				v15[safeIndex(90, v15.Length)] := fm39(v16, v0[safeIndex(138, v0.Length)], globalState);
				v15[safeIndex(90, v15.Length)] := if (v10.f25) then v14 else v14;
			} else {
				var v17: map<array<int>, int> := map[v6 := fm5(f24, p2, globalState)];
				var v18: map<bool, bool> := map[v0[safeIndex(138, v0.Length)] := v0[safeIndex(138, v0.Length)]];
				globalState.f3 := (f11 + |(v17[v6 := |map[v10.f25 := |v18|]|])[v6 := 0x88]|) + 431;
				v1 := v10.f26;
				globalState.f3 := f24 + p1;
				globalState.f3 := safeDivisionInt(p0, safeDivisionInt(f23, |v3|));
				f23 := f23;
			}
			
			var v19: array<array<int>> := new array<int>[10];
			var v20: seq<array<array<int>>> := [v19, v19, v19, v19];
			v19 := v20[safeIndex(f11, |v20|)];
		} else {
			r3 := f24;
			v6[safeIndex(109, v6.Length)] := f24;
			v6[safeIndex(109, v6.Length)] := f23;
			var v21: map<int, string> := map[p1 := f9];
			var v22: map<bool, map<int, string>> := map[v3 == v3 := v21[f11 := f9]];
			var v23: map<bool, int> := map[v1 := f23];
			v22 := v22[v0[safeIndex(138, v0.Length)] || v0[safeIndex(138, v0.Length)] := map[|v23| := f9]];
			var v24: array<char> := new char[7](i3 => 'c');
			var v25 := 'i';
			v24[safeIndex(978, v24.Length)] := v25;
			v24[safeIndex(978, v24.Length)] := v25;
			var v26: seq<seq<bool>> := [[!v1]];
			v6[safeIndex(109, v6.Length)] := -|(([v3, v3, v3, fm2(fm37(p0, v6[safeIndex(109, v6.Length)], v1, p1, globalState), f24, globalState), v3])[safeIndex(0x242, |[v3, v3, v3, fm2(fm37(p0, v6[safeIndex(109, v6.Length)], v1, p1, globalState), f24, globalState), v3]|) := v3] + (v26 + v26))|;
		}
		
		var i4 := 0;
		while (v1 <== v0[safeIndex(138, v0.Length)])
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			i4 := i4 + 1;
			r1 := v1 <== v0[safeIndex(138, v0.Length)];
			var v27 := "jqd";
			var v28: array<map<int, seq<int>>> := new map<int, seq<int>>[14];
			var v29: seq<int> := [-f11];
			var v30: map<int, seq<int>> := map[|map[p1 := v1]| := v29];
			v28[safeIndex(495, v28.Length)] := v30;
			v27, r3, v28[safeIndex(495, v28.Length)], v29 := v27 + "cxbbyr", f23, v30, v29;
			r3 := |v3| + safeModuloInt(p1, f11);
			var v31: map<int, bool> := map[0xbd := v0[safeIndex(138, v0.Length)]];
		...
		r1 := v1;
		r2 := v6;
		r3 := safeModuloInt(safeModuloInt(-0x3b7, f23), p2);
	}
	method m17(p0: int, p1: int, globalState: GlobalState) {
		...
		var v12: map<bool, map<bool, bool>> := map[v8[safeIndex(f11, |v8|)] := fm45(p1, map v9 : string | v9 in v11 :: (v9) := (true), 0x34, v5.f25, globalState)];
		v12 := v12[v5.f25 := v4];
		var v13: seq<int> := [f24];
		...
		v16 := v17[safeIndex(safeDivisionInt(|(set v18 : int | (0x191 <= v18) && (v18 < 0x162) :: (v18 + f23))|, f24), |v17|)];
		globalState.f3 := f23 + safeModuloInt(|map[false := seq(abs(0x204), i0  => (|v2|))]|, f24);
	}
	method m18(p0: seq<string>, p1: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		var v1: seq<int> := [f23];
		var v2 := new C0(v0 > v0, p1, f9, f10[safeIndex(f11, |f10|) := v1]);
		r2 := p1;
		for i0 := f24 to f11 - f23 {
			...
			var v9: array<bool> := new bool[26] [v2.f25, fm38(f24, globalState), v2.f25, v2.f26, !v4[safeIndex(-f24, |v4|)], v2.f25, v2.f25, v2.f25, v2.f26, false, v4[safeIndex(f23, |v4|)], p1, v2.f25, v2.f25, v8.cf24, v2.f26, v2.f25, v2.f25, v2.f25, v2.f25, false, p1, v2.f26, !v2.f26, v2.f26, v2.f25];
			var v10: map<array<bool>, int> := map[v9 := i0];
			r1 := |v10|;
			v9[safeIndex(345, v9.Length)] := v2.f26;
			var v11: multiset<bool> := multiset{v2.f25};
			var v12: seq<multiset<bool>> := [v11, multiset{v2.f26}, v11];
			var v13: map<int, bool> := map[|v12| := p1];
			r0, v9[safeIndex(345, v9.Length)], r0, globalState.f3 := v2.f25, v2.f26, if (safeDivisionInt(f24, f23) in v13) then v13[safeDivisionInt(f24, f23)] else v2.f25, if (v2.f25) then fm0(f23, -i0, globalState) else f23 * -f23;
		...
		match (v16.(cf16 := v15)) {
			case DC14(cf17) =>
				...
				r2 := f24 > |v19|;
				cf17[safeIndex(867, cf17.Length)] := f11 * (if (|f9| in v19) then v19[|f9|] else f24);
				var v20: array<bool> := new bool[1] [v2.f26];
				v20[safeIndex(396, v20.Length)] := v18.f26;
				var v21: map<multiset<string>, int> := map[multiset([f9]) := |v1|];
				r1, cf17[safeIndex(867, cf17.Length)], r0, r2, v20[safeIndex(396, v20.Length)] := if (v0 in v21) then v21[v0] else f11, f11, v2.f26, if (v18.f26) then v18.f25 else fm38(f24, globalState), -0x10 == f23;
				var v22 := 's';
				var v23: map<bool, bool> := map[!v18.f25 := p1];
				var v24: map<string, map<bool, bool>> := map[f9 := v23];
				v22, globalState.f3 := 'l', |((if ((seq(abs(0x165), i1  => (v22))) in v24) then v24[seq(abs(0x165), i1  => (v22))] else v23) + (v23 + map[v2.f26 := v18.f25]))|;
			case DC13(cf16) =>
				var v25: array<string> := new string[23];
				v25[safeIndex(166, v25.Length)] := f9;
				v25[safeIndex(166, v25.Length)] := f9;
				var v26 := new C0(p1, v2.f26, v25[safeIndex(166, v25.Length)], f10 + f10);
				var v27: array<bool> := new bool[26];
				v27 := v27;
				var v28: map<bool, array<bool>> := map[v2.f26 := v27];
				var v29: set<int> := {625};
				var v30: multiset<int> := multiset{|fm2(v25[safeIndex(166, v25.Length)], |v29|, globalState)|, f24, f23, f24, |f9|};
				v28 := v28[fm38(|v30|, globalState) <==> v2.f25 := v27];
		}
		
		f23 := f24 - f24;
		f23 := v1[safeIndex(f23, |v1|)] - |(seq(abs(862), i2  => ('c')))|;
		r0 := v2.f25 ==> p1;
		r1 := f11;
...
class C2 extends T1 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
			...
			decreases 100 - i0
		{
			...
			v7[safeIndex(492, v7.Length)] := v4;
			var v8: set<string> := {f9};
			globalState.f3, v7[safeIndex(492, v7.Length)], r2, r2 := safeModuloInt(p0, p0), v4, v8 !! v8, v4;
			globalState.f3 := f11;
			var v9: array<D1> := new D1[8];
			var v10: set<bool> := {v7[safeIndex(492, v7.Length)]};
			...
			var v17: map<bool, bool> := map[v7[safeIndex(492, v7.Length)] := false];
			var v18: array<int> := new int[7] [f11, |v11[safeIndex(|v12|, |v11|)]|, f11, f11, |v16|, f11, |v17|];
		...
		match (DC15(v21)) {
			case DC16() =>
				...
				var v27: array<map<int, array<int>>> := new map<int, array<int>>[25] [map[p0 := v23], v24[p0 := v23] + v24, v25.cf29, v24, v24, map[p0 := v23], v24, map[f11 := v23], v24[p0 := v23], v24 + v24, v24 + v24, v24 + v24, map[f11 := v23], v24, if (v4) then v24 else v24, v24, v24, v24, v26[safeIndex(|multiset{v4, v4}|, |v26|)], v24, v24 + v24, if (v4) then v24 else v24, v24, (v24[p0 := v23])[|v22| := v23], v24];
				v27[safeIndex(142, v27.Length)] := v24;
				var v28: map<array<int>, map<int, array<int>>> := map[v23 := v24];
				v27[safeIndex(142, v27.Length)] := (if (v23 in v28) then v28[v23] else v24) + v24;
			case DC15(cf18) =>
				...
				match (v33) {
					...
					case DC15(cf18) =>
						...
						var v37: seq<bool> := [v36[safeIndex(-188, |v36|)], v4, v4, !v4, v4];
						var v38 := DC11(v4, |multiset(v37)|);
						v35[safeIndex(194, v35.Length)] := v38;
						v35[safeIndex(194, v35.Length)] := v38;
						...
						v42[safeIndex(731, v42.Length)] := 0x370 - f11;
						v39, r3, v40, v42[safeIndex(731, v42.Length)] := v39, fm0(f11, f11, globalState), v40, p0 - f11;
						var v43 := new C0(v4, v4, if (v4) then f9 else seq(abs(146), i2  => (v0)), f10 + f10);
						var v44: map<map<int, int>, char> := map[map[p0 := p0] := v0];
						v0, v42[safeIndex(731, v42.Length)], v37 := if (v29 in v44) then v44[v29] else v0, if (v4) then p0 else p0, (v37 + v37) + [v43.f25, v43.f25];
				}
		...
		var v48 := new C1(|(v47 + v47)|, p0, f11, f12, f9, seq(abs(-0x2db), i4  => ([f11])));
		var v49 := DC16();
		match (v49) {
			case DC16() =>
				...
				var v56: map<string, int> := map["d" := |v55[safeIndex(v48.f23, |v55|)]|];
				var v57 := new C1(|v54[safeIndex(v48.f23, |v54|)]|, if (v4) then |v56| else v48.f24, |v55|, fm47(v4, v4, v4, v4, globalState), f9 + f9, fm41(!v4, v4, v4, globalState));
				v46[safeIndex(298, v46.Length)] := v4;
				var v58: array<int> := new int[5];
				var v59: seq<array<int>> := [v58];
				v46[safeIndex(298, v46.Length)] := !!!!(if (v4) then if (v4) then v4 else v4 else fm38(|v59|, globalState));
				globalState.f3 := -(if (v46[safeIndex(298, v46.Length)] in v6) then v6[v46[safeIndex(298, v46.Length)]] else v57.f23 - v48.f23);
			case DC15(cf18) =>
				var v60: array<int> := new int[24];
				v60[safeIndex(817, v60.Length)] := v48.f23;
				r2, v48.f23, v60[safeIndex(817, v60.Length)], r2 := v4, safeDivisionInt(p0, |v6|), v48.f23, v4;
				v4 := fm38(f11, globalState);
				v46[safeIndex(257, v46.Length)] := !v4;
				var v61: set<bool> := {true};
				var v62: seq<set<bool>> := [v61];
				var v63: map<bool, int> := map[true := v48.f24];
				r2, v48.f23, v46[safeIndex(257, v46.Length)], globalState.f3 := v4, safeModuloInt(---v48.f24, v48.f24 * |v62[safeIndex(v60[safeIndex(817, v60.Length)], |v62|)]|), v4, |[multiset([|v63|])]|;
				r2 := v48.f24 >= v48.f24;
		}
	...
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		var v0 := true;
		v0 := !(p1 <= ((seq(abs(-0x35e), i0  => ('e'))) + (seq(abs(-667), i1  => ('n')))));
		var i2 := 0;
		while (v0)
			decreases 100 - i2
		{
			...
			match (v2) {
				case DC2() =>
					...
					globalState.f3 := -p2 * safeModuloInt(|v4|, p0);
					var v5 := 'k';
					var v6: map<set<int>, set<bool>> := map[{|{v5, v5, p1[safeIndex(|f9|, |p1|)]}|} := {!!v0}];
					v6 := (v6 + v6) + v6;
				case DC1(cf1) =>
					v0 := cf1;
				...
				case DC3(cf2) =>
					v0 := v0;
					var v8: array<int> := new int[15] [p0, |"b"|, p2, p0, p0, -0x302, p0, p2, f11, p2, p0, fm0(f11, p2, globalState), -|(seq(abs(-0x23c), i3  => ('g')))|, f11, f11];
					var v9: set<int> := {225, 0x293};
					var v10: map<set<int>, array<int>> := map[v9 := v8];
					var v11: seq<array<int>> := [v8, v8];
					var v12: array<array<int>> := new array<int>[25] [v8, v8, if (fm48(v0, p0, 0x18, v0, globalState) in v10) then v10[fm48(v0, p0, 0x18, v0, globalState)] else v8, v8, v8, v8, v8, v8, v8, v8, v8, v11[safeIndex(p0, |v11|)], v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8];
					v12 := v12;
		...
		v16, v18, v20, globalState.f3 := v16, [p2, f11, |(if (f11 in v22) then v22[f11] else v21)|], v20[p2 := f11], |(seq(abs(523), i5  => ('j')))| - p2;
		var v23: array<bool> := new bool[27](i6 => v0);
		var v24: map<array<bool>, int> := map[v23 := safeDivisionInt(0x2c5, f11)];
		v24 := v24[v23 := f11];
		var v26: seq<map<int, int>> := [map v25 : int | (678 <= v25) && (v25 < 0x3dd) :: (v25 + -p2) := (p2), v20];
		var v27: seq<map<int, int>> := [v20 + v20, v26[safeIndex(-f11, |v26|)]];
		v26 := v26;
		var i7 := 0;
			...
			decreases 100 - i7
		{
			...
			v29[safeIndex(85, v29.Length)] := v28;
			v29[safeIndex(85, v29.Length)], v0, v0 := v28, v0, fm39(DC15(v17), v0, globalState) in f9;
			...
			v31, v0, globalState.f3 := (v31 * v31) - ((set v32 : string | v32 in fm49(v0, v0, v0, globalState) :: (v32)) - v31), true, safeDivisionInt(f11, |v33|);
	...
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		var v0 := false;
		var v1 := 'r';
		var v2 := new C1(if (v0) then p2 else p2, f11 * |"ofpnkf"|, f11, f12, f9[safeIndex(p0, |f9|) := v1], seq(abs(98), i0  => (seq(abs(0xdb), i1  => (p2)))));
		...
		match (v6) {
			case DC36(cf48) =>
				var v7 := new C1(-v2.f24 + -v2.f24, -safeModuloInt(v2.f23, |f9|), 907, f12, f9, f10);
				r0 := true;
				var v8 := "pruulrdgp";
				v8 := f9;
				var v9: map<bool, string> := map[!!true ==> false := v8 + v8];
				var v10: multiset<int> := multiset{v7.f24};
				var v11 := DC15(v10[f11 := abs(p2)]);
			...
			case DC37(cf49, cf50, cf51) =>
				...
				v13[safeIndex(446, v13.Length)] := cf51;
				var v14: seq<bool> := [v0];
				var v15: seq<bool> := [cf51, v14[safeIndex(0x1e7, |v14|)]];
				var v16: map<int, int> := map[-v2.f23 := 998];
				var v17: set<int> := {|map[cf51 := 'r']|, v2.f23};
				var v18 := DC6(v17);
				var v19 := DC21(v18, v1, cf51);
				v13[safeIndex(446, v13.Length)] := if (true) then v14[safeIndex(if (v2.f24 in v16) then v16[v2.f24] else f11, |v14|)] && v0 else v19.cf24;
				var v20 := "adaxfjygr";
				v20 := v20 + f9;
				globalState.f3 := --154;
				r1 := !(v2.f24 > (p1 * p2));
			case DC35(cf47) =>
				v3[safeIndex(326, v3.Length)] := safeModuloInt(592, v2.fm5(p0, p0, globalState));
				v3[safeIndex(326, v3.Length)] := p0;
				...
				v23 := v23[v0 := multiset((seq(abs(0xf0), i3  => (multiset{v0}))) + v24)];
				globalState.f3 := v2.f24;
				v3[safeIndex(326, v3.Length)] := safeDivisionInt(v2.f23, f11);
		}
		
		var v25: array<bool> := new bool[9];
		v25[safeIndex(511, v25.Length)] := v0 && v0;
		v25[safeIndex(511, v25.Length)] := false;
		r3 := -f11 + -872;
		var v26: multiset<bool> := multiset{v0, v0, v25[safeIndex(511, v25.Length)], true};
		var v27: map<bool, bool> := map[v26[v0 := abs(p2)] > v26 := v25[safeIndex(511, v25.Length)]];
		if (if (v25[safeIndex(511, v25.Length)] in v27) then v27[v25[safeIndex(511, v25.Length)]] else v0) {
			var v28: seq<int> := [p0, p2];
			v2.f23 := |f9[safeIndex(p0 - |v28[safeIndex(v2.f24, |v28|) := p1]|, |f9|) := v1]|;
			var v29 := DC14(v3);
			v29 := v29;
			var v30: map<char, int> := map[v1 := p2];
			var v31: set<int> := {|f9|, v2.f23};
			var v32: map<int, bool> := map[-fm5(|v31|, p0, globalState) := !v0];
			v0, v25[safeIndex(511, v25.Length)], v28, r2, v30 := true, if (v2.f24 in v32) then v32[v2.f24] else v25[safeIndex(511, v25.Length)], v28, v3, v30;
			var v33 := new C0(v25[safeIndex(511, v25.Length)], v0, f9 + f9, f10);
			r3 := v2.fm5(0x14, p2, globalState);
		} else {
			v3[safeIndex(302, v3.Length)] := p0 + f11;
			var v34: set<string> := {f9, "hubpie"};
			var v35: set<int> := {p2};
			var v36: map<set<string>, int> := map[v34 * {f9, f9, f9} := -|v35| * v2.f23];
			v3[safeIndex(302, v3.Length)], v0 := if ((v34 - v34) in v36) then v36[v34 - v34] else 0x95, v25[safeIndex(511, v25.Length)];
			v25[safeIndex(511, v25.Length)] := v25[safeIndex(511, v25.Length)] ==> v25[safeIndex(511, v25.Length)];
			...
			var v41: array<int> := new int[21] [v2.f23, p2, if (v38[safeIndex(v2.f23, |v38|)] in v37) then v37[v38[safeIndex(v2.f23, |v38|)]] else v3[safeIndex(302, v3.Length)], v2.f23, -0x56 + 232, p0, -0x7, f11, p1, v2.f23, -488, v3[safeIndex(302, v3.Length)], f11, f11 - 874, safeDivisionInt(p0, |(if (v39 in v40) then v40[v39] else v26)|), p1, v2.f24 - f11, -v2.f24, p1, f11, -|[v1, v1]|];
			r2 := v41;
			r3 := v2.f23;
			if (v25[safeIndex(511, v25.Length)]) {
				v3[safeIndex(302, v3.Length)] := f11;
				v3[safeIndex(302, v3.Length)] := if (v25[safeIndex(511, v25.Length)]) then |f9| else v2.f23;
				v25[safeIndex(511, v25.Length)] := fm38(v3[safeIndex(302, v3.Length)], globalState);
				v25[safeIndex(511, v25.Length)] := v0;
				r1 := fm38(-safeDivisionInt(v2.f24, -0x37a), globalState);
			} else {
				var v42: seq<bool> := [v0, v25[safeIndex(511, v25.Length)]];
				var v43 := new C0(v0, p2 != |v42|, f9, f10);
				v25[safeIndex(511, v25.Length)] := (multiset{v25[safeIndex(511, v25.Length)]} * v26) !! (multiset{v0, v0, v43.f25} - v26);
				globalState.f3 := v38[safeIndex(v38[safeIndex(v2.f23, |v38|)], |v38|)];
				v25 := v25;
				var v44: map<bool, char> := map[v25[safeIndex(511, v25.Length)] := v1];
				var v45: map<bool, char> := map[v2.f23 <= v2.f23 := if (v25[safeIndex(511, v25.Length)] in v44) then v44[v25[safeIndex(511, v25.Length)]] else v1];
				v44 := v44 + v44;
			}
			
		}
		
		var v46: seq<bool> := [v0, v25[safeIndex(511, v25.Length)]];
		v46, r3, r1, r2, r0 := if (v25[safeIndex(511, v25.Length)]) then [v0, v0, !v0, v25[safeIndex(511, v25.Length)]] + v46 else v46 + v46, 0x1ff, v25[safeIndex(511, v25.Length)], v3, false;
		r0 := v25[safeIndex(511, v25.Length)];
		r1 := !(safeDivisionInt(p1, -0x2df) >= v2.f23);
		r2 := v3;
		r3 := safeDivisionInt(0xdf, f11);
	}
	method m15(p0: array<D1>, p1: int, p2: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<bool>) {
		...
		var v10: array<seq<bool>> := new seq<bool>[21] [v7 + v7, fm2(f9, |v3|, globalState), v7, v7, v7, if (v8 in v9) then v9[v8] else [v0], v7, v7, v7, [v0], v7, v7, v7, v7, v7, v7, v7, (v7 + v7)[safeIndex(p1, |(v7 + v7)|) := v0], [v0, v0, v0, v0, v0], v7, v7];
		...
		var v22 := DC14(p2);
		v21[safeIndex(970, v21.Length)] := v22;
		v21[safeIndex(970, v21.Length)] := DC14(p2);
		r0 := f11;
	...
	method m16(p0: bool, globalState: GlobalState) returns (r0: array<int>, r1: seq<int>, r2: bool) {
		var v0: seq<bool> := [p0];
		r2 := if (f11 == f11) then p0 || v0[safeIndex(-0x298, |v0|)] else p0;
		var v1: map<int, int> := map[f11 := 0x8e];
		var v2 := 'c';
		var v3: map<seq<int>, char> := map[[f11] := v2];
		var v4 := DC34(|v3|, f11, f11, p0);
		var v5: array<int> := new int[22] [f11, 270, f11, if (p0) then -f11 else f11, f11, f11 + f11, f11, 680, f11 * |v1|, safeModuloInt(|"vwaeq"|, f11), f11, v4.cf44, 0x16a, f11, f11, |v0|, f11, f11, f11, f11 * f11, |v1[f11 := f11]|, |f9| - f11];
		v5[safeIndex(889, v5.Length)] := f11;
		v5[safeIndex(889, v5.Length)] := -f11;
		var v6: array<char> := new char[21] [v2, v2, if (p0) then v2 else v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, v2, f9[safeIndex(0x194, |f9|)], v2, v2, v2];
		var v7: set<int> := {v5[safeIndex(889, v5.Length)]};
		var v8: map<int, map<int, int>> := map[v5[safeIndex(889, v5.Length)] := v1[v5[safeIndex(889, v5.Length)] := |v7|]];
		var v9: seq<int> := [f11];
		var v10: T1 := new C1(v5[safeIndex(889, v5.Length)] - v5[safeIndex(889, v5.Length)], v5[safeIndex(889, v5.Length)] + v5[safeIndex(889, v5.Length)], |map[p0 := v5[safeIndex(889, v5.Length)]]|, map[if (v9[safeIndex(f11, |v9|)] in v8) then v8[v9[safeIndex(f11, |v9|)]] else v1 := v1], f9, f10);
		v6, r2, v5[safeIndex(889, v5.Length)], v10 := v6, v5[safeIndex(889, v5.Length)] < |v9|, 0x20f, v10;
		var v11: map<string, int> := map[v10.f9 := v5[safeIndex(889, v5.Length)]];
		var v12 := DC0(v10.f9);
		var v13, v14 := v10.m3(-f11 - v10.f11, v10.f9, if (f9 in v11) then v11[f9] else v10.f11, v12, globalState);
		globalState.f3 := v5[safeIndex(889, v5.Length)];
		var v15: array<bool> := new bool[2];
		var v16: seq<array<bool>> := [v15, v15, v15, v15];
		if ((-|v16| > v10.f11) ==> p0) {
			r2 := 725 > f11;
			var v17 := DC11(true, v5[safeIndex(889, v5.Length)]);
			r2 := |(seq(abs(997), i0  => (v2)))| == v17.cf14;
			var v18, v19, v20, v21 := v10.m1(safeModuloInt(|multiset{f11}|, f11), v5[safeIndex(889, v5.Length)], -0xfa, globalState);
			v18 := v19;
			v19 := v18;
		} else {
			v1 := v1;
			globalState.f3 := safeDivisionInt(|fm37(v10.f11, v5[safeIndex(889, v5.Length)], p0, v10.f11, globalState)|, v5[safeIndex(889, v5.Length)]);
			...
			globalState.f3 := |v28[safeIndex(|v29|, |v28|)]|;
		}
		
		r0 := new int[12];
		r1 := fm44(v5[safeIndex(889, v5.Length)] > v10.f11, v10.f11, p0, globalState);
		r2 := p0;
	}
}
...
class C3 extends T1 {
	...
	function fm5(p0: int, p1: int, globalState: GlobalState): int {
		|([f9, "rvbse", "ijam", f9] + DC20(seq(abs(-0x2d8), i0  => (f9))).cf21)|
	}
	...
	function fm30(globalState: GlobalState): seq<string> {
		([seq(abs(0x97), i0  => ('i'))] + ["rnatxbt", f9]) + ["fyqtru"]
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
		...
		if (fm31(globalState) !in v5) {
			...
			match (v9) {
				case DC14(cf17) =>
					...
					v12 := v12[v10 := v11];
					r2, globalState.f3, r0, r3 := f21 || f21, f11, safeModuloInt(f22, p0), -f22;
					var v13 := 'f';
					var v14: seq<int> := [|['s', v13, v13]|];
					var v15 := new C2(f22, fm47(f21, f21, !f21, fm38(f11, globalState), globalState), v1 + "oqrfnoj", [v14, v14, v14, fm44(true, v14[safeIndex(f11, |v14|)], f21, globalState)]);
				case DC13(cf16) =>
					var v16: map<int, int> := map[f22 := 0x265];
					globalState.f3 := -(if ((f22 * -f22) in v16) then v16[f22 * -f22] else |v2|);
					globalState.f3 := -f22;
					var v17 := new C2(f11 - 0x3c4, fm47(f21, f21, f21, v2[safeIndex(|v6|, |v2|)], globalState) + fm47(f21, f21, f21, f21, globalState), f9, seq(abs(0x34c), i2  => ([|multiset{{f21, f21}}|])));
					var v18: seq<multiset<int>> := [multiset{f11}];
					var v19: seq<int> := [f22];
					v1, globalState.f3, r2, r2 := fm37(-p0, p0, v2 < fm2(f9, f22, globalState), f11 * |"hfkpr"|, globalState), f22, v2[safeIndex(DC36(f11).cf48, |v2|)], |v18[safeIndex(|v19|, |v18|)]| <= p0;
			}
			...
			if (f21) {
				...
				v23 := v23[safeDivisionInt(f22, f11) := v22];
				...
				v1 := (v1 + (seq(abs(0x196), i3  => ('n')))) + ((seq(abs(0x24b), i4  => ('i'))) + f9);
				v0[safeIndex(818, v0.Length)] := f11;
				v0[safeIndex(818, v0.Length)] := -(p0 * safeModuloInt(0x35d, |v2|));
				v7[safeIndex(166, v7.Length)] := f21;
				v7[safeIndex(166, v7.Length)], v0[safeIndex(818, v0.Length)], r2, globalState.f3, v0[safeIndex(818, v0.Length)] := f21, v0[safeIndex(818, v0.Length)], !f21, f22, -0xa1;
			} else {
				v2 := [!f21, f21] + v2;
				var v26 := 'd';
				v26 := v26;
				var v27: map<int, seq<int>> := map[f11 := [f22, p0]];
				r2 := |(v2 + v2)[safeIndex(p0, |(v2 + v2)|) := false]| !in v27;
				var v28: map<bool, bool> := map[f21 := !true];
				var v29: array<map<bool, bool>> := new map<bool, bool>[3] [v28 + map[f21 := f21], v28, v28];
				v29[safeIndex(88, v29.Length)] := map[f21 := f21];
				v29[safeIndex(88, v29.Length)] := (v28 + v28) + v28;
				globalState.f3 := safeModuloInt(0x10f, safeModuloInt(fm0(p0, 276, globalState), -p0));
			}
			
			r0 := f11;
			var v30 := DC33(|f9|, v1, f21);
			var v31: array<string> := new string[26] [f9, seq(abs(-0x98), i5  => ('y')), f9, "ypfklawbb", f9, f9, f9 + v30.cf41, "dpjcs", v1, f9, f9, fm37(p0, p0, f21, f11, globalState) + v1, f9, f9, v1, fm31(globalState) + (seq(abs(0x298), i6  => ('n'))), v1, "jaablnfpo", v1, f9 + v1, v1 + (seq(abs(0x3d8), i7  => ('q'))), v1, f9, "hlohlnv" + v1, f9, v1];
			v31[safeIndex(830, v31.Length)] := f9;
			v31[safeIndex(830, v31.Length)] := v1;
			var v33 := 'o';
		...
		v35 := v35[f11 := f21];
		r0 := safeDivisionInt(f11, |[f21, f21, v2[safeIndex(f11, |v2|)]]|);
		...
		r3 := if (v38 in v39) then v39[v38] else safeModuloInt(f22, f11);
	}
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		var v0: seq<int> := [|p1|];
		var v1 := DC28(v0);
		match (v1.(cf31 := v0)) {
			case DC29(cf32, cf33, cf34, cf35, cf36) =>
				...
				if (if (cf35 in v2) then v2[cf35] else !cf32) {
					...
					v3[safeIndex(265, v3.Length)] := cf32;
					v3[safeIndex(265, v3.Length)] := fm38(p0, globalState);
					cf35 := safeDivisionInt(-0x9a, 0x37c) > p2;
					cf32 := !((f9 + p1) < f9);
					globalState.f3 := -cf36 * 145;
					var v4: array<int> := new int[2];
					var v5: map<bool, int> := map[cf35 := |f9|];
					v4[safeIndex(160, v4.Length)] := |v5[f21 := 0x32]|;
					v4[safeIndex(160, v4.Length)] := f22;
				} else {
				...
				v13[safeIndex(719, v13.Length)] := cf35;
				var v14: seq<string> := [f9, seq(abs(0x32f), i2  => ('s'))];
				v13[safeIndex(719, v13.Length)], cf36 := !cf32, |(v14[safeIndex(f22, |v14|)] + p1)|;
				var v15 := new C0(cf32, !true, (seq(abs(563), i3  => ('i'))) + fm37(f22, |cf34|, !v13[safeIndex(719, v13.Length)], p2, globalState), f10);
				var v16: seq<seq<seq<int>>> := [[cf34, cf34], seq(abs(-949), i4  => ([0x2d7, p0, cf34[safeIndex(cf36, |cf34|)], cf33])), f10, f10, [cf34, seq(abs(0x6), i5  => (cf36))]];
				var v17 := new C0(cf32, v13[safeIndex(719, v13.Length)], p1, v16[safeIndex(f22, |v16|)]);
			case DC28(cf31) =>
				var v18 := false;
				var v19 := DC26();
				var v20 := DC27(v19);
				...
				v21[safeIndex(209, v21.Length)] := v20;
				var v22: array<int> := new int[28];
				var v23: seq<array<int>> := [v22, v22, v22, v22, v22];
				v18, globalState.f3, globalState.f3, v18, v21[safeIndex(209, v21.Length)] := v23 == [v22, v22, v22, v22], p2, f22, f21, v20.(cf30 := v19);
				var v24: multiset<bool> := multiset{f21, v18};
				var v25: set<int> := {|v24|};
				var v27: map<int, int> := map[-f11 := f22];
				var v28: set<map<int, int>> := {v27, v27};
				var v29 := new C1(-0x1af, -|v25|, safeDivisionInt(f22, -143), map v26 : map<int, int> | v26 in v28 :: (v26) := (v27), f9, (seq(abs(0x2c4), i6  => (cf31))) + f10);
				var v30: seq<bool> := [v18];
				var v31: map<bool, bool> := map[if (v18) then v30[safeIndex(709, |v30|)] else !v18 := fm38(-0x11c, globalState)];
				v31 := v31;
		...
		v50 := [v50[safeIndex(|multiset{f21, if (v0 in v51) then v51[v0] else f21}|, |v50|)] + v49, v49];
		v1 := v1;
		var v52 := false;
		var v53: set<map<int, int>> := {v49};
		var v54: seq<set<map<int, int>>> := [v53, v53, v53, v53, v53];
		v52 := v53 !! v54[safeIndex(-0x1aa, |v54|)];
		if (f21) {
			var v55: seq<string> := [seq(abs(-0x31b), i8  => ('q'))];
			var v56 := DC20(v55);
			...
			var v62: array<int> := new int[29] [-(if (p0 in v60) then v60[p0] else f11) - f11, f11, fm5(|v61|, p0, globalState), 0x21d + p0, p2, f22 - p0, -f11, p0 * f11, f11, p0, -|v0|, safeDivisionInt(-0x252, f11), -p0, p2, f22, f22, f11, |v61|, safeModuloInt(fm0(|f9|, f11, globalState), f22), p0, |p1|, f22, safeModuloInt(p2, f11), f11, p0, -|(p1 + (seq(abs(498), i9  => ('n'))))|, p2, safeDivisionInt(0x2, f11), fm0(f11, f22, globalState)];
			...
			match (v65) {
				case DC12(cf15) =>
					...
					v66[safeIndex(583, v66.Length)] := v52;
					v66[safeIndex(583, v66.Length)] := (f22 > f22) && (|v0| != p2);
					var v67 := "gcdxudp";
					v67 := (p1 + f9) + (seq(abs(0x24), i10  => (cf15)));
					v66[safeIndex(583, v66.Length)] := f21;
					var v68: seq<bool> := [v66[safeIndex(583, v66.Length)]];
					var v69 := DC7(v68[safeIndex(f22, |v68|)]);
					var v70 := DC37(p0, v69, true);
					var v71 := new C2(f11, if (v70.cf51) then map[map[0x188 := fm0(0x4b, p2, globalState)] := v49] else f12, f9[safeIndex(p0, |f9|) := cf15], f10);
			}
			
			v62[safeIndex(730, v62.Length)] := 0x301;
			var v72: array<seq<bool>> := new seq<bool>[2];
			var v73 := 'w';
			v62[safeIndex(730, v62.Length)], v52, v72, v73, v52 := p0 - safeDivisionInt(p0, p2), v52, v72, v73, f21;
			var v74 := new C1(|"ddxoouvc"|, p2, f11, f12 + f12, p1 + p1, [v0]);
		} else {
			if ((f9 + f9) < p1) {
				globalState.f3 := -(f22 + -p0);
				var v75: array<string> := new string[4];
				v75[safeIndex(249, v75.Length)] := seq(abs(121), i11  => ('i'));
				var v76: array<int> := new int[17];
				v76[safeIndex(605, v76.Length)] := -|p1|;
				var v77 := DC11(v52, 354);
				v75[safeIndex(249, v75.Length)], v76[safeIndex(605, v76.Length)] := p1, |{v77.cf13}|;
				v52 := if (v52) then v52 else v52;
				var v78 := new C0(v52, v52, f9, f10);
				var v79 := DC16();
				var v80: array<D7> := new D7[16] [DC16(), v79, v79, fm50(fm29(-v76[safeIndex(605, v76.Length)], v52, f21, globalState), globalState), v79, DC16(), v79, v79, v79, v79, v79, v79, v79, v79, v79, v79];
				v80 := v80;
			} else {
				v52 := v52;
				var v81: set<bool> := {fm38(|v0|, globalState)};
				var v82: map<int, set<bool>> := map[f22 - -|p1[safeIndex(-p2, |p1|) := 'e']| := v81];
				v82 := v82[f11 := v81];
				v52 := f21;
			...
			var v91: array<int> := new int[23] [|f9|, f11, p0, if (v52) then f22 else 0xc0, f22, if (!v52) then fm0(|v86[safeIndex(f11, |v86|)]|, p0, globalState) else p0, f11, safeDivisionInt(p0, f11), |v87| + |v49|, -f11, f22, f22, f22 + p2, p2, |(seq(abs(660), i12  => ('m')))|, p2, f22, fm0(f11, p0, globalState), fm29(|v89|, !f21, fm38(|(seq(abs(-786), i13  => (f22)))|, globalState), globalState), safeDivisionInt(|v90|, p0), 0x10d, 974, safeDivisionInt(f11, |f9|)];
			v91[safeIndex(870, v91.Length)] := f11 + f11;
			...
			globalState.f3, globalState.f3, v91[safeIndex(870, v91.Length)], globalState.f3 := fm0(f11, 395, globalState) * f22, f11, -p2, if (safeDivisionInt(-(if (v52 in v92) then v92[v52] else |v0|), p0) in v49) then v49[safeDivisionInt(-(if (v52 in v92) then v92[v52] else |v0|), p0)] else p2 * (if (v93 in v94) then v94[v93] else |v95|);
			v91[safeIndex(870, v91.Length)] := safeModuloInt(p0, f11) - f22;
			v93 := if (0x3bc < fm5(f22, f11, globalState)) then v93 else v93;
			if (fm38(|p1|, globalState)) {
				v52 := f21;
				var v96 := new C2(p2, f12, f9, f10);
				globalState.f3 := v91[safeIndex(870, v91.Length)];
				var v97: map<int, string> := map[p2 := f9];
				var v98: map<string, seq<int>> := map[if (p2 in v97) then v97[p2] else fm31(globalState) := fm44(v52, if (v91[safeIndex(870, v91.Length)] in v49) then v49[v91[safeIndex(870, v91.Length)]] else f22, v52, globalState)];
				v91[safeIndex(870, v91.Length)] := |map[v52 := |(if (f9 in v98) then v98[f9] else v0)|]|;
				var v99: map<char, int> := map[v93 := p0];
				globalState.f3 := if (v93 in v99) then v99[v93] else |v87| - |f9|;
			} else {
				v91[safeIndex(870, v91.Length)] := 0x378 + p0;
				var v100: map<bool, string> := map[if (v52) then v52 else f21 := p1 + f9];
				var v101: seq<bool> := [!f21];
				v100 := v100[v101[safeIndex(p0, |v101|)] := f9];
				v92 := (fm42(v92, v52, |v90|, v52, globalState))[v52 := if (f21) then f22 else 0x390];
				var v102: array<char> := new char[11] [v93, v93, v93, v93, v93, v93, v93, v93, f9[safeIndex(f11, |f9|)], v93, v93];
				v102[safeIndex(566, v102.Length)] := v93;
				v102[safeIndex(566, v102.Length)] := v93;
				globalState.f3 := safeDivisionInt(-p2, f22 + |p1|);
			}
		...
		var v111: array<int> := new int[28] [f22, safeDivisionInt(p0, p2), p2, |v0|, |[p2]|, safeDivisionInt(if (|map[false := f21]| in v49) then v49[|map[false := f21]|] else |(seq(abs(88), i15  => (|[|[f21]|]|)))|, -f11), 222, f11, if (false) then if (v107 in v108) then v108[v107] else p2 else p2, f11, p0, fm0(p0, p2, globalState), |(v109 + v109)|, -f22, f22, p0, f11, p0, if (f9 in v110) then v110[f9] else f22, p0, p2, p0, 0x251, p2 - |v50[safeIndex(f11, |v50|)]|, |v107|, v0[safeIndex(f11, |v0|)], p0, p2];
		r1 := v111;
	}
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		r1 := f21 <== true;
		var v0: array<int> := new int[13];
		v0[safeIndex(676, v0.Length)] := fm0(p2, p2, globalState);
		r0, v0[safeIndex(676, v0.Length)] := f21, p0;
		for i0 := f22 to f11 {
			var v1 := DC14(v0);
			var v2: array<D6> := new D6[2] [v1, DC14(v0)];
			var v3: array<bool> := new bool[1](i1 => false);
			var v4: multiset<bool> := multiset{f21};
			v3[safeIndex(406, v3.Length)] := fm38(|v4|, globalState);
			v2, v3[safeIndex(406, v3.Length)] := v2, |"ndeaoaq"| != v0[safeIndex(676, v0.Length)];
			if (v3[safeIndex(406, v3.Length)]) {
				var v5: set<bool> := {v3[safeIndex(406, v3.Length)]};
				var v6: map<bool, bool> := map[f21 := true];
				var v7: map<bool, map<bool, bool>> := map[f21 := v6[v3[safeIndex(406, v3.Length)] := v3[safeIndex(406, v3.Length)]]];
				var v8: seq<map<bool, map<bool, bool>>> := [v7];
				globalState.f3, v5, v0[safeIndex(676, v0.Length)], globalState.f3 := --(if (p1 < p2) then p1 else p0), v5, |(v8[safeIndex(p2, |v8|)])[v3[safeIndex(406, v3.Length)] := v6 + v6]|, f11;
				...
				v3[safeIndex(406, v3.Length)] := fm38(|v11|, globalState);
				var v12: array<map<map<bool, bool>, int>> := new map<map<bool, bool>, int>[26];
				var v14: seq<map<bool, bool>> := [v6];
				var v15: map<int, map<map<bool, bool>, int>> := map[v0[safeIndex(676, v0.Length)] := map v13 : map<bool, bool> | v13 in v14 :: (v13) := (p0)];
				var v16: map<map<bool, bool>, int> := map[v6 := |(seq(abs(-587), i2  => (v10)))|];
				v12[safeIndex(687, v12.Length)] := if (f11 in v15) then v15[f11] else v16;
				v12[safeIndex(687, v12.Length)] := v16;
			} else {
				var v17 := 'y';
				v17 := v17;
				globalState.f3 := p2;
				r0 := v3[safeIndex(406, v3.Length)];
				...
				var v26: seq<C2> := [v19];
				var v27: array<C2> := new C2[27] [v19, v19, v19, v19, v19, v19, v19, v19, v19, v19, if (v24 in v25) then v25[v24] else v19, v19, v19, v19, if (f21) then v19 else v19, v19, v19, v19, v19, v19, v19, v26[safeIndex(p2, |v26|)], v19, v19, v19, v19, v19];
				v27[safeIndex(927, v27.Length)] := v19;
				v27[safeIndex(927, v27.Length)] := v19;
				v3[safeIndex(406, v3.Length)] := v3[safeIndex(406, v3.Length)];
			}
		...
		var v32: map<bool, int> := map[multiset{p1, v0[safeIndex(676, v0.Length)]} >= v31 := f22];
		var v33 := DC39(v32);
		...
		r2 := if (v36[safeIndex(-p2, |v36|)]) then v0 else if (f21) then v0 else v0;
		r3 := |[safeDivisionInt(|f9|, p0), v0[safeIndex(676, v0.Length)], p1, safeModuloInt(0x1b6, v0[safeIndex(676, v0.Length)])]|;
	}
}
...
class C4 extends T0 {
	...
	function fm5(p0: int, p1: int, globalState: GlobalState): int {
		safeDivisionInt(|f9| + |[map[0x243 := f20], map[|map[f20 := f20]| := f19]]|, 0x12d - 0x2b4)
	}
	...
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		...
		if ((v0 + v0) == v0) {
			...
			var v5: array<int> := new int[27](i1 => safeDivisionInt(i1, p1));
			...
			match (v10.(cf4 := false, cf7 := safeDivisionInt(0x3b3, p1))) {
				...
				case DC4(cf3) =>
					...
					var v26 := DC17(v25);
					var v27: array<int> := new int[21] [|(v21 + v21)|, 2 * cf3, if (v20 in v22) then v22[v20] else p1, if (f19 in v23) then v23[f19] else cf3, p2, p0, 0x99, fm0(p2, |map[p0 := true]|, globalState), safeModuloInt(-(if (f19 in v24) then v24[f19] else cf3), p1), 0x94, p0, |(v23 + multiset(v26.cf19))|, 0x242, cf3, p0, p2 + p0, cf3, p0 * p2, cf3, fm0(cf3, p1, globalState), cf3];
					v27[safeIndex(287, v27.Length)] := p2;
					var v28: map<int, int> := map[-p1 := p0];
					v20, v27[safeIndex(287, v27.Length)] := fm27(globalState), -(if (p2 in v28) then v28[p2] else p0);
			...
			var v32: map<array<int>, set<int>> := map[v31[safeIndex(p1, |v31|)] := v29];
			var v33 := 'f';
			var v34: set<bool> := {f19};
			var v35: multiset<int> := multiset{p1};
			var v36 := DC4(p2);
			r2 := new int[20] [p0 + p0, |f10[safeIndex(|(if (v30 in v32) then v32[v30] else v29)|, |f10|)]|, p2, p0, p1, safeModuloInt(p1, -fm0(p0, fm24(p0, f19, v33, globalState), globalState)), p0, |({f19} + v34)|, p0 * p0, p0, p0, |(multiset(v8) * v35)|, |f9|, p1, p1, safeModuloInt(v36.cf3, |f9|), if (f19) then --0x6a else fm0(|v34|, p1, globalState), p1, p2, |f9|];
			v30[safeIndex(255, v30.Length)] := p0;
			v30[safeIndex(255, v30.Length)] := p2;
			var v37: seq<bool> := [f20];
			match (fm28(p2 - p2, v37 + v37, globalState)) {
				case DC0(cf0) =>
					v9[safeIndex(63, v9.Length)] := f20;
					v9[safeIndex(63, v9.Length)] := f19;
					var v38: map<bool, bool> := map[f20 := v9[safeIndex(63, v9.Length)]];
					v38 := (map[f19 := f20])[f19 := !v37[safeIndex(-119, |v37|)]] + v38;
					var v39: multiset<bool> := multiset{!!v9[safeIndex(63, v9.Length)]};
					f19 := v39 >= (multiset{f19, v9[safeIndex(63, v9.Length)], v9[safeIndex(63, v9.Length)], f20, f19} - v39);
					var v40: array<T1> := new T1[10];
					var v42: map<int, int> := map[v30[safeIndex(255, v30.Length)] := p0];
					var v43: map<map<int, int>, bool> := map[v42 := f20];
					var v45: T1 := new C3(f20, p2, p2, map v41 : map<int, int> | v41 in v43 :: (v41) := (map v44 : int | v44 in v8 :: (safeDivisionInt(v44, |v37|)) := (p2)), f9, f10);
					v40[safeIndex(511, v40.Length)] := v45;
					v40[safeIndex(511, v40.Length)] := v45;
			}
		...
		var v53: array<char> := new char[15] [v50, v50, v50, v50, v50, 'k', v50, v50, v50, v50, f9[safeIndex(p2, |f9|)], 's', v50, v50, v50];
		var v54 := DC13(v53);
	...
	method m13(p0: array<map<int, int>>, p1: bool, p2: int, p3: char, globalState: GlobalState) returns (r0: int) {
		...
		var v5 := new C0(p2 != p2, f19, ("t")[safeIndex(p2, |"t"|) := p3], f10);
		...
		var v13: array<multiset<int>> := new multiset<int>[22] [v9, v9, multiset{p2} * (if (p2 in v12) then v12[p2] else v9), v9, fm53(globalState), v9, v9, v9, v9 * v9, v9, v9, v9, v9, v9, multiset{p2, 0x251, p2}, v9 - v9, v9, v9, v9, multiset((seq(abs(0x364), i1  => (p2))) + [p2, p2, p2]), v9, v9];
		v13[safeIndex(675, v13.Length)] := multiset(v2);
		...
		v11, f19, v13[safeIndex(675, v13.Length)], v14, v17 := if (v5.f25) then v11 else {p3}, ([v5.f26, v5.f25])[safeIndex(p2, |[v5.f26, v5.f25]|) := p1] == v7, multiset{fm0(0x322, p2, globalState), -p2}, v14, v17;
		r0 := -p2;
	}
	method m14(p0: array<array<bool>>, globalState: GlobalState) returns (r0: bool, r1: bool) {
		var v0 := 0x173;
		var v1: set<seq<int>> := {seq(abs(261), i1  => (v0))};
		for i0 := |f9| * v0 to if (fm25(f19, f20, v1, globalState)) then v0 else -0x9f {
			...
			match (v4) {
				case DC9(cf11) =>
					...
					globalState.f3 := v0;
					f19 := !(safeDivisionInt(-0xd5, i0) > (if (f20) then 0x398 else 0x139));
					var v7: seq<int> := [i0];
					...
					var v14 := new C3(v7 < (seq(abs(0xa6), i2  => (i0))), |v11| * i0, |(v12 + v12)|, v13, v2, f10 + f10);
				case DC10(cf12) =>
					f20 := f20;
					globalState.f3 := safeDivisionInt(v0, safeDivisionInt(-v0, -i0));
				...
				case DC11(cf13, cf14) =>
					...
					v20[safeIndex(85, v20.Length)] := cf13;
					var v21: set<bool> := {f19, cf13};
					v20[safeIndex(85, v20.Length)] := v21 !! (v21 + {true, f19, f19, f19});
				...
				case DC8(cf10) =>
					...
					var v31: array<string> := new string[10] [f9 + f9, v2, (seq(abs(0x2e0), i5  => ('d'))) + (if (v28 in v29) then v29[v28] else v2), v2, v2, v30[safeIndex(555, |v30|)] + f9, (seq(abs(587), i6  => ('r'))) + "v", v2, f9, v2];
					var v32: array<bool> := new bool[25](i7 => f20);
					v31, v32 := v31, v32;
			}
			
			var v33: seq<string> := [f9];
			var v34: map<int, string> := map[v0 := v33[safeIndex(i0, |v33|)]];
			...
			v34 := v34[-(|v37| - |v38|) := (f9[safeIndex(v0, |f9|) := v39])[safeIndex(v0, |f9[safeIndex(v0, |f9|) := v39]|) := if (v0 in v40) then v40[v0] else v39] + f9];
		}
		var i8 := 0;
		while (false)
			decreases 100 - i8
		{
			...
			if (!f20) {
				...
				var v42: map<int, int> := map[v0 := |(seq(abs(0x15d), i9  => ('d')))|];
				var v43: array<bool> := new bool[18] [f20, f20, f19, false, f19, f20, f19, f20, fm25(false, f20, v1, globalState), f20, !f20, f19, f19, f20, f19, f20, f20, v41[safeIndex(|v42|, |v41|)]];
				var v44: map<int, array<bool>> := map[v0 := v43];
				v43[safeIndex(530, v43.Length)] := true || f19;
				v44, v43[safeIndex(530, v43.Length)], globalState.f3 := v44, true, 0x12b;
				...
				var v51: map<int, bool> := map[v0 := v41[safeIndex(v0, |v41|)]];
				var v52 := DC15(v47);
				var v53 := DC12(fm39(v52, v43[safeIndex(530, v43.Length)], globalState));
				var v54 := 'i';
				var v55 := m13(v50, if (f20) then if (v0 in v51) then v51[v0] else f19 else v43[safeIndex(530, v43.Length)], v0, (v53.(cf15 := v54)).cf15, globalState);
				var v57: seq<int> := [|v41| + |(set v56 : int | (415 <= v56) && (v56 < 0xec) :: (v56 - v0))|];
				v57 := (if (f20) then v57 else v57 + v57)[safeIndex(v55, |(if (f20) then v57 else v57 + v57)|) := safeModuloInt(v55, v55)];
			} else {
				var v58: array<bool> := new bool[12];
				p0[safeIndex(76, p0.Length)] := v58;
				p0[safeIndex(76, p0.Length)] := v58;
				var v59: map<int, bool> := map[v0 := true];
				var v60: multiset<int> := multiset{v0, v0, v0, v0, |v59|};
				globalState.f3 := safeDivisionInt(v0, safeModuloInt(|f9|, |v60|));
				var v61: seq<int> := [v0];
				var v62: map<int, int> := map[v0 := |multiset{f20}|];
				var v63: map<map<int, int>, map<int, int>> := map[v62 := v62];
				var v64: seq<seq<seq<int>>> := [[v61, seq(abs(120), i10  => (v0))]];
				var v65: map<bool, map<int, bool>> := map[f19 := v59];
				var v66 := new C3(false && f19, v0, safeDivisionInt(v0, v61[safeIndex(v0, |v61|)]), v63, f9, (v64[safeIndex(|v65|, |v64|)])[safeIndex(|f9|, |v64[safeIndex(|v65|, |v64|)]|) := v61]);
				var v67 := 'l';
				var v68: map<char, bool> := map[v67 := f19];
				p0[safeIndex(76, p0.Length)][safeIndex(407, p0[safeIndex(76, p0.Length)].Length)] := v66.f21;
				var v69: multiset<char> := multiset{v67};
				v68, globalState.f3, p0[safeIndex(76, p0.Length)][safeIndex(407, p0[safeIndex(76, p0.Length)].Length)] := map[v67 := false], v0, (v69 * v69) >= (multiset{v67, v67} - v69);
				p0[safeIndex(76, p0.Length)][safeIndex(407, p0[safeIndex(76, p0.Length)].Length)] := !v66.f21;
			}
			...
			if (f19) {
				...
				var v73 := DC0("knlhj");
				r1, globalState.f3, globalState.f3 := !!!v70[safeIndex(if (false) then |(if (v71 in v72) then v72[v71] else v73.cf0)| else 0x10f, |v70|)], |v1|, fm0(v0, v0 - 0x5b, globalState);
				...
				v81[safeIndex(969, v81.Length)] := f9;
				v81[safeIndex(969, v81.Length)] := f9;
				var v82: array<char> := new char[29](i12 => v71);
				v82[safeIndex(729, v82.Length)] := f9[safeIndex(v0, |f9|)];
				v82[safeIndex(729, v82.Length)] := v71;
			} else {
				var v83: seq<int> := [v0];
				f20 := v83 != v83;
				var v84 := 'a';
				...
				r0 := if (fm38(fm24(-v0, f20, v84, globalState), globalState) || true) then (if (f19 in v85) then v85[f19] else fm25(f19, f19, {v83}, globalState)) <==> v86[safeIndex(v0, |v86|)] else f20;
			...
			var v92 := DC28(v89[safeIndex(v0, |v89|) := v0]);
			var v93 := DC29(f20, |f9|, v89, f20, |(seq(abs(0x3c7), i14  => ('n')))|);
			var v94: map<bool, bool> := map[DC40(f9, f19, |f9|).cf55 := f19];
			var v95: set<bool> := {f20, f20, f20};
			var v96: array<seq<int>> := new seq<int>[24] [v89, v89, v89 + v89, v89, v89, v89, fm44(f19, v0, v91.cf4, globalState), v89, [v0, v0, -v0, v0], seq(abs(0x10b), i13  => (|{v0}|)), v89, v89, v89, v92.cf31, v89, v89 + v89, v89, v89, v89 + v89, v89, v89, v89 + v89, (v93.cf34[safeIndex(|v94|, |v93.cf34|) := v0] + v89)[safeIndex(v0, |(v93.cf34[safeIndex(|v94|, |v93.cf34|) := v0] + v89)|) := |v95|], v89];
			var v97: map<int, bool> := map[v0 := f20];
			v96 := new seq<int>[8] [v89, v89, (seq(abs(-0xc8), i15  => (884))) + v89, [v0, v0, v0, |v97|], v89, v89, v89, fm44(!f19, v0, f20, globalState)];
		}
		globalState.f3 := v0;
		var v98: multiset<int> := multiset{v0, |f9|};
		var v99: seq<bool> := [true, f20, f20];
		var v100: array<bool> := new bool[24] [v99[safeIndex(v0, |v99|)], f20, f19, f19, f19, f19, f19, f19, f19, f19, f19, f19, f19, f19, f20, f20, true, f20, f19, f19, f20, true, f19, f20];
		var v101 := 'l';
		var v102 := DC5(f20, v100, |fm51(f19, v0, v101, f20, globalState)|, v0);
		v0 := |(if (|v98| != |v99|) then if (f19) then v99 else v99 else (fm2(f9, v0, globalState) + v99)[safeIndex(v0, |(fm2(f9, v0, globalState) + v99)|) := v102.cf4])|;
		var v103 := DC33(v0, f9, f19);
		if (v103.cf41 <= f9) {
			v100[safeIndex(960, v100.Length)] := true;
			v100[safeIndex(960, v100.Length)] := !(|"bhhyskph"| == v0);
			...
			globalState.f3 := fm5(v0, safeDivisionInt(if (v0 in v98) then v98[v0] else |f9|, v106.f24), globalState);
			var v107: array<bool> := new bool[10];
			v107 := (v102.(cf7 := fm5(v106.f24, v0, globalState), cf5 := v107)).cf5;
			v100[safeIndex(960, v100.Length)] := f19;
		} else {
			globalState.f3 := -|f9|;
			v101 := v101;
			var v108: array<int> := new int[6] [v0, safeDivisionInt(v0, v0), -|f9|, v0, |v99|, |f9|];
			v108[safeIndex(950, v108.Length)] := v0;
			var v109: seq<int> := [0x277, v0];
			v108[safeIndex(950, v108.Length)] := |v109| + v0;
			f20 := 'b' !in f9;
			var v110: map<bool, int> := map[f19 := v0];
			var v111: seq<map<bool, int>> := [v110, v110, v110];
			r0 := if (!false) then v110 !in v111 else -v108[safeIndex(950, v108.Length)] <= v108[safeIndex(950, v108.Length)];
		}
		
		var v112 := DC7(false);
		var v113 := DC37(v102.cf6, v112, false);
		var v114: multiset<D15> := multiset{v113, v113, v113, v113, v113};
		globalState.f3 := safeDivisionInt(v0, if (DC37(v0, v112, f20) in v114) then v114[DC37(v0, v112, f20)] else v0);
		var v115: seq<int> := [v0, |"xpcmhno"|, v0];
		var v116: map<seq<int>, bool> := map[v115 := f20];
		r0 := if ((seq(abs(0x30c), i16  => (v0))) in v116) then v116[seq(abs(0x30c), i16  => (v0))] else f19;
		var v117: seq<string> := [seq(abs(0x289), i17  => (v101)), f9, fm31(globalState), "re"];
...
class C5 {
	...
	function fm23(globalState: GlobalState): int {
		safeModuloInt(f17, safeDivisionInt(f17, -0x23a))
	}
	method m11(p0: map<bool, int>, p1: array<bool>, p2: int, globalState: GlobalState) returns (r0: seq<map<int, int>>, r1: D1, r2: bool) {
		for i0 := 0x228 to f17 {
			...
			if (v12.cf49 > p2) {
				...
				globalState.f3 := if ((v19[safeIndex(i0, |v19|)] * fm55(|v20|, globalState)) in v18) then v18[v19[safeIndex(i0, |v19|)] * fm55(|v20|, globalState)] else v10.f22;
		...
		match (v29) {
			case DC7(cf9) =>
				var v30: array<int> := new int[1](i2 => safeModuloInt(i2, f17));
				var v31 := "ydfoo";
				var v32: map<int, bool> := map[|v31| := fm38(p2, globalState)];
				v30[safeIndex(978, v30.Length)] := safeModuloInt(p2, |v32|);
				v30[safeIndex(978, v30.Length)] := 0x394;
				r2 := fm38(v30[safeIndex(978, v30.Length)] - f17, globalState);
				var v33 := 'v';
				var v34: map<int, char> := map[v30[safeIndex(978, v30.Length)] := v33];
				var v35: map<int, int> := map[p2 := p2];
				var v36: seq<int> := [464, f17];
				var v37: seq<int> := [-p2, v36[safeIndex(v30[safeIndex(978, v30.Length)], |v36|)]];
				var v38: C2 := new C2(v30[safeIndex(978, v30.Length)], map[v35 := v35], v31, ([v37, [0x373]])[safeIndex(v30[safeIndex(978, v30.Length)], |[v37, [0x373]]|) := [-|v35|, |v36|]]);
				var v39: set<C2> := {v38};
			...
			case DC6(cf8) =>
				...
				v48[safeIndex(971, v48.Length)] := v49;
				v48[safeIndex(971, v48.Length)] := fm2(v46 + v46, p2, globalState);
		}
		...
		for i3 := 630 to |[p2]| {
			...
			var v53: seq<int> := [i3];
			var v54: set<int> := {v53[safeIndex(p2, |v53|)]};
		...
		if (v28 || v28) {
			...
			var v69 := new C4(!v28, v28, v65 + (seq(abs(901), i5  => ('p'))), v68[safeIndex(|p0|, |v68|)]);
			v69.f19 := p2 >= -p2;
			...
			var v81: array<map<int, int>> := new map<int, int>[7] [map v74 : int | v74 in v75 :: (safeModuloInt(v74, f17)) := (p2), v76, v76, v76, v76 + v76, v76, (map v77 : int | v77 in v78 :: (safeModuloInt(v77, |(map v79 : int | v79 in (map v80 : int | v80 in map[p2 := 'w'] :: (v80 + f17) := (v28)) :: (v79 * p2) := (v28))|)) := (p2)) + map[p2 := p2]];
			p1[safeIndex(667, p1.Length)] := v28;
			...
			v28, v81, p1[safeIndex(667, p1.Length)] := fm38(fm0(|p0|, f17, globalState), globalState), v84[safeIndex(-0x3b1, |v84|)], !(v28 <== v28);
			var v85: set<int> := {p2};
			p1[safeIndex(667, p1.Length)] := if (v28) then p1[safeIndex(667, p1.Length)] else p2 in v85;
			var v86: array<map<int, bool>> := new map<int, bool>[27];
			var v88 := DC10(map v87 : int | (975 <= v87) && (v87 < -0x188) :: (v87 - |multiset{'v', 'w', 'q'}|) := (p1[safeIndex(667, p1.Length)]));
			var v89: map<array<map<int, bool>>, D4> := map[v86 := v88];
			v89 := v89[v86 := v88];
			p1[safeIndex(667, p1.Length)] := false;
			r2 := v28;
		}
		...
		var v98: C1 := new C1(0x2b, p2, p2, fm47(v28, v28, !v28, v94[safeIndex(|"aw"|, |v94|)], globalState), v95, v97);
	...
	method m12(globalState: GlobalState) returns (r0: char, r1: string, r2: D7, r3: char) {
		...
		var v7: array<int> := new int[18] [-|v0|, -safeModuloInt(-f17, f17), f17, f17, f17, safeDivisionInt(f17, f17), f17, if (v1) then f17 else f17, f17 - f17, f17, f17 - f17, f17, safeModuloInt(f17, -f17), f17, f17 * f17, f17, fm0(|v2|, |v3|, globalState), v6[safeIndex(f17, |v6|)]];
		forall i0 | 0 <= i0 < v7.Length {
			v7[i0] := safeModuloInt(i0, f17);
		}
		var v8 := DC14(v7);
		var v9: map<D6, int> := map[v8 := safeModuloInt(f17, f17)];
		v9 := v9[DC14(v7) := |v0|];
		var v10: seq<bool> := [true, v1];
		v4 := multiset(([v1] + v10)[safeIndex(if (f17 in v3) then v3[f17] else f17, |([v1] + v10)|) := v1]);
		var v11 := DC7(false);
		var v12: set<bool> := {true, v11.cf9, v1};
		globalState.f3 := |v12|;
		v7[safeIndex(110, v7.Length)] := fm23(globalState);
		v7[safeIndex(110, v7.Length)] := |[fm38(|v3|, globalState)]| + fm0(f17, |v0|, globalState);
		var v13: map<map<int, int>, map<int, int>> := map[v3 := v3];
		var v14: seq<seq<int>> := [v6];
		var v15: seq<seq<int>> := [v14[safeIndex(0x334, |v14|)], [|v3|], v6];
		var v16 := new C2(v7[safeIndex(110, v7.Length)], v13, v0, v15);
		r0 := 's';
		r1 := v0;
		var v17 := DC33(v7[safeIndex(110, v7.Length)], v0, v1);
...
class C6 extends T1, T0 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
		...
		if ((v1 * v1) >= (v1 + multiset(fm21(f9, globalState)))) {
			...
			match (v19) {
				case DC18() =>
					...
					v21[safeIndex(887, v21.Length)] := v0;
					v21[safeIndex(887, v21.Length)] := [f11, p0, f11, if (v20) then 0x310 else f11];
					var v22: map<bool, int> := map[v20 := f11];
					v22 := v22[v20 := safeDivisionInt(f11, p0)];
				case DC17(cf19) =>
					...
					var v28: array<string> := new seq<char>[14] [seq(abs(0x292), i1  => ('q')), "fixhi", fm26(0x1ce, v23, globalState), f9[safeIndex(p0, |f9|) := v24], f9 + f9, "dquiue" + v25[safeIndex(p0, |v25|)], "weygk", v25[safeIndex(|v27|, |v25|)] + f9, f9 + fm31(globalState), f9, seq(abs(-0x260), i2  => (v24)), f9 + f9, ("kjuipbpmt")[safeIndex(f11, |"kjuipbpmt"|) := v24], f9];
					v28 := new string[19];
					var v29: array<int> := new int[26];
					v29[safeIndex(953, v29.Length)] := p0;
					v29[safeIndex(953, v29.Length)] := -0x31d;
					var v31: set<bool> := {v26};
					var v32: map<bool, bool> := map[v26 := v26];
					var v33: map<int, int> := map[|v31| := |v32|];
					var v34: set<map<int, int>> := {v33};
					var v35 := new C3(v26, -490, ---f11, (map v30 : map<int, int> | v30 in v34 :: (v30) := (v33)) + f12, f9, (seq(abs(140), i3  => (v0))) + f10);
				...
				case DC19(cf20) =>
					...
					v39[safeIndex(325, v39.Length)] := v40;
					var v41: map<int, bool> := map[p0 := v37];
					var v42: map<bool, map<int, bool>> := map[true := v41];
					v37, v37, v39[safeIndex(325, v39.Length)], globalState.f3 := (p0 - f11) !in v0, v37, v40, safeDivisionInt(|v42|, f11) * f11;
					var v43: multiset<int> := multiset{-267, v0[safeIndex(f11, |v0|)], p0, -835};
					v43 := v43 * v43;
			}
			...
			if (if (true) then v45 else v45) {
				...
				v52[safeIndex(724, v52.Length)] := |v53| * f11;
				var v54: seq<bool> := [v45, v45, v50.f26, v50.f25];
				globalState.f3, globalState.f3, v48, v52[safeIndex(724, v52.Length)] := 419, f11 - 0x314, v48 + (v48 + v48), fm0(f11, |(v54 + v54)|, globalState);
			}
			...
			var v58: array<array<array<bool>>> := new array<array<bool>>[4] [v56[safeIndex(p0, |v56|)], v55, if (false in v57) then v57[false] else v55, if (v45) then v55 else v55];
			v58[safeIndex(543, v58.Length)] := v55;
			var v59: map<string, array<array<bool>>> := map[f9 := v55];
			v58[safeIndex(543, v58.Length)] := if (v44 in v59) then v59[v44] else v55;
		...
		v64 := v64[f11 := f11];
		var v65 := 'c';
		var v66: seq<string> := [("ktkt")[safeIndex(p0, |"ktkt"|) := v65], seq(abs(0xc9), i6  => (v65))];
		var v67: map<string, string> := map[f9 := v66[safeIndex(f11, |v66|)]];
		v67 := v67[fm31(globalState) := f9];
		r3 := fm5(p0, safeModuloInt(p0, |v0|), globalState);
		var v69 := true;
		var v70: map<map<int, int>, int> := map[v64 := |multiset{v69, v69, v69}|];
		v62 := new bool[11] [map[map v68 : int | (-288 <= v68) && (v68 < -0x306) :: (safeModuloInt(v68, 0x267)) := (p0) := f11] == v70, v69, v69, v69, false, v69, !v69, v69, fm38(p0, globalState), v69 && v69, v69];
		var v71 := DC7(v69);
		...
		match (v72) {
			...
			case DC37(cf49, cf50, cf51) =>
				...
				v85[safeIndex(205, v85.Length)] := v64;
				var v86: map<array<bool>, int> := map[v62 := cf49];
				r2, v85[safeIndex(205, v85.Length)], v62 := (v86 + v86) == map[v62 := cf49], v64, v62;
			...
			case DC35(cf47) =>
				...
				globalState.f3 := f11;
				var v91 := "vpaie";
				v91 := (seq(abs(696), i9  => (v65)))[safeIndex(f11 + |map[v69 := p0]|, |(seq(abs(696), i9  => (v65)))|) := v65];
		}
	...
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		...
		var v2: C0 := new C0(false, true in v1, p1, seq(abs(96), i0  => (seq(abs(0x1e0), i1  => (p2)))));
		...
		if (v2.f25) {
			...
			globalState.f3 := safeModuloInt(|v5|, f11);
			var v6 := "sqdygrsf";
			...
			var v11: seq<string> := [seq(abs(-0x392), i2  => ('x')), v6];
			v0 := v10[safeIndex(|v11|, |v10|)] <== v2.f26;
		} else {
			var v12 := "tn";
			v12 := v12;
			v0 := !(p0 == f11);
			...
			if (if (p0 in v13) then v13[p0] else !v2.f26) {
				v3[safeIndex(42, v3.Length)] := |[v2.f26]|;
				var v14: map<bool, int> := map[v0 := |v1|];
				var v18: multiset<set<int>> := multiset{set v16 : int | (0x173 <= v16) && (v16 < -0x1c2) :: (v16 - p0), set v17 : int | v17 in [p2, p2] :: (safeModuloInt(v17, 0x1c3))};
				var v19: map<int, map<bool, int>> := map[|f9| := v14];
				var v20: array<bool> := new bool[25];
				var v21 := DC5(v2.f25, v20, p2, |[p2]|);
				var v22: seq<bool> := [v0, v0];
				var v23: array<map<bool, int>> := new map<bool, int>[27] [map[v2.f25 := p2] + v14, v14, v14[v2.f26 := |(map v15 : set<int> | v15 in v18 :: (v15) := (p0))|] + fm42(v14, false, f11, v2.f26, globalState), v14, v14, if (p2 in v19) then v19[p2] else v14, v14, v14[v2.f25 := --p0], v14, v14, map[v21.cf4 := f11], v14, v14, v14, fm42(v14, v2.f26, f11, !v2.f25, globalState), v14[v2.f25 := p2], v14[v0 := -0x129], map[v22[safeIndex(p0, |v22|)] := fm5(f11, f11, globalState)] + v14, fm20(v2.f25, p0, f11, globalState) + fm42(v14, true, p0, v0, globalState), v14, v14, v14, v14 + v14, map[false := f11], map[v2.f25 := 0x30c] + v14, v14, v14 + v14];
				v23[safeIndex(333, v23.Length)] := v14[v2.f26 := p2] + v14;
				v0, v3[safeIndex(42, v3.Length)], v23[safeIndex(333, v23.Length)] := !(v2.f25 && v2.f25), 0x240, v14 + v14;
				globalState.f3 := p2;
				globalState.f3 := v3[safeIndex(42, v3.Length)];
				v0 := p2 <= f11;
				v0 := v2.f25;
			} else {
				v0 := v2.f26;
				var v24: array<bool> := new bool[12];
				v24[safeIndex(569, v24.Length)] := v2.f26;
				v24[safeIndex(569, v24.Length)] := f11 == (0x70 - f11);
				var v25 := 'u';
				var v26: multiset<int> := multiset{p0};
				var v27: multiset<multiset<int>> := multiset{v26};
				v25 := if (v27 !! multiset{v26}) then v25 else v25;
				v24[safeIndex(569, v24.Length)], v0, v0 := v2.f26, v2.f26, 'r' in f9;
				v0, v24[safeIndex(569, v24.Length)] := v2.f26, v2.f26;
			}
			
			var v28: seq<bool> := [v2.f25];
			v28 := ((v28 + [v0]) + ([v2.f26])[safeIndex(f11, |[v2.f26]|) := v0])[safeIndex(0, |((v28 + [v0]) + ([v2.f26])[safeIndex(f11, |[v2.f26]|) := v0])|) := v2.f26];
			v0 := v0;
		}
		...
		v0, v31, globalState.f3 := !v0, v31, if (((seq(abs(0x2ea), i3  => (p0))) + v32) in v33) then v33[(seq(abs(0x2ea), i3  => (p0))) + v32] else p0;
		var v34: set<int> := {0x206, p0, |p1|, v32[safeIndex(p2, |v32|)]};
		var i4 := 0;
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			if (!!v2.f25) {
				var v35, v36, v37, v38 := v2.m1(p0, p0 - f11, safeDivisionInt(-p2, p2), globalState);
				var v39 := new C3(v2.f25, v38, p0, f12 + f12, if (true) then seq(abs(230), i5  => ('w')) else f9, if (v2.f25) then f10 else f10);
				var v40: map<int, int> := map[f11 := f11];
				var v41 := new C1(v39.fm29(v39.fm29(|v40|, v2.f25, true, globalState), v0, !v35, globalState), -996, -f11, f12, seq(abs(0x130), i6  => ('k')), f10);
				var v42: multiset<array<int>> := multiset{v3, v37};
				var v43 := DC35(v42);
				var v44: map<D15, int> := map[v43 := v41.f23];
				var v45: seq<multiset<array<int>>> := [v42];
				var v46: seq<multiset<array<int>>> := [v45[safeIndex(v38, |v45|)], multiset{v37, v37}];
				v44 := v44[v43.(cf47 := v45[safeIndex(v39.f22, |v45|)]) := v38];
				var v47 := "apogbv";
				var v48: seq<bool> := [v36 && v35];
				var v49: array<seq<int>> := new seq<int>[8] [v32, v32, v32, v32, v32, if (v2.f25) then v32 else [0x48, p0, v41.f24, v38], seq(abs(0x172), i7  => (-v39.f22)), v32 + v32];
				v49[safeIndex(624, v49.Length)] := f10[safeIndex(-p2, |f10|)];
				globalState.f3, v47, v38, v48, v49[safeIndex(624, v49.Length)] := v38, p1, -f11, [v48[safeIndex(v41.f23, |v48|)]], ((v32[safeIndex(fm5(v41.f23, p2, globalState), |v32|) := 0x166] + v32) + (v32 + v32))[safeIndex(p2, |((v32[safeIndex(fm5(v41.f23, p2, globalState), |v32|) := 0x166] + v32) + (v32 + v32))|) := v2.fm5(-8, v39.f22, globalState)];
			} else {
				var v50: seq<bool> := [v2.f25, v2.f26];
				var v51: map<int, int> := map[fm0(p2, |v50[safeIndex(p2, |v50|) := v2.f26]|, globalState) := 0x294];
				var v52: map<bool, string> := map[v2.f25 := f9];
				v0, globalState.f3, globalState.f3 := (if (p0 in v51) then v51[p0] else p0) < f11, safeDivisionInt(|v1|, if (v2.f26) then f11 else |(if (v2.f26 in v52) then v52[v2.f26] else p1)|), p2 - f11;
				var v53 := "qrevsuo";
				v53 := "mgtr";
			...
			v59[safeIndex(105, v59.Length)] := v60;
			v59[safeIndex(105, v59.Length)] := v60;
	...
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
			...
			decreases 100 - i0
		{
			...
			if (v8 > (if (v0) then v8 else v8)) {
				var v9 := DC34(v5[safeIndex(f11, |v5|)], |f9|, 300, v0);
				var v10: seq<bool> := [(v9.(cf46 := v0)).cf46];
				r3 := -safeModuloInt(|v10|, if (v0) then p1 else v3.f17);
				v7[safeIndex(682, v7.Length)] := p1;
				var v11 := "t";
				var v12: multiset<array<bool>> := multiset{v6, v6};
				var v13: multiset<map<int, bool>> := multiset{map[v3.f17 := v0], v1, map[f11 := v0]};
				v7[safeIndex(682, v7.Length)], v11, v12 := -(-v3.f17 - p2), f9 + ("lel")[safeIndex(if (v1 in v13) then v13[v1] else p0, |"lel"|) := 'w'], v12;
				v0 := v0;
				v6 := DC5(v0, v6, v7[safeIndex(682, v7.Length)], v7[safeIndex(682, v7.Length)]).cf5;
				v11 := f9;
			} else {
			...
			decreases 100 - i3
		{
			...
			var v21: array<int> := new int[22](i4 => safeDivisionInt(i4, p2));
			r2 := v21;
		}
		if (!(|v1[p0 := v0]| == (p1 + |(seq(abs(0x2bb), i5  => (|map[true := v0]|)))|))) {
			var v22: array<seq<bool>> := new seq<bool>[9];
			var v23: seq<bool> := [!v0, true];
			v22[safeIndex(45, v22.Length)] := v23 + v23;
			var v24 := "s";
			v22[safeIndex(45, v22.Length)], v5, globalState.f3, v24 := v23[safeIndex(v3.f17, |v23|) := v0], v5, safeModuloInt(|(set v25 : int | (0x197 <= v25) && (v25 < 0x2b) :: (safeDivisionInt(v25, v5[safeIndex(p2, |v5|)])))|, |v24|), fm31(globalState);
			...
			match (DC21(v29, v30, v3.f17 > fm0(p0, 120, globalState))) {
				case DC21(cf22, cf23, cf24) =>
					...
					v31[safeIndex(608, v31.Length)] := cf24;
					v31[safeIndex(608, v31.Length)] := true;
					var v32: seq<bool> := [if (!v31[safeIndex(608, v31.Length)]) then cf24 else v0];
					v32 := [32 > v3.f17];
					var v33 := new C5(|v5|, v2);
				case DC20(cf21) =>
					var v34: map<char, bool> := map[v30 := !v0];
					var v35: multiset<int> := multiset{|v34|, 0x337};
					r0 := (v35 * v35) > (fm53(globalState))[v3.f17 := abs(f11)];
			...
			var v44 := DC41((multiset{v0, v0})[v0 := abs(f11)]);
			match (v44) {
				case DC42(cf58, cf59) =>
					...
					v46[safeIndex(754, v46.Length)] := v45;
					var v47: seq<set<int>> := [v28];
					v28, v46[safeIndex(754, v46.Length)], globalState.f3, globalState.f3 := v47[safeIndex(|v28| * -v3.f17, |v47|)], v45, v3.f17, p2;
					var v48 := new C5(p1, v3.f18);
					var v49: array<set<C5>> := new set<C5>[18];
					v49 := v49;
					var v50: seq<bool> := [v0];
					var v51: seq<array<int>> := [v46[safeIndex(754, v46.Length)]];
					var v52: seq<array<int>> := [v45, v51[safeIndex(v3.f17, |v51|)], v45];
					var v53: map<int, array<int>> := map[if (v0) then v48.f17 else |v50| := v51[safeIndex(p0, |v51|)]];
					var v54 := DC25(v53);
					var v55: multiset<int> := multiset{v48.f17};
					var v56: set<bool> := {cf58};
					r0, globalState.f3, v53, r0, globalState.f3 := cf58, 0x17f, map[v3.f17 := v46[safeIndex(754, v46.Length)]] + v54.cf29, v55 > multiset{|v56|}, cf59;
				case DC43(cf60, cf61) =>
					globalState.f3 := -(893 + p1);
					var v57 := DC34(-v3.f17, -0x35d, |[v30, v30]|, v0);
					var v58 := new C0(cf60, v57.cf46, seq(abs(-0x386), i6  => (v30)), f10);
					...
					var v66: array<int> := new int[29] [p2, v3.f17, |v60|, p0, 0x35a, p0, cf61, 0x310, |v61|, v3.f17, v3.f17, v3.f17, p2, |((map v62 : char | v62 in v63 :: (v62) := ('l')) + fm58(cf60, v60, -p0, globalState))|, p2 + v3.f17, p2, p2, f11, v3.f17, v3.f17, p1, 0x12d - 0x312, v3.f17 * v3.f17, -|(set v64 : int | (0x33a <= v64) && (v64 < 596) :: (safeModuloInt(v64, |v5|)))|, v3.f17 + p1, -(0x16c - |[cf60]|), |v65|, |f9| - v3.f17, safeModuloInt(cf61, fm0(0x1c6, v3.f17, globalState))];
					v66[safeIndex(39, v66.Length)] := v3.f17 * p0;
					var v67: array<bool> := new bool[2] [v58.f25, v58.f25];
					var v68: set<array<bool>> := {v67, v67};
					r3, v66[safeIndex(39, v66.Length)], r1, r0 := |map[v5 := cf60]|, |v68|, false, fm22(p0 <= cf61, p0, globalState);
				case DC41(cf57) =>
					globalState.f3 := 0x27f;
					v0 := if (v0) then v0 <== v0 else v0;
					var v69: array<seq<bool>> := new seq<bool>[8](i7 => [v0] + [v0, v0, v0]);
					var v70: seq<bool> := [v0];
					var v71: seq<bool> := [v70[safeIndex(p1, |v70|)], v0];
					v69[safeIndex(600, v69.Length)] := v71;
					...
					v69[safeIndex(600, v69.Length)] := v70[safeIndex(if (v3.f17 in v73) then v73[v3.f17] else -v3.f17, |v70|) := !v0];
				...
				case DC44(cf62) =>
					...
					v77[safeIndex(163, v77.Length)] := v3.f17;
					v77[safeIndex(163, v77.Length)] := v3.f17;
					r2, r1, r1, v77[safeIndex(163, v77.Length)] := v77, v0, v0, (if (v0) then v3.f17 else p1) * p2;
			...
			var v82 := "ydfxhmfrd";
			v82 := f9;
			r1 := (seq(abs(-0x1aa), i10  => (v30))) != (f9 + (seq(abs(0x35), i11  => (v30))));
			var v84: seq<bool> := [v0];
			var v85: multiset<int> := multiset{|map[multiset(v84) := v0]|, p1, |v5|, -p1, 888};
			var v86 := DC0(v82);
			var v87: map<int, D0> := map[|(map v83 : int | v83 in v85 :: (safeModuloInt(v83, 0x215)) := (false))| := v86];
		...
		var v91: map<int, array<int>> := map[safeModuloInt(p2, p1) := v90];
		var v92: seq<bool> := [v0];
	...
	method m10(p0: D5, globalState: GlobalState) returns (r0: int) {
		...
		if (!v1[safeIndex(|v4|, |v1|)]) {
			if (v0) {
				var v5: array<D4> := new D4[14];
				v5[safeIndex(265, v5.Length)] := DC11(v0, f11);
				var v6: map<bool, int> := map[v1[safeIndex(f11, |v1|)] := 630];
				var v7: seq<int> := [|v4|];
				var v8: map<map<bool, int>, seq<int>> := map[v6 := v7];
				v5[safeIndex(265, v5.Length)] := DC11(fm38(|v6|, globalState), |v8|);
				v2 := v2;
				globalState.f3 := f11 * f11;
				var v9: seq<string> := ["gxl", f9];
				var v10 := 'd';
				var v11 := DC22(multiset{f9, v9[safeIndex(|map[v0 := v10]|, |v9|)]});
				...
				var v16 := "qa";
				var v17: seq<int> := [f11];
				globalState.f3, v16 := if (true) then v17[safeIndex(-0x12d, |v17|)] else f11, f9;
			...
			v20[safeIndex(627, v20.Length)] := safeDivisionInt(f11, f11);
			v20[safeIndex(627, v20.Length)] := safeDivisionInt(safeDivisionInt(0x1aa, f11), -f11);
			v4 := v4;
			var v21: map<int, array<int>> := map[safeModuloInt(f11, -0x86) := v20];
			var v22: seq<array<int>> := [v20];
			v21 := v21[f11 := v22[safeIndex(v20[safeIndex(627, v20.Length)], |v22|)]];
			var v23 := "tll";
			v23 := "vxxnkdro" + (v23 + "rbuite");
		} else {
			var v24: array<string> := new string[26];
			v24[safeIndex(499, v24.Length)] := fm37(f11, |v4|, v0, f11, globalState);
			v24[safeIndex(499, v24.Length)] := f9;
			var v25 := 'a';
			var v26 := DC33(f11, v24[safeIndex(499, v24.Length)], v0);
			var v27: multiset<D14> := multiset{DC33(f11, f9[safeIndex(f11, |f9|) := v25], true), v26, v26};
			var v28: map<bool, multiset<D14>> := map[v0 := v27];
			v28 := v28;
			var v29: seq<int> := [840, f11, -f11, f11];
			var v30: multiset<int> := multiset{f11};
			var v31: map<bool, int> := map[(seq(abs(0xd8), i0  => (f11))) <= v29 := |(v30 + v30)|];
		...
		v34[safeIndex(247, v34.Length)] := v33;
		var v35: seq<array<D14>> := [v33];
		var v36 := DC45(v35[safeIndex(f11, |v35|)]);
		v34[safeIndex(247, v34.Length)] := if (!fm38(f11, globalState)) then v36.cf63 else v33;
		var v37: array<int> := new int[8](i1 => safeDivisionInt(i1, |f9|));
		var v38: seq<string> := ["cfudaygy"];
		v37[safeIndex(284, v37.Length)] := |v38[safeIndex(f11, |v38|)]|;
		v37[safeIndex(284, v37.Length)] := |(match DC0("vbttwbn") {
			case DC0(cf0) => f9
		})|;
		v2[safeIndex(369, v2.Length)] := v0;
		var v39 := "xugdjgxwd";
		var v40 := DC20([v39]);
		var v41: multiset<int> := multiset{v37[safeIndex(284, v37.Length)]};
		var v42: map<bool, multiset<int>> := map[v0 := v41];
		var v43: map<multiset<int>, array<bool>> := map[if (v0 in v42) then v42[v0] else v41 := v2];
		var v45: seq<map<multiset<int>, array<bool>>> := [v43[v41[|(set v44 : int | (0x3cd <= v44) && (v44 < 0x20a) :: (v44 * f11))| := abs(0x60)] := v2], v43, v43];
		v2[safeIndex(369, v2.Length)], v38, v39 := (v38 + [v39]) <= v38, v40.cf21[safeIndex(|v45[safeIndex(f11, |v45|)]|, |v40.cf21|) := seq(abs(0x1dc), i2  => ('q'))], seq(abs(0xff), i3  => (if (false) then 'm' else 'y'));
		var v46: seq<int> := [v37[safeIndex(284, v37.Length)], -|f9|];
		var v47 := new C3(v0, v37[safeIndex(284, v37.Length)], |v46|, f12, "vtbgn", f10);
		var v48: set<int> := {-f11};
		var v49 := DC6(v48);
		var v50 := 'u';
		var v51 := DC21(v49, v50, v0);
		v37[safeIndex(284, v37.Length)], v37[safeIndex(284, v37.Length)], v37[safeIndex(284, v37.Length)], v37[safeIndex(284, v37.Length)], globalState.f3 := f11, f11, if (v51.cf24) then v37[safeIndex(284, v37.Length)] else f11, 762, f11;
...
class C7 extends T0, T1 {
	...
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		...
		if (fm13(v2[safeIndex(f11, |v2|)], |(seq(abs(-222), i0  => (p1)))|, f9 + f9, globalState)) {
			var v3: map<bool, int> := map[!!(f9 < f9) := p2];
			v3 := v3[v1 := f11];
			var v4: map<int, int> := map[-p0 := |f9|];
			var v5: seq<map<int, int>> := [v4, v4, v4, v4, v4];
			r3 := -|(v4 + (if (v1) then fm14(f9[safeIndex(p2, |f9|)], v1, globalState) else v5[safeIndex(p2, |v5|)]))|;
			...
			v13[safeIndex(534, v13.Length)] := v12;
			v12[safeIndex(29, v12.Length)] := if (v2[safeIndex(p2, |v2|)]) then v1 else v1;
			var v14 := "utiomrrs";
			v12[safeIndex(534, v12.Length)] := v14 < v14;
			v13[safeIndex(534, v13.Length)], v12[safeIndex(29, v12.Length)], v14, v12[safeIndex(534, v12.Length)] := v12, v1, f9, !true;
			if (v12[safeIndex(29, v12.Length)]) {
				v12[safeIndex(29, v12.Length)] := v0 !in (v14 + v14);
				var v15: array<multiset<bool>> := new multiset<bool>[25];
				var v16: multiset<bool> := multiset{v12[safeIndex(29, v12.Length)]};
				v15[safeIndex(269, v15.Length)] := v16 * v16;
				v15[safeIndex(269, v15.Length)] := v16 * multiset{v12[safeIndex(29, v12.Length)], true};
				globalState.f3 := fm0(|f9|, |f9[safeIndex(p2, |f9|) := v0]|, globalState);
				var v17: array<int> := new int[10] [-p1, p0, p1, 0xde, fm0(p2, |v14|, globalState), p0, p2, f11, f11, p0];
				var v18: seq<int> := [p2];
				var v19: map<bool, char> := map[v1 := v0];
				m8(f11, v17, v18[safeIndex(|v19|, |v18|)], v12[safeIndex(29, v12.Length)], globalState);
				r1 := true;
			} else {
				var v20 := DC6(fm16(|f9|, v1, p0, globalState));
				v20 := if (v12[safeIndex(29, v12.Length)]) then v20 else DC6(set v21 : int | v21 in [p0] :: (v21 + 0x12d));
				v12[safeIndex(29, v12.Length)], globalState.f3, globalState.f3 := ((seq(abs(0x29a), i1  => (v0))) + v14) <= ((seq(abs(-25), i2  => ('c'))) + "mmptpg"), |f9|, f11;
				r3 := safeModuloInt(p2 - |[|fm14(v0, v1, globalState)|]|, f11);
				var v22: map<int, int> := map[p0 := |v14|];
				var v23: seq<int> := [if (p2 in v22) then v22[p2] else p2, f11, p2, f11];
				r0 := v23[safeIndex(p0, |v23|)] > |(v14 + v14)|;
				globalState.f3 := -0x17c;
			}
			
			r3 := safeModuloInt(p0, p0 + p1);
		...
		v25[safeIndex(332, v25.Length)] := seq(abs(0x211), i3  => (|map[v1 := v1]|));
		var v26: set<int> := {p0, p1};
		var v27: seq<int> := [|v26|, f11, p2];
		v25[safeIndex(332, v25.Length)] := v27;
		var v28 := DC12('w');
		...
		var v32: array<array<char>> := new array<char>[21] [v29, DC13(v29).cf16, if (v0 in v30) then v30[v0] else v31[safeIndex(0x1af, |v31|)], v29, v29, v29, v29, v31[safeIndex(p0, |v31|)], v29, v29, v29, v29, v29, v29, v29, v29, v29, v29, v29, v29, v29];
		v32[safeIndex(515, v32.Length)] := v29;
		var v33: array<bool> := new bool[4] [v1, v1, v1, v1];
		v33[safeIndex(402, v33.Length)] := v1;
		v32[safeIndex(515, v32.Length)], v33[safeIndex(402, v33.Length)], r1 := v29, [p1, p2] <= v27, !('f' !in (if (v1) then f9 else f9[safeIndex(p1, |f9|) := f9[safeIndex(p1, |f9|)]]));
		r3 := p1;
		v33[safeIndex(402, v33.Length)] := true;
		r0 := f11 != f11;
		var v34: seq<string> := [f9, f9, f9, f9];
		r1 := ((seq(abs(584), i4  => (f9))) + [f9]) <= ((seq(abs(0x43), i5  => (f9))) + v34);
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
		...
		for i0 := p0 to p0 {
			...
			v3[safeIndex(706, v3.Length)] := v0;
			var v4 := 'r';
			var v5: seq<bool> := [v0];
			var v6: map<bool, bool> := map[v0 := v0];
			var v7: map<bool, char> := map[v0 := v4];
			var v8: array<char> := new char[13] [v4, v4, v4, v4, v4, v4, v4, fm17(v0, globalState), v4, if (v5[safeIndex(f11, |v5|)]) then v4 else fm17(if (v0 in v6) then v6[v0] else v0, globalState), if (v0 in v7) then v7[v0] else 'l', v4, v4];
			v8[safeIndex(336, v8.Length)] := v4;
			var v9: array<int> := new int[24](i1 => safeDivisionInt(i1, f11));
			v9[safeIndex(747, v9.Length)] := i0 * 325;
			var v10: multiset<int> := multiset{f11, f11, safeModuloInt(p0, i0)};
			var v11: seq<int> := [i0];
			r2, v3[safeIndex(706, v3.Length)], v8[safeIndex(336, v8.Length)], r2, v9[safeIndex(747, v9.Length)] := if (v0 in v6) then v6[v0] else v0, !v0 || !(if (v0) then v0 else v0), v4, (v0 <== v0) <== v5[safeIndex(i0, |v5|)], if (p0 in v10) then v10[p0] else -(v11[safeIndex(p0, |v11|)] * f11);
			var v12: array<seq<int>> := new seq<int>[28](i2 => seq(abs(0x1a0), i3  => (478)));
			var v13: map<array<seq<int>>, bool> := map[v12 := |map[v3 := 220]| < f11];
			v13 := v13[v12 := fm13(v0, -0x15b, f9, globalState)];
			v9 := v9;
			var v14 := "xbueos";
			var v15: map<bool, seq<int>> := map[v0 := f10[safeIndex(|{v3[safeIndex(706, v3.Length)], v3[safeIndex(706, v3.Length)], true, v3[safeIndex(706, v3.Length)]}|, |f10|)]];
			v14, v10, v3[safeIndex(706, v3.Length)], v3[safeIndex(706, v3.Length)], r3 := v14, multiset(if (fm13(v0, -i0, v14, globalState) in v15) then v15[fm13(v0, -i0, v14, globalState)] else seq(abs(-0x192), i4  => (v9[safeIndex(747, v9.Length)]))), v14 < v14, if (true) then v3[safeIndex(706, v3.Length)] <== true else false, i0 + 877;
		}
		var i5 := 0;
		while (v0)
			decreases 100 - i5
		{
			...
			v17[safeIndex(144, v17.Length)] := fm18(globalState) + v2;
			v17[safeIndex(144, v17.Length)] := if (v0) then v2 else map[v0 := f11];
			var v18: array<bool> := new bool[26](i6 => v0);
			var v19 := 'k';
			var v20: map<char, int> := map[v19 := f11];
			v18[safeIndex(676, v18.Length)] := fm13(v0, |v20|, f9, globalState);
			var v21: seq<bool> := [v0, v0, v0];
			v18[safeIndex(676, v18.Length)] := v21[safeIndex(f11, |v21|)];
			var v22 := "ejrycfmmc";
			v22 := (f9 + "rsspel") + f9;
			globalState.f3 := |(v2 + v2[v18[safeIndex(676, v18.Length)] := p0])|;
		}
		var v23: array<bool> := new bool[6](i7 => f9 <= f9);
		v23[safeIndex(941, v23.Length)] := v0;
		v23[safeIndex(941, v23.Length)] := v0;
		v0 := v0;
		for i8 := p0 to p0 {
			var v24: seq<map<bool, int>> := [v2];
			var v25: map<array<bool>, int> := map[v23 := |v24|];
			r3, globalState.f3, v23[safeIndex(941, v23.Length)], v23[safeIndex(941, v23.Length)] := fm0(p0, p0, globalState), p0, v23 !in v25, v23[safeIndex(941, v23.Length)];
			globalState.f3 := (i8 + f11) - p0;
			var v26: array<int> := new int[28];
			v26 := new int[27](i9 => i9 - -0x24b);
			r2 := v0;
		}
		r0 := p0 * safeDivisionInt(p0, p0);
		...
		r2 := v23[safeIndex(941, v23.Length)];
		r3 := f11;
	}
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		var v0 := false;
		...
		v1[safeIndex(331, v1.Length)] := -|v2|;
		var v3: seq<int> := [p0];
		var v4: map<int, bool> := map[p0 := v0];
		v0, globalState.f3, v0, globalState.f3, v1[safeIndex(331, v1.Length)] := p2 in map[|f9| := p3], p2 - (f11 + f11), v0, f11, v3[safeIndex(|v4|, |v3|)] - 357;
		if (v3 != (v3 + v3)) {
			var v5: array<char> := new char[22];
			var v6 := 'p';
			v5[safeIndex(690, v5.Length)] := v6;
			v5[safeIndex(690, v5.Length)] := v6;
			var v7: array<bool> := new bool[20];
			v7[safeIndex(388, v7.Length)] := v0;
			var v8: set<bool> := {v0};
			v7[safeIndex(388, v7.Length)] := !(if (v0) then v8 > v8 else v0);
			var v9: multiset<int> := multiset{v1[safeIndex(331, v1.Length)], 38, v1[safeIndex(331, v1.Length)]};
			var v10, v11 := m9(p0, if (-p0 in v9) then v9[-p0] else p2, globalState);
			var v12 := "uraswbovw";
			var v13: seq<bool> := [v11];
			var v14: map<seq<bool>, bool> := map[[fm13(v0, v1[safeIndex(331, v1.Length)], seq(abs(0xb8), i0  => (v6)), globalState)] := v0];
			var v15: seq<bool> := [[v13[safeIndex(p0, |v13|)], v7[safeIndex(388, v7.Length)], false, v11, !v11] !in v14];
			var v16: map<int, array<bool>> := map[f11 := v7];
			v11, v10, v12 := !v15[safeIndex(|v16[fm0(p2, p2, globalState) := v7]|, |v15|)], v10, p1 + p1;
			var v17: map<bool, bool> := map[if (p0 in v4) then v4[p0] else v0 := v7[safeIndex(388, v7.Length)]];
			m8(f11, v1, |v17|, v11, globalState);
		} else {
			var v18: map<array<int>, int> := map[v1 := p2];
			var v19: set<int> := {fm5(p0, v1[safeIndex(331, v1.Length)], globalState), v1[safeIndex(331, v1.Length)]};
			...
			v21[safeIndex(747, v21.Length)] := v20.f19;
			var v22: multiset<bool> := multiset{v20.f19, false};
			v21[safeIndex(747, v21.Length)] := multiset{true} > v22;
			...
			if (v23 > (v23 * v23)) {
				...
				v24[safeIndex(101, v24.Length)] := f9;
				v24[safeIndex(101, v24.Length)] := p1;
				var v25: array<array<D7>> := new array<D7>[22];
				var v26 := DC46(v25);
				v25 := v26.cf64;
				v1[safeIndex(331, v1.Length)] := safeModuloInt(p0, v1[safeIndex(331, v1.Length)]);
			} else {
				var v27: multiset<multiset<bool>> := multiset{multiset{v21[safeIndex(747, v21.Length)], v20.f20, v21[safeIndex(747, v21.Length)]}, v22, v22};
				v27 := v27;
				v20.f19 := v20.f19;
				var v28: seq<bool> := [fm22(v0, -55, globalState)];
				var v29: seq<seq<bool>> := [v28];
				v29 := v29;
				v20.f19 := v1[safeIndex(331, v1.Length)] == -|fm31(globalState)|;
				globalState.f3 := -0x93;
			}
		...
		var v32 := 'y';
		var v33: array<string> := new string[15] [f9[safeIndex(f11, |f9|) := 'v'], p1, "ktgqa", p1, f9, "fc", f9[safeIndex(|v31.cf34|, |f9|) := v32], p1, f9, p1, p1, "ioore", "sylgk", f9, f9];
		forall i3 | 0 <= i3 < v33.Length {
			v33[i3] := f9 + (f9 + p1)[safeIndex(|p1|, |(f9 + p1)|) := v32];
		}
	...
	method m8(p0: int, p1: array<int>, p2: int, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3: C2 := new C2(|v2|, f12 + f12, f9, seq(abs(46), i2  => ([f11])));
			p1[safeIndex(116, p1.Length)] := 0x323;
			...
			v3, v0, v1, p1[safeIndex(116, p1.Length)], v6 := v3, true, v1, p2, DC5(fm38(p2, globalState), v1, 976, f11).(cf6 := |v7| - p0);
			var v8: seq<int> := [f11, p0];
			v8 := v8;
			var v9: array<array<int>> := new array<int>[27];
			var v10 := 'i';
			var v11 := DC12(v10);
			var v12: multiset<int> := multiset{p1[safeIndex(116, p1.Length)]};
			var v13: set<multiset<int>> := {v12};
			var v14 := DC23(v10, v13);
			var v15: map<char, char> := map[v11.cf15 := v14.cf26];
			v0, v9, globalState.f3, v15 := -p2 == (f11 * f11), if (true) then v9 else v9, if (v0) then -875 else |(seq(abs(-0x1cb), i3  => (v10)))|, v15;
		}
		var v16: array<char> := new char[22];
		var v17 := 't';
		v16[safeIndex(57, v16.Length)] := if (true) then v17 else v17;
		var v18 := DC12(v17);
		v16[safeIndex(57, v16.Length)] := v18.cf15;
		...
		if (p3) {
			...
			v23 := v23[v0 := v22];
			var v24: set<bool> := {v0};
			p1[safeIndex(287, p1.Length)] := |v24|;
			var v25 := "ymacyooe";
			v19[safeIndex(98, v19.Length)] := v0;
			var v26: seq<bool> := [p3, v0, !p3];
			p1[safeIndex(287, p1.Length)], v0, v25, v19[safeIndex(98, v19.Length)], v20 := if (p3) then f11 else p0, p3 <== p3, f9 + v25, true, multiset(v26);
			var v27: C0 := new C0(v19[safeIndex(98, v19.Length)], true, seq(abs(0x1bf), i6  => (v16[safeIndex(57, v16.Length)])), f10);
			var v28 := DC32(v27);
			match (v28) {
				case DC33(cf40, cf41, cf42) =>
					var v29: array<bool> := new bool[20];
					var v30: map<bool, int> := map[v27.f26 := p2];
					var v31: map<array<bool>, int> := map[v29 := safeDivisionInt(f11, if (true in v30) then v30[true] else cf40)];
					v31 := v31[v29 := safeDivisionInt(if (cf42 in v20) then v20[cf42] else p2, cf40)];
					var v32: seq<int> := [if (cf42 in v30) then v30[cf42] else p0, p1[safeIndex(287, p1.Length)], f11];
					p1[safeIndex(287, p1.Length)] := |v32| + p1[safeIndex(287, p1.Length)];
					p1[safeIndex(287, p1.Length)] := p1[safeIndex(287, p1.Length)];
					cf40 := p0;
				case DC34(cf43, cf44, cf45, cf46) =>
					v19[safeIndex(98, v19.Length)] := !v27.f26;
					var v33: map<int, int> := map[cf44 := f11];
					var v34: multiset<int> := multiset{p2};
					var v35: map<bool, int> := map[f11 < -(if (|v34| in v33) then v33[|v34|] else cf43) := -|map[DC28([|[false, v27.f26, !true, v27.f25]|, cf44]) := v19[safeIndex(98, v19.Length)]]|];
					var v36: set<int> := {p1[safeIndex(287, p1.Length)], f11};
					v35 := v35[fm38(p1[safeIndex(287, p1.Length)], globalState) := safeModuloInt(cf44, |v36|)];
					var v37 := DC42(cf46, p0);
					var v38, v39 := m9(|"hskkwpm"|, if (v37.cf58) then cf45 else cf43, globalState);
					p1[safeIndex(287, p1.Length)] := cf44;
				case DC32(cf39) =>
					p1[safeIndex(287, p1.Length)] := -0x344 - p1[safeIndex(287, p1.Length)];
					globalState.f3 := p0;
			...
			var v42: multiset<char> := multiset{v16[safeIndex(57, v16.Length)]};
			v0 := !(multiset{v17, v17, v17} > (v42 * multiset(f9)));
			var v43: set<int> := {p2};
			var v44: seq<int> := [p0, -p2, safeDivisionInt(f11, fm5(|v43|, p2, globalState))];
			v44 := v44;
			var v45: map<int, int> := map[f11 := p2];
			var v46: C2 := new C2(p0, map[v45 := v45], f9, f10);
			var v47: seq<C2> := [v46];
			var v48: array<C2> := new C2[7] [v46, v46, v47[safeIndex(f11, |v47|)], v46, v46, v46, v46];
			v48 := v48;
	...
	method m9(p0: int, p1: int, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v8: seq<int> := [p0, p0, |v7|, |fm2(seq(abs(0x1af), i1  => (v3)), f11, globalState)|];
		var v9: seq<bool> := [true];
		var v10: array<int> := new int[19] [-p1, f11 - p1, |(v1 + v1)|, --0x326, p1, |f9|, |multiset(seq(abs(0x146), i0  => (|f9|)))|, p1, safeDivisionInt(if (true in v2) then v2[true] else f11, f11), f11, if (v0) then |map[v3 := v5]| else |f9|, |(v6 + multiset(v8))|, safeModuloInt(-110, if (v9[safeIndex(f11, |v9|)] in v2) then v2[v9[safeIndex(f11, |v9|)]] else 368), p0 * |{p0}|, p1, p1 * f11, f11, safeModuloInt(p1, |f9|), p0 + p0];
		v10[safeIndex(149, v10.Length)] := p0;
		var v11 := DC2();
		var v12 := DC9(v11);
		r0, v10[safeIndex(149, v10.Length)] := if (v0) then fm0(478, f11, globalState) else p0, match v12 {
			case DC9(cf11) => p0 * |[f9]|
			case DC10(cf12) => p0
		...
		var v14 := DC33(if (v3 in v13) then v13[v3] else --v10[safeIndex(149, v10.Length)], f9, false);
		var v15 := new C1(-0x3d7, -v10[safeIndex(149, v10.Length)], p1, fm47(v0, v0, false, false, globalState), f9, fm21(v14.cf41, globalState));
		v10[safeIndex(149, v10.Length)] := |(match DC42(v0, |DC41(v2).cf57|) {
			case DC42(cf58, cf59) => f9 + (seq(abs(0x177), i2  => (v3)))
			case DC43(cf60, cf61) => "maluwbg"
			case DC41(cf57) => "phbkdec"
			case DC44(cf62) => f9 + f9
		})|;
		var v16 := "s";
		v16, r0 := f9[safeIndex(safeModuloInt(p0, f11), |f9|) := v3], -0xe1;
		if (276 >= v15.f23) {
			var v17: set<int> := {v10[safeIndex(149, v10.Length)], f11};
			...
			match (v20) {
				case DC9(cf11) =>
					v15.f23 := v15.f24;
					v0 := false;
					r0 := v8[safeIndex(-(|v9| * |v16|), |v8|)];
					r1 := |v16| == |fm31(globalState)|;
				case DC10(cf12) =>
					var v21 := DC36(-(|multiset(seq(abs(974), i3  => (v10[safeIndex(149, v10.Length)])))| + p0));
					v21 := v21;
					v10[safeIndex(149, v10.Length)] := safeDivisionInt(if (v15.f24 in v6) then v6[v15.f24] else v15.f23, v15.f23);
					var v22 := new C6(f11, f12 + f12, v16 + v16[safeIndex(v15.f24, |v16|) := v3], f10);
					var v23: set<bool> := {v0};
				...
				case DC11(cf13, cf14) =>
					v0 := v0 && v0;
					v9 := v9 + v9;
					v10[safeIndex(149, v10.Length)] := v15.f23;
					cf13 := cf13;
				case DC8(cf10) =>
					var v25: array<bool> := new bool[16](i4 => v0);
					v25[safeIndex(276, v25.Length)] := v0;
					v25[safeIndex(276, v25.Length)] := if (false) then true <==> false else v0;
					v25[safeIndex(276, v25.Length)] := v0;
					r0 := -safeModuloInt(f11, 0x7e);
					var v26: set<bool> := {fm38(f11, globalState)};
					var v27: array<set<bool>> := new set<bool>[2] [v26, {v25[safeIndex(276, v25.Length)], v25[safeIndex(276, v25.Length)]} * fm51(v0, v15.f24, v3, v25[safeIndex(276, v25.Length)], globalState)];
					v27 := v27;
			}
			
			var v28: array<seq<int>> := new seq<int>[9] [v8[safeIndex(v10[safeIndex(149, v10.Length)], |v8|) := v15.f23], [0x2ba], v8, v8, v8, [v15.f23, v15.f24], f10[safeIndex(v15.f24, |f10|)], v8, v8];
			v28 := v28;
			globalState.f3 := v15.f24;
			var v29 := DC41(v2);
			v15.f23, v2 := -v15.f23, v29.cf57;
			var v30 := new C3(if (v15.f23 in v7) then v7[v15.f23] else v9[safeIndex(v10[safeIndex(149, v10.Length)], |v9|)], v15.f23, -v15.f23, f12, f9, seq(abs(-0x259), i5  => (v8)));
		} else {
			v10[safeIndex(149, v10.Length)] := p0;
			v2 := v2;
			...
			v34 := v34;
			var v35: map<map<bool, bool>, int> := map[v33[v0 := v0] + v33 := fm0(v10[safeIndex(149, v10.Length)], v15.f24, globalState)];
			v35 := v35[map[v0 := v0] := f11];
		}
		
		for i6 := v15.f23 to v10[safeIndex(149, v10.Length)] {
			v10[safeIndex(149, v10.Length)] := v15.f23;
			var v36: array<D1> := new D1[2];
			var v37: seq<array<D1>> := [v36];
			var v38: set<string> := {f9, f9};
			var v39: array<array<D1>> := new array<D1>[15] [v37[safeIndex(|v38|, |v37|)], v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36, v36];
			...
			v42 := v42[safeModuloInt(f11, p0) := v41];
...
class C8 {
	...
	method m6(globalState: GlobalState) returns (r0: map<bool, int>, r1: bool, r2: int) {
		if (f16) {
			...
			if (f16) {
				f16 := f16;
				var v0: array<set<int>> := new set<int>[17](i0 => {|[f16, f16, f16]|, f15, |(seq(abs(-0x2b8), i1  => ('o')))|});
				var v1: set<int> := {f15};
				v0[safeIndex(266, v0.Length)] := v1;
				v0[safeIndex(266, v0.Length)] := v1;
				var v2 := "polvaf";
				...
				v4, globalState.f3, v6, v0[safeIndex(266, v0.Length)] := v4, fm0(f15, |(seq(abs(481), i2  => ('r')))|, globalState) * (f15 - f15), fm11(|v8|, globalState), v0[safeIndex(266, v0.Length)] * v1;
				var v9: map<int, bool> := map[|v2| := 0xd <= f15];
				var v11: set<set<int>> := {set v10 : int | (871 <= v10) && (v10 < -47) :: (v10 + -0x21e), v0[safeIndex(266, v0.Length)]};
				var v12 := DC10(v9);
				...
				var v29: map<bool, int> := map[f16 := v22[safeIndex(|v22|, |v22|)]];
				globalState.f3, r2, globalState.f3, r1 := |v15| + 0x1b4, (f15 + v22[safeIndex(f15, |v22|)]) + |v27|, safeModuloInt(safeDivisionInt(v28.cf7, -f15), f15), f16 in v29;
			}
			
			var v30: multiset<bool> := multiset{f16, f16};
			var v31: seq<bool> := [f16, f16];
			var v32: map<int, bool> := map[|v30| := v31[safeIndex(f15, |v31|)]];
			...
			match (v35.(cf3 := f15)) {
				case DC5(cf4, cf5, cf6, cf7) =>
					...
					var v38 := "yd";
					var v39 := new C6(0xa3, v37, v38, seq(abs(0x20d), i4  => (seq(abs(215), i5  => (cf7)))));
					var v40: array<seq<bool>> := new seq<bool>[7](i6 => DC17([f16, f16]).cf19 + [cf4, f16]);
					v40 := v40;
					var v41: seq<string> := [v38];
					var v42 := new C2(cf7, v37, v41[safeIndex(|[f16, f16, f16, cf4]|, |v41|)], fm21(v38, globalState));
			...
			if ((if (f16) then DC34(f15, -f15, f15, f16).cf46 else false) && f16) {
				...
				f16, f16, globalState.f3, f16 := f16, !!(f15 > f15), safeModuloInt(f15, (fm62(fm13(f16, f15, v58, globalState), |v58|, v59, f15, globalState)).cf48), v61 == (v61 + v61);
				...
				var v69 := DC47(f16, |(seq(abs(0x4e), i7  => ('k')))|, f16);
				...
				v71[safeIndex(771, v71.Length)] := f16;
				v71[safeIndex(771, v71.Length)] := !f16;
				v34 := v34[v71[safeIndex(771, v71.Length)] := f15];
				var v72 := DC7(false);
				var v73: seq<bool> := [!(v71[safeIndex(771, v71.Length)] <== v71[safeIndex(771, v71.Length)]), -0x36f <= |(seq(abs(0x2bc), i8  => (f15)))|, v72.cf9, f16, !(v71[safeIndex(771, v71.Length)] && f16)];
				r1 := !v73[safeIndex(f15, |v73|)];
			}
			
			if (safeModuloInt(f15, f15) == f15) {
				var v74: map<bool, bool> := map[f16 := f16];
				v34 := v34[f15 >= |v74| := f15];
				var v75 := 'u';
				var v76: map<char, bool> := map[v75 := f16 <== f16];
				v76 := v76[v75 := fm38(f15, globalState)];
				var v77: map<multiset<int>, int> := map[(multiset{f15})[f15 := abs(f15)] - fm10(if (f16 in v74) then v74[f16] else fm22(f16, -f15, globalState), f15, f15, |(seq(abs(944), i9  => (v75)))|, globalState) := -f15];
				...
				v80[safeIndex(484, v80.Length)] := f16;
				v79, v81, v82, r2, v80[safeIndex(484, v80.Length)] := if (f16 ==> false) then v79 else v79, map[-f15 > f15 := v80], v82, if (f16) then f15 else f15, if (true) then f16 else f16;
				var v83: array<int> := new int[9];
				var v84: array<array<D7>> := new array<D7>[13];
				var v85 := DC46(v84);
				r1, v83, v75, v85, v80[safeIndex(484, v80.Length)] := f16, v83, v75, DC46(v84).(cf64 := v84), v80[safeIndex(484, v80.Length)];
			} else {
				var v86: array<bool> := new bool[17](i10 => f16);
				v86[safeIndex(817, v86.Length)] := f16;
				v86[safeIndex(817, v86.Length)] := f16;
				var v87: array<multiset<int>> := new multiset<int>[27](i11 => multiset{|map[f16 := v86[safeIndex(817, v86.Length)]]|, f15});
				...
				globalState.f3 := -safeDivisionInt(safeModuloInt(if (v87 in v88) then v88[v87] else v92[safeIndex(0x1f3, |v92|)], f15), 0x9d + f15);
				r2 := f15;
				var v93 := 'w';
				var v94: map<char, bool> := map[v93 := v86[safeIndex(817, v86.Length)]];
				var v95: seq<map<char, bool>> := [fm63(f16, globalState), v94, v94];
				v89[safeIndex(135, v89.Length)] := |v95[safeIndex(f15, |v95|)]|;
				v89[safeIndex(135, v89.Length)] := f15;
				v89 := v89;
			}
		...
		match (v103) {
			case DC47(cf65, cf66, cf67) =>
				...
				var v109: map<map<int, int>, map<int, int>> := map[map v107 : int | v107 in map[cf66 := f15] :: (safeDivisionInt(v107, f15)) := (cf66) := v108];
				var v110: C7 := new C7(v104, v106, f15, v109);
				var v111: map<bool, C7> := map[v97[safeIndex(cf66, |v97|)] := v110];
				...
				v114[safeIndex(789, v114.Length)] := v115;
				...
				v114[safeIndex(789, v114.Length)], v117, v115 := if ((false <==> cf67) in v118) then v118[false <==> cf67] else v115, (v117 + v117)[v116 := v115], v115;
				f16 := cf65;
			case DC48(cf68, cf69, cf70) =>
				cf68 := false;
				globalState.f3 := safeModuloInt(|"mlffyw"|, f15);
				var v119: map<int, int> := map[282 := f15];
				var v120: map<map<int, int>, map<int, int>> := map[v119 := v119];
				var v122: seq<int> := [|(seq(abs(0x372), i12  => (f15)))|];
				var v123 := "pbkk";
				var v124: seq<seq<int>> := [v122];
				var v125 := new C2(-f15, v120[map[0x28c := f15] := v119] + map[v119 := map v121 : int | v121 in v122 :: (safeModuloInt(v121, f15)) := (|multiset{v97[safeIndex(787, |v97|)], f16}|)], v123, v124);
			...
			case DC46(cf64) =>
				...
				if (f16) {
					...
					var v135 := DC29(f16, |v132|, if (f16 in v134) then v134[f16] else seq(abs(0x134), i13  => (-f15)), f16, f15);
					v131[safeIndex(575, v131.Length)] := DC30(v135);
					var v136: array<set<bool>> := new set<bool>[18];
					v136[safeIndex(563, v136.Length)] := {f16, v97[safeIndex(0x24a, |v97|)], f16, f16};
					var v137 := DC30(v135);
					var v138: set<bool> := {f16};
					f16, globalState.f3, v131[safeIndex(575, v131.Length)], v133, v136[safeIndex(563, v136.Length)] := f16, f15 * (f15 * f15), v137, v133, v138;
					var v139 := 'j';
					var v140: map<string, char> := map[v132 := v139];
					v140 := v140[if (v97[safeIndex(f15, |v97|)]) then v132 else "un" := v139];
					r1 := !!(v139 in v132[safeIndex(|v132|, |v132|) := v139]);
					...
					v142[safeIndex(313, v142.Length)] := v145;
					...
					r1, v142[safeIndex(313, v142.Length)], v149, v102, r1 := f16, v145, v149, (v102 + v102) * (if (f16 in v150) then v150[f16] else v102), f16;
				} else {
					var v151: map<int, bool> := map[f15 := true];
					var v152: set<int> := {f15, f15};
					var v153: map<bool, set<int>> := map[v97[safeIndex(|v151|, |v97|)] := v152];
					v153 := v153;
					var v154: array<map<bool, bool>> := new map<bool, bool>[14](i14 => map[f16 := f16]);
					var v155: map<bool, bool> := map[f16 := true];
					v154[safeIndex(733, v154.Length)] := v155;
					var v156: seq<map<bool, bool>> := [v155, v155, v155, v155];
					v154[safeIndex(733, v154.Length)] := v156[safeIndex(-f15, |v156|)];
					f16 := f16;
					...
					v160[safeIndex(551, v160.Length)] := false;
					v160[safeIndex(551, v160.Length)] := f16;
				...
				match (v163) {
					case DC23(cf26, cf27) =>
						...
						var v166: seq<int> := [|(seq(abs(0x204), i15  => (f15)))|, |v165|];
						...
						v173[safeIndex(102, v173.Length)] := false;
						v173[safeIndex(102, v173.Length)] := v168.f20;
					...
					case DC24(cf28) =>
						...
						v185 := fm26(v186[safeIndex(f15, |v186|)] * f15, map[f15 := v185] + fm65(f15, |multiset{f15, f15, f15, f15}|, f16, f16, globalState), globalState);
						r2 := (f15 + f15) * 0x2e9;
						...
						var v193: array<bool> := new bool[20] [if (f16) then f16 else f16, f15 < -v187.cf3, f16, f16, f16, v97[safeIndex(f15, |v97|)] || f16, v188 >= v188, f16, f16, v97[safeIndex(f15, |v97|)], 0x2d8 >= f15, fm38(|v189|, globalState), f16, true, f16, v191.cf32, !!f16, v102 <= multiset{f15}, f16 in v192[safeIndex(-fm0(0x1dc, f15, globalState), |v192|)], f16];
						v193[safeIndex(960, v193.Length)] := f16;
						var v194 := DC40("hyeonp", f16, 0x46);
						v193[safeIndex(960, v193.Length)] := !fm13(f16, |v102|, v185 + v194.cf54, globalState);
						var v195: array<array<int>> := new array<int>[29];
						var v196: array<int> := new int[28](i16 => safeModuloInt(i16, f15));
						v195[safeIndex(481, v195.Length)] := v196;
						v195[safeIndex(481, v195.Length)] := if (v193[safeIndex(960, v193.Length)]) then v196 else v196;
				}
				
		}
		
		var v197: array<int> := new int[20];
		v197[safeIndex(136, v197.Length)] := f15;
		v197[safeIndex(136, v197.Length)] := f15;
		var v198 := "mqgss";
		for i17 := v197[safeIndex(136, v197.Length)] * fm0(v197[safeIndex(136, v197.Length)], f15, globalState) to fm0(|v198|, f15, globalState) * f15 {
			var v199: array<bool> := new bool[27](i18 => f16);
			v199[safeIndex(503, v199.Length)] := false ==> f16;
			v199[safeIndex(503, v199.Length)] := false;
			var v200: map<bool, int> := map[v199[safeIndex(503, v199.Length)] := f15];
			var v201 := DC39(v200[f16 := f15] + v200);
			match (v201) {
				case DC40(cf54, cf55, cf56) =>
					var v202: array<array<seq<bool>>> := new array<seq<bool>>[23];
					var v203: array<seq<bool>> := new seq<bool>[3] [v97, fm2(seq(abs(0x118), i19  => ('o')), |cf54|, globalState), v97];
					v202[safeIndex(753, v202.Length)] := v203;
					v202[safeIndex(753, v202.Length)] := v203;
					var v204: set<bool> := {v199[safeIndex(503, v199.Length)]};
					...
					var v210: seq<int> := [cf56, v197[safeIndex(136, v197.Length)]];
					v209[safeIndex(191, v209.Length)] := [|multiset{!cf55}|, |v210|];
					v209[safeIndex(191, v209.Length)] := ([v210[safeIndex(v210[safeIndex(i17, |v210|)], |v210|)], f15])[safeIndex(cf56, |[v210[safeIndex(v210[safeIndex(i17, |v210|)], |v210|)], f15]|) := -0x320];
				case DC39(cf53) =>
					var v211: map<int, bool> := map[v197[safeIndex(136, v197.Length)] := f16];
					var v212 := 'w';
					var v213: seq<int> := [safeDivisionInt(if (|v211| in v102) then v102[|v211|] else |v198[safeIndex(v197[safeIndex(136, v197.Length)], |v198|) := v212]|, v197[safeIndex(136, v197.Length)]), |"s"|, safeModuloInt(i17, i17), f15, safeDivisionInt(-|v97|, 0x3e4)];
					var v214: map<int, int> := map[f15 := |v102|];
					var v215: map<map<int, int>, map<int, int>> := map[v214 := v214];
					var v216: T0 := new C6(v197[safeIndex(136, v197.Length)], v215, v198, seq(abs(0x1d3), i21  => ([f15, f15])));
					var v217: map<bool, T0> := map[f16 := v216];
					var v218: set<char> := {fm27(globalState), v212};
					var v219: seq<set<char>> := [v218, {v212}, v218, v218];
					v213 := ([safeModuloInt(f15, --|v217|), i17, -i17])[safeIndex(|(v219 + v219)|, |[safeModuloInt(f15, --|v217|), i17, -i17]|) := fm0(v197[safeIndex(136, v197.Length)], v197[safeIndex(136, v197.Length)], globalState)];
					v199[safeIndex(503, v199.Length)] := v199[safeIndex(503, v199.Length)];
					var v220: map<map<int, int>, seq<int>> := map[v214 := v213];
					var v222: map<map<int, int>, int> := map[v214 := v197[safeIndex(136, v197.Length)]];
					v220 := if (f16 <== !f16) then map v221 : map<int, int> | v221 in v222 :: (v221) := (v213[safeIndex(v197[safeIndex(136, v197.Length)], |v213|) := i17]) else v220;
					r2 := safeDivisionInt(v197[safeIndex(136, v197.Length)], 0x210);
			}
			
			var v223 := 'o';
			var v224: seq<int> := [|fm53(globalState)|];
			var v225: map<bool, seq<int>> := map[v199[safeIndex(503, v199.Length)] := v224];
			v223, v199[safeIndex(503, v199.Length)], v198, v225, v197 := v223, f16, v198, v225, v197;
			var v226: multiset<bool> := multiset{!true};
			var v227: map<bool, multiset<bool>> := map[v199[safeIndex(503, v199.Length)] := v226];
			var v228: multiset<char> := multiset{'n', v223};
			var v229: map<int, int> := map[v197[safeIndex(136, v197.Length)] := |v228|];
			var v230: map<map<int, int>, map<int, int>> := map[v229[v197[safeIndex(136, v197.Length)] := f15] := v229];
			var v231: map<int, string> := map[|multiset(v198)| := seq(abs(-0x2d9), i22  => (v223))];
			var v232: seq<seq<int>> := [v224, [-0xb0], v224, v224, v224];
			var v233: C2 := new C2(|v227|, v230, (if (-i17 in v231) then v231[-i17] else (seq(abs(0x7f), i23  => (v223)))[safeIndex(i17, |(seq(abs(0x7f), i23  => (v223)))|) := v223]) + v198, v232);
			v233 := v233;
		}
		v197 := v197;
		r2 := v197[safeIndex(136, v197.Length)];
		var v234: map<bool, int> := map[f16 := fm0(f15, v197[safeIndex(136, v197.Length)], globalState)];
	...
	method m7(globalState: GlobalState) returns (r0: bool, r1: bool, r2: set<map<bool, int>>) {
			...
			decreases 100 - i0
		{
			...
			var v7: map<map<int, int>, map<int, int>> := map[v5 := map v6 : int | (0x2a0 <= v6) && (v6 < -0x3ba) :: (safeModuloInt(v6, f15)) := (f15)];
		...
		for i2 := 0x1bf to -f15 {
			...
			var v21 := 't';
			v21 := v15[safeIndex(i2, |v15|)];
		}
		var v22 := "yqwke";
		var v23 := 'r';
		globalState.f3 := |v22[safeIndex(f15, |v22|) := v23]|;
		...
		match (v26) {
			case DC42(cf58, cf59) =>
				...
				if (f16) {
					...
					var v43: array<int> := new int[3] [v42[safeIndex(-cf59, |v42|)], v29.f17, f15];
					v43[safeIndex(604, v43.Length)] := safeDivisionInt(-0x50, f15);
					...
					v43[safeIndex(604, v43.Length)], globalState.f3, r0, v45, globalState.f3 := if (!cf58) then cf59 else f15 - |v46|, cf59, cf58, v45.(cf25 := v44["dgkcyyhh" := abs(v29.f17)]), v29.f17;
			...
			case DC43(cf60, cf61) =>
				...
				match (v56) {
					case DC7(cf9) =>
						...
						var v59: map<char, int> := map[v23 := safeDivisionInt(|(set v58 : char | v58 in v57 :: (v58))|, 258)];
						v59 := v59[v23 := cf61];
						...
						v62[safeIndex(37, v62.Length)] := v64;
						v62[safeIndex(37, v62.Length)] := v64;
					...
					case DC6(cf8) =>
						...
						v73 := multiset(DC17(DC17(v55).cf19[safeIndex(f15, |DC17(v55).cf19|) := cf60]).cf19);
						globalState.f3 := safeDivisionInt(safeModuloInt(cf61, f15), |(v73 - multiset(v55))|);
			...
			case DC41(cf57) =>
				...
				globalState.f3 := safeModuloInt(f15, |(v75[safeIndex(|v22|, |v75|)] + v76)|);
				var v77: map<string, int> := map[seq(abs(0x1ae), i6  => ('e')) := f15];
				...
				var v89: seq<seq<int>> := [v84, v88.cf34[safeIndex(|v85|, |v88.cf34|) := f15]];
				var v90: C1 := new C1(f15, f15, f15, v87, seq(abs(0xf3), i7  => (v23)), v89);
				var v91: set<C1> := {v90};
				var v92: seq<set<C1>> := [{v90}, v91, v91, v91, {v90, v90, v90}];
				v79, v24, globalState.f3, globalState.f3, globalState.f3 := [fm38(|multiset{f15, |v25|}|, globalState), fm38(f15, globalState), v82.cf68], v24, safeModuloInt(f15, |[f16]|), f15 + |v92|, safeDivisionInt(v90.f23, f15);
			case DC44(cf62) =>
				globalState.f3 := f15;
				...
				var v97: seq<bool> := [f16];
				var v98: seq<bool> := [v97[safeIndex(|v22|, |v97|)], f16];
				var v99: map<int, int> := map[|v96[safeIndex(|v97|, |v96|)]| := 215];
		...
		r2 := fm67((seq(abs(-0x367), i8  => (v23))) + v111[safeIndex(f15, |v111|)], globalState);
	}
}
...
class C9 {
	...
	function fm7(p0: int, p1: int, globalState: GlobalState): int {
		safeModuloInt(-safeModuloInt(|map[!DC1(false).cf1 := false]|, 0x38b), |([false] + [false])|)
	}
	method m5(p0: seq<bool>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool, r1: int) {
		var v0 := 0x80;
		for i0 := safeDivisionInt(-583, v0) to v0 {
			if (p2) {
				var v1 := DC2();
				var v2 := 's';
				...
				v0 := safeModuloInt(if (true in v6) then v6[true] else i0, v8.cf6);
				r1 := v0;
				...
				r1 := safeDivisionInt(v0, if (fm8(|v9|, p1, p2, globalState)) then v0 else |v12|);
				var v13: map<int, array<bool>> := map[safeDivisionInt(v0, i0) := f14];
				v13 := v13[i0 := f14];
				r0 := p1;
				v0 := i0;
				f14[safeIndex(984, f14.Length)] := p1;
				f14[safeIndex(984, f14.Length)] := p2;
			}
			
			f14[safeIndex(158, f14.Length)] := false;
			var v14 := 'l';
			r1, f14[safeIndex(158, f14.Length)], r1 := --891, v14 !in "yc", if (p2) then v0 + i0 else v0;
			f14[safeIndex(158, f14.Length)] := false;
			f14[safeIndex(158, f14.Length)] := f14[safeIndex(158, f14.Length)];
		}
		...
		match (v16.(cf1 := v21[safeIndex(-v0, |v21|) := v19] != [v19])) {
			case DC2() =>
				globalState.f3 := v0;
				...
				var v26 := new C1(safeDivisionInt(v0, if (v0 in v23) then v23[v0] else v0), |(if (!p1) then p0 else p0[safeIndex(v24[safeIndex(v0, |v24|)], |p0|) := p1])|, --v0, fm47(p2, p2, p1, p1, globalState), seq(abs(-0x27c), i1  => (v20)), v25);
				if (v0 < v26.f23) {
					...
					f14[safeIndex(790, f14.Length)] := if (true) then fm38(|(v31[safeIndex(v26.f24, |v31|)])[p2 := v26.f24]|, globalState) else true;
					...
					f14[safeIndex(790, f14.Length)] := (if (p2) then v34 else DC52(v34).cf77) > (v34 * v34);
					var v35: map<bool, bool> := map[f14[safeIndex(790, f14.Length)] := p1];
					...
					var v40: map<bool, map<int, C5>> := map[p2 := v39[safeIndex(v26.f23, |v39|)]];
					f14[safeIndex(790, f14.Length)] := v26.f24 == -(|v40[p1 := v38]| * |v24|);
					var v41: array<seq<map<D11, char>>> := new seq<map<D11, char>>[4];
					var v42 := DC25(v33);
					var v43 := DC27(v42);
					var v44: map<D11, char> := map[v43 := v20];
					var v45: seq<map<D11, char>> := [v44, v44];
					v41[safeIndex(613, v41.Length)] := v45 + v45;
					v41[safeIndex(613, v41.Length)] := v45;
				} else {
					f14[safeIndex(599, f14.Length)] := p1;
					var v46 := DC50(v26.f23, p2, p2, p1);
					var v47 := DC42(v46.cf74, v26.f24);
					var v48: set<bool> := {false, v47.cf58};
					f14[safeIndex(599, f14.Length)] := (v48 * {fm38(v26.f24, globalState), p1}) <= fm51(true, v26.f23, v20, !p1, globalState);
					v0 := if (|v24| in v23) then v23[|v24|] else -safeModuloInt(v26.f23, v26.f23);
					var v49: map<int, bool> := map[0x308 := f14[safeIndex(599, f14.Length)]];
					var v50 := DC10(v49);
					var v51: set<map<int, bool>> := {v50.cf12, map[v26.f23 := p1]};
					var v52 := DC55(v51);
					v51 := v52.cf82;
					r0 := f14[safeIndex(599, f14.Length)];
				...
				match (v54) {
					case DC2() =>
						...
						var v57: array<array<array<C6>>> := new array<array<C6>>[12] [v55, v55, v55, v55, v55, v55, v56[safeIndex(v26.f23, |v56|)], if (true) then v55 else v55, v55, v55, v55, v55];
						var v58 := DC58(v55);
						v57[safeIndex(931, v57.Length)] := v58.cf89;
						v57[safeIndex(931, v57.Length)] := if (p2) then v55 else v58.cf89;
						var v59: array<bool> := new bool[8](i2 => p2);
						v59 := v59;
						var v60: seq<array<bool>> := [f14];
						var v61: seq<array<bool>> := [v60[safeIndex(v26.f24, |v60|)], v59, f14, v59];
						var v62 := DC61([f14]);
						v61 := v62.cf94;
						var v63: set<bool> := {p2, p1, p1, p2, false};
						v0, r0 := v26.f24, !(|(v63 + fm51(p2, -0x263, v20, p1, globalState))| >= v0);
					case DC1(cf1) =>
						globalState.f3 := -safeDivisionInt(|multiset(fm44(true, v26.f24, p2, globalState))|, -0x3ad);
						v26.f23 := v26.f24;
						f14[safeIndex(549, f14.Length)] := p1;
						f14[safeIndex(549, f14.Length)] := !!p2;
						var v64: array<char> := new char[15](i3 => v20);
						v64[safeIndex(494, v64.Length)] := v20;
						v64[safeIndex(494, v64.Length)] := v20;
					case DC3(cf2) =>
						v26.f23 := v26.fm5(if (!fm38(v26.f24, globalState)) then v26.f24 else v0, |([p2, p2, p1, p1, p1] + p0)|, globalState);
						var v65 := "n";
						f14[safeIndex(316, f14.Length)] := v15 >= DC62(v15).cf95;
						var v66: array<int> := new int[13];
						v65, f14[safeIndex(316, f14.Length)], v66 := v65, fm22(p0[safeIndex(v26.f24, |p0|)], v26.f23, globalState), v66;
						v26.f23 := -v26.f24 * v26.f24;
						f14[safeIndex(316, f14.Length)] := p2;
				}
				
			case DC1(cf1) =>
				var v67: seq<int> := [v0];
				var v68: map<bool, bool> := map[fm8(v0, cf1, p1, globalState) := v67[safeIndex(v0, |v67|)] == v0];
				v68 := v68[p2 := p2];
				var v69: map<char, int> := map['x' := v0];
				var v70 := "lejmoqt";
				globalState.f3 := |v69| - safeDivisionInt(v0, fm7(|fm45(v0, map[v70 := cf1], -v0, true, globalState)|, v0, globalState));
				var v71: seq<bool> := [true];
				v71 := v71;
				var v72: array<int> := new int[22](i4 => safeModuloInt(i4, v0));
				v72[safeIndex(433, v72.Length)] := if (p1 in v17) then v17[p1] else 0x5d;
				v72[safeIndex(433, v72.Length)] := v0;
			case DC3(cf2) =>
				var v73 := DC47(false, v0, p2);
				var v74: map<int, int> := map[v0 := v73.cf66];
				var v75: map<map<int, int>, map<int, int>> := map[v74 := map[v0 := v0]];
				var v76 := "jvfqohe";
				var v77: seq<int> := [|(seq(abs(381), i6  => (v0)))|];
				var v78: seq<int> := [v0, v0, 0x214, v0, |v77|];
				var v79: seq<seq<int>> := [v78];
				var v80 := new C2(v0, v75, v76, (seq(abs(-0x169), i5  => ([v0]))) + v79);
				if (!p2) {
					var v81: array<array<int>> := new array<int>[10];
					var v82: array<int> := new int[17];
					v81[safeIndex(279, v81.Length)] := v82;
					v81[safeIndex(279, v81.Length)] := new int[16];
					r0 := p2;
					v0 := v0;
					...
					v87 := v87;
					var v89, v90 := v80.m3(v0, v76, if (v86.f26) then |v76[safeIndex(v0, |v76|) := v20]| else |multiset{v18, v18}|, DC0(v76), globalState);
		...
		if ((fm69(fm22(p1, v0, globalState), v99.f9, globalState)).cf51) {
			...
			var v104 := DC60(v103);
			v104 := v104;
			r0 := p2 || (0x330 < v97[safeIndex(|v99.f9|, |v97|)]);
			v20 := v20;
			if (fm38(v99.f11, globalState)) {
				var v105: array<string> := new string[19];
				v105 := if (p1) then v105 else v105;
				v105[safeIndex(495, v105.Length)] := v99.f9;
				v105[safeIndex(495, v105.Length)] := "lhtvkeqx";
				v0 := |v99.f9| + v99.f11;
				...
				v107[safeIndex(508, v107.Length)] := v109;
				v107[safeIndex(508, v107.Length)] := v109;
			} else {
				r0 := p2;
				...
				r0 := v113[safeIndex(v99.f11, |v113|)] <= (v112[f14 := abs(v99.f11)] - v112);
				globalState.f3 := -fm7(v99.f11, -v99.f11, globalState);
				var v114: map<char, bool> := map[v20 := p2];
				var v116: array<int> := new int[24] [v99.f11, v0, 0x159, |"lfylrpmlt"|, |(v95 + v95)|, |v99.f9| * v99.f11, v0 + v99.f11, --v99.f11, -0x30, v99.f11, safeModuloInt(0x58, v99.f11), v0, 0x357, v0 + v99.f11, 0x247, safeDivisionInt(|v114[v20 := p2]|, |fm37(0x21e, v99.f11, !p1, -v0, globalState)|), -v99.f11, v0, v99.f11, -0x3b4, 0x2c9, v0, |(if (p2) then map v115 : int | (0x360 <= v115) && (v115 < 0x256) :: (v115 * v0) := (-v0) else v94)|, safeDivisionInt(v99.f11, -|v95|)];
				v116[safeIndex(777, v116.Length)] := v99.f11;
				v116[safeIndex(777, v116.Length)] := v0;
			}
			...
			if (fm13(!p1, 0xeb, if (v117 in v118) then v118[v117] else v99.f9, globalState)) {
				...
				var v124: array<string> := new string[25] [v99.f9 + (seq(abs(0x2f5), i7  => ('j'))), "vuctiil", (seq(abs(-0x1c8), i8  => (v20))) + v99.f9, v99.f9, v99.f9, if (p2) then v99.f9[safeIndex(-v97[safeIndex(v99.f11, |v97|)], |v99.f9|) := 'i'] else v99.f9, (seq(abs(0x94), i9  => ('a'))) + v99.f9, v99.f9, fm26(v99.f11, map[v99.f11 := v99.f9[safeIndex(|multiset{0x374}|, |v99.f9|) := v20]], globalState), v99.f9, v99.f9, "eensas", v99.f9, v99.f9, (seq(abs(0x3aa), i10  => (v20))) + v99.f9, v99.f9 + v99.f9, v99.f9 + v99.f9, "wmqrjxe", seq(abs(0xea), i11  => (v20)), v99.f9, "mg", v99.f9, v99.f9, v99.f9, v99.f9];
				v124[safeIndex(121, v124.Length)] := v99.f9;
				var v125: set<bool> := {p1};
				var v126: seq<bool> := [v125 <= v125, p1, p2];
				var v127 := DC17(v126[safeIndex(|v97|, |v126|) := p1]);
				globalState.f3, r0, v124[safeIndex(121, v124.Length)], v126 := safeDivisionInt(v99.f11, v99.f11), (-|v97| != v0) in {!p1}, (fm31(globalState))[safeIndex(v99.f11, |fm31(globalState)|) := 'j'], (if (p2) then [false, p2] else v127.cf19) + v126;
				var v128: map<int, bool> := map[v99.f11 := p2];
				v128 := map[safeModuloInt(v99.f11, v0) := p2];
				var v129: multiset<bool> := multiset{!p2};
				var v130 := DC29(p2, |v129|, v99.f10[safeIndex(v99.f11, |v99.f10|)], p2, |p0|);
				r0 := v130.cf35;
				...
				var v138 := new C1(v99.f11, safeDivisionInt(v0, |v137[safeIndex(v99.f11, |v137|)]|), v99.f11 + v99.f11, map[v94 := v94] + v99.f12, v99.f9 + "vfeh", v98);
				globalState.f3 := -0x5a;
			}
			...
			var v141 := new C0(-v0 == v99.f11, |v100| != v139.cf66, v99.f9[safeIndex(v0, |v99.f9|) := v20] + v99.f9[safeIndex(|"kvgf"|, |v99.f9|) := v20], [seq(abs(-434), i12  => (v99.f11)), [|v17|, v0, v99.f11, v99.f11], [|v17|, -v99.f11, |v99.f9|, v99.f11, v99.f11]] + v140[safeIndex(v99.f11, |v140|)]);
			f14[safeIndex(389, f14.Length)] := v141.f25;
			var v142 := "xhfe";
			r0, f14[safeIndex(389, f14.Length)], v142 := v0 != (if (p2) then v141.fm5(v99.f11, 106, globalState) else 0x167), v20 in (v142 + v142), "nj" + (v99.f9 + v99.f9);
			globalState.f3 := v99.f11;
			var v143: set<bool> := {v141.f26, v141.f25, v141.f26, p2 <==> !p2, p2};
			r0, globalState.f3, globalState.f3, r0 := -safeModuloInt(|v94|, v99.f11) == -0x31e, -|v143|, if (f14[safeIndex(389, f14.Length)]) then |v95| * v99.f11 else 0x14c, v141.f26;
			f14[safeIndex(389, f14.Length)] := f14[safeIndex(389, f14.Length)];
		}
		
		for i13 := 0x18f to v0 {
			f14[safeIndex(777, f14.Length)] := p1;
			var v144 := DC34(v0, v99.f11, v99.f11, p1);
			r0, f14[safeIndex(777, f14.Length)] := v144.cf46, p2;
			v17 := v17[v95 >= v95 := v0];
			var v145: array<int> := new int[13](i14 => safeDivisionInt(i14, v0));
			...
			v153[safeIndex(45, v153.Length)] := if (false) then v152 else v152;
			v145, v153[safeIndex(45, v153.Length)], globalState.f3 := v145, v152, -|((v99.f9 + v99.f9)[safeIndex(v99.f11, |(v99.f9 + v99.f9)|) := v20] + v99.f9)|;
			var v154: map<char, bool> := map[v20 := f14[safeIndex(777, f14.Length)]];
			v154 := DC63(v154).cf96;
		}
		r0 := p1;
		r1 := v99.f11 + v0;
...
class C10 extends T1 {
	...
	function fm6(globalState: GlobalState): char {
		if (!(f11 <= f13)) then f9[safeIndex(106, |f9|)] else 'k'
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: map<bool, string>, r2: bool, r3: int) {
		var v0 := false;
		if (v0) {
			...
			match (v20) {
				...
				case DC17(cf19) =>
					...
					r2 := v28 <= (v28 + v28);
					var v29: multiset<string> := multiset{seq(abs(0x174), i1  => (v10))};
					var v30 := DC22(v29);
					var v31 := DC24(v30);
					v31 := DC24(v30);
					globalState.f3 := f11;
				...
				case DC19(cf20) =>
					...
					v0 := v0 <== (f9 < fm37(|v11[safeIndex(fm0(p0, |map[v32 := |(seq(abs(0x1f8), i2  => (p0)))|]|, globalState), |v11|) := v0]|, |v11|, v0, p0, globalState));
					v32[safeIndex(729, v32.Length)] := -safeDivisionInt(f11, p0);
					v32[safeIndex(729, v32.Length)] := f13;
					var v33 := DC14(v32);
			...
			v37[safeIndex(300, v37.Length)] := v0;
			...
			v37[safeIndex(300, v37.Length)], v39, v43, v0, r2 := (v0 || v0) || !v0, v39, v43, f9 != "a", v0;
		}
		...
		if (v0 && fm22(v0, f13, globalState)) {
			...
			var v51: seq<T0> := [v50];
			var v52: seq<int> := [|v51|];
			var v53: array<int> := new int[20] [-0x2f7, -|v46|, p0, safeModuloInt(p0, f13), safeModuloInt(|v46|, -f11), p0 + |multiset{v0}|, safeDivisionInt(|v49|, p0), p0, safeDivisionInt(907, 0x198), f13, p0, f13, -|f9|, f11, |(v52 + v52)|, f13, |v52|, f13, f13, f11 * f11];
			...
			var v66: multiset<seq<bool>> := multiset{v64[safeIndex(p0, |v64|) := fm22(v0, |v65|, globalState)], v64};
			var v67: map<bool, seq<seq<int>>> := map[v66 != v66 := f10 + f10];
			v67 := v67[v0 := f10 + (seq(abs(0x358), i6  => (seq(abs(414), i7  => (p0)))))];
			var v68: array<int> := new int[14](i8 => safeModuloInt(i8, -|v64|));
			var v69 := DC14(v68);
			var v70: multiset<array<int>> := multiset{v69.cf17};
			var v71 := DC35(v70);
			var v72: map<D15, int> := map[v71 := p0];
			v72 := v72[v71 := safeDivisionInt(f13, f13)];
			var v73: array<bool> := new bool[6] [v63.f26, v63.f25, v0, fm8(f13, v63.f25, v63.f25, globalState), v63.f25, v63.f26];
			var v74 := new C9(v73);
		}
		
		var v76: multiset<int> := multiset{|(set v75 : int | (999 <= v75) && (v75 < 0x38) :: (safeDivisionInt(v75, |{-0x2d2}|)))|, p0};
		if (v76 >= multiset(seq(abs(660), i9  => (p0)))) {
			var v77: array<bool> := new bool[20];
			var v78: array<char> := new char[26];
			var v79 := DC13(v78);
			var v80: map<int, D6> := map[f13 := v79];
			v77[safeIndex(243, v77.Length)] := !(|v80| <= f13);
			var v81: seq<bool> := [v0];
			v77[safeIndex(243, v77.Length)] := multiset{v0} >= multiset(v81);
			r3 := 107 - p0;
			var v82 := "lqfxdl";
			var v83: array<string> := new string[8] [v82, f9, f9, if (v0) then v82 else f9, f9, f9 + f9, f9, f9 + f9];
			var v84: map<bool, int> := map[v0 := f11];
			var v85: map<int, bool> := map[if (v77[safeIndex(243, v77.Length)] in v84) then v84[v77[safeIndex(243, v77.Length)]] else p0 := v77[safeIndex(243, v77.Length)]];
			var v86 := 't';
			var v87: multiset<char> := multiset{v86, v86};
			v83[safeIndex(51, v83.Length)] := if (if ((if (v86 in v87) then v87[v86] else p0) in v85) then v85[if (v86 in v87) then v87[v86] else p0] else v77[safeIndex(243, v77.Length)]) then f9 else v82;
			v82, v81, v83, v82, v83[safeIndex(51, v83.Length)] := v82, v81, v83, v82 + "ccvj", "sdqwgmr";
			var v88: seq<int> := [p0];
			var v89: T1 := new C6(|v82|, f12, f9, [v88]);
			globalState.f3, v89 := DC54(p0, p0).cf80, v89;
			var v90: map<int, int> := map[fm0(v89.fm5(v88[safeIndex(f13, |v88|)], |v84|, globalState), v89.f11, globalState) := f13];
			v90 := v90[safeDivisionInt(0x384, |v88|) := p0];
		} else {
			var v91 := "giaoojal";
			...
			globalState.f3 := f11;
			var v93: seq<int> := [f13];
			r0 := safeModuloInt(|(v93 + fm44(v0, p0, v0, globalState))|, -0x39e);
			globalState.f3 := -p0;
			var v94: array<bool> := new bool[10];
			var v95: seq<array<bool>> := [v94, v94];
			if (v95 < v95) {
				f13 := safeDivisionInt(|[v0]|, -p0);
				r2 := !v0;
				v0 := !v0;
				var v96 := DC15(v76);
				v96 := v96;
				...
				v0 := (-|v102| - f11) != safeDivisionInt(p0, 0x3df);
			}
		...
		match (v104) {
			case DC2() =>
				if (v0) {
					...
					v116 := [seq(abs(0x208), i11  => (|multiset{v0, false, v0, !v0}|)), v115 + [f13, f11, f11], (seq(abs(0x23e), i12  => (p0))) + v115, v115];
					m4(p0, globalState);
					v0 := v0;
					globalState.f3 := f11 - (if (v0) then f11 else |f9|);
				}
				
				var v117 := new C0(v0, if (v0) then !v0 else v0, f9, (seq(abs(-0xb1), i13  => ([p0]))) + f10);
				...
				var v123 := DC47(v117.f25, |v121[safeIndex(|v122|, |v121|)]|, v117.f26);
				match (v123) {
					case DC47(cf65, cf66, cf67) =>
						r3 := f11;
						...
						var v129: seq<bool> := [v128[safeIndex(0x16e, |v128|)]];
						var v130 := 'q';
						...
						var v133: array<seq<int>> := new seq<int>[18] [if (v117.f25) then v124 else v124, v124 + (seq(abs(-0x88), i14  => (|f9|))), v124 + [|v127|, f11], if (v131 in v132) then v132[v131] else v124, v124 + f10[safeIndex(|v124|, |f10|)], v124, v124, v124, v124, v124 + v124, [p0, p0], v124, v124, v124, v124, [p0, p0], v124, v124 + [cf66, p0]];
						v133[safeIndex(865, v133.Length)] := v124 + v124;
						v133[safeIndex(865, v133.Length)] := v124[safeIndex(f11, |v124|) := f11] + v124;
						v0 := v0;
					...
					case DC48(cf68, cf69, cf70) =>
						...
						v137[safeIndex(974, v137.Length)] := multiset(v138);
						var v139 := DC40(f9, v117.f25, -f13);
						var v140 := DC34(p0, |v138|, f11, v0);
						var v141: map<D17, int> := map[v139 := v140.cf44];
						v137[safeIndex(974, v137.Length)] := multiset{|v141|};
						var v142: map<seq<D4>, int> := map[fm72(globalState) := f13];
						var v143 := DC2();
						var v144 := DC9(v143);
						v142 := v142[[v144] := p0];
						var v145: seq<bool> := [v0];
						r3 := if (v145[safeIndex(f11, |v145|)]) then f13 else f11;
					case DC46(cf64) =>
						var v146 := "huqeb";
						v146 := f9;
						var v147: T1 := new C1(safeModuloInt(p0, f11), safeDivisionInt(f13, 0x52), p0, f12, v146, f10 + f10);
						v147 := v147;
						var v148: map<bool, int> := map[true := 0x2ea];
						var v149: seq<int> := [|v148|];
						f13 := v149[safeIndex(v149[safeIndex(f11, |v149|)], |v149|)];
			...
			case DC1(cf1) =>
				...
				if (({p0} !! v162) || v0) {
					...
					var v164 := DC22(v163[f9 := abs(f13)]);
					var v165: seq<bool> := [v0];
					var v166: array<D10> := new D10[3] [v164, v164, fm73(v165[safeIndex(|v165|, |v165|)], globalState)];
					var v167: set<bool> := {!fm8(f13, true, v165[safeIndex(f11, |v165|)], globalState)};
					...
					v168[safeIndex(990, v168.Length)] := v169 < v169;
					globalState.f3, globalState.f3, v166, r0, v168[safeIndex(990, v168.Length)] := f11, f13, v166, f13, false <==> v0;
					var v170: map<seq<bool>, array<int>> := map[v165 := v155];
					var v171 := DC14(v155);
					v170 := v170[v165 := (v171.(cf17 := v155)).cf17];
					v168[safeIndex(990, v168.Length)] := !v0;
					var v172: array<map<bool, int>> := new map<bool, int>[28](i17 => DC39(map[v0 := f11]).cf53);
					var v173: map<bool, int> := map[v0 := p0];
					v172[safeIndex(841, v172.Length)] := fm42(v173, v0, p0, v168[safeIndex(990, v168.Length)], globalState);
					v172[safeIndex(841, v172.Length)] := v173 + v173;
					v168[safeIndex(990, v168.Length)] := v0;
				} else {
			...
			case DC3(cf2) =>
				...
				f13 := safeDivisionInt(p0, p0) - 0x393;
	...
	method m3(p0: int, p1: string, p2: int, p3: D0, globalState: GlobalState) returns (r0: array<array<bool>>, r1: array<int>) {
		...
		var v4: seq<int> := [f11];
		var v5 := new C7(f9, (f10 + fm41(v1, v1, v1, globalState))[safeIndex(|p1|, |(f10 + fm41(v1, v1, v1, globalState))|) := v4], if (!v1) then p0 else f11, DC69(f12).cf108);
		globalState.f3 := p2;
		var v6: seq<bool> := [v1];
	...
	method m1(p0: int, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: array<int>, r3: int) {
		...
		var v1: seq<C7> := [v0];
		var i0 := 0;
		while (!(v1[safeIndex(f13, |v1|)] !in v1))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			i0 := i0 + 1;
			var v2 := false;
			var v3 := DC47(v2, |(seq(abs(-0xc0), i1  => ('v')))|, v2);
			var v4: seq<int> := [f11];
			var v5: map<D20, int> := map[v3 := |multiset(v4)|];
			r3 := if (v3 in v5) then v5[v3] else -p1;
			var v6: array<int> := new int[14];
			r2 := v6;
			var v7 := new C6(f11, f12, f9, f10 + [(seq(abs(799), i2  => (0x65)))[safeIndex(f11, |(seq(abs(799), i2  => (0x65)))|) := f11], v4, v4]);
			var v8 := 'v';
			var v9 := DC12(v8);
		...
		var v12 := false;
		var v13: map<int, bool> := map[safeDivisionInt(f11, p2) := v12];
		v13 := v13[p0 := v12];
		var v14 := 'm';
		var v15: seq<int> := [--p1];
		var v16: T0 := new C7(f9[safeIndex(-0x277, |f9|) := v14], f10, v15[safeIndex(749, |v15|)], f12);
		var v17: seq<T0> := [v16, v16];
		var v18: seq<T0> := [v16, v16, v17[safeIndex(p0, |v17|)], if (v12) then v16 else v16];
		...
		for i3 := f13 to p1 {
			...
			v26[safeIndex(978, v26.Length)] := v12;
			v26[safeIndex(978, v26.Length)] := v12;
		}
		...
		var v38: array<int> := new int[20] [|v35|, f13, |v16.f9|, fm0(v28.f15, p0, globalState) + p0, v28.f15, p2, 0x21, |v36[f11 := abs(f13)]|, f13 - v28.f15, 0x9f, p2 * fm5(|fm1(p0, p2, globalState)|, |map[v12 := v12]|, globalState), p0, p1, if (v28.f16) then f13 else p0, f11, p1, f11 * |v15|, f13, if (-p0 in v37) then v37[-p0] else v28.f15, v28.f15];
		r2 := v38;
	...
	method m4(p0: int, globalState: GlobalState) {
		...
		if (v0) {
			if (true) {
				...
				v6[safeIndex(533, v6.Length)] := v1 < v1;
				...
				v5, globalState.f3, globalState.f3, v6[safeIndex(533, v6.Length)], v9 := v5 + map[([v0])[safeIndex(p0, |[v0]|) := v0] := v4], v11.cf36, safeDivisionInt(p0, -f13), v13[safeIndex(p0, |v13|)] >= v12, [p0, fm5(f11, p0, globalState), f13];
				globalState.f3 := f13;
				v6 := v6;
				...
				v15[safeIndex(561, v15.Length)] := safeModuloInt(if (f13 in v17) then v17[f13] else -p0, f13);
				v15[safeIndex(561, v15.Length)] := -0x55 * |v4|;
			} else {
				var v18: seq<bool> := [v0];
				var v19: seq<int> := [|v18|, f11];
				var v20 := DC42(v0, 617);
				var v21: set<int> := {v20.cf59};
				var v22 := new C4(v0, v0, f9 + "owf", [[f11, f11], v19[safeIndex(|v21|, |v19|) := p0], (fm44(!v0, f13, v0, globalState))[safeIndex(p0, |fm44(!v0, f13, v0, globalState)|) := p0]]);
				v22.f20 := v22.f19;
				v0 := v22.f20;
				v22.f20 := fm22(v0, 0x313, globalState);
				var v23 := 'b';
				var v24: map<int, int> := map[f13 := |"g"|];
				var v25: array<char> := new char[26] [v23, 'y', v23, if (DC47(v22.f20, -|v24|, false).cf67) then v23 else v23, v23, v23, v23, v23, if (v22.f20) then v23 else v23, v23, v23, v23, 'l', v23, f9[safeIndex(-f11, |f9|)], v23, v23, v23, v23, v23, v23, v23, if (v0) then v23 else v23, v23, v23, fm6(globalState)];
				v25 := v25;
			}
			...
			if (if ((f11 - p0) in v34) then v34[f11 - p0] else v0) {
				var v35 := 'a';
				var v36: map<string, string> := map[(fm31(globalState))[safeIndex(|f9[safeIndex(p0, |f9|) := v35]|, |fm31(globalState)|) := v35] := (f9 + f9)[safeIndex(p0, |(f9 + f9)|) := v35]];
				var v37: seq<bool> := [false];
				globalState.f3, v36, globalState.f3 := |f9|, v36, (|v37| * f11) * (f13 - -f11);
				var v38 := new C2(safeModuloInt(f11, f13), f12, f9, fm41(v0, v0, false, globalState));
				var v39: array<multiset<int>> := new multiset<int>[5](i2 => multiset{p0, p0});
				var v40: multiset<int> := multiset{f11};
				v39[safeIndex(127, v39.Length)] := v40;
				v39[safeIndex(127, v39.Length)] := v40 - v40;
				var v41 := "xyv";
				...
				var v51: seq<int> := [|v50|];
				var v52: array<int> := new int[17] [f13, -f11, p0, f13, p0, |(seq(abs(0x94), i3  => (f13)))|, p0, p0, |v41|, |"ak"|, |v45| - |v47|, 172, if (!v0) then |v49| else v51[safeIndex(f11, |v51|)], f13, |(v41 + f9)|, fm0(f13, f11, globalState), f11];
				v52[safeIndex(795, v52.Length)] := f11;
				globalState.f3, v41, v52[safeIndex(795, v52.Length)] := f13, ("xdtkw" + v41) + v41, 0x30;
				...
				var v63: array<bool> := new bool[23] [v0 <== v0, !v0, v0, v0, (multiset{!false})[!v0 := abs(p0)] !! v54, v56 == v56, true || v0, v0, v59 != v59['i' := p0], v0, !false, v0, v0, v0, v0 <==> false, v0, f9 != f9[safeIndex(f13, |f9|) := v57], (set v61 : set<int> | v61 in v60 :: (v61)) !! {v55, v55, v55, v55, v55}, fm13(v0, p0, if (v0 in v62) then v62[v0] else f9, globalState), true, v0, v0, true];
				v63[safeIndex(652, v63.Length)] := v0;
				...
				var v68: C7 := new C7(f9, seq(abs(0x233), i4  => (seq(abs(-0x1fa), i5  => (f13)))), f13, f12);
				...
				globalState.f3, v63[safeIndex(652, v63.Length)], globalState.f3, v67, v64.f20 := p0, if (f11 in v34) then v34[f11] else v64.f19, f13, v67[safeIndex(f13, |v67|) := v0], v72 > multiset{v71};
				v63[safeIndex(652, v63.Length)] := v64.f20;
			}
			...
			v77[safeIndex(532, v77.Length)] := v0;
			v77[safeIndex(532, v77.Length)] := v0;
			var v78 := DC42(v0, p0);
			var v79: seq<D18> := [v78, v78];
			var v80: map<bool, bool> := map[v77[safeIndex(532, v77.Length)] := v0];
			v79 := v79[safeIndex(f13 + p0, |v79|) := DC42(v0, |v80[fm38(|(seq(abs(0x18c), i6  => ('h')))|, globalState) := v77[safeIndex(532, v77.Length)]]|)];
		}
		
		var v81 := 'h';
		var v82: map<bool, bool> := map[true := v0];
		var v83 := DC64(v82, v0, p0, seq(abs(-0x23f), i8  => (f13)), f11);
		...
		forall i7 | 0 <= i7 < v84.Length {
			v84[i7] := |(map[f13 := map[DC22(multiset{seq(abs(0xbb), i9  => (v81)), f9[safeIndex(-f13, |f9|) := v81], f9}) := |{v0, v0, v0}|]] + map[f13 := map[DC22(multiset{f9, seq(abs(0x341), i10  => (v81))}) := p0]])| <= |((map v85 : int | (-201 <= v85) && (v85 < 0x1e1) :: (v85 + |f9[safeIndex(0x17e, |f9|) := v81]|) := (v0)) + map[150 := v0])|;
		}
		var v86: seq<bool> := [v0];
		v86 := v86;
		var i11 := 0;
		...
		if (if (v0) then p0 <= f13 else v0) {
			var v87: array<int> := new int[1](i12 => safeModuloInt(i12, f11));
			v87[safeIndex(990, v87.Length)] := p0;
			v87[safeIndex(668, v87.Length)] := f13;
			var v88: multiset<int> := multiset{f13 * -f11};
			var v89 := DC18();
			v0, f13, v87[safeIndex(990, v87.Length)], v87[safeIndex(668, v87.Length)], v88 := v0 && (v0 <== v0), f13, -p0 - p0, |fm74(v89, multiset(v86 + v86), v86[safeIndex(f11, |v86|)], globalState)|, v88 + v88;
			f13 := p0;
			globalState.f3 := f11;
			var v90 := DC7(v0);
			match (v90.(cf9 := fm0(p0, f11, globalState) >= f11)) {
				case DC7(cf9) =>
					...
					var v94: T1 := new C7(f9, f10, 200, map[map[p0 := v87[safeIndex(990, v87.Length)]] := v93]);
					v91[safeIndex(993, v91.Length)] := v94;
					v91[safeIndex(993, v91.Length)] := v94;
					var v95: map<bool, int> := map[false := p0];
					v0 := safeDivisionInt(f13, v87[safeIndex(990, v87.Length)]) != fm5(fm5(|f9|, |v95|, globalState), p0, globalState);
					var v96: seq<int> := [v94.f11];
					var v97: map<int, bool> := map[0x1f3 := v0];
					var v98: array<seq<int>> := new seq<int>[14] [v96, v96, v96 + v96, v96, [v87[safeIndex(990, v87.Length)], v94.fm5(v94.f11, 0x241, globalState)], v96, [v87[safeIndex(990, v87.Length)], p0, |v97|, f13], [f11, 0x26e, p0], v96, v96, [|v97|, |(seq(abs(0x24b), i13  => (v81)))|, f11], v96, v96, v96];
					v98[safeIndex(377, v98.Length)] := v96;
					var v99: multiset<bool> := multiset{cf9, cf9};
					v98[safeIndex(377, v98.Length)] := [v87[safeIndex(990, v87.Length)], f13, v87[safeIndex(990, v87.Length)], if (v0) then -|v95| else |multiset(v96)|, -safeDivisionInt(if (!cf9 in v99) then v99[!cf9] else f13, v94.f11)];
					v87[safeIndex(990, v87.Length)] := |fm44(cf9, -0xb7, !!(v87[safeIndex(990, v87.Length)] != v87[safeIndex(990, v87.Length)]), globalState)|;
				case DC6(cf8) =>
					var v100: seq<string> := ["frgutkyq", seq(abs(449), i15  => ('w'))];
					var v101: array<string> := new string[15] [f9, seq(abs(-0x112), i14  => (v81)), v100[safeIndex(517, |v100|)], f9, f9, f9 + f9, f9, f9, fm37(-0x382, v87[safeIndex(990, v87.Length)], v0, p0, globalState), f9[safeIndex(f11, |f9|) := v81], "mbprxsgwh", f9, "leunq", (seq(abs(0x6), i16  => (v81))) + f9, f9];
					v101 := v101;
					var v102 := "fvcmat";
					v102 := v102;
					var v103: seq<int> := [|v102|];
					var v104: map<seq<int>, int> := map[v103 := f13];
					v87[safeIndex(990, v87.Length)] := -(safeModuloInt(|v100|, f11) - |v104|);
					var v105: set<array<int>> := {v87, v87, v87, v87};
					v105 := (v105 * v105) * v105;
			}
			
			v87[safeIndex(990, v87.Length)], f13, v0, v0, v87[safeIndex(990, v87.Length)] := safeModuloInt(p0, v87[safeIndex(990, v87.Length)]), (p0 * |v82|) + safeDivisionInt(p0, v87[safeIndex(990, v87.Length)]), v0, false, if (v0) then |f9| else if (f13 in v88) then v88[f13] else f11;
		} else {
			v81 := v81;
			var v106 := "idid";
...
class C11 {
	...
	method m0(p0: bool, p1: int, p2: array<int>, p3: bool, globalState: GlobalState) returns (r0: map<int, bool>) {
		p2[safeIndex(4, p2.Length)] := f8 - p1;
		var v0 := "vq";
		p2[safeIndex(4, p2.Length)] := |v0|;
		var v1 := false;
		v1 := !p3;
		var v2: array<bool> := new bool[8];
		v2[safeIndex(679, v2.Length)] := !(p3 ==> !p3);
		v2[safeIndex(679, v2.Length)] := v1;
		globalState.f3 := -p1;
		v2[safeIndex(679, v2.Length)] := p0;
		var v3: seq<bool> := [true, p3];
		var v4 := DC0(v0);
		for i0 := |v3| - |map["ftg" := v4]| to f8 {
			var v5: set<bool> := {p3};
			var v6: seq<set<bool>> := [v5, v5, v5, {p0}];
			var v7: map<int, int> := map[|"xkyu"| := -p2[safeIndex(4, p2.Length)]];
			var v8 := DC4(p1);
			var v9: map<map<int, int>, map<int, int>> := map[v7 := map[fm0(v8.cf3, i0, globalState) := i0]];
			var v10 := 'y';
			var v11: seq<int> := [f8, --f8, f8];
			var v12: seq<seq<int>> := [v11, v11, fm44(v2[safeIndex(679, v2.Length)], v8.cf3, p3, globalState), seq(abs(-0x140), i1  => (p2[safeIndex(4, p2.Length)])), v11];
			var v13 := new C10(|v6[safeIndex(f8, |v6|)]|, i0, v9, v0[safeIndex(f8, |v0|) := v10], v12);
			p2[safeIndex(4, p2.Length)] := |[i0]|;
			if (|v0| >= (f8 + p2[safeIndex(4, p2.Length)])) {
				v1 := if (v2[safeIndex(679, v2.Length)]) then !!v1 else fm22(v1, p1, globalState);
				v0 := "svtrbss";
				v2[safeIndex(679, v2.Length)] := fm2(v0, 0x169, globalState) != [!v1, p3];
				var v14: array<seq<int>> := new seq<int>[17] [v11, v11, v11, v11, v11, v11, v11, [0xfe], v11, v11, v11, fm44(v1, f8, v1, globalState), v11, seq(abs(0x5f), i2  => (p2[safeIndex(4, p2.Length)])), [v13.f13], v11, v11];
				var v15 := DC53(v14, f8);
				...
				v2[safeIndex(679, v2.Length)] := (if (v2[safeIndex(679, v2.Length)]) then fm16(p2[safeIndex(4, p2.Length)], v1, |v17|, globalState) else v18) !! v18;
			} else {
				var v19 := new C2(p2[safeIndex(4, p2.Length)], v9, v0, v12);
				var v20: array<char> := new char[10] [if (v1) then v10 else 'u', v10, v10, v10, v10, v10, v10, v10, v10, v10];
				v20[safeIndex(18, v20.Length)] := v10;
				v20[safeIndex(18, v20.Length)], v13.f13, p2[safeIndex(4, p2.Length)], globalState.f3 := v10, v13.f13, safeDivisionInt(p2[safeIndex(4, p2.Length)], i0 * f8), f8 * f8;
				var v21 := new C9(v2);
				v0 := v0;
				v2[safeIndex(679, v2.Length)] := v1;
			}
			...
			var v23 := DC43(v3[safeIndex(|v0[safeIndex(0xb2, |v0|) := v10]|, |v3|)], i0);
			v2[safeIndex(679, v2.Length)] := if (v23.cf60 in v22) then v22[v23.cf60] else v1;
		}
		r0 := (f7 + f7) + f7;
	}
}
...
function fm8(p0: int, p1: bool, p2: bool, globalState: GlobalState): bool {
	!match DC23('i', {multiset{|(map v0 : int | (0x3b3 <= v0) && (v0 < 0x20a) :: (v0 + 150) := (true))|}, multiset{-591}}) {
		...
		case DC24(cf28) => !([0x4f, -0x315, 0xb8] != (seq(abs(0x9e), i0  => (|"n"|))))
	}
}
...
function fm10(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): multiset<int> {
	multiset{safeDivisionInt(|(seq(abs(133), i0  => (0x1f3)))|, |map[false := -86]|), |"al"| + |multiset{true}|, 353}
}
...
function fm12(p0: string, p1: char, p2: int, globalState: GlobalState): map<seq<int>, bool> {
	(map v0 : seq<int> | v0 in multiset{seq(abs(0x108), i0  => (0x1f3))} :: (v0) := (false)) + map[[|map[|map[true := |multiset{|(set v1 : int | v1 in multiset{0xf9, 0x13f} :: (safeModuloInt(v1, |{!true}|)))|, 484}|]| := true]|] := !true]
}
function fm13(p0: bool, p1: int, p2: string, globalState: GlobalState): bool {
	(|map["bajccy" := |[true, !false]|]| < |[map[0xd1 := !false]]|) && ((set v1 : int | v1 in (map v0 : int | (-0x83 <= v0) && (v0 < 215) :: (safeModuloInt(v0, -|[true]|)) := (map[false := false])) :: (v1 + |map[false := true]|)) >= {|{|{|['q']|}|}|})
}
function fm14(p0: char, p1: bool, globalState: GlobalState): map<int, int> {
	((map v0 : int | (0x25f <= v0) && (v0 < -661) :: (safeDivisionInt(v0, -242)) := (|map[false := 0x4]|)) + map[|map[0x16d := -|map[|"qle"| := 0x1fc]|]| := |(seq(abs(0xe7), i0  => ('m')))|]) + map[0x86 := |[-|"mkuy"|]|]
}
...
function fm28(p0: int, p1: seq<bool>, globalState: GlobalState): D0 {
	DC0("pfhckddj" + (seq(abs(0x328), i0  => ('x'))))
}
function fm31(globalState: GlobalState): string {
	"x"
}
function fm32(p0: int, p1: bool, globalState: GlobalState): multiset<string> {
	(multiset(["smuuw"]) - multiset{"rgxqmv", seq(abs(-33), i0  => ('m')), "kaql", "axecgxsb", "f"}) * (multiset{"dkadtamt", seq(abs(0x5a), i1  => ('o')), seq(abs(0x2ed), i2  => ('h')), seq(abs(-0x3c5), i3  => ('l')), "cheyv"} - multiset(["smc", "qvjngnya"]))
}
function fm33(p0: map<bool, int>, globalState: GlobalState): seq<seq<bool>> {
	match DC41(multiset{false, false}) {
		case DC42(cf58, cf59) => seq(abs(0x341), i0  => ([cf58]))
...
function fm39(p0: D7, p1: bool, globalState: GlobalState): char {
	match DC40("yrblsbu", true, |map[|(seq(abs(913), i0  => ('n')))| := true]|) {
...
function fm41(p0: bool, p1: bool, p2: bool, globalState: GlobalState): seq<seq<int>> {
	([[|(seq(abs(0x39f), i0  => ('s')))|, |[false, false]|]] + (seq(abs(0x133), i1  => ([0x391, |map[true := -|multiset{'x', 'l'}|]|])))) + ([seq(abs(918), i2  => (691))] + [[|[false, true]|, |[false, false]|]])
}
...
function fm46(globalState: GlobalState): map<int, bool> {
	map[|map[-0x91 := seq(abs(261), i0  => ('n'))]| := false] + (map v0 : int | (0x193 <= v0) && (v0 < 0x3a7) :: (v0 * |multiset{false}|) := (!true))
}
function fm47(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<map<int, int>, map<int, int>> {
	(map[map v0 : int | v0 in (set v1 : int | (-757 <= v1) && (v1 < 0x291) :: (safeDivisionInt(v1, --0x1e5))) :: (safeDivisionInt(v0, -0x3a6)) := (|(seq(abs(218), i0  => (0x349)))|) := map[-0x25e := |map[false := 111]|]] + (map v2 : map<int, int> | v2 in map[map[|"rikrnkyb"| := |[-74]|] := false] :: (v2) := (map[|map[true := false]| := -0x2e3]))) + (map[map[-620 := |multiset{|[false, true]|}|] := map[-0x186 := |(seq(abs(0x19a), i1  => ('t')))|]] + (map v3 : map<int, int> | v3 in {map[0x3aa := 0x170], map[|(seq(abs(268), i2  => (|map[true := true]|)))| := |[false]|], map v4 : int | (-0x320 <= v4) && (v4 < 0x13b) :: (v4 + |map[0x39 := |"ynysll"|]|) := (316)} :: (v3) := (map v5 : int | (-76 <= v5) && (v5 < -0x77) :: (v5 * 556) := (339))))
}
...
function fm49(p0: bool, p1: bool, p2: bool, globalState: GlobalState): map<string, bool> {
	map["ne" := false] + map[seq(abs(-566), i0  => ('p')) := true]
}
...
function fm53(globalState: GlobalState): multiset<int> {
	multiset{-463} - (multiset{--|[|[0x159]|]|, |(seq(abs(-27), i0  => (-0x274)))|, |map[|[-|map[|map[-429 := 0x80]| := |map[false := -0x2e4]|]|, 0x25d, 0x16]| := |[|(seq(abs(0x2d0), i1  => ('x')))|]|]|} + multiset{0xe5, -372, 0x3a8, |[|[true]|]|, |(seq(abs(0x29d), i2  => (0x371)))|})
}
function fm54(p0: int, p1: int, globalState: GlobalState): D4 {
	DC11({|multiset{906, |multiset{set v0 : int | (0x132 <= v0) && (v0 < -44) :: (safeDivisionInt(v0, 0x20))}|, |map[!true := 0x2e8]|, 476, |{true}|}|} >= {|{!false}|}, |"efvmiht"|)
}
...
function fm56(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState): D17 {
	DC39(map[false := |"adbfyy"|] + map[DC21(DC6({0x3c5}), 'w', false).cf24 := |(set v0 : int | (0x243 <= v0) && (v0 < 0x88) :: (safeModuloInt(v0, 963)))|])
}
...
function fm60(p0: int, globalState: GlobalState): multiset<set<bool>> {
	match DC33(0x1ad, seq(abs(0x28f), i0  => ('d')), !!false) {
		...
		case DC32(cf39) => multiset{{cf39.f26}} - multiset(seq(abs(0x4e), i1  => ({cf39.f25})))
	}
}
function fm61(p0: char, p1: bool, globalState: GlobalState): set<string> {
	({seq(abs(771), i0  => ('d')), "jygawouda", "dnyrafmlm", "ibmng", "d"} - {seq(abs(0x34), i1  => ('e'))}) - {"hcwf", "tnlmfd"}
}
...
function fm65(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<int, seq<char>> {
	DC88(map[759 := ['g']]).cf135 + map[|[0x3e2]| := seq(abs(0x107), i0  => ('o'))]
}
...
function fm67(p0: string, globalState: GlobalState): set<map<bool, int>> {
	({map[false := |[map[-227 := -0x2de]]|]} - {map[true := |(seq(abs(145), i0  => (-0x14d)))|], map[false := |(seq(abs(0x33), i1  => (426)))|]}) * {map[false := 613], map[true := |[true]|], map[true := 0x222]}
}
...
function fm77(p0: int, p1: int, p2: int, p3: string, globalState: GlobalState): multiset<seq<int>> {
	multiset{if (true) then [|map['x' := !false]|] else [-|[-0xf4]|], seq(abs(25), i0  => (-|"uwanxmr"|)), [|"igo"|], seq(abs(0x107), i1  => (0x233)), [|[0x1c5]|]}
}
...
method m19(p0: int, p1: char, globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: seq<string>) {
	...
	if (v0) {
		...
		var v12: seq<bool> := [v0];
		var v13 := DC65(v0, v7[safeIndex(p0, |v7|) := p1], v12);
		...
		if (v0) {
			...
			var v31: map<C3, seq<bool>> := map[v27 := v29[safeIndex(|v30|, |v29|)]];
			var v32 := DC82(v31);
			v0, globalState.f3, v31 := v0, p0, v32.cf125;
			var v33: array<int> := new int[22];
			v33[safeIndex(593, v33.Length)] := -0x21f;
			...
			r0, v33[safeIndex(593, v33.Length)], globalState.f3, globalState.f3 := v27.f21 ==> v27.f21, if (v0) then p0 else -|v34|, v27.f22, if (v36 in v37) then v37[v36] else |([map[p1 := fm78(v27.f22, p0, p0, v27.f22, globalState)]] + v39)|;
			v33[safeIndex(593, v33.Length)] := -v27.f22;
			var v40: multiset<bool> := multiset{v0};
			globalState.f3 := safeModuloInt(|v40|, safeModuloInt(v33[safeIndex(593, v33.Length)], p0));
			v28 := v28 + v28;
		} else {
			var v42 := "wp";
			...
			v50[safeIndex(960, v50.Length)] := v0;
			v50[safeIndex(960, v50.Length)] := v0;
			globalState.f3 := p0;
			var v51: map<bool, int> := map[false := safeDivisionInt(p0, p0)];
			v51 := v51[if (!v0) then v50[safeIndex(960, v50.Length)] else v0 := -p0];
			var v52: multiset<bool> := multiset{v50[safeIndex(960, v50.Length)], v0, v50[safeIndex(960, v50.Length)], v50[safeIndex(960, v50.Length)]};
			var v53: array<array<D1>> := new array<D1>[19];
			var v54 := new C5(|(v52 - fm36(p0, v50[safeIndex(960, v50.Length)], |map[v0 := p0]|, globalState))|, v53);
			var v55: map<bool, bool> := map[v0 := v0];
			var v56: array<int> := new int[25] [p0, -v54.f17, v54.f17, v54.f17, v46[safeIndex(v54.fm23(globalState), |v46|)], -(p0 + |map[!v50[safeIndex(960, v50.Length)] := p0]|), v54.f17, -(p0 - |v42|), v54.f17, v54.f17, safeModuloInt(552, -0x2f1), safeDivisionInt(v54.f17, p0), v54.f17, |v42|, |v42[safeIndex(412, |v42|) := p1]| - v54.f17, p0, 0x1bb, safeModuloInt(p0, 0x149), if (if (true in v55) then v55[true] else !v50[safeIndex(960, v50.Length)]) then p0 else v54.f17, p0, v54.f17, p0 - p0, p0, v54.f17, v54.f17];
			v56[safeIndex(814, v56.Length)] := -p0;
			v56[safeIndex(814, v56.Length)] := v54.f17 * v46[safeIndex(p0, |v46|)];
		}
		...
		var v63 := new C10(p0, p0, v59, "b" + v60, v62 + [v61, v61, seq(abs(-0x3b8), i0  => (0x18e)), v61]);
		r0 := fm38(safeDivisionInt(v63.f13, p0), globalState);
		...
		if (v65 >= (v65 * v65)) {
			...
			v70[safeIndex(161, v70.Length)] := v66;
			var v71: map<bool, int> := map[v0 := v63.f13];
			var v72: set<int> := {|[v0, false]|, p0, v63.f13, fm0(v63.f13, |v71|, globalState)};
			var v76: seq<map<int, int>> := [map v75 : int | (392 <= v75) && (v75 < 0x42) :: (safeModuloInt(v75, |v57|)) := (|[DC65(v0, v66.f9, v57)]|), v58];
			var v77: seq<map<int, int>> := [map v74 : int | v74 in v72 :: (v74 * p0) := (p0), v76[safeIndex(384, |v76|)]];
			var v78 := DC69(v59);
			v70[safeIndex(161, v70.Length)] := new C7(v66.f9 + v66.f9, v66.f10, |v72|, (map v73 : map<int, int> | v73 in v77 :: (v73) := (v58)) + v78.cf108);
			var v79: map<bool, map<map<int, int>, map<int, int>>> := map[!v0 := v59];
			var v80 := new C2(-0x3a9, if (v0 in v79) then v79[v0] else v59, v66.f9, v62[safeIndex(|fm2(v66.f9, v63.f13, globalState)|, |v62|) := seq(abs(0x169), i1  => (0xc1))]);
			v63.f13 := v63.f13;
			var v82: array<map<int, int>> := new map<int, int>[1](i2 => v58 + (map v81 : int | v81 in (seq(abs(657), i3  => (v63.f13))) :: (v81 + p0) := (v63.f13)));
			v82 := if (fm8(|v61|, fm8(v63.f13, v57[safeIndex(v63.f13, |v57|)], v0, globalState), v0, globalState)) then v82 else v82;
		} else {
			v0 := v0;
			var v83: array<C8> := new C8[26];
			var v84: map<bool, int> := map[v0 := p0];
			var v85: C8 := new C8(|v84|, !v0);
			v83[safeIndex(232, v83.Length)] := v85;
			v83[safeIndex(232, v83.Length)] := v85;
			...
			var v91: array<bool> := new bool[15] [(fm69(if ((seq(abs(-0x2ab), i4  => (DC12(DC21(DC6(DC6({v85.f15, p0}).cf8), p1, v0).cf23).cf15))) in v86) then v86[seq(abs(-0x2ab), i4  => (DC12(DC21(DC6(DC6({v85.f15, p0}).cf8), p1, v0).cf23).cf15))] else false, v60, globalState)).cf51, if (v87 in v88) then v88[v87] else v0, !(if (v0) then v85.f16 else v85.f16), v85.f16, !v85.f16, v90 != v90, p0 > v85.f15, v85.f16, if (v85.f16) then v85.f16 else v85.f16, 0x1d9 >= v63.f13, !!v85.f16, v0, v85.f16, !!fm22(v0, -0x35f, globalState), fm8(v85.f15, v0, v85.f16, globalState)];
			v91 := v91;
			var v92: array<char> := new char[13] [p1, 'f', p1, p1, p1, p1, p1, 'u', p1, p1, p1, p1, p1];
			v92[safeIndex(905, v92.Length)] := p1;
			v6[safeIndex(275, v6.Length)] := v1 + v1;
			v87[safeIndex(298, v87.Length)] := false;
			v92[safeIndex(905, v92.Length)], v0, r0, v6[safeIndex(275, v6.Length)], v87[safeIndex(298, v87.Length)] := 'g', v0, !fm38(0x2c9, globalState), fm51(!v0, safeDivisionInt(v63.f13, v85.f15), p1, v0, globalState), !v85.f16;
			var v93 := new C0(v0, v87[safeIndex(298, v87.Length)], v60, DC87(v62).cf134);
		}
		...
		decreases 100 - i5
	{
		...
		var v95: seq<int> := [-p0];
		v94 := v94[-(v95[safeIndex(p0, |v95|)] * p0) := p0];
		...
		match (DC35(v97 + v97)) {
			case DC36(cf48) =>
				...
				v101[safeIndex(315, v101.Length)] := !v102[safeIndex(318, |v102|)];
				v101[safeIndex(315, v101.Length)] := v0;
			case DC37(cf49, cf50, cf51) =>
				var v103: set<int> := {-144, cf49};
				var v104 := "bhutlkcul";
				var v105: seq<seq<int>> := [v95, v95];
				var v106: C0 := new C0(v0, cf51, v104, v105);
				var v107: map<bool, char> := map[v103 > v103 := v104[safeIndex(|multiset([v106])|, |v104|)]];
				var v108: seq<bool> := [v0, (seq(abs(-0x110), i6  => (p1))) <= v104];
				var v109: array<string> := new string[20];
				v109[safeIndex(416, v109.Length)] := "f";
				var v110 := DC6(v103 - v103);
				var v111 := DC65(v0, v104, v108);
				v107, v108, v109[safeIndex(416, v109.Length)], v110 := fm35(cf49 - p0, cf49, globalState), v111.cf104 + (v108 + v108), v104 + ("hrnx" + v104[safeIndex(|v104|, |v104|) := p1]), v110.(cf8 := v103);
				var v112: array<char> := new char[1];
				var v113 := DC13(v112);
				var v114: C4 := new C4(v106.f26, cf51, "golpgbcr", v105);
				var v115: seq<C4> := [v114, v114];
				globalState.f3, v113, v96 := |v115| + safeModuloInt(|v109[safeIndex(416, v109.Length)][safeIndex(p0, |v109[safeIndex(416, v109.Length)]|) := p1]|, cf49), DC13(v112), v96;
				cf51 := cf51;
				globalState.f3 := |fm55(safeModuloInt(cf49, cf49), globalState)|;
			case DC35(cf47) =>
				...
				v116[safeIndex(848, v116.Length)] := v0;
				var v117 := DC2();
				...
				v96[safeIndex(48, v96.Length)] := safeDivisionInt(p0, |v121|);
				v0, v0, v116[safeIndex(848, v116.Length)], v96[safeIndex(48, v96.Length)] := v0, if (v0) then v0 else v0, v0, |(if ((if (v120.f17 in v94) then v94[v120.f17] else DC33(-0x1ab, seq(abs(0xd), i8  => (p1)), v0).cf40) > v120.f17) then {v0, v0} else v1 + v1)|;
				v1 := v1 - (v1 * v1);
		}
		...
		v122[safeIndex(793, v122.Length)] := v125;
		v122[safeIndex(793, v122.Length)] := v125 + (v125 + v125);
		var v126 := "mnfmt";
		...
		var v134 := new C7(v126, v128 + (seq(abs(0x12e), i9  => (v95))), p0, if (v0) then v129 else v133[safeIndex(251, |v133|)]);
	}
	var v135: array<bool> := new bool[26];
	v135[safeIndex(733, v135.Length)] := v0;
	var v136: array<D21> := new D21[18];
	var v137 := "gjhnucbss";
	var v138: set<char> := {p1, 'e', 'i', v137[safeIndex(p0, |v137|)]};
	var v139 := DC51(DC49(v138));
	v136[safeIndex(364, v136.Length)] := v139;
	v135[safeIndex(733, v135.Length)], globalState.f3, v136[safeIndex(364, v136.Length)], globalState.f3 := v0, if (!v0) then p0 - p0 else |(v137 + v137)|, v139.(cf76 := fm68(multiset{p0, p0, p0, p0}, v0, globalState)), p0;
	r0 := v135[safeIndex(733, v135.Length)];
	var v140 := DC26();
	var v141 := DC27(v140);
	var v142 := DC27(v141);
	var v143 := DC27(v140);
	var v144: array<C1> := new C1[23];
	var v145: multiset<bool> := multiset{!v135[safeIndex(733, v135.Length)]};
	var v146: seq<bool> := [v135[safeIndex(733, v135.Length)], v0, v0, v0];
	var v147: map<bool, bool> := map[v0 := v0];
	var v148: seq<int> := [-p0];
	var v149 := DC64(v147, v0, |v137|, v148, p0);
	var v150: seq<seq<int>> := [v148];
	var v151: C1 := new C1(p0, if (v135[safeIndex(733, v135.Length)] in v145) then v145[v135[safeIndex(733, v135.Length)]] else p0, p0, fm47(v135[safeIndex(733, v135.Length)], !!v146[safeIndex(p0, |v146|)], v0, v149.cf98, globalState), v137, v150);
	v144[safeIndex(743, v144.Length)] := v151;
	var v152: array<array<int>> := new array<int>[12];
	var v153: array<int> := new int[29];
	v152[safeIndex(298, v152.Length)] := v153;
	var v154: map<multiset<bool>, bool> := map[v145 := true];
	var v156: set<multiset<bool>> := {v145, v145};
	v0, v135[safeIndex(733, v135.Length)], v143, v144[safeIndex(743, v144.Length)], v152[safeIndex(298, v152.Length)] := v0, ((set v155 : multiset<bool> | v155 in v154 :: (v155)) * v156) > v156, v143, v151, v153;
...
method Main() {
	...
	if (!v3 || v3) {
		...
		v5[safeIndex(566, v5.Length)] := |fm1(0x1ee, if (v3 in v6) then v6[v3] else v0, globalState)|;
		v5[safeIndex(566, v5.Length)] := safeModuloInt(v0, v0);
		var v7 := DC0(v4);
		var v8: multiset<string> := multiset{v7.cf0, seq(abs(-0x3ac), i0  => ('v')), v4, v4, v4};
		if ("jhmh" !in (v8[v4 := abs(v0)] * v8)) {
			v5[safeIndex(566, v5.Length)], v3, v4 := -v5[safeIndex(566, v5.Length)] - (fm0(-v5[safeIndex(566, v5.Length)], -0x1ee, globalState) + v5[safeIndex(566, v5.Length)]), v3, seq(abs(0x285), i1  => ('p'));
			v0 := v5[safeIndex(566, v5.Length)];
			var v9: array<seq<bool>> := new seq<bool>[23];
			var v10: seq<bool> := [v3, !v3];
			v9[safeIndex(396, v9.Length)] := v10;
			v9[safeIndex(396, v9.Length)] := fm2(v4, v0, globalState);
			var v11: array<bool> := new bool[25];
			v11[safeIndex(355, v11.Length)] := v3;
			v11[safeIndex(355, v11.Length)] := !true;
			var v12 := DC2();
			var v13 := DC9(v12);
			var v14: map<D4, bool> := map[v13 := v11[safeIndex(355, v11.Length)]];
			var v15: multiset<map<D4, bool>> := multiset{v14};
			var v16: map<int, int> := map[v5[safeIndex(566, v5.Length)] := if (v14 in v15) then v15[v14] else |v6|];
			var v18: map<int, bool> := map[|(set v17 : int | v17 in v16 :: (safeDivisionInt(v17, |multiset{[true, !false], [true]}|)))| := v11[safeIndex(355, v11.Length)]];
			var v19 := new C11(v18, safeModuloInt(v0, v5[safeIndex(566, v5.Length)]));
		} else {
			globalState.f3 := 0x31d + fm0(v0, fm0(v0, v0, globalState), globalState);
			var v20: array<char> := new char[23](i2 => 'i');
			v20[safeIndex(826, v20.Length)] := 's';
			var v21 := 'p';
			var v22: set<bool> := {v3};
			var v23: C7 := new C7(v4, seq(abs(-940), i3  => ([|{v3, v3}|, v5[safeIndex(566, v5.Length)]])), |v22|, fm47(fm8(v5[safeIndex(566, v5.Length)], v3, v3, globalState), v3, true, v3, globalState));
			var v24: set<C7> := {v23, v23, v23};
			var v25: seq<int> := [v0, v5[safeIndex(566, v5.Length)], |v24| + v0, v5[safeIndex(566, v5.Length)]];
			v3, v20[safeIndex(826, v20.Length)], v5[safeIndex(566, v5.Length)] := v3, if (v3) then v21 else v21, |v25|;
			v0 := |multiset{v3, v3}| - |v4|;
			var v26: map<char, set<bool>> := map[v20[safeIndex(826, v20.Length)] := {v3, v3, !true, v3}];
			v26 := v26[v20[safeIndex(826, v20.Length)] := v22 * v22];
			globalState.f3 := v5[safeIndex(566, v5.Length)];
		}
		
		var v27 := DC7(v3);
		if (v27.cf9) {
			var v28: map<bool, string> := map[v3 := v4];
			var v29: seq<string> := [seq(abs(854), i4  => ('v')), v4];
			var v30: array<string> := new string[7] [v4, v4 + v4, (if (v3 in v28) then v28[v3] else v29[safeIndex(v0, |v29|)]) + v4, v4 + v4, v4, "gmmhky", (seq(abs(222), i5  => ('u'))) + v4];
			var v31 := 'f';
			v30, v31, v5[safeIndex(566, v5.Length)] := v30, 'c', v0 * v5[safeIndex(566, v5.Length)];
			var v32: map<int, int> := map[v5[safeIndex(566, v5.Length)] := v0];
			...
			var v36: set<bool> := {v3};
			v3 := (v36 * v36) > v36;
			globalState.f3 := if (v36 > v36) then v5[safeIndex(566, v5.Length)] else -0x1bb;
			var v37: array<bool> := new bool[5];
			v37[safeIndex(343, v37.Length)] := v3;
			var v38: set<int> := {v5[safeIndex(566, v5.Length)]};
			v37[safeIndex(343, v37.Length)] := !v35.f21 && (v38 > {-54, v0, v5[safeIndex(566, v5.Length)]});
		} else {
			var v39: array<C2> := new C2[26];
			var v40: multiset<array<C2>> := multiset{v39};
			v0 := safeDivisionInt(|v4|, v0) + (if (v39 in v40) then v40[v39] else -v0);
			v3 := v3 || (v0 >= v0);
			var v41: array<array<set<int>>> := new array<set<int>>[4];
			var v43: array<set<int>> := new set<int>[17](i6 => set v42 : int | v42 in map[|map[|v4| := false]| := v5[safeIndex(566, v5.Length)]] :: (safeModuloInt(v42, --|[505, 0x21f]|)));
			v41[safeIndex(122, v41.Length)] := v43;
			v41[safeIndex(122, v41.Length)] := v43;
			var v44 := 'n';
			var v45: map<char, int> := map[v44 := v0];
			v45 := v45[v44 := v5[safeIndex(566, v5.Length)]];
			...
			var v49: map<map<int, int>, map<int, int>> := map[v48 := map[v5[safeIndex(566, v5.Length)] := v0]];
			var v50 := new C3(v3, safeModuloInt(v0, v5[safeIndex(566, v5.Length)]), -0x41, v49, "vffpxyinc" + v4, v2 + v2);
		}
		
		var v51: set<bool> := {v3};
		var v52: seq<int> := [|fm37(-v5[safeIndex(566, v5.Length)], v5[safeIndex(566, v5.Length)], false, |v51|, globalState)|];
		var v53: array<bool> := new bool[6] [v3, v3, v3, v3, false, v3];
		var v54: map<int, array<bool>> := map[v52[safeIndex(fm0(v5[safeIndex(566, v5.Length)], v0, globalState), |v52|)] := v53];
		v54 := v54[v0 - 0x285 := if (v3) then v53 else v53];
		var v55: seq<string> := [v4];
		var v56: array<string> := new string[18] [v4 + "c", (seq(abs(0x230), i7  => ('a'))) + v4, v4, v4, v4, seq(abs(0x2c5), i8  => ('u')), fm31(globalState), "wnsfde", v4, v4 + v4, v55[safeIndex(v5[safeIndex(566, v5.Length)], |v55|)], v4, v4, v4, "pxgpcele", v4 + v4, v55[safeIndex(v0, |v55|)], v4];
		v56 := v56;
	} else {
		v2 := (v2 + v2) + v2;
		var v57 := 'o';
		...
		decreases 100 - i9
	{
		...
		if (v3) {
			...
			var v83: T0 := new C0(v80, v80, seq(abs(292), i11  => ('r')), v2);
			var v84: seq<T0> := [v83];
			var v85: map<map<int, int>, int> := map[map v82 : int | (519 <= v82) && (v82 < -0x118) :: (v82 * |v1|) := (v72.f17) := |v84|];
			var v86 := DC0(v74);
			var v87 := 'b';
			var v88 := new C1(v72.f17, v72.f17, v72.f17, map v81 : map<int, int> | v81 in v85 :: (v81) := (map[v71.f17 := v72.f17]), v86.cf0 + v83.f9[safeIndex(v72.f17, |v83.f9|) := v87], v83.f10);
			...
			var v105: C1 := new C1(v72.f17, v71.f17, |v103|, v102.f12, v102.f9, v102.f10[safeIndex(v72.f17, |v102.f10|) := v104]);
			...
			var v109 := new C6(0x26c, v108[safeIndex(v72.f17, |v108|)], v96 + "hjurkj", [seq(abs(0x385), i12  => (-0x214))]);
			globalState.f3 := v72.f17;
		...
		var v115: map<map<int, int>, map<int, int>> := map[v113 := map v114 : int | (-0x273 <= v114) && (v114 < -0x2b8) :: (safeModuloInt(v114, v71.f17)) := (v71.f17)];
		...
		v111 := ("mc")[safeIndex(if (v3) then v71.fm23(globalState) else v71.f17, |"mc"|) := 'l'];
	}
	...
	if (|(multiset{!v3, v3, v3} + (if (v137 in v136) then v136[v137] else v135))| > safeDivisionInt(v0, |v122|)) {
		v121 := v121;
		...
		v147[safeIndex(770, v147.Length)] := ((seq(abs(-0x1dd), i14  => (v138))) + v139)[safeIndex(v0, |((seq(abs(-0x1dd), i14  => (v138))) + v139)|) := v138];
		v147[safeIndex(770, v147.Length)] := v139;
	} else {
		if (v3) {
			...
			v121[safeIndex(470, v121.Length)] := v72.f17;
			v121[safeIndex(470, v121.Length)] := if (v3) then v127.f11 else 0x17;
		} else {
			v3 := safeDivisionInt(v72.f17, v127.f11) < (v71.f17 + -v72.f17);
			...
			var v164: C8 := new C8(safeModuloInt(v127.f11, |v135|), if (v162 in v163) then v163[v162] else v3);
			v164 := v164;
			...
			v167 := v167[safeIndex(fm0(v71.f17, v71.f17, globalState) * v72.f17, |v167|) := fm13(v3, v127.f11, v122[safeIndex(v72.f17, |v122|) := v131], globalState)];
			var v168: array<bool> := new bool[2](i15 => true);
			v168[safeIndex(720, v168.Length)] := v165.f21;
			var v169: seq<array<bool>> := [v168, v168, v168, v168, v168];
			v168[safeIndex(720, v168.Length)] := if (|(v169 + v169[safeIndex(v127.f11, |v169|) := v168])| in v125) then v125[|(v169 + v169[safeIndex(v127.f11, |v169|) := v168])|] else v3;
		}
		...
		match (v170) {
			case DC69(cf108) =>
				...
				v177[safeIndex(94, v177.Length)] := v3 ==> true;
				v172, v176, v177[safeIndex(94, v177.Length)] := v172, (v176 + v176) + v176, v3 in v73;
				var v178: seq<T1> := [v127];
				var v179: seq<seq<T1>> := [v178[safeIndex(v72.f17, |v178|) := v127]];
				var v180 := new C1(|v179|, v71.f17, safeDivisionInt(v0, v71.f17), cf108, v127.f9, v127.f10);
				var v181 := DC5(v177[safeIndex(94, v177.Length)], v177, v173.f23 - v180.f24, 0x99);
				v181 := v181;
				var v182: array<map<int, int>> := new map<int, int>[3](i16 => map[v127.f11 := v71.f17]);
				v182 := v182;
		}
		
		v131 := v127.f9[safeIndex(0x28a, |v127.f9|)];
	...
	for i18 := v71.f17 to v0 {
		var v185: map<bool, int> := map[fm13(v3, v72.f17, seq(abs(0x178), i19  => (v131)), globalState) := v127.f11];
		v185 := v185[v3 := v72.f17];
		v0 := v72.f17 * v72.f17;
		globalState.f3 := safeDivisionInt(-49, |(seq(abs(0x26b), i20  => ('m')))|);
		var v186: array<array<int>> := new array<int>[19];
		v186[safeIndex(188, v186.Length)] := v121;
		v186[safeIndex(188, v186.Length)] := v121;
	}
	...
	if (v3) {
		...
		var v195: array<seq<bool>> := new seq<bool>[25] [if (-v72.f17 in v192) then v192[-v72.f17] else [!v3, v3], v191 + v191, [v3] + v191, v191, v191 + v191[safeIndex(|v194[safeIndex(v71.f17, |v194|)]|, |v191|) := v3], v191 + [v3, true], [v3] + v191, v191, v191 + v191, v191, v191, v191, v191, v191, v191, v191, v191, v191 + v191, (v191 + fm2(v127.f9, v127.f11, globalState))[safeIndex(v71.f17, |(v191 + fm2(v127.f9, v127.f11, globalState))|) := !fm22(v3, v72.f17, globalState)], [v3] + v191, v191, v191, v191, [v3], v191];
		v195[safeIndex(33, v195.Length)] := [v3];
		v195[safeIndex(33, v195.Length)] := v191;
		v3 := false;
		...
		var v202: array<string> := new seq<char>[4](i21 => (seq(abs(0x295), i22  => (v127.f9[safeIndex(v71.f17, |v127.f9|)]))) + v122[safeIndex(v71.f17, |v122|) := v196]);
		v202 := new string[3] [v122, v127.f9 + v197, fm37(222, |v122|, v3, v72.f17, globalState)];
	}
	
	var v203: array<array<int>> := new array<int>[15];
	v203[safeIndex(471, v203.Length)] := v121;
	var v204: seq<array<int>> := [v121, v121, v121];
	v203[safeIndex(471, v203.Length)] := v204[safeIndex(v71.f17, |v204|)];
	var v205: map<bool, bool> := map[v3 := v3];
	var v206, v207 := v127.m3(safeModuloInt(v72.f17, v71.f17), fm37(v127.fm5(|v1|, v71.f17, globalState), v71.f17, false, |v205|, globalState), v0 - |map[v0 := v3]|, DC0(v122[safeIndex(v71.f17, |v122|) := fm17(v3, globalState)]), globalState);
	...
	v213[safeIndex(569, v213.Length)] := v131;
	v212, v213[safeIndex(569, v213.Length)] := if (v211) then v212 else v212, v131;
	var v214 := DC10(v125);
	match (match v214 {
		...
		case DC5(cf4, cf5, cf6, cf7) =>
			...
			match (v216) {
				case DC26() =>
					cf7 := v127.f11;
					cf4 := 'm' !in ((seq(abs(0x324), i23  => (v213[safeIndex(569, v213.Length)]))) + v127.f9);
					var v217: set<int> := {v0, -v127.f11, 0x39a};
					v212.f23 := safeModuloInt(cf6, -0x6f) - |v217|;
					cf4 := cf4;
				case DC25(cf29) =>
					v212.f23 := 0x38c;
					...
					var v221: C3 := new C3(cf4, cf7, v212.f23, v127.f12, v122[safeIndex(v72.f17, |v122|) := v213[safeIndex(569, v213.Length)]], v127.f10 + v127.f10);
					v221 := v221;
					v212.f23 := v212.f24;
				case DC27(cf30) =>
			...
			v207[safeIndex(191, v207.Length)] := safeModuloInt(v71.f17, v212.f24);
			v207[safeIndex(191, v207.Length)] := v127.f11;
			var v235: array<seq<int>> := new seq<int>[6];
			var v236: seq<array<seq<int>>> := [v235, v235];
			var v237 := DC41(multiset([!false, v211, v3, v3, v211]));
			var v238 := DC53(v236[safeIndex(cf7, |v236|)], |v237.cf57|);
			match (v238) {
				case DC53(cf78, cf79) =>
					globalState.f3 := v72.f17 - v127.fm5(v212.f23, v72.f17, globalState);
					v213[safeIndex(569, v213.Length)] := if (cf4) then v131 else v131;
					var v239, v240, v241, v242 := v72.m12(globalState);
					v3 := v3;
				case DC54(cf80, cf81) =>
					var v243: seq<set<bool>> := [v73, v73 * v73];
					v73 := v243[safeIndex(v212.f23, |v243|)];
					globalState.f3 := safeDivisionInt(|("gey" + v127.f9)|, cf81);
					v215 := v215;
					var v244 := DC0(seq(abs(0x4d), i25  => (v131)));
					var v245: seq<string> := [v127.f9, v127.f9[safeIndex(v212.f24, |v127.f9|) := v131], v244.cf0, v127.f9];
					var v246: seq<int> := [-0x1d0];
					v122, cf80, v127, v212.f23, v211 := seq(abs(22), i24  => (v131)), |v127.f9|, v127, 0x107, v245[safeIndex(if (cf4 in v135) then v135[cf4] else -|v246|, |v245|) := v127.f9] <= (seq(abs(0x3bf), i26  => (v122[safeIndex(v72.f17, |v122|) := v131])));
				case DC52(cf77) =>
					v211 := cf4;
					var v247: C3 := new C3(false, v127.f11, v212.f23, v127.f12, v127.f9, seq(abs(0x2a2), i27  => (seq(abs(0xb6), i28  => (v71.f17)))));
					var v248: set<C3> := {v247};
					var v249: seq<set<C3>> := [v248];
					cf4 := v248 !in v249;
					var v250: seq<bool> := [v211];
					var v251: T0 := new C7(v127.f9, v127.f10, safeModuloInt(v127.f11, |v250|), v127.f12);
					var v252: C7 := new C7(v127.f9, seq(abs(0x227), i29  => ([|v250|, cf6])), v0, v127.f12);
					var v253 := DC72(v251);
		...
		case DC4(cf3) =>
			v73 := v73;
			v187[safeIndex(31, v187.Length)] := v3;
			var v254 := DC40("ddkrbmll", v211, |v124|);
			var v255: map<multiset<int>, int> := map[v1 := if (v211 in v135) then v135[v211] else -v127.f11];
			v187[safeIndex(31, v187.Length)] := if (v254.cf55 <== v211) then v3 else |v255| > v71.f17;
			var v256, v257, v258, v259 := v212.m1(|v125|, v72.f17, cf3, globalState);
			v187[safeIndex(31, v187.Length)] := v187[safeIndex(31, v187.Length)];
	}
	
	print v0, "\n";
	print v1 == multiset{-71, -71}, "\n";
	print v2 == [[-71]], "\n";
	print globalState.f0 == multiset{-71, -71}, "\n";
	print globalState.f1, "\n";
	print globalState.f2, "\n";
	print globalState.f3, "\n";
	print globalState.f4, "\n";
	print globalState.f5 == [[-71]], "\n";
	...
	print i9, "\n";
	print v122, "\n";
	print v124 == map[-474 := 4], "\n";
	print v125 == map[-474 := false], "\n";
	print v126 == [map[-474 := -474], map[-474 := 4], map[-474 := 4], map[-474 := 4], map[1 := 1]], "\n";
	print v127.f11, "\n";
	print v127.f12 == map[map[-474 := -474] := map[-474 := 4], map[-474 := 4] := map[-474 := 4], map[1 := 1] := map[-474 := 4]], "\n";
	print v127.f9, "\n";
	print v127.f10 == [[-71]], "\n";
	print |v128|, "\n";
	print |v129|, "\n";
	print v131, "\n";
	print v132 == multiset{'v'}, "\n";
	print v133 == map[map['v' := false] := -474], "\n";
	print v134 == map['v' := true], "\n";
	print v135 == multiset{false}, "\n";
	print v136 == map[map[true := "fjhipg", false := "kgg"] := multiset{false}], "\n";
	print v137 == map[false := "psiuxumem"], "\n";
	print v187[5], "\n";
	print |v204|, "\n";
	print v205 == map[true := true], "\n";
	print v207[6], "\n";
	print v207[12], "\n";
	print v208 == map[true := -474], "\n";
	print v209 == [map[-474 := 478, 1 := 478]], "\n";
	print v210.cf1, "\n";
	print v211, "\n";
	print v212.f23, "\n";
	print v212.f24, "\n";
	print v213[0], "\n";
	print v214.cf12 == map[-474 := false], "\n";
}