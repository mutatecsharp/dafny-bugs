...
function fm9(globalState: GlobalState): int {
	-(279 % |map[-0xbe := |DC9(false, false, map[!false := false], true, false).cf21|]|)
}
...
function fm12(p0: seq<int>, p1: bool, p2: char, globalState: GlobalState): D2 {
	match DC80(0x100, --|(map v0 : int | v0 in multiset{-579, |map[-|map[true := true]| := map[false := true]]|} :: (v0 - |[[!false]]|) := (0x89))|) {
		...
		case DC82(cf159) => DC5(|(seq(0x36c, i0  => ('o')))|)
	}
}
...
function fm19(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): seq<bool> {
	[if (false) then !false else false, !!(if (!false) then true else false), true, !(|(seq(73, i0  => (479)))| in [|multiset{multiset([DC102(DC101("noqss", !!false, 't'))]), multiset{DC102(DC101("ave", false, 'l')), DC102(DC101(seq(0x2bd, i1  => ('t')), true, 'p'))}, multiset{DC102(DC100(map[true := DC9(false, true, map[false := false], true, false)]))}, multiset([DC102(DC101("vb", false, 'p')), DC102(DC100(map[false := DC9(true, true, map[false := false], true, !false)]))])}|])]
}
function fm20(p0: seq<bool>, p1: bool, p2: bool, globalState: GlobalState): string {
	seq(0x1c9, i0  => ('r'))
}
function fm21(p0: int, globalState: GlobalState): D3 {
	if (!({0x32f, 110} < (set v0 : int | (0x2e6 <= v0) && (v0 < 0x10d) :: (v0 * |map[false := |(seq(635, i0  => (0x69)))|]|)))) then DC8(true, "iuynlk", 841) else DC8(!true, "us", 0xe9)
}
...
function fm25(p0: int, globalState: GlobalState): string {
	match DC83(map[{false, true} := |[false, false]|]) {
		...
		case DC83(cf160) => seq(0x248, i0  => ('n'))
	}
}
...
function fm36(p0: bool, p1: char, p2: bool, globalState: GlobalState): seq<bool> {
	[multiset{673, -163, -463} <= multiset{|{true, false}|}, -|"h"| >= |(seq(132, i0  => ([true, true])))|, DC95(true, -0xe1, |map['l' := -367]|).cf174]
}
function fm37(p0: bool, p1: map<int, int>, p2: bool, globalState: GlobalState): string {
	match DC49(multiset{0x3df}, false, true) {
		...
		case DC49(cf100, cf101, cf102) => (seq(0xd9, i0  => ('i'))) + "mwgss"
		case DC50(cf103) => seq(0x1f4, i1  => ('w'))
		case DC47(cf94) => "sig" + "awafob"
		case DC51(cf104) => "qqa" + "yyygwwk"
	}
}
function fm38(p0: int, p1: bool, p2: bool, globalState: GlobalState): D5 {
	DC14(|map[|['p']| := [false, false, false, !true, false]]| + |map[|map[|map[true := map v0 : int | (-0x137 <= v0) && (v0 < -0x199) :: (v0 - |"opowryqmc"|) := (false)]| := |map[true := |(seq(-0x31, i0  => ('b')))|]|]| := false]|)
}
function fm39(globalState: GlobalState): seq<int> {
	seq(0x10, i0  => (-(|map[false := true]| * 177)))
}
...
function fm44(p0: char, p1: bool, p2: int, globalState: GlobalState): set<int> {
	if (true) then (set v0 : int | (0x2f7 <= v0) && (v0 < 0x343) :: (v0 - 0x2c1)) - {-|multiset{false}|} else set v2 : int | v2 in [|(map v1 : int | (0x3ad <= v1) && (v1 < 0x12e) :: (v1 % 0x212) := (false))|] :: (v2 * 0x392)
}
...
function fm46(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<int, int> {
	map[-984 := DC116(-0x298, "oyldfqo").cf202] + map[-0x135 := |map[DC81(true, |"ut"|, true, true).cf156 := seq(0x3cb, i0  => ('b'))]|]
}
function fm47(p0: bool, p1: map<int, bool>, p2: bool, p3: bool, globalState: GlobalState): seq<map<int, int>> {
	if (!false) then (seq(0x116, i0  => (map[0x2b2 := |"wokluooj"|]))) + [map v0 : int | (585 <= v0) && (v0 < 0x3bd) :: (v0 / |map[false := true]|) := (|{0x1ab}|)] else [map[|multiset([false, false])| := |DC7([true]).cf15|]]
}
...
function fm49(p0: int, globalState: GlobalState): seq<int> {
	([0xd2, -139] + [-0x11]) + (seq(961, i0  => (0x1b2)))
}
...
function fm58(globalState: GlobalState): multiset<int> {
	multiset{|(seq(-76, i0  => ('q')))|, 0x30f * -|map[false := false]|, |("nva" + (seq(0x1b4, i1  => ('e'))))|}
}
...
function fm60(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState): multiset<char> {
	(multiset(seq(0xf9, i0  => ('g'))) + DC117(multiset{'r', 'q'}).cf204) - multiset{'e'}
}
function fm61(p0: bool, p1: map<D12, int>, p2: int, p3: bool, globalState: GlobalState): D3 {
	if (true) then DC9(false, !true, map[!true := true], false, true) else DC9(DC8(true, seq(0x88, i0  => ('u')), -|"lsar"|).cf16, false, map[true := true], !true, true)
}
...
function fm63(globalState: GlobalState): char {
	match DC120(DC118(!false, seq(-0x181, i0  => ('o')), |(set v0 : int | (-0x392 <= v0) && (v0 < 276) :: (v0 + -|(seq(0x237, i1  => ('e')))|))|, |"asqgi"|, 0x1e9)) {
...
function fm66(p0: int, p1: char, p2: bool, globalState: GlobalState): seq<int> {
	if (|"hh"| < |[!false]|) then [|map['i' := |[|map[!false := false]|]|]|, |multiset{169, |{|"j"|}|}|] else (seq(0x218, i0  => (|(set v0 : int | (-0x167 <= v0) && (v0 < -0x26a) :: (v0 + |"a"|))|))) + [|map[true := true]|, 0x4e]
}
...
function fm73(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): seq<string> {
	["mrfjbvos"] + (["tfeqbpf", "imu", seq(0xe1, i0  => ('o'))] + ["je"])
}
function fm74(p0: int, p1: char, p2: char, p3: char, globalState: GlobalState): seq<bool> {
	if ([|(seq(0x1d7, i0  => ('y')))|, |multiset([!!true])|] < (seq(672, i1  => (|map[!false := |{'t'}|]|)))) then [false] + [!true, false] else if (false) then [false, false, true, true] else [false, false]
}
...
function fm76(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): D22 {
	if (!false) then DC49(multiset{|map[0x3e0 := DC38(false)]|, |"epbyqyc"|, 0x193, 0x390}, true, false) else DC49(multiset([|(seq(367, i0  => (DC73({DC53(0x388), DC53(0x136)}))))|]), true, !false)
}
function fm77(globalState: GlobalState): D25 {
	match if (false) then DC4(0x183) else DC4(107) {
		...
		case DC6(cf14) => DC56(seq(0x1bd, i0  => (DC31(true))))
	}
}
function fm78(p0: map<int, bool>, p1: char, globalState: GlobalState): map<int, bool> {
	match DC9(false, true, map[false := !false], false, true) {
		...
		case DC9(cf19, cf20, cf21, cf22, cf23) => map v0 : int | v0 in {|(seq(0x39, i0  => ('n')))|} :: (v0 - |"scvnv"|) := (true)
...
function fm81(p0: int, p1: char, globalState: GlobalState): seq<int> {
	[|multiset{-105, |(map v0 : int | (0x120 <= v0) && (v0 < 0xc2) :: (v0 % 0xcf) := (multiset{0x1a4}))|, 978, 0x1b5, 0x57}|, 698, |multiset{false, true, !false}|, 0x23f] + ((seq(0x30b, i0  => (413))) + [-|{true}|])
}
...
function fm84(p0: int, p1: bool, globalState: GlobalState): D5 {
	if (false) then if (true) then DC13(set v0 : int | (0x22a <= v0) && (v0 < 0x381) :: (v0 * 0x340)) else DC13({0x1ab, |[false, true]|, |(seq(0x145, i0  => ('n')))|, |map[0x341 := |map[!true := |map[true := 529]|]|]|}) else DC13({483})
}
function fm85(p0: bool, globalState: GlobalState): string {
	"jyf" + "cxojdkdo"
}
function fm86(globalState: GlobalState): map<int, multiset<int>> {
	map[|"bqyuus"| := multiset(seq(771, i0  => (0x57))) - multiset(seq(0x287, i1  => (0x37c)))]
}
...
function fm88(globalState: GlobalState): map<bool, char> {
	map["kkpxavxx" != (seq(616, i0  => ('p'))) := 'g']
}
function fm89(p0: int, globalState: GlobalState): seq<seq<int>> {
	[[0x15b], seq(0x338, i0  => (|{true, false, true, true}|)), [|map[true := false]|, |{"e"}|], [|map[!true := true]|, |(map v0 : char | v0 in multiset{'s', 'a'} :: (v0) := (false))|]] + ((seq(0x3b0, i1  => (seq(0x173, i2  => (|[true, true]|))))) + [[0x1e1, |multiset{|[0x32]|}|, |{0x23b}|]])
}
...
function fm91(p0: bool, p1: D27, globalState: GlobalState): set<int> {
	match if (false) then DC23(map v0 : int | v0 in (map v1 : int | v1 in (map v2 : int | (317 <= v2) && (v2 < 0x4b) :: (v2 % 0x349) := (true)) :: (v1 + |multiset{true}|) := (|map[|map[true := true]| := |multiset{true}|]|)) :: (v0 / 0x115) := (false)) else DC23(map[|map[900 := !true]| := false]) {
		case DC23(cf46) => {0x15d} * (set v3 : int | (548 <= v3) && (v3 < -0x33a) :: (v3 % |[0x309, 67]|))
	}
}
...
function fm98(p0: int, globalState: GlobalState): map<seq<D22>, set<int>> {
	map[seq(0x2af, i0  => (DC49(multiset([|"lodb"|]), true, !DC90(false, true, true).cf167))) := set v0 : int | (270 <= v0) && (v0 < 0x118) :: (v0 * |DC70(|[|map[0x14f := 0x210]|, 0x2e1]|, map[|map[|[false, false, true, true, true]| := DC67(false, false)]| := !true], 0x2ce).cf136|)]
}
function fm99(p0: int, p1: char, p2: int, globalState: GlobalState): multiset<multiset<bool>> {
	multiset(seq(-539, i0  => (multiset{true, false, !!false})))
}
function fm100(p0: int, globalState: GlobalState): set<char> {
	((set v0 : char | v0 in (seq(-0x130, i0  => ('h'))) :: (v0)) - (set v1 : char | v1 in ['r'] :: (v1))) * ({'a', 'e'} * {'c', 'd'})
}
function fm101(p0: bool, p1: seq<bool>, p2: int, globalState: GlobalState): map<bool, set<int>> {
	map[945 != -|(seq(0x1ae, i0  => ('g')))| := DC13(DC13({876}).cf32).cf32]
}
function fm102(p0: bool, p1: int, globalState: GlobalState): map<D10, bool> {
	map v0 : D10 | v0 in multiset([DC20(map[|{true, true}| := "vyxgfmf"])]) :: (v0) := (|(set v1 : int | (0x222 <= v1) && (v1 < 0x3c4) :: (v1 % |(seq(330, i0  => ('y')))|))| <= 0x12c)
}
...
function fm105(p0: int, p1: int, p2: int, globalState: GlobalState): set<D20> {
	(DC127(set v0 : D20 | v0 in multiset{DC43(map[|"i"| := 's'])} :: (v0)).cf227 * {DC43(map[|[|map[0x103 := -461]|]| := 'f']), DC43(map[|"emxost"| := 'o'])}) + ({DC43(map[0x20c := 'd'])} * {DC43(map v1 : int | (0xc7 <= v1) && (v1 < 839) :: (v1 / 624) := ('m'))})
}
function fm106(p0: string, globalState: GlobalState): seq<D22> {
	if (true) then (seq(-0x108, i0  => (DC47(multiset{false, false})))) + (seq(-0x2b0, i1  => (DC47(multiset{false, true, true, !true, true})))) else [DC47(multiset{false, false})] + [DC47(multiset([false]))]
}
...
function fm108(p0: bool, p1: int, p2: int, globalState: GlobalState): D4 {
	match DC33(955, false, true) {
		...
		case DC32(cf61) => DC11(map[[true, false] := -|(seq(0x1ba, i0  => ('c')))|])
...
function fm110(p0: bool, globalState: GlobalState): set<D23> {
	({DC53(|{false}|)} - {DC53(|map[!true := {true}]|)}) - {DC53(|map[0x11c := |map[|map[!true := -0x8a]| := false]|]|), DC53(|map[|multiset{DC86(seq(0x1bf, i0  => (DC47(multiset{false})))), DC86([DC47(multiset{true, false, true})])}| := -0x17b]|), DC53(|[895, 0xc2]|)}
}
function fm111(globalState: GlobalState): map<bool, D3> {
	map[DC74([map v0 : char | v0 in ['i'] :: (v0) := (0x23f), map v1 : char | v1 in ['t', 'j', 'p'] :: (v1) := (|"qjdu"|)], false, seq(0x205, i0  => (|{-0x2b5}|))).cf145 := DC9(false, !true, map[!!!true := true], true, false)]
}
...
function fm113(p0: int, p1: bool, p2: map<int, multiset<int>>, p3: bool, globalState: GlobalState): map<int, seq<int>> {
	(map[|multiset([[!false]])| := [|map[false := |[|(seq(51, i0  => (0x1b3)))|, |[true]|]|]|, 0x179]] + map[0x2f2 := [0x2f3]]) + (map[0xcb := [616, -0x20c, -405, 828, 0x3c4]] + (map v0 : int | (728 <= v0) && (v0 < -536) :: (v0 * -837) := ([|"wrignh"|])))
}
...
function fm120(p0: bool, p1: bool, p2: int, p3: char, globalState: GlobalState): D30 {
	DC71(-0x3af - |"pgdrdsxv"|, seq(0x7f, i0  => ('p')), |"dlgh"|)
}
function fm121(p0: int, globalState: GlobalState): D35 {
	DC81(|[-0x3e0]| < |(seq(-0x1e6, i0  => (multiset{0x2ee, 689, |[true, !true]|})))|, |({|{|"vy"|}|} - {-|map[false := true]|})|, true, true)
}
method m0(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState) returns (r0: seq<int>, r1: int) {
	...
	var v6 := DC46(v3, v5[p0], v0, p1, fm52(globalState));
	...
	v0[805] := p2;
	globalState.f0, v10, r1, v0[805], r1 := p3, v10, p0 * p0, p1, p3;
		...
		decreases 100 - i1
	{
		...
		i1 := i1 + 1;
		var v12: set<bool> := {p1, !p1, p1, v0[805], p2};
		...
		var v16: C3 := new C3(multiset{DC34(v15, v0[805], v4)}, p3, p1);
		v14[76] := v16;
		v14[76] := new C3(v16.f36 * v16.f36, p3, |"ebwlbig"| != p0);
		var v17 := new C5(v9);
	...
	var v19 := DC97({v9});
	var v20: set<char> := {v9};
	var v21 := new C8(p2 && p2, v19.cf178 * v20, p0, v0[805]);
	var i2 := 0;
		...
		decreases 100 - i2
	{
		...
		var v30: set<seq<bool>> := {v23, [v21.f31], v29.cf1, (v23[p0 := false])[p3 := v21.f31], v23};
		r1 := |v30|;
		v0[805] := if (v21.f31) then p2 else p2;
		...
		match (v31) {
			case DC2(cf5, cf6, cf7) =>
				...
				globalState.f0 := p0;
				var v33 := DC19();
				var v34: map<bool, int> := map[!v0[805] := -734];
				var v35: array<D8> := new D8[25];
				var v36: T0 := new C6(v35);
				var v37: multiset<T0> := multiset{v36, v36, v36};
				var v38: set<bool> := {cf7, v0[805], if (p0 in v3) then v3[p0] else false, !p1};
				v0[805] := if (!(fm40(false, v33, if (p2 in v34) then v34[p2] else p0, |v37|, globalState) >= v38)) then cf5 <==> !v21.f31 else false;
				v0[805] := v21.f31;
			case DC3(cf8, cf9, cf10, cf11) =>
				var v39: array<int> := new int[27](i3 => i3 / |v23|);
				v39[696] := --p0;
				var v40: C16 := new C16();
				var v41: seq<C16> := [v40];
				var v42: T1 := new C21(v0[805], v21.f31, p3, p1);
				var v43: map<T1, seq<C16>> := map[v42 := v41];
				v39[696] := (p0 * p0) - |(v41 + (if (v42 in v43) then v43[v42] else [v40]))|;
	...
	if (if (true) then p1 else v21.f31) {
		...
		v63[225] := v65;
		var v66 := DC55(p2, v0[805], v9, p2);
		v61[903], globalState.f5, globalState.f4, r1, v63[225] := v62[p3 := v0], v66.cf109, true, p3, v65 + (v65 + v65);
		var v67 := new C10(v0[805] !in [v21.f31], -p0, |v3|, !v0[805]);
		var v68: set<D23> := {DC53(v67.f27)};
		var v69 := DC73(fm110(v0[805], globalState) * v68);
		var v70: map<bool, bool> := map[p1 := v67.f26];
		var v71: seq<int> := [-p0, |v70|];
		var v72 := DC4(|(v71 + v71)[v67.f27 := 394]|);
		...
		v69, v72, v70, v0[805], v73[412] := v69, DC4(0x2b1).(cf12 := p0), v70[p0 in v77 := |v4| != 0x36d], false, (v78[p0] - v74) * (v74 * v74);
		if (|v71| != (p3 + v67.f27)) {
			var v79: array<seq<bool>> := new seq<bool>[27];
			var v80: seq<bool> := [v21.f31];
			v79[159] := v80;
			v79[159] := v80 + v80;
			v75[798] := |(if (false) then v4 else v4)|;
			v75[798] := v67.f27 / (|"pwedwumqa"| + p0);
		...
		var v87: map<int, int> := map[v67.f27 / p3 := p0];
		...
		var v89: array<string> := new string[24] [v4 + v4, if (p2) then "tof" else v4, v4, v4, v4, v4, v4 + (seq(240, i4  => (v9)))[p3 := v9], v4[p0 := v9] + (seq(434, i5  => (v9))), v4, (seq(0x267, i6  => (v9))) + v4[0x145 := 'o'], v4[943 := fm63(globalState)], if (v21.f31) then v4[|v88| := v9] else v4, v4, v4, v4, "xopsoift", v4 + (seq(0x53, i7  => (v9))), v4, v4, v4, v4, fm85(!v21.f31, globalState), v4, "dagbgoer" + v4];
		v89 := v89;
		var v90: array<D12> := new D12[8](i8 => DC24(v9));
		var v91: C7 := new C7(v90);
		var v92: multiset<C7> := multiset{if (p2) then v91 else v91};
		globalState.f0, globalState.f4, v92 := p3, p1 || v0[805], multiset{v91};
		var v93: map<bool, bool> := map[p1 := v21.f31];
		var v94: seq<bool> := [false, v21.f31 <==> !(if (v21.f31 in v93) then v93[v21.f31] else !v0[805]), !p1];
		v94 := v94;
		if (p1) {
			var v95 := DC8(p2, "kop", p0);
			var v96: array<int> := new int[19] [p3, 0x6f, p3, p0 + p3, p0, p0, p0, p3, -p0 / 0x183, p0, v95.cf18, p3, -p3 + 0x243, -p3 - fm23(0x49, 0x29e, v21.f31, --p0, globalState), p0, -831, -p3, p3, p0];
			v96[777] := -p3;
			v96[777] := -p0;
			globalState.f5 := p2;
			r1 := v96[777] * p3;
			...
			var v101: seq<int> := [p0];
			var v102: map<int, seq<bool>> := map[-|v100[v21.f31 := |v101|]| := v94];
			var v103 := DC19();
			var v104: map<bool, D9> := map[v21.f31 := v103];
			var v105: array<map<int, seq<bool>>> := new map<int, seq<bool>>[10] [v102, v102 + v102, v102, v102, map[|v104| := [v0[805], v21.f31]], v102, v102, map[|v4| := v94[-p0 := v21.f31]], v102, v102];
			v105[725] := v102;
			v97[706], v105[725], r1 := v99, if (v21.f31) then v102 + map[|v4| := v94] else v102, p0;
			var v106 := DC5(v96[777]);
			var v107 := DC6(v106);
			...
			globalState.f0, v0[805], globalState.f5, globalState.f0, globalState.f0 := v21.fm3([p0, p3] + v111, globalState), !fm1(globalState), v9 !in v4, p0 + 294, |multiset(v111)|;
			var v112: multiset<map<int, bool>> := multiset{map[-p3 := p2]};
			globalState.f0 := p0 + (|v112| - p0);
		}
		
		var v113: map<bool, array<bool>> := map[v0[805] := v0];
		var v114: map<int, int> := map[p3 := p0];
		var v115: T1 := new C8(v0[805], {v9}, p3, v0[805]);
		...
		var v124 := DC18(v123[v4 := p3]);
		var v125: array<D9> := new D9[2] [v124, DC18(v123)];
		var v126: map<array<D9>, int> := map[v125 := v115.f14];
		var v127: array<int> := new int[24] [|v4| - (if (p0 in v11) then v11[p0] else p3), if (|v117| in v114) then v114[|v117|] else v115.f14, |v4|, 0x17a * p3, p0, p0, |v118|, p3, |v120|, if ('q' in v122) then v122['q'] else p0, p0, p3, if (v0[805]) then -p3 else -p3, 0x205 % -|v4|, p0 - p3, p3, p0 + p3, if (v115.f15) then -0x24c else |v4|, if (v125 in v126) then v126[v125] else p3, v115.f14, p0, p3, p3, v115.f14];
		v127[567] := fm9(globalState);
		globalState.f0, v113, v127[567], r1, globalState.f5 := fm9(globalState), v113 + v113, |v121| * v115.f14, p0 + v115.f14, fm1(globalState);
	}
...
class C0 {
	...
	function fm29(p0: int, p1: bool, globalState: GlobalState): bool {
		|(seq(297, i0  => (-829)))| == (|{true, f30, f30, f30, f30}| - 0x2f1)
	}
...
class C1 extends T0 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		var v11: array<int> := new int[22] [0xb9, v0, v0, v0, v0, v0, v0 / v0, v0, v0, v0 * v0, -(v0 % v0), |v1|, v0 / v0, v0 % fm3(v1, globalState), -(|v2| % -v0), v0, 394, |(if (!v3) then v4 else v4)|, |v5[|v8| := v3]|, v0, if (v3 in v9) then v9[v3] else -|v10|, v0];
		v11[86] := v0;
		v11[86] := v0 / -v0;
		var v12, v13 := m0(v0, v3, v3, v11[86], globalState);
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			v5 := ((fm62(v3, globalState))[v0 := v3])[|[v13]| := v3] + (v5 + v5);
			v6[943] := v3;
			var v14 := DC8(true, seq(746, i2  => ('v')), -v11[86]);
			var v15: map<int, int> := map[v0 := |v4|];
			var v16: map<int, bool> := map[if (--0x2ab in v15) then v15[--0x2ab] else v13 := v3];
			var v17: multiset<int> := multiset{v11[86], --660, v11[86], v11[86], v11[86]};
			globalState.f5, globalState.f0, globalState.f5, v6[943] := (|DC34(v14, if (v13 in v16) then v16[v13] else v3, "qiapsnofo").cf67| < 929) && false, if (v3) then 0x3d6 else v11[86] / v13, ((seq(0x3b1, i3  => (v11[86]))) + v1) <= (v1 + (seq(0x3d3, i4  => (v0)))), (v17 + v17) >= (v17 + v17);
		...
		for i6 := v0 to v0 {
			...
			var v26: seq<array<int>> := [v25[|v4|], v11];
			var v27: map<char, bool> := map[fm63(globalState) := v3];
			var v28 := new C0(v25, v5[-|v27|]);
			var v29 := 'k';
			globalState.f1 := v29;
		}
		var v30: map<int, int> := map[v11[86] := v11[86]];
		var v31: map<map<int, int>, int> := map[v30 + v30 := v11[86] % v0];
		v31 := v31[v30 := v11[86] - v11[86]];
		var v32 := 'o';
		globalState.f1 := v32;
	}
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		...
		if (p0) {
			...
			var v4 := DC4(v0);
			globalState.f4 := if (if (v2 in v3) then v3[v2] else v2[v0]) then p0 else v0 != v4.cf12;
			...
			var v10 := DC27(v8, v0, v7[420], p0, v2);
			v7, v0, v9, v7[420] := v7, fm3(v1, globalState), v9, !v10.cf55;
		} else {
			...
			var v20 := DC20(v19);
			var v22: set<D10> := {v20.(cf38 := v19), v20.(cf38 := map v21 : int | v21 in v1 :: (v21 - |map[p0 := v0]|) := (seq(499, i0  => ('s')))), v20};
			v18[739] := v22;
			var v23: map<int, bool> := map[v0 := fm1(globalState)];
			var v24: set<array<bool>> := {v17};
			v14, globalState.f0, v17[449], v18[739], v0 := v14, v0, if (|(v24 * v24)| in v23) then v23[|(v24 * v24)|] else p0, v22, v0 - v0;
			globalState.f5 := !v17[449];
			if (!p0) {
				r0 := v13;
				var v25 := 'k';
				globalState.f1 := v25;
				var v26: seq<array<int>> := [p1];
				var v27 := new C0(v26 + v26, [!false, v17[449]] < v16);
				var v28: multiset<int> := multiset{|{v0}|};
				var v29: set<int> := {|v16[|multiset{|fm64("ghtijkf", globalState)|, |v28|}| := p0]|, v0, v0};
				v29 := v29;
				v17[449] := fm1(globalState);
			} else {
				var v30: map<array<bool>, bool> := map[v17 := false];
				var v31 := DC44(p0, v30, v23, v13);
				r0 := (v31.cf87 % v13) + |{p0, false, v17[449]}|;
				p1[402] := v0 - v13;
				globalState.f4, p1[402] := v13 > (v0 * |"d"|), v0;
				var v32: array<int> := new int[15](i1 => i1 * |v14|);
				var v33: seq<array<int>> := [v32];
				var v34 := new C0(v33 + v33, p0);
				var v35: map<bool, bool> := map[v16[|v12|] := v13 < v0];
				globalState.f0 := -|v35|;
				globalState.f5 := p0;
			}
		...
		if (match if (!p0) then v38 else DC3(!true, p0, v37[p0 := v0], true) {
			...
			var v45 := 'h';
			var v46 := DC8(p0, v36[v0 := v45], 0x8d);
			...
			match (if (p0) then v46 else DC8(p0, v36, |fm66(v0, v45, if (v0 in v47) then v47[v0] else p0, globalState)|)) {
				...
				case DC9(cf19, cf20, cf21, cf22, cf23) =>
					...
					var v54: array<array<int>> := new array<int>[18] [p1, p1, if (|v36| in v52) then v52[|v36|] else p1, v53[v0], p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, if (cf19) then p1 else p1];
					...
					v62[219] := v55.fm29(v0, cf19, globalState);
					v62[219] := fm1(globalState) <== cf20;
					globalState.f0 := -0x20b / v0;
				case DC10(cf24, cf25, cf26) =>
					...
					v66[497] := multiset{v63};
					v66[497] := v64 - v65.cf107;
					v63 := v63;
				...
				case DC7(cf15) =>
					...
					v72[312] := v73;
					v72[312] := (map[v0 := p1])[v0 * v0 := p1];
					var v74: array<int> := new int[6];
					var v75: seq<array<int>> := [p1];
					var v76: C0 := new C0(v75, p0);
					var v77: map<int, seq<bool>> := map[v0 := cf15[v0 := v76.fm29(v0, v76.f30, globalState)]];
					var v78: map<int, int> := map[v0 := v0];
					v74 := new int[20] [v0, v0, |(map[v76 := 'q'])[v76 := v45]|, -|cf15|, -v0, v0, |(if (v0 in v77) then v77[v0] else cf15)|, |v36| * v0, -v0, -v0, v0, v0, v0 / v0, v0, --v0, v0, |v36[v0 := 'i']|, 694, if (p0) then |v78| else |v1|, v0];
					var v79: array<bool> := new bool[9];
					v79 := v79;
					var v80: seq<array<bool>> := [v79];
					var v81: array<array<bool>> := new array<bool>[11] [v80[v0], v79, v79, v79, v79, v80[765], v79, v79, v79, v79, v79];
					v81[435] := v79;
					r0, v81[435], v74, globalState.f4, globalState.f5 := v0, v79, p1, v36 != (seq(-0x98, i2  => (v45))), p0;
			}
			...
			if (v82.cf109) {
				...
				v87, globalState.f0, v38, v83[974], globalState.f4 := if (if (p0) then p0 else p0) then v87 else v87, |(v44 - v44)|, v38, v83[974], p0;
			...
			v98[179] := if (v104 in v105) then v105[v104] else p0;
		}
			...
			decreases 100 - i4
		{
			...
			v123, globalState.f0 := v123 + v123, -|(seq(0x2f8, i5  => (v0)))| % v0;
		...
		var v137: seq<multiset<char>> := [v136[if (p0 in v37) then v37[p0] else v0]];
		r1 := v136[v0];
...
class C2 extends T0 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		for i0 := -0x27c to 0xdc + v0 {
			...
			var v5 := true;
			v4[916] := !(if (!v5) then v5 else v5);
			var v6: set<array<bool>> := {v4, v4, v4};
			globalState.f0, v4[916], globalState.f0 := i0, v5, |v6|;
			globalState.f1 := 'p';
		}
		var v7 := DC29(v0);
			...
			decreases 100 - i3
		{
			...
			var v16: multiset<bool> := multiset{v13[200], v13[200]};
			v15 := v15[|(multiset{!v9} + v16)| := v14];
			v13 := v13;
			v13, v0 := v13, v0;
		}
		var v17: seq<int> := [v0];
		var v18: seq<seq<int>> := [v17];
		var v19: set<int> := {v0, v17[v0]};
		globalState.f5, v13[200], v18 := v9 <==> v9, |({v17, seq(232, i4  => (v0))} * {v17[v0 := v0], v17})| == |v19|, seq(0x21a, i5  => (v17));
		var v20: map<bool, int> := map[v13[200] := |v11|];
		v0 := DC10(v13[200], v0, v20).cf25 % v0;
	}
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		var v0 := 964;
		for i0 := v0 to -v0 {
			r0 := -v0;
			var v1: array<D10> := new D10[13](i1 => DC20(map[141 := seq(0x315, i2  => ('a'))]));
			var v2: map<array<D10>, bool> := map[v1 := p0];
			match (DC37(if (v1 in v2) then v2[v1] else p0, i0 > v0)) {
				case DC37(cf70, cf71) =>
					var v3: map<bool, int> := map[cf70 := v0 / i0];
					v3 := v3[false := -0x19 + v0];
					var v4 := "od";
					globalState.f0 := |v4|;
				...
				case DC38(cf72) =>
					...
					p1[942] := if ((v0 - |v11|) in v9) then v9[v0 - |v11|] else -939;
					globalState.f5 := !true;
					var v12 := DC4(i0);
					var v13 := DC6(v12);
					v13 := v13;
			...
			var v18 := DC31(p0);
			p1[850] := |v16[|v17| := v18.cf60]| * i0;
			var v19 := 't';
			var v20: set<char> := {v19, v19, v19, v19, v19};
			var v21 := "fvdwboics";
			var v22: set<bool> := {p0, fm1(globalState)};
			var v23: array<int> := new int[15] [v0 + v0, 0x335, -i0, i0, |v20|, i0 * -|v21|, |v22|, i0, |[p0]|, -0x116, i0, v0, v0, |"buvyb"|, i0 % -v0];
			p1[850], v23, v23 := v0, p1, p1;
			v21 := v21 + v21;
		}
		var v24: array<int> := new int[3](i4 => i4 % v0);
		...
		if (p0) {
			...
			v32[20][641] := v41.f30 !in v46;
			var v47: seq<bool> := [v26.f30];
			p1[337], globalState.f0, v45, v32[20][641], globalState.f4 := v0, (if (v41.f30) then -v0 else v0) + |v47|, v45, v26.f30, v26.f30;
			var v48: array<seq<bool>> := new seq<bool>[1];
			var v49: map<string, int> := map["m" := v0];
			var v50: multiset<string> := multiset{v43, "age", v43, v43, v43};
			var v51: map<bool, int> := map[p0 := p1[337]];
			var v52 := DC10(v32[20][641], if ("hjhlxd" in v50) then v50["hjhlxd"] else p1[337], v51);
			var v53 := DC45(v48);
			...
			decreases 100 - i6
		{
			...
			if ((seq(719, i7  => (v28))) != v54) {
				...
				var v58 := DC8(v26.f30, v54, p1[689]);
				var v59 := DC34(v58, v26.f30, v54[|v54| := v28]);
				v59 := v59;
			} else {
				...
				v61[933] := v63;
				var v64: seq<int> := [v0];
				p1[884] := v0 * fm3(v64, globalState);
				var v65: multiset<int> := multiset{v0, v0, v0, |v64|};
				v0, globalState.f5, v61[933], p1[884] := v0 / |v65[|"xd"| := v0]|, p0, v63, -(v0 - v0);
			}
	...
	method m25(globalState: GlobalState) {
		...
		var v3 := -0x358;
		var v4: seq<int> := [v3];
		var v5 := DC25(v4[0xe9], fm59(v0, globalState), v3);
		...
		v8[782] := DC9(v0, v0, v1, v0, v0);
		v8[782] := DC9(v0, v0, v1, !v0, v0).(cf21 := v1, cf19 := v0);
		var v9: multiset<bool> := multiset{true, v0};
		v3 := -|(v9 - (multiset{v0} - DC47(v9).cf94))|;
		for i0 := v3 to v3 * v3 {
			var v10: map<int, int> := map[i0 := i0 - v3];
			v10 := v10[v3 := i0] + (map v11 : int | (0xc0 <= v11) && (v11 < 841) :: (v11 / 0x2a5) := (v3));
			var v12: T0 := new C1();
			var v13: seq<T0> := [v12, v12, v12, v12, v12];
			var v14: array<int> := new int[12](i2 => i2 + |v1|);
			var v15: map<array<int>, bool> := map[v14 := v0];
			var v16: array<int> := new int[9] [|(seq(0x1da, i1  => ('m')))|, -0x3b7, v3, i0, i0, v3, v3, |v15|, |{v0}|];
			var v17: seq<array<int>> := [DC21(v3, v0, v3, v13[v3], v16).cf43];
			var v18 := new C0(v17, v0);
			globalState.f5 := v0;
			if (v18.f30) {
				var v19 := new C1();
				var v20: array<map<int, char>> := new map<int, char>[9](i3 => map[i0 := 'b'] + map[v4[0x18d] := 'f']);
				var v21 := 'h';
				var v22: map<int, char> := map[if (!v0 in v9) then v9[!v0] else i0 := v21];
				v20[338] := v22;
				v20[338] := fm68(fm69(v18.f30, i0, globalState), !v0, globalState);
				var v23: array<bool> := new bool[26];
				v23[689] := v0;
				v23[689] := v18.f30;
				var v24: multiset<int> := multiset{i0, i0};
				globalState.f5 := (v3 < |v24|) && v0;
				globalState.f0, v23[689], globalState.f5 := i0 * i0, |{v3, v3, i0, v3}| >= i0, v18.f30;
			} else {
				...
				var v34: map<bool, D3> := map[true := v8[782]];
				var v35: array<D22> := new D22[11] [v32, v32, v32, DC51(v33[|v34|]), v32, v32, v32, if (!v0) then v32 else v32, v32, v32, DC51(v31)];
				globalState.f0, v35 := v3, v35;
				v16 := v14;
				var v36 := new C0(v18.f29, v18.f30);
				v27[318] := 'x' in (v7[v3 := v29])[|"neyytcdw"| := v29];
				v27[318] := v36.f30;
			}
			
		}
		for i4 := fm3(seq(0x133, i5  => (v3)), globalState) to v3 {
			var v37: set<bool> := {v0};
			...
			v41[363] := v43;
			v7, globalState.f4, v40, v0, v41[363] := v7 + (if (v0) then v7 else v7), v0, v40, !v0, fm70(globalState);
			var v44: array<bool> := new bool[20](i7 => v0 <== v0);
			v44[653] := !(v0 ==> true);
			v44[653] := {0x38} >= v38;
			var v45: seq<bool> := [true, v44[653]];
			v45 := v45 + v45;
			...
			var v49 := new C0(v48 + [v47, v47, v47], v44[653]);
		}
		for i8 := v3 to v3 {
			var v50: array<bool> := new bool[10];
			var v51: multiset<array<bool>> := multiset{v50};
			var v52 := DC29(if (v50 in v51) then v51[v50] else v3);
			globalState.f0 := -((v3 + |v4|) / v52.cf58);
			var v53: array<int> := new int[1];
			v53[664] := i8;
			v4, globalState.f0, v53[664], globalState.f4, v0 := v4, v3, v3 - v3, fm1(globalState), v3 < 525;
			var v54 := new C1();
			v7 := "hqmsayuk";
		}
		var v55: seq<bool> := [!v0];
...
class C3 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		var v5: C1 := new C1();
		var v6: seq<C1> := [v5];
		var v7, v8 := m0(|v4| / |v6|, false !in fm72(v0[f14 := v3], globalState), fm71(f15, f15, f15, f14, globalState), p0, globalState);
		var v9 := new C2();
			...
			decreases 100 - i0
		{
			...
			var v17: array<D3> := new D3[24] [v14, DC7(v12), v14, v14, v14, v14, v14, v14, v14, v14, v14, DC7(v15[|v16|]), DC7(v12), v14, fm75(v8, fm1(globalState), -v8, globalState), v14, v14, v14, DC7(v12), v14, v14, DC7([f15]), DC7(v12), DC7(v12)];
			...
			var v20: array<int> := new int[21] [|[v8]|, f14 / (if (f15 in v4) then v4[f15] else f14), v8, p0, p0, |v0|, -|([v4, multiset{f15}])[|v12| := v4]| - p0, |(if (f15) then v10[v8] else v0)[0x93 := v3]|, f14, |(v12 + fm74(0x46, v3, v3, if (v8 in v13) then v13[v8] else v3, globalState))|, |v18|, |(v0 + v0)|, v8, f14, fm4(v0, f15, f15, globalState) / -f14, --p0, -p0, |map[f14 := v19]|, |v0| % v8, |v19|, p0 / v5.fm3(v7, globalState)];
			v20[91] := v8;
			var v21: map<int, bool> := map[v8 := f15];
			v20[91] := -|(v12[|v21| := f15] + v12)|;
			var v22: array<D22> := new D22[16];
			var v23: multiset<int> := multiset{v20[91], -0x100};
			var v24 := DC49(v23, f15, f15);
			v22[8] := v24;
			var v25: map<seq<int>, char> := map[v7 := v3];
			globalState.f5, v22[8], v8, globalState.f4 := f15, fm76(v8, f15, v20[91], f15, globalState), if (!!fm1(globalState)) then |v25| + |"hpe"| else --p0, f15;
			globalState.f4 := f15;
			var v26 := DC43(v13);
			v26 := v26;
		}
	...
	method m26(p0: bool, globalState: GlobalState) returns (r0: bool) {
		...
		match (v4) {
			...
			case DC9(cf19, cf20, cf21, cf22, cf23) =>
				...
				if (f15) {
					...
					var v12 := DC17(v11);
					var v13: map<int, D8> := map[|("ko" + v9[|v9| := v0])| := v12];
					v13 := v13[f14 := v12];
					globalState.f5 := f15;
					var v14: array<char> := new char[20];
					v14[775] := v0;
					var v15: seq<int> := [f14, f14];
					globalState.f4, v14[775], globalState.f1, v14 := p0, v0, v9[|(multiset(v15))[f14 := f14]|], v14;
					...
					var v20: array<array<int>> := new array<int>[26] [v16, v16, v16, DC39(v17, true, v16, !true, f14).cf75, v16, v18[f14], v16, v16, v16, v16, if (f14 in v19) then v19[f14] else v16, v18[DC8(f15, v9, |v1|).cf18], v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16];
					v20[152] := if (cf20) then v16 else v16;
					var v21: map<int, string> := map[f14 := v9];
					var v22: multiset<int> := multiset{f14};
					var v23: map<bool, char> := map[cf19 := v14[775]];
					...
					v9, globalState.f4, globalState.f0, v9, v20[152] := seq(0x87, i2  => ('i')), if (|v15| !in v21) then v22 >= (multiset{|v23|})[|v25| := f14] else cf22, f14, v9[if (f14 in v22) then v22[f14] else |v23| := v14[775]], v16;
				} else {
					globalState.f0 := fm4("n", f15, cf19, globalState);
					var v26: array<int> := new int[1] [f14];
					v26[45] := f14;
					v26[45] := (f14 / f14) - 0x24f;
					var v27: array<char> := new char[27](i3 => 'w');
					v27[887] := v0;
					v27[887] := 't';
					var v28: array<array<int>> := new array<int>[16];
					v28[959] := v26;
					v28[959] := if (cf22) then v26 else v26;
					v27[887] := v0;
				}
				...
				var v32 := "tvfrfjoty";
				var v33: array<multiset<int>> := new multiset<int>[12] [multiset{f14}, v29 + v29, v29, v29 - multiset{f14, f14, v30[f14]}, v29[f14 := f14], if (false in v31) then v31[false] else v29, v29, v29, v29, v29, v29[fm4(v32, cf22, cf20, globalState) := f14] - v29, v29];
				...
				var v39: array<int> := new int[13] [fm4(v32, cf20, cf20, globalState), |v34|, f14, f14, |(if (p0) then v8 else v8)|, 0x180 * |v32|, v36.cf48, fm4(seq(-976, i4  => (v0)), cf23, cf22, globalState), |(if (cf22) then "gprrsenw" else v32)[f14 := v0]|, if (cf23) then |v38| else -f14, f14, f14, f14];
				v39[83] := f14;
				globalState.f4, globalState.f1, globalState.f5, v33, v39[83] := fm71(cf20, |v8| < f14, f15, f14, globalState), v0, if (p0) then f15 else cf19, v33, f14;
				var v40: array<D11> := new D11[17](i5 => DC23(v35));
				var v41: seq<array<D11>> := [v40];
				var v42: map<array<D11>, seq<int>> := map[v41[v39[83]] := (seq(0x1c1, i6  => (f14))) + v30];
				v42 := v42;
			case DC10(cf24, cf25, cf26) =>
				...
				var v52: multiset<bool> := multiset{cf24, !v51[cf25]};
				cf26 := cf26[p0 := |v52|];
				globalState.f0 := cf25;
				v4 := v4;
			case DC7(cf15) =>
				var v53: array<int> := new int[17](i7 => i7 % f14);
				...
				v54[900] := if ((f14 - f14) in v55) then v55[f14 - f14] else v53;
				var v56 := "pwcbtcx";
				v56 := v56;
				var v57: array<bool> := new bool[25](i8 => p0);
				v57[12] := true;
				v57[12] := f15;
				globalState.f4 := v57[12];
		}
		...
		if (f15) {
			...
			v58[275] := (if ('j' in v59) then v59['j'] else f14) in (if (false) then map[f14 := f14] else v61);
			v58[275] := v58[275];
			f14 := f14;
			var v62: seq<int> := [0x322, 586];
			var v63: multiset<seq<int>> := multiset{v62};
			var v64: multiset<int> := multiset{f14};
			var v65: array<int> := new int[5] [-f14 % f14, 0x307, if (v62 in v63) then v63[v62] else |v64|, 127, if (|v60| in v61) then v61[|v60|] else f14];
			v65 := v65;
		} else {
			var v66 := "v";
			var v67: seq<int> := [f14, |v66|];
			v67 := seq(0x139, i9  => (f14));
			globalState.f5 := v67[f14] <= f14;
			var v68: map<int, int> := map[f14 := v67[-f14]];
			var v69: seq<bool> := [fm1(globalState)];
			var v70, v71 := m0(|v68|, v69[f14], f15, f14, globalState);
			var v72: array<string> := new string[24](i10 => v66);
			v72[292] := v66;
			v72[292] := if (!p0) then v66 else v66;
			var v73: multiset<bool> := multiset{f15};
			var v74: map<int, multiset<bool>> := map[f14 := v73[false := f14]];
			var v75: map<int, map<int, multiset<bool>>> := map[f14 * 0x3af := v74];
			v75 := v75[v67[|v66|] := v74[0x27c := v73]];
		}
		...
		match (v80) {
			case DC33(cf62, cf63, cf64) =>
				...
				if (v83 !in (v84 - v84)) {
					...
					v90[474] := v92 > {cf62, -cf62};
					v90[474] := (if (v90[474]) then f15 else cf63) <==> fm1(globalState);
					var v93 := new C1();
					globalState.f0, v90[474], globalState.f4, globalState.f0, globalState.f0 := -(f14 * (f14 * cf62)), cf64, cf62 == -f14, 0x3bd, f14;
					globalState.f0 := cf62;
				}
				...
				var v97: seq<int> := [v96[f14], -(-f14 / |v1|)];
				var v98 := DC4(cf62);
				globalState.f0 := |v97[-0x2a9 := v98.cf12]|;
			case DC34(cf65, cf66, cf67) =>
				var v99: seq<int> := [-930];
				var v100: map<int, bool> := map[f14 := true];
				var v101, v102 := m0(f14, v99[|cf67|] == |fm78(fm78(v100, v0, globalState), v0, globalState)|, f15, f14, globalState);
				var v103: array<char> := new char[18];
				v103[639] := v0;
				var v104: set<int> := {v102, v102, f14};
				var v105 := DC27(v0, 0x1e1, v4.cf19, f15, (fm74(0xea, 'e', v0, v0, globalState))[v102 := cf66]);
				v103[639], v77 := fm79(DC13(v104), v105, v78, globalState), v77 + v77;
				var v106: T0 := new C1();
				...
				var v109 := DC17(v108);
				var v110: array<seq<D3>> := new seq<D3>[7](i12 => (seq(0x30a, i13  => (DC10(true, f14, map[p0 := v102])))) + (seq(0x74, i14  => (DC10(cf66, v102, v1)))));
				var v111 := DC10(if (f14 in v100) then v100[f14] else p0, f14, v1);
				var v112: seq<D3> := [v111, v111];
				v110[454] := v112;
				var v113: map<int, int> := map[f14 := v102];
				var v114: multiset<string> := multiset{cf67[|v78| := (fm80(v102, globalState)).cf52], cf67};
				v76[602], v109, v110[454] := (if (|v114| in v113) then v113[|v114|] else v102) + f14, v109, if (f15) then v112[f14 := v111] else v112;
			case DC32(cf61) =>
				globalState.f0 := |v77|;
				var v115: seq<int> := [|"xfqqdch"|];
				var v116: map<bool, seq<int>> := map[fm71(p0, true, f15, f14, globalState) := v115];
				var v117: array<seq<int>> := new seq<int>[3] [if (p0 in v116) then v116[p0] else v115, seq(-0x117, i15  => (|v78|)), v115];
				v117[164] := v115;
				v117[164], globalState.f1, v115, globalState.f5 := [f14, f14 % f14], v0, fm81(-0x2f6, v0, globalState), f15;
				var v118: set<int> := {f14};
				v76[370] := |((set v119 : int | v119 in v118 :: (v119 - |DC16(map[0xa4 := 412]).cf35|)) + v118)|;
				v76[370] := f14;
				var v120: map<int, int> := map[v76[370] := fm4(v78, f15, p0, globalState)];
				var v121 := DC16(v120);
				v76[370] := |v121.cf35|;
			case DC35(cf68) =>
				...
				v76[625] := f14;
				v78, v76[625] := "hgkoh" + "rsmtoxe", f14 - f14;
				var v126: seq<int> := [v76[625], |v78|, v76[625]];
				var v127: set<int> := {v76[625], |v126|};
				var v128: map<int, bool> := map[f14 := f15];
				var v129: multiset<int> := multiset{|v128|, f14};
				var v130: array<int> := new int[24] [-v76[625], f14, v76[625], -f14 % |v126|, if (f15) then 0x3b7 else |[v76[625], v76[625]]|, |v127| + f14, v76[625], -fm4(v78, f15, p0, globalState), f14, -v76[625], |v78|, fm4(v78, p0, !!false, globalState), fm4("fboa", !p0, !p0, globalState), -0xad, |v129|, 427, f14, v76[625], v76[625] * v76[625], |v78| * f14, |v126| * f14, -v76[625], v76[625], -0x2d6 * v76[625]];
				...
				globalState.f5, globalState.f4, globalState.f4, f14, v130 := !fm71(fm71(false, p0, f15, v76[625], globalState), p0, p0, f14, globalState), (p0 && f15) ==> p0, f15 <==> f15, (f14 / f14) / |(v133.cf90 + v78)|, v130;
				var v134 := new C2();
		}
	...
	method m27(p0: int, globalState: GlobalState) returns (r0: int, r1: array<int>) {
		if (f15) {
			...
			var v25 := DC8(f15, v22[|(set v24 : map<int, int> | v24 in v23 :: (v24))|], |v12|);
			...
			var v30: seq<int> := [f14];
			var v31: array<int> := new int[28] [f14, 0x239, fm4(v12, f15, if (v13 in v14) then v14[v13] else f15, globalState) * |v16|, -0x335, |v21|, |(seq(0x67, i0  => ('v')))| - p0, if (f15 in v15) then v15[f15] else f14, if (f15 in v15) then v15[f15] else -|{f15, f15, f15, fm1(globalState), f15}|, f14, p0 / |v12|, fm4(v12, f15, f15, globalState), v25.cf18 % |v27|, p0, f14, f14, p0, |v28|, p0, p0 % f14, |v28|, --|(v29 - {false})|, if (f15) then p0 else 0x2d1, p0, p0, -f14, p0, -(|v12| - f14), |v30| + f14];
			v31[412] := f14;
			var v32: array<set<int>> := new set<int>[16];
			var v33: set<int> := {|(seq(532, i1  => ('q')))|};
			var v34: set<int> := {|v33|};
			v32[128] := v34;
			var v35 := 'o';
			globalState.f1, v31[412], r1, v32[128], globalState.f0 := v35, f14, v31, v33 + v34, f14 / p0;
			r1 := new int[18](i2 => i2 / f14);
			v12 := v12;
			v31 := v31;
		...
		var v37: seq<int> := [|([p0])[-p0 := |v36|]|];
		var v38 := "gttutnx";
		var v39: map<bool, string> := map[!f15 := v38];
		f14 := v37[f14] - |(if (f15 in v39) then v39[f15] else v38)|;
		...
		if (v43 in v38) {
			if (f15) {
				...
				v47 := v47[p0 := v42[175]];
				var v48: seq<bool> := [v42[175], f15];
				v48 := v48 + v48;
				r0 := |v40| - fm4(v38, f15, !f15, globalState);
				f14, globalState.f1 := |(v47 + (map v49 : int | (0xcc <= v49) && (v49 < 0xfc) :: (v49 % -0x1b5) := (f15)))|, v43;
				var v50 := new C1();
			}
			
			var v51: seq<bool> := [v42[175], false];
			var v52 := DC7(v51);
			match (v52) {
				case DC8(cf16, cf17, cf18) =>
					var v53 := new C2();
					var v54: map<bool, int> := map[v42[175] := cf18];
					var v55: multiset<bool> := multiset{v42[175], true, f15, v42[175]};
					var v56: map<int, multiset<bool>> := map[cf18 := v55];
					v54 := v54[false := |v56|];
					var v57: array<int> := new int[8];
					v57[973] := v37[cf18];
					var v58: array<seq<int>> := new seq<int>[25];
					cf17, v43, v57[973], v58 := cf17, v43, cf18 * cf18, v58;
				...
				case DC9(cf19, cf20, cf21, cf22, cf23) =>
					...
					v66[722] := v64;
					v66[722] := v64;
					v42[175] := if (cf23 in cf21) then cf21[cf23] else cf19;
					var v67: array<string> := new string[18];
					v67[111] := v38;
					var v68: seq<seq<bool>> := [v51, [cf22, v42[175]]];
					v67[111] := if (|v68[p0]| != --|multiset{v61.fm3(v37, globalState)}|) then v38 + v38 else v38;
				case DC10(cf24, cf25, cf26) =>
					var v69: array<array<array<int>>> := new array<array<int>>[13];
					var v70: array<array<int>> := new array<int>[12];
					v69[852] := v70;
					v69[852] := if (f15) then v70 else v70;
					...
					v38 := (v38 + v38)[f14 := v43];
					globalState.f4 := if (cf24) then f15 else v42[175];
				case DC7(cf15) =>
					v42[175] := f15;
					var v75 := DC8(v42[175], v38, p0);
					var v76: set<bool> := {v75.cf16};
					var v77: map<bool, set<bool>> := map[!v42[175] := v76];
					var v78: multiset<bool> := multiset{v76 > (if (v42[175] in v77) then v77[v42[175]] else v76)};
					v78 := (v78 * v78)[v42[175] := 0x39e % f14];
					v42[175] := p0 > v37[f14];
					globalState.f0 := f14;
			}
			...
			var v80 := DC33(f14, v79 > multiset(v51), v51[f14]);
			v80 := fm82(globalState);
			r0, globalState.f5, f14 := (p0 - f14) % |v37|, f15 || f15, p0 % (-0x398 - f14);
		} else {
			globalState.f4 := v42[175];
			v37 := (((seq(0x59, i3  => (p0))) + v37) + v37)[-|(v38 + "snydxeouu")| := p0];
			if (f15) {
				...
				v85[679] := (fm83(f15, map[f14 := if (v42[175] in v86) then v86[v42[175]] else p0], globalState))[v43 := false];
				v85[679] := v81;
				var v87: seq<bool> := [true];
				var v88: map<int, int> := map[p0 := |v87|];
				var v89, v90 := m0(f14, v42[175], f15, |v88|, globalState);
				var v92: set<bool> := {v42[175], !f15};
				var v93: set<seq<int>> := {[0x321, |v92|]};
				var v94: seq<set<seq<int>>> := [v93, v93, v93];
				var v95: array<int> := new int[9] [f14, v90 + f14, f14, p0, -p0, p0, v90, |(map v91 : seq<int> | v91 in v94[0x26c] :: (v91) := (v90))|, fm4(v38, f15, v42[175], globalState)];
				v95[183] := f14;
				v95[183] := (f14 * v90) - (if (v42[175]) then v90 else f14);
				v88, v95[183] := v88 + v88, |v89|;
				var v96: map<seq<bool>, string> := map[v87 := v38];
				v38 := "wwlmwh" + (if (fm74(589, v43, v43, v43, globalState) in v96) then v96[fm74(589, v43, v43, v43, globalState)] else seq(0x223, i4  => (v43)));
			} else {
		...
		if (v42[175]) {
			...
			if (true) {
				...
				v101[516] := 0x366;
				v101[516], v42[175], v42 := p0, v42[175], v42;
				...
				var v105 := new C0(v104, v42[175]);
				var v106: map<string, int> := map[v105.fm30(f14, !false, globalState) := f14];
				v106 := v106[v38 := |(seq(0x383, i6  => (v43)))|];
				var v107: map<int, bool> := map[613 := f15];
				var v108: map<int, char> := map[v101[516] := v43];
				var v109, v110 := m0(f14, if (v101[516] in v107) then v107[v101[516]] else v42[175], f15, |v108|, globalState);
			} else {
				var v112: map<int, bool> := map[f14 := f15];
				var v113: seq<bool> := [p0 in (map v111 : int | v111 in v112 :: (v111 / p0) := (f15))];
				v113 := v113;
				v42[175] := (multiset{f14} == v40) || v42[175];
				v42[175] := f15;
				var v114: multiset<seq<bool>> := multiset{[f15]};
				globalState.f5, globalState.f0, globalState.f4, v42[175], v42[175] := v114 !! multiset(seq(0xef, i7  => (v113))), 0x1ba - p0, DC31(v42[175]).cf60, if (f15) then f14 > p0 else fm4("usf", f15, true, globalState) != -513, f15;
				globalState.f4 := f15;
			}
			
			var v115: map<bool, int> := map[v42[175] := p0 + f14];
			v115 := v115 + map[v42[175] := p0];
			v42[175] := f15;
			v115 := v115[f15 := f14];
		} else {
			var v116: seq<bool> := [false];
			var v117: set<bool> := {f15, v116[p0], f15};
			if (fm71(f15, v117 !! v117, f14 == p0, f14, globalState)) {
				globalState.f5 := v42[175];
				var v118: array<array<bool>> := new array<bool>[28];
				v118[739] := v42;
				var v119: map<bool, array<bool>> := map[p0 == p0 := v42];
				globalState.f1, v39, r0, v118[739] := v43, v39 + v39, f14, if (v42[175] in v119) then v119[v42[175]] else v42;
				globalState.f5 := f14 in (seq(0x86, i8  => (f14)));
				var v120 := new C2();
				...
				var v125: array<array<array<int>>> := new array<array<int>>[27] [if (f15 in v122) then v122[f15] else v121, v121, v121, v121, v121, v121, v121, v121, v121, v123[0x1ae], v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, v121, if (f14 in v124) then v124[f14] else v121, v121];
				v125[922] := v121;
				v125[922] := v123[|"r"| % |v117|];
			} else {
				globalState.f5 := v42[175];
				v38 := v38;
				var v126 := DC13(v36);
				var v127 := DC27('c', p0, v42[175], true, v116);
				var v128: map<set<int>, int> := map[v36 := p0];
				globalState.f1, globalState.f4, f14 := fm79(v126.(cf32 := {0xfe, fm4(v38, v42[175], v42[175], globalState)}), v127, v38, globalState), |v36| <= f14, |v128|;
				var v129: map<bool, int> := map[v42[175] := |v38|];
				var v130: array<int> := new int[21] [-f14, fm4(v38, f15, v42[175], globalState), p0, f14 % f14, fm4(v38, v42[175], v42[175], globalState) + p0, p0 + f14, p0 / p0, f14, |v117|, f14, f14, f14, -(-f14 % f14), f14, -(0x5f / -0x38d), if (f15) then p0 else -|v129|, f14, f14 - f14, f14, |v116|, f14];
				v130[842] := p0 - -63;
				v130[842] := p0;
			...
			f14, globalState.f0, v117, r1 := f14, p0 % f14, v117, if (0xeb != p0) then v131 else v131;
			globalState.f4, r0, v117 := !(if (!(v38 == v38)) then f15 else f15), (p0 + f14) - (|v116| / |"mclvvfmhi"|), v117;
			var v132: seq<array<int>> := [v131, v131];
			var v133 := new C0(v132, f15);
			var v134 := new C1();
		}
		
		var v135: multiset<bool> := multiset{v42[175]};
		r0 := if (|(if (!true) then v38 else seq(-0xa6, i9  => (v43)))| in v40) then v40[|(if (!true) then v38 else seq(-0xa6, i9  => (v43)))|] else |v135| * f14;
...
class C4 extends T0 {
	...
	function fm3(p0: seq<int>, globalState: GlobalState): int {
		(--|(seq(349, i0  => (0x3b0)))| - |map[false := true]|) / -0x2
	}
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		if (v0) {
			...
			if (v0) {
				...
				var v21: multiset<int> := multiset{|v20[v1]|};
				...
				v28 := v28[v26 := v27];
				v27[791] := v0;
				v27[791], globalState.f5, globalState.f0 := true, v0, v1 * v11.fm2(globalState);
				v27[791] := v1 < v1;
			}
			
			var v29: seq<bool> := [v0];
			var v30: map<bool, int> := map[v0 := |multiset(v29[-0x11f := true])|];
			globalState.f5 := v30 == (if (v0) then v30 else v30);
			var v31: set<int> := {v1};
			var v32: seq<int> := [v1, -0x163];
			v31 := (v31 * v31) + ({v32[|v32|]} * {v1});
			var v33 := 'f';
			var v34: seq<char> := [v33];
			globalState.f0 := |(v34 + (seq(0x2b, i0  => (v33))))|;
		} else {
			var v35 := 0x3c1;
			globalState.f0 := v35;
			v35 := v35 / v35;
			if (fm1(globalState)) {
				...
				v42[801] := if (v0) then v35 else v35;
				...
				v42[801] := if (((seq(-0xc2, i1  => (v43))) + v44) in v45) then v45[(seq(-0xc2, i1  => (v43))) + v44] else v35;
				var v46: array<bool> := new bool[13];
				v46[958] := !v0;
				var v47: array<map<int, seq<bool>>> := new map<int, seq<bool>>[18](i2 => map[v42[801] := [v0]] + map[v35 := [v0]]);
				var v49: seq<bool> := [v0, v0];
				var v50: seq<int> := [-v42[801], v42[801], |v49|];
				v47[45] := (map v48 : int | v48 in v50 :: (v48 + v42[801]) := (v49))[v42[801] := v49];
				var v51: array<char> := new char[27];
				var v52: seq<array<char>> := [v51, v51, v51, v51, v51];
				var v53: seq<array<char>> := [if (v0) then v51 else v51, v52[v35], v51];
				var v54 := "oxi";
				var v55 := 'c';
				var v56: map<int, char> := map[|v54| := v55];
				v42, v42[801], v46[958], v47[45], v53 := v42, |((if (v0) then v56 else v56) + v56)|, v0, (map v57 : int | (0x304 <= v57) && (v57 < -855) :: (v57 * v35) := (v49)) + map[v42[801] := v49[0x157 := v0]], v53;
				var v58 := DC22(v0, fm57(-417, v55, globalState));
				var v59: map<D10, string> := map[v58 := seq(0x3ce, i3  => (v55))];
				var v60 := DC36(seq(-0x363, i4  => (map[v35 := v35])));
				globalState.f0, globalState.f0, globalState.f0, globalState.f5 := |v54|, |(if (v58 in v59) then v59[v58] else v54[v42[801] := v55])|, |v60.cf69| + v42[801], v0;
				var v61: map<int, int> := map[v42[801] := |v54|];
				var v62: set<int> := {|v61|};
				var v63: multiset<set<int>> := multiset{v62};
				globalState.f0, globalState.f5, v42[801] := v42[801] % ((if (v62 in v63) then v63[v62] else v35) / 0x36f), v46[958], |(v43 - v43)|;
				globalState.f4 := !v0;
			}
			...
			if (v0) {
				...
				globalState.f4, globalState.f0, globalState.f4, globalState.f5 := |(v66[v35 := v64] + "uuuihvypd")| >= 0x21b, v35, v0, (if (v0 in v74) then v74[v0] else 0x251) < (if (|v66| in v75) then v75[|v66|] else v35);
			} else {
				var v76: T0 := new C1();
				...
				var v83: T1 := new C3(v82 * v82, v77[175], !(v66 == v66));
				v83 := v83;
				var v84: set<int> := {v77[175]};
		...
		for i6 := v86 to v86 {
			...
			if ((v89 + v89) != "f") {
				...
				var v91: array<int> := new int[18] [i6 - i6, -i6, i6, v86 - i6, |"kh"| % i6, |multiset{v0}|, |(v88[v86 := i6])[641 := v86]|, v86, i6, v86, i6, i6, v86, i6 - v86, |v90|, |(seq(875, i7  => ('x')))| * fm2(globalState), |v87|, -471];
				var v92 := 'f';
				var v93: map<seq<bool>, string> := map[v87 := ("oamjreqa")[i6 := v92]];
				v91[903] := |(v93 + v93)|;
				var v94: seq<string> := [v89];
				v91[903] := |(if (v0) then v94 else v94)|;
				v87 := fm62(v0, globalState);
				v89 := v89 + ("dhttil" + (seq(0x1fb, i8  => (v92))));
				globalState.f5 := v0;
				...
				var v99: array<bool> := new bool[6] [v0, fm1(globalState), if (v0) then v0 else v0, multiset{i6} == multiset{v86, 0x19f, -v91[903]}, v0, v96 in v98];
				v96[382] := map[v86 := v91[903]] == (map v100 : int | (546 <= v100) && (v100 < 0x1a7) :: (v100 * v86) := (|v87|));
				v96[382], globalState.f0 := v0, v91[903];
			} else {
				globalState.f5 := (i6 - -0x335) != i6;
				var v101: multiset<int> := multiset{i6};
				var v102: seq<multiset<int>> := [v101];
				var v103: map<bool, int> := map[v102[v86] > v101 := i6 / -i6];
				v103 := v103[v0 := -280];
			...
			if (false <==> true) {
				...
				v107[667], globalState.f5, v108 := -(i6 / i6), v0, v108;
				...
				globalState.f4 := v107[667] < (i6 + DC44(v111.f30, v114, v116[v86], v107[667]).cf87);
				var v117: map<bool, int> := map[v111.f30 := v86];
				var v118: map<int, D25> := map[|v117| := DC57(v113)];
				var v119 := DC57(v113);
				globalState.f4 := v111.fm29(v107[667], v118 == map[v107[667] := v119], globalState);
			} else {
				var v120: map<bool, int> := map[false := i6];
				var v121: multiset<bool> := multiset{v0, v0};
				v120 := v120[v0 := |v121|];
				globalState.f4 := v121 > v121;
				globalState.f0 := (i6 % i6) + -v86;
				globalState.f0 := i6 % v86;
				globalState.f0 := i6;
			}
		...
		if (v0 && v0) {
			...
			v130 := v131[v86] * (v130 - v130);
			var v132: array<bool> := new bool[7];
			v132[97] := v0;
			var v133: map<int, bool> := map[fm3(v124, globalState) := v0];
			var v134: seq<bool> := [v0, v0];
			v132[97] := |"m"| < |DC46(v133, v122, v132, v0, v134).cf90|;
			var v135: map<bool, string> := map[v132[97] := v122];
			var v136 := 'p';
			v122 := if (v0 in v135) then v135[v0] else (fm85(v0, globalState))[v86 := v136];
			v132[97] := v132[97];
			v86 := -910;
		} else {
			...
			match (v148) {
				case DC48(cf95, cf96, cf97, cf98, cf99) =>
					var v149 := new C0(v138.f29, v145[v86]);
					v0 := v0;
					var v150: array<bool> := new bool[1];
					v150[191] := v138.f30;
					var v151: multiset<multiset<int>> := multiset{v125, v125};
					v150[191] := (if (!true) then v151 else v151) > v151;
					var v152, v153 := m0(cf99, v150[191] ==> !v138.f30, !v149.f30, cf97, globalState);
				case DC49(cf100, cf101, cf102) =>
					...
					v154[940] := [v155, v155, v155, v155, v155];
					v129[857] := v86;
					var v156: seq<array<D1>> := [v155, v155, v155, v155, v155];
					v154[940], v137, globalState.f0, v129[857], globalState.f4 := v156, v137, v86 / v86, |v122|, fm57(v86, v139, globalState);
					var v157: array<bool> := new bool[7](i12 => v138.f30);
					var v158: array<map<int, bool>> := new map<int, bool>[16];
					var v159: map<int, bool> := map[v129[857] := false];
					v158[754] := v159;
					var v160 := DC46(v159, v122, v157, cf101, v145);
					v157, v0, v158[754], v122 := v160.cf91, |fm86(globalState)| == (if (v138.f30) then v129[857] else v86), v159, v122[v129[857] := v148.cf95];
				case DC50(cf103) =>
					v145 := v145;
					var v161: array<bool> := new bool[18];
					v161[950] := cf103;
					v161[950] := v0;
					var v162 := new C3(multiset{v128.(cf66 := v0)}, |v124| % |(seq(-0xac, i13  => (v148.cf95)))|, !!v161[950]);
					v86 := v86;
				case DC47(cf94) =>
					v86 := v86 * (v86 * v86);
					v129[881] := v86 % v86;
					p0[181] := v129;
					globalState.f0, v129[881], p0[181], v146, globalState.f5 := fm2(globalState), 0x7a, v129, DC27(v139, v86, v0, fm57(v86, v122[v86], globalState), v145 + v145), v0;
					var v163: map<bool, int> := map[v138.f30 := v129[881]];
					v163 := v163;
					globalState.f5 := v138.f30;
				case DC51(cf104) =>
					var v164: map<char, int> := map[fm79(v144, v146, seq(285, i14  => (v139)), globalState) := v86 % -v86];
					...
					v164 := fm87(fm2(globalState), v86 % v86, |v166.cf2|, globalState);
					var v167: map<bool, int> := map[if (v0) then v0 else v138.f30 := v86 / v86];
					v167 := v167[v0 := v86 * v86];
					p0[213] := v129;
					p0[213] := v129;
					var v168: array<string> := new string[5](i15 => "dccga");
					v168[438] := (seq(0x2bf, i16  => (v139))) + v122;
					globalState.f1, v86, v168[438] := fm79(v144, v146, v122, globalState), 0x319, v122;
			}
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
			...
			decreases 100 - i0
		{
			...
			var v4 := 'f';
			var v5: seq<string> := [seq(0x2fe, i1  => (v4))];
			var v6: array<string> := new string[10] [(if (fm2(globalState) in v2) then v2[fm2(globalState)] else v1) + v1, "qgnm", v1, v1, ("btyfftv")[if (p0 in v3) then v3[p0] else v0 := 'u'], v1[v0 := v4], v1 + v5[v0], "bmx", "xc", v1];
			v6[398] := v1 + v1;
			var v7: seq<array<int>> := [p1];
			p1[584], v6[398], v1, v7 := v0, v1, v1, v7;
			p1[584] := p1[584];
			var v8 := DC8(p0, v1, |"m"|);
			var v9 := DC34(v8, p0, v6[398]);
			var v10: multiset<D16> := multiset{v9, v9, v9};
			var v11 := new C3(if (p0) then v10 else v10, if (p0) then p1[584] else v0, p0);
			v4 := v4;
		}
		var v12 := 0x271;
		p1[144] := -v12;
		...
		p1[144] := if (p0 in v16) then v16[p0] else v12;
		var v17: array<string> := new string[25](i3 => "cixtkhk");
		forall i2 | 0 <= i2 < v17.Length {
			v17[i2] := DC34(DC8(p0, "xtbdtv", |multiset{-|{p0, p0, p0}|, p1[144]}|), p0, "tb").cf67 + ((seq(0x14, i4  => ('q'))) + "s");
		}
		var i5 := 0;
		while (p0)
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v19: set<int> := {p1[144], p1[144], p1[144]};
			var v20 := "lxts";
			p1[144] := if ((set v18 : int | (580 <= v18) && (v18 < -0x2c0) :: (v18 / |map[p0 := if (p0 in v16) then v16[p0] else p1[144]]|)) > v19) then |v20| else v12;
			var v21 := DC31(true);
			p1[144], globalState.f5, globalState.f4, globalState.f5 := v12, (if (p0) then p0 else v21.cf60) && p0, p0, !p0;
			var v22 := 'o';
			...
			var v27 := DC20(v25 + (map v26 : int | (580 <= v26) && (v26 < 946) :: (v26 + p1[144]) := ("wd")));
			var v28: seq<bool> := [p0];
			var v30 := DC13(set v29 : int | (0x281 <= v29) && (v29 < 0x155) :: (v29 + v12));
			var v31 := DC27('t', p1[144], p0, p0, v28);
			var v32: map<int, bool> := map[|v28| := p0];
			p1[144], v24, globalState.f0, v27 := -p1[144], (v24 + v24) + v24[v28[0x328] := multiset(v15)], if (false) then |([v22, v22, v22, fm79(v30, v31, v20, globalState), v22] + v20)| else -|v32| / v12, DC20(v25 + v25);
		...
		var v38: array<bool> := new bool[7] [p1[144] < v12, true, p0, |v15| != 0x23c, p0, p0, p0 <== !(if (v36 in v37) then v37[v36] else p0)];
		v38[559] := if (p0) then p0 else p0;
		v38[559] := p0;
...
class C5 extends T0 {
	...
	function fm2(globalState: GlobalState): int {
		|(seq(-157, i0  => (f35)))| + |({"osieuh"} * {"pc"})|
	}
	function fm3(p0: seq<int>, globalState: GlobalState): int {
		|("hu" + "yqygqlqw")| / (0x162 + --0x337)
	}
	function fm53(globalState: GlobalState): bool {
		match DC18(multiset{"e", "svx", "hgmiifvw"}) {
			case DC19() => false
			case DC18(cf37) => f35 in (seq(0x30e, i0  => (f35)))
		}
	}
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		if (v6.cf3) {
			...
			var v15: array<bool> := new bool[27] [v2 > |v12[v2]|, fm53(globalState), DC27(f35, |v14[v2]|, v1, !v1, v11).cf55, if (true) then false else v1, v1, true, |map[v1 := v2]| > v2, true, fm53(globalState), v1, false, false, v1 || v1, v1, v1, v2 != v2, v2 >= v2, v1, !v1, v1, v1, v1, v1, v1, v1, v1, v1];
			...
			var v22: seq<D18> := [v21];
			var v23 := DC41(v22);
			var v24: array<seq<D18>> := new seq<D18>[17] [v22[v2 := v21], v22, v22 + v22, v22, v22, v22, [v21, v21, v21], v22 + [v21], v22, [v21, v21, v21], v23.cf79, v22 + v22, [v21] + v22, [DC40(v21.cf78)] + [v21, v21], v22, v22, v22];
			v24[466] := v22;
			v24[466] := (v22 + v22)[v2 := v21];
			if (fm53(globalState)) {
				v15[287] := v1;
				var v25: array<seq<bool>> := new seq<bool>[14] [v11 + v11, (if (v1) then v11 else v11)[v2 := v1], [v1, v1, v1, v1, v1], v11 + v11, (v12[v2])[v2 := v1], [true], v11, v11, v11[fm3(v5, globalState) := v1], fm54(globalState), v11, v11, fm54(globalState), v11];
				globalState.f0, v15[287], v25 := v2, v1 && (v17 <= v17), v25;
				globalState.f4 := v15[287] ==> v1;
			...
			var v32 := DC21(v2, v1, v2 % v2, v30, v31);
			v32 := v32;
		}
		
		var v33 := DC36(seq(0x1f3, i2  => (map[-|multiset{v1, v1}| := v2])));
		...
		if (v34[707]) {
			...
			globalState.f4 := v1;
			globalState.f0 := -v2;
			var v35: multiset<bool> := multiset{v34[707]};
			var v36: map<int, multiset<bool>> := map[v2 := v35];
			var v37: seq<bool> := [v34[707]];
			var v38: array<multiset<bool>> := new multiset<bool>[16] [v35, v35 - v35, v35, if (v2 in v36) then v36[v2] else multiset(fm54(globalState)), v35[v34[707] := -v2], v35, v35, v35, v35 + v35, multiset{v1} + v35[!v1 := v2], multiset(v37) - v35, v35, v35, v35, v35, v35];
			v38[886] := multiset{!v1, v34[707]};
			var v39: array<seq<D17>> := new seq<D17>[14];
			var v40 := DC37(v1, v34[707]);
			var v41: seq<D17> := [v40, v40];
			v39[24] := v41 + v41;
			v38[886], v39[24], v1, globalState.f0, globalState.f0 := fm55(v1, v34[707], globalState) - v35, v41[v2 := v40] + v41, v34[707], v5[if (fm1(globalState)) then fm2(globalState) else fm2(globalState)], if (fm53(globalState)) then |v4| else v2;
			...
			match (v43) {
				case DC40(cf78) =>
					...
					var v45 := "q";
					var v46 := DC24(v45[v2]);
					var v47 := DC49(v44, v1, v34[707]);
					v5, globalState.f5, globalState.f1, v44 := v5 + (if (v34[707]) then v5 else v5), fm1(globalState) && v34[707], v46.cf47, (multiset{v2} + multiset(v5)) + v47.cf100;
					var v48: map<bool, int> := map[v34[707] := v2];
					v48 := v48[v1 := v2 / -0x138];
					v34[707] := v1;
					globalState.f0 := v2;
			}
			...
			var v49 := new C2();
			var v50: multiset<bool> := multiset{v34[707]};
			var v51: map<bool, bool> := map[v34[707] := v1];
			var v52: seq<map<bool, bool>> := [v51, v51, v51, v51];
			var v53 := DC9(v34[707], v34[707], v51, v34[707], v34[707]);
			globalState.f0, v1, v5, v5, v50 := -v2 / v2, DC61(v52).cf121 != ([v51, v53.cf21, fm0(v2, globalState), fm0(v2, globalState), v51] + [v51]), ((seq(0x1b6, i3  => (v2))) + v5) + v5, v5 + (v5 + [v2, v2]), v50;
			if (v1 <== false) {
				var v54 := new C4();
				var v55 := new C4();
				var v56: array<int> := new int[14](i4 => i4 + |[!v34[707]]|);
				var v57: seq<array<int>> := [v56];
				var v58: C0 := new C0(v57, v34[707]);
				v58, globalState.f4 := v58, !(v50 <= v50);
				var v59 := new C1();
				var v60: seq<bool> := [v1];
				globalState.f4 := v60[v2 / -v2];
			} else {
				...
				var v63 := new C2();
				var v64 := "br";
				var v65 := DC34(DC8(v1, v64, v2), v34[707], v64);
				var v66: array<string> := new string[14] [v64, (v64 + ("nlwk")[-0x271 := f35])[v2 := f35], v64, v64, "tjce", "buwqyv", if (fm1(globalState)) then v64 else v64, "uuvust", v64, v65.cf67, v64 + v64, v64, "wao" + v64[--0x13d := f35], v64];
				v66[927] := v64;
				v66[927] := ((v64 + v64)[-v2 * v2 := f35])[v2 := f35];
				globalState.f0 := fm2(globalState);
				var v67: seq<bool> := [v34[707], v34[707]];
		...
		v68[61] := v2;
		var v69 := DC31(v34[707]);
		v68[61] := match v69 {
			case DC31(cf60) => |multiset{false, v1}| + v2
			case DC30(cf59) => 0x13
		};
		var v70 := DC62(v34[707], v2);
		for i6 := v70.cf123 to -0x55 {
			var v71: multiset<bool> := multiset{v34[707]};
			var v72: map<bool, seq<int>> := map[!v1 := v5];
			var v73: map<bool, int> := map[(if (!true in v71) then v71[!true] else -0x1c5) in (if (v1 in v72) then v72[v1] else v5) := 0x222 / v2];
			v73 := v73[false := v2 * v2];
			globalState.f5 := v1;
			if (v34[707]) {
				globalState.f5 := v1;
				globalState.f4, v2 := v34[707], v68[61];
				v34[707] := v34[707];
				var v74: array<D1> := new D1[27];
				v74 := v74;
				var v76: map<int, set<int>> := map[i6 := (set v75 : int | v75 in v3 :: (v75 / 0x6f)) - v3];
				var v77 := "ygsljlsx";
				var v78: seq<string> := [v77];
				var v79: multiset<string> := multiset{v78[v68[61]]};
				v76, globalState.f0, v79, globalState.f4 := v76, |v77[-|v5| := f35]| + |(v77 + v77[i6 := f35])|, v79, 0xdb != ((if (v1 in v73) then v73[v1] else v68[61]) + v68[61]);
			} else {
				globalState.f0 := i6;
				v1 := !v1;
				var v80 := DC37(v1, v1);
				var v81: seq<bool> := [v34[707], v1, v1, !false, v80.cf71];
				globalState.f0 := |v81| - v2;
				m23(!v34[707], globalState);
				globalState.f0 := v2 / i6;
			}
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
			...
			decreases 100 - i0
		{
			...
			var v0 := 0x3d6;
			p1[554] := -v0;
			r2, p1[554], globalState.f5 := f35, 0x2ea, p0;
			globalState.f4 := p0;
			...
			var v6: set<bool> := {p0};
			var v8 := "jutjwsvsf";
			v3[303] := v5[|v6|] + (map v7 : string | v7 in ["qjxg", v8, "k", v8] :: (v7) := (v0));
			var v10: multiset<string> := multiset{v8};
			v3[303] := (map v9 : string | v9 in v10 :: (v9) := (v0))[v8[v0 := f35] := 0x2b5];
			var v11: multiset<int> := multiset{v0, -p1[554]};
			...
			var v16: array<bool> := new bool[26] [p1[554] in v11, p0, fm53(globalState), false, fm53(globalState) <== p0, fm1(globalState), p1[554] <= -p1[554], v13 < multiset{p0}, p0, p0, fm2(globalState) != p1[554], p0 && p0, p0, p0, !(v11 >= v11), if (p0) then p0 else p0, p0, v14 != v14, p0, p0, true, v0 == |v14[p1[554] := false]|, !(if (v8 in v15) then v15[v8] else p0), p0, p0, p0];
			v16[951] := !p0 ==> p0;
			var v17: array<map<int, bool>> := new map<int, bool>[12](i2 => map[v0 := p0] + map[v0 := p0]);
			var v18: map<int, bool> := map[p1[554] := true];
			v17[263] := v18 + v18;
			var v19 := DC24(f35);
			var v20: map<char, int> := map[f35 := v0];
			var v21 := DC44(p0, map[v16 := p0], map[|v14| := p0], |v20|);
			v16[951], v17[263], globalState.f4, p1[554], v19 := (v0 + |v6|) < p1[554], v21.cf86, p0, v0 / p1[554], v19;
		}
		var v22 := -896;
		globalState.f0 := v22 / |[f35, f35]|;
		var v23: map<bool, bool> := map[!p0 && p0 := !p0];
		r0 := |v23|;
		var v24 := "jmanlnv";
		v22 := (if (p0) then v22 else v22) / |(v24 + v24)|;
		var i3 := 0;
		while (!p0)
			decreases 100 - i3
		{
			...
			match (v27.(cf90 := v24, cf91 := v25, cf93 := v26 + v26, cf89 := v28)) {
				case DC46(cf89, cf90, cf91, cf92, cf93) =>
					...
					v30[583] := if ((v22 % v22) in v31) then v31[v22 % v22] else 'v';
			...
			if (!(v37 !! fm55(p0, p0, globalState))) {
				...
				var v41 := new C0(v40[v22], p0);
				v23 := v23[v41.f30 := v41.f30];
				var v42: array<array<int>> := new array<int>[2];
				var v43: map<array<array<int>>, int> := map[v42 := p1[911]];
				var v44: seq<int> := [v22];
				v43 := v43[v42 := |v44| * v22];
				...
				globalState.f0 := -|v45|;
				var v46 := new C1();
				var v47 := DC25(v22, map[v22 := false], p1[911]);
				r0, v22, globalState.f5 := -(v22 - v47.cf48), if (p0) then v22 else p1[911], p0 ==> p0;
				v25[972] := p0;
				v25[972] := false;
			}
		...
		if ((f35 !in v24) <== p0) {
			...
			globalState.f1, globalState.f0 := f35, v22 / v22;
			...
			if (p0) {
				...
				globalState.f4, r0, v55[667] := p0, |(v24 + v24)|, v23 !in v57;
				var v58: array<int> := new int[18](i8 => i8 - p1[195]);
				var v59: seq<array<int>> := [v58, v58, v58];
				var v60 := new C0(v59, if (!p0) then p0 else v55[667]);
				v24 := v24;
				var v61: map<bool, char> := map[p0 := f35];
				v61 := v61[v60.f30 := f35];
				p1[195] := (p1[195] / p1[195]) + v22;
			} else {
				var v62: map<bool, int> := map[!p0 := v22];
				globalState.f4 := (if (p0 in v62) then v62[p0] else p1[195]) <= v22;
				var v63: map<int, string> := map[p1[195] := seq(0x12f, i9  => ('o'))];
				v63 := v63[0x12 := v24];
				var v64: seq<int> := [fm2(globalState)];
				var v65: seq<seq<int>> := [fm66(v22, v24[v22], p0, globalState), v64];
				var v66: map<char, seq<seq<int>>> := map[f35 := v65];
				v65 := ((if (f35 in v66) then v66[f35] else [v64]) + v65) + fm89(p1[195], globalState);
				v55 := v55;
				var v67: multiset<int> := multiset{p1[195]};
				var v68: map<char, int> := map[f35 := v22];
				v22 := fm3([p1[195], if (p1[195] in v67) then v67[p1[195]] else |v68|, v22, -v22], globalState) % |((seq(0x16d, i10  => (DC55(false, p0, 'h', p0).cf110))) + v24)|;
			}
			
			p1[195] := p1[195];
			if (p0) {
				var v69: map<array<bool>, bool> := map[v55 := true];
				var v70 := DC44(p0, v69, map[p1[195] := fm53(globalState)], v22);
				...
				globalState.f0 := -((v22 - p1[195]) / p1[195]);
				var v75: set<bool> := {!p0, p0};
				var v76: seq<set<bool>> := [v75];
				var v77 := DC26(v75);
				v76, globalState.f5, globalState.f0, globalState.f4 := [v75] + v76[v22 := v77.cf51], fm53(globalState), p1[195], !(v22 < 0x2bc);
				var v78 := DC14(p1[195]);
				var v79: map<D5, array<bool>> := map[v78 := v55];
				var v80: map<int, int> := map[p1[195] := -|v79|];
				v80 := v80 + map[v22 := -p1[195]];
				p1[195] := -|v24|;
			} else {
				var v81: multiset<string> := multiset{v24};
				var v82: map<map<bool, bool>, int> := map[map[p0 := p0] := v22];
				globalState.f4, globalState.f4, globalState.f0, globalState.f5 := !p0, (if (v24 in v81) then v81[v24] else v22) == |v82|, p1[195], p0;
				var v83: map<string, bool> := map[seq(0x35f, i11  => (f35)) := p0];
				var v84 := DC48('f', false, p1[195], 'x', p1[195]);
				var v85: seq<int> := [v84.cf97];
				var v86: map<bool, int> := map[v24[p1[195] := f35] in v83 := |((seq(0x2d, i12  => (v22))) + v85)|];
				r0 := if ((p0 <== p0) in v86) then v86[p0 <== p0] else p1[195] % v85[p1[195]];
		...
		r0 := (v22 % |v90|) % (v22 % |fm66(v22, f35, p0, globalState)|);
	...
	method m23(p0: bool, globalState: GlobalState) {
		...
		globalState.f5 := (v0[|v0| := p0] != [if (p0 in v1) then v1[p0] else p0]) ==> fm53(globalState);
		var v2 := 370;
		for i0 := -v2 to v2 % v2 {
			globalState.f0 := -((i0 - v2) / v2);
			...
			var v6 := DC28(v5);
			var v7 := new C0(v5 + v6.cf57, v0[v2]);
			...
			v10[252] := false;
			v10[252] := v7.f30 ==> (if (p0) then v7.f30 else p0);
		}
		globalState.f4 := p0;
		...
		v2, globalState.f4, v11, globalState.f4 := v2, if (p0) then p0 else v14 <= v16, v17[v2], p0;
		...
		for i1 := v25.cf31 to v2 {
			...
			v28[530] := if (v2 in v30) then v30[v2] else v29;
			v28[530] := v29;
		}
	}
	method m24(p0: bool, p1: string, p2: bool, globalState: GlobalState) {
		...
		var v7: map<int, bool> := map[|v6[v0 := v0]| := true];
		var v8: multiset<bool> := multiset{if (v0 in v7) then v7[v0] else p2};
		v3, v0, v0, v0 := [v0, v0], v3[|v5.cf129|], -(if (p0) then |p1| else if (p2 in v8) then v8[p2] else v0) + v0, fm2(globalState);
		for i0 := v0 to |p1| {
			var v9 := new C2();
			if (if (true) then !(v8 == multiset(([p0])[i0 := p2])) else p2) {
				...
				v11[693] := |{|v4|}|;
				globalState.f0, v12, v13, v11[693] := fm2(globalState), v12, v13, v0;
				v11[693] := v11[693];
				var v14: array<bool> := new bool[20];
				v14[942] := p2;
				v14[942], globalState.f0, v7 := if (v11[693] in v7) then v7[v11[693]] else p2, --v11[693], map[v0 % -v11[693] := fm1(globalState)];
				globalState.f4 := p1 < p1;
				globalState.f0 := |p1| - v11[693];
			} else {
				var v15 := new C1();
				v0 := -v0;
				...
				v16[330], v18 := !!true, v18.(cf21 := v17, cf23 := p0, cf20 := p2).(cf21 := map[p2 := p2]);
				var v19: array<int> := new int[25](i2 => i2 % i0);
		...
		if (p2) {
			...
			var v23: seq<bool> := [p0, p0, v0 in v6[v0 := |v21|], v0 < 0xc4, |"n"| in v22];
			v23 := v23;
			if (v0 > (if (p2) then v0 else v0)) {
				...
				v3, globalState.f4, v0, v27, v28 := v3, v25[803], |([v24[839]] + v3)|, v27, v28;
			} else {
				globalState.f5 := p0;
				var v29: set<bool> := {p2};
				var v30: set<int> := {v0};
			...
			globalState.f5, globalState.f4, v46[636] := (v0 <= |[-v0, v0]|) <==> true, if (v0 in v7) then v7[v0] else !p0, |v48|;
			if (p2) {
				v0 := v0;
				v46[636] := fm2(globalState);
				globalState.f0 := v46[636] / v46[636];
				globalState.f5 := p0;
				var v49 := DC48(f35, p2, if (p0) then |"sgfo"| else v0, f35, v0);
				v49 := v49;
			} else {
				v46[636] := (if (true) then |v3| else |fm91(false, fm92(|p1|, p0, v0, v0, globalState), globalState)|) - (if (!fm53(globalState) in v8) then v8[!fm53(globalState)] else v3[v46[636]]);
				v3 := [v46[636]] + v3;
				var v50 := new C2();
				globalState.f5 := p0;
				globalState.f5 := v47[|v8|];
			}
			
			v42 := v42;
			var v51: multiset<seq<int>> := multiset{v3, seq(0x38d, i5  => (0x194)), [v46[636], v46[636], -v0, v46[636]]};
			var v52: array<D12> := new D12[20];
			var v53: multiset<array<D12>> := multiset{v52};
			var v54: map<multiset<seq<int>>, int> := map[v51 := |v53| - -v46[636]];
			v54 := v54[v51 := v0];
		}
		...
		if (v0 > v0) {
			...
			v55[258] := (if (p0) then |(map v56 : seq<char> | v56 in (seq(0x369, i6  => (p1))) :: (v56) := (p0))| else |v57|) % 983;
			var v58: map<int, int> := map[v0 := v55[258]];
			v7 := map[v55[258] := !(v55[258] < |v58|)];
			var v59: seq<array<int>> := [v55, v55];
			var v60 := new C0(v59[v0 := v55] + v59[284 := v55], p2);
			var v61: map<bool, bool> := map[v60.f30 := p2];
			globalState.f4 := v57[-|v61| / v55[258]];
		} else {
			if (p2) {
				var v62: seq<bool> := [p0];
				globalState.f4 := v62[v0];
				...
				var v71 := DC69(v70);
				v66[812], globalState.f1, globalState.f1, v67, v68[337] := p0, f35, f35, if (!p0) then v67 else v67, |((v71.cf134[false := v69] + map[p2 := v69]) + (fm93(p2, v0, globalState) + map[p0 := v69]))|;
				...
				var v78: array<multiset<int>> := new multiset<int>[24] [v6, multiset{|v75|}, v6, v6, v6 - v6, v6 + v6, v6, v6, v6, v6, multiset{v0, v68[337]}, if (p0) then v6 else v6, (multiset{v0})[|p1| := -v0], v6, multiset{-v0, v0, v0, v68[337]}, v6, v6 - v6, v6, v6, multiset{|v77|}, v6, v6 + v6, multiset{-0x2fa, v0} + v6, v6];
				v78[381] := v6;
				var v79: map<bool, set<int>> := map[p0 := v65];
				var v80 := DC63(v68[337], f35);
				v66[812], v78[381] := p0, multiset{0x27 - v68[337], v0, |{|(if (p2 in v79) then v79[p2] else fm91(p2, v80, globalState))|, v68[337]}| + 0x1db};
				globalState.f0 := v0;
				var v81 := new C4();
				var v82 := new C2();
			}
			...
			var v85 := DC16(v84);
			var v86: seq<seq<int>> := [fm81(v0, f35, globalState), fm81(|p1|, f35, globalState), v3, seq(-0xb2, i9  => (v0)), [v0, v0] + v3];
			var v87: map<string, bool> := map[p1 := p2];
			v83[6], v3, v85, globalState.f4 := p1 + p1, v86[|v87|], v85, p2;
			var v88: array<int> := new int[13](i10 => i10 % |p1|);
			v88[461] := v0;
			var v89 := DC23(v7);
			v88[461], globalState.f0, globalState.f5 := if (if (p0) then fm1(globalState) else p0) then |(v7 + v89.cf46)| else v0, v0, p0;
			globalState.f5 := p2;
			var v90: array<bool> := new bool[4];
			v90[314] := p0;
			v90[314] := !((v83[6][v88[461] := f35] + v83[6]) != (v83[6] + v83[6]));
		}
...
class C6 extends T0 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		if (v0) {
			...
			var v3: seq<int> := [v2];
			var v4: seq<bool> := [v0];
			var v5: set<int> := {v2 / fm3(v3, globalState), |(v4[v2 := true] + [v0, v0, v0, v0])|, |map[v2 := v0]| % v2, v2 % v2};
			v5 := v5 * v5;
			...
			var v17: array<bool> := new bool[27] [v0, v0, |(map v9 : int | (0x36f <= v9) && (v9 < 0x72) :: (v9 + v2) := (|map[-v2 := v0]|))| > |v10|, !v0, v0, v0, v0, v4[-|v12|], !!false, (seq(414, i0  => (v11))) == v14.cf67, v0, !(-v2 != v2), v0, v0, v0, if (v0) then v0 else v0, v0, v0, if (!v0) then v0 else v0, v0, !true <== v0, v0, v16[v2] != v15, v0, v0, true, v0];
			...
			v21[158], v28 := v26, v28[multiset(v29) := fm3(v30, globalState)];
			var v31: array<map<int, bool>> := new map<int, bool>[13];
			var v32: map<int, bool> := map[v19 := v0];
			v31[746] := v32;
			var v34: set<int> := {v19};
			v31[746] := v32 + (map v33 : int | v33 in v34 :: (v33 + |multiset(v29)|) := (v0));
		}
		...
		if (0x1a2 == |v36|) {
			...
			globalState.f4, globalState.f5, globalState.f5 := v0, !v0, |"ytlvxe"| >= (v35 % v35);
			var v40: seq<string> := [v38, v38, v38, v38];
			var v41: array<string> := new string[21] [v38, v38, v40[|v38|], v38, v38, seq(44, i3  => ('f')), v38, seq(224, i4  => ('l')), "sdwggv", v38, v38, v38, v38, "ibwtxpjda", "hkiab", v38, v38, seq(0x3a3, i5  => ('c')), v38, "bmeq", v38];
			var v42: array<array<string>> := new array<string>[19] [v41, v41, v41, if (v37[451]) then v41 else v41, v41, v41, v41, v41, v41, v41, v41, if (v0) then v41 else v41, DC40(v41).cf78, v41, v41, v41, v41, v41, v41];
			v42[249] := v41;
			var v43 := DC40(v41);
			v42[249] := if (v37[451]) then v41 else v43.cf78;
		} else {
			var v44: array<int> := new int[18];
			...
			match (v47) {
				case DC23(cf46) =>
					...
					var v50: map<bool, bool> := map[v0 := !v49[-0x14d]];
					var v51: map<bool, bool> := map[v0 := if (v0 in v50) then v50[v0] else v0];
					var v52 := "eqrsrysg";
					var v53 := DC71(|v52|, v52, v35);
					var v54 := DC8(v0, seq(-0x399, i6  => ('l')), v35);
					v44[300], v48, v51, v52, globalState.f0 := (v53.cf140 / v35) / v35, v48, v50, v52, v54.cf18;
					var v55: array<int> := new int[17](i7 => i7 * v44[300]);
					var v56 := new C0([v55], !v0);
					globalState.f4 := v0 in v49;
					var v57: seq<string> := [fm85(v0, globalState), v52];
					var v58: seq<int> := [|((v57[v35])[-0x219 := 'l'] + "ri")|];
					v58 := v58;
			}
			
			var v59 := "ms";
			var v60: seq<bool> := [v0];
			var v61: set<int> := {|DC8(v0, seq(0x42, i8  => ('e')), v35).cf17|, -0x389};
			...
			v62[564] := v59 < v63.cf90;
			v62[564] := v0;
			globalState.f0 := v35;
			if ((v35 > v35) <==> v0) {
				var v64: map<bool, string> := map[v62[564] := v59];
				...
				var v69: set<multiset<D30>> := {if (v0) then v68 else v68, v68 + v68, v68[DC70(v35, v46, |[v62[564], v62[564]]|) := |v36|] - v68};
				...
				var v74: map<bool, bool> := map[v62[564] || v62[564] := multiset(v71) >= v73[v35]];
				v74 := v74[true := v62[564]];
			} else {
				v44[303] := --v35;
				v44[303] := |(v59 + fm85(!v0, globalState))|;
				var v75 := 'n';
		...
		match (match v86 {
			...
			case DC67(cf130, cf131) =>
				...
				v87[180] := if (p0 in v88) then v88[p0] else v0;
				cf131 := v35 == |v83|;
				var v89 := 'q';
				v0, globalState.f1, globalState.f0, v87[180] := v0, v89, v35, (if (v0) then cf131 else cf130) <==> cf131;
				var v90: array<int> := new int[10](i10 => i10 % v35);
				v90 := v90;
			...
			case DC66(cf129) =>
				...
				v95[163] := v0;
				v95[163] := v0;
				var v96: map<bool, bool> := map[v35 > v35 := v95[163]];
				v96 := v96;
		}
		...
		for i11 := -v35 to v35 {
			...
			v121[598] := if ((seq(-917, i14  => (v103))) in v122) then v122[seq(-917, i14  => (v103))] else v103;
			v121[598] := v83[v35 - i11];
		}
	}
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		var v0: array<bool> := new bool[22];
		v0[168] := if (p0) then p0 else p0;
		var v1 := 0x147;
		var v2: seq<bool> := [p0, p0];
		v0[168] := !match DC65(v1, |v2|) {
		...
		for i0 := |(v4 - multiset(v2))| to |v5| {
			r0 := -i0;
			var v6: map<int, bool> := map[526 * i0 := v0[168]];
			v6 := v6[i0 % v1 := if (p0) then p0 else p0];
			globalState.f4 := v0[168];
			var v7 := DC68(!v0[168], 0x1d0);
			if (v7.cf132) {
				globalState.f4 := false;
				var v8 := DC8(v0[168], v3, i0);
				...
				var v18: map<bool, int> := map[v0[168] := i0];
				var v19: map<int, map<bool, int>> := map[|v17| := v18];
				v12, globalState.f0 := map v13 : multiset<D12> | v13 in ({if (p0 in v14) then v14[p0] else multiset{v15}, multiset{v15, v15}} + fm96(v0[168], globalState)) :: (v13) := (v11), (if (v1 in v16) then v16[v1] else |v2|) % |v19|;
				globalState.f4 := v11 < v11;
				var v20: map<bool, bool> := map[if (i0 in v6) then v6[i0] else p0 := fm51(v1, v1, v1, i0, globalState)];
				var v21: array<map<bool, bool>> := new map<bool, bool>[13] [v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, map[v0[168] := p0], v20];
				var v22: seq<int> := [i0, i0, v1, v1];
				var v23 := DC0(v21, [v0[168], false], v22, p0);
				var v24 := DC2(p0, v23, v0[168]);
				var v25: map<bool, bool> := map[v0[168] := v24.cf7];
				v20 := (v20 + v25[true := p0]) + v20;
				var v26 := DC44(v0[168], map[v0 := v0[168]], v6, i0);
				var v27: seq<multiset<bool>> := [v4, v4];
				var v28, v29, v30 := m21(v26.cf87 / v1, v27 + v27, v0[168], if (v1 in v16) then v16[v1] else |v11|, globalState);
			} else {
				var v31: multiset<int> := multiset{v1};
				p1[63] := |v31|;
				p1[63] := i0;
				var v32 := DC6(fm97(v3, globalState));
				var v33 := DC60(p0, -p1[63], v0[168] <== p0, v0[168], |v3|);
				var v34 := DC5(p1[63]);
				v32, globalState.f0, p1[63], v33, v0[168] := if (p0) then DC6(v34) else v32, p1[63], v1, if (v0[168]) then v33 else v33, v4[v0[168] := -v1] !! v4;
				var v35: map<bool, int> := map[p0 := 253];
				var v36 := DC3(v0[168], v0[168], v35, v0[168]);
				var v37: array<map<bool, int>> := new map<bool, int>[13] [v35, v35, v35, v35, v35, v35[false := |v3|], v35, (map[p0 := i0])[v0[168] := v1], v35, map[p0 := v1], v36.cf10, v35, map[p0 := v1]];
				var v38: seq<int> := [i0, i0];
				var v39: map<array<map<bool, int>>, bool> := map[v37 := fm50(v38, v0[168], globalState)];
				v39 := v39[v37 := p0];
				globalState.f4 := v0[168] || false;
				p1[63] := fm3(v38[v1 := fm3(v38, globalState)], globalState);
			}
			...
			decreases 100 - i1
		{
			...
			v40 := if (v0[168]) then v40 else if (v1 in v43) then v43[v1] else v40;
			var v44: seq<int> := [v1, v1, v1 % v1, v1 % v1, |v3| * v1];
			v1 := v44[0x2be];
			globalState.f0 := 0x31 % v1;
			match (DC60(v0[168], v1, v1 > v1, fm1(globalState), v1)) {
				case DC60(cf116, cf117, cf118, cf119, cf120) =>
					cf119 := true;
					...
					var v49: array<multiset<array<int>>> := new multiset<array<int>>[19] [v45, v47[|[cf118]|], v45, v45, multiset{if (cf117 in v48) then v48[cf117] else p1}, v45, v45 - v45, v45, v45 - v45, v45, if (cf116) then v45 else v45, v45, v45, multiset{p1, p1, p1, p1, p1}, v45, v45, v45, v45, v45];
					v49[281] := v45;
					var v50: T0 := new C4();
					var v51 := DC53(|map[cf116 := |v3|]|);
					var v52: set<D23> := {v51};
					var v53: map<int, T0> := map[v1 := v50];
					var v55 := DC73(set v54 : D23 | v54 in (seq(0xe0, i2  => (v51))) :: (v54));
					v49[281], v50, v1, v52 := (multiset{p1})[p1 := v1], if (0xdb in v53) then v53[0xdb] else v50, v1 - v1, v52 - (v55.cf143 - v52);
					v40 := v40;
					var v56: map<bool, int> := map[true := cf117];
					v56 := v56;
				case DC59(cf115) =>
					var v57: map<int, bool> := map[v1 / 0x215 := p0];
					var v58: set<int> := {0x37f, |v3|};
					v57 := v57[|v58| := !p0];
					var v59 := new C2();
					var v60: array<int> := new int[29];
					globalState.f5, v60, globalState.f4 := v0[168], v60, fm1(globalState);
					var v61: map<bool, bool> := map[true := v0[168]];
					var v62 := DC5(|v61|);
					v62 := v62;
			}
			
		}
		var v63: array<int> := new int[14](i3 => i3 % v1);
		v63 := p1;
		r0 := v1;
		var v64 := 'k';
	...
	method m21(p0: int, p1: seq<multiset<bool>>, p2: bool, p3: int, globalState: GlobalState) returns (r0: string, r1: seq<array<int>>, r2: int) {
		...
		forall i3 | 0 <= i3 < v19.Length {
			v19[i3] := map[{'o', 'p'} !! {'i', 'u'} := -p3 / p3];
		}
		var v20: array<bool> := new bool[26](i5 => if (false) then !p2 else p2);
		v20[173] := false;
		var v21: map<bool, int> := map[p2 := p0];
		v20[173], r2, globalState.f0 := p2, -214 % p3, |v21| * 0x2c4;
		var v22: seq<int> := [p3];
		r2 := v22[p0];
		if (v20[173] ==> fm1(globalState)) {
			var v23 := "nwfy";
			r0 := v23 + (v23 + v23);
			...
			match (v25) {
				case DC65(cf127, cf128) =>
					...
					globalState.f0 := cf127 + --(if (v20[173]) then |v27| else p0);
					var v28 := new C2();
					cf128 := p0 + (p0 * 0x1f3);
					var v29: map<bool, bool> := map[v20[173] := !p2];
					var v30 := DC68(p2, p3);
					cf127, v20[173] := -663 / cf128, (|v29| % cf127) > v30.cf133;
				case DC64(cf126) =>
					globalState.f0 := -p3;
					globalState.f0 := p3;
					var v31 := 'h';
					var v32: map<char, bool> := map[v31 := v20[173]];
					v32 := v32[v31 := p2];
					var v33: array<multiset<bool>> := new multiset<bool>[22];
					v33[504] := multiset{p2};
					v33[504] := fm55(p0 !in (map v34 : int | (0x2e2 <= v34) && (v34 < 133) :: (v34 / p3) := (v20[173])), false, globalState);
			}
			
			var v35 := DC8(p2, v23, 0x252);
			var v36 := DC34(v35, v20[173], v23);
			var v37 := new C3(multiset{v36}, p3 * p0, p2);
			v18 := v18;
			var v38: map<map<seq<D22>, set<int>>, int> := map[fm98(p0, globalState) := p3];
			var v39 := DC49(multiset([-302]), v20[173], v20[173]);
			var v40: seq<D22> := [v39];
			...
			var v44 := "bro";
			globalState.f5, v20[173], globalState.f5, v43 := true, v20[173], (v44 + v44) <= (v44 + v44), v43;
			var v45: multiset<multiset<bool>> := multiset{multiset{false}};
			var v46: seq<bool> := [v20[173]];
			var v47: map<int, string> := map[p0 := v44];
			var v48 := DC20(v47);
			var v49: multiset<bool> := multiset{v20[173]};
			var v50: map<D10, multiset<multiset<bool>>> := map[v48 := multiset{v49, multiset{v20[173], v20[173], p2, p2, v20[173]}}];
			var v51: array<multiset<multiset<bool>>> := new multiset<multiset<bool>>[9] [v45 - v45, v45, v45, v45, v45 + multiset(seq(540, i6  => (multiset([v20[173], v20[173], true, p2, false])))), if (v20[173]) then v45 else multiset{multiset(v46)}, (if (v48 in v50) then v50[v48] else multiset(seq(-0x14b, i7  => (v49)))) * v45, v45, v45];
			v51[580] := multiset{multiset{v20[173], p2}, v49, v49} * multiset{v49};
			var v52 := 'q';
			v51[580] := (v45 - fm99(p3, v52, p0, globalState)) - v45;
			var v53: array<int> := new int[29];
			var v54: seq<array<int>> := [v53];
			var v55 := new C0(v54, v20[173]);
			if (p2) {
				r2 := p0 * (p3 - p3);
				...
				v53 := if (v20[173] in v58) then v58[v20[173]] else v53;
	...
	method m22(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: array<array<bool>>) {
		...
		match (v9) {
			case DC74(cf144, cf145, cf146) =>
				...
				var v13: map<bool, bool> := map[v0[355] := false];
				...
				v14[490] := DC70(v6.f14, map v15 : int | (0x294 <= v15) && (v15 < -69) :: (v15 % 474) := (v0[355]), if (v0 in v16) then v16[v0] else v6.f14).cf137;
				v3 := -0x1e;
				...
				var v22 := DC27(v20, |v21|, v6.f15, DC50(v0[355]).cf103, [true, !cf145]);
				v17[372] := fm79(v19, v22, v2, globalState);
				v17[372] := v20;
			case DC75(cf147, cf148) =>
				...
				var v31: array<int> := new int[15] [v3, |v23| % v6.f14, v3 * |multiset{v6.f15}|, v6.f14, |[v3]|, v6.f14 % |v2|, v6.f14 - v6.f14, v6.f14 - v6.f14, v6.f14, |v24| - (if (fm1(globalState) in v25) then v25[fm1(globalState)] else |v27|), 0x241, -917, if (v28 in v29) then v29[v28] else |v30|, v6.f14 + v6.f14, v6.f14];
				v31 := v31;
				v6.f14 := v6.f14;
				var v32 := 'h';
			...
			case DC73(cf143) =>
				var v38 := new C1();
				if (if (v0[355]) then v0[355] else v2 < v2) {
					...
					var v49: seq<map<char, int>> := [(map[v46 := v3])[v2[v6.f14] := v6.f14]];
					...
					globalState.f0 := if (v52 !! v52) then v7.cf106 else 0x37a % v6.f14;
					v6.f14 := v45.fm2(globalState);
				}
				
				var v53 := new C1();
				var v54: seq<int> := [v3, v6.f14];
				globalState.f0, v3, globalState.f5, v3 := fm3(v54[v6.f14 := -v6.f14], globalState), v6.f14 * v6.f14, !((if (v6.f15) then v6.f14 else v6.f14) <= v38.fm3(seq(-0x1d, i2  => (v6.f14)), globalState)), v54[v54[v6.f14]];
		}
		
		var v55: map<array<bool>, bool> := map[v0 := v6.f15];
		var v56: map<int, bool> := map[|v2| := v0[355]];
		var v57 := DC44(false, v55, v56, v3);
		var v58: map<bool, D20> := map[!v6.f15 := v57];
		var v60: seq<int> := [v6.fm4(seq(464, i3  => (v2[|(seq(0x293, i4  => ('k')))|])), false, v6.f15, globalState)];
		...
		if (!((v62 !! v62) <== fm50(v60, v1, globalState))) {
			...
			v70 := v70[if (v0[355]) then v6.f15 else v1 := v69];
			var v71 := DC31(v6.f15);
			var v72: seq<D15> := [v71];
			var v73 := DC56(v72);
			var v74 := DC58(v73);
			...
			match (v75.(cf132 := v6.f15)) {
				case DC67(cf130, cf131) =>
					...
					globalState.f4 := true;
					v66[165] := v6.f14;
					globalState.f4 := v6.f14 in map[|(seq(0xc, i6  => ('a')))| := -|[v1, v0[355]]|];
				case DC68(cf132, cf133) =>
					v66[165] := v6.f14 / v6.f14;
					v0[355] := v3 >= (v6.f14 - v3);
					...
					v81[870] := v67;
					v66[165], v79[810], v65, v81[870], v0 := cf133, v80, v65 + v65, if (true) then v67 else v67, v0;
				case DC66(cf129) =>
					...
					v82[918] := v84 + {v64, v64};
					var v85 := 'j';
					v0[355] := v64[|(fm85(v6.f15, globalState))[v66[165] := v85]|];
					var v86: array<array<array<bool>>> := new array<array<bool>>[24];
					var v87: seq<array<bool>> := [v0];
					var v88: array<array<bool>> := new array<bool>[29] [v0, v0, v0, v0, v0, v0, v0, v0, v0, v87[v66[165]], v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
					v86[208] := v88;
					v86[208] := v88;
					var v89: seq<D18> := [v68];
					var v90 := DC41(v89[0x54 := v68]);
					v90 := v90;
			}
			
			var v91 := 'q';
			v1, globalState.f1, v60, v61, v60 := v0[355], v91, [v66[165]] + v60, v61 - v61, v60;
		} else {
			r1 := v60[v6.f14];
			var v92: array<int> := new int[29];
			v92[174] := v6.f14;
			v92[174] := -(0x1de + (v57.cf87 * v6.f14));
			v3 := v3;
		...
		var v95: multiset<bool> := multiset{v0[355]};
		var i9 := 0;
		while (v95 != (v95 * v95))
			decreases 100 - i9
		{
			...
			if (v6.f15) {
				...
				var v97 := DC1(v96[v6.f14 := v0] + v96);
				v97 := DC1(v96);
				var v98: array<D1> := new D1[12];
				v98[490] := v97.(cf4 := v96[v6.f14 := v0]);
				v98[490] := v97;
				var v99: array<seq<int>> := new seq<int>[7](i10 => v60);
				v99[22] := v60[v3 := v6.f14];
				v99[22] := v60;
				var v100: array<int> := new int[15];
				v100[210] := v6.f14;
				var v101: seq<bool> := [v1, v1, v0[355], v1];
				var v102: set<seq<bool>> := {[true], v101};
				var v103 := 't';
				var v104: set<char> := {v103, v103};
				v100[210], v1, v0[355], v100 := |v102|, v104 !! fm100(|fm94(multiset{v6.f14}, 'e', v6.f15, globalState)|, globalState), (v6.f14 * v3) <= v6.f14, v100;
				globalState.f5 := v0[355];
			} else {
				var v105: array<map<bool, bool>> := new map<bool, bool>[1];
				var v106: seq<bool> := [v6.f15];
				var v107 := DC0(v105, v106, seq(0x24b, i11  => (|v62|)), true);
				...
				v109[354] := v107;
				globalState.f4, v109[354] := !v1, v108;
				...
				var v114 := DC12(v0[355], v3, |v2|, v6.f14);
				...
				v116[148] := v110;
				v116[148] := v110;
				var v117: map<bool, int> := map[v0[355] := v3 % v6.f14];
		...
		r0 := true;
		r1 := v6.fm4(fm85(v0[355], globalState) + v2, v0[355], true, globalState);
		r2 := (if (v0[355]) then v0[355] else !!v0[355]) && v0[355];
...
class C7 extends T0 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		var v14 := "aqdbvor";
		var v15: seq<multiset<int>> := [v13 * v13[v0 := |v14|], v13, v13];
		v15 := v15;
		var v16: seq<map<int, int>> := [map[v0 := v0], v10, v10];
		var v17: set<int> := {0x19e};
		var v18 := DC16(v16[|v17|] + v10);
		match (v18) {
			case DC16(cf35) =>
				...
				match (v26) {
					case DC2(cf5, cf6, cf7) =>
						...
						v27[870], v27, v27, globalState.f0, v27[714] := cf5, if (|v28| == -|v29|) then v27 else v27, v27, v0, !(v14 <= ((v14[v0 := 'h'])[|v23| := 'g'] + "bbikde"));
						v27[870] := v13 !! v13;
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		...
		p1[638] := v0;
		p1[638] := (-v0 - v0) / v0;
		var v1: map<int, int> := map[p1[638] := -v0];
		for i0 := p1[638] - -|map[-597 := p1[638]]| to -|v1| {
			var v2 := 'x';
			r2 := v2;
			var v3: seq<int> := [i0];
			if (fm49(p1[638], globalState) < v3) {
				var v4 := "xumpvgdu";
				globalState.f0 := --|v4|;
				var v5: map<bool, int> := map[p0 := 142];
				p1[638], p1[638], v0, globalState.f4, globalState.f0 := v0 % p1[638], |v5| * i0, 0x3a6 + -i0, p0, v0 / p1[638];
				var v6: map<int, bool> := map[v0 := p0];
				var v7: set<map<int, bool>> := {v6};
				var v8: seq<string> := [v4, v4];
				var v9: map<seq<int>, bool> := map[v3 := p0];
				v7, v8, globalState.f5 := if (if (v3 in v9) then v9[v3] else p0) then v7 else {map v10 : int | (-0xfc <= v10) && (v10 < 60) :: (v10 % 0xd3) := (!!p0)}, v8, fm1(globalState);
				var v11: seq<bool> := [p0, p0, p0];
				var v12: map<bool, char> := map[v11[v0] := v2];
				var v13: map<bool, bool> := map[!p0 := p0];
				p1[638] := 0x27d % |(fm0(|v12|, globalState) + v13)|;
				...
				v16[743] := p0;
				v14, v16[743], r0 := v14, true, (v0 * i0) - (0x3e2 - v0);
			} else {
				var v17 := "ivuiblsh";
				var v18: seq<string> := ["d", seq(951, i1  => (v2))];
				var v19: map<bool, array<int>> := map[fm1(globalState) := p1];
				var v20 := DC8(p0, v17, v0);
				var v21 := DC34(v20, p0, v17);
				globalState.f5 := v17 !in v18[|(v19[p0 := p1])[!p0 := p1]| := v21.cf67];
				var v22: seq<bool> := [p0];
				v22 := (v22 + v22) + v22;
				var v23 := DC36(seq(0x357, i2  => (v1)));
				var v24: map<int, D17> := map[|v17| := v23];
				var v26: map<bool, map<int, int>> := map[p0 := v1];
				var v28: seq<map<int, int>> := [map v25 : int | (0xcb <= v25) && (v25 < 0x2e8) :: (v25 * -0x267) := (p1[638]), v1, if (p0 in v26) then v26[p0] else (map v27 : int | v27 in v3 :: (v27 - i0) := (v0))[i0 := |v1|]];
				v24 := v24[p1[638] := DC36(v28).(cf69 := v28)];
				r0 := if (if (p0) then p0 else !p0) then p1[638] else p1[638];
				var v29: multiset<int> := multiset{v0, p1[638]};
				v1 := v1[i0 := |(v29 - v29)|];
			}
			
			globalState.f4 := (v0 - v3[p1[638]]) > i0;
		...
		for i4 := p1[638] to p1[638] {
			...
			globalState.f0, v34, v36, v0, p1[638] := 0x237, v34, [v35], -498, |v38[v37 + v37 := p0]|;
			r0 := (p1[638] - p1[638]) * (if (p0) then i4 else p1[638]);
			var v39 := "vufff";
			var v41: seq<bool> := [p0, p0];
			var v42: map<seq<bool>, int> := map[v41 := v0];
			var v43 := DC8(p0, v39, |(map v40 : seq<bool> | v40 in v42 :: (v40) := (p0))|);
			var v44 := 'q';
			var v45: array<D3> := new D3[9] [v43, DC8(p0, v39, p1[638]), v43, v43, v43, v43, v43, DC8(p0, v39[|v41| := v44], p1[638]), v43];
			var v46 := DC17(v45);
			v46 := v46.(cf36 := v45);
			var v47: map<bool, bool> := map[p0 := p0];
			globalState.f5 := !DC9(p0, fm1(globalState), v47, p0, p0).cf20;
		}
		var v48: map<bool, int> := map[!p0 := p1[638]];
		var v49 := DC3(p0, p0, v48, p0);
		var v50: seq<map<bool, int>> := [v49.cf10, map[p0 := p1[638]]];
		v50 := v50;
		var v51 := "qjua";
		var v52: T0 := new C5('k');
	...
	method m20(globalState: GlobalState) returns (r0: bool, r1: map<int, int>, r2: map<int, array<bool>>, r3: bool) {
		...
		if (v3 !! v3) {
			...
			var v7: seq<bool> := [v1];
			var v8: map<char, int> := map[v4[v0[98]] := 0x20c];
			var v9: map<int, bool> := map[|v8| := v1];
			var v10: map<int, int> := map[|v2| := v0[98]];
			var v11: array<map<bool, set<int>>> := new map<bool, set<int>>[15] [v6, v6, v6[v1 := v5] + v6, map[v1 := v5], fm101(v1, v7, v0[98], globalState), v6[fm1(globalState) := v5], v6, v6 + v6, v6, map[false := v5], if (v1) then v6 else v6, fm101(if (v0[98] in v9) then v9[v0[98]] else v1, v7, |v10|, globalState), v6, v6 + v6, map[v1 := v5]];
			v11[941] := v6;
			var v12: array<map<bool, multiset<int>>> := new map<bool, multiset<int>>[7];
			var v13: multiset<int> := multiset{v0[98]};
			v12[462] := map[v1 := v13];
			var v14: map<bool, int> := map[v1 := |[v0[98], v0[98]]|];
			var v15: seq<int> := [|v14|, v0[98], |map[v1 := v1]|];
			var v16 := 'r';
			var v17: map<char, bool> := map[v16 := v1];
			var v18: map<bool, multiset<int>> := map[-160 >= |v13| := v13 - v13];
			globalState.f0, globalState.f1, globalState.f5, v11[941], v12[462] := v0[98] + v0[98], v4[v15[v0[98]]], v1, fm101(if (v16 in v17) then v17[v16] else v1, v7, v0[98], globalState), v18;
			v0[98] := v0[98] * v0[98];
			var v19 := DC26({v1});
			var v20: map<D13, bool> := map[v19 := fm1(globalState)];
			var v22: set<D13> := {v19, v19};
			v4 := (v4 + v4)[|(v20 + (map v21 : D13 | v21 in v22 :: (v21) := (v1)))| := v16];
			var v23: T0 := new C4();
			var v24 := DC21(v0[98], v1, 0x1e1, v23, v0);
			var v25: multiset<array<int>> := multiset{v0, v0, v0, v0, v24.cf43};
			var v26 := DC48(fm63(globalState), v1, -|v25|, v16, v0[98]);
			match (v26) {
				case DC48(cf95, cf96, cf97, cf98, cf99) =>
					var v27 := DC55(cf96, cf96, cf98, v1);
					var v28 := DC13({v0[98], v0[98], |v5|, cf99});
					var v29 := DC27(v16, cf97, cf96, v1, v7);
					var v30: array<char> := new char[15] [v27.cf110, cf98, fm63(globalState), fm63(globalState), v16, cf95, fm79(v28, v29, seq(0x1c4, i0  => (v16)), globalState), cf98, 'b', cf98, fm63(globalState), cf95, cf95, 's', v16];
					v30 := v30;
					var v31: array<seq<bool>> := new seq<bool>[3] [v7 + v7, v7, v7[v0[98] := cf96]];
					v31[411] := [v1] + [cf96, v1];
					v31[411] := v7;
					globalState.f1 := 'l';
					v0[98] := v0[98];
				case DC49(cf100, cf101, cf102) =>
					v0[98] := (0x137 + v0[98]) % (if (|v5| in v10) then v10[|v5|] else v0[98]);
					var v32: set<bool> := {v4 == v4};
					globalState.f0, v0[98], v32, globalState.f0, v4 := -(|multiset{fm1(globalState), v1, cf101}| - v0[98]), v0[98], v32 - v32, |(v4 + v4[-v0[98] := v16])|, v4;
					var v33 := new C1();
					globalState.f5 := v23.fm3(v15, globalState) <= v0[98];
				case DC50(cf103) =>
				...
				case DC47(cf94) =>
					...
					var v38: map<D14, int> := map[DC28(v37) := v0[98]];
					var v39: seq<map<D14, int>> := [v38, v38 + v38, v38];
					var v41 := DC12(v1, |(map v40 : char | v40 in v8 :: (v40) := (v1))|, v0[98], v0[98]);
					var v42 := DC39(v41, v1, v0, false, |v15|);
					var v43 := DC28([v0, v42.cf75, v0, v0]);
					v16, globalState.f0, v37, globalState.f0, globalState.f0 := v16, |v39[v0[98] := v38[v43 := v0[98]]]|, (v37 + v37) + [v0], -v0[98], fm3([v0[98], v0[98]] + v15, globalState);
					globalState.f5 := v7[0x251] <==> ({true, false} !! {v1});
					v0[98] := v0[98];
				case DC51(cf104) =>
					globalState.f0 := 0x37;
					var v44: array<bool> := new bool[23](i2 => if (v1) then v1 else DC38(v1).cf72);
					v44 := v44;
					v0[98] := (v0[98] - v0[98]) - v0[98];
					var v45: set<bool> := {v1};
					var v46: map<bool, set<bool>> := map[v1 := v45];
					var v48: map<int, set<int>> := map[745 := v5];
					var v49 := DC63(v0[98], v16);
					var v52: seq<string> := [v4];
					var v53: map<char, string> := map[v16 := v52[v0[98]]];
					var v55: array<set<int>> := new set<int>[27] [v5, v5, v5, {v0[98], v0[98]}, v5 - v5, v5, v5, v5 * v5, {v0[98], |v46|} * v5, v5 + (set v47 : int | v47 in map[v0[98] := v0[98]] :: (v47 % -|(seq(-0xaf, i3  => ('a')))|)), if (v0[98] in v48) then v48[v0[98]] else v5, v5, v5, (if (v1 in v11[941]) then v11[941][v1] else v5) + v5, v5, v5 * fm91(v1, v49, globalState), if (v1) then v5 else v5, set v50 : int | v50 in map[v0[98] := v16] :: (v50 / 0x163), v5, if (v1) then v5 else v5, v5 - v5, v5 - {v0[98]}, fm91(v1, DC63(DC63(|(seq(567, i4  => (0x112)))|, v16).cf124, v16), globalState), v5, (set v51 : int | (0x16e <= v51) && (v51 < 0xce) :: (v51 * |v4|)) + v5, v5, {v0[98], |(set v54 : char | v54 in v53 :: (v54))|, |v9[v0[98] := v1]|}];
					v55, r3, globalState.f4, globalState.f0 := v55, if (true <== v1) then v1 else !v1, v1, v0[98];
			}
			
		} else {
			var v56 := "sq";
			var v57: multiset<string> := multiset{v56};
			v0[98] := (if (v56 in v57) then v57[v56] else v0[98]) - v0[98];
			v2 := v2 + fm0(v0[98], globalState);
			v0[98] := v0[98] - v0[98];
			var v58: set<int> := {v0[98]};
			if (v58 > (v58 + (set v59 : int | v59 in [|v2|, v0[98], 0x3d6] :: (v59 / |map[true := 's']|)))) {
				var v60 := DC33(v0[98], v1, v1);
				var v61: array<bool> := new bool[4] [v1, v1, v1 ==> v60.cf64, v1 <== v1];
				v61[134] := v1;
				var v62: multiset<int> := multiset{-481, 0x19e, v0[98]};
				var v63: seq<multiset<int>> := [v62, v62, v62];
				v61[134] := v63 < v63;
				var v64 := DC15(v61);
				var v65: set<D6> := {v64};
				globalState.f4, r0 := v65 <= (v65 * v65), v61[134];
				globalState.f0 := v0[98];
				var v66 := new C1();
				var v67: map<int, int> := map[v0[98] := v0[98]];
				r1 := v67 + v67;
			} else {
				var v68 := new C4();
				globalState.f5 := v0[98] < v0[98];
				globalState.f4 := !v1;
				var v69: seq<bool> := [v1];
				var v70: map<int, bool> := map[v0[98] := v1];
				var v71 := DC25(v0[98], map[v0[98] := v1] + v70, 0x304);
				var v72: array<bool> := new bool[6];
				v72[267] := v0[98] > v0[98];
				var v73 := DC7(v69);
				v69, v71, v72[267] := (v73.(cf15 := v69)).cf15, v71, v1;
				globalState.f0 := -v0[98];
			}
		...
		var v74: map<bool, int> := map[v1 := v0[98]];
		var v75: map<map<bool, int>, D5> := map[v74 := DC14(-v0[98])];
		if (v74 !in v75) {
			globalState.f0 := if (v1 in v74) then v74[v1] else v0[98];
			var v76 := DC8(v1, seq(0x2d, i5  => ('j')), v0[98]);
			var v77 := "k";
			var v78 := DC34(v76, v1, v77);
			var v79: multiset<D16> := multiset{v78};
			var v80 := new C3(v79 + v79, if (v1) then v0[98] else v0[98], v1);
			globalState.f4, v0[98], globalState.f0, globalState.f0 := fm1(globalState), v0[98], v80.fm4("orw" + v77, if (v1 in v2) then v2[v1] else !v1, fm1(globalState), globalState), v0[98];
			...
			var v86: multiset<D22> := multiset{v82.(cf94 := (multiset(v83))[true := v85.cf53])};
			var v87 := DC52(seq(206, i6  => (multiset{v0[98], if (v1 in v74) then v74[v1] else v0[98], v0[98]})));
			var v88: map<int, D23> := map[|v83| := v87];
			v0, v81[27], v86, globalState.f4, globalState.f0 := v0, v0, v86, (v88 + v88) == v88, v0[98] / (0x2ea - 0x236);
			if (fm1(globalState)) {
				var v89: map<int, int> := map[582 := v0[98]];
				v0[98] := fm3(([|v89|, v0[98]])[v0[98] := v0[98]], globalState);
				var v90: array<seq<map<D10, bool>>> := new seq<map<D10, bool>>[10](i7 => seq(475, i8  => (map[DC20(map[v0[98] := v77]) := !v1])));
				var v91: map<int, string> := map[v0[98] := v77];
				var v92 := DC20(v91);
				var v93: seq<map<D10, bool>> := [map[v92 := v1], fm102(v1, v0[98], globalState)];
				v90[659] := v93;
				v90[659] := seq(919, i9  => (map v94 : D10 | v94 in [v92, v92] :: (v94) := (v1)));
				var v95, v96 := m0(v0[98], if (v1) then v1 else v1, v1, if (v1) then v0[98] else v0[98], globalState);
				var v97: seq<string> := [v77[v0[98] := v84], "wphfll", v77, "jxjpnxg", "nmnmkmri"];
				v97 := v97;
				var v98: multiset<multiset<bool>> := multiset{multiset{v1, false}};
				var v99: map<int, multiset<multiset<bool>>> := map[v0[98] := multiset{multiset(v83), v3} + v98];
				v99 := v99[v96 % |(map v100 : int | (-209 <= v100) && (v100 < 703) :: (v100 % v96) := (v1))| := v98];
			} else {
				var v101: array<bool> := new bool[12];
				v101[367] := v1;
				v101[367] := false ==> (fm1(globalState) ==> v1);
				v101 := new bool[8] [!v101[367], true, !v101[367], v101[367], if (v101[367]) then v1 else !false, v1, v101[367], v101[367]];
				var v102: seq<int> := [v0[98]];
				globalState.f0, r3, globalState.f0 := v0[98], v0[98] <= |v102|, 41;
				v0[98] := 0x1ad;
				v77 := v77 + v77;
			}
			...
			var v105 := DC27(v103, v0[98] + v0[98], v1, v3 >= multiset(v104), v104);
			match (v105) {
				case DC27(cf52, cf53, cf54, cf55, cf56) =>
					var v106 := new C4();
					globalState.f5 := cf55;
					var v107: array<map<array<int>, int>> := new map<array<int>, int>[13];
					var v108: map<array<int>, int> := map[v0 := v0[98]];
					v107[374] := v108;
					v107[374] := v108 + (map[v0 := cf53])[v0 := cf53];
					globalState.f4 := !false;
				case DC26(cf51) =>
					var v109 := "iopsp";
					var v110 := DC8(v1, v109, v0[98]);
					var v111: map<bool, string> := map[v1 := v110.cf17];
					var v112: map<int, int> := map[v0[98] := v0[98]];
					var v113: map<int, int> := map[|v112| := |map[|v3| := v1]|];
					var v114: seq<int> := [if ((if (v1 in v3) then v3[v1] else v0[98]) in v112) then v112[if (v1 in v3) then v3[v1] else v0[98]] else |map[v0[98] := false]|];
					var v115: set<seq<int>> := {v114, seq(171, i10  => (-v0[98])), v114, v114};
					v0[98], r3, cf51, globalState.f5, globalState.f5 := v0[98], false, cf51, ((if (v1 in v111) then v111[v1] else fm85(v1, globalState)) != v109) in (v104 + v104), !((v115 - v115) >= (if (true) then v115 else v115));
					var v116: array<bool> := new bool[19];
					v116 := v116;
					r3 := v1;
					globalState.f0 := -|v109| % (v114[v0[98]] % v114[v0[98]]);
			}
			...
			globalState.f0, v0[98] := -|(v122 + ((v122 + v122)[59 := v121])[|v2| := if (v0[98] in v123) then v123[v0[98]] else v121])|, v0[98];
			globalState.f5 := v1;
			var v124 := "jcdhyrlx";
			var v125: multiset<char> := multiset{v124[0x110]};
			v0[98], globalState.f4, v1 := if (v103 in v125) then v125[v103] else v0[98], v1, v1;
			if (v1) {
				globalState.f0 := v0[98];
				globalState.f0 := v0[98];
				var v126: array<map<int, int>> := new map<int, int>[29](i11 => map[v0[98] := v0[98]]);
				v126[280] := map v127 : int | (988 <= v127) && (v127 < 0x3d) :: (v127 * 0x2dd) := (|map[{v0[98], |v124|} := v1]|);
				var v128: map<int, int> := map[v0[98] := |(v124 + fm85(!v1, globalState))|];
				v126[280] := v128;
				var v129: seq<int> := [v0[98]];
				var v130: multiset<int> := multiset{|v129|, v0[98]};
				...
				globalState.f4, r0, v0[98], globalState.f0, v130 := v120.fm51(v0[98], v0[98], |v132[v0[98]]|, v0[98], globalState), !((if (fm1(globalState) in v133) then v133[fm1(globalState)] else v104) <= [!true, v1]), v0[98] + (|v129| % v0[98]), |(v104 + v104)|, v130;
				var v134 := new C2();
			} else {
				var v135: seq<array<int>> := [v0];
				var v136 := new C0(v135, v1);
				var v137: map<int, bool> := map[-v0[98] := v0[98] != v0[98]];
				var v138: seq<string> := [v124, v124, seq(-0x30a, i12  => (v103)), v124];
				var v139: array<bool> := new bool[10](i13 => v136.f30);
				v139[550] := v1;
				var v140: C1 := new C1();
				var v141: seq<seq<string>> := [v138, v138];
				v137, v138, v139[550], v140, r0 := v137, v141[|v2|], v1 in (if (v1) then [v136.f30] else v104), v140, v136.f30;
				var v142: array<D5> := new D5[29];
				var v143 := DC14(v0[98]);
				v142[590] := v143;
				var v144: multiset<int> := multiset{v0[98], v0[98], 287};
				var v146: T0 := new C5(v103);
				var v147 := DC21(v0[98], v1, v0[98], v146, v0);
				var v148 := DC21(v0[98], v136.f30, |(map v145 : int | (0x68 <= v145) && (v145 < 637) :: (v145 % v0[98]) := (v1))|, v147.cf42, v0);
				v142[590] := fm103(-(|v144| / v0[98]), false, v0[98] % v148.cf41, !v1 !in map[!v139[550] := v103], globalState);
				var v149: set<int> := {v0[98], |(v124 + v124)|, v0[98]};
				globalState.f0 := |v149|;
				globalState.f0 := -(if (v136.f30) then 0x9 else v0[98]);
			}
		...
		var v152 := "khru";
		r0 := (v151 !in v152) && v1;
		var v153: map<int, int> := map[v0[98] := v0[98]];
		r1 := v153[v0[98] := -v0[98]] + v153;
		var v154: multiset<int> := multiset{v0[98]};
		var v155: array<bool> := new bool[13](i15 => v1);
		var v156: map<int, array<bool>> := map[|(multiset{v0[98], v0[98]} * v154)| := v155];
		r2 := v156;
		r3 := v1;
	}
}
...
class C8 extends T1, T0 {
	...
	function fm3(p0: seq<int>, globalState: GlobalState): int {
		f14 / -(DC5(0x8b).cf13 * f14)
	}
	function fm35(p0: D3, globalState: GlobalState): map<set<int>, bool> {
		(if (!f15) then map v0 : set<int> | v0 in [set v1 : int | v1 in multiset(seq(0x20, i0  => (|(seq(0x19d, i1  => ('e')))|))) :: (v1 % 850)] :: (v0) := (f31) else map[{f14, |["sfbearo"]|} := f31]) + map[set v2 : int | v2 in map[--0xa9 := 408] :: (v2 % 0x34e) := f15]
	}
	method m3(p0: int, globalState: GlobalState) {
		...
		for i2 := f14 to p0 {
			...
			match (v4) {
				case DC19() =>
					...
					f14, globalState.f0, v7 := |v5|, f14, v7 + v8[|(seq(-164, i3  => (808)))|];
			...
			if (-|(fm36(f31, v18, f31, globalState) + v19)| >= f14) {
				...
				v20 := ((v20 + v20) + fm37(f31, v21, true, globalState))[i2 / p0 := v18];
				...
				v25[243] := (if (f15) then v28 else v28) > {v27};
				globalState.f1 := v18;
			}
			
			var v29: array<bool> := new bool[27];
			v29[325] := f15 <== f31;
			v29[325] := v1 >= (DC26(v1).cf51 - {f15, f15, f15});
			v3[869] := -435;
			v3[869] := -((p0 / i2) * f14);
		}
		...
		var v32 := "ixwnnt";
		var v33 := 'w';
		var v34: seq<int> := [v31.cf33, |v32[f14 := v33]|, p0];
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		match (v0) {
			case DC5(cf13) =>
				...
				v3[10] := f15;
				v3[10] := f15;
				globalState.f4 := v3[10] <== v3[10];
				if (f15) {
					v3 := v3;
					globalState.f0, globalState.f4 := f14, v3[10];
					globalState.f4 := v3[10];
					var v4: map<int, bool> := map[f14 := v3[10] <==> f15];
					var v5: map<bool, bool> := map[f31 := f31];
					v4 := v4[0x1ef := !(if (if (v3[10] in v5) then v5[v3[10]] else f31) then f15 else f31)];
					globalState.f0 := 0x341;
				} else {
					globalState.f0 := f14 % cf13;
					var v6: seq<array<bool>> := [v3, v3, v3, v3];
					var v7 := DC1(v6);
					var v8: seq<int> := [cf13];
					v7, f14 := DC1(v6), fm2(globalState) * v8[--0x3e4];
					var v9: array<int> := new int[8](i0 => i0 - 809);
					v9[318] := f14;
					v9[318] := fm2(globalState);
					var v10: seq<bool> := [f15];
					var v11 := DC8(v3[10], v1, |v10|);
					var v12: multiset<int> := multiset{v11.cf18};
					cf13, v9[318], globalState.f4 := if (cf13 in v12) then v12[cf13] else v9[318], -(854 % (f14 * v9[318])), f15;
			...
			case DC4(cf12) =>
				...
				v13[546], globalState.f4, globalState.f5, v14 := f31, if ((!f15 || fm1(globalState)) in v15) then v15[!f15 || fm1(globalState)] else f31, v17 >= v17, v14;
				var v18: array<int> := new int[6];
				var v19: seq<array<int>> := [v18];
				var v20: map<array<int>, bool> := map[v18 := v13[546]];
				...
				var v25 := DC3(true, v21.f30, v23, v24[-0x1ff]);
				v13[546], globalState.f4, v13[546], v14, globalState.f5 := (if (f15) then v25 else v25).cf8, false, v21.f30, v14, v13[546];
			case DC6(cf14) =>
				var v26 := DC14(f14);
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		for i0 := f14 - f14 to f14 {
			...
			if (f15 <== f15) {
				...
				v5 := v6[0x2c6];
				var v7: seq<string> := [v0 + v0, v0[0x2f6 := 't'], (seq(0x361, i2  => ('p'))) + v0];
				v7 := v7;
				p1[456] := 0x3b3;
				var v8: multiset<string> := multiset{seq(-0x34a, i3  => ('g')), v0};
				p1[456], globalState.f0, globalState.f0 := i0, |v8|, |(seq(-728, i4  => ('k')))|;
			} else {
				var v9: map<bool, bool> := map[p0 := f15];
				var v10: map<bool, int> := map[p0 := |(seq(0x6a, i5  => ('y')))|];
				...
				var v19: seq<bool> := [v16[852], f15, p0, !f15, true];
				var v20 := DC26(v14);
				var v21 := new C0(v17, v18[-|v19|] != (v20.(cf51 := v14)).cf51);
				globalState.f4 := v19 < v19;
				var v22 := DC28(v17);
				var v23 := new C0([p1] + v22.cf57, p0);
				var v24: map<int, bool> := map[i0 := v21.f30];
				globalState.f0, globalState.f0, v16[852] := i0, i0, if (f14 in v24) then v24[f14] else f15;
			}
		...
		v27[830] := f15;
		var v28 := DC19();
		globalState.f0, v27[830], globalState.f5 := |(fm40(!p0, DC19(), -f14, f14, globalState) - fm40(f15, v28, f14, f14, globalState))|, f31 <==> f15, p0;
		v27[830] := f15;
		p1[784] := f14;
		var v29 := DC29(f14);
		p1[784] := match v29 {
	...
	method m19(p0: int, globalState: GlobalState) returns (r0: T0, r1: int, r2: bool, r3: string) {
		...
		match (v4) {
			case DC2(cf5, cf6, cf7) =>
				...
				var v7: array<bool> := new bool[24] [cf5, false, cf7, cf5, cf5, if (f31) then cf7 else cf5, f15, cf7, v6.cf16, f15, [p0] <= (seq(0x345, i0  => (p0))), -p0 > p0, f15, f15, if (cf7) then f31 else cf5, f15, f15, f14 >= |v5|, cf7, !f15, cf5, cf5 <== !false, f15, cf7];
				v7[610] := cf5;
				v7[610] := !cf5;
				var v8 := DC22(cf7, f31);
				...
				var v17 := DC2(cf5, DC0(v16, v3, seq(323, i2  => (0x100)), cf7), false);
				r2, globalState.f1, v13, v14[697], v7 := (if (!cf5 in v15) then v15[!cf5] else v17.cf5) && f31, 't', v13, p0, v7;
			case DC3(cf8, cf9, cf10, cf11) =>
				...
				globalState.f0 := (if (cf8 in cf10) then cf10[cf8] else p0) % (if (f31) then |v23| else f14);
				globalState.f0 := p0 / f14;
				var v24: map<map<int, int>, int> := map[map[f14 := f14] := f14 % p0];
				var v25: map<int, int> := map[f14 := 0x3bd];
				var v26 := "xdtcyv";
				var v27: seq<int> := [-0x2f8];
				var v28: array<char> := new char[10] [v21, v21, v21, v21, v21, v21, v21, 'g', v26[|v27|], v21];
			...
			case DC1(cf4) =>
				...
				var v39: array<int> := new int[20](i3 => i3 / -f14);
				var v40: seq<array<int>> := [v39];
				v38[494] := v40 + v40;
				var v41: seq<map<bool, string>> := [map[f31 := v33]];
				var v42: map<int, bool> := map[p0 := f31];
				v31, r1, v37, v38[494] := v31, f14, v41[f14] + (v37 + map[if (p0 in v42) then v42[p0] else f15 := v33]), v40;
				...
				v45 := fm40(true, DC19(), -p0, |fm37(f15, v36, f31, globalState)| % f14, globalState);
		}
		...
		match (v51.(cf14 := v47)) {
			...
			case DC4(cf12) =>
				...
				var v63 := DC18(multiset{"clppjtkey", if (|v62| in v61) then v61[|v62|] else v60, "mpmyhkgq", seq(0x2d0, i5  => ('a'))});
				v63 := v63;
			case DC6(cf14) =>
				f14, globalState.f0, v3, globalState.f0, globalState.f5 := f14 % (if (f31) then |"c"| else p0), p0, (v3 + v3) + (v3 + v3), f14, !f15;
				var v64: array<map<bool, bool>> := new map<bool, bool>[18];
				var v65 := "tkvspf";
				var v66 := DC0(v64, (v3[DC10(false, |v65|, v1).cf25 := true])[f14 := f31], v46, f31);
				var v67 := DC2(f31, v66, f15);
				match (v67) {
					case DC2(cf5, cf6, cf7) =>
						var v68: array<int> := new int[3] [|v65|, p0 / |v65|, f14];
						v68[373] := p0;
						v68[373] := f14;
						globalState.f0 := v68[373];
					...
					case DC3(cf8, cf9, cf10, cf11) =>
						...
						var v77: map<int, map<seq<int>, int>> := map[p0 := v75 + v76[p0]];
						v77 := v77[0x15b := v75];
						var v78 := new C0([v71, v71, v71] + v72, v74.f30);
					case DC1(cf4) =>
						var v79: seq<seq<bool>> := [v3, ((v3[|v3| := true])[p0 := f15])[0x390 := true], v3];
						v79 := v79;
						var v80: array<seq<bool>> := new seq<bool>[17];
						v80[566] := [!f31];
						v80[566] := (v3 + v3) + ([!!f15] + v3);
						globalState.f5 := !true;
						var v81: multiset<int> := multiset{f14};
						var v82, v83 := m0(p0 * fm3(seq(0x65, i6  => (f14)), globalState), f31, multiset(v46) > v81, f14, globalState);
				}
				
				var v84: map<string, bool> := map["fjyyhqq" := false];
				var v85: array<int> := new int[4] [f14, p0, f14, -(p0 % |v84|)];
				v85[821] := p0 - p0;
				v85[821] := p0;
				var v86: array<bool> := new bool[3];
				var v87: map<array<bool>, int> := map[v86 := |map[v85[821] := !f15]|];
				var v88: map<int, array<bool>> := map[v85[821] := v86];
				var v89 := DC27(fm41(|v87|, f15, f31, globalState), |v88|, fm1(globalState), f31, v3);
				if (v89.cf54) {
					v86[103] := f31;
					var v90: seq<seq<int>> := [v46, v46];
					var v91: seq<seq<int>> := [v90[|[|v3|, fm3([p0, v85[821]], globalState)]|]];
					v86[103] := [v46] == v91;
					var v92 := DC22(f15, v86[103]);
					var v93: seq<D10> := [v92];
					globalState.f0 := (|v93| * p0) % (f14 / -553);
					var v94: seq<array<int>> := [v85, v85];
					var v95 := new C0(if (v86[103]) then v94[f14 := v85] else v94, f31);
					globalState.f5 := !true;
					var v96: array<map<bool, int>> := new map<bool, int>[25] [map[f15 := f14], v1, map[v95.fm29(p0, v86[103], globalState) := p0], fm43(|v1|, v3[0x14e], f15, globalState), v1, v1, v1, v1, fm43(f14, f15, v95.f30, globalState), map[v86[103] := p0], v1, v1, v1, v1, map[f15 := 0x345], v1[f15 := f14], v1, v1, v1, v1, v1, map[v86[103] := p0], v1, v1, v1];
					var v97: map<bool, array<map<bool, int>>> := map[f15 := v96];
					var v98: array<array<map<bool, int>>> := new array<map<bool, int>>[27] [v96, v96, v96, DC32(v96).cf61, v96, v96, v96, if (v86[103] in v97) then v97[v86[103]] else v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96, v96];
					v98[901] := v96;
					v85[821], v85, v98[901] := p0, v85, v96;
				} else {
					var v99, v100 := m0(f14, f15, f31 in v3, v85[821], globalState);
		...
		if ((f31 ==> f31) <== (f31 <==> f15)) {
			...
			if (!f15) {
				...
				var v117 := "bkpl";
				r1 := |v117| / (f14 / f14);
				var v118: map<bool, string> := map[f31 := seq(0xc0, i9  => (v109))];
			...
			r1 := -fm3(v46, globalState) / (|v122[f14 := p0]| % f14);
			...
			var v127: seq<array<int>> := [v126[f14]];
			var v128 := "odaj";
			...
			var v137 := DC5(|(map v134 : int | v134 in v136 :: (v134 / p0) := (p0))|);
			var v138: map<int, int> := map[959 := f14];
			var v139: map<map<int, int>, bool> := map[v138 := f31];
			var v140: map<int, bool> := map[-p0 := !f31];
			v132, v133[384], r2, globalState.f1 := v132, |(fm45(p0, v137, f15, globalState) + v139)| !in v140, f15, v135;
			...
			decreases 100 - i11
		{
			...
			var v148 := DC36(v145);
			var v149: array<seq<map<int, int>>> := new seq<map<int, int>>[23] [v145, v145, v145, [fm46(f15, p0, f15, f15, globalState), v144, v144, v144, v144[p0 := p0]], (seq(645, i12  => (v144))) + v145, v145 + v145, v145, v145, v145, v145, [v144, map[|v146| := f14], v144], v145, v145, v145 + v145, fm47(f31, map[p0 := f15], f15, f31, globalState), v145, if (f15) then [v144] else fm47(f31, v147, f15, f31, globalState), v148.cf69, v145, seq(0x3ca, i13  => (v144)), v145, v145 + v145, v145];
			v149[823] := v145;
			v149[823] := v145[p0 + |v3| := v144];
			var v150 := 'j';
			var v151: map<bool, char> := map[f31 := v150];
			f14, v146, globalState.f5, r1, v151 := f14 + f14, v146 * {f31, f31, f15}, v3[f14], |(map v152 : int | v152 in v144 :: (v152 / 0x10d) := (f15))| / fm3(v46, globalState), v151;
			...
			var v157 := DC29(p0);
			var v158 := "ojsxkfqlv";
			var v159: set<seq<int>> := {v46[p0 := |v146|], [p0]};
			r1, f14, v153[620] := 0x8a % |v156|, (v157.(cf58 := |v158|)).cf58 + |(v159 - v159)|, if (f15) then v150 else v158[p0];
...
class C9 {
	...
	method m18(p0: array<int>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			p0[469] := v1;
			var v4 := 'a';
			var v5: map<bool, char> := map[(if (v0 in v2) then v2[v0] else p0[469]) != p0[469] := v4];
			v5 := v5[v0 := v4];
			p0[469] := 0x236 / v1;
		}
		var v6 := 0x28f;
		...
		match (v7) {
			case DC12(cf28, cf29, cf30, cf31) =>
				if (cf28) {
					...
					var v16: multiset<bool> := multiset{!cf28, (fm31(globalState))[cf29 := 0x274] < (v12[-cf31 := cf30])[|multiset{v13}| := v6], cf28 in (if (|v11| in v15) then v15[|v11|] else v14), cf28, v8.f30};
					v13[583] := v0;
					v10, v16, globalState.f5, v13[583] := if (cf28) then v10 else DC17(v9), fm32(cf30, v0 <==> v0, globalState), (multiset{v0} * v16) !! v16, cf30 >= cf31;
					var v17 := 'r';
					globalState.f1 := v17;
					globalState.f4 := !v13[583];
					var v18: multiset<char> := multiset{v17, v17};
					v18 := v18;
				} else {
					var v19: seq<bool> := [cf28];
					var v20: map<seq<bool>, int> := map[v19[v6 := v0] := cf30];
					...
					var v26 := DC19();
					var v27: map<int, bool> := map[(if (cf28 in v25) then v25[cf28] else cf29) + --fm28(v26, globalState) := v19[cf30]];
					v27 := v27;
					globalState.f0 := cf29;
			...
			case DC11(cf27) =>
				...
				match (DC11(cf27 + map[v36[v6] := v6])) {
					...
					case DC11(cf27) =>
						...
						var v47: array<int> := new int[28](i1 => i1 % v6);
				...
				if (v0) {
					...
					p0[459] := v6;
					var v57 := 'n';
					var v58: multiset<D12> := multiset{DC25(p0[459], fm34(v57, globalState), v6)};
					...
					var v70 := DC21(|(seq(100, i3  => (|v65|)))|, v35[v6], v6, v69, p0);
					var v71: set<D10> := {v70, v70};
					var v72: multiset<bool> := multiset{v0, v0};
					var v73: array<bool> := new bool[21] [v35[v6], |v62| > 0x140, if (v0) then v0 else v0, v0, v0, v0, if (if (v0 in v63) then v63[v0] else v0) then v0 else v0, v0, v0 <== v0, v0 && v0, v0 <== v0, v0, v65 > v66[v6], v0 && v0, true, v67 != v67, v0, {v70, v70} >= v71, v6 <= v6, !v0, multiset{v0} !! v72];
					v61, v73 := v61, v73;
					v73[334] := v0;
					v73[334] := v0;
					v73[334] := v0;
					...
					var v77 := 'p';
					globalState.f0, globalState.f0, v74[238] := v6, if (((v76[|v35|])[v6 := v77] + f28) in v75) then v75[(v76[|v35|])[v6 := v77] + f28] else v6, v73;
				}
		...
		var v80 := DC19();
		for i5 := -(if (v0) then fm28(v80, globalState) else v6) to v6 / v6 {
			var v81: array<bool> := new bool[11];
			var v82: map<array<bool>, string> := map[v81 := seq(0x1ac, i6  => (DC24('l').cf47))];
			var v83 := 'i';
			var v84 := DC27(v83, -0x9f, v0, v0, fm52(globalState));
			var v85: seq<int> := [|v84.cf56|];
			var v86: map<int, int> := map[|v82| := v85[|v85|]];
			var v87 := DC16(v86);
			match (v87) {
				case DC16(cf35) =>
					globalState.f4 := v0;
			...
			v91 := new array<bool>[20] [v81, v81, v81, v81, v92[i5], v81, v81, v81, v81, v81, v81, v81, v81, v81, DC57(v81).cf113, v81, v81, v81, v81, v81];
			globalState.f4 := v0;
		...
		v95[932] := v93;
		v95[932] := fm0(|(seq(0x124, i7  => ('n')))|, globalState) + v93;
		if (v0) {
			v0 := true;
			globalState.f4 := v0;
			...
			if (v0) {
				...
				globalState.f0, globalState.f0 := |(v101 + v101)|, v6 % --|{v102, v102, v102}|;
				var v103 := new C4();
				var v104: map<bool, int> := map[v0 := 0x1a4 % v6];
				globalState.f5, v104 := v0, (v104 + v104) + v104;
			} else {
				var v105 := "bp";
				var v106: seq<string> := [f28, v105];
				var v107: seq<string> := [v106[v6], v105 + v105, f28 + v105];
				v105 := v107[|f28|];
				v0 := v0;
				var v108 := 'r';
				globalState.f1 := v108;
			...
			v109 := new int[19](i9 => i9 % v6);
		} else {
			if (v0) {
				var v110 := 'j';
				var v111: array<int> := new int[5] [v6, v6, |fm33(globalState)|, |f28[fm28(v80, globalState) := v110]|, -v6];
				v111 := v111;
				globalState.f5 := !fm1(globalState);
				globalState.f5 := v0;
				var v112, v113 := m0(v6, v0, false, v6, globalState);
				var v114: array<seq<string>> := new seq<string>[25](i10 => [f28, f28] + ["qrf"]);
				v114[200] := [f28, f28, f28] + [seq(0x2d5, i11  => (v110))];
			...
			p0[806] := (if (v0) then v121 else v121).cf120;
			var v122 := 'h';
			var v123: set<bool> := {false, v0};
			var v124: seq<int> := [v6, p0[806], |v123|, 0x37e];
			var v125: map<seq<int>, string> := map[v124 := f28];
			var v126: array<string> := new string[22] [f28 + (seq(0x1d6, i13  => ('g'))), f28[p0[806] := v122], f28, f28, "rmkdtff", f28, f28, f28, f28, f28, f28, "jtjjbss", "c", f28 + f28, f28 + (seq(0x1ab, i14  => (v122))), "qxk" + f28, seq(0xe2, i15  => (v122)), "sjeytol", if (v124 in v125) then v125[v124] else "j", f28, f28, seq(-0x3c8, i16  => (v122))];
			v126 := v126;
		}
			...
			decreases 100 - i17
		{
			...
			i17 := i17 + 1;
			p0[573] := fm28(DC19(), globalState);
			var v127: array<seq<int>> := new seq<int>[22];
			var v128: seq<int> := [v6];
			v127[518] := if (v0) then v128 else v128;
			var v129 := 'k';
			var v130: map<char, bool> := map[v129 := v0];
			p0[573], v127[518], globalState.f0, globalState.f0, v130 := -(v6 % (fm28(v80, globalState) + v6)), fm66(v6, v129, false, globalState), v6, v6, v130;
			if (v0) {
				...
				p0[573] := fm28(v80, globalState);
				globalState.f4 := p0[573] <= |"aq"|;
				var v133 := "qvolo";
				v133 := "xbqxqe" + (seq(0x38c, i18  => (v129)));
			} else {
				var v134: map<int, int> := map[v6 := v128[v6]];
				var v135: set<bool> := {!!v0};
				var v136: map<map<int, int>, set<bool>> := map[v134[p0[573] := p0[573]] := v135];
				...
				v137[779] := v138;
				var v139 := DC5(v6);
				var v140: multiset<int> := multiset{v6, v6, v6 % v139.cf13};
				var v141: map<int, seq<int>> := map[p0[573] := v128];
				v137[779], v140, globalState.f4 := v138, (multiset(if (0x15a in v141) then v141[0x15a] else [|map[v0 := v0]|]))[p0[573] := -(p0[573] * fm28(v80, globalState))], (|v95[932]| / v6) == p0[573];
				var v142: array<multiset<int>> := new multiset<int>[24](i19 => v140 - v140);
				v0, v142, p0[573] := !v0, v142, p0[573];
			}
			...
			if (v0) {
				...
				p0[573], globalState.f5, globalState.f4, globalState.f0 := -730, fm1(globalState), v0, p0[573] * -(|(seq(0x269, i21  => ([v0])))| % v6);
				var v148 := new C5(v129);
				globalState.f0 := p0[573];
			}
...
class C10 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
		for i0 := -f27 to f14 {
			...
			v0[96] := f26;
			globalState.f5 := f26;
			globalState.f4 := -f14 < |[f26, !v0[96], !f15]|;
			var v1 := 'x';
		...
		v3[732] := f15 <==> fm27(|v5|, f27, f26, globalState);
		var v6 := "sutbt";
		var v7: multiset<string> := multiset{v6};
		v3[732] := v7 >= multiset{"vvognbi", v6};
		...
		v8[859] := v9;
		f26 := !v3[732];
		var v10: multiset<bool> := multiset{f26, v3[732]};
		var v11 := DC8(f26, v6, |(if (!v3[732]) then multiset{v3[732]} else v10)|);
		match (v11) {
			case DC8(cf16, cf17, cf18) =>
				cf18 := cf18;
				...
				if (if (true) then !(p0 <= |[f14]|) else f15) {
					...
					var v22: seq<int> := [f27];
					var v23: array<int> := new int[22] [f14, p0, cf18, 0x109, fm4(cf17, cf16, cf16, globalState), -(cf18 % v12.fm3([f27], globalState)), p0, p0, f27, f27 % |v14|, |v17[f14]|, -fm26(!cf16, v3[732], globalState), f27, p0, -0x315, |v18|, cf18, |v19[|v20| := f14]|, -p0, |v21|, f27, f14 / v22[0xd7]];
					v23[138] := -f14;
					v23[138], globalState.f0 := cf18 * (f27 * |v22|), |(set v24 : int | (380 <= v24) && (v24 < 0x121) :: (v24 * |map[cf16 := DC55(f26, f15, v4, cf16).cf108]|))|;
					var v25: multiset<char> := multiset{v4};
					var v26: map<bool, bool> := map[f26 := f26];
					var v27: array<map<bool, bool>> := new map<bool, bool>[11] [v26, v26, v26, v26, v26, v26, map[f26 := v3[732]], v26, v26, v26, v26];
					var v28: seq<bool> := [f15];
					var v29 := DC0(v27, v28, v22, fm1(globalState));
					var v30 := DC2(cf16, v29, true);
					var v31: map<bool, D1> := map[v19 > (multiset{cf18, |v25|, v23[138]})[f14 := f27] := v30];
					v31 := v31[!(v6 <= cf17) := v30];
					globalState.f4 := f15;
					...
					var v35 := DC22(v3[732], cf16);
					var v36: map<C8, D10> := map[v34 := v35];
					var v37 := DC77(v36);
					var v38: array<map<C8, D10>> := new map<C8, D10>[25] [v36, v36, v36, v36 + v36, if (cf16) then v36 else v36, map[v34 := DC22(!v3[732], v34.f31)] + v36, v36, v36, map[v34 := v35] + v36, v36, v36, v36 + v36, v36 + v36, v36, v36, v37.cf150 + v36, v36, map[v34 := DC22(v34.f31, true)], if (v3[732]) then v36 else v36, v36, v36, v36[v34 := v35], v36, v36, v36];
					v38[952] := map[v34 := v35] + v36;
					v38[952] := v36;
					v3[732] := f26;
					cf16 := f15;
				}
			...
			case DC10(cf24, cf25, cf26) =>
				...
				var v44: set<bool> := {v3[732]};
				var v45 := DC19();
				cf25, globalState.f0, globalState.f4 := (if (f26) then cf25 else |v44|) % (v40.fm28(v45, globalState) + f14), cf25, DC48(v4, cf24, cf25, v4, f27).cf96;
			case DC7(cf15) =>
				...
				match (v49) {
					case DC67(cf130, cf131) =>
						...
						v52[738] := p0;
						v52[738] := -(if (v3[732]) then 0xb0 else 606);
					case DC68(cf132, cf133) =>
						globalState.f0 := if (v3[732]) then p0 else f14;
						v6 := fm48(v4, -(p0 % f27), -cf133, cf133, globalState);
						...
						v55[462], v8[859][25], v55, cf133, globalState.f5 := ((if (f27 in v56) then v56[f27] else f14) * |v57[f27 := |v5|]|) - p0, v3, v55, cf133, !f15;
						globalState.f4 := cf132;
					case DC66(cf129) =>
						var v58: set<int> := {f14, p0, p0, f14};
						var v59 := DC13(v58);
						globalState.f0 := |(v59.cf32 - v58)|;
						var v60, v61 := m0(f27, v3[732], f15, f27 * f27, globalState);
		...
		var v76: set<bool> := {v3[732]};
		var v77: array<int> := new int[26] [p0, -f14, f14, f14, |v68|, p0, f14, f14, |v68|, f27, |"eyhfysik"|, |v71|, v69.fm3(v75, globalState), f14, p0, p0, p0, |v76|, f27, f14, 0x27b, 0x230, f14, v75[f14], p0, |(seq(0x84, i2  => (v10)))|];
	...
	method m17(globalState: GlobalState) {
		...
		if (!(f14 !in v0)) {
			...
			v4[690] := fm49(|v1|, globalState) in v6;
			var v7 := new C2();
		} else {
			var v8: array<bool> := new bool[27];
			var v9: array<string> := new string[3] ["wwr", seq(-0x269, i1  => (DC48('s', f26, f14, 'x', f14).cf95)), "ggpnx"];
			var v10: map<bool, bool> := map[f26 := false];
			var v11: seq<array<string>> := [v9, v9];
			var v12: array<array<string>> := new array<string>[16] [if (f26) then v9 else v9, v9, v9, if (false) then v9 else v9, v9, v9, v9, if (!(if (!f15 in v10) then v10[!f15] else false)) then v9 else v9, v9, v9, v9, v9, v9, v9, v11[f27], v9];
			v12[487] := v9;
			...
			v8, v12[487], f14, v13[1] := v20.cf91, v9, |((v21 + v21) + v21)|, v14;
			var v22 := new C1();
		...
		if (true) {
			...
			globalState.f0 := |v33| % (f14 / f27);
			var v34: C4 := new C4();
			v34 := v34;
			var v35: map<int, int> := map[-f27 := -f14];
			f14 := -|{f15, false}| + |v35|;
			f26 := f15;
			var v36: array<bool> := new bool[17] [f26, f26, true, f15, f15, f15, f26, f26, f26, false, f26, f15, f26, f15, f26, v33[v34.fm2(globalState)], f15];
			var v37 := DC57(v36);
			var v38 := DC58(v37);
			var v39 := DC58(v38);
			var v40: multiset<D25> := multiset{v39};
			f26 := (if (true) then v40 else v40) !! v40[DC58(v37) := |map[true := f15]|];
		} else {
			...
			if ("rijbsnarx" < v43) {
				...
				globalState.f0 := (f27 % fm26(f15, (DC2(true, DC0(v44, v45, v46, f15), f15).(cf5 := f15)).cf7, globalState)) / f27;
				var v47: array<string> := new string[13];
				v47 := v47;
				var v50: array<map<int, bool>> := new map<int, bool>[3](i3 => (map v48 : int | (73 <= v48) && (v48 < -0x236) :: (v48 % f27) := (!f26)) + (map v49 : int | (0x252 <= v49) && (v49 < 0x19) :: (v49 * f14) := (true)));
				var v51 := 'e';
				v50[627] := map[|v0| := f15] + fm34(v51, globalState);
				var v52: map<int, bool> := map[f14 % f27 := f15];
				v50[627] := v52;
				...
				var v59: seq<array<bool>> := [v58[f27]];
				var v60: array<int> := new int[2](i4 => i4 - f27);
				var v61: set<array<int>> := {v60, v60};
				var v62 := DC57(v57);
				var v63: array<array<bool>> := new array<bool>[21] [v57, v59[v41[909]], v57, v57, v57, v58[|v61|], v57, if (f15) then v57 else v57, v57, v57, v57, v57, v57, v57, v57, v57, v62.cf113, v57, v57, v57, v57];
				var v64: array<D17> := new D17[16];
				var v65: seq<int> := [f27];
				var v66: map<bool, int> := map[f15 := v41[909]];
				var v67: seq<array<D17>> := [v64];
				v63, v41[909], v64 := v63, v65[if (f15 in v66) then v66[f15] else f14] - f27, v67[v65[f14]];
				var v68 := 'q';
				var v69: set<char> := {v68, v68, v68, v68, v68};
				var v70 := new C8(f26, v69, v41[909] - f27, f15);
				v57[486] := v70.f31 ==> f15;
				v57[486] := -0x1a3 < f14;
				v57[486] := fm1(globalState);
			}
			...
			globalState.f1 := v43[v76[f14]];
			var v77: map<int, bool> := map[f14 := f15];
			var v78: map<char, int> := map[v72 := |v77| / |map[v41 := f26]|];
			v78 := v78[if (!false) then v72 else v72 := f27 % f27];
		}
...
class C11 extends T0 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		v0 := v1[f25];
		var v2 := "dgpmcmtho";
		var v3: seq<string> := [v2, (seq(0xe0, i0  => ('e'))) + v2, v2];
		v3 := v3;
		...
		v4[668] := if (|v7| in v5) then v5[|v7|] else -f24;
		var v8 := false;
		var v9: map<bool, int> := map[v8 := -|(seq(0x35f, i1  => ('k')))|];
		globalState.f0, v4[668] := -0x13f + f24, |(v9 + v9)|;
		globalState.f0 := f24;
		var v10 := 'a';
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
			...
			decreases 100 - i0
		{
			...
			v0[79] := v2 !! v2;
			v0[79] := if (f24 == f25) then p0 && true else p0;
			v0[79] := (f25 >= -f24) ==> v0[79];
			var v3 := "jscheq";
			var v4: map<int, bool> := map[f24 := v0[79]];
		...
		if (p0) {
			...
			globalState.f5, p1[709], globalState.f0 := f25 < 0x301, f24, |v9|;
			globalState.f4 := fm1(globalState);
			...
			v10[73] := v11 + (if (v8[f25] in v12) then v12[v8[f25]] else v11);
			v10[73] := v11 + (v11 + v11);
			var v13 := 'k';
			var v14: map<int, char> := map[p1[709] := v13];
		...
		v24, p1[882], globalState.f4, v27[705], globalState.f0 := v24, |(v33 + v29)|, false, if (p0) then v26 else v26, f24 % (if (!p0) then f25 else f24);
		...
		for i4 := f24 to f25 {
			if (742 <= f24) {
				...
				v35[143] := p0;
				v35[143] := i4 < 0x307;
				var v36 := DC62(true, p1[882]);
				p1[882] := v36.cf123 / f25;
				var v37: map<int, set<char>> := map[807 := {v23}];
				var v38: set<char> := {fm41(p1[882], p0, v35[143], globalState), v23};
				var v39 := new C8(if (v35[143]) then v35[143] else p0, if (f24 in v37) then v37[f24] else v38, f25, p0);
				globalState.f0 := -(i4 - f24);
				globalState.f4 := v35[143];
			} else {
				globalState.f0 := f25;
				var v40: array<array<int>> := new array<int>[24];
				v40[1] := if (p0) then p1 else p1;
				var v41: multiset<bool> := multiset{p0};
				var v42 := DC12(p0, |v41|, i4, f25);
				var v43 := DC39(v42, p0, p1, p0, f24);
				v40[1] := v43.cf75;
				var v44: map<int, multiset<bool>> := map[p1[882] := fm55(p0, p0, globalState)];
				var v45, v46 := m0(|(if (i4 in v44) then v44[i4] else v41)|, p0, p0, i4, globalState);
				globalState.f0 := p1[882];
				var v47: map<bool, int> := map[p0 := f25];
				var v48: multiset<int> := multiset{|v47|};
				var v49 := "oma";
				p1[882] := if (|v49| in v48) then v48[|v49|] else p1[882] + v46;
			}
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v52: map<int, int> := map[p1[882] := f24];
			v52 := v52[-f24 := if (p0) then f25 else p1[882]];
			if (|multiset{p0, p0, p0}| > (f25 + 0x2a)) {
				var v53: array<bool> := new bool[27];
				v53[302] := p0;
				v53[302] := f25 == (f24 % -f24);
				var v54: seq<char> := [v23, v23, v23];
				var v55: multiset<bool> := multiset{p0, v53[302]};
				var v56 := DC63(|v55|, v23);
				var v57: seq<multiset<int>> := [multiset{|v54|, |map[p1 := p0]|, |v54|, f25}];
				var v58 := DC52(v57);
				var v59: map<int, D23> := map[p1[882] := v58];
				var v60: seq<map<int, D23>> := [v59];
				var v61: map<int, bool> := map[f24 := p0];
				var v62 := DC46(v61, v54, v53, p0, v29);
				var v63: map<bool, seq<char>> := map[!v53[302] := v54];
				var v64: array<seq<char>> := new seq<char>[24] [v54, v54, [v56.cf125, v54[|v60|]], v54, v54, v54, v54, fm37(p0, v52, false, globalState), v54, v54, v62.cf90, fm85(p0, globalState), v54, fm85(p0, globalState), v54 + v54, (if (p0 in v63) then v63[p0] else seq(-0x392, i6  => ('b')))[p1[882] := 'g'], [v23] + (seq(730, i7  => ('d'))), v54, seq(95, i8  => ('x')), [v23] + v54, fm85(v53[302], globalState) + [v23], seq(967, i9  => (v23)), v54, v54];
				v64[316] := if (p0) then v54 else [v23];
				var v65: map<array<bool>, seq<bool>> := map[v53 := v33];
				v64[316], p1[882], globalState.f4, globalState.f4 := v54, f25, true, v53 !in (if (p0) then map[v53 := v29] else v65);
				globalState.f4 := v30 < v30;
				var v66 := new C10(v53[302], if (v53[302]) then 0x26 else 547, p1[882], fm1(globalState));
			...
			v73, p1[882], globalState.f0, r0, globalState.f5 := v73, |v77|, f25, f25 / f25, p0 <==> (v79 != v79);
			var v80: map<bool, bool> := map[p0 := fm1(globalState)];
			v80 := if (p0) then map[p0 := p0] else v80;
		}
		r0 := p1[882];
		var v81: seq<char> := [v23];
		var v82: multiset<char> := multiset{'w', v81[f24], v23};
		r1 := v82;
		var v83: set<int> := {p1[882]};
		var v84 := DC13(v83);
	...
	method m15(p0: set<int>, p1: int, p2: char, p3: array<bool>, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := |(p0 * (set v4 : int | v4 in v3 :: (v4 % |map['t' := true]|)))| to -|(if (v0) then v6 else v6)[f25 := v5]| {
			v0 := !v0;
			globalState.f4 := v0;
			var v7 := new C10(v0, p1, f24, v0);
			var v8: array<array<int>> := new array<int>[9];
			var v9: array<int> := new int[19](i1 => i1 / p1);
			v8[80] := v9;
			v8[80] := v9;
		}
		var v10 := "uyhvk";
		...
		v17[948] := p2;
		var v18: array<int> := new int[9](i2 => i2 % |[f24, |[v0, v0, false, v0]|]|);
		var v19: set<array<int>> := {v18, v18, v18, v18};
		var v20: multiset<char> := multiset{p2, p2};
		globalState.f0, v17[948], v19 := (f25 + p1) + v16.fm3(([p1, p1, -|v20|])[p1 := f24], globalState), p2, v19;
	...
	method m16(globalState: GlobalState) returns (r0: bool, r1: string, r2: map<int, D10>) {
		...
		for i0 := if (v0) then |v5| else f25 to if (v0) then fm3(v6, globalState) else f25 {
			if (!!v0) {
				...
				v7[201] := v8 + v8;
				v7[201] := v8 - (v8[f25 := |v2|] * v8);
				globalState.f0 := -(f25 * (f25 / i0));
				globalState.f4 := !v0;
				var v9: seq<bool> := [v0, v0];
				var v10 := DC47(multiset{false});
				globalState.f5 := multiset{v9[f25], v0} !! v10.cf94;
				var v11 := DC19();
				v11 := v11;
			} else {
				var v12: set<int> := {f25};
				...
				globalState.f4 := v2[|v12| := v1] in v16;
				...
				var v21: set<bool> := {false};
				var v22: array<int> := new int[10] [|v2| % -0x374, 0x231, |v6|, f25, i0, f24, -0x8c, |v19|, if (-0x27d in v20) then v20[-0x27d] else f24, |v21|];
				v22[272] := |v20| % f24;
				v22[272] := f24 - f24;
				v0 := v0;
			}
			...
			if (v24 !! (v24 * (set v25 : int | v25 in v23 :: (v25 - -|map[0x140 := -|map[false := "teg"]|]|)))) {
				...
				v30[330], v29, globalState.f0, globalState.f0, globalState.f0 := v0, v29, -(fm2(globalState) % f25), v31.cf12, |v33|;
				var v34 := DC24('y');
			...
			v44[15] := [true, fm1(globalState)];
			var v45: seq<bool> := [v0, v0, v0];
			v44[15] := if (v0) then v45 + v45 else [v0] + [v0];
		}
		...
		match (v47) {
			case DC17(cf36) =>
				...
				v49[801] := v0;
				v49[801], globalState.f4 := v0, f24 > f25;
				var v50: map<char, array<bool>> := map[v1 := v49];
				if (v1 in v50) {
					var v51 := DC8(v0, v2, f25);
					var v52 := DC34(v51, v0, seq(0x2d8, i3  => (v1)));
					var v53: multiset<D16> := multiset{v52, v52};
					var v54 := new C3(v53, f24, v0);
					var v55 := DC48(v1, v49[801], -0x1bd, v1, 0x319);
					var v56 := DC51(v55);
					var v57: map<int, D22> := map[fm2(globalState) := v56];
					var v58: map<int, map<int, D22>> := map[fm2(globalState) := v57];
					globalState.f0 := (|[v49[801]]| + f25) / -|v58|;
					globalState.f5 := !false;
					var v59: map<bool, int> := map[v49[801] := |(if (v49[801]) then v2 else seq(569, i4  => (v1)))|];
					var v60: multiset<int> := multiset{f24};
					v59 := v59[v0 := |map[if (f25 in v60) then v60[f25] else v54.fm4(v2, v0, v49[801], globalState) := v49[801]]|];
					v49[801] := v60 >= v60;
				} else {
					var v61: map<int, string> := map[f24 := v2 + v2];
					var v62: array<int> := new int[17];
					v61 := v61[f25 % |[v62, v62]| := v2];
					var v63: array<char> := new char[24];
					var v64: multiset<array<char>> := multiset{v63, v63};
					v64 := v64;
					var v65: map<bool, bool> := map[v0 := v0];
					var v66: seq<bool> := [v49[801]];
					v65 := if (v49[801]) then v65 else fm0(|v66|, globalState);
					v66 := v66;
					var v67: set<bool> := {v49[801], v0};
					v0 := v67 !! v67;
				}
				
				var v68: map<int, bool> := map[603 := v0];
				v68 := v68[|((seq(882, i5  => (v1))) + v2)| := v49[801] <==> v0];
		}
		
		globalState.f0 := (f25 % f24) - f25;
		...
		var i6 := 0;
		while (-(if (v6 in v78) then v78[v6] else |v2|) > (f24 % f25))
			decreases 100 - i6
		{
			if (i6 >= 100) {
				break;
			...
			i6 := i6 + 1;
			globalState.f1 := v1;
			v70[988] := if (v0) then v0 else v0;
			v70[988] := v0;
			var v79: map<int, char> := map[f24 := v1];
			var v80: array<bool> := new bool[18] [v0, v70[988], v0, v70[988], v70[988], v70[988], v0, v70[988], v0, v0, true, true, v0, v70[988], v70[988], v70[988], v70[988], v0];
			var v81: map<array<bool>, char> := map[v80 := v2[0x34]];
			var v82 := DC63(f24, v1);
			var v83 := DC79(v3);
			var v84: seq<bool> := [fm24('i', v83.cf152, globalState)];
			var v85 := DC27(v1, f25, v0, v0, v84);
			var v87: array<map<int, char>> := new map<int, char>[21] [v79, v79, v79, v79, map[f25 := v1], v79 + v79, v79, v79, map[|v71| := if (v80 in v81) then v81[v80] else v1], v79 + map[f24 := v82.cf125], v79 + v79, v79, fm68([v85.cf56], fm1(globalState), globalState) + (map v86 : int | (0x266 <= v86) && (v86 < 323) :: (v86 / -0x19) := ('n')), v79, v79, map[f25 := if (f24 in v79) then v79[f24] else v1], v79, v79, v79[f25 := v1] + v79, v79, v79];
			v87[154] := v79;
			var v89: map<bool, map<int, char>> := map[fm1(globalState) := map[f24 := v1]];
			var v90: map<bool, bool> := map[v0 := v70[988]];
			v87[154] := (map v88 : int | v88 in v71 :: (v88 + f25) := (v2[f24])) + (if ((if (v70[988] in v90) then v90[v70[988]] else true) in v89) then v89[if (v70[988] in v90) then v90[v70[988]] else true] else v79);
			v70[988] := v2 < fm25(f24, globalState);
		}
		v2 := v2;
		var v91: set<int> := {f24};
		var v92: multiset<array<bool>> := multiset{v70, v70, v70};
		var v93: seq<string> := [v2];
		r0 := fm73(|v91|, f24, |("bqp")[f25 := v1]|, -|v92|, globalState) == v93;
		r1 := v2;
		var v94: T0 := new C1();
...
class C12 {
	...
	method m13(p0: array<bool>, p1: seq<bool>, p2: array<int>, p3: int, globalState: GlobalState) returns (r0: char, r1: bool) {
		...
		for i0 := p3 to p3 {
			...
			match (v8) {
				case DC2(cf5, cf6, cf7) =>
					...
					v9[546] := v12;
					v9[546] := v12;
					globalState.f0 := fm23(p3 / p3, 2, i0 > i0, p3, globalState);
					...
					var v17 := "tovexr";
					globalState.f0, r1, v13, v16 := p3 + (if (cf7) then |v17| else |(seq(0x249, i1  => (p3)))|), cf7, v13, v16;
				case DC3(cf8, cf9, cf10, cf11) =>
					var v18 := "mowxcw";
					...
					v0[189] := |v20| in v24[p3 := fm1(globalState)];
					var v25: set<string> := {v18};
					v0[189] := v25 !! v25;
					var v26 := 'f';
					r0 := v26;
					var v27: seq<int> := [i0];
					var v28: map<bool, seq<int>> := map[p1[p3] := seq(0x3d2, i2  => (i0))];
					globalState.f0 := |(([0x1f8, p3] + v27) + (if (false in v28) then v28[false] else v27))[|p1| := i0]|;
				case DC1(cf4) =>
					var v29 := new C2();
					var v30: set<int> := {--|"wmvspdclq"| / p3, p3, p3};
					v30 := if (!v3) then v30 else set v31 : int | (0x277 <= v31) && (v31 < 0x3dc) :: (v31 / i0);
					var v32 := "aosusdfyf";
					var v33 := DC8(v3, v32, 731);
					var v34 := DC34(v33, v3, seq(674, i3  => ('n')));
					var v35: multiset<D16> := multiset{v34, v34};
					var v36 := new C3(multiset{v34} + v35, p3, if (v3) then v3 else v3);
					p2[26] := i0;
					p2[26] := if (v3 in v7) then v7[v3] else -(p3 * 0x4a);
			}
		...
		for i4 := p3 to p3 * p3 {
			...
			var v48: multiset<string> := multiset{("qhvyhhcq")[|(seq(0x345, i5  => (v37)))| := v37]};
			var v49: map<bool, string> := map[v38 := "hlivrk"];
			var v50 := "eefjt";
			var v51: map<int, bool> := map[i4 := v38];
			var v52: multiset<map<int, bool>> := multiset{v51, v51};
			var v53, v54 := m0(|[v38, v38]| % -(if ((if (v38 in v49) then v49[v38] else v50) in v48) then v48[if (v38 in v49) then v49[v38] else v50] else p3), DC75(p1[0x26e], v38).cf148, v38, |v52|, globalState);
		}
		if (-p3 <= p3) {
			var v55 := false;
			var v56: map<string, bool> := map["pbqlistjl" := v55];
			v56 := v56[if (v55) then seq(0x226, i6  => ('x')) else "c" := !false];
			var v57: multiset<int> := multiset{p3};
			v57 := v57;
			var v58 := 'x';
			var v59: seq<char> := [v58, v58, v58];
			globalState.f1 := v59[p3];
			var v60: set<bool> := {true};
			var v61: map<set<bool>, int> := map[v60 := -p3];
			var v62: seq<int> := [p3];
			v61 := DC83(map[v60 := v62[p3]]).cf160;
			p2[372] := |"fxaccybl"|;
			p2[372] := p3 / p3;
		} else {
			var v63 := 'i';
			...
			var v67: map<int, map<int, D25>> := map[|v65| := map v66 : int | (0x326 <= v66) && (v66 < 0x1c5) :: (v66 % |map[true := |multiset{true}|]|) := (DC56([DC31(false)]))];
			var v68 := true;
			p0[261] := v68;
			var v69: set<char> := {v63, v63, v63, v63};
			var v70: map<bool, bool> := map[v68 := v68];
			var v71: map<bool, int> := map[!(v69 > v69) := |v70|];
			v67, p0[261], v71, globalState.f0, globalState.f0 := if (v68) then v67 else v67, v68, v71 + v71, p3, -p3;
			if (v68) {
				globalState.f0 := p3;
				globalState.f5 := p0[261];
				...
				v68 := p0[261];
				globalState.f5 := |v64| > fm23(p3, p3, p0[261], p3, globalState);
				...
				var v83: seq<array<int>> := [p2, v81.cf43, v82[p3]];
				var v84: array<array<int>> := new array<int>[28] [p2, v83[p3], p2, v77, v77, p2, v77, p2, v77, p2, p2, p2, p2, v77, v77, p2, v77, p2, p2, v77, v77, p2, v77, v77, v83[p3], v77, p2, v77];
				v84 := v84;
			}
			...
			var v89: map<map<int, int>, bool> := map[v86 := p1[|v88|]];
			p2[994] := |(v89 + v89)|;
			var v90: set<int> := {-0x21a, p2[994], |map[v68 := p0[261]]|};
			v90 := v90;
		}
	...
	method m14(p0: int, p1: int, p2: bool, p3: array<int>, globalState: GlobalState) returns (r0: int, r1: int, r2: set<bool>, r3: bool) {
		...
		var v1: seq<bool> := [p2];
		v0 := v0[p0 := true in v1];
		globalState.f0 := 0xd4 + (|(seq(0x322, i0  => (p1)))| + p1);
		var v2 := "um";
		r0 := |v2| % p0;
		var v3: set<int> := {p1};
		...
		if (v4 < fm81(p1, v5, globalState)) {
			...
			globalState.f4, v2, r1, globalState.f0, v10[69] := !(v13.cf148 ==> p2), "wsdsaoc", p0, (if (true) then p1 else p0) / p0, if (p2 in v14) then v14[p2] else v12;
			var v15: map<bool, bool> := map[p1 <= p0 := p2];
			var v16: seq<map<bool, bool>> := [v15];
			var v17: set<string> := {"f"};
			v15 := v16[p0] + fm0(|v17|, globalState);
			if (p0 > fm23(p1, p0, p2, 413, globalState)) {
				...
				v21 := DC25(p0, map v22 : int | (689 <= v22) && (v22 < -0x311) :: (v22 - p1) := (v1[p0]), |v2|).(cf48 := p0);
				var v23: set<bool> := {p2};
				p3[849] := ---(p0 % |v23|);
				p3[849] := p1 % p1;
				globalState.f5 := p2;
				...
				var v28: array<string> := new string[6] [v2[p1 := v5], v26[p1], v2, fm48(v5, p0, p1, fm23(|v27|, p0, p2, 954, globalState), globalState), (seq(-0x8f, i1  => (v5))) + "weviqrjo", if (p2) then v2 else v2];
				v28 := v28;
				var v29: map<bool, int> := map[p2 := p1];
				v29 := v29 + v29;
				globalState.f5 := ((seq(545, i2  => ('m'))) + v2) < "kpmaulr";
				p3[77] := p1;
				p3[77] := p1;
			...
			globalState.f5 := if (p2) then p0 == p0 else v30 == v31[p1];
			globalState.f5 := if (p2 in v15) then v15[p2] else p2;
		}
		
		var v32: multiset<string> := multiset{v2, ("rgseenxoc")[p1 := v5]};
		v32 := v32[v2 := p0];
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			var v35 := DC9(v1[p1], p2, fm0(|v4|, globalState), false, p2);
			var v36: map<D3, bool> := map[v35 := p2];
			var v37: seq<map<D3, bool>> := [v36];
			p3[913] := |v37|;
			p3[913] := (-0x1f6 * p1) - fm23(|v1|, p1, p2, |v3|, globalState);
			globalState.f1 := v5;
			var v38: array<int> := new int[28];
			var v39: multiset<array<int>> := multiset{v38};
			globalState.f5 := v39[v38 := |v4|] !! v39;
			var v40: array<D2> := new D2[29](i4 => DC6(DC6(DC4(p3[913]))));
			var v41 := DC4(p0);
			var v42 := DC6(v41);
			var v43 := DC6(v42);
			v40[543] := v43.(cf14 := DC4(p0));
			v40[543] := fm97(v2, globalState);
		}
		var v44: set<char> := {'m'};
		...
		r1 := -483 + v45.f14;
		var v47: multiset<seq<int>> := multiset{v4[|multiset{v45.f15, p2}| := p1]};
		r2 := {p1 >= p0, v47 != multiset{v4, seq(31, i5  => (|(set v48 : map<bool, bool> | v48 in multiset(seq(399, i6  => (v46))) :: (v48))|))}};
		r3 := p2 && v45.f15;
	}
}
...
class C13 extends T0, T1 {
	...
	function fm4(p0: string, p1: bool, p2: bool, globalState: GlobalState): int {
		if (false <==> false) then |(seq(238, i0  => (f23)))| else DC5(0x1ec).cf13 * f14
	}
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		if (false) {
			...
			var v6: array<array<bool>> := new array<bool>[7] [v4, v4, v4, v5[f14], v4, v4, v4];
			v6[616] := v4;
			var v7: seq<int> := [f14];
			...
			f14, v6[616], globalState.f0, globalState.f5, globalState.f5 := 0x74 - |v7[|v8| := f14]|, v4, f14, v9 !! fm18(f15, f14, false, f22, globalState), fm17(v10, v11, f14 * f14, f15, globalState);
			...
			match (v14) {
				case DC12(cf28, cf29, cf30, cf31) =>
					...
					v4 := v4;
					globalState.f5 := fm17(v10, v11, f14 / |v2|, false, globalState);
				...
				case DC11(cf27) =>
					...
					var v19 := DC10(f22, v16[130], v18);
					v16[130], v4[659], v16[130] := -(f14 * v19.cf25), !f22, fm3(v7, globalState);
			...
			globalState.f4, globalState.f0, v2, globalState.f1 := (seq(0x307, i1  => (multiset{-0x3cd}))) != v22, f14, v2, f23;
			...
			var v35 := DC18(v34);
			var v36 := DC2([f22, f15] <= [!f15], DC0(v33, [f15, f22, f15], seq(0xf0, i3  => (0x305)), f22), v34 >= v35.cf37);
			var v37: seq<int> := [|(seq(0x246, i4  => (f23)))|, f14, f14];
			var v38 := DC8(f22, v27, f14);
			var v39: array<string> := new string[24] [(fm21(v37[f14], globalState)).cf17[f14 := 'p'], v27, v27, v27, v27, v27, v27 + v27, v27, "dnktts", v38.cf17, v27, v27 + v27, v27, v27 + v27, v27 + v27[f14 := f23], "otah", v27, v27, "hlnfl", v27, if (true) then seq(-0x32b, i5  => (f23)) else v27, v27, v27, v27];
			v39[893] := v27 + v27;
			...
			v30, v31[532], v36, v39[893], v40[541] := if (v41 in v43) then v43[v41] else v30 + v30, v32, DC2(f15, DC0(v33, v26, v37, f15), f22).(cf5 := f22), v27[f14 := 'w'] + v27, f14 + f14;
			globalState.f5 := f14 != v40[541];
			var v44 := DC7([f22]);
			v26 := v44.cf15;
			f14 := f14 * -v40[541];
			...
			globalState.f5, v40[541], v45[180] := (v46 + v46) !! v46, if (f15) then f14 else v40[541] + v40[541], f22;
		}
		...
		if (v52 >= v52) {
			...
			var v54, v55 := m0(f14, f15, v53[f14], f14, globalState);
			var v56: array<bool> := new bool[5];
			v56[895] := f22;
			v56[895] := f15 && f15;
			v51 := (seq(0x35b, i8  => (f23))) + ("j" + "njite");
			v55 := f14;
		} else {
			f14 := f14;
			globalState.f5 := f14 != f14;
			...
			v64[244] := v70 > multiset(v51);
			v64[244], globalState.f5 := v68 <= v68, f15;
			globalState.f0 := (f14 + f14) / f14;
		}
		...
		for i12 := if (false) then |v74| else |v75| to f14 {
			...
			var v81 := DC46(v79, "yfkrxex", v71, f22, v80[i12]);
			...
			var v87 := DC0(v83, v72, v85[f14 := |v86|], f15);
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		var v0 := "pprnqj";
		var v1: seq<bool> := [f22];
		var v2: seq<bool> := [f22, f15, p0, v1[f14], p0];
		var v3 := DC53(635);
		...
		var v11: array<char> := new char[27] [f23, f23, f23, f23, f23, f23, f23, f23, f23, f23, f23, f23, v0[f14], f23, f23, 'k', v0[f14], f23, f23, f23, f23, 'c', 'p', f23, f23, f23, f23];
		var v12: map<int, array<char>> := map[|v10| := v11];
		var v13: multiset<int> := multiset{|v12|, f14, f14};
		var v14: array<int> := new int[28] [f14, f14, f14, fm4("sfj", f22, p0, globalState), f14, -|v0|, 332 % f14, -f14, f14, f14, |v1|, f14, if (v1[v3.cf106]) then 733 else f14, f14, f14, f14 % -|v4|, v7[f14], fm3(v7, globalState), |v8|, f14, f14, 0x31e, -|v9| * f14, (if (|fm0(0x107, globalState)| in v10) then v10[|fm0(0x107, globalState)|] else 858) * -f14, f14, |v0|, (if (|v7| in v13) then v13[|v7|] else f14) - f14, -0x370];
		...
		if (p0) {
			...
			v25[224] := v22;
			v25[224] := map v26 : int | (569 <= v26) && (v26 < 627) :: (v26 / |(map v27 : int | (0x283 <= v27) && (v27 < 0x2fb) :: (v27 / v24.f24) := (f15))|) := (p0);
			globalState.f0 := |(v7 + v15)| * v24.f25;
			globalState.f5 := f22;
			v14[630] := -v16;
			var v28: map<int, map<bool, int>> := map[v16 := v18];
			v14[630] := -365 + |(if (v24.f24 in v28) then v28[v24.f24] else v18)|;
		} else {
			var v29: array<array<bool>> := new array<bool>[6];
			var v30: array<bool> := new bool[8];
			v29[773] := v30;
			v29[773] := if (p0) then v30 else v30;
			var v31 := DC25(0x363 / |[if (p0 in v18) then v18[p0] else -f14, fm4(v0, f15, f15, globalState), -v16, -f14, |v0|]|, map[v16 := f15], f14);
			v31 := v31;
		...
		r1 := v35[fm41(fm3(v15, globalState), f22, !fm1(globalState), globalState) := v16 / f14];
		r2 := f23;
	}
	method m3(p0: int, globalState: GlobalState) {
		f14 := f14;
		...
		if (!match fm80(-227, globalState) {
			...
			v8[905] := f23;
			v8[905], globalState.f5 := f23, true;
			...
			v11[670] := f14 - (if (f22 in v13) then v13[f22] else p0);
			...
			v14[664] := |v2| - p0;
			v14[664] := (if (f15) then |[f22]| else p0) / p0;
			globalState.f5 := f15;
		}
		
		var v15: seq<int> := [f14 * fm4(v2, f22, false, globalState)];
		globalState.f0 := v15[f14];
...
class C14 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		if (f15) {
			...
			var v3 := DC86(seq(0x25f, i2  => (DC47(multiset([v1.f26])))));
			v2[731] := v3.cf163;
			var v4: multiset<bool> := multiset{false};
			var v5 := DC47(multiset{f15, v1.f26});
			var v6: seq<D22> := [DC47(v4), v5];
			var v7 := "hv";
			v2[731] := (v6 + (seq(-687, i3  => (DC47(multiset{!v1.f26, false}))))) + fm106(v7, globalState);
			...
			v15, v16 := v15 + v15, v16[0x36a := f14] + v16;
			...
			var v20 := "y";
			v19[175] := |v20|;
			v18[320], v19[175] := f15, 0x23c + (f14 * -p0);
			var v21: array<char> := new char[23](i5 => 'f');
			var v22: map<array<char>, int> := map[v21 := v19[175]];
			globalState.f0, v22, globalState.f4 := p0, v22[v21 := -p0], v18[320] <==> fm1(globalState);
		}
		...
		v26 := match DC73({v27.(cf106 := v32.cf99)}) {
			...
			case DC75(cf147, cf148) => v26 + v26[f14 := v28]
	...
	method m11(p0: int, globalState: GlobalState) returns (r0: bool, r1: array<map<int, bool>>, r2: bool) {
		...
		for i0 := f14 to p0 {
			...
			if (f15) {
				...
				var v6: array<int> := new int[10] [i0 * |v3[f14 := 'g']|, p0, i0, i0, p0, fm23(|(map v4 : int | (-0x373 <= v4) && (v4 < 0x1c4) :: (v4 + i0) := (i0))|, |v5|, false, i0, globalState), f14, 668 * 718, if (f15) then p0 else f14, p0];
				v6[277] := f14;
				v6[277] := p0;
				var v7: seq<int> := [f14, i0, i0];
				var v8 := 'd';
				var v9: map<seq<int>, int> := map[v7 := |("gnamgk")[v6[277] := v8]|];
				var v10: map<int, int> := map[if (v7 in v9) then v9[v7] else f14 := i0];
				var v11: map<seq<char>, bool> := map[v3 + v3 := !(v3[p0] !in fm37(!f15, v10, f15, globalState))];
				v11 := v11[v3 := f15];
				var v12 := new C9((v3 + v3)[p0 := v8]);
				var v13: map<int, bool> := map[|fm107(f15, f15, f14, v3[p0], globalState)| := f15];
				var v14: map<int, array<bool>> := map[p0 := v1];
				var v15: seq<map<int, array<bool>>> := [(v14[801 := v1])[f14 := if (v6[277] in v14) then v14[v6[277]] else v1]];
				var v16: multiset<int> := multiset{f14, v6[277], |v15[-v6[277]]|, p0};
				var v17: seq<bool> := [f15, !(!f15 && fm1(globalState)), multiset((([v6[277]])[f14 := v6[277]])[f14 := f14]) > v16];
				globalState.f0, globalState.f4, globalState.f4, v13 := p0, v17[p0], f15, v13 + v13;
			} else {
				var v18: array<int> := new int[27];
				v18[38] := -p0;
				var v19 := 'u';
				globalState.f0, globalState.f5, v3, globalState.f0, v18[38] := p0, !(497 > f14), ("ixdh")[f14 := v19], p0, f14;
				v1[943] := [f15, !f15] < [f15, f15, f15, f15, f15];
				v1[943] := f15 <==> true;
				v1[943] := !v1[943];
				var v20: set<int> := {-i0, fm23(p0, p0, v1[943], -fm23(v18[38], f14, f15, 0x194, globalState), globalState), f14, 594};
				v20 := {v18[38], p0, f14, -0x5c};
				v18[38] := (v18[38] / i0) - p0;
			}
		...
		var v28: set<string> := {seq(0x2c7, i2  => (v24)), seq(0x226, i3  => (v24))};
		var v29 := "gremutbq";
		var v30: set<char> := {v24};
		var v31: multiset<int> := multiset{p0, p0};
		var v32: map<bool, int> := map[f15 := |v31|];
		var v33: array<int> := new int[16] [if (f15 in v21) then v21[f15] else f14, |(v22 + v22)|, p0, |(v23 + v27.cf146)|, f14, |v28|, fm4(v29, f15, f15, globalState), fm4(v29, f15, f15, globalState), p0, f14, f14, -p0, |v30|, f14, p0, -|v32| % p0];
		...
		for i4 := f14 to |v23| {
			...
			var v37: set<int> := {i4};
			var v40: map<int, multiset<int>> := map[|(set v39 : set<int> | v39 in [v37, {if (v24 in v25) then v25[v24] else p0, |(map v38 : int | (885 <= v38) && (v38 < -0x13a) :: (v38 % f14) := (v24))|}] :: (v39))| := v31];
			var v41: multiset<map<int, int>> := multiset{v35, (map v36 : int | v36 in {p0} :: (v36 % |{f14, i4, p0, i4, |v29|}|) := (i4))[|v40| := f14], v35, v35};
			var v42: map<bool, bool> := map[f15 := !f15];
			var v43: seq<multiset<map<int, int>>> := [v41];
			var v44: array<multiset<map<int, int>>> := new multiset<map<int, int>>[18] [v41, v41 + v41, v41, v41, v41 + v41, v41 + multiset{v35, v35}, v41[v35 := |v42|] * v41, v43[0x39b], v41, v41, v41 * v41, multiset{v35, map[i4 := p0]}, v41, v41, v41 - v41, v41, v41, v41];
			v44[518] := v41;
			var v45 := DC9(f15, !f15, v42, false, f15);
			var v46: seq<bool> := [v45.cf19];
			var v47 := DC27(v24, |{false}|, true, false, v46);
			v33[52], globalState.f0, globalState.f5, v44[518] := -(p0 / v47.cf53), 0x39b, i4 > 0x1bb, v41;
			var v48: array<int> := new int[19];
			v48 := if (f15) then v48 else v48;
			var v49 := DC13(v37);
			v24 := fm79(v49, DC27(v24, v33[52], f15, false, v46[-0x35a := f15]).(cf52 := v24, cf56 := v46), v29, globalState);
		}
		...
		match (match v50 {
			...
			case DC25(cf48, cf49, cf50) =>
				...
				var v53: seq<bool> := [f15];
				var v54 := DC46(map v52 : int | (0x121 <= v52) && (v52 < 749) :: (v52 % 0x257) := (f15), v29, v51, false, v53[fm23(|v23|, f14, f15, p0, globalState) := f15]);
				v51, globalState.f0, globalState.f0, v29, v33 := v54.cf91, cf50, |(v29[-650 := v24] + v29)|, v29 + (v29 + v29), v33;
				v33[698] := p0;
				v33[883] := -281;
				var v55: seq<string> := [v29, v29, v54.cf90];
				var v56 := DC66(v55);
				var v57: T1 := new C10(f15, cf48, f14, f15);
				f14, v33[698], cf49, v33[883], v56 := v23[cf48 + 0x293], |map[p0 := DC89(v57).cf166]|, cf49[cf50 := f15], f14, v56;
				if (v57.f15) {
					var v58: seq<multiset<bool>> := [multiset{v57.f15}];
					var v59: seq<seq<multiset<bool>>> := [v58];
					globalState.f5 := if (v57.f15) then f15 && f15 else v53[|v59[cf50]|];
					...
					var v63: array<int> := new int[7](i5 => i5 % v33[698]);
					var v64: map<int, array<int>> := map[if (v57.f15) then v33[698] else f14 := v63];
					v64 := v64[0x134 := v63];
				} else {
					v33[698] := |(v32 + v32)|;
					globalState.f4 := DC62(!v57.f15, v33[698]).cf122 || (cf50 >= 0x395);
					var v65 := new C2();
					v29 := ([v24] + v29) + v29;
					v33[698] := v57.f14;
				}
				...
				if (f15) {
					...
					var v70: array<int> := new int[10] [0x3a8, 986, -cf48, 0x323, v33[698], v33[698], |v31|, cf50, v57.f14, p0];
			...
			case DC24(cf47) =>
				...
				var v82, v83 := m0(p0 % (if (cf47 in v25) then v25[cf47] else f14), f15, f15, |v81|, globalState);
				...
				var v86: map<map<string, array<bool>>, string> := map[map[v29 := v84] + v85 := seq(693, i7  => (v24))];
				v86 := v86[v85 := v29 + v29];
				if (fm1(globalState)) {
					v29 := (v29 + v29) + v29;
					var v87: map<int, string> := map[v83 := seq(460, i8  => (v24))];
					f14 := |(v87 + v87)|;
					r0 := fm1(globalState);
		...
		var v94: set<int> := {|(seq(0x17, i9  => (f14)))|, |v93|, |multiset{f15}|};
	...
	method m12(p0: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: int, r3: multiset<multiset<bool>>) {
		if (p0) {
			...
			var v12 := DC12(f15, |(seq(0x10d, i1  => (seq(-0x2f, i2  => (f14)))))|, |v11|, f14);
			...
			v8, r2, r2, v0[613] := v8, -f14, if (v10.cf67 < v8) then v12.cf31 else |v13| - |multiset{f15}|, f14;
			globalState.f5 := |(seq(0xdd, i3  => (v4)))| != f14;
			...
			match (v20) {
				case DC21(cf39, cf40, cf41, cf42, cf43) =>
					...
					v0[613] := if (multiset{"stljgeg"} in v22) then v22[multiset{"stljgeg"}] else v0[613];
					cf40 := v4 !in "qvqm";
				...
				case DC22(cf44, cf45) =>
					...
					var v25: map<int, bool> := map[v0[613] - -v0[613] := !(f14 < f14)];
					...
					var v32 := DC43(v31[v0[613]]);
					v32 := DC43(v29).(cf83 := map[|v8| := v4] + v29);
				case DC20(cf38) =>
					globalState.f5 := p0;
					globalState.f0 := f14 / 0x283;
					v6 := v6;
					globalState.f4 := false;
			}
			...
			var v34: multiset<bool> := multiset{v33[f14]};
			...
			if (false) {
				...
				var v52: array<int> := new int[16] [f14, f14 % f14, |v34|, f14 * f14, f14, |v41| + v42[f14], f14, fm4(v44.cf139, f15, v50.cf40, globalState), v48.fm2(globalState), |map[p0 := v43]|, f14 + fm4(v43, p0, f15, globalState), f14, |v34|, f14, fm4(v43, f15, f15, globalState), |[if (f14 in v51) then v51[f14] else v49, v49, v49, v49, v49]|];
				v52[653] := fm23(f14, f14, p0, f14, globalState) + f14;
				v52[653] := f14;
				var v53: map<seq<bool>, int> := map[v33[-f14 := p0] := |v36|];
				var v54 := DC11(v53);
				var v55: seq<D4> := [v54, v54, v54, v54, DC11(v53)];
				var v56: seq<seq<D4>> := [v55];
				var v57: seq<seq<D4>> := [v55, v55, (v56[-|v37|])[f14 := fm108(f15, v52[653], 429, globalState)], v56[v48.fm2(globalState)], seq(-806, i5  => (v54))];
				v55 := v57[0x15b];
				globalState.f4 := p0;
				v38 := v38[|v33| := true];
			} else {
				...
				v58[758] := f15;
				v58[758] := ((if (f15 in v34) then v34[f15] else f14) * f14) <= -0x155;
				var v59: set<bool> := {p0};
				v59 := v59;
				var v60 := 'u';
		...
		globalState.f5 := !((if (!fm16(f15, if (f15 in v65) then v65[f15] else f14, globalState)) then seq(0x39a, i6  => (f14)) else v66) <= v66);
		var v67 := "wsxnc";
		...
		if (fm83(p0, v68, globalState) != v70[v69 := p0]) {
			...
			var v72: set<bool> := {p0};
			r1 := (|v71| / |v72|) % (if (f15 in v65) then v65[f15] else f14);
			...
			var v76: array<array<bool>> := new array<bool>[16] [v73, v73, v73, v74[|v75|], v73, v73, v73, v73, v74[f14], v73, v73, v73, v73, v73, v73, v73];
			var v77: map<array<array<bool>>, int> := map[v76 := f14 % 0x3ab];
			v77 := v77[v76 := f14];
			globalState.f1 := v69;
			...
			match (v82) {
				...
				case DC38(cf72) =>
					...
					v92[525] := (map v93 : int | v93 in (seq(-0x2c9, i9  => (f14))) :: (v93 % |v67|) := (v71))[|v67| := v71];
					var v94: map<int, seq<bool>> := map[f14 := v71];
					v92[525] := v94 + v94;
					var v95: array<string> := new string[26];
					v73[651] := false;
					v95, v73[651], f14 := v95, fm1(globalState), --0xd4;
				...
				case DC39(cf73, cf74, cf75, cf76, cf77) =>
					...
					v73[791] := (v97 + v97) !in v98;
					var v99: seq<seq<int>> := [v66 + v66, v66, v66[f14 := v66[cf77]]];
					...
					var v102: map<bool, int> := map[v73[791] := cf77];
					var v103: seq<map<bool, int>> := [v102];
					var v104: map<multiset<map<bool, int>>, seq<int>> := map[multiset(v103) := seq(0x299, i10  => (f14))];
				...
				case DC36(cf69) =>
					globalState.f5 := f15;
					v67 := fm48(v69, f14, fm4(v67, f15, v71[f14], globalState), fm4(v67, p0, p0, globalState), globalState);
					v67 := "mspawiio" + (v67 + v67);
					var v107: map<map<bool, bool>, bool> := map[map[f15 := p0] := f15];
					globalState.f0 := (|v107| - |v67|) / |v67|;
			}
			...
			if ((v108 + v108) > v108) {
				...
				globalState.f4, f14, v66 := p0, |v109| / f14, [f14];
			...
			var v127 := new C13(v67 in v126, v69, -(f14 % f14), (seq(631, i11  => (v69))) <= (fm48(v69, f14, f14, f14, globalState))[f14 := v69]);
		}
		...
		if (f15) {
			...
			v128[481], f14, v66, v132, globalState.f4 := f15, f14, v66, v132, (f14 % f14) > |v66|;
			globalState.f5 := v128[481] && (if (v128[481]) then f15 else f15);
			f14 := |v67|;
			...
			r1, globalState.f4, globalState.f0, globalState.f0 := (|v133| + f14) - f14, fm1(globalState), |v135|, fm23(if (-|v136| in v134) then v134[-|v136|] else f14, |v67|, v128[481], f14, globalState);
			globalState.f0 := f14;
		} else {
			...
			if ((multiset(v66) * v139) != (if (p0) then v139 else multiset(v66))) {
				...
				v140[54] := v141 * {f14, 642, |v66|, f14, f14};
				var v142: map<bool, bool> := map[p0 := f15];
				v140[54], globalState.f0, globalState.f0, r1 := v141, --|("qfhlipc" + ("vddgn" + (seq(0x231, i12  => (v69)))[f14 := v69]))|, -|v142|, f14;
				globalState.f0 := f14;
				globalState.f0 := f14;
			} else {
				var v143: set<char> := {v67[f14]};
				var v144 := new C8(p0 <==> f15, v143, f14, p0);
				globalState.f1 := v69;
				var v145: array<map<int, seq<int>>> := new map<int, seq<int>>[18];
				v145[750] := map[f14 := v66] + (map v146 : int | v146 in v68 :: (v146 % 0x314) := (v66));
				var v147: map<int, seq<int>> := map[f14 := v66];
				v145[750], v137 := v147 + v147, v137;
				var v148 := new C2();
				var v149 := new C5('e');
			}
			
			v65 := v65[!p0 := v66[f14]] * (v65 * v65);
		}
		...
		if (!(v67 < v67)) {
			...
			match (v150) {
				case DC5(cf13) =>
					...
					globalState.f0, v152 := (|v67| / -0x1d5) - cf13, v152 + v152;
				...
				case DC4(cf12) =>
					...
					v67, v155[901] := fm37(f14 < |v68|, v68 + v68, !p0, globalState), f15 in v158;
					globalState.f0 := v66[if (v155[901]) then f14 else cf12];
				case DC6(cf14) =>
			...
			var v168: array<string> := new string[29] [v67, seq(686, i14  => (v69)), seq(0x223, i15  => (v69)), "bwpmwygqb", ("kxwcpe")[f14 := v69] + v67, v67, "kawafdyc", v67, "henskts", v67, v67, v67, v67, v67, (seq(0x3a3, i16  => (v69))) + v67, "eqlimi", v67 + v67, v67, v67 + v67, v67 + (seq(0x325, i17  => (v69))), v67, v67, seq(-0x358, i18  => (DC27(v69, f14, true, p0, [f15, p0, f15]).cf52)), v67, v67, seq(242, i19  => (v69)), if (f15 in v167) then v167[f15] else seq(0x13f, i20  => (v69)), "dng" + v67, "kumcrlk"];
			v168[23] := v67;
			v168[23] := v67;
			var v169 := DC47(v65);
			v65 := v169.cf94 + v65;
			...
			globalState.f0 := (|{f15}| + |v172|) % |v174[f14]|;
			...
			v178[581] := f15;
			globalState.f5, v178[581] := p0 || f15, p0 <==> f15;
			var v179 := DC8(p0, v67, f14);
			var v180 := DC34(v179, fm1(globalState), v67);
			var v181: multiset<D16> := multiset{v180};
			var v182: seq<bool> := [!p0];
			var v183 := new C3(v181, f14, v182[if (f14 in v68) then v68[f14] else DC72(f14, p0).cf141]);
		}
		...
		for i21 := |v67| to |(v184[f15 := f14] + v184)| {
			...
			v185[230] := f15;
			v185[230] := -|map[f14 := f15]| < f14;
			if (fm1(globalState)) {
				globalState.f5 := f15;
				var v186: map<bool, bool> := map[v185[230] := v185[230]];
				...
				var v194: array<seq<int>> := new seq<int>[16] [v187[f14], v66, v66, seq(0x3bc, i23  => (i21)), v190.cf2, v66 + v66, v66, seq(-539, i24  => (i21)), v66[|v192| := 0x26b], v66, v66, [i21, f14, f14, |v193|], v66, v66 + [i21], v66, v66];
				v194[319] := [i21, f14];
				v69, v186, globalState.f4, v194[319] := v69, v186, !v185[230], ([i21])[f14 := i21];
				globalState.f5 := v185[230];
				v185[230] := if (!(f15 && p0)) then !v185[230] else p0;
				f14 := f14;
			} else {
				var v195: array<int> := new int[11](i25 => i25 / |multiset{-f14, f14}|);
				v195 := v195;
				v195[38] := i21;
				v195[38] := |(seq(0x7a, i26  => (f14)))| - i21;
				var v196 := new C5(v69);
				var v197: seq<bool> := [f15];
				globalState.f0 := v195[38] * (|[v197, v197]| * f14);
				var v198 := DC10(v185[230], -v66[i21], v184);
				f14 := v198.cf25;
			}
			
			var v199: set<bool> := {v185[230], false, p0, f15};
			if (v199 > v199) {
				var v200: multiset<int> := multiset{f14};
				var v201 := DC49(multiset(v66), !v185[230], p0);
				v200 := v201.cf100;
				v68 := v68[0x211 := f14];
				var v202: map<seq<int>, int> := map[v66 + v66 := i21 * |v67|];
				var v203: seq<seq<int>> := [v66];
				v202 := v202[(seq(0x6d, i27  => (f14))) + v203[i21] := i21];
				globalState.f0 := f14;
				var v204: seq<string> := [v67 + v67];
				var v205: map<int, bool> := map[f14 := !f15];
				var v206 := DC44(f14 >= i21, map[v185 := f15], v205, f14);
				var v208: map<char, map<bool, int>> := map[v69 := map[!v185[230] := 0x104]];
				var v209 := DC66(v204);
				v70, v204, globalState.f4, globalState.f0, v206 := map v207 : char | v207 in v208 :: (v207) := (true ==> v185[230]), v209.cf129, p0, -fm23(f14, f14 - |v205|, p0, f14, globalState), v206;
			} else {
				var v210: map<int, bool> := map[|v65| := p0];
				v210 := v210;
				var v211: array<string> := new seq<char>[17] [seq(0x5d, i28  => (v69)), v67 + v67, seq(0x37e, i29  => (v69)), v67 + v67, v67, v67, v67, v67, v67, v67, fm85(p0, globalState), if (v185[230]) then seq(0x34b, i30  => (v69)) else v67, (v67 + "flrxylk")[|v210| := v69], v67 + v67, v67, "wwjfb", v67];
				v211[572] := v67;
				v211[572] := v67;
				var v212: seq<string> := [v67];
				var v213: array<int> := new int[28](i31 => i31 / i21);
				v213[986] := -636;
				var v214 := DC70(i21, v210, i21);
				v212, v213[986], globalState.f0 := ((seq(0x2e4, i32  => ("irvdukq"))) + v212) + v212, (if (v185[230]) then v214 else v214).cf137, i21;
				v185[230] := f15;
				var v215: seq<bool> := [p0, f15];
				var v216 := DC39(DC12(v215[f14], |"fdwvucr"|, f14, fm4(v67, f15, p0, globalState)), v213[986] >= v213[986], v213, fm1(globalState), f14);
				v216 := v216;
			}
...
class C15 extends T1 {
	...
	function fm4(p0: string, p1: bool, p2: bool, globalState: GlobalState): int {
		|(((map v0 : int | v0 in (map v1 : int | v1 in [f14] :: (v1 - f14) := (f15)) :: (v0 / |"rpks"|) := (f14)) + map[f14 := f14]) + (map[f14 := f14] + map[f14 := f14]))|
	}
	method m3(p0: int, globalState: GlobalState) {
		...
		v0[654] := if ('g' in v2) then v2['g'] else p0;
		for i0 := f14 to -f14 {
			...
			v4[836] := f15;
			var v5 := "boqtebye";
			var v6: multiset<bool> := multiset{false, false, v4[836], f15};
			var v7: seq<int> := [v0[654], if (f15 in v6) then v6[f15] else p0];
			var v8 := DC8(v4[836], v5, v7[p0]);
			var v9 := DC9(v1[p0], f15, map[!f15 := false], f15, v4[836]);
			globalState.f5, globalState.f0, globalState.f5, v0[654], v5 := v4[836], v8.cf18, v9.cf19, 0x2aa + -(i0 - p0), v5;
		}
		var v10: array<string> := new string[14];
		var v11 := "lvlleiry";
		v10[151] := if (f15) then v11 else v11;
		v10[151] := fm15(f15, globalState);
		...
		var v16: seq<seq<int>> := [DC0(v15, v1, seq(267, i2  => (f14)), f15).cf2];
		v0[654], v13[695] := v0[654] + 0xc7, (seq(0x4b, i1  => (|v10[151]|))) in v16;
		var v17: set<bool> := {fm1(globalState)};
		var v18: map<int, int> := map[|v17| / p0 := p0];
		var v19 := DC16(v18);
		v18 := v19.cf35;
	}
	method m9(p0: int, p1: map<map<int, bool>, multiset<bool>>, p2: bool, p3: int, globalState: GlobalState) {
		...
		for i0 := p0 to 0x126 {
			...
			var v12: array<seq<string>> := new seq<string>[11] [v9, (fm73(p3, |v11|, p3, p0, globalState) + (seq(0x36f, i1  => ("mddrv"))))[p0 := v0], v9, [v0, v0], v9[p0 := v0], v9, v9 + v9, [v0[f14 := f21], v0, v0], v9 + v9, [v0], (v9[p0 := v9[f14]])[-f14 := v0]];
			v12[375] := DC66(v9).cf129;
			var v13: multiset<string> := multiset{v0};
			var v14 := DC22(f15 <== f15, v13 <= v13);
			globalState.f5, v8, v12[375], v14 := p2, v8, v9, v14;
		...
		v22[521], v22[592], v23, f14 := f15, fm1(globalState), v23, if ((p2 <== v28.cf84) in v25) then v25[p2 <== v28.cf84] else p0;
		var v29: seq<bool> := [v22[521]];
		match (DC81(v22[521], p0, f15, v29[p0])) {
			case DC80(cf153, cf154) =>
				var v30: array<string> := new string[25](i2 => v0[p3 := 'b']);
				var v31: seq<string> := [v0];
				v30[981] := v31[cf153] + v0;
				v30[981] := v0 + v0[p0 := f21];
				globalState.f0, globalState.f4, globalState.f0 := 0x3cd - |(v1 - v1)|, (cf153 * 0x38f) < -(fm97(v30[981], globalState)).cf13, cf154;
				var v32: array<seq<bool>> := new seq<bool>[4];
				var v33: seq<array<seq<bool>>> := [v32, v32];
				var v34 := DC90(p2, v22[521], p2);
				var v35 := DC9(f15, v34.cf169, v24, p2, v22[521]);
				var v36: set<int> := {p3, v5.fm4(v0, p2, f15, globalState)};
				v32, globalState.f4, v22[521], globalState.f0, globalState.f0 := v33[cf153], p2, !v35.cf22, fm4(fm33(globalState), cf154 < cf154, v5.fm71(p2, if (f15 in v24) then v24[f15] else p2, f15, |[|v24[v22[521] := !v22[521]]|]|, globalState), globalState), |((v36 + v36) - v36)|;
				v22[521] := v22[521];
			case DC81(cf155, cf156, cf157, cf158) =>
				...
				var v40: map<bool, int> := map[v22[521] := f14];
			...
			case DC82(cf159) =>
				...
				globalState.f0 := -(f14 % p3) % p0;
				var v44: array<int> := new int[5](i3 => i3 % f14);
				var v45: multiset<array<int>> := multiset{v44, v44};
				globalState.f5 := v45 !! v45[v44 := f14];
		}
		
		if (f15) {
			var v46: C2 := new C2();
			var v47: map<int, char> := map[fm4(v0, v22[521], fm1(globalState), globalState) := f21];
			var v48: map<set<bool>, int> := map[v1 := p0];
			var v49: seq<int> := [p0, -|v29|];
			globalState.f4, v0, f14, globalState.f0, globalState.f0 := v46 in multiset{v46, v46, v46, v46}, (v0[-p3 / f14 := if (|v48| in v47) then v47[|v48|] else f21])[v49[0x6c] := f21], |((fm33(globalState) + v0) + "l")|, -|v0[p0 := f21]|, p3;
			var v50 := v5.m26(f15, globalState);
			var v51: map<bool, char> := map[f15 := f21];
			var v52: map<D30, bool> := map[DC70(|v51|, v27, fm4("pvtuif", f15, v22[521], globalState)) := f15];
			...
			var v59 := DC93(v58);
			var v60: map<D40, bool> := map[v59 := v29[-f14]];
			var v61: map<char, int> := map[f21 := f14];
			var v62: array<int> := new int[22] [p0, |v56|, if (!p2) then f14 else -|"suds"|, f14, |"g"| - p0, p0, p3 - p3, if (v54 in v57) then v57[v54] else p3, 0x7b * -0x3a4, f14, |v29|, |v60|, p3, |(v49 + v49)|, p0, p3, f14, p0, p0 % |fm67(v61, globalState)|, p3, p0, p0];
			v54[467] := p0;
			var v63: multiset<int> := multiset{p0};
			v54[467] := if (0xe9 !in v63) then f14 else p0;
			...
			v66[449] := v67;
			v64[86], globalState.f0, globalState.f4, v66[449] := v0, p3, p2, v67 + v67;
		} else {
			var v68: map<string, bool> := map[v0 := v22[521]];
			...
			if (f15) {
				...
				v73[159] := v74;
				v73[159] := set v75 : int | (-0x231 <= v75) && (v75 < 0xad) :: (v75 % f14);
				var v76: map<int, int> := map[p0 / |v24| := p0 * |v74|];
				v76 := v76;
			} else {
				var v77: multiset<int> := multiset{v5.fm4(v0, f15, p2, globalState)};
				v77 := v77;
				var v78: array<int> := new int[21](i6 => i6 % f14);
				v78[767] := p0;
				v78[767] := p3;
				var v79: array<string> := new string[4](i7 => v0 + v0);
				v79[390] := fm25(p3, globalState);
				v79[390] := fm85(p2 || f15, globalState);
				var v80 := new C11(0x274, p3);
				var v81: map<int, seq<bool>> := map[v80.f25 := v29];
				v22[521] := !!(v78[767] in v81);
			}
	...
	method m10(p0: set<string>, p1: D5, p2: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool) {
		...
		var v5: array<int> := new int[25] [f14 / f14, f14, -0x1be * f14, f14, |v0| + -f14, f14, |v1|, 0x24, f14 % f14, if (p2) then f14 else f14, f14, (if (p2 in v2) then v2[p2] else f14) % f14, DC8(f15, v0, f14).cf18, f14, f14, f14 % f14, f14 - f14, f14, |v2|, |((v3[p2 := f15])[p2 := true])[p2 := !f15]| + v4[f14], f14 / f14, f14, f14, f14, f14];
		...
		var v7: map<int, bool> := map[v5[623] := fm1(globalState)];
		...
		var v11: array<char> := new char[14] [f21, v10.cf52, f21, f21, f21, f21, f21, v0[|{true}|], 'y', f21, f21, f21, 'e', f21];
		v11 := v11;
		r0 := f14 % (|v0| % f14);
		r1 := p2;
...
class C16 {
	...
	method m8(p0: D1, p1: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: multiset<int>, r3: bool) {
		...
		for i0 := v0 * v0 to |(v1 + v1)| {
			...
			var v11 := "mhjjblkl";
			v10 := v10[|v11| := v9];
			globalState.f5, globalState.f0 := !((if (v8.f26) then p1 else v8.f26) ==> !!p1), v8.f27 - (|v11| / i0);
		}
		...
		if (v1[|v17|]) {
			var v18: set<bool> := {!p1};
			v18 := v18;
			globalState.f5 := !v1[fm23(v0, v0, !p1, v0, globalState)];
			...
			var v23 := DC20(v22);
			v20[460] := p1;
			v19, v20, v23, globalState.f4, v20[460] := if (p1) then v19 else v19, v20, v23, -fm23(v0, -448, p1, v0, globalState) <= v0, p1;
			if (v20[460]) {
				...
				v27, globalState.f0, globalState.f5, globalState.f1 := v27 + v27, v0, (if (v20[460]) then v20[460] else p1) && ([v1, [v20[460]], v1] < v28), v16;
				v18 := v18;
				var v29: array<int> := new int[1];
				var v30 := DC97(v17);
				var v31: map<bool, bool> := map[v20[460] := p1];
				var v32: C8 := new C8(v20[460], v30.cf178, |v31|, v20[460]);
				var v33: map<C8, bool> := map[v32 := v32.f31];
				v29[991] := fm23(-v0, fm23(v0, |v33|, v20[460], v0, globalState), v20[460], 0x329, globalState);
				v29[991] := -(v0 / (v0 + v0));
				...
				v35[954] := |v18|;
				globalState.f0, v20[460], globalState.f5, v35[954] := v0, (v16 !in fm25(v0, globalState)) && !false, p1, fm23(v0, -(if (v20[460]) then 0xb4 else v0), v1 < v1, v0, globalState);
			...
			if (v20[460]) {
				...
				var v38: multiset<multiset<int>> := multiset{v36, (v36[|v37| := v0])[v0 := v0]};
				var v39: map<int, bool> := map[|v38| := v20[460]];
				v39 := v39[v0 := p1];
				globalState.f4 := !p1;
				globalState.f5 := true;
				...
				v40[763] := fm23(|map[!p1 := p1]|, v0, p1, |map[v0 := v41]|, globalState);
				var v42 := DC22(p1, v20[460]);
				var v43: map<bool, D10> := map[p1 := v42];
				v43 := v43[p1 := DC22(v20[460], v20[460])];
			} else {
				var v44: array<map<bool, int>> := new map<bool, int>[17];
				var v45 := DC32(v44);
				var v46: map<map<bool, bool>, D16> := map[map[v20[460] := v20[460]] := v45];
				var v47: map<bool, bool> := map[v20[460] := v20[460]];
				v46 := v46[v47 := v45];
				globalState.f0 := |(fm20(v1, v20[460], v20[460], globalState) + v21)| - 0x13f;
				var v48: map<int, int> := map[fm23(|v21|, v0, v20[460], v0, globalState) := v0];
				var v49: set<int> := {v0};
		...
		match (v61) {
			case DC23(cf46) =>
				...
				v65, globalState.f5, v64[139], v67, v16 := v65, p1, -v64[139], v67 + [v66[v64[139] := -v64[139]], v66], v16;
				var v68: seq<array<bool>> := [v65];
				var v69: map<bool, bool> := map[p1 := p1];
				var v70: seq<map<bool, bool>> := [v69];
				var v71: array<array<bool>> := new array<bool>[20] [v65, v65, if (p1) then v65 else v65, v68[|v70[v64[139]]|], v65, v65, v65, v65, v65, v65, v65, v65, v65, v65, v65, if (p1) then v65 else v65, v65, v65, v65, v65];
				v71[658] := v65;
				v71[658] := new bool[22](i5 => false);
		...
		var v78: map<int, multiset<T0>> := map[v64[139] := v77];
		r1 := (v64[139] * v64[139]) % |v78|;
...
class C17 extends T1 {
	...
	method m3(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3 := new C13(0x1ba >= |v2[p0]|, fm22(f15, globalState), if (f15) then f14 else 0x227, f15 || f15);
			if (!f15) {
				...
				var v10: seq<int> := [f14];
				f14 := |(fm66(fm13(v6, v7, globalState), v3.f23, v3.f22, globalState))[(if (f14 in v8) then v8[f14] else v0.fm3(v10, globalState)) % 689 := p0]|;
				...
				var v18: array<bool> := new bool[2] [v3.f22, v4[p0]];
				var v19 := DC15(v18);
				var v20: map<array<bool>, bool> := map[v19.cf34 := fm1(globalState)];
				var v21: array<int> := new int[23] [--p0, p0, 0x319, |v12|, f14 % f14, f20, |(multiset(v10) + v13)|, --|v15|, f14, -f14 + f14, f20 - p0, |v8|, f14 + |v16|, f14, |v10| / |v9|, if (v3.f22 in v17) then v17[v3.f22] else f14, DC44(v3.f22, v20, v16, |(seq(58, i1  => (p0)))|).cf87 + f14, p0, |v4|, f14, f14, f14, f14 - |(seq(-278, i2  => (v3.f23)))|];
				v21 := v21;
				...
				var v28: array<array<int>> := new array<int>[18] [v25, v25, v25, if (f14 in v26) then v26[f14] else v25, v25, v27[p0], v25, v25, v25, v25, if (v3.f22) then v25 else v25, v25, if (f15) then v25 else v25, v25, v25, v25, v25, v25];
				v28[308] := v25;
				var v29: multiset<bool> := multiset{v3.f22, f15};
				v28[308] := if (v29 >= v29) then v25 else v25;
		...
		for i4 := f14 to fm23(f20, 0x228, if (|v46| in v41) then v41[|v46|] else f15, f20, globalState) {
			var v47: map<int, seq<map<bool, D3>>> := map[f20 := seq(42, i5  => (DC100(map[f15 := DC9(f15, !f15, v45, f15, f15)]).cf181))];
			var v48 := DC8(f15, v42, f20);
			var v49 := DC9(f15, f15, v45, f15, f15);
			var v50: seq<bool> := [f15, f15, true, f15, f15];
			var v51: set<int> := {f20};
			var v52: map<bool, D3> := map[v48.cf16 := v49.(cf21 := map[fm1(globalState) := v50[|v51|]], cf22 := f15)];
			...
			if (!(f15 && (f15 ==> f15))) {
				...
				var v61: array<int> := new int[12] [(if (f15 in v59) then v59[f15] else |[|v42|]|) - f20, f14, p0, p0, f20, f14 / (if (f14 in v60) then v60[f14] else f14), i4, p0, v0.fm2(globalState), if (fm1(globalState) in v59) then v59[fm1(globalState)] else p0, 0x41, f14];
				v61[848] := (if (-f20 in v44) then v44[-f20] else f20) % |fm0(f20, globalState)|;
				var v62 := DC16(v44);
				var v63 := 'y';
				...
				v44, globalState.f4, globalState.f4, v61[848] := v62.cf35 + (v44 + fm46(f15, i4, true, f15, globalState)), i4 <= v65.cf29, fm1(globalState), -|v69[|(v46 + v46)|]|;
				var v70, v71, v72 := v0.m2(f15, v61, globalState);
				v70 := -90;
				var v73: array<set<int>> := new set<int>[23];
				v73[824] := (set v74 : int | (450 <= v74) && (v74 < 0x318) :: (v74 / f14)) * v51;
				v73[824] := v51;
				var v75: map<int, char> := map[p0 := v63];
				var v76: map<map<int, char>, set<int>> := map[v75 := v73[824]];
				v76 := v76[v75 + v75 := v73[824]];
			}
			...
			match (v83) {
				case DC70(cf135, cf136, cf137) =>
					var v84: array<int> := new int[5](i6 => i6 % f14);
					v84[978] := cf135;
					v84[978] := f14;
					var v85 := 'b';
					var v86 := DC48(v85, f15, cf137, v85, f14);
					var v87: set<D22> := {v86, v86};
					var v88, v89 := m0(cf137 + v84[978], !f15, !(v86 in v87), |v51|, globalState);
					globalState.f0 := if (f15) then p0 else -794;
					var v90 := DC29(0x18e);
					var v91: seq<D14> := [v90];
					var v92: map<bool, string> := map[f15 := fm48(v85, -|v91[p0 := DC29(cf137)]|, f14, v89, globalState)];
					v92 := v92[f15 := v42 + v42];
				...
				case DC72(cf141, cf142) =>
					...
					v97[770] := if (fm1(globalState)) then false else cf142;
					v95[466], v97[770] := fm112(f15, v50, v80.fm71(cf142, f15, cf142, v46[-0x19e], globalState), p0, globalState) + v96, v0.fm3(v46, globalState) > (f14 / -f20);
					var v98: array<array<map<int, bool>>> := new array<map<int, bool>>[10];
					var v100: multiset<int> := multiset{cf141, |v50|};
					var v101: array<map<int, bool>> := new map<int, bool>[2] [v41, (map v99 : int | v99 in v100 :: (v99 / |DC47(multiset{f15, cf142}).cf94|) := (cf142))[i4 := cf142]];
					v98[465] := v101;
					v98[465] := v101;
					globalState.f0 := p0;
					var v102 := 'x';
					...
					v105, v43, v42 := fm113(p0 % |v50|, cf142, v106, f15, globalState), v43, v42;
				case DC69(cf134) =>
		...
		for i10 := p0 to p0 / |v42| {
			...
			if (if (v110 == [f15, f15]) then f15 else (seq(0x16c, i11  => (-p0))) in v112) {
				...
				var v117 := 'k';
				var v118: map<bool, string> := map[f15 := v42[|v116| := v117]];
				globalState.f1, v114[584], globalState.f5, v118, v46 := v117, |v42| < i10, f15, v118 + v118, (v46 + [v46[f14], p0])[p0 := i10 - f14];
				...
				v121[832] := f15;
				globalState.f0, globalState.f0, globalState.f4, globalState.f0, v121[832] := f14, |v42|, f15, p0, f15;
				var v122, v123 := m6(v110 + v110, globalState);
				v42 := v42;
				var v124: multiset<int> := multiset{i10};
				var v125 := 'p';
				var v126 := DC16(v44);
				var v127: array<map<int, int>> := new map<int, int>[26] [fm94(v124, v125, f15, globalState), v44 + v44, map[-0xe2 := |map[v43 := v121]|], v44, v44, v44, fm46(v121[832], f14, f15, v121[832], globalState), v44, v44, v44, v44, map[f20 := f14], v44, map[p0 := i10], v44, v44 + v44, v126.cf35, map[f20 := fm4("yoefppoq", f15, f15, globalState)], v44, (DC16(v44).(cf35 := v44)).cf35, if (v121[832]) then v44 else v44, v44, v44 + v44, v44 + v44, v44, v44];
				v127[542] := v44;
				v121[832], v127[542] := v121[832], v44;
				globalState.f0 := 773 * f20;
			}
			
			f14 := i10;
			v42 := v42 + v42;
			v42 := (v42 + (seq(-0x114, i13  => ('d')))) + v42;
		}
	}
	method m6(p0: seq<bool>, globalState: GlobalState) returns (r0: array<set<int>>, r1: seq<string>) {
		...
		match (DC94(v0)) {
			case DC94(cf173) =>
				...
				globalState.f5 := !f15;
				var v3: set<int> := {fm23(f20, f14, f15, -|p0|, globalState), f20, |(seq(0x285, i1  => (v2.f21)))|};
				var v5: seq<set<int>> := [v3, v3, v3, set v4 : int | (0x102 <= v4) && (v4 < 0x118) :: (v4 / f20)];
				var v6: set<bool> := {true};
				var v7: map<bool, bool> := map[true := v3 != v5[fm23(f20, |multiset(seq(0x38b, i2  => (f20)))|, f15, |DC26(v6).cf51|, globalState)]];
				v7 := v7[p0[f14] := f15];
				var v8 := DC9(f15, !f15, v7, !f15, f15);
				var v9 := DC9(f15, f15, v8.cf21, f15, f15);
				var v10: set<D3> := {v9};
				globalState.f0, globalState.f0 := |v10|, (f20 * f20) / |(v7 + v7)|;
			case DC95(cf174, cf175, cf176) =>
				var v11 := "ilfksl";
				var v12: map<bool, string> := map[0x8e !in (seq(-0x319, i3  => (cf175)))[f14 := cf176] := v11];
				...
				var v24: array<map<int, bool>> := new map<int, bool>[17] [v15[f20 := cf174], map v16 : int | v16 in v18 :: (v16 % cf175) := (f15), v15, map[cf175 := true], map[f20 := f15], v15, v15, v15, v15, map[f14 := !cf174], v15, v15, v23.cf86, v15, v15, map[918 := cf174], v15];
				var v25: seq<array<map<int, bool>>> := [v24, v24, v24, v24, v24];
				var v26: array<array<map<int, bool>>> := new array<map<int, bool>>[15] [v24, v24, v24, v24, v24, v25[cf175], v24, v24, v24, v24, v24, v24, v24, v24, v24];
				v26[512] := v24;
				v26[512] := v25[0x2f];
				globalState.f5 := !f15;
			...
			case DC93(cf172) =>
				...
				if (f15) {
					v0[998] := !f15;
					v0[998] := !f15;
					globalState.f5, v28[83], v0[998] := f15, v28[83], f15;
					globalState.f5 := v0[998];
					v0[998] := v0[998];
					globalState.f4 := f15 <==> true;
				} else {
					v28[83] := f14;
					var v30: set<int> := {v28[83] % 0x78, v28[83], v28[83], v28[83], 85};
					v30 := v30;
					var v31: array<map<int, int>> := new map<int, int>[14](i5 => map[-0x26c := DC25(f20, map[v28[83] := true], f14).cf48] + map[|[{!!f15}, {f15}]| := 442]);
					...
					f14 := v28[83] / (if (f15) then v28[83] else |v35|);
				}
				
				var v36 := "tgfvuvi";
				var v37: T0 := new C11(f14, v28[83]);
				var v38: seq<string> := [v36];
				v36, v37 := v38[f14] + v36, v37;
				globalState.f4 := p0[f14];
		}
		...
		var v45 := DC102(v44);
		var v46 := DC18(v41);
		v0, f14, f14, v0[654], v41 := v0, -f14, match v45 {
			case DC101(cf182, cf183, cf184) => if (f15) then f20 else f14
			case DC100(cf181) => f14
			case DC102(cf185) => |([f20, f20] + (seq(0x3c1, i6  => (f20))))|
			...
			decreases 100 - i7
		{
			...
			i7 := i7 + 1;
			var v47 := DC37(if (false) then f15 else v0[654], f15);
			v47 := v47;
			globalState.f4 := f15;
			globalState.f5 := false;
			globalState.f4 := (f14 / f14) >= f20;
		}
		var v48: seq<int> := [|p0|];
		var v49: map<bool, int> := map[f15 := f14];
		var v50: set<bool> := {f15};
		var v51: multiset<bool> := multiset{f15};
		var v52: array<int> := new int[14] [-f14, f20 * f20, -|v48|, f20, f14, f20, f14, -(f20 % |v39|), f14, if (f15) then |v49| else |v50|, |p0| + |v51|, f14, f14, f20];
		...
		if (--f20 == f14) {
			if (f14 != f20) {
				...
				var v54 := 'n';
				v53 := multiset{625, |(if (f15) then map[v0[654] := v54] else map[f15 := v54])|};
				var v55: map<bool, string> := map[v0[654] := "kpkudsp"];
				v55 := v55[!v0[654] := "okilon"];
				v52[833] := f14;
				v52[833], globalState.f0, globalState.f5 := f14, -|(if (f15) then [f20, f20] else v48)|, -|[multiset{f15}]| == f20;
				...
				v57, v58[904] := v57, v49;
				var v59: set<int> := {f20};
				v0 := new bool[25] [fm1(globalState), v39 <= v39, fm1(globalState) <== v0[654], -f20 == f20, |v59| !in [f14], f15, v0[654], -f14 < f14, f15, f15, f15 && true, v0[654], false !in v51, v0[654], v0[654], v0[654], v0[654] ==> f15, v52[833] >= f20, multiset(v48) >= v53, if (false) then f15 else f15, v0[654], v0[654], true, !false, v0[654]];
			} else {
				var v60: map<bool, array<int>> := map[!v0[654] := v52];
				var v61: array<array<int>> := new array<int>[28] [v52, v52, v52, v52, v52, v52, v52, if (v0[654] in v60) then v60[v0[654]] else v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, if (v0[654]) then if (f15 in v60) then v60[f15] else v52 else v52, v52, v52, v52, v52, v52, v52, v52, v52, if (v0[654]) then v52 else v52];
				v61[274] := v52;
				v61[274] := v52;
				v52 := v52;
				var v62: seq<array<int>> := [v52, v61[274], v52];
				v62 := v62 + v62;
			...
			var v65: map<bool, bool> := map[if (!v64.cf16) then v0[654] else f15 := v0[654]];
			v65 := v65[f15 := v0[654]];
			var v66: seq<string> := [v39, v39, v39];
			r1 := v66 + (seq(650, i9  => (v39)));
			var v67 := 'o';
			globalState.f1 := if (false) then v67 else 'f';
		} else {
			if (!(p0 == p0)) {
				var v68 := new C11(f14 / f20, f14);
				var v69: C14 := new C14(fm4(v39, v0[654], f15, globalState), f15);
				var v70 := DC22(v48 in map[v48 := v69], v0[654]);
				...
				v0[654], v70, globalState.f0, v71[431] := (v39 < v39) !in v50, DC22(f15, f15), |(v74 + map[v0[654] := v0[654]])|, v0;
				var v75: map<int, bool> := map[|multiset{!fm1(globalState), v0[654], true, f15, !f15}| := v0[654]];
				globalState.f4 := !((|v75| % |v39|) > f20);
				globalState.f5 := f15;
				f14 := -v68.f25;
			} else {
				var v76: multiset<int> := multiset{f14, f20};
				var v77: seq<multiset<int>> := [multiset(v48)];
				v76 := v77[f20] * (if (f15) then v76 else v76);
				...
				globalState.f0 := if (v82 in v83) then v83[v82] else f14 / f14;
				globalState.f0 := f14;
			}
			
			var v84: seq<array<int>> := [v52];
			var v85 := new C0(v84, v0[654]);
			globalState.f0 := |v48|;
			var v86: seq<string> := [v39];
			var v87 := DC66(v86);
			globalState.f4, globalState.f0, v0[654], v87, v0[654] := if (v50 > v50) then if (f15) then !true else f15 else !fm1(globalState), f14, f15, v87, v0[654];
			var v88: map<int, int> := map[f14 := |v39|];
			var v89: C9 := new C9(v39);
			v88, v89, globalState.f0, globalState.f0 := (v88 + v88) + map[fm4(seq(0x3aa, i10  => (DC55(v85.f30, f15, 'b', f15).cf110)), v0[654], false, globalState) := |v89.f28|], v89, f14, f20 + |v89.f28|;
		}
	...
	method m7(globalState: GlobalState) {
		...
		match (v6) {
			case DC80(cf153, cf154) =>
				...
				v12[480] := multiset{|multiset{!f15}|} > v13;
				v12[480] := f15;
			case DC81(cf155, cf156, cf157, cf158) =>
				...
				var v25 := "pltmuokvq";
				cf155 := (--f14 / fm4(v25, cf158, true, globalState)) >= (cf156 * cf156);
				var v26: multiset<bool> := multiset{f15, cf155, f15, f15, cf157};
				v26 := (multiset{f15})[f15 := |v23|] - (v26 - v26);
			case DC79(cf152) =>
				...
				v27[971], v27[971], v27[971] := f20, |v29| - f20, if (!(0xdc >= f20)) then -f14 else v27[971];
		...
		var v40, v41 := m0(f20, false, f15, |v39[f14]|, globalState);
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			var v44 := "ed";
			var v45 := new C7(v43[|v44|]);
		}
		var v46 := DC56(seq(0x2a0, i2  => (DC31(f15))));
		...
		for i3 := f20 to f14 {
			if (f15) {
				...
				var v53: multiset<int> := multiset{v40[f14], 376 - |v52|, i3 + v41};
				var v54: multiset<bool> := multiset{f15};
				var v55: set<string> := {seq(66, i4  => (v2)), v49};
				globalState.f0, globalState.f0, globalState.f0, v41, v48[721] := f14, f20 * 0x279, if (f14 in v53) then v53[f14] else |(v54 * v54)|, (if (f15) then i3 else i3) + -v41, v55 != {"vsoue", v49[|v1| := v2]};
				var v56: seq<bool> := [v48[721], !v48[721]];
				var v57: map<int, seq<bool>> := map[f20 := v56];
				var v58: seq<seq<bool>> := [v56, v56, if (|v49| in v57) then v57[|v49|] else [v48[721], v48[721]]];
				v56 := v56 + v58[|"bv"|];
				v48[721], v48, f14, v48[721] := fm1(globalState), if (v48[721]) then v48 else v48, f14, v2 !in (seq(355, i5  => (v2)));
				var v59: array<array<string>> := new array<string>[28];
				var v60: seq<string> := ["rwm", v49, v49];
				var v61: array<string> := new string[17] [v49, v49, "lxrlbvdf", v49, v49, v49, seq(0x1d3, i6  => (v2)), v49, v49, v49, v60[f14], v49, v49, v49, "synkdjgy", v49, v49];
				v59[888] := v61;
				v59[888] := v61;
				var v62: map<bool, bool> := map[v48[721] := false];
				var v63 := DC9(!f15, v48[721], v62, v48[721], v48[721]);
				var v64: seq<map<bool, bool>> := [v63.cf21];
				var v65: array<int> := new int[8] [if (v56[v41]) then f20 else -f14, v41, |v64|, f20 - f20, f14, f20, 0x230, i3 * f20];
				v65[76] := f14;
				v65[76] := 0x3c6;
			} else {
				var v66 := new C12();
				...
				v68[321] := v40[v41];
				v68[321], globalState.f0, globalState.f0 := |([v40, v40, v40, v40, if (f15) then v40 else v40])[i3 := seq(74, i7  => (0x2a3))]|, (f20 - f14) * 0x230, -v41;
				var v69 := DC86(seq(-0x2e6, i8  => (DC47(multiset([f15])))));
			...
			v73, v74, globalState.f5, v40 := [v72, v72, v72, v72, DC87()] + (v73 + [DC87()])[i3 := DC87()], if (f15 in v75) then v75[f15] else v74, if (f15) then f15 else f15, [if (fm1(globalState)) then f14 else |v77[multiset{0x1be} := v2]|, f20];
			var v78 := DC26(v1);
...
class C18 {
	...
	method m5(p0: int, globalState: GlobalState) returns (r0: bool, r1: array<char>, r2: seq<int>, r3: seq<int>) {
		...
		match (fm11(p0, !v1[p0], p0, v0, globalState)) {
			case DC2(cf5, cf6, cf7) =>
				var v2 := DC5(p0);
				var v3: seq<int> := [p0];
				var v4 := 'a';
			...
			case DC3(cf8, cf9, cf10, cf11) =>
				...
				if (p0 > v16.f14) {
					...
					v16.f14 := fm23(v16.f14, -v16.f14, cf9, v20[p0], globalState);
				...
				globalState.f5, globalState.f5, globalState.f0 := fm1(globalState), cf8, (v16.f14 / -657) - v16.f14;
				var v27 := "de";
				...
				if ((v27 != v27) !in (v28 + v28)) {
					...
					var v32: seq<int> := [336, 835, fm23(p0, p0, v0, v29[641], globalState), v29[641], p0];
					v31 := v31[v32 <= v32 := "vfqwt"];
					cf8 := p0 != v16.fm4(v27, v0, v0, globalState);
				} else {
					v27 := ((seq(826, i3  => (v14))) + v27) + "mqc";
					globalState.f0 := v16.fm4(v27, cf9, v16.f15, globalState) / v16.f14;
					...
					var v39: multiset<int> := multiset{v38[v16.f14]};
					v33[63], v16.f14, v33, cf11, v36 := true, p0, if (v0 in v37) then v37[v0] else v33, v39 <= (v39 - v39), v36;
					var v41 := DC72(0x6c, v16.f15);
					var v42: set<bool> := {fm1(globalState), cf9};
					var v43 := DC68(v16.f15, p0);
					var v44 := DC10(v16.f15, v16.f14, cf10);
					var v45: array<int> := new int[19] [|(map v40 : int | (0x1be <= v40) && (v40 < 0x259) :: (v40 / v16.f14) := ({cf8, !cf9}))|, v41.cf141, v16.f14, |v42|, |"b"|, -v16.f14, 653, v16.f14, |v27|, p0, v16.f14, v16.f14 / (if (|"q"| in v39) then v39[|"q"|] else v16.f14), p0, v16.f14, v43.cf133, ---|v27|, v16.f14, v44.cf25, p0];
					v45 := v45;
			...
			case DC1(cf4) =>
				...
				v47[424] := fm23(0x283, p0, v0, p0, globalState) + p0;
				v47[424] := p0 * -(p0 * p0);
				globalState.f4 := false;
				var v48: seq<int> := [p0];
		...
		if (p0 < -p0) {
			...
			var v58: map<bool, C15> := map[---p0 == |v54| := if (v0) then v55 else v56[|v57|]];
			v58 := v58[v0 := v55];
			...
			var v61: seq<int> := [|(seq(378, i4  => (DC5(v53.f24).cf13)))|];
			...
			var v84: array<string> := new string[14] [v75, v75, v75 + v75, "gqmcy", seq(-0x36b, i6  => ('p')), v75, v75, v75, v75 + v75, v75, v75 + "wyfcss", "tviej" + v75, v75, v75];
			v84[162] := v75 + "igfnvkifo";
			var v85 := DC14(319);
			var v86: array<int> := new int[27];
			var v87: C0 := new C0([v86], v82.f15);
			v84[162], v85, v87 := v75 + v75, v85, v87;
		}
...
class C19 {
	...
	function fm8(p0: char, p1: char, p2: int, p3: bool, globalState: GlobalState): seq<int> {
		[|[|{!false, !false}|, 0x0]|, 853] + ([0x2a2] + (seq(0x336, i0  => (0x353))))
	}
	method m4(p0: bool, p1: map<string, int>, p2: string, globalState: GlobalState) returns (r0: array<D3>) {
			...
			decreases 100 - i0
		{
			...
			if (v6 <= v6) {
				...
				var v12: array<bool> := new bool[23] [p0, p0, fm1(globalState), p0, if (v3 in v5) then v5[v3] else false, p0, !p0, p0, p0, fm7(p0, v3, "d", globalState), (if (v11 in v10) then v10[v11] else v9) !! v9, p0, v3 < v3, p0, |v6| >= 0x2de, if (p0) then p0 else fm7(p0, v3, p2, globalState), !f19[-|[p0]|], p0, p0, p0, v2 > v2, p0, p0];
				var v13: map<bool, string> := map[p0 := seq(0x1b5, i1  => ('v'))];
				v12[797] := p0 !in v13;
				var v14: set<int> := {v3, v3};
				var v15 := DC13(v14);
				var v16: multiset<set<int>> := multiset{{0x225}, v15.cf32};
				v12[797] := !(if (false) then v16 >= v16 else fm1(globalState));
				var v17: map<bool, char> := map[p0 := v8];
				v5 := v5[v3 := fm9(globalState) >= |v17|];
				var v18: multiset<bool> := multiset{v12[797]};
				globalState.f5 := -v3 >= (if (v12[797] in v18) then v18[v12[797]] else v3);
				var v19: set<array<bool>> := {v12};
				var v20: seq<set<array<bool>>> := [v19, v19];
				var v21 := DC15(v12);
				var v22: array<set<array<bool>>> := new set<array<bool>>[24] [{v12}, v19, v20[v3], v19, v19, v19, v19, {v21.cf34, v12}, {v12}, v19 * v19, {v12, v12}, v19, v19, {v12, v12, v12}, v19, v19, v19, v19, {v12}, v19 - v19, v19, v19, {v12}, v19];
				v22[368] := if (p0) then v19 else {v12, v12, v12};
				v22[368] := v19;
				globalState.f0 := -0x37;
			} else {
				...
				var v29: array<int> := new int[13] [v3, |(seq(-320, i3  => ('l')))|, |"bxxe"|, v3, if (|v27| in v28) then v28[|v27|] else v3, v24.fm3(v27, globalState), v3, v3, v3, v3, v3, v3, v3];
				var v30: multiset<array<int>> := multiset{v29};
				v26[670] := (fm115(v3, -v3, if (v29 in v30) then v30[v29] else v3, p0, globalState)).cf146;
			}
			
			if (p0) {
				globalState.f0 := if (p0 in v0) then v0[p0] else |"ivfo"|;
				v3 := v3;
				globalState.f5 := if (p2 < p2) then f19[v3] else p0;
				...
				v31 := new int[3](i5 => i5 / DC62(false, v3).cf123);
				var v33 := 'd';
		...
		v43[335] := v47[-v44];
		v43[335], globalState.f4, globalState.f0, globalState.f0 := v45 + multiset{v44, |p2|}, p0, v44, (v44 + v44) + |p2|;
		if (v43[335] > v43[335]) {
			...
			globalState.f0 := if ((if (v53.cf32 in v52) then v52[v53.cf32] else p2) < (seq(0x4, i7  => ('r')))) then v44 else |v54| % v44;
			...
			var v60: multiset<D16> := multiset{v59, DC34(v58, p0, seq(-0xff, i8  => ('m'))), DC34(v58, p0, p2), v59, v59};
		...
		if ((seq(0x14d, i9  => ([v44, v44, -491]))) < (v68 + v68)) {
			var v69 := 'e';
			...
			match (v74.(cf51 := {p0} + v2)) {
				case DC27(cf52, cf53, cf54, cf55, cf56) =>
					...
					v75 := v75;
					v0 := fm43(v44, (set v76 : int | (0x168 <= v76) && (v76 < 655) :: (v76 % cf53)) <= {v44, -v44}, !false, globalState);
					var v77: map<bool, bool> := map[cf55 := false];
					var v78: seq<seq<bool>> := [f19, f19];
					var v79: array<seq<bool>> := new seq<bool>[14] [cf56, f19, cf56 + cf56, [p0], cf56, [false, p0, if (cf55 in v77) then v77[cf55] else cf55], [true], f19 + f19, cf56, cf56 + v78[cf53], cf56, f19, cf56, f19];
					v79[532] := cf56;
					v71[246] := v44;
					var v80: map<bool, string> := map[p0 := p2];
					globalState.f4, v79[532], globalState.f0, v71[246] := (v80 + v80) != v80, cf56, 698, --0x2cf;
					var v81 := DC85(v71[246]);
					cf53 := v81.cf162;
				case DC26(cf51) =>
					var v82, v83 := m0(v44 / v44, v44 == -v44, |p2| > v44, v44, globalState);
			...
			globalState.f4 := v86[877] && (v44 < -DC39(v89, p0, v87, p0, |v0|).cf77);
			if (if (v86[877]) then v86[877] else true) {
				var v90: array<string> := new string[25](i12 => p2);
				v90[926] := p2 + p2;
				var v91: array<array<int>> := new array<int>[19];
				v91[323] := v87;
				v44, v90[926], globalState.f0, v91[323] := |p2|, p2, v44, v87;
				v86[877] := !p0;
				var v92: array<char> := new char[28];
				var v93 := 'x';
				v92[782] := v93;
				v91[323][694] := v44;
				v92[782], globalState.f1, v91[323][694] := v93, v93, v44;
				var v94: map<char, string> := map[if (fm1(globalState)) then v90[926][-v44] else v90[926][v91[323][694]] := v90[926] + p2];
				v94 := v94['v' := p2 + v90[926]];
				var v95 := new C4();
			} else {
				var v96 := new C18();
				globalState.f4 := v86[877];
				globalState.f0 := v44 % v44;
				globalState.f0 := fm9(globalState) % (v44 - v44);
				var v97 := DC8(p0, p2, -|v43[335]|);
				var v98: map<int, D3> := map[v44 := v97];
				globalState.f0, globalState.f5, v98 := (if (v86[877]) then v44 else v44) * (v44 * v44), v86[877], v98 + v98;
			}
			...
			decreases 100 - i13
		{
			...
			match (v102) {
				case DC53(cf106) =>
					...
					var v111 := DC46(v109, p2 + fm48(v100.f21, v44, v106, v106, globalState), v110, f19[v106], f19);
					v111 := v111;
...
class C20 extends T0 {
	...
	function fm2(globalState: GlobalState): int {
		(if (true) then ---653 else --710) % |"cbscmuvy"|
	}
	function fm3(p0: seq<int>, globalState: GlobalState): int {
		457
	}
	method m1(p0: array<array<int>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v13[985], v13[595], v1[333], globalState.f5 := -v15.cf12, 0x1cf, f18, v4 !in v16;
			v14 := v14;
		}
		var v17: array<int> := new int[25](i2 => i2 % v4);
		var v18: seq<array<int>> := [v17];
		var v20 := 'a';
		var v21: set<char> := {v20};
		var v22: seq<set<char>> := [v21];
		var v23: set<array<int>> := {v17, v17, v17, v18[|(map v19 : set<char> | v19 in v22 :: (v19) := (f18))|]};
		v23 := v23;
		var i3 := 0;
		while (f18)
			decreases 100 - i3
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		...
		if (v0[v1]) {
			...
			if (f18) {
				...
				var v21 := DC0(v17, [f18, p0], if (v1 in v20) then v20[v1] else seq(0x16a, i2  => (v1)), f18);
				v15 := v15[v14 := v21.cf1];
				p1[28] := v1;
				p1[28] := v1;
				var v22: map<bool, int> := map[p0 := p1[28]];
				var v23 := 's';
				v19 := [p1[28], v1, v1, -p1[28], if (!f18 in v22) then v22[!f18] else p1[28]] + fm66(v1, v23, f18, globalState);
				var v24: array<array<bool>> := new array<bool>[17];
				var v25: array<bool> := new bool[18];
				v24[934] := v25;
				var v26: map<int, int> := map[p1[28] := |v19|];
				var v27: set<int> := {v1, if (-fm9(globalState) in v26) then v26[-fm9(globalState)] else |multiset(v0)|, if (v1 in v26) then v26[v1] else p1[28], p1[28] + v1};
				var v28 := DC94(v25);
				v24[934], v1, v27 := v28.cf173, |fm73(|v18| * p1[28], |v4|, |v18| * v1, -|fm94(v4[p1[28] := p1[28]], v23, p0, globalState)| + |fm52(globalState)|, globalState)|, {fm9(globalState)};
				var v29 := DC34(DC8(f18, "kmmhygd", p1[28]), f18, v18);
			...
			var v42: map<bool, int> := map[v0[v1] := v1];
			v41[464] := v42;
			var v43 := "hjqegf";
			var v44 := DC65(v1, v1);
			var v45: map<D28, bool> := map[v44 := v37[744]];
			var v46 := DC10(p0, v1, v42);
			globalState.f0, v37[744], v37[744], v40, v41[464] := if (f18) then v1 + v1 else v1, |v43| == |v45|, v46.cf24, v40, v42;
		} else {
			...
			var v53 := DC84(p0);
			var v54: array<multiset<int>> := new multiset<int>[7] [(multiset(([|"fygaldiiq"|])[v1 := v1]))[489 := v1], v47, multiset((fm66(v1, v48, true, globalState) + v50)[|v52[v53 := v1]| := v1]), multiset{v1, v1} * v47, v47[fm3(v50, globalState) := v1] - multiset{v1}, v47, v47 * v47];
			v54 := v54;
			...
			match (v58) {
				case DC2(cf5, cf6, cf7) =>
					...
					p1[0] := |v61|;
					p1[767] := v1;
					p1[0], v0, p1[767], v1 := (v1 + |map[p0 := v1]|) + fm9(globalState), v0, -|v50| + (if (!false) then -0x285 else v1), (v1 - v1) * v1;
				case DC3(cf8, cf9, cf10, cf11) =>
					var v62: array<bool> := new bool[9];
					var v63: map<array<bool>, bool> := map[v62 := f18];
					var v64: array<seq<int>> := new seq<int>[27] [fm39(globalState), v50 + v50, v50, v57.cf2 + (seq(0x142, i3  => (v1))), v50, v50 + v50, v50, [v1, --v1], v50, if (fm1(globalState)) then [|map[v1 := v49]|] else seq(0x270, i4  => (v1)), v50, v50, v50, v50, [v1], v50, v50 + v50, (seq(0x32e, i5  => (v1))) + (seq(0xcd, i6  => (|v47|))), v50, v50, v50 + [|cf10|, |v63|], v50 + (seq(-0x26f, i7  => (v1))), fm31(globalState), v50, v50, v50[v1 := fm3(v50, globalState)], v50];
					v64 := if (f18 <== f18) then v64 else v64;
					globalState.f0 := if (|v50| > -|v47|) then v1 else v1;
					var v65: set<array<int>> := {p1, p1};
					var v66 := new C17(v1, fm9(globalState), v55[100] !in v65);
					var v67 := new C16();
				case DC1(cf4) =>
					...
					v74 := v74[-fm9(globalState) := v49[|[v1]| := v48]];
			}
			
			globalState.f4 := (594 / v1) >= v1;
			var v75: seq<string> := [v49];
			p1[810] := |v49|;
			var v76: array<bool> := new bool[23](i8 => p0);
			v76[207] := v0[v1];
			var v77 := DC81(false, |v49|, p0, p0);
			r0, v75, p1[810], globalState.f5, v76[207] := v77.cf156, [v49], 0x325, p0, f18;
		}
		...
		match (DC42(f18, p0 || p0, fm1(globalState))) {
			case DC42(cf80, cf81, cf82) =>
				...
				v86 := (v86 + v86) + ("onll")[|v87| := v78];
			case DC41(cf79) =>
				var v88: set<bool> := {f18};
				var v89 := new C14(v1, p0 in v88);
				var v90 := "exbtb";
				v90 := v90 + (v90 + (seq(-0x9a, i9  => ('s'))));
				v0 := v0[v1 := true];
				var v91: array<seq<bool>> := new seq<bool>[1];
				v91[847] := v0;
				var v92: seq<seq<bool>> := [v0[v1 := f18], v0, v0, v0];
				v91[847] := v92[v1];
		}
		...
		for i10 := |v94| to 0x2a6 {
			...
			if (f18) {
				var v96: array<bool> := new bool[14](i11 => v0[-|{f18, f18}|]);
				var v97 := DC31(false);
				var v98: seq<D15> := [v97];
				var v99 := DC56(v98);
				var v100: map<D25, bool> := map[v99 := f18];
				var v101: map<map<D25, bool>, int> := map[v100 := v1];
				var v102: seq<string> := [(v95 + v95)[if (v100 in v101) then v101[v100] else i10 := v93], v95, v95];
				var v103: array<map<bool, int>> := new map<bool, int>[22](i12 => map[f18 := v1]);
				v96, v102, globalState.f4, globalState.f0, v103 := v96, v102[i10 := v95], f18, i10, v103;
				globalState.f5 := f18;
				globalState.f0 := v1;
				...
				var v107 := new C2();
				var v108 := new C4();
				globalState.f5, globalState.f1, globalState.f5 := v0[-i10], v93, p0 <==> p0;
				v95 := v95;
			}
...
class C21 extends T0, T1 {
	...
	method m1(p0: array<array<int>>, globalState: GlobalState) {
		...
		if (f16) {
			...
			if (f14 > 33) {
				...
				v29, f14, v33, globalState.f0 := v29, |v30[--(if (v31.f14 in v34) then v34[v31.f14] else v31.f14) := v12]| - (if (|map[f14 := f17]| in v34) then v34[|map[f14 := f17]|] else v31.f14), if (v31.f15) then v33 else v33, v31.f14 / f14;
				...
				v44[301] := v36;
				v44[301] := map[v35 := v2[v31.f14]] + v36;
				var v45 := DC4(v31.f14);
				var v46: multiset<string> := multiset{v30, ("nvfobo")[f14 := v12], v30, "rcvvvvv"};
				...
				v48, globalState.f4, globalState.f0 := v48, v47[f14 := v12] < fm48(v12, f14, f14, f14, globalState), f14 % |"kljn"|;
				...
				var v55: multiset<map<int, int>> := multiset{map v52 : int | (0x2c3 <= v52) && (v52 < 109) :: (v52 % f14) := (f14), v53, if (v12 in v54) then v54[v12] else v53};
				v51 := v51[v50 := (seq(217, i4  => (v12)))[|v55[v53 := f14]| := v12]];
				f14 := f14 - -f14;
			}
	...
	method m2(p0: bool, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: multiset<char>, r2: char) {
		...
		var v3 := DC58(v2);
		var v4 := DC58(v3);
		var v5 := new C17(v0[|[v4, DC58(v3), v4]|], 0x18, f17);
		var v6 := "h";
		...
		var v12: array<int> := new int[22] [v5.f20, 837, fm3(fm39(globalState), globalState), 0xed, f14, f14, v5.f20, |(seq(0x4c, i1  => ("itkca")))|, |v7| / |v0|, fm23(|fm48(v8, f14, f14, f14, globalState)|, --0x3c9, f15, v5.f20, globalState), v5.f20, f14, v5.f20, |(if (f15) then v7 else fm91(f17, v9, globalState))|, v5.f20, v5.f20, 0x185, v5.f20 * f14, v5.f20, v5.f20, if (|v11| in v10) then v10[|v11|] else v5.f20, |v6| % v5.f20];
		forall i0 | 0 <= i0 < v12.Length {
			v12[i0] := i0 * (f14 / v5.f20);
		}
		...
		if (p0 || f16) {
			...
			v19 := v19[v6 + (seq(212, i4  => (v8))) := v5.f20 / -f14];
			...
			if (if (f15) then f15 else !f16 <==> f16) {
				...
				var v27 := DC34(DC8(false, seq(0x2d3, i5  => (v6[v5.f20])), f14), f15, v6);
				...
				v30[817] := if (v5.f20 in v24) then v24[v5.f20] else f17;
				var v31: map<bool, array<int>> := map[f17 := v12];
				var v32: seq<array<int>> := [if (f16 in v31) then v31[f16] else p1, p1, v12];
				v11, v12, v30[817], globalState.f4, globalState.f0 := v26.f19, v32[f14], !(!f15 && p0), f16, 0x32d;
			} else {
				var v33: map<bool, int> := map[f15 := |v6|];
				var v34 := DC10(false, v5.f20, v33);
				var v35: map<bool, bool> := map[p0 := true];
				var v36 := DC9(v11[v5.f20], if (p0) then f16 else v34.cf24, v35, p0, f15);
				var v37: array<bool> := new bool[17](i6 => !f17);
				var v38: multiset<string> := multiset{v6, seq(714, i7  => (v8))};
				v37[334] := multiset{"lalsfov"} !! v38;
				var v39: T0 := new C2();
				var v40: seq<T0> := [v39, v39];
				v36, v37[334], globalState.f5, globalState.f0, v40 := v36, f16, p0, v5.f20, [v39, v39, v39] + v40;
				var v41: C4 := new C4();
				v41 := v41;
				var v42 := DC101(seq(185, i8  => (v8)), v37[334], v8);
			...
			if (if (v5.f20 != v5.f20) then f17 else f16) {
				globalState.f4 := !f16;
				globalState.f5 := f15;
				var v45, v46 := m0(v0[v5.f20], f15, f17, if (f17) then v5.f20 else f14, globalState);
		...
		if (v6 != v6) {
			...
			var v59: array<bool> := new bool[29] [p0, f17, v5.f20 !in v57, v55.f15, f16, (DC50(p0).(cf103 := f15).(cf103 := f16)).cf103 !in v58, f16, f17, v55.f15, if (f15) then f16 else f16, v55.f15, f14 <= -|v6|, p0, 827 != fm9(globalState), fm1(globalState), f17, !f17, !p0 <==> true, p0, fm1(globalState) || f16, p0, p0, if (v0[v5.f20] in v57) then v57[v0[v5.f20]] else f17, f15, v55.f14 in v0, v55.f15, f17, p0, true];
			var v60: map<seq<int>, char> := map[(fm31(globalState))[|v11| := f14] := v8];
			var v61: seq<string> := [v6];
			v59[48] := (if (v0 in v60) then v60[v0] else v8) !in v61[v55.f14];
			v59[48] := !f17;
			...
			var v67: array<map<int, bool>> := new map<int, bool>[25] [v57, v57 + v57, map[f14 := false] + v57, v57, v62.cf89 + v57, v57, map[v5.f20 := v55.f15], v57, v57, v57, v57 + v57, v57 + v57, v63[f14], map[v5.f20 := false], v64.cf49, v57, v57, v57 + (map v65 : int | (0x200 <= v65) && (v65 < 605) :: (v65 * f14) := (f16)), v57, v57, map[if (f15 in v66) then v66[f15] else v55.f14 := p0] + v57, map[v5.f20 := p0], map[v5.f20 := p0], map[-0x2f1 := v59[48]], v57];
			v67[87] := map v68 : int | (0x286 <= v68) && (v68 < -440) :: (v68 / v55.f14) := (v55.f15);
			v67[87] := v57;
			if (v55.f15) {
				r0 := f14;
				...
				v69[156] := if (v59[48]) then v71[f14] else seq(-0x8e, i12  => (v11));
				v69[156] := v70;
				...
				var v77: seq<multiset<map<bool, bool>>> := [fm118(globalState), v75, multiset{v76[f14]}];
				var v78: array<multiset<map<bool, bool>>> := new multiset<map<bool, bool>>[17] [v75, v75 - v75, (multiset{v74})[v74 := v55.f14], v75, v75, v75, v75 - v75, v75, v75 * v75, multiset(v76), multiset(v76) + v75, v77[v55.f14], v75, v75, v75, v75, multiset{fm0(f14, globalState)}];
				v78[704] := v75;
				var v79: C4 := new C4();
				var v80: map<C4, int> := map[v79 := v5.f20];
				v78[704] := (multiset{v74, fm0(v5.f20, globalState)})[v74 := f14 % |v80|];
				var v81: array<char> := new char[6] [v8, v8, v8, v8, v8, v8];
				v81[571] := 'p';
				v81[571] := v8;
				var v82: array<multiset<bool>> := new multiset<bool>[7];
				v82[711] := multiset{true, v59[48], true, v55.f15};
				v59[48], v59[48], v82[711] := f16 <== (if (v55.f15 in v74) then v74[v55.f15] else v59[48]), if (v5.f20 > v5.f20) then p0 else if (false) then v79.fm57(v55.f14, v81[571], globalState) else f15, v66 + v66;
				globalState.f0 := fm2(globalState);
				globalState.f5 := (if (v59[48]) then f16 else true) ==> p0;
			}
			
		} else {
			var v83 := new C19(([f17])[f14 := f15]);
			if (f15) {
				p1[281] := v5.f20;
				var v84: array<bool> := new bool[1](i13 => p0);
				v84[469] := p0;
				v12[468] := v5.f20;
				var v85: map<array<bool>, bool> := map[v84 := v83.f19[v5.f20]];
				var v86: map<int, bool> := map[0xe6 := f16];
				var v87 := DC44(v83.fm7(f15, f14, v6, globalState), v85, v86, f14);
				p1[281], globalState.f4, v84[469], globalState.f4, v12[468] := f14 % v5.f20, f16, !f17 <==> v87.cf84, fm6(f17, f16, f14, globalState), -f14;
				var v88 := DC62(f16, if (v84[469]) then p1[281] else f14);
				v88 := if (if (f16) then f15 else p0) then v88.(cf122 := f17) else v88;
				var v89: set<bool> := {true, v84[469]};
				...
				v92 := v92[v93 := !f15];
				globalState.f4 := f16;
				var v95: C13 := new C13(!(if (p0 in v91) then v91[p0] else v84[469]), 'd', v5.f20, false);
				v6, globalState.f5, v95, p1[281] := v6, f17, v95, -v5.f20;
			} else {
	...
	method m3(p0: int, globalState: GlobalState) {
		...
		if (f16) {
			var v7 := "fbhkmjv";
			globalState.f5 := v7 == (seq(-0x278, i0  => ('h')));
			v5[91] := -f14;
			v5[91] := p0;
			var v8: seq<int> := [v5[91], f14, v5[91], -|v7|];
			v5[91] := v8[v5[91]];
			var v9: array<bool> := new bool[26](i1 => f17);
			v9[38] := f17;
			var v10 := DC87();
			v9[38], v5[91], v10, globalState.f0 := f17, p0, v10, -(|(v8 + v8)| / f14);
			f14 := fm2(globalState);
		} else {
			globalState.f0 := f14;
			var v11 := 'o';
			...
			var v14 := "wgg";
			globalState.f0, v14, globalState.f0 := |(v14[f14 := v11] + v14)|, (fm120(f15, f17, -f14, v11, globalState)).cf139, f14;
			var v15: map<char, string> := map[v12.f23 := "ffupfrwe" + "covh"];
			v15 := v15[v12.f23 := (seq(0x62, i2  => (v12.f23))) + v14];
			var v16: C2 := new C2();
			v16 := v16;
		}
		...
		for i3 := |v17| to if (f17 in v18) then v18[f17] else fm4(v19, v20[0x127], f16, globalState) {
			var v21: array<bool> := new bool[10] [f16, f17, !false <==> f16, f16, f15, !f17, f17 ==> f16, v20[0x93], f17, i3 != |v17|];
			v21[391] := f17;
			...
			decreases 100 - i5
		{
			...
			if (f15) {
				globalState.f0 := -p0;
				var v28 := DC8(false, "jtyfk", |v19[f14 := v26]|);
				var v29 := DC34(v28, f15, v19[p0 := v26]);
				var v30: T1 := new C3(multiset{v29, v29}, v5[675], f15);
				var v31: map<T1, bool> := map[v30 := f16];
				var v32: set<int> := {p0, |v31|};
				var v33: seq<int> := [p0];
				f14 := (|v32| / v33[|v17|]) + v30.f14;
				var v34: array<string> := new string[28];
				v34[97] := v19;
				var v35: multiset<int> := multiset{v30.f14};
				v19, v34[97] := fm20(v20, false, v35 != v35, globalState), seq(-0xe1, i6  => (v26));
				var v36: array<bool> := new bool[29](i7 => false);
				var v37: set<array<bool>> := {v36};
				v37 := v37;
				var v38, v39 := m0(f14 * v30.f14, f16, f15, -v33[0xee], globalState);
			} else {
				v5[675] := -0xe2;
				var v40 := new C18();
				v19 := v19;
				...
				v41[129] := fm79(if (f15) then v42 else v42, if (f16) then v43 else v43, v19 + v19, globalState);
				var v44: array<C9> := new C9[12];
				var v45: map<array<C9>, int> := map[v44 := 0x2a0 + -v5[675]];
				v45 := v45;
			}
		...
		for i8 := p0 to f14 {
			...
			match (v51.(cf59 := v50)) {
				case DC31(cf60) =>
					v5[695] := p0 % p0;
					v5[695] := if (f15) then p0 / f14 else f14;
					...
					var v56: C10 := new C10(true, i8, v5[695], f17);
				...
				case DC30(cf59) =>
					...
					globalState.f1, globalState.f5, v47[666], v3[680], v61 := fm22(f17, globalState), f15, !((f14 == |v17|) || fm1(globalState)), v5, [|v62|, |v19|, -p0, i8] + v61;
...
method Main() {
	...
	var v3 := -0x82;
	var v4: array<bool> := new bool[27] [v0, v0, true, v0, v0, v0, v0, v0, v0, v0, v0, !v0, false, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v2[v3], v0];
	var v5 := "xiprvx";
	...
	for i0 := v3 to |v1| {
		...
		var v17 := DC0(v12, [if (v15 in v13) then v13[v15] else v0, v0, false], (seq(927, i1  => (v3))) + [v9, i0], v16 > {v0});
		match (v17) {
			case DC0(cf0, cf1, cf2, cf3) =>
				v5 := (seq(270, i2  => ('r'))) + ((seq(0x32b, i3  => ('l'))) + v5);
				v9 := v9;
	...
	var v24: map<bool, int> := map[v0 := |v23[v0 := v3]|];
	...
	var v34: array<int> := new int[28] [v3, v3, v9 + |v1|, v3, v9, v9, |v5| - 0x335, v3, v9, |(seq(-404, i5  => ('g')))| - v9, v3 - |{v22, v22, v22, v22, v22}|, |v24|, v9, v9, fm23(v3, |(if ((if (v0 in v27) then v27[v0] else set v28 : seq<bool> | v28 in v25 :: (v28)) in v26) then v26[if (v0 in v27) then v27[v0] else set v28 : seq<bool> | v28 in v25 :: (v28)] else v1)|, false, v9, globalState), |v8|, v9, |map[v0 := v0]|, if (v0) then v3 else |v30|, -v9, v9 - v9, v29.f27, fm23(v29.f27, |v31|, v0, v9, globalState), v9 - v3, 0x176, v9, |v33|, v3 + v3];
	...
	for i6 := v29.f27 to v3 {
		...
		if (v29.f26) {
			v22[129] := v3;
			var v35: map<char, seq<char>> := map[v5[0x89] := v5];
			v3, v22[129] := v29.f27, -(|((seq(-629, i7  => (v3))) + v8)| + |(if (v32 in v35) then v35[v32] else v5)|);
			var v36 := DC87();
			v36 := v36;
			v5 := v5;
	...
	if (v29.f26) {
		...
		globalState.f5, v7, v3, globalState.f0 := (if (v5 in v50) then v50[v5] else v8[v29.f27]) < v3, v7, fm9(globalState) + v9, v9;
		...
		match (v51) {
			...
			case DC93(cf172) =>
				...
				v60, globalState.f0, v5, v7 := v60, --(0x171 + v8[v29.f27]), [v61.cf110, 'j', v5[-v29.f27]] + v5, v7;
				v29.m17(globalState);
		}
		...
		v34[608], v4[246], v29.f26 := v3, v29.f26, v70 != (v70 + v70);
	}
	...
	for i9 := v3 + |v5| to |(map v71 : int | (0x264 <= v71) && (v71 < -780) :: (v71 - v9) := (v29.f26))| {
		if (!v29.f26) {
			...
			var v77: map<C13, bool> := map[v76 := v2[i9]];
			...
			v9 := v29.f27;
			globalState.f4 := !(-(v29.f27 / v29.f27) in v31);
			v22[748] := i9;
			v22[748] := (v29.f27 / |v82|) * fm23(v29.f27, v29.f27, v29.f26, v3, globalState);
			globalState.f0 := v3 + -|v5|;
		}
		
		var v84 := DC8(v29.f26, v5, i9);
		var v85 := DC34(v84, false, "ok");
		var v86: C3 := new C3(multiset{v85}, v9 / v9, v0);
		...
		v29.f26, v21, globalState.f5, globalState.f5, v9 := v2[v9], v21, v0, v29.f26, -v29.f27;
	}
	v3 := v29.f27;
	var v92 := new C16();
	var i10 := 0;
		...
		decreases 100 - i10
	{
		...
		if (v93 >= (multiset{v7} + v93)) {
			...
			v8 := [v3];
			var v95 := new C10(v29.f26, v29.f27, (if (v29.fm27(|(seq(0x4f, i11  => (v32)))|, v29.f27, v29.f26, globalState) in v23) then v23[v29.fm27(|(seq(0x4f, i11  => (v32)))|, v29.f27, v29.f26, globalState)] else v29.f27) - 0x1a, v29.f26);
			v95 := v95;
			...
			v104 := v104[seq(643, i12  => (v32)) := v103];
			v29.f26 := v8 < v8;
		}
