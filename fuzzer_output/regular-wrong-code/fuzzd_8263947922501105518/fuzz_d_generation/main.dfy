...
class C0 extends T0 {
	...
	function fm12(p0: int, p1: int, globalState: GlobalState): map<int, bool> {
		map v0 : int | (0x56 <= v0) && (v0 < 775) :: (safeModuloInt(v0, |[multiset([|{!false, false}|]), multiset{0x1e7}, multiset{469, -0xb0, |"rlwoljed"|}]|)) := (!(true <==> false))
	}
}
...
class C1 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		...
		v1[safeIndex(724, v1.Length)] := v0;
		v1[safeIndex(795, v1.Length)] := f25 <= "ulun";
		var v2 := "eyygeolb";
		var v3: map<array<bool>, bool> := map[v1 := !(p0 == p0)];
		var v4: seq<int> := [p0];
		v1[safeIndex(724, v1.Length)], v1[safeIndex(795, v1.Length)], v2, v0 := if (v1 in v3) then v3[v1] else v0, !(|v4| >= -p0), f25, v0;
		if (v0) {
			var v5: map<int, bool> := map[p0 := v1[safeIndex(724, v1.Length)]];
			var v6: array<C0> := new C0[29];
			var v7: multiset<array<C0>> := multiset{v6, v6};
			var v8: multiset<int> := multiset{|v5|, -p0, p0, |v7|, p0};
			var v9: seq<bool> := [true, v0, v1[safeIndex(724, v1.Length)]];
			globalState.f10, globalState.f15, v1[safeIndex(724, v1.Length)], globalState.f6 := -(-0x12f * (if (v1[safeIndex(724, v1.Length)]) then p0 else |v8|)), fm3(|v9| == fm59(p0, v0, p0, v2, globalState), globalState), v1[safeIndex(724, v1.Length)], p0;
			var v10 := DC33(p0);
			v2, globalState.f10, v1[safeIndex(724, v1.Length)] := f25 + (seq(abs(0x3be), i0  => (f25[safeIndex(p0, |f25|)]))), v10.cf63 + p0, p0 != p0;
			globalState.f6 := -0x359;
			var v11 := new C0();
			v1 := v1;
		} else {
			globalState.f10, v1[safeIndex(724, v1.Length)] := -p0, v0;
			globalState.f10 := -(safeDivisionInt(p0, p0) * -p0);
			var v12: multiset<bool> := multiset{v1[safeIndex(724, v1.Length)], v0, v0};
			v1[safeIndex(724, v1.Length)] := |v12| < v4[safeIndex(-p0, |v4|)];
			v1[safeIndex(724, v1.Length)] := true;
			globalState.f15 := f25 < v2;
		}
		
		for i1 := if (v1[safeIndex(724, v1.Length)]) then |[v1[safeIndex(724, v1.Length)]]| else -28 to p0 {
			var v13: array<map<int, int>> := new map<int, int>[10];
			var v14: set<int> := {i1};
			var v15: map<int, int> := map[i1 := |v14|];
			v13[safeIndex(825, v13.Length)] := v15;
			var v16: multiset<int> := multiset{0x1c0};
			var v17: seq<multiset<int>> := [v16, v16];
			var v18: array<int> := new int[1] [|v17[safeIndex(fm59(p0, v1[safeIndex(724, v1.Length)], |f25|, "xoekhts", globalState), |v17|)]|];
			var v19: set<bool> := {true, v1[safeIndex(724, v1.Length)], v0};
			v18[safeIndex(327, v18.Length)] := if (v0) then -p0 else |v19|;
			var v20: seq<bool> := [|v2| > p0, v0];
			globalState.f6, globalState.f10, v13[safeIndex(825, v13.Length)], v1[safeIndex(724, v1.Length)], v18[safeIndex(327, v18.Length)] := p0, p0, (v15 + map[|v2| := i1])[p0 := p0], v20[safeIndex(0x32a, |v20|)], p0;
			r1, v18[safeIndex(327, v18.Length)], v18[safeIndex(327, v18.Length)] := v20[safeIndex(p0, |v20|)], p0, |v14|;
			var v21: map<string, char> := map[f25 := f25[safeIndex(|v14|, |f25|)]];
			var v22 := 'i';
			v21 := v21["jpvvosh" := v22];
			var v23: multiset<bool> := multiset{v0};
			var v24 := DC15(fm59(v18[safeIndex(327, v18.Length)], v1[safeIndex(724, v1.Length)], |v23[v0 := abs(v18[safeIndex(327, v18.Length)])]|, v2[safeIndex(|f25|, |v2|) := v22], globalState));
			var v25 := DC16(v24);
			var v26 := DC16(v24);
			var v27: multiset<seq<bool>> := multiset{v20 + v20, fm60(v0, globalState), v20};
			var v28: array<char> := new char[16] [v2[safeIndex(p0, |v2|)], v22, v22, v22, v22, v22, 'g', v22, 'd', v22, v22, v22, v22, v22, v22, v22];
		...
		var v42 := DC32(|v30|, v1[safeIndex(724, v1.Length)], v1[safeIndex(724, v1.Length)], v38, |v41|);
		var v44: set<seq<int>> := {v4, v4};
		v32[safeIndex(195, v32.Length)] := (if (v1[safeIndex(724, v1.Length)] in v37) then v37[v1[safeIndex(724, v1.Length)]] else set v43 : seq<int> | v43 in map[[p0] := v42] :: (v43)) + v44;
		var v45: seq<bool> := [v1[safeIndex(724, v1.Length)], v1[safeIndex(724, v1.Length)]];
		var v47 := DC3(f25);
		globalState.f15, v31, r2, globalState.f6, v32[safeIndex(195, v32.Length)] := if (v1[safeIndex(724, v1.Length)]) then v0 else v45[safeIndex(-p0, |v45|)], match DC7(p0, p0, |(map v46 : int | (0xb6 <= v46) && (v46 < 0x145) :: (safeDivisionInt(v46, p0)) := (-0x321))|, v0, f25) {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		if (|v0| != (if (v1) then p0 else p0)) {
			if ((v1 <==> v1) <== v1) {
				...
				globalState.f6 := safeModuloInt(p0, p0);
				globalState.f6 := p0;
				var v12 := "vckdhsiw";
				var v13: seq<bool> := [!!v1];
				var v14: set<int> := {p0, p0};
				var v15: map<int, bool> := map[if (v13[safeIndex(p0, |v13|)]) then 0x350 else -p0 := v14 !! v14];
				var v16: seq<string> := [v12];
				var v17: map<string, string> := map[v16[safeIndex(p0, |v16|)] := v12];
				...
				var v19: array<int> := new int[9](i2 => i2 * DC36(-v0[safeIndex(0x178, |v0|)]).cf66);
				v19[safeIndex(435, v19.Length)] := 0xc6;
				var v20: set<bool> := {v1, true ==> v1};
				v19[safeIndex(435, v19.Length)] := |v20|;
				v18 := v18[v19[safeIndex(435, v19.Length)] := v19[safeIndex(435, v19.Length)]];
			}
			
			if (v1) {
				var v21 := m0(globalState);
				globalState.f15 := v1;
				var v22: array<int> := new int[28](i3 => safeModuloInt(i3, v21));
				v22[safeIndex(518, v22.Length)] := v21 - v21;
				var v23: multiset<bool> := multiset{v1};
				var v24: array<bool> := new bool[17];
				var v25: seq<array<bool>> := [v24, v24, v24, v24, v24];
				var v26 := DC45(v25);
				v22[safeIndex(518, v22.Length)] := -(|(v23 + multiset{v1})| - |(v25 + v26.cf77)|);
				v21 := v22[safeIndex(518, v22.Length)];
				var v27: array<seq<set<int>>> := new seq<set<int>>[4](i4 => [{p0}]);
				var v28: set<int> := {v22[safeIndex(518, v22.Length)]};
				var v29: seq<set<int>> := [v28, v28];
				v27[safeIndex(472, v27.Length)] := v29 + v29;
				v27[safeIndex(472, v27.Length)] := ((v29 + v29) + ((seq(abs(-604), i5  => (v28))) + v29))[safeIndex(-v22[safeIndex(518, v22.Length)] - -v21, |((v29 + v29) + ((seq(abs(-604), i5  => (v28))) + v29))|) := v28];
			} else {
				globalState.f6 := (p0 + p0) * p0;
				var v30 := 'l';
				var v31: seq<bool> := [v30 in "xsmqbvv"];
				v31 := v31 + (v31 + v31);
				globalState.f6 := safeDivisionInt(p0, p0);
				var v32: set<int> := {407, fm59(p0, v1, p0, f25, globalState), p0 - p0, p0};
				var v33: array<bool> := new bool[27];
				v33[safeIndex(930, v33.Length)] := v1;
				v32, v33, v33[safeIndex(930, v33.Length)] := v32, if (!v1) then v33 else v33, v1;
				r3 := -|fm63(v33[safeIndex(930, v33.Length)], 297, p0, true, globalState)|;
			}
			...
			v35, globalState.f6 := if (if (v1) then v1 else v1) then [[v1, v36.cf29]] else [[v1], v37, v37, v37, v37], safeDivisionInt(0x13c, |v38|);
			v38 := v38;
		} else {
			var v41: array<char> := new char[16];
			v41[safeIndex(853, v41.Length)] := f25[safeIndex(p0, |f25|)];
			var v42 := 'd';
			globalState.f15, v1, globalState.f6, v41[safeIndex(853, v41.Length)] := false, !v1, p0, v42;
			var v43: array<map<int, bool>> := new map<int, bool>[6](i6 => map[p0 := v1]);
			v43 := v43;
			var v44: map<int, bool> := map[p0 := !(|"nmfnvh"| == p0)];
			var v45 := DC8(v44);
			v44 := v45.cf23;
			r3 := -v0[safeIndex(0x25b, |v0|)];
			var v46: array<bool> := new bool[27];
			var v47: set<int> := {p0};
			var v49: set<char> := {'j'};
			var v52: map<int, int> := map[p0 := p0];
			var v54: array<set<int>> := new set<int>[24] [v47, v47, v47, v47, {p0}, v47, v47, set v48 : int | (-0xdf <= v48) && (v48 < 0xa9) :: (v48 * p0), v47, {p0, |v49|, p0}, fm64(globalState), v47, v47, v47, v47, set v50 : int | (0x2ad <= v50) && (v50 < 632) :: (v50 + p0), v47, {p0}, {|f25|}, v47, set v51 : int | v51 in v47 :: (v51 * -|{map[true := true]}|), set v53 : int | v53 in v52 :: (safeModuloInt(v53, |map[DC31(seq(abs(-0xcc), i7  => (multiset{|[false, !true, false, false]|}))) := 0x1d5]|)), v47, v47];
		...
		var v63: seq<map<char, bool>> := [v58, v58 + v58, v59[safeIndex(p0, |v59|)], v58, map v60 : char | v60 in v62 :: (v60) := (v1)];
		v58 := v59[safeIndex(p0, |v59|)];
		r2 := v1;
		var v64: set<int> := {p0};
		var v65: map<seq<int>, bool> := map[v0[safeIndex(p0, |v0|) := p0] := v64 == v64];
		var i8 := 0;
			...
			decreases 100 - i8
		{
			...
			var v71: set<bool> := {v66[safeIndex(v69.cf1, |v66|)], v70 != v70};
			v71 := v70;
			...
			v76[safeIndex(478, v76.Length)] := p0;
			v76[safeIndex(478, v76.Length)] := -p0;
		}
		for i9 := safeModuloInt(p0, |f25|) to -safeModuloInt(|"hwveutwoy"|, |v0|) {
			var v77: multiset<int> := multiset{safeModuloInt(i9, i9), i9, |map[p0 := p0]|};
			v77, v1, v1 := v77, v1, v1;
			...
			if (v78 >= v78) {
				...
				v80[safeIndex(322, v80.Length)] := safeDivisionInt(p0, -|v81|);
				v80[safeIndex(322, v80.Length)] := 924;
				globalState.f15 := v1;
				var v82: map<int, bool> := map[v80[safeIndex(322, v80.Length)] := v78 == v80[safeIndex(322, v80.Length)]];
				var v83: map<int, int> := map[fm59(v78, !v1, v80[safeIndex(322, v80.Length)], v79, globalState) := i9];
				v82 := v82[|v83| := v1];
				r2 := safeDivisionInt(p0, v78) == 0x3a2;
			} else {
				v61 := f25[safeIndex(-0x172, |f25|)];
				...
				v87[safeIndex(346, v87.Length)] := -v78;
				v87[safeIndex(346, v87.Length)] := p0;
			}
			
			var v88: array<int> := new int[23];
			v88 := v88;
		}
		var v89: array<int> := new int[29](i10 => safeModuloInt(i10, |map[v1 := !v1]|));
		var v90: set<bool> := {!v1};
		v89[safeIndex(959, v89.Length)] := |v90|;
		var v91: array<bool> := new bool[16];
		var v92: set<array<bool>> := {v91, v91, v91, v91, v91};
		v89[safeIndex(959, v89.Length)] := |({v91} - v92)|;
		r0 := 451;
		var v93: array<seq<int>> := new seq<int>[8](i11 => seq(abs(0x101), i12  => (|map[v1 := p0]|)));
		r1 := v93;
...
class C2 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		...
		v1[safeIndex(854, v1.Length)] := if (true in v2) then v2[true] else !v0;
		v1[safeIndex(854, v1.Length)] := !v0;
		var v3 := new C0();
		var v4: set<bool> := {v0, v0 <==> !v1[safeIndex(854, v1.Length)]};
		v4 := {v0} + v4;
		var v5: array<int> := new int[13];
		var v6: map<array<int>, array<bool>> := map[v5 := v1];
		v6 := if (v0) then v6 else v6;
		var v7 := 's';
		var v8: multiset<string> := multiset{f25[safeIndex(p0, |f25|) := v7] + f25, (f25 + f25[safeIndex(|f25|, |f25|) := v7])[safeIndex(p0, |(f25 + f25[safeIndex(|f25|, |f25|) := v7])|) := 'e'], f25};
		var v9: map<int, bool> := map[|[|v4|, p0, p0, p0, p0]| := !v1[safeIndex(854, v1.Length)]];
		var v10: seq<string> := [f25, f25, seq(abs(331), i1  => (v7)), "oqeo"];
		v8 := multiset([f25, "aab", ("aswamsi")[safeIndex(|v9|, |"aswamsi"|) := v7], seq(abs(0x3c9), i0  => (v7)), "kcbxa"]) * multiset(v10 + v10);
		var v11 := DC26(multiset(seq(abs(0x180), i3  => (p0))), -p0, v0, |map[f25 := p0]|, false);
		var v12: set<int> := {p0};
		var i2 := 0;
		while ((fm53(v1[safeIndex(854, v1.Length)], v11, p0, |v12|, globalState) - fm53(!v1[safeIndex(854, v1.Length)], v11, p0, p0, globalState)) !! (v4 * v4))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			match (v15) {
				...
				case DC37(cf67) =>
					...
					v20 := v20;
					var v21: map<bool, int> := map[v1[safeIndex(854, v1.Length)] := |[p0]|];
					var v22: set<array<bool>> := {v1};
					var v23: seq<set<array<bool>>> := [v22, v22, {v1}];
					globalState.f13, globalState.f15, v1[safeIndex(854, v1.Length)], globalState.f13 := (if (v1[safeIndex(854, v1.Length)] in v21) then v21[v1[safeIndex(854, v1.Length)]] else p0) <= 0x333, (fm54(v0, cf67, v1[safeIndex(854, v1.Length)], v9, globalState).(cf34 := v0)).cf34, v1 !in v23[safeIndex(-p0, |v23|)], fm1(v1[safeIndex(854, v1.Length)], globalState);
					var v24 := new C0();
				case DC35(cf65) =>
					v12 := (set v25 : int | (0x32e <= v25) && (v25 < 0x2be) :: (v25 + p0)) - v12;
					r1 := v1[safeIndex(854, v1.Length)];
					globalState.f15 := (if (v0 in v2) then v2[v0] else v0) <==> !v0;
					globalState.f15 := v1[safeIndex(854, v1.Length)];
				case DC38(cf68) =>
					var v26: map<seq<bool>, int> := map[fm55(p0, v0, v0, globalState) := if (fm3(v1[safeIndex(854, v1.Length)], globalState)) then 712 else p0];
					var v27: seq<bool> := [v1[safeIndex(854, v1.Length)]];
					v26 := v26[v27 := p0];
					var v28 := "efsntpr";
					v28 := "oojdwp";
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		if (false) {
			...
			v8[safeIndex(383, v8.Length)] := p0 > |multiset(v10)|;
			var v11 := true;
			...
			globalState.f10, v8, v8[safeIndex(383, v8.Length)], globalState.f13 := if (v11 <==> v11) then p0 - p0 else p0, if (v11) then v8 else v12.cf11, v14.cf21, if ((set v16 : map<int, bool> | v16 in [v15] :: (v16)) !! {map v17 : int | (899 <= v17) && (v17 < 0x128) :: (safeModuloInt(v17, p0)) := (true)}) then true else false;
			globalState.f13 := v11;
			globalState.f6 := |({v8[safeIndex(383, v8.Length)]} + {v11})| + p0;
			var v18 := new C0();
		...
		v21[safeIndex(122, v21.Length)] := |(fm53(v22, v24, |v25|, 0x13c, globalState) - v26)|;
		v21[safeIndex(122, v21.Length)], r2 := safeDivisionInt(p0, p0), v22;
		var v27 := DC3("cdudhos");
		var v28 := DC5(v27, v22, p0, fm1(v22, globalState));
		var v29: seq<bool> := [v22, v22];
		var v30: map<D2, seq<bool>> := map[v28 := v29];
		v30 := v30[DC5(v27, v22, v21[safeIndex(122, v21.Length)], v22) := v29];
		r0 := p0 * |(f25 + f25)|;
		var v31: set<string> := {f25};
		var v32: set<int> := {p0, p0};
		var v33 := 'x';
		var v34: map<int, char> := map[v21[safeIndex(122, v21.Length)] := v33];
		v21[safeIndex(122, v21.Length)], globalState.f10, globalState.f13 := fm58(v31, v22, globalState), -0x178, |(v32 - (set v35 : int | v35 in v34 :: (v35 - |{!false}|)))| == safeDivisionInt(p0, v21[safeIndex(122, v21.Length)]);
		...
		r1 := v41;
		var v42 := DC32(v21[safeIndex(122, v21.Length)], true, v22, {v22}, v21[safeIndex(122, v21.Length)]);
		...
		var v46: seq<int> := [|multiset([v22, !!v22, v22, !v22])|, v21[safeIndex(122, v21.Length)], p0];
		r3 := -v46[safeIndex(p0, |v46|)];
	}
	method m17(p0: bool, globalState: GlobalState) returns (r0: char, r1: int, r2: int) {
		if (p0) {
			if (f25 != (f25 + f25)) {
				...
				var v11: array<int> := new int[27] [v1, v1, 142, v1, |"indtbnkr"|, v1 + v1, |v2|, safeModuloInt(v1, v1), fm58(v3, v0.fm3(p0, globalState), globalState), |v4|, v1, v1, v1, v1 + fm58(set v6 : string | v6 in v5 :: (v6), if (p0 in v2) then v2[p0] else p0, globalState), v1, v1, v1, -v1, 0x3bb * v1, |v7|, safeDivisionInt(v1, |multiset(v9)|), v1, fm58(v3, p0, globalState), --v1, -v1, |[v10, v10]|, v1];
				v11[safeIndex(930, v11.Length)] := v1;
				var v12: set<int> := {v1, v1, v1, v1, v1};
				var v13: seq<bool> := [p0, p0, p0, p0, fm59(v1, p0, v1, v0.f25, globalState) < |v12|];
				v11[safeIndex(930, v11.Length)] := |v13|;
				r1 := v9[safeIndex(v1, |v9|)];
				r2, globalState.f13, v8 := v11[safeIndex(930, v11.Length)], p0, v8;
				var v14 := m0(globalState);
			} else {
				var v15: array<bool> := new bool[2];
				v15[safeIndex(293, v15.Length)] := p0;
				var v16 := -0x120;
				var v17: map<int, bool> := map[v16 := p0];
				var v18 := 't';
				v15[safeIndex(293, v15.Length)], r0, v15, v17 := !(true || false), if (p0) then v18 else v18, v15, v17;
				v16 := v16;
				var v19: array<int> := new int[15];
				var v20: seq<int> := [|f25|, v16];
				var v21: set<char> := {v18};
				v19[safeIndex(607, v19.Length)] := v20[safeIndex(|v21|, |v20|)];
				var v22 := "ui";
				var v23: array<array<int>> := new array<int>[17];
				v23[safeIndex(783, v23.Length)] := v19;
				v19[safeIndex(607, v19.Length)], v22, v23[safeIndex(783, v23.Length)] := -v16, ((fm56(fm1(v15[safeIndex(293, v15.Length)], globalState), fm62(v16, v16, f25, v16, globalState), -v16 != 383, globalState))[safeIndex(v16, |fm56(fm1(v15[safeIndex(293, v15.Length)], globalState), fm62(v16, v16, f25, v16, globalState), -v16 != 383, globalState)|) := if (v15[safeIndex(293, v15.Length)]) then v18 else v18])[safeIndex(safeModuloInt(|(seq(abs(0x18e), i0  => (v18)))|, v16), |(fm56(fm1(v15[safeIndex(293, v15.Length)], globalState), fm62(v16, v16, f25, v16, globalState), -v16 != 383, globalState))[safeIndex(v16, |fm56(fm1(v15[safeIndex(293, v15.Length)], globalState), fm62(v16, v16, f25, v16, globalState), -v16 != 383, globalState)|) := if (v15[safeIndex(293, v15.Length)]) then v18 else v18]|) := v18], v19;
				var v24: set<int> := {v19[safeIndex(607, v19.Length)]};
				var v25: array<set<int>> := new set<int>[1] [v24];
				var v26: map<array<bool>, char> := map[v15 := v18];
				var v27: seq<map<array<bool>, char>> := [v26, v26];
				var v28 := DC1(v25, v15, v27[safeIndex(|v20|, |v27|)], p0);
				var v29: multiset<array<bool>> := multiset{v28.cf5};
				var v30: seq<bool> := [p0, v15[safeIndex(293, v15.Length)], p0, v15[safeIndex(293, v15.Length)], p0];
				var v31: map<int, int> := map[v16 := v19[safeIndex(607, v19.Length)]];
				var v32: multiset<int> := multiset{v19[safeIndex(607, v19.Length)]};
				var v33: seq<bool> := [v30[safeIndex(v16, |v30|)], v31 == v31, !!(v32 >= multiset{|v20|, v16, v16})];
				v19[safeIndex(607, v19.Length)], v19[safeIndex(607, v19.Length)], r1, v29 := -v16, |v33|, v19[safeIndex(607, v19.Length)] + v19[safeIndex(607, v19.Length)], v29;
				var v34: C0 := new C0();
				var v35 := DC11(v34);
				var v36: map<D4, bool> := map[v35 := p0];
				v15[safeIndex(293, v15.Length)] := if (DC11(v34) in v36) then v36[DC11(v34)] else p0;
			}
			...
			var v41 := 'x';
			v40[safeIndex(979, v40.Length)] := v41;
			v40[safeIndex(979, v40.Length)] := v41;
			globalState.f13 := p0;
			var v42: map<bool, bool> := map[p0 := false];
			var v43 := DC48(v42);
			var v44 := 699;
			globalState.f6 := -safeDivisionInt(|v43.cf83|, v44) * v44;
		...
		var v63: array<int> := new int[10] [|v56|, v57, fm59(v57, p0, v57, "scybqkicp", globalState), |f25|, |v60[safeIndex(v57, |v60|)]|, v57, |v62|, v57, v57, v57];
		var v64 := 'v';
		...
		match (v67) {
			case DC18(cf34) =>
				...
				v68[safeIndex(591, v68.Length)] := f25;
				v63[safeIndex(705, v63.Length)] := v57;
				var v69: seq<string> := [f25];
				globalState.f10, v68[safeIndex(591, v68.Length)], r0, v63[safeIndex(705, v63.Length)] := v57, (f25 + f25) + ("gyp" + f25), f25[safeIndex(-|v69[safeIndex(|(seq(abs(0xb5), i2  => (|f25|)))|, |v69|)]| + v57, |f25|)], v57;
				if (p0) {
					...
					var v74: seq<D14> := [v72];
					var v75: array<set<seq<D14>>> := new set<seq<D14>>[10] [v73, v73, v73, v73 * v73, v73, v73, v73, v73, {v74, [v72, DC39(v71[safeIndex(v63[safeIndex(705, v63.Length)], |v71|) := v70])]} * v73, v73];
					v75[safeIndex(244, v75.Length)] := {v74};
					var v76: set<bool> := {cf34, !cf34, p0};
					var v77 := DC26(v62, v57, p0, v57, p0);
					v75[safeIndex(244, v75.Length)], v76 := v73, fm53(!true, if (true) then v77 else v77, v57, v63[safeIndex(705, v63.Length)] - v63[safeIndex(705, v63.Length)], globalState);
					v58[safeIndex(15, v58.Length)] := cf34;
					v58[safeIndex(15, v58.Length)] := cf34;
					v63[safeIndex(705, v63.Length)] := |v62|;
					var v78: T1 := new C1(f25[safeIndex(v63[safeIndex(705, v63.Length)], |f25|) := v64]);
					var v79 := DC23(v78, -0x33e, v57, v57);
					v79 := v79;
					var v80: seq<int> := [v63[safeIndex(705, v63.Length)]];
					globalState.f20 := v80 + [fm59(fm59(v57, cf34, --v63[safeIndex(705, v63.Length)], seq(abs(0x33d), i3  => (v64)), globalState), true, v63[safeIndex(705, v63.Length)], "xkwvuq", globalState)];
				} else {
					var v81: seq<bool> := [p0];
					var v82: multiset<bool> := multiset{p0, p0, p0, v81[safeIndex(v57, |v81|)], cf34};
					var v83: set<bool> := {cf34, cf34, p0, p0, cf34};
					var v84: map<bool, string> := map[(if (cf34 in v82) then v82[cf34] else v63[safeIndex(705, v63.Length)]) > |v83| := "fwqnmepwa"];
					var v86: array<seq<int>> := new seq<int>[2](i4 => if (p0) then [v63[safeIndex(705, v63.Length)], v57, v57, |[v57, v63[safeIndex(705, v63.Length)], v57, |(map v85 : char | v85 in f25 :: (v85) := (cf34))|, v57]|] else [v63[safeIndex(705, v63.Length)], v57, v57]);
					var v87: set<string> := {"wqoelbdk", f25};
					var v88: seq<int> := [fm58(v87, !cf34, globalState), v63[safeIndex(705, v63.Length)], v57];
					v86[safeIndex(84, v86.Length)] := v88;
					var v89: multiset<C0> := multiset{v55};
					v84, globalState.f10, v64, v86[safeIndex(84, v86.Length)], v63[safeIndex(705, v63.Length)] := fm65(|v62|, 0x27b, globalState), -v63[safeIndex(705, v63.Length)], fm2(0x21d + v63[safeIndex(705, v63.Length)], p0, v89 !! v89, globalState), v88, v57;
					var v90: map<int, bool> := map[v63[safeIndex(705, v63.Length)] := cf34];
					var v91 := DC8(map[|v68[safeIndex(591, v68.Length)]| := cf34]);
					var v92: seq<map<int, bool>> := [v91.cf23];
					var v93: seq<map<int, bool>> := [v90, v90, v92[safeIndex(v63[safeIndex(705, v63.Length)], |v92|)]];
					v93 := (v93 + v92) + (v92 + v93);
			...
			case DC17(cf33) =>
				...
				var v101: multiset<bool> := multiset{!(if (p0) then p0 else p0), v99[safeIndex(v57, |v99|)], |[v57]| in (map v100 : int | v100 in v61 :: (v100 + |map[!p0 := p0]|) := ("ryh")), v64 in f25};
				v101 := v101;
				globalState.f15 := p0;
				if (p0) {
					v99 := v99;
					v58[safeIndex(951, v58.Length)] := p0;
					var v102: seq<multiset<bool>> := [multiset{p0}];
					var v103: seq<multiset<bool>> := [v102[safeIndex(if (p0 in v101) then v101[p0] else |map[0x206 := f25]|, |v102|)]];
					var v104 := DC0(map[p0 := v57], v57, v55.fm11(fm63(p0, v57, v57, p0, globalState), globalState), p0);
					globalState.f10, v58[safeIndex(951, v58.Length)], globalState.f15, r0, v103 := v57, if (p0) then p0 else p0, p0 ==> fm3(p0, globalState), v104.cf2, v103;
					v64 := v64;
					globalState.f6 := v57;
					var v105: map<map<bool, bool>, bool> := map[map[fm3(v58[safeIndex(951, v58.Length)], globalState) := v58[safeIndex(951, v58.Length)]] := p0];
					r2 := safeModuloInt(|v105|, v57 + v57);
				} else {
					var v106: map<bool, bool> := map[p0 := p0];
					var v107: seq<multiset<int>> := [multiset{|v106|}, v62];
					var v108 := DC31(v107 + (seq(abs(479), i6  => (multiset{v57}))));
					v108 := v108;
		...
		var v115 := new C1(f25);
		v58[safeIndex(923, v58.Length)] := !fm1(p0, globalState);
		var v116 := "iyiqnk";
		v58[safeIndex(923, v58.Length)], v116, r0, globalState.f15 := 602 != -v57, f25, f25[safeIndex(0x30d, |f25|)], p0;
		r0 := 'f';
		r1 := safeDivisionInt(v57, v57);
		r2 := safeModuloInt(v57, |v56|);
	}
}
...
class C3 extends T1 {
	...
	function fm48(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState): bool {
		!(({-0x8b} + (set v0 : int | v0 in [0x1b4, --0x3f] :: (v0 * 173))) != {|map[true := map v1 : int | (739 <= v1) && (v1 < 0x183) :: (safeDivisionInt(v1, 0x2ec)) := (|[true, false, false]|)]|, |f25|})
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		globalState.f6 := p0;
		var v0: array<int> := new int[8];
		v0[safeIndex(81, v0.Length)] := p0;
		var v1 := false;
		var v2: map<bool, bool> := map[v1 := v1];
		v0[safeIndex(81, v0.Length)] := |v2|;
		globalState.f6 := v0[safeIndex(81, v0.Length)] * p0;
		var v3: multiset<int> := multiset{-0xb2, |((seq(abs(874), i0  => ('d'))) + f25)|, |f25| - p0};
		v0[safeIndex(81, v0.Length)] := |v3|;
		var i1 := 0;
		while (v1)
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			globalState.f15 := v1;
			globalState.f6 := -v0[safeIndex(81, v0.Length)];
			globalState.f10 := v0[safeIndex(81, v0.Length)] + 468;
			var v4 := "s";
			var v5: array<D14> := new D14[25](i3 => DC41(v3));
			globalState.f6, globalState.f15, v4, globalState.f10 := p0, v1, "f" + (seq(abs(0x3bf), i2  => ('p'))), safeDivisionInt(p0, |[v5, v5, v5]|);
		}
		globalState.f13 := v1;
		var v6 := 'm';
		var v7 := DC0(map[v1 := v0[safeIndex(81, v0.Length)]], p0, v6, !v1);
		var v8: map<bool, int> := map[v1 := v0[safeIndex(81, v0.Length)]];
		var v9: seq<bool> := [v1];
		var v10: array<D0> := new D0[16] [v7, v7, v7, DC0(v8, v0[safeIndex(81, v0.Length)], v6, v1), v7, v7, v7, v7, v7, v7, v7, v7, v7.(cf1 := v0[safeIndex(81, v0.Length)], cf0 := v8, cf3 := v9[safeIndex(p0, |v9|)]), v7, v7, v7];
		...
		r1 := match v13 {
			...
			case DC33(cf63) => v1
			case DC31(cf57) => v0[safeIndex(81, v0.Length)] in map[|f25| := multiset{v1, v1, v1}]
		};
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		var v3: array<set<int>> := new set<int>[8] [v0, v0, v0, v0, v0, set v2 : int | v2 in (map v1 : int | v1 in v0 :: (v1 - p0) := (false)) :: (safeDivisionInt(v2, -|{true}|)), v0, {|"oa"|}];
		var v4: array<bool> := new bool[9](i1 => true);
		var v5 := 'f';
		var v6: map<array<bool>, char> := map[v4 := v5];
		var v7 := false;
		var v8 := DC1(v3, v4, v6, v7);
		r3, r3 := |(seq(abs(489), i0  => ('s')))|, fm49((v8.(cf6 := v6)).cf7, p0, globalState);
			...
			decreases 100 - i2
		{
			...
			globalState.f20 := if (|f25| in v13) then v13[|f25|] else seq(abs(0x189), i3  => (p0));
			var v14: C0 := new C0();
			var v15: set<C0> := {v14};
			...
			var v28: array<int> := new int[15] [p0, |map[false := |f25|]| - 0xcc, p0, p0, |fm50(p0, v7, p0, p0, globalState)| * |(if (|f25| in v16) then v16[|f25|] else v15)|, |v17|, 459, -(|[v4]| - 0x2ac), |[fm3(v19.cf17, globalState), fm3(v7, globalState), v7]|, |v20|, p0, safeModuloInt(-p0, |v21.cf47|), 833, |v23|, p0 - (if (v24 in v27) then v27[v24] else 0x3c6)];
			var v29: multiset<char> := multiset{v5, v5};
			v28[safeIndex(835, v28.Length)] := |v29|;
			v28[safeIndex(835, v28.Length)] := p0;
			v19 := fm51(globalState).(cf16 := p0, cf15 := v7);
			var v30 := new C0();
		}
		v4[safeIndex(863, v4.Length)] := v7;
		...
		v4[safeIndex(863, v4.Length)] := (if (v7) then v33 else v33).cf52;
		var v34 := "tvpk";
		v34 := match DC37(v7) {
			case DC36(cf66) => "sldbydeyv" + f25[safeIndex(cf66, |f25|) := v34[safeIndex(cf66, |v34|)]]
			case DC37(cf67) => f25
			case DC35(cf65) => v34
			case DC38(cf68) => v34
		};
		r0 := fm49(v4[safeIndex(863, v4.Length)], p0, globalState);
		var v35: seq<int> := [p0];
		var v36: seq<seq<int>> := [v35];
		var v37: array<seq<int>> := new seq<int>[27] [v35 + v35, v35, v35, v35, v35, v35 + v35, [p0], v35, v35[safeIndex(p0, |v35|) := p0], v36[safeIndex(p0, |v36|)], v35, v35 + v35, v35, [p0, p0], v35, v35, v35, v35, v35, v35, (seq(abs(0x103), i4  => (p0)))[safeIndex(p0, |(seq(abs(0x103), i4  => (p0)))|) := p0] + v35, seq(abs(235), i5  => (p0)), v35 + (seq(abs(-0x3a4), i6  => (p0))), seq(abs(0x297), i7  => (p0)), v35, (seq(abs(0xfe), i8  => (v35[safeIndex(p0, |v35|)])))[safeIndex(p0, |(seq(abs(0xfe), i8  => (v35[safeIndex(p0, |v35|)])))|) := |v35|], seq(abs(0xb9), i9  => (p0))];
		r1 := v37;
		r2 := !(!!v4[safeIndex(863, v4.Length)] && v4[safeIndex(863, v4.Length)]);
		r3 := p0 + p0;
	}
	method m16(p0: seq<array<bool>>, p1: int, p2: map<multiset<char>, bool>, globalState: GlobalState) {
		...
		if ((if (v0 in v1) then v1[v0] else v0) <== v0) {
			...
			var v11: array<int> := new int[17] [p1, -|v3|, p1, |f25|, p1, p1, p1, |fm52(v0, v0, v4, globalState)|, v8.cf8, safeDivisionInt(0x386, p1), v9.cf70, p1, 0x78, -p1 + |v10|, if (v0) then -157 else p1, p1, p1];
			v11[safeIndex(710, v11.Length)] := p1;
			v11[safeIndex(710, v11.Length)] := p1;
			var v12 := new C0();
		} else {
			...
			v20[safeIndex(358, v20.Length)] := fm48(|map[v21.cf70 := p1]|, v0, p1, p1, globalState);
			v20[safeIndex(358, v20.Length)] := v0;
		}
		...
		var v32: seq<bool> := [v0];
		var v33: seq<int> := [|f25[safeIndex(|v32|, |f25|) := 'p']|];
		var v34: array<int> := new int[29] [p1, p1, p1, p1, |v25|, 0x33c, 0x2fc, p1, p1, |v27|, p1, |v28|, |v31|, |("iujkicv")[safeIndex(p1, |"iujkicv"|) := v22]|, |v24|, |v24|, |map[p1 := p1]|, 0x155, p1, p1, |v33|, p1, -p1, -0x239, p1, p1, p1, 47, p1];
		f34[safeIndex(261, f34.Length)] := v34;
		var v35 := DC24(v34, !v0);
		f34[safeIndex(261, f34.Length)] := v35.cf44;
		globalState.f6 := p1;
		...
		f34[safeIndex(261, f34.Length)][safeIndex(336, f34[safeIndex(261, f34.Length)].Length)] := -|v24| - p1;
		var v38: map<bool, seq<bool>> := map[v0 := [v0]];
		v0, f34[safeIndex(261, f34.Length)][safeIndex(336, f34[safeIndex(261, f34.Length)].Length)] := !match v26.(cf67 := v0) {
			case DC36(cf66) => false
			case DC37(cf67) => cf67
			case DC35(cf65) => v0
			case DC38(cf68) => |"rmhias"| != p1
		}, fm49(v0, v33[safeIndex(|v38|, |v33|)], globalState);
	}
}
...
class C4 extends T2 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i1
		{
			...
			v1[safeIndex(851, v1.Length)] := |v5|;
			v1[safeIndex(851, v1.Length)] := safeDivisionInt(0x273, f27);
			var v6: map<int, bool> := map[f27 := f26];
			var v7: set<int> := {v1[safeIndex(851, v1.Length)], f27, f33, |"ssn"|, |(seq(abs(0x1b1), i2  => ('m')))|};
			var v8: array<bool> := new bool[14](i3 => f26);
			var v9: map<array<bool>, int> := map[v8 := -f27];
			var v10: multiset<string> := multiset{f25, f25, f25, f25};
			var v11: set<bool> := {p0};
			var v12: array<bool> := new bool[29] [f26 ==> p0, v1[safeIndex(851, v1.Length)] <= f33, f26, f26, !(if (v1[safeIndex(851, v1.Length)] in v6) then v6[v1[safeIndex(851, v1.Length)]] else false), f26, {f27, v1[safeIndex(851, v1.Length)]} >= v7, f26, if (p0) then !f26 else p0, v8 !in v9, fm3(p0, globalState), p0, false, p0, f26, fm1(!p0, globalState), p0, true, f26, !(v4 != v4), false, multiset{f25, f25} >= v10, p0, p0 in v11, false, !fm1(f26, globalState), fm4(globalState), fm4(globalState), p0];
			v8[safeIndex(920, v8.Length)] := p0;
			v8[safeIndex(920, v8.Length)] := p0;
			globalState.f15 := v8[safeIndex(920, v8.Length)];
			var v13: array<map<bool, int>> := new map<bool, int>[6];
			v13 := if (p0) then if (p0) then v13 else v13 else v13;
		}
		var v14: set<int> := {safeModuloInt(f33, f27)};
	...
	method m4(p0: int, p1: map<bool, int>, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool) {
		...
		match (v1) {
			case DC20(cf36, cf37) =>
				...
				var v12: set<int> := {|v11|};
				var v13: set<int> := {safeDivisionInt(-0x2b9, |v12|)};
				...
				v19[safeIndex(667, v19.Length)] := cf36;
				v19[safeIndex(667, v19.Length)] := if (p2) then f33 > 0x3a1 else v5[safeIndex(|(fm55(f27, true, p2, globalState))[safeIndex(0x232, |fm55(f27, true, p2, globalState)|) := f26]|, |v5|)];
			case DC19(cf35) =>
				var v20: seq<bool> := [p2];
				var v21: multiset<bool> := multiset{f26, p2, p2, true, f26};
				var v22: seq<multiset<bool>> := [v21];
				var v23: set<multiset<bool>> := {multiset(v20), multiset{!f26, p2}, v22[safeIndex(f33, |v22|)], v21, multiset{f26, f26}};
				var v24: seq<int> := [0x26c];
				var v25: seq<int> := [-|v24|];
				globalState.f15, globalState.f6, f33 := (v23 * v23) >= fm66(f27, f33, f26, |v24|, globalState), f27, |(f25 + f25[safeIndex(-p0, |f25|) := v0])|;
				globalState.f15 := f26;
				var v26: array<multiset<int>> := new multiset<int>[23];
				var v27: array<bool> := new bool[4] [v24 < (seq(abs(0x37b), i0  => (0x15c))), p2, p2, f26];
				v27[safeIndex(775, v27.Length)] := fm3(v20[safeIndex(f33, |v20|)], globalState);
				v26, globalState.f6, v27[safeIndex(775, v27.Length)], r1, f33 := v26, -f27, p2, p2, ---f33;
			...
			case DC21(cf38) =>
				...
				var v36: array<map<int, int>> := new map<int, int>[6] [v31[safeIndex(fm49(p2, |(seq(abs(0x26f), i1  => (f27)))|, globalState), |v31|)], map[f27 := f33], map[v33[safeIndex(f27, |v33|)] := -0x196], map v34 : int | (0x140 <= v34) && (v34 < 0x6d) :: (v34 * f33) := (p0), if (p0 in v35) then v35[p0] else v30, v30];
				v36 := new map<int, int>[28];
				var v37: array<int> := new int[11](i2 => i2 + f33);
				var v38: array<array<int>> := new array<int>[4] [v37, v37, v37, v37];
				var v39 := new C3(v38, seq(abs(619), i3  => (v0)));
				var v40: array<seq<bool>> := new seq<bool>[11];
				v40[safeIndex(793, v40.Length)] := (fm55(p0, f26, p2, globalState))[safeIndex(|"c"|, |fm55(p0, f26, p2, globalState)|) := f26];
				var v41: seq<bool> := [p2, p0 > p0, f26];
				v40[safeIndex(793, v40.Length)] := v41;
		}
		
		var v42: array<array<int>> := new array<int>[9];
		var v43: array<int> := new int[19];
		v42[safeIndex(767, v42.Length)] := v43;
		v42[safeIndex(767, v42.Length)] := v43;
		var v44 := "kshc";
		var v45: array<bool> := new bool[16];
		v45[safeIndex(114, v45.Length)] := f26;
		var v46: map<int, int> := map[f27 := -826];
		var v47: map<int, int> := map[f27 := |v46|];
		globalState.f6, r1, v44, v45[safeIndex(114, v45.Length)] := f27 - p0, match DC14(v46) {
			case DC15(cf31) => p2
			case DC14(cf30) => |multiset{seq(abs(523), i4  => (|multiset([f26])|))}| !in [f27, |v44|, p0, f33, f33]
			case DC16(cf32) => p2
		}, v44, p2;
		var v48 := DC29(DC27(v45[safeIndex(114, v45.Length)]));
		match (v48) {
			case DC26(cf47, cf48, cf49, cf50, cf51) =>
				...
				match (v49) {
					case DC36(cf66) =>
						...
						var v54: array<seq<D0>> := new seq<D0>[29](i5 => [DC0(map[cf51 := |v44|], |[cf49, f26, cf49]|, DC0(p1, f33, v0, v45[safeIndex(114, v45.Length)]).cf2, cf49), DC0(p1, cf48, v0, cf51)]);
						var v55 := DC0(p1, 0x15d, v0, !p2);
						var v56: seq<D0> := [v55];
						v54[safeIndex(920, v54.Length)] := v56;
						v52, v42[safeIndex(767, v42.Length)], v53, v54[safeIndex(920, v54.Length)], globalState.f15 := (v52 + v52) + v52, v42[safeIndex(767, v42.Length)], fm67(false, fm4(globalState), globalState), v56 + (v56 + v56), fm1(v45[safeIndex(114, v45.Length)], globalState);
						var v57: array<char> := new char[23] ['q', fm2(p0, v45[safeIndex(114, v45.Length)], p2, globalState), v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, fm2(cf66, f26, p2, globalState), v44[safeIndex(cf66, |v44|)], 'k', v0, v0, v0, v0, v0, 'v', v0];
						v57[safeIndex(353, v57.Length)] := v0;
						cf50, v57[safeIndex(353, v57.Length)] := safeDivisionInt(fm49(f26, p0, globalState), f33), v0;
						var v58: map<bool, bool> := map[v45[safeIndex(114, v45.Length)] := p2];
						cf66 := -|v58|;
						var v59: map<char, int> := map[v57[safeIndex(353, v57.Length)] := f33];
						var v60: array<map<char, int>> := new map<char, int>[5] [v59 + v59, v59, v59, v59, v59];
						v60[safeIndex(363, v60.Length)] := map[v57[safeIndex(353, v57.Length)] := |v44|];
						v60[safeIndex(363, v60.Length)] := v59;
					case DC37(cf67) =>
						...
						v66 := v66[f27 + p0 := v67];
						var v68 := new C2(fm47(v45[safeIndex(114, v45.Length)], f33, f26, cf48, globalState));
						globalState.f6 := p0;
					case DC35(cf65) =>
						...
						v43[safeIndex(38, v43.Length)] := -cf50;
						v73, globalState.f13, globalState.f13, v43[safeIndex(38, v43.Length)] := fm69(globalState), true, !!cf51, f27;
						globalState.f10 := |v44|;
						globalState.f15 := !!!p2;
					case DC38(cf68) =>
						var v74 := m0(globalState);
						var v75: seq<array<int>> := [v42[safeIndex(767, v42.Length)], v42[safeIndex(767, v42.Length)]];
						globalState.f10 := -|([v42[safeIndex(767, v42.Length)], v42[safeIndex(767, v42.Length)], v43, v43, v43] + v75)|;
						globalState.f6 := safeDivisionInt(0x20e, cf48 - v74);
				...
				var v82: array<seq<int>> := new seq<int>[21] [v80, v80, seq(abs(684), i6  => (|[f26]|)), v80, v80, v80, v80, v80, v80, fm52(cf49, cf49, v0, globalState), [f33, p0], v80, [cf50, |f25|], [cf48, -0x1b9], [p0, |{f33, 0x30e}|], [f33], v80, [f27], v80, [cf48, cf50, cf50, |v81|, |(seq(abs(-0x355), i7  => (v0)))|], v80];
				var v83 := DC25(v82);
				var v84: multiset<D9> := multiset{DC25(v82), v83, v83};
				var v85: seq<multiset<D9>> := [v84];
				v78[safeIndex(91, v78.Length)] := v85 + v85;
				var v86: seq<seq<multiset<D9>>> := [v85, [v84, multiset{v83, v83}, v84]];
				v78[safeIndex(91, v78.Length)] := v86[safeIndex(p0, |v86|)];
				var v87: map<bool, bool> := map[cf49 := cf51];
				globalState.f10 := safeModuloInt(safeDivisionInt(p0, f33), if (fm1(p2, globalState)) then 0x3f else |v87|);
				var v88: array<char> := new char[11];
				v88[safeIndex(329, v88.Length)] := v0;
				v88[safeIndex(329, v88.Length)] := fm2(-5, f33 != (if (p0 in cf47) then cf47[p0] else cf50), p2, globalState);
			case DC27(cf52) =>
				v44 := f25;
				var v89 := new C1(f25);
				var v90: set<int> := {f27};
				var v91: map<set<int>, int> := map[v90 * v90 := safeModuloInt(f33, f33)];
				v91 := map[v90 := f27];
				v44 := (v44[safeIndex(|[v45[safeIndex(114, v45.Length)]]|, |v44|) := v0])[safeIndex(f33, |v44[safeIndex(|[v45[safeIndex(114, v45.Length)]]|, |v44|) := v0]|) := 'j'] + ("uqwsi" + f25);
			case DC28(cf53, cf54) =>
				globalState.f13 := p2;
				globalState.f6 := -f33;
				var v92 := new C3(v42, v44);
				v45[safeIndex(114, v45.Length)] := p2;
			case DC25(cf46) =>
				var v93 := new C2(fm63(p2, p0, f33, f26, globalState) + (seq(abs(0x344), i8  => ('b'))));
				var v94: map<int, bool> := map[804 := f26];
				v45[safeIndex(114, v45.Length)] := fm1(f26, globalState) || (if (|(set v95 : int | (0xbf <= v95) && (v95 < 0x11d) :: (v95 - |[|f25|, f27]|))| in v94) then v94[|(set v95 : int | (0xbf <= v95) && (v95 < 0x11d) :: (v95 - |[|f25|, f27]|))|] else !v45[safeIndex(114, v45.Length)]);
				v0 := v0;
				var v96: map<char, bool> := map[v0 := v45[safeIndex(114, v45.Length)]];
				var v97: map<string, map<char, bool>> := map[f25 := v96 + v96];
				v97 := v97["boke" := map[v0 := p2]];
			case DC29(cf55) =>
				var v98: array<set<array<int>>> := new set<array<int>>[18];
				var v99: seq<array<int>> := [v42[safeIndex(767, v42.Length)]];
				var v100: set<array<int>> := {v42[safeIndex(767, v42.Length)], v42[safeIndex(767, v42.Length)], v99[safeIndex(p0, |v99|)], v43, v43};
				v98[safeIndex(143, v98.Length)] := if (p2) then v100 else {v43, v42[safeIndex(767, v42.Length)]};
				v98[safeIndex(143, v98.Length)] := v100;
				var v101: set<string> := {f25};
				globalState.f6 := fm58(v101, false, globalState);
				v45[safeIndex(114, v45.Length)] := false;
				globalState.f6 := f27;
		}
			...
			decreases 100 - i9
		{
			...
			var v106: array<seq<set<int>>> := new seq<set<int>>[21] [v103[safeIndex(p0, |v103|) := v102], v103, v103, v103, [v103[safeIndex(|v105|, |v103|)], v102, v102], v103, v103, seq(abs(0x292), i10  => (v102)), v103, v103, v103, v103, v103, v103, fm70(v45[safeIndex(114, v45.Length)], globalState), [{f27}, v102, v102], v103, v103, v103, v103, v103];
			v106[safeIndex(285, v106.Length)] := v103;
			v106[safeIndex(285, v106.Length)] := v103;
			var v107: map<char, int> := map[v0 := f27];
			v45[safeIndex(114, v45.Length)], globalState.f6, globalState.f10, globalState.f13, v44 := !!(p0 > p0), f27, (if (v0 in v107) then v107[v0] else f27) - f33, v45[safeIndex(114, v45.Length)], f25;
			globalState.f10 := -f33 - f27;
			v42[safeIndex(767, v42.Length)] := v42[safeIndex(767, v42.Length)];
		}
		r0 := fm52(!v45[safeIndex(114, v45.Length)], f26, v0, globalState);
		var v108: set<int> := {-f33};
		var v109: seq<bool> := [v108 >= v108];
		r1 := v109[safeIndex(991, |v109|)];
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		var v0: array<int> := new int[14];
		v0[safeIndex(840, v0.Length)] := -0x389;
		v0[safeIndex(840, v0.Length)] := f27;
		var v1: set<string> := {f25, f25, "nd", "a", f25};
		v0[safeIndex(840, v0.Length)] := fm58(v1, !f26, globalState);
		for i0 := p0 to v0[safeIndex(840, v0.Length)] - |"ik"| {
			...
			if (!(if (f26) then f26 else if (f26) then f26 else f26)) {
				...
				globalState.f6 := |map[f26 := v6]| + v0[safeIndex(840, v0.Length)];
				var v7 := 'i';
				v7, globalState.f10, globalState.f15 := v7, f27, f26;
				var v8: map<int, bool> := map[p0 := f26];
				v0[safeIndex(840, v0.Length)] := |((map[|v6| := true] + map[p0 := f26]) + v8)|;
				var v9: map<int, int> := map[-f27 := v0[safeIndex(840, v0.Length)]];
				...
				var v13 := DC49(v12[safeIndex(|fm60(f26, globalState)|, |v12|)]);
				...
				v14[safeIndex(710, v14.Length)] := v11;
				v14[safeIndex(710, v14.Length)] := v11;
		...
		var v16: map<bool, seq<int>> := map[!(if (f26) then f26 else f26) := fm52(f26, true, f25[safeIndex(fm59(f33, f26, p0, f25, globalState), |f25|)], globalState)];
		var v17: multiset<bool> := multiset{f26, f26, false};
		var v18: seq<int> := [f33];
		var v19 := DC50(0x2f, f25, v17, v18, f26);
		v16 := v16[f26 := v19.cf88];
		var v20: map<int, bool> := map[v0[safeIndex(840, v0.Length)] := f26];
		...
		v24[safeIndex(90, v24.Length)] := DC48(v22);
		r2, v24[safeIndex(90, v24.Length)] := f26 && f26, DC48(map[f26 := f26]);
		var v25: array<D0> := new D0[23];
		var v26: seq<array<D0>> := [v25];
		var v27: seq<seq<array<D0>>> := [v26];
		r0 := v27[safeIndex(f33, |v27|)];
		var v28: seq<bool> := [f26, f26, if (!f26) then fm1(f26, globalState) else f26, if (f26 in v22) then v22[f26] else f26, f26];
		r1 := v28[safeIndex(safeDivisionInt(|f25|, |v22|), |v28|)];
		var v29: set<bool> := {f26};
		r2 := (fm71(v29, globalState)).cf81;
		r3 := match DC14(map[v0[safeIndex(840, v0.Length)] := |f25|]) {
			case DC15(cf31) => v17
			case DC14(cf30) => v17[f26 := abs(|v20|)]
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		v0[safeIndex(147, v0.Length)] := v2.cf81;
		v0[safeIndex(147, v0.Length)] := f26;
		var v3 := DC40(p0);
		var v4: seq<bool> := [v0[safeIndex(147, v0.Length)], f26];
		var v5: map<bool, int> := map[v0[safeIndex(147, v0.Length)] := |v4|];
		var v6: array<D14> := new D14[5] [v3, DC40(if (v0[safeIndex(147, v0.Length)] in v5) then v5[v0[safeIndex(147, v0.Length)]] else f27), v3, v3, v3.(cf70 := |[0x3b6]|)];
		v6[safeIndex(217, v6.Length)] := DC40(p0);
		v6[safeIndex(217, v6.Length)] := if (!(true ==> v0[safeIndex(147, v0.Length)])) then DC40(0x266) else DC40(f33);
		var v7: array<int> := new int[5](i1 => i1 + f27);
		var v8: map<int, array<int>> := map[|(seq(abs(366), i2  => (p0)))| := v7];
		var v9: array<array<int>> := new array<int>[16] [v7, v7, v7, v7, v7, v7, v7, v7, v7, v7, v7, v7, if (f33 in v8) then v8[f33] else v7, v7, v7, v7];
		var v10 := 'd';
		var v11 := new C3(v9, f25[safeIndex(f27, |f25|) := v10]);
		globalState.f6 := |v4[safeIndex(p0, |v4|) := map[f26 := p0] == v5]|;
		v0[safeIndex(147, v0.Length)] := fm3(f26, globalState);
		for i3 := -f33 to f27 {
			globalState.f13 := f26;
			globalState.f13 := true;
			r2 := v0[safeIndex(147, v0.Length)];
			globalState.f6 := f27;
		}
		r0 := -p0;
		var v12: seq<int> := [p0];
		var v13: array<seq<int>> := new seq<int>[8] [v12, [|f25|], v12, v12, (seq(abs(73), i4  => (f33))) + v12, [557, p0, f33, f27], [p0] + [f27, p0, f27, 0x18f, p0], v12];
		r1 := v13;
		r2 := if (f26) then v0[safeIndex(147, v0.Length)] else !(f33 < p0);
		r3 := |(seq(abs(0x1ee), i5  => ('i')))[safeIndex(f27, |(seq(abs(0x1ee), i5  => ('i')))|) := v10]|;
	}
	method m14(p0: string, p1: string, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (f26) {
			...
			var v3 := new C3(v2, p0);
			if (!((f33 <= |p1|) || f26)) {
				var v4: array<int> := new int[12](i1 => safeDivisionInt(i1, DC46(f33, f27, f33, f26).cf80));
				v4[safeIndex(488, v4.Length)] := 0x38;
				v4[safeIndex(488, v4.Length)] := f33;
				globalState.f13 := !!f26;
				var v5: map<bool, int> := map[f26 := f33];
				var v6 := DC0(v5, f27, 's', true);
				var v7: map<int, bool> := map[f27 := v6.cf3];
				v7 := v7[f33 - fm59(f27, f26, v4[safeIndex(488, v4.Length)], p1, globalState) := f26];
				...
				var v13: T1 := new C1(seq(abs(-0x1cc), i2  => ('w')));
				...
				globalState.f6 := if (|v16| in v12) then v12[|v16|] else safeModuloInt(|v17|, f27);
				...
				v20[safeIndex(126, v20.Length)] := f26;
				...
				v20[safeIndex(126, v20.Length)], v21, v22 := safeDivisionInt(fm49(f26, f33, globalState), fm59(fm58(v23, f26, globalState), f26, -0x6, "edehubpw", globalState)) in multiset{f27}, (v21 + DC51(v21).cf90)[safeIndex(f27, |(v21 + DC51(v21).cf90)|) := v13.f25] + v21, v22;
			}
			...
			v30[safeIndex(406, v30.Length)] := p1;
			var v31: array<char> := new char[10] [v28, 'n', v28, v28, v28, v28, v28, v28, v28, v28];
			v31[safeIndex(464, v31.Length)] := v28;
			var v32: multiset<bool> := multiset{f26};
			var v33: multiset<multiset<bool>> := multiset{v32};
			globalState.f13, v30[safeIndex(406, v30.Length)], r1, globalState.f10, v31[safeIndex(464, v31.Length)] := v33 < v33, f25, f26, f27, v28;
			var v34: array<bool> := new bool[21];
			v34[safeIndex(772, v34.Length)] := f26;
			var v35 := DC20(f26, v28);
			var v36: array<D7> := new D7[12] [fm72(f26, globalState).(cf36 := f26), v35, v35, if (f26) then DC20(f26, v31[safeIndex(464, v31.Length)]).(cf36 := f26) else v35, v35, if (!f26) then v35 else v35, fm72(f26, globalState), v35, if (f26) then v35 else v35, DC20(f26, v31[safeIndex(464, v31.Length)]), v35, v35];
			v34[safeIndex(772, v34.Length)], v36 := f26, v36;
		}
			...
			decreases 100 - i5
		{
			...
			if ((if (f26) then v43 else 'o') in f25) {
				...
				v46 := v46[seq(abs(-432), i6  => (v43)) := v45];
				...
				globalState.f10 := safeModuloInt(f33, f33) + f27;
				...
				var v53: array<bool> := new bool[21] [f26, f26, f26, f26, f26, !false, f26, fm1(f26, globalState), v52[safeIndex(0x23a, |v52|)], f26, !f26, f26, f26, true, f26, f26, f26, false, f26, f26, f26];
			...
			var v62: array<array<int>> := new array<int>[27] [v59, v59, v59, v59, DC24(v59, f26).cf44, v59, v59, v59, v59, v59, v59, v59, v59, v59, if (v43 in v60) then v60[v43] else v59, v59, v59, v61[safeIndex(f27, |v61|)], v59, v59, v59, v59, v59, v59, v59, v59, v59];
			var v63 := new C3(v62, p0);
			var v64: array<bool> := new bool[17];
			var v65: seq<array<bool>> := [v64, v64];
			var v66: seq<array<bool>> := [v65[safeIndex(f33, |v65|)]];
		...
		forall i7 | 0 <= i7 < v69.Length {
			v69[i7] := safeModuloInt(i7, f33 + f33);
		}
	...
	method m15(p0: char, globalState: GlobalState) returns (r0: D11) {
		...
		if ((f33 in v0) || f26) {
			...
			v1[safeIndex(759, v1.Length)] := false;
			v1[safeIndex(759, v1.Length)] := f26;
			var v2 := DC7(f33, f33, f27, v1[safeIndex(759, v1.Length)], f25);
			...
			var v6: multiset<bool> := multiset{v1[safeIndex(759, v1.Length)], !f26};
			v6 := v6;
			globalState.f10 := fm59(f27, v1[safeIndex(759, v1.Length)] ==> v1[safeIndex(759, v1.Length)], -758, f25, globalState);
			var v7: seq<bool> := [v1[safeIndex(759, v1.Length)]];
			var v8: map<char, int> := map[p0 := -948];
			var v10: map<char, char> := map[p0 := p0];
			var v11: map<bool, bool> := map[f26 := !v1[safeIndex(759, v1.Length)]];
			...
			var v15: map<int, string> := map[|[f25, f25]| := seq(abs(0x352), i1  => (p0))];
			...
			v17 := v17 + (v19.cf86 + f25[safeIndex(if (f27 in v22) then v22[f27] else f33, |f25|) := p0]);
			var v23 := 't';
			...
			if (f26) {
				...
				v24[safeIndex(18, v24.Length)] := -f33;
				v24[safeIndex(18, v24.Length)] := 0x1d6 * -f27;
				v24[safeIndex(18, v24.Length)] := v24[safeIndex(18, v24.Length)];
				globalState.f6 := 0xc4;
				...
				v25[safeIndex(293, v25.Length)] := v28;
				v25[safeIndex(293, v25.Length)] := v28 + v28[f26 := f33];
				v24[safeIndex(18, v24.Length)] := f27;
			} else {
				globalState.f13 := f26;
				var v29: array<seq<int>> := new seq<int>[18](i2 => v0);
				v29[safeIndex(112, v29.Length)] := v0;
				var v30: array<bool> := new bool[14];
				v30[safeIndex(430, v30.Length)] := f26;
				var v31: set<multiset<bool>> := {v18, v18, v18, v18, v18};
				v29[safeIndex(112, v29.Length)], v23, globalState.f15, globalState.f10, v30[safeIndex(430, v30.Length)] := seq(abs(0x1bc), i3  => (f27)), if (f26) then p0 else v23, f26, |({v18} * v31)|, if (f26 <== f26) then f26 else false;
				v23 := p0;
				globalState.f13 := f26;
				var v32: map<bool, int> := map[false := f27];
				globalState.f10 := safeModuloInt(f33 * f33, f33 + |v32|);
			}
			
			var v33: array<int> := new int[8];
			v33[safeIndex(735, v33.Length)] := f33;
			v33[safeIndex(735, v33.Length)] := -(f33 + v0[safeIndex(f33, |v0|)]);
		}
		...
		match (v35) {
			case DC12() =>
				...
				v36[safeIndex(864, v36.Length)] := ("bwpnbooh")[safeIndex(f27, |"bwpnbooh"|) := p0] < f25;
				v36[safeIndex(864, v36.Length)] := f26;
				if (f26) {
					var v37: array<map<int, bool>> := new map<int, bool>[19];
					v37 := v37;
					globalState.f13 := !(f26 ==> f26);
					var v38: map<bool, bool> := map[!v36[safeIndex(864, v36.Length)] := v36[safeIndex(864, v36.Length)]];
					var v39 := DC46(-0x326, f33, 0x3cd, v36[safeIndex(864, v36.Length)]);
					var v40: set<int> := {-f33};
					...
					v41[safeIndex(47, v41.Length)] := 0x11;
					var v42: set<string> := {"yetwbkagx", if (!f26) then "gnf" else f25, f25 + f25};
					v41[safeIndex(47, v41.Length)] := |v42|;
					globalState.f10 := safeModuloInt(f27, v41[safeIndex(47, v41.Length)]);
					var v43: map<int, seq<int>> := map[safeDivisionInt(175, f33) := v0];
					v43 := v43;
				} else {
					var v44: seq<bool> := [f26];
					var v45: multiset<bool> := multiset{v36[safeIndex(864, v36.Length)]};
					v36[safeIndex(864, v36.Length)] := (v44[safeIndex(|v45|, |v44|)] <==> v36[safeIndex(864, v36.Length)]) <==> v36[safeIndex(864, v36.Length)];
					globalState.f15 := f26;
					var v46: seq<multiset<bool>> := [v45, multiset{v36[safeIndex(864, v36.Length)]}];
					var v47: map<bool, bool> := map[true := v36[safeIndex(864, v36.Length)]];
					globalState.f15, globalState.f6 := v46 < fm73(v36[safeIndex(864, v36.Length)], v36[safeIndex(864, v36.Length)], f26, globalState), if (!fm3(v36[safeIndex(864, v36.Length)], globalState)) then if (if (!v36[safeIndex(864, v36.Length)] in v47) then v47[!v36[safeIndex(864, v36.Length)]] else f26) then f27 else f27 else f33;
					v36[safeIndex(864, v36.Length)] := false;
				...
				var v53 := new C3(v52, ("ymqoapjdh")[safeIndex(f33, |"ymqoapjdh"|) := 'v']);
			...
			case DC13(cf29) =>
				...
				v56[safeIndex(950, v56.Length)] := v58;
				v56[safeIndex(950, v56.Length)] := fm74(globalState);
				...
				if (cf29) {
					...
					v63 := v63[v64 := |v66|];
					v59[safeIndex(331, v59.Length)] := f33;
					v59[safeIndex(657, v59.Length)] := f33;
					v59[safeIndex(331, v59.Length)], v59[safeIndex(657, v59.Length)] := f33, f27;
					globalState.f15 := !f26;
				} else {
					var v67: array<bool> := new bool[9];
					v67[safeIndex(282, v67.Length)] := cf29 ==> cf29;
					var v68: map<string, bool> := map[if (!f26) then "d" else f25 := !f26];
					v67[safeIndex(282, v67.Length)], v68, globalState.f15, v55, v57 := cf29, v68, f26, (map v69 : int | (108 <= v69) && (v69 < -0x1fd) :: (v69 + |map[cf29 := cf29]|) := (DC36(f33).cf66)) + ((map[f33 := f27])[f33 := f27] + v55), v57 + v57;
					f33 := 945;
					var v70: seq<array<bool>> := [v67];
					v67[safeIndex(282, v67.Length)] := |v70| >= (f27 * 0xed);
			...
			case DC11(cf28) =>
				...
				var v71: array<seq<int>> := new seq<int>[6] [fm52(f26, f26, p0, globalState), [f27, f33, f33, f27, f27], v0, v0, v0, [f27, f33] + (seq(abs(0x214), i6  => (v0[safeIndex(f33, |v0|)])))];
				v71[safeIndex(502, v71.Length)] := v0;
				v71[safeIndex(502, v71.Length)] := v0;
				...
				match (v76.(cf38 := v75)) {
					case DC20(cf36, cf37) =>
						...
						v78[safeIndex(573, v78.Length)] := cf37;
						var v79: map<bool, bool> := map[f26 := cf36];
						var v80: seq<map<bool, bool>> := [v79];
						var v81 := DC48(v80[safeIndex(f27, |v80|)]);
						...
						v78[safeIndex(573, v78.Length)], v81, globalState.f15, f33, v83 := p0, (if (cf36) then v81 else v81).(cf83 := v79), -f27 == f33, v0[safeIndex(|(v84 * v84)|, |v0|)], v85.cf93 + v83;
						globalState.f10 := -|{!v73.fm3(f26, globalState), if (f26) then cf36 else f26, f26, v79 == v79}|;
						var v86 := DC20(f26, p0);
						var v87: array<bool> := new bool[25] [f26, v86.cf36, if (f26) then f26 else f26, cf36, f26, true, f26, if (cf36) then cf36 else f26, !!cf36, f26, cf36, cf36, f26, f26, cf36, -0x34e < -v71[safeIndex(502, v71.Length)][safeIndex(f33, |v71[safeIndex(502, v71.Length)]|)], f26, cf36, f26, cf36, !(multiset{|(seq(abs(215), i8  => (f27)))|, f27} != multiset{0x388, f33}), cf36, f26, cf36, v84 !! multiset{f33, f33}];
						v87 := v87;
					case DC19(cf35) =>
						globalState.f10 := f33;
					...
					case DC21(cf38) =>
						...
						v92[safeIndex(913, v92.Length)] := f25 + f25;
						var v93 := "qnbivmq";
						var v94: array<array<bool>> := new array<bool>[28];
						var v95: multiset<string> := multiset{v93[safeIndex(f33, |v93|) := p0]};
						...
						v92[safeIndex(913, v92.Length)], globalState.f6, v93, v94 := v73.f25, --(if (f25 in v95) then v95[f25] else f27), if (v102.cf7) then v73.f25 else f25 + v73.f25, if (f33 < (if (f33 in v97) then v97[f33] else f27)) then v94 else v94;
						var v103: set<char> := {'q'};
						globalState.f13 := {'i', p0, p0, p0} >= v103;
						globalState.f6 := f33;
						var v104: array<int> := new int[9];
						v104[safeIndex(930, v104.Length)] := f33;
						v100[safeIndex(669, v100.Length)] := f26;
						v104[safeIndex(930, v104.Length)], v100[safeIndex(669, v100.Length)] := |("ojmees" + "ttngdmq")|, f26 && f26;
				}
		...
		var v116: array<int> := new int[20] [f33, safeModuloInt(f33, |f25|), |v105[fm4(globalState) := abs(f27)]|, f27, |fm76(-f27, f26, v106, globalState)|, fm59(v108.cf10, fm1(f26, globalState), f27, f25, globalState), |v109| * f33, if (f26) then f33 else f27, |(fm47(f26, |v0|, f26, f27, globalState))[safeIndex(f33, |fm47(f26, |v0|, f26, f27, globalState)|) := p0]|, f33, |multiset{f26}|, safeModuloInt(f27, f27), -f27, |v105|, ---safeModuloInt(|map[v111.cf64 := f26]|, f33), safeModuloInt(fm58(set v113 : string | v113 in v112.cf103 :: (v113), false, globalState), |v115|), f27, f27, f33, -282];
		forall i9 | 0 <= i9 < v116.Length {
			v116[i9] := i9 + (-f33 + f27);
		}
		var v117: multiset<string> := multiset{f25, f25};
		var v118: map<multiset<string>, int> := map[v117 := -f27];
		v118 := v118[v117 * v117 := safeDivisionInt(f33, 0x378)];
		var v119: seq<bool> := [f26, f26];
		var v120: map<bool, bool> := map[!f26 := v119[safeIndex(if (f27 in v109) then v109[f27] else f33, |v119|)]];
		v120 := v120[f26 := f26];
		var v121: array<char> := new char[23];
		v121[safeIndex(51, v121.Length)] := p0;
		v121[safeIndex(51, v121.Length)] := p0;
		var v122 := DC33(f27);
		r0 := v122;
	}
...
class C5 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		...
		for i0 := |v1| to p0 + p0 {
			...
			if (v2 ==> v2) {
				...
				var v9: array<int> := new int[13](i1 => safeModuloInt(i1, -p0));
				v9[safeIndex(962, v9.Length)] := -0x274;
				var v10: set<bool> := {true, v2, v2, v2};
				var v11: map<bool, bool> := map[v10 >= v10 := v2];
				v9[safeIndex(962, v9.Length)], globalState.f15, r1, globalState.f15 := |v1|, if (v2 in v11) then v11[v2] else true, v2, (v2 && v2) <==> (v2 <==> v2);
				var v12: seq<seq<D5>> := [seq(abs(0x1bf), i2  => (DC16(DC16(DC16(DC16(DC15(i0)))))))];
				var v13: map<int, int> := map[p0 := p0];
				var v14 := DC16(DC14(v13));
				var v15 := DC16(v14);
				var v16: seq<D5> := [DC16(v14), v15];
				v9, v2, v9[safeIndex(962, v9.Length)], v9, v12 := v9, false, p0, v9, fm37(|f25|, v0, p0, 0x34c, globalState) + [[v15], v16];
				...
				var v22: seq<multiset<int>> := [multiset{v9[safeIndex(962, v9.Length)], v9[safeIndex(962, v9.Length)]}, v21, fm39(|f25|, globalState), v21, v21];
				var v23: seq<set<bool>> := [v10, v10, v10, v10, v10];
				globalState.f6 := -fm38((seq(abs(0xfe), i3  => (multiset{|v19|}))) + v22, v10 >= v23[safeIndex(p0, |v23|)], globalState);
			}
			
			var v24: multiset<bool> := multiset{true};
			globalState.f15 := multiset{true} !! (v24[v2 := abs(p0)] * multiset{v2, v2, v2, v2, v2});
			var v25: array<int> := new int[16];
			var v26: seq<bool> := [true];
			v25[safeIndex(266, v25.Length)] := |v26|;
			v25[safeIndex(266, v25.Length)] := |v26[safeIndex(i0, |v26|) := v2 || v2]|;
			globalState.f13 := !v2;
		}
		var v27 := true;
		var v28: map<int, bool> := map[p0 := v27];
		globalState.f10 := if (if (p0 in v28) then v28[p0] else v27) then -p0 else safeDivisionInt(p0, p0);
		var v29: seq<int> := [p0];
		var v30: multiset<int> := multiset{p0, p0};
		var v31: seq<multiset<int>> := [v30, v30];
		var v32 := DC31(v31);
		var v33: map<int, int> := map[p0 := |v29[safeIndex(p0, |v29|) := fm38(v32.cf57, v27, globalState)]|];
		globalState.f10 := 217 - (p0 * |v33|);
		if (v27) {
			var v34: array<bool> := new bool[27];
			v34[safeIndex(430, v34.Length)] := v27;
			v34[safeIndex(430, v34.Length)] := |fm40(globalState)| == p0;
			var v35: map<bool, int> := map[v27 := p0];
			v35 := v35;
			var v36 := "nsgicxj";
			v36, v34[safeIndex(430, v34.Length)], v34[safeIndex(430, v34.Length)], r1, r2 := v36, v34[safeIndex(430, v34.Length)], fm1(!v34[safeIndex(430, v34.Length)], globalState), p0 == (-|v35| * p0), false;
			var v37 := DC6();
			v37 := v37;
			...
			if ((|v30| * p0) >= |v38|) {
				...
				globalState.f6 := v39;
				var v40 := new C0();
				var v41: map<multiset<char>, int> := map[multiset(seq(abs(610), i4  => (v0))) := 0x319 - p0];
				globalState.f10, v39 := if ((v1[v0 := abs(|v30|)] - v1) in v41) then v41[v1[v0 := abs(|v30|)] - v1] else v39, p0;
				globalState.f10 := fm38(v31, v27, globalState);
			} else {
				globalState.f6, globalState.f10, v34[safeIndex(430, v34.Length)], globalState.f6, globalState.f13 := -p0, -0x375, v34[safeIndex(430, v34.Length)], p0, p0 == --0x302;
				var v42 := new C0();
				var v43 := new C0();
				globalState.f10 := p0;
				var v44: array<seq<set<bool>>> := new seq<set<bool>>[28](i5 => seq(abs(-0x1b0), i6  => ({v34[safeIndex(430, v34.Length)]})));
				var v45: seq<set<bool>> := [{v27, v34[safeIndex(430, v34.Length)], false}];
				v44[safeIndex(837, v44.Length)] := v45;
				v44[safeIndex(837, v44.Length)] := v45;
			}
		...
		if (v48 != (v48 + multiset{v27})) {
			...
			if (false) {
				...
				v55[safeIndex(611, v55.Length)] := p0;
				...
				v59[safeIndex(271, v59.Length)] := v27 ==> v27;
				v59[safeIndex(775, v59.Length)] := v27;
				var v60 := "acpuxrk";
				var v61: map<bool, string> := map[v27 := v60];
				v55[safeIndex(611, v55.Length)], v59[safeIndex(271, v59.Length)], globalState.f15, v59[safeIndex(775, v59.Length)], v60 := |((if (v27 in v61) then v61[v27] else v60) + (if (false in v61) then v61[false] else v60))[safeIndex(0xed, |((if (v27 in v61) then v61[v27] else v60) + (if (false in v61) then v61[false] else v60))|) := v0]|, fm1(!fm35(v27, v60, "xfkhyv", globalState), globalState), v27, v27, (v60 + f25) + f25;
				globalState.f13 := fm1(!!v59[safeIndex(271, v59.Length)], globalState);
				var v62: seq<array<int>> := [v55];
				globalState.f6, v59[safeIndex(271, v59.Length)] := |v60| + (|v62| * -496), v59[safeIndex(271, v59.Length)];
				...
				var v71: seq<string> := [f25[safeIndex(|v70|, |f25|) := v0], f25];
				globalState.f15 := v71 != [seq(abs(813), i9  => (v0))];
				var v72: seq<bool> := [v27];
				var v73: seq<seq<bool>> := [v72 + v72, v72, (v72 + v72)[safeIndex(p0, |(v72 + v72)|) := v27], [v27, v27]];
			...
			v76[safeIndex(592, v76.Length)] := v75;
			v76[safeIndex(592, v76.Length)] := v75 + v75;
			v28 := v28;
			var v77 := "lxpkp";
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		var v2 := DC39(v1);
		r2 := v2.cf69[safeIndex(p0, |v2.cf69|) := v0] <= v1;
		var v3 := false;
		var v4: seq<bool> := [v3];
		...
		var i0 := 0;
		while (v4[safeIndex(|v7[v3 := !v3]|, |v4|)])
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v4 := fm44(globalState);
			var v8: seq<int> := [p0];
			var v9: multiset<int> := multiset{v8[safeIndex(p0, |v8|)], p0};
			if (v9 < (v9 + multiset{p0})) {
				var v10: map<int, int> := map[safeModuloInt(p0, -0x192) := p0];
				var v11 := DC26(multiset{p0}, p0, v3, p0, v3);
				v10 := v10[v11.cf50 := safeModuloInt(p0, p0)];
				r3 := p0;
				var v12 := new C0();
				globalState.f10 := p0;
				var v13 := DC11(v12);
				...
				v16[safeIndex(880, v16.Length)] := v15;
				v16[safeIndex(880, v16.Length)] := v15;
				var v17: set<bool> := {false, v3 || v3, v3, !v3};
				var v18 := "hupwuuh";
				globalState.f10, v17, v15, v18 := safeModuloInt(safeDivisionInt(p0, p0), p0), v17, fm2(p0, v3, false || v3, globalState), fm36(p0, globalState);
				var v19: multiset<bool> := multiset{v3, v3};
				v9 := (multiset(v8 + [|v19|, -p0]))[p0 := abs(p0)];
			}
		...
		for i2 := p0 * p0 to p0 + p0 {
			...
			var v21: T2 := new C4(safeModuloInt(i2, i2), v3, p0, f25);
			var v22: set<string> := {f25};
			var v23: map<int, T2> := map[safeDivisionInt(p0, fm58(v22, v3, globalState)) := if (v21.f26) then v21 else v21];
		...
		if (v3) {
			...
			v25 := v25;
			v5[safeIndex(726, v5.Length)] := v3;
			v5[safeIndex(726, v5.Length)] := v3;
			var v26: set<bool> := {v5[safeIndex(726, v5.Length)], v3};
			var v27: multiset<bool> := multiset{true, v5[safeIndex(726, v5.Length)]};
			var v28: map<int, int> := map[|v27| := p0];
			var v29 := DC14(v28);
			var v30: seq<int> := [|v29.cf30|, p0, p0];
			var v31: array<bool> := new bool[28] [v26 !! v26, v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], v3, v5[safeIndex(726, v5.Length)], true, if (v3) then v3 else v5[safeIndex(726, v5.Length)], !v5[safeIndex(726, v5.Length)], p0 in map[|v30| := true], v3, v3, v26 > v26, v5[safeIndex(726, v5.Length)], v3, v3 <== v3, true, !true, fm1(v3, globalState), v3, !v5[safeIndex(726, v5.Length)], v4[safeIndex(p0, |v4|)], v3, v5[safeIndex(726, v5.Length)], v3 <== v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)] && v5[safeIndex(726, v5.Length)], v3, v3];
			var v32: multiset<int> := multiset{p0};
			var v33: seq<multiset<int>> := [v32];
			var v34: multiset<int> := multiset{fm38(v33, v5[safeIndex(726, v5.Length)], globalState), p0};
			v31 := new bool[26] [v5[safeIndex(726, v5.Length)] !in v26, v3, (if (v4[safeIndex(p0, |v4|)] in v7) then v7[v4[safeIndex(p0, |v4|)]] else v3) ==> !v5[safeIndex(726, v5.Length)], !!v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], !v5[safeIndex(726, v5.Length)], v3, true, v5[safeIndex(726, v5.Length)], false, v5[safeIndex(726, v5.Length)], v3, v3, v3, v3, v3, fm1(v5[safeIndex(726, v5.Length)], globalState), v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], v5[safeIndex(726, v5.Length)], v3, v5[safeIndex(726, v5.Length)], v3, v5[safeIndex(726, v5.Length)] || v3, v32 >= fm39(v30[safeIndex(-p0, |v30|)], globalState)];
			var v35: map<D15, int> := map[DC43(fm57(v26, globalState), p0, p0) := |v28|];
			var v36 := DC43(multiset{v3}, 0x2ef, |f25|);
			v35 := v35[v36 := v30[safeIndex(p0, |v30|)]];
		} else {
			...
			decreases 100 - i3
		{
			...
			v49 := v49 + v49;
			var v50: map<int, int> := map[safeDivisionInt(-|v48.f25|, p0) := p0];
			...
			var v54 := "mtg";
			var v55 := 'o';
			v54 := ("xonopppb")[safeIndex(p0, |"xonopppb"|) := v55];
...
class C6 extends T1 {
	...
	function fm3(p0: bool, globalState: GlobalState): bool {
		safeDivisionInt(|[|f25|]|, -|f32|) != 0x113
	}
	function fm27(globalState: GlobalState): int {
		safeModuloInt(|map[false := !true]| * 0x1b6, |[|f25|, -0x16e]| - |f25|)
	}
	function fm28(p0: bool, globalState: GlobalState): int {
		--0x141 * -|(map v0 : int | (832 <= v0) && (v0 < 0x36a) :: (safeDivisionInt(v0, -|{|{false}|, 924}|)) := (|f25|))|
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		var v0 := false;
		var v1 := 'y';
			...
			decreases 100 - i0
		{
			...
			match (if (v2 !! v2) then v3 else v3) {
				...
				case DC19(cf35) =>
					...
					v13[safeIndex(749, v13.Length)] := v11;
					v13[safeIndex(749, v13.Length)] := v11;
					globalState.f15 := v0;
				case DC21(cf38) =>
					...
					var v16 := DC3(f25);
					r1, globalState.f15, globalState.f13, globalState.f10, globalState.f15 := if ((v0 <== v0) in v14) then v14[v0 <== v0] else v0, false, (v15 !! v15) && v0, p0, (seq(abs(0x31f), i1  => (v1))) <= v16.cf12;
					var v17 := DC15(p0);
					v17 := v17;
			...
			if (p0 <= p0) {
				...
				v25[safeIndex(376, v25.Length)] := v1 !in f25;
				v25[safeIndex(376, v25.Length)] := fm1(!v0, globalState);
			} else {
				var v26: array<int> := new int[29](i3 => i3 + p0);
				var v27 := DC9(f25, v26, v0);
				var v28 := DC10(v27);
				var v29: seq<D3> := [v27];
				var v30: array<D3> := new D3[9] [DC10(v27), v28, v28, v28, v28, DC10(v27).(cf27 := v29[safeIndex(p0, |v29|)]), v28, v28, DC10(v27)];
				v30[safeIndex(232, v30.Length)] := v28;
				v30[safeIndex(232, v30.Length)] := v28.(cf27 := v28.cf27);
				var v31: seq<int> := [0x2d2, p0];
				globalState.f6 := safeDivisionInt(p0, |v31|) * -(p0 * p0);
				var v32: set<int> := {-p0};
				var v34: set<set<int>> := {v32, v32, set v33 : int | (607 <= v33) && (v33 < -0x210) :: (safeDivisionInt(v33, p0))};
				v0 := v32 !in v34;
				globalState.f10 := -518;
				var v35 := new C0();
			}
			...
			var v37: seq<string> := [f25, "uiwq", seq(abs(-0xf6), i4  => ('f')), f25, f25];
			v36[safeIndex(734, v36.Length)] := fm27(globalState) == |v37|;
			v36[safeIndex(734, v36.Length)] := p0 != p0;
		}
		for i5 := p0 to p0 {
			r2 := safeDivisionInt(p0, p0) == (-0x34d + |f25|);
			...
			match (v41) {
				case DC15(cf31) =>
					var v42: array<seq<D5>> := new seq<D5>[25](i6 => seq(abs(0x231), i7  => (DC16(DC14(v38)))));
					v42[safeIndex(67, v42.Length)] := seq(abs(692), i8  => (DC16(DC15(i5))));
					var v43 := DC15(i5);
					var v44 := DC16(v43);
					var v45 := DC16(v43);
					var v46 := DC16(v44);
					var v47: seq<D5> := [v46];
					globalState.f6, v42[safeIndex(67, v42.Length)] := if (p0 in v38) then v38[p0] else fm27(globalState), (if (v0) then v47 else v47) + v47;
				...
				case DC14(cf30) =>
					...
					globalState.f6 := --safeDivisionInt(p0, |v50|);
		...
		for i10 := p0 to if (v61 in v63) then v63[v61] else 0x1e4 {
			...
			v64 := v66.cf0 + v64;
			v61[safeIndex(940, v61.Length)] := v0;
			v61[safeIndex(940, v61.Length)] := v0;
			v60[safeIndex(781, v60.Length)] := p0;
			var v67: seq<int> := [p0];
			var v68: set<array<int>> := {v60};
			globalState.f10, v60[safeIndex(781, v60.Length)] := i10, i10 + v67[safeIndex(|v68|, |v67|)];
			v0 := v0;
		}
		v0 := (p0 + p0) < p0;
		var v69: seq<bool> := [v0];
		if ((v69 < v69) && (if (v0) then v0 else false)) {
			...
			var v70: seq<int> := [p0];
			var v71: seq<int> := [v70[safeIndex(p0, |v70|)]];
			var v72: map<int, bool> := map[|v70[safeIndex(p0, |v70|) := p0]| := v0];
			var v73 := DC8(v72);
			match (v73) {
				case DC9(cf24, cf25, cf26) =>
					...
					v75 := set v76 : int | v76 in multiset{p0, p0, p0, p0} :: (safeDivisionInt(v76, 0x308));
					...
					r1 := fm1(fm3(v69[safeIndex(p0, |v69|)], globalState), globalState);
				case DC8(cf23) =>
					...
					v84[safeIndex(970, v84.Length)] := if (v0) then 'a' else v1;
					var v85: set<bool> := {v0};
					v84[safeIndex(970, v84.Length)] := fm2(|v85|, true, v0, globalState);
					var v86: map<string, int> := map["imhqxjfda" + f25 := |(f32 + f32)|];
					v86 := v86;
				case DC10(cf27) =>
					var v87 := DC9(f25 + f25, v60, |{map[v0 := v0]}| <= |f25|);
					v87 := v87;
					globalState.f10 := safeModuloInt(|map[p0 := v0]|, p0 + p0);
			...
			v60[safeIndex(57, v60.Length)] := p0;
			var v88: seq<int> := [p0];
			var v89: set<seq<int>> := {v88[safeIndex(p0, |v88|) := p0]};
			v60[safeIndex(57, v60.Length)] := |(v89 - v89)|;
			var v90: set<char> := {v1};
			var v91: seq<string> := [f25];
			var v92: map<int, seq<string>> := map[|(v90 + v90)| := (v91 + v91)[safeIndex(p0, |(v91 + v91)|) := f25]];
			v92 := v92[p0 := v91];
			var v93: multiset<bool> := multiset{v0, !v0, v0, v0, v0};
			globalState.f6 := -((if (fm3(v0, globalState) in v93) then v93[fm3(v0, globalState)] else 913) + v60[safeIndex(57, v60.Length)]);
		...
		r0 := v96 + v96;
		r1 := v0;
		r2 := !v69[safeIndex(0x1d8, |v69|)] <==> v0;
		var v97: multiset<bool> := multiset{v0};
		r3 := (v97 - v97[v0 := abs(p0)]) * (multiset{v0, v0, v0, !v0, v0} * v97);
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		var v0 := true;
		...
		for i1 := p0 to p0 {
			v1[safeIndex(746, v1.Length)] := v0;
			var v2: array<string> := new string[1](i2 => "yjcc");
			v2[safeIndex(589, v2.Length)] := f25;
			v1[safeIndex(746, v1.Length)], globalState.f10, v2[safeIndex(589, v2.Length)], r3, globalState.f13 := (v0 && v0) <==> v0, fm27(globalState), (f25 + f25) + f25, i1 * p0, v0;
			var v3 := new C0();
			if (!fm1(if (v1[safeIndex(746, v1.Length)]) then !v1[safeIndex(746, v1.Length)] else false, globalState)) {
				v1[safeIndex(746, v1.Length)] := v0;
				v1[safeIndex(746, v1.Length)] := v1[safeIndex(746, v1.Length)];
				v1[safeIndex(746, v1.Length)] := true;
				r3 := |((seq(abs(0x359), i3  => (f25[safeIndex(|f25|, |f25|)]))) + ['s'])| + -i1;
				var v4 := 'l';
				v0 := (DC20(v1[safeIndex(746, v1.Length)], v4).(cf37 := v4)).cf36;
			} else {
				var v5 := new C0();
				var v6: array<char> := new char[2];
				v6[safeIndex(866, v6.Length)] := 'n';
				var v7 := 'y';
				v6[safeIndex(866, v6.Length)] := v7;
				var v8: seq<bool> := [fm3(v0, globalState)];
				var v9: array<bool> := new bool[18] [v1[safeIndex(746, v1.Length)], v1[safeIndex(746, v1.Length)], v0, v8[safeIndex(p0, |v8|)], v0, v1[safeIndex(746, v1.Length)], v0, v0, !v0, v0, v0, v1[safeIndex(746, v1.Length)], v0, fm1(v0, globalState), true, v1[safeIndex(746, v1.Length)], v1[safeIndex(746, v1.Length)], v1[safeIndex(746, v1.Length)]];
				var v10: map<string, array<bool>> := map[v2[safeIndex(589, v2.Length)] := v9];
				v10 := v10[v2[safeIndex(589, v2.Length)] := v9];
				v1[safeIndex(746, v1.Length)] := !v0;
				var v11: map<int, int> := map[p0 := safeDivisionInt(|v8|, |f25|)];
				var v12: multiset<int> := multiset{p0};
				var v13 := DC14(map[0x1d7 := |v2[safeIndex(589, v2.Length)]|]);
				var v14: map<bool, bool> := map[!v0 := v0];
				var v15: multiset<bool> := multiset{v0};
				var v16: map<multiset<bool>, array<bool>> := map[v15 := v9];
				v11, v12, globalState.f6, globalState.f6 := (v11 + v13.cf30) + v11, if (!(if (v0 in v14) then v14[v0] else v1[safeIndex(746, v1.Length)])) then v12 else (v12[i1 := abs(p0)])[p0 := abs(|v2[safeIndex(589, v2.Length)]|)], if (i1 in v12) then v12[i1] else |v16|, |[p0, 0x216]|;
			}
			...
			decreases 100 - i4
		{
			...
			var v18: set<bool> := {v0};
			var v19: array<int> := new int[18] [p0, |v17|, p0, if (v0) then -544 else p0, safeModuloInt(0x30f, p0), safeModuloInt(0x38e, p0), p0, p0, p0, p0, |v18|, if (!v0) then |f25| else -|fm31(globalState)|, p0, safeModuloInt(p0, |"lavoxko"|), p0, p0, -(p0 + 0x1c2), p0];
			v19[safeIndex(137, v19.Length)] := p0;
			var v20 := "wipp";
			...
			globalState.f15, v19[safeIndex(137, v19.Length)], globalState.f10, v20, r3 := (fm1(false, globalState) in v22) in v23, if (p0 in v24) then v24[p0] else -p0, safeModuloInt(if (v0 in f32) then f32[v0] else p0, p0 * |v25|), v20, p0;
			if (if (v0) then v0 else v0) {
				v1[safeIndex(302, v1.Length)] := v0;
				var v26: set<array<bool>> := {v1, v1, v1, v1};
				v1[safeIndex(302, v1.Length)] := !(v26 > (v26 * v26));
				var v27 := 'k';
				v27 := v27;
				var v28: set<char> := {'c'};
				var v29: map<map<bool, int>, int> := map[f32 := v19[safeIndex(137, v19.Length)]];
				v19[safeIndex(137, v19.Length)], r3, globalState.f15, v20 := fm28(!true, globalState) + v19[safeIndex(137, v19.Length)], safeModuloInt(|v28|, safeModuloInt(v19[safeIndex(137, v19.Length)], v19[safeIndex(137, v19.Length)])), v0, fm29(v1[safeIndex(302, v1.Length)], f32, v29, globalState);
				v20 := (v20 + v20)[safeIndex(p0, |(v20 + v20)|) := v27];
				v20 := seq(abs(0xaa), i5  => (v27));
			} else {
				var v30: array<map<bool, int>> := new map<bool, int>[21];
				v30[safeIndex(234, v30.Length)] := f32;
				v30[safeIndex(234, v30.Length)] := f32;
				r2 := v0;
				r0 := safeModuloInt(v19[safeIndex(137, v19.Length)] * v19[safeIndex(137, v19.Length)], |v30[safeIndex(234, v30.Length)]|);
				v1[safeIndex(435, v1.Length)] := v0;
				v1[safeIndex(435, v1.Length)], globalState.f15 := false, v0;
				var v31 := 'i';
				v31 := if (v1[safeIndex(435, v1.Length)]) then 'f' else if (v1[safeIndex(435, v1.Length)]) then v31 else v20[safeIndex(-|v22|, |v20|)];
			}
			
			globalState.f13 := false;
			var v32: seq<int> := [p0, p0, p0, |(seq(abs(0x10a), i6  => ('o')))|, v19[safeIndex(137, v19.Length)]];
			var v33: seq<int> := [|v32|];
			r2 := fm3(v32 <= v32[safeIndex(p0, |v32|) := p0], globalState);
		}
		r2 := !false;
		if (!v0 <== v0) {
			var v34 := new C0();
			...
			v39[safeIndex(401, v39.Length)] := fm32(if (v40 in v41) then v41[v40] else 0x9f, !v0, p0, v0, globalState);
			var v42: seq<bool> := [v0, false];
			v39[safeIndex(401, v39.Length)] := (DC22([v42]).cf39 + [v42])[safeIndex(p0, |(DC22([v42]).cf39 + [v42])|) := v42 + v42];
			...
			v44 := f25[safeIndex(p0, |f25|)];
			var v49: C0 := new C0();
			var v50 := DC3("baava");
			var v51 := DC5(v50, !v48, p0, v48);
			var v52: multiset<int> := multiset{(v51.(cf17 := v42[safeIndex(p0, |v42|)], cf15 := v48, cf14 := v50)).cf16};
		...
		r0 := p0 * |((seq(abs(0x172), i8  => ('k'))) + v55.cf22)|;
	...
	method m12(p0: array<bool>, p1: bool, p2: map<bool, int>, p3: array<bool>, globalState: GlobalState) returns (r0: map<int, string>, r1: bool) {
		...
		var v8 := 'e';
		var v9: set<string> := {f25[safeIndex(v0, |f25|) := v8]};
		if (v1 < (v4[safeIndex(v0, |v4|) := v0])[safeIndex(|v6|, |v4[safeIndex(v0, |v4|) := v0]|) := -|[|(map v7 : string | v7 in v9 :: (v7) := (|map[f25 := v0]|))|]|]) {
			...
			var v15: array<int> := new int[28] [|map[p1 := p1]|, v0, safeModuloInt(v0, -949), v10, 268, -853, |f25|, v0, v0, v0 * 0x2fe, |v4|, v10, v10, v0 * v10, v10 + v0, v10, v10, |fm33(globalState)|, v10, v10, v10, -v10, v10, v10, v10, v10, v10, v0];
			v15 := v15;
			p0[safeIndex(28, p0.Length)] := p1;
			var v16: multiset<bool> := multiset{p1, p1};
			var v17: map<int, bool> := map[|v1| := p1];
			var v18: array<bool> := new bool[25] [v3 != {p1, p1}, p1, v0 != v10, p1, p1, v8 in (seq(abs(0x2e), i0  => (v8))), v8 !in f25, p1, p1, p1, p1, v16 == v16, p1 || p1, v17 != v17, p1, p1, if (p1) then false else p1, p1, p1, p1, v0 < 0x8a, p1, p1 <==> p1, p1, fm3(p1, globalState)];
			p0[safeIndex(545, p0.Length)] := v3 >= v3;
			v18[safeIndex(50, v18.Length)] := p1;
			p0[safeIndex(28, p0.Length)], globalState.f15, v18, p0[safeIndex(545, p0.Length)], v18[safeIndex(50, v18.Length)] := v10 != v10, safeDivisionInt(v10, v0) > v10, p0, p1, !p1;
		} else {
			if ((|f25| * |v4|) < v0) {
				...
				var v23: array<int> := new int[18] [v0, 0x2ae, |(set v19 : char | v19 in f25 :: (v19))|, -0x252, fm27(globalState), v0, |(v5 + v5)[safeIndex(fm27(globalState), |(v5 + v5)|) := !p1]|, 0xaa, |(v21 * {v20})|, v0, v0, |(v1 + v4)|, if (p1 in v22) then v22[p1] else v0, fm28(!p1, globalState), v0, fm27(globalState) * v0, v0, v0 + v0];
				v23 := new int[28];
				v23[safeIndex(159, v23.Length)] := |(f25 + f25)|;
				v23[safeIndex(159, v23.Length)] := v0 - v0;
			} else {
				globalState.f6 := |f25|;
			...
			if (p1) {
				...
				v32[safeIndex(695, v32.Length)] := v5;
				v32[safeIndex(695, v32.Length)] := v5 + v5;
				var v33 := new C0();
				globalState.f13 := p1;
				v8 := v8;
				var v34: multiset<set<bool>> := multiset{v3, v3};
				globalState.f6 := safeDivisionInt(v0, v0) * |v34|;
			} else {
				v5 := (v5 + ([!fm3(p1, globalState), p1])[safeIndex(v0, |[!fm3(p1, globalState), p1]|) := p1]) + v5;
				v8 := 'u';
				v29 := v29;
				var v35: C0 := new C0();
				v35 := new C0();
			...
			if (p1) {
				...
				v36 := (v36 + v36)[safeIndex(v0, |(v36 + v36)|) := [-|f25|, v0, |map[p1 := v8]|, v0, |v38|]];
				p0[safeIndex(258, p0.Length)] := p1;
				p0[safeIndex(258, p0.Length)] := if (p1) then p1 else p1;
				globalState.f15 := p0[safeIndex(258, p0.Length)];
				v29[safeIndex(792, v29.Length)] := if (p0[safeIndex(258, p0.Length)]) then v0 else |(map v39 : int | (0x286 <= v39) && (v39 < -906) :: (v39 - v0) := (|map[p0[safeIndex(258, p0.Length)] := p0[safeIndex(258, p0.Length)]]|))|;
				v29[safeIndex(792, v29.Length)] := v0;
				var v40: T1 := new C1(f25);
				var v41 := DC19({v40});
				v41 := v41;
			} else {
				var v42: seq<string> := [f25 + (seq(abs(0x280), i2  => (v8))), ("ydchekk" + f25)[safeIndex(v0, |("ydchekk" + f25)|) := v8], (seq(abs(372), i3  => (v8))) + "x"];
				v42 := v42;
				globalState.f13 := p1;
				globalState.f6 := v0;
				p3[safeIndex(53, p3.Length)] := p1;
				p3[safeIndex(53, p3.Length)] := v0 == v0;
				globalState.f15 := v0 <= safeModuloInt(|v28[p1 := abs(v0)]|, |f25|);
			}
			
			var v43: array<seq<int>> := new seq<int>[7] [[v0], v1, v4, v4, seq(abs(-0x245), i4  => (v0)), fm52(p1, p1, v8, globalState), v4];
			v43[safeIndex(58, v43.Length)] := v4;
			v43[safeIndex(58, v43.Length)] := v4;
		}
		...
		r1 := v0 >= -952;
		r0 := map v47 : int | v47 in v2[-v0 := |multiset(v1)|] :: (safeModuloInt(v47, |multiset{p1}|)) := (f25 + f25);
		r1 := p1;
	}
	method m13(p0: bool, p1: int, p2: bool, p3: map<char, bool>, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: bool, r3: bool) {
		...
		var v16: array<map<int, int>> := new map<int, int>[25] [v2, v2, v2, v2, v2, v2, v2, v2, v2[p1 := p1], v2[0xc0 := p1], v3.cf30, v2, map[p1 := p1], v2, v2, v2 + v2, v2, v2 + v2, v2 + (map v4 : int | (985 <= v4) && (v4 < 684) :: (safeModuloInt(v4, p1)) := (p1)), v2 + v2, map v5 : int | v5 in (map v6 : int | v6 in v10[|v15| := v9] :: (v6 + p1) := (true)) :: (safeModuloInt(v5, 0x144)) := (p1), v2, (map[|(seq(abs(510), i0  => (p1)))| := p1])[0x134 := |f32|], v2 + map[p1 := p1], v2];
		v16 := v16;
		var v17: map<bool, int> := map[true := p1];
		var v18: multiset<bool> := multiset{p2, false, p0, p2, p0};
		v17 := v17[false := |v18|];
		var v19: array<string> := new string[2];
		v19[safeIndex(153, v19.Length)] := f25;
		v19[safeIndex(153, v19.Length)] := f25;
		var v20: array<int> := new int[10](i1 => safeDivisionInt(i1, p1));
		v20[safeIndex(82, v20.Length)] := p1;
		v20[safeIndex(82, v20.Length)] := -p1 + (if (p0) then --p1 else p1);
		v11[safeIndex(348, v11.Length)] := p0;
		v11[safeIndex(348, v11.Length)] := p2;
		var i2 := 0;
		while (p2)
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			var v21 := DC43(v18, v20[safeIndex(82, v20.Length)], v20[safeIndex(82, v20.Length)]);
			var v22: map<D15, int> := map[v21 := v15[safeIndex(|v2|, |v15|)]];
			var v23: seq<multiset<bool>> := [v18];
			var v24 := DC18(true);
			var v25: multiset<D6> := multiset{v24};
			var v27: seq<D15> := [DC43(v18, v20[safeIndex(82, v20.Length)], v20[safeIndex(82, v20.Length)]), v21];
			var v29: map<bool, map<D15, int>> := map[!p0 := v22];
			var v31: multiset<D15> := multiset{v21, v21};
			var v32: array<array<int>> := new array<int>[4];
			var v33: C3 := new C3(v32, v19[safeIndex(153, v19.Length)]);
			var v34: map<C3, bool> := map[v33 := false];
			var v35: multiset<int> := multiset{|v34|, -p1};
			var v36: array<map<D15, int>> := new map<D15, int>[23] [v22, v22, v22, v22, v22 + v22, map[DC43(v18, DC40(p1).cf70, |v19[safeIndex(153, v19.Length)]|) := -0x84] + v22, map[DC43(v23[safeIndex(p1, |v23|)], -p1, |v25|).(cf75 := v20[safeIndex(82, v20.Length)]) := 0x272] + v22, v22, fm79(0x205, p1, globalState), v22[v21 := p1], v22, ((map v26 : D15 | v26 in v27 :: (v26) := (v20[safeIndex(82, v20.Length)]))[v21 := p1])[v21 := p1] + v22, map[v21 := p1], map v28 : D15 | v28 in (seq(abs(0x78), i3  => (v21))) :: (v28) := (|(v19[safeIndex(153, v19.Length)][safeIndex(p1, |v19[safeIndex(153, v19.Length)]|) := v7])[safeIndex(p1, |v19[safeIndex(153, v19.Length)][safeIndex(p1, |v19[safeIndex(153, v19.Length)]|) := v7]|) := v7]|), v22, v22, v22, v22, v22, v22[DC43(v18, p1, v20[safeIndex(82, v20.Length)]) := v20[safeIndex(82, v20.Length)]], v22 + (if (v11[safeIndex(348, v11.Length)] in v29) then v29[v11[safeIndex(348, v11.Length)]] else map v30 : D15 | v30 in v31 :: (v30) := (v20[safeIndex(82, v20.Length)])), v22, fm79(v20[safeIndex(82, v20.Length)], |v35|, globalState)];
			var v38: set<D15> := {v21, v21, v21, v21, DC43(v18, p1, v20[safeIndex(82, v20.Length)])};
			var v40: map<D15, bool> := map[v21 := p0];
			v36[safeIndex(909, v36.Length)] := (map v37 : D15 | v37 in v38 :: (v37) := (v20[safeIndex(82, v20.Length)])) + (map v39 : D15 | v39 in v40 :: (v39) := (p1));
			var v41: multiset<string> := multiset{v19[safeIndex(153, v19.Length)], v19[safeIndex(153, v19.Length)]};
			v36[safeIndex(909, v36.Length)] := fm79(-p1, safeModuloInt(0x18e, |v41|), globalState);
			if (p2) {
				var v42: seq<array<bool>> := [v11];
				var v43: multiset<array<bool>> := multiset{v11, v11, v42[safeIndex(v20[safeIndex(82, v20.Length)], |v42|)]};
				globalState.f13, v43, v20[safeIndex(82, v20.Length)] := v11[safeIndex(348, v11.Length)], v43, |(seq(abs(0xa6), i4  => (v7)))|;
				v11[safeIndex(348, v11.Length)] := p0;
				globalState.f13 := true;
				var v44: map<int, bool> := map[v20[safeIndex(82, v20.Length)] := p0];
				...
				var v47: seq<string> := ["rribthn", v19[safeIndex(153, v19.Length)]];
				globalState.f6, v19[safeIndex(153, v19.Length)], globalState.f6, v46 := v20[safeIndex(82, v20.Length)], v19[safeIndex(153, v19.Length)], -(v20[safeIndex(82, v20.Length)] + p1) * (if (v11[safeIndex(348, v11.Length)]) then p1 else |v47[safeIndex(v20[safeIndex(82, v20.Length)], |v47|)]|), v46;
				v17 := f32;
			} else {
				var v48: array<seq<bool>> := new seq<bool>[2](i5 => v0);
				v48[safeIndex(921, v48.Length)] := v0 + v0;
				v48[safeIndex(921, v48.Length)], v20[safeIndex(82, v20.Length)], v20[safeIndex(82, v20.Length)], globalState.f15, v13 := v0, v20[safeIndex(82, v20.Length)], 0xd2, v11[safeIndex(348, v11.Length)], v13;
				var v49: array<D15> := new D15[26];
				var v50: set<array<int>> := {v20};
				var v51 := DC52(v50);
				var v52: map<array<D15>, D20> := map[v49 := v51];
				v52 := v52;
				var v53: map<char, bool> := map[v7 := v11[safeIndex(348, v11.Length)]];
				v53 := v53;
				globalState.f10 := safeDivisionInt(v20[safeIndex(82, v20.Length)], 0x146) + -p1;
				globalState.f13 := v11[safeIndex(348, v11.Length)];
			}
		...
		r0 := v20;
		r1 := v20[safeIndex(82, v20.Length)] > p1;
		r2 := v20[safeIndex(82, v20.Length)] >= p1;
		r3 := v11[safeIndex(348, v11.Length)];
	}
}
...
class C7 extends T1 {
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			v6[safeIndex(583, v6.Length)] := multiset{v7, v7, v7} > v8;
			...
			v6[safeIndex(583, v6.Length)] := v13 !in v15;
		}
		...
		if (fm3(v1, globalState)) {
			...
			match (v24) {
				case DC12() =>
					globalState.f6 := safeDivisionInt(f31, p0);
				...
				case DC13(cf29) =>
					...
					var v27: set<string> := {f25[safeIndex(|v26|, |f25|) := v0], f25};
					v25[safeIndex(895, v25.Length)] := v27;
					var v28: array<int> := new int[3](i3 => i3 - 0x206);
					v28[safeIndex(813, v28.Length)] := p0;
					v16[safeIndex(433, v16.Length)] := cf29;
					var v29: seq<bool> := [f25 <= f25, v1, cf29, v1];
					v25[safeIndex(895, v25.Length)], globalState.f6, v28[safeIndex(813, v28.Length)], v16[safeIndex(433, v16.Length)] := (fm80(p0, globalState)).cf112, |v4|, p0, v29[safeIndex(f31, |v29|)];
					v28[safeIndex(813, v28.Length)] := safeModuloInt(v28[safeIndex(813, v28.Length)], p0);
					v29 := v29;
					var v30: map<int, int> := map[p0 := v28[safeIndex(813, v28.Length)]];
					var v31 := DC53(|v30|);
					var v32: map<D20, string> := map[v31 := f25];
					v32 := v32[v31.(cf92 := -|v4[safeIndex(p0, |v4|) := v28[safeIndex(813, v28.Length)]]|) := (seq(abs(0x75), i4  => ('q'))) + f25];
				case DC11(cf28) =>
					r1 := v1;
					var v33: map<seq<int>, bool> := map[v4 := v1];
					globalState.f6 := fm59(safeModuloInt(p0, 0x23c), if ([|f25|, f31] in v33) then v33[[|f25|, f31]] else false, f31, f25, globalState);
					globalState.f15 := fm1(v1, globalState);
					var v34: seq<string> := [f25, f25];
					globalState.f10 := v4[safeIndex(|(v34[safeIndex(-f31, |v34|)] + f25)|, |v4|)];
			}
			
			var v35: set<int> := {|(seq(abs(-0x46), i5  => (v0)))|, v4[safeIndex(f31, |v4|)], f31};
			...
			var v40: array<int> := new int[26](i6 => safeDivisionInt(i6, |(seq(abs(944), i7  => (f25)))|));
			var v41: multiset<array<bool>> := multiset{v16, v16};
			var v42 := DC24(v40, false);
			var v43: seq<D8> := [v42, v42];
			var v44 := DC63(v43);
			var v45: array<int> := new int[24] [|(if (false in v36) then v36[false] else v35)|, f31, |v38|, fm26(p0, v39[safeIndex(|f25|, |v39|)], v1, globalState), f31 + |f25|, f31 - -p0, p0 - 74, |map[v40 := f31]|, -f31, 868 - -0xac, |f25|, p0 - f31, f31, p0, |v41|, p0, |f25| - f31, if (false) then f31 else |v44.cf113|, -p0, f31, f31, safeDivisionInt(p0, fm59(|f25|, v1, f31, f25, globalState)), if (fm1(false, globalState)) then f31 else -p0, f31];
			...
			var v48 := DC64(v47);
			v47 := v48.cf114;
			v45[safeIndex(45, v45.Length)] := f31;
			v45[safeIndex(45, v45.Length)] := (f31 - |"ldospdvs"|) * (p0 + f31);
		} else {
			r2 := !v1;
			v16[safeIndex(492, v16.Length)] := v1;
			v16[safeIndex(492, v16.Length)] := !false;
			globalState.f6 := f31;
			globalState.f13 := v1;
			var v49: set<D22> := {DC57(f31, |map[v16[safeIndex(492, v16.Length)] := map[p0 := p0]]|, p0, v0, p0)};
			var v50: map<int, bool> := map[p0 := v1];
			var v51: map<bool, int> := map[v49 !! v49 := |fm56(v16[safeIndex(492, v16.Length)], v50, v1, globalState)|];
			var v52 := DC0(v51, f31, v0, v16[safeIndex(492, v16.Length)]);
			var v53: seq<map<bool, int>> := [DC0(map[v1 := p0], f31, v0, v1).cf0 + v51, if (!v1) then v51 else map[v16[safeIndex(492, v16.Length)] := f31], v52.cf0[true := p0], v51 + v51];
			var v54: multiset<int> := multiset{p0, v52.cf1};
			v51 := v53[safeIndex(|v54|, |v53|)];
		}
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		var v1: seq<bool> := [v0];
		var v2: seq<int> := [f31];
		var v3: map<seq<bool>, int> := map[v1 := v2[safeIndex(f31, |v2|)]];
		...
		if (match v4 {
			...
			var v5: set<int> := {-safeModuloInt(f31, p0)};
			v5 := v5;
			var v6: map<bool, bool> := map[v0 := v0];
			var v7: set<map<bool, bool>> := {map[v0 := v0]};
			globalState.f13 := v6 !in v7;
			var v8: array<string> := new string[27](i0 => f25[safeIndex(p0, |f25|) := 'd']);
			v8 := v8;
			var v9: map<string, bool> := map[f25 := v0];
			v9 := v9[f25 := v0];
			var v10: seq<string> := ["ythf"];
			var v11: multiset<string> := multiset{f25};
			globalState.f10 := fm26(safeDivisionInt(f31, f31), v0, multiset{v10[safeIndex(f31, |v10|)], f25, "t"} >= v11, globalState);
		} else {
			...
			v19 := (v19 + v19) * v21[safeIndex(p0, |v21|)];
		...
		match (DC13(v0 <==> false)) {
			case DC12() =>
				...
				v26, v27, globalState.f10 := seq(abs(0x30d), i1  => (if (v0) then v24 else v24)), v27, 0x307;
				var v28 := DC40(f31);
				var v29: map<seq<int>, bool> := map[seq(abs(0x3df), i2  => (|multiset([DC46(p0, p0, f31, v0), DC46(f31, f31, |map[v0 := |{p0, f31}|]|, v0), DC46(225, |{-f31, |v27|}|, f31, v0)])|)) := if (v28.cf70 in v27) then v27[v28.cf70] else v0];
				v29 := v29 + v29;
			case DC13(cf29) =>
				var v30: array<bool> := new bool[5];
				v30[safeIndex(525, v30.Length)] := cf29;
				var v31: map<bool, int> := map[v0 := f31];
				var v32 := 'q';
				v30[safeIndex(525, v30.Length)] := DC0(v31, 0xd0, v32, cf29).cf3;
				v30[safeIndex(525, v30.Length)] := false <== v30[safeIndex(525, v30.Length)];
				...
				if (v0) {
					...
					var v37: map<bool, map<int, C6>> := map[v1[safeIndex(p0, |v1|)] := v36];
					var v38 := DC0(v31, p0, v32, true);
					v34[safeIndex(110, v34.Length)] := if (v38.cf3 in v37) then v37[v38.cf3] else v36;
					v34[safeIndex(110, v34.Length)] := v36;
					var v39: C1 := new C1(f25);
					var v40: seq<C1> := [v39, v39, v39];
					v40 := v40;
				} else {
					var v41: array<int> := new int[12](i3 => safeDivisionInt(i3, f31));
					var v42: map<int, array<int>> := map[f31 := v41];
					var v43 := DC54(v42);
					v43 := v43;
					var v44: map<int, bool> := map[|"gu"| := true];
					v44 := v44[f31 := cf29];
					globalState.f13 := v30[safeIndex(525, v30.Length)];
					var v45 := DC22(seq(abs(567), i4  => (v1)));
					globalState.f6 := safeModuloInt(p0, (fm81(v45, true, -0x18e, globalState).(cf87 := v23, cf88 := v2)).cf85);
		...
		r0 := -safeModuloInt(f31, p0);
		var v50: array<seq<int>> := new seq<int>[18](i5 => v2[safeIndex(f31, |v2|) := p0] + v2);
		r1 := v50;
		r2 := true;
		var v51: set<int> := {f31, p0, fm49(v0, f31, globalState)};
		var v52 := DC65(map[|v51| := v0], f25);
		r3 := |(if (f25 < (seq(abs(0x38f), i6  => (f25[safeIndex(p0, |f25|)])))) then f25 + v52.cf116 else seq(abs(0x253), i7  => ('c')))|;
	}
}
...
class C8 extends T2 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: bool) {
		...
		v7 := v7[v8[safeIndex(|(set v9 : int | (832 <= v9) && (v9 < -929) :: (v9 - f27))|, |v8|)] := true];
		for i3 := |("dgji" + f25)| to 0x254 {
			globalState.f15 := safeDivisionInt(i3, -f27) >= -f27;
			globalState.f10 := |f25|;
			if (!f26) {
				globalState.f10 := |f25| * f27;
				var v10: array<bool> := new bool[11];
				v10[safeIndex(657, v10.Length)] := p0;
				globalState.f15, globalState.f13, v10[safeIndex(657, v10.Length)] := f26, p0, f26;
				globalState.f10 := f27;
				globalState.f10 := f27;
				var v11: map<bool, int> := map[f26 := f27];
				var v12: map<bool, int> := map[p0 := if (v10[safeIndex(657, v10.Length)] in v11) then v11[v10[safeIndex(657, v10.Length)]] else f27];
				var v13 := 't';
				var v16 := DC4(f30);
				var v18: seq<set<int>> := [f30, {i3}];
				var v19: array<set<int>> := new set<int>[26] [{|f25|, f27}, f30, {f27, |v7|}, set v14 : int | (0x207 <= v14) && (v14 < 0x41) :: (v14 + f27), f30, f30, f30, f30, set v15 : int | (0x2e6 <= v15) && (v15 < 0x11f) :: (safeDivisionInt(v15, f27)), f30, f30, fm20(207, f27, true, v10[safeIndex(657, v10.Length)], globalState), f30, v16.cf13, {i3}, set v17 : int | (187 <= v17) && (v17 < 0x358) :: (safeModuloInt(v17, 523)), f30, {0x32c}, f30, v18[safeIndex(106, |v18|)], f30, f30, f30, f30, f30, f30];
				var v20: map<array<bool>, char> := map[v10 := f25[safeIndex(f27, |f25|)]];
		...
		v27[safeIndex(928, v27.Length)] := v28[safeIndex(-0x36d, |v28|)];
		var v30: map<D2, set<int>> := map[DC4(f30) := set v29 : int | v29 in (seq(abs(-0x341), i4  => (-f27))) :: (safeDivisionInt(v29, 0x2))];
		var v31 := DC4(f30);
		v27[safeIndex(928, v27.Length)] := if (false) then if (v31 in v30) then v30[v31] else set v32 : int | (0x1ca <= v32) && (v32 < -156) :: (v32 - f27) else f30;
		globalState.f15 := p0;
		r0 := !((f27 - f27) != f27);
	}
	method m4(p0: int, p1: map<bool, int>, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool) {
		for i0 := p0 to -p0 {
			...
			if (f26) {
				...
				var v9: array<int> := new int[18] [if (!f26) then p0 else |"odhdyyy"|, f27 * i0, 0x3dd * i0, p0, p0, p0, |f25|, f27, p0, safeModuloInt(if (p0 in v3) then v3[p0] else -f27, 0xff), p0, |v5|, |(v6 + v6)|, p0 - (if (f26 in p1) then p1[f26] else f27), 0x35b, if (p2) then p0 else 32, if (v3 in v8) then v8[v3] else p0, |{p0, f27}|];
				v9[safeIndex(153, v9.Length)] := i0;
				var v10: multiset<array<int>> := multiset{v9, v9, if (f26) then v9 else v9, v9, v9};
				v9[safeIndex(153, v9.Length)], v9, globalState.f15, globalState.f10, globalState.f6 := |(f25 + f25)|, v9, f27 < -f27, f27, if (v9 in v10) then v10[v9] else p0;
				...
				var v15: array<array<int>> := new array<int>[10] [v9, v9, v13[safeIndex(p0, |v13|)], if (p2 in v14) then v14[p2] else v9, v9, v9, v9, v9, v9, v9];
				v12[safeIndex(518, v12.Length)] := v15;
				v12[safeIndex(518, v12.Length)] := new array<int>[23];
			} else {
				var v16: array<set<bool>> := new set<bool>[4];
				var v17: set<bool> := {p2};
				v16[safeIndex(473, v16.Length)] := v17;
				v16[safeIndex(473, v16.Length)] := v17;
				...
				v20, globalState.f6 := v20[fm3(f26, globalState) := true], safeDivisionInt(|f25|, fm21(fm3(true, globalState), f26, f27, globalState)) + safeDivisionInt(p0, p0);
				var v21: seq<int> := [p0, 441];
				var v22 := 's';
				var v23: map<map<int, bool>, map<bool, char>> := map[map[|f30| := f26] := map[p2 := v22]];
				var v24: array<int> := new int[10] [-safeDivisionInt(0xe2, f27), |v20|, v21[safeIndex(p0, |v21|)], p0, f27, |"sde"|, p0, i0, |v23|, p0];
				v24 := v24;
			}
		...
		if (if (p2 in v29) then v29[p2] else f26) {
			...
			var v35: seq<seq<int>> := [[if (|fm23(p0, f27, v31, globalState)| in v34) then v34[|fm23(p0, f27, v31, globalState)|] else p0, p0], seq(abs(0xea), i1  => (f27))];
			v27[safeIndex(512, v27.Length)] := safeModuloInt(0x1b5, |v35|);
			v27[safeIndex(512, v27.Length)] := p0;
			if (!f26) {
				var v36 := new C0();
				v26 := v26;
				globalState.f10, globalState.f15, r1 := fm21(f26, f26, -v27[safeIndex(512, v27.Length)], globalState) - p0, f26, false;
				var v37: multiset<bool> := multiset{if (f26) then f26 else false, f26 ==> p2, !p2};
				v27[safeIndex(512, v27.Length)], globalState.f15, v37 := v27[safeIndex(512, v27.Length)], !p2, (v37 + v37) * (multiset{p2} + fm24(globalState));
				...
				var v47: array<map<bool, bool>> := new map<bool, bool>[5] [v29, (if (f26 in v43) then v43[f26] else v29) + map[p2 := if (v27[safeIndex(512, v27.Length)] in v44) then v44[v27[safeIndex(512, v27.Length)]] else f26], map[f26 := f26], map[p2 := fm4(globalState)], map[f26 := v46.cf3]];
				v47[safeIndex(75, v47.Length)] := v29;
				var v48 := DC3(v26);
				v26, v47[safeIndex(75, v47.Length)], globalState.f15, globalState.f13, v46 := f25[safeIndex(v27[safeIndex(512, v27.Length)], |f25|) := v31] + v48.cf12, map[f26 := f26] + (v29 + v29), p2 <== fm1(p2, globalState), f27 == p0, v46;
				var v49: array<seq<seq<bool>>> := new seq<seq<bool>>[5](i2 => seq(abs(0x130), i3  => ([!f26])));
				var v50: seq<bool> := [f26, p2];
				var v51: map<int, seq<bool>> := map[v27[safeIndex(512, v27.Length)] := v50];
				var v52: seq<seq<bool>> := [v50, v50, if (v27[safeIndex(512, v27.Length)] in v51) then v51[v27[safeIndex(512, v27.Length)]] else v50, v50[safeIndex(|multiset{p0}|, |v50|) := f26], v50];
				var v53: map<int, seq<seq<bool>>> := map[v27[safeIndex(512, v27.Length)] := v52];
				v49[safeIndex(731, v49.Length)] := if (p0 in v53) then v53[p0] else v52;
				v49[safeIndex(731, v49.Length)] := v52;
				r1 := fm4(globalState);
				var v54 := DC13(f26);
				globalState.f6 := f27 - (if (p2) then |fm25(f26, v54.cf29, globalState)| else v27[safeIndex(512, v27.Length)]);
			}
			
			var v55: T1 := new C2(f25);
			var v56: set<T1> := {v55};
			var v57: seq<int> := [0x165, f27, |DC19(v56).cf35|];
			var v58: map<int, seq<int>> := map[v27[safeIndex(512, v27.Length)] := v57];
			v58 := v58[-safeModuloInt(v27[safeIndex(512, v27.Length)], |v26|) := v57 + v57];
		} else {
			var v59: map<int, int> := map[safeModuloInt(p0, fm26(p0, f26, f26, globalState)) := f27 - p0];
			v59 := v59;
			var v60 := new C1("qegkq");
			var v61 := new C4(f27, f26, f27, f25);
			v27[safeIndex(8, v27.Length)] := p0;
			v27[safeIndex(8, v27.Length)] := --safeDivisionInt(v61.f33, f27);
			var v62 := new C5(v26);
		}
		
		var v63: array<bool> := new bool[25](i4 => f26);
		var v64: seq<array<bool>> := [v63];
		var v65 := DC2(|v29|, p2, p0, v64[safeIndex(p0, |v64|)]);
		...
		v68[safeIndex(398, v68.Length)] := v63;
		var v69 := DC53(295);
		v68[safeIndex(398, v68.Length)], r1, v69, v68 := v63, f26, v69.(cf92 := p0), v68;
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		...
		globalState.f6, globalState.f6, v1, globalState.f15 := safeDivisionInt(227, |v3|) + p0, |v4|, v1, f26;
		var v5: seq<int> := [f27];
		var v6: seq<int> := [p0, |v5|, f27];
		var v7: map<int, int> := map[p0 := |f25|];
		var v8 := DC46(f27, |v6|, if (0x2aa in v7) then v7[0x2aa] else |(seq(abs(-0xa8), i1  => ('v')))|, f26);
		var i0 := 0;
		while (!v8.cf81)
			decreases 100 - i0
		{
			...
			if (if (f26) then f26 else f26) {
				...
				v10[safeIndex(849, v10.Length)] := fm4(globalState) <==> f26;
				v10[safeIndex(849, v10.Length)], v10 := f26, v10;
				v10[safeIndex(849, v10.Length)] := f26;
			} else {
				var v11: array<int> := new int[20];
				v11[safeIndex(33, v11.Length)] := 0x170;
				v11[safeIndex(33, v11.Length)] := -(p0 + p0);
				...
				globalState.f6 := if (f26) then p0 else |v15| - v11[safeIndex(33, v11.Length)];
				globalState.f15 := !((f26 || f26) <== !(f26 ==> f26));
				var v16: array<char> := new char[14](i2 => 'y');
				var v17 := 'q';
				v16[safeIndex(580, v16.Length)] := v17;
				v16[safeIndex(580, v16.Length)] := v17;
			}
			...
			v20[safeIndex(925, v20.Length)] := p0 + f27;
			var v21 := "pytdj";
			r1, globalState.f6, v20[safeIndex(925, v20.Length)], v21, v5 := f26, fm59(safeModuloInt(0x2b0, |"orqfpnwrp"|), f26, p0, v21, globalState), f27, fm56(!(p0 == f27), v0 + v0, v18 != v18, globalState), (seq(abs(306), i4  => (-p0))) + v6;
		}
		globalState.f15 := p0 != f27;
		globalState.f10 := (if (f26 in v4) then v4[f26] else f27) - p0;
		var v22 := "vgbsmswsg";
		var v23: seq<string> := [f25];
		var v24: multiset<string> := multiset{v23[safeIndex(p0, |v23|)]};
		var v25: multiset<bool> := multiset{f26};
		var v26: set<bool> := {f26};
		var v27 := 's';
		globalState.f6, globalState.f6, v22 := if (v22 in v24) then v24[v22] else |(v25 - fm57(v26, globalState))|, f27, f25[safeIndex(v6[safeIndex(p0, |v6|)], |f25|) := v27];
		globalState.f10 := p0;
		var v28: array<D0> := new D0[8](i5 => DC0(v4, 968, 'y', f26));
		var v29: seq<array<D0>> := [v28, v28, v28];
		r0 := v29;
		var v30: seq<bool> := [true];
		r1 := p0 >= safeModuloInt(|v30|, p0);
		var v31: multiset<int> := multiset{p0, f27};
		r2 := (multiset{p0})[|multiset{|v30|}| := abs(|v2|)] in (multiset(seq(abs(0x39a), i6  => (multiset{f27, p0}))) * multiset{v31});
		r3 := (v25 - v25) - v25;
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			v0[safeIndex(480, v0.Length)] := v4;
			var v5: map<int, int> := map[|[p0]| := |v2|];
			v0[safeIndex(480, v0.Length)] := v4[|v5| := abs(-0xc)] - v4;
			var v6 := 'c';
			...
			r3 := |v13|;
			v7[safeIndex(731, v7.Length)] := v10;
			v7[safeIndex(731, v7.Length)] := v11;
		}
		if (f26) {
			...
			v14, v15, globalState.f13 := v14, v15, (multiset(v16))[f27 := abs(|f25|)] > v19;
			if (fm1(if (f26) then f26 else f26, globalState)) {
				var v20: array<char> := new char[22](i1 => v15);
				v20[safeIndex(535, v20.Length)] := v15;
				v20[safeIndex(535, v20.Length)] := v15;
				r2 := |f25| >= 0x1df;
				var v21: array<D3> := new D3[1];
				v21[safeIndex(412, v21.Length)] := DC9(f25, v14, false);
				var v22 := DC9(f25, v14, fm1(f26, globalState));
				v21[safeIndex(412, v21.Length)] := v22.(cf25 := v14, cf26 := f26);
			...
			v35[safeIndex(745, v35.Length)] := f26;
			v34, globalState.f10, v35[safeIndex(745, v35.Length)], globalState.f10 := v34, |f25| - |f25|, p0 == -v16[safeIndex(f27, |v16|)], safeDivisionInt(safeModuloInt(f27, p0), f27);
			r0 := (f27 * f27) * f27;
			var v36: set<bool> := {v35[safeIndex(745, v35.Length)]};
			var v37 := DC42(seq(abs(0x13e), i5  => (|"agvifq"|)));
			var v38: array<seq<int>> := new seq<int>[16] [v16, seq(abs(-975), i4  => (p0)), v16, v16, [if (-p0 in v17) then v17[-p0] else f27, -0x2f6], v16, v16[safeIndex(|v36|, |v16|) := p0], v37.cf72, v16 + v16, seq(abs(0x205), i6  => (|map[f26 := DC27(v35[safeIndex(745, v35.Length)])]|)), v16 + v16, v16, v16, v16, v16, seq(abs(601), i7  => (f27))];
			v38[safeIndex(988, v38.Length)] := v16;
			v38[safeIndex(988, v38.Length)] := v16;
		} else {
			r0 := p0;
			r0 := p0;
			...
			var v44: array<int> := new int[16] [f27, |(fm52(f26, f26, v39, globalState))[safeIndex(|v40|, |fm52(f26, f26, v39, globalState)|) := -f27]|, |v43|, p0, v41.f33 * v41.f33, v41.f33, f27, safeDivisionInt(f27, p0), f27, p0, f27, safeModuloInt(v41.f33, f27), f27, 0x3cb, f27, safeModuloInt(p0, f27)];
			v44[safeIndex(63, v44.Length)] := 849;
			v44[safeIndex(901, v44.Length)] := v41.f33;
			v44[safeIndex(63, v44.Length)], v41.f33, v44[safeIndex(901, v44.Length)], globalState.f13 := if (f26) then 0x55 else p0 + -f27, safeDivisionInt(safeDivisionInt(f27, f27), safeDivisionInt(f27, -0x24)), if (f25 <= f25) then f27 else -0x306, f26;
			r0 := v44[safeIndex(63, v44.Length)];
			globalState.f15 := f26;
		}
		...
		var v58: array<int> := new int[12] [p0, f27, fm26(p0, f26, f26, globalState), --|(f25 + (if (f27 in v53) then v53[f27] else f25))|, p0, f27, safeDivisionInt(p0, p0), f27 - |v55|, fm26(|f25|, f26, f26, globalState), -563, if (f26) then -(if (v56 in v57) then v57[v56] else p0) else p0, f27 * f27];
		r2, v49, globalState.f6, v52, v58 := f26, v49, |f30|, {v51, v51, v51 - v51}, v58;
		var v59: T0 := new C0();
		var v60: set<T0> := {v59, v59};
		var v61: array<set<T0>> := new set<T0>[1] [v60];
		v61[safeIndex(909, v61.Length)] := v60;
		v61[safeIndex(909, v61.Length)] := v60;
		r2 := f26;
		r0 := f27;
		var v62: seq<int> := [-f27];
	...
	method m10(p0: bool, p1: char, p2: array<bool>, globalState: GlobalState) returns (r0: int, r1: set<bool>, r2: bool, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			if (p0) {
				p2[safeIndex(465, p2.Length)] := f26;
				p2[safeIndex(465, p2.Length)] := f26;
				var v1: multiset<int> := multiset{f27};
				var v2: seq<multiset<int>> := [v1, v1];
				var v3: array<bool> := new bool[16](i1 => p2[safeIndex(465, p2.Length)]);
				globalState.f10 := fm38(v2, map[fm1(f26, globalState) := v3] != map[p2[safeIndex(465, p2.Length)] := v3], globalState);
				var v4 := "lkibsxc";
				v4 := v4;
				var v5: map<char, bool> := map['o' := !p0];
				var v6, v7, v8, v9 := v0.m13(f27 != f27, safeModuloInt(f27, -f27), f26, v5, globalState);
				var v10: seq<bool> := [!false, f26];
				var v11: map<int, int> := map[0x5e := f27];
				p2[safeIndex(465, p2.Length)] := v10[safeIndex(if (v9) then |f25| else |v11|, |v10|)];
			} else {
				var v12 := "tusfb";
				var v13 := 'i';
				var v14: array<int> := new int[13];
				v14[safeIndex(67, v14.Length)] := f27;
				var v15: set<bool> := {f26};
				v12, v13, globalState.f10, v14[safeIndex(67, v14.Length)] := v12[safeIndex(|v15|, |v12|) := v13] + ("pewmc" + f25), p1, 0x2dd, f27;
				v14[safeIndex(67, v14.Length)] := f27;
				globalState.f10 := v14[safeIndex(67, v14.Length)];
				var v16: seq<array<int>> := [v14, v14];
				v14[safeIndex(67, v14.Length)] := |((v16 + [v14]) + v16)|;
				globalState.f15 := f26;
			}
			
			var v17: array<int> := new int[15];
			v17[safeIndex(715, v17.Length)] := f27;
			v17[safeIndex(715, v17.Length)] := f27;
			globalState.f10 := safeModuloInt(|f25|, v17[safeIndex(715, v17.Length)]);
		}
		globalState.f13 := f26;
		var i2 := 0;
		while (p0)
			...
			decreases 100 - i4
		{
			...
			var v25: array<string> := new string[23] [f25, f25, f25, seq(abs(0xfe), i5  => ('r')), "qpxwa", f25, f25, f25, f25, seq(abs(-858), i6  => (p1)), f25, if (f26 in v24) then v24[f26] else "n", seq(abs(0x2cc), i7  => (p1)), f25, f25, f25, "fopr", seq(abs(335), i8  => (p1)), f25, f25, f25, f25, seq(abs(0x3ac), i9  => (p1))];
			...
			if (p0) {
				...
				v27[safeIndex(612, v27.Length)] := if (f26) then v28 else fm23(f27, f27, p1, globalState);
				v27[safeIndex(612, v27.Length)] := v28;
				p2[safeIndex(745, p2.Length)] := p0;
				p2[safeIndex(745, p2.Length)] := p0;
				globalState.f10 := f27;
				...
				var v32 := DC62(v29);
				v31 := v31[v30[safeIndex(0xb2, |v30|) := v32] := |"md"| * f27];
				globalState.f10 := 0x30;
			} else {
				var v33: array<char> := new char[12](i11 => p1);
				v33[safeIndex(302, v33.Length)] := p1;
				...
				v35[safeIndex(824, v35.Length)] := |v36|;
				var v37: multiset<int> := multiset{-f27, f27};
				var v38: seq<multiset<int>> := [v37];
				var v39 := DC46(|[f27, f27]|, f27, f27, p0);
				globalState.f10, r0, v33[safeIndex(302, v33.Length)], v35[safeIndex(824, v35.Length)], globalState.f10 := 144, safeDivisionInt(fm38(v38, p0, globalState) - v39.cf79, if (p0) then |f25| else f27), p1, -f27, safeModuloInt(-200, f27);
				var v40: array<multiset<int>> := new multiset<int>[29];
				v40, globalState.f6, f30 := v40, v35[safeIndex(824, v35.Length)], if (p0) then f30 else f30;
				v35[safeIndex(824, v35.Length)] := if (v33[safeIndex(302, v33.Length)] in v34) then v34[v33[safeIndex(302, v33.Length)]] else v35[safeIndex(824, v35.Length)];
				var v41: map<string, string> := map[f25 := f25];
				globalState.f10 := |v41|;
				globalState.f10 := if (fm3(f26, globalState)) then v35[safeIndex(824, v35.Length)] else v35[safeIndex(824, v35.Length)];
			}
			
			var v42: array<int> := new int[19];
			v42[safeIndex(401, v42.Length)] := f27;
			v42[safeIndex(401, v42.Length)] := f27;
			var v43 := new C1("atf");
		}
		var v44: array<int> := new int[16](i13 => safeDivisionInt(i13, f27));
	...
	method m11(p0: array<bool>, globalState: GlobalState) returns (r0: bool, r1: int, r2: int, r3: int) {
			...
			decreases 100 - i0
		{
			...
			v2[safeIndex(19, v2.Length)] := -f27 - f27;
			var v3 := DC40(f27);
			v2[safeIndex(19, v2.Length)], r0, globalState.f10, r0 := |(f25 + f25)|, f26, v3.cf70, f26;
			p0[safeIndex(38, p0.Length)] := 0x37d > v2[safeIndex(19, v2.Length)];
			var v4 := DC7(f27, f27, v2[safeIndex(19, v2.Length)], f26, f25);
			var v5: seq<bool> := [!f26];
			var v6: seq<bool> := [v4.cf21, v5[safeIndex(v2[safeIndex(19, v2.Length)], |v5|)]];
			p0[safeIndex(38, p0.Length)] := v6[safeIndex(f27, |v6|)];
			var v8 := 'e';
			var v9: set<char> := {v8};
			var v10 := DC66(map v7 : char | v7 in v9 :: (v7) := (f26));
			var v11: seq<int> := [v2[safeIndex(19, v2.Length)]];
			var v12: map<int, int> := map[|multiset{|v11|, v2[safeIndex(19, v2.Length)]}| := |v5|];
			...
			decreases 100 - i1
		{
			...
			v22[safeIndex(714, v22.Length)] := v20;
			v22[safeIndex(714, v22.Length)] := (map[f27 := 310])[0xad := f27 * |v0|];
			var v23: seq<int> := [f27];
			var v24: map<bool, bool> := map[f26 := f26];
			var v25: array<seq<int>> := new seq<int>[19] [[|"rvi"|, f27], v23[safeIndex(|v24|, |v23|) := f27], v23, v23, v23, seq(abs(0x251), i2  => (f27)), v23, v23, v23, v23, v23, v23, v23, v23, v23[safeIndex(f27, |v23|) := |f30|], v23, v23, v23, v23];
			var v26 := DC25(v25);
			match (v26) {
				case DC26(cf47, cf48, cf49, cf50, cf51) =>
					var v27: seq<bool> := [cf49];
					globalState.f15 := true || (|v27| == f27);
					v22[safeIndex(714, v22.Length)] := v22[safeIndex(714, v22.Length)][cf48 := cf50];
					var v28: map<int, map<int, int>> := map[f27 := v22[safeIndex(714, v22.Length)]];
				...
				case DC27(cf52) =>
					...
					v36[safeIndex(329, v36.Length)] := v34;
					v36[safeIndex(329, v36.Length)] := v34;
					r1 := --(f27 + v23[safeIndex(f27, |v23|)]);
					var v37: map<bool, int> := map[f26 := f27];
					r2 := fm21(cf52, true, if (f27 in v22[safeIndex(714, v22.Length)]) then v22[safeIndex(714, v22.Length)][f27] else if (true in v37) then v37[true] else fm49(f26, f27, globalState), globalState);
				case DC28(cf53, cf54) =>
					var v38: seq<seq<int>> := [seq(abs(993), i4  => (|v0|)), [f27], v23];
					r3, globalState.f20, v20 := f27, v23, map[0x30d := 963] + (map[|(v38[safeIndex(f27, |v38|)])[safeIndex(f27, |v38[safeIndex(f27, |v38|)]|) := f27]| := |cf53|] + v20);
					...
					v40 := v40[seq(abs(-0xc6), i5  => ('a')) := safeDivisionInt(f27, 0x3b)];
					globalState.f15 := f27 >= fm21(f26, f26, |f30|, globalState);
				case DC25(cf46) =>
					var v41: array<int> := new int[9];
					v41[safeIndex(684, v41.Length)] := f27;
					var v42: map<string, seq<int>> := map[f25 := v23];
					v41[safeIndex(684, v41.Length)] := safeDivisionInt(-|v42|, f27);
					v41[safeIndex(684, v41.Length)] := v41[safeIndex(684, v41.Length)];
					p0[safeIndex(370, p0.Length)] := f26;
					p0[safeIndex(370, p0.Length)] := !false;
					globalState.f15 := true;
				case DC29(cf55) =>
					globalState.f6 := safeDivisionInt(f27 + |[v23, v23, v23]|, f27);
					r2 := f27;
					var v43: map<int, string> := map[f27 := f25 + f25];
					v43 := v43[f27 := f25];
					var v44: array<array<bool>> := new array<bool>[5];
					var v45: seq<array<array<bool>>> := [v44];
					var v46 := DC49(v45[safeIndex(f27, |v45|)]);
					v44 := v46.cf84;
			}
			
		}
		var v47 := 'o';
		if (v47 !in (seq(abs(0xc3), i6  => (v47)))) {
			var v48: seq<bool> := [f26, if (|[false]| in v0) then v0[|[false]|] else f26, f26];
			globalState.f13 := !((f25 != f25) ==> (if (f26) then v48[safeIndex(f27, |v48|)] else f26));
			globalState.f13 := !(|(if (f26) then f25 else seq(abs(-0x1b3), i7  => (v47)))| == f27);
			...
			globalState.f13 := v48[safeIndex(-safeModuloInt(0x1fe, f27), |v48|)];
			...
			var v56: seq<int> := [-f27];
			var v57 := DC42(v56);
			match (if (v55[safeIndex(f27, |v55|)]) then v57 else v57) {
				case DC43(cf73, cf74, cf75) =>
					...
					globalState.f13 := f26;
					var v61 := new C4(-|[f26, f26, f26]|, v59 > v59, |(seq(abs(0x267), i8  => (v47)))|, "rkyr");
				case DC42(cf72) =>
					var v62 := "oi";
					v62 := f25 + "typy";
					var v63 := new C1(v62);
					...
					var v66: array<int> := new int[24] [f27, f27, f27, f27, |v62|, f27, f27, f27, 0x17e, |"cu"|, f27, f27, f27, f27, f27, f27, f27, f27, |{|v64|, |multiset{f27}|}|, f27, |fm36(f27, globalState)|, 0x3ab, -f27, |f25[safeIndex(|v65|, |f25|) := v47]|];
					var v67: multiset<array<int>> := multiset{v66};
					var v68: seq<string> := [f25, v62];
					var v69: seq<multiset<int>> := [multiset{f27}, v64, v64, v64, v64];
					var v70: multiset<map<int, bool>> := multiset{fm62(|v67|, f27, v68[safeIndex(f27, |v68|)], fm38(v69, f26, globalState), globalState)};
					globalState.f15 := multiset{f27, |v70|, f27} < (v64 * (multiset{f27})[476 := abs(f27)]);
					p0[safeIndex(254, p0.Length)] := f26;
					var v71: map<char, bool> := map[v47 := f26];
					var v72 := DC41(v64);
					var v73: map<int, multiset<int>> := map[f27 := v72.cf71];
					globalState.f13, p0[safeIndex(254, p0.Length)], v71, r2 := f26, v73 == ((map v74 : int | v74 in v64 :: (safeDivisionInt(v74, v56[safeIndex(f27, |v56|)])) := (multiset{-484})) + map[-634 := v64]), (v71 + v71)[v47 := f26], f27 * 0x2a6;
				case DC44(cf76) =>
					...
					v78[safeIndex(659, v78.Length)] := f27;
					...
					var v87: array<seq<char>> := new string[9] [v85.cf24, v81.f25 + (if (-v75.f31 in v86) then v86[-v75.f31] else [v47, v47]), f25, f25, f25, f25, f25, v81.f25[safeIndex(-v75.f31, |v81.f25|) := v47], v81.f25];
					v87[safeIndex(933, v87.Length)] := v81.f25;
					var v88: map<string, bool> := map[seq(abs(581), i9  => (v47)) := f26];
					v78[safeIndex(659, v78.Length)], globalState.f13, v84, v87[safeIndex(933, v87.Length)] := safeModuloInt(v75.f31, |v88|) + 0x2b0, f26, (map[v78 := v83])[v78 := v83], [v47, v81.f25[safeIndex(v75.f31, |v81.f25|)], v47];
					p0[safeIndex(149, p0.Length)] := f26 && f26;
					p0[safeIndex(149, p0.Length)] := f26;
					var v89 := new C2(f25);
			}
			
			if (v55[safeIndex(f27, |v55|)]) {
				...
				r0 := f26;
				var v95: array<seq<set<bool>>> := new seq<set<bool>>[28](i10 => seq(abs(0x21b), i11  => ({!f26, f26, f26, f26})));
				var v96: set<bool> := {f26, true};
				var v97: seq<set<bool>> := [v96, v96];
				v95[safeIndex(946, v95.Length)] := v97;
				v95[safeIndex(946, v95.Length)] := v97;
			} else {
				var v98 := DC18(f26);
				...
				v99[safeIndex(860, v99.Length)] := f27;
				var v100: multiset<int> := multiset{|v55|};
				v99[safeIndex(860, v99.Length)], globalState.f6, globalState.f15, r3 := |fm55(if (f27 in v100) then v100[f27] else f27, f26, if (!f26) then f26 else true, globalState)|, f27, !!f26, f27;
			...
			if (f26 ==> f26) {
				p0[safeIndex(515, p0.Length)] := f26 <==> !f26;
				var v104: multiset<bool> := multiset{f26};
				p0[safeIndex(515, p0.Length)], v104, r1 := fm4(globalState) && f26, DC50(f27, f25, fm24(globalState), v56, f26).cf87 + (v104 * multiset{f26, f26}), f27;
				var v105: C1 := new C1(f25);
				var v106: multiset<map<C1, bool>> := multiset{map[v105 := f26]};
				var v107 := DC43(multiset{!f26, p0[safeIndex(515, p0.Length)]}, |v106|, f27);
				var v108 := DC44(DC44(v107));
				globalState.f6 := -|map[v108 := !f26]|;
				var v109 := "dn";
				var v110: array<string> := new string[9];
				v110[safeIndex(112, v110.Length)] := "axotqrafp";
				var v111: C0 := new C0();
				var v112: seq<C0> := [v111];
				var v113: set<string> := {v109};
				v109, v110[safeIndex(112, v110.Length)], p0[safeIndex(515, p0.Length)], v111, r1 := v109, (fm25(p0[safeIndex(515, p0.Length)], p0[safeIndex(515, p0.Length)], globalState))[safeIndex(f27, |fm25(p0[safeIndex(515, p0.Length)], p0[safeIndex(515, p0.Length)], globalState)|) := v47], f26, v112[safeIndex(f27 * f27, |v112|)], fm58(v113, p0[safeIndex(515, p0.Length)], globalState);
				var v114: set<bool> := {f26};
				globalState.f10 := if (p0[safeIndex(515, p0.Length)]) then f27 else |(v114 * v114)|;
				var v115: map<int, int> := map[f27 := f27];
				var v116 := DC50(f27, v110[safeIndex(112, v110.Length)], v104, v56, !f26);
				...
				globalState.f13, globalState.f6, v47 := p0[safeIndex(515, p0.Length)], 362, v110[safeIndex(112, v110.Length)][safeIndex(|(v118 * v118[f27 := abs(|v119|)])|, |v110[safeIndex(112, v110.Length)]|)];
			} else {
				var v120: T0 := new C0();
		...
		if (f26) {
			...
			var v128 := DC37(v127[safeIndex(f27, |v127|)]);
			...
			if (fm2(|f25|, f26, true, globalState) in f25) {
				...
				var v137: seq<string> := [fm63(!f26, |(map v133 : D11 | v133 in (map v134 : D11 | v134 in v136 :: (v134) := (|[f26, f26]|)) :: (v133) := (f27))|, f27, true, globalState), f25, seq(abs(0x6d), i13  => (v47))];
				...
				var v143: array<int> := new int[11] [-f27, f27, f27, -|v137|, f27, f27, |v139|, -(|(seq(abs(638), i14  => ('n')))[safeIndex(|v140|, |(seq(abs(638), i14  => ('n')))|) := v47]| - |v141|), |v142|, f27, f27];
				v143[safeIndex(390, v143.Length)] := f27;
				v143[safeIndex(390, v143.Length)] := f27;
				p0[safeIndex(892, p0.Length)] := true;
				p0[safeIndex(892, p0.Length)] := f26;
				var v144: array<bool> := new bool[4];
				v144 := if (f26) then v144 else v144;
				var v145: map<bool, bool> := map[f26 := f26];
				var v146: map<bool, int> := map[if (f26 in v145) then v145[f26] else true := -v143[safeIndex(390, v143.Length)]];
				var v147 := DC0(v146, f27, v47, f26);
				globalState.f6 := (v147.(cf0 := v146, cf1 := v143[safeIndex(390, v143.Length)], cf2 := v47)).cf1;
			} else {
				globalState.f6, globalState.f6 := f27, f27;
				globalState.f15 := f26 !in ([f26, false, true, f26])[safeIndex(f27, |[f26, false, true, f26]|) := f26];
				...
				v151[safeIndex(353, v151.Length)] := |v152|;
				v151[safeIndex(353, v151.Length)] := f27;
			}
			
			p0[safeIndex(686, p0.Length)] := f26;
			p0[safeIndex(686, p0.Length)], globalState.f15, globalState.f10, r3 := f26, f26, 0x26f, f27;
			...
			var v160 := DC32(f27, true, p0[safeIndex(686, p0.Length)], v158, |[f26]|);
...
class C9 extends T2 {
	...
	method m4(p0: int, p1: map<bool, int>, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool) {
		for i0 := p0 to p0 {
			...
			globalState.f15 := v0 in (f25 + (seq(abs(0x36d), i1  => (v0))));
			globalState.f13 := p2;
		}
		globalState.f10 := p0;
		var i2 := 0;
			...
			decreases 100 - i2
		{
			...
			if (if (p2) then p2 else v6 == v6) {
				...
				var v9: seq<bool> := [f26];
				v7 := ((map v8 : int | (-0x29c <= v8) && (v8 < 528) :: (safeDivisionInt(v8, f27)) := (f26)) + v3.fm12(p0, |v9|, globalState)) + v7;
				var v10: seq<int> := [p0];
				...
				v6 := (v20[safeIndex(0xcc, |v20|)])[f26 := abs(p0)];
				globalState.f6 := -p0;
				var v21 := 'w';
				var v22: multiset<char> := multiset{v21};
				var v23 := DC3(f25);
				var v24: map<string, int> := map[v23.cf12 := if (f26) then f27 else 0x30c];
				globalState.f6, v22, v24, globalState.f10 := safeModuloInt(f27, |f25|), v22, map["jq" := f27], f27;
				var v25 := DC11(v3);
		...
		if (f27 > (|v34| - f27)) {
			...
			v35[safeIndex(78, v35.Length)] := |v37|;
			var v38 := 'i';
			v35[safeIndex(78, v35.Length)] := DC0(fm15(globalState), p0, v38, p2).cf1;
			globalState.f6 := f27 - v35[safeIndex(78, v35.Length)];
			var v39: array<bool> := new bool[25];
			v39[safeIndex(889, v39.Length)] := !f26;
			v39[safeIndex(889, v39.Length)] := f26;
			var v40 := new C0();
		} else {
			var v41 := 'c';
		...
		for i4 := if (|multiset(v50)| in v34) then v34[|multiset(v50)|] else p0 to -0xd5 {
			...
			if ((v50 + v50) < (if (f25 in v51) then v51[f25] else [i4])) {
				...
				v53[safeIndex(908, v53.Length)] := !(f26 && p2);
				v53[safeIndex(908, v53.Length)] := f26;
			} else {
				...
				v55 := v56[safeIndex(v58.cf18, |v56|)];
				globalState.f6, globalState.f6 := safeDivisionInt(f27 - f27, v58.cf19), -|(seq(abs(0x129), i5  => (p0)))[safeIndex(--0x1fe, |(seq(abs(0x129), i5  => (p0)))|) := i4]|;
		...
		r0 := match v72 {
			...
			case DC4(cf13) => v50 + v50[safeIndex(f27, |v50|) := 0x16c]
		};
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			v5[safeIndex(975, v5.Length)] := v11.cf0;
			var v12: seq<bool> := [f26];
			v5[safeIndex(975, v5.Length)] := v6[f26 := |v12|] + fm15(globalState);
			v2[safeIndex(507, v2.Length)] := p0 - p0;
			globalState.f13, r1, globalState.f15, v2[safeIndex(507, v2.Length)] := f26 <== (f26 <== f26), f26, f26 || f26, f27;
			var v13: array<bool> := new bool[24];
			v13[safeIndex(967, v13.Length)] := f26;
			v13[safeIndex(967, v13.Length)] := !f26 !in ([f26, f26, fm1(f26, globalState)] + v12);
		}
		...
		if (v17.cf7) {
			...
			var v21 := 'l';
			r2, r1, globalState.f13, globalState.f13 := ([f27] + v18) != (v18 + ([f27])[safeIndex(|v19|, |[f27]|) := if (f26 in v20) then v20[f26] else 621]), true, f27 != -f27, f25[safeIndex(p0, |f25|) := v21] == f25;
			var v22: array<int> := new int[15];
			v22[safeIndex(987, v22.Length)] := f27;
			var v23: map<multiset<bool>, bool> := map[v20 := f26];
			globalState.f15, v22[safeIndex(987, v22.Length)] := [false, f26] == [f26], p0 * |v23|;
			var v24: map<int, seq<int>> := map[v22[safeIndex(987, v22.Length)] - f27 := [f27]];
			v24 := v24[v22[safeIndex(987, v22.Length)] := v18];
			var v25: multiset<array<bool>> := multiset{v15};
			r2 := v25 != v25;
			v15[safeIndex(535, v15.Length)] := f26;
			v15[safeIndex(535, v15.Length)] := !f26;
		} else {
			...
			match (v39) {
				case DC0(cf0, cf1, cf2, cf3) =>
					...
					v44[safeIndex(865, v44.Length)] := v42;
					var v45: seq<C0> := [v42, v42, v42];
					var v46: seq<C0> := [v42, v45[safeIndex(-|fm17(fm2(p0, cf3, f26, globalState), cf3, globalState)|, |v45|)]];
					v44[safeIndex(865, v44.Length)] := v46[safeIndex(p0, |v46|)];
				...
				case DC1(cf4, cf5, cf6, cf7) =>
					globalState.f10 := safeModuloInt(-(f27 + p0), f27);
					var v50: seq<bool> := [!fm14(f26, globalState), cf7];
					globalState.f15 := |v50| >= -f27;
					cf7, globalState.f13, globalState.f6 := cf7, p0 == f27, safeDivisionInt(p0, p0);
				...
				case DC2(cf8, cf9, cf10, cf11) =>
					...
					var v58: array<D3> := new D3[22] [DC10(DC9(f25, v35, cf9)).(cf27 := v54), v55, v55, v55, v55, DC10(v56[safeIndex(|v57|, |v56|)]), DC10(v53), v55, v55, v55, v55, v55, DC10(v52), DC10(v52), DC10(DC10(v53)), v55, v55, v55, v55, v55, v55, v55];
					...
					v62[safeIndex(249, v62.Length)] := v29;
					v62[safeIndex(123, v62.Length)] := v29;
					v35, v62[safeIndex(249, v62.Length)], v62[safeIndex(123, v62.Length)], globalState.f10 := v35, v29, v29, cf8;
					var v63: seq<string> := [f25 + (seq(abs(0x251), i2  => (v62[safeIndex(249, v62.Length)])))];
					v63 := ["dl"] + ([seq(abs(0x2bf), i3  => (v61.cf2)), seq(abs(0x256), i4  => (v29))] + fm18(cf9, cf8, globalState));
			}
			
			var v64 := new C0();
			v35[safeIndex(886, v35.Length)] := p0;
			v35[safeIndex(886, v35.Length)] := f27;
			r1 := v29 !in f25;
		}
		
		var v65: array<int> := new int[4];
		forall i5 | 0 <= i5 < v65.Length {
			v65[i5] := safeDivisionInt(i5, p0);
		}
		var v66: set<array<int>> := {v65};
		r1 := v66 !! v66;
		v15[safeIndex(773, v15.Length)] := f26;
		v15[safeIndex(773, v15.Length)] := true;
		var v67: map<bool, int> := map[v15[safeIndex(773, v15.Length)] := p0];
		var v69 := 's';
		var v70 := DC0(v67, |(set v68 : int | (0x369 <= v68) && (v68 < 513) :: (v68 + 0x288))|, v69, v15[safeIndex(773, v15.Length)]);
		var v71: C0 := new C0();
		var v72: map<C0, bool> := map[v71 := f26];
		var v73: array<D0> := new D0[18] [v70.(cf3 := if (v71 in v72) then v72[v71] else v15[safeIndex(773, v15.Length)]), v70.(cf0 := map[fm1(v15[safeIndex(773, v15.Length)], globalState) := 222]), v70.(cf3 := false).(cf2 := v69), v70, v70, v70, v70, v70.(cf2 := v69), v70, v70, v70, v70, v70, v70, DC0(v67, f27, v69, f26), v70, v70, DC0(v67, f27, v69, f26)];
		var v74: multiset<bool> := multiset{!v15[safeIndex(773, v15.Length)], v15[safeIndex(773, v15.Length)], f26};
		var v75: seq<array<D0>> := [v73];
		r0 := ([v73, v73])[safeIndex(|v74|, |[v73, v73]|) := v75[safeIndex(|map[p0 := f26]|, |v75|)]] + v75;
		r1 := v70.cf3;
		r2 := f26;
		var v76: map<bool, bool> := map[f26 := v15[safeIndex(773, v15.Length)]];
		r3 := (multiset{if (v15[safeIndex(773, v15.Length)] in v76) then v76[v15[safeIndex(773, v15.Length)]] else f26})[v15[safeIndex(773, v15.Length)] := abs(f27)];
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		globalState.f13 := f26;
		...
		var v7 := DC14(v6);
		var v8: map<seq<bool>, multiset<bool>> := map[v0 := if (f26) then v1[f26 := abs(p0)] else v1[f26 := abs(fm13(f26, p0, f26, map[|v2| := v7.cf30], globalState))]];
		v8 := v8 + v8;
		var v9: T2 := new C4(|v2|, fm14(f26, globalState), |multiset{p0, p0}|, seq(abs(0x171), i0  => (v5)));
		var v10: set<T2> := {v9};
		v10 := v10;
		for i1 := f27 to p0 {
			...
			if (f26) {
				...
				var v15: array<string> := new seq<char>[7] [seq(abs(876), i2  => (v5)), v9.f25, v9.f25 + v9.f25, if (v9.f26) then "khphfqbhx" else f25, fm29(!v9.f26, v3, map[map[f26 := v9.f27] := -|f25|], globalState) + f25, fm29(v9.f26, fm30(v9.f27, fm38(v13, v9.f26, globalState), false, globalState), v14, globalState) + f25, f25 + v9.f25];
				v15[safeIndex(188, v15.Length)] := v9.f25 + v9.f25;
				v15[safeIndex(188, v15.Length)] := v9.f25;
				...
				globalState.f10, r2 := v19[safeIndex(v9.f27, |v19|)], ({f27} <= v20) <== (v9.f26 || v9.f26);
				var v21: array<bool> := new bool[26](i3 => v9.f26);
				v21[safeIndex(385, v21.Length)] := false;
				v21[safeIndex(385, v21.Length)] := f26;
				var v22: array<map<int, bool>> := new map<int, bool>[6](i4 => v2);
				var v23 := DC70(v22);
				var v24: array<array<map<int, bool>>> := new array<map<int, bool>>[29] [v22, v22, if (v21[safeIndex(385, v21.Length)]) then v22 else v22, v22, v22, v22, v22, v23.cf125, v22, v22, v22, v22, if (v9.f26) then v22 else v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22, v22];
				v24[safeIndex(53, v24.Length)] := v22;
				v24[safeIndex(53, v24.Length)] := v22;
				var v25: array<int> := new int[12](i5 => i5 + v9.f27);
				v25[safeIndex(9, v25.Length)] := v9.f27;
				var v26: map<bool, array<int>> := map[f26 := v25];
				var v27 := DC9(v9.f25, v25, v9.f26);
				var v28 := DC37(v21[safeIndex(385, v21.Length)]);
				...
				v29[safeIndex(987, v29.Length)] := v25;
				v25[safeIndex(9, v25.Length)], v29[safeIndex(987, v29.Length)], globalState.f6 := if (true) then i1 else f27, v25, f27;
				globalState.f6 := -v9.f27;
			}
			
			var v30: array<int> := new int[4] [f27, -i1 + i1, f27, |fm83('n', v9.f27, v5, v9.f27, globalState)|];
			v30[safeIndex(799, v30.Length)] := v9.f27;
			v30[safeIndex(799, v30.Length)] := fm26(-v9.f27, f26, -86 == i1, globalState);
			var v31: set<char> := {v5};
			if ((if (f26) then |v31| else |(seq(abs(0x360), i6  => (v5)))|) == |v0|) {
				globalState.f15 := f26;
				globalState.f6 := v9.f27;
				globalState.f15 := !((|v9.f25| >= v30[safeIndex(799, v30.Length)]) || v9.f26);
				var v32 := DC71(v9.f27);
				var v33: array<D29> := new D29[28] [v32, v32, v32, DC71(p0), v32, v32, v32, v32.(cf126 := v30[safeIndex(799, v30.Length)]), v32, v32, v32, DC71(v30[safeIndex(799, v30.Length)]), DC71(v9.f27), v32.(cf126 := i1), DC71(i1), DC71(0x31c), v32, v32, v32, v32, v32, DC71(|f25|), DC71(|v1|), DC71(0x232), v32, v32, v32, v32];
				v33[safeIndex(995, v33.Length)] := v32;
				v33[safeIndex(995, v33.Length)] := v32.(cf126 := p0);
				var v34: array<bool> := new bool[3];
				v34 := v34;
			} else {
				v30[safeIndex(799, v30.Length)] := 0x25a;
				var v35: array<bool> := new bool[18];
				v35[safeIndex(404, v35.Length)] := v9.f26;
				v35[safeIndex(404, v35.Length)] := fm1(v9.f26, globalState);
				var v36: seq<int> := [p0];
				var v37 := DC42(v36);
				var v38 := DC44(v37);
				v38 := v38;
				...
				v30[safeIndex(799, v30.Length)] := |v39|;
			}
		...
		var v41: seq<map<bool, int>> := [v40[safeIndex(0x1ca, |v40|)], v3];
		v2 := v2[|v41[safeIndex(v9.f27, |v41|)]| - v9.f27 := true];
		r0 := v9.f27;
	...
	method m8(p0: seq<bool>, p1: string, p2: char, globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := f27 + fm21(true, fm1(true, globalState), fm49(f26, f27, globalState), globalState) to |v1.cf30| {
			var v2 := "weohger";
			v2 := (fm63(true, -safeDivisionInt(i0, f27), f27 + i0, f26, globalState))[safeIndex(0x203, |fm63(true, -safeDivisionInt(i0, f27), f27 + i0, f26, globalState)|) := fm2(i0, f26, f26, globalState)];
			...
			var v7: map<seq<bool>, map<int, bool>> := map[(p0[safeIndex(i0, |p0|) := false])[safeIndex(f27, |p0[safeIndex(i0, |p0|) := false]|) := f26] := fm62(|v6|, f27, "b", f27, globalState)];
			var v8: array<bool> := new bool[21] [fm14(!!p0[safeIndex(i0, |p0|)], globalState), f26, f26, f26, f26, if (|(if ([f26] in v7) then v7[[f26]] else v5)| in v5) then v5[|(if ([f26] in v7) then v7[[f26]] else v5)|] else f26, false, f26, f26, f26, true, f26, f26, f26, f26, f26, f26, !!f26, f26, fm14(f26, globalState), f26];
			var v9: map<array<bool>, char> := map[v8 := p2];
			var v10 := DC1(v4, v8, v9, f26);
			v3[safeIndex(729, v3.Length)] := v10;
			v3[safeIndex(729, v3.Length)] := v10.(cf5 := v8);
			var v11 := new C2(p1[safeIndex(i0, |p1|) := p2] + v2);
			var v12: map<bool, string> := map[f26 := v2];
			var v13: array<map<bool, string>> := new map<bool, string>[9] [v12, v12, v12, v12, v12, v12, v12, if (f26) then map[f26 := seq(abs(0x1bd), i1  => (p2))] else v12, v12[true := f25] + v12];
			v13[safeIndex(949, v13.Length)] := v12;
			v13[safeIndex(949, v13.Length)] := v12;
		}
			...
			decreases 100 - i2
		{
			...
			var v18 := 'l';
			v16, globalState.f15, v17, v18 := v16 + fm69(globalState), p0[safeIndex(f27, |p0|)], p0, p2;
			var v19: array<array<bool>> := new array<bool>[25];
			v19 := v19;
			var v20: seq<int> := [f27];
			var v21 := DC7(|multiset(v20)|, f27, f27, f26, f25);
			var v22: map<int, bool> := map[f27 := f26];
			globalState.f6 := safeDivisionInt((v21.(cf20 := |v22|)).cf19 + f27, fm26(--0xe9, f26, f26, globalState));
			v18 := p1[safeIndex(-f27, |p1|)];
		}
		var v23: array<D7> := new D7[15](i3 => DC20(f26, p2));
		var v24 := DC20(true, 'q');
		v23[safeIndex(359, v23.Length)] := v24;
		v23[safeIndex(359, v23.Length)], globalState.f15 := v24, fm3(f26, globalState);
		globalState.f15 := !!f26;
		...
		match (v28) {
			case DC26(cf47, cf48, cf49, cf50, cf51) =>
				...
				var v33: set<T2> := {v32};
				v29[safeIndex(321, v29.Length)] := |v33|;
				v29[safeIndex(321, v29.Length)] := cf50;
				var v34 := v32.m3(!f26, globalState);
			case DC27(cf52) =>
				var v35: array<int> := new int[27];
				v35[safeIndex(97, v35.Length)] := f27;
				...
				v35[safeIndex(97, v35.Length)] := if (v38 in v39) then v39[v38] else if (cf52) then f27 else f27;
				var v40 := new C0();
				globalState.f15 := f26;
				var v41: set<multiset<bool>> := {v36};
				var v42: array<set<multiset<bool>>> := new set<multiset<bool>>[4] [v41, v41, v41, v41];
				v42[safeIndex(127, v42.Length)] := v41;
				var v43: map<int, array<int>> := map[v35[safeIndex(97, v35.Length)] := v35];
				...
				var v48 := "v";
				var v49: multiset<int> := multiset{|multiset(v37[safeIndex(76, |v37|)])|};
				var v50 := DC73(v47);
				var v51: seq<array<array<int>>> := [v47, v50.cf128, v50.cf128];
				var v52 := DC3(v48);
				globalState.f10, v42[safeIndex(127, v42.Length)], v47, v48 := if (v35[safeIndex(97, v35.Length)] > 0x2a2) then v35[safeIndex(97, v35.Length)] else if (f26) then f27 else |v49|, v41 * v41, v51[safeIndex(safeDivisionInt(v35[safeIndex(97, v35.Length)], -21), |v51|)], v52.cf12;
			case DC28(cf53, cf54) =>
				var v53: array<D5> := new D5[9];
				var v54 := DC15(f27);
				v53[safeIndex(30, v53.Length)] := v54;
				v53[safeIndex(30, v53.Length)] := if (f26) then v54 else v54;
				...
				v56[safeIndex(242, v56.Length)] := v61;
				v56[safeIndex(242, v56.Length)] := v61;
			...
			case DC25(cf46) =>
				...
				v66[safeIndex(28, v66.Length)] := v67;
				v66[safeIndex(28, v66.Length)] := v67;
				globalState.f6 := safeDivisionInt(f27, -f27);
				var v68: array<map<int, C4>> := new map<int, C4>[4];
				v68 := new map<int, C4>[11];
			case DC29(cf55) =>
				var v69: multiset<char> := multiset{p2, p2};
				var v70 := new C7(if (p2 in v69) then v69[p2] else f27, seq(abs(0x28a), i6  => (p2)));
				...
				var v77: array<int> := new int[25] [-v70.f31, v70.f31, -f27, f27, |p1| - 0x10d, v70.f31, f27, 0x391, v70.f31, 0x191, safeModuloInt(v70.f31, f27), |v71[safeIndex(f27, |v71|)]|, f27, f27, v70.f31, (v72.(cf126 := f27)).cf126, safeDivisionInt(f27, v70.f31), |v75|, -v70.f31, if (false) then v70.f31 else 0x11f, safeModuloInt(f27, -99), f27, v70.f31, v76[safeIndex(-f27, |v76|)], f27];
				v77 := v77;
				globalState.f13 := f26;
	...
	method m9(p0: bool, p1: set<bool>, p2: C0, globalState: GlobalState) returns (r0: array<map<bool, bool>>, r1: bool, r2: array<seq<bool>>) {
		...
		v1[safeIndex(313, v1.Length)] := !false;
		var v2: seq<bool> := [p0, f26];
		var v3: seq<int> := [f27];
		v1[safeIndex(313, v1.Length)] := v2[safeIndex(|(if (!f26) then v3 else v3)|, |v2|)];
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			r1 := v2[safeIndex(f27, |v2|)];
			var v4: multiset<bool> := multiset{p0, !f26};
			var v5: map<array<bool>, int> := map[v1 := |(fm24(globalState) - v4)|];
			v5 := if (false) then v5 else v5;
			var v6: array<multiset<int>> := new multiset<int>[26](i1 => multiset{v3[safeIndex(f27, |v3|)]});
			var v7: multiset<int> := multiset{f27};
			v6[safeIndex(170, v6.Length)] := v7;
			var v8 := DC41(v7);
			v6[safeIndex(170, v6.Length)] := v8.cf71;
		}
		...
		v10 := v10;
		var v11 := 'b';
		var v12: map<int, char> := map[fm21(v1[safeIndex(313, v1.Length)], v2[safeIndex(|f25|, |v2|)], f27, globalState) := v11];
		v11 := if (-f27 in v12) then v12[-f27] else v11;
		var v13: map<bool, bool> := map[f26 := p0];
		var v14: array<map<bool, bool>> := new map<bool, bool>[9] [v13, v13 + (map[v1[safeIndex(313, v1.Length)] := f26])[v1[safeIndex(313, v1.Length)] := f26], v13[v1[safeIndex(313, v1.Length)] := f26] + v13, v13, map[v1[safeIndex(313, v1.Length)] := v2[safeIndex(|f25|, |v2|)]], v13 + fm84(p0, globalState), v13, v13, v13 + v13];
		r0 := v14;
		r1 := true;
...
class C10 extends T1 {
	...
	function fm3(p0: bool, globalState: GlobalState): bool {
		!(if (false) then (seq(abs(0x282), i0  => (DC0(map[!true := f29], |DC3(f28).cf12|, 'u', !!false).cf2))) <= f25 else if (false) then true else true)
	}
	...
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		var v0 := true;
		globalState.f15 := v0;
		var v1: map<bool, string> := map[!v0 := seq(abs(669), i0  => ('t'))];
		var v2 := 'i';
		...
		var v8: array<string> := new string[21] ["ajd", f28, if (v0 in v1) then v1[v0] else (fm7(p0, globalState))[safeIndex(p0, |fm7(p0, globalState)|) := v2], (f25 + f28)[safeIndex(if (v0 in v3) then v3[v0] else f29, |(f25 + f28)|) := 'd'], f28, f25 + f25, f25, f25, f28, "bqwepnt", "hrxtxx", f25, seq(abs(-366), i1  => (v2)), f25 + f28, f25 + "ah", fm7(p0, globalState), (seq(abs(0x326), i2  => (v2)))[safeIndex(if (p0 in v5) then v5[p0] else |map[v6[safeIndex(-231, |v6|)] := v0]|, |(seq(abs(0x326), i2  => (v2)))|) := v2], f28, if (v0) then "odegeel" else f28, f28[safeIndex(f29, |f28|) := 'w'], f28 + f28[safeIndex(v7.cf1, |f28|) := v2]];
		v8 := v8;
		...
		var v12 := DC2(p0, v0, 0x18d, v11[safeIndex(|f28|, |v11|)]);
		match (v12) {
			case DC0(cf0, cf1, cf2, cf3) =>
				var v13: seq<int> := [cf1];
				var v14: seq<int> := [|v5|, f29, p0, |v13|];
				globalState.f6 := safeModuloInt(safeDivisionInt(cf1, v14[safeIndex(cf1, |v14|)]), |cf0|);
				var v15: array<set<array<bool>>> := new set<array<bool>>[5];
				var v16: set<array<bool>> := {v10, v10};
				v15[safeIndex(594, v15.Length)] := v16;
				var v17: map<int, bool> := map[fm9(cf3, f29, cf1, -|(seq(abs(0x19a), i5  => (cf2)))|, globalState) := v0];
				var v18: multiset<map<int, bool>> := multiset{v17, v17};
				v15[safeIndex(594, v15.Length)], v14, globalState.f13 := v16, fm8(p0 > cf1, cf2, v18, v0 ==> cf3, globalState), v0;
				v10 := v10;
				globalState.f13 := v0;
			case DC1(cf4, cf5, cf6, cf7) =>
				if (cf7) {
					...
					v27 := v27[cf7 := v28[safeIndex(|f25|, |v28|)]];
				} else {
					var v29: T0 := new C0();
					v29 := if (cf7) then v29 else v29;
					r2 := cf7;
					var v30: array<char> := new char[15] [v2, v2, v2, 'i', v2, v2, v2, v2, v2, v2, 'j', v2, 'b', fm2(p0, !cf7, v0, globalState), f28[safeIndex(0xbe, |f28|)]];
					v30 := new char[16];
					var v31: seq<bool> := [cf7];
					var v32: array<int> := new int[10] [|v31|, p0 - 0x160, -p0, |v5| + f29, safeDivisionInt(p0, p0), p0, p0, p0, f29, safeDivisionInt(f29, p0)];
					v32[safeIndex(493, v32.Length)] := p0;
					var v33: set<seq<bool>> := {v31};
					v32[safeIndex(493, v32.Length)] := -|(v33 * v33)|;
					v32[safeIndex(493, v32.Length)] := (v32[safeIndex(493, v32.Length)] * p0) - f29;
				}
				...
				if (cf7) {
					...
					var v42 := DC3(f25);
					var v43: seq<D1> := [v42];
					v41 := (v41 + v41)[safeIndex(if (v0) then f29 else |v43|, |(v41 + v41)|) := false];
				} else {
					v10 := cf5;
					...
					var v54 := DC79(v52);
					var v55: array<array<T2>> := new array<T2>[23] [v52, v52, if (false) then v52 else v52, v52, v53[safeIndex(p0, |v53|)], v52, v52, v52, v52, v52, v52, v52, v52, if (cf7) then v52 else v52, v52, v52, v52, v52, v52, v52, v53[safeIndex(v50.f27, |v53|)], v52, v54.cf136];
					v55 := v55;
					var v56: array<T0> := new T0[6];
					var v57: T0 := new C0();
					v56[safeIndex(209, v56.Length)] := v57;
					globalState.f6, f29, v0, v56[safeIndex(209, v56.Length)] := |v4|, p0, !(fm26(v50.f27, v50.f26, cf7, globalState) == f29), v57;
					v34[safeIndex(685, v34.Length)] := |f28|;
					v34[safeIndex(685, v34.Length)] := -((v50.f27 * v50.f27) - fm49(cf7, p0, globalState));
				}
			...
			case DC2(cf8, cf9, cf10, cf11) =>
				...
				var v60 := DC55(|v3|, |(seq(abs(0x1d4), i6  => (|{cf9, cf9}|)))|, cf8);
				...
				v63[safeIndex(112, v63.Length)] := safeModuloInt(p0, p0);
				v63[safeIndex(112, v63.Length)] := f29;
			...
			decreases 100 - i7
		{
			...
			i7 := i7 + 1;
			var v66: array<int> := new int[13](i8 => safeDivisionInt(i8, f29));
			v66[safeIndex(313, v66.Length)] := f29;
			v66[safeIndex(313, v66.Length)] := safeDivisionInt(safeModuloInt(-|(seq(abs(0x13e), i9  => (|f28|)))|, f29), f29);
			var v67: array<D26> := new D26[9];
			var v68 := DC24(v66, v0);
			var v69: seq<D8> := [v68, v68];
			var v70 := DC63(v69);
			v67[safeIndex(63, v67.Length)] := v70;
			v67[safeIndex(63, v67.Length)] := v70;
			...
			if (if (!v0) then fm6(v75, !v0, v0, v73, globalState) else true) {
				...
				globalState.f10, globalState.f10, v76, globalState.f15 := --v74, safeModuloInt(-v74, fm9(v0, if (fm21(v0, v0, v74, globalState) in v77) then v77[fm21(v0, v0, v74, globalState)] else v66[safeIndex(313, v66.Length)], 381, f29, globalState)), v76, v0;
				...
				var v85: T2 := new C8(v84, v0, v66[safeIndex(313, v66.Length)], f25);
				var v86: array<T2> := new T2[12] [v85, v85, v85, v85, v85, v85, v85, v85, v85, v85, v85, v85];
				var v87 := DC79(v86);
				v83[safeIndex(193, v83.Length)] := map[v87 := false];
				var v88 := DC33(v66[safeIndex(313, v66.Length)]);
				var v89: map<int, set<bool>> := map[v88.cf63 := {v0} - {v0}];
				var v90: map<int, set<array<int>>> := map[v85.f27 := v82];
				v82, v83[safeIndex(193, v83.Length)], globalState.f10, v66[safeIndex(313, v66.Length)], v89 := if (v66[safeIndex(313, v66.Length)] in v90) then v90[v66[safeIndex(313, v66.Length)]] else v82, map[v87 := !v0 && v85.f26], p0, v85.f27, v89;
				v73 := 0x14f;
			} else {
				var v91 := DC15(v74);
				var v92: set<int> := {v91.cf31, v74, v74};
				var v93 := new C8(v92, fm26(v74, v0, v0, globalState) >= v73, |[v73, v66[safeIndex(313, v66.Length)], v73]|, seq(abs(792), i11  => (v2)));
				var v94: array<array<int>> := new array<int>[9];
				var v95 := DC28(seq(abs(498), i12  => (v2)), f28[safeIndex(|v72|, |f28|) := v2]);
				var v96 := new C3(v94, v95.cf54);
				var v97: map<bool, bool> := map[v0 := v0];
				var v98: map<int, int> := map[--0x247 := |v97[v0 := v0]|];
				v10[safeIndex(181, v10.Length)] := v98 != v98;
				v10[safeIndex(181, v10.Length)] := v93.fm4(globalState);
				var v99: array<bool> := new bool[9];
				var v100: seq<set<bool>> := [{v0, v0, v0, v10[safeIndex(181, v10.Length)], v7.cf3}];
				v2, globalState.f13, v99, v100, v10[safeIndex(181, v10.Length)] := v2, "v" == v71, if (v10[safeIndex(181, v10.Length)]) then v99 else v99, v100 + v100, DC46(-|f28[safeIndex(0x105, |f28|) := v2]|, |v3|, 14, v0).cf81;
				var v101 := DC33(v66[safeIndex(313, v66.Length)]);
		...
		r1 := v5 > (multiset{0x2af})[f29 := abs(f29)];
		var v105: set<string> := {f28};
		r2 := safeDivisionInt(fm58(v105, v0, globalState), p0) >= (|v4| * p0);
		var v106: seq<multiset<bool>> := [v4, v4, multiset{v0}];
		r3 := v106[safeIndex(p0, |v106|)] * v4;
	}
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		globalState.f10 := p0;
		...
		r2 := v0[p0 := abs(f29)] > v0[f29 := abs(|v2[safeIndex(f29, |v2|)]|)];
		var v3: array<bool> := new bool[7](i0 => v1);
		v3[safeIndex(881, v3.Length)] := !v1;
		v3[safeIndex(881, v3.Length)] := v1;
		v3[safeIndex(881, v3.Length)] := !v1;
		forall i1 | 0 <= i1 < v3.Length {
			v3[i1] := if (v1) then v1 else v3[safeIndex(881, v3.Length)];
		}
		var v4 := 'o';
		...
		r1 := v9[safeIndex(f29, |v9|)];
		r2 := f29 in (map[p0 := v1] + v5);
		r3 := safeDivisionInt(|"pbikue"|, p0);
	}
	method m6(p0: bool, p1: int, p2: multiset<bool>, p3: bool, globalState: GlobalState) returns (r0: int) {
		...
		var v1: seq<bool> := [p0];
		if (if (p3) then !v1[safeIndex(p1, |v1|)] else p0) {
			var v2 := m0(globalState);
			var v3: array<bool> := new bool[24](i1 => !p0);
			var v4: seq<array<bool>> := [v3, v3, v3, v3];
			var v5: map<seq<array<bool>>, int> := map[v4 := safeModuloInt(f29, f29)];
			var v6: set<bool> := {p0, fm1(false, globalState), p0, p0};
			v5 := v5[v4 := |v6|];
			f28 := f28;
			f28 := f28;
			var v7: array<int> := new int[17](i2 => safeModuloInt(i2, p1));
			var v8: set<array<int>> := {v7, v7};
			globalState.f13 := v8 !! v8;
		} else {
			var v9: map<bool, int> := map[p0 := f29];
			var v10 := 'd';
			var v11: array<seq<char>> := new string[18] [f28, f25[safeIndex(if (p0 in v9) then v9[p0] else f29, |f25|) := v10], f28, f25[safeIndex(f29, |f25|) := v10], seq(abs(0x3a0), i3  => (v10)), f25, f25, (seq(abs(701), i4  => (v10)))[safeIndex(-p1, |(seq(abs(701), i4  => (v10)))|) := v10], f25, f28, f25, f25, seq(abs(0x273), i5  => (v10)), f25, f25, f28, f25, seq(abs(-0x21), i6  => (v10))];
			...
			if (if (p3 in v16) then v16[p3] else p3) {
				...
				v18 := v18;
				globalState.f15 := !p0;
				v13 := (v13[safeIndex(|v13|, |v13|) := f29] + v13[safeIndex(|v13|, |v13|) := 0xce]) + v13;
				...
				v14 := |v22[safeIndex(-|(v1 + v1[safeIndex(f29, |v1|) := p3])|, |v22|)]|;
			} else {
		...
		if (p0) {
			...
			var v44: array<bool> := new bool[15] [p3, p3, p0, v43.cf7, p3, p0, !fm3(!p3, globalState), f28 == (seq(abs(205), i7  => (v42))), p3, !p0, p0, f28 <= f25, !p0 || p3, p3, v38 !! v38];
			v44[safeIndex(289, v44.Length)] := p3;
			v44[safeIndex(289, v44.Length)] := p3;
			globalState.f13 := v1[safeIndex(f29, |v1|)];
			var v45 := DC37(p0);
			var v46: map<D13, int> := map[v45 := -p1];
			v46 := v46[v45 := p1];
			v44[safeIndex(289, v44.Length)] := fm3(v38 !! v38, globalState);
			var v47: map<bool, bool> := map[p0 := p3];
			var v48: array<map<bool, bool>> := new map<bool, bool>[12] [v47, v47, v47, v47, v47, v47, v47, v47, map[p0 := v44[safeIndex(289, v44.Length)]], v47, v47, v47];
			...
			v52[safeIndex(351, v52.Length)] := p2;
			var v53: array<string> := new string[3];
			v53[safeIndex(964, v53.Length)] := f25;
			v53[safeIndex(514, v53.Length)] := seq(abs(-0x1fc), i8  => ('q'));
			var v54: map<int, int> := map[0x24c := f29];
			var v55 := DC14(v54 + v54);
			var v56: map<int, multiset<bool>> := map[f29 := p2];
			globalState.f15, v52[safeIndex(351, v52.Length)], v53[safeIndex(964, v53.Length)], v53[safeIndex(514, v53.Length)], v55 := false, if (f29 in v56) then v56[f29] else p2, (f28 + f25) + f25, (f28 + f28[safeIndex(p1, |f28|) := fm2(0x237, p3, false, globalState)]) + "kgoi", v55;
			var v57: array<array<bool>> := new array<bool>[8];
			v57 := v57;
			var v58: array<bool> := new bool[11] [p0, p3, p3, p3, p3, v1[safeIndex(f29, |v1|)], p3, p0, p3, p0, p3];
		...
		v63, globalState.f13 := v65[safeIndex(f29, |v65|)], false && (v67 != v67);
		globalState.f10 := safeDivisionInt(f29, -0x4a);
		var i9 := 0;
		while (p3)
			decreases 100 - i9
		{
			...
			if (p3) {
				...
				globalState.f6 := |(multiset{p3} - multiset(v1))| * |(v1 + (v68[safeIndex(0x338, |v68|)])[safeIndex(0x34b, |v68[safeIndex(0x338, |v68|)]|) := p0])|;
				var v69 := 'n';
				f28 := (f25[safeIndex(f29, |f25|) := v69] + "ldkpcdjtk") + (f28 + f28);
				...
				var v80 := DC32(f29, p0, p3, fm53(p0, DC26(multiset{f29}, -0x4, v1[safeIndex(-f29, |v1|)], f29, true), -0x104, |v79|, globalState), f29);
				...
				var v85: array<int> := new int[17] [p1, |v61|, |v77|, f29, if (v61 in v78) then v78[v61] else -f29, if (v80 in v81) then v81[v80] else f29, f29 * 66, f29, 0x254, p1, |(v62.cf88 + v61)|, |['j']|, f29, f29, -p1, safeDivisionInt(|v83|, f29), -(if (v61 in v84) then v84[v61] else f29)];
				v85[safeIndex(186, v85.Length)] := 0x2d3;
				v85[safeIndex(186, v85.Length)], v79 := f29, v79 - v79;
			}
	...
	method m7(p0: bool, p1: array<seq<char>>, globalState: GlobalState) returns (r0: string, r1: seq<int>, r2: int, r3: int) {
			...
			decreases 100 - i0
		{
			...
			v2[safeIndex(278, v2.Length)] := |fm31(globalState)|;
			v2[safeIndex(278, v2.Length)] := --f29;
			globalState.f15 := p0;
			var v3: seq<bool> := [p0];
			if (if (p0) then p0 else !v3[safeIndex(f29, |v3|)]) {
				...
				v6 := v6;
				f29 := f29;
				var v7 := DC53(v2[safeIndex(278, v2.Length)]);
				var v8: multiset<int> := multiset{v2[safeIndex(278, v2.Length)]};
				...
				var v13 := DC23(v11, |v3|, v2[safeIndex(278, v2.Length)], v2[safeIndex(278, v2.Length)]);
				var v14 := DC60(p0, f29, v2[safeIndex(278, v2.Length)], DC19(v12), v13);
				v14 := v14;
				var v15: map<bool, int> := map[p0 := |[p0, !!p0]|];
				var v16: seq<int> := [v2[safeIndex(278, v2.Length)], |v15|];
				var v17: map<int, int> := map[v2[safeIndex(278, v2.Length)] := f29];
				var v18: map<int, int> := map[551 := v16[safeIndex(|v17|, |v16|)] + v2[safeIndex(278, v2.Length)]];
				v17 := v17 + (v17 + v18);
				var v19: map<int, string> := map[v2[safeIndex(278, v2.Length)] := f25];
				v0[safeIndex(986, v0.Length)] := v2[safeIndex(278, v2.Length)] in v19;
				var v20 := DC51([f28, f25]);
				var v21: multiset<D19> := multiset{v20};
				v0[safeIndex(986, v0.Length)] := v21 >= v21;
		...
		globalState.f15 := !p0;
		var v23: C1 := new C1(seq(abs(0x337), i2  => ('l')));
		var v24 := DC82(v23);
		var v25: array<C1> := new C1[10] [v23, v23, v23, v23, v23, v23, v24.cf141, v23, v23, v23];
		v25[safeIndex(875, v25.Length)] := v23;
		v25[safeIndex(875, v25.Length)], r0 := v23, f25;
		r0 := f28;
...
class C11 extends T2 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: bool) {
		...
		var v4 := new C3(v3, seq(abs(0x210), i2  => ('h')));
		v2[safeIndex(734, v2.Length)] := f27;
		v2[safeIndex(734, v2.Length)] := f27;
			...
			decreases 100 - i3
		{
			...
			var v9: map<int, bool> := map[v2[safeIndex(734, v2.Length)] := p0];
	...
	method m4(p0: int, p1: map<bool, int>, p2: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool) {
		...
		var v3: map<string, map<int, bool>> := map[f25 := v1[safeIndex(f27, |v1|)] + (if (p0 in v2) then v2[p0] else v0[p0 := p2])];
		var v4 := DC85(v3);
		v3 := v4.cf144;
		var i0 := 0;
		while (p0 > p0)
			decreases 100 - i0
		{
			...
			var v13: multiset<map<int, array<bool>>> := multiset{map[f27 := if (p2 in v10) then v10[p2] else v9], v11, v12[safeIndex(p0, |v12|)], v11};
			...
			match (v14) {
				case DC86(cf145, cf146) =>
					...
					var v18: seq<array<bool>> := [v17[safeIndex(f27, |v17|)], v9, v9];
					var v19 := 'j';
				...
				case DC87(cf147, cf148, cf149, cf150, cf151) =>
					...
					v0, v23, globalState.f6, globalState.f6, globalState.f15 := v0, v24[safeIndex(cf151, |v24|)], if (v23 in v25) then v25[v23] else -p0, |v5|, cf148 || p2;
					var v26: array<D3> := new D3[26];
					var v27: array<int> := new int[3] [p0, -|[f26, cf148]|, cf150];
					var v28 := DC9(v23, v27, f26);
					v26[safeIndex(247, v26.Length)] := v28;
					v26[safeIndex(247, v26.Length)] := v28;
					globalState.f6, v23, globalState.f13 := cf151, "fan" + (if (p2) then f25 else v23), p2;
				case DC88(cf152) =>
					v9[safeIndex(391, v9.Length)] := f26;
					v9[safeIndex(391, v9.Length)] := !!p2;
					var v29 := 'a';
					...
					var v34: array<array<int>> := new array<int>[17] [v31, v31, v31, v31, v31, v32[safeIndex(f27, |v32|)], v31, v31, v31, v31, v31, v31, v31, v31, if (f26 in v33) then v33[f26] else v31, v31, v31];
					...
					var v40: map<map<seq<int>, int>, bool> := map[v39 := v9[safeIndex(391, v9.Length)]];
					var v42: set<seq<int>> := {v6};
					v40 := v40[map v41 : seq<int> | v41 in v42 :: (v41) := (if (p0 in cf152) then cf152[p0] else 0x25d) := f26];
				case DC85(cf144) =>
					v9[safeIndex(125, v9.Length)] := p2;
					v9[safeIndex(125, v9.Length)] := fm1(p2 !in v8, globalState);
					var v43 := "mpb";
					var v44 := DC3(f25);
					v43 := (v44.cf12 + v43) + f25;
					var v45: T1 := new C6(p1, seq(abs(634), i2  => ('o')));
					var v46: seq<T1> := [v45];
					var v47: set<seq<T1>> := {[v46[safeIndex(p0, |v46|)], v45, v45]};
					...
					var v50: map<char, bool> := map[f25[safeIndex(0x261, |f25|)] := if (p1 in v49) then v49[p1] else f26];
					var v51 := 'r';
					v50 := v50[v51 := f26];
			}
			
			globalState.f13 := (f27 * f27) != |v6|;
			v9[safeIndex(0, v9.Length)] := f26;
			v9[safeIndex(0, v9.Length)] := if (f26) then false else p0 == f27;
		}
		if (f26 !in map[p2 := -13]) {
			var v52: T0 := new C0();
			...
			if (v53 != (set v56 : int | v56 in v55 :: (safeDivisionInt(v56, DC33(-59).cf63)))) {
				var v57: seq<set<int>> := [v53];
				var v58: multiset<bool> := multiset{!f26, fm1(f26, globalState)};
				var v59 := 'u';
				var v60: array<int> := new int[13] [|(v57[safeIndex(p0, |v57|)] * v53)|, safeModuloInt(p0, f27), if (fm3(f26, globalState) in v58) then v58[fm3(f26, globalState)] else f27, fm9(p2, f27, f27, f27, globalState), p0, f27, f27, p0, p0, f27, f27, p0 - p0, |f25[safeIndex(f27, |f25|) := v59]|];
				v60 := v60;
				var v61, v62, v63 := m5(globalState);
				v60[safeIndex(204, v60.Length)] := safeModuloInt(|fm24(globalState)|, p0);
				var v64 := "ptmpjjacc";
				var v65 := DC13(f26);
				var v66: map<bool, bool> := map[v62 := v61];
				v59, v60[safeIndex(204, v60.Length)], v64, v62, globalState.f13 := v59, fm59(--f27, f26, if (v62) then v63 else f27, f25 + f25, globalState), f25 + f25[safeIndex(f27, |f25|) := v59], v65.cf29, v66 == v66;
				var v67 := new C5("xwmjnryvf");
				var v68: array<bool> := new bool[4](i4 => v62);
				var v69 := DC2(f27, v61, |(seq(abs(0x253), i3  => (v0)))| * f27, v68);
				v69 := if (v62) then v69 else v69;
			} else {
				globalState.f6 := -0x236;
				var v70: array<int> := new int[26];
				var v71: seq<bool> := [false];
				v70[safeIndex(256, v70.Length)] := |v71|;
				v70[safeIndex(256, v70.Length)] := p0;
				var v72 := new C0();
				...
				v75[safeIndex(863, v75.Length)] := !f26;
				v73, globalState.f15, v75[safeIndex(863, v75.Length)], v75 := v73, p2, f26, v75;
				v70 := v70;
			}
			...
			if (v79 >= v79) {
				...
				v84[safeIndex(493, v84.Length)] := v78;
				globalState.f6, v84[safeIndex(493, v84.Length)] := p0, 'd';
				var v85: array<bool> := new bool[27];
				v85[safeIndex(843, v85.Length)] := !f26;
				var v86: seq<set<string>> := [{"efk", f25, f25, "liw", f25}];
				v85[safeIndex(843, v85.Length)] := !(fm58(v86[safeIndex(p0, |v86|)], p2, globalState) > (p0 - |v2|));
			} else {
				var v87: array<int> := new int[1](i5 => safeDivisionInt(i5, p0));
				v87[safeIndex(61, v87.Length)] := -f27;
				var v88 := "rrtulkls";
				...
				var v94: array<bool> := new bool[20] [false, f27 <= |map[[p2, f26] := f26]|, v91 != v91, if (v92 in v93) then v93[v92] else f26, f26, f26, fm4(globalState), p2, p2, f25[safeIndex(f27, |f25|) := v78] < v88, f26, f26, fm3(p2, globalState), p2, p2, !p2, v88 <= f25, p2, fm3(f26, globalState), false];
				var v95: seq<bool> := [p2];
				var v96: set<bool> := {fm1(p2, globalState)};
				v94[safeIndex(202, v94.Length)] := v95[safeIndex(|v96|, |v95|)];
				var v97: seq<int> := [f27];
				globalState.f10, v87[safeIndex(61, v87.Length)], v88, v94[safeIndex(202, v94.Length)] := v97[safeIndex(safeModuloInt(f27, f27), |v97|)], -0x341, f25, p2;
				globalState.f6 := 0x1f8 * f27;
				var v98: T0 := new C0();
				var v99: map<T0, int> := map[v98 := f27 + 0x2f5];
				v99 := v99;
				var v100 := m0(globalState);
				var v101 := new C4(f27, p2, 0x1b4, (seq(abs(0x12e), i6  => (v78))) + f25);
			}
			...
			var v115: array<int> := new int[27] [254, p0 + f27, p0, |f25|, -p0, p0, -p0, f27 + f27, |v102|, p0 + f27, f27, -f27 + |(if (v105 in v106) then v106[v105] else "fld")|, |v108| - p0, |v109|, v105.f27, p0, p0, v105.f27, p0, f27, f27, v105.f27, v114[safeIndex(f27, |v114|)], -0x3df, |(v105.f25 + (seq(abs(0x2f4), i7  => (v78))))|, if (!p2) then f27 else v105.f27, safeModuloInt(f27, f27)];
			v115[safeIndex(356, v115.Length)] := safeDivisionInt(v105.f27, |v0|);
			var v116: multiset<bool> := multiset{v105.f26};
			v115[safeIndex(356, v115.Length)] := fm21(p2, f26, |v116|, globalState);
			globalState.f6 := v103.f31;
			globalState.f13 := fm3(v105.f26, globalState);
			if (|{true, v105.f26}| >= v105.f27) {
				v113 := v113[|v108| := f27];
				r1, v0, v115[safeIndex(356, v115.Length)] := v114 <= v114, v0, v103.f31;
				var v117 := DC46(v103.f31, safeDivisionInt(|"ea"|, v103.f31), v105.f27, f26);
				v117 := v117;
				...
				var v122 := DC88(v121[safeIndex(v105.f27, |v121|)]);
				var v123 := DC14(v113);
				...
				globalState.f10 := -safeDivisionInt(|v109| - v103.f31, 0x1c3);
				var v127: array<string> := new string[10](i8 => v105.f25);
				var v128: array<array<string>> := new array<string>[3] [v127, v127, v127];
				v128[safeIndex(533, v128.Length)] := v127;
				v128[safeIndex(533, v128.Length)] := v127;
				v115[safeIndex(356, v115.Length)] := v105.f27;
				v128[safeIndex(533, v128.Length)] := v127;
			}
			...
			decreases 100 - i9
		{
			...
			var v130 := 'q';
			v129[safeIndex(952, v129.Length)] := fm8(p2, v130, multiset{v0}, f26, globalState);
			...
			v129[safeIndex(952, v129.Length)] := v135;
		...
		v137[safeIndex(561, v137.Length)] := v141;
		v137[safeIndex(561, v137.Length)] := v141;
		...
		var v146: C3 := new C3(v144, fm56(f26, v0, v145[safeIndex(|map[p0 := f27]|, |v145|)], globalState));
		v137[safeIndex(561, v137.Length)][safeIndex(966, v137[safeIndex(561, v137.Length)].Length)] := p2;
		var v147: seq<int> := [p0];
		globalState.f6, globalState.f13, v146, v137[safeIndex(561, v137.Length)][safeIndex(966, v137[safeIndex(561, v137.Length)].Length)] := f27, "juvosft" <= f25, v146, match DC50(f27, seq(abs(-818), i10  => ('b')), multiset{f26, f26, v146.fm48(p0, p2, p0, --0x163, globalState)}, v147[safeIndex(p0, |v147|) := f27], p2) {
			case DC50(cf85, cf86, cf87, cf88, cf89) => cf87 >= cf87
			case DC49(cf84) => p2
		};
		r0 := v147;
		r1 := v137[safeIndex(561, v137.Length)][safeIndex(966, v137[safeIndex(561, v137.Length)].Length)] && f26;
	}
	method m1(p0: int, globalState: GlobalState) returns (r0: seq<array<D0>>, r1: bool, r2: bool, r3: multiset<bool>) {
		r2 := f26;
		globalState.f10 := safeDivisionInt(p0, f27);
		...
		var v6: seq<D9> := [v5, DC28(seq(abs(707), i1  => (v1)), f25)];
		var v7 := DC89(v6);
		r1 := match v7 {
	...
	method m2(p0: int, globalState: GlobalState) returns (r0: int, r1: array<seq<int>>, r2: bool, r3: int) {
		...
		var v5: seq<bool> := [f26];
		var v6: array<bool> := new bool[23] [f26, f26, !f26, f26, f26, f26, f27 != |v0|, !(if (f26) then f26 else f26), f26, f26, f26, f26, (v2.(cf158 := if (f26 in v3) then v3[f26] else p0)).cf155, f26, f26, if (f26) then f26 else f26, v4 > v4, fm4(globalState), f26, if (f26) then true else f26, true, v5[safeIndex(p0, |v5|)], f26];
			...
			decreases 100 - i1
		{
			...
			var v12 := DC32(f27, true, f26, v11[safeIndex(p0, |v11|)], 600);
		...
		globalState.f13 := f26;
		globalState.f13 := "sotrk" <= (seq(abs(-0x33e), i2  => (v20)));
		r0 := f27;
		var v22: array<seq<int>> := new seq<int>[2](i3 => [f27, p0, f27]);
		r1 := v22;
		r2 := p0 >= p0;
		r3 := safeModuloInt(f27, f27);
	}
	method m5(globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v7: array<int> := new int[21] [v0.f31, if (f26) then -v0.f31 else |multiset{f27}|, |DC14(v3).cf30|, safeModuloInt(f27, -0x2c9), f27, safeModuloInt(f27, v0.f31), v0.f31, f27, safeDivisionInt(v0.f31, fm59(f27, f26, fm49(f26, -v0.f31, globalState), f25, globalState)), fm9(f26, -f27, v0.f31, |v4|, globalState), safeDivisionInt(|v3|, f27), 0x184, safeDivisionInt(f27, f27), v0.f31, v0.f31 + --v0.f31, f27, f27, v6.cf20, if (f26) then |f25| else f27, v0.f31, -v0.f31];
		v7[safeIndex(28, v7.Length)] := safeModuloInt(v0.f31, v0.f31);
		v1, v7[safeIndex(28, v7.Length)] := v1, fm26(789, f26, f26, globalState);
		...
		v15 := v15 + (seq(abs(0x17), i0  => (v4)))[safeIndex(f27, |(seq(abs(0x17), i0  => (v4)))|) := v4];
		var v16: C4 := new C4(if (|v4| in v3) then v3[|v4|] else |f25|, !f26, f27, "xxrguu");
		v16, v7[safeIndex(28, v7.Length)] := v16, |(v3 + v3)|;
		...
		var v23: seq<seq<int>> := [v18, v18, [f27, v7[safeIndex(28, v7.Length)]], v18, fm8(f26, v1, v22, f26, globalState)];
		r0 := (v19 < multiset(v23)) ==> false;
		var v24: multiset<bool> := multiset{!f26, f26};
		r1 := !f26 ==> (multiset{f26} !! v24);
		r2 := v7[safeIndex(28, v7.Length)];
	}
}
...
function fm8(p0: bool, p1: char, p2: multiset<map<int, bool>>, p3: bool, globalState: GlobalState): seq<int> {
	([---0x3cb] + (seq(abs(-0x33), i0  => (|[|"wlyhesmb"|]|)))) + ([-568, 580, |[|multiset([|map[|multiset{|(set v0 : int | v0 in map[|{0x1ac}| := false] :: (v0 + |multiset{!false}|))|, 882}| := |[false]|]|])|, |multiset{|map['j' := false]|}|]|] + [-|{|multiset{false, false, false}|}|, |map[false := -|"meksab"|]|])
}
...
function fm10(p0: multiset<bool>, p1: int, globalState: GlobalState): multiset<map<bool, bool>> {
	multiset((seq(abs(-232), i0  => (map[true := true]))) + ([map[false := true]] + (seq(abs(-494), i1  => (map[true := true])))))
}
...
function fm21(p0: bool, p1: bool, p2: int, globalState: GlobalState): int {
	if (!(false && false)) then |"ngtinuil"| else safeModuloInt(|"pcnt"|, 0x9e)
}
function fm22(p0: bool, p1: bool, globalState: GlobalState): map<char, bool> {
	match DC46(|multiset{false, false}|, |"nytdyytq"|, -0x1ea, false) {
		...
		case DC45(cf77) => map['e' := true] + (map v0 : char | v0 in multiset(seq(abs(987), i0  => ('f'))) :: (v0) := (false))
		case DC47(cf82) => map v1 : char | v1 in (seq(abs(-730), i1  => ('a'))) :: (v1) := (false)
	}
}
...
function fm25(p0: bool, p1: bool, globalState: GlobalState): seq<char> {
	(seq(abs(0x362), i0  => ('f'))) + (seq(abs(626), i1  => ('r')))
}
...
function fm30(p0: int, p1: int, p2: bool, globalState: GlobalState): map<bool, int> {
	map["uytrqk" != "ydngrl" := safeDivisionInt(414, |"elnlooe"|)]
}
...
function fm34(p0: int, p1: bool, p2: int, p3: int, globalState: GlobalState): map<map<int, bool>, char> {
	map[map[|(seq(abs(0x39), i0  => (|(seq(abs(0x3b7), i1  => ('k')))|)))| := false] := 'k'] + (map[map[-0x303 := false] := 'n'] + map[map[-792 := true] := 'w'])
}
...
function fm37(p0: int, p1: char, p2: int, p3: int, globalState: GlobalState): seq<seq<D5>> {
	(if (true) then [[DC16(DC16(DC15(37)))], seq(abs(0xa4), i0  => (DC16(DC16(DC16(DC15(-0x116)))))), [DC16(DC16(DC15(|multiset(seq(abs(0x9a), i1  => (|(seq(abs(286), i2  => ('b')))|)))|)))]] else [[DC16(DC15(|{true}|)), DC16(DC15(|"jwpbewfh"|))], [DC16(DC14(map v0 : int | v0 in [|['l', 'f']|] :: (v0 - |"h"|) := (|[false, true]|)))], [DC16(DC15(|(seq(abs(0xc0), i3  => (|multiset([-0x2f8])|)))|))], [DC16(DC14(map v1 : int | v1 in map[-|{true}| := false] :: (safeDivisionInt(v1, 851)) := (787)))]]) + [[DC16(DC15(|"yxlvqqy"|)), DC16(DC14(map[-|[false, false]| := 0x39d])), DC16(DC14(map[|multiset([DC74(|[0x54, 0x3a, |"bktt"|, |map[false := |{false}|]|]|, 142, 0x88).cf130])| := -0x3de])), DC16(DC15(214))]]
}
function fm38(p0: seq<multiset<int>>, p1: bool, globalState: GlobalState): int {
	safeDivisionInt(--0x211, safeDivisionInt(|{940, |multiset{|[0x179]|}|, 0xcf}|, |map[false := true]|))
}
...
function fm42(globalState: GlobalState): set<int> {
	((set v0 : int | (31 <= v0) && (v0 < 0x177) :: (v0 - 0x2d2)) * {0xf6}) + {|(seq(abs(0x1ac), i0  => ('f')))|, -419, |"ibvgcq"|, -0xab}
}
...
function fm45(p0: int, p1: D14, globalState: GlobalState): seq<int> {
	[--932, 0x121, 0xd, |[-|{false}|, |['t', 'l', 't']|, |"wuaeihi"|]|, |[multiset{-782}]|] + ((seq(abs(0x264), i0  => (0xf5))) + [|"jtrwbq"|, |(seq(abs(0x1be), i1  => ('f')))|, |[!false, true, true]|, |"hfoe"|, 0x1ca])
}
...
function fm47(p0: bool, p1: int, p2: bool, p3: int, globalState: GlobalState): string {
	if (!true) then "cac" + (seq(abs(0x2b4), i0  => ('x'))) else "qgr" + "lsbcnxhkm"
}
...
function fm54(p0: bool, p1: bool, p2: bool, p3: map<int, bool>, globalState: GlobalState): D6 {
	if (!false) then DC18(DC87(seq(abs(830), i0  => (|DC8(map[|"efceihfyl"| := false]).cf23|)), false, multiset{-789}, |[-327]|, |"wj"|).cf148) else DC18(false)
}
...
function fm58(p0: set<string>, p1: bool, globalState: GlobalState): int {
	-|((if (false) then "xmcyjqn" else seq(abs(0x266), i0  => ('d'))) + ("to" + "gyboku"))|
}
function fm59(p0: int, p1: bool, p2: int, p3: string, globalState: GlobalState): int {
	safeModuloInt(|[|[true, !false]|]|, -0x77)
}
...
function fm62(p0: int, p1: int, p2: string, p3: int, globalState: GlobalState): map<int, bool> {
	map[--833 := true] + (map[0x3a3 := true] + map[-|map[false := |map[map[false := --|(map v0 : int | (-0x3a8 <= v0) && (v0 < 677) :: (safeDivisionInt(v0, 0x156)) := (false))|] := true]|]| := !true])
}
...
function fm67(p0: bool, p1: bool, globalState: GlobalState): D9 {
	DC26(multiset{-0x60, 0x141} * multiset{156}, |multiset([!!true, false])| - |{!!false, false}|, !false, safeDivisionInt(-0x158, 0x16), if (false) then false else true)
}
function fm68(globalState: GlobalState): seq<set<bool>> {
	[{true, true} + {true}]
}
function fm69(globalState: GlobalState): seq<map<int, int>> {
	seq(abs(0x31b), i0  => (if (true) then map[|multiset{"iltqawwo", "vksfkxvop"}| := |map[|map[0x12c := |[false, true]|]| := 'y']|] else map[|[--|map[!false := true]|, 0x34c, -0x217]| := |{-937}|]))
}
function fm70(p0: bool, globalState: GlobalState): seq<set<int>> {
	[{0x26e, 0x1f1}] + (seq(abs(0x72), i0  => (set v0 : int | v0 in map[577 := DC12()] :: (v0 * |[0xa0]|))))
}
...
function fm74(globalState: GlobalState): seq<seq<bool>> {
	seq(abs(0x298), i0  => ([false, true] + [!!false]))
}
...
function fm76(p0: int, p1: bool, p2: D13, globalState: GlobalState): map<bool, set<int>> {
	match DC22([[true, true, false]]) {
		...
		case DC24(cf44, cf45) => map[cf45 := {0x185, -|map[seq(abs(-0xab), i0  => ('q')) := |(seq(abs(69), i1  => (|(map v0 : char | v0 in ['x'] :: (v0) := ({cf45}))|)))|]|}]
		case DC22(cf39) => map[true := {|"seoupasgf"|}]
	}
}
function fm77(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): multiset<string> {
	match DC57(0x3ae, |(seq(abs(0x181), i0  => ('p')))|, 0x1fc, 'w', -809) {
		case DC57(cf98, cf99, cf100, cf101, cf102) => multiset{"ywsx"}
		case DC56(cf97) => multiset([seq(abs(-0x74), i1  => ('i'))])
	}
}
function fm78(p0: int, globalState: GlobalState): map<bool, seq<int>> {
	map[(seq(abs(44), i0  => ('o'))) < "kyy" := [|multiset{0x2e6, 0x285, -0x328, --92, 0x347}|, |[true]|] + [0xd9, -0x300]]
}
...
function fm80(p0: int, globalState: GlobalState): D25 {
	if (!(if (false) then true else true)) then DC62(set v0 : string | v0 in map["mcdnquxw" := 0x273] :: (v0)) else DC62({seq(abs(0x1e8), i0  => ('v'))})
}
function fm81(p0: D8, p1: bool, p2: int, globalState: GlobalState): D18 {
	DC50(|map[0x373 := false]| * 0x8, "kfdt", multiset{true, false, true, DC7(|['b']|, |(seq(abs(-0x2fb), i0  => ('w')))|, |(seq(abs(0x33), i1  => (|map[648 := false]|)))|, false, seq(abs(0x219), i2  => ('r'))).cf21, true} + multiset{true}, if (!true) then [|map[672 := true]|, --578] else seq(abs(0x26e), i3  => (196)), multiset{true, false, !false} > multiset{false})
}
function fm82(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): D13 {
	match if (true) then DC57(|map[false := |"cvkcg"|]|, 660, -0x219, 'n', |map[0x91 := true]|) else DC57(|"s"|, 0x1fb, |(seq(abs(0x2c6), i0  => ('c')))|, 'l', |{true}|) {
...
method m0(globalState: GlobalState) returns (r0: int) {
	...
	if (v0) {
		...
		var v11: set<string> := {seq(abs(0x1ca), i0  => ('w')), v7};
		globalState.f13 := v11 >= v11;
		if (v0 || (v9 > v9)) {
			var v12: array<bool> := new bool[10](i1 => v0);
			v12[safeIndex(80, v12.Length)] := !(v9 > |v7|);
			...
			var v22: array<int> := new int[16] [v9, 0x3e3 - v9, v9, v9, safeModuloInt(v9, -v9), safeDivisionInt(v9, |v14|), v9, v9, 0x383, v9 + |v19|, -v9, -0x248, v9, (if (v9 in v21) then v21[v9] else v9) + v9, v9 * -v9, 0xf9 * -v9];
			var v23: multiset<set<bool>> := multiset{{v0, v0, v0}, v20, v20, {v0}};
			v22[safeIndex(628, v22.Length)] := |v23|;
			var v24: multiset<bool> := multiset{v0};
			var v25: set<int> := {v9};
			v12[safeIndex(80, v12.Length)], v22[safeIndex(628, v22.Length)] := true, safeDivisionInt(--(if (v0) then if (false in v24) then v24[false] else |v25| else 192), v9);
			var v26 := new C0();
			v22, v12[safeIndex(80, v12.Length)], v15, v12[safeIndex(80, v12.Length)] := v22, !v12[safeIndex(80, v12.Length)], v15, !v12[safeIndex(80, v12.Length)];
			v22[safeIndex(628, v22.Length)] := v9;
			var v27: array<multiset<int>> := new multiset<int>[8];
			var v28: seq<int> := [v9];
			v27[safeIndex(604, v27.Length)] := multiset{v9, v22[safeIndex(628, v22.Length)], -0x38d, v22[safeIndex(628, v22.Length)], |v28|};
			var v29 := 'o';
			var v30: map<array<bool>, string> := map[v12 := (seq(abs(214), i2  => (v29))) + v7];
			var v31: multiset<int> := multiset{v22[safeIndex(628, v22.Length)]};
			var v32: multiset<int> := multiset{|v24|, v9, v9 - v9, if (v9 in v31) then v31[v9] else |v16|};
			v9, globalState.f13, globalState.f15, v9, v27[safeIndex(604, v27.Length)] := v28[safeIndex(v9, |v28|)], (|[|v7|, v22[safeIndex(628, v22.Length)]]| - |map[v29 := v22[safeIndex(628, v22.Length)]]|) == safeModuloInt(v22[safeIndex(628, v22.Length)], v9), !fm1(v0, globalState), -|v30|, v32;
		} else {
			...
			v37 := v37[v36 := v0];
			globalState.f10 := v9;
			v9 := safeDivisionInt(v9, v9);
			v9 := v9;
		}
		
		var v38: seq<bool> := [v0];
		var v39: seq<int> := [-638];
		var v40 := DC50(v9, seq(abs(0x4f), i3  => ('o')), multiset(v38), v39, v0);
		var v41: seq<string> := [v7 + v7, (v40.(cf89 := v0, cf86 := v7, cf88 := v39)).cf86];
		v41 := seq(abs(0x1c9), i4  => (v7));
	}
	...
	var v52: array<array<multiset<int>>> := new array<multiset<int>>[11] [v50, v50, v50, v50, v50, v50, v50, v51[safeIndex(v42, |v51|)], v50, v50, v50];
	v52[safeIndex(962, v52.Length)] := v50;
	v52[safeIndex(962, v52.Length)] := if (v0) then v50 else v50;
	var v53: seq<bool> := [v0, v0];
	var v54: T0 := new C0();
	var v55: set<int> := {v42, 0x3aa};
	var v56: array<bool> := new bool[23] [v53[safeIndex(|map[v54 := |v55|]|, |v53|)], v0, v0, !v0, v0, v0, true, fm1(true, globalState), v0, !fm1(!v0, globalState), v0, v0, v0, v0, v0, v0, v0, fm1(v0, globalState), v0, v0, v0, v0, false];
	var v57 := "fokuwp";
	var v58: C6 := new C6(map[v0 := v42], v57);
	var v59: map<array<bool>, C6> := map[v56 := v58];
	v59 := v59[v56 := v58];
	var v60: multiset<bool> := multiset{v0};
	var v61: map<bool, bool> := map[DC68(v53[safeIndex(|v60|, |v53|)]).cf123 := v0];
	var v62 := 'm';
	var v63 := new C9(if (v0 in v61) then v61[v0] else v0, 0x2e4, fm17(v62, false, globalState));
	var v64 := new C1(seq(abs(0x2d3), i6  => ('r')));
	r0 := v42;
}
method Main() {
	var v0 := true;
	...
	var v7: array<string> := new seq<char>[1](i0 => seq(abs(-0x2e1), i1  => ('s')));
	var v8 := "hgal";
	v7[safeIndex(314, v7.Length)] := v8;
	v7[safeIndex(314, v7.Length)] := v8;
	...
	var v16: set<bool> := {v0};
	globalState.f15, v11, globalState.f6, v5[safeIndex(215, v5.Length)] := |(set v12 : int | (0x28b <= v12) && (v12 < 0xc) :: (safeModuloInt(v12, v3)))| == 0x94, v11, if (v15 in v14) then v14[v15] else safeDivisionInt(v9, |v16|), v9;
	var v17 := 'i';
	var v18: set<int> := {v9};
	...
	var v23: map<int, bool> := map[v5[safeIndex(215, v5.Length)] := v0];
	v20 := v20[v17 := [v19[safeIndex(-(if (v5[safeIndex(215, v5.Length)] in v22) then v22[v5[safeIndex(215, v5.Length)]] else |v23|), |v19|)]]];
	globalState.f13 := if (fm1(v0, globalState)) then v0 else v0;
	for i5 := |(v4 + v4)| to -v5[safeIndex(215, v5.Length)] {
		v5 := new int[21];
		v2, v3 := v2 + v2, v3;
		...
		match (v26.(cf5 := v11)) {
			case DC0(cf0, cf1, cf2, cf3) =>
				v7 := new string[23](i7 => v7[safeIndex(314, v7.Length)]);
				...
				var v29: multiset<array<char>> := multiset{v28[safeIndex(v3, |v28|)], v27, v27, v27};
				globalState.f15 := v29 <= (v29 * v29[v27 := abs(v9)]);
				var v30 := DC0(cf0, v3, cf2, false);
				var v31: multiset<D0> := multiset{DC0(cf0, v5[safeIndex(215, v5.Length)], cf2, cf3), v30};
				globalState.f15 := v31[DC0(cf0, 0x129, cf2, v0) := abs(v3)] == (multiset{v30, DC0(cf0, i5, cf2, cf3)})[v30 := abs(i5)];
				var v32 := new C8(v18, v0, -safeDivisionInt(v9, cf1), v8);
			case DC1(cf4, cf5, cf6, cf7) =>
				globalState.f13 := v0;
				var v33: array<array<D7>> := new array<D7>[6];
				var v34: array<D7> := new D7[21];
				v33[safeIndex(238, v33.Length)] := v34;
				v33[safeIndex(238, v33.Length)] := v34;
				var v35 := new C4(i5, v0, i5, v7[safeIndex(314, v7.Length)]);
				var v36 := v35.m3(v2[safeIndex(i5, |v2|)], globalState);
			case DC2(cf8, cf9, cf10, cf11) =>
				v5[safeIndex(215, v5.Length)], globalState.f15, globalState.f13, globalState.f13, globalState.f13 := v5[safeIndex(215, v5.Length)], (v4 + v4) == v4, v0, (|v23| >= -i5) || v0, cf9;
				var v37: C2 := new C2(v7[safeIndex(314, v7.Length)]);
				var v38: set<C2> := {v37};
				v5[safeIndex(215, v5.Length)] := -safeModuloInt(|(v38 + v38)|, i5);
				var v39, v40, v41, v42 := v37.m1(-v3, globalState);
				v0 := v8 == (seq(abs(0x22c), i8  => (v17)));
		}
	...
	match (v48) {
		case DC80(cf137, cf138, cf139) =>
			...
			v49[safeIndex(126, v49.Length)] := v2;
			v49[safeIndex(126, v49.Length)] := v2;
			v11[safeIndex(727, v11.Length)] := {v0, v0, true, v0} == v16;
			v11[safeIndex(727, v11.Length)] := if (v5[safeIndex(215, v5.Length)] > 0x22c) then v3 == v9 else v17 !in v8;
			v3 := v5[safeIndex(215, v5.Length)] - cf138;
			var v50 := m0(globalState);
		case DC79(cf136) =>
			v8 := v8;
			var v51: C11 := new C11(v0, -v5[safeIndex(215, v5.Length)], v7[safeIndex(314, v7.Length)]);
			v51 := new C11(v18 !! {v5[safeIndex(215, v5.Length)], 7}, v9, v7[safeIndex(314, v7.Length)] + v7[safeIndex(314, v7.Length)]);
			var v52: seq<array<bool>> := [v11];
			var v53: array<array<bool>> := new array<bool>[6] [v11, v52[safeIndex(v9, |v52|)], v11, v11, v11, v11];
			...
			globalState.f15, globalState.f6, v0, globalState.f10, v51 := if (v55 in v56) then v56[v55] else v0, |(v7[safeIndex(314, v7.Length)] + v57[safeIndex(v3, |v57|)])|, (v7[safeIndex(314, v7.Length)] <= fm7(-0x333, globalState)) !in v21, safeModuloInt(v5[safeIndex(215, v5.Length)], safeDivisionInt(v5[safeIndex(215, v5.Length)], v3)), v51;
		case DC81(cf140) =>
			var v58 := m0(globalState);
			v1 := v1[v0 := v0];
			if (v0) {
				var v59 := new C5(v7[safeIndex(314, v7.Length)]);
				...
				v5[safeIndex(215, v5.Length)] := v3;
				globalState.f6 := v3;
				var v63: seq<array<bool>> := [v11];
				var v64 := DC45(v63);
				var v65: array<seq<array<bool>>> := new seq<array<bool>>[6] [v63 + v63, v64.cf77, v63, v63, v63, [v11, v11]];
				v65[safeIndex(400, v65.Length)] := [v11];
				v65[safeIndex(400, v65.Length)] := if (v0) then v63 else v63 + v63;
		...
		decreases 100 - i10
	{
		...
		i10 := i10 + 1;
		v11[safeIndex(914, v11.Length)] := (if (-0x1a8 in v23) then v23[-0x1a8] else !v0) ==> fm1(v0, globalState);
		v11[safeIndex(914, v11.Length)] := v0;
		if (v11[safeIndex(914, v11.Length)]) {
			globalState.f6 := safeModuloInt(v5[safeIndex(215, v5.Length)], v5[safeIndex(215, v5.Length)]);
			var v67 := m0(globalState);
			v11[safeIndex(914, v11.Length)] := v4 != v4;
			var v68 := new C11(v11[safeIndex(914, v11.Length)], v9, v7[safeIndex(314, v7.Length)]);
			v11[safeIndex(914, v11.Length)] := v8 <= v8;
		} else {
			var v69 := m0(globalState);
			var v70: T1 := new C10((seq(abs(674), i11  => ('l')))[safeIndex(v5[safeIndex(215, v5.Length)], |(seq(abs(674), i11  => ('l')))|) := v17], -984, v8);
			var v71: map<T1, multiset<bool>> := map[v70 := v21];
			globalState.f6 := safeModuloInt(v3 + |v71|, v9);
			...
			var v75, v76, v77, v78 := v70.m1(if (v8 in v74) then v74[v8] else v5[safeIndex(215, v5.Length)], globalState);
		}
		
		globalState.f10 := v9;
		v22 := v22[v3 := v3 + v3];
	}
	var v79 := new C4(|v8|, v0, 0x334, v7[safeIndex(314, v7.Length)][safeIndex(v3, |v7[safeIndex(314, v7.Length)]|) := v17]);
	v5[safeIndex(215, v5.Length)] := |([v0, v0] + v2)|;
	globalState.f13 := v0 <==> v79.fm4(globalState);
	if (v17 !in v7[safeIndex(314, v7.Length)]) {
		var v80: array<char> := new char[16](i12 => 'f');
		v80[safeIndex(751, v80.Length)] := v17;
		v80[safeIndex(751, v80.Length)] := v17;
		v11[safeIndex(569, v11.Length)] := true;
		v11[safeIndex(569, v11.Length)], v5[safeIndex(215, v5.Length)] := v79.fm3(v0, globalState), v79.f33;
		if (v79.fm4(globalState)) {
			...
			v85 := v85;
			globalState.f6 := v9;
			globalState.f6 := (v3 * 0x163) + (if (v0 in v21) then v21[v0] else v5[safeIndex(215, v5.Length)]);
			globalState.f13 := v11[safeIndex(569, v11.Length)];
			var v86: multiset<string> := multiset{fm63(v11[safeIndex(569, v11.Length)], v5[safeIndex(215, v5.Length)], |v21|, v0, globalState)};
			var v87 := DC58(v86);
			v87 := v87.(cf103 := v86);
		} else {
			v80 := if (v11[safeIndex(569, v11.Length)]) then v80 else v80;
			var v88: array<array<int>> := new array<int>[2] [v5, v5];
			var v89 := DC73(v88);
			v89 := v89.(cf128 := v88);
			var v90, v91 := v79.m14(v7[safeIndex(314, v7.Length)], "qccldlnqe", globalState);
			v3 := v3;
			v2 := v2 + v2;
		}
		
		var v92: array<bool> := new bool[15](i13 => v11[safeIndex(569, v11.Length)]);
		...
		var v97: T0 := new C0();
		v8, v97 := v7[safeIndex(314, v7.Length)], v97;
		var v98: seq<set<bool>> := [v16, {v0, v0}, v16];
		v5[safeIndex(215, v5.Length)] := -v79.f33 * -|v98|;
		var v99: C10 := new C10(v8, if ((if (v79.f33 in v23) then v23[v79.f33] else v0) in v21) then v21[if (v79.f33 in v23) then v23[v79.f33] else v0] else if (v0 in v21) then v21[v0] else v9, (seq(abs(0x2a1), i14  => (v17))) + v8);
		v99 := v99;
		var v100, v101, v102, v103 := v79.m2(v5[safeIndex(215, v5.Length)], globalState);
	}
	
	var v104: map<bool, string> := map[v0 := seq(abs(0x6c), i16  => ('w'))];
	var i15 := 0;
	while (v7[safeIndex(314, v7.Length)] < (if (false in v104) then v104[false] else seq(abs(139), i17  => (v7[safeIndex(314, v7.Length)][safeIndex(|v45|, |v7[safeIndex(314, v7.Length)]|)]))))
		decreases 100 - i15
	{
		if (i15 >= 100) {
			break;
		...
		i15 := i15 + 1;
		v11[safeIndex(952, v11.Length)] := v0;
		v11[safeIndex(952, v11.Length)] := v0;
		v5[safeIndex(215, v5.Length)], v0, v17 := fm26(v79.f33, v0, v11[safeIndex(952, v11.Length)], globalState), false, if (v79.f33 < |v8|) then v17 else 'q';
		var v105 := DC7(fm49(v11[safeIndex(952, v11.Length)], v79.f33, globalState), v3, |v23[v79.f33 := v0]|, v11[safeIndex(952, v11.Length)], "ng");
		v0 := !(safeDivisionInt(v79.f33, |v105.cf22|) > ((if (v5[safeIndex(215, v5.Length)] in v22) then v22[v5[safeIndex(215, v5.Length)]] else |v1|) + v5[safeIndex(215, v5.Length)]));
		var v106, v107, v108, v109 := v79.m1(v79.f33, globalState);
	}
	var v110 := DC50(v79.f33, v7[safeIndex(314, v7.Length)], v21, v4, v0);
	var i18 := 0;
	while (match v110 {
		...
		decreases 100 - i18
	{
		...
		i18 := i18 + 1;
		var v111: array<seq<string>> := new seq<seq<char>>[7](i19 => [seq(abs(0x1a9), i20  => (v17)), v7[safeIndex(314, v7.Length)][safeIndex(v5[safeIndex(215, v5.Length)], |v7[safeIndex(314, v7.Length)]|) := v17]]);
		v111[safeIndex(201, v111.Length)] := [v8, v7[safeIndex(314, v7.Length)]];
		var v112: seq<string> := [v8, v8];
		v111[safeIndex(201, v111.Length)] := v112[safeIndex(v9, |v112|) := fm47(v0, if (v3 in v45) then v45[v3] else v79.f33, v0, -v79.f33, globalState)] + v112;
		v9 := v79.f33;
		var v113, v114 := v79.m14(fm7(|map[v0 := v0]|, globalState), v8, globalState);
		v16 := v16 + v16;
	}
	var v115: array<array<int>> := new array<int>[15];
	v115[safeIndex(734, v115.Length)] := v5;
	v115[safeIndex(734, v115.Length)] := v6[safeIndex(v3, |v6|)];
	print v0, "\n";
	print v1 == map[false := true], "\n";
	print v2 == [true, true], "\n";
	print v3, "\n";
	print v4 == [768], "\n";
	print v5[1], "\n";
	...
	print globalState.f4 == map[false := true], "\n";
	print globalState.f5, "\n";
	print globalState.f6, "\n";
	print globalState.f7 == [true, true], "\n";
	...
	print v8, "\n";
	print v9, "\n";
	print v10[0] == [768, 4, -768], "\n";
	print v10[1] == [768, 4, -768], "\n";
	print v10[2] == [768, 4, -768], "\n";
	print v10[3] == [768, 4, -768], "\n";
	print v10[4] == [768, 4, -768], "\n";
	print v10[5] == [768, 4, -768], "\n";
	print v10[6] == [768, 4, -768], "\n";
	print v10[7] == [768, 4, -768], "\n";
	print v10[8] == [768, 4, -768], "\n";
	print v10[9] == [768, 4, -768], "\n";
	print v10[10] == [768, 4, -768], "\n";
	print v10[11] == [768, 4, -768], "\n";
	print v10[12] == [768, 4, -768], "\n";
	print v10[13] == [768, 4, -768], "\n";
	print v10[14] == [768, 4, -768], "\n";
	print v10[15] == [768, 4, -768], "\n";
	print v10[16] == [768, 4, -768], "\n";
	print v10[17] == [768, 4, -768], "\n";
	print v10[18] == [768, 4, -768], "\n";
	print v10[19] == [768, 4, -768], "\n";
	print v10[20] == [768, 4, -768], "\n";
	print v10[21] == [768, 4, -768], "\n";
	print v10[22] == [768, 4, -768], "\n";
	print v10[23] == [768, 4, -768], "\n";
	print v10[24] == [768, 4, -768], "\n";
	print v10[25] == [768, 4, -768], "\n";
	print v11[0], "\n";
	print v11[1], "\n";
	print v11[2], "\n";
	print v11[3], "\n";
	print |v13|, "\n";
	print v14 == map[map[['x'] := true, ['x', 'h', 'f'] := true, ['o'] := true] := 1], "\n";
	print v15 == map["hgal" := true], "\n";
	print v16 == {true}, "\n";
	print v17, "\n";
	print v18 == {1}, "\n";
	print v19 == [{1}], "\n";
	print v20 == map['i' := [{1}]], "\n";
	print v21 == multiset{true}, "\n";
	print v22 == map[-4 := 1, -767 := -1534], "\n";
	print v23 == map[1 := true], "\n";
	print v45 == multiset{768}, "\n";
	print v46 == [multiset{768}, multiset{768}], "\n";
	print v47.cf57 == [multiset{768}, multiset{768}], "\n";
	print v48.cf137.cf57 == [multiset{768}, multiset{768}], "\n";
	print v48.cf138, "\n";
	print v48.cf139[0], "\n";
	print v48.cf139[1], "\n";
	print v48.cf139[2], "\n";
	...
	print i10, "\n";
	print v79.f33, "\n";
	print v104 == map[true := ['w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w']], "\n";
	print i15, "\n";
	print v110.cf85, "\n";
	print v110.cf86, "\n";
	print v110.cf87 == multiset{true}, "\n";
	print v110.cf88 == [768], "\n";
	print v110.cf89, "\n";
	print i18, "\n";
	print v115[14][1], "\n";
