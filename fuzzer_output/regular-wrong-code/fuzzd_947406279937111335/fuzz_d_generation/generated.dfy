...
function fm3(globalState: GlobalState): int {
	-((|map[true := |[false, false]|]| % |{406, 0xf4, 694, |"tudpflvdl"|}|) - (|map[0x149 := |"nmmeb"|]| % |"rdcukv"|))
}
function fm4(p0: bool, p1: int, p2: bool, globalState: GlobalState): map<bool, bool> {
	map[!({831, |multiset{|map[false := 251]|}|} !! {|"famu"|, |DC8("fsdvonkfs", seq(0x1d3, i0  => (|"w"|))).cf13|}) := true]
}
...
function fm6(p0: int, p1: int, p2: bool, p3: char, globalState: GlobalState): D3 {
	DC8("jucvf", [|(seq(-165, i0  => ('x')))|, |map[{0x25c, 0x362} := 'u']|] + (seq(512, i1  => (|[!true]|))))
}
function fm7(p0: bool, p1: D2, p2: bool, p3: bool, globalState: GlobalState): map<string, string> {
	(map[seq(132, i0  => ('o')) := "bxf"] + map["epp" := "kjb"]) + ((map v0 : string | v0 in map["b" := !false] :: (v0) := ("lcmexjuub")) + DC16(map[seq(-223, i1  => ('i')) := "lsqfg"]).cf29)
}
function fm8(p0: bool, globalState: GlobalState): map<string, bool> {
	map["obosvty" + (seq(0x266, i0  => ('y'))) := false]
}
...
function fm10(p0: bool, globalState: GlobalState): string {
	(seq(-0x21a, i0  => ('b'))) + ((seq(0x268, i1  => ('y'))) + "fn")
}
...
method m0(p0: int, p1: multiset<int>, p2: bool, p3: int, globalState: GlobalState) {
	for i0 := p3 to p3 + p0 {
		match (DC6(i0 != p0)) {
			...
			case DC5(cf9) =>
				...
				v3[653] := v4;
				var v5: array<int> := new int[3](i1 => i1 % 0x325);
				v5[564] := i0;
				var v6 := "cfaaiqx";
				var v7: map<bool, string> := map[if (cf9[i0]) then p2 else p2 := "ma" + v6];
				var v8: map<bool, bool> := map[p2 := p2];
				var v9 := 'p';
				var v10: set<bool> := {p2};
				globalState.f4, v3[653], v5[564], globalState.f7 := ((if ((if (p2 in v8) then v8[p2] else p2) in v7) then v7[if (p2 in v8) then v8[p2] else p2] else v6)[--p3 := v9])[fm3(globalState) % |v6| := v9], v4, i0, if (p2) then if (p2) then p3 else |v10| else i0;
				v4[686] := p2;
				v4[686] := if (false) then p2 else p2;
				var v11: map<char, int> := map[v9 := p3];
				var v12 := DC2(p0);
				var v13: map<bool, int> := map[p2 := p0];
				var v14: set<D0> := {v12, v12, DC2(v5[564]), DC2(|v13|), v12};
				globalState.f7, v4[686], globalState.f4 := |v11| % (|v14| + p0), p2, v6 + v6;
				var v15: map<bool, array<bool>> := map[!v4[686] := v3[653]];
				var v16: map<map<bool, array<bool>>, int> := map[v15 + v15 := v5[564] % p3];
				v16 := v16[v15[false := v3[653]] := p3];
		}
		...
		match (v17.(cf4 := |(map v18 : int | (-0x36 <= v18) && (v18 < 0x8a) :: (v18 + |"fqe"|) := (0x308))|)) {
			case DC1(cf1, cf2, cf3) =>
				...
				var v22 := "s";
				var v23 := 'u';
				globalState.f4 := (v22 + v22)[cf1 := v23] + ("ihfuqk" + "unigk");
			case DC2(cf4) =>
				var v24: array<seq<string>> := new seq<string>[21];
				var v25 := "vp";
				var v26: seq<string> := [v25];
				v24[444] := v26;
				v24[444] := (seq(0x28c, i2  => (v25))) + (v26 + v26);
				var v27: array<int> := new int[21](i3 => i3 % cf4);
				v27[363] := p0;
				v27[363] := i0;
				var v28 := false;
				v28 := v28;
		...
		decreases 100 - i6
	{
		...
		var v42: C0 := new C0(|(seq(317, i7  => (v38)))|);
		var v43 := DC10(p2, v42);
		...
		v45[817] := v44;
		v45[817] := new D4[2] [v43.(cf15 := p2), v43];
		var v46 := new C0(p0);
		var v47 := "ogpsjgmip";
	...
	v51, v53[952], globalState.f7, v49 := map[v49 := v50], p0, |v54| * (p3 - v49.f8), v49;
	...
	v58 := v58[v62[|v63|] in [v61] := v53[952]];
...
class C0 {
	...
	method m1(globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: char) {
		...
		var v6: array<bool> := new bool[4] [v0 < v0, (seq(0x75, i0  => (f8))) !in DC0([v5]).cf0, v1, v1];
		var v7: map<bool, bool> := map[!v1 := v1];
		var v8: set<map<bool, bool>> := {v7, (v7[v1 := false])[v1 := true], v7};
		var v9 := 'f';
		var v11 := DC4({map[true := v1], v7});
		globalState.f7, v6, globalState.f7, globalState.f7, v8 := |(set v10 : map<char, bool> | v10 in map[map[v9 := !v1] := v1] :: (v10))|, v6, (f8 * f8) / -|[v1]|, f8 + f8, v11.cf8;
		var v12: seq<bool> := [v1];
		...
		r0 := fm0(fm0(true, v1, v16, |v8|, globalState), v1, v16[map v17 : char | v17 in (seq(0x25d, i1  => (v9))) :: (v17) := (!v1) := f8] + v16, f8, globalState);
		r1 := v1;
...
method Main() {
	...
	var v2: array<int> := new int[1](i0 => i0 % 448);
	...
	v3[619] := true;
	v3[619] := v5 >= v5;
	var v9: seq<bool> := [v3[619], v3[619], v0];
		...
		decreases 100 - i2
	{
		...
		var v14: multiset<int> := multiset{v11[|v11|], v5, -|v13|, v5};
		m0(-v5, v14, v3[619] <==> v3[619], -v5, globalState);
		var v15: map<string, bool> := map[(v4 + v4)[-0x339 := v12] := if (v9[v5]) then !v0 else v3[619]];
		var v17: multiset<string> := multiset{v4, "n", "npfn"};
		v0, globalState.f7, v15 := v3[619], -(v5 - v5), map v16 : string | v16 in v17 :: (v16) := (v0);
		if ((v3[619] ==> v0) ==> (v5 in v14)) {
			v2[788] := v5;
			v2[788] := v5;
			v2[788] := v5;
			globalState.f7 := v2[788] - (fm3(globalState) % -v5);
			var v18: array<seq<bool>> := new seq<bool>[7](i3 => [v0]);
			v18[921] := v9 + v9;
			v18[921] := v9;
			v0 := v18[921][|multiset{v18[921]}|];
		} else {
			var v19 := new C0(v5);
			...
			m0(|(v4 + v4)|, v14, |v4[v19.f8 := 'c']| != |(if (v19.f8 in v25) then v25[v19.f8] else v24)|, |v26|, globalState);
			var v27 := DC5(v9);
			var v28: set<bool> := {v21, false <== v21, v5 != (if (v0 in v1) then v1[v0] else |v27.cf9|)};
			v28 := v28;
		}
		
		m0(v5, v14, v3[619], v5, globalState);
	}
	...
	v34 := DC1(0x142, v5, v5);
	var v35 := DC2(|(seq(-986, i4  => (v5)))|);
	var v36: multiset<D0> := multiset{v35, DC2(v5)};
	v36 := v36[v35 := v5];
	var v37: map<bool, bool> := map[v0 := v0];
	v5, globalState.f7 := if (false) then |(v37 + v37)| else v5, v5;
	var v38: map<array<int>, bool> := map[v2 := v3[619]];
	var v39 := 'c';
	if (if (v2 in v38) then v38[v2] else fm0(!v0, fm0(false, false, multiset{v6[v39 := v0]}, v5, globalState), (multiset(v7))[v6 := v5], v5, globalState)) {
		var v40: map<bool, array<bool>> := map[v0 := v3];
		v40 := v40[v0 := v3];
		var v41 := DC7(v37);
		v0 := (v41.cf11 + v37) == (v37 + fm4(!v0, v5, v3[619], globalState));
		var v42: multiset<bool> := multiset{v3[619], v0, v3[619] <== !!v0, v0, v4 < v4};
		var v43: set<bool> := {!v0};
		var v44: map<int, bool> := map[|(seq(0x25c, i5  => (v5)))| := !v0];
		globalState.f7 := if (fm0(v0, v0, v8, |v43|, globalState) in v42) then v42[fm0(v0, v0, v8, |v43|, globalState)] else |fm5(17, v0, if (|v31| in v44) then v44[|v31|] else true, globalState)| / 0x88;
		var v46: map<int, D0> := map[v5 := DC0([seq(242, i7  => (|"hwbs"|))])];
		var v47: seq<int> := [|map[v5 := v3[619]]|];
		var v48: seq<seq<int>> := [v47];
		var v49 := DC0(v48);
		m0(|((map v45 : int | (0x3ba <= v45) && (v45 < 0x26f) :: (v45 + |[v5]|) := (DC0([seq(-0x107, i6  => (v5)), [v5, |v4|]]))) + v46[|v4| := v49])|, v31, v0, v5, globalState);
		v5 := v5;
	} else {
		var v50 := new C0(v5 % -0x77);
	...
	for i10 := v57.f8 to v57.f8 {
		...
		v64 := v64[|v65| / i10 := v0];
		v3[619] := fm0(v3[619], v3[619], v8, v57.f8, globalState);
		v3[619] := v3[619];
		v35 := v35;
	}
	...
	var v67: seq<int> := [v5];
	v66[610] := v67;
	v66[610] := (seq(466, i11  => (v57.f8))) + v67;
	for i12 := -v5 to v5 + -0x10 {
		if (!(v39 !in v4)) {
			var v68: map<bool, C0> := map[v0 := v57];
			var v69: map<bool, map<bool, C0>> := map[v3[619] := v68];
			v69 := v69[false := v68[v3[619] := v57]];
			var v70: multiset<bool> := multiset{v0, v3[619], v3[619], v0};
			v0, v57.f8, v57.f8, v57.f8, v3[619] := !v3[619], 0x1c6 % v57.f8, -0x28b, (v57.f8 - v5) - v57.f8, if (true) then if (v0 in v37) then v37[v0] else fm0(v0, v3[619], v8, |(seq(109, i13  => (v39)))|, globalState) else v70 <= v70;
			v3[619] := v3[619];
			var v71 := DC5([v3[619]]);
			...
			var v74 := DC5(v9);
			var v75: map<string, bool> := map[v4 := v3[619]];
			var v76 := DC9(v75);
			var v78: set<string> := {v4};
			var v79: seq<map<string, bool>> := [map v77 : string | v77 in v78 :: (v77) := (v3[619]), v75];
			var v80: array<map<string, bool>> := new map<string, bool>[17] [(map v73 : string | v73 in fm7(v0, v74, v3[619], v3[619], globalState) :: (v73) := (v3[619])) + v75, v75, map[v4 := false], v75, v75, v75, v75, v75, v75, v75 + v75, v75, v75 + v75, v76.cf14, v75, v79[v5], v75, v75];
			v80[35] := fm8(fm0(false, false, multiset{map[v39 := v0], v6}, 0xa, globalState), globalState);
			v80[35] := v75 + v75;
			v4 := v4 + v4;
			var v81 := DC7(v37);
			var v82 := DC8(v4, v67);
		...
		var v86 := DC11(v39);
		v29[436] := v86.cf17;
		var v87: multiset<bool> := multiset{fm0(v0, v3[619], v8, |v67|, globalState)};
		v57.f8, v85, v29[436], globalState.f7, v3[619] := v5 * (if (v3[619] in v87) then v87[v3[619]] else i12), v85, 'r', v57.f8, true;
	}
}