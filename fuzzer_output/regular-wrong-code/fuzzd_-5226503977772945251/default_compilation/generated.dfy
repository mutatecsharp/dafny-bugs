...
function fm0(p0: bool, globalState: GlobalState): string {
	match DC59({map[|"mubrpfn"| := |map[true := 0x18]|], map[|multiset{false}| := |[|[!false, true, true, true]|]|], map[0x20b := 434]}) {
		...
		case DC59(cf98) => "amnfynyx" + (seq(33, i0  => ('r')))
	}
}
...
function fm18(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): seq<int> {
	[-0x3] + (if (DC101(false, |"hto"|, -|map[false := DC47(!true, map[!false := 36]).cf71]|).cf158) then [-0x134, |{!true, true}|, |(seq(252, i0  => ('q')))|, |[false, !false]|] else [-|['v']|])
}
...
function fm29(p0: bool, globalState: GlobalState): multiset<int> {
	(DC10(false, multiset{383}).cf19 * multiset{|"b"|}) * (multiset{|(seq(0x174, i0  => ('c')))|, -2, -0x17e} - multiset{|multiset{false, false}|, |[true]|})
}
...
function fm32(globalState: GlobalState): seq<multiset<int>> {
	[multiset(seq(0x3d9, i0  => (|[-0x3b5]|)))] + [multiset{|{|[false]|, -300, 357, |multiset{-0x38}|}|, --13, -0x361}, multiset(seq(0x10, i1  => (|[|"jgefpyq"|]|))), multiset{371, |['i']|}]
}
...
function fm38(p0: bool, p1: int, globalState: GlobalState): multiset<int> {
	match DC14() {
		...
		case DC15(cf23) => multiset{|"k"|, |{cf23, cf23, !true}|, -815, |map[-|"lc"| := |(seq(0x236, i0  => ([cf23])))|]|, -|map[!cf23 := cf23]|}
		case DC16() => multiset{|"hpntu"|, |(seq(0x12e, i1  => (|{609}|)))|} + multiset([0x2c7])
		case DC13(cf22) => multiset{|multiset{-0x1c1}|}
		case DC17(cf24) => multiset{|(seq(-194, i2  => ('c')))|, |"kkat"|, 0xf1, --DC66(!!true, |"hjj"|, 0x7, !false).cf115, 534}
	}
}
function fm39(p0: bool, globalState: GlobalState): D2 {
	if (|map[|[0x1f6, -|map[--|{false}| := 0x15c]|]| := false]| != |{true, true}|) then DC7(|[true]|, 0x1d6, |multiset{true, !true, false}|) else if (false) then DC7(0x387, -0xcf, |"phu"|) else DC7(|multiset{0x133, |[!true, true]|}|, --0x2ee, |(seq(0x1a6, i0  => (|map[true := 0xfd]|)))|)
}
...
function fm46(p0: bool, globalState: GlobalState): map<bool, seq<int>> {
	(map[true := [|(map v0 : int | v0 in map[|[true]| := |[false, true]|] :: (v0 + 0x210) := (true))|, 0x181, 0x29a, 0x35]] + map[!!false := [|map[!true := |multiset{true}|]|]]) + (map[false := seq(0x2e4, i0  => (|map[0x160 := true]|))] + map[false := [|{0x96}|]])
}
function fm47(p0: int, p1: int, globalState: GlobalState): seq<bool> {
	[!false, true, false] + ([false, true] + [true])
}
function fm48(globalState: GlobalState): seq<multiset<int>> {
	match DC100(map[true := seq(0x379, i0  => ('o'))]) {
		case DC101(cf158, cf159, cf160) => [multiset{cf159}] + [multiset(seq(0x143, i1  => (cf159)))]
		case DC100(cf157) => [multiset(seq(0x220, i2  => (|map[true := 974]|)))]
	}
}
...
function fm51(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): seq<int> {
	seq(-0x4b, i0  => (0x3be + |{0x2f9}|))
}
function fm52(globalState: GlobalState): map<map<bool, char>, int> {
	match DC10(true, multiset{220, |(seq(0x2d7, i0  => (|"hjmfil"|)))|}) {
...
function fm54(p0: bool, p1: int, p2: bool, p3: seq<bool>, globalState: GlobalState): multiset<int> {
	multiset{0x3dd, |"r"|, |map[541 := 0x287]|, |[0x339]|, -|[map[!true := |(map v0 : int | (0x235 <= v0) && (v0 < 0x128) :: (v0 - |"u"|) := (|"hrxrasal"|))|], map[true := |"joxe"|], map[false := |multiset([-868])|]]|} + multiset{559, |multiset{[|(seq(0x249, i0  => ('t')))|], [0x34b]}|, 715, 0x1d0}
}
...
function fm57(globalState: GlobalState): map<string, int> {
	(map[seq(-0x31e, i0  => ('k')) := 0xd8] + map[seq(270, i1  => (DC60('r', -0x252, false, 'u', |"hodiwfr"|).cf102)) := 0x65]) + (map["ng" := -0x26d] + map["dcfnlcx" := 0x1af])
}
...
function fm62(globalState: GlobalState): set<string> {
	match DC73(DC70(map[map[|(seq(373, i0  => ('c')))| := true] := false])) {
		case DC71(cf120, cf121) => if (!true) then {seq(0x13b, i1  => ('q')), "isdksk"} else {"mmkjmtak"}
...
function fm64(globalState: GlobalState): D13 {
	if (true) then DC34(map[[|map[|"h"| := multiset{0x1b1, -0x9d}]|] := [--0x113]]) else DC34(map[seq(399, i0  => (|map[true := 166]|)) := seq(849, i1  => (174))])
}
function fm65(p0: int, p1: bool, globalState: GlobalState): multiset<int> {
	multiset((seq(892, i0  => (0x2a))) + ([|[false]|, -0x379] + [|"rt"|]))
}
...
function fm67(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<bool, multiset<int>> {
	if (!(false <==> true)) then if (false) then map[true := multiset{|map[true := 0x1f4]|}] else map[true := multiset{-|multiset(seq(675, i0  => (|(seq(407, i1  => ('v')))|)))|, |multiset{true}|}] else map[false := multiset{|(map v0 : int | (648 <= v0) && (v0 < 0x298) :: (v0 + |multiset{true, false}|) := (true))|}] + map[!false := multiset{|"xggryhcfy"|, |map[false := !true]|}]
}
...
function fm70(p0: bool, p1: int, globalState: GlobalState): seq<int> {
	((seq(881, i0  => (0x38f))) + [467, |map[!false := false]|]) + ([|"l"|] + [|multiset{true}|])
}
function fm71(p0: int, globalState: GlobalState): map<bool, int> {
	match DC45(DC45(DC42(DC66(!false, 165, |map[!true := 0xc0]|, true).cf113))) {
		...
		case DC45(cf69) => map[true := |multiset(DC57(seq(0x220, i0  => ('u')), |[316]|, 0x1bd, 531, true).cf92)|] + map[true := -683]
	}
}
function fm72(globalState: GlobalState): set<int> {
	{--(-0x334 % -|[|"sjp"|, -|map[true := "iyojjwedr"]|]|), 0x3c9, |multiset{808}|}
}
...
function fm77(p0: bool, p1: bool, globalState: GlobalState): D13 {
	DC36(|['v', 'y']| / |{|"pub"|, |[false]|}|, 0x36e, DC64(true, [0x1fc], 0x62).cf109, {0x3be} * (set v0 : int | (0x220 <= v0) && (v0 < 632) :: (v0 / |multiset{true}|)), true)
}
function fm78(p0: multiset<bool>, p1: int, p2: char, globalState: GlobalState): multiset<int> {
	multiset{344, -(if (true) then |DC0(seq(-0x1c0, i0  => ('y'))).cf0| else |(map v0 : int | (0x30b <= v0) && (v0 < 0x87) :: (v0 - |"yjpn"|) := (0x190))|), 0x275, |{false}| / 461}
}
...
function fm85(globalState: GlobalState): D11 {
	DC29(set v0 : seq<int> | v0 in map[[|(seq(0x1ad, i0  => (DC1('q', 0x385, {|(seq(0xdf, i1  => ('k')))|}, "yxlnjlbd").cf1)))|, -|[false, !!true]|, |[true, false]|, |"apav"|, 0x2c4] := |(seq(0x1a3, i2  => ('y')))|] :: (v0))
}
...
function fm88(p0: bool, p1: bool, globalState: GlobalState): D13 {
	DC35(|(seq(0xf3, i0  => (|map[true := map[-|{false}| := true]]|)))|, (set v0 : int | v0 in map[223 := 0x2d3] :: (v0 * 0x2f1)) < {873}, map[[|(seq(522, i1  => (669)))|, 0x1af, |multiset{false, false}|, |"svys"|] := 521] + map[[-0xd6, 942] := |map['s' := true]|])
}
...
function fm90(p0: bool, p1: int, globalState: GlobalState): D15 {
	if (true) then DC41(map v0 : char | v0 in (seq(952, i0  => ('p'))) :: (v0) := (-|[map[false := |(seq(-0x2fb, i1  => ('n')))|], map[true := -|{true, false}|]]|)) else DC41(map['w' := 0x18e])
}
...
function fm96(p0: string, p1: seq<char>, p2: int, globalState: GlobalState): multiset<int> {
	multiset([798, 0x39b, |(seq(392, i0  => ('i')))|, 0x1e, 892]) - multiset{|"fspvv"|, 0x391}
}
...
function fm98(p0: int, globalState: GlobalState): seq<seq<int>> {
	([[|"wsg"|, 681]] + [seq(-0x87, i0  => (|{"q"}|)), [|multiset{true, true}|]]) + (seq(0x305, i1  => ([|map[!true := false]|])))
}
...
function fm104(p0: D9, p1: int, p2: int, p3: int, globalState: GlobalState): D9 {
	if (false) then DC27(0x392, DC86(|(seq(0x353, i0  => ('w')))|, false, -|multiset{seq(0xa4, i1  => ('w')), "gfnjcwxk"}|, false).cf135, 0xff) else DC27(511, true, |map[false := seq(887, i2  => ('n'))]|)
}
...
function fm110(p0: bool, p1: int, globalState: GlobalState): map<D19, bool> {
	map[DC54(|"gaccpcdt"|, 0x344, multiset{'o'}, |[true, false]|, 0x2a2) := !false] + (map[DC54(-0x330, |"nvjxcmygv"|, multiset(['n']), |multiset([0x160])|, 351) := false] + map[DC54(35, |[true]|, multiset{'c'}, |map[|{false}| := DC75(false, |map[true := 276]|).cf124]|, |map[|multiset{true, true}| := |(seq(0x3df, i0  => ('o')))|]|) := false])
}
...
function fm113(p0: int, p1: char, p2: map<int, bool>, globalState: GlobalState): seq<string> {
	if (if (false) then true else !!true) then ["vurrvuds", "jx"] + ["oyjn"] else ["sdgi"] + [seq(0x3c9, i0  => ('u')), seq(0x3e7, i1  => ('w')), seq(-0x3e2, i2  => ('o'))]
}
...
function fm117(p0: int, globalState: GlobalState): D27 {
	DC71(|"wymt"|, |map[-826 := |(seq(0x105, i0  => ('y')))|]| / |multiset{DC51(true, false, -924).cf77}|)
}
...
function fm120(p0: int, p1: int, p2: char, globalState: GlobalState): D18 {
	match DC74([map v0 : int | v0 in map[0x28b := true] :: (v0 * |{0x271}|) := (0x2c5), map[0xb9 := |[!true, true]|]]) {
		case DC75(cf124, cf125) => DC50(map[cf125 := |(seq(0xf1, i0  => ('p')))|])
		case DC76() => DC50(map[-0x249 := |{'b'}|])
		case DC77() => DC50(map[-0x1a8 := |map[false := false]|])
		case DC74(cf123) => DC50(map[-0x301 := |"rqfwgmu"|])
		case DC78(cf126) => DC50(map[|(seq(0x382, i1  => ('d')))| := |(set v2 : map<int, int> | v2 in {map v1 : int | (89 <= v1) && (v1 < 735) :: (v1 * 0x12d) := (0x2f4)} :: (v2))|])
	}
}
function fm121(p0: bool, p1: bool, p2: int, globalState: GlobalState): multiset<seq<int>> {
	if (0x5f <= 0x12d) then multiset{[0x319]} * multiset([[|[0x2ce, |[0x1d8]|, 675]|]]) else multiset{seq(0x342, i0  => (-|[|[true, true, true]|, 0x232]|)), [-0x384], seq(0x190, i1  => (-|multiset{multiset{0x3c5}, multiset([0x8f]), multiset([0x60])}|))}
}
...
function fm123(p0: int, p1: char, globalState: GlobalState): seq<map<bool, bool>> {
	([map[true := !false], map[false := false]] + (seq(-46, i0  => (map[!false := true])))) + ([map[true := true], map[true := !true]] + [map[false := true]])
}
...
function fm125(p0: int, p1: bool, globalState: GlobalState): D20 {
	DC57("jr", 363, 110 % -0x299, |{|"hd"|, |[!true, DC88(true).cf139]|, |(seq(0x256, i0  => ('r')))|}|, -|"prxbn"| > |(map v0 : char | v0 in map['g' := map[true := 340]] :: (v0) := (false))|)
}
function fm126(p0: bool, globalState: GlobalState): D32 {
	DC89(0x102 + |"nkmyqmnft"|)
}
function fm127(globalState: GlobalState): set<seq<int>> {
	{[--|[false, true, false, true]|], [|[true, false, true]|], seq(0x41, i0  => (|{740, |[true, false, true, false, false]|}|)), [|map[false := |"dgwsbk"|]|]} + {[992]}
}
function fm128(p0: int, p1: bool, p2: bool, globalState: GlobalState): D24 {
	DC64(!false, [|["jeatybqkx", "jcqcsa"]|, -0x2fb, DC27(-0x2a3, false, |[|(seq(505, i0  => (-|multiset([true])|)))|, -0x152]|).cf39], -|(multiset{false} - multiset(DC3([false, true]).cf6))|)
}
...
function fm131(p0: int, p1: int, p2: bool, globalState: GlobalState): map<D0, int> {
	map[DC0(seq(0x37c, i0  => ('r'))) := |"xlymsk"| - |{0x18c, -6}|]
}
...
function fm135(p0: int, p1: bool, p2: int, globalState: GlobalState): map<seq<int>, bool> {
	map[DC23(seq(35, i0  => (0xe3))).cf33 := 0x242 < |"eouxlwnwc"|]
}
method m0(p0: seq<seq<bool>>, p1: int, p2: map<char, int>, p3: bool, globalState: GlobalState) returns (r0: array<bool>) {
	...
	if (|v0| > p1) {
		...
		var v7: C0 := new C0(v1);
		var v8: map<seq<int>, C0> := map[(v6 + v6)[v1 := p1] := v7];
		...
		globalState.f0 := v11[v1] > ((if (p3 in v12) then v12[p3] else {p3}) + v10);
		...
		var v26 := 0x23;
		var v27: set<bool> := {p3};
		v20[410], globalState.f0, v21[670], v26 := v17, v27 < v27, v25.(cf109 := p3), v26;
		v26 := |v27|;
		...
		match (v31) {
			case DC39(cf63, cf64, cf65) =>
				...
				cf64, globalState.f0, globalState.f0 := v32 < v32, (if (p3) then cf64 else true) !in (v33 + ([cf64])[-p1 := cf64]), v22.fm3(v0, globalState);
				var v34 := 'w';
				var v35: map<int, char> := map[cf65 / p1 := fm14(p3, v34, v26, v26, globalState)];
				v34 := if (-0x364 in v35) then v35[-0x364] else 'r';
			case DC38(cf62) =>
				var v36 := DC10(!p3, multiset{-p1, v26, p1, -p1});
				v16[460] := v26;
				var v37 := DC86(-p1, p3, |v0|, false);
				globalState.f0, v36, v16[460], v26, v16 := true, v36, v37.cf134, p1, v16;
				...
				v26 := fm2(v16[460] / |v40|, |map[p3 := 0x26b]|, fm10(p1, v41, globalState), v0 <= v0, globalState);
				v16[460] := --0x271;
			case DC40(cf66) =>
				var v42 := 'n';
		...
		if (p3) {
			...
			v58 := v58 + v58;
			v26 := (if (p3) then v26 else p1) % p1;
			var v59: seq<bool> := [p3];
			var v60: array<bool> := new bool[6];
			var v61: C13 := new C13(0x27e, v16, p3, v60, p3);
			var v62: seq<seq<int>> := [v24, [v61.f9], v24];
			var v63: array<seq<int>> := new seq<int>[13] [v24, v24, v24[-v26 := fm2(|multiset(v59)|, |map[v61 := p1]|, p3, p3, globalState)], v24, v62[p1], v62[v26], v24, v24, v24, seq(980, i0  => (0x2bc)), v24, [v26, v26, p1], v24];
		...
		decreases 100 - i1
	{
		...
		v67 := |(fm135(|v69|, v70[p1], |v74|, globalState) + v75)|;
		...
		var v79: array<T1> := new T1[7] [v77, v77, v77, v77, v77, v77, v78[p1]];
		v79[594] := if (p3) then v77 else v77;
		v68[820] := p1;
		var v80: multiset<bool> := multiset{p3};
		var v81: map<seq<char>, multiset<bool>> := map[v0 := v80];
		var v82 := 'b';
		var v83: map<bool, int> := map[false := |v0|];
		v79[594], v68, v68[820], v0, v67 := v77, v68, |(v81 + map[[v82] := multiset{p3}])|, v0, -(if (v70[-0x204] in v83) then v83[v70[-0x204]] else p1) % v67;
		var v84: seq<array<int>> := [v68];
		v68 := v84[v68[820]];
		if (p3) {
			v68[820] := p1;
			globalState.f0, globalState.f0, globalState.f0, globalState.f0, globalState.f0 := true, p3, p3, p3, if (v70[v68[820]]) then p3 else fm10(fm2(|v70|, p1, p3, p3, globalState), [p3], globalState) || p3;
			var v85 := DC32(v71, v79[594]);
			var v86 := new C7(v85);
			...
			v88[48] := (if (p3 in v91) then v91[p3] else [v89, v89]) + v90;
		} else {
			var v92 := DC72();
			v92 := v92;
			v68[820] := v67 % v68[820];
			v72 := (v72[|(v83 + map[p3 := |(seq(-0x1c1, i3  => (v82)))|])| := v68[820]])[v68[820] := v67];
			var v93: seq<string> := [v0];
			v68[820] := -(p1 / (v68[820] / |v93[v67]|));
			var v94: multiset<int> := multiset{v68[820]};
			...
			v94, v98, v72, v99 := v94, v98 + v98, v72 + v72, fm130(v70[0x1df], v67, |(if (v95.f5) then v100 else v100)|, globalState);
		}
	...
	v101[191] := -(if (if (p3) then p3 else p3) then v101[191] else |v110|);
	r0 := v102;
}
trait T0 {
...
class C0 {
	...
	function fm27(p0: D4, p1: bool, globalState: GlobalState): int {
		match DC2(DC1('o', f19, set v0 : int | v0 in map[f19 := true] :: (v0 / 0x2b6), "djb")) {
	...
	function fm28(p0: int, p1: int, p2: bool, globalState: GlobalState): bool {
		match DC1('o', |[true]|, {f19}, seq(0x2aa, i0  => ('f'))) {
...
class C1 {
	...
	method m14(p0: int, globalState: GlobalState) {
		...
		var v7: seq<int> := [0x3f];
		v0, f17, v0, v0 := |map[v5[-p0] := v6]|, f17, v4.f19 - (if (f17) then v7[0x311] else p0), |((seq(0x305, i0  => ('p'))) + (seq(834, i1  => ('r'))))|;
		var v8: map<bool, int> := map[f17 := if (f17) then p0 else v4.f19];
		v8 := v8[f17 := v4.f19];
		var v9 := "qipncbhr";
		var v10: map<bool, string> := map[v5 < v5 := (seq(-0x1a9, i2  => ('u'))) + v9];
		v10 := v10[false := v9];
	...
	method m15(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: char) {
			...
			decreases 100 - i1
		{
			...
			if (f17) {
				...
				v8[194] := fm25(globalState);
				r1, v8, v8[194] := p1, v8, f17;
			} else {
				var v9 := "j";
		...
		var v21 := "iwb";
		v0[90] := p1;
		v21, v0[90], f17, r1 := v21, p1, fm2(p2, p2, true, !fm25(globalState), globalState) !in fm31(f17, globalState), p2 + (p2 % p2);
		...
		match (if (f17) then v23 else if (p0) then DC10(p0, f18) else v23) {
			case DC10(cf18, cf19) =>
				...
				var v29 := DC1('t', v0[90], v28, v21);
				r3, v24 := v25, if (v21[p1 := v29.cf1] in v26) then v26[v21[p1 := v29.cf1]] else v24;
				var v30: set<bool> := {if (v0[90] in v22) then v22[v0[90]] else p0, cf18, false, f17};
				var v31: seq<set<bool>> := [v30, v30];
				var v32: map<set<bool>, bool> := map[v31[v0[90]] := p0];
				var v33 := DC13(v30);
				v32 := v32[v33.cf22 := p0];
				var v34 := DC11(p0);
				f17 := !v34.cf20;
			...
			case DC11(cf20) =>
				...
				v42[719] := DC18(v40).cf25;
				r1, r0, v42[719], r1 := |(([p1] + v1) + v1)|, p1 / p1, v40, v39.f19;
			case DC9(cf17) =>
				r1 := v0[90];
				var v43: array<bool> := new bool[5](i3 => f17);
				var v44 := DC5(v0[90], v43, f17, p2, f17);
				match (v44) {
					case DC4() =>
						var v45: map<map<int, bool>, string> := map[map[-0x3d7 := f17] := v21];
						r1, v45, v0[90] := p2, v45 + v45, 0xdf % p1;
						var v46: multiset<bool> := multiset{f17};
						var v47: map<int, seq<multiset<int>>> := map[|((map[|{f17}| := p0])[v0[90] := p0])[v0[90] := f17]| := fm32(globalState)];
						var v48: map<multiset<bool>, seq<multiset<int>>> := map[v46 := if (v0[90] in v47) then v47[v0[90]] else [f18]];
						var v49: seq<multiset<int>> := [f18, f18[p2 := |v21|]];
						var v50: multiset<array<int>> := multiset{v0, cf17};
						v48 := v48[v46 := (if (!true) then v49 else if (p2 in v47) then v47[p2] else fm32(globalState))[|v50| := f18]];
						...
						var v57: array<set<multiset<bool>>> := new set<multiset<bool>>[24] [{v46, v46}, v52, {v46, v46}, set v56 : multiset<bool> | v56 in v54[if (p0 in v55) then v55[p0] else v0[90]] :: (v56), v52, v52, v52, {v46} - v52, v52, fm34(v51, p2, globalState), v52, v52, v52, v52, {v46[true := p1]}, v52, v52 * v52, v52, v52 * v52, {v46, v46[f17 := p1]}, v52, {v46}, {v46, multiset{true, f17}, v46, multiset{f17}}, v52];
						v57[429] := v52;
						var v58: set<multiset<int>> := {f18};
						var v59: map<bool, bool> := map[fm25(globalState) := p0];
						var v60 := 'g';
						var v61: map<array<int>, char> := map[cf17 := v60];
						globalState.f0, r1, v43[86], r0, v57[429] := ({f18} + v58) !! v58, |v59|, f17, |v61[v0 := v60]|, v52 - v52;
					case DC5(cf7, cf8, cf9, cf10, cf11) =>
						v21 := v21 + (v21 + v21);
						cf8[739] := v21 <= v21;
						cf8[739] := cf11;
						var v62 := DC15(cf8[739]);
						var v63: map<D5, bool> := map[fm35(globalState) := cf8[739]];
						cf9 := v62 !in v63;
						var v64 := DC11(cf11);
						cf8[739] := v64.cf20;
					case DC3(cf6) =>
						...
						var v68: array<string> := new string[21] [v21, (if (p2 in v65) then v65[p2] else v21) + v21, v21, "lqngew", v21, v21, v21, v21 + v21, v21, v21, if (false) then v21 else v21, v21[-24 := v66], v21, if (v66 in v67) then v67[v66] else "jrpmslyd", v21 + v21, v21 + v21, "wg", seq(0x13a, i4  => (v66)), "jawcaro" + v21, "ocvcuvp", v21];
						var v69: set<array<bool>> := {v43, v43, v43};
						v21, v68, v69, v66 := v21 + v21, v68, v69 + (if (!f17) then v69 else v69), v66;
						var v70 := DC7(p2, p2, v0[90]);
						var v71: set<D2> := {DC7(0x18, -p1, p1), v70, DC7(v0[90], p2, |[p0, p0]|), v70, v70};
						var v72: map<set<D2>, bool> := map[v71 := !(p0 && f17)];
						v72 := v72[{DC7(p1, 0x311, v0[90]), v70, v70} := p0 && f17];
						v21 := v21;
				}
			...
			case DC12(cf21) =>
				...
				v75 := v75;
				var v76: map<bool, int> := map[false := v0[90]];
		...
		r0 := fm2(v0[90] % |v79|, p1 % v0[90], true <== p0, false, globalState);
		var v80: array<bool> := new bool[11];
		r1 := --fm2(p2, --0x8d, DC5(p1, v80, true, p1, p0).cf9, f17, globalState) * (p1 + v0[90]);
		r2 := DC11(true).cf20;
		r3 := v21[0x1e9];
	}
}
...
class C2 extends T0 {
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			var v6: set<int> := {p2};
			var v7: map<int, string> := map[-0xae := v2[if (v6 in v5) then v5[v6] else 0xb1 := v3]];
			v0[645], v1[449], v3 := -|"xrrlfcd"|, (if (0x2ab in v7) then v7[0x2ab] else if (true) then v2 else v2)[0x6b := v3], v3;
			globalState.f0 := p0;
		}
		...
		match (DC8(v9)) {
			case DC8(cf16) =>
				...
				v11 := (v11 + (v11 + (seq(0x2ed, i1  => (v10)))))[p2 := if (p0) then v10 else v10];
				var v12 := "uygyl";
		...
		if (true) {
			...
			var v18 := DC10(p0, multiset{p2, fm2(fm22(false, p1, globalState), |("vaifami")[p2 := v15]|, p1, !p0, globalState), p2, -p2, 0xbb} - v17);
			var v19: array<D0> := new D0[1](i2 => DC1(v15, -799, {-p2, |map[p2 := p0]|}, seq(-0x2c3, i3  => (v15))));
			var v20: set<int> := {-0xa9};
			var v21 := "a";
			var v22 := DC1(v15, p2, v20, v21);
			v19[287] := v22;
			v16, v18, r0, v19[287] := v16[fm3(v21, globalState) := p1] + v16, v18.(cf19 := v17 + v17), p2, DC1(v15, p2, v20, v21);
			...
			if (v25 !in (v26 - v26)) {
				...
				var v36: map<string, bool> := map[seq(0x2f0, i4  => ('m')) := v24.f17];
				v36 := v36[v21 := v24.f17];
				v8[636] := p2;
				...
				var v40 := DC5(fm2(-|v39|, p2, v34, p1, globalState), v23, v34 ==> p0, (if (p2 in v24.f18) then v24.f18[p2] else v32) / v8[636], true);
			...
			if (p0 <== p0) {
				...
				v45[768] := v8;
				v44[934], v45[768] := p1, v8;
				globalState.f0 := v44[934];
				var v46: seq<multiset<bool>> := [multiset{p0, p1, p0, true, true}];
				var v47: seq<bool> := [v44[934], p0, v42 < v42];
				var v48 := DC5(0x226, v44, !p0, p2, v44[934]);
				var v49: map<int, int> := map[p2 := |[p0]|];
				var v50: map<bool, int> := map[p1 := p2];
				var v51: seq<int> := [p2];
				var v52: seq<int> := [if (p0 in v50) then v50[p0] else v51[p2]];
				var v53 := "rn";
				var v54: map<bool, bool> := map[false := p0];
				var v55: multiset<int> := multiset{|v52|, p2, p2, |v53|, |v54|};
				v46, v47, globalState.f0, r0 := if (v44[934]) then v46 else v46 + v46, v47, v48.cf9, if (p2 in v49) then v49[p2] else |v55|;
			} else {
				var v56 := "lkkc";
				v56 := v56;
				globalState.f0 := p0;
			...
			var v57 := "ppubx";
			var v58 := 'g';
			globalState.f0 := (v57[-0x3a9 := v58] < "rm") ==> p1;
...
class C3 extends T2 {
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v8 := DC30(p1, v6, v7, seq(-460, i1  => (v6)));
		...
		if (if (f5) then f5 || f5 else f22) {
			...
			match (v13) {
				case DC10(cf18, cf19) =>
					...
					var v19 := 'c';
					var v20 := "ehgnkp";
					var v21 := m0(v18, v0, map[v19 := v12], v17[|v17|] <== v11.fm3(v20, globalState), globalState);
					var v22 := new C1(f5, cf19);
					cf19 := cf19;
				case DC11(cf20) =>
					var v23: multiset<int> := multiset{v0};
					var v24 := new C1(f22, v23 - v23[v12 := v0]);
					var v25 := "qxrylh";
					var v26: array<set<bool>> := new set<bool>[1] [{!v24.f17, f5}];
					var v27: array<bool> := new bool[24](i2 => f22);
					var v28: seq<bool> := [f5];
					v27[842] := v28[v0];
					v0, v25, cf20, v26, v27[842] := (-v0 % v0) / (|v25| - v0), v25, f22, v26, v24.f17;
					v12 := v0;
				...
				case DC12(cf21) =>
					...
					v39[427] := fm4(v0, true, globalState);
					var v40: array<int> := new int[19](i3 => i3 % v12);
					...
					v39[427], v40, v41, globalState.f0, v42 := (v34 + v34) + (v34 + v34), v40, (if (|v41| in v43) then v43[|v41|] else v41)[v0 * (if (v44 in v45) then v45[v44] else 0xab) := if (f5) then v42.f19 else v12], f22, v42;
			...
			v47[421] := (map[!f5 := |v48|])[f22 := |v49|] != v50;
		} else {
			globalState.f0 := f22;
			if (!f5) {
				var v51: set<bool> := {f5};
				...
				var v59: array<bool> := new bool[26] [v0 != |v54|, !f5, if (true in v55) then v55[true] else true, f5, f5, fm3(if (f22 in v57) then v57[f22] else v56, globalState), f5, true ==> f5, |v58| > v0, v54[v0], !(!f5 && !f22), f22, true, f5, false, false, f5, !f22, v54 < v54, v54[v0], false <==> f5, f22 || f5, f22 && f5, !!false, true <== true, f22];
				v59[174] := f22;
				v59[174] := v53 !! v53;
				...
				var v63: seq<bool> := [v62 > {seq(0x27c, i7  => (v0)), seq(35, i8  => (v0)), v61}];
				var v64 := "t";
				var v65 := 'r';
				v63 := fm53(f5, v0, v64 + (seq(84, i9  => ('f')))[|v61| := v65], globalState);
				var v66 := new C2();
				v0 := v0;
				var v67: map<bool, bool> := map[f22 := f5];
				var v68: map<bool, bool> := map[f5 := if (f22 in v67) then v67[f22] else f22];
				v68 := v68[f5 := v0 != |v64|];
				r0 := |((v64[v0 := v65] + fm0(f22, globalState)) + v64)|;
			}
		...
		for i10 := 0x187 to -v0 {
			...
			match (v85.(cf36 := f22)) {
				...
				case DC25() =>
					...
					var v88, v89, v90, v91 := v75.m15(v81[i10 := v78] !in v87, i10, i10, globalState);
					var v92 := new C2();
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		v3 := v3[v5 < fm55(true, f5, v0, v0, globalState) := map[v1 := v1[-0x1a6 := 307]]];
		var v6 := 'j';
		v6 := v6;
		...
		var i0 := 0;
		while (if (v8 > v8) then f5 else fm3(v4[v0 := v6], globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			i0 := i0 + 1;
			var v9 := new C0(|"sqawpdcx"| / |[f22]|);
			v7[205] := fm3("tmiftso", globalState);
			var v10 := new C0(v0);
			globalState.f0, globalState.f0, globalState.f0 := !(if (f22) then -v9.f19 <= v10.f19 else f5), v7[205], v7[205];
		}
		var i1 := 0;
		while (f4 in {f4})
			decreases 100 - i1
		{
			...
			v0 := v0;
			var v12 := DC22(v7[205], f22);
			var v13: array<D7> := new D7[15] [v12, v12, v12, v12, v12, v12, v12, DC22(v7[205], f22), v12, v12, v12, v12, v12, v12, v12];
			v13[245] := v12;
			var v14: set<char> := {v6};
			var v15: map<int, bool> := map[v0 := v14 > v14];
			var v16 := DC24(v0, |fm53(v7[205], v0, v4[v0 := v6], globalState)|, v7[205], v7);
			v13[245], v0, v15 := DC22(v16.cf36, v7[205]), v0, v15;
		}
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		f4[402] := p2;
		...
		var v4: seq<bool> := [p1];
		var v5: set<bool> := {p1, p1, v4[|v4|]};
		var v6: seq<int> := [p2, p2, p2];
		var v7 := "mjepbeho";
		var v8: map<int, bool> := map[p2 := fm3(v7, globalState)];
		var v9: multiset<bool> := multiset{p1};
		r0, f4[402], r0 := |(v1 + v1)|, |v3|, if (f22) then |v5| else -v6[|v8|] - (if (!f5 in v9) then v9[!f5] else p2);
		var v10: array<int> := new int[11](i0 => i0 - f4[402]);
		var v11: map<int, array<int>> := map[p2 := v10];
		var v12: seq<array<int>> := [v10, v10];
		var v13: array<array<int>> := new array<int>[18] [v10, v10, if (f4[402] in v11) then v11[f4[402]] else v10, if (p1) then v10 else v10, v10, v10, v10, v10, v10, v10, v12[p2], v10, v10, v10, v10, v12[f4[402]], v10, v10];
		v13[998] := v10;
		v13[998] := v10;
		var v14 := DC3(v4);
		var v15: array<seq<bool>> := new seq<bool>[23] [fm53(f5, |v6|, ("bbycdl")[|v8| := v2], globalState) + [p0, false], v4, ([f22])[-p2 := true], [f22, f22, p0], [f22], ([p1, p1, p1])[f4[402] := p1] + v4, v4[p2 := f5], v4, (v4 + v4)[f4[402] := p1], [p0], v4, (v4 + v4)[p2 := fm3(v7, globalState)], v4 + v4, v4, [false, f5], v14.cf6, [f5, p1, f5], v4 + v4, v4 + fm53(true, f4[402], v7, globalState), v4, v4, v4, v4 + v4];
		...
		if (-p2 == f4[402]) {
			var v17: multiset<int> := multiset{p2, f4[402], p2};
			var v18: map<bool, int> := map[p2 <= |v17| := f4[402]];
			v18 := map[f5 := -(|(seq(0xee, i3  => (v2)))| + p2)];
			f4[402] := fm2(p2, p2, false, f5 !in v0, globalState);
			v2 := v2;
			v11 := v11;
			v18 := v18[v4[|v7|] := |(seq(-192, i4  => (|v7|)))|];
		} else {
			globalState.f0 := v7 < "be";
			var v19: multiset<int> := multiset{|v7[|v7| := v2]|, p2};
			r0 := -|v19|;
			f4[402] := f4[402];
			f4[402], v1, r0 := -f4[402], v1 * (set v20 : int | (0x335 <= v20) && (v20 < 0x3b7) :: (v20 * 0x3b3)), f4[402];
			if (p1) {
				v7 := v7;
				v13 := v13;
				...
				v21[347] := v16;
				v21[347] := v16;
				var v22: map<char, map<string, int>> := map[v7[p2] := fm57(globalState)];
				...
				v5, globalState.f0, v13[998], r0, f4[402] := (if (f22) then v5 else v5) * {f5, p0, f22}, f5, if (v8 in v24) then v24[v8] else v10, ---|v7|, |(v7 + "tjqiwjwht")|;
				v2 := v2;
			}
			
		}
		
		globalState.f0 := v7 < (fm4(121, false, globalState))[f4[402] := v2];
		r0 := p2;
	}
	method m17(p0: seq<bool>, p1: int, p2: array<int>, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3: multiset<int> := multiset{v0, v0, -v2[fm2(v0, v0, !f22, f22, globalState)]};
			...
			v0 := |(f21 * f21)| / (if (map[p1 := p1] in v6) then v6[map[p1 := p1]] else p1);
			var v7 := new C0(0x11a);
			var v8: map<bool, bool> := map[f22 := f22];
			v8 := v8[v4.f17 := p3];
		}
		f4[883] := -269;
		f4[883] := fm2(p1, 0x308, f22, p3, globalState);
		var v9 := DC3(p0);
		var v10: seq<seq<bool>> := [p0 + p0, p0, p0 + (v9.(cf6 := p0)).cf6];
		v10 := (v10 + [p0, p0, p0, p0, p0]) + v10;
		var v11: set<int> := {f4[883]};
		...
		if (true) {
			...
			var v17: multiset<int> := multiset{f4[883], |v16|};
			v0 := f4[883] / |v17|;
			...
			v19[938] := (if (p2 in v21) then v21[p2] else v20) >= ((if (p0 in v22) then v22[p0] else v20) - v20);
			var v23: map<bool, array<int>> := map[f22 := p2];
			match (DC7(|v23|, v0 / v0, v0)) {
				case DC7(cf13, cf14, cf15) =>
					var v24 := 't';
					var v25: map<bool, int> := map[!true := f4[883]];
				...
				case DC6(cf12) =>
					...
					v0 := v0 + 0x236;
					var v26: map<multiset<int>, bool> := map[multiset([|v12|, fm2(fm2(p1, |{f5}|, true, v18.f17, globalState), |f21[v19 := p1]|, v19[938], cf12, globalState), f4[883], f4[883], f4[883]]) := v19[938]];
			...
			globalState.f0 := multiset{|v11|, f4[883], |v29|, v0, fm2(0x1ca, 933, f5, p3, globalState)} != (v31 - v31);
			if ((if (f5) then f4[883] else p1) <= v0) {
				var v32: array<string> := new string[8](i2 => v30);
				v32 := v32;
				var v33: map<seq<int>, int> := map[v29 := |v30|];
				var v34 := DC35(p1, f5, v33);
				var v35 := 'e';
				var v36 := m0(v10, v34.cf53, map[v35 := -f4[883]], p3 <==> f22, globalState);
				f4[883], v0 := v0, p1;
				...
				v36[334] := v38 !in v40;
				v36[334] := if (p0[p1]) then f5 else p3 && false;
				var v41: map<bool, int> := map[p3 := v0];
				f4[883] := --(-(-f4[883] + v0) - (f4[883] + |v41|));
			} else {
				v29 := v29;
				var v42 := new C2();
				var v43 := 'p';
			...
			var v47 := DC35(v0, p3, map[[fm2(f4[883], f4[883], f5, f22, globalState), 351] := v0]);
			v45 := if (v47.cf53 in v46) then v46[v47.cf53] else v45;
			var v48: array<bool> := new bool[21](i3 => f22);
			v48[636] := p3;
			v48[636] := fm3("si", globalState);
	...
	method m18(p0: bool, p1: bool, p2: bool, globalState: GlobalState) returns (r0: set<set<int>>, r1: int) {
		match (DC9(f4)) {
			case DC10(cf18, cf19) =>
				...
				v3[229], v6, v0 := v5 + v5, v6, if (v1 < v1) then v0 else v0;
			case DC11(cf20) =>
				var v7 := DC11(cf20);
				var v8 := DC12(v7);
				v8 := v8;
				...
				var v18 := 0x94;
				var v19: array<array<bool>> := new array<bool>[29] [v14, if (p0 in v15) then v15[p0] else v16[|v17|], v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v14, v16[v18], v14, v14, v14, v14, v14, v14];
				v19 := v19;
			...
			case DC9(cf17) =>
				...
				var v26 := DC20(v25);
				var v27: map<bool, D7> := map[fm3(seq(0x1eb, i1  => ('k')), globalState) := v26.(cf28 := v25)];
				v27 := v27[f22 := DC20(v25)];
				var v28: array<map<bool, int>> := new map<bool, int>[9];
				var v29: map<bool, int> := map[f5 := v22];
				v28[905] := v29;
				var v30 := "ayslmmgbh";
				globalState.f0, v22, v28[905], globalState.f0, v30 := f5, -v22, v29, p0, v30 + v30;
			...
			case DC12(cf21) =>
				...
				var v39: map<bool, bool> := map[v34[v31] := f5];
		...
		for i2 := |"sirxk"| / v43 to v43 + v43 {
			...
			if (!DC22(p1, p2).cf32) {
				...
				v51[504] := p0;
				v51[504] := (v46 != v46) <== (i2 > |v44|);
				var v52: seq<int> := [i2, i2 + i2];
				v43 := v52[v43 - -i2];
				var v53: multiset<int> := multiset{i2};
				var v54 := new C1(v43 < |v53|, v53 - (multiset{v43, 0x170})[i2 := v43]);
			...
			decreases 100 - i5
		{
			...
			if (fm3(v57 + "jrkvsvff", globalState)) {
				globalState.f0 := p2;
				var v58: map<int, string> := map[-v43 := seq(241, i6  => ('m'))];
				...
				var v68: map<string, string> := map[v67[v43] := v57];
			...
			match (v84) {
				case DC19(cf26, cf27) =>
					var v85: seq<seq<bool>> := [v82[v43 := false]];
					var v86 := 'i';
					...
					v57 := ("jpfs")[if (v43 in v91) then v91[v43] else -v43 := v86];
				case DC18(cf25) =>
					...
					var v105: seq<seq<int>> := [seq(0x210, i12  => (v98[v43])), v98];
					var v106: array<seq<int>> := new seq<int>[28] [v98, v98, v98, [|v99|, v43], [v43], [|v100|, |v101[v43 := v43]|, v43] + v98[v43 := |v57|], v98, seq(-0x40, i7  => (v43)), v98, v98, v98 + v98, if (f22) then fm51(v43, f5, v43, p2, globalState) else if (p2 in v102) then v102[p2] else seq(631, i8  => (v43)), v98, v98, seq(-0x3ac, i9  => (v43)), v98 + v98, fm51(v43, f5, v43, f5, globalState), seq(0x2cb, i10  => (DC35(-561, p0, map[[v43, 823] := v43]).cf53)), v103.cf33, fm51(fm2(|[p0]|, v43, !f22, fm3(seq(0x282, i11  => (v93)), globalState), globalState), f22, v43, f5, globalState), if (true) then fm51(|map[p2 := f22]|, p1, |v57|, p2, globalState) else v98, if (false) then v98[v43 := |v104|] else [v43, 0x3d2], v105[v43], v98, if (f5 in v102) then v102[f5] else v98, v98, v98, v98 + v98];
					v106[546] := v98 + v98;
					v106[546] := v98;
					r1 := v43;
			}
		...
		var v111: seq<string> := [v109, v109, v109 + v110[v43]];
		var v112: map<int, int> := map[v43 := v43];
		var v113: seq<int> := [|v109|, |v112|];
		v109, v43 := v110[0x22e / 172], v43 * v113[v43];
		...
		var v117: set<set<int>> := {set v115 : int | v115 in map[v43 := seq(0x8, i13  => (v107))] :: (v115 / -|"bpnebxcrg"|), v116, v116 + v116, v116};
		r0 := v117;
		r1 := -v43;
	}
}
...
class C4 extends T3 {
	...
	function fm73(p0: string, p1: int, p2: bool, globalState: GlobalState): int {
		(387 / |"otn"|) + (if (f25) then 0x35c else -0x173)
	}
	...
	method m4(globalState: GlobalState) {
		...
		f4[335] := v3;
		var v5 := "kuxf";
		f4[335] := |(if (f25) then seq(-403, i1  => (v0[149])) else v5)|;
		v2[304] := f5;
		v2[304] := f25;
		if (!(if (!!f5) then f7 else f5)) {
			v3 := -f4[335];
			var v6: set<bool> := {f5};
			var v7: seq<bool> := [v2[304], f24, v2[304], true, v6 > {true, true}];
			v7 := v7 + v7;
			var v8: set<array<bool>> := {v2, v2, f6};
			var v9: map<int, string> := map[|v8| := v5];
			f4[335] := fm2(|(if (v3 in v9) then v9[v3] else v5)|, v3, f5, v2[304], globalState);
			var v10: map<bool, bool> := map[f5 := f5];
			var v11: seq<int> := [|v10|, f4[335]];
			...
			match (v15) {
				case DC24(cf34, cf35, cf36, cf37) =>
					v3 := cf35;
					var v16: array<int> := new int[4] [-cf34 + v3, cf34, f4[335] - cf35, -0x2c - v3];
					var v17: seq<seq<bool>> := [fm75(DC19(v16, f7).cf27, f5, |v5|, globalState)];
					f24, cf35, v16, v2 := (seq(0x72, i2  => ([f7]))) != v17, cf34, v16, v2;
					var v18: map<bool, bool> := map[v2[304] := f7];
					v18 := v18[f24 := v2[304]];
					var v19: seq<int> := [40];
					var v20: seq<seq<int>> := [v19, v19, v19, v19, v19];
					var v21: map<seq<char>, map<bool, bool>> := map[v5 := map[v2[304] := !f25]];
					var v22: map<int, map<seq<char>, map<bool, bool>>> := map[|(v19 + v20[cf34])| := v21 + map[v5 := v18]];
					var v23: seq<set<char>> := [{v0[149], v1}];
					var v24 := DC27(|v23[f4[335]]|, cf36, v3);
					v22 := v22[v24.cf41 := v21[v5 := v18]];
				case DC25() =>
					var v25: array<int> := new int[7];
					v25 := v25;
					v1 := v0[149];
					var v26: map<int, bool> := map[f4[335] := f25];
					v26 := v26;
					var v27 := DC7(v3, f4[335], |map[v0[149] := f24]|);
					var v28: set<int> := {f4[335]};
					v3, f4[335], f4[335], v5 := v3, -(-f4[335] % -v27.cf13) - (if (v2[304]) then f4[335] else -|v28|), v3, v5;
				case DC23(cf33) =>
					var v29: map<bool, bool> := map[|v5| == f4[335] := fm6(!v2[304], cf33, globalState)];
					v29 := v29[v2[304] := v2[304]];
					globalState.f0 := (v5 + (seq(0x20a, i3  => (v1)))) == (seq(0x8c, i4  => (v0[149])));
					var v30: set<bool> := {f25, f7};
					v3 := |[v30 <= v30, f25, !v2[304], if (f7) then f5 else true, {fm3(v5, globalState)} >= {f24}]|;
					v3 := v3 - (v3 + f4[335]);
			}
			
			var v31: multiset<char> := multiset{v1};
			f24, f4[335] := v31 !! v31, v3;
			var v32: map<int, bool> := map[f4[335] := v2[304] <==> f5];
			v32 := v32[f4[335] % v3 := f25];
		}
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if ((v0 + v0) !in v2) {
			var v3: seq<bool> := [f25];
			var v4: map<bool, int> := map[v3[v1] := v1];
			v4 := v4[f24 := v1 - v1];
			var v5 := 'n';
			...
			v12, v8.f17, globalState.f0, v1 := map[v1 := v4] + v12, f25, f25, v1 - (v1 % v1);
			v8.f17 := v3[v1];
		} else {
			...
			decreases 100 - i0
		{
			...
			if (f5) {
				...
				v19[119] := v23[v1];
				f4[295] := v1;
				var v24: set<bool> := {f6[814]};
				var v25: map<int, int> := map[v1 := |v24|];
				var v26: seq<bool> := [f6[814], f6[814]];
				var v27: array<bool> := new bool[25] [f5, f7, f25, true, f25, f7, f5, false, f25, f25, f6[814], f7, f5, f7, f5, f7, false, f25, !f24, f6[814], f7, f5, false, f5, f25];
				var v28: seq<array<bool>> := [v27];
				var v29 := DC39(v28, f5, v1);
				var v30: array<bool> := new bool[18] [f25, f24, f24, f7, f7, f6[814], f6[814], f6[814], f25, f25, f6[814], f6[814], f24, v26[v1], f24, f6[814], fm3(v0, globalState), v26[v29.cf65]];
				var v31 := DC5(v1, v27, f6[814], 916, f7);
				var v32: map<bool, bool> := map[f25 := true];
				var v33 := DC50(v25);
				var v37: set<int> := {v1};
				var v39: array<map<int, int>> := new map<int, int>[27] [v25[|v26| := v1] + map[v31.cf7 := |map[v27 := DC24(v1, v1, f25, v27).cf35]|], v25, v25, v25, (map[v1 := v1])[v1 := fm2(v1, fm2(v1, v1, f24, f25, globalState), f6[814], true, globalState)], v25, v25[|v24| := v1], v25, v25, v25 + v25, v25, v25, v25, fm80(-v1, v1, v32, globalState), v33.cf75 + map[v1 := v1], map v34 : int | (983 <= v34) && (v34 < 449) :: (v34 - -v1) := (v1), v25, v25, v25, v25, if (false) then v25 else v25, v25, map v35 : int | (0x243 <= v35) && (v35 < -948) :: (v35 / |(seq(0x233, i1  => (if (f25 in v20) then v20[f25] else v1)))|) := (v1), map[v1 := -|v22|], map v36 : int | (0x206 <= v36) && (v36 < 0x260) :: (v36 % 0xf1) := (v1), ((map[0x378 := 0x70])[|v37| := 820])[|v19[119]| := v1], (map v38 : int | (0x1fc <= v38) && (v38 < 0x1ed) :: (v38 % 926) := (v1)) + map[v1 := v1]];
				v39[773] := map v40 : int | (0x271 <= v40) && (v40 < 514) :: (v40 % v1) := (v1);
				f4[295], r0, v39[773], globalState.f0 := 0x218 / (|"u"| * v1), v1, v25, !(v1 > (if (true in v20) then v20[true] else v22[v1]));
				...
				var v45: map<int, bool> := map[v1 / v1 := v1 <= (if (f24 in v44) then v44[f24] else |[v1]|)];
				v45 := v45[v1 / v1 := v44 >= fm81(false, f25, v1, seq(812, i2  => (DC1('h', v1, {|v0|}, v0).cf1)), globalState)];
				var v46: seq<bool> := [f7];
				var v47: map<bool, int> := map[v46[v1] := v1];
				r0 := (v1 / v1) + (if (f24 in v47) then v47[f24] else v1);
				r0 := v1;
			}
			
			if (-0x2ca >= |map[seq(0x2d9, i3  => ('u')) := multiset{true, f25, f7}]|) {
				globalState.f0 := f5;
		...
		for i4 := 0xd6 to 780 {
			...
			var v64: set<int> := {|(seq(-0x3de, i5  => ('q')))|};
			v63[159] := v64;
			v63[159] := if (false) then v64 * v64 else v64;
		...
		f6[895] := if (v68 in v69) then v69[v68] else f5;
		r0 := v1;
		r1 := f25;
	}
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		var v3: seq<bool> := [v2[v0]];
		f6[138] := v2[-v0];
		if ((v0 / v0) >= v0) {
			f6[138] := f5;
			var v4: multiset<int> := multiset{v0, |v1|};
			var v5 := new C1(f6[138], v4 * multiset(v1));
			var v6: map<int, int> := map[v0 := v0 * v0];
			var v7 := "vvyljbgm";
			v6 := v6[v0 := -v0 * |v7|];
			var v8 := DC22(f6[138], f24);
			...
			if (f5) {
				...
				v0 := v0;
				v0 := v0;
				v2 := ([f25, f24 <== false])[0xf6 := f25];
				var v10: map<bool, char> := map[f24 := 'j'];
				var v11: map<int, bool> := map[|v10| := f25];
				v2 := (if (f6[138]) then v2 else [f6[138], v5.f17, f6[138], if (0xe6 in v11) then v11[0xe6] else false, f24]) + [f7];
			} else {
				v7 := v7;
				var v12 := DC0("hmfmve");
				var v13 := DC2(v12);
				var v14: map<int, D0> := map[-v0 % v0 := v13];
				...
				v0, v15, v0 := |(fm4(v0, f24, globalState) + v24[v0])|, v15, v0;
			}
			...
			v25[320] := fm82(v0, v1, globalState);
			var v26 := DC14();
			var v27 := DC17(v26);
			var v28 := DC17(v26);
			v25[320] := if (f6[138]) then v28 else v28;
			var v29 := 'c';
			...
			var v40: map<D0, bool> := map[v37 := f6[138]];
			v38 := v38 + ((map v39 : D0 | v39 in v40 :: (v39) := (|v32|)) + v38);
			f6[138] := fm74(globalState);
		}
		...
		var v48: map<set<int>, bool> := map[fm83(|(seq(0x6, i0  => ('e')))|, DC54(-130, v0, v47, v0, v0), globalState) := f7];
		var v49 := new C0(|v48|);
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := |v0[p2 := |v2|]| * p2 to 0x132 {
			...
			globalState.f0, f4[84], r0, r0, f24 := !(v7 > multiset{v5.fm3(v8, globalState)}), -p2, i0 % (i0 / |v8|), p2 + i0, f24 in v9[p2 := p0];
			var v10 := DC21(v5.f22, 0x341 / p2);
			match (v10) {
				case DC21(cf29, cf30) =>
					r0 := fm73(v8, fm73(fm4(-p2, f7, globalState), cf30, f7, globalState), f4[84] <= cf30, globalState);
					globalState.f0 := f7;
					f6[435] := v10.cf29;
					f6[435] := true;
					var v11 := 'a';
				...
				case DC22(cf31, cf32) =>
					...
					f6[332] := if (i0 in v14) then v14[i0] else cf32;
					globalState.f0 := cf32;
					globalState.f0 := f24;
				case DC20(cf28) =>
					var v15: array<seq<bool>> := new seq<bool>[26];
					v15[144] := fm75(true, false, 0x2bb, globalState);
					v15[144] := v9;
					r0 := p2;
					var v16 := new C0(238);
		...
		if (!f5) {
			...
			if (f7) {
				...
				var v21 := "ohtcbp";
				v20[842] := v21;
				globalState.f0, v20[842], r0, r0 := p2 != p2, (seq(0x235, i2  => (DC1('a', |v21|, set v22 : int | (0x75 <= v22) && (v22 < 0x151) :: (v22 % -0x2f0), v21).cf1))) + "xyl", fm73(fm0(f24, globalState), p2, f5, globalState), p2;
				v0 := v0;
				f6[974] := f7 ==> true;
				var v23 := 'y';
				var v24: map<array<bool>, bool> := map[f6 := true];
				var v25 := DC30(f4, v23, v24, v21);
				v20[842], f6[974] := v25.cf47, f24;
				var v26: map<bool, bool> := map[f5 := p1];
				var v27: map<char, bool> := map[v23 := f6[974]];
				...
				v31 := [f7, f7];
				f6[930] := -0x3c4 == p2;
				f6[930] := !fm3(v29, globalState);
			}
			
			if (p0) {
				f4[387] := p2;
				f4[387] := fm2(p2, p2, p2 >= p2, f5, globalState);
				...
				var v39 := DC56(v38);
				var v40: array<seq<array<D12>>> := new seq<array<D12>>[8] [v38, v38[p2 := v37], v38 + v38, v39.cf91 + v38, v38 + v38, v38, v38, [v37, v37]];
				v40[224] := v38 + v38;
				v40[224] := v38;
			} else {
				globalState.f0 := f7;
				r0 := if (p0) then p2 % p2 else |("xkvran" + "xprcu")|;
				r0 := p2 - p2;
				...
				v41[912] := if (f24) then (if (v1 in v43) then v43[v1] else map v44 : int | v44 in v0 :: (v44 + p2) := (f7))[p2 := f25] else map v45 : int | (158 <= v45) && (v45 < 0xdf) :: (v45 / -0xf3) := (false);
				v41[912] := v42;
			...
			var v48: array<int> := new int[10] [p2, p2, -p2, p2, p2 / p2, p2 % p2, 0x256, p2, |"hhqfsvcu"|, p2];
			v48 := v48;
		} else {
			var v49 := new C2();
			var v50 := 'v';
			...
			if (v55 > (v55 * v55)) {
				...
				f24 := false;
				globalState.f0 := !v54[v51.f19];
				v53 := v53;
				f4[571] := |v54|;
				var v57: map<multiset<bool>, set<int>> := map[multiset(v54) := (set v56 : int | v56 in v1 :: (v56 / |[|[true]|]|)) + {-p2, 0x364, p2, -v51.f19}];
				var v59: multiset<bool> := multiset{p0};
				var v60: set<multiset<bool>> := {v59};
				r0, f4[571], v57 := v51.f19, 0x29, (v57 + (map v58 : multiset<bool> | v58 in v60 :: (v58) := (v55))) + v57;
			} else {
				var v61: map<int, bool> := map[v51.f19 := f24];
				var v62: multiset<bool> := multiset{f5, !!f7};
				f24, v61, v61 := v51.f19 != -(if (f24 in v62) then v62[f24] else 0x2fd), (v61 + (map v63 : int | (0xcf <= v63) && (v63 < 642) :: (v63 / v51.f19) := (false))) + (v61 + v61), (v61 + v61) + v61;
				...
				v65[788] := v66[DC5(-v51.f19, f6, true, if (f25 in v62) then v62[f25] else v51.f19, f24).cf7];
				var v67: map<bool, bool> := map[f7 := fm6(p1, v0, globalState)];
				v65[788] := ((v54 + [p1])[-|v67| := f7])[-759 := f25 && p1];
				f6[167] := f5;
				f6[167] := f24;
				r0 := v51.f19;
			}
		...
		if (if (p2 in v70) then v70[p2] else f24) {
			...
			match (v73.(cf28 := v72 * v72)) {
				...
				case DC22(cf31, cf32) =>
					...
					var v81 := "kkkdp";
					r0, v71, f6[872] := |(if (cf32) then v81 else "gw")|, v71, f5;
				case DC20(cf28) =>
					var v82 := "reaxnja";
					...
					var v88: map<bool, array<bool>> := map[v87[p2] := v86];
			...
			if (f7) {
				...
				var v96: array<int> := new int[5] [p2, p2 - p2, |v94[|multiset{|v95|}| := v93[v71 := f7]]|, p2, p2];
				v92, r0, v96 := v92, p2 % p2, f4;
				f4[208] := p2;
				f4[208] := p2;
			}
			...
			decreases 100 - i6
		{
			...
			var v117: map<D14, int> := map[v116 := p2 % p2];
			v117 := v117[v116 := fm73(seq(0xa2, i7  => (v114)), p2, f25, globalState)];
		}
		var v118: map<array<int>, int> := map[f4 := 0xea];
		if ((p2 % p2) == (if (f24) then p2 else -(if (f4 in v118) then v118[f4] else |v70|))) {
			var v119 := DC4();
			...
			if (!(((set v126 : int | v126 in (map v124 : int | v124 in v125 :: (v124 / v123.f19) := (p2)) :: (v126 / |map[true := false]|)) - v125) > v125)) {
				...
				var v134: map<seq<int>, int> := map[seq(0x1fc, i8  => (v123.f19)) := 604];
				...
				f6[251], r0, v131, v132, globalState.f0 := p1, p2, f4, if (if (v121.f17) then !p1 else p0) then f6 else v132, v138 <= multiset{v137};
			...
			match (v143) {
				case DC42(cf68) =>
					f4[887] := 0xdc;
					var v144 := "tf";
					f4[887] := if (f7) then |v144| else 0x62;
					r0 := p2;
					r0 := (if (cf68) then p2 else |(seq(0x3bc, i9  => ('n')))|) % f4[887];
					r0 := (p2 + f4[887]) / (p2 % f4[887]);
				case DC43() =>
					globalState.f0 := true;
				...
				case DC44() =>
					...
					var v151: array<array<bool>> := new array<bool>[20] [f6, f6, f6, f6, f6, f6, f6, f6, f6, v150[p2], f6, f6, f6, f6, f6, f6, f6, f6, f6, f6];
					v151[931] := f6;
					v151[931] := f6;
				...
				case DC41(cf67) =>
					...
					var v153 := new C0(p2);
					var v154 := "vrrco";
					var v155: map<bool, int> := map[p1 := f4[590]];
					var v156: seq<bool> := [false, v153.fm28(|v155|, 287, f5, globalState), f7, true, true];
					var v157: array<int> := new int[9] [0x84 - v153.f19, |[f5]|, |(seq(0xc9, i11  => ('u')))| + |v154|, 0x3bc, v0[f4[590]], f4[590], p2, |multiset(v156)| - v153.f19, p2];
					v157 := v157;
...
class C5 extends T1 {
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v1 := false;
		var v2: seq<bool> := [v1];
		var v3: array<bool> := new bool[23] [v1, v1, v1, !v1, v1, false, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, v2[f27], v1];
		var v4 := DC24(f27, 0x34e, fm3(v0, globalState), v3);
		var v5 := DC24(f27, fm2(f27, f27, true, true, globalState), fm3(seq(-0xa9, i1  => (f26)), globalState), v4.cf37);
		var i0 := 0;
		while (!v5.cf36)
			decreases 100 - i0
		{
			...
			match (v8) {
				case DC57(cf92, cf93, cf94, cf95, cf96) =>
					...
					var v11: map<string, T3> := map[v0[cf94 := f26] := v10];
					var v12: map<map<string, T3>, bool> := map[v11 := cf96];
					var v13 := new C4(v1, v1, v3, v9[v6 := cf93] !! v9, p1, if (v11 in v12) then v12[v11] else true);
					var v14 := 'o';
					v14 := v14;
					var v15 := new C2();
			...
			var v22 := new C3(v21, v1, p1, v2[f27]);
			var v23: seq<array<int>> := [p1];
			var v24: array<array<int>> := new array<int>[19] [p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, v23[|v0|], p1, p1, p1, p1, p1];
			var v25 := DC26(v24);
			...
			match (v25) {
				...
				case DC26(cf38) =>
					...
					v3[624] := !!(v44.cf75 !in (if (v41 in v45) then v45[v41] else v46));
					v3[624] := v1;
			}
			
			v2 := v2[f27 := v22.f22] + v2;
		}
		...
		for i3 := f27 to f27 {
			...
			var v63: map<multiset<int>, bool> := map[v62 := v3[666]];
			var v64: map<bool, int> := map[v1 := |v63|];
			var v65: seq<int> := [742];
			var v66: multiset<int> := multiset{if (f27 in v61) then v61[f27] else if (v3[666] in v64) then v64[v3[666]] else i3, f27, |v65[|v59| := |v0|]|, 0x26e, i3};
		...
		var i4 := 0;
		while (if ((v73 + (map v75 : int | (423 <= v75) && (v75 < 0x10d) :: (v75 / v70) := (DC28(map[v1 := v71]).cf42))) in v74) then v74[v73 + (map v75 : int | (423 <= v75) && (v75 < 0x10d) :: (v75 / v70) := (DC28(map[v1 := v71]).cf42))] else v71)
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			var v78: seq<int> := [|v0[|v77| := f26]|];
			v70 := if (v1 in v76) then v76[v1] else |v78|;
			var v79: map<bool, char> := map[v1 := f26];
			v79 := v79[v1 := f26];
			globalState.f0, f27, v71 := (|v0| % f27) <= (f27 / f27), f27, f27 == f27;
			var v80: seq<seq<bool>> := [fm93(f27, globalState), v2];
			var v81 := DC31(v80);
			var v82: map<char, int> := map[f26 := fm2(f27, f27, v71, !false, globalState)];
			var v83 := m0(v81.cf48, v70 / fm2(f27, v70, v1, v1, globalState), v82, f27 == fm2(f27, f27, v1, v1, globalState), globalState);
		}
		for i5 := f27 % |multiset{f27, f27}| to f27 {
			v70 := f27;
			var v84 := DC0("dja");
			v0 := v84.cf0;
			...
			v87 := v87[v1 := v86];
			if (!DC6(v1).cf12) {
				var v88: array<seq<int>> := new seq<int>[25](i6 => [v70] + (seq(0x64, i7  => (f27))));
				var v89: seq<int> := [v70];
				v88[813] := v89 + v89;
				v88[813] := seq(0x45, i8  => (v70));
				var v90: multiset<seq<bool>> := multiset{v2, v2};
				globalState.f0 := v90 > v90;
				v3[939] := v1;
				var v91: array<seq<char>> := new seq<char>[9];
				v91[584] := (seq(0x16e, i9  => ('q')))[f27 := f26];
				var v92: seq<seq<int>> := [[i5], v89];
				var v93: map<seq<int>, int> := map[v92[v70] := fm2(i5, v70, v1, true, globalState)];
				...
				v3[939], v71, v91[584], v71 := v71, i5 > (|v0| / (if (v88[813] in v93) then v93[v88[813]] else |v96|)), v0 + ((if (v70 in v97) then v97[v70] else fm0(v1, globalState)) + v0), v71;
				r0 := i5;
				v0 := v0 + "gceom";
			} else {
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		var v3: map<int, multiset<char>> := map[f27 := multiset{fm5(|"jo"|, false, v1[f27 := v0], v0, globalState), 'j'}];
		...
		var v7 := "yqw";
		var v8: array<int> := new int[25] [f27, f27 * f27, -(f27 / f27), f27, -f27, |v1|, f27, |v2|, f27, f27, v5.cf89, f27, f27, f27, |v6|, |v6| - 0x199, f27, f27, -f27, f27, |(if (false) then v7 else seq(0x2aa, i0  => (f26)))|, -f27, if (!v0) then 0x321 else 880, f27, f27 + -f27];
		v8 := v8;
		f27 := f27 * f27;
		var v9 := DC25();
		f27 := match v9 {
		...
		for i1 := fm2(fm2(|(seq(-939, i2  => (f26)))|, f27, v0, v0, globalState), 971, v0, v0, globalState) to f27 {
			if (!fm3(v7, globalState)) {
				...
				var v16 := DC10(v11.f17, if (f27 in v15) then v15[f27] else v11.f18[f27 := 29]);
				var v17: seq<D4> := [v16];
				v14[644] := v17 + (seq(0x350, i5  => (v16)));
				v14[644] := if (f27 > i1) then [DC10(v11.f17, v10), v16] else v17;
			} else {
			...
			var v33: multiset<int> := multiset{-i1, v29.fm22(true, v0, globalState), |(map v32 : int | (0x2ab <= v32) && (v32 < 0x38f) :: (v32 % f27) := (v0))|};
			var v34: array<bool> := new bool[25] [v30 < v30, v0, DC19(v8, v0).cf27, true, if (i1 in v31) then v31[i1] else v0, v0, v0, v0, false, !(v33 != fm96(v7, v7, if (f27 in v33) then v33[f27] else -i1, globalState)), v0, v0, !(i1 < -|fm97(globalState)|), v0, v0, v0, v1[f27], v0, v0, f27 >= f27, v7 != v7, v0, v0, v0, v0];
			v34[524] := v0;
			var v35 := DC44();
			v34[524], v35, v7, f27 := v0, v35, v7 + fm4(0x28d, v0, globalState), f27 % (i1 - |v30|);
			var v36 := DC30(v8, f26, map[v34 := true], v7);
			var v37: map<D11, int> := map[v36 := -761 - i1];
			var v38: map<array<bool>, bool> := map[v34 := true];
			v37 := ((map[v36 := f27])[DC30(v8, f26, v38, fm0(v34[524], globalState)) := f27] + v37) + v37;
		}
			...
			decreases 100 - i6
		{
			...
			v8[124], v0, v44, v8[124], globalState.f0 := f27, (v45 - v45) >= v45, [|v46[|v7|]|, -f27], v8[124], (v47 + (set v49 : int | v49 in (if (v8[124] in v48) then v48[v8[124]] else multiset{v8[124]}) :: (v49 * |multiset([DC51(false, true, 0x1a9).cf77, !false])|))) >= (v47 + v47);
			v8[124] := v8[124];
			var v50: array<seq<bool>> := new seq<bool>[14](i7 => v1);
			v50[728] := v1[v8[124] := v0];
			v50[728] := v1;
		}
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		if (v4[DC57(v2, f27, p2, |v5|, v0[191]).cf95]) {
			var v6: array<array<int>> := new array<int>[20];
			var v7: map<bool, array<array<int>>> := map[v0[191] := v6];
			...
			v0[191] := p0;
			var v10 := new C2();
			v0[191], v2, globalState.f0, globalState.f0 := p1, "yqmakvcs", p1, v0[191];
		} else {
			r0 := p2;
			var v11 := DC3(v4);
			var v12: array<seq<bool>> := new seq<bool>[20] [v4, v11.cf6, v4, v4, v4, ([v4[f27]])[0x182 := v0[191]], v4, v4 + v4, v4, v4, v4, v4, v4, v4 + v4, v4, v4[f27 := v0[191]], fm93(p2, globalState), v4, v4, v4];
			v12 := v12;
			var v13: set<seq<bool>> := {[p1, v0[191]]};
			v0[191], r0, globalState.f0 := p0, fm2(p2, |fm93(f27, globalState)|, p0, v0[191], globalState) * f27, (v4 !in v13) || p0;
			if (p0) {
				var v14: map<int, bool> := map[|v2| := v0[191]];
				var v15: seq<int> := [|v14|, f27];
				var v16: map<bool, bool> := map[p1 := v0[191]];
				var v17: array<int> := new int[12] [-p2, |v4|, if (p2 in v5) then v5[p2] else f27, p2 % p2, -|v15|, p2 % |v16|, f27, f27, |v2|, -p2 % |map[f27 := p2]|, -p2, p2];
				v17[382] := |v16|;
				var v18: array<array<D1>> := new array<D1>[20];
				var v19: array<D1> := new D1[22];
				v18[834] := v19;
				var v20: map<int, char> := map[|map[p1 := v0]| := f26];
				f27, v17[382], v2, f27, v18[834] := f27, |v20|, "njcbi", -f27, v19;
				var v21: set<char> := {'p', f26, f26, f26};
				var v22: map<int, set<char>> := map[p2 := v21];
				v21 := ((if (-0x1a4 in v22) then v22[-0x1a4] else {f26}) - v21) + v21;
				var v23: array<seq<seq<int>>> := new seq<seq<int>>[5](i1 => [(v15[v17[382] := f27])[p2 := v17[382]], v15, seq(0x230, i2  => (f27))]);
				v23[838] := seq(0x119, i3  => (v15));
				var v24: multiset<bool> := multiset{v0[191], v0[191]};
				var v25: seq<string> := [v2[fm2(0x20e, |v2|, p0, p1, globalState) := f26], "iy", v2];
				f27, v23[838] := |(v24 * v24)| + |v25|, ([v15])[f27 := v15] + fm98(f27, globalState);
				var v26 := 'e';
				v26 := v26;
				var v27, v28, v29, v30 := m19(!v0[191], v26 in v2, fm99(v17[382], v17[382], v17[382], v17[382], globalState), globalState);
			} else {
				var v31: array<array<bool>> := new array<bool>[23];
				v31[410] := v0;
				var v32: array<string> := new string[24](i4 => (v2[f27 := 's'])[p2 := f26]);
				v32[426] := v2;
				var v33 := DC25();
				var v35: map<set<int>, bool> := map[set v34 : int | (0x315 <= v34) && (v34 < 0x29a) :: (v34 - f27) := !p0];
				var v36 := DC24(f27, |v35|, !v0[191], v0);
				r0, v31[410], v32[426], v0, v33 := (p2 % f27) / (if (p2 in v5) then v5[p2] else 0x353), (v36.(cf37 := v0, cf36 := v0[191])).cf37, seq(-389, i5  => (f26)), v0, v33;
				var v37: array<multiset<seq<D19>>> := new multiset<seq<D19>>[5](i6 => multiset{[DC54(p2, f27, multiset{f26}, p2, |v4|), DC54(p2, |[f27]|, multiset{f26, f26}, |v1|, p2)], seq(0x20, i7  => (DC54(|multiset{f27, 0x196}|, |[p2]|, multiset{f26}, f27, p2)))});
				var v38: multiset<seq<D19>> := multiset{seq(-866, i8  => (DC54(p2, -0x334, multiset{f26}, 0x28a, f27)))};
				v37[516] := v38;
				v37[516] := v38;
				var v39: array<int> := new int[19];
				var v40: map<array<bool>, array<int>> := map[v31[410] := v39];
				...
				var v47: map<bool, bool> := map[v0[191] := false];
				var v48: array<int> := new int[25] [f27 / fm2(-0x10, |v1|, p0, p0, globalState), |v40|, |v4| * |(seq(0x367, i9  => (f26)))|, p2 % (if (v43 in v42) then v42[v43] else |v4|), p2 - p2, |(v45 + v45)|, f27 % |v46|, -p2, |(seq(0x235, i10  => (v32[426][|v41|])))|, -f27 % p2, |v47| * p2, if (p1) then p2 else 0xa1, f27, if (p1) then f27 else p2, -f27, |v43| - p2, f27 % 0x57, f27, 610, |(if (p0) then [if (true in v47) then v47[true] else p0] else v4)|, p2 % p2, p2, p2, |(v4 + v4)|, p2];
				v48 := v48;
				globalState.f0 := (f27 * p2) !in v5;
				v0[191] := v4[|v2| + (if (0x16c in v5) then v5[0x16c] else f27)];
			}
			
			var v49: map<bool, int> := map[p0 := p2];
			var v50: map<map<bool, int>, bool> := map[v49 := v0[191]];
			var v51 := DC11(p0);
			v50 := fm100(|(if (p1) then v4 else v4)|, v51, v2[0x289] in "qrhfg", globalState);
		}
		
		var v52: array<set<bool>> := new set<bool>[2](i11 => {v0[191]});
		var v53 := DC18(v52);
		v53 := v53;
		f27 := |v2[f27 := 'j']|;
		...
		match (DC17(if (v0[191] in v56) then v56[v0[191]] else v55)) {
			case DC14() =>
				var v57 := 'e';
				var v58: map<bool, char> := map[v4[|v54|] := v57];
			...
			case DC16() =>
				...
				v67[152] := -(if (v0 in v68) then v68[v0] else f27);
				var v69 := new C1(!p1, v5);
				var v70: array<D14> := new D14[9](i14 => DC38(map[map[f27 := p0] := -p2]));
				var v71: map<map<int, bool>, int> := map[map[f27 := v0[191]] := v67[152]];
				var v72 := DC38(v71);
				v70[406] := v72;
				v70[406] := v72;
			case DC13(cf22) =>
				...
				var v75: multiset<seq<bool>> := multiset{[v0[191], v0[191]], v4[p2 := v0[191]], v4[|v74| := false], v4, [false, p1]};
				v73[481] := v75;
				v73[481] := v75;
				var v76 := DC16();
				...
				var v78 := DC21(p1, |v2|);
				v77[394] := v78.cf30;
				v76, v77[394] := v76, 103 + |multiset(v2)|;
				v77[394] := 0x11f;
				var v79: map<int, int> := map[v77[394] := f27];
				globalState.f0 := !((v77[394] / -498) in v79);
			case DC17(cf24) =>
				var v80: seq<int> := [0xc1, f27];
				var v81: map<bool, seq<int>> := map[fm3(seq(355, i16  => (f26)), globalState) := v80];
				f27 := fm2(|(if (p1 in v81) then v81[p1] else v80)|, 769, !v0[191], v1 >= v1, globalState);
				var v82: array<seq<bool>> := new seq<bool>[16];
				v82[211] := v4;
				var v83: map<array<bool>, int> := map[v0 := f27];
				v82[211], v83, v2 := v4, v83 + v83, v2;
				var v84: array<int> := new int[21](i18 => i18 / p2);
				var v85: seq<seq<bool>> := [v82[211], v82[211]];
				var v86 := DC31(v85);
				var v87 := DC33(v86);
				var v88 := DC33(v86);
				...
				var v93: map<bool, seq<D19>> := map[v2 < (seq(192, i17  => ('r'))) := v92];
				v93 := map[v0[191] := v92] + v93;
				globalState.f0 := p1;
		}
		
		var v94 := DC37(DC36(0x1f7, p2, v0[191], v1, v0[191]));
		var v95 := DC37(v94);
		var v96 := DC37(v94);
		var v97 := DC37(v95);
		r0 := -match v97 {
			...
			case DC34(cf52) => |multiset{f26}| / |v5|
			case DC37(cf61) => -517
		};
	}
	method m19(p0: bool, p1: bool, p2: map<int, seq<int>>, globalState: GlobalState) returns (r0: map<bool, bool>, r1: string, r2: map<int, int>, r3: seq<array<char>>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v0: set<seq<int>> := {seq(0x72, i1  => (0x18c)), [f27, f27, f27, -0x257]};
		...
		var v9: multiset<bool> := multiset{p1};
		v8[715] := if (p0 in v9) then v9[p0] else f27;
		var v10 := 'm';
		globalState.f0, v8[715], globalState.f0, v10 := p1, f27, p1, v10;
		var v11: seq<bool> := [false];
		f27 := fm2(f27, f27, v11[f27], p1, globalState) + v8[715];
		var v12 := "otnrcoh";
		var v13: seq<string> := [v12, v12];
		var v14: set<int> := {v8[715], v8[715]};
		var v15: map<int, set<int>> := map[|v13| := v14];
		var v16: seq<int> := [v8[715], |v15|];
		match (fm103(-f27, |v16| / v8[715], seq(335, i2  => (f26)), globalState)) {
			case DC21(cf29, cf30) =>
				v8[715] := -v8[715];
				v8[715] := (f27 + 0xf8) * v16[f27];
				globalState.f0, f27, globalState.f0, cf29 := (seq(0xb1, i3  => ('x'))) != v12, if (p1 <==> p0) then fm2(cf30, cf30, cf29, p0, globalState) - cf30 else v8[715], multiset{true, false, cf29} !! (v9 + v9), v12 <= v12;
				f27 := f27;
			case DC22(cf31, cf32) =>
				cf31 := (seq(0x357, i4  => (v10))) == "rjqglksfk";
				...
				v18 := v18;
			case DC20(cf28) =>
				v8[715], r1, globalState.f0 := v8[715], (seq(-0x156, i5  => (v10)))[v8[715] := f26], p1 && p1;
				var v19: array<string> := new string[17](i6 => "b");
				v19[889] := v12;
				v19[889] := v12;
				v8[715] := |(if (p1) then v9 else multiset(v11 + [p0, p1, p0]))|;
				v8[715] := |fm0(if (false) then p0 else p1, globalState)|;
		}
		
		if (p0) {
			var v20: array<array<bool>> := new array<bool>[10];
			var v21, v22, v23 := m20(v20, 0x49 - v8[715], p1, p1, globalState);
			var v24 := DC9(v8);
			var v25: set<array<int>> := {v8, v24.cf17, v8};
			var v26 := DC8(v25);
			var v27: seq<D3> := [v26];
			var v28 := DC27(|v27|, p0 <==> v23, |v12|);
			v28 := fm104(v28, f27, v22, f27 + v8[715], globalState);
			v8[715] := v8[715];
			var v29 := new C2();
			v8 := v8;
		} else {
			v8[715] := fm2(v8[715] - v8[715], v8[715], if (p1) then p0 else p1, true, globalState);
			if (p1) {
				v10 := v10;
				v8 := v8;
				...
				v35[544] := v31;
				var v36 := DC7(f27, v8[715], f27);
				var v37: map<bool, int> := map[v36.cf14 != f27 := v8[715]];
				v34[426], v35[544], v37, v8[715] := fm105(globalState), v31, v37, (if (p0 in v9) then v9[p0] else v8[715]) % f27;
				...
				var v41, v42, v43 := m20(v40, fm2(f27, v8[715], p1, p0, globalState), true, p1 <==> p0, globalState);
				var v44 := DC42(p1);
			...
			if (p1) {
				...
				v50[7] := p0;
				v50[7] := p0;
				var v51: set<bool> := {p0, p0, v50[7]};
				v8[715] := fm2(|v12| / |multiset{v8, v8}|, f27, fm3(v12, globalState), v51 !! v51, globalState);
				v16 := v16;
				var v52: map<bool, int> := map[!true := v8[715]];
				var v53: set<set<int>> := {v14, v14, v14};
				v50[7], v8[715], v8[715], globalState.f0, v8[715] := v11 <= v11, |(("vam" + v12) + v12)|, if (fm3(v12, globalState) in v52) then v52[fm3(v12, globalState)] else |v53|, false, if (p0 in v52) then v52[p0] else v8[715];
				v50[7] := !true;
			}
			
			globalState.f0 := !p1;
			var v54: map<string, bool> := map[(seq(0x3d3, i8  => (f26))) + v12 := |v14| != f27];
			v54 := v54[v12 + v12 := p0];
		}
		
		var v55: map<int, multiset<bool>> := map[f27 := v9];
		var v56: set<multiset<bool>> := {v9, if (v8[715] in v55) then v55[v8[715]] else v9, v9 + v9};
		globalState.f0, v56, globalState.f0, v8[715] := (p0 <==> p0) && p1, v56, true, f27;
		var v57: map<bool, bool> := map[p1 := p1];
		r0 := v57;
		r1 := seq(-0x238, i9  => ('e'));
		var v58: map<int, int> := map[f27 := f27];
		r2 := fm106(v8[715], v8[715], f27, globalState) + v58;
		var v59: multiset<seq<int>> := multiset{[f27, 0x3bf]};
		var v60: array<char> := new char[20];
		var v61: seq<array<char>> := [v60, v60];
		var v62: map<seq<int>, seq<array<char>>> := map[v16 + [f27, if (v16 in v59) then v59[v16] else f27, v8[715]] := v61];
		r3 := if ((v16 + (seq(185, i10  => (|v12|)))) in v62) then v62[v16 + (seq(185, i10  => (|v12|)))] else v61;
	}
	method m20(p0: array<array<bool>>, p1: int, p2: bool, p3: bool, globalState: GlobalState) returns (r0: set<array<bool>>, r1: int, r2: bool) {
		...
		var v15: seq<string> := [v0, v0, v0, seq(195, i1  => (f26)), "p"];
		var v16: array<string> := new string[19] [v0, v0[|multiset{p2, p2}| := f26] + v0, v0 + v0, v0[|v13| := f26], v0, v0, fm4(|v14|, p2, globalState), v15[0x3d], v0, "oqwx", v0, v0, v0, v0 + v0, v0, v0, v0 + v0, v0, v0];
		v16 := v16;
...
class C6 extends T3 {
	...
	function fm4(p0: int, p1: bool, globalState: GlobalState): string {
		match DC10(f5, multiset([-0x309])) {
			...
			case DC9(cf17) => "s"
			case DC12(cf21) => "laihybtuy" + (seq(0x3c3, i0  => ('y')))
		}
	}
	function fm5(p0: int, p1: bool, p2: seq<bool>, p3: bool, globalState: GlobalState): char {
	...
	method m4(globalState: GlobalState) {
		...
		var v2 := 0x2e;
		var v3 := DC6(f7);
		globalState.f0, v0, globalState.f0, globalState.f0 := f7, v1[fm2(|(seq(0x1ac, i0  => ('b')))|, |"ryqdxmf"|, false, f7, globalState)], v2 < -(if (f7) then v2 else v2), match v3 {
		...
		if (!(if (f5) then f5 else f5)) {
			...
			var v13: array<multiset<array<int>>> := new multiset<array<int>>[14] [v12, multiset{f4}, if (f5) then multiset{f4} else v12, v12, v12, v12, v12, multiset{f4, f4, f4, f4}, v12, v12[f4 := |multiset{false, f5, f5, true, f7}|], v12, (multiset{f4})[f4 := v2], v12, multiset{f4}];
			v13[858] := v12 - v12;
			v13[858] := multiset{f4};
			if (f7 || f5) {
				...
				var v24: map<bool, int> := map[if (v22 in v23) then v23[v22] else f7 := |(seq(337, i1  => (v6)))|];
			...
			match (v30) {
				case DC1(cf1, cf2, cf3, cf4) =>
					...
					var v31 := new C0(v2);
					var v32 := DC11(f7);
					f4[889] := v31.fm27(v32, f5, globalState);
					var v33: multiset<int> := multiset{v2};
					f4[889] := fm2(0x34d, v2, f7, f7, globalState) % |v33|;
					var v34: array<multiset<int>> := new multiset<int>[6] [v33, v33, multiset{-v31.f19, |v33|}, v33, v33, v33];
					v34[747] := multiset{cf2, cf2, |v7|, v31.f19} * v33;
					v34[747] := if (!f5) then v33 else v33;
				case DC0(cf0) =>
					var v35: set<bool> := {f5};
					...
					f4[507] := -v2;
					f4[507] := -v2;
					var v39 := DC5((if (f4[507] in v38) then v38[f4[507]] else v2) % f4[507], f6, f5, f4[507], f5);
					v39 := v39;
				case DC2(cf5) =>
					v2 := -v2;
					...
					var v48: array<seq<int>> := new seq<int>[25] [v42, v42 + v42, v42, if (f7) then v42 else seq(-0x311, i2  => (v2)), v42 + v42, v42, v42, v42, seq(154, i3  => (v2)), (seq(751, i4  => (v2))) + v42, v42, fm70(f7, 0x220, globalState), v42[671 := v2], if (v43 in v44) then v44[v43] else v42, v42, v42, v42, [v2, v2], v42, v42, v42 + v42, v42, v42, [v2, |v46[v2]|, |v47|, 0x308, v2], v42];
					v48[863] := seq(0x265, i5  => (0x335));
					v48[863] := v42;
					var v49: C1 := new C1(true, v40);
					var v50: set<C1> := {v49};
					globalState.f0, globalState.f0, globalState.f0 := fm6(|v12| <= |v50|, v48[863], globalState), f7, f7;
					v2 := -0x1b4 - v2;
			}
			...
			if (if (f5) then f5 else fm3(v29, globalState) || !f7) {
				...
				var v62: T3 := new C4(f7, f5, f6, f5, f4, v4[|v61|]);
			...
			f4[879] := |v66| + (v2 % v2);
			if (f7) {
				var v68: map<bool, int> := map[f7 := |[v2, |(seq(19, i8  => (f4[879])))|]|];
				var v69: C0 := new C0(|v8|);
				var v70: multiset<C0> := multiset{v69, v69};
				var v71: multiset<char> := multiset{v6};
				var v72 := DC54(v2, 0x5c, v71, v69.f19, f4[879]);
				var v73 := DC36(|v68|, v2, f7, fm83(if (v69 in v70) then v70[v69] else v2, v72, globalState), f5);
				var v74: set<int> := {v73.cf56};
				var v75 := DC1(v6, f4[879], v74, v66);
				var v76: seq<string> := [v66, v66, v75.cf4, seq(-0x2aa, i9  => (v6)), fm0(f7, globalState)];
				var v77: set<string> := {v66, seq(0xf3, i7  => (v6)), "jpusesqo", v76[|v74|], v66};
				v77 := v77;
				var v78 := DC15(f5);
				...
				var v82: array<int> := new int[16](i11 => i11 - f4[879]);
				var v83 := new C3(v81, if (f7) then v4[v2] else f5, if (f5) then v82 else v82, f5);
			} else {
				var v84: seq<int> := [0x92 * |v7|, f4[879], fm2(f4[879], -v2, f5, f5, globalState)];
				var v85: map<char, char> := map[v6 := v6];
				f4[879], globalState.f0, globalState.f0, v6, v84 := v2 - f4[879], f7, !f7, if (v6 in v85) then v85[v6] else v6, v84;
				var v86: map<array<bool>, bool> := map[f6 := f5];
				var v87: map<multiset<bool>, map<array<bool>, bool>> := map[v7 := v86];
				v87 := v87[v7 := v86];
				var v88: array<int> := new int[28](i12 => i12 + f4[879]);
				var v89: map<bool, array<int>> := map[f7 := v88];
				v89 := v89[f5 := v88];
				var v90: array<string> := new string[12];
				v90[263] := v66 + v66;
				v2, v90[263] := |multiset{v84, v84, v84, v84, fm79(|[f7]|, globalState)}|, "wotrf" + v66;
				var v91: map<bool, int> := map[f7 := f4[879]];
				v91 := v91;
			}
		...
		match (v104) {
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				match (fm90(v105 < v106.cf33, cf2, globalState)) {
					case DC42(cf68) =>
						cf2, cf4 := |cf4|, ("xexqui")[|v105| := cf1] + (fm0(f7, globalState) + v92[-0x2cf := 'm']);
						f4[799] := v2;
						var v107: array<string> := new string[17];
						v107[880] := (seq(-105, i13  => (cf1))) + "mxumtnv";
						var v108: multiset<char> := multiset{cf1};
						var v109: map<seq<int>, int> := map[[342, |v92|, |v4|, cf2] := cf2];
						var v110 := DC54(cf2, -v2, v108, cf2, |v109|);
						f4[799], v2, globalState.f0, v107[880] := (cf2 * cf2) * cf2, |(fm83(cf2, v110, globalState) * fm72(globalState))| - |v105[cf2 := cf2]|, f7, v92;
						var v111: set<bool> := {cf68};
						var v112: map<int, bool> := map[|v111| := f5];
						var v113: map<string, bool> := map[cf4 := cf68];
						var v114: array<int> := new int[14] [f4[799], v2, v2, v2, |v113|, cf2, 878, v2, f4[799], |cf3|, fm2(f4[799], cf2, f5, cf68, globalState), f4[799], f4[799], |(seq(-0x3d, i14  => (v6)))|];
						var v115 := new C4(cf68, cf2 <= f4[799], v9, if (cf2 in v112) then v112[cf2] else cf68, v114, if (f7) then f7 else v4[fm2(v2, f4[799], f5, cf68, globalState)]);
						f4[799] := cf2 % v2;
					case DC43() =>
						cf2, globalState.f0, globalState.f0, v2 := if (v4[|v105|]) then --|v4| else v2, f7 || true, f7, |fm75(f7, f5, v2, globalState)|;
					...
					case DC44() =>
						...
						v120 := new int[16] [-v105[|v105|], cf2, cf2 % v2, cf2 - v2, 138, -v2, v2 / |v121|, -|"gatpmqd"|, v2, v105[|v122|], v2, 0x6f, v2, |(multiset(v105) + v123)|, cf2, -v2 - cf2];
					case DC41(cf67) =>
						...
						v9[703] := f7;
						v92, v9[703], v2 := v92, if (true) then f7 else true in {f7}, v2;
						var v126: seq<string> := ["drokjsd", v92, cf4[v2 := cf1], cf4, cf4];
				...
				globalState.f0, f4[876], cf2, v134 := f5, -0x16e, cf2, v134;
				cf2 := f4[876];
				f4[876] := v2;
			case DC0(cf0) =>
				f6[570] := !f5;
				...
				f6[570] := (|[v2]| - v2) in v136[-fm2(832, v2, f5, f7, globalState)];
				var v137: set<int> := {v2};
				var v138 := new C4(f5, f7, v9, f7, f4, v137 > v137);
				var v139: multiset<int> := multiset{v2};
				var v140: map<multiset<int>, seq<int>> := map[if (v138.f25) then v139 else v139 := seq(0x22, i15  => (0x6c))];
				var v141: seq<int> := [v2];
			...
			case DC2(cf5) =>
				...
				globalState.f0, v144, v6, v2, v2 := !((if (v92[v2] in v145) then v145[v92[v2]] else f5) <== !f5), v144, DC30(f4, v6, v146, seq(0x1d4, i16  => (v6))).cf45, v2, v2;
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (f7) {
			...
			match (v10) {
				case DC57(cf92, cf93, cf94, cf95, cf96) =>
					...
					var v14: seq<int> := [v13[v2]];
					cf93 := v13[cf94 % cf94];
					globalState.f0 := multiset{cf96} > (multiset{true})[f7 := cf93];
					f6[676] := f5;
					f6[676] := false;
				case DC56(cf91) =>
					var v15: set<int> := {v3.f19};
					var v16: multiset<int> := multiset{-v3.f19};
					var v17: map<set<int>, bool> := map[v15 + v15 := multiset{v3.f19} > v16[v2 := v2]];
			...
			var v33: array<char> := new char[19] [v28.cf81, v24, if (f7) then fm5(|v30[v3.f19 := |(map v31 : int | v31 in v32[v3.f19 := f5] :: (v31 / v3.f19) := ('p'))|]|, true, v0, f5, globalState) else v24, v24, v24, 'r', 'k', v24, v24, v24, v24, 'm', v24, v24, v24, 'f', v24, if (f7) then v24 else v24, v24];
			v33[468] := fm5(fm2(-|v0|, v2, f7, f7, globalState), f7, v0, f5, globalState);
			v33[468] := v24;
			v4 := v4[v3.f19 := v2];
			var v34 := DC16();
			var v35: set<int> := {|v0|};
			f6[782] := v35 == {v2};
			var v36 := "bd";
			r1, v34, f6[782], globalState.f0 := !((fm0(f5, globalState) <= v36) ==> f5), v34, !!(f7 ==> (v30 <= v30)), v0[v3.f19];
		} else {
			var v37 := 0x1a6;
			r0 := -v37;
			if (f7) {
				...
				var v41: map<int, int> := map[v39[|v40|] := v37];
				globalState.f0 := fm2(v37, v38.f19, fm6(f7, v39, globalState), false, globalState) >= (|v41| % |v1|);
				...
				globalState.f0 := |([v48.f22, f7])[|(seq(0x9e, i0  => (v37)))| := f7]| > (if (f7) then --v37 else 0x32f);
				var v49: seq<int> := [v37];
			...
			v55[275] := v56;
			var v57 := DC14();
			v55[275], v57, v0, r0 := v56, v57, v0[v37 := f7], v37 + -0x3cc;
			v0 := v0 + v0;
		}
		...
		for i1 := -v58 to -0x8 {
			...
			var v67: array<array<bool>> := new array<bool>[19] [v65.cf37, f6, f6, f6, f6, f6, f6, f6, f6, if (v0[v58] in v66) then v66[v0[v58]] else f6, f6, if (f5) then f6 else f6, f6, f6, if (f7) then f6 else f6, f6, f6, f6, f6];
			v67[792] := if (f5 in v66) then v66[f5] else f6;
			var v68: seq<int> := [i1, v58, v58, |map[f4 := p1[718]]|];
			f6[932], v67[792], r1, p1[718] := f7, if (f7) then f6 else f6, |(v59 + v59)| != v68[-|v0|], p1[718] * v58;
		}
		var v69 := "wcaxmi";
		var i2 := 0;
		while (('p' in v69) ==> f5)
			decreases 100 - i2
		{
			...
			v73 := v73[v58 := v72];
			if (false) {
				var v74: map<int, bool> := map[v58 := f6[117] || f7];
				v74 := v74[if (true) then v58 else v58 := true];
				var v75: map<bool, bool> := map[f7 := false];
				var v76: array<bool> := new bool[29] [f6[117], f7, fm3(v69, globalState), f6[117], f5, f5, f5, v72.fm3("wyw", globalState), f6[117], f6[117], f5, f7, f6[117], f5, f7, !f5, f5, f6[117], f5, f6[117], f7, f5, if (f6[117] in v75) then v75[f6[117]] else f6[117], f7, f7, f7, f5, true, f5];
				var v77: multiset<array<bool>> := multiset{v76};
				var v78 := new C3(v77, f6[117], f4, f6[117]);
				var v79: set<bool> := {f6[117], f6[117]};
				v69, v58, f6[117], r1 := "ghdmya", v58 / |v0|, f6[117] <== f6[117], if (|v79| >= v58) then false else f5;
				v76 := v76;
				f4[95] := v58;
				var v80 := DC62(seq(0x10e, i3  => ({v70})));
				globalState.f0, f4[95], f6[117], v58 := f7, |fm107(f6[117], false, globalState)|, f7, if (v76 in v78.f21) then v78.f21[v76] else -|v80.cf105|;
			} else {
				var v81 := DC6(f5);
				var v82: map<D2, int> := map[v81 := -v58];
				v69, v70, r0, f6[117] := v69, 's', -((if (fm108(f5, 116, v58, false, globalState) in v82) then v82[fm108(f5, 116, v58, false, globalState)] else v58) % v58), f5;
				v58 := v58;
				var v83: array<bool> := new bool[27];
				var v84: multiset<array<bool>> := multiset{v83};
				var v85: multiset<int> := multiset{|[v58, v58]|, v58, v58, |(seq(0x1bc, i4  => (v70)))|, v58};
				var v86: map<int, int> := map[|(multiset{|v84|} + v85)| := |fm86(globalState)| * v58];
				v86 := v86[v58 % v58 := 0xe8];
		...
		var v93: array<int> := new int[11] [v58, 0x15c - |v91|, -|(v92 + v92)|, v58 % -v58, v58, v58 % |v69|, v58, v58 % -v58, |fm75(f5, f5, v58, globalState)|, if (v0[-v58]) then v58 else v58, v58];
		v93 := p1;
		var v94 := DC6(true);
		var v95: map<seq<bool>, string> := map[v0 := v69[-77 := fm68("xcg", v94.(cf12 := f5), f5, f5, globalState)]];
		v92 := v92[|v95| := v58];
		r0 := 0x239 + v58;
		r1 := !(v58 in v91);
	}
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		v0, v1, globalState.f0, v2[512] := v0 + v0[if (|v4| in v3) then v3[|v4|] else f5 := !true], v8[|(if (|v10| in v9) then v9[|v10|] else map v11 : int | (0x221 <= v11) && (v11 < 782) :: (v11 / v1) := (f7))|], f7 && !f7, f6;
		var v12: array<map<int, int>> := new map<int, int>[20];
		forall i0 | 0 <= i0 < v12.Length {
			v12[i0] := map[v1 % v1 := --0x74];
		}
		f4[183] := v1;
		f4[183] := v1;
		for i1 := -0x6e to v1 {
			...
			var v16: map<int, seq<string>> := map[|v15| - f4[183] := v15];
			v16 := v16[i1 := v15];
			f4[183] := f4[183];
			globalState.f0 := f5;
			...
			v21 := v21[fm6(true, ([0x318, v1, v1])[|map[f5 := f4[183]]| := v1], globalState) := [v20[-f4[183]]]];
		}
		var v22 := "s";
		var v23 := 'm';
		var v24: seq<bool> := [f7, f7];
		var v25 := DC1(v23, |v24[|v24| := f7]|, v4, v22);
		if ((v22 + v25.cf4) <= fm0(f5, globalState)) {
			v22 := if (f7) then v22 else v22 + v22;
			var v26: map<bool, seq<int>> := map[f7 := v8];
			f4[183] := |(if (f5 in v26) then v26[f5] else v8)| * |(map[v1 := v1])[v1 := f4[183]]|;
			if (f7) {
				v1 := |((v22 + v22) + (seq(454, i2  => (v23))))|;
				var v27: map<int, int> := map[v1 := v1];
				var v28: map<map<int, int>, int> := map[v27 := f4[183]];
				...
				f4[183], v24, f4[183], v1 := v1 * (if (v27 in v28) then v28[v27] else |"wviay"|), (v24 + v24) + (v24 + v24), |(v29 + ({f5} + v29))|, if (v31 in v32) then v32[v31] else v1;
				v2[512] := f6;
				v22 := (v22 + v22) + (seq(0x7b, i3  => (v23)))[fm2(v1, v1, f5, f7, globalState) := v23];
				var v33: multiset<array<bool>> := multiset{v2[512], v2[512]};
				var v34: array<int> := new int[12];
				var v35: map<char, bool> := map[v23 := f5];
				var v36: map<map<char, bool>, bool> := map[v35 := v24[--f4[183]]];
				...
				v38 := v38[v39 := -f4[183] % f4[183]];
				var v40 := new C1(f5, multiset{v1, 75, f4[183]});
				var v41: array<seq<bool>> := new seq<bool>[27];
				v41[418] := v24;
				v41[418] := if (f5) then [f5] else v24;
				v1 := -f4[183];
			}
			
			var v42: multiset<bool> := multiset{v5.cf40};
			globalState.f0 := v42 !! v42;
			var v43: multiset<int> := multiset{f4[183]};
			f4[183], v1 := v1, fm2(fm2(|v43|, 0x184, !f7, f5, globalState), fm2(|v43|, 0xc9, f5, f7, globalState), f7, !f5, globalState) * v1;
		} else {
			var v44 := DC31(seq(0x2bd, i4  => (v24)));
			var v45: map<int, D12> := map[v1 := v44];
			v45 := v45[v1 := v44];
			v2[512] := v2[512];
			f4[183] := v1;
			var v47: map<int, int> := map[-844 := |[f5, f5]|];
			var v48: set<map<int, int>> := {map v46 : int | v46 in (seq(0x3a1, i5  => (v1))) :: (v46 * 0x33a) := (v1), v47, v47};
			var v49 := DC59(v48);
			var v50: array<D22> := new D22[17] [if (f5) then v49.(cf98 := v48) else v49, v49, v49, v49, fm109(fm2(-v1, 852, f5, f7, globalState), f4[183], v1, globalState), v49, v49, v49, v49, v49, DC59({v47}), v49, v49, v49, v49, v49, v49];
			v50[174] := v49;
			v50[174] := v49;
			var v51 := DC16();
			match (v51) {
				case DC14() =>
					...
					var v53: array<int> := new int[27] [|v22|, |v52|, f4[183], |"pe"|, 0x145, f4[183], |v10|, f4[183], v1, 0x25b, |multiset{f7, f7}|, 0x2a7, -v1, -v1, -0x87, v1, v1, f4[183], |v22[v1 := 'f']|, v1, v1, f4[183], -f4[183], f4[183], v8[f4[183]], 0x217, f4[183]];
					var v54: set<array<int>> := {v53, v53};
					var v55 := DC8(v54);
					var v56: map<D3, bool> := map[v55 := f5];
					v56 := v56;
					var v57: array<C4> := new C4[28];
					var v58: C4 := new C4(f5, false, v2[512], !f7, v53, f5);
					v57[530] := v58;
					v57[530] := v58;
				...
				case DC15(cf23) =>
					...
					v1 := ---|(if (|v62| >= v1) then v47 else map[f4[183] := v1])|;
					f6[714] := f5;
					f6[714] := if (false) then f7 else f5;
					f6[714] := v22 != (v22 + v22);
					var v63: multiset<array<bool>> := multiset{v2[512], v2[512]};
					var v64: array<int> := new int[16](i6 => i6 / f4[183]);
					var v65: T2 := new C3(v63, f7, v64, v61.fm3(v22, globalState));
					var v66: multiset<T2> := multiset{v65, v65, v65};
					cf23, v1, f4[183] := -f4[183] > v1, f4[183], if (v65 in v66) then v66[v65] else f4[183];
				case DC16() =>
					var v68: map<int, map<int, int>> := map[|v22| := map v67 : int | v67 in multiset(v8) :: (v67 + v1) := (0x16a)];
					v8 := v8[-|(v3 + v3)| := |(if (|v3| in v68) then v68[|v3|] else v47)|];
					var v69: seq<string> := [seq(258, i7  => (v23)), "sa"];
					v22 := v69[f4[183]];
				...
				case DC13(cf22) =>
					...
					var v73 := DC60(v23, -0x51, f7, v23, f4[183]);
					v72 := (v72 + v72) * {v23, v23, v22[-0xb], v73.cf99, v23};
					var v75: set<set<int>> := {v4, if (true) then v4 else v4, set v74 : int | (0x1ef <= v74) && (v74 < -0x324) :: (v74 * f4[183])};
					v75 := (v75 - v75) * v75;
					v22 := v22;
					f4[183] := f4[183];
				case DC17(cf24) =>
					var v76: map<array<bool>, bool> := map[f6 := v24[|{f7, f5}|]];
					var v77: seq<map<array<bool>, bool>> := [v76];
					v76 := (v76 + v76) + v77[|v22|];
					globalState.f0 := f7;
					var v78: T1 := new C5(v23, v1);
					var v79 := DC32(v4, v78);
					var v80: map<int, T1> := map[f4[183] := v78];
					var v81: multiset<int> := multiset{v1};
					var v82: multiset<bool> := multiset{f5};
					var v83: map<D12, array<bool>> := map[v79.(cf50 := v78).(cf50 := if ((if (fm2(|v82|, f4[183], false, f5, globalState) in v81) then v81[fm2(|v82|, f4[183], false, f5, globalState)] else |v22|) in v80) then v80[if (fm2(|v82|, f4[183], false, f5, globalState) in v81) then v81[fm2(|v82|, f4[183], false, f5, globalState)] else |v22|] else v78) := f6];
					var v84 := DC24(v1, f4[183], f5, v2[512]);
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		var v16: map<int, bool> := map[603 := fm6(p0, seq(0x1b6, i2  => (0x216)), globalState)];
		v11 := new bool[10] [!fm6(!p1, v12[p2], globalState), f5, f5, p1, p1, |v13| <= p2, fm6(!true, if (|v15| in v14) then v14[|v15|] else seq(0x20, i1  => (-p2)), globalState), if (p2 in v16) then v16[p2] else p1, !f5, f7];
...
class C7 extends T1 {
	...
	function fm3(p0: string, globalState: GlobalState): bool {
		DC1('u', |[DC1('l', -0x2a8, set v0 : int | (-0x351 <= v0) && (v0 < 0x1f5) :: (v0 % |map[|(seq(258, i0  => ('i')))| := |map[!true := 'x']|]|), seq(0x378, i1  => ('o'))).cf1, 'y', 'q', 'h', 'k']|, set v1 : int | (-662 <= v1) && (v1 < 0x16) :: (v1 - |map[0xbf := 0x362]|), "ogkw").cf4 <= ("r" + "amofcxxt")
	}
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		var v0 := 0x285;
		var v1: set<int> := {v0};
		...
		r0 := v0;
		var v10 := new C2();
		var v11: map<bool, bool> := map[v9[427] := v9[427]];
		var v12: map<int, bool> := map[v0 := v9[427]];
		var v13: seq<int> := [-0x1a, v0, |v12|];
		var v14: map<bool, seq<int>> := map[v9[427] := v13];
		var v15: array<seq<int>> := new seq<int>[6] [v13, v13, v13, v13, (if (v3 in v14) then v14[v3] else v13)[|v4| := 44], seq(0x12f, i3  => (v0))];
		var v16: multiset<array<seq<int>>> := multiset{v15, v15};
		r0 := |v11| % (if (v15 in v16) then v16[v15] else v0);
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		for i0 := v0 to v0 {
			...
			if (v1) {
				...
				var v26: map<array<bool>, bool> := map[v24[|v25|] := true];
			...
			match (fm64(globalState).(cf52 := v33 + v33)) {
				...
				case DC36(cf56, cf57, cf58, cf59, cf60) =>
					...
					var v38 := new C0(cf57);
					var v39 := new C2();
					var v40: map<int, int> := map[cf57 := -cf56 / v0];
					v40 := v40[-cf56 := cf57];
				case DC34(cf52) =>
				...
				case DC37(cf61) =>
					...
					var v54: array<seq<D15>> := new seq<D15>[2] [v53[|v31|], v52];
					var v55: seq<array<seq<D15>>> := [v54, v54, v54, v54];
					var v56: map<int, array<seq<D15>>> := map[v0 := v54];
					var v57: array<array<seq<D15>>> := new array<seq<D15>>[26] [v54, v54, v55[i0], if (v0 in v56) then v56[v0] else v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54, v54];
					v57[801] := v54;
					v0, v57[801] := i0, v54;
					var v58: map<seq<int>, bool> := map[[|v5|] := (seq(0x260, i2  => (v2))) == v30];
					v58 := v58[seq(-508, i3  => (v0)) := [-i0] <= v31];
					...
					var v64: array<bool> := new bool[14] [v1, |v59| in v62, "ehkbiuj" != v30, v7.f17, true, v7.f17, v7.f17, v1, false, v7.f17, v7.f17, v63[v0], v1, v7.f17];
					v64[824] := v7.f17;
					v64[824] := v7.f17;
					v2 := 'l';
			}
		...
		if (|fm67(v0, v69, v69, globalState)| <= v0) {
			...
			v75 := v75;
			v74[514] := v70 < v70;
			v74[514] := if (fm3(v70, globalState)) then v69 else fm3(v70, globalState);
			if (fm3(v70, globalState)) {
				var v76: map<int, bool> := map[v0 := v69];
				globalState.f0 := if (v70 != v70) then v74[514] else map[v0 := v74[514]] != v76;
				var v77: seq<bool> := [v74[514], v74[514], true, v69];
				v0 := fm2(fm2(v0, 0x5a, v77[v0], v69, globalState), v0, fm2(v0, v0, v69, v69, globalState) != v0, false, globalState);
				v70 := v70;
				...
				globalState.f0, v70, v74, v0, v0 := v74[514], v70[v0 := v75], if (v74[514]) then v74 else v74, if ((v84 + v84) in v85) then v85[v84 + v84] else v0, v0;
				v0 := 0x1ea;
			...
			globalState.f0, globalState.f0, v0, v0, v0 := true, !fm3(v70, globalState), v88[|v89|] % fm2(v0, v0, v69, v69, globalState), v90.cf111 % v0, v0;
		}
			...
			decreases 100 - i6
		{
			...
			v0, v99[19], v100 := v0, v69 && (v69 && v69), v100;
			var v101: multiset<bool> := multiset{v99[19]};
			globalState.f0 := (v101 - fm81(v99[19], v69, v0, v70, globalState)) == v101;
			var v102 := v98.m1(v99[19], !v69, |v91| / v0, globalState);
		}
		var v103 := 'y';
		var v104: multiset<bool> := multiset{v69};
		v103, v0, v0 := fm5(|(v70 + "nk")|, v69, [v69], v69, globalState), 0x297, (if (v69 in v104) then v104[v69] else v0) % v0;
		globalState.f0, v0, v0 := fm3(v70, globalState) || ("xscq" < v70), v0, |(((seq(0x24c, i7  => (v103))) + v70) + v70)|;
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		match (match v4 {
			...
			case DC21(cf29, cf30) =>
				var v5: seq<int> := [v0[6], |"tossco"|, 0x2a6, p2];
				...
				if (p1) {
					...
					var v15: map<seq<bool>, int> := map[v1 := v5[v0[6]]];
					var v16: array<bool> := new bool[23] [p1 && p1, p0, cf29, if (p1) then fm3(v8, globalState) else cf29, p0, !p1, false, cf29, (if (|v3| in v10) then v10[|v3|] else v9) > v9, p1, !(v2 < v2), cf29, p1, cf29, cf29, false, p0, v1[p2], true, v14 != v14, cf29, v15 == v15, p1];
					v16 := v13;
					v0[6], v6 := |fm98(cf30, globalState)|, v6;
					var v17 := DC58(seq(0x28, i0  => (v8)));
					var v18: map<D21, int> := map[v17 := |v8|];
					var v19: map<bool, map<D21, int>> := map[!true := v18];
					var v20: seq<string> := [v8, v8];
					globalState.f0, cf30, cf29, v0[6], globalState.f0 := cf29 ==> fm3(v8, globalState), v0[6], v0[6] >= cf30, |(if (cf29 in v19) then v19[cf29] else v18)[v17.(cf97 := v20) := -(v0[6] + cf30)]|, p1;
					var v21: seq<array<bool>> := [v16];
					var v22: C4 := new C4(p1, !p1, v13, p1, v0, cf29);
					var v23: set<C4> := {v22, v22};
					var v24 := DC39([v21[|v23|]], p0, -cf30);
					var v25: seq<D14> := [v24];
					var v26: map<bool, bool> := map[[v24] != v25 := !!p1];
					globalState.f0 := if (p1 in v26) then v26[p1] else !false;
					v8 := fm4(|(seq(0x27d, i1  => (v11)))|, v22.f25, globalState);
				} else {
					r0 := fm2(v0[6], v0[6], p0, !p1, globalState) + -p2;
			...
			case DC22(cf31, cf32) =>
				...
				v39[750] := v2;
				v39[750] := {cf32};
				var v40: seq<int> := [v0[6] % p2];
				v40 := v40;
				var v41 := "bvq";
				var v42: array<bool> := new bool[13](i3 => cf31);
				var v43: map<seq<int>, array<bool>> := map[v40 := v42];
				var v44: map<array<bool>, int> := map[if (v40 in v43) then v43[v40] else v42 := v0[6]];
				globalState.f0 := (|v41| - v0[6]) <= (v0[6] % |v44|);
				v0[6] := v0[6];
			case DC20(cf28) =>
				var v45 := 'p';
				var v46 := "jnu";
				...
				v48 := v48;
				v0[6] := fm2(p2, v0[6], p0, p1, globalState);
				var v49: seq<int> := [v0[6], p2, v0[6], v0[6]];
				var v50: multiset<char> := multiset{v45, v45, v45, v45, v46[|v49|]};
				var v51: map<multiset<char>, int> := map[v50 := |v46|];
				var v52: set<int> := {v0[6], if (v50 in v51) then v51[v50] else |v46|, 660};
				var v53 := DC9(v0);
				var v54: map<bool, D4> := map[|v52| > -v0[6] := DC12(v53)];
		...
		var v61 := DC54(v0[6], v0[6], v60, p2, v0[6]);
		...
		var v70: map<string, char> := map[v57 := if (v0[6] in v69) then v69[v0[6]] else v59];
		v70 := v70[v57 := v59];
		var i5 := 0;
		while ({v0} <= {v0})
			decreases 100 - i5
...
class C8 extends T3 {
	...
	function fm6(p0: bool, p1: seq<int>, globalState: GlobalState): bool {
		--(615 % -|DC10(f7, multiset{|map[f5 := -0xa6]|, |map[0x3d3 := f5]|}).cf19|) != 0x33d
	}
	function fm4(p0: int, p1: bool, globalState: GlobalState): string {
		seq(678, i0  => (if (f7) then 'h' else 't'))
	}
	function fm5(p0: int, p1: bool, p2: seq<bool>, p3: bool, globalState: GlobalState): char {
		DC1('m', |[f7, f7, f5]|, {842, -|multiset{f5, true}|, |[|multiset([false])|]|, 969}, seq(-0x374, i0  => ('v'))).cf1
	}
	function fm3(p0: string, globalState: GlobalState): bool {
		55 < -65
	}
	method m4(globalState: GlobalState) {
		var v0: seq<char> := ['b'];
		var v1 := -649;
		var v2: multiset<char> := multiset{v0[v1]};
			...
			decreases 100 - i0
		{
			...
			f6[268] := f7;
			var v8: seq<bool> := [!f7];
			v1, v7[466], v1, f20[44], f6[268] := -v4.f19, v6[v4 := v5], v4.fm27(DC11(v8[v4.f19]), f5, globalState), v4.f19 >= v1, true;
			f4[579] := v1;
			f4[579] := (0x89 / 0x3d8) / (v4.f19 % v4.f19);
		}
		for i1 := v1 + -|(seq(-167, i2  => (v3)))| to -0x1dc {
			...
			var v17: set<bool> := {f5, fm3(seq(0x231, i3  => (v3)), globalState)};
			var v18: array<int> := new int[26] [-v9[i1], |v11|, -|(v12 - v12)|, i1, v1 % v1, |(if (f7 in v14) then v14[f7] else v15)|, |multiset{f7, f7}|, i1 + i1, 0x376, i1, v1, v1, i1 / |v16|, if (f7) then |v17| else i1, 0x332, v1, i1, i1, v1 * i1, |(v12[f7 := |v16|])[f7 := v1]|, (if (f7 in v16) then v16[f7] else i1) - v1, if (f5) then i1 else v1, |v17| * v1, |v12|, |v9|, 677];
			v18 := v18;
			var v19: set<int> := {i1};
			...
			match (v20) {
				...
				case DC0(cf0) =>
					...
					v25, v1, globalState.f0, globalState.f0 := v26[i1], i1 * i1, (v29 + v29) == v29, |v19| !in (seq(0x140, i4  => (i1)))[v1 := v1];
					var v30: map<char, bool> := map[v3 := f5];
					v30 := v30[v0[v1] := fm6(fm3("rvkgqvutq", globalState), v9, globalState)];
					globalState.f0 := false;
					globalState.f0 := f5;
				case DC2(cf5) =>
			...
			var v35: multiset<int> := multiset{i1 / v1, v1, v1};
			var v36 := DC10(f7, v35);
			v35 := v36.cf19;
		}
		...
		match (v40) {
			case DC10(cf18, cf19) =>
				...
				if (fm2(|v42|, |v44|, f7, f7, globalState) > (v1 * v1)) {
					...
					var v51: array<multiset<int>> := new multiset<int>[18] [multiset{v1, v1}, v37, v37, v37, cf19, v47.cf19, cf19, DC10(false, cf19).cf19 * multiset([0x290]), cf19, fm38(cf18, v1, globalState), cf19, multiset{v1}, cf19, multiset{|v48|, |v49|}, v37[v1 := |v50|], v37, cf19, v37];
					v51[157] := fm38(true, v1, globalState);
					v51[157] := multiset{-0x38};
					globalState.f0 := cf18;
					v0 := v0;
				} else {
					globalState.f0 := cf18;
					...
					var v54: seq<D2> := [fm39(f20[405], globalState)];
					var v55: map<bool, bool> := map[cf18 := cf18];
					var v56: array<seq<D2>> := new seq<D2>[5] [[v53], v54, (v54[v1 := v53])[|v55| := DC7(-|v0|, v1, v1)], v54, v54 + v54];
					v56[971] := v54;
					v52, v56[971], globalState.f0 := v52, [v53], f5;
				}
				
				globalState.f0 := false;
				var v57 := DC10(f7, v37);
				var v58: map<bool, bool> := map[v57.cf18 := v44[0x64] >= v43];
				v58 := v58["rqt" <= v0 := f5];
			...
			case DC11(cf20) =>
				...
				if (|(fm40(v1, |v72[-v1]|, globalState) + v73)| > v1) {
					globalState.f0 := !f5;
					var v74: map<array<bool>, bool> := map[f20 := f7];
					v0, v74, v37 := seq(0x176, i6  => (v3)), v74, v37 * (v37 + v37);
					f20[487] := cf20;
					f20[487] := cf20;
					cf20 := f5;
					v1 := v1;
				...
				v79[353] := v0;
				v79[353] := fm0(cf20, globalState);
				var v80: seq<array<bool>> := [f6, f6];
				var v81 := new C1(|v80| == v1, v37);
			case DC9(cf17) =>
				if (if (f5) then f5 else fm6(f7, seq(376, i7  => (v1)), globalState)) {
					globalState.f0 := f7;
					var v82: map<int, bool> := map[-0x223 := if (f5) then true else f7];
					var v83: seq<bool> := [f7, f7, f7, f5];
					f6[796] := v1 < |v83|;
					var v84 := DC10(f7, v37);
					v37, v82, f6[796] := fm38(f7, 0x2a1, globalState) + v37, fm40(v1 / v1, v1, globalState), v84.cf18;
					cf17[280] := 0x18a;
					var v85: set<bool> := {f5, false};
					var v86: multiset<D4> := multiset{v84};
					cf17[280] := -|(fm1(v1, v1, globalState) - v85)| / (if (v84 in v86) then v86[v84] else v1);
					var v87: multiset<bool> := multiset{f7, !f6[796]};
					var v88, v89, v90, v91 := m16(v1, v87[false := v1] >= v87, globalState);
					var v92 := new C2();
				} else {
					v1 := -(-v1 + v1);
					...
					var v99: array<set<char>> := new set<char>[12] [{v3}, v93 + v93, v93, v94[v95.cf7], v93, if (!f5) then v93 else v93, set v96 : char | v96 in {v3} :: (v96), v93 - v93, v93, {'y', v3, v3} + v93, if (fm6(f5, v97, globalState)) then v93 else v93, (fm41(|v98|, v1, v1, v1, globalState)).cf28];
					v99[529] := v93;
					var v100: set<bool> := {f7};
					v99[529], v1 := v93, -(if (v1 != |v100|) then v1 else v1);
					v1 := v1;
				...
				match (v104) {
					case DC14() =>
						...
						var v106 := DC7(v1, |(seq(242, i8  => (v3)))|, v1);
						var v107: map<multiset<string>, D2> := map[v105 := v106];
						var v108: seq<int> := [v1];
						var v109: map<int, int> := map[v1 := v108[v1]];
					...
					case DC15(cf23) =>
						...
						v1 := |(fm0(f7, globalState) + v112[v1])| * fm2(-0x283, v1, f5, !cf23, globalState);
					case DC16() =>
						f4[768] := v1;
						f4[768] := v1;
						v1 := -(if (f5) then v1 else f4[768]);
						f20[736] := !f7;
						var v113: array<D5> := new D5[28](i9 => DC16());
						var v114: seq<array<D5>> := [v113, v113, v113, v113];
						f20[736], v114, v1, f4[768], v3 := v0 == v0, (v114 + v114) + v114, -fm2(v1, f4[768], f7, f5, globalState) + f4[768], f4[768], v3;
						var v115: array<seq<bool>> := new seq<bool>[24];
						var v116: seq<bool> := [false];
						v115[628] := v116;
						var v117: seq<int> := [--(v1 / 155)];
						var v119 := DC1(v3, v1, set v118 : int | (376 <= v118) && (v118 < 0x9a) :: (v118 + v1), v0);
						var v120: set<string> := {v0};
						var v121: seq<seq<int>> := [v117];
						v1, v115[628], v117, globalState.f0 := v119.cf2, (v116 + v116)[|v120| := true], v121[-v1 * v1], f7;
					case DC13(cf22) =>
					...
					case DC17(cf24) =>
						...
						var v129 := DC23(seq(0x392, i14  => (v1)));
						var v130: array<seq<int>> := new seq<int>[24] [v125 + v125, [|v126|, v1, 0x338] + [v1, v1], seq(0xde, i10  => (|"df"|)), if (true) then v125 else v125, v125, v125[v1 := v1], [|v128|], v125, v125, v125 + [v1, v1], if (f7) then [v1] else v125, v125 + v125, v125 + v125, v125 + v125, seq(-0x3c0, i11  => (v1)), v125, v125 + (seq(0x67, i12  => (|v0|))), v125, seq(0x2d9, i13  => (-0x1ce)), fm42(globalState), fm42(globalState), v125, v125, v129.cf33];
						v130[689] := seq(-0xcf, i15  => (if (f5 in v126) then v126[f5] else v1));
						v1, v130[689] := v1 + (v1 + v1), if (f7) then v125 else v125;
						globalState.f0 := !f5;
						v1 := v1;
				}
				...
				cf17 := new int[19] [0xa - |[v132, v132, v132, seq(0x247, i16  => (|v0|)), v132]|, v1 + 0x120, v1, v1, v1, 0x11d, v1, |v133|, v1, v1, v1, v1, if (f7) then v1 else fm2(v132[v1], v1, f5, f5, globalState), v1 * |v134|, 0x364, v1, v1, -v1, v1];
			case DC12(cf21) =>
				...
				match (v136) {
					case DC24(cf34, cf35, cf36, cf37) =>
						...
						v1 := (if ((if (cf34 in v139) then v139[cf34] else v137) in v138) then v138[if (cf34 in v139) then v139[cf34] else v137] else cf34) % |v140|;
						var v141 := new C0(cf35 / cf35);
						globalState.f0 := !f5;
						var v142 := new C2();
					case DC25() =>
						var v143 := new C0(v1);
						var v144 := new C1(f5, v37);
						var v145: map<int, bool> := map[v143.f19 % v143.f19 := v144.f17];
						v145 := v145[|v0[v143.f19 := v3]| := f7];
						...
						f6[955], f4[423], v148[625], f20 := v149[|v145| % v143.f19], (v1 - v143.f19) % v1, set v150 : int | (28 <= v150) && (v150 < 532) :: (v150 / |v149|), v151[|v0|];
					case DC23(cf33) =>
						var v152: set<bool> := {f5};
						f4[99] := 0x19 / |v152|;
						f4[99] := v1;
						var v153 := new C2();
						var v154: array<int> := new int[4](i17 => i17 % v1);
						var v155: multiset<array<int>> := multiset{v154, v154};
						var v156: seq<multiset<array<int>>> := [v155];
						var v157: map<bool, multiset<array<int>>> := map[f7 := (v156[f4[99]])[v154 := f4[99]]];
		...
		for i19 := v1 to |[v3]| {
			f4[385] := -v1;
			f4[385] := i19;
			f20[401] := fm3(fm0(f5, globalState), globalState);
			f20[401] := i19 >= i19;
			var v162: map<bool, map<int, int>> := map[f5 := map[i19 := i19]];
			var v164: seq<int> := [v1];
			f4[385] := -((|(if (f7 in v162) then v162[f7] else map v163 : int | v163 in v164 :: (v163 % -v1) := (v1))| - v1) * 0x52);
			if (f5) {
				var v165: array<array<char>> := new array<char>[20];
				var v166: seq<bool> := [f20[401]];
				var v167: multiset<seq<bool>> := multiset{v166, v166};
				var v168: set<int> := {-|v167|};
				f20[401], f4[385], v165, f20[401] := v1 != |fm4(f4[385], f20[401], globalState)|, f4[385], v165, v168 >= v168;
				f4[385] := |fm43(-i19, v0 < v0, f7, globalState)|;
				f20[401] := !!f5;
				var v169: map<bool, int> := map[f5 := f4[385]];
				v169 := v169[v168 < v168 := f4[385]];
				v3 := v3;
			} else {
				v3 := v3;
				var v170: multiset<bool> := multiset{!f5, false, f5, !f20[401], f7};
				...
				var v175: set<bool> := {f7, v171[f4[385]]};
				v174 := v174[{f20[401], f5} != v175 := v0];
				var v176: array<array<int>> := new array<int>[24];
				var v177: seq<array<array<int>>> := [v176, v176, v176];
				var v178: array<array<array<int>>> := new array<array<int>>[4] [v176, v177[i19], v176, v176];
				v178[473] := v176;
				var v179: array<int> := new int[3];
				var v180 := DC19(v179, f5);
				v178[473] := new array<int>[10] [v179, v179, if (f20[401]) then v180.cf26 else v179, v179, v179, v179, if (f20[401]) then v179 else v179, v179, v179, v179];
			}
			
		}
		var v181: set<int> := {v1};
		var v182: set<int> := {|v181|};
		var v183 := DC1(v3, v1, v181, seq(960, i20  => (v3)));
		var v184 := DC2(v183);
		match (v184) {
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				match (v186) {
					...
					case DC16() =>
						...
						v198, f20[898], globalState.f0 := if ((cf2 >= v1) in v202) then v202[cf2 >= v1] else fm44(v1, globalState), !(v203 != [f5, f7, f5]), f5;
					case DC13(cf22) =>
						var v204: map<int, array<int>> := map[--v1 := f4];
						v204 := v204;
						var v205: multiset<bool> := multiset{f7, f5, !f7};
						globalState.f0, globalState.f0, cf2, globalState.f0 := f5 <== f5, v205 !! v205, -(v1 % v1), f7;
					...
					case DC17(cf24) =>
						...
						var v208: map<bool, int> := map[fm6(false, seq(0x21b, i22  => (cf2)), globalState) := v1];
			...
			case DC0(cf0) =>
				...
				globalState.f0 := !(|(v217[v1 := f5] + v217)| > (v1 - |v217|));
				var v218: map<bool, int> := map[f7 := -0x3e1 % v216.f19];
			...
			case DC2(cf5) =>
				...
				var v222: seq<int> := [v1];
				var v223 := new C1(f7, multiset{v1, |v222|, -0xd5, |(seq(0x2b3, i23  => (v3)))|, v1} * fm38(f5, v1, globalState));
				if ((-v1 + v1) <= (v1 % |v221|)) {
					f4[298] := v1 * 0x124;
					var v224: set<char> := {v3};
					var v225 := DC28(map[v223.f17 := v223.f17]);
					var v226: map<bool, int> := map[v223.f17 := 663];
					var v227: array<int> := new int[22] [|fm46(v223.f17, globalState)|, |(v0 + (fm4(v1, v223.f17, globalState))[v1 := v3])|, |v224|, -v1, v1, v1, |v0|, v1, 0x34, v1, |(v225.cf42[false := f5] + map[f5 := false])|, |fm4(|v222|, v223.f17, globalState)|, -v1, v1, fm2(|v222|, |v226[v223.f17 := fm2(v1, 670, v223.f17, f7, globalState)]|, f7, v223.f17, globalState), v1, -v1, v1, v1, if (v1 in v223.f18) then v223.f18[v1] else v1, 0x2d9, v1];
					...
					f4[298], v227 := |(if ((if (v223.f17 in v230) then v230[v223.f17] else |v231|) in v229) then v229[if (v223.f17 in v230) then v230[v223.f17] else |v231|] else v228)|, f4;
					var v232: seq<bool> := [f5];
					v1 := fm2(|v0|, --(-f4[298] % v1), v223.f17 ==> f7, v232[f4[298]], globalState);
					...
					f4[298], v234[420], v235[119] := f4[298], v0 + (if (-v222[-0x30a] in v236) then v236[-v222[-0x30a]] else seq(-0x29e, i25  => (v3))), if (v223.f17) then fm5(f4[298], f5, v232, v223.f17, globalState) else v3;
					var v237 := DC1(v3, v1, v182, v234[420]);
					var v238: set<bool> := {fm3("obfstydn", globalState)};
					var v239: map<int, seq<bool>> := map[v237.cf2 := fm47(|v238|, |v0|, globalState)];
					f4[298], globalState.f0, v223.f17, globalState.f0, v223.f17 := 0x25f % f4[298], v223.f18[f4[298] := f4[298]] > (v37 + v223.f18), f5, f7 in (if (v1 in v239) then v239[v1] else v232), v223.f17;
				} else {
					var v240: array<array<seq<int>>> := new array<seq<int>>[16];
					var v241: array<seq<int>> := new seq<int>[17](i26 => v222);
					v240[244] := v241;
					v240[244] := v241;
					globalState.f0 := v181 !! ((set v242 : int | v242 in v221 :: (v242 / -624)) * (set v243 : int | (-557 <= v243) && (v243 < 0x3bf) :: (v243 % v1)));
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		f4[660] := fm2(v0, fm2(v2.f19, |fm42(globalState)|, f5, f5, globalState), !f7, f5, globalState);
		...
		var v7 := "mxctmywn";
		v0 := fm2(|"us"|, v2.f19, !(v4 < v5[v0]), if (v7 in v6) then v6[v7] else f7, globalState);
		v7 := fm4(v2.f19 + f4[660], f7, globalState);
		if (f5) {
			globalState.f0 := f5;
			var v8 := 'v';
			...
			if (v0 > (v2.f19 % |v12|)) {
				...
				v17[937] := seq(-0x6d, i1  => (|multiset{'n', v8, v8}|));
				var v18: set<seq<int>> := {v11};
				var v19 := DC29(v18);
				v0, v17[937], v10.f17, v18, f4[660] := |(v4 + v4)| + v2.f19, v11, v2.f19 < 0x1fd, v19.cf43, v2.f19;
				f4[660] := f4[660] + v2.f19;
			} else {
				v0 := v2.f19;
				var v20: array<map<int, int>> := new map<int, int>[29](i2 => v1 + map[|map[v2.f19 := |v7|]| := v0]);
				v20[865] := v1;
				f4[660], v20[865] := v2.f19 - -0x11a, map v21 : int | (0x38d <= v21) && (v21 < 0x33c) :: (v21 / -v2.f19) := (-(if (false) then v2.f19 else v2.f19));
				r0, r0, f4[660] := v2.f19, fm2(v2.f19, 0x2ee, f7, f7, globalState) + v2.f19, |v10.f18[v2.f19 := v0 % 0xf5]|;
				var v22: set<seq<bool>> := {v4, v4, v4};
				var v23 := DC5(-(v2.f19 % -|v22|), f6, v8 !in v7, f4[660] - f4[660], v2.f19 == v2.f19);
				v23 := v23;
				v0 := v2.f19 + v0;
			}
			...
			var v26 := 'w';
			var v27: map<char, int> := map[v26 := f4[660]];
			...
			match (v31) {
				...
				case DC31(cf48) =>
					...
					v35 := v35;
					var v36: array<int> := new int[20](i3 => i3 % v2.f19);
					f4[660], r1, globalState.f0, v36, f4[660] := v0, f7 ==> ("h" < v7), f5, p1, v2.f19;
				...
				case DC33(cf51) =>
					...
					v37[247] := v40.cf1;
					f6[513] := f4[660] != f4[660];
					f6[513] := !f5;
					globalState.f0 := v2.fm28(f4[660], |fm42(globalState)|, f7, globalState);
					f4[660] := v2.f19 - v2.f19;
			}
			
			var v41: set<bool> := {f7, f7};
			if ({v4[v0]} > v41) {
				var v42: seq<int> := [v0 / |v41|, |map[v2.f19 := f5]|];
				globalState.f0, v0 := f7, v42[f4[660]];
				var v43 := new C2();
				v0 := 0x128;
				f20[694] := f5;
				f20[694] := !f7;
			...
			f20[808] := f4[660] > v2.f19;
			f4[660], v0, v51, f4[660], f20[808] := v0, f4[660], v51, v0 / v2.f19, "ndxiwch" != v7;
		}
			...
			decreases 100 - i5
		{
			...
			if (v57 || f5) {
				...
				v55 := f7;
				v0 := v2.f19 % (if (f7) then v2.f19 else v52.fm22(f5, true, globalState));
				var v59: multiset<int> := multiset{v2.f19};
				var v60: seq<multiset<int>> := [v59, multiset([--v2.f19])];
				var v61: map<multiset<int>, bool> := map[v60[v2.f19] := f7];
				v61 := v61[v59 := false];
		...
		var v66: seq<int> := [v2.f19, |fm45(f5, f5, f4[660], f5, globalState)|, -v2.f19];
		r0 := |v66|;
		r1 := !f5;
	}
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		if (f7) {
			...
			match (v1.(cf16 := {f4, f4, f4} + v2[v3])) {
				case DC8(cf16) =>
					...
					globalState.f0, f4[419], v3, v8, v10 := f7 <== f5, v3 + v3, if (f5) then -v3 else v3, v8, fm48(globalState);
					var v11 := "qjovdnx";
					var v12 := new C0(|v11|);
			}
			...
			globalState.f0, v13, globalState.f0, globalState.f0, globalState.f0 := {f4, f4} <= ({f4, f4} * v0), v13, if (f5) then false else fm6(f7, v15[v3 := |v14|], globalState), f7, f7;
			f20[300] := -0x2f1 == v3;
			f20[300] := false;
			...
			if (f5) {
				...
				v29[994], v27, globalState.f0, globalState.f0, f4[993] := f4, v31[-v18], f7, v18 != (v18 * -v18), v18;
			}
			...
			match (v33) {
				case DC8(cf16) =>
					...
					f4[385] := v18;
					v35, f4[385] := v35, v18 + v18;
					f4[385] := f4[385];
					var v36: map<int, bool> := map[|v34| := f5];
					v36 := v36;
					var v37: seq<bool> := [f7];
					var v38: multiset<bool> := multiset{if (v37[v18]) then f7 else f5, f7 && false};
		...
		if (f7) {
			...
			if (f7) {
				...
				v42[54], f4[12], v44 := v43, v44 - |fm4(v44, f5, globalState)|, -(if (v46 in v47) then v47[v46] else fm2(v44, |v48|, f7, false, globalState));
				f4[12] := v44;
				var v49: seq<bool> := [f5, f5, f5, !f7];
				var v50: seq<seq<bool>> := [v49, v49, v49];
				var v51 := DC31(v50);
				v44, v51, v43, f20 := f4[12], v51, if (if (f5) then f7 else f5) then v43 else fm5(v44, f5, v49, !f7, globalState), f6;
				var v52: map<int, bool> := map[v44 := f5];
				var v53: multiset<int> := multiset{f4[12], |v52|};
				var v54 := new C1(!f5, v53 + v53);
				var v55: seq<int> := [v44];
				var v56: seq<seq<int>> := [[v44, v44], seq(0x387, i2  => (|{v54.f18}|)), v55];
				var v57: map<int, int> := map[v44 := |v56|];
				var v58: seq<int> := [|v57|, v44];
				var v59: set<bool> := {fm6(f7, v58, globalState)};
				v43, v44, globalState.f0 := v43, |(seq(0x1c1, i1  => (0x2a3)))[0x9e := f4[12]]| + |fm40(fm2(v44, |v59|, v54.f17, if (f4[12] in v52) then v52[f4[12]] else f7, globalState), |v45|, globalState)|, fm6(v54.f17, v55, globalState);
			} else {
				globalState.f0 := f7;
				var v60 := new C2();
				f20[48] := f7;
			...
			v66, v65, v70[868], v78 := v66, v65, v67, ([!f5] + v78) + (v78 + v71);
			var v79: multiset<array<int>> := multiset{f4, f4, f4, f4, f4};
			globalState.f0 := v79 >= v79;
			v72 := "ojdhcna";
			var v80: set<int> := {v65, |([0x2e3, v65])[v65 := v65]|};
			var v81: map<int, array<array<int>>> := map[|(v80 + v80)| := v70[868]];
			v81 := v81[|v72| := v67];
			v65 := v65;
		}
			...
			decreases 100 - i4
		{
			...
			globalState.f0 := !fm6(f5, v90[v83 := v83], globalState);
			v83 := --v83;
			var v91 := DC22(f5, f7);
		...
		globalState.f0, v96, v97, v98, globalState.f0 := f5, v96, v97, multiset{f4} * (if ('j' in v99) then v99['j'] else v100[v83]), match v101.(cf19 := v84) {
		...
		if (f5) {
			...
			var v107: T2 := new C3(v104, f7, v105[0x22], v106.cf40);
			var v108: seq<T2> := [v107];
			v107 := v108[if (f7) then v83 else v83];
			if (-0x270 == v83) {
				...
				v115[554] := v97;
				f20[439], v115[554] := v107.f5, v85[v83];
				v83 := v83;
			} else {
				...
				v83 := (-v83 - -fm2(v83, v83, f20[439], v107.f5, globalState)) - v83;
				var v130: array<array<bool>> := new array<bool>[13];
				v130[914] := f6;
				var v131 := DC24(v83, fm2(v83, v83, !!f20[439], fm6(v107.f5, v123, globalState), globalState), true, f6);
				v130[914] := v131.cf37;
			}
			
			var v132: map<char, int> := map[v97 := v83];
			var v133: map<int, int> := map[|v132| := -0x2d3];
			f20[439] := -|v133| < (if (v107.f5) then v83 else v83);
			f20[439] := f7;
		}
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		var v0: C0 := new C0(p2);
		var v1: seq<C0> := [v0];
		var v2: map<array<bool>, C0> := map[f20 := v1[p2]];
		r0 := (p2 * p2) % |(v2 + v2)|;
		var v3 := DC14();
		match (v3) {
			case DC14() =>
				var v4: seq<int> := [0x38e];
				f20[329] := fm6(p1, v4, globalState);
				f20[329] := true;
				var v5: set<int> := {v0.f19};
				r0 := (|v5| - -v0.f19) % -146;
				var v6: array<seq<int>> := new seq<int>[27];
				globalState.f0, globalState.f0, v6, globalState.f0, f20[329] := f5, p0, v6, if (f20[329]) then p1 else f7, p1;
				var v7 := DC5(-0x3a8, f6, p1, v0.f19, p1);
				var v8: seq<bool> := [v7.cf9, f20[329]];
				var v9: seq<seq<bool>> := [v8[v0.f19 := f5], v8];
				var v10 := 'w';
			...
			case DC15(cf23) =>
				...
				f4[943] := -v0.f19;
				var v15 := DC46(v14);
				var v16: seq<int> := [|(seq(0x21a, i1  => ('f')))|];
				v14, cf23, f20[219], f4[943], globalState.f0 := v15.cf70, if (p1) then p1 else cf23 && f5, f7, |v16| + v0.f19, f5;
				f4[943] := p2;
			...
			case DC16() =>
				...
				var v23 := "ilul";
				v20[476] := if (|v23| in v22) then v22[|v23|] else 'y';
				...
				match (v28) {
					...
					case DC31(cf48) =>
						...
						var v33: array<array<bool>> := new array<bool>[18] [f6, f20, f6, f6, f20, f6, f20, v32[v0.f19], f20, f20, f20, f6, f20, f6, f20, f20, f20, f6];
						v33[590] := f6;
						v33[590] := f6;
						v21 := v20[476];
						var v34 := DC11(f5);
						var v35: map<int, int> := map[v0.f19 := v0.f19];
						v21, r0, r0, v21, r0 := fm5(if (p1) then -v0.f19 else v0.f19, f7, v26, p0, globalState), v0.fm27(v34, f5, globalState) % p2, v0.f19, v20[476], (v0.f19 + (if (p2 in v35) then v35[p2] else |[true]|)) * 659;
						var v36: seq<int> := [v0.f19, v0.f19];
						var v37: seq<seq<int>> := [[v0.f19, v0.f19], v36];
						var v38: set<bool> := {f7};
						var v39: map<int, set<bool>> := map[v0.f19 := v38];
						v35 := v35[|v37[v0.f19]| := |v39|];
					case DC33(cf51) =>
						r0 := v0.f19;
				...
				r0 := -((if (p1) then v0.f19 else p2) % 0x28c);
				var v42 := DC16();
				match (v42) {
					case DC14() =>
						r0 := v0.f19;
						...
						var v46: seq<set<bool>> := [v45[v0.f19], v44, v44, v44];
						f6[513] := v46[v0.f19] >= v44;
						f4[186] := v0.f19;
						var v47: multiset<bool> := multiset{false, f7};
						f4[186] := --|v24[p0 := (if (p1 in v47) then v47[p1] else p2) * v0.f19]|;
						f4[186] := -0x182;
					case DC15(cf23) =>
						f6[626] := f5;
						f6[626] := (p2 % p2) >= |v26|;
					...
					case DC16() =>
						...
						v53 := v53[f7 := f7];
						f4[354] := fm2(0xf, v0.f19, fm3(v23, globalState), true, globalState);
						f4[354] := 0x287;
						var v54: map<seq<bool>, bool> := map[v26 := f5];
						var v55: map<bool, char> := map[if (v26 in v54) then v54[v26] else if (f5 in v53) then v53[f5] else f7 := v20[476]];
						var v56: map<char, char> := map[if (p1 in v55) then v55[p1] else v21 := v20[476]];
						f4[354] := |("he")[v0.f19 := if (v20[476] in v56) then v56[v20[476]] else fm5(f4[354], DC15(f5).cf23, v26, f5, globalState)]|;
					...
					case DC17(cf24) =>
						...
						var v61: multiset<char> := multiset{v20[476]};
						var v62: multiset<bool> := multiset{f7};
						var v63: array<D4> := new D4[18];
						var v64: map<multiset<char>, array<D4>> := map[v61 - v61[v21 := |v62|] := v63];
						v64 := v64[multiset{v23[|v26[v0.f19 := f5]|]} := v63];
				}
			...
			case DC13(cf22) =>
				...
				var v69: seq<int> := [v0.f19, p2 / (if (|cf22| in v65) then v65[|cf22|] else -899), v0.f19, p2, p2];
				f4[498] := p2;
				var v71: map<int, int> := map[|([f7])[p2 := false]| := p2];
				var v72 := DC23(v69);
				v67, v68, v69, r0, f4[498] := v67 + v67, (map v70 : int | v70 in v71 :: (v70 * v0.f19) := (v66.f17)) + v68, v72.cf33, v0.f19, -234;
				if (p1) {
					v66.f17 := !p1;
					var v73: set<int> := {p2};
					var v74 := "npdjh";
					var v75: array<seq<int>> := new seq<int>[14] [v69[|v73| := |"bsitdlai"|], v69, [v0.f19, |v71|, f4[498], v0.f19], v69, v69 + v69, fm42(globalState), v69, v69[v0.f19 := v0.f19], (seq(0x139, i3  => (867)))[v0.f19 := |v74|], v69, [v0.f19], v69, v69, v69];
					v75[42] := seq(-0x5b, i4  => (|v71|));
					var v76: map<map<int, int>, seq<int>> := map[v71 := v69[-p2 := v0.f19]];
					v75[42] := v69 + (if (map[p2 := |v74|] in v76) then v76[map[p2 := |v74|]] else v69);
					v66.f17 := fm6(v66.f17, (seq(0x314, i5  => (-p2)))[p2 := v0.f19], globalState);
					f4[498] := v0.f19;
					var v77: multiset<bool> := multiset{f7, v66.f17};
					f4[498] := if ((|v77| + |cf22|) in v71) then v71[|v77| + |cf22|] else f4[498];
				} else {
					var v78: set<int> := {v0.f19};
					var v79 := "odnpcrw";
					var v83: array<set<int>> := new set<int>[17] [v78, fm56(p2, globalState), {|v79|}, set v80 : int | v80 in map[0x150 := f5] :: (v80 * 0x2f), v78, v78, v78, v78, set v81 : int | (0x1f1 <= v81) && (v81 < 0x15d) :: (v81 * v0.f19), set v82 : int | (-76 <= v82) && (v82 < -0x2b3) :: (v82 / 0x294), v78, {p2, v0.f19}, v78, v78, v78, v78, v78];
					var v84: map<map<bool, int>, array<set<int>>> := map[fm45(false, f7, v0.f19, v66.f17, globalState) := v83];
					v84 := v84[v67 := v83];
					globalState.f0 := v78 !! (v78 * v78);
					var v85: array<map<map<int, int>, int>> := new map<map<int, int>, int>[9](i6 => map[v71 := f4[498]]);
					...
					var v95 := m0(v88, |v92|, map v93 : char | v93 in v94 :: (v93) := (v0.f19), v87[|v71|], globalState);
					f4[498] := v0.fm27(DC11(f5), true, globalState);
				}
				
				var v96: multiset<bool> := multiset{p1, p1};
				var v97: seq<bool> := [v66.f17];
				var v98: set<int> := {0x24f};
				f4[498] := fm2(v0.f19 - v0.f19, 957 / (if (false in v96) then v96[false] else -|v97[|v98| := f7]|), p0, v66.f17, globalState);
			case DC17(cf24) =>
				globalState.f0 := false;
				f6[331] := f5;
				f6[331] := f5;
				f4[628] := v0.f19 % 275;
				f4[628] := (-374 * v0.f19) % 225;
				var v99: map<int, bool> := map[v0.f19 := p0];
				var v100: seq<int> := [v0.f19, f4[628]];
				var v101: map<map<int, bool>, int> := map[v99 := v100[v0.f19]];
				var v102 := DC38(v101);
				var v103 := 'o';
				var v104: map<D14, char> := map[v102 := v103];
				var v105: array<int> := new int[12];
				f4[628] := -(if (!(p2 == DC24(fm2(|v104|, |[v105]|, p0, f5, globalState), f4[628], p0, f20).cf35)) then v0.f19 else v0.f19);
		}
		...
		for i7 := p2 to v0.f19 {
			...
			match (v116) {
				case DC4() =>
					...
					f4[12] := (|v121| % -v0.f19) * v0.f19;
					var v122: array<int> := new int[6] [|v115|, i7 * v0.f19, --|v119|, |v110|, v0.f19, f4[12]];
					v122 := v122;
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					...
					v123[996] := v124[|v115|];
					v123[996] := f20;
					var v125: multiset<bool> := multiset{p0, f5, (fm60(p1, !fm3(v110[cf7 := v108], globalState), v0.f19, globalState)).cf60, f5};
					var v126: multiset<int> := multiset{v0.f19};
					var v127: array<int> := new int[18] [217 * v113[i7], |v125|, v0.f19 - v0.f19, v0.f19, if (true) then |v113| else cf10, 0xb1, cf7, if (cf9) then p2 else cf10, |(v126 + multiset{v0.f19})|, |v109|, v0.f19, i7, v0.f19, cf7, p2, -507, i7, cf10];
					v127 := f4;
					f6[815] := -0x42 < i7;
					...
					v128[229] := v129;
					f4[789] := i7;
					f6[815], r0, v128[229], v127, f4[789] := ([cf8, cf8])[v0.f19 := f20] < v124, -cf10 * p2, v129, f4, i7;
					var v130: map<int, int> := map[v0.f19 := if (f5 in v125) then v125[f5] else i7];
					var v131: array<char> := new char[22] [v108, v108, v108, v108, v108, v108, fm5(f4[789], true, (v115[|v110| := false])[-cf10 := f5], false, globalState), 'r', v108, v108, v108, v108, fm5(|v130|, f6[815], v115, cf11, globalState), v108, v108, v108, v108, v108, v108, v108, v108, if (cf9) then v108 else v108];
					v131[738] := 'd';
					v131[738] := v108;
				case DC3(cf6) =>
					f6[143] := !f7;
					...
					var v136: set<seq<int>> := {v113[|(if (p0 in v133) then v133[p0] else v135)| := 0x269]};
					f6[143] := v136 != (v136 + v136);
					...
					v140 := v140;
					globalState.f0 := cf6[v0.f19];
					var v141 := DC10(p0, multiset(v113));
					var v142: array<D4> := new D4[18] [fm61(globalState), DC10(p0, multiset{v0.f19}).(cf19 := (multiset{v0.f19})[v0.f19 := v0.f19]), v141, v141, v141, v141, v141, DC10(f7, v132), v141, v141, v141.(cf19 := v132), if (f7) then v141 else DC10(p1, v132), v141, DC10(!f7, v132).(cf19 := v132[p2 := i7]), v141, DC10(f6[143], multiset(v113)), v141, v141];
					v142 := v142;
			}
		...
		if (p0) {
			...
			var v145 := "ufkcbn";
			var v146 := 'l';
			var v147: map<bool, int> := map[f7 := |v145[v0.f19 := v146]|];
			...
			match (v150) {
				case DC27(cf39, cf40, cf41) =>
					...
					cf39 := cf39 * |v152|;
					r0 := if (f5) then v0.f19 else 5 / v0.f19;
					...
					var v155: set<bool> := {v153[|v145|], p1};
					v154[475] := v155 - {f5};
					var v156 := DC13(v155);
					v154[475] := v156.cf22;
				case DC26(cf38) =>
					...
					var v163: map<string, bool> := map[seq(0x13e, i8  => (v146)) := v149.f22];
					var v164: seq<map<string, bool>> := [v163];
					var v165: multiset<char> := multiset{v146, v146};
					var v166: seq<int> := [0x31b];
					var v167: array<int> := new int[9] [v0.f19, v0.f19 * 423, v0.f19 - v0.f19, v0.f19, v0.f19, p2, |v164[if (v146 in v165) then v165[v146] else v0.f19]|, v0.f19, v166[p2]];
			...
			if (f5) {
				...
				v173 := v174[v0.f19 + v0.f19];
				var v175: multiset<bool> := multiset{p1};
				r0 := (v0.f19 / -|v175|) * (v0.f19 - -0x7c);
				...
				var v187: array<string> := new string[16] [v184, v184 + "bcpqygqq", v184, v184, fm4(fm2(0x37c, v0.f19, f7, p0, globalState), f5, globalState), v184, v184[p2 := if (!true in v186) then v186[!true] else v185], seq(0x239, i10  => (v185)), v184, v184 + v184, v184, v184, v184, v184, v184, v184];
				var v188 := DC46(v187);
				v187 := v188.cf70;
				r0 := v0.f19;
				r0 := -575 * (v0.f19 * p2);
			...
			if (fm3(v193, globalState)) {
				...
				f20[656] := !f7 in v199;
				f20[656] := f5;
				var v200: map<int, bool> := map[v0.f19 := p1 && f20[656]];
				v200 := v200[p2 := p0];
				var v201 := new C1(f20[656], multiset{p2, p2, v0.f19} * v197);
				var v202: map<bool, bool> := map[f20[656] || true := !(if (f7) then f7 else f7)];
				var v203 := DC15(f20[656]);
				var v204: map<int, D5> := map[-|[v193]| := v203];
				var v205: seq<map<int, D5>> := [v204];
				var v206: seq<int> := [v0.f19];
				v202 := v202[(seq(-0x377, i11  => (map[p2 := DC15(v201.f17)]))) <= v205 := !fm6(v199[-92], v206, globalState)];
			} else {
				var v207: multiset<int> := multiset{v0.f19};
				var v208: seq<multiset<int>> := [v207];
				var v209: array<seq<multiset<int>>> := new seq<multiset<int>>[12] [v208, v208, v208, seq(92, i12  => (v207)), v208, v208 + v208, [v207], fm48(globalState), v208, seq(5, i13  => (v207)), v208 + (seq(0x1fc, i14  => (v207))), v208];
				v209[875] := v208;
				v209[875] := fm48(globalState);
				globalState.f0 := p0;
				globalState.f0 := p0;
			...
			var v213: array<array<array<D1>>> := new array<array<D1>>[17] [v211, v211, v211, v211, v211, v212[|v193|], v211, v211, v211, v211, v211, v211, v211, v211, v211, v211, v211];
			v213[364] := v211;
			v213[364] := v211;
			var v214 := 'h';
			v214 := v214;
		...
		var v227: array<set<int>> := new set<int>[28] [v218, set v220 : int | v220 in (map v219 : int | (-0xb2 <= v219) && (v219 < 865) :: (v219 / p2) := ("ydd")) :: (v220 - |map[490 := 0x1e0]|), {v0.f19}, v218 * v218, v218, v218, v218, v218, {p2} - v218, v218, v218, {v0.f19, fm2(p2, 590, p1, false, globalState)}, v218, v218, v218, v218, v218, {p2, v222.cf30, |(if (v0.f19 in v224) then v224[v0.f19] else fm45(f5, p1, |v225|, fm3(v221, globalState), globalState))|}, v218, v218 + v218, v218 * v218, {p2, v0.f19}, v218, v218, v218, v218 - v218, v218 * {v0.f19, 553}, set v226 : int | (0x1f4 <= v226) && (v226 < 836) :: (v226 % v0.f19)];
	...
	method m16(p0: int, p1: bool, globalState: GlobalState) returns (r0: array<int>, r1: bool, r2: seq<int>, r3: bool) {
			...
			decreases 100 - i0
		{
			...
			var v2 := DC32({f4[215]}, v1);
			v2 := v2;
			match (fm111(p1, p0 < -f4[215], v0, globalState)) {
				case DC58(cf97) =>
					r3 := f7;
...
class C9 extends T0, T2 {
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i0
		{
			...
			v3[394] := v6;
			var v7: set<int> := {p2};
			v3[394] := v6.(cf8 := v4, cf10 := DC1(v1, p2, v7, v0).cf2);
			var v8: seq<bool> := [p1];
			var v9: seq<bool> := [v8[701]];
			var v10: seq<seq<bool>> := [v8, v9, v8, v8, [false, f16, f16, f16]];
			var v11: map<char, int> := map['p' := p2];
			var v12 := m0(v10, |(f15[-p2 := p2] + (fm18(f16, f5, p0, -p2, globalState))[p2 := p2])|, v11, f16 <==> fm3(v0, globalState), globalState);
		}
		...
		match (v15) {
			case DC4() =>
				...
				v22[325] := f5;
				var v23 := "vpcy";
				v20, v22[325] := (seq(0x2d1, i1  => (v19)))[p2 := v19] + v20, fm3(v23, globalState);
				r0 := p2;
				r0 := |[v22[325], fm3(v23, globalState)]| - p2;
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				cf7 := cf10 % 0x34a;
				var v24 := 'c';
				v24 := v24;
				...
				v26 := v26[v25[|v27| := v24] + "ciievxvrk" := v24];
				if (true) {
					globalState.f0 := if (f5) then fm3(v25, globalState) else f5;
					f4[302] := p2 / cf7;
					var v28: seq<bool> := [f5];
					f4[302], r0, globalState.f0, cf10 := p2, |f15| * -cf10, v13 >= multiset(v28 + fm20(globalState)), |((seq(-0x2c4, i2  => (v24))) + v25)| / p2;
					cf8[388] := f5;
					cf8[302] := cf9;
					cf8[388], cf8[302] := true, p0;
					v24 := v24;
					globalState.f0 := cf8[388];
				} else {
					...
					f4[295] := -(|f15| % p2) * p2;
					globalState.f0 := p0;
					var v33: map<int, bool> := map[cf10 / cf10 := f16];
					var v34: seq<bool> := [fm3(v25, globalState), f16, p1];
					v33 := map[|v34| * cf10 := f4[295] < cf10];
				}
			...
			case DC3(cf6) =>
				...
				globalState.f0, r0, globalState.f0, f4[766], v37[842] := p1, -p2, false, (p2 - v40.cf2) % p2, v15;
		}
		
		f4[457] := 0x146;
		f4[457] := |map[p1 := f15]| - p2;
		r0 := if (p1) then p2 else f4[457];
	}
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			match (v1) {
				...
				case DC11(cf20) =>
					var v7 := "hrdcoko";
					var v8 := 0x34a;
					r0 := |((seq(0x3b4, i1  => ('k'))) + v7)| * fm2(fm2(0xfe, v8, false, f16, globalState), v8, f5, f16, globalState);
					var v9: array<int> := new int[29];
					v9 := v9;
					var v10: seq<bool> := [!f16];
					globalState.f0 := v10[v8 / v8];
				...
				case DC9(cf17) =>
					...
					cf17[622] := v15.cf41 + v12;
					var v16: map<bool, int> := map[f5 := |"ohso"|];
					var v17 := DC11(!f5);
					var v18 := DC47(f16, v16[f5 := -fm2(cf17[622], cf17[622], f16, v17.cf20, globalState)]);
					v18 := v18;
				case DC12(cf21) =>
					globalState.f0 := f5;
					...
					var v22 := m0((seq(-131, i3  => ([f5]))) + [v19], v20, v21, f16, globalState);
					var v24: seq<int> := [fm2(-fm2(v20, |(set v23 : int | (444 <= v23) && (v23 < -412) :: (v23 % 0x5a))|, f5, f5, globalState), v20, f5, f16, globalState)];
					var v25 := "ei";
					var v26: map<int, seq<int>> := map[|(v25 + "kqdhxtfos")| := if (f5) then v24 else f15];
					v24 := (if (|map[f16 := v20]| in v26) then v26[|map[f16 := v20]|] else [v20, |map[f15 := 0x2af]|, |v24|])[|v25| := v20 * v20];
					p1[678] := |(if (f16) then [f5] else [f5, true, true])|;
					var v27: set<int> := {v20};
					p1[678] := -f15[|v27|];
			}
			...
			if (f16) {
				...
				var v42: array<bool> := new bool[20] [f16 ==> v32.cf116, |v36| >= -|v37|, v37 < fm72(globalState), v35.f5, f16, f15 in (seq(0x9d, i4  => (f15))), false, f16, f5, v30.f17, v35.f5, !f5, if (v38 in v39) then v39[v38] else v30.f17, f16, v40[v28], !(v41 > v41), v28 < v28, f16, v28 in v37, f5];
				var v43 := 'd';
				var v44 := DC3(v40 + v40);
				p1[40], v42, v43, f16, v44 := f15[v28] + |v38|, v42, v43, f16 <== false, v44;
				r0 := 0x3a3;
				v30.f17 := v35.f5;
				v33 := v42;
			} else {
				...
				f4[319] := |v47| % (if (f16) then |v48| else fm2(v45, fm2(v45, v45, f5, f16, globalState), f5, f16, globalState));
				var v49: map<int, int> := map[|(v0[f4[319] := p1] + [p1])| := 798 - 149];
				var v51: array<bool> := new bool[7] [f5, f16, f5, f5, f5, f5, f16];
				v49 := (if (f16) then v49 else map v50 : int | (0x11d <= v50) && (v50 < -778) :: (v50 * |(seq(0x297, i5  => (f4[319])))|) := (965))[|multiset{v51, v51}| - f4[319] := -v45];
				...
				var v60: set<int> := {|v58|, f4[319], |multiset{v59}|};
				var v61 := m0(v54, v45, v56[v55 := v45], v60 !! v60, globalState);
				v46 := (fm93(|fm18(f5, f16, f5, |"wugc"|, globalState)|, globalState) + v46)[f4[319] * v45 := !false];
			}
		...
		if ((if (f16) then f5 else f16) && f16) {
			...
			r0 := if ((multiset{|(seq(0x35e, i6  => (|{f5, f5, f16, f5}|)))|, v67, v67} >= v68) in v66) then v66[multiset{|(seq(0x35e, i6  => (|{f5, f5, f16, f5}|)))|, v67, v67} >= v68] else v67;
			r0 := v67;
			...
			var v79 := 0x137;
			v78 := v78[v79 := if (f5) then v77 else v77];
		...
		match (v90.(cf101 := f16 ==> !f16)) {
			case DC60(cf99, cf100, cf101, cf102, cf103) =>
				...
				v98[710] := (if (f16 in v100) then v100[f16] else [v82, v82, v82]) + v99;
			case DC59(cf98) =>
				r0 := (v81 % v81) / v81;
				r1 := f16;
				r1 := f16;
		...
		f4[732] := -0x16b;
		var v108 := DC1('k', v81, v82, seq(556, i9  => (v83)));
		v101, v104, v106, v107, f4[732] := v101, v104 + v104, v106 + (v106 + v106), v107, match v108 {
			case DC1(cf1, cf2, cf3, cf4) => v81
			case DC0(cf0) => |map[v102[v81] := v81]|
			case DC2(cf5) => |"noh"|
		};
		r0 := v81;
		var v109 := "c";
		var v110: map<string, bool> := map[v109 := !(f4[732] <= |v109|)];
		r1 := if ((v109 + ("iucu")[f4[732] := v83]) in v110) then v110[v109 + ("iucu")[f4[732] := v83]] else true;
	}
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		var i0 := 0;
		while (f16)
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			v31 := v31[v26.f22 := v20];
			var v33: map<seq<int>, int> := map[seq(821, i5  => (v20)) := v20];
			var v34 := DC35(|f15|, f16, v33);
			v20 := v34.cf53;
			if ((if (fm3(v29, globalState) in v31) then v31[fm3(v29, globalState)] else v20) > (v20 / v20)) {
				var v35 := 'm';
				v35 := if (f16) then v35 else 'j';
				globalState.f0 := v26.f22;
				var v36: seq<string> := ["ba", v29];
				v36 := fm113(v20, v35, map v37 : int | (0x9f <= v37) && (v37 < 0x1c7) :: (v37 + |multiset([map[|f15| := true]])|) := (!v25[|(set v38 : char | v38 in multiset{v35} :: (v38))|]), globalState);
				var v39: multiset<int> := multiset{f15[v20]};
				v31 := v31[f16 := (if (v20 in v39) then v39[v20] else v20) % v20];
				v20 := v20;
			} else {
				v20 := v20 + v20;
				v21[325] := f5;
				globalState.f0, v20, globalState.f0, v21[325], globalState.f0 := v26.f22, v20 % v20, v26.f22, v26.f22, (v25 + v24) == v25;
				v21[325] := f5;
				v19[787] := v20;
				var v40 := 'k';
				v19[787], v29, v21[325] := v20, (v29 + v29) + (if (f16) then v29[0x0 := v40] else "c"), v21[325];
				v19[787] := v19[787];
			}
...
class C10 extends T1 {
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		for i3 := 0xd3 to v0 {
			...
			var v26 := "iputbwm";
			var v27: array<bool> := new bool[16] [v16.f16, v16.f16, v3, v3, v3, v16.f16 && v3, v17[-701] in v18, v16.f16, v3, false, v3, if (!v16.f16) then true else if (DC63(v0, v16.f16, DC5(v0, v22, v3, v12.f19, v3)) in v25) then v25[DC63(v0, v16.f16, DC5(v0, v22, v3, v12.f19, v3))] else v3, v16.f16, v16.fm3(v26, globalState), v3, v3];
			v22[635] := v16.f16;
			var v28: array<D15> := new D15[21](i4 => v14);
			var v29: map<array<D15>, bool> := map[v28 := v16.f16];
			v22[635] := !(if (v28 in v29) then v29[v28] else v16.f16 || !v3);
			var v30: array<array<int>> := new array<int>[5];
			v30[693] := f14;
			v30[693] := f14;
			var v31: C2 := new C2();
			var v32 := DC68(v31);
			v31, v22[635] := v32.cf118, i3 != v12.f19;
		}
		var i5 := 0;
		while (v3)
			decreases 100 - i5
		{
			...
			var v39: T1 := new C7(DC32(set v36 : int | v36 in v35 :: (v36 % -|map[map[false := false] := false]|), v38));
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		var v15 := DC32({v1}, v14);
		var v16 := DC33(v15);
		var v17 := DC53(f14, v7[v1], f14, v1, v16);
		v1 := v17.cf83;
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		globalState.f0, globalState.f0, v0[621], v1 := !p1, false, v2 <= v2, v1;
		var v3: map<int, bool> := map[p2 := v0[621]];
		var v4: seq<map<int, bool>> := [v3, v3];
		var v5: seq<int> := [|[v3, v4[p2]]|, 424, p2 % p2];
		var v6: map<bool, int> := map[p2 < p2 := p2];
		var v7: array<int> := new int[11](i0 => i0 + p2);
		var v8: set<int> := {p2};
		var v9: seq<bool> := [p1];
		v5, v6, r0, v7, globalState.f0 := v5, v6, -p2, f14, !!(if (|v8| !in v5[|v9| := p2]) then p1 else v0[621] <==> !p1);
		globalState.f0 := v9[p2];
		v0[621] := v0[621];
		var v10: multiset<int> := multiset{-p2};
		var v11 := new C4(v0[621], v10 !! v10, v0, p0, v7, fm2(p2, p2, p0, v0[621], globalState) <= p2);
		if (v11.fm74(globalState)) {
			v0[621] := p1;
			r0 := p2;
			v0 := new bool[5] [v11.f25, v11.f24, v8 != v8, v11.f25, if (!v11.f24) then !v0[621] else p1];
			var v12 := "tgqyt";
			...
			if (v11.fm6(!v11.f25, v5, globalState)) {
				v14 := "goyypph" + (seq(627, i1  => (v1)));
				r0 := p2;
				var v15: T0 := new C9([p2], v11.f24, f14, v11.f24);
				f14[975] := v11.fm73(seq(-0x1d4, i2  => (v1)), |[v15, v15]|, !v11.f25, globalState);
				f14[975] := -p2;
				var v16: seq<seq<char>> := [v14];
				var v17: map<int, int> := map[f14[975] := |v16|];
				var v18: set<map<int, int>> := {v17};
				var v19: map<D22, char> := map[DC59(v18) := v1];
				var v20 := DC59(v18);
				v19 := v19[if (fm3(seq(0xe9, i3  => (v1)), globalState)) then v20 else v20 := v1];
				f14[975] := if (v11.f24) then p2 else f14[975];
			} else {
				var v21: array<array<bool>> := new array<bool>[6] [v0, v0, v0, v0, v0, v0];
				var v22 := DC52(v21);
				v22 := v22;
				globalState.f0 := v11.f25 && true;
				var v24: set<bool> := {v0[621]};
				var v25 := DC64(v0[621], v5, p2);
				var v26 := DC61(v3);
				var v27: array<map<int, bool>> := new map<int, bool>[15] [v3, v3[p2 := v0[621]], v3, map v23 : int | (0x1e9 <= v23) && (v23 < -0x69) :: (v23 % p2) := (false), map[-|v24| := v25.cf109], v3, v3, v3[-|"yps"| := v11.f25], fm24(p2, v11.f24, globalState), if (v9[p2]) then map[p2 := v11.fm6(v11.f24, v5, globalState)] else v3, v3, v3, v26.cf104, v3, v3 + v3];
				v27 := v27;
			...
			var v34: map<array<bool>, array<D2>> := map[v31[206] := if (v11.f25 in v33) then v33[v11.f25] else v32];
			v34, v0[621], r0 := v34 + (v34 + v34), p1, p2;
		}
	...
	method m13(globalState: GlobalState) returns (r0: map<map<int, bool>, bool>) {
		...
		if (v9 < v9) {
			...
			v0, v11, globalState.f0, v0, v0 := v0, [v10, v10] + v11, fm3(v9, globalState), --v12[|(set v15 : multiset<int> | v15 in v14 :: (v15))| / v0], fm2(v0, |"vsonn"| % v0, false, !v2, globalState);
			var v16: seq<string> := [fm4(|v9|, v2, globalState), v9];
			var v17: map<bool, int> := map[v2 := |v9|];
			var v18: map<bool, int> := map[v16[v0] == v9 := -0x233 - |v17|];
			v17 := v17;
			...
			var v26: map<bool, seq<int>> := map[v2 := v25[0x13a := 0x3c0]];
			var v27: map<int, bool> := map[0x62 := true];
			var v28: seq<bool> := [v2];
			var v29: map<bool, bool> := map[v2 := v2];
			var v30: multiset<map<bool, bool>> := multiset{map[v28[v0] := v2], v29};
			var v31: set<bool> := {v2, false};
			v23, v24, v2, v0 := if (v2) then f14 else v23, ([v23, v23] + v24)[v0 := v23], !((v25 + v25) < (if ((if ((if (v0 in v1) then v1[v0] else v0) in v27) then v27[if (v0 in v1) then v1[v0] else v0] else v2) in v26) then v26[if ((if (v0 in v1) then v1[v0] else v0) in v27) then v27[if (v0 in v1) then v1[v0] else v0] else v2] else v25)), (|(seq(0xa2, i2  => ('d')))| % |v30|) - (|v31| / v0);
			v2 := v2;
		...
		match (if (v2) then v36 else DC58(v35)) {
			case DC58(cf97) =>
				...
				match (v40) {
					case DC61(cf104) =>
						v0 := v0;
						var v41: array<seq<int>> := new seq<int>[8](i3 => (seq(137, i4  => (DC36(v0, v0, v2, {v0}, true).cf57))) + [|[|[v2]|]|, v0]);
						var v42: seq<int> := [v0];
						v41[256] := v42;
						var v43: map<int, seq<int>> := map[if (v2) then v0 else 0xc2 := fm70(v2, v0, globalState)];
						v41[256] := if (fm2(v0, |v9|, v2, v2, globalState) in v43) then v43[fm2(v0, |v9|, v2, v2, globalState)] else v42;
						var v44 := 'f';
						var v45: map<bool, char> := map[v2 := v44];
						v45 := v45[v37[444] := v44];
						f14[398] := fm2(v0, fm2(v0, v0, v37[444], v2, globalState), v2, v37[444], globalState);
						f14[398] := v0;
				}
		...
		var v47: array<D8> := new D8[21](i6 => DC23(seq(583, i7  => (v0))));
		forall i5 | 0 <= i5 < v47.Length {
			v47[i5] := DC23(seq(0x281, i8  => (v0)));
		}
		var v48 := 'd';
		v48 := v48;
...
class C11 extends T1, T0, T3 {
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if ((v0 + v0) <= (|v1| % |v2|)) {
			...
			var v11 := "tssjahag";
			var v12 := DC1(fm5(v0, f6[530], v9, f7, globalState), v0, v10, v11);
			v12 := v12;
			v0 := v0;
			...
			v15[774] := if (f12) then {f4} else v13;
			v15[774] := v13;
		}
		
		var v16 := "lkqcfvtfb";
		var v17 := 'w';
		var v18: map<int, bool> := map[|v16[|v16| := v17]| := !f5];
			...
			decreases 100 - i0
		{
			...
			if (!f7) {
				...
				v21 := v21 + fm16(f4[853], !f7, globalState);
				globalState.f0 := f7;
			} else {
				v0 := |"shu"|;
			...
			if (if (f5) then f7 else true) {
				...
				var v34: array<array<bool>> := new array<bool>[3] [v33[528], f6, f6];
				v34 := new array<bool>[13] [v25.f20, v25.f20, f6, f6, v25.f20, v25.f20, v33[0x3ad], f6, v25.f20, v25.f20, v25.f20, v25.f20, f6];
				globalState.f0, v16 := false, v16 + v16;
				r0 := v0;
			}
			
			if (f7) {
				var v35: array<int> := new int[8](i1 => i1 % |"v"|);
				var v36: map<int, array<int>> := map[v0 := v35];
				v35 := if (v0 in v36) then v36[v0] else f4;
				var v37: map<bool, bool> := map[f12 := if (v0 in v18) then v18[v0] else v19[|v16|]];
		...
		v48 := seq(975, i2  => (v48[|(map v49 : int | v49 in v18 :: (v49 % |v1|) := (v0))|]));
		var v50: map<array<int>, bool> := map[p1 := f5];
		if (f7 <== (if (v19[|v50|]) then false else f7)) {
			f6[41] := f5;
			f6[41], r0 := fm6(f7 <==> true, v47, globalState), v0;
			...
			v53[758] := {v54, v54};
			var v55: set<multiset<char>> := {v54, multiset{v17, v17, 's'} + v54, (multiset{v17})[v17 := -0x3cc]};
			v17, f6[41], v53[758], v0 := v17, f6[41], v55, v0 % (0x1c4 * -v0);
			v0 := v0;
			r0 := |{f12}| + |map[f6[41] := |v16|]|;
		} else {
			var v56: map<array<bool>, int> := map[f6 := -0xe3];
			var v57: set<bool> := {f5, f5};
			globalState.f0 := (|v56| / v0) == |v57|;
			...
			if (fm3(v16, globalState)) {
				...
				f4[650] := -(if (f7 in v60) then v60[f7] else -0x23a);
				f4[650] := v0 / v0;
				globalState.f0 := f12;
				...
				v65 := v65[f5 := -(v0 - -510)];
				globalState.f0 := f12;
				f6[837] := v0 <= |v16[|v16| := v17]|;
				var v66: map<bool, bool> := map[f7 := false];
				f6[837] := fm6(v0 <= -|v66|, v47 + fm70(true, |v16|, globalState), globalState);
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			f4[415] := 331;
			var v69: multiset<seq<bool>> := multiset{v19[-0x15f := true], v19, fm20(globalState), fm47(v0, v0, globalState)};
			f4[741] := -(if ([false] in v69) then v69[[false]] else fm2(v0, v0, f5, f7, globalState));
			v0, f4[415], r0, f4[741] := (v0 / fm2(v0, v0, f7, f12, globalState)) / v0, v47[v0], v0, v0;
			f4[415] := 0x3df;
			r0, v16, r1, r1, globalState.f0 := f4[415] * v0, v16, f5, f12, !!!(f12 ==> f7);
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			v16, v16, v0, v16 := v16, if (f7) then seq(0x2d5, i5  => (v17)) else v16, -v0, fm4(v0 / v0, f7, globalState);
			var v71: array<bool> := new bool[8];
			v71 := v71;
			v48 := v48 + v48;
			p1[344] := v0 + v0;
			var v72 := DC42(f5);
			p1[344] := fm2(fm2(|v18|, v0, f5, f7, globalState), v0, fm3(v16, globalState), v72.cf68, globalState);
		}
		var v73: set<bool> := {f5};
		var v74 := DC13(v73);
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		v0, v0, v10, v11, v0 := match v15 {
			...
			case DC59(cf98) => v0
		}, if (f7) then v0 else fm2(if (v17 in v16) then v16[v17] else |map[v0 := v0]|, v0, f7, f5, globalState), f6, v11, (v0 * v0) - (v0 / v0);
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v1 := "ntvqtdjs";
			var v2: seq<int> := [364 - p2, |v1| % p2, 0x2ca * 715, p2];
			r0, r0, r0, globalState.f0 := v2[p2 % p2], fm2(|v1|, p2, f7, f7, globalState) / (-p2 - p2), p2, p0;
			var v3: multiset<seq<int>> := multiset{fm42(globalState), v2, v2};
			globalState.f0, globalState.f0, v1 := v3 !! v3, f12, fm4(if (fm6(p0, v2, globalState)) then |(seq(-409, i2  => (p2)))| else p2, p1, globalState);
		...
		var v11: seq<map<int, int>> := [v7 + v7, v7 + map[|v8| := p2], v7, v9[p2] + (map v10 : int | (0x3d1 <= v10) && (v10 < -0x3c3) :: (v10 % p2) := (p2))];
		var v12 := DC74(v11);
		v11 := v12.cf123;
		...
		if (f12 !in v13) {
			if (v8[p2] in v8) {
				...
				v15 := if ((if (f7 in v18) then v18[f7] else v16[p2 := fm15(f7, p1, p2, globalState)]) in v17) then v17[if (f7 in v18) then v18[f7] else v16[p2 := fm15(f7, p1, p2, globalState)]] else v15;
				v15 := v15;
				v16 := (if (f6[197]) then "dxqkdunxk" else v16) + ((seq(965, i4  => ('q'))) + v16)[|v16| := v15];
			} else {
				...
				f6[197], f6[197], v20, v22 := p1, !f6[197], v20, multiset(seq(275, i5  => (v21)));
				f4[670] := p2 % 0x12a;
				f4[670] := -p2;
				var v23: multiset<int> := multiset{221};
				f6[197], r0 := fm3(v21, globalState), if (v23[|v7| := p2] != v23) then p2 * f4[670] else 943;
				r0 := f4[670];
				r0 := -f4[670];
			}
			
			globalState.f0 := f6[197];
			var v24 := 'u';
			v24 := v24;
			...
			var v28 := "y";
			v26[363], f4[806], globalState.f0 := v27[p2 % p2], p2 / p2, !fm3(v28, globalState);
		} else {
			f4[707] := p2;
			f4[707] := p2;
			var v29: seq<bool> := [true, f12];
			var v30: seq<seq<bool>> := [[!f12, f7, f12], v29 + v29, v29, v29, v29];
			v30 := v30[-p2 := v29] + ([v29] + (seq(0x17e, i6  => ([p0]))));
			var v31 := "jfo";
			var v32: map<bool, bool> := map[f4[707] != |v31| := v31[p2] in v31];
			v32 := fm89(globalState);
			var v33: set<int> := {p2};
			var v34: array<int> := new int[5] [|map[f4[707] := f12]|, f4[707], f4[707], p2, 0x3a2];
			var v35 := DC8({v34});
			var v36: T1 := new C10(v35, v34);
			var v37 := DC32(v33, v36);
			var v38 := new C7(v37);
			var v39: array<map<int, seq<D2>>> := new map<int, seq<D2>>[26];
			v39[21] := map v40 : int | (0x143 <= v40) && (v40 < 0x2d5) :: (v40 - f4[707]) := ([DC7(p2, p2, f4[707])]);
			var v41 := DC7(p2, p2, |v31|);
			var v42: seq<D2> := [v41, v41];
			v39[21] := map[if (p2 in v7) then v7[p2] else p2 := v42];
		}
	...
	method m4(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			f4[839] := v0;
			v0, globalState.f0, v1, f4[839] := v0 % v0, f12, v1, 0x235;
			var v2 := 'j';
			var v3: map<char, int> := map[v2 := f4[839]];
			v0 := (if (|(multiset{f5})[f12 := if (v2 in v3) then v3[v2] else 847]| in v1) then v1[|(multiset{f5})[f12 := if (v2 in v3) then v3[v2] else 847]|] else v0) - (f4[839] * 0x2d1);
			var v4 := DC23([f4[839]]);
			...
			if ((v5 == v0) <==> !(if (f7) then !f7 else f5)) {
				...
				var v12: map<int, bool> := map[f4[839] := f5];
				var v13: set<int> := {f4[839]};
				var v14: seq<bool> := [f12];
				var v15: array<int> := new int[21] [f4[839], 0x164, f4[839], -(v11.(cf64 := f7)).cf65, |v12|, f4[839], |v13|, |v7|, v5, v0, f4[839], v5, |v14|, |(seq(0x1eb, i1  => (v2)))|, |v7|, v5, v0, f4[839], v5, f4[839], f4[839]];
				var v17: T1 := new C5(v2, f4[839]);
				var v18 := DC32(set v16 : int | v16 in map[v0 := f4[839]] :: (v16 + 0x34), v17);
				var v19 := DC33(v18);
				var v20 := DC53(v15, v2, v15, |v10|, v19);
				var v21: multiset<D19> := multiset{v20, v20, v20, v20};
				v5, v8 := f4[839] % (if (v20.(cf82 := v15) in v21) then v21[v20.(cf82 := v15)] else f4[839]), v8 * v8;
				...
				v26[290], globalState.f0, globalState.f0, v2 := v30, !f12, !(f5 ==> !f5), if (fm75(f7, f12, v5, globalState) in v31) then v31[fm75(f7, f12, v5, globalState)] else v2;
				var v32 := DC71(v0, v5);
				var v33: map<bool, bool> := map[f12 := f7];
				var v34: array<D27> := new D27[4] [v32, v32.(cf121 := fm2(|v27|, |v33|, f12, f12, globalState)), v32, v32];
				v34[53] := fm117(|fm18(true, f12, f7, v5, globalState)|, globalState);
				v34[53] := v32;
				var v35: map<bool, int> := map[!f5 := v5];
				var v36: seq<array<bool>> := [f6, f6, f6];
				var v37: array<int> := new int[14] [f4[839], if (f5 in v35) then v35[f5] else fm2(v5, 0x163, f12, f7, globalState), v0, v0, v0, f4[839], -v0, 0x0, -f4[839], f4[839], -0x365, v5, |v36|, v5];
		...
		var v48 := DC24(v40, |(if (v40 in v47) then v47[v40] else seq(0x8, i3  => (v41)))|, !false, f6);
		var v49 := "smpkh";
		globalState.f0, v44[400], globalState.f0 := false, v48.cf37, !fm3(v49, globalState);
		v44[400] := v44[400];
		...
		match (if (v50 !! v50) then v51 else v51) {
			case DC1(cf1, cf2, cf3, cf4) =>
				f6[740] := f7;
				f6[740] := f5 <==> f5;
				var v52: seq<seq<bool>> := [([false])[cf2 := f6[740]]];
				var v53 := DC31(v52);
				var v54 := DC33(v53);
				match (v54) {
					case DC32(cf49, cf50) =>
						f6[740] := !(0x48 >= (cf2 * v40));
						var v55 := new C8(v44[400], if (true) then v44[400] else v44[400], f6[740], f4, f7);
						cf2 := |[f12]| + -v40;
						globalState.f0 := if (f6[740]) then v40 < cf2 else f5;
					case DC31(cf48) =>
						var v56: multiset<int> := multiset{cf2, v40, cf2};
						var v57: map<int, int> := map[if (v40 in v56) then v56[v40] else v40 := -(v40 - v40)];
						v57 := v57[v40 := v40];
						var v58 := new C6(v44[400], f12 <==> f7, f4, f12);
						v41 := cf1;
						cf1 := v41;
					case DC33(cf51) =>
						globalState.f0 := f7;
						...
						var v63: seq<bool> := [f7];
						var v64: map<string, set<int>> := map[v59[|v60|] := {v40, |v62[|DC64(f6[740], [|v63|], cf2).cf110| := v61]|, cf2, v40}];
						var v65: multiset<int> := multiset{v40, |cf4|};
						v64 := map[v49 + v49 := set v66 : int | v66 in v65[--0x319 := cf2] :: (v66 + |map[!false := 551]|)];
						cf1 := cf1;
						v40 := cf2;
				}
				
				var v67: multiset<string> := multiset{"qx"};
				globalState.f0 := (v67 - multiset([v49[v40 := 'x'], v49])) != v67;
				var v68: map<bool, array<bool>> := map[f5 := v44[400]];
				v68 := v68[f5 := v44[400]];
			case DC0(cf0) =>
				var v69: multiset<bool> := multiset{true, f5, f5};
				var v70: multiset<bool> := multiset{v69 >= v69};
				v70 := v70;
				v40 := -|(v49 + (seq(0x37f, i4  => (v41))))|;
				v44[400][116] := true;
				v44[400][116] := !true;
				...
				v71[758] := v41;
			case DC2(cf5) =>
				var v72: map<array<bool>, seq<bool>> := map[v44[400] := [f7]];
				...
				f4[551] := v40 - -|v50|;
				f6[478] := f5;
				v76, f4[551], v76, v40, f6[478] := v76, 0x319, f4, v40 - v40, f12;
				f4[551] := -v40;
				globalState.f0 := v40 < f4[551];
				var v77: map<string, array<bool>> := map[v49 := v44[400]];
				...
				var v82: map<int, bool> := map[f4[551] := f7];
				var v83: seq<int> := [|v49|];
				var v84 := new C8(v44[400], if (v49 in v77) then v77[v49] else v44[400], [f6[478]] <= v78, if (v79 in v80) then v80[v79] else v81[f4[551]], v82 != v82[v40 := fm6(f5, v83, globalState)]);
		}
		
		var v85 := DC71(v40, v40 / v40);
		match (v85) {
			case DC71(cf120, cf121) =>
				...
				v44[400][766] := fm3(v49, globalState);
				var v91: T3 := new C8(f6, v44[400], f12, f4, f12);
				var v92: multiset<T3> := multiset{v91};
				globalState.f0, cf120, v90, v44[400][766] := f5, (cf120 + |v49|) * |v88|, if (|v92| != v40) then v90 else v90, f5;
				v91.f4[911] := cf120;
				var v93: array<string> := new string[4] [v49, v49, v49, v49];
				v93[16] := if (v91.f7) then v49 else seq(523, i5  => (v41));
				...
				var v97: map<int, bool> := map[|v96[cf120]| / v40 := f7];
				v91.f4[911], v93[16], v97 := v40, v49, v97 + map[v40 := false];
			case DC72() =>
			...
			case DC73(cf122) =>
				...
				v40, v40, v40 := (if (f7 in v107) then v107[f7] else |v109[v40]|) / (--503 % v106.f19), -(v110[v106.f19] + v40), |(v49 + v49)|;
				if (false) {
					...
					v46 := DC30(f4, v41, map[v44[400] := f7], v49).(cf44 := f4);
					var v126: multiset<seq<int>> := multiset{[0x174, fm2(v106.f19, v106.f19, f12, f7, globalState), v106.f19, v106.f19, |v110|]};
					f6[19] := v110 !in v126;
					var v127: seq<seq<bool>> := [v105, v105, fm63(f5, globalState), v105[v106.f19 := f5]];
					var v128 := DC31(v127);
					var v129 := DC33(v128);
					var v130 := DC53(f4, v41, f4, v40, v129);
					var v131 := DC55(v130);
					var v132: set<D19> := {DC55(v130), v131};
					globalState.f0, f6[19], v40 := 0x383 <= v106.f19, {v131} >= v132, if (f5) then v106.f19 else 0x2f3;
					var v133: map<bool, bool> := map[f6[19] := f6[19]];
	...
	method m11(p0: seq<int>, globalState: GlobalState) returns (r0: int, r1: multiset<multiset<bool>>) {
		if (f5) {
			...
			if (fm3(fm0(f5, globalState) + v1, globalState)) {
				globalState.f0 := f7;
				f4[765] := v0 - v0;
				globalState.f0, f4[765], r0, r0 := f12, v0, v0 + v0, v0;
				var v2: array<string> := new string[14];
				v2[120] := v1;
				var v3: seq<string> := [v1, seq(0x42, i0  => ('w')), v1];
				var v4: map<int, int> := map[v0 := v0];
				globalState.f0, f4[765], v1, v2[120] := !f5, v0, v3[--(fm2(|v4|, v0, f5, f12, globalState) * f4[765])], (seq(-901, i1  => ('i')))[f4[765] := fm15(false, f7, f4[765], globalState)];
				var v5 := DC31(seq(445, i2  => ([f7, f5])));
				var v6 := DC33(v5);
				var v7 := DC33(DC33(v6));
				var v8 := DC24(0x288, f4[765], !!(v0 >= v0), f6);
				var v9: map<int, bool> := map[v0 := fm6(f5, seq(0x37e, i3  => (f4[765])), globalState)];
				...
				v11[940] := f6;
				globalState.f0, v7, v8, v11[940] := !fm6(f12, p0, globalState), if (true) then v7 else v7, v8, f6;
				...
				f4[713] := |v12|;
				var v13: map<bool, int> := map[v0 > v0 := |(seq(0x205, i4  => ('i')))|];
			...
			globalState.f0, v21, v22, v29, r0 := f5 && v20, v21, if (v25[v0]) then v22 else v22, v29, 0xfc;
		} else {
			var v30 := 0x281;
			if (fm6(v30 < v30, fm79(v30, globalState) + p0, globalState)) {
				...
				var v36 := DC31(v35);
				var v37 := DC33(v36);
				var v38 := DC53(f4, v32[|v33|], f4, v30, v37);
				...
				var v48 := DC39([v47[v30], f6, f6, f6], f5, v30);
				var v49: array<int> := new int[22] [0x154, fm2(|v43|, v30, f12, f7, globalState), -v30, (if (f7 in v45) then v45[f7] else v30) * v30, v30, -(|(if (v48.cf65 in v46) then v46[v48.cf65] else "runmnfsx")| / |v32|), v30, v30, 0x14b, v30, |([f5, f12] + fm75(false, f5, v30, globalState))|, v30, v30, |fm98(v30, globalState)|, |(v32 + v32)|, |v34|, v30, v30 % |v32|, v30, if (f7) then -v30 else v30, p0[v30], if (f5) then -v30 else v30];
				v49 := v49;
				f6[535] := v40 !! v40;
				f6[535] := f5;
			} else {
				...
				var v50 := 'p';
				var v51 := "wnluol";
				f6[446], r0, f4[127], v50, r0 := fm6(fm3(v51, globalState), p0, globalState), v30, v30 - 0x164, v50, v30 % (|v51| + v30);
				var v52: seq<bool> := [f5];
				...
				var v60: map<D2, int> := map[v59 := 41 % f4[127]];
				v30, v57, v51 := if (v59 in v60) then v60[v59] else f4[127], DC56(v56), if (f7) then v51 else v51;
				var v61: array<bool> := new bool[7] [f12, f6[446], f12, f6[446], f7, f5, f12];
				var v62: map<bool, array<bool>> := map[f12 := v61];
				v62 := v62[f5 := v61];
				var v63 := DC24(f4[127], v30, f7, v61);
				var v64 := new C6(v63.cf37, f6[446], v58, f7);
				f6[446] := v64.fm3(v51, globalState);
			}
		...
		match (v67) {
			case DC75(cf124, cf125) =>
				if (cf125 == (cf125 - cf125)) {
					...
					cf125 := fm2(|(v73[v72 := cf125])[multiset(p0) := p0[cf125]]|, -cf125, !f7, cf124, globalState) - cf125;
				} else {
					cf124 := f12;
					var v74 := "rrtcma";
					v74 := v74;
					var v75: multiset<string> := multiset{v74};
					f6[926] := multiset{v74, v74, v74} !! v75;
					...
					var v86: set<multiset<bool>> := {multiset{f6[926]}, v85};
					var v87: set<int> := {-0x142, cf125, cf125, cf125, |v86|};
					v81[16], v74 := v84[|v74|], DC1(v82, 440, v87, "qpstnhe").cf4;
					cf124 := fm6(f7, seq(0x146, i6  => (0x17f)), globalState);
				}
				...
				if (v91 !! v91) {
					...
					f4[244] := cf125;
					v88, v93, f4[244], cf125, cf125 := v88, v93, cf125 + cf125, fm2(cf125 - cf125, cf125, !(f12 <== f12), if (f12) then cf124 else f7, globalState), cf125;
					var v94: array<seq<int>> := new seq<int>[7](i7 => seq(0xc, i8  => (-0x169)));
					v94[250] := p0;
					...
					v88, f4[244], v94[250], f4[244] := 'b', if (cf124) then |"dbafmfjy"| else cf125, v95[cf125] + p0, (|v97| * cf125) + (|v98| % -fm2(cf125, cf125, cf124, cf124, globalState));
					var v99: array<int> := new int[20];
					var v100: set<array<int>> := {v99, v99};
					var v101 := DC8(v100);
					var v102 := new C10(v101, v99);
					globalState.f0, cf124 := !!f12, fm6(f12, seq(823, i9  => (f4[244])), globalState);
					cf124 := f7;
				} else {
					...
					v105, cf124, f4[455], v106 := v105, (cf125 + cf125) >= -686, cf125, v106 * fm33(cf124, cf125, f5, v105, globalState);
					var v107: map<int, bool> := map[f4[455] := f5];
					...
					v109 := v109[v103.f16 := fm75(f5, f12, -f4[455], globalState) + v108];
				...
				var v117: seq<bool> := [(seq(524, i10  => (cf125))) == [|(map v112 : D23 | v112 in v115 :: (v112) := (cf125))|, |v91|, cf125, cf125, |v116|], f5];
				globalState.f0 := v116[0x91];
			case DC76() =>
				var v118 := 0x5;
				...
				var v122: map<bool, int> := map[v119[v118] := if (f5 in v121) then v121[f5] else -v118];
				...
				var v128: array<int> := new int[22] [v118 + v118, if (f12) then v118 else v118, v118, if (f12 in v122) then v122[f12] else v118, v118 / (if (f5 in v122) then v122[f5] else v118), v118, v118, v118, v118, v118, v118, v118 / |v123|, v118 - 0xc0, v118, |v124|, if (p0[735 := |v123|] in v125) then v125[p0[735 := |v123|]] else v118, v118, v118, |(seq(0x222, i11  => (|"phfi"|)))|, |fm42(globalState)| / v118, |(v126 + v126)|, v118 % fm2(v118, |(map v127 : map<int, bool> | v127 in {v123} :: (v127) := (v118))|, f12, f7, globalState)];
				var v129: map<string, int> := map["qfxnhwcpy" := |v119| * v118];
				var v130 := "phxjwabu";
				var v131: map<array<int>, int> := map[v124[v118] := --v118];
				v118, v128, globalState.f0, globalState.f0 := -(if (v130 in v129) then v129[v130] else |v131|), v128, !v119[v118], f7;
				globalState.f0 := v118 <= v118;
				v128 := new int[22];
			case DC77() =>
				var v132 := 356;
				...
				var v140 := DC63(p0[|v138|], f12, v139);
			...
			case DC74(cf123) =>
				...
				var v146 := DC41(v145);
				var v147 := m0(seq(0x10d, i12  => ([!f7, f7])), -(303 + p0[|v142|]), v146.cf67 + map[v144 := v143], p0 < p0, globalState);
			...
			case DC78(cf126) =>
				...
				if (v153 >= (v153 * v153)) {
					f4[550] := -0x21d;
					var v154: array<int> := new int[10](i13 => i13 % v153);
					f4[550], v154 := v153, v154;
					f4[550] := f4[550];
					f4[550] := -((f4[550] - v153) - f4[550]);
					var v155: seq<array<bool>> := [f6];
					var v156 := DC39(v155, f7, |"ay"|);
					var v158: set<bool> := {true};
					f6[502] := v156.cf65 !in (map v157 : int | v157 in [|v158|, v153] :: (v157 + v153) := (v153));
					f6[502] := true;
					var v159 := 'a';
					var v160: map<bool, char> := map[fm6(f7, fm42(globalState), globalState) := v159];
					var v161 := "rtetj";
					v160 := v160[v161 < v161 := if (f7) then v161[v153] else v159];
				} else {
					r0 := -v153;
					...
					v163, globalState.f0, globalState.f0, globalState.f0 := v165[0x20a], f12, v175 !! (v175 - v175), (v178 + v178) !! multiset(p0);
					var v179: map<int, char> := map[v153 := v176];
					var v180: seq<char> := [v176];
					var v181: array<char> := new char[14] [v176, 'l', v176, if (|v180| in v179) then v179[|v180|] else v176, v176, v176, 'g', v176, v176, v176, v176, 'y', v180[v153], 'd'];
				...
				var v184: map<bool, int> := map[f5 := v153 / v153];
				v153 := |v184|;
		...
		var v190 := 132;
		var v191: seq<bool> := [!f12 <== v189[v190]];
		...
		v197[55] := if (f12) then v194 else v194;
		var v198 := DC23(p0);
		var v199: set<bool> := {f5};
		var v200 := "c";
		v189, v197[55], v198, v190 := ([f7, !f5, !fm3("nmv", globalState)] + v189)[v190 := !({v194.f5} > v199)], if (v194.f5) then v194 else v194, v198, |v200|;
		v190 := -v190;
		var v201 := DC49(v195);
		if (match v201 {
			case DC49(cf74) => !f7
		}) {
			v194.f4[932] := -v190 % v190;
			var v202: set<int> := {v190, -v190};
			var v203 := DC36(v190, v190, v194.fm3(fm0(true, globalState), globalState), v202, f12);
			v194.f4[932] := |v203.cf59|;
			...
			v204[855] := [v206, v206, v206, v206, v206] + v208[v190];
			v194.f4[932], v204[855], globalState.f0 := (v190 - v194.f4[932]) + v190, v207, v194.f5;
			...
			v212[383] := ("sbg" + v200)[v194.f4[932] := v211];
			var v213: seq<array<bool>> := [f6];
			var v214 := DC39(v213, f12, v194.f4[932]);
			var v215: seq<int> := [v214.cf65];
			f6[123] := f7;
			var v216: map<seq<int>, seq<bool>> := map[([-0x12])[v194.f4[932] := v190] := v189];
			v212[383], v215, f6[123], v211 := v200, if (f5) then p0 else seq(0x29f, i16  => (v190)), if (false) then v194.f5 else 0x117 == v194.f4[932], fm5(-fm2(v190, -0x260, f12, f7, globalState), v194.f5, if (v215 in v216) then v216[v215] else v191, f7, globalState);
		} else {
			var v217: map<int, array<bool>> := map[|v200| % v190 := f6];
			var v218: map<int, multiset<bool>> := map[|v199| := v195[f5 := |fm4(403, f7, globalState)|]];
			v217 := v217[|v218| := f6];
			v194.f4[796] := v190;
			v194.f4[796] := v190;
			var v219: set<int> := {v194.f4[796]};
			var v220: seq<set<int>> := [v219];
			var v221: seq<int> := [|v220|, v194.f4[796], p0[608]];
			v221 := p0;
			var v222 := 'q';
			var v223: map<string, char> := map[v200[v190 := v222] := v222];
			v222 := if (fm4(|multiset(v189)|, v194.f5, globalState) in v223) then v223[fm4(|multiset(v189)|, v194.f5, globalState)] else v222;
			r0 := (v194.f4[796] % v194.f4[796]) + 0x228;
		}
	...
	method m12(p0: array<int>, globalState: GlobalState) returns (r0: int, r1: bool, r2: string, r3: bool) {
		...
		match (v0) {
			case DC14() =>
				if (f5) {
					...
					var v7 := DC1(v5, v1, v6, seq(777, i0  => (v5)));
					var v8: seq<int> := [v1, |fm4(v1, f12, globalState)|, v1, |(seq(224, i1  => (v5)))|, v1];
					v4 := v4[v7.cf4 + v3 := v8[-0x26c] * 366];
					var v9: set<char> := {v5};
					...
					f6[263] := v18 != map[v15 := map[-v16 := v13.f22]];
			...
			case DC15(cf23) =>
				...
				p0[625] := v23 - v23;
				var v24 := "nndy";
				f6[113], p0[625] := (seq(62, i2  => ('u'))) == (v24 + "ie"), v23;
				var v25: seq<bool> := [cf23, f5];
				var v26: seq<seq<bool>> := [[f6[113], f7], v25];
				var v27 := 'w';
				...
				var v31 := DC8(v29);
				var v32 := new C10(if (f5) then DC8(v30[p0[625]]) else v31, f4);
			case DC16() =>
				var v33: seq<array<bool>> := [f6, f6];
				var v34 := 140;
				var v35 := new C6(v33[v34], f12, p0, f7);
				var v36: seq<int> := [v34];
				var v37 := 'n';
			...
			case DC17(cf24) =>
				...
				var v70: multiset<seq<bool>> := multiset{v68, v68, v68, v68, v69[v67]};
				var v71 := new C0(DC80(v67, v70).cf128);
				v67 := v71.f19 % (v71.f19 * v67);
				if (f5) {
					var v72 := "pf";
					...
					var v80: seq<int> := [v71.f19, |map[v67 := -|(seq(0x2a2, i6  => (DC60('i', |{v71.f19}|, f7, 'v', |{f5}|).cf99)))|]|];
					var v81 := DC23(v80);
					v79[58] := v81;
					v79[58] := v81;
					p0[796] := v71.f19;
					v79[58], v76, p0[796], v76 := v81, v76, 0x230, v76 + ((seq(0x206, i7  => ('y'))) + v76);
					r0 := |v76| + v71.f19;
				}
		...
		if (!f5) {
			...
			v85[14] := multiset(v91[v86]) - v92;
			var v93: multiset<bool> := multiset{true, f5};
			v85[14] := fm78(v93 * multiset{true}, v86, v83, globalState);
			globalState.f0 := !f5;
			var v94: map<seq<int>, int> := map[v90 := v86];
			f6[588] := if (f12) then DC66(f5, v86, |v94|, f7).cf113 else true;
			f6[588] := v93 != v93;
			v86 := v86;
		} else {
			var v95 := 0x19;
			...
			if (v97 > (v97 * (if (f7 in v98) then v98[f7] else multiset(v101[v95 := v95])))) {
				r0, r2 := v95, "esypiqtbn";
				...
				var v112 := "vnwxbqcd";
				r2, v111 := v112, (v111[v95 := v99.f6] + v111) + v111;
				...
				v114[811], r2, r2, v117, v95 := DC81(v116).cf130, v112, v112 + v112, v117, -|(if (v118[v95 := v99.f5] in v119) then v119[v118[v95 := v99.f5]] else seq(0x2a2, i8  => (v95)))|;
				var v120: array<int> := new int[22](i9 => i9 - v116.f27);
				v120 := v99.f4;
				var v121: multiset<array<int>> := multiset{p0};
				v99.f6[167] := v121 !! v121;
				v99.f6[167] := |v112| != (v95 * v116.f27);
			}
			...
			if (f7) {
				...
				r0 := v101[fm2(v95, v95, fm6(v99.f5, v101, globalState), v127.cf124, globalState) + v95];
				var v128: array<string> := new seq<char>[8](i10 => seq(0x55, i11  => ('m')));
				...
				f6[943] := v95 >= 0x294;
				f6[943] := if (f7) then v99.f5 else v99.f5;
		...
		for i12 := v140 to |v141| {
			...
			if (true) {
				...
				var v147: map<int, seq<int>> := map[-0x299 := seq(-0x3a8, i13  => (i12))];
				...
				var v161 := DC74([v160]);
				globalState.f0, r0, v161 := !f5, |v160| % v140, v161;
		...
		v167[99], v170 := v168 + (seq(0x165, i14  => ('x'))), v170 + v170;
		if (false) {
			var v171 := DC57(v167[99], |v141|, v140, v140, f5);
			var v172: seq<int> := [-v140];
			var v173: set<seq<int>> := {v172};
			var v174: seq<bool> := [{[v140, |v171.cf92|, v172[-v140]]} > v173, f7, f12];
			v140, globalState.f0 := |v174|, v174[v140];
			f6[332] := f12;
			var v175: map<int, int> := map[-v140 + |"rtfx"| := 0x19c + |v170|];
			f6[332], r3, v175, v167[99], v140 := f5, v169 !in v168, v175 + v175, v167[99], 0x383;
			var v176: C0 := new C0(v140);
			var v177: map<bool, C0> := map[f12 := v176];
			var v178: map<bool, int> := map[f7 := v176.f19];
			var v179 := DC47(f5, v178);
			if (if (f12) then f6[332] in v177 else [f5] <= [v179.cf71]) {
				var v180: set<seq<char>> := {seq(0xf7, i15  => (v169))};
				f6[332] := (v180 + v180) != v180;
				var v181: array<bool> := new bool[29](i16 => f12);
				var v182: map<array<bool>, bool> := map[v181 := f6[332]];
				var v183 := DC30(f4, v169, v182, v168);
				var v184: seq<string> := [v168, v183.cf47, v168];
				var v185: set<int> := {|{f5}|};
				v178 := v178[!fm3(v184[|v185|], globalState) := |v175| % -v176.f19];
				...
				v187[172] := v188 + v188;
				v187[172] := if (f7) then v188 else v188 + v188;
				...
				v189[722] := v191;
				v189[722] := multiset{v190 * v190, v190};
			} else {
				v167[99] := "qn";
				globalState.f0 := f12;
				var v192: set<bool> := {f6[332]};
				f4[273] := fm2(|v192|, v140, f7, f12, globalState);
				f4[273] := (|v168| % v140) + v176.f19;
				var v193: map<seq<int>, bool> := map[v172 := fm6(f6[332], seq(0x1d6, i17  => (|v167[99]|)), globalState)];
			...
			v194[671] := map v195 : string | v195 in v196 :: (v195) := (multiset{|v141|, |{false}|, v140, v176.f19});
			var v197: seq<seq<int>> := [v172, v172];
			var v198: map<int, char> := map[|v197[|v174|]| := v169];
			...
			var v200 := DC7(-0xeb, -v176.f19, -|v167[99]|);
			var v201: map<string, multiset<int>> := map[seq(0x1f3, i18  => (v167[99][v176.f19])) := multiset{v200.cf15}];
			v194[671], v199, globalState.f0 := v201, v199, f6[332];
		} else {
			r3 := f7;
			globalState.f0 := f12;
			var v202: multiset<int> := multiset{fm2(v140, v140, f5, f5, globalState)};
			var v203: seq<int> := [v140];
			var v204: multiset<multiset<int>> := multiset{v202 * multiset(v203[v140 := |v170|])};
			p0[529] := 714;
			f4[316] := v140;
			v204, p0[529], f4[316] := v204, ---v140, -v140;
			r3 := fm6(f5, v203, globalState);
			var v205 := DC2(DC0(v167[99]));
			var v206: set<int> := {v140, |v203|};
			var v207 := DC1(v169, -f4[316], v206, v167[99][f4[316] := v169]);
			match (if (f4[316] != |v167[99]|) then v205 else DC2(v207)) {
				case DC1(cf1, cf2, cf3, cf4) =>
					v167[99] := v168;
					var v208: seq<bool> := [f5, f12, f5];
					var v209: map<bool, int> := map[f12 := |v208| * |(seq(-0xa0, i19  => (f4[316])))[cf2 := v203[p0[529]]]|];
					v209 := v209[!v208[906] := v140];
					r1 := f5;
					v167[99] := "vl";
				case DC0(cf0) =>
					...
					v211 := v211;
					r0 := 0x32d;
					var v213: set<string> := {v168, v167[99], v168, "nu"};
					globalState.f0 := v213 >= v213;
				case DC2(cf5) =>
					var v214: multiset<array<bool>> := multiset{f6, f6, f6, f6};
					var v215: array<int> := new int[1] [f4[316]];
...
class C12 {
	...
	method m9(globalState: GlobalState) returns (r0: map<int, int>, r1: T3, r2: multiset<bool>, r3: int) {
		...
		match (DC0(v0)) {
			case DC1(cf1, cf2, cf3, cf4) =>
				...
				var v5 := false;
				var v6: seq<bool> := [v5];
				globalState.f0, globalState.f0, v4[522] := (if (v5) then v5 else v5) <==> v5, if (v5) then fm10(f11, v6, globalState) else !true, fm2(fm2(f10, cf2, v5, fm10(49, v6[f10 := v5], globalState), globalState) % f11, f10, v0 < cf4, v5, globalState);
				var v7: map<int, array<int>> := map[f10 := v4];
				v4 := if (v4[522] in v7) then v7[v4[522]] else v4;
				var v8: seq<array<int>> := [v4];
				v4 := v8[|v0|];
			case DC0(cf0) =>
				var v9 := true;
				globalState.f0 := v9 <== !(if (true) then v9 else false);
				var v10: array<string> := new string[10](i0 => v0[0x28b := 'e']);
				v10[631] := v0 + v0;
				v10[631] := v0;
			...
			case DC2(cf5) =>
				...
				var v19: array<bool> := new bool[13] [v15[f11] !in v15, v14, v14, false, false, if (v14) then v14 else v14, v14, if (v14) then v14 else !fm10(|"xmvjorpcf"|, v16, globalState), multiset{v17} > v18, v14, v14 || v14, !(v0 < v0), v14];
		...
		var v22 := 'i';
		var v23 := true;
		v22 := v0[|fm0(v23, globalState)|];
		r3 := f10;
		for i2 := f11 to f11 % -0x8a {
			...
			match (v25) {
				...
				case DC6(cf12) =>
					...
					v42[701], v23, r3, r3, v42[884] := f11, f11 < f11, i2, f11, |v45[|(fm12(|v46|, v0, 107, f11, globalState) + map[v23 := v23])| := v35]|;
			}
		...
		for i7 := f11 to |v52| {
			...
			var v59: array<map<array<char>, int>> := new map<array<char>, int>[9] [v56, v56 + map[v55 := |v51[68]|], v56, v56, v56[v57[f11] := |v0|], map[v55 := |v58|], v56 + v56, if (v23) then v56 else v56, v56[v55 := f10]];
			v59[745] := v56;
			v59[745] := v56 + (v56 + v56);
			v52, r3 := v52, i7 % f11;
		...
		var v61: map<int, int> := map[-(f10 + f10) := -(|[v51[68]]| / f11)];
		r0 := v61;
		var v62: array<bool> := new bool[27];
		var v63: array<int> := new int[14](i8 => i8 - -0x3a9);
		var v64: T3 := new C11(fm10(f10, [v23], globalState), v62, v51[68] <= v51[68], v63, v23);
		r1 := v64;
		var v65: multiset<bool> := multiset{v64.f7};
		r2 := (v65 - v65)[f10 <= -f11 := f11];
		r3 := f10;
	}
	method m10(globalState: GlobalState) returns (r0: string) {
		...
		var v1 := false;
		var v2: seq<bool> := [v1];
		v0[647] := fm10(f11, v2, globalState) <==> v1;
		v0[647] := f10 < f11;
		var v3: seq<seq<bool>> := [v2, v2];
		var v4 := "ipte";
		var i0 := 0;
		while (fm10(f10, v3[|v4|], globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			i0 := i0 + 1;
			var v5: map<bool, bool> := map[v0[647] := v0[647]];
			var v8 := 'd';
			var v9: map<char, bool> := map[v8 := v0[647]];
			var v10: array<int> := new int[16] [f10, f11, f11, |v4|, f10, |v5|, f11, f11, |(map v6 : int | (-311 <= v6) && (v6 < -0x3c8) :: (v6 % f10) := (f11))|, f10, 676, f10, f11, f10, 0x2a9, |(map v7 : char | v7 in v9 :: (v7) := (multiset{f11, f10}))|];
			var v11: set<array<int>> := {v10};
			var v12 := DC8(v11);
			var v13 := new C10(v12.(cf16 := v11), v10);
			var v14: multiset<array<bool>> := multiset{v0, v0};
			var v15: map<bool, array<int>> := map[fm10(f11, v2[f11 := v1], globalState) := v13.f14];
			var v16: map<int, int> := map[fm2(f11, fm2(f10, |[v0[647], v0[647]]|, v1, v0[647], globalState), v0[647], v0[647], globalState) := f11];
			var v17 := new C3(v14 + v14[v0 := f10], v1, if (v1 in v15) then v15[v1] else v13.f14, v2 != v3[|v16|]);
			var v18: multiset<string> := multiset{"q", v4};
			var v19: seq<int> := [0x52, 0x2aa, f11];
			var v20: multiset<int> := multiset{-f11, f11};
			v18, v1, v19 := fm122(79, globalState), (v20 >= v20) <== v0[647], v19;
			var v21: map<bool, int> := map[v1 := f11 * |v4[f11 := v8]|];
			var v22: multiset<bool> := multiset{v17.f22, v0[647]};
			v21 := v21[fm2(|v22|, f10, true, v0[647], globalState) != 0x3 := 0x34];
		}
		var v23 := 'x';
		var v24: array<char> := new char[6] ['i', v23, v23, 'd', if (v0[647]) then v23 else v23, v23];
		v24[954] := v23;
		v24[954] := 'i';
		globalState.f0, r0, v1 := v1, v4, v4 <= "peg";
		for i1 := ---f10 / f11 to f10 {
		...
		match (if (true) then DC69() else v29) {
			case DC69() =>
				...
				if (fm10(f10, v2, globalState)) {
					v0[647] := v0[647];
					globalState.f0 := v0[647];
					var v30: map<char, int> := map['i' := f10];
					var v31 := m0(v3, f11, v30 + v30[v23 := 0x3a8], v0[647], globalState);
					var v32: array<seq<bool>> := new seq<bool>[13] [v2, v2, fm93(f10, globalState) + v2, v2, v2, ([v0[647], v0[647]])[f10 := fm10(fm2(f10, f10, v0[647], v1, globalState), v2, globalState)], v2, v2 + v2, v2, v2 + v2, v2, v2, v2];
					var v33: map<string, bool> := map[v4 := true];
					globalState.f0, v32, globalState.f0 := if ((seq(48, i2  => (v24[954]))) in v33) then v33[seq(48, i2  => (v24[954]))] else v0[647], v32, v1;
					globalState.f0 := v1;
				} else {
					var v34: map<int, int> := map[f11 := |[false, v1, v0[647]]|];
					var v35: set<map<int, int>> := {map[0x9 := 225] + v34, v34};
					var v36 := 859;
					var v37: array<int> := new int[20];
					v35, v0[647], v36, v36, v0[647] := (v35 - v35) * v35, v37 in {v37}, (f11 + v36) % f10, f11, f11 > fm2(-f11, v36, v1, v0[647], globalState);
					var v38: map<int, bool> := map[v36 := v1];
					var v39: C6 := new C6(v0, !false, v37, if (|v2| in v38) then v38[|v2|] else v1);
					var v40: seq<C6> := [v39];
					globalState.f0 := v2[|v40|];
					r0 := v4;
					var v41: multiset<bool> := multiset{v0[647], v39.fm6(v0[647], fm18(v0[647], v0[647], v0[647], f10, globalState), globalState)};
					var v42: map<int, multiset<bool>> := map[f10 := v41];
					var v43: set<multiset<bool>> := {multiset{v0[647], v1, v0[647], v0[647], v1} * v41, v41 + multiset(v2), v41, multiset{!v0[647], v0[647], v0[647], v0[647]}, if (f10 in v42) then v42[f10] else v41};
					var v44: set<int> := {f11, f11, -f11, f11};
					v43 := v43 - fm34(v44, 0x3b3, globalState);
					var v45: map<bool, multiset<bool>> := map[v44 >= v44 := (multiset{v0[647]})[false := -f10] + v41];
					var v46: seq<array<bool>> := [v0, v0];
					var v47: seq<array<bool>> := [v0, v0, v46[v36], v0, v0];
					v34, globalState.f0, v36, v45 := v34[|v46| := v36], v2[-(-f11 / v36)], -f10, v45 + map[true := v41];
				}
		...
		r0 := if (|v59| == f11) then fm0(v1, globalState) else ("fso")[|fm12(|v60|, v4, f10, f11, globalState)| := v23];
	}
}
...
class C13 extends T2, T3 {
	...
	function fm8(p0: bool, p1: bool, globalState: GlobalState): bool {
		f9 != DC1('x', f9, {f9}, seq(0x125, i0  => ('d'))).cf2
	}
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (!f5) {
			...
			var v6: seq<bool> := [f7];
			var v7: seq<bool> := [!f7, f7, v6[0x32e]];
			...
			var v14 := "comihe";
			var v15: seq<int> := [|v14|];
			var v16: map<int, multiset<bool>> := map[if (!f5 in v13) then v13[!f5] else v15[f9] := v13];
			var v17: map<int, bool> := map[f9 - |v16| := f5];
			v17 := v17[f9 - |"acplw"| := f7];
			var v18: array<D16> := new D16[10];
			var v19: seq<array<D16>> := [v18, v18];
			var v20: set<array<D16>> := {v19[-f9], v18, v18};
			var v21: seq<set<array<D16>>> := [v20];
			var v22: seq<set<array<D16>>> := [v20, v21[f9], v20];
			v20 := v22[f9];
		...
		if (f7 ==> f5) {
			...
			var v26: seq<bool> := [f7];
			var v27: set<int> := {|v26|};
			var v28: map<int, multiset<int>> := map[f9 := (v24[f9 := |v26|])[f9 := f9]];
			if ((v25[|v27|] * v24) >= (if (f9 in v28) then v28[f9] else v24)) {
				var v29 := "anryvbgci";
				...
				var v33 := new C6(f6, !f5, v32[f9], f7);
				globalState.f0 := f7;
				var v34 := DC75(f5, |v27|);
				...
				v39, v42, v43[223], r0, v46 := v39, v42, v45 + (if (f7) then v45 else v45[v44 := f7]), (0x242 / |v47|) % f9, (v46 + v46) + fm67(|multiset([f5, f5])|, f5, true, globalState);
				var v48 := 's';
				globalState.f0, v48, v48, globalState.f0 := f5, v48, v48, f5;
				globalState.f0 := f5 <== false;
				var v49: seq<int> := [f9];
				r0 := v49[fm2(f9, f9, f5, f5, globalState)];
				var v50 := DC19(p1, f5);
				v50 := v50;
			}
			...
			if (f9 <= |v51|) {
				...
				var v55 := DC31(v54);
				var v56: array<D12> := new D12[20] [v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, DC31(v54), v55, DC31(v54[f9 := v26]), v55, DC31(v54), v55.(cf48 := v54), DC31(v54), v55, v55];
				var v57: seq<array<D12>> := [v56];
				var v58 := DC56(v57[|v51| := v56] + v57);
				v58 := v58;
				var v59: array<bool> := new bool[10];
				v59 := if (false) then v59 else f6;
			} else {
				var v60 := DC35(f9, f7, map[seq(826, i2  => (f9)) := f9]);
				var v61: set<D13> := {v60};
				p1[17] := |v26| * |v61|;
				f6[901] := f7 <== f5;
				p1[17], f6[901] := f9, !(f5 || f5);
			...
			var v67 := 'i';
			r0, r1 := f9 % -99, !(v67 !in (seq(0x1a0, i4  => (v67))));
			var v68: array<bool> := new bool[5];
			v68 := f6;
			r0 := f9;
			f6[393] := f7;
			var v69: seq<bool> := [f7, f7, f5, f5];
			f6[393], globalState.f0 := (true <== fm10(f9, v69, globalState)) <== f5, f7;
			var v70 := DC71(0xf, f9);
			var v71: seq<D27> := [v70, DC71(f9, f9), v70];
			var v72: array<seq<D27>> := new seq<D27>[25] [v71[f9 := DC71(f9, f9)], v71, [v70], [v70], v71 + v71, v71 + v71[f9 := v70], v71, seq(0x163, i5  => (DC71(|{f7, !f7}|, 0x1ab))), v71, [v70], v71, v71, v71, v71 + v71, v71, seq(0x31e, i6  => (v70)), v71 + v71, v71, [v70], v71 + [v70], v71, v71, v71, [v70], (seq(0x1ff, i7  => (v70))) + v71];
			var v73: map<int, array<seq<D27>>> := map[--(f9 % f9) := v72];
			v72 := if (f9 in v73) then v73[f9] else v72;
		}
		
		var v74 := "tkhhkqfau";
		var v75: seq<seq<int>> := [[f9]];
		r0 := -(fm2(f9, |v74|, f5, f7, globalState) % |v75|);
		var v76: seq<bool> := [false];
		var v77 := 'r';
		var v78: set<char> := {v77};
		var v79 := DC57(v74, |multiset(v76)|, |v78|, f9, f7);
		r0 := 0x152 % |(v79.cf92 + v74)[f9 := v77]|;
		r0 := f9;
		globalState.f0 := f5;
		r0 := 0x24c;
		r1 := f7;
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		v1 := map v2 : string | v2 in ((if (f9 in v3) then v3[f9] else multiset{v0, v0}) * v4) :: (v2) := ((seq(701, i0  => (|v0|))) <= [0x183, |map[!f7 := true]|]);
		var i1 := 0;
		while (f5)
			decreases 100 - i1
		{
			...
			var v8: multiset<int> := multiset{|(if (f5 in v6) then v6[f5] else v5)|, v7[f9], -f9};
			var v9 := 'k';
		...
		var v16 := 'e';
		var v17: seq<bool> := [f7];
		for i3 := fm2(f9, |v0[f9 := v16]|, f7, fm10(v11, v17, globalState), globalState) to v11 {
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		var v4 := DC54(v2.f27, f9, v3['m' := p2], 826, f9);
		var v5 := DC55(v4);
		v5 := v5;
		...
		for i0 := 0x19 * v2.f27 to v2.f27 {
			...
			v2.f27 := |(v7 - fm83(p2, DC54(|v8|, |v9|, v3, 0x114, p2), globalState))| % v2.f27;
			v2.f27 := p2;
			var v10: array<int> := new int[27](i1 => i1 * |{f7, !p0, p1, f7}|);
			v10 := f4;
			var v11: map<int, bool> := map[-p2 % v2.f27 := v2.f27 == 0x13];
	...
	method m4(globalState: GlobalState) {
		...
		match (v5) {
			case DC80(cf128, cf129) =>
				...
				f6[593] := v10 < v10;
				globalState.f0 := cf128 > (f9 % f9);
				var v11: seq<int> := [if (f7) then cf128 else f9, f9];
				var v12: seq<bool> := [f5];
				var v13: array<bool> := new bool[12];
				var v14 := DC24(f9, cf128, f5, v13);
				v11 := (if (!f6[593]) then fm18(f7, v12[|v7|], f7, f9, globalState) else v11) + [fm2(cf128, v11[-f9], v14.cf36, f7, globalState)];
			case DC79(cf127) =>
				...
				v20 := v18[f9 := if (f4 in v21) then v21[f4] else v17];
				var v22: array<seq<int>> := new seq<int>[8](i0 => [f9]);
				var v23: seq<int> := [|(seq(0x1a1, i1  => (v2)))|];
				v22[978] := v23;
				v22[978] := v23[f9 := f9];
				f6[507] := v17.f17;
				var v24: seq<bool> := [v17.f17];
				f6[507] := (if (fm10(f9, v24, globalState) in v0) then v0[fm10(f9, v24, globalState)] else f5) && true;
		}
		...
		for i2 := -|v25| to |v27| {
			...
			match (v34) {
				case DC63(cf106, cf107, cf108) =>
					...
					v36[63] := v38;
					var v39: multiset<string> := multiset{seq(0x38a, i5  => (v2))};
					v35, cf106, cf107, v36[63], globalState.f0 := (seq(0x30, i4  => (-0x21f))) + v35, cf106, (f9 * cf106) > (if (cf107) then cf106 else DC83(|[f7]|, f7).cf131), v38, (if (v26.fm6(f5, v35, globalState)) then v39 else v39) !! v39;
					f6[7] := v35 == v35;
				case DC64(cf109, cf110, cf111) =>
					globalState.f0 := cf109 <==> cf109;
					v26.f20[615] := f7;
					v30[56] := cf111;
					cf109, v26.f20[615], cf111, v30[56] := fm2(cf111, cf111, f5, f5, globalState) == i2, f5, i2, -i2;
					var v40: map<bool, array<int>> := map[v26.f20[615] := f4];
					var v41: set<bool> := {f5, cf109};
					var v42: C11 := new C11(f7, v26.f20, f7 && v26.f20[615], if (cf109 in v40) then v40[cf109] else f4, v41 <= {cf109, f5, true});
					v42 := v42;
					v30[56] := cf111;
				case DC62(cf105) =>
					v26.f20[152] := f5;
					...
					v26.f20[152] := v43[f9];
					v26.f20[152] := if (v26.f20[152]) then f7 else v26.f20[152];
			...
			v26.f20[223] := v26.fm6(v45 !! v45, v47, globalState);
		}
		globalState.f0 := f7;
		var i6 := 0;
		while (f9 > (f9 * f9))
			decreases 100 - i6
		{
			...
			v3 := v3[false := if (f9 in v50) then v50[f9] else v49];
			var v51: set<int> := {v49};
			var v52: seq<set<int>> := [v51];
			var v53: T1 := new C5('o', f9);
			var v54 := DC32(v52[|v51|], v53);
			var v55 := new C7(v54);
		}
		var v56 := DC4();
	...
	method m7(p0: bool, p1: bool, p2: D0, p3: int, globalState: GlobalState) returns (r0: char) {
		...
		if (p1) {
			if (if (f5) then f5 else p0) {
				...
				v10[264] := fm124(globalState);
				var v11 := 'i';
				var v12: map<bool, string> := map[f7 := v4[f9 := v11]];
				v10[264] := v12[p1 := v4];
				globalState.f0 := f5;
				globalState.f0 := p0;
				...
				v17[521] := v18;
				var v19 := 'd';
				var v20: array<string> := new seq<char>[18] [seq(0x1be, i3  => ('w')), v4, if (p1) then v4 else v4, v4, v4, v4, (v4 + v4)[p3 := fm14(f5, v19, -f9, p3, globalState)], v4, v4 + v4, v4, v4, v4, v4, v4, v4, v4 + v4, v4, v4];
				v20[194] := v4;
				v20[194] := (v4 + (seq(0x205, i4  => ('e')))) + v4;
			}
			...
			v24, globalState.f0, v9, v9, f6[938] := v24, v26 !! (multiset{p0} - v26), f9 - p3, f9, fm9(p0, globalState);
			f6[938] := !p1;
			var v27: array<bool> := new bool[22] [f6[938], f7, if (p0 in v25) then v25[p0] else f6[938], p0, p0, p0, false, f5, f7, !f6[938], p1, f7, p0, p1, p1, f7, p1, false, f6[938], p1, f6[938], f6[938]];
			var v28: map<array<bool>, bool> := map[v27 := f5];
			globalState.f0 := v27 !in (v28 + v28);
			if (fm3(v4, globalState)) {
				var v29: map<D24, seq<int>> := map[DC62(seq(0x29, i5  => ({'j', 'r'}))) := [-264, -0xc2, f9]];
				var v30: map<bool, int> := map[f6[938] := |(v29 + v29)|];
				v9, globalState.f0 := |v30|, !(v9 <= |[f9]|);
				var v31 := DC69();
				v31 := v31;
				var v32 := 'g';
				v9, v4 := |(v4[|v26| := v32] + v4)| * p3, v4;
				var v33 := DC9(f4);
				...
				v35 := ([|v37|, |v4|] + v35)[|v23| := v9];
				var v38 := DC75(p1, v35[f9]);
				...
				var v43 := DC3([true, f6[938], false, f7]);
				var v44: multiset<seq<bool>> := multiset{v43.cf6, ([p0, p0, p1, f6[938], p1])[f9 := f7], v23, v23};
				var v45: seq<int> := [0xca, |v26|, |v41|, -v9, p3];
				var v46: array<int> := new int[13] [DC80(p3, v44).cf128 * p3, |v25|, -p3, |map[|[f5, f7]| := |v21|]|, p3, f9, p3, |v45|, p3 % v9, p3, v9, |v21| / v9, v9];
				v46 := f4;
				var v47: map<int, int> := map[p3 := f9];
				var v48 := new C12(if (v9 in v47) then v47[v9] else |v23|, f9);
				var v49: set<seq<bool>> := {v23, v23[v9 := false]};
				var v50: map<set<seq<bool>>, int> := map[v49 := |v21|];
				v9 := (|v4| / (if (v49 in v50) then v50[v49] else v48.f10)) + (v9 * 112);
			}
			...
			if (p1) {
				...
				f4[220], globalState.f0, v54[458] := f9, v55 !in v56, if (f7) then v4 else v4 + v4;
				var v57: multiset<array<bool>> := multiset{f6};
				var v58: map<bool, int> := map[f5 := p3];
				var v59 := new C3(v57[f6 := |v58|], f5, v55, p1);
			} else {
				f4[220] := p3 / v9;
				var v60 := 'g';
				...
				var v66: map<char, bool> := map[v60 := if (f4[220] in v65) then v65[f4[220]] else f7];
				v66 := v66[v60 := p0];
			...
			v73 := map v74 : int | (171 <= v74) && (v74 < 0x354) :: (v74 / p3) := (p3);
		}
		
		for i7 := p3 to p3 {
			var v75: array<int> := new int[9];
			globalState.f0, v9, v75 := p0, i7 % (p3 % f9), v75;
			globalState.f0 := false;
		...
		if (true ==> f7) {
			...
			if ((v2 !! v2) <==> p0) {
				...
				v110[948] := (v115 - v115) - (v115 * multiset(v116));
				globalState.f0 := f7;
				var v117: C6 := new C6(f6, p0, v89.f14, v83[p3]);
				var v118: array<C6> := new C6[17] [v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117, v117];
				v118[224] := v117;
				v118[224], v9 := v117, p3;
				var v119: seq<C6> := [v118[224], v117, v118[224], v118[224]];
			...
			v122 := v122[f7 := -0x3c9];
			var v123 := 's';
			globalState.f0 := v123 !in (seq(-0x35a, i11  => (v123)));
			...
			match (v125) {
				case DC51(cf76, cf77, cf78) =>
					...
					var v128 := DC5(f9, v126, !cf76, v127[v9], !p0);
				...
				case DC50(cf75) =>
					...
					var v133: multiset<array<int>> := multiset{f4, f4, v132[v9], f4, f4};
					v133 := (v133 - v133) - (v133 + v133);
					globalState.f0 := p1;
			}
			
			m8(v0, !f5, p1, globalState);
			v9 := 621 + (f9 / |([false])[p3 := false]|);
		}
	...
	method m8(p0: set<array<bool>>, p1: bool, p2: bool, globalState: GlobalState) {
		...
		if (!p2) {
			...
			var v1: seq<int> := [844, f9, |(seq(-311, i0  => ('f')))|];
			var v2: multiset<array<int>> := multiset{f4, v0[|{|v1|}|], f4, f4, f4};
			globalState.f0 := v2 != v2[f4 := f9];
			var v3: seq<bool> := [f7];
			var v4: array<bool> := new bool[3] [f5, p2, f7 <==> v3[f9]];
			v4 := v4;
			...
			if (true) {
				...
				v7 := map v8 : string | v8 in (if (f5) then multiset(["vvworjo", seq(936, i2  => ('e'))]) else v9) :: (v8) := (v4[513]);
			} else {
				f4[133] := -(f9 * f9);
				f4[133] := v6.f19;
				globalState.f0 := p2;
			...
			if ((v12 + v12) < v12) {
				...
				var v16 := "ftnptr";
				var v17: seq<int> := [|v16|];
				var v18: map<string, int> := map[v16 + v16 := v17[f9]];
		...
		if (f5) {
			...
			if (p2) {
				...
				var v26: seq<bool> := [f5];
				f4[60], v24, v23[974] := 58, fm2(|v25| % v24, f9, p1, fm10(0x34, v26, globalState), globalState), f9 * 744;
				v24 := v23[974];
				f6[285] := f7;
				var v27: map<bool, bool> := map[p2 := f5];
				globalState.f0, f6[285], v27 := f7, false, v27;
				...
				var v32 := 'o';
				var v33: seq<int> := [f4[60], v23[974], f9];
				var v34: set<int> := {v23[974]};
				var v35: array<bool> := new bool[16];
				var v36: multiset<array<bool>> := multiset{v35, v35, v35, v35};
				f6[285], v24, v23[974], v24 := v30 == (v30 + [seq(0xcb, i5  => ('j')), v29])[v24 := v29[|{v31, v31}| := v32]], --(v33[|v34|] + 0x4b), |(v36 * v36)|, v24;
			} else {
				...
				v42, globalState.f0, v43, v42, v44 := seq(0x2e3, i6  => (v38)), f7, --v43, v37.fm4(v43, f7, globalState) + v42, v44;
				v43 := -v43 + |(seq(0x289, i7  => (v38)))|;
			}
			...
			match (v48) {
				case DC71(cf120, cf121) =>
					...
					var v51: seq<bool> := [f7];
					var v52 := DC57(v49, |p0|, fm2(cf120, cf120, p2, v50.cf40, globalState), cf120, v51[cf120]);
					...
					var v58 := m0(v53 + [v51, v51], f9 % 0x233, v56, !(if (p2) then p2 else if (fm9(f5, globalState) in v57) then v57[fm9(f5, globalState)] else f7), globalState);
			...
			var v83: seq<bool> := [f5];
			var v84: multiset<int> := multiset{fm2(f9, f9, p2, if (f5 in v82) then v82[f5] else v83[|[f7]|], globalState), f9};
			...
			match (DC13({false}).(cf22 := v88)) {
				...
				case DC16() =>
					...
					v102, v101 := v102, if (v86.f17 <==> p1) then seq(-0xcb, i9  => ('f')) else v101;
				case DC13(cf22) =>
					globalState.f0 := f9 !in (v86.f18 * v86.f18);
					v87 := f9 + f9;
					f4[963] := fm2(f9, v87, f5, p1, globalState);
					f4[963] := v87;
					v87 := f9;
				case DC17(cf24) =>
					...
					v105[236] := (if (v103.f19 in v106) then v106[v103.f19] else v84)[f9 := |v104|];
			}
			...
			decreases 100 - i11
		{
			...
			if (v112 < fm20(globalState)) {
				...
				var v115: seq<string> := [seq(-0x6c, i12  => (v109)), v113];
				...
				var v121: set<int> := {|[f9]|};
				globalState.f0, v119, v113 := (if (!true) then true else if (v111.fm6(p1, v117, globalState) in v120) then v120[v111.fm6(p1, v117, globalState)] else p1) && (v121 >= v121), v119, (v113 + (seq(0x316, i13  => (v109)))) + v113;
				var v122: array<map<int, bool>> := new map<int, bool>[1](i14 => v114);
				v122[65] := map[v119 := p1] + map[fm2(v119, v119, !f5, p1, globalState) := !f5];
				v122[65] := map[f9 := f7];
				v119 := f9;
			} else {
				...
				f4[145], f4[693], v129, v130 := -(f9 * v129), |((v132[f9])[|(map v133 : int | (-0x206 <= v133) && (v133 < 0x366) :: (v133 % |"bejg"|) := (f9))[|v134| := v129]| := v129] * v131)| % v129, f9, v130;
				var v135 := "pckl";
				v129 := |(v135 + v135)|;
				var v136: array<D24> := new D24[6](i15 => DC64(v127.f5, [|v135|, f4[145], f4[145]], 0x22a));
				var v137: map<bool, array<D24>> := map[f4[145] != f4[145] := v136];
			...
			match (v140) {
				case DC42(cf68) =>
					...
					v111.f20[93] := cf68;
					var v143 := "cmkyn";
					v141, cf68, v142, v109, v111.f20[93] := v141, (v143 + v143) <= v143, (if (cf68) then v142 else v142) - v142, v109, p1;
				...
				case DC43() =>
					...
					v145[888], globalState.f0 := v147 + v147, p1;
					f4[753] := fm2(f9, f9, f5, p1, globalState);
					f4[753] := -591;
					f4[753] := --457;
				case DC44() =>
					var v148 := 0x23c;
					var v149: map<int, int> := map[f9 := |(seq(-0x5f, i18  => (v109)))|];
					var v150: map<int, map<int, int>> := map[|(seq(0x17d, i17  => (v109)))| := v149];
					var v151: seq<int> := [f9, f9, v148, |v150|];
					v148 := (v148 * --633) + v151[-0x227];
					var v152: map<array<bool>, int> := map[v111.f20 := 43];
					var v153: map<bool, int> := map[f7 := f9];
					v152 := v152[f6 := |(v153 + map[f7 := v148])|];
					f4[894] := v148 * f9;
					v148, f4[894], v148, globalState.f0 := v148, f9 % |"tyyuhk"|, f9, false && true;
				...
				case DC45(cf69) =>
					...
					f4[325] := fm2(f9 - f9, |v168|, p2, v169.cf116, globalState);
			}
		...
		var v178: seq<string> := [seq(440, i21  => ('i'))];
		var v179: set<int> := {f9};
		var v180: set<D20> := {fm125(f9, f7, globalState), v174, DC57("frlr", f9, f9, |v179|, true), v174};
		var i20 := 0;
		while ({v174.(cf93 := |(map v175 : int | v175 in v176 :: (v175 + 115) := (map v177 : int | v177 in [|{'h'}|, f9, f9, f9, |map[f9 := f9]|] :: (v177 * f9) := (0x214)))|, cf94 := fm2(f9, f9, true, p2, globalState), cf92 := v178[f9]), v174, v174, fm125(f9, p2, globalState)} <= (v180 + v180))
			decreases 100 - i20
		{
			if (i20 >= 100) {
				break;
		...
		if (|([f5])[f9 := f5]| > f9) {
			...
			v187[689] := DC35(f9, p1, v189);
			var v190: map<char, char> := map['m' := v183];
			var v191: map<int, seq<int>> := map[|v190| := v188];
			var v192: seq<bool> := [p1];
			var v193 := DC35(v185 / v185, if (true) then p1 else v192[v185], v189);
			v184, v185, v186, v183, v187[689] := DC22(f7, f5), v185, if (!f7) then v186 + fm92(|v191|, v185, f7, !f7, globalState) else v186, v170[-v185], v193;
			...
			match (DC56(v199)) {
				case DC57(cf92, cf93, cf94, cf95, cf96) =>
					...
					var v201: set<multiset<int>> := {v200[cf95]};
					v201 := v201;
					var v202: array<seq<int>> := new seq<int>[25](i23 => seq(-0xd7, i24  => (|map[v171.f20[963] := v171.f20[963]]|)));
					v202[263] := seq(98, i25  => (v185));
					...
					var v206: array<int> := new int[25] [0x1af, f4[349], cf94, f9, cf94, f9, |cf92|, -f4[349], |v192|, |v205|, |v170|, 66, cf93, f4[349], v185, f9, cf93, cf93, cf95, fm2(f9, f4[349], p2, p1, globalState), f4[349], v185, |v192|, cf94, 859];
					...
					v211 := v211[0x9d := v212];
				case DC56(cf91) =>
					v171.f20[963] := v171.f20[963];
					var v213: map<bool, int> := map[f7 := |(v170 + v170)|];
					v213 := v213[v171.f20[963] := f9];
					v171.f20[963], v185, v185, globalState.f0 := p2, -f9 - -fm2(|v170|, v185, !f5, p1, globalState), v185, v185 == (f9 + v185);
			...
			var v217 := 'j';
			globalState.f0 := !!DC60(v217, f9, f5, v170[|v170|], |v176|).cf101;
			var v218: map<bool, array<int>> := map[p2 := f4];
			var v219: map<array<int>, int> := map[f4 := |v170|];
			var v220: seq<map<array<int>, int>> := [v219];
			var v221: array<map<array<int>, int>> := new map<array<int>, int>[9] [map[if (p1 in v218) then v218[p1] else if (p2 in v218) then v218[p2] else f4 := |multiset(seq(0xa9, i26  => (-f9)))|], v219, v219, v219[f4 := 0x1ce], v219 + v219, v219, v219, v219 + v219, v219 + v220[f9]];
			v221[216] := v220[-f9] + v219;
			v221[216] := v219 + (map[f4 := f9] + v219);
			f6[124] := false <== p2;
			...
			f6[124] := (multiset{p2} < v226) <==> (|v228[v224]| == |"qicgokva"|);
		}
...
class C14 extends T2 {
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		if (v0 <= (v0 + v0)) {
			...
			var v11 := "s";
			var v12: set<int> := {|v11|};
			v2[727] := new int[13] [v1, v1, fm2(v1, v1, f5, v4.cf9, globalState), v1, 0x310 * |v5|, |(seq(0xe8, i1  => ('l')))|, v1 - |v5[if (f5 in v6) then v6[f5] else f5 := v1]|, fm2(|v8|, |v10[v1 := v9]|, f5, f5, globalState), v1, v1 * |v12|, v1, v1 * v1, v1];
			r0 := v1 * -v1;
			p1[49] := v1;
			...
			match (v4.(cf7 := |map[v7 := f5]| * |v9|, cf11 := true)) {
				case DC4() =>
					p1[49] := 0x2ff;
					var v15: set<bool> := {f5, p1[49] < -p1[49], f5};
					var v16: seq<array<bool>> := [v3, v3, v3];
					var v17: map<int, array<bool>> := map[v1 := v3];
					var v18: array<array<bool>> := new array<bool>[27] [v3, v3, v3, v3, v3, v16[|map[v1 := true]|], v3, if (f5) then v3 else v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, v3, if (f5) then v3 else v3, v3, v3, v3, if (fm2(v1, p1[49], f5, f5, globalState) in v17) then v17[fm2(v1, p1[49], f5, f5, globalState)] else v3, v3];
					var v19: seq<bool> := [f5];
					var v20: map<int, int> := map[358 := p1[49]];
					var v21: multiset<int> := multiset{|v19|, p1[49], if (p1[49] in v20) then v20[p1[49]] else p1[49], |v12|};
					r1, v1, v12, v15, v18 := f5, (v4.(cf10 := v1, cf8 := v3, cf7 := |map[|v21| := f5]|)).cf10, v12, v15, v18;
					var v22: map<multiset<int>, bool> := map[multiset([|map[p1[49] := f5]|]) := f5];
					v22 := v22[v21 - v21 := !!!f5];
					globalState.f0, globalState.f0, v7 := (if (f5) then |v11| else p1[49]) <= p1[49], f5, v7;
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
			...
			v27 := v27[v28[v26] := v26];
			var v29: seq<bool> := [f5];
			var v30: multiset<seq<bool>> := multiset{v29[v26 := !true]};
		...
		var v61: array<D32> := new D32[25] [v59.(cf140 := v37), v59, v59, fm126(false, globalState), DC89(v37), fm126(f5, globalState), v59.(cf140 := --v37), if (f5) then DC89(v37) else DC89(v37), DC89(|v60|), v59, v59, v59, v59, fm126(false, globalState), v59, v59, v59, v59, DC89(-v37), v59, v59, DC89(|(seq(0x180, i4  => ('w')))|).(cf140 := |{f5}|), v59, v59, v59];
		v61[445] := v59.(cf140 := v37);
		...
		v54[47], v37, r0, v57, v61[445] := (v56 + v56)[v37 := if (v62 in v63) then v63[v62] else |v55|], |fm49(if (f5) then -v37 else v37, globalState)|, fm2(v37, |v65|, {!!false, f5} > v66, f5, globalState), v57, if (f5) then v59 else v59;
		...
		v67, v66, v68 := v67, fm1(fm2(v37, 0x37c, f5, f5, globalState) % -151, (if (v37 in v69) then v69[v37] else v37) + |v75|, globalState), if (multiset(v58) !! multiset{f5}) then v68 + (map v76 : seq<bool> | v76 in v77 :: (v76) := (f5)) else map[v58 := f5];
		var v78: set<int> := {v37 / fm2(|v69|, 0x373, f5, f5, globalState), |multiset{seq(130, i6  => (v70))}| % v37, v37};
		var v80: seq<set<int>> := [v78, set v79 : int | (0x3af <= v79) && (v79 < 0xd4) :: (v79 % v37), v78, v78];
		v78 := v80[v37 + v54[47][v37]];
	...
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
		...
		for i0 := -v0 to v3[v0] {
			...
			v10[810] := v11 * v11;
			var v12 := DC88(f5);
			v8[54], v10[810], globalState.f0, globalState.f0 := false, v11, f5, v12.cf139 && f5;
			globalState.f0 := f5;
		}
		for i1 := v0 to v0 {
			globalState.f0 := f5;
			...
			f4[996] := 0x110;
			f4[996] := i1 / (if (f5) then i1 else |v1|);
		}
		var v18: map<bool, bool> := map[f5 := !f5];
		var v19: set<int> := {v0, v0};
		var v20: seq<bool> := [f5, f5];
		var v21: map<bool, int> := map[{|(seq(0x294, i2  => ('t')))|, |v18|} !! v19 := |v20| * v0];
		...
		for i3 := |(map[f5 := f5])[f5 := f5]| to v0 {
			...
			if (!(v23 > (v23 - {v3, v3, v3, [|v1|], v3}))) {
				...
				var v26 := 'i';
				v25[629] := if (!f5) then v26 else v26;
				v25[629] := v26;
				v1 := v1;
				...
				v29[147] := f5 <== f5;
				v29[147] := fm3(seq(552, i5  => ('x')), globalState);
				v29[147] := f5;
				var v30: seq<array<bool>> := [v29];
				var v31: multiset<array<bool>> := multiset{v30[v0]};
				...
				v38 := v38 + v38;
				var v39: T2 := new C3(v31 + v32.f21, v29[147], f4, f5);
				v39 := v39;
				var v40 := 'd';
				var v41: T0 := new C2();
				...
				var v47 := new C8(v29, v29, v39.f5, (v46.(cf84 := DC33(v44), cf81 := v40, cf80 := f4)).cf82, v29[147]);
			}
			
		}
		var v48: array<bool> := new bool[13];
		var v49: map<array<int>, int> := map[f4 := v0];
		v48[482] := (if (f4 in v49) then v49[f4] else v0) !in v19;
		v48[482] := v20[v0 % v0];
	}
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		var v0 := "gtnqjfd";
		...
		var v4: array<bool> := new bool[17] [p1, f5, p1, f5, !p1, f5, !!v1[p2], p1, fm3(v2[p2], globalState), p0, !p0, if (fm2(p2, p2, f5, p1, globalState) in v3) then v3[fm2(p2, p2, f5, p1, globalState)] else f5, fm3(v0, globalState), f5, p1, p0, f5];
		...
		for i0 := fm2(|v0|, |map[0x1ce := -p2]|, p1, f5, globalState) to p2 {
			...
			if (f5) {
				...
				var v14: seq<seq<seq<bool>>> := [((seq(0x361, i1  => (v1))) + ([v1])[p2 := v1])[p2 := v1]];
				v13 := v14[i0 - i0];
				var v15 := DC71(p2, p2);
				var v16: map<bool, char> := map[p0 := v10];
				f4[210] := -|(if (p0) then v7 else [(v15.(cf121 := |v16|)).cf121])|;
				f4[210] := i0;
			} else {
				var v17: seq<int> := [i0];
				var v18: map<array<int>, seq<int>> := map[f4 := v17];
				var v19: seq<multiset<int>> := [multiset(v17)];
				v18 := v18[f4 := v17[p2 := |v19|]];
				...
				v24 := v24;
				v17 := [i0];
				var v25: seq<seq<int>> := [seq(616, i2  => (p2)), v17];
				globalState.f0 := v5.fm6(p1, v25[i0], globalState);
				var v26 := DC23(v17);
			...
			if (p0) {
				...
				globalState.f0 := p0;
				f4[729] := i0;
				f4[729] := fm2(|(v1 + v1[p2 := p0])|, p2, p1, v29.fm3(v0, globalState), globalState);
			} else {
				var v30 := 'v';
				...
				r0, globalState.f0, r0, v32 := i0, if (p0 && f5) then p1 else f5, i0 % -|v0|, v32 - (v32 - (if (v36[280 := v35] in v37) then v37[v36[280 := v35]] else {v31}));
				var v38: set<int> := {p2};
				...
				var v47: array<D1> := new D1[17] [DC5(|v42|, v4, p1, i0, f5), v43, v43, v43, v43, v43, v43, v43, DC5(fm2(p2, p2, f5, !p1, globalState), v4, v1[i0], |multiset{v46}|, p1), v43, v43, v43, v43, DC5(p2, v4, !!true, v31.f27, f5), v43, v43, v43];
				v47[557] := v43;
				var v48: multiset<int> := multiset{v31.f27, v31.f27, i0};
				var v49: seq<int> := [v31.f27 / p2, v31.f27, |v48|];
				var v50: multiset<bool> := multiset{p1, p0};
				r0, v47[557], v31.f27, r0, r0 := |v49|, v43, |v50| / (|v48| % |v49|), -v31.f27, (i0 - i0) - p2;
				r0 := i0;
				v31.f27 := if (v45.fm3(v0, globalState)) then p2 else i0;
				var v51: set<seq<bool>> := {v1, v1};
				var v52: seq<set<seq<bool>>> := [v51, {v1, v1, v1}, v51];
				var v53 := DC90({v1});
				v51 := {v1} + (if (false) then v52[v31.f27] else v53.cf141);
			}
...
class C15 extends T3 {
	...
	method m4(globalState: GlobalState) {
		if (f7 || !f7) {
			...
			if (f7) {
				...
				var v7: map<T2, set<char>> := map[v4[f8] := v6];
				v7 := v7;
				var v8: map<bool, bool> := map[f7 := v3.f5];
				var v9: map<int, bool> := map[-f8 := v3.f5];
				var v10: multiset<int> := multiset{f8, |(seq(0x1d0, i0  => (v5)))|};
				var v11 := DC10(f7, v10);
			...
			if (v31[f8 / v30]) {
				f4[395] := fm2(v30, f8, f7, f7, globalState);
				f4[395] := 0x250;
				globalState.f0 := false;
				var v32: map<int, bool> := map[f8 := f5];
				var v33: seq<map<bool, int>> := [v28, v28, v28, (map[f5 := |v0|])[f7 := v30], map[f5 := f4[395]]];
				v32 := v32[|v33| := true];
				...
				f4[907] := f8;
				f4[907] := f8;
				var v44: array<int> := new int[9] [v30, f4[907], 0x281, 0x173, v30, |(seq(0x167, i1  => ('b')))|, -f4[907], f4[907], f4[907]];
				var v45: seq<array<int>> := [v44];
				var v46: set<array<int>> := {v45[|v0|]};
				...
				var v49 := new C13(v30, v44, v31 != v31, f6, f4[907] >= f4[907]);
				v30 := v49.f9;
			}
			...
			var v53 := DC36(f8, f8 % |v50|, |[v51, v51, v51]| != |(seq(0x172, i2  => ({f7})))|, set v52 : int | (455 <= v52) && (v52 < -0x349) :: (v52 - |v50|), f7);
			var v55: set<int> := {f8};
			...
			f4[392] := --255 - v57;
			f4[392] := -970 % -|v50|;
			var v58: seq<int> := [DC27(-f4[392], f5, 0x32a).cf41, v57];
			var v59: multiset<bool> := multiset{f5};
			var v60: array<int> := new int[28];
			var v61: C14 := new C14(v60, !f5);
			var v62: array<int> := new int[23] [f4[392], v57, |v58|, f8, f8, f8, fm2(v57, v57, f7, f5, globalState), f8, v57, v57, f4[392], f8, -v57, f4[392], f4[392], 727, f8, 0x25a, -|(seq(-0x29e, i3  => (f4[392])))|, v57, |v59|, |multiset{v61}|, v57];
			...
			var v66 := DC54(v56.fm22(!false, f5, globalState), v57, v65, -f8, v58[0x1f5]);
			var v67: seq<bool> := [f7, f7, f5];
			var v68: set<set<int>> := {v55, {v57, f8} + v55, fm83(f8, v66, globalState), if (v67[f4[392]]) then v55 else v55};
			f4[392], v63, v63, f4[392], globalState.f0 := -(f4[392] % |v55|), v63, v63, |v68|, v67[0x16b];
		}
		
		var v69: seq<int> := [f8, f8];
		var v70: seq<int> := [|v69[f8 := f8]|];
		var v71: seq<bool> := [f7];
	...
	method m2(p0: array<set<T0>>, p1: array<int>, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		f6[536] := f7;
		f6[536] := f7;
		var v4: map<D0, int> := map[DC0(seq(872, i2  => ('d'))) := f8];
		var v5 := 'o';
		var v6: set<string> := {v2, v2, fm4(fm7(v4, v2, f8, globalState), fm3(v2, globalState), globalState), v2[f8 := v5]};
		r0 := |v6| + f8;
		var i3 := 0;
		while (f6[536])
			decreases 100 - i3
		{
			...
			if (v8 <= v8) {
				...
				var v10: T3 := new C8(if (f5) then v9 else v9, v9, f6[536], p1, f7);
				...
				var v16: map<array<array<bool>>, string> := map[if (v8[f8] in v15) then v15[v8[f8]] else v14 := v2];
				var v17: array<string> := new string[6] [v2, v2, v2, v2, v2 + v2, if (v14 in v16) then v16[v14] else v2];
				v17[797] := v2;
				var v18: seq<string> := ["wqkibiv", v2, v2];
				var v19: multiset<bool> := multiset{v8[v11.f27], f5, f7, f7};
				v17[797], v11.f27, v11.f27 := v2 + v18[if (v8[v7[v11.f27]] in v19) then v19[v8[v7[v11.f27]]] else f8], v11.f27, f8;
			} else {
				var v20: array<T3> := new T3[19];
				var v21: array<bool> := new bool[6](i4 => f6[536]);
				var v22: seq<array<bool>> := [v21];
				var v23: map<int, char> := map[f8 := v5];
				var v24: map<map<int, char>, int> := map[v23 := f8];
				var v25: T3 := new C8(v22[if (v23 in v24) then v24[v23] else f8], v21, f6[536], f4, f7);
				v20[914] := v25;
				var v26 := DC5(f8, v21, f6[536], f8, f6[536] in v8);
				r0, v5, v2, v20[914], v26 := -0x329, v5, (seq(0x2b1, i5  => (v5))) + (v2 + v2), v25, DC5(f8, v21, f6[536], |"ihmsbjegd"| * -696, f5);
				...
				v30 := v30[f6[536] := if (v25.f7) then v8 else v8];
				f6[536] := v8[0x107 / f8];
			}
		...
		var v35 := DC20(v34);
		r0 := match v35 {
			case DC21(cf29, cf30) => |({cf30} - (set v36 : int | v36 in {f8, cf30, |map[f6[536] := cf30]|, cf30, cf30} :: (v36 + |{-78}|)))|
			case DC22(cf31, cf32) => |multiset{cf31, cf31, cf31}|
			case DC20(cf28) => DC27(f8, f6[536], f8).cf41
		};
		var v37: set<bool> := {f7};
		r1 := v37 <= (v37 + v37);
	}
	method m3(p0: multiset<set<D0>>, globalState: GlobalState) {
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v18: map<bool, string> := map[f5 := seq(-0xd9, i2  => (v16))];
			var v19: map<array<bool>, bool> := map[v17[989] := fm3(if (f7 in v18) then v18[f7] else v0, globalState)];
			var v20 := DC30(f4, v16, v19, v0);
			v20 := v20;
			if (f5) {
				globalState.f0 := f5;
				var v21 := -0x97;
				v0, v0, v17[989], v21 := v0, v0 + v0, v17[989], -f8;
				v0 := v0;
				...
				var v28: array<seq<int>> := new seq<int>[29] [v24, [f8], v24, [f8], v24, fm30(globalState), v24, v24, v24, v24, v24, v24, v24, v24, if (-f8 in v26) then v26[-f8] else v24, v24, [f8], v24, v24, v24, seq(0xab, i4  => (v21)), [v21, v21], v24, seq(0x191, i5  => (|[map v27 : int | (0x1ca <= v27) && (v27 < -815) :: (v27 / v21) := (true), map[f8 := f5]]|)), v24[f8 := v21], v24, v24, v24, v24];
				var v29: array<array<seq<int>>> := new array<seq<int>>[4] [v28, if (f5) then v28 else v28, v28, v28];
				v29[854] := v28;
				globalState.f0, v29[854] := f7 ==> f5, v28;
			} else {
				var v30: multiset<int> := multiset{f8, -529};
				var v31: seq<int> := [f8, f8, -0x91];
				var v32 := DC83(f8, f5);
				var v33: array<seq<int>> := new seq<int>[18] [v31, v31, v31, (fm128(f8, f7, f5, globalState)).cf110, v31, seq(0x379, i6  => (f8)), v31, v31, v31[f8 := v32.cf131], seq(0x33, i7  => (f8)), v31, v31 + v31, v31 + v31, [f8], v31, v31, v31, v31];
				v33[823] := (seq(-0x249, i8  => (849))) + [f8, fm2(f8, f8, f5, f7, globalState), f8];
				var v34: seq<seq<int>> := [v31];
				var v35: set<bool> := {f5};
				v30, v33[823] := v30, (v31 + v31) + (v34[f8] + [|v35|, f8, f8, 0x33c]);
				var v36: T3 := new C4(f7, f5, v17[989], false, f4, f7);
				var v37 := DC93();
				...
				v40[261], v36.f6[297], v44 := v41, v36.f7, v44;
				v0 := v0;
				v0 := "jdwd";
			}
			...
			v17[989], f6[74], globalState.f0 := v49[f8 % f8], f5, false;
			...
			if (v51 > v52.cf154) {
				...
				var v56: seq<bool> := [f7, f7, 746 < |v55[v53]|];
				v56 := v56;
				var v57: set<int> := {f8 - v53};
				v57 := v57 * (set v58 : int | v58 in v1 :: (v58 + |"ltoii"|));
				var v59: set<string> := {v0};
				var v60 := DC96(v59, "akmlvma", v46, map[f7 := f8]);
				var v61 := DC54(f8, v53, multiset(seq(0x226, i10  => (v16))), |v60.cf152|, v53);
				v53 := -v61.cf85;
				var v62: map<int, char> := map[v53 := v16];
				var v63: map<multiset<char>, bool> := map[multiset{v16, v16, if (f8 in v62) then v62[f8] else 'x'} := f6[74]];
				var v64: multiset<char> := multiset{'i'};
				var v65: multiset<int> := multiset{|v64|};
				var v66: array<int> := new int[19] [0x34d, v53, fm2(|v63|, 206, f7, f6[74], globalState), fm2(f8, |v50[f5 := |v45|]|, f6[74], f7, globalState), v53, -v53, v53, fm2(v53, f8, f7, !fm6(false, v48, globalState), globalState), f8, v53, v53, f8, |v47|, f8, v53, if (f7) then -0x1fc else v53, fm2(fm2(v53, f8, f6[74], f7, globalState), |v65|, f7, f7, globalState), v53, -v53];
				v66 := v66;
			} else {
				var v67 := 0x389;
				var v69: set<char> := {v16};
				v67 := v67 / |map[map v68 : char | v68 in v69 :: (v68) := (|v0|) := f8]|;
				v67 := 0x52 / (f8 % v67);
				var v70 := DC77();
				var v71 := DC78(v70);
				var v72: C0 := new C0(|fm70(f7, -v67, globalState)|);
				var v73: set<C0> := {v72};
				var v74: T2 := new C13(v67, v20.cf44, v67 != fm2(|v73|, -0x10c, false, f6[74], globalState), v17[989], f5);
				var v75: map<map<bool, string>, string> := map[v18[f5 := v0] := "bkuwpbm"];
				globalState.f0, v71, v0, v74, v16 := v72.f19 == v67, if (!f6[74]) then v71 else v71, if ((v18 + v18) in v75) then v75[v18 + v18] else v0, v74, v16;
				v67 := v72.f19;
				var v76 := new C11(f7 <==> v74.fm3(v0, globalState), v17[989], true, f4, fm6(f5, v48, globalState));
			}
			
		}
		var v77: map<bool, int> := map[f5 := |v0|];
		var v78: seq<int> := [|v77|];
		v78 := v78 + v78[f8 := fm2(f8, f8, !f5, f5, globalState)];
	...
	method m1(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int) {
		...
		for i0 := -p2 to |v1| {
			...
			var v4 := DC8(v3);
			var v5 := 'e';
			var v6 := DC33(DC31(seq(712, i1  => ([f5]))));
			...
			if (v8 >= (set v9 : char | v9 in [v5] :: (v9))) {
				...
				var v15: array<array<bool>> := new array<bool>[8] [v12[fm2(f8, f8, p1, f5, globalState)], f6, f6, f6, f6, if (v13 in v14) then v14[v13] else f6, f6, f6];
		...
		f4[73] := -fm7(map[v23 := f8], v1, |(if (f8 in v25) then v25[f8] else v24[f7 := f8])|, globalState);
		if (f7) {
			var v26: set<bool> := {f5};
			...
			var v31: array<int> := new int[25] [f4[73], f8, f4[73], |v26|, 0x15e, f4[73], f4[73], |(seq(503, i2  => ('s')))|, f8, p2, f8, f8, f8, -114, |v29[v28 := f4[73]]|, |(seq(57, i3  => (f4[73])))|, p2, f4[73], |v30|, p2, f4[73], p2, |v1|, |v24|, p2];
			...
			match (fm129([true, p1, p0], fm7(v33, v1, f8, globalState), globalState)) {
				case DC88(cf139) =>
					...
					var v35: array<string> := new seq<char>[11](i4 => seq(548, i5  => ('c')));
					v34[956] := v35;
					v34[956] := v35;
					var v36: array<array<bool>> := new array<bool>[15];
					v36[747] := f6;
					v36[747] := new bool[23](i6 => !!(if (cf139) then f7 else cf139));
					var v37 := 'v';
				...
				case DC89(cf140) =>
					...
					var v46 := DC66(p1, f4[73], |v45|, f5);
					f4[73], globalState.f0, v24 := cf140, if (!!f5) then v46.cf116 else p2 > cf140, v24 - v24;
					v45 := v45;
				case DC87(cf138) =>
					...
					v49[803] := v50;
					var v51 := DC42(p0);
					v47, v48, v49[803], v51 := v47, v48, v50, v51;
					r0 := -f4[73];
			...
			var v60 := new C1(if (f5) then f5 else p1, v59[|v0| := |v1|]);
			var v62: set<int> := {p2};
			if (f7 <== ((set v61 : int | (0x16f <= v61) && (v61 < -0x11e) :: (v61 * f8)) == v62)) {
				...
				var v66 := DC97(v65);
				v63[875] := v66;
				var v67: seq<map<bool, int>> := [v64, map[p1 := -f4[73]]];
				v63[875] := v66.(cf154 := if (f5) then multiset(v67) else v65);
				f4[73] := f8;
				...
				v73 := v73[fm130(p0, f4[73], if (f7 in v24) then v24[f7] else f4[73], globalState) := 910];
			...
			if (p1) {
				...
				v79 := (DC24(|v0|, f4[73], f5, v79).(cf36 := p0, cf35 := f4[73])).cf37;
				var v80: set<int> := {f4[73]};
				var v81: map<D0, int> := map[v23 := |v1|];
				var v82: seq<int> := [p2];
				var v83: array<int> := new int[17](i8 => i8 / |[f4[73], f8]|);
				var v84: set<array<int>> := {v83};
				var v85: array<int> := new int[28] [f4[73], |v80|, f4[73], f8, f4[73], f8, p2, f8, f4[73], f4[73], p2, f8, fm7(v81, v1, f4[73], globalState), p2, |v82|, f4[73], |v84|, f4[73], f4[73], f4[73], 0x1ec, p2, -0x287, f4[73], 0x37a, p2, f4[73], f8];
				var v86: map<int, int> := map[-|"a"| := f4[73]];
				var v87: map<int, int> := map[|v86| := p2];
				var v88: C8 := new C8(f6, v79, f7, v83, v0[if (p2 in v86) then v86[p2] else f4[73]]);
				var v89: set<C8> := {v88};
				var v90 := new C0(|v89|);
				var v91: array<T1> := new T1[2];
				var v92: T1 := new C11(f5, v79, p1, v83, f7);
				v91[351] := v92;
				v91[351], f4[73] := v92, 0x155;
				r0 := -f8;
				...
				f4[73], globalState.f0, v93 := if (v96 in v97) then v97[v96] else 0x85, v95.f18 !! multiset{|v1|}, v93;
			} else {
				f6[695] := p0;
				var v98: map<bool, int> := map[p0 := p2];
				var v99: seq<int> := [f8];
				var v100: multiset<int> := multiset{f4[73]};
				var v101 := 'f';
				var v102: map<multiset<int>, char> := map[v100 := v101];
				r0, f6[695], r0 := fm7(fm131(if (!!p1 in v98) then v98[!!p1] else p2, f8, false, globalState), "adds", f8, globalState), fm10(v99[f4[73]], v0, globalState), |v100| + |v102[v100 := v101]|;
				var v103: map<int, bool> := map[if (f8 in v100) then v100[f8] else f8 := p1];
				v103 := v103[p2 := false];
				var v104: set<char> := {v101};
				f4[73] := if (f7) then f4[73] else |v104| * f4[73];
				r0 := -f8;
				...
				var v110: map<char, int> := map[v101 := if (p0) then f4[73] else |map[v106 := v109]|];
				v110 := v110[v105.f26 := |v0|];
			}
			
			var v111: array<seq<int>> := new seq<int>[28];
			v111[985] := seq(-53, i9  => (p2));
			var v112: seq<int> := [fm2(f4[73], f8, p0, p0, globalState), -f4[73], fm2(f8, f4[73], p0, p0, globalState)];
			v111[985] := v112 + v112;
		}
		
		var v113 := DC27(0x1cf, true, f4[73]);
		var v114: map<D9, int> := map[fm104(v113.(cf41 := f8), f8, 0x49, p2, globalState) := p2];
		var v115: seq<map<D9, int>> := [v114, map[v113 := f4[73]]];
		var v116: seq<seq<map<D9, int>>> := [v115];
		for i10 := 913 to |v116[f4[73]]| {
			if (v0[fm2(i10, p2, p1, p0, globalState)]) {
				var v117: array<string> := new string[7];
				var v118 := DC46(v117);
				var v119: map<D16, int> := map[v118 := f8];
				v119 := v119[v118 := i10];
				var v120: C0 := new C0(-f4[73]);
				var v121: map<C0, bool> := map[v120 := !f7];
				var v122: map<set<bool>, int> := map[fm1(634, --f8, globalState) := |v121| - f4[73]];
				var v123: set<bool> := {p1, f7};
				v122 := v122[v123 := f8];
				var v124: map<int, int> := map[f4[73] := v120.f19 * v120.f19];
				var v126: multiset<int> := multiset{v120.f19, p2, f4[73]};
				...
				var v131: map<seq<C1>, multiset<bool>> := map[v130 := v24[f7 := i10]];
				var v132 := DC49(v24);
				var v133: map<bool, int> := map[p0 := f4[73]];
				var v134: array<multiset<bool>> := new multiset<bool>[28] [if (f7) then if ([v129] in v131) then v131[[v129]] else v24 else v132.cf74, v132.cf74, fm81(v129.f17, p1, |v133|, seq(0x262, i11  => ('f')), globalState), v24, v24, v24 + v24, v24 * v24, v24, v24, v24, v24 + (v24[p0 := i10])[f7 := fm2(|"mo"|, |v0|, f5, p0, globalState)], v24, v24, multiset{v129.f17} - (if (-0x2c7 in v25) then v25[-0x2c7] else multiset{f5}), multiset(v0[i10 := f7] + [p0, f7, f5, f5]), v24 - v24, v24, v24, v24, v24, v24, multiset{p1} * multiset(v0), v24 - v24, v24, v24, multiset(v0 + v0), v24, v24];
				v134 := v134;
				var v135: set<bool> := {v129.f17};
				var v136: set<int> := {0xe8 % p2, |(v135 + v135)|};
				v136 := v136;
				f6[985] := false;
				var v137 := 'k';
				globalState.f0, v129.f17, f6[985] := !((f8 % p2) == |multiset{v137, v137, v137}|), v0[p2], !f7;
				var v138: seq<int> := [p2];
				var v139: array<int> := new int[7] [i10, f8, p2, 0x6e, i10, p2, p2];
				var v140: set<string> := {v1};
				var v141: T0 := new C9((v138 + v138)[653 := f8], if (p0) then p0 else f5, v139, v140 !! v140);
				v141 := v141;
				var v142: array<char> := new char[27];
				v142[465] := v137;
				v142[465] := if (v129.f17) then v137 else v137;
			}
			...
			var v151: set<int> := {f4[73], f8};
			var v152: set<bool> := {f5, true};
			var v153: map<int, bool> := map[i10 := f7];
			var v154 := DC36(i10, |v145|, f7, v151, p1);
			var v155: seq<set<int>> := [v151, v151, v151, {f4[73]}, v154.cf59];
			var v156: array<int> := new int[22] [f4[73], |[|multiset{f5}|]|, p2, f4[73], |v151|, |v152|, f4[73], |v153|, -f8, f4[73], |"tf"|, |v155[i10]|, i10, p2, i10, p2, |[p2, f8]|, |map[f5 := f8]|, |v151|, p2, i10, f8];
			var v157: C8 := new C8(f6, f6, f7, v156, p1);
			var v158: array<map<int, int>> := new map<int, int>[26] [map v144 : int | v144 in v145[p2 := f8] :: (v144 / p2) := (|v145|), map v146 : int | (0x3a4 <= v146) && (v146 < 382) :: (v146 / i10) := (f8), v147, v147, v147, v147, map v148 : int | (0x16b <= v148) && (v148 < 174) :: (v148 + |map[DC27(f4[73], f5, i10).cf40 := |"ipsuwtop"|]|) := (i10), map[f8 := f4[73]], v147, v147, v147, v147, v147 + map[p2 := |v1|], v147, v147[|v149| := 819], v147, v147, v147 + v147, v147, v147, v147, (map v150 : int | (0x2b3 <= v150) && (v150 < 722) :: (v150 % |multiset{f4[73]}|) := (|v147|)) + v147, v147, map[p2 := |v145|], v147, v147[|[v157]| := f8] + v147];
			v158 := v158;
			var v159 := 'f';
			r0 := (if (f7 in v149) then v149[f7] else p2) % |(if (f5) then v1 else [v159, v159, fm36(p0, globalState), v159, v159])|;
		}
		var v160: map<bool, int> := map[f7 := |{f8}|];
		var v161: seq<int> := [p2];
		var v162: set<int> := {744, f8, f4[73]};
		var v163: map<bool, bool> := map[f5 := f7];
		var v164 := DC24(-0x27d, |v1|, f7, f6);
		var v165: map<int, bool> := map[f8 := v164.cf36];
		var v166: map<int, string> := map[f8 := seq(358, i14  => ('n'))];
		var v167: seq<map<int, bool>> := [v165, map[v161[|(if (f4[73] in v166) then v166[f4[73]] else seq(777, i15  => ('e')))|] := p1]];
		var v168: array<int> := new int[28] [f8, p2, f8, |v160|, f8, f8, p2, p2, |v24|, f8, -f8, f8, v161[if (f7 in v24) then v24[f7] else f8], f8, f4[73], |(seq(-0x30d, i13  => ('b')))|, f8, |v162|, 0x31c, |[false]|, |v163|, p2, f4[73], f4[73], |v167[f8]|, f4[73], p2, p2];
		var v169 := new C9(seq(0x247, i12  => (f4[73])), p1, v168, p1);
		var v170 := DC93();
	...
	method m5(p0: seq<array<T0>>, p1: set<D1>, globalState: GlobalState) returns (r0: int) {
		for i0 := f8 to -f8 {
			if (!f5 <== f7) {
				...
				v1 := v1 + v1;
				var v2: array<int> := new int[5](i1 => i1 % i0);
				v2 := v2;
				...
				var v22 := "uesg";
				var v23: seq<T2> := [v20];
				globalState.f0 := v16 !! v17[v18[|(if ([|v22|] in v21) then v21[[|v22|]] else v23)|]];
				var v24 := 'n';
				v24 := v24;
				r0 := i0 / i0;
				v20.f4[559] := f8 - i0;
				v16, v20, v20.f4[559] := v16 + v16, v20, i0;
			}
			...
			var v37 := DC66(true, |[|v31|, v32[|v36|]]|, f8, f7);
			...
			decreases 100 - i2
		{
			...
			var v45 := "jt";
			var v46 := 'f';
			var v47: seq<string> := [v45[f8 := v46], v45];
			var v48 := DC3((if (f8 in v44) then v44[f8] else fm20(globalState))[|v47| := f5]);
	...
	method m6(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: bool, r1: int) {
		...
		var v13: seq<seq<bool>> := [v12, v12[p0 := v6.f22]];
		var v14 := DC3(v13[f8]);
		...
		if (f7) {
			...
			var v18 := 'y';
			var v19: map<bool, string> := map[p1 := ("cymort")[p2 := v18]];
			...
			var v24 := DC82();
			f6[153] := if (true) then f5 else v6.f22;
			globalState.f0, v24, v16, f6[153], v16 := v6.f22, v24, v16, f7, p2 * p2;
		} else {
			v16 := v16;
			var v25 := 'a';
			var v26: set<int> := {v16};
			...
			v2.f4[638], r0, v30 := v16, v6.f22, v30;
		}
		...
		match (v32) {
			case DC96(cf150, cf151, cf152, cf153) =>
				...
				if (v35.cf29) {
					...
					var v48: map<bool, seq<char>> := map[false := seq(0x2b, i0  => (v41))];
					...
					f4[318] := fm2(f8, |multiset{|(if (v16 in v49) then v49[v16] else v4[|v50| := v41])|}|, v6.f22, f7, globalState);
					f4[318] := v16;
					cf151 := (cf151 + "xejtycbex") + cf151;
					r0 := if ({|multiset{p1}|, p2} == fm31(f6[450], globalState)) then v0 >= v0 else v6.f22;
				} else {
					var v51: C14 := new C14(v2.f4, 'r' in v4);
					v51, v33, r0, r1, globalState.f0 := v51, v33, f7 && ((seq(703, i1  => ('y'))) <= v4), f8 / f8, !v2.f5;
					v4 := v4;
					globalState.f0 := v6.f22 <==> v12[v16];
					...
					v55[619] := v34.cf37;
					v55[619] := if (p1) then f6 else f6;
				}
				
				globalState.f0 := v6.fm3("raa", globalState);
				var v56 := 'o';
				var v57: array<string> := new string[11] [v4, cf151 + cf151, ("pmh")[p2 := v56], v4, cf151, if (v2.f5) then cf151 else v4, "gx", cf151, seq(0xfe, i2  => (v56)), v4, v4 + "t"];
				v57[621] := (seq(0x71, i3  => (v56)))[p2 := v56];
				var v58: multiset<int> := multiset{v16};
				var v59: C8 := new C8(f6, v33, v2.f5, f4, true);
				var v60: set<C8> := {v59};
				v57[621], v58, r1, v60 := v4, fm65(f8, v6.f22, globalState) + v58, f8 / |(if (v2.f5) then v1 else v1)|, (if (v2.f5) then v60 else v60) + v60;
			case DC95(cf149) =>
				r0 := false;
				...
				var v72: array<string> := new string[26] [v4, "ngupjp", seq(0x35e, i4  => ('q')), "fuj", (v4 + v4)[p2 := v65], v4, v4 + v4, v4, v4, v4, v4, v4, fm0(true, globalState), seq(0x363, i5  => (v65)), if (v66 in v67) then v67[v66] else v4, v4, v4, if (!v2.f5) then v4 else v4, v6.fm4(|v71|, !v66.f12, globalState), v4, v4, v4, (fm133(globalState)).cf151, "tjc", v4, v4 + v4];
				v72 := new string[7];
		}
		...
		var v75 := DC28(v74[p2]);
		var v76 := 's';
		v75, r1, globalState.f0 := v75.(cf42 := v73), 0x376, v76 !in (seq(0x353, i6  => (v76)));
...
method Main() {
	...
	var v5 := 0x114;
	var v6: seq<int> := [v5];
	var v7: seq<int> := [v5, v6[|v6|]];
	var v8: seq<seq<int>> := [v7];
	v4[811] := v8;
	var v9: seq<bool> := [v5 <= v5];
	var v10 := "o";
	var v11: map<bool, string> := map[v0 := v10];
	v2, v3[351], v4[811], globalState.f0, v0 := v2, v9[|(if (v0 in v11) then v11[v0] else seq(0x35b, i1  => (v2)))|], [v6, v6] + v8, v0, 0x376 <= v5;
	var v12: seq<string> := ["xkhuocpak"];
	v12 := seq(0x18a, i2  => (v10));
	v2 := v2;
	var v13: map<bool, int> := map[!v0 := -|v1|];
	v13 := v13 + v13;
	var v14 := DC0(v10);
	var v15: array<string> := new string[26] [v10, v10, "ti", v14.cf0, "jvis", "bqncp", "eba", v10, v10 + v10, v10 + v10, if (v0) then v10 else fm0(v3[351], globalState), v10, v10[v5 := v2], v10, fm0(v0, globalState) + v10, v10, seq(71, i3  => (v2)), v10 + v10[v5 := 'x'], v10, v10, v10[v5 := v2], v10, "pdode", "ifhsjttu", v10, v10];
	v15[164] := v10;
	v15[164] := v10 + fm0(v3[351], globalState);
	var v16: array<int> := new int[16];
	v16 := new int[11](i4 => i4 * v5);
	var v17: array<multiset<int>> := new multiset<int>[6];
	v17, v5 := v17, |v9| / (v5 + |map[|v1| := v5]|);
	if (v0) {
		if (false) {
			v14 := DC0("hnq").(cf0 := v15[164]);
			var v18: seq<seq<bool>> := [v9];
			var v19: map<char, int> := map[v2 := v5];
			var v20 := m0(v18, 0x144 + |v15[164]|, v19, v0, globalState);
			var v21 := m0(v18[0xa := v9], v5, v19 + map[v2 := v5], !v3[351], globalState);
			var v22: set<int> := {|v10|};
			var v23: set<int> := {v5, |v22|, 0x348};
			v3[351] := !(v22 !! v23);
			var v24: map<int, int> := map[v5 := |v13|];
			var v25 := DC1(v2, v5, {v5, v5, v5, fm2(|v24|, v5, true, v3[351], globalState), v5}, seq(0x21c, i5  => (v2)));
			...
			var v29 := new C4(v3[351], v3[351], v3, !(0x211 == v5), v28, v0);
			v3[351], globalState.f0 := false, v29.f25;
			v16[170] := 0x161;
			var v30: array<C0> := new C0[19];
			var v31: C0 := new C0(v16[170]);
			v30[158] := if (!v3[351]) then v31 else v31;
			var v32 := DC102(v31);
			v29.f24, v16[170], v30[158], v16[170] := v29.f24, v5, v32.cf161, v16[170];
		}
		
		v9 := v9;
		v15[164] := v15[164];
		var v33: multiset<int> := multiset{v5};
		var v34: map<multiset<int>, bool> := map[v33 := !v3[351]];
		v34 := v34[v33 - v33 := if (v0) then !v3[351] else v0];
		...
		var v40: T3 := new C15(|v38|, v3, if (v2 in v39) then v39[v2] else v0, v16, v37.fm3(v15[164], globalState));
		var v41: seq<set<T3>> := [{v40, v40}];
		var v42: map<string, set<T3>> := map[seq(-465, i7  => ('l')) := v41[v5]];
		var v43: set<T3> := {v40};
		var v44: array<set<T3>> := new set<T3>[11] [if (v15[164] in v42) then v42[v15[164]] else v43, v43, v41[v5], v43, {v40} - {v40}, v43, v43, v43 - v43, v43 + v43, if (v9[v5]) then v43 else {v40, v40}, v43];
		v5, v6, v35[906], v44 := (v5 + v5) + v5, if (v40.f7) then seq(0x375, i8  => (|v15[164]|)) else if (v40.f7) then v7 else v7, v36, v44;
		...
		var v49: map<int, bool> := map[|v48| := v3[351]];
		v40.f4[708], v46 := |v49| % v46.f19, v46;
	...
	v53[232] := map[true := v54];
	var v55: map<bool, array<char>> := map[true := v54];
	v53[232] := v55;
	var v56: map<int, bool> := map[v5 := v3[351]];
	var v57: multiset<int> := multiset{|[v3[351], if (v5 in v56) then v56[v5] else v0]|};
	var v58: seq<seq<bool>> := [v9];
	var v59: map<char, int> := map[v2 := v5];
	var v60 := m0(if (v0) then fm49(|v57|, globalState) else v58, v5, v59, !v3[351], globalState);
	var v61: C6 := new C6(v3, v0, v16, v3[351]);
	var v62: map<C6, bool> := map[v61 := v0];
	var v63: map<map<C6, bool>, bool> := map[v62 := v3[351]];
	var v64 := DC21(!v3[351], |v63|);
	var v65 := m0(v58, v5, v59, v64.cf29, globalState);
	var v66 := DC58(v12);
	v66 := v66;
	var i10 := 0;
	while (|v15[164]| <= (if (true) then |v10| else 552))
		decreases 100 - i10
	{
		if (i10 >= 100) {
			break;
		...
		i10 := i10 + 1;
		var v67: C11 := new C11(!false, v65, v3[351], v16, v3[351]);
		var v68: multiset<C11> := multiset{v67};
		globalState.f0 := multiset{v67} <= v68;
		var v69: set<string> := {v15[164]};
		var v70: map<bool, bool> := map[false := v67.f12];
		var v71 := DC96(v69, v15[164], v70, v13);
		v10 := v71.cf151;
		...
		match (v74) {
			...
			case DC40(cf66) =>
				...
				var v83: map<T1, string> := map[v82 := v15[164]];
				v5 := v5 * |(if (v82 in v83) then v83[v82] else v15[164])|;
				var v84 := DC64(v0, v6[v5 := |v9|], v5);
				v3[351], v84 := v0, v84;
				var v85: C4 := new C4(v0, v67.f12, v60, v67.f12, v16, v5 <= v5);
				v85, v9, v10 := v85, v9, if (v3[351]) then v10 else v15[164] + v15[164];
		}
		
		if (v67.fm3(if (!v3[351]) then v10 else v10, globalState)) {
			var v86: set<int> := {|v10|};
			var v87: map<char, set<int>> := map[v2 := v86];
			v87 := v87['s' := v86];
			v11 := fm124(globalState);
			v61.m4(globalState);
			globalState.f0 := v67.fm3(v15[164] + v10, globalState);
			var v88: array<T0> := new T0[8];
			var v89: map<array<T0>, string> := map[v88 := seq(0x2c3, i11  => (v2))];
			var v90: multiset<map<array<T0>, string>> := multiset{v89 + v89, v89};
			v5 := if (map[v88 := v10] in v90) then v90[map[v88 := v10]] else v5;
		} else {
			var v91 := new C13(v5 % v5, v16, !v3[351], v60, v5 < v5);
			var v92 := DC6(v67.f12);
			var v93 := m0(v58 + v58, v5, (map[v61.fm68("qkciyu", v92, v67.f12, v0, globalState) := v91.f9])['u' := v5] + v59[v2 := v91.f9], v3[351] !in [v67.f12], globalState);
			v5 := |v6| * v91.f9;
			var v94: multiset<bool> := multiset{!v67.f12, v67.f12};
			v5 := -(v5 * (|v94| + v5));
			v16[303] := fm2(v91.f9, v5, v67.f12, !fm10(v5, v9, globalState), globalState);
			v16[303] := -v91.f9;
		}
		
	}
	var v95: set<C6> := {v61, v61, v61};
	v5, v9, v0, v95 := fm2(382, v5, v0, v0, globalState) * (v5 - v5), v9 + (v9 + v9), v3[351], v95;
	if (if (!v0) then !!v3[351] else v3[351]) {
		globalState.f0 := true;
		var v96: map<int, char> := map[v5 := v2];
		if (!(if (v3[351]) then |v96| == v5 else v3[351])) {
			globalState.f0 := true;
			var v97: map<int, int> := map[v5 := v5];
			v3[351] := v7[|v7|] < (-|v97| + 439);
			var v98 := DC51(v0, v0, v5);
			globalState.f0 := v98.cf77;
			v3[351] := v57 != (if (true) then v57 else v57);
			v5 := -v5;
		} else {
			...
			var v102: multiset<bool> := multiset{v0, v3[351]};
			var v103: map<seq<int>, int> := map[v7 := |v102[!v3[351] := v5]|];
		...
		if (v0) {
			...
			var v109 := DC36(v5, -0x329, v3[351], v108, v0);
			v5 := v109.cf57;
			v3[351] := (|v15[164]| >= v5) <== v0;
			var v110: C4 := new C4(v3[351], v3[351], v65, v3[351], v16, v5 >= v5);
			v110 := if (true) then v110 else v110;
			globalState.f0 := v110.f24;
			v5 := v5;
		}
		
		var v111: multiset<bool> := multiset{v0, v3[351]};
		var v112: map<int, set<multiset<bool>>> := map[v5 := {v111}];
		var v113: set<int> := {v5};
		var v114: set<multiset<bool>> := {v111, multiset(v9)};
		var v115: map<char, bool> := map[v2 := v3[351]];
		var v117: multiset<bool> := multiset{v3[351], (if (|v113| in v112) then v112[|v113|] else {v111}) >= v114, (set v116 : char | v116 in v115 :: (v116)) !! {'u'}, false};
		v5 := if (v0 in v111) then v111[v0] else v5;
		var v118: map<bool, set<int>> := map[!v3[351] := v113];
		var v119: array<D28> := new D28[18];
		var v120: map<map<bool, set<int>>, array<D28>> := map[v118 := v119];
		var v121: seq<map<bool, set<int>>> := [v118];
		var v122: map<int, map<bool, set<int>>> := map[312 := v121[0x32a]];
		v120 := v120[(if (v5 in v122) then v122[v5] else v118)[true := v113] := v119];
		var v123 := DC0(v15[164]);
		var v124 := DC2(v123);
		var v125 := DC2(v124);
