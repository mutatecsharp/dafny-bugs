...
function fm0(globalState: GlobalState): int {
	|(map[|"sppkdbw"| := ['d']] + map[-0x292 := ['y', DC66(true, false, |"tv"|, 'n').cf115, 'y']])| / |("av" + "iysixoa")|
}
...
function fm4(p0: int, globalState: GlobalState): map<seq<int>, bool> {
	(map[seq(0xa2, i0  => (940)) := false] + map[[0x22f, 10, 0x336, |multiset{|multiset([|map[false := |(map v0 : int | (0x15 <= v0) && (v0 < 0x2e7) :: (v0 + 0xba) := (|"d"|))|]|])|}|, 0x266] := true]) + map[seq(-0x1b, i1  => (|map[true := DC32(false).cf55]|)) := !true]
}
...
function fm14(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState): D1 {
	DC5(!false, [|multiset{-0x3a2}|] + [0x104, |map[false := |(map v0 : int | (0x203 <= v0) && (v0 < -0x140) :: (v0 * 0x11) := (|(seq(327, i0  => ('l')))|))|]|, -|[false]|], 0x56)
}
...
function fm20(p0: bool, p1: bool, globalState: GlobalState): string {
	("j" + "dftv") + ((seq(-393, i0  => ('w'))) + "dxmd")
}
function fm21(p0: bool, globalState: GlobalState): seq<int> {
	[--0x3c1, -0x20d, 0x31c] + ((seq(-308, i0  => (-|(seq(0xc4, i1  => (|"fhati"|)))|))) + [0x209, |[|"ltildgwl"|]|])
}
...
function fm23(globalState: GlobalState): D1 {
	DC5(!(|(seq(0x2a1, i0  => ('x')))| != |[false]|), [0x237] + [0x2db, 0x170], |[true, true, true]|)
}
...
function fm38(p0: bool, globalState: GlobalState): seq<set<bool>> {
	[{!true}] + (seq(0x304, i0  => ({true, !true})))
}
function fm39(p0: int, p1: bool, globalState: GlobalState): D1 {
	DC5(!true, [|[true]|, |(seq(907, i0  => (map[false := |map[|[true]| := false]|])))|, DC17(true, -0x312, 'd', 'r').cf32, 0x256], 0x103)
}
function fm40(p0: bool, p1: D6, p2: int, globalState: GlobalState): D9 {
	DC25()
}
function fm41(p0: bool, globalState: GlobalState): seq<seq<bool>> {
	[[!false], [!true]] + ((seq(-0x3c7, i0  => ([false, false]))) + (seq(0x1f6, i1  => ([false, true, true, false]))))
}
...
function fm59(globalState: GlobalState): seq<D15> {
	[DC44(DC44(DC44(DC43(|(seq(0x104, i0  => (-0x211)))|)))), DC44(DC44(DC42(multiset{true, false, !false}))), DC44(DC43(|[686, DC9(|map[0x73 := false]|, -0x1aa, seq(0x67, i1  => ('h')), false, map[DC0(|map['r' := false]|) := |(seq(0x2e3, i2  => ('i')))|]).cf17]|)), DC44(DC42(multiset{true})), DC44(DC44(DC43(|multiset([|{true}|])|)))]
}
...
function fm61(p0: int, p1: bool, globalState: GlobalState): multiset<seq<int>> {
	multiset((seq(0x380, i0  => (seq(0x33, i1  => (|map[false := false]|))))) + [seq(-0xcb, i2  => (-0x38e)), [0x215, |{|[-0x29e, 717]|}|, |map[-282 := |(set v1 : int | v1 in map[|map[|[|multiset{'k'}|, |(seq(-0x349, i3  => ('a')))|]| := |(map v0 : int | (0x13f <= v0) && (v0 < 45) :: (v0 / |(seq(0x142, i4  => ('p')))|) := (|{true}|))|]| := !!!false] :: (v1 / |[true]|))|]|, |map[false := false]|]]) * (multiset{[0x2d2, |[0x297]|]} - DC82(multiset([[0x331, 778], [|(seq(642, i5  => (|"neutv"|)))|], [0x23e, |[false]|], [|(seq(0x2a2, i6  => (|{0x5, |[true]|}|)))|, 197]])).cf141)
}
function fm62(p0: bool, p1: int, globalState: GlobalState): set<string> {
	{"ldysnsn", "tddexouk", "cm", "yicgsp"} + ({"iuli", "wobeyci"} * (set v0 : string | v0 in {seq(0x85, i0  => ('x'))} :: (v0)))
}
function fm63(p0: seq<int>, p1: bool, p2: bool, globalState: GlobalState): D17 {
	DC48(!(|[|multiset{|(seq(0x22a, i0  => ('t')))|, |{!true, !false, false}|}|]| != -0x2c1), true && !true, "wivlux" == "nw")
}
function fm64(globalState: GlobalState): D2 {
	if (false) then DC7({-133}) else DC7({|["jalxahvpr"]|, |(seq(0x7, i0  => ('l')))|, 570})
}
method m0(p0: int, p1: int, globalState: GlobalState) {
		...
		decreases 100 - i0
	{
		...
		if (v0 || (if (if (p0 in v1) then v1[p0] else v0) then v0 else v0)) {
			...
			var v11: map<int, int> := map[if (v0 in v10) then v10[v0] else v3.f14 := 274 % p0];
			v2, v8[350], v2, v9, v11 := -p0, v4, p1, v9, fm29(v3.f14 / p1, v10 != multiset{v4.f10}, globalState);
			v0 := v4.f10;
		} else {
		...
		if (v0) {
			...
			var v19: multiset<multiset<bool>> := multiset{v17, v17, v18[p1], v17};
			...
			var v28: seq<array<C6>> := [v27[p1], v26];
			v25[748] := p0 >= |v28|;
			v25[748] := true;
			var v29 := 0x330;
			v29 := p0;
			...
			var v47 := DC34(v46);
			var v48: seq<D13> := [v47];
			var v49 := DC49(|v41|, v48, -|v40|, v25[748]);
			var v50 := DC7(v43);
			var v51: array<D2> := new D2[6] [v50, v50, v50, v50, v50, DC7(v43)];
			var v52: C4 := new C4(v51, v25[748]);
			var v53: multiset<map<bool, C4>> := multiset{map[v36.f7 := v52], map[v36.f7 := v52]};
			var v55: array<int> := new int[21] [v29, -(p0 - 0x2f9), p1 + |v30|, |v34|, |v35| * v29, -p1, |v39|, |v39|, |v40|, fm0(globalState), -v29, |v30|, v49.cf82, |multiset(v40)| * |v53|, v29, --v36.fm9(v25[748], p0, v33.f16, globalState), p0, v29, p1, v29, |(v43 * (set v54 : int | (0x2e8 <= v54) && (v54 < -0x3c8) :: (v54 % 0x1c2)))|];
			v55[386] := p0;
			v29, v55[386], v25[748] := p1 + (p1 % |v41|), |v41|, v0;
		...
		v62[861] := if (v0) then v61 else v61;
		var v63 := DC50(v58);
		v58, v60, v0, v62[861], v63 := v58, v60, v0, v61, v63;
	}
	var v64 := "ed";
	...
	var v71: array<string> := new string[27] [v64, v64, "pxnpy", v64, fm28(v0, p0, globalState), v65[p1], v64, seq(0x268, i2  => ('l')), fm35(730, p0, globalState), v64, fm28(v0, -|v66|, globalState), v64 + v64, v64 + v64, v64 + v64, fm28(v0, |fm34(|v67|, v0, v0, |v70[0x36c]|, globalState)|, globalState), "hccoqdanf", v64, v64, v64, v64 + v64, "jlpfou", "wniyk" + v64, v64, "vclldfv", v64, "vimrxtn", v64];
	var v72 := DC77(v71);
	v71 := v72.cf134;
	var v73 := 0x3e7;
	...
	var v78: set<int> := {535};
	var v79 := DC7(v78);
	var v81: array<D2> := new D2[25] [v79.(cf13 := v78), v79, v79, DC7(v78), fm64(globalState).(cf13 := fm2(0x284, v0, globalState)), v79, v79, v79, v79, v79, v79, DC7({v73}), v79, v79, v79, v79, v79, DC7({v73, |(map v80 : int | (0x4b <= v80) && (v80 < 0x279) :: (v80 % p0) := (779))|}), v79, v79, v79, DC7({v73}), v79, DC7(v78), v79];
...
class C1 extends T0 {
	...
	function fm32(p0: bool, p1: set<int>, p2: int, p3: int, globalState: GlobalState): bool {
		DC9(|map[f7 := f7]|, DC5(f7, seq(-0x203, i0  => (-0x22c)), |"ywsvi"|).cf11, "nemcnlivt", f7, map[DC0(-|[|map[f7 := DC5(f7, [781, 0x297], -754)]|]|) := DC11(0x57, |multiset{f7}|, 0x222, f7).cf23]).cf19
	}
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		var v0 := DC4(f7, f7);
		...
		v4[500] := if (p1 in v5) then v5[p1] else if (v3.f12) then p0 else v3.f12;
		var i0 := 0;
		while (!true)
			decreases 100 - i0
		{
			...
			var v9: seq<seq<seq<int>>> := [v8, seq(-0x139, i1  => (v7[-0x23d := p1])), v8];
			var v10: seq<bool> := [v4[500]];
			var v11: map<seq<bool>, seq<bool>> := map[v10 := v10];
			var v12: map<int, seq<seq<int>>> := map[fm0(globalState) := (v9[p1])[|v11| := v7]];
			v12 := v12[p1 := v8];
			var v13 := -0x1b6;
			...
			v13 := if (v14 < fm33(p1, v15, globalState)) then p1 else |v17| / v13;
			v13 := -p1;
			v13 := 697 % (p1 - v13);
		}
		...
		r0 := v20 + v20;
		var v21: seq<bool> := [f7];
		var v22: set<bool> := {p2, v18.f13, v3.fm16(false, globalState), v21[p1], v3.f12};
		var v23: map<bool, set<bool>> := map[v4[500] := v22 * v22];
	...
	method m3(globalState: GlobalState) {
		match (DC24()) {
			...
			case DC25() =>
				var v8 := 319;
				var v9: map<int, bool> := map[v8 % v8 := f7];
				...
				var v21: seq<seq<bool>> := [v14[if (f7 in v18) then v18[f7] else |v20| := f7] + v14, v14];
				v8, v16, v17, v17, v8 := |v21|, fm36(!f7, f7 && f7, globalState), if ({0x3cc} !! v13) then if (false) then v17 else v17 else v17, v17[v8 := v11] + (seq(349, i0  => (v11))), |v17| % v8;
				...
				if (v19.f12) {
					...
					v19.f13 := (v19.f13 !in v23[!!v14[v8] := v8]) <== (if (v19.f13) then v19.f12 else v19.f12);
					...
					v25[105], v11, v28, v11, v29 := v15, v11, (v28 + (set v31 : set<int> | v31 in v30 :: (v31))) * {v13}, v11, v32[v8];
			...
			case DC23(cf44) =>
				...
				cf44[404] := v40;
				cf44[404] := -|multiset{v40, v40}| - v40;
				var v44: array<D0> := new D0[21];
				var v45 := DC0(cf44[404]);
				v44[643] := v45;
				v44[643], v40 := v45.(cf0 := cf44[404]), -v40 % (|"edflhdb"| + |v42|);
				var v46 := 'w';
		...
		v56[929] := [{v51.f13, f7, v51.f12}, {false, v51.f12}];
		v56[929] := fm38(v51.f12, globalState);
		var v57: seq<int> := [v54];
		if (v57[v52[138]] <= v54) {
			var v58: map<bool, int> := map[v51.f12 := 0xee];
			var v59: multiset<map<bool, int>> := multiset{v58};
			var v60: multiset<int> := multiset{v52[138]};
			var v61: seq<map<bool, int>> := [map[f7 := |v60|], map[v51.f13 := v52[138]]];
			var v62: seq<multiset<map<bool, int>>> := [multiset(v61)];
			f7 := v59 !! (v62[v52[138]] - v59);
			v52[138] := v54;
			var v63: seq<bool> := [!f7];
			f7 := v63 <= (if (f7) then v63 else v63);
			var v64 := "mwepdcn";
			var v65 := 'g';
			f7, v51.f13, v51.f13, v64, v65 := v54 <= v54, !(if (v51.f13) then v51.f13 else v51.f13), if (v51.f13) then v51.f13 else v51.f13, v64[v52[138] := v65] + v64, if (f7) then v65 else v65;
			v54 := fm0(globalState);
		} else {
			v51.f13 := v51.f12;
			...
			if (v69 in v70) {
				...
				var v74: map<int, map<int, int>> := map[v52[138] := v73];
				v74 := v74 + map[v54 := v73];
				...
				var v82: multiset<map<bool, char>> := multiset{map[DC9(|(seq(-963, i4  => (v54)))|, |v78|, v70, v51.f12, v80).cf19 := v69], v81};
				var v83 := new C0(v82 !! multiset([v81]), !v51.f12);
				var v84: set<array<int>> := {v52, v52};
				var v85 := DC2(v66.f12 || fm32(!v51.f12, v71, v54, v52[138], globalState), v52[138] % v52[138], v84, |v71|);
				v85 := v85;
				...
				var v94: set<string> := {"cr", v93[v52[138]]};
				v54, v52[138], v54, v66.f13 := -(v52[138] * (v54 * v52[138])), v52[138], v52[138] + v54, v94 !! {v70, v70, v70, v70, "ct"};
			}
			...
			if (!(v51.f12 <==> v66.fm16(v51.f13, globalState))) {
				...
				var v98: multiset<int> := multiset{|v96|, v54, |(set v97 : int | (0xa8 <= v97) && (v97 < 0x3d7) :: (v97 / v54))|, v54};
				var v99: map<bool, multiset<int>> := map[v51.f12 := v98];
				var v100 := DC0(498);
				var v101: seq<D0> := [v100];
				var v102: set<array<int>> := {v52};
				var v103 := DC2(v51.f13, v52[138], v102, v52[138]);
				var v104: array<bool> := new bool[11] [v51.f13, f7, !v51.f13, !(v98 !! (if (v66.f13 in v99) then v99[v66.f13] else v98)), !v51.f13, v51.f12, v66.f12, fm1(v101, v52[138], -0x221, globalState), if (v103.cf2) then v51.f13 else !v66.f13, f7, v51.f12];
				var v105: seq<bool> := [true];
				v104[630] := v105[v54];
				var v106: array<seq<int>> := new seq<int>[19](i6 => v57[v52[138] := v54]);
				var v107: map<int, string> := map[v52[138] := v70];
				v106[488] := (v57 + v57)[-|(if (v54 in v107) then v107[v54] else v70[v54 := v95[748]])| := fm0(globalState)];
				v52[138], v104[630], v106[488] := |v70|, v52[138] <= v54, v57 + v57;
				var v108 := DC10(v104);
				v104 := v108.cf21;
				var v109: array<seq<bool>> := new seq<bool>[2](i7 => v105);
				v109[950] := v51.fm17(|v70|, v66.f12, globalState);
				v109[950] := v66.fm17(v52[138], v51.f13, globalState);
				v54 := v54;
			} else {
				...
				v54 := (|v57| * --v52[138]) * v54;
				v52[138] := v52[138] - v54;
				m0(v52[138], v54, globalState);
			}
			
		}
		
		var v115 := DC0(v52[138]);
		var v116 := "to";
		...
		if (fm1(v117 + v117, |v121|, v52[138], globalState)) {
			var v122: seq<string> := [v116, v116];
			if ((v122 + v122) < (seq(275, i8  => (v116)))) {
				var v123: map<D0, int> := map[v115 := v54];
				var v124 := DC9(v54 * v54, v54, "v", v51.f12, v123);
				v52[138], v51.f13, v124 := v54 / -(v52[138] / v52[138]), v51.f13, v124;
				var v125: map<bool, int> := map[v51.f12 <==> v51.f12 := v52[138]];
				v54 := if (v51.f13 in v125) then v125[v51.f13] else if (v51.f13) then fm0(globalState) else v52[138];
				f7 := f7;
				var v126 := DC8(v51.f12, v116);
				v54, v126, v51.f13, v116 := v54 / |("giukdrl" + v116)|, v126, v51.f13, (v116 + v116) + (v116[v52[138] := v118] + v116);
				var v127 := DC11(v52[138], v54, v54, v51.f13);
				var v128: seq<bool> := [v127.cf25];
				var v129: multiset<int> := multiset{v54};
				var v130: seq<multiset<int>> := [v129];
				var v131: array<bool> := new bool[24] [true, v51.f12, v51.f12, v51.f13, v128[v54], v51.f12, v51.f12, v51.f13, (multiset(v57))[v52[138] := v52[138]] > v130[v52[138]], v51.f12, v51.f12, f7, (fm39(v52[138], v51.f12, globalState)).cf10 == [fm0(globalState)], v54 >= v54, v51.f12, f7, v51.f12, if (f7) then v51.f12 else v51.f12, v51.f13, v51.f12, |v116| <= v54, v51.f12, false, v129 < multiset{v54}];
				v131[783] := v51.f12;
				v131[783] := v52[138] > v54;
			} else {
				v52[138] := v52[138];
				var v132: seq<bool> := [v51.f12];
				var v133: multiset<seq<bool>> := multiset{v132};
				var v134 := DC8(false, seq(368, i9  => (v118)));
				var v135: map<string, seq<int>> := map[((fm35(|v133|, -0x27, globalState) + v134.cf15)[fm0(globalState) := 'h'])[v54 := v118] := v57];
				v135 := if (v51.f13) then v135 + v135 else v135;
				var v136 := new C0(f7, v57 < v57);
				v54 := -v52[138];
				v52[138] := if (v136.f12) then v52[138] else v52[138];
			}
			
			if (v51.f12) {
				var v137: map<bool, bool> := map[true := v51.f12];
				v137 := v137[f7 := fm1(v117, v54, v52[138], globalState)];
				var v138 := DC17(v51.f12, -v52[138], v118, v118);
				var v139 := DC18(v138);
				var v140: map<bool, D9> := map[v51.f12 := fm40(if (v52[138] in v53) then v53[v52[138]] else f7, v139, v54, globalState)];
				var v141 := DC25();
				...
				v145[29] := v116;
				v142[314] := fm2(v52[138], v51.f12, globalState) <= {v52[138], v52[138], v52[138]};
				v145[29], v142[314] := v116, v51.f13;
			} else {
				...
				v146[985] := v149;
				v146[985] := v149;
				var v150: array<seq<seq<bool>>> := new seq<seq<bool>>[25](i11 => [[v51.f13, v51.f13, v51.f13, v51.f12, true]] + (seq(92, i12  => ([v51.f12]))));
				v150[783] := fm41(v51.f13, globalState);
				var v151: seq<bool> := [v51.f12, true, v51.f13];
				var v152: seq<seq<bool>> := [v151, v151, v151[v52[138] := true], v151 + (v151[v52[138] := v51.f12])[v54 := v51.f13], v151 + v151];
				v150[783] := v152;
				var v153: array<bool> := new bool[11](i13 => true);
				v153[691] := v51.f12;
				v153[691] := f7;
				v52[138] := v57[v52[138] % v54];
				v54 := v52[138];
			}
			
			var v154: map<array<int>, int> := map[v52 := v54];
			var v155: seq<bool> := [f7];
			v154 := if (f7) then v154 else map[v52 := |v155[v54 := v51.f13]|];
			if (f7) {
				v116 := v116;
				var v156 := DC4(f7, f7);
				...
				v118 := v118;
				var v160: set<int> := {v52[138]};
				var v161: multiset<array<int>> := multiset{v52, v52, v52, v52, v52};
				v54, v160, v161 := v54, v160 - v160, v161;
				var v162 := DC5(v51.f13, seq(409, i14  => (v54)), 0x18a);
				f7, v51.f13, v52[138], v51.f13 := v52[138] >= v52[138], v51.f13, fm0(globalState), v162.cf9;
			} else {
				v51.f13 := v51.f13;
				var v163: map<C0, array<int>> := map[v51 := v52];
				var v164: multiset<array<int>> := multiset{v52, v52, if (v51 in v163) then v163[v51] else v52};
				v164 := v164;
				var v165: map<int, seq<bool>> := map[v52[138] := v51.fm17(v54, v51.f13, globalState)];
				v165 := v165[v54 := v155];
				var v166: map<bool, int> := map[v51.f12 := |map[v51.f13 := v51.f12]|];
				v166 := v166[v51.f12 := v52[138]];
				var v167: array<bool> := new bool[18] [f7, v51.f12, fm32(v51.f13, {v52[138]}, v52[138], v52[138], globalState), v51.f12, v51.f12, v51.fm16(true, globalState), f7, fm1(v117, v52[138], v54, globalState), f7, v52[138] != v52[138], v51.f12, v51.f12, !v51.f13 ==> f7, v51.f13 <==> v51.f12, v51.f13, v51.f13, !(if (f7) then v51.f12 else v51.f12), !f7];
				f7, v167 := v116 <= (seq(0x164, i15  => (v118))), v167;
			}
			...
			if (false) {
				...
				v171 := v171[v51.f12 := v52[138]];
				var v172: multiset<bool> := multiset{v169.f13, false};
				m0(if (v51.f12 in v172) then v172[v51.f12] else v52[138], v54, globalState);
			} else {
				v54 := v54 / v54;
				v52[138], v116 := (v54 + v54) - v52[138], v116;
				var v173: array<bool> := new bool[1] [v51.f12];
				var v174: set<array<bool>> := {v173, v173};
				var v175 := DC21(|v116|, v174, -v52[138]);
				m0(if (f7) then v54 else v175.cf38, v52[138], globalState);
				v54 := v54 * v54;
				var v176: multiset<int> := multiset{v54};
				v51.f13 := !(v176 > (v176 - multiset{v52[138], v54}));
			}
			
			var v177: map<bool, int> := map[v51.f12 := -(163 % v54)];
			...
			if (v51.f12) {
				...
				var v183: array<bool> := new bool[11] [v51.f13, v51.f13, v51.f13, v51.f12, true, v51.f13, fm32(v51.f13, v182, 0x37d, -v52[138], globalState), v51.f13, v51.f13, false, v51.f12];
				var v184: set<array<bool>> := {v183};
				v51.f13 := v183 in v184;
				var v185: map<array<bool>, int> := map[v183 := v52[138]];
				v185 := v185[v183 := v52[138]];
				var v186 := DC4(v51.f13, v51.f12);
				v183[312] := |v181| >= v54;
				v52[138], v186, v183[312], v51.f13 := 0x12d, v186, v51.f12 && f7, if (f7) then true else v51.f12;
				var v187: map<bool, seq<int>> := map[v51.f12 := v57];
				var v188: seq<bool> := [true];
				v187 := v187[v188[|(seq(0xfe, i16  => (v52[138])))|] ==> v51.f13 := v57];
				f7 := (v52[138] - v52[138]) == v52[138];
			} else {
				var v189: set<int> := {v54};
				var v190: set<bool> := {v51.f13};
				f7 := !(!!(v189 >= v189) !in v190);
				var v191 := DC1(v52[138]);
				var v192: array<bool> := new bool[22](i17 => v51.f12);
				var v193: array<array<bool>> := new array<bool>[3] [v192, v192, v192];
				v191, v54, v51.f13, v116, v193 := v191, fm0(globalState) / v54, v51.f13, seq(0x93, i18  => (v118)), v193;
				v51.f13 := v51.f13;
...
class C2 extends T0 {
	...
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		if ((seq(85, i0  => (f16))) !in (seq(0x17, i1  => ("nohtpuim")))) {
			var v0: seq<int> := [p1];
			var v1: seq<bool> := [p0];
			var v2 := DC5(p2 <==> p0, v0[p1 := p1] + v0, |v1|);
			match (v2) {
				case DC4(cf7, cf8) =>
					var v3 := 0x210;
					v3 := fm0(globalState);
					v3 := v3;
					v3, v3, cf7 := v3, p1 / v3, p1 < v3;
					v3 := p1 - v3;
				case DC5(cf9, cf10, cf11) =>
					var v4: array<int> := new int[11](i2 => i2 / p1);
					v4 := v4;
					...
					v15 := v15;
				case DC3(cf6) =>
					var v16: map<int, int> := map[p1 := p1 % p1];
					v16 := v16[p1 := fm0(globalState)];
					var v17: array<int> := new int[1];
					v17[452] := -p1;
					v17[452] := fm0(globalState);
					f7 := p0;
					v17[452] := p1 + -v17[452];
				case DC6(cf12) =>
					...
					v20[733] := !fm1(v21, v19, 891, globalState);
					var v22: C0 := new C0(f7, !p0);
					v19, v20[733], v22, v19 := v19 * v19, p2, v22, p1;
					var v23: map<int, seq<int>> := map[p1 := v0];
					v23 := v23[p1 := v0];
					var v24: array<string> := new seq<char>[26](i4 => (seq(0x2f9, i5  => (f16))) + "iwiju");
					var v25 := "rnjpk";
					v24[808] := v25;
					...
					var v31: set<bool> := {f7, if (p2 in v18) then v18[p2] else v20[733], v25 == v25, v30 !! v30, v20[733]};
					v24[808], v26[673], r1, v28 := v25, v27 + v27, v31, fm26(!f7, p1 / v0[p1], 236, globalState);
			}
			
			var v32: set<bool> := {p2};
			var v33: array<int> := new int[12](i6 => i6 / p1);
			...
			v36 := v36[v34 + v34 := v35];
			var v37 := 0x248;
			var v38: map<bool, int> := map[!(p0 || true) := |v0| / 0x1ac];
			v37 := if (p0 in v38) then v38[p0] else p1;
			v35[632] := p2;
			v35[632] := p2;
			m0(p1 % v37, v37, globalState);
		} else {
			var v39 := -0x123;
			var v40 := "uk";
			...
			if ({v44} > v45.cf39) {
				...
				var v59: array<int> := new int[27] [v39, if (p0 in v53) then v53[p0] else p1, p1, p1, if (p0 in v54) then v54[p0] else v39, |v56|, p1, p1, v39, |(seq(467, i8  => ('y')))[0x68 := f16]|, p1, v57[p1], p1, v39, v39, p1, v39, fm0(globalState), -0x18c, v57[v39], -866, |(seq(0x48, i9  => (f16)))|, v39, p1, -p1, |v58|, p1];
				var v60: seq<array<int>> := [v59];
				var v61: seq<seq<array<int>>> := [v60, v60, v60, v60 + v60, v60];
				v39 := |(v61[-v39])[|fm27(f7, 'c', f7, v43.cf31, globalState)| := v59]|;
				f7 := p1 < p1;
				v59[377] := |v40|;
				v59[377] := p1;
			}
			...
			f7 := p2;
			f7 := (v40 + v40) == v40[-p1 := f16];
			var v62: array<string> := new string[3](i10 => v40);
			v62[49] := v40;
			var v63: seq<int> := [0x3aa];
			var v64: multiset<int> := multiset{|(seq(0x296, i11  => (f16)))[0x48 := f16]|, --|v63|, v39};
			var v65: map<int, multiset<int>> := map[v39 := multiset{fm0(globalState), p1}];
			f7, v39, f7, v62[49] := !(v64 !! (if (p1 in v65) then v65[p1] else v64)), p1, f7, v40;
		}
		...
		if (DC11(p1, p1, p1, f7).cf25) {
			...
			f7 := if ((-p1 / p1) in v71) then v71[-p1 / p1] else p2;
			var v72 := 0x198;
			v72 := v72;
			var v73: map<bool, char> := map[v68.f13 := f16];
			var v74: seq<int> := [318, v72];
			var v75: array<char> := new char[25] ['s', f16, f16, f16, if (!p2 in v73) then v73[!p2] else f16, f16, v67[|v74|], f16, f16, f16, f16, f16, f16, f16, f16, f16, 'd', f16, f16, 'x', f16, f16, f16, 'u', f16];
			...
			if (p2) {
				...
				var v77: set<bool> := {p0};
				v76[795] := v77;
				v76[795] := fm27(p0, f16, p2, p2, globalState);
				var v78: array<int> := new int[6];
				v78[394] := p1;
				var v79: seq<bool> := [false];
				v78[394] := (|v79| % p1) + (p1 * p1);
				...
				v81 := if (p2) then fm26(p0, |v83|, v78[394], globalState) else f16;
			} else {
				var v84 := "ymragmkba";
				v84 := v84;
			...
			if (p0) {
				...
				var v96: seq<bool> := [f7];
				var v97: multiset<bool> := multiset{false, false, v96[p1], f7, f7};
				...
				var v102: array<seq<bool>> := new seq<bool>[22] [[p2], [if (fm28(p2, |[p0]|, globalState) in v95) then v95[fm28(p2, |[p0]|, globalState)] else p2, p0, p0, f7, f7], v96 + v96, v96, v96, v96, v96, v96, v96, v96, v96[|v97| := f7], v96, v96, v96 + v96, if (v99 in v100) then v100[v99] else v96, v96, [if (p0 in v101) then v101[p0] else p0, p0, p0] + v96, v96, [p2, f7], [p2, true], v96, v96];
				v102[947] := [!p0];
				v102[947] := v96;
				var v103 := -0x179;
				v103 := v103;
				...
				f7 := f7;
				var v108: array<int> := new int[7](i14 => i14 % p1);
				...
				f7, v108, v111, v112[554], v113 := p2, v108, v111, v108, if ((v113 - p1) in v114) then v114[v113 - p1] else p1;
			...
			v122[565] := -(if (v121[p1] in v123) then v123[v121[p1]] else |v119|);
			v122[565] := p1 % (p1 % |v119|);
		}
		...
		for i15 := p1 to p1 + p1 {
			...
			v124[522] := v125 !! v125;
			var v126 := -0x5a;
			var v127: seq<bool> := [v124[522], v124[522], p0];
			v126 := |[v127[v126], p0, p0]| + |v127|;
			var v128 := DC16(p0);
			v128 := v128;
		}
		var i16 := 0;
			...
			decreases 100 - i16
		{
			...
			i16 := i16 + 1;
			var v129 := -0x2ba;
			v129 := -((v129 / v129) * (v129 % 198));
			var v130 := 'p';
			var v131 := "pmp";
			v130 := if (p2) then v131[p1] else f16;
			...
			var v138: map<bool, seq<string>> := map[fm1((v135[v129 := v136])[-p1 := v136], -v129, |v137|, globalState) := seq(485, i17  => (v131))];
			var v139: seq<bool> := [f7];
			var v140: map<bool, bool> := map[true := DC11(|v139|, p1, p1, f7).cf25];
			var v141: seq<string> := [v131];
			v138 := v138[v140 == v140 := v141[v129 := v131] + v141];
		}
		var v142 := DC0(p1);
		...
		v143[210] := p1;
		var v144 := DC16(true);
		var v145: map<bool, int> := map[v144.cf30 := v143[210]];
		v145 := v145[f7 := p1];
		var v146 := DC1(-0x58);
		r0 := match v146 {
	...
	method m3(globalState: GlobalState) {
		...
		match (v4) {
			case DC21(cf38, cf39, cf40) =>
				...
				match (v15) {
					...
					case DC22(cf41, cf42, cf43) =>
						var v22: array<seq<int>> := new seq<int>[17](i0 => [0x1c6, |(map v21 : int | (0x105 <= v21) && (v21 < 923) :: (v21 % -cf41) := (cf40))|, |v8|]);
					...
					case DC20(cf37) =>
						...
						var v29: seq<array<char>> := [if (v1[cf40]) then v28 else v28, v28];
						v28 := v29[cf40 * cf38];
						v28[675] := v0;
						v28[675] := f16;
				}
				...
				f7 := f7 ==> (f7 <==> v5.f12);
				var v30: multiset<int> := multiset{v3, |v1[cf38 := f7]|};
			...
			case DC22(cf41, cf42, cf43) =>
				...
				if (v1[v3]) {
					...
					cf41 := v3 % v3;
					var v39: map<int, int> := map[-(v3 + |(seq(0x80, i1  => (v0)))|) := v3];
					v39 := v39[v3 := cf41];
					...
					v47[370] := cf41;
					v3 := cf41;
					var v48: map<bool, int> := map[f7 := |v41[343]|];
					v48 := v48[f7 := cf41];
				}
			...
			case DC20(cf37) =>
				...
				v51 := v51[v3 != -684 := f7];
				var v52 := new C0(|(seq(0x35f, i2  => (f16)))| >= v3, v3 < v3);
				var v53: map<int, bool> := map[v3 := v52.f12];
				var v54: array<bool> := new bool[3] [|(seq(0x1a4, i3  => (v0)))| !in v53, v52.f13, v52.f13];
				v54[275] := v52.f12;
				v54[275] := !v52.f12;
				var v55: set<map<int, bool>> := {v53 + v53, v53};
				var v56 := "rck";
				var v58: map<int, string> := map[v3 := fm28(true, --0x310, globalState)];
				v55, v56, v3, v0 := v55 - {map v57 : int | (0x29b <= v57) && (v57 < 0xdd) :: (v57 / v3) := (v52.f13), v53}, if ((if (f7) then v3 else v3) in v58) then v58[if (f7) then v3 else v3] else v56, fm0(globalState), v0;
		}
			...
			decreases 100 - i5
		{
			...
			v61[23] := v0;
			v61[23] := v0;
			v61[23] := if (f7) then v0 else fm37(f7, DC25(), globalState);
		...
		v64[681] := v65;
		v64[681] := fm42(|map[f7 := 'j']|, v3 <= v3, globalState);
	}
	method m13(p0: bool, p1: bool, p2: bool, p3: array<char>, globalState: GlobalState) {
		var v0: seq<bool> := [p0];
		var v1 := 0x260;
		var v2: seq<seq<bool>> := [v0[v1 := f7], v0];
		f7 := (seq(0x2c, i0  => ([f7]))) <= v2;
			...
			decreases 100 - i2
		{
			...
			if (p2) {
				...
				v19 := f16;
				v19 := f16;
				var v20: array<seq<int>> := new seq<int>[3](i3 => [0x323] + (seq(0x1ad, i4  => (|v12|))));
				v20 := new seq<int>[14](i5 => [|v4|]);
				v1 := v1;
				v12 := v12;
			} else {
				var v21: seq<D0> := [v15];
				var v22: set<map<bool, bool>> := {v8, v8, map[fm1(v21[|fm43(f16, f7, p2, globalState)| := DC0(v1)], v1, v1, globalState) := !!true]};
				v1, v22 := |(v12 + (v12 + v12))[v1 := f16]|, v22;
				v10[773] := v10[773];
				var v23: array<set<string>> := new set<string>[17];
				var v24: set<string> := {seq(0x142, i6  => (f16))};
				v23[836] := v24;
				v23[836] := v24;
				v1, v12 := v1, "qr" + v12;
				var v25: array<string> := new string[4];
				v25[673] := seq(0x304, i7  => (f16));
				v25[673] := v12 + v12;
			}
			
			v10[773][934] := fm0(globalState);
			v10[773][934] := v1;
			var v26 := DC16(true);
			f7 := v26.cf30;
		}
		...
		if (if (!(v1 == 889)) then fm1(v29, v1, |v8|, globalState) else true <== f7) {
			...
			var v39 := "fvugstq";
			match (fm44(v1 % v1, map[v1 := v36] + v37, v27, v38[|fm45(|v39|, |v39|, globalState)|], globalState)) {
				case DC28(cf47) =>
					v39 := v39;
			...
			if (fm1(v29, 0x5, -|f15|, globalState) <==> f7) {
				...
				var v51: seq<int> := [-|v49|, |v50[v1]|];
				var v52 := DC8(f7, v39);
				var v53: multiset<D2> := multiset{v52};
				var v54: array<int> := new int[9] [v1, v1, v1, |v4|, v51[v1], v1, v1, v1, |v53|];
				...
				v39 := v39;
				var v56 := DC17(f7, v51[v1], 'b', f16);
				v27, f7, v36, v1, v27 := f16, if (p1) then v56.cf31 else p1, multiset{v1}, -|({v1, v1} + fm2(v1, f7, globalState))|, f16;
				var v57: array<bool> := new bool[6](i8 => v0[|v9|]);
				v57 := v57;
			} else {
				var v58: seq<int> := [-0x253];
				var v59: set<int> := {v1, |v58|, v1, -v58[-v1], |v36|};
				var v60 := new C0(p1, v59 <= v59);
				var v62: set<map<int, int>> := {map v61 : int | v61 in v36 :: (v61 % v1) := (v1)};
				v8 := v8[v62 >= v62 := f7];
				f7 := v60.f12;
				m0(|v4|, -(-v1 % v1), globalState);
				v1 := -(if (v0[v1] in v4) then v4[v0[v1]] else v1);
			}
...
class C3 extends T1 {
	...
	method m4(p0: int, p1: string, globalState: GlobalState) returns (r0: array<array<bool>>, r1: int, r2: bool, r3: int) {
		...
		if (!f7) {
			...
			if (f7) {
				...
				var v12 := 't';
				r1 := fm9(v0.f13, f14 - |v11[p0 := v0.f13]|, v12, globalState);
				v0.f13 := !!v0.f13;
				...
				var v19: array<int> := new int[20](i0 => i0 / p0);
				v19[917] := f14 * p0;
				v19[917], r3, v18 := p0, -p0 + -0x14e, v18;
			} else {
				var v20: array<int> := new int[20];
				v20[456] := p0;
				var v21 := 'e';
				v20[456], v0.f13, r3, r1 := fm9(v0.f13, f14, DC17(v0.f12, p0, v21, v21).cf33, globalState), f7, p0, 0x32b;
			...
			v31 := v31;
			if (v0.f12) {
				var v32: array<int> := new int[12] [f14 + -0x3ba, |(if (f7) then seq(0x344, i2  => (v31)) else p1)|, p0, p0 / 919, 0x236, -p0, f14, p0, f14, f14, p0, f14];
				v32[436] := |p1|;
				var v33: seq<bool> := [f7, !v0.f12];
				v32[998] := |([v0.f12] + v33)|;
				v29[478] := v0.f12;
				v32[436], v32[998], v29[478], v31 := p0, -p0, v0.f13, v31;
				var v34: seq<int> := [v32[436]];
				v32[436] := |map[v0.f13 := 33]| * v34[p0];
				var v35 := "wloks";
		...
		var v43: set<int> := {|v42|};
		for i3 := p0 to |(v41[|v43| := v0.f13])[|map[f14 := v0.f12]| := v0.f12]| {
			v0.f13 := v0.f13;
			r1 := p0 - f14;
		...
		if (-(if (|p1| in v48) then v48[|p1|] else f14) !in v48) {
			...
			r1 := fm0(globalState);
			var v53 := 'b';
			r2 := v53 in (seq(748, i6  => (v53)));
			if (v0.f12 !in v49) {
				r1 := f14;
				var v54: map<int, array<bool>> := map[f14 := v47];
				var v55: map<int, int> := map[|v54| := -|(multiset{|p1|, p0, |v43|})[|[f14]| := |v43|]|];
				...
				v53 := v53;
				var v59: seq<int> := [p0];
				var v60 := DC5(f7, v59[f14 := p0], |v59|);
				var v61: multiset<bool> := multiset{v0.f12};
				var v62: seq<multiset<bool>> := [v61[v0.f12 := p0]];
			...
			match (v67) {
				...
				case DC12(cf26) =>
					...
					v71[982] := v72;
					v0.f13, f7, r3, v71[982] := v0.f13, fm8(p0, globalState), |[multiset{f14} >= v48]|, v72 + v72;
					v47[693] := v0.f13;
					var v73: map<char, bool> := map[v53 := f7];
					v47[693] := if (fm8(f14, globalState)) then if (v53 in v73) then v73[v53] else v0.f12 else v0.f12;
					v0.f13 := f7;
			...
			v75[450] := |v0.fm17(f14, f7, globalState)|;
			v75[450] := p0;
		...
		var v86: seq<array<bool>> := [v47, v85[-0x1b1]];
		var v87: array<array<bool>> := new array<bool>[27] [v47, v84.cf21, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, v47, if (v0.f12) then v47 else v47, v47, v47, v47, v86[fm0(globalState)], v47, v47, v47, v47, v47, v47, v47, v47];
		r0 := v87;
		r1 := f14;
		var v88 := DC0(p0);
		r2 := match v88 {
	...
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		...
		var v14 := 0x1e4;
		v13, v14, v14 := v13, p1 - (---f14 / v14), f14;
		var v15: set<multiset<bool>> := {v4, v2};
		r0 := v11[p2 := v14 > |v15|];
		var v16: seq<bool> := [f7];
		var v17 := 's';
		var v18: set<bool> := {f7, true};
		r1 := fm27(v16[f14], v17, v3, p0, globalState) - (v18 - v18);
	}
	method m3(globalState: GlobalState) {
		...
		if (!(v2 < v2)) {
			...
			v3 := |((if (f7) then v5 else map[f7 := v4]) + map[f7 := seq(0x2f8, i0  => ('c'))])|;
			v3 := v2[v3];
			var v6 := DC6(DC4(f7, f7));
			var v7: seq<bool> := [true];
			var v8: seq<seq<bool>> := [v7[v3 := f7], v7 + v7];
			v6, f7, v3, v8 := v6, if (f7) then f7 else v3 >= v3, f14, seq(-0x2ca, i1  => (v7 + v7));
			...
			if (v12[f14] || f7) {
				var v13 := DC16(!(if (v12[|v2|]) then !f7 else f7));
				v13 := v13.(cf30 := f7);
				var v14 := 0x131;
				...
				var v41: array<set<char>> := new set<char>[12] [{'a', v34, v34}, v35, {v34, v34, v34}, v35 - v35, v35, if (v36 in v38) then v38[v36] else v35, v35, v35 + v35, v35 * v35, set v40 : char | v40 in v39[-v32[504]] :: (v40), v35 + v35, v35];
				v41[500] := v35;
				v41[500] := (v35 - v35) * v35;
				var v42: set<int> := {v32[504], f14};
				var v43: multiset<int> := multiset{f14 * f14, -v32[504], f14 / |v42|, v32[504]};
				v43 := fm33(0x101, v34, globalState) - v43;
				var v44 := DC0(f14);
				var v45: seq<D0> := [v44];
				var v46 := "htrgmixse";
				var v47: seq<seq<int>> := [fm21(fm1(v45, |v46|, v32[504], globalState), globalState)];
				v2 := v47[v32[504] + v32[504]];
			...
			if (f14 >= (|v50| / f14)) {
				...
				v58 := v58[f7 ==> f7 := v53 == v53[732 := v57.f16]];
				var v59 := -744;
				v59 := f14;
				...
				v54[186] := v61 > v61;
				var v62: seq<string> := ["acfbl", seq(-0x307, i4  => (v57.f16)), v53];
				v53, v60, v54[186], v53 := v62[|v49|] + v53, v60, f7, "acvrlugbv";
			}
			...
			match (v64) {
				case DC4(cf7, cf8) =>
					...
					v71 := (if (!cf7) then (multiset{f14})[f14 := f14] else v71) * multiset{f14, if (cf8 in v72) then v72[cf8] else f14};
					var v73: seq<char> := [v70, v70];
					var v74: map<seq<int>, char> := map[v2 := v73[f14]];
					v74 := v74;
					v68.f7 := v68.f7 <== cf8;
				case DC5(cf9, cf10, cf11) =>
					v1 := v1[f14 := cf11 + cf11];
					...
					v77, v78, v78 := fm47((v79.(cf49 := |v2|)).cf51, cf11 % cf11, globalState), v78, v78;
					v12 := v12;
				...
				case DC3(cf6) =>
					...
					var v97: array<int> := new int[27] [|(v82 + v82)|, -|v2|, fm9(f7, |multiset{f7}|, v83, globalState), f14 - |v84|, fm0(globalState), f14 - |v85.cf48|, fm9(f7, f14, v83, globalState), |v89|, 638, |v82[|v91| := 'l']|, |{f7}|, 483, -f14, f14 - 0x2c5, fm0(globalState), if (v86 in v93) then v93[v86] else 787, f14, if (f7) then 0x3d2 else f14, -411, f14, |(v82 + v82[|v12| := v83])|, f14, |v96| / f14, if (f7) then f14 else |v50|, f14, -0x12, f14];
					v86[600] := f14;
					v86[600] := -f14;
					var v98 := DC1(f14);
					v98 := v98.(cf1 := |(seq(0x240, i7  => (v83)))| * 725);
				case DC6(cf12) =>
					var v99 := 0x16d;
					v99 := f14;
					v99 := -v99 - f14;
					...
					v105[202] := |(if (v106 in v108) then v108[v106] else v109)|;
					v105[202] := |[v105, if (false) then v105 else v105]|;
			}
		...
		var v112: array<bool> := new bool[20] [v110.f12, f7, v110.f13, v111[if (f14 in v1) then v1[f14] else f14], f7, v110.f12, v110.f13, !v110.fm16(f7, globalState), v110.f12, v110.f12, v110.f13, f7, f7, v110.f12, f7, f7, !v110.f12, v110.f12, v110.f12, f7];
		var v113 := 'y';
		var v114: map<array<bool>, char> := map[v112 := v113];
		var v115 := "acjxxafo";
		v114 := v114[v112 := if (DC4(v110.f13, v111[|v115|]).cf8) then v113 else v113];
		v113 := v113;
		...
		var v123: array<int> := new int[28] [f14, f14, v2[f14], -|[map[|v118| := fm9(v110.f13, f14, v113, globalState)]]|, -f14, f14, f14, f14, f14, f14, f14, f14, f14, f14, f14, f14, f14, 84, f14, f14, |v120|, f14, f14, if (-f14 in v121) then v121[-f14] else f14, fm0(globalState), |v116|, f14, -|v122.cf15|];
	...
	method m11(globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v12: array<int> := new int[23] [f14, f14, f14, if (f7) then f14 else f14, f14, |v7| + |fm21(f7, globalState)|, f14, f14, fm0(globalState), f14, f14, f14, (if (f7 in v8) then v8[f7] else f14) / f14, f14, f14, f14, f14, f14, |v9|, v11.cf52, f14, f14, f14];
			...
			decreases 100 - i3
		{
			...
			var v18: array<bool> := new bool[2](i4 => v10[|{|v8|}|]);
			v18[645] := |v10| < f14;
			v18[645] := f7;
			v12 := v12;
			v18[645] := (v8 * multiset{v18[645], true, true}) > (v8 + v8);
		}
		...
		var v23: map<bool, map<bool, bool>> := map[f7 := v22[f14]];
		var v24: seq<int> := [|v20|, |v9|, |(if (f7 in v23) then v23[f7] else v21[f7 := f7])|, f14, f14 + 0x23d];
		var v25: array<bool> := new bool[25];
		v25[425] := !f7;
		var v26 := 's';
		var v27: set<int> := {f14};
		r1, v24, v25[425], v26, f7 := (f7 !in map[f7 := f14]) <==> f7, v24, (if (f7) then v27 else v27) <= v27, v26, f7;
		var v28: array<array<bool>> := new array<bool>[14];
		v28, r0 := v28, if (!(if (v25[425]) then !f7 else f7)) then v10[|v9|] else f7;
		var v29 := DC15(v26);
		var v30: map<D6, bool> := map[v29.(cf29 := v26) := v25[425]];
		r0 := v29 !in v30;
		var v31: seq<string> := [seq(-0x139, i5  => (v26))];
		r1 := (v31[|(seq(0x3a0, i6  => (v26)))| := seq(-208, i7  => (v26))] + v31) != ((seq(0x89, i8  => (v9))) + v31);
	}
	method m12(globalState: GlobalState) returns (r0: bool, r1: multiset<bool>, r2: bool, r3: multiset<bool>) {
		var v0 := 'p';
		var v1: map<bool, string> := map[f7 := (seq(0x2b, i0  => ('m')))[f14 := v0]];
		var v2 := "vau";
		...
		for i1 := fm0(globalState) to f14 {
			...
			var v15: seq<int> := [|v14|];
			var v16: array<bool> := new bool[23] [f7, f7, f7, f7 || f7, fm1(v9, i1, 503, globalState), f7, !v3[f14], f7, f7, f7, f7, f7 <== f7, f7, if (v2 in v10) then v10[v2] else f7, f7, true, !f7, v12 > v12[v11 := i1], f7, fm1(v9, |((fm50(v13, v7, -fm0(globalState), globalState))[f14 := f7])[-f14 := f7]|, 0x127, globalState), f7, false, i1 == |v15|];
			v3, v6, v7, v16 := [v3 < v3], v6, v7, v16;
			v16[744] := f7;
			var v17: seq<seq<char>> := [v2, [v0], v2];
			v16[744] := fm1(seq(0x336, i3  => (v8)), i1 / |v17|, i1, globalState);
			var v18: multiset<string> := multiset{v17[f14], v2};
			var v19: seq<multiset<string>> := [v18];
			r2 := f7 <== (multiset(v17) == v19[-f14]);
			v2 := v2;
		}
...
class C4 extends T0 {
	...
	function fm15(globalState: GlobalState): int {
		|(seq(538, i0  => ('v')))| + (-0x1a1 * |{-|"gmpsycksp"|, |"x"|}|)
	}
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		...
		for i1 := p1 to p1 {
			...
			var v13: map<seq<int>, int> := map[v12 := -|(seq(0x107, i2  => ('l')))|];
			...
			v17[560] := 324 * ((if (-348 in v18) then v18[-348] else |(if (v2.f12 in v19) then v19[v2.f12] else v14)|) * i1);
			var v20 := 't';
			var v21 := "anfua";
			...
			v17[560], v17[560], v25[930], v17[560], v2.f13 := v17[560] + |(v27 + v27)|, fm15(globalState), v23, v17[560], v2.f12;
			if (p1 != 423) {
				...
				v30 := v30[p1 := fm2(v17[560], !v22.f13, globalState)];
				...
				v33 := v33;
				v26[746] := v2.f12;
				v26[746] := if (v17[560] in v18) then v22.f12 else if (v22.f12) then v2.f12 else v2.f13;
		...
		if (v2.f13 || p2) {
			...
			match (v43) {
				case DC4(cf7, cf8) =>
					...
					var v48: map<bool, multiset<char>> := map[v41 != v41 := v47[v38 := v40] + v47];
				...
				case DC6(cf12) =>
					...
					var v74: array<int> := new int[10] [if (v2.f12 in v63) then v63[v2.f12] else p1, fm15(globalState) % v40, v40, v40, |v73|, v40, p1, 0x2bd % p1, 395, DC1(-p1).cf1 - v40];
					v69[102] := if (v40 in v64) then v64[v40] else v72[v40];
					var v75: array<bool> := new bool[25];
					v40, v69[102], v75, v36, f7 := p1 / v40, v40, v75, v36, v2.f12;
					...
					v78[475] := v75;
					v76[366], v2.f13, v2.f13, v2.f13, v78[475] := v77, false, p2, if (true) then p0 else v2.f13 || v2.f12, v75;
					var v79: seq<array<bool>> := [v78[475], v78[475], v78[475], v75, v78[475]];
					var v80: map<bool, array<bool>> := map[v2.f12 := v79[v69[102]]];
					v72, v75 := v72, if (false in v80) then v80[false] else v78[475];
					var v81 := DC1(fm0(globalState) % v40);
					f7, v67, v69[102], v81, v2.f13 := p2, (v67 + v67)[v81.cf1 := v38] + v67, v72[|(seq(0x12d, i4  => ('d')))|], v81, v2.f12;
			}
			...
			var v86: array<bool> := new bool[24] [p2, p2, v2.fm16(true, globalState), p0, v2.f12, v2.f12, v2.f13, false <==> true, true, p0, if (v36[p1]) then v2.f12 else v2.f12, true, if (v2.f13) then v2.f12 else v2.f12, v2.f13, v2.f12, v2.f12, false, f7, if (f7) then false else p0, v2.f12, p0, v2.f13, p1 >= v40, v2.f13];
			v86[719] := v2.f13;
			v86[719] := p0 || f7;
		} else {
			v2.f13 := false;
			...
			if (v2.fm16([v88] == v89, globalState)) {
				...
				var v97: array<array<map<bool, bool>>> := new array<map<bool, bool>>[26] [v92, v92, v92, if (v88 in v93) then v93[v88] else v92, v92, v92, v92, v92, v94.cf27, v92, v92, v92, v92, v92, v92, v92, v92, v92, v95[if (true in v96) then v96[true] else p1], v92, v92, v94.cf27, v92, v92, v92, v92];
				v97[422] := v92;
				v88[802] := v2.f13;
				var v98: multiset<array<int>> := multiset{v90};
				v38, v97[422], v88[802], v98 := v38, if (v2.f12) then v92 else v92, v2.f12, v98;
				...
				v99[380] := if ((if (!v2.f13) then v101 else v101) in v102) then v102[if (!v2.f13) then v101 else v101] else v100;
				v88[802] := f7;
				var v103 := 0x3b7;
				v103 := p1;
			} else {
				...
				var v105 := new C0(!v2.f13, v36[v104[p1]]);
				var v106 := "ukiih";
				v106 := "tgmrpobis" + (v106 + v106);
				var v107: map<int, int> := map[p1 := v104[p1]];
				var v108 := 0x19a;
				var v109 := DC1(v108);
	...
	method m3(globalState: GlobalState) {
		...
		for i0 := v0 to v0 {
			var v3 := DC0(i0);
			var v4: seq<D0> := [v3];
			var v5 := new C0(fm1(v4, i0, -|v1[v0 := 'e']|, globalState), f7);
			var v6 := 'b';
			var v7: map<bool, char> := map[v5.f13 := v6];
			var v8: map<bool, string> := map[v5.f13 := ((if (v5.f12) then fm20(v5.fm16(v5.f13, globalState), v5.f12, globalState) else "gcosxqa")[v0 := v6])[v0 := if (f7 in v7) then v7[f7] else v6]];
			...
			if (v5.fm16(v5.f12, globalState)) {
				...
				v0 := |(v14 + v14)| * i0;
				v1 := v1;
				var v15: set<seq<int>> := {seq(-993, i1  => (v0))};
		...
		v25[523] := v26;
		v25[523] := v26 + map[multiset{f7} := fm1(seq(0x1ec, i2  => (DC0(v0))), v0, v0, globalState)];
		var v27: set<array<int>> := {v22[575]};
		...
		for i3 := v28.cf3 to v0 {
			...
			var v31: seq<map<bool, bool>> := [v29, v30[v0], v29];
			var v32: multiset<int> := multiset{i3, -v0, |v31[i3]|};
			f7 := !(i3 !in v32);
			v0 := v0;
			f7 := f7;
			m10(v0, globalState);
		...
		if (if (v33 in v34) then v34[v33] else v35 >= v35) {
			...
			var v37 := 'h';
			v36[668] := if (f7) then v37 else v37;
			v36[668] := v37;
			v33.f13 := v0 != v0;
			var v38: set<int> := {v0};
			v33.f13 := v38 <= v38;
			...
			v46, v47, v0, v0, v0 := v46, fm27(v33.f12, 't', !(v0 != v0), f7, globalState), v0 - (v0 / v0), |v1|, fm15(globalState) - v0;
			var v48 := 'c';
			v48 := v48;
			if (!((v47 + v47) !! v47)) {
				...
				var v52: map<bool, multiset<bool>> := map[v51[|(seq(-478, i5  => (v48)))|] := v45];
				...
				var v62: map<array<int>, D1> := map[v22[575] := DC4(true, v33.f13)];
				var v63 := DC4(v33.f13, v33.f13);
				v33.f13 := v62 == map[v22[575] := v63];
			}
	...
	method m9(globalState: GlobalState) returns (r0: char, r1: int, r2: map<bool, string>) {
		...
		if (match v4 {
			...
			var v7: map<bool, bool> := map[f7 := v6 != (seq(0x27d, i0  => (v5)))[|(seq(0x5e, i1  => (v2)))| := v5]];
			v7 := v7;
			var v8: array<seq<int>> := new seq<int>[9];
			v8[440] := v6;
			var v9: set<bool> := {f7};
			f7, v6, v8[440], f7, f7 := f7 !in (v9 + v9), v6, v6, true, f7;
			f7 := f7;
			var v10 := DC26(v8[440]);
			var v11 := DC31(v10, f7);
			if (f7 <== v11.cf54) {
				...
				f7 := if (f7) then f7 else v0[|(seq(436, i2  => (v13.f14)))|];
				...
				v5 := v5;
				var v16 := "mj";
				var v17: array<string> := new string[7] [v16 + v16, v16, v16, v16 + v16, seq(0x1cc, i3  => (v2)), seq(0x2ae, i4  => (v2)), v16];
				v17[154] := seq(0x332, i5  => (v2));
				var v18: seq<string> := [v16, v16, v16];
				v17[154] := (if (f7) then v16 else v16) + (v18[v5] + v16);
				f7 := f7;
				var v19: set<set<bool>> := {v9};
				var v20: set<int> := {-|v19|};
				var v21: map<set<int>, string> := map[v20 := seq(-716, i6  => (v2))];
				v21 := v21;
			...
			var v24: map<int, multiset<bool>> := map[476 := v23[f7 := v5]];
		...
		var v30 := 0x3a0;
		if (v0[v30]) {
			if (fm1(fm51(fm18(globalState), f7, globalState), v30 / v30, v30 * v30, globalState)) {
				...
				r1, v35, v36[120], r1, f7 := v30 / v30, (DC38(v35).(cf62 := v35)).cf62, fm15(globalState) % v30, -v30, v1.fm32(v30 > v30, v38, 0x2d8, |v39|, globalState);
				...
				var v46 := DC0(v36[120]);
				var v47: seq<D0> := [v46];
				var v48: seq<multiset<bool>> := [v43, v44.cf69, v43[true := v30], fm49(!f7, v45, f7, globalState) - multiset{fm1(v47, v30, v30, globalState)}, v43 - multiset{false, f7}];
				r1 := |v48|;
			} else {
				var v49: set<bool> := {f7};
				var v50 := DC3(v49);
				...
				var v56: array<int> := new int[26] [v30, 0x2b6, v30, fm0(globalState), |({f7, f7} - v50.cf6)|, if (true) then v30 else v30, 0x8a % |v49|, v30 + v30, if (f7) then v30 else |v0|, v30, |(if (f7) then v51 else v51)|, v30, 0x397 + v30, v30, v30, v53.cf23, v30, v30, fm15(globalState), 0x304, if (f7) then fm0(globalState) else v30, v30, v30, v30, |(v52 + (if (-|v55| in v54) then v54[-|v55|] else v52))|, v30];
				v56[947] := -v30;
				v56[947] := |(v0 + v0)|;
				var v57: array<bool> := new bool[10](i8 => multiset{v0} > multiset{v0});
				v57 := v57;
				var v58: array<D13> := new D13[19];
				var v60: map<array<int>, set<int>> := map[v56 := set v59 : int | (262 <= v59) && (v59 < 0x246) :: (v59 / v56[947])];
				var v61 := DC34(v60);
				var v62 := DC37(v61);
				v58[875] := v62;
				v58[875] := DC37(v61);
				var v63: map<seq<int>, bool> := map[fm21(f7, globalState) := v52 <= v52];
				var v64: seq<int> := [|v52|, v56[947], v56[947], v56[947], 28];
				v63 := v63 + map[v64 := f7];
				v56[947] := -|v52|;
			}
			...
			var v77 := "snip";
			v30 := (if (f7 in v76) then v76[f7] else v30) / |v77|;
		...
		if (fm1(fm51(v2, f7, globalState), |(v78 + fm35(|[v79, if (fm1(v83, v30, v30, globalState) in v80) then v80[fm1(v83, v30, v30, globalState)] else v79, v79, v79]|, |v84|, globalState))|, |v78| - -v30, globalState)) {
			...
			if (fm30(!f7, v79.f14, false, globalState) == v3) {
				...
				var v95: map<bool, seq<seq<bool>>> := map[v0[-(if (f7 in v81) then v81[f7] else |v81|)] := v94];
				var v96: seq<seq<seq<bool>>> := [v94];
				v90[950], v94 := v92, if (v79.fm8(v79.f14, globalState) in v95) then v95[v79.fm8(v79.f14, globalState)] else if (f7) then v96[v79.f14] else v94;
				...
				v98 := fm52(v101 + [multiset(v102), v100, v100, v100[|(if (|v106| in v104) then v104[|v106|] else v103)| := v79.f14], multiset(v102)], v30, v79.f14 % v30, f7, globalState);
				var v107: set<array<bool>> := {v105, v105};
				var v108 := DC25();
				var v109 := new C2(v107, fm37(f7, v108, globalState), 0xff >= 0x33a);
				r1 := v79.f14 % (v30 * v79.f14);
			...
			if (multiset(v0) !! v81) {
				...
				v120[485] := if (f7) then v121 else v121;
				v120[485] := new char[9] [v2, v2, 't', v2, v2, v2, if (!f7 in v84) then v84[!f7] else v2, 'n', v2];
				v78 := v78;
				var v122: multiset<int> := multiset{0xd1};
				var v123: map<bool, bool> := map[!f7 := f7];
				var v124: array<bool> := new bool[21] [f7, v122 > multiset{v79.f14, v79.f14}, f7, true, f7, f7 <==> false, f7, !(if (f7 in v123) then v123[f7] else f7), !f7 && f7, f7, f7, f7, f7, if (f7) then !f7 else f7, v79.f14 < v79.f14, -v30 < v79.f14, f7, f7, f7, v0[--fm0(globalState)], f7];
				v124[433] := f7;
				r0, v124[433] := v78[|v114| / |v122|], f7;
			}
			...
			if (v125 in [v125, v125, v125]) {
				...
				v30, f7, v125[219], v126[841] := if (v79.fm9(f7, -v30, v2, globalState) in v128) then v128[v79.fm9(f7, -v30, v2, globalState)] else fm0(globalState), f7, v79.f14, v127;
				v30 := v79.f14;
				...
				v125[92] := v79.f14;
				v125[92] := (v79.f14 * v30) / (v79.f14 - 0xef);
				var v137: array<bool> := new bool[10](i14 => f7);
				v137[831] := f7;
				v137[831], f7, v30 := f7 && f7, false ==> f7, 0x2b2;
				v137[831] := true;
				var v138 := new C1(f7);
				r1, v30, v30 := v79.f14 % v125[92], -v79.f14 % v125[92], v79.f14;
			}
		...
		f7, f7, r1, v143[392] := !f7, match v144 {
		...
		v30, v143[392], v143[392], r1, v143[392] := (v30 * 0x3b4) - v30, v143[392], v1.fm32(!v143[392], set v146 : int | (0x102 <= v146) && (v146 < 0x240) :: (v146 / v79.f14), 0x33f, v30, globalState), -(v145.cf70 / v30), f7;
		r0 := fm18(globalState);
		r1 := v30;
	...
	method m10(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v5[793] := |(v9 - v9[v8 := p0])|;
			var v10: multiset<int> := multiset{|(seq(0x284, i2  => (|v3|)))|};
			v5[793] := if (p0 in v10) then v10[p0] else |(seq(0x1da, i3  => ([|"nnw"|])))|;
		}
		var v11 := DC28({v2, v2});
		...
		if (f7 && f7) {
			...
			if (v22.cf30) {
				...
				v21.f13, v21.f13, v0 := (if (v21.f13) then {v23} else v24) > (if (if (v21.f12 in v13) then v13[v21.f12] else true) then v24 else if (v21.f13 in v25) then v25[v21.f13] else v24), fm1(v27, |v28|, v31.cf41, globalState), |(v23 + (seq(0x3a5, i4  => (--p0))))|;
				...
				v34[107] := v35;
				v0, v33, v21.f13, v2, v34[107] := v32[35] % (if (v21.f12) then p0 else |v13|), (v33 + v33) + v33, !v21.f13, fm18(globalState), v35;
				var v36: seq<bool> := [!!f7, f7];
				var v37: seq<bool> := [v36[p0]];
				var v38: map<bool, int> := map[v21.f13 := p0];
				var v39: seq<map<bool, int>> := [v38, v38];
				var v40: map<int, char> := map[|v3| := v2];
				var v41: map<seq<map<bool, int>>, seq<bool>> := map[v39 := (v37 + [v21.f13, v21.f12, v21.f12, f7, v21.f12])[|v40| := v21.f12]];
				v37 := if (v39 in v41) then v41[v39] else v37;
				v32[35], v21.f13 := v32[35] - v0, v21.f13;
			} else {
				...
				v42[382] := new int[21] [p0, if (v21.f13) then v0 else p0, -965, v0, v0, v0, v0, fm0(globalState), p0, p0, p0, -(857 % |v44|), p0, v0, p0 - |v44|, -(p0 * |(fm53(|v45|, v21.f13, globalState)).cf15|), p0, -(v0 / p0), v0 * 0x65, v0, 507 * |v46[v22 := v21.f12]|];
				...
				v42[382][695] := v0;
				v42[382][695] := v0;
				v42[382][695] := v42[382][695];
				var v52 := DC24();
				v42[382][695] := |DC45(map[v52 := v42[382]]).cf72|;
			}
			...
			v53[17] := v54[|v3| := |v55|] + (seq(0x3d7, i7  => (-p0)));
			v55 := v55;
			...
			var v60 := DC3(v59);
			var v61 := DC0(|v3[p0 := v2]|);
			var v62 := DC22(0x1be, v60, v61);
			var v63: seq<bool> := [true, fm1(seq(578, i8  => (v61)), v0, p0, globalState), v21.f13];
			v56[928], v21.f13, v21.f13, v2, v62 := v21.f12, v63[|v3|], (v3 + v3) <= v3, v2, v62;
		} else {
			if (if (f7) then true else f7) {
				...
				var v67: seq<bool> := [f7];
				var v68: seq<int> := [|v67|];
				var v69 := new C1(fm1(v66, |v3|, -v68[p0], globalState));
				var v70: array<bool> := new bool[23];
				v70[542] := f7;
				v70[542] := f7;
				var v71: map<bool, int> := map[v70[542] := v0 - v0];
				...
				var v77: set<int> := {|v75|};
				var v78: array<int> := new int[16] [p0, -0xfc, v0, 250 + v74.cf32, v0, v0 + v0, p0, v0, |v1|, v0, if (p0 in v75) then v75[p0] else |(map v76 : int | v76 in v77 :: (v76 % |v3|) := (f7))|, p0, v0, -(fm0(globalState) + |v3|), v0 + |(seq(81, i10  => (p0)))|, p0];
				v78[846] := p0;
				v78[846] := 276 + p0;
				var v79: seq<bool> := [f7, false];
				var v80: seq<bool> := [f7, f7, v79[v0], f7, f7];
				var v81: seq<int> := [|v80|];
				var v82: map<array<int>, int> := map[v78 := v0];
				v78[846] := v81[(if (v78 in v82) then v82[v78] else v78[846]) % v81[v0]];
				var v83: seq<string> := ["p", ((if ((if (f7 in v13) then v13[f7] else f7) in v12) then v12[if (f7 in v13) then v13[f7] else f7] else v3) + v3)[v78[846] := v2], v3, "volltvv", v3];
				var v84 := DC26(v81);
				var v85 := DC31(v84, f7);
				var v86: map<bool, seq<bool>> := map[true := v79];
				v83 := fm3(f7, v0, |fm49(v85.cf54, v86, f7, globalState)|, if (f7) then v78[846] else v0, globalState);
		...
		for i12 := fm15(globalState) to if (f7) then -0x196 else |v92| {
			...
			v93[225] := v96.cf3 == |(v97 + v97)|;
			v93[225], f7 := false, v93[225];
			v0 := v0;
			var v98: seq<map<int, bool>> := [v1];
			f7 := |v98[v91.f14]| >= 0x309;
		}
	}
}
	...
	method m7(globalState: GlobalState) {
		...
		for i0 := if (v0 in v2) then v2[v0] else v3 to v3 {
			if (f10) {
				...
				v4, v6, v3 := -0x197 in (map v7 : int | v7 in v8 :: (v7 % i0) := (map[|v1| := v4])), v6, -|{[v4, f10, v9[|v11|]], v9, v9}|;
				v4 := v4;
				var v12 := DC4(v4, !v4);
				...
				v14[400] := !v16 <== v16;
				v14[400], v16 := v16, true;
				var v19: set<int> := {i0, fm0(globalState), v3};
				var v20 := DC7(v19);
				v19 := (v20.(cf13 := set v21 : int | (0x85 <= v21) && (v21 < -0x3aa) :: (v21 / 0x1ce))).cf13;
			}
			...
			var v30: seq<int> := [i0];
			v23[584], v24, v1, v3, v24 := DC8(f10, v1).cf14, if ("akjinxm" in v27) then v27["akjinxm"] else !v24 || f10, (v1 + v1) + (if (v24) then v1 else v28[|v29|]), -fm0(globalState), fm1(v26, |v30|, v3, globalState) <== f10;
			var v31 := DC4(f10, v24);
			var v32 := DC6(v31);
			var v33: multiset<int> := multiset{v3};
			var v34: set<bool> := {v23[584], f10};
			var v35: seq<D1> := [DC6(v31), fm14(i0, |v33|, |v34|, fm1([v25, v25, DC0(i0), v25, v25], |v1|, v3, globalState), globalState), v31, v31, v31];
			var v36: array<D1> := new D1[19] [v32, v32, v32, v32, v32, v32, v32, DC6(v31), v32, v32, v32, v32, v32, DC6(v35[i0]), v32, DC6(v31), v32, v32, DC6(v31).(cf12 := v31)];
			var v37: set<array<D1>> := {v36};
			v24 := v37 > v37;
			var v38: seq<seq<int>> := [if (v23[584]) then v30 else seq(0x3aa, i2  => (i0)), v30 + v30, [v3]];
			v30 := v38[v3 * v3];
		}
		var v39 := false;
			...
			decreases 100 - i3
		{
			...
			v44[875] := if (if (0x21f in v48) then v48[0x21f] else v39) then map[f10 := v3] else map[!v39 := v3];
		...
		v56[864] := |map[|v57| := fm0(globalState)]|;
		v56[864] := v3;
		var i6 := 0;
		while (f10)
			decreases 100 - i6
		{
			...
			v58[486] := if (f10 in v59) then v59[f10] else v56;
			v58[486] := v56;
			var v60: multiset<bool> := multiset{f10, v39, v39, !v39, f10};
			var v61: map<bool, multiset<bool>> := map[f10 := multiset{v39}];
			v56[864], v3, v60, v56[864] := v56[864], fm0(globalState), if (v39 in v61) then v61[v39] else v60, |(v57 + v57)| * v3;
		}
		var v62: set<int> := {v56[864], v3, v56[864], v3};
		v3 := |(v62 - v62)| + (v56[864] / 0x94);
	}
	method m8(p0: D0, p1: bool, globalState: GlobalState) returns (r0: D0) {
		var v0 := 0x3d8;
		for i0 := fm0(globalState) / v0 to |(map v1 : int | (0xdb <= v1) && (v1 < 0x10b) :: (v1 / |"kja"|) := (p1))| {
			var v2: multiset<int> := multiset{641 % v0, v0};
			v2 := v2;
			var v3 := true;
			v3 := p1;
			var v4: seq<bool> := [p1];
			var v5 := "ocvmfl";
			var v6: multiset<bool> := multiset{v4[i0], i0 == |v5|, f10, f10, p1};
			var v7 := DC1(v0);
			var v8: map<D0, bool> := map[v7 := v3];
			var v9 := 'x';
			var v10: array<bool> := new bool[16] [v3, i0 <= 858, p1, p1, v0 == i0, p1, !(if (v7 in v8) then v8[v7] else v3), !f10, v3, (seq(166, i1  => ('v')))[v0 := v9] < v5, false, f10, !(v3 <==> !v3), i0 <= i0, f10, p1];
			v6, v10 := v6, v10;
			...
			decreases 100 - i2
		{
			...
			if (if (v0 in v15) then v15[v0] else !p1) {
				...
				var v23: array<seq<int>> := new seq<int>[26] [[v0, v0], v21.cf10, seq(-0x1b9, i4  => (v0)), v20, v20, v20, v20, [v0], v20, v20[v0 := v0], v20, v20[|v13| := v0], [v0], v20, seq(0x323, i5  => (|v20|)), v20[v0 := v0], v20, [v0], seq(856, i6  => (v0)), v20, [-v0, |v22|, |(seq(0x3c9, i7  => (v0)))|], v20, v20, v20, v20, v20];
				...
				v37[271] := if (v0 in v40) then v40[v0] else v39;
				v37[271] := v39;
			}
			...
			v41[66] := !p1;
			var v42 := DC16(false);
			var v43: multiset<bool> := multiset{v42.cf30, v13[v0]};
			var v44 := DC11(|v43|, v0, v0, f10);
			if (v44.cf25) {
				var v46: array<D2> := new D2[29](i9 => DC7(set v45 : int | v45 in multiset{|v15|} :: (v45 % |multiset{322}|)));
				var v47 := new C4(if (v41[66]) then v46 else v46, f10);
				v0 := v0 + v0;
				...
				var v50 := DC0(v0);
				var v51: seq<D0> := [v50];
				v41[66] := fm1(v51, v0, v0 * v0, globalState);
				v41[66] := p1;
				v0 := v0;
			}
		...
		for i10 := if (p1) then |v55| else |v13| to v53.f14 {
			...
			v0 := v53.f14 % (i10 % (if (|map[v57 := seq(0x236, i11  => ('y'))]| in v56) then v56[|map[v57 := seq(0x236, i11  => ('y'))]|] else v0));
		...
		var i12 := 0;
		while (fm1(([v66, v66])[|v67| := DC0(|v68|)], -v0, |(if (true in v71) then v71[true] else map v72 : char | v72 in v73 :: (v72) := (--0x2ea))|, globalState))
			decreases 100 - i12
		{
			if (i12 >= 100) {
				break;
			...
			match (DC40(v79, !v62, f10)) {
				...
				case DC38(cf62) =>
					...
					var v87: seq<array<D6>> := [v85, v85, v85, v86[v53.f14], v85];
					...
					v88[232] := v53.f14;
					v88[232] := v53.f14;
					var v89: map<int, int> := map[v0 / v88[232] := fm0(globalState)];
					v89 := v89[fm0(globalState) := v0];
				case DC41(cf68) =>
					v76[959] := f10;
					var v90: map<bool, seq<bool>> := map[p1 := v13];
					v76[959] := (fm49(p1, v90, false, globalState))[p1 := if (v53.f14 in v67) then v67[v53.f14] else -v53.f14] == v65;
					v76[959] := v62;
					v62 := v76[959];
					...
					var v96: array<array<int>> := new array<int>[28] [v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v92.cf74, v91, v93.cf44, v91, v91, v91, v91, v94[v53.f14], v91, v91, v91, v91, v91, v91, v91, v95.cf64];
					v96 := v96;
			}
...
class C6 extends T1 {
	...
	function fm9(p0: bool, p1: int, p2: char, globalState: GlobalState): int {
		(101 / |(seq(0x186, i0  => (seq(-704, i1  => (|multiset{f9, f9}|)))))|) * |((map v0 : int | (0x378 <= v0) && (v0 < 0x301) :: (v0 * |"oxffjj"|) := (f9)) + map[DC1(-|[|map[-0x3e0 := 0xd7]|]|).cf1 := f7])|
	}
	...
	method m4(p0: int, p1: string, globalState: GlobalState) returns (r0: array<array<bool>>, r1: int, r2: bool, r3: int) {
			...
			decreases 100 - i1
		{
			...
			var v2: seq<bool> := [v0[505]];
			var v3: multiset<bool> := multiset{v0[505], f9};
			var v4: seq<int> := [p0];
			var v5: seq<int> := [|v4|];
			var v6: map<int, bool> := map[p0 := f9];
			var v7: array<int> := new int[18] [|(v1 + v1[p0 := [|v2|, p0]])|, |v3|, v5[p0], p0, p0, fm12(f7, |v6|, p0, v0[505], globalState), p0, 764 + -0x25e, fm0(globalState), p0, fm9(v0[505], p0, 'g', globalState), p0 + |p1|, |p1|, p0, p0, 611, |v6|, |v4| / p0];
			v7[301] := 0x230;
			v7[301] := p0;
			var v8: map<int, string> := map[p0 := p1];
			var v9 := 'w';
			v7[301] := |((if (|"ydewlhgde"| in v8) then v8[|"ydewlhgde"|] else p1) + (p1[fm0(globalState) := v9])[v7[301] := v9])|;
			f7 := !f7;
		}
		v0[505] := true;
		var v10 := 'm';
		...
		v0[505] := if (if (f9) then f7 else f9) then v12 >= v12 else f9;
			...
			decreases 100 - i2
		{
			...
			var v16: seq<int> := [p0];
			v14[315] := v15[if (f7) then |v16| else p0];
			v10 := 'm';
			var v17: array<int> := new int[4](i3 => i3 * |[p0]|);
			var v18: set<array<int>> := {v17};
			var v19: seq<set<array<int>>> := [v18, v18];
			var v21 := DC2(f7, -p0, v19[|(set v20 : int | (0x11f <= v20) && (v20 < 279) :: (v20 + p0))|], fm9(f7, p0, v10, globalState));
			v0[505] := v21.cf2;
			v0[505] := !f9;
		}
		...
		r1 := (fm12(f7, p0, p0, v0[505], globalState) + p0) + (|v11| * |v25|);
		r2 := v0[505];
		r3 := |p1| * p0;
	}
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		...
		var v1 := "onrgrefdt";
		for i0 := |(v0[p1] + v1)| to p1 + p1 {
			var v2: array<bool> := new bool[25](i1 => f9);
			v2[602] := f7;
			var v3 := 'c';
			v2[602], v3 := p0, v3;
			var v4: map<bool, bool> := map[v2[602] := v2[602]];
		...
		if (fm8(p1, globalState)) {
			...
			v8 := v9[p1];
			var v10: seq<bool> := [p0];
			v8 := |v10[p1 * |map[f7 := false]| := false <==> p2]|;
			var v11 := 'k';
			var v12 := DC15(v11);
			v12 := DC15(v1[|v1|]);
			...
			f7, v16, f7, v17 := (v16 <= |[v18[p1]]|) <==> f9, fm12(p0, v16, 0x1de, p2, globalState) - p1, [fm1(v20[|v21| := DC0(|v1|)], p1, v16, globalState)] < v18, (v17 + map[p1 := v1]) + map[v16 := v1];
			v16 := 0x27b;
			v16 := v16;
			var v22: array<int> := new int[14](i3 => i3 + p1);
			v22[816] := |multiset(v21)|;
			v22[816] := |((v17 + v17) + v17)|;
		}
		...
		if (p0) {
			var v23 := DC35();
			var v24: seq<D13> := [v23];
			var v25: map<seq<D13>, int> := map[(seq(-987, i4  => (DC35()))) + v24 := p1];
			var v26 := 'u';
			...
			v28[557] := v30 - v30;
			var v31: seq<bool> := [p2, fm1(seq(0x2b5, i5  => (DC0(p1))), p1, p1, globalState), f9];
			var v32: map<seq<int>, seq<bool>> := map[v29 := v31];
			v28[557] := {v29, [|v31|, p1], v29} * (set v33 : seq<int> | v33 in v32 :: (v33));
			var v34: array<int> := new int[22];
			v34[965] := p1;
			v34[965] := p1 % p1;
			v34[965] := p1;
			v34[965] := if (f9) then fm9(f9, -v34[965], v26, globalState) / v34[965] else -v34[965];
		} else {
			f7 := p2;
			...
			if (!(((if (-0x128 in v35) then v35[-0x128] else v36) > multiset{f9, true}) || f9)) {
				...
				var v48: seq<int> := [|v1|];
				var v49: array<int> := new int[15] [p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, |multiset{fm0(globalState)}|, p1, v48[0x224], p1];
				var v50: map<bool, array<int>> := map[false := v49];
				var v51: array<int> := new int[27] [|v1|, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, p1, |v1[|v40| := v43]|, -p1, p1, p1, p1, p1, |v44|, 0x99, |v42[|"vkp"| := |v47|]|, -|v42|, 441, |v50|];
				var v52: multiset<array<int>> := multiset{v51, v49, v51};
				var v53 := 0x372;
				var v54: map<int, array<int>> := map[p1 := v51];
				var v55 := DC47(v52);
				v38, v42, v52, v53 := v38[|v54| := v37], v42, (v55.cf76 - v52)[v51 := v53], p1;
				m0(-|v40| / v53, v53, globalState);
				v53 := v53 * 0x335;
				...
				v58[87] := fm28(p2, v53, globalState);
				v58[87] := seq(0x333, i6  => (v43));
			} else {
				...
				v73, v74[843], v75, v76, v64 := fm54(globalState), v77[v60.f14], v75, v76, v64;
			}
	...
	method m3(globalState: GlobalState) {
		if (f7) {
			...
			var v7: array<int> := new int[5](i0 => i0 / v0);
			var v8: map<int, array<int>> := map[v0 := v7];
			var v9: map<bool, int> := map[v0 < v0 := |v6| / |v8|];
			v9 := v9;
			var v10: array<char> := new char[1];
			v10[358] := if (f7) then 'r' else 'o';
			var v11: seq<bool> := [v4.f7];
			var v12: set<bool> := {f9, v11 < v11};
			v10[358], v12 := fm13(v4.f7, v0, f9, globalState), v12;
			...
			var v19: array<D2> := new D2[19] [v17, v17, DC7(v18[v0]), v17, DC7(v16).(cf13 := v16), DC7(v16).(cf13 := v16), v17, v17, v17, v17, v17, DC7(v16), v17, v17, v17, v17, DC7({v0, v0, v0, v0, v0}), v17, DC7(v16)];
			...
			var v24: array<C4> := new C4[22] [v20, v20, v20, v20, v20, if (f9 in v21) then v21[f9] else v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, if (f9) then v20 else v20, v23[v0]];
			v24[229] := v23[v0];
			v24[229] := v20;
		} else {
			...
			var v39: array<int> := new int[15] [v32, v32 * |v33|, -(if (f7 in v34) then v34[f7] else 0x3d9), |"caerf"|, 0x349 - |v35|, v32, v32 / |v34|, |{fm12(fm8(v32, globalState), v32, v32, fm1(v37, v32, v32, globalState), globalState)}|, v32, v32, |(v38[|v35| := 387] + (multiset{|v38|})[v32 := fm12(f9, v32, |v38|, !f9, globalState)])|, if (f9 in v34) then v34[f9] else |(seq(-0x260, i2  => ('a')))|, v32, -v32 - v32, 0x3cb];
			v39[512] := v32 / v32;
			v31, f7, v39[512], f7, f7 := fm13(if (f7) then !f7 else false, v32, f7, globalState), f7, (|[f7]| * fm0(globalState)) + -0x3bc, !f9 && f9, f9;
			if (f7) {
				var v40: seq<bool> := [f7];
				var v41: set<bool> := {f7, v40[903], f9};
				var v42: map<bool, set<bool>> := map[f7 := v41];
				v39[512] := v32 - -|v42|;
				var v43: map<bool, int> := map[f9 := v39[512]];
			...
			m0(v39[512], v39[512], globalState);
		}
			...
			decreases 100 - i3
		{
			...
			var v50: seq<bool> := [f9];
			var v51: array<bool> := new bool[10] [f7, !f7, f7 ==> f9, f9, !(v48[|v49|] !in (seq(0x1f4, i4  => (v47)))), f7, v47 in v48, f7, !f9, |v50| == -v46];
			v51[541] := f7;
			v51[541] := f7;
			v46 := 625;
			v46 := (if (f9) then 0x13a else v46) % -0x26c;
			v47 := v47;
		}
		...
		for i7 := v46 * v46 to |[v46]| {
			if (v57.f14 >= v57.f14) {
				...
				v64 := (map[v63 := |"mdo"|])[map[v46 := v57.f14] := v55[v57.f14]];
			...
			v70[640] := {|multiset{v57.f14, v57.f14}|, 484};
			var v71: set<int> := {i7};
			v70[640] := v71;
			var v72: seq<bool> := [f7];
...
class C7 extends T0, T1 {
	...
	function fm9(p0: bool, p1: int, p2: char, globalState: GlobalState): int {
		-(-831 / |(map v0 : int | v0 in map[|[0x274, -|[f7]|]| := |[|multiset{true, false, f7}|]|] :: (v0 - |(map v1 : int | (573 <= v1) && (v1 < 0x336) :: (v1 * |"ugnal"|) := (f7))|) := (|[|[f7, f7]|, 734]|))|) + |("hyvc" + "f")|
	}
	...
	method m2(p0: bool, p1: int, p2: bool, globalState: GlobalState) returns (r0: map<bool, bool>, r1: set<bool>) {
		for i0 := p1 to fm0(globalState) - fm10(false, globalState) {
			var v0: map<seq<int>, bool> := map[seq(0x64, i1  => (p1)) := f7];
			...
			if (f7) {
				...
				var v8 := "nmrn";
				var v9: array<int> := new int[10] [p1, -|{p2, f7, f7, f7, p2}|, p1 / -i0, |(if (f7) then v6 else v6)|, 888, if (p2) then i0 else i0, |v7|, 29 + i0, i0, |v8|];
		...
		for i2 := p1 to p1 {
			...
			if (v17.f10) {
				...
				v21 := v21;
				var v22: set<seq<int>> := {fm21(p0, globalState), seq(562, i3  => (p1))};
				v22 := v22;
				v16 := v16;
				...
				v23[356] := |((v27[i2] + v25[v18 := v26.(cf27 := v24)]) + v25)|;
				v23[356] := p1;
			} else {
				var v28: array<int> := new int[17](i4 => i4 / 0x5d);
				v28[558] := i2;
				v28[558] := (-p1 * i2) / (|"oxawko"| - i2);
		...
		var v34: seq<D0> := [v33];
		var v35 := 'e';
		var v36: seq<string> := [v32, (seq(0x366, i5  => (v32[p1])))[|map[fm1(v34, p1, p1, globalState) := f7]| := v35], "ojoyengg", v32 + v32, v32 + (seq(0x24c, i6  => (v35)))];
		v32 := v36[p1];
		var i7 := 0;
		while (p1 >= p1)
			decreases 100 - i7
		{
			...
			v40[86] := v32;
			v37[315], v40[86] := v32 < ("duoejddgs" + v32), v32 + (v32 + v32);
			v38.f7 := p2;
			if (v38.f7) {
				var v41 := 0x1df;
				v41 := -(p1 * (45 / v41));
				...
				var v44: map<char, seq<char>> := map[v35 := v40[86]];
				var v45: seq<bool> := [[v35] <= (if (v35 in v44) then v44[v35] else ([v35])[|v32[770 := 'v']| := v35])];
				v38.f7, v37[315] := v43.cf63 < (if (v38.f7) then v32 else v32), v45[v41];
				v41 := -(-p1 - v41);
				var v46: set<bool> := {v38.f7, true};
				var v47: seq<int> := [v41, 0x8a];
				var v48 := DC5(v38.f7, v47, 616);
				r1 := v46 - (if (false) then fm27(v38.f7, v35, v37[315], !v48.cf9, globalState) else v46);
				v41 := p1 / p1;
			} else {
				var v49 := 0x149;
				v49 := p1;
				...
				f7, v49, v50[412], v49, v49 := !p0, if (v38.f7 in v51) then v51[v38.f7] else v49, p1, v38.fm9(!v37[315], p1, v35, globalState), v49;
				v38.f7 := v37[315];
				v37[315] := (DC11(fm0(globalState), v50[412], p1, v38.f7).(cf24 := p1, cf23 := v49, cf22 := v49)).cf25;
				v50[412] := p1;
			}
			...
			if (p0) {
				...
				v69[351] := v37;
				v38.f7, v63, v67, v69[351] := if ((seq(0x24b, i9  => (p1))) < v60) then v57 != v57 else fm1(v34[v52 := v33], -v52, 805, globalState), v63 + v63, v67, v37;
				v37[315] := if (false) then f7 else v38.f7;
			} else {
				var v70 := 0x7e;
				...
				var v74: set<array<bool>> := {v37, v37, v73[v70]};
				var v75 := new C2(v74, v35, |(seq(0x216, i10  => (DC36(v35, [p0, v38.f7], true).cf58)))| == v70);
				v37 := v37;
				v75.m3(globalState);
			}
		...
		for i11 := p1 to p1 {
			...
			match (v77) {
				case DC30(cf49, cf50, cf51, cf52) =>
					...
					v32 := (v32 + v32[cf52 := v35]) + v32;
				case DC31(cf53, cf54) =>
					var v80: multiset<bool> := multiset{f7, f7};
					var v81 := new C3(|v80[p0 := i11]| - p1, p2);
					var v82: seq<int> := [i11];
					var v83: seq<bool> := [fm8(v82[v81.f14], globalState), p2, f7];
					f7 := v83[|v76| + v81.f14];
					...
					v87 := v87;
					cf54 := !(((seq(0xb4, i12  => (v35))) + fm20(p2, cf54, globalState)) < v32);
				case DC32(cf55) =>
					var v88: seq<bool> := [f7, fm8(i11, globalState), p2];
					var v89: set<int> := {|v88[p1 := f7]|, i11, fm0(globalState), i11, p1};
				...
				case DC33(cf56) =>
					...
					var v97 := 0x3cb;
					var v98: map<bool, bool> := map[false := fm8(|v32[0x17b := v35]|, globalState)];
					...
					var v102: multiset<string> := multiset{seq(-0x22, i14  => (v35)), v32};
					v102, v97 := v102, |v32|;
			}
			...
			if (true) {
				...
				v106[445] := v108[i11 := v107] + v108[i11 := v107];
				v106[445] := v108;
				...
				var v112: array<string> := new seq<char>[6](i16 => seq(187, i17  => (v35)));
				v110[320], v103, v111, v35, v112 := v36, v103, v111, v105.f16, v112;
	...
	method m3(globalState: GlobalState) {
		...
		for i0 := v0 to -|v1| * |v6| {
			...
			var v9: multiset<multiset<bool>> := multiset{v8[|v1|]};
			v9 := v9 + v9;
			f7 := f7;
			var v10 := "ygaj";
			if (v2 !in v10) {
				...
				v12[81] := map[i0 := -0x110] + v6;
				var v13: seq<map<int, int>> := [v6];
				v12[81] := v13[i0];
				f7 := (|(seq(0x307, i1  => (v2)))[i0 := v2]| / v0) != i0;
				...
				var v16 := DC28(v3);
				var v17: seq<D11> := [v16];
				var v18: map<seq<int>, seq<D11>> := map[if (f7 in f8) then f8[f7] else [i0] := v17[|v10| := v16]];
				v18 := v18;
				var v19: map<bool, char> := map[f7 := v2];
				f7 := (|v19| / v0) < (if (|v10| in v6) then v6[|v10|] else v0);
				var v20: set<bool> := {f7};
				var v21 := DC3(v20);
				var v22 := DC0(v0);
		...
		if (v24 > v24) {
			...
			var v27: seq<seq<int>> := [v26, v26, (seq(0x59, i3  => (v0)))[|"owdl"| := |fm20(f7, f7, globalState)|]];
			if (((seq(349, i2  => (v0))) + [v0]) !in v27) {
				...
				var v33 := DC3({f7, f7});
				var v34: map<bool, bool> := map[v25[997] := v25[997]];
				var v35: C3 := new C3(v26[|v34|], v25[997]);
				...
				var v40: array<array<int>> := new array<int>[15] [v37, v38[v0], v37, v37, v37, v37, v37, v37, v37, v37, v37, v37, if (v25 in v39) then v39[v25] else v37, v37, v37];
				v32[185] := v40;
				v32[185] := if (f7) then v40 else v40;
				var v41: set<array<int>> := {v37};
				v25[997], v0, v41, v0 := f7, -0x145 + v0, (v41 - v41) - {v37}, -(v0 - v35.f14);
				var v42 := "qpswxaqat";
				v0, f7, f7 := |v42|, v25[997], v25[997];
				v0 := (v35.f14 / |multiset{v35.f14, v0}|) * (v35.f14 * |[f7]|);
				var v43 := DC0(v35.f14);
			...
			if (f7) {
				...
				var v53: array<int> := new int[17] [v0, v0, -0x3e5, |v51|, |v52| / v0, -|v51|, v0, if (v1[v0]) then v0 else v0, |v26| % v0, -|v51| / 802, -0xc4, v0, v0, v0, v0, |v51|, v0];
				v53[716] := v0;
				v53[716] := v0;
				var v54 := DC4(f7, f7);
				var v55 := DC6(v54);
				...
				v1, v53, f7, v55 := v1[v0 := !v25[997]], v53, v0 >= |v57|, v55;
			}
			...
			var v64 := new C0(v0 < v0, (seq(0x1e6, i4  => (v2))) == v63[v0]);
			f7 := true;
			v64.f13 := v64.f13;
		...
		var v66: seq<int> := [|(seq(999, i6  => (v0)))|];
		v65[579] := DC26(v66);
		var v67 := DC26(v66);
		var v68: map<int, seq<int>> := map[v0 := DC26(v66).cf45];
		var v69 := "msetw";
		v65[579] := v67.(cf45 := if (|v69| in v68) then v68[|v69|] else v66).(cf45 := seq(944, i7  => (v0)));
	}
	method m4(p0: int, p1: string, globalState: GlobalState) returns (r0: array<array<bool>>, r1: int, r2: bool, r3: int) {
		m5(globalState);
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			v13[380] := seq(0x123, i3  => ('h'));
			r1, v8[78], v10[542], v13[380] := -p0, p1[p0], f7, "fgnlwup";
			...
			var v18 := DC49(p0, v17, p0, v10[542]);
			r1 := v18.cf82;
		}
		...
		var v25: seq<string> := [seq(-0x37c, i4  => (v20))];
		var v26: map<bool, string> := map[f7 := seq(0xf4, i5  => (v20))];
		var v27: seq<seq<string>> := [([p1])[p0 := p1], v25, v25, [if (f7 in v26) then v26[f7] else seq(14, i6  => (v20)), p1]];
		var v28 := DC0(p0);
		var v29: seq<D0> := [v28, v28];
		...
		var v36: array<bool> := new bool[21] [f7, f7, f7, f7, v24.cf54, p1 !in ((v27[p0])[p0 := p1])[p0 := "eopjgc"], fm1(v29, p0, p0, globalState) || f7, !true, f7 <== f7, if (f7) then f7 else f7, f7, true, f7, f7, (seq(-0x14b, i7  => (p1))) <= v25, f7, v35.cf83, f7, v20 in p1, v20 !in (seq(564, i9  => (v20))), true];
		v36[473] := fm8(p0, globalState);
		var v37: map<int, bool> := map[p0 := !f7];
		v21, f7, v36[473], v19, f7 := v21 * (v21 + v21), |v22| > p0, if (p0 in v37) then v37[p0] else f7, v19, f7;
		r2 := v36[473];
	...
	method m5(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v9: map<char, map<bool, int>> := map[v6 := v8[v1]];
			var v10: seq<int> := [v1, v1];
			v9 := fm57("oqkrpxyi", v1, v10[v1], globalState);
			var v11 := "ivk";
		...
		for i1 := v1 to -0x386 {
			...
			var v18: map<int, array<int>> := map[|v15| := v17[fm0(globalState)]];
			var v19, v20 := m6(62 + i1, v18, v1, v1 < i1, globalState);
			var v21: seq<int> := [v1];
			var v23: array<bool> := new bool[11] [v0.f13, v20, false, v0.f13, v0.f12, v0.f12, (set v22 : int | v22 in v21 :: (v22 / |map[true := [110, |multiset{false}|, |[true, true]|]]|)) !! v19, f7, false, false, v0.f13];
			v23[700] := true;
			v1, v1, v23[700] := v1, |((v15 + v15) + v15)|, (-v1 / v1) < v1;
			if (f7) {
				v1 := v1;
				v1 := |v15|;
				...
				var v27: seq<bool> := [v23[700]];
				v0.f13 := DC49(fm0(globalState), v26, v1, v27[i1]).cf83;
				var v28: map<bool, int> := map[v23[700] := i1];
				...
				var v35: map<int, map<bool, map<bool, bool>>> := map[v16[776] := v34];
				var v36: map<int, bool> := map[i1 := v30.f9];
				v35 := v35[v1 / -|map[|v15| := v36]| := v34];
			}
	...
	method m6(p0: int, p1: map<int, array<int>>, p2: int, p3: bool, globalState: GlobalState) returns (r0: set<int>, r1: bool) {
		...
		v4[837] := if (fm8(-p0, globalState) in v9) then v9[fm8(-p0, globalState)] else v6[fm2(|v10|, f7, globalState) := f7];
		var i1 := 0;
		while (true)
			decreases 100 - i1
		{
...
class C8 {
	...
	method m1(p0: array<map<bool, int>>, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: int) {
		...
		match (if (v0) then v1 else DC4(v0, v0)) {
			case DC4(cf7, cf8) =>
				if (cf7) {
					...
					var v8: set<bool> := {cf7};
					var v9: array<multiset<int>> := new multiset<int>[29] [v5, if (true) then multiset(v6) else v5, v5, v5 + v5, v5, multiset(v6), v5 * multiset{f6}, v5, v5 * v5, v5 - v5, multiset{|multiset{cf7}|, f6, f6}, v5 * v5, v5, multiset(if (cf8) then seq(0xd7, i0  => (f6)) else seq(-510, i1  => (0x2ca))), multiset{f6} + v5, multiset{f6, f6}, fm7(cf8, v0, cf8, globalState), v5, (multiset{|v7|, f6})[f6 := --0x2a5], v5, v5 + multiset{f6}, multiset(v6), v5, fm7(v0, v0, cf7, globalState), v5, v5[|v8| := f6] * v5, fm7(v0, v0, v0, globalState), v5, multiset{f6, f6}];
					v9 := v9;
					...
					var v23: array<int> := new int[29] [0x165, f6 % f6, f6, fm0(globalState), |v16|, f6, f6, f6 - f6, f6, f6, -0x239 - f6, f6, 515, if (!v11.f12) then f6 else f6, f6, f6, |(seq(-0x34b, i2  => (v12)))|, f6, |v17|, f6 / |v18|, -f6, f6, f6, -|v11.fm17(f6, v0, globalState)|, f6, |v19| * -0x24b, |map[v21.cf89 := multiset(v22[f6 := f6])]|, f6, f6];
					var v24: seq<array<bool>> := [v14];
					v23[434] := |v24| * f6;
					v23[434] := ---(f6 + -563);
					var v25 := DC1(f6 - v23[434]);
				...
				var v35: map<seq<T0>, bool> := map[(v30 + v30[f6 := v29])[fm0(globalState) := v29] := v34[f6]];
				...
				if (!(v28 !in v41)) {
					...
					var v45 := DC2(v29.f7, v43[541], v44, v43[541]);
					...
					var v52: map<D0, int> := map[v31 := v43[541]];
					var v53 := DC9(f6 % -f6, --|[fm1([DC0(f6)], f6, v43[541], globalState)]|, v50, v43[541] < |map[v51 := v46]|, v52);
					var v54: map<int, int> := map[v43[541] := f6];
					v49, v53, r1 := v49, v53, if (v43[541] in v54) then v54[v43[541]] else v43[541];
					var v55: map<int, bool> := map[v43[541] := cf7];
					...
					var v61 := DC30(f6, v37.f9, fm21(if (v55 in v56) then v56[v55] else v37.fm8(v43[541], globalState), globalState), |v60|);
					...
					var v65: C2 := new C2(v27, v28, v34[f6]);
					v64[950] := v65;
					v64[950] := new C2(v27, v28, cf8);
					var v66: array<int> := new int[29](i4 => i4 % f6);
					var v67 := "xsi";
					v66[690] := -|v67|;
					var v68: map<string, bool> := map[v67 := v37.f9];
					var v69: multiset<int> := multiset{453 - f6, -f6, |v68|};
					r1, v66[690], v69 := f6, 0x39b, v69;
					...
					v70 := v70[f6 := |v74|];
					var v75: map<bool, int> := map[v37.f9 := v66[690]];
					v75 := v75;
			...
			case DC5(cf9, cf10, cf11) =>
				...
				var v88: array<int> := new int[26] [-691, f6, cf11 % f6, f6 / -0x6b, |(v80[f6 := v83] + v80)|, cf11, 0x4c - f6, cf11, f6, |v79|, |(v84 + v84)|, cf11, cf11, -|(multiset{v80, [v83, v83]})[v80 := f6]|, cf11, cf11, |(v80 + (if (f6 in v86) then v86[f6] else v80))|, |fm21(cf9, globalState)| + f6, |v80|, f6, f6, f6, |v80| % -cf11, |(v87 * v87)|, 0x3bd, cf11];
				v88[537] := -f6;
				v88[537] := f6;
				...
				var v96: seq<map<int, int>> := [map[-0x2e7 := v88[537]]];
				var v97: seq<multiset<int>> := [v87, v87[|v80| := |[!cf9]|]];
				v93 := v93[!(v95 > (multiset(v96))[map[|map[v88 := v77.f7]| := v88[537]] := |v97[0x10f]|]) := {v91, v91}];
			case DC3(cf6) =>
			...
			case DC6(cf12) =>
				...
				var v113 := DC33(DC30(0xab, fm1(v112, f6, f6, globalState), seq(0, i6  => (f6)), f6));
				var v114 := DC32(false);
				...
				v110[247] := v115;
				var v116 := DC57(v115);
				v0, v109, v110[247] := false, v109, v116.cf98;
				r3 := f6;
				var v117 := "ao";
				...
				match (v118) {
					case DC8(cf14, cf15) =>
						...
						var v124 := new C4(v123[f6], v0 <== false);
						v105.f7 := v0;
						cf14 := !v0 || cf14;
						var v125 := DC43(|"xnka"|);
						var v126 := DC44(v125);
					...
					case DC9(cf16, cf17, cf18, cf19, cf20) =>
						...
						r0, cf16, v131 := if (cf19) then v105.f7 else v132.cf109 != v133, cf17, (map v134 : int | v134 in v135 :: (v134 / cf16) := (!v105.f7)) + (v131 + fm45(cf17, f6, globalState));
					case DC7(cf13) =>
						...
						v137[695] := v0 !in v139;
						v137[121] := v105.f7;
						var v140: array<int> := new int[29](i7 => i7 / |v117|);
						v140[728] := 0xd;
						var v141: map<int, bool> := map[f6 := v105.f7];
						v138[849], r1, v137[695], v137[121], v140[728] := v137, f6, v0, if (f6 in v141) then v141[f6] else v0, -f6;
		...
		var v153: array<int> := new int[24] [|v143|, f6, fm5(globalState), f6, f6, |v144| * (if (f6 in v145) then v145[f6] else f6), -f6 + f6, f6, |v146|, f6, -f6 % f6, f6 * f6, f6, f6, f6, f6, if (v150 in v151) then v151[v150] else f6, f6, f6, f6, 0xb0, f6, |(fm6(v152.(cf0 := f6), globalState) + v144)|, -0x2ee];
		var v154: map<array<int>, int> := map[v153 := -f6];
		v153[456] := (if (v153 in v154) then v154[v153] else 0x29a) / f6;
		v153[456] := f6 / f6;
		r3 := 435;
		...
		for i8 := |map[v155 := v144]| to -0x1bb {
			...
			match (v158) {
				case DC35() =>
					m0(v153[456], f6 / v153[456], globalState);
					var v159: seq<D0> := [v152, v152];
					r0 := if (fm1(v159[i8 := v152.(cf0 := v153[456])], |v156|, v153[456], globalState)) then v0 else false;
					...
					var v164: seq<set<string>> := [set v163 : string | v163 in (seq(-0x3e2, i9  => (v144))) :: (v163)];
					var v165: map<bool, bool> := map[v150.f7 := v150.f7];
					v156 := v156 + fm50(v162, v164[i8], |v165|, globalState);
				case DC36(cf58, cf59, cf60) =>
					v147[746] := v0;
					v147[746] := v0;
					r3 := v153[456] / v153[456];
					v153[456] := f6 + v153[456];
					r3 := i8;
				case DC34(cf57) =>
					...
					v167[969] := v166;
					var v168: array<string> := new string[18] [v144, v144, v144, v144, v144, "oviiryq", v144, v144, if (!false) then seq(0x184, i10  => (v149)) else v144, v144, "bwnc", v144, v144, v144, v144[i8 := v149], v144, v144, v144];
					v168[878] := v144;
					...
					var v175 := DC58(v153[456]);
					var v176: array<D2> := new D2[22];
					var v177: C4 := new C4(v176, v0);
					var v178: map<bool, C4> := map[v166.f7 := v177];
					v167[969], v149, v168[878], r2, v153[456] := v169[f6], if ((if (v175.cf99 in v174) then v174[v175.cf99] else map[|map[f6 := v178]| := v171]) in v173) then v173[if (v175.cf99 in v174) then v174[v175.cf99] else map[|map[f6 := v178]| := v171]] else fm13(v150.f7, |v144|, v0, globalState), v144, -v153[456] == v153[456], f6 - v153[456];
					v150 := v150;
					v1 := v1;
					r3 := f6;
				case DC37(cf61) =>
					...
					v180[949] := v153;
					v147[877] := 0x182 != v153[456];
					v179, v149, r2, v180[949], v147[877] := v179, v144[|v144|], v0, v153, v150.f7;
					...
					var v183 := DC61(v182);
					var v184: C5 := new C5(v147[877]);
					var v185: C4 := new C4(v182, v150.f7);
					v145, v150.f7, v183, v184, v185 := v145[i8 := -v153[456] % f6], false, DC61(v185.f11), v184, v185;
					v153[456] := -v153[456];
			}
			...
			if (v187.fm8(if (v150.f7) then f6 else 0x187, globalState)) {
				...
				v143 := ((v143 + [f6, v153[456], f6, |v143|, v153[456]]) + v143)[v153[456] := f6];
				var v190: map<bool, bool> := map[v150.f7 := v0];
				var v191 := DC53(v190);
				var v192: multiset<seq<int>> := multiset{fm21(v150.f7, globalState), seq(0xe, i12  => (0x2b1))};
				r3, r3, v191, r1, v150.f7 := v153[456], |v144| / v153[456], v191, |(fm61(v153[456], false, globalState) * v192)|, v150.f7;
				m0(v153[456], -i8, globalState);
				var v194: array<map<string, char>> := new map<string, char>[26](i13 => (map v193 : string | v193 in [v144] :: (v193) := (v149)) + map[seq(-365, i14  => (if (f6 in v188) then v188[f6] else v149)) := v149]);
				var v195: map<string, char> := map["plrvjxso" := v149];
				v194[865] := v195;
				var v197: multiset<string> := multiset{v144, v144};
				v194[865] := if (!!v150.f7) then v195 else map v196 : string | v196 in v197 :: (v196) := (v149);
			} else {
				r3 := v143[i8];
				var v198: seq<seq<bool>> := [fm50(fm30(v147[530], f6, v147[530], globalState), fm62(v150.f7, v153[456], globalState), i8, globalState)];
				v198 := fm41(v150.f7, globalState);
				r3 := --i8;
				v145 := v145[v153[456] := -(f6 % --|v146|)];
				var v199 := new C5(v0);
			}
		...
		if (match if (true) then v201 else v201 {
			...
			if (v202.cf30) {
				v150.f7 := v150.f7;
				var v203: C2 := new C2({v147, v147, v147, v147}, v149, |v143| < v153[456]);
				v203 := v203;
				var v204: multiset<char> := multiset{v144[-v153[456]]};
				var v205: multiset<multiset<char>> := multiset{v204};
				var v206: seq<multiset<multiset<char>>> := [v205];
				v205 := v206[v153[456]] * v205;
				r1 := v153[456] * (|"tin"| - v153[456]);
				var v207: map<int, char> := map[(if (!v150.f7 in v146) then v146[!v150.f7] else fm0(globalState)) / f6 := v203.f16];
				v207 := v207[f6 := v149];
			} else {
				var v208: array<seq<int>> := new seq<int>[6](i15 => seq(0x3c6, i16  => (v153[456])));
				v208[488] := seq(746, i17  => (DC17(v150.f7, f6, v149, v149).cf32));
				var v209: set<int> := {756 / -|v143|, v153[456]};
				var v210: seq<seq<int>> := [v143];
				v208[488], v209 := v210[|v144|] + ([-0x105, f6] + v143), (v209 * v209) - v209;
				var v211: array<D2> := new D2[5](i18 => DC7(v209));
				var v212: C4 := new C4(v211, v0);
				v212 := v212;
				v147[306] := if (v0) then v150.f7 else v150.f7;
				v147[306] := v150.f7;
			...
			if (f6 >= (f6 % f6)) {
				...
				r3, v147[996], v216[459], v153[456], r0 := f6, v217 !! multiset{v149, 'n', v149}, if (v150.f7) then v149 else v149, fm0(globalState), !(v218 < v218);
				r2 := true;
				var v219, v220 := v150.m2(v147[996], f6, v216[459] !in v144, globalState);
				v153[456] := v153[456];
				var v221 := new C2(v148, v149, v150.f7);
			} else {
				v147 := v147;
				var v222: array<string> := new string[6] [v144 + v144, v144, v144 + v144, v144, v144, "wc"];
				v222[702] := v144 + "pbrvad";
				v222[702], v150, r3, r2, v150.f7 := fm6(v152, globalState) + v144, v150, |v144| % |v145[f6 := v153[456]]|, !!(|v143| <= f6), v0;
				v150.f7 := v0;
				v153[456], v149 := f6, v149;
				v153[456] := -f6;
			}
			
			var v223: map<bool, bool> := map[false := v150.f7];
			v147[700] := if (v150.f7 in v223) then v223[v150.f7] else v0;
			v147[700] := v0 <== v150.f7;
		} else {
			r3 := f6;
			v153[456] := (f6 / fm5(globalState)) + fm0(globalState);
			var v224: multiset<seq<int>> := multiset{seq(0x29c, i19  => (f6))};
			v153[456] := f6 % |v224|;
			var v225 := DC59(v147, v144[|v144| := v149], v153, true);
			var v226: seq<D21> := [v225, v225];
			v153[456], v150.f7 := -(f6 % |v144|), v226 < ([v225] + v226);
			var v227 := DC24();
			v227 := v227;
		}
		
		var v228: map<bool, bool> := map[v0 := v150.f7];
		v228 := v228[v0 := v153[456] < f6];
...
method Main() {
	...
	var v2 := true;
	var v3: seq<bool> := [v2];
	var v4: multiset<bool> := multiset{true, v3[v0]};
	...
	if (v2) {
		...
		if (false) {
			...
			v0 := v0 / v0;
			var v12 := "h";
			var v13: set<bool> := {v3[v0]};
			var v14 := 'w';
			var v15: set<char> := {v14};
			var v16: set<int> := {v0, v0};
			var v17: map<set<int>, bool> := map[v16 := v2];
			var v18: array<bool> := new bool[20] [v2, v2, v0 >= v0, v12 != v12, !(v2 && v2), v2, {v2} == v13, true, v13 < v13, v2, !fm1([DC0(v0)], |(seq(0x3cd, i1  => ('s')))|, |v6|, globalState), v2 in v4, v2, v0 > v0, v2, v13 > {v2, false}, v15 > v15, v2 && v2, !(fm2(v0, v2, globalState) in v17), v2];
			v18 := v18;
		} else {
			...
			v21[967] := v22;
			v2, v0, v21[967] := v2, -v0, v22;
			var v23 := "bdayhkro";
			v23 := v23 + (seq(0x2be, i2  => (v19[404])));
		...
		var v27: array<bool> := new bool[28] [v2, !v2, fm1(v25, v0, v0, globalState), v2, v2, v2, v2, v2, v2, v2, v2, !v2, v2, v3[v0], v2, v2, v2, v2, v2, fm1(v25, |v26|, v0, globalState), v2, v2, v2, false, v2, v2, v2, v2];
		var v28 := "mre";
		...
		var v35 := 't';
		v34 := v34[[v28[v0 := v35], seq(-0x28b, i3  => (v35))] := v2];
		v27 := new bool[9] [v2, v4 > v4, (seq(0xde, i4  => (v0))) < [|(seq(958, i5  => (v35)))|], v0 <= -0x2b9, v2, !v2, v2, v0 < |v28|, v2];
	}
	...
	for i6 := v0 to |v36| {
		...
		if (v2) {
			...
			v38 := v38 + v38;
			v2 := v37[505];
			m0(i6, |(map v39 : seq<int> | v39 in fm4(i6, globalState) :: (v39) := (v37[505]))| * 0x28a, globalState);
		} else {
			var v40 := DC0(i6);
			var v41: seq<D0> := [v40, DC0(i6).(cf0 := i6), v40, v40];
			var v42: seq<int> := [|(seq(633, i8  => (v0)))|, i6];
			v2 := fm1(v41 + v41, i6, |(v42 + v42)|, globalState);
			var v43 := "mb";
			v43 := v43;
			m0(v0, v42[v0], globalState);
			v0 := v0;
		...
		if (true) {
			...
			v48[152] := v0 <= i6;
			v0 := v0;
			var v49: array<int> := new int[12](i9 => i9 * |map[v48[152] := true]|);
			v49[383] := 0x21f;
			v49[383] := -i6 / (i6 + v0);
			var v50: seq<array<int>> := [v49];
	...
	if (if (v61 in v62) then v62[v61] else v63 > v63) {
		...
		var v71 := DC2(v69.cf2, v0, v70[v0], v0);
		v66 := v66[!v71.cf2 := v4];
		...
		var v76 := 'g';
		var v77 := new C2(DC21(v0, v74, |v75|).cf39, v76, v64[870]);
	} else {
		var v78: array<bool> := new bool[13](i11 => v2);
		v78[962] := v2;
		var v79 := "nkcb";
		var v80: seq<string> := [v79, seq(0x1ee, i12  => ('w'))];
		v78[962] := v80[v0] <= v79;
		m0(v0, v0, globalState);
		var v81: map<bool, bool> := map[v2 := v2];
		var v82: seq<D0> := [DC0(v0)];
		v81 := v81[v2 := fm1(v82, v0, -v0, globalState) ==> v78[962]];
		var v83: map<bool, int> := map[v78[962] := v0];
		var v84: array<int> := new int[19](i13 => i13 / v0);
		var v85 := DC34(map[v84 := fm2(540, v2, globalState)]);
		var v86: seq<D13> := [v85];
		var v87 := DC49(|v83|, v86, |v83|, v2);
		v87 := v87;
		var v88 := DC16(v78[962]);
	...
	if (v2) {
		...
		var v92: seq<C1> := [v91];
		var v93: array<C1> := new C1[27] [v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v92[v0], v91, v92[v0], v91, v91, v91, v91, v91, v91, v91, v91];
		...
		var v99: array<map<array<C1>, bool>> := new map<array<C1>, bool>[25] [v94, v94, v94, v94, (map[v93 := v2])[v95[v0] := v2], map[v93 := if (DC9(|v36|, 94, v90, v2, v96) in v98) then v98[DC9(|v36|, 94, v90, v2, v96)] else v2], if (v2) then v94 else v94, v94, map[v93 := v2], v94, v94, v94 + v94, map[v93 := v3[v0]], map[v93 := v2], v94, (map[v93 := false])[v93 := v2], v94[DC67(v93).cf116 := v2], v94, v94, map[v93 := v2], v94, v94, v94, v94, v94];
		v99[147] := v94;
		var v100 := DC67(v93);
		v99[147] := v94[v100.cf116 := v2];
		var v101: array<int> := new int[20](i14 => i14 + |v90|);
		v101 := v101;
		var v102: map<bool, array<C1>> := map[v3[v0] := v93];
		var v103 := DC62(!v2, v0);
		var v104: array<array<C1>> := new array<C1>[26] [v93, v93, v93, v93, v93, v93, v93, v93, v93, v93, v93, v95[v0], v93, v93, v93, v93, v93, if (v2) then v93 else v93, v100.cf116, v93, v93, v93, v93, v93, v93, if (v103.cf106 in v102) then v102[v103.cf106] else v93];
		v104[898] := if (v2) then v93 else v93;
		...
		v104[898], v106, v108[921], v109 := v93, v106, fm63(v115[v0 := v0], (v117.(cf118 := v2)).cf118, v2, globalState), v109;
		v0 := v0 / v115[0x13f];
	} else {
		m0(v0, v0, globalState);
		...
		var v120: seq<int> := [v0];
		var v121: array<int> := new int[2] [v120[-v0], |v120|];
		v121[729] := v0;
		v121[729] := if (v3[v0]) then |v90| else v0;
	}
	...
	if (v134 < v134) {
		...
		if ((if (v2) then v123.f13 else v130[708]) || v123.f13) {
			...
			var v144: T0 := new C4(v143, !v130[708]);
			var v145: seq<map<T0, bool>> := [map[v144 := v144.f7]];
			v0, v0, v140[765], v123.f13 := |("sqlveg" + (v90 + v90))|, v142.cf70 % -|(v145 + v145)|, v141, v123.f12;
			v0 := -v0;
			v2 := v2 || (v0 > v0);
			var v146 := 'v';
		...
		v130[708] := fm1(v147, |v152| % v0, 0x35d - v0, globalState);
		...
		v123.f13, v130[941] := !(v0 != (if (v123.f13) then v0 else v0)), v156 > {v130};
		v3 := v3[|"ivahwxl"| := v130[941]];
		if ((v90 + v90) <= (v90 + v90)) {
			v0, v2, v90 := -(-v0 + v0), v123.f13, (seq(0x304, i19  => ('f'))) + (v90 + v90);
			...
			var v161: array<bool> := new bool[10](i20 => if (v3[v0]) then v130[941] else v123.f12);
			...
			var v172: array<array<T1>> := new array<T1>[28] [v167, v167, v167, v167, v167, v167, v167, v168[if ((if (v155.f9 in v171) then v171[v155.f9] else v169) in v170) then v170[if (v155.f9 in v171) then v171[v155.f9] else v169] else -0x10], v167, v167, v168[if (v0 in v162) then v162[v0] else v0], if (v123.f12) then v167 else v167, v167, v167, v167, if (v155.f9) then v167 else v167, v167, v167, v167, v167, v167, v167, v167, if (v155.f9) then v167 else v167, v167, v167, v167, v167];
			v172[785] := v167;
			var v174: set<int> := {0x30, v0};
			var v177 := 'x';
			var v178: map<T1, int> := map[v166 := |DC70(map v175 : char | v175 in (map v176 : char | v176 in v90[|v3| := v177] :: (v176) := (v123.f12)) :: (v175) := (v0)).cf125|];
			v0, v164, v172[785], v123.f13 := v0 - v0, (v164 + (map v173 : int | v173 in v174 :: (v173 - v0) := (DC35())))[|v126| := v163], v167, v166 !in (v178 + v178);
		} else {
			v133 := (v133 - v133) - v133;
			...
			var v182 := DC73(v181);
			var v183 := 'r';
			var v184: C2 := new C2(v156, v183, v130[941]);
			var v185: map<C5, C2> := map[v182.cf129 := v184];
			v180[715] := if (v181 in v185) then v185[v181] else v184;
			v179, v130[941], v0, v180[715] := v179, false, v0, v184;
			v131[250] := |v90|;
			var v186: map<int, int> := map[v0 := v0];
			v131[250] := |(v186 + v186)|;
			var v187 := DC43(|v90[v155.fm12(v123.f12, v0, |v126|, v123.f12, globalState) := v184.f16]|);
			v131[250], v131[250], v131[250], v123.f13, v131[250] := v0, v131[250] - v131[250], v187.cf70, !v155.f9, fm0(globalState);
			var v188 := DC35();
			v188 := v188;
		}
	...
	v123.f13 := ((if (v0 in v190) then v190[v0] else "tjbvvw") + "gwgsuo") <= (seq(0x27c, i22  => ('u')));
	v131[514] := v0;
	v131[514] := v0;
	...
	v191 := v191;
	v90, v36, v131 := seq(0x30d, i23  => (if (v123.f12) then 'k' else 'x')), multiset(v127 + v127), v131;
}