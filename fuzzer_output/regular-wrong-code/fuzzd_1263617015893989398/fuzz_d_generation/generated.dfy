...
function fm4(p0: bool, globalState: GlobalState): set<int> {
	(set v1 : int | v1 in {0x137, 0x1cd, |[|(map v0 : int | v0 in multiset{|[512]|} :: (v0 / |"cpviudyfg"|) := (446))|]|, -|map[-299 := false]|} :: (v1 * |[|[false, false]|]|)) * ({0x279, |map['n' := true]|} * (set v2 : int | (0x17d <= v2) && (v2 < 334) :: (v2 + |map[map[0x18e := false] := false]|)))
}
...
function fm6(p0: seq<int>, p1: int, p2: int, globalState: GlobalState): multiset<int> {
	if (|(seq(15, i0  => ('f')))| < 0x361) then multiset{0xe9} else multiset{0x121}
}
...
function fm9(p0: bool, p1: int, p2: seq<int>, p3: map<string, bool>, globalState: GlobalState): multiset<char> {
	multiset(seq(0x335, i0  => ('x'))) + multiset{'e', 'm'}
}
function fm10(globalState: GlobalState): map<string, bool> {
	match if (!false) then DC15(0x197, false, |[false, false]|) else DC15(--917, false, 0x2f5) {
		...
		case DC15(cf26, cf27, cf28) => map[seq(0xb7, i0  => ('d')) := cf27] + (map v0 : string | v0 in map["enjjy" := 'e'] :: (v0) := (cf27))
...
function fm13(globalState: GlobalState): seq<int> {
	match if (false) then DC27(false, 154) else DC27(false, 85) {
		...
		case DC26(cf44) => [|multiset{!true}|] + (seq(-351, i0  => (-0x15a)))
	}
}
function fm14(p0: bool, p1: string, globalState: GlobalState): map<int, bool> {
	map[0x5b * 417 := |[|['p']|]| >= |(map v0 : int | v0 in [|map[0x155 := -0xf0]|, |"fwkthi"|] :: (v0 * |(seq(-881, i0  => (0x57)))|) := (0x208))|]
}
...
function fm16(p0: char, p1: int, p2: int, p3: int, globalState: GlobalState): seq<string> {
	(["hfqueonrf", seq(258, i0  => ('x'))] + ["yayviyc"]) + (seq(616, i1  => ("ocnyb")))
}
function fm17(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): map<bool, int> {
	map[false := |[true]|] + map[!false := -|(map v0 : int | (0x252 <= v0) && (v0 < 946) :: (v0 % -0x159) := (331))|]
}
function fm18(p0: multiset<bool>, p1: D8, p2: bool, globalState: GlobalState): int {
	(|{|map[true := true]|, 0x5d}| / 0x189) * |(map[DC25(|[false]|, !!!false).cf43 := true] + map[false := !true])|
}
...
function fm20(p0: int, globalState: GlobalState): map<char, int> {
	match DC25(-|[0x2d0, -331, |(seq(0x250, i0  => ('f')))|, --0x134]|, true) {
		case DC25(cf42, cf43) => map['n' := |{seq(-0xbe, i1  => (cf42)), [cf42, cf42, cf42], [cf42, cf42, --|[cf42]|, cf42, cf42]}|]
...
function fm24(p0: bool, globalState: GlobalState): seq<set<int>> {
	if (false !in map[!!!false := 0x1a4]) then [{-|"ggcg"|}, {836, 0xbc}] + [set v0 : int | (0x189 <= v0) && (v0 < 0x132) :: (v0 * |(seq(0x2cc, i0  => (--0x96)))|)] else [{-234}] + (seq(0x319, i1  => ({512})))
}
function fm25(globalState: GlobalState): D3 {
	DC3(["koggtmo"])
}
function fm26(globalState: GlobalState): map<set<int>, string> {
	if (multiset([true]) != multiset{!true}) then if (true) then map[set v1 : int | v1 in (map v0 : int | (571 <= v0) && (v0 < -350) :: (v0 * 0x116) := (|[|map[true := true]|]|)) :: (v1 / |[0x14f]|) := "esyx"] else map[{|multiset{true}|} := seq(0x149, i0  => ('p'))] else map[{0x8e} := "kraaoyc"] + map[{957} := seq(0x2a0, i1  => ('p'))]
}
...
method m0(globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: int) {
	...
	for i0 := v0 to 0x136 {
		...
		v4, r0, globalState.f5, globalState.f5, globalState.f8 := v4, -(v0 * |v6|) - i0, v3, v3, if (v5 in v7) then v7[v5] else i0 / i0;
		r1 := v3;
		globalState.f8 := v0;
	}
	var v8 := true;
	...
	v9[482] := (if (v8 in v11) then v11[v8] else v0) + |v14|;
	...
	var v20: set<bool> := {v8};
	v15, v19, globalState.f8, v0 := v15, v19, (|v20| - |fm13(globalState)|) % (v0 / v9[482]), (818 * v0) + v0;
	var v21: array<string> := new string[6];
	v21[495] := fm1(globalState);
	v21[495] := v16;
	var v22 := new C3(v9);
	r0 := v0 * -0x28b;
	var v23 := DC16(v21[495]);
	r1 := v23.cf29 <= v16;
	r2 := true;
	r3 := v0 - v9[482];
}
...
class C1 extends T0 {
	...
	method m1(globalState: GlobalState) {
		...
		var v5: multiset<bool> := multiset{v1, v2[|v4|]};
		var v6 := 'f';
	...
	method m2(globalState: GlobalState) {
		...
		if (v2 < (v2 + v2)) {
			...
			var v4 := -0xf3;
			var v5: seq<int> := [v4];
			var v6: map<char, int> := map[v3 := v5[v4]];
			v6 := fm20(v4, globalState);
			var v7: array<int> := new int[29](i0 => i0 % v4);
			v7[870] := v4;
			var v8: map<int, int> := map[v4 := v4];
			var v9 := DC14(v4, v0, v0, v0, v4);
			v4, v7[870], globalState.f23 := (if (v4 in v8) then v8[v4] else v9.cf25) * v4, v4, v7;
			...
			var v15: map<bool, array<bool>> := map[v0 := v14[0x5d]];
			var v16: array<array<bool>> := new array<bool>[20] [v12, v12, v12, v12, v12, v13.cf2, v12, v12, v12, v12, v12, if (v0 in v15) then v15[v0] else v12, v12, v12, v12, v12, v12, v14[v4], v12, v12];
			var v17 := DC9(v16);
			...
			var v22 := DC17(v3, v3, v7[870]);
			var v23: map<map<bool, int>, bool> := map[v19 + v19 := (if (v0 in v21) then v21[v0] else v20) !! v20[v0 := fm18(multiset(v1), v22, v0, globalState)]];
			v23 := v23[if (!v0) then v19 else v19 := v0];
		} else {
			var v25: array<int> := new int[13](i1 => i1 % |(map v24 : int | v24 in (seq(0x2a1, i2  => (|{seq(149, i3  => ('i')), "buof"}|))) :: (v24 * -364) := ("u"))|);
			var v26 := 0x245;
			v25[503] := v26;
			v25[503] := v26 + -v26;
			globalState.f19 := v0;
			var v27 := "wxrqlhdfx";
			var v28: map<int, string> := map[v25[503] := v27];
			v28 := v28[v26 := v27];
		...
		var v47: seq<int> := [|v46|];
		var v48: array<bool> := new bool[27] [false, {v33.f27, v33.f27, v33.f27, v33.f27} != v38, !v0, v31.f27, fm0(v1, globalState), v33.f27, |v41| < v34, v0, v42 == v42, v0, v0, (map v43 : int | v43 in v44 :: (v43 % v34) := (v34)) == v45, v1[|v47|], !v31.f27, v31.f27, v33.f27, v33.f27, v31.f27, v33.f27, v0, v33.f27, v0, v31.f27, v33.f27, if (v31.f27) then v31.f27 else v31.f27, v31.f27, v0];
		v48[380] := v33.f27;
		var v49 := 'o';
		...
		match (v50) {
			case DC17(cf30, cf31, cf32) =>
				...
				if (v33.f27) {
					...
					var v69: array<int> := new int[22] [v64, |(if (v65.cf27) then v42 else v42)|, v61, v57, v34, v64, v64 % v54, v61, v61, cf32, v54 - v64, v64, |v45|, v57, if (v33.f27) then |v39| else 0x38d, v54, |v68[0x1bb]|, if (v0) then v61 else fm18(v46, DC17(cf30, v49, 435), true, globalState), cf32, v61, 226, v54];
					v66[651] := v61;
					globalState.f22, v66[651] := v64 >= v61, (|v51| / (if (cf32 in v45) then v45[cf32] else v57)) / (-v34 * fm18(v46, v50, v31.f27, globalState));
					v61 := -v54;
				} else {
					globalState.f5 := !(multiset{v31.f27, v1[v57], v33.f27, v48[380], v31.f27} !! (v46 * v46));
					var v70: multiset<map<bool, int>> := multiset{v52};
					v34 := -(if (v31.f27) then |(multiset([v52, v52, v52, v52, v52]) + v70)| else cf32);
					v34 := -796 % (v34 + v54);
					v52 := v52[v33.f27 := v54 % |v52|];
					var v71: array<array<bool>> := new array<bool>[2] [v48, v48];
					v71[58] := v48;
					v48[380], v71[58], globalState.f22, v0 := v1[v34], v48, !v31.f27, v55;
				}
			...
			case DC16(cf29) =>
				...
				if ((if (|v1| in v44) then v44[|v1|] else |fm23(v31.f27, v34, v0, globalState)|) != v34) {
					globalState.f8 := if ((v34 - v34) in v45) then v45[v34 - v34] else |(map[v33.f27 := |"rclqacbxk"|] + map[!v48[380] := v34])|;
					v39 := cf29;
					var v73: multiset<array<bool>> := multiset{v48};
					v73 := v73;
					var v74: array<D8> := new D8[19];
					var v75: seq<array<D8>> := [v74, v74];
					var v76: multiset<array<D8>> := multiset{v75[v34]};
					var v77: map<multiset<array<D8>>, int> := map[v76 + v76 := -(v34 % v34)];
					v77 := v77[v76 * multiset{v74, v74, v74} := if (v31.f27 in v46) then v46[v31.f27] else |(multiset(fm24(v33.f27, globalState)))[set v78 : int | (905 <= v78) && (v78 < 0x5) :: (v78 + v34) := v34]|];
					var v79: array<C0> := new C0[26];
					v79[71] := v33;
					var v80: array<int> := new int[26](i4 => i4 % v34);
					var v81: seq<array<int>> := [v80];
					v79[71] := new C0(v81 == v81);
				} else {
				...
				globalState.f17 := v1[v34];
				v1, globalState.f8 := v1, -|v51|;
			case DC18(cf33) =>
				v48 := v48;
				var v87: array<string> := new string[2];
				var v88: map<C0, T1> := map[v31 := f29];
				var v89: array<int> := new int[15] [v34, 0x40, v34, -v34, v34, v34, -|(v1 + v1)|, v34, -(v34 / v34), -0x3d7 * |v88|, v34, v34, v34 / v34, v34, |v45|];
				globalState.f8, globalState.f23, v87 := v34, v89, v87;
				v89[896] := v34 * v34;
				v89[896] := fm18(v46, v50, v0, globalState) + -0x311;
				v39 := v39;
		}
		
		v48[380] := !fm0(v1, globalState);
	}
}
...
class C2 extends T0 {
	...
	method m1(globalState: GlobalState) {
		...
		if (v3.cf4 >= -v0) {
			...
			var v17: array<int> := new int[4] [-0x1f6, --(v0 / |(if (true in v15) then v15[true] else v4)|), 124, |(if (v2) then map[v2 := multiset{v2}] else v16)|];
			v17[71] := v0;
			v17[71] := v0 / v0;
			...
			v21 := v21[DC5(v19) := v1 < [|(seq(0x2d8, i0  => (v0)))|, v0]];
			var v22: set<int> := {v0};
			var v23 := DC6(v22);
			...
			var v33: array<set<int>> := new set<int>[25] [{v0}, v22, v22, v23.cf8, {|v27|, v0, v0}, set v28 : int | (983 <= v28) && (v28 < 0x2ab) :: (v28 * v0), v22, {|(seq(0x16, i1  => ('l')))|, v0}, v22, v22, v22, v22, v22, v22, v22, {0x10b, |multiset(v1)|, fm5(globalState), |v29|, v0}, set v31 : int | v31 in fm6(v1, |v30|, 655, globalState) :: (v31 / |[true]|), v22, v22, v22, {|v32|}, v22, v22, v22, {v0}];
			...
			if (v2 <== v24.f27) {
				...
				v57[435] := v26;
				v48, v57[435], v25, v24 := v48, v26, v25[v0 := fm8(globalState)], v24;
		...
		if (v2) {
			...
			v62[863][603] := v0;
			globalState.f5 := v2;
			v62[863][603] := v62[863][603];
			var v72 := "xm";
			var v73: map<int, string> := map[|fm13(globalState)| := v72 + ("nbgsu")[v62[863][603] := 't']];
			v73 := v73[v62[863][603] := v72 + v72];
		} else {
			...
			var v78: set<int> := {-v0};
			var v79: map<bool, seq<map<int, bool>>> := map[false := [map v77 : int | v77 in v78 :: (v77 / v0) := (DC8('x', v2, v2).cf14)]];
			var v80: multiset<bool> := multiset{true, v2};
			v76, globalState.f22, globalState.f19, v0 := v76 + ((if ((if (|v75| in v74) then v74[|v75|] else v2) in v79) then v79[if (|v75| in v74) then v74[|v75|] else v2] else v76[|v80| := v74]) + [map[|v75| := v2]]), v2, v0 > |v75|, |(seq(0x28c, i5  => (v0)))|;
	...
	method m2(globalState: GlobalState) {
		...
		var v10: array<int> := new int[29] [v2, |v4|, v2, v2, v2, v2, v2, v2, v2, v2, v2, |[v5]|, -|"dauxjhvs"|, 0x67, |{v6}|, v2, 0x126, 0x3be, 0x3de, |v8|, -v2, v2, fm5(globalState), |v9|, v2, |v0|, |[v2, v9[v2], |v0|, v2]|, v2, v2];
		var v11: seq<array<int>> := [v5];
		var v12 := DC1(v2);
		var v13: map<D1, char> := map[v12 := v6];
		var i0 := 0;
		while (([v10, v11[|v13|], v5, v10] + v11) <= (v11 + v11))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v26, v2, v6, v27[551] := v26 * v26, |(seq(0x2e8, i2  => (v2 - v2)))|, v6, v29.cf11;
			v2 := v2;
		...
		match (v1) {
			case DC17(cf30, cf31, cf32) =>
				...
				var v31: array<seq<string>> := new seq<string>[16] [v30 + v30, v30, v30, v30 + fm16(cf31, v2, 526, cf32, globalState), seq(878, i3  => (v0)), v30, v30, v30, ["sf", v0] + v30, v30, v30, v30 + v30, [v0] + v30, seq(102, i4  => (v0)), v30, v30];
				v31[976] := v30;
				v31[976] := ((if (v3) then seq(0xe7, i5  => (v0)) else v30) + (v30 + [v0, v0, v0, v0]))[-cf32 % cf32 := v0 + v0];
				...
				var v38: map<bool, seq<array<int>>> := map[v3 := ([v10])[v2 := v5]];
				...
				v2 := 0x121;
			case DC16(cf29) =>
				var v43: array<seq<char>> := new seq<char>[2] [seq(0x1ac, i6  => (v6)), if (v3) then cf29 else v0];
				v43[950] := v0;
				v2, v2, globalState.f17, v43[950] := v2 - |(seq(0x3a8, i7  => (cf29[v2])))|, v2 % fm5(globalState), !v3, (cf29 + cf29) + v0;
		...
		for i8 := v9[v2] to |v7| {
			...
			v53, globalState.f8, globalState.f8 := v53, (0x149 / v2) + i8, i8;
			var v54 := DC15(|v4|, v3, v2);
			match (v54.(cf28 := |v0| % 422)) {
				case DC14(cf21, cf22, cf23, cf24, cf25) =>
					...
					v56[674], v0, globalState.f8 := v6, v0 + "o", if (v57 > v57) then -i8 else i8;
				case DC15(cf26, cf27, cf28) =>
					v10[790] := i8;
					v10[790] := v2;
					var v58 := DC11(v3);
					var v59: array<bool> := new bool[20] [v3, 0x17f == -cf28, true || v3, v3, v3, false, v58.cf18, v3, !(false && v3), cf27, !cf27, cf26 <= fm5(globalState), DC11(cf27).cf18, v3, cf27, v8 !! (multiset{-cf26, cf28})[v10[790] := i8], cf27, v3, multiset{0xa8} !! v8, v3];
					v59[610] := v3;
					v59[610] := cf27;
					var v60: map<bool, set<int>> := map[v9[v10[790]] in v9 := v49 - v49];
					var v61: seq<set<int>> := [v49];
					v60 := v60[v6 !in v0 := v61[|v48[964][i8 := v59[610]]|] - (set v62 : int | (-0x121 <= v62) && (v62 < 0x28d) :: (v62 % v2))];
					v10[790] := -i8;
				case DC13(cf20) =>
			...
			v66[125] := v67;
			v65, v66[125] := v65, v67[fm5(globalState) := i8];
		}
		match (DC8(v6, v3, v3)) {
			case DC7(cf9, cf10, cf11, cf12) =>
				...
				globalState.f17 := v70 != (v70 + v70)[cf12 := v69];
				...
				var v77: map<map<array<int>, set<int>>, int> := map[v75 := |([-cf9, -|v0|, |v76|, cf12] + (seq(687, i10  => (-cf9))))|];
				v10[123] := if (v75 in v77) then v77[v75] else v2;
			case DC8(cf13, cf14, cf15) =>
				var v78: array<bool> := new bool[4];
				v78[991] := v3;
				v78[991] := v3;
				globalState.f19 := v78[991];
				...
				match (v79) {
					...
					case DC10(cf17) =>
						v2 := v2;
						cf14, globalState.f8 := v78[991], v2;
						v9 := v9;
			...
			case DC6(cf8) =>
				...
				if (v89 <= v89) {
					...
					var v92: array<array<D7>> := new array<D7>[29] [v90, v90, v90, v91[v2], v90, v90, if (v3) then v90 else v90, v90, v90, v90, v90, v90, v90, v91[v2], v90, v90, v90, v90, v90, v90, v90, v90, v90, v90, v90, v90, v90, v90, v90];
					v92[5] := v90;
					v92[5] := v90;
					var v93: seq<string> := [v0];
					var v94: map<set<int>, string> := map[{|v0|} := v93[v2]];
					var v95: T1 := new C0(true);
					var v96: T0 := new C1(v94, v95);
					v96 := v96;
					var v97: map<bool, int> := map[!(fm0(v7, globalState) || v3) := v9[v2]];
					globalState.f17, v97, globalState.f5 := v3, v97, (v8 * v8) >= v8;
					globalState.f8 := |((v11 + v11) + (if (v3) then v11[|v4| := v10] else v11))|;
					v9 := v9;
				} else {
	...
	method m5(p0: bool, globalState: GlobalState) returns (r0: int, r1: array<map<bool, char>>, r2: bool) {
		...
		var v1: array<bool> := new bool[12](i1 => map["rgdrpsk" := 107] == map[seq(124, i2  => ('k')) := -|map[0x3ad := p0]|]);
		...
		var v4 := 0x316;
		for i4 := v4 to |[v3[58]]| * v4 {
			var v5: set<char> := {v2};
			v5 := v5;
			var v6 := DC15(-(v4 % v4), p0, i4);
			match (v6) {
				case DC14(cf21, cf22, cf23, cf24, cf25) =>
					...
					var v12 := DC21(v10);
					var v13: map<char, bool> := map[v3[58] := cf23];
					var v14: multiset<int> := multiset{906};
					var v15: map<int, map<bool, bool>> := map[|v14| := v10];
					var v16: array<map<bool, bool>> := new map<bool, bool>[13] [v11[cf25], v10, v10, (v12.(cf37 := map[p0 := if (v3[58] in v13) then v13[v3[58]] else v8.f27])).cf37[p0 := cf23], v10, v10, v10, if (cf21 in v15) then v15[cf21] else v10, v10, v10, v10, v10, if (fm0(v0, globalState)) then v12.cf37 else v10];
					v16[180] := map[true := cf23];
					v16[180] := (v10[cf24 := cf22] + v10) + (map[cf23 := cf24])[p0 := cf24];
					var v17: seq<int> := [-cf21, i4, v4];
					var v18: seq<seq<int>> := [v17, v17];
					var v19: array<seq<int>> := new seq<int>[26] [v17, v17, fm13(globalState) + [cf25], if (v8.f27) then v17 else [cf21, cf21], [i4, cf25], v18[|(seq(0x13d, i5  => (v2)))|], v17, v17[i4 := -0x1f9], (seq(0x322, i6  => (cf25))) + v17, (seq(0x7f, i7  => (|{cf24}|))) + (seq(0x1c9, i8  => (cf21))), v17, v17 + v17, v17, v17 + v17, v17, [-|v17|], v17, v17, v17, v17, v17 + [0x25c, i4], v17, v17 + v17, v17, v17, v17];
					var v20: map<bool, seq<int>> := map[v8.f27 := v17];
					v19 := new seq<int>[17] [v17, v17, if (v8.f27) then v17 else v17, v17, v17, v17, v17, v17, seq(0xb8, i9  => (cf25)), seq(870, i10  => (0x2be)), if (true in v20) then v20[true] else v17[cf25 := cf21], seq(0x29, i11  => (i4)), v17 + (seq(292, i12  => (if (v8.f27 in v7) then v7[v8.f27] else cf21))), v17 + v17, v17, v17, v17];
				case DC15(cf26, cf27, cf28) =>
					...
					var v26 := DC24(v25);
					var v27 := DC17(v3[58], v2, |v22|);
					var v28: multiset<char> := multiset{v3[58], v3[58]};
					var v29: seq<int> := [cf28, fm18(multiset{!cf27, !cf27}, v27, !p0, globalState), cf26, cf26];
					var v30: array<int> := new int[25] [|(map[fm0(v0, globalState) := !p0] + v21)|, cf28, |v22| * i4, fm18(multiset{p0}, DC17(v3[58], if (|v24| in v23) then v23[|v24|] else v2, cf26), cf27, globalState) * cf26, fm18(v26.cf41, v27, false, globalState), fm5(globalState), |v28|, -i4, cf28, 0x205, |v25|, |v0| + i4, if (cf27) then |v0| else cf26, cf28, fm18(v25, v27, cf27, globalState), --v4, v4 % -v4, i4 * 0xeb, i4 * cf26, |v29| - v4, |v22| - cf26, 0x2b2, -cf26, if (cf27) then -|v0| else i4, v4];
					v30[714] := cf26;
					v30[714] := |v25[p0 := v29[v4]]| % -0x1d2;
					var v31: map<char, bool> := map[v2 := p0];
					var v32: map<map<char, bool>, bool> := map[v31 := v0[cf28]];
					v32 := v32[v31 := p0];
					cf26 := cf26;
					cf28 := v29[v30[714]] - cf28;
				case DC13(cf20) =>
					v2 := v2;
					var v33 := "nc";
					...
					v37, v1[206], v4, v0, globalState.f8 := v37, !(p0 || p0), v4 * i4, if (p0) then v0 else v0, (i4 * |v38|) / |v33|;
					v1[206], globalState.f8 := v1[206], i4 / i4;
					globalState.f8 := -v4;
			}
			...
			var v46: seq<int> := [v4];
			var v47: array<int> := new int[23] [v4, i4, -i4, i4, -i4, -i4, i4, i4, v4, v4, fm5(globalState), |v39|, |map[|{p0}| := !p0]|, v4, v4, |v40|, |v43[|[v0[v4]]| := v4]|, |v45|, |v46|, i4, |v43|, i4, |v0|];
			var v48: set<int> := {v4};
			...
			v51 := v51[v47 := map v52 : int | (-0x38c <= v52) && (v52 < 0x94) :: (v52 % -0x2d3) := (v46)];
			var v53 := "yq";
			v53 := v53;
		}
		...
		r1 := v55;
		var v56 := DC14(|(seq(0x3c2, i13  => (v3[58])))|, false, true, !p0, v4);
		r2 := match v56 {
			case DC14(cf21, cf22, cf23, cf24, cf25) => cf22
			case DC15(cf26, cf27, cf28) => !false
			case DC13(cf20) => DC15(v4, p0, |(map v57 : int | (688 <= v57) && (v57 < 0x354) :: (v57 % v4) := (|{v3[58]}|))|).cf27
		};
	}
}
...
class C3 extends T0 {
	...
	function fm2(p0: int, p1: bool, p2: map<int, bool>, globalState: GlobalState): seq<string> {
		([seq(0x265, i0  => ('g'))] + ["glht", "wx", "rlclyu", "llfeqpt", "ao"]) + (DC3(seq(0x38e, i1  => (seq(0x5f, i2  => ('y'))))).cf3 + (seq(0x265, i3  => (seq(0x123, i4  => ('h'))))))
	}
	method m1(globalState: GlobalState) {
		var v0 := -373;
		if (v0 != v0) {
			...
			v3[205] := if (|v8| in v7) then v7[|v8|] else v2.f27;
			var v9 := "bycndgxtw";
			var v10: multiset<int> := multiset{0x15c, |v9|};
			var v11: set<bool> := {v1, v8[326]};
			f26[640], v3[205], globalState.f8, globalState.f2 := v0, v1, v0 / v0, fm28(v0 < -|v10|, v11 !! v11, v2.f27, v0, globalState);
			var v12: array<D6> := new D6[17];
			var v13: multiset<bool> := multiset{false, v1};
			var v14 := 'w';
			var v15 := DC17(v14, v14, 0x37b);
			var v16: array<int> := new int[16] [0x218, f26[640], 195, f26[640], v0, 0x2e4, v0, fm18(v13, v15, v2.f27, globalState), f26[640], v0, v0, |v13|, v0, v0, v0, v0];
			v12[313] := DC10(v16);
			var v17 := DC10(if (v3[205]) then v16 else v16);
			v12[313] := v17;
		} else {
			var v18 := new C2();
			var v19 := "qujdwm";
			v19 := seq(-0xed, i0  => (if (false) then 'd' else 'g'));
			globalState.f8 := v0;
			var v20 := false;
			var v21: C0 := new C0(v20);
			var v23 := 'n';
			var v24: multiset<string> := multiset{("qd")[v0 := v23], "sir"};
		...
		var v30: seq<multiset<int>> := [multiset(seq(-0x267, i1  => (v0)))];
		var v31: seq<int> := [|v29|, |v30[v0]|, fm5(globalState), 0xad, v0];
		var v32: map<seq<int>, map<int, bool>> := map[v31 := map[v0 := v27]];
		var v33: map<int, bool> := map[v0 := v27];
		var v35: multiset<map<int, bool>> := multiset{if (v31 in v32) then v32[v31] else v33, map[-59 := v27], map v34 : int | v34 in {v0} :: (v34 % v0) := (v27)};
	...
	method m2(globalState: GlobalState) {
		...
		var v5: multiset<int> := multiset{v3, |[v1]|, v4[v3]};
		var v6 := 'e';
...
class C4 extends T0, T1 {
	...
	method m1(globalState: GlobalState) {
		var v0: seq<int> := [f25, |(seq(0xf1, i1  => ('d')))|, f25, f25, f25];
		var v1 := DC1(|v0|);
		for i0 := v1.cf1 to f25 {
			var v2 := true;
			globalState.f17, globalState.f8 := v2, -0x356 / i0;
			var v3: array<bool> := new bool[24];
			var v4: seq<array<bool>> := [v3, v3];
			var v5: array<array<bool>> := new array<bool>[18] [if (v2) then v3 else v3, v3, v3, v3, if (v2) then v3 else v3, if (v2) then v3 else v3, v3, v3, v3, v3, v3, v3, if (v2) then v4[f25] else v3, v3, v3, v3, v3, v3];
			v5[832] := v3;
			var v6 := "upnyjowbd";
			var v7 := 't';
			var v8: array<string> := new string[9] [fm1(globalState), v6, v6[i0 := v7], v6 + v6, v6, seq(-241, i2  => (v7)), v6, v6, v6 + v6];
			v8[57] := v6;
			var v9: seq<bool> := [!v2];
			v5[832], v8[57], globalState.f22 := v3, v6, fm0(v9, globalState);
			v2 := v2;
			...
			decreases 100 - i3
		{
			...
			v15[274], globalState.f17, v30, v20 := true, fm0(fm12(v20, -|(seq(939, i4  => (f25)))|, !v18, globalState) + v14, globalState), if (v32 > v32) then v30 else v30, v11;
			if (v18) {
				v28[155] := f25;
				var v33: seq<seq<int>> := [v0];
				var v34: multiset<seq<int>> := multiset{[f25]};
				var v35: multiset<bool> := multiset{{true, true} <= v12, v11, v19, DC28(v33[|v14|]).cf47 !in v34};
				globalState.f8, v15[274], v28[155], globalState.f8 := |v17|, v18, if (false in v35) then v35[false] else fm18(v35, v30, v20, globalState), f25 * f25;
				var v36: array<int> := new int[26](i5 => i5 - |"trutx"|);
				var v37: set<array<int>> := {v36, v36, v36};
				var v38 := DC31(v37);
				var v39: map<char, set<array<int>>> := map['w' := v37];
				var v40: map<int, set<array<int>>> := map[v28[155] := if ('j' in v39) then v39['j'] else v37];
				var v41: array<set<array<int>>> := new set<array<int>>[25] [v37 * v37, v37 * v38.cf50, {v36, v36} * v37, v37, v37, v37 * {v36}, v37, v37, {v36, v36, v36}, (if (v28[155] in v40) then v40[v28[155]] else v37) * {v36, v36, v36, v36, v36}, v37, v37, if (v18) then v37 else v37, {v36} * v37, v37, v37, v37 - v37, v37 + v37, v37, v37, {v36, v36}, v37, v37, v37 * v37, if (v18) then v37 else v37];
				v41[212] := v37;
				...
				v44[909] := v43;
				v41[212], v44[909] := if (v20) then v37 else v37, v43 + v43;
				var v45: map<array<int>, int> := map[v36 := v28[155]];
				globalState.f8, v28[155] := (if (f25 in v21) then v21[f25] else v28[155]) - v28[155], -((|v17| / |v45|) / (if (v19) then v28[155] else 0xb4));
				v27 := if (v11) then v27 else v27;
				v28[155] := (v28[155] * f25) % f25;
			} else {
				var v46 := DC10(v28);
				...
				var v49: map<int, D3> := map[fm18(multiset{v15[274], v19, v18, !v18, v11}, v30, true, globalState) := v48];
				var v50: seq<map<int, D3>> := [v49, v49, v49];
				var v51: map<D1, int> := map[v1 := f25];
				v27, globalState.f17, globalState.f8, v15[274] := if (v15[274]) then fm22(v18, globalState) else v27, true, |v0| / (-f25 / f25), v50[if (v1 in v51) then v51[v1] else 0x233 := v49] <= v50;
				globalState.f19 := !v18;
	...
	method m2(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			v2 := v2[!v0 := !([f25, f25] <= v5)];
			var v11: array<string> := new string[12] [fm1(globalState), seq(0x120, i1  => (v7)), "fvis", v3 + v3, seq(0x1fa, i2  => (v7)), v3[f25 := v7], "qknenuyap", v3, seq(-977, i3  => (v7)), v3, seq(0x62, i4  => (v7)), "s"];
			v11[733] := (seq(0x345, i5  => (v7))) + v3;
			v11[733] := v3 + ((seq(-0x19a, i6  => ('l')))[f25 := v7] + v3);
			var v12: array<set<int>> := new set<int>[21](i7 => {f25} + {f25, f25});
			var v13: set<int> := {f25, f25, f25};
			var v14: seq<set<int>> := [v13];
			v12[928] := v14[0x193] + {f25};
			v12[928] := v13;
			var v15: array<int> := new int[16](i8 => i8 * |[v0, v0]|);
			var v16 := new C3(if (!v0) then v15 else v15);
		}
		globalState.f17 := (f25 % f25) in v5;
		var v17: array<int> := new int[5](i9 => i9 % f25);
		globalState.f23 := v17;
		...
		v21[37] := !v0;
		v21[37] := fm0(v19 + v19, globalState);
	}
	method m3(p0: set<bool>, p1: bool, p2: array<bool>, p3: string, globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool) {
		...
		for i0 := f25 to f25 {
			...
			v3 := v3 + v3;
			var v5: array<set<seq<int>>> := new set<seq<int>>[14](i1 => {[i0, -f25]} * (set v4 : seq<int> | v4 in {seq(0x31e, i2  => (-i0)), [i0, f25]} :: (v4)));
			var v6: seq<int> := [i0];
			var v7 := DC28(v6);
			var v8: set<seq<int>> := {v7.cf47, [f25, i0], v6[i0 := i0], v6};
			v5[598] := v8 - {v6, v6};
			var v9: seq<seq<int>> := [v6];
			v5[598] := set v10 : seq<int> | v10 in v9 :: (v10);
			var v11 := 'k';
		...
		v14, v15, globalState.f19, p2[145] := v16[|({v17, v17} + v19)|], fm8(globalState), f25 > 0x3d4, !v17.f27;
		var v20: array<int> := new int[23](i3 => i3 + |[f25]|);
		v20[174] := |v0|;
		v20[174] := f25 + fm5(globalState);
		var v21: map<bool, int> := map[p1 := v20[174]];
		for i4 := f25 to |v21| {
			var v22 := DC28([f25, v20[174], |p3|]);
			v22 := v22;
			globalState.f8 := v20[174];
			var v23 := new C0(true);
			...
			var v28: map<T0, map<bool, bool>> := map[v26 := if (v17.f27) then map[!p2[145] := p2[145]] else v27];
			v28 := v28[v26 := v27];
		}
	...
	method m4(p0: seq<int>, p1: map<bool, bool>, p2: bool, globalState: GlobalState) returns (r0: bool, r1: array<bool>, r2: bool, r3: int) {
		...
		globalState.f19 := if (p2) then if ((seq(0x396, i0  => ('f'))) in v0) then v0[seq(0x396, i0  => ('f'))] else p2 else false;
		var v1 := "ahhoqv";
		v1, r2 := (seq(0x19, i1  => ('j'))) + v1, p2 <== true;
		var v2 := 'b';
		var v3: seq<bool> := [p2];
		...
		match (v4) {
			case DC7(cf9, cf10, cf11, cf12) =>
				...
				v15[334] := v14;
				v12, v13, v5, v15[334], v1 := DC12(v10), v13, v5, v14, v1 + v1;
			case DC8(cf13, cf14, cf15) =>
				...
				v23[231] := fm29(false, p2, globalState);
				var v24: map<string, int> := map[v1 := f25];
				var v25: seq<string> := [fm1(globalState), v1, seq(-0x360, i3  => (v2))];
				v23[231], v3, globalState.f8, globalState.f8 := v24, [p2], f25, |(if ("k" < v25[f25]) then p1 else p1)|;
			case DC6(cf8) =>
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			globalState.f19 := p2;
			globalState.f8 := -(f25 / (f25 * f25));
			var v31: array<bool> := new bool[6];
			v31[463] := p2;
			var v32: array<array<D7>> := new array<D7>[3];
			var v33: array<int> := new int[8];
			v31[463], globalState.f22, r2, v32 := p2, v33 in [v33], p2, v32;
			v0 := (v0 + map[v1 := fm0(v3[f25 := p2], globalState)]) + v0;
		}
		var i5 := 0;
		while (p2)
			decreases 100 - i5
		...
		v38[590] := f25;
		v38[492] := f25;
		v38[877] := --(fm5(globalState) * f25);
		var v39: seq<string> := ["bjxoc", v1];
		v38[590], v38[492], r0, v38[877] := |((if (p2) then v39 else v39) + (v39 + v39))|, |v1|, p2, (f25 * f25) * (if (p2) then f25 else f25);
		r0 := p2 ==> (v1 <= "sjbp");
		...
		r1 := new bool[5] [v41[v1 := v40] != v41, !p2, fm0(v42[|v1|], globalState), p2, p2];
		var v43: set<int> := {-0x25b};
		var v44: T1 := new C0(p2);
		var v45: C1 := new C1(map[v43 := v1], v44);
		var v46 := DC33(false, p2, |(seq(171, i6  => ('q')))|, v45, p2);
		var v47 := DC17(v2, v2, v46.cf54);
		r2 := v38[590] >= fm18(multiset{!p2, p2, p2}, v47, p2, globalState);
		r3 := v38[590];
	}
}
...
method Main() {
	var v0 := "wifcawqh";
	var v1: array<int> := new int[16](i0 => i0 / |v0|);
	...
	var v10: array<string> := new string[4] [v0, v0, v0, seq(0x1f3, i1  => ('h'))];
	...
	v14 := v14 + (v14 + v14);
	var v15: map<string, bool> := map[seq(40, i3  => ('l')) := v3];
	var i2 := 0;
	while ((v0 + v0) in v15)
		decreases 100 - i2
	{
	...
	match (v25) {
		...
		case DC28(cf47) =>
			...
			if ((set v36 : D0 | v36 in v35 :: (v36)) !! (set v38 : D0 | v38 in v37 :: (v38))) {
				...
				v21 := v7 * v7;
				v23.f26[117] := v21 / v21;
				v18, v23.f26[117] := v18, -(|(seq(0x128, i4  => ('u')))| + v21);
			} else {
				v7 := v18;
				...
				v23.f26[260] := |(if (v43 in v45) then v45[v43] else v44 + v44)|;
				var v46: map<int, array<int>> := map[|v0| := v1];
				var v47: seq<array<int>> := [v1];
				globalState.f23 := if (|([|map[v22.f27 := v22.f27]|])[|v13| := v7]| in v46) then v46[|([|map[v22.f27 := v22.f27]|])[|v13| := v7]|] else v47[v21];
			}
	...
	}, v7, v62[v54.f25 % -0x262];
	if (v50.f27) {
		var v63 := 'a';
		v59[255] := v63;
		globalState.f8, v59[255], v7 := -(v21 - v54.f25), v63, v12[v54.f25];
		var v64: multiset<bool> := multiset{!v22.f27};
		var v65 := DC17(v59[255], v59[255], v54.f25);
		v18 := (fm18(v64, v65, v3, globalState) + v54.f25) % -v18;
		v59[255] := fm8(globalState);
		var v66: array<bool> := new bool[8](i7 => false);
		v66[830] := v3;
		v66[830] := v54.f25 !in v53;
		v3 := v19;
	} else {
		...
		v67[867] := (if (v22.f27) then seq(0x8, i9  => ('a')) else v69[v54.f25]) < v0;
		v12 := v12;
		var v70: set<int> := {-|v53|};
		v70 := v70;
		var v71 := new C0(fm5(globalState) in map[v21 := true]);
		globalState.f5 := !!(-(v54.f25 + v7) > (|(seq(412, i10  => ('v')))| * v21));
	}
