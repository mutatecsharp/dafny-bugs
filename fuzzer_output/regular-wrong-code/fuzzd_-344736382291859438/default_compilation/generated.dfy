...
function fm10(p0: map<int, int>, p1: char, p2: bool, globalState: GlobalState): string {
	if (--0x1d1 <= 0x2bd) then seq(0x179, i0  => ('h')) else "xyrvtep"
}
...
function fm14(p0: bool, p1: int, p2: int, globalState: GlobalState): seq<int> {
	[|(seq(606, i0  => ("gcrwhf")))|, 0x53 - |map[0x206 := 'k']|, -|map[0x281 := false]| - -|(set v0 : int | (518 <= v0) && (v0 < 0x6f) :: (v0 + 828))|]
}
...
function fm17(p0: int, p1: bool, p2: char, globalState: GlobalState): multiset<int> {
	(multiset(seq(0x1ea, i0  => (|multiset{0x2f5, 0x56}|))) - multiset{0x1e8}) * multiset(seq(0x370, i1  => (|(seq(-0x1a5, i2  => ('x')))|)))
}
...
function fm20(p0: int, p1: bool, p2: int, globalState: GlobalState): map<multiset<int>, seq<int>> {
	(map[multiset{|map[|multiset{false}| := -|[!true, false, true, false]|]|, 671} := seq(0x3e4, i0  => (-936))] + map[multiset{|map[false := 0x7d]|} := [0x1bb, 0x2cf]]) + map[multiset{931} := [0x358]]
}
...
function fm23(p0: D2, p1: int, p2: int, globalState: GlobalState): string {
	match DC30("oausrgoo", 442, 'l') {
		case DC29(cf45, cf46, cf47) => (seq(494, i0  => ('p'))) + (seq(0x21b, i1  => ('s')))
		case DC30(cf48, cf49, cf50) => cf48 + cf48[-0xd1 := 'o']
		case DC31(cf51, cf52, cf53, cf54) => "xdvd"
		case DC28(cf44) => seq(0x3e3, i2  => ('m'))
	}
}
...
function fm25(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): D1 {
	DC5(|({"ptgi"} + {seq(0x1da, i0  => ('n'))})|, false, !([multiset{false, true}] <= [multiset{false, !true, true, true, !false}, multiset{!true, true}]), map[multiset{0x4d} := [|{true, true}|]])
}
function fm26(p0: int, p1: bool, p2: char, globalState: GlobalState): map<bool, seq<int>> {
	(map[false := [|map[479 := false]|, |multiset{|[true]|}|, 538, 0x2f2, -|[|[false, true]|]|]] + map[false := seq(0x3b5, i0  => (|[|['h']|]|))]) + map[true := [230, -506]]
}
function fm27(p0: map<set<bool>, bool>, globalState: GlobalState): set<seq<char>> {
	{(seq(0x69, i0  => ('n'))) + ['a'], (seq(486, i1  => ('w'))) + (seq(0x294, i2  => ('u'))), ['t', 'p', 'n']}
}
...
function fm32(p0: char, p1: bool, p2: char, globalState: GlobalState): multiset<seq<int>> {
	multiset(if (true) then (seq(0x3ce, i0  => ([|[|map[-|[0x1fb]| := |multiset{|"xwenmsl"|}|]|]|]))) + (seq(-309, i1  => ([|{false}|]))) else [seq(0x388, i2  => (-134)), seq(-210, i3  => (|"qqmyop"|)), [|map[|DC37(map v0 : char | v0 in (map v1 : char | v1 in {'g'} :: (v1) := (|[!true]|)) :: (v0) := (!!true)).cf64| := true]|]])
}
...
function fm34(p0: bool, p1: char, p2: int, globalState: GlobalState): seq<bool> {
	[false, [multiset{|[0x1fb]|, |"ghvpdnr"|, |[-|map[DC4(map[multiset{true} := true]) := |multiset{true}|]|, 0xb3]|}, multiset(seq(0x1f8, i0  => (|[|[|map[false := |map[true := false]|]|, |[0x5e, |map[449 := |[985, 0xa5]|]|, |map[!true := true]|, 0x1a9]|]|]|))), multiset{|map[188 := -0x80]|, |"ahqc"|}] == [multiset{942}]]
}
...
function fm36(p0: char, p1: D3, p2: bool, globalState: GlobalState): seq<map<char, int>> {
	([map['e' := |(seq(0x2f6, i0  => ('h')))|]] + [map v0 : char | v0 in ['d', 'x', 'f', 'q'] :: (v0) := (0x182)]) + [map['p' := 538], map[DC13('e').cf24 := |multiset{0x2fa, |"quneatwcc"|}|]]
}
...
function fm39(globalState: GlobalState): set<seq<int>> {
	({[0x1aa, 976, |"rkh"|]} - {seq(-561, i0  => (|(set v0 : int | (0x232 <= v0) && (v0 < 0x1ab) :: (v0 / |[0x165, |multiset([true])|]|))|))}) * ({[-|[|"ddtk"|]|]} * {[0x50], [0x31e], [-0x3ab]})
}
...
function fm41(p0: int, p1: bool, p2: multiset<bool>, p3: multiset<int>, globalState: GlobalState): D4 {
	match DC31(|[false, DC29([0x377, |(seq(0x163, i0  => ('c')))|], |(map v0 : int | (273 <= v0) && (v0 < 623) :: (v0 + 518) := (|"dbeopaxvs"|))|, false).cf47]|, false, false, |(map v1 : int | (0x1de <= v1) && (v1 < 0x7d) :: (v1 / |map[true := -611]|) := ('g'))|) {
...
function fm43(p0: char, p1: map<bool, char>, globalState: GlobalState): map<int, seq<int>> {
	if (908 != |"qpimlci"|) then map[668 := [--988]] else map[|multiset{'x'}| := seq(0x3bc, i0  => (0xfb))]
}
...
function fm46(p0: int, p1: int, p2: int, globalState: GlobalState): seq<map<bool, int>> {
	if (|map[true := true]| <= -344) then (seq(-0x222, i0  => (map[false := 102]))) + [map[true := |{true}|]] else [map[!true := -804], map[false := 0x271]]
}
method m8(globalState: GlobalState) {
	...
	match (v5) {
		case DC26(cf42) =>
			...
			var v16 := 'i';
			var v17: array<int> := new int[28] [0x29e, fm0(|v3|, globalState), if (v0) then 203 else v2, v2, -0x14a, v2, v2, DC20(seq(133, i0  => (v2)), v6, v8, v0, v2).cf34, -v2, |v1|, v2, |map[v13 := v6]|, -v2, v2, v2, |([v0, fm12(v0, v0, globalState), v0, !false])[v2 := v0]|, v2, v2, v2, |(v14 + v14)|, v2, 0x73, -|fm44(v2, 0x169, (v3[fm0(|v15|, globalState) := v16])[v13.fm2(globalState) := v16], globalState)|, -0x3c, v2, v2 % |v3|, v2, v2];
			var v18: set<int> := {v2};
			v10[785] := |v18| % v2;
			v17[892] := v2;
			...
			v0, v10[785], globalState.f13, v17[892], v19[954] := !(if (v22 >= v22) then v0 else if (v0 in v23) then v23[v0] else v0), v2, if ('r' in v25) then v25['r'] else !(v0 || v0), (if (v0) then v21.f30 else v2) - |(v3 + v3)|, if (v0) then if (v21.f30 in v26) then v26[v21.f30] else v20 else v20;
			globalState.f24 := v18;
			if (if (v0) then v1[v17[892]] else !v0) {
				...
				var v30: set<bool> := {v0};
				var v31: seq<set<int>> := [v18, v18, fm42(v10[785], v30, v10[785], globalState)];
				var v32: map<int, bool> := map[-v21.f30 := v27.f32];
				v29, globalState.f22, globalState.f10, v10[785], v17[892] := v29, (v18 + v31[v10[785]]) >= (v18 - v18), |v23| % v2, if (!v1[|v9|]) then -v21.f30 else if (v0) then |[if (v17[892] in v32) then v32[v17[892]] else v0, false]| else v21.f30, -v10[785];
				var v33: map<bool, int> := map[v27.f32 := v21.f30];
				var v34: multiset<map<bool, int>> := multiset{v33};
				var v35: seq<set<bool>> := [v30, v30];
				var v36: array<multiset<map<bool, int>>> := new multiset<map<bool, int>>[25] [v34 * multiset{v33}, fm45(-v10[785], globalState), multiset{v33, v33, v33, v33, v33}, v34, v34, v34, v34, v34, v34[v33 := v13.fm2(globalState)], v34, multiset(fm46(v17[892], v2, v21.f30, globalState)), v34 * v34, v34, v34 * v34, fm45(v21.fm3(v17[892], v27.f32, -0x158, DC2(v17[892], true), globalState), globalState), v34, v34, v34, v34, multiset{map[v27.f32 := |v35|]}, v34 * v34, v34, v34, v34, v34[v33 := v21.f30] + v34];
				v36[865] := v34;
				v36[865] := v34;
				globalState.f19 := v16;
			} else {
	...
	v39[546] := v0;
	var v40 := 'v';
	v38, globalState.f10, v39[546], v2, v3 := DC34(v0), v2, v0, v2, fm10(map[v2 := v2], v40, v0, globalState);
	globalState.f10 := |v1|;
	globalState.f7 := v39[546];
	var v41: map<bool, bool> := map[v39[546] := v39[546]];
	...
	for i1 := v2 to |v43| {
		...
		v4, v39, globalState.f13, globalState.f7 := v4, v39, v41 == v41, if (-i1 !in v47) then v39[546] else v39[546];
		var v48 := DC19();
		match (v48) {
			case DC19() =>
				v39 := v39;
			...
			case DC20(cf30, cf31, cf32, cf33, cf34) =>
				...
				v54 := v54[cf34 % cf34 := v0];
				v43 := [fm0(v2, globalState), cf34, i1];
				var v55: array<string> := new string[19](i2 => v3);
				v55[429] := v3;
				v55[429] := (if (cf33) then v3 else v3)[i1 := v40] + "uyvafgoga";
			case DC18(cf29) =>
				globalState.f22, v39[546], globalState.f10 := v39[546], v39[546], -v2;
				var v56: seq<seq<bool>> := [v1];
				var v57: array<seq<bool>> := new seq<bool>[2] [v56[i1] + v1, [v39[546], v0, v39[546], v39[546], v0]];
				v57[701] := v1;
				v57[701] := if (v0) then [v39[546], v39[546]] else v1;
				globalState.f10 := -v2;
				v2 := 0x379;
		}
...
class C0 {
	...
	function fm13(p0: int, globalState: GlobalState): int {
		-match DC6(DC2(891, f32).cf5, [[f32], [!f32, f32]], 124, f32) {
			...
			case DC6(cf13, cf14, cf15, cf16) => -(cf15 % |map[cf16 := cf13]|)
			case DC4(cf8) => 0x278 / |{0x153}|
		}
	}
}
...
class C1 extends T0 {
	...
	function fm1(p0: D0, p1: seq<int>, p2: char, p3: seq<bool>, globalState: GlobalState): map<multiset<bool>, bool> {
		map[multiset{!false} := map[-0x217 := !true] !in (seq(0x3b2, i0  => (map[|map[false := |multiset{true, false, false, true, true}|]| := false])))]
	}
	function fm2(globalState: GlobalState): int {
		-|[|(seq(0x30a, i0  => ('c')))|, -566 / -96, 0x3c4 - |"v"|, 0x44 * -0x1bb]|
	}
	...
	method m0(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
		if (p1) {
			...
			v0[665] := if (p0 in v1) then v1[p0] else p0;
			...
			globalState.f10, v0[510], v0[665], v2[858] := p0, fm0(p0, globalState), if (p1) then p0 else v3[|v6|], p1;
			var v7: map<bool, bool> := map[v2[858] := p3];
			var v8: seq<bool> := [if (p3 in v7) then v7[p3] else true, p1 ==> p3, p1];
			v0[510], v8, v0 := (p0 / fm0(p0, globalState)) + p0, v8 + (v8 + v8), if (false) then v0 else v0;
			if (fm21(p0, globalState)) {
				...
				var v10 := new C0(p3);
				globalState.f22 := p3;
				v2[858] := fm21(-p2, globalState);
			} else {
				v8 := [false, fm21(-v0[510], globalState), p1] + (fm22(v2[858], globalState) + v8);
				var v11 := "xfsnymi";
				var v12 := DC0(v11);
			...
			var v19 := "sj";
			var v20: array<multiset<bool>> := new multiset<bool>[24] [v13, v13, v13, if (v14[|v15|]) then v13 else multiset{v14[|fm23(DC7(v16), p0, v18.cf15, globalState)|], p3, false}, v13, if (p3) then v13 else v13, multiset(v14), v13 + v13, fm24(|v19|, p3, globalState), v13 + v13, v13, v13, multiset(v14) - v13, v13, v13, v13, v13, v13, multiset{false, p3}, v13, v13, v13 - v13, v13, v13];
			v20 := v20;
			...
			if (p0 == |v21|) {
				...
				v23[793] := false;
				v23[793], v22, globalState.f22 := p3, v22, (if (p1) then p1 else p1) <==> p1;
				var v24 := DC7(v16);
				var v25: map<array<bool>, string> := map[v23 := v19];
				var v26: array<string> := new string[16] [fm23(v24, -p2, p2, globalState), seq(400, i1  => (v22)), v19 + v19, v19 + (seq(945, i2  => (v22))), v19 + v19, if (v23 in v25) then v25[v23] else v19, v19, v19, seq(-0xbe, i3  => (v19[|v19|])), v19, v19, fm23(v24, -323, p2, globalState), v19[|v21| := v22], "ubj", v19, v19];
				v26[923] := v19;
				v23[793], v26[923], globalState.f22 := fm21(532, globalState), "fye" + ("uerjb" + v19), false;
				globalState.f10 := p0;
				var v27: array<map<int, bool>> := new map<int, bool>[17];
				var v28: map<int, bool> := map[p2 := v23[793]];
				v27[353] := v28;
				var v29: array<C0> := new C0[24];
				var v30: C0 := new C0(v23[793]);
				v29[303] := v30;
				var v31: array<int> := new int[8](i4 => i4 % p0);
				v31[648] := p2 / p0;
				var v32 := DC10(multiset(v14));
				var v33: map<string, array<int>> := map[v26[923] := v31];
				var v34 := DC17(v31);
				var v35: seq<array<int>> := [v31];
				var v37: array<array<int>> := new array<int>[14] [v31, v31, v31, v31, v31, if (fm21(p2, globalState)) then if (v19 in v33) then v33[v19] else v31 else v31, v31, v31, v31, v34.cf28, v35[-|(map v36 : int | v36 in [-0x23b] :: (v36 * v21[p0]) := (p0))|], v31, v31, v31];
				v27[353], v29[303], v31[648], v32, v37 := map v38 : int | (207 <= v38) && (v38 < 0x384) :: (v38 + p0) := (p0 == --|v21|), v30, p2 + p2, v32, if (p3 <==> !v23[793]) then v37 else v37;
				var v39: map<bool, int> := map[v23[793] := v31[648]];
				var v40: map<bool, map<bool, int>> := map[v23[793] := v39];
				v26[923] := (v19 + (v26[923] + v26[923]))[|(v40 + v40)| := v22];
			} else {
				...
				v41[81] := DC4(v45).(cf8 := map[multiset{p1} := p1]);
				var v46: array<int> := new int[23](i6 => i6 * -650);
				v46[438] := p2;
				v46[438], globalState.f19, globalState.f10 := p2, v22, -p2;
				...
				var v49: map<map<int, bool>, bool> := map[v48 := fm21(v46[438], globalState)];
				v47[622] := v49;
				v46[438], v47[622], v21, globalState.f13 := p0, v49, (v21 + v21) + [0xd0], p1;
				var v50 := DC2(fm0(p2, globalState), p1);
				var v51: array<bool> := new bool[15] [p3, p3, p3, !p1, !!(p3 !in v15), 867 <= |(seq(-0x5d, i8  => (|map[p3 := v22]|)))|, p0 >= p0, p1, p1, p3, !p3 || p1, p1, p1, p1, p0 < v50.cf5];
				v51[863] := p1;
				var v52 := DC1(p0, |map[p3 := p0]|, p2, v51);
				var v53 := DC3(v52);
				v51[863], v53, v46[438], v46[438] := p1, if (p3) then v53 else v53, (p2 * v46[438]) * v46[438], p0;
			}
			...
			v61[837] := 'e';
			v58, v59[921], globalState.f13, globalState.f10, v61[837] := v58, v60, p3 !in (v14 + v14[|v19| := p1]), p2, v22;
		}
		
		for i11 := 0x1cd to 61 % 131 {
			...
			var v70: multiset<seq<C0>> := multiset{v67[|v69| := v66], v67};
			var v71: multiset<int> := multiset{p2};
			var v72: array<int> := new int[24] [p0, p0, i11, p0, p0 * |v65|, p2, i11, |v63|, i11, |v63|, |fm22(p3, globalState)|, |v63| % i11, i11, fm2(globalState), if (v67 in v70) then v70[v67] else fm0(|v71|, globalState), p2, p0, p2, i11, p0, v66.fm13(p2, globalState) % |[v68, v68, v68]|, |map[v66.f32 := v68]|, v66.fm13(p0, globalState) / fm0(i11, globalState), p0];
			var v73: set<bool> := {v66.f32};
			v72[573] := |v73| % p2;
			v72[573] := p2;
			var v74: array<bool> := new bool[4](i12 => |map[v66.f32 := DC7(map[i11 := v72[573]])]| > i11);
			v74[971] := p1;
			v72[573], v72[573], v74[971] := -(|[v64[i11], -i11, |v63|]| % p2), i11, i11 >= i11;
			var v75 := new C0(v74[971]);
		}
		var v76: array<array<array<int>>> := new array<array<int>>[17];
		var v77: seq<int> := [p2];
		var v78: seq<bool> := [fm21(p0, globalState)];
		var v79: multiset<int> := multiset{|(seq(0x1c, i13  => ('l')))|};
		var v80 := "cxrrfwi";
		...
		v76[692] := if (p1 in v84) then v84[p1] else v83;
		...
		var v89 := DC2(p0, p1);
		var v90: array<bool> := new bool[19] [p3, p1, p1, p1, v86.cf16, p3, p3, if ((if (p3 in v88) then v88[p3] else p1) in v87) then v87[if (p3 in v88) then v88[p3] else p1] else p3, p1, p3, p1, v89.cf6, v78[p0], p1, p1, p3, p3, !p1, false];
		var v91: set<array<bool>> := {v90};
		var v92: set<int> := {v77[|"cqty"|]};
		var v93: seq<set<array<bool>>> := [{v90, v90, v90}, v91];
		globalState.f10, v91, globalState.f10 := |((v92 + {-p2}) * (if (p1) then v92 else v92))|, v93[p0 * p2], p0;
		globalState.f13 := p3;
		var v94 := 'y';
		var v95 := DC13(v94);
	...
	method m1(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		if (p2) {
			...
			globalState.f10, v0, v3, globalState.f10, globalState.f13 := if (!p2) then p1 else if (v4[p1]) then p1 else -0x240, "ocl", v3, 0x224 % p1, fm21(-p1, globalState);
			if (p2) {
				var v5: seq<int> := [p1, p1];
				v5 := (v5 + [p1, -p1, p1])[p1 := if (p2) then p1 else p1];
				globalState.f7 := p2;
				var v6: multiset<int> := multiset{p1, |v0|};
				var v7: map<multiset<int>, seq<int>> := map[v6 := p0[p1 := |multiset{true}|]];
				var v8 := DC5(p1, !p2, p2, v7);
				var v9: array<D1> := new D1[10] [fm25(p2, !p2, p1, p2, globalState), v8, v8, v8, v8, v8, v8, v8, DC5(p1, p2, true, v7), v8];
				v9[758] := v8;
				v9[758] := v8;
				var v10 := m6(|v5| - p1, |v0| - p1, |v4| * p1, p1 / p1, globalState);
				var v11: set<bool> := {true, p2, p2};
				globalState.f13 := p2 <== !(p2 in v11);
			} else {
				var v12: map<bool, seq<int>> := map[p2 := p0[p1 := p1] + p0];
				...
				var v22: multiset<int> := multiset{|v16|, |v18| * p1, p1, |v19| / |v21|, p1};
				var v23 := DC2(p1, p2);
				var v24: map<bool, bool> := map[v23.cf6 := p2];
				globalState.f10, v12, v22, globalState.f13, globalState.f10 := |(if (p2) then v4 else v4 + fm22(p2, globalState))|, fm26(p1, if (p2 in v24) then v24[p2] else p2, v0[|v22|], globalState), v22, true, p1;
				var v25: set<seq<char>> := {[v17] + v0[-p1 := v17]};
				var v26: map<set<bool>, bool> := map[v19 := p2];
				v25, globalState.f22 := fm27(v26, globalState), p2;
				var v27: array<bool> := new bool[27] [p2, p2, p2, p2, p2, p2, p2, p2, p2, false, p2, fm21(p1, globalState), p2, p2, false, p2, p2, p2, p2, !p2, p2, !false, p2, p2, p2, v4[p1], p2];
				var v28: seq<array<bool>> := [v27, v27];
				var v29: map<array<bool>, int> := map[v28[p1] := |v0|];
				var v30: map<map<array<bool>, int>, bool> := map[v29 := v17 in v0];
				v30 := v30[v29 := p2];
				globalState.f7 := p2;
				v3[242] := v27;
				var v31 := DC14(p2);
				v3[242], globalState.f22, v31 := v27, p2, v31;
			}
			
			globalState.f10 := |((v4 + fm22(p2, globalState)) + v4)|;
		} else {
			var v32: set<seq<char>> := {v0, seq(303, i0  => ('f'))};
			...
			v34[839] := p1 <= p1;
			v34[839] := p2;
			globalState.f13 := v34[839];
			var v35: set<bool> := {v34[839]};
			var v36: seq<bool> := [v34[839]];
			var v37: multiset<int> := multiset{p1};
			var v38: set<bool> := {!p2, v35 < {p2}, if (!p2) then v36[p1] else !p2, v34[839], v37 > v37};
			v35 := v38;
		}
		...
		v43[960] := new bool[14];
		globalState.f10 := p1;
		var v44 := DC1(0x392, p1, p1, v43[960]);
	...
	method m6(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState) returns (r0: char) {
		...
		v1[935] := p1;
		var v2 := false;
		v1[935] := if (!v2) then |(seq(835, i0  => (-p1)))| else p2;
		var v3: seq<bool> := [v2];
		globalState.f10 := v1[935] * -|v3[p3 := v2]|;
		if (v2 <==> v2) {
			var v4 := "ffxpkyq";
			globalState.f10, globalState.f10, v1[935] := -(|[v2]| * p0) % v1[935], -(|v0| % p3) + (|v4| / v1[935]), p2;
			var v5 := new C0(v4 != v4);
			var v6 := DC12(v5.f32);
			...
			globalState.f10 := (|v9| % -p3) % (p3 + p2);
			var v10 := 'n';
			globalState.f19 := v10;
		} else {
			globalState.f22, v1[935], globalState.f7 := fm21(-p3, globalState), p1, !(p3 > p0);
			var v11 := new C0(fm21(p2, globalState));
			var v12: multiset<bool> := multiset{v11.f32};
			var v13: map<bool, bool> := map[!!v11.f32 := !!v11.f32];
			globalState.f10 := if (v11.f32) then if (false in v12) then v12[false] else |v13| else v1[935];
			var v14 := new C0(v2);
			var v15 := "lroq";
			var v16: map<int, int> := map[v1[935] := p3];
			var v17 := DC7(v16);
			var v18 := 'x';
			var v19 := DC11(p3);
			var v20: seq<string> := [v15];
			var v21: array<string> := new string[28] [v15, seq(663, i1  => ('d')), fm23(v17, p2, -v1[935], globalState) + "dtnxh", seq(0x26c, i2  => ('t')), v15, v15, "vhcdvwyj", "chvp", v15 + v15, v15, seq(44, i3  => ('l')), v15, v15[0x30d := v18], v15 + "xjxlm", "kxppprism" + (seq(0x2a5, i4  => (v18))), "qghd", "ajvtl" + v15, seq(0x89, i5  => (v18)), v15, fm23(DC7(v16), 0x1a6, v1[935], globalState), v15, (seq(0x311, i6  => (v18))) + v15, v15, seq(-0x39e, i7  => (v18)), v15, "ytkqvx", v15[v19.cf22 := v18] + v15, v20[v1[935]]];
			v21[835] := v15;
			var v22: array<D4> := new D4[28];
			var v23 := DC13(v18);
			var v24 := DC15(v23);
			v22[31] := v24;
			v21[835], v1[935], v22[31], globalState.f7 := "akub", |v3|, v24, v11.f32;
		}
	...
	method m7(p0: int, p1: int, globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		...
		match (DC1(|v0|, -0x22c, p0, v2).(cf4 := if (v1) then v2 else v2)) {
			...
			case DC2(cf5, cf6) =>
				...
				var v10: array<int> := new int[5](i1 => i1 % cf5);
				var v11: seq<int> := [cf5];
				v10[735] := v11[fm2(globalState)];
				v10[735] := p1;
				r0 := v10;
				cf5 := cf5;
			case DC0(cf0) =>
				...
				v2[164] := (v1 || (v12.(cf6 := v1)).cf6) || false;
			...
			case DC3(cf7) =>
				...
				v18 := v18 + [v17, v17, v17];
				var v19: seq<seq<char>> := [seq(0x29f, i2  => (v17))];
				v18 := v19[|(if (v1) then v0 else v0)|];
				var v20 := DC0(v18);
				match (v20.(cf0 := v18 + v18)) {
					case DC1(cf1, cf2, cf3, cf4) =>
						...
						v26[431] := if (v1) then v25 else v25;
						var v27: map<map<int, bool>, bool> := map[map[cf2 := v1] := v1];
						var v28 := DC2(p0, v1);
						v18, v26[431], globalState.f13, v27 := v19[-cf3], v25, if (v1) then v1 else v28.cf6, v27;
						var v29: array<int> := new int[29];
						var v30 := DC17(v29);
						var v31: seq<array<int>> := [v30.cf28, v29, v29];
						r0, v2, r1, cf2 := v31[p1], v2, v1, cf1;
					case DC2(cf5, cf6) =>
						globalState.f13 := cf6;
						v2[413] := !(v18 == v18);
						var v32: map<bool, bool> := map[v1 := !v1];
						globalState.f10, v2[413], globalState.f10 := p1 % p1, cf6, if (fm30(true, globalState) == v32) then p1 / p0 else -cf5;
						var v33: seq<bool> := [v2[413]];
						var v34: seq<bool> := [v33[p0], v2[413]];
						v34 := v33;
					...
					case DC0(cf0) =>
						...
						var v40 := m6(fm0(p0, globalState), p0 * p1, v39[p0], p0, globalState);
						globalState.f22 := v1;
						var v41: array<int> := new int[24](i3 => i3 * p1);
						var v42: map<bool, array<int>> := map[v1 := v41];
						v42 := v42[v1 := v41];
						globalState.f13 := ((seq(0xd6, i4  => (v17))) + v18) < v20.cf0;
					case DC3(cf7) =>
						var v43: array<char> := new char[8];
						var v44: seq<array<char>> := [v43];
						v17, globalState.f22, v43 := 'p', v1, v44[0x59];
						v2 := v2;
						globalState.f10 := p0 / -p1;
						globalState.f22 := v1;
				}
		...
		for i6 := |v48| to p1 {
			...
			var v50: seq<int> := [i6];
			var v51: seq<int> := [if (!v1 in v49) then v49[!v1] else p1, i6, v50[p0], i6, i6];
			v2[129] := v51[i6] > i6;
			globalState.f22 := !v48[p1];
			var v52 := DC11(p1);
			match (v52) {
				case DC11(cf22) =>
					var v53 := "lkekff";
					...
					v54[428] := v53[-|(v55 * v55)|];
					var v56: map<multiset<bool>, bool> := map[multiset{v2[129], v1} := v2[129]];
					var v57 := DC4(v56);
					v57 := v57;
					var v58: multiset<bool> := multiset{v2[129], v2[129], v1};
					var v59 := m6(i6, cf22, i6, cf22 % (if (v1 in v58) then v58[v1] else --473), globalState);
				case DC12(cf23) =>
					var v60 := "bxjrgwaol";
					var v61: array<bool> := new bool[6] [cf23, v1, v1, cf23, v2[129], cf23];
					var v62: multiset<bool> := multiset{false};
					var v63: map<D3, bool> := map[v52 := v2[129]];
					var v64: seq<map<D3, bool>> := [v63];
					var v65: map<bool, bool> := map[cf23 := v2[129]];
					var v66 := DC14(v1);
					var v67 := DC15(v66);
					var v68 := DC15(v67);
					var v69 := DC20([0x24e], v61, v68, v2[129], p1);
					var v70: map<int, int> := map[414 := v69.cf34];
					var v71: array<int> := new int[25] [|DC18(seq(933, i7  => (map['m' := |v48|]))).cf29| % |v60|, p1, 0x2ba, p0, p0, p1, 0xf9, -(-p0 / |v48|), 504, p0, p0, |multiset{v61}| - -328, |v62|, i6 / -i6, |v64[|v62|]|, |(v60 + "gicvf")|, p0, 264, p0, -0x57, if (v1) then i6 else i6, i6 + p0, 487, |v65| % |v70|, i6];
					v71[364] := |v60|;
					v48, v51, v71[364] := v48 + v48, (seq(0x390, i8  => (i6))) + v50, p0;
					v65 := v65[v2[129] := !cf23];
					globalState.f7 := v48[i6];
					v65 := if (cf23) then v65 else v65 + v65;
				case DC10(cf21) =>
					globalState.f7 := v2[129];
					globalState.f13 := v2[129];
					var v72: map<int, seq<bool>> := map[i6 := v48];
					var v73: C0 := new C0(v2[129]);
					var v74: seq<C0> := [v73];
...
class C2 extends T1 {
	...
	method m0(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
		...
		var v16: multiset<seq<int>> := multiset{((v15[468 := p2])[p0 := |map[v5.f32 := -p2]|])[v0[146] := p0], seq(0x105, i0  => (-686))};
		v13[710] := fm32(v14, v5.f32, v14, globalState) - v16;
		var v17: seq<bool> := [p1];
		...
		v13[710] := if (v19 in v20) then v20[v19] else v16;
		if (p1) {
			f33 := f33;
			if (!p1) {
			...
			var v26: set<int> := {|v8|};
			var v27: map<bool, int> := map[p1 := -0x4c / |v26|];
			v27 := v27[p1 := v0[146]];
			var v28 := new C1();
		} else {
			...
			v2[168] := true;
			v2[168], globalState.f10 := v0[146] !in v18, if (p3) then |(map v30 : int | (0x1a0 <= v30) && (v30 < 0x336) :: (v30 / p0) := (p3))| else p0 % |v15|;
			globalState.f13 := p3;
			var v31 := DC22(v0[146], v2[168], v14);
			var v32 := DC16(map[!v31.cf37 := v5.f32]);
			match (v32) {
				case DC16(cf27) =>
					globalState.f13, globalState.f13, v0[146] := false, (v15 + v15) <= v15, p2;
					globalState.f7 := true;
					var v33: array<bool> := new bool[9] [675 >= v0[146], !(v4 !! v4), fm31(v4, globalState), v5.f32, v5.f32, v5.f32, false, v0[146] > p0, v5.f32];
			...
			var v36: map<int, bool> := map[|v17| := v2[168]];
			v35 := DC1(|v36|, |f33| + |fm33(v5.f32, v5.f32, p3, v5.f32, globalState)|, if (v0[146] in v18) then v18[v0[146]] else v0[146], v34);
		}
		
		if (p1) {
			if (false) {
				f33 := (f33 + f33[p0 := 'u']) + f33;
				v17 := v17 + (v17 + v17);
				...
				globalState.f22 := v38.fm21(v0[146], globalState);
				var v39: array<multiset<bool>> := new multiset<bool>[7];
				v39[967] := v1;
				v39[967] := multiset(v17 + (v17 + v17));
			}
			
			var v40 := new C0(!p3 <== v5.f32);
			var v41: array<D6> := new D6[27];
			v41 := if (p0 < |fm34(p1, f33[p2], v0[146], globalState)|) then v41 else v41;
			var v42: seq<seq<bool>> := [v17[p0 := p1] + v17, [v5.f32, false, v40.f32, fm31(multiset{p2}, globalState)]];
			var v43: map<bool, array<bool>> := map[v40.f32 := v2];
			var v44: set<array<bool>> := {if (p3 in v43) then v43[p3] else v2};
			var v45 := DC13(v14);
			var v46 := DC15(v45);
			var v47 := DC20(v15, v2, v46, v5.f32, v0[146]);
			v42, v0[146], globalState.f22 := [v17, v17, [!p3], v17], (p0 * p0) % p0, v44 !! {v2, v2, v47.cf31, v2};
			globalState.f7 := v5.f32;
		} else {
			var v48: map<bool, bool> := map[v5.f32 := v5.f32];
			v0[146] := -(p0 + |v48[p1 := v5.f32]|);
			var v49: map<string, bool> := map[f33 := p1];
			v48 := v48[v5.f32 := if (f33 in v49) then v49[f33] else p1];
			var v50 := new C1();
			var v51: map<char, int> := map['t' := |([v15, [|f33|, p0]])[|f33| := v15]|];
			var v52: map<map<char, int>, string> := map[v51 := fm35(v0[146], p3, !v5.f32, globalState)];
			v52 := if (f33 < "nos") then v52[v51 := seq(-70, i1  => (v14))] else v52 + (map v53 : map<char, int> | v53 in fm36(v14, DC10(v1), p1, globalState) :: (v53) := ("wqaidjcb"));
			globalState.f7 := p1;
		}
	...
	method m1(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		v0[314] := DC18(([v3])[p1 := v3]);
		v0[314] := fm37(p1, p1, p1, globalState);
		f33 := "xcb";
		var v4: array<int> := new int[16](i1 => i1 % p1);
		v4[887] := p1;
		...
		v11[951] := !p2;
		v4[405] := p1;
		v4[887], v11[951], globalState.f10, v4[405], globalState.f10 := |(v2 + v2[fm2(globalState) := fm31(v6, globalState)])|, p2 <== !({p2, p2} !! fm38(|p0|, true, globalState)), p1 * (-0x231 % p1), |v6|, p1;
		forall i2 | 0 <= i2 < v4.Length {
			v4[i2] := i2 % v4[887];
		}
		var v12 := DC0(f33);
		var v13: map<int, string> := map[v4[887] := f33];
		var v14: array<string> := new string[20] [v12.cf0, DC0(f33).cf0, "gbvposwab", f33[p1 := v1], f33, "iwtorenfq", f33, if (p1 in v13) then v13[p1] else f33, "scc", "qltrd" + f33, seq(0x1e, i3  => (v1)), "ssiokybl", "atla", "j", f33[|v8| := v1], f33 + fm35(v4[887], !p2, v11[951], globalState), f33, "uokfrfjh", f33, fm35(308, p2, false, globalState)];
		var v15: map<bool, bool> := map[p2 := v11[951]];
		v14[597] := f33[|f33| := f33[|v15|]];
		v14[597] := f33;
		var v16: set<bool> := {p2, v6 > multiset{|v2|}};
		var v17: seq<set<bool>> := [v16];
		v16, v1 := (fm38(p1, p2, globalState) * v16) - v17[p1], v1;
		r0 := DC1(p1, p1 % p1, p1, v11);
		r1 := p2;
	}
}
...
class C3 extends T0 {
	...
	function fm2(globalState: GlobalState): int {
		match DC6(|map[false := |(set v0 : int | (0x18 <= v0) && (v0 < 0xb6) :: (v0 % 21))|]|, [[false, false], [false]], 0x1a7, !true) {
			case DC5(cf9, cf10, cf11, cf12) => cf9 / cf9
			case DC6(cf13, cf14, cf15, cf16) => cf13
			case DC4(cf8) => |"vpngnpve"| % |map[0x368 := -382]|
		}
	}
	function fm8(p0: int, p1: int, p2: int, globalState: GlobalState): int {
		(|"yxgl"| * -0x204) % (0xb7 * |DC0("ulgojwmoa").cf0|)
	}
	function fm9(p0: int, p1: int, p2: int, globalState: GlobalState): D1 {
		DC4(DC4(map v0 : multiset<bool> | v0 in map[multiset{true, !false, true, false, false} := |map[-0x1fe := |(map v1 : int | (0x209 <= v1) && (v1 < 0x3e5) :: (v1 / 433) := (|[false]|))|]|] :: (v0) := (false)).cf8 + map[multiset{false, false, false, false} := false])
	}
	method m0(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
		var v0: map<int, int> := map[p0 := 604];
		var v1: map<int, int> := map[p0 := |v0|];
		var v2: seq<map<int, int>> := [v0];
		globalState.f22 := v2[p0 := DC7(v1).cf17] <= (v2 + v2);
		...
		var v8: array<D0> := new D0[16] [v5, v5, DC0(v4[v3[663] := v6]), v5, v5, v5.(cf0 := v4).(cf0 := v4), DC0(fm10(map[v3[663] := p0], fm11(v3[663], globalState), p3, globalState)), v5, v5, v5, v5, v5.(cf0 := v5.cf0), v5, DC0(if (p3 in v7) then v7[p3] else v4).(cf0 := v4), v5, v5];
		v8[494] := v5;
		var v9: seq<bool> := [true, p1, !p1];
		v8[494] := (if (!v9[p0]) then v5 else DC0(v5.cf0)).(cf0 := (v4 + "q")[p2 := v6]);
		var v10: map<int, bool> := map[|v9| := p3];
		var v11: map<int, array<int>> := map[|v10[v3[663] := p1]| := v3];
		v11 := v11[p0 := v3];
		if (p3 <==> !p1) {
			v3[663] := |fm10(v0 + v1, 's', p3, globalState)|;
			var v12: multiset<int> := multiset{p2};
			var v13: map<multiset<int>, seq<int>> := map[v12 := (seq(510, i0  => (p0)))[p2 := p0]];
			var v14 := DC5(|v9|, p1, p1, v13);
			v3[663] := -(|v10| - (v14.(cf12 := v13, cf9 := p2, cf11 := p3)).cf9);
			v3[663] := p2;
			globalState.f22 := fm12(p1, p1, globalState);
			var v15: map<D0, bool> := map[DC0(v4) := p1];
			var v16: array<bool> := new bool[21] [p1, p1, if (v8[494] in v15) then v15[v8[494]] else p1, p1, false, p3, true, p3, false, p3, p1, p3, p3, p1, p1, p1, true, p1, p3, p1, false];
			var v17: map<int, array<bool>> := map[p2 := v16];
			var v18: seq<array<bool>> := [v16, v16, v16];
			v17 := v17[p0 := v18[fm2(globalState)]];
		} else {
			var v19 := new C0(p3);
			v4 := seq(133, i1  => (v6));
			...
			if (fm12(!p3, v19.f32, globalState)) {
				...
				var v21: seq<int> := [p0];
				v3[663] := (|v7| * |v20|) + |(v21 + fm14(false, -0xf8, p2, globalState))|;
				var v22, v23, v24 := m4(v4, |v21|, globalState);
				globalState.f22 := v9[p0];
				var v25: map<array<int>, char> := map[v3 := 'u'];
				v25 := v25[v3 := v6];
				var v26 := new C0(p1);
			} else {
				var v27 := new C0(map[!p3 := v9] == map[!v9[-175] := v9]);
				globalState.f22 := !v27.f32;
				globalState.f13 := p1;
				v10 := v10[p0 := !v19.f32];
				globalState.f10 := (|v10| + |v4|) / (-p2 + v3[663]);
			}
			
			globalState.f19 := if (v19.f32) then v6 else if (v19.f32) then v6 else v6;
		}
		
		var v28: array<map<int, bool>> := new map<int, bool>[14] [v10, v10 + v10[v3[663] := true], map[-p0 := p3], v10 + v10, v10, map[v3[663] := p1], v10, if (p1) then v10 else map[v3[663] := p1], v10, v10, map[v3[663] := !p1] + v10, v10 + v10[p2 := p1], v10 + v10[v3[663] := !p3], v10];
	...
	method m1(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		v0[300] := v1;
		v0[300] := if (fm12(p2, p2, globalState)) then v1 else v1;
		var v2 := "nnaijwfws";
		globalState.f10 := |v2|;
		v1[582] := p2;
		v1[582] := DC6(|"ydkxlx"|, [[p2, p2, p2, p2, p2]], p1, !p2).cf16;
		var v3 := new C0(true);
		var i0 := 0;
		while (p2)
			decreases 100 - i0
		{
			...
			var v7 := new C0(!((fm15(v5, p1, fm12(v1[582], p2, globalState), globalState)).cf21 != v6));
			var v8: map<int, int> := map[p1 := |map[v5 := DC2(p1, false)]|];
			var v9: seq<int> := [p1, -p1 * p1, p1, -(if (p1 in v8) then v8[p1] else p1), -191];
			var v10: seq<bool> := [v1[582]];
			var v11: set<bool> := {v1[582], v1[582], p2};
	...
	method m4(p0: string, p1: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: T0) {
			...
			decreases 100 - i0
		{
			...
			globalState.f7, r0, v0, v5, v1[201] := v0, v6[p1] !in v7, fm12(v0, v0, globalState), v5, v10.cf9;
			var v11: array<bool> := new bool[24];
			v11[349] := true;
			v11[349] := v0;
			var v12 := DC11(v1[201]);
			var v13: set<array<int>> := {v1, v1};
			v1[201] := -((v12.(cf22 := -v1[201])).cf22 + (p1 - |v13|));
		}
		for i1 := p1 to p1 {
			...
			v18[212] := false;
			var v19: set<int> := {p1};
			r0, v18[212], globalState.f10 := fm12(v0, i1 < |v19|, globalState), false, p1;
			var v20: array<map<int, bool>> := new map<int, bool>[15](i2 => v14);
			v20[420] := fm18(p1, v0, globalState);
			v20[420] := v14;
			var v21: array<seq<char>> := new string[16](i3 => p0);
			var v22: map<int, seq<char>> := map[-100 := p0];
			v21[897] := (if (i1 in v22) then v22[i1] else p0)[p1 := fm11(p1, globalState)];
			var v23 := 't';
			v21[897] := [v23] + p0;
			var v24 := new C0(fm12(v18[212], v18[212], globalState));
		}
		for i4 := |p0| to p1 {
			...
			if (v31[i4]) {
				...
				v34[507] := v35[p1];
				v34[507] := if (fm12(v0, v0, globalState)) then v25 else v25;
			} else {
				...
				v36[514] := fm12(v36[514], if (v26 in v37) then v37[v26] else if (p1 in v38) then v38[p1] else true, globalState) || v0;
				v0 := true;
		...
		if (v41[p1] <==> fm12(v0, v0, globalState)) {
			var v42 := DC2(p1, v0);
			...
			match (v44) {
				case DC11(cf22) =>
					...
					var v47: map<seq<int>, map<int, bool>> := map[(seq(0x2dd, i7  => (p1))) + fm14(v0, cf22, fm0(cf22, globalState), globalState) := v46];
					var v48: seq<int> := [p1];
					v47 := v47[v48 := v46];
				...
				case DC12(cf23) =>
					...
					v55[538] := p1;
					var v56: multiset<string> := multiset{p0, seq(0x2be, i8  => ('o'))};
					var v57: C0 := new C0(false);
					globalState.f13, globalState.f10, r1, globalState.f10, v55[538] := v41[|(v56 + v56)|], |[v57]| + p1, -p1, p1, p1;
					globalState.f10 := p1;
					var v58: map<bool, int> := map[false := v55[538]];
				...
				case DC10(cf21) =>
					...
					v65[709] := v60 + (set v67 : int | v67 in v66 :: (v67 * |"mbi"|));
					v65[709] := {p1};
					var v68 := 'd';
					var v69 := DC13(v68);
					var v70: seq<D4> := [v69];
			...
			globalState.f7 := v0;
			var v72: array<bool> := new bool[8] [v0, fm12(v0, v0, globalState), v0, v41[p1], if (v41[fm0(p1, globalState)]) then v0 else v0, v0, !v0 && v0, v0];
			var v73: map<bool, bool> := map[v0 := v0];
			v72[557] := v73 == v73;
			v72[557] := v0;
			var v74 := "rlvkgkw";
			v74, v74 := v74, p0 + "opjwmmjub";
			var v75 := new C0(v72[557]);
			var v76: T0 := new C1();
			var v77 := 'h';
		...
		var v81: map<multiset<int>, seq<int>> := map[v79[-|v80| := -0x38c] := seq(687, i9  => (p1))];
		...
		match (v82) {
			case DC5(cf9, cf10, cf11, cf12) =>
				if (cf10) {
					...
					cf9, v84 := p1, (v84 + v84)[|multiset{v85, v85, v85}| := multiset{v0, v0}];
					var v86: map<bool, bool> := map[v0 := cf11];
					var v87 := 'p';
					var v88: seq<int> := [|v86|, cf9, |{v87}|, cf9];
					var v89: seq<seq<int>> := [v88, v88];
					var v90: map<seq<int>, bool> := map[if (cf11) then v89[cf9] else v88 := cf11];
					v90 := v90;
					...
					globalState.f10, v100, v101[930], v103 := |p0| % p1, v100, v102, v103;
					var v104: seq<int> := [cf9, p1];
					globalState.f10 := -v104[cf9] * cf9;
					r1 := -p1;
					globalState.f10 := cf9;
					var v105: map<bool, char> := map[cf11 := v102];
					var v106: array<map<bool, char>> := new map<bool, char>[3] [v105 + v105, map[cf11 := v101[930]], v105];
					v106[669] := v105;
					var v107: map<bool, bool> := map[true := cf10];
					v106[669] := v105 + map[if (v0 in v107) then v107[v0] else cf10 := v102];
				}
				...
				match (v109.(cf28 := v108)) {
					case DC17(cf28) =>
						...
						v110 := v110[fm8(|"isvwjc"|, -69, cf9, globalState) / p1 := |(map v111 : multiset<bool> | v111 in v113 :: (v111) := (cf9))|];
			...
			case DC6(cf13, cf14, cf15, cf16) =>
				var v117 := "esqyiagdp";
				var v118 := 'w';
				var v119: map<bool, string> := map[v0 := v117[cf13 := v118]];
				v117 := v117[|(if (!v0) then v117 else if (v0 in v119) then v119[v0] else p0)| := v118];
				globalState.f13 := if (v0) then cf16 else fm0(cf13, globalState) < p1;
				var v120: map<bool, bool> := map[!v41[271] := true];
				var v121: set<bool> := {cf16, v0};
				globalState.f13 := if ((v121 >= v121) in v120) then v120[v121 >= v121] else v0;
				var v122: array<bool> := new bool[8];
				var v123: map<int, array<bool>> := map[0x338 / cf13 := v122];
				v123 := v123[|v120| := v122];
			case DC4(cf8) =>
				...
				v127[345] := p1 >= v125[p1];
				v127[345] := [v0, v0] != (if (v0) then [v0] else v41);
				globalState.f13 := v127[345];
				var v128: array<array<multiset<int>>> := new array<multiset<int>>[5];
				var v129: set<bool> := {true};
				var v130: array<multiset<int>> := new multiset<int>[9] [v79, v79, v79, multiset{p1, p1}, multiset(seq(0x1e, i12  => (961))), v79, v79, v79, multiset{|v129|, p1}];
				v128[19] := v130;
				v128[19] := new multiset<int>[11];
		}
	...
	method m5(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		var v10: map<string, D1> := map[("bk")[p0 := v5] := v9];
		var v11: map<bool, map<string, D1>> := map[p2 := v10];
		var v12 := "rwbrc";
		v11 := v11[!(v12[p0 := v5] <= "wouynh") := v10[v12 := v9]];
		var i3 := 0;
		while (p1)
			decreases 100 - i3
		{
...
class C4 extends T0, T1 {
	...
	function fm2(globalState: GlobalState): int {
		-(if (if (false) then false else false) then 0x3cd + -|[631]| else |(if (true) then ['t'] else seq(0x165, i0  => ('a')))|)
	}
	...
	method m0(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v0 := "gjwrovu";
			var v1 := 'o';
			var v2: map<int, multiset<int>> := map[|v0[-|map[p2 := 0x3e1]| := v1]| := multiset{p2}];
			v2 := v2[p2 := (multiset([0x3d3, p0, p0]))[p0 := p2]];
			var v3: set<bool> := {p3, p3};
			var v4: T0 := new C3();
			var v5: seq<T0> := [v4];
			var v6: multiset<set<bool>> := multiset{v3, v3};
			if ((multiset{fm7(p1, p3, globalState), v3, {p1}})[{p3} := |v5|] <= v6) {
				var v7 := DC8(p3, p1);
				var v8 := DC9(v7);
				var v9: map<char, int> := map[v1 := p0 / |(map[p0 := v8])[p2 := v8]|];
				v9 := v9[v1 := p2];
				var v10: array<int> := new int[11];
				v10[954] := p0;
				v10[954] := -p0 / p0;
				v10 := v10;
				var v11: seq<int> := [742, fm2(globalState), v10[954]];
				...
				v17[86] := p2;
				globalState.f10, globalState.f13, v17[86] := p0, v1 !in "xnwqqkdl", p2;
				var v18 := new C0(false);
				var v19: map<bool, char> := map[false := v1];
				var v20: seq<bool> := [p1];
				var v21: seq<bool> := [v20[p2]];
				v19 := v19[v21 != v21 := v1];
				globalState.f10 := -p0;
			}
			...
			if (p3) {
				...
				var v34: seq<int> := [--fm2(globalState) * p2, |(if (!v32[49]) then v0 else v0)|, -p2 % p2];
				v34 := v34;
			} else {
				var v35 := new C3();
				var v36: seq<string> := [v0];
				var v37: map<bool, int> := map[p3 := p0];
				var v38: array<string> := new string[16] [fm10(map[|v0| := |v3|], v1, p1, globalState), v0 + "gdhniefl", v0, v0, v0, v0, "arq", v0, (seq(0x309, i4  => (v1))) + v0, v0, v36[|v37|] + v0, "pl", v0, "abm", (seq(0x17d, i5  => (v1))) + v0, v0];
				v38[692] := v0 + v0;
				v38[692] := (seq(0x392, i6  => (v1))) + ((seq(577, i7  => ('x'))) + v0);
				globalState.f10 := p0;
		...
		for i8 := p0 to -238 {
			...
			var v50: seq<int> := [|v46|, |v49[p2]|];
			var v51: array<int> := new int[15] [p0, if (v44 in v45) then v45[v44] else p2, 0x2aa / -113, i8, fm0(i8, globalState), |v41| * p2, 584, p0, p0, i8 - --7, p2, p2, v43.fm2(globalState), v50[p0], p0];
			v51[233] := if (p1) then p2 else p2;
			globalState.f10, v51[233] := i8 + p0, p2;
			if (!!p1) {
				globalState.f10 := v51[233] / i8;
				globalState.f7 := !p1;
				var v52 := 'l';
				var v53 := DC13(v52);
				var v54 := DC15(v53);
				...
				var v61 := new C2(v44);
				globalState.f13 := p1;
				v51[233] := |(seq(0x2d8, i9  => ('j')))|;
			}
			
		}
		var v62: array<seq<D4>> := new seq<D4>[26];
		forall i10 | 0 <= i10 < v62.Length {
			v62[i10] := (seq(0x2c0, i11  => (DC13('n')))) + (seq(0x53, i12  => (DC13('q'))));
		}
		if (if (!(p0 != p2)) then p1 <== p3 else p3) {
			...
			var v66 := 'a';
			var v67: map<array<seq<bool>>, char> := map[v65[p2] := v66];
			v67 := v67[v64 := v66];
			globalState.f7 := p3;
			...
			match (DC10(fm24(p2, p1, globalState)).(cf21 := v71[p1 := -p2])) {
				case DC11(cf22) =>
					...
					var v81 := "pwm";
					v77, globalState.f10, globalState.f22, v79 := v77, v80[p0], fm2(globalState) != |v81|, if (false) then v79[cf22 := v76.f32] + v79 else v79;
				case DC12(cf23) =>
					var v82 := 'j';
					...
					var v85 := "tmjx";
					var v86: multiset<int> := multiset{p2, |v84|, |fm39(globalState)| % p2, -|("ywd" + v85)|};
					...
					globalState.f10 := (p0 - p0) / 0x306;
					var v90: array<string> := new seq<char>[11] [seq(0x1b1, i15  => (v82)), (v85[p2 := v82])[|(seq(465, i16  => (v82)))[|v85| := v82]| := 'h'], v85, seq(0xe, i17  => (v82)), v85, v85, fm10(fm33(p3, p3, true, true, globalState), v82, p3, globalState), "pyctsgo", v85[|v85| := v82], "qdgk", v85];
			...
			if (p3) {
				...
				var v106: map<bool, int> := map[v102[p2] := v104[|v105|]];
				var v107: map<bool, array<array<int>>> := map[v106 == v106 := v101];
				v101 := if (v102[p2] in v107) then v107[v102[p2]] else v101;
				...
				v113[626] := p0 % |v116|;
				v113[739] := p2;
				v113[332], globalState.f22, v115, v113[626], v113[739] := (p0 * p2) * 0x175, fm5(p3, ["ochwdrjm", v116], p1, globalState), v115, -(fm6(globalState) * |(v70 + v70)|), |v116|;
				...
				globalState.f13, v118[189], v119, globalState.f22 := v120 != (if (p3) then v120 else v120), v117, if (p3 in v121) then v121[p3] else v119, p3;
				globalState.f10 := (p2 * p0) % p2;
				v118[189][716] := p3;
				v118[189][716] := p3;
				globalState.f10 := p0;
			}
		...
		forall i19 | 0 <= i19 < v125.Length {
			v125[i19] := ("roywi" + "fllqnoebg") + (seq(0x397, i20  => ('b')));
		}
	}
	method m1(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		r1 := p2;
			...
			decreases 100 - i0
		{
			...
			var v4 := 'k';
			v0, v1 := if (-0x12c in v2) then v2[-0x12c] else ("phjwav" + v0)[|v3| := v4], if (p2) then v1 else v1;
		...
		if (v10.cf21 !! (v9 + v9)) {
			...
			var v23: map<int, bool> := map[|multiset{|(seq(91, i1  => (|v12|)))|, |(map v21 : int | v21 in v22 :: (v21 / -0x1e6) := (p2))|}| := fm5(p2, seq(0x374, i2  => (v12)), p2, globalState)];
			...
			var v26: multiset<int> := multiset{p1 % |v25|, p1, p1, p0[p1] - p1};
		...
		if (p2) {
			...
			if ((v37.(cf5 := p1)).cf6) {
				...
				var v46: map<int, seq<int>> := map[p1 := p0[|v45| := p1]];
				...
				var v51: seq<string> := [v36.f33, (if (p2 in v50) then v50[p2] else v36.f33)[0x89 := v49], v35 + v35];
				v51 := (v51 + v51) + v51;
			}
			
			v36.m0(|v35|, p2, -(p1 % p1), true, globalState);
			globalState.f10 := -((p1 - p1) / p1);
		} else {
			globalState.f13 := p2;
			globalState.f10 := |v9| + (0x92 + p1);
			var v52: map<int, int> := map[fm6(globalState) / p1 := |map[0 := p0]| * p1];
			v52 := v52[p1 := 0x349];
			globalState.f10 := 622;
			...
			var v58: array<int> := new int[26] [|map[[p1] := p2]|, p1, p1, p1, p1, p1, |v53|, p1, |v55|, p1, p1, p1, p1, p1, if (p1 in v54) then v54[p1] else p1, |v54[p1 := p1]|, |v56|, p1, p1, |v56|, p1, |v57|, p1, p1, p1, p1];
			var v59: map<array<int>, bool> := map[v58 := p2];
			globalState.f10 := 0x1bf + |v59|;
		}
		
		var v60: map<int, int> := map[-p1 % -889 := -(if (p2) then p1 else p1)];
		v60 := v60[p1 := 0x235];
		var v61: seq<bool> := [p2];
		...
		var v67 := DC1(|v61[p1 := p2]|, p1, if (v65.cf10) then -p1 else |v61|, v66);
		r0 := v67;
	...
	method m2(globalState: GlobalState) returns (r0: array<int>) {
		...
		var v8 := DC3(v4[|(set v7 : map<int, int> | v7 in v6 :: (v7))|]);
		var v9: map<int, D0> := map[v1 := v8];
		var v10 := "w";
		var v11 := DC11(v1);
		var v12: multiset<int> := multiset{v1};
		var v13: map<multiset<int>, seq<int>> := map[v12 := seq(0x328, i1  => (-553))];
		var v14 := DC5(|"csvrecknv"|, v2, v2, v13);
		var v15 := DC5(v1, false, v2, v14.cf12);
		var v16: array<int> := new int[3](i2 => i2 / |v10|);
		...
		v18[476] := v1;
		v18[476] := v1;
		var v19: map<bool, set<array<int>>> := map[v18[476] <= v1 := {v16, v16, v18}];
...
class C5 extends T1 {
	...
	method m0(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState) {
		if (p1) {
			...
			v0[161] := v2;
			v0[161], globalState.f22 := v2 - v2, p1 <==> p1;
			v1[417] := p3;
			var v3: seq<bool> := [true];
			var v4: set<bool> := {p1, p3, v3[f30]};
			v1[417] := v4 > ({false} - {!p1, p1, p1, true, p1});
			var v5: array<seq<int>> := new seq<int>[7](i1 => (seq(723, i2  => (p2))) + (seq(604, i3  => (DC2(p0, p1).cf5))));
			var v6: multiset<int> := multiset{p0, 0x103};
			v5, v6, globalState.f7 := v5, v6, v1[417] && !v1[417];
			var v7 := "spjomng";
			var v8 := DC0(v7 + v7);
			v8 := v8;
			...
			var v15 := "vkarjbt";
			v14[929] := v15 + v15;
			v14[929] := fm35(603, p1, f30 != 0xa2, globalState);
			...
			var v28: map<multiset<map<int, bool>>, seq<map<D2, int>>> := map[if (p1) then v18[|map[|v21| := p0]|] else (multiset{map[if (p1 in v22) then v22[p1] else |v23| := p1], v24})[v24 := p2] := v27];
			v28 := v28[v17 := seq(11, i6  => (v26))];
			var v29 := 'c';
			v14[929] := (fm23(DC7(v19), -(if (p1 in v22) then v22[p1] else p2), -p0, globalState))[p0 := v29];
		}
		...
		var v36 := DC11(p0);
		var v37: seq<int> := [|v34|, |(map v35 : int | v35 in fm14(p1, p2, v36.cf22, globalState) :: (v35 % |map[p1 := v34]|) := (v31))|, f30 + fm0(p0, globalState)];
		v30[535], f30, v30[16], f30, globalState.f10 := -(p0 - p2), p2, v37[p0 * p0], |([-p0, -948] + v37)| * (p2 + f30), |"iqxo"|;
		var v38 := DC2(v30[535], !p3);
		v38 := v38;
		var v39: C3 := new C3();
		var v40: multiset<C3> := multiset{v39};
		var v41: map<int, int> := map[|v40| := v39.fm8(p2, -0x2c, p0, globalState)];
		v41 := v41[0x2e8 := v30[535]];
		var i7 := 0;
		while (p3)
			decreases 100 - i7
		{
			...
			if (p3) {
				...
				var v44 := DC14(p1);
				var v45 := DC15(v44);
				var v46 := DC20(([f30])[|v41| := |v43|], v42, v45, p3, f30);
				var v47 := DC0(v43);
				v42[491], globalState.f7, globalState.f13, globalState.f10 := v46.cf33, p3, (v43 + v47.cf0) == (v43 + (seq(936, i9  => (v31)))), p2;
				var v49: seq<bool> := [v42[491]];
				var v50: seq<seq<bool>> := [v49];
				v46 := v46.(cf34 := |(map v48 : seq<bool> | v48 in multiset(v50) :: (v48) := (v42[491]))| / v30[535], cf30 := v37);
				var v51: array<seq<bool>> := new seq<bool>[25](i10 => DC21(v49).cf35 + [v42[491]]);
				v51 := v51;
				var v52: array<D1> := new D1[14];
				var v53: map<bool, array<D1>> := map[v42[491] := v52];
				var v54: seq<array<D1>> := [if (false in v53) then v53[false] else v52, v52, v52, v52];
				var v55: array<array<D1>> := new array<D1>[6] [v52, v54[v37[f30]], v52, v52, v52, v52];
				var v56: T1 := new C4(v55);
				v56 := v56;
				var v57: array<string> := new string[11];
				v57[248] := seq(427, i11  => (v43[|map[v31 := p2]|]));
				v49, v57[248] := fm34(p1, v31, if (v42[491]) then v39.fm2(globalState) else |v33|, globalState), (seq(-404, i12  => (v31))) + v43;
			} else {
				var v58: array<D3> := new D3[1](i13 => v36);
				v58[34] := v36;
				v58[34] := fm40(|v34|, false, p3, globalState).(cf22 := v37[0x143]);
				v30[535], v30[535], globalState.f10 := v30[535], p0, f30;
				globalState.f7 := p3;
				var v59: C1 := new C1();
				...
				v30[535] := (if (p1) then v30[535] else |v62|) * p2;
			}
			
			var v63 := "v";
			v63, globalState.f10 := (seq(0x2e, i14  => (v31)))[f30 := v31], |(v34 - multiset(v37))|;
			if (p3) {
				...
				var v77: array<bool> := new bool[26] [p3, true, !p1, p1, false, p3, p1, !true, p3, p3, p3, p3, fm4(v63, |v76|, globalState), p1, p1, p1, p3, !false, false, p3, p1, fm4("whc", |map[v30[535] := 0x8a]|, globalState), p1, p3, p3, p3];
				var v78 := DC14(p3);
				var v79 := DC15(v78);
				var v80 := DC20(v37, v77, v79, p3, p0);
				v74[516] := v80;
				v74[516] := DC20((seq(0x138, i15  => (|"flxdys"|))) + (seq(-0x392, i16  => (p0))), v77, v79, p3, p0);
				var v81: map<string, seq<int>> := map[v63 + fm10(v41, v31, p3, globalState) := [v30[535]]];
				v81 := v81[v63 := v37];
				var v82: map<int, array<bool>> := map[0x2a8 := v77];
				v77 := if (v30[535] in v82) then v82[v30[535]] else v77;
			}
			
			var v83: array<bool> := new bool[29];
			v83[222] := v30[535] >= v30[535];
			v83[222] := fm4(v63, |v63|, globalState);
		}
	}
	method m1(p0: seq<int>, p1: int, p2: bool, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		for i0 := p1 to p1 / |v0| {
			...
			globalState.f10, v9, globalState.f7 := i0 - 0x178, v9, v2[i0];
			var v10 := 'b';
		...
		if (multiset{v21, v21} !! multiset{v21}) {
			...
			match (v23) {
				case DC5(cf9, cf10, cf11, cf12) =>
					...
					var v35: array<map<D8, int>> := new map<D8, int>[5] [map[DC21(v29) := |v30|] + (map v31 : D8 | v31 in v33 :: (v31) := (|{|v17|}|)), v34[DC21(v29[cf9 := p2]) := |v30|], v34, v34, map[v32 := f30] + v34];
					v35[948] := map[v32 := f30];
					globalState.f22, v28, v35[948] := cf10, v28, v34;
					cf9 := (p1 / f30) * (if (cf10) then -f30 else |v30|);
				case DC6(cf13, cf14, cf15, cf16) =>
					var v36 := "rmnqe";
					var v37: map<bool, string> := map[cf16 := v36];
					var v38: set<bool> := {true};
					v21[647] := -(if (cf16) then |multiset{|v37|, cf13, 0x11f}| else |v38|);
					...
					var v49 := DC20(p0, v42, v44, !cf16, p0[|(set v48 : int | v48 in v47 :: (v48 % 0x14a))|]);
					v21[647], globalState.f22, globalState.f10, cf13, v39[112] := -p0[cf13], v41.cf39, v49.cf34, p1, if (fm0(cf13, globalState) <= cf13) then v40 else v40;
					var v50: multiset<string> := multiset{v36, v36, "ybyitirvg"};
					v50 := v50;
					var v51 := new C0(p2);
					v42[631] := p2;
					v42[941] := cf15 < -|(seq(919, i2  => (0x191)))|;
					var v52: seq<set<bool>> := [v38, v38];
					globalState.f10, v42[631], v42[941], globalState.f13 := v51.fm13(cf13, globalState), !cf16, !!!p2, v52 <= v52;
				case DC4(cf8) =>
					...
					var v57: map<int, bool> := map[728 % p1 := p2 <== true];
					var v58 := "nvdnrsmts";
			...
			if (p2) {
				...
				v73 := v73[v71 := v21];
				globalState.f10 := -(|multiset{p2}| / p1) + f30;
				var v74 := "lcy";
				...
				v76[79], v77, globalState.f13 := p2, fm22(v78 >= {p0, p0, [|p0|]}, globalState), p2;
			} else {
				var v79: seq<bool> := [fm12(true, p2, globalState)];
				var v80 := "shrji";
				var v81: C0 := new C0(v79[|v80|]);
				var v82: seq<C0> := [v81];
				var v83: array<C0> := new C0[23] [v81, v81, v81, v81, v81, v81, v82[f30], v81, v81, v81, v81, v81, if (p2) then v81 else v81, v81, v81, v81, if (v81.f32) then v81 else v81, v81, v81, v81, v81, v81, v81];
				v83[455] := v81;
				v83[455] := v81;
				globalState.f10 := |v80|;
				var v84: map<int, seq<int>> := map[|p0| := seq(0x159, i4  => (f30))];
				...
				v92[114] := fm41(|v93[f30 := v80]|, p2, fm24(0x5d, p2, globalState), v17, globalState);
				var v95 := DC13(fm11(p1, globalState));
				v90, v91, v92[114] := (map v94 : int | v94 in v0 :: (v94 / |v17|) := (v81.f32)) + v90, v91, v95;
			}
			
			if (false <== p2) {
				var v96 := 'i';
				var v97: multiset<char> := multiset{v96};
				globalState.f19, globalState.f10, f30, f30 := if (p2) then 'q' else v96, p1, p0[|v97[v96 := p1]|] - f30, f30;
				...
				v21[567] := -f30;
				v21[567] := p1 * (v68.fm2(globalState) * p1);
				globalState.f10 := if (v19 != v19) then p1 else f30;
				var v99: seq<bool> := [p2];
				var v100: multiset<seq<bool>> := multiset{v99, v99};
				var v101: multiset<bool> := multiset{p2};
				globalState.f10 := if (!p2) then |v100| else -(v21[567] + |multiset{v21[567], |v101|, f30}|);
				var v102: map<bool, int> := map[p2 := v21[567]];
				var v103 := "rbconal";
				v102 := v102[p2 := |v103|];
				globalState.f13 := p2;
			}
		...
		globalState.f10, r1, f30 := if (f30 < |[p2]|) then f30 else f30, p2, if (p2) then p0[|p0|] else |{p2}|;
		if (p2) {
			...
			var v110: array<array<char>> := new array<char>[17] [v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v107, v108.cf42, v107, v107, v109[f30]];
			var v111: seq<array<array<char>>> := [v110];
			v106[119], globalState.f22, globalState.f6 := p2, p2, v111[f30];
			var v112: multiset<set<int>> := multiset{{f30}};
			if (v112 > v112) {
				var v113: seq<bool> := [multiset{|map[false := p1]|, p1, p1, f30} >= v17, p2];
				v113 := fm22(!v106[119], globalState);
				var v114 := "bvnrgdjr";
				var v115: seq<seq<int>> := [seq(0x19c, i9  => (f30))];
				var v116 := 'm';
				var v117 := DC0(v114);
				var v118: array<string> := new string[11] [(v114 + (seq(177, i8  => ('n'))))[|v115| := v116], v114, v114, v114, v114, seq(-829, i10  => (v116)), v114, (seq(0x210, i11  => (v116))) + "aiqhwkuhp", v117.cf0, v114, v114 + v114];
				v118[600] := v114;
				var v119: map<bool, string> := map[v106[119] := seq(-0xdc, i12  => (v116))];
				var v120: map<array<bool>, int> := map[v106 := p1];
				v118[600] := if ((p2 && v106[119]) in v119) then v119[p2 && v106[119]] else fm23(v18, p1, |v120[v106 := p1]|, globalState);
				v118[600] := (v118[600] + v114)[|"d"| := v116];
				globalState.f22 := v106[119];
				var v121: seq<map<char, int>> := [map[v116 := 0x1d3]];
				var v122 := DC18(v121);
				var v123: seq<D7> := [v122, v122.(cf29 := v121)];
				globalState.f13 := fm4(v118[600], |v123|, globalState);
			} else {
				globalState.f10 := fm0(-0x211, globalState) / f30;
				var v124: multiset<bool> := multiset{p2};
				var v125: seq<bool> := [v106[119]];
				...
				v134 := v134[v106[119] := v133];
				var v135: set<int> := {-f30 + f30, f30};
				globalState.f24 := v135;
				var v136 := new C4(v133.f31);
			}
			
			globalState.f13 := -f30 >= (f30 / p1);
			v106[119] := p2;
			globalState.f13 := p2;
		} else {
			var v137: array<array<bool>> := new array<bool>[19];
			f29[77] := v21;
			v137, globalState.f10, f29[77], globalState.f10 := v137, f30, v21, f30;
			if (p2) {
				var v138: multiset<bool> := multiset{p2};
				globalState.f10 := (p1 / -|"ekgpmyva"|) + |(v138 + multiset{p2})|;
				globalState.f10 := p1 % (f30 / f30);
				globalState.f13 := p2;
				globalState.f7 := p2;
				globalState.f22 := false;
			} else {
			...
			var v149: seq<seq<int>> := [p0, [f30, -|(seq(0x3a9, i13  => (-f30)))|, f30], p0, p0, p0];
			var v150 := DC15(v146);
			v148 := if (p2) then DC20(p0[|v149[f30]| := p1], v145, v150, p2, |map[f30 := -p1]|) else v148;
			var v151 := new C1();
			if (-|map[f30 := fm4(v144, f30, globalState)]| >= |p0[f30 := |p0|]|) {
				var v152 := DC2(-p1, p2);
				var v153: seq<D0> := [v152];
				var v154: seq<seq<D0>> := [v153, v153, v153[f30 := v152], seq(0x16f, i14  => (v152)), v153];
				var v155: map<bool, seq<seq<D0>>> := map[p2 := v154[|v0| := v153]];
				...
				var v165 := 'y';
				v17 := fm17(f30, v164[p1], v165, globalState) * v17;
			...
			decreases 100 - i15
		{
			...
			globalState.f22 := p2;
			if (p2) {
				globalState.f10 := p0[p1] - f30;
				globalState.f10 := p1 % -f30;
			...
			if (p2 in (v177 + v177)) {
				...
				v182[260] := multiset([v179, v179, v180[719]]);
				...
				var v189: map<map<C0, D8>, multiset<string>> := map[v187 + v187 := multiset{fm23(v18, -|v188|, p1, globalState), v180[719], v180[719]}];
				globalState.f10, globalState.f7, v21[475], v181, v182[260] := p1, {p1} !! fm42(-f30, {p2, !p2}, p1, globalState), |(if (p2) then if (p2 in v178) then v178[p2] else fm23(v18, p1, f30, globalState) else v180[719])|, v181, if ((map[v183 := v186] + v187) in v189) then v189[map[v183 := v186] + v187] else multiset{v180[719], v180[719]} * multiset(seq(0x373, i16  => (v180[719])));
				globalState.f22 := p2;
			} else {
				globalState.f13 := p2;
...
method Main() {
	...
	var v6 := -551;
	var v7: array<seq<bool>> := new seq<bool>[2] [v3[v6 := v2], v3];
	var v8 := "wrohtasav";
	var v9: multiset<int> := multiset{|(seq(0xb1, i0  => (v6)))|};
	var v10: map<char, multiset<int>> := map[v8[v6] := v9];
	...
	var v18: array<string> := new string[18] [v8, v8, v8, v8, v8, v8[v6 := v13], v8, v17[v6], v8, v8, DC0(v8).cf0, v8, ("vfacyd")[v6 := v8[|v3|]], v8, v8, v8, v8, v8[v6 := v13]];
	var v19: set<int> := {|v3|};
	...
	match (DC3(v21).(cf7 := v21)) {
		case DC1(cf1, cf2, cf3, cf4) =>
			...
			v22 := v22;
			var v23 := new C1();
			var v24, v25 := v23.m1(v4[cf1 := cf1], if (v2) then cf1 else cf1, v2, globalState);
		case DC2(cf5, cf6) =>
			var v26: map<bool, bool> := map[v2 := cf6];
			v20 := v20[|v20| % cf5 := !(cf5 >= |(([!(if (v2 in v26) then v26[v2] else v2), cf6])[cf5 := cf6])[cf5 := v2]|)];
			m8(globalState);
		...
		case DC0(cf0) =>
			m8(globalState);
			var v28: array<char> := new char[21] [v13, v13, 'j', v13, v13, cf0[-v6], 'd', v13, v13, v13, 'p', v8[|v9|], v13, v13, v13, v13, v13, v13, v13, v13, v13];
			v28[472] := 'l';
			var v29: map<array<bool>, char> := map[v0 := v13];
			v28[472] := if (v2) then v13 else if (v0 in v29) then v29[v0] else v13;
			globalState.f10 := v6 * -(v6 + v6);
			var v30 := DC3(if (v2) then v21 else v21);
			match (v30) {
				case DC1(cf1, cf2, cf3, cf4) =>
					cf4[377] := fm12(v2, v2, globalState);
					cf4[377] := v2;
					cf3 := cf3;
					m8(globalState);
					cf0 := cf0;
				...
				case DC0(cf0) =>
					...
					v38[701] := |v39|;
					v38[701] := v4[0x280 - |v19|];
					v38[701] := v6;
					v0[491] := fm12(false, false, globalState);
					v0[491] := !("gr" !in v17);
				case DC3(cf7) =>
					v6 := v6;
					globalState.f10 := v4[-v6];
					m8(globalState);
		...
		case DC3(cf7) =>
			...
			if (multiset{v6} >= v9) {
				...
				globalState.f10 := fm0(-v6 % v6, globalState);
				globalState.f7 := v41.f32;
				var v42: array<int> := new int[16](i2 => i2 * v6);
				v42[251] := v6;
				var v44: seq<map<int, bool>> := [map[fm0(v6, globalState) := true], map v43 : int | (0x257 <= v43) && (v43 < -0x1d) :: (v43 / |v8|) := (v2)];
				v42[251] := (v6 / v6) + (v6 + -|[|v44|]|);
				...
				v50[796] := v46;
				v50[796] := v46;
				v50[796] := if (v2) then v46 else v46;
				m8(globalState);
				v0[587] := v2;
				v0[587] := !false;
			}
	...
	match (DC22(|v54|, v2, v13)) {
		case DC22(cf36, cf37, cf38) =>
			...
			cf37 := (if (!cf37) then v4 else v4) <= ((seq(0xfb, i3  => (v6))) + v4);
			var v57 := new C1();
		...
		case DC23(cf39) =>
			...
			var v62: seq<T0> := [v61];
			var v63: map<int, T0> := map[v6 / -v6 := v62[v6]];
			var v64: map<bool, bool> := map[v2 := v2];
			v58, v59[599], v63 := v58, v6 * (|v64| * v6), v63 + (v63 + v63);
			...
			v67[990] := if (cf39) then v13 else v68.cf38;
			var v69: map<int, seq<int>> := map[v59[599] := v4];
			v69 := v69[v6 := v4];
			var v70: C3 := new C3();
			var v71: seq<C3> := [v70];
			v6 := -(v6 * (|v71| - v6));
		...
		case DC24(cf40) =>
			...
			match (if (v75.cf25) then DC2(0x14e, !v2) else v77) {
				...
				case DC0(cf0) =>
					...
					v0[367] := if (fm12(v82.f32, if (v6 in v20) then v20[v6] else v2, globalState) in v84) then v84[fm12(v82.f32, if (v6 in v20) then v20[v6] else v2, globalState)] else !v2;
					v0[367] := v2;
					v9 := v9;
					globalState.f10 := v6 / (v6 * -|{v6}|);
				case DC3(cf7) =>
					...
					v85[4] := v0;
					v74[398], v85[4], v2 := fm11(v6, globalState), v0, !v2;
					v6 := v6;
					globalState.f10 := v6;
					v11[240] := v9;
					globalState.f10, v6, v11[240] := v6, -v6, multiset{v6, v6};
			}
			
			var v86: map<int, int> := map[v6 := |v54| / |v8|];
			var v87: C1 := new C1();
			var v88: seq<C1> := [v87];
			v86 := v86[|map[v88[if (v6 in v9) then v9[v6] else v6 := v87] := v2]| := v6];
		...
		decreases 100 - i4
	{
		...
		v94[899] := v6;
		globalState.f7, v98, v8, v94[899] := v13 !in v8, v98, v8, v6;
	}
	var v100: map<int, map<char, int>> := map[v6 := map v99 : char | v99 in v8 :: (v99) := (v6)];
	globalState.f10 := if (fm12(!v2, v2, globalState)) then |v100| * v6 else |v8| / v6;
	...
	if (!((v3 + DC21(v3).cf35) == v3)) {
		...
		match (v104.(cf21 := multiset{fm12(v2, v2, globalState)} - multiset(v3))) {
			...
			case DC12(cf23) =>
				...
				var v116: array<set<bool>> := new set<bool>[13] [v54, {cf23} + v54, v54, v54, v54, {v2, cf23}, v54, if (cf23) then if (v13 in v115) then v115[v13] else v54 else {v2, cf23}, {cf23, v3[-0x244], cf23, fm12(!cf23, false, globalState)}, v54, v54, v54, v54];
				var v117: map<bool, bool> := map[v2 := !true];
				var v118 := DC16((map[v2 := cf23])[false := cf23]);
				var v119 := DC29(seq(0x3e1, i7  => (0x15f)), v6, v2);
				...
				v120[180] := DC16(v117[cf23 := v2]);
				v102[860] := fm0(504, globalState);
				var v121: set<string> := {v8[-v6 := v8[v6]]};
				v116, v6, v120[180], v102[860], v6 := v116, v6 + |v8|, v118, v6 / |v121|, 951;
				globalState.f10 := v102[860];
				...
				v102[860], v122, v123[108], globalState.f7, v0[156] := v6 * (if (v2 in v129) then v129[v2] else v6), map[v8 := cf23] + v122, v18, fm0(|v132|, globalState) >= -0x312, v2;
			case DC10(cf21) =>
				globalState.f7, globalState.f7, v4 := fm12(v2, v2, globalState), true, [v6, v6, v6, v6, v6];
				v8 := (("qmpwft" + v8) + v8)[v6 := v13];
				var v133: array<C3> := new C3[24];
				var v134: C3 := new C3();
				v133[127] := v134;
				v133[127] := v134;
				v0[23] := fm12(!v2, v2, globalState);
				v6, v0[23], v6 := v6, fm12(v2, v2, globalState), if (true) then v134.fm8(v6, 0xb8, v6, globalState) else v134.fm8(|v19|, v6, |v3|, globalState);
		}
		...
		v141[288] := v140;
		globalState.f10, v141[288], globalState.f10 := v6 % --v6, v140, -|[if (|v19| in v20) then v20[|v19|] else v2]|;
		...
		m8(globalState);
		globalState.f10 := -(fm0(v6, globalState) % v6);
	...
	if (v2) {
		...
		var v158: map<set<T1>, string> := map[v157 := v17[v153.f30]];
		v158 := v158[v157 := v8 + v8];
		var v159: array<map<bool, bool>> := new map<bool, bool>[24](i8 => map[v2 := v3[v6]] + map[v2 := v2]);
		var v160: map<bool, bool> := map[v2 := v2];
		v159[459] := v160[v2 := v153.fm4(v8, v6, globalState)];
		v159[459] := (v160 + v160) + map[false := v2];
		v153.f30 := v153.f30;
	}
	
	var v161 := DC15(DC14(v2));
	globalState.f10 := DC20(v4[v6 := v6], v0, v161, v2, v6).cf34;
	if (v2) {
		var v162 := DC19();
		...
		if (v3[537]) {
			...
			v0[739] := if (!v2 in v166) then v166[!v2] else v2;
			v0[739] := v2;
			var v168: array<bool> := new bool[25](i9 => v0[739]);
		...
		var v179: map<int, map<char, array<bool>>> := map[|v177| := map['o' := v178[0x17d]]];
		...
		v180[522] := v176;
		v180[522] := (v176 + v176[v13 := v0]) + v176;
	}
