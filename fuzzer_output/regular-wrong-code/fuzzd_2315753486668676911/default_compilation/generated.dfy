...
function fm17(p0: int, globalState: GlobalState): int {
	|multiset([!false] + [false])| + (|(set v0 : int | (0x1ec <= v0) && (v0 < -555) :: (v0 / |(map v1 : int | (581 <= v1) && (v1 < 0x177) :: (v1 % |"vfftcgcr"|) := (|(seq(0x21c, i0  => ('s')))|))|))| * 0x1af)
}
function fm18(p0: int, p1: int, p2: multiset<char>, globalState: GlobalState): map<int, bool> {
	map v0 : int | v0 in ((seq(-246, i0  => (316))) + (seq(-167, i1  => (-88)))) :: (v0 % |{0x1c5, 0xf3}|) := (!true)
}
...
function fm30(p0: int, p1: bool, p2: set<int>, p3: bool, globalState: GlobalState): string {
	match DC35([map v0 : int | v0 in (map v1 : int | (-0x312 <= v1) && (v1 < 0x195) :: (v1 * |(seq(0x274, i0  => ('o')))|) := (false)) :: (v0 - 0x2b8) := (false), map v2 : int | (0xe3 <= v2) && (v2 < 0xaf) :: (v2 % |[-0x1ed]|) := (false)]) {
		case DC36(cf53) => "fsqaxwqte"
		case DC35(cf52) => "dxhjglaic" + (seq(-301, i1  => ('h')))
		case DC37(cf54) => "mplnkdwif"
	}
}
function fm31(p0: int, p1: int, globalState: GlobalState): multiset<int> {
	multiset{0x48} + multiset{77, |multiset{!DC55(|[186, |{false, false}|]|, |DC38(map[|(seq(116, i0  => ('s')))| := true]).cf55|, false, true).cf87, true, true}|, |"xmniuvfes"|, 0x2d8, 0x136}
}
...
function fm39(p0: int, p1: char, p2: seq<int>, p3: bool, globalState: GlobalState): seq<int> {
	([0x29d, |[multiset{930}, multiset{0x381, 342, -|multiset{false}|, |(seq(0x1f7, i0  => (162)))|}]|] + [|map[|map[true := 0x2dc]| := |"fnqkq"|]|]) + (if (false) then [157, |"rysmqpp"|] else [--412, |map[true := false]|, 193, |map[true := true]|, |[|[|map[|map[|"ng"| := false]| := 'x']|]|, -0x2ad]|])
}
function fm40(p0: int, p1: bool, p2: bool, p3: D8, globalState: GlobalState): D1 {
	DC2(if (true) then |"clskkt"| else |(seq(681, i0  => ('f')))|)
}
function fm41(p0: char, globalState: GlobalState): map<int, int> {
	(map[|"hjghubcnr"| := |[false, !DC52(0x110, true, true).cf82]|] + map[|(seq(-0x2e2, i0  => ('g')))| := |(set v0 : int | v0 in [-|"cxpjsdcn"|] :: (v0 / |multiset{854}|))|]) + (map[0x1c0 := |map[false := false]|] + map[-0x2cd := 806])
}
...
function fm44(p0: int, p1: bool, globalState: GlobalState): map<bool, int> {
	map[DC3("frlkbglny", !false).cf3 <= (seq(-0x264, i0  => ('j'))) := 0x2ba]
}
function fm45(globalState: GlobalState): seq<map<int, bool>> {
	[map[|"klqhbvu"| := false]] + [map v0 : int | (-0x237 <= v0) && (v0 < 0x14e) :: (v0 - |[false]|) := (DC33(true).cf50), map v1 : int | v1 in (seq(0x189, i0  => (-|[[false], [true], [false]]|))) :: (v1 % -|{false}|) := (!!true)]
}
...
function fm47(p0: bool, p1: int, globalState: GlobalState): multiset<string> {
	(multiset{seq(0x1d, i0  => ('s')), seq(0xa8, i1  => ('f')), "pabhldsjv", "cksrrod", "mwrut"} + multiset{"ddnqnu", "nb"}) * (multiset(["itm", seq(0xb1, i2  => ('t')), "juvss"]) * multiset{seq(0x29d, i3  => ('b'))})
}
...
function fm50(p0: bool, p1: bool, p2: int, p3: bool, globalState: GlobalState): multiset<multiset<D2>> {
	(multiset{multiset{DC6(-0xae)}} + multiset{multiset{DC6(|"udq"|), DC6(|"ivkmw"|)}}) * multiset{multiset([DC6(0xd6), DC6(0x215)]), multiset{DC6(|[|(seq(0x28e, i0  => ('f')))|, |map[|"dxvtbcyv"| := true]|, |[true]|]|), DC6(|(seq(286, i1  => ('i')))|)}, multiset([DC6(|multiset{false}|)]), multiset([DC6(|multiset{DC42(false, false, true), DC42(!true, !false, false), DC42(!false, false, false)}|), DC6(|"resvq"|), DC6(|multiset{true}|), DC6(|[|"lhcaqip"|]|), DC6(|"og"|)]), multiset{DC6(473), DC6(|(map v0 : int | (-474 <= v0) && (v0 < -0x106) :: (v0 * 0x165) := (true))|)}}
}
...
function fm52(globalState: GlobalState): seq<D11> {
	(if (true) then [DC31(DC28(set v1 : int | v1 in [|(map v0 : int | (0x14e <= v0) && (v0 < 762) :: (v0 / 0x262) := (|{!true}|))|] :: (v1 * |[true, false, false]|))), DC31(DC29())] else [DC31(DC29()), DC31(DC29()), DC31(DC28({-0x284}))]) + ((seq(0x21f, i0  => (DC31(DC28({0x2b7}))))) + [DC31(DC29()), DC31(DC31(DC30(true, |(map v2 : int | v2 in map[|multiset{|map[|"fviyvd"| := 'h']|, -349}| := false] :: (v2 + 461) := (multiset{true}))|)))])
}
function fm53(p0: int, globalState: GlobalState): D3 {
	DC10(-0x11a, -0x74 / |map[!true := false]|)
}
...
function fm56(p0: int, p1: int, globalState: GlobalState): D7 {
	DC22({!false} >= {!false, false}, |("cwvgtdwty" + "q")|, multiset{false, true, true, true, true} < multiset{false, true, true}, |(seq(498, i0  => (|map[!false := true]|)))| * -0x31d)
}
function fm57(p0: int, p1: map<int, D5>, globalState: GlobalState): multiset<D7> {
	(multiset{DC22(false, |multiset([true])|, false, 0x1e3), DC22(true, -0xab, false, 0x2eb)} - multiset{DC22(false, 640, false, |map[0xdb := -0x18f]|), DC22(!!true, --|map[-|[true]| := 't']|, false, |{false, true, true}|)}) * multiset{DC22(!true, 898, false, |(seq(-0x85, i0  => ('h')))|)}
}
function fm58(p0: bool, p1: char, globalState: GlobalState): map<int, D21> {
	map[-0x9d := DC57(0x1ac, 475, DC14('p', true, |{true}|, DC49(true, !false, 'o', false).cf76))] + (map[|"irgs"| := DC57(|multiset{|multiset{0x13b}|, 0x27f, -|(seq(0xca, i0  => ('w')))|, 0x2a8, 0x1e}|, |"yptolnu"|, DC14('o', false, |"tusd"|, false))] + map[490 := DC57(0x32e, -0x378, DC14('i', !true, 374, true))])
}
...
function fm60(p0: map<int, bool>, p1: int, globalState: GlobalState): D19 {
	DC52(|"i"| % 0x3e2, multiset{false} >= multiset{false}, !!false)
}
trait T0 {
...
class C0 {
	...
	function fm28(p0: seq<seq<int>>, globalState: GlobalState): string {
		((seq(0x354, i0  => ('d'))) + "o") + "fdqgbyeq"
	}
	function fm29(p0: seq<bool>, p1: string, p2: bool, p3: int, globalState: GlobalState): bool {
		DC14('n', false, |map[|map[true := DC21(739, |(map v0 : int | v0 in map[|"sosvg"| := 968] :: (v0 % |multiset{false, false}|) := (-0x142))|, true, !true, false)]| := 206]|, !true).cf21
	}
}
...
class C1 {
	...
	method m13(p0: D7, p1: int, globalState: GlobalState) returns (r0: char, r1: int, r2: D7, r3: D1) {
		...
		var v2: set<int> := {p1};
		v0, v1[958] := v2 >= v2, 38;
		var v3: seq<int> := [-v1[958]];
		var v4 := DC16(v3);
		var v5: map<bool, bool> := map[v0 := v0];
		v1[958] := -|multiset(v4.cf23)| / (v1[958] * |v5|);
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			match (DC19(v7 + v7[p1 := v6])) {
				case DC20(cf29) =>
					var v8 := "slrsv";
					var v9 := 'c';
					var v10: map<bool, int> := map[!!(v8 != v8[v1[958] := v9]) := p1];
					v10 := v10[v0 := p1];
				...
				case DC21(cf30, cf31, cf32, cf33, cf34) =>
					...
					var v14: array<seq<bool>> := new seq<bool>[28] [v13, v13 + v13[cf31 := cf34], v13, v13[p1 := !v0], [v0, !!cf32], v13, v13, fm27(globalState), v13, v13, fm27(globalState), v13[cf31 := fm26(globalState)], [true, cf32, v0, cf34] + v13, [cf32], v13, v13, v13, v13, v13, v13, [cf34, v0], v13, [cf33, v0], [cf33, cf34, false, true, cf32], v13, v13, v13, v13];
					var v15 := DC26(v14);
					var v16: seq<seq<int>> := [v3[0x3bf := p1]];
					cf33, v14, globalState.f7, v1[958] := p1 <= cf30, v15.cf43, |v16|, cf30 + p1;
					var v17: multiset<int> := multiset{cf30, -v1[958]};
					var v18 := 'r';
					var v19 := "fk";
					var v20: seq<char> := [v19[p1]];
					var v21: map<multiset<int>, D5> := map[v17 := DC14(v18, v13[p1], --|v19|, v0)];
					v21 := v21;
				...
				case DC19(cf28) =>
					...
					v24[591], globalState.f7, v0, globalState.f4, v0 := v25 + v25, p1 - v1[958], !(v26 >= v26), p1, !v0;
			}
			...
			v32, globalState.f4, v1, globalState.f13, globalState.f4 := v32, --0x1a0, v1, -|v33|, |v34| * (p1 * v1[958]);
		}
		var v35 := DC5(v1);
		match (v35) {
			case DC6(cf7) =>
				var v36: map<int, bool> := map[v1[958] := v0];
				var v37: seq<bool> := [!v0];
				v0 := !((map[p1 := v0] == v36) <==> v37[cf7]);
				var v38: map<int, char> := map[fm25(v0, v0, globalState) := 'b'];
				var v39: array<seq<bool>> := new seq<bool>[20] [v37, ([v0])[|v38| := false], v37, v37, [v0], v37, v37, v37, v37, fm27(globalState), [v0, v0, v0], v37, v37, v37, [v0, fm26(globalState)], v37, [!false, true], v37, v37, v37[fm25(v0, !v0, globalState) := v0]];
				var v40 := DC26(v39);
				match (v40) {
					case DC26(cf43) =>
						var v41 := "owcdswdik";
						var v42: seq<char> := [v41[v1[958]]];
						globalState.f15 := -|v41|;
						var v43 := DC23(v37);
						...
						globalState.f7 := cf7 * v1[958];
						var v47: map<int, int> := map[cf7 % |v41| := cf7];
						var v48: multiset<int> := multiset{v1[958]};
						var v49: set<bool> := {v0};
						var v50 := 't';
						var v51: array<bool> := new bool[11] [v49 !! v49, v0, {|v3|} !! v2, true, v1[958] == fm25(false, v0, globalState), v0, v0, v0, v50 in v42, !v0 && v0, multiset{v0, v0} > multiset{v0}];
						v51[236] := if (v1[958] in v36) then v36[v1[958]] else true;
						v47, v48, v51[236] := v47, v48, v0 ==> v0;
				}
				...
				if (v52 in (v53 + v53)) {
					...
					v54[416], v55 := v0, v55;
					v52, v54[416] := v52, !!v0;
					v54[416], globalState.f7, v54[416], v0, v54[416] := v54[416], cf7, (v0 <== true) ==> v0, fm26(globalState), v54[416];
					var v56: map<int, seq<bool>> := map[p1 := [v54[416]]];
					r0 := if ((0x36f - |(if (v1[958] in v56) then v56[v1[958]] else v37)|) in v38) then v38[0x36f - |(if (v1[958] in v56) then v56[v1[958]] else v37)|] else v52;
					var v57: set<bool> := {v0};
					var v58 := DC22(v0, cf7, v37[p1], v1[958]);
					var v59: seq<D7> := [v58, v58];
					v53 := (v53[|v57| := v52] + fm30(|v59|, fm26(globalState), set v60 : int | v60 in v3 :: (v60 / 0x16), v54[416], globalState)) + v53;
				} else {
					var v61: array<bool> := new bool[12] [v0, true, v0, v0, v0, v0, v0, v0, v0, v0, true, v0];
					v0 := (-|map[v61 := 0x124]| / cf7) <= v1[958];
					globalState.f7 := v1[958];
					...
					v64, v61[419], v0, globalState.f15, v0 := v64 + v64, v0, (0x69 - |v68|) in (seq(-919, i6  => (|map[v0 := v0]|))), -271, v3 != v3;
					var v69 := DC16(v3);
					var v70 := DC18(v69);
			...
			case DC7(cf8, cf9, cf10) =>
				...
				var v76: multiset<int> := multiset{p1, v1[958]};
				var v77: set<multiset<int>> := {v76, v76, fm31(v1[958], v1[958], globalState)};
				v75[578] := v77;
				v75[578] := v77 * v77;
				globalState.f13 := p1;
				var v78 := "vs";
				...
				if (v0) {
					...
					globalState.f13 := -(v1[958] + fm25(cf8, cf8, globalState));
			...
			case DC5(cf6) =>
				...
				v85 := (v85 + v85)[0x30e := v0];
				v0 := p1 > v1[958];
				v35 := v35;
				v0 := (p1 / p1) != (114 * p1);
			case DC8(cf11) =>
				v0 := fm26(globalState);
				v1[958] := -(-v1[958] / v1[958]);
				var v86 := "wxgofwv";
				var v87 := 'e';
				...
				v91[954] := v86;
				v91[954], globalState.f15 := v86, p1;
				var v92 := DC20(p1);
				v92 := v92;
		}
		...
		v0, v0, globalState.f15, globalState.f15, v93[687] := v0, v96 !! ((set v97 : multiset<bool> | v97 in [v95] :: (v97)) - v96), v1[958], p1 - (|v98| + 0xbc), v0;
		for i8 := fm25(v0, v0, globalState) to v1[958] {
			v3 := v3 + (seq(0x264, i9  => (0x23e)));
			globalState.f15 := if (|(v2 * v2)| in v98) then v98[|(v2 * v2)|] else v3[p1] - i8;
			var v99: set<bool> := {v0, v0, v0, !v93[687], true};
			v94, globalState.f7, v93[687] := v94[p1 := v93[687]] + (v94 + v94), fm25(v0, v93[687], globalState), fm32(|v94|, v1[958], v99, globalState) == (fm32(|(seq(0xbc, i10  => (v1[958])))|, 466, v99, globalState) - v2);
			globalState.f15 := fm25(!!true, v93[687], globalState) / i8;
		}
		var v100 := DC17(true, v93[687], !v93[687]);
		r0 := match v100 {
			case DC17(cf24, cf25, cf26) => 'c'
			case DC16(cf23) => if (v93[687]) then 'b' else 'y'
			case DC18(cf27) => 'x'
		};
		r1 := p1;
		var v101: seq<array<bool>> := [v93];
		r2 := if (!v93[687]) then DC19(v101) else p0;
		var v102 := "lpsnk";
...
class C2 extends T1, T0 {
	...
	function fm7(p0: int, globalState: GlobalState): multiset<set<int>> {
		multiset{{0x75} - {-|map[|multiset([true])| := 0x2a7]|}, {-|map["yjblw" := DC3("ywhli", false).cf4]|, -|{DC20(0x382).cf29, |[|map[--596 := 483]|]|, 0x2e}|}, set v0 : int | v0 in multiset{0x102, |{false, false, true, true}|} :: (v0 % |(set v1 : int | (0x238 <= v1) && (v1 < 0x12d) :: (v1 * |map['y' := !true]|))|), {|[false, !false]|} - {-746}}
	}
	function fm8(p0: int, p1: bool, p2: int, globalState: GlobalState): bool {
		if (true ==> !false) then !(DC10(|(map v0 : int | v0 in multiset{0x32d} :: (v0 * |[|[0x253, |map[true := |map[|map[true := 'a']| := true]|]|]|]|) := (true))|, |[true, true]|) in map[DC10(818, |"fve"|) := -|"aclnkmm"|]) else 0x28d < |(seq(0x1e8, i0  => (0x30e)))|
	}
	function fm1(p0: map<bool, map<bool, bool>>, p1: int, globalState: GlobalState): bool {
		true
	}
	...
	method m6(p0: int, p1: multiset<bool>, p2: bool, p3: D2, globalState: GlobalState) {
		for i0 := p0 to -p0 % 693 {
			...
			v3[591], v0 := (p0 / i0) % |{v0}|, fm1(v5 + v5[p2 := v4], i0, globalState);
			v0 := !v0;
		}
		var v6 := false;
		var v7 := "qtrupg";
		...
		v13[801] := if (v6) then v15 else v15;
		v13[801] := v15;
		...
		v22[977] := v25 + v25;
		var v27 := DC28(v17);
		var v28: multiset<string> := multiset{seq(0x3ba, i2  => ('l')), fm30(p0, p2, v27.cf45, p2, globalState), v7};
		v16, v21, v22[977], globalState.f4, v6 := v16, (map v26 : string | v26 in v28 :: (v26) := (v18))[v7 := v18 + v18], v25, p0, v6;
		var v29: array<char> := new char[25](i3 => if (v6) then 'g' else 'e');
		var v30 := 'l';
		v29[341] := v30;
		var v31: array<bool> := new bool[1] [p2];
		v31[89] := v6;
		v29[341], v27, v31[89], globalState.f7, globalState.f13 := v30, DC28(v17), p2, p0, p0;
	}
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
		var v0: seq<string> := [seq(-0x4d, i0  => ('s'))];
		var v1 := DC11(v0 + [p0]);
		match (v1) {
			case DC12(cf16) =>
				var v2: array<int> := new int[28](i1 => i1 / 344);
				v2[354] := cf16;
				v2[354] := cf16;
				var v3 := false;
				if (v3) {
					globalState.f4 := v2[354];
					var v4: map<int, int> := map[v2[354] := cf16 - cf16];
					v4 := v4;
					var v5: array<D3> := new D3[28](i2 => DC9('v'));
					var v6 := 'm';
					var v7 := DC9(v6);
					v5[894] := if (v3) then v7 else v7;
					v5[894] := v7;
					v2, globalState.f7 := v2, v2[354] / v2[354];
					v3 := !!!v3;
				} else {
					globalState.f13 := v2[354];
					v2[354] := -v2[354];
					globalState.f15 := -v2[354];
					var v8 := DC10(v2[354], -cf16);
					var v9: map<D3, bool> := map[v8 := v3];
					var v10: multiset<int> := multiset{|v9|};
					var v11: seq<int> := [0x2d0];
					var v12 := DC4(v10);
					var v13: seq<multiset<int>> := [multiset{v2[354], cf16}];
					var v14: map<int, bool> := map[|v10| := v3];
					var v15: array<multiset<int>> := new multiset<int>[23] [multiset{v2[354]} - v10, v10, multiset(v11 + (seq(222, i3  => (|{cf16}|)))), v10, v10, v10, v10, v12.cf5, v10, fm31(cf16, v2[354], globalState), v10, v13[v2[354]], v10, v10, multiset{|v14|, v2[354]}, v10 - v10, v10, multiset{v2[354]}, multiset(v11), v10, v10, v10, multiset{v2[354], -|p0|, |v11|, 0x20e}];
					v15[564] := v10 - v10;
					v8, v3, v15[564] := v8, v3, v10;
					m12(v3, v3, v2, DC22(v3, v2[354], v3, v2[354]).cf35, globalState);
				}
			...
			case DC11(cf15) =>
				...
				var v23: array<bool> := new bool[10] [v19, v19, v19, v19 <==> v19, if (v19) then v19 else v19, v19, v20 >= {v19}, v19, !(v21[v18] <==> v19), v22.cf4];
				v23 := v23;
				if (v19) {
					...
					v24 := v24;
					var v25 := new C0();
					var v26: map<int, int> := map[v18 / v18 := v18];
					...
					globalState.f13 := |(seq(0x32f, i5  => ('l')))|;
					var v29 := new C0();
					var v30 := new C1();
				}
		...
		var v37: map<bool, array<bool>> := map[v34[|v36|] := v31];
		...
		globalState.f15 := --(if ([v31] in v38) then v38[[v31]] else |v39| / v35);
	...
	method m11(p0: array<bool>, p1: seq<bool>, p2: set<bool>, p3: bool, globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
		...
		if (v1 == {v0}) {
			...
			v2[436] := |[v2, v2, v2]|;
			v2[436] := v0 * v0;
			globalState.f7 := v2[436];
			var v3 := DC7(p3, fm34(v0, v0, p3, globalState), v2);
			match (v3) {
				case DC6(cf7) =>
					var v4 := false;
					v4 := !fm8(cf7, p3, v2[436], globalState);
					var v5 := new C1();
				...
				case DC7(cf8, cf9, cf10) =>
					...
					var v9: map<int, set<int>> := map[v0 := {if (v0 in v8) then v8[v0] else 0x11e, |(fm35(globalState))[v2[436] := cf8]|} + v1];
					var v10: array<bool> := new bool[22];
					var v11: map<int, array<bool>> := map[v0 := p0];
					var v12 := "jf";
					var v13: map<multiset<int>, char> := map[v8[|v12| := -v2[436]] := v7];
				...
				case DC5(cf6) =>
					...
					var v23 := "racjbb";
					var v24 := DC3(v23, p3);
					v21[91], v24, globalState.f13 := v22, if (p0[300]) then v24 else v24, v2[436];
				case DC8(cf11) =>
					var v25: map<bool, int> := map[p3 := -v0];
					var v26: seq<int> := [0x14b, v2[436]];
					var v27: multiset<int> := multiset{v26[v2[436]], 86};
					var v28: seq<multiset<int>> := [multiset{if (p3 in v25) then v25[p3] else v2[436]}, v27, v27];
					v28 := v28;
					var v29: map<int, bool> := map[v0 := p3];
					v2[436] := --((|[|v29|]| / v0) * (v2[436] * v0));
					globalState.f13 := v0 / v2[436];
					p0[129] := fm26(globalState);
					p0[129] := false;
			}
			
			v2[436] := v0 / v0;
			var v30: seq<array<int>> := [v2];
			var v31: seq<array<int>> := [v30[v2[436]], v2, v2];
			v31 := v31;
		} else {
			var v32: array<bool> := new bool[24](i1 => p1[v0]);
			...
			v34 := v0 >= (if (p3) then |multiset(v36[v0 := v0])| else v0);
			v34 := p3;
		}
		...
		for i2 := v0 to -680 {
			...
			var v42: seq<D0> := [v39];
			v41 := v41[|("ayhpbe" + (seq(0x265, i3  => ('a'))))| := multiset(v42)];
			...
			if (p3) {
				var v44 := "bypilo";
				v44, globalState.f15 := v44 + v44, -v43[370];
				var v45 := new C0();
				v38 := v43[370] != v0;
				...
				v38, v57[994], v58, v38 := v38, if (-v43[370] >= v43[370]) then v56 else seq(0x160, i5  => (v50)), (v58[v43[370] := v56] + v58) + v58, !v38 <== p3;
				var v59 := new C1();
			}
			...
			decreases 100 - i6
		{
			...
			v62[420] := -(|{v0}| + v0);
			v62[420] := -v0;
			var v63: map<bool, set<bool>> := map[true := {p1[v62[420]]}];
			var v64: map<int, set<bool>> := map[v62[420] := {!p3}];
	...
	method m12(p0: bool, p1: bool, p2: array<int>, p3: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			p2[561] := v5;
			p2[561] := |(set v6 : int | (0xda <= v6) && (v6 < 0x9d) :: (v6 + |multiset{p1, p0}|))|;
			var v7 := DC6(v5);
			var v8 := DC8(v7);
			match (v8) {
				case DC6(cf7) =>
					...
					var v12: seq<int> := [p2[561]];
					v11[348] := v12;
					var v13: map<int, bool> := map[p2[561] := p0];
					v11[348] := ((seq(0x1ac, i2  => (cf7))) + (if (p0) then v12 else v12))[p2[561] := |v13|];
					var v14: array<bool> := new bool[26];
					var v15 := DC1(v14);
					var v16: set<array<bool>> := {v15.cf1, v14};
					v16, v5, v9, v9 := v16 + v16, p2[561] - 0xb9, -cf7 >= (cf7 % cf7), v2 < (v2 + "sqk");
				case DC7(cf8, cf9, cf10) =>
					globalState.f13 := -p2[561];
					var v17: array<bool> := new bool[13](i3 => p1);
					var v18: multiset<string> := multiset{seq(0x72, i4  => (v1)), v2};
					var v19: set<bool> := {p3};
					var v20: seq<bool> := [p1];
					var v21 := DC2(|v20|);
					var v22: map<int, D1> := map[p2[561] := v21];
					v17[121] := !(v18 != multiset{"wqrdii", fm30(|v19|, p1, {v5, |v22|, v5}, p3, globalState), seq(-0x34a, i5  => (v1)), v2});
					var v23: map<bool, bool> := map[p3 := p0];
					v17[121] := if (p0 in v23) then v23[p0] else p1;
					v5 := p2[561] - v5;
					v2 := DC3(v2, true).cf3;
				case DC5(cf6) =>
					...
					globalState.f4, globalState.f4, v24[964], v1, globalState.f7 := p2[561], |v26| + p2[561], v25, v2[p2[561] - |v2|], v5;
					var v27: seq<int> := [fm2(v5, globalState)];
					p2[561] := (fm2(p2[561], globalState) % p2[561]) + v27[v5];
					var v28 := false;
					...
					var v32, v33, v34 := m11(v24[964], v30, v31, v5 <= -0x337, globalState);
				case DC8(cf11) =>
					globalState.f4 := v5;
					var v35: set<int> := {p2[561], v5, |"l"|};
					var v36: seq<int> := [|v0|];
					var v38: seq<set<int>> := [v35, {p2[561]}, set v37 : int | v37 in v36 :: (v37 - |map[DC20(0x13b) := true]|), {fm2(p2[561], globalState)}];
					var v39: seq<set<int>> := [{p2[561], p2[561]}, v35, v38[p2[561]], v35];
					globalState.f13 := |v39[p2[561] + p2[561]]|;
					var v40: map<int, string> := map[p2[561] := v2];
					var v41 := DC14(v1, p3, -v5, p0);
					v2 := (if (v5 in v40) then v40[v5] else v2) + v2[v5 := v41.cf18];
					p2[561] := v5 % v5;
			}
...
class C3 extends T0 {
	...
	function fm2(p0: int, globalState: GlobalState): int {
		(if (!f25) then |multiset([328])| else --0x21c) % 0x2ca
	}
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
		var v0 := -0x8c;
		var v1: seq<int> := [v0, v0];
		var v2: map<int, int> := map[v0 := v1[v0]];
		...
		var v11: array<int> := new int[28] [-941 / v0, v0, if (f25) then v0 else 0x1a6, v0, |v2| * v0, v0, v0, if (!f25 in v3) then v3[!f25] else v0, |p0| % (if (v4 in v5) then v5[v4] else v0), 25, v0 / v0, -0x7f, v0, v0, 19, |v7|, -v0, v0, v0, |v9|, v0, v0 + 652, v0, |v9|, if (f25 in v10) then v10[f25] else v0, v0 % v0, v0, -v0 % v0];
		v11[7] := v0;
		var v12: array<seq<int>> := new seq<int>[17] [[v0, 0x23c, v0], v1, seq(0x1b8, i1  => (v0)), [0x3c9], v1[v0 := v0], v1, [v0, |map[f25 := fm2(|v3|, globalState)]|], v1, [|"nht"|], [v0, v0], v1, DC16(v1).cf23, v1, v1, v1[|p0| := v0], v1, v1];
		var v13: seq<array<seq<int>>> := [v12, v12, v12];
		var v14: array<array<seq<int>>> := new array<seq<int>>[15] [if (f25) then v12 else v12, v13[v0], if (f25) then v12 else v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v12, v12];
		v14[229] := v12;
		v11[7], globalState.f15, v14[229], v0 := 0xfa, v0, v12, -DC2(v0).cf2 / v0;
		v0 := v0;
		var v15: array<bool> := new bool[9];
		var v16: seq<array<bool>> := [v15];
		var v17 := DC19(v16);
		f25, v4, v16 := f25, v4, v17.cf28;
		for i2 := |v2| - -v0 to if (f25) then v0 else v11[7] {
			var v18: array<map<char, bool>> := new map<char, bool>[24];
			var v19: seq<array<map<char, bool>>> := [v18, v18, v18];
			var v20: array<array<map<char, bool>>> := new array<map<char, bool>>[29] [v19[|p0|], v18, v18, v18, v18, v18, v18, v18, v18, v19[v11[7]], v18, v18, v18, v18, v18, if (true) then v18 else v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18];
			v20[447] := v18;
			var v21 := DC6(v11[7]);
			v20[447], f25, f25, v21 := v18, f25, true, v21;
			globalState.f4 := v0;
			f25 := f25;
			f25 := (v0 == |p0|) ==> f25;
		}
	...
	method m10(globalState: GlobalState) returns (r0: set<int>, r1: array<int>, r2: seq<map<int, bool>>) {
		...
		v0[361] := !(if (f25) then f25 else f25);
		var v1 := 0xc7;
		var v2: set<int> := {v1};
		...
		var v5: seq<bool> := [f25];
		var v6 := DC23([f25, f25]);
		v0[361], globalState.f4, f25, v3, v4 := (v5 + v6.cf39) < [f25, f25], -v1 + v1, (v1 % v1) != -740, v3, v4;
		...
		f25 := |(if (f25) then v10 else seq(159, i1  => (v1)))| !in v10;
		var v11: multiset<bool> := multiset{f25};
		var v12 := "bpoxflb";
		var v13 := DC21(if (f25 in v11) then v11[f25] else |v12|, v1, false, f25 <== v0[361], false);
		match (v13) {
			case DC20(cf29) =>
				if (v0[361]) {
					var v14 := new C1();
					v7[857] := v1 % |v5|;
					v0[361], f25, v7[857], r1, v0[361] := f25, v0[361], |((seq(0x314, i2  => (v4))) + "tswns")|, v7, fm39(v1, v4, v10, !f25, globalState) < ([cf29, -|(seq(0x13e, i3  => (DC28(v2))))|, |v12|] + v10);
					f25 := false;
					var v15 := DC2(|v10|);
					var v16: array<D1> := new D1[20] [v15, v15, v15, v15, DC2(v1), v15, DC2(cf29), v15, DC2(v10[|v12[|v2| := v4]|]), DC2(cf29), v15, v15, v15, v15, v15, DC2(v7[857]).(cf2 := v1), v15, v15, v15, fm40(v7[857], v0[361], f25, v6, globalState)];
					v16 := v16;
					v7[857] := 603;
				} else {
					var v17: map<set<int>, bool> := map[v2 := f25];
					v10 := (if (if (v2 in v17) then v17[v2] else fm26(globalState)) then v10 else v10) + [v1];
					var v18: map<int, bool> := map[v1 := v0[361]];
			...
			case DC21(cf30, cf31, cf32, cf33, cf34) =>
				match (DC28(v2).(cf45 := v2)) {
					case DC29() =>
						...
						var v27 := DC20(316);
						globalState.f4, cf32, v26, cf32, cf32 := cf31, [true, !f25] != v5[v27.cf29 := v0[361]], v26, cf34 <== f25, cf32;
					case DC30(cf46, cf47) =>
						var v28: map<int, int> := map[-980 := |map[cf34 := v1]|];
						var v29: map<int, string> := map[-|map[cf32 := if (cf31 in v28) then v28[cf31] else v1]| := seq(0x3b, i4  => (v4))];
						var v30 := DC2(cf30);
						var v31: set<D1> := {v30};
				...
				match (DC13(v48 + multiset{v2, v2, v2})) {
					...
					case DC13(cf17) =>
						...
						var v53: map<bool, string> := map[v0[361] := v12];
						var v54: seq<string> := [v12, v12, v12, v12, v12];
						var v55: seq<seq<string>> := [[v12, v12, if (!v0[361] in v53) then v53[!v0[361]] else v12, v12], v54[v1 := v12], v54];
						v7[563], v1, v52, cf33, v11 := cf30 * v1, |v55[-fm2(cf31, globalState)]|, v52, true, v11;
						var v56: array<multiset<set<bool>>> := new multiset<set<bool>>[6];
						var v57: set<bool> := {f25, cf32, v0[361]};
						var v58 := DC32(v57);
						v56[650] := (multiset{v57, v58.cf49, v57, v57, v57})[v57 := cf31];
						var v59: multiset<set<bool>> := multiset{v57};
						var v60: map<bool, int> := map[cf32 := cf30];
						v56[650], v0[361], globalState.f7 := v59 + (v59 * v59), fm26(globalState), v10[if (!!cf34 in v60) then v60[!!cf34] else cf30];
						globalState.f15 := cf31;
						var v61: map<int, bool> := map[v1 := cf33];
						var v62: map<map<int, bool>, int> := map[fm35(globalState) := cf31];
						var v63: array<int> := new int[10] [|v10| / v1, |v61| % |v62|, cf30, -v7[563], |v61| / cf30, cf30, v7[563], v7[563], cf31, fm2(v7[563], globalState)];
						r1 := v63;
					case DC15(cf22) =>
						var v64: map<bool, int> := map[false := |v12|];
						var v65 := DC34(v64);
						var v66: multiset<map<bool, int>> := multiset{v64, v65.cf51, map[v5[cf30] := v1] + fm44(cf30, true, globalState), v64 + map[fm26(globalState) := cf30]};
						globalState.f4 := if (v64 in v66) then v66[v64] else v1 % v1;
						globalState.f7 := v1;
						v7 := DC7(v0[361], v11, v7).cf10;
						cf34 := cf31 in v10;
				}
			...
			case DC22(cf35, cf36, cf37, cf38) =>
				...
				var v72: map<bool, seq<D3>> := map[v0[361] := v71];
				var v73: map<bool, bool> := map[cf35 := f25];
				v72 := map[if (v0[361] in v73) then v73[v0[361]] else cf35 := ([v69, v69])[cf36 := v69]];
				cf37 := v2 <= v2;
				v0[361] := fm26(globalState);
			case DC19(cf28) =>
				var v74: map<int, char> := map[655 := 'g'];
				v0[361], v74, v0[361], v1, v7 := f25, v74, v0[361], v1 - -v1, v7;
				v5 := v5;
		...
		for i6 := |v76| to if (v12 in v77) then v77[v12] else v1 {
			...
			v0[361], f25, v78 := v0[361], true, if (v78.fm1(v81, i6, globalState) in v79) then v79[v78.fm1(v81, i6, globalState)] else v78;
			v0[361] := v0[361];
		}
		var v82 := new C1();
		r0 := {v1, |"pvydf"|};
		var v83: multiset<int> := multiset{v1};
		r1 := if ((fm42(|(seq(-0x10d, i7  => (0x17)))|, v1, globalState)).cf5 !! v83) then v7 else v7;
		var v84: map<int, bool> := map[v1 := v0[361]];
...
class C4 extends T1 {
	...
	function fm7(p0: int, globalState: GlobalState): multiset<set<int>> {
		DC13(multiset{{-0x1d8, |['h']|, |[false, true]|}}).cf17 * (multiset{{-0x8c}, set v0 : int | (0x1d6 <= v0) && (v0 < 0x1be) :: (v0 * |[|multiset{false, true, false}|, |(seq(0x19c, i0  => ('s')))|]|)} + multiset{{|[false, false]|, 0x2c6}})
	}
	function fm8(p0: int, p1: bool, p2: int, globalState: GlobalState): bool {
	...
	function fm23(p0: map<bool, D4>, p1: int, p2: int, globalState: GlobalState): int {
		(if (!true) then 0x38d else 0x2db) % (if (true) then |"xueolns"| else |"apewrwfc"|)
	}
	method m6(p0: int, p1: multiset<bool>, p2: bool, p3: D2, globalState: GlobalState) {
		...
		match (v1) {
			case DC1(cf1) =>
				...
				var v5: seq<bool> := [p2];
				var v6 := "wnhu";
				v4 := v4[v5[|v6|] := if (p2) then v3 else v3];
			...
			case DC0(cf0) =>
				...
				v8[914] := {if (p2 in v10) then v10[p2] else p2};
		...
		if (v21 >= v21) {
			...
			var v26 := 'f';
			var v27: seq<int> := [p0];
			v22[586], v23, v0[405], v25 := v26, v23, !!fm8(v27[p0], if (p2) then v25 else v25, p0, globalState), v25;
			...
			if (p2) {
				...
				v25, v23 := false, fm30(p0, p2, v31[p0], !!!(v32 > v32), globalState);
				v0[405] := !p2;
				var v33: seq<string> := ["rfny"];
				var v34 := DC11(v33);
				var v35: map<bool, D4> := map[v0[405] := v34.(cf15 := v33)];
				var v36: T1 := new C2();
				var v37: seq<T1> := [v36, v36];
				globalState.f13 := fm23(v35, |v33[p0]| / |v37|, p0, globalState);
				v25 := (|p1| - p0) > p0;
			} else {
				var v38: seq<string> := [v23];
				var v39: map<bool, D4> := map[p2 := DC11(v38)];
				var v40: set<int> := {p0, fm23(v39, |v23|, -0xc1, globalState), |[p0]|, p0, p0};
				v38 := (seq(0x3b6, i1  => (v23)))[p0 := fm30(|[278]|, !p2, v40, v25, globalState)] + v38;
				globalState.f4 := 0x136;
				var v41 := new C2();
				v23 := "bsu";
				var v42: array<bool> := new bool[5] [v0[405], p2, v25, p2, !(v25 <== p2)];
			...
			var v50: set<int> := {p0};
			var v51: array<int> := new int[3] [0x310, -(p0 % |v50|), p0];
			v51[405] := -129 + p0;
			v49, v51[405] := v49, 0x376;
			var v52 := false;
			v52 := !(--|(map v53 : int | (0x2e9 <= v53) && (v53 < -795) :: (v53 % v51[405]) := (v47))| >= v51[405]);
		}
		...
		var v62: array<int> := new int[23] [p0, 0x325, p0, -v55.cf16, |map[|p1| := p2]|, p0, p0, |v58|, p0, |(seq(658, i3  => ([if (p0 in v20) then v20[p0] else p2, DC3(seq(-0x2ad, i4  => ('t')), !p2).cf4, p2])))[|v59| := [v60.cf37, p2]]|, p0, p0, p0, p0, |multiset{p2}|, p0, p0, p0, p0, |v61|, p0, p0, p0];
			...
			decreases 100 - i2
		{
			...
			v62[512] := |(if (false) then v65 else v65)|;
			if (p2) {
				globalState.f4 := p0;
				var v66 := true;
				v66 := v66;
				...
				var v68: seq<bool> := [p2];
				v66, v66, v66 := !p2, v66, !((v62[512] <= |v67|) ==> (v66 in v68));
				var v69: seq<int> := [v62[512], v62[512], 431, v62[512]];
				globalState.f15 := |((v69[p0 := |v54|] + v69) + v69)|;
				v0[346] := !p2;
				var v70: array<D6> := new D6[11];
				var v71 := DC16([|v56|, p0]);
				var v72 := DC18(v71);
				v70[615] := v72;
				v0[346], v70[615], v66 := v68[v62[512]], v72, p2;
			} else {
				var v73 := true;
				v73 := p2;
				var v74: array<int> := new int[23](i5 => i5 / v62[512]);
				var v75 := DC5(v74);
				var v76 := DC8(v75);
				var v77 := new C3(v76, p0 < |v59|);
				var v78: array<string> := new string[23](i6 => v56);
				v78[708] := v56;
				var v79: multiset<int> := multiset{v62[512], 0x2d9};
				...
				v78[708], v80, v81 := v56, v80, v81 + (v81 + map[p2 := v0]);
				var v82: map<multiset<bool>, array<int>> := map[p1 := v74];
				v82 := v82[fm34(p0, p0, v73, globalState) := v74];
				globalState.f13 := v62[512];
			}
			
			var v83: seq<string> := [fm30(v62[512], p2, v57, true, globalState)];
			var v84 := DC11(v83);
			var v85: map<bool, D4> := map[true := v84];
			var v86: seq<int> := [fm23(v85, v62[512], p0, globalState)];
			v86 := v86[|fm30(p0, p2, v57, p2, globalState)| := v62[512]];
			var v87 := DC29();
			match (v87) {
				case DC29() =>
					var v88 := false;
				...
				case DC30(cf46, cf47) =>
					var v90 := 'b';
					var v91: array<int> := new int[2] [v62[512], |fm41(v90, globalState)|];
					...
					var v96 := DC21(v62[512], 508, cf46, fm8(p0, v94.f25, v62[512], globalState), v94.f25);
					v95[637] := if (v96.cf32) then v86[fm23(v85, v62[512], cf47, globalState) := cf47] else v86;
					...
					v95[637], v97[970], cf46, v98[129], v99 := ((if (v94.f25) then v86 else v86)[cf47 := cf47])[|p1| := |v100|] + v86, if (true) then if (p2) then v0 else v0 else if (cf46) then v0 else v101[v62[512]], cf46 <== cf46, if (cf46) then v56[cf47 := fm38(true, globalState)] else v56, map[v0 := v56] + v99;
				case DC28(cf45) =>
					var v102: array<D11> := new D11[20];
					v102[623] := v87;
					v102[623] := v87;
					var v103 := false;
					v59, v103, globalState.f15, v62[512] := v59 - (v59 + v59), v103, p0 + (if (p2) then p0 else p0), 0x99;
					v103 := p2;
					var v104 := new C1();
				case DC31(cf48) =>
					v54 := v54;
					...
					var v107 := DC5(v106);
					v105, globalState.f13, globalState.f13, v107, v62[512] := fm26(globalState), p0, v62[512], p3, p0;
					var v108 := 'p';
		...
		for i8 := if (false) then p0 else p0 to p0 {
			...
			var v113: set<string> := {v56, seq(204, i9  => ('a')), v56, v56, v56};
			v110, v111, v0[312], v110 := if (v56 == v56) then p2 else v112.cf8, v111, v113 >= v113, v110;
...
class C5 extends T1 {
	...
	function fm7(p0: int, globalState: GlobalState): multiset<set<int>> {
		(multiset([{0xb4}, {-0x254}]) * multiset{set v2 : int | v2 in (set v1 : int | v1 in (map v0 : int | (0x2e5 <= v0) && (v0 < 0x25a) :: (v0 - |[-0xc1]|) := (587)) :: (v1 / |"we"|)) :: (v2 / 0x301), set v3 : int | (0x176 <= v3) && (v3 < 894) :: (v3 * 245), set v4 : int | (0x29a <= v4) && (v4 < 0x2c9) :: (v4 * 0x90)}) - (multiset{{412, 0xb7, |map[|(map v5 : int | (0x151 <= v5) && (v5 < -0x63) :: (v5 + |map[false := 500]|) := (0x355))| := -0xa1]|}, set v6 : int | v6 in multiset{0xd7, |"h"|} :: (v6 / 0x304), {|"jghlcq"|, |{false}|}} - multiset([{|multiset(['a'])|}, {0x8a}]))
	}
	function fm8(p0: int, p1: bool, p2: int, globalState: GlobalState): bool {
	...
	method m6(p0: int, p1: multiset<bool>, p2: bool, p3: D2, globalState: GlobalState) {
		...
		if (p2) {
			...
			var v1 := 'g';
			var v2: set<bool> := {v0};
			var v3: array<int> := new int[28](i0 => i0 / p0);
			var v4: array<bool> := new bool[23] [true, true <==> v0, v0, (fm21('m', v1, globalState)).cf4, p2, p2, if (true) then v0 else true, v0, fm20(globalState), p1 !! p1, p2, p2, p2, v2 >= v2, p2, v0, (multiset{v3})[v3 := -p0] > multiset{v3, v3}, p2, fm20(globalState), false, !p2, p2, fm8(p0, p2, p0, globalState)];
			var v5: set<string> := {"g"};
			v4[670] := v5 >= v5;
			var v6 := "slclxhejc";
			var v7: seq<string> := [v6, v6[p0 := 'x']];
			var v8 := DC11(v7);
			v0, v4[670], v7 := p2, p2, v8.cf15;
			v3[876] := p0;
			v3[876] := if (v4[670]) then p0 else p0;
			v4[670], v1 := v3[876] < (v3[876] / v3[876]), v1;
			var v9: map<bool, bool> := map[p2 := v0];
			var v10: map<bool, array<int>> := map[v4[670] := v3];
			var v11: map<int, map<bool, bool>> := map[-|v10| := v9];
			var v12: array<map<bool, bool>> := new map<bool, bool>[17] [v9, v9 + v9, v9 + map[p2 := p2], map[v4[670] := v0], v9, v9 + v9, map[v4[670] := p2], v9, (map[p2 := v4[670]])[p2 := v4[670]], v9 + v9, v9, v9 + v9, v9, if (v0) then fm22(v7, v3[876], globalState) else if (p0 in v11) then v11[p0] else v9, v9, v9, v9];
			v12[90] := if (false) then map[v0 := v4[670]] else fm22(v7, p0, globalState);
			v0, v12[90], v0 := !p2, v9 + v9, v4[670];
			var v13 := DC6(v3[876] + v3[876]);
			v13 := DC6(v3[876]).(cf7 := p0);
		} else {
			...
			var v21: seq<int> := [p0];
			var v22: array<multiset<int>> := new multiset<int>[8] [v20, v20, v20 - multiset(v21), v20, v20, v20 + v20, v20 * v20[p0 := p0], v20];
			var v23: seq<string> := [v18, seq(0x316, i1  => ('h'))];
			...
			var v29 := 'o';
			v18, v22, globalState.f4, globalState.f13 := v18 + v23[p0], v22, |fm39(|v27[fm26(globalState) := -592]| - |v28|, v29, (seq(0x20c, i2  => (p0))) + v21, p2, globalState)|, p0;
			var v30: map<bool, bool> := map[p2 := p2];
			var v31: multiset<map<bool, bool>> := multiset{v30};
			v14 := if (v31 > v31) then v14 else v14;
			if (((seq(0x176, i3  => (v29))) + v18) <= (seq(0x6f, i4  => ('l')))) {
				v14[385] := v17.fm2(|map[v17.f25 := "xs"]|, globalState) + |v28|;
				v14[385] := p0;
				v17.f25 := v17.f25 <==> (v28 == [v17.f25]);
				v17.f25 := v14[385] < v14[385];
				v17.f25 := true;
				v30 := v30[false := v17.f25 || p2];
			} else {
				v29 := fm38(v17.f25 <==> p2, globalState);
				v29 := v29;
				var v32: set<bool> := {v28[p0]};
		...
		var v42 := DC34(v41);
		globalState.f13, v39[817], v40, v42 := p0 + p0, v40, !p2, v42;
...
class C6 {
	...
	function fm15(p0: string, p1: bool, globalState: GlobalState): set<string> {
		({seq(353, i0  => ('a')), "vmtigl"} * {"ggpkkfhx", "mo", "jhtp", "rhv"}) + {seq(-0xc9, i1  => ('y'))}
	}
	...
	method m9(p0: int, p1: bool, p2: bool, globalState: GlobalState) returns (r0: int, r1: multiset<int>, r2: bool) {
		...
		if (false) {
			...
			var v24 := DC1(v23);
			v24 := v24;
			var v25: seq<bool> := [v23[0], false];
			var v26: map<seq<bool>, bool> := map[v25 := if (v23[0]) then false else p1];
			var v27: seq<set<char>> := [{v12}];
			v23[0] := if ([p1] in v26) then v26[[p1]] else if (-|v27| in v9[998]) then v9[998][-|v27|] else p1;
			var v28 := DC0(v23);
			globalState.f15, v23[0], v28, v23[0], v25 := p0 * p0, if (p0 in v10) then v10[p0] else p1, v28, !p2, v25 + v25;
			var v29 := DC3(v15, p1);
			if (v29.cf4 ==> v23[0]) {
				r2 := v23[0];
				...
				r2 := if (({p0, if (p1 in v0) then v0[p1] else p0} - {|v33|, 0x2d1}) in v32) then v32[{p0, if (p1 in v0) then v0[p1] else p0} - {|v33|, 0x2d1}] else !v23[0];
				v1[609] := p0 % p0;
				v1[609] := p0;
				v15 := v16[736] + v15;
				v20 := v20;
				...
				var v34 := DC9(v12);
				v12 := v34.cf12;
				globalState.f4, globalState.f4, v23[0] := p0, p0, p1;
				var v35 := new C0();
				v23[0] := (p0 % p0) == p0;
				var v36 := DC38(v10);
			...
			if (v16[736] <= v16[736][p0 := v12]) {
				...
				var v43: array<array<map<int, bool>>> := new array<map<int, bool>>[28] [v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v40[p0], v9, v9, v9, v9, v9, v9, if (p2) then v9 else if (|v42| in v41) then v41[|v42|] else v40[p0], v9, v9, if (false) then v9 else v9, v9, v9, v9, v9, v9, v9];
				v43[188] := v9;
				v43[188] := v9;
			} else {
				globalState.f4 := p0 % 0x377;
				r2 := !((p0 * -0x39c) != (p0 / p0));
				var v44: seq<int> := [|fm33(p1, p1, p0, globalState)|, p0];
				r2 := (v44 + (seq(-0x177, i2  => (0x217)))) <= v44;
				var v45: seq<bool> := [p2 <== !p2];
				var v46: seq<map<bool, bool>> := [v21];
				var v47: seq<seq<map<bool, bool>>> := [v46];
				var v48: multiset<int> := multiset{|multiset(v47[|v9[998]|])|};
				globalState.f15, v45 := p0, [p2, p1, !(v48 >= v48)];
				r2 := false;
			}
			
			var v49: multiset<int> := multiset{p0, p0};
			var v50: map<char, multiset<int>> := map[v16[736][p0] := v49];
			v50 := v50[v12 := v49 + v49];
			if (fm26(globalState)) {
				v1[862] := p0;
				v1[862] := (|map[v1 := fm26(globalState)]| / p0) - fm17(p0, globalState);
				r2 := p2;
				...
				globalState.f13 := -(|v53| / |(seq(-0x250, i4  => (DC9(v12).cf12)))|);
				r2 := p2;
				v52[842] := p1;
				v52[842] := p2 ==> p2;
				v17[306][200] := |v15|;
			...
			if (true) {
				...
				var v57: array<map<int, int>> := new map<int, int>[14] [map[0x183 := p0], v54, v54, v54, v54[-p0 := p0], v54, v54, v54, v54[p0 := 733] + v54, if (p2) then v54 else v54, map v55 : int | (0x151 <= v55) && (v55 < 0x341) :: (v55 - p0) := (p0), map v56 : int | (0x84 <= v56) && (v56 < 0x306) :: (v56 / p0) := (p0), v54, v54];
				v57 := v57;
				var v58: array<bool> := new bool[18];
				v58[353] := fm16(p0, globalState);
				var v59: seq<bool> := [false, p1];
				var v60: seq<multiset<int>> := [v49, multiset{p0, 0xd1}];
				v58[353] := (v49[|v59| := p0] * multiset{p0}) in multiset(v60);
				v58[353] := p2;
				v58[353] := p1;
			} else {
				v16[736] := (seq(-551, i5  => (v12))) + v16[736];
				var v61 := DC12(p0);
				var v62: multiset<string> := multiset{v16[736]};
				...
				v1[87], v0, v64[97], globalState.f4 := |(v65 + v65)|, (multiset{!p1})[fm26(globalState) := p0 * v66[p0]], multiset{p1} >= (v0[p1 := p0] * v0), p0;
			}
			
			globalState.f15 := p0;
		}
		
		var v67 := DC7(p1, v0, v17[306]);
		var v68 := DC8(v67);
		...
		for i7 := p0 to p0 {
			...
			v1[457], globalState.f15 := p0, -|v71|;
			r2 := v69.f25;
			r2 := !v69.f25;
			var v72: multiset<int> := multiset{p0, v1[457]};
			globalState.f4 := if (p0 in v72) then v72[p0] else p0;
		}
		r0 := v69.fm2(-(p0 % |v9[998]|), globalState);
		var v73: map<int, int> := map[p0 := p0];
		var v74: seq<multiset<int>> := [multiset{if (p0 in v73) then v73[p0] else p0}];
		var v75: set<map<int, int>> := {map[p0 := |v16[736]|]};
		var v76: multiset<int> := multiset{|v75|, |v16[736]|};
		r1 := v74[761] - v76[p0 := p0];
		var v77 := DC38(v9[998]);
		var v78 := DC40(v77);
		var v79 := DC40(v77);
		var v80 := DC40(v77);
...
class C7 extends T0 {
	...
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
		...
		var v8: seq<int> := [78];
		var i0 := 0;
		while (!!((if (!v0 in v7) then v7[!v0] else v8[v2]) >= (if (v0) then v2 else v2)))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			if (if (v8 in v13) then v13[v8] else v14 <= v14) {
				...
				var v18: array<bool> := new bool[27] [v0, v0, false, v0, v0, v0, !false, v0, v0, v0, !v0, v0, v16[v2], v0, true, v0, v0, v0, fm1(v17, |map[v2 := v2]|, globalState), v0, v0, v16[v2], v0, v0, v0, true, if (|{v2, v2, v2}| in v3) then v3[|{v2, v2, v2}|] else v0];
				var v19: map<array<bool>, bool> := map[v18 := if (v0) then !!false else v0];
				v0 := if (v18 in v19) then v19[v18] else false;
				v18[706] := fm1(v17, v2, globalState) in map[false := v2];
				var v20: set<bool> := {v0};
				v18[706] := v20 !! v20;
				...
				var v24: array<array<bool>> := new array<bool>[7] [v18, v18, v18, v23[0x265], v18, v18, v18];
				v24[49] := v18;
				var v25: map<int, array<int>> := map[|[v0, v18[706], v18[706]]| := v4];
				var v26: set<string> := {"ejjgk"};
				var v28: map<map<int, bool>, bool> := map[map v27 : int | (803 <= v27) && (v27 < -0x330) :: (v27 % v2) := (v0) := !!v18[706]];
				v18[706], v22, v24[49] := (|multiset{v0}| - |v25|) == (0x12d - v2), fm14(|v14|, v26, v2, v28 + (map[v3 := v18[706]])[(map[|v16| := v18[706]])[|{946, v2}| := v0] := v18[706]], globalState), v18;
			}
			
			v4[706] := |v3[v2 := !v0]|;
			v4[706] := if (v0) then -v2 else v2;
			var v29 := DC2(v2);
			if (v4[706] > v29.cf2) {
				globalState.f13 := v4[706];
				var v30 := new C0();
				var v31 := new C2();
				var v32: seq<bool> := [v0];
				var v33 := DC30(v0, v4[706]);
				...
				var v36 := DC12(v4[706]);
				var v37: map<D4, int> := map[v36.(cf16 := v4[706]) := v4[706]];
...
class C8 extends T0, T1 {
	...
	function fm1(p0: map<bool, map<bool, bool>>, p1: int, globalState: GlobalState): bool {
		((seq(326, i0  => (|[true]|))) + [|map[true := |{0x194}|]|, |"hwtfiavx"|, |multiset{true}|]) < ([0x2fe, 187, 520] + [0x1da])
	}
	function fm2(p0: int, globalState: GlobalState): int {
		if (!(true || true)) then -|(DC3("bmw", !false).cf3 + "yvx")| else 0xe7
	}
	function fm7(p0: int, globalState: GlobalState): multiset<set<int>> {
		multiset{set v0 : int | (-228 <= v0) && (v0 < 300) :: (v0 - |multiset{|multiset{255}|, 0x81}|)} + (multiset{set v1 : int | (-0x16f <= v1) && (v1 < 626) :: (v1 * 0x7a), set v2 : int | v2 in map[9 := |{|{'w'}|}|] :: (v2 % 0x1dd)} - multiset{{|[false, true]|}, {|multiset{[!false, true]}|, 0x26e}, {18}, set v5 : int | v5 in (map v3 : int | (0x2d3 <= v3) && (v3 < -0xd0) :: (v3 + |(seq(0x111, i0  => ('a')))|) := (|(map v4 : string | v4 in ["xypuautvo"] :: (v4) := (false))|)) :: (v5 + |"ubinwfp"|), {|"yhq"|}})
	}
	function fm8(p0: int, p1: bool, p2: int, globalState: GlobalState): bool {
	...
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
		...
		for i2 := |fm11(v0, globalState)| to if (v0) then v2 else |(map v3 : int | v3 in v4 :: (v3 % v2) := (v2))| {
			...
			decreases 100 - i3
		{
			...
			var v12: map<bool, bool> := map[v11[v10 := v2] >= v11 := v0 <==> v0];
			v12 := v12[v0 := !v0];
			...
			if (if (v14 in v15) then v15[v14] else if (v0) then v0 else !v0) {
				...
				v1[841] := (if (v2 in v17) then v17[v2] else v2) > v2;
				v1[841] := if ((v2 % |"gmlde"|) in v4) then v4[v2 % |"gmlde"|] else v0;
				v0 := v1[841];
				var v18 := new C1();
				var v19 := DC38(v4);
				v10[794] := -|v19.cf55|;
				v1[841], globalState.f7, v10[794], v0 := v1[841], v2, v2 / v2, v1[841];
			} else {
				v0 := v0;
				var v20: C1 := new C1();
				...
				v24[347] := v1;
				var v25: seq<bool> := [v0];
				globalState.f4, v22, v23, v2, v24[347] := v20.fm25(v0, v0, globalState), seq(0x3b3, i5  => (DC9('d').cf12)), v23 + v23, v2 / (v2 % |v25|), v1;
	...
	method m6(p0: int, p1: multiset<bool>, p2: bool, p3: D2, globalState: GlobalState) {
		...
		var v1 := "bqid";
		var v2 := DC11([v1, v1, v1, seq(0x141, i0  => ('x')), v1]);
		var v3: map<D13, D4> := map[v0 := if (p2) then v2 else v2];
		var v4: seq<string> := [seq(144, i1  => ('c')), seq(-780, i2  => ('h')), v1, "qfjnmala"];
		var v5: map<int, bool> := map[-p0 := p2];
		var v6: seq<string> := [v4[|v5|], v1];
		v3 := v3[v0 := DC11(v4)];
		var i3 := 0;
		while (p2)
			decreases 100 - i3
		{
			...
			var v10: map<array<bool>, seq<map<bool, bool>>> := map[v7 := (v9[p0])[p0 := map[p2 := p2]]];
			...
			var v17: array<int> := new int[24] [|map[p0 := v6[-p0]]| % |v13|, 961, p0, -500 * p0, fm2(-0x1ac, globalState), p0, fm2(p0, globalState), p0 - p0, |v15|, p0, -0x333, p0, |p1|, p0, |(if (v12) then v1 else v1)|, |(if (v12 in v16) then v16[v12] else v1)|, -|(p1 * p1)|, |(v13 + fm27(globalState))|, p0, p0 * p0, p0, -p0, p0 % p0, p0];
			var v18 := DC25(p0);
			v17[885] := (v18.(cf42 := p0)).cf42;
			var v19: C5 := new C5();
			v17[885], v19 := 0xd7, v19;
			globalState.f15 := v17[885];
		}
		for i4 := p0 to p0 {
			var v20 := false;
			...
			v21[464] := fm8(|v30|, !v27.f25, i4, globalState);
			v21[464] := !false;
			...
			var v38: seq<multiset<bool>> := [p1, p1, p1[p2 := p0]];
			v20, v31[984], v34[938], v20, v35 := v32 in v1, v36[true <== v21[464] := p0], v1[|v38[|v23|]|], v21[464], v35;
		}
		var v39: seq<bool> := [p2];
		var v40: map<bool, bool> := map[p2 := v39[-0x2b8]];
		...
		var v45 := 'k';
		var v46 := DC38(v5);
		v1, globalState.f15, v44, globalState.f4, v43 := v1 + v1[|multiset{v44, !v44}| := v45], -p0, !v44 ==> (p0 == p0), match v46 {
	...
	method m8(globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		v9 := new multiset<bool>[12] [multiset(v10), v8, v8, v8, v11[v0] - v8, v8, v8[v1 := |v12|], multiset(v10), v8, v8, multiset(fm27(globalState)), v8 - (if (v0 in v14) then v14[v0] else v8)];
		r0 := v0;
		var v15 := DC10(v0, v0);
		r1 := match v15 {
...
class C9 extends T0, T1 {
	...
	function fm1(p0: map<bool, map<bool, bool>>, p1: int, globalState: GlobalState): bool {
		(if (!!true) then DC3(seq(-16, i0  => ('i')), false) else DC3("r", true)).cf4
	}
	function fm2(p0: int, globalState: GlobalState): int {
		|map[|multiset{false}| := false]| % 0x14a
	}
	function fm7(p0: int, globalState: GlobalState): multiset<set<int>> {
		(multiset([{-0x239}, {|[[|map[-|map[false := -0x17d]| := true]|, |{true}|, |map[|{|(seq(0x6, i0  => ('p')))|}| := 0x352]|, 0x31, |(seq(0x18, i1  => ('c')))|]]|, |"otolbkm"|}]) + multiset([{|multiset{true}|}])) - (multiset{{833}, {0x2c1}, {909}} - multiset{set v0 : int | v0 in {0x33d} :: (v0 / |multiset{|(seq(0x62, i2  => (|multiset{true}|)))|, |{!false}|}|)})
	}
	function fm8(p0: int, p1: bool, p2: int, globalState: GlobalState): bool {
	...
	function fm9(p0: int, globalState: GlobalState): bool {
		match DC6(-528) {
			case DC6(cf7) => multiset([|[cf7]|, cf7, cf7, 0x152]) <= multiset{|(map v0 : int | (0x1e4 <= v0) && (v0 < 0x1ec) :: (v0 / cf7) := (!false))|}
	...
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
		...
		var v10 := false;
		var v11: array<map<int, int>> := new map<int, int>[23] [map[fm2(v0, globalState) := v0], v1, map v2 : int | v2 in v4 :: (v2 + v0) := (v0), map v5 : int | (0x2a <= v5) && (v5 < 0x2ba) :: (v5 / v0) := (v0), v1, v1, v1, v1[v0 := v0], map[v4[|p0|] := -607], map v6 : int | (0x146 <= v6) && (v6 < -0x308) :: (v6 / v0) := (|v3|), v1 + (map v7 : int | v7 in [v0, v0] :: (v7 / v0) := (v0)), v1 + v1, v1 + v1, map v8 : int | (-0x29a <= v8) && (v8 < 0x190) :: (v8 % 0x16d) := (--|multiset{true, true}|), v1 + v1, v1, (map v9 : int | v9 in map[v0 := v10] :: (v9 * 215) := (v0))[v0 := v0], v1 + v1, v1, if (v10) then v1 else v1, v1, v1, map[-0x134 := v0]];
		v11[808] := (map v12 : int | (537 <= v12) && (v12 < 0x3a8) :: (v12 * |v4|) := (v0)) + map[v0 := |p0|];
		v11[808] := v1 + (if (!v10) then v1 else v1);
		v1 := v1[v4[v0] := v0];
		...
		for i0 := v0 to |v13| {
			...
			if (if (v0 in v14) then v14[v0] else v10) {
				...
				var v23: array<D2> := new D2[22] [v21, v21, v21, v21, v21, v21, if (v10) then v21 else v21, v21, v21, v21, v21, DC7(v10, multiset(v22[v0 := v10]), v20), v21, v21, v21, DC7(v10, v15, v20), v21, v21, DC7(true, multiset{v10}, v20), DC7(v10, v15, v20), v21, DC7(v10, fm34(|fm19(v10, !v10, globalState)|, v0, if (i0 in v14) then v14[i0] else v10, globalState), v20)];
				v23 := new D2[25];
				v10 := v19 >= v19;
				v10 := (v4 + v4) != (seq(305, i1  => (if (v10 in v3) then v3[v10] else i0)));
			...
			v10, v10, v31, v32, globalState.f13 := v10 <==> v10, !v33[i0], v34.cf18, v32, fm2(v0 / i0, globalState);
			...
			var v40: array<int> := new int[17] [|p0|, 0x108, i0, |v37|, i0 - -v0, 0x1f0, i0, fm2(v0, globalState), i0, v0, v0, v0, v0, 0xd2 + |v37|, v0, if (v10) then |v39| else v0, -0x23a % v0];
			v40[757] := v0;
			v40[757] := v0;
		}
		...
		v41[442] := false;
		v41[442] := v10;
		var v42 := DC21(v0, v0, v10, v41[442], v10);
		if (!(v42.cf32 <==> v41[442])) {
			var v43: array<multiset<bool>> := new multiset<bool>[7](i2 => multiset{!!true, v41[442]});
			v43[320] := multiset{true};
			var v44: set<bool> := {v41[442]};
			var v45: map<set<bool>, bool> := map[v44 := fm9(v0, globalState)];
			var v46: multiset<bool> := multiset{if (v44 in v45) then v45[v44] else v41[442]};
			v43[320] := v46;
			var v47: array<int> := new int[19];
			v47[117] := |(seq(-0x298, i3  => ('e')))|;
			v47[117] := v0;
			v47 := v47;
			var v48: seq<bool> := [v10];
			v41[442], v48, v44, globalState.f13 := true, v48, (v44 - v44) - v44, v47[117];
			var v49 := 'h';
			var v50: seq<string> := [p0[v0 := v49] + p0, fm19(v10, v10, globalState), p0 + p0, p0[v47[117] := v49]];
			v50 := v50;
		} else {
			globalState.f7 := v0;
			v41[442] := if (v10) then v0 > v0 else v10;
			var v51 := new C8();
			var v52: array<int> := new int[28](i4 => i4 - v0);
			v52[790] := v0;
			v52[790] := --(fm17(fm2(v0, globalState), globalState) * (v0 % v0));
			if (v52[790] < (v52[790] % |p0|)) {
				var v53 := DC17(v41[442], v41[442], v41[442]);
				v10 := fm8(v52[790], if (v10) then v53.cf26 else v10, -v0, globalState);
				var v54 := new C2();
				var v55: multiset<bool> := multiset{v41[442]};
				var v56: map<int, bool> := map[v52[790] := v10];
				var v57 := DC38(v56);
				var v58: map<multiset<bool>, D15> := map[v55 - v55 := v57];
				var v59 := 'u';
				var v60: map<bool, char> := map[v10 := v59];
				v58 := v58[multiset([fm10(v60, v0, v11[808], globalState), v10, v41[442], v41[442]]) := v57];
				globalState.f4 := v0;
				globalState.f4 := v0;
			} else {
				v4 := v4;
				var v61 := new C4();
				globalState.f4 := v52[790];
				v3 := v3[v10 := v52[790]];
				var v62: multiset<bool> := multiset{!v41[442]};
				var v63 := DC5(v52);
		...
		var v65 := DC7(v41[442], multiset{v41[442]}, v64);
		var v66 := DC8(v65);
		var v67: map<int, bool> := map[v0 := v10];
		var v68 := new C3(v66, if (v0 in v67) then v67[v0] else v41[442]);
	}
	method m6(p0: int, p1: multiset<bool>, p2: bool, p3: D2, globalState: GlobalState) {
		var v0: set<int> := {p0};
		var v1: seq<set<int>> := [v0];
		var v2 := "fwnxp";
		var v3 := DC13(multiset{v1[|v2|]});
		match (v3) {
			case DC14(cf18, cf19, cf20, cf21) =>
				var v4: multiset<int> := multiset{435};
				var v5: map<int, multiset<int>> := map[p0 := v4];
				var v6: seq<D1> := [DC4(if (p0 in v5) then v5[p0] else v4)];
				v6 := seq(-0x14, i0  => (DC4(multiset{|{p0, cf20, cf20, -0x18, |{cf19, cf21, !cf21}|}|, p0, p0})));
				...
				if (!(cf19 ==> (p1 > p1))) {
					...
					v22[482] := v21;
					v20, globalState.f13, v22[482] := v20 + v20[p0 := !cf21], p0, v21;
					var v23, v24 := m7(cf20 % 821, cf19, globalState);
					v8[900] := fm8(cf20, cf21, p0, globalState);
					v8[900] := !false;
				} else {
					v8[818] := cf21;
					var v25: seq<int> := [-cf20];
					var v26: multiset<string> := multiset{v2, v2[|v25| := cf18], v2};
					v8[818] := v26 > fm47(p2, -cf20, globalState);
					v2 := v2 + (v2 + v2);
					var v27: C1 := new C1();
			...
			case DC13(cf17) =>
				var v35 := false;
				v35 := p2;
				var v36: seq<string> := [v2, if (p2) then seq(0x117, i1  => ('t')) else v2, v2 + v2, v2, v2];
				var v37: T0 := new C2();
				var v38: set<T0> := {v37, v37, v37, v37, v37};
				var v39: map<int, int> := map[|v38| := p0];
				var v40: seq<int> := [p0, p0, |v39|, 0x10d];
				var v41: seq<int> := [|v0|, -v40[|"is"|], -p0];
				...
				v44[169] := v45;
				v44[169], v35, v39, globalState.f7 := v45, v43[747], v39, |v2| % p0;
			case DC15(cf22) =>
				if (p0 > (if (true in p1) then p1[true] else p0)) {
					...
					globalState.f13 := p0;
					var v48 := new C6();
					var v49: seq<int> := [-p0 / p0, |("dkgfi" + v2)|, p0];
					v49 := seq(0xed, i4  => (p0));
					var v50: map<int, bool> := map[-p0 := p2];
					var v51: map<int, bool> := map[898 := if ((if (p0 in v46) then v46[p0] else p0) in v50) then v50[if (p0 in v46) then v46[p0] else p0] else v47[p0]];
					...
					var v60: seq<bool> := [p2, v59[|v59|]];
					var v61: set<bool> := {p2};
					var v62 := DC6(p0 / -p0);
					v2, v59, v61, v62 := v2, v59 + ([v56, p2])[0x248 := p2], v61, v62;
				}
				...
				v66, v66, v70 := p2, v71[p0 - |v63|], v70;
				var v72 := DC37(DC36(v71));
				var v73 := DC36(v71);
				var v74: map<int, bool> := map[p0 := v66];
				var v75: array<D14> := new D14[25] [v72, v72, v72, DC37(v73).(cf54 := v73), v72, v72.(cf54 := v73), v72, v72, v72, v72, v72, DC37(v73), v72, DC37(fm48(v66, p2, if (p0 in v74) then v74[p0] else p2, globalState)), v72, v72, v72, v72, v72, v72, if (p2) then v72 else v72, DC37(v73), v72, v72, DC37(DC35(seq(0x3c9, i5  => (v74[p0 := p2]))))];
				v75[983] := v72;
				v75[983] := v72;
		}
		...
		if (!((p0 <= p0) && !(p0 >= 0x327))) {
			...
			if (!(|v0| == p0)) {
				...
				v95, v96[529], v97, v95, v95 := p2 in p1, p0 + (|v98| - p0), v97, v100.cf57, v95;
				var v101 := DC35(seq(7, i8  => (map[v96[529] := p2])));
				...
				v104[47] := p2;
				var v105: multiset<int> := multiset{v96[529], v99[v96[529]]};
				v104[47] := v105 <= (multiset{v96[529], p0} + fm31(v96[529], p0, globalState));
				var v106: map<seq<int>, bool> := map[v99 := !v104[47]];
				v106 := v106;
			}
			...
			var v111: array<int> := new int[24] [-(-p0 / p0), p0 - |v110|, p0, -p0, p0, p0, p0, 75, p0, p0, p0, 0x395, p0, |v107| / p0, 265, p0, p0, p0, p0, p0, p0, |p1|, fm2(fm17(|v2|, globalState), globalState), p0];
			v111 := v111;
			globalState.f4 := p0;
			var v112: array<D12> := new D12[28](i10 => DC32({v110[p0]}));
			var v113 := DC32({p2});
			v112[615] := v113;
			var v114: array<D4> := new D4[15];
			var v115 := DC11(seq(608, i11  => (v2)));
			v114[46] := v115;
			globalState.f4, v107, v112[615], globalState.f4, v114[46] := if (p2) then p0 else p0, v107, DC32(v107), p0, v115;
			var v116: seq<int> := [p0, p0];
			var v117: multiset<int> := multiset{p0, |v116|, p0, |v2|};
			var v119: multiset<int> := multiset{p0 * p0, -0x2fb, -(if (p0 in v117) then v117[p0] else -p0), if (false) then |map[!p2 := |(map v118 : int | (0x1b4 <= v118) && (v118 < 908) :: (v118 / p0) := (p2))|]| else |(seq(815, i12  => ('q')))|, p0};
			v117 := v117;
			if (p2) {
				var v120: multiset<seq<int>> := multiset{seq(0x117, i13  => (p0))};
				var v121 := DC3(v2, !!true);
				var v122: map<int, string> := map[-|(v120[v116 := |v107|])[v116 := -0x33]| := v121.cf3];
				...
				v124[305] := if (true in v126) then v126[true] else v125;
				v124[305] := v125;
				v124[305] := v125;
				var v127 := DC25(p0 - p0);
				v127 := v127;
				...
				var v128 := 'x';
				var v129: array<string> := new string[17] [v2, v2, seq(-0x315, i14  => ('e')), "xxum", v2, fm19(p2, !p2, globalState), v2, v2, v2, v2, "hhvdynhug", v2[fm17(-p0, globalState) := v128], v2, seq(0x376, i15  => ('k')), v2, "m", v2];
				...
				v132[469] := fm1(v133, |v110|, globalState);
				v132[469] := false;
				var v134 := new C7();
		...
		for i17 := p0 / p0 to p0 {
			...
			var v140: array<int> := new int[20](i18 => i18 % p0);
			v139[342] := v140;
			var v141: multiset<int> := multiset{if (p2) then i17 else -0x25d, i17 * i17};
			var v142: seq<multiset<int>> := [v141, v141];
			var v143: T0 := new C7();
			var v144: seq<multiset<int>> := [(v142[p0])[i17 := DC47(v143, true, i17, i17, fm17(i17, globalState)).cf72]];
			v139[342], globalState.f4, v141 := v140, |p1|, v144[i17];
			if (p2) {
				var v145 := true;
				var v146: map<int, int> := map[p0 := v143.fm2(p0, globalState)];
				var v147: set<map<int, int>> := {v146, v146};
				v145 := v147 >= v147;
				globalState.f15 := |multiset{-0x51}| - (|v141| % i17);
				v145 := v145;
				var v148: multiset<seq<int>> := multiset{seq(0x38e, i19  => (i17)), seq(0x11d, i20  => (p0))};
				var v149: seq<int> := [p0];
				var v150 := 'y';
				...
				var v159: multiset<string> := multiset{seq(0x300, i21  => ('d'))};
				v158 := v158[v159 != v159 := v157];
				var v160 := DC2(p0);
				globalState.f13 := (p0 % p0) - v160.cf2;
				v157 := {p2, p2, p2, p2, p2};
			}
	...
	method m7(p0: int, p1: bool, globalState: GlobalState) returns (r0: int, r1: multiset<set<D0>>) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v7: seq<int> := [|v3[p1 := p0]|, fm2(p0, globalState), |v6|];
				var v8 := DC10(|v7|, p0);
				v2[36] := v8;
				var v9: set<bool> := {!p1};
				var v10: set<set<bool>> := {v9, v9};
				v2[36] := v8.(cf14 := (if (|v10| in v5) then v5[|v10|] else p0) % p0);
				var v11: C5 := new C5();
				globalState.f15 := p0 % -(if (p1) then |map[p0 := v11]| else |"tmqug"|);
				var v12 := DC48(v5);
				...
				var v21: seq<set<int>> := [v18[0x18e], if ((set v20 : int | (0x252 <= v20) && (v20 < 392) :: (v20 + p0)) in v19) then v19[set v20 : int | (0x252 <= v20) && (v20 < 392) :: (v20 + p0)] else v17, {-p0, p0, p0}, v17, v17];
				globalState.f13 := |v21|;
				var v22: array<int> := new int[22];
				var v23: map<array<int>, int> := map[v22 := p0];
				var v24 := "kxs";
				var v25: map<string, map<array<int>, int>> := map[v24 := v23];
				v0[636] := v23 != (if ("idknhjqof" in v25) then v25["idknhjqof"] else v23);
				v0[636] := v11.fm20(globalState);
				var v26 := DC6(p0);
				var v27: multiset<D2> := multiset{v26, v26, v26};
				var v28: multiset<multiset<D2>> := multiset{v27[v26 := p0], v27, v27, v27, v27};
				var v29 := 'f';
				var v30: map<bool, char> := map[v0[636] := v29];
				var v31: seq<multiset<D2>> := [v27, v27[v26 := p0]];
				var v32: map<int, multiset<multiset<D2>>> := map[p0 := multiset(v31)];
				var v33: array<multiset<multiset<D2>>> := new multiset<multiset<D2>>[9] [v28, if (p1) then v28 else v28, v28 * v28, fm50(v0[636], fm10(v30, 790, v5, globalState), p0, if (p0 in v15) then v15[p0] else p1, globalState), if (p0 in v32) then v32[p0] else v28, v28, v28, v28, fm50(v0[636], fm9(p0, globalState), p0, p1, globalState) + v28];
				v33[732] := v28;
				v33[732] := v28;
			} else {
				var v34 := true;
				...
				var v36 := "l";
				globalState.f13, v34, v35 := -p0, (if (p1) then v36 else seq(506, i2  => ('b'))) <= v36, (v35 * v35) + v35;
				...
				v0, globalState.f13, v0[84] := v0, -((p0 * -p0) % fm17(p0, globalState)), fm1(v42, p0, globalState);
				...
				v44 := v44[v0[84] := map v45 : int | v45 in v35 :: (v45 - p0) := (seq(124, i3  => ('u')))];
			}
		...
		var v57: array<seq<D11>> := new seq<D11>[21] [[DC31(v51)], v53, [DC31(DC31(v51)), v54, v54] + v53, v53, [v54], [v54.(cf48 := v51)], v53, if (p1) then v53 else v55.cf80, [v54] + v53, v56[p0], v53, fm52(globalState) + v53, v53, seq(0x300, i4  => (v54)), v53, v53, v53, seq(-0xf3, i5  => (v54)), v53, v53, v53[p0 := fm51(v52, p0, globalState)]];
		v57[537] := [DC31(v51), v54];
		var v58 := true;
		var v59 := DC0(v0);
		var v60: map<int, bool> := map[p0 := false];
		var v61: seq<bool> := [v58, if (|v52[667 := p0]| in v60) then v60[|v52[667 := p0]|] else v58];
		var v62 := "ksdbdq";
		var v63: seq<string> := [v62, "mhqnf", fm30(p0, v58, v50, true, globalState)];
		var v64 := DC21(p0, p0, false, v58, p1);
		v0, v57[537], globalState.f4, v58 := (if (v58) then v59 else v59).cf0, (fm52(globalState))[|v61| + -0xb6 := v54], |v63[p0 + p0]|, (-v64.cf30 + -0x345) > (p0 - p0);
		var i6 := 0;
		while (p1)
			decreases 100 - i6
		{
			...
			v58, v61, v0[332], v0[825] := p0 == p0, ([v58, p1] + v61) + v61, "aqqe" == (v62 + "behwcy")[-p0 := v65], fm1(v70, p0, globalState);
			globalState.f4 := -(p0 % 0x1e8);
			var v71 := DC12(if (p1) then -|v62| else p0);
			match (v71) {
				case DC12(cf16) =>
					var v72 := new C2();
					var v73: array<int> := new int[19](i7 => i7 % cf16);
					v73[409] := p0;
					...
					v77 := v77[v78[p0 := cf16] > v78 := v76];
					var v80 := DC38(map[cf16 := v58]);
					var v81: multiset<D15> := multiset{DC38(v60), DC38(map v79 : int | v79 in (seq(-0x248, i8  => (v73[409]))) :: (v79 + |map[p1 := false]|) := (p1)), v80};
					v73[409] := if (v80 in v81) then v81[v80] else |({v0[332], v0[332]} + v49)|;
				case DC11(cf15) =>
					v58 := !!true;
					var v82 := DC10(p0, p0);
					...
					var v84: array<int> := new int[21] [-p0, p0, fm2(|v60|, globalState), p0, p0, |multiset(v52)|, p0, |"wcuryoktk"|, |map[|v62| := v58]|, p0, p0, p0, p0, p0, p0, |v62[|v69| := v65]|, |v62|, p0, p0, p0, v52[0x16c]];
					var v85: map<array<int>, seq<int>> := map[v84 := v52];
					var v86: seq<seq<int>> := [seq(277, i9  => (p0))];
					var v87: map<int, seq<bool>> := map[|v52| := v61];
					var v88 := DC3(v62, p1);
					v83 := map[(if (v84 in v85) then v85[v84] else v86[-|(if (p0 in v87) then v87[p0] else v61)|]) < v52 := |(v88.cf3 + v62)|];
			}
			
			globalState.f7 := -(p0 % 766) * p0;
		}
		var v89 := new C0();
...
class C10 extends T0 {
	...
	function fm6(p0: bool, p1: bool, p2: map<int, int>, p3: char, globalState: GlobalState): int {
		-match DC2(647) {
			case DC3(cf3, cf4) => DC2(|map[cf4 := -|[|multiset{cf4, cf4}|, -|multiset{621, |map[cf4 := cf4]|, |multiset{0x3c}|, |map[|(seq(919, i0  => (0x6b)))| := cf4]|, 0x106}|]|]|).cf2
	...
	method m5(p0: int, p1: bool, p2: bool, globalState: GlobalState) returns (r0: array<multiset<bool>>, r1: bool, r2: char) {
		...
		for i0 := |v0| to p0 {
			...
			v3[302] := if (|v4| in v1) then v1[|v4|] else p0;
			var v5: map<bool, int> := map[p1 := p0];
			v3[302] := -((i0 + p0) * (if (false in v5) then v5[false] else --0x269));
		}
		...
		v18 := v18;
		var v19 := "lpee";
		v19 := (fm19(p2, p1, globalState))[p0 := v13];
		if (false) {
			...
			if (p2) {
				...
				globalState.f15 := if (v18 in v22) then v22[v18] else -v21[469];
				...
				v25[673] := v23;
				var v26: set<bool> := {p1};
				v21, globalState.f13, r1, r1 := v21, v21[469], v26 < v26, v19 == fm19(false, p1, globalState);
			} else {
				var v27: array<map<bool, int>> := new map<bool, int>[18](i3 => map[p1 := 0x315]);
				v27[593] := map[p1 := p0] + map[p2 := |v15|];
				var v28: map<bool, int> := map[p2 := p0];
				r1, v27[593], globalState.f7, v13 := p1, (if (p1) then v28 else map[p1 := p0]) + v28, p0, v13;
				...
				var v32: array<array<bool>> := new array<bool>[23] [v18, v18, v18, v18, v18, if (p2) then v31[|v10|] else v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, if (p2) then v18 else v18, v18, v18];
				v32[99] := v18;
				v32[99] := v18;
			}
			...
			if (p1) {
				...
				var v36 := DC34(v35);
				var v37: map<D13, string> := map[v36.(cf51 := v35) := v19 + (seq(0x3d0, i5  => ('u')))];
				v37 := v37[v36 := v19];
				var v38: set<bool> := {p1};
				...
				v40 := v41[if (!p1 in v42) then v42[!p1] else p0];
			...
			v18, v54 := v18, v54;
			globalState.f7, globalState.f15, r1 := p0 * (-|[seq(0x391, i6  => (v13))]| * v15[p0]), p0, p1;
			var v55 := new C4();
		}
		...
		if (p2) {
			...
			if (p2) {
				...
				v11, r1, globalState.f13, r1, v61[662] := v11, p1, v62.cf14, v64 == (v64 + v64), (p0 * p0) - -95;
				r1 := p2;
				v61 := v61;
				v61[662] := p0;
				var v65 := DC5(v61);
				v17.m6(if (p2) then |v11[|map[0x80 := p1]| := p1]| else ---|fm19(p2, DC52(p0, p1, p2).cf82, globalState)|, v16 + v16, if (p2) then p2 else p1, v65, globalState);
			}
			...
			var v75: array<multiset<array<int>>> := new multiset<array<int>>[4] [v74, v74[v73 := p0] - v74, v74, v74];
			v75[80] := v74;
			v73[962] := -p0 * -|v11|;
			v67, globalState.f13, v75[80], r1, v73[962] := (v67 + v67) - (v67 - {v0, v0}), p0 + |v11|, if (!!p2) then v74 - v74 else v74, p0 != p0, v15[p0] / p0;
			if (!((v11 + [p2, p2]) <= (v11 + v11))) {
				var v76 := new C5();
				v76.m6(v73[962], fm34(--0x371, v73[962], !p2, globalState), !true, DC5(v68), globalState);
				globalState.f4 := v73[962] * -v73[962];
				var v77: array<array<D18>> := new array<D18>[6];
				v18, v77, globalState.f13 := if (p2) then v18 else v18, v77, v73[962];
				var v78: seq<array<int>> := [v68, v73];
				var v79: map<array<int>, int> := map[v78[p0] := v73[962]];
				v79 := v79;
			} else {
				var v80: array<map<bool, int>> := new map<bool, int>[9](i8 => if (p1) then map[p2 := v73[962]] else map[p1 := p0]);
				var v81: map<bool, int> := map[p2 := p0];
				v80[149] := v81 + map[v72.cf83 := p0];
				v80[149] := v81 + v81;
				var v82: set<bool> := {p2};
				...
				var v90: T0 := new C2();
				var v91 := DC47(v90, p2, v73[962], |v19|, v73[962]);
				var v92: seq<map<bool, int>> := [v80[149]];
				var v93: map<char, bool> := map[v19[|v92[p0]|] := v17.fm8(p0, false, v90.fm2(p0, globalState), globalState)];
				var v94 := DC36(v11);
				var v95: map<int, seq<bool>> := map[p0 := [p1]];
				var v96: array<seq<map<char, bool>>> := new seq<map<char, bool>>[12] [v89, v89, v89, v89, v89[v91.cf73 := v93], seq(881, i9  => (v93)), seq(0x35a, i10  => (v93)), v89, v89 + [v93, v93, v93, v93], fm55(p1, p0, p2, v94, globalState), v89 + (seq(-814, i11  => (v93))), fm55(p1, |(if (v73[962] in v95) then v95[v73[962]] else v11)|, p1, v94, globalState)];
				v96[272] := v89;
				var v97: map<int, char> := map[v73[962] := v13];
				globalState.f15, r1, v96[272] := p0 + v73[962], p1, (v89 + v89) + (v89[v73[962] := map[v13 := false]] + v89[if (p2 in v81) then v81[p2] else v73[962] := map[if (-|v16| in v97) then v97[-|v16|] else v13 := p1]]);
			}
			
		} else {
			var v98 := DC3(seq(627, i12  => (v13)), p1);
			match (v98.(cf3 := v19)) {
				case DC3(cf3, cf4) =>
					var v99 := DC10(p0, |v16|);
					...
					v100[306] := cf3;
					cf4, v100[306] := !(p1 || p1), cf3 + cf3;
					globalState.f7 := (if (0x3d6 in v10) then v10[0x3d6] else p0) / (p0 - p0);
				...
				case DC4(cf5) =>
					...
					v102[566] := p0;
					v18[140] := p2;
					v18[140] := v11[p0 % v102[566]];
					v18[140] := p2;
				case DC2(cf2) =>
					var v103 := new C2();
					r1 := p2;
					v18[864] := v19 <= v19;
					r1, cf2, v18[864], r1 := !false, p0, p1, cf2 != |v15|;
					v18[864] := false;
			}
			
			r1 := p1;
			var v104: seq<multiset<bool>> := [v16];
			var v105: array<multiset<bool>> := new multiset<bool>[18] [v16, v16 + v16, fm34(p0, |v16|, p2, globalState), v16 + v16, v16, v16, v16, v16, v16, multiset{!p2, !p1}, v16 * v16, v16 * v16, v16, v16 * v16, v16, v104[p0], v16, v16];
...
class C11 extends T0 {
	...
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v6: set<int> := {v3, -0x204, |(seq(-0x1ab, i1  => (v2)))|};
				...
				v1, globalState.f15, v11 := ("l" + v0) != (fm5(globalState))[|v5| := v2], v3, v11;
				v0 := p0;
			...
			globalState.f13, v18[295], globalState.f7, globalState.f13, v1 := -|v22[v20 := |v23|]|, v19, v20 + -v20, fm2(v20 * v20, globalState), v20 <= |v21|;
		}
		var v24 := true;
		var v25 := 0x105;
		...
		match (if (v24) then v27 else v27) {
			...
			case DC2(cf2) =>
				...
				if (v24) {
					...
					var v49: seq<multiset<int>> := [v48[v25]];
				...
				var v65: seq<int> := [cf2, |v60| - fm17(v25, globalState), |v64[|[v24, v24]|]|];
				v65 := v65;
				v24 := -cf2 >= 0x2a6;
		}
		...
		v69[835], v70[703], v66[592], v73 := v68, v66, (if (v24) then v25 else -v25) / (|v74| % v25), v73;
	...
	method m3(globalState: GlobalState) returns (r0: int, r1: map<multiset<int>, bool>, r2: int, r3: array<map<bool, int>>) {
		...
		var v9: set<int> := {v1};
		var v10 := DC3(fm30(557, !v8[|fm5(globalState)|], v9, false, globalState), false);
		v6 := v10.cf3;
		var v11: map<int, int> := map[v1 := |((seq(-0x43, i0  => ('a'))) + v6)|];
		v11 := v11[v1 := v1];
		...
		var v17: array<array<array<int>>> := new array<array<int>>[25] [v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v16[-v1]];
		v17[948] := v15;
		v17[948] := v15;
	...
	method m4(p0: int, p1: bool, p2: map<bool, char>, p3: bool, globalState: GlobalState) returns (r0: multiset<int>) {
			...
			decreases 100 - i0
		{
			...
			if (true) {
				...
				var v14: array<string> := new string[21] ["gif", v7, v7, (fm5(globalState))[v5 := v1], seq(-0x2cd, i1  => (v1)), v7, seq(0x157, i2  => (v1)), v9.fm28(v12, globalState), v7, (v7[v3 := 'n'])[p0 := 'x'], v7, v7, v7, v7, "jc", v7, v7, v7, "befkyx", v13[v5], v7];
			...
			case DC33(cf50) =>
				...
				match (v36) {
					case DC10(cf13, cf14) =>
						...
						var v39: array<int> := new int[7](i3 => i3 - |(seq(78, i4  => (cf14)))|);
						var v40 := DC5(v39);
						var v41: set<D2> := {v40};
						cf50, cf50, cf50, v26, v37 := fm26(globalState), (if (p1) then cf50 else !p3) ==> (if (|v33| in v38) then v38[|v33|] else p3), (if (v31[0x1d]) then v34 else v34) !in fm19(v31[|v41|], cf50, globalState), v26, v37 + v37;
						var v42: array<array<bool>> := new array<bool>[2];
						v42, cf50, v28, v34, cf50 := v42, if (p3) then p3 <== p1 else cf50, seq(-0x199, i5  => (cf13 - |v38|)), v34, p3;
						v37 := v37;
					case DC9(cf12) =>
				...
				v45 := v45[v28[p0] % p0 := -fm2(p0, globalState)];
				if (false) {
					cf50 := !true;
					var v46 := "auf";
					v46 := v46;
					...
					globalState.f7 := p0 % (p0 + (if (p0 in v48) then v48[p0] else p0));
				} else {
					var v49: multiset<bool> := multiset{!p3};
					var v50: multiset<multiset<bool>> := multiset{v49[cf50 := p0], multiset{p3, p3, p3, cf50}};
					...
					v51[85], v55, v56 := (v57 - (set v59 : char | v59 in v58 :: (v59))) < {v34}, fm57(p0, v61, globalState), v56;
					...
					v62[942] := v68;
					v62[942] := v68;
					var v69: array<seq<bool>> := new seq<bool>[25] [v31, v31, v31, v31, v31, v31, v31, [v51[85]], v31, v31, v31, v31[p0 := v51[85]], [p3], fm27(globalState), v31, v31, v31, v31, v31, v31, v31, v31, [cf50, true], v31, v31];
					var v70 := DC26(v69);
					var v71: seq<array<int>> := [v67, v67, v67, v67, v67];
					var v72: seq<array<int>> := [v71[-0x9b]];
					var v73 := DC5(v67);
					v70, v72, v51[85], cf50, cf50 := v70, [v67, v73.cf6] + v71, 0x364 < p0, v65.fm16(p0, globalState), p1;
				}
		...
		var v86 := "juct";
		var v87: array<seq<char>> := new seq<char>[5] [[v85.cf18, v86[p0]], v86, fm5(globalState), v86, ([v34, v86[p0]])[|v31| := v34]];
		var v88 := DC56(v87);
		match (v88) {
			case DC57(cf90, cf91, cf92) =>
				...
				if (!v84 <== p3) {
					...
					var v118: seq<multiset<map<int, D21>>> := [v112, v117[cf91]];
					var v119: seq<multiset<map<int, D21>>> := [v117[p0]];
					var v120: set<char> := {v34, v34, v34};
					var v121 := DC59(v112);
					var v122: array<multiset<map<int, D21>>> := new multiset<map<int, D21>>[29] [v112, v112, v112, v112, v112, v112, v112, v112 - v118[p0], v112, v112, multiset(v116[v83.fm6(p1, p3, map[-245 := p0], fm38(p3, globalState), globalState) := v115]) + v112, v117[0x30c], v112, v112 * v112, v112, v112, v112, v112, v112, v112, v119[231], v112, multiset{v116[|v120|], fm58(v84, v34, globalState)}, v112, (v121.(cf94 := v112)).cf94, v112, v112, v112, v112 * v112];
					v122[816] := v112;
					v122[816] := v112;
					v84 := v84;
					v84 := v84;
					...
					globalState.f7, v123[237], globalState.f13 := cf91 / |v113|, |v124|, if (v86 in v125) then v125[v86] else p0 / |v86|;
					...
					v128 := v128[p1 := v127];
					var v129: map<int, seq<int>> := map[cf90 % cf90 := v28 + v28];
			...
			case DC56(cf89) =>
				...
				var v137: array<array<bool>> := new array<bool>[27] [v132, v133.cf0, v132, v132, v132, v132, v132, if (p0 in v134) then v134[p0] else v132, if (p3 in v135) then v135[p3] else v132, v132, if (p1) then v132 else v132, v132, v132, v132, v132, v132, v136[p0], v132, v132, v132, v132, v132, if (true in v135) then v135[true] else v136[|(seq(0x18d, i11  => (-0x184)))|], v132, v132, v132, v132];
				var v138 := DC1(v132);
				v137[340] := v138.cf1;
				v137[340] := new bool[22](i12 => p1);
			case DC58(cf93) =>
				globalState.f4 := p0;
				var v139: array<int> := new int[8](i13 => i13 * p0);
				v139[63] := p0;
				var v140: map<array<int>, int> := map[v139 := -p0];
				v139[63], globalState.f7 := p0 / |(v140[v139 := p0])[v139 := |v31|]|, p0 - p0;
				v34 := 'b';
				var v141: set<char> := {v34};
				var v142 := DC61(p0, 128, fm2(v139[63], globalState), v86[|v141| := v34]);
				var v143: multiset<D22> := multiset{v142};
				globalState.f13 := -(v139[63] - |v143|);
		}
...
class C12 extends T0 {
	...
	method m1(p0: string, p1: map<bool, array<int>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			if (if (v0 in v4) then v4[v0] else false) {
				...
				var v7: array<bool> := new bool[6] [fm1(v5, f22, globalState), v6[0x2dc], 873 <= f22, true, p0 == p0, v0];
				v7[274] := v0;
				v7[274] := v0;
				globalState.f7 := f22;
				...
				var v8 := "hlrwshec";
				v8 := if (f22 < -0x282) then f23 else ("umwm" + "npllbkx")[-f22 := v1];
				...
				v9[133], v8, globalState.f7 := v10, "oexfuyyh", |v12|;
				v8 := p0;
				var v13 := new C6();
		...
		for i3 := f22 to f22 {
			if (f22 > i3) {
				var v17: array<int> := new int[7](i4 => i4 / i3);
				v17 := v17;
				v0 := v0 <==> v0;
				...
				v18[279] := ("spf")[f22 := v19];
				var v20 := "s";
				v17, v18[279], v20 := v17, f23, (((p0 + p0)[f22 + |(seq(0x34f, i5  => (v19)))| := v19])[i3 / 0x216 := v19])[if (v0) then --|v16| else i3 := v19];
				var v21 := DC25(f22);
				...
				v23[387] := if (v0) then (v25.(cf57 := !v0)).cf58 else --(f22 * i3);
				var v26 := new C2();
				v0 := v26.fm8(0x18, v0, i3, globalState) <== v0;
				var v27: array<array<bool>> := new array<bool>[16];
				var v28: array<bool> := new bool[18] [v0, v0, v0, v0, !v0, v0, v0, v0, v0, v0, v0, fm26(globalState), v0, v0, v26.fm8(v23[387], v0, fm17(0x39, globalState), globalState), v0, v0, if (i3 in v14) then v14[i3] else v0];
				v27[814] := v28;
				var v29 := 'a';
				var v30: multiset<char> := multiset{v29, v29};
				var v31 := DC22(v0, v23[387], v0, v23[387]);
				v27[814] := new bool[22] [fm1(map[true := v24], -i3, globalState), v0 || v0, v0, v0, if (v0) then v0 else v0, v0, v30 <= v30, true, v0 <== true, if (v0) then v0 else v0, v0, v0, -i3 in multiset([v23[387]]), v0, !v0, if (|fm35(globalState)| in v14) then v14[|fm35(globalState)|] else v31.cf37, false, v0, v0, true, false, !v0];
			}
			...
			var v36 := DC5(v35);
			var v38: map<int, string> := map[f22 := fm30(fm17(i3, globalState), v33[298], set v37 : int | (0x12f <= v37) && (v37 < -84) :: (v37 * i3), v0, globalState)];
			var v39: seq<map<int, string>> := [v38, map[f22 := "gpjnbt"], v38];
			var v40: map<int, array<int>> := map[|v39[-f22]| := v35];
			...
			if (p0 <= p0) {
				globalState.f15 := f22;
				var v42 := "ks";
				v42 := if (v33[298]) then seq(-0x2b5, i6  => ('k')) else v42 + p0;
				var v43: array<array<bool>> := new array<bool>[26];
				v43[736] := v33;
				var v44: C2 := new C2();
				var v45: map<C2, array<bool>> := map[v44 := v33];
				v43[736] := if (v44 in v45) then v45[v44] else v33;
				var v46: set<bool> := {v33[298]};
				v14 := v14[-f22 / i3 := v46 !! v46];
				v46 := v46 + v46;
			} else {
				var v47: T0 := new C11();
				var v48: map<T0, bool> := map[v47 := v33[298]];
				var v49: seq<map<T0, bool>> := [v48, map[v47 := v33[298]]];
				v0 := !(v49 != v49);
				v33[298] := !v0;
				var v50 := new C2();
				var v51 := "jhounbr";
				var v52 := DC1(v33);
				globalState.f15, v33[298], v51, v52 := -i3, v0, if (|f23| in v38) then v38[|f23|] else f23, v52;
				var v53: seq<int> := [f22 % i3];
	...
	method m2(p0: int, p1: bool, p2: int, globalState: GlobalState) {
		...
		if (f23 in ({"jieavydw", fm19(p1, p1, globalState)} + v1)) {
			...
			match (v4) {
				case DC49(cf75, cf76, cf77, cf78) =>
					...
					var v10 := DC13(v9);
					v5[443] := v10;
					v5[443] := v10.(cf17 := multiset{v7, v7} - v9);
				...
				case DC48(cf74) =>
					...
					var v21: seq<seq<array<char>>> := [[v18, v18, v18] + v19, (v20[p0])[-f22 := v18], v19];
					v17[764] := v21[|f23| - -f22];
					...
					var v31: array<multiset<bool>> := new multiset<bool>[21] [multiset(v2[|fm19(p1, p1, globalState)| := p1]) + v22, multiset{!p1, p1}, multiset{p1}, v22[false := p0], v22 + fm34(f22, p0, p1, globalState), multiset(v3), v22, v22[false := p2], v22, v22, multiset{!p1}, v22 + v22, v22, v22, v22 + v22, v22, if (p1) then v22 else v22, v22, multiset{p1}, if (p1) then v22 else v22, if (v29 in v30) then v30[v29] else v22];
					var v32: map<bool, bool> := map[p1 := v3[p0]];
					v18[7] := f23[f22];
					var v33: seq<array<multiset<bool>>> := [v31, v31];
					v23, v31, v32, v18[7], globalState.f13 := v23, v33[0x1fd], v32, v0, -p2;
					globalState.f15 := -p0;
					var v34: seq<int> := [p0, p2];
					globalState.f15 := v34[0xdb];
				case DC50(cf79) =>
					...
					var v41: multiset<string> := multiset{seq(-0x2b8, i1  => (v0))};
		...
		var v62: seq<map<int, bool>> := [map v60 : int | v60 in v61 :: (v60 / 13) := (p1)];
		var v63 := DC35(v62);
		var i4 := 0;
		while (match v63 {
			case DC36(cf53) => p1
			...
			decreases 100 - i4
		{
			...
			match (v65) {
				...
				case DC61(cf97, cf98, cf99, cf100) =>
					var v69 := true;
					v69 := p1;
					var v70: array<bool> := new bool[19](i6 => (seq(-0x1cb, i7  => (v0))) < "claiu");
					v70 := v70;
				...
				case DC62(cf101, cf102, cf103, cf104, cf105) =>
					...
					v78 := v78;
					var v79: array<int> := new int[21](i8 => i8 % p0);
					v79[350] := cf102;
					v79[350] := 0xcd;
					var v80 := DC5(v79);
					var v81 := DC8(v80);
					...
					var v85: map<int, string> := map[v79[350] := cf101];
					var v86: array<string> := new seq<char>[18] [cf101 + f23, f23 + cf101, f23, v82.cf100, f23, v82.cf100 + cf101, cf101, cf101[v79[350] := 'o'], cf101[-0x2c := v0], cf101, (if (v83 in v84) then v84[v83] else f23) + f23, f23, "s", f23, cf101, "jfd", if (v64.fm2(-cf103, globalState) in v85) then v85[v64.fm2(-cf103, globalState)] else f23, f23];
					v86[470] := "bnimhcmi" + f23;
					...
					var v93: array<seq<bool>> := new seq<bool>[26] [v87, v87, [cf105, cf105], [cf105], v87, [v59.fm8(cf104, cf105, 0x12e, globalState)], DC36([p1, cf105]).cf53, v87, [p1], v87, v87, v87, v87, if (v89 in v90) then v90[v89] else v87, v87, v87[cf104 := cf105], v87, v87, v87, v87, v87, fm27(globalState), v87, v87, v87, if (v91 in v92) then v92[v91] else v87];
					var v94: seq<array<seq<bool>>> := [v93, v93, v93];
					var v95: array<array<seq<bool>>> := new array<seq<bool>>[17] [v93, v93, v93, v93, v93, v93, v93, v93, v93, v93, v93, v93, v94[cf103], v93, v93, v93, v93];
					v95[721] := v93;
					v86[470], v95[721], globalState.f15, v0 := f23, if (p1) then v93 else v93, -(cf104 - v79[350]), v0;
				case DC59(cf94) =>
					var v96 := DC25(-p2 * f22);
					v96 := v96;
			...
			decreases 100 - i11
		{
			...
			if (false) {
				...
				v106[970] := v59.fm8(|v107|, p1, -p2, globalState) || p1;
				var v108 := true;
				var v109: seq<int> := [p2, p0];
				var v110 := DC3("ohan", false);
				globalState.f13, v106[970], v102, v108, v108 := (f22 / |v102|) * |v109|, true, fm30(p2, p2 >= f22, fm4(v102, p2, v108, v110, globalState), v108, globalState), p0 >= p0, p1;
				var v111 := DC35(v62);
				var v112 := DC37(v111);
				var v113 := DC37(v111);
				var v114 := DC37(v112);
				...
				globalState.f15 := ((if (v114 in v115) then v115[v114] else p0) / f22) - (v117.cf72 - (if (v108 in v118) then v118[v108] else p2));
				v101[368] := p2;
				v101[368] := p0;
				var v119: C9 := new C9();
				...
				v102 := (((v123[f22])[p2 := v0])[f22 := v0] + v102) + "rxdtrqap";
				v101 := v101;
				v101[335] := -p0;
				v101[335] := p0;
			}
...
class C13 {
	...
	function fm0(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<int, int> {
		map[f20 := f20] + ((map v0 : int | (0xb4 <= v0) && (v0 < 472) :: (v0 % f20) := (f20)) + map[f20 := |map[f21 := f21]|])
	}
	method m0(p0: bool, p1: bool, p2: bool, globalState: GlobalState) returns (r0: char) {
		if (p2) {
			...
			var v3: seq<array<bool>> := [v0, (v1.(cf0 := v0)).cf0, v2[DC2(|multiset{f20}|).cf2], v0];
			v3 := v2 + v3;
			var v4 := 'c';
			...
			v10 := fm34(|v11| * f20, |multiset(v12)|, f21 || v12[f20], globalState);
		...
		var v20: multiset<int> := multiset{|v19[f20 := f20]|};
		var v21: seq<multiset<int>> := [v19, v20];
		var v22 := "onoohtgc";
		var v23: map<int, bool> := map[f20 := false];
		var v24: array<bool> := new bool[22] [p2, p1, fm26(globalState), v21 == v21, p2, p1, f21, !(p2 ==> p0), p2, p0, p0, v16[|v22|], fm26(globalState), if (!p2) then p2 else if (f20 in v23) then v23[f20] else p1, p2, p0, f21, true, v22 < v22, p2, p2, p2 && f21];
		v24[895] := if (f21) then p0 else f21;
		var v25 := 'l';
		globalState.f15, v18, v24[895], globalState.f7 := match DC21(f20, f20, v16[f20], f21, false) {
			case DC20(cf29) => 881
			case DC21(cf30, cf31, cf32, cf33, cf34) => -0x17b
			case DC22(cf35, cf36, cf37, cf38) => |{seq(0xaa, i1  => ('l')), "ug", v22, DC62(v22, f20, cf38, cf38, false).cf101}|
			case DC19(cf28) => f20
		}, v18, !(v25 in v22), f20;
		...
		var v44: array<string> := new string[25] ["uxr", v22, "hlbyiwl", v22 + (seq(214, i2  => (v25))), seq(0x1e8, i3  => (v25)), v22, v22, v22 + v22, v22[f20 := v25], v22 + v22, v22, seq(0x35a, i4  => ('q')), seq(0x2f5, i5  => (v25)), v22, (seq(-0x1ff, i6  => (v25))) + v22, v22, (seq(30, i7  => (v25))) + v22, fm30(f20, false, v43, p0, globalState), if (v24[895]) then seq(992, i8  => (v25)) else v22, "ihj", v22, v22, "xfq" + v22, v22, (seq(74, i9  => (v25))) + v22];
		v44[162] := "idcvyt" + v22[f20 := fm38(f21, globalState)];
		v44[162] := v22 + v22;
...
method Main() {
	...
	for i0 := v1 to v1 {
		...
		v8[805] := !(if (v0) then true else v0);
		var v9 := "eabrtymy";
		v8[805], v9, v1, v0, v1 := v0 <== true, seq(0x24c, i2  => ('d')), v1, if (v0) then |(multiset(v5))[v0 := i0]| == fm17(v1, globalState) else v0, i0;
		v5 := v5;
		...
		if (true) {
			...
			var v14 := DC2(i0);
			globalState.f15, v8[805] := -(918 / |{v1, -i0, i0}|) + v1, (v7.fm23(v11, |v9|, |v13|, globalState) * |v9|) <= |(v3 * {v14.cf2})|;
			globalState.f4 := 0x282;
			var v15 := DC1(v8);
			var v16: map<bool, array<bool>> := map[v8[805] := v8];
			v15 := DC1(if (v8[805] in v16) then v16[v8[805]] else v8);
			v8[805], v1 := v8[805], if (v0) then -v1 else v1;
			var v17: multiset<bool> := multiset{v0, v8[805]};
			var v18: array<int> := new int[11];
			var v19 := DC7(false, v17, v18);
			var v20 := DC8(v19);
			var v21: C3 := new C3(v20, v8[805]);
			...
			v25 := v25[|(seq(0x3b9, i3  => (v1)))| / i0 := if (!v8[805]) then v24 else v24];
			globalState.f15 := v1;
			var v26 := new C8();
	...
	match (v30) {
		case DC55(cf85, cf86, cf87, cf88) =>
			...
			var v32 := "dnextlf";
			globalState.f15 := v1 - v31[|v32|];
			var v33 := DC42(false, cf87, cf88);
			var v34: seq<D16> := [v33, v33, v33];
			v34, cf85, cf86, v0 := (seq(0x2e4, i4  => (v33))) + v34, v31[cf86], cf85 + cf86, cf88 ==> cf88;
			var v35 := new C8();
			globalState.f7 := cf85;
		case DC54(cf84) =>
	...
	v48 := v48;
	v0 := v0;
	var v49: array<seq<bool>> := new seq<bool>[10] [v5, [v0], v5, [v0], v5, v5, v5, v5, v5 + v5, v5[v1 := v0]];
	var v50 := "ipyktu";
	var v51: C12 := new C12(|v50|, "xofwgsc");
	var v52: array<C12> := new C12[4] [v51, v51, v51, v51];
	var v53: seq<array<C12>> := [v52, v52, v52, v52];
	v49[986] := [false, v7.fm8(|v53|, v0, v51.f22, globalState)];
	v49[986] := v5 + fm27(globalState);
	var v54: T0 := new C11();
	var v55: seq<T0> := [v54];
	var v56: map<bool, seq<T0>> := map[v0 := v55];
	if (v5[|(if (v0 in v56) then v56[v0] else v55)|]) {
		...
		match (v57) {
			...
			case DC4(cf5) =>
				...
				v1 := v1 % |(if (v0) then "cbcyxwik" else v50)|;
				var v63 := 'r';
				var v64: array<bool> := new bool[18](i6 => v0);
				v64[581] := v0;
				var v65: array<int> := new int[18](i7 => i7 % v1);
				var v66 := DC8(DC5(v65));
				var v67 := DC5(v65);
				var v68 := DC8(v67);
				...
				var v73: array<int> := new int[22] [|v70| + -v69.fm2(v51.fm3(v69.f25, globalState), globalState), v51.f22, 0x321, |("jqh" + "usr")|, v51.f22, v51.f22, 0x98, -(|v72| * v1), v51.f22, |v50| * -0x232, |v51.f23| * -0x3b1, if (v0) then v51.f22 else v1, v44[|v2|], v51.f22, 0x31e, -0x352, v51.f22, v51.f22 * v51.f22, 0x1ef, v44[v51.f22], v1, -503];
				v65[303] := v51.f22;
				v50, v63, v0, v64[581], v65[303] := v50, v63, true, v69.f25, v1;
				v4 := v4[true := v64[581]];
			case DC2(cf2) =>
				globalState.f15 := cf2;
				var v74: C13 := new C13(v51.f22, !v28.fm16(366, globalState));
				var v75: multiset<int> := multiset{|v51.f23|, v1};
				v74, v0, globalState.f13 := v74, false, |v75| % v74.f20;
		...
		v89[341] := if (!v0 in v2) then v2[!v0] else v51.f22;
		v89[341] := |v51.f23|;
	} else {
		var v90: set<bool> := {v0};
		if (fm37(globalState) <= v90) {
			...
			globalState.f4, v100, globalState.f7 := v51.f22, v100 + (v100 + [if (v51.f22 in v101) then v101[v51.f22] else v4, v4]), (0x1d2 / v1) % -194;
		} else {
			var v102: multiset<bool> := multiset{v0, v0, v0};
			var v103: map<bool, multiset<bool>> := map[false := v102];
			var v104: array<int> := new int[6];
			var v105 := DC5(v104);
			v7.m6(v1, (if (true in v103) then v103[true] else v102)[!v0 := |fm32(v51.f22, v51.f22, {v0, if (true in v4) then v4[true] else v0, v0}, globalState)|], v0, v105, globalState);
			...
			globalState.f7, v110, v0, v0 := v1 % v51.f22, v110, v111 > v111, (v2 == v2) <==> (v6 > v6);
			globalState.f4 := -v51.f22;
		}
		
		globalState.f15 := v51.f22 + |v90|;
		v0 := v90 < v90;
		var v112, v113, v114 := v28.m9(v51.f22 / v51.f22, false, v0, globalState);
		v114 := v44 < (v44 + v44);
	}
	...
	var v120: array<int> := new int[13] [-v51.f22, v51.f22, v1 - |fm5(globalState)|, |(v49[986] + v49[986])|, v1, v1, v51.f22 - v51.f22, v1, v1 / v1, v1, |v116|, v1, |v119[v117 := v118]| / 0x17e];
	v120[52] := v1;
	v120[52] := v51.f22 % v51.f22;
	var v121 := 'i';
	var v122 := DC16(v44);
	var v123: map<seq<int>, string> := map[fm39(v44[v1], v121, v122.cf23, v0, globalState) := v51.f23[v1 := v121]];
	v123 := v123[seq(0x116, i8  => (|v51.f23|)) := v51.f23 + v51.f23];
