...
function fm7(globalState: GlobalState): D2 {
	DC6(DC2(map[DC0({!false}) := !false]), "jm", |((seq(469, i0  => (DC2(map[DC0({false}) := true])))) + [DC2(map v0 : D0 | v0 in map[DC0({!false}) := false] :: (v0) := (false)), DC2(map[DC0({false}) := false]), DC2(map v1 : D0 | v1 in [DC0({false}), DC0({true})] :: (v1) := (true)), DC2(map[DC0({true, false, false, false}) := !true]), DC2(map[DC0({true, true}) := false])])|)
}
...
function fm10(p0: bool, p1: bool, p2: seq<bool>, p3: bool, globalState: GlobalState): map<int, int> {
	(map[-|[-0x18e, |map[true := |{DC21(DC6(DC2(map v0 : D0 | v0 in map[DC0({false}) := !false] :: (v0) := (false)), "gjxpwm", 0x341), map[map[true := 0x2b1] := true])}|]|, |"e"|, |{false, true, true}|, |map[90 := |multiset([false, false])|]|]| := 505] + map[0x319 := -|"uwa"|]) + (map[|map[false := false]| := |{false}|] + (map v1 : int | (162 <= v1) && (v1 < 0x3e) :: (v1 % 0x35b) := (979)))
}
...
function fm17(p0: multiset<char>, p1: bool, p2: int, p3: seq<seq<int>>, globalState: GlobalState): map<int, int> {
	map[-171 := 0x39b] + map[0x1c3 := |[|multiset{|(seq(0x190, i0  => (444)))|, |map[true := 0x249]|}|]|]
}
...
function fm21(globalState: GlobalState): seq<bool> {
	match DC22(seq(0xd2, i0  => (|multiset{!true}|))) {
...
function fm25(globalState: GlobalState): char {
	match DC16(map['d' := |"rrvjgmae"|]) {
		case DC17(cf31, cf32) => cf31[137]
		case DC16(cf30) => 'a'
	}
}
function fm26(p0: int, p1: bool, globalState: GlobalState): seq<set<int>> {
	([{-724}] + (seq(843, i0  => ({|map[true := !true]|})))) + (seq(0x12a, i1  => ({-|"cjmi"|, |multiset{53}|, |map[756 := !true]|, |[true, false]|, -95})))
}
function fm27(p0: int, p1: string, p2: char, globalState: GlobalState): seq<bool> {
	match DC30(seq(0x2c9, i0  => ("ekdl"))) {
...
function fm29(globalState: GlobalState): map<seq<int>, int> {
	((map v0 : seq<int> | v0 in [seq(0x2ee, i0  => (|map[false := true]|))] :: (v0) := (|"cvfumpis"|)) + map[[|map[0x2a8 := !true]|, |multiset{|multiset([false, true, false])|}|] := |(map v1 : int | (0xe7 <= v1) && (v1 < -903) :: (v1 + -|{true}|) := (-|map[|map[true := true]| := true]|))|]) + map[[0x360] := |map['y' := true]|]
}
function fm30(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): map<bool, int> {
	map[(seq(-0x3e4, i0  => ('g'))) == "tsneoe" := |"tmfqkanh"|]
}
...
function fm34(globalState: GlobalState): set<set<int>> {
	({{279, 0x197}, set v0 : int | v0 in [|['c']|, -0x1f8] :: (v0 / 968)} * {{|multiset([true, false])|, |(seq(-0x54, i0  => (|{false, true}|)))|, |(map v1 : int | (-0x1eb <= v1) && (v1 < -155) :: (v1 % 0x30a) := ([true, true]))|}}) - (set v2 : set<int> | v2 in [{0x2db}] :: (v2))
}
...
function fm36(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): set<int> {
	{|multiset{0x29, |"eqwwqd"|, 79, 0x2c6, 0x1a0}|, |{false, false, true}| - |[|{false}|, |[false, true, !!false, false, !!false]|, |map[true := false]|]|, 679 % |(seq(188, i0  => ('k')))|}
}
function fm37(p0: int, p1: D1, globalState: GlobalState): map<char, int> {
	map['x' := 0x36b]
}
function fm38(globalState: GlobalState): seq<string> {
	["xeomwdehc"] + ((seq(-0x2fc, i0  => (seq(0x231, i1  => ('g'))))) + (seq(0xa9, i2  => ("unkma"))))
}
function fm39(p0: int, p1: char, p2: int, p3: int, globalState: GlobalState): D10 {
	if ((set v1 : int | v1 in map[|(map v0 : int | (935 <= v0) && (v0 < 0x1b1) :: (v0 / |map[seq(1, i0  => ('l')) := true]|) := (true))| := false] :: (v1 * 979)) !! {0x2e1}) then DC24('o') else DC24('l')
}
...
method m0(p0: D0, p1: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: array<map<int, bool>>) {
	...
	match (v7.(cf33 := if (false) then v6 else v6)) {
		...
		case DC20(cf39, cf40, cf41, cf42) =>
			...
			if (v6.f6 <= -v6.f7) {
				var v27 := "rcspe";
				v26.f10 := ("bjfovcio")[v6.f7 := v5] < (v27 + "xmouvrgh");
				v6.f7 := v6.f7 + v6.f6;
				var v28: multiset<string> := multiset{seq(0x31f, i0  => (v5))};
				...
				var v34 := "tobbymm";
				var v35: seq<int> := [|v34|];
				var v36: seq<bool> := [cf42, v0, v0, v35[v6.f7] >= |[cf39]|, v5 !in "wlngpj"];
				v6, v26.f10, v34 := v7.cf33, !v36[0x19c], v34;
				var v37: array<bool> := new bool[4];
				var v38: map<T0, bool> := map[v6 := v26.f10];
				v37[654] := fm0(v0, v1[|v38| := v6.f7], -|map['f' := cf41]|, globalState);
				v37[654] := cf40;
				v34 := v34;
				var v39: map<int, bool> := map[p1 := cf42];
				var v40: map<array<bool>, map<int, bool>> := map[v37 := v39];
				var v41: C4 := new C4(v26.f10, v40, |v34| / -v6.f7, fm1(cf42, globalState));
				v41 := v41;
				v6.f7 := v6.f7;
			}
		...
		case DC21(cf43, cf44) =>
			...
			if (v0) {
				...
				v58, v3[952], v60 := v58, v6.f6 / v6.f7, if (v6.f7 <= v6.f7) then v60 else v60;
			...
			var v71: seq<int> := [|v70|];
			v3[329], v69, v3, v71, r1 := v6.f6, "pba", v3, v70, v0;
		...
		case DC18(cf33) =>
			...
			var v75 := DC19(true, v5 !in v74, {v3, v3}, cf33.f7 - p1, v6.f7 / v6.f6);
			match (v75) {
				case DC19(cf34, cf35, cf36, cf37, cf38) =>
					var v76 := "nvmlujfv";
				...
				case DC20(cf39, cf40, cf41, cf42) =>
					...
					v82 := v82[v6.f7 > cf33.f6 := |[if (0xe0 in v83) then v83[0xe0] else false, cf42, true]| % cf33.f6];
					v1 := v1 + map[v6.f6 := v6.f7];
					v6.f7 := v6.f6;
					var v84 := "jiffwqiab";
					var v85: multiset<int> := multiset{|v1[cf33.f6 := v6.f6]|, |v82|, v6.f6};
					var v86: map<multiset<int>, string> := map[v85 := v84];
					var v87: array<string> := new string[22] [v84, v84, seq(0x18d, i4  => (v5)), v84, "stfj", v84, v84, v84, "iausxosc", v84, v84, v84, v84, v84, v84, "jjnked", (seq(0x202, i5  => ('g')))[v6.f7 := v5], "laj", v84, v84, "xt", if (v85 in v86) then v86[v85] else v84];
				...
				case DC18(cf33) =>
					...
					v98[150] := v3;
					v98[150], v93, v0 := v3, v93, (v0 ==> v0) && (v0 ==> v0);
			...
			v3[771] := if (false) then v6.f7 else v6.f6;
			...
			var v108: seq<T0> := [v6];
			v0, v0, cf33.f7, v3[771] := if (v0) then v6.f7 == |v107| else v106.f11, v106.f11, cf33.f6 * (|v108| % p1), cf33.f7;
			v102[256] := v106.f11;
			var v109: array<C4> := new C4[1];
			v109[343] := v106;
			v102[256], v109[343], cf33.f7, v6.f7 := v106.f11, v106, v3[771], p1 % -v6.f6;
	}
	
	for i7 := p1 to -(p1 % v6.f7) {
		v3[482] := i7;
		...
		v111[974] := new C4(v0, v113, p1 * v6.f6, v6.f6 % fm1(v0, globalState));
		if (v0) {
			var v115: set<int> := {v6.f6, v6.f7};
			var v116: set<bool> := {!((set v114 : int | (0x31e <= v114) && (v114 < 0x15c) :: (v114 + v3[482])) < v115)};
			v3[482] := |v116|;
			v0 := true || v0;
			var v117 := "nbbdvvot";
			var v118: C0 := new C0(v0);
			var v119: map<int, C0> := map[|v115| := v118];
			var v120 := new C1(fm20(seq(831, i8  => (v5)), false, fm1(v0, globalState), globalState), |v117| + |v119|, v6.f6);
			...
			var v129 := "vrbqmsdid";
			var v130 := DC10(v128[|v129|]);
			v127[26] := v130.cf19;
			v127[26] := v126;
			r1 := !v0;
			var v131: array<int> := new int[23](i10 => i10 / v6.f6);
			...
			r0, r1, r0, v3[482] := v110[v3[482]], v126.f10, if (if (if (v6 in v134) then v134[v6] else v0) then v0 else v0) then |[v135.cf5]| else v6.f6, fm1(v126.f10, globalState);
			v131 := new int[20];
			globalState.f1 := (-750 - v6.f6) % |(if (v0) then "wunqg" else v129)|;
		}
	...
	for i11 := v6.f7 - v6.f7 to v6.f7 {
		...
		v142[603] := {v140.f10, v0} * {false, if (i11 in v138) then v138[i11] else false};
...
class C1 extends T0 {
	...
	method m1(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		match (if (v6.f10) then v9 else v9) {
			case DC6(cf10, cf11, cf12) =>
				...
				var v13: array<C0> := new C0[11] [v6, v6, v6, v6, v6, v6, v6, v6, v11[0x246], if (f7 in v12) then v12[f7] else v6, v6];
			...
			case DC7(cf13, cf14, cf15, cf16) =>
				...
				v14, globalState.f1, v15, v8[845] := fm25(globalState), --|v16|, multiset{cf13, v24 != v24}, f7;
			...
			case DC8(cf17) =>
				...
				v1, v1, v3[364] := v28[|(v1 + v1)|], (v32.cf11 + v1) + (v1 + v1), fm0(p0, v0, f7, globalState);
				var v33: map<bool, int> := map[v6.f10 := p2];
				var v34: multiset<array<int>> := multiset{v8};
				f7, v3[364] := -(if (v6.f10 in v33) then v33[v6.f10] else -p2) - |v34[v8 := -|v1|]|, (p2 < f6) || v6.f10;
				var v35: set<int> := {p2};
		...
		if (false) {
			...
			var v45: set<int> := {f7};
			var v46: set<int> := {|v45|};
			v40 := new seq<bool>[28] [v2, v2[|v1[f7 := f13]| := v6.f10] + v2, v2, v2, [p0, v41.cf3], [if (v6.f10 in v42) then v42[v6.f10] else v6.f10], v2, [v6.f10, v6.f10] + DC11(v2).cf20[f6 := v6.f10], [v6.f10, v6.f10], v2 + DC11([false]).cf20, v2 + v2, v43.cf20, v2, [true] + [false, p0, p0], v44[p2], v2, [v2[f7], v6.f10], v2, v2 + v2, v2, v2, v2 + v2, v2, v2, [fm0(v6.f10, v0, p1, globalState)], v2, [(v41.(cf1 := v6.f10)).cf1], fm27(|v45|, v1, f13, globalState)];
			r0 := !(if (v6.f10) then v6.f10 else |v46| < v8[752]);
			v8[752] := f7;
		} else {
			...
			var v50 := DC3(false, |v49[|v1|]|, p1);
			r0 := if (v50.cf5) then v6.f10 else true;
			v3[342] := v6.f10 || v6.f10;
			v8[100] := p1;
			var v51: set<bool> := {v6.f10, v6.f10};
			var v52: map<int, set<bool>> := map[|v51| := v51];
			v6.f10, v3[342], globalState.f1, v8[100] := v6.f10, v6.f10, -|(map[p2 := v51] + (v52 + v52))|, p1;
			match (v50) {
				case DC3(cf5, cf6, cf7) =>
					...
					var v55 := DC12(cf6);
					var v56: multiset<int> := multiset{v8[100]};
					...
					cf6 := v8[100] - -|(map v58 : map<int, char> | v58 in v60 :: (v58) := (cf6))|;
				case DC4(cf8) =>
					var v61: seq<int> := [v8[100], f6];
					var v62: array<seq<int>> := new seq<int>[5] [v61, v61, v61, v61, v61];
					v62[328] := v61;
					v1, v3[342], v62[328] := ((seq(403, i1  => (f13))) + "endmc") + "gmwqy", v6.f10, v61;
					...
					v66 := (v67[p2])[!cf8 := v3[342]];
					var v68: multiset<int> := multiset{0xa8, f6, p1};
					var v69: map<bool, seq<bool>> := map[cf8 := v2];
					var v70: multiset<bool> := multiset{false, v6.f10};
					v3[342], v6.f10, v68, r0 := p0, (if (|v69| in v0) then v0[|v69|] else fm1(v6.f10, globalState)) <= -f7, multiset{|(multiset([v6.f10, v6.f10]) + v70)|}, !v6.f10;
				case DC2(cf4) =>
					var v71 := new C0(!v6.f10);
					var v72: array<int> := new int[11](i2 => i2 % |map[v71.f10 := [v6.f10]]|);
					v72 := v72;
					var v73: array<map<int, int>> := new map<int, int>[10](i3 => v0);
					v73[939] := map[p1 := fm1(fm0(v6.f10, v0, p2, globalState), globalState)];
					var v74: array<seq<int>> := new seq<int>[22](i4 => [0x3bf, p1]);
					globalState.f1, r2, v73[939], v6.f10, v74 := f7, -(v8[100] / -0x23f) % (v8[100] + v8[100]), v0 + v0, fm0(p0 <== true, map[-0x10b := f7], v8[100], globalState), v74;
					v71.f10 := false;
			}
			...
			if (p0) {
				...
				v81[940] := v79;
				var v82: multiset<bool> := multiset{true, v6.f10, v6.f10, !p0, v3[342]};
				var v83: map<bool, array<D1>> := map[if (fm0(p0, v0, f7, globalState)) then v6.f10 else v3[342] := v79];
				globalState.f1, v81[940] := (f7 + v8[100]) % |v82|, if (v6.f10 in v83) then v83[v6.f10] else v79;
				var v84 := new C0(p0);
				...
				v51 := (fm3(p0, p1, v51, map v87 : string | v87 in v88 :: (v87) := (v8[100]), globalState)).cf0;
				v6.f10 := !(v3[342] ==> v6.f10);
			}
	...
	method m10(p0: int, globalState: GlobalState) returns (r0: multiset<bool>, r1: int, r2: D1, r3: bool) {
		...
		for i0 := fm1(v0, globalState) * -0x36e to |(v1 + v1)| {
			...
			v13[34] := if (v0) then v14 else v15.cf30;
		}
		var v16: array<int> := new int[12](i1 => i1 / f6);
		var v17: map<int, int> := map[p0 := f7];
		v16[139] := if (f7 in v17) then v17[f7] else f6;
		var v18: multiset<bool> := multiset{v0};
		v16[139], r3 := p0, v18 >= v18;
		var v19: seq<int> := [v16[139] - f6];
		v16[139], v16[139], v16[139] := f6, (if (v0) then f6 else v16[139]) - -(f7 % v16[139]), v19[f6 % p0];
		for i2 := fm1(v0, globalState) to p0 {
			var v20: set<bool> := {i2 != --i2, v0 <==> v0, v0, fm0(v0, v17, v16[139], globalState), false};
			v20 := v20;
			var v21: map<seq<int>, int> := map[v19 := f7];
			v21, v16[139], v19 := fm29(globalState) + (v21 + v21), -(p0 - (p0 + 410)), (v19 + ((seq(-0x36e, i3  => (--0x274))) + v19))[DC3(v0, |v1|, f6).cf6 := f6];
		...
		var v26: set<int> := {f7, v16[139]};
		if ({-627} !! {|v19|, |v26|, 0xd0}) {
			var v27 := new C0(if (true) then v0 else v0);
			v0 := v0;
			var v29: seq<bool> := [v0, v0, v27.f10];
			var v30: seq<seq<bool>> := [v29, v29];
			f7 := if (!v27.f10) then v16[139] else if (v27.f10) then |(map v28 : seq<bool> | v28 in v30 :: (v28) := (p0))| else f6;
			v27.f10 := v0;
			var v31 := "cykvhpkly";
			var v32: multiset<int> := multiset{v16[139], v16[139]};
			globalState.f1, v16, v16[139], globalState.f1, v29 := if (v27.f10) then v16[139] else 0xc8, v16, (|v31| + |{|v32|, -0xa2, -131, 355}|) % (v16[139] - f7), f7 - f7, v29 + (v29 + v29);
		} else {
			if (v0) {
				var v33 := 'i';
				v33 := v33;
				...
				v34.f10 := v0;
				var v36: map<int, array<int>> := map[v16[139] := v16];
				v36 := v36[f6 := v16];
			} else {
				v0 := !(v0 <==> (false || v0));
				...
				v16 := if (v0) then v16 else v38[f7];
				v0 := !v0;
				...
				var v43: seq<map<int, bool>> := [v42 + map[v16[139] := true], v42, v42];
		...
		var v56 := DC4(f7 <= |(map v53 : set<int> | v53 in v55[v16[139]] :: (v53) := (v0))|);
		r2 := v56;
		r3 := v0;
	}
}
...
class C2 extends T0 {
	...
	method m1(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		if ((if (p0) then v0 else v0).cf5) {
			...
			if (p0) {
				...
				v20[681] := v7;
				v19[28], v1, v20[681], v2.f10 := f6 % (if (false) then f7 else f7), v1, v7, v2.f10;
			} else {
				var v21: array<bool> := new bool[10];
				var v22: seq<int> := [p1];
				var v23: map<seq<int>, bool> := map[v22 := p0];
				v21, v23, v21 := v21, map[seq(655, i2  => (f7)) := p0], v21;
				var v24: map<bool, bool> := map[p0 := p0];
				var v25 := "yujxjkyll";
				var v26: seq<bool> := [false];
				m8(v24, DC6(fm24(p0, DC4(p0), f7, globalState), v25, |v26[f6 := !p0]|), v25, globalState);
			...
			match (v33) {
				case DC3(cf5, cf6, cf7) =>
					...
					var v36: map<bool, int> := map[!(-p2 > 0x129) := cf6 / (if ([p0] in v35) then v35[[p0]] else f6)];
					v36 := v36[false := -(f7 - f7)];
					var v37 := new C0(cf5);
					var v38 := "nbw";
				...
				case DC4(cf8) =>
					...
					v43[709] := p0;
					v43[709] := p0;
					var v44: map<bool, bool> := map[v43[709] := p0];
					var v45 := DC0(v31);
					var v46: map<D0, bool> := map[v45 := v43[709]];
					var v47 := DC2(v46);
					var v48 := "vpeiqsqiw";
				...
				case DC2(cf4) =>
					...
					v50, v31, r1, v53[763] := v50, v31, (v54[p0 := p0] + v54) == (v54 + v54), if (true || p0) then v52 else {v51};
					r0 := p0;
		...
		for i7 := -(f7 + |v60|) to DC7(p0, f6, v62, v61).cf14 {
			...
			var v65: seq<int> := [f7];
			var v66: array<int> := new int[19] [f6, if (v0.cf5) then v0.cf6 else f6, -p2, f7, p1, |(v63 + (if (i7 in v64) then v64[i7] else v63))|, -f6 + p2, p2, p2, p1, i7, -fm1(p0, globalState), p2, i7, -i7, v65[p2], v0.cf6, -p2, fm1(p0, globalState) / f7];
			v66[488] := f6;
			v66[488] := 242;
			var v67: map<bool, int> := map[p0 := |v63| * p1];
			v67 := v67[p0 := p2];
			var v68: map<int, int> := map[v65[|v65|] := p1];
			v68 := v68[f6 := if (p0 in v67) then v67[p0] else f6];
			if (p0) {
				var v69: array<bool> := new bool[27];
				v69[578] := -f7 <= |map[fm0(false, v68, f6, globalState) := v66[488]]|;
				v69[578] := !p0;
				v66[488] := fm1(p0, globalState);
				var v70: multiset<int> := multiset{|v63|};
				globalState.f1, v69[578] := -(0x91 * p2) / p2, (604 <= f6) <==> (v70 !! v70);
				var v71 := 'i';
				var v72: seq<string> := [v63];
				var v73: seq<bool> := [v69[578]];
				var v74: set<string> := {v63, (seq(0x183, i8  => ('n')))[p2 := v71], v72[|v73|]};
				v74 := v74;
				...
				var v85: array<array<bool>> := new array<bool>[11] [v83, v83, v83, v83, v83, v83, v83, v84[p2], v83, v83, v83];
				var v86: array<char> := new char[7];
				var v87 := 'o';
				v86[866] := v87;
				v85, v79.f10, v86[866], v76, globalState.f1 := v85, if (p0 in v60) then v60[p0] else p0, v87, v76, v76.f6;
			}
		...
		for i9 := f6 to p2 {
			...
			if (!p0) {
				...
				m8(v60 + v60, v110, v109 + (seq(0x2a2, i12  => ('i'))), globalState);
			...
			var v121 := "kifqmnwow";
			var v122: array<int> := new int[17] [p1, p2, fm1(p0, globalState), f7, f6, -f6, p1 / p2, p2, if (p0) then -p2 else i9, p1 + (if (p0 in v119) then v119[p0] else |fm30(v120[p1], p0, p1, p1, globalState)|), i9 * p1, i9, i9 + p2, -0xb5, |((seq(0x74, i14  => ('k'))) + v121)|, 767, 0x115];
			v122[704] := f7;
			var v123: seq<int> := [i9];
			var v124: map<int, int> := map[-i9 := |map[v123[|map[f7 := p0]|] := true]|];
			v122[704] := (fm1(p0, globalState) * |v60|) / (-(if (p0 in v119) then v119[p0] else if (p2 in v124) then v124[p2] else fm1(p0, globalState)) * f6);
		}
		var v125: map<int, int> := map[p2 := f6];
		var v126: seq<int> := [|v125|];
		for i15 := v126[f7] * p1 to p1 {
			if (p0 || (if (v0.cf5) then p0 else false)) {
				...
				var v146: set<int> := {f7};
				v139, f7, r0, r0 := v139, |v134| + (f6 + |map[p1 := true]|), v145.cf14 <= (|v146| % v138.f7), p0;
			...
			v147, v148, v147, r1, v126 := v147, ("amfxpo")[295 := v149], v147, p0, (v126 + v126)[-p1 := f6 / |v150|];
			v147[488] := f6 * i15;
			v147[488] := p1 % f6;
			var v151 := new C0(p0);
		}
		...
		if (fm0(f6 !in v153[f6], map[p2 := f7] + map[|v125| := p2], p2, globalState)) {
			var v154: seq<seq<int>> := [seq(0x356, i18  => (p1)), v126, v126, seq(-0x3a3, i19  => (f7)), v126];
			var v155: array<string> := new seq<char>[3] [(seq(0x103, i17  => ('g'))) + v152, fm2(v154[p1], f7, |(seq(873, i20  => (0xb8)))|, p0, globalState), v152];
			v155[403] := v152 + v152;
			var v156: array<array<bool>> := new array<bool>[18];
			var v157: array<bool> := new bool[14];
			v156[578] := v157;
			v155[403], v156[578] := "hv", v157;
			globalState.f1 := f6;
			...
			globalState.f1, v158[324], v159, r1 := |v162| % p1, fm32(p0, !!(v163 <= v163), p0, p1, globalState), v159, v164.cf26;
			var v165: array<int> := new int[20];
			v165 := v165;
			v165[535] := -v126[p2] - |(seq(316, i22  => (|"p"|)))|;
			v165[535] := p1;
		} else {
			v126 := v126;
		...
		r2 := (|map[f7 := p0]| / f7) / -(if (p2 in v171) then v171[p2] else |v171|);
	}
	method m8(p0: map<bool, bool>, p1: D2, p2: string, globalState: GlobalState) {
		...
		v6 := set v7 : int | v7 in (v6 - v6) :: (v7 % 0x108);
		if (!v0) {
			v0 := v0;
			...
			var v10 := 'g';
			var v11 := new C1(v10, -0x3de % |([f7])[|p2| := |{151, f6}|]|, if (v0) then -0x48 else |p2|);
			f7 := f7;
			var v12: multiset<bool> := multiset{v0};
			var v13 := new C1(v11.f13, f7, |v12| / f7);
		} else {
			var v14 := "jx";
			...
			var v19: seq<int> := [f7];
			var v20: array<map<int, bool>> := new map<int, bool>[5] [v16, map[f7 := v0], map v17 : int | (856 <= v17) && (v17 < 0x285) :: (v17 + |"xrpgkhh"|) := (v0), v16 + (map v18 : int | v18 in v19 :: (v18 % f6) := (v0)), v16];
			v14, v15[166], v0, v0, v20 := ((seq(0xdf, i0  => ('u'))) + p2) + (seq(0x3d7, i1  => ('u'))), multiset(v19), v0, !(f6 != (f7 * f6)), v20;
			var v22: array<set<seq<int>>> := new set<seq<int>>[15](i2 => {v19[f6 := f6]} + (set v21 : seq<int> | v21 in [v19, v19] :: (v21)));
			var v23: set<seq<int>> := {v19, v19};
			v22[93] := v23;
			var v24: map<seq<int>, bool> := map[v19 := false];
			v22[93] := if (v0) then set v25 : seq<int> | v25 in v24[v19 := !false] :: (v25) else v23;
			if (!v0) {
				globalState.f1 := f7;
				var v26 := new C0(v0);
				v4[666] := -f7;
				...
				var v29 := 'f';
				globalState.f1, globalState.f1, v4[666], v14 := f7, -|(v27[f6] + (map v28 : int | v28 in (seq(284, i3  => (f6))) :: (v28 * f7) := (f7)))|, |(v14 + (if (v26.f10) then v14[f6 := v29] else seq(0x3b6, i4  => (v29))))|, p2;
				var v30 := new C0(v0);
				v4[666] := 222 % (f7 - f6);
			} else {
				var v31: map<int, int> := map[f7 := |(seq(-0xc9, i5  => ('p')))|];
				v0, v0 := true, fm0(v0, v31, 734 % f6, globalState);
				globalState.f1 := f7 / f7;
				globalState.f1 := 767;
			...
			v32[387] := v36 >= v36;
			var v37: map<bool, int> := map[v32[387] := |p2|];
		...
		var v42: array<bool> := new bool[24] [v0, v0 <==> v0, v0, v0, if (!v0) then v0 else v0, !(f6 in {f7, f7, f6, f7}), v0, true, !v0, v0, v2 < multiset{85}, 0x30b == |(map v38 : int | v38 in map[|v6| := v2] :: (v38 / |v6|) := (v0))|, v0, false, p2 != p2, v0 !in v40, p2 < p2, v0, v0, v0, !!!(v41 !! fm34(globalState)), v0, v0, v0];
	...
	method m9(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState) {
		...
		if (!!p0) {
			var v4: seq<int> := [f7];
			v3.f7 := (|v4| / p1) / fm1(v0, globalState);
			globalState.f1 := -p2;
			var v5: seq<string> := ["tjotuokyi", seq(-0x69, i0  => (v2))];
			v3.f7 := |((v5 + v5) + (seq(0x87, i1  => (v1))))|;
			var v6 := DC24(v2);
			var v7: array<char> := new char[7] [v2, v2, v2, 't', v2, v2, v6.cf51];
			v7 := v7;
			var v8: seq<bool> := [v0];
			var v9 := DC11(v8);
			v3.f7 := |v9.cf20[0x161 := p0]|;
		} else {
			...
			v11[857] := v10 + map[v0 := v3.f7];
			v11[857] := fm30(p0, p0, p1 - |[v3.f7]|, -(-0x3af * v3.f7), globalState);
			var v12: seq<int> := [f7];
			var v13: C0 := new C0(p0);
			var v14: multiset<C0> := multiset{v13};
			if (v3.f7 != (|fm2(v12[|v14| := p3], 0x3da, 0x1db, p0, globalState)| / p2)) {
				var v15: set<bool> := {p0};
				...
				var v25: array<seq<bool>> := new seq<bool>[24] [v23, v23, v23, v23, v23, v23, v23, fm27(p2, v1, 'b', globalState), if (v13.f10) then v23 else v23, v23 + v23, v23, v23, v23, if (v13.f10) then v23 else v23, [v13.f10, v13.f10, v13.f10, v13.f10, v23[p2]], [v24.cf52, true], v23 + [v13.f10], [v0, v13.f10], v23, v23 + v23, [true], v23, [p0, v0, v0], v23];
				v25[520] := v23;
				var v26: map<bool, seq<bool>> := map[v13.f10 := v23];
				v25[520] := if ((if (v13.f10) then v13.f10 else v0) in v26) then v26[if (v13.f10) then v13.f10 else v0] else v23;
			} else {
				var v27: array<array<int>> := new array<int>[27];
				var v28: array<bool> := new bool[17];
				v28[18] := v13.f10;
				v27, globalState.f1, v13, v28[18] := v27, f7, v13, p0;
				var v29: multiset<seq<D0>> := multiset{seq(0x1b8, i2  => (DC0({v0})))};
				var v30: map<int, bool> := map[v3.f6 := v13.f10];
				var v31 := DC4(v13.f10);
				var v32 := DC7(v28[18], 0x101, v30, v31);
				var v33: set<bool> := {!v28[18], v32.cf13};
				var v34 := DC0(v33);
				var v35: seq<D0> := [v34];
				var v36: seq<bool> := [p0];
				v28[18], v3.f7, v0 := DC26(v28[18]).cf52, if (v35 in v29) then v29[v35] else v3.f7, v36 < v36;
				v13.f10 := v28[18];
				v13.f10 := !!!(v2 in "oqk");
			...
			v38[902] := v3.f7;
			v3.f7, v38[902] := f7, (f7 - |(seq(-376, i3  => (v2)))|) / p3;
			var v39 := DC5(v38);
			v39 := v39.(cf9 := v38);
			var v40: seq<bool> := [v0];
			var v41 := DC23(v40[v3.f6], 0x14, v0, v0, v3.f7);
			v38[902] := --v41.cf47;
		}
			...
			decreases 100 - i5
		{
			...
			v45 := v45[-226 := |v46| % |v47|];
			v1 := v1;
			var v49: multiset<map<int, int>> := multiset{map v48 : int | v48 in v43 :: (v48 % 0x3d7) := (p3), v45, v45};
			v49 := v49;
			v0 := v0;
		}
	}
...
class C3 extends T0 {
	...
	method m1(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v4: seq<bool> := [p0];
		var v5: map<int, int> := map[f7 := |v0| + |v3[|v4|]|];
		var v6 := 'a';
		...
		v5, r1, v6, f7, r1 := fm17(multiset(v7[|v8|]), p0 ==> p0, f7, v9, globalState), match v12.(cf15 := v10) {
			case DC6(cf10, cf11, cf12) => p0
			case DC7(cf13, cf14, cf15, cf16) => true
			case DC5(cf9) => p0
			case DC8(cf17) => p0 ==> p0
		}, v6, 0x132 / (if (p0) then f7 else |fm18(fm0(p0, v5, f6, globalState), p1, globalState)|), p0;
		var i0 := 0;
		while (true)
			decreases 100 - i0
		{
			...
			v16[219] := if (p0 in v18) then v18[p0] else f6;
			var v19: multiset<int> := multiset{fm1(p0, globalState), --p1 - -411, f7 - p1};
			var v20 := DC9(v18);
			r0, v19, v20, globalState.f1 := p0 && p0, v19, if (!!p0) then fm19(p0, globalState) else DC9(v18[true := p2]), 0xd9;
			r1 := p0;
		}
		v6 := v6;
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			if (-p1 > p2) {
				...
				r1, f7, f7, v2, v26[372] := p0, p2, -|((v8 + v8) + [|fm2(v8, |v27|, f7, p0, globalState)|])|, v2, -f7 % |(v8 + v8)|;
				r1 := !p0;
				v2 := v2;
				var v28 := new C0(true);
				...
				globalState.f1, v21[51], v34 := -542, p0, v34;
				var v35 := new C0(v21[51] <== p0);
				r1, v21[51], v35.f10, v35.f10, globalState.f1 := p0, v35.f10, fm0(fm16(globalState), v5, fm15(p1, 0x11d, globalState), globalState), v35.f10, fm15(p2, p1, globalState);
				var v36 := DC0(v0);
				var v37: map<D0, bool> := map[v36 := v21[51]];
				var v38 := DC2(v37);
		...
		if (|v2| != p1) {
			...
			v43[395] := v44 - multiset{|v2|, fm15(f6, 0x9c, globalState), |v44|};
			v43[395] := multiset(v8);
			var v45: array<bool> := new bool[27];
			var v46: multiset<array<bool>> := multiset{v45};
			var v47: map<int, string> := map[p1 := "mubemdm"];
			var v48 := m6(v10 + map[|v46[v45 := |v47|]| := v41.f10], p2, {DC2(map[DC0(v0) := v41.f10])}, globalState);
		} else {
			var v49: array<char> := new char[21] [v6, 'l', v6, v6, fm20(v2, p0, |v10|, globalState), 'c', v6, if (p0) then v6 else v6, v6, v2[p1], v6, v6, 'o', v6, v6, v6, 'u', v6, fm20("kpvixhs", p0, p2, globalState), v6, if (p0) then v6 else v6];
			v49 := v49;
			...
			match (v51) {
				case DC10(cf19) =>
					...
					var v55: array<int> := new int[14] [|v52|, f7, p2, 0x116 + p2, p1, f6 - p1, f7, -p1, v8[-p1], f6 + p2, f6, |(v54 + v54)|, f7, f6 + p2];
					v53[144] := fm15(p2, f7, globalState);
					var v57: array<bool> := new bool[11] [v50.f10, fm16(globalState), v50.f10, !cf19.f10, if (v50.f10) then v50.f10 else p0, cf19.f10 <== v50.f10, p0 <==> p0, fm0(cf19.f10, map v56 : int | (0x11b <= v56) && (v56 < -0x1d2) :: (v56 % f7) := (|v0|), f6, globalState) <== v50.f10, cf19.f10, cf19.f10, !cf19.f10];
					v57[701] := cf19.f10;
					v53[144], v57[701], globalState.f1, globalState.f1 := p2, v50.f10, p2 - (p2 + p1), |[v55, v55, v53, v55]| % p2;
					v57[701] := false && fm0(v57[701], v5, f7, globalState);
					v50 := cf19;
			...
			var v69: array<bool> := new bool[27] [if (v50.f10) then p0 else true, p0, !(p1 == |(v64[f6])[v50.f10 := v50.f10]|), v12.cf13, v50.f10, !p0, v50.f10, v50.f10, false, v50.f10, v0 <= v0, p0, v50.f10, p0, v50.f10, multiset(v8) > v65, v50.f10, p2 >= p2, p0, false || true, !(if (v50.f10) then v50.f10 else v67.cf3), v68 == multiset{fm0(v50.f10, map[p2 := p2], p1, globalState)}, fm0(v50.f10, v5, p1, globalState), p0, p0, fm16(globalState), v50.f10];
			v69[401] := p0;
			var v70: set<int> := {f6};
			var v72: array<D2> := new D2[16];
			var v73: set<array<D2>> := {v72, v72};
			v69[401], r1, f7 := if (v70 !! (set v71 : int | (288 <= v71) && (v71 < 0x18a) :: (v71 / p1))) then p0 else true, !((v73 * v73) >= (v73 + v73)), -(p2 - |v5|);
			r0 := p0;
		}
		...
		if (fm16(globalState)) {
			...
			r1 := v4[(if (v6 in v74) then v74[v6] else |v8|) + p1];
			var v75: map<bool, bool> := map[p0 := p0];
			var v76: set<seq<bool>> := {v4};
			var v77: array<int> := new int[11] [fm15(p1, p1, globalState) % -|v75|, |v76|, 0x376, p1, p2, p1, p2 * v8[p2], f7, p1, f6, p2];
			v77[566] := p2;
			r1, v77[566] := false, (if (p0 in v1) then v1[p0] else f7) * (f6 / f6);
		} else {
			...
			v10 := v10[f7 := (if (f7 in v81) then v81[f7] else v80[844]) < v80[844]];
			var v82: array<bool> := new bool[11];
			v82[317] := p0;
			v82[317] := f6 != -fm1(v78.f10, globalState);
			var v83: array<map<multiset<char>, bool>> := new map<multiset<char>, bool>[2];
			var v84: multiset<char> := multiset{v6, v6, v6, v6, v6};
			v83[922] := map[v84 := v82[317]];
			var v85: map<multiset<char>, bool> := map[v84 := !v78.f10];
			globalState.f1, v78.f10, v6, v83[922] := -|(seq(280, i6  => (v6)))|, v78.f10, v6, map[v84 := true] + v85;
		}
		
		r0 := p0;
		var v86: set<int> := {f6, |("oh")[p2 := 'f']|};
		r1 := v86 !! v86;
		r2 := f6 + 0x144;
	}
	method m6(p0: map<int, bool>, p1: int, p2: set<D1>, globalState: GlobalState) returns (r0: bool) {
			...
			decreases 100 - i0
		{
			...
			var v10: seq<bool> := [v0];
			globalState.f1, r0, v1, v4[974], r0 := p1 + (|v7| + f6), !!!!([fm1(v0, globalState)] < [|v9|]), v1 + v1, v2, v10[p1];
			v7 := v7[v0 := f6];
			v0 := v0;
		...
		var v20: array<int> := new int[6](i1 => i1 % f6);
		var v21: multiset<array<int>> := multiset{v20, v20};
		var v22: array<bool> := new bool[21] [v0, f7 > f6, v0, v0, v12 !! (if (v0 in v14) then v14[v0] else set v15 : int | (-0x8e <= v15) && (v15 < 0xa8) :: (v15 * |"qkk"|)), !v0, v16[p1], v0, v0, !v18.cf3 ==> !v0, v16 < v16, v0, v0, p1 !in (if (p1 in v19) then v19[p1] else map[f6 := v0]), v0, if (p1 in p0) then p0[p1] else v0, v0, v0, v0, v21 <= v21, v0];
		v22[143] := false;
		v22[11] := v0;
		var v23 := "w";
		var v24: multiset<bool> := multiset{v0, v0, !!v0};
		var v25: set<bool> := {v0, v16[723]};
		var v26 := DC0(v25);
		v22[143], v22[11], f7 := !((((multiset(v16))[v0 := |v23|])[v0 := p1])[v0 := 0x90] == (fm22(p1, globalState) * v24)), match v26 {
			case DC1(cf1, cf2, cf3) => if (v0 in v13) then v13[v0] else v0
			case DC0(cf0) => false
		}, f6;
		v23 := match v26 {
			case DC1(cf1, cf2, cf3) => v23
			case DC0(cf0) => seq(0x3d3, i2  => ('m'))
		};
		for i3 := f6 / p1 to p1 {
			var v27: map<int, bool> := map[f6 := false];
			v27 := v27[|(if (true) then v12 else v12)| := v22[143]];
			v0 := false;
			v0 := v22[143];
			var v28 := 'g';
			var v29: seq<set<bool>> := [v25];
			r0, v22[143], globalState.f1, globalState.f1, v22[143] := !v22[143], !(v28 !in v23), f6, (f6 % f7) % i3, (v25 - v25) > v29[i3];
		}
		for i4 := p1 to p1 {
			var v30 := 'c';
			var v31: seq<set<bool>> := [v25, v25];
			var v32: T0 := new C1(v30, f6 % 95, |v31[f6]| % i4);
			var v33: map<bool, T0> := map[true := v32];
			v32 := if ((v32.f7 < p1) in v33) then v33[v32.f7 < p1] else v32;
			v20[509] := -|multiset{v30}|;
			v0, globalState.f1, v20, v20[509], v22[143] := v0, i4, v20, f7, v22[143];
			var v34: array<string> := new string[21](i5 => v23);
			v34[561] := v23;
			v34[561] := ("xr" + v23) + (v23 + v23);
			var v35 := new C2(0x100 % v32.f6, p1);
		}
		v20[821] := f6;
		v20[821] := p1;
		var v36: map<int, int> := map[-0x15c := f6];
		var v37: map<map<int, int>, bool> := map[v36 := v22[143]];
	...
	method m7(p0: bool, p1: bool, p2: int, globalState: GlobalState) returns (r0: int, r1: int, r2: int) {
			...
			decreases 100 - i1
		{
			...
			var v3: array<int> := new int[29](i2 => i2 % f6);
			var v4: seq<array<int>> := [v3];
			var v5: map<array<int>, bool> := map[v4[-0x39d] := v1];
			v5 := map[v3 := v1];
			...
			if (fm0(v1, v13, |v14|, globalState)) {
				...
				v0[559] := v19 in v14;
				v3[795] := f7;
				v0, v0, v0[559], r0, v3[795] := v0, v0, p0, |v14|, -0x3cc;
				var v21: map<seq<bool>, bool> := map[(v2 + v2)[f6 := p0] := if (p1) then v1 else v1];
				v21 := v21[fm21(globalState) := !v0[559]];
				var v22: set<bool> := {p0};
				var v23: map<bool, int> := map[p1 := v8];
				var v25: multiset<int> := multiset{f6};
				var v28: array<int> := new int[17] [fm1(p0, globalState) - f6, v3[795] - v8, fm1(p1, globalState), v8, if (p0) then |v22| else |v23|, -0x1b4 % p2, v8, v3[795] + |multiset{v8}|, fm1(v9, globalState), |((set v24 : int | (0xdb <= v24) && (v24 < 0x3dc) :: (v24 * p2)) + (set v26 : int | v26 in v25 :: (v26 + 0x323)))|, v3[795] + |(map v27 : int | (0x311 <= v27) && (v27 < 0xc0) :: (v27 % v8) := (p1))|, p2, p2, p2, fm15(|(seq(0x21f, i5  => (v12)))[77 := v12]|, f7, globalState), 0x10e * p2, f6];
				v28 := v28;
			}
		...
		var v31: seq<int> := [|v30[p2]|];
		var v32: seq<int> := [v31[p2], p2];
		var v33: seq<int> := [|v32|];
		r1 := -v31[p2];
		var v34 := 'e';
		var v35: C1 := new C1(v34, p2, |(seq(-0x1e5, i6  => (DC24('e').cf51)))|);
		v34, v35 := v34, v35;
...
class C4 extends T0 {
	...
	function fm12(p0: bool, p1: bool, globalState: GlobalState): seq<char> {
		(['t', 'g'] + (seq(-535, i0  => ('f')))) + ((seq(511, i1  => ('q'))) + ['j', 'u'])
	}
	method m1(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		for i0 := f6 to fm1(p0, globalState) / p1 {
			var v0: multiset<int> := multiset{i0};
			var v1: seq<int> := [0x4d];
			v0 := multiset(v1);
			var v2: map<int, int> := map[i0 := p2 / 76];
			f7 := if (-(v1[-i0] % f6) in v2) then v2[-(v1[-i0] % f6)] else f7;
			var v3 := "t";
			v3 := v3;
			f7 := p1 - 0xe4;
		}
		...
		match (v13) {
			case DC9(cf18) =>
				...
				var v17: map<bool, int> := map[if (v15[520 := f6] in v16) then v16[v15[520 := f6]] else v9.f10 := 266];
				v17 := v17 + (v17 + v17);
		...
		match (v22) {
			case DC6(cf10, cf11, cf12) =>
				...
				r0 := !((fm13(globalState))[p0 := -|v23|] >= (fm13(globalState))[v9.f10 := cf12]);
				r1 := f11;
			...
			case DC5(cf9) =>
				...
				cf9[844] := |(v40 + v40)|;
				cf9[844] := if (false) then f6 else p1;
			case DC8(cf17) =>
				r1 := v9.f10;
				v5[132] := p2;
				...
				v41[158] := !p0;
				v7[371] := f7;
				v9.f10, v5[132], v41[158], v7[371], r1 := "mdoyxqucy" < v4, p2, p0, -836, f11;
				var v42: array<array<bool>> := new array<bool>[13];
				v42 := v42;
				var v43: seq<array<bool>> := [v41];
				var v44: multiset<array<bool>> := multiset{v43[f7]};
				v44 := v44[v41 := p1];
		}
		
		var i5 := 0;
		while ((0x218 / |map[v9.f10 := f11]|) == f7)
			decreases 100 - i5
		{
			if (i5 >= 100) {
				break;
	...
	method m4(globalState: GlobalState) {
		...
		for i0 := f7 to 0x6e {
			if (v2) {
				...
				var v10 := DC18(v8);
				var v11: array<T0> := new T0[29] [v8, v8, v8, v8, v8, v8, v8, v8, v8, if (f11) then v8 else v8, v8, v8, if (f11) then v8 else v8, v8, v8, v8, v8, v8, v8, if (!v9[|[v2, v2, v2]|]) then v10.cf33 else v8, v8, v8, v8, v8, v8, v8, v8, v8, v8];
				v11[661] := v8;
				v11[661] := DC18(v8).cf33;
				var v12: seq<int> := [v8.f7, 0x256, i0 + i0];
				f7 := -v12[fm1(v2, globalState)];
				var v13: array<int> := new int[24](i1 => i1 - f6);
				v13[819] := if (v2) then 0x114 else v8.f7;
				v13[819] := v8.f6;
				var v14: map<T0, bool> := map[v11[661] := v2];
				v14 := v14[v11[661] := v2];
			} else {
				...
				v18, v19[426], v20[190], globalState.f1, v22 := v18, !v2 || (v2 in v1), f7, -(--0x168 % i0), if (fm0(f11, map v23 : int | (63 <= v23) && (v23 < 280) :: (v23 - f7) := (689), f7, globalState)) then v22 + v22 else map[!f11 := fm12(false, f11, globalState)];
				v21 := v21 + v21;
				var v24: map<array<int>, int> := map[v20 := i0];
				v2, v20, v20[190], v20[190] := |v24| >= |fm36(f7, v19[426], f6, f11, globalState)|, v20, f6, f7 + f7;
				var v25: set<bool> := {v2};
				v2 := !(true in v25);
			}
			...
			v27, f7, v2, v2, v33 := fm37(|{v2}| - |(seq(0x2ca, i4  => (f7)))|, DC3(!true, i0, |v34|), globalState), -f7, v35 in v36, fm0(!!v2, v37 + v37, |v39|, globalState), v33;
			v2 := !f11;
			...
			match (v41) {
				case DC14(cf23, cf24, cf25) =>
					cf23 := (-f6 + |v31|) % (cf23 * f7);
					var v42: seq<bool> := [v2];
					var v43: seq<bool> := [v42[|v42|], true];
					v32[453] := if (v2 in v28) then v28[v2] else |v43|;
					var v44 := DC5(v32);
					var v45: array<D2> := new D2[2] [v44, v44];
					v35[747] := true;
					v35[900] := v2;
					v32[453], v45, v26, v35[747], v35[900] := fm1(f11, globalState), v45, v26, f11, 455 != (if (f11) then |{v2, f11, v2}| else i0);
					v2 := v35[747];
			...
			decreases 100 - i7
		{
			...
			if ((v56 - v56) >= v56) {
				...
				v59 := v59;
				var v60: array<int> := new int[12](i8 => i8 % f7);
				v60[134] := -f7;
				v60[134] := f6;
				v2 := f11;
				v2 := true <==> v2;
				...
				v2, v60[134], v61[899], v60[134] := v1 > v1, if (v62 in v63) then v63[v62] else --(v62.f6 * v62.f7), f11, f7;
			} else {
				v2 := f11;
				...
				v68[115] := |v69[f7 := v0]|;
				var v70 := "um";
				v68[115] := fm1("ut" < v70, globalState);
				var v71: seq<int> := [f7];
				v71 := v71;
				v2 := f11;
			}
			...
			var v74 := "utk";
			var v75 := new C0(fm0(fm0(true, map v72 : int | (-881 <= v72) && (v72 < -0x31c) :: (v72 * |v1|) := (f7), v73[|v74|], globalState), v55, -f6, globalState));
			f7 := f6;
		}
		var i10 := 0;
		while (false)
			decreases 100 - i10
		{
			...
			var v85: array<seq<string>> := new seq<string>[23] [[v77], v78, v78[|map[f6 := f11]| := v77], v78, [v77[f6 := v79], v77], v78, [v77] + v78[f6 := v77], v78, v78, [v77, "fdn", v77, v77, v77], v78, (v78 + v78)[f7 := "smsluxg"], v78, v78, (seq(0xc4, i11  => (v77))) + v78, seq(0x94, i12  => (v77)), v78, v80.cf59[|v82| := fm2(v83, f7, f7, f11, globalState)], v78, fm38(globalState), v78, v78[|v84| := v77], v78];
			v85[779] := v78;
			var v86: seq<seq<bool>> := [[DC26(v2).cf52]];
			v2, globalState.f1, v76, v2, v85[779] := v2, if (v2) then v83[f6] else fm1(true, globalState), if (f7 < f7) then v76 else v76, !((f7 > f7) && (v86 <= [v84])), v78 + v78[f6 := v77];
			v2 := f7 <= f6;
			v76[187] := f11;
			v76[187] := f6 >= (f7 / |v83|);
			f7 := f7;
	...
	method m5(p0: int, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v8: seq<int> := [|v7|];
			var v9: map<seq<string>, int> := map[v5 := |v8| % fm1(f11, globalState)];
			...
			if (f11 <== (f7 != f7)) {
				...
				v13, v3[464], globalState.f1 := v13, false in v15, f6 - -|v2|;
			} else {
				v3[928] := f11;
				...
				v3[928] := if (v20 in v19) then v19[v20] else false;
				var v21: map<string, int> := map["ctwrgg" := f7];
				var v22: map<int, bool> := map[|v21| := v3[928]];
				v22 := v22[p0 := v3[928]];
				var v23: array<D6> := new D6[19];
				v23[590] := DC15(f11, f6, f6, p0);
				var v24: array<int> := new int[10];
				var v25 := DC15(v3[928], fm1(!v3[928], globalState), f7, p0);
				v23[590], v24 := v25.(cf27 := p0, cf29 := f6), v24;
				v3[928] := f7 == p0;
				v7 := v8 + (seq(0x54, i1  => (0x390)));
			}
		...
		var v31: array<string> := new string[18] [v27, v27, if (f11) then "jeil" else v27, v27, v27[p0 := v28], v27, v27, v27, v27, v27, v27, v27, fm2(v29, if (p0 in v30) then v30[p0] else f6, f6, f11, globalState) + v27, v27 + v27, v27, v27, v27 + v27, v27];
		var v32: map<int, int> := map[f7 := |v27|];
		v31[56] := fm12(fm0(f11, v32, -p0, globalState), f11, globalState);
		v31[56] := v27;
		var v33: set<int> := {p0, v29[-0x38]};
		...
		var v39: map<bool, int> := map[v37 := |v31[56]|];
		...
		match (v40) {
			case DC25() =>
				...
				if (p0 >= (p0 - -0x3d8)) {
					...
					v44[450] := fm0(fm0(true, v32, f6, globalState), v32, |v41|, globalState);
					v44[450] := f11;
					var v45: array<char> := new char[12];
					v45[652] := v28;
					v44[450], globalState.f1, v37, v45[652], v37 := v44[450], p0, v44[450], v28, f11;
					var v46: map<int, bool> := map[p0 := true];
					var v47 := DC0(v41);
					var v48: map<D0, bool> := map[v47 := !v44[450]];
					var v49 := DC2(v48);
					var v50: set<D1> := {v49, DC2(v48).(cf4 := v48), v49, v49};
					var v51 := v42.m6(v46 + v46, f7, v50, globalState);
					var v52: array<D6> := new D6[17](i2 => DC14(f7, multiset{v51, v44[450]}, f6));
					var v53 := DC14(|[!v44[450], v51]|, multiset{v37}, f7);
					v52[706] := v53;
					v52[706] := v53;
					v43[968] := fm1(v43[968] > 0x87, globalState);
				} else {
					var v54 := new C0(v31[56] == v27);
					var v55 := DC9(multiset{f11, f11, f11});
					var v56 := DC15(v37 <==> v37, p0, 0x359 * v29[p0], |multiset{v43[968]}| / f6);
					var v57: seq<D10> := [if (!v54.f10) then v40 else v40.(cf51 := v28), v40, v40, v40];
					var v58: multiset<bool> := multiset{v54.f10};
					globalState.f1, v55, v56, v57, v27 := v43[968] - (f7 + v43[968]), v55.(cf18 := v58), v56, [fm39(|[p0]|, 'h', p0, f6, globalState), v40] + (v57[f6 := v40] + v57), "jl";
					globalState.f1, globalState.f1, globalState.f1 := 0x2f1, p0, p0;
					globalState.f1 := (f7 + v43[968]) - v43[968];
			...
			case DC26(cf52) =>
				...
				v59[505] := if (fm1(cf52, globalState) in v60) then v60[fm1(cf52, globalState)] else f11;
				v59[505] := f11;
				v59 := v59;
				v37 := f11;
				var v61: array<int> := new int[20];
				v61[860] := if (cf52) then f6 else -f7;
				v61[860] := -f7 - f6;
			case DC24(cf51) =>
				v37 := !v37;
				var v62 := DC11(v38);
				var v63: map<D5, int> := map[v62 := f6];
				globalState.f1, v37, v37 := -0x3e3 * (f6 % 477), fm0(v37, v32, f7 - f6, globalState), v38[if (v62 in v63) then v63[v62] else f6];
				var v64: set<bool> := {v37};
				var v65: multiset<bool> := multiset{fm0(f11, map[|v64| := |v38|], |v29|, globalState)};
				if (v65 !! v65) {
					var v66 := new C2(f6, 383);
					var v69 := DC4(f11);
					var v70 := DC7(f11, v29[f7], map v68 : int | (0x179 <= v68) && (v68 < -0xbf) :: (v68 / f7) := (v37), v69);
					...
					var v77 := DC2(v76);
					var v78 := DC6(v77.(cf4 := map[v75 := f11]).(cf4 := v76), v31[56], f6);
					v66.m8(v74, v78, seq(0x77, i3  => (cf51)), globalState);
				} else {
					var v79: map<bool, set<bool>> := map[v37 := v64 - v64];
					var v80: array<set<bool>> := new set<bool>[1];
					var v81: map<int, bool> := map[0x10c := f11];
					globalState.f1, v79, globalState.f1, v80 := p0, v79, f7 / (f6 + |v81|), if (fm0(v37, v32, |v65|, globalState)) then v80 else v80;
...
class C5 extends T0 {
	...
	method m1(p0: bool, p1: int, p2: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v5: map<int, int> := map[|v4| / 387 := f6];
		r2 := |v5|;
		for i0 := -f6 to p2 {
			...
			v6[429] := if (p0) then v15 else v15;
			var v16: seq<array<map<D0, bool>>> := [v15];
			v6[429] := v16[DC3(p0, -p1, f7).cf6];
			...
			var v23: array<seq<int>> := new seq<int>[18] [f9, f9 + f9, f9 + f9, if (i0 in v17) then v17[i0] else f9, f9, f9, f9 + v18[p2], f9, f9, if (p0 in v19) then v19[p0] else f9, f9, f9, [p1, 821, -|v20|, f6, p1], seq(-17, i1  => (f6)), f9 + f9, if ((if (v21 in v22) then v22[v21] else i0) in v17) then v17[if (v21 in v22) then v22[v21] else i0] else f9, f9 + f9, seq(919, i2  => (f6))];
			v23[973] := [f6];
			v23[973] := if (p0) then fm5(p0, p1, p2, p0, globalState) + v18[f6] else f9;
			var v24: multiset<int> := multiset{p2, f7, f6, f6};
			var v25: set<int> := {|v20|, -0x1df, p2};
			var v26: array<int> := new int[15](i3 => i3 / |(seq(0x39c, i4  => (|multiset{!p0}|)))|);
			var v27: map<char, array<int>> := map[v0 := v26];
			var v28: array<int> := new int[23] [f6, p2, |v1|, p1, if (!!p0) then |v23[973]| else i0, |"f"|, -i0, i0, i0, f6, f6, i0 - f6, v23[973][f6], f7, i0, |v19|, -p2, if (|v25| in v24) then v24[|v25|] else i0, f6, f7, |v27|, f7 % f7, p1];
			v26 := DC5(v28).cf9;
			if (p0) {
				...
				v32 := v32["m" := p0];
				f7 := f7 / (853 / |v1|);
				var v33: seq<array<bool>> := [v3, v2[377], v3];
				v3 := v33[i0];
				r1 := p0;
				var v34: multiset<bool> := multiset{true, p0, p0, p0, p0};
				var v35 := DC9(v34);
				var v36: map<bool, multiset<bool>> := map[p0 := v34];
				var v37: array<multiset<bool>> := new multiset<bool>[24] [if (p0) then v34 else multiset{p0, p0}, v34, fm6(globalState), v34, v35.cf18, v34, multiset{!p0, p0, p0}, v34, multiset(v21), v34, v34, (multiset{p0})[p0 := p1], v34, v34 + multiset{p0}, v34, v34, v34 * (if (p0 in v36) then v36[p0] else fm6(globalState)), multiset{p0} - v34, v34 * v34, v34, v34, v34, multiset{!p0, p0, p0}, v34[p0 := p2]];
				v37 := v37;
			}
		...
		v2[377][667] := v38.f10;
		v2[377][667] := p0;
		var v39: multiset<bool> := multiset{v2[377][667], p0};
		var v40 := DC9(v39);
		r0 := match v40 {
	...
	method m2(p0: multiset<array<bool>>, p1: bool, p2: bool, globalState: GlobalState) returns (r0: bool, r1: array<D0>) {
			...
			decreases 100 - i0
		{
			...
			var v13: array<D2> := new D2[25] [v10, v10, v10, DC6(v9, seq(0x2f7, i2  => (v1)), (v12.(cf7 := f7, cf5 := p1)).cf7), DC6(v9, v4, f7), v10, v10.(cf10 := DC2(v8), cf12 := f7), v10, v10, v10, v10, if (p1) then v10 else v10, v10, v10, v10, v10.(cf11 := v4, cf10 := v9), v10, fm7(globalState), v10, v10, fm7(globalState), v10, v10, v10, v10];
			v13 := v13;
			r0, r0 := !false, p2;
			...
			match (v15) {
				...
				case DC7(cf13, cf14, cf15, cf16) =>
					...
					f7, v14.f10, v11, v0[491], v17 := |(v18 + map[v14.f10 := p2])|, cf13, v11, -312, v17;
				...
				case DC5(cf9) =>
					...
					v21 := v21[v14.f10 := cf9];
					v1 := fm8(v4 + (seq(200, i3  => (v1))), v1, v14.f10, fm4(globalState), globalState);
					var v22: seq<string> := [v10.cf11];
					var v23: array<string> := new seq<char>[7] [seq(0x51, i4  => (v1)), v4[|[f9]| := v1], v4, v4, v4, v22[f7], "sfyudb"];
					var v24: map<int, array<string>> := map[v0[491] := v23];
					v24 := v24[f6 := v23];
					var v25: seq<C0> := [if (v14.f10) then v14 else v14, v14, v14];
					var v26: multiset<bool> := multiset{v14.f10, v14.f10};
					v14, v0[491], v22, v1, r0 := v25[v0[491]], (v0[491] % f6) * v0[491], [v4, seq(0x183, i5  => (v1))], v1, f6 == (|v26| * f6);
				case DC8(cf17) =>
					v0[491] := f6;
					globalState.f1 := f7;
		...
		var v28: map<int, int> := map[|v4| := v0[491]];
		var v29: set<bool> := {p1};
		var v30 := DC0(v29);
		...
		v34 := v34[-((if (v36[v0[491]] in v35) then v35[v36[v0[491]]] else f7) % |v4|) := v37];
		r0 := p1;
	...
	method m3(p0: array<bool>, p1: int, globalState: GlobalState) {
		var v0 := true;
		var v1: seq<bool> := [v0];
		var v2: map<seq<bool>, int> := map[v1[f6 := v0] := f6];
		var v3: multiset<int> := multiset{f6};
		f7 := if ((v1 + v1) in v2) then v2[v1 + v1] else |v3[957 := f6]| / |"adkmbscvj"|;
		var i0 := 0;
		while (v0)
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v4 := "lvswxolf";
			v4 := fm2(f9, if (v1[f7]) then f7 else f6, f6, !v0, globalState);
			var v5 := new C0(v0);
			...
			match (v6) {
				case DC1(cf1, cf2, cf3) =>
					...
					v7[928] := v9[|fm10(v5.f10, v0, v1, true, globalState)|];
					p0[159] := v0;
					p0[159] := cf3;
				...
				case DC0(cf0) =>
					globalState.f1 := p1;
					v4 := (v4 + v4) + v4;
					var v11: array<int> := new int[9](i1 => i1 / -0x1bc);
					var v12: T0 := new C2(|v1|, |(seq(0x18d, i2  => (f6)))|);
					var v13: map<T0, bool> := map[v12 := true];
					var v14: map<bool, int> := map[v0 := |v13|];
					v11[176] := |v14|;
					p0[213] := v0;
					v11[176], p0[213] := |v4|, v5.f10;
		...
		var v24: array<seq<int>> := new seq<int>[26] [f9, [f6, f9[|v19|], f6], [p1], seq(423, i5  => (f6)), f9[f7 := |v20|], f9 + [f7, -0x106], f9, f9, f9, f9, fm5(v18.f10, if (v0 in v21) then v21[v0] else |map[v0 := p1]|, fm1(v18.f10, globalState), v0, globalState), f9[f7 := v23.cf23], f9, f9, fm5(true, -647, p1, v18.f10, globalState), f9, f9, f9, [-fm1(false, globalState), f7, f6, f6], f9, f9, fm35(f7, f7, globalState), f9, f9, fm5(v0, p1, f7, v0, globalState) + f9, f9];
		forall i4 | 0 <= i4 < v24.Length {
			v24[i4] := (seq(0x343, i6  => (|v21|))) + f9;
		}
		var v25 := 't';
		var v26: C1 := new C1(fm8(v20, v25, v18.f10, !v18.f10, globalState), |v20|, f7);
		v26 := v26;
		var v27 := new C3(|fm2([24], f7, -f7, v0, globalState)| % f7, 0x36c);
		var v28 := new C3(v27.fm15(f7, p1, globalState) / f6, f9[p1]);
	}
}
...
method Main() {
	...
	v1, v2[673], v4, v1 := v1, v1, map[{v1, v1} := v1], v6 !! (if (multiset([v7, v7, v7, v7]) in v9) then v9[multiset([v7, v7, v7, v7])] else v6);
	for i1 := v0 + v0 to v0 {
		v5[990] := i1;
		v5[990] := i1;
		var v10: map<int, int> := map[v5[990] := i1];
		var v11: map<bool, bool> := map[false := fm0(v2[673], v10, -i1, globalState)];
		v11 := v11[v1 := v5[990] > i1];
		v5[990] := v0;
		globalState.f1 := v0;
	}
	...
	if (if (if (v1) then v1 else true) then v1 && fm0(v2[673], v12, v0, globalState) else v0 == -v0) {
		var v13 := DC0(v3);
		var v14: multiset<set<bool>> := multiset{v3, v3, v13.cf0};
		v5[30] := v0 / (if (v3 in v14) then v14[v3] else 0x3e4);
		v5[30], globalState.f1, v2[673], v2, v2[673] := v0 - v0, v0 + v0, v1, v2, v1;
		var v15: array<seq<int>> := new seq<int>[8];
		v15[659] := [v5[30], fm1(v1, globalState)];
		var v16: seq<int> := [v0];
		v15[659] := v16;
		var v17 := DC1(v1, v2, v2[673]);
		var v18, v19, v20 := m0(v17.(cf3 := !v2[673], cf2 := v2).(cf3 := false), v5[30], globalState);
		v17 := v17;
		var v21, v22, v23 := m0(v17, v18, globalState);
	} else {
		v7 := fm2([v0, fm1(fm0(v2[673], v12, -v0, globalState), globalState)], fm1(v1, globalState) / v0, v0, !v1, globalState);
		var v24: multiset<int> := multiset{v0, 556};
		v1 := (v24 > v24) || v1;
		v2[673] := v2[673] <== v2[673];
		globalState.f1 := v0;
		var v25: multiset<bool> := multiset{v2[673]};
	...
	v5[71] := |v32|;
	var v33: map<int, bool> := map[v0 := v2[673]];
	var v34: map<array<bool>, map<int, bool>> := map[v2 := v33];
	var v35 := new C4(v1, v34, 745, v5[71]);
	globalState.f1 := -937;
	var v37 := DC16(map v36 : char | v36 in v7 :: (v36) := (v0));
	var v38: map<bool, D7> := map[v2[673] := v37];
	v38 := v38;
	var v39: multiset<int> := multiset{v5[71], v0};
	for i4 := v5[71] to |v39| {
		v5[71] := v5[71];
		var v40: seq<bool> := [v35.f11, v35.f11];
		var v41 := 'h';
		var v42: array<array<int>> := new array<int>[6];
		var v43: map<bool, bool> := map[true := v2[673]];
		var v44: C5 := new C5(v42, [|v43|, v5[71]], i4, v5[71]);
		var v45: multiset<C5> := multiset{v44};
		var v46 := DC11(v40);
		var v47 := DC19(v1, v2[673], v6, v0, v5[71]);
		var v48: array<seq<bool>> := new seq<bool>[29] [v40 + v40, v40, v40, v40, [v2[673]], v40, if (v1) then v40 else ([v35.f11, v35.f11])[v0 := v1], v40, v40, (fm27(-187, seq(-0x385, i5  => ('h')), v41, globalState))[if (v44 in v45) then v45[v44] else 0x21a := v35.f11], v40, v40, v40, v40, v40, v40, v46.cf20, v40, v40 + v40, v40 + v40, v40, v40 + v40, fm21(globalState), v40, v40 + [v47.cf34], [v35.f11], v40, if (v35.f11) then v40 else v40, v46.cf20];
		v48[592] := v40;
		v48[592] := v40;
		var v49 := DC0(v3);
		var v50: map<D0, bool> := map[v49 := v1];
		var v51 := DC2(v50);
		var v52 := DC6(v51, "vku", v5[71]);
		var v53: map<bool, int> := map[v1 := v5[71]];
		...
		decreases 100 - i7
	{
		...
		i7 := i7 + 1;
		globalState.f1 := v5[71];
		var v56: array<seq<bool>> := new seq<bool>[14](i8 => [true] + [v35.f11, v35.f11]);
		var v57: seq<bool> := [true, v1];
		v56[535] := v57 + v57;
		var v58 := DC4(v1);
		var v59 := DC7(v35.f11, |v3|, v33, v58);
		v56[535] := (if (!fm0(v59.cf13, v12, |v7|, globalState)) then v57 else v57) + ([v1, if (v0 in v33) then v33[v0] else v35.f11])[v0 := true];
		var v60 := new C0({v5[71], v5[71]} >= v30);
		var v61: T0 := new C4(v35.f11, v35.f12, v5[71], fm1(v2[673], globalState));
		var v62: multiset<T0> := multiset{v61, v61, v61, v61};
		var v63: map<multiset<T0>, bool> := map[v62 := false];
		var v64: T0 := new C4(fm0(v2[673], v12, |v57[v0 := v2[673]]|, globalState), v34, v0, |(v63 + v63)|);
		var v65 := 'k';
		v7, v64 := v7 + [v65, fm8(seq(0x33c, i9  => (v65)), 'p', false, v35.f11, globalState), v65, v65], v61;
	}
	v2[673] := v2[673];
	var v66 := DC0(v3);
	var v67: map<D0, bool> := map[v66 := v2[673]];
	var v68 := DC2(v67);
	match (v68) {
		case DC3(cf5, cf6, cf7) =>
			...
			var v75, v76, v77 := v35.m1(v73[v0], --(|v74| - cf6), |map[cf7 := cf6]|, globalState);
			v35.m5(-(if (cf5) then v5[71] else v0), globalState);
			var v78 := 'q';
		...
		case DC4(cf8) =>
			...
			var v81 := new C2(v5[71], v0);
			v2 := v2;
			var v82: multiset<bool> := multiset{!false};
			if (|(if (cf8) then v82[v1 := v5[71]] else v82[v35.f11 := v0])| > v5[71]) {
				...
				var v86: C0 := new C0(v2[673]);
				var v87 := DC10(v86);
				v87 := v87;
				cf8 := v35.f11;
				var v88: seq<bool> := [cf8 || !v86.f10, cf8];
				v88 := v88 + v88;
				var v89 := DC3(v2[673], -v0, |v39|);
				v1, v2[673], v5[71], cf8, cf8 := if (v86.f10) then |v30| <= -0xc0 else v35.f11, v2[673], (v0 - |v88|) / v5[71], (|v33| * v0) == v0, v89.cf5;
				globalState.f1 := v0 % (if (v5[71] in v12) then v12[v5[71]] else v0);
			}
			
		case DC2(cf4) =>
			var v90: seq<array<bool>> := [v2, v2];
			var v91: array<array<bool>> := new array<bool>[12] [v2, v90[v5[71]], v2, v2, DC1(v2[673], v2, v35.f11).cf2, v2, v2, v2, v2, v2, v2, v2];
			v91[615] := if (v35.f11) then v2 else v2;
			v91[615] := v2;
			v12 := v12[-v5[71] := |v7| + v5[71]];
			v2[673] := v1;
			v0 := v5[71];
	}
	...
	if (v2[673]) {
		...
		var v92 := 'p';
		v92 := v7[v0 / |v3|];
		v12 := v12[fm1(v2[673], globalState) := fm1(v2[673], globalState)];
		v0 := fm1(v1, globalState);
		var v94: array<set<int>> := new set<int>[6] [v30, v30, v30, {v0, v0, v0, v5[71]}, set v93 : int | (0x36d <= v93) && (v93 < 0x1b2) :: (v93 * v0), {v0, v0, v0, v0, v0}];
		var v95 := DC28(v7, v94, v35.f11, v1);
		var v96 := DC29(v95);
		v96 := v96;
	} else {
		var v97: set<array<bool>> := {v2};
		var v98: map<bool, int> := map[v1 := v5[71]];
		v2[673] := !!fm0(v35.f11, v12[|v39[v0 := |v97|]| := |v98|], v0, globalState);
		var v99: C0 := new C0(v35.f11);
		var v100 := DC10(v99);
		v100 := v100;
		v99.f10 := fm0(fm0(v35.f11, v12, v0, globalState), v12, |fm40(v5[71], v99.f10, globalState)|, globalState);
		globalState.f1 := -v0;
		globalState.f1 := -252;
	}
