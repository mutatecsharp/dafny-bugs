...
class C1 extends T1, T3 {
	...
	method m3(p0: bool, p1: map<array<int>, seq<bool>>, p2: bool, p3: T2, globalState: GlobalState) returns (r0: int, r1: int, r2: set<int>, r3: char) {
		...
		var v13: array<int> := new int[2] [f16, safeDivisionInt(0x20f, if (v10 in v12) then v12[v10] else 0x17c)];
		var v14 := 'w';
	...
	method m4(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		for i0 := p2 to f13 {
			...
			var v1: map<string, int> := map[("xek")[safeIndex(p2, |"xek"|) := fm1(f13, globalState)] := f12[safeIndex(|v0|, |f12|)]];
			var v2 := "y";
		...
		var v8: map<set<int>, string> := map[set v7 : int | (-982 <= v7) && (v7 < 773) :: (safeModuloInt(v7, |"mfaatcgy"|)) := "jsyns"];
		var v9 := "xiwrxg";
		...
		v13[safeIndex(745, v13.Length)] := p3;
		globalState.f5, v13[safeIndex(745, v13.Length)] := f13 * p2, !p3;
		var i2 := 0;
		while (p3)
			decreases 100 - i2
		{
			...
			var v15: array<int> := new int[13] [p2, p2, f16, if (!!v13[safeIndex(745, v13.Length)]) then p0 else |v9|, f12[safeIndex(p2, |f12|)], f16 * (if (p3 in v14) then v14[p3] else p1), p1, f16 * |v9|, f13, f16, p0, f13, p2];
			v15 := v15;
			if (p3) {
				r1 := v13[safeIndex(745, v13.Length)];
				var v16: multiset<bool> := multiset{v13[safeIndex(745, v13.Length)], p3};
				var v17: multiset<multiset<bool>> := multiset{v16, multiset{v13[safeIndex(745, v13.Length)]}};
				v14 := v14[fm44(globalState) !! v17 := f16];
				v15[safeIndex(763, v15.Length)] := p2;
				v15[safeIndex(763, v15.Length)] := p2;
				var v18: set<bool> := {false, v13[safeIndex(745, v13.Length)]};
				var v19: map<int, bool> := map[|v18| := v13[safeIndex(745, v13.Length)]];
				var v20: multiset<map<int, bool>> := multiset{v19};
				var v21 := new C0(v13[safeIndex(745, v13.Length)], v20, [|f12|, p1]);
				m0(v13[safeIndex(745, v13.Length)], globalState);
			} else {
				var v22: array<seq<char>> := new string[17](i3 => v9);
				v22[safeIndex(814, v22.Length)] := v9;
				globalState.f5, v13[safeIndex(745, v13.Length)], globalState.f5, v22[safeIndex(814, v22.Length)] := |[p3]|, p3, 0x3b3 - safeDivisionInt(p0, f13), (seq(abs(0x14b), i4  => (if (v13[safeIndex(745, v13.Length)]) then v3 else v3)))[safeIndex(p2 - p1, |(seq(abs(0x14b), i4  => (if (v13[safeIndex(745, v13.Length)]) then v3 else v3)))|) := v9[safeIndex(fm4(v4, globalState), |v9|)]];
				v13[safeIndex(745, v13.Length)] := fm0(p0, !p3, f14, globalState);
				globalState.f9 := v13;
				r1 := v4 !! v4;
				var v23: seq<bool> := [f14 && p3, v13[safeIndex(745, v13.Length)]];
			...
			var v28: map<set<array<bool>>, bool> := map[v24 * v24 := |((map[v13[safeIndex(745, v13.Length)] := v25])[true := {v26[safeIndex(p1, |v26|)]}])[v27.cf9 := v25]| > f13];
			v28 := v28[v24 := p3];
			globalState.f5 := p1 - p2;
		}
		if (v13[safeIndex(745, v13.Length)]) {
			var v29: map<bool, char> := map[fm0(p1, true, f14, globalState) := v3];
			var v30: array<char> := new char[10] [v3, v3, v3, v3, v3, v3, v3, v3, v3, v3];
			v29, r1, v13[safeIndex(745, v13.Length)], v30, globalState.f5 := v29, v13[safeIndex(745, v13.Length)], fm0(f13, p3, !(f13 > p2), globalState), v30, f13;
			var v31: array<int> := new int[25](i5 => safeDivisionInt(i5, p2));
			...
			if (v13[safeIndex(745, v13.Length)]) {
				globalState.f5, globalState.f5, r1, globalState.f0 := p2, -((f16 + p2) - p0), fm0(f12[safeIndex(fm6(globalState), |f12|)], f13 != f13, 0x16d <= f16, globalState), v3;
				var v34: map<int, bool> := map[p1 := p3];
				var v35: multiset<map<int, bool>> := multiset{v34};
				var v36 := DC33(v35);
				var v37 := new C0(p2 == p0, v36.cf61, f12[safeIndex(f13, |f12|) := f16]);
				...
				v38, r1, globalState.f5, v37.f25, v41 := v38, true, f16, true ==> true, v41.(cf13 := v42[safeIndex(f13, |v42|)]);
				v13[safeIndex(745, v13.Length)] := v37.f25;
				var v43 := DC0(p0);
				v5 := v5[fm2(p2, v43, p0, v37.f25, globalState) + -p2 := p0];
			} else {
				v5 := v5[f16 := p0];
				v13[safeIndex(745, v13.Length)] := f14;
				r1 := v13[safeIndex(745, v13.Length)];
				var v44: map<int, bool> := map[p1 := p3];
				var v46: map<bool, bool> := map[f14 := p3];
				var v47: multiset<map<int, bool>> := multiset{v44, (map v45 : int | v45 in f12 :: (v45 * |{v13[safeIndex(745, v13.Length)], v13[safeIndex(745, v13.Length)]}|) := (true))[f13 := v13[safeIndex(745, v13.Length)]], map[p1 := f14], fm46(if (f14 in v46) then v46[f14] else f14, f14, p0, globalState)};
				var v48 := new C0(f14, v47 + v47, [f16, fm4(v4, globalState), f16, p2]);
				var v49: seq<int> := [p2];
				var v50: map<bool, int> := map[if (v48.f25) then v13[safeIndex(745, v13.Length)] else p3 := p0];
				globalState.f9, globalState.f5, v49, r1, v9 := v13, if (true in v50) then v50[true] else safeModuloInt(|v9|, f16), v49, true, v9 + (v9 + v9);
			}
			
			var v51: multiset<bool> := multiset{v13[safeIndex(745, v13.Length)], p3};
			var v52: map<int, bool> := map[368 := p3];
			var v53: seq<bool> := [if (f13 in v52) then v52[f13] else v13[safeIndex(745, v13.Length)]];
			var v54: seq<bool> := [if (p3) then p3 else f14, v13[safeIndex(745, v13.Length)], v51 > v51, v53[safeIndex(481, |v53|)]];
			if (v53[safeIndex(f12[safeIndex(p2, |f12|)], |v53|)]) {
				globalState.f5 := safeModuloInt(safeDivisionInt(|v9|, p0), p1 * |v9|);
				var v55: array<D6> := new D6[29];
				var v56: set<array<D6>> := {v55, v55};
				v13[safeIndex(745, v13.Length)] := v56 == (v56 * v56);
				var v57 := DC1(p3);
				var v58 := DC5(v57);
				v58 := v58;
				v53 := v53;
				...
				globalState.f0 := v3;
				v31 := v31;
				v31[safeIndex(52, v31.Length)] := p1;
				var v59: array<map<int, D1>> := new map<int, D1>[7](i6 => map[f13 := DC1(f14)]);
				v13[safeIndex(745, v13.Length)], v31[safeIndex(52, v31.Length)], v59, v13[safeIndex(745, v13.Length)] := fm0(|f12|, "npsub" <= "fjkmpnsb", f14 ==> p3, globalState), f16, v59, p1 in ((seq(abs(0x8a), i7  => (f16))) + (seq(abs(-0x235), i8  => (p0))))[safeIndex(p1, |((seq(abs(0x8a), i7  => (f16))) + (seq(abs(-0x235), i8  => (p0))))|) := f16];
				globalState.f9, v3, globalState.f5, v31[safeIndex(52, v31.Length)] := v13, v3, p1, p0;
				var v60: multiset<int> := multiset{p2, f13, p1};
				v13[safeIndex(745, v13.Length)] := -p1 in v60;
			}
			
			globalState.f5 := fm4(v4, globalState);
		} else {
			v13[safeIndex(745, v13.Length)] := v3 !in "if";
			globalState.f9 := if (if (!p3) then p3 else v13[safeIndex(745, v13.Length)]) then v13 else v13;
			var v61: map<bool, bool> := map[f14 := !(f13 > |v5|)];
			var v62: seq<bool> := [p3, p3, !f14];
			var v63: map<bool, int> := map[v62[safeIndex(-0xc9, |v62|)] := 725];
			v61 := v61[false := v62[safeIndex(if (v13[safeIndex(745, v13.Length)] in v63) then v63[v13[safeIndex(745, v13.Length)]] else |map[f14 := fm0(f13, true, f14, globalState)]|, |v62|)]];
			globalState.f5 := p1;
			v13[safeIndex(745, v13.Length)] := p3;
		}
		...
		var v64 := DC0(f13);
		r0 := match v64 {
			case DC0(cf0) => multiset{!p3, v13[safeIndex(745, v13.Length)]} - multiset{true}
		};
		r1 := f14;
	}
}
...
class C2 extends T3, T1, T2 {
	...
	function fm9(p0: bool, globalState: GlobalState): bool {
		(|f12[safeIndex(-f16, |f12|) := f13]| - --f16) <= |map[f14 := DC18(multiset{false}).cf31]|
	}
	...
	method m3(p0: bool, p1: map<array<int>, seq<bool>>, p2: bool, p3: T2, globalState: GlobalState) returns (r0: int, r1: int, r2: set<int>, r3: char) {
		for i0 := f13 - f13 to p3.f13 {
			...
			v1 := v1[f16 := v3.cf44];
			var v4: seq<bool> := [p2];
			var v5: multiset<seq<bool>> := multiset{v4, v4[safeIndex(p3.f13, |v4|) := p3.f14]};
			...
			if (fm9(p3.f14 <==> v0, globalState)) {
				...
				v7[safeIndex(270, v7.Length)] := v8;
				v7[safeIndex(270, v7.Length)] := v8;
				var v9: map<int, int> := map[f16 := f13];
				var v10 := DC31(p3.f13, v2, p2, p2, i0);
				var v11: multiset<int> := multiset{f13, p3.f13};
				var v12: array<int> := new int[12] [p3.f13, p3.f13, -safeDivisionInt(f16, i0), safeDivisionInt(p3.f13, f13), -|({p3.f14} - {true})|, -|v9| * f13, p3.f13, -i0, v10.cf56, |multiset{p2}| + p3.f13, if (p3.f13 in v11) then v11[p3.f13] else |(multiset{!f14})[v0 := abs(f16)]|, if (p2) then p3.f13 else f16];
				...
				v12[safeIndex(800, v12.Length)] := safeModuloInt(i0, |v16|);
				v12[safeIndex(800, v12.Length)] := f13;
				v0 := p0;
				globalState.f5 := (if (p3.f14) then f16 else |p3.f12|) + -p3.f13;
			} else {
				var v17 := 'p';
				r2 := fm40((seq(abs(-72), i2  => ('d')))[safeIndex(p3.f13, |(seq(abs(-72), i2  => ('d')))|) := v17] != "wnsm", safeModuloInt(-f16, 0x2a3), f14, globalState);
				var v18 := "amhyprjop";
				v18 := v18 + v18;
				v0 := p3.f14;
		...
		var v29: array<string> := new string[29] [v27.cf19, (fm47(f13, globalState)).cf19, v26, v26, v26, "krbn", v26, seq(abs(0x221), i4  => ('y')), v26 + v26, "r", v26, v26, v26 + "njvhqfjv", v26, v26, v26 + v26, seq(abs(284), i5  => ('d')), (seq(abs(-0xf2), i6  => ('l'))) + v26, v26, v26, v26, v26, v26, DC14(p2, v26, p3.f13, p2, v25).cf19, v26, v26, v26, (if (false in v28) then v28[false] else v26) + "qep", v26];
		v29[safeIndex(286, v29.Length)] := v26;
		v29[safeIndex(286, v29.Length)] := v26 + v26;
		r0 := 0x22d;
	...
	method m4(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		var v0: array<int> := new int[14](i0 => safeDivisionInt(i0, -f16));
		var v1: map<int, array<int>> := map[p2 := v0];
		v1 := v1[p1 := v0];
		v0[safeIndex(233, v0.Length)] := safeDivisionInt(p1, f16);
		...
		v7[safeIndex(180, v7.Length)] := p3;
		v0[safeIndex(233, v0.Length)], v8, v7[safeIndex(180, v7.Length)] := p0, v8, false;
		v0[safeIndex(233, v0.Length)] := -p2;
		globalState.f5 := v0[safeIndex(233, v0.Length)] * f16;
		v0[safeIndex(233, v0.Length)] := |((seq(abs(-0x128), i1  => (0x1bb))) + (f12 + f12))|;
		forall i2 | 0 <= i2 < v0.Length {
			v0[i2] := safeModuloInt(i2, |(if (p3) then map[f14 := f14] else map[true := f14])|);
		}
		var v9: multiset<bool> := multiset{p3};
		r0 := v9;
		r1 := if (v7[safeIndex(180, v7.Length)]) then p3 else f14;
	}
	method m1(globalState: GlobalState) {
		for i0 := f13 to f16 {
			var v0 := "wpydv";
		...
		for i1 := |[f14]| + f13 to f16 {
			if ((0x14c * f16) >= safeModuloInt(i1, i1)) {
				...
				v17 := v18[safeIndex(i1, |v18|)];
				globalState.f5 := f13;
				var v19: array<int> := new int[25](i2 => safeModuloInt(i2, i1));
				v19[safeIndex(53, v19.Length)] := 0x2d7;
				var v20: array<char> := new char[7](i3 => 'j');
				var v21: seq<array<char>> := [v20, v20, v20, if (f14) then v20 else v20, v20];
				globalState.f5, v19[safeIndex(53, v19.Length)], v20 := f16, f13 + f16, v21[safeIndex(i1, |v21|)];
				var v22 := false;
				v22 := f14;
			}
			...
			if (f14) {
				...
				var v30: multiset<map<int, bool>> := multiset{map[f13 := f14], if ((seq(abs(0xde), i4  => (v25))) in v28) then v28[seq(abs(0xde), i4  => (v25))] else v29};
				...
				var v39: multiset<int> := multiset{|v38[safeIndex(f16, |v38|)]|};
				var v40: seq<int> := [|f12|, f16 - (if (f16 in v39) then v39[f16] else 0x2ab), safeModuloInt(i1, i1), f13];
				var v41: seq<string> := [v35, fm48(-0x3ba, globalState), v35];
				var v42: array<string> := new string[14] [v35, v41[safeIndex(|map[f14 := v34]|, |v41|)], v35, (seq(abs(0x4e), i5  => ('e'))) + v35, v35, "omxgy" + v35, if (v34) then seq(abs(-368), i6  => ('g')) else v35, v35, v35, v35, v35, (seq(abs(6), i7  => ('d'))) + "x", v35, v35 + v35];
				v42[safeIndex(380, v42.Length)] := "sobqxnf";
				v23[safeIndex(424, v23.Length)] := true;
				var v43: map<bool, seq<int>> := map[v34 := v40[safeIndex(-0x97, |v40|) := f13]];
				globalState.f5, v40, globalState.f5, v42[safeIndex(380, v42.Length)], v23[safeIndex(424, v23.Length)] := f16, (if (v34 in v43) then v43[v34] else f12) + f12, f13, v35 + v35, f14;
		...
		v51 := v52[safeIndex(f13 - f13, |v52|)];
		var i8 := 0;
		while ((seq(abs(-166), i9  => ('x'))) < (if (f14) then v49 else "kbqip"))
			decreases 100 - i8
		{
			if (i8 >= 100) {
				break;
			...
			var v58: array<seq<bool>> := new seq<bool>[27] [(v47 + v47)[safeIndex(0x18f, |(v47 + v47)|) := false], v47, v47, if (f14) then [f14] else v47, v47, v47, v47, v47, v47, v47, v56[safeIndex(|v57|, |v56|)], [f14], [f14], fm50(f14, false, globalState), fm50(f14, f14, globalState), v47, ([f14])[safeIndex(f16, |[f14]|) := true] + v47, v47, v47[safeIndex(|v49|, |v47|) := f14], v47, v47, v47, v47, v47, v47, v47, v47 + v47];
			v58[safeIndex(369, v58.Length)] := [f14] + v47;
			var v59: array<array<int>> := new array<int>[19];
			v59[safeIndex(582, v59.Length)] := v48;
			v55, v58[safeIndex(369, v58.Length)], v59[safeIndex(582, v59.Length)] := v55, v47 + v47, v48;
			globalState.f5 := f16;
			...
			match (v61) {
				case DC14(cf18, cf19, cf20, cf21, cf22) =>
					var v62: set<int> := {safeDivisionInt(cf20, f16)};
					...
					cf18, cf19, globalState.f9 := !fm0(DC15(cf20, cf18, cf21).cf23, cf22, v47[safeIndex(if ([!f14, cf22] in v67) then v67[[!f14, cf22]] else fm4(v62, globalState), |v47|)], globalState), cf19, v68;
					var v69 := DC14(cf18, v49, f13, !cf22, cf22);
					v49 := v69.cf19;
					var v70: set<bool> := {true};
					globalState.f5 := |v70|;
				case DC15(cf23, cf24, cf25) =>
					v54, globalState.f5 := v54, safeDivisionInt(-f16, f13);
					v59[safeIndex(582, v59.Length)][safeIndex(11, v59[safeIndex(582, v59.Length)].Length)] := 0x28e;
					globalState.f5, v59[safeIndex(582, v59.Length)][safeIndex(11, v59[safeIndex(582, v59.Length)].Length)], v48 := cf23, -0x313, v48;
					var v72: set<bool> := {cf24, cf25};
					var v73 := DC7();
					var v74: seq<D2> := [v73];
					var v75: map<set<bool>, seq<D2>> := map[v72 := v74];
					var v76: seq<seq<D2>> := [if ({cf24} in v75) then v75[{cf24}] else v74, seq(abs(0x221), i11  => (v73))];
					var v77 := DC9(map v71 : seq<D2> | v71 in multiset(v76) :: (v71) := ('x'));
					var v78: map<D3, int> := map[v77 := f16];
					var v79 := new C1(v59[safeIndex(582, v59.Length)][safeIndex(11, v59[safeIndex(582, v59.Length)].Length)], f14, f12, |v78|);
					cf25 := if (true) then cf25 else f14;
				case DC16(cf26, cf27, cf28, cf29) =>
					v59[safeIndex(582, v59.Length)][safeIndex(856, v59[safeIndex(582, v59.Length)].Length)] := cf29;
					v59[safeIndex(582, v59.Length)][safeIndex(856, v59[safeIndex(582, v59.Length)].Length)] := cf29 - cf29;
					v49 := v49 + v49;
					var v80 := false;
					v80 := (v49 + v49) != v49;
					cf29 := 0x91;
				case DC13(cf17) =>
					...
					v81[safeIndex(104, v81.Length)] := f14;
					v81[safeIndex(104, v81.Length)] := f14;
					var v82: seq<string> := [v49];
					var v83: set<int> := {f16, safeDivisionInt(f16, |v82|)};
					var v84: seq<set<int>> := [v83, v83, v83];
					v83 := v83 * v84[safeIndex(-f16, |v84|)];
					var v85 := 'c';
					globalState.f0 := v85;
					var v86: map<int, bool> := map[f13 := v81[safeIndex(104, v81.Length)]];
					var v87: multiset<map<int, bool>> := multiset{map[f13 := f14], v86, v86};
					var v88 := new C0(v81[safeIndex(104, v81.Length)], v87 + v87, (seq(abs(-0x18d), i12  => (|v49|))) + f12);
				case DC17(cf30) =>
					...
					var v93 := 'l';
					v92[safeIndex(31, v92.Length)] := if (v91.f25) then v93 else v93;
					v92[safeIndex(31, v92.Length)] := v93;
			...
			v59[safeIndex(582, v59.Length)][safeIndex(421, v59[safeIndex(582, v59.Length)].Length)] := |fm51(f13, f16, f14, f14, globalState)| - |f12|;
			var v99 := 'c';
			var v100 := DC32(v99, f14, f13, |v49|);
			v59[safeIndex(582, v59.Length)][safeIndex(421, v59[safeIndex(582, v59.Length)].Length)] := fm2(f13, DC0(v100.cf60).(cf0 := -f16), f13, v49 < v49, globalState);
		}
	}
	method m2(p0: bool, p1: int, p2: D0, p3: bool, globalState: GlobalState) returns (r0: int) {
		var v0 := "r";
		...
		if (f14) {
			if (fm7(globalState) <==> ((seq(abs(0x149), i1  => ('d'))) < v0)) {
				v3 := v3;
				...
				v0 := if (!p3) then "evocqido" else v0 + (seq(abs(-246), i2  => ('j')));
				...
				var v20: array<array<bool>> := new array<bool>[27] [v18, v18, v18, v18, v19[safeIndex(-f16, |v19|)], v18, v18, v18, v18, v18, v18, v18, v19[safeIndex(|v0|, |v19|)], v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18, v18];
				...
				var v26: seq<map<int, bool>> := [map v22 : int | v22 in v23 :: (safeDivisionInt(v22, f16)) := (v1), v25, v25];
			...
			v28[safeIndex(565, v28.Length)] := p1 == f16;
			v28[safeIndex(565, v28.Length)] := (f16 - p1) == f13;
			globalState.f5 := f16;
			var v29: multiset<seq<int>> := multiset{seq(abs(0xa7), i4  => (p1))};
			r0, r0, v29, globalState.f5 := p1, p1, (multiset([seq(abs(391), i5  => (|map[v1 := p1]|)), seq(abs(613), i6  => (f16))]) + multiset{f12}) + v29, f16;
			var v30: map<int, bool> := map[|v0| := v1];
			var v31: multiset<map<int, bool>> := multiset{v30};
			var v32 := new C0(v1 <==> p3, v31, f12);
		} else {
			globalState.f5 := safeDivisionInt(f13, p1) - 100;
			var v33 := new C1(p1, f14, [|map[f13 := 198]|], -safeDivisionInt(f13, p1));
			var v34: set<bool> := {p0};
			...
			var v43 := DC22(v40, v36[safeIndex(|v41|, |v36|)], |v36|, p1, |[v42]|);
			...
			v44[safeIndex(184, v44.Length)] := p3;
			v44[safeIndex(184, v44.Length)] := !fm7(globalState);
			v44[safeIndex(184, v44.Length)] := p3 ==> p3;
		}
		
		r0 := safeModuloInt(f13, |fm48(|f12|, globalState)|);
		...
		var v52: map<int, string> := map[|v0| := (v0 + v0)[safeIndex(|v0|, |(v0 + v0)|) := 'i']];
		v52 := v52[f12[safeIndex(f13, |f12|)] := v0];
		var v53 := DC11(v1);
		var v54 := DC12(v53);
	...
	method m18(globalState: GlobalState) returns (r0: bool, r1: seq<bool>, r2: seq<D7>) {
		var v0 := DC0(f16);
		r0, globalState.f5, globalState.f5 := f14, safeModuloInt(safeModuloInt(f16, f16), f13), fm2(|"gh"|, v0, f13, f14, globalState);
		var v1 := DC1(false);
		...
		var v9: set<int> := {f16};
		v8 := v8[v7[f14 := v6] := (v3 + v3)[safeIndex(|v9|, |(v3 + v3)|) := true]];
		...
		var v13: array<array<bool>> := new array<bool>[21] [v11, v11, v11, v11, v11, v11, v12[safeIndex(f13, |v12|)], v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11, v11];
		v13[safeIndex(1, v13.Length)] := v11;
		var v14: seq<seq<int>> := [seq(abs(0x277), i1  => (f13))];
		var v15 := "whdka";
		r0, v13[safeIndex(1, v13.Length)], v10 := fm0(fm8(fm52(fm9(f14, globalState), f14, f14, globalState), [f14], multiset(v14), v15, globalState), f14, f14, globalState), v11, v10;
		r0 := f14;
	...
	method m19(p0: int, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: bool, r2: set<int>, r3: multiset<bool>) {
		if (p2) {
			...
			r0 := safeModuloInt(p0, p3 + |(v11[safeIndex(p3, |v11|)])[p1 := p2]|);
		}
		
		var v12: array<bool> := new bool[19];
		forall i0 | 0 <= i0 < v12.Length {
			v12[i0] := map[|map[|"spu"| := seq(abs(0x3e3), i1  => (p3))]| := f16] == (if (DC25(p2).cf46) then DC39(map[|[p2]| := |"elomxnsh"|]).cf75 else map[0x3d4 := f13]);
		}
		var v13 := 'a';
		...
		r0 := -(p1 - |v15|);
		r1 := f14 || f14;
		var v16: set<int> := {safeDivisionInt(p0, p0), safeDivisionInt(f16, f13)};
		r2 := v16;
...
class C3 extends T1, T0 {
	...
	function fm36(globalState: GlobalState): D3 {
		DC9(if (f14) then map[[DC7(), DC7(), DC7()] := 'o'] else map[seq(abs(0x300), i0  => (DC7())) := 'n'])
	}
	method m17(globalState: GlobalState) {
		...
		var v3 := DC27(v2[safeIndex(f13, |v2|)]);
		var v4 := DC29(DC29(v3));
		var v5 := DC29(v3);
		...
		var v10 := DC30(v9);
		v7[safeIndex(235, v7.Length)] := (v10.(cf51 := v9)).cf51;
		v7[safeIndex(235, v7.Length)] := [v8];
		var v11: map<bool, bool> := map[f24 := true];
		v11 := v11[f24 := f24];
		globalState.f5 := fm6(globalState);
		globalState.f5 := safeDivisionInt(fm4({f13}, globalState), |v0|);
		var v12: seq<seq<int>> := [f12];
		var v13 := 'd';
		var v14 := DC6(map[f14 := v13]);
		var v15 := new C1(f13, f24 <==> f14, v12[safeIndex(fm35(v14, f13, globalState), |v12|)], fm6(globalState) * 496);
	}
}
...
class C4 extends T1 {
	...
	method m16(p0: seq<bool>, globalState: GlobalState) {
		...
		if (fm7(globalState)) {
			globalState.f5 := -(f13 + safeModuloInt(f13, f13));
			var v1: multiset<map<int, bool>> := multiset{map[f13 := f14]};
			var v2 := new C0(!f14, v1[map[f13 := f14] := abs(f13)], [|[f14, f14, f14, f14]|]);
			...
			var v12 := "lm";
			v11[safeIndex(826, v11.Length)] := v12;
			...
			v14[safeIndex(808, v14.Length)] := v13;
			...
			v7, v10, v11[safeIndex(826, v11.Length)], v14[safeIndex(808, v14.Length)], v7 := !(f14 <==> v7), v18[safeIndex(f13, |v18|)], v19[safeIndex(fm2(f13, v20.(cf0 := f13), |v21|, v7, globalState), |v19|)], if (fm0(|(seq(abs(0x2a2), i1  => ('w')))|, v7, false, globalState)) then DC31(|v12|, v13, false, v7, |f12|).cf53 else v13, fm1(|v12|, globalState) in "irasevdgx";
			var v22 := 'o';
			globalState.f0 := v22;
			...
			if (f14) {
				v0 := DC21(v0).cf36;
				v13[safeIndex(812, v13.Length)] := v7;
				v13[safeIndex(812, v13.Length)] := true;
				var v24: map<int, bool> := map[|v11[safeIndex(826, v11.Length)]| := false];
				...
				var v28: map<array<bool>, bool> := map[v14[safeIndex(808, v14.Length)] := v7];
				v28 := map[v14[safeIndex(808, v14.Length)] := v13[safeIndex(812, v13.Length)]] + v28[v14[safeIndex(808, v14.Length)] := f14];
				var v29: map<string, string> := map[v11[safeIndex(826, v11.Length)] := v12];
				v13[safeIndex(812, v13.Length)] := v12 in v29;
			} else {
				globalState.f5 := |v21|;
				globalState.f5 := -safeDivisionInt(|v12|, f13);
				v12 := v12;
				var v30: map<bool, int> := map[v7 := f13];
				v0[safeIndex(463, v0.Length)] := safeDivisionInt(if (v7 in v30) then v30[v7] else f13, |{f13}|);
				v0[safeIndex(463, v0.Length)] := |(f12 + (f12 + f12))|;
				v7 := true;
			}
			
			if (v7) {
				var v31: map<char, bool> := map[v22 := v7];
				v0[safeIndex(403, v0.Length)] := |(v31 + v31[v22 := v7])|;
				v0[safeIndex(403, v0.Length)] := -safeModuloInt(|v21|, f13);
				m0(f14, globalState);
				...
				v35[safeIndex(345, v35.Length)] := v22;
				var v36: multiset<array<bool>> := multiset{v14[safeIndex(808, v14.Length)]};
				var v37: array<multiset<array<bool>>> := new multiset<array<bool>>[22] [v36, v36, v36, v36[v13 := abs(f13)] - v36, v36, if (f14) then v36 else v36, v36 * v36, v36, v36, v36, v36, if (p0[safeIndex(f13, |p0|)]) then v36 else v36, v36 + v36, v36, v36 + v36, v36 * v36, v36, v36, v36 - v36, v36, v36[v14[safeIndex(808, v14.Length)] := abs(f13)], v36];
				v37[safeIndex(862, v37.Length)] := v36 * multiset{v14[safeIndex(808, v14.Length)], v13, v13, v13, v14[safeIndex(808, v14.Length)]};
				v0[safeIndex(382, v0.Length)] := f13;
				var v38 := DC28(v22);
				var v39: map<bool, int> := map[fm34(v7, globalState) := f13];
				v35[safeIndex(345, v35.Length)], v37[safeIndex(862, v37.Length)], globalState.f5, v0[safeIndex(382, v0.Length)] := v38.cf49, v36, (|v39| + f13) * f13, f13;
				var v41: array<set<int>> := new set<int>[15](i2 => {f13} * (set v40 : int | (0x31c <= v40) && (v40 < 0x30b) :: (safeModuloInt(v40, v0[safeIndex(382, v0.Length)]))));
				var v42: set<int> := {|v12|, v0[safeIndex(382, v0.Length)], f13, f13};
				v41[safeIndex(32, v41.Length)] := v42;
				v14[safeIndex(808, v14.Length)][safeIndex(773, v14[safeIndex(808, v14.Length)].Length)] := v12[safeIndex(v0[safeIndex(382, v0.Length)], |v12|) := 't'] <= v11[safeIndex(826, v11.Length)];
				var v44 := DC4(fm56(v35[safeIndex(345, v35.Length)], v7, f14, globalState) <= f12, -(|(map v43 : seq<bool> | v43 in fm57(v7, globalState) :: (v43) := (v0[safeIndex(382, v0.Length)]))| * v0[safeIndex(382, v0.Length)]), f14);
				v41[safeIndex(32, v41.Length)], globalState.f5, v14[safeIndex(808, v14.Length)][safeIndex(773, v14[safeIndex(808, v14.Length)].Length)], globalState.f5, v44 := set v45 : int | (14 <= v45) && (v45 < 0x224) :: (v45 - f13), |multiset{|v15|}|, v12 < v19[safeIndex(f13, |v19|)], safeDivisionInt(285, v0[safeIndex(382, v0.Length)]), v44;
				v7 := f14;
			}
		...
		var v50: array<D5> := new D5[26] [DC15(|multiset{f14, f14}|, f14, f14), v46, fm58(f14, globalState), v46, v46, DC15(|(seq(abs(0x24f), i3  => (f13)))|, !!false, fm0(|multiset(v48)|, f14, f14, globalState)), DC15(f13, fm0(|v49|, f14, f14, globalState), !f14), v46, v46, v46, v46, v46, v46, v46, v46, if (fm0(f13, f14, false, globalState)) then DC15(f13, false, f14) else v46, DC15(f13, f14, fm0(f13, f14, f14, globalState)), v46, DC15(f13, f14, f14), v46, v46, v46, v46, v46, v46, v46.(cf25 := f14, cf24 := f14)];
		v50 := v50;
		var v51: array<bool> := new bool[20];
		var v52: seq<map<int, bool>> := [map[|multiset{v51}| := true]];
		var v53: map<int, bool> := map[f13 := f14];
		var v54: multiset<map<int, bool>> := multiset{v52[safeIndex(883, |v52|)], v53};
			...
			decreases 100 - i5
		{
			...
			var v65: T1 := new C1(f13, f14, seq(abs(-0x35a), i6  => (f13)), |f12|);
			...
			var v69: C2 := new C2(if (f14) then f13 else f13, |DC42(v64[safeIndex(f13, |v64|)]).cf80|, f14, f12 + [-f13, 0x12d], v68);
			v69 := new C2(if (v65.f14) then f13 else f13, safeDivisionInt(v65.f13, |v66|), true, [v65.f13] + f12, v68);
		}
	}
}
...
class C5 extends T0 {
	...
	method m15(p0: char, p1: bool, p2: bool, globalState: GlobalState) returns (r0: char) {
			...
			decreases 100 - i0
		{
			...
			match (v10) {
				case DC14(cf18, cf19, cf20, cf21, cf22) =>
					...
					v11, globalState.f5 := multiset(DC16(|v12[safeIndex(v0, |v12|)]|, cf20, v3, |(multiset(v3))[cf22 := abs(v0)]|).cf28 + v3), (fm60(globalState)).cf8;
					var v13: set<bool> := {cf22, cf18, p2};
					var v14: T0 := new C3(cf22, |v13|, false, seq(abs(0xa3), i1  => (cf20)));
				...
				case DC15(cf23, cf24, cf25) =>
					...
					globalState.f5, globalState.f5 := -f12[safeIndex(safeModuloInt(|v15|, cf23), |f12|)], safeModuloInt(cf23, v0) * v0;
					...
					var v27: array<set<int>> := new set<int>[27] [{v0, cf23} + v8, set v19 : int | v19 in v15 :: (safeDivisionInt(v19, 0x21d)), fm40(p2, cf23, cf25, globalState), v8, v8, {cf23, |v21|, |"tsadsj"|}, v8 - v8, if (p1) then v8 else v8, fm40(true, v0, true, globalState), v8, v8, v8, v8 + v8, v8, set v22 : int | (0x9e <= v22) && (v22 < 580) :: (safeModuloInt(v22, v0)), v8, {cf23, v0} * v8, set v23 : int | (-0xc6 <= v23) && (v23 < 0x342) :: (safeModuloInt(v23, cf23)), v8, v8 + v8, v8, v8 * v8, v8, v26.cf65 - v8, v8, {cf23, 378} + v8, {cf23, -v0}];
					v27 := v27;
				case DC16(cf26, cf27, cf28, cf29) =>
					var v28 := false;
					v28 := p2;
					...
					v30 := map v31 : char | v31 in (v32 - (if (cf27 in v34) then v34[cf27] else v32)[p0 := abs(|v35|)]) :: (v31) := (v28);
					globalState.f0 := p0;
				case DC13(cf17) =>
					...
					v39 := v39[v1 := p2 <== p1];
					globalState.f5 := safeModuloInt(if (p2) then 0x107 else v0, v0);
				case DC17(cf30) =>
					...
					v40[safeIndex(83, v40.Length)] := f23 + [v41, v41, v41, v41];
					v40[safeIndex(83, v40.Length)] := (f23 + f23)[safeIndex(v0, |(f23 + f23)|) := v41];
					var v42: array<D7> := new D7[10];
					var v43: multiset<int> := multiset{v0};
					var v44: array<int> := new int[17] [|v43|, 0x2aa, v0, v0, |v1|, |map[!p1 := v0]|, v0, |(seq(abs(0x286), i2  => (p0)))|, v0, -0x102, v0, -v0, v0, v0, v0, v0, v0];
					var v45 := DC21(v44);
					v42[safeIndex(115, v42.Length)] := v45;
					v42[safeIndex(115, v42.Length)] := v45;
					globalState.f5 := -v0;
			...
			var v56: array<seq<int>> := new seq<int>[17] [f12, v48[safeIndex(v0, |v48|)] + (seq(abs(335), i3  => (v0))), (seq(abs(658), i4  => (v0))) + f12, f12, f12[safeIndex(v0, |f12|) := (fm58(true, globalState)).cf23], f12, [v0], f12, f12, f12, fm56(if (-v0 in v51) then v51[-v0] else p0, p2, p1, globalState), f12 + f12, f12, if (v52 in v55) then v55[v52] else f12, f12, f12, f12];
			var v57: array<bool> := new bool[8];
			v57[safeIndex(767, v57.Length)] := false;
			globalState.f5, v56, v57[safeIndex(767, v57.Length)], v49 := 125, v56, v2.fm7(globalState), (fm61(globalState)).cf86;
			var v58 := DC30(f23);
			match (v58) {
				...
				case DC32(cf57, cf58, cf59, cf60) =>
					var v65 := DC28(v1[safeIndex(f12[safeIndex(cf59, |f12|)], |v1|)]);
					var v66 := DC36(cf58, v57[safeIndex(767, v57.Length)], v65);
					var v67: array<int> := new int[15];
					v67[safeIndex(584, v67.Length)] := fm2(v0, v9, cf59, true, globalState);
					var v68: map<bool, char> := map[true := p0];
					var v69 := DC6(v68);
					v66, v67[safeIndex(584, v67.Length)], cf60, globalState.f5 := v66, |v8| - cf60, safeDivisionInt(v52.fm35(v69, cf60, globalState), -v0), cf60;
					v57[safeIndex(767, v57.Length)] := cf58;
					var v70: multiset<int> := multiset{v67[safeIndex(584, v67.Length)]};
					v0 := |(multiset{cf60, cf59} * v70)|;
					var v71: array<array<bool>> := new array<bool>[9];
					v71[safeIndex(440, v71.Length)] := v57;
					v71[safeIndex(440, v71.Length)] := v57;
				case DC30(cf51) =>
					var v72: map<int, bool> := map[v0 := false];
					var v74: seq<map<int, bool>> := [v72, v72, (map v73 : int | (0x132 <= v73) && (v73 < -0x27a) :: (safeDivisionInt(v73, v0)) := (v57[safeIndex(767, v57.Length)]))[v0 := p1]];
					v74 := v74;
					var v75: set<bool> := {v57[safeIndex(767, v57.Length)], v2.fm7(globalState)};
					var v76 := DC10(v75);
					var v77 := DC12(v76);
					v77 := v77;
					var v78: map<int, set<bool>> := map[v0 := {!v57[safeIndex(767, v57.Length)]}];
					globalState.f5 := |v78|;
					v2 := v2;
			}
		...
		var v87: set<bool> := {p2};
		var v88: seq<int> := [v0, v0, v0, |v87|, safeModuloInt(-474, |{fm0(v0, fm0(v0, false, p1, globalState), true, globalState), p2}|)];
		var v89: map<bool, char> := map[p2 := p0];
		v88 := f12 + f12[safeIndex(|v89|, |f12|) := v0];
...
class C6 extends T2 {
	...
	function fm32(p0: bool, globalState: GlobalState): bool {
		match DC19('h', map v0 : int | (0x280 <= v0) && (v0 < -5) :: (safeModuloInt(v0, f13)) := (f14), f13) {
	...
	method m1(globalState: GlobalState) {
		for i0 := f12[safeIndex(f13, |f12|)] to f21 {
			var v0 := "xmo";
			var v1: seq<string> := ["mbjhvh", v0];
			var v2: multiset<string> := multiset{v1[safeIndex(f21, |v1|)], seq(abs(0x19c), i1  => ('x'))};
			globalState.f5 := |v2["uamejp" := abs(f21)]|;
			v0 := v0 + v0;
			var v3 := false;
			...
			match (DC25(f14).(cf46 := v3)) {
				case DC24(cf43, cf44, cf45) =>
					...
					var v10 := new C5((v8.cf51[safeIndex(-f13, |v8.cf51|) := cf45])[safeIndex(|v9|, |v8.cf51[safeIndex(-f13, |v8.cf51|) := cf45]|) := v5], f12);
					var v11: seq<bool> := [false];
					cf45[safeIndex(310, cf45.Length)] := v9 <= multiset(v11);
					cf45[safeIndex(310, cf45.Length)] := f14;
					globalState.f5 := |(seq(abs(0xc3), i3  => ('e')))| * i0;
				case DC25(cf46) =>
					v0 := v0;
					...
					globalState.f5 := if (f15 in v16) then v16[f15] else |((fm50(cf46, cf46, globalState))[safeIndex(|(seq(abs(0x3b3), i4  => (v13)))|, |fm50(cf46, cf46, globalState)|) := cf46] + v17)|;
				case DC23(cf42) =>
					var v18 := DC11(v3);
					...
					var v22: map<bool, array<bool>> := map[v3 := v21[safeIndex(i0, |v21|)]];
					var v23: seq<array<bool>> := [v5, if (f14 in v22) then v22[f14] else v5];
					var v24 := DC14(map[f14 := f14] !in {v19, v19}, v0, i0, f14, v3 && v3);
					v5[safeIndex(25, v5.Length)] := f14;
					v20, v23, v24, v5[safeIndex(25, v5.Length)] := v20, v23, v24.(cf21 := true, cf18 := i0 > i0, cf19 := v0), v3;
				case DC26(cf47) =>
		...
		if (fm63(v34, f13, |v36|, f12[safeIndex(f21, |f12|)], globalState) !! ((set v39 : seq<int> | v39 in v38 :: (v39)) - v40)) {
			...
			if (([if (v34 in v41) then v41[v34] else 0x10b, f13] < fm56(v34, f14, f14, globalState)) !in [f14, f14]) {
				...
				var v46 := DC40(f21, fm0(|v45|, f14, f14, globalState), |(seq(abs(-538), i5  => (v34)))|);
				v44[safeIndex(193, v44.Length)] := v46;
				var v47: array<bool> := new bool[23];
				v47[safeIndex(516, v47.Length)] := !f14;
				v42, v44[safeIndex(193, v44.Length)], globalState.f5, v47[safeIndex(516, v47.Length)] := map[0x2b5 := f21], v46, f21 - f13, fm32(f14, globalState);
				var v48: map<bool, bool> := map[v47[safeIndex(516, v47.Length)] := v47[safeIndex(516, v47.Length)]];
				var v49: map<bool, string> := map[if (v47[safeIndex(516, v47.Length)] in v48) then v48[v47[safeIndex(516, v47.Length)]] else f14 := v35];
				v49 := v49[true := v35 + v35];
				var v50: array<int> := new int[1] [0x261];
				v50, v47[safeIndex(516, v47.Length)] := v50, true;
				var v51: map<int, bool> := map[f21 := false];
				var v52 := DC19(v34, v51, f13);
				var v54: multiset<map<int, bool>> := multiset{v52.cf33, v51, fm46(v47[safeIndex(516, v47.Length)], f14, f13, globalState), map v53 : int | (628 <= v53) && (v53 < 535) :: (safeDivisionInt(v53, |v35|)) := (f14)};
				var v55 := new C0(f14, v54, [0xfd, 0x387, 640, f21, |f12|] + f12);
				var v56: multiset<bool> := multiset{f14, v47[safeIndex(516, v47.Length)]};
				v47[safeIndex(516, v47.Length)] := (v56 - v56) > v56;
			} else {
				var v57: C3 := new C3(f14, f13, f14, seq(abs(868), i6  => (f21)));
				var v58: seq<C3> := [v57];
				var v59: seq<bool> := [v57.f24];
				var v60: set<int> := {|v59|, |v59|};
				var v61: C2 := new C2(|(v58 + v58[safeIndex(|v35|, |v58|) := v57])|, fm4(v60, globalState), f14, f12, f15);
				v61 := v61;
				...
				v62[safeIndex(436, v62.Length)] := v65;
				...
				v62[safeIndex(436, v62.Length)] := fm64(v69, v57.f24, globalState);
				v57.f24 := !f14;
				v35 := "qafivbw";
			}
			...
			v74[safeIndex(457, v74.Length)] := |v75|;
			v74[safeIndex(457, v74.Length)] := f21;
			v70, globalState.f5, globalState.f0, v74[safeIndex(457, v74.Length)] := v70, f21, v34, -(f21 * --v74[safeIndex(457, v74.Length)]);
			v70 := "ogfducpga" <= (v35 + v35);
		} else {
			var v76: array<D12> := new D12[10];
			v76[safeIndex(44, v76.Length)] := DC37(f14, f14, v36, f21, f12);
			var v77 := DC37(f12 <= f12, !f14, v36, f13, f12 + f12);
			v76[safeIndex(44, v76.Length)] := v77;
			var v78 := new C3(f14, -0x3e7, f14, seq(abs(-0x212), i8  => (0x12)));
			var v79: seq<bool> := [true, f14, !fm0(f13, v78.f24, v78.fm7(globalState), globalState), v78.f24, if (f14) then v78.f24 else v78.f24];
			v78.f24 := v79[safeIndex(|(v35 + v35)|, |v79|)];
			...
			var v86: array<bool> := new bool[2] [true, if (|(set v84 : int | v84 in multiset{|v35|} :: (safeDivisionInt(v84, |map[-|[|{seq(abs(0x319), i9  => ('p'))}|, |(set v85 : int | (0x87 <= v85) && (v85 < -810) :: (safeModuloInt(v85, 383)))|]| := false]|)))| in v83) then v83[|(set v84 : int | v84 in multiset{|v35|} :: (safeDivisionInt(v84, |map[-|[|{seq(abs(0x319), i9  => ('p'))}|, |(set v85 : int | (0x87 <= v85) && (v85 < -810) :: (safeModuloInt(v85, 383)))|]| := false]|)))|] else v78.f24];
			var v87 := DC31(f13 - f13, v86, v78.f24, v78.f24, f21);
			match (v87) {
				case DC31(cf52, cf53, cf54, cf55, cf56) =>
					var v88: array<array<int>> := new array<int>[8];
					var v89: array<int> := new int[29];
					v88[safeIndex(82, v88.Length)] := v89;
					v88[safeIndex(82, v88.Length)] := new int[24](i10 => i10 - f21);
					globalState.f0 := v34;
					var v90: multiset<bool> := multiset{cf55};
					v81 := v81[safeDivisionInt(f13, if (cf54 in v90) then v90[cf54] else f21) := cf56];
					cf52 := cf52 * (f13 * |v38|);
				case DC32(cf57, cf58, cf59, cf60) =>
					...
					v92[safeIndex(961, v92.Length)] := v93;
					v92[safeIndex(961, v92.Length)] := multiset{v78.f24, cf57 in v35, f14};
					var v94: set<bool> := {f14};
					cf60 := fm5(if (-f21 in v83) then v83[-f21] else v78.f24, seq(abs(0x2eb), i11  => (cf57)), DC49(f22[f21 := abs(|v94|)]).cf92, globalState);
					v78.f24 := f14;
				case DC30(cf51) =>
					globalState.f5 := f13;
					var v95: seq<string> := [(seq(abs(0x30a), i12  => (v34)))[safeIndex(f21, |(seq(abs(0x30a), i12  => (v34)))|) := v34]];
					...
					var v103: map<string, array<D2>> := map[v35 + v95[safeIndex(f12[safeIndex(0x1e6, |f12|)], |v95|)] := v102];
					v103 := v103[v35 := v102];
					var v104 := DC7();
					...
					v86[safeIndex(824, v86.Length)] := v78.f24;
					var v109: set<bool> := {false};
					v108, v86[safeIndex(824, v86.Length)], globalState.f5, globalState.f5 := v107, v78.f24, if (v78.f24) then 894 else f21 + |(seq(abs(550), i13  => (v34)))|, -|(v109 * {v78.f24})|;
					...
					var v113 := DC18(v110);
					var v114: array<multiset<bool>> := new multiset<bool>[22] [v110 + multiset{v86[safeIndex(824, v86.Length)]}, multiset(v79), v110 - v110[v78.f24 := abs(f13)], multiset{v78.f24, v78.f24, v78.f24, f14}, v110, multiset(v79), v110, v110, v110, v110, v110 + multiset{false, v78.f24}, v110, v110, v110, multiset(v79 + v79[safeIndex(f13, |v79|) := f14]), if (v35 in v111) then v111[v35] else (v110[f14 := abs(|{f13}|)])[f14 := abs(if (v78.f24 in v110) then v110[v78.f24] else |f12|)], v110[v78.f24 := abs(|v112|)] + multiset(v79), v110 - v110, v110 * v110, multiset{v78.f24, v78.f24}, v110, v113.cf31];
					v114[safeIndex(303, v114.Length)] := v110;
					v114[safeIndex(303, v114.Length)] := v110;
			}
		...
		var v117 := new C0('g' !in v35, v116 - v116, seq(abs(-0x296), i14  => (f21)));
		...
		for i15 := f13 + |v118| to f21 {
			...
			if (v117.f25) {
				var v122 := DC37(f14, v117.f25, v36, v121, f12[safeIndex(f13, |f12|) := i15]);
				...
				v123 := new seq<int>[27] [f12, if (true in v124) then v124[true] else f12, f12 + f12, (fm56(v34, v117.f25, v117.f25, globalState))[safeIndex(v121, |fm56(v34, v117.f25, v117.f25, globalState)|) := f21] + (seq(abs(-361), i16  => (i15))), [v120], f12, if (v117.f25) then f12 else f12, fm56(v34, v117.f25, true, globalState), seq(abs(0x1f3), i17  => (v121)), f12, f12, [f21, f21, v120] + f12, f12, f12, f12, f12, f12, seq(abs(434), i18  => (v120)), seq(abs(746), i19  => (|v115|)), f12, f12, seq(abs(0xf5), i20  => (f21)), f12 + f12, f12, [i15, i15], f12, f12 + f12];
				...
				v125[safeIndex(164, v125.Length)] := v126;
				var v127: set<bool> := {f14};
				v125[safeIndex(164, v125.Length)] := if (|v127| <= v120) then v126 else v126;
				v117.f25 := 994 !in (f12 + f12);
				var v128: seq<array<bool>> := [v125[safeIndex(164, v125.Length)], v126, v125[safeIndex(164, v125.Length)], v126];
				var v129 := new C5(v128 + v128, f12);
				var v130: array<int> := new int[24](i21 => i21 * |v115|);
				v130[safeIndex(337, v130.Length)] := f13;
				v130[safeIndex(337, v130.Length)] := v117.fm45(globalState);
			} else {
				var v131: array<bool> := new bool[19];
				var v132 := DC24(f21, v117.f25, v131);
				var v133 := DC31(v121, v131, f14, v117.f25, v120);
				var v134: array<bool> := new bool[11] [v132.cf44, !false, f14, v117.f25, v117.f25, v117.f25, v133.cf52 != f12[safeIndex(v121, |f12|)], v117.f25, (seq(abs(0xb4), i22  => ('f'))) == v35, v117.f25, f14];
				v134[safeIndex(179, v134.Length)] := v117.f25;
				v134[safeIndex(179, v134.Length)] := v117.f25;
				var v135: seq<bool> := [v117.f25];
				v117.f25 := v135 < v135;
				var v136: array<int> := new int[7](i23 => i23 - f13);
				v136[safeIndex(467, v136.Length)] := f21;
				globalState.f5, v136[safeIndex(467, v136.Length)] := v120, safeDivisionInt(-i15, v120);
				var v137: seq<array<bool>> := [v134];
				var v138 := new C5(v137, fm56(v34, v117.f25, v117.f25, globalState) + f12[safeIndex(|v35|, |f12|) := f21]);
				var v139: array<string> := new string[21](i24 => v35);
				v139[safeIndex(538, v139.Length)] := fm48(v121, globalState);
				var v140: map<bool, int> := map[false := f21];
				var v141: seq<map<bool, int>> := [v140];
				var v142: map<int, int> := map[|v141| := v136[safeIndex(467, v136.Length)]];
				v139[safeIndex(538, v139.Length)], v120, v142 := v35, v120, v142;
			}
			...
			match (DC42(v145)) {
				case DC43(cf81, cf82, cf83, cf84, cf85) =>
					...
					v150[safeIndex(15, v150.Length)] := safeDivisionInt(cf83, |v149|);
					v150[safeIndex(15, v150.Length)] := i15;
				case DC42(cf80) =>
					globalState.f5 := fm5(v117.f25 ==> f14, v35[safeIndex(v117.fm4(v143, globalState), |v35|) := v34], f22 + f22, globalState);
					v117.f25 := v117.f25;
					v117.f25 := true;
					var v151 := DC7();
		...
		globalState.f5 := safeDivisionInt(safeDivisionInt(|(if (-|fm48(|v35|, globalState)| in v157) then v157[-|fm48(|v35|, globalState)|] else set v158 : int | (-562 <= v158) && (v158 < 0x1db) :: (v158 + f13))|, |(if (|v161| in v159) then v159[|v161|] else seq(abs(0x108), i25  => (v34)))[safeIndex(f21, |(if (|v161| in v159) then v159[|v161|] else seq(abs(0x108), i25  => (v34)))|) := v34]|), if (|v156| in f22) then f22[|v156|] else |v162|);
		var v163: array<int> := new int[1];
		v163[safeIndex(814, v163.Length)] := if (v117.f25) then f21 else f13;
		v163[safeIndex(814, v163.Length)] := -f21;
	}
	method m2(p0: bool, p1: int, p2: D0, p3: bool, globalState: GlobalState) returns (r0: int) {
		var v0 := true;
		var v1: multiset<int> := multiset{-p1, f21, f21};
		var v2: seq<multiset<int>> := [f22];
		v0, v0, v1 := v0, p3 <==> v0, v2[safeIndex(|("kpkvrt" + "s")|, |v2|)];
		var v3: array<int> := new int[1];
		v3[safeIndex(138, v3.Length)] := f21;
		v3[safeIndex(138, v3.Length)] := p1;
		var v4: set<int> := {p1};
		for i0 := safeDivisionInt(|v4|, 0x3af) to p1 + f13 {
			v0, globalState.f5, globalState.f5, v0 := p3, f21, safeDivisionInt(v3[safeIndex(138, v3.Length)], f21), v0;
			v0 := fm7(globalState);
			v3[safeIndex(138, v3.Length)] := if (f14) then f21 else p1;
			var v5: array<seq<bool>> := new seq<bool>[22](i1 => if (v0) then [true] else [p3]);
			var v6: seq<bool> := [v0, p0];
			v5[safeIndex(520, v5.Length)] := v6;
			var v7 := 'd';
			var v8 := "kyps";
			var v9: map<int, array<int>> := map[f13 := v3];
			v3[safeIndex(138, v3.Length)], v0, v5[safeIndex(520, v5.Length)], v0, v0 := v3[safeIndex(138, v3.Length)], (f12 + f12) < fm56(v7, fm31(f13, globalState), f14, globalState), v6, fm31(v3[safeIndex(138, v3.Length)], globalState), (v8[safeIndex(|v9|, |v8|) := v7] + "l") < (v8 + "ufdlshgcx")[safeIndex(f21, |(v8 + "ufdlshgcx")|) := v7];
		}
		var v10: set<string> := {seq(abs(0x18), i3  => ('l'))};
		var v11 := DC37(true, true, v10, f13, [8]);
		for i2 := (v11.(cf73 := seq(abs(258), i4  => (f13)))).cf72 to v3[safeIndex(138, v3.Length)] - f21 {
			...
			var v16: map<array<int>, T3> := map[v12[safeIndex(v3[safeIndex(138, v3.Length)], |v12|)] := if (0x38e in v15) then v15[0x38e] else v14];
			v16 := v16;
			var v17: seq<bool> := [v14.f14];
			var v18: set<bool> := {v17[safeIndex(707, |v17|)]};
			var v19: multiset<set<bool>> := multiset{v18 - v18};
			var v20: seq<set<bool>> := [v18, v18, {v14.f14, v0, v0, p3, p3}];
			v19 := multiset{v18, v18, fm67(f21, p1, globalState), v20[safeIndex(i2, |v20|)], fm67(v3[safeIndex(138, v3.Length)], f21, globalState)};
			v0 := f14;
			var v21 := "j";
			v0 := |v21| > f21;
		}
		for i5 := 0x303 to |([f21, f21, f13] + v11.cf73)| {
			...
			if (p3) {
				...
				var v25: C1 := new C1(f21, true, v24[safeIndex(-f21, |v24|)], f13);
				var v26 := "aqcjfsgdb";
				...
				v31[safeIndex(318, v31.Length)] := if (f14) then v25 else v25;
				var v32: seq<bool> := [p0, v0, p3];
				v31[safeIndex(318, v31.Length)] := new C1(f21 + |"ofprse"|, f14, f12, |v32|);
				v23[safeIndex(613, v23.Length)] := !p0;
				v0, v0, v3[safeIndex(138, v3.Length)], v23[safeIndex(613, v23.Length)], v3[safeIndex(138, v3.Length)] := (multiset{v25.fm5(v0, seq(abs(792), i6  => ('a')), multiset(f12), globalState)} !! v1) !in v32, p0, f21, p0, (|v26| + f21) * (f21 * f21);
				var v33: multiset<bool> := multiset{p0};
				var v34: seq<multiset<bool>> := [v33];
				var v35 := DC16(p1, i5, v32, 113);
				v33 := (v33 - v34[safeIndex(i5, |v34|)]) - fm64(DC35({v35}, |v22|, v4), false, globalState);
				v3[safeIndex(138, v3.Length)] := fm6(globalState);
			} else {
				var v36 := "fng";
				v36 := fm48(p1, globalState);
				var v37: seq<bool> := [v0];
				var v38: seq<bool> := [v0, v0, p1 <= f21, fm9(v37[safeIndex(|v36|, |v37|)], globalState), v0];
				v37 := v38 + v37;
				v0 := v36 != v36;
				var v39: map<int, bool> := map[|{v0}| := false];
				v39 := v39;
				v36 := (seq(abs(-0x38c), i7  => ('d'))) + "lkoqu";
			}
			...
			match (if (p3) then v40 else DC47(|v42|)) {
				case DC46(cf88, cf89) =>
					...
					var v44: array<string> := new seq<char>[18](i8 => seq(abs(0x39d), i9  => (cf89)));
					var v45 := "rcdcrdwkq";
					v44[safeIndex(263, v44.Length)] := v45;
					var v46: map<int, bool> := map[v3[safeIndex(138, v3.Length)] := p3];
					var v47: seq<string> := [v45];
					globalState.f5, globalState.f5, v23[safeIndex(966, v23.Length)], v43, v44[safeIndex(263, v44.Length)] := f21, safeModuloInt(-|v46|, p1), if (v47 < v47) then f14 else p3, v43, "pmsdtkqsg";
					var v48: set<bool> := {p0, cf88, cf88};
					var v49: map<int, set<bool>> := map[f13 := v48];
					globalState.f5 := |(if (v3[safeIndex(138, v3.Length)] in v49) then v49[v3[safeIndex(138, v3.Length)]] else v48 * {p3})|;
					var v50: array<multiset<int>> := new multiset<int>[10];
					v50[safeIndex(257, v50.Length)] := multiset{0x21c, v3[safeIndex(138, v3.Length)], v3[safeIndex(138, v3.Length)]};
					v50[safeIndex(257, v50.Length)] := f22;
				case DC47(cf90) =>
					r0 := f21;
					var v51 := new C3(!v0, i5 + -f13, f14, f12 + f12);
					var v52 := "axg";
					var v53 := 'y';
					cf90 := fm5(false, v52 + v52[safeIndex(85, |v52|) := v53], v2[safeIndex(|v52|, |v2|)], globalState);
					v0 := f14;
				case DC45(cf87) =>
					var v54: map<bool, int> := map[p0 := f13];
					var v55: multiset<map<bool, int>> := multiset{v54, v54};
					var v56: map<int, bool> := map[p1 := p3];
					v0, v0, v0, globalState.f5, v3[safeIndex(138, v3.Length)] := p3, (v55 >= multiset{v54, v54, v54[if (f13 in v56) then v56[f13] else p3 := i5], v54, v54}) && false, f14, p1, p1;
					var v57: multiset<map<int, bool>> := multiset{v56};
					var v58 := new C0(p0, v57 - v57, f12);
					var v59 := new C4(if (v0) then -p1 else -0x131, p3, f12);
					var v60 := new C4(-0x15c, v3[safeIndex(138, v3.Length)] !in v22, f12 + f12);
				case DC48(cf91) =>
					var v61 := 'h';
					var v62 := "blgof";
					var v63: seq<char> := ['h', v61, v62[safeIndex(v3[safeIndex(138, v3.Length)], |v62|)], v61, v61];
					globalState.f0 := v62[safeIndex(v3[safeIndex(138, v3.Length)], |v62|)];
		...
		for i10 := -(if (f14) then f13 else v3[safeIndex(138, v3.Length)]) to |v72[v71 := v0]| {
			r0 := p1;
			var v73: array<bool> := new bool[10];
			var v74: array<array<bool>> := new array<bool>[6] [v73, v73, v73, v73, v73, v73];
			v74[safeIndex(592, v74.Length)] := v73;
			v74[safeIndex(592, v74.Length)] := if (p3) then v73 else v73;
			...
			var v81: array<set<bool>> := new set<bool>[13] [{v0}, v80, v80, v80, {true}, {p3}, {p0, p3, fm0(f12[safeIndex(978, |f12|)], v0, p0, globalState), p0}, {p0}, v80, v80, v80, v80, v80];
			v79[safeIndex(151, v79.Length)] := v81;
			var v82 := "ktugxmsa";
			var v83: map<bool, int> := map[|f12| == -|v82| := f13 + fm5(fm0(i10, p3, f14, globalState), "an", v1, globalState)];
			v0, globalState.f5, v79[safeIndex(151, v79.Length)], v74, v83 := f14, f21, v81, v74, v83;
		}
		var v84 := 'c';
		var v85: map<char, bool> := map[v84 := f14];
		r0 := safeDivisionInt(-safeModuloInt(|v4|, p1), |(map[v84 := p3] + v85)|);
	}
	method m14(p0: seq<string>, globalState: GlobalState) returns (r0: int, r1: int) {
		for i0 := f21 to f13 {
			r1 := safeModuloInt(safeModuloInt(f21, f21), f21);
			...
			if (v2 !in v3) {
				...
				var v5 := new C3(i0 != |{f13, i0}|, f21 * f13, f22 > v4[safeIndex(i0, |v4|)], f12);
				var v6: array<bool> := new bool[6];
				var v7: set<bool> := {false};
				globalState.f9, v5.f24 := v6, fm31(|v7|, globalState);
				v6[safeIndex(379, v6.Length)] := v5.f24;
				v6[safeIndex(379, v6.Length)] := v5.f24;
				v6[safeIndex(379, v6.Length)] := (i0 - f13) < f13;
			} else {
				var v8 := true;
				v8 := true;
				globalState.f5 := i0;
				...
				v10 := v10[fm1(|v0|, globalState) := v11[safeIndex(f12[safeIndex(f21, |f12|)], |v11|)]];
			}
			
			var v12: array<int> := new int[22];
			v12[safeIndex(833, v12.Length)] := -0x93;
			v12[safeIndex(833, v12.Length)] := -i0;
			var v13: set<array<int>> := {v12, v12, v12, v12, v12};
			if (v13 > v13) {
				var v14: map<bool, bool> := map[!f14 := f14];
				v14 := v14[false := f14];
				v12[safeIndex(833, v12.Length)] := i0 + -(v12[safeIndex(833, v12.Length)] * i0);
				...
				var v30: map<D0, seq<bool>> := map[v28 := (v27[safeIndex(f13, |v27|) := if (f14 in v29) then v29[f14] else f14])[safeIndex(|v27|, |v27[safeIndex(f13, |v27|) := if (f14 in v29) then v29[f14] else f14]|) := f14]];
				var v31: multiset<seq<int>> := multiset{f12, f12, f12, f12, f12};
				var v32 := "vu";
				var v33 := 'j';
				var v34 := DC46(f14, v33);
				v12[safeIndex(833, v12.Length)] := fm8(v30, v27, v31, v32[safeIndex(-f21, |v32|) := v34.cf89], globalState);
			}
			
		}
		globalState.f5 := safeModuloInt(f21, f21);
		var i3 := 0;
		while (|f22| != safeModuloInt(|map[-f13 := f14]|, f13))
			decreases 100 - i3
		{
			if (i3 >= 100) {
				break;
			...
			var v48: array<int> := new int[20] [f21, |[f14, f14, f14, f14]|, f13, |v35|, f21, -0x2fc, f13 + |v35|, f12[safeIndex(0xd5, |f12|)], if (f21 in f22) then f22[f21] else f21, f13, if (f13 in v38) then v38[f13] else f21, f21, f21, if (f14 in v39) then v39[f14] else f21, f21, f13, f13, |v40|, if (v45 in v46) then v46[v45] else |(map v47 : int | (0xf5 <= v47) && (v47 < 0x144) :: (safeModuloInt(v47, -502)) := (true))|, f13];
			var v49 := false;
			...
			if (!f14) {
				...
				v50[safeIndex(494, v50.Length)] := v49;
				var v51 := DC0(|[f13, f13, f13]|);
				var v52 := 'r';
				var v53 := DC32(v52, f14, |f22|, f21);
				var v54: map<seq<int>, int> := map[f12 := f21];
				globalState.f5, globalState.f5, globalState.f5, v50[safeIndex(494, v50.Length)] := f21 - fm2(f13, v51, DC16(f13, f13, v43, f13).cf29, v49, globalState), safeDivisionInt(v53.cf60, f21), if (f12 in v54) then v54[f12] else f21, v49;
				var v55: set<array<bool>> := {v50};
				v55 := v55 - v55;
				var v56: array<seq<bool>> := new seq<bool>[19];
				v56[safeIndex(57, v56.Length)] := v43 + v43;
				var v57: seq<seq<bool>> := [v43];
				v56[safeIndex(57, v56.Length)], v41, v49, v49, v50[safeIndex(494, v50.Length)] := ((v57[safeIndex(f21, |v57|)] + v43) + (v43 + fm50(v49, f14, globalState)))[safeIndex(safeDivisionInt(-|v36|, f21), |((v57[safeIndex(f21, |v57|)] + v43) + (v43 + fm50(v49, f14, globalState)))|) := f14], v41, v49, fm9(v50[safeIndex(494, v50.Length)] !in [f14], globalState), f14;
			} else {
				var v58 := 'w';
				globalState.f5, globalState.f5 := if (v58 in (seq(abs(0x2a5), i4  => (v58)))) then |[f13]| else f13, f21;
				v49 := f14;
				v48[safeIndex(705, v48.Length)] := f21;
				v48[safeIndex(705, v48.Length)] := safeDivisionInt(-f13, f12[safeIndex(f21, |f12|)]);
			...
			globalState.f0 := v35[safeIndex(fm4(v37, globalState) + f21, |v35|)];
			if (if (f14) then true else fm7(globalState)) {
				...
				v65[safeIndex(354, v65.Length)] := v49;
				v65[safeIndex(354, v65.Length)] := false;
				v35 := "qi";
				var v66: C5 := new C5([v65], v36);
				var v67: map<array<bool>, C5> := map[v65 := v66];
				var v68 := DC16(-505, -516, [v49, v65[safeIndex(354, v65.Length)]], |v67|);
				var v69 := DC17(v68);
				...
				v71[safeIndex(725, v71.Length)] := DC17(v68);
				v71[safeIndex(725, v71.Length)] := v69;
				v65[safeIndex(354, v65.Length)] := |(seq(abs(0x3a3), i5  => ('s')))| < f21;
			} else {
				var v72: array<array<bool>> := new array<bool>[14];
				v72 := v72;
				var v73: array<bool> := new bool[25](i6 => !(v49 ==> true));
				v73[safeIndex(549, v73.Length)] := [v49, f14] != v43;
				v73[safeIndex(549, v73.Length)] := v49;
				globalState.f5 := --f13;
				r0 := f13;
				v73[safeIndex(549, v73.Length)] := f14;
			}
		...
		var v80: set<bool> := {f14, false, v79[safeIndex(f21, |v79|)]};
		...
		if (fm32(v81.f25, globalState)) {
			...
			var v92 := DC47(513);
			var v93 := DC48(v92);
			v91[safeIndex(286, v91.Length)] := v93;
			v91[safeIndex(286, v91.Length)] := DC48(v92);
			r1 := f21;
			var v94 := DC57(v81);
			var v95: map<array<bool>, C0> := map[v85 := v94.cf103];
			v95 := v95[v85 := v81];
			var v96 := new C1(f13, v81.f25, [-|[true]|], -safeModuloInt(f21, f21));
			...
			r0 := safeModuloInt(f21 - f13, -f13);
			v87, v81.f25 := v87 + v87, (v81.f25 <==> v81.f25) || fm7(globalState);
			if (v81.f25) {
				v85[safeIndex(474, v85.Length)] := v81.f25;
				var v103: map<bool, bool> := map[v81.f25 := v81.f25];
				v85[safeIndex(474, v85.Length)] := if (v81.f25) then v103 != v103 else fm9(v81.f25, globalState);
				var v104: map<bool, int> := map[f14 := f21];
				var v105: array<bool> := new bool[13] [v80 !! fm67(f13, f21, globalState), v81.f25, v81.f25, v85[safeIndex(474, v85.Length)], v81.f25, v85[safeIndex(474, v85.Length)], (multiset{f21, f13, |v104|, f21, |map[v81.f25 := v81.f25]|})[|v87| := abs(f13)] !! f22, v81.f25, v85[safeIndex(474, v85.Length)] <==> v81.f25, fm7(globalState), v85[safeIndex(474, v85.Length)], !v81.f25, v81.f25 in v79];
				globalState.f9 := v105;
				var v106: array<array<int>> := new array<int>[21];
				v106[safeIndex(111, v106.Length)] := if (v81.f25) then v74 else v74;
				v106[safeIndex(111, v106.Length)] := if (v81.f25 <==> v81.f25) then v74 else v74;
				globalState.f5 := safeModuloInt(|v87|, -73);
...
class C7 extends T0, T2 {
	...
	function fm6(globalState: GlobalState): int {
		safeModuloInt(-515, |(DC16(|"q"|, f13, [false, f14], f13).cf28 + [f14, f14])|)
	}
	function fm7(globalState: GlobalState): bool {
		f14
	}
	function fm26(p0: bool, p1: map<bool, int>, globalState: GlobalState): int {
		-(if (true) then |(multiset{f14, false} + multiset{f14, f14})| else f12[safeIndex(f13, |f12|)] + |map['y' := |(seq(abs(0x113), i0  => ('a')))|]|)
	}
	method m1(globalState: GlobalState) {
		var v0: seq<bool> := [f14];
		...
		var v10: set<int> := {f13};
		var v11: map<seq<bool>, int> := map[v0[safeIndex(f13, |v0|) := f14] := |v10|];
		var v13: seq<set<seq<bool>>> := [set v12 : seq<bool> | v12 in v11 :: (v12), {v0}];
		var v15: array<set<seq<bool>>> := new set<seq<bool>>[24] [set v2 : seq<bool> | v2 in v1 :: (v2), {DC16(f13, |v3|, v0, f13).cf28, v0}, v1, {v0}, v1 - v1, {v0}, v1, set v7 : seq<bool> | v7 in fm27(v6, f14, globalState) :: (v7), v1, (set v9 : seq<bool> | v9 in v8 :: (v9)) + v1, v1, v1, v1, v13[safeIndex(f13, |v13|)] + v1, v1 - v1, v1 + v1, v1 - v1, (set v14 : seq<bool> | v14 in v8 :: (v14)) + v1, v1, v1, v1 + v1, v1, v1, fm28(globalState)];
		v15[safeIndex(260, v15.Length)] := v1;
		v15[safeIndex(260, v15.Length)] := fm28(globalState) - (fm29(f13, f14, fm9(f14, globalState), f14, globalState)).cf48;
		var v16: array<string> := new string[25];
		v16[safeIndex(786, v16.Length)] := v3;
		v16[safeIndex(786, v16.Length)] := seq(abs(0x2ad), i0  => (v4));
		var v17 := true;
		v17 := f14 && f14;
		var v18: array<int> := new int[7](i2 => safeDivisionInt(i2, f13));
		forall i1 | 0 <= i1 < v18.Length {
			v18[i1] := i1 - f13;
		}
		v18[safeIndex(513, v18.Length)] := f13;
		var v19 := DC0(f13);
		var v20: multiset<char> := multiset{v4};
		var v22: map<int, int> := map[f13 := f13];
		var v23: map<multiset<char>, map<int, int>> := map[v20 := (map v21 : int | (0x331 <= v21) && (v21 < -0xb3) :: (safeDivisionInt(v21, f13)) := (-134)) + v22];
		var v24 := DC19(v4, v5, |v16[safeIndex(786, v16.Length)]|);
		var v25: map<bool, char> := map[v17 := v4];
		var v26 := DC6(v25);
		var v27 := DC8(v26);
		var v28 := DC8(v26);
		var v29: map<D2, bool> := map[v28 := v17];
		v18[safeIndex(513, v18.Length)], v19, v23, v17 := |("ky" + v16[safeIndex(786, v16.Length)])|, match DC20(v24) {
		...
		v17 := |v30| >= v18[safeIndex(513, v18.Length)];
	}
	method m2(p0: bool, p1: int, p2: D0, p3: bool, globalState: GlobalState) returns (r0: int) {
		if (!p0) {
			var v0: array<multiset<bool>> := new multiset<bool>[8];
			var v1: multiset<bool> := multiset{p0};
			v0[safeIndex(834, v0.Length)] := v1;
			var v2: set<bool> := {f14, p0, p0, p3, p3};
			var v3: seq<set<bool>> := [v2, v2, {p3, f14}];
			var v4 := DC15(0x20c, f14, f14);
			var v5 := DC17(v4);
			v0[safeIndex(834, v0.Length)], v3, v5 := v1, v3, v5;
			var v6 := false;
			v6 := v6;
			v6 := fm7(globalState);
			globalState.f5 := if (v0[safeIndex(834, v0.Length)] > v0[safeIndex(834, v0.Length)]) then p1 else p1;
			var v7: map<bool, map<int, int>> := map[p0 := fm30(v6, f13, globalState)];
			v7 := v7;
		} else {
			var v8: array<int> := new int[24](i0 => i0 + p1);
			v8[safeIndex(329, v8.Length)] := 0x9;
			var v9 := "vsyirq";
			var v10 := 'c';
			v8[safeIndex(329, v8.Length)], v9 := (p1 + f13) * f13, (seq(abs(-0x14b), i1  => ('w')))[safeIndex(p1, |(seq(abs(-0x14b), i1  => ('w')))|) := v10];
			var v11: multiset<int> := multiset{f13, v8[safeIndex(329, v8.Length)]};
			if (v11 == v11) {
				var v12: array<bool> := new bool[14];
				v12[safeIndex(316, v12.Length)] := p3;
				v12[safeIndex(316, v12.Length)], v11 := !p0, (multiset(f12) - multiset{f13, p1})[p1 := abs(v8[safeIndex(329, v8.Length)])];
				var v13: multiset<bool> := multiset{p3, p0};
				var v14: map<int, bool> := map[|v13| := v12[safeIndex(316, v12.Length)]];
				var v15 := new C0(p0, if (v12[safeIndex(316, v12.Length)]) then multiset(fm68(f13, globalState)) else multiset{v14}, f12);
				v12[safeIndex(316, v12.Length)] := p3;
				var v16 := new C4(fm6(globalState), false, f12[safeIndex(-f13, |f12|) := v8[safeIndex(329, v8.Length)]]);
				var v17: map<int, string> := map[v8[safeIndex(329, v8.Length)] := v9 + "hjoitp"];
				var v18: seq<map<int, string>> := [v17];
				v17 := v18[safeIndex(87, |v18|)];
			} else {
				globalState.f5 := v8[safeIndex(329, v8.Length)];
				var v19 := false;
				var v20: array<bool> := new bool[22];
				var v21: multiset<array<bool>> := multiset{v20, v20, v20};
				v19 := v21[v20 := abs(p1)] !! (multiset{v20, v20, v20, v20, v20} + v21);
				v8[safeIndex(329, v8.Length)] := v8[safeIndex(329, v8.Length)];
		...
		if (fm4(v28, globalState) in f12) {
			var v29 := 's';
			var v30: map<int, bool> := map[|(seq(abs(525), i2  => (v29)))| := p0];
			var v31 := "awfm";
			...
			match (v32) {
				case DC19(cf32, cf33, cf34) =>
					...
					var v34: map<bool, seq<int>> := map[v33[safeIndex(cf34, |v33|)] := f12];
					var v35: multiset<bool> := multiset{v27};
					var v36: array<seq<int>> := new seq<int>[29] [f12, [-|v31|], f12 + f12, f12, if (p0 in v34) then v34[p0] else f12, f12, f12, f12, f12, seq(abs(0x329), i3  => (cf34)), seq(abs(319), i4  => (cf34)), f12 + f12, f12 + (seq(abs(0x7e), i5  => (cf34))), f12, f12 + (seq(abs(238), i6  => (p1))), [if (fm0(cf34, !false, f14, globalState) in v35) then v35[fm0(cf34, !false, f14, globalState)] else cf34, -7, |multiset{p3}|], f12, f12, f12, f12 + f12, f12, f12, f12 + f12, f12, f12, f12, f12, if (false in v34) then v34[false] else f12, f12];
					var v37: map<int, seq<int>> := map[cf34 := seq(abs(-0x16e), i7  => (|v31|))];
					v36[safeIndex(571, v36.Length)] := if (f13 in v37) then v37[f13] else seq(abs(-0x3c9), i8  => (cf34));
					var v38: multiset<int> := multiset{cf34, cf34, f13, p1};
					v36[safeIndex(571, v36.Length)] := f12[safeIndex(f13 * |v33|, |f12|) := safeModuloInt(|v38|, f13)];
					var v39: array<bool> := new bool[13](i9 => v27);
					v39[safeIndex(587, v39.Length)] := f14;
					var v40 := DC16(f13, 777, v33, p1);
					var v41: set<D5> := {v40, v40};
					var v42 := DC35(v41, |v35|, v28);
					v39[safeIndex(587, v39.Length)] := multiset{!p0, DC25(p0).cf46, f14} !! (if (v27) then fm64(v42, !f14, globalState) else v35);
				case DC18(cf31) =>
					var v43: array<int> := new int[28];
					v43[safeIndex(303, v43.Length)] := |(f12 + f12)|;
					var v44: seq<bool> := [v27, f14];
					var v45: map<bool, int> := map[p0 := |v44|];
					v43[safeIndex(303, v43.Length)] := |multiset{v45, if (v27) then v45 else v45}|;
					globalState.f0 := v29;
					var v46: array<array<bool>> := new array<bool>[4];
					var v47: array<bool> := new bool[19];
					v46[safeIndex(112, v46.Length)] := v47;
					var v48 := DC16(v43[safeIndex(303, v43.Length)], f13, v44, |cf31|);
					var v49: set<D5> := {v48, v48, v48, DC16(0xba, p1, [f14, f14], -548)};
					var v50 := DC35(v49, 0x179, {f13});
					v46[safeIndex(112, v46.Length)], cf31, v43[safeIndex(303, v43.Length)], globalState.f5 := v47, if (v27) then if (true) then ((fm64(v50, p0, globalState))[p0 := abs(p1)])[f14 := abs(p1)] else cf31 else multiset{f14} * multiset{!f14, f14}, safeModuloInt(-p1, f13), f13 * f13;
					var v51: seq<array<bool>> := [v46[safeIndex(112, v46.Length)], v46[safeIndex(112, v46.Length)]];
					var v52 := new C5(v51 + v51, f12 + f12);
				case DC20(cf35) =>
					var v53: array<int> := new int[9];
					v53[safeIndex(112, v53.Length)] := f13;
					v53[safeIndex(112, v53.Length)] := f13;
					var v54: map<bool, char> := map[false := v29];
					var v55: seq<map<bool, char>> := [map[true := v29], v54];
					var v56 := DC6(v55[safeIndex(-v53[safeIndex(112, v53.Length)], |v55|)]);
					var v57: array<bool> := new bool[9](i10 => v53[safeIndex(112, v53.Length)] <= 0x232);
					v57[safeIndex(148, v57.Length)] := fm0(f13, p0, v27, globalState);
					v56, r0, v57[safeIndex(148, v57.Length)], v27, v31 := v56, p1, !(f13 >= safeDivisionInt(v53[safeIndex(112, v53.Length)], f13)), !v27, v31;
					var v58 := new C0(f14, multiset{v32.cf33, v30}, f12[safeIndex(f13, |f12|) := p1]);
					v53[safeIndex(112, v53.Length)] := f13;
			}
			...
			var v64: map<int, int> := map[0x2fd := |(map v59 : int | v59 in (if (f14 in v63) then v63[f14] else v62) :: (safeDivisionInt(v59, -|v60|)) := ("tsrpyxbt"))|];
			var v65: seq<map<int, int>> := [v64, map[|v28| := p1]];
			var v66 := DC7();
			var v67: seq<D2> := [v66, v66, v66];
			var v68 := DC9(map[v67 := v29]);
			var v69: map<map<int, int>, D3> := map[v65[safeIndex(f13, |v65|)] := v68];
			v69 := v69[v64 := v68.(cf13 := v68.cf13)];
			var v70: array<bool> := new bool[20];
			v70[safeIndex(428, v70.Length)] := p0;
			var v71: map<string, bool> := map[v31 := p3];
			v70[safeIndex(428, v70.Length)] := (v71 != map[v31 := false]) <== true;
			var v72: array<int> := new int[13];
			v72[safeIndex(613, v72.Length)] := p1;
			v72[safeIndex(613, v72.Length)] := p1;
			var v73: map<bool, bool> := map[v27 := v27];
			var v74: map<string, map<bool, bool>> := map[v31 := v73];
			globalState.f5 := if (f14) then |(set v75 : string | v75 in v74 :: (v75))| else safeDivisionInt(|v28|, v72[safeIndex(613, v72.Length)]);
		} else {
			var v76: set<bool> := {f14, f14, p3, p3};
			v27 := safeDivisionInt(|v76|, f13) < p1;
			if (p0) {
				v27 := v27;
				...
				v77 := v77[f13 := |v79|];
				v78[safeIndex(611, v78.Length)] := p1;
				v78[safeIndex(410, v78.Length)] := f13;
				var v80 := "hykoh";
				var v81 := DC1(p0);
				v78[safeIndex(611, v78.Length)], v27, globalState.f5, v78[safeIndex(410, v78.Length)], v27 := if (f14) then p1 else |v80|, v81.cf1, p1, f13, f14;
				v27 := p0;
				v27 := p0;
			} else {
				globalState.f5 := -f13;
				...
				v85[safeIndex(682, v85.Length)] := f13 + |(seq(abs(-399), i12  => ('i')))|;
				v85[safeIndex(682, v85.Length)] := safeDivisionInt(p1, f13);
				var v86: multiset<int> := multiset{p1, v85[safeIndex(682, v85.Length)]};
				var v87 := new C6(v85[safeIndex(682, v85.Length)], v86, f15, safeModuloInt(v85[safeIndex(682, v85.Length)], |f12|), v27, f12);
				var v88 := 'i';
				var v89 := "u";
				v27 := v88 in v89;
			}
			...
			v91[safeIndex(655, v91.Length)] := f14;
			v91[safeIndex(655, v91.Length)] := safeDivisionInt(f13, p1) > 93;
			var v92: set<map<bool, bool>> := {map[p0 := v91[safeIndex(655, v91.Length)]]};
		...
		var v97: map<int, seq<int>> := map[p1 := (fm56(v95, if (false in v96) then v96[false] else f14, v27, globalState))[safeIndex(p1, |fm56(v95, if (false in v96) then v96[false] else f14, v27, globalState)|) := p1]];
		...
		var v107: array<bool> := new bool[29] [v27 || f14, p3, p0, f14, if (p0) then f14 else p0, v27, multiset(v94) <= multiset{p0}, p3 || v27, v94[safeIndex(0x224, |v94|)], true, (if (|v100| in v97) then v97[|v100|] else [|v99|]) != f12, true, p0, p0, fm0(f13, v27, true, globalState), v27, !(v94 < v94), f14, p0, p3, p3, f14, 0x2eb <= -p1, v101 > v101, false, !("jwgkavmfw" < v99), v102.cf1, v106 > v106, v27];
		forall i14 | 0 <= i14 < v107.Length {
			v107[i14] := {f12[safeIndex(f13, |f12|)], p1} >= v28;
		}
...
class C8 {
	...
	function fm24(p0: bool, p1: bool, p2: set<int>, globalState: GlobalState): int {
		safeDivisionInt(|multiset{false}|, |multiset{true, false}| * -798)
	}
	function fm25(p0: bool, p1: seq<D2>, p2: int, globalState: GlobalState): set<int> {
		if (true) then {|(seq(abs(0x32f), i0  => ('n')))|, -|map[[-619] := 0x1c9]|, |multiset{0xd, 0x225}|, |multiset{!false, !false, false}|} else {|"cavau"|} - {0xbe, -0x170, 0x22c}
	}
	method m12(p0: int, p1: D6, globalState: GlobalState) returns (r0: int, r1: int, r2: bool, r3: bool) {
		var v0 := true;
		var v1 := "xxdwd";
		var v2: seq<int> := [p0, |v1|];
		var v3: map<D5, int> := map[DC16(p0, p0, [v0, v0, v0], v2[safeIndex(p0, |v2|)]) := 44];
		...
		var v11 := new C7(v9 + v2, v10, safeModuloInt(p0, p0), false);
		if (v2 != v9) {
			r1 := p0;
			var v12 := 'e';
			v1 := ("sujt" + (v1[safeIndex(p0, |v1|) := v12] + fm48(p0, globalState)))[safeIndex(p0, |("sujt" + (v1[safeIndex(p0, |v1|) := v12] + fm48(p0, globalState)))|) := v12];
			v1 := seq(abs(18), i0  => (v12));
			...
			if (v13 < v13) {
				...
				v7[safeIndex(473, v7.Length)] := |v1|;
				v7[safeIndex(473, v7.Length)] := -(if (v0) then if (p0 in v5) then v5[p0] else 699 else p0);
				r2 := v0;
				r3 := v0 || v0;
				r2 := v0;
				v0 := v0;
			...
			var v18 := DC15(p0, v17[safeIndex(p0, |v17|)], v0);
			v18 := v18.(cf25 := v0 <== v0, cf24 := !(([|v17|])[safeIndex(0x1e3, |[|v17|]|) := p0] == v9));
			...
			v23[safeIndex(46, v23.Length)] := v22;
			v23[safeIndex(46, v23.Length)], v1 := v22, v1;
		}
	...
	method m13(p0: bool, p1: string, p2: bool, globalState: GlobalState) returns (r0: char, r1: int, r2: bool) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := safeDivisionInt(i0, -(0x358 * |{0x45, |map[|map[map['p' := |multiset{0x18c, |[p0, true]|}|] := |(set v1 : int | (0x1f9 <= v1) && (v1 < 0x21f) :: (v1 - 0x296))|]| := 508]|}|));
		}
		var v2 := 'p';
		var v3 := DC28(v2);
		r2 := match v3 {
		...
		v5[safeIndex(621, v5.Length)] := p0;
		v5[safeIndex(621, v5.Length)] := p2;
		var v6 := 96;
		...
		for i2 := v6 to if (true in v8) then v8[true] else v6 {
			...
			v9 := v10[safeIndex(fm24(!false, p2, v12, globalState), |v10|)];
			var v13: seq<array<bool>> := [v5];
			var v14 := DC30(v13);
			match (v14) {
				case DC31(cf52, cf53, cf54, cf55, cf56) =>
					var v15: seq<bool> := [p2, p0];
					var v16: seq<bool> := [fm0(cf52, p2, p2, globalState), v15[safeIndex(|p1|, |v15|)], p2];
					globalState.f5, cf53, cf53, v15 := -cf56, cf53, v13[safeIndex(v6, |v13|)], (v16 + [p0])[safeIndex(cf56, |(v16 + [p0])|) := v5[safeIndex(621, v5.Length)] || p2];
					var v17 := "h";
					v17 := "ijwlv";
					var v18: map<int, int> := map[cf52 := |v17|];
					var v19: multiset<map<int, int>> := multiset{v18};
					v5[safeIndex(621, v5.Length)] := v18 in v19;
				...
				case DC32(cf57, cf58, cf59, cf60) =>
					var v24 := DC24(-safeModuloInt(cf60, v6), p0, v5);
					v24 := v24;
					cf60 := cf59;
					...
					var v29: seq<int> := [|v28|];
					var v30 := new C5(v25[safeIndex(cf60, |v25|)], v26);
					v9[safeIndex(675, v9.Length)] := p1;
					v9[safeIndex(675, v9.Length)] := seq(abs(0x10b), i3  => (v2));
				case DC30(cf51) =>
					var v31: set<set<char>> := {{v2}};
					v31 := v31;
					v5[safeIndex(621, v5.Length)] := v5[safeIndex(621, v5.Length)];
					var v32: multiset<bool> := multiset{p2, v5[safeIndex(621, v5.Length)], p0};
					var v33 := DC24(|v32|, v5[safeIndex(621, v5.Length)], v5);
					var v34: seq<bool> := [false, v5[safeIndex(621, v5.Length)], true, v33.cf44];
					var v35: set<seq<bool>> := {v34};
					var v36: seq<bool> := [v35 <= {v34[safeIndex(i2, |v34|) := p0], v34}, v5[safeIndex(621, v5.Length)], false, !(i2 == 0x364), fm0(i2, p2, p2, globalState)];
					v34 := v36 + v34;
					var v37 := DC31(v6, v5, p2, p2, v6);
					r1 := --|([p2, fm0(0x2d1, !p0, p2, globalState), false])[safeIndex(i2, |[p2, fm0(0x2d1, !p0, p2, globalState), false]|) := if (v37.cf54) then p2 else p2]|;
			}
			
			v5[safeIndex(621, v5.Length)] := (v5[safeIndex(621, v5.Length)] && v5[safeIndex(621, v5.Length)]) in fm50(p2, true, globalState);
			if (true) {
				globalState.f5 := i2;
				r2 := p0;
				v5[safeIndex(621, v5.Length)] := p0;
				var v38: map<bool, array<int>> := map[v5[safeIndex(621, v5.Length)] <== v5[safeIndex(621, v5.Length)] := v0];
				v38 := (v38 + v38[!p0 := v0]) + v38;
				v13 := v13[safeIndex(i2, |v13|) := if (p2) then v5 else v5];
			} else {
				globalState.f5 := i2;
				...
				v41 := v41[safeDivisionInt(v6, |v11|) := v40];
				var v42: map<bool, char> := map[v5[safeIndex(621, v5.Length)] := v2];
				v5[safeIndex(621, v5.Length)] := i2 == |v42|;
				r2 := (i2 + v6) == i2;
				v5[safeIndex(621, v5.Length)] := (v6 != v6) ==> p0;
			}
			
		}
		var i4 := 0;
		while (v5[safeIndex(621, v5.Length)])
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			v49 := (v49[v48 := v5[safeIndex(621, v5.Length)]] + v49[v48 := true]) + (map v50 : multiset<char> | v50 in v51[v48 := v6] :: (v50) := (DC51(seq(abs(843), i5  => (v8)), p0, DC18(multiset{p0, p2, v5[safeIndex(621, v5.Length)]})).cf95))[v48 := p2];
			var v52: seq<seq<int>> := [[v6]];
			m0(v52 <= v52, globalState);
		}
		r0 := v2;
		r1 := safeDivisionInt(if (true) then v6 else v6, -0x318 * |"oxev"|);
		r2 := fm0(safeModuloInt(0x10b, v6), p2, true, globalState);
	}
}
...
class C9 {
	...
	method m10(p0: bool, globalState: GlobalState) {
		...
		var v4: array<int> := new int[25](i0 => safeDivisionInt(i0, 712));
		var v5: seq<array<int>> := [v4];
		var v6 := DC23(v5);
		if ((v6.(cf42 := v5)).cf42 < [v4]) {
			var v7 := 'u';
			var v9 := DC19(v7, map v8 : int | (-0x32b <= v8) && (v8 < 0x2f0) :: (safeDivisionInt(v8, f20)) := (DC15(f20, p0, p0).cf24), |([v3, v3])[safeIndex(f20, |[v3, v3]|) := v3]|);
			globalState.f0 := v9.cf32;
			var v10: map<bool, bool> := map[p0 := p0];
			v10 := v10[p0 := p0];
			var v11: multiset<map<int, bool>> := multiset{map[|(seq(abs(67), i1  => (v7)))| := p0]};
			...
			v24[safeIndex(594, v24.Length)] := v26;
			v24[safeIndex(594, v24.Length)] := ((v26[false := |multiset{f20}|])[p0 := f20])[p0 := safeModuloInt(f20, f20)];
			var v27 := 'j';
			var v28: seq<int> := [f20, f20, f20];
			var v29 := DC32(v27, false, f20, |v28|);
			if (!(344 > safeDivisionInt(f20, v29.cf60))) {
				var v30 := true;
				var v31 := "ltdskiisi";
				...
				v30, v23, v30, v31 := if (v30) then v34.fm7(globalState) else p0, v23, !(!v30 && fm0(v32.f12[safeIndex(f20, |v32.f12|)], v32.f14, p0, globalState)), (v31 + v31) + "eevneduy";
			} else {
				...
				var v53: T1 := new C3(v51, f20, p0, v52[safeIndex(f20, |v52|)]);
				...
				v4[safeIndex(28, v4.Length)] := v53.f13;
				globalState.f9, v56, globalState.f5, v4[safeIndex(28, v4.Length)] := v40, v56, f20, if (p0) then -v53.f13 else f20;
				var v57: array<int> := new int[20];
				v57 := new int[18];
				v4[safeIndex(28, v4.Length)], v51 := v42.fm4({v53.f13}, globalState), p0;
			}
			
			var v58 := true;
			var v59: map<char, bool> := map[v27 := p0];
			var v60: map<seq<bool>, int> := map[v3 := |v59|];
			var v61: map<seq<int>, int> := map[v28 + v28[safeIndex(f20, |v28|) := if (v3 in v60) then v60[v3] else f20] := f20];
			var v62: seq<seq<int>> := [[f20, f20, f20, 0x19a, f20]];
			var v63: seq<multiset<int>> := [multiset(v62[safeIndex(f20, |v62|)])];
			v58, v58, v61 := p0, true <==> (|v63| > f20), v61;
		}
		
		var v64 := 'x';
		var v65: set<bool> := {v3[safeIndex(|map[v64 := p0]|, |v3|)], p0, p0, p0, p0};
	...
	method m11(p0: bool, p1: map<bool, bool>, p2: int, p3: bool, globalState: GlobalState) {
		...
		for i0 := |v2| to --p2 {
			...
			var v5: set<string> := {v4[safeIndex(p2, |v4|)]};
			v5 := {v3, v3, "osgaw" + v3, v4[safeIndex(p2, |v4|)] + v3, v3};
			var v6 := DC28(v0);
			globalState.f0 := v6.cf49;
			var v7 := false;
			v7 := p3 <== v7;
			var v8: array<int> := new int[23](i1 => safeModuloInt(i1, f20));
			var v9: array<array<int>> := new array<int>[8] [v8, v8, v8, v8, v8, v8, v8, v8];
			v9[safeIndex(969, v9.Length)] := v8;
			var v10: seq<array<int>> := [v8];
			v9[safeIndex(969, v9.Length)] := v10[safeIndex(i0, |v10|)];
		}
		var v11: multiset<bool> := multiset{p0, p3};
		globalState.f5 := -|(if (p3) then v11 else v11)|;
		var v12: multiset<int> := multiset{p2, |(([f20, p2])[safeIndex(p2, |[f20, p2]|) := p2])[safeIndex(0x42, |([f20, p2])[safeIndex(p2, |[f20, p2]|) := p2]|) := p2]|, p2, f20};
		...
		for i2 := |fm64(v17, p0, globalState)| + f20 to p2 {
			...
			if (if (if (p3) then p3 else p0) then v18 != v18 else p0) {
				var v19: array<int> := new int[27](i3 => safeDivisionInt(i3, p2));
				v19[safeIndex(706, v19.Length)] := f20;
				v19[safeIndex(706, v19.Length)] := p2 - (i2 * i2);
				var v20 := DC14(false, v18, v19[safeIndex(706, v19.Length)], false, p0);
				var v21 := DC4(if (p3) then p0 else v20.cf21, -safeModuloInt(v19[safeIndex(706, v19.Length)], v19[safeIndex(706, v19.Length)]), p0);
				v21 := if (p0) then v21.(cf8 := v19[safeIndex(706, v19.Length)]) else DC4(true, v19[safeIndex(706, v19.Length)], p0);
				globalState.f5 := safeModuloInt(|(fm48(v19[safeIndex(706, v19.Length)], globalState) + (seq(abs(338), i4  => (v0))))|, |(if (p0) then v18 else v18)|);
				var v22: map<bool, int> := map[p3 := v19[safeIndex(706, v19.Length)]];
				var v23: seq<int> := [|(seq(abs(0x263), i5  => (v0)))|, v19[safeIndex(706, v19.Length)], 0xe8];
				globalState.f5 := |v22[v19[safeIndex(706, v19.Length)] < |v23| := |v18| - f20]|;
				globalState.f5 := v19[safeIndex(706, v19.Length)];
			} else {
				var v24 := true;
				var v25: set<char> := {v0};
			...
			v30 := v30[p0 := v29];
			globalState.f5 := safeDivisionInt(safeDivisionInt(i2, |"rhobvw"|), -p2);
		}
		var v31: array<array<bool>> := new array<bool>[16];
		var v32: array<bool> := new bool[12](i7 => p0);
		v31[safeIndex(657, v31.Length)] := v32;
		v31[safeIndex(657, v31.Length)] := v32;
		if (v11 < v11) {
			var v33 := true;
			v33 := v33;
			...
			v34[safeIndex(551, v34.Length)] := f20;
			v34[safeIndex(863, v34.Length)] := if (v33) then f20 else p2;
			var v35: seq<int> := [p2];
			var v36 := "ar";
			var v37: map<int, int> := map[|v36| := |v16|];
			var v38 := DC22(v0, p0, |v37|, f20, |v16|);
			v33, v34[safeIndex(551, v34.Length)], v34[safeIndex(863, v34.Length)] := !((v35 == v35) ==> p3), v38.cf39, f20;
			var v39 := DC0(v34[safeIndex(551, v34.Length)]);
			var v40: map<bool, int> := map[fm0(fm2(v34[safeIndex(551, v34.Length)], v39, p2, v33, globalState), v33, p3, globalState) := |v16|];
			globalState.f5 := p2 * (if (v33) then |v40[v33 := v34[safeIndex(551, v34.Length)]]| else 0x12d);
			var v41 := DC46(p3, v0);
			var v42: set<D17> := {v41};
			if ((v42 !! v42) !in v13) {
				globalState.f5 := safeDivisionInt(v34[safeIndex(551, v34.Length)], f20) + v34[safeIndex(551, v34.Length)];
				v33 := fm0(v34[safeIndex(551, v34.Length)], if (v33) then p0 else p3, v33, globalState);
				v33 := -|(v36 + v36)| < v34[safeIndex(551, v34.Length)];
				var v43: set<bool> := {p3, p3};
				globalState.f5 := if (-(|v43| + v34[safeIndex(551, v34.Length)]) in v37) then v37[-(|v43| + v34[safeIndex(551, v34.Length)])] else fm2(v34[safeIndex(551, v34.Length)], v39, p2, p3, globalState);
				var v44: map<int, bool> := map[p2 := true];
				var v45: seq<string> := [v36, if (if (p2 in v44) then v44[p2] else v33) then seq(abs(444), i9  => (v0)) else v36, v36];
				v45 := ["lmyi"];
			} else {
				var v46 := new C4(v34[safeIndex(551, v34.Length)] + v34[safeIndex(551, v34.Length)], if (p3) then p3 else p0, v35);
				v33 := v46.fm7(globalState);
				var v47: map<bool, bool> := map[v33 := true];
				v47 := v47 + (v47 + v47);
				v32[safeIndex(316, v32.Length)] := p3;
				v32[safeIndex(316, v32.Length)] := p3 && p3;
				globalState.f5 := f20;
			}
			...
			var v50 := DC14(p0, v48, p2, if ((seq(abs(-740), i10  => (v0))) in v49) then v49[seq(abs(-740), i10  => (v0))] else p0, p0 <==> p3);
			v50 := v50;
			var v51 := false;
			v51 := v12 != fm70(p0, globalState);
			var v52: seq<array<bool>> := [v31[safeIndex(657, v31.Length)]];
			var v53: seq<int> := [p2];
			...
			var v59: C6 := new C6(if (p0 in v55) then v55[p0] else -f20, v12, v56, v57.f13, v51, seq(abs(0xbd), i11  => (v57.f13)));
			var v60 := DC32(v0, fm0(|v48|, fm0(-p2, true, p0, globalState), true, globalState), if (p3 in v11) then v11[p3] else p2, |map[v59 := p0]|);
			v31[safeIndex(657, v31.Length)][safeIndex(736, v31[safeIndex(657, v31.Length)].Length)] := v60.cf58;
			v31[safeIndex(657, v31.Length)][safeIndex(736, v31[safeIndex(657, v31.Length)].Length)] := v13 == v13;
			v16 := fm40(v57.f14, -0x1e5, v31[safeIndex(657, v31.Length)][safeIndex(736, v31[safeIndex(657, v31.Length)].Length)], globalState);
		}
...
class C10 extends T1, T3 {
	...
	method m3(p0: bool, p1: map<array<int>, seq<bool>>, p2: bool, p3: T2, globalState: GlobalState) returns (r0: int, r1: int, r2: set<int>, r3: char) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v1 := "wvklm";
			v1 := seq(abs(0x3d8), i1  => ('u'));
			var v2: array<bool> := new bool[26](i2 => v0 !! v0);
			v2[safeIndex(352, v2.Length)] := false || p0;
			v2[safeIndex(352, v2.Length)] := f19;
			var v3: array<char> := new char[24](i3 => 'a');
			var v4: array<array<char>> := new array<char>[2] [v3, v3];
			v4[safeIndex(976, v4.Length)] := if (p0) then v3 else v3;
			v4[safeIndex(976, v4.Length)] := v3;
		...
		for i4 := f16 to f13 {
			...
			v8 := v8;
			var v9 := "ycbuyuiwx";
			var v10: set<bool> := {v7[safeIndex(|v9|, |v7|)]};
			var v11 := DC10(v10);
			var v12: map<D4, bool> := map[v11 := p0];
			f19 := fm0(i4, DC10(v10) !in v12, !p3.f14 || p2, globalState);
			v9, f19, r1, f19 := v9, v7[safeIndex(p3.f13, |v7|)], --safeModuloInt(f13, f13), p3.f14;
		}
		if (f14) {
			...
			match (v13.(cf6 := f19)) {
				case DC2(cf2, cf3, cf4) =>
					...
					v14[safeIndex(86, v14.Length)] := v15[cf2 := abs(p3.f13)] >= v15;
					...
					var v20: seq<array<array<int>>> := [v19[safeIndex(f16, |v19|)], v18];
					v14[safeIndex(86, v14.Length)], cf4, globalState.f10 := if (f14) then f19 else p0, p3.f14, v20[safeIndex(p3.f13 - -p3.f13, |v20|)];
					...
					globalState.f5, cf4, v22, v23, v18 := safeDivisionInt(p3.f13, |(v24 + [map[f19 := p3.f13], fm20(p3.f14, globalState), v22, v22])|), (if (v28 in v26) then v26[v28] else v25) < v25, v22, (multiset{v0} - v23)[v0 := abs(-p3.f13)], v18;
				...
				case DC3(cf5, cf6) =>
					...
					var v35 := new C0(p2, v34 - v34[v33 := abs(f16)], ([p3.f13] + f12)[safeIndex(f16, |([p3.f13] + f12)|) := fm5(p0, seq(abs(431), i6  => ('k')), v0, globalState)]);
					f19 := false;
				...
				case DC4(cf7, cf8, cf9) =>
					...
					v37[safeIndex(213, v37.Length)] := v39;
					v37[safeIndex(213, v37.Length)] := v39 + map[v38 := p2];
					v38[safeIndex(882, v38.Length)] := cf8;
					var v40: multiset<bool> := multiset{p2};
					var v41: set<bool> := {p3.f14, p0, p0};
					v38[safeIndex(882, v38.Length)], v40, v41, cf7, cf9 := safeModuloInt(0x337, f16), v40 * v40, {p3.f14, !f19, p3.f14, !p3.fm9(p3.f14, globalState)}, p3.f14, cf7;
				...
				case DC1(cf1) =>
					...
					var v52: multiset<bool> := multiset{p3.f14, v51[safeIndex(|v47|, |v51|)]};
					var v53 := DC18(v52);
					var v54 := DC20(v53);
					...
					var v60: array<int> := new int[29] [p3.f13 * p3.fm6(globalState), f13, p3.f13 + |v47|, p3.f13, -p3.f13, f16, (v56.(cf52 := -f13, cf55 := p3.f14)).cf56, p3.f13, p3.f13, p3.f13, p3.f13, safeDivisionInt(-p3.f13, p3.f13), safeDivisionInt(p3.f13, |v57|), f16, |((if (!f14 in v58) then v58[!f14] else p3.f12) + [p3.fm5(f19, ("fi")[safeIndex(p3.f13, |"fi"|) := v42], v0, globalState), 897])|, p3.fm5(p3.fm7(globalState), v47, v0, globalState), f16, p3.f13, |v47|, -f16, f13, p3.f13, f13, f16, |v47|, f13, f16, |(v59 + v59)|, 0x35c];
					v60[safeIndex(620, v60.Length)] := |(map v61 : int | (380 <= v61) && (v61 < 418) :: (v61 + |v51|) := (v59))|;
					var v62: set<int> := {f13};
					var v63: map<int, bool> := map[|v62| := p3.f14];
					var v64: map<bool, bool> := map[true := if (|v47| in v63) then v63[|v47|] else true];
					v60[safeIndex(620, v60.Length)] := |(fm48(|v64|, globalState) + (seq(abs(0x11b), i9  => (if (f19 in v43) then v43[f19] else v42))))|;
					v47 := (v47 + v47) + (v47 + v47);
				case DC5(cf10) =>
			...
			if (p3.f14 || f19) {
				...
				var v68: map<bool, int> := map[f19 := p3.f12[safeIndex(p3.f13, |p3.f12|)]];
				var v69 := DC0(|v68|);
				var v70: array<int> := new int[3] [fm2(|v0|, v69, p3.f13, p3.f14, globalState), f16, f13];
				v70[safeIndex(496, v70.Length)] := -p3.f13;
				...
				v70[safeIndex(496, v70.Length)] := safeDivisionInt(|v72|, |v73|) - f16;
				f19 := f14;
				var v74 := 'e';
				var v75: multiset<char> := multiset{v74, v74};
				var v76: seq<multiset<char>> := [v75, v75, v75];
				v70[safeIndex(496, v70.Length)] := -(0x5a * |v76|);
				var v77: multiset<bool> := multiset{p3.f14};
				var v78 := DC22(v74, p2, f13, |v77|, v70[safeIndex(496, v70.Length)]);
				f19 := |map[p3.f14 := -v78.cf39]| > p3.f13;
			} else {
				var v79: C2 := new C2(p3.f13, f13, f19, p3.f12, p3.f15);
				var v80: map<int, seq<int>> := map[safeDivisionInt(f13, f16) := f12];
			...
			if (p3.f14) {
				...
				v89[safeIndex(220, v89.Length)] := p3.f14;
				var v90 := 'y';
				var v91: multiset<char> := multiset{fm1(f16, globalState), v90, v90};
				var v92: seq<char> := [v90, v90];
				var v93: seq<bool> := [f19, p3.f14, p3.f14];
				v89[safeIndex(220, v89.Length)], r0, v91 := (|v92| != p3.f13) <== p3.f14, f16, v91[v90 := abs(safeDivisionInt(f16, -|v93|))];
				...
				var v105 := new C0(v101.f14, multiset{v104, map[p3.f13 := v101.f14]}, p3.f12[safeIndex(-f16, |p3.f12|) := f13]);
			}
			...
			if (p3.fm9(if (p3.f14) then p0 else p3.f14, globalState)) {
				...
				var v108 := DC10(v107);
				var v109: seq<D4> := [v108, DC10(v107), fm73(|(seq(abs(-159), i11  => (|DC16(f13, f13, [p2, p3.f14, false], f13).cf28|)))|, globalState), v108, DC10(v107).(cf14 := v107)];
				...
				v117[safeIndex(308, v117.Length)] := 0x212 > p3.f12[safeIndex(p3.f13, |p3.f12|)];
				...
				v117[safeIndex(308, v117.Length)], globalState.f9, v119, f19, f19 := v0 >= v0, v117, fm75(v112[safeIndex(|[p3.f14, p3.f14, f19, p3.f14]|, |v112|)], f13, p2 && p3.f14, globalState), v120 in v121, v122 in v123;
				var v124 := new C2(f16, -p3.f13, f19, p3.f12, p3.f15);
				globalState.f5, f19, globalState.f0, r0, globalState.f5 := f13, v124.fm7(globalState), v122, safeModuloInt(p3.f13, f16), f13;
			} else {
				...
				v128[safeIndex(836, v128.Length)] := f16 <= 0x378;
				var v129: set<string> := {v127, v127};
				var v130 := DC37(p3.f14, p3.f14, v129, p3.f13, p3.f12);
				v128[safeIndex(836, v128.Length)] := v130.cf70;
				var v131 := 'a';
				...
				f19, r1, r1, v128[safeIndex(836, v128.Length)] := p2, f13, if (v128[safeIndex(836, v128.Length)]) then f13 else 0x272, (v131 in "uhqc") || (v133 >= v133);
				var v134 := DC0(0x10b);
				var v135: seq<bool> := [p3.f14, v128[safeIndex(836, v128.Length)]];
				...
				v132[safeIndex(476, v132.Length)] := p3.fm8(v137, v135, v138, v127, globalState);
				var v139: set<bool> := {f14};
				v132[safeIndex(476, v132.Length)] := |(v139 - v139)|;
			...
			f19 := f14;
			if (f19) {
				globalState.f5 := p3.f12[safeIndex(f13, |p3.f12|)];
				...
				v144[safeIndex(884, v144.Length)] := p3.f13 + -f16;
				v144[safeIndex(884, v144.Length)] := p3.f13;
				var v145 := "jgnal";
				var v146: C4 := new C4(0x28a, p3.f14, f12[safeIndex(p3.f13, |f12|) := |v145|]);
				...
				v147[safeIndex(801, v147.Length)] := v146;
				f19, v147[safeIndex(801, v147.Length)] := v146.fm7(globalState), v146;
			} else {
				var v148: array<D5> := new D5[18];
				var v149: array<bool> := new bool[19];
				var v150: multiset<array<bool>> := multiset{v149, v149};
				var v151 := DC13(v150);
				v148[safeIndex(568, v148.Length)] := v151;
				v148[safeIndex(568, v148.Length)] := DC13(v150 + v150);
				v149[safeIndex(244, v149.Length)] := p3.f14;
				v149[safeIndex(244, v149.Length)] := f19;
				var v152 := 'f';
				globalState.f0 := v152;
				var v153 := DC0(-0xd4);
				var v154: seq<bool> := [v149[safeIndex(244, v149.Length)]];
				...
				var v159: array<int> := new int[24] [-f16, p3.f13, safeModuloInt(f16, f13), p3.f13, -(f13 * p3.f13), 461, if (p3.f13 in v0) then v0[p3.f13] else p3.f13, f16, p3.f13, p3.f13 + p3.fm8(v155, v154, v156, "ueniwbqd", globalState), 0x29e, f13 - f13, f16, f12[safeIndex(|"po"|, |f12|)], |v157|, f16, |v158|, p3.f13, p3.f13, p3.f13, f13 * 0x1ab, p3.f13 + p3.f13, 677 + p3.f13, f13 * 0x257];
				v159 := v159;
				globalState.f5 := p3.f12[safeIndex(f16, |p3.f12|)];
			}
		...
		var v169: array<int> := new int[21] [p3.f13, f16, |v162|, f16, f13, -(0x4d * p3.f13), f16, p3.f13, if (p0) then f16 else |v163|, f16, f13 - p3.f13, safeModuloInt(f13, |v164|), |(v161 + v161)|, p3.f13, -0x32a, safeDivisionInt(|v165|, f16), p3.f13, 0x99 - |v163|, f16, |v168| - -f16, safeModuloInt(p3.f12[safeIndex(p3.f13, |p3.f12|)], p3.f13)];
		v169[safeIndex(91, v169.Length)] := |fm40(true, f16, f19, globalState)| - p3.f13;
		var v170: multiset<bool> := multiset{!p3.f14};
		v169[safeIndex(91, v169.Length)] := if (false in v170) then v170[false] else p3.f13;
		var v171: seq<array<int>> := [v169, v169, v169, v169];
		var v172: array<array<int>> := new array<int>[24] [v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v169, v171[safeIndex(v169[safeIndex(91, v169.Length)], |v171|)], v169, v169, v169, if (f14) then v169 else v169];
		globalState.f10 := v172;
		f19 := f14 ==> !p0;
		r0 := f13;
		r1 := |v164| * (v169[safeIndex(91, v169.Length)] - v169[safeIndex(91, v169.Length)]);
	...
	method m4(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		for i0 := p1 to f13 {
			...
			if (({map v1 : int | v1 in v3 :: (v1 + i0) := (p1), v4} * v5) !! v5) {
				...
				f19 := v8[v2 := abs(-997)] >= v8;
				var v9: array<D8> := new D8[5](i1 => DC25(f19));
				var v10 := DC25(p3);
				v9[safeIndex(130, v9.Length)] := v10;
				v9[safeIndex(130, v9.Length)] := v10;
				var v11: array<int> := new int[6];
				v11[safeIndex(41, v11.Length)] := |v6|;
				v11[safeIndex(41, v11.Length)] := p2;
			} else {
				f19 := f19;
				var v12 := 'w';
				...
				var v17 := "bfhfeuec";
				var v18: seq<string> := [v17, v17];
				var v19 := DC14(p3, v18[safeIndex(p1, |v18|)], fm5(p3, "pvhxoefis", v16.f22, globalState), true, p3);
				var v20: array<string> := new seq<char>[9] [seq(abs(-736), i2  => (v12)), v19.cf19, v17, seq(abs(-605), i3  => (v12)), v17 + "ipmxp", v17, ("ndcqs")[safeIndex(f16, |"ndcqs"|) := v12], "kerrytb", v17 + v17];
				v20 := v20;
				...
				var v24: array<array<D7>> := new array<D7>[10] [v22, v22, v22, v22, v22, v22, v22, v22, v23[safeIndex(f13, |v23|)], v22];
				var v25 := DC61(v24);
				v24 := v25.cf108;
			}
			...
			var v31 := "n";
			var v32: map<T2, int> := map[v29 := safeModuloInt(|v30|, |v31|)];
			v32 := v32[v29 := v29.f13];
			globalState.f5, f19, globalState.f5 := v0.f20 - v27.f13, f14, v27.f12[safeIndex(0x338, |v27.f12|)];
		}
		var v33 := "vlhwbd";
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v35 := 'v';
			f19 := (v33[safeIndex(f16, |v33|) := v35] + (seq(abs(0x280), i5  => (v35))))[safeIndex(p0, |(v33[safeIndex(f16, |v33|) := v35] + (seq(abs(0x280), i5  => (v35))))|) := v35] == (seq(abs(578), i6  => (v35)));
			if (fm7(globalState)) {
				...
				v39[safeIndex(681, v39.Length)] := v34;
				var v40: array<map<bool, char>> := new map<bool, char>[18];
				var v41: map<bool, char> := map[!f19 := v35];
				v40[safeIndex(900, v40.Length)] := v41;
				var v42: map<int, map<array<bool>, D5>> := map[|"rfriwxyb"| := map[v36 := v37]];
				var v43: multiset<bool> := multiset{p3, p3};
				var v44: seq<string> := [v33, seq(abs(0x2c4), i8  => (v35)), v33, "wu", v33];
				var v45: multiset<array<bool>> := multiset{v36};
				var v46: map<int, D5> := map[|v44| := DC13(v45)];
				var v47: map<bool, seq<int>> := map[f19 := [|v43[p3 := abs(|v46|)]|]];
				v38, v39[safeIndex(681, v39.Length)], v40[safeIndex(900, v40.Length)] := if (f19) then v38 else (if (|v47| in v42) then v42[|v47|] else v38) + v38, v34 + v34, v41 + v41;
				...
				v48[safeIndex(671, v48.Length)] := v49 * v49;
				var v50: array<int> := new int[21];
				v50[safeIndex(35, v50.Length)] := f13;
				v36[safeIndex(812, v36.Length)] := false;
				v48[safeIndex(671, v48.Length)], v50[safeIndex(35, v50.Length)], v36[safeIndex(812, v36.Length)] := v49, --f13, f13 > 0x211;
				var v51: set<int> := {p1};
				var v52: map<int, int> := map[|(seq(abs(-0x294), i10  => (v35)))[safeIndex(|v51|, |(seq(abs(-0x294), i10  => (v35)))|) := v35]| := if (f19) then f13 else v50[safeIndex(35, v50.Length)]];
				r1, v52 := !false, v52;
				var v53: map<int, multiset<int>> := map[p1 := v48[safeIndex(671, v48.Length)]];
				var v54: seq<bool> := [p3];
				var v55: C9 := new C9(p0);
				var v56: C3 := new C3(f14, f16, f19, f12);
				var v57 := DC16(-0x311, p1, v54, |map[v55 := v56]|);
				var v58 := DC35({v57}, p2, v51);
				var v59: seq<multiset<bool>> := [multiset(v54), fm64(v58, fm0(0x2f0, !f19, v36[safeIndex(812, v36.Length)], globalState), globalState)];
				v53 := v53[|v59| := multiset{v55.f20}];
				var v60: map<bool, array<bool>> := map[v56.f24 := if (fm0(f12[safeIndex(v56.fm6(globalState), |f12|)], true, v56.f24, globalState)) then v36 else v36];
				var v61: map<int, bool> := map[-v50[safeIndex(35, v50.Length)] := fm7(globalState)];
				v60 := v60[(if (f16 in v61) then v61[f16] else v36[safeIndex(812, v36.Length)]) in fm53(f14, p1, globalState) := v36];
			} else {
				var v62 := new C8();
				globalState.f5 := p1;
				f19 := p3;
				...
				globalState.f5 := safeModuloInt(p1, if (p3 in v63) then v63[p3] else p0);
			}
			
			var v64 := DC2(f19, v35, p3);
			v64 := fm77(globalState).(cf4 := p3);
			var v65: array<array<int>> := new array<int>[10];
			var v66: array<int> := new int[4](i11 => safeDivisionInt(i11, |f12|));
			v65[safeIndex(838, v65.Length)] := v66;
			v65[safeIndex(838, v65.Length)] := new int[9](i12 => safeDivisionInt(i12, p1));
		}
			...
			decreases 100 - i13
		{
			...
			if (!((|(if (fm1(0x2b1, globalState) in v74) then v74[fm1(0x2b1, globalState)] else f12)| * |v33|) >= f13)) {
				...
				v78[safeIndex(784, v78.Length)] := p3;
				var v79: multiset<bool> := multiset{f19};
				v78[safeIndex(784, v78.Length)] := v79 !! multiset{p3};
				var v80: array<int> := new int[3];
				v80[safeIndex(858, v80.Length)] := |f12|;
				var v81: map<bool, string> := map[p3 := v33];
				var v82: seq<string> := [v33, v33];
				var v83: seq<string> := [v82[safeIndex(f16, |v82|)]];
				v80[safeIndex(858, v80.Length)] := |(if (f19 in v81) then v81[f19] else v82[safeIndex(|[f14]|, |v82|)])[safeIndex(f16, |(if (f19 in v81) then v81[f19] else v82[safeIndex(|[f14]|, |v82|)])|) := v73]|;
				var v84 := new C1(f13, 389 <= 0x2d2, f12, fm2(-p2, DC0(v80[safeIndex(858, v80.Length)]), p2, f19, globalState));
			} else {
				globalState.f5 := p1;
			...
			globalState.f5, f19, v96, globalState.f5 := -f16, (v33 + v33) < (v33 + v97[safeIndex(|"upkpgtgx"|, |v97|)]), v96, 0x158;
			var v98: array<string> := new string[27];
			v98[safeIndex(537, v98.Length)] := "ojijbut";
			v98[safeIndex(537, v98.Length)] := fm48(f16, globalState);
			var v99: multiset<int> := multiset{p2, f13};
			var v100: array<int> := new int[4] [-(f16 + |(seq(abs(0x13d), i16  => ('e')))|), |v98[safeIndex(537, v98.Length)]|, p2, (if (p1 in v99) then v99[p1] else p2) + p2];
			var v101: map<array<int>, bool> := map[v100 := !f14];
			var v102: array<bool> := new bool[25];
			v100[safeIndex(831, v100.Length)] := |{|v101|, |map[v102 := p2]|, |f12|}|;
			v100[safeIndex(831, v100.Length)] := p2;
		}
		if (f19) {
			var v103: array<bool> := new bool[9] [true, p3, p3, false, p3, f14, p3, p3, p3];
			var v104: map<array<bool>, string> := map[v103 := seq(abs(580), i17  => ('n'))];
			v104 := v104[v103 := v33];
			globalState.f5 := f13 + f16;
			var v105: seq<bool> := [f19, f19, f14];
			var v106: map<seq<bool>, int> := map[v105[safeIndex(p1, |v105|) := f14] := 0x2ad];
			globalState.f5 := if (f14) then safeDivisionInt(f13, 0x1ca) else safeModuloInt(|v106|, f13);
			globalState.f5 := -0x3d;
			globalState.f5 := |(seq(abs(0xc9), i18  => (if (f19) then 'l' else 'o')))|;
		} else {
			...
			var v122: map<bool, bool> := map[v120[false := abs(|v121|)] != v120 := f14];
			v122 := v122[!(0x105 < -p1) := p3];
		}
		
		var v123: array<map<D18, int>> := new map<D18, int>[6];
		v123[safeIndex(936, v123.Length)] := map v124 : D18 | v124 in (seq(abs(977), i19  => (DC49(multiset{f13})))) :: (v124) := (f16);
		var v125 := DC7();
		v123[safeIndex(936, v123.Length)] := match v125 {
	...
	method m9(globalState: GlobalState) returns (r0: array<int>, r1: int, r2: int) {
		...
		var v2: seq<map<int, bool>> := [v1[safeIndex(|[fm1(|v0|, globalState)]|, |v1|)]];
		var v3 := new C0(false, multiset(v2), f12);
		var v4: array<array<bool>> := new array<bool>[26];
		var v5: array<bool> := new bool[1];
		v4[safeIndex(343, v4.Length)] := v5;
		v4[safeIndex(343, v4.Length)] := v5;
		if (safeDivisionInt(f13, f13) <= 0x39c) {
			...
			v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)] := if (v3.f25) then v3.f25 else fm0(f13, f14, true, globalState);
			v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)] := f19;
			if (f14) {
				var v9: multiset<int> := multiset{0x2ec};
				var v10: set<int> := {-f13, |v9|, f13};
				v10 := set v11 : int | v11 in v0 :: (safeModuloInt(v11, |{map[-0xd0 := true], map[46 := true]}|));
				var v12: seq<bool> := [v3.f25, v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)], f14];
				var v13: map<bool, char> := map[v12[safeIndex(|v9|, |v12|)] := 'g'];
				var v14: array<int> := new int[19];
				var v15: map<map<bool, char>, array<int>> := map[v13 := v14];
				var v16 := 'g';
				v15 := v15[map[v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)] := v16] := v14];
				globalState.f9 := v5;
				var v17 := "bfngub";
				var v18: seq<string> := [v17, v17];
				var v19: multiset<string> := multiset{v17, v18[safeIndex(f13, |v18|)], v17, v17, seq(abs(0x1cb), i0  => (v16))};
				v3.f25 := (v19 * v19) > v19;
				v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)] := f14;
			} else {
				var v20 := new C0(f19, multiset{v0, fm46(v3.f25, v3.f25, f16, globalState), v0, v0}, f12);
				var v21 := "cpsxduvas";
				var v22: seq<bool> := [v20.f25, v4[safeIndex(343, v4.Length)][safeIndex(378, v4[safeIndex(343, v4.Length)].Length)]];
				var v23: map<string, bool> := map[v21 + "ovxin" := v22[safeIndex(f16, |v22|)]];
				r2 := -|v23|;
				v3.f25 := v3.f25;
				var v24 := DC58();
				v24 := v24;
			...
			v28[safeIndex(429, v28.Length)] := v29;
			v28[safeIndex(429, v28.Length)] := v29;
			v28[safeIndex(429, v28.Length)] := v29;
			var v30: multiset<int> := multiset{f16};
			v29[safeIndex(668, v29.Length)] := -(if (f13 in v30) then v30[f13] else f16);
			var v31 := "lxpvvh";
			var v32 := 'v';
			var v33: map<string, int> := map[v31[safeIndex(f13, |v31|) := v32] := -f16];
			var v34: seq<string> := ["hjnbi", v31, seq(abs(-400), i2  => (v32))];
			var v35: array<string> := new string[20] [v31, v31, if (true) then "qqeg" else v31, v31, v31, v31, v31 + v31, "byupqit", seq(abs(745), i1  => ('n')), v31, v31, v31, "qu" + v31, v31, v31, fm48(f16, globalState), fm48(-|v33|, globalState) + v34[safeIndex(f16, |v34|)], v31 + v31, v31, v31];
			v35[safeIndex(410, v35.Length)] := (fm48(v3.fm45(globalState), globalState))[safeIndex(3, |fm48(v3.fm45(globalState), globalState)|) := v32];
			v29[safeIndex(668, v29.Length)], v35[safeIndex(410, v35.Length)], v3.f25 := -f13, v31, v3.f25;
			var v36 := DC49(v30 - v30);
			v36 := fm79(v3.f25, globalState);
			v29[safeIndex(668, v29.Length)] := safeDivisionInt(v29[safeIndex(668, v29.Length)], 0x3d);
		}
		...
		if (!(v37 < (v37 + "nrbbi"))) {
			...
			v40[safeIndex(676, v40.Length)] := if (v3.f25) then f13 else 292;
			...
			var v49: set<D5> := {v48};
			var v51: set<int> := {f16};
			var v52 := DC35(v49, |{|(map v50 : multiset<bool> | v50 in (seq(abs(241), i5  => (multiset(v47)))) :: (v50) := (v3.f25))|, f16, f13}|, v51);
			var v53: seq<set<int>> := [v52.cf65];
			v43[safeIndex(157, v43.Length)] := v53 + v53;
			var v54: set<char> := {v39, v39};
			var v55: set<set<char>> := {v54, {v39} * v54};
			var v56: seq<array<int>> := [v40];
			r2, r2, v40[safeIndex(676, v40.Length)], v43[safeIndex(157, v43.Length)], v55 := safeModuloInt(-0x339, |v38|) * (f16 * |v56|), f13, f16, (if (v3.f25) then [v51, v51, v51] else [v51]) + v53, v55;
		} else {
			if (fm0(f12[safeIndex(f13, |f12|)], f14, v3.f25, globalState)) {
				var v57: array<int> := new int[2](i6 => i6 + |map[v3.f25 := |multiset{f13, f13}|]|);
				v57[safeIndex(310, v57.Length)] := f13;
				v4[safeIndex(343, v4.Length)][safeIndex(369, v4[safeIndex(343, v4.Length)].Length)] := f19;
				...
				v57[safeIndex(310, v57.Length)], v4[safeIndex(343, v4.Length)][safeIndex(369, v4[safeIndex(343, v4.Length)].Length)], v76, f19 := 0x7b, !(if (v79 !! v79) then !(v58 != fm50(if (f14 in v80) then v80[f14] else f19, v3.f25, globalState)) else v74.fm9(v3.f25, globalState)), v76, v68.f14;
				v3.f25 := v3.f25;
				f19 := v70.f14;
				var v81: seq<seq<int>> := [f12, f12, [v70.f13, v70.f12[safeIndex(|v58|, |v70.f12|)]], v70.f12, [v68.f13]];
				var v82 := DC19(v66, v0, v68.f13);
				var v83 := DC19(v66, map[v70.f13 := v3.f25], v82.cf34);
				var v84 := new C6(0x281, multiset(v81[safeIndex(f16, |v81|)] + [v68.f13]), v69, f13, v70.f14, [v82.cf34]);
				...
				v87[safeIndex(594, v87.Length)] := |v88| + f12[safeIndex(|v89|, |f12|)];
				var v90: C8 := new C8();
				var v91 := DC55(v3.f25);
				...
				v3.f25, v87[safeIndex(594, v87.Length)], v90, v87 := v92 !! v92, f16, v93[safeIndex(safeDivisionInt(f16, |v94|), |v93|)], v87;
				var v95 := new C9(f13);
				var v96: map<int, int> := map[safeModuloInt(f12[safeIndex(-0x228, |f12|)], |(seq(abs(476), i7  => ('p')))|) := v95.f20];
				v96 := v96[f16 * v87[safeIndex(594, v87.Length)] := f13];
			}
			...
			v100[safeIndex(723, v100.Length)] := f13;
			v100[safeIndex(723, v100.Length)] := |(if (if (v3.f25) then v3.f25 else f19) then v0 + v0 else v0)|;
			var v101 := 'y';
			...
			decreases 100 - i8
		{
			...
			var v115: array<array<char>> := new array<char>[24] [v111, v111, v111, if (f16 in v112) then v112[f16] else v111, if (v3.f25 in v113) then v113[v3.f25] else v111, v111, v114[safeIndex(f13, |v114|)], v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111, v111];
			v115[safeIndex(719, v115.Length)] := v111;
			var v116: seq<bool> := [false];
			v115[safeIndex(719, v115.Length)] := if (f14) then v114[safeIndex(|v116|, |v114|)] else v111;
		...
		var v122: array<int> := new int[15] [safeModuloInt(|v118|, f16), |v37|, v3.fm45(globalState), f13 + f13, f16, if (f14) then |fm48(f13, globalState)| else f13, f16, f13, f13, |([f14, f14] + v119)|, |v119[safeIndex(f13, |v119|) := !v3.f25]|, f16, |v121[601 := v120]| * |map[v3.f25 := |v37|]|, -f16, f13 + f16];
		r0 := v122;
		r1 := 0x2e8 + safeModuloInt(f13, |v37|);
		...
		r2 := safeDivisionInt(-|(v37 + v37)|, |v126[safeIndex(--f16, |v126|)]|);
	}
}
...
class C11 extends T2 {
	...
	function fm6(globalState: GlobalState): int {
		safeDivisionInt(|multiset([f14, f17])|, |"jvmbaanhk"|) - -f13
	}
	function fm7(globalState: GlobalState): bool {
	...
	method m1(globalState: GlobalState) {
		...
		match (DC12(v0)) {
			...
			case DC12(cf16) =>
				...
				v13[safeIndex(798, v13.Length)] := f13 + fm6(globalState);
				var v14 := 'd';
				var v15: set<char> := {v14, v14};
				var v16: map<set<char>, int> := map[v15 := f13];
				globalState.f5, globalState.f5, v13[safeIndex(798, v13.Length)] := f13, safeModuloInt(safeModuloInt(if (v15 in v16) then v16[v15] else f13, f13), f13), safeModuloInt(f13, 0x3dd);
				var v17 := "hwugcr";
				...
				v20[safeIndex(595, v20.Length)] := v19;
				var v21: T3 := new C2(|v17|, v13[safeIndex(798, v13.Length)], f17, f12, f15);
				var v22: map<seq<bool>, T3> := map[v11 := v21];
				var v23 := DC2(v21.f14, v14, f18);
				var v24: map<array<bool>, D1> := map[if (f17) then v7 else v7 := v23];
				var v25: map<char, string> := map[v14 := seq(abs(0xc7), i2  => (v14))];
				v20[safeIndex(595, v20.Length)], v22, globalState.f5, v24 := (v19 + v19) + map[v7 := v21.f16], v22, v21.f16 - |(v25 + v25)|, v24 + v24;
		}
			...
			decreases 100 - i3
		{
			...
			v26[safeIndex(624, v26.Length)] := f13;
			v26[safeIndex(624, v26.Length)] := |(seq(abs(0x35f), i5  => ('j')))| * (if (f17) then 0x1db else f13);
			v26[safeIndex(624, v26.Length)] := f13;
			var v27 := DC28('i');
			var v28 := 'k';
			match (v27.(cf49 := v28)) {
				case DC28(cf49) =>
					...
					var v31 := "vfxmqptux";
					v30[safeIndex(32, v30.Length)] := v31;
					var v32: array<D18> := new D18[9](i6 => DC51([map[v29.f19 := f13], map[f14 := v26[safeIndex(624, v26.Length)]]], !!f14, DC18(multiset{f17, f17, f17, v29.f19})));
					...
					v32[safeIndex(583, v32.Length)] := v37;
					v29.f19, v30[safeIndex(32, v30.Length)], v32[safeIndex(583, v32.Length)], v31 := (-f13 + f13) == f13, "tqhdohgp" + v31, fm80(f18, globalState), v31;
					v26[safeIndex(624, v26.Length)] := -v26[safeIndex(624, v26.Length)];
					var v38: array<bool> := new bool[28];
					globalState.f9 := if (false) then v38 else v38;
				case DC27(cf48) =>
					var v39: map<int, int> := map[f13 := v26[safeIndex(624, v26.Length)]];
					var v40: seq<bool> := [!true];
					v39 := v39[v26[safeIndex(624, v26.Length)] := |v40| + f13];
					v26[safeIndex(624, v26.Length)] := f13;
					var v41 := false;
					v41 := f13 >= -f13;
					m0(f14, globalState);
				case DC29(cf50) =>
					...
					var v47 := new C6(f13, v46 - multiset{f13}, f15, |(seq(abs(0x3a3), i7  => (v28)))|, v44, f12);
			}
			
			var v48 := false;
			var v49 := "nh";
			var v50: set<int> := {f13};
			var v51: multiset<int> := multiset{f13, v26[safeIndex(624, v26.Length)], |v50|};
		...
		v55[safeIndex(128, v55.Length)] := f13;
		var v57: set<bool> := {f18};
		var v58: seq<set<bool>> := [v57];
		var v59: map<bool, bool> := map[f14 := f17];
		v54, v56, v55[safeIndex(128, v55.Length)], globalState.f5, v54 := v58[safeIndex(-f13, |v58|)] !! v57, v56 * v56, (if (if (v54 in v59) then v59[v54] else v54) then f13 else f12[safeIndex(|"njkbrbqps"|, |f12|)]) - |"n"|, 0x1f9, v54;
		v53[safeIndex(103, v53.Length)] := v54;
		v53[safeIndex(103, v53.Length)] := f14;
		globalState.f9 := v53;
	}
	method m2(p0: bool, p1: int, p2: D0, p3: bool, globalState: GlobalState) returns (r0: int) {
		var i0 := 0;
			...
			decreases 100 - i0
		{
			...
			v2 := v2[p3 := f14];
			var v3: array<string> := new string[16] [fm48(p1, globalState), if (!f17) then v0 else v0, "rwm", v0[safeIndex(-155, |v0|) := 'u'], seq(abs(0x28e), i1  => ('o')), v0, seq(abs(0x318), i2  => ('f')), v0, v0, v0, v0, seq(abs(160), i3  => ('l')), v0, v0, v0, v0 + v0];
			v3[safeIndex(837, v3.Length)] := v0 + v0;
			var v4 := 't';
			v3[safeIndex(837, v3.Length)] := if (true) then if (v1) then v0 else v0[safeIndex(-f13, |v0|) := v4] else v0;
		}
		if (f18) {
			var v5 := 'j';
			var v6: map<int, char> := map[p1 := v5];
			var v7: seq<char> := [v5, v5, v5];
			v6 := v6[|f12| := v7[safeIndex(-0x1cb, |v7|)]];
			...
			if (f17) {
				...
				var v13 := true;
				v13 := f14;
				var v15: T3 := new C2(p1, |(set v14 : int | (0x1d1 <= v14) && (v14 < 0x26e) :: (safeModuloInt(v14, |map[p0 := p0]|)))|, f18, f12, f15);
				...
				var v29: array<int> := new int[22] [if (!f14) then 0xd else p1, safeModuloInt(v15.f13, |v18.f23|), |map[v5 := f13]| + |{p1}|, f13 - f13, if (f17) then v15.f16 else f13, if (v5 in v11) then v11[v5] else v15.f16, safeDivisionInt(0x2ee, f13), fm2(v15.f16, p2, v15.f13, f17, globalState), 0x202 + p1, |v7|, v15.f13, |v21|, f13, p1, if (v22 in v25) then v25[v22] else -774, f13, v15.f16, p1, p1, fm8(v27, [v13, f18], v28, fm48(|"ebgcbxsk"|, globalState), globalState), v15.f13, v15.f16 - f13];
				v29[safeIndex(595, v29.Length)] := safeDivisionInt(|map[f13 := p0]|, -v15.f16);
				var v30 := DC7();
				v7, v19, v29[safeIndex(595, v29.Length)], v30 := "embxarju", v19, v15.f16, v30;
				var v31: multiset<array<int>> := multiset{v23};
				v26, v13, v5, v31 := v26, (v22 - multiset{f17, f14, p3}) >= multiset(v26[safeIndex(p1, |v26|) := p3]), v5, v31;
			} else {
				var v32: array<int> := new int[21](i4 => i4 - |multiset{f13}|);
				v32[safeIndex(583, v32.Length)] := p1;
				v32[safeIndex(583, v32.Length)] := fm6(globalState);
				var v33: map<char, int> := map[v5 := p1];
				var v34: set<map<char, int>> := {v33, if (f17) then (map[v5 := 0x271])[v5 := v32[safeIndex(583, v32.Length)]] else v33, v33 + v33};
				var v35: array<multiset<bool>> := new multiset<bool>[24](i5 => multiset{p0});
				var v36: seq<array<multiset<bool>>> := [v35, v35, v35];
				v34, v32[safeIndex(583, v32.Length)], v35 := v34, p1, v36[safeIndex(p1, |v36|)];
				globalState.f5 := v32[safeIndex(583, v32.Length)];
				...
				var v42 := DC9(v41);
				var v43: set<D3> := {v42};
				v38[safeIndex(807, v38.Length)] := if (f17) then v43 else {v42};
				var v44 := true;
				var v45: seq<set<D3>> := [v43];
				var v46: map<char, bool> := map[v5 := f14];
				var v47: seq<bool> := [f17, if (v5 in v46) then v46[v5] else p0, f14];
				var v48: set<bool> := {v47[safeIndex(f13, |v47|)]};
				var v49 := DC43(-0x264, p0, f13, v48, p1);
				var v50: map<bool, bool> := map[true := !!f18];
				r0, v38[safeIndex(807, v38.Length)], v44, globalState.f5, globalState.f5 := p1, v43 * v45[safeIndex(v49.cf85, |v45|)], (|v50[f17 := p0]| != f13) || true, fm6(globalState), v32[safeIndex(583, v32.Length)];
			}
			...
			v52[safeIndex(572, v52.Length)] := v54;
			v52[safeIndex(572, v52.Length)] := v54;
			var v55 := 'r';
			var v56: seq<char> := [v55, v55, v55, v55];
			var v57: map<int, seq<char>> := map[f13 := ([v55])[safeIndex(f13, |[v55]|) := v55]];
		...
		v66[safeIndex(102, v66.Length)] := (if (f13 in v67) then v67[f13] else 9) < f13;
		var v68 := "j";
		var v69: set<int> := {|v68|, p1};
		var v71: map<bool, bool> := map[p3 := p3];
		v65, globalState.f5, r0, v66[safeIndex(102, v66.Length)] := (if (f14) then v69 else {f13, f13, p1, f13}) !! (v69 + (set v70 : int | (-360 <= v70) && (v70 < 0x7e) :: (v70 * p1))), p1, p1, f17 !in v71;
		if (if (v66[safeIndex(102, v66.Length)]) then !p3 else p0) {
			var v72: array<array<int>> := new array<int>[11];
			var v73: array<int> := new int[14];
			var v74: seq<array<int>> := [v73, v73, v73];
			v72[safeIndex(280, v72.Length)] := v74[safeIndex(262, |v74|)];
			v72[safeIndex(280, v72.Length)] := v73;
			if (v68 < v68) {
				v66[safeIndex(102, v66.Length)] := multiset(f12) !! multiset{p1, |(fm20(f17, globalState))[v66[safeIndex(102, v66.Length)] := p1]|, p1};
				var v75: C1 := new C1(|f12|, f17, f12, p1);
				var v76: map<bool, int> := map[f17 := 235];
				var v77: set<bool> := {v66[safeIndex(102, v66.Length)]};
				v75, v65, v76 := v75, p3, v76 + map[v66[safeIndex(102, v66.Length)] := |v77|];
				globalState.f5 := |f12| + f13;
				var v78: multiset<int> := multiset{f13, f13};
				v72[safeIndex(280, v72.Length)][safeIndex(862, v72[safeIndex(280, v72.Length)].Length)] := |{|v78|, p1}| + p1;
				var v79: multiset<bool> := multiset{!true, fm7(globalState)};
				v72[safeIndex(280, v72.Length)][safeIndex(862, v72[safeIndex(280, v72.Length)].Length)] := safeDivisionInt(if (v66[safeIndex(102, v66.Length)] in v79) then v79[v66[safeIndex(102, v66.Length)]] else p1, f13);
				var v80: C6 := new C6(v72[safeIndex(280, v72.Length)][safeIndex(862, v72[safeIndex(280, v72.Length)].Length)], v78, f15, v72[safeIndex(280, v72.Length)][safeIndex(862, v72[safeIndex(280, v72.Length)].Length)], v65, f12);
				var v81: set<C6> := {v80};
				var v82: seq<map<bool, bool>> := [map[false := f17], v71, v71, v71, map[v65 := !v66[safeIndex(102, v66.Length)]]];
				var v83: map<set<C6>, seq<map<bool, bool>>> := map[v81 - v81 := v82 + v82];
				var v84 := DC64(v81);
				v83 := v83[if (f18) then v84.cf110 else v81 := v82];
			} else {
				var v85 := DC14(true, v68, f13, f18, v66[safeIndex(102, v66.Length)]);
				...
				var v92: map<bool, int> := map[v91[safeIndex(0x22d, |v91|)] := p1];
				var v93: multiset<map<bool, int>> := multiset{fm20(false, globalState), v92};
				var v94: set<bool> := {true};
				var v95: array<map<array<int>, int>> := new map<array<int>, int>[11] [v89 + map[v73 := |(seq(abs(0x271), i7  => ('f')))[safeIndex(f13, |(seq(abs(0x271), i7  => ('f')))|) := v90]|], map[v72[safeIndex(280, v72.Length)] := |v93|], v89, v89, v89, v89, map[v72[safeIndex(280, v72.Length)] := |{seq(abs(614), i8  => (v90))}|], v89, v89, v89[v72[safeIndex(280, v72.Length)] := |v94|] + v89, v89 + v89];
				v95[safeIndex(494, v95.Length)] := v89;
				var v96 := DC65(v89);
				v66[safeIndex(102, v66.Length)], v88, v95[safeIndex(494, v95.Length)] := |v68| <= p1, v88[v66[safeIndex(102, v66.Length)] := v92] + v88, v96.cf111;
				...
				var v101 := DC31(634, v66, v66[safeIndex(102, v66.Length)], p0, |v100|);
				var v102: map<T0, bool> := map[v99 := v101.cf55];
				var v103: seq<map<T0, bool>> := [v102[v99 := !p3], v102, v102, v102];
				var v104: seq<map<T0, bool>> := [v103[safeIndex(f13, |v103|)]];
				var v105: T3 := new C2(if (false in v92) then v92[false] else |v91|, f13, v65, seq(abs(0x1a), i9  => (f13)), f15);
				...
				v67 := v67[safeDivisionInt(v105.f16, -v105.f13) := |(v91 + v91)|];
			}
			...
			if (!!f17) {
				...
				r0, globalState.f0, v65, v66[safeIndex(102, v66.Length)] := |v67| * |v68|, fm1(p1, globalState), v111 !! v111, f17;
				v66[safeIndex(102, v66.Length)] := fm0(f13 + p1, f14, !v66[safeIndex(102, v66.Length)], globalState);
				var v112: seq<bool> := [v66[safeIndex(102, v66.Length)]];
				var v113 := DC49(multiset{|v112|, p1});
				var v114: multiset<multiset<int>> := multiset{v113.cf92, v109};
				var v115 := DC31(if (p0) then p1 else f13, v66, false, v68[safeIndex(p1, |v68|)] !in v68, |v114|);
				var v116: seq<seq<int>> := [fm56('c', fm7(globalState), f14, globalState), [f13, 0x6d]];
				var v117: map<int, seq<int>> := map[p1 := f12];
				var v118: array<seq<int>> := new seq<int>[21] [seq(abs(994), i10  => (f13)), f12 + f12, f12, f12, f12, f12 + f12, f12, f12, f12 + (seq(abs(0x22d), i11  => (p1))), [f13, 0x19f], f12, f12, seq(abs(0x36b), i12  => (p1)), f12 + f12, v116[safeIndex(fm2(f13, p2, p1, p0, globalState), |v116|)], f12, f12, [|(seq(abs(509), i13  => (f13)))|, p1], (seq(abs(-0x6c), i14  => (f13))) + f12, if (f13 in v117) then v117[f13] else f12, [f13, p1]];
				v118[safeIndex(628, v118.Length)] := f12;
				var v119: map<bool, int> := map[v66[safeIndex(102, v66.Length)] := fm5(v65, v68, v109, globalState)];
				v115, v110, v118[safeIndex(628, v118.Length)], v119, globalState.f5 := v115.(cf55 := f18, cf56 := p1), if (!f18) then if (f17) then v110 else v110 else 'c', f12, (map[true := f13] + v119) + fm59(f18, globalState), fm5(!p3, v68, v109, globalState);
				v68 := v68 + v68;
				var v120: array<char> := new char[10];
				var v121 := DC69(v120);
				var v122: seq<array<char>> := [v120, v120, if (v66[safeIndex(102, v66.Length)]) then v120 else v121.cf118, v120, v120];
				var v123: map<int, seq<array<char>>> := map[f13 := v122];
				v122 := v122 + (if (f13 in v123) then v123[f13] else v122);
			} else {
				var v124: seq<bool> := [!p0, p0];
				var v125 := new C7((seq(abs(483), i15  => (f13))) + f12, f15, |v124| + p1, v66[safeIndex(102, v66.Length)]);
				globalState.f5 := f13;
				var v126: seq<array<bool>> := [v66];
				globalState.f5 := (|v126| - 0x16b) * |v68|;
				var v127: seq<int> := [p1, 0x20c - -f13, |f12|];
				v127 := v127;
				var v128: C3 := new C3(p0, f13, v66[safeIndex(102, v66.Length)], f12);
				var v129: map<int, C3> := map[f13 := v128];
				var v130 := new C6(safeModuloInt(|v129|, p1), v109, f15, f13, f17, f12[safeIndex(f13, |f12|) := 0x348]);
			}
			...
			match (v134) {
				case DC62() =>
					...
					v65 := (if (v66[safeIndex(102, v66.Length)] in v71) then v71[v66[safeIndex(102, v66.Length)]] else v66[safeIndex(102, v66.Length)]) <==> f14;
					var v142: multiset<map<int, bool>> := multiset{v136, v136, v136};
					var v143 := DC33(v142);
					v143 := DC33(v142);
					var v144: array<int> := new int[21];
					v144[safeIndex(427, v144.Length)] := safeModuloInt(v137.f21, p1);
					v144[safeIndex(427, v144.Length)] := safeModuloInt(-(|v136| - p1), p1);
				case DC61(cf108) =>
					...
					var v150: seq<C6> := [v149[safeIndex(8, |v149|)], v148, v148, v148, v148];
					v66[safeIndex(102, v66.Length)] := |v145[safeIndex(f13, |v145|)]| <= |v150|;
					var v151: set<bool> := {f18};
					var v152 := new C4(f13, v151 > fm67(p1, v148.f21, globalState), seq(abs(0x201), i16  => (f13)));
					globalState.f5 := v152.fm5(!f17, seq(abs(0x42), i17  => (v131)), (multiset{v148.f21, f13})[|v71| := abs(p1)], globalState);
					globalState.f5 := safeModuloInt(-v148.f21, p1);
			}
			
			v66[safeIndex(102, v66.Length)] := f17 || p0;
			...
			globalState.f5 := safeModuloInt(fm6(globalState), p1 + |(if (|v68| in v156) then v156[|v68|] else v157)|);
		}
			...
			decreases 100 - i18
		{
			...
			var v159: array<int> := new int[27] [p1, |v71|, p1, -p1, f13, p1, p1, 0x28c, f13, |"vccmq"|, f13, f13, p1, p1, f13, f13, |v69|, f13, f13, 0x2f0, fm5(!v66[safeIndex(102, v66.Length)], v68, multiset{p1}, globalState), f13, |v158|, f13, p1, f13, p1];
			...
			match (v161) {
				case DC66() =>
					...
					var v164: multiset<char> := multiset{v68[safeIndex(p1, |v68|)], 'p', 'a'};
					v164, v68, r0 := v164, seq(abs(443), i19  => (if (p3) then 'c' else 'p')), p1 - (if (f17) then 926 else f13);
					v65 := f14 || f18;
				case DC67(cf112, cf113, cf114) =>
					...
					var v168 := DC14(v65, seq(abs(0x1f9), i20  => ('p')), cf114, true, p0);
					...
					v171 := (v171[!p3 := abs(0x211)] + v171) + v172[safeIndex(cf114, |v172|)];
				...
				case DC68(cf115, cf116, cf117) =>
					...
					v66[safeIndex(102, v66.Length)] := f18;
					v66[safeIndex(102, v66.Length)] := p3;
					var v176: multiset<seq<bool>> := multiset{fm50(fm0(-p1, f14, p3, globalState), f17, globalState)};
					v176 := v176;
				case DC65(cf111) =>
					var v177 := new C3(v66[safeIndex(102, v66.Length)], p1, p0, f12);
					v68 := v68;
			...
			var v180: multiset<int> := multiset{f13, f13, p1, |v179[|v68| := fm9(v66[safeIndex(102, v66.Length)], globalState)]|};
			if (!(|v71| > |v180[f13 := abs(|f12|)]|)) {
				var v181: array<array<bool>> := new array<bool>[15];
				v181[safeIndex(133, v181.Length)] := v66;
				v181[safeIndex(133, v181.Length)] := v66;
				globalState.f5 := f13;
				m0(v65, globalState);
				v65 := false;
				...
				var v185 := DC48(v184[safeIndex(|v68|, |v184|)]);
				v185 := v185;
			} else {
				...
				globalState.f5 := -f13;
				v65 := v66[safeIndex(102, v66.Length)];
				var v188: seq<array<bool>> := [v66];
				var v189: map<array<bool>, int> := map[v66 := p1];
				var v190 := DC31(f13, v188[safeIndex(f13, |v188|)], fm0(p1, p0, v66[safeIndex(102, v66.Length)], globalState), v65, |v189|);
				...
				var v195: map<seq<bool>, array<int>> := map[v158[safeIndex(f13, |v158|) := v66[safeIndex(102, v66.Length)]] := v159];
				var v196: set<bool> := {f17};
				globalState.f5 := safeDivisionInt(if (f18) then |v195| else |v196|, f13);
			}
			
			v159[safeIndex(789, v159.Length)] := p1;
			var v197: array<seq<bool>> := new seq<bool>[20];
			v197[safeIndex(204, v197.Length)] := v158;
			v159[safeIndex(789, v159.Length)], v197[safeIndex(204, v197.Length)], v65 := -safeDivisionInt(0xa7, 0x343), v158 + v158, |v68| == p1;
...
class C12 extends T3, T1 {
	...
	function fm11(globalState: GlobalState): int {
		|(match DC3(f14, true) {
			case DC2(cf2, cf3, cf4) => if (cf2) then "yngkbm" else seq(abs(-0x329), i0  => ('f'))
			case DC3(cf5, cf6) => "mllnw"
			case DC4(cf7, cf8, cf9) => "njqc"
			case DC1(cf1) => (seq(abs(0x2b5), i1  => ('w'))) + (seq(abs(-0xfb), i2  => ('y')))
			case DC5(cf10) => "ll"
		})|
	}
	function fm6(globalState: GlobalState): int {
		f12[safeIndex(f13, |f12|)]
	}
	function fm7(globalState: GlobalState): bool {
		!(f12 != (f12 + f12))
	}
	function fm4(p0: set<int>, globalState: GlobalState): int {
		match DC8(DC7()) {
			case DC7() => safeModuloInt(|["xnmtaxosn"]|, f16)
			case DC6(cf11) => |((seq(abs(0xca), i0  => ('h'))) + "s")|
			case DC8(cf12) => f13 - 0x18b
		}
	}
	function fm5(p0: bool, p1: string, p2: multiset<int>, globalState: GlobalState): int {
		-(f16 - safeModuloInt(-f13, f16))
	}
	...
	method m3(p0: bool, p1: map<array<int>, seq<bool>>, p2: bool, p3: T2, globalState: GlobalState) returns (r0: int, r1: int, r2: set<int>, r3: char) {
		...
		v0[safeIndex(233, v0.Length)] := v1;
		var v2: seq<multiset<int>> := [v1, v1, v1[f13 := abs(--f16)]];
		v0[safeIndex(233, v0.Length)] := v2[safeIndex(p3.f13, |v2|)];
		var v3: map<bool, bool> := map[!p3.f14 := p2];
		var v4: map<int, int> := map[f16 := |v3|];
		globalState.f5 := -safeModuloInt(f16, -|v4| - f13);
		var v5 := true;
		var v6 := 'r';
		var v7: map<seq<D2>, char> := map[seq(abs(0x118), i0  => (DC7())) := v6];
		var v8: array<map<int, int>> := new map<int, int>[3];
		v8[safeIndex(139, v8.Length)] := v4;
		var v9: map<int, bool> := map[f13 := p3.f14];
		var v10: map<bool, map<int, bool>> := map[v5 := v9];
		var v11: seq<map<int, int>> := [v4];
		var v12 := DC7();
		globalState.f5, v5, v7, v5, v8[safeIndex(139, v8.Length)] := f12[safeIndex(f13, |f12|)], fm0(|v10[p3.f14 := v9]|, p0 ==> p0, p2, globalState), (v7 + (fm16(globalState)).cf13)[(seq(abs(0x1c3), i1  => (DC7())))[safeIndex(|v11|, |(seq(abs(0x1c3), i1  => (DC7())))|) := v12] := v6], p2, v4;
		if (!p3.fm9(!p2 ==> p3.f14, globalState)) {
			var v13 := "bqmhoa";
			globalState.f5 := |v13| - safeModuloInt(|v13|, p3.f13);
			var v14 := DC10({p2, p2, p2});
			var v15: map<bool, set<bool>> := map[fm7(globalState) := v14.cf14];
			var v16: set<bool> := {p0, v5, p2};
			globalState.f5 := -safeDivisionInt(safeModuloInt(-f16, f16), |(if (p3.f14 in v15) then v15[p3.f14] else v16)|);
			if (|(seq(abs(0x2dd), i2  => (-397)))| > (if (f13 in v8[safeIndex(139, v8.Length)]) then v8[safeIndex(139, v8.Length)][f13] else f13)) {
				...
				v24[safeIndex(501, v24.Length)] := f16;
				var v25: set<int> := {f13};
				v23, v4, r2, v24[safeIndex(501, v24.Length)] := v23, map[f16 := p3.f13], v25, safeModuloInt(safeDivisionInt(|p3.f12|, |v4|), safeModuloInt(|v25|, p3.f13));
				v5 := v1 >= fm17(p3.f14, v24[safeIndex(501, v24.Length)], globalState);
				var v26: seq<bool> := [p3.f14];
				var v27 := new C9(safeDivisionInt(|map[v26[safeIndex(|v3|, |v26|)] := v6]|, |multiset{v6}|));
				v5 := p3.f13 == |(v26[safeIndex(-|[-490, 0x165]|, |v26|) := p2] + fm50(true, false, globalState))|;
				var v28: array<bool> := new bool[23];
				v28[safeIndex(962, v28.Length)] := p3.f14;
				var v31: seq<set<int>> := [v25, v25, set v30 : int | (0xc2 <= v30) && (v30 < -0x172) :: (safeDivisionInt(v30, p3.f13)), v25];
				v28[safeIndex(962, v28.Length)], v5 := p3.f14, v25 !in (map v29 : set<int> | v29 in v31 :: (v29) := (p2));
			} else {
				var v32 := DC46(v5, v6);
				var v33: array<char> := new char[28] [v32.cf89, v13[safeIndex(|v13[safeIndex(f16, |v13|) := v6]|, |v13|)], v6, if (if (p3.fm7(globalState) in v3) then v3[p3.fm7(globalState)] else p2) then v6 else v6, v6, v6, fm1(-|p3.f12|, globalState), v6, v6, v6, v6, v6, v6, 'i', 'k', v6, v6, v6, v6, v6, v6, v6, v6, 'i', v6, v6, v6, v6];
				v33[safeIndex(733, v33.Length)] := if (p0) then v6 else v6;
				v33[safeIndex(733, v33.Length)] := v6;
				globalState.f5 := f13;
				var v34: array<bool> := new bool[19](i3 => f14);
				var v35: seq<array<bool>> := [v34, v34, v34, v34, v34];
				var v36 := new C5(v35, p3.f12 + p3.f12);
				var v37: map<char, bool> := map[v33[safeIndex(733, v33.Length)] := !!true];
				v37 := v37[v6 := p3.f14];
				var v38 := DC40(|v8[safeIndex(139, v8.Length)]|, p2, p3.f13);
			...
			var v40: array<int> := new int[1](i4 => safeModuloInt(i4, p3.f13));
			v40[safeIndex(259, v40.Length)] := f16;
			v40[safeIndex(259, v40.Length)] := (if (v5 in v39) then v39[v5] else f13) + -f16;
		} else {
			var v41: multiset<bool> := multiset{true};
			var v42: map<char, multiset<bool>> := map['d' := v41[p3.f14 := abs(f16)]];
			...
			match (v43) {
				case DC19(cf32, cf33, cf34) =>
					...
					var v47: array<array<bool>> := new array<bool>[28] [v44, v44, v45[safeIndex(if (!p2 in v46) then v46[!p2] else |"m"|, |v45|)], v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44, v44];
					var v48: seq<array<array<bool>>> := [v47];
					v47 := v48[safeIndex(f13, |v48|)];
				case DC18(cf31) =>
					var v49: array<bool> := new bool[10](i6 => p3.f14 <== v5);
					v49[safeIndex(152, v49.Length)] := p3.f14;
					v49[safeIndex(152, v49.Length)] := p3.f14;
					...
					v56 := v56[v55 := f16];
				case DC20(cf35) =>
					var v57 := new C4(safeDivisionInt(-f13, 0x67), v5, seq(abs(0x376), i7  => (p3.f13)));
					var v58 := new C6(0x107, v0[safeIndex(233, v0.Length)], p3.f15, p3.f13, v5, p3.f12);
					v5 := fm0(safeModuloInt(f13, f13), false || p3.f14, f13 == f13, globalState);
					globalState.f0 := v6;
			}
			...
			if (!(v61 !in v62)) {
				globalState.f5 := p3.f13 - safeDivisionInt(p3.f13, p3.f13);
				v60 := fm48(-f13, globalState);
				v5 := p0;
				var v63: map<bool, int> := map[p2 := f16];
				var v64: multiset<seq<int>> := multiset{seq(abs(962), i8  => (|v60|))};
				var v65: C2 := new C2(p3.f13, f13, p3.f14, p3.f12, p3.f15);
				var v66: map<C2, bool> := map[v65 := p2];
				var v67: array<int> := new int[17] [safeDivisionInt(|v63|, 0x66), p3.f13, p3.f13, f16, safeDivisionInt(p3.f13, p3.f13), p3.f13, |(map[p3.f13 := !p2] + v9)|, 0x164, f13, safeModuloInt(p3.f13, 436), f13, f16 - -|v64|, |v66|, f13, p3.f13, p3.f13, p3.f13];
				v67[safeIndex(519, v67.Length)] := -p3.f13;
				var v68: seq<bool> := [false];
				v5, v5, v67[safeIndex(519, v67.Length)], globalState.f9, v1 := f16 <= f13, (fm81(|v68|, p3.f14, p2, p3.f13, globalState)).cf77, p3.f13, if (f14) then if (!false) then v59 else v59 else v59, (v1 - v1) - (multiset{672, p3.f13} * v1);
				v3 := v3[f14 := p3.f14];
			} else {
				...
				var v73: set<int> := {f16, p3.f13, p3.f12[safeIndex(p3.f13, |p3.f12|)], f13};
				v5, globalState.f0, r1, v71, v72 := {f13} >= ({f13, p3.f13, f13} - v73), v60[safeIndex(p3.f13, |v60|)], p3.f13, v71 + v71, v72;
				var v74: seq<bool> := [f14];
				var v75: seq<int> := [|v74|, safeDivisionInt(f13, p3.f13), f13];
				globalState.f5, globalState.f5, v75, v75 := f16, if ((f13 * 521) in v4) then v4[f13 * 521] else 0x38b, f12, p3.f12 + f12;
				globalState.f5 := -safeModuloInt(-(p3.f13 + |fm50(false, v5, globalState)|), f16);
				v75 := p3.f12;
				var v76: seq<seq<int>> := [[f13]];
				var v77: set<seq<int>> := {v76[safeIndex(p3.f13, |v76|)]};
				v5 := v77 != v77;
			}
			...
			var v87: array<int> := new int[27] [-55, |v60|, f13, p3.f13, f13, -0x11d, f13, |v82|, p3.f13, f16, |(seq(abs(793), i9  => (v6)))|, fm2(p3.f13, v83, |fm48(f13, globalState)|, true, globalState), |v84|, p3.f13, f16, p3.f13, p3.f13, f16, |v4|, p3.f13, |p3.f12|, -|v86|, f13, p3.f13, p3.f13, f13, if (!p3.f14 in v85) then v85[!p3.f14] else p3.f13];
			var v88: seq<array<int>> := [v87];
			globalState.f5 := |(if (p3.f14 in v80) then v80[p3.f14] else v81)| + |(v88[safeIndex(p3.f13, |v88|) := v87] + [v87, v87])|;
		}
			...
			decreases 100 - i10
		{
			...
			v93[safeIndex(507, v93.Length)] := v94;
			var v95: map<string, int> := map["lm" + v89[safeIndex(f13, |v89|) := v6] := if (p3.f14) then p3.f13 else f13];
			v93[safeIndex(507, v93.Length)], v95 := v94, map[v89 := p3.f13];
			if ([v6] != v89) {
				var v96: array<bool> := new bool[15] [p2, f14, p3.f14, p3.fm7(globalState) <== p3.f14, v0[safeIndex(233, v0.Length)] > v0[safeIndex(233, v0.Length)], p0 <==> p2, v92.f19, !p0, p3.f14, v92.f19, p3.f14 <==> !f14, if (p2) then p3.f14 else v5, f14, f14, false];
				v96[safeIndex(775, v96.Length)] := p3.f14;
				v96[safeIndex(775, v96.Length)] := p3.f14;
				var v97: set<int> := {p3.f13};
				globalState.f5 := v92.fm4({0x26f, f13, |p3.f12|, f16, f16} * v97, globalState);
				globalState.f5 := f16;
				v94 := v93[safeIndex(507, v93.Length)];
				v5 := v92.f19;
			} else {
				...
				globalState.f5 := -(|v89[safeIndex(p3.f13, |v89|) := v6]| + p3.f13);
				globalState.f5 := f16;
				r1 := |v89|;
				v93[safeIndex(507, v93.Length)][safeIndex(481, v93[safeIndex(507, v93.Length)].Length)] := |v1| - f13;
				v93[safeIndex(507, v93.Length)][safeIndex(481, v93[safeIndex(507, v93.Length)].Length)] := 0x348 * p3.f13;
			}
			...
			decreases 100 - i11
		{
			...
			v102[safeIndex(364, v102.Length)] := p3.f13;
			v102[safeIndex(364, v102.Length)] := f13;
			globalState.f5 := |(seq(abs(-0x271), i12  => (p3.f13 + |v89|)))|;
			var v103 := new C8();
		}
		r0 := safeDivisionInt(f16, -0x22);
		var v104: multiset<bool> := multiset{p0, true};
		r1 := |v104|;
		r2 := {|v9|, f13, -f16, safeModuloInt(f16, -f13), --f16};
		r3 := v6;
	}
	method m4(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		...
		var v3: array<array<bool>> := new array<bool>[21] [v0, v0, v0, v0, if (f14) then v0 else v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, if (0x26e in v1) then v1[0x26e] else v0, v2[safeIndex(f13, |v2|)], v0];
		v3[safeIndex(814, v3.Length)] := v0;
		var v4: array<int> := new int[11];
		v4[safeIndex(82, v4.Length)] := p1;
		v3[safeIndex(814, v3.Length)], globalState.f5, v4[safeIndex(82, v4.Length)], globalState.f5 := v0, p2, p0, p0;
		var v5: array<T0> := new T0[3];
		var v6: map<int, bool> := map[f16 := f14];
		var v7: multiset<map<int, bool>> := multiset{v6, v6};
		var v8: T0 := new C0(p3, v7[v6 := abs(p2)], f12);
		var v9 := DC70(v8);
		v5[safeIndex(43, v5.Length)] := v9.cf119;
		v5[safeIndex(43, v5.Length)] := new C0(f13 != p1, v7, v8.f12 + f12);
		if ((f16 >= p1) ==> f14) {
			var v10 := new C5(v2, v8.f12);
			var v11 := "lhcvojula";
			var v12: multiset<bool> := multiset{f14};
			v4[safeIndex(82, v4.Length)], r1, globalState.f5 := |((v11[safeIndex(if (f14 in v12) then v12[f14] else f16, |v11|) := fm1(v4[safeIndex(82, v4.Length)], globalState)] + v11) + (v11 + "pkrimy"))|, f14, |"tugvioqa"|;
			var v13 := 'd';
			globalState.f0 := v13;
			...
			v19 := ((seq(abs(0x3e4), i0  => (multiset{p3}))) + (seq(abs(-0x22e), i1  => (multiset{f14, p3}))))[safeIndex(f13, |((seq(abs(0x3e4), i0  => (multiset{p3}))) + (seq(abs(-0x22e), i1  => (multiset{f14, p3}))))|) := v18];
			var v20: seq<seq<int>> := [v8.f12];
			v20 := v20;
			var v21 := 'p';
			var v22 := "shxeoay";
			r1 := v21 !in ("wwc" + v22[safeIndex(p1, |v22|) := v21]);
			v3[safeIndex(814, v3.Length)] := new bool[8];
		}
		
		var v23 := new C4(f16, !fm0(p2, p3, f14, globalState), v8.f12 + f12);
		v3 := v3;
		if (f12 < v8.f12) {
			v4[safeIndex(82, v4.Length)] := fm15(f14, globalState);
			...
			if (f14 in ([p3] + v25)) {
				...
				var v28 := DC18(v27);
				v26[safeIndex(667, v26.Length)] := v28;
				var v29: C0 := new C0(f14, multiset{v6, v6, map[v4[safeIndex(82, v4.Length)] := !p3], v6, v6} - v7, v8.f12);
				r1, v26[safeIndex(667, v26.Length)], v29 := v29.f25, v28, if (p3) then v29 else v29;
				var v30: map<int, C4> := map[p2 := v23];
				var v31: map<int, map<int, C4>> := map[f16 - |v25| := v30];
				var v32 := "awsoxwsot";
				var v33 := DC0(v4[safeIndex(82, v4.Length)]);
				var v34 := 'b';
				v31 := v31[(fm82(-f13, p0, |v32[safeIndex(fm2(-0x381, v33, p1, v29.f25, globalState), |v32|) := v34]|, p2, globalState)).cf85 := v30 + map[284 := v23]];
				globalState.f0, v4[safeIndex(82, v4.Length)], v29.f25, r1, globalState.f5 := v34, p1 + f16, false, -0x391 <= (p0 * p0), 0x22;
			} else {
				...
				var v44: array<seq<map<bool, D19>>> := new seq<map<bool, D19>>[29] [v39, v39[safeIndex(v4[safeIndex(82, v4.Length)], |v39|) := v38] + v39, v39, DC71(v39).cf120, (v39[safeIndex(18, |v39|) := v38])[safeIndex(f13, |v39[safeIndex(18, |v39|) := v38]|) := v38], v39, v39, if (f13 in v40) then v40[f13] else v39, v39, v39, v39, v39 + v39, [v38], v39, v39, v39, v39 + v39, v41.cf120, v39, ([v38])[safeIndex(f16, |[v38]|) := v38], v39, v39, v39, v39 + v42[safeIndex(f16, |v42|)], v39, [map[p3 := DC56(v36)]], v39, v39, if (|v43| in v40) then v40[|v43|] else v39];
				v44[safeIndex(675, v44.Length)] := [v38, v38, v38, v38];
				v0[safeIndex(466, v0.Length)] := p3;
				globalState.f5, v35, v44[safeIndex(675, v44.Length)], v0[safeIndex(466, v0.Length)], r1 := -p0, DC25(false), v39, v23.fm34(p3, globalState), f14;
			...
			v4[safeIndex(82, v4.Length)], globalState.f5, r1 := p0, f16, !((if (f14 in v47) then v47[f14] else p2) <= p0);
			v4[safeIndex(82, v4.Length)] := f16;
		} else {
			var v48: multiset<int> := multiset{p0, f16};
			var v49 := "umrumiurg";
			var v50: C9 := new C9(0xd0);
			var v51: seq<C9> := [v50];
			var v52: array<C9> := new C9[16] [v50, v50, v50, v50, v50, v51[safeIndex(f16, |v51|)], v50, v50, v50, v50, v50, v50, v50, v50, v50, v50];
			var v53: map<array<C9>, int> := map[v52 := v4[safeIndex(82, v4.Length)]];
			var v54: set<int> := {|v53|, f16, f13};
			var v55 := 'w';
			var v56: map<bool, char> := map[f14 := v55];
			var v57: map<bool, multiset<int>> := map[true := v48];
			var v58: array<multiset<int>> := new multiset<int>[23] [multiset{v4[safeIndex(82, v4.Length)]}, v48 * v48, v48 * v48, v48, multiset([|v49|, --0x2ad, v23.fm4(v54, globalState)]), if (!f14) then multiset{f16} else v48, multiset{f16}, multiset{p1} + v48, v48, v48 - v48, v48[|v56| := abs(p2)], v48, v48, v48, if (f14 in v57) then v57[f14] else v48, v48, v48, v48, v48, v48, v48, fm70(f14, globalState), v48];
	...
	method m7(p0: seq<int>, p1: array<char>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
		...
		var v17 := DC30(v8);
		var v18: array<seq<array<bool>>> := new seq<array<bool>>[28] [v8, v8, v8, v8, v8, v8, v8 + v8, v9[safeIndex(|v14|, |v9|)], v8, v8, v8, v8 + v8, v8, v8, v8[safeIndex(f13, |v8|) := v2], v8[safeIndex(|fm56(v1, false, f14, globalState)|, |v8|) := v2], v8 + v8, v9[safeIndex(f13, |v9|)] + v8, ([v2, v2])[safeIndex(|v16|, |[v2, v2]|) := v2], v8, v9[safeIndex(f16, |v9|)], v8 + v8, if (true) then v8 else v8, v8, v8, v8, v8 + v17.cf51, v8];
		v18[safeIndex(151, v18.Length)] := v8;
		var v19: map<int, array<bool>> := map[f13 := v2];
		v18[safeIndex(151, v18.Length)] := (if (f14) then v8 else [v2, if (f16 in v19) then v19[f16] else v2]) + v9[safeIndex(f13, |v9|)];
	...
	method m8(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: int, r1: int) {
		...
		var v1: map<string, seq<bool>> := map[seq(abs(0x184), i0  => ('l')) := v0];
		globalState.f5 := f12[safeIndex(|(if ((fm47(p0, globalState)).cf19 in v1) then v1[(fm47(p0, globalState)).cf19] else [f14, p1])|, |f12|)];
		for i1 := f13 to p2 {
			var v2: multiset<int> := multiset{p0, f16};
			var v3: set<bool> := {v0[safeIndex(f13, |v0|)]};
			var v4 := "kmwuja";
			var v5: multiset<string> := multiset{v4, v4};
			var v6 := DC0(f16);
			var v7: set<int> := {f12[safeIndex(|v2|, |f12|)], safeModuloInt(|v3|, |v5|), fm2(i1, v6, -i1, !p1, globalState)};
			globalState.f5 := |v7|;
			var v8: array<set<bool>> := new set<bool>[28](i2 => if (DC11(!v0[safeIndex(f13, |v0|)]).cf15) then v3 else v3);
			v8[safeIndex(250, v8.Length)] := v3 - {p1, p1, v0[safeIndex(f16, |v0|)], p1, p1};
			v8[safeIndex(250, v8.Length)] := v3 * v3;
			if (f14) {
				globalState.f5 := f13;
				v4 := v4;
				...
				v17[safeIndex(618, v17.Length)] := f14;
				v17[safeIndex(618, v17.Length)] := if (f14) then p1 else p1;
				r0 := v13.f12[safeIndex(p2, |v13.f12|)];
			} else {
				...
				var v29: seq<C6> := [v28];
				var v30: array<int> := new int[19] [i1, if (f14) then 0x20d else |map[v20 := v23]|, p2, fm15(f14, globalState), f16, p2, f13, 605, f13 * -0x74, i1, -0x3d5, p2, p0, i1, fm5(f14, v4, v2, globalState) - |v29|, |(v0[safeIndex(|v25.f12|, |v0|) := v25.f14])[safeIndex(v28.f21, |v0[safeIndex(|v25.f12|, |v0|) := v25.f14]|) := p1]|, |v25.f12|, v28.f21, -v25.f13];
				v30[safeIndex(477, v30.Length)] := f13;
				v30[safeIndex(477, v30.Length)] := f16;
				var v31: array<string> := new string[27];
				v31[safeIndex(171, v31.Length)] := v4;
				v31[safeIndex(171, v31.Length)] := v4;
				var v32: multiset<bool> := multiset{v25.f14, v25.f14};
				var v33 := DC18(v32);
				v30[safeIndex(477, v30.Length)] := -|((v33.cf31 - v32) * v32)|;
				var v34: T2 := new C2(if (!f14) then fm4(v7, globalState) else 0x10e, safeModuloInt(|v31[safeIndex(171, v31.Length)]|, v25.f13), p1, f12, v27);
				v34 := v34;
			}
			...
			if (f14) {
				...
				v38 := f12[safeIndex(|v41|, |f12|) := f13];
				var v42 := DC40(f13, p1, safeModuloInt(f13, v40.f13));
				v42 := v42;
			} else {
				...
				v46[safeIndex(588, v46.Length)] := f14;
				...
				var v52: array<int> := new int[20](i3 => safeModuloInt(i3, f16));
				var v53 := DC47(f16);
				...
				v46[safeIndex(588, v46.Length)] := !(v55 > (if (true) then v55 else v55));
				var v56: array<multiset<T2>> := new multiset<T2>[12];
				v56 := v56;
				v46[safeIndex(588, v46.Length)] := p0 != v51.f16;
				v46[safeIndex(588, v46.Length)] := (if (p1) then v51.f14 else v46[safeIndex(588, v46.Length)]) <== (v3 > v8[safeIndex(250, v8.Length)]);
				v4 := v4 + ("xws" + "jq");
			}
		...
		for i4 := 0x2e8 to f16 {
			...
			v59[safeIndex(972, v59.Length)] := v61[safeIndex(p0, |v61|)];
			var v62 := 'n';
			v59[safeIndex(972, v59.Length)] := v60[safeIndex(f13, |v60|) := v62] + v60;
			...
			v65[safeIndex(785, v65.Length)] := true;
			v65[safeIndex(785, v65.Length)] := p1;
		}
		var v66 := 'd';
		var v67 := "snygff";
		var v68: array<char> := new char[8] ['v', v66, v67[safeIndex(f13, |v67|)], v66, v66, v66, v66, v66];
		var v69, v70, v71 := m7(f12, v68, globalState);
		if (v69 || (f14 ==> v69)) {
			var v72: seq<string> := [v67, v67, seq(abs(0x263), i6  => (v66))];
			v72 := v72;
			...
			if (v77.cf44) {
				...
				v79 := v79;
				globalState.f5 := 715 * safeDivisionInt(f16, f13);
				v69 := f14;
			} else {
				var v80 := DC14(f14, v67, p2, p1, v70);
				v70 := (v67 + "nxgex") < v80.cf19;
				v75[safeIndex(11, v75.Length)] := v67 < v72[safeIndex(p0, |v72|)];
				v75[safeIndex(11, v75.Length)] := f14;
				...
				var v83 := DC28(v67[safeIndex(f13, |v67|)]);
				var v84: map<bool, char> := map[v70 := v83.cf49];
				var v85: set<int> := {f13};
				v84 := v84[v85 !! v85 := v66];
			}
			
			v75[safeIndex(819, v75.Length)] := v70;
			var v86 := DC69(v68);
			...
			v75[safeIndex(819, v75.Length)], v86, v71, v89 := !true, v86, fm5(f12 < f12, v67, v90, globalState), v89;
		} else {
			var v91 := new C1(p0, f14, f12[safeIndex(p2, |f12|) := p0] + f12, p0);
			...
			v97[safeIndex(294, v97.Length)] := !(f16 < f13);
			v95, globalState.f5, v97[safeIndex(294, v97.Length)], v70 := fm71(p0, fm6(globalState), globalState), p0, false, !v69;
			...
			match (v99) {
				case DC14(cf18, cf19, cf20, cf21, cf22) =>
					...
					v71 := --p2;
				case DC15(cf23, cf24, cf25) =>
					var v103: map<string, array<bool>> := map[seq(abs(325), i7  => (v66)) := v97];
					...
					v67, v104, r1, v97[safeIndex(294, v97.Length)] := v67, DC22(v66, false, v71, p2, cf23), -v71, |(if (v66 in v105) then v105[v66] else v67)| >= safeDivisionInt(f16, p2);
					v97[safeIndex(294, v97.Length)] := false;
					...
					v108[safeIndex(295, v108.Length)] := v106;
					var v109: map<bool, seq<bool>> := map[cf25 := [f14, p1]];
					var v110: map<int, int> := map[v71 := |v67|];
					var v111: set<int> := {f12[safeIndex(175, |f12|)], f16};
					var v112: array<int> := new int[15] [-v71, v71, cf23, v106.fm11(globalState), v93.cf23, v91.fm11(globalState), |(if (v97[safeIndex(294, v97.Length)] in v109) then v109[v97[safeIndex(294, v97.Length)]] else [v106.f19, v97[safeIndex(294, v97.Length)], true, f14])|, |v110|, |v111|, if (p1) then |[v71]| else f13, v71, |(v67 + v67)|, v71, f16, |f12|];
					globalState.f5, v108[safeIndex(295, v108.Length)], v112 := 211, v106, v112;
				case DC16(cf26, cf27, cf28, cf29) =>
					var v113: map<array<bool>, int> := map[v97 := f16];
					var v114: multiset<bool> := multiset{f14, v97[safeIndex(294, v97.Length)]};
					var v115: seq<seq<bool>> := [cf28, cf28, [p1, v69, v97[safeIndex(294, v97.Length)], p1, fm0(p2, v70, v97[safeIndex(294, v97.Length)], globalState)], cf28[safeIndex(if (fm7(globalState) in v114) then v114[fm7(globalState)] else cf29, |cf28|) := p1], [v69, f14, v69]];
					var v116: map<bool, seq<bool>> := map[v69 := [v97[safeIndex(294, v97.Length)], v97[safeIndex(294, v97.Length)]]];
					var v117: map<int, bool> := map[|v67| := true];
					var v118: array<seq<bool>> := new seq<bool>[16] [v0, [v69], [v69, f14] + cf28, cf28[safeIndex(if (v97 in v113) then v113[v97] else cf29, |cf28|) := f14], v0, cf28, v0, v115[safeIndex(v71, |v115|)], if (p1 in v116) then v116[p1] else v0, v0, [v97[safeIndex(294, v97.Length)], if (0xec in v117) then v117[0xec] else v70], cf28, cf28 + cf28, v0, v0, v0 + fm50(v70, p1, globalState)];
					v118 := v118;
					...
					v67 := v67;
				case DC13(cf17) =>
					v97[safeIndex(294, v97.Length)] := f13 >= f16;
					var v125: map<int, int> := map[p0 := p2];
					v125 := v125[f16 := DC67(p2, v97[safeIndex(294, v97.Length)], |multiset{v70}|).cf114];
					var v126: set<seq<bool>> := {[!f14], v0, v0};
					var v127 := DC27(v126);
					var v128 := DC29(v127);
					v128 := v128;
					var v129: map<int, bool> := map[f13 := v70];
					v70, globalState.f5, v67, v69, v97[safeIndex(294, v97.Length)] := v69 ==> v70, v91.fm11(globalState), v67, v97[safeIndex(294, v97.Length)] ==> v69, if (f16 in v129) then v129[f16] else v69;
				case DC17(cf30) =>
					var v130: map<int, int> := map[p2 := f13];
					v130 := v130[|v67| := f16];
					var v131 := DC0(v71);
					var v132: seq<int> := [|((seq(abs(-0xdb), i8  => (v66))) + v67)|, safeModuloInt(fm2(f13, v131, f16, true, globalState), 948), |v67|];
					v132 := v132;
					var v133: map<string, bool> := map[(seq(abs(1), i9  => (v66))) + v67 := v0 != fm50(v70, true, globalState)];
					v133 := v133[v67 + v67 := v69];
					var v134: set<bool> := {v97[safeIndex(294, v97.Length)], v97[safeIndex(294, v97.Length)]};
					...
					var v141 := new C0(true !in v135[safeIndex(714, |v135|)], v139 + multiset(v140), v132);
			}
			...
			if (p1 && false) {
				...
				var v146 := DC73(v145);
				v145 := v146.cf122;
				m0(v97[safeIndex(294, v97.Length)] ==> fm0(p2, v69, v69, globalState), globalState);
				...
				v67 := seq(abs(-0x288), i10  => (if (p1) then v66 else 'h'));
				v70 := true;
				var v153: set<bool> := {v97[safeIndex(294, v97.Length)]};
				var v154 := DC10(v153);
				var v155 := DC12(v154);
				var v156: array<int> := new int[27];
				var v157: map<array<int>, bool> := map[v156 := f13 >= f16];
				var v158: map<bool, bool> := map[true := true];
				var v159: map<bool, int> := map[v97[safeIndex(294, v97.Length)] := p0];
				var v160: seq<map<bool, int>> := [v159, v159];
				var v161: multiset<bool> := multiset{p1};
				var v162 := DC18(v161);
				var v163 := DC51(fm85(|v158|, v97[safeIndex(294, v97.Length)], globalState) + v160, p1, v162);
				v155, v157, v163 := v155, v157 + v157, v163.(cf96 := v162);
				v156[safeIndex(230, v156.Length)] := p0;
				var v164: seq<string> := [v67, v67, v67];
				var v165: multiset<int> := multiset{|v153|};
				v70, v156, v156[safeIndex(230, v156.Length)], v164 := f14, v156, v91.fm5(true, v164[safeIndex(|[v91]|, |v164|)], v165, globalState) + -f13, v164;
				var v166: multiset<map<int, bool>> := multiset{map[p2 := f14]};
				var v167 := DC33(v166);
				var v168: map<char, D11> := map[v66 := v167];
				var v169: map<string, bool> := map["wg" := p1];
				v67, v168, v97[safeIndex(294, v97.Length)], v69 := v67, if (if (v67 in v169) then v169[v67] else !v70) then map[v66 := v167] else v168, f14, v69;
			}
		...
		if (match v170 {
			...
			var v177: array<bool> := new bool[27] [v171.cf77, p1, v0 != [!v69], v69 <== v70, v69, !p1, v70, f14, f14, true, v174 >= v174, false, v69, !(v175 != {seq(abs(0x7e), i11  => (v71)), f12}), !v69, v70, f16 <= f13, false, f14, !(f16 < f13), v70, f13 != 0x286, p1, v70, v176 != v176, v69, (seq(abs(0x245), i12  => (v71))) == f12];
			v177[safeIndex(605, v177.Length)] := v66 in v67;
			var v178 := DC4(false, p0, v69);
			v177[safeIndex(605, v177.Length)] := v69 ==> fm0(p2, v69, v178.cf7, globalState);
			var v179 := DC49(v173);
			match (v179) {
				case DC50(cf93) =>
					cf93 := (if (v70) then f12 else f12) == f12;
					var v180: array<int> := new int[21];
					v180[safeIndex(314, v180.Length)] := f13;
					v180[safeIndex(314, v180.Length)] := fm5(p1, v67 + v67, v173, globalState);
					cf93 := v69;
					v174 := v174;
				case DC51(cf94, cf95, cf96) =>
					...
					var v183: map<bool, array<bool>> := map[true := v182[safeIndex(p2, |v182|)]];
					var v184: map<int, multiset<int>> := map[f13 := v173];
					v177[safeIndex(605, v177.Length)] := v71 > safeDivisionInt(|v183|, |v184|);
					var v185: array<int> := new int[3];
					v185 := v185;
				case DC49(cf92) =>
					v69 := v177[safeIndex(605, v177.Length)];
					var v186: map<bool, bool> := map[v69 := f14];
					var v187: multiset<map<bool, bool>> := multiset{v186, v186};
					var v188: array<T1> := new T1[21];
					var v189: T3 := new C2(f13, v71, v177[safeIndex(605, v177.Length)], f12, v188);
				...
				case DC52(cf97) =>
					...
					v192 := v192 - v192;
					globalState.f5 := f13;
					var v193: array<int> := new int[6](i13 => safeModuloInt(i13, f16));
					v193[safeIndex(924, v193.Length)] := f16;
					v193[safeIndex(924, v193.Length)] := |(seq(abs(0x309), i14  => (v66)))|;
					v69 := if (p1) then p1 else {f13} <= {0x109};
			}
			
			r0 := safeModuloInt(f13, safeModuloInt(f16, f16));
			globalState.f0 := v66;
			var v194: array<string> := new string[17];
			v194[safeIndex(467, v194.Length)] := v67;
			v67, v194[safeIndex(467, v194.Length)] := ("fjx")[safeIndex(310, |"fjx"|) := v66], v67;
		} else {
			...
			v198[safeIndex(754, v198.Length)] := p1;
			v70, v198[safeIndex(754, v198.Length)], v69 := v69, f14, true;
			var v199: C10 := new C10(v198[safeIndex(754, v198.Length)], f13, v70, f12, |multiset{f13}|);
			var v200: map<bool, C10> := map[p1 := v199];
			var v201 := DC14(p1, v67, |v200|, v69, v69);
			var v202: seq<int> := [v71 * 0x2d0, safeDivisionInt(|v0[safeIndex(0x3db, |v0|) := v70]|, |v201.cf19|), -909, f16, f16];
			v202 := f12 + v202;
			var v203 := DC0(f16);
			r0 := -(p0 - fm2(|v0|, v203, f13, v70, globalState));
			v0 := (v0 + [v198[safeIndex(754, v198.Length)]]) + v0;
			var v204: array<seq<int>> := new seq<int>[7];
			v204[safeIndex(150, v204.Length)] := f12 + f12;
			v204[safeIndex(150, v204.Length)] := f12;
		}
		
		r0 := -safeModuloInt(f13, p0);
		r1 := p0;
	}
}
...
class C13 extends T1, T2, T3 {
	...
	function fm9(p0: bool, globalState: GlobalState): bool {
		({f16} * {f16, f13}) > ({f16, |map[f16 := seq(abs(697), i0  => ('o'))]|} * {|map[f14 := f16]|})
	}
	function fm10(p0: int, p1: string, globalState: GlobalState): map<bool, char> {
	...
	function fm12(p0: string, p1: int, p2: int, p3: bool, globalState: GlobalState): map<int, D0> {
		map[f13 := DC0(f16)] + (map v0 : int | (-846 <= v0) && (v0 < 0x340) :: (safeModuloInt(v0, f13)) := (DC0(f16)))
	}
	...
	method m1(globalState: GlobalState) {
		...
		if (f14) {
			...
			v1[safeIndex(586, v1.Length)] := 0x394;
			var v2: seq<bool> := [f14];
			var v3 := "ya";
			v1[safeIndex(586, v1.Length)] := -safeModuloInt(|"gjymy"|, |(fm14(f13, v2[safeIndex(f16, |v2|) := v0], globalState) + v3)|);
			v0 := f12 < f12;
			var v4: map<bool, bool> := map[f14 && f14 := false];
			var v5: multiset<bool> := multiset{v0, v0};
			v4 := v4[v1[safeIndex(586, v1.Length)] <= |v5| := f14];
			var v6: array<bool> := new bool[17];
			var v7 := DC1(v0);
			v6[safeIndex(663, v6.Length)] := v7.cf1;
			var v8: map<string, int> := map[v3 := 0x1ce];
			var v10: seq<string> := [v3];
			v6[safeIndex(663, v6.Length)] := v8 == (v8 + (map v9 : string | v9 in v10 :: (v9) := (v1[safeIndex(586, v1.Length)])));
			var v11 := 'k';
			var v12: map<map<bool, int>, bool> := map[map[v6[safeIndex(663, v6.Length)] := -f13] := v3 <= v3[safeIndex(v1[safeIndex(586, v1.Length)], |v3|) := v11]];
			var v13: map<bool, int> := map[v0 := f13];
			v0, v0, v0, globalState.f5, v0 := v6[safeIndex(663, v6.Length)], f14, if (v13 in v12) then v12[v13] else false, v1[safeIndex(586, v1.Length)], fm0(f16, !v0, v6[safeIndex(663, v6.Length)], globalState);
		} else {
			var v14 := DC1(f16 >= f16);
			v14 := v14;
			v0 := !fm13(globalState);
			var v15 := "j";
			var v16 := DC2(f14, v15[safeIndex(f16, |v15|)], v0);
			var v17 := DC5(v16);
			match (v17) {
				case DC2(cf2, cf3, cf4) =>
					var v18: array<string> := new string[11] ["sexynkwd", v15, v15, "wvs", "xpm", v15, v15, v15[safeIndex(-|v15|, |v15|) := cf3], v15, v15, "m"];
					var v19: map<int, int> := map[f13 := f13];
					var v20: map<array<string>, int> := map[v18 := safeDivisionInt(|v19|, f16)];
					v20 := v20[v18 := f16];
					var v21: seq<seq<int>> := [fm56('t', f14, false, globalState)];
					var v22 := new C4(f13, !cf2, v21[safeIndex(f13, |v21|)]);
					...
					v29[safeIndex(104, v29.Length)] := v26;
					v29[safeIndex(104, v29.Length)] := v26;
				...
				case DC3(cf5, cf6) =>
					...
					v31[safeIndex(954, v31.Length)] := v32 + v32;
					v31[safeIndex(954, v31.Length)] := v32;
					var v33: array<int> := new int[16](i0 => i0 + -0x307);
					var v34: map<int, array<int>> := map[f16 := v33];
					var v35: set<int> := {f13};
					var v36: seq<set<int>> := [{f16}, v35];
					var v37: multiset<set<int>> := multiset{v35 * v35, fm40(v0, f16, v0, globalState), v35, v36[safeIndex(f16, |v36|)], {|[cf6]|}};
					...
					globalState.f9 := v46;
					v33[safeIndex(394, v33.Length)] := f16;
					v33[safeIndex(394, v33.Length)] := -f16 + f13;
				case DC4(cf7, cf8, cf9) =>
					m0(cf7, globalState);
					...
					v49[safeIndex(798, v49.Length)] := if (true) then 0x269 else if (cf9 in v58) then v58[cf9] else f13;
					v49[safeIndex(798, v49.Length)] := --((-35 + f16) * cf8);
					...
					var v64: set<int> := {v49[safeIndex(798, v49.Length)], f16};
					v61[safeIndex(853, v61.Length)] := (if (cf9) then v60 else [v59, if (f14 in v62) then v62[f14] else v63.cf45, v59])[safeIndex(|v64|, |(if (cf9) then v60 else [v59, if (f14 in v62) then v62[f14] else v63.cf45, v59])|) := v59];
					v61[safeIndex(853, v61.Length)] := v60;
				case DC1(cf1) =>
					var v65 := 'd';
					var v66: map<int, char> := map[f13 := v65];
					var v68: seq<bool> := [true, cf1];
					var v72: map<int, bool> := map[f13 := true];
					var v74: array<map<int, char>> := new map<int, char>[26] [v66, v66, (map v67 : int | v67 in v66 :: (safeModuloInt(v67, |(seq(abs(-0xb4), i1  => (|map[v65 := v0]|)))[safeIndex(f13, |(seq(abs(-0xb4), i1  => (|map[v65 := v0]|)))|) := |f12|]|)) := (v65)) + v66, map[f12[safeIndex(-f13, |f12|)] := v15[safeIndex(|v68|, |v15|)]], v66, v66, v66, v66, v66, v66 + v66, v66 + v66, v66, v66, v66, v66, map v69 : int | (196 <= v69) && (v69 < -0x1a) :: (v69 - f16) := (v65), map[f13 := v65], v66, v66[f16 := v65] + (map v70 : int | (-596 <= v70) && (v70 < 0xb9) :: (safeModuloInt(v70, f16)) := ('p')), v66 + v66, map[f16 := v65] + v66, v66, v66, v66, map v71 : int | (218 <= v71) && (v71 < 384) :: (v71 + |v68|) := (v65), if (f14) then fm41(f14, v72, [!cf1], globalState) else map v73 : int | (131 <= v73) && (v73 < 323) :: (v73 * f13) := (v65)];
					...
					var v80: array<map<int, bool>> := new map<int, bool>[22] [v72, v72, map[f13 := cf1], v72[|v75| := !f14], if (f14) then map v76 : int | (0x121 <= v76) && (v76 < -0x1a2) :: (safeDivisionInt(v76, 758)) := (cf1) else v72, v72[f13 := fm9(true, globalState)], v72, v72, map v77 : int | (0x3ad <= v77) && (v77 < -0x19e) :: (v77 + f16) := (cf1), v72, v72, v72, v72 + v72, map v78 : int | (-440 <= v78) && (v78 < 0x358) :: (safeDivisionInt(v78, f13)) := (f14), v72 + v72, if (fm86(cf1, cf1, globalState) in v79) then v79[fm86(cf1, cf1, globalState)] else v72, v72 + v72, v72, v72, v72, map[-f16 := v0], map[f13 := v0]];
					v80[safeIndex(823, v80.Length)] := v72;
					...
					v80[safeIndex(823, v80.Length)], cf1, v68, v81 := v72, !(v85.cf125 < v15), v68, (v81 + v81) + v81;
					var v86: array<set<int>> := new set<int>[10](i3 => v84);
					v86 := v86;
					var v87: seq<array<bool>> := [v82];
					var v88: C5 := new C5(v87, f12[safeIndex(f16, |f12|) := |f12|]);
					v88 := v88;
				case DC5(cf10) =>
					globalState.f5 := |("ahraw" + (v15 + (seq(abs(91), i4  => ('s')))))|;
					v0 := false;
					v0 := v0;
			...
			v0 := !f14;
			var v89 := new C4(safeDivisionInt(f16, f16), f14, f12);
		}
			...
			decreases 100 - i5
		{
			...
			var v101: array<int> := new int[12] [f13, f13, f13, f16, f13 - v95.cf26, safeDivisionInt(f13, f16), f13, if (f14) then |v99| else |v100|, f13, 0x2f7, f13, f13];
			v101[safeIndex(703, v101.Length)] := f13;
			v101[safeIndex(703, v101.Length)] := safeDivisionInt(safeModuloInt(|v91|, f13), f16);
		...
		v111[safeIndex(334, v111.Length)] := v109;
		var v112: multiset<int> := multiset{|fm48(0x22f, globalState)|, f16};
		v110, v111[safeIndex(334, v111.Length)], globalState.f5 := v110, 'c', fm5(f14, v110, v112, globalState);
		...
		var v117: array<int> := new int[29] [f13, safeModuloInt(-0x17d, 0x12e), f16, f13, f16, f16, |v113| + f16, f16, f16, f16, f16, f13 + f16, |(v114 + v114)|, f13, f16, if (f16 in v115) then v115[f16] else f13, f16, f16, f13, f13, f13, |v116|, safeDivisionInt(f16, f13), f16, f13, |v110|, f13, |v110[safeIndex(0xfc, |v110|) := fm1(-|v116|, globalState)]| * f13, f16];
		...
		if (f16 > f16) {
			...
			var v127: array<string> := new seq<char>[15] [v110, v110, v110, v110, v110, v110, v110, v110[safeIndex(f16, |v110|) := v109], v110, seq(abs(0x17e), i8  => (v111[safeIndex(334, v111.Length)])), v110, v110, v110, v110, v110];
			...
			var v137 := DC43(f16, f14, fm8(v135, v130[safeIndex(f16, |v130|) := v0], v136, v110, globalState), v129, f13);
			globalState.f5, v0, globalState.f5 := if (v133[safeIndex(f16, |v133|)] in v132) then v132[v133[safeIndex(f16, |v133|)]] else f16, f14, if (v137.cf83 == f13) then f13 else f16;
			v127[safeIndex(349, v127.Length)] := v110;
			v127[safeIndex(349, v127.Length)] := (v110 + v110) + v110;
			v117 := v117;
		}
	...
	method m2(p0: bool, p1: int, p2: D0, p3: bool, globalState: GlobalState) returns (r0: int) {
		...
		v9[safeIndex(588, v9.Length)] := p1 == p1;
		v9[safeIndex(588, v9.Length)] := !(f14 ==> p0);
		var v10 := DC7();
		v9[safeIndex(588, v9.Length)] := match v10 {
			case DC7() => v3
	...
	method m3(p0: bool, p1: map<array<int>, seq<bool>>, p2: bool, p3: T2, globalState: GlobalState) returns (r0: int, r1: int, r2: set<int>, r3: char) {
		...
		globalState.f5 := f16;
		r0 := v0[safeIndex(464, v0.Length)];
		r1 := -p3.f13;
		r2 := {-v0[safeIndex(464, v0.Length)]};
		r3 := v4;
	}
	method m4(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) returns (r0: multiset<bool>, r1: bool) {
		for i0 := p2 to p1 {
			...
			v1[safeIndex(214, v1.Length)] := if (p3) then v0 else v0;
			v1[safeIndex(214, v1.Length)] := v0;
			...
			match (v6) {
				case DC50(cf93) =>
					...
					var v11 := new C5(v10[safeIndex(p2, |v10|) := v7], v2.f12);
					var v12 := new C9(i0);
					v1[safeIndex(214, v1.Length)] := v0;
				case DC51(cf94, cf95, cf96) =>
					...
					v17[safeIndex(384, v17.Length)] := v16;
					var v18: array<bool> := new bool[19];
					v17[safeIndex(384, v17.Length)], cf95, globalState.f9 := v16, p3, v18;
					var v19: seq<bool> := [v2.f14];
					var v20: seq<seq<bool>> := [v19];
					v20 := (seq(abs(789), i2  => (v19))) + v20;
				case DC49(cf92) =>
				...
				case DC52(cf97) =>
					...
					var v28 := DC21(v0);
					v27[safeIndex(857, v27.Length)] := v28.(cf36 := v0);
					var v29 := "k";
					var v30: seq<string> := [v29, seq(abs(134), i4  => ('r'))];
					var v31: T2 := new C6(|v30| + i0, if (p3) then v5 else v5, f15, p2, p3, v2.f12);
					v27[safeIndex(857, v27.Length)], v31 := v28, v31;
			...
			v40[safeIndex(239, v40.Length)] := v2.fm7(globalState);
			globalState.f5, v39, v40[safeIndex(239, v40.Length)] := -89, v39[p3 := v1[safeIndex(214, v1.Length)]] + v39, p3;
		}
		var v41 := DC58();
		match (v41) {
			case DC58() =>
				...
				v51[safeIndex(344, v51.Length)] := f14;
				var v52: seq<bool> := [p3];
				v50, r0, v51[safeIndex(344, v51.Length)] := (v47 * v48.f22) + v48.f22, (multiset(v52))[213 > p2 := abs(|(map[p3 := f14])[p3 := p3]|)], p3;
				...
				r1, v55, v51[safeIndex(344, v51.Length)] := p3, map[v54 := p0], v48.fm31(v48.f21, globalState);
			case DC57(cf103) =>
				...
				v59[safeIndex(295, v59.Length)] := cf103.f25;
				var v60: seq<bool> := [!cf103.f25, p3];
				v59[safeIndex(295, v59.Length)] := !(f14 && (f16 > |v60|));
				var v61: seq<array<bool>> := [v59];
				var v62 := new C5(v61, f12);
				globalState.f5 := |map[f14 := v60]| * fm2(f13, DC0(p2), f16, v60[safeIndex(p0, |v60|)], globalState);
		}
		
		var v63 := "dnfnkplqp";
		var v64: T3 := new C12(p2, f16, !p3, f12);
		var v65: map<string, T3> := map[v63 + (seq(abs(0x312), i8  => ('c'))) := v64];
		...
		var i9 := 0;
		while (!(-117 != safeDivisionInt(0x48, 0x31c)))
			decreases 100 - i9
		{
			if (i9 >= 100) {
				break;
			...
			if (v64.f14) {
				...
				v72 := v72[|v73| := v71];
				globalState.f5 := |(seq(abs(532), i10  => (v64.f13)))| * (f13 - v64.f16);
				var v74: array<int> := new int[10];
				v74 := v74;
				var v75: map<int, int> := map[v64.f16 := v64.f13];
				var v76 := DC39(v75);
				v76 := v76.(cf75 := (map v77 : int | v77 in v64.f12 :: (safeModuloInt(v77, v64.f13)) := (|v63|)) + map[p0 := f13]);
				...
				v78[safeIndex(204, v78.Length)] := v69;
				var v79: map<int, char> := map[p1 := fm1(p1, globalState)];
				v78[safeIndex(204, v78.Length)] := if (|v64.f12| in v79) then v79[|v64.f12|] else v69;
				v67[safeIndex(776, v67.Length)] := false;
				v67[safeIndex(776, v67.Length)] := f14;
				var v80: array<int> := new int[6];
				v80[safeIndex(509, v80.Length)] := f16 * v64.f16;
				v80[safeIndex(509, v80.Length)] := safeModuloInt(f16, f13);
				var v81: set<char> := {v78[safeIndex(204, v78.Length)]};
				var v82: multiset<set<char>> := multiset{v81};
				v82 := multiset{v81 * v81, if (true) then {v69} else {v78[safeIndex(204, v78.Length)]}, v81 + v81};
				var v83: seq<string> := [v63, fm48(v64.f13, globalState)];
				var v84: seq<seq<string>> := [v83, v83, v83, v83, v83];
				v83, v67[safeIndex(776, v67.Length)], globalState.f0, v67[safeIndex(776, v67.Length)] := v83 + (v84[safeIndex(|v63|, |v84|)] + v83), p3, v78[safeIndex(204, v78.Length)], if (f14) then p3 else f14;
			}
			...
			var v89: C1 := new C1(v64.f16, v64.f14, f12[safeIndex(f13, |f12|) := v64.f13], v64.f13);
			var v90: seq<C1> := [v89, v89];
			var v91: seq<bool> := [true, p3, v64.f14];
			v85, v87, globalState.f5 := if (f14) then v85 else v85, v88[safeIndex(|(v90 + v90)|, |v88|)], |v91| + p2;
			var v92: array<int> := new int[21];
			v92[safeIndex(656, v92.Length)] := safeDivisionInt(p2, |"fa"|);
			var v93: set<int> := {v64.f16};
			var v94: map<int, set<int>> := map[f16 := v93];
			v92[safeIndex(122, v92.Length)] := |(f12 + ([232])[safeIndex(p1, |[232]|) := |v94|])[safeIndex(v64.f16, |(f12 + ([232])[safeIndex(p1, |[232]|) := |v94|])|) := f16]|;
			v92[safeIndex(656, v92.Length)], v92[safeIndex(122, v92.Length)] := p0, p2;
			v92[safeIndex(656, v92.Length)] := p2;
		}
	...
	method m5(p0: bool, p1: bool, globalState: GlobalState) {
		...
		var v1 := "c";
		v0[safeIndex(70, v0.Length)] := v1;
		var v2: array<int> := new int[19](i0 => safeDivisionInt(i0, DC43(f13, p1, f13, {true}, |v1|).cf85));
		v0[safeIndex(70, v0.Length)], v2 := v1, v2;
		for i1 := f16 + f16 to 0x2b4 - f16 {
			var v3 := false;
			v3 := !f14;
			v3 := f14;
			globalState.f5 := f16;
			var v4: array<set<int>> := new set<int>[5](i2 => {f12[safeIndex(i1, |f12|)], f13} * {i1, 510});
			v4 := v4;
		}
		var v5: multiset<int> := multiset{f16};
		var v6: seq<multiset<int>> := [v5, v5, v5 + fm70(p0, globalState)];
		v5 := v6[safeIndex(f16, |v6|)];
		var v7 := true;
		v7 := !f14;
		var i3 := 0;
		while ((p0 <==> f14) <== v7)
			decreases 100 - i3
		{
			...
			var v10 := new C10(v8[safeIndex(f13, |v8|)], safeDivisionInt(0x218, f16), p1, f12, |v9|);
			v2[safeIndex(69, v2.Length)] := f13;
			v2[safeIndex(69, v2.Length)] := f13;
			v2[safeIndex(69, v2.Length)] := f13;
			...
			v11[safeIndex(54, v11.Length)] := v14 + v14;
			v11[safeIndex(54, v11.Length)] := v14;
		}
		var v15 := DC0(f13);
	...
	method m6(globalState: GlobalState) returns (r0: multiset<int>, r1: bool, r2: bool) {
		...
		var v1: map<bool, bool> := map[f14 := f14 ==> v0[safeIndex(-0xbf, |v0|)]];
		v1 := v1[f14 := f14];
		var v3: array<map<int, bool>> := new map<int, bool>[15](i1 => map v2 : int | (0x3b0 <= v2) && (v2 < 0x2e5) :: (safeModuloInt(v2, f13)) := (f14));
		forall i0 | 0 <= i0 < v3.Length {
			v3[i0] := map[f16 := f14];
		}
		for i2 := -f12[safeIndex(-f16, |f12|)] to safeModuloInt(-f16, f16) {
			var v4 := 'f';
			r1 := v4 !in ((seq(abs(288), i3  => (v4))) + "ox");
			var v5 := "twmsmcn";
			v5 := (v5 + v5) + "hjytgi";
			...
			v6[safeIndex(458, v6.Length)] := v9;
			v6[safeIndex(458, v6.Length)] := v9;
			var v10: seq<int> := [i2];
			var v11: array<int> := new int[10](i4 => i4 * (if (f13 in v7) then v7[f13] else f16));
			v11[safeIndex(354, v11.Length)] := i2;
			var v12: map<int, seq<int>> := map[i2 := seq(abs(9), i5  => (f13))];
			v10, v11[safeIndex(354, v11.Length)] := v10 + (if (f13 in v12) then v12[f13] else seq(abs(462), i6  => (i2))), f16;
		}
		var i7 := 0;
		while (f14)
			decreases 100 - i7
		{
			...
			var v15: map<seq<int>, string> := map[v14.cf73 := seq(abs(0x9), i8  => ('d'))];
			var v16 := 'b';
			var v17 := DC28(v16);
			...
			v18[safeIndex(876, v18.Length)] := v15;
			...
			var v26 := "nvleyasks";
			v18[safeIndex(876, v18.Length)] := ((if (f14 in v19) then v19[f14] else map v20 : seq<int> | v20 in multiset{(fm89(f13, f13, f14, globalState)).cf73} :: (v20) := (seq(abs(-360), i9  => (v16)))) + v15)[[f16] + [|v25|] := v26];
			v1 := v1[f14 := f14 ==> f14];
			var v27: C10 := new C10(f14, 0x281, !f14, f12, f16);
			var v28 := DC79(f13, v27);
			var v29 := DC40(f16, f14, f16);
			globalState.f5 := -fm2(v28.cf130, DC0(v29.cf76), safeDivisionInt(f16, f13), v27.f19, globalState);
		}
		var v30: array<C5> := new C5[7];
		var v31: array<bool> := new bool[9];
		var v32: seq<array<bool>> := [v31];
		var v33: C5 := new C5(v32, f12);
		v30[safeIndex(151, v30.Length)] := v33;
		v30[safeIndex(151, v30.Length)] := v33;
...
function fm1(p0: int, globalState: GlobalState): char {
	match DC16(92, -|DC74(|map[0xd1 := 0x23a]|, map[set v0 : int | v0 in map[661 := true] :: (safeModuloInt(v0, |multiset(seq(abs(901), i0  => (|map[|map[0x60 := true]| := 494]|)))|)) := map[0x226 := !true]], "uyuylyi").cf125|, [false], 0xf2) {
...
function fm2(p0: int, p1: D0, p2: int, p3: bool, globalState: GlobalState): int {
	|{DC40(|DC74(120, map[{|{false}|} := map v0 : int | (0x149 <= v0) && (v0 < 34) :: (safeDivisionInt(v0, -0x17e)) := (true)], "foqxh").cf125|, !false, -846), DC40(|multiset{false}|, !false, 720), DC40(|multiset{-0x3c8}|, false, --0x24a), DC40(|{true, true}|, true, -543), DC40(0x1b9, false, 0x2d3)}| * |({seq(abs(-31), i0  => (|(seq(abs(0x284), i1  => ('b')))|)), [0x3d8, |{262}|]} * {[-0x1d], [|map[|[550]| := |[0x256]|]|, |"twonrg"|]})|
}
...
function fm14(p0: int, p1: seq<bool>, globalState: GlobalState): string {
	((seq(abs(0x24d), i0  => ('s'))) + "nue") + "ayydts"
}
function fm16(globalState: GlobalState): D3 {
	DC9(map[seq(abs(0x107), i0  => (DC7())) := 'g'])
}
...
function fm28(globalState: GlobalState): set<seq<bool>> {
	({[!false], [true]} - {[false], [true], [false, true], [false, true, !false, false], [false]}) - (if (!!false) then set v0 : seq<bool> | v0 in (seq(abs(-264), i0  => ([true, false]))) :: (v0) else {[!false, true, false, false, true], [true]})
}
...
function fm30(p0: bool, p1: int, globalState: GlobalState): map<int, int> {
	(map[0xf3 := 0x1e3] + map[|"wjuim"| := DC35({DC16(867, |[false]|, [true], |multiset{|(seq(abs(0x370), i0  => ('b')))|}|)}, |map[true := false]|, {76}).cf64]) + (if (true) then map[-0x2fe := -299] else map v0 : int | v0 in [|[false]|] :: (safeModuloInt(v0, |map[-0x1e5 := {true}]|)) := (|"rslvn"|))
}
...
function fm40(p0: bool, p1: int, p2: bool, globalState: GlobalState): set<int> {
	({|multiset{DC7()}|, 0x19e} * {|(seq(abs(0x36b), i0  => (0x190)))|, |[false]|, 0x298}) - {|map[|(seq(abs(0x332), i1  => ('i')))| := 68]|}
}
function fm41(p0: bool, p1: map<int, bool>, p2: seq<bool>, globalState: GlobalState): map<int, char> {
	map[|"teksnqj"| := 'o'] + (if (false) then map[0x2a1 := 'm'] else map v0 : int | v0 in map[--|multiset{['l'], ['o']}| := false] :: (safeDivisionInt(v0, 0x319)) := ('q'))
}
...
function fm43(p0: bool, globalState: GlobalState): map<int, D9> {
	map[-0x71 := DC29(DC27({[true]}))] + (map[245 := DC29(DC28('c'))] + (map v0 : int | (0x70 <= v0) && (v0 < 0x239) :: (safeDivisionInt(v0, |[true]|)) := (DC29(DC29(DC27({[false], [false], [true, false], [true, false, !false, false, false]}))))))
}
...
function fm56(p0: char, p1: bool, p2: bool, globalState: GlobalState): seq<int> {
	[0x37f] + [-|map[|DC14(false, seq(abs(258), i0  => ('w')), |"lsu"|, false, false).cf19| := true]|, |[DC51([map[!true := -0x64]], false, DC18(multiset{false, true, true, false, true})).cf95]|]
}
function fm57(p0: bool, globalState: GlobalState): seq<seq<bool>> {
	(if (DC2(true, 'n', DC43(|map[true := false]|, false, |map[map[|(map v0 : char | v0 in multiset{'u'} :: (v0) := ('y'))| := false] := 0x191]|, {!true}, 0x2a).cf82).cf4) then [[false]] else [[false]]) + ((seq(abs(-0x174), i0  => ([true]))) + [[true, true]])
}
function fm58(p0: bool, globalState: GlobalState): D5 {
	DC15(safeDivisionInt(|{0x1f3}|, -|['y']|), false, !(!!!false && false))
}
...
function fm68(p0: int, globalState: GlobalState): seq<map<int, bool>> {
	([map v0 : int | v0 in [-|[|(seq(abs(-0x2d9), i0  => ('p')))|]|] :: (safeModuloInt(v0, |{true}|)) := (!true), map v1 : int | (0x3da <= v1) && (v1 < -932) :: (safeModuloInt(v1, -0x85)) := (true)] + [map[|(map v2 : map<bool, bool> | v2 in (map v3 : map<bool, bool> | v3 in map[map[true := false] := false] :: (v3) := (false)) :: (v2) := (false))| := false]]) + ([map v4 : int | (-0x386 <= v4) && (v4 < 0x394) :: (v4 * |"joxgyos"|) := (true)] + [map[--0x380 := false], map[-0xcd := true], map[|(seq(abs(44), i1  => ('p')))| := true], map[0xdd := false]])
}
...
function fm72(p0: int, globalState: GlobalState): map<bool, string> {
	(map[true := seq(abs(0x271), i0  => ('b'))] + map[true := "cabhij"]) + map[true := "kwbfu"]
}
...
function fm78(p0: int, globalState: GlobalState): D13 {
	DC39(map[51 := |"syafly"|] + (map v0 : int | (-0x2e <= v0) && (v0 < 0x2b3) :: (safeModuloInt(v0, 880)) := (-|"tm"|)))
}
...
function fm80(p0: bool, globalState: GlobalState): D18 {
	match DC37(!true, true, {"gyoqe"}, 0x6f, [24]) {
		...
		case DC38(cf74) => if (true) then DC51([map[true := |map[|map[false := true]| := -0x208]|], map[false := |map[|{false}| := |[true]|]|], map[true := 0x29e]], false, DC18(multiset{true, false})) else DC51(seq(abs(0x2af), i0  => (map[true := 187])), false, DC18(multiset{false}))
	}
}
...
function fm82(p0: int, p1: int, p2: int, p3: int, globalState: GlobalState): D15 {
	match DC46(false, 'k') {
		...
		case DC48(cf91) => DC43(-0x21, false, 0x295, {true}, |(seq(abs(0x17e), i0  => ('m')))|)
	}
}
...
function fm85(p0: int, p1: bool, globalState: GlobalState): seq<map<bool, int>> {
	([map[true := |['v']|], map[true := |map[true := 'c']|]] + [map[false := -0x2ad]]) + [map[false := |multiset{false, false}|], map[false := |map[false := 'm']|], map[true := -372], map[true := |(seq(abs(307), i0  => ('q')))|], map[!true := |{false}|]]
}
function fm86(p0: bool, p1: bool, globalState: GlobalState): set<string> {
	{seq(abs(0x3b1), i0  => ('g')), "ao", "lgxsqxsr", seq(abs(0x341), i1  => ('n')), "xridsprdx"} * (set v0 : string | v0 in (seq(abs(0x3c3), i2  => ("qxljabs"))) :: (v0))
}
...
function fm88(p0: int, p1: D9, globalState: GlobalState): map<seq<int>, string> {
	map[[|[DC66(), DC66(), DC66()]|] := seq(abs(0x26d), i0  => ('h'))] + (map v0 : seq<int> | v0 in map[[|map[0xb6 := |(seq(abs(0x367), i1  => ('r')))|]|, |map[false := 'm']|] := [false, true]] :: (v0) := ("ndefukifj"))
}
function fm89(p0: int, p1: int, p2: bool, globalState: GlobalState): D12 {
	DC37(multiset{|(map v0 : int | (0x3c0 <= v0) && (v0 < 0x196) :: (v0 + |(seq(abs(474), i0  => ('b')))|) := (|[250, -819]|))|} <= multiset{|map[false := true]|}, {{false, false, false}} >= {{true}}, (set v1 : string | v1 in map["xdwsyqja" := DC43(0x201, false, |multiset{0x2d0}|, {true, false}, |multiset{false, true}|).cf82] :: (v1)) - {"gdssw"}, |"tbynwhrwt"|, seq(abs(0x2ea), i1  => (-0x6f)))
}
function fm90(globalState: GlobalState): D5 {
	DC16(-(|(map v0 : int | (0x346 <= v0) && (v0 < 0x318) :: (safeDivisionInt(v0, |map[true := 'h']|)) := (0x3c4))| * |[true]|), |[!!!true, true, true, !false, true]|, [true], -|(map v1 : int | v1 in DC37(true, !false, {"vftke"}, |(seq(abs(0x1cc), i0  => ('k')))|, seq(abs(0x20c), i1  => (520))).cf73 :: (safeDivisionInt(v1, 0x10c)) := (false))|)
}
...
method m0(p0: bool, globalState: GlobalState) {
	...
	match (v6.(cf20 := safeDivisionInt(v3, v3), cf22 := p0)) {
		case DC14(cf18, cf19, cf20, cf21, cf22) =>
			var v7 := new C8();
			var v8: C10 := new C10(p0, cf20, p0, v2, safeModuloInt(cf20, v3));
			v8 := v8;
		...
		case DC15(cf23, cf24, cf25) =>
			...
			v17[safeIndex(453, v17.Length)] := v3;
			v17[safeIndex(453, v17.Length)] := v3;
			...
			if (if (cf23 in v19) then v19[cf23] else !cf24) {
				var v20: multiset<int> := multiset{v3, cf23, v3, v17[safeIndex(453, v17.Length)]};
				var v21: T1 := new C10(false, cf23, cf25, v2, cf23);
				var v22: array<T1> := new T1[3] [v21, v21, v21];
				var v23: C6 := new C6(cf23, v20, v22, v17[safeIndex(453, v17.Length)], cf24, v2);
				...
				v31[safeIndex(728, v31.Length)] := p0;
				...
				var v38: T3 := new C1(cf23, cf24, v2, v17[safeIndex(453, v17.Length)]);
				var v39: map<T3, int> := map[v38 := v3];
				v17[safeIndex(453, v17.Length)], cf25, cf25, v31[safeIndex(728, v31.Length)], cf24 := |v36[safeIndex(cf23, |v36|) := v35]| - safeModuloInt(|v37|, v3), fm0(cf23, cf25 && p0, p0, globalState), fm0(v17[safeIndex(453, v17.Length)] * v17[safeIndex(453, v17.Length)], true, p0, globalState), v38 !in v39, p0;
				cf25 := true;
				globalState.f5 := cf23;
				v31 := v31;
				cf23 := cf23;
			...
			var v43 := new C11(fm0(v17[safeIndex(453, v17.Length)], cf25, p0, globalState), p0, v40, cf23, true, v2);
		case DC16(cf26, cf27, cf28, cf29) =>
			var v44: array<seq<C1>> := new seq<C1>[20];
			var v45: map<int, bool> := map[cf29 := p0];
			var v46 := DC40(|(seq(abs(-223), i0  => ('u')))|, p0, cf27);
			var v47: C1 := new C1(|v45|, v46.cf77, [cf29], cf26);
			var v48: seq<C1> := [v47, v47];
			v44[safeIndex(398, v44.Length)] := v48[safeIndex(cf29, |v48|) := v47];
			v44[safeIndex(398, v44.Length)] := v48 + v48;
			var v49 := false;
			var v50: set<bool> := {v49};
			v49 := {v47.fm7(globalState), v49, v49, p0, p0} != v50;
			var v51 := new C10(p0, cf27, p0, seq(abs(75), i1  => (cf26)), cf29);
			cf29 := -cf26;
		case DC13(cf17) =>
			v0 := v0;
			if (p0) {
				v4 := v4[v3 := v2[safeIndex(v3, |v2|)]];
				var v52: seq<string> := [v0, v0];
				var v53: map<bool, bool> := map[p0 := p0];
				var v54: set<string> := {v0, v52[safeIndex(|v53|, |v52|)], v0};
				...
				v72[safeIndex(5, v72.Length)] := v70;
				var v73: C3 := new C3(!v64, v3, !v64, v2);
				var v74: seq<C3> := [v73, v73];
				v72[safeIndex(5, v72.Length)] := if (fm0(|v74|, v73.f24, v73.f24, globalState)) then v70 else v70;
				var v75: array<bool> := new bool[13];
				v75[safeIndex(7, v75.Length)] := v73.f24;
				v75[safeIndex(7, v75.Length)] := if (false) then if (v64) then v73.f24 else p0 else false;
			}
			...
			var v81: C7 := new C7(v2, v80[safeIndex(v78.f13, |v80|)], |fm40(v78.f14, v3, v78.f14, globalState)|, v78.f14);
			...
			v82[safeIndex(567, v82.Length)] := v81;
			v82[safeIndex(567, v82.Length)] := v81;
			var v83: array<bool> := new bool[18];
			var v84: seq<array<bool>> := [v83];
			var v85 := DC31(v78.f13, v83, p0, v78.f14, v3);
			var v86: array<array<bool>> := new array<bool>[17] [v84[safeIndex(v78.f13, |v84|)], v83, v83, v83, v85.cf53, v83, v83, v83, v83, v83, v83, v83, v83, v83, v83, v83, v83];
			var v87 := DC34(v86);
			match (v87) {
				case DC35(cf63, cf64, cf65) =>
					...
					v3 := safeDivisionInt(|v93|, |cf65|) - v78.f13;
				case DC36(cf66, cf67, cf68) =>
					globalState.f5 := safeModuloInt(v78.f13, |(seq(abs(801), i2  => ('p')))|);
					v1 := (multiset(v76))[cf67 := abs(|"fpujy"|)] * (v1 - v1);
					var v94: map<bool, string> := map[p0 := v0];
					var v95: seq<string> := ["bgqttwnsw"];
					var v97 := 'r';
					var v98: set<string> := {v0[safeIndex(|v0|, |v0|) := v97]};
					var v99: set<bool> := {true};
					var v100: set<set<bool>> := {v99};
					var v101: T0 := new C3(v81.fm7(globalState), |v100|, v78.f14, [99]);
					var v102: seq<T0> := [v101];
					cf67 := ({if (cf66 in v94) then v94[cf66] else "jabmwpk"} + (set v96 : string | v96 in v95 :: (v96))) >= (v98 - (set v103 : string | v103 in v95[safeIndex(|v102|, |v95|) := v0] :: (v103)));
					...
					var v108: array<int> := new int[21] [v78.f13, v78.f13, |(if (!v78.f14) then v94 else v94)|, v78.f13, safeModuloInt(v3, v3), v78.f13, v78.f13, v104.cf34, 0x1ec, v78.f13, v78.f13, safeDivisionInt(v78.f13, v78.f13), v3, v78.fm6(globalState), if (p0) then -|v0| else |v0|, v101.fm5(p0, "lupu", v105[v78.f13 := abs(-|v106|)], globalState), v3, -0x288, v78.f13, |v106| + v3, |(v107 + fm59(!cf67, globalState))|];
					v108[safeIndex(749, v108.Length)] := v78.f13 + v3;
					v108[safeIndex(749, v108.Length)] := v3;
				case DC37(cf69, cf70, cf71, cf72, cf73) =>
					...
					var v111: array<array<int>> := new array<int>[8] [v109, v109, v109, v109, if (cf70) then v109 else v109, v109, v109, v110[safeIndex(v3, |v110|)]];
					v111[safeIndex(813, v111.Length)] := v109;
					...
					v83[safeIndex(216, v83.Length)] := !v116.fm9(cf69, globalState);
					v111[safeIndex(813, v111.Length)], v116, v117, v83[safeIndex(216, v83.Length)] := v109, DC87(v116).cf142, fm70(v113.fm7(globalState), globalState), !v113.f14;
					v0 := v0;
					var v118: C8 := new C8();
					v118 := v118;
					v109[safeIndex(38, v109.Length)] := |(v0 + v0)|;
					v109[safeIndex(38, v109.Length)] := v78.f13 * v3;
				case DC34(cf62) =>
					v83[safeIndex(654, v83.Length)] := p0;
					v83[safeIndex(654, v83.Length)] := v81.fm9(v78.f14, globalState);
					...
					v83[safeIndex(654, v83.Length)] := v121 > (DC49(v121).cf92 + v121);
					globalState.f5 := -v78.f13;
				case DC38(cf74) =>
					var v122 := DC1(v81.fm9(p0, globalState));
					v122 := DC1(p0).(cf1 := p0);
					var v123: array<int> := new int[1](i4 => i4 + v78.f13);
					v123[safeIndex(364, v123.Length)] := v78.f13;
					var v124 := 'v';
					var v125: map<char, int> := map[v124 := v78.f13];
					var v126: seq<map<char, int>> := [v125, v125];
					var v127: map<int, bool> := map[v3 := true];
					v123[safeIndex(364, v123.Length)] := -v78.f12[safeIndex(|(fm91(fm14(960, v76, globalState), v3, p0, v3, globalState) + v126[safeIndex(|v127|, |v126|)])|, |v78.f12|)];
					var v128: seq<D34> := [DC84(v78.f13, v124, v78.f14)];
					var v129: multiset<int> := multiset{v123[safeIndex(364, v123.Length)], |v128|, v3, v78.f13, v78.f13};
					var v130: map<bool, int> := map[p0 := -|v0|];
					var v131 := new C6(|v129|, (multiset{v78.f13})[|v2| := abs(v123[safeIndex(364, v123.Length)])] + multiset{v78.f13}, v77, v3, v130 != v130, v78.f12 + v78.f12);
		...
		case DC17(cf30) =>
			...
			var v141 := true;
			v141, globalState.f5, v136 := v0[safeIndex(v2[safeIndex(v3, |v2|)], |v0|) := 'd'] < "idojeqgy", safeDivisionInt(-v3, v3), if (v136.fm7(globalState)) then v136 else v136;
			v141 := v141;
	}
	...
	for i5 := |(v144 + v144)| to v3 {
		...
		v146[safeIndex(989, v146.Length)] := v0 + "snqtbmd";
		var v147: set<bool> := {!p0};
		var v148 := DC43(v3, p0, i5, v147, v3);
		var v149: map<bool, string> := map[v148.cf82 := v0];
		v145, v146[safeIndex(989, v146.Length)] := v145, if (p0 in v149) then v149[p0] else v0;
		var v150 := true;
		v150 := p0;
	...
	var v152 := DC0(v3);
	var v153: array<int> := new int[26](i8 => safeModuloInt(i8, v3));
	var v154: set<array<int>> := {v153};
	var v155 := 'p';
	var v156: multiset<char> := multiset{v155};
	var v157: seq<bool> := [true, p0];
	var v158: seq<seq<bool>> := [v157[safeIndex(v3, |v157|) := p0], v157, [p0, p0]];
	var v159 := DC88(v158);
	...
	v153[safeIndex(257, v153.Length)] := v3;
	var v161: set<int> := {v3, v3};
	v153[safeIndex(257, v153.Length)] := fm2((fm92(p0, v3, v3, 863, globalState)).cf59, v152, fm2(v3, DC0(-|v161|), 422, true, globalState), p0, globalState);
		...
		decreases 100 - i9
	{
		...
		v164 := v164[(v2[safeIndex(0x3d7, |v2|) := v153[safeIndex(257, v153.Length)]])[safeIndex(v3, |v2[safeIndex(0x3d7, |v2|) := v153[safeIndex(257, v153.Length)]]|) := v3] := v3];
		var v165 := DC54(v153, v3);
		var v166 := DC22(v155, p0, -|v0|, |v2|, v153[safeIndex(257, v153.Length)]);
		var v167: array<D7> := new D7[25] [v166, v166, v166, v166, v166, v166, DC22(v155, p0, |multiset(v157)|, v153[safeIndex(257, v153.Length)], v153[safeIndex(257, v153.Length)]), v166, v166, v166, v166, v166, DC22(v0[safeIndex(v3, |v0|)], false, v153[safeIndex(257, v153.Length)], v3, v153[safeIndex(257, v153.Length)]), v166, v166, v166, v166, v166, DC22(v155, p0, 0xec, v2[safeIndex(v153[safeIndex(257, v153.Length)], |v2|)], v153[safeIndex(257, v153.Length)]), v166, fm76(globalState), v166, v166, v166, v166];
		var v168 := DC78(v167);
		var v169: map<D32, bool> := map[v168 := p0];
		v160, v2 := v165.cf99, [|v169|] + [v153[safeIndex(257, v153.Length)]];
		var v170 := DC18(v1);
		var v171 := DC18(v170.cf31);
		var v172: map<int, D6> := map[v153[safeIndex(257, v153.Length)] := v170];
		v172 := v172;
	}
}
method Main() {
	...
	if (true) {
		...
		v8[safeIndex(207, v8.Length)] := |v10|;
		v8[safeIndex(207, v8.Length)] := v4;
		var v11: array<int> := new int[16](i0 => i0 - v8[safeIndex(207, v8.Length)]);
		v9[safeIndex(633, v9.Length)] := v11;
		v5, v9[safeIndex(633, v9.Length)], v2, v2 := v5 + ("qyh" + "sudmbem"), v11, !!v2, v2;
		m0(v2, globalState);
		if (v2) {
			var v12: map<D0, int> := map[v7 := -v4];
			globalState.f5 := -(if (v2) then if (v2) then if (v7 in v12) then v12[v7] else v4 else v4 else v8[safeIndex(207, v8.Length)]);
			var v13: map<bool, string> := map[true := v5];
			var v14 := 'm';
			var v15: seq<string> := [(if (v2 in v13) then v13[v2] else seq(abs(324), i1  => ('x')))[safeIndex(v4, |(if (v2 in v13) then v13[v2] else seq(abs(324), i1  => ('x')))|) := v14]];
			var v16: map<bool, string> := map[false := v15[safeIndex(-0xed, |v15|)]];
			var v17: map<bool, int> := map[fm0(v8[safeIndex(207, v8.Length)], v2, false, globalState) := v4];
			var v18: map<int, map<bool, int>> := map[v8[safeIndex(207, v8.Length)] := v17];
			globalState.f5 := |(((if (v2 in v16) then v16[v2] else v5) + v5) + (v5 + "tcsx"))[safeIndex(|(if (v4 in v18) then v18[v4] else v17)|, |(((if (v2 in v16) then v16[v2] else v5) + v5) + (v5 + "tcsx"))|) := v14]|;
			v2 := v2;
			v8[safeIndex(207, v8.Length)] := v4;
			v2, v7 := safeModuloInt(v4, |v5|) == (if (false) then 0x2b4 else v8[safeIndex(207, v8.Length)]), if (v2) then v7 else v7;
		} else {
			var v19 := 'l';
			var v20: array<char> := new char[25] [v19, v19, v19, 'i', v19, v19, v19, v19, v19, fm1(fm2(0x2b2, v7, -855, v2, globalState), globalState), v19, v5[safeIndex(v4, |v5|)], v19, v19, v19, v19, v19, v19, v19, v19, 'e', v19, v19, 'f', 's'];
			var v21: map<array<char>, char> := map[v20 := v19];
			v21 := map[v20 := v19] + map[v20 := v19];
			var v22: array<seq<int>> := new seq<int>[11];
			v22[safeIndex(671, v22.Length)] := v10;
			v22[safeIndex(671, v22.Length)], v2 := v10, v2;
			globalState.f0 := v19;
			...
			v8[safeIndex(207, v8.Length)] := if (v5 in v25) then v25[v5] else -v8[safeIndex(207, v8.Length)];
		}
		...
		v8[safeIndex(460, v8.Length)], globalState.f5, v7, v2, v2 := -v4, v4, fm3(v26[safeIndex(v4, |v26|)], globalState), !v2, if (v8 in v27) then v27[v8] else v2;
		var v28: seq<array<bool>> := [v0, v0];
		var v29: seq<int> := [|map[v2 := v2]|];
		var v30 := new C5(v28, v29);
		var v31: map<bool, array<bool>> := map[v2 := v0];
		v2 := fm0(|v31|, v26[safeIndex(v4, |v26|)], v2, globalState);
		v4 := v8[safeIndex(460, v8.Length)] * v8[safeIndex(460, v8.Length)];
		...
		decreases 100 - i2
	{
		...
		var v38: map<bool, seq<T1>> := map[v37[safeIndex(v34.f13, |v37|)] := v35];
		var v39: array<seq<T1>> := new seq<T1>[7] [v35, v36[safeIndex(v4, |v36|)], v35, v35, if (v2 in v38) then v38[v2] else v35, if (v2) then v35 else v35, v35];
		v39[safeIndex(286, v39.Length)] := v35 + v35[safeIndex(0x3c4, |v35|) := v34];
		var v40: map<seq<D2>, char> := map[seq(abs(-0xb4), i3  => (DC7())) := fm1(v4, globalState)];
		var v41 := DC9(v40);
		...
		globalState.f5, v39[safeIndex(286, v39.Length)], v42, globalState.f5, v2 := safeModuloInt(safeDivisionInt(v34.f13, v4), |v45|), v36[safeIndex(v34.f13, |v36|)], v42, v4, v2;
		v0[safeIndex(115, v0.Length)] := |v45| < v34.f13;
		v8[safeIndex(144, v8.Length)] := v4;
		v43, v34, v0[safeIndex(115, v0.Length)], v8[safeIndex(144, v8.Length)] := v43, if (fm0(v4, !!v34.f14, v34.f14, globalState)) then v34 else v34, v34.f14, v4;
		var v46: set<int> := {v4};
		var v47: map<map<bool, set<int>>, int> := map[map[v0[safeIndex(115, v0.Length)] := v46] := v8[safeIndex(144, v8.Length)]];
		var v48: seq<set<int>> := [v46, v46];
		var v49: map<bool, set<int>> := map[true := v48[safeIndex(v8[safeIndex(144, v8.Length)], |v48|)]];
		v47 := v47[map[v34.f14 := v46] + v49 := v4];
		if (v34.f14) {
			v0[safeIndex(115, v0.Length)] := !(if (v0[safeIndex(115, v0.Length)]) then v34.f14 else if (v34.f14) then v34.f14 else !v34.fm7(globalState));
			var v50 := DC50(v2);
			var v51: map<bool, bool> := map[v34.f14 := v0[safeIndex(115, v0.Length)]];
			var v52: multiset<int> := multiset{v8[safeIndex(144, v8.Length)]};
			var v53: map<seq<int>, multiset<int>> := map[[|v37|] := v52];
			var v54: array<bool> := new bool[21] [v34.f14, |v5| == v4, v50.cf93, !v34.f14, v34.f14, v2, v34.f14, v34.fm7(globalState), v34.f13 >= v4, false || v34.f14, v34.f14, v0[safeIndex(115, v0.Length)], v0[safeIndex(115, v0.Length)], v0[safeIndex(115, v0.Length)], v0[safeIndex(115, v0.Length)], if (v34.f14 in v51) then v51[v34.f14] else v0[safeIndex(115, v0.Length)], v0[safeIndex(115, v0.Length)] in v3, "juqibioi" <= v5, true ==> !v0[safeIndex(115, v0.Length)], v34.f12 !in v53, v34.f14];
			globalState.f9 := v54;
			var v55 := 'u';
			v2 := (v34.f12 + v34.f12) != fm56(v55, v34.f14, v0[safeIndex(115, v0.Length)], globalState);
			var v56: map<D23, bool> := map[DC63(v34) := true];
			var v57: seq<map<D23, bool>> := [v56, v56];
			var v58 := DC63(v34);
			var v59: map<char, map<D23, bool>> := map[fm1(|v37[safeIndex(v4, |v37|) := v34.f14]|, globalState) := map[v58 := v34.f14]];
			var v60 := DC80(map[v58 := false]);
			var v61: array<map<D23, bool>> := new map<D23, bool>[17] [v56 + v56, v57[safeIndex(v8[safeIndex(144, v8.Length)], |v57|)], v56, v56 + (if (v55 in v59) then v59[v55] else v56), v56, map[v58 := !v34.f14], v56 + v56, v56 + v56, (map[v58 := true])[DC63(v34) := v34.f14], v56, map[v58 := v43.fm7(globalState)], v56, v56, v56, v56 + v56, v60.cf132, v56];
			v61[safeIndex(624, v61.Length)] := v56;
			v61[safeIndex(624, v61.Length)] := v56;
			...
			v63, v8[safeIndex(144, v8.Length)] := v63, safeDivisionInt(-safeModuloInt(v8[safeIndex(144, v8.Length)], v34.f13), v4 * |v65.cf75|);
		} else {
			v2 := !true;
			...
			var v70: array<C2> := new C2[16] [if (v0[safeIndex(115, v0.Length)]) then v69 else v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, v69, if (false) then v69 else v69];
			v70[safeIndex(594, v70.Length)] := if (!v0[safeIndex(115, v0.Length)]) then v69 else v69;
			var v71: map<int, C2> := map[0x210 := v69];
			v70[safeIndex(594, v70.Length)] := if ((v34.f13 * -|v37|) in v71) then v71[v34.f13 * -|v37|] else v69;
			var v72 := new C4(v8[safeIndex(144, v8.Length)] * v34.f13, !v34.f14, [v34.f13]);
	...
	match (fm29(v4, v2, fm0(v4, v2, v2, globalState), !v74[safeIndex(v4, |v74|)], globalState)) {
		case DC28(cf49) =>
			globalState.f5 := |[|v5[safeIndex(v4, |v5|) := cf49]|, v4]|;
			...
			v0[safeIndex(782, v0.Length)], v80, v2, v5, v0 := v2, v81[safeIndex(v4, |v81|)], (v6 - v6) >= v6, (v5 + v5) + (if (v2) then v5 else v5), v0;
			var v82: C4 := new C4(v4, v2, seq(abs(0x105), i4  => (v4)));
			var v83: map<C4, bool> := map[v82 := v2];
			if (v74[safeIndex(|v83|, |v74|)]) {
				m0(v0[safeIndex(782, v0.Length)] ==> v2, globalState);
				globalState.f5 := v4;
				var v84: set<int> := {v4};
				var v85: map<set<int>, bool> := map[v84 := fm0(v4, v2, v0[safeIndex(782, v0.Length)], globalState)];
				v2, v4, v2, v4, v85 := v4 >= v4, v4, v0[safeIndex(782, v0.Length)], v4 + 0x133, v85 + v85;
				v82.m16(v74 + v74, globalState);
				m0(v2, globalState);
			} else {
				var v86: multiset<int> := multiset{0x22a, v4};
				v86 := (if (v74[safeIndex(v4, |v74|)]) then multiset([v4, v4, -|v5|]) else v86)[v4 := abs(v4)];
				var v87: C1 := new C1(0x22a, v2, v78.f12, |v74|);
				var v88: map<C1, int> := map[v87 := v4];
				var v89: map<multiset<bool>, int> := map[v3 := |v88|];
				var v90: map<map<multiset<bool>, int>, bool> := map[v89 := v0[safeIndex(782, v0.Length)]];
			...
			v0[safeIndex(782, v0.Length)] := v2;
		case DC27(cf48) =>
			v8[safeIndex(809, v8.Length)] := v4;
			v8[safeIndex(809, v8.Length)] := v4;
			var v95: set<int> := {v4};
			var v96: map<int, bool> := map[v4 := !v2];
			var v97 := DC16(v8[safeIndex(809, v8.Length)], |v96|, v74, v4);
			var v98: set<D5> := {v97, fm90(globalState)};
			var v99 := DC35(v98, 409, v95);
			v2 := v95 >= v99.cf65;
			v0[safeIndex(164, v0.Length)] := v2;
			v0[safeIndex(164, v0.Length)] := v2;
			var v100 := DC5(DC4(v2, 693, v0[safeIndex(164, v0.Length)]));
			var v101 := DC5(v100);
			var v102: map<D1, bool> := map[v101.(cf10 := v100) := |v74| > v4];
			v102 := (v102 + v102)[v101 := (set v103 : int | (0x2b9 <= v103) && (v103 < 0x17) :: (v103 * v8[safeIndex(809, v8.Length)])) <= v95];
		case DC29(cf50) =>
			var v104: map<bool, int> := map[v2 := v4];
			var v105: seq<map<bool, int>> := [v104];
			var v106: multiset<int> := multiset{|v105[safeIndex(v4, |v105|)]|, v4, -v4};
			var v107: seq<int> := [v4];
			globalState.f5 := if ((v107[safeIndex(v4, |v107|)] - |multiset{v2}|) in v106) then v106[v107[safeIndex(v4, |v107|)] - |multiset{v2}|] else v4;
			var v108: seq<array<bool>> := [v0];
			var v109 := new C5(v108 + v108, v107 + v107);
			v0[safeIndex(386, v0.Length)] := if (v2) then v2 else v2;
			v0[safeIndex(386, v0.Length)] := !false;
			globalState.f5 := v109.fm33([v2, v2, v0[safeIndex(386, v0.Length)]], v109.fm5(v2, v5, v106, globalState), v2, !!v2, globalState) - (v4 - v4);
	}
	...
	for i7 := 761 to v4 {
		v2 := !v2;
		globalState.f5 := safeDivisionInt(-v4, i7) * i7;
		v2, v4 := v2, safeDivisionInt(v4, v4) - i7;
		var v113 := DC40(i7, v3 >= v3, safeDivisionInt(-v4, i7));
		var v114 := DC15(v4, v2, true);
		v113 := v113.(cf77 := v2, cf78 := v114.cf23);
	}
	var v115: array<array<bool>> := new array<bool>[14];
	v115[safeIndex(661, v115.Length)] := v0;
	v115[safeIndex(661, v115.Length)] := v0;
	var i8 := 0;
	while (v2)
		decreases 100 - i8
	{
		...
		var v120 := DC43(safeDivisionInt(v4, -v4), v2, |v119|, v6, -v4 - v4);
		match (v120) {
			case DC43(cf81, cf82, cf83, cf84, cf85) =>
				...
				v126[safeIndex(373, v126.Length)] := v125;
				v126[safeIndex(373, v126.Length)] := v125;
			...
			case DC42(cf80) =>
				...
				v129[safeIndex(192, v129.Length)] := v128;
				v129[safeIndex(192, v129.Length)] := DC5(v127);
	...
	if (true) {
		...
		var v134 := DC83(v133);
		var v136: map<multiset<T1>, set<int>> := map[v134.cf136 := set v135 : int | (0x320 <= v135) && (v135 < 0x3c7) :: (safeDivisionInt(v135, v132.f13))];
		v136 := v136;
		v8[safeIndex(824, v8.Length)] := |v5|;
		var v138: map<string, bool> := map["gctd" := v132.f14];
		v2, v8[safeIndex(824, v8.Length)], globalState.f5 := |(map v137 : string | v137 in (set v139 : string | v139 in v138 :: (v139)) :: (v137) := ('h'))| > safeDivisionInt(v132.f13, v4), v132.f13, v132.f13;
		m0(v2, globalState);
		var v140 := 'o';
		v5 := v5[safeIndex(v132.f13, |v5|) := v140] + v5;
		if (fm0(v8[safeIndex(824, v8.Length)], v132.f14, v2, globalState)) {
			var v141: set<string> := {"aqa", (seq(abs(52), i10  => (v140)))[safeIndex(v4, |(seq(abs(52), i10  => (v140)))|) := v140], v5, v5, v5};
			v2 := v141 > v141;
			var v142 := DC63(v132);
			...
			v144 := v144;
			v2 := v132.f14;
			var v145: multiset<int> := multiset{--v8[safeIndex(824, v8.Length)], v132.f13};
			v0[safeIndex(57, v0.Length)] := v145 < v145;
			v0[safeIndex(57, v0.Length)] := (set v146 : int | v146 in v145 :: (safeDivisionInt(v146, 350))) !! (set v147 : int | v147 in multiset{v132.fm6(globalState)} :: (v147 - 0x4c));
			v8[safeIndex(824, v8.Length)] := safeDivisionInt(v4, -v4 + |v5|);
		} else {
			m0(v132.f14, globalState);
			globalState.f5 := v4;
			v0[safeIndex(64, v0.Length)] := v2;
			...
			var v154 := DC74(v132.f13, v153, seq(abs(0x18d), i11  => (v140)));
			globalState.f5, v5, v0[safeIndex(64, v0.Length)], v8[safeIndex(824, v8.Length)], v151 := v4, fm14(v154.cf123, v74, globalState) + v5, v132.f14, |v3|, v151;
			v0[safeIndex(64, v0.Length)] := v132.f14 <== v132.f14;
		...
		v2 := true;
		globalState.f0 := v5[safeIndex(v4, |v5|)];
		v115[safeIndex(661, v115.Length)][safeIndex(733, v115[safeIndex(661, v115.Length)].Length)] := v2;
		v115[safeIndex(661, v115.Length)][safeIndex(733, v115[safeIndex(661, v115.Length)].Length)] := v2;
		v115[safeIndex(661, v115.Length)][safeIndex(733, v115[safeIndex(661, v115.Length)].Length)] := v2;
		v1[safeIndex(889, v1.Length)] := v112;
		v1[safeIndex(889, v1.Length)] := v112 * v112;
	}
		...
		decreases 100 - i12
	{
		...
		i12 := i12 + 1;
		v9[safeIndex(284, v9.Length)] := if (v2) then v8 else v8;
		var v156: C10 := new C10(v2, v4, v2, seq(abs(-255), i13  => (v4)), -v4);
		var v157 := DC76(v156);
		var v158 := DC54(v8, v4);
		var v159: map<bool, C10> := map[v2 := v156];
		globalState.f5, v9[safeIndex(284, v9.Length)], v5, v157 := v4, v158.cf99, "ldghem" + v5, DC76(v156).(cf127 := if (fm0(v4, v2, v156.f19, globalState) in v159) then v159[fm0(v4, v2, v156.f19, globalState)] else v156);
		v156.f19 := v2 && false;
		var v160, v161, v162 := v156.m9(globalState);
		v9[safeIndex(284, v9.Length)][safeIndex(75, v9[safeIndex(284, v9.Length)].Length)] := v161;
		var v163: multiset<int> := multiset{v162};
		var v164: set<string> := {v5, v5, v5, v5, ("y")[safeIndex(v4, |"y"|) := v5[safeIndex(if (-v161 in v163) then v163[-v161] else |v5|, |v5|)]]};
		var v165: map<bool, set<string>> := map[0x2ed > v162 := v164 * v164];
		v9[safeIndex(284, v9.Length)][safeIndex(75, v9[safeIndex(284, v9.Length)].Length)] := |(if (!v156.f19 in v165) then v165[!v156.f19] else {v5, v5, v5, v5} - v164)|;
	}
	if (v2) {
		var v166 := DC77(v4);
		...
		globalState.f5 := |v167| * --safeDivisionInt(|v171|, v170.f16);
		var v172: map<int, bool> := map[safeModuloInt(v170.f16, v170.f16) := v2];
		v172 := v172;
		v4 := -0x91;
		var v173: array<seq<bool>> := new seq<bool>[5];
		v173[safeIndex(505, v173.Length)] := v74 + [v170.f14, v2, true];
		v173[safeIndex(505, v173.Length)] := v74;
		...
		var v177: multiset<seq<bool>> := multiset{v173[safeIndex(505, v173.Length)]};
		...
		v2 := !(v180 >= v180);
		var v182 := DC40(v4, true, |(set v181 : int | (0x298 <= v181) && (v181 < 0x24b) :: (safeModuloInt(v181, v4)))|);
		v8[safeIndex(771, v8.Length)] := v182.cf78;
		v8[safeIndex(771, v8.Length)] := -v4;
	}
	...
	v185 := (map v186 : int | v186 in v188 :: (safeDivisionInt(v186, -v4)) := (v183))[fm2(15, v7, if (v2 in v3) then v3[v2] else v4, !v2, globalState) := v183 + map[v4 := fm0(v4, false, v2, globalState)]];
	for i14 := v4 to v4 {
	...
	if (v4 < v4) {
		...
		v193[safeIndex(641, v193.Length)] := map[v2 := v8];
		v193[safeIndex(641, v193.Length)] := v192 + v192;
		m0(v112 == v112, globalState);
		if (fm0(safeDivisionInt(v4, v4), !v2, !(v188 < v188), globalState)) {
			var v194 := new C12(safeModuloInt(v4, |v5|), |v112|, !(true in v74[safeIndex(v4, |v74|) := v2]), v188);
			globalState.f5 := v188[safeIndex(-v4, |v188|)];
			var v195: array<seq<int>> := new seq<int>[12](i15 => seq(abs(135), i16  => (-0x10b)));
			v195[safeIndex(390, v195.Length)] := v188;
			var v196: map<int, int> := map[v4 := 0x3df];
			var v197: map<int, seq<int>> := map[|v196[v4 := v4]| := v188];
			v74, v195[safeIndex(390, v195.Length)] := v74, if (-0x15a in v197) then v197[-0x15a] else [v4, |v188|];
			v2 := v2;
			var v198 := 'd';
			var v199 := DC46(v2, v198);
			var v200: set<string> := {"jc"};
			var v201 := DC37(v2, v199.cf88, v200, v4, [v4, 0x30, v4]);
			v188 := v188 + (if (v2) then v201.cf73 else ([v4, |v5|])[safeIndex(303, |[v4, |v5|]|) := v4]);
		} else {
			v2 := v2;
			globalState.f5 := fm2(0xb3, v7, v4, v2, globalState);
			var v202: T0 := new C3(v2, safeModuloInt(v4, v4), v2, seq(abs(0xa7), i17  => (v4)));
		...
		var v205 := new C1(|v5|, fm2(v4, v7, v4, v2, globalState) <= 0x3e4, v188 + (seq(abs(391), i18  => (v4))), v4);
		if (v2) {
			v2 := v2;
			...
			var v208, v209, v210, v211 := v205.m3(v2 && !v74[safeIndex(v4, |v74|)], map[v8 := v74], false && v2, v207, globalState);
			v8 := v8;
			v2 := v2;
		} else {
			v8[safeIndex(463, v8.Length)] := v4;
			v8[safeIndex(463, v8.Length)] := -(v205.fm5(v2, seq(abs(565), i19  => ('o')), v187, globalState) * -0x2a5);
			...
			v8[safeIndex(463, v8.Length)] := |{v8[safeIndex(463, v8.Length)] + v8[safeIndex(463, v8.Length)], |v214[safeIndex(v8[safeIndex(463, v8.Length)], |v214|)]|, |v74| + v4}|;
			var v215: array<int> := new int[11](i20 => i20 * v188[safeIndex(v212.f20, |v188|)]);
			var v216: seq<array<int>> := [v215, v215];
			var v217 := new C4(v8[safeIndex(463, v8.Length)], [v215] <= v216, v188);
			globalState.f9 := v115[safeIndex(661, v115.Length)];
		}
		
		globalState.f5 := v4;
		var v218 := DC44(v184 + v184);
		v2, v218 := (if (v2) then v188[safeIndex(394, |v188|)] else v4) != v4, v218;
		var v219 := 't';
		globalState.f0 := v219;
	}
	...
	m0(|(seq(abs(0x259), i21  => ('l')))| <= |([v4])[safeIndex(|v221|, |[v4]|) := v4]|, globalState);
	print v0[9], "\n";
	print v0[10], "\n";
	print v2, "\n";
	...
	print globalState.f6 == multiset{true}, "\n";
	print globalState.f7, "\n";
	print globalState.f8, "\n";
	print globalState.f9[9], "\n";
	print globalState.f9[10], "\n";
	print globalState.f10[0][0], "\n";
	print globalState.f10[0][1], "\n";
	print globalState.f10[0][2], "\n";
	print globalState.f10[0][3], "\n";
	print globalState.f10[0][4], "\n";
	print globalState.f10[0][5], "\n";
	print globalState.f10[0][6], "\n";
	print globalState.f10[0][7], "\n";
	print globalState.f10[0][8], "\n";
	print globalState.f10[0][9], "\n";
	print globalState.f10[0][10], "\n";
	print globalState.f10[0][11], "\n";
	print globalState.f10[0][12], "\n";
	print globalState.f10[1][0], "\n";
	print globalState.f10[1][1], "\n";
	print globalState.f10[1][2], "\n";
	print globalState.f10[1][3], "\n";
	print globalState.f10[1][4], "\n";
	print globalState.f10[1][5], "\n";
	print globalState.f10[1][6], "\n";
	print globalState.f10[1][7], "\n";
	print globalState.f10[1][8], "\n";
	print globalState.f10[1][9], "\n";
	print globalState.f10[1][10], "\n";
	print globalState.f10[1][11], "\n";
	print globalState.f10[1][12], "\n";
	print globalState.f10[2][0], "\n";
	print globalState.f10[2][1], "\n";
	print globalState.f10[2][2], "\n";
	print globalState.f10[2][3], "\n";
	print globalState.f10[2][4], "\n";
	print globalState.f10[2][5], "\n";
	print globalState.f10[2][6], "\n";
	print globalState.f10[2][7], "\n";
	print globalState.f10[2][8], "\n";
	print globalState.f10[2][9], "\n";
	print globalState.f10[2][10], "\n";
	print globalState.f10[2][11], "\n";
	print globalState.f10[2][12], "\n";
	print globalState.f10[3][0], "\n";
	print globalState.f10[3][1], "\n";
	print globalState.f10[3][2], "\n";
	print globalState.f10[3][3], "\n";
	print globalState.f10[3][4], "\n";
	print globalState.f10[3][5], "\n";
	print globalState.f10[3][6], "\n";
	print globalState.f10[3][7], "\n";
	print globalState.f10[3][8], "\n";
	print globalState.f10[3][9], "\n";
	print globalState.f10[3][10], "\n";
	print globalState.f10[3][11], "\n";
	print globalState.f10[3][12], "\n";
	print globalState.f10[3][13], "\n";
	print globalState.f10[3][14], "\n";
	print globalState.f10[3][15], "\n";
	print globalState.f10[4][0], "\n";
	print globalState.f10[4][1], "\n";
	print globalState.f10[4][2], "\n";
	print globalState.f10[4][3], "\n";
	print globalState.f10[4][4], "\n";
	print globalState.f10[4][5], "\n";
	print globalState.f10[4][6], "\n";
	print globalState.f10[4][7], "\n";
	print globalState.f10[4][8], "\n";
	print globalState.f10[4][9], "\n";
	print globalState.f10[4][10], "\n";
	print globalState.f10[4][11], "\n";
	print globalState.f10[4][12], "\n";
	print globalState.f10[5][0], "\n";
	print globalState.f10[5][1], "\n";
	print globalState.f10[5][2], "\n";
	print globalState.f10[5][3], "\n";
	print globalState.f10[5][4], "\n";
	print globalState.f10[5][5], "\n";
	print globalState.f10[5][6], "\n";
	print globalState.f10[5][7], "\n";
	print globalState.f10[5][8], "\n";
	print globalState.f10[5][9], "\n";
	print globalState.f10[5][10], "\n";
	print globalState.f10[5][11], "\n";
	print globalState.f10[5][12], "\n";
	print globalState.f10[6][0], "\n";
	print globalState.f10[6][1], "\n";
	print globalState.f10[6][2], "\n";
	print globalState.f10[6][3], "\n";
	print globalState.f10[6][4], "\n";
	print globalState.f10[6][5], "\n";
	print globalState.f10[6][6], "\n";
	print globalState.f10[6][7], "\n";
	print globalState.f10[6][8], "\n";
	print globalState.f10[6][9], "\n";
	print globalState.f10[6][10], "\n";
	print globalState.f10[6][11], "\n";
	print globalState.f10[6][12], "\n";
	print globalState.f10[7][0], "\n";
	print globalState.f10[7][1], "\n";
	print globalState.f10[7][2], "\n";
	print globalState.f10[7][3], "\n";
	print globalState.f10[7][4], "\n";
	print globalState.f10[7][5], "\n";
	print globalState.f10[7][6], "\n";
	print globalState.f10[7][7], "\n";
	print globalState.f10[7][8], "\n";
	print globalState.f10[7][9], "\n";
	print globalState.f10[7][10], "\n";
	print globalState.f10[7][11], "\n";
	print globalState.f10[7][12], "\n";
	print globalState.f10[8][0], "\n";
	print globalState.f10[8][1], "\n";
	print globalState.f10[8][2], "\n";
	print globalState.f10[8][3], "\n";
	print globalState.f10[8][4], "\n";
	print globalState.f10[8][5], "\n";
	print globalState.f10[8][6], "\n";
	print globalState.f10[8][7], "\n";
	print globalState.f10[8][8], "\n";
	print globalState.f10[8][9], "\n";
	print globalState.f10[8][10], "\n";
	print globalState.f10[8][11], "\n";
	print globalState.f10[8][12], "\n";
	print globalState.f10[9][0], "\n";
	print globalState.f10[9][1], "\n";
	print globalState.f10[9][2], "\n";
	print globalState.f10[9][3], "\n";
	print globalState.f10[9][4], "\n";
	print globalState.f10[9][5], "\n";
	print globalState.f10[9][6], "\n";
	print globalState.f10[9][7], "\n";
	print globalState.f10[9][8], "\n";
	print globalState.f10[9][9], "\n";
	print globalState.f10[9][10], "\n";
	print globalState.f10[9][11], "\n";
	print globalState.f10[9][12], "\n";
	print globalState.f11, "\n";
	print i2, "\n";
	print v74 == [false, false], "\n";
	print v110[0], "\n";
	print v110[1], "\n";
	print v110[2], "\n";
	print v110[3], "\n";
	...
	print i8, "\n";
	print i12, "\n";
	print v183 == map[624 := false], "\n";
	print v184 == map[false := 476], "\n";
	print v185 == map[0 := map[624 := false, 476 := false]], "\n";
	print v187 == multiset{2}, "\n";
	print v188 == [1, 2], "\n";
	print v220.f16, "\n";
	print v220.f13, "\n";
	print v220.f14, "\n";
