...
function fm0(p0: bool, p1: string, p2: set<bool>, p3: int, globalState: GlobalState): seq<bool> {
	[-|DC22(map[-0x2be := true]).cf41| >= |[DC25(true, map[false := 0x2fc], 'd', DC13(map v0 : int | (0x86 <= v0) && (v0 < 865) :: (v0 / 0xeb) := (DC5({false}))), 350), DC25(!true, map[!true := |"kj"|], 'h', DC13(map v1 : int | v1 in [|map[653 := false]|] :: (v1 / |{-|{true}|, -|{true}|, |{false, false}|, |(seq(0x268, i0  => ('m')))|}|) := (DC5({true}))), |[|multiset{true}|, 123]|)]|, multiset{seq(-0x340, i1  => ('e'))} <= multiset{"aphwvlvy"}, true <== true]
}
...
function fm4(p0: char, globalState: GlobalState): int {
	306 % ---(-211 % |map[true := false]|)
}
function fm5(p0: int, p1: bool, p2: bool, globalState: GlobalState): bool {
	(map['m' := |[--129, -0x26e]|] + map['o' := 0x120]) in ({map['e' := |[false]|], map v0 : char | v0 in ['t'] :: (v0) := (---0x1ac)} - (set v2 : map<char, int> | v2 in map[map v1 : char | v1 in map['t' := 'o'] :: (v1) := (0x2ec) := |(seq(0x247, i0  => ('t')))|] :: (v2)))
}
...
function fm18(p0: int, globalState: GlobalState): map<int, bool> {
	map[0x28d + -0x13f := [0x1ed, |"vyeibuhk"|] == [DC71(|(seq(-137, i0  => ('o')))|, seq(0xfc, i1  => ('t')), false).cf133, -331, |(set v1 : set<char> | v1 in [set v0 : char | v0 in map['w' := !false] :: (v0)] :: (v1))|, |[false]|]]
}
...
function fm20(p0: bool, p1: char, p2: int, p3: char, globalState: GlobalState): char {
	match DC8(false, 0x227, |(seq(705, i0  => (0x204)))|) {
...
function fm30(globalState: GlobalState): map<map<bool, bool>, set<int>> {
	(map v0 : map<bool, bool> | v0 in multiset{map[false := false]} :: (v0) := ({|map[false := !false]|})) + (map[map[true := false] := {|map[false := 's']|}] + map[map[false := false] := set v1 : int | v1 in (seq(881, i0  => (357))) :: (v1 / --|map[DC22(map[251 := true]) := true]|)])
}
function fm31(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): D7 {
	DC19(|(map[0x81 := |map[|(seq(246, i0  => ('s')))| := |map[true := 682]|]|] + (map v0 : int | v0 in [0x2b5] :: (v0 * 0x352) := (--0xb6)))|, false)
}
function fm32(p0: bool, p1: map<multiset<int>, seq<bool>>, p2: map<bool, multiset<int>>, p3: char, globalState: GlobalState): D2 {
	DC9(--(|"kcoc"| - -|(seq(0x303, i0  => ('t')))|), true || true, |multiset{0x3d7}|, -(972 * |[false, true]|))
}
function fm33(p0: char, p1: bool, p2: bool, globalState: GlobalState): multiset<int> {
	(multiset{-985, |[0x10d, |(seq(0x281, i0  => ('y')))|]|} + multiset{0x75, 0x11e}) - DC30(multiset{-0x324}).cf57
}
...
function fm35(p0: char, p1: bool, p2: int, globalState: GlobalState): multiset<D2> {
	match DC42(multiset{true}) {
		case DC43() => multiset{DC9(|[|(set v0 : seq<int> | v0 in map[seq(841, i0  => (|map[|[|(seq(-569, i1  => (|[|multiset{'m', 'd'}|, 788]|)))|, 0x367]| := true]|)) := 373] :: (v0))|, |map[0x36f := false]|]|, true, |(set v1 : int | (-0x135 <= v1) && (v1 < 0x3bf) :: (v1 + |map[false := true]|))|, |"rxbwm"|)}
...
function fm36(p0: bool, p1: bool, p2: bool, globalState: GlobalState): string {
	seq(-0x325, i0  => (if (false) then 'v' else 'c'))
}
...
function fm39(p0: char, p1: bool, p2: int, p3: bool, globalState: GlobalState): map<int, D1> {
	(map v0 : int | (0x10a <= v0) && (v0 < -0xa6) :: (v0 / DC88(!false, 15).cf169) := (DC5({true}))) + (if (true) then map[|"t"| := DC5({false, !!false})] else map[|[[false, false, true]]| := DC5({false, !true, false, false, false})])
}
...
function fm45(p0: int, p1: map<bool, int>, p2: map<int, int>, globalState: GlobalState): seq<int> {
	match DC41(map["wujr" := !true]) {
		case DC41(cf79) => seq(0x370, i0  => (|map[|(set v0 : int | (-0x171 <= v0) && (v0 < 0xa1) :: (v0 * 0x2a9))| := [|multiset{"lnglsm", DC71(|(seq(0x34a, i1  => ('d')))|, "omhtja", false).cf134}|]]|))
	}
}
function fm46(p0: bool, p1: int, p2: bool, globalState: GlobalState): set<int> {
	{|[[false, false]]|, |([seq(0x26c, i0  => ('e'))] + ["fcaxw", seq(48, i1  => ('m')), "noyjivij"])|, -|"fvhcgs"| + |[|(set v0 : int | (0x365 <= v0) && (v0 < -0x15c) :: (v0 % |[false]|))|]|}
}
...
function fm50(globalState: GlobalState): seq<map<int, int>> {
	[map[|[!false]| := 961]] + ([map v0 : int | (0x217 <= v0) && (v0 < 0x3d2) :: (v0 + |[|(seq(0x30b, i0  => ('u')))|]|) := (0x1d3)] + [map[-|multiset{false}| := 0x81], map[765 := 0xc8]])
}
...
function fm53(p0: bool, globalState: GlobalState): D2 {
	match DC15(seq(-498, i0  => (|(seq(0x3c5, i1  => ('d')))|))) {
...
function fm54(p0: bool, p1: bool, p2: char, p3: bool, globalState: GlobalState): map<char, int> {
	(map['n' := -0x13] + map['s' := 0xe8]) + (map['l' := |(seq(0x184, i0  => (|(seq(936, i1  => (|"vhlfqtxej"|)))|)))|] + map['k' := |multiset{true}|])
}
...
function fm56(p0: int, globalState: GlobalState): multiset<string> {
	multiset(if (true || true) then ["wi"] else [seq(-0x2cc, i0  => ('f'))])
}
function fm57(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState): seq<multiset<bool>> {
	[multiset([DC45(|multiset{!false, false}|, true, 0x7f, 708, false).cf86, !true]) + multiset{false}, multiset{false, false} + multiset{true}, multiset{DC79(|(seq(0x3e4, i0  => ('x')))|, 0x2f, !true).cf152, true} - multiset{DC88(true, |(seq(17, i1  => ('u')))|).cf168}]
}
...
function fm61(p0: bool, p1: bool, p2: int, globalState: GlobalState): D21 {
	DC57('o', -|(multiset{true, false} + multiset{false})|, |(map[true := true] + map[false := false])|, |((seq(0x1a8, i0  => ('h'))) + "pae")|)
}
function fm62(p0: int, p1: char, p2: int, globalState: GlobalState): D24 {
	DC71(-|[DC72(true, 0x238, 'd', seq(257, i0  => ('w')), false).cf136, false]| % 878, (seq(757, i1  => ('d'))) + "lmyvl", !false)
}
...
method m8(p0: bool, p1: seq<bool>, p2: int, p3: seq<bool>, globalState: GlobalState) returns (r0: C6) {
		...
		decreases 100 - i0
	{
		...
		var v4: map<array<C1>, bool> := map[v3[p2] := p0];
		var v5: map<int, map<array<C1>, bool>> := map[|fm0(p0, v0, v1, p2, globalState)| / 459 := v4];
		v5 := v5[p2 / p2 := v4];
		...
		var v11: map<bool, T0> := map[p3[p2] := v10];
	...
	if (v15.cf37) {
		...
		v16[683] := seq(0x1a1, i2  => ('b'));
		var v17 := "tgesotcly";
		var v18 := DC71(p2, v17, p0);
		v16[683] := v18.cf134 + v17;
		var v19 := DC82(p2, p2);
		match (v19) {
			case DC82(cf155, cf156) =>
				...
				v21[381] := v23.cf152;
				v21[381], globalState.f0 := fm5(p2 - cf156, false, p0 ==> p0, globalState), p2 - cf156;
				var v24: array<T0> := new T0[10];
				v24 := new T0[5];
				var v25: C5 := new C5(0x2d4, p2 / cf156, cf155, v17 + (seq(-0x182, i3  => (v20))));
				v25 := v25;
			...
			case DC84(cf159, cf160, cf161, cf162) =>
				...
				globalState.f9 := fm5(-p2 % 0x1fa, p0, if (cf161) then p0 else true, globalState);
				var v35: multiset<int> := multiset{-677};
				globalState.f8 := ((if (p2 in v35) then v35[p2] else p2) / p2) * cf159;
				globalState.f9 := cf161;
			case DC81(cf154) =>
				globalState.f25 := p0;
				var v36 := 'l';
				v36 := v36;
				v16[683] := (seq(0x115, i5  => (v36))) + v16[683];
				var v37: seq<bool> := [p0, p2 <= p2, fm24(p0, p0, p0, -p2, globalState)];
				var v38: multiset<string> := multiset{v17 + v16[683], v17, "gxfhafvnj" + v17, v16[683]};
				var v39: set<bool> := {p0};
				var v40: set<int> := {|v39|};
			...
			case DC85(cf163) =>
				...
				var v43 := new C4(p0, fm4(v41, globalState), v16[683], v42 + v42);
				...
				var v48: seq<array<bool>> := [if (v41 in v46) then v46[v41] else v47[p2], v45];
				var v49: set<int> := {|(seq(0x31e, i6  => (p2)))|, |"bngxvpx"|, p2};
				var v50 := DC56(v49);
				var v51: array<int> := new int[6] [p2, p2, |(v47 + v48)|, p2, |v50.cf107| + |v17|, p2];
				v51 := v51;
				var v52: seq<string> := [v17 + v16[683], "gaoopuw", v17];
				v16[683], v51, v52 := v17, v51, [v17, v16[683] + "gch"];
		...
		v63[141] := v64;
		v63[486] := v64;
		v60[195], globalState.f24, v63[141], globalState.f9, v63[486] := {v61}, p2, v64, p0, v64;
		var v65 := 'p';
		v65 := v65;
		...
		decreases 100 - i9
	{
		...
		var v71 := DC66(p0 in v70[p2]);
		var v72 := 'j';
		var v73: seq<int> := [p2];
		v71, v72, globalState.f0 := v71, fm20(fm24(p0, p0, p0, |v73|, globalState), 't', -(p2 % p2), v72, globalState), p2;
		...
		match (DC87(v77, v73, 'v')) {
			case DC87(cf165, cf166, cf167) =>
				...
				globalState.f17, globalState.f9, globalState.f0, globalState.f25, v78[502] := fm4(v72, globalState), !false, if (false) then v78[502] else v78[502], p0, |v76|;
			...
			case DC86(cf164) =>
				...
				globalState.f0, v82[673], globalState.f1, globalState.f0, v88[835] := |v89|, v84[v83.f26 := v83], v88, p2, !p0;
				var v90: set<bool> := {p0};
				v90 := v90 + {p0};
		}
	...
	for i11 := p2 to p2 {
		...
		globalState.f9 := p0 || (v93 != (multiset(v95))[p2 := i11]);
	...
	if (p0) {
		...
		var v108: array<bool> := new bool[15] [!p0, if ("qe" in v101) then v101["qe"] else p0, !p0, fm5(p2, !p0, p0, globalState), p0, 0x34e < p2, p0 ==> p0, p0, multiset{v104} !! v105, p0, p0, p0, p0, !p0, multiset{v100, v100, v100[p2 := v106]} <= v107];
		globalState.f1 := v108;
		globalState.f25 := p0;
		var v109 := new C3(p2, fm4(v106, globalState), v100 + "yygjxck");
		globalState.f23 := v100 + v100;
		var v110: multiset<char> := multiset{v100[v109.f34], v106};
		v110 := v110 + v110;
	} else {
		var v111 := "dbsvhj";
		...
		var v120: array<int> := new int[25] [p2, p2, |[|v111|, p2]|, |(v112[false := v113] + map[p0 := v113])|, p2, -p2, p2 - |v111|, p2, p2 * p2, p2, -0xa5, p2 + -|v113|, p2 * p2, p2 % |v111|, p2, 0xb6, |map[!p0 := v115[|v116|]]|, 77, fm4(v117, globalState), p2 - p2, |map[[p0] := v117]|, fm4(v117, globalState) + p2, 0xfc, |(map v118 : set<char> | v118 in map[v119 := true] :: (v118) := (v117))|, p2];
		v120 := v120;
		var v121: map<bool, int> := map[!p0 := p2];
		var v122: multiset<int> := multiset{p2, -|v121|};
		var v123 := new C5(|("gwxwo")[-p2 := 'k']|, if (807 in v122) then v122[807] else fm4('m', globalState), 320, v111[p2 := v117] + v111);
		v120[360] := v123.f29;
		v120[360] := v123.f29;
		var v124 := DC32(p0, v120[360], p0);
		v120[360], globalState.f9, globalState.f9 := if (v124.cf64) then |v111[p2 := v117]| else p2, p0, p0;
		var v125: seq<array<int>> := [v120, v120, v120, v120, v120];
		v125 := v125[|v111| := v120] + v125;
	}
	
	var v126: array<bool> := new bool[29];
	forall i13 | 0 <= i13 < v126.Length {
		v126[i13] := (p2 % |multiset{p2}|) <= |(seq(-0x2e7, i14  => ('w')))|;
	}
	var v127 := "gvwmon";
...
class C1 extends T0 {
	...
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		var v11: seq<bool> := [!p1];
		var v12: seq<bool> := [fm15(|map[v10 := p0]|, --v0, globalState), v11[|[!p1]|], true];
		...
		if (p1) {
			...
			if (p1) {
				...
				var v24: array<map<int, bool>> := new map<int, bool>[4] [map v23 : int | (0x10 <= v23) && (v23 < 0x19d) :: (v23 - v0) := (p1), fm18(v0, globalState), map[|v15| := v12[v0]], v9];
				v24[933] := v9;
				var v25 := 'm';
				...
				var v31: seq<int> := [|v30|];
				v24[933], v20, v25, v27, globalState.f25 := map[v0 := !p1], ((seq(571, i2  => ("me"))) + v28.cf29)[|(map v29 : int | v29 in v31 :: (v29 % |v15|) := (v0))| := v15] + (seq(0x244, i3  => (v15))), 'v', v27, !p1;
			...
			if (!p1) {
				...
				var v39 := "encpnwnn";
				v38[443] := v39 != v39;
				v38[443] := fm15(v0, -v0, globalState);
				v38[443] := (v0 + v0) >= |v39|;
				var v40 := new C0();
				var v41 := new C0();
				var v42 := 'd';
				...
				v44 := v44;
				p0[878] := v0;
				p0[878] := (if (p1) then v0 else v0) % v0;
				globalState.f9 := p1;
		...
		match (v48) {
			case DC16(cf31, cf32) =>
				...
				var v53 := "sjsfbwvme";
				v51, globalState.f0, v0, globalState.f23, globalState.f0 := if ((v0 + |v47|) in v52) then v52[v0 + |v47|] else v51, -cf31, v0 / cf31, v53, cf31 * cf31;
				r1 := p1;
			...
			case DC15(cf30) =>
				...
				if (v57 >= (set v58 : int | v58 in v57 :: (v58 - 0x10e))) {
					...
					v61[875] := v65 + (v65[!p1 := v64])[v13.cf13 := v64];
					v61[875] := v65 + (map[p1 := v64])[fm15(-670, -v0, globalState) := v64];
					...
					v71[762] := v72;
					var v73 := 'i';
					v71[762] := ("adaeodbg")[|v72| + v0 := v73];
					var v74: multiset<int> := multiset{v0, v0};
					var v75: map<seq<bool>, bool> := map[v12 := false];
					var v77: seq<map<int, int>> := [map[v0 := v0], map v76 : int | (0x2 <= v76) && (v76 < 0x1f5) :: (v76 - |multiset(v47)|) := (|map[p1 := v11[if ((if (p1 in v56) then v56[p1] else v0) in v74) then v74[if (p1 in v56) then v56[p1] else v0] else v0]]|)];
	...
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		...
		var v3 := 's';
		globalState.f9 := fm15(v0, |(map v1 : int | (0x215 <= v1) && (v1 < 0x338) :: (v1 * |map[|[354]| := !false]|) := (map[v0 := p0]))[v0 := v2]|, globalState) <== ((seq(577, i0  => ('e')))[v0 := v3] != "svrrlefr");
		var v4: set<int> := {v0};
		var v5 := "o";
		var v6: map<set<int>, string> := map[v4 := v5];
		var v7: seq<string> := [v5, v5];
		v6 := v6[{v0} := if (p0) then v7[v0] else v5];
		var v8: array<int> := new int[9];
		v8[733] := v0;
		v8[733] := if (p0) then v0 else v0;
		if (!!(((seq(482, i1  => ('q'))) + v5) < v5)) {
			match (DC14(v7 + v7)) {
				case DC14(cf29) =>
					globalState.f5 := 793;
					v8[733] := v8[733];
			...
			globalState.f17, r0, globalState.f24, globalState.f9 := v0 + v8[733], (v8[733] % -473) * v0, if (v3 in v10) then v10[v3] else -v0, !(true ==> p0);
			var v11 := new C0();
			globalState.f9 := v0 != |v5|;
			var v12: seq<int> := [v0, v0, v8[733]];
			if (fm7(v0, p0, globalState) >= (if (p0) then v0 else v12[v8[733]])) {
				var v13: seq<bool> := [p0];
				var v14 := DC3(v0 / -v8[733], v8[733]);
				...
				globalState.f24, v13, v14, v16, globalState.f0 := v8[733] % v0, fm0(p0, (v7[|(if (true in v19) then v19[true] else multiset(v12))|])[0x271 := v3] + v5[v0 := v3], v17 - v17, v8[733], globalState), v14, v16, v0;
				var v20 := DC16(v0, p0);
				var v21: set<D6> := {v20, v20, v20, v20};
				var v22: multiset<char> := multiset{v3};
				var v23: array<set<D6>> := new set<D6>[4] [{v20}, {v20} * v21, {v20, fm22(|v22|, v0, v0, v8[733], globalState)}, {DC16(v8[733], p0)}];
				v23[676] := {v20.(cf32 := p0)};
				globalState.f8, v23[676], v16 := v8[733], v21, v16;
				var v24 := DC1(v5, |v5|, -|v5|);
				var v25 := DC4(v24);
				var v26 := DC4(v25.cf7);
				var v27: map<int, D0> := map[-v8[733] := v26];
				v27 := v27[-v8[733] := v26.(cf7 := DC2(true))];
				var v28: array<bool> := new bool[26];
				v28[808] := p0;
				v28[808], v8[733], globalState.f5 := !p0, --((v0 - v8[733]) % v0), v11.fm16(v8[733], v8[733] + v8[733], -v0, p0, globalState);
				v8[733] := fm7(v8[733], p0, globalState);
			} else {
				...
				v29[857] := v5[v0];
				globalState.f17, v29[857] := v0, v3;
				v8[733] := (v8[733] / |v12|) / v0;
				globalState.f9 := p0;
				var v30 := DC12(p0, v8[733], p0);
				v30 := v30;
			...
			globalState.f9 := !p0;
			globalState.f25 := fm7(v8[733], p0, globalState) > v8[733];
			var v34: seq<bool> := [p0];
			if (fm15(v0, |(v34 + v34)|, globalState)) {
				var v35: map<bool, int> := map[p0 := -v8[733]];
				v35 := v35[p0 := v8[733]];
				globalState.f17 := v8[733];
				globalState.f24 := v8[733];
				var v36: array<bool> := new bool[6](i2 => p0);
				v36[587] := p0;
				v36[587] := multiset{p0} == multiset(v34);
				v36 := v36;
			} else {
				var v37: set<bool> := {p0};
				var v38 := DC8(p0, |(fm0(true, v5, v37, v8[733], globalState))[v8[733] := p0]|, v8[733]);
				var v39: array<bool> := new bool[26];
				var v40: map<bool, array<bool>> := map[p0 := v39];
				var v41: map<D2, bool> := map[v38 := v8[733] > |v40|];
				v41 := v41[if (p0) then v38 else v38 := p0];
				var v42 := new C0();
				globalState.f8 := (v8[733] - v8[733]) + |v5|;
				globalState.f8 := 352 % v0;
				var v43: array<set<int>> := new set<int>[3](i3 => v4);
				v43[214] := set v44 : int | (0x38d <= v44) && (v44 < 79) :: (v44 % v0);
				var v45: multiset<int> := multiset{477};
				globalState.f8, v8[733], globalState.f9, globalState.f25, v43[214] := ((if (v0 in v45) then v45[v0] else v8[733]) + v0) % v0, v8[733], p0, fm15(0xa4, v0, globalState), (v4 - v4) - (v4 + v4);
			}
			...
			globalState.f9, globalState.f9 := (v48 - multiset(fm0(p0, v5, v46, v8[733], globalState))) == multiset{DC6(p0, v3, v0).cf9}, p0;
		}
		
		var v49: array<D1> := new D1[18];
		var v50: multiset<array<D1>> := multiset{v49, v49, v49, if (p0) then v49 else v49, v49};
		var v51: seq<int> := [v8[733]];
		globalState.f9, v50, globalState.f5 := !!(fm15(v0, |v51|, globalState) !in fm23(v5, globalState)), v50, v8[733];
		var v52: seq<bool> := [p0];
		var v53: map<bool, bool> := map[v3 in v7[|v52|] := p0 && p0];
		v53 := v53[p0 := p0];
		var v54: map<bool, int> := map[p0 := v8[733]];
		...
		r0 := if (p0) then if (p0) then |v54| else |v58| else v8[733];
		var v59: multiset<D0> := multiset{DC0(v8[733])};
		var v60 := DC0(v8[733]);
		r1 := (v59[v60 := v8[733]])[v60 := v8[733]];
...
class C2 extends T2 {
	...
	function fm12(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<set<int>, bool> {
		map v0 : set<int> | v0 in ({{|map[-0x2ff := true]|}, {|{f31, map[-0x45 := |[true]|], f31}|, 0x383, |[false]|}} + (set v1 : set<int> | v1 in [{-0x2a5, 50, |{0xf}|}, {0xaf, |multiset{!true}|}, {0x1a3, |"plbidf"|}] :: (v1))) :: (v0) := (!(multiset{true} > multiset{false, true, !DC9(|(seq(0x1e1, i0  => ('u')))|, true, 0x156, -0x165).cf17, true, false}))
	}
	function fm6(p0: map<int, bool>, p1: int, p2: seq<int>, p3: map<seq<bool>, bool>, globalState: GlobalState): int {
	...
	method m3(p0: bool, p1: seq<string>, globalState: GlobalState) returns (r0: string) {
		var v0 := 0x1c;
		globalState.f8 := v0 / |multiset(f33)|;
		if (p0) {
			globalState.f25 := !(p0 || p0);
			match (DC10(map[p0 := p0])) {
				case DC11(cf21, cf22, cf23, cf24) =>
					...
					v2 := seq(-0x2a0, i0  => (if (p0) then v1 else v1));
					globalState.f0 := if (cf24 in cf21) then cf21[cf24] else cf23 / cf23;
					var v3: T0 := new C1();
					v3 := v3;
				...
				case DC12(cf25, cf26, cf27) =>
					var v8 := 'a';
					var v9: map<char, string> := map[v8 := seq(489, i1  => (v8))];
					v9 := v9;
					...
					var v15: array<bool> := new bool[26] [cf27, cf27, cf25, !(p0 && cf27), cf25 ==> p0, true, cf25, cf25, fm24(p0, !cf25, cf27, 0x20e, globalState), cf27, p0, p0, 369 != |f33|, cf27, v13 != v13, |v14| != v10[373], cf27, cf27, cf25, p0, cf25, p0 && p0, true, !cf27, p0, cf25];
					v15[985] := cf25;
					var v16: set<int> := {v10[373]};
					v15[985] := (v16 + {v0, 365}) >= v16;
				case DC10(cf20) =>
					var v17 := 'b';
			...
			v25[443] := |((map v27 : int | v27 in v28 :: (v27 + v0) := (0x2d4))[v0 := |"qyynns"|])[v0 := 0xe6]| > -0x235;
		} else {
			...
			v29[466] := |v31[v0]| % v0;
			var v32: array<bool> := new bool[9](i5 => v0 == v29[466]);
			v32[326] := 0x266 >= v29[466];
			v32[326] := !p0;
			var v33 := DC14(fm25(v32[326], globalState));
			var v34: seq<array<bool>> := [if (v32[326]) then v32 else v32, v32, v32];
			globalState.f1, v33 := v34[v0], v33;
			var v35: T0 := new C1();
			var v36: set<T0> := {v35, v35};
			var v37: map<int, bool> := map[682 := p0];
			globalState.f0 := v29[466] * (if (p0) then |v36| else |v37|);
			v29 := v29;
		}
		...
		var v44: array<int> := new int[17] [v0, v0, |v39| + v0, v0 % v0, v0 % |v40|, v0 - v0, v0, v0, |v41|, |f33|, v0, v0, 0xf8, |v39|, v0, f33[|v42|] - v0, v0 % |v43|];
		v44 := v44;
	...
	method m4(p0: int, p1: D2, globalState: GlobalState) returns (r0: int) {
		...
		match (DC9(if (v0) then p0 else p0, v1[p0 := |fm21(p0, p0, v0, v0, globalState)|] !! v1, p0, DC0(p0).cf0)) {
			case DC8(cf13, cf14, cf15) =>
				...
				if (cf13) {
					var v4 := new C1();
					globalState.f0 := cf15;
					var v5: map<bool, int> := map[!cf13 := cf14 / |f31|];
					v5 := v5[cf13 := 66];
					v0 := true;
					var v6 := new C0();
				} else {
					v2[24] := cf13;
					v2[24] := !!((if (-976 in v1) then v1[-976] else cf14) >= (p0 * cf14));
					globalState.f17 := -p0;
					var v7: seq<bool> := [v0];
					var v8: multiset<seq<bool>> := multiset{v7, v7 + v7, v7[cf15 := cf13]};
					var v9 := DC11(f31, v2[24], cf15, 0x1de);
					globalState.f0 := -(if ([v0, v0, v9.cf22, v0, v2[24]] in v8) then v8[[v0, v0, v9.cf22, v0, v2[24]]] else p0);
					var v10: set<int> := {cf14, -p0};
					var v11: map<int, bool> := map[p0 := v2[24]];
					var v13 := 'b';
					var v14: map<bool, char> := map[v10 !! (set v12 : int | v12 in v11 :: (v12 * 0x3d5)) := v13];
					var v15: seq<set<int>> := [v10, v10];
					var v16 := "mxn";
					v0, v14 := v15[cf14] <= v10, fm23(v16, globalState) + v14;
					cf13 := v0;
				}
				...
				match (v21) {
					...
					case DC7(cf12) =>
						...
						var v38: C1 := new C1();
						v2[248], v37, v38, globalState.f5, globalState.f23 := v0, v37.(cf20 := v36), v38, p0, (v17 + [v18, 'p', v18]) + (v17 + v17);
				}
			...
			case DC7(cf12) =>
				...
				if (v0 && v0) {
					...
					globalState.f8 := p0 % (if (v0 in v60) then v60[v0] else p0);
					...
					var v65: array<bool> := new bool[27] [v0, false, (fm27(v0, p0, globalState)).cf9, if (v0) then true else v0, v0, v61 < {v0}, v0, p0 != p0, v0, v0, p0 >= p0, v0, v0, v0, v0, v63 !! v63, !v0, v0, v0, v0, v0, v0, v0, v0, v0, cf12[p0], !v0 !in v64];
					globalState.f1 := v62;
					...
					var v70: set<int> := {p0};
					globalState.f8, v66, globalState.f17, v67[221] := fm6(v58 + v58, p0, f33, (map v68 : seq<bool> | v68 in v69 :: (v68) := (v0)) + fm28(globalState), globalState), v66, |v70|, if (v0) then p1 else p1;
					var v71: array<int> := new int[26];
					var v72: array<array<int>> := new array<int>[8] [v71, v71, v71, v71, v71, v71, v71, v71];
					v72[504] := v71;
					v72[504] := v71;
					v0, globalState.f24, globalState.f24 := (-0x28d > p0) <==> v0, |cf12|, p0 % p0;
					globalState.f24 := --p0;
				}
				...
				v73[752] := v54 + v54;
				var v74 := 'm';
				globalState.f13, v58, globalState.f5, v73[752] := v54, v58[p0 := v0] + v58, fm7(p0, if (v0) then v0 else v0, globalState), (v54[p0 := v74] + (seq(0x25b, i4  => (v74)))) + "mogo";
				if (v0) {
					var v75 := new C0();
					var v76 := DC19(|cf12|, fm24(cf12[|v57|], v0, v0, p0, globalState));
		...
		var v91 := "uartbboah";
		var v92 := 'g';
		v90 := fm29(v91[-824 := v92], 'w', map v93 : int | v93 in multiset(f33) :: (v93 * 284) := (p0), globalState);
		...
		var v98: map<int, bool> := map[-(if (!true) then p0 else p0) := v95 >= (if (p0 in v96) then v96[p0] else v95)[v94 := |v97|]];
		var v99: array<bool> := new bool[10];
		var v100 := DC17(v99);
		var v101: set<D7> := {v100};
		v98 := v98[f33[|v101|] := v0 ==> v0];
		...
		v108[769] := if (v0) then v104 else map v109 : map<bool, bool> | v109 in (map v110 : map<bool, bool> | v110 in v111 :: (v110) := (p0)) :: (v109) := ({p0});
		var v112: seq<D7> := [fm31(false, false, v0, v0, globalState)];
		var v113 := DC24(|(seq(0x164, i5  => (DC2(v0))))|, p0, |v112|);
		globalState.f24, v108[769] := -p0, match v113 {
		...
		var v116: array<int> := new int[16](i7 => i7 / p0);
		...
		for i6 := |v117| to p0 {
			...
			var v121: seq<seq<seq<bool>>> := [v118, [v119], v120[i6], [[v0, fm24(v0, v0, v0, p0, globalState), v0, v0]]];
			globalState.f25, v116[992], globalState.f13 := (v121[i6] + [v119]) <= (v118 + v118), p0 - |v119|, v91;
			var v122: map<multiset<int>, seq<bool>> := map[v1 := v119];
			var v123: map<bool, multiset<int>> := map[v0 := multiset{v116[992], v116[992]}];
			match (fm32(v0, v122 + v122, v123, v92, globalState)) {
				case DC8(cf13, cf14, cf15) =>
					var v124: map<map<bool, int>, bool> := map[v97 := true];
					var v125: map<map<map<bool, int>, bool>, int> := map[v124 := v116[992]];
					v125 := v125[v124 := p0];
					globalState.f5 := |(if (cf15 < fm6(map v126 : int | v126 in v1 :: (v126 / cf14) := (cf13), i6, f33, map[v119 := cf13], globalState)) then [cf13, v0, true] else v119)|;
				...
				case DC9(cf16, cf17, cf18, cf19) =>
					...
					v133 := v133[v132 := seq(0x1ff, i8  => (v92))];
				case DC7(cf12) =>
					var v134: multiset<bool> := multiset{v0, !v0};
					globalState.f0 := if ((v92 !in (seq(0xe9, i9  => (v92)))) in v134) then v134[v92 !in (seq(0xe9, i9  => (v92)))] else |map[v0 := p0]|;
					var v135: array<set<int>> := new set<int>[16](i10 => v103);
					v135[71] := set v136 : int | v136 in v98 :: (v136 - 0x1ef);
					var v138: map<bool, set<int>> := map[v0 := set v137 : int | (0x12 <= v137) && (v137 < 0x1a6) :: (v137 * |"jlhoqiw"|)];
					var v139: map<bool, char> := map[v0 := v92];
					globalState.f25, globalState.f8, v0, v135[71], globalState.f25 := !v0, p0, !(p0 > i6), if (v0 in v138) then v138[v0] else v103, fm24([v0] <= v119, v116[992] >= |v102|, v0, if (v0) then v116[992] else |v139|, globalState);
					var v140 := DC6(v0, v92, v116[992]);
					globalState.f9 := fm24(v0 || v140.cf9, i6 == v116[992], false, if (v0 in v97) then v97[v0] else 0x29d, globalState);
					var v141: seq<string> := ["wswtmk"];
					v141 := seq(130, i11  => (DC1(v91, p0, v116[992]).cf1));
			}
		...
		match (p1) {
			case DC8(cf13, cf14, cf15) =>
				...
				match (v144) {
					case DC6(cf9, cf10, cf11) =>
						globalState.f25 := if (v143 >= v143) then (multiset{cf9})[cf13 := cf11] != multiset{v0} else cf9;
						globalState.f17 := cf11 / 564;
						v116[810] := cf11;
						var v145: array<set<bool>> := new set<bool>[4](i13 => v143);
						v145[474] := {cf13, fm24(cf13, cf9, !v0, -cf14, globalState)};
						v116[441] := |v1|;
						var v146: seq<map<int, bool>> := [v98];
						var v147: map<int, set<bool>> := map[-|v103| := v143];
						var v148: seq<map<int, bool>> := [v146[|v147|]];
						...
						v116[810], v145[474], globalState.f8, v116[441], cf14 := cf11 * |v91|, v143, fm6(v146[cf14], |(if (v0 in v149) then v149[v0] else v150)|, f33 + f33, v152, globalState), |map[v99 := cf13]| / cf15, DC19(cf15, cf9).cf36;
						var v153 := DC22(v98);
						...
						v154[368] := v155;
						v153, v154[368], globalState.f5 := if (cf9) then v153 else DC22(v98), v155, -(cf14 * -0x190);
					case DC5(cf8) =>
						v98 := map[cf14 := DC2(cf13).cf4] + v98;
						var v156 := new C1();
						v92 := fm20(v0, v92, cf14, v142[2], globalState);
						globalState.f13 := v91;
				}
			...
			case DC9(cf16, cf17, cf18, cf19) =>
				...
				cf17 := v0 || (cf18 > p0);
				globalState.f5 := |(seq(0x290, i15  => (v92)))|;
				v116[618] := -0x11;
				v116[618] := cf18;
			case DC7(cf12) =>
				...
				if (v0) {
					...
					var v163: seq<seq<D7>> := [v162, v162, v162, v162, v162[p0 := v161]];
					var v164 := DC27(v163);
					globalState.f9, v99[15], globalState.f25, globalState.f17 := fm24(v103 != {p0}, v0, v0, p0, globalState), v0, v0, |v164.cf55|;
					var v165: array<char> := new char[14];
					v165[884] := v92;
					globalState.f5, v165[884] := f33[p0], fm20(v99[15], v92, p0, v92, globalState);
					var v166: array<multiset<int>> := new multiset<int>[23](i16 => DC30(multiset{p0}).cf57);
					var v167: map<int, array<multiset<int>>> := map[fm7(p0, v99[15], globalState) := v166];
					v167 := v167[p0 := DC33(v166).cf65];
					globalState.f13 := v91 + v91;
					var v168: map<int, multiset<int>> := map[p0 := v1];
					var v169: set<string> := {v91, v91};
					v1 := (if (|v169| in v168) then v168[|v169|] else fm33(v92, if (v99[15] in v102) then v102[v99[15]] else !v0, v0, globalState)) * (v1 * v1);
				} else {
					globalState.f25 := v0 && (cf12 <= cf12);
					v159 := v159[|(seq(-0x20d, i17  => (v92)))| := p0];
					var v170: seq<int> := [-0x18c];
					v170 := f33;
					var v171: set<seq<int>> := {v170, v170[p0 := |[v0]|]};
				...
				match (v174) {
					case DC0(cf0) =>
						...
						globalState.f25 := v0;
						globalState.f17 := if (cf0 in v1) then v1[cf0] else p0 / |"iwviylb"|;
					case DC1(cf1, cf2, cf3) =>
						var v178: set<bool> := {cf12[|v91|]};
					...
					case DC2(cf4) =>
						globalState.f5 := p0;
						v97 := v97[v92 in ("oc")[p0 := 'c'] := fm7(|v158|, cf4, globalState)];
						v97 := v97 + v97;
	...
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		p0[241] := (v1 + |map[v1 := v2[v1]]|) / |v4[v1 := v3]|;
		globalState.f25 := p1;
		...
		if (v2[|v6.cf12|]) {
			...
			var v8 := 'm';
			v7[807] := fm35(v8, p1, v1, globalState);
			var v9: map<int, bool> := map[p0[241] := true];
			var v10 := DC9(v1, true, |v9[-p0[241] := p1]|, -0xe9);
			...
			match (v12) {
				case DC0(cf0) =>
					...
					v16[398] := map[|f33| := v5[494]] + map[|(map v17 : int | v17 in f33 :: (v17 - v1) := (|multiset{p1}|))| := false];
					var v18 := DC22(v9);
					v16[398] := v18.cf41;
					var v19: array<map<bool, bool>> := new map<bool, bool>[21](i2 => map[v5[494] := p1]);
					var v20: multiset<array<map<bool, bool>>> := multiset{v19};
					p0[241] := if (v19 in v20) then v20[v19] else p0[241] - -cf0;
				case DC1(cf1, cf2, cf3) =>
					var v21: set<map<int, bool>> := {v9 + v9};
					p0[241], globalState.f9 := |v21|, v10.cf17;
					var v22: array<multiset<int>> := new multiset<int>[28];
					v22[701] := multiset(f33);
					v22[701] := multiset{p0[241], -v1, cf2} * v3;
					var v23: seq<int> := [|{-|v22[701]|, p0[241], -v1}|];
					var v24: map<int, seq<int>> := map[cf3 := v23];
					var v25: multiset<bool> := multiset{v5[494]};
					globalState.f24, v23, globalState.f8, globalState.f24 := cf2, (if (|v25| in v24) then v24[|v25|] else v23) + [v1], (if (!p1) then |map[v8 := 647]| else fm7(DC31(v5[494], fm21(v1, p0[241], v5[494], p1, globalState), true, v1).cf61, p1, globalState)) - v1, cf3;
					var v26: C0 := new C0();
					var v27: multiset<C0> := multiset{v26, v26, v26, v26};
					v27 := v27;
				case DC2(cf4) =>
					var v28 := "yrvigief";
					var v29 := DC1(v28, |v28|, p0[241]);
					globalState.f5 := fm7(v29.cf2, cf4, globalState);
					globalState.f0 := p0[241] % p0[241];
					var v30: array<string> := new string[4];
					var v31: map<bool, array<string>> := map[fm24(false, v5[494], cf4, v1, globalState) := v30];
					v31 := v31[v5[494] := v30];
					globalState.f23 := fm36(cf4, !cf4, v5[494], globalState);
				case DC3(cf5, cf6) =>
					globalState.f9, r1 := v5[494] <== v5[494], v5[494];
					var v32: array<int> := new int[28](i3 => i3 + |{cf5, |["ubffx", "eliyqgiwy"]|, -437}|);
					var v33 := DC19(865, p1);
					globalState.f0, globalState.f9, v32 := |fm36(p1, true, v33.cf37, globalState)|, v5[494], v32;
					var v34: map<bool, int> := map[p1 := p0[241]];
					var v35, v36, v37 := m5(v5, v34, globalState);
					var v38: map<bool, map<array<int>, int>> := map[!v5[494] := map[v32 := 0x2c4]];
					var v39: map<array<int>, int> := map[p0 := cf5];
					v38 := v38[p1 := v39];
				case DC4(cf7) =>
					var v40: array<seq<int>> := new seq<int>[20](i4 => f33);
					var v41 := DC31(v5[494], f33, p1, 0x365);
					var v42: map<seq<bool>, bool> := map[v2 := v41.cf58];
					v40[785] := (f33 + f33)[fm6(v9, f33[p0[241]], f33, v42, globalState) := v1];
					v40[785] := (f33 + f33)[v1 := v1] + f33;
					var v43 := new C1();
					var v44: set<int> := {v1, v1, p0[241]};
					globalState.f9 := (v44 + v44) >= {fm7(v1, p1, globalState)};
					var v45: multiset<bool> := multiset{-p0[241] < v1, p1};
					v45 := v45;
			}
			
			var v46 := new C0();
			var v47: map<bool, bool> := map[!(v2 < v2) := v5[494]];
			v47 := v47[if (p1) then v5[494] else p1 := p1];
			var v48: map<bool, char> := map[v5[494] := v8];
			...
			globalState.f17 := (if (p1) then v1 else v1) / v1;
			var v55: multiset<bool> := multiset{v5[494]};
			var v56 := DC2(p1);
			var v57: map<bool, bool> := map[v5[494] := v5[494]];
		...
		var v72: map<seq<bool>, bool> := map[v2 := v5[494]];
		v1 := fm6(v71, v1 * v1, if (v5[494]) then f33 else f33, v72, globalState);
		var v73 := "gfostyx";
		for i5 := p0[241] to |v73| {
			v3 := multiset(f33 + (seq(-555, i6  => (DC6(p1, 'h', p0[241]).cf11))));
			if (p1) {
				r0 := 0x37f;
				r1 := p1;
				var v74: C0 := new C0();
				var v75 := 's';
				v74, globalState.f1, v5[494], v75 := v74, if (p1) then v5 else v5, v5[494], v75;
				globalState.f24 := p0[241];
				globalState.f5 := v1;
			} else {
				v5[494] := v5[494];
				globalState.f23 := v73;
				var v76: seq<int> := [v1, i5, |fm0(v5[494], v73, v0, -0x73, globalState)| / p0[241], -p0[241]];
				v76 := v76;
			...
			v3, v0, r1, globalState.f9, v78 := (v3 - v3) - v3[|v3| := v1], fm17(globalState) + v0, v5[494] && v5[494], v5[494], v78;
			var v79: array<char> := new char[6];
			var v80 := 'f';
			v79[680] := v80;
			v79[680], globalState.f0, globalState.f24, globalState.f5 := v80, |f33|, i5, i5 % (if (v5[494]) then v1 else i5);
		}
		r0 := -473 / p0[241];
		r1 := p1;
	}
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		if (!!(true ==> p0)) {
			...
			v6[905] := v7 + v7;
			var v8: seq<bool> := [p0];
			globalState.f9, v2[605], v5, v6[905] := true, v3, multiset(v8 + [p0, p0]) * (fm37(p0, p0, v1, v1, globalState) - v5), v7;
			var v9 := new C1();
		} else {
			var v10 := 0x380;
			...
			var v13 := "hyukiyfki";
			globalState.f8, globalState.f9 := v10, fm24(p0, p0, v12 >= v12[v10 := |v13|], v10, globalState);
			var v14: map<bool, int> := map[p0 := v10];
			globalState.f9 := f33[-0x27b := if (p0 in v14) then v14[p0] else v10] < [v10];
			globalState.f9 := p0;
			...
			v18[544] := v19 + v19;
			v18[544] := (v19 + v19) + (v19[v10 := v13])[v10 := v13];
		}
		...
		var v28 := DC1(v23, |v21|, v25[233]);
		var v29: array<string> := new string[13] ["yes" + v23, if (p0 in v27) then v27[p0] else v23, v23, seq(385, i1  => ('w')), v23, v23 + "vra", v28.cf1, v23, v23, v23, v23 + v23, v23, v23];
		v29[658] := v23;
		var v30 := 'b';
		var v31: seq<string> := [v23[|v23| := fm20(p0, v30, |f33|, v30, globalState)], v23 + v23];
		v29[658] := v31[v20];
		var v32: set<bool> := {p0};
		var v33 := DC5(v32);
		var v34: map<int, D1> := map[|fm36(!p0, fm24(fm24(p0, false, p0, v25[233], globalState), p0, p0, v20, globalState), !p0, globalState)| := v33.(cf8 := {!p0, p0, p0, !!true})];
		var v35 := DC13(v34);
		var v36: array<array<int>> := new array<int>[9];
		v35, r2, r0, v29[658] := v35, v36, v20, v31[v25[233]];
	...
	method m5(p0: array<bool>, p1: map<bool, int>, globalState: GlobalState) returns (r0: set<int>, r1: map<multiset<int>, int>, r2: char) {
		...
		globalState.f25 := v0;
		var v1 := 0x84;
		if (|((seq(0x2d3, i0  => ('l'))) + "oqcc")| != (if (v0) then 994 else v1)) {
			...
			p0[223] := v0 <==> v0;
			var v9 := "erhvfc";
			var v10: array<string> := new string[9] [v9 + v9, v9, v9, v9, v9[-755 := v5], v9, v9, v9, v9 + v9];
			globalState.f24, p0[223], v10 := -v1, false, v10;
			var v11 := DC0(v1);
			...
			match (DC2(!v0)) {
				...
				case DC1(cf1, cf2, cf3) =>
					...
					r0 := v20 + (v20 * v20);
					p0[223] := cf2 != v1;
					var v21: map<bool, bool> := map[v20 >= v20 := p0[223]];
					v21 := v21[p0[223] := v0];
				case DC2(cf4) =>
					var v22 := new C1();
					globalState.f0 := v1;
					...
					globalState.f17 := -v1;
				case DC3(cf5, cf6) =>
					globalState.f24 := v1 % cf5;
					var v24: map<int, bool> := map[if (v3[v1]) then v1 else v1 := f33[|p1| := |['x', 'j']|] == f33];
					v24 := v24[v1 := p0[223]] + (map v25 : int | (0x35 <= v25) && (v25 < 0x360) :: (v25 + 775) := (p0[223]));
					globalState.f5 := v1;
				...
				case DC4(cf7) =>
					...
					p0[223] := v0;
					var v29: set<bool> := {v0};
					globalState.f25, globalState.f17, p0[223] := v0, v1, fm0(false, v9, v29, v1, globalState) != v3[|f33| := v0];
					var v30: array<map<int, bool>> := new map<int, bool>[26];
					var v31: map<int, bool> := map[-v1 := !p0[223]];
					v30[556] := v31;
					v30[556] := v31 + map[|v9| := v0];
			}
		...
		if (v0 ==> (v0 && v0)) {
			...
			globalState.f25 := fm24(v39 !! v39[v0 := v1], v0, v0, v1, globalState);
			...
			var v48: array<int> := new int[9] [v43 * --fm6(DC22(v45).cf41, v1, f33, map[v46 := v46[|(seq(-0x262, i1  => ('c')))|]], globalState), v43, v43, v1 / |"ayp"|, -(v43 / v1), v43, v43, if (v42) then v47.cf14 else v1, v43];
			v48[518] := v43;
			v48[518] := v43;
			var v49 := 'h';
			var v50 := DC5(v38);
			...
			var v59: map<seq<int>, int> := map[seq(415, i2  => (v1)) := 0x25a];
			if (fm24(v0, f33[|v58|] <= fm7(v1, v0, globalState), v0, if (fm24(v0, v0, v0, v1, globalState)) then |v59| else -v1, globalState)) {
				var v60: array<multiset<bool>> := new multiset<bool>[10];
				v60[644] := multiset{v0, v0};
				v60[644] := v58;
				globalState.f1 := p0;
				globalState.f25 := v0;
				...
				var v67: array<map<char, bool>> := new map<char, bool>[24] [v62, map[v56 := v0], v62, v62, map v63 : char | v63 in v64 :: (v63) := (v0), v62, v62, v62, v62, v62, v62, v62, v62, v62[v56 := v0], v65[v1], v62, v62, v62, map[v56 := v0], v62, map[v56 := v0], v62, map v66 : char | v66 in v62 :: (v66) := (!v0), v62];
				...
				var v75 := DC3(v1, |(seq(-0x2de, i3  => (v1)))|);
				v69[655] := (v72[v71 := v1])[fm19(v74, v75, v56, v0, globalState) := v1];
				var v76 := new C1();
		...
		if (v1 >= (v1 % --v1)) {
			...
			if (v0) {
				p0[459] := true;
				p0[459] := v0;
				var v85: map<int, bool> := map[|f33| := p0[459]];
				var v86: seq<bool> := [p0[459], p0[459]];
				var v87: map<seq<bool>, bool> := map[v86 := p0[459]];
				var v88: map<bool, bool> := map[p0[459] := v0];
				...
				var v94 := 't';
				var v95, v96, v97 := m6(fm6(v85, v1, f33, v87, globalState) > |v89|, v91, (v92 + v92)[|v93| := v94], (if (v1 in v85) then v85[v1] else p0[459]) || v0, globalState);
				v97 := (fm17(globalState) - v38) > v38;
				var v98 := DC5(v38);
				var v99: map<int, D1> := map[v1 := v98];
				var v100 := DC13(v99);
				var v101 := DC25(false, p1, v94, v100, v1);
				var v102: seq<D8> := [DC25(p0[459], p1, 'f', v100, v96), v101];
				var v103: array<map<int, int>> := new map<int, int>[5] [map[fm7(|map[v1 := v102]|, p0[459], globalState) := v96], f31, f31, f31, f31];
				var v104: map<int, map<int, int>> := map[v1 := f31];
				v103[280] := if (v96 in v104) then v104[v96] else fm40(v97, v1, v85, v97, globalState);
				v103[280] := fm40(v95, 0x8d, map v105 : int | v105 in v93 :: (v105 + v96) := (v95), p0[459], globalState) + map[|v86| := v96];
				globalState.f5 := 535;
			} else {
				globalState.f17 := -v1;
				var v106: seq<bool> := [v0 ==> true, v0, v0];
				v106 := v106;
				var v107: multiset<bool> := multiset{!v106[|v106|]};
				var v108: array<int> := new int[21] [v1, v1, -v1, v1, v1, v1, v1, v1, v1, v1, v1, v1, 923, v1, |f33|, |v106|, 0x156, v1, |v107[false := v1]|, v1, v1];
				...
				v108[682] := fm6(fm18(v1, globalState), v1, f33, v111, globalState) / -v1;
				v108[682] := |v38|;
				var v112 := new C1();
			}
			
			var v113: array<int> := new int[5](i5 => i5 % |multiset{v0, v0}|);
		...
		v1, v117[353], globalState.f8, v117[714], globalState.f9 := v1, match v118 {
			case DC0(cf0) => -|f33|
		...
		var v124: set<int> := {v117[353], |v123|, v1};
		r0 := (v124 * v124) - (if (v0) then v124 else v124);
		var v125: map<multiset<int>, int> := map[(multiset{v117[353]})[v117[353] := -533] := |fm21(v1, v1, v0, fm24(v0, v0, v0, v1, globalState), globalState)|];
		r1 := v125;
		var v126 := 's';
		r2 := v126;
	}
	method m6(p0: bool, p1: map<array<bool>, bool>, p2: string, p3: bool, globalState: GlobalState) returns (r0: bool, r1: int, r2: bool) {
		...
		v1[737] := v2;
		v1[737] := v2;
		var v3: map<int, bool> := map[v1[737] := fm24(false, p3, p0, |p2|, globalState)];
		var v4: seq<bool> := [p0];
		var v5: map<seq<bool>, bool> := map[fm0(p0, p2, fm17(globalState), v2, globalState) := p0];
		v2 := v2 / fm6(v3, |v4|, f33, v5, globalState);
		for i1 := v2 to -0x20c {
			var v6 := new C0();
			r0 := i1 < 0x60;
		...
		if (p0) {
			...
			v8[911] := v9;
			var v10: array<map<bool, int>> := new map<bool, int>[26](i3 => map[p0 := v1[737]] + map[p0 := v1[737]]);
			var v11: map<bool, array<map<bool, int>>> := map[p0 := v10];
			v8[911], v10, globalState.f25, globalState.f5 := if (p3) then v9 else v9, if (p3 in v11) then v11[p3] else v10, p0, v1[737];
			if (!p0) {
				var v12 := DC7(v4);
				...
				var v15: C0 := new C0();
				v14[442] := v15;
				v13[625] := fm24(p3, p3, p0, v2, globalState);
				var v16: array<string> := new string[16](i5 => p2 + p2);
				v16[510] := p2 + (seq(0x2d3, i6  => ('t')));
				var v17: multiset<int> := multiset{0x163, v2};
				var v18: set<int> := {v2};
				var v19: map<bool, int> := map[!(if (|p2| in v3) then v3[|p2|] else p3) := |v18|];
				v14[442], globalState.f25, v13[625], globalState.f9, v16[510] := v15, !fm24(true, v17 >= v17, p3, |v19|, globalState), fm24(p0, if (p0 in v0) then v0[p0] else p0, p3, v1[737], globalState), f33[v1[737]] != |v4|, ("mmftdfysg")[v1[737] / 0x4c := 'i'];
				var v20 := new C1();
				v1 := v1;
				v18 := set v21 : int | (-0x1e1 <= v21) && (v21 < 0x16f) :: (v21 % 834);
			} else {
				var v22 := new C0();
			...
			v25[313] := true;
			v25[313] := v4[v2] <== p3;
			globalState.f0 := v1[737];
			globalState.f9 := v25[313];
		} else {
			var v26: seq<string> := [p2, p2];
			var v27: map<set<bool>, int> := map[{p3} := |v0|];
			var v28: array<bool> := new bool[28] [p0, p0, p3, !false, !(f33 < f33), p3, p0, p3, p0 ==> p0, p0, |multiset{v2}| < 611, !(!p0 && p0), p0, p3, p0, p3, p0, p3, if (false) then !p0 else p0, p0, v2 != 379, p3, p3, p0, p3, p3, p0, p2 == v26[|v27|]];
			v28[641] := true;
			var v29: set<bool> := {p3, false, p0, p0};
			var v30 := DC5(v29 * v29);
			var v31: map<bool, string> := map[true := p2];
			var v33: map<bool, map<int, bool>> := map[p0 := map v32 : int | (372 <= v32) && (v32 < 0x2b7) :: (v32 * f33[v2]) := (false)];
			var v34: map<int, set<bool>> := map[v1[737] := v29];
			globalState.f17, globalState.f5, v28[641], globalState.f25, v30 := fm6(v3 + v3, |(v31[p0 := p2] + v31)|, f33, v5, globalState), -(-v2 * (-v1[737] - v1[737])), p3, if (p0) then |(if (p3 in v33) then v33[p3] else if (p3 in v33) then v33[p3] else map[v2 := p3])| <= v2 else p3, (if (p3) then v30 else DC5(v29)).(cf8 := (if (v1[737] in v34) then v34[v1[737]] else v29) - v29);
			globalState.f0 := -v1[737];
			var v35: multiset<bool> := multiset{p0, v28[641]};
			r1 := (|{v28[641]}| % |p2|) * |v35|;
			var v36 := new C1();
			globalState.f0 := fm7(v36.fm7(v1[737], p0, globalState), p3, globalState);
		}
		
		r0 := p0 ==> (-v1[737] >= v1[737]);
		var v37 := DC18(v2, v1);
		var v38 := 'p';
		r1 := |(seq(0x390, i7  => (v1[737])))[-v2 - v37.cf34 := -|map[v38 := v1[737]]|]|;
		r2 := p3;
	}
}
...
class C3 extends T1 {
	...
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		var v1: seq<int> := [-0x136 * |(set v0 : int | (0x300 <= v0) && (v0 < 144) :: (v0 / f26))|];
		v1 := if (if (p1) then p1 else p1) then if (p1) then seq(0x1bb, i0  => (f26)) else v1 else [|{v1, v1}|] + v1;
		var v2: multiset<bool> := multiset{p1};
		r1 := p1 && (v2 < v2);
		var v3: map<bool, int> := map[p1 := f34];
		for i1 := v1[|v3[p1 := |f27|]|] to f26 {
			var v4 := DC42(v2);
			if ((v2 - v2) != (multiset{true, p1} * v4.cf80[!p1 := i1])) {
				...
				var v14: map<bool, bool> := map[v10 := if (!v13[0x1b6]) then p1 else if (v8 in v12) then v12[v8] else p1];
				...
				var v19: set<int> := {v1[198] + f34, |(f27 + (seq(0x187, i3  => ('m'))))|};
				var v20: array<string> := new string[13](i4 => f27);
				v20[941] := (seq(0x4d, i5  => ('o'))) + f27;
				var v21: map<bool, bool> := map[p1 := false];
				var v22 := DC8(p1, f34, i1);
				v19, v20[941], globalState.f8, globalState.f25, v20 := v19, f27 + f27, |((v21 + v21) + map[false := v22.cf13])|, !p1, v20;
				var v23 := 'n';
				v23 := v23;
				var v24: multiset<int> := multiset{-f26, |f27|};
				globalState.f9 := fm8(v24, false, |[f34, i1, i1, f34, -|f27|]|, |(map v25 : int | (0x1 <= v25) && (v25 < -0x2e1) :: (v25 % i1) := (p1))|, globalState);
				var v26: map<int, int> := map[f34 := if (p1 in v2) then v2[p1] else i1];
				var v27 := new C2([f26, |(seq(0x1e9, i6  => (i1)))|, f26, f26], v26);
			}
			...
			p0[53] := i1;
			var v31 := 'f';
			globalState.f9, r0, v28[628], p0[53] := f26 <= |map[p1 := v31]|, f26, map[v29 := f26], (|f27| % f26) + 814;
			globalState.f25 := p1;
			globalState.f25 := p1;
		}
		var v32: multiset<int> := multiset{f26, f34};
		var v33: map<int, bool> := map[f26 := p1];
		var v34: seq<bool> := [fm8(v32[f34 := |v33|], true, f34, f34, globalState), p1, false];
		var v35: seq<bool> := [v34[f34]];
		globalState.f9 := v34[f26];
		if (true) {
			...
			var v44: seq<map<int, bool>> := [v42[f26], v33, v33, map v43 : int | (280 <= v43) && (v43 < 0x315) :: (v43 - |f27|) := (p1)];
			var v45: seq<seq<int>> := [v1];
			var v47: seq<multiset<bool>> := [v2, v2, v2];
			var v48: seq<set<int>> := [v40, v40];
			globalState.f1, globalState.f25, v38, v39[437], globalState.f0 := v41, v44 != (fm41(p1, v45[f34], globalState) + v42), DC36(map v46 : multiset<bool> | v46 in v47 :: (v46) := (DC10(map[!p1 := !DC31(p1, v1, p1, f34).cf58]))), ({f26, f34} + v48[f34]) - v40, if (p1) then |v40| else f26;
			v2 := v2;
			v41[599] := fm8(v32, p1, f26, f34, globalState) <==> p1;
			v41[599] := p1;
			globalState.f25 := p1;
			var v49 := 'k';
			...
			if (p1) {
				...
				var v59 := DC35(v58[f34]);
				var v60 := DC35(v59);
				v60 := DC35(v59).(cf68 := DC33(v56));
				v54[384] := p1;
				var v61 := DC19(f34, p1);
				v54[384] := (|[v61.cf37]| * f26) < (f26 * f34);
			}
	...
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		...
		if (((seq(0x291, i0  => ([p0]))) + v1) == (([v0])[f34 := v0] + v1)) {
			...
			v11[379] := f27 + f27;
			var v12 := 'a';
			v11[379] := f27 + ("rxbou")[|(seq(0x143, i1  => (f26)))| := v12];
			v9 := v9[-0x3b2 := -(0x1c9 % f26)];
		} else {
			var v13: set<bool> := {p0};
			...
			v18[387], v19[982], globalState.f17, globalState.f23 := v21.cf32 <==> v17, (v16 % v15) / (0x3a2 % f34), v16, "k";
			globalState.f25 := v18[387];
			if (v18[387]) {
				var v22: map<int, bool> := map[v15 := v17];
				var v23 := DC8(v17, v15, -f26);
				v22 := v22[v23.cf14 := v18[387]];
				var v24: multiset<bool> := multiset{v18[387]};
				v22 := v22[fm7(|v24|, v17, globalState) := !v18[387]];
				...
				v27, globalState.f24 := v27, 0x90 % v19[982];
				v19[982] := f26;
				v19[982] := -f34;
				var v28 := 'f';
				v28 := v28;
		...
		if (true) {
			...
			v44[159] := map v45 : int | (615 <= v45) && (v45 < 0x271) :: (v45 + -f26) := (|v38|);
			var v46: map<int, int> := map[f26 := f34];
			v44[159] := if (p0) then v46 else map[300 := |f27[f26 := v31]|];
			...
			var v50: C1 := new C1();
			v49[862] := v50;
			v49[862], globalState.f5, globalState.f8, globalState.f0 := v50, (f34 % f34) / 0x281, f26, f34;
			var v51: map<int, set<int>> := map[f26 := v36];
			globalState.f5, globalState.f8, globalState.f9, globalState.f25 := 0xf9 % f34, -|((if (-0x1ca in v51) then v51[-0x1ca] else v36) * v36)| % f26, p0, if (f34 != f34) then fm8(v40[|map[p0 := p0]| := |v38|], p0, f34, f26, globalState) else p0;
		} else {
			globalState.f8 := -f26;
			...
			v52[803], globalState.f17, v53[342], globalState.f17 := fm8(multiset{v54[|v37|]}, 0x5d !in (seq(-155, i4  => (f26))), -f26, f26, globalState), f26, f34 / |f27|, f34 % (if (!true) then f34 else f34);
			globalState.f17, r0 := (if (false) then f34 else v53[342]) % f34, |f27|;
			globalState.f9 := (f26 < v53[342]) <== true;
		}
		...
		r1 := v61[v60 := f26] + multiset{v60};
		var v62: array<int> := new int[1](i5 => i5 % |map[multiset{true, p0} := 2]|);
		var v63: map<int, array<int>> := map[|v40| := v62];
		var v64: map<int, int> := map[fm6(v55, f26, seq(0x322, i6  => (|f27|)), map[v0 := p0], globalState) := |f27|];
	...
	method m7(p0: set<bool>, globalState: GlobalState) returns (r0: string, r1: int, r2: int, r3: bool) {
		...
		for i0 := |v2| to |multiset{f26, -980, -f26, 0x1f, f34}| {
			...
			if (v3) {
				...
				var v9: map<int, int> := map[|f27[f34 := v1]| := fm7(f26, true, globalState)];
				var v10 := DC1(f27, f34, |f27|);
				var v11: multiset<string> := multiset{seq(0xbc, i1  => (v1)), fm43(fm8(v8, v3, f26, 411, globalState), |v9|, globalState), f27 + v10.cf1, v10.cf1};
				v11 := v11;
				var v12: seq<bool> := [true, v3, v3];
				var v13 := DC7(v12);
				var v14: map<D2, string> := map[v13.(cf12 := [v3, v3]) := v10.cf1];
				v14 := v14[v13 := seq(-0x3cd, i2  => (v1))];
				...
				v20[517] := v2 + map[v0 := v1];
				v20[517] := v2;
			}
			
			globalState.f8 := (--541 % |"lhkdo"|) - i0;
			var v21: C1 := new C1();
			var v22: array<string> := new string[22];
			var v23: seq<C1> := [v21, v21];
			v21, v22 := v23[|({v0} - {v0})|], v22;
		}
		var v24 := true;
		if (v24) {
			...
			var v45: T2 := new C2(seq(0x2c3, i3  => (|(set v43 : int | v43 in map[|(seq(0x1f4, i4  => (v1)))| := v24] :: (v43 - -|multiset{!false}|))|)), v44);
			var v46: seq<T2> := [v45];
			var v47: map<int, string> := map[|v46| := f27];
			var v48: map<bool, multiset<int>> := map[v42[-0x1c6] := v39 * multiset{f34, f26, |v47|}];
			v48 := v48;
			var v49 := DC16(f26, v24);
			if (v49.cf32) {
				var v50: array<int> := new int[27](i5 => i5 / |v39|);
				v50[831] := -(-786 + f26);
				...
				v42 := v42;
				var v54: map<string, int> := map[seq(487, i6  => (v1)) := f34];
				var v56: map<int, set<string>> := map[|[true, v42[f34]]| := set v55 : string | v55 in v54 :: (v55)];
				var v57: set<string> := {f27};
				var v58: map<int, map<string, string>> := map[v50[831] := map v53 : string | v53 in DC47(if (v50[831] in v56) then v56[v50[831]] else v57).cf88 :: (v53) := (f27)];
				var v59: map<string, string> := map[f27 := f27[f34 := f27[v50[831]]]];
				v58 := v58[0x2e7 := v59];
			} else {
				v44 := v44[f26 := f26];
			...
			decreases 100 - i7
		{
			...
			if (v24) {
				...
				v66 := DC4(v69[fm6(map v70 : int | (0x2cf <= v70) && (v70 < 0x3a8) :: (v70 - f26) := (v24), f34, v71, v74, globalState)]);
				globalState.f17, globalState.f8 := |(v71 + v71)|, (f26 + f34) / f34;
				var v75: map<bool, string> := map[v24 := seq(-901, i8  => (v1))];
				...
				var v90: array<int> := new int[27] [f26 / |f27|, f34 % f26, f34, f26, f26, |v84|, f26, |(map[v24 := v83] + v85)|, 0x220, f34, f26, f26, f34 / f34, f26, -f26, 551, f34, |(if (v24) then p0 else p0)|, if (-fm6(v81, f26, v71, map[[v24] := v24], globalState) in v76) then v76[-fm6(v81, f26, v71, map[[v24] := v24], globalState)] else |v64|, -0x264, f34, f34, |v89.cf99|, f26, f34 * f34, f34 * 317, f34 + f34];
				v90[777] := 0x119 / f26;
				globalState.f25, v82, v90[777], v84 := v84 < ({f26, 335, |v72|, |v81|, f34} + {f26, f34}), v82, -(|("j" + f27)[f26 := v1]| / |("f" + "khcfajjp")|), {f26};
				var v91 := new C1();
			} else {
				v0[723] := v24;
				...
				v0[723] := if (v95 in v96) then v96[v95] else false <==> v24;
				var v97: map<string, bool> := map[f27 := !!true];
				var v98 := DC41(v97);
				v98 := v98;
				globalState.f9 := if (v0[723]) then v24 else v0[723];
			...
			decreases 100 - i9
		{
			...
			if (v24) {
				...
				var v122: array<int> := new int[19] [f34, f34, v117.cf84, f34, if (v120 in v121) then v121[v120] else f26, -0x321, f34, -|f27|, f26, f34, f26 % f34, v115.fm7(if (v24 in v108) then v108[v24] else f26, v24, globalState), f34, if (v24) then f26 else f34, f34, |v120|, f34, f34, |(multiset{v120} - v121[seq(0x35, i10  => (f34)) := f34])|];
				v122[574] := |f27|;
				v122[574] := f34;
				...
				v123[587] := -f34;
				v123[587] := 0x2e0;
				v123, globalState.f5, v123[587], v123[587] := if (v0[644]) then v123 else v123, f26 + (f34 / -|[f27, "ltlyxnx", f27[0x60 := v1], fm43(v0[644], f34, globalState), f27]|), |(f27 + f27)|, v123[587];
				v1 := v1;
			}
		...
		r2 := |(match v124 {
			...
			case DC7(cf12) => (map v127 : int | (-0x190 <= v127) && (v127 < -0x38) :: (v127 - f34) := (map[f34 := |DC31(v24, seq(-0x80, i11  => (|map[|f27| := v24]|)), v24, f34).cf59|])) + map[f34 := map v128 : int | v128 in multiset([f26]) :: (v128 % |f27|) := (407)]
		})|;
		r3 := v24;
	}
}
...
class C4 extends T1, T0, T2 {
	...
	function fm12(p0: bool, p1: int, p2: int, p3: bool, globalState: GlobalState): map<set<int>, bool> {
		map[{f26} := f32] + (map v0 : set<int> | v0 in map[{-|map[true := 'l']|, f26, f26} := DC3(|(seq(0x28a, i0  => ('w')))|, f26)] :: (v0) := (true))
	}
	function fm13(p0: bool, p1: string, p2: int, globalState: GlobalState): seq<char> {
		f27
	}
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		if (!('f' !in (seq(674, i0  => ('h'))))) {
			globalState.f25 := false;
			var v0: seq<bool> := [false];
			globalState.f25 := v0[f26] && v0[f26];
			p0[640] := 0x6f;
			p0[640] := fm7(f26 * f26, f32, globalState);
			var v1 := 'l';
			var v2: multiset<char> := multiset{v1};
			if (v2 !! (multiset(f27) * multiset{'u'})) {
				var v3: multiset<int> := multiset{p0[640]};
				var v4: map<bool, bool> := map[false := f32];
				var v5: set<seq<int>> := {[if (p0[640] in v3) then v3[p0[640]] else f26, |v4|, 0x32b]};
				var v6: multiset<bool> := multiset{v5 > v5};
				var v7: seq<int> := [|v6|];
				var v9: map<bool, D3> := map[f32 := DC11(map v8 : int | (-412 <= v8) && (v8 < 0x23e) :: (v8 - p0[640]) := (p0[640]), f32, f26, f26)];
				var v10: multiset<map<bool, D3>> := multiset{v9};
				globalState.f25, v1, globalState.f25, v6, v0 := (85 / p0[640]) >= v7[p0[640]], v1, |fm13(f32, f27, |f27|, globalState)| != p0[640], v6[fm8(v3, v0[|v10|], f26, 201, globalState) := f26], if (false <==> f32) then v0 else ([fm8(v3, p1, 154, |(v0[p0[640] := f32])[f26 := p1]|, globalState), p1])[p0[640] := !p1];
				var v11: set<bool> := {f32, f32};
				v0, p0[640], globalState.f5, globalState.f0, globalState.f17 := v0 + ([p1, p1, p1] + v0), f26, --|(v11 - (v11 + fm14(globalState)))|, f26 % f26, f26;
				r1 := p1;
				globalState.f1 := new bool[7](i1 => f32);
				globalState.f13 := f27;
			} else {
				globalState.f24 := p0[640];
				var v12: seq<int> := [p0[640], p0[640], f26];
				var v13: seq<seq<int>> := [v12, v12, seq(0x4f, i2  => (f26))];
				var v14: map<bool, int> := map[f32 := f26];
				var v15: multiset<int> := multiset{p0[640], p0[640]};
				var v16: multiset<string> := multiset{"isc"};
				var v17 := new C2((v13[p0[640]] + [f26, |f27|])[f26 := 1], f31[if (f32 in v14) then v14[f32] else |v15| := |v16|]);
				globalState.f25 := !p1;
				var v18: map<bool, bool> := map[p1 := !f32];
				var v19: map<int, bool> := map[v17.fm7(p0[640], false, globalState) := false];
			...
			if (p1) {
				...
				var v22: array<int> := new int[11](i3 => i3 % p0[640]);
				v21[27] := v22;
				v21[27] := v22;
				var v23: map<char, bool> := map[v1 := f32];
				v23 := map[v1 := 0x101 !in map[p0[640] := p0[640]]];
				globalState.f9 := v0[0x34d - (if (p0[640] in f31) then f31[p0[640]] else -f26)];
				var v24: array<string> := new string[5];
				v24, globalState.f9 := v24, p1;
			} else {
				var v25: multiset<bool> := multiset{p1};
				globalState.f0 := if (p1 <== p1) then f26 % -f26 else f26 + |v25|;
				globalState.f23, globalState.f24, p0[640], globalState.f13 := f27, p0[640], f26, f27;
			...
			if (p1) {
				...
				v45 := v45[(set v47 : int | v47 in v46 :: (v47 * |(map v48 : int | v48 in (seq(-300, i5  => (976))) :: (v48 - |[0x3a5, 0x1a3]|) := (|multiset{|map[true := -0x17a]|, -317}|))|)) * v44 := if (v49 in v50) then v50[v49] else f26];
				globalState.f9 := p1;
				globalState.f17 := --(f26 * (f26 % -|[f32]|));
		...
		for i6 := fm6(map[f26 := p1], 0x357, v64.f33, v66, globalState) to f26 / f26 {
			globalState.f25 := p1;
			...
			var v72: array<multiset<bool>> := new multiset<bool>[20] [v67, v67 * v67, v68.cf80, v67, multiset(v65 + v65), v67 - multiset{p1}, v67 * (if (f26 in v69) then v69[f26] else v67), multiset{p1, p1, f32, f32} - v67, if (p1 in v70) then v70[p1] else v67, v67, v67, v71[f26], v67, v67, v67 + v67, v67 - v67, multiset(v65), v67, v67, multiset{p1, p1, f32}];
			v72 := v72;
		...
		var v77: map<int, map<bool, int>> := map[v64.f33[-f26] % 14 := v76];
		v77 := v77;
		var v78 := new C0();
		for i7 := f26 to f26 {
			globalState.f0 := (f26 % i7) / f26;
			var v79 := DC2(!f32);
	...
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		if (f32) {
			...
			var v2: array<D3> := new D3[6](i0 => DC11(f31, f32, f26, |(seq(0xfc, i1  => ('y')))|));
			var v3: map<string, array<D3>> := map["ndhq" := v2];
			var v4 := 'p';
			v3 := v3[(f27 + f27)[f26 := v4] := v2];
		...
		v17[584] := v16;
		v17[584], globalState.f24, r0 := v16, fm7(f26, f32, globalState), f26;
		var v18: array<bool> := new bool[26];
		v18[454] := p0;
		var v19: seq<map<int, int>> := [f31, f31];
		var v20 := 'q';
		var v21: map<bool, int> := map[f32 := f26];
		globalState.f1, globalState.f0, globalState.f25, globalState.f0, v18[454] := v18, f26 + (f26 - |f27[|v19| := v20]|), p0, f26, f26 >= |(fm47(globalState) + v21)|;
		globalState.f9 := !p0;
		forall i2 | 0 <= i2 < v18.Length {
			v18[i2] := p0 || !p0;
		}
		var v22: map<bool, bool> := map[v18[454] := f32];
		var v23 := DC10(v22);
		var v24 := DC37(f26, f26 + f26, v23, f26, f26);
		match (v24) {
			case DC37(cf70, cf71, cf72, cf73, cf74) =>
				globalState.f9 := p0;
				var v25: map<int, int> := map[cf71 := cf71 % cf71];
				var v26: multiset<int> := multiset{0x248, cf70, cf73, |f27|};
				var v27: multiset<bool> := multiset{f32};
				var v28: seq<int> := [cf73];
				v18[454], globalState.f9, globalState.f8, v25 := fm8(v26, !f32, if (f32) then f26 else |v27|, cf74, globalState), v28 != [f26, -0x96], cf70, f31;
				v16[290] := cf71;
				var v29: multiset<array<bool>> := multiset{v18, v18};
				v16[290], globalState.f25, v21, v20, globalState.f17 := 0x362 - -cf73, if (f32) then !(v27 != fm37(v18[454], p0, (fm31(v18[454], v18[454], true, p0, globalState)).cf36, |v26|, globalState)) else f27 < DC1("aewnvt", cf73, |f31|).cf1, (v21[p0 := cf71])[v18[454] := f26], v20, |(v29[v18 := cf73] - v29)| % (cf71 + |f27|);
				var v30: map<int, bool> := map[f26 := v18[454]];
				var v31 := new C2(v28[cf74 := cf74], fm40(v18[454], cf70, v30, f32, globalState));
			case DC38() =>
				v17[584][438] := -f26;
				...
				var v34: map<int, D1> := map[|f27| := v33];
				var v35 := DC13(v34);
				var v36 := DC25(v18[454], v21, v20, v35, f26);
				var v37: map<bool, char> := map[v18[454] := v36.cf51];
				var v38: seq<bool> := [p0];
				var v39: seq<int> := [|"fxrlhps"|, |v38|, f26, f26];
				var v40: map<seq<bool>, bool> := map[v38[|v38| := true] := f32];
				v18[454], v17[584][438], globalState.f25, v37 := true, fm6(fm18(f26, globalState), -f26, v39, v40 + v40[v38 := false], globalState), "exfichunx" < f27, fm23(f27, globalState);
				var v41: array<array<set<bool>>> := new array<set<bool>>[20];
				var v42: array<set<bool>> := new set<bool>[12];
				v41[713] := v42;
				v41[713] := new set<bool>[6];
				if (false) {
					v17[584][438] := f26;
					var v43: array<D4> := new D4[12];
					v43[319] := v35.(cf28 := v34);
					var v44: array<string> := new string[21];
					var v45 := DC40(v44, v18, v18[454]);
					var v46: seq<array<bool>> := [v18, v18, v18];
					var v47: map<array<bool>, bool> := map[v46[v17[584][438]] := f32];
					...
					v49[424] := v16;
					var v50 := DC50(f26, v18[454], v39, v20, v17[584][438]);
					var v51 := DC51(v50);
					var v52 := DC51(v50);
					var v53 := DC51(v50);
					...
					globalState.f8, v43[319], v48[634], v49[424], globalState.f8 := v17[584][438], v35, v47, if (v54 in v55) then v55[v54] else v16, f26;
					var v56: C2 := new C2(((seq(289, i3  => (v17[584][438]))) + v39)[65 := f26], f31);
					v56 := new C2(fm45(v56.f33[|[v18[454]]|], map[v18[454] := 0x1ac], f31, globalState), map[v17[584][438] := f26]);
					var v57: map<int, map<bool, int>> := map[v17[584][438] := v21];
					var v58 := DC24(|"ukglkivlo"|, |v57|, v17[584][438]);
					var v59: map<D8, seq<int>> := map[v58 := v39];
					var v60: seq<seq<int>> := [v39];
					var v61 := new C2(if (v58 in v59) then v59[v58] else v60[|v38|], f31);
					var v62: map<set<bool>, bool> := map[v32 * v32 := p0];
					var v63: map<int, bool> := map[f26 := f32];
					v62 := v62[v32 := !!(v56.fm6(v63, v56.fm6(map v64 : int | v64 in v39 :: (v64 - v17[584][438]) := (v18[454]), v17[584][438], v39, fm28(globalState), globalState), seq(0x244, i4  => (-f26)), v40, globalState) < f26)];
				} else {
					var v65: set<int> := {0x3e7, v17[584][438]};
					v65 := v65;
					v17[584][438] := v17[584][438];
					v18[454] := f32;
					v17[584][438] := v17[584][438];
					v17[584][438] := fm7(v17[584][438], p0, globalState);
				}
				
				var v66: multiset<int> := multiset{f26};
				globalState.f9 := if (v66 >= v66) then p0 else f32;
			case DC36(cf69) =>
				globalState.f0 := --(f26 / f26);
				var v67: map<int, bool> := map[f26 := f32];
				var v68: set<bool> := {if (if (f26 in v67) then v67[f26] else false) then v18[454] else f32};
	...
	method m3(p0: bool, p1: seq<string>, globalState: GlobalState) returns (r0: string) {
		...
		if ((v1 !! v1) <==> p0) {
			...
			if (v3[f26]) {
				...
				v8 := v8[(if (v3 in v9) then v9[v3] else f26) / f26 := DC37(v2.f34, v2.f34, v5, v2.f34, |v10|)];
				v10 := v10[v2.f34 * v2.f34 := p0];
				var v11: array<int> := new int[21](i1 => i1 % |v3|);
				...
				v13[960], v15, globalState.f25, globalState.f25 := if ((v2.f34 / v2.f34) in v16) then v16[v2.f34 / v2.f34] else v0, v15 + [|[f26, v2.f34, v2.f34, v2.f34]|, v2.f34, -v2.f34, v2.f34, v2.f34], map[v3 := 0x312] == map[[f32, f32] := |v1|], !(v17 >= v18.cf80) <== p0;
			} else {
				var v19: seq<int> := [v2.f34];
				var v20 := DC31(p0, v19[v2.f34 := v2.f34], f32, f26);
				var v21: map<char, int> := map['t' := v2.f34];
				var v22: array<int> := new int[8] [v20.cf61, v2.f34, |v21|, v2.f34, v2.f34, v19[v2.f34], v2.f34, v2.f34];
				v22 := new int[23];
				globalState.f24 := v2.f34;
				v0[152] := p0;
				v0[152] := !(v3 <= v3);
				var v23 := new C1();
				var v24: map<bool, bool> := map[p0 := if (true) then v0[152] else f32];
				var v25: set<int> := {|f27|, v19[f26], f26, v19[0x158]};
			...
			globalState.f8 := -f26 / |map[f32 := v2.fm8(v26, f32, f26, v2.f34, globalState)]|;
		} else {
			var v27 := DC38();
			v27 := v27;
			...
			if (p0) {
				...
				var v31 := 'w';
				var v32 := DC54(v29);
				globalState.f17, globalState.f9, v30[650], globalState.f17, v31 := v28[401] - fm7(-f26, p0, globalState), v0[150], if (v0[150]) then v32.cf102 else v29, v28[401] - v28[401], 'y';
				var v33: map<int, bool> := map[v28[401] := p0];
				var v34 := DC0(f26);
				var v35: map<int, D0> := map[|v33| := v34];
				var v36 := DC52(v35);
				var v37: map<bool, bool> := map[(fm48(f26, f32, v36, globalState)).cf39 := false];
				globalState.f25 := (if (f32 in v37) then v37[f32] else !true) <==> (v0[150] ==> p0);
				var v38: multiset<int> := multiset{v28[401], v28[401]};
				var v39: seq<bool> := [f32];
				var v40: seq<int> := [DC6(f32, 'm', |multiset{v28[401]}|).cf11];
				var v41: seq<bool> := [fm8(v38, v0[150], 905, |v39|, globalState), p0, fm24(v39[|v40|], v0[150], v0[150], f26, globalState), if (|fm21(v28[401], 0x6f, f32, f32, globalState)| in v33) then v33[|fm21(v28[401], 0x6f, f32, f32, globalState)|] else false];
				var v42: multiset<bool> := multiset{v0[150]};
				...
				var v45 := 'i';
				var v46 := DC1(seq(0x35e, i5  => ('b')), |f27|, f26);
				var v47: array<string> := new string[27] [f27, f27, f27, "oqbwkhq" + f27, f27, fm43(p0, |v44[v28[401] := v43]|, globalState) + "bxptv", seq(0x367, i3  => ('c')), ("nnoknyvk" + f27)[v28[401] := v45], fm36(p0, p0, p0, globalState) + (seq(0x24c, i4  => (v45))), f27, f27 + v46.cf1, f27, f27, f27, f27, f27 + f27, "hncieu", "y", f27 + f27, f27, "yhaagcqq", f27, "paglhji", f27, f27, f27 + f27, if (p0) then f27 else ("xxpqa")[f26 := v45]];
				v47[118] := f27;
				v47[118] := f27;
				var v48 := new C1();
				globalState.f24 := f26;
				var v49: seq<int> := [v28[401]];
				globalState.f9 := !fm24(fm24(f32, f32, !f32, v28[401], globalState), f32, -f26 >= v49[v28[401]], v28[401], globalState);
				var v50: map<int, int> := map[f26 := f26];
				v50, globalState.f24, globalState.f25, globalState.f5, globalState.f9 := (map v51 : int | v51 in [0x1d1, v28[401], |v49|] :: (v51 + f26) := (v28[401]))[f26 := |"rmf"|], f26 / |(f27 + v47[118])|, true, (v28[401] / |(seq(0x217, i6  => (v45)))|) / |v1|, p0;
			}
		...
		if (fm8(multiset{0x2f4, |f27|}, !f32 <==> f32, -fm6(v52, |f27|, fm45(-0xa3, v54, map[f26 := f26], globalState), v56, globalState), f26, globalState)) {
			...
			var v75: multiset<string> := multiset{seq(808, i9  => ('p'))};
			...
			match (v77) {
				case DC31(cf58, cf59, cf60, cf61) =>
					...
					globalState.f25 := if (v55[|map[|cf59| := p0]|]) then f26 <= 0x215 else p0;
					var v78: array<int> := new int[28];
					v78[663] := f26;
					v78[663] := f26;
				case DC32(cf62, cf63, cf64) =>
					var v79: seq<int> := [f26, f26];
					var v80: map<seq<int>, string> := map[v79 + (seq(0xf0, i10  => (f26))) := f27];
				...
				case DC30(cf57) =>
					...
					var v89: array<int> := new int[15] [f26, |(v52 + v53)|, f26, |[f26, f26, DC24(f26, f26, f26).cf46, f26, 0x238]|, -0x2c6, f26, f26 / f26, f26, v87[f26], f26, f26, f26 - f26, f26 * |v55|, f26, |v88|];
					v89[941] := f26;
					var v91 := DC28();
					var v92: map<int, D9> := map[fm6(v52, f26, v87, map v90 : seq<bool> | v90 in (seq(656, i11  => (v55))) :: (v90) := (DC2(p0).cf4), globalState) := v91];
					globalState.f5, v89[941], globalState.f24, v86[123], globalState.f17 := f26, -(f26 + -f26), f26 / |v92[937 := v91]|, v0, if (f27[f26 := v84] == f27[519 := v84]) then (if (fm7(f26, p0, globalState) in v76) then v76[fm7(f26, p0, globalState)] else f26) + |v55| else f26;
					v89 := new int[22](i12 => i12 + v89[941]);
					var v93 := new C1();
			}
			...
			v94[184] := f26;
			v94[184] := -(f26 - (f26 * |v55|));
			var v95: seq<int> := [-v94[184]];
			var v96: multiset<bool> := multiset{f32, f32, p0};
			var v97: set<int> := {f26, v94[184], f26, f26, |v76|};
			v95 := fm21(f26, |(f27 + f27)|, !(f26 != (if (f26 in v76) then v76[f26] else |v96|)), v97 < v97, globalState);
			var v98: seq<seq<bool>> := [v55];
			var v99 := new C3(-f26, v95[|(v98[f26])[f26 := p0]|], fm36(f32, p0, p0, globalState));
			v0[892] := !p0;
			v0[892] := v99.f34 < f26;
		}
		
		for i14 := f26 to f26 {
			var v100: map<bool, bool> := map[f32 := v55[-0x2ac]];
			v100 := v100[p0 := !f32];
			...
			v105[269] := v103;
			v105[269] := new int[2](i15 => i15 * -f26);
		}
		if (true) {
			...
			var v109 := 'a';
			globalState.f13 := (f27[f26 := 'q'] + f27)[v108.cf74 := v109];
			v0[270] := false;
			...
			var v115 := DC56(v114);
			v0[270], v111, globalState.f25, globalState.f0, v113 := true, v111.(cf30 := [|v53|, 0xd2, f26]), !(v115.cf107 <= v114), f26, (if (f32) then map[v112 := f32] else v113) + v113;
			var v116: multiset<string> := multiset{seq(0x66, i16  => (v109))};
			var v117: map<int, string> := map[f26 := f27];
			var v118: array<string> := new string[5] [f27, f27, f27, DC1(f27, |f31|, |v116[seq(0x24b, i17  => (v109)) := f26]|).cf1, if (|f27| in v117) then v117[|f27|] else f27];
			var v119: map<int, array<string>> := map[f26 := v118];
			v119 := v119[f26 := v118];
			v109 := 'r';
			v106 := v106[p0 := fm24(f32, p0, v0[270], |f27|, globalState)];
		} else {
			...
			if (f26 != (-0x1d1 * f26)) {
				...
				var v129: multiset<bool> := multiset{true, v55[-0x1ad], p0, p0};
	...
	method m4(p0: int, p1: D2, globalState: GlobalState) returns (r0: int) {
		...
		var v3 := DC42(v2);
		v1[697] := (if (f32) then v2 else v2) >= v3.cf80;
		if (!f32) {
			globalState.f24 := -(-p0 % p0);
			r0 := f26;
			var v4: map<int, bool> := map[f26 := v1[697]];
			var v5 := DC11(f31, true, f26, p0);
			var v6: set<bool> := {f32, v1[697]};
			var v7: array<int> := new int[14];
			var v8: set<array<int>> := {v7, v7};
			var v9: map<int, map<int, int>> := map[f26 := (v5.(cf21 := map[|v6| := |v8|], cf23 := p0)).cf21];
			var v10: array<map<int, int>> := new map<int, int>[15] [f31, f31, f31, map[p0 := f26], f31, f31, f31, f31, f31, f31, fm40(v1[697], f26, v4, f32, globalState), f31[|([f32, v1[697], !f32, v1[697]])[|map[v1[697] := |(seq(376, i2  => (p0)))|]| := v1[697]]| := p0], f31, if (f26 in v9) then v9[f26] else f31, f31];
			v10[890] := f31;
			v1[697], globalState.f24, globalState.f8, v10[890] := v1[697], f26, p0, f31;
			var v11 := new C0();
			var v12: seq<bool> := [f32];
			globalState.f24 := -(|v12[p0 := v1[697]]| % f26) - p0;
		} else {
			var v13 := new C1();
			var v14, v15, v16 := v13.m2(v1[697], fm49(|[f26]|, globalState), globalState);
			var v17: map<bool, bool> := map[f32 := f32];
			var v18: set<int> := {v14, v14, |"mjs"|};
			var v19: seq<int> := [v14, v14];
			v17 := v17[v14 != f26 := |v18| != |v19|];
			var v20 := DC2(f32);
			var v21, v22, v23 := v13.m2(v1[697], v20, globalState);
			var v24: array<int> := new int[29](i3 => i3 % v21);
			v23[278] := v24;
			v23[278] := v24;
		}
		...
		if (DC2(v1[697]).cf4) {
			...
			var v29: map<T1, bool> := map[v28 := v1[697]];
			var v30: map<int, bool> := map[p0 := v1[697]];
			var v31: seq<int> := [f26];
			var v32: seq<bool> := [f32];
			var v33: map<seq<bool>, bool> := map[v32 := false];
			var v34: array<int> := new int[12] [p0, f26, f26, |f27|, f26, fm7(p0, v1[697], globalState), p0 - |v29|, f26, |fm50(globalState)| / |v28.f27|, p0 / f26, v28.fm6(v30, f26, v31, v33, globalState), f26];
			v34 := v34;
			var v35: map<D15, T1> := map[v3 := v28];
			if (|v35| !in fm40(v1[697], p0, v30, true, globalState)) {
				var v36: map<map<int, int>, int> := map[f31 := f26 / v28.f26];
				v36 := (fm51(p0, false, globalState) + v36) + v36;
				var v37: map<array<bool>, array<char>> := map[v1 := v0];
				var v38: map<bool, map<array<bool>, array<char>>> := map[v1[697] := v37];
				var v39: array<map<array<bool>, array<char>>> := new map<array<bool>, array<char>>[15] [map[v1 := v0], map[v1 := v0], v37, v37 + v37, (if (f32 in v38) then v38[f32] else v37) + v37, v37, (if (v1[697] in v38) then v38[v1[697]] else v37) + v37, v37, map[v1 := v0], v37, v37, v37, v37, v37, v37 + v37];
				v39[94] := v37;
				v39[94] := v37 + v37;
				...
				v1[697] := !false <== fm24(f32, v1[697], f32, |{v42}|, globalState);
				v34 := v34;
			} else {
				var v43: map<bool, int> := map[f32 := v28.f26];
				var v44: map<map<bool, int>, bool> := map[v43 := f32];
				var v45: map<bool, bool> := map[if (if (map[f32 := |v2|] in v44) then v44[map[f32 := |v2|]] else f32) then v1[697] else v1[697] := !f32];
				v45 := v45[v1[697] <== f32 := !f32];
				globalState.f25 := f32;
				globalState.f9 := f32;
				v1[697] := !f32;
			...
			v46[98] := (map v47 : char | v47 in v48 :: (v47) := (|v28.f27|)) + v26;
			v46[98], r0, globalState.f17 := (v26 + v26) + v26, -(p0 / v28.f26), -(if (!(f32 ==> true)) then v28.f26 else v28.f26);
		} else {
			var v49: array<int> := new int[3];
			v49[673] := -(f26 * |fm14(globalState)|);
			v49[673] := |(seq(-0x1de, i4  => ('j')))|;
			globalState.f25 := v1[697];
			v1[697] := f32;
			...
			v51 := v51[!v1[697] := if (f32) then v1[697] else f32];
		}
		
		var v52: seq<int> := [f26, p0, p0];
		var v53: map<seq<bool>, bool> := map[[!f32, !f32, v1[697]] := f32];
...
class C5 extends T1 {
	...
	function fm6(p0: map<int, bool>, p1: int, p2: seq<int>, p3: map<seq<bool>, bool>, globalState: GlobalState): int {
		|([[f29, |multiset{!true}|], [0x274, |map[{'e'} := f30]|, -f30], [|(map v0 : char | v0 in multiset{'t', 'r'} :: (v0) := (true))|, f30, |DC7([false, false]).cf12|]] + ((seq(-0x348, i0  => (seq(-0x2cf, i1  => (f26))))) + [[|(seq(0x1e6, i2  => (|f27[f29 := 's']|)))|], [f26, f30]]))|
	}
	function fm7(p0: int, p1: bool, globalState: GlobalState): int {
	...
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v3: array<bool> := new bool[11] [p1, p1, p1 || p1, v2[|(seq(839, i2  => (v1)))|], p1, p1, true, DC9(-f29, p1, f26, f30).cf17, p1, p1, p1];
			v3[220] := p1;
			v3[220] := p1;
		...
		var v8 := 'q';
		r1, globalState.f23, globalState.f17, v5[220] := p1, (if (p1 ==> !p1) then f27 else f27 + f27)[832 + --|v7| := v8], 566, p1;
		p0[616] := f26;
		p0[616] := f26;
		var v9: map<int, map<bool, int>> := map[f29 := map[v5[220] := f26]];
		var v10: map<bool, int> := map[v5[220] := f26];
		var v11: seq<int> := [f30, |(if (0x220 in v9) then v9[0x220] else v10)|];
		p0[616] := |(if (v5[220]) then v11 else [-(fm10(globalState)).cf11, f29, |v11|])|;
		if (p1) {
			var v12: multiset<int> := multiset{f26, f26};
			var v13: set<bool> := {v5[220], p1, false, p1};
			var v14: map<bool, bool> := map[fm8(v12[|v11| := f26], p1, -0xf8, p0[616], globalState) := !fm8(multiset(v11), !v5[220], |v13|, p0[616], globalState)];
			var v15: set<map<bool, bool>> := {v14, DC10(v14).cf20};
			v5[220] := fm11(v5[220], globalState) != v15;
			var v16: map<int, bool> := map[f29 := false];
			v16 := map[fm7(f26, !true, globalState) := v6[f30]];
			var v17 := new C3(f26, f26, seq(0x76, i3  => (v8)));
			globalState.f9 := [!v5[220]] <= [v5[220]];
			var v18: seq<map<bool, bool>> := [map[v5[220] := p1]];
			...
			v20 := v20[fm43(v6[|v21|], -f26, globalState) := {v14}];
		} else {
			...
			v22[763] := v23;
			var v24: map<int, string> := map[-p0[616] - |DC50(f30, v5[220], v11, v8, f26).cf95| := f27[f26 := v8]];
			v22[763], globalState.f23 := (map[v5 := v10] + v23[v5 := v10]) + map[v5 := v10], if (p0[616] in v24) then v24[p0[616]] else f27 + f27[f26 := v8];
			var v25: array<char> := new char[16];
			var v26: map<int, array<char>> := map[p0[616] := v25];
			var v27 := DC54(if (f29 in v26) then v26[f29] else v25);
			var v28: map<bool, array<char>> := map[p1 := v25];
			match (v27.(cf102 := if (v5[220] in v28) then v28[v5[220]] else v25)) {
				case DC55(cf103, cf104, cf105, cf106) =>
					globalState.f9 := v5[220];
					var v29: array<array<bool>> := new array<bool>[11];
					v29 := v29;
					var v30: set<bool> := {v5[220], v5[220], cf104, cf106};
					var v31 := DC5(v30);
					var v32: map<int, D1> := map[p0[616] := v31];
					var v33 := DC13(v32);
					var v34 := DC25(cf106, v10, 'c', v33, cf105);
					globalState.f25 := -f30 == v34.cf53;
					var v35: map<int, bool> := map[cf105 := v6[f26]];
					globalState.f8, p0[616] := |v35| * cf103, cf103;
				case DC54(cf102) =>
					globalState.f13 := f27;
					globalState.f0 := f29 / f30;
					var v36: set<bool> := {v5[220]};
					var v38: map<int, bool> := map[f30 := v5[220]];
					var v39: map<bool, map<int, bool>> := map[!v5[220] := v38];
					var v41 := new C4(v6[|v24[|fm0(v5[220], f27, v36, f29, globalState)| := f27]|], p0[616], "enn", map v37 : int | v37 in (if (v5[220] in v39) then v39[v5[220]] else map[896 := v5[220]]) :: (v37 % |(set v40 : int | v40 in [|map[-f30 := f30]|, DC32(v5[220], |multiset{|map[p1 := p1]|}|, false).cf63] :: (v40 % -0x16a))|) := (p0[616]));
					p0[616] := f29 * (|multiset{true}| - |(v10[v5[220] := f29])[v5[220] := |"rol"|]|);
			}
			
			p0[616] := |(seq(0x3d7, i4  => (f30)))|;
			var v42: map<string, array<int>> := map[f27 := p0];
			var v43: multiset<array<int>> := multiset{p0};
			var v44 := DC23(p1, v42 + v42, v43, !(if (false) then v5[220] else p1));
			v44 := v44.(cf44 := multiset{p0});
			var v45 := DC45(f30, v5[220], p0[616], |f27|, false);
			var v46 := DC46(v45);
			match (v46) {
				case DC45(cf82, cf83, cf84, cf85, cf86) =>
					...
					globalState.f8 := cf84 / --f30;
				case DC44(cf81) =>
					var v50 := DC31(p1, [|f27|], v5[220], f29);
					var v51: multiset<int> := multiset{|f27|};
					var v52: map<seq<bool>, bool> := map[v6[p0[616] := p1] := v5[220]];
					v5[220], v5[220], globalState.f9, globalState.f8, globalState.f0 := p1, f30 != -f30, v5[220], |(v6 + (if (p1) then ([p1, v5[220]])[v11[f30] := v5[220]] else v6))|, if (v50.cf60 in v10) then v10[v50.cf60] else -(if (f29 in v51) then v51[f29] else fm6(map[f26 := v5[220]], 182, v11, v52, globalState));
					var v53: array<string> := new string[15] ["fbh", f27 + (seq(138, i5  => (v8))), f27, f27, "xhed", "wklq" + f27, f27, f27 + f27, f27, f27, f27 + f27, f27, "e", f27 + f27[p0[616] := 'n'], "xjsu"];
					v53[172] := f27;
					var v54: array<array<bool>> := new array<bool>[6];
					v54[138] := v5;
					var v55: map<bool, array<bool>> := map[fm8(multiset{p0[616], 0x31c}, v5[220], |v7|, p0[616], globalState) := v5];
					var v56: set<char> := {v8};
					v53[172], v54[138], r1, v5[220], v54 := "qqkfolo", if ((v8 !in [v8, v8]) in v55) then v55[v8 !in [v8, v8]] else v5, p1, if (v5[220]) then p1 else v56 >= v56, if (true) then v54 else v54;
					var v57: set<bool> := {p1};
					var v58 := DC45(|v11|, p1, f30, p0[616] - -p0[616], fm0(p1, f27, v57, f29, globalState) == v6);
					var v59: array<seq<int>> := new seq<int>[6];
					v59[707] := v11;
					var v61: T2 := new C2(v11, map v60 : int | v60 in v11 :: (v60 + f26) := (f26));
					var v62: seq<T2> := [v61, v61];
					var v63: map<T2, bool> := map[v62[f29] := false];
					var v64 := DC48(v61, f26, v8);
					v58, v59[707], globalState.f9, v5 := v58, v11, (if (v64.cf89 in v63) then v63[v64.cf89] else p1) <== v5[220], v54[138];
					globalState.f5 := f26;
				case DC46(cf87) =>
					v5[220] := v5[220];
					var v65 := DC19(-0x4d, v5[220]);
					var v66 := DC21(v65);
					var v67: seq<D7> := [v66];
		...
		var v72: map<bool, bool> := map[v5[220] := v5[220]];
		if ((p1 in v72) && !p1) {
			var v73 := DC50(f29, p1, v11, v8, f29);
			var v74: array<string> := new string[24] [fm43(v73.cf94, f29, globalState), seq(0x208, i6  => (v8)), seq(0x266, i7  => (v8)), f27, f27, fm43(p1, p0[616], globalState), f27, f27, "m", f27, f27, f27, f27, f27, f27, f27, f27, f27, seq(0x2c7, i8  => (v8)), f27, f27, f27[p0[616] := v8], f27, "tlbn"];
			var v75 := DC40(v74, v5, v5[220]);
			var v76 := DC16(f26, p1);
			p0[616], r1, r0, v5, globalState.f24 := f30 * p0[616], [p1, if (p1 in v72) then v72[p1] else true] == v6, -(p0[616] % fm6((map[f26 := !p1])[|v7| := v5[220]], f29, v11, fm28(globalState), globalState)), v75.cf77, v76.cf31;
			globalState.f25 := p1;
			globalState.f8 := p0[616];
			var v77: C0 := new C0();
			var v78: multiset<C0> := multiset{v77};
			var v79: multiset<int> := multiset{f30, |f27|};
			v5[220], globalState.f25 := !(v78 > v78), fm8(v79[f29 := p0[616]] + v79, |v6| != f26, if (f26 in v79) then v79[f26] else |f27|, f29, globalState);
			f29 := f26 * |"vdy"|;
		} else {
			p0[616] := --0x185;
			globalState.f13 := f27;
			var v80: multiset<int> := multiset{|(seq(0x87, i9  => (f29)))|, p0[616], p0[616]};
			if (v6[if (fm8(v80, !p1, f29, f30, globalState)) then p0[616] else f29]) {
				var v81 := DC31(v5[220], v11, v5[220], f26);
				globalState.f5 := v81.cf61;
				var v82: array<seq<bool>> := new seq<bool>[11] [v6, v6, v6, v6, v6, v6, v6, v6, v6, ([!p1])[f29 := v5[220]], v6];
				...
				v5[220] := !((p0[616] + f30) <= f30);
				var v87 := DC18(p0[616], p0);
				var v88 := DC21(v87);
				var v89: seq<D7> := [v88.(cf40 := v87)];
				var v90: seq<seq<D7>> := [v89];
				var v91 := DC27(v90);
				var v92: map<array<int>, D9> := map[p0 := v91];
				v5[220], globalState.f0 := v8 in f27, --|((v92 + v92) + v92)|;
			} else {
				var v94: map<int, int> := map[f29 := p0[616]];
				globalState.f8 := (if (p1) then |(set v93 : int | (0x18f <= v93) && (v93 < 0x137) :: (v93 % f30))| else if (0x278 in v94) then v94[0x278] else f26) - 459;
				var v95: set<bool> := {true};
				var v96 := DC5(v95);
				var v97: map<int, D1> := map[|multiset{v5[220]}| := v96.(cf8 := v95)];
				var v98 := DC13(v97);
				var v99: seq<string> := [f27];
				var v100: seq<multiset<bool>> := [multiset{v5[220]}];
				var v101: map<array<bool>, int> := map[v5 := |v100|];
				var v102: array<D4> := new D4[25] [v98, v98, v98, v98, v98, v98, DC13(map[f26 := v96]), v98, DC13(v97), DC13(v97), v98, v98, if (v5[220]) then v98 else DC13(v97), v98.(cf28 := map[0x33 := v96]), fm52(p1, p1, |f27|, f26, globalState), DC13(v97), v98.(cf28 := v97), v98, v98, v98.(cf28 := v97), DC13((map[p0[616] := v96.(cf8 := v95)])[|v99| := v96]), v98, v98, v98.(cf28 := map[|v101| := v96]), v98];
				v102[339] := v98;
				var v103: T0 := new C1();
				var v104 := DC32(v5[220], |f27|, v5[220]);
				globalState.f9, p0[616], v102[339], v103 := v104.cf64, f26 + (if (p1) then f30 else |[false, p1]|), DC13(v97), v103;
	...
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		...
		if (p0) {
			...
			var v10: array<char> := new char[12] ['f', v5, f27[fm6(v6, f29, v7, v9, globalState)], v5, v5, if (p0) then 'b' else 'y', if (p0) then v5 else v5, v5, v5, 'h', v5, v5];
			v10 := v10;
			v7 := v7;
			var v11: C3 := new C3(f26, f29, f27);
			var v12: map<C3, bool> := map[v11 := !v8[f29]];
			v12 := v12[v11 := p0];
			globalState.f9 := p0;
			...
			if (!p0) {
				...
				globalState.f23 := f27;
				globalState.f17 := f30;
				var v15: array<bool> := new bool[19] [v0[475], v0[475], v0[475], v0[475], p0, v0[475], p0, p0, p0, p0, p0, p0, v0[475], false, v0[475], v0[475], true, false, p0];
				var v16 := DC35(DC34(v15, p0));
				var v17 := DC35(v16);
				v17 := v17.(cf68 := DC35(v16));
				var v18: seq<int> := [f26];
				var v19: map<int, bool> := map[|v18| := v0[475]];
				var v20: map<bool, array<bool>> := map[if (f30 in v19) then v19[f30] else p0 := v15];
				v20, globalState.f8, globalState.f9, globalState.f25, globalState.f24 := v20, -f26, v0[475], v0[475], -|f27|;
			} else {
			...
			if (!p0) {
				globalState.f25 := p0;
				var v35: array<int> := new int[18](i1 => i1 % |"in"|);
				v35[996] := 129 * f30;
				var v36: set<bool> := {p0, p0};
				var v37: seq<bool> := [p0, p0];
				globalState.f25, v35[996], globalState.f9, globalState.f0 := p0, -(|v36| / -0x1fd), v37[f26] && (f29 >= f29), f30;
				...
				var v46: set<seq<D7>> := {v44, v45[f26]};
				var v47 := DC44(v46 + v46);
				v47 := v47;
				var v48: map<int, int> := map[f29 := f29];
				var v49 := DC34(v0, p0);
				v48 := v48[fm7(f30, v49.cf67, globalState) := f29 % f30];
			} else {
				...
				var v52: T0 := new C1();
				var v53: seq<T0> := [v52];
				v0[376] := v53 != (if (p0) then [v52, v52] else v53);
				var v54: multiset<bool> := multiset{true};
				var v55: map<int, int> := map[f29 := 0x259];
				var v56 := new C4(p0, |v54|, seq(0x2f7, i3  => (f27[f30])), v55);
				var v57 := new C1();
				var v59: seq<map<int, D6>> := [map v58 : int | (0x272 <= v58) && (v58 < -472) :: (v58 * f29) := (DC16(f26, v0[376]))];
				...
				var v64: array<bool> := new bool[24] [v0[376], v0[376], v56.f32, p0, f29 == f26, v0[376], v56.f32, v56.f32, v59[f30] != v61, v0[376], f30 >= f30, p0, v56.f32 <== v56.fm8(v62, p0, f29, f26, globalState), false ==> !p0, v0[376], !!v0[376], v0[376], v56.f32, p0, v56.f32, DC31(v0[376], [|f27|, f29], p0, f26).cf60, v0[376], v0[376], v63 != v63];
				globalState.f1 := v64;
			}
			...
			v65[148] := f29;
			v65[148] := if (!true) then f26 - -609 else f30;
		}
		...
		match (p1) {
			case DC0(cf0) =>
				...
				var v71 := DC28();
				v69[617] := 0x246;
				v0[994] := fm24(p0, p0, fm24(p0, p0, p0, f26, globalState), cf0, globalState);
				var v72: seq<bool> := [!p0];
				var v74: multiset<map<int, int>> := multiset{map v73 : int | (0x335 <= v73) && (v73 < 0x2f) :: (v73 / f29) := (|multiset{f30}|)};
				var v75: map<int, int> := map[f30 := |v70|];
				v69[960], v70, v71, v69[617], v0[994] := |((v72 + v72) + v72)|, ((v70[|[v72, v72[f29 := p0]]| := if (v75 in v74) then v74[v75] else f29])[cf0 := |f27|])[f26 := f26], fm38(p0, globalState), f26 - 0x2da, p0;
				var v76 := DC20(!p0, p0);
			...
			case DC1(cf1, cf2, cf3) =>
				...
				globalState.f24 := |(if (p0) then v82 else (v83[|(seq(181, i5  => (cf3)))|] + (seq(0x17f, i6  => (v80))))[f29 := fm18(fm7(|v86|, p0, globalState), globalState)])|;
				var v87: seq<array<bool>> := [v0];
				var v88: seq<D7> := [v1.(cf33 := v87[cf2]).(cf33 := v0), v1];
				globalState.f24 := (|v88[cf2 := v1]| - f29) / cf2;
				var v89: seq<bool> := [p0];
				v0[2] := v89[f29];
				v0[2] := p0;
			case DC2(cf4) =>
				globalState.f13 := seq(0x3cb, i7  => (if (cf4) then 'n' else 'x'));
				globalState.f24 := f29;
				globalState.f9 := (f27 + f27) != (seq(0x337, i8  => ('o')));
				var v90: multiset<int> := multiset{f30, f30, f26};
				var v91 := 'j';
				var v92: array<string> := new string[21] [f27 + "jxbnntp", seq(-0x3a4, i9  => ('c')), if (fm8(v90, !cf4, f29, |v90|, globalState)) then f27 else f27, if (cf4) then f27 else f27, seq(444, i10  => ('d')), fm36(cf4, cf4, p0, globalState), f27 + f27, f27, f27, f27 + f27, f27, f27, f27, f27, seq(-0x1d1, i11  => ('y')), ((seq(846, i12  => ('a'))) + f27)[-0x5a := v91], f27, f27, f27, seq(-0x167, i13  => (v91)), f27 + (seq(-0x187, i14  => (f27[-0x35b])))];
				v92[123] := f27;
				...
				cf4, globalState.f25, cf4, globalState.f24, v92[123] := p0, p0, p0, f29, (fm36(p0, cf4, p0, globalState))[0x2a7 - f26 := fm42({|v90|, f29, v97.cf90}, globalState)];
			case DC3(cf5, cf6) =>
				var v98: seq<bool> := [p0];
				if (f26 < |v98|) {
					var v99: array<int> := new int[4](i15 => i15 % |f27|);
					...
					var v106: array<T0> := new T0[5] [v103, v105[cf6], if (true) then v103 else v103, v103, v103];
					v106[560] := v103;
					v106[560] := v103;
					...
					var v111: map<int, int> := map[0x3e0 := |v66[p0 := v98[cf5]]|];
			...
			case DC4(cf7) =>
				...
				if (p0) {
					...
					var v125: array<int> := new int[4] [f26, |f27|, |(("orpypysup")[v124.cf53 := v119])[0x3d5 := v119]|, |f27|];
					var v126: map<int, bool> := map[f26 := true];
					v125[28] := fm6(v126, f30, [f26, f26, f29, f30], map[[p0, p0] := p0], globalState) % -f26;
					globalState.f9, globalState.f9, v117, v125[28] := f30 < f26, p0, v117, |"jvoen"|;
					v0[227] := p0;
					v0[227] := !p0;
				} else {
					globalState.f5 := (f30 - f30) % -0x2f7;
					...
					v131[669], globalState.f0, globalState.f25, globalState.f9, globalState.f9 := f30, if (v133[|v134|] in v132) then v132[v133[|v134|]] else 0x20d, fm24(p0, p0, p0, -|v66| * f29, globalState), !!(v135 !in v136), v137 > (v137 - v137);
				...
				globalState.f25, globalState.f17, v145 := p0, 0x36c % (f26 - -0x27c), DC19(|v146|, p0);
		}
		...
		if (!p0) {
			...
			globalState.f9 := p0;
			var v149: array<string> := new string[19] [f27, "qksflf", "ujenvwrw", f27, f27, "jsytxhdyk", "wv", "vioievb", f27, f27, seq(107, i17  => ('f')), f27, f27, f27, f27, f27, f27, f27, f27];
			var v150: map<int, array<string>> := map[f30 / f29 := v149];
			v150 := v150[f30 := v149];
			var v151 := DC3(f30, f29);
			var v152: seq<D0> := [v151, v151, v151];
			var v153 := DC4(v152[-f29]);
			match (v153) {
				case DC0(cf0) =>
					var v154: seq<int> := [f29, f30, f29];
					var v155 := 'j';
					var v156: map<char, bool> := map[v155 := p0];
					var v157: array<int> := new int[8] [|v156|, cf0 + f29, cf0, f30, |{'c', v155, 'q', 'n'}|, f26 / f26, cf0, cf0];
					v157[849] := cf0;
					var v158: array<array<bool>> := new array<bool>[16];
					var v159: seq<array<array<bool>>> := [v158];
					var v160: map<array<array<bool>>, seq<int>> := map[v159[cf0] := v154];
					v154, v149, globalState.f9, r0, v157[849] := if (v158 in v160) then v160[v158] else v154, v149, p0 <==> (f30 == cf0), -f30, f29;
					globalState.f9 := p0;
					v154 := v154;
				...
				case DC1(cf1, cf2, cf3) =>
					...
					v161 := if (p0) then [v67, set v163 : int | v163 in v162 :: (v163 * |multiset{|(seq(-0xed, i18  => ('v')))|}|)] else seq(-0xcc, i19  => (v67));
					v0 := new bool[4];
				...
				case DC2(cf4) =>
					...
					var v174 := DC61(v173[f29]);
					r0, v172, globalState.f25 := f30, v174.cf118, cf4;
					var v175: array<map<bool, bool>> := new map<bool, bool>[27](i20 => map[v168[0x189] := p0]);
					var v176: multiset<int> := multiset{f30, f30};
					v175[823] := map[fm8(v176, cf4, f30, f30, globalState) := cf4];
					v0[442] := fm24(cf4, p0, fm8(v176, cf4, -0x1bd, 652, globalState), -f26, globalState);
					var v177: seq<map<bool, bool>> := [v66 + v66];
					globalState.f24, v175[823], v0[442], cf4 := (f29 - f30) % (f29 - f26), v177[-0x19], p0, p0;
				case DC3(cf5, cf6) =>
					var v178 := 'p';
					v178 := 'g';
					globalState.f9 := false;
					...
					globalState.f5, v180, v181, globalState.f24 := v182.cf34, v184[-0xdd], v181, f29 - 0x78;
					var v185 := new C1();
				case DC4(cf7) =>
					...
					globalState.f0 := fm7(f26 / f29, fm6(v186, f30, v187[|f27| := |map[p0 := f26]|], v189, globalState) == f29, globalState);
			...
			v202[433] := set v204 : set<bool> | v204 in v203[v198 := 0x8f] :: (v204);
			var v205: multiset<int> := multiset{f26, f29};
			v205 := v205 * ((multiset{f26})[f26 := if (f29 in v205) then v205[f29] else f30] - v205);
		}
...
class C6 extends T0, T1 {
	...
	function fm6(p0: map<int, bool>, p1: int, p2: seq<int>, p3: map<seq<bool>, bool>, globalState: GlobalState): int {
		|(match DC2(false) {
			...
			case DC2(cf4) => map[DC0(|(seq(0x20f, i0  => (|map[cf4 := f26]|)))|) := cf4]
	...
	method m1(p0: array<int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
		...
		match (v0) {
			case DC0(cf0) =>
				...
				var v3: array<string> := new string[8] [if (f26 in v2) then v2[f26] else if (cf0 in v2) then v2[cf0] else seq(0x66, i0  => ('c')), f27, f27 + f27, f27, f27, f27, f27, f27];
				v3[789] := DC1(f27, 226, 0x61).cf1;
				v3[789] := f27 + f27;
				v3 := v3;
			case DC1(cf1, cf2, cf3) =>
			...
			case DC2(cf4) =>
				...
				r1 := (if (f27[|"sy"|] in v26) then v26[f27[|"sy"|]] else v11) == v11;
				var v27: set<bool> := {cf4, fm8(v10, p1, 0x128, f26, globalState), cf4};
				v27 := {cf4};
				var v28: seq<int> := [|v11|, f26];
				globalState.f17 := v12.f26 % (f26 % v28[v12.f26]);
			case DC3(cf5, cf6) =>
				globalState.f25 := p1;
				var v29 := 'r';
				v29 := v29;
			...
			case DC4(cf7) =>
				if (!p1) {
					...
					v57, v49 := v57, fm0(p1, seq(-641, i5  => (v46)), v58[p0[292]], |"wd"|, globalState);
				} else {
					...
					var v71: map<int, C5> := map[-(|"mliwwul"| % (if (f26 in v60) then v60[f26] else f26)) := if (p1) then v70 else v70];
					v71 := v71;
					...
					v70.f29, globalState.f0, globalState.f9, globalState.f9 := v70.f30, |([p1] + fm0(true, if (f26 in v73) then v73[f26] else "ohsnbkvuj", v74, v70.f30, globalState))|, !!v70.fm8((v77[-DC32(p1, -0xb8, p1).cf63])[0xed := |(seq(0x158, i6  => (|v60|)))|], p1, v70.f29, v70.f29, globalState), p1;
					var v78 := 'y';
					v78 := v78;
				}
				...
				v79[746] := p1;
				var v80: multiset<string> := multiset{seq(0xf5, i8  => ('w'))};
				v79[746] := (multiset{f27, f27} - v80) == v80;
				var v81: seq<bool> := [p1, p1, v79[746]];
				var v82: map<int, string> := map[|v81| := f27];
				var v83: seq<int> := [f26, f26 / f26, |v82|, f26 + f26];
				v83 := v83;
				var v84: seq<string> := ["dm"];
				var v85: seq<string> := [v84[f26]];
				var v86 := DC14(v85[-f26 := seq(-221, i9  => ('c'))]);
				match (v86) {
					case DC14(cf29) =>
						...
						globalState.f9 := v92 < v92[v91 := |v81|];
						globalState.f9 := v79[746];
				}
		...
		if (p1) {
			...
			if ({f26, f26} !! v93) {
				...
				v100[905] := map v101 : char | v101 in fm36(false, p1, p1, globalState) :: (v101) := (|{p1, true}|);
				...
				v100[905], v103, v104[564], v107 := v95, DC52(v102), v105, v107;
				globalState.f8 := f26;
				...
				p0[154], globalState.f25, v113, v116, v111[684] := |(f27 + f27)|, if (f26 in v117) then v117[f26] else p1, v113, v116, v111[684];
				var v118: set<char> := {v112, v111[684]};
				globalState.f25 := (v111[684] in v118) <== (f26 <= 0x309);
				r1 := (f27 + f27) < f27;
				var v119: array<bool> := new bool[21];
				var v120: seq<array<bool>> := [v119, v119, v119];
				var v121: map<string, bool> := map[f27 := p1];
				var v122: map<array<bool>, map<string, bool>> := map[if (true) then v120[p0[154]] else v119 := v121 + v121];
				v122 := v122[v119 := v121 + v121];
			}
			
			globalState.f25 := p1 <== (if (p1) then p1 else p1);
			globalState.f24 := 0xe9;
			globalState.f25 := fm8(multiset{f26, f26}, p1, f26 / f26, f26, globalState);
			if (p1) {
				...
				v123, globalState.f8, v123 := if (p1) then v123 else fm0(p1, seq(-0x39f, i10  => ('t')), fm14(globalState), f26, globalState), fm6(if (p1) then v124 else map[|v125| := p1], 0x367, v126, map v127 : seq<bool> | v127 in v128 :: (v127) := (!p1), globalState), v123 + v123;
				var v129: array<char> := new char[10](i11 => 'p');
				var v130 := 'o';
				v129[930] := v130;
				v129[930] := v130;
				globalState.f25 := (seq(0x4d, i12  => (v130))) <= f27;
				p0[458] := f26;
				globalState.f25, p0[458] := false, -(-f26 - f26);
				var v131: map<bool, bool> := map[p1 := p1];
				var v132: map<int, map<bool, bool>> := map[v126[f26] := v131];
				var v133: multiset<bool> := multiset{p1, p1, p1};
				r1, v132, globalState.f8 := p1, v132, p0[458] + |(multiset(v128[-f26]) - v133)|;
			} else {
				...
				var v138 := new C0();
				var v139 := 'e';
				var v140: array<string> := new string[4] [f27, f27, f27, (f27 + "gehqfs")[f26 := v139]];
				v140[317] := f27;
				v140[317] := f27 + f27;
			...
			if (p1) {
				...
				v153[608] := multiset{f27, f27, f27} * fm56(|v154|, globalState);
			...
			if (p1) {
				...
				v160 := new int[14] [f26, f26 + |map[p1 := p1]|, f26, -(|v162[f26]| / f26), -|v163|, 0x2cf, f26, f26 * f26, f26, |v166.cf95|, f26, f26, -0x8d + f26, fm9(-|f27|, f26, p1, globalState)];
				var v167: array<map<int, int>> := new map<int, int>[3];
				v167 := v167;
				var v168: seq<string> := [f27];
				var v169 := DC14(v168 + ([f27, f27])[|(seq(946, i14  => (v165)))| := f27]);
				v169 := DC14(v168).(cf29 := [f27, f27, seq(538, i15  => (v165))] + [f27]);
				var v170: seq<multiset<bool>> := [multiset{!p1, false}];
				var v171: seq<seq<multiset<bool>>> := [[fm37(p1, p1, f26, f26, globalState)]];
				var v172: array<seq<multiset<bool>>> := new seq<multiset<bool>>[28] [v170, [multiset(v161), v159], v170 + v170, v170 + v170, v170, v170, v170, v170 + v170, v170, v170[f26 := multiset([p1])] + fm57(p1, p1, f26, |[p1]|, globalState), v170, v170, v170, [v159], v170, v171[f26], v170 + fm57(p1, p1, f26, f26, globalState), v170 + [v159], v170, v170, v170, v170, seq(0xb7, i16  => (v159)), v170, v170[f26 := v159], [v159, v159] + v170, fm57(p1, p1, |f27|, |v159|, globalState) + v170, v170];
				v172[985] := v170 + v170;
				v172[985] := v170;
			} else {
				var v173: C1 := new C1();
				...
				var v177: T2 := new C2(v175, (map v176 : int | (0x57 <= v176) && (v176 < 0x1de) :: (v176 - |(seq(-430, i17  => ('w')))[651 := 't']|) := (|{|[p1]|}|))[f26 := f26]);
			...
			if (!(|v179| != fm7(f26, p1, globalState))) {
				...
				v180[439] := v181;
				var v182 := DC22(v181);
				v180[439] := (v182.cf41 + v181) + v181;
				var v183: seq<bool> := [p1, p1, p1];
				var v184: map<seq<bool>, bool> := map[v183 := p1];
				var v185 := 'a';
				var v186 := new C5(f26, f26, fm6(v180[439], f26, [f26], v184, globalState), ("afigneams" + f27)[f26 := v185]);
				v183 := (v183 + v183)[|f27| - v186.f29 := !p1];
				globalState.f24 := -907;
			} else {
				globalState.f0 := -(f26 / |v179|) + f26;
				globalState.f5 := f26;
				var v187: multiset<bool> := multiset{!!p1, p1};
				var v188: map<int, bool> := map[f26 := fm24(true, p1, p1, f26, globalState)];
				var v189: array<multiset<bool>> := new multiset<bool>[7] [v187, multiset{p1}, v187 * v187, multiset{if (f26 in v188) then v188[f26] else p1}, v187[true := f26], v187, v187];
			...
			var v197: map<bool, map<char, bool>> := map[(seq(-0x342, i18  => ('r'))) <= f27 := map[fm42(v195, globalState) := if (p0 in v196) then v196[p0] else p1]];
		...
		r0 := fm6(map v201 : int | v201 in v202 :: (v201 % f26) := (p1), |v202|, if (!p1 in v203) then v203[!p1] else v202, v204, globalState) % f26;
			...
			decreases 100 - i19
		{
			...
			var v210 := 'e';
			v209[621] := fm20(p1, v210, f26, 'l', globalState);
			v209[621] := v210;
			...
			if (0x16f == f26) {
				...
				var v214: map<int, bool> := map[|v213| := v211[940]];
				...
				v220[113] := f27 + f27;
				v220[113] := fm43(v211[940], f26, globalState);
			} else {
				globalState.f0 := f26;
				globalState.f9 := p1;
		...
		p0[379], globalState.f0 := (471 / f26) / (f26 - f26), if (p1 in v226) then v226[p1] else f26;
		r0 := DC55(f26, p1, f26, p1).cf105;
		r1 := if (p0[379] != f26) then p1 else p1;
	}
	method m2(p0: bool, p1: D0, globalState: GlobalState) returns (r0: int, r1: multiset<D0>, r2: array<array<int>>) {
		var v0: multiset<seq<int>> := multiset{seq(-0x3bd, i0  => (f26))};
		v0 := v0;
			...
			decreases 100 - i1
		{
			...
			var v4 := DC33(v3);
			var v5: array<int> := new int[29](i2 => i2 % f26);
			v5[328] := -f26 / f26;
			...
			globalState.f9, v2, v4, v5[328], v1 := v9[f26], v2, v4, f26, if (p0) then v1 else map[p0 := f26];
			globalState.f24 := |f27|;
			var v10: map<int, bool> := map[f26 := true];
			globalState.f5 := v5[328] / |(map[463 := p0] + v10)|;
		}
		var i4 := 0;
		while (p0)
			decreases 100 - i4
		{
			...
			if (f26 > (f26 - f26)) {
				...
				var v12: map<bool, bool> := map[if (p0) then p0 else p0 := if (!false) then p0 else fm8(multiset(v11), p0, fm9(f26, f26, p0, globalState), |(seq(-0x2c7, i5  => ('a')))|, globalState)];
				...
				v13[407] := if ((seq(-0x17a, i7  => (f27[f26]))) in v16) then v16[seq(-0x17a, i7  => (f27[f26]))] else f26;
				...
				var v24: seq<map<int, int>> := [v23[|f27| := v13[407]]];
				v17[83], v18[776], globalState.f25, globalState.f9, v20 := v19, ((seq(0x251, i8  => (map v21 : int | (0xfc <= v21) && (v21 < 324) :: (v21 / DC12(p0, v13[407], p0).cf26) := (v13[407])))) + v24) <= v24, !p0, false, multiset{p0};
			} else {
				...
				v28 := v28[false := if (p0 in v28) then v28[p0] else seq(0x19d, i9  => ('p'))];
				...
				globalState.f25, globalState.f25, v29[729], globalState.f8 := if (f27 in v30) then v30[f27] else !p0, p0 <== p0, f27 + ("fn")[f26 := 'd'], |(map[v33 := v34] + v35)|;
			}
			...
			if (p0) {
				...
				var v40: seq<int> := [if (v36[160] in v39) then v39[v36[160]] else |v1|];
				var v41: map<seq<bool>, bool> := map[[p0] := p0];
				var v42: seq<bool> := [!v36[160]];
				globalState.f9 := f26 <= fm6(v38, f26, v40, v41[v42 := p0], globalState);
				var v43: C3 := new C3(f26, 0x151, f27);
				var v44 := DC65(v43);
				var v45: seq<C3> := [v43];
				var v46: array<C3> := new C3[27] [v43, v43, v43, v43, v43, v44.cf122, v43, v43, v43, v43, if (false) then v43 else v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v43, v45[-f26], v43, v43, v45[f26], v43, v45[f26]];
				v46[535] := v43;
				v46[535] := v43;
				var v47: set<int> := {|v39|};
				var v48: multiset<set<int>> := multiset{v47, v47, v47};
				var v49 := new C5(f26 + v43.f34, -|multiset{f26, v43.f34, f26, |v48[v47 := v43.f34]|}|, f26, f27);
				var v50: array<int> := new int[23](i10 => i10 % |f27|);
				v50[500] := |([v43.f34] + v40)|;
				v50[500] := v43.f34;
			} else {
				var v51: seq<int> := [-f26, f26, |"ktwuwhbfj"|];
				globalState.f8 := v51[f26];
				var v52: array<multiset<bool>> := new multiset<bool>[8];
				var v53: multiset<bool> := multiset{p0, p0};
				v52[804] := v53;
				v52[804] := fm37(p0, p0, f26 - f26, |fm36(p0, p0, p0, globalState)|, globalState);
				var v54: array<bool> := new bool[3](i11 => DC6(p0, 'g', f26).cf9);
				v54[723] := p0;
				var v55: seq<bool> := [false];
				var v56: map<int, seq<bool>> := map[f26 := [p0]];
				globalState.f23, v52[804], v54[723], v55, globalState.f1 := (f27 + "duqjf") + f27, multiset(v55), true, v55 + (if (f26 in v56) then v56[f26] else v55), v54;
				var v57 := DC8(p0, f26, 202);
				var v58: array<C3> := new C3[1];
				var v59: map<D2, array<C3>> := map[v57.(cf15 := |f27|) := v58];
				v59, globalState.f25 := v59, p0;
				globalState.f25 := v54[723];
			}
		...
		v63[388] := DC18(0x1be, v66[|v67[p0 := f26]|]).cf35;
		v63[388] := v65;
		r0 := -f26 % (f26 + 0x190);
		var v68 := DC0(f26);
		var v69: multiset<D0> := multiset{v68, v68.(cf0 := f26)};
		r1 := (v69 + v69[DC0(f26) := 0x5]) * (v69 * v69);
		var v70: array<bool> := new bool[23](i13 => p0);
		var v71 := DC17(v70);
		r2 := new array<int>[18] [v65, v63[388], v63[388], v63[388], v65, v65, v63[388], DC67(p0, v71.(cf33 := v70), v63[388], f26, |map[f26 := f26]|).cf126, v66[f26], v65, v63[388], v65, v63[388], v65, v63[388], v63[388], v63[388], v63[388]];
	}
}
...
class C7 {
	...
	method m0(p0: bool, p1: int, p2: bool, p3: string, globalState: GlobalState) {
		...
		v0[971] := if (p0) then p0 else p0;
		var v1: seq<bool> := [p2];
		v0[971] := [true, p0, p2, !p0, p0] < v1;
		var v2 := DC3(p1, p1);
		match (v2) {
			case DC0(cf0) =>
				globalState.f8 := p1;
				var v3 := DC2(v0[971]);
				var v4: map<bool, bool> := map[v0[971] := p0];
				var v5: set<map<bool, bool>> := {map[p0 := v3.cf4], map[v0[971] := p0], v4, fm1(fm2(p2, globalState), "uywfafmwc", p0, cf0, globalState), v4};
			...
			case DC2(cf4) =>
				...
				var v13: map<bool, string> := map[p2 := seq(0x1c9, i1  => ('e'))];
				var v14 := 'w';
				v12 := [p3, if (cf4 in v13) then v13[cf4] else p3[p1 := v14], p3 + p3];
				var v15: array<int> := new int[26];
				v15[896] := p1;
				v15[896] := p1;
				var v16: array<array<bool>> := new array<bool>[5];
				v16[19] := v0;
				var v17: map<int, int> := map[p1 := v15[896]];
				v16[19], globalState.f0, globalState.f25 := v0, p1, p0 <== ((if (v15[896] in v17) then v17[v15[896]] else v15[896]) == |map[v0[971] := v14]|);
				var v18: set<int> := {0x136, p1 + v15[896]};
				globalState.f24, v16[19] := |v18|, v0;
			case DC3(cf5, cf6) =>
				var v19 := 's';
				var v20: multiset<int> := multiset{cf6};
				var v21: seq<int> := [|p3[-cf5 := v19]|, 258, |v20|, cf5, -p1];
				var v22: map<int, bool> := map[|map[p2 := false]| := p2];
				var v23: seq<map<int, bool>> := [v22];
				var v24: multiset<map<int, bool>> := multiset{v22};
				var v25: multiset<int> := multiset{v21[cf6], |(multiset(v23) + v24)|, p1};
				var v26: map<int, int> := map[cf5 := p1];
				v20 := multiset{|v26|} + v25;
				var v27: multiset<bool> := multiset{!fm5(p1, p0, p2, globalState)};
				globalState.f25, globalState.f5, v0[971] := v27 > v27, cf6, p2;
				var v28: map<bool, int> := map[p2 := p1];
				var v29 := new C3(cf6, if (p2 in v28) then v28[p2] else cf5, p3 + p3);
				var v30: map<C3, set<bool>> := map[v29 := {p2, v0[971]}];
				var v31 := DC9(0x41, v0[971], |v28|, 0x113);
				var v32: set<int> := {|v1|, v31.cf19};
				var v33: map<int, seq<int>> := map[cf5 := (seq(689, i2  => (|map[553 := v19]|)))[if (false in v28) then v28[false] else |v30| := |v32|]];
				var v34: map<bool, string> := map[v0[971] := p3];
				var v35: array<string> := new string[7] [p3, p3, p3, p3, p3, p3[cf5 := p3[|v33|]], (if (p0 in v34) then v34[p0] else p3) + p3];
				v35[219] := "qcv";
				var v36 := DC57(v19, -p1, v29.f34, v29.f34);
				v35[219], v0[971], globalState.f17, globalState.f5 := p3, -p1 == cf5, cf6, -fm4(v36.cf108, globalState);
			case DC4(cf7) =>
				var v37: multiset<bool> := multiset{p2, true};
				globalState.f17 := p1 / (p1 / -(if (p0 in v37) then v37[p0] else -0x382));
				var v38: set<int> := {p1};
				...
				var v47 := 'f';
				var v48: C6 := new C6(map[if (v44 in v46) then v46[v44] else v45 := v47], |(seq(175, i3  => (v44.f26)))|, v44.f27);
				var v49: map<int, C6> := map[p1 := v48];
				if (fm5(|(v38 - (set v39 : int | (811 <= v39) && (v39 < 0x180) :: (v39 - 198)))|, (set v41 : set<int> | v41 in v40 :: (v41)) > v42, if (v0[971]) then fm5(|v49[-0x168 := v48]|, p2, p2, globalState) else false, globalState)) {
					...
					globalState.f8 := v56.cf34 - (p1 % p1);
					var v57, v58, v59 := v48.m2(v44.f26 != p1, DC2(p0), globalState);
					globalState.f23 := fm36(p2, v1[v44.f26], v0[971], globalState);
					v55[996] := if (v0[971]) then -v44.f26 else v44.f26;
					v55[996] := 290;
				} else {
					...
					v61 := if (!p2) then v61 else DC73(v0[971], v0[971], v60);
					var v62: map<int, int> := map[v44.f26 := p1];
					var v63: seq<seq<bool>> := [v1, v1];
					v62 := v62[p1 := |(v1 + v63[p1])|];
					globalState.f9 := p0;
				}
				
				if (p2) {
					var v64: array<int> := new int[11];
					v64[691] := v44.f26 * |{true, p2}|;
					var v65: array<char> := new char[8];
					v65[695] := v47;
					var v66: multiset<seq<char>> := multiset{seq(218, i4  => (v47))};
					globalState.f24, v64[691], v65[695] := p1, (|v66| * v44.f26) % v44.f26, v47;
					var v67: seq<int> := [p1];
					var v68: map<bool, bool> := map[v1[v44.f26] := p0];
					var v69: map<int, bool> := map[|v68| := p0];
					var v70 := DC75(v44);
					var v72: set<seq<bool>> := {v1[|v68| := v0[971]]};
					globalState.f25, v64[691], v47 := p0 <== (if (p2) then p2 else p0), v67[v48.fm6(v69, v44.f26, [|([v44, v44, v70.cf145])[v64[691] := v44]|, |v37|], map v71 : seq<bool> | v71 in v72 :: (v71) := (v0[971]), globalState)], v47;
					var v73: array<set<T1>> := new set<T1>[3];
					v73, v47, globalState.f1, v64[691] := v73, v47, v0, v64[691];
					var v74 := DC34(v0, p2);
					var v75: array<array<bool>> := new array<bool>[21] [v0, v74.cf66, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0, v0];
					var v76: map<bool, array<array<bool>>> := map[v0[971] := v75];
					v76 := v76[v0[971] := v75];
					globalState.f25 := v1[|v38|];
				} else {
					var v77: map<string, bool> := map[v44.f27 := v0[971]];
					var v78 := DC41(v77);
					v78 := v78;
					v0[971] := v44.f26 < |v38|;
					var v79 := new C5(v44.f26 - v44.f26, --p1, p1, v44.f27);
					var v80: set<bool> := {p0, !p2, v0[971], p0};
					v80 := v80;
					var v81: map<int, int> := map[0x2b5 := v44.f26];
					var v82: map<char, map<int, int>> := map[v47 := v81];
					var v83: multiset<int> := multiset{v44.f26};
					var v84: map<char, bool> := map[v47 := v0[971]];
					var v86: map<int, bool> := map[|(set v85 : int | (-0x255 <= v85) && (v85 < 0xfa) :: (v85 % v79.f29))| := v0[971]];
					var v87: seq<int> := [349];
					var v88: map<seq<bool>, bool> := map[v1 := p2];
					var v89: T0 := new C1();
					var v90: seq<T0> := [v89];
					var v91: map<bool, seq<T0>> := map[p2 := v90];
					var v92: array<int> := new int[29] [-v79.f29, fm4('x', globalState), |v82|, -p1, v79.f29, if (v47 in v43) then v43[v47] else v79.f30, v44.f26, v79.f29 + v44.f26, v79.f30 % |v83|, v44.f26, |v84|, p1, v48.fm6(v86, |[v44.f26]|, v87, DC78(v88).cf149[v1 := p0], globalState), v44.f26 / v79.f29, v79.f30, v44.f26, v79.f30, -(v44.f26 * p1), |map[v0 := p0]|, v79.f30, v44.f26, |v38|, v44.f26, v79.f30, 0xb3, v79.f29 + v44.f26, if (p2) then |v38| else p1, v79.f30, |(v91[p2 := v90] + v91)|];
					v92 := v92;
				}
		...
		if (p0) {
			...
			globalState.f25, v94[704], globalState.f0 := v95 !! (multiset{p1} + v95), if (v98 in v99) then v99[v98] else -(|v100| + p1), p1 % p1;
			if (v0[971]) {
				var v101: map<D6, int> := map[DC16(p1, false) := v94[704]];
				var v102 := DC16(p1, p0);
				v101 := v101[v102 := v94[704]];
				globalState.f25 := p2;
				v0 := new bool[24];
				var v103 := new C4(!(|multiset{|p3|, p1, v94[704]}| > v94[704]), v94[704], p3, map[v94[704] := |p3|]);
				var v104: map<bool, string> := map[v103.fm8(v95, v0[971], |v1|, v94[704], globalState) := "kxi"];
				var v105 := new C6(map[map[v103.f32 := v94[704]] := v93], p1, p3 + (if (p0 in v104) then v104[p0] else p3));
			} else {
				v0[971] := p2;
				globalState.f5 := -69;
				...
				v108[828] := v107;
				v108[828] := v107;
				var v109: multiset<bool> := multiset{p1 < p1, v94[704] < p1, fm5(p1, v0[971], p2, globalState)};
				var v110: set<bool> := {p2, p0, p2, p0};
				var v111: map<seq<bool>, int> := map[fm0(p2, p3, v110, fm4(v93, globalState), globalState) := v94[704]];
				v109 := v109 - (fm37(p0, fm24(p0, p2, v0[971], |v111|, globalState), v94[704], v94[704], globalState) + multiset{fm5(v94[704], v0[971], !p2, globalState), false});
				v110 := v110;
			}
			...
			v112[981] := |v113|;
			v112[981] := -p1;
			globalState.f23 := seq(0x283, i5  => ('l'));
			var v114 := 'u';
			var v115: map<bool, int> := map[p2 := p1];
			v112 := new int[12] [|"efiixvi"|, fm4(v114, globalState) % p1, v112[981], v112[981], v112[981], p1, v112[981], |p3[v112[981] := v114]| - v112[981], -0x1b0, (if (p0 in v115) then v115[p0] else p1) / v112[981], p1, p1];
			globalState.f0 := v112[981];
			var v116: seq<seq<bool>> := [DC7(v1).cf12, [p2, p0], v1, [p0, false, v0[971], p2], [p0]];
			v1 := v116[-0x13e];
		}
		
		if (|fm47(globalState)| < p1) {
			var v117: map<string, bool> := map[seq(0x27b, i6  => ('j')) := v0[971]];
			var v118 := DC41(v117);
			v118, globalState.f25 := v118, p0 || (p2 ==> p0);
			var v119 := 'l';
			v119 := if (v0[971]) then v119 else v119;
			var v120: map<int, char> := map[|v1| := v119];
			var v121 := new C5(p1, -p1, |v120|, if (true) then p3 else "gns");
			var v122: array<int> := new int[27](i7 => i7 % p1);
			v122[0] := |multiset{v121.f29, v121.f30, v121.f30}|;
			var v123: seq<string> := [p3, p3];
			var v124: map<int, int> := map[|v1[v121.f29 := !true]| := v121.f30];
			...
			v122[0], globalState.f0, v0[971], v1 := --0x1b2 + p1, (if (false) then v121.f30 else |v123[v121.f29]|) - (v121.f30 + |v124|), v125[|p3| := v126[v121.f30]] !! (if (|[v121.f30, |p3|]| in v128) then v128[|[v121.f30, |p3|]|] else v125), v1;
			globalState.f25 := !((p3 + p3) < (p3 + p3));
		} else {
			globalState.f5 := p1;
			var v129: map<int, int> := map[p1 := 915];
			globalState.f9 := v1[|v129|];
			var v130 := 's';
			globalState.f9 := p1 != (fm4(v130, globalState) * 821);
			globalState.f8 := (|p3| % -0x28a) * p1;
			globalState.f13, v130, v0[971], globalState.f8 := seq(0x293, i8  => (v130)), v130, p1 > (p1 - p1), p1;
		}
		...
		for i9 := p1 to p1 {
			...
			var v133 := 'a';
			v132[951] := fm4(v133, globalState) / p1;
			v132[951] := p1;
			var v134: multiset<array<int>> := multiset{v132};
			globalState.f5 := -(if (v132 in v134) then v134[v132] else v132[951]);
			var v135: map<int, int> := map[p1 / -v132[951] := p1];
			v135 := v135[-0x3d0 + v132[951] := fm4(v133, globalState)];
		}
...
method Main() {
	...
	var v10: set<bool> := {v2};
	globalState.f17 := v9[|(fm0(v2, "tlj", v10, v4, globalState))[v4 := v2]|];
	var v11 := DC2(v2);
	match (v11) {
		case DC0(cf0) =>
			v9 := v9;
			var v12 := 'v';
			globalState.f24 := v4 - |(if (v2) then v3[v4 := v12] else "itarlcvfg")|;
			...
			globalState.f24 := v14.f29 / v14.f29;
		case DC1(cf1, cf2, cf3) =>
			v2 := v2 <==> v2;
			v0[895] := false;
			...
			if (v0[895]) {
				...
				var v19 := new C4(v0[895], cf2, v3, v18[cf3]);
				var v20: map<bool, int> := map[v0[895] := 0x1e5];
				var v21: multiset<bool> := multiset{v0[895]};
				var v22 := 'h';
				var v23: set<char> := {v22};
				globalState.f17 := (if (v2 in v20) then v20[v2] else if (v0[895] in v21) then v21[v0[895]] else |v23|) + -cf2;
				globalState.f9 := v2;
				var v24: C5 := new C5(cf2, cf3, cf2, "yvh");
				var v25: map<bool, C5> := map[false := v24];
				var v26: C5 := new C5(v4, |v25|, v24.f30, seq(301, i2  => (v22)));
				var v27: set<C5> := {v24};
				var v28: C4 := new C4(v27 >= v27, cf2, v3, v5);
				var v29: map<int, C5> := map[v26.f30 / v4 := v24];
				var v30: C3 := new C3(v4, v26.f29, v3 + "xlblnafu");
				var v31: array<bool> := new bool[14](i3 => v2);
				var v32 := DC34(v31, v19.f32);
				var v33: seq<D11> := [v32, DC34(v31, v2), v32, DC34(v31, v0[895]), v32];
				...
				v37 := v37;
				var v38: map<bool, bool> := map[v0[895] := false];
				var v39: seq<map<bool, bool>> := [v38];
				var v40: set<int> := {|v39[cf3]|};
				globalState.f13 := fm36(v9[|v40|] < cf2, v0[895], fm5(v4, v2, v0[895], globalState), globalState);
				var v41: map<bool, int> := map[v0[895] := v4];
				var v42 := 'r';
				var v44 := DC13(map v43 : int | (42 <= v43) && (v43 < 0x2c4) :: (v43 % |multiset{DC53(cf3, v2).cf101}|) := (DC5(v10)));
				var v45 := DC25(v2, v41, v42, v44, v4);
				var v47: map<int, char> := map[cf2 := v42];
				var v48: multiset<bool> := multiset{v0[895]};
				var v49 := DC79(|v45.cf50|, |(map v46 : int | (0x3da <= v46) && (v46 < 0x358) :: (v46 - cf3) := (v0[895]))[fm4(if (|v48| in v47) then v47[|v48|] else cf1[v4], globalState) := v2]|, v2);
		...
		case DC2(cf4) =>
			...
			v2 := fm5(v4 % v4, v2, cf4 ==> cf4, globalState);
		case DC3(cf5, cf6) =>
			...
			var v59 := DC13(v58);
			v57[503], v4, v10, globalState.f25 := v7, -(if (v2) then cf5 else -(-|map[v59 := -0x24d]| / cf6)), v10 - {v2}, v2;
		...
		case DC4(cf7) =>
			...
			match (v76) {
				case DC53(cf100, cf101) =>
					...
					v77[644] := fm45(cf100, v70, v5, globalState);
					v77[644] := v9 + v72.f33;
					var v78: seq<seq<int>> := [v9, v72.f33];
					var v79 := new C2(v78[v4], fm40(cf101, cf100, v68, false, globalState));
					var v80 := DC8(v2, v4, cf100);
					var v81 := v72.m4(v4, v80, globalState);
					var v82 := DC50(v72.f33[v81], !(if (v2 in v73) then v73[v2] else false), v9, v69, cf100);
	...
	var v92: seq<D7> := [v90, DC21(v91[v4])];
	...
	for i5 := fm4(v106, globalState) to v98 {
		...
		v0[805], v5, globalState.f9 := true in v109, v5, v105.fm7(v4, v2, globalState) > |(v111 + map[v112[v96.f30] := v110.f26])|;
		var v113: array<multiset<bool>> := new multiset<bool>[2];
		var v114: multiset<bool> := multiset{v0[805], v2};
		v113[694] := v114 * v114;
		var v115: map<int, bool> := map[i5 := v0[805]];
		v0[805], v113[694], v0[805] := if ((v105.fm9(v110.f26, |v110.f27|, v0[805], globalState) + v96.f30) in v115) then v115[v105.fm9(v110.f26, |v110.f27|, v0[805], globalState) + v96.f30] else v2, v114 - (multiset{v0[805]} - v114), v2;
		var v116: multiset<array<int>> := multiset{v7, v7, v7, v7};
		if (v116 >= (v116 + v116)) {
			v7[820] := v98;
			var v117 := DC58(v96.f30, v0[805], v8, -|v107|, v0[805]);
			v7[820] := v117.cf112;
			var v118: array<C4> := new C4[1];
			var v119: map<array<C4>, int> := map[v118 := v96.f29];
			var v120: T0 := new C4(v2, v96.f29, v3, v5);
			var v121: map<T0, bool> := map[v120 := v0[805]];
			globalState.f25 := v119 != (v119 + map[v118 := |v121|]);
			var v122: array<int> := new int[18];
			var v123: C7 := new C7();
			var v124 := DC81(v123);
			var v125: array<C7> := new C7[24] [v123, v123, v123, v123, if (v0[805]) then v123 else v123, v123, v123, v124.cf154, v123, v123, v123, v123, v123, v123, v123, v123, v123, v123, v123, v123, v123, v123, v124.cf154, v123];
			v125[601] := v123;
			var v126: seq<map<int, int>> := [map[|v110.f27| := 0x102], v5, v5 + fm40(v2, v96.fm7(-0x2c0, v2, globalState), v115, false, globalState), v5 + v5];
			v122, v125[601], v126 := v122, v123, (v126 + [map v127 : int | v127 in v9 :: (v127 + v110.f26) := (0x3e6)]) + v126;
			var v128: C0 := new C0();
			var v129: seq<C0> := [v128, v128];
			var v130 := DC55(v96.f30, v0[805], v96.f29, false);
			var v131: map<seq<C0>, map<D20, C5>> := map[v129[v96.f30 := v128] := map[v130 := v96]];
			var v132: map<bool, bool> := map[v0[805] := v2];
			globalState.f0, globalState.f17, globalState.f8 := |((v131 + v131) + v131)|, (if (v0[805]) then |v132| else v96.f30) % i5, v98 / v96.f30;
			v0[805] := if (v109[v9[0x282]]) then v0[805] else v0[805];
		} else {
			var v133, v134, v135 := v105.m2(true in v10, v11.(cf4 := v2), globalState);
			var v136 := new C5(v96.f30, v96.f30 % v110.f26, v110.f26, if (v2) then v3 else v110.f27);
			var v137: seq<string> := [v110.f27];
			v7[717] := |v137| * -0x1f5;
			v7[717] := v96.f29;
			var v138 := DC64(v0[805]);
			var v139: set<C6> := {v105};
			var v140: seq<map<int, bool>> := [map[v96.f29 := v0[805]], fm18(i5, globalState)];
			var v142: array<map<int, bool>> := new map<int, bool>[19] [v115, v115, map[|v3| := v138.cf121], v115, v115[|v139| := v0[805]], v115, v140[849], v115 + v115, v115, v115, if (v2) then v115 else v115, v115, map[i5 := !v0[805]], v115, map v141 : int | (0x95 <= v141) && (v141 < 667) :: (v141 % v96.f29) := (v2), v140[v4], map[v136.f30 := v0[805]], map[v110.fm6(map[v96.f30 := v0[805]], v96.f30, v9, map[v109 := v0[805]], globalState) := v2], v115];
			v142[533] := if (v2) then v115 else v115;
			v142[533], globalState.f9, v0[805], globalState.f23 := fm18(v96.f29, globalState), (v96.f29 + v110.f26) > v98, v2, (fm36(!v0[805], v105.fm8(v108, if (|v108| in v115) then v115[|v108|] else !v2, 0x1bf, -v96.f30, globalState), !!v0[805], globalState))[v96.f30 := v106];
			var v143: array<bool> := new bool[5];
			v8[318] := v143;
			v8[318] := v143;
		}
		
		var v144: map<bool, bool> := map[v0[805] := v0[805]];
		var v145: seq<string> := [v110.f27];
		var v146: seq<string> := [v3, "lrj", fm36(v0[805], fm5(v110.f26, if (v0[805] in v144) then v144[v0[805]] else v0[805], v2, globalState), !true, globalState), v145[v110.f26]];
		var v147: map<int, seq<string>> := map[-(if (v0[805]) then v98 else v9[v96.f30]) := v146];
		v147 := v147[-|v5| := v146];
	}
	for i6 := -v98 to 0x30e {
		if (v3 < v3) {
			...
			globalState.f25, globalState.f25, globalState.f8, v0[782] := v9 <= v152.cf59, v2, v96.f30 % v96.f30, (v2 || v2) <==> v2;
		} else {
			globalState.f9 := v2;
			...
			var v155: C2 := new C2(seq(0x26d, i7  => (0x382)), if (true) then v5 else map[v96.f30 := -v98]);
			...
			var v159 := new C5(-(v4 / v96.f29), v98, i6, seq(511, i8  => (v106)));
			globalState.f25 := !v2;
			var v160: array<string> := new string[19] [v3, "gwpepkb", v3, seq(-754, i9  => (DC72(v2, v96.f29, v106, (seq(551, i10  => (v106)))[v96.f29 := v106], v2).cf138)), "krjjo", v3, v3, v3, v3, v3, v3, v3, v3, "of", "cbfnkt", "wbavnfdvc", v3, v3, fm36(v2, v2, v2, globalState)];
		...
		var v173: array<map<D20, bool>> := new map<D20, bool>[21] [v169, v169[v168 := v2], v169, v169, if (v96.f29 in v170) then v170[v96.f29] else v169, v169, v169 + v169, v169, v169, map[v168 := v2] + v169, v169, v169, if (v2) then v169 else v169, v169 + v169, v169[DC54(v167) := v2], if (v9[i6] in v170) then v170[v9[i6]] else map[DC54(v167) := true], if (v171 in v172) then v172[v171] else map[v168 := v2], v169, v169, v169, v169];
		v173[384] := v169 + map[v168 := v2];
		v173[384] := v169[v168 := !v2];
	...
	if (fm5(|v175| + |v176|, v4 <= v4, v2 ==> v2, globalState)) {
		...
		v7[974] := |v179|;
		v7[974] := v178.f34;
		var v180 := DC45(v96.f30, v2, v178.f34 - 0xa2, 0x325 + v7[974], if (v2) then !v2 else v2);
		var v181: set<int> := {v7[974]};
		...
		v7[831] := v96.f30;
		var v184: array<char> := new char[7] [fm42({-v96.f29}, globalState), v106, if (!true) then v106 else v106, v106, v106, v106, v3[|v9|]];
		v96.f29, v7[831], v184, v9 := v96.f29, v96.f29 * -v96.f30, v184, v9;
		var v185: array<D10> := new D10[27];
		v185 := v185;
		var v186: set<int> := {0x393};
		var v187: array<int> := new int[13] [v96.f29, v7[831], |v186|, -v7[831], v96.f30, v7[831], v98, v96.f29, v4, |(v3[v98 := v106])[v4 := v106]|, if (false in v103) then v103[false] else -435, v96.f30, v4];
		var v188, v189 := v96.m1(v187, v96.f29 == |v186|, globalState);
		v0[779] := true;
		v0[779] := (v2 || v2) ==> v2;
		var v190: T0 := new C6(v105.f28, v96.f29, v3[v98 := v106]);
	...
	var v203: map<int, multiset<C1>> := map[|v200[v175 := v2]| / -v96.f29 := v202];
	var v205: map<int, char> := map[v96.f30 := v106];
	var v207: multiset<map<int, char>> := multiset{map v204 : int | v204 in v194 :: (v204 / v98) := (v106), v205, v205, map v206 : int | v206 in v194 :: (v206 / 296) := (v106)};
	v203 := v203[|(v207 - v207)| := v202];
	var v208 := DC24(v4, -v96.f30 / v98, v96.f29);
	match (v208) {
		case DC23(cf42, cf43, cf44, cf45) =>
			...
			globalState.f24 := (v96.f30 % v96.f30) / v96.f29;
		case DC24(cf46, cf47, cf48) =>
			globalState.f23 := v3;
			var v213: seq<string> := [v3];
			var v214: map<int, bool> := map[v96.f30 := v2];
			var v215: seq<map<D23, D18>> := [fm60(v2, v3, v2, v3, globalState), fm60(v2, v3, v2, v213[|v214|], globalState)];
			v215 := v215 + v215;
		...
		case DC25(cf49, cf50, cf51, cf52, cf53) =>
			...
			match (v220.(cf74 := cf53)) {
				case DC37(cf70, cf71, cf72, cf73, cf74) =>
					...
					var v222: seq<string> := [seq(0x2ec, i13  => (v106)), v3];
					v7[234] := |(v221 - fm37(cf49, true, v98, |v222|, globalState))|;
					v7[234] := 0x179;
					...
					globalState.f5 := v96.f29 % v7[234];
				case DC38() =>
					v7 := new int[24];
					globalState.f5 := cf53;
					v96.f30 := v4;
					var v226 := new C5(|((seq(0x223, i14  => (cf51))) + (seq(284, i15  => (v106))))|, v96.f30 * v98, v96.f30, v3);
				case DC36(cf69) =>
			...
			v231[132] := v106;
			v231[132] := fm20(v2, (fm61(cf49, v2, cf53, globalState)).cf108, if (cf53 in v217) then v217[cf53] else v96.f29, 'p', globalState);
		...
		case DC22(cf41) =>
			...
			var v237 := DC5(v236[|multiset(seq(-0xcb, i18  => (v96.f29)))|]);
			var v238: map<int, D1> := map[|v10| := v237];
			var v239 := DC13(v238);
			var v240 := DC25(!v2, v103, v106, v239, |v236[v96.f30]|);
			...
			v8[885] := v0;
			v8[885] := v0;
			v8[885][614] := if (v2) then fm5(v4, v2, false, globalState) else v2;
			v8[885][614] := -0x1b1 >= (v4 % v105.fm9(v96.f30, |v3|, v2, globalState));
		case DC26(cf54) =>
			globalState.f0 := -v4 % |v175|;
			var v242: C0 := new C0();
			...
			match (v244) {
				...
				case DC19(cf36, cf37) =>
					...
					var v249: map<string, D12> := map[("dgirbomb")[|v175| := v106] := DC36(v248)];
					var v250 := DC36(v248);
					var v251: seq<map<string, D12>> := [v249, v249, v249, v249["tsgljx" := v250]];
					var v252: array<map<string, D12>> := new map<string, D12>[7] [v249, v249, v249, v251[v96.f29], v249, v249, v249];
					v252[278] := map[v3 := v250];
					v252[278] := map[v3 := v250];
					var v253 := DC71(v4, fm36(v2, v2, v2, globalState), v2);
					var v254, v255, v256 := v96.m2(v253.cf133 >= -|(seq(-0x27c, i19  => (v106)))|, v11, globalState);
				case DC20(cf38, cf39) =>
					globalState.f13 := fm2(cf39, globalState) + (seq(827, i20  => (v106)));
					v7 := v7;
				...
				case DC21(cf40) =>
					...
					globalState.f9 := -(875 / -|v175|) <= (v201.fm6(fm18(v96.f30, globalState), |fm47(globalState)|, v9, map v268 : seq<bool> | v268 in (seq(0x261, i21  => (v175))) :: (v268) := (true), globalState) - v4);
			...
			match (DC48(v271[v96.f30], |([v2] + v175)|, v106)) {
				case DC48(cf89, cf90, cf91) =>
					globalState.f0 := v96.f30 - -v98;
					var v272: map<int, bool> := map[v4 := false];
					v7[521] := v242.fm16(0x2bd, |v272|, v96.f30, v2, globalState);
					v7[521] := v96.f29;
					var v273 := DC71(v7[521], "jqkcubwy", v2);
				...
				case DC47(cf88) =>
					...
					globalState.f25, v274[864], v275, v199 := v2, if (v2) then v105 else v105, v275, v199 + v199;
					globalState.f8 := 0x26e;
					var v276: array<set<string>> := new set<string>[13];
					v276[849] := cf88;
					v276[849] := cf88;
					var v277 := DC31(v2, v9, v2, |v3|);
					globalState.f5 := -v242.fm16(v96.f29 - v242.fm16(v96.f30, |{v194}|, 0x17b, v2, globalState), v96.f30, (v277.(cf61 := |(seq(0x38e, i22  => (v106)))|, cf59 := v9)).cf61, !v2, globalState);
			}
			
	}
	
	var v278, v279, v280 := v201.m2(v2, if (v2) then v11 else v11, globalState);
	var v281: map<map<bool, int>, int> := map[v103 := 647 % v4];
	v281 := v281;
	for i23 := v278 / v96.f29 to v96.f29 {
		v7[422] := v96.f29;
		v7[422] := v96.f30;
		...
		var v288: map<map<array<bool>, char>, seq<D18>> := map[map[v0 := v3[v96.f30]] := v287];
