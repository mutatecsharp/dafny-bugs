...
function fm3(p0: int, p1: int, p2: bool, globalState: GlobalState): char {
	if (|(seq(0x327, i0  => ('a')))| == |{!!!false, !!!!true, !true, false}|) then 'd' else 'g'
}
function fm6(p0: bool, p1: bool, p2: bool, p3: bool, globalState: GlobalState): map<set<int>, int> {
	map[{0x2f7} := |{true, false}|] + map[set v0 : int | v0 in map[|(seq(-0x2ad, i0  => (-0x3e2)))| := true] :: (v0 - |(seq(0x4f, i1  => (['m', 'w', 'k', 'b', 'g'])))|) := 930]
}
function fm7(p0: bool, p1: char, globalState: GlobalState): string {
	("j" + "iptpuc") + (seq(838, i0  => ('s')))
}
...
method m0(p0: bool, p1: int, globalState: GlobalState) {
	...
	var v2: seq<bool> := [p0];
	var v3 := "iaqmfjp";
	var v4: multiset<bool> := multiset{v2[v0.f14], p0, p0};
	var v5: array<bool> := new bool[12] [v0 in v1, v2[|v3|], p0, !(p0 || p0), p0, p0, p0, p0, -|v3| != |"rpjgtvwk"|, p0, v4 > v4, v0.fm4(p0, globalState)];
	v5[212] := true;
	v5[212] := p0;
	var v6 := new C0(p1 / p1);
	...
	if (!v5[212]) {
		...
		v3, globalState.f10, v9[881], v5[212] := v3, v6.f14, |v10|, !p0;
		var v11: map<bool, seq<map<bool, bool>>> := map[v5[212] := seq(0x337, i0  => (map[v5[212] := v5[212]]))];
		var v12: map<bool, bool> := map[v5[212] := p0];
		var v13: seq<map<bool, bool>> := [v12, v12];
		v11 := v11[v5[212] := v13];
	} else {
		var v14: map<int, int> := map[0x2c9 := |map[v5[212] := v5[212]]|];
		var v15 := DC1(v14);
		match (v15.(cf1 := v14)) {
			case DC2(cf2, cf3, cf4, cf5) =>
				var v16: multiset<string> := multiset{v3};
				var v17: map<int, string> := map[|v16| := v3];
				v3 := if (v0.f14 in v17) then v17[v0.f14] else seq(0xa6, i1  => ('h'));
				var v18 := new C0(v0.f14);
				v5[212] := cf4 > cf4;
				cf3 := v6.f14;
			case DC1(cf1) =>
				v5[212] := (-v6.f14 + -|v3|) <= (if (p0 in v7) then v7[p0] else v6.f14);
				var v19: array<int> := new int[6];
				v19[236] := v0.f14;
				globalState.f10, v19[236], globalState.f10 := -|v3| % v6.f14, 0x4a - p1, v0.f14 % p1;
				var v20 := 'c';
				v20 := v20;
				v19 := v19;
			case DC3(cf6) =>
				globalState.f10 := 0x238;
				v5[212] := v6.fm5(globalState);
				var v21 := new C0(v0.f14);
				var v22: array<map<bool, seq<bool>>> := new map<bool, seq<bool>>[16];
				var v23: map<bool, seq<bool>> := map[!p0 := v2[v21.f14 := v5[212]]];
				v22[241] := v23;
				var v24 := 'd';
				var v25: map<map<bool, int>, C0> := map[map[p0 := |[p0]|] := v21];
				var v26: map<char, C0> := map[v24 := if (v7 in v25) then v25[v7] else v21];
				globalState.f10, v22[241], v26 := v6.f14, v23, v26 + map[v24 := v0];
		}
		
		var v27: map<int, bool> := map[p1 := v5[212]];
		...
		if (!(v3 == v3)) {
			...
			var v32: map<int, seq<int>> := map[p1 := v28[v0.f14 := |v31|]];
			var v33: set<int> := {v0.f14, 831};
			v5[212] := |v32| in (if (p0) then v33 else v33);
			var v34 := 'l';
			var v35: map<map<bool, bool>, char> := map[map[p0 := v5[212]] := v34];
			globalState.f10 := v28[|v35| - v6.f14];
			var v36 := DC1(v14);
			var v37 := DC3(v36);
			...
			var v38 := 'g';
			v5[212] := -|(v3 + v3)[v0.f14 := v38]| != v0.f14;
			...
			v42[163] := v43 + v43;
			v41, v5[212], v42[163] := v41, p0 <==> v5[212], v43 + v43;
			v5[212] := false;
		}
...
method Main() {
	...
	if (v1 <== (--v0 > fm0(globalState))) {
		...
		v1 := fm1(v16[0x8b], false, v1, [v2, fm2(v0, v1, v1, globalState)] + [v2], globalState);
		var v17: map<int, int> := map[v0 := fm0(globalState)];
		v17 := v17[|(v5[v0 := fm3(v0, v0, v1, globalState)] + v5)| := v0];
	...
	v6[506] := fm1(v0, true, false, if (v0 in v21) then v21[v0] else v20, globalState);
	v6[506] := v1;
	var v22 := 'i';
	var v23: map<string, bool> := map[("c")[v0 := v22] := v6[506]];
	v1 := (if (v5 in v23) then v23[v5] else true) <== v6[506];
	var v24: array<int> := new int[4](i0 => i0 / v0);
	v24[76] := v0;
	v24[597] := |multiset{v6[506], v1}|;
	var v25: seq<int> := [v0, v0, v0];
	v24[76], globalState.f6, v22, v24[597], v25 := v0 % -fm0(globalState), (v0 + |v18|) * v0, v5[v0], -v0, v25;
	for i1 := v24[76] to v24[76] {
		var v26: set<bool> := {v1};
		var v27: map<bool, int> := map[v1 := |v26|];
		v27 := v27[true := 0x1e2];
		m0(v6[506], --|(v25 + v25)|, globalState);
		v3 := v3 + v3;
	...
	var v30: map<int, char> := map[v24[76] := v22];
	v30 := v30[v0 := v22];
	if (v1) {
		globalState.f6 := v24[76] * v24[76];
		if (!false || fm1(|v5|, v6[506], v6[506], v20, globalState)) {
			v1 := v6[506];
			v6 := v6;
			v5 := v5;
			var v31 := new C0(v24[76]);
			var v32: map<seq<bool>, bool> := map[v3 + v3 := v6[506] <== v6[506]];
			v32 := v32[v3[v0 := v6[506]] := !(v3[v0] <==> v6[506])];
		} else {
			var v33: seq<array<bool>> := [v6];
			m0(v6[506], |v33|, globalState);
			v24[76] := fm0(globalState);
			v1 := v1;
			var v34: seq<string> := [v5, v5];
			var v35: map<int, seq<int>> := map[v24[76] := [v0, v24[76]]];
			v1, globalState.f10, v1, globalState.f6, v6[506] := v6[506], 0x25a, !!v6[506], v0 / |v34[0x316 := "c"]|, (v24[76] * |v3|) in v35;
			var v36 := new C0(0x1de);
		}
		
		v6[506] := v1;
		var v37: map<string, array<bool>> := map[v5 := v6];
		v6 := if (((seq(76, i3  => (v22))) + v5)[v0 := 'c'] in v37) then v37[((seq(76, i3  => (v22))) + v5)[v0 := 'c']] else v6;
		var v38: set<seq<int>> := {v25};
		m0({[-0x90]} > v38, v24[76], globalState);
	} else {
		v22 := 'y';
		v5 := v5;
		if (|v5| == v0) {
			var v39: array<multiset<seq<C0>>> := new multiset<seq<C0>>[25];
			var v40: C0 := new C0(v24[76]);
			var v41: seq<C0> := [v40];
			var v42: multiset<seq<C0>> := multiset{v41, v41};
			var v43: map<array<int>, multiset<seq<C0>>> := map[v24 := v42];
			var v44: seq<seq<C0>> := [v41];
			var v45: map<bool, bool> := map[v6[506] := v1];
			var v46: map<int, map<bool, bool>> := map[-v0 := v45];
			v39[793] := (if (v24 in v43) then v43[v24] else multiset(v44))[v41 := |v46|];
			v39[793] := v42;
			m0(v6[506], v24[76], globalState);
			v25 := v25 + (v25 + v25);
			...
			v48 := v48[v47 := |v3| - v24[76]];
			v24[76] := 0x36e;
			v4 := v4;
			var v49: set<int> := {v24[76], v24[76], v24[76]};
			var v50: map<bool, bool> := map[v6[506] := v6[506]];
			var v51: map<set<int>, int> := map[v49 := |v50[v6[506] := v6[506]]|];
			var v52: C0 := new C0(v24[76]);
			var v53: seq<C0> := [v52, v52];
			var v54: seq<map<set<int>, int>> := [v51, v51];
			var v55: array<map<set<int>, int>> := new map<set<int>, int>[19] [map[{v0} := v0], v51[v49 := |v53|], v51 + v51, v51, v54[v0], v51 + v51, v51, v51, fm6(v6[506], v1, v6[506], v1, globalState), v51, v51 + v51, map[v49 := 0x2df], v51, v51, v51 + v51, v51, v51[v49 := -v24[76]], v51, v51];
			v55[728] := v51;
			var v56: seq<string> := [v5];
			v24[76], v1, globalState.f6, v55[728] := |v56|, v6[506], fm0(globalState), v51 + v51;
		}
	...
	for i4 := v24[76] to 0x3e6 {
		...
		var v63 := DC3(v61);
		v63 := v63.(cf6 := v61);
		var v64: map<C0, bool> := map[v58[728] := v6[506]];
		if (if (v58[728] in v64) then v64[v58[728]] else v1 && v6[506]) {
			var v65: set<bool> := {v6[506]};
			var v66: multiset<array<bool>> := multiset{v6};
			v24 := new int[14] [i4, v59.f14, i4, |v60| / i4, -0x1ea, v59.f14 % 461, v0, v59.f14, v24[76], |v65|, v59.f14, v59.f14, -v59.f14, |v66| * v0];
			m0(!v1, |(seq(556, i5  => (v22)))|, globalState);
			m0(!v1 && v1, v59.f14, globalState);
			v59 := v59;
			var v67: multiset<char> := multiset{v22, v22};
			var v68 := new C0(v24[76] * (if (v22 in v67) then v67[v22] else i4));
		} else {
			var v69 := DC1(v18 + v18);
			var v70: set<C0> := {v58[728]};
			var v71 := DC4(v70);
			v6[506], v1, v6[506], v69, v6[506] := !fm1(v24[76], v6[506], v6[506], [v2], globalState), (if (v6[506]) then v70 else v71.cf7) !! v70, v1, v69, v6[506];
			v24[76] := -(v0 % 0x173);
			v24 := new int[7](i6 => i6 / -|[v6[506], v1, v6[506], true]|);
			var v72 := new C0(-(v0 - v59.f14));
			m0(v1, v59.f14 / v59.f14, globalState);
		}
	...
	if (v1) {
		...
		var v80: array<seq<seq<bool>>> := new seq<seq<bool>>[10](i7 => seq(0x2bc, i8  => (v3)));
		var v81: seq<seq<bool>> := [[v1, v1]];
		v80[593] := v81;
		var v82: map<char, char> := map[v22 := v22];
		var v83: set<map<char, char>> := {v82};
		var v84 := DC6(!v6[506], v1, v22);
		var v86: set<char> := {v22};
		var v87 := DC8(v86);
		v79, v80[593], v83, v84 := v79[v74.f14 := v78], v81, v83 * (set v88 : map<char, char> | v88 in multiset{v82, map v85 : char | v85 in v87.cf14 :: (v85) := (v22)} :: (v88)), v84;
		m0(DC5(v1, v6[506]).cf9, v74.f14 / v74.f14, globalState);
		v24[76] := v74.f14;
		v1, v2, v24[76], globalState.f10, globalState.f6 := |v5| != |v18|, map v89 : int | (-0x2d9 <= v89) && (v89 < 0x2a) :: (v89 % v74.f14) := (v1), 0x204, |v5| * v74.f14, -v0;
		v2 := v2[v74.f14 := v1];
	} else {
		if (v1) {
			var v90: seq<set<int>> := [v77];
			v6[506], v1, v77, v22 := v74.fm4(v1, globalState), v1, v90[v74.f14 + v74.f14], v22;
			var v91: seq<set<char>> := [{v22}];
			var v92: map<C0, set<char>> := map[v74 := v91[v74.f14]];
			var v93 := DC8(if (v74 in v92) then v92[v74] else {v22});
			var v94: multiset<D3> := multiset{v93};
			var v95: multiset<bool> := multiset{v1, v1 || v1, v6[506], v1, v94 == v94};
			v95 := (v95 * v95) - v95;
			m0(v1, v74.f14, globalState);
			var v96: array<C0> := new C0[28];
			v96 := v96;
			var v97: multiset<int> := multiset{235};
			globalState.f10 := v25[if (v74.f14 in v97) then v97[v74.f14] else v74.f14];
		} else {
			v24 := new int[18];
			var v98: multiset<char> := multiset{v22};
			v24[76] := |(v98 + multiset(v5))| - v74.f14;
			var v99: set<C0> := {v75[v0]};
			var v100 := DC4(v99 * v99);
			v100 := v100;
			var v101 := DC5(!v6[506], v1);
			var v102: map<set<array<int>>, D2> := map[{v24, v24, v24} := if (v6[506]) then v101 else v101];
			v102 := v102[{v24, v24} := v101];
			m0(v6[506], v74.f14, globalState);
		}
		
		v24 := v24;
		v24[76] := -v74.f14;
		var v103: multiset<bool> := multiset{v1};
		var v104: map<map<int, bool>, bool> := map[v2 := !v3[if (v6[506] in v103) then v103[v6[506]] else v24[76]]];
		v6[506], globalState.f6, v104 := v103 > v103, v0 % v74.f14, v104 + v104;
		if (v1) {
			v6[506] := v0 != v74.f14;
			v24[76] := v24[76];
			v1 := v6[506];
			...
			v106[243] := v76;
			v106[243] := (multiset{v74} + multiset{v74}) * v76[v74 := v24[76]];
	...
	match (if (v1) then v108 else v108) {
		...
		case DC6(cf10, cf11, cf12) =>
			v24 := new int[29](i9 => i9 / |v25|);
			var v113 := new C0(v74.f14);
			var v114: map<bool, bool> := map[v1 := cf11];
			v6[506] := if (v6[506] in v114) then v114[v6[506]] else false;
		...
		case DC4(cf7) =>
			if (v1) {
				...
				v18 := v18[|[v1, v6[506]]| := v74.f14];
				var v119: array<array<string>> := new array<string>[2] [v73, v73];
				v119[43] := if (v6[506]) then v73 else v73;
				var v120 := DC4(cf7);
				var v121: set<D2> := {v120, v120, v120, v120, DC4(cf7)};
				v119[43], v24[76], v1, globalState.f6, globalState.f6 := v73, v74.f14, v74.f14 == v0, |(v121 + v121)|, v74.f14 / |v5|;
				v0 := fm0(globalState);
				v22 := v22;
				var v122 := new C0(v74.f14);
			}
			
			var v123 := new C0(-(v24[76] % 0x326));
			if ((multiset{v74} * v76) < v76) {
				...
				v6, globalState.f6, globalState.f6, globalState.f6 := v6, if (DC11(v124).cf19 in v125) then v125[DC11(v124).cf19] else v24[76] + v74.f14, v123.f14, v74.f14;
				var v126: multiset<array<bool>> := multiset{v6};
				globalState.f6 := (v74.f14 + |v126|) / --(v24[76] * v0);
			} else {
				m0(v1, -(v123.f14 + 0xfe), globalState);
				v5 := v5;
				v1 := |v5| <= v24[76];
				var v127: multiset<int> := multiset{v74.f14};
				globalState.f6, globalState.f6 := (if (v24[76] in v127) then v127[v24[76]] else v123.f14) + (v74.f14 * |fm7(v6[506], v22, globalState)|), -v123.f14;
				v24 := new int[23];
			}
			...
			v128 := v129[v74.f14];
		case DC7(cf13) =>
			v74 := new C0(v74.f14 / v0);
			v6[506], globalState.f6 := v24[76] >= v74.f14, v24[76];
			v1 := [v1] == fm8(v6[506], globalState);
			if (v3[v74.f14]) {
				var v130 := DC8({v22, v22, v22, v22, 'v'});
				var v131: set<char> := {v22, v22};
				v130 := v130.(cf14 := v131);
				v130 := if (v6[506]) then v130 else v130;
				v73[437] := v5;
				v73[437] := v5 + v5;
				...
				globalState.f6 := -v24[76];
				var v133: seq<array<int>> := [v24, v24, v24, v24];
				var v134: multiset<array<int>> := multiset{v133[v24[76]]};
				v6[506] := v134 > multiset{v24};
				v24[76] := |(v5 + fm7(v6[506], fm3(v24[76], -0x1e, v6[506], globalState), globalState))|;
				globalState.f10 := -v0;
