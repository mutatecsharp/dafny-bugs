...
method m0(p0: int, p1: int, globalState: GlobalState) returns (r0: bool, r1: set<int>) {
	...
	if (v13.cf33) {
		...
		var v19: seq<bool> := [v0];
		var v20: array<int> := new int[28] [v11.f8 * v11.f8, p0, p0 * -p1, p0 + p1, -0x2b3, v11.f8, p1, v11.f8, |v15|, if (v0 in v16) then v16[v0] else |v10|, v11.f8, v11.f8, p0, p1, p1, v11.f8, p1, v11.f8 * v13.cf30, p0, v11.f8, v11.f8, if (v9 in v17) then v17[v9] else v11.f8, v11.f8, v11.f8, p0, -(p1 % |v18|), |v19|, v11.f8];
		v20[572] := (if (v0 in v14) then v14[v0] else v11.f8) / p1;
		v20[572] := v11.f8;
		v19 := v19;
		...
		var v26 := new C0(v24.f7 + [v9, fm6(globalState), v9], |"qf"|, (seq(0x319, i2  => (v9)))[p1 := v9], v25[v24.f8] ==> v0);
		...
		var v34: map<bool, int> := map[!v0 := |(seq(415, i3  => (0x219)))| + |v33|];
		var v35: set<int> := {--v26.f8};
		v22[142] := if ((v25 != v25) in v34) then v34[v25 != v25] else |({p0} + v35)|;
	}
	
	for i4 := v11.f8 to p1 {
		var v36: seq<int> := [p1, p1];
		if (fm1(if (v0) then p1 else v36[p1], v10 < (seq(0x144, i5  => (v9))), globalState)) {
			v10 := v11.f7;
			...
			globalState.f1, v9, globalState.f1 := |v11.f7|, fm6(globalState), |(v40 + v40)| / -v11.f8;
		...
		if (i4 > p0) {
			...
			var v56: set<int> := {v11.f8, v52[507], p1, v53.f8};
			v55[310] := v56 + v56;
			var v57: array<C0> := new C0[2] [if (v47.f6) then v11 else v11, v11];
			var v58: map<C0, map<bool, bool>> := map[v11 := v49];
			var v59: seq<set<int>> := [v56];
			v49, v50[178], v54, v55[310], v57 := map[v0 := v47.f6] + (if (v11 in v58) then v58[v11] else v49)[v0 := v0], v47.f6, v54.(cf26 := v0), v59[v53.f8], v57;
			globalState.f1 := --p0 + v11.f8;
		} else {
			var v60: array<seq<T0>> := new seq<T0>[2];
			var v61: T0 := new C0([fm6(globalState)], -v11.f8, seq(264, i8  => (v9)), v47.f6);
			var v62: seq<T0> := [v61];
	...
	for i9 := |v66| to |multiset(v67)| {
		...
		var v73: array<int> := new int[11] [|v69|, i9, -|v70|, -0x2b, |v72|, i9, |v71|, i9, v11.f8, -0x47, v72[v11.f8]];
		v68[807] := v73;
		v68[807] := if (v0) then DC5(v73).cf12 else v73;
		...
		v75[343], v76[771], v10, v76[858], v73[288] := v77[v11.f8], !!v0, v74.f7, v0, v11.f8;
		var v78: map<int, int> := map[if (v76[771]) then p0 else v11.f8 := v74.f8];
		var v79 := DC13(v0, v0);
		var v80 := DC16(v79);
		var v81: map<D6, bool> := map[v80 := true];
		var v82: map<bool, map<D6, bool>> := map[v0 := v81];
		v73[288] := if (v74.f8 in v78) then v78[v74.f8] else -|v82|;
	}
...
method Main() {
	...
	v1[662] := (if (false in v3) then v3[false] else v2) + (seq(-891, i1  => ('s')));
	v1[662] := "osndtkw";
	...
	if ({v6} > (v7 - v7)) {
		...
		var v11 := 'p';
		globalState.f0, v4, globalState.f1, globalState.f0 := v4 in v8, v4, fm0(v9 > multiset{|v10|}, v2, v4, globalState), (v11 in v1[662]) <== v4;
		if (!v4) {
			globalState.f1 := |v8|;
			var v12: map<bool, bool> := map[fm1(-v0, v4, globalState) := v4];
			var v13: set<bool> := {v4};
			v4, v4 := if (v4 in v12) then v12[v4] else v13 > {v4, !v4}, fm1(|v2| % v0, v4, globalState);
		...
		var v21 := DC3(false, |v1[662]|, v4, v11);
		v0, globalState.f0 := DC3(v4, |(map v20 : int | v20 in v9 :: (v20 / |v1[662]|) := (v4))|, v21.cf9, v11).cf8, v4;
		v1[662] := v2;
		...
		v24[351] := v25;
		v24[351] := if (fm1(v0, v4, globalState)) then v25 else map[v0 := v4];
		var v26: seq<int> := [v0, -|v1[662]|];
		...
		if ((if (fm1(-v0, v4, globalState)) then v0 else |v26|) > -((if (v4 in v27) then v27[v4] else v0) - v0)) {
			...
			v28[977] := v29 + v29;
			v28[977] := v29;
			globalState.f1 := |v1[662]|;
			var v30 := DC1(v0);
			v30 := v30;
			var v31, v32 := m0(v0, v0 % v0, globalState);
			v6 := new bool[8];
		} else {
			var v33 := 's';
			v33 := v33;
			...
			v34 := v34;
			v6[959] := v4;
			v6[959] := v4 <== (if (v4) then v4 else !v4);
		...
		v39 := v39[false := v38];
		var v40: seq<bool> := [fm1(v26[v0], false, globalState)];
	...
	var v46: map<array<int>, bool> := map[v45[281] := v4];
	var v47 := DC1(|v46|);
	var v48 := DC4(v47);
	v41[269] := v48;
	var v49: array<array<int>> := new array<int>[23];
	var v50: map<bool, int> := map[true := |(seq(0x20c, i3  => ('g')))|];
	var v51: set<bool> := {v4};
	v0, v41[269], globalState.f0, v49, globalState.f1 := v0, v48.(cf11 := v47), fm1((if (v4 in v50) then v50[v4] else v0) * v0, if (v4) then v4 else true, globalState), v49, -(if (|v51| in v42) then v42[|v51|] else -v0);
	v0 := v0;
	...
	match (v53) {
		case DC2(cf2, cf3, cf4, cf5, cf6) =>
			...
			match (v57) {
				case DC0(cf0) =>
					...
					v6[997] := if ((multiset(v2) !! (if (v0 in v61) then v61[v0] else v60)) in v58) then v58[multiset(v2) !! (if (v0 in v61) then v61[v0] else v60)] else v4;
					cf5 := cf5;
					globalState.f0 := v4;
					v51 := v51;
			}
		...
		case DC3(cf7, cf8, cf9, cf10) =>
			...
			var v65, v66 := m0(|v63| % cf8, |(v64 + v64)|, globalState);
			if (!cf7) {
				v44 := v44;
				v42 := v42;
				globalState.f1 := |v2|;
				v44[653] := if (cf7) then -cf8 else -94;
				v44[653] := 0x214;
				var v67: map<bool, bool> := map[(fm3(v44[653], v0, globalState)).cf0 := v65];
				v67 := v67;
			} else {
				...
				var v75 := new C0(v2[cf8 := v52], v0 * v0, "homss", cf7);
		...
		case DC1(cf1) =>
			...
			globalState.f1 := (|(map v80 : map<int, int> | v80 in v82 :: (v80) := (v4))| % cf1) / (0x69 + v0);
			v44[945] := v0;
			var v83: map<string, bool> := map[v2 := v4];
			v1[662], v44[945], globalState.f1, v0, cf1 := "s", v0, (|v83| / v0) / (v0 - cf1), if (v4) then |(v51 + v51)| else cf1, v0;
			if (v4 <==> (if (v4) then v4 else v4)) {
				v1[662] := v1[662];
				v1[662] := v2;
				globalState.f0 := false;
				globalState.f0 := v4;
				var v84: map<string, char> := map[v1[662] := v52];
				v84 := v84[v1[662] := v52];
			} else {
				v6[230] := v4;
				v6[230] := v4;
				...
				var v86: seq<bool> := [true, v6[230]];
				var v87: map<bool, seq<bool>> := map[false := v86];
				var v88 := DC6(v87);
				v85[473] := v88;
				var v89 := DC0(v6[230]);
				var v90: T0 := new C0([v52], fm0(v4, v1[662], v89.cf0, globalState), v1[662], v6[230]);
				v85[473], v90 := v88, v90;
				v52 := fm6(globalState);
				var v91: C0 := new C0(v1[662], v44[945], "lf", v6[230]);
				var v92: map<bool, C0> := map[v4 := v91];
				var v93: array<C0> := new C0[26] [v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, if (v6[230] in v92) then v92[v6[230]] else v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91, v91];
		...
		case DC4(cf11) =>
			var v95: C0 := new C0(v1[662], v0, v2, !!v4);
			var v96: map<C0, array<bool>> := map[v95 := v6];
			v96 := v96[v95 := v6];
			var v97 := DC0(v4);
			globalState.f0 := if (v97.cf0) then v4 else v4;
			var v98: seq<bool> := [!v4, v4];
			var v99: T0 := new C0(v1[662], v95.fm4(v95.f8, v0, v98, globalState), "xalwfr", v4);
			v99 := v99;
			var v100: map<int, bool> := map[|(v99.f5 + "le")| := v4];
			v100 := v100[v95.f8 % v55[v95.f8] := v4];
	}
	
	v6[75] := !v4;
	v6[75] := !false;
	v2 := (fm2(if (v4) then v6[75] else v6[75], v4, v0, v4, globalState))[v0 + fm0(v6[75], v2, fm1(v0, false, globalState), globalState) := v52];
	v44[579] := |v2|;
	v44[579] := 0x52;
	var v101: set<array<int>> := {v44, v44};
	var v102: map<set<array<int>>, bool> := map[v101 := true || v6[75]];
	v102 := v102[{v44} := v6[75]];
	for i5 := v0 to -v0 {
		var v103 := new C0(v2, v0 / v44[579], v1[662] + (if (!v6[75] in v3) then v3[!v6[75]] else seq(902, i6  => (v52))), v6[75]);
		if (v6[75]) {
			var v105: multiset<bool> := multiset{v6[75], v4};
			var v106: map<int, multiset<bool>> := map[|(map v104 : int | (0x4f <= v104) && (v104 < -0x6) :: (v104 + |v103.f7|) := (v6[75]))| := v105];
			v4, v1[662], globalState.f1, globalState.f0, v4 := v6[75], "tkbtcsqb", v0, !(0x2 !in (if (v6[75]) then v106 else v106)), !v6[75];
			v2, v1[662], globalState.f0 := v1[662], "ilf" + (if (true) then v2 else v1[662]), v6[75];
			var v107: map<bool, C0> := map[v4 := v103];
			var v108: seq<C0> := [v103];
			var v110: seq<set<int>> := [v5, v5, set v109 : int | (172 <= v109) && (v109 < -0x13a) :: (v109 / v0), v5, v5];
			var v111: map<int, bool> := map[i5 := v5 < v110[v0]];
			var v112: seq<bool> := [v4, v4, v6[75], !v4];
			v107, v52, globalState.f0 := map[v4 || v4 := v103], v103.f7[|[v55[|v108|], |v103.f7|, if (v6[75] in v105) then v105[v6[75]] else |fm7(v103.f8, globalState)|, i5]|], if (|(v112 + v112)| in v111) then v111[|(v112 + v112)|] else v4;
			var v113: array<array<bool>> := new array<bool>[19] [v6, v6, v6, v6, v6, v6, v6, v6, DC7(v6).cf14, v6, v6, v6, v6, v6, v6, v6, v6, v6, v6];
			v113 := v113;
			v44[579] := v103.f8;
		} else {
			var v114 := DC11(v45);
			v44, v103, globalState.f0, globalState.f0, v44[579] := v44, v103, !(v5 == v5), v4, |"mxtsyoj"| - (|v55| + |v114.cf24|);
			var v115 := new C0(v103.f7, i5, v2, v6[75]);
			var v116 := DC12(v42);
			var v117: multiset<bool> := multiset{v4, v6[75] && v4, if (v6[75]) then v6[75] else v4, v116.cf25 !! v42, v6[75] !in map[v6[75] := v6[75]]};
			v44[579] := |v117|;
			...
			var v122 := DC15(v103.f8, v115, map v120 : string | v120 in v121 :: (v120) := (v0), fm1(|v117|, v6[75], globalState));
			var v123 := DC16(v122);
			var v124: map<D6, int> := map[v123 := |v103.f7|];
			v119[218] := v124 + v124;
			v119[218] := v124 + (v124 + v124);
		}
