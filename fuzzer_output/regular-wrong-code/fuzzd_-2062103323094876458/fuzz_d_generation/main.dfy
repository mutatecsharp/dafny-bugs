...
class C1 {
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: int, r1: multiset<multiset<bool>>) {
			...
			decreases 100 - i0
		{
			...
			if (p0) {
				...
				var v15: array<array<D1>> := new array<D1>[19] [v13, v13, v13, v13, if (p0) then v13 else v13, v13, v13, v13, v13, if (v7) then v13 else v13, v13, v13, v13, v13, if (p0) then v13 else v13, v13, v13, v13, v14[safeIndex(v1, |v14|)]];
				...
				v11, v7, v15, v5, v0 := v11, (v6 != v1) in v20, v15, v6 == safeDivisionInt(-v1, v1), v0;
			} else {
				var v21 := "dcfqu";
			...
			if (safeModuloInt(-0x55, --525) < v1) {
				globalState.f10 := v3[safeIndex(safeDivisionInt(v1, -v1), |v3|)];
				v0[safeIndex(733, v0.Length)] := p0;
				var v26 := "t";
				var v27: map<int, bool> := map[|(("nogbhr")[safeIndex(v1, |"nogbhr"|) := f20] + (fm6(fm1(p0, v26, globalState), globalState))[safeIndex(v1, |fm6(fm1(p0, v26, globalState), globalState)|) := fm7(f20, p0, globalState)])| := {v1} !! fm8(|multiset(v26)|, v1, globalState)];
				...
				var v36 := DC2(p0);
				v0[safeIndex(733, v0.Length)], v27, v0[safeIndex(336, v0.Length)], globalState.f0, globalState.f9 := v28 !in v29, if (p0) then v27 else if (v1 in v34) then v34[v1] else v27, p0, p0 !in (v35 + {v36.cf2, p0, p0}), fm0(globalState);
				...
				v44[safeIndex(75, v44.Length)] := v43;
				globalState.f3, globalState.f9, v42, v44[safeIndex(75, v44.Length)] := p0, safeDivisionInt(v1, 256), map[f20 := v41], fm6(p0, globalState);
			}
		...
		var v59: multiset<multiset<bool>> := multiset{v56, v56, if (p0) then fm9(|v57|, p0, p0, --|v58|, globalState) else multiset(v58), v56[p0 := abs(|v57|)]};
		r1 := v59;
	}
	method m4(globalState: GlobalState) returns (r0: bool, r1: int, r2: bool, r3: bool) {
		...
		if (v0) {
			var v1 := 0x311;
			var v2: seq<bool> := [v0];
			var v3: multiset<bool> := multiset{v0, v1 == v1, v2[safeIndex(v1, |v2|)]};
			var v4: seq<int> := [v1, -v1];
			var v5 := "hfyg";
			v3, globalState.f3, globalState.f2 := multiset((if (v0) then [v0, v0] else v2)[safeIndex(0x3b3, |(if (v0) then [v0, v0] else v2)|) := v0]) + v3, v0, safeDivisionInt(v1, |v4|) - -(v1 + -|v5|);
			var v6: array<D1> := new D1[16];
			var v7 := DC4(v6);
			v6 := v7.cf4;
			var v8: array<int> := new int[27];
			v8[safeIndex(644, v8.Length)] := v1 - v1;
			v8[safeIndex(644, v8.Length)] := v1;
			globalState.f0 := false;
			var v9: array<seq<D2>> := new seq<D2>[23];
			var v10: seq<array<seq<D2>>> := [v9, v9];
			var v11: seq<array<seq<D2>>> := [v9, v10[safeIndex(-315, |v10|)]];
			var v12: map<bool, array<seq<D2>>> := map[v0 := v9];
			var v13: array<array<seq<D2>>> := new array<seq<D2>>[28] [v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v9, v11[safeIndex(v1, |v11|)], v9, v9, if (true) then v9 else v9, v9, v9, v9, v9, v9, if (true) then v11[safeIndex(v1, |v11|)] else v9, v9, v9, v9, v9, v9, if (v0 in v12) then v12[v0] else v9, v9];
			v13[safeIndex(554, v13.Length)] := v9;
			v13[safeIndex(554, v13.Length)] := v9;
		} else {
			var v14 := -271;
			var v15: seq<int> := [v14, v14, v14];
			globalState.f0 := safeModuloInt(v14, v14) >= v15[safeIndex(v14, |v15|)];
			...
			match (v18) {
				case DC0(cf0) =>
					...
					v21 := seq(abs(787), i0  => (v20));
					var v22 := 'h';
					var v23 := "nntcghypc";
					var v24: array<int> := new int[8];
					v24[safeIndex(426, v24.Length)] := cf0;
					var v25: array<bool> := new bool[3];
					v25[safeIndex(148, v25.Length)] := v16 <= v16;
					var v26: seq<array<bool>> := [v25];
					var v27: map<seq<array<bool>>, char> := map[v26 := v22];
					v22, v23, v24[safeIndex(426, v24.Length)], v25[safeIndex(148, v25.Length)] := if (v26 in v27) then v27[v26] else v22, (seq(abs(0x255), i1  => (v23[safeIndex(cf0, |v23|)]))) + (seq(abs(0x291), i2  => (v22))), cf0, !v0;
					v20 := v20[fm1(v0, v23, globalState) := v24[safeIndex(426, v24.Length)]];
			}
			...
			decreases 100 - i3
		{
			...
			if (v39[safeIndex(safeModuloInt(-|v40|, |v42|), |v39|)]) {
				var v43: set<bool> := {v0};
				var v44 := 0xc0;
				var v45: map<bool, int> := map[v0 := v44];
				var v46 := DC0(|v45|);
				var v47: map<set<bool>, bool> := map[v43 := v39[safeIndex(v46.cf0, |v39|)]];
				v47 := v47;
				globalState.f3 := v0 || v0;
				r3 := v0;
				globalState.f10 := v0;
				var v48: seq<int> := [v44, v44];
				var v49: multiset<int> := multiset{|{f20, v40[safeIndex(v44, |v40|)]}|};
				var v50: array<bool> := new bool[1];
				var v51 := DC5(v0, v44, v50, multiset{v44});
				var v52: array<bool> := new bool[5] [multiset(v48) >= v49, v39[safeIndex(-v44, |v39|)], v0, v0, v51.cf5];
				v52[safeIndex(784, v52.Length)] := v0;
				v52[safeIndex(784, v52.Length)] := v0;
			} else {
				v40 := (seq(abs(0x2fc), i5  => (f20))) + v40;
				...
				var v57 := 30;
				var v58 := DC9(v55);
				var v59: array<C0> := new C0[24] [v55, v55, v55, v55, v56[safeIndex(v57, |v56|)], v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v55, v58.cf15];
				v59[safeIndex(899, v59.Length)] := v55;
				v59[safeIndex(899, v59.Length)] := v55;
				globalState.f2 := v57;
				...
				v62[safeIndex(191, v62.Length)] := v60;
				var v63: multiset<int> := multiset{v57, v57, v57};
				v57, v62[safeIndex(191, v62.Length)] := |v63|, v60;
				globalState.f2 := v57;
			}
			
			v0 := v0;
			var v64: array<bool> := new bool[28] [v0, v0, v0, v0, fm1(true, v40, globalState), v0, fm1(v0, v40, globalState), v0, v0, v0, !v0, v0, v0, v0, v0, v0, true, v0, v0, v0, v0, v0, v0, false, v0, v0, v0, fm1(v0, v40[safeIndex(0x274, |v40|) := f20], globalState)];
			var v65 := DC1(v64);
			var v66: seq<array<bool>> := [v64];
			var v67: array<array<bool>> := new array<bool>[25] [v64, v64, v64, v64, v64, v64, v64, if (v0) then v64 else v64, v64, v64, v64, v64, v64, v64, v64, v64, v64, v64, v64, v64, v64, v65.cf1, v64, if (v0) then v64 else v66[safeIndex(|v39|, |v66|)], v64];
			v67 := new array<bool>[5];
			var v68 := 0xe;
			r2 := safeDivisionInt(v68, |{v40, v40}|) > |v39|;
		}
		...
		v73 := v73[|v74| - v72 := -351];
		v69[safeIndex(401, v69.Length)] := v0;
		var v75: seq<int> := [v72];
		v69[safeIndex(401, v69.Length)] := (v75 < v75) <== false;
		var v76: seq<bool> := [v69[safeIndex(401, v69.Length)]];
		var v77 := DC2(v76[safeIndex(v72, |v76|)] <== v69[safeIndex(401, v69.Length)]);
		v77 := v77.(cf2 := false);
		var v78: map<int, bool> := map[-v72 := v69[safeIndex(401, v69.Length)]];
		var v79, v80 := m0(if (v76[safeIndex(v75[safeIndex(v72, |v75|)], |v76|)]) then v69[safeIndex(401, v69.Length)] else v69[safeIndex(401, v69.Length)], v78[v72 := v0], globalState);
		r0 := !v69[safeIndex(401, v69.Length)];
		var v81 := DC12(v74);
		r1 := |(v81.cf18 + (v74 + v74))|;
		r2 := fm1(v0, v74, globalState);
		r3 := !v0 <== (v69[safeIndex(401, v69.Length)] <==> v69[safeIndex(401, v69.Length)]);
	}
}
	...
	method m2(globalState: GlobalState) returns (r0: int) {
		...
		if (match v11 {
			...
			if ((v0 + v0) > v0) {
				...
				globalState.f3 := safeDivisionInt(v0, -v0) < v0;
				r0 := v0;
				var v15 := DC14(v3);
				...
				v17[safeIndex(553, v17.Length)] := if (v7) then v8[safeIndex(v0, |v8|) := v2] else v8;
				var v18: array<T0> := new T0[23];
				var v19: multiset<array<T0>> := multiset{v18};
				globalState.f0, v17[safeIndex(553, v17.Length)], globalState.f3, r0 := if (v7) then !v7 else v7, (seq(abs(143), i2  => (v3.f20)))[safeIndex(-v0, |(seq(abs(143), i2  => (v3.f20)))|) := 'h'], (v19 + v19) >= v19, v0;
				var v20: map<int, bool> := map[safeDivisionInt(v0, |v5|) := v7];
				var v21: set<char> := {'e'};
				v20 := v20[-fm0(globalState) + v0 := v21 > v21];
				v13[safeIndex(626, v13.Length)] := true;
				var v22: multiset<bool> := multiset{v7, v7};
				v13[safeIndex(626, v13.Length)] := if (!v7 ==> v7) then v22 > v22 else v7;
				v7 := !(v17[safeIndex(553, v17.Length)] == v17[safeIndex(553, v17.Length)]);
				var v23: map<int, char> := map[0x25e := v2];
				var v24: seq<map<int, char>> := [v23];
				globalState.f0 := v0 <= |v24[safeIndex(0x2e8, |v24|)]|;
			}
			
			var v25: array<set<array<bool>>> := new set<array<bool>>[6];
			var v26: set<array<bool>> := {v13};
			v25[safeIndex(453, v25.Length)] := v26;
			v25[safeIndex(453, v25.Length)] := v26 - v26;
			globalState.f0 := v7;
		} else {
			globalState.f2 := v0;
			...
			if (v7) {
				...
				globalState.f9 := safeModuloInt(v0, |fm10(globalState)|) - (v0 + |v8|);
				...
				var v34: seq<multiset<D2>> := [v32, v32[v31 := abs(-|v33|)]];
				v34 := v34;
				...
				var v38: seq<bool> := [v7, v37 <= v37[safeIndex(v0, |v37|) := v9]];
				globalState.f10 := v38[safeIndex(safeModuloInt(|[v7, false]|, v0), |v38|)];
				globalState.f2 := v0;
				var v39: map<D5, char> := map[v11 := 'd'];
				var v40: array<char> := new char[27] [v2, fm7(v2, fm1(v7, seq(abs(0x127), i4  => (v3.f20)), globalState), globalState), v35.f20, v3.f20, v3.f20, v3.f20, v3.f20, v35.f20, v3.f20, 'b', v2, v3.f20, v2, v2, v3.f20, v2, v3.f20, if (v11 in v39) then v39[v11] else 'f', v3.f20, v35.f20, v35.f20, v2, v2, v3.f20, 'j', v3.f20, v2];
				v40[safeIndex(199, v40.Length)] := v35.f20;
				var v41: array<set<bool>> := new set<bool>[5];
				var v42: map<array<set<bool>>, char> := map[v41 := v3.f20];
				var v43: seq<array<set<bool>>> := [v41];
				v40[safeIndex(199, v40.Length)] := if (v43[safeIndex(-v0, |v43|)] in v42) then v42[v43[safeIndex(-v0, |v43|)]] else v3.f20;
				var v44: array<bool> := new bool[10](i5 => v7);
				var v45: multiset<seq<int>> := multiset{[v0]};
				var v46: seq<multiset<seq<int>>> := [v45];
				v44[safeIndex(330, v44.Length)] := v46[safeIndex(|[v3.f20]|, |v46|)] < v45;
				var v47 := DC17(v40[safeIndex(199, v40.Length)], v7, !v7, v3.f20);
				v44[safeIndex(330, v44.Length)] := v47.cf34;
			}
		...
		if ((if (v7) then v7 else v50.cf32) <== v7) {
			...
			var v56: array<bool> := new bool[25] [v54 == v54, v7, v0 <= v0, !v7, v7, v7, v55[safeIndex(v0, |v55|)], v7, if (!false) then v7 else v7, fm1(v7, fm6(!v7, globalState), globalState), v7, v7, |v49| >= v0, v5 != v5, v7, v7, v7, v7, v7, true, v7, v50.cf29, v7, v7, v7];
			v8, v53, v8, globalState.f11 := v8 + v8, v53, v8, v56;
			globalState.f9 := v0;
			var v57: map<bool, bool> := map[v7 := v7];
			var v58: seq<D5> := [v9.(cf19 := |v55|), v9];
			v57 := v57[fm1(v7, seq(abs(269), i6  => (v3.f20)), globalState) := v58 < (seq(abs(0x30e), i7  => (v9)))];
			var v59 := DC2(v7);
			var v60 := DC3(v59);
			v60 := v60;
			if (v7) {
				...
				var v68: map<seq<int>, int> := map[if (v65 in v67) then v67[v65] else v66 := safeModuloInt(v0, v0)];
...
class C3 extends T0 {
	...
	function fm4(p0: int, p1: string, p2: seq<int>, globalState: GlobalState): int {
		safeModuloInt(f18, f18 + f18)
	}
	method m1(globalState: GlobalState) returns (r0: array<int>, r1: bool) {
		var v0: seq<int> := [f18];
		for i0 := -v0[safeIndex(-233, |v0|)] to f18 * |f19| {
			match (f17) {
				case DC0(cf0) =>
					globalState.f2 := i0;
					var v1 := true;
					...
					v3[safeIndex(652, v3.Length)] := v5;
					v5[safeIndex(99, v5.Length)] := true;
					var v6 := DC1(v5);
					var v7: seq<bool> := [v1];
					v3[safeIndex(652, v3.Length)], globalState.f2, globalState.f0, v5[safeIndex(99, v5.Length)] := v6.cf1, i0, if (v7[safeIndex(i0, |v7|)]) then v1 else v1, v1;
			}
			...
			match (v9) {
				case DC2(cf2) =>
					...
					v8[safeIndex(734, v8.Length)] := {i0, f18} != fm8(if (cf2 in v14) then v14[cf2] else i0, i0, globalState);
					v10, globalState.f9, v13, v8[safeIndex(734, v8.Length)] := v10, i0, v13 + v13, i0 < f18;
				case DC1(cf1) =>
					var v15 := false;
					v8[safeIndex(660, v8.Length)] := v15;
					var v16: T0 := new C0(DC0(f18), i0);
					var v17: set<T0> := {v16, v16};
					v8[safeIndex(660, v8.Length)] := (v17 - v17) > v17;
					var v18: array<int> := new int[27];
					v18[safeIndex(162, v18.Length)] := 874;
					v8[safeIndex(660, v8.Length)], v18[safeIndex(162, v18.Length)] := v8[safeIndex(660, v8.Length)], f18;
					v16 := v16;
				...
				case DC3(cf3) =>
					...
					v35[safeIndex(400, v35.Length)] := v34;
					v35[safeIndex(400, v35.Length)] := v34;
			}
			...
			var v41: seq<map<int, bool>> := [v38, v38, map v39 : int | v39 in v40 :: (safeDivisionInt(v39, i0)) := (v37)];
			...
			v36[safeIndex(807, v36.Length)] := v47;
			v36[safeIndex(807, v36.Length)] := v47;
		...
		for i1 := f18 to -0x6d {
			...
			var v51 := 'x';
			v51 := v51;
			globalState.f9 := i1 + -v0[safeIndex(|f19|, |v0|)];
			v50 := v50;
		}
		var v52: array<int> := new int[25](i2 => i2 + -0x6b);
		v52[safeIndex(497, v52.Length)] := f18;
		v52[safeIndex(497, v52.Length)] := f18 - -fm0(globalState);
		var v53: array<string> := new string[14];
		var v54: array<bool> := new bool[16](i3 => "alyvhe" != f19);
		var v55 := true;
		v54[safeIndex(961, v54.Length)] := v55;
		var v56: multiset<int> := multiset{|map[|f19| := v55]|};
		v53, v54[safeIndex(961, v54.Length)] := v53, v56 >= v56;
		var v57 := "baxh";
		var v58: multiset<array<int>> := multiset{v52};
		v57, globalState.f9, v58, globalState.f0 := f19, f18, v58, if (v54[safeIndex(961, v54.Length)]) then v54[safeIndex(961, v54.Length)] else v54[safeIndex(961, v54.Length)];
		var i4 := 0;
		while (v55)
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			if (v55) {
				var v59: map<int, bool> := map[f18 := v54[safeIndex(961, v54.Length)]];
				var v60, v61 := m0(v55, v59, globalState);
				var v63: set<map<int, bool>> := {v59};
				var v64 := DC15(|(map v62 : int | (-0x142 <= v62) && (v62 < 0x268) :: (v62 + v52[safeIndex(497, v52.Length)]) := (-v61))|, v61, [f18], f18, {v60, |v63|, -v52[safeIndex(497, v52.Length)], v60, v61});
				var v65 := 'c';
				var v66: map<bool, int> := map[v54[safeIndex(961, v54.Length)] := f18];
				v64, globalState.f10, v65, v60, globalState.f3 := v64, (v66 + v66) != (v66 + v66), v65, v61 * (if (v54[safeIndex(961, v54.Length)]) then v60 else v60), fm1(fm1(v54[safeIndex(961, v54.Length)], v57, globalState), ("g")[safeIndex(v52[safeIndex(497, v52.Length)], |"g"|) := v65], globalState);
				var v67: array<map<C1, int>> := new map<C1, int>[1];
				var v68: C1 := new C1(v65);
				var v69: map<C1, int> := map[v68 := v52[safeIndex(497, v52.Length)]];
				v67[safeIndex(264, v67.Length)] := v69;
				var v70 := DC1(v54);
				var v71: seq<D1> := [v70];
				globalState.f9, v61, v54[safeIndex(961, v54.Length)], v67[safeIndex(264, v67.Length)], globalState.f2 := v52[safeIndex(497, v52.Length)], fm0(globalState) * (v52[safeIndex(497, v52.Length)] * |v71|), v54[safeIndex(961, v54.Length)], map[v68 := 670] + (map[v68 := 0x8f] + v69), v52[safeIndex(497, v52.Length)];
				globalState.f3 := v61 <= v52[safeIndex(497, v52.Length)];
				globalState.f9 := |f19|;
			} else {
				globalState.f2 := safeModuloInt(-0x84, f18);
				globalState.f2 := f18;
				v57 := f19;
				v0 := v0;
				var v72: map<int, int> := map[f18 := safeDivisionInt(|f19|, v52[safeIndex(497, v52.Length)])];
				v72 := v72[v52[safeIndex(497, v52.Length)] := 0x37];
			}
			
			globalState.f9 := f18 - (if (v55) then fm3(v55, f18, globalState) else 0x352);
			var v73: seq<string> := [seq(abs(547), i6  => ('f')), "bj", v57, v57, v57];
			var v74: seq<string> := [seq(abs(0x234), i5  => ('h')), f19, f19, v73[safeIndex(f18, |v73|)]];
			var v75: seq<bool> := [v54[safeIndex(961, v54.Length)]];
			v52[safeIndex(497, v52.Length)], v52[safeIndex(497, v52.Length)] := f18, safeDivisionInt(|v73[safeIndex(fm3(v75[safeIndex(v52[safeIndex(497, v52.Length)], |v75|)], |v75|, globalState), |v73|)]|, v52[safeIndex(497, v52.Length)]);
			globalState.f9 := v52[safeIndex(497, v52.Length)] * -v52[safeIndex(497, v52.Length)];
		}
		r0 := v52;
		r1 := v54[safeIndex(961, v54.Length)];
	}
}

function fm0(globalState: GlobalState): int {
	safeDivisionInt(|map[-120 := false]|, -0x160 + |(seq(abs(873), i0  => ('n')))|)
}
...
function fm5(p0: int, p1: int, globalState: GlobalState): D1 {
	DC2(!(|map[false := false]| != |[seq(abs(175), i0  => ('c')), "ol"]|))
}
...
function fm8(p0: int, p1: int, globalState: GlobalState): set<int> {
	{0x230, safeDivisionInt(-|"mng"|, 987), if (true) then |map[false := false]| else -0x114, 0xcb}
}
...
function fm11(p0: int, p1: bool, p2: int, globalState: GlobalState): seq<int> {
	(if (false) then seq(abs(0x27c), i0  => (|"fqfptov"|)) else [-151]) + ([|map[0x37a := false]|, 0x1f9] + [0x300])
}
...
function fm14(p0: bool, p1: char, p2: bool, globalState: GlobalState): set<bool> {
	{true, false, |[0x142, |"t"|, |map[true := |(seq(abs(0x22e), i0  => ('f')))|]|]| > |{0x4c, 0x70}|}
}
function fm15(p0: bool, p1: map<bool, int>, p2: bool, p3: bool, globalState: GlobalState): map<seq<int>, multiset<bool>> {
	map[[|map[false := true]|, |multiset([|[508, |map[false := 'o']|]|])|] := multiset([false, true, true])] + map[seq(abs(644), i0  => (-|[false]|)) := multiset([false])]
}
...
method m0(p0: bool, p1: map<int, bool>, globalState: GlobalState) returns (r0: int, r1: int) {
	...
	var v6: array<bool> := new bool[22] [false, DC26(p0, v0, v1, v2).cf51, p0, p0, if (fm1(true, seq(abs(0xb0), i1  => ('d')), globalState) in v3) then v3[fm1(true, seq(abs(0xb0), i1  => ('d')), globalState)] else !p0, p0, p0, p0, p0, p0, p0, fm1(p0, if (p0 in v5) then v5[p0] else v4, globalState), p0, p0, p0, false, p0, p0, p0, p0, p0, p0];
	var v7: seq<array<bool>> := [v6, v6];
	var v8 := 0x0;
	var v9: map<bool, seq<array<bool>>> := map[!(if (p0) then p0 else p0) := v7[safeIndex(v8, |v7|) := v6]];
	v9 := v9[!p0 := v7];
	var v10: seq<int> := [v8];
	...
	globalState.f2 := |(match DC6(|v10|, v11.cf21, p0, v8) {
		...
		case DC7(cf13) => {map[p0 := 'x']} - (set v14 : map<bool, char> | v14 in (seq(abs(0x3cf), i2  => (map[false := 'h']))) :: (v14))
	})|;
	var v15 := DC0(v8);
	var v16: C3 := new C3(v4, v15, -0x8c);
	var v17: array<C3> := new C3[12] [v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16, v16];
	v17[safeIndex(999, v17.Length)] := v16;
	globalState.f2, v17[safeIndex(999, v17.Length)] := v8 - (|v16.f19| + -v8), v16;
	for i3 := v8 to v8 {
		if (p0) {
			var v18 := new C2();
			...
			globalState.f9 := i3;
			globalState.f0 := false;
			v6[safeIndex(701, v6.Length)] := p0;
			v6[safeIndex(701, v6.Length)] := "ph" != (seq(abs(0x25a), i4  => ('r')));
		} else {
			var v21: T0 := new C0(v15, 0x271);
			var v22: seq<T0> := [v21, v21, v21];
			var v23: seq<seq<T0>> := [v22[safeIndex(v21.f18, |v22|) := v21]];
			...
			v24[safeIndex(327, v24.Length)] := v23;
			v24[safeIndex(327, v24.Length)] := v23[safeIndex(i3, |v23|) := v22 + v22];
			...
			var v28: set<int> := {v8};
			var v29: map<int, map<bool, int>> := map[v8 := v27[safeIndex(|v28|, |v27|)]];
			...
			var v32 := DC10(v31);
			v32 := v32;
			v31[safeIndex(778, v31.Length)] := v8;
			v31[safeIndex(778, v31.Length)] := v8;
			var v33: seq<bool> := [p0];
			var v34 := 'i';
			globalState.f2, v33, globalState.f9, globalState.f3 := v31[safeIndex(778, v31.Length)], [v34 in v16.f19, p0], safeDivisionInt(v31[safeIndex(778, v31.Length)], v21.f18), p0;
		}
		...
		v38, globalState.f0, globalState.f10, globalState.f9 := v38, i3 < (v10[safeIndex(v8, |v10|)] * i3), v16.f19 < (v16.f19 + v16.f19), i3;
	}
	...
	if (multiset{p0, p0} > v39) {
		...
		if (!!!p0 && !p0) {
			...
			v43[safeIndex(642, v43.Length)] := if (p0) then v8 else v8;
			var v48: map<bool, map<bool, bool>> := map[p0 := v3];
			v47, globalState.f0, v43[safeIndex(642, v43.Length)] := v46, true, -(|v48| + v8);
			var v49 := new C0(v15, v43[safeIndex(642, v43.Length)]);
			globalState.f3 := if (p0 in v3) then v3[p0] else false;
			globalState.f2 := v43[safeIndex(642, v43.Length)];
			var v50: seq<bool> := ["vckfvwohs" < v16.f19];
			v50 := v50;
		} else {
			globalState.f2 := -((v8 * v8) - safeDivisionInt(v8, v8));
			v1[safeIndex(665, v1.Length)] := p0;
			v1[safeIndex(665, v1.Length)] := p0;
			var v51 := DC32(v8);
			var v52 := 'q';
			var v53: C1 := new C1(v52);
			v8, globalState.f0, v51, v53 := safeDivisionInt(v8, v8), v1[safeIndex(665, v1.Length)], v51, v53;
			var v54: map<C1, C0> := map[v53 := v46];
			var v55: seq<C0> := [v46];
			var v56: array<C0> := new C0[10] [if (p0) then v46 else v46, if (v53 in v54) then v54[v53] else v46, v46, v46, v46, v46, v55[safeIndex(|v10|, |v55|)], v46, v46, v46];
			v56[safeIndex(611, v56.Length)] := v46;
			var v57 := DC6(v8, true, p0, v8);
			var v58: seq<D2> := [v57];
			var v59: multiset<D5> := multiset{v11, v11, fm17(|v4|, v58, globalState)};
			var v60 := DC3(DC2(v1[safeIndex(665, v1.Length)]));
			var v61 := DC15(v8, v8, fm11(-v8, false, 0xda, globalState), v8, {-|"c"|});
			v56[safeIndex(611, v56.Length)], v59, globalState.f9, globalState.f9, v60 := v46, v59 + (v59 - v59), |fm18(v8, globalState)|, -v61.cf24, v60.(cf3 := DC2(p0));
	...
	v6[safeIndex(684, v6.Length)] := p0;
	var v67: array<set<int>> := new set<int>[14];
	var v69: seq<set<int>> := [set v68 : int | (0x310 <= v68) && (v68 < 0xf3) :: (safeDivisionInt(v68, v8))];
	v67[safeIndex(925, v67.Length)] := v69[safeIndex(0x4d, |v69|)];
	...
	v4, v65, v66, v6[safeIndex(684, v6.Length)], v67[safeIndex(925, v67.Length)] := v4, v16.f19[safeIndex(safeModuloInt(|v70|, |v71|), |v16.f19|)], if (fm1(p0, v4, globalState)) then v66 else v66, p0, (v74 * v74) * (v74 * v74);
	r0 := if ('g' in v4) then v8 else v8;
	var v75: map<bool, char> := map[v6[safeIndex(684, v6.Length)] := v65];
	var v76 := DC34(v75);
	var v77: map<int, map<bool, char>> := map[v8 := (v76.(cf61 := v75)).cf61];
	r1 := |v77[safeModuloInt(v8, v8) := map[p0 := v65]]|;
}
method Main() {
	var v0 := true;
	...
	if (v0) {
		...
		var v7: seq<bool> := [v0];
		v6[safeIndex(676, v6.Length)] := v7;
		v6[safeIndex(676, v6.Length)] := v7[safeIndex(if (v0) then -v2 else v2, |v7|) := v7[safeIndex(-v2, |v7|)]];
		...
		var v12: seq<int> := [|v11|];
		var v13: array<int> := new int[28] [v2, 0x4d, |v6[safeIndex(676, v6.Length)]| * v2, v2, fm0(globalState) * -v2, v2, fm0(globalState), v2, v2, safeDivisionInt(0x163, v2), |v10| + v2, v2, v2, 0x150, v2, fm0(globalState) - v2, v2, v2, v2, safeDivisionInt(v2, v2), v2, if (v0) then v2 else v2, |v4|, v2, safeDivisionInt(v2, |v11|), v2, v2, fm0(globalState)];
		var v14: map<int, array<int>> := map[-0x291 := v13];
		v1, globalState.f9, v13 := v1, (v2 * v2) - safeDivisionInt(v2, v2), if (safeModuloInt(v2, v2) in v14) then v14[safeModuloInt(v2, v2)] else v13;
		...
		var v22, v23 := m0(v4 <= v4, (map v19 : int | v19 in v20 :: (safeModuloInt(v19, v2)) := (v0))[|v21| := v18[safeIndex(v2, |v18|)]], globalState);
		var v24: seq<string> := [v4, seq(abs(0x30f), i2  => (v16)), v4, v4];
		if (fm1(false, v24[safeIndex(v22, |v24|)], globalState)) {
			v16 := v16;
			...
			var v34: set<seq<bool>> := {v18, v18, v18, v18, if (v18[safeIndex(v2, |v18|)] in v33) then v33[v18[safeIndex(v2, |v18|)]] else v18};
	...
	globalState.f9, globalState.f9 := if (-safeDivisionInt(v36.cf31, v2) in v35) then v35[-safeDivisionInt(v36.cf31, v2)] else -v2, v2;
	...
	match (v45.(cf22 := if (v0) then v44 else v44)) {
		case DC15(cf23, cf24, cf25, cf26, cf27) =>
			...
			v49[safeIndex(787, v49.Length)] := v51 + v51;
			var v52: multiset<array<bool>> := multiset{v1};
			var v53: map<int, int> := map[cf26 := cf26];
			var v54: map<bool, map<int, int>> := map[false := v53];
			v48, cf25, v44, v49[safeIndex(787, v49.Length)] := v48, fm11(safeModuloInt(|v4|, |multiset(v37)|), v0, if (v1 in v52) then v52[v1] else |(if (v0 in v54) then v54[v0] else map[v48.f18 := v2])|, globalState), v44, v51;
		...
		case DC16(cf28, cf29, cf30, cf31, cf32) =>
			...
			var v60: seq<seq<int>> := [v37[safeIndex(-15, |v37|) := v56]];
			var v61: map<string, bool> := map[v4 := cf32];
			var v62: array<seq<int>> := new seq<int>[13] [v37, v37, v37, v37, v37 + v37, v37, [fm0(globalState), 0x127], [cf31, 173, |multiset(v58[safeIndex(cf28, |v58|) := v0])|, 3], v37[safeIndex(v2, |v37|) := cf28], if (cf28 in v59) then v59[cf28] else v37, v37 + (seq(abs(0x97), i3  => (|v40|))), v37, (v60[safeIndex(cf31, |v60|)])[safeIndex(|v61|, |v60[safeIndex(cf31, |v60|)]|) := cf30]];
			v62[safeIndex(373, v62.Length)] := v37;
			v62[safeIndex(373, v62.Length)] := v37;
			...
			match (fm12(v64.cf46, v67, cf30, cf31, globalState)) {
				case DC13(cf19, cf20, cf21) =>
					globalState.f2 := cf20;
					v63[safeIndex(881, v63.Length)] := |map['p' := v3]|;
					var v68: array<char> := new char[5];
					v68[safeIndex(898, v68.Length)] := v44.f20;
					var v69: map<int, int> := map[cf31 := |v58|];
					var v70: map<map<int, int>, string> := map[v69 := v4];
					var v71: map<int, map<int, int>> := map[cf20 := v69];
					var v72 := DC12(v4);
					var v73: array<string> := new string[28] [v4, "sfvx" + "tunb", "laijoy", "l", v4, v4, if ((if (|v62[safeIndex(373, v62.Length)]| in v71) then v71[|v62[safeIndex(373, v62.Length)]|] else v69) in v70) then v70[if (|v62[safeIndex(373, v62.Length)]| in v71) then v71[|v62[safeIndex(373, v62.Length)]|] else v69] else v4, v4[safeIndex(v2, |v4|) := v44.f20], v4 + v4, v72.cf18[safeIndex(v56, |v72.cf18|) := v43], v4, if (cf29) then v4 else v4, if (fm1(cf29, v4, globalState)) then (fm6(cf32, globalState))[safeIndex(v56, |fm6(cf32, globalState)|) := v44.f20] else v4, "vrxbpbgci", v4, v4, v4, "uci", v4, v4, DC12(v4).cf18, v4, v4, v4, "smf", v4, "hrnoni", "abfgyma"];
					var v74: set<seq<bool>> := {v58, [cf29, v0, true]};
					var v75 := DC24(v73);
					v63[safeIndex(881, v63.Length)], globalState.f2, globalState.f3, v68[safeIndex(898, v68.Length)], v73 := if ((v74 < v74) in v3) then v3[v74 < v74] else cf30, safeModuloInt(0x32b - |v40|, cf28), v0, v44.f20, v75.cf49;
					var v76: C2 := new C2();
					var v77 := DC22(v76);
					var v78 := DC0(v56);
					var v79: C0 := new C0(v78, cf30);
					v58, globalState.f10, v77, v79 := v58[safeIndex(safeModuloInt(v2, v63[safeIndex(881, v63.Length)]), |v58|) := true], cf32, v77, v79;
					var v80 := DC9(v79);
					v80 := v80;
				case DC12(cf18) =>
					v62[safeIndex(373, v62.Length)] := v37;
					...
					v88[safeIndex(509, v88.Length)] := v82;
					v88[safeIndex(509, v88.Length)], cf31 := (map[v81 := v2] + (map v89 : map<int, bool> | v89 in v82 :: (v89) := (|map[|map[v4 := -0x10d]| := |[false]|]|))) + v82, cf28;
		...
		case DC17(cf33, cf34, cf35, cf36) =>
			...
			globalState.f10 := !(v92[safeIndex(-0x3b0, |v92|)] < v37);
			globalState.f0 := true;
		case DC14(cf22) =>
			globalState.f0 := true;
			globalState.f9 := v2;
			...
			if ((v2 + (v93.(cf55 := v2)).cf55) !in (map v94 : int | v94 in [v2] :: (v94 * v2) := (v2))) {
				...
				var v96: map<string, bool> := map[v95[safeIndex(v2, |v95|)] := !v0];
				v96 := v96;
			...
			v106[safeIndex(565, v106.Length)] := safeModuloInt(0xaa, v2);
			v106[safeIndex(565, v106.Length)] := |v40|;
	}
	
	var v107 := DC25(v2);
	var v108: array<D9> := new D9[6] [v107, v107.(cf50 := v2), v107, if (v0) then v107 else v107, v107, v107];
	v108[safeIndex(481, v108.Length)] := v107;
	v108[safeIndex(481, v108.Length)] := v107.(cf50 := |(v4 + v4)|);
	if (safeDivisionInt(v2, v2) != |(if (v0) then [v2] else seq(abs(0x1c5), i5  => (-v2)))|) {
		...
		if (fm14(v0, 'c', !v0, globalState) != v40) {
			...
			globalState.f10 := v0;
			globalState.f2 := safeModuloInt(|fm8(v2, 873, globalState)|, v2);
			var v117: C2 := new C2();
			...
			v125[safeIndex(587, v125.Length)] := v120;
			v125[safeIndex(587, v125.Length)] := v120;
		}
		...
		v4 := (if (v2 in v128) then v128[v2] else v4[safeIndex(v2, |v4|) := v44.f20])[safeIndex(|"kr"|, |(if (v2 in v128) then v128[v2] else v4[safeIndex(v2, |v4|) := v44.f20])|) := v43];
		globalState.f3 := v0;
		var v129: array<array<bool>> := new array<bool>[27];
		v129[safeIndex(543, v129.Length)] := v1;
		v129[safeIndex(543, v129.Length)] := v1;
	}
	...
	if ({v2} !! v131) {
		...
		match (v139.(cf14 := v138)) {
			case DC8(cf14) =>
				...
				v141[safeIndex(718, v141.Length)] := v142;
				v141[safeIndex(718, v141.Length)] := v142;
				globalState.f2 := v133;
				v43 := v44.f20;
		}
		...
		match (DC18(v150 + {v149, v149, v149, v149})) {
			...
			case DC20(cf41, cf42, cf43) =>
				globalState.f0 := v0;
				v1[safeIndex(870, v1.Length)] := v0;
				v1[safeIndex(870, v1.Length)], cf43 := true, (cf43 + cf43) + -v2;
				var v159 := DC0(|(seq(abs(0x44), i8  => (cf43)))|);
				var v160: map<int, bool> := map[cf43 := true];
				var v161: C0 := new C0(v159, |v160|);
				var v162 := DC9(v161);
				var v163: map<bool, C0> := map[v0 := v161];
				var v164: array<C0> := new C0[10] [v161, v161, v161, v162.cf15, v161, v161, v161, v161, v161, if (v1[safeIndex(870, v1.Length)] in v163) then v163[v1[safeIndex(870, v1.Length)]] else v161];
				v164[safeIndex(182, v164.Length)] := v161;
				v164[safeIndex(182, v164.Length)] := v161;
				var v165, v166 := m0(v1[safeIndex(870, v1.Length)], v160, globalState);
			case DC18(cf37) =>
				v4, globalState.f9 := v4 + ([v44.f20, v44.f20] + v4), v2 * (v2 * v2);
				v146[safeIndex(356, v146.Length)] := v2;
				var v167: array<D10> := new D10[25];
				var v168 := DC29();
				v167[safeIndex(109, v167.Length)] := v168;
				v146[safeIndex(805, v146.Length)] := safeDivisionInt(fm0(globalState), |v131|);
				var v169: C0 := new C0(DC0(|v37|), v2);
				var v170 := DC6(v2, true, v0, -|map[if (v0 in v5) then v5[v0] else true := v169]|);
				v146[safeIndex(356, v146.Length)], globalState.f3, v167[safeIndex(109, v167.Length)], globalState.f9, v146[safeIndex(805, v146.Length)] := v2 + v2, v0, DC29(), fm0(globalState), v170.cf12;
				var v171: map<int, int> := map[v2 := v146[safeIndex(356, v146.Length)]];
				v0 := if (!(|"hiwhxnyyd"| in v171)) then v0 else v0;
				var v172: map<int, bool> := map[safeDivisionInt(v2, |v4|) := v0];
				v172 := v172[v146[safeIndex(356, v146.Length)] - v146[safeIndex(356, v146.Length)] := if (v0) then v0 else v0];
			case DC21(cf44) =>
				v1[safeIndex(987, v1.Length)] := v2 != v2;
				v1[safeIndex(987, v1.Length)] := v0;
				var v173 := DC0(-v2);
				...
				var v181: map<set<D2>, int> := map[v180 - v180 := -v37[safeIndex(v175.f18, |v37|)]];
				v181 := v181[v180 := |(fm16(v175.f18, v1[safeIndex(987, v1.Length)], 'b', v2, globalState) + v5)|];
		}
		
		var v182: seq<string> := [v4, v4];
		var v183: array<string> := new string[28] [v4, fm6(v0, globalState), seq(abs(-0x2e7), i10  => (v44.f20)), v4, v4, v4, v4, fm6(v0, globalState), v4 + "l", v4 + v4, "veh", seq(abs(0x27e), i11  => (v43)), v4, v4 + v4, v4, v4, v4[safeIndex(v2, |v4|) := v44.f20], seq(abs(489), i12  => (v44.f20)), v4, v182[safeIndex(-0x168, |v182|)], v4, v4, "psmshitr", v4[safeIndex(v2, |v4|) := 'f'], seq(abs(478), i13  => ('t')), v4 + (seq(abs(-0x390), i14  => ('s'))), v4, v4];
		v183[safeIndex(306, v183.Length)] := v4;
		v183[safeIndex(306, v183.Length)] := seq(abs(762), i15  => (v44.f20));
		v1[safeIndex(379, v1.Length)] := v37 <= v37;
		v1[safeIndex(379, v1.Length)] := v108[safeIndex(481, v108.Length)].cf50 == v2;
		var v184 := DC31(v39);
		globalState.f2 := safeDivisionInt(v2 * |v184.cf58|, v2);
		var v185 := new C1(v43);
	}
	
	var v186: array<set<int>> := new set<int>[27](i16 => v131);
	v186[safeIndex(599, v186.Length)] := v131 - v131;
	v186[safeIndex(599, v186.Length)] := v131;
	...
	for i17 := |v187.cf27| to v2 {
		...
		v188[safeIndex(44, v188.Length)] := v2;
		var v189 := DC10(v188);
		...
		v188[safeIndex(44, v188.Length)] := (DC20({v190, v190}, DC13(fm0(globalState), fm0(globalState), v0), |v191|).(cf43 := v2, cf41 := v192)).cf43;
		var v193 := DC0(i17);
	...
	v199 := v199;
	for i20 := safeModuloInt(v2, v2) to v2 {
		globalState.f9 := v2;
		if (!v0) {
			...
			globalState.f2 := if (fm6(v0, globalState) != fm6(v38.cf2, globalState)) then safeDivisionInt(v2, v2) else v220.f18;
	...
	print v1[20], "\n";
	print v2, "\n";
	print v3 == map[true := 213], "\n";
	print v4, "\n";
	print v5 == map[true := true], "\n";
	...
	print globalState.f8 == multiset{213, 213}, "\n";
	...
	print globalState.f12 == map[true := -213], "\n";
	print globalState.f13, "\n";
	print globalState.f14, "\n";
	print globalState.f15 == map[true := true], "\n";
	print globalState.f16, "\n";
	print v35 == multiset{212, 212, 212}, "\n";
	print v36.cf28, "\n";
	print v36.cf29, "\n";
	print v36.cf30, "\n";
	print v36.cf31, "\n";
	print v36.cf32, "\n";
	print v37 == [-496, 212, 212, 212, -496, 212, 212], "\n";
	print v38.cf2, "\n";
	print v39 == multiset{true}, "\n";
	print v40 == {true}, "\n";
	print v41[0].cf2, "\n";
	print v41[1].cf2, "\n";
	print v41[2].cf2, "\n";
	...
	print v42.cf4[8].cf2, "\n";
	print v42.cf4[9].cf2, "\n";
	print v42.cf4[10].cf2, "\n";
	print v42.cf4[11].cf2, "\n";
	print v42.cf4[12].cf2, "\n";
	print v42.cf4[13].cf2, "\n";
	print v42.cf4[14].cf2, "\n";
	print v42.cf4[15].cf2, "\n";
	print v42.cf4[16].cf2, "\n";
	print v42.cf4[17].cf2, "\n";
	print v42.cf4[18].cf2, "\n";
	print v42.cf4[19].cf2, "\n";
	print v43, "\n";
	print v44.f20, "\n";
	print v45.cf22.f20, "\n";
	print v107.cf50, "\n";
	...
	print v187.cf23, "\n";
	print v187.cf24, "\n";
	print v187.cf25 == [-496, 212, 212, 212, -496, 212, 212], "\n";
	print v187.cf26, "\n";
	print v187.cf27 == {212}, "\n";
	print v199 == {"y", "r"}, "\n";
}