...
class C0 {
	...
	method m12(p0: string, p1: map<bool, int>, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: seq<D1>) {
		...
		globalState.f7 := p2;
		var v1 := DC8(fm17(seq(abs(994), i0  => (p3)), globalState), p2, p0);
		...
		var v3: seq<bool> := [p2];
		var v4: multiset<multiset<bool>> := multiset{v2[p2 := abs(-|v3|)]};
...
class C1 extends T0, T2 {
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		for i0 := p1 to f12 {
			...
			var v3 := DC15(f11);
			var v4: array<D4> := new D4[25] [v3, v3, v3, DC15(i0), v3, DC15(f14), v3, v3, v3, v3.(cf32 := f12), DC15(p1), v3, fm19(p2, f15, seq(abs(0x393), i1  => (p1)), globalState), DC15(p1), v3, v3, v3, v3, DC15(f12), v3, v3, v3, v3, v3, v3];
			v4[safeIndex(309, v4.Length)] := DC15(0x27a);
			v4[safeIndex(309, v4.Length)], globalState.f6, v0, globalState.f6 := v3, p3, v0, |"xcpelm"| * p1;
			if (!true) {
				var v5: seq<bool> := [!f15, true];
				var v6: map<int, int> := map[0x1f1 := p3];
				var v7: set<bool> := {p2};
				var v8: multiset<int> := multiset{|f13[safeIndex(|{p1}|, |f13|) := f13[safeIndex(i0, |f13|)]]|, |v5[safeIndex(if (|v7| in v6) then v6[|v7|] else f14, |v5|) := true]|};
				var v9: seq<bool> := [multiset{f12, p1} < v8, p2];
				globalState.f2 := v5[safeIndex(f11, |v5|)];
				globalState.f2 := p2;
				var v10 := new C0();
				var v11: array<seq<int>> := new seq<int>[17](i2 => [i0, f12, f12]);
				var v12: seq<int> := [fm0(p2, globalState), i0];
				v11[safeIndex(370, v11.Length)] := v12;
				v11[safeIndex(370, v11.Length)] := v12;
				f24 := f24;
			} else {
				...
				var v18: array<array<bool>> := new array<bool>[9] [v17[safeIndex(p1, |v17|)], f24, f24, f24, f24, f24, f24, f24, f24];
				v18[safeIndex(942, v18.Length)] := f24;
				v18[safeIndex(942, v18.Length)] := f24;
				var v19: set<bool> := {true};
				r2 := -safeModuloInt(f14, |v19| + -i0);
				...
				var v23: map<array<bool>, bool> := map[v18[safeIndex(942, v18.Length)] := f15];
			...
			if (!(f15 ==> (if (p2) then p2 else p2))) {
				...
				var v32 := 'u';
				globalState.f7, r0, globalState.f2, v26, v27 := f15, f15, f15, v26, p0[safeIndex(|(if (v28 in v29) then v29[v28] else v30)[v31.cf15 := f15]|, |p0|) := v32];
				v0[safeIndex(991, v0.Length)] := fm0(f15, globalState);
				v0[safeIndex(991, v0.Length)], globalState.f2, v27 := f14, (if (f15) then p2 else p2) ==> f15, v26.cf9 + v27;
				v0[safeIndex(991, v0.Length)] := i0 + (v0[safeIndex(991, v0.Length)] - p3);
				r0 := f15;
				v32 := v32;
			} else {
				var v33 := "bfqkk";
				...
				v0[safeIndex(479, v0.Length)] := |(v36 + v36)|;
				v0[safeIndex(479, v0.Length)] := f12;
				var v37 := new C0();
				r1 := |(seq(abs(0x186), i3  => (i0)))|;
			}
			
		}
		for i4 := |(seq(abs(-0x1f), i5  => ('a')))| to -0x1b3 {
			r2 := p3;
			var v38: seq<int> := [f11];
			var v39: multiset<seq<int>> := multiset{v38 + v38};
			v39 := multiset{fm20(f15, f15, !p2, globalState) + v38};
			if (fm1(if (DC4(p2).cf5) then v38[safeIndex(f11, |v38|)] else f12, -0x3d3 == f12, p2, globalState)) {
				f24[safeIndex(803, f24.Length)] := if (!fm1(f14, f15, f15, globalState)) then f15 else p2;
				f24[safeIndex(803, f24.Length)] := (f14 + i4) < f11;
				f24[safeIndex(803, f24.Length)] := (fm1(f11, f15, f24[safeIndex(803, f24.Length)], globalState) ==> f15) ==> p2;
				var v40: map<int, bool> := map[f11 := f24[safeIndex(803, f24.Length)]];
				...
				globalState.f6 := -safeDivisionInt(-|v45|, -0x4d);
				var v46: set<bool> := {p2};
				var v47, v48 := m13(v46, globalState);
				v47[safeIndex(925, v47.Length)] := f14;
				v47[safeIndex(925, v47.Length)] := -(safeDivisionInt(p3, p1) * f11);
				v47 := v47;
				v47 := v47;
			}
		...
		if ((if (v53 in v54) then v54[v53] else f14) < f14) {
			f24[safeIndex(182, f24.Length)] := p2;
			...
			f24[safeIndex(182, f24.Length)] := v59 >= v59;
			...
			if (f15) {
				...
				r0, r2, globalState.f2, r2, globalState.f2 := p2, fm0(f15, globalState), fm1(f11, f24[safeIndex(182, f24.Length)], true, globalState) <== f15, |v62|, p2;
				globalState.f6 := f12;
				var v63: seq<bool> := [if (false in v51) then v51[false] else f15, p2];
				var v64: multiset<int> := multiset{43, f14};
				f24[safeIndex(182, f24.Length)] := v63[safeIndex(if (-|f13| in v64) then v64[-|f13|] else -0x11b, |v63|)];
				var v65 := DC20(f11, fm0(f24[safeIndex(182, f24.Length)], globalState));
				var v66 := DC22(v65);
				var v67: map<bool, D6> := map[f15 := v66];
				v67, globalState.f2 := (v67 + v67) + v67, f24[safeIndex(182, f24.Length)];
				var v68 := "vcndqglo";
				v68 := (f13 + p0) + "sdyux";
			} else {
				var v69 := DC13(v53);
				...
				f24[safeIndex(182, f24.Length)] := (set v70 : int | v70 in v69.cf29 :: (safeDivisionInt(v70, 0x366))) > v72[safeIndex(p3, |v72|)];
				var v73: map<int, int> := map[f14 := 280];
				v73 := v73[safeModuloInt(fm2(p3, false, p1, f15, globalState), v53[safeIndex(-f11, |v53|)]) := p1];
				globalState.f6 := p3;
				var v74: array<array<D4>> := new array<D4>[20];
				var v75: array<D4> := new D4[22](i6 => DC14(v61, p1));
				v74[safeIndex(835, v74.Length)] := v75;
				v74[safeIndex(835, v74.Length)] := v75;
				f24[safeIndex(182, f24.Length)] := f24[safeIndex(182, f24.Length)];
			}
			...
			var v77 := DC15(p3);
			var v78 := 'l';
			var v79: map<string, int> := map[p0 + p0[safeIndex(v77.cf32, |p0|) := v78] := f14];
			f24, r2 := f24, if (f13 in v79) then v79[f13] else p3;
			if (true ==> f15) {
				globalState.f7 := false;
				var v80 := new C0();
				var v81: array<int> := new int[14];
				var v82: set<int> := {v53[safeIndex(fm0(f15, globalState), |v53|)]};
				v81[safeIndex(274, v81.Length)] := -safeModuloInt(-|v82|, 738);
				globalState.f6, v81[safeIndex(274, v81.Length)] := p3, v80.fm16(p2, p1, f11, p1, globalState);
				f24 := new bool[3](i7 => p2);
				var v83: map<string, bool> := map[f13 := f15];
				var v84: map<int, string> := map[|map[f15 := v53]| := "vcj"];
				v83 := v83[p0 + (if (f12 in v84) then v84[f12] else "juhvefvw") := !((seq(abs(0x314), i8  => (v78))) < f13)];
			} else {
				...
				f24[safeIndex(235, f24.Length)] := v93 !in v94;
				f24[safeIndex(235, f24.Length)] := v90.fm17(fm20(p2, f15, false, globalState) + v53, globalState);
				var v95: seq<bool> := [f24[safeIndex(235, f24.Length)]];
				...
				v96[safeIndex(715, v96.Length)] := v97;
				v96[safeIndex(715, v96.Length)] := v97;
			}
		...
		r2 := safeModuloInt(fm0(f15, globalState), p3);
	}
	method m2(p0: array<bool>, p1: multiset<int>, globalState: GlobalState) returns (r0: bool, r1: multiset<int>) {
		var i0 := 0;
		while (f15)
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			globalState.f6 := -safeModuloInt(f14 + f14, 0x22d);
			globalState.f6 := f14;
			var v0: map<array<bool>, int> := map[f24 := f11];
			v0 := v0;
			globalState.f6 := -safeDivisionInt(f11, f12);
		}
		if (f15) {
			var v1 := new C0();
			f24[safeIndex(246, f24.Length)] := if (f15) then f15 else false;
			f24[safeIndex(246, f24.Length)] := f14 > f11;
			if (!fm1(f11, f24[safeIndex(246, f24.Length)], f24[safeIndex(246, f24.Length)], globalState)) {
				var v2: seq<bool> := [f15];
				var v3: seq<int> := [|v2|];
				var v4 := 'a';
				f24[safeIndex(246, f24.Length)] := ("t")[safeIndex(|v3|, |"t"|) := v4] < f13;
				globalState.f6 := f12;
				var v5: set<bool> := {f24[safeIndex(246, f24.Length)], true};
				var v6, v7 := m13(v5, globalState);
				globalState.f6 := safeModuloInt(f14, f11) + |(f13 + f13)|;
				var v8 := new C0();
			} else {
				globalState.f6 := 951;
				...
				var v17 := "uyja";
				var v18: seq<string> := [f13[safeIndex(f14, |f13|) := v14]];
				v17 := v18[safeIndex(f14, |v18|)] + "fkid";
			}
			...
			v20[safeIndex(605, v20.Length)] := v19;
			v20[safeIndex(605, v20.Length)] := v19;
			v20[safeIndex(605, v20.Length)] := v20[safeIndex(605, v20.Length)];
		} else {
			var v21: map<int, int> := map[f14 := f11];
			var v22: map<bool, string> := map[f15 := f13];
			var v23 := 'h';
			var v24: map<int, string> := map[|f13[safeIndex(|multiset(fm22(f14, globalState))|, |f13|) := v23]| := f13];
			var v26: map<bool, bool> := map[f15 := f15];
			var v27 := DC1(if (f15 in v26) then v26[f15] else f15, f12);
			var v28: array<int> := new int[28] [f12, f12, f14 + f11, |f13|, if (f11 in v21) then v21[f11] else -|"avvm"|, f12, f14, f12, f12, fm0(f15, globalState), f14, 0x4a, -f11, |v22| - |v24|, f12, f14, f14, f14, f12, f14 + fm0(true, globalState), |(set v25 : int | v25 in map[f12 := f13] :: (safeModuloInt(v25, 0x1bb)))|, f12, |(if (f15 in v22) then v22[f15] else f13)|, if (f15) then 0x291 else f11, safeModuloInt(f12, f11), safeDivisionInt(|map[f14 := f15]|, f11), v27.cf2, f11];
			v28[safeIndex(177, v28.Length)] := f14;
			...
			var v33: map<int, bool> := map[|v29| := |f13[safeIndex(|p1|, |f13|) := v23]| == |v32|];
			var v34: seq<int> := [f14];
			var v35 := DC13(v34);
			var v36: map<bool, int> := map[!false := f12];
			var v37: array<seq<int>> := new seq<int>[9] [v34 + v34, v34[safeIndex(f14, |v34|) := fm2(f12, f15, 959, false, globalState)], v34, v34 + (seq(abs(0x2a), i1  => (|map[DC4(f15).cf5 := f15]|))), [if (f15 in v36) then v36[f15] else f12, f12], v34, v34, v34, fm20(false, false, f15, globalState)];
			v37[safeIndex(689, v37.Length)] := [fm0(f15, globalState)];
			v28[safeIndex(177, v28.Length)], v29, v35, globalState.f6, v37[safeIndex(689, v37.Length)] := f11, v33, v35, f14, v34;
			var v38: seq<bool> := [f15];
			var v39: map<bool, char> := map[v38[safeIndex(f11, |v38|)] := v23];
			v39 := v39[f15 := v23];
			globalState.f6 := f12;
		...
		var v43: multiset<bool> := multiset{v42[safeIndex(f11, |v42|)], false};
		...
		var v50: array<int> := new int[29] [f12, -|v41[safeIndex(|v43|, |v41|)]|, -947, |v44|, f12, |v44|, DC1(!false, |[f15]|).cf2, f11, f11, f11, |[fm2(-f12, false, |v42|, f15, globalState), f12, f12]|, |v45|, -(f11 * f14), safeModuloInt(if ((seq(abs(0xff), i2  => (|[f11, -f12]|))) in v47) then v47[seq(abs(0xff), i2  => (|[f11, -f12]|))] else f12, f11), safeDivisionInt(f14, 0x367), -(f11 * f11), safeModuloInt(|v46|, f14), f14, f14, safeDivisionInt(f14, 0x3e0), f11, f12, f14, 990, f11, f14, |(map v48 : int | (0x20f <= v48) && (v48 < 0x12e) :: (safeModuloInt(v48, f12)) := (f11))| + f11, |v49| + f14, |multiset(v42)|];
		v50 := v50;
		var v51: map<set<bool>, bool> := map[v44 := f15];
		v51 := v51[{!f15, f15} := if (v42[safeIndex(f14, |v42|)]) then !f15 else true];
		var v52 := DC6(seq(abs(316), i3  => ('j')));
		var v53: seq<D2> := [v52];
		var v54: multiset<seq<D2>> := multiset{v53, v53};
		var v55: map<seq<int>, array<int>> := map[[if ((seq(abs(0x58), i4  => (DC6(f13)))) in v54) then v54[seq(abs(0x58), i4  => (DC6(f13)))] else f12, f12] := v50];
		...
		v58[safeIndex(78, v58.Length)] := v42[safeIndex(f11, |v42|) := f15];
		v58[safeIndex(78, v58.Length)] := v42;
		r0 := f15 <==> !f15;
		r1 := p1;
	}
	method m13(p0: set<bool>, globalState: GlobalState) returns (r0: array<int>, r1: set<bool>) {
		...
		f24[safeIndex(136, f24.Length)] := if (f15) then f15 else f15;
		f24[safeIndex(136, f24.Length)] := f15;
		for i1 := fm2(f14, f24[safeIndex(136, f24.Length)], f14, f15, globalState) to f14 {
			var v4: map<bool, bool> := map[f24[safeIndex(136, f24.Length)] := f24[safeIndex(136, f24.Length)]];
			var v5: multiset<map<bool, bool>> := multiset{v4[f15 := f24[safeIndex(136, f24.Length)]], v4};
			var v6: multiset<string> := multiset{"cewdik", f13};
			var v7: map<int, int> := map[-0x24b := f14];
			var v8: map<bool, map<int, int>> := map[f24[safeIndex(136, f24.Length)] := v7];
			globalState.f2 := (f12 + (if (v4 in v5) then v5[v4] else -(if ((seq(abs(704), i2  => ('c'))) in v6) then v6[seq(abs(704), i2  => ('c'))] else f14))) < |v8|;
			v1[safeIndex(711, v1.Length)] := f11;
			v1[safeIndex(711, v1.Length)] := i1;
			globalState.f6 := |(f13 + f13)|;
			globalState.f1 := map[f15 := if (f24[safeIndex(136, f24.Length)]) then true else if (f15 in v4) then v4[f15] else f15];
		}
		if (f15) {
			var v9: array<char> := new char[6](i3 => 'w');
			var v10 := 's';
			v9[safeIndex(36, v9.Length)] := v10;
			v9[safeIndex(36, v9.Length)] := v10;
			globalState.f2 := f24[safeIndex(136, f24.Length)];
			var v11 := new C0();
			globalState.f6 := f14;
			var v12: seq<int> := [f14, f12];
			globalState.f6 := |v12| + f11;
		} else {
			if (f24[safeIndex(136, f24.Length)]) {
				var v13: array<bool> := new bool[3](i4 => f24[safeIndex(136, f24.Length)]);
				...
				v18 := v18[v1 := f24[safeIndex(136, f24.Length)]];
				var v19: array<set<bool>> := new set<bool>[29];
				v19[safeIndex(761, v19.Length)] := p0;
				v19[safeIndex(761, v19.Length)] := (p0 + p0) - {true};
				var v20: multiset<int> := multiset{f11};
				var v21: seq<int> := [if (f11 in v20) then v20[f11] else f14, f12, f14, f14];
				var v22: map<bool, seq<int>> := map[f24[safeIndex(136, f24.Length)] := v21];
				var v23: map<array<bool>, seq<int>> := map[v13 := if (f15 in v22) then v22[f15] else v21];
				v23 := v23[v13 := v21 + v21];
			} else {
				f24[safeIndex(136, f24.Length)] := f24[safeIndex(136, f24.Length)];
				var v24: array<D5> := new D5[11];
				var v25: array<bool> := new bool[17] [f24[safeIndex(136, f24.Length)], f24[safeIndex(136, f24.Length)], f24[safeIndex(136, f24.Length)], f24[safeIndex(136, f24.Length)], !f24[safeIndex(136, f24.Length)], true, f15, f24[safeIndex(136, f24.Length)], f15, f15, f15, f24[safeIndex(136, f24.Length)], f24[safeIndex(136, f24.Length)], f15, f24[safeIndex(136, f24.Length)], false, f15];
				var v26: map<array<bool>, int> := map[v25 := f11];
				var v27 := DC18(v26, f12);
				v24[safeIndex(530, v24.Length)] := v27;
				v24[safeIndex(530, v24.Length)] := v27;
				...
				var v31: map<bool, int> := map[!false := |(if (f13 in v30) then v30[f13] else {f24[safeIndex(136, f24.Length)], f15})|];
				var v32: array<array<map<bool, bool>>> := new array<map<bool, bool>>[1] [v29[safeIndex(|v31|, |v29|)]];
				v32[safeIndex(461, v32.Length)] := v28;
				v32[safeIndex(461, v32.Length)] := v28;
				var v33: seq<D5> := [v24[safeIndex(530, v24.Length)]];
				var v34, v35 := m0(f24[safeIndex(136, f24.Length)], f15, |(v33 + v33)|, 53, globalState);
				globalState.f6 := f14;
			}
			
			var v36 := 'o';
			var v37: set<int> := {f12};
			var v38: array<char> := new char[11] ['p', v36, v36, f13[safeIndex(|v37|, |f13|)], 'v', v36, v36, v36, v36, v36, v36];
			v38[safeIndex(631, v38.Length)] := v36;
			v38[safeIndex(631, v38.Length)] := v36;
			var v39 := new C0();
			var v40 := new C0();
			globalState.f2 := !f15;
		...
		r1 := (p0 + p0) + v41[safeIndex(f14, |v41|)];
	}
	method m14(globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v3: map<seq<D6>, array<bool>> := map[v1[safeIndex(|v2|, |v1|) := v0] := f24];
			...
			var v8 := 'd';
			globalState.f7 := (v8 !in (seq(abs(0x1a3), i1  => (v8)))) <== f15;
		}
		var v9 := DC4(f15);
		...
		v12 := (v13[safeIndex(f14, |v13|)] - v12) + v12;
		var v14 := new C0();
		var v15 := new C0();
		var v16: array<int> := new int[15](i2 => i2 * f12);
		v16[safeIndex(940, v16.Length)] := 916;
		...
		v16[safeIndex(940, v16.Length)] := v18[safeIndex(f11, |v18|)];
...
class C2 extends T1 {
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		if (|v0| < f12) {
			...
			globalState.f6 := p3;
			r1 := safeModuloInt(--(f11 - 0x1d0), f27);
			var v1: set<int> := {-p3};
			globalState.f7, globalState.f6, globalState.f2 := p2, -p1, v1 < (v1 - v1);
			var v2: array<bool> := new bool[21];
			v2[safeIndex(699, v2.Length)] := |[p2]| <= p1;
			v2[safeIndex(699, v2.Length)] := p0 != p0;
		} else {
			var v3 := DC30(p2, p2, f13, p2);
			var v4: array<map<int, bool>> := new map<int, bool>[11];
			var v5: seq<int> := [p1];
			var v6: map<int, bool> := map[|v5| := false];
			v4[safeIndex(773, v4.Length)] := v6;
			v3, r1, v4[safeIndex(773, v4.Length)] := v3, p3, (fm42(p3, p2, map v7 : int | (-647 <= v7) && (v7 < 0x1c3) :: (v7 + f11) := (157), globalState))[safeModuloInt(p1, p3) := p2];
			globalState.f7 := p2;
			var v8: set<bool> := {!p2};
			...
			v13 := (v13 + v13) + v13;
			var v14 := "xvu";
			globalState.f6, v14 := |((v14 + p0) + (p0 + (seq(abs(-0xb0), i0  => ('i')))))|, p0;
		}
		
		var v15: multiset<int> := multiset{p1};
		var v16: multiset<bool> := multiset{true};
		var v17: set<bool> := {p2, p2};
		r1 := if (safeDivisionInt(|v16|, 618) in v15) then v15[safeDivisionInt(|v16|, 618)] else |v17| * |p0|;
		...
		match (v21) {
			case DC34(cf58, cf59, cf60, cf61, cf62) =>
				...
				globalState.f6, cf59, v26 := safeDivisionInt(-v20.f14, v20.f11), !(v31 >= v31), v26;
				if (!cf58) {
					v18 := v18;
					v18[safeIndex(292, v18.Length)] := cf59;
					v18[safeIndex(292, v18.Length)] := cf58;
					v16 := v16[v20.f15 := abs(if (cf59 in v16) then v16[cf59] else v20.f14)];
					v29 := v29;
					f27 := |f13|;
				} else {
					...
					v18[safeIndex(687, v18.Length)] := cf58;
					v18[safeIndex(687, v18.Length)] := fm44(f11, !v20.f15, globalState) == (p0 + v20.f13);
					var v33: seq<bool> := [v20.f15];
					var v34: array<bool> := new bool[7] [v20.f15, false, v20.f15, v33[safeIndex(f12, |v33|)], fm1(p1, v20.f15, cf62, globalState), cf58, v20.f15];
					var v35 := new C1(v34, safeModuloInt(v20.f12, |v17|), f12, v30.cf20, v20.f15, v20.f13);
					var v36 := DC37(v15);
			...
			case DC33(cf57) =>
				...
				v40 := v43[safeIndex(0xde - |v45[safeIndex(0x19e, |v45|)]|, |v43|)];
				r2, f27, r1 := -safeDivisionInt(v20.f14, p3), -f11 - f12, cf57.f14;
		...
		for i2 := v20.f14 to v20.f14 {
			...
			var v51 := 'i';
			v48[safeIndex(510, v48.Length)] := if (v51 in v50) then v50[v51] else 0x60;
			var v52: seq<bool> := [v20.f15];
			v49, v48[safeIndex(510, v48.Length)], globalState.f6, f27 := p0, |((v52 + v52) + v52)|, safeDivisionInt(v20.f14, v20.f11), -|v20.f13|;
			...
			var v56 := DC40(v52);
			var v57: seq<seq<bool>> := [v55[safeIndex(|v56.cf72|, |v55|)], [v53.fm1((fm46(p2, |v15|, i2, 0x20b, globalState)).cf24, v20.f15, p2, globalState), v20.f15]];
			var v58: map<char, int> := map[v51 := |v52|];
			v54 := v54[v20.f15 := v20.f15 in v55[safeIndex(if (v51 in v58) then v58[v51] else v20.f14, |v55|)]];
		}
		var v59: seq<int> := [f12, f11, f12];
		var v60: seq<seq<int>> := [seq(abs(0x327), i4  => (|map[|[|multiset{v20.f15, p2, v20.f15, false}|]| := p1]|)), v59];
		for i3 := 0x3ba to |v60| {
			v18[safeIndex(674, v18.Length)] := v20.f15;
			v18[safeIndex(674, v18.Length)] := v20.f15;
			var v61 := new C0();
			var v62 := 'c';
			v62 := p0[safeIndex(0x368, |p0|)];
			var v63 := new C0();
		}
		if (v20.f15) {
			globalState.f2 := p2;
			...
			var v64 := "n";
			var v65 := 's';
			v64 := (f13 + f13)[safeIndex(p3, |(f13 + f13)|) := v65];
			var v66: array<array<seq<bool>>> := new array<seq<bool>>[3];
			var v67: array<seq<bool>> := new seq<bool>[2];
			v66[safeIndex(77, v66.Length)] := v67;
			v66[safeIndex(77, v66.Length)] := v67;
			v18[safeIndex(506, v18.Length)] := v20.f15;
			v18[safeIndex(506, v18.Length)] := (f27 in v59) <==> v20.f15;
		} else {
			f27 := p3;
			var v68 := 'a';
			...
			v69[safeIndex(592, v69.Length)] := v68;
			var v70 := "j";
			globalState.f7, globalState.f7, v69[safeIndex(592, v69.Length)], v70, f27 := v17 > (v17 + v17), (if (!p2) then f11 else if (v20.f15 in v16) then v16[v20.f15] else v20.f14) <= v20.fm2(f27, p2, v20.f12, v20.f15, globalState), v68, fm44(-(---104 + |v16|), p2, globalState), p1;
			var v71: array<int> := new int[29];
			v71[safeIndex(528, v71.Length)] := v20.f12;
			v71[safeIndex(528, v71.Length)] := f12 * v20.f11;
			v18[safeIndex(958, v18.Length)] := false;
			v18[safeIndex(958, v18.Length)] := p2 ==> v20.f15;
			var v72: array<map<bool, int>> := new map<bool, int>[9];
			var v73: map<bool, int> := map[true := v20.f11];
			v72[safeIndex(887, v72.Length)] := v73[true := v20.f11];
			v18[safeIndex(958, v18.Length)], globalState.f6, v72[safeIndex(887, v72.Length)] := v17 == v17, safeModuloInt(v20.f12, |v59|), v73;
		}
	...
	method m19(p0: int, p1: int, p2: D7, p3: int, globalState: GlobalState) {
		...
		if (if ((true !in v3) in v2) then v2[true !in v3] else !fm41(globalState)) {
			...
			var v9: array<seq<int>> := new seq<int>[16] [v5, v5, v5, seq(abs(0x93), i0  => (f27)), [f27], v5, v5[safeIndex(f12, |v5|) := 0xef], [p0, f12, 0x2ad, p0], v6[safeIndex(|v8|, |v6|)], v5, v5, v5, seq(abs(0x17), i1  => (f12)), v5, v5, v5];
			var v10 := m20(fm41(globalState), {v0}, v9, v0, globalState);
			var v11 := new C0();
			var v12: array<int> := new int[14];
			v12[safeIndex(42, v12.Length)] := f11;
			v12[safeIndex(42, v12.Length)] := f12;
			globalState.f7 := true;
		} else {
			...
			var v16: array<int> := new int[9] [f12, f27, f27, if (v0) then p1 else |f13|, f12, f11, |(v13 + v13)|, fm40(v13[safeIndex(|v14|, |v13|)], v0, v1, v0, globalState), |f13| * p0];
			var v17: map<string, D11> := map[f13 := DC34(v0, v0, -0x24e, v0, v0)];
			var v18: seq<string> := [f13];
			var v19 := DC34(v0, v0, f11, v0, v0);
			v16[safeIndex(95, v16.Length)] := |(if (false) then v17 else map[v18[safeIndex(p0, |v18|)] := v19])|;
			var v20 := "kddujed";
			v16[safeIndex(95, v16.Length)], globalState.f2, v14, v20, v0 := p1, v0, v14 + (v14 + [v0, !false]), (if (v0) then f13 else "hke") + v20, f12 == fm40(864, v0, v1, v0, globalState);
			var v21 := DC41(fm1(p1, v0, v0, globalState), v0, seq(abs(309), i2  => (v1)));
			var v22 := DC30(true || v0, v14 == v14, v21.cf75, v0 ==> v0);
			match (v22) {
				case DC29() =>
					var v23: multiset<seq<char>> := multiset{[v1], [v1], f13, f13, f13};
					var v24: map<string, int> := map[f13 := v16[safeIndex(95, v16.Length)]];
				...
				case DC30(cf48, cf49, cf50, cf51) =>
					...
					v28 := if (cf51) then if (cf51) then {v27, v27} else v28 else v29[safeIndex(p3, |v29|)];
					var v30: multiset<int> := multiset{v16[safeIndex(95, v16.Length)], |multiset{v16}|};
					var v31: map<int, int> := map[|v13| := f11];
					var v32: map<seq<bool>, map<int, int>> := map[v14 := v31];
					var v33: set<multiset<int>> := {v30, v30, v30[|v32| := abs(|v13|)], v30[|v14| := abs(v16[safeIndex(95, v16.Length)])], v30};
				...
				case DC31(cf52, cf53, cf54, cf55) =>
					globalState.f6 := -safeDivisionInt(v16[safeIndex(95, v16.Length)] - cf52, cf52);
					var v36: multiset<bool> := multiset{true};
					f27 := safeDivisionInt(p1, if (v0 in v36) then v36[v0] else --cf52);
					var v37 := DC27(v16);
					v16 := v37.cf46;
					v16, v16[safeIndex(95, v16.Length)] := v16, v16[safeIndex(95, v16.Length)];
				case DC28(cf47) =>
					...
					v43[safeIndex(883, v43.Length)] := v0;
					v43[safeIndex(883, v43.Length)] := fm41(globalState);
					globalState.f6 := v16[safeIndex(95, v16.Length)];
					globalState.f6 := f11 + (if (v0) then |"oxxopb"| else p3);
				case DC32(cf56) =>
					v16[safeIndex(95, v16.Length)] := f11 - p0;
					var v44 := DC19(v3);
					var v45: map<multiset<D6>, seq<bool>> := map[multiset{v44} := fm43(v0, v0, globalState)];
					var v46: map<int, seq<bool>> := map[p1 := v14[safeIndex(p1, |v14|) := v0]];
					var v47: multiset<D6> := multiset{v44};
					var v48: map<int, multiset<D6>> := map[|(if (p0 in v46) then v46[p0] else v14)| := v47];
					v45 := (v45[multiset{v44} := v14])[(if (v16[safeIndex(95, v16.Length)] in v48) then v48[v16[safeIndex(95, v16.Length)]] else v47)[v44 := abs(p1)] := [v0, v0]];
					var v49: map<int, int> := map[f12 + f11 := safeModuloInt(|f13|, f11)];
					v49 := v49[|map[v0 := v0]| * f27 := v16[safeIndex(95, v16.Length)]];
					var v50 := DC2(v1);
					...
					globalState.f2 := v51 >= (if (v0) then set v54 : D1 | v54 in v53[safeIndex(p1, |v53|)] :: (v54) else v51);
			}
	...
	method m20(p0: bool, p1: set<bool>, p2: array<seq<int>>, p3: bool, globalState: GlobalState) returns (r0: int) {
		...
		var v4 := 'h';
		var v5: array<int> := new int[26] [f12, f12, f12, fm0(p0, globalState), f27, f27, -f12, |v0|, f11, 0xe2, f27, if (p3 in v1) then v1[p3] else |f13|, |v2|, f12, |p1|, f27, f27, |v1|, fm40(f27, v3[safeIndex(0x12f, |v3|)], v4, p0, globalState), f27, |p1|, f12, f27, |p1|, |v1|, |f13|];
		var v6 := DC27(v5);
			...
			case DC27(cf46) =>
				...
				match (v8.(cf33 := v7)) {
					case DC14(cf30, cf31) =>
						...
						r0 := safeDivisionInt(f12, cf31);
						v9[safeIndex(123, v9.Length)] := p0;
						var v11: set<int> := {f12};
						var v12 := DC40(v3);
						var v13: map<int, bool> := map[f11 := fm41(globalState)];
						var v14 := DC1(p3, 0x152);
						var v15: multiset<int> := multiset{f11};
						r0, v9[safeIndex(123, v9.Length)], globalState.f2, f27, globalState.f2 := safeDivisionInt(0x244, |v11|), fm41(globalState) in v12.cf72, if (f11 in v13) then v13[f11] else v14.cf1, f27, v15 >= v15;
						v13 := v13[f27 := p3];
					case DC15(cf32) =>
						...
						var v18 := DC6("k");
						var v19: seq<seq<int>> := [v17 + [|v18.cf9|, f12], (seq(abs(0x362), i1  => (-f12))) + v17, v17, v17];
						...
						cf46[safeIndex(795, cf46.Length)] := f27;
						v19, v21, globalState.f6, globalState.f6, cf46[safeIndex(795, cf46.Length)] := [v17], v21, fm40(f11, p0, v4, DC41(p0, p3, f13).cf74, globalState) + (f11 - f12), cf32, -cf32;
						var v22 := DC20(f12, cf46[safeIndex(795, cf46.Length)]);
						var v23: multiset<int> := multiset{f12};
						var v24: map<bool, bool> := map[p3 := p3];
						var v25: array<bool> := new bool[21] [p3, v3[safeIndex(v22.cf38, |v3|)], p0, p3, p0, multiset{cf46[safeIndex(795, cf46.Length)]} < v23, p0, p0, p0, p3, p0, p0, p3, p3, p0, p3, -0x265 != -|f13|, p3, !p0, p0 in v24, p0];
						v25[safeIndex(448, v25.Length)] := cf46[safeIndex(795, cf46.Length)] == v17[safeIndex(f27, |v17|)];
						v25[safeIndex(448, v25.Length)] := fm41(globalState);
				...
				v35 := v35[|f13| := v34];
				globalState.f6 := |(f13 + ("pcrtaml" + f13))[safeIndex(fm0(p3, globalState) - f11, |(f13 + ("pcrtaml" + f13))|) := v4]|;
			case DC26(cf45) =>
				...
				match (fm52(v3, if (p3) then p0 else p3, v38 >= v38, f27, globalState)) {
					case DC20(cf38, cf39) =>
						...
						f27 := -safeDivisionInt(|v39|, cf39 * f27);
					case DC21(cf40) =>
						v1 := multiset((v3 + fm43(p0, p3, globalState)) + (v3[safeIndex(f11, |v3|) := p0] + v3));
					...
					case DC19(cf37) =>
						...
						var v49: map<int, bool> := map[|v48[safeIndex(f11, |v48|)]| := p3];
					...
					case DC22(cf41) =>
						...
						v51[safeIndex(147, v51.Length)] := v52;
						v51[safeIndex(147, v51.Length)] := v52;
						var v53 := DC0(multiset(f13));
						var v54: map<int, D0> := map[f27 := v53];
						var v55 := DC4(p0);
						v54 := v54[safeModuloInt(|f13|, f12) := if (v55.cf5) then v53 else v53];
						v5[safeIndex(492, v5.Length)] := f12;
						v5[safeIndex(492, v5.Length)] := if (p3 in v1) then v1[p3] else safeModuloInt(f27, f27);
						globalState.f7 := !(!p0 <== p3);
				}
				
				cf45.f24[safeIndex(347, cf45.f24.Length)] := !p3;
				var v56: map<int, map<bool, int>> := map[f27 := v2];
				cf45.f24[safeIndex(347, cf45.f24.Length)] := cf45.fm1(|v56|, false, true, globalState);
		}
		...
		v57[safeIndex(488, v57.Length)] := v60;
		v57[safeIndex(488, v57.Length)] := (v60 + v60) + v60[v59 := p0];
		...
		r0 := safeModuloInt(fm40(56, p0, 'e', p0, globalState), if (p3) then f11 else -0x16e);
	}
}
...
class C3 extends T3 {
	...
	function fm2(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): int {
		if (f15) then |map[false := f12]| else safeModuloInt(-f11, |map[f11 := f11]|)
	}
	function fm3(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<bool, int> {
		if (false) then map[!f25 := f14] + map[f25 := |(seq(abs(0x193), i0  => (seq(abs(-0x236), i1  => ('e')))))|] else map[f25 := |multiset{f12, f14}|] + map[f25 := f12]
	}
	function fm1(p0: int, p1: bool, p2: bool, globalState: GlobalState): bool {
	...
	method m3(p0: map<array<bool>, int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: T0) {
		...
		v7[safeIndex(55, v7.Length)] := fm1(-f12, f15, true, globalState);
		var v9: seq<set<int>> := [set v8 : int | (-0x153 <= v8) && (v8 < 906) :: (safeModuloInt(v8, f11))];
		v7[safeIndex(55, v7.Length)] := match fm27(|v9|, f15, globalState) {
		...
		var i0 := 0;
		while (882 <= fm0(v3[safeIndex(|v10|, |v3|)], globalState))
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			i0 := i0 + 1;
			var v11 := new C0();
			globalState.f7 := v7[safeIndex(55, v7.Length)];
			var v12: set<bool> := {p1};
			var v13: array<int> := new int[13] [f11, f14, f11, f12, |f13|, f11, safeModuloInt(|v12|, f11), f14, f12, f11, |fm3(f14, !v7[safeIndex(55, v7.Length)], p1, globalState)|, 0xbd, f14];
			v13[safeIndex(425, v13.Length)] := f14;
			var v14 := DC14(v4, fm2(f12, p1, f14, p1, globalState));
			v13[safeIndex(425, v13.Length)] := v14.cf31;
			...
			match (v16) {
				case DC20(cf38, cf39) =>
					...
					v17[safeIndex(694, v17.Length)] := v19;
					v17[safeIndex(694, v17.Length)] := v19;
					var v20 := DC18(p0, |multiset{cf38}|);
					var v21: multiset<D5> := multiset{v20};
					globalState.f7, cf38, v13[safeIndex(425, v13.Length)], v7[safeIndex(55, v7.Length)] := v7[safeIndex(55, v7.Length)], cf39, v13[safeIndex(425, v13.Length)], v20 in v21;
					v13 := new int[29](i1 => safeModuloInt(i1, cf38));
					var v22: map<int, bool> := map[|f26| := v0 > v0];
					v22 := v22[-safeDivisionInt(cf39, v13[safeIndex(425, v13.Length)]) := p1];
				case DC21(cf40) =>
					v13[safeIndex(425, v13.Length)], globalState.f6 := f14, fm2(0x17, false, v13[safeIndex(425, v13.Length)], f15, globalState);
					var v23: seq<int> := [0x1b1];
					v13, v23, v7, v7[safeIndex(55, v7.Length)] := v13, seq(abs(0x25d), i2  => (v13[safeIndex(425, v13.Length)])), v7, v7[safeIndex(55, v7.Length)];
					var v24 := DC19(fm3(f12, false, v7[safeIndex(55, v7.Length)], globalState));
					var v25 := DC22(v24);
					v0, globalState.f7, v25 := if (cf40) then v0 else multiset(v3), cf40, v25;
					var v26 := DC5(DC18(p0, |v3|).cf36, v7[safeIndex(55, v7.Length)], p1);
					var v27 := DC2('p');
					var v28: array<D1> := new D1[3] [DC2(v4), fm28(!f15, cf40, fm26(true, globalState), v26, globalState), v27];
					v28[safeIndex(491, v28.Length)] := v27;
					v28[safeIndex(491, v28.Length)] := v27;
				case DC19(cf37) =>
					v7[safeIndex(55, v7.Length)] := (0x65 * fm2(f12, v3[safeIndex(f11, |v3|)], v13[safeIndex(425, v13.Length)], f15, globalState)) !in v6;
					globalState.f7 := v7[safeIndex(55, v7.Length)];
					globalState.f7 := true in v12;
					globalState.f6 := f11;
				case DC22(cf41) =>
					r1 := !!f25;
					var v29: C1 := new C1(v7, f14, v13[safeIndex(425, v13.Length)], |map[v3 := f25]|, true, f26[safeIndex(v13[safeIndex(425, v13.Length)], |f26|) := 'c']);
					var v30: seq<C1> := [v29];
					v30 := v30 + v30;
		...
		if (82 > f14) {
			...
			if (true) {
				...
				globalState.f2 := !v7[safeIndex(55, v7.Length)];
				v35[safeIndex(831, v35.Length)] := f11;
				globalState.f7, globalState.f6, v35[safeIndex(831, v35.Length)] := v3[safeIndex(fm0(true, globalState), |v3|)], fm0(v7[safeIndex(55, v7.Length)], globalState) * f11, if (f25) then 0x2c8 else fm0(f15, globalState);
				v38 := v38;
				var v40 := new C0();
			} else {
				r0 := f12;
				var v41: seq<int> := [|(v3[safeIndex(f11, |v3|) := v7[safeIndex(55, v7.Length)]] + [p1, f25, fm1(f12, false, v7[safeIndex(55, v7.Length)], globalState)])|, safeModuloInt(f14, f12), f14];
				globalState.f6 := |v41|;
				v7[safeIndex(55, v7.Length)] := p1;
				globalState.f7 := f15;
				globalState.f6 := safeModuloInt(-|[f12]|, f12);
			}
			
			var v42: array<int> := new int[15](i3 => i3 * f12);
			var v43: map<bool, array<int>> := map[f25 := v42];
			var v44: map<bool, set<int>> := map[f15 := {f12, |v43|}];
			var v45: array<set<int>> := new set<int>[24] [v6 - v6, v6, v6, v6, {f14}, {f12}, v6 + {f14, f12}, v6, v6 - {|v0|}, {f14} + fm29(globalState), v6, if (v7[safeIndex(55, v7.Length)] in v44) then v44[v7[safeIndex(55, v7.Length)]] else v9[safeIndex(f12, |v9|)], {f14}, v6, {f11, f11}, v6, v6, v6 + v6, fm29(globalState), v6, v6, fm29(globalState), v6, v6];
			v45[safeIndex(867, v45.Length)] := set v46 : int | (0x42 <= v46) && (v46 < 693) :: (v46 - f14);
			v45[safeIndex(867, v45.Length)] := set v47 : int | v47 in (v2 + v2) :: (v47 - 0xa8);
			f16 := f13;
			...
			var v55 := DC2(v4);
			var v56: map<bool, bool> := map[v7[safeIndex(55, v7.Length)] := p1];
			var v57 := DC7(v7, v54, v55, |v56|, 0x2ca);
			var v58: map<map<char, int>, int> := map[v52 := fm2(v57.cf13, false, f12, p1, globalState)];
			v58 := map v59 : map<char, int> | v59 in (seq(abs(396), i4  => (v52))) :: (v59) := (f12);
			r0 := f14;
			var v60: map<string, int> := map[f13 := safeDivisionInt(f14, f11)];
			v60 := v60[f26[safeIndex(f14, |f26|) := v4] := 450];
			var v61 := new C0();
			var v62, v63 := m0(true, v3[safeIndex(f12, |v3|)], f14, safeModuloInt(f12, f14), globalState);
		}
		
		var v64: array<int> := new int[28];
		v64[safeIndex(982, v64.Length)] := f12;
		v64[safeIndex(982, v64.Length)] := f12;
		globalState.f7 := f15;
		r0 := safeDivisionInt(v64[safeIndex(982, v64.Length)], f11);
		r1 := f12 > f11;
	...
	method m4(p0: array<bool>, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v1: seq<int> := [443];
			var v2: map<array<bool>, int> := map[p0 := v1[safeIndex(f11, |v1|)]];
			var v3 := DC18(v2, f14);
			var v4: multiset<bool> := multiset{f25, fm1(f11, f15, false, globalState)};
			var v5 := 'x';
			var v6: set<bool> := {!f15};
			var v7: multiset<int> := multiset{v3.cf36 + -(if (f25 in v4) then v4[f25] else -|f16[safeIndex(f14, |f16|) := v5]|), 0x3, f12 + |v6|, f14};
			...
			if (fm26(f25, globalState)) {
				...
				v11 := v11[safeDivisionInt(-0x3a5, |v6|) := f11 + f11];
				var v12: map<bool, int> := map[false := 494];
				var v13 := DC19(v12);
				var v14: array<int> := new int[6];
				v14[safeIndex(744, v14.Length)] := f12;
				var v15: seq<bool> := [f15];
				var v16: map<seq<bool>, bool> := map[v15 := f15];
				var v17: multiset<char> := multiset{v5};
				var v18 := DC0(v17);
				globalState.f2, globalState.f7, v13, v14[safeIndex(744, v14.Length)], globalState.f2 := f25, if (if (v15 in v16) then v16[v15] else !f25) then f15 else false, v13, (if (f15) then f12 else f11) + fm2(f11, f15, f11, f15, globalState), v5 !in fm31(v5, v18, globalState);
				...
				var v22: array<int> := new int[21](i1 => safeModuloInt(i1, f14));
				var v23 := DC23(v22);
				var v24: map<bool, array<int>> := map[v21[safeIndex(|f16|, |v21|)] := v23.cf42];
				var v25: seq<array<int>> := [v22];
				v24 := v24[f15 <==> f15 := v25[safeIndex(f11, |v25|)]];
				globalState.f2 := f15;
			}
		...
		globalState.f7 := v26[safeIndex(|map[v27 := f14]|, |v26|)];
		var v28: array<int> := new int[8];
		forall i2 | 0 <= i2 < v28.Length {
			v28[i2] := safeModuloInt(i2, f12);
		}
		var v29 := 'w';
		...
		v30[safeIndex(810, v30.Length)] := v29;
		v30[safeIndex(810, v30.Length)] := v29;
		r0 := safeDivisionInt(--f14, fm2(0x22f, false, f14, f15, globalState) + -0xd1);
		var v31: seq<int> := [f11];
	...
	method m2(p0: array<bool>, p1: multiset<int>, globalState: GlobalState) returns (r0: bool, r1: multiset<int>) {
		...
		if (!(f25 && f15)) {
			...
			v0 := v0[v2 != map[seq(abs(844), i0  => (f14)) := p0] := v3];
			...
			var v13: seq<map<bool, bool>> := [v5[safeIndex(|v12|, |v5|)], v4];
			v5 := [v4] + v5;
			globalState.f6 := safeDivisionInt(v10.cf14, f14);
			var v14 := new C0();
		} else {
			var v15: seq<bool> := [f15];
			...
			var v25 := DC0(v24);
			var v26: array<string> := new string[23] [if (v16.f15) then f26[safeIndex(|v18|, |f26|) := v19] else v16.f13, v16.f13, f13, "tpecquwlx", v20.cf9, "ql", f26, f13, f16, f13, f26, f26 + f13, f16, v16.f13, f16, v20.cf9, f13 + v16.f13, v16.f13, f16[safeIndex(v16.f14, |f16|) := v19], "xv" + v22.cf22[safeIndex(f14, |v22.cf22|) := v19], v16.f13, v23.cf17, fm31(v19, v25, globalState) + "bumgcuck"];
			v26[safeIndex(598, v26.Length)] := v23.cf17;
			v26[safeIndex(598, v26.Length)] := f26 + (v16.f13 + f26);
			...
			var v35: seq<C1> := [v33];
			var v36 := DC26(v35[safeIndex(v16.f12, |v35|)]);
			...
			var v49: array<bool> := new bool[27] [v16.f15, 0x391 != f12, v31 !! DC24(v31).cf43, v38 > fm32(f25, v39, v40, f25, globalState), (if (f25 in v41) then v41[f25] else multiset{f11, v16.f14, |p1|})[|v17| := abs(-0x297)] > p1, f15, !f25, v16.f15, (map v42 : int | (-0x80 <= v42) && (v42 < 126) :: (v42 * f14) := ([v16.f15, f15, f25, f15, f25])) != v44.cf47, v16.f15, v16.f15, v46 > v46, f25, f15, (if (false in v48) then v48[false] else v40) == v40, !true, v16.f15, fm1(|f16|, f15, DC4(v16.f15).cf5, globalState), f15, f25, f15, !(-f12 >= f14), f15, true, false, v15[safeIndex(f11, |v15|)], f25];
			v49 := v33.f24;
		}
		...
		match (v52) {
			case DC29() =>
				...
				var v56 := new C1(p0, |v54|, f12, safeDivisionInt(f14, |v55|), f15, f13);
				match (DC32(v51)) {
					case DC29() =>
						var v57: T2 := new C1(v56.f24, f12 * f11, -499, f12, f15, seq(abs(0x2ad), i1  => (v50)));
						v57 := v57;
					...
					case DC30(cf48, cf49, cf50, cf51) =>
						...
						v61 := (v61 + v61) + v61;
						var v62 := DC5(|(seq(abs(0x269), i2  => (v50)))|, cf49, f25);
						...
						v65 := v65[false := f16];
						globalState.f2 := true;
						globalState.f6, globalState.f6 := 309, |(seq(abs(0x2bf), i3  => (DC25(f14))))|;
					case DC31(cf52, cf53, cf54, cf55) =>
					...
					case DC28(cf47) =>
						...
						v69[safeIndex(801, v69.Length)] := |(if (f15) then p1 else fm33(globalState))|;
						var v70: seq<bool> := [f15];
						globalState.f6, v69[safeIndex(801, v69.Length)] := v67[safeIndex(safeDivisionInt(f14, |v70|), |v67|)], safeDivisionInt(f14, f14);
					case DC32(cf56) =>
						globalState.f2 := !!f15;
						v56.f24[safeIndex(282, v56.f24.Length)] := true;
						v56.f24[safeIndex(282, v56.f24.Length)] := (f12 - |f16|) != f12;
						globalState.f7 := v56.f24[safeIndex(282, v56.f24.Length)];
						globalState.f7 := false;
				}
				
				var v71: array<seq<bool>> := new seq<bool>[12];
				var v72: seq<bool> := [false];
				v71[safeIndex(18, v71.Length)] := v72 + v72;
				v71[safeIndex(18, v71.Length)] := v72 + (v72 + v72);
			case DC30(cf48, cf49, cf50, cf51) =>
				if (fm26(f12 < f11, globalState)) {
					...
					var v83 := new C1(p0, -0x374 - fm2(-f14, cf51, f14, false, globalState), if (f25) then f11 else f14, f11, cf51, (seq(abs(236), i5  => (v50)))[safeIndex(|v82|, |(seq(abs(236), i5  => (v50)))|) := 'v']);
					v83.f24[safeIndex(30, v83.f24.Length)] := cf49;
					var v84: seq<int> := [f11];
					v83.f24[safeIndex(30, v83.f24.Length)] := |multiset(v84)| in map[f11 := false];
					var v85: map<map<bool, bool>, int> := map[fm35(v83.f24[safeIndex(30, v83.f24.Length)], v84[safeIndex(f12, |v84|) := |f13|], globalState) := f14];
					...
					var v92: seq<set<int>> := [set v91 : int | v91 in multiset{if (v83.f24[safeIndex(30, v83.f24.Length)] in v87) then v87[v83.f24[safeIndex(30, v83.f24.Length)]] else f11, f12, |multiset(v89[safeIndex(f14, |v89|)])|, |v90|, |"cun"|} :: (safeDivisionInt(v91, -0x121))];
					v86 := v86 - v92[safeIndex(f14, |v92|)];
				}
				...
				var v94: seq<int> := [f11];
				v94 := [f14, |(v94 + v94)|];
				v93[safeIndex(977, v93.Length)] := f12;
				var v95: array<bool> := new bool[28];
				cf49, v93[safeIndex(977, v93.Length)], cf51, v95 := (f14 + f12) >= f11, -f12, true, if (false) then v95 else v95;
			case DC31(cf52, cf53, cf54, cf55) =>
				var v96 := DC30(f25, !f15, f13, f25);
				match (v96) {
					case DC29() =>
						var v97: map<string, int> := map[f16 := f12];
						var v98 := DC10(f25, 0x352, v97, seq(abs(0x2e7), i6  => (cf53)), 0xbe);
						f16 := f13 + v98.cf22;
						globalState.f6 := cf52;
						cf55 := 780;
						var v99: array<char> := new char[6](i7 => f16[safeIndex(0x7, |f16|)]);
						v99[safeIndex(685, v99.Length)] := fm34(cf53, globalState);
						v99[safeIndex(685, v99.Length)] := 'x';
					case DC30(cf48, cf49, cf50, cf51) =>
						...
						var v105: array<set<int>> := new set<int>[21] [v101, v101, v101, v101, v101, {f12}, v101, v101, {f14}, {0x68, -f14, f11, cf55}, v101, set v102 : int | (-190 <= v102) && (v102 < 0x3a5) :: (safeDivisionInt(v102, cf52)), {|v103|, cf52, cf52}, v101, set v104 : int | (0x215 <= v104) && (v104 < -0x2b7) :: (v104 + |cf50|), v101 * {cf55, cf54}, v101, v101 * v101, v101, v101, v101];
						v100, globalState.f7, v105 := [fm0(cf48, globalState), cf52], (f12 * f14) == |v101|, v105;
						f16 := seq(abs(-0x58), i8  => (cf53));
						var v106 := new C0();
						v100 := v100 + v100;
					case DC31(cf52, cf53, cf54, cf55) =>
						var v107: map<bool, int> := map[f25 := cf55];
						var v108: seq<int> := [if (f25 in v107) then v107[f25] else f11, 0xe7];
						var v109: multiset<multiset<int>> := multiset{p1, multiset{f14}, p1, p1 * p1[-f12 := abs(f12)], multiset(v108) - (multiset{fm0(f25, globalState), 0x178, cf55})[|f13| := abs(f14)]};
						v109 := v109;
						var v110: seq<string> := [f16 + f16];
						v110 := v110;
						var v111 := new C1(p0, cf54, f14, f11, f15, f16 + "pma");
						v111.f24[safeIndex(666, v111.f24.Length)] := v111.fm1(f12, v111.fm1(f14, f15, f25, globalState), false, globalState);
						var v113: map<map<int, int>, bool> := map[map v112 : int | (0x299 <= v112) && (v112 < 0xed) :: (v112 - cf55) := (|{cf52, -0x18a}|) := fm1(cf55, f25, true, globalState)];
						v111.f24[safeIndex(666, v111.f24.Length)], v96, globalState.f6 := f15, v96, -safeDivisionInt(|v113| * f14, fm2(f14, f15, f11, f15, globalState));
					case DC28(cf47) =>
						var v114 := new C1(p0, |f26|, cf52, cf54, f15, f26);
						v114.f24[safeIndex(915, v114.f24.Length)] := !f15;
						var v115: multiset<char> := multiset{v50};
						var v116 := DC0(v115);
						var v117: seq<D0> := [v116];
						v114.f24[safeIndex(915, v114.f24.Length)] := [v116, DC0(v115), v116] < v117;
						v114.m14(globalState);
						globalState.f6 := -(cf55 + fm2(cf54, f25, cf54, v114.f24[safeIndex(915, v114.f24.Length)], globalState));
					case DC32(cf56) =>
						cf52 := cf52;
						var v118: multiset<char> := multiset{cf53, 'd', v50, cf53, v50};
						var v119 := DC0(v118);
						var v120 := new C1(p0, f12, -cf55, cf54, f25, fm31(cf53, v119, globalState) + (seq(abs(0x345), i9  => (cf53))));
						...
						var v125: seq<seq<int>> := [[|v121[safeIndex(f12, |v121|) := f25]|, |v123|], v124];
				...
				if (f25) {
					...
					v126[safeIndex(820, v126.Length)] := f13 + f16;
					v126[safeIndex(820, v126.Length)] := "wyovsxkv";
					globalState.f6 := fm0(fm26(f25, globalState), globalState);
					var v127: array<bool> := new bool[8](i11 => f25);
					var v128 := DC21(f25);
					p0[safeIndex(224, p0.Length)] := v50 !in f13;
					cf54, v127, v128, p0[safeIndex(224, p0.Length)] := cf55, p0, v128, f25;
					v127 := v127;
				} else {
					...
					v135, f16, cf53 := v135, seq(abs(0x14a), i12  => (v50)), cf53;
					var v136: array<D10> := new D10[3];
					var v137: map<int, array<D10>> := map[safeModuloInt(-f12, -626) := if (false) then v136 else v136];
					v137 := v137[f14 * 451 := v136];
					p0[safeIndex(824, p0.Length)] := if (f15) then f15 else true;
					var v138: set<int> := {f11, cf55, -0x2fb};
					p0[safeIndex(824, p0.Length)] := if (!!(f25 || f25)) then f25 else v138 !! v138;
					var v139: seq<D10> := [fm37(p0[safeIndex(824, p0.Length)], globalState)];
					var v140: map<bool, seq<D10>> := map[p0[safeIndex(824, p0.Length)] := v139];
					v140 := (if (f25) then v140 else v140) + map[fm1(|f16|, p0[safeIndex(824, p0.Length)], f15, globalState) := v139];
			...
			case DC28(cf47) =>
				...
				if (v142 >= v142) {
					var v143: map<int, int> := map[f11 := safeModuloInt(|"mvena"|, f14)];
					v143 := v143[-0x191 := |f16|];
					...
					p0[safeIndex(480, p0.Length)] := f25;
					var v155: set<int> := {f12};
					var v157: multiset<map<int, bool>> := multiset{v154, v154, v154, map[-f14 := f25], v154};
					v154, p0[safeIndex(480, p0.Length)], globalState.f7, v155, globalState.f7 := v154 + (map v156 : int | (446 <= v156) && (v156 < 0x328) :: (safeModuloInt(v156, f11)) := (f25)), f15, f25, v155, v157 !! (v157 - multiset{v154, v154});
					var v158: map<bool, bool> := map[true := p0[safeIndex(480, p0.Length)]];
					globalState.f1 := map[fm1(f12, p0[safeIndex(480, p0.Length)], p0[safeIndex(480, p0.Length)], globalState) := f25] + map[f15 := if (f15 in v158) then v158[f15] else if (!!true in v158) then v158[!!true] else f25];
					globalState.f2 := false;
					p0[safeIndex(480, p0.Length)] := f15;
					var v159: array<C0> := new C0[14];
					var v160: C0 := new C0();
					v159[safeIndex(516, v159.Length)] := if (f15) then v160 else v160;
					v159[safeIndex(516, v159.Length)] := v160;
				}
				
				p0[safeIndex(515, p0.Length)] := true;
				p0[safeIndex(515, p0.Length)] := fm1(0x1e1, f15, f15, globalState);
				var v161: seq<bool> := [f15, p0[safeIndex(515, p0.Length)]];
				var v162: array<bool> := new bool[25] [f25, p0[safeIndex(515, p0.Length)], f25, f15, p0[safeIndex(515, p0.Length)], f15, f25, f25, f15, p0[safeIndex(515, p0.Length)], p0[safeIndex(515, p0.Length)], f15, p0[safeIndex(515, p0.Length)], f15, !f15, f25, p0[safeIndex(515, p0.Length)], false, !fm1(f14, p0[safeIndex(515, p0.Length)], f25, globalState), f15, fm1(|v161|, f25, false, globalState), f15, p0[safeIndex(515, p0.Length)], f25, p0[safeIndex(515, p0.Length)]];
				var v163: array<int> := new int[10](i14 => i14 - f14);
				var v164 := DC21(p0[safeIndex(515, p0.Length)]);
				m17(if (p0[safeIndex(515, p0.Length)]) then v162 else v162, v163, if (fm26(v164.cf40, globalState)) then v163 else v163, globalState);
				p0[safeIndex(515, p0.Length)] := p0[safeIndex(515, p0.Length)];
			case DC32(cf56) =>
				globalState.f6 := 0x120;
				globalState.f2 := (p1[f14 := abs(f12)] == p1) ==> f15;
		...
		var v172: array<array<int>> := new array<int>[14] [v170, v170, v170, v171[safeIndex(f11, |v171|)], v170, v170, v170, v170, v170, v170, v170, v170, v170, v170];
		v172 := v172;
		...
		match (v174.(cf29 := if (f15) then v173 else v173)) {
			case DC14(cf30, cf31) =>
				...
				v175 := v176[safeIndex(f12, |v176|)];
				var v177: map<int, bool> := map[cf31 := f15];
				var v178: map<bool, bool> := map[|map[cf30 := true]| > f11 := (if (-0x1dd in v177) then v177[-0x1dd] else f15) !in (fm30(f25, f15, --cf31, f15, globalState))[safeIndex(f11, |fm30(f25, f15, --cf31, f15, globalState)|) := true]];
				var v179: multiset<bool> := multiset{f25, false};
				var v180: T2 := new C1(p0, 247, cf31, f14, f15, seq(abs(0x1d5), i15  => (v50)));
				var v181 := DC33(v180);
				...
				globalState.f7 := if ((fm1(335, f25, f15, globalState) <== f25) in v178) then v178[fm1(335, f25, f15, globalState) <== f25] else v179 > v179[f15 := abs(v185.cf13)];
				cf31 := v173[safeIndex(v180.f12, |v173|)];
				var v186 := DC6(seq(abs(265), i16  => (v50)));
				var v187: seq<string> := [f13, "gqkjge", v180.f13, v186.cf9, v180.f13];
				f16 := f26 + (v187[safeIndex(-v180.f12, |v187|)])[safeIndex(v180.f14, |v187[safeIndex(-v180.f12, |v187|)]|) := v50];
			case DC15(cf32) =>
			...
			case DC13(cf29) =>
				p0[safeIndex(606, p0.Length)] := f15;
				p0[safeIndex(606, p0.Length)] := f25;
				globalState.f6 := f14;
				...
				v197 := v197[if (f11 in v198) then v198[f11] else f12 := v196[v195 := abs(f12)]];
				var v199: map<int, string> := map[0x3a0 := "xw"];
				var v200: map<int, set<char>> := map[|"hqso"| := {'e', v50, v50}];
				v199 := v199[|(v200 + v200)| := ("lp")[safeIndex(f12, |"lp"|) := v50]];
			case DC16(cf33) =>
				r0 := false;
				p0[safeIndex(542, p0.Length)] := f15;
				p0[safeIndex(542, p0.Length)] := f15;
				var v201: array<seq<int>> := new seq<int>[1] [v173];
				v201[safeIndex(506, v201.Length)] := v173;
				var v202: map<bool, bool> := map[!f25 := fm26(f15, globalState)];
				v170, p0[safeIndex(542, p0.Length)], v201[safeIndex(506, v201.Length)], globalState.f6, globalState.f6 := v170, fm1(f14 - |{f25}|, f11 <= f11, f15, globalState), [f12, |f16|] + v173, |fm38(f12, f26, if (f25 in v202) then v202[f25] else p0[safeIndex(542, p0.Length)], globalState)|, f14;
				globalState.f7, globalState.f2 := v169[safeIndex(f12 + f12, |v169|)], false;
		}
		
		var v203: map<bool, string> := map[false := f26];
		var v204: array<string> := new string[23] [f16, f26, f26 + f16, f13, f13, f26, (f26 + f13[safeIndex(f12, |f13|) := v50])[safeIndex(-0x364, |(f26 + f13[safeIndex(f12, |f13|) := v50])|) := v50], if (f25 in v203) then v203[f25] else "dffjfo", f13, f13, f26, f13, f13[safeIndex(f12, |f13|) := v50] + (seq(abs(0x317), i17  => (v50))), f26, f16, seq(abs(-0x248), i18  => ('k')), f26, f16, f13 + f16, "lwefadivg", f26, f13, f13 + f26];
		v204[safeIndex(794, v204.Length)] := f16 + f13;
		v204[safeIndex(794, v204.Length)] := (match fm39(globalState) {
			case DC7(cf10, cf11, cf12, cf13, cf14) => "cmmrxafmt"
			case DC8(cf15, cf16, cf17) => "qfxans"
			case DC6(cf9) => seq(abs(0x29c), i19  => (v50))
		})[safeIndex(|[f25, f15, f15, f25, fm26(f15, globalState)]|, |(match fm39(globalState) {
			case DC7(cf10, cf11, cf12, cf13, cf14) => "cmmrxafmt"
			case DC8(cf15, cf16, cf17) => "qfxans"
			case DC6(cf9) => seq(abs(0x29c), i19  => (v50))
		})|) := v50];
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		v4[safeIndex(465, v4.Length)] := v7 == v7;
		var v8: array<int> := new int[27](i0 => safeModuloInt(i0, p1));
		var v9: map<bool, int> := map[p2 := f11];
		var v10: seq<map<bool, int>> := [v9];
		var v11 := DC19(v10[safeIndex(f12, |v10|)]);
		var v12: map<int, bool> := map[fm2(f14, true, 0x11d, f25, globalState) := f14 > f11];
		var v13: seq<array<int>> := [v8, v8, v8, v8, v8];
		globalState.f6, v4[safeIndex(465, v4.Length)], v8, v11 := f14, if ((if (false) then |v2[safeIndex(f11, |v2|) := p2]| else p1) in v12) then v12[if (false) then |v2[safeIndex(f11, |v2|) := p2]| else p1] else f25, v13[safeIndex(|([f15] + v2)|, |v13|)], v11;
		var v14: set<bool> := {v2[safeIndex(0x2c0, |v2|)]};
		var v15 := DC35(v14);
		var i1 := 0;
		while (v15.cf63 >= (if (f15) then {v4[safeIndex(465, v4.Length)]} else v14))
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			var v16 := 'i';
			v16 := v16;
			if (v2[safeIndex(-0x364 + -f12, |v2|)]) {
				globalState.f2 := f15;
				v8[safeIndex(556, v8.Length)] := f11;
				v8[safeIndex(556, v8.Length)] := f11;
				globalState.f6 := safeModuloInt(v8[safeIndex(556, v8.Length)], |v2|) + f12;
				globalState.f7 := !f25;
				var v17: array<array<int>> := new array<int>[24];
				var v18 := DC14(v16, f14);
				var v19: set<int> := {v8[safeIndex(556, v8.Length)]};
				var v20: seq<set<int>> := [v19];
				var v21: T1 := new C2(f11, p0[safeIndex(|{v3}|, |p0|) := v18.cf30], p3, if (v2[safeIndex(|v20[safeIndex(|v2|, |v20|)]|, |v2|)] in v5) then v5[v2[safeIndex(|v20[safeIndex(|v2|, |v20|)]|, |v2|)]] else 435);
				var v22: seq<T1> := [v21, if (v4[safeIndex(465, v4.Length)]) then v21 else v21, v21, v21];
				var v23: map<int, map<int, int>> := map[v8[safeIndex(556, v8.Length)] := v7];
				globalState.f6, v17, globalState.f7, v22 := safeModuloInt(|v3|, v21.f12), v17, safeModuloInt(|v23|, -f11) == f11, v22 + v22;
			} else {
				var v24: map<seq<bool>, bool> := map[v2 := !p2];
				r0 := p2 <==> (if (v2 in v24) then v24[v2] else fm26(v4[safeIndex(465, v4.Length)], globalState));
				var v25: map<bool, map<bool, bool>> := map[p2 := v6[f25 := false]];
				var v26 := DC42(v25);
				v25 := v26.cf76;
				var v27: seq<set<bool>> := [v14, v14];
				r0 := (v14 + v14) <= v27[safeIndex(f12, |v27|)];
				v8[safeIndex(910, v8.Length)] := 0x3c7;
				v8[safeIndex(910, v8.Length)] := f11 - 0x177;
				v4[safeIndex(465, v4.Length)], globalState.f6, v16, v16, v4 := f25 <== f25, f11, v16, fm47(safeDivisionInt(|f16|, f14), globalState), v4;
			}
			
			var v28 := new C1(v4, -387, f14, |map[v4 := f25]|, f25, "iyyrfnvqk");
			globalState.f7 := p3 < (v3[safeIndex(v28.fm2(|f26|, v4[safeIndex(465, v4.Length)], p3, p2, globalState), |v3|)] * |p0|);
		}
		var v29: set<string> := {fm44(f12, f25, globalState)};
		v29 := v29;
		var v30 := DC8(false, v4[safeIndex(465, v4.Length)], p0);
		var v31 := 't';
		...
		match (v35) {
			case DC10(cf19, cf20, cf21, cf22, cf23) =>
				v8[safeIndex(199, v8.Length)] := |cf22|;
				var v36: map<char, int> := map[v31 := -p3];
				v8[safeIndex(199, v8.Length)] := safeModuloInt(|fm32(f25, v36, set v37 : int | (0x22e <= v37) && (v37 < 0x2c0) :: (safeModuloInt(v37, cf23)), f15, globalState)|, 0x315) - (p1 - cf23);
				var v38 := DC24(v5);
				var v39: seq<D8> := [v38];
				cf20, r2, v31 := (f12 * f14) + |(v39 + [v38.(cf43 := v5), v38, v38, v38])|, -cf20, v31;
				var v40: set<int> := {cf20, f12};
				var v41: multiset<int> := multiset{p3, |v14|};
				var v42 := new C1(v4, |(v40 + v40)|, |v41|, |fm43(v4[safeIndex(465, v4.Length)], p2, globalState)|, cf19, if (v4[safeIndex(465, v4.Length)]) then seq(abs(-0x1a0), i2  => (v31)) else fm31(v31, v33, globalState));
				var v43 := DC31(p1, v31, p1, f14);
				var v44: array<multiset<char>> := new multiset<char>[21] [multiset{v31} * multiset{v31}, multiset{v31, v43.cf53} + v32, multiset{v31}, v32[v31 := abs(cf20)] + v32, v32, v32, multiset{'x'}, multiset{v31, v31, v31}, v32 + v32, v32, v32, v32, multiset{v31} + v32, v32, v32, if (v0.fm17(v3, globalState)) then v32 else v32[v31 := abs(cf20)], v32, v32 - multiset(p0), v32, v32 * v32, v32];
				v44[safeIndex(737, v44.Length)] := v32 - v32;
				v4[safeIndex(465, v4.Length)], v44[safeIndex(737, v44.Length)] := true, if (f25) then v32 else v32;
			case DC11(cf24, cf25, cf26, cf27) =>
				v8[safeIndex(166, v8.Length)] := 761;
				globalState.f6, globalState.f7, globalState.f6, v8[safeIndex(166, v8.Length)] := fm0(p2, globalState) - -0x3b5, f11 in map[p1 := p2], f11, v3[safeIndex(p3, |v3|)];
				r0 := v4[safeIndex(465, v4.Length)];
				if ((f13 == f26) && cf27) {
					globalState.f6 := -fm0(!f15, globalState);
					globalState.f2, r1, globalState.f6, v8[safeIndex(166, v8.Length)], globalState.f7 := !!(fm0(p2, globalState) < (-174 - |v12|)), |((fm31(v31, v33, globalState) + p0) + f26)|, f12, v8[safeIndex(166, v8.Length)] + (p1 - f14), true;
					...
					v3 := [f12, |v3|, -|v46|, |"nl"|, v8[safeIndex(166, v8.Length)]] + v3;
				} else {
					...
					var v54 := DC31(p1, v31, 566, safeModuloInt(p3, -|v53|));
					v54 := v54;
					var v55: array<int> := new int[1] [|multiset{v8[safeIndex(166, v8.Length)]}|];
					var v56 := DC27(v55);
					var v57: map<array<int>, multiset<bool>> := map[v56.cf46 := v5];
					v5 := (if (v4[safeIndex(465, v4.Length)]) then if (v55 in v57) then v57[v55] else v5 else fm54(v3[safeIndex(p3, |v3|)], globalState))[cf27 := abs(f14 - cf24)];
					r0 := false;
			...
			case DC9(cf18) =>
				...
				var v61 := DC3(v4[safeIndex(465, v4.Length)]);
				var v62: array<char> := new char[10](i3 => v31);
				var v63: map<bool, array<char>> := map[v4[safeIndex(465, v4.Length)] := v62];
				var v64 := DC45(v4, v31, -0x364, |v63|, f15);
				var v65, v66 := m0(v61.cf4, !v64.cf85, f12, safeModuloInt(f12, |map[v4[safeIndex(465, v4.Length)] := v31]|), globalState);
				r2 := p3;
				f16 := f16;
			case DC12(cf28) =>
				var v67 := DC5(f14, v4[safeIndex(465, v4.Length)], v4[safeIndex(465, v4.Length)]);
				if (v67.cf8) {
					var v68: multiset<int> := multiset{f11, f12};
					var v69 := new C1(v4, 0xb0, p1, p3 * f14, v68 !! v68, "vcmr");
					var v70: map<bool, array<int>> := map[v4[safeIndex(465, v4.Length)] := v8];
					v70 := v70;
					globalState.f2 := f25;
					var v71: C0 := new C0();
					var v72 := DC24(v5);
					v71, v4[safeIndex(465, v4.Length)] := v71, v5 >= v72.cf43;
					var v73: set<int> := {f12};
					v8[safeIndex(488, v8.Length)] := -|(v73 + v73)|;
					v8[safeIndex(488, v8.Length)], v31, v4[safeIndex(465, v4.Length)], globalState.f7, globalState.f7 := f14 * 0xae, 'e', (0x22 < |v73|) || f15, v69.fm1(f12, v4[safeIndex(465, v4.Length)], true, globalState), fm26(v4[safeIndex(465, v4.Length)], globalState);
				} else {
					...
					v79[safeIndex(626, v79.Length)] := v3;
					v79[safeIndex(626, v79.Length)] := v3;
					var v80: map<bool, map<bool, bool>> := map[false := v6];
					v8[safeIndex(632, v8.Length)] := p1 - |v80|;
					v4[safeIndex(465, v4.Length)], v8[safeIndex(632, v8.Length)] := p2, f14 + |("oxpno")[safeIndex(|(map v81 : int | (0x16 <= v81) && (v81 < 699) :: (v81 * |f16|) := (p3))|, |"oxpno"|) := v31]|;
					globalState.f6 := |v5|;
					var v82 := DC34(!v4[safeIndex(465, v4.Length)], p2, f12, p2, !f25);
					var v83: map<bool, D11> := map[p2 := v82];
					v83 := v83[v4[safeIndex(465, v4.Length)] := DC34(f15, p2, f14, f15, f15)];
				}
		...
		var v89: multiset<string> := multiset{f16[safeIndex(0x10f, |f16|) := v31], "wnoekch", f26, (f26 + f13)[safeIndex(|v3|, |(f26 + f13)|) := v31]};
		v89 := v89;
		r0 := f25;
		r1 := -f14;
	...
	method m17(p0: array<bool>, p1: array<int>, p2: array<int>, globalState: GlobalState) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := safeModuloInt(i0, f12);
		}
		var v1: array<set<int>> := new set<int>[17];
		var v2: seq<int> := [f14, f11];
		var v3: set<int> := {f11, f11, |v2|};
		v1[safeIndex(231, v1.Length)] := v3;
		var v4: seq<bool> := [f25];
		var v5 := DC40(v4);
		v1[safeIndex(231, v1.Length)] := match v5 {
			case DC41(cf73, cf74, cf75) => {|multiset{f14}|} * v3
			case DC40(cf72) => {v2[safeIndex(|f13|, |v2|)]}
		};
		globalState.f7 := fm1(|[v2, v2]|, fm26(f15, globalState), (seq(abs(221), i2  => ('t'))) <= f16, globalState);
		if (f25 ==> (if (f15) then f15 else f15)) {
			globalState.f6 := if (f25) then -f12 else 0x6b;
			if ((if (f15) then f12 else f14) >= |f16|) {
				v1[safeIndex(231, v1.Length)] := v1[safeIndex(231, v1.Length)];
				globalState.f6 := safeDivisionInt(f12, f11) + f11;
				p0[safeIndex(309, p0.Length)] := f12 <= f12;
				p1[safeIndex(691, p1.Length)] := f11;
				var v6: set<bool> := {f15};
				var v7: multiset<set<bool>> := multiset{v6};
				var v8 := 'm';
				var v9: map<char, bool> := map[v8 := f15];
				var v10: multiset<map<char, bool>> := multiset{v9};
				p0[safeIndex(309, p0.Length)], p1[safeIndex(691, p1.Length)], v7, globalState.f7 := (if (f25) then v10 else v10) != v10, f11, multiset(fm55(globalState)), !f25;
				globalState.f6 := safeModuloInt(f12, f14);
				p1[safeIndex(691, p1.Length)] := p1[safeIndex(691, p1.Length)];
			} else {
				...
				v13 := DC1(f25, -safeModuloInt(f11, f12));
				v0 := v0;
				p0[safeIndex(458, p0.Length)] := f25 ==> true;
				p0[safeIndex(458, p0.Length)] := f15;
			}
			...
			if (f25) {
				...
				v14[safeIndex(152, v14.Length)] := p1;
				v14[safeIndex(152, v14.Length)] := v0;
				p0[safeIndex(626, p0.Length)] := false;
				p0[safeIndex(626, p0.Length)] := f25;
				var v15: array<seq<int>> := new seq<int>[17];
				v15 := v15;
				var v16: array<bool> := new bool[22](i3 => f15);
				var v17 := 'h';
				var v18: C1 := new C1(v16, fm0(f15, globalState), |("r")[safeIndex(f12, |"r"|) := v17]|, f14 - f12, !!!p0[safeIndex(626, p0.Length)], f13);
				v18 := v18;
			} else {
				...
				var v24 := DC2(v20);
				var v25 := DC7(p0, if (v4[safeIndex(f12, |v4|)] in v23) then v23[v4[safeIndex(f12, |v4|)]] else v22, v24, f12, f14);
				var v26 := new C2(|(v19 - v19)|, f26 + (seq(abs(378), i4  => ('h'))), f14, |map[multiset{v20} := {v25.cf14}]|);
				p1[safeIndex(621, p1.Length)] := v26.f27 - f12;
				p0[safeIndex(206, p0.Length)] := f15;
				var v27: set<bool> := {f25, f25};
				var v28: map<char, array<bool>> := map[v20 := p0];
				p1[safeIndex(621, p1.Length)], globalState.f6, p0[safeIndex(206, p0.Length)], globalState.f2, v26.f27 := 97, safeModuloInt(if (!!true) then |v2| else 701, f12), 0x10a != |(v27 * v27)|, f15, |v28|;
				p0[safeIndex(206, p0.Length)] := !p0[safeIndex(206, p0.Length)];
				var v29: array<array<bool>> := new array<bool>[17];
				var v30: array<bool> := new bool[24];
				v29[safeIndex(315, v29.Length)] := v30;
				v29[safeIndex(315, v29.Length)] := v30;
				var v31: map<int, array<int>> := map[|v4| := p2];
				var v32: map<array<int>, array<int>> := map[if (p0[safeIndex(206, p0.Length)]) then v0 else v0 := if (-0x292 in v31) then v31[-0x292] else p2];
				v32 := v32[p2 := v0];
			}
			
		} else {
			globalState.f6 := |"pcgqgvidi"| - f14;
			p0[safeIndex(736, p0.Length)] := f15;
			p0[safeIndex(736, p0.Length)] := f25;
			var v33: array<bool> := new bool[16](i5 => multiset{v4[safeIndex(-f11, |v4|)]} !! multiset{f25, false});
			v33 := v33;
			var v34: map<bool, string> := map[p0[safeIndex(736, p0.Length)] := f26];
			var v35 := new C2(f12, if (p0[safeIndex(736, p0.Length)] in v34) then v34[p0[safeIndex(736, p0.Length)]] else f26, f14, f12);
			globalState.f7 := f15;
		}
		...
		for i7 := f14 to fm0(f15, globalState) {
			...
			if (f15) {
				...
				v37[safeIndex(632, v37.Length)] := v4 + (if ((if (f15 in v39) then v39[f15] else f25) in v38) then v38[if (f15 in v39) then v39[f15] else f25] else v4);
				v37[safeIndex(632, v37.Length)] := (if (!!f15) then v4 else [f25]) + (v4 + v4);
				...
				v42 := v42 * (v42[f11 := abs(0x8b)] + v42);
				var v43 := 'm';
				var v44: multiset<char> := multiset{v43, 'y'};
				var v45 := DC30(f25, !f25, f16[safeIndex(|v44|, |f16|) := v43], v43 !in f13);
				globalState.f6, globalState.f2, v45 := f12, f15, DC30(f15, f25 && f25, f16, f12 != i7);
			} else {
				var v46: map<int, bool> := map[-902 - |multiset{f15}| := f15];
				v46 := v46[f12 := f15];
				v36[safeIndex(923, v36.Length)] := f25;
				var v47: set<bool> := {!fm1(i7, f25, f25, globalState)};
				var v48: seq<set<bool>> := [v47, v47, v47];
				v36[safeIndex(923, v36.Length)] := v4[safeIndex(safeModuloInt(|v48[safeIndex(i7, |v48|)]|, f14), |v4|)];
				var v49: multiset<bool> := multiset{!v36[safeIndex(923, v36.Length)]};
				v0[safeIndex(524, v0.Length)] := (if (f15 in v49) then v49[f15] else |v4|) - f14;
				v0[safeIndex(524, v0.Length)] := f11;
				var v50: map<int, int> := map[f12 := |f26|];
				var v51: C2 := new C2(f12, f26, |v50|, v0[safeIndex(524, v0.Length)]);
				globalState.f6 := |multiset{v51, v51, v51, v51}|;
				v36[safeIndex(923, v36.Length)] := f14 < v51.f27;
			}
			...
			var v62: map<multiset<map<int, int>>, int> := map[v56 := |(map v57 : int | v57 in v58 :: (safeModuloInt(v57, |"bwekm"|)) := (f11))[if (f12 in v52) then v52[f12] else if (v60 in v61) then v61[v60] else i7 := -|v2|]| + i7];
			var v63: multiset<bool> := multiset{f25};
			v62 := v62[multiset{map[|(v4[safeIndex(f12, |v4|) := f15])[safeIndex(|[|[v59, v59]|, |v4|]|, |v4[safeIndex(f12, |v4|) := f15]|) := f25]| := |v63|]} := f14];
			var v64: set<bool> := {f15, f25};
			var v65 := new C2(safeDivisionInt(|v64|, f12), seq(abs(0x1e5), i9  => (v59)), 0xbb, -0x2e9 + |v2|);
		}
	}
	method m18(p0: array<int>, p1: int, globalState: GlobalState) returns (r0: array<int>, r1: map<int, seq<int>>, r2: seq<int>, r3: char) {
		...
		match (DC48(f25 || f15, !(p1 <= f11), f15)) {
			case DC48(cf90, cf91, cf92) =>
				...
				v1[safeIndex(451, v1.Length)] := cf91;
				v1[safeIndex(451, v1.Length)] := f15;
				var v2: array<multiset<int>> := new multiset<int>[21](i0 => multiset([f12]));
				var v3: multiset<int> := multiset{f14};
				v2[safeIndex(216, v2.Length)] := v3;
				var v4: seq<int> := [p1, f14];
				var v5: seq<seq<int>> := [v4];
				var v6: seq<bool> := [f15];
				var v7: seq<bool> := [v6[safeIndex(f12, |v6|)]];
				v2[safeIndex(216, v2.Length)] := multiset(v5[safeIndex(fm2(f14, cf90, |v7|, v1[safeIndex(451, v1.Length)], globalState), |v5|)]) + multiset{|v6|, fm0(true, globalState), p1};
				var v8: set<int> := {|v7|};
				var v9: map<int, int> := map[-|v8| := f12];
				var v10: map<int, map<int, int>> := map[p1 := v9];
				globalState.f6 := p1 * |v10|;
			case DC49(cf93) =>
				p0[safeIndex(248, p0.Length)] := p1;
				p0[safeIndex(248, p0.Length)] := f11;
				var v11 := 't';
				var v12: multiset<char> := multiset{v11};
				var v13 := DC0(v12);
				var v14: array<D0> := new D0[25] [v13, DC0(multiset{v11, v11, 'm'}), fm56(p0[safeIndex(248, p0.Length)], globalState), DC0(v12), v13, v13, DC0(v12), if (fm1(cf93, fm26(f25, globalState), f15, globalState)) then v13 else fm56(f12, globalState), v13, v13, v13, v13, v13, v13, DC0(v12), DC0(multiset{'r', 'l'}), v13, v13, v13, v13, v13, v13, v13.(cf0 := multiset{'m'}), DC0(v12), v13.(cf0 := v12)];
				v14[safeIndex(90, v14.Length)] := v13;
				v14[safeIndex(90, v14.Length)] := v13;
				var v15: array<int> := new int[17];
				var v16 := DC23(v15);
				var v17: array<array<int>> := new array<int>[9] [v15, v15, v15, (v16.(cf42 := v15)).cf42, v15, v15, v15, v15, v15];
				v17[safeIndex(374, v17.Length)] := if (f15) then v15 else v15;
				v17[safeIndex(374, v17.Length)] := v15;
				globalState.f7 := (-p0[safeIndex(248, p0.Length)] - f12) > f11;
			case DC50(cf94) =>
				...
				globalState.f6 := |f26|;
			case DC47(cf89) =>
				globalState.f6, globalState.f6 := f14, -safeModuloInt(if (f25) then p1 else 0x3bc, f12);
				p0[safeIndex(47, p0.Length)] := f11;
				var v20: seq<bool> := [f25];
				p0[safeIndex(47, p0.Length)] := |(v20 + (v20 + v20))|;
				var v21 := 'n';
				var v22: map<char, int> := map[v21 := --p1];
				var v23: map<int, bool> := map[p1 := fm1(f11, f15, f25, globalState)];
				var v24: seq<int> := [|v23|];
				var v25: set<int> := {f11, |v24|};
				var v26: set<int> := {-p1 + 861, if (f25) then p0[safeIndex(47, p0.Length)] else -|fm32(f15, v22, v25, f25, globalState)|, p1, p1};
				v26 := v26;
				if (f15) {
					v21 := v21;
					globalState.f6 := f11;
					...
					var v34 := DC36(p0[safeIndex(47, p0.Length)], f11, f11);
					var v35: set<D12> := {v34};
					...
					var v41: array<map<int, string>> := new map<int, string>[7] [v39, v39, fm57(f25, v31.f27, globalState), v39, v39 + (map v40 : int | v40 in v23 :: (safeModuloInt(v40, |(seq(abs(884), i3  => (|multiset{v31.f27}|)))|)) := (f16))[p1 := f26], v39 + v39, map[p0[safeIndex(47, p0.Length)] := f13]];
					v41[safeIndex(102, v41.Length)] := map[f14 := f16] + v39;
					v41[safeIndex(102, v41.Length)] := map[v31.fm40(|f13|, f15, v21, !f15, globalState) := "lhjdtwyrw"];
				}
		...
		var v52: seq<multiset<map<bool, bool>>> := [v50[v47 := abs(|v51|)], v50, v50];
		r0 := if (v52[safeIndex(p1, |v52|)] in v48) then v48[v52[safeIndex(p1, |v52|)]] else p0;
...
class C4 extends T3, T2, T1 {
	...
	method m3(p0: map<array<bool>, int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: T0) {
		...
		var v2: T3 := new C3(f15, v0[safeIndex(|(map v1 : int | (128 <= v1) && (v1 < 60) :: (safeModuloInt(v1, f11)) := (p1))|, |v0|)], f16, f14, p1, f13, f14, f12);
		...
		var v12: array<bool> := new bool[18] [f15, p1, fm24(|fm25(f12, p1, globalState)|, f15, globalState), p1, f15, !(v3 < v3), p1, p1, f14 <= v2.f11, if (if (0x3d7 in v5) then v5[0x3d7] else f15) then f15 else false, v6[safeIndex(v2.f14, |v6|)], f15, v2.f15, |v2.f16| !in v11, v2.f15, p1, !(|f16| >= f14), p1];
		var v13: multiset<bool> := multiset{false, p1};
		v12[safeIndex(96, v12.Length)] := v13 <= v13;
		v12[safeIndex(96, v12.Length)] := f15;
		...
		var i1 := 0;
		while (v6[safeIndex(fm0(v16.cf19, globalState), |v6|)])
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			v18, globalState.f7, globalState.f7 := v18 + (seq(abs(0x329), i2  => (v2.f14))), v6[safeIndex(f12, |v6|)] ==> (v2.f14 != v2.f11), p1;
			globalState.f7 := v2.f11 > v2.f11;
			var v19 := new C0();
		}
		var v20: array<int> := new int[15];
		v20[safeIndex(616, v20.Length)] := -(|v4| * f12);
		var v21: set<string> := {f16};
		v20[safeIndex(616, v20.Length)] := fm2(f11, {seq(abs(928), i3  => (v7))} !! v21, f11, p1, globalState);
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			if (!v12[safeIndex(96, v12.Length)]) {
				var v22 := DC8(p1, v12[safeIndex(96, v12.Length)], v2.f16);
				...
				v20[safeIndex(616, v20.Length)] := v2.f11 - (if (v2.f15) then f12 else 0xfd);
				var v28: array<char> := new char[2];
				v28[safeIndex(658, v28.Length)] := v7;
				var v29: map<seq<bool>, bool> := map[v6 := false];
				globalState.f6, v28[safeIndex(658, v28.Length)], v20[safeIndex(616, v20.Length)] := f11, v7, |(v29 + v29)[v6 := v13 !! v13]|;
				var v30: T2 := new C1(v12, v2.f14, v20[safeIndex(616, v20.Length)], v2.f12 * |v2.f13|, multiset{v2.f15, false} > fm54(f12, globalState), v2.f16);
				v30 := v30;
				var v31: map<int, char> := map[v20[safeIndex(616, v20.Length)] := fm34(v28[safeIndex(658, v28.Length)], globalState)];
				globalState.f2 := (f14 + |v31|) >= 597;
			} else {
				globalState.f6 := safeModuloInt(v2.f11 + v2.f12, fm2(0x123, v2.f15, |v2.f13|, v2.f15, globalState));
				var v33 := new C3(v2.f15, "psqvohow", v2.f16, v2.f14, p1, f13, |(map v32 : int | (0xc4 <= v32) && (v32 < 54) :: (safeDivisionInt(v32, |v2.f13|)) := (v2.f11))|, v2.f11);
			...
			var v37: map<int, map<int, char>> := map[v2.f14 := map[v20[safeIndex(616, v20.Length)] := 'o']];
			v36 := (v36 + v36)[|v37| := v7];
			globalState.f6 := -v2.f12;
		...
		for i6 := 0x36f to -(-0x329 + v2.f12) {
			...
			var v40: T2 := new C1(v10, v2.f12, f11, 282, v2.f15, if (i6 in v39) then v39[i6] else seq(abs(-0x3da), i7  => (v7)));
			var v41 := DC33(v40);
			v41 := v41;
			var v42: seq<int> := [f12];
			var v43 := DC37(multiset{v40.f11});
			globalState.f2 := |(v42[safeIndex(v20[safeIndex(616, v20.Length)], |v42|) := |v43.cf67|] + v42)[safeIndex(v40.f14, |(v42[safeIndex(v20[safeIndex(616, v20.Length)], |v42|) := |v43.cf67|] + v42)|) := v40.f11]| in v42;
			var v44: map<int, map<int, int>> := map[v2.f14 := v14];
			globalState.f2 := v40.fm1(|v44|, !v12[safeIndex(96, v12.Length)] <==> v2.f15, p1, globalState);
			globalState.f7 := (seq(abs(0xdb), i8  => (v7))) <= "ie";
		}
		r0 := v20[safeIndex(616, v20.Length)];
		r1 := (v2.f13 == f13) <== (v6 <= v6);
		r2 := new C1(v12, -v20[safeIndex(616, v20.Length)], |v14|, f14, v12[safeIndex(96, v12.Length)], seq(abs(421), i9  => ('h')));
	}
	method m4(p0: array<bool>, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		...
		var v5: array<int> := new int[18] [safeDivisionInt(f14, f11), 659, f11 - |map[f12 := f15]|, safeDivisionInt(f14, f14), |v0[v1[safeIndex(f14, |v1|)] := f14]| * f14, -(f11 + -f14), f11 + f11, f12, |v0|, -safeDivisionInt(-f14, v2.cf66), f12, safeModuloInt(f11, -|v3.cf89|), 0x3d, safeModuloInt(f11, fm0(f15, globalState)), |v4|, f12 * f14, -f11, f14];
		var v6: multiset<bool> := multiset{f15, !!f15};
		v5, v5, globalState.f2 := v5, if (v4[safeIndex(if (!f15 in v6) then v6[!f15] else f12, |v4|)]) then v5 else v5, f15;
		var v7 := DC29();
		var v8 := DC32(v7);
		match (v8) {
			case DC29() =>
				r0 := f12 + f12;
				v5[safeIndex(168, v5.Length)] := f12;
				var v9: multiset<int> := multiset{|multiset(f13)|};
				var v10 := DC43(|(seq(abs(0x30c), i0  => ('i')))|, f15, f15);
				v5[safeIndex(168, v5.Length)] := safeDivisionInt(if (f12 in v9) then v9[f12] else f14, v10.cf77);
				...
				var v14 := DC51(v13[safeIndex(0x2ac, |v13|)]);
				var v15: array<array<multiset<int>>> := new array<multiset<int>>[6] [v11, v11, if (f15 in v12) then v12[f15] else v11, v14.cf95, v11, v11];
				v15[safeIndex(374, v15.Length)] := v11;
				v15[safeIndex(374, v15.Length)] := v11;
				if (v4[safeIndex(|{f15, f15, f15}|, |v4|)]) {
					var v16: map<int, bool> := map[f14 := |v1| > f14];
					var v17: array<seq<D5>> := new seq<D5>[25](i2 => [DC17({f13}), DC17({f13})]);
					var v18: set<string> := {f16, f13};
					var v19 := DC17(v18);
					var v20: seq<D5> := [v19];
					v17[safeIndex(257, v17.Length)] := v20;
					globalState.f6, v16, v5[safeIndex(168, v5.Length)], v17[safeIndex(257, v17.Length)] := safeModuloInt(|v0|, v5[safeIndex(168, v5.Length)]) - f12, map[safeModuloInt(f11, f14) := !f15], f11, [v19];
					...
					var v23: map<int, set<bool>> := map[|v9[f12 := abs(f12)]| := v22];
					var v24: map<bool, set<bool>> := map[v5[safeIndex(168, v5.Length)] <= |v1| := if (f12 in v23) then v23[f12] else v22];
					v24 := v24[f15 := v22];
					var v25 := new C0();
					var v26 := 'o';
					var v27: map<char, bool> := map[v26 := f15];
					var v28: map<int, bool> := map[v5[safeIndex(168, v5.Length)] := f15];
					var v29: map<map<int, bool>, string> := map[v28 := ("lsvhdg")[safeIndex(v5[safeIndex(168, v5.Length)], |"lsvhdg"|) := v26]];
					var v30: array<int> := new int[16] [|(seq(abs(561), i3  => (v26)))|, v5[safeIndex(168, v5.Length)], -v5[safeIndex(168, v5.Length)], f14, f11, f11, |"i"|, |v1|, v5[safeIndex(168, v5.Length)], |v29|, v5[safeIndex(168, v5.Length)], f14, -f12, f14, f14, f14];
					var v32: C3 := new C3(f15, f16, seq(abs(0x36), i4  => (v26)), f12, f15, f13, |(map v31 : int | (-953 <= v31) && (v31 < 0x106) :: (v31 * |map[f15 := f15]|) := (f15))|, fm2(-0x33b, false, fm2(v5[safeIndex(168, v5.Length)], f15, |v4|, f15, globalState), f15, globalState));
					var v33: map<array<int>, C3> := map[v30 := v32];
					v0 := v0[if (if (v26 in v27) then v27[v26] else f15) then f11 else f11 := |v33|];
					globalState.f6 := safeModuloInt(v5[safeIndex(168, v5.Length)], f11);
					var v34: array<D5> := new D5[13];
					var v35: map<array<bool>, int> := map[p0 := f14];
					var v36 := DC18(v35, f11);
					v34[safeIndex(351, v34.Length)] := v36;
					var v37: map<bool, int> := map[!(v26 !in f16) := f11];
					var v38 := DC19(v37);
					v34[safeIndex(351, v34.Length)], v5[safeIndex(168, v5.Length)], v37 := v36, f11, v38.cf37;
				}
			...
			case DC30(cf48, cf49, cf50, cf51) =>
				...
				match (v3) {
					case DC48(cf90, cf91, cf92) =>
						...
						var v46: map<bool, seq<seq<bool>>> := map[false := seq(abs(-0x1aa), i5  => (v4))];
						var v47: array<seq<seq<bool>>> := new seq<seq<bool>>[22] [v45, (if (cf48 in v46) then v46[cf48] else v45) + v45, v45[safeIndex(f14, |v45|) := v4], v45 + v45, v45, v45, v45, fm58(|f13|, globalState), v45, [v4], v45, v45, v45 + [v4], seq(abs(774), i6  => (v4)), v45, (seq(abs(194), i7  => (v4))) + fm58(0x355, globalState), fm58(f11, globalState), v45, [[cf48], v4] + [v4, v4], (if (f15 in v46) then v46[f15] else [v4, v4]) + (seq(abs(0x3dc), i8  => (v4[safeIndex(f12, |v4|) := cf49]))), v45, v45];
						v47[safeIndex(954, v47.Length)] := [v4];
						v47[safeIndex(954, v47.Length)] := (v45 + v45) + [v4];
					case DC49(cf93) =>
						globalState.f2 := !f15;
						p0[safeIndex(493, p0.Length)] := if (f15) then cf49 else cf48;
						p0[safeIndex(493, p0.Length)] := cf48;
					...
					case DC50(cf94) =>
						var v49 := new C1(p0, f14, f11, f12, f15, seq(abs(0x1db), i9  => ('r')));
						v5 := v5;
						r0 := f14;
						var v50 := new C0();
					case DC47(cf89) =>
						var v51: array<string> := new string[11];
						v51[safeIndex(188, v51.Length)] := f16;
						v5[safeIndex(269, v5.Length)] := safeDivisionInt(f12, f12);
						var v52 := DC13(v1);
						var v53: seq<D4> := [v52];
						var v54 := 'w';
						var v55: map<char, bool> := map[v54 := f15];
						var v56: map<bool, bool> := map[if (v54 in v55) then v55[v54] else cf48 := cf48];
						globalState.f2, v51[safeIndex(188, v51.Length)], globalState.f6, v5[safeIndex(269, v5.Length)] := f11 != (-0x244 - |multiset{cf49, cf49}|), "ttxre", f12 * (if (cf51) then |fm3(f11, cf51, cf48, globalState)| else f14), |v53[safeIndex(|v56|, |v53|) := DC13(v1)]| - -|v1|;
						globalState.f2 := !f15;
						var v57: map<int, bool> := map[f14 := cf51];
						var v58: multiset<int> := multiset{f12};
						v57, globalState.f7, v4, cf49 := if (f15) then v57 + v57 else v57, if ((|(seq(abs(0x1b2), i10  => (v54)))| * v5[safeIndex(269, v5.Length)]) in v57) then v57[|(seq(abs(0x1b2), i10  => (v54)))| * v5[safeIndex(269, v5.Length)]] else v58 >= v58, (v4[safeIndex(f12, |v4|) := cf48] + [cf51, !cf51, cf48]) + v4, if (f13 <= f13) then fm0(cf48, globalState) < f14 else cf49;
						globalState.f6 := v5[safeIndex(269, v5.Length)];
				}
				
				globalState.f7 := !f15;
				v5[safeIndex(45, v5.Length)] := f11;
				v5[safeIndex(45, v5.Length)] := f12;
			case DC31(cf52, cf53, cf54, cf55) =>
				p0[safeIndex(149, p0.Length)] := true;
				p0[safeIndex(149, p0.Length)] := (v6 * multiset{f15}) <= v6;
				...
				if (if (fm2(|v4|, false, cf55, false, globalState) in v59) then v59[fm2(|v4|, false, cf55, false, globalState)] else f15) {
					v5[safeIndex(982, v5.Length)] := cf54 + f12;
					v5[safeIndex(982, v5.Length)] := f12;
					v5[safeIndex(982, v5.Length)] := cf54 * -f12;
					var v60: set<bool> := {p0[safeIndex(149, p0.Length)]};
					var v61, v62 := m0(multiset{p0[safeIndex(149, p0.Length)]} !! multiset{f15}, v60 !! v60, cf55, 0x232, globalState);
					var v63 := DC5(cf52, f15, p0[safeIndex(149, p0.Length)]);
					var v64: map<bool, bool> := map[f15 := !p0[safeIndex(149, p0.Length)]];
					var v65: array<bool> := new bool[27] [f15, p0[safeIndex(149, p0.Length)], v61, p0[safeIndex(149, p0.Length)], p0[safeIndex(149, p0.Length)], f15, true, p0[safeIndex(149, p0.Length)], f15, if (f14 in v59) then v59[f14] else p0[safeIndex(149, p0.Length)], !v61, v61, v61, p0[safeIndex(149, p0.Length)], v61, v63.cf8, true, v61, !v61, true, p0[safeIndex(149, p0.Length)], f15, p0[safeIndex(149, p0.Length)], p0[safeIndex(149, p0.Length)], if ((if (f15 in v64) then v64[f15] else true) in v64) then v64[if (f15 in v64) then v64[f15] else true] else v61, f15, v61];
					var v66: map<bool, array<bool>> := map[f15 := v65];
					p0[safeIndex(149, p0.Length)] := (v66 + v66) != v66[p0[safeIndex(149, p0.Length)] := v65];
					r0 := 634;
				} else {
					globalState.f6 := cf52;
					var v67 := new C0();
					v5[safeIndex(851, v5.Length)] := cf55;
					v5[safeIndex(851, v5.Length)], v4 := f11, v4;
					var v68 := new C0();
					p0[safeIndex(149, p0.Length)] := f15;
				}
				
				var v69: seq<map<int, int>> := [v0[cf54 := 0x32b]];
				var v70: set<map<int, int>> := {v69[safeIndex(0x2e7, |v69|)], v0};
				globalState.f6, globalState.f2, v70, cf52, globalState.f2 := 979, !(!p0[safeIndex(149, p0.Length)] <==> p0[safeIndex(149, p0.Length)]) ==> f15, v70, safeDivisionInt(cf55, cf52), f15;
				cf53 := 'v';
			case DC28(cf47) =>
				v5[safeIndex(979, v5.Length)] := f11;
				v5[safeIndex(979, v5.Length)] := f11 - -0x94;
				...
				v74 := v74[p0 := v5[safeIndex(979, v5.Length)] > -|v77|];
				var v78: multiset<set<int>> := multiset{{f12, 580, f11}};
				var v79: map<bool, seq<bool>> := map[v4[safeIndex(v5[safeIndex(979, v5.Length)], |v4|)] := v4];
				var v80 := 'y';
				var v81: set<int> := {f11};
				var v82: seq<map<int, seq<bool>>> := [cf47];
				f16, v5[safeIndex(979, v5.Length)], v78 := (seq(abs(0x144), i11  => ('d')))[safeIndex(safeDivisionInt(f14, |(if (false in v79) then v79[false] else [f15, v75.f25])|), |(seq(abs(0x144), i11  => ('d')))|) := v80], v5[safeIndex(979, v5.Length)] * |f16|, (v78 - multiset{v81})[v81 := abs(|v82[safeIndex(f14, |v82|)]|)];
			case DC32(cf56) =>
				v5 := v5;
				...
				v83[safeIndex(974, v83.Length)] := (if (!f15 in v86) then v86[!f15] else v87) + v87;
				v83[safeIndex(974, v83.Length)] := v87;
				var v88 := 'e';
				var v89: map<seq<int>, seq<char>> := map[v1 := f16[safeIndex(f11, |f16|) := v88]];
				var v90: set<bool> := {v4[safeIndex(-|v4|, |v4|)], f15};
	...
	method m2(p0: array<bool>, p1: multiset<int>, globalState: GlobalState) returns (r0: bool, r1: multiset<int>) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v3 := new C3(f12 == |v1|, f16, (seq(abs(-0x19f), i1  => ('j'))) + f16, f11, false, f13, f12, 0x357);
			var v4 := DC52(v3.f25, v3.f25, v3.f26);
			var v5: seq<bool> := [v3.f25, v3.f25, v4.cf96, f15];
			globalState.f7 := v5[safeIndex(f12, |v5|)];
			...
			if (v3.f25) {
				...
				var v12 := DC21(f15);
				v12 := v12.(cf40 := f15);
				p0[safeIndex(15, p0.Length)] := v5[safeIndex(f11, |v5|)] ==> v3.f25;
				p0[safeIndex(15, p0.Length)] := !(f14 > f12) || v3.f25;
				globalState.f6 := f11 * f14;
			} else {
				var v13: set<array<bool>> := {p0, if (f15) then p0 else p0, p0, p0, p0};
				v13 := {p0} * (v13 * {p0});
				p0[safeIndex(392, p0.Length)] := f15;
				var v14: map<bool, bool> := map[v3.f25 := f15];
				var v15: set<int> := {|v14|};
				var v16: seq<int> := [f11, |v15|, f12, 0x1ed];
				var v17: map<string, int> := map[seq(abs(0x231), i3  => ('m')) := |(v16 + v16)|];
				globalState.f7, p0[safeIndex(392, p0.Length)], v17 := false, !!(p1 >= p1), v17;
				var v18: array<seq<bool>> := new seq<bool>[22] [fm30(true, v3.f25, f11, !f15, globalState), [p0[safeIndex(392, p0.Length)]] + v5, v5 + v5, v5, v5, v5 + v5, v5, [!false, f15], v5, [p0[safeIndex(392, p0.Length)]], v5, v5, v5, v5[safeIndex(f14, |v5|) := !f15], v5, v5, v5, v5, v5, v5, [v3.f25] + v5, v5];
				v18[safeIndex(60, v18.Length)] := v5;
				v18[safeIndex(60, v18.Length)], globalState.f7 := [v3.f25], p0[safeIndex(392, p0.Length)];
				v14 := v14[if (true) then !p0[safeIndex(392, p0.Length)] else !p0[safeIndex(392, p0.Length)] := false];
				var v19: multiset<bool> := multiset{f15, p0[safeIndex(392, p0.Length)]};
				v19 := v19 * multiset(v18[safeIndex(60, v18.Length)]);
			}
		...
		var v22 := 'u';
		var v23 := DC40(v20);
		v21 := v21[(f16 + f13)[safeIndex(|v1|, |(f16 + f13)|) := v22] := v23];
		var v24: array<D0> := new D0[5];
		forall i4 | 0 <= i4 < v24.Length {
			v24[i4] := DC0(multiset{v22} - multiset((seq(abs(123), i5  => (v22)))[safeIndex(-f12, |(seq(abs(123), i5  => (v22)))|) := v22]));
		}
			...
			decreases 100 - i7
		{
			...
			if (false) {
				...
				v20 := v20;
				globalState.f6 := safeDivisionInt(f11, f14);
				...
				var v42: T0 := new C1(p0, f12, f14, f14, v37.f25, seq(abs(0x71), i8  => (v22)));
			...
			v44 := v44;
			p0[safeIndex(585, p0.Length)] := f15;
			p0[safeIndex(585, p0.Length)] := fm24(347, f15, globalState);
			globalState.f7, p0[safeIndex(585, p0.Length)] := p0[safeIndex(585, p0.Length)], p0[safeIndex(585, p0.Length)];
		}
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		if (p2) {
			...
			v0.f27 := safeModuloInt(|v2[safeIndex(-p1, |v2|) := v1]|, f14);
			var v3 := 'm';
			var v4: set<char> := {v3};
			var v5: seq<int> := [p1, f11, f12, |v4|];
			r0 := v5[safeIndex(p3, |v5|)] > (if (false) then v0.f27 else f12);
			globalState.f7 := p2;
			globalState.f2 := !p2;
		} else {
			var v6: seq<bool> := [f15];
			...
			globalState.f7 := v6[safeIndex(f14, |v6|)];
		...
		if (true) {
			...
			v20[safeIndex(939, v20.Length)] := v11;
			v20[safeIndex(939, v20.Length)] := v14.f24;
			var v21 := 'x';
			var v22: map<char, bool> := map[v21 := f15];
			r0 := (map[v21 := p2] + v22) != v22;
		} else {
			var v23: map<string, int> := map[p0 + f16 := -safeDivisionInt(p1, f14)];
			v23 := v23;
			var v24: set<int> := {f14};
			globalState.f7 := fm24(f14, 310 !in v24, globalState);
			if (p1 < |f16|) {
				var v25: array<int> := new int[10];
				v25[safeIndex(532, v25.Length)] := f11;
				v25[safeIndex(532, v25.Length)] := fm0(p2, globalState);
				var v26: array<bool> := new bool[18];
				v26[safeIndex(40, v26.Length)] := true;
				v26[safeIndex(40, v26.Length)] := p2;
				var v27: C2 := new C2(f12, f16, p3, v25[safeIndex(532, v25.Length)]);
				var v28: multiset<C2> := multiset{v27, v27, v27, v27};
				var v29: seq<map<int, int>> := [map[p3 := |(seq(abs(0x1ae), i0  => ('w')))|]];
				var v30 := DC8(f15, !false, f16);
				var v31 := DC0(multiset{'u'});
				var v32: set<D0> := {v31, v31};
				globalState.f7, r1, globalState.f6, v26[safeIndex(40, v26.Length)] := f15, f11 * (if (p2) then |map[f12 := f15]| else DC11(if (v27 in v28) then v28[v27] else |v29|, v30, v32, f15).cf24), f11, f15;
				var v33: seq<string> := [f16];
				var v34: map<int, int> := map[v27.f27 := f12];
				f16 := v33[safeIndex(|(if (p2) then v34 else map[-0xea := v27.f27])|, |v33|)];
				r0 := !fm24(v27.f27, v26[safeIndex(40, v26.Length)], globalState);
			} else {
				var v35: seq<bool> := [p2];
				...
				v46[safeIndex(481, v46.Length)] := if (f12 in v48) then v48[f12] else v44;
				v46[safeIndex(481, v46.Length)] := (map[fm0(f15, globalState) := -p3] + v44) + (if (p2) then v44 else v44);
		...
		var v51: seq<bool> := [false, fm1(|(seq(abs(0x63), i2  => ({p3})))|, false, p2, globalState)];
		v51 := v51;
		var v52 := 'p';
		v52 := v52;
			...
			decreases 100 - i3
		{
			...
			var v58 := DC0(v57);
			r1, f16, globalState.f7, globalState.f6 := safeModuloInt(f14, f11), f16 + f16, v52 !in fm31(v52, v58, globalState), f12;
			...
			v60[safeIndex(937, v60.Length)] := v59;
			v60[safeIndex(937, v60.Length)] := v59;
			if (v59.fm1(f14, f15, false, globalState) <==> true) {
				...
				var v62: map<bool, int> := map[v51[safeIndex(|v61|, |v51|)] := p1];
				var v63: multiset<int> := multiset{if (v59.f25 in v62) then v62[v59.f25] else fm0(v59.f25, globalState), f14};
				globalState.f7 := v51[safeIndex(|(fm33(globalState) + v63)|, |v51|)];
				...
				var v70: array<int> := new int[11] [p3, f14, |[v59.f25, v66.cf49]|, 617, |v67|, safeModuloInt(f14, p1), if (v59.f25) then p3 else fm0(f15, globalState), v69[safeIndex(696, |v69|)], fm0(v59.f25, globalState), safeModuloInt(f12, p3), safeDivisionInt(-f14, f11)];
				v70[safeIndex(774, v70.Length)] := f11 + p1;
				v70[safeIndex(774, v70.Length)] := (if (!v59.f25) then f14 else p3) + 280;
				var v71: set<int> := {|"udycj"|};
				v54[safeIndex(101, v54.Length)] := v71 >= (set v72 : int | v72 in v68 :: (safeDivisionInt(v72, |[true, false]|)));
				v54[safeIndex(101, v54.Length)] := v59.f25;
				v70[safeIndex(774, v70.Length)] := 0x31e;
				globalState.f6 := f11;
				...
				r1 := safeModuloInt(0x286, p1) * |(v76 + v76)|;
			}
			...
			decreases 100 - i6
		{
			...
			v81 := v81[v77 := v80 + v80];
			v78, globalState.f2, f16 := v78, safeModuloInt(f11, p1) >= f14, p0 + fm44(p3, p2, globalState);
	...
	method m15(p0: string, p1: int, p2: D5, p3: bool, globalState: GlobalState) {
		...
		if (f15) {
			...
			var v4: map<bool, seq<bool>> := map[p3 := v3[safeIndex(f12, |v3|)]];
			f16 := v1[safeIndex(-(if (p3) then |v4[p3 := [f15]]| else f12), |v1|)];
			...
			var v12 := DC44(v11);
			var v13: map<D16, seq<int>> := map[v12 := seq(abs(308), i3  => (f12))];
			var v14 := DC56(v0, v2[safeIndex(f14, |v2|)], |(if (-0x1c in v8) then v8[-0x1c] else if (v12 in v13) then v13[v12] else v7)|, [v9[f15 := p3]]);
			match (v14) {
				case DC56(cf105, cf106, cf107, cf108) =>
					...
					cf105[safeIndex(855, cf105.Length)] := safeDivisionInt(|p0|, |v19|);
					cf105[safeIndex(855, cf105.Length)] := v11.f11 + f11;
					var v20: map<bool, int> := map[if (v11.f12 in v19) then v19[v11.f12] else cf106 := f11];
					var v21: map<seq<int>, map<bool, int>> := map[seq(abs(0x102), i4  => (v11.f11)) := if (p3) then v20 else v20[!v16.f25 := p1]];
					v21 := v21;
				case DC55(cf104) =>
					var v22: map<seq<bool>, bool> := map[v3[safeIndex(f11, |v3|)] := false];
					v22 := v22[v2 + [fm24(v11.f12, !f15, globalState)] := f15];
					var v23: multiset<bool> := multiset{f15};
					var v24: map<bool, int> := map[p3 := 622 + |v23|];
					v24 := v24[v11.f12 != 0x21f := -safeModuloInt(|v6|, v11.f11)];
			...
			var v28: seq<bool> := [p3];
			var v29: multiset<set<int>> := multiset{v26 * v26, v27[safeIndex(|v28|, |v27|)], fm29(globalState)};
			var v30: seq<multiset<set<int>>> := [v29];
			var v31: seq<int> := [p1];
			var v32: C2 := new C2(0xa7, "ehkwmbwj", |v31|, -0x111);
			var v33 := DC53(f14, v26, f11, v32);
			v29 := v29 * (v30[safeIndex(|v33.cf100|, |v30|)] * v29);
			var v34: set<bool> := {p3};
			var v35: array<seq<int>> := new seq<int>[14](i5 => seq(abs(0x86), i6  => (f11)));
			var v36 := v32.m20(p3, v34, v35, !p3, globalState);
			v32.f27 := safeModuloInt(f12 * |"pdjyeq"|, v36);
			var v37: array<string> := new string[29];
			v37[safeIndex(36, v37.Length)] := "xmgyjqauo";
			var v38: map<bool, string> := map[f15 := "jwhmi" + f13];
			var v39 := 'o';
			v37[safeIndex(36, v37.Length)] := if (f15 in v38) then v38[f15] else (seq(abs(0x3a8), i7  => ('k')))[safeIndex(f12, |(seq(abs(0x3a8), i7  => ('k')))|) := v39];
			v31 := v31 + (v31 + v31);
		}
		...
		if (p3) {
			var v42 := 'u';
			var v43: map<bool, int> := map[f15 := |{p0, ("dcvpfgnfj")[safeIndex(f14, |"dcvpfgnfj"|) := v42], f16, "oewnblx", "yitlhryc"}|];
			var v44 := DC19(v43);
			match (v44) {
				case DC20(cf38, cf39) =>
					...
					var v48: array<bool> := new bool[24] [p3 ==> p3, p3, f15 <== f15, true, p3 <== p3, true, !!(if (p3) then true else f15), if (p3) then f15 else f15, f15, true, p3, f15, {p3} > v45, |(seq(abs(403), i8  => (f14)))| > (if (v42 in v46) then v46[v42] else f12), if (f15) then f15 else p3, if (!p3) then f15 else f15, f12 >= cf39, f15, f15, p3, p3, f15, f15, multiset{cf39} != v47];
					v48[safeIndex(196, v48.Length)] := if (f15) then p3 else !true;
					v48[safeIndex(196, v48.Length)] := f15;
					globalState.f6 := f12;
				...
				case DC21(cf40) =>
					...
					v53[safeIndex(680, v53.Length)] := v52;
					v53[safeIndex(680, v53.Length)] := v52;
				...
				case DC19(cf37) =>
					...
					var v63: set<bool> := {!p3};
					v62, globalState.f6 := v62, safeDivisionInt(-|v63|, f12);
					var v64: seq<bool> := [p3];
					var v65: multiset<bool> := multiset{v64[safeIndex(f12, |v64|)], !f15, p3, p3};
					var v66: array<string> := new string[20];
					v66[safeIndex(807, v66.Length)] := f13;
					var v67: seq<string> := [f13];
					globalState.f7, globalState.f6, v65, v66[safeIndex(807, v66.Length)], globalState.f6 := p3, fm2(safeDivisionInt(p1, -p1), fm1(-|v64|, p3, p3, globalState), f11, f15, globalState), v65, if (if (f15) then f15 else p3) then v67[safeIndex(f14, |v67|)] else f16, p1;
					v40 := [f14, f11, safeDivisionInt(f11, f12)];
					globalState.f2 := p3;
				case DC22(cf41) =>
					v0 := v0;
					...
					v69[safeIndex(263, v69.Length)] := map v70 : int | v70 in v71 :: (v70 - |map[f15 := v40]|) := (seq(abs(-0x13), i10  => (v42)));
					var v72 := DC15(f14);
					...
					var v79 := DC2(v42);
					v69[safeIndex(263, v69.Length)] := if (safeModuloInt(DC7(v76, v78, v79, |"os"|, p1).cf13, p1) in v75) then v75[safeModuloInt(DC7(v76, v78, v79, |"os"|, p1).cf13, p1)] else v74;
			...
			match (v44) {
				case DC20(cf38, cf39) =>
					...
					globalState.f6 := safeModuloInt(|v86|, if (p3 in v87) then v87[p3] else cf39);
					cf38 := fm0(f15, globalState);
					var v88: array<char> := new char[17];
					v88[safeIndex(330, v88.Length)] := 'h';
					v88[safeIndex(330, v88.Length)] := v42;
					var v89: array<bool> := new bool[24](i12 => p3);
					var v90 := new C1(v89, f14, --f14 + cf38, -cf38, p1 in (seq(abs(0x28a), i13  => (|{671}|))), if (p3) then f13 else f13);
				case DC21(cf40) =>
					v83 := v83;
					...
					var v93: array<array<D0>> := new array<D0>[9] [v91, v92[safeIndex(f11, |v92|)], v91, v91, v91, v91, v91, if (f15) then v91 else v91, v91];
					v93 := v93;
				case DC19(cf37) =>
					v42 := v42;
					globalState.f7 := p3;
				...
				case DC22(cf41) =>
					globalState.f7 := ((seq(abs(803), i15  => (v42))) + p0) < (if (p3) then "tiwiwo" else f13);
					globalState.f6 := f12;
					var v98: map<int, char> := map[fm0(f15, globalState) := 'n'];
					var v99 := DC36(p1, p1, -f14);
					globalState.f6 := safeDivisionInt(|v98[917 := v42]| + 0x314, v99.cf64);
					v0[safeIndex(511, v0.Length)] := fm0(p3, globalState);
					v0[safeIndex(511, v0.Length)] := f12;
			}
			...
			if (f15 ==> (p1 > p1)) {
				...
				var v108, v109, v110, v111 := m16(if (p3) then v0 else v0, !((seq(abs(0x2e7), i17  => ('i'))) < f13), p0, multiset{p3, fm1(f11, f15, !!f15, globalState), v106}, globalState);
				var v112 := 'g';
				var v113: map<bool, char> := map[f12 == f11 := v112];
				v113 := v113[v110 := v112];
				globalState.f7 := v106;
				var v114: multiset<bool> := multiset{v110};
				var v115 := DC50(v114[v110 := abs(0x66)]);
				v115 := v115;
			} else {
				...
				var v119 := DC39(v118);
				v119 := v119;
				globalState.f6 := safeDivisionInt(f14, fm0(p3, globalState));
				var v120 := 'u';
				var v121: map<int, char> := map[f14 := v120];
				var v122: set<int> := {|p0|};
				v121 := v121[|((seq(abs(578), i18  => (f12)))[safeIndex(-0xf7, |(seq(abs(578), i18  => (f12)))|) := |v122|] + (seq(abs(0x151), i19  => (f12))))| := 'u'];
			...
			v130[safeIndex(483, v130.Length)] := p3;
			v0[safeIndex(156, v0.Length)] := f12 - 171;
			var v131: set<int> := {0x9d};
			var v132: seq<bool> := [f15];
			var v133: map<int, string> := map[f14 := f13];
			v130[safeIndex(483, v130.Length)], v0[safeIndex(156, v0.Length)], globalState.f2, globalState.f7 := v131 > {p1}, -((p1 + 0x13f) * -f14), v132[safeIndex(f14, |v132|) := f15] <= v132, p0 <= ((if (f12 in v133) then v133[f12] else f13) + f16);
			var v134: array<char> := new char[13];
			v134 := if (v0[safeIndex(156, v0.Length)] != v40[safeIndex(f12, |v40|)]) then v134 else v134;
			var v135: map<seq<bool>, bool> := map[fm30(p3, f15, p1, v130[safeIndex(483, v130.Length)], globalState) := p1 != fm0(!p3, globalState)];
			v135 := v135;
			var v136: array<map<bool, int>> := new map<bool, int>[1];
			var v137: map<bool, int> := map[!f15 := f12];
			v136[safeIndex(854, v136.Length)] := v137 + v137;
			v136[safeIndex(854, v136.Length)] := v137[f15 := f11] + (v137 + v137);
		}
		...
		if (f15) {
			...
			v149[safeIndex(34, v149.Length)] := f15;
			var v150 := DC6(f13);
			var v151: seq<array<bool>> := [v149, v149, v149, v149];
			v149[safeIndex(34, v149.Length)], v150, v151 := |(f13 + f13)| in v148, v150, [v149, v149, v149, v149];
			globalState.f6 := f12;
			globalState.f6 := fm0(v149[safeIndex(34, v149.Length)], globalState);
			var v152: multiset<bool> := multiset{f15};
			var v153: C3 := new C3(p3, seq(abs(791), i20  => (v141)), p0, f11, v149[safeIndex(34, v149.Length)], p0, f14, |v152|);
			var v154: map<array<int>, D1> := map[v0 := v41];
			v149[safeIndex(34, v149.Length)], globalState.f2, globalState.f2, v153, v149[safeIndex(34, v149.Length)] := |v154| == f11, f14 <= (0x6f - f12), p3, v153, v149[safeIndex(34, v149.Length)];
			v0[safeIndex(23, v0.Length)] := f14;
			...
			v0[safeIndex(23, v0.Length)] := if ((if (f13 in v157) then v157[f13] else v155) in v156) then v156[if (f13 in v157) then v157[f13] else v155] else p1;
		} else {
			var v158: map<int, bool> := map[f11 := p3];
			globalState.f6 := safeDivisionInt(p1, |map[0x386 := |v158|]|);
			globalState.f2, globalState.f2, globalState.f2, globalState.f7 := !f15, false, p3, p3;
			var v159: seq<string> := [f16];
			v0[safeIndex(665, v0.Length)] := |v159|;
			var v160 := 'g';
			var v161: map<array<int>, char> := map[v0 := v160];
			v0[safeIndex(665, v0.Length)] := |v161|;
			...
			f16, v0[safeIndex(665, v0.Length)], v163, v164, v0[safeIndex(665, v0.Length)] := f16[safeIndex(|(if (!p3) then v158 else v158)|, |f16|) := if (p3) then v160 else v160], safeModuloInt(safeDivisionInt(v40[safeIndex(-0x2cf, |v40|)], p1), v0[safeIndex(665, v0.Length)]), v163 + v163, if (v165 in v166) then v166[v165] else v164, 611;
			var v167 := new C2(0x1e7, seq(abs(0x238), i21  => (v160)), p1, p1 - p1);
		}
	...
	method m16(p0: array<int>, p1: bool, p2: seq<char>, p3: multiset<bool>, globalState: GlobalState) returns (r0: set<bool>, r1: int, r2: bool, r3: int) {
		...
		match (v1) {
			...
			case DC55(cf104) =>
				if (!(if (fm2(0x16e, f15, 0x2ee, false, globalState) > 0x78) then p1 else f15)) {
					...
					globalState.f7 := p1;
					var v9 := 'u';
					var v10: seq<bool> := [false, f15, f13 < ("sbhdeamr")[safeIndex(f11, |"sbhdeamr"|) := v9]];
					v10 := [true, p1, p1];
					var v11: array<int> := new int[4](i0 => i0 - -f14);
					v11 := p0;
					var v13: array<multiset<int>> := new multiset<int>[25](i1 => multiset([|f13|, |(set v12 : int | (-0x70 <= v12) && (v12 < 0x369) :: (v12 + f11))|, f11, f11, f14] + (seq(abs(-0x151), i2  => (if (f11 in v8) then v8[f11] else f14)))));
					var v14: map<bool, int> := map[!p1 := f14];
					var v15: multiset<int> := multiset{865, if (true in v14) then v14[true] else f11, |p2|};
					v13[safeIndex(675, v13.Length)] := v15;
					var v16: map<bool, bool> := map[f15 := f15];
					v13[safeIndex(675, v13.Length)], globalState.f6, globalState.f6 := v15, fm2(safeDivisionInt(f11, f12), if (p1 in v16) then v16[p1] else p1, f14 + f12, false, globalState), f14;
				} else {
				...
				var v20 := 'l';
				var v21: multiset<string> := multiset{p2, v19[safeIndex(|multiset{f12}|, |v19|)] + f13, if (p1) then f13 else f13, fm31(v20, DC0(fm62(p1, globalState)), globalState), "xmr"};
				var v22: array<seq<bool>> := new seq<bool>[28];
				v22[safeIndex(361, v22.Length)] := v18;
				var v23: map<bool, bool> := map[p1 := f15];
				var v24: map<int, bool> := map[|v23| := f15 || p1];
				v21, v22[safeIndex(361, v22.Length)], globalState.f7, r2 := v21, v18, !!(fm39(globalState)).cf16, if (f12 in v24) then v24[f12] else fm1(f14, !p1, f15, globalState);
		}
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v25 := 'r';
			var v26: set<string> := {(f13 + "whv")[safeIndex(f12, |(f13 + "whv")|) := v25], if (p1) then p2 else f16, if (f15) then f13 else f16};
			var v27: map<int, set<string>> := map[-f11 := v26];
			v26 := if ((|p2| + f12) in v27) then v27[|p2| + f12] else v26;
			var v28: seq<int> := [f14, f14];
			var v29: set<int> := {v28[safeIndex(f11, |v28|)], f12, f14};
			var v30: map<string, bool> := map[p2 := v29 == v29];
			v30 := v30 + v30;
			v0[safeIndex(55, v0.Length)] := f16 <= (DC52(f15, p1, f13).(cf96 := false, cf97 := p1)).cf98;
			v0[safeIndex(55, v0.Length)] := fm24(-safeModuloInt(f11, f12), true, globalState);
			var v31: set<bool> := {f15};
			var v32: seq<bool> := [true];
			var v33: multiset<int> := multiset{|multiset([f14, |v31|, |v32|, f12])|, f12, f11, f12, f14};
			var v34: map<bool, int> := map[(multiset(v28))[f11 := abs(f14)] > v33 := f11];
			v34 := v34[p1 := f11];
		}
		for i5 := f12 - 0x1b3 to f12 {
			...
			f16 := (seq(abs(312), i6  => ('x'))) + p2;
		}
		var v37: set<int> := {fm0(p1, globalState)};
		if (v37 !! (v37 + {f12, f12, |([p0])[safeIndex(f11, |[p0]|) := p0]|})) {
			if (v37 >= v37) {
				var v38: seq<int> := [f11, f12, |((seq(abs(0x219), i7  => ('q'))) + f13)|, safeModuloInt(f12, f11), f11];
				globalState.f6 := v38[safeIndex(f14, |v38|)];
				var v39 := 'p';
				...
				v42[safeIndex(913, v42.Length)] := v43;
				v42[safeIndex(913, v42.Length)] := v43;
				var v44: set<bool> := {p1};
				...
				v46[safeIndex(621, v46.Length)] := v47;
				var v48: seq<seq<int>> := [v47 + v47, v47];
				v0, globalState.f6, globalState.f6, v46[safeIndex(621, v46.Length)], globalState.f6 := v0, f11, |v48[safeIndex(-f11, |v48|)]|, v47, 0x3b1;
				v0 := v0;
			...
			v55[safeIndex(890, v55.Length)] := v0;
			v55[safeIndex(890, v55.Length)] := v0;
			globalState.f7 := p1;
			var v56: seq<bool> := [p1, !p1];
			var v57: seq<bool> := [p1, v56[safeIndex(f14, |v56|)]];
			var v58 := DC40(v57);
			if ((f11 + f14) != -safeModuloInt(-f12, -|v58.cf72|)) {
				var v59: multiset<string> := multiset{p2};
				var v60 := DC57(v59);
				r2 := v60.cf109 !! v59;
				globalState.f2 := p1;
				globalState.f6 := f11 * (f14 + f12);
				p0[safeIndex(449, p0.Length)] := f11;
				p0[safeIndex(449, p0.Length)] := f12;
				v55 := v55;
			} else {
				...
				var v66 := DC23(v65[safeIndex(f14, |v65|)]);
				v64[safeIndex(749, v64.Length)] := v66;
				v64[safeIndex(749, v64.Length)] := v66;
				globalState.f6 := |p2|;
				var v67: array<array<multiset<bool>>> := new array<multiset<bool>>[21];
				var v68 := DC30(p1, p1, f13, p1);
				var v69 := DC58(v68.cf51);
				var v70: array<multiset<bool>> := new multiset<bool>[5] [p3[f15 := abs(f14)], p3, multiset{true, v69.cf110}, p3, multiset{p1, f15}];
				v67[safeIndex(502, v67.Length)] := v70;
				v67[safeIndex(502, v67.Length)] := v70;
			}
			...
			globalState.f6 := f12;
			var v71 := 'h';
			var v72: multiset<char> := multiset{f16[safeIndex(f14, |f16|)], v71};
			v72 := multiset(f16 + [v71]);
			var v73: array<map<bool, bool>> := new map<bool, bool>[28];
			var v74: map<array<map<bool, bool>>, int> := map[v73 := |"qjxwipci"|];
			v74 := v74[v73 := f12];
			var v75 := DC21(f15);
			v0[safeIndex(649, v0.Length)] := v75.cf40;
			var v77: seq<int> := [f12];
			var v78: seq<int> := [|v77|];
			var v79: map<seq<int>, int> := map[v78 := f12];
			v0[safeIndex(649, v0.Length)] := |(map v76 : seq<int> | v76 in v79 :: (v76) := (if (false in p3) then p3[false] else 45))| == f14;
			globalState.f6 := safeDivisionInt(|f16|, |"uxurtcjh"|);
		}
		
		var v80: array<array<int>> := new array<int>[18];
		v80[safeIndex(318, v80.Length)] := p0;
		v80[safeIndex(318, v80.Length)] := new int[21];
		var v81: set<bool> := {p1};
		var v82 := DC35(v81);
		r0 := v82.cf63;
		r1 := (fm63("vei", p1, 296, globalState)).cf93;
		r2 := fm24(safeDivisionInt(f12, f14), f14 >= f12, globalState);
...
class C5 {
	...
	method m10(p0: int, p1: int, p2: bool, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (fm13(p0, v0, v0, globalState)) {
			...
			var v6: array<char> := new char[17] [v0, if (p2) then v0 else 'b', if (true) then v0 else v0, v0, v2.cf3, if (p1 in v3) then v3[p1] else v0, v0, v0, v1[safeIndex(|v4|, |v1|)], v0, v0, fm14(p2, v0, p1, p2, globalState), fm14(p2, v0, p0, p2, globalState), v0, v0, if (p2 in v5) then v5[p2] else v0, v0];
			v6[safeIndex(29, v6.Length)] := v0;
			...
			var v9: set<bool> := {p2};
			v7[safeIndex(667, v7.Length)] := map[("yg")[safeIndex(|v8|, |"yg"|) := v0] := v9];
			var v10 := DC1(p2, p0);
			v6[safeIndex(29, v6.Length)], v7[safeIndex(667, v7.Length)] := v0, fm15(p0, v10.cf2, globalState);
			globalState.f2 := !(p1 > p0);
			var v11: set<char> := {v0, v6[safeIndex(29, v6.Length)]};
			var v12: array<int> := new int[23];
			var v13: map<bool, array<int>> := map[v11 <= {v0, v0, v6[safeIndex(29, v6.Length)]} := v12];
			...
			if (p2) {
				...
				v1 := v1;
				globalState.f2 := p2;
				var v20 := DC0(multiset{v6[safeIndex(29, v6.Length)]});
			...
			var v28: array<int> := new int[15] [|(map[p1 := p2] + map[|v25| := p2])|, |v1| + p0, p0, safeModuloInt(p1, p0), -fm0(p2, globalState), -|v26|, safeDivisionInt(-p1, fm0(p2, globalState)), -|(map[p2 := |v27|] + map[false := p1])|, p1, p1, p0, |v1|, p1, p0, safeDivisionInt(p1, 197)];
			v28[safeIndex(547, v28.Length)] := p1;
			v28[safeIndex(547, v28.Length)] := p0;
			var v29: seq<int> := [safeDivisionInt(225, -413)];
			var v30: set<int> := {safeDivisionInt(0x12c, -p1)};
			var v31 := DC2(v1[safeIndex(p0, |v1|)]);
			v28[safeIndex(547, v28.Length)], r1, v28[safeIndex(547, v28.Length)], v29 := |v30|, fm13(p0 - p1, v31.cf3, v0, globalState), -v28[safeIndex(547, v28.Length)], DC13(v29).cf29;
			v1 := fm18(p2 <== p2, v28[safeIndex(547, v28.Length)], globalState);
		}
		
		if (p2) {
			var v32: array<bool> := new bool[19];
			v32[safeIndex(363, v32.Length)] := fm13(-p1, v1[safeIndex(91, |v1|)], 's', globalState);
			var v33: set<string> := {v1};
			var v34 := DC17(v33);
			v32[safeIndex(363, v32.Length)] := v34.cf34 != (v33 + v33);
			var v35: T2 := new C1(v32, p0, p0, p0, v32[safeIndex(363, v32.Length)], v1);
			...
			if (p1 != -0x364) {
				...
				globalState.f7 := if (map[p0 := v32[safeIndex(363, v32.Length)]] in v50) then v50[map[p0 := v32[safeIndex(363, v32.Length)]]] else v43;
				...
				v32[safeIndex(363, v32.Length)] := v52 >= v52;
				var v53: seq<bool> := [v32[safeIndex(363, v32.Length)]];
				v32[safeIndex(363, v32.Length)] := (v53[safeIndex(v35.f12, |v53|)] <==> false) <==> !v35.f15;
				v32[safeIndex(363, v32.Length)] := v35.f15;
				globalState.f2 := v32[safeIndex(363, v32.Length)];
				v32 := v32;
			}
			...
			if (p2) {
				...
				v0 := v0;
				var v56: seq<bool> := [v32[safeIndex(363, v32.Length)]];
				globalState.f6 := if (v35.f13 == v35.f13) then -(if (p2) then v35.f11 else |(set v55 : int | (0x3cb <= v55) && (v55 < 0x2ad) :: (v55 + v35.f11))|) else safeModuloInt(v35.fm2(v35.f11, v32[safeIndex(363, v32.Length)], |v56|, v32[safeIndex(363, v32.Length)], globalState), v35.f11);
				v32 := if (v32[safeIndex(363, v32.Length)]) then v32 else v32;
			} else {
				var v57: array<string> := new string[2] [v35.f13, v35.f13];
				v57[safeIndex(952, v57.Length)] := seq(abs(0x7f), i2  => (v0));
				v57[safeIndex(952, v57.Length)] := v1[safeIndex(v35.f12, |v1|) := v0];
				var v58: set<bool> := {v35.f15};
				var v59: array<int> := new int[28] [p1, 0x2e8, 0x94, p0, v35.f11, p1, v35.f14, 0x33c, v35.fm2(|v1|, p2, v35.f14, v35.f15, globalState), p0, p1, p0, |("vahvy")[safeIndex(fm0(v35.f15, globalState), |"vahvy"|) := v0]|, v35.f12, p0, v35.f12, v35.f12, v35.f14, v35.f12, p1, v35.f12, p1, v35.f14, fm0(p2, globalState), 0x362, v35.f11, 0x16d, |v58|];
				...
				var v63 := DC10(p2, p0, v62, seq(abs(0x63), i3  => (v0)), p0);
			...
			if (v1 == v1) {
				...
				var v68: seq<int> := [safeDivisionInt(-p1, p0), |(v67 * v67)|];
				globalState.f6 := v68[safeIndex(p1, |v68|)];
				...
				var v76: seq<int> := [|v75|];
				var v77: seq<int> := [v76[safeIndex(0x34b, |v76|)], |v1[safeIndex(p1, |v1|) := v0]|, -p1, p1, p0];
				globalState.f6 := |v77|;
				var v78 := new C0();
			...
			v88 := v89[safeIndex(p1, |v89|)];
			var v90: array<bool> := new bool[26](i5 => true);
			var v91 := new C1(v90, p0, p1, safeModuloInt(p0, p1), fm13(p0, v0, v0, globalState), "hsuvd" + v1);
		}
		...
		match (v93) {
			case DC20(cf38, cf39) =>
				...
				cf39, globalState.f7, cf39 := fm0(fm13(-p1, v0, v0, globalState), globalState), (v96 * v96) !! {|multiset((seq(abs(0x2fc), i6  => (cf38)))[safeIndex(845, |(seq(abs(0x2fc), i6  => (cf38)))|) := |v96|])|, -444}, p1;
				if (false) {
					var v97: set<bool> := {!p2};
					globalState.f2 := (v97 + v97) !! v97;
					var v98: array<int> := new int[7](i7 => safeDivisionInt(i7, --0x10e));
					v98 := v98;
					v94[safeIndex(252, v94.Length)] := p2;
					v94[safeIndex(252, v94.Length)] := p2;
					v1 := seq(abs(0x45), i8  => (if (p2) then v0 else v0));
					var v99: seq<bool> := [v94[safeIndex(252, v94.Length)]];
					var v100: map<seq<bool>, string> := map[v99 := (seq(abs(418), i9  => (v0))) + "co"];
					v100 := v100[[p2] := v1 + "vj"];
				} else {
					r0 := p2;
			...
			case DC21(cf40) =>
				...
				v106[safeIndex(989, v106.Length)] := safeDivisionInt(p0, p1);
				v106[safeIndex(989, v106.Length)] := safeModuloInt(p1, p1);
				var v107: array<D17> := new D17[28](i10 => DC49(p0));
				var v108 := DC49(v106[safeIndex(989, v106.Length)]);
				v107[safeIndex(353, v107.Length)] := v108;
				v107[safeIndex(353, v107.Length)] := v108;
			case DC19(cf37) =>
				var v109: array<bool> := new bool[26];
				v109[safeIndex(494, v109.Length)] := false;
				v109[safeIndex(494, v109.Length)] := p1 > p1;
				if (v109[safeIndex(494, v109.Length)]) {
					r1 := v109[safeIndex(494, v109.Length)];
					var v110 := new C0();
					var v111 := new C4(v1, if (!false) then |v1| else DC45(v109, v0, p1, p1, v109[safeIndex(494, v109.Length)]).cf84, true, v1, p1, p0);
					var v112: multiset<int> := multiset{631, p1};
					var v113: set<bool> := {v109[safeIndex(494, v109.Length)], v109[safeIndex(494, v109.Length)], p2, p2};
					...
					v109 := v109;
					v109[safeIndex(494, v109.Length)] := p2;
					globalState.f6 := 0x1b6;
					var v115: array<D11> := new D11[28];
					var v116: array<int> := new int[11];
					var v117: map<char, int> := map[v1[safeIndex(--p0, |v1|)] := safeDivisionInt(p1, 0x299)];
					globalState.f6, v115, v116 := --(if (v0 in v117) then v117[v0] else -|map[v109[safeIndex(494, v109.Length)] := v0]|), v115, v116;
					var v118: seq<int> := [p0, p1];
					var v119 := DC13(v118);
					var v120: seq<seq<int>> := [v118, v119.cf29, v118];
					v116[safeIndex(814, v116.Length)] := |v120[safeIndex(p0, |v120|)]|;
					globalState.f6, v116[safeIndex(814, v116.Length)], globalState.f6 := fm0({p2} !! {fm13(p0, v0, 'c', globalState), !p2, v109[safeIndex(494, v109.Length)], v109[safeIndex(494, v109.Length)], p2}, globalState), p0, p1;
				}
				...
				var v126 := new C1(v109, |(v123 + v123)|, |[p1]|, v125[safeIndex(p0, |v125|)], p2, "bbxl");
			case DC22(cf41) =>
				var v127 := new C2(p1, v1, p1, p1);
				globalState.f6 := safeModuloInt(safeDivisionInt(v127.f27, v127.f27), v127.f27);
				var v128: seq<bool> := [p2];
				var v129: set<bool> := {v127.fm41(globalState), v127.fm1(p0, false, v128[safeIndex(v127.f27, |v128|)], globalState), p2};
				v129 := ({p2} - v129) + v129;
				var v130: map<string, bool> := map[fm18(v128[safeIndex(v127.f27, |v128|)], v127.f27, globalState) := true || p2];
	...
	method m11(globalState: GlobalState) returns (r0: bool, r1: array<int>, r2: multiset<seq<int>>) {
		...
		v6, globalState.f7, v7 := if (v0) then v6 else v6, safeDivisionInt(v1, v1) >= safeDivisionInt(|v4|, v1), v7;
		...
		v12[safeIndex(233, v12.Length)] := v1;
		var v13: multiset<bool> := multiset{v0, v0, v0};
		var v14 := DC24(v13);
		v4, globalState.f7, v4, v12[safeIndex(233, v12.Length)], r0 := (v4 + "iokci") + "if", match v14 {
			case DC25(cf44) => {|v3|} > {cf44, cf44}
			case DC24(cf43) => !v0
		}, v4, v1, v0;
		r0 := v0;
		v12[safeIndex(233, v12.Length)] := fm0(v0, globalState);
		globalState.f7 := v13 < v13;
		if (v0) {
			var v15 := DC50(multiset{v0});
			var v16: map<int, D17> := map[0x334 := v15];
			v16 := v16 + (v16 + v16);
			if (v12[safeIndex(233, v12.Length)] != v12[safeIndex(233, v12.Length)]) {
				var v17, v18 := m0(0x2be <= v12[safeIndex(233, v12.Length)], v0, v1, v1, globalState);
				var v19 := DC47(v3);
				v19 := v19;
				v8 := v8;
				var v20: map<bool, bool> := map[v0 := v0];
				var v21: multiset<int> := multiset{|v20|, 0x352, fm0(v17, globalState), v12[safeIndex(233, v12.Length)], v1};
				v12[safeIndex(233, v12.Length)] := -safeModuloInt(if (v12[safeIndex(233, v12.Length)] in v21) then v21[v12[safeIndex(233, v12.Length)]] else v1, v12[safeIndex(233, v12.Length)]);
				v3 := v3[v1 := safeModuloInt(|v18|, -|"q"|)];
			} else {
				var v22: seq<map<bool, bool>> := [map[v0 := v0]];
				var v23 := DC56(v12, !v0, v12[safeIndex(233, v12.Length)], v22);
				v1 := v23.cf107;
				globalState.f6 := v1;
				var v24 := 'g';
				var v25: multiset<char> := multiset{v24, fm34(v24, globalState)};
				var v26 := DC0(v25);
				var v27: array<string> := new string[17] [v4, v4, v4, v4 + v4, v4, fm18(v0, v12[safeIndex(233, v12.Length)], globalState), v4, v4, ("gbogkbui")[safeIndex(v12[safeIndex(233, v12.Length)], |"gbogkbui"|) := v24] + (seq(abs(0x163), i0  => (v24))), fm31(v24, v26, globalState), "uan", seq(abs(0x30f), i1  => (v24)), seq(abs(0x2b1), i2  => (v24)), v4, v4, v4, v4];
				v27[safeIndex(847, v27.Length)] := v4;
				v27[safeIndex(847, v27.Length)] := v4 + v4;
			...
			v8 := v8[v0 := v12[safeIndex(233, v12.Length)]];
			var v32 := DC1(v0, -0x209);
			var v33: array<bool> := new bool[16];
			v32, v33, globalState.f6, v12[safeIndex(233, v12.Length)] := v32, v33, (if (v0) then -v12[safeIndex(233, v12.Length)] else |v2|) + v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)];
			...
			v34[safeIndex(745, v34.Length)] := v35;
			v34[safeIndex(745, v34.Length)] := v35;
		} else {
			var v36: array<map<int, int>> := new map<int, int>[19](i4 => v3);
			var v38: set<int> := {v1, |(seq(abs(0xe5), i5  => (v1)))|};
			v36[safeIndex(552, v36.Length)] := map v37 : int | v37 in v38 :: (v37 + v1) := (v1);
			var v39 := 'q';
			globalState.f7, v36[safeIndex(552, v36.Length)], globalState.f2, v0 := !fm13(-0x187 * v12[safeIndex(233, v12.Length)], v39, v39, globalState), v3, v0, v0 || v0;
			var v40 := DC13(v2);
			var v41: seq<bool> := [fm13(v1, v39, v39, globalState), v0];
			match (if (!(v0 <==> v0)) then v40 else fm65(v0, v8[v41[safeIndex(|v13|, |v41|)] := 441], globalState)) {
				case DC14(cf30, cf31) =>
					v11 := v11[|v8[!v0 := v12[safeIndex(233, v12.Length)]]| := v38 >= v38];
					var v42 := DC8(v0, v0, v4);
					var v43: multiset<char> := multiset{cf30};
					var v44 := DC0(v43);
					var v45: set<D0> := {v44, v44};
					var v46 := DC11(v12[safeIndex(233, v12.Length)], v42, v45, v0);
					var v47 := DC11(fm0(v0, globalState), DC8(v0, v0, "gqtltn"), v46.cf26, !v0);
					globalState.f6 := if (v0) then v46.cf24 + cf31 else v2[safeIndex(v1, |v2|)];
					var v48: map<int, map<int, bool>> := map[v1 := v11];
					v38 := set v49 : int | v49 in (if (v0) then if (v12[safeIndex(233, v12.Length)] in v48) then v48[v12[safeIndex(233, v12.Length)]] else v11 else v11) :: (safeModuloInt(v49, |("fsn" + (seq(abs(0x3a7), i6  => ('o'))))|));
					globalState.f2 := fm0(true, globalState) == v12[safeIndex(233, v12.Length)];
				case DC15(cf32) =>
					v12[safeIndex(233, v12.Length)] := v2[safeIndex(cf32, |v2|)];
					var v50: array<bool> := new bool[19];
					v50[safeIndex(686, v50.Length)] := v0;
					v50[safeIndex(686, v50.Length)], globalState.f7 := v0, v0;
					var v51: array<D12> := new D12[15];
					var v52 := DC36(|v4|, v1, v12[safeIndex(233, v12.Length)]);
					v51[safeIndex(408, v51.Length)] := v52;
					v51[safeIndex(408, v51.Length)] := if (v12[safeIndex(233, v12.Length)] >= v12[safeIndex(233, v12.Length)]) then v52 else v52;
					globalState.f2 := 0x1e7 != v12[safeIndex(233, v12.Length)];
				case DC13(cf29) =>
					var v53: seq<seq<int>> := [v2, cf29, cf29, seq(abs(0xdc), i7  => (v1))];
					var v54: map<int, seq<seq<int>>> := map[|[v0]| := v53];
					var v55 := DC43(v1, v0, v0);
					var v56: array<seq<seq<int>>> := new seq<seq<int>>[18] [v53, v53, v53, v53[safeIndex(if (v0 in v8) then v8[v0] else v12[safeIndex(233, v12.Length)], |v53|) := cf29], v53, if (215 in v54) then v54[215] else v53, [[v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)], v1], fm20(v0, v0, false, globalState)], v53, if (!v0) then v53 else v53, v53 + v53, fm66(v0, v0, DC43(v12[safeIndex(233, v12.Length)], v0, v0), v41, globalState), v53, v53 + v53, v53, (if (true) then v53 else v53)[safeIndex(|v4|, |(if (true) then v53 else v53)|) := v2], v53 + v53, v53, (fm66(v0, v0, v55, v41, globalState))[safeIndex(v12[safeIndex(233, v12.Length)], |fm66(v0, v0, v55, v41, globalState)|) := v2]];
					v56[safeIndex(880, v56.Length)] := seq(abs(915), i8  => ([|v41|, |v41|]));
					v56[safeIndex(405, v56.Length)] := v53 + v53;
					var v57: array<array<string>> := new array<string>[24];
					var v58: array<string> := new string[26];
					v57[safeIndex(409, v57.Length)] := v58;
					...
					v1, v56[safeIndex(880, v56.Length)], v56[safeIndex(405, v56.Length)], v57[safeIndex(409, v57.Length)], v12[safeIndex(233, v12.Length)] := if ((v0 in v41) in v13) then v13[v0 in v41] else v12[safeIndex(233, v12.Length)], v53 + v53, fm66(v0, !v0, DC43(|cf29|, v0, v0), v41 + v41, globalState), if (v60 in v61) then v61[v60] else v58, fm0(v0, globalState);
					var v62: array<bool> := new bool[10];
					var v63 := DC58(v0);
					v62[safeIndex(702, v62.Length)] := v63.cf110;
					v62[safeIndex(128, v62.Length)] := v0;
					var v64: multiset<int> := multiset{v1, v1, v12[safeIndex(233, v12.Length)]};
					var v65: seq<seq<bool>> := [v41, [v0, v0]];
					v62[safeIndex(702, v62.Length)], v62[safeIndex(128, v62.Length)], v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)], v41 := v0, v0, v1, if (0x1c5 in v64) then v64[0x1c5] else if (v12[safeIndex(233, v12.Length)] in v36[safeIndex(552, v36.Length)]) then v36[safeIndex(552, v36.Length)][v12[safeIndex(233, v12.Length)]] else 0x111, v65[safeIndex(|v13|, |v65|)] + v41;
					var v67: array<map<map<int, bool>, int>> := new map<map<int, bool>, int>[1](i9 => map[map v66 : int | (-0x2fb <= v66) && (v66 < 590) :: (safeModuloInt(v66, v12[safeIndex(233, v12.Length)])) := (v0) := v1] + map[v11 := |v4|]);
					var v69: map<map<int, bool>, int> := map[v11 := v1];
					v67[safeIndex(21, v67.Length)] := if (v0) then map v68 : map<int, bool> | v68 in fm67(v39, globalState) :: (v68) := (93) else v69;
					v67[safeIndex(21, v67.Length)] := v69;
					var v70: map<bool, bool> := map[v62[safeIndex(702, v62.Length)] := v0];
					var v71: map<bool, string> := map[fm13(|v41|, v39, v39, globalState) := v4];
					var v72 := new C3(if (v62[safeIndex(702, v62.Length)] in v70) then v70[v62[safeIndex(702, v62.Length)]] else v62[safeIndex(702, v62.Length)], "glah", if (v62[safeIndex(702, v62.Length)] in v71) then v71[v62[safeIndex(702, v62.Length)]] else v4, v1, v62[safeIndex(702, v62.Length)], v4, |v41|, v1);
				case DC16(cf33) =>
					var v73: array<D13> := new D13[27](i10 => DC37(multiset{|v41|, v1}));
					var v74: multiset<int> := multiset{v12[safeIndex(233, v12.Length)]};
					var v75 := DC37(v74[|v4| := abs(if (-v1 in v74) then v74[-v1] else v1)]);
					v73[safeIndex(888, v73.Length)] := v75;
					var v76: C0 := new C0();
					var v77: set<bool> := {false};
					var v78: seq<seq<bool>> := [[v0, v0]];
					var v79: map<bool, bool> := map[v0 := v0];
					var v80: C2 := new C2(-0x35b, v4, v1, v12[safeIndex(233, v12.Length)]);
					var v81: array<seq<bool>> := new seq<bool>[29] [v41 + (([v0])[safeIndex(|v77|, |[v0]|) := v0])[safeIndex(v1, |([v0])[safeIndex(|v77|, |[v0]|) := v0]|) := v0], v78[safeIndex(v12[safeIndex(233, v12.Length)], |v78|)], [!v0], v41[safeIndex(|v38|, |v41|) := v0], v41, v41, v41, fm30(v0, v0, v1, v41[safeIndex(v12[safeIndex(233, v12.Length)], |v41|)], globalState) + v41, [if (v0 in v79) then v79[v0] else v0], v41, ([v0, v0])[safeIndex(-v2[safeIndex(0x3d3, |v2|)], |[v0, v0]|) := v0] + v41, [v0, v0] + [v0], v41, v41, v41 + v41, v41, fm30(if (v0 in v79) then v79[v0] else v41[safeIndex(v1, |v41|)], v0, v1, v0, globalState), v41[safeIndex(-v1, |v41|) := v0], v41[safeIndex(0xec, |v41|) := v0] + [v0], v41 + v41, v41, v41, v41, v41, v41, v41, v78[safeIndex(|multiset{v80, v80}|, |v78|)] + v41, v41, v41 + v41];
					var v82: set<char> := {v39};
					globalState.f2, globalState.f6, v73[safeIndex(888, v73.Length)], v76, v81 := if (v38 < v38) then v0 else v0, |(v82 + v82)|, DC37(v74[v80.f27 := abs(0x2be)]), if (v13 !! multiset{v0}) then v76 else v76, v81;
					v12[safeIndex(233, v12.Length)] := |v2|;
					v39 := v39;
			...
			v12[safeIndex(233, v12.Length)] := v12[safeIndex(233, v12.Length)];
			...
			match (v86.(cf72 := fm22(v1, globalState))) {
				case DC41(cf73, cf74, cf75) =>
					...
					var v92: map<char, int> := map[v39 := -|(set v91 : char | v91 in (map v89 : char | v89 in v90 :: (v89) := (v2[safeIndex(v1, |v2|)])) :: (v91))|];
					var v94: array<set<bool>> := new set<bool>[24] [v87, v87, fm32(fm13(|cf75|, v88.cf30, v39, globalState), v92, set v93 : int | (-758 <= v93) && (v93 < 0x355) :: (safeDivisionInt(v93, 645)), true, globalState) - v87, v87, v87, v87 * fm32(cf74, v92, v38, v0, globalState), v87, v87, v87, v87, v87, v87, v87, v87 * {cf73}, v87, v87 + v87, v87 + v87, v87, v87, v87, v87, v87, v87 + v87, v87];
					v94[safeIndex(142, v94.Length)] := {v0};
					var v95: array<bool> := new bool[10] [cf73, cf74, cf74, v0, cf74, cf74, cf74, false, cf73, cf74];
					var v96: multiset<char> := multiset{'w'};
					var v97: C1 := new C1(v95, v1, v12[safeIndex(233, v12.Length)], if (v39 in v96) then v96[v39] else v2[safeIndex(v1, |v2|)], cf74, cf75);
					var v98 := DC26(v97);
					var v99: map<int, D9> := map[v12[safeIndex(233, v12.Length)] := v98];
					v94[safeIndex(142, v94.Length)], v99, v12[safeIndex(233, v12.Length)], v95 := v87, v99, -0x24d, v95;
					var v100: map<bool, array<bool>> := map[!v0 := v95];
					var v101: T0 := new C1(if (cf74 in v100) then v100[cf74] else v95, v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)], v12[safeIndex(233, v12.Length)], cf74, v4);
					...
					v103[safeIndex(429, v103.Length)] := v101;
					var v104: seq<T0> := [if (cf73) then v101 else v101];
					v103[safeIndex(429, v103.Length)] := v104[safeIndex(v101.f11, |v104|)];
					globalState.f6 := v101.f11;
					v12[safeIndex(233, v12.Length)] := fm0(!cf74, globalState);
				case DC40(cf72) =>
					var v105: map<char, int> := map[if (true) then 'a' else v39 := fm0(v0, globalState)];
					v105 := v105 + v105;
					var v106, v107 := m0(v0, v0, v12[safeIndex(233, v12.Length)], 0x11b, globalState);
					v12[safeIndex(233, v12.Length)] := v12[safeIndex(233, v12.Length)];
...
class C6 extends T2, T1 {
	...
	function fm2(p0: int, p1: bool, p2: int, p3: bool, globalState: GlobalState): int {
		|(if (true) then f13 else f13[safeIndex(f11, |f13|) := 'h'])|
	}
	function fm3(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<bool, int> {
	...
	method m2(p0: array<bool>, p1: multiset<int>, globalState: GlobalState) returns (r0: bool, r1: multiset<int>) {
		...
		var v3 := new C3(v0 in "qnbi", seq(abs(0x32e), i0  => (v0)), f13, safeDivisionInt(f14, f12), f15, f13, (if (!f15 in v1) then v1[!f15] else f11) + |v2|, f12);
		...
		for i1 := f11 to f14 {
			...
			var v8: array<array<bool>> := new array<bool>[3] [v7[safeIndex(f12, |v7|)], p0, p0];
			v8 := new array<bool>[19];
			var v9: array<bool> := new bool[4];
			v9 := v9;
		}
		var v10 := DC30(f15, v3.f25, f13[safeIndex(f12, |f13|) := v0], v3.f25);
		...
		for i2 := f14 to |map[f11 := DC10(f15, f14, v11, v3.f26, |v12|)]| {
			if (v3.f25) {
				...
				var v14: array<int> := new int[24](i3 => safeModuloInt(i3, f11));
				...
				p0[safeIndex(600, p0.Length)] := !v3.f25;
				p0[safeIndex(407, p0.Length)] := f14 >= i2;
				globalState.f6, globalState.f2, p0[safeIndex(600, p0.Length)], p0[safeIndex(407, p0.Length)], globalState.f2 := safeDivisionInt(f14 * f14, i2), !v3.f25, v3.f25, v3.f25, v21.f25;
			...
			var v28 := DC47(map[i2 := |map[f15 := |(seq(abs(0xd3), i5  => (v0)))|]|]);
			var v29: map<int, int> := map[f14 := |v1|];
			var v30: multiset<D17> := multiset{v28.(cf89 := v29), v28.(cf89 := v29), DC47(map[f11 := |(seq(abs(-0x3d), i6  => (f14)))|])};
			globalState.f2 := (if (v28.(cf89 := v29) in v30) then v30[v28.(cf89 := v29)] else f14) < f11;
			if (v3.f25) {
				p0[safeIndex(441, p0.Length)] := f15;
				...
				p0[safeIndex(441, p0.Length)], v31, globalState.f6 := !(v33 >= v33), v31, if (v3.f25 || f15) then f12 else -|(v34 + v34)|;
				var v35: array<bool> := new bool[13] [p0[safeIndex(441, p0.Length)], f15, p0[safeIndex(441, p0.Length)], f15, v3.f25, !true, p0[safeIndex(441, p0.Length)], v3.f25, f15, v3.f25, f15, !v3.f25, v3.f25];
				...
				var v42: array<seq<bool>> := new seq<bool>[19] [v34 + [(fm39(globalState)).cf15, v3.f25], v34, [false, v3.f25, false], v34, v34, v34 + v34, v34, [!f15], v34, v34, v34 + v34, v34, v34, v34, [false, !p0[safeIndex(441, p0.Length)]], v34[safeIndex(|v40|, |v34|) := v3.f25], v34, if (v38 in v41) then v41[v38] else v34, v34];
				v42 := v42;
				globalState.f6 := safeDivisionInt(safeModuloInt(f11, |v12|), i2);
			} else {
				...
				var v45: seq<seq<int>> := [v44, v44, (seq(abs(0x1ec), i7  => (0x10f)))[safeIndex(f11, |(seq(abs(0x1ec), i7  => (0x10f)))|) := f11], v44];
				v44 := v45[safeIndex(i2, |v45|)] + v44;
				globalState.f2 := f15;
			}
			...
			if (f15) {
				...
				v51[safeIndex(871, v51.Length)] := f11 * f14;
				...
				v51[safeIndex(871, v51.Length)] := v54.cf60;
				v51[safeIndex(871, v51.Length)] := |f13|;
				v48.f27 := f14;
				var v55 := new C4(v3.f26, -i2, f12 >= i2, "pesc", if (v3.f25) then 0x255 else v48.f27, v51[safeIndex(871, v51.Length)]);
			} else {
				var v56: seq<int> := [0x3ad, safeDivisionInt(f11, fm0(v3.f25, globalState)), f12];
				globalState.f6 := v56[safeIndex(f12, |v56|)];
				globalState.f7 := v3.f25;
				p0[safeIndex(656, p0.Length)] := |v56| !in v56;
				p0[safeIndex(656, p0.Length)] := true;
				globalState.f2 := if (v3.f25) then false else p0[safeIndex(656, p0.Length)];
		...
		var v60: array<set<char>> := new set<char>[16] [v57, v57, v57, v57, v57, v57, fm68(f12, f13[safeIndex(v3.fm2(-f12, v3.f25, f14, f15, globalState), |f13|) := v0], globalState), v57, v57, v57 * v57, {v0}, v57 * v57, v57 * v57, if (v3.f25) then v57 else v57, set v59 : char | v59 in v58 :: (v59), {v0}];
		var v61: array<int> := new int[13];
		var v62: map<array<int>, int> := map[v61 := f12];
		var v63: map<int, array<set<char>>> := map[safeDivisionInt(if (v61 in v62) then v62[v61] else |"yajajypjw"|, v3.fm2(f11, v3.f25, |v12|, f15, globalState)) := v60];
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		for i0 := p1 to |v0| {
			var v1 := "ti";
			v1 := f13[safeIndex(p3, |f13|) := f13[safeIndex(f12, |f13|)]] + "tx";
			globalState.f7 := safeDivisionInt(p1, f11) != i0;
			...
			v4, r2, v5, globalState.f6, r1 := v4 + (map[v6[safeIndex(|v7|, |v6|)] := v3] + v4), safeDivisionInt(|(v8 + v8)|, f14), v5, safeDivisionInt(p1, 0x22f) + safeModuloInt(f14, f12), p1 - 906;
			var v9: map<bool, bool> := map[false := f15];
			v3[safeIndex(62, v3.Length)] := |v9|;
			v3[safeIndex(62, v3.Length)] := --p1;
		}
		if (f15) {
			...
			if (p2) {
				...
				v12[safeIndex(243, v12.Length)] := v11;
				v12[safeIndex(243, v12.Length)] := v11;
				r0 := p2;
				v11, globalState.f7 := v12[safeIndex(243, v12.Length)], f15;
				...
				v17 := (map[p2 := (v19[safeIndex(|v16|, |v19|)])[p3 := p3]] + v17) + (v17 + (if (f13 in v20) then v20[f13] else map[true := v16]));
				globalState.f2 := f15;
				var v21 := new C5();
			}
			...
			if (p2) {
				...
				var v29: array<int> := new int[19] [|v24|, if (!fm1(p1, f15, p2, globalState)) then f11 else |v25|, f11 + f12, f11, 0xee, p3, p1, v26.cf77, 391, |v27|, |v28|, f12, |fm48(globalState)|, p3, |"ubupnkhmv"|, |fm42(p3, f15, fm12(v22, p0, f15, |f13|, globalState), globalState)|, safeModuloInt(|[multiset{f11}]|, fm0(p2, globalState)), p1, f11 + f12];
				v29[safeIndex(760, v29.Length)] := p1;
				var v30: array<bool> := new bool[5] [p2, !f15, p2, f15, f15];
				var v31: seq<array<bool>> := [v30, v30];
				v29[safeIndex(760, v29.Length)], globalState.f7, r1, globalState.f7 := --|v31| - |fm60(globalState)|, fm1(|(if (true) then v22 else v22)|, true, f15, globalState), p1, !p2;
				var v32: seq<string> := [p0, fm18(p2, -917, globalState), f13];
				var v33: multiset<int> := multiset{p1};
				var v34: C1 := new C1(v30, |p0|, |v32[safeIndex(|v33|, |v32|)]|, |v33|, f15, p0);
				...
				v37[safeIndex(396, v37.Length)] := p1;
				r1, v37[safeIndex(396, v37.Length)] := f11, safeDivisionInt(0x283, |multiset{f15}|);
				var v38 := 'o';
				v38 := v38;
				...
				r1 := |(v45 + v45)[v37[safeIndex(396, v37.Length)] := p0 + p0]|;
			}
			...
			var v48: array<bool> := new bool[11] [p2, f15, f15, f15, false, p2, {v46, v46} > v47[safeIndex(f12, |v47|)], p2, f15, p2, f15];
			v48[safeIndex(350, v48.Length)] := p2;
			var v49 := DC45(v48, v46, -p1, 382, f15);
			v48[safeIndex(350, v48.Length)] := v46 !in (f13 + p0[safeIndex(p1, |p0|) := v49.cf82]);
			if (v48[safeIndex(350, v48.Length)]) {
				var v50: array<string> := new string[29];
				v50 := new string[13] ["rte", seq(abs(0x126), i4  => (v46)), seq(abs(0x7d), i5  => (v46)), p0, f13, seq(abs(-0x399), i6  => ('o')), p0, f13, f13 + f13, p0, f13, p0, f13 + "vhxtce"];
				var v51: array<char> := new char[29];
				v51 := v51;
				var v52 := DC10(p2, f12, map[f13 := f12], p0, f11);
				var v53: map<D3, int> := map[v52 := f14];
				var v54, v55 := m0(-f11 < p1, v48[safeIndex(350, v48.Length)], f12, f14 * (if (v52 in v53) then v53[v52] else f14), globalState);
				r1 := v49.cf83;
				var v56: set<array<bool>> := {v48};
				var v57: set<bool> := {f15};
				var v58: C2 := new C2(|v56|, ("tgmsv")[safeIndex(f14, |"tgmsv"|) := v46], if (p2) then p1 else p1, -(f12 * -fm2(p1, v54, |v57|, v54, globalState)));
				v58, globalState.f7, globalState.f7 := v58, f15, true;
			} else {
				var v59, v60 := m0(v48[safeIndex(350, v48.Length)], false, f14 - f11, f11, globalState);
				var v61: array<int> := new int[17];
				var v62: multiset<int> := multiset{p1, |p0|, p3, f14, f12};
				v61[safeIndex(456, v61.Length)] := |v62|;
				v61[safeIndex(456, v61.Length)] := |fm22(488, globalState)|;
				globalState.f2 := v59;
				v61[safeIndex(456, v61.Length)] := |{f15}|;
				var v63: C4 := new C4(f13, v61[safeIndex(456, v61.Length)], !p2, p0, p3, f11);
				r0, globalState.f2, v61[safeIndex(456, v61.Length)], globalState.f7, v61[safeIndex(456, v61.Length)] := p2, v48[safeIndex(350, v48.Length)], if (!v59) then f12 else |DC60([v63, v63, v63, v63, v63]).cf112|, v59, v61[safeIndex(456, v61.Length)];
			}
		...
		if (p3 != |(v68 - v68)|) {
			...
			v66[safeIndex(318, v66.Length)] := v69;
			v66[safeIndex(318, v66.Length)] := v69 * (v69 * v69);
			globalState.f6 := f11;
			var v70: map<bool, bool> := map[f15 := fm1(p1, p2, false, globalState)];
			var v71: seq<bool> := [p2];
			v70 := v70[v71[safeIndex(f12, |v71|)] := f15];
			r0 := p2;
			var v72 := new C2(0x328, p0 + p0, 0x32e * f12, f12);
		} else {
			r2 := safeDivisionInt(p1, p3);
			if (f15) {
				globalState.f6 := v0[safeIndex(f14, |v0|)];
				var v73: map<int, seq<string>> := map[f14 := [f13]];
				var v74: seq<string> := ["ntli"];
				v73 := v73[safeModuloInt(f12, v0[safeIndex(p1, |v0|)]) := v74];
				var v75: array<int> := new int[3](i8 => i8 * p1);
				v75[safeIndex(922, v75.Length)] := |v67|;
				var v76 := DC35(v68);
				...
				v75[safeIndex(922, v75.Length)] := |v82|;
				r0 := p2;
				...
				var v86: map<bool, int> := map[if ('d' in v84) then v84['d'] else v85[safeIndex(f11, |v85|)] := f14];
				...
				v91[safeIndex(953, v91.Length)] := f11;
				v91[safeIndex(953, v91.Length)] := |p0|;
			}
...
class C7 {
	...
	method m9(p0: T0, p1: string, p2: int, globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		var v0: array<string> := new string[10](i0 => ("apfdd")[safeIndex(0x2b6, |"apfdd"|) := 'c']);
		v0[safeIndex(293, v0.Length)] := p1;
		var v1 := true;
		v0[safeIndex(293, v0.Length)] := p1[safeIndex(p0.f12, |p1|) := fm11(v1, --p0.f11, globalState)];
		...
		var v4 := new C1(v3, p0.f11 * 350, p0.f11, safeDivisionInt(p0.f11, p0.f11), v1, "r" + p1);
...
class C8 {
	...
	method m7(p0: int, p1: D3, p2: bool, p3: array<string>, globalState: GlobalState) returns (r0: int, r1: T1, r2: multiset<bool>) {
		if ((if (f22) then f22 else fm7(f21, p0, globalState)) <== f21) {
			...
			globalState.f7 := !(p0 >= p0) ==> v1[safeIndex(p0, |v1|)];
			globalState.f6 := p0;
			if (f21) {
				globalState.f2 := f22;
				globalState.f6 := -safeModuloInt(-450, p0);
				var v2 := DC1(f22, p0);
				...
				var v15: seq<array<int>> := [v14];
				v13[safeIndex(398, v13.Length)] := v15;
				v13[safeIndex(398, v13.Length)] := v15;
				var v16 := new C0();
				var v17 := new C7();
				r0 := p0;
				var v18: array<char> := new char[1];
				v18[safeIndex(720, v18.Length)] := fm34('t', globalState);
				var v19 := 'u';
				v18[safeIndex(720, v18.Length)] := v19;
			}
			
			var v20: array<bool> := new bool[18];
			var v21: set<array<bool>> := {v20};
			v21 := v21;
			globalState.f6 := safeDivisionInt(p0, p0 * p0);
		} else {
			var v22 := 'l';
			...
			if ((if (f22) then p0 else p0) < fm0(f21, globalState)) {
				...
				var v27 := DC62(v25);
				var v28: seq<map<int, bool>> := [v26[safeIndex(p0, |v26|)], v25, v27.cf117];
				var v29 := "sijb";
				var v30: seq<bool> := [true];
				var v31: seq<int> := [0x198, |v29|];
				var v32 := DC43(p0, f22, p2);
				var v33: map<bool, int> := map[p2 := p0];
				var v34 := new C6(v26 + (seq(abs(0x233), i0  => (v25))), p0, p2, v29, |v30| - |v31|, v32.cf77 * (if (f22 in v33) then v33[f22] else p0));
				var v36: array<int> := new int[15](i1 => i1 * |(map v35 : int | (288 <= v35) && (v35 < 0xbb) :: (v35 - p0) := (v22))|);
				v36[safeIndex(416, v36.Length)] := p0;
				v36[safeIndex(416, v36.Length)] := p0;
				var v37: map<bool, bool> := map[f22 := f21];
				var v38: array<bool> := new bool[18] [f21, v36[safeIndex(416, v36.Length)] != v36[safeIndex(416, v36.Length)], p2, p2, f21, f21, p2, f22 || f21, f22, f21, p2, p2, f22, f21, f22, f21, true, if (true in v37) then v37[true] else p2];
				v38[safeIndex(316, v38.Length)] := f22;
				var v39: multiset<bool> := multiset{f22};
				v38[safeIndex(316, v38.Length)] := v39 <= multiset{true, !p2};
				var v40: seq<array<int>> := [v36, v36, v36, v36];
				v40 := v40;
				globalState.f6 := -(safeModuloInt(v36[safeIndex(416, v36.Length)], p0) * safeDivisionInt(|{!f21}|, v34.fm2(v36[safeIndex(416, v36.Length)], f22, v36[safeIndex(416, v36.Length)], f21, globalState)));
			} else {
				var v41: array<bool> := new bool[29](i2 => p2);
				v41 := v41;
				var v42 := DC6(seq(abs(596), i3  => (v22)));
				v42 := fm70(globalState);
				var v43: array<int> := new int[12];
				var v44: seq<int> := [p0];
				v43[safeIndex(941, v43.Length)] := |(if (f21) then v44 else v44)|;
				v43[safeIndex(941, v43.Length)] := p0;
				var v45: array<D3> := new D3[6];
				var v46: seq<array<D3>> := [v45];
				var v47: multiset<int> := multiset{v43[safeIndex(941, v43.Length)]};
				globalState.f2, globalState.f7, v22, globalState.f2 := if (v44 <= [p0]) then v46 != [v45] else (if (v43[safeIndex(941, v43.Length)] in v47) then v47[v43[safeIndex(941, v43.Length)]] else p0) in fm29(globalState), f21, v22, p2 || (f21 <== p2);
				v41[safeIndex(587, v41.Length)] := !f22;
				var v48: multiset<bool> := multiset{p2, !!f22};
				v41[safeIndex(587, v41.Length)], globalState.f6, globalState.f6 := v43[safeIndex(941, v43.Length)] >= |v48|, p0, p0;
			}
			...
			var v55: array<array<bool>> := new array<bool>[26] [v52, v52, v53[safeIndex(|v54|, |v53|)], v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v52, v53[safeIndex(0x2c0, |v53|)], v52, v52, v52, v52, v52, v52];
			v55[safeIndex(376, v55.Length)] := v52;
			v55[safeIndex(376, v55.Length)] := if (f22) then if (f22) then v52 else v53[safeIndex(p0, |v53|)] else v52;
			globalState.f6 := -safeModuloInt(p0, safeDivisionInt(p0, -p0));
			globalState.f7 := f22;
		}
		
		globalState.f6 := -safeDivisionInt(fm0(p2, globalState), 0x7c);
		if (f22 <== f22) {
			var v56 := "dbxauraqu";
			...
			if (f22) {
				...
				var v67: array<array<bool>> := new array<bool>[28] [v58, v58, v58, v58, v58, v58, v58, v58, if (true in v59) then v59[true] else v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v58, v65.cf81, v66[safeIndex(0x0, |v66|)], v58, v58, v58, v58, v58, v58];
				v67[safeIndex(373, v67.Length)] := v58;
				v67[safeIndex(373, v67.Length)] := new bool[9](i5 => f22);
				globalState.f6 := p0;
				v64 := v64;
				...
				v69 := fm71([v71, v71, v71] + (seq(abs(-413), i6  => (v71)))[safeIndex(|v76|, |(seq(abs(-413), i6  => (v71)))|) := ([v70, v70])[safeIndex(|v56|, |[v70, v70]|) := DC48(f21, p2, f22)]], p0, false, globalState);
				var v77 := DC13([-p0, 186]);
				globalState.f1 := fm35(f22, v77.cf29, globalState);
			} else {
				var v78: map<bool, int> := map[f22 := p0];
				globalState.f6 := p0 + safeModuloInt(if (p2 in v78) then v78[p2] else p0, p0);
				var v79 := DC29();
				v79 := v79;
				...
				var v81 := DC10(!f22, p0, fm9(f21, globalState), v56, |(seq(abs(0x3c4), i7  => (p0)))|);
				...
				v83[safeIndex(277, v83.Length)] := p0 >= |map[v84 := p2]|;
				v83[safeIndex(277, v83.Length)] := (p0 * p0) != p0;
			}
			
			var v85: multiset<bool> := multiset{f22};
			var v86: seq<multiset<bool>> := [v85[f22 := abs(0x99)] - v85];
			v86 := v86 + v86;
		} else {
			var v87: array<bool> := new bool[25](i8 => p2);
			v87[safeIndex(559, v87.Length)] := f22;
			v87[safeIndex(559, v87.Length)] := p2;
			r0 := p0;
			var v88: array<multiset<T0>> := new multiset<T0>[27];
			var v89 := "yyhf";
			var v90: map<bool, bool> := map[f22 := v87[safeIndex(559, v87.Length)]];
			var v91: T0 := new C1(v87, |v89|, -|v90|, p0, v87[safeIndex(559, v87.Length)], v89);
			var v92: multiset<T0> := multiset{v91};
			v88[safeIndex(914, v88.Length)] := v92;
			var v93: seq<T0> := [v91, v91, v91, v91, v91];
			v88[safeIndex(914, v88.Length)] := multiset([v91] + v93);
			if (f22) {
				var v94 := 'o';
				var v95: map<bool, char> := map[f21 := v94];
				v95 := (map[!f22 := v94])[v89 <= (seq(abs(952), i9  => (v94))) := v94];
				var v96 := DC5(v91.f11, p2, f21);
				v87[safeIndex(559, v87.Length)] := v96.cf8;
				var v97: array<int> := new int[1] [v91.f11];
				v97[safeIndex(85, v97.Length)] := 0x360;
				v94, v97[safeIndex(85, v97.Length)], v94, v94 := v94, v91.f11, v89[safeIndex(v91.f12 * v91.f12, |v89|)], fm21(v91.f11, f21, globalState);
				var v98: array<string> := new string[10];
				v98 := v98;
				var v99: seq<seq<char>> := [v89, v89, v89 + v89, v89, seq(abs(0x307), i10  => (v94))];
				v99 := v99;
			} else {
				globalState.f2 := f21;
				var v100 := new C7();
				...
				var v110: set<bool> := {f21, if (v108 in v109) then v109[v108] else f22, f21, !v87[safeIndex(559, v87.Length)], f21};
				r0, globalState.f6, v101, v102, v87[safeIndex(559, v87.Length)] := -v91.f12, v91.f12, v105.cf121, v102, (v110 * v110) !! v110;
				v87[safeIndex(559, v87.Length)] := f21;
				globalState.f6 := safeDivisionInt(safeModuloInt(v91.f12, v91.f11), -fm0(f21, globalState) + v91.f11);
			}
			...
			v115[safeIndex(271, v115.Length)] := |v116|;
			var v117: seq<string> := [v89];
			v113, r0, v114, v115[safeIndex(271, v115.Length)] := v113, |v117|, v114, safeModuloInt(v91.f11, v91.f11);
		}
		...
		var v123: set<bool> := {v122[safeIndex(p0, |v122|)]};
		var v124: array<int> := new int[27] [p0, p0, p0, p0 + |v118[safeIndex(|v119|, |v118|) := v120]|, p0, |v118|, p0, |"d"|, p0, p0, |v121|, p0, p0, if (p2) then p0 else p0, p0, safeDivisionInt(p0, p0), |fm48(globalState)|, |(v123 * v123)|, p0, p0, p0, safeModuloInt(p0, 761), p0, |fm18(f21, p0, globalState)| - p0, p0, |((v118[safeIndex(-|v122|, |v118|) := v120])[safeIndex(p0, |v118[safeIndex(-|v122|, |v118|) := v120]|) := v120] + v118)|, p0];
		var v125: seq<int> := [p0, p0];
		var v126: multiset<int> := multiset{p0, p0, v125[safeIndex(p0, |v125|)], |v118|};
		v124[safeIndex(197, v124.Length)] := if (p0 in v126) then v126[p0] else 0x3ce;
		v124[safeIndex(197, v124.Length)], globalState.f2 := --(p0 + (p0 + p0)), v122[safeIndex(0x2bf, |v122|)];
		...
		match (v128) {
			case DC41(cf73, cf74, cf75) =>
				...
				cf74 := (v124[safeIndex(197, v124.Length)] + |v130[safeIndex(v124[safeIndex(197, v124.Length)], |v130|)]|) >= safeDivisionInt(|v125|, v124[safeIndex(197, v124.Length)]);
				...
				match (p1.(cf26 := v133, cf27 := cf73)) {
					case DC10(cf19, cf20, cf21, cf22, cf23) =>
						...
						v136[safeIndex(638, v136.Length)] := fm69(p2, |v125|, v131['x' := abs(v124[safeIndex(197, v124.Length)])], v124[safeIndex(197, v124.Length)], globalState);
						globalState.f2, v136[safeIndex(638, v136.Length)] := f22, f22 <== cf19;
					case DC11(cf24, cf25, cf26, cf27) =>
						v124 := v124;
						var v137: array<bool> := new bool[12] [!(p0 >= cf24), cf73, p2, !(f21 ==> cf73), v121 != v121, if (-v124[safeIndex(197, v124.Length)] in v119) then v119[-v124[safeIndex(197, v124.Length)]] else f22, f21, if (cf27) then cf27 else cf27, fm69(false, cf24, v131, |v118|, globalState), cf74, v128.cf74, cf74];
						v137 := v137;
						var v138: map<bool, bool> := map[f22 := cf27];
						var v139: array<char> := new char[26];
						var v140: map<array<char>, map<bool, bool>> := map[v139 := v138];
						var v141: set<map<bool, bool>> := {v138, v138[!cf73 := p2], map[fm69(f22, v124[safeIndex(197, v124.Length)], v131, p0, globalState) := cf27] + (if (v139 in v140) then v140[v139] else v138), v138};
						v141 := v141;
						globalState.f7 := cf74;
					case DC9(cf18) =>
						globalState.f2 := f22;
						var v142, v143, v144 := m8(globalState);
						var v145: map<char, int> := map[v120 := v124[safeIndex(197, v124.Length)]];
						var v146: array<bool> := new bool[12] [v143, cf73, p2, f22, f22, v144, v142, v122[safeIndex(if (v120 in v145) then v145[v120] else p0, |v122|)], v144, v144, p2, v142];
						var v147: T2 := new C1(v146, v124[safeIndex(197, v124.Length)], v124[safeIndex(197, v124.Length)], p0, cf74, v118);
					...
					case DC12(cf28) =>
						...
						var v157: array<bool> := new bool[14] [f21, f22, v124[safeIndex(197, v124.Length)] !in (map[|v152| := v154[safeIndex(v125[safeIndex(|v155|, |v125|)], |v154|)]])[p0 := v153], f22, v122[safeIndex(p0, |v122|)], v156.cf92, cf74, f21, f21, f21, f21, cf74, f22, v122[safeIndex(p0, |v122|)]];
						v157[safeIndex(430, v157.Length)] := cf74;
						var v158: map<array<int>, int> := map[v124 := v124[safeIndex(197, v124.Length)]];
						v157[safeIndex(430, v157.Length)], cf75 := v124 in v158, fm18(cf74, v124[safeIndex(197, v124.Length)], globalState) + v118;
						globalState.f6 := v124[safeIndex(197, v124.Length)];
						v126 := v126;
						globalState.f7 := fm7(cf73, -p0, globalState);
				}
				
				var v159: seq<array<int>> := [v124, v124, v124];
				var v160: array<array<int>> := new array<int>[19] [v124, v124, if (cf74) then v124 else v159[safeIndex(28, |v159|)], v124, v124, v124, v124, v124, v124, v124, v124, v124, v124, if (fm69(cf73, p0, v131, v124[safeIndex(197, v124.Length)], globalState)) then v124 else v124, v124, v124, v124, v124, if (cf74) then v124 else v124];
				var v161: map<int, array<int>> := map[v124[safeIndex(197, v124.Length)] := v124];
				...
				var v165 := DC56(if (f21 in v162) then v162[f21] else v124, cf73, v124[safeIndex(197, v124.Length)], v164);
				var v166: map<int, int> := map[v165.cf107 := v124[safeIndex(197, v124.Length)]];
				var v167: map<bool, bool> := map[v125[safeIndex(v124[safeIndex(197, v124.Length)], |v125|)] in v166 := f22];
				r0, globalState.f2, v160, globalState.f2, f21 := |v122|, if (cf74 in v163) then v163[cf74] else f21, v160, (fm9(cf73, globalState) + map[cf75 := v124[safeIndex(197, v124.Length)]]) != fm9(f22, globalState), f21;
				globalState.f7 := f21;
			case DC40(cf72) =>
				var v168: map<bool, int> := map[f21 := v124[safeIndex(197, v124.Length)]];
				...
				var v172: array<bool> := new bool[28] [fm7(!f21, v124[safeIndex(197, v124.Length)], globalState), false, !fm7(f22, 0x27e, globalState), f21, p2, 952 >= (if (fm7(false, |v123|, globalState) in v168) then v168[fm7(false, |v123|, globalState)] else v124[safeIndex(197, v124.Length)]), p2, f21, f21, true, p2, f21, p2, v124[safeIndex(197, v124.Length)] > p0, if (true in v169) then v169[true] else fm7(f22, -0x38, globalState), fm7(f22, v125[safeIndex(0x315, |v125|)], globalState), p2 <==> p2, f21, f22, f22, if (v170 in v171) then v171[v170] else f21, f21, p2 || f21, p2, v122 != v122, p2 <== f22, p2, p2];
				v172 := v172;
				p3[safeIndex(993, p3.Length)] := v118;
				p3[safeIndex(993, p3.Length)] := v118 + v118;
				var v173: map<string, set<bool>> := map["fuxngc" + v118 := v123];
				v173 := v173[v118 + p3[safeIndex(993, p3.Length)] := v123];
				globalState.f7 := p2;
		}
		
		r0 := -safeModuloInt(p0, p0) - v124[safeIndex(197, v124.Length)];
	...
	method m8(globalState: GlobalState) returns (r0: bool, r1: bool, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			if (f22) {
				v3[safeIndex(69, v3.Length)] := f22;
				v3[safeIndex(69, v3.Length)] := if (0x277 in v2) then v2[0x277] else f22;
				var v8: multiset<bool> := multiset{f21};
				var v9: map<bool, multiset<bool>> := map[v3[safeIndex(69, v3.Length)] := v8];
				v9 := (map[v3[safeIndex(69, v3.Length)] := v8] + v9) + v9;
				var v10: map<int, char> := map[v0 := fm47(v0, globalState)];
				v10 := v10[|v4| := v5];
				globalState.f6 := v0;
				v3[safeIndex(69, v3.Length)] := v3[safeIndex(69, v3.Length)];
			} else {
				...
				v7.f24[safeIndex(853, v7.f24.Length)] := true;
				...
				var v25 := DC65(v22);
				var v26: array<C3> := new C3[19] [v22, v22, v22, v22, v22, v22, v22, v22, if (f22) then v23[safeIndex(v0, |v23|)] else v22, if ((seq(abs(0x239), i1  => (v5))) in v24) then v24[seq(abs(0x239), i1  => (v5))] else v22, v22, v22, v22, v22, v22, v22, v22, (v25.(cf122 := v22)).cf122, v22];
				v26[safeIndex(280, v26.Length)] := v22;
				var v27: array<char> := new char[18];
				v27[safeIndex(796, v27.Length)] := fm14(v22.f25, v5, v0, f22, globalState);
				var v28 := DC29();
				v7.f24[safeIndex(853, v7.f24.Length)], v21, v26[safeIndex(280, v26.Length)], v27[safeIndex(796, v27.Length)], v4 := f22, fm72(v28, v0, safeModuloInt(v0, v0), v2, globalState), v22, v5, v4;
				v16 := v16 + v16;
				v18[safeIndex(37, v18.Length)] := v0;
				v18[safeIndex(37, v18.Length)] := v0;
				v7.f24[safeIndex(853, v7.f24.Length)] := f21;
			}
		...
		for i2 := |v31| to v32 {
			...
			var v34 := DC21(f22);
			var v35: array<bool> := new bool[16] [f21, v33[safeIndex(fm0(f22, globalState), |v33|)], f21, f22, !f21, f22, f21, f21, v33[safeIndex(-i2, |v33|)], f22, f21, v34.cf40, f21, f21, !f21, f21];
			var v36: map<int, int> := map[v32 := 0x12b];
			var v37: T2 := new C1(v35, |v36|, i2, 824, f21, seq(abs(0x1dd), i3  => ('j')));
			...
			v44[safeIndex(489, v44.Length)] := -safeDivisionInt(|DC67(v45).cf125|, v37.f11);
			v44[safeIndex(489, v44.Length)] := v32;
		}
		...
		v48[safeIndex(65, v48.Length)] := v46;
		v48[safeIndex(65, v48.Length)] := match DC4(f21) {
			case DC3(cf4) => v46
			case DC4(cf5) => v46
		...
		globalState.f6 := match v50 {
			case DC10(cf19, cf20, cf21, cf22, cf23) => safeModuloInt(cf23, cf20)
			case DC11(cf24, cf25, cf26, cf27) => v32
			case DC9(cf18) => v32
			case DC12(cf28) => 0x2df
		};
		var v51: array<int> := new int[13];
		v51[safeIndex(251, v51.Length)] := v32;
		var v52: multiset<int> := multiset{v32};
		v51[safeIndex(251, v51.Length)] := -|(multiset{fm0(f21, globalState)} + (v52 * v52))|;
		var v53: seq<int> := [v32, v51[safeIndex(251, v51.Length)], 0x234];
		r0 := (seq(abs(0x219), i4  => (v32))) < v53;
...
class C9 extends T0 {
	...
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		var v0 := 'v';
		var v1: seq<seq<char>> := [f19[safeIndex(f12, |f19|) := v0], [v0]];
		var v2: array<seq<char>> := new string[28] [if (p2) then f19 else ['h'], seq(abs(0x65), i0  => ('r')), (p0 + (seq(abs(-0x12e), i1  => ('k'))))[safeIndex(0x2c3, |(p0 + (seq(abs(-0x12e), i1  => ('k'))))|) := 'x'], p0, p0, (seq(abs(0x202), i2  => (f19[safeIndex(p3, |f19|)])))[safeIndex(|f19|, |(seq(abs(0x202), i2  => (f19[safeIndex(p3, |f19|)])))|) := v0], v1[safeIndex(f12, |v1|)], f19, ['u', v0, v0] + (seq(abs(0x3e), i3  => (v0))), v1[safeIndex(f11, |v1|)] + p0, f19, f19, p0 + f19, f19 + f19, p0, f19, seq(abs(0xfd), i4  => (v0)), f19, p0, [v0, v0, v0], [v0] + f19, [v0, v0], [v0], f19, f19, f19 + p0, p0, if (f20) then p0 else f19];
		v2 := v2;
		...
		globalState.f2, globalState.f7, v4 := v5[safeIndex(f11, |v5|)] == safeDivisionInt(p1, p1), if (v3 in v7) then v7[v3] else p2, seq(abs(149), i7  => (v0));
	...
	method m6(p0: int, p1: char, p2: bool, p3: int, globalState: GlobalState) returns (r0: seq<bool>, r1: bool, r2: bool, r3: int) {
		...
		var v2: seq<set<bool>> := [v1[safeIndex(p3, |v1|)], {f20}, v0];
			...
			decreases 100 - i0
		{
			...
			var v13: array<int> := new int[13] [0x39c, fm0(f20, globalState), p3, p0, f11, |v11[|map[0x2d6 := p2]| := abs(p0)]|, f11, |f19|, f12, p3, |v12|, |v10|, f12];
			var v14: map<int, array<int>> := map[f11 := v13];
			var v15: C2 := new C2(f12, v10, |(seq(abs(0x3d8), i1  => (p3)))|, p3);
			var v16 := DC53(p0, v12, -p3, v15);
			var v17 := DC1(p2, 0x376);
			var v18: array<D18> := new D18[20] [DC53(|v14|, v12, p0, v15), v16, v16, if (true) then v16 else v16, v16, v16, if (v17.cf1) then v16 else v16, v16, v16.(cf100 := v12, cf99 := f12), v16, v16, v16, v16, v16, v16, DC53(|"qmmc"|, v12, |v10[safeIndex(p0, |v10|) := p1]|, v15).(cf102 := v15), if (false) then v16 else v16, v16, v16, v16];
			v18[safeIndex(338, v18.Length)] := v16;
			var v19: seq<int> := [p3, p3];
			globalState.f6, r3, v18[safeIndex(338, v18.Length)], r1 := p3, --(|(v19 + [p3])| * v15.f27), v16.(cf100 := {p0}, cf102 := v15), 55 != 0x1f7;
			...
			match (v6) {
				case DC7(cf10, cf11, cf12, cf13, cf14) =>
					...
					v22[safeIndex(474, v22.Length)] := v19 + v19;
					v22[safeIndex(474, v22.Length)] := fm48(globalState);
					var v23 := 'f';
					...
					globalState.f2, globalState.f2, globalState.f7, globalState.f6, v23 := true && p2, p2, !(v25 !! (v25 + (if (p2 in v26) then v26[p2] else v25))), safeModuloInt(safeModuloInt(|v0|, cf14), v22[safeIndex(474, v22.Length)][safeIndex(|((seq(abs(-0x222), i3  => ('g')))[safeIndex(cf13, |(seq(abs(-0x222), i3  => ('g')))|) := p1])[safeIndex(f11, |(seq(abs(-0x222), i3  => ('g')))[safeIndex(cf13, |(seq(abs(-0x222), i3  => ('g')))|) := p1]|) := v23]|, |v22[safeIndex(474, v22.Length)]|)]), f19[safeIndex(v15.f27, |f19|)];
				...
				case DC6(cf9) =>
					...
					v35[safeIndex(733, v35.Length)] := v37;
					v35[safeIndex(733, v35.Length)], globalState.f2, globalState.f7 := v37, (f20 <== f20) && f20, safeDivisionInt(|v10|, |"otjwwaac"|) > f12;
		...
		forall i4 | 0 <= i4 < v41.Length {
			v41[i4] := safeModuloInt(i4, safeDivisionInt(262, f12));
		}
		var i5 := 0;
		while (p2)
			decreases 100 - i5
		{
			...
			v45[safeIndex(407, v45.Length)] := p2;
			var v46: multiset<int> := multiset{f12};
			globalState.f6, v10, v45[safeIndex(407, v45.Length)] := -f12, f19, v46 !! v46;
			globalState.f7 := !(p2 || f20);
			v41[safeIndex(45, v41.Length)] := f12;
			v41[safeIndex(45, v41.Length)] := -p3;
			var v47: multiset<bool> := multiset{f20, true};
			var v48: C2 := new C2(|v47|, f19, v41[safeIndex(45, v41.Length)], |(seq(abs(-99), i6  => (|multiset{p3, p0, 0x128}|)))|);
			var v49: map<int, C2> := map[v41[safeIndex(45, v41.Length)] := v48];
			var v50: array<D3> := new D3[9];
			var v51: map<array<D3>, map<int, C2>> := map[v50 := v49];
			var v52: map<int, map<int, C2>> := map[safeDivisionInt(199, p3) := v49 + (if (v50 in v51) then v51[v50] else v49)];
...
class C10 extends T3 {
	...
	method m3(p0: map<array<bool>, int>, p1: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: T0) {
		...
		var v2: map<array<int>, set<bool>> := map[v0 := {v1[safeIndex(--0x4c, |v1|)], f15, f15, f18}];
		v2, r1 := v2 + v2, f15;
		...
		match (v3) {
			case DC1(cf1, cf2) =>
				...
				v4[safeIndex(280, v4.Length)] := f13;
				v4[safeIndex(280, v4.Length)] := f13;
				var v5: seq<int> := [cf2, f11, f14, f11];
				v5 := v5;
				var v6 := DC8(p1, f18, f16);
				v4[safeIndex(280, v4.Length)] := v6.cf17[safeIndex(-0x1d8, |v6.cf17|) := 'g'];
			case DC0(cf0) =>
				var v7: array<bool> := new bool[7];
				var v8: map<int, array<bool>> := map[f14 - f12 := v7];
				v8 := v8[-0xe4 := v7];
				v0[safeIndex(326, v0.Length)] := f14;
				...
				v0[safeIndex(326, v0.Length)] := (if (!f18 in v9) then v9[!f18] else -fm0(fm1(f14, p1, false, globalState), globalState)) + |v14|;
				v0[safeIndex(326, v0.Length)] := f14;
				var v15: map<string, int> := map[f16 := |f16|];
				var v16: map<int, bool> := map[|v15| := f15];
				globalState.f6 := if (f15) then v0[safeIndex(326, v0.Length)] else |(v16 + v16[-0xfb := f18])|;
		}
		
		var v17: array<bool> := new bool[24];
		v17[safeIndex(701, v17.Length)] := f18;
		var v18: seq<array<int>> := [v0, v0];
		var v19: seq<seq<array<int>>> := [v18];
		var v20: array<seq<array<int>>> := new seq<array<int>>[20] [v18, v18, v18, v19[safeIndex(f11, |v19|)] + v18[safeIndex(552, |v18|) := v0], v18, v18 + v18, v18[safeIndex(f12, |v18|) := v0], if (p1) then v18 else ([v0, v0])[safeIndex(f12, |[v0, v0]|) := v0], v18 + v18, v18, [v0, v0, v0], v18, v18, if (f15) then v18 else [v0, v0], v18[safeIndex(811, |v18|) := v0], v18, v18, v18, [v0], v19[safeIndex(f11, |v19|)] + v18];
		v20[safeIndex(166, v20.Length)] := v18[safeIndex(0x213, |v18|) := v0];
		var v21 := DC9([v0]);
		v17[safeIndex(701, v17.Length)], r0, globalState.f2, v20[safeIndex(166, v20.Length)], globalState.f6 := p1, 0xa3, f18, v21.cf18, f12;
		var v23: set<int> := {0x281, f11};
		var v24: map<bool, char> := map[(set v22 : int | (0x147 <= v22) && (v22 < 0xa9) :: (safeDivisionInt(v22, f11))) >= v23 := fm5(globalState)];
		var v25 := 'e';
		v24 := v24[if (p1) then f15 else false := v25];
		v0[safeIndex(997, v0.Length)] := |"ouawvkk"|;
		v0[safeIndex(997, v0.Length)] := if (p1) then f11 else 0x20d;
		r0 := f14;
		r1 := v1[safeIndex(|v23|, |v1|)];
	...
	method m4(p0: array<bool>, globalState: GlobalState) returns (r0: int, r1: seq<int>) {
		...
		if (!fm69(v2, f14 * f11, v5, f12, globalState)) {
			if (f15) {
				...
				v8[safeIndex(851, v8.Length)] := safeModuloInt(fm4(if (f11 in v9) then v9[f11] else -971, f11, v2, v3, globalState), |v10|);
				v8[safeIndex(851, v8.Length)] := f11;
				var v11, v12, v13 := m5(globalState);
				var v14: multiset<array<bool>> := multiset{p0};
				v14 := v14;
				r0 := safeDivisionInt(-f11, f14) * (if (v2) then f11 else v8[safeIndex(851, v8.Length)]);
			} else {
				var v15: C4 := new C4(f17, f12, v3, f17, safeDivisionInt(f14, --f14), if (f18) then f12 else f14);
				v15 := v15;
				globalState.f7 := v3;
				globalState.f6 := f12;
			...
			globalState.f6, p0[safeIndex(615, p0.Length)], f16 := if (v3 in v19) then v19[v3] else f14, v20 >= ({v23, v23, v24[safeIndex(-f12, |v24|)]} + v20), if (v2) then f13 else f17;
			var v25: set<int> := {f12, f14};
			var v26, v27 := m0(f18, v3, |v25|, f14, globalState);
			if (v26) {
				globalState.f7 := v3;
				globalState.f6 := safeDivisionInt(|v1|, f14 - -f14);
				globalState.f7 := v26;
				var v28: map<bool, array<bool>> := map[p0[safeIndex(615, p0.Length)] := v4];
				var v29: map<int, array<bool>> := map[f12 := v4];
				v28 := v28[v2 := if (f11 in v29) then v29[f11] else v4];
				var v30 := new C7();
			} else {
				p0[safeIndex(615, p0.Length)] := f11 > (|v22| + f12);
				...
				v31[safeIndex(997, v31.Length)] := v32;
				var v33: map<int, multiset<multiset<int>>> := map[f14 := multiset{v23}];
				p0[safeIndex(615, p0.Length)], v31[safeIndex(997, v31.Length)] := f11 >= f11, if (v2) then v32 * v32 else if (fm2(f14, f18, f11, f15, globalState) in v33) then v33[fm2(f14, f18, f11, f15, globalState)] else multiset(v24);
				globalState.f6 := |(v1 * (v1 + v1))|;
				var v34: array<set<C2>> := new set<C2>[4];
				var v35: T1 := new C6(seq(abs(0x36a), i3  => (map[f11 := f15])), f12, !v3, f17, f14, f11);
				...
				var v39: set<C2> := {v38};
				v34[safeIndex(707, v34.Length)] := v39;
				var v40: seq<set<C2>> := [v39, v39];
				v34[safeIndex(707, v34.Length)], v38.f27, p0[safeIndex(615, p0.Length)], globalState.f7, globalState.f2 := v40[safeIndex(0x4c, |v40|)] * v39, fm0(f15, globalState), v26, f15, v35.f12 < v35.f11;
				var v41: seq<array<bool>> := [v4, v4, v4, v4, v4];
				var v42: multiset<array<bool>> := multiset{v41[safeIndex(f14, |v41|)]};
			...
			var v48: T0 := new C1(if (f11 in v44) then v44[f11] else v4, safeModuloInt(|v45|, f14), f11, 0x151, v46 < v46, v47.cf75);
			v48 := v48;
		} else {
			f16 := f13;
			f16 := f13 + (f13 + f16);
			...
			v53[safeIndex(179, v53.Length)] := v51;
			v53[safeIndex(179, v53.Length)] := v51;
			...
			v59[safeIndex(469, v59.Length)] := v58[v4 := v57];
			var v60: map<bool, char> := map[v3 := v0];
			v59[safeIndex(469, v59.Length)], globalState.f2, v0 := v58, f18, fm21(|(v60 + v60)|, f18, globalState);
		}
		
		var v61: seq<string> := [f13, f13];
		var v62: map<bool, bool> := map[f18 := false];
		var v63: multiset<int> := multiset{-|map[f14 := v62]|};
		var v64 := DC10(v3, f12, map[f16 := f14], v61[safeIndex(-|v62|, |v61|)], |v63|);
		var v65 := DC0(v5);
		var v66: array<string> := new string[23] [v64.cf22, "qytdjteat", f16 + "ubnvsov", "fphrhl" + f17, f16, f17 + f16, f16, f17, "jrv" + f17, "wuoqrwen", f13, seq(abs(0xff), i5  => (v0)), f16, f17, fm44(|(seq(abs(0x36b), i6  => (f11)))|, v3, globalState), f17, f17, f16, DC8(v2, f18, f16).cf17 + f17, f13[safeIndex(f14, |f13|) := v0] + fm31(v0, v65, globalState), "ghpfxsjx", "fx", f16 + "c"];
		forall i4 | 0 <= i4 < v66.Length {
			v66[i4] := "abjfwpiw" + v61[safeIndex(f12, |v61|)];
		}
		r0 := f11;
	...
	method m2(p0: array<bool>, p1: multiset<int>, globalState: GlobalState) returns (r0: bool, r1: multiset<int>) {
		p0[safeIndex(960, p0.Length)] := f15;
		p0[safeIndex(960, p0.Length)] := if (false) then f15 else f18;
		for i0 := fm0(p0[safeIndex(960, p0.Length)], globalState) to f14 {
			globalState.f6 := f14;
			var v0 := 'j';
			f16 := (f13 + f17)[safeIndex(f11 * 963, |(f13 + f17)|) := v0];
			var v1: array<int> := new int[9](i1 => safeModuloInt(i1, f12));
			var v2: map<array<int>, int> := map[v1 := 0x42];
			var v3 := DC63(|multiset{|v2|}|, f15, p0[safeIndex(960, p0.Length)]);
			var v4: map<int, bool> := map[f14 := f15];
			var v5: array<int> := new int[5] [f14, f14, v3.cf118, f14, fm4(|v4|, 0x191, p0[safeIndex(960, p0.Length)], f15, globalState)];
			var v6: map<bool, array<int>> := map[p0[safeIndex(960, p0.Length)] := v1];
			var v7: array<map<bool, array<int>>> := new map<bool, array<int>>[11] [v6, v6, map[f18 := v5], v6, map[p0[safeIndex(960, p0.Length)] := v1], v6, v6, map[f18 := v1], v6, v6, v6];
			v7[safeIndex(216, v7.Length)] := v6 + v6;
			v5[safeIndex(126, v5.Length)] := f12;
			var v8 := DC15(-f11);
			var v9 := DC8(false, f15, f16);
			var v10: map<D2, map<bool, array<int>>> := map[v9 := v6];
			globalState.f6, globalState.f6, v7[safeIndex(216, v7.Length)], v5[safeIndex(126, v5.Length)], p0[safeIndex(960, p0.Length)] := v8.cf32, i0, if (fm39(globalState) in v10) then v10[fm39(globalState)] else v6, f11, f15;
		...
		match (v11) {
			case DC1(cf1, cf2) =>
				var v12: set<int> := {cf2};
				globalState.f7 := v12 !! (v12 + (set v13 : int | v13 in p1 :: (safeDivisionInt(v13, 0x133))));
				...
				var v18: array<array<array<D7>>> := new array<array<D7>>[25] [if (f18) then v15 else v15, v15, v15, v15, v15, v16[safeIndex(f14, |v16|)], v15, v15, v15, v15, if (cf1) then v15 else v15, v15, if (cf2 in v17) then v17[cf2] else v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, v15, if (cf1) then v15 else v15];
				v18[safeIndex(583, v18.Length)] := if (cf2 in v17) then v17[cf2] else v15;
				var v19: array<bool> := new bool[13](i2 => f15);
				v18[safeIndex(583, v18.Length)], v19 := if (f18) then v15 else v15, v19;
			...
			case DC0(cf0) =>
				if (f18) {
					...
					var v26: map<int, int> := map[safeModuloInt(fm4(-f11, -0x2d9, f18, true, globalState), |v25|) := f12];
					...
					v31[safeIndex(645, v31.Length)] := v30;
					v31[safeIndex(645, v31.Length)] := v30;
					var v32 := new C3(f15, f16, f16, f14, (seq(abs(278), i4  => (v31[safeIndex(645, v31.Length)]))) < f17, f17, -f12, f12);
					var v33: seq<C3> := [v32];
					p0[safeIndex(960, p0.Length)] := v32.fm1(f14 + 0x110, f18, v32 !in v33, globalState);
				} else {
					var v34: seq<bool> := [f18];
					var v35 := DC40(v34);
					var v36: seq<D14> := [v35, v35, DC40(v34)];
					v36 := v36;
					var v37: C3 := new C3(!f15, "jm", f17, f14, p0[safeIndex(960, p0.Length)], f17, f11, f12);
					var v38: set<C3> := {v37};
				...
				v43 := v43;
				globalState.f2 := p0[safeIndex(960, p0.Length)];
				var v45: seq<map<int, bool>> := [map v44 : int | (0x39b <= v44) && (v44 < 0x355) :: (safeModuloInt(v44, f11)) := (true)];
				...
				var v51 := DC13(v50);
				v49 := v49[safeDivisionInt(f11, f14) := v48 + map[f15 := |v51.cf29|]];
		}
		...
		var v57 := new C9((f16 + f13)[safeIndex(-0x2c9, |(f16 + f13)|) := v54], v55[safeIndex(f12, |v55|)] && v55[safeIndex(0xbf, |v55|)], f11 + f12, |v56|);
		r0 := (f11 + f14) > f14;
		r1 := p1 * p1;
	}
	method m1(p0: string, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		globalState.f6 := -safeModuloInt(p1, |{p1}|) + f12;
		var v12 := 'f';
		...
		var v17: T3 := new C3(f15, f13[safeIndex(|v16|, |f13|) := v12], f13, f11, p2, p0, |f17|, |p0|);
		...
		var v23: map<bool, string> := map[p2 := if (p2 in v22) then v22[p2] else seq(abs(0x3d3), i2  => (v12))];
		var v24: set<int> := {-v17.f12, v17.f12, -|v16|, |(seq(abs(0x1a8), i3  => (v12)))|};
		...
		v25[safeIndex(495, v25.Length)] := |v14| != v17.f14;
		var v26: set<bool> := {p2};
		v25[safeIndex(495, v25.Length)] := true ==> (v26 > v26);
		var v27: set<array<bool>> := {v25};
		var v28 := DC55(v27);
		match (v28) {
			case DC56(cf105, cf106, cf107, cf108) =>
				globalState.f2 := p2 && ("rrj" <= f13);
				if (v25[safeIndex(495, v25.Length)]) {
					cf105[safeIndex(391, cf105.Length)] := v17.f11;
					cf105[safeIndex(391, cf105.Length)] := |fm74(false, cf106, v17.f11, globalState)|;
					cf106 := v16[safeIndex(safeModuloInt(0x228, v17.f11), |v16|)];
					v17.f16 := (p0 + f16) + f13;
					cf105[safeIndex(391, cf105.Length)] := f11;
					r0 := !v25[safeIndex(495, v25.Length)];
				} else {
					...
					v31 := new C2(|(seq(abs(815), i4  => (v12)))| * -0x44, v17.f13 + f16, v17.f14, 827);
					var v32: set<multiset<int>> := {v20};
					v32, v25, v25[safeIndex(495, v25.Length)], v31.f27 := v32, v25, v17.f15, safeModuloInt(v17.f12, v17.f12);
				...
				r1 := 0x307;
				globalState.f6 := safeModuloInt(v17.f11, v17.f14);
			case DC55(cf104) =>
				var v35 := DC49(fm0(f15, globalState));
				match (v35) {
					case DC48(cf90, cf91, cf92) =>
						var v36 := new C8(v25[safeIndex(495, v25.Length)], cf90);
						var v37 := DC52(cf91, v17.f15, (seq(abs(0xc7), i5  => (v12)))[safeIndex(-|[f12]|, |(seq(abs(0xc7), i5  => (v12)))|) := v12]);
					...
					case DC49(cf93) =>
						var v42: map<bool, bool> := map[v17.fm1(v17.f12, false, v25[safeIndex(495, v25.Length)], globalState) := v25[safeIndex(495, v25.Length)]];
						v42 := v42[fm69(v17.f15, f12, v13, |v26|, globalState) := v17.f15];
						v19 := v19[|map[v17.f14 := v17.f15]| := v17.f14];
						globalState.f2 := !!(p1 > cf93);
						v25[safeIndex(495, v25.Length)] := v17.f15;
					case DC50(cf94) =>
						globalState.f6 := v17.f12;
						var v43: map<set<int>, bool> := map[v24 - v24 := f15];
						v43 := v43[v24 * v24 := true];
						var v44 := new C3(p2, v17.f13, v17.f16, --f14, v17.f15, seq(abs(0xd4), i6  => (v12)), v17.f11, f12);
						var v45 := DC46(v26 + v26, fm8(p2, v25[safeIndex(495, v25.Length)], v17.f15, |f17[safeIndex(v17.f12, |f17|) := v12]|, globalState), cf94);
						v45 := v45;
					case DC47(cf89) =>
						v25[safeIndex(495, v25.Length)] := false;
						var v46 := DC21(f18);
						var v47: map<int, char> := map[p3 := v12];
						v46 := DC21(v17.fm1(|v47|, v17.f15, v25[safeIndex(495, v25.Length)], globalState));
						var v48, v49 := v17.m4(v25, globalState);
						globalState.f6 := v17.f11;
				}
				
				globalState.f2 := v25[safeIndex(495, v25.Length)];
				if (!(-v17.f14 <= f12)) {
					var v50 := DC43(v17.f12, f18, p2);
					globalState.f6, v19, r1 := 0xf7, v19, v50.cf77;
					var v51: array<char> := new char[23];
					v51[safeIndex(668, v51.Length)] := v12;
					v51[safeIndex(668, v51.Length)] := v12;
					...
					var v55: map<array<bool>, bool> := map[v25 := v25[safeIndex(495, v25.Length)]];
					v52, globalState.f6, globalState.f6, v25[safeIndex(495, v25.Length)], v53 := v52, safeModuloInt(|v52|, -|v20|) + fm2(v17.f11, v17.f15, v17.f11, true, globalState), safeModuloInt(|(v54 + v54)|, p1), if (v25 in v55) then v55[v25] else p2, fm76(|(if (v17.f15) then v19 else v19)|, globalState);
					v21 := v21 + v21;
					globalState.f2 := v17.f15;
				} else {
					var v56: map<bool, bool> := map[!p2 := v17.f15];
					globalState.f2 := (if (v25[safeIndex(495, v25.Length)] in v56) then v56[v25[safeIndex(495, v25.Length)]] else v25[safeIndex(495, v25.Length)]) ==> (if (v17.f12 in v15) then v15[v17.f12] else v17.f15);
					var v57: map<bool, int> := map[f18 := v17.f11];
					v57 := v57[v24 !! v24 := v17.f12];
					var v58: array<int> := new int[29](i7 => i7 + v17.f14);
					v58[safeIndex(300, v58.Length)] := 0x370;
					var v59 := DC15(if (v17.f15 in v14) then v14[v17.f15] else -0x3d3);
					v58[safeIndex(300, v58.Length)] := v59.cf32;
					var v60: map<bool, char> := map[f18 := v12];
					v60 := v60;
					var v61: set<multiset<bool>> := {v14};
					var v62: seq<multiset<bool>> := [multiset(v16)];
					v58[safeIndex(300, v58.Length)], v61, v58[safeIndex(300, v58.Length)] := -p1, (set v63 : multiset<bool> | v63 in v62 :: (v63)) - (v61 * v61), -994;
				}
				
				var v64: array<array<C5>> := new array<C5>[15];
				var v65: array<C5> := new C5[13];
				v64[safeIndex(385, v64.Length)] := v65;
				r2, globalState.f6, v64[safeIndex(385, v64.Length)] := -(if (f11 in v20) then v20[f11] else 0x10d), v17.f14, v65;
		}
		
		var v66: C4 := new C4(f13, f12, p2, "e", v17.f11, |{v12, fm14(f15, 'g', f12, v17.f15, globalState), v12, v12}|);
		var v67: set<C4> := {v66, v66};
		for i8 := -(if (!fm7(v25[safeIndex(495, v25.Length)], if (v17.f15 in v14) then v14[v17.f15] else f11, globalState)) then -v17.f12 else |v67|) to 0x310 {
			r0 := fm0(f15, globalState) == safeDivisionInt(f11, p1);
			...
			var v74: array<map<set<bool>, array<int>>> := new map<set<bool>, array<int>>[22] [v70 + v70[v26 := v69], v70 + map[v26 := if (|v26| in v71) then v71[|v26|] else v69], v70, map[if (v17.f15 in v72) then v72[v17.f15] else v26 := v69] + v70, v70, v70, v70, v70, v70, v70, v70 + v70, v70 + v70, DC71(map[v26 := v69]).cf130, v70, v70, v70, v70 + v70, map[{v17.f15} := v69], map[v26 := v69] + v73[safeIndex(f14, |v73|)], v70, v70 + v70, v70];
			v74[safeIndex(772, v74.Length)] := v70;
			v74[safeIndex(772, v74.Length)] := v70 + v70[v26 := v69];
		...
		for i9 := p3 to p1 {
			...
			var v82: array<int> := new int[15] [|v15|, i9, fm0(!f18, globalState), -|(if (v77 in v78) then v78[v77] else p0)[safeIndex(-v17.f14, |(if (v77 in v78) then v78[v77] else p0)|) := v12]|, v17.f11, v17.f14 - f14, p1, if (fm31(v12, v79, globalState) in v0) then v0[fm31(v12, v79, globalState)] else |v26|, v17.f12 * v77.f27, v17.f11, safeModuloInt(-f11, v17.f12), v17.f12, 13, f14, fm4(|v80|, v81.cf31, false, false, globalState)];
			v82 := v82;
			...
			if (f18) {
				...
				globalState.f6 := v17.f12;
				globalState.f6 := p1;
				var v84 := DC8(!f15, p2, seq(abs(364), i10  => (v12)));
				var v85: map<bool, int> := map[p2 := v17.f14];
				var v86: map<map<bool, int>, int> := map[v85 := 0x1e3];
				var v87 := new C2(i9, v84.cf17, |v86|, f11);
			} else {
				r1 := v77.f27;
				globalState.f2 := if (v17.f15 || v25[safeIndex(495, v25.Length)]) then v17.f15 else true;
				v77.f27 := -p3;
				var v88: map<multiset<bool>, int> := map[v14 := p1];
				v88 := v88[v14 := i9];
				var v89: seq<C4> := [v66];
				v26, v14, v77.f27 := {false, v17.f15, false} + v26, multiset{v89 < v89, p2, v17.f15, v25[safeIndex(495, v25.Length)], f18}, v17.f12 * v17.f12;
			}
			
		}
		var v90: multiset<string> := multiset{v17.f13};
		var v91: seq<multiset<string>> := [v90, v90];
		r0 := f18 <== (v91[safeIndex(v17.f14, |v91|)] !! v90);
		r1 := v17.f11;
		r2 := 0x341;
	}
	method m5(globalState: GlobalState) returns (r0: set<bool>, r1: bool, r2: bool) {
		...
		var v2 := DC0(v1);
		f16, globalState.f6 := fm31('g', v2, globalState), safeDivisionInt(f12, f11);
		globalState.f6 := f11;
		...
		match (v6) {
			case DC64(cf121) =>
				...
				var v10: map<int, char> := map[f11 := f16[safeIndex(f12, |f16|)]];
				...
				v15[safeIndex(132, v15.Length)] := v14;
				globalState.f7, globalState.f7, r2, v15[safeIndex(132, v15.Length)] := f18, !f18, f18, v14;
				var v16: seq<int> := [f11];
				var v17: multiset<string> := multiset{(f17[safeIndex(|f17|, |f17|) := v0])[safeIndex(|v16|, |f17[safeIndex(|f17|, |f17|) := v0]|) := v0]};
				var v18 := DC57(v17);
		...
		r0 := v23;
		r1 := f15;
		var v24: map<string, char> := map[seq(abs(0x1a4), i3  => (v0)) := v0];
		r2 := f16 !in v24;
	}
}

function fm0(p0: bool, globalState: GlobalState): int {
	-match if (DC77(|(map v0 : int | v0 in (map v1 : int | v1 in (seq(abs(0x1ee), i0  => (DC34(true, false, 0x3b6, false, false).cf60))) :: (safeModuloInt(v1, -0x3b4)) := (false)) :: (safeModuloInt(v0, |map[|{|multiset{500}|, |"a"|}| := !false]|)) := (|[357]|))|, true).cf141) then DC72(141, !false, |{true}|) else DC72(353, true, |[!true]|) {
...
function fm7(p0: bool, p1: int, globalState: GlobalState): bool {
	|(map[false := |[278, 0x2cb]|] + map[true := |multiset{0x136, |map[-0x21a := !DC3(true).cf4]|}|])| in ((map v0 : int | v0 in [|[false, true]|, |"hyrbgem"|, |"tjbkt"|, 0x1a1, |{false, !false, true}|] :: (safeDivisionInt(v0, 156)) := ("ybcsqf")) + map[|map[false := !true]| := seq(abs(638), i0  => ('o'))])
}
...
function fm23(p0: int, p1: int, globalState: GlobalState): seq<string> {
	["v"] + ((seq(abs(-0x2d9), i0  => ("wv"))) + ["gvir", "mskma"])
}
function fm25(p0: int, p1: bool, globalState: GlobalState): multiset<int> {
	if (false) then multiset{|(seq(abs(-0x21c), i0  => ('p')))|} else multiset(DC13([0x8d, |map[false := 0x6e]|]).cf29) * multiset([262])
}
function fm27(p0: int, p1: bool, globalState: GlobalState): D3 {
	if (multiset{|{!true}|, |multiset{false}|} !! DC37(multiset{985}).cf67) then DC10(!false, -DC49(|map[false := false]|).cf93, map["uoj" := |(map v0 : int | (-0x97 <= v0) && (v0 < 0x3ad) :: (v0 * 0x32a) := (!false))|], "nq", -299) else DC10(!false, |(map v1 : int | (0xc9 <= v1) && (v1 < 0x271) :: (safeDivisionInt(v1, 0x1f)) := (513))|, map["hw" := |map['x' := false]|], seq(abs(0x2c2), i0  => ('h')), |{[true]}|)
}
function fm28(p0: bool, p1: bool, p2: bool, p3: D1, globalState: GlobalState): D1 {
	DC2('v')
}
function fm29(globalState: GlobalState): set<int> {
	{|(seq(abs(0xcb), i0  => ('r')))|, 0x2cb, |map[-0x3c := |[--858]|]|, -|"anvvoyeki"|} + (set v0 : int | v0 in [|{"u"}|, |[|multiset{true, false}|, 0x3c]|] :: (v0 - |"wnkd"|))
}
...
function fm38(p0: int, p1: string, p2: bool, globalState: GlobalState): seq<map<int, bool>> {
	match DC36(932, -0x331, |map[DC15(0x20d) := false]|) {
		case DC36(cf64, cf65, cf66) => if (false) then [map[|['a', 'o']| := false]] else [map v0 : int | (0x282 <= v0) && (v0 < -0x1be) :: (safeModuloInt(v0, cf64)) := (false), map[|multiset{true}| := true], map[cf64 := true], map[cf66 := true], map[170 := true]]
		case DC35(cf63) => [map[|DC13([0x57]).cf29| := !true], map[|multiset{0x2a8}| := true]]
	}
}
function fm39(globalState: GlobalState): D2 {
	DC8(!true && true, -0x299 >= |map[map[false := false] := |"m"|]|, seq(abs(765), i0  => ('w')))
}
function fm42(p0: int, p1: bool, p2: map<int, int>, globalState: GlobalState): map<int, bool> {
	map[safeModuloInt(0x8a, 0x124) := true in [false]]
}
function fm43(p0: bool, p1: bool, globalState: GlobalState): seq<bool> {
	[(set v0 : int | (0x335 <= v0) && (v0 < 0x1de) :: (safeModuloInt(v0, |(map v1 : int | v1 in map[|(map v2 : int | (0x35a <= v2) && (v2 < -901) :: (v2 + -710) := (false))| := -0x3c8] :: (v1 - |[false, false]|) := (-240))|))) >= {-|map[false := 'd']|}]
}
function fm44(p0: int, p1: bool, globalState: GlobalState): string {
	seq(abs(0x395), i0  => (if (!!true) then DC2('m').cf3 else 'o'))
}
function fm45(p0: int, p1: bool, p2: string, globalState: GlobalState): map<int, set<int>> {
	map v0 : int | v0 in map[0x332 := [999]] :: (safeModuloInt(v0, 81)) := ({839, 0x321, 0x3, 257} - (set v1 : int | v1 in [|[-0x1f0]|, 812] :: (safeDivisionInt(v1, 0x30d))))
}
function fm46(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): D3 {
	match DC57(multiset{"hbuaxrp", "gljasqy", seq(abs(-0x2ab), i0  => ('j')), seq(abs(0x1bd), i1  => ('m'))}) {
		case DC58(cf110) => DC11(712, DC8(cf110, cf110, seq(abs(0x297), i2  => ('g'))), {DC0(multiset{'q'}), DC0(multiset{'d'}), DC0(multiset{'s', 'e'})}, cf110)
...
function fm48(globalState: GlobalState): seq<int> {
	[|(seq(abs(-0x1da), i0  => ('w')))|, -|({multiset{true}, multiset([true, !!false]), multiset{true}} + {multiset{false, true, true}, multiset{false, true}})|]
}
...
function fm55(globalState: GlobalState): seq<set<bool>> {
	(seq(abs(212), i0  => ({false, true}))) + ([{true}] + (seq(abs(-0x1d0), i1  => ({true, true}))))
}
...
function fm57(p0: bool, p1: int, globalState: GlobalState): map<int, string> {
	map v0 : int | v0 in {|"judqia"|, 22} :: (v0 * |(seq(abs(0x3e5), i0  => ('p')))|) := ("c")
}
function fm58(p0: int, globalState: GlobalState): seq<seq<bool>> {
	([[true]] + (seq(abs(0x88), i0  => ([!!true])))) + ((seq(abs(834), i1  => ([true]))) + (seq(abs(0x310), i2  => ([true, false]))))
}
function fm59(p0: map<bool, int>, p1: int, p2: bool, globalState: GlobalState): D4 {
	DC14('o', -0x6 + |[false]|)
}
function fm60(globalState: GlobalState): map<int, int> {
	(map[--|"cdyjih"| := -0x32e] + map[|(seq(abs(0xe), i0  => ('k')))| := |map[false := |multiset{!!false, false, false}|]|]) + (map[0x378 := 0x398] + (map v0 : int | (0x2c2 <= v0) && (v0 < 0x11c) :: (safeModuloInt(v0, |{DC41(true, true, "yurnal").cf73}|)) := (|[|map[!!false := --0xa9]|]|)))
}
function fm61(p0: bool, p1: bool, p2: bool, p3: int, globalState: GlobalState): set<set<int>> {
	{{|[813, |["aebiwlg"]|]|, 0x360, |map[true := |(seq(abs(42), i0  => (|[|"kw"|]|)))|]|}, {500, |map[0xfc := DC52(false, false, "vol")]|}}
}
...
function fm64(p0: int, globalState: GlobalState): multiset<map<int, bool>> {
	multiset{map[0x1a5 := false], map[|"prdjb"| := true]} * multiset((seq(abs(0x318), i0  => (map[794 := true]))) + [map[581 := false]])
}
function fm65(p0: bool, p1: map<bool, int>, globalState: GlobalState): D4 {
	DC13([0x7c, |{seq(abs(532), i0  => ('h'))}|, 0x167])
}
function fm66(p0: bool, p1: bool, p2: D15, p3: seq<bool>, globalState: GlobalState): seq<seq<int>> {
	seq(abs(-0x4e), i0  => ([|map[-0x371 := |[-753]|]|, |(seq(abs(-0x2b5), i1  => ('e')))|]))
}
function fm67(p0: char, globalState: GlobalState): map<map<int, bool>, int> {
	map[map v0 : int | v0 in multiset([0x2b3]) :: (v0 - |"g"|) := (!true) := -355] + (map[map[-0x69 := false] := -0x30a] + map[map v1 : int | (-0x379 <= v1) && (v1 < 0x1c4) :: (safeDivisionInt(v1, |[0x3bd, |[|map[true := true]|]|]|)) := (false) := 357])
}
...
function fm74(p0: bool, p1: bool, p2: int, globalState: GlobalState): map<bool, string> {
	map[true := "rqff"] + map[true := seq(abs(716), i0  => ('m'))]
}
function fm75(p0: bool, globalState: GlobalState): D1 {
	DC5(-|(map v0 : int | (0x339 <= v0) && (v0 < 0x286) :: (safeModuloInt(v0, |"l"|)) := (false))|, if (true) then false else true, false)
}
...
method m0(p0: bool, p1: bool, p2: int, p3: int, globalState: GlobalState) returns (r0: bool, r1: seq<bool>) {
	...
	match (v2) {
		case DC1(cf1, cf2) =>
			...
			var v5 := DC8(p0, p1, v4);
			var v6: seq<bool> := [cf1];
			var v7: array<bool> := new bool[21] [p0, DC11(p2, v5, {v2}, !cf1).cf27, p1, !(([p0])[safeIndex(p3, |[p0]|) := cf1] <= v6), p1, p0, cf1, p1, p0, p0, cf1, p0, fm69(true, |v6|, v1, p2, globalState), p2 != p2, true, cf1 ==> true, if (cf1) then cf1 else p0, !false, p1, p1, p1];
			var v8: C1 := new C1(v7, cf2, p2, p2, cf1, v4);
			var v9: seq<C1> := [v8];
			var v10: array<int> := new int[20] [-|v4|, p2, p3, p2, p3, p3, |v9|, p2, cf2, cf2, |map[0x25a := cf1]|, p3, cf2, 0x322, p3, p2, cf2, p2, |v4[safeIndex(cf2, |v4|) := v0]|, |v4|];
			var v11: map<bool, bool> := map[p0 := cf1];
			var v12: seq<map<bool, bool>> := [v11];
			var v13 := DC56(v10, cf1, p2, v12);
			v7[safeIndex(435, v7.Length)] := v13.cf106;
			v7[safeIndex(435, v7.Length)] := cf1;
			if (cf1) {
				var v14: array<string> := new string[29](i0 => v4 + "ib");
				v14[safeIndex(495, v14.Length)] := v4;
				v14[safeIndex(495, v14.Length)] := "xyhfc" + (seq(abs(0x36f), i1  => (v0)));
				v7[safeIndex(435, v7.Length)], v4, v14[safeIndex(495, v14.Length)] := cf1, v4, v4;
				v8 := v8;
				var v15: map<bool, int> := map[false := p3];
				var v16 := DC30(cf1, fm7(false, cf2, globalState), v14[safeIndex(495, v14.Length)] + (seq(abs(701), i2  => ('q'))), v15 == v15);
				v16 := v16;
				globalState.f6 := cf2;
			} else {
				var v17 := new C8(!p0, p1);
				cf2 := safeDivisionInt(safeModuloInt(p2, p2), -(-cf2 * p2));
				var v18: map<bool, string> := map[v17.f21 := v4[safeIndex(p2, |v4|) := v0]];
				var v19 := DC73(v18);
				...
				v21[safeIndex(513, v21.Length)] := v22;
				var v23: C0 := new C0();
				var v24: map<bool, int> := map[v17.f21 := fm0(v7[safeIndex(435, v7.Length)], globalState)];
				v20, v21[safeIndex(513, v21.Length)], v7[safeIndex(435, v7.Length)], cf1, v23 := if (|v4| == |v24|) then v20 else v20, v22, v17.f22, 'n' !in (seq(abs(-692), i4  => (v0))), v23;
		...
		case DC0(cf0) =>
			...
			var v31: set<bool> := {p1};
			v30[safeIndex(467, v30.Length)] := v31;
			v30[safeIndex(467, v30.Length)] := ({p0} * v31) + v31;
			globalState.f6 := if (p0) then p2 else p2;
	}
	
	var v32: map<int, bool> := map[p2 := true];
	var v33: seq<map<int, bool>> := [v32, map[p3 := p0]];
	var v34: map<int, bool> := map[|v33[safeIndex(p2, |v33|)]| := p1];
	globalState.f7 := fm69(p1, -p3, v1, safeDivisionInt(|v34|, p2), globalState);
	var v35: array<bool> := new bool[25];
	v35[safeIndex(651, v35.Length)] := p2 <= p2;
	globalState.f7, v35[safeIndex(651, v35.Length)] := p3 == fm0(p0, globalState), p0;
	var v36: set<bool> := {p0, v35[safeIndex(651, v35.Length)]};
	var v37: set<int> := {-p3};
	var v38 := "prushd";
	...
	match (if (v35[safeIndex(651, v35.Length)]) then DC53(|v36|, v37, p2, v43) else v44) {
		case DC52(cf96, cf97, cf98) =>
			v0 := v0;
			var v45 := DC15(|map[v43.f27 := -|(seq(abs(488), i6  => (v0)))|]|);
			var v46 := DC16(v45);
			var v47 := DC16(v46);
			var v48: map<bool, bool> := map[cf96 := p0];
			var v49: seq<bool> := [cf96];
			globalState.f1, r1, v47 := v48[v35[safeIndex(651, v35.Length)] := cf96] + v48, v49 + (if (cf96) then v49 else fm8(p0, v35[safeIndex(651, v35.Length)], p1, |cf98|, globalState)), v47;
			var v50: array<string> := new string[10](i7 => v39.f13);
			v50[safeIndex(470, v50.Length)] := v38;
			v50[safeIndex(470, v50.Length)] := v38;
			v50[safeIndex(470, v50.Length)] := cf98[safeIndex(p2, |cf98|) := fm11(cf96, p3, globalState)];
		case DC53(cf99, cf100, cf101, cf102) =>
			if (!v35[safeIndex(651, v35.Length)]) {
				globalState.f2 := true;
				var v51: T0 := new C1(v35, -(|{v43.f27, v39.f11}| * cf102.f27), --fm0(p1, globalState), |(seq(abs(-0x9e), i8  => (p2)))|, v35[safeIndex(651, v35.Length)], v39.f13);
				v51 := v51;
				...
				v52[safeIndex(929, v52.Length)] := v53;
				var v54: map<C2, int> := map[v43 := v39.f12];
				var v55: seq<string> := [v39.f13, seq(abs(0x27b), i9  => (v0))];
				v52[safeIndex(929, v52.Length)] := new int[17] [cf102.f27, v39.f11, cf99, 0x22a, v39.f12, |"oruuaf"|, v51.f12 - |multiset{v51.f12}|, |(("d")[safeIndex(v39.f11, |"d"|) := v0] + v38)|, -|v39.f13| - cf101, if (!v35[safeIndex(651, v35.Length)] in v41) then v41[!v35[safeIndex(651, v35.Length)]] else v43.f27, -0x1d8, |v42|, if (v43 in v54) then v54[v43] else v39.f12, v39.f12, v39.f12, p3, |v55|];
				cf99 := -safeDivisionInt(v43.fm40(v39.f12, !p1, v0, cf102.fm41(globalState), globalState), if (p1) then v39.f11 else 0x13);
				var v56: multiset<bool> := multiset{p0, p1, !p1};
				var v57: seq<bool> := [p1, v35[safeIndex(651, v35.Length)]];
				var v58: array<multiset<bool>> := new multiset<bool>[3] [v56 * v56, v56 * v56, multiset(v57)];
				v58[safeIndex(535, v58.Length)] := if (v35[safeIndex(651, v35.Length)]) then v56 else v56;
				v58[safeIndex(535, v58.Length)] := v56;
			} else {
				var v59: multiset<bool> := multiset{v35[safeIndex(651, v35.Length)], DC63(v43.f27, p0, v35[safeIndex(651, v35.Length)]).cf119, v35[safeIndex(651, v35.Length)], p0};
				globalState.f2 := v59 != v59;
				var v60: T2 := new C4(v39.f13, v39.f11 + |v41|, v35[safeIndex(651, v35.Length)], v38 + "uejn", -p3, 720);
			...
			if (false) {
				var v69 := DC10(v35[safeIndex(651, v35.Length)], cf101, map[v39.f13 := v39.f11], "aqm", v39.f11);
				...
				var v74 := DC76(v72);
				var v75: C3 := new C3(p1, seq(abs(0x104), i10  => (v0)), v39.f13, |v73[p0 := v74.cf139]|, p0, "nsnwettne", v43.f27, -834);
				var v76 := DC65(v75);
				v76 := v76;
				v43 := v43;
				...
				v78 := v78[p1 := v77];
				var v79 := new C10(v39.f13 + v38, if (v35[safeIndex(651, v35.Length)]) then v75.f25 else fm7(false, p3, globalState), v38, v39.f12 - |[cf99, v43.f27]|, p0, (seq(abs(0x283), i12  => (v0))) + v39.f13, v43.f27, v39.f12 - -p2);
			} else {
				var v80: map<bool, bool> := map[!p1 := v35[safeIndex(651, v35.Length)]];
				v35[safeIndex(651, v35.Length)] := if ((if (p1) then p0 else p0) in v80) then v80[if (p1) then p0 else p0] else !true;
				v33 := [v34] + (seq(abs(0x307), i13  => (v34[p2 := p1])));
				v32 := v32[v39.f12 := v35[safeIndex(651, v35.Length)]];
				r0 := p1;
				var v81: seq<bool> := [!(p0 && p0), p0, p0, p0 || p0, v35[safeIndex(651, v35.Length)]];
				v35[safeIndex(651, v35.Length)] := v81[safeIndex(v39.f11, |v81|)];
			}
			
			var v82: array<int> := new int[24];
			var v83: map<int, array<int>> := map[p3 := v82];
			var v84: seq<array<int>> := [v82];
			var v85: array<array<int>> := new array<int>[11] [v82, v82, v82, v82, v82, v82, if (cf99 in v83) then v83[cf99] else v82, v82, v82, v82, v84[safeIndex(p2, |v84|)]];
			var v86: map<int, int> := map[v39.f12 := v39.f11];
			v85[safeIndex(342, v85.Length)] := v84[safeIndex(|v86[|(seq(abs(446), i14  => ('e')))| := cf99]|, |v84|)];
			v85[safeIndex(342, v85.Length)] := v82;
			var v87: seq<bool> := [fm69(p0, v39.f11, v1, v43.f27, globalState)];
			match (DC43(|(v87 + v87)|, p0, if (p0) then v35[safeIndex(651, v35.Length)] else p1)) {
				case DC43(cf77, cf78, cf79) =>
					...
					v32 := v32[safeModuloInt(cf102.f27, v43.f27) := p3 !in map[cf101 := v35]];
				...
				case DC42(cf76) =>
					...
					var v92 := DC34(p0, v35[safeIndex(651, v35.Length)], 0x29c, false, v35[safeIndex(651, v35.Length)]);
					v91[safeIndex(78, v91.Length)] := [v43.f27, p2, 391, p2, fm0(v92.cf58, globalState)];
					var v93: map<int, seq<int>> := map[v39.f11 := v42];
					v91[safeIndex(78, v91.Length)], globalState.f2, r0, v35[safeIndex(651, v35.Length)] := if (v43.f27 in v93) then v93[v43.f27] else (seq(abs(-0x3de), i16  => (v39.f12)))[safeIndex(cf102.f27, |(seq(abs(-0x3de), i16  => (v39.f12)))|) := p2] + v42, p1, v35[safeIndex(651, v35.Length)] <== !v39.fm1(v39.f12, p1, true, globalState), v35[safeIndex(651, v35.Length)];
					v38 := v39.f13;
			}
		...
		case DC51(cf95) =>
			...
			var v95: multiset<bool> := multiset{p1, v35[safeIndex(651, v35.Length)]};
			v94 := fm23(if (p0 in v95) then v95[p0] else v39.f11, v39.f11, globalState);
			v0 := fm47(v43.f27, globalState);
			var v96 := new C3(p0, v38, v39.f13 + v38, v43.f27 * p2, p0 || v35[safeIndex(651, v35.Length)], "ceiapmhef" + "estmoun", v39.f11, v39.f11);
		case DC54(cf103) =>
			globalState.f2 := p0;
			var v97: array<string> := new string[29];
			v97[safeIndex(328, v97.Length)] := v39.f13;
			var v98: C4 := new C4(v39.f13, v43.f27, p1, v39.f13, v39.f12, |v32|);
			var v99: map<C4, string> := map[if (v35[safeIndex(651, v35.Length)]) then v98 else v98 := v39.f13 + v39.f13];
			v97[safeIndex(328, v97.Length)] := if (v98 in v99) then v99[v98] else seq(abs(-0x40), i17  => (v0));
			v0 := v0;
		...
		decreases 100 - i18
	{
		...
		i18 := i18 + 1;
		v43.f27 := v39.f12;
		v35[safeIndex(651, v35.Length)] := v35[safeIndex(651, v35.Length)];
		globalState.f7 := v35[safeIndex(651, v35.Length)];
		v35[safeIndex(651, v35.Length)] := p0;
	}
	v35[safeIndex(651, v35.Length)] := v43.fm1(v39.f11 * p2, p0, p1, globalState);
	r0 := !true;
...
method Main() {
	...
	var v4: array<bool> := new bool[6] [v0, v0, v0, v0, v1[safeIndex(v2, |v1|)], v0];
	var v5 := "qlvjuryaj";
	var globalState := new GlobalState(v1[safeIndex(v2, |v1|) := v0] + v1, v3, false, v4, -0x172, 'm', 0xfa, true, 0x2ee, 0x3cc, v5);
	var v6: seq<int> := [v2, |[v2]|];
	globalState.f6 := v6[safeIndex(v2, |v6|)];
	...
	var v20: map<int, map<int, int>> := map[v2 := v19[v2 := v6[safeIndex(v2, |v6|)]]];
	var v21: array<int> := new int[9] [v2, -(if (v10 in v11) then v11[v10] else v2), v2, 809, fm0(v13, globalState) * -v2, |multiset(v6[safeIndex(v2, |v6|) := v2] + v6)|, v2, |v16[safeIndex(|(if (v2 in v20) then v20[v2] else v19)|, |v16|)]|, v2];
	v21[safeIndex(953, v21.Length)] := v2;
	var v22: multiset<seq<int>> := multiset{[v2]};
	v21[safeIndex(953, v21.Length)] := fm0(v2 >= (if (v6 in v22) then v22[v6] else v2), globalState);
	if (v13) {
		var v23: map<bool, int> := map[v13 := v21[safeIndex(953, v21.Length)]];
		var v24: map<bool, int> := map[v0 := safeModuloInt(|v23|, v2)];
		v23 := v23[!(v21[safeIndex(953, v21.Length)] > v21[safeIndex(953, v21.Length)]) := v21[safeIndex(953, v21.Length)]];
		globalState.f2 := if (v0) then v0 else true;
		var v25 := new C0();
		var v26: set<bool> := {v0};
		var v27 := DC46(v26, v9, multiset{v8, if (v8 in v3) then v3[v8] else v8, v13});
		var v28, v29 := v25.m12("efayxjylm" + v5, v24, v1 == v27.cf87, safeModuloInt(if (v13 in v24) then v24[v13] else v21[safeIndex(953, v21.Length)], v21[safeIndex(953, v21.Length)]), globalState);
		v21[safeIndex(953, v21.Length)], globalState.f2, globalState.f6 := -v21[safeIndex(953, v21.Length)], v8, v2;
	} else {
		v13 := v8;
		var v30 := new C8(false, v13);
		var v31: array<string> := new string[25](i1 => "tpi" + v5);
		v31[safeIndex(834, v31.Length)] := v5 + "lcoui";
		var v32: map<bool, char> := map[v30.f21 := v10];
		var v33: array<map<bool, bool>> := new map<bool, bool>[22];
		v33[safeIndex(323, v33.Length)] := fm51(v8, fm0(v30.f22, globalState), v21[safeIndex(953, v21.Length)], |v9|, globalState);
		var v34: map<array<string>, bool> := map[v31 := !v8];
		globalState.f6, v30.f21, v31[safeIndex(834, v31.Length)], v32, v33[safeIndex(323, v33.Length)] := v21[safeIndex(953, v21.Length)], fm69(if (v31 in v34) then v34[v31] else v13, |(if (v30.f22) then v5 else v5)|, multiset(v5), v2, globalState), v5 + "x", v32, v3;
		var v35: C5 := new C5();
		...
		v21[safeIndex(953, v21.Length)], v37, globalState.f2 := 0x27c, if (v30.f22) then v38[safeIndex(v21[safeIndex(953, v21.Length)], |v38|)] else v37, v39 < fm54(v21[safeIndex(953, v21.Length)], globalState);
		var v40: T1 := new C4(v5, safeModuloInt(v21[safeIndex(953, v21.Length)], v2), v8, v5, 254, v21[safeIndex(953, v21.Length)]);
		v40 := v40;
	}
	
	var v41 := new C1(v4, v2, 0x66, v21[safeIndex(953, v21.Length)], fm7(v0, |"bu"|, globalState), v5);
	var i2 := 0;
	while (v0)
		decreases 100 - i2
	{
		...
		if (v0) {
			v41.f24 := v41.f24;
			globalState.f6 := -v6[safeIndex(|v6|, |v6|)];
			v21[safeIndex(953, v21.Length)] := |v5|;
			v21[safeIndex(953, v21.Length)] := v2;
			var v42: set<int> := {v21[safeIndex(953, v21.Length)]};
			var v43: set<set<int>> := {v42};
			var v44: map<set<set<int>>, bool> := map[v43 := v21[safeIndex(953, v21.Length)] <= v21[safeIndex(953, v21.Length)]];
			v44 := v44[v43 := v8];
		} else {
			v21[safeIndex(953, v21.Length)] := v2;
			v13 := (if (v0) then v8 else v8) <==> v0;
			v41.m14(globalState);
			var v45, v46, v47 := v41.m1(v5[safeIndex(v2, |v5|) := v10], v2, v8, if (v13) then -|v6| else 0x1f2, globalState);
			v41.f24[safeIndex(888, v41.f24.Length)] := v45;
			v8, v41.f24[safeIndex(888, v41.f24.Length)], v7 := true, false, v7 - v7;
		}
		
		var v48: set<int> := {v2, 0x4e};
		var v49 := DC45(v4, v10, |v48|, v2, v8);
		var v50: T3 := new C10(v5 + "hmwbirfxq", v5[safeIndex(v2, |v5|) := v10] != v5, "dq", |v14| + v2, v0 ==> v49.cf85, v5, safeDivisionInt(v21[safeIndex(953, v21.Length)], v2), v2);
		v50 := v50;
		var v51: seq<set<int>> := [{v50.f14, v21[safeIndex(953, v21.Length)]}];
		var v52: map<bool, int> := map[v50.f15 := v50.f14];
		var v53 := DC4(v48 < v51[safeIndex(v41.fm2(|v52|, v13, v21[safeIndex(953, v21.Length)], v8, globalState), |v51|)]);
		match (v53) {
			case DC3(cf4) =>
				v10 := v10;
				v41.f24[safeIndex(934, v41.f24.Length)] := !v8;
				v41.f24[safeIndex(934, v41.f24.Length)] := fm0(v13, globalState) != |v52|;
				v52 := v52[if (v13 in v3) then v3[v13] else v8 := v50.f14];
				globalState.f6 := fm0(false, globalState) * v50.f11;
			case DC4(cf5) =>
				v21[safeIndex(953, v21.Length)] := -v50.f11;
				v41.f24[safeIndex(538, v41.f24.Length)] := v7 >= v7;
				v48, v41.f24[safeIndex(538, v41.f24.Length)] := v48, v13;
				var v54: map<bool, string> := map[v50.f15 := v50.f16];
				var v55, v56, v57 := v50.m1(if (v41.f24[safeIndex(538, v41.f24.Length)] in v54) then v54[v41.f24[safeIndex(538, v41.f24.Length)]] else v50.f16, |map[v2 := v8]| * v50.f12, v50.f15, 0x354, globalState);
				var v58, v59, v60 := v50.m3(map[v4 := v6[safeIndex(v50.f14, |v6|)]], fm69(v41.f24[safeIndex(538, v41.f24.Length)], 0x38a, v11, v50.f11, globalState), globalState);
			case DC5(cf6, cf7, cf8) =>
				...
				v61[safeIndex(679, v61.Length)] := fm20(v8, v0, cf8, globalState);
				v61[safeIndex(679, v61.Length)] := v6;
			case DC2(cf3) =>
				v21[safeIndex(953, v21.Length)] := (if (v0 in v52) then v52[v0] else v2) - 0x125;
				v10 := cf3;
	...
	for i3 := v2 to fm0(DC8(v13, v0, "o").cf16, globalState) {
		var v65: seq<string> := [v5, seq(abs(453), i4  => ('u')), v5, v5, v5];
		v13 := v41.fm2(v2, v8, i3, v13, globalState) == |v65|;
		v21[safeIndex(953, v21.Length)] := i3 * i3;
		v10 := v10;
		...
		v68[safeIndex(509, v68.Length)] := v66;
		v68[safeIndex(509, v68.Length)] := v66;
	}
	var v69: map<array<int>, bool> := map[v21 := v8];
	v3 := v3[if (v21 in v69) then v69[v21] else v13 := v13];
	globalState.f6 := v21[safeIndex(953, v21.Length)];
	globalState.f2 := (map v70 : int | (935 <= v70) && (v70 < -0x31d) :: (safeModuloInt(v70, v21[safeIndex(953, v21.Length)])) := (v21[safeIndex(953, v21.Length)])) != (map v71 : int | (181 <= v71) && (v71 < 804) :: (safeModuloInt(v71, v2)) := (v21[safeIndex(953, v21.Length)]));
	var v72: C0 := new C0();
	var v73: multiset<C0> := multiset{v72};
	globalState.f2 := v6[safeIndex(if (v72 in v73) then v73[v72] else v21[safeIndex(953, v21.Length)], |v6|)] >= v21[safeIndex(953, v21.Length)];
	var v74: array<seq<bool>> := new seq<bool>[16](i5 => v14);
	v74[safeIndex(540, v74.Length)] := v9;
	v74[safeIndex(540, v74.Length)] := v14;
	var i6 := 0;
	while (v0)
		decreases 100 - i6
	{
		...
		i6 := i6 + 1;
		v4[safeIndex(867, v4.Length)] := v2 < -v2;
		var v75: seq<seq<int>> := [v6];
		v4[safeIndex(867, v4.Length)] := v72.fm17(if (v8) then v6 else v75[safeIndex(v21[safeIndex(953, v21.Length)], |v75|)], globalState);
		v0 := -(0x2b0 - -v21[safeIndex(953, v21.Length)]) != v2;
		var v76, v77, v78 := v41.m1(v5, 0x3a * |v5|, v0, -v2, globalState);
		var v79: map<int, seq<bool>> := map[v2 := v9];
		var v80 := DC28(v79);
		match (v80.(cf47 := v79).(cf47 := v79)) {
			case DC29() =>
				v21[safeIndex(953, v21.Length)] := safeDivisionInt(v21[safeIndex(953, v21.Length)], v2);
				var v81 := DC0(v11);
				var v82, v83, v84 := v41.m1(v5 + fm31(v10, v81, globalState), v78, v0, |(v5 + v5)|, globalState);
				v4[safeIndex(867, v4.Length)] := v82;
				var v85 := new C7();
			case DC30(cf48, cf49, cf50, cf51) =>
				v5 := cf50;
				var v86: set<int> := {v78, v78, v21[safeIndex(953, v21.Length)], v21[safeIndex(953, v21.Length)], v21[safeIndex(953, v21.Length)]};
				...
				var v92 := new C1(v41.f24, v6[safeIndex(v78, |v6|)], v41.fm2(|v91|, v4[safeIndex(867, v4.Length)], v21[safeIndex(953, v21.Length)], cf48, globalState), |(if (cf51) then cf50 else v5)|, v72.fm17([v2], globalState), "cv");
				v92.m14(globalState);
				globalState.f6 := v2;
			case DC31(cf52, cf53, cf54, cf55) =>
				...
				var v97: C6 := new C6(v94, cf54, fm7(v95.cf78, v21[safeIndex(953, v21.Length)], globalState), v5, -|v96|, v78);
				var v98: map<C6, bool> := map[v97 := v0];
				var v99: set<bool> := {cf52 != v21[safeIndex(953, v21.Length)], v76, v0, v13, if (v76) then fm7(v0, v77, globalState) else if (v97 in v98) then v98[v97] else v76};
				...
				var v102 := DC2('s');
				v10, v99, v4[safeIndex(867, v4.Length)] := v102.cf3, v99, !(if (fm7(v0, v78, globalState)) then !v8 else false && v8);
				var v103: C4 := new C4("vg", v77, v76, v5, cf52, cf52);
				var v104: set<C4> := {v103};
				v76 := -safeModuloInt(cf52, |v104|) == |(v99 + v99)|;
			case DC28(cf47) =>
				v76 := v8;
				var v105 := new C0();
				var v106: map<string, bool> := map[seq(abs(918), i7  => (v10)) := v13];
				var v107: map<bool, map<string, bool>> := map[v0 := v106];
				v4[safeIndex(867, v4.Length)] := !(if ("vmnbmsk" !in (if (v0 in v107) then v107[v0] else v106)) then v0 else v4[safeIndex(867, v4.Length)]);
				var v108: T3 := new C10(v5, v64.fm13(v2, v10, v10, globalState), v5, v77, v8, v5, v78, v21[safeIndex(953, v21.Length)]);
				var v109: map<array<int>, T3> := map[if (v4[safeIndex(867, v4.Length)]) then v21 else v21 := v108];
				v109 := v109[v21 := v108];
			case DC32(cf56) =>
				var v110: map<bool, int> := map[v4[safeIndex(867, v4.Length)] := v77];
				var v111, v112 := v72.m12("dp", v110, v13, v78, globalState);
				globalState.f2 := true;
				var v113: array<array<int>> := new array<int>[20];
				v113[safeIndex(940, v113.Length)] := v21;
				v113[safeIndex(940, v113.Length)] := v21;
				var v114: map<array<bool>, int> := map[v41.f24 := v77];
				var v115: C4 := new C4(seq(abs(670), i8  => (v10)), v2 - fm0(v76, globalState), !("gdtdq" == v5), if (v8) then v5 else v5, v78, DC18(v114, v78).cf36 * |v5|);
				v78, v21[safeIndex(953, v21.Length)], globalState.f2, v115, v110 := if (!true) then -v77 else v77 - v78, safeDivisionInt(|multiset(v74[safeIndex(540, v74.Length)])| * -v21[safeIndex(953, v21.Length)], -v78), !v4[safeIndex(867, v4.Length)], v115, v110[if (v4[safeIndex(867, v4.Length)]) then v0 else v13 := safeModuloInt(-0x2bb, 0x5a)];
		}
	...
	print v4[5], "\n";
	print v5, "\n";
	print globalState.f0 == [false, false], "\n";
	print globalState.f1 == map[false := false], "\n";
	...
	print v6 == [67, 1], "\n";
	print v7 == multiset{67, 67}, "\n";
	print v8, "\n";
	print v9 == [true], "\n";
	print v10, "\n";
	print v11 == multiset{'j', 'j', 'j', 'j', 'j'}, "\n";
	print v12[0] == multiset{'j', 'j', 'j', 'j', 'j'}, "\n";
	print v12[1] == multiset{'j', 'j', 'j', 'j', 'j'}, "\n";
	print v12[2] == multiset{'j', 'j', 'j', 'j', 'j'}, "\n";
	print v12[3] == multiset{'j', 'j', 'j', 'j', 'j'}, "\n";
	print v13, "\n";
	print v14 == [true], "\n";
	print |v15|, "\n";
	print |v16|, "\n";
