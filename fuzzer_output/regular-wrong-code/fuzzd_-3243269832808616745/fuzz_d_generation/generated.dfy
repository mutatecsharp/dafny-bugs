...
function fm15(p0: int, globalState: GlobalState): map<seq<int>, bool> {
	map[seq(882, i0  => (0x207)) := true]
}
function fm16(p0: int, globalState: GlobalState): set<int> {
	(if (true) then {0x37c, -|{false}|, |{353, -0x203}|} else {|{-214}|}) + ((set v0 : int | (-357 <= v0) && (v0 < 0x14a) :: (v0 / |[false]|)) - {|map[799 := true]|, |map[52 := true]|})
}
...
function fm25(p0: bool, p1: int, p2: D0, p3: map<int, int>, globalState: GlobalState): map<int, seq<int>> {
	if (false !in map[true := !true]) then map v0 : int | (-970 <= v0) && (v0 < -0x1cc) :: (v0 * 0x322) := ([-|"thvvevq"|, -0x1dd, 0x323, |multiset{false}|]) else map v1 : int | (0x1e8 <= v1) && (v1 < 518) :: (v1 / 567) := (seq(-0xd7, i0  => (-0x2de)))
}
function fm26(globalState: GlobalState): D1 {
	DC5('f' !in "ero")
}
function fm27(p0: seq<char>, p1: bool, p2: bool, globalState: GlobalState): D3 {
	DC10((map v0 : int | v0 in (seq(0xec, i0  => (-977))) :: (v0 / |{|"tpiay"|, |[|(set v1 : int | (0xe <= v1) && (v1 < 0x2c2) :: (v1 % |(seq(-948, i1  => ('x')))|))|, 0x293]|, 0x136}|) := (|{false, false, !true}|)) + map[-232 := 0xd])
}
...
function fm33(globalState: GlobalState): map<int, bool> {
	match DC21(map[false := false]) {
		case DC22(cf24, cf25, cf26, cf27, cf28) => (map v0 : int | v0 in multiset{|{|[0x3a6]|, |{cf27}|, -580, |cf28|, --0x23a}|} :: (v0 / -820) := (cf27)) + map[|cf28| := false]
...
function fm35(p0: string, p1: multiset<int>, p2: char, globalState: GlobalState): set<int> {
	(set v0 : int | (379 <= v0) && (v0 < -0x244) :: (v0 % 0x270)) * (set v1 : int | (-0x9 <= v1) && (v1 < 0x2a) :: (v1 % -0x1ad))
}
...
function fm43(p0: bool, p1: bool, globalState: GlobalState): set<int> {
	{--|(seq(0x317, i0  => ('n')))|} + ((set v0 : int | (0x355 <= v0) && (v0 < 3) :: (v0 / |"gsah"|)) * (set v1 : int | (-0xe8 <= v1) && (v1 < 0x112) :: (v1 - |"jynfus"|)))
}
function fm44(p0: bool, globalState: GlobalState): multiset<char> {
	multiset{'q', 's'}
}
function fm45(globalState: GlobalState): multiset<int> {
	(multiset([|[!true, true, true]|, |(seq(-0xdc, i0  => ('u')))|, |[0xec]|, |multiset{0x3cb, -640, |multiset{{!true, true}}|, |{false, true}|}|]) - multiset(seq(-0x324, i1  => (|map[[true, true] := 'x']|)))) + multiset{0x1d9, |"hmbwmks"|}
}
...
function fm47(p0: bool, globalState: GlobalState): map<int, map<bool, bool>> {
	map[|(seq(0x131, i0  => ('s')))| := map[false := true]]
}
...
function fm52(p0: bool, p1: bool, globalState: GlobalState): seq<seq<int>> {
	[seq(398, i0  => (-816)), DC13(seq(0x304, i1  => (0xf7))).cf14, [|multiset{-873}|, -|"xmsk"|], seq(0x201, i2  => (|map[0x106 := |multiset{!!true, true}|]|))]
}
...
function fm55(p0: int, p1: int, globalState: GlobalState): map<int, seq<bool>> {
	(map[0x1df := [true]] + (map v0 : int | v0 in [|(map v1 : int | v1 in multiset{|multiset{multiset{true}}|} :: (v1 % 0x43) := (true))|] :: (v0 - 520) := ([false]))) + map[|(seq(0x3d3, i0  => (DC30([{false, false}]))))| := [true, true, true]]
}
function fm56(globalState: GlobalState): seq<int> {
	([|map[true := DC21(map[false := !false])]|] + [|(set v0 : char | v0 in multiset{'v'} :: (v0))|, -|multiset{0x175}|]) + ([0x33d] + (seq(0x169, i0  => (|"xibg"|))))
}
...
function fm61(p0: map<int, int>, globalState: GlobalState): multiset<string> {
	multiset{"jemqeaufg", (seq(0x2d3, i0  => ('f'))) + "oyqd", "e" + "yk", "acxl", "kqlctexte" + "alohcbeea"}
}
...
method m0(p0: array<bool>, p1: char, p2: bool, p3: char, globalState: GlobalState) returns (r0: D0, r1: bool) {
		...
		decreases 100 - i0
	{
		...
		var v9 := "ioa";
		globalState.f1, r1, globalState.f1, r1, v9 := -fm3(p2, p2, globalState), p2, v1[v0 + -0x103], p2, v9;
		...
		decreases 100 - i1
	{
		...
		v11[938] := v12 + v12[0x91 := v0];
		v11[938] := v12;
		if (p2) {
			var v13: seq<bool> := [true, p2];
			var v14: map<bool, bool> := map[v13[v0] := p2];
			r1 := v13[|v14|];
			var v15 := DC20(p2, |v11[938]|);
			...
			v22 := v22[v19[689] := p2];
			v19[689][943] := p2;
			globalState.f1, v0, v19[689][943], r1 := -v0, -0xf3 - v0, true, v13[-v0];
		} else {
			globalState.f1 := -v0;
			var v23: array<seq<bool>> := new seq<bool>[19](i3 => [p2, p2] + [true, p2]);
			var v24: seq<bool> := [p2, p2];
			var v25: seq<bool> := [v24[|v1|], p2];
			v23[940] := v24;
			v23[940] := v25 + v24;
			var v26 := DC26(true, v0, p3);
			var v27 := new C7(0x70 + v0, |"oabcxl"| % v0, p3, v26.cf32);
			var v28: set<multiset<int>> := {v11[938], v12, v11[938]};
			r1 := (v28 + v28) == (v28 + v28);
			var v29: map<int, int> := map[-0x1bc := v27.f10];
			var v30: set<bool> := {p2, !p2};
			var v31 := "ycbrppf";
			var v32: multiset<string> := multiset{v31};
			var v33: map<bool, string> := map[p2 := seq(402, i4  => ('j'))];
			var v34: array<int> := new int[18] [v0, v0, v27.f10, |v29|, v27.f9, v0, |[v27.f10, |v30|, |v32|, |v33|]|, v27.f10, 0x228, v0, v27.f9, v0, v0, 0x3c, v27.f9, |v11[938]|, v27.f9, v27.f10];
		...
		var v37: seq<bool> := [p2];
		var v38: seq<bool> := [p2, p2, v37[v0]];
		v0 := if (if (p2) then p2 else p2) then |(v37 + v38)| else v0;
		if ((v1[v0] / v0) >= (v0 - -0x27a)) {
			...
			r1, p0[825], globalState.f1, globalState.f1, p0[825] := !!v41.f6, ("tyay" + v52) !in (if (p0[825]) then v53 else if (v54 in v55) then v55[v54] else multiset{v52}), v0, v1[v0] - v0, fm0(!p2, globalState);
		} else {
			var v56 := "xarvj";
			v56 := v56;
			var v57 := new C4();
			p0[213] := p2;
			p0[213] := true;
			globalState.f1 := if (p0[213]) then v0 else v0;
			v0 := -v0;
		}
...
class C1 extends T2 {
	...
	function fm6(p0: seq<int>, globalState: GlobalState): bool {
		if (!!!false) then multiset{-16, 0x1b4, 0x51, -|(seq(0x338, i0  => (0x285)))|, -807} <= multiset{484, 0x1bf} else true <==> !!false
	}
	function fm7(p0: bool, globalState: GlobalState): int {
		-399 / |(set v0 : D1 | v0 in [DC5(true)] :: (v0))|
	}
	function fm4(p0: seq<bool>, p1: int, p2: int, p3: multiset<int>, globalState: GlobalState): int {
	...
	function fm14(globalState: GlobalState): int {
		|("aam" + ((seq(0x8f, i0  => ('y'))) + "hteems"))|
	}
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		r0 := fm6(seq(0x2a, i0  => (-0x267)), globalState);
		var v0: seq<bool> := [p0, p0, p0];
		v0 := [p0] + v0;
		var v1: multiset<int> := multiset{fm7(p0, globalState)};
		r0, globalState.f1 := p0, fm4([p0], 0x145, p1 % p1, v1, globalState);
		var v2: array<bool> := new bool[9] [fm0(p0, globalState), !p0, !!fm6(seq(578, i1  => (p1)), globalState), p0, p0, p0, p0, p0, false];
	...
	method m3(globalState: GlobalState) returns (r0: int) {
		...
		if (if (map[v0 := v4] in v6) then v6[map[v0 := v4]] else !v0) {
			...
			if ((v9 + v9) != v9) {
				...
				v11[4] := v9[-v3];
				v10 := v10;
				var v12: map<bool, bool> := map[v11[4] := v0];
				v11[4] := if (false in v12) then v12[false] else !!(v3 < v3);
				v8[349] := v3;
				v8[349] := --v3;
			} else {
				v0 := v0 ==> v0;
			...
			var v17: map<seq<int>, bool> := map[v16[v3 := v3] := v0];
			...
			var v21: seq<seq<int>> := [v16, v16, seq(-0x23d, i0  => (v3))];
			var v22: T0 := new C0(v0, v21 + v21);
			var v23: seq<bool> := [v0];
			v0, v20, v0, v22 := v0, v20, v23[v3], v22;
		}
		...
		if (v24[-v3]) {
			...
			v29[915] := if (v0) then v27.f11 else v0;
			var v30 := DC5(v27.f11);
			v29[915], v0, v0 := v30.cf5, v0, v27.f11;
			v29[915] := fm6(v27.f12[v3], globalState);
			v0 := v0;
		} else {
			...
			v33[798] := v0;
			v33[798], v1, v1, v3 := !v0 ==> v0, (seq(242, i2  => ('q'))) + v1, v1, 535;
			var v34: array<int> := new int[18];
			v34[456] := v3 + v3;
			var v35: map<bool, int> := map[v33[798] := -v3];
			var v36: multiset<map<int, int>> := multiset{v4, v4, map[v3 := -0x35d]};
			var v37 := 'e';
			var v38: map<char, int> := map[v37 := v3];
			v34[456] := if ((v36 !! v36) in v35) then v35[v36 !! v36] else (if (v37 in v38) then v38[v37] else v3) - v3;
			v33[798] := v33[798];
			var v39 := DC5(v33[798]);
			var v40: map<int, D1> := map[v3 := v39];
			var v41: map<int, string> := map[v34[456] := v1];
			v40 := map[|v41| := v39];
		}
		
		var v42: seq<seq<int>> := [seq(299, i3  => (-622))];
			...
			decreases 100 - i4
		{
			...
			if (v43.f11) {
				...
				v44[684] := if (v43.f11) then v46 !! v46 else v0;
				v1, v44, globalState.f1 := v1, v44, -0xf1;
				var v47 := new C0(v0, seq(0x1b5, i5  => ([v3, v3])));
				v3 := v3;
			} else {
				var v48 := 'p';
	...
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		if (p2) {
			...
			var v11: array<bool> := new bool[22] [p0, false, p0, p0, p0, v3 == {v2}, p0, p2, p0, fm16(0x47, globalState) !! v3, v0, !(if (p2) then v0 else v4[v2]), p0, v0, false || p2, p1 !in (if ((if (v2 in v9) then v9[v2] else v2) in v8) then v8[if (v2 in v9) then v9[v2] else v2] else map[p1 := v6]), !p0, v0, fm0(false, globalState), v4 <= v10[0x94], p0, p0];
			v11[612] := true;
			v11[612] := v0;
			var v12: array<int> := new int[2];
			v12[511] := |"cf"| * |[v2, v2, v2]|;
			v12[511] := v2;
			globalState.f1 := v12[511];
			var v13 := 'k';
			v1 := ((v1 + v1) + v1)[v2 := v13];
			var v14 := DC5(p2);
			var v15: map<D1, bool> := map[v14 := p2];
			var v16: multiset<char> := multiset{v13, v13, v13};
			globalState.f1, v12[511], v15, v11[612] := |v16| * v12[511], -(v2 / (v12[511] - |v9|)), v15 + map[v14 := p2], v0;
		} else {
			var v17: multiset<string> := multiset{seq(-0x2f2, i2  => ('q'))};
			v0 := v17 >= v17;
			var v18: set<bool> := {v0};
			...
			var v20 := 192;
			var v21 := DC8(p0);
			v0, v18, v19[470], v0, globalState.f1 := !v0, v18 - (v18 - fm17(v20, v0, globalState)), v0 ==> (v20 < v20), if (v0) then if ((v21.(cf9 := true)).cf9) then p2 else p0 else p2, -fm3(v0, p2, globalState);
			var v22: map<int, int> := map[v20 := v20];
			var v23 := 'e';
			var v24: map<string, string> := map[fm1(|v1|, false, v20, globalState) := v1[v20 := v23]];
			v22 := map[v20 % |(if (v1 in v24) then v24[v1] else v1)| := v20];
			...
			v19[470], v28, v30, v19[470] := v0, (v28 + v28)[v20 := -|v1|], v30, p1 >= p1;
		}
		...
		var v37: array<string> := new string[8] [v1, if (p2 in v36) then v36[p2] else v1, v1, v1, "cucmgtuti", v1, if (true) then seq(0x2cd, i3  => ('q')) else "n", fm1(v31, p2, v31, globalState)];
		v37[549] := v1;
		var v38: map<bool, bool> := map[v0 := false];
		v0, v35, v37[549], v31 := !((v0 <== v34.f11) !in v38), v35, v1, -(v31 / v31);
		var v39: array<array<int>> := new array<int>[26];
		var v40: array<int> := new int[3](i4 => i4 - 0x19a);
		v39[840] := v40;
		v39[840] := new int[26](i5 => i5 - v31);
	}
}
...
class C2 extends T4 {
	...
	method m4(p0: array<int>, p1: seq<bool>, p2: bool, p3: int, globalState: GlobalState) returns (r0: D2, r1: multiset<bool>) {
			...
			decreases 100 - i0
		{
			...
			if (f6) {
				...
				var v1 := DC8(p2);
				var v2: set<bool> := {f6};
				var v3: array<bool> := new bool[9] [f6, f5 !in v0, p2, v1.cf9, f6, p1[|fm2(f6, f6, globalState)|], fm22(v2, 102, f6, f6, globalState) in "fllshammk", !f6, p2];
				v3[178] := p2;
				var v4: map<bool, int> := map[p2 := p3];
				var v5: seq<map<bool, int>> := [v4];
				v3[178] := f6 !in v5[-|"dcgthjfh"|];
				globalState.f1 := p3;
				var v6: map<int, array<int>> := map[p3 := p0];
				var v7: map<array<int>, bool> := map[if (p3 in v6) then v6[p3] else p0 := f6];
				var v8: map<set<bool>, bool> := map[v2 := v3[178]];
				var v9: multiset<bool> := multiset{p2, p2, f6, fm10(multiset(p1), v8[v2 := p2], p3, globalState), v3[178]};
				v7 := v7[p0 := fm10(v9, v8, p3, globalState)];
				v0 := v0 + fm1(0xe4, v3[178], 0x157, globalState);
				var v10: seq<array<bool>> := [v3, v3];
				v3[178] := v10 <= [v3, v3];
			} else {
				var v11: multiset<int> := multiset{p3, 0x35, p3};
				p0[525] := -(|map[map[!p2 := |v11|] := f6]| / p3);
				p0[525] := 0x145;
				p0[525] := p0[525];
				var v12 := "pxu";
				var v13 := DC1();
				...
				v14[686] := v13;
				var v15 := true;
				v12, globalState.f1, v14[686], v15, p0[525] := v12, p0[525], v13, v15, p3 - p3;
			...
			var v27: seq<seq<int>> := [seq(0x267, i1  => (p3)), v26];
			...
			var v33: array<bool> := new bool[21] [v19, if (v19 in v20) then v20[v19] else p2, if (f6 in v20) then v20[f6] else f6, v19 <== v19, |p1| >= -0x59, false, !fm0(p2, globalState), fm8(p2, f6, p2, globalState) > p3, false, map[p2 := p3] == v21, p2, (v23[|v24|])[p3 := 108] >= v22, v25.cf5, if (!v19) then false else f6, p3 <= p3, v29 !in v30, v19, v19, v28.f11, !(|v32| < p3), v22[p3 := p3] !! v22];
			v33[282] := v28.f11;
			v19, v33[282], globalState.f1, v19, globalState.f1 := v19, (v19 && v28.f11) || v19, p3, p2, |(if (f6) then v24 else v24)| + p3;
			v33[282] := v28.f11;
			if (f6) {
				globalState.f1 := p3;
				var v34 := new C1();
				globalState.f1 := (p3 + |([f6])[p3 := f6]|) * p3;
				var v35: array<string> := new string[14](i2 => v24);
				var v36 := DC0(v19);
				var v37: map<D0, bool> := map[v36 := v19];
				v35[3] := if (if (v36 in v37) then v37[v36] else v33[282]) then v24 else "btwvxfgd";
				v35[3] := v24;
				...
				var v39 := 'u';
				v39 := f5;
				var v40: set<bool> := {v33[282]};
				var v41, v42 := m0(v33, fm22(v40, p3, p2, v28.f11, globalState), v28.f11, f5, globalState);
				var v43: multiset<bool> := multiset{v28.f11, v42};
				var v44: multiset<multiset<bool>> := multiset{(v43[v28.f11 := p3])[v28.f11 := fm4(p1, |v43|, p3, v22, globalState)], fm20(seq(-0x7, i3  => (v39)), false, globalState), v43};
				v44 := (v44 - v44) - (v44 + v44);
				v33[282] := true;
				var v45 := new C1();
			}
		...
		v46[794] := multiset{v47};
		var v48: multiset<array<char>> := multiset{v47, v47, v47};
		v46[794] := (multiset{v47})[v47 := fm3(p2, p2, globalState)] - v48;
		...
		var v56: seq<multiset<bool>> := [(v55[fm0(p2, globalState) := p3])[v50 := p3], v55];
		v54 := v54[v56[p3] := true];
		v50 := p3 > |v51|;
	...
	method m5(p0: string, p1: int, globalState: GlobalState) {
		...
		for i0 := -p1 to v0[p1] {
			if (f6) {
				...
				var v11: array<seq<bool>> := new seq<bool>[29] [v10, [v8] + v10, v10, v10[i0 := f6], v10, v10, [v8], v10, v10, v10, v10, v10, v10, v10, v10, v10, v10, v10, v10 + v10, v10, v10 + v10, v10, v10, v10 + v10, v10 + v10, v10, [f6], v10, v10 + fm2(v4, v4, globalState)];
				var v12: seq<array<seq<bool>>> := [v11];
				v9, v11, globalState.f1 := v9, v12[|map[i0 := p1]|], p1;
			} else {
				...
				var v18: multiset<array<bool>> := multiset{v16[|v0|], v13, if (i0 in v17) then v17[i0] else v13};
			...
			decreases 100 - i4
		{
			...
			v34[143] := v33 - v33;
			v34[143], globalState.f1 := v33 + v33, p1;
			var v35 := DC0(v26);
			...
			match (v30.(cf13 := v29)) {
				case DC12(cf13) =>
					...
					v27 := v27[f6 := fm3(v26, fm0(v26, globalState), globalState) % p1];
		...
		match (v30) {
			case DC12(cf13) =>
				...
				globalState.f1, v26, v52[150], globalState.f1, v53 := p1, if (f6) then v26 else p1 >= |v54|, p1 < -p1, fm3(fm0(v26, globalState), if (true) then v26 else v26, globalState), v53;
				var v55: map<bool, array<int>> := map[v26 := v29];
				var v56: array<array<int>> := new array<int>[20] [v29, if (f6 in v55) then v55[f6] else cf13, cf13, v29, if (v52[150]) then v29 else v29, v30.cf13, cf13, cf13, v29, cf13, cf13, cf13, v29, cf13, v29, v29, cf13, cf13, cf13, cf13];
				v56 := v56;
		}
		...
		if (v26) {
			...
			if ((fm26(globalState)).cf5) {
				...
				v62, globalState.f1, globalState.f1, v0 := v62 + [v60.f11, f6, v26], p1, p1, (v0 + (v0 + v0))[-p1 := p1];
				...
				v64, globalState.f1, globalState.f1, v26 := v64, (|p0| % p1) + 0x15d, p1 + |((seq(0x18, i6  => (map[true := p1]))) + v65)|, fm10(v66, v68, p1 + p1, globalState);
			...
			var v71 := DC0(false);
			var v72 := DC3(v71);
			v70, v26, v72 := v70, p1 >= v0[p1], DC3(v71);
			var v73: array<string> := new string[2](i7 => if (v26) then p0 else "cqdfgekt");
			globalState.f1, globalState.f1, globalState.f1, v73 := -p1, (p1 * p1) - (|p0| + p1), (p1 * p1) * (-35 / p1), if (!f6) then v73 else if (f6) then v73 else v73;
			...
			if (v77[p1 / |v0|]) {
				...
				v78 := p0;
				var v80: set<int> := {p1};
				v26 := (set v79 : int | v79 in (seq(-802, i8  => (0x1d))) :: (v79 - -659)) >= v80;
				var v81 := 'v';
				var v82 := DC4(0x2ab);
	...
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		var v2 := DC4(|v1|);
		for i0 := (v2.(cf4 := v0[165])).cf4 to p1 {
			var v3: array<bool> := new bool[16];
			v3[660] := f6;
			v3[660] := f6;
			r0 := |("ocyq" + p2)| >= (p1 - --i0);
			var v4: seq<int> := [v0[165]];
			var v5 := DC13(v4);
			r0 := v5.cf14 != v4;
			var v6: array<D0> := new D0[4];
			var v7: map<array<bool>, char> := map[v3 := f5];
			var v8 := DC2(v7, f5);
			v6[868] := if (p0) then v8 else v8;
			v0[165], v3[660], v3[660], v6[868], globalState.f1 := p1 + v0[165], !(if (f6) then !(i0 != |v1|) else if (f6) then v3[660] else f6), i0 == p1, v8.(cf1 := v7 + v7), --p1;
		}
		...
		r0, v0, r0 := fm10(v9, v11 + v11, if (true) then |v13| else v0[165], globalState), v0, f6;
		var v14: seq<int> := [v0[165]];
		var v15: map<int, bool> := map[|v14| := p0];
		var v16: seq<int> := [|v15|, p1, |(seq(-0x126, i1  => (f5)))|, p1];
		r0 := v16 == v14;
		for i2 := p1 to p1 {
			r0 := f6 in v12;
			var v17: array<bool> := new bool[2](i3 => !f6);
			var v18 := DC0(f6);
			v17[387] := fm9(i2, v18, f6, 0xec, globalState);
			v17[387] := v1[v0[165]];
			var v19: map<char, array<int>> := map[f5 := v0];
			v0 := if (f5 in v19) then v19[f5] else if (!p0) then v0 else v0;
			var v20 := DC12(v0);
			v17[387], v20 := v9 !! v9, v20;
		}
		r0 := (v10 * v10) >= {p0, p0, p0};
		r1 := (seq(0x1a9, i4  => (f5))) + "jr";
	}
	method m3(globalState: GlobalState) returns (r0: int) {
		var v0 := false;
			...
			decreases 100 - i1
		{
			...
			i1 := i1 + 1;
			var v14: map<string, bool> := map[seq(0x134, i2  => (f5)) := f6];
			v14 := v14;
			r0 := v3;
			v0 := true || v0;
			var v15 := 'w';
			...
			decreases 100 - i3
		{
			...
			if (f6) {
				...
				r0 := (-v3 / v3) - fm3(v20[|v20|], fm0(false, globalState), globalState);
				var v21: multiset<C1> := multiset{v12};
				var v22: seq<int> := [v3];
				var v23: multiset<int> := multiset{v3};
				v18[972] := -(if (v12 in v21) then v21[v12] else v12.fm4(v20[|v20| := v12.fm6(v22, globalState)], v3, v3, v23, globalState));
				var v24: seq<string> := [seq(0x2f9, i5  => (f5)), v6, "ea", v6, v6];
				var v25: seq<seq<string>> := [v24 + (seq(0x5d, i6  => (v6))), v24];
				v18[972] := |v25[v3]|;
			} else {
				var v26: array<int> := new int[9](i7 => i7 - |{v6, v6}|);
				v26[211] := |v6|;
				v26[211] := if (v3 >= -v3) then v3 else |v6| / |v4|;
				v26 := v26;
				var v27: map<bool, bool> := map[v0 := f6];
				var v28: seq<int> := [fm7(false, globalState)];
				v27 := v27[f6 := fm6(v28, globalState) || v0];
				var v29: seq<bool> := [v0];
				v26[211] := |((v29 + v29) + v29[v3 := f6])|;
				var v30: array<bool> := new bool[20];
				var v31 := 'c';
				v26[211], v6, v30, v31, v31 := v28[v3], v6, v30, f5, f5;
			}
			...
			v34[889] := |(v6 + (seq(422, i8  => (f5))))|;
			var v35: seq<bool> := [f6];
			v33, v34[889] := v33 - {v32[547], v0}, (v3 + |v35|) % v3;
		}
		r0 := -v3;
	}
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		var v5: array<int> := new int[6] [v3, -v3, v3, (if (f5 in v4) then v4[f5] else v3) % v3, -v3, 632];
		v5[784] := -v3;
		var v6: set<string> := {seq(-0x160, i0  => (f5)), v0, v0, v0, v0 + v0};
		v1, v5[784] := v1 && p0, |v6|;
		var v7: array<D5> := new D5[13];
		var v8 := DC12(v5);
		v7[274] := v8;
		v7[274] := DC12(v5).(cf13 := v5);
		v3 := v3;
		var v9: seq<bool> := [v1];
		var i1 := 0;
		while (v9[v5[784]] <==> p0)
			decreases 100 - i1
		{
			...
			var v14: set<int> := {|v13|};
			var v15: multiset<int> := multiset{v12[|v14|], -|v12|};
			v11[194] := v15;
			v10, v0, v3, v3, v11[194] := v10, v0, -v3, v5[784] % v3, v15[v3 := v3];
			globalState.f1 := v3;
			var v16: map<set<bool>, bool> := map[v2 := f6];
			var v17: map<int, bool> := map[v3 := p0];
			var v18: map<seq<int>, int> := map[v12 := 316];
			var v19: seq<map<seq<int>, int>> := [v18, v18[v12 := |map[v1 := v5[784]]|]];
			var v20: seq<map<seq<int>, int>> := [v19[v3]];
			var v21 := DC0(fm10(multiset(v9), v16, v5[784], globalState));
			var v22: array<bool> := new bool[16] [fm6(seq(0x184, i3  => (-v5[784])), globalState), p0, f6, true, !v9[|v0|], v5[784] == 468, fm10(multiset{p2, v1}, v16, v3, globalState), f6, p0, f6, p2, false <== (if (v5[784] in v17) then v17[v5[784]] else v1), !!!(v5[784] >= |fm28(v1, p0, v19[v5[784]], globalState)|), v21.cf0, f6 || !f6, 686 != 53];
			v22 := v22;
			var v23 := DC0(p2);
			var v24 := DC3(v23);
			var v25 := DC7(v3, v5[784]);
			var v26: map<D0, int> := map[v24 := v25.cf8];
			v26 := v26[v24.(cf3 := v23) := v12[|multiset{v3}|]];
		}
	}
}
...
class C3 extends T0, T1 {
	...
	function fm4(p0: seq<bool>, p1: int, p2: int, p3: multiset<int>, globalState: GlobalState): int {
		-(0x2a / |(if (f14) then [set v0 : int | (0x193 <= v0) && (v0 < 547) :: (v0 + -0x235), {0x2e, 880}, set v1 : int | v1 in multiset{|map[|map[|"p"| := f13]| := f14]|, |"ueuscelno"|} :: (v1 - |(seq(603, i0  => ('y')))|)] else [{|multiset{f13}|}])|)
	}
	function fm5(p0: D2, globalState: GlobalState): D1 {
	...
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		var v4 := false;
		v4 := v2[v0[248]];
		var v5: seq<int> := [v0[248], v1];
		var v6 := "t";
		var v7: seq<string> := [v6, seq(0x2c3, i1  => ('c'))];
		var v8 := DC6(fm1(0x381, true, v0[248], globalState));
		var v9 := DC9(v8);
		var v10 := DC4(|v7|);
		...
		var v15: map<int, map<bool, D10>> := map[v1 := v14[|v6|]];
		var v16: map<map<int, map<bool, D10>>, bool> := map[v15 := !p2];
		v5, v7, v9, v4, globalState.f1 := fm37(!f13, |v5| / |"g"|, v10, v1, globalState), v7, v9, if (v15 in v16) then v16[v15] else f14, v1;
		var v17: map<int, int> := map[v1 := v0[248]];
		var v18: set<bool> := {fm0(f14, globalState), f13, f14};
		globalState.f1 := |v17| % |v18|;
		if (f13) {
			var v19 := DC0(v4);
			v4 := v19.cf0;
			var v20 := 'a';
			...
			v4 := 0x3a < v1;
			v4 := p2 <==> (0xf3 == v1);
			var v23: array<char> := new char[23] [v20, v20, v20, v20, v20, v20, 'x', v20, if (p0) then v20 else v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v20, v6[|v6|]];
			v23[535] := 'd';
			v23[535] := v20;
		} else {
			v0[248] := v0[248];
			v4, v0[248], v2 := !v2[v1], v0[248], v2;
			var v24: multiset<int> := multiset{v0[248]};
			globalState.f1 := (872 % fm4(v2, v1, 0xb0, v24, globalState)) % -(0x30d - v1);
			var v25 := 'p';
			var v26, v27 := m0(v11, v25, p0, v25, globalState);
			v25 := 'x';
		}
		
		globalState.f1 := -v0[248];
	}
}
...
class C4 extends T1 {
	...
	function fm5(p0: D2, globalState: GlobalState): D1 {
		if (true) then DC4(|(map v0 : int | v0 in multiset([|"qfa"|, -|[false, true]|]) :: (v0 / |map['x' := [-0x1c6]]|) := (-0xb1))|) else DC4(0x170)
	}
	function fm30(p0: map<map<int, int>, bool>, p1: multiset<seq<bool>>, globalState: GlobalState): int {
		|(if (false) then seq(-0x147, i0  => ('x')) else "wx")|
	}
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		var v0 := true;
		v0 := false;
		var v1 := new C0(p0, seq(-580, i0  => ([822, |multiset{0x285, |multiset([-0x219])|}|, |(seq(0x28c, i1  => ('n')))|, 830, 0x3d3])));
		v0 := v0;
		var v2: seq<bool> := [v0];
		var i2 := 0;
		while (!v2[-736])
			decreases 100 - i2
		{
			...
			v0 := multiset(((fm31(p0, v5, globalState))[|v6.cf6| := 0x378])[|v8| := |v3|]) !! fm32(globalState);
			v5 := v5;
			globalState.f1 := v5;
		}
		var v9 := 0x8c;
			...
			decreases 100 - i3
		{
			...
			if (v9 == |map[|[p0, false, v0]| := v9]|) {
				...
				v20[927], v0, v0 := v22[v9], ((if (p0 in v23) then v23[p0] else p1) == multiset{p0}) && v1.f11, v1.f11;
				v0 := true;
	...
	method m10(p0: array<bool>, globalState: GlobalState) returns (r0: C0, r1: array<bool>, r2: array<bool>) {
		if (false) {
			...
			p0[850] := v4 in v11;
			p0[92], p0[850], v0 := fm0(v4.f11, globalState), v0, if (v0) then if (v0) then v0 else v4.f11 else v0;
		} else {
			var v12 := true;
			...
			v13 := v13[v14 := p0];
			var v15: seq<int> := [--|[v12]|];
			v15 := v15 + (seq(-0x2b6, i0  => (0x185)));
			var v16: seq<seq<int>> := [v15, v15];
			var v17: seq<seq<seq<int>>> := [[v15], v16];
			var v18 := new C0(if (false) then fm0(v12, globalState) else !v12, v16 + v17[v14]);
			globalState.f1 := v14;
		}
		
		var v19 := 0x1d6;
		var v20: seq<int> := [v19];
		for i1 := v19 % v19 to v20[v19] {
			var v21 := false;
			p0[600] := v21;
			p0[600] := v21;
			if (i1 <= i1) {
				var v22: seq<seq<int>> := [v20];
				var v23 := new C0(fm0(p0[600], globalState), if (p0[600]) then v22 else [seq(0x359, i2  => (-i1)), v20]);
				p0[600] := v23.f11;
				...
				var v31: array<set<int>> := new set<int>[11] [v25, v25, v25 + v25, if (v23.f11) then v25 else v25, v25 + v25, v25, set v26 : int | (347 <= v26) && (v26 < 914) :: (v26 % 690), v25, v25, if (v23.f11 in v27) then v27[v23.f11] else v25, fm35(fm1(i1, p0[600], i1, globalState), v28, fm36(i1, |v29|, i1, v30, globalState), globalState)];
				v31 := v31;
				v20 := (seq(0x310, i3  => (i1))) + v20;
				var v32: map<bool, seq<bool>> := map[p0[600] := v24 + v24];
				var v33 := "iwoqi";
				var v34 := 'a';
				p0[600], p0[600], globalState.f1, v24, p0[600] := !v23.f11, fm0(v23.f11, globalState), v19, if (p0[600] in v32) then v32[p0[600]] else v24, (v33 + v33) == (seq(0xd3, i4  => ('b')))[i1 := v34];
			} else {
				var v35: array<array<char>> := new array<char>[8];
				v35 := v35;
				var v36: T1 := new C3(true, v21);
				var v37: map<int, int> := map[fm3(v21, p0[600], globalState) := v19];
				var v38: map<map<int, int>, bool> := map[v37 := v21];
				var v39: seq<bool> := [v21, p0[600]];
				var v40: multiset<seq<bool>> := multiset{v39, v39, v39};
				var v41: map<int, T1> := map[fm30(v38, v40, globalState) := v36];
				v36 := if (-|(seq(318, i5  => ('u')))| in v41) then v41[-|(seq(318, i5  => ('u')))|] else v36;
			...
			if (!fm0(true, globalState)) {
				var v45 := new C1();
				r2 := new bool[26](i6 => !(multiset{|[v21, p0[600]]|, i1, 266, v19} != multiset{i1}));
				var v46 := "xr";
				p0[600] := v46 < v46;
				var v47 := DC1();
				v47 := v47;
				var v48: array<bool> := new bool[25](i7 => p0[600]);
				var v49: seq<bool> := [p0[600], false];
				var v50: seq<bool> := [true, p0[600], !v49[-v19], !false];
				var v51: map<array<bool>, bool> := map[v48 := v49[i1]];
				v51 := v51[v48 := v21];
			} else {
				var v52 := 'x';
				var v53: multiset<bool> := multiset{p0[600]};
				var v54 := new C2(v52, v53 >= v53);
				globalState.f1 := i1;
				var v55 := new C2(v52, v19 < v19);
				var v56 := DC7(i1 / |v20[0x286 := -i1]|, i1);
				var v57 := "tecdwogxu";
			...
			var v59: map<array<bool>, bool> := map[v58 := p0[600]];
			var v60 := new C3(p0[600], if (v58 in v59) then v59[v58] else p0[600]);
		}
		var v61 := false;
		...
		for i9 := |map[v62 := 'l']| to v19 {
			...
			globalState.f1 := |v64| + (i9 % |v65|);
			v19 := v19;
			var v66: array<string> := new seq<char>[24](i10 => seq(924, i11  => ('o')));
			v66[547] := v63;
			var v67: seq<bool> := [!v61];
			var v68: multiset<int> := multiset{v19};
			v66[547] := fm1(|v67| + (if (i9 in v68) then v68[i9] else i9), v61, i9, globalState);
			...
			v74 := (v74 + v74) + [v73, v73, v74[v19], v73, v73];
		}
		globalState.f1 := -(v19 % v19);
		if (v61 || v61) {
			var v75 := "ig";
			v75 := v75;
			globalState.f1 := v19;
			...
			var v86 := DC7(fm4(v79, v19, |v79|, v85[v19 := v19], globalState), v19);
	...
	method m11(p0: bool, p1: int, p2: bool, globalState: GlobalState) {
			...
			case DC7(cf7, cf8) =>
				...
				match (fm5(v4, globalState).(cf4 := cf8)) {
					case DC5(cf5) =>
						...
						cf5, globalState.f1 := p2, cf7 / (-cf7 % -|v0|);
						var v5 := 'c';
					...
					case DC4(cf4) =>
						...
						var v14: array<int> := new int[10](i0 => i0 / 0x360);
						var v15: map<array<int>, int> := map[v14 := p1];
						v11, cf8, v12 := v11.(cf3 := v13[cf4]), -|v15| + cf4, v12;
						v7 := p2;
						v0 := v0;
				}
				...
				var v18 := 'o';
				v17[605] := (fm1(p1, p0, |(seq(-0x33a, i2  => (DC19('q').cf20)))|, globalState))[p1 := v18] + (seq(0x2bb, i3  => (v18)));
				var v19: map<int, bool> := map[cf8 := p2];
				globalState.f1, v16, v17[605] := -((p1 % cf7) % (|v19| * |"vfndmpit"|)), v16, v0;
			case DC8(cf9) =>
				...
				if (if (p2 in v20) then v20[p2] else p2) {
					...
					var v24 := DC19(v21);
					v23, v24, v0, v0 := v23 + v23, DC19(v21), v0, (v0 + DC6(v0).cf6)[p1 := v21];
					var v25: array<bool> := new bool[8](i4 => p0);
					var v26: multiset<bool> := multiset{false, p0, p0};
					v25[297] := fm34(p2, globalState) > v26;
					var v27: map<string, bool> := map[v0 := |v20| != p1];
					v25[297] := if ((seq(0x29, i5  => (v21))) in v27) then v27[seq(0x29, i5  => (v21))] else cf9;
					globalState.f1 := p1 * p1;
		...
		if (p2 <== p0) {
			...
			match (v70.(cf3 := v69)) {
				case DC1() =>
					...
					var v76: array<int> := new int[18](i8 => i8 % -p1);
					v76[85] := -p1;
					v76[85] := p1;
				case DC2(cf1, cf2) =>
					var v77: array<string> := new seq<char>[7] [seq(0x1a5, i9  => (cf2)), v0, v0, v0[-0x22c := cf2], v0 + v0, v0, v0];
					v77[441] := (seq(-35, i10  => (v67))) + v0;
					v77[441] := "remd" + v0;
					var v78 := false;
					var v79 := DC15([p0]);
					...
					v84[140] := v82;
					var v86: map<int, int> := map[v83[827] := v83[827]];
					var v87: map<map<int, int>, bool> := map[v86 := v78];
					var v88: seq<seq<bool>> := [v80];
					var v89: multiset<int> := multiset{v83[827], p1, v83[827], p1, p1};
					var v90: seq<int> := [v83[827], p1];
					v83[827], v84[140], globalState.f1, v78 := p1 % (fm30(map v85 : map<int, int> | v85 in v87 :: (v85) := (v78), multiset(v88), globalState) * 0x16a), fm35(v0, v89, v67, globalState), if ((if (v78) then v83[827] else |v89|) in v89) then v89[if (v78) then v83[827] else |v89|] else 0xbf / p1, !(v83[827] == v90[v83[827]]);
				case DC0(cf0) =>
					...
					v91[969] := new bool[5];
					var v93 := DC19(v67);
					var v94: map<D11, int> := map[v93 := p1 % p1];
					var v95: multiset<int> := multiset{|"lrxmykw"|, p1};
					v94 := v94[v93 := if (fm4([cf0, p0], p1, p1, v95[p1 := p1], globalState) in v95) then v95[fm4([cf0, p0], p1, p1, v95[p1 := p1], globalState)] else p1];
					var v96: array<int> := new int[29](i12 => i12 % p1);
					v96[888] := p1;
					v96[888], cf0, v96 := fm3(p2, p0, globalState), p1 > 970, v96;
				...
				case DC3(cf3) =>
					...
					v98[796] := --(if (!true) then -p1 else p1);
					v98[796] := p1 - (p1 / p1);
					var v99 := true;
					var v100: seq<bool> := [v99, p2];
					v99 := |v100| < 589;
					var v101 := new C2(v0[v98[796]], !fm0(p0, globalState));
			...
			var v109 := DC18(if (p1 in v107) then v107[p1] else v108[p1]);
			...
			globalState.f4 := v114;
			var v115: multiset<string> := multiset{seq(0x297, i14  => ('y'))};
			...
			v122[106] := if (p0) then p2 else p2;
			v122[106] := true;
			var v123: set<string> := {v0 + v0};
			var v124 := 'n';
			v123, v122[106], v124 := v123, fm0(--p1 >= 65, globalState), v124;
		}
		...
		v125[129] := |((v0 + (if (|v130| in v128) then v128[|v130|] else seq(0x16f, i17  => ('f')))) + ("mvaeqnmre" + v0))|;
		var v131 := DC15(v129);
		match (v131) {
			case DC15(cf16) =>
				var v132 := false;
		...
		var v137: seq<int> := [p1, 0x2c5, v125[129]];
		var v138: seq<seq<int>> := [v137, v137];
		var v139 := new C0(|v137| < v125[129], v138 + v138);
	}
}
...
class C5 extends T3 {
	...
	function fm42(p0: int, p1: bool, p2: seq<char>, p3: int, globalState: GlobalState): map<int, set<D3>> {
		(map[f15 := set v0 : D3 | v0 in map[DC10(map[|(seq(0x181, i0  => (f5)))| := f15]) := f5] :: (v0)] + (map v1 : int | v1 in [DC4(f15).cf4] :: (v1 / f15) := ({DC10(map[f15 := f15]), DC10(map[f15 := |"p"|])}))) + ((map v2 : int | (0x34c <= v2) && (v2 < 0x56) :: (v2 % |"jpe"|) := (set v3 : D3 | v3 in [DC10(map[0x19f := f15]), DC10(map[|map[f6 := f15]| := f15])] :: (v3))) + map[f15 := set v4 : D3 | v4 in map[DC10(map[f15 := f15]) := f15] :: (v4)])
	}
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		for i0 := 0x217 * |v0| to p1 {
			...
			match (v3) {
				case DC17(cf18) =>
					...
					var v10: map<bool, bool> := map[v4 > v4 := (v6[-0xfb := |v7|])[p1 := |v9|] >= v6];
					v10 := v10[p0 := p0];
			}
			...
			v13[776] := fm43(!p0, !f6, globalState);
			...
			v11, globalState.f1, v12[153], v13[776], v15 := v11, if ((p1 * f15) in v16) then v16[p1 * f15] else i0, if (i0 != i0) then p2 else p2, v14 + (v14 + (set v18 : int | v18 in v17 :: (v18 % |(seq(905, i2  => ('u')))|))), v15;
			v2[480] := p0;
			v2[480] := if (f6 || f6) then (seq(-713, i3  => (f5))) != v12[153] else !(p0 ==> false);
		}
		f15 := p1;
		...
		v25[46] := v24 + v24;
		r0 := f6;
		r1 := (p2 + (p2[f15 := f5])[p1 := f5]) + p2[p1 := f5];
	}
	method m3(globalState: GlobalState) returns (r0: int) {
		match (DC1()) {
			case DC1() =>
				...
				var v5 := DC27(v4);
				globalState.f4, v3[725] := (v4 + v4) * v5.cf35, -f15 != f15;
				var v6: multiset<int> := multiset{f15, f15};
				var v7: map<int, multiset<int>> := map[|"wl"| := v6];
				var v8: seq<int> := [0x2f6];
				var v9: seq<multiset<int>> := [v6];
				var v10: array<multiset<int>> := new multiset<int>[14] [multiset{|fm44(!v3[725], globalState)|}, fm45(globalState), if (|fm46(fm6(v8, globalState), globalState)| in v7) then v7[|fm46(fm6(v8, globalState), globalState)|] else multiset{f15}, v6 + v6[f15 := f15], v6, v6, v6, multiset{|v8|}, v6, v6, v6, v6, v9[f15], v6[f15 := f15] * v6];
				v10[9] := v6;
				v10[9] := v6;
			case DC2(cf1, cf2) =>
				var v11 := false;
				...
				match (DC27(v12)) {
					case DC28(cf36, cf37) =>
						...
						var v14 := "g";
						var v15: multiset<string> := multiset{v14, v14, seq(0x3c9, i0  => (cf2)), "bjrtxt", v14};
						var v17 := DC10(map v16 : int | (0x2cd <= v16) && (v16 < -0xc4) :: (v16 / |multiset{[true, f6]}|) := (0x364));
						var v18 := DC22(v17, seq(0x225, i1  => ([v11, cf37])), cf2, v11, v14);
						v13 := new bool[19] [f6, v15 >= v15, cf37, if (v11) then !v11 else cf36, cf37, false, cf36, cf36, cf37, v11, v14 < v14[f15 := v18.cf26], 0x1b8 > f15, v11, v11, cf37, cf36, cf36, !!cf37, v11];
					...
					case DC27(cf35) =>
						...
						v25[514] := if (v11) then v23 else v23;
						v25[514] := v23;
					...
					case DC29(cf38) =>
						...
						v27[494] := f15;
						globalState.f1, v28, v29, v27[494], globalState.f1 := f15, map[v26 := v27] + v28, v29, f15, 0x1cb;
						var v30: array<bool> := new bool[3](i3 => f6);
						var v31, v32 := m0(v30, f5, !f6, cf2, globalState);
						var v33: map<int, bool> := map[-|fm48(v27[494], true, globalState)| := v32];
						var v34 := DC11(v33);
				...
				v11 := map[f15 := v37] != (map v38 : int | v38 in v36 :: (v38 + f15) := ((map v39 : D14 | v39 in (seq(-0xbb, i4  => (DC26(v11, f15, cf2)))) :: (v39) := ('q'))[DC26(v11, f15, f5) := cf2]));
			case DC0(cf0) =>
				...
				var v50: array<seq<int>> := new seq<int>[22] [v42[-0x230 := 0x1f5] + v42, v42, v43, v47[f15], v43, seq(0x172, i6  => (0xbd)), [f15, |v41|, f15], v42, v43[700 := f15], [f15, f15] + v48.cf14, v42, v43, [|v49|] + (seq(-0x2, i7  => (-85))), v43, v42 + v42, v42[-f15 := |map[cf0 := f15]|], ((seq(794, i8  => (f15))) + v42)[-f15 := f15], v43, v42, v43 + v43, v42, seq(781, i9  => (f15))];
				v50[637] := [f15, f15];
				var v51: multiset<bool> := multiset{f6};
				var v52: map<int, multiset<bool>> := map[f15 := v51];
				var v53: seq<multiset<bool>> := [v51];
				var v54: array<multiset<bool>> := new multiset<bool>[25] [multiset(v46) + v51[true := f15], v51, v51 - v51, v51 * v51, v51, v51, v51, v51, v51 - v51, v51, v51 * fm48(f15, f6, globalState), v51 + v51, v51, multiset([!!true]), v51 + v51, v51, if (fm7(cf0, globalState) in v52) then v52[fm7(cf0, globalState)] else v51, v53[f15], v51 - v51, (multiset(v46))[v46[0x309] := f15], multiset{cf0, cf0} + v51, multiset{cf0}, v51, v51, v51 - v51];
				...
				v55[693] := v59;
				v40, v44[764], v50[637], v54, v55[693] := v40, !((if (!!true) then v45 else v45) >= v45), v43[f15 := 0x309], v54, v59;
				var v60: map<string, string> := map["erhqhi" := v41];
				v60 := v60;
				var v61: map<bool, array<int>> := map[v44[764] := v40];
				var v62 := DC12(if (!false) then v40 else if (v46[f15] in v61) then v61[v46[f15]] else v40);
			...
			case DC3(cf3) =>
				if (f6) {
					...
					var v70 := "bc";
					v68[88] := (if (f6 in v69) then v69[f6] else v70) + v70;
					v68[88] := v70;
					...
					globalState.f1 := if (fm50(fm0(v63, globalState), f6, map v75 : int | (0x1dd <= v75) && (v75 < -0x96) :: (v75 * |v68[88]|) := (f15), globalState) in v74) then v74[fm50(fm0(v63, globalState), f6, map v75 : int | (0x1dd <= v75) && (v75 < -0x96) :: (v75 * |v68[88]|) := (f15), globalState)] else f15;
				} else {
					var v76 := false;
					var v77: map<bool, bool> := map[f6 := v76];
					v76 := (|v77| - f15) == f15;
					globalState.f1 := fm3(f6, true, globalState) + (f15 % f15);
					var v78 := "paf";
					var v79: map<bool, int> := map[f6 := f15];
					var v80: map<int, int> := map[|v79| := f15];
					var v81: seq<int> := [f15, f15, |v80|];
					var v82: array<int> := new int[25] [-f15, f15, f15 + 0x1ce, |v78|, f15, f15 + |v78|, f15, if (true) then 159 else |v78|, 0x48, v81[f15], f15, f15, f15, f15, f15, f15, f15, f15 * f15, -f15, f15 % |map[!true := f15]|, f15, v81[f15], f15, f15, f15];
					v82[935] := f15 / fm8(true, f6, f6, globalState);
					v82[935] := 0x95;
					v82[935] := v82[935];
					v78 := (seq(0x33, i11  => (f5))) + v78[v82[935] := f5];
				}
				...
				if (f6) {
					...
					var v89: set<bool> := {fm6(seq(672, i12  => (f15)), globalState)};
					var v90 := "jdvhobhq";
					var v91: map<int, bool> := map[fm8(v83, v86.f11, v86.f11, globalState) := v86.f11];
					var v92: map<int, string> := map[|v84| := v90];
					var v93: array<bool> := new bool[26] [f6, v86.f11, v83, f15 <= f15, v86.f11, fm0(v83, globalState) || v86.f11, v86.f11, v87[f15], f6 ==> v86.f11, false, !v86.f11, f15 < f15, v86.f11, v86.f11, if (v89 in v88) then v88[v89] else v83, f5 in v90, v86.f11, v86.f11, v86.f11, f6, if (|v92| in v91) then v91[|v92|] else v83, f6, v86.f11 && v83, f6, v86.f11, true];
					var v94 := DC8(v83);
					f15, globalState.f4, v93, v94, r0 := f15, (((multiset{v83})[v86.f11 := f15])[v86.f11 := f15])[v83 := f15], if (!f6) then v93 else v93, v94, 0x21b % (|fm46(v86.f11, globalState)| % f15);
					...
					var v100: array<int> := new int[4](i13 => i13 / f15);
					v100[858] := f15;
					v100[858] := f15;
					var v101 := DC27(v96);
					v101 := v101;
				...
				v106[477] := f15 + |(v111[f15] + map[v103 := v110])|;
		}
		
		f15 := fm7(f6, globalState) - f15;
		var v112: multiset<int> := multiset{f15, 0x209};
		for i14 := if (f15 in v112) then v112[f15] else f15 to f15 % f15 {
			...
			var v117 := DC27(v116);
			v113[954], v115, f15, v117 := -f15, v115, -0x32d, DC27(v116);
			v113[954] := 327;
		...
		var v131: map<seq<seq<int>>, string> := map[v129[-|v130| := seq(0x2fc, i16  => (|"utb"|))] := v122];
		v123[712], v122 := f15, if ((v129 + fm52(f6, false, globalState)) in v131) then v131[v129 + fm52(f6, false, globalState)] else "amowydn";
		r0 := v128[v123[712]];
	}
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		for i0 := if (fm0(p2, globalState) in v0) then v0[fm0(p2, globalState)] else f15 to f15 * -f15 {
			...
			var v6: array<int> := new int[25] [i0, f15, fm7(p2, globalState) + -i0, f15, f15, i0 * f15, -|(if (f6) then v1 else v1)|, i0, -|v2|, -i0, --(if (v3 in v4) then v4[v3] else i0), --i0, i0, f15, 0x13d * |v1|, |v1|, 362, -(f15 % i0), i0, f15, f15, f15, -i0, f15, f15 * |v5|];
			v3 := v6;
			if (fm0(p2 <== f6, globalState)) {
				...
				var v11: array<array<bool>> := new array<bool>[16] [v8, v8, v8, if (f6) then v8 else v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v8, v10[i0], v8];
				v11 := v11;
				var v12: map<int, int> := map[i0 := |[v8[256]]|];
		...
		var v25 := "vinlx";
		var v26 := DC22(v23, v24, v25[f15], p0, v25);
		match (v26) {
			case DC22(cf24, cf25, cf26, cf27, cf28) =>
				...
				if (f6) {
					...
					v35[58], globalState.f4, v37 := !(p0 <==> (v21 != v21)), (p1 * multiset{p2, p2, f6}) + multiset{p0}, if (fm6(v32, globalState)) then map[v35 := v36] else v37;
					var v38 := new C3(!p0, v35[58]);
					v35[58], cf27 := v35[58], v34.f11;
				...
				v41[740] := if ((p0 && p0) in v46) then v46[p0 && p0] else set v48 : map<bool, bool> | v48 in v47 :: (v48);
				var v49: array<bool> := new bool[28];
				var v50: map<array<bool>, int> := map[v49 := f15 % f15];
				v50 := v50[v49 := f15 / f15];
			case DC23(cf29) =>
			...
			case DC21(cf23) =>
				...
				if (if (v59 in v60) then v60[v59] else true) {
					...
					v64 := v64[v63 + (seq(4, i3  => (v0))) := f5];
				} else {
					var v65 := false;
					var v66: array<int> := new int[22](i4 => i4 / f15);
					var v67: map<array<int>, bool> := map[v66 := p0];
					var v68: seq<array<int>> := [v66, v66];
					var v69 := DC5(v65);
					v65 := !!(if (v68[|v21|] in v67) then v67[v68[|v21|]] else v69.cf5);
					globalState.f1 := f15;
					...
					var v75 := 'k';
					var v76 := DC4(f15);
					v65, v65, v65, v75, v76 := !p0, p2 && !(v58[320] > p1), !fm0(f6, globalState) <== f6, v75, v76;
					v65 := v65 <==> p2;
				}
		...
		match (v78) {
			case DC28(cf36, cf37) =>
				...
				v79[574] := f15;
				var v80: seq<int> := [-106];
				var v81: multiset<int> := multiset{f15 * f15, v80[851], f15};
				var v82: map<bool, bool> := map[f6 := cf36];
				var v83 := DC21(v82);
				var v84 := DC7(f15, fm7(fm0(cf37, globalState), globalState));
				cf36, v79[574], v81, globalState.f1, v83 := p0, -f15, (multiset{|[v25, v25[0x2ea := f5]]|, f15, 597} + v81) + multiset{f15, -663, 0x324}, v84.cf7, v83;
				var v85 := new C3(cf37, p2);
				var v86 := DC20(f6, v79[574]);
			...
			case DC27(cf35) =>
				...
				var v98: array<int> := new int[21] [f15, f15, f15, v95.cf22, v96[f15], 0x278, -f15, 725, 0xdf, 898, f15, f15, f15 / f15, f15, v94.fm14(globalState), (if (v94.fm4(v21, 832, f15, v97, globalState) in v97) then v97[v94.fm4(v21, 832, f15, v97, globalState)] else fm7(p2, globalState)) - f15, |((seq(-0x5, i5  => (f5))) + v25)|, f15, f15 * f15, f15, -v96[0x1b5]];
				v98[697] := -0x2c;
				var v99 := true;
				globalState.f1, v98[697], v99, globalState.f1 := fm8(f6, p2, p2, globalState) - -0x2b8, v94.fm7(p2, globalState), fm3(p2, f6, globalState) != f15, -v96[|(v96 + v96)[f15 := f15]|];
				var v100: multiset<array<bool>> := multiset{v91, v91, v91};
				v98[697], v98[697] := if ((if (f6) then v91 else v91) in v100) then v100[if (f6) then v91 else v91] else f15, v98[697];
			case DC29(cf38) =>
				var v101 := true;
				var v102: seq<int> := [f15, f15];
				v101, globalState.f1, globalState.f1, globalState.f1 := f6, f15, |v102| * (f15 / f15), 0x94;
				var v103: set<bool> := {p2};
				v101 := {p0, v101} < v103;
				v101 := v21[|[-f15]|];
				var v104: multiset<int> := multiset{f15, f15};
				var v105: array<multiset<int>> := new multiset<int>[20] [v104, v104, v104, v104 * v104, v104, multiset(v102 + (seq(0x30e, i6  => (f15)))), v104, v104, fm45(globalState) + v104, v104, v104, v104, v104, v104, v104, multiset{f15, f15} + v104, fm45(globalState) * v104, v104, v104, v104];
		...
		f15, v106, v108 := v110.cf33, (v25 + v25) != ((v25[f15 := f5] + v25)[f15 := f5])[f15 := f5], v108 + v108;
		var v111 := DC13(v109);
		v111 := v111.(cf14 := v109);
	}
	method m12(p0: int, p1: bool, p2: int, globalState: GlobalState) returns (r0: map<string, int>, r1: seq<int>, r2: set<bool>, r3: bool) {
		...
		var v8: array<int> := new int[24] [-|[v0, v0]|, p2, f15 / p2, if (p1) then if (f6 in v2) then v2[f6] else v4.cf8 else p2, fm3(f6, p1, globalState), -0x51, p2, v5[|map[p2 := p1]|], p2, f15, (if (f6 in v6) then v6[f6] else f15) - p2, v5[-0x102], p2, f15 * |v7|, if (false in v6) then v6[false] else f15, f15, if (p1) then p0 else p0, 0x376, |fm1(p0, f6, -0x26f, globalState)|, p2 - p2, |v2|, f15, -p0, p2];
		v8[892] := p0 % f15;
		v8[892] := |(seq(0x16c, i0  => (f5)))| - p2;
		var i1 := 0;
		while (p1)
			decreases 100 - i1
		{
			...
			v11[272] := (map v12 : int | v12 in fm56(globalState) :: (v12 % p0) := (v1)) == v13;
		}
		v8[892] := f15 % (|(set v14 : int | (0x324 <= v14) && (v14 < 0x30d) :: (v14 * -p2))| % p0);
			...
			decreases 100 - i3
		{
			...
			i3 := i3 + 1;
			v16[366] := 'p';
			v15[519] := if (true) then f6 else p1;
			v15[519] := f6;
			r3 := v15[519];
			var v17: set<int> := {v8[892], f15};
			var v18: set<int> := {-(|(seq(0x359, i4  => (f5)))| * |v17|), p0};
			v17 := v18;
		}
		var v19: array<set<int>> := new set<int>[23](i5 => {v8[892]} * {f15, |map[f6 := f6]|});
		v19, r3, r3, v8[892], f15 := v19, p1, f6, f15, |(seq(-0x18, i6  => (v16[366])))[v8[892] := if (p1) then f5 else f5]|;
		var v20: map<string, int> := map[fm1(|v1|, fm6(v5, globalState), v8[892], globalState) := p0];
		...
		var v24: map<string, bool> := map[fm1(0x8a, f6, |v22|, globalState) + v23[v8[892]] := f6];
...
class C6 extends T2, T1 {
	...
	function fm7(p0: bool, globalState: GlobalState): int {
		(0x3d6 - 0x23b) * (-|(map v0 : char | v0 in {'k'} :: (v0) := (true))| / 708)
	}
	function fm4(p0: seq<bool>, p1: int, p2: int, p3: multiset<int>, globalState: GlobalState): int {
		(|map[|multiset{|"nyudstnyx"|, 0x340}| := false]| / -|(seq(0x91, i0  => ('x')))|) + 0x6f
	}
	function fm5(p0: D2, globalState: GlobalState): D1 {
		DC4(0x114 / 0x14a)
	}
	...
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
			...
			case DC16(cf17) =>
				...
				match (v8) {
					case DC17(cf18) =>
						...
						r0, v11, v12 := !p0, (map[v5 := v10])[v5 := v13[p1]], v12;
						var v14 := 'q';
				...
				var v30: array<int> := new int[10] [-|(p2 + p2[p1 := v23])|, 339 / p1, p1, p1, v4[if (p0 in v24) then v24[p0] else |v27|], p1, --(|multiset{|v5|, p1, -|v28|}| * p1), p1, p1 * p1, if (v23 in v29) then v29[v23] else p1];
				v30[298] := p1;
				...
				v30[298] := |fm1(v25.fm30(v33, multiset(v34), globalState) * p1, p0, |(if (p0 in v35) then v35[p0] else v28)|, globalState)|;
		}
		...
		for i1 := p1 to |p2| {
			...
			var v41: array<int> := new int[5] [p1, if (p0) then |multiset{v38}| else p1, i1 * i1, |(v38 + v38[p1 := p0])|, |v40| % ---942];
			v41[214] := p1;
			v37, v41[214] := v37, p1;
			var v42: map<int, int> := map[i1 := |v39|];
			r0 := !((p1 > fm3(true, p0, globalState)) ==> ((if (i1 in v42) then v42[i1] else p1) < v41[214]));
			var v43 := 'f';
			var v44: map<int, bool> := map[|p2| := !p0];
			var v45: map<int, bool> := map[i1 := if (v41[214] in v44) then v44[v41[214]] else p0];
		...
		for i3 := fm29(p1, v48.cf6, globalState) / p1 to v52[p1] {
			var v53 := 'k';
			var v54: set<char> := {v53, v53};
			var v55: array<C3> := new C3[5];
			var v56: C3 := new C3(p0, p0);
			v55[28] := if (p0) then v56 else v56;
			v50[171] := p1;
			...
			v54, v55[28], v50[171], v57[977], v59 := v54, v56, i3, v53, v59;
		...
		forall i5 | 0 <= i5 < v61.Length {
			v61[i5] := if (p0) then multiset([|[p0, p0]|]) + multiset(seq(0x14, i6  => (p1))) else multiset{p1} * multiset{p1, |v52|};
		}
		r0 := p0;
		var v62: map<int, bool> := map[691 := p0];
		var v63 := 'x';
		r1 := ((p2 + p2) + (p2 + p2))[|v62[p1 := p0]| := v63];
	}
	method m3(globalState: GlobalState) returns (r0: int) {
		var v0 := "ojxcdwwr";
		v0 := v0;
			...
			decreases 100 - i0
		{
			...
			var v3 := 0x2cb;
			var v4 := DC20(v1, -v3);
			if (v2[if (v4.cf21) then v3 else v3]) {
				var v5 := new C4();
				var v6 := 'o';
				v6 := v6;
				var v7: array<string> := new string[29];
				v7[915] := v0 + v0;
				v7[915] := if (!!v1) then (seq(-0x1c8, i1  => (v6))) + (seq(-0xdb, i2  => (v6))) else v0;
				var v8: array<map<bool, int>> := new map<bool, int>[9];
				var v9: map<bool, int> := map[v1 := -v3];
				v8[108] := v9;
				v3, v1, v0, v1, v8[108] := v3, !(-(v3 * v3) != v3), ("qn" + "syeqbdag") + (v0 + v7[915]), v1, v9 + (map[v1 := v3] + v9);
				v5 := v5;
			} else {
				...
				v12[251], v19, v20[290] := if (!(if (v1) then v1 else false)) then v3 else |v21|, v19, ((v2[|v18| := false])[|(map v22 : string | v22 in (set v24 : string | v24 in v23 :: (v24)) :: (v22) := (v1))| := v1])[|v2| := v1] + v2;
			}
			
			var v25: C4 := new C4();
			var v26 := DC25(v25);
			var v27: array<D14> := new D14[13] [v26, v26, v26, v26, v26, v26, DC25(v25), v26, DC25(v25), DC25(v25), v26, v26, v26.(cf31 := v25)];
			v27[105] := v26.(cf31 := v25);
			...
			v27[105], v28[618], v1, globalState.f1, v29 := v26, v36, v1 <== v1, 342, v29;
			...
			var v44: array<int> := new int[17] [if (v1) then -0x1c2 else v3, -|v40|, v3 + |v0|, |fm35(v0, multiset(v28[618]), v30, globalState)|, |v0|, |(set v41 : int | (973 <= v41) && (v41 < 0x8) :: (v41 - v3))|, if (v1) then -|v0| else v3, v3, v3, 0x39f, v3, fm3(v1, v1, globalState), v3, v3, |(v0 + (seq(0x83, i4  => (v30))))|, |v42|, |v43|];
			var v45 := DC12(v44);
			var v46 := DC23(v45.(cf13 := v44));
			var v47: seq<D12> := [v46, v46];
			var v48: map<int, seq<D12>> := map[0x108 * |v0| := v47[|v36| := v46]];
			var v49: seq<string> := [v0, (v0[v3 := v30])[v3 := v30]];
			var v50: map<int, map<int, seq<D12>>> := map[0x124 := map[v3 := v47]];
			v3, v38, globalState.f1, v44, v48 := v3 * v3, multiset(v49 + v49), -(-0x328 % v3) - (v3 - 0x189), v45.cf13, v48 + (if (v3 in v50) then v50[v3] else v48);
			globalState.f1 := v3;
		}
		if (v1) {
			var v53: array<char> := new char[23](i5 => v0[|{|(map v51 : string | v51 in (set v52 : string | v52 in [seq(-862, i6  => ('p')), v0] :: (v52)) :: (v51) := (map[!!v1 := 0x3dd]))|}|]);
			v53 := v53;
			if (!v1) {
				var v54 := 0x1e7;
				...
				var v65: map<int, int> := map[v54 := fm4((v61[|v62| := v1])[v54 := !v1], v54, -v54, v64, globalState)];
				v56[116], v1, v57 := v1, [v59] < v60, fm36(v54, v54, v54 - v54, v65, globalState);
				v1 := v1;
				v54 := v54;
			} else {
				...
				var v69: map<int, array<array<char>>> := map[v66[v67] := v68];
				v69 := v69[v67 := v68];
			...
			if (v1) {
				...
				v82 := v82[-(|(set v83 : int | (342 <= v83) && (v83 < 0x11) :: (v83 / -v81))| % v81) := v76];
				var v84: map<int, bool> := map[v81 := v1];
				v76[328] := if (v81 in v84) then v84[v81] else v1;
				v76[328] := false;
			} else {
				var v85 := 0xa8;
			...
			globalState.f1, v1 := (if (v105 in v106) then v106[v105] else -v101) / v101, (v101 / v101) == v101;
			...
			if (v1) {
				...
				var v124: array<map<array<bool>, int>> := new map<array<bool>, int>[24] [v111 + v111, v111, v111, map[v112[v113] := v113] + map[v110 := |v115|], v111, v111[v110 := 0x3b4], v111, v116[v113], v111, v111, map[if (|v0| in v117) then v117[|v0|] else v110 := v113], v111, map[v110 := v113], v111, v111, map[v110 := |v123|], v111 + v111, map[v110 := v113], v111 + v111, v111, v111, v111 + v111, v111, map[v110 := v113]];
				v124[422] := v111;
				var v125: multiset<int> := multiset{v113, v113};
				v124[422] := (v111[v110 := v113])[v110 := v113 % |v125|];
				v118, globalState.f1 := v118, if (if (v1) then false else v1) then 811 / v113 else v113;
				var v126 := DC13(v119);
				v126 := v126;
				...
				v1, v134, v110[447] := v1, if (((if (v136 in v137) then v137[v136] else |multiset{v110}|) / v113) in v135) then v135[(if (v136 in v137) then v137[v136] else |multiset{v110}|) / v113] else v134, v1;
			} else {
				var v138 := -0x3db;
				globalState.f1 := -v138;
			...
			if ((if (v1) then {v1, v1, v1, v1} else v146) >= v146) {
				...
				var v154: map<int, array<int>> := map[-v142 := v153[v142]];
		...
		var v171: seq<seq<int>> := [v169, v169, v169, v169, v170[v166]];
		...
		var v178: array<int> := new int[27] [v166, |(v173 + fm57(-v166, |v174|, globalState))|, v166, v166 + v166, v166, -v166, v166, v166, v166, |"pmtyrbao"| / v166, -(|v169| - v166), v166, |v175|, -v166 / v166, v166, if ((if (v166 in v176) then v176[v166] else v166) in v176) then v176[if (v166 in v176) then v176[v166] else v166] else |map[v166 := v166]|, v166, |v169|, if (false) then v166 else |v175|, v166, v166, |v0|, v166 % v166, |(if (false) then v177 else v177)|, v166 + v166, v166, v166];
		v178, v1 := v178, v1;
		r0 := v166;
	}
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		var v0 := 0x1ba;
		var v1: seq<int> := [fm3(p0, fm0(p0, globalState), globalState) % v0];
		v1 := v1;
		var v2 := "yqnx";
		v0 := |v2| % v0;
		var i0 := 0;
	...
	method m8(p0: bool, p1: bool, p2: array<int>, globalState: GlobalState) returns (r0: int, r1: C1) {
		...
		var v5 := DC4(v1);
		v0[282], p2[112], globalState.f1, globalState.f1 := |(seq(941, i0  => ('n')))| == -0x1ce, |(v2 + v2)|, -(v1 - v1) * (v1 / v1), fm4(v3, v1, v1, v4, globalState) - v5.cf4;
		v2 := v2;
		var v6: map<int, int> := map[p2[112] := p2[112]];
		var v7 := 'u';
		var v8, v9 := m0(v0, fm36(fm3(p1, p1, globalState), p2[112], v1, v6, globalState), v2 == v2, v7, globalState);
		v7 := v7;
		p2[112] := fm7(p0, globalState) % v1;
		var v10 := DC12(p2);
	...
	method m9(p0: string, globalState: GlobalState) {
		...
		var v9: seq<int> := [v0];
		var v10: array<int> := new int[24] [0xa7, v0 + v0, if (v1) then v0 else v0, v0, |v2|, -|fm59(globalState)|, v0, v0, v0, 158, v0, v0, v0, fm3(v1, v1, globalState), |multiset(v3)|, -0x1de, fm3(v1, v1, globalState) % (if (v0 in v4) then v4[v0] else -v0), |(v4 + v4[v0 := v0])|, v0, |fm49(globalState)|, |fm57(|v5|, -v0, globalState)|, -|v8|, v0 - |v9|, v0];
		forall i0 | 0 <= i0 < v10.Length {
			v10[i0] := i0 % (if (v0 in v5) then v5[v0] else |[DC29(DC27(multiset{v1, false}))]|);
		}
		v1 := v0 <= v0;
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			match (v11) {
				case DC11(cf12) =>
					...
					var v15: array<D14> := new D14[28] [DC26(v1, v0, v12), v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, v13, DC26(v1, 0x21a, v12), DC26(v3[|v14|], 245, v12), v13, v13, v13, v13, v13, v13, v13, fm60(globalState), if (v1) then v13 else v13, fm60(globalState)];
					v15 := v15;
			...
			v1 := v1;
			var v19: seq<seq<int>> := [seq(-0x288, i2  => (v0)), v9];
			...
			decreases 100 - i3
		{
			...
			if (v1) {
				...
				var v26: seq<array<bool>> := [v25[v0], v24, v24];
				v24 := v26[v0];
			} else {
				globalState.f1 := v0;
...
class C7 extends T3 {
	...
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		v0[292] := if (!f6) then !p0 else f6;
		v0[292] := p0;
		var v1: multiset<bool> := multiset{p0};
		f10 := f10 - (|v1| % f10);
		var v2 := DC6(seq(563, i1  => (f5)));
		match (v2) {
			case DC7(cf7, cf8) =>
				var v3 := 'l';
				v3 := f5;
				...
				globalState.f1 := |v4|;
				var v5: seq<bool> := [v0[292], f6];
				v5 := fm2(v5[--|{p1, f10}|], v5[p1], globalState);
				r1 := p2;
			case DC8(cf9) =>
				var v6: set<bool> := {true, v0[292], p0, cf9};
				...
				var v12: array<int> := new int[12] [|v6|, f10 + (if (v9[f10] in v8) then v8[v9[f10]] else f10), f10, f10, f10, f10, |p2|, 534, |v10| / |v11|, p1, 599, fm7(v0[292], globalState)];
				v12[641] := p1;
				var v13: map<string, bool> := map[if (f6) then v2.cf6 else p2 := p1 !in map[p1 := f6]];
				v12[641], v13, f10 := f9, v13, (f9 % -f9) * -(0x3b9 / -0xc2);
				v7 := v7;
				var v14 := new C0(v0[292], seq(0x31a, i2  => (v11)));
				var v15 := new C0(p0, v14.f12);
			case DC6(cf6) =>
				globalState.f1 := f10;
				globalState.f1 := f10;
				f10 := f9;
				v0[292] := !(f9 < fm3(f6, p0, globalState));
			case DC9(cf10) =>
				var v16: seq<string> := ["cofnqf", (seq(0x3a4, i3  => (f5))) + p2];
				v16 := v16;
				var v17: T0 := new C0(v0[292], seq(0x2ec, i4  => ([|{f6, f6}|])));
				var v18: seq<int> := [p1];
				var v19: map<T0, seq<int>> := map[v17 := v18];
				var v20 := DC8(p0);
				r0, v0[292], v19 := (f10 * 611) <= |[f6, f6]|, v0[292] || v20.cf9, v19[v17 := v18] + v19[v17 := [|v1|]];
	...
	method m3(globalState: GlobalState) returns (r0: int) {
		...
		var v3: array<map<bool, bool>> := new map<bool, bool>[14] [v0, v0, v0 + v0, map[f6 := f6], map[!!f6 := f6], v0[f6 := f6], v0 + v0, map[f6 := f6], fm19(fm0(f6, globalState), if (f9 in v1) then v1[f9] else |"nud"|, globalState), v0, v0, v0 + v0, v0, v0 + v2[0x3b1]];
		...
		if (f6) {
			...
			v16, v15[106], v17, f10 := v16, f10, false, fm8(v20 != v20, f6, false, globalState);
			var v21: seq<int> := [v15[106], f10];
			...
			if (f9 < (f9 / v15[106])) {
				...
				var v24 := "mcwnadjh";
				var v25: set<int> := {f10};
				var v26: map<int, char> := map[v15[106] := f5];
				v17, v24, v17, v15[106], v15[106] := v22.f11, if (v17) then v24 + v24 else v24, v25 >= (v25 - v25), -(|v1| / v15[106]), -|(v24 + v24)[f9 := if (v15[106] in v26) then v26[v15[106]] else f5]| % v15[106];
				var v27 := DC6(v24);
				v27 := DC6(v24);
			...
			match (v36.(cf3 := v39)) {
				case DC1() =>
					...
					var v44 := "qucb";
					f10, globalState.f1, v43, v44 := -v21[f9], f9 - -(f10 - f9), [v15], "yhwkuxs";
					var v45: multiset<bool> := multiset{fm0(v22.f11, globalState), v22.f11};
					var v46: seq<bool> := [f6, !v17];
					var v47: array<multiset<bool>> := new multiset<bool>[18] [multiset{v22.f11, f6}, v45 + v45, multiset{v22.f11, v22.f11} - v45, v45, v45 - multiset(v46), v45, multiset{f6, false, v22.f11, !f6, v22.f11}, v45 + multiset(v46), v45, v45, v45, v45, v45 + v45, v45, v45, v45, v45, multiset{f6} + (multiset{f6, v22.f11, f6})[v22.f11 := v42[382].cf4]];
					v47[585] := v45 + v45;
					v47[585] := v45;
				case DC2(cf1, cf2) =>
					var v48 := new C1();
					v0 := v0[f9 > f10 := v22.f11];
					v17 := v15[106] != (v15[106] % f9);
					v17 := v22.f11;
				case DC0(cf0) =>
					var v49 := "psooqryel";
					cf0 := v49 <= "udq";
					var v50: seq<array<int>> := [v15];
					v49, globalState.f1, v17, v17, cf0 := v49, -128 % f9, true, cf0, v50 < v50;
					var v51: seq<bool> := [v17];
					v17 := true || v51[v15[106]];
			...
			var v68 := "ekfgutbiw";
			var v69: seq<int> := [|v68|];
			v66, v63, v63, v63 := v67.cf16, (v64 >= v64) <==> v66[-f10], (0x28c / -f9) !in v69, f6;
			...
			v71[723] := v70;
			v63, f10, globalState.f1, v71[723], globalState.f1 := |v68| >= f10, f10, f9, v70, 0x350;
		}
		
		var v72 := false;
		v72 := v72;
		for i5 := -364 to -(f10 / f9) {
			...
			var v80: C0 := new C0(v74.fm6(v78[f10 := i5], globalState), v79);
			var v81: multiset<C0> := multiset{v80, v80};
			v75, r0, v76, v73[520] := if (i5 in v77) then v77[i5] else v75, if (v80 in v81) then v81[v80] else f9, v76, fm6(v78 + v78, globalState);
			v73[520] := v72;
		}
		var i6 := 0;
			...
			decreases 100 - i6
		{
			...
			if (f6) {
				...
				var v95: array<bool> := new bool[15] [f6 ==> false, f6, v84.cf9, v86 > v85, v72, v72, f6, f9 < |v93|, v92.f11, f6, !(false && false), f6, v92.f11, v94[f10], false];
				v95[875] := f6;
				var v96: seq<int> := [f9, |v89|, |v94|];
				v82, v83[862], v72, v95[875], v96 := v82, f9, f10 <= (if (v92.f11) then f10 else f10), v72, v96 + (seq(0x3cf, i8  => (|v89|)));
				globalState.f1 := f9 - v83[862];
				...
				var v103: map<int, multiset<array<bool>>> := map[v83[862] := v100];
				var v104: seq<multiset<array<bool>>> := [v100];
				var v105: array<multiset<array<bool>>> := new multiset<array<bool>>[28] [v100, multiset{v95, v95} * v100, multiset{v95}, if (f5 in v101) then v101[f5] else v100, v100[v95 := f9], v100, multiset{v95, v95, v95, v95, v95}, v100, v100 * multiset{v95, v95, if (!!f6 in v102) then v102[!!f6] else v95, v95}, if (f9 in v103) then v103[f9] else v100, v104[v99.fm4(v94, f10, v83[862], multiset{-337}, globalState)], v100, v100 - v100, v100 - v100, v100, v100, if (v83[862] in v103) then v103[v83[862]] else v100, (if (f9 in v103) then v103[f9] else v100) * multiset{v95}, multiset{v95}, multiset{v95}, v100, v100, v100 - multiset{v95, v95}, multiset{v95, v95, v95, v95}, v100, v100, v100 + v100, v100];
				v105[236] := v100;
				v105[236] := v100[v95 := |((seq(0x2e3, i9  => (f5))) + v89)|];
			} else {
			...
			v108[534] := if (f9 in v111) then v111[f9] else v110;
		}
		r0 := f10;
	}
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		var v9 := DC4(f10);
		v2[896], v3, v4, v5 := |(v7 + v7)|, true, v4, if ((v9.(cf4 := f9)).cf4 in v8) then v8[(v9.(cf4 := f9)).cf4] else 'b';
		v3 := (f9 * f9) != (-f9 * 0x244);
		var v10 := "jrsms";
		if ((v10 + "sqhcfc") < fm1(f9, p2, 0x152, globalState)) {
			if (false) {
				...
				v11[901] := v13;
				v11[901], globalState.f1, globalState.f1 := DC16(v13).cf17, f9, v2[896];
				f10 := fm3(false, f6, globalState) * f10;
				var v14: map<D3, int> := map[fm27(v10, !!p2, true, globalState) := f9];
				var v15 := DC10(map[v2[896] := |[v2]|]);
				var v16: map<int, int> := map[|(seq(40, i1  => (v5)))| := f10];
				var v17 := DC8(v3);
				...
				var v21: map<array<bool>, array<C2>> := map[v4 := v20[v2[896]]];
				var v22: map<bool, map<array<bool>, array<C2>>> := map[p2 := ((map[v4 := v19])[v4 := v19])[v4 := v19]];
				var v23 := DC15(v6);
				var v24: set<seq<bool>> := {v6, v6, v6, v23.cf16[v2[896] := f6]};
				...
				v26 := v26 + ((set v27 : map<int, bool> | v27 in v26 :: (v27)) * v28[f10]);
			} else {
				v2[896] := |v6|;
				v3 := p0;
				v3 := f6;
				globalState.f1 := -fm7(true, globalState) - 0x2f7;
				var v29: seq<seq<int>> := [seq(294, i2  => (f9))];
			...
			v33 := v33;
			if (f9 != -v2[896]) {
				var v34: set<int> := {v2[896], f10};
				v2[896] := fm8(p2, v3, v34 !! v34, globalState);
				globalState.f4 := p1;
				var v35: array<string> := new string[21];
				v35[926] := (seq(0x1c0, i3  => ('b'))) + v10;
				var v36: map<int, seq<bool>> := map[-f9 := v6];
				v35[926] := (seq(110, i4  => (v5))) + ((seq(-0x1a, i5  => (f5))) + (v10[v2[896] := f5])[|v36| := 'r']);
				v4, v3 := v4, f6;
				var v37: seq<string> := [(seq(-0x298, i6  => (v5))) + "l", v10];
				v37 := v37;
			} else {
				var v38 := DC10(map[f10 := f9]);
				v3, v3, v38, v3 := v3, p2, v38, (f10 == |v10|) ==> (v10 == v10[0x23e := v5]);
				v2[896] := v2[896];
				...
				var v47: set<map<D1, T1>> := {v44, v45[if (|v10| in v46) then v46[|v10|] else |map[p2 := v6[v2[896]]]|]};
				v42[878] := v47;
				v42[878] := (v47 * v47) + v47;
			...
			if (p0 <== p0) {
				...
				v50 := v50[v3 := v2];
				var v51: map<string, bool> := map[v10 + (seq(-377, i7  => (v5))) := f6];
				v51 := v51[v10 := false];
				v3 := !true;
				var v52: map<int, bool> := map[0x41 := v3];
				var v53: map<bool, map<int, bool>> := map[!v6[-|multiset{0x7f, v2[896], v2[896]}|] := v52[v2[896] := f6]];
				v53 := (v53 + v53)[!(v1 <= v1) := v52 + v52];
			} else {
				v3, v2[896] := f6 && false, -(fm3(f6, v3, globalState) / f9);
				...
				v3, globalState.f1, globalState.f1, v3, v54[674] := v3, f9, |multiset((((if (v3) then v58 else v58) + (v58 + v58))[f9 / |v60| := v57])[f10 := v57])|, f6, v55;
				v2 := v2;
				var v61: array<string> := new string[19](i9 => "tbknyswhp" + v10);
				v61[905] := "penmrr" + v10;
				v61[905] := "kq" + "onejtsx";
				var v62 := DC8(v3);
				globalState.f1, v9 := v2[896], if (v2[896] > f10) then v9 else fm5(v62, globalState);
			}
	...
	method m7(p0: int, globalState: GlobalState) returns (r0: int, r1: int, r2: int, r3: seq<array<bool>>) {
		...
		if (f6) {
			...
			var v4: multiset<int> := multiset{v3[|v3|], -0x358};
			v4 := v4;
			var v5 := 'n';
			v5 := v5;
			...
			if (f5 !in DC6(v6).cf6) {
				...
				var v11: map<array<D13>, array<bool>> := map[v8 := v10[fm8(v7, v7, f6, globalState)]];
				var v12 := DC33(v11);
				v11 := v12.cf42;
				var v13 := new C6();
				...
				var v17: map<bool, string> := map[true := v16[f9]];
				...
				var v23: array<string> := new string[6] [(if (p0 in v15) then v15[p0] else "v") + "j", if (v7 in v17) then v17[v7] else seq(3, i0  => (f5)), v6 + v6, v6, v6, v22.cf28];
				v23[440] := v6;
				v14[536], v23[440] := v9, v6;
			} else {
				var v24 := new C2(v6[f9], fm0(f6, globalState));
				var v25 := true;
				v25 := v25;
		...
		v35 := v35;
		var v36: map<string, char> := map[seq(0x6f, i1  => (f5)) := f5];
		var v37 := "adh";
		...
		r0 := f10;
		r1 := (|v37| / f10) / fm3(f6, v44, globalState);
		var v45 := DC14(v44);
		r2 := |(match v45 {
			case DC14(cf15) => if (true) then [f9, f10, f9, p0] else seq(0x23b, i2  => (f10))
			case DC13(cf14) => cf14
		})|;
...
class C8 extends T4 {
	...
	function fm10(p0: multiset<bool>, p1: map<set<bool>, bool>, p2: int, globalState: GlobalState): bool {
		(-0x3c6 % |[f6]|) != (DC7(|[-0x295]|, -0x29b).cf8 - |map[!!f6 := f6]|)
	}
	function fm8(p0: bool, p1: bool, p2: bool, globalState: GlobalState): int {
		0x1b2
	}
	...
	function fm7(p0: bool, globalState: GlobalState): int {
		match DC7(0x383, -|{{f6, f6}}|) {
			...
			case DC8(cf9) => |(map v0 : int | v0 in multiset{|map[|"ngprv"| := false]|} :: (v0 / 266) := (cf9))|
			case DC6(cf6) => -0x1ab + 0x5e
			case DC9(cf10) => 409 / 0xfa
		}
	}
	function fm4(p0: seq<bool>, p1: int, p2: int, p3: multiset<int>, globalState: GlobalState): int {
		|(([!f6] + [f6, f6]) + [false])|
	...
	function fm11(p0: int, p1: bool, p2: int, globalState: GlobalState): map<int, int> {
		if ({f6, f6, f6} >= {f6}) then map[609 := |(seq(-0x255, i0  => (|multiset{true, f6}|)))|] else DC10(map[|(set v0 : int | (0x13 <= v0) && (v0 < 0x9) :: (v0 * |multiset{0x249}|))| := |{f6, f6}|]).cf11 + map[0xa8 := 0x181]
	}
	...
	method m4(p0: array<int>, p1: seq<bool>, p2: bool, p3: int, globalState: GlobalState) returns (r0: D2, r1: multiset<bool>) {
		p0[174] := p3;
		p0[174] := fm3(!p2, if (p2) then p2 else f6, globalState);
		var v0 := true;
		...
		var v6: multiset<bool> := multiset{f6, p2, v5[p0[174]] >= v4, v0 && f6};
		v0, v2, globalState.f1, v3 := v0, v2, |v6|, v3;
		var v7 := new C1();
		var v8: seq<int> := [p3, p0[174], p0[174]];
		var v9: map<int, seq<int>> := map[p0[174] := v8];
		var v10 := DC13(if (p0[174] in v9) then v9[p0[174]] else v8);
		var v11: map<D6, int> := map[v10 := p3];
		for i0 := if (v10 in v11) then v11[v10] else 415 to p3 % -p0[174] {
			p0[174] := v8[-0x281];
		...
		if (v0) {
			if (p2 && v0) {
				var v14 := new C7(-p3, p0[174], f5, v0);
				var v15 := 'q';
				v15 := v15;
				...
				var v20: C2 := new C2(fm22({f6}, |multiset{true}|, p2, p1[p3], globalState), !v0);
				v19[435] := v20;
				v19[435] := v20;
				var v21: array<map<int, string>> := new map<int, string>[21];
				var v22: map<int, string> := map[p0[174] := "lyknjnvny"];
				v21[408] := v22[p3 := v3];
				v21[408] := v22 + map[p3 := v3];
				var v23 := DC20(v0, p3);
			...
			var v25: map<int, int> := map[p0[174] / -p3 := p3];
			v25 := v25[p0[174] := p0[174]];
			if ((multiset{|"smcp"|, p0[174], |v6|})[|map[p3 := f6]| := p3] > v4) {
				v3 := v3;
				v0 := false;
				globalState.f1, globalState.f1 := p3 * p3, p3 + (p0[174] * -p3);
				...
				v29 := v29[-0x3e7 - p3 := p2];
				var v30: set<int> := {|fm1(p0[174], !p2, p0[174], globalState)|};
				v30 := v30;
				v0 := p2;
			}
			...
			var v32 := new C6();
			var v33 := DC26(f6, p3, fm53(v3, p0[174], globalState));
			globalState.f1 := v8[v33.cf33];
			v0 := f6;
			var v34: set<bool> := {p2};
			var v35: map<array<bool>, bool> := map[f7 := v34 !! v34];
			var v36: seq<map<array<bool>, bool>> := [v35, map[f7 := p2]];
			v35, v0, v0, globalState.f1 := v35[f7 := f6] + v36[p0[174]], false, v0, |(map[f6 := p2])[fm0(f6, globalState) := p1[p3]]|;
			p0[174] := p0[174];
		}
		
		var v37 := DC20(!true, p0[174]);
		var v38: map<seq<int>, bool> := map[v8 := |"ymtkf"| >= v37.cf22];
		globalState.f1 := |v38|;
		var v39: map<bool, int> := map[p2 := p3];
		var v40: map<int, bool> := map[if (!p2 in v39) then v39[!p2] else p0[174] := v0];
	...
	method m5(p0: string, p1: int, globalState: GlobalState) {
		...
		match (DC11(v2 + v2)) {
			case DC11(cf12) =>
				v1 := v1;
				globalState.f1 := p1;
				var v3: map<int, int> := map[p1 / |{v1}| := p1];
				v3 := v3[0x85 := -p1];
				var v4 := DC18(f7);
				...
				match (v6) {
					case DC24(cf30) =>
						...
						f7[685] := false;
						var v10: seq<int> := [p1];
						globalState.f1, v7[221], globalState.f1, f7[685] := p1, p1 % p1, (p1 / -|(map v9 : int | v9 in v10 :: (v9 / p1) := (p1))|) + p1, f6;
						var v11 := DC10(v3);
						var v12: seq<seq<bool>> := [v8, v8];
						var v13 := DC22(v11, v12, f5, v1, v0);
						var v14: seq<string> := [v13.cf28, "aldrxfvuv" + p0, v0, seq(461, i1  => (f5)), "toj"];
						v14 := v14;
				}
	...
	method m2(p0: bool, p1: int, p2: string, globalState: GlobalState) returns (r0: bool, r1: string) {
		...
		for i0 := |v0| to p1 {
			...
			globalState.f1, r0, r0, v1[842] := p1 + (if (p0 in v2) then v2[p0] else -p1), fm0(fm9(p1, v3, f6, p1, globalState), globalState), (if (p0 in v0) then v0[p0] else fm3(f6, f6, globalState)) >= i0, (|(map v4 : int | v4 in (if (f6 in v5) then v5[f6] else v6) :: (v4 * i0) := (|v2|))| + p1) / (i0 * p1);
			var v7: seq<bool> := [p0];
			r0, globalState.f4, r0, f7 := f6, v0, !f6 <==> v7[v1[842]], f7;
			r0 := f6;
			v1[842] := v1[842];
		}
		var i2 := 0;
			...
			decreases 100 - i2
		{
			...
			v10[913] := if (v11 in v12) then v12[v11] else |p2|;
			...
			decreases 100 - i3
		{
			...
			var v22 := DC26(f6, p1, fm36(p1, p1, |v20|, map v21 : int | (0x89 <= v21) && (v21 < 471) :: (v21 % p1) := (p1), globalState));
			match (v22) {
				...
				case DC25(cf31) =>
					...
					v29[384] := (if (p1 in v35) then v35[p1] else p1) - (30 / p1);
			...
			v43[481], r0, v44[16], v45 := v44, (seq(946, i5  => (f5))) <= ("vhbetwjr" + (seq(0x1bb, i6  => (f5)))), -p1 / p1, v45;
			f7[369] := if (p0) then p0 else v45[v44[16]];
			f7[369] := p0;
		}
	...
	method m3(globalState: GlobalState) returns (r0: int) {
			...
			case DC11(cf12) =>
				...
				match ((if (f6) then v6.(cf29 := v5) else v6).(cf29 := DC12(v4))) {
					case DC22(cf24, cf25, cf26, cf27, cf28) =>
						...
						v8, cf27 := if (v10 >= v10) then (v8 + v8[v0 := v0])[if (v11 in v12) then v12[v11] else v0 := 672] else v8, cf27;
					...
					case DC23(cf29) =>
						...
						var v19: multiset<int> := multiset{v18[v0]};
		...
		var v44: set<multiset<bool>> := {v39, multiset(v40), multiset((([f6])[v0 := f6])[if (-249 in v43) then v43[-249] else v0 := f6])};
		var v45 := new C7(|v44|, v0 % v0, f5, f6);
		if (0x3b2 > 0x320) {
			var v46 := true;
			v46 := f6 && f6;
			f7[644] := f6;
			...
			v46, v0, f7[644], v47 := if (true) then v46 else v41.fm6(v48, globalState), 0x6f, if (if (!DC40(f6, v45.f9, v49).cf51) then f6 else f6) then f6 else !f6, (v47 + (seq(0x71, i1  => (f5)))[v45.fm4(v40, v0, v45.f10, v50, globalState) := f5]) + v47;
			var v51: set<int> := {v0, v45.f9};
			v46 := v51 == v51;
			var v52: map<bool, bool> := map[fm0(v46, globalState) := false];
			var v53 := DC45(v50);
			var v54: map<multiset<bool>, bool> := map[v39[f7[644] := |v52|] := v53.cf60 !! v50];
			v54 := v54[v39 := !!f7[644]];
			var v55, v56, v57 := m6(f7[644], f7[644], globalState);
		} else {
			if (true) {
				...
				v62, v45.f10, globalState.f1 := v64[|v63|] !in v64, v0, v45.f9;
				var v65: set<bool> := {f6};
				var v66: map<bool, set<bool>> := map[fm6(v63[v45.f10 := v45.f9], globalState) := v65];
				...
				f7[585] := !(v45.f9 >= v41.fm7(f6, globalState));
				f7[585] := fm0(f6, globalState);
				var v70 := "baymc";
				...
				var v77: array<int> := new int[24] [-(if (f6) then v45.f9 else v45.f10), v45.f9, v45.f9, |v70[v45.f9 := f5]| * v45.f9, |(v72[v45.f10 := v71] + v72)|, v45.f9 - -0x23c, |v73|, v45.f9, v45.f9, v45.f9, v45.f10, v45.f10, v45.fm4(v40, if (f6 in v39) then v39[f6] else |(seq(0xa2, i2  => (|(seq(811, i3  => (v40)))|)))|, v45.f10, v76, globalState), v45.fm7(f7[585], globalState), |v74|, -0x2e3, fm3(f6, f6, globalState), v45.f10, v45.f9, 0xdd, v45.f9 * |map[f7[585] := v45.f10]|, |(seq(0x2e2, i4  => (f5)))|, v45.f9, |v70|];
				var v78: set<int> := {v45.f10, v45.f10};
				var v79: seq<set<int>> := [v78, v78];
				v77[747] := |v79|;
				v77[747] := v45.f9 % v45.f10;
				v0 := 0x87;
				var v80 := DC12(v77);
				var v81: map<int, D5> := map[|v40| := v80];
				v45.f10 := (v77[747] - v77[747]) % |v81|;
				v77[747] := v45.f10;
			}
			...
			f7[609] := f6 && v40[v45.f10];
			f7[609] := false;
			var v84: map<bool, int> := map[true := v45.f9];
			var v85 := DC13([v45.f9]);
			var v86 := "uuafj";
			var v87: map<seq<int>, int> := map[v85.cf14 := |v86|];
			v84, globalState.f1 := fm28(f7[609], f7[609], v87, globalState), v45.f9;
	...
	method m1(p0: bool, p1: multiset<bool>, p2: bool, globalState: GlobalState) {
		...
		v0 := f5;
		var v1: seq<bool> := [p0];
		var v2 := DC28(f6, v1[--|v1|]);
		match (v2) {
			case DC28(cf36, cf37) =>
				var v3 := -0x2c8;
				var v4: seq<seq<bool>> := [v1];
				cf36, v1, cf37 := v3 <= (v3 + v3), (v1 + v1) + v4[v3], cf36 && cf37;
				cf36 := cf37;
				f7[312] := p0;
				var v5 := DC0(p2);
				...
				var v8 := "rgibkeo";
				var v9 := DC13(seq(0x9e, i0  => (v3)));
				var v10: map<bool, bool> := map[f6 := p0];
				var v11 := DC43(|v9.cf14|, if (p0 in v10) then v10[p0] else f6, 88);
				var v12 := DC44(v11);
				var v13: set<D20> := {v12};
				f7[312] := (if (v3 in v6) then v6[v3] else v7) >= (if (-v3 in v6) then v6[-v3] else (multiset{|v8|})[0x2b1 := |v13|]);
				globalState.f1 := v3;
			case DC27(cf35) =>
				if (p0) {
					var v14 := "giybh";
					...
					v19, f7[397], v20 := if ((v22 + v22) in v23) then v23[v22 + v22] else v19, v1[v16.f15], v20;
					var v24: array<array<int>> := new array<int>[2];
					var v25: array<int> := new int[28];
					v24[555] := v25;
					var v26: map<bool, int> := map[f7[397] := -0xd4];
					var v27: map<char, map<bool, int>> := map['h' := v26];
					v17, v24[555] := ([v16.f15] + ([v15] + v17))[|v27| := v16.f15 - |v17|], v25;
				} else {
					var v28 := DC47(f6);
					var v29 := false;
					...
					var v34 := "eu";
					globalState.f1, v28, v29, f7, v30[463] := if (!(if (v31 in v32) then v32[v31] else v29)) then v31 else |p1|, v28.(cf64 := v31 <= -v31), v29, v33[v31], |[v34, v34, v34, v34, v34]| / fm8(p2, v29, !true, globalState);
					f7[174] := (seq(419, i1  => ('p'))) <= v34;
					f7[174] := (v1 + v1) <= v1;
					v31 := |["ff"]|;
					var v35: map<int, string> := map[v31 := v34];
					var v36: set<string> := {v34[v31 := 'f']};
					var v37: map<array<int>, bool> := map[v30 := v1[v31]];
					v34 := (if (v30[463] in v35) then v35[v30[463]] else v34)[|v36| := v0] + (seq(628, i2  => (v0)))[|v37| := (fm65(f6, 0x10a, v30[463], globalState)).cf43];
					f7[174] := v29;
				}
				...
				if (p2) {
					...
					f7[36], globalState.f1, globalState.f1, v47 := p0, |v1|, (v45 - v48[--v45]) % (if (p2 in cf35) then cf35[p2] else v45), v47;
					var v49: seq<seq<int>> := [v48 + (seq(-385, i3  => (205))), [fm3(v47.f6, p2, globalState), -0xce] + v48];
					var v50 := "fdtgl";
			...
			case DC29(cf38) =>
				...
				if (p2 && (if (176 in v64) then v64[176] else p2)) {
					...
					v1, v0, f7[996], v67, globalState.f1 := v1[v61 := f6], v0, p2, v67, |fm11(v61, p0, |v68|, globalState)|;
					globalState.f1 := v62[14];
					var v69: map<bool, bool> := map[f7[996] := f7[996]];
					v69 := v69;
					globalState.f1 := (if (p0) then |[v62[14]]| else v61) / |p1|;
				}
		...
		var v74: map<bool, string> := map[f6 ==> v1[v70] := seq(0x105, i4  => (f5))];
		globalState.f1, v71, v70, v73 := v70, if (f6 in v74) then v74[f6] else v71, v70 - v70, v73 * ((multiset{v71, v71})["anuxkuyu" := -0x396] + multiset{"xbkjrf"});
	...
	method m6(p0: bool, p1: bool, globalState: GlobalState) returns (r0: seq<int>, r1: bool, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			var v8: seq<C3> := [v7];
			var v9: seq<C3> := [if (!p0) then v7 else v7, v8[v3[402]], v7];
			var v10: seq<int> := [-v3[402], v3[402], v1, v3[402]];
			v7 := v9[|v10|];
			var v11: multiset<int> := multiset{v1};
			var v12: set<int> := {fm4(v0, 0x392, v1, v11, globalState)};
			v10 := [v1, v1, |(v12 + v12)|, v3[402]];
			v3[402] := fm3(!v7.f14, p0, globalState);
			r2 := v12 !! v12;
		}
		var v13 := DC14(f6);
		var i1 := 0;
			...
			decreases 100 - i1
		{
			...
			match (v19) {
				case DC28(cf36, cf37) =>
					var v20: map<bool, multiset<int>> := map[cf36 := multiset{v1, v1, v3[402]}];
					...
					var v29: array<set<bool>> := new set<bool>[8] [{true}, {p1} - v26, v26, v27[|v28|], fm17(v1, p1, globalState), fm17(v1, f6, globalState), v26 + v26, fm49(globalState)];
					var v30: array<string> := new string[7];
					v30[403] := seq(-409, i2  => (f5));
					var v31 := "ayjjit";
					v29, v30[403] := v29, v31;
					globalState.f1 := if (!(p0 <==> cf37)) then v3[402] else v3[402] / |fm1(597, cf36, v3[402], globalState)|;
					v30[403] := v31;
				case DC27(cf35) =>
					r1 := false;
					globalState.f1 := v3[402];
					var v32: seq<int> := [v3[402], v3[402]];
					var v33: array<bool> := new bool[13] [!(if (f6) then p1 else p0), p1, v0[v1], p1, p1, f7[222], v32 == (seq(368, i3  => (|map[v1 := f5]|))), f6, p0 <== f7[222], f7[222], f7[222], p0, v1 !in v32];
					var v34: map<bool, int> := map[f6 := v3[402] + v1];
					v3[402], v33, v33, v34, f7[222] := v1, v33, v33, v34, f6;
					var v35: set<bool> := {f6};
					var v36: map<set<bool>, bool> := map[v35 := f6];
					f7[222] := !fm10(v18, v36, v3[402] - v1, globalState);
				case DC29(cf38) =>
					var v37: seq<int> := [v1];
					var v38: map<int, seq<int>> := map[709 := v37[fm8(true, f6, f7[222], globalState) := v3[402]]];
					var v39: seq<seq<int>> := [if (v3[402] in v38) then v38[v3[402]] else v37, v37];
					var v40: map<int, bool> := map[|v39| := true];
					v40 := v40[v3[402] := !f7[222]];
					var v41: set<int> := {v1};
					var v42 := "gxqw";
					var v43: map<int, int> := map[|v41| := fm8(v0[|v42|], p1, f7[222], globalState)];
		...
		var v44: seq<int> := [-v3[402], v1];
		r0 := ((v44 + v44) + [-v1, v3[402]])[v1 * v1 := v1];
		var v45 := DC20(p0, v3[402]);
		r1 := v45.cf21;
		r2 := !p1;
	}
}
...
method Main() {
		...
		decreases 100 - i0
	{
		...
		v10[975] := v0;
		v10[975] := v0 + (if (v9) then v0 else v0);
		var v11: map<int, D0> := map[v0 := v8];
		var v12: map<int, int> := map[0x145 := v0];
		var v13: map<map<int, int>, map<int, D0>> := map[v12 := v11];
		var v14: map<int, set<map<int, D0>>> := map[v10[975] * v0 := {v11, if (v12 in v13) then v13[v12] else v11, v11}];
		var v15: set<map<int, D0>> := {v11};
		v14 := v14[v10[975] / v10[975] := v15];
		var v16: multiset<int> := multiset{v0, 0x1ed};
		var v17: map<bool, int> := map[fm0(v3, globalState) := 0x17b / |v16|];
		v17 := v17[v3 := v0];
	}
	var v18 := DC3(DC0(v5[v0]));
	v18 := v18;
	...
	if (v22) {
		v19[54] := v3;
		v19[54] := !(v24[731] == fm1(v0, v5[v0], 0x25e, globalState));
		var v29: array<int> := new int[9];
		v29 := v29;
		var v31: map<seq<bool>, seq<int>> := map[fm2(v3, v22, globalState) := v1];
		var v32: map<seq<int>, seq<int>> := map[v1 := if ([v19[54], v19[54]] in v31) then v31[[v19[54], v19[54]]] else v2[|v24[731]|]];
		var v33: multiset<char> := multiset{v20, v20};
		var v34: map<bool, multiset<char>> := map[v19[54] := v33];
		var v35 := DC4(|v34|);
		var v36 := DC5(!v19[54]);
		globalState.f1, v0, v3 := -0xf2, |(map v30 : seq<int> | v30 in v32[v1 := v1] :: (v30) := (v22))| + v35.cf4, v36.cf5;
		var v37: set<int> := {-(if (v19[54]) then 0x172 else v0), v0, v0, v0};
		globalState.f1, v37 := -|(v2[v0] + v1)| + fm3(v19[54], v3, globalState), (set v38 : int | (0x10e <= v38) && (v38 < -0x216) :: (v38 * v0)) + v37;
		var v39 := DC6(v24[731]);
		if ((v25 + v39.cf6) != v25) {
			var v40: map<int, bool> := map[v0 := v19[54]];
			var v41: map<bool, bool> := map[v3 := if (v0 in v40) then v40[v0] else v3];
			var v42 := new C7(v0, |(v41 + v41)|, v20, if (v19[54]) then v3 else v19[54]);
			v29[164] := v42.f9;
			v29[164] := v0;
			var v43: array<seq<bool>> := new seq<bool>[15];
			v43[946] := fm2(v22, !v3, globalState);
			v43[946] := [v19[54]] + v5;
			v19[54], v29[164], v0, v19[54] := v22, -0x218, v42.fm8(!(v42.fm7(v22, globalState) <= v0), v19[54], v22, globalState), v3;
			v19[54] := v22;
		} else {
			v19[54] := v3;
			...
			var v47: array<array<bool>> := new array<bool>[7] [if (v22) then v45 else v45, v45, v46[v0], v45, v45, v45, v45];
			v47[176] := v45;
			v47[176] := v46[-v0];
			v19[54] := !!v3;
		}
		...
		if (v3 || fm0(v22, globalState)) {
			...
			var v52: array<array<map<char, int>>> := new array<map<char, int>>[5] [v49, v49, v50[|v51|], v49, v49];
			v52[812] := v49;
			globalState.f1, v52[812] := (-v0 * v0) % v0, v49;
			var v53: C6 := new C6();
			...
			v58, v0 := v58 + (if (v22) then v64[-v0] else if (v0 in v65) then v65[v0] else v58), |v5| * v0;
			...
			v70, v1, v19[671], globalState.f1 := multiset{v69, ((map[v22 := v3])[v3 := true])[v22 := v22], v69}, v1 + v1, if (v22) then v3 <==> v3 else v3, -(v0 / (if (0x3a1 in v71) then v71[0x3a1] else -v0));
		}
		
		var v72: map<int, bool> := map[v0 := v3];
		var v73: multiset<int> := multiset{|v72|, |v1|};
		var v74, v75 := m0(v19, v20, multiset{-|v24[731]|, fm3(v22, v3, globalState)} >= v73, v20, globalState);
		v72 := v72[0xfd := v75];
	...
	if (v87.cf52 >= |v89|) {
		...
		match (v91) {
			case DC49(cf66) =>
				v3 := v22;
				var v92: set<bool> := {v3};
				var v93: map<set<bool>, int> := map[v92 := |v24[731]|];
			...
			case DC48(cf65) =>
				...
				globalState.f1 := (v0 / -v0) + |(v24[731] + v25)|;
		...
		var v103: map<bool, seq<C5>> := map[if (v0 in v99) then v99[v0] else !v22 := v102[-v0 := v101]];
		v81[742], v1, v103, v101.f15 := -v0, v1 + (v1 + v1), v103 + (v103 + v103[v22 := v102]), v0;
		var v104: C0 := new C0(642 > (if (!v22 in v88) then v88[!v22] else v101.f15), (v2 + v2)[v101.f15 := v1]);
		v104, globalState.f1, v24[731] := v104, -v0, v25;
		var v105: multiset<char> := multiset{v20};
		var v106: array<int> := new int[29] [v101.f15, v81[742], v81[742], v101.f15, v0, -|v1|, v101.f15, v101.f15, |v24[731]|, v101.f15, v0, |[false]|, v101.f15, if (v20 in v105) then v105[v20] else 0x49, v101.f15, v81[742], v101.f15, 864, 933, v101.f15, |v99|, v81[742], |{|v1|}|, v101.f15, |v1|, v81[742], v101.f15, v101.f15, v101.fm8(v3, v3, !v22, globalState)];
		var v107, v108 := v83.m4(v106, v5, v104.f11, v81[742], globalState);
	} else {
		var v109: set<array<bool>> := {v83.f7};
		v19[265] := v83.f7 !in v109;
		v19[265] := v3;
		match (v21) {
			case DC1() =>
				globalState.f1 := v0 + -(v0 + -v0);
				...
				v19[265] := false;
			case DC2(cf1, cf2) =>
				var v114 := new C3(v25 <= v24[731], true);
				var v115: set<bool> := {v3};
				var v116: map<int, set<bool>> := map[v0 := v115];
				var v117: map<set<bool>, bool> := map[{v22} := v3];
				globalState.f1, cf2, globalState.f1 := v0 % (v0 / v0), fm22(v115 - DC50(if (v0 in v116) then v116[v0] else v115).cf67, v83.fm7(v114.f14, globalState) / v0, v83.fm10(v84, v117, v0, globalState), multiset{true} > fm48(v0, !true, globalState), globalState), v0;
				v22, v25, globalState.f1 := v3, v24[731], v0;
			...
			case DC0(cf0) =>
				...
				var v123: array<T1> := new T1[21] [v119, v119, v119, v119, v119, v119, v119, v120[|v122|], v119, v119, v119, v119, v119, v119, v119, v119, v119, v119, v119, v119, v119];
				v123[899] := if (v3) then v119 else v119;
				v123[899] := new C4();
				...
				v19[265] := v5 in v127[v5 := v0];
				v81[614] := v0;
				v81[614] := (if (v126) then 0x6e else 0x1b6) % v0;
			case DC3(cf3) =>
				var v128: map<array<int>, bool> := map[v81 := v3];
				var v129 := new C5(|(if (v19[265]) then v128[v81 := v22] else v128)|, v25[-v0], !v3);
				var v130, v131 := v83.m2(v22, v129.f15, "ylqpcjtj", globalState);
				v19[265] := v3;
				v81[892] := |(v5 + v5)|;
				v81[892] := v0 * (v129.f15 * v0);
		}
		
		v20 := v20;
		v83 := new C8(v83.f7, v82, v20, v3);
		v22 := 'f' !in ("asmrl")[|"pjcwgjki"| := v20];
	}
	...
	for i4 := v0 to v0 - v0 {
		...
		v19[71], v132, globalState.f1 := v3, (multiset{v83.fm4(v5, i4, i4, multiset{v0}, globalState), i4, v0, -v0, |v135|} + v132) + v136[|v25|], if (v133.f6) then --(0x3d7 / |(seq(0x176, i5  => (v133.f5)))|) else v133.fm7(v22, globalState);
		var v137: array<multiset<int>> := new multiset<int>[27];
		v137[329] := v132;
		v137[329], globalState.f1, v0 := v132 - v132, |(fm1(0x15b, v19[71], v0, globalState) + v25)|, v83.fm4(v5, i4, v0, v132, globalState);
		...
		var v142 := DC51(v139);
		var v143 := DC43(0x2b4, v19[71], v0);
		globalState.f1, v22, v139, v81[439], v24[731] := -i4, v0 != |v141|, v142.cf68, v143.cf56, seq(0x1c0, i6  => (v133.f5));
	}
	if (v0 > v0) {
		var v144: C2 := new C2(v20, v3);
		v144 := v144;
		globalState.f1 := |v25| - v0;
		var v145: seq<string> := [v24[731]];
		v81[793] := |("b" + v145[v144.fm7(v22, globalState)])|;
		globalState.f1, v0, v22, v81[793] := -(v0 - v0), v0, v144.fm9(v0, v4, false, v0, globalState), v0 - v83.fm8(v22, true, v3, globalState);
		v0 := 0x166;
		v22 := true;
	} else {
		globalState.f1 := v0;
		...
		decreases 100 - i8
	{
		...
		v3, v151 := if (fm0(v5[v0], globalState)) then v3 else v151 <= v151, multiset(v1) * v151;
	}
	var i9 := 0;
	while (v22)
		decreases 100 - i9
	{
		...
		globalState.f1 := |v151|;
		globalState.f1 := v0 * v0;
		v81[458] := fm3(false, v3, globalState) - -v0;
		...
		v81[458], v158[729], v83.f7, v0 := v0, (if (0x1eb in v162) then v162[0x1eb] else v160) * v160[v159 := v0], v19, v0;
	}
}