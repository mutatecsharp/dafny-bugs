...
class C2 extends T0, T1 {
	...
	method m1(p0: seq<int>, p1: bool, p2: string, globalState: GlobalState) returns (r0: int, r1: char) {
		...
		var v3: map<int, seq<map<bool, bool>>> := map[p0[safeIndex(fm24({f12, f12, |p2|}, globalState), |p0|)] := v2];
		var v4 := DC1(v2 + (if (f12 in v3) then v3[f12] else [v1]));
		match (v4) {
			case DC2(cf2, cf3, cf4) =>
				var v5: array<bool> := new bool[22];
				v5[safeIndex(309, v5.Length)] := v0;
				var v6: set<int> := {cf2, |p2|, -0x48};
				v5[safeIndex(309, v5.Length)] := (v6 - v6) >= v6;
				v6 := v6;
				if (cf3) {
					...
					var v11: array<set<bool>> := new set<bool>[14] [{v0}, v10 + v10, v10, {v5[safeIndex(309, v5.Length)], true}, v10, v10, v10, v10, if (true) then v10 else v10, {v0} - v10, v10, v10, v10, v10];
					v11 := v11;
					...
					v16 := v16[v8.f13 := v5[safeIndex(309, v5.Length)]];
					...
					var v26: map<int, bool> := map[|[v23[safeIndex(896, |v23|)], cf3]| * fm24(v25[safeIndex(p0[safeIndex(v22, |p0|)], |v25|)], globalState) := v0];
					v26 := v26[f12 := !v20 ==> v0];
					...
					v27[safeIndex(976, v27.Length)] := safeModuloInt(|(if ((if (p1 in v1) then v1[p1] else false) in v28) then v28[if (p1 in v1) then v1[p1] else false] else v25[safeIndex(|v30|, |v25|)])|, -fm24(v6, globalState));
					v27[safeIndex(976, v27.Length)] := v22 - cf2;
			...
			case DC1(cf1) =>
				...
				v32[safeIndex(478, v32.Length)] := v0;
				var v33 := DC5(f12, f11, f11, v0, v0);
				v32[safeIndex(478, v32.Length)] := v33.cf11;
				var v34: multiset<array<bool>> := multiset{v32};
				v32[safeIndex(478, v32.Length)] := (v34 - v34) <= v34;
				var v35: set<bool> := {f11, v0, v32[safeIndex(478, v32.Length)]};
				var v36: map<set<bool>, set<bool>> := map[v35 := v35];
				if (v35 !! (if ({v0, v0} in v36) then v36[{v0, v0}] else {v0})) {
					var v37: map<bool, seq<int>> := map[v32[safeIndex(478, v32.Length)] := p0];
					var v38: seq<bool> := [v32[safeIndex(478, v32.Length)], f11, v32[safeIndex(478, v32.Length)], false];
					var v39: map<bool, int> := map[v32[safeIndex(478, v32.Length)] := f12];
					var v40: array<seq<int>> := new seq<int>[6] [p0, (if (!fm23(p2, f12, 0x310, v32[safeIndex(478, v32.Length)], globalState) in v37) then v37[!fm23(p2, f12, 0x310, v32[safeIndex(478, v32.Length)], globalState)] else p0) + p0[safeIndex(|v38|, |p0|) := |v39|], [f12, f12], p0, p0, p0];
					var v41: map<int, array<seq<int>>> := map[f12 := v40];
					var v42: seq<array<seq<int>>> := [if (f12 in v41) then v41[f12] else v40];
					v40 := v42[safeIndex(f12, |v42|)];
					var v43 := 'l';
					r1 := v43;
					v32[safeIndex(478, v32.Length)] := !(p2 in ([p2])[safeIndex(f12, |[p2]|) := p2]) && !fm23(p2, f12, f12, v32[safeIndex(478, v32.Length)], globalState);
					var v44: array<C0> := new C0[3];
					var v45: C0 := new C0(f12);
					v44[safeIndex(607, v44.Length)] := v45;
					v44[safeIndex(607, v44.Length)] := v45;
					v40[safeIndex(567, v40.Length)] := p0;
					var v46: seq<seq<bool>> := [v38];
					var v47: multiset<seq<bool>> := multiset{v38, v46[safeIndex(v45.f13, |v46|)]};
					var v48: multiset<bool> := multiset{v0};
					var v49: map<multiset<seq<bool>>, seq<int>> := map[v47 := p0[safeIndex(p0[safeIndex(if (v32[safeIndex(478, v32.Length)] in v48) then v48[v32[safeIndex(478, v32.Length)]] else |p2|, |p0|)], |p0|) := f12] + p0];
					v40[safeIndex(567, v40.Length)] := if (v47 in v49) then v49[v47] else seq(abs(0x28b), i1  => (-644));
				} else {
					var v50: set<int> := {f12};
					...
					var v57: seq<set<int>> := [v50, {f12}, {|(seq(abs(0x17), i2  => (|map[p2 := v0]|)))|}];
					var v58: multiset<int> := multiset{848, fm24(v57[safeIndex(f12, |v57|)], globalState), |{v56, v56, v56}|};
					var v59: map<int, int> := map[|v1| := f12];
					globalState.f2 := if (0x2d5 in v58) then v58[0x2d5] else |(if (fm23(p2, v56.f13, |v59|, v32[safeIndex(478, v32.Length)], globalState)) then seq(abs(0x12c), i3  => ('y')) else p2)|;
		...
		for i6 := -f12 to |v64| {
			...
			v75 := v75[v74 + map[v73 := p1] := seq(abs(0x93), i7  => ('j'))];
		}
		r0 := -safeDivisionInt(f12, DC4(f12).cf6);
		var v76 := 'q';
		r1 := v76;
	}
	method m6(globalState: GlobalState) returns (r0: int, r1: int, r2: bool) {
		...
		var v2: set<int> := {|(seq(abs(0x2f8), i1  => ('s')))|, f12, |v1|};
		for i0 := f12 to fm24(v2, globalState) {
			r2 := if (f11) then f11 else f11;
			globalState.f2 := i0;
			var v3 := "y";
			if (!fm23(v3, safeDivisionInt(i0, -836), i0, f11, globalState)) {
				v3 := ((v3 + v3) + v3)[safeIndex(f12, |((v3 + v3) + v3)|) := 'f'];
				var v4: array<bool> := new bool[16];
				var v5 := DC5(i0, f11, f11, f11, f11);
				v4[safeIndex(561, v4.Length)] := v5.cf9 || f11;
				var v6: array<D2> := new D2[22](i2 => v5);
				var v7: seq<bool> := [!f11, f11, true, f11, !f11];
				var v8: multiset<bool> := multiset{f11};
				r2, v4[safeIndex(561, v4.Length)], r2, v6 := f12 != |v7|, v8[false := abs(i0)] != (v8 - v8), f11, v6;
				var v9 := 'j';
				var v10 := DC2(f12, v4[safeIndex(561, v4.Length)], -552);
				var v11: array<seq<bool>> := new seq<bool>[4] [v7, v7 + v7, v7, if (v10.cf3) then v7 else [v4[safeIndex(561, v4.Length)]]];
				v11[safeIndex(807, v11.Length)] := v7;
				var v12: map<bool, char> := map[f11 := v9];
				var v13: set<char> := {if (v4[safeIndex(561, v4.Length)] in v12) then v12[v4[safeIndex(561, v4.Length)]] else 'w', v9};
				var v14: array<int> := new int[7] [|v3|, |v13|, f12, i0, f12, i0, f12];
				var v15: seq<array<int>> := [v14, v14, v14];
				var v16: array<array<int>> := new array<int>[3] [v15[safeIndex(i0, |v15|)], v14, v14];
				v16[safeIndex(113, v16.Length)] := v14;
				var v17: set<bool> := {v4[safeIndex(561, v4.Length)], v4[safeIndex(561, v4.Length)]};
				v9, v11[safeIndex(807, v11.Length)], globalState.f2, v16[safeIndex(113, v16.Length)], v7 := fm26(safeDivisionInt(i0, i0), |({f11} + v17)|, v4[safeIndex(561, v4.Length)], globalState), v7 + v7, -(if (|v3| <= i0) then |(v7 + v7)| else f12), v14, v7[safeIndex(f12, |v7|) := if (true) then f11 else v4[safeIndex(561, v4.Length)]];
				globalState.f2 := i0;
				v4[safeIndex(561, v4.Length)] := f11;
			} else {
				...
				v26 := v26 * v27.cf21;
				var v28: seq<int> := [i0];
				globalState.f2 := if (!(v28 < (seq(abs(0x129), i4  => (0x375))))) then f12 else f12;
		...
		v32[safeIndex(923, v32.Length)] := v31;
		var v33: array<string> := new string[24](i6 => DC11(DC11("fwqyvo").cf22).cf22);
		var v34 := "g";
		var v35 := 'x';
		var v36 := DC11(v34[safeIndex(261, |v34|) := v35]);
		v33[safeIndex(772, v33.Length)] := v36.cf22;
		v32[safeIndex(923, v32.Length)], v33[safeIndex(772, v33.Length)], r1, r2 := if (f11) then v31 else v31, ((seq(abs(0x30), i7  => (v35))) + v34) + ((seq(abs(569), i8  => (v35))) + v34), f12, f11;
		var v37, v38, v39 := m0(f12, globalState);
		var v40: seq<int> := [f12];
		for i9 := v39 to |v40| {
			var v41: seq<seq<int>> := [fm27(v40, !v37, v37, globalState)];
			r0 := |v41|;
			v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)] := 0x1e3;
			var v42: seq<map<bool, bool>> := [v0[v38 := false]];
			var v43 := DC1(v42);
			v35, v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)], v43 := 'r', 0x2c3, v43;
			v39 := safeModuloInt(v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)], v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)] * |v40|);
			var v44: set<array<int>> := {v31};
			var v45 := DC2(v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)], v37, v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)]);
			v32[safeIndex(923, v32.Length)][safeIndex(816, v32[safeIndex(923, v32.Length)].Length)] := |v44| + v45.cf4;
		}
		match (match DC2(v39, f11, f12) {
			...
			case DC4(cf6) =>
				v37 := v37 <==> false;
				var v47 := new C0(cf6);
				v31[safeIndex(311, v31.Length)] := 0x329;
				v31[safeIndex(311, v31.Length)] := v39 * (cf6 * cf6);
				cf6 := -v47.f13;
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				...
				v50[safeIndex(510, v50.Length)] := cf11;
				var v52: map<int, bool> := map[|v33[safeIndex(772, v33.Length)]| := v38];
				r1, r1, v50[safeIndex(510, v50.Length)], cf9 := cf7, -|(((map v51 : int | (865 <= v51) && (v51 < 0xb9) :: (safeDivisionInt(v51, 0xeb)) := (true)) + (v52[f12 := cf11])[|v40| := fm23(v33[safeIndex(772, v33.Length)], f12, |(seq(abs(0x91), i10  => (v35)))|, cf11, globalState)]) + v52[f12 := cf11])|, cf8, true;
				var v53 := DC6(v35);
				v35 := v53.cf12;
				r2 := v50[safeIndex(510, v50.Length)];
				var v54 := DC5(cf7, cf11, f11, cf11, cf8);
				cf8 := (v54.(cf11 := f11, cf8 := v50[safeIndex(510, v50.Length)], cf9 := !!cf11)).cf11;
			case DC3(cf5) =>
				r1 := v39;
				var v55 := new C0(f12);
		...
		r1 := (v39 - |v57|) * |v33[safeIndex(772, v33.Length)][safeIndex(|v58|, |v33[safeIndex(772, v33.Length)]|) := v35]|;
		r2 := v37;
	}
	method m7(p0: bool, p1: bool, globalState: GlobalState) returns (r0: int, r1: string, r2: int) {
		...
		if (p1) {
			...
			v4[safeIndex(881, v4.Length)] := v0;
			var v5: map<int, array<bool>> := map[f12 + f12 := v0];
			v4[safeIndex(881, v4.Length)] := if (f12 in v5) then v5[f12] else v0;
			var v6: map<bool, bool> := map[!p0 := p1];
			var v7: set<map<bool, bool>> := {v6, v6, v6};
			v7 := v7;
			var v8 := true;
			var v9: seq<map<bool, bool>> := [v6];
			v8 := fm23(seq(abs(0x8c), i0  => ('p')), |v9|, f12, p0, globalState);
			...
			var v12: seq<C0> := [v11];
			var v13: array<int> := new int[6] [|v12|, safeModuloInt(v11.f13, v11.f13), f12 - -v11.f13, |(v1 + [v11.f13, |v1|, f12])[safeIndex(v11.f13, |(v1 + [v11.f13, |v1|, f12])|) := v11.f13]|, f12, f12];
			v13[safeIndex(352, v13.Length)] := f12;
			...
			r0, v13[safeIndex(352, v13.Length)], v14, v17 := safeModuloInt(v11.f13, v11.f13), |v21|, v14, v17;
			var v22, v23, v24 := m6(globalState);
			v24 := !(if (p1) then f11 else true);
			var v25: array<array<int>> := new array<int>[7];
			v25[safeIndex(966, v25.Length)] := v13;
			v0[safeIndex(251, v0.Length)] := !!false;
			v13[safeIndex(352, v13.Length)], v25[safeIndex(966, v25.Length)], v0[safeIndex(251, v0.Length)] := 0x16d, v13, p1;
		}
		...
		var v30 := 'u';
		r1 := ((fm25(!f11, f12, globalState) + v26) + (if (v28 in v29) then v29[v28] else "i"))[safeIndex(f12, |((fm25(!f11, f12, globalState) + v26) + (if (v28 in v29) then v29[v28] else "i"))|) := v30];
		globalState.f2 := 0xee;
		...
		match (v35) {
			case DC2(cf2, cf3, cf4) =>
				...
				v41 := if (v42[safeIndex(|v43|, |v42|)]) then if (p1) then v41 else DC4(f12) else v41;
			case DC1(cf1) =>
				if (p0) {
					var v44: set<string> := {"c", v26};
					var v45 := DC12(f11, fm26(f12, f12, f11, globalState));
					v26 := ("xramcle")[safeIndex(|v44|, |"xramcle"|) := v45.cf24] + v26;
					var v46 := new C0(f12);
					var v47 := false;
					var v48: seq<C0> := [v46, v46, v46];
					var v49: map<int, string> := map[v46.f13 := v26];
					v0[safeIndex(451, v0.Length)] := p1;
					var v50 := DC15(v0);
					var v51: map<array<bool>, bool> := map[v50.cf27 := p1];
					v47, v48, v49, v0[safeIndex(451, v0.Length)] := v47, v48 + v48[safeIndex(f12, |v48|) := v48[safeIndex(v46.f13, |v48|)]], map[f12 := fm25(if (v0 in v51) then v51[v0] else p0, 0xb9, globalState)], true;
					r0 := f12 + |(v26 + v26)|;
				...
				match (v62.(cf27 := v0)) {
					case DC16(cf28, cf29, cf30, cf31) =>
						v0[safeIndex(406, v0.Length)] := v33 <= v33;
						v0[safeIndex(406, v0.Length)] := false;
						var v63: multiset<int> := multiset{cf31, |v26|};
						globalState.f2 := (cf28 + |v63|) * cf31;
						var v64: set<bool> := {p0};
						var v65: array<int> := new int[2] [cf31, safeModuloInt(cf28, |v64|)];
						v65[safeIndex(202, v65.Length)] := cf28;
						v65[safeIndex(202, v65.Length)] := -0x16e;
						var v66 := DC16(cf31, p0, f11, cf28);
						cf29 := v66.cf29;
					case DC15(cf27) =>
						var v67: T0 := new C1(v1[safeIndex(f12, |v1|)], f3);
						v67 := v67;
					...
					case DC17(cf32) =>
						...
						v75[safeIndex(685, v75.Length)] := f12;
						...
						globalState.f2, globalState.f2, v74, v75[safeIndex(685, v75.Length)] := |((v26 + v26) + (v26 + v26)[safeIndex(v72.f13, |(v26 + v26)|) := v30])|, safeModuloInt(-v72.f13, v72.f13), if ((if (fm23(v26, v72.f13, v72.f13, v71, globalState)) then v26 else v26[safeIndex((fm30(v72.f13, f12, "hkitllpy", globalState)).cf7, |v26|) := 'f']) in v77) then v77[if (fm23(v26, v72.f13, v72.f13, v71, globalState)) then v26 else v26[safeIndex((fm30(v72.f13, f12, "hkitllpy", globalState)).cf7, |v26|) := 'f']] else v74, f12;
						var v78 := new C0(v1[safeIndex(v72.f13, |v1|)]);
...
class C3 {
	...
	method m5(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool, r1: bool, r2: char, r3: bool) {
		...
		v0[safeIndex(803, v0.Length)] := v3 + v3;
		v0[safeIndex(803, v0.Length)] := v3;
		...
		match (v6) {
			case DC4(cf6) =>
				...
				var v17: array<bool> := new bool[27] [fm21(|v10|, v11, fm21(-|v12[fm19(v11, v13[safeIndex(|v14|, |v13|)], globalState) := v2]|, v11, p1, f10, globalState), p1, globalState), v9 >= v9, multiset(v13) > f9, f10, p1, fm21(|v8|, v11, f10, false, globalState), p1, f10, if (false) then p1 else f10, p1, p1, v15.cf11, if (f10) then true else f10, !f10, f10, p1, false, f10, f10 <==> !f10, p1, p1 && f10, p1, false, (set v16 : int | v16 in v13 :: (safeModuloInt(v16, |(seq(abs(0x3e2), i0  => (0x79)))|))) > {p0, cf6}, p1, v13 == v13, fm21(cf6, v11, if (true in v1) then v1[true] else f10, p1, globalState)];
				v17[safeIndex(725, v17.Length)] := p1;
				v17[safeIndex(725, v17.Length)] := f10;
				v2 := v2;
				v17 := v17;
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				cf11 := p0 != (cf7 - cf7);
				...
				r1 := if (fm22(v19, cf7, v20, globalState) !in map[v6 := p1]) then fm21(p0, v20, v21[safeIndex(cf7, |v21|)], cf10, globalState) else fm21(cf7, v20, f10, cf10, globalState);
			...
			case DC3(cf5) =>
				var v26 := "lnqpg";
				var v27 := 'b';
				var v28 := DC9(0x3df, v27, seq(abs(0x77), i1  => (141)), p0, f10);
				var v29: seq<int> := [p0, -0x350];
				var v30: seq<int> := [|(v26 + fm25(v28.cf20, |v29|, globalState))|];
				globalState.f2 := v29[safeIndex(p0, |v29|)];
				globalState.f2 := p0;
				var v31: array<string> := new string[27];
				v31[safeIndex(842, v31.Length)] := fm25(f10, 0x1bc, globalState);
				v31[safeIndex(842, v31.Length)] := seq(abs(0x281), i2  => (v27));
				r3 := p1;
		}
		...
		v34[safeIndex(975, v34.Length)] := v37;
		var v38: map<multiset<int>, int> := map[f9 := -|[f10, p1, !f10, f10, p1]|];
		v34[safeIndex(975, v34.Length)] := match DC3(v38) {
			case DC4(cf6) => v37
...
class C4 extends T1, T0 {
	...
	method m1(p0: seq<int>, p1: bool, p2: string, globalState: GlobalState) returns (r0: int, r1: char) {
		...
		v2, v3[safeIndex(414, v3.Length)], globalState.f2 := v2, v0, |(map v4 : map<int, bool> | v4 in v7 :: (v4) := (v0))[v8 := v0 * v0]|;
		var i0 := 0;
		while (p1)
			decreases 100 - i0
		{
			...
			var v13: array<D2> := new D2[8] [DC3(v9), v10, DC3((map[f8 := |(seq(abs(0x21a), i1  => (|(multiset{v3[safeIndex(414, v3.Length)], -0x3b3})[|p2| := abs(v0)]|)))|])[f8 := if (|v12| in v11) then v11[|v12|] else v0]), v10, v10, v10, v10, v10];
			v13[safeIndex(780, v13.Length)] := v10;
			v13[safeIndex(780, v13.Length)] := v10;
			var v14 := "c";
			v14 := v14 + (p2 + p2);
			if (f7) {
				...
				v18 := v18[v3[safeIndex(414, v3.Length)] := [f7, v15] + v17];
				v15 := v15;
				v3[safeIndex(414, v3.Length)] := v0;
			} else {
				var v19 := DC6('l');
				v0 := p0[safeIndex(|fm16(v3[safeIndex(414, v3.Length)], v19.cf12, v3[safeIndex(414, v3.Length)], globalState)|, |p0|)];
				var v20: seq<seq<char>> := [p2, ['r']];
				globalState.f2 := fm17([v14], v3[safeIndex(414, v3.Length)], |p0|, v3[safeIndex(414, v3.Length)], globalState) + fm17(v20, v0, v3[safeIndex(414, v3.Length)], v0, globalState);
				var v21: array<D2> := new D2[22];
				v21 := v21;
				var v22: map<bool, bool> := map[false := true];
				var v23: seq<int> := [v3[safeIndex(414, v3.Length)], v3[safeIndex(414, v3.Length)], |v22| * v3[safeIndex(414, v3.Length)], --0xd4, safeModuloInt(571, v0)];
				var v24: set<array<bool>> := {v2};
				v0, globalState.f2, v1, globalState.f2, v23 := -safeModuloInt(-|v14|, v0), v0, fm18(|v24|, |p0|, globalState), v3[safeIndex(414, v3.Length)], p0;
				var v25: array<array<int>> := new array<int>[16];
				v25[safeIndex(306, v25.Length)] := v3;
				v25[safeIndex(306, v25.Length)] := v3;
			}
			...
			decreases 100 - i2
		{
			...
			i2 := i2 + 1;
			globalState.f2 := -|((if (p1) then v8 else v8[v3[safeIndex(414, v3.Length)] := f7]) + v8)|;
			var v28 := new C0(if (p1) then fm17(seq(abs(-0x153), i3  => (p2)), v3[safeIndex(414, v3.Length)], v3[safeIndex(414, v3.Length)], v0, globalState) else v3[safeIndex(414, v3.Length)]);
			...
			decreases 100 - i4
		{
			...
			i4 := i4 + 1;
			var v31 := 'x';
			r1, v30, v30 := if (v30) then v31 else p2[safeIndex(v0, |p2|)], v0 <= safeModuloInt(-v0, v0), (v3[safeIndex(414, v3.Length)] * v0) == (if (p1) then v0 else v0);
			var v32: array<set<bool>> := new set<bool>[16](i5 => {v30, !f7, p1} - {p1});
			v32[safeIndex(670, v32.Length)] := {true, p1, f7, !v30};
			var v33: set<bool> := {f7};
			v32[safeIndex(670, v32.Length)] := v33;
			v30 := v3[safeIndex(414, v3.Length)] > v0;
			var v34 := DC4(safeModuloInt(v0, v0));
			match (v34) {
				case DC4(cf6) =>
					v31 := v31;
					v3 := v3;
					var v35: map<int, int> := map[v3[safeIndex(414, v3.Length)] := 0xa9];
					var v36: map<int, int> := map[(if (v0 in v35) then v35[v0] else fm24(v6, globalState)) + v3[safeIndex(414, v3.Length)] := cf6 * cf6];
				...
				case DC5(cf7, cf8, cf9, cf10, cf11) =>
					...
					v0 := v3[safeIndex(414, v3.Length)] - |v39|;
					var v40 := new C0(cf7);
					var v41: seq<bool> := [cf8];
					var v42: multiset<seq<bool>> := multiset{v41 + v41, v41[safeIndex(720, |v41|) := !true], [cf8], v41};
					...
					v44[safeIndex(426, v44.Length)] := v41;
					v44[safeIndex(426, v44.Length)] := v41;
				case DC3(cf5) =>
					...
					v49[safeIndex(914, v49.Length)] := v3;
					var v50: map<bool, multiset<bool>> := map[f7 := multiset{p1} * v46];
					v46, v30, v49[safeIndex(914, v49.Length)] := if (p1 in v50) then v50[p1] else v46, p1, if ((v3[safeIndex(414, v3.Length)] * v45.f12) in v48) then v48[v3[safeIndex(414, v3.Length)] * v45.f12] else v3;
					var v51: map<int, int> := map[v0 := v3[safeIndex(414, v3.Length)]];
					var v52: map<map<int, int>, multiset<int>> := map[v51 := f8 * multiset{v3[safeIndex(414, v3.Length)]}];
					v52 := v52[(v51[v45.f12 := v3[safeIndex(414, v3.Length)]])[|f8| := -|multiset{f7}|] := f8];
					v30, r0, globalState.f2, v30, v30 := true, -(safeDivisionInt(v45.f12, v3[safeIndex(414, v3.Length)]) * v0), v45.f12, f7, safeModuloInt(v0, v0) > v45.f12;
			}
...
class C5 {
	...
	method m4(p0: int, p1: int, globalState: GlobalState) {
		...
		if (!v0) {
			...
			v2[safeIndex(439, v2.Length)] := map[p1 := p1];
			...
			v17[safeIndex(445, v17.Length)] := v18;
			...
			var v25: array<int> := new int[25] [-p1, p1, p0, p0, p1, p1, -|v20|, 0x207, 0x76, p0, v15[safeIndex(p1, |v15|)], p1, p0, fm9(-p1, globalState), p0, p0, p1 * -p1, |(if (v21 in v22) then v22[v21] else seq(abs(0xdc), i3  => (f6)))|, if (v0 in v21) then v21[v0] else p1, safeDivisionInt(fm9(p0, globalState), |v14|), p1, safeDivisionInt(-p0, p0), |(v24 + map[v23 := v0])|, |"ngqqsqvhs"|, p1];
			var v26: seq<bool> := [v0, v0, v0];
			var v27: seq<seq<bool>> := [fm10(v0, globalState), v26];
			var v28 := DC0(v27[safeIndex(0x3e, |v27|)]);
			v25[safeIndex(351, v25.Length)] := |v28.cf0|;
			...
			v16, v17[safeIndex(445, v17.Length)], v25[safeIndex(351, v25.Length)], v29, globalState.f2 := v16 + v16, v18, p1, fm11(v0, v0, DC5(p0, v0, v0, v0, v0), globalState), -((if (v15 in v31) then v31[v15] else |v26|) + p1);
			if (v0) {
				v25[safeIndex(351, v25.Length)] := v25[safeIndex(351, v25.Length)];
				v23[safeIndex(86, v23.Length)] := v0;
				var v32: map<bool, bool> := map[v0 := v0];
				var v33: set<int> := {-v25[safeIndex(351, v25.Length)], |v30|};
				var v34: seq<map<bool, int>> := [v21];
				var v35 := DC5(v25[safeIndex(351, v25.Length)], v0, v0, if (v0 in v32) then v32[v0] else v0, fm7(p0, v0, v19, globalState));
				var v36: map<array<bool>, D2> := map[v23 := v35];
				var v37: map<map<array<bool>, D2>, set<int>> := map[v36 := v33];
				v23[safeIndex(86, v23.Length)], globalState.f2, v14, v32, v33 := !true, (v25[safeIndex(351, v25.Length)] + p0) + (p1 + p0), seq(abs(0x11d), i4  => (f6)), v32[v21 == v34[safeIndex(p1, |v34|)] := f6 in v14], if (v36 in v37) then v37[v36] else v33;
				var v38: map<int, bool> := map[v25[safeIndex(351, v25.Length)] := v23[safeIndex(86, v23.Length)]];
				var v41: map<char, bool> := map['o' := v23[safeIndex(86, v23.Length)]];
				var v42: array<map<int, bool>> := new map<int, bool>[14] [v38, v38, map v39 : int | (0x131 <= v39) && (v39 < 57) :: (v39 - p1) := (v0), v38, map[v25[safeIndex(351, v25.Length)] := v23[safeIndex(86, v23.Length)]], v38, v38, map v40 : int | v40 in v38 :: (safeModuloInt(v40, p0)) := (v23[safeIndex(86, v23.Length)]), fm34(v23[safeIndex(86, v23.Length)], 'k', v15, globalState), v38, v38, map[|v30| := if (f6 in v41) then v41[f6] else if (v23[safeIndex(86, v23.Length)] in v32) then v32[v23[safeIndex(86, v23.Length)]] else v0], v38, map[v25[safeIndex(351, v25.Length)] := v0]];
				var v43: T0 := new C2(true, v25[safeIndex(351, v25.Length)], v42);
				var v44: map<bool, T0> := map[fm7(v25[safeIndex(351, v25.Length)], v0, v19, globalState) := v43];
				var v45: seq<T0> := [v43];
				v44 := v44[true := v45[safeIndex(v25[safeIndex(351, v25.Length)], |v45|)]];
				var v46 := DC7(|v14|, p0);
				var v47: map<D3, array<int>> := map[v46 := v25];
				var v48: map<bool, array<int>> := map[v0 := v25];
				var v49: array<array<int>> := new array<int>[17] [if (v46 in v47) then v47[v46] else v25, v25, v25, v25, v25, v25, v25, if (v23[safeIndex(86, v23.Length)] in v48) then v48[v23[safeIndex(86, v23.Length)]] else v25, v25, v25, v25, v25, v25, v25, v25, v25, v25];
				v49 := new array<int>[9];
				v32 := v32[v23[safeIndex(86, v23.Length)] := v23[safeIndex(86, v23.Length)]];
			} else {
				var v50 := DC7(v25[safeIndex(351, v25.Length)], p0);
				var v51: seq<D3> := [v50, v50, v50];
				v23[safeIndex(140, v23.Length)] := v0;
				var v52 := DC9(p0, f6, v15, |v14|, true);
				var v53: map<D4, array<bool>> := map[v52 := v23];
				v51, v14, globalState.f2, v23, v23[safeIndex(140, v23.Length)] := v51, v14[safeIndex(v25[safeIndex(351, v25.Length)], |v14|) := f6], fm17([v14], p1, safeModuloInt(p0, -0x15f), v25[safeIndex(351, v25.Length)], globalState), if (v52 in v53) then v53[v52] else v23, if (v26[safeIndex(v25[safeIndex(351, v25.Length)], |v26|)]) then v0 else !(|v14| > v25[safeIndex(351, v25.Length)]);
				v23[safeIndex(140, v23.Length)] := fm23(v14 + v14[safeIndex(|v15|, |v14|) := f6], p1, p1, !false, globalState);
				var v54: seq<D0> := [v28];
				v0 := v54 <= v54;
				v25[safeIndex(351, v25.Length)] := p0;
				v21 := v21;
			}
			
			v25[safeIndex(351, v25.Length)], v13 := |(seq(abs(0x164), i5  => (f6)))|, map[true := v14 + (seq(abs(121), i6  => (f6)))];
			var v55: array<map<int, bool>> := new map<int, bool>[2];
			var v56 := new C2(v26[safeIndex(|v14|, |v26|)], |v26|, v55);
		}
		...
		match (v57) {
			case DC12(cf23, cf24) =>
				if (cf23) {
					var v58 := "wgyx";
					var v59: array<string> := new string[6] [v58, v58, seq(abs(536), i7  => (cf24)), v58, "ef", v58];
					var v60 := DC18(v59);
					...
					v61[safeIndex(959, v61.Length)] := v59;
					v61[safeIndex(959, v61.Length)] := v59;
					...
					v64 := v64[v63 := seq(abs(0x3d5), i8  => (f6))];
					...
					var v77 := DC16(v68[safeIndex(p1, |v68|)], if (v75 in v76) then v76[v75] else cf23, cf23, p1);
					v0 := v77.cf29;
					var v78: seq<seq<char>> := [v69];
					v69 := v69 + (v69 + (seq(abs(0xd), i9  => (f6))))[safeIndex(v68[safeIndex(fm17(v78, p0, |v69|, |v72|, globalState), |v68|)], |(v69 + (seq(abs(0xd), i9  => (f6))))|) := cf24];
					v75[safeIndex(309, v75.Length)] := p0;
					var v79: map<set<string>, bool> := map[fm35(globalState) := cf23];
					var v80: set<string> := {v69};
					globalState.f2, v57, v75[safeIndex(309, v75.Length)], v0, v72 := p1, v57, p1, if (v80 in v79) then v79[v80] else !v0, v72;
				...
				if (fm23(seq(abs(608), i10  => (cf24)), 0x128, safeModuloInt(p0, |v82|), cf23, globalState)) {
					var v83: array<int> := new int[4](i11 => i11 - p0);
					v83[safeIndex(915, v83.Length)] := p0;
					var v84: seq<seq<char>> := [v82, seq(abs(0x307), i12  => (cf24))];
					var v85: seq<seq<char>> := [v84[safeIndex(p0, |v84|)], v82, fm25(v0, p0, globalState)];
					var v86: map<int, string> := map[p0 := v82];
					v83[safeIndex(915, v83.Length)], cf23 := fm17(if (v0) then v85 else v85, p1, 0x52, p0, globalState), fm7(p0, cf23, v86[p0 := v82], globalState);
					var v87: array<seq<bool>> := new seq<bool>[15](i13 => [v0, cf23] + [!true]);
					var v88: seq<bool> := [cf23];
					v87[safeIndex(45, v87.Length)] := v88 + v88;
					v87[safeIndex(45, v87.Length)] := [cf23] + v88;
					var v89: seq<int> := [v83[safeIndex(915, v83.Length)] + p0];
					var v90 := DC9(-v83[safeIndex(915, v83.Length)], f6, v89, p0, cf23);
					...
					v93 := v93[cf23 := -p1];
					v0 := if ((seq(abs(0x384), i14  => (v83[safeIndex(915, v83.Length)]))) <= [p0, p0]) then 0x342 == p1 else v0;
				} else {
					var v94: array<int> := new int[26](i15 => i15 + p1);
					v94[safeIndex(457, v94.Length)] := p1;
					v94[safeIndex(457, v94.Length)] := |((v82[safeIndex(p1, |v82|) := cf24] + "q") + "lojxgqr")|;
					var v95: C0 := new C0(p0);
					var v96 := DC8(v95);
					var v97: multiset<D4> := multiset{v96, v96};
					var v98 := DC14(if (v96 in v97) then v97[v96] else p0);
					v98 := fm36(v0, globalState).(cf26 := v94[safeIndex(457, v94.Length)]);
					var v99 := DC21(v94);
			...
			case DC11(cf22) =>
				...
				var v104 := DC4(v103[safeIndex(p0, |v103|)]);
				var v105: seq<D2> := [v104];
				v105 := [v104] + (v105 + v105);
				var v106: array<bool> := new bool[3];
				var v107: seq<array<bool>> := [v106];
				var v108: seq<array<bool>> := [v107[safeIndex(p1, |v107|)], v106];
				var v109 := DC15(v108[safeIndex(p0, |v108|)]);
				match (v109) {
					case DC16(cf28, cf29, cf30, cf31) =>
						v0 := v0;
						cf30 := cf30;
						...
						v110[safeIndex(150, v110.Length)] := safeModuloInt(if (cf31 in v111) then v111[cf31] else |map[cf29 := p0]|, v104.cf6);
						v110[safeIndex(150, v110.Length)] := cf28;
						var v112 := 'm';
						v112 := v112;
					case DC15(cf27) =>
						var v113: seq<map<bool, bool>> := [map[v0 := v0]];
						var v114: map<int, map<bool, bool>> := map[p1 := v113[safeIndex(p0, |v113|)]];
						var v115: set<int> := {p1};
						...
						v0 := (v118[safeIndex(|v119|, |v118|)] + v117) <= multiset(v113 + fm37(DC2(p1, false, p0), v0, globalState));
						v0 := v0;
						globalState.f2 := 14;
					...
					case DC17(cf32) =>
						...
						var v127: array<int> := new int[28](i16 => safeDivisionInt(i16, 0x30a));
						...
						v131[safeIndex(536, v131.Length)] := v127;
						v131[safeIndex(536, v131.Length)] := v127;
				...
				v132[safeIndex(50, v132.Length)] := if (fm9(|cf22|, globalState) in v133) then v133[fm9(|cf22|, globalState)] else -|v134|;
				var v135: map<char, string> := map['b' := cf22 + cf22];
				var v136: map<int, array<int>> := map[p1 := v132];
				var v138: set<char> := {f6};
				v132[safeIndex(50, v132.Length)], v135, globalState.f2, globalState.f2, v136 := if (!true) then p0 else p0, if (v0) then v135 else (map v137 : char | v137 in v138 :: (v137) := (cf22))['f' := cf22], safeModuloInt(p1 + p1, p1), p1, map[p1 := v132];
		}
		...
		match (DC5(|v144|, v145.cf8, v0, v0, f6 !in v139)) {
			case DC4(cf6) =>
				...
				if (v152[safeIndex(p0, |v152|)]) {
					var v154: map<int, int> := map[v146.f12 := -v146.f12];
					var v155: set<int> := {|(map v153 : int | v153 in v154 :: (safeModuloInt(v153, p1)) := (v146.f11))|};
					...
					v156 := v157[safeIndex(cf6, |v157|)] - (multiset{v147, v158[safeIndex(-0x378, |v158|)], v147} + v156);
					...
					v165[safeIndex(473, v165.Length)] := v162;
					v165[safeIndex(473, v165.Length)] := v162[p1 := if (v149.f10) then |v152| else -0x3a7];
				}
				...
				if (v149.f10) {
					...
					var v176: set<int> := {v146.f12, v140[safeIndex(--p1, |v140|)]};
					var v177: map<bool, set<int>> := map[v146.f11 := v176];
					var v178: map<bool, set<int>> := map[v140 == v140 := fm38(|map[v149.f10 := v152[safeIndex(0x1ec, |v152|)]]|, v152[safeIndex(p1, |v152|)], v149.f10, v149.f10, globalState) + (if (v149.f10 in v177) then v177[v149.f10] else {v146.f12, p1})];
					v177 := v177[!(cf6 !in v176) := if (false) then set v179 : int | (0x79 <= v179) && (v179 < 0x4a) :: (safeModuloInt(v179, |(map v180 : int | (0x7c <= v180) && (v180 < 935) :: (v180 - cf6) := (p1))|)) else v176];
			...
			case DC5(cf7, cf8, cf9, cf10, cf11) =>
				...
				v184[safeIndex(389, v184.Length)] := (multiset{v185, v185, v185})[v185 := abs(p1)];
				var v186: multiset<array<int>> := multiset{v185, v185, v185, v185};
				v184[safeIndex(389, v184.Length)] := if (cf8) then v186 - v186 else v186 + v186;
				var v187: multiset<string> := multiset{"polxqwadi"};
				v187 := (v187 + v187)["uiiokhs" := abs(-980)];
				v139 := v57.cf22;
				var v188: array<set<bool>> := new set<bool>[5](i17 => {cf8});
				v188[safeIndex(560, v188.Length)] := fm16(p0, 'l', cf7, globalState);
				var v189: set<int> := {p1};
				var v190: seq<bool> := [!false];
				var v191: set<bool> := {{|(seq(abs(0x220), i18  => (p1)))|} >= v189, cf10, v190[safeIndex(p0, |v190|)]};
				v188[safeIndex(560, v188.Length)] := v191;
			case DC3(cf5) =>
				var v192 := new C2(v0, safeDivisionInt(p0, 0x82), v142);
				if (v192.f11) {
					v0 := v0;
					...
					v195 := v195.(cf27 := v193);
					v0 := p0 <= v192.f12;
					v0 := if (-v140[safeIndex(p0, |v140|)] >= |v139|) then v192.f11 else v192.f11 <==> fm23(v139, |multiset{v192.f12}|, p1, v192.f11, globalState);
				} else {
					v0, v139 := !!!v192.f11, v139;
					globalState.f2 := |({0x24, |v139|} * (set v196 : int | v196 in [p1] :: (v196 * 489)))| - p1;
					v0 := v0;
					var v197: map<int, int> := map[v192.f12 := |v141|];
					globalState.f2 := safeDivisionInt(if (v192.f12 in v197) then v197[v192.f12] else v192.f12, p1);
					var v198 := 'e';
					v198 := f6;
				}
		...
		v199[safeIndex(840, v199.Length)] := (seq(abs(-512), i19  => (f6))) < v139;
		var v200 := DC22(map[p1 := p0]);
		var v201 := DC6(f6);
		var v202: array<int> := new int[11];
		v202[safeIndex(52, v202.Length)] := p1;
		v199[safeIndex(840, v199.Length)], v200, globalState.f2, v201, v202[safeIndex(52, v202.Length)] := v0, v200, (p0 - p1) - (-p1 - 468), v201, p1;
		v199[safeIndex(840, v199.Length)] := !true;
		var v203: multiset<int> := multiset{p0};
		var v204: C3 := new C3(v203, v0);
		var v205: map<C3, char> := map[v204 := f6];
		v199[safeIndex(840, v199.Length)] := v205 != map[v204 := DC6(f6).cf12];
	}
}
...
class C6 {
	...
	method m2(p0: bool, globalState: GlobalState) returns (r0: int, r1: bool) {
			...
			decreases 100 - i0
		{
			...
			var v14: seq<bool> := [p0];
			v11 := v11[v8 - v8 := if (p0) then |v13| else |map[v5[safeIndex(|v14|, |v5|)] := v4]|];
		}
		var v15: multiset<bool> := multiset{true, !p0, p0, p0};
		var v16 := 'x';
		var v17: map<int, bool> := map[0x374 := fm21(f5, v16, p0, false, globalState)];
		var v18 := "tbwc";
		var v19: multiset<int> := multiset{|v15| * f5, f5, safeModuloInt(|v17|, |v18|)};
		...
		v22[safeIndex(678, v22.Length)] := v23;
		v22[safeIndex(678, v22.Length)] := v23;
		for i2 := -f5 - f5 to f5 {
			r1 := p0;
			v15 := v15;
			...
			var v28: array<seq<int>> := new seq<int>[21] [v25 + fm12(p0, |v25|, v26, v27, globalState), seq(abs(699), i4  => (i2)), fm12(p0, |v18|, v26, v27, globalState), v25 + v25, seq(abs(0xf0), i5  => (i2)), [f5], v25, ([f5, i2])[safeIndex(i2, |[f5, i2]|) := f5] + v25, v25, v25, v25, v25, v25, v25, v25, [i2], [|v25|, i2, i2, i2], v25, v25, v25 + [0x2d9], v25 + v25];
			var v29: map<int, array<seq<int>>> := map[v25[safeIndex(i2, |v25|)] := v28];
			...
			decreases 100 - i6
		{
			...
			var v33: seq<int> := [|v30[p0 := v22[safeIndex(678, v22.Length)]]|, |[v32]|, f5, v32.f12];
			var v34: seq<multiset<int>> := [multiset(v33)];
			var v35 := new C3(multiset{|v19|, f5} + v34[safeIndex(v32.f12, |v34|)], p0);
			var v36: seq<bool> := [v32.f11];
			var v37 := DC9(|multiset(v36)|, v16, [|[v32.f12, f5]|], f5, p0);
			v16 := v37.cf17;
			var v38: seq<multiset<bool>> := [fm40(v35.f10, v32.f12, v16, v32.f11, globalState), (multiset{v32.f11})[v32.f11 := abs(f5)], v15];
			var v39: set<int> := {v32.f12};
			var v40: seq<set<int>> := [v39, v39, v39, v39];
			var v41: array<int> := new int[5] [-v32.f12, |(v15 * v38[safeIndex(0x134, |v38|)])|, |v40|, f5, v32.f12];
			v41[safeIndex(999, v41.Length)] := f5;
			var v42: set<bool> := {p0};
			globalState.f2, f5, v41[safeIndex(999, v41.Length)], r1 := v32.f12, |((v42 * v42) - {true, false})|, |(seq(abs(748), i7  => (v32.f12 * |v17|)))[safeIndex(f5, |(seq(abs(748), i7  => (v32.f12 * |v17|)))|) := -(-f5 * v32.f12)]|, v35.f10;
			v23[safeIndex(848, v23.Length)] := f5 != v41[safeIndex(999, v41.Length)];
			v23[safeIndex(848, v23.Length)] := if (v32.f12 > f5) then v32.f11 else v16 in v18;
		}
		...
		r0 := fm9(|v46[v45 := abs(f5)]|, globalState);
		r1 := |(v18 + v18)| <= f5;
	}
	method m3(p0: multiset<string>, p1: int, p2: bool, p3: int, globalState: GlobalState) returns (r0: int, r1: int, r2: set<string>) {
		...
		match (v1) {
			case DC16(cf28, cf29, cf30, cf31) =>
				...
				v2[safeIndex(584, v2.Length)] := |(if (cf30) then v3 else v3)|;
				v2[safeIndex(584, v2.Length)] := cf31;
				cf28 := cf28;
				var v4 := 'x';
				var v5 := DC6(v4);
				var v6 := new C5(v5.cf12);
				var v7: multiset<int> := multiset{v2[safeIndex(584, v2.Length)], p1};
				v2[safeIndex(584, v2.Length)] := safeModuloInt(p1, f5 * (if (f5 in v7) then v7[f5] else |"m"|));
			case DC15(cf27) =>
				var v8 := true;
				...
				globalState.f2 := -safeModuloInt(-fm17(v15, -p1, |v9|, p1, globalState), p1);
			...
			case DC17(cf32) =>
				...
				var v20: set<seq<int>> := {[f5, p3, |(seq(abs(0x1d3), i2  => (228)))|, p1] + v19};
				v20 := v20;
				var v21: array<multiset<char>> := new multiset<char>[29];
				var v22: seq<array<multiset<char>>> := [v21];
				var v23: array<array<multiset<char>>> := new array<multiset<char>>[18] [v21, v21, v21, v21, v21, v21, v21, v21, if (p2) then v21 else v21, v22[safeIndex(p3, |v22|)], v21, v21, v21, v22[safeIndex(f5, |v22|)], v21, if (true) then v21 else v21, v21, v21];
				v23[safeIndex(460, v23.Length)] := v21;
				v23[safeIndex(460, v23.Length)] := v21;
				...
				if ((p2 || p2) <==> (if (f5 in v24) then v24[f5] else p2)) {
					...
					v39[safeIndex(999, v39.Length)] := f5;
					v39[safeIndex(999, v39.Length)] := safeDivisionInt(|([p2, p2])[safeIndex(p3, |[p2, p2]|) := p2]|, |[v0]|);
					var v40, v41 := m2(p2, globalState);
					var v42 := "yxohwdduo";
					var v43: map<char, int> := map[v17.f6 := -|v42|];
					v43 := v43[v17.f6 := 435];
					v41 := fm21(v39[safeIndex(999, v39.Length)], v17.f6, v41, if (v41) then false else v41, globalState);
					var v44: map<bool, int> := map[p2 := p1];
					v44 := v44[v39[safeIndex(999, v39.Length)] != v39[safeIndex(999, v39.Length)] := v40 + v39[safeIndex(999, v39.Length)]];
				}
		...
		if (p2) {
			...
			var v59: seq<string> := [v57, v57, (v57[safeIndex(f5, |v57|) := v48])[safeIndex(-|v58|, |v57[safeIndex(f5, |v57|) := v48]|) := v48]];
			...
			var v68: map<int, char> := map[v49[safeIndex(0x18b, |v49|)] := v48];
			var v69: array<int> := new int[27] [p1, |(map[p2 := v55] + v56)|, p3 + f5, p3, |v59|, p1, fm24(set v62 : int | v62 in v61[safeIndex(p1, |v61|)] :: (v62 * -|[559, 505]|), globalState), if (p1 in v47) then v47[p1] else DC4(p3).cf6, |v57| - DC14(p1).cf26, safeModuloInt(|v63.cf22|, v51[safeIndex(p1, |v51|)]), fm24(set v64 : int | (0xbe <= v64) && (v64 < 666) :: (v64 - |v58|), globalState), safeDivisionInt(|v51|, p1), p1, p3, f5, f5, p1 - f5, p3, f5, v67.cf35, p1 - f5, f5, f5, |[map[0xe1 := 'l'], v68, v68, v68]|, p1, p3, p3];
			v69[safeIndex(963, v69.Length)] := p3;
			var v70: array<char> := new char[22];
			v0[safeIndex(31, v0.Length)] := if (p2) then p2 else v53;
			var v72: map<seq<char>, string> := map[v57 := v57];
			v69[safeIndex(963, v69.Length)], v70, v0[safeIndex(31, v0.Length)] := fm17(v59, |(map v71 : seq<char> | v71 in v72 :: (v71) := (v57))|, p1, f5, globalState), v70, fm21(if (v54.cf30 in f4) then f4[v54.cf30] else f5, v48, p2, p2, globalState);
			...
			globalState.f2 := safeDivisionInt(p3, if (p2) then |v77| else |v57|);
		} else {
			var v78 := true;
			v78 := true || p2;
			var v79: set<int> := {f5};
			if (p3 !in (fm38(0x305, true, !p2, v78, globalState) + v79)) {
				...
				v84 := v84[(if (229 in v85) then v85[229] else seq(abs(-0x88), i4  => (v81.f6)))[safeIndex(f5, |(if (229 in v85) then v85[229] else seq(abs(-0x88), i4  => (v81.f6)))|) := v80] + v82 := v83];
			} else {
				...
				v90[safeIndex(949, v90.Length)] := p1;
				var v91 := 'h';
				v90[safeIndex(949, v90.Length)] := v87.fm19(v91, 0x110, globalState);
				globalState.f2 := safeDivisionInt(safeDivisionInt(0x4a, -(if (f5 in v86) then v86[f5] else f5)), p1);
			}
			...
			decreases 100 - i6
		{
			...
			globalState.f2 := safeModuloInt(-safeModuloInt(p1, |v96|), f5);
...
class C7 extends T0, T1 {
	...
	function fm0(p0: int, globalState: GlobalState): int {
		safeDivisionInt(|map[!false := |[297]|]|, |"fuwqkmw"|) - |(seq(abs(0x2a7), i0  => ('j')))|
	}
	...
	method m1(p0: seq<int>, p1: bool, p2: string, globalState: GlobalState) returns (r0: int, r1: char) {
		...
		if (p1) {
			var v1: seq<bool> := [p1];
			var v2: map<seq<bool>, seq<int>> := map[v1[safeIndex(v0, |v1|) := p1] := p0[safeIndex(v0, |p0|) := |p2|]];
			var v3 := 't';
			var v4: map<bool, bool> := map[p1 := v1[safeIndex(0x12f, |v1|)]];
			...
			v8[safeIndex(667, v8.Length)] := p1;
			v8[safeIndex(667, v8.Length)] := p1;
			var v9: array<map<D1, seq<bool>>> := new map<D1, seq<bool>>[15](i0 => map[DC2(-0x9c, false, v0) := v1] + map[DC2(|map[v8[safeIndex(667, v8.Length)] := v0]|, p1, v0) := v1]);
			var v10: multiset<int> := multiset{v0};
			var v11 := DC2(|v10|, v8[safeIndex(667, v8.Length)], v0);
			var v12: map<D1, seq<bool>> := map[v11 := v1];
			v9[safeIndex(119, v9.Length)] := v12[v11 := v1];
			var v13: set<bool> := {p1};
			v9[safeIndex(119, v9.Length)] := v12[DC2(v0, v8[safeIndex(667, v8.Length)], |v13|) := v1] + map[v11 := v1];
			v8[safeIndex(667, v8.Length)] := v11.cf3;
			v10 := v10;
			if (fm2(v3, v5, p1, globalState)) {
				v6 := fm4(p1, v3, v0, fm5(v0, globalState), globalState);
				var v14: array<string> := new string[29](i1 => p2);
				v14[safeIndex(515, v14.Length)] := p2;
				v14[safeIndex(515, v14.Length)] := p2;
				v8[safeIndex(667, v8.Length)] := v8[safeIndex(667, v8.Length)];
				...
				var v20 := DC0(v1);
				var v21: map<bool, seq<bool>> := map[v11.cf3 := v19[safeIndex(v0, |v19|)] + fm6(|p2|, fm1(v1[safeIndex(-0x7c, |v1|)], v3, v20, v8[safeIndex(667, v8.Length)], globalState), v3, globalState)];
				v21 := v21[v8[safeIndex(667, v8.Length)] := v1];
				var v22: array<int> := new int[20](i3 => i3 + |p2|);
				var v23 := "bgdm";
				globalState.f2, v22, v8[safeIndex(667, v8.Length)], v23 := |("khi" + v23)|, v22, (v0 == v0) <== (fm2(v3, v5, !!true, globalState) && v8[safeIndex(667, v8.Length)]), p2;
			}
			...
			v25[safeIndex(845, v25.Length)] := fm2(v26, v28, v24, globalState);
			v25[safeIndex(845, v25.Length)] := v24;
			v27 := v27 + v27;
			var v29: multiset<int> := multiset{v0, v0, v0};
			var v30: map<int, int> := map[v0 := v0];
			var v31: multiset<bool> := multiset{p1};
			var v32: array<int> := new int[18] [|v29|, v0, v0, v0, v0, v0, v0, 0x129, v0, DC2(0x24f, v25[safeIndex(845, v25.Length)], v0).cf4, v0, |v30|, v0, v0, v0, |p2|, v0, if (p1 in v31) then v31[p1] else v0];
			var v33: map<bool, array<int>> := map[|{p1, v25[safeIndex(845, v25.Length)]}| >= |(seq(abs(-0x2ce), i4  => ('l')))| := v32];
			v33 := v33 + v33;
		}
		
		var v34: array<bool> := new bool[2] [p1, p1];
		v34[safeIndex(649, v34.Length)] := p1 <== false;
		var v35: map<bool, bool> := map[p1 := true];
		var v36: seq<map<bool, bool>> := [v35];
		v34[safeIndex(649, v34.Length)] := !p1 ==> fm2(fm5(v0, globalState), v36, p1, globalState);
		var v37 := new C0(v0);
		var v38: multiset<int> := multiset{v0, |p2|, v37.f13};
		for i5 := safeDivisionInt(|v38|, v0) to v0 {
			v35 := v35[p1 := true];
			if (p1) {
				var v39: seq<char> := ['l'];
				v39 := p2;
				var v40: seq<multiset<int>> := [v38, v38, v38];
				var v41: set<bool> := {v34[safeIndex(649, v34.Length)]};
				var v42: seq<bool> := [v34[safeIndex(649, v34.Length)]];
				var v43: array<multiset<int>> := new multiset<int>[16] [multiset{v37.f13}, v38, v38, v40[safeIndex(0x180, |v40|)], v38, v38, multiset{v37.f13}, multiset{v37.f13, 907}, v38, multiset{i5, v37.f13}, v38, multiset{|"ffaybi"|, |v41|, i5, -v37.f13}, v38, multiset{|v42|}, v38, v38];
				var v44: map<array<multiset<int>>, int> := map[v43 := v0];
				v44 := v44[v43 := v37.f13];
				v34[safeIndex(649, v34.Length)] := !p1;
				v34[safeIndex(649, v34.Length)] := false;
				globalState.f2 := 804;
			} else {
				var v45: multiset<bool> := multiset{p1, v34[safeIndex(649, v34.Length)]};
				var v46: seq<bool> := [v34[safeIndex(649, v34.Length)], p1, p1];
				...
				v34[safeIndex(649, v34.Length)] := v48.cf4 >= v37.f13;
				var v49: array<map<multiset<bool>, multiset<int>>> := new map<multiset<bool>, multiset<int>>[24];
				v49[safeIndex(303, v49.Length)] := fm43(multiset(p0), i5, i5, globalState);
				...
				var v53: set<bool> := {v34[safeIndex(649, v34.Length)], p1};
				var v54: seq<map<string, int>> := [v50, v52[safeIndex(|v53|, |v52|)]];
				var v56: map<string, bool> := map[p2 := v34[safeIndex(649, v34.Length)]];
				v49[safeIndex(303, v49.Length)], v50, v34[safeIndex(649, v34.Length)] := v51 + v51, (v50 + v54[safeIndex(i5, |v54|)]) + (map v55 : string | v55 in v56 :: (v55) := (v37.f13)), v37.f13 > i5;
				v0 := --safeModuloInt(v37.f13, safeDivisionInt(i5, 0x323));
				var v57: map<int, bool> := map[i5 := p1];
				var v58: map<map<int, bool>, int> := map[v57 := -541];
				v34[safeIndex(649, v34.Length)] := map[-i5 := p1] !in v58;
			}
			
			var v59 := DC2(v37.f13, v34[safeIndex(649, v34.Length)], i5);
			v34[safeIndex(649, v34.Length)] := v59.cf3;
			var v60 := DC4(|v38|);
			v60 := v60;
		}
		if (p1) {
			...
			var v62 := 'c';
			r1 := v62;
			var v63: array<int> := new int[8] [v37.f13, v37.f13, v0, v37.f13, 0x9f, p0[safeIndex(v0, |p0|)], v37.f13, |multiset(p2)|];
			var v64 := DC21(v63);
			var v65: map<int, D10> := map[v37.f13 := v64];
			var v66: set<bool> := {p1};
			var v67: map<int, int> := map[v0 := v37.f13];
			v65 := v65[|(fm12(!p1, v0, v66, v67, globalState) + p0)| := v64];
			var v68: C2 := new C2(false && v34[safeIndex(649, v34.Length)], safeModuloInt(v0, v37.f13), f3);
			...
			v72[safeIndex(721, v72.Length)] := v71;
			v72[safeIndex(721, v72.Length)] := v71;
			var v73: multiset<bool> := multiset{v34[safeIndex(649, v34.Length)], v34[safeIndex(649, v34.Length)]};
			var v74: seq<int> := [if (v34[safeIndex(649, v34.Length)] in v73) then v73[v34[safeIndex(649, v34.Length)]] else v37.f13, -v37.f13, v0, v37.f13, v37.f13];
			v74 := v74;
...
function fm2(p0: char, p1: seq<map<bool, bool>>, p2: bool, globalState: GlobalState): bool {
	-(if (true) then |map[DC0([false]) := 'n']| else 0x62) <= -|("bdayefsjg" + (seq(abs(543), i0  => ('w'))))|
}
function fm3(globalState: GlobalState): seq<map<bool, bool>> {
	seq(abs(0x3dc), i0  => (map[true := !true]))
}
function fm4(p0: bool, p1: char, p2: int, p3: char, globalState: GlobalState): D1 {
	DC1(seq(abs(61), i0  => (map[false := false])))
}
...
function fm9(p0: int, globalState: GlobalState): int {
	-safeDivisionInt(|multiset{|{true}|}|, |(map v0 : int | (468 <= v0) && (v0 < -404) :: (v0 * 0xcb) := (415))|) + 0x299
}
...
function fm11(p0: bool, p1: bool, p2: D2, globalState: GlobalState): multiset<int> {
	(multiset{-|"kjyj"|, -0x7b} * multiset{|"pmifknqvs"|}) - multiset([0x30d] + (seq(abs(-0xa6), i0  => (0x196))))
}
function fm12(p0: bool, p1: int, p2: set<bool>, p3: map<int, int>, globalState: GlobalState): seq<int> {
	((seq(abs(0x2ac), i0  => (-|"fxkcy"|))) + (seq(abs(0xad), i1  => (-0x6e)))) + [0xc2]
}
function fm15(p0: bool, p1: bool, globalState: GlobalState): multiset<int> {
	(multiset{|[[0x39, 0x339], seq(abs(13), i0  => (0x381)), [-0x355, |"inrv"|]]|, -0x162, -0x331} - multiset([0x4])) + (multiset{|map[true := 5]|, -|multiset{false}|, |map[true := false]|, |map[|"uvdonglnj"| := false]|} * multiset{|(seq(abs(0x241), i1  => (0x20f)))|})
}
function fm16(p0: int, p1: char, p2: int, globalState: GlobalState): set<bool> {
	({false, true, false} - {!true}) * (if (true) then {false, true, DC9(293, 'i', seq(abs(0x2d6), i0  => (0x2ff)), 37, false).cf20, true} else {true, true})
}
function fm17(p0: seq<seq<char>>, p1: int, p2: int, p3: int, globalState: GlobalState): int {
	-(0xbe - --0x33f) * -safeModuloInt(|[false, true]|, |map[!false := 'r']|)
}
...
function fm22(p0: seq<int>, p1: int, p2: char, globalState: GlobalState): D2 {
	DC3(map[multiset(seq(abs(0x374), i0  => (925))) := |(seq(abs(0x4e), i1  => (|"fqwbp"|)))|] + map[multiset([|multiset(seq(abs(0x301), i2  => (0x345)))|, 0x1d7]) := 819])
}
...
function fm27(p0: seq<int>, p1: bool, p2: bool, globalState: GlobalState): seq<int> {
	if ("hls" <= "nhuwclrv") then seq(abs(0x1d8), i0  => (--387)) else [|DC26(multiset{false}).cf45|] + DC9(0x13d, 'l', [0x6f, |map[true := 'v']|], 0x1bf, !true).cf18
}
...
function fm35(globalState: GlobalState): set<string> {
	if (false ==> true) then {seq(abs(0x18d), i0  => ('b'))} else {seq(abs(-615), i1  => ('o')), "b"}
}
...
function fm42(p0: bool, p1: int, p2: bool, globalState: GlobalState): map<string, map<char, bool>> {
	map v0 : string | v0 in ((set v2 : string | v2 in (map v1 : string | v1 in multiset{"sl", "qwc", "prgm"} :: (v1) := (false)) :: (v2)) - {seq(abs(0x244), i0  => ('k')), "kbeim"}) :: (v0) := (map['w' := true] + map['i' := false])
}
...
method m0(p0: int, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int) {
	...
	v12 := v12[v11 := 0x335];
	v10.f5 := safeDivisionInt(p0, v10.f5);
	...
	v14[safeIndex(813, v14.Length)] := v13;
	v14[safeIndex(813, v14.Length)] := v13;
	r0 := false;
	r1 := v13.f12 < p0;
	var v15 := DC11("tw");
...
method Main() {
	...
	var v2 := DC0(v1);
	var v3 := 124;
	var v4: array<seq<bool>> := new seq<bool>[11] [v1, v1, v2.cf0, v1, v1[safeIndex(v3, |v1|) := v0], v1, v1, v1, v1, [v0], v1];
	...
	if (v5 < v5) {
		...
		if (!v7) {
			...
			v22 := v22[(seq(abs(0xda), i0  => (v13))) < v14 := v8];
		} else {
			...
			var v25 := "ro";
			var v26 := 'j';
			var v27: array<bool> := new bool[9] [if (v0) then v7 else v0, v6, fm21(|v25|, v26, false, v7, globalState), v7, false, if (v6) then fm21(v8, v26, v7, !v7, globalState) else v6, v0, !(if (v7) then !fm2('f', seq(abs(0x2e9), i1  => (map[v7 := v7])), v7, globalState) else v7), v7 <== true];
			...
			v30[safeIndex(154, v30.Length)] := v2;
			v30[safeIndex(154, v30.Length)], v3, globalState.f2, v7, v26 := v2, |(v25 + v25)|, v29.f14, v1[safeIndex(v29.f14, |v1|)], v26;
			var v31: seq<seq<char>> := [v25];
			var v32: set<array<bool>> := {v27, v27};
			var v33: set<C1> := {v29};
			v6 := (|v25| - fm17(v31, v24[safeIndex(v29.f14, |v24|)], |v32|, v29.f14, globalState)) <= fm17([v25, v25, v25[safeIndex(653, |v25|) := 'b']], v29.f14, |map[v3 := |v33|]|, v3, globalState);
		}
		...
		if (v0) {
			...
			var v45: map<int, multiset<bool>> := map[|v39| := v44[v41 := abs(v3)]];
			v45 := v45[v3 := v44];
			var v46: multiset<int> := multiset{v43, v3, v43, v3};
			var v47: C3 := new C3(v46, v41);
			var v48: seq<C3> := [v47];
			var v49: set<map<int, int>> := {v40};
			var v50: array<C3> := new C3[6] [v47, v47, v48[safeIndex(|[|v49|, v43]|, |v48|)], v47, v47, v47];
			v50 := v50;
		} else {
			...
			v51[safeIndex(699, v51.Length)] := |v53|;
			...
			v51[safeIndex(699, v51.Length)] := fm17(v54, |v39|, v57.cf19, v3, globalState);
			v52[safeIndex(689, v52.Length)] := v0;
			v52[safeIndex(689, v52.Length)] := v0;
			v55 := v55[v0 := v51[safeIndex(699, v51.Length)]];
			var v58: map<char, int> := map[v38 := |v39| + v3];
			v58 := v58[v38 := v51[safeIndex(699, v51.Length)]];
	...
	for i4 := v3 to v3 + v3 {
		...
		var v66: array<int> := new int[1] [|v65[safeIndex(--v3, |v65|)]|];
		var v67 := "qm";
		...
		v69[safeIndex(422, v69.Length)] := v0;
		v69[safeIndex(422, v69.Length)] := v0;
		v0 := !v0;
		var v70: multiset<int> := multiset{|v67|};
		var v71 := new C3(v70, true);
		var v72: map<bool, bool> := map[v0 := v71.f10];
		v69[safeIndex(422, v69.Length)] := if (v0 in v72) then v72[v0] else v69[safeIndex(422, v69.Length)];
	}
	v0 := v0;
		...
		decreases 100 - i5
	{
		...
		var v76: map<int, seq<int>> := map[safeModuloInt(|v75|, |v1|) := [v3, v3]];
		v76 := v76;
		...
		decreases 100 - i6
	{
		...
		i6 := i6 + 1;
		v73[safeIndex(724, v73.Length)] := v0;
		v73[safeIndex(724, v73.Length)] := v0;
		globalState.f2 := v3;
		...
		var v91 := DC5(|v90|, v73[safeIndex(724, v73.Length)], v0, !v0, v73[safeIndex(724, v73.Length)]);
		var v92: seq<D2> := [v91];
		var v93 := DC19(v88, |multiset{v92}|, v3);
		var v94: array<T0> := new T0[5] [v88, v88, v93.cf34, v88, v88];
		var v95: seq<T0> := [v88, v88];
		v94[safeIndex(160, v94.Length)] := v95[safeIndex(v3, |v95|)];
		v94[safeIndex(160, v94.Length)] := v93.cf34;
		var v96 := "jfj";
		v96 := v96 + (v96 + "wye");
	}
	...
	var v102: multiset<int> := multiset{v3, |v101|, |(seq(abs(0x28c), i9  => ('i')))|, v3};
	...
	var v116 := new C2(v0, v103[safeIndex(|v115|, |v103|)], v112);
	var v117, v118 := v113.m1(seq(abs(0x77), i10  => (v3)), v109.f13 == v116.f12, v101, globalState);
	v73[safeIndex(902, v73.Length)] := {v109.f13} <= v5;
	v73[safeIndex(902, v73.Length)] := fm21(safeDivisionInt(71, v117), v118, v0 <== v116.f11, v0, globalState);
	v0 := !(v116.f11 <==> (v74 >= v74));
	var v119 := DC15(v73);
	var v120: multiset<D8> := multiset{v119};
	var v121: seq<multiset<int>> := [v102, v102];
	var v122: map<bool, bool> := map[v73[safeIndex(902, v73.Length)] := v0];
	var v123: multiset<seq<int>> := multiset{v103};
	var v124: map<string, int> := map[v101 := -|v74|];
	var v125: array<int> := new int[9] [|(if (v73[safeIndex(902, v73.Length)]) then v120 else v120)|, |(v121[safeIndex(v116.f12, |v121|) := multiset{v117, v116.f12}] + v121)|, if (v0) then v116.f12 else |v102[|v122| := abs(v117)]|, if ([v3] in v123) then v123[[v3]] else v3, if (v101 in v124) then v124[v101] else v108.f5, v3 * v103[safeIndex(|v101|, |v103|)], v109.f13, 0x2b1, v109.f13];
	v125[safeIndex(288, v125.Length)] := v109.f13;
	var v126: map<array<int>, bool> := map[v125 := v73[safeIndex(902, v73.Length)]];
	v125[safeIndex(288, v125.Length)] := |v126|;
	match (DC7(|v1|, safeDivisionInt(v108.f5, v125[safeIndex(288, v125.Length)]))) {
		case DC7(cf13, cf14) =>
			var v127, v128 := v113.m1(fm12(!v116.f11, v108.f5, v97, map[v116.f12 := |v5|], globalState), v116.f11, v101, globalState);
			v73[safeIndex(902, v73.Length)] := v73[safeIndex(902, v73.Length)];
			var v130: map<int, int> := map[cf14 := cf13];
			var v131: map<int, int> := map[fm24(set v129 : int | (0x2a4 <= v129) && (v129 < 163) :: (safeModuloInt(v129, |v97|)), globalState) * |v130| := v109.f13];
			v130 := v131;
			var v132: array<string> := new string[10];
			var v133 := DC18(v132);
			v133, cf13, v73, v125[safeIndex(288, v125.Length)] := v133, safeModuloInt(|v101|, v116.f12 + cf14), v73, (0x14c + |v101|) + v108.f5;
		case DC6(cf12) =>
			v102 := v102 * (v102 + v102);
			v5 := if (v116.f11) then v5 else v5;
			v3 := if (v0) then safeModuloInt(|[v116]|, v108.f5) else v116.f12;
			v0 := true;
	}
	...
	match (v134) {
		case DC9(cf16, cf17, cf18, cf19, cf20) =>
			...
			if (v0) {
				...
				v137[safeIndex(642, v137.Length)] := v103;
				v107, globalState.f2, v3, v137[safeIndex(642, v137.Length)], v73[safeIndex(902, v73.Length)] := (v108.f4 + v107) + v108.f4, v117, v109.f13, cf18, !((multiset(v1))[v116.f11 := abs(|(v122[false := v73[safeIndex(902, v73.Length)]])[v0 := v116.f11]|)] != multiset(v1));
				var v138: map<C7, seq<int>> := map[v113 := v137[safeIndex(642, v137.Length)]];
				var v139: seq<seq<int>> := [v137[safeIndex(642, v137.Length)], v137[safeIndex(642, v137.Length)]];
				v138 := (map[v113 := v103])[v113 := v139[safeIndex(v109.f13, |v139|)]] + v138;
				...
				var v142: seq<seq<bool>> := [[false, if (v116.f12 in v100) then v100[v116.f12] else cf20], if (v73[safeIndex(902, v73.Length)]) then v1 else v1, v1];
				var v143: T0 := new C2(v73[safeIndex(902, v73.Length)], v108.f5, v112);
				...
				var v145: array<char> := new char[12] [v101[safeIndex(v109.f13, |v101|)], v85, v101[safeIndex(|v101|, |v101|)], v85, v86.f6, v118, if (!true) then DC6(v118).cf12 else v86.f6, v86.f6, v86.f6, cf17, v86.f6, v86.f6];
				v145[safeIndex(825, v145.Length)] := v86.f6;
				var v146: map<bool, set<bool>> := map[v0 := v97];
				var v147 := DC22((map[|v101| := |(if (cf20 in v146) then v146[cf20] else v97)|])[v108.f5 := v3]);
				v145[safeIndex(131, v145.Length)] := if (cf20) then v136 else v86.f6;
				v0, v145[safeIndex(825, v145.Length)], v147, v145[safeIndex(131, v145.Length)] := v116.f11, v118, v147, v101[safeIndex(safeDivisionInt(-851, |{"lbovk", "kydcrfrb"}|), |v101|)];
			}
			
		case DC8(cf15) =>
			if (cf15.f13 == (-0x1e5 - v109.f13)) {
				v121 := v121;
				globalState.f2 := -safeDivisionInt(fm9(0x344, globalState), v125[safeIndex(288, v125.Length)]);
				v108.f5 := if ((if (true) then v73[safeIndex(902, v73.Length)] else fm2('r', [v122], false, globalState)) in v107) then v107[if (true) then v73[safeIndex(902, v73.Length)] else fm2('r', [v122], false, globalState)] else v117 + cf15.f13;
				globalState.f2 := v117;
				v3 := fm9(cf15.f13 * v116.f12, globalState);
			} else {
				v73[safeIndex(902, v73.Length)] := true;
				v5 := v5 - v5;
				var v148: array<C6> := new C6[7];
				v148 := v148;
				var v149: seq<C2> := [v116, v116];
				var v150 := DC24(v116);
				var v151: array<C2> := new C2[23] [v116, v116, v116, v149[safeIndex(v116.f12, |v149|)], v116, v116, v116, v116, if (v73[safeIndex(902, v73.Length)]) then v116 else v116, v116, v116, v116, v116, v116, v116, if (v116.f11) then v116 else v150.cf41, v116, v149[safeIndex(v125[safeIndex(288, v125.Length)], |v149|)], v116, v116, v116, v116, v116];
				v151[safeIndex(385, v151.Length)] := v116;
				v151[safeIndex(385, v151.Length)] := v116;
				var v152 := new C7(v112);
			}
			
			var v153: C4 := new C4(v73[safeIndex(902, v73.Length)], v102, v112);
			var v154: map<C4, bool> := map[v153 := v0];
			v101 := (v101 + v101)[safeIndex(|v154|, |(v101 + v101)|) := v86.f6] + v101;
			var v155: seq<seq<char>> := [v101];
			var v156: map<int, int> := map[v117 := fm17(v155, fm9(v109.f13, globalState), v116.f12, v116.f12, globalState)];
			v125[safeIndex(288, v125.Length)] := if (v109.f13 in v156) then v156[v109.f13] else -0x1e;
	...
	print v4[9] == [false], "\n";
	print v4[10] == [false], "\n";
	print globalState.f0[0] == [false], "\n";
	print globalState.f0[1] == [false], "\n";
	print globalState.f0[2] == [false], "\n";
	print globalState.f0[3] == [false], "\n";
	print globalState.f0[4] == [false], "\n";
	print globalState.f0[5] == [false], "\n";
	print globalState.f0[6] == [false], "\n";
	print globalState.f0[7] == [false], "\n";
	print globalState.f0[8] == [false], "\n";
	print globalState.f0[9] == [false], "\n";
	print globalState.f0[10] == [false], "\n";
	...
	print v119.cf27[28], "\n";
	print |v120|, "\n";
	print v121 == [multiset{124, 124, 1, 652}, multiset{124, 124, 1, 652}], "\n";
	print v122 == map[true := true], "\n";
	print v123 == multiset{[4, 1]}, "\n";
	print v124 == map[['y'] := -1], "\n";
	print v125[0], "\n";
	print v125[1], "\n";
	print v125[2], "\n";
