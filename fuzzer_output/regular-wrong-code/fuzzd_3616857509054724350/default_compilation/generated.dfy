...
function fm9(p0: int, p1: bool, globalState: GlobalState): seq<D2> {
	(seq(0x36e, i0  => (DC3(false)))) + [DC3(!true)]
}
...
function fm12(p0: bool, globalState: GlobalState): multiset<seq<int>> {
	multiset{(seq(988, i0  => (|"qdliekdl"|))) + (seq(108, i1  => (|map[true := 'd']|)))}
}
...
function fm14(p0: int, p1: char, p2: int, globalState: GlobalState): map<bool, string> {
	if ({true, true, false} < {true}) then map[false := seq(0x27a, i0  => ('y'))] else map[true := "k"] + map[!!true := "kkbipqqh"]
}
function fm15(p0: char, p1: int, p2: bool, p3: int, globalState: GlobalState): map<string, int> {
	match DC6(multiset(seq(187, i0  => (|[0x13f, 0x65]|)))) {
		case DC6(cf14) => map[seq(0x13d, i1  => ('b')) := 665]
	}
}
function fm16(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState): seq<int> {
	if (0x1d7 <= -0x353) then [937, |"xuck"|] else [|[false]|, |map[-0x84 := |map['a' := true]|]|] + (seq(0xe5, i0  => (613)))
}
...
function fm20(p0: bool, globalState: GlobalState): set<int> {
	({0x103} + {-865, 0x2a5, |map[0x292 := !!false]|, 0x30a, 0x22d}) * (set v1 : int | v1 in (set v0 : int | (-0x2c <= v0) && (v0 < 0x1f2) :: (v0 / |map[true := 0x374]|)) :: (v1 / |"dtejhablw"|))
}
...
function fm24(globalState: GlobalState): set<bool> {
	{if (false) then true else !false, (seq(0xc6, i0  => ('m'))) < (seq(0x256, i1  => ('s'))), (set v0 : int | (123 <= v0) && (v0 < -43) :: (v0 - 0x2a3)) == {-0x2ca}}
}
method m0(p0: bool, p1: set<map<bool, int>>, p2: bool, globalState: GlobalState) returns (r0: int) {
	var v0 := "upn";
	var v1: C4 := new C4(v0);
	var v2: multiset<C4> := multiset{v1, v1};
	globalState.f5 := |v2| % 0x49;
	var v3: array<bool> := new bool[10](i0 => [222] == [-|map[p0 := p0]|]);
	v3[410] := v1.fm1(p2, p0, globalState);
	var v4: array<set<int>> := new set<int>[8](i1 => {122});
	var v5: set<int> := {-565};
	v4[72] := v5;
	var v6: array<int> := new int[14](i2 => i2 / 842);
	var v7 := -144;
	v6[237] := v7;
	var v8 := false;
	var v9: multiset<bool> := multiset{v8, p0, p2};
	var v10: multiset<seq<int>> := multiset{seq(107, i3  => (0x2c3))};
	var v11 := DC10(v10);
	var v12: array<C0> := new C0[18];
	var v13: seq<array<C0>> := [v12];
	var v14: map<D5, int> := map[v11 := |v13|];
	v3[410], globalState.f5, v4[72], v6[237], v8 := p2, (-v7 * v7) / v7, v5, (if (v8 in v9) then v9[v8] else |v14|) + v7, p2;
	if (v1.fm1(p2, v3[410] ==> v8, globalState)) {
		var v15: map<bool, bool> := map[if (p2) then p0 else v3[410] := v8];
		v15 := v15[p2 := p2];
		globalState.f5 := v6[237];
		v3[410] := v8;
		r0 := v6[237];
		globalState.f5 := v6[237];
	} else {
		var v16: set<bool> := {p0, v8, v3[410], v3[410]};
		var v17: map<bool, set<bool>> := map[v3[410] := v16];
		...
		v18[491] := v3;
		if (v3[410] <== v3[410]) {
			var v19: array<map<int, bool>> := new map<int, bool>[13](i4 => map[|map[v7 := v3[410]]| := p2]);
			var v20: map<int, bool> := map[v6[237] := p0];
			v19[726] := v20;
			v19[726] := (v20[v6[237] := p2])[v6[237] := !v3[410]] + v20;
			var v21 := 'r';
			var v22: C0 := new C0(v6[237], v21, p0, v3[410]);
			var v23: seq<C0> := [v22, v22, v22, v22];
			var v24: map<bool, bool> := map[v3[410] := p0];
			var v25: seq<bool> := [v3[410], v22 !in v23, if (p2 in v24) then v24[p2] else v22.fm5(v8, globalState)];
			v25 := v25;
			var v27 := DC11();
			var v28: multiset<D5> := multiset{v27};
			var v29: map<bool, multiset<D5>> := map[p0 := v28];
			globalState.f5, v3[410] := |((map v26 : int | v26 in (seq(946, i5  => (v22.f13)))[|"dy"| := v22.f13] :: (v26 * v7) := (multiset{DC11()}))[832 := if (v8 in v29) then v29[v8] else v28])[-(v22.f13 * -v7) := v28]|, v8;
			v8 := p0;
			var v30 := DC1(v1.f7[v7 := v21]);
		...
		decreases 100 - i7
	{
		...
		i7 := i7 + 1;
		v6[237] := fm0(if (p0) then p0 else p0, v1.f7, globalState);
		var v33 := 'r';
		var v34: map<seq<bool>, char> := map[fm23(p0, v8, v7, globalState) := v33];
		v6[237] := |v34| - v6[237];
		globalState.f5 := (v7 + v6[237]) % v6[237];
		var v35 := new C3();
	}
	var v36: seq<array<bool>> := [v3, v3];
	var v37 := 'e';
	var v38: seq<string> := [v1.f7, v0, v0, v1.f7[v7 := v37], v1.f7];
	var v39 := DC9(p0, v8);
	var v40: seq<array<bool>> := [v36[|fm16(|v38|, v3[410], v39.cf21, true, globalState)|], v3, v3];
	v40 := v40;
	r0 := v7;
}
trait T0 {
...
class C1 extends T1 {
	...
	method m4(p0: int, p1: string, p2: char, p3: bool, globalState: GlobalState) returns (r0: int, r1: bool, r2: bool, r3: bool) {
		...
		match (v3) {
			...
			case DC3(cf9) =>
				var v12: array<seq<int>> := new seq<int>[8](i0 => seq(0x38, i1  => (p0)));
				var v13: seq<int> := [392];
				v12[707] := v13;
				var v14 := "s";
				v12[707], v0.f9, v14, v14, cf9 := v13, cf9, v14, v14, f8;
			...
			case DC5(cf13) =>
				...
				var v19: map<string, string> := map[seq(0x2e4, i2  => (v0.f10)) := v18[p0]];
				var v20: array<int> := new int[21](i3 => i3 % |{!true, false}|);
				...
				var v32: set<int> := {p0};
				globalState.f5, v0.f9, r2, globalState.f5, v30 := 0x3ab - (-0x10d / |v2|), f9, !((if (p0 in v31) then v31[p0] else v32) == v32), |[v21, v21, v21]|, v30;
		}
		...
		r2 := (seq(0x96, i4  => (p1[p0]))) <= DC1(seq(197, i5  => (v0.f10))).cf5;
		r3 := f9;
	}
}
...
class C3 {
	...
	function fm4(globalState: GlobalState): D2 {
		DC4("mmapr" + "he", [false, false], --0x368 / 0x2e2)
	}
	method m2(p0: bool, p1: array<char>, p2: int, p3: multiset<array<bool>>, globalState: GlobalState) returns (r0: int, r1: char, r2: bool) {
		...
		var v5: array<array<bool>> := new array<bool>[8] [v3[p2], v2, v2, v2, v2, v2, v2, if (p0 in v4) then v4[p0] else v2];
		v5[280] := v2;
		var v6: array<int> := new int[25](i0 => i0 * 0x3c8);
		var v7: map<array<int>, bool> := map[v6 := !!p0];
		var v8: set<char> := {v0};
		var v9: map<int, bool> := map[-0x2cd := !p0];
		v5[280] := new bool[7] [if (p0) then p0 else p0, p0, p0, v6 !in v7, v8 >= {v0}, DC3(!p0).cf9 <==> p0, v9 == v9];
		for i1 := v1.f13 to v1.f13 {
			...
			v5[280][638] := i1 !in v13;
			v6[449] := (355 * p2) - i1;
		}
		var v14: map<array<bool>, char> := map[v3[p2] := v0];
		v14 := v14;
	...
	method m3(p0: int, p1: seq<D1>, p2: int, p3: bool, globalState: GlobalState) returns (r0: int, r1: int) {
		if (false) {
			...
			var v6 := 'q';
			var v7: seq<bool> := [p3];
			var v8 := new C1(fm12(p3, globalState) - v5, true, v6, if (false) then if (p0 in v3) then v3[p0] else !v7[p0] else !p3, v1.f12);
			...
			v12, r0 := !p3, |(if (v8.f12) then {v1.f12} else v14[0x2b1])|;
			...
			var v19: seq<bool> := [v16[609], p2 <= |v18|, v16[609]];
			globalState.f5 := |v19|;
			...
			globalState.f5 := (p2 % p0) + p0;
			var v26 := "cb";
			v16[609] := (seq(726, i1  => (v25))) < v26;
		}
			...
			decreases 100 - i2
		{
			...
			if ((p0 / |v28|) <= p0) {
				...
				v47 := v47[v48[|multiset(v37)|] := v27];
			}
			
			var v49: array<int> := new int[12](i3 => i3 + p2);
			var v50 := 'g';
			var v51: seq<string> := [v28, v28, "molvhg", v28[p0 := v50]];
			v49[988] := |v51|;
			...
			v49[988], globalState.f5, v53, v27 := p2 + p0, p2, v53 - v53, (if (p3) then v54 else (multiset{v27, v27})[v27 := p2]) !! v54;
			...
			var v59 := new C1(multiset(v58), !p3, v50, p3 || true, v55[v49[988]]);
		}
		var v60: array<char> := new char[18];
		var v61: array<bool> := new bool[21](i4 => v27);
		var v62: multiset<array<bool>> := multiset{v61, v61};
		var v63, v64, v65 := m2(!p3, v60, p0 % p0, v62, globalState);
		var v66: seq<bool> := [v65];
		for i5 := p0 to |v66| {
			var v67 := new C0(p0, v64, v65, v65);
			var v68: map<int, char> := map[p0 := v64];
			v68 := v68[i5 % 0x243 := v64];
			var v69: array<int> := new int[22];
			v69[692] := v63 - p2;
			v69[692] := v63;
			if (v27) {
				var v70 := "xp";
				var v71: map<int, string> := map[|v70| := (seq(-0xf0, i6  => (v64))) + v70];
				v71 := v71 + v71;
				var v72: set<bool> := {true, false};
				var v73: map<string, int> := map["xas" := |({v27} * v72)|];
				v73 := if (true) then map[v70 := v63] + v73[v70 := v67.f13] else fm15(v64, v67.f13, p3, fm0(v27, seq(0xab, i7  => (v64)), globalState), globalState);
				var v74: T0 := new C2(v63, v65, v27);
				var v75: set<T0> := {v74};
				var v76 := new C1(multiset{fm16(|multiset{true}|, v65, v27, p3, globalState), [v67.f13, v67.f13]}, p3, v64, v66[v69[692]], v75 >= {v74, v74});
				var v77: set<C0> := {v67};
				v27 := {v67} <= v77;
				var v78: multiset<bool> := multiset{!v74.f9};
				v78 := multiset{!v74.f8} * v78;
			} else {
				globalState.f5 := p0 / (if (p3) then v69[692] else -v69[692]);
				v61[37] := v65 ==> fm3(globalState);
				v61[37] := p3;
				var v79: seq<int> := [p2, v63];
				var v80: multiset<seq<int>> := multiset{v79};
				var v81 := "eopmhpt";
				var v82: multiset<string> := multiset{v81};
				var v83: map<int, int> := map[v69[692] := -0x99];
				...
				v86 := v86[fm19(v66, v61[37], globalState) := v69];
				v27 := !v67.fm5(v66 != v66, globalState);
			}
			
		}
		var v87: seq<int> := [p0, v63, fm0(v27, seq(0x3b6, i8  => (v64)), globalState), v63, |map[p3 := v63]|];
		var v88 := DC7(v87);
	...
	method m1(p0: int, p1: int, p2: int, p3: bool, globalState: GlobalState) {
		...
		for i0 := 0xc6 to -p2 {
			...
			if (p3) {
				...
				v8 := v3[-p2 % p0];
				v4[372] := true;
				v4[372] := if (p3) then v8 else p3;
				var v9: array<int> := new int[27];
				var v10: map<int, array<int>> := map[p0 := v9];
				var v11 := DC1(f7[p1 := f7[i0]]);
				var v12: multiset<bool> := multiset{v8};
				var v13: seq<int> := [p0];
				var v14: seq<seq<bool>> := [v3];
				var v15: seq<seq<bool>> := [v14[p2], v3];
				var v16: array<int> := new int[22] [p0 / |v10|, |f7|, p1 % i0, |(f7 + v11.cf5)|, p2, p1 + fm0(true, seq(-0x1d6, i2  => (v0)), globalState), i0, p1, -fm0(p3, f7, globalState), -(i0 + p0), p2, i0, 0x2ec, p0, p2, if (p3 in v12) then v12[p3] else |v13[|v2| := -|v12|]|, p2, i0, i0, |f7|, |v15|, fm0(!!v8, f7, globalState)];
				v16 := v9;
				var v17: array<string> := new string[22];
				v17[21] := f7;
				var v18: map<string, string> := map[f7 + f7 := f7];
				globalState.f5, v17[21], v3, v8, v18 := -p1, f7[i0 := f7[p2]], v3 + v3, v8, v18 + fm2(p2, v4[372], p3, globalState);
			} else {
				var v19 := true;
				v19 := !v19;
				...
				v4[508] := v19 in v21;
				var v22 := DC3(p3);
				v4[508] := (v22.(cf9 := true)).cf9;
				v4[508] := p2 >= (|[!fm1(v19, v19, globalState)]| + |f7|);
			}
			
			var v23: array<int> := new int[25];
			v23[908] := 873;
			v23[908] := -(if (p3) then p0 % |f7| else |map[map v24 : int | (0x18d <= v24) && (v24 < 0x354) :: (v24 - p1) := (v3[p1]) := p2]|);
			globalState.f5, v23[908], v23[908], v23[908] := -v23[908], v23[908], i0, p2;
		}
		...
		globalState.f5 := p1;
		if (false) {
			var v27 := new C0(p1 / p1, 'g', fm1(p3, p3, globalState) && p3, fm1(p3, p3, globalState));
			if (p3) {
				globalState.f5 := v27.f13 + |(seq(-130, i4  => (p1)))|;
				var v28 := true;
				v28 := v28;
				var v29 := "xmevn";
				v29 := ("njdcm")[p1 := fm13(p1, globalState)];
				var v30: multiset<char> := multiset{v0, v0};
				var v31: map<int, bool> := map[p1 := p3];
				var v32: set<map<int, bool>> := {map[p0 := true], v31};
				v27.f13 := (if (p3) then |v30| else |v32|) + (v27.f13 % -p0);
				var v33: array<array<int>> := new array<int>[13];
				var v34: map<array<array<int>>, bool> := map[v33 := v28];
				var v35: seq<bool> := [v28];
				var v36 := new C2(p2, true, if (v33 in v34) then v34[v33] else v35[p2]);
			} else {
				var v37: seq<int> := [v27.f13];
				v37 := [v27.f13, |[p3]| % v27.f13, p1];
				var v38 := true;
				v38 := v38;
				v38 := p3;
				...
				v39[553] := |(if (p3) then v40 else v40)| * fm0(p3, f7, globalState);
			...
			v44 := v44[v43 := v45 > v45];
			v0 := v0;
			var v46: array<int> := new int[4](i6 => i6 % |map[-v27.f13 := [p3]]|);
			v46[448] := p1;
			v46[448] := p0;
		} else {
			if (p2 != -p1) {
				...
				var v55: seq<int> := [p2];
				var v56: map<int, bool> := map[v55[p2] := p3];
				...
				v53 := v53[DC4(seq(0x347, i7  => (v0)), v54, |v58|).cf12 := if (p3) then v0 else v0];
				globalState.f5 := |f7| + (if (false) then fm0(p3, f7, globalState) else 0x2c7);
				var v59 := DC1("e");
				var v60: seq<string> := [f7];
				v59 := DC1(v60[p2]);
				globalState.f5 := (p0 % p1) % (|f7| - p0);
			}
...
method Main() {
	...
	var v6: array<int> := new int[11](i1 => i1 / v0);
	var v7 := true;
	...
	var v12 := DC0(v5[v4 := seq(-0x1a1, i0  => ('c'))], v6, if (v7) then v8 else v11, v9, v6);
	match (v12) {
		case DC0(cf0, cf1, cf2, cf3, cf4) =>
			...
			match (DC0(cf0, v6, map[false := |v15|], cf3, cf4)) {
				case DC0(cf0, cf1, cf2, cf3, cf4) =>
					cf1[597] := v14;
					cf1[597] := (|(seq(0x2af, i3  => ("nvgx")))| - fm0(v7, seq(-0x8b, i4  => ('l')), globalState)) * v0;
					cf1[597] := cf1[597];
	...
	if (v7) {
		...
		var v32: T1 := new C1(v25.f11, v7, v22, v31[v0], v7);
		var v33: seq<T1> := [v32];
		...
		v4, v32.f9, v4, v41, v42 := v4, v25.f12, fm21(if (v25.f12) then v21 else -0x1, v4 + v4, seq(0x6d, i5  => ('v')), v41.f14, globalState), if (true) then v41 else v41, v42;
	} else {
		...
		var v51: map<bool, seq<bool>> := map[v7 := (v50 + v50)[v0 := v48.f12]];
		v51 := v51;
		v7 := false;
	...
	v7, v54, v7 := v7, (v54 + v55[v53.f14]) + v54, v7;
	var v56: multiset<seq<int>> := multiset{v1};
	var v57: T1 := new C1(v56, v7, v52, v7, v7);
	var v58: seq<T1> := [v57, v57, v57, v57, v57];
	var v59: array<T1> := new T1[10] [if (v7) then v57 else v57, v57, v57, if (v7) then v57 else v57, v57, v58[|v4|], v57, v57, v57, v57];
	v59[979] := v57;
	v59[979] := v57;
	...
	if ((|v60| != v0) || (v61 !! v61)) {
		v6[927] := -(v0 % v53.f14);
		v6[927] := v53.f14 % (v0 + 0x47);
		var v62: array<int> := new int[26];
		v62 := v62;
		v7 := v7;
		globalState.f5 := DC2(-|map[v62 := v57.f9]|, v6[927], v57.f10).cf7;
		var v63: seq<bool> := [v7];
		if (v63[0x50]) {
			v4 := v4;
			v7 := v63[v6[927]];
			...
			v66 := v66[(seq(0x246, i6  => (v52)))[v53.f14 := v57.f10] + (seq(996, i7  => (v57.f10))) := |(seq(983, i8  => (v57.f10)))| * v53.f14];
			v3[999] := !v57.f8;
			var v67: set<bool> := {v57.f8, v65.f12};
			v3[999] := v57.fm7(|v63| > v53.f14, v67, v4, globalState);
		} else {
			...
			globalState.f5 := if (--(if (|v71| in v60) then v60[|v71|] else v53.f14) in v60) then v60[--(if (|v71| in v60) then v60[|v71|] else v53.f14)] else v69 % v6[927];
			v57.f10 := v4[v69];
		...
		v6[298] := v53.f14;
		v6[298] := v57.fm6(v57.f9, globalState);
		v3[680] := v7;
		var v72 := DC9(v57.f8, v57.f9);
		v3[680] := !(false && v72.cf21);
		var v73: seq<bool> := [fm22(v53.f14, v3[680], v57.f9, v7, globalState)];
		if (v60 !! multiset{|v73|, v53.f14}) {
			var v74: map<int, int> := map[v53.f14 := |(map[v57.fm6(v57.f8, globalState) := v53.f14])[v6[298] := v53.f14]|];
			v57.f9 := (v53.f14 / |v74|) < (v53.f14 + v53.f14);
			var v75: C1 := new C1(v56 - v56, v57.f8, v57.f10, v57.f8, v53.fm5(v57.f8, globalState));
			var v76 := DC8(v6[298], v57.f8, v53.f14, v75);
			v75 := new C1(v75.f11, v7, v52, (v76.(cf17 := v57.f9, cf16 := v6[298])).cf17, v57.f8);
			v60 := v60;
			var v77: set<bool> := {v75.f12, v57.f9, v57.f8, v57.f9, !v57.f9};
			var v78: array<bool> := new bool[24](i9 => v3[680]);
			var v79: map<string, int> := map[v4 := v6[298]];
			v6[298], v77, v78, v0, globalState.f5 := v53.f14 + |v60|, {v4 == [v57.f10, 'h'], !v3[680], false ==> v57.f9}, v78, |v4|, if (("sgw" + v4) in v79) then v79["sgw" + v4] else v53.f14;
			v0 := |v61| / 0x3b;
		} else {
			var v80 := DC4(v4, v73, v0);
			var v81: map<int, bool> := map[|v4| := v57.f8];
			var v82: C1 := new C1(DC10(v56).cf22, true, v4[|v56|], v7, v7);
			var v83 := DC8(v53.fm18(v57.f8, v6[298], v53.fm18(v57.f9, |v73|, v53.f14, v53.f14, globalState), v53.f14, globalState), v57.f8, |v81|, v82);
			var v84: array<seq<bool>> := new seq<bool>[27] [fm23(!v57.f9, v57.f9, |v73|, globalState), v73, v73, v73, [v3[680]], v73, v73 + v73, v73, v73, fm23(!v57.f8, !v7, |"yowvpprj"|, globalState), v80.cf11, v73 + v73[v0 := v7], v73, if (v83.cf17) then v73 else v73, v73, v73, (v73 + [false, v7])[v53.f14 := v7], v73, v73 + v73, v73, [v57.f8, true], v73 + v73, v73 + v73[v6[298] := v3[680]], v73, v73 + v73, v73 + [v82.f12], [v57.f8, v82.f12, v82.f12, !v82.f12, v57.f9]];
			v84[2] := fm23(v57.f8, v57.f8, |{v57.f10, 'm'}|, globalState);
			v84[2] := v73;
			v3[680] := v0 >= v53.f14;
			var v85: map<bool, seq<bool>> := map[!v7 := [v57.f8]];
			globalState.f5 := |(v85 + v85)|;
			var v86: map<int, map<bool, int>> := map[v53.f14 := v11];
			var v87: seq<map<bool, int>> := [(if (566 in v86) then v86[566] else v11)[v57.f8 := v6[298]], v8, v11];
			var v88: set<bool> := {true, v57.f8};
			var v89: map<bool, map<bool, int>> := map[v7 := v8];
			var v90: set<map<bool, int>> := {v87[|v88|], v11, if (v57.f9 in v89) then v89[v57.f9] else v11};
			var v91: seq<seq<int>> := [v1, v1];
			var v92: set<C2> := {v53, v53};
			var v93: map<int, set<C2>> := map[v1[v53.fm17(v57.f9, false, v91, |v4|, globalState)] := v92];
			var v94 := m0(v57.f8, v90, {v53} > (if (v53.f14 in v93) then v93[v53.f14] else v92), globalState);
			var v95: C0 := new C0(285, 'y', v3[680], v57.f8);
			var v96: seq<C0> := [v95];
		...
		var v99 := new C0(|v98| * v57.fm6(v3[680], globalState), v52, if (!v57.f9) then v3[680] else v7, v7);
		v0 := v99.f13;
	}
	
	v7 := !v7;
	var v100: map<string, bool> := map[seq(956, i10  => (v57.f10)) := v57.f9];
	var v101: C0 := new C0(v53.f14, v52, fm22(v53.f14, v57.f9, v57.f8, v57.f9, globalState), false);
	var v102: map<int, C0> := map[v0 := v101];
	v100 := v100[("v")[|multiset{v101, v101, if (v101.f13 in v102) then v102[v101.f13] else v101, v101}| := v52] := v57.f9];
	var v103: seq<bool> := [v57.f9 <==> v57.f9, v57.f8];
	v7 := v103[v101.f13 * v101.f13];
