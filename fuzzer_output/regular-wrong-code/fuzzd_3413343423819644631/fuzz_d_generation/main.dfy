...
class C1 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
		...
		for i0 := v1 to if (v1 in v5) then v5[v1] else |(seq(abs(0x25e), i1  => (f18)))| {
			var v6 := new C0();
		...
		v13[safeIndex(224, v13.Length)] := v5;
		var v14: array<bool> := new bool[3](i4 => if (v2) then v2 else v2);
		v14[safeIndex(216, v14.Length)] := fm1(fm1(v2, v1, globalState), v1, globalState);
		var v15 := "eeqfoa";
		var v16: map<bool, bool> := map[v1 > v1 := v2 ==> !fm1(false, v1, globalState)];
		var v17: multiset<string> := multiset{"swagwqdi"};
		var v18 := DC3(v9);
		v12, v13[safeIndex(224, v13.Length)], v14[safeIndex(216, v14.Length)], v1, v15 := v12, v5 + v5, if (v2 in v16) then v16[v2] else v2, safeDivisionInt(v1, |v17|), match v18 {
			case DC4(cf8) => v15 + "yuqea"
			case DC3(cf7) => v15 + v15
		};
		var v19: seq<int> := [v1];
		v19 := [v1 - v1, -v1 - |f2|, safeModuloInt(v1, v1)];
		var v20: multiset<bool> := multiset{v2, v14[safeIndex(216, v14.Length)], v14[safeIndex(216, v14.Length)]};
		var i5 := 0;
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			v14[safeIndex(216, v14.Length)] := v14[safeIndex(216, v14.Length)];
			var v21: map<set<bool>, D1> := map[f2 := v18];
			var v22 := DC16(v21);
			var v23: map<D5, string> := map[v22 := v15];
			var v24, v25 := m28(v15, v14[safeIndex(216, v14.Length)], v23, v14[safeIndex(216, v14.Length)], globalState);
			var v26 := new C0();
			var v27 := new C0();
		}
	...
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
		...
		for i0 := 0x15 * v0 to 0x230 {
			...
			var v5: array<bool> := new bool[27] [v1, true, true, v1, false, v1, v1, v1, v1, v1, v2[safeIndex(v0, |v2|)], false, v1, v1, v1, v1, v1, v1, !v1, v1, true, v2[safeIndex(if (v3 in v4) then v4[v3] else i0, |v2|)], v1, v1, v1, v1, v1];
			...
			var v12: map<int, set<int>> := map[safeModuloInt(i0, i0) := if (!v1) then if (i0 in v11) then v11[i0] else v10 else v10];
			v11 := (map[v0 := v10] + fm46(i0, globalState)) + v11;
			if (-i0 >= i0) {
				v5[safeIndex(407, v5.Length)] := v1;
				v5[safeIndex(407, v5.Length)] := v1;
				v5[safeIndex(407, v5.Length)] := v1;
				v5[safeIndex(407, v5.Length)] := true;
				var v13: map<int, bool> := map[v0 * v0 := v5[safeIndex(407, v5.Length)]];
				v13 := v13[safeDivisionInt(i0, v0) := v5[safeIndex(407, v5.Length)]];
				v1 := |(seq(abs(833), i1  => ('f')))| > 475;
			} else {
				var v14 := 'q';
				v14 := v14;
				v1 := v1;
				...
				v5[safeIndex(935, v5.Length)] := |v15| > (if (false in v16) then v16[false] else |fm0(v1, |fm47(globalState)|, v1, globalState)|);
				v5[safeIndex(935, v5.Length)] := !v2[safeIndex(i0, |v2|)];
				var v17: array<char> := new char[23](i2 => f18);
				v17[safeIndex(35, v17.Length)] := f18;
				v17[safeIndex(35, v17.Length)] := f18;
				v1 := v1;
			}
			...
			match (v20) {
				case DC33(cf57, cf58, cf59, cf60, cf61) =>
					var v21: map<int, bool> := map[safeModuloInt(|[cf58]|, 0x17) := cf59];
					v21 := v21[0x17c := cf57];
					var v22: map<bool, int> := map[true := 0x1d1];
					v9 := v9[cf60 := |v22| * |v21|];
					v18[safeIndex(89, v18.Length)] := v8;
					v18[safeIndex(89, v18.Length)] := v8;
				...
				case DC34() =>
					...
					v5[safeIndex(315, v5.Length)] := !v1;
					v5[safeIndex(315, v5.Length)] := v1;
					var v25: map<bool, int> := map[v5[safeIndex(315, v5.Length)] := i0];
					var v26: multiset<char> := multiset{f18};
					v5[safeIndex(315, v5.Length)] := (v25[v5[safeIndex(315, v5.Length)] := if (f18 in v26) then v26[f18] else v0] != v25) || !v1;
					var v27 := DC13();
					v27 := v27;
				case DC32(cf56) =>
					var v28 := new C0();
					...
					v31 := v31[safeModuloInt(fm3(v1, globalState), i0) := v30];
					v1 := v1;
				...
				case DC35(cf62) =>
					...
					var v40 := DC36(v38);
					v37, v38 := v39[safeIndex(i0, |v39|)], v40.cf63;
					v0 := i0;
					v18[safeIndex(672, v18.Length)] := v8;
					v18[safeIndex(672, v18.Length)] := v8;
					v0 := v0;
			}
		...
		v49[safeIndex(482, v49.Length)] := v0;
		v49[safeIndex(482, v49.Length)] := if (v44 < v44) then v0 else v0;
		var v50: map<int, bool> := map[v49[safeIndex(482, v49.Length)] := v41];
		var v51: seq<int> := [|v50|];
		if ((v49[safeIndex(482, v49.Length)] - v0) == -v51[safeIndex(v49[safeIndex(482, v49.Length)], |v51|)]) {
			var v52 := "jvhanmwjp";
			var v53: map<int, string> := map[v49[safeIndex(482, v49.Length)] := seq(abs(0x2ea), i5  => (f18))];
			v52 := if (v0 in v53) then v53[v0] else v52;
			var v54: map<bool, int> := map[v41 := v0];
			var v55: seq<multiset<int>> := [v44[v49[safeIndex(482, v49.Length)] := abs(v0)]];
			v49[safeIndex(482, v49.Length)] := if ((-|v55| <= |v52|) in v54) then v54[-|v55| <= |v52|] else v49[safeIndex(482, v49.Length)] * -v0;
			v0 := fm3(v41, globalState);
			var v56: array<char> := new char[17];
			v56[safeIndex(227, v56.Length)] := v42;
			v56[safeIndex(227, v56.Length)] := f18;
			var v57: array<bool> := new bool[17];
			v41, v49[safeIndex(482, v49.Length)], v57, v41 := v41, v0, v57, !v41;
		} else {
			v50 := v50[v0 := v41];
			var v58 := DC26({v0, v0, v0});
			v58 := v58;
			var v60: map<char, set<int>> := map[v42 := {v0, 981}];
			var v61: map<char, int> := map[f18 := v49[safeIndex(482, v49.Length)]];
	...
	method m28(p0: string, p1: bool, p2: map<D5, string>, p3: bool, globalState: GlobalState) returns (r0: string, r1: bool) {
		if (p1) {
			...
			v5[safeIndex(943, v5.Length)] := if (p1) then f2 else f2;
			v5[safeIndex(943, v5.Length)] := f2;
			v4 := -v4;
			r1 := !p3;
		}
		...
		for i1 := v8 to v8 {
			...
			v9[safeIndex(176, v9.Length)] := i1 > v8;
			var v10: multiset<int> := multiset{i1};
			v9[safeIndex(176, v9.Length)] := |v10| == |(seq(abs(841), i2  => (f18)))|;
		}
		var v11: set<bool> := {p1, p1};
		r0, v11, r1 := seq(abs(194), i3  => (f18)), f2, fm1(p3, v8 - v8, globalState);
		var v12, v13, v14 := m0(globalState);
		r1, v12 := v12 == -(-0x29e * v12), |(v11 - v11)|;
		r0 := seq(abs(314), i4  => (if (p3) then f18 else f18));
		r1 := p3;
	}
}
...
class C2 {
	...
	function fm41(p0: int, p1: int, p2: bool, p3: bool, globalState: GlobalState): int {
		safeDivisionInt(0x343 * |[0x9d]|, -safeModuloInt(|map[|(seq(abs(-0x262), i0  => ('q')))| := !f17]|, |"u"|))
	}
	method m26(globalState: GlobalState) returns (r0: int, r1: D9) {
		...
		v0, v1, r0 := fm42(globalState), !v3[safeIndex(-|v4|, |v3|)], safeModuloInt(v2, v2);
		if (v1) {
			var v5 := DC24(v2, 0x20f, v3);
			v2 := v5.cf42;
			var v6 := 'g';
			var v7: array<char> := new char[1] [v6];
			v7[safeIndex(590, v7.Length)] := v6;
			var v8: array<bool> := new bool[7];
			var v9: seq<array<bool>> := [v8, v8, v8];
			v7[safeIndex(590, v7.Length)], v1, v8 := v6, f17, v9[safeIndex(v2 * v2, |v9|)];
			...
			var v13: seq<int> := [v2];
			v2, r0 := safeModuloInt(v2, |v12| + v2), v13[safeIndex(v2, |v13|)];
			if (v1 && f17) {
				v8[safeIndex(106, v8.Length)] := v1;
				v8[safeIndex(106, v8.Length)] := |(if (f17) then v0 else fm42(globalState))| <= v2;
				v8[safeIndex(106, v8.Length)] := v8[safeIndex(106, v8.Length)];
				var v14: multiset<bool> := multiset{!v8[safeIndex(106, v8.Length)], if (v8[safeIndex(106, v8.Length)]) then v8[safeIndex(106, v8.Length)] else v8[safeIndex(106, v8.Length)], v2 < v2, v2 >= 988};
				v14 := (v14 + multiset([f17, v8[safeIndex(106, v8.Length)]])) * v14;
				v2 := v2;
				var v15: array<seq<bool>> := new seq<bool>[3] [v3[safeIndex(v2, |v3|) := v8[safeIndex(106, v8.Length)]], [f17, v1, f17, v1, v1], v3];
				v15 := v15;
			} else {
				v7[safeIndex(590, v7.Length)] := v6;
			...
			if (f17) {
				...
				v1 := (v18 <= v18) <==> f17;
				r0 := v2;
				var v19 := DC3(v7[safeIndex(590, v7.Length)]);
				...
				v23 := [v22, v22, v22] + v24[safeIndex(fm3(f17, globalState), |v24|)];
				v9 := v9 + v9;
			} else {
				r0 := v2;
				r0 := v2;
				...
				var v28: map<int, map<int, bool>> := map[|(v13 + v13)| := v27[safeIndex(-845, |v27|)]];
				v7[safeIndex(590, v7.Length)], v6, v1, v28 := fm43(globalState), v7[safeIndex(590, v7.Length)], f17, v28;
			}
			...
			if (!!f17) {
				...
				var v32: map<bool, seq<int>> := map[v1 := seq(abs(954), i0  => (v2))];
				...
				v42[safeIndex(3, v42.Length)] := |v3|;
				v42[safeIndex(3, v42.Length)] := v2 * |(map v43 : int | (-0x1d1 <= v43) && (v43 < 0x23a) :: (v43 * v2) := (f17))|;
				...
				var v45, v46, v47, v48 := m27(v42[safeIndex(3, v42.Length)] * v2, v44, f17, globalState);
				var v49: seq<seq<bool>> := [v3, v3];
				v42[safeIndex(3, v42.Length)], v3 := v45 - |v0|, (v3 + v3) + (v3 + v49[safeIndex(v45, |v49|)]);
				...
				v56[safeIndex(975, v56.Length)] := v44;
				v44, v2, v55, v45, v56[safeIndex(975, v56.Length)] := v48.cf1, v42[safeIndex(3, v42.Length)], v55, v2, v44;
				var v58 := 'f';
				var v59: map<int, char> := map[v42[safeIndex(3, v42.Length)] := v58];
				var v62: array<map<int, bool>> := new map<int, bool>[15] [fm44(globalState) + map[|v3| := f17], v51, v51, (map v57 : int | v57 in v59 :: (v57 + |"xxxads"|) := (f17)) + v51, v51, v51, v51[v42[safeIndex(3, v42.Length)] := v1], map v60 : int | v60 in v51[|multiset{f17}| := fm1(!f17, v42[safeIndex(3, v42.Length)], globalState)] :: (v60 - |v0|) := (f17), map[v45 := v1], v51, v51, fm44(globalState) + v51, v51, v51 + v51, map v61 : int | (0x26b <= v61) && (v61 < 0xb3) :: (v61 - v42[safeIndex(3, v42.Length)]) := (false)];
				v62[safeIndex(675, v62.Length)] := v51;
				v62[safeIndex(675, v62.Length)], v42[safeIndex(3, v42.Length)] := map[|([f17] + v49[safeIndex(v2, |v49|)])| := true], v45 * v42[safeIndex(3, v42.Length)];
			}
			...
			var v69 := 's';
			var v70: map<char, int> := map[v69 := safeModuloInt(v2, v2)];
			var v71: seq<int> := [19, v2];
			var v72 := DC30(v66);
			v70 := v70[v69 := v71[safeIndex(DC21(f17, v4, v1, |map[v1 := f17]|).cf35, |v71|)] - |v72.cf50|];
		}
		...
		match (v74) {
			case DC29(cf49) =>
				...
				var v79 := DC32(v77);
				var v80: multiset<array<string>> := multiset{if (fm1(v1, v2, globalState)) then v78[safeIndex(v2, |v78|)] else v79.cf56, v77, v77};
				...
				var v81: multiset<string> := multiset{seq(abs(0xf4), i2  => (v0[safeIndex(|v0|, |v0|)]))};
				var v82 := DC23(v81 + v81);
				match (v82) {
					case DC24(cf41, cf42, cf43) =>
						var v83: multiset<array<bool>> := multiset{v75};
						v75[safeIndex(719, v75.Length)] := v1;
						v83, v75[safeIndex(719, v75.Length)], cf41 := v83, f17, cf41;
						v3 := v3;
						var v84 := new C0();
						v75[safeIndex(719, v75.Length)] := true;
					case DC23(cf40) =>
						v1 := ((seq(abs(-0x1e5), i3  => ('o'))) <= "gfkd") <==> v1;
						v2 := |v4|;
						v1 := f17;
					...
					case DC25(cf44) =>
						v75[safeIndex(792, v75.Length)] := v1;
						...
						v75[safeIndex(792, v75.Length)] := v87 in (set v91 : set<bool> | v91 in v90 :: (v91));
						...
						var v101: multiset<bool> := multiset{false, v75[safeIndex(792, v75.Length)], f17, f17, f17};
						var v102: multiset<int> := multiset{if (v3 in v95) then v95[v3] else |v98|, |v100|, |v101|};
						v75[safeIndex(792, v75.Length)], v75[safeIndex(792, v75.Length)], v94, r0 := (v102 > fm45(globalState)) in v4, !(v102 > v102), {(([v92])[safeIndex(v2, |[v92]|) := v92])[safeIndex(0x32b, |([v92])[safeIndex(v2, |[v92]|) := v92]|) := v93[safeIndex(0x393, |v93|)]]}, v2 * -v2;
						var v103 := new C0();
						var v104 := new C0();
				}
				
				var v105: array<int> := new int[10];
				v105[safeIndex(876, v105.Length)] := v2;
				v105[safeIndex(876, v105.Length)] := v2;
		}
		
		var v107: set<int> := {|v0|};
		var i4 := 0;
		while (!((set v106 : int | (0x264 <= v106) && (v106 < 0x3bb) :: (safeModuloInt(v106, |{{v1}}|))) !! v107))
			decreases 100 - i4
		{
			if (i4 >= 100) {
				break;
			...
			if (f17) {
				...
				v110[safeIndex(560, v110.Length)] := true || f17;
				var v111: array<int> := new int[25](i5 => i5 * -520);
				v110[safeIndex(560, v110.Length)], v3, v0, v111, v3 := f17, [f17] + v3, fm42(globalState) + v0, if (v1) then v111 else v111, [f17, v1];
				var v112 := 'p';
				var v113 := DC6(f17, v1, v112, v2, v1);
				v112, r0, v2 := v113.cf12, v2, v2;
				v110[safeIndex(560, v110.Length)] := v1;
				var v114: multiset<seq<int>> := multiset{v73};
				v110[safeIndex(560, v110.Length)], r0, v110[safeIndex(560, v110.Length)] := f17, v2, v114 !! (v114[v73 := abs(fm3(v1, globalState))] * v114);
				v1 := !v110[safeIndex(560, v110.Length)];
			} else {
				v1 := (v108 + v108) > (v108 * v108);
				var v115: array<bool> := new bool[5] [v1, f17, f17, v0 == (seq(abs(-0x337), i6  => ('b'))), v1];
				v115[safeIndex(889, v115.Length)] := true;
				v115[safeIndex(889, v115.Length)], v2 := f17, 0x30c;
				var v116 := 'j';
				var v117: map<bool, char> := map[v115[safeIndex(889, v115.Length)] := v116];
				v117 := v117[v115[safeIndex(889, v115.Length)] := 'c'];
				v115[safeIndex(889, v115.Length)] := v3[safeIndex(v2 - 0x3f, |v3|)];
				v1 := v115[safeIndex(889, v115.Length)];
			}
			
			var v118: array<int> := new int[8](i7 => i7 * v2);
			v118[safeIndex(274, v118.Length)] := v2;
			var v119: map<int, int> := map[170 := fm3(v1, globalState)];
			v2, v1, v118, v118[safeIndex(274, v118.Length)], v1 := if (|map[f17 := v73[safeIndex(v2, |v73|)]]| in v119) then v119[|map[f17 := v73[safeIndex(v2, |v73|)]]|] else v2, f17, v118, safeModuloInt(776, v2) * v2, ((set v120 : int | (0x258 <= v120) && (v120 < -785) :: (safeDivisionInt(v120, v2))) - v107) !! v107;
			if (v107 <= v107) {
				var v121: map<int, bool> := map[|v109[safeIndex(v2, |v109|)]| := v1 || f17];
				v121 := v121;
				var v122: map<bool, seq<int>> := map[fm1(v1, v118[safeIndex(274, v118.Length)], globalState) := v73 + v74.cf49];
				v73 := if (f17 in v122) then v122[f17] else v73 + v73;
				var v123: array<bool> := new bool[28](i8 => v1);
				var v124 := 'd';
				var v125: map<bool, char> := map[v1 := v124];
				var v126 := DC1(v123, v118[safeIndex(274, v118.Length)], v1, v125, false);
				var v127, v128, v129, v130 := m27(|v107|, v126.cf1, v1, globalState);
				v118[safeIndex(274, v118.Length)] := v127;
				v118[safeIndex(274, v118.Length)] := safeModuloInt(v127, |[f17, f17, v1, v1]|);
			} else {
				var v131: multiset<int> := multiset{-fm3(v1, globalState)};
				v131 := multiset(v73 + (seq(abs(-0x1aa), i9  => (|v0|)))) + multiset(v73);
				...
				var v136 := DC37(f17, [v1, f17], v0, v118[safeIndex(274, v118.Length)]);
				v1 := if (!v1) then v1 else if (v136.cf64) then f17 else v1;
				var v137 := DC33(f17, v118[safeIndex(274, v118.Length)], !v1, v118[safeIndex(274, v118.Length)], v118[safeIndex(274, v118.Length)]);
				v1 := v137.cf59;
				r0 := v2;
			}
		...
		for i10 := |(v138 + v138)| to -v2 {
			...
			match (if ("clyjaxdyl" < v0) then v139 else v139.(cf8 := v1)) {
				...
				case DC3(cf7) =>
					...
					v143 := v143.(cf30 := f17, cf29 := v0[safeIndex(v144.cf58, |v0|)]);
			...
			if ((v149 + v149) >= multiset(v150)) {
				...
				var v156: array<bool> := new bool[20] [f17, v155 !! v155, f17, fm1(f17, 476, globalState), true, v146 != |v107|, v1, f17, v107 >= v107, f17, f17, v1, (v148.(cf55 := -0x1b0)).cf52, f17, f17, if (false) then false else f17, f17, v3[safeIndex(i10, |v3|)], v1 <==> v1, f17];
				v154[safeIndex(129, v154.Length)] := v1;
				v154[safeIndex(129, v154.Length)] := !v1;
				v1 := (seq(abs(0x116), i12  => (v2))) < v73;
				var v157 := new C1(v153.f18, v152 * {v154[safeIndex(129, v154.Length)], f17, v1});
			} else {
				var v158: array<bool> := new bool[7](i13 => v2 >= v145);
				v158[safeIndex(343, v158.Length)] := f17;
				var v159 := DC13();
				...
				r0, v158[safeIndex(343, v158.Length)], r0 := |(map[v159 := v161] + v163[safeIndex(v145, |v163|)])|, v107 >= v107, i10;
				var v164: set<bool> := {v1};
				var v165: array<int> := new int[1](i14 => safeModuloInt(i14, v145));
				var v166: seq<seq<int>> := [v73];
				var v167 := DC22(v165, |v166|, v1, i10);
				var v168: map<int, string> := map[fm41(v2, |v107|, v158[safeIndex(343, v158.Length)], v1, globalState) := v0];
				var v169 := DC9(v168);
				var v170: multiset<D3> := multiset{v169};
				var v171: set<multiset<D3>> := {v170, v170};
				v158 := new bool[10] [true, f17, v158[safeIndex(343, v158.Length)], v158[safeIndex(343, v158.Length)], v164 <= v164, fm3(f17, globalState) < v146, if (f17) then f17 else v158[safeIndex(343, v158.Length)], v158[safeIndex(343, v158.Length)], v167.cf38, if (|v171| in v138) then v138[|v171|] else v158[safeIndex(343, v158.Length)]];
				var v172 := DC0(v146);
				v172 := v172;
				v1 := v1;
				v0 := v0 + v0;
		...
		match (v174) {
			case DC20(cf29, cf30, cf31) =>
				...
				v175[safeIndex(440, v175.Length)] := f17;
				v175[safeIndex(440, v175.Length)] := if (!(v2 < v2)) then !!v1 else v1;
				...
				if (if (v175[safeIndex(440, v175.Length)] in v4) then v4[v175[safeIndex(440, v175.Length)]] else if (f17) then !v175[safeIndex(440, v175.Length)] else cf30) {
					...
					v188[safeIndex(73, v188.Length)] := v0;
					var v189: seq<string> := [DC37(!v1, v3, v0, v2).cf66, "aowt"];
					v175[safeIndex(440, v175.Length)], r0, v188[safeIndex(73, v188.Length)], v2, v2 := v175[safeIndex(440, v175.Length)], fm3(cf30, globalState), (fm47(globalState) + v0) + v189[safeIndex(v2, |v189|)], v2, -(|v3| - v2) + 0x26f;
					var v190: map<bool, int> := map[true := v2];
					v175[safeIndex(440, v175.Length)] := fm1(v175[safeIndex(440, v175.Length)], if (f17 in v190) then v190[f17] else v2, globalState);
					v175[safeIndex(440, v175.Length)] := f17;
					v188[safeIndex(73, v188.Length)] := v0 + (seq(abs(0x159), i15  => (cf29)));
				} else {
					cf30 := f17;
					var v191: array<int> := new int[25];
					v191[safeIndex(575, v191.Length)] := v2;
					var v192: multiset<bool> := multiset{v175[safeIndex(440, v175.Length)]};
					v1, v1, v191[safeIndex(575, v191.Length)] := v175[safeIndex(440, v175.Length)], v192 < multiset(v3 + v3), v2;
					var v193: multiset<array<int>> := multiset{v191};
					v175[safeIndex(440, v175.Length)], v193, cf30 := f17, v193, cf30;
					cf29 := cf29;
					var v194: C0 := new C0();
					var v195: seq<C0> := [v194];
					var v196: multiset<int> := multiset{v2};
					var v197: seq<C0> := [v195[safeIndex(|v196|, |v195|)], v194, v194, if (f17) then v194 else v194];
					var v198: set<seq<bool>> := {v3};
					v2, r0, cf30, v197 := |v198|, v191[safeIndex(575, v191.Length)], cf30, v195;
				}
			...
			case DC19(cf28) =>
				...
				match (v205) {
					case DC10() =>
						...
						var v212: map<bool, char> := map[f17 := v0[safeIndex(0x201, |v0|)]];
						var v213 := DC1(v211, v2, v1, v212, f17);
						var v214 := 'a';
						var v215: map<int, char> := map[-0x34c := v214];
						var v216: array<int> := new int[23] [v2, -v2, v2 * v2, v2 * v2, v2, |v208[v0 := v2]| + v2, |v209|, |((map[v1 := v1])[fm1(v1, v2, globalState) := !v1] + map[v1 := v1])|, v2, |(v107 - v107)|, 0x277, |v210| - v2, v2, safeDivisionInt(v2, fm41(v2, v2, v1, f17, globalState)), v2, fm3(false, globalState), --v2 * v2, v2, -safeDivisionInt(v2, v2), v2, v213.cf2, safeDivisionInt(|v215|, -0x3b4), v2];
						v216[safeIndex(823, v216.Length)] := v2;
						...
						var v221 := DC40(v220[safeIndex(v2, |v220|)]);
						v216[safeIndex(823, v216.Length)], r0, v2, v217 := |(fm47(globalState) + v0)|, v73[safeIndex(|v219[safeIndex(-fm3(v1, globalState), |v219|)]|, |v73|)], -v2, v217 + v221.cf70;
						var v222: map<string, bool> := map[v0 := f17];
						v73 := (v73 + v73)[safeIndex(v216[safeIndex(823, v216.Length)], |(v73 + v73)|) := fm3(if (v0 in v222) then v222[v0] else v1, globalState)] + v73;
						var v223: map<int, int> := map[v73[safeIndex(-378, |v73|)] := |v0|];
						v223 := v223[v216[safeIndex(823, v216.Length)] := |v0|];
					case DC9(cf18) =>
						var v224: set<bool> := {v1};
						var v225: set<set<bool>> := {v224, v224 + v224};
						var v226: multiset<bool> := multiset{v1};
						v225, v1, r0, r0 := ({v224, v224} + fm53(v3, |v226|, 0x1dc, f17, globalState)) + v225, f17, safeModuloInt(v2, if (f17 in v226) then v226[f17] else fm3(!true, globalState)), v2;
						var v227: array<bool> := new bool[13];
						var v228: seq<array<bool>> := [if (f17) then v227 else v227];
						v228 := v228;
						v2 := v2 + |(v138 + v138)|;
						var v229: array<int> := new int[3] [-v2, v2, v2];
						v229[safeIndex(719, v229.Length)] := 0x35;
						var v230: seq<seq<int>> := [v73];
						v229[safeIndex(719, v229.Length)] := v2 - |v230[safeIndex(|v224|, |v230|)]|;
					case DC11(cf19) =>
						v1 := v1;
						v0 := seq(abs(-0x35d), i16  => ('y'));
						...
						v236[safeIndex(383, v236.Length)] := v0;
						v236[safeIndex(383, v236.Length)] := v0 + v0;
				}
	...
	method m27(p0: int, p1: array<bool>, p2: bool, globalState: GlobalState) returns (r0: int, r1: map<bool, bool>, r2: D8, r3: D0) {
		...
		var v8 := DC22(v6, p0, f17, v5[safeIndex(|v7|, |v5|)]);
		...
		p1[safeIndex(455, p1.Length)] := f17;
		p1[safeIndex(455, p1.Length)] := f17;
		r0 := -p0;
		for i0 := p0 to p0 {
			...
			if (f17) {
				...
				v11[safeIndex(713, v11.Length)] := p1;
				v11[safeIndex(713, v11.Length)] := p1;
				p1[safeIndex(455, p1.Length)] := p1[safeIndex(455, p1.Length)];
				r0 := i0;
				p1[safeIndex(455, p1.Length)] := fm1(p1[safeIndex(455, p1.Length)], p0 + i0, globalState);
				var v12: multiset<bool> := multiset{p1[safeIndex(455, p1.Length)], !p2};
				var v13 := DC27(v12, -i0);
				...
				var v16: multiset<bool> := multiset{p2, f17, p2, p1[safeIndex(455, p1.Length)], p1[safeIndex(455, p1.Length)]};
				var v17: multiset<int> := multiset{|v5|, p0, |multiset{v16, v16, v16, v16}|, p0};
				r0, v15 := ---(if (if (f17) then f17 else p1[safeIndex(455, p1.Length)]) then i0 - i0 else if (p0 in v17) then v17[p0] else |(seq(abs(0x101), i1  => ('o')))|), v15;
				var v18: map<bool, int> := map[f17 <== p1[safeIndex(455, p1.Length)] := p0];
				v18 := v18[f17 ==> f17 := p0];
			}
			
			if (p2 || f17) {
				var v19: seq<seq<bool>> := [v1, (v1[safeIndex(p0, |v1|) := p2])[safeIndex(p0, |v1[safeIndex(p0, |v1|) := p2]|) := f17], [p1[safeIndex(455, p1.Length)], p1[safeIndex(455, p1.Length)]]];
				var v20: set<int> := {i0, p0, |v19|, |(seq(abs(0x43), i2  => ('m')))|, i0};
				r0 := fm3(i0 >= |v20|, globalState);
				var v21 := 'p';
				var v22: map<char, bool> := map[v21 := p1[safeIndex(455, p1.Length)]];
				p1[safeIndex(455, p1.Length)] := i0 == (p0 - |v22|);
				var v23: map<bool, bool> := map[v1[safeIndex(i0, |v1|)] := p1[safeIndex(455, p1.Length)]];
				p1[safeIndex(455, p1.Length)], p1[safeIndex(455, p1.Length)], r0, r0, p1[safeIndex(455, p1.Length)] := true, v21 !in v0, i0, p0, if (true in v23) then v23[true] else p2;
				v0 := v0;
				var v24: map<int, seq<int>> := map[i0 := v5];
				v5 := (if (i0 in v24) then v24[i0] else v5) + (seq(abs(684), i3  => (i0)));
			} else {
				p1[safeIndex(455, p1.Length)], r0 := f17, p0 * |((seq(abs(967), i4  => ('g'))) + (seq(abs(0x3ce), i5  => ('i'))))|;
				r0 := i0;
				r0 := i0;
				v0 := v0;
				var v25: array<bool> := new bool[9] [false, !false, f17, p1[safeIndex(455, p1.Length)], f17, f17, true && p2, p2, p1[safeIndex(455, p1.Length)]];
				v25 := v25;
			}
			
			var v26: map<int, bool> := map[i0 := f17];
			var v27: map<map<int, bool>, int> := map[v26 := i0];
			p1[safeIndex(455, p1.Length)] := fm1(p2, p0 - |v27|, globalState);
		}
		r0 := -p0;
		var v28: array<set<bool>> := new set<bool>[17](i6 => v3 + v3);
		v28[safeIndex(255, v28.Length)] := v3 - v3;
		v28[safeIndex(255, v28.Length)] := v3;
		r0 := p0;
...
class C3 extends T0 {
	...
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
		...
		for i4 := 796 to v1 {
			var v9 := new C0();
			v1 := safeDivisionInt(safeDivisionInt(i4, |f15|), i4);
			var v10: array<bool> := new bool[19](i5 => DC33(false, i4, f16, v1, |v3|).cf57);
			v10[safeIndex(134, v10.Length)] := f16;
			v10[safeIndex(134, v10.Length)] := (f2 + {f16, f16, f16}) !! f2;
			if (f16) {
				var v11: map<bool, int> := map[v10[safeIndex(134, v10.Length)] := i4];
				...
				var v19: array<char> := new char[10] [v16, v16, if (i4 in v17) then v17[i4] else f15[safeIndex(v1, |f15|)], v16, v16, v16, v16, v16, v16, f15[safeIndex(|v18|, |f15|)]];
				v19[safeIndex(11, v19.Length)] := v16;
				var v20: map<int, array<bool>> := map[i4 := v10];
				var v21 := DC40(v20);
				v19[safeIndex(11, v19.Length)], v21 := v16, v21;
				var v22: map<array<bool>, bool> := map[v10 := f16];
				v1 := |v22| * (i4 * |f15|);
			} else {
				var v23: multiset<bool> := multiset{f16, !true};
				var v24: seq<multiset<bool>> := [v23, v23];
				f16, v10[safeIndex(134, v10.Length)], v10[safeIndex(134, v10.Length)], v10[safeIndex(134, v10.Length)], v10[safeIndex(134, v10.Length)] := f16, ((multiset{v10[safeIndex(134, v10.Length)], v10[safeIndex(134, v10.Length)]})[v10[safeIndex(134, v10.Length)] := abs(i4)] >= v24[safeIndex(|v2|, |v24|)]) !in v23, "giwpxt" != f15, f16 ==> v10[safeIndex(134, v10.Length)], if (f16 in v2) then v2[f16] else v10[safeIndex(134, v10.Length)];
				var v25: seq<int> := [-i4 * v1, 0x237, v1];
				v25 := (v25 + v25) + v25;
				f16 := f16;
				var v26 := 'e';
				v10[safeIndex(134, v10.Length)] := v26 !in (f15 + f15[safeIndex(|map[v1 := f16]|, |f15|) := 's']);
				v2 := v2[i4 > v1 := f16 || v10[safeIndex(134, v10.Length)]];
			}
			
		}
		var v27: seq<int> := [v1, v1, v1];
		r0 := multiset(v27);
		r1 := ["jdcr" <= (seq(abs(0x1c5), i6  => ('g'))), false, f16];
	}
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
		var v0 := -542;
		v0 := --v0;
		...
		for i0 := if (-v0 in v6) then v6[-v0] else |f15| to v0 {
			if (v0 >= i0) {
				...
				var v18: array<int> := new int[22] [|(f15 + (if (f16 in p0) then p0[f16] else seq(abs(314), i1  => ('y')))[safeIndex(v0, |(if (f16 in p0) then p0[f16] else seq(abs(314), i1  => ('y')))|) := v8])|, v0, |(v2 + [|v9|])|, v0, v0, i0, v0, i0, v0, v0, if ((if (v0 in v12) then v12[v0] else v10) in v11) then v11[if (v0 in v12) then v12[v0] else v10] else i0, v0, v0, i0, -i0, |v13|, i0, |(map[f16 := v0] + v14)|, v0, v0, |v17|, -v0];
				v18[safeIndex(621, v18.Length)] := i0;
				v18[safeIndex(621, v18.Length)] := |f2|;
				v18[safeIndex(621, v18.Length)] := safeDivisionInt(i0, v18[safeIndex(621, v18.Length)]);
				var v19 := new C2(f16);
				v0 := v18[safeIndex(621, v18.Length)];
			} else {
				var v20 := 'd';
				...
				v0 := 0x17c;
				var v23: map<bool, int> := map[f16 || true := safeModuloInt(|fm0(f16, v0, f16, globalState)|, v0)];
				var v24: seq<bool> := [f16, f16];
				v23 := v23[true := |v24|];
				f16 := if (f16) then f16 else f16;
				v0 := -safeDivisionInt(i0, i0 + |(seq(abs(0x2e6), i2  => (v20)))|);
			}
			...
			v25[safeIndex(220, v25.Length)] := !(v27 < v27);
			var v28: multiset<bool> := multiset{true, f16, f16};
			var v29: seq<multiset<bool>> := [v28[f16 := abs(i0)]];
			v25[safeIndex(220, v25.Length)] := v28 !! (v29[safeIndex(v0, |v29|)] + v28);
			var v30 := 'p';
			v30 := v30;
		}
		if (f16) {
			...
			var v45: array<int> := new int[29] [v0, v0, fm3(f16, globalState), v0, |(f2 + f2)|, |v34|, v0, v0, v0, v2[safeIndex(470, |v2|)] * v0, v0, v0, v0, v0, -119 + v0, 506, v0, v0 + 819, |({v0, v37.cf2} + v42)|, v0, |v1|, if (f16) then v0 else v0, |(v44 + v44)|, v0, v0, v0, safeModuloInt(v0, |f15|), v0, v0];
			...
			v47[safeIndex(545, v47.Length)] := v35;
			var v48: multiset<bool> := multiset{true, f16};
			var v49 := DC37(true, v43, f15, v0);
			v47[safeIndex(545, v47.Length)] := new bool[12] [if (f16 in v5) then v5[f16] else fm1(f16, --730, globalState), true, v0 == v0, f16, true, f16, f16 !in v48, f16 <==> f16, f16, f16 <== v49.cf64, f16, f15 != f15];
			v45[safeIndex(31, v45.Length)] := safeDivisionInt(v0, |v1|);
			v45[safeIndex(31, v45.Length)] := v0;
			var v50: array<D4> := new D4[11](i4 => DC15(v45[safeIndex(31, v45.Length)], v43, f16));
		...
		v53 := (v53[f16 := abs(|f15|)])[f16 := abs(|v56|)];
	}
	method m25(p0: bool, globalState: GlobalState) returns (r0: int) {
		...
		v9[safeIndex(528, v9.Length)] := f16;
		v9[safeIndex(528, v9.Length)] := v0 < v0;
		var v10: map<string, int> := map[fm47(globalState) := v1];
		var v11: array<int> := new int[6];
		v11[safeIndex(741, v11.Length)] := v1;
		v10, v11[safeIndex(741, v11.Length)], v1, v1 := map[fm42(globalState) := v1] + fm55(false, f16, v1, globalState), v1, v1, v1;
		var v12: map<set<bool>, bool> := map[f2 := !v9[safeIndex(528, v9.Length)]];
		v12 := v12;
		var v13: multiset<int> := multiset{v1, |f15|};
		var v14: map<bool, map<bool, int>> := map[!!f16 := map[v9[safeIndex(528, v9.Length)] := |v13|]];
		var v15 := DC42(v14);
		v14 := v15.cf75;
		var v16, v17, v18 := m0(globalState);
		r0 := v11[safeIndex(741, v11.Length)];
	}
}
	...
	method m4(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: array<set<int>>, r1: bool, r2: multiset<seq<D0>>) {
		...
		match (v1.(cf76 := p0, cf79 := fm1(p2, v2, globalState), cf78 := p0)) {
			case DC43(cf76, cf77, cf78, cf79, cf80) =>
				...
				cf79 := fm1(cf79, fm3(if ((seq(abs(0x39a), i0  => ('c'))) in v3) then v3[seq(abs(0x39a), i0  => ('c'))] else true, globalState), globalState);
				v0 := v0;
				var v4: array<bool> := new bool[16] [p0, p0, cf76, p1[safeIndex(v2, |p1|)], p0, cf80, cf76, p2, p2, p2, !cf78, false, cf78, cf80, cf78, p0];
				...
				v7[safeIndex(228, v7.Length)] := v9 * v9;
				v5, v7[safeIndex(228, v7.Length)], v2 := v5 + v5, v9, |{false}|;
				var v10 := 'w';
				var v11 := DC3(v10);
				var v12: set<D1> := {v11};
				var v13 := DC7(p2, v12);
			...
			case DC44(cf81, cf82, cf83) =>
				...
				var v17: set<int> := {v2};
				cf81 := p1[safeIndex(safeModuloInt(v2, |map[-|v16| := v17]|), |p1|)];
				...
				v21[safeIndex(210, v21.Length)] := p0;
				var v22: seq<multiset<int>> := [multiset{v2}, (multiset{v2})[v2 := abs(v2)]];
				v0, v20, v2, v21[safeIndex(210, v21.Length)] := v0 + v0, v20, |v22|, cf82;
				...
				v26 := v26[|(fm0(v21[safeIndex(210, v21.Length)], |v28|, cf82, globalState) + p1)| := v2];
			case DC45(cf84, cf85, cf86) =>
				...
				if (!v32.cf30) {
					...
					v33[safeIndex(895, v33.Length)] := v34;
					...
					v33[safeIndex(895, v33.Length)] := if (v37[safeIndex(v2, |v37|)] in v36) then v36[v37[safeIndex(v2, |v37|)]] else v34 + v34;
					var v38: multiset<int> := multiset{|v33[safeIndex(895, v33.Length)]|};
					...
					var v44: array<string> := new string[19] [v0, v0[safeIndex(v2, |v0|) := v30], v0, if (false in v43) then v43[false] else "ymeguesr", "wn", seq(abs(-33), i3  => (v30)), v0, v0, v0, v0, seq(abs(0x20), i4  => ('v')), v0, v0, v0, seq(abs(0x1c8), i5  => ('u')), seq(abs(0x355), i6  => (v30)), seq(abs(42), i7  => (v30)), "uhg", v0];
					var v45 := DC32(if (p2) then v44 else v44);
					v45 := v45;
					v44[safeIndex(474, v44.Length)] := v0;
					...
					v47[safeIndex(401, v47.Length)] := v46;
					...
					v44[safeIndex(474, v44.Length)], v47[safeIndex(401, v47.Length)], v2, v48, v49 := (v0 + v0) + ("duwv" + v0), v46, -|((fm60(|v0|, p0, |v50|, v30, globalState) + map[[p2] := !p2]) + (if (cf85) then map v51 : seq<bool> | v51 in v52 :: (v51) := (p0) else map v53 : seq<bool> | v53 in v54 :: (v53) := (false)))|, v48, DC37(v2 <= cf84, p1, v0, cf84);
				} else {
					cf85 := !p0;
					...
					v59[safeIndex(396, v59.Length)] := v55;
					v59[safeIndex(396, v59.Length)] := v55;
				}
				
				v2 := safeModuloInt(cf84, v2);
				v2 := v2 - (cf84 - v2);
			case DC42(cf75) =>
				var v60: array<string> := new string[1] ["l"];
				v60[safeIndex(300, v60.Length)] := v0 + v0;
				v60[safeIndex(300, v60.Length)] := seq(abs(206), i9  => ('j'));
				...
				if (p0) {
					var v64 := DC10();
					v64 := v64;
					var v65: set<bool> := {p1[safeIndex(0x225, |p1|)]};
					var v66 := DC30(v65);
					...
					var v72 := DC39(map v71 : string | v71 in {seq(abs(0x2c9), i11  => ('u'))} :: (v71) := (-0x38f));
					var v73: map<string, int> := map[v60[safeIndex(300, v60.Length)] := 0x57];
					var v74: map<int, map<string, int>> := map[v2 := v73];
					v70, v72 := v70, DC39(if (720 in v74) then v74[720] else v73);
					r1 := p0;
					v0 := v60[safeIndex(300, v60.Length)];
			...
			case DC46(cf87) =>
				v2 := v2;
				v0 := seq(abs(0x1b9), i12  => ('k'));
				var v76 := 'm';
				var v77: map<char, int> := map[v76 := v2];
				var v78: multiset<string> := multiset{v0[safeIndex(v2, |v0|) := v76]};
				var v79 := DC23(v78);
				v77 := v77[fm61(--0x1c6, p2, v2, v79, globalState) := v2];
				var v80: array<seq<int>> := new seq<int>[15](i13 => [--v2]);
				var v81: seq<int> := [0x13d, v2];
				v80[safeIndex(914, v80.Length)] := v81;
				v80[safeIndex(914, v80.Length)] := (v81 + v81) + v81;
		}
			...
			decreases 100 - i14
		{
			...
			if (p2) {
				...
				var v83: array<bool> := new bool[15] [p0, v82.cf93, p2, p0, p1[safeIndex(-0x1e8, |p1|)], false, p0, p0, p0, p0, p2, p0, p2, p2, p0];
				var v84 := 'd';
				...
				v94[safeIndex(469, v94.Length)] := v91;
				v94[safeIndex(469, v94.Length)] := v91;
				var v95: map<string, bool> := map[if (p2) then v0 else v0 := p2];
				var v97: multiset<string> := multiset{v0};
				v95 := v95 + (map v96 : string | v96 in v97 :: (v96) := (p1[safeIndex(|(seq(abs(0x65), i15  => (v84)))|, |p1|)]));
				...
				v98[safeIndex(643, v98.Length)] := v100 + v100;
				var v101: map<bool, int> := map[p0 := |map[v99 := v0]|];
				var v102: seq<map<map<bool, int>, array<int>>> := [v100, v100];
				var v103 := DC55(v100);
				var v104: seq<map<map<bool, int>, array<int>>> := [map[v101 := v99], v102[safeIndex(-0x16a, |v102|)], v100 + v103.cf105, v100 + v100, v100];
				var v105: multiset<bool> := multiset{p2};
				v98[safeIndex(643, v98.Length)] := v104[safeIndex(|v105|, |v104|)];
			} else {
				var v106: array<int> := new int[15];
				var v107: set<string> := {v0, seq(abs(0x16e), i16  => ('g')), v0};
				var v108 := DC56(v107);
				r1, v106, v2, v2 := p0, if (!(v107 !! v108.cf106)) then v106 else v106, v2, safeDivisionInt(v2, v2);
				v106[safeIndex(273, v106.Length)] := 0x1b7;
				v106[safeIndex(273, v106.Length)] := v2;
				var v109 := new C2(338 <= v106[safeIndex(273, v106.Length)]);
				var v110: multiset<bool> := multiset{p2};
				var v111: set<int> := {-|v110|};
				var v112 := DC26(v111);
				var v113: set<D9> := {DC26(v111), v112};
				v106[safeIndex(273, v106.Length)] := |fm62(v106[safeIndex(273, v106.Length)], p0, multiset{v113}, globalState)| * v2;
				var v114: seq<int> := [v106[safeIndex(273, v106.Length)], v2, v106[safeIndex(273, v106.Length)]];
				var v115: seq<int> := [|v114|, v106[safeIndex(273, v106.Length)], -v106[safeIndex(273, v106.Length)]];
				var v116: seq<seq<int>> := [v114, (v115[safeIndex(v2, |v115|) := fm3(false, globalState)])[safeIndex(v106[safeIndex(273, v106.Length)], |v115[safeIndex(v2, |v115|) := fm3(false, globalState)]|) := v2], v114, v114, v114];
				v106[safeIndex(273, v106.Length)] := |v116|;
			}
			
			var v117: map<int, int> := map[v2 := v2];
			v2 := safeDivisionInt(-v2, (if (v2 in v117) then v117[v2] else v2) + v2);
			var v118 := 's';
			r1 := if (p2) then v2 == |("degf")[safeIndex(v2, |"degf"|) := v118]| else !p2 <== p2;
		...
		if (true) {
			...
			var v134: multiset<seq<bool>> := multiset{if (v132 in v133) then v133[v132] else p1, p1[safeIndex(v2, |p1|) := p2]};
			var v135: multiset<bool> := multiset{p0};
			var v136: map<char, int> := map[v132 := v2];
			var v137 := DC50(p0, false, v2);
			var v138: set<int> := {v2};
			var v139: array<bool> := new bool[27] [v134[p1 := abs(v2)] == v134, p0, true, p1 != p1, p2, fm1(p0, v2, globalState), !false, p2, p2, v135 < v135, p0, p0, p0, false, v2 > |v136|, p2, p0, fm4(v137.cf93, |v135|, |v138|, v2, globalState) !! v138, p0, p2, p0, p2, p0, p0, false, p0, p0];
			...
			v144 := v144[0x300 := v0];
			v139[safeIndex(455, v139.Length)] := p0;
			v139[safeIndex(455, v139.Length)] := p2;
		}
		
		for i17 := v2 to v2 {
			var v145: array<int> := new int[8](i18 => i18 - 0x80);
			v145[safeIndex(157, v145.Length)] := safeModuloInt(i17, i17);
			v145[safeIndex(157, v145.Length)] := v2;
			v2 := v145[safeIndex(157, v145.Length)];
			var v146 := 'y';
			var v147 := new C1(v146, {p0, p0, p2, !p2});
			var v150: array<map<map<int, int>, bool>> := new map<map<int, int>, bool>[3](i19 => (map v148 : map<int, int> | v148 in (set v149 : map<int, int> | v149 in multiset{map[i17 := i17], map[v2 := v145[safeIndex(157, v145.Length)]]} :: (v149)) :: (v148) := (!p2)) + map[map[v2 := v145[safeIndex(157, v145.Length)]] := p0]);
			...
			v150[safeIndex(179, v150.Length)] := v154[safeIndex(v2, |v154|)];
			var v156: seq<map<int, int>> := [v152];
			v150[safeIndex(179, v150.Length)] := (v153 + (map v155 : map<int, int> | v155 in v156 :: (v155) := (p2)))[fm64(p0, 0x2d, p2, |v0|, globalState) := if (|v0| in v151) then v151[|v0|] else p2];
		}
		if (fm1(p0 !in p1, v2, globalState)) {
			...
			v158 := v159[safeIndex(v2, |v159|)];
			r1 := !p0;
			var v160: array<bool> := new bool[1](i20 => p2);
			v160[safeIndex(45, v160.Length)] := p0;
			v160[safeIndex(45, v160.Length)] := if (v0 in v157) then v157[v0] else p2;
			var v161: array<int> := new int[23];
			v161 := v161;
		} else {
			var v162: array<int> := new int[8](i21 => i21 * |v0|);
			v162[safeIndex(567, v162.Length)] := v2;
			var v163: map<int, int> := map[v2 := |(seq(abs(0xeb), i22  => (|{p0}|)))|];
			v162[safeIndex(567, v162.Length)] := v2 + -(if (v2 in v163) then v163[v2] else v2);
			var v164: seq<int> := [v2];
			var v165 := 'e';
			var v166: map<bool, char> := map[!p0 := v165];
			var v167: map<int, array<int>> := map[v2 := v162];
			var v168: map<int, seq<bool>> := map[v2 := p1];
			v162[safeIndex(567, v162.Length)], v162, r1, v164 := |(map[p0 := v165] + v166)|, if (-v162[safeIndex(567, v162.Length)] in v167) then v167[-v162[safeIndex(567, v162.Length)]] else v162, p0 in (if (v2 in v168) then v168[v2] else p1), (if (p2) then v164 else seq(abs(987), i23  => (v2))) + v164;
			var v169: map<bool, bool> := map[p2 := !false];
			var v170: seq<map<bool, bool>> := [v169, v169];
			v169 := map[false := p2] + (v170[safeIndex(v2, |v170|)] + v169[false := p2]);
			var v171: array<bool> := new bool[19];
			v171[safeIndex(865, v171.Length)] := false;
			v171[safeIndex(865, v171.Length)] := v2 < safeDivisionInt(v162[safeIndex(567, v162.Length)], |v164|);
			v2 := v162[safeIndex(567, v162.Length)];
		}
	...
	method m29(globalState: GlobalState) returns (r0: seq<D1>, r1: seq<bool>) {
		...
		for i0 := if (v1) then |[v4, v4]| else v4 to 0x278 {
			...
			match (v7) {
				case DC59(cf111, cf112) =>
					...
					var v15 := DC22(v12, v13[safeIndex(v4, |v13|)] - cf112, true, safeModuloInt(i0, |v14|));
					v15 := v15;
					v4 := |(seq(abs(0x31b), i1  => (v8)))|;
					cf112 := fm3(v1, globalState);
				case DC60(cf113, cf114) =>
					v1 := {v3.f16, v3.f16} < {v3.f16};
					var v16: set<int> := {v4};
					var v17: array<int> := new int[6] [safeModuloInt(i0, -fm3(true, globalState)), safeModuloInt(v4, v4), |v16| - i0, i0, v4, v4];
					var v18 := DC53(v3.f16, v4);
					v17[safeIndex(519, v17.Length)] := v18.cf103;
					v17[safeIndex(519, v17.Length)] := safeDivisionInt(i0, i0);
					var v19 := new C0();
					v3.f15 := v3.f15;
				case DC58(cf110) =>
					v1 := v1;
					...
					v20[safeIndex(237, v20.Length)] := v21;
					var v22: multiset<bool> := multiset{false};
					var v23 := 'f';
					var v24: map<bool, char> := map[v3.f16 := v23];
					v20[safeIndex(237, v20.Length)] := DC27(v22 * v22, |v24|);
					var v25: array<string> := new string[14](i3 => v3.f15 + (seq(abs(0x2e0), i4  => (v23))));
			...
			match (if (v3.f16) then DC33(true, i0, true, i0, i0).(cf59 := v3.f16, cf60 := i0, cf58 := |v28|) else v29) {
				case DC33(cf57, cf58, cf59, cf60, cf61) =>
					...
					v30 := v30;
					v30, cf61, cf60 := v30, i0, safeDivisionInt(i0 * i0, if (v5[safeIndex(|v0|, |v5|)]) then cf60 else cf58);
					var v31: map<bool, bool> := map[v3.f16 := v3.f16];
					cf61 := if (v5[safeIndex(|v0|, |v5|)]) then |(v31 + map[true := v1])| else cf58 * cf58;
					cf58 := cf61 - v4;
				case DC34() =>
					var v32: array<int> := new int[12];
					v32[safeIndex(603, v32.Length)] := v4;
					v32[safeIndex(603, v32.Length)] := if (v3.f16) then v4 else i0;
					v4 := safeModuloInt(v32[safeIndex(603, v32.Length)], v4 + v32[safeIndex(603, v32.Length)]);
					var v33: multiset<int> := multiset{|v0|};
					v32[safeIndex(603, v32.Length)] := safeDivisionInt(v4 + fm3(v5[safeIndex(if (v32[safeIndex(603, v32.Length)] in v33) then v33[v32[safeIndex(603, v32.Length)]] else v32[safeIndex(603, v32.Length)], |v5|)], globalState), v4);
					v32[safeIndex(603, v32.Length)] := v32[safeIndex(603, v32.Length)] * (v4 - i0);
				case DC32(cf56) =>
					...
					v36[safeIndex(346, v36.Length)] := v34;
					v36[safeIndex(346, v36.Length)] := v34;
				...
				case DC35(cf62) =>
					...
					v38 := v38;
					v4 := -|(seq(abs(0x18b), i6  => (v28)))|;
			}
			
			var v39: array<int> := new int[24];
			v39 := v39;
		}
		var v40: array<D19> := new D19[25](i8 => DC52(map[DC19(seq(abs(892), i9  => (v2))) := v4]));
		...
		match (if (v1) then v41 else v41) {
			case DC59(cf111, cf112) =>
				...
				v42[safeIndex(570, v42.Length)] := v44[v43 := abs(483)];
				var v45: map<bool, bool> := map[v3.f16 := v1];
				var v46: seq<bool> := [cf111];
				var v47: array<bool> := new bool[12] [(if (v3.f16 in v45) then v45[v3.f16] else v1) <==> v3.f16, v4 > -cf112, cf111, v3.f16, [cf111] <= v46, !v1, if (v3.f16 in v45) then v45[v3.f16] else v46[safeIndex(cf112, |v46|)], v3.f16, v3.f16, cf111, v3.f16, v1];
				v47[safeIndex(366, v47.Length)] := v3.f16;
				v42[safeIndex(570, v42.Length)], v1, v47[safeIndex(366, v47.Length)] := v44, v2 !! v2, v3.f16;
				v47[safeIndex(366, v47.Length)] := !v47[safeIndex(366, v47.Length)];
				var v48 := 't';
				...
				v50[safeIndex(683, v50.Length)] := |(seq(abs(877), i11  => (v48)))| + v4;
				v49, v3.f16, v50[safeIndex(683, v50.Length)] := v49, v3.f16, -(cf112 + cf112);
				var v51 := new C0();
			case DC60(cf113, cf114) =>
				...
				var v57: map<array<bool>, char> := map[v55 := v0[safeIndex(fm3(v1, globalState), |v0|)]];
				var v58 := 'w';
				...
				var v61: seq<multiset<bool>> := [multiset{v3.f16, v3.f16}, v60, v60 - multiset{v3.f16, v3.f16, v3.f16, false, v3.f16}, v60, v60[v3.f16 := abs(0xf)]];
				v52, v4, v52, v61 := 0x48, v53, v4, (seq(abs(-0x296), i12  => (v60 - v60)))[safeIndex(if (v3.f16 in v60) then v60[v3.f16] else v53, |(seq(abs(-0x296), i12  => (v60 - v60)))|) := v60];
			case DC58(cf110) =>
				var v62: seq<int> := [v4];
				...
				var v66: array<int> := new int[19](i13 => safeModuloInt(i13, v4));
				var v67: seq<array<int>> := [v66, v66];
				v65[safeIndex(47, v65.Length)] := if (v3.f16) then v66 else v67[safeIndex(v4, |v67|)];
				v65[safeIndex(47, v65.Length)] := v66;
		}
		
		v4, v3.f16 := v4, v3.f16;
		v4 := safeDivisionInt(v4, |{v4, v4}|);
		var v68 := DC3('d');
		var v69 := 'r';
		var v70: seq<D1> := [v68, DC3(v69)];
		r0 := v70 + [v68.(cf7 := v69), v68, DC3(v69), v68];
		var v71: seq<bool> := [v1];
		r1 := (v71[safeIndex(v4, |v71|) := v3.f16] + v71) + v71;
	}
}
...
class C5 extends T2 {
	...
	function fm8(p0: D1, p1: int, globalState: GlobalState): multiset<bool> {
		multiset{DC23(multiset(["egwmey"])).cf40 > multiset{seq(abs(0x325), i0  => ('g'))}, true}
	}
	function fm9(p0: int, p1: bool, globalState: GlobalState): multiset<bool> {
		multiset{true}
	}
	...
	method m4(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: array<set<int>>, r1: bool, r2: multiset<seq<D0>>) {
		...
		r1 := v3 != v3;
		v0 := safeDivisionInt(if (p2) then fm3(p2, globalState) else v0, v0);
		...
		match (DC25(v4).(cf44 := v4)) {
			case DC24(cf41, cf42, cf43) =>
				...
				var v8 := DC20(v5, p0, map[v2[safeIndex(v0, |v2|)] := |v7|]);
				var v9: set<D7> := {v8};
				var v10: map<bool, bool> := map[true := p1[safeIndex(|v9|, |p1|)]];
				var v11: map<bool, int> := map[p0 := cf41];
				var v12: set<bool> := {p0};
				var v13 := "amhryple";
				var v14: map<int, int> := map[fm3(p2, globalState) := -0xa8];
				var v15: array<int> := new int[24] [fm3(p2, globalState), safeModuloInt(cf42, cf41), |v10|, v0, cf42, v0, v0, cf41, cf42, cf41, v0, cf41, safeDivisionInt(v0, --cf41), cf41, -(|[v11, map[p0 := |v12|]]| + cf42), |(v13 + v13)|, cf41, cf42, |v14|, cf41 + cf41, |map[p0 := cf41]|, cf42, cf41 + v0, v0];
				v15[safeIndex(164, v15.Length)] := -cf41;
				v15[safeIndex(164, v15.Length)] := v0;
				cf41 := v15[safeIndex(164, v15.Length)] + -|v13|;
				cf42 := -cf41;
				v0 := safeDivisionInt(cf41, -v0);
			case DC23(cf40) =>
				var v16 := "jxiulgir";
				...
				if (p2) {
					...
					var v19: array<string> := new seq<char>[26] [seq(abs(822), i0  => ('t')), v16 + v17[safeIndex(0xbe, |v17|)], v16 + v16, v16[safeIndex(|v18|, |v16|) := fm39(globalState)], v16, seq(abs(0x18), i1  => ('u')), seq(abs(32), i2  => ('c')), seq(abs(512), i3  => ('a')), "i", v16, v16, v16, v16, fm40(v0, globalState), seq(abs(-0x233), i4  => ('x')), v16, v16, v16, v16, v16, v16, v16, v16, v16, "mmqvjc", v16];
					v19[safeIndex(775, v19.Length)] := "fogkpmbv";
					v19[safeIndex(775, v19.Length)] := "or";
					var v20: map<bool, int> := map[p2 := safeModuloInt(v0, v0)];
					var v21: set<bool> := {p0, p0};
					var v22: set<int> := {v0};
					v20 := v20[p0 in v21 := |v22| - |DC26(v22).cf45|];
					v20 := v20[fm1(p0, v0, globalState) := safeDivisionInt(v0, 688)];
					v0 := v0 + v0;
					var v23 := 'p';
					...
					var v27 := DC47(v26);
					var v29: map<bool, set<int>> := map[v25 < v25 := set v28 : int | v28 in v27.cf88[|v2| := p2] :: (safeDivisionInt(v28, |map[!true := DC37(!true, [true, true], "l", 662).cf64]|))];
					v29 := v29[p0 := v25];
					...
					v32[safeIndex(181, v32.Length)] := v16 + fm42(globalState);
					var v33: multiset<bool> := multiset{p2};
					r1, r1, r1, v31, v32[safeIndex(181, v32.Length)] := safeDivisionInt(v0, if (false in v33) then v33[false] else -v0) > v0, !p0, p2, v31, seq(abs(-0x337), i5  => ('y'));
				}
			...
			case DC25(cf44) =>
				...
				var v46: array<int> := new int[17] [|p1| - v0, v0, if (v41 in v42) then v42[v41] else v0, v0, safeModuloInt(v0, v0), safeDivisionInt(|{[v0, v0]}|, v0), safeDivisionInt(v0, v0), safeModuloInt(v0, v0), |(map v43 : int | (0xe <= v43) && (v43 < 405) :: (safeDivisionInt(v43, |map[-v0 := if (p2 in v36) then v36[p2] else |p1|]|)) := (map[v0 := |p1|]))|, v0, v0, v0, |(seq(abs(0x30), i6  => (v0)))| * v0, --v0, if (|v40| in v45) then v45[|v40|] else v0, safeDivisionInt(|v45|, v0), -v0];
				v46[safeIndex(591, v46.Length)] := 0x2ed;
				var v47 := 'm';
				var v48: seq<char> := [v47];
				var v49 := DC48(fm56(v0, globalState));
				v46[safeIndex(591, v46.Length)], r1, v47 := v0, p0, v48[safeIndex(|v49.cf89| - v0, |v48|)];
				v48 := v48;
		}
		...
		v53 := v53.(cf69 := v54[safeIndex(v0, |v54|)] + v52);
		var v55: array<set<int>> := new set<int>[16](i7 => {|"jrmynqehj"|});
		r0 := v55;
		r1 := (if (p0) then p0 else p2) <==> p1[safeIndex(|v52|, |p1|)];
		var v56 := 'g';
		var v57: map<bool, char> := map[true := v56];
		var v58 := DC1(v1, v0, !p0, v57, p0);
		var v59 := DC3(v56);
		var v60: map<D1, bool> := map[v59 := p2];
		var v61: seq<D0> := [DC1(v1, |(seq(abs(-0xd6), i8  => (v56)))|, if (v59 in v60) then v60[v59] else p0, v57, p0)];
		var v62: multiset<seq<D0>> := multiset{[v58.(cf2 := -v0, cf1 := v1, cf3 := p2), v58], v61, v61[safeIndex(-v0, |v61|) := DC1(v1, v0, true, v57, p2).(cf1 := v1)], v61 + v61, v61};
		r2 := v62;
	}
	method m23(p0: int, p1: int, p2: array<string>, p3: string, globalState: GlobalState) returns (r0: array<bool>, r1: D4, r2: bool) {
			...
			decreases 100 - i0
		{
			...
			v0 := v0;
			var v10: array<int> := new int[16](i1 => safeDivisionInt(i1, p0));
			v10 := v10;
		}
		...
		match (match DC25(v12) {
			...
			case DC27(cf46, cf47) =>
				...
				cf47, v15, cf47, cf47 := safeDivisionInt(cf47, 0x22a), "qjqcmqr", 0x293, if (v16 in v17) then v17[v16] else p1;
			...
			case DC26(cf45) =>
				...
				if ((fm58(globalState)).cf85) {
					...
					v29[safeIndex(195, v29.Length)] := v30;
					...
					v24, v0, v2, v2, v29[safeIndex(195, v29.Length)] := if (v31 in v32) then v32[v31] else v24, true, fm0(v2[safeIndex(|v33|, |v2|)], fm3(v0, globalState), v0, globalState), v2, if (v0) then v30[v24 := v0] else v30;
				} else {
					var v35: map<seq<multiset<int>>, bool> := map[seq(abs(893), i3  => (multiset{|map[v0 := v0]|})) := v0];
					var v36: seq<multiset<int>> := [multiset{p0, 0xb4}];
					v35 := v35[v36[safeIndex(p1, |v36|) := multiset((seq(abs(0x3a7), i4  => (p1)))[safeIndex(p1, |(seq(abs(0x3a7), i4  => (p1)))|) := p0])] := v0];
					r2 := !v0;
					var v37: array<bool> := new bool[3];
					v37[safeIndex(633, v37.Length)] := fm1(v0, 0x75, globalState);
					v37[safeIndex(633, v37.Length)] := v0 <==> v0;
					...
					v40[safeIndex(566, v40.Length)] := (if (p1 in v38) then v38[p1] else |v2|) + -|p3|;
					v40[safeIndex(566, v40.Length)] := p0;
					r2 := v2[safeIndex(v40[safeIndex(566, v40.Length)], |v2|)];
				}
			...
			case DC28(cf48) =>
				...
				var v44: array<array<array<int>>> := new array<array<int>>[26] [v41, v41, if (v0) then v41 else v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, v41, if (v0 in v42) then v42[v0] else v41, v41, v41, v41, v41, v43[safeIndex(p1, |v43|)], v43[safeIndex(|map[v0 := p0]|, |v43|)], v41, v41, v41];
				v44[safeIndex(103, v44.Length)] := v41;
				v44[safeIndex(103, v44.Length)] := v41;
				var v45 := 0x2eb;
				var v46: seq<int> := [p1, v45];
				var v47: multiset<int> := multiset{-p0, if (v0 in v3) then v3[v0] else v46[safeIndex(|p3|, |v46|)], p0, v45, fm3(v0, globalState)};
				v45 := |(v47 * (v47 * v47))|;
				var v48 := 'm';
	...
	method m24(p0: array<int>, globalState: GlobalState) returns (r0: D2, r1: map<map<bool, bool>, bool>, r2: set<multiset<bool>>) {
		...
		match (v7) {
			case DC27(cf46, cf47) =>
				...
				v9[safeIndex(156, v9.Length)] := v1;
				v9[safeIndex(156, v9.Length)] := v1;
				var v10: array<D16> := new D16[9](i0 => DC43(v1, v0, !v9[safeIndex(156, v9.Length)], v1, v9[safeIndex(156, v9.Length)]));
				var v11: seq<bool> := [v9[safeIndex(156, v9.Length)], !v1];
				var v12 := DC43(v11[safeIndex(cf47, |v11|)], v0, v9[safeIndex(156, v9.Length)], v9[safeIndex(156, v9.Length)], true);
				v10[safeIndex(888, v10.Length)] := v12;
				v10[safeIndex(888, v10.Length)] := DC43(437 != |v11|, v0, true, v1, !v1);
			case DC26(cf45) =>
				v1 := !v1;
				var v13: array<bool> := new bool[9];
				p0[safeIndex(378, p0.Length)] := v2[safeIndex(v4, |v2|)];
				v13, v1, p0[safeIndex(378, p0.Length)], v4 := if (v1) then v13 else v13, if (v1) then v1 else v1, v4 * -v4, v4;
				v4 := if (v1 in v3) then v3[v1] else safeDivisionInt(359, v4);
				v4 := p0[safeIndex(378, p0.Length)];
			case DC28(cf48) =>
				v1 := v5 >= v5;
				...
				v4 := v4;
				var v18: seq<bool> := [v1];
				var v19: array<bool> := new bool[22] [v1 <== v1, v1, v1, v1, v1, v1, v1, true, v18[safeIndex(v4, |v18|)], v1, v1, if (v4 in v15) then v15[v4] else v1, v1, v1, v1, v1, v1, v1, v1, if (v1) then v1 else v1, false, v1];
				v19 := v19;
		}
		...
		match (v22) {
			case DC43(cf76, cf77, cf78, cf79, cf80) =>
				...
				var v28 := new C0();
				p0[safeIndex(657, p0.Length)] := v4;
				var v29: map<multiset<char>, char> := map[multiset(cf77) := v24];
				var v30 := DC24(|v29|, v4, [cf76]);
				var v31: set<bool> := {cf80, v1, cf80};
				p0[safeIndex(657, p0.Length)], v4 := if (fm1(v1, v30.cf42, globalState) in v3) then v3[fm1(v1, v30.cf42, globalState)] else safeDivisionInt(v4, |v31|), if (cf76) then v4 else v4 + v4;
			case DC44(cf81, cf82, cf83) =>
				...
				var v37 := DC52(v35);
				var v38: seq<bool> := [!v1];
				var v39: array<map<D7, int>> := new map<D7, int>[8] [v35, v35[v36 := v4], v35, v35, map[DC19(v34) := v4], v37.cf101, v35 + fm59(true, v38[safeIndex(v4, |v38|)], globalState), v35 + map[v36 := 801]];
				v39[safeIndex(246, v39.Length)] := fm59(cf82, cf81, globalState);
				var v40: array<bool> := new bool[10];
				var v41 := DC41(cf81, cf82, v4, v40);
				v39[safeIndex(246, v39.Length)] := map[v36 := v41.cf73];
			case DC45(cf84, cf85, cf86) =>
				cf84 := v4;
				var v42: array<bool> := new bool[25];
				v42[safeIndex(921, v42.Length)] := cf85;
				v42[safeIndex(921, v42.Length)] := if (v1) then cf85 else false;
				...
				if (v1 <==> (multiset(v2) > v44)) {
					...
					v45 := v45[safeDivisionInt(cf84, v4) := v42[safeIndex(921, v42.Length)]];
					v42[safeIndex(921, v42.Length)] := v1;
					...
					var v48: map<multiset<string>, int> := map[v46[v0 := abs(cf84)] := cf84];
					v48 := v48[v46 := |v5|];
				} else {
					v42[safeIndex(921, v42.Length)] := fm1(false, cf84, globalState);
					var v49: seq<bool> := [v42[safeIndex(921, v42.Length)]];
					v42[safeIndex(921, v42.Length)] := !(v49 < (v49 + v49));
					var v50: set<bool> := {true};
					p0[safeIndex(264, p0.Length)] := |v50|;
					p0[safeIndex(264, p0.Length)] := --(|"wsquuffxg"| * 0x1af);
					v42[safeIndex(921, v42.Length)] := fm38(globalState);
					v1 := v1;
				}
				
				var v51: array<seq<int>> := new seq<int>[12](i1 => v2);
				v51[safeIndex(84, v51.Length)] := [v4];
				v51[safeIndex(84, v51.Length)] := v2;
			case DC42(cf75) =>
				p0[safeIndex(892, p0.Length)] := v4;
				p0[safeIndex(391, p0.Length)] := safeModuloInt(v4, v4);
				var v52: map<int, bool> := map[v4 := v1];
				p0[safeIndex(892, p0.Length)], p0[safeIndex(391, p0.Length)] := -v4 - (|v52| - v4), 0xc;
				var v53: array<int> := new int[21];
				var v54: map<bool, array<int>> := map[v1 := v53];
				var v55: seq<bool> := [v1];
				v54 := v54[v55[safeIndex(v4, |v55|)] := v53];
				v4 := v2[safeIndex(0x393, |v2|)];
				var v56: array<C2> := new C2[28];
				var v57: map<int, array<C2>> := map[p0[safeIndex(892, p0.Length)] := v56];
				v57 := v57 + v57[v4 := v56];
			case DC46(cf87) =>
				var v58 := new C0();
				v4 := -v4;
				var v59: map<map<bool, int>, bool> := map[v3 := v1];
				v4 := safeDivisionInt(v4, |(v59 + v59)|);
				if (v1) {
					v1 := false;
					...
					v60[safeIndex(338, v60.Length)] := |v61|;
					v60[safeIndex(338, v60.Length)] := (v4 * 0xc) + v4;
					var v62: map<bool, bool> := map[v1 := v1];
					var v63 := DC21(false, v62, v1, v60[safeIndex(338, v60.Length)]);
					var v64 := 'f';
					var v65: map<map<D7, bool>, char> := map[map[v63 := v1] := v64];
					v65 := v65[map[v63 := v1] := 'h'];
				} else {
					p0[safeIndex(517, p0.Length)] := v4;
					var v66: array<bool> := new bool[28];
					v66[safeIndex(518, v66.Length)] := v4 < 0x259;
					...
					var v70: seq<string> := [seq(abs(0xa2), i2  => ('q')), v0];
					var v71: map<int, seq<string>> := map[v4 := v70];
					p0[safeIndex(517, p0.Length)], v66, v66[safeIndex(518, v66.Length)], v1 := -v4, v68[safeIndex(|[-fm3(v1, globalState), |v69|, v4, fm3(fm38(globalState), globalState), v4]|, |v68|)], v1, (v70 + (if (v4 in v71) then v71[v4] else v70)) <= v70;
					var v72: array<array<string>> := new array<string>[11];
					var v73: array<string> := new string[28];
					v72[safeIndex(80, v72.Length)] := v73;
					v72[safeIndex(80, v72.Length)] := v73;
					var v74 := 'r';
					v74 := v74;
					v4 := v4;
					var v75: map<int, bool> := map[p0[safeIndex(517, p0.Length)] := v1];
					var v76: map<int, map<int, bool>> := map[p0[safeIndex(517, p0.Length)] := v75];
					var v78 := DC47(if (v4 in v76) then v76[v4] else map v77 : int | (-575 <= v77) && (v77 < 0x36e) :: (v77 * p0[safeIndex(517, p0.Length)]) := (v1));
					var v79: multiset<int> := multiset{p0[safeIndex(517, p0.Length)]};
					var v80: map<int, int> := map[v4 := v4];
					var v81: array<int> := new int[18] [p0[safeIndex(517, p0.Length)], 15, v2[safeIndex(v4, |v2|)], 0x2d2, v4, p0[safeIndex(517, p0.Length)], |v78.cf88|, v4, |v79|, v4, if (|map[true := v1]| in v80) then v80[|map[true := v1]|] else 0x174, 0x23a, v4, v4, p0[safeIndex(517, p0.Length)], p0[safeIndex(517, p0.Length)], 0x215, p0[safeIndex(517, p0.Length)]];
					var v82: map<int, array<int>> := map[|(seq(abs(-0x3d), i3  => (v74)))| := v81];
					v82 := map[v4 - p0[safeIndex(517, p0.Length)] := v81];
				}
		...
		v85[safeIndex(775, v85.Length)] := v1;
		var v86: map<string, int> := map[v0 := 0x6f];
		var v87: seq<map<string, int>> := [v86];
		v85[safeIndex(775, v85.Length)] := v4 >= safeDivisionInt(|v87[safeIndex(v4, |v87|)]|, -v4);
		var v88: array<map<int, bool>> := new map<int, bool>[15];
		forall i4 | 0 <= i4 < v88.Length {
			v88[i4] := map[0xff := (seq(abs(-0x2d6), i5  => (v20))) != [v20, v20]];
		}
		var v89 := 'i';
		var v90 := new C1(v89, {v85[safeIndex(775, v85.Length)]});
		var v91: seq<string> := [v0, v0, seq(abs(0xb0), i9  => (v89)), "xdi", v0[safeIndex(v4, |v0|) := v89]];
		var v92: T2 := new C4();
		var v93: map<T2, int> := map[v92 := v4];
		var v94: array<string> := new string[11] [v0 + v0[safeIndex(v2[safeIndex(v4, |v2|)], |v0|) := v89], v0, "ipkpxvg", if (v85[safeIndex(775, v85.Length)]) then v0 else seq(abs(0x47), i6  => (v90.f18)), v0, v0 + (seq(abs(-275), i7  => (v89))), v0, v0 + (seq(abs(620), i8  => (v89))), v0 + v0, v91[safeIndex(|v93|, |v91|)], v0 + v0];
		v94[safeIndex(590, v94.Length)] := ("ydfws")[safeIndex(|fm45(globalState)|, |"ydfws"|) := 'k'];
		var v95: array<array<int>> := new array<int>[21];
		v95[safeIndex(384, v95.Length)] := p0;
		v85[safeIndex(775, v85.Length)], v94[safeIndex(590, v94.Length)], v95[safeIndex(384, v95.Length)], v85[safeIndex(775, v85.Length)] := v85[safeIndex(775, v85.Length)] ==> v85[safeIndex(775, v85.Length)], v0 + (v0 + v0), p0, true;
		var v96 := DC6(v85[safeIndex(775, v85.Length)], v1, v90.f18, v4, v85[safeIndex(775, v85.Length)]);
		r0 := v96.(cf13 := |v5|, cf12 := v89);
		var v97: map<map<bool, bool>, bool> := map[v84 := v85[safeIndex(775, v85.Length)]];
		...
		var v101: seq<bool> := [v85[safeIndex(775, v85.Length)]];
...
class C6 extends T1 {
	...
	function fm6(p0: bool, p1: int, globalState: GlobalState): string {
		(seq(abs(387), i0  => ('n'))) + ("wj" + (seq(abs(0x300), i1  => ('v'))))
	}
	function fm7(p0: bool, p1: string, p2: map<string, string>, globalState: GlobalState): bool {
	...
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		...
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := !(multiset([p0, p0]) !! multiset{p0, |(seq(abs(0x25), i1  => ('p')))|});
		}
		var v1 := new C5();
		for i2 := |"ctcye"| to p0 {
			var v2: seq<bool> := [true];
			v2 := (v2 + v2) + v2;
			var v3: map<bool, int> := map[fm1(p1, p0, globalState) := safeModuloInt(fm68(p1, p1, globalState), i2)];
			var v4 := "ltybst";
			var v5: multiset<int> := multiset{|v4|, i2};
			r1, r1, v3 := fm68(p1, v2[safeIndex(p0, |v2|)], globalState), safeModuloInt(|v5| * -i2, |{i2}|), (v3 + map[p1 := i2]) + v3;
			var v6: array<D10> := new D10[3];
			var v7: seq<int> := [p0];
			v6[safeIndex(309, v6.Length)] := DC29(v7);
			var v8 := DC29(v7);
			v6[safeIndex(309, v6.Length)] := v8;
		...
		if ((p0 != |v14|) <== p1) {
			match (fm69(p1, p1, globalState)) {
				...
				case DC52(cf101) =>
					...
					var v27: array<int> := new int[9](i3 => safeModuloInt(i3, p0));
					var v28: multiset<array<int>> := multiset{v27, v27};
					var v29: seq<int> := [p0];
					r1 := -p0 + safeModuloInt(|v28|, v29[safeIndex(p0, |v29|)]);
					r1, v19, r1 := p0, v19, p0;
					var v30 := true;
				...
				case DC54(cf104) =>
					...
					v32 := (v37 != v37) <== true;
					v0[safeIndex(161, v0.Length)] := p1;
					var v38 := 'l';
					var v39: map<bool, char> := map[!v32 := v38];
					var v40 := DC1(v0, |v14|, v32, v39, p1);
					v0[safeIndex(161, v0.Length)] := p1 <==> (v40.(cf1 := v0, cf3 := v32)).cf3;
					var v41: array<string> := new string[13];
					var v42, v43, v44 := v1.m23(p0 * p0, p0, if (v0[safeIndex(161, v0.Length)]) then v41 else v41, v14, globalState);
			}
			...
			var v48 := DC43(p1, v14, v46[safeIndex(|v14|, |v46|) := v45] == v47.cf43, v45, v45);
			var v49: array<int> := new int[23];
			var v50: seq<array<bool>> := [v0];
			var v51: multiset<array<bool>> := multiset{v50[safeIndex(p0, |v50|)], v0};
			var v52: seq<multiset<array<bool>>> := [v51];
			var v53: seq<string> := [v14];
			r1, v48, r1, v49 := -fm68(if (p1) then v45 else v45, p1, globalState), if (v52[safeIndex(|v14|, |v52|)] > multiset{v0}) then DC43(p1, v14, p1, v1.fm37(globalState), p1) else DC43(p1, v53[safeIndex(p0, |v53|)], v45, v45, v45), p0, v49;
			...
			var v57: map<string, int> := map[seq(abs(356), i4  => ('p')) := 0x242];
			...
			v56, v45, v58 := v56, (v61 + v61) != map[true := v60], v58[p0 > p0 := abs(p0)];
		} else {
			var v62 := false;
			...
			var v68: array<seq<C5>> := new seq<C5>[13] [[v1], v67, ([v1])[safeIndex(0x111, |[v1]|) := v1], v67 + v67, v67 + [v1, v1], v67, v67 + v67, v67[safeIndex(p0, |v67|) := v1], v67, v67, v67 + v67, v67, v67];
			v68[safeIndex(310, v68.Length)] := v67;
			var v69: seq<seq<C5>> := [v67];
			var v70: seq<seq<C5>> := [v69[safeIndex(p0, |v69|)]];
			var v71: multiset<char> := multiset{'f'};
			var v72: multiset<multiset<char>> := multiset{v71};
			v68[safeIndex(310, v68.Length)] := v70[safeIndex(|(if (p1) then v72 else multiset{v71, v71, v71, v71, v71})|, |v70|)];
			var v73: map<bool, int> := map[!!v62 := p0];
			var v74: seq<int> := [p0, 0x99, safeDivisionInt(p0, |v73|)];
			r1, v74 := -p0 + p0, v74;
			r1 := 0x1c4;
		...
		v0[safeIndex(365, v0.Length)] := v14 == v14;
		var v80 := false;
		var v81 := 'e';
		var v82 := DC3(v81);
		...
		r1, v0[safeIndex(365, v0.Length)], v0, v80, v85 := p0, v86 != v86, v0, (v89 != v89) ==> p1, v90[safeIndex(p0, |v90|)];
		r0 := v81;
		var v91: map<bool, bool> := map[v0[safeIndex(365, v0.Length)] := v80];
		r1 := fm68(if (true in v91) then v91[true] else p1, v0[safeIndex(365, v0.Length)], globalState);
	}
}
...
class C7 extends T1 {
	...
	function fm35(globalState: GlobalState): int {
		-(safeDivisionInt(603, |{false}|) + -|([|[true]|] + (seq(abs(0x13e), i0  => (|[|[0x360]|]|))))|)
	}
	function fm36(p0: bool, globalState: GlobalState): bool {
		!(|"twmiui"| >= (|[|(seq(abs(972), i0  => (f14)))|, 0x28d]| * 49))
	}
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		r1 := p0;
		r1 := p0;
		var v0: array<char> := new char[18](i0 => if (p1) then 'b' else f14);
		v0[safeIndex(309, v0.Length)] := 'y';
		v0[safeIndex(309, v0.Length)] := f14;
		for i1 := safeModuloInt(p0, -0xce) to safeModuloInt(0x25e, |[p1, p1]|) {
			...
			match (DC6(!true, p1, f14, i1, v3.f17).(cf11 := !v3.f17)) {
				case DC6(cf10, cf11, cf12, cf13, cf14) =>
					...
					var v7 := new C3(v4 + v4, (seq(abs(0xb6), i2  => (cf13))) < v6, v1);
					var v8: array<bool> := new bool[3] [cf14, p1, p1 ==> cf11];
					var v9: multiset<bool> := multiset{true};
					v8[safeIndex(259, v8.Length)] := multiset{v3.f17, !v7.f16} !! v9;
					v8[safeIndex(259, v8.Length)] := v3.f17 <== cf14;
					...
					var v15 := DC21(v8[safeIndex(259, v8.Length)], if (|(if (|v13| in v12) then v12[|v13|] else [true])| in v10) then v10[|(if (|v13| in v12) then v12[|v13|] else [true])|] else v14, v7.f16, 0x1f2);
					v15 := v15.(cf34 := cf11, cf33 := map[v8[safeIndex(259, v8.Length)] := cf11]);
					...
					var v19 := new C2(i1 != -(if (v11[safeIndex(|v18|, |v11|)] in v16) then v16[v11[safeIndex(|v18|, |v11|)]] else cf13));
				case DC7(cf15, cf16) =>
					...
					var v26: array<int> := new int[13] [v3.fm41(p0, i1, true, v3.f17, globalState), |(v22 + v22)|, p0, i1, 0x286, i1, i1, --i1, |v24[p1 := v23]|, |v25[fm35(globalState) := v21]|, p0, |v21[safeIndex(|v21|, |v21|) := 'h']| + p0, p0];
					v26[safeIndex(777, v26.Length)] := p0;
					v26[safeIndex(777, v26.Length)] := p0;
				...
				case DC5(cf9) =>
					...
					var v36 := "lwtan";
					v35[safeIndex(896, v35.Length)] := (v36 + v36)[safeIndex(p0, |(v36 + v36)|) := fm43(globalState)];
					var v37: seq<array<bool>> := [v30];
					v30, v34, v35[safeIndex(896, v35.Length)] := v37[safeIndex(i1, |v37|)], v34, (v36 + v36) + v36;
					var v38 := new C4();
					var v39 := new C4();
				case DC8(cf17) =>
					r1 := safeModuloInt(p0, p0);
					var v40: array<int> := new int[3] [i1, p0, p0];
					v40[safeIndex(173, v40.Length)] := i1;
					var v41: array<multiset<int>> := new multiset<int>[11];
					v41[safeIndex(514, v41.Length)] := multiset{i1};
					var v42 := "tbh";
					var v43 := DC17();
					...
					var v49: seq<seq<string>> := [[v42], ["okpfu"], if (v46 in v48) then v48[v46] else seq(abs(0x310), i3  => ("inf")), v47];
					var v50 := DC37(p1, v44, v42, i1);
					var v51: multiset<int> := multiset{i1};
					r1, v40[safeIndex(173, v40.Length)], r1, r1, v41[safeIndex(514, v41.Length)] := p0, |v49[safeIndex(v50.cf67, |v49|)]|, safeDivisionInt(p0, i1), p0, if (p0 != --i1) then v51 else v51;
					v40[safeIndex(173, v40.Length)] := v40[safeIndex(173, v40.Length)];
					v42 := v50.cf66;
			}
			...
			v58[safeIndex(152, v58.Length)] := -0x1b8 > i1;
			var v59: seq<bool> := [p1];
			var v60: multiset<int> := multiset{|v59|};
			var v61: set<int> := {|map[p0 := !(if (|v60| in v52) then v52[|v60|] else v57)]|, i1};
			v56, v57, v58[safeIndex(152, v58.Length)], r1 := v56, p1, v61 <= ({p0} + v61), i1;
		}
		var i5 := 0;
		while (p1 <==> (p1 <== p1))
			decreases 100 - i5
		{
			...
			v63[safeIndex(125, v63.Length)] := 0x3ca;
			v63[safeIndex(125, v63.Length)] := p0;
			var v64: seq<bool> := [p1];
			var v65: seq<int> := [p0, |v64|, v63[safeIndex(125, v63.Length)]];
			var v66: map<int, bool> := map[750 := p1];
			v62 := -v65[safeIndex(|v66|, |v65|)] > v63[safeIndex(125, v63.Length)];
			v62 := p1 <==> (fm1(fm1(p1, v63[safeIndex(125, v63.Length)], globalState), 155, globalState) <==> v62);
		}
		var v67 := false;
		v67 := p1;
		r0 := f14;
	...
	method m21(p0: D2, p1: bool, globalState: GlobalState) returns (r0: seq<int>, r1: int, r2: array<int>, r3: int) {
			...
			decreases 100 - i0
		{
			...
			var v1 := true;
			var v2 := "yeiu";
			var v3: map<string, bool> := map[("lcdpehg")[safeIndex(v0, |"lcdpehg"|) := f14] + v2 := v1];
			var v4: seq<bool> := [p1, v1];
			var v5: array<bool> := new bool[20] [p1, true, true, p1, v1, true, p1, v1, p1, v1, v1, p1, p1, p1, p1, v1, v1, p1, p1, v4[safeIndex(v0, |v4|)]];
			...
			v5[safeIndex(238, v5.Length)] := fm7(fm1(v15.cf79, |"jr"|, globalState), "gwra", v16, globalState);
			v1, v5[safeIndex(238, v5.Length)] := p1, v1;
		}
		var v17 := true;
		v17 := v17;
		...
		match (DC48(v19)) {
			case DC49(cf90, cf91, cf92) =>
				...
				v20[safeIndex(505, v20.Length)] := v21;
				r1, v20[safeIndex(505, v20.Length)] := cf91, v21;
				var v22: multiset<int> := multiset{cf91};
				var v23: multiset<bool> := multiset{v17};
				var v24: array<bool> := new bool[8] [p1, p1, p1, v22 > v22, !v17, !(!v17 in v23[v17 := abs(cf91)]), v17, p1];
				var v25 := DC3(f14);
				var v26 := DC3(v25.cf7);
				var v27: multiset<D1> := multiset{v25};
				v24[safeIndex(631, v24.Length)] := v27 > v27;
				...
				var v32: seq<int> := [v0];
				var v33: map<int, map<bool, int>> := map[if (f14 in v30) then v30[f14] else cf91 := if (|v32| in v31) then v31[|v32|] else v20[safeIndex(505, v20.Length)]];
				var v34 := "jv";
				v24[safeIndex(631, v24.Length)], r3, r1, v21 := v23 > fm2(f14, v17, !false, cf90, globalState), safeDivisionInt(DC1(v24, cf91, v17, v28, true).cf2, cf91), -((if (p1) then cf91 else DC45(v0, v17, DC34()).cf84) * safeDivisionInt(|v29|, |{v17}|)), if ((|v34| + -0x1c0) in v33) then v33[|v34| + -0x1c0] else v21;
				var v35: array<D18> := new D18[24];
				var v36: seq<array<D18>> := [v35, v35, v35];
				var v37: array<array<D18>> := new array<D18>[20] [v36[safeIndex(v0, |v36|)], v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35, v35];
				v37[safeIndex(589, v37.Length)] := v35;
				var v38: map<bool, bool> := map[v24[safeIndex(631, v24.Length)] := p1];
				var v39: seq<array<bool>> := [v24, v24];
				v0, v37[safeIndex(589, v37.Length)], v17, v0 := -|(v38 + v38)|, v35, v24 !in (v39 + v39), cf91;
			case DC50(cf93, cf94, cf95) =>
				...
				v42[safeIndex(709, v42.Length)] := v41;
				...
				var v47: seq<int> := [v0];
				v42[safeIndex(709, v42.Length)] := fm49(cf95, if (|v47| in v46) then v46[|v47|] else |v44|, v40, globalState);
			case DC51(cf96, cf97, cf98, cf99, cf100) =>
				...
				if (p1) {
					...
					var v55: map<seq<int>, bool> := map[seq(abs(0xd2), i1  => (|v51|)) := v17];
					var v57: map<string, seq<int>> := map[v50 := seq(abs(0x1de), i2  => (-cf98))];
					...
					v61[safeIndex(496, v61.Length)] := v54 * v54;
					var v62: array<multiset<bool>> := new multiset<bool>[22];
					v52, v61[safeIndex(496, v61.Length)], v62 := v52, v54, v62;
					v17 := fm1(if (v17) then cf96 else p1, 0x3d0, globalState);
					v48[safeIndex(937, v48.Length)] := p1 <== p1;
					v48[safeIndex(937, v48.Length)] := true;
					cf96 := cf98 > cf98;
					v50 := v52.cf77;
				} else {
				...
				v48[safeIndex(568, v48.Length)] := v17;
				v48[safeIndex(568, v48.Length)] := cf96;
				var v67: map<bool, bool> := map[p1 := !(p1 ==> true)];
				v67 := v67[cf96 := true];
			case DC48(cf89) =>
				var v68 := DC17();
				var v69: seq<bool> := [v17];
				var v70 := DC5(v69[safeIndex(v0, |v69|) := false]);
		...
		v75[safeIndex(35, v75.Length)] := v76;
		v75[safeIndex(35, v75.Length)] := v76;
		var i3 := 0;
			...
			decreases 100 - i3
		{
			...
			var v81: seq<int> := [|v80[safeIndex(v0, |v80|)]|, v0];
			v77 := v77[if (v17 in v78) then v78[v17] else fm3(v17, globalState) := v81[safeIndex(|v79|, |v81|)]];
			var v82 := DC15(v0, v75[safeIndex(35, v75.Length)], p1);
			var v83: set<seq<int>> := {[v0, v0]};
			var v84: array<bool> := new bool[10] [v82.cf25 in [p1, v17, v17, false, v17], p1, !v17, |fm4(v17, -v0, |v79|, |[v17, p1, p1, p1, !v17]|, globalState)| < |(seq(abs(-0x224), i4  => (f14)))|, !v17, v17 || v17, v0 > v0, v17, p1, v81 in v83];
			v84[safeIndex(800, v84.Length)] := v17;
			v84[safeIndex(800, v84.Length)] := p1 ==> true;
			v17 := !!v17;
			var v85: array<int> := new int[20](i5 => i5 * |multiset{v0}|);
			v85[safeIndex(536, v85.Length)] := -v0;
			...
			v85[safeIndex(536, v85.Length)], r1, v0, r1, r1 := -(|v86[safeIndex(|v87|, |v86|)]| * v0), -(safeDivisionInt(v0, |v88|) + |v87|), -safeModuloInt(v0, |v88[|v89| := abs(v0)]| * |v90|), -85, v0;
		}
		r0 := [v0, safeModuloInt(v0, v0)];
		var v91 := "bmlcfooev";
		r1 := v0 - -safeModuloInt(|fm75(fm36(!p1, globalState), globalState)|, |v91|);
		var v92: array<int> := new int[22];
		r2 := v92;
		var v93: seq<seq<bool>> := [v76, v75[safeIndex(35, v75.Length)]];
		var v94: map<bool, int> := map[true := v0];
		r3 := safeDivisionInt(|(v93[safeIndex(v0, |v93|)] + v76)|, if (v17 in v94) then v94[v17] else v0);
	}
	method m22(globalState: GlobalState) returns (r0: int) {
		...
		if (if (v0) then !((if (|v5| in v4) then v4[|v5|] else v0) <==> !v0) else fm1(v0, 104, globalState)) {
			...
			var v10: array<int> := new int[26] [if (v0) then v1 else 0x97, v1, v1, safeDivisionInt(v1, |v6|), v1, v1, v1, if (v1 in v7) then v7[v1] else |v8|, v1, v1, v1, |v6| * |v9|, v1, v1, v1, safeDivisionInt(v1, v1), fm3(v0, globalState) - v1, safeModuloInt(v1, 0x1b6), v1, -0x34f, v1, v1, fm35(globalState), v1, safeDivisionInt(v1, v1), v1];
			v10[safeIndex(403, v10.Length)] := 0x26f;
			v10[safeIndex(403, v10.Length)] := v1;
			v6 := v6;
			var v11: map<bool, D4> := map[v0 := DC13()];
			v11 := v11;
			v2 := v2;
			v2[safeIndex(560, v2.Length)] := v0;
			v2[safeIndex(560, v2.Length)] := v0;
		} else {
			v0 := v0;
			var v12: set<int> := {v1};
			...
			v1 := if (v0) then safeDivisionInt(v1, v1) else if (true) then v1 else 0x50;
			var v14: seq<bool> := [v0];
			var v15: set<seq<bool>> := {v14, v14[safeIndex(v1, |v14|) := false]};
			...
			var v22 := "hayt";
			var v23: seq<int> := [v1];
			var v24: array<int> := new int[25] [v1, |v13[|v15| := abs(v1)]|, safeDivisionInt(v1, v1), v1, v1, -(if (v13 in v21) then v21[v13] else v1), v1, v1, v1, 694, |v22|, |(if (v0) then v14 else v14)|, |v4|, v1, v1, safeModuloInt(v1, fm35(globalState)), v1, safeDivisionInt(-0x3ab, v1), |(if (v0) then v23 else seq(abs(0x393), i0  => (|(seq(abs(0x50), i1  => (v5)))|)))|, |v22|, |(v12 * {v1})|, v1, v1, v1, fm3(v0, globalState)];
			v24[safeIndex(554, v24.Length)] := -v1;
			v24[safeIndex(554, v24.Length)] := v1;
			v0 := (v23 + v23) != v23;
		}
		
		for i2 := v1 to safeDivisionInt(v1, v1) {
			...
			match (v26) {
				...
				case DC38(cf68) =>
					...
					v41[safeIndex(289, v41.Length)] := [v2];
					...
					v41[safeIndex(289, v41.Length)], v39.f15 := v40[safeIndex(-151 + -|v43|, |v40|) := v44.cf1], fm40(|fm47(globalState)|, globalState);
					var v45: map<set<string>, int> := map[fm76(globalState) := v1];
					var v46: set<string> := {seq(abs(0x2b1), i4  => (f14)), v39.f15, v39.f15, v39.f15, v39.f15};
					v45 := v45[v46 * v46 := v1];
			}
			
			var v47: array<int> := new int[6](i5 => i5 + i2);
			v47[safeIndex(255, v47.Length)] := i2;
			var v48: map<bool, array<int>> := map[v0 := v47];
			v47[safeIndex(255, v47.Length)] := |((v48 + v48) + map[!v0 := v47])|;
		}
		v5 := fm49(v1, -v1, v1, globalState) + v5[v0 := v0];
		var v49: seq<int> := [v1, v1];
		v5 := v5[(seq(abs(849), i6  => (0x168))) != v49 := !(if (!v0) then false else false)];
		var v50 := DC53(v0, v1);
		v0 := !!match v50 {
			...
			decreases 100 - i7
		{
			...
			if (v0) {
				...
				v1 := safeModuloInt(v1, |v60|) + (if (if (v0 in v5) then v5[v0] else v0) then v1 else v1);
				var v61 := "qsr";
				r0 := v49[safeIndex(safeDivisionInt(v1, |v61|), |v49|)];
			} else {
				var v62: map<seq<int>, int> := map[v49 := v1];
				v62 := v62;
				var v63: array<array<bool>> := new array<bool>[14];
				v63 := if (v51[safeIndex(v1, |v51|)]) then v63 else v63;
				...
				var v69 := "hgc";
				var v70: array<int> := new int[22] [fm35(globalState), v1 + v1, |(v65 + v65)|, safeDivisionInt(v1, |[v1]|), |v66|, v1, |v67|, v1, if (v0) then 0x334 else if (|fm0(v0, |v68|, false, globalState)| in v67) then v67[|fm0(v0, |v68|, false, globalState)|] else v1, v1, -v1, v1, |(v69 + v69)|, 0x3ce, v1, |[v0]|, v1, v1, v1, 0x215 - v1, -v1, v1];
				v70 := v70;
			}
			
			var v71 := "xnifrrss";
			v71 := "cyfeevjva";
			v2[safeIndex(246, v2.Length)] := v0;
			v2[safeIndex(246, v2.Length)], v0 := v0, v0;
			var v72 := DC13();
...
class C8 {
	...
	method m19(p0: int, globalState: GlobalState) returns (r0: bool, r1: seq<bool>, r2: int, r3: int) {
		...
		if (!f12) {
			...
			v1[safeIndex(826, v1.Length)] := !!fm1(f12, p0, globalState);
			r0, v1[safeIndex(826, v1.Length)] := fm1(f12, p0, globalState), f12;
			v1[safeIndex(826, v1.Length)] := f12;
			var v2: set<bool> := {!v1[safeIndex(826, v1.Length)]};
			var v3: seq<set<bool>> := [v2, {f12}];
			var v4: seq<set<bool>> := [v3[safeIndex(p0, |v3|)], v2, {f12}, v2];
			var v5 := DC19([{v1[safeIndex(826, v1.Length)], v1[safeIndex(826, v1.Length)], v1[safeIndex(826, v1.Length)]}, v2]);
			v3 := v3 + v5.cf28;
			var v6: multiset<bool> := multiset{v1[safeIndex(826, v1.Length)]};
			...
			var v11: seq<bool> := [v1[safeIndex(826, v1.Length)], v1[safeIndex(826, v1.Length)] <==> f12];
			r1 := v11;
		} else {
			...
			if ({p0} >= v12) {
				...
				v17[safeIndex(624, v17.Length)] := |(seq(abs(0x8c), i0  => ('i')))| - p0;
				var v18: seq<int> := [p0, p0];
				v17[safeIndex(624, v17.Length)] := -v18[safeIndex(p0, |v18|)];
				var v19: array<bool> := new bool[9];
				v19[safeIndex(413, v19.Length)] := f12;
				v19[safeIndex(413, v19.Length)] := f12;
				f12 := !v19[safeIndex(413, v19.Length)];
			} else {
				var v20 := "wvovo";
				v20 := "tcpunm";
				r3 := p0;
				...
				var v27: seq<D0> := [v26];
				var v28: multiset<seq<D0>> := multiset{v27[safeIndex(-0x3cd, |v27|) := v26]};
				var v29: map<bool, bool> := map[v28 <= v28 := f12];
				v29 := v29[false := v21[safeIndex(p0, |v21|)]];
			}
			...
			v35[safeIndex(508, v35.Length)] := p0;
			v35[safeIndex(508, v35.Length)] := p0;
		}
		...
		var i2 := 0;
		while (-p0 <= safeDivisionInt(p0, |v36|))
			decreases 100 - i2
		{
			if (i2 >= 100) {
				break;
			...
			v46[safeIndex(941, v46.Length)] := v42;
			v46[safeIndex(941, v46.Length)] := fm34(fm32(|v43|, f12, globalState), f12, globalState);
		}
		for i3 := p0 - 0x146 to safeDivisionInt(p0, |"qidfutkuq"|) {
			f12 := i3 <= safeModuloInt(i3, i3);
			var v47 := "iaxxpykpd";
			var v48 := 'l';
			...
			var v56: array<int> := new int[23] [i3 * i3, p0 * p0, p0, -p0, p0, p0, |(v47[safeIndex(i3, |v47|) := v49.cf12] + v47)[safeIndex(i3, |(v47[safeIndex(i3, |v47|) := v49.cf12] + v47)|) := v48]|, i3, safeDivisionInt(|v50|, |v51|), |v53|, i3, i3, p0, p0, if (f12) then |v55| else i3, i3 * |v36|, |v47|, if (-0x20c in v52) then v52[-0x20c] else p0, p0 + i3, p0, i3, safeDivisionInt(i3, p0), -p0];
			v56[safeIndex(851, v56.Length)] := p0;
			v56[safeIndex(851, v56.Length)] := i3;
			var v57: seq<int> := [safeModuloInt(|(seq(abs(0x37), i4  => ('w')))|, p0), i3 + p0, safeDivisionInt(p0, p0)];
			v56[safeIndex(851, v56.Length)] := v57[safeIndex(|DC18(v52).cf27|, |v57|)];
			if (p0 < safeModuloInt(i3, v56[safeIndex(851, v56.Length)])) {
				var v58: seq<map<int, int>> := [map[|v54| := i3], v51];
				v56[safeIndex(851, v56.Length)] := if (v58 == v58) then v56[safeIndex(851, v56.Length)] else p0;
				v47 := v47;
				v56 := v56;
				var v59: map<bool, multiset<bool>> := map[f12 := v55];
				var v60: set<bool> := {f12};
				var v61: array<bool> := new bool[16] [false, f12 && false, f12, !f12, if (f12) then f12 else f12, 0x5f != v56[safeIndex(851, v56.Length)], !f12, f12, if (f12) then f12 else false, v55 == (if (f12 in v59) then v59[f12] else v55), f12, v56[safeIndex(851, v56.Length)] <= i3, v56[safeIndex(851, v56.Length)] >= -|v60|, fm1(f12, p0, globalState), true, f12];
				...
				var v67: map<set<int>, int> := map[{|v52[v56[safeIndex(851, v56.Length)] := abs(v56[safeIndex(851, v56.Length)])]|, v57[safeIndex(i3, |v57|)], i3} * v66[safeIndex(v56[safeIndex(851, v56.Length)], |v66|)] := p0];
				v67 := if (true) then v67 else v67;
				var v68: array<bool> := new bool[7];
				v68[safeIndex(252, v68.Length)] := v48 !in v47;
				v68[safeIndex(252, v68.Length)] := !false;
				var v69 := new C4();
				var v70 := DC10();
				var v71: set<D3> := {v70, DC10()};
				var v72: map<set<D3>, int> := map[v71 := v56[safeIndex(851, v56.Length)]];
				v72 := v72[v71 := safeDivisionInt(v56[safeIndex(851, v56.Length)], 0x215)];
			}
			...
			decreases 100 - i5
		{
			...
			var v77 := DC53(fm1(f12, |(seq(abs(312), i6  => ('m')))|, globalState), p0);
	...
	method m20(p0: bool, p1: int, globalState: GlobalState) {
		...
		var v1: array<bool> := new bool[3] [p1 >= p1, true <== f12, !v0[safeIndex(0xff, |v0|)]];
		v1 := v1;
		var v2 := 623;
		v2 := p1;
		v1[safeIndex(55, v1.Length)] := f12;
		v1[safeIndex(55, v1.Length)] := f12 <==> true;
		v2 := p1;
		if (f12) {
			var v4 := DC26(set v3 : int | (224 <= v3) && (v3 < 0x21c) :: (v3 * |(seq(abs(628), i0  => (v2)))|));
			var v5: set<D9> := {v4};
			var v6: multiset<set<D9>> := multiset{v5};
			var v7 := "muy";
			var v8: map<int, array<bool>> := map[v2 := v1];
			var v9 := DC40(v8);
			var v10: multiset<bool> := multiset{p0, fm62(p1, v1[safeIndex(55, v1.Length)], v6, globalState) <= v7, v2 != |map[v2 := v9]|};
			v10 := v10;
			if (!!v1[safeIndex(55, v1.Length)]) {
				var v11: array<int> := new int[22];
				v11[safeIndex(989, v11.Length)] := p1;
				var v12: set<string> := {v7, v7};
				var v13 := DC44(f12, f12, p0);
				var v14: array<D16> := new D16[4] [v13, v13, v13, DC44(f12, false, p0)];
				v14[safeIndex(502, v14.Length)] := fm77(globalState);
				var v15: map<char, bool> := map['l' := p0];
				var v16 := DC53(p0, v2);
				var v18 := 'r';
				v11[safeIndex(989, v11.Length)], v12, v14[safeIndex(502, v14.Length)], v15, f12 := v16.cf103, v12, v13, (map v17 : char | v17 in (seq(abs(260), i1  => ('l'))) :: (v17) := (p0)) + map[v18 := f12], v1[safeIndex(55, v1.Length)];
				var v19: set<char> := {v18, v18};
				var v20 := DC31(safeDivisionInt(p1, p1), f12, v11[safeIndex(989, v11.Length)], v11[safeIndex(989, v11.Length)], |(v19 + {v18, v18, 'o', v18})|);
				v20 := v20;
				v1[safeIndex(55, v1.Length)] := v1[safeIndex(55, v1.Length)];
				v7 := "n" + (v7 + v7);
				var v21 := new C3(v7, true, {p0});
			} else {
				var v22: map<int, int> := map[p1 := v2];
				var v23: multiset<int> := multiset{-(if (fm3(v1[safeIndex(55, v1.Length)], globalState) in v22) then v22[fm3(v1[safeIndex(55, v1.Length)], globalState)] else p1)};
				v23 := v23;
				...
				v1[safeIndex(55, v1.Length)], v28, v1[safeIndex(55, v1.Length)], v1[safeIndex(55, v1.Length)] := v1[safeIndex(55, v1.Length)], v28, f12 ==> fm1(v1[safeIndex(55, v1.Length)], fm32(|v29|, v1[safeIndex(55, v1.Length)], globalState), globalState), !v1[safeIndex(55, v1.Length)];
				v2 := v2;
			}
			...
			var v33 := DC3('r');
			var v35 := DC7(p0, set v34 : D1 | v34 in v32[safeIndex(p1, |v32|) := v33] :: (v34));
			v1[safeIndex(55, v1.Length)] := v35.cf15;
			var v36: map<bool, bool> := map[fm1(!p0, p1, globalState) := v1[safeIndex(55, v1.Length)]];
			var v37: seq<int> := [|v10|, |v36|];
			v1[safeIndex(55, v1.Length)], v7, v37, v2 := f12, v7, if (v1[safeIndex(55, v1.Length)]) then [v2, p1, v2] + v37 else v37 + fm66(globalState), v2;
			var v38: set<int> := {556};
			var v39: seq<set<int>> := [v38, v38, v38, v38];
			var v40 := DC48(v39);
			var v41: map<int, D18> := map[|(v0[safeIndex(v2, |v0|) := p0] + v0)| := v40];
			v41 := v41[v2 := DC48(v39[safeIndex(p1, |v39|) := v38])];
		} else {
			var v42 := "rfyahcgjs";
			v42 := v42;
			if (!p0) {
				...
				v46[safeIndex(681, v46.Length)] := -p1;
				v46[safeIndex(681, v46.Length)] := safeDivisionInt(fm32(fm3(p0, globalState), p0, globalState), fm32(v2, v1[safeIndex(55, v1.Length)], globalState));
				var v47: array<array<bool>> := new array<bool>[4];
				v47 := v47;
				v2 := v46[safeIndex(681, v46.Length)];
				var v48: seq<int> := [v2];
				v46[safeIndex(681, v46.Length)] := safeModuloInt(0xf9, v48[safeIndex(467, |v48|)]);
				v46[safeIndex(681, v46.Length)] := |"dphh"|;
			}
			
			var v49: array<int> := new int[18];
			v49 := v49;
			v49[safeIndex(476, v49.Length)] := v2;
			var v50: array<string> := new string[14](i3 => v42);
			var v51 := DC59(f12, p1);
			v49[safeIndex(476, v49.Length)], v2, v1[safeIndex(55, v1.Length)], v50, v42 := p1, -(v51.cf112 * p1), p0, v50, if (fm1(f12, p1, globalState)) then v42 else v42 + v42;
			var v52: seq<int> := [v49[safeIndex(476, v49.Length)], p1, v2];
			var v53 := DC23(multiset(fm78(0x17d, v52, v2, globalState)));
			var v54: set<bool> := {p0};
			var v55: map<int, set<bool>> := map[v49[safeIndex(476, v49.Length)] := v54];
			var v56 := new C1(fm61(0x12b, p0, v2, v53, globalState), if (v49[safeIndex(476, v49.Length)] in v55) then v55[v49[safeIndex(476, v49.Length)]] else v54);
		}
		...
		match (v57) {
			case DC17() =>
				...
				v2 := p1;
				var v58 := 'u';
				var v59 := DC8(DC6(!v1[safeIndex(55, v1.Length)], p0, v58, v2, p0));
				var v60 := DC8(v59);
				match (if (f12) then v60 else v60) {
					case DC6(cf10, cf11, cf12, cf13, cf14) =>
						...
						v2, cf13, cf13, v1[safeIndex(55, v1.Length)], cf11 := -(cf13 * v2), cf13, |fm79(p1, safeDivisionInt(|v62|, -|v63[safeIndex(|v64|, |v63|) := v58]|), globalState)|, v0 < (if (cf14) then v0 else v0), cf11;
						v1[safeIndex(55, v1.Length)] := f12 in v0;
						var v65: multiset<string> := multiset{v63};
						cf10 := v65 == (v65 + multiset{fm47(globalState)});
					case DC7(cf15, cf16) =>
						var v66 := DC1(v1, -v2, v1[safeIndex(55, v1.Length)], map[f12 := v58], v1[safeIndex(55, v1.Length)]);
						...
						v67[safeIndex(489, v67.Length)] := v60;
						v67[safeIndex(489, v67.Length)] := v60;
					case DC5(cf9) =>
						v2 := p1;
						var v68 := "srhhmnppt";
						v1[safeIndex(55, v1.Length)] := v2 < -safeModuloInt(|v68|, v2);
						v2 := p1;
						v58 := v58;
					case DC8(cf17) =>
						var v69: array<int> := new int[21](i4 => safeModuloInt(i4, v2));
						v69 := v69;
						var v70: set<int> := {v2, v2};
						var v71: seq<set<int>> := [v70];
						var v72 := DC48(v71);
						var v73 := DC48(fm56(fm3(v1[safeIndex(55, v1.Length)], globalState), globalState) + v72.cf89);
						v72 := v72;
						v69[safeIndex(861, v69.Length)] := p1;
						var v74: map<int, int> := map[p1 := |(seq(abs(-0x23e), i5  => (v58)))|];
						var v75 := DC20(v58, v1[safeIndex(55, v1.Length)], v74);
						var v76: map<bool, bool> := map[p0 := v1[safeIndex(55, v1.Length)]];
						v69[safeIndex(861, v69.Length)], v1[safeIndex(55, v1.Length)], v58, v69, v2 := p1, p0, v75.cf29, if (!(if (v1[safeIndex(55, v1.Length)]) then if (f12 in v76) then v76[f12] else v1[safeIndex(55, v1.Length)] else !f12)) then v69 else v69, |"pfm"| - p1;
			...
			case DC16(cf26) =>
				if (p0) {
					...
					v81[safeIndex(128, v81.Length)] := v2;
					v81[safeIndex(128, v81.Length)] := p1;
					var v82 := "evoytisib";
					v81[safeIndex(128, v81.Length)] := |v82|;
					v81[safeIndex(128, v81.Length)] := p1;
				} else {
					var v83: seq<int> := [p1];
					var v84: map<bool, seq<int>> := map[v1[safeIndex(55, v1.Length)] := v83];
					v84 := v84[!v1[safeIndex(55, v1.Length)] := v83];
					var v85 := "pworj";
					v85 := "dllcxp";
					var v86: map<int, int> := map[-p1 := 0x3ca];
					v2 := safeModuloInt(if (fm3(v1[safeIndex(55, v1.Length)], globalState) in v86) then v86[fm3(v1[safeIndex(55, v1.Length)], globalState)] else v2, p1);
					var v87: set<int> := {v2, |map[v1 := v2]|, v2, p1, v2};
					var v88: map<int, set<int>> := map[fm32(v2, p0, globalState) := v87];
					var v89: array<int> := new int[7] [v2 + v2, v83[safeIndex(|(if (v2 in v88) then v88[v2] else v87)|, |v83|)], v2, 0x162, v2 + |v85|, v2, v2];
					v89[safeIndex(738, v89.Length)] := v2;
					var v90: multiset<string> := multiset{v85};
					var v91 := 'n';
					var v92: array<string> := new string[25] [v85, v85[safeIndex(|v90|, |v85|) := v91], "snmwbvhs", v85, "elhqbotp" + (seq(abs(0x35f), i7  => (v91))), v85[safeIndex(v2, |v85|) := v91] + "lqvpf", v85, v85[safeIndex(v2, |v85|) := v85[safeIndex(p1, |v85|)]], v85, v85 + "dlpcyjnm", v85, v85, v85, v85 + v85, v85 + v85, v85, v85, v85 + v85, v85, v85 + v85, "vvhahu" + v85, v85, v85 + v85, v85, "vixe"];
					v92[safeIndex(789, v92.Length)] := v85;
					var v93: multiset<bool> := multiset{f12};
					v89[safeIndex(738, v89.Length)], v92[safeIndex(789, v92.Length)] := if (f12 in v93) then v93[f12] else v2 * |v85|, v85;
					v1[safeIndex(55, v1.Length)] := v0[safeIndex(p1, |v0|)];
				}
				
				var v94: multiset<bool> := multiset{fm1(v1[safeIndex(55, v1.Length)], p1, globalState)};
				var v95 := "rptf";
				var v96: map<int, string> := map[safeModuloInt(p1, |v94|) := v95];
				v96 := v96[v2 := v95];
				var v97 := DC27(v94, fm3(v1[safeIndex(55, v1.Length)], globalState));
				v1[safeIndex(55, v1.Length)] := v94 > (v94 - v97.cf46);
				var v98 := DC9(v96 + v96);
				match (v98) {
					case DC10() =>
						...
						var v102 := 'q';
						v102 := v95[safeIndex(safeModuloInt(v2, v2), |v95|)];
						v1[safeIndex(55, v1.Length)] := f12;
					case DC9(cf18) =>
						v1[safeIndex(55, v1.Length)] := true;
						var v103: map<bool, bool> := map[v0[safeIndex(v2, |v0|)] := p0];
						v103 := v103[v1[safeIndex(55, v1.Length)] := true];
						v2 := -p1;
						var v104: array<int> := new int[3](i8 => i8 + p1);
						v104[safeIndex(578, v104.Length)] := v2 * v2;
						v104[safeIndex(578, v104.Length)] := -p1;
					case DC11(cf19) =>
						var v106: set<bool> := {v1[safeIndex(55, v1.Length)], p0};
						var v107: set<int> := {p1, v2, |v106|};
						var v108: set<int> := {p1, |v107|, v2};
						var v109 := 'l';
						var v110: map<int, char> := map[v2 := v109];
						var v111: map<int, map<int, char>> := map[p1 := (map v105 : int | v105 in v107 :: (safeDivisionInt(v105, |v106|)) := ('c')) + v110];
						...
						v111, v1[safeIndex(55, v1.Length)], v1[safeIndex(55, v1.Length)] := v111, p0, if ((v2 * |v114|) in v112) then v112[v2 * |v114|] else v0[safeIndex(|v116|, |v0|)];
...
class C9 extends T1 {
	...
	function fm29(globalState: GlobalState): bool {
		match DC16(map[{!false} := DC3('a')]) {
			case DC17() => |"wreneun"| >= |['i']|
			case DC16(cf26) => 0xd9 == -|(set v0 : int | (0x192 <= v0) && (v0 < 0x197) :: (safeModuloInt(v0, 0x355)))|
		}
	}
	...
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		...
		if (fm1(v0, fm3(v0, globalState), globalState)) {
			...
			v3[safeIndex(109, v3.Length)] := p0;
			var v4 := 'e';
			var v5 := DC6(v0, p1, v4, p0, v0);
			v3[safeIndex(109, v3.Length)] := v5.cf13;
			v0 := p0 != p0;
			v5 := v5.(cf13 := |[v4, v4]|);
			var v6: map<bool, seq<D2>> := map[p1 := fm31(globalState)];
			var v7 := DC6(v0, false, v4, v3[safeIndex(109, v3.Length)], p1);
			var v8 := DC8(v7);
			var v9: seq<D2> := [v8];
			v6 := v6[p1 := v9];
		} else {
			...
			var v11 := 'j';
			v10[safeIndex(411, v10.Length)] := v11;
			v10[safeIndex(411, v10.Length)] := v11;
			v0 := p1;
			v0 := !v0;
			var v12 := DC3('w');
			...
			v13 := v14[safeIndex(p0, |v14|)];
			var v15: array<bool> := new bool[24];
			var v16 := DC1(v15, safeModuloInt(|"qhr"|, p0), v0, map[p1 := v11], p1);
			v16 := v16;
		}
		...
		if (v0) {
			...
			var v18: array<int> := new int[25](i2 => safeDivisionInt(i2, p0));
			var v19 := "mwtt";
			var v20: multiset<int> := multiset{|v19|};
			var v21 := DC18(v20);
			v17, v0, v0, v18 := v17, p1, (v20 >= v21.cf27[p0 := abs(p0)]) <== false, v18;
			v0 := (p0 + p0) <= 755;
			var v22: map<bool, int> := map[p1 := fm3(v0, globalState)];
			var v23: map<string, map<bool, int>> := map[seq(abs(0x28b), i3  => ('q')) := v22];
			v23 := map[seq(abs(0x191), i4  => ('m')) := v22];
			var v24 := 'w';
			var v25 := new C7(v24);
			v19 := v19;
		} else {
			...
			v26[safeIndex(467, v26.Length)] := (if (p0 in v28) then v28[p0] else map[p0 := v29]) != v27;
			v26[safeIndex(467, v26.Length)] := !false;
			var v30 := "wixps";
			var v31: array<string> := new string[19];
			v31[safeIndex(535, v31.Length)] := v30;
			var v32 := 'l';
			var v33: map<string, string> := map[v30 := v30[safeIndex(p0, |v30|) := v32]];
			var v34: map<bool, bool> := map[p0 == p0 := fm7(p1, v30, v33, globalState)];
			v31[safeIndex(795, v31.Length)] := v30;
			v30, v31[safeIndex(535, v31.Length)], v26[safeIndex(467, v26.Length)], v34, v31[safeIndex(795, v31.Length)] := v30, v30, p1, v34, fm6(v0, -0x31c * p0, globalState);
			var v35: multiset<bool> := multiset{true, v0, false, v0};
			var v36: seq<multiset<bool>> := [v35, v35];
			v35 := v36[safeIndex(p0, |v36|)];
			var v37: array<int> := new int[6];
			v37[safeIndex(339, v37.Length)] := safeDivisionInt(p0, p0);
			v37[safeIndex(339, v37.Length)] := 0x388;
			r1 := v37[safeIndex(339, v37.Length)];
		}
...
class C10 {
	...
	method m17(p0: D2, p1: int, globalState: GlobalState) {
		for i0 := p1 to p1 {
			...
			var v2: multiset<int> := multiset{if (f9 in v0) then v0[f9] else -0x21b, safeModuloInt(i0, p1), (if (i0 in v1) then v1[i0] else i0) - p1};
			var v3: array<int> := new int[3];
			var v4: multiset<bool> := multiset{!f9};
			v3[safeIndex(995, v3.Length)] := |v4|;
			var v5 := false;
			var v6 := 0x142;
			v1, v3[safeIndex(995, v3.Length)], v5, v5, v6 := v2[v6 := abs(i0)], fm3(v5, globalState), v5, f9, fm3(true, globalState);
			var v7 := "yetejf";
			v7 := v7;
			var v8: array<bool> := new bool[29];
			v8[safeIndex(348, v8.Length)] := f9;
			var v9: seq<bool> := [v5, true];
			var v10: map<int, bool> := map[-|v9| := v5];
			var v11: set<int> := {|v10|, v6};
			v8[safeIndex(348, v8.Length)] := v3[safeIndex(995, v3.Length)] in (v11 + v11);
			if (if (!v5) then v5 else v8[safeIndex(348, v8.Length)]) {
				var v12 := DC10();
				var v13: T1 := new C9(v9, v12);
				var v14: multiset<multiset<int>> := multiset{v2, v2};
				var v15: map<string, string> := map[v7 := "ge"];
				v13, v5, v7, v8[safeIndex(348, v8.Length)] := v13, p1 <= (if (v2 in v14) then v14[v2] else v3[safeIndex(995, v3.Length)]), v7, v13.fm7(v5, v7, v15, globalState);
				var v16: array<char> := new char[5](i1 => 'q');
				var v17: map<bool, bool> := map[f9 := v8[safeIndex(348, v8.Length)]];
				var v18: map<array<char>, bool> := map[v16 := (if ((if (f9 in v17) then v17[f9] else !f9) in v17) then v17[if (f9 in v17) then v17[f9] else !f9] else v8[safeIndex(348, v8.Length)]) || v8[safeIndex(348, v8.Length)]];
				v18 := v18[v16 := v8[safeIndex(348, v8.Length)]];
				var v19: array<array<int>> := new array<int>[2] [v3, v3];
				v19[safeIndex(367, v19.Length)] := v3;
				var v20: set<bool> := {v5};
				var v21: map<int, int> := map[v3[safeIndex(995, v3.Length)] := v6];
				var v22 := DC22(v3, -|v7|, v5, p1);
				v19[safeIndex(367, v19.Length)] := new int[15] [i0, v3[safeIndex(995, v3.Length)], if (v5) then |v20| else v6, safeDivisionInt(p1, |v1|), p1, if (f9) then p1 else v6, v6, if (v3[safeIndex(995, v3.Length)] in v21) then v21[v3[safeIndex(995, v3.Length)]] else p1, i0, v3[safeIndex(995, v3.Length)], p1, v6, v22.cf39, -i0, i0];
				var v23: map<bool, string> := map[!v5 := v7];
				v23 := v23[!(f9 <==> v8[safeIndex(348, v8.Length)]) := if (v13.fm7(v8[safeIndex(348, v8.Length)], seq(abs(0xaf), i2  => ('t')), v15, globalState)) then v7 else seq(abs(0x1af), i3  => ('a'))];
				v20 := v20 - {v5};
			} else {
				var v24, v25, v26 := m0(globalState);
				v5, v3[safeIndex(995, v3.Length)], v3, v3, v8 := f9, v24 - (v6 * v3[safeIndex(995, v3.Length)]), v3, v3, v8;
				var v27: seq<int> := [i0];
				v24, v8[safeIndex(348, v8.Length)], v8[safeIndex(348, v8.Length)], v7 := fm3(v8[safeIndex(348, v8.Length)], globalState), (v1 + v1) >= (if (!v5) then multiset{|v10|} else multiset(v27)), f9 || (f9 in [v26[safeIndex(i0, |v26|)]]), seq(abs(982), i4  => ('i'));
				var v28: T2 := new C5();
				v28 := if (v5) then v28 else v28;
				var v29 := 'g';
				v29, v4, v3[safeIndex(995, v3.Length)], v3[safeIndex(995, v3.Length)], v3[safeIndex(995, v3.Length)] := v29, v4, v6, v6, safeDivisionInt(v3[safeIndex(995, v3.Length)], |[v7]|);
			}
			
		}
		for i5 := p1 to safeModuloInt(p1, p1) {
			var v30 := true;
			v30 := false;
			var v31 := 0x217;
			v31 := i5;
			...
			if (v30) {
				...
				v32[safeIndex(655, v32.Length)] := v30;
				v35, v31, v32[safeIndex(655, v32.Length)] := v35, -i5, !false;
				v32[safeIndex(655, v32.Length)] := v32[safeIndex(655, v32.Length)];
				...
				v37[safeIndex(737, v37.Length)] := if (v38 in v39) then v39[v38] else v31;
				var v40 := DC50(v30, v32[safeIndex(655, v32.Length)], v31);
				v37[safeIndex(737, v37.Length)] := v34[safeIndex(|"ryqkxs"| - --v40.cf95, |v34|)];
				var v41: map<char, string> := map[v38 := v33];
				v41 := v41[v33[safeIndex(i5, |v33|)] := v33];
			} else {
				var v42: seq<bool> := [f9];
				var v43: seq<int> := [0x3d0, fm3(v30, globalState), v31, i5, p1];
				v31 := |(v42 + v42)| * v43[safeIndex(-i5, |v43|)];
				var v44: map<bool, bool> := map[v30 := v30];
				var v45 := 'j';
				v31 := --(if (v30 !in v44) then p1 else safeDivisionInt(|multiset{v45, v45, v45}|, -374));
				var v46 := new C4();
				var v47: array<string> := new string[10](i6 => "smk");
				var v48 := "bcr";
				v47[safeIndex(31, v47.Length)] := v48;
				v47[safeIndex(31, v47.Length)] := v48;
				var v49: array<int> := new int[10];
				v49[safeIndex(944, v49.Length)] := |v42|;
				v49[safeIndex(944, v49.Length)] := fm3(f9, globalState);
			}
		...
		v53[safeIndex(647, v53.Length)] := v55;
		v53[safeIndex(647, v53.Length)] := v55[v50 := v54] + (v55 + v55);
		for i8 := p1 to p1 {
			var v56 := DC13();
			v56 := v56;
			var v57: array<int> := new int[11];
			v57[safeIndex(797, v57.Length)] := -p1;
			v57[safeIndex(797, v57.Length)] := fm3(v50 && f9, globalState);
			v57[safeIndex(797, v57.Length)] := 0x23e;
			v50 := f9;
		}
		var v58 := 'e';
		var v59 := "renwq";
		if (v58 in v59) {
			if (fm1(fm1(v50, p1, globalState), safeDivisionInt(p1, |v59|), globalState)) {
				...
				v50 := false;
				v63[safeIndex(76, v63.Length)] := v50;
				var v64: seq<int> := [v62, p1];
				var v65: seq<bool> := [f9, false, f9, f9, f9];
				var v66: map<bool, int> := map[v65[safeIndex(|v64|, |v65|)] := 0x33b];
				v62, v62, v62, v63[safeIndex(76, v63.Length)], v62 := p1, v62 * (if (f9) then p1 else -p1), fm3(!!true, globalState) - safeDivisionInt(|[p1, v64[safeIndex(|map[v58 := v62]|, |v64|)], p1]|, |map[p1 := v63]|), f9, safeDivisionInt(p1 + |v66|, p1);
				...
				v70[safeIndex(943, v70.Length)] := v71;
				var v73: seq<int> := [p1, p1];
				v70[safeIndex(943, v70.Length)] := map v72 : int | v72 in v73 :: (v72 * |v59|) := (DC44(true, v50, v50));
				var v74, v75 := m18(globalState);
				v75 := p1;
				v74 := |v73[safeIndex(v75 * p1, |v73|) := safeDivisionInt(v75, p1)]|;
			}
			
			var v76 := new C6();
			var v77 := DC19(seq(abs(0x2aa), i12  => ({v50, v50})));
			...
			match (v79.(cf101 := v78)) {
				...
				case DC54(cf104) =>
					...
					var v96: map<int, int> := map[|v93| := safeModuloInt(p1, -v94[safeIndex(|v95|, |v94|)])];
					v96 := v96[-(-|v93| + |v94|) := p1];
					var v97 := 0x14f;
					var v98: array<int> := new int[2](i13 => i13 - -0x29d);
					v98[safeIndex(628, v98.Length)] := v97;
					var v99: array<seq<seq<int>>> := new seq<seq<int>>[1];
					var v100: seq<seq<int>> := [v94, fm66(globalState), v94];
					v99[safeIndex(264, v99.Length)] := v100;
					var v101: multiset<seq<int>> := multiset{seq(abs(0x27a), i14  => (v97))};
					v50, v50, v97, v98[safeIndex(628, v98.Length)], v99[safeIndex(264, v99.Length)] := (f9 ==> f9) <== f9, multiset{DC57(v94, f9, p1).cf109, -p1} != fm45(globalState), safeDivisionInt(p1, p1), |v101[([v97, v97])[safeIndex(p1, |[v97, v97]|) := p1] + (seq(abs(0x123), i15  => (-|multiset{false}|))) := abs(-p1)]|, v100[safeIndex(v76.fm68(fm1(!f9, p1, globalState), v76.fm7(f9, v59, map v102 : string | v102 in multiset{v59} :: (v102) := ("jujbdrpc"), globalState), globalState), |v100|) := v94];
					v98[safeIndex(628, v98.Length)], v97, v59 := p1, -p1, "x" + v59;
					v50 := f9;
			}
			...
			if (if (v50) then f9 else v50) {
				...
				v115[safeIndex(127, v115.Length)] := v50;
				v115[safeIndex(127, v115.Length)], v113 := f9, |v59|;
				...
				v118 := v118[safeDivisionInt(p1, p1) := 0x27d];
			...
			v123[safeIndex(569, v123.Length)] := v124 < v124;
			v123[safeIndex(569, v123.Length)] := f9;
			var v125 := 0x3d5;
	...
	method m18(globalState: GlobalState) returns (r0: int, r1: int) {
		...
		var v1 := DC26({v0});
		v1 := v1;
		var v2: array<int> := new int[7](i0 => safeDivisionInt(i0, 0x2fc));
		v2 := v2;
		var v3: map<int, int> := map[v0 := safeModuloInt(|{f9, f9, !f9}|, v0)];
		var v4: map<bool, bool> := map[f9 := f9];
		v3 := (v3 + v3) + (if (if (f9 in v4) then v4[f9] else true) then v3 else v3);
		r1 := v0 * v0;
		var v5 := DC21(f9, v4, f9, v0);
		match (match v5 {
			case DC20(cf29, cf30, cf31) => DC19(seq(abs(-0x2cd), i1  => ({f9})))
			...
			case DC20(cf29, cf30, cf31) =>
				...
				if ((v6 < v6) <== cf30) {
					...
					v8[safeIndex(31, v8.Length)] := v10 != v10;
					var v11: set<int> := {v0};
					var v12 := "fg";
					v8[safeIndex(31, v8.Length)], v11, v12 := f9, v11, v12;
					var v13: seq<array<int>> := [v2, v2, v2];
					var v14: array<array<int>> := new array<int>[4] [v13[safeIndex(v0, |v13|)], v2, v2, v2];
					v14[safeIndex(438, v14.Length)] := v2;
					var v15: map<bool, array<int>> := map[v0 != -v0 := v2];
					v14[safeIndex(438, v14.Length)] := if (cf30 in v15) then v15[cf30] else v2;
					r0 := v0 + v0;
					v14[safeIndex(438, v14.Length)][safeIndex(834, v14[safeIndex(438, v14.Length)].Length)] := safeModuloInt(-v0, |v11|);
					v14[safeIndex(438, v14.Length)][safeIndex(834, v14[safeIndex(438, v14.Length)].Length)] := v0;
				} else {
					var v16 := "hfmkycqxn";
					...
					v18[safeIndex(11, v18.Length)] := v19;
					var v21: map<char, bool> := map[cf29 := false];
					var v22: map<char, int> := map[cf29 := v0];
					cf30, cf30, v18[safeIndex(11, v18.Length)], cf29, r0 := cf30, cf30, set v23 : char | v23 in ((map v20 : char | v20 in v21 :: (v20) := (v0)) + v22[cf29 := -v0]) :: (v23), cf29, v0;
					...
					v27[safeIndex(610, v27.Length)] := v0 > -269;
					v27[safeIndex(727, v27.Length)] := cf30 <== fm1(false, v0, globalState);
					var v28: array<char> := new char[3] [fm39(globalState), cf29, cf29];
					v28[safeIndex(287, v28.Length)] := fm43(globalState);
					var v29: map<int, bool> := map[v0 * 0x134 := cf30];
					v16, cf30, v27[safeIndex(610, v27.Length)], v27[safeIndex(727, v27.Length)], v28[safeIndex(287, v28.Length)] := v16, false, !f9, if (-v0 in v29) then v29[-v0] else f9, cf29;
				}
				...
				match (fm82(globalState)) {
					case DC20(cf29, cf30, cf31) =>
						...
						var v36 := new C8(v34[safeIndex(v0, |v34|)], v35);
						v36.f12 := cf30 <== f9;
					...
					case DC21(cf32, cf33, cf34, cf35) =>
						...
						cf34, r1 := (seq(abs(554), i2  => (set v38 : int | v38 in [|"bbtdpjut"|] :: (v38 * 508))))[safeIndex(v0, |(seq(abs(554), i2  => (set v38 : int | v38 in [|"bbtdpjut"|] :: (v38 * 508))))|) := v39] < (seq(abs(766), i3  => (v39))), v0;
					...
					case DC19(cf28) =>
						...
						v4 := v4[cf30 := f9];
						v48 := ((seq(abs(0x17e), i4  => (cf29))) + (v48 + "kgde"))[safeIndex(v0, |((seq(abs(0x17e), i4  => (cf29))) + (v48 + "kgde"))|) := fm48(cf30, v0, globalState)];
						r1 := -v0;
				}
			...
			case DC22(cf36, cf37, cf38, cf39) =>
				cf38 := cf38;
				cf36[safeIndex(784, cf36.Length)] := cf39;
				var v56 := 'j';
				var v57: multiset<char> := multiset{v56, v56};
				var v58: seq<bool> := [cf38];
				r0, cf38, cf38, cf36[safeIndex(784, cf36.Length)] := v0 * |v57|, safeModuloInt(0x3ac, cf39) != v0, cf38 ==> v58[safeIndex(0x52, |v58|)], cf39;
			...
			case DC19(cf28) =>
				...
				var v63 := "d";
				var v64: map<bool, int> := map[true := safeDivisionInt(v0, |v63|)];
				r1 := if (f9 in v64) then v64[f9] else v0;
				v0 := v0;
				v0 := v0;
		}
		
		v2[safeIndex(997, v2.Length)] := v0;
		v2[safeIndex(997, v2.Length)] := v0;
		r0 := v0;
		r1 := v2[safeIndex(997, v2.Length)];
	}
}
...
class C11 {
	...
	function fm23(p0: bool, globalState: GlobalState): bool {
		if (multiset{|{|map[true := set v0 : int | (873 <= v0) && (v0 < -0x3e5) :: (safeModuloInt(v0, --0x192))]|}|, -0x151} !! multiset{0x2a6, |"msow"|, |map[true := 0x3ab]|, 0x290}) then false && !false else if (true in f6) then f6[true] else !true
	}
	...
	method m15(p0: int, globalState: GlobalState) returns (r0: bool) {
		...
		var v2 := true;
		v1[safeIndex(940, v1.Length)] := v2;
		var v3 := 0xe8;
		var v4 := "rdjjbb";
		r0, v1[safeIndex(940, v1.Length)], v3 := !(--p0 >= (|v4| - |fm25(p0, globalState)|)), !!true, if (false) then p0 else p0;
		v0 := match fm26(globalState) {
			case DC17() => v0
			case DC16(cf26) => DC6(v2, v2, v0, p0, v1[safeIndex(940, v1.Length)]).cf12
		};
		var v5 := DC9(map[p0 := seq(abs(-0x397), i1  => (v0))]);
		var v6 := DC11(v5);
		var v7: set<D3> := {v6, v6, v6};
		var v8: set<set<D3>> := {v7};
		if (v8 !! v8) {
			var v9: seq<bool> := [fm23(true, globalState)];
			v2 := v9[safeIndex(v3, |v9|)];
			var v10: set<int> := {p0};
			var v11: multiset<bool> := multiset{!v1[safeIndex(940, v1.Length)], v1[safeIndex(940, v1.Length)], v1[safeIndex(940, v1.Length)]};
			var v12: array<int> := new int[13] [-p0, p0, |v4|, p0, 428, safeDivisionInt(v3, fm3(!v1[safeIndex(940, v1.Length)], globalState)), p0, --p0, p0, v3, 0x38a, |v4|, |v11|];
			v12[safeIndex(919, v12.Length)] := v3;
			var v13: multiset<int> := multiset{v3, v3, 93};
			v10, v3, v12, v12[safeIndex(919, v12.Length)] := v10, |v11| + (if (0x308 in v13) then v13[0x308] else p0), v12, p0;
			var v14: array<char> := new char[14](i2 => v0);
			v14[safeIndex(552, v14.Length)] := v0;
			v14[safeIndex(552, v14.Length)] := v0;
			v12[safeIndex(919, v12.Length)] := -fm3(if (v2 in f6) then f6[v2] else v9[safeIndex(v12[safeIndex(919, v12.Length)], |v9|)], globalState);
			v12[safeIndex(919, v12.Length)] := p0;
		} else {
			v4 := ((seq(abs(-23), i3  => ('d'))) + fm27(v1[safeIndex(940, v1.Length)], v3, v1[safeIndex(940, v1.Length)], true, globalState)) + v4;
			var v15 := DC6(v2, v2, v0, v3, v1[safeIndex(940, v1.Length)]);
			var v16: seq<int> := [p0, p0, p0, v15.cf13, p0];
			var v17: seq<bool> := [v2, v2];
			var v18: map<seq<int>, seq<bool>> := map[if (v1[safeIndex(940, v1.Length)]) then v16 else fm28(v3, globalState) := fm0(fm1(true, |"osapsb"|, globalState), 0x6, v2, globalState) + v17];
			v18 := v18[seq(abs(762), i4  => (|{v1[safeIndex(940, v1.Length)]}|)) := v17];
			v3 := safeDivisionInt(-|v4| + -0x380, |(seq(abs(-53), i5  => (v0)))| * v3);
			v3 := p0;
			var v19: map<char, bool> := map[v0 := v1[safeIndex(940, v1.Length)]];
			v3 := |v19|;
		}
		
		var v20 := DC4(v1[safeIndex(940, v1.Length)]);
		var v21: seq<D1> := [v20, DC4(v1[safeIndex(940, v1.Length)])];
		var v22: map<seq<D1>, bool> := map[v21 := v1[safeIndex(940, v1.Length)]];
		v22 := v22[([v20, v20, v20, v20, DC4(v2).(cf8 := v2)])[safeIndex(v3, |[v20, v20, v20, v20, DC4(v2).(cf8 := v2)]|) := v20] + v21 := false];
	...
	method m16(p0: int, p1: bool, p2: bool, p3: bool, globalState: GlobalState) returns (r0: string) {
		...
		match (v5) {
			case DC13() =>
				...
				match (v6) {
					case DC13() =>
						...
						v9[safeIndex(708, v9.Length)] := v8;
						v9[safeIndex(708, v9.Length)] := v8;
						var v10 := -0x287;
						v10 := safeModuloInt(-p0, -0x31);
						var v11 := new C0();
					case DC14(cf21, cf22) =>
						var v12 := 0x21e;
						...
						var v16: array<string> := new string[19] [v13, "l", "r", v13, v13, v13, v13, v15.cf66, (seq(abs(388), i1  => (v0))) + v13, (seq(abs(0x159), i2  => (v0))) + v13, v13, v13, "hkng", "clqilxfo" + v13, seq(abs(0x243), i3  => (v0)), v13, v13, v13, v13];
						v16 := v16;
						var v17 := true;
						v17 := !v17;
					case DC15(cf23, cf24, cf25) =>
						...
						var v23: seq<int> := [|v22[p2 := abs(295)]|];
						var v24: map<bool, int> := map[cf25 := fm3(true, globalState)];
						var v25: array<int> := new int[21] [cf23, p0, cf23, p0 * 0x323, |v21| * p0, fm3(true, globalState), cf23, cf23, v23[safeIndex(|multiset{cf23}|, |v23|)], 0xe7, -p0, cf23, |v24|, |v23|, cf23, if (p2) then p0 else fm3(p2, globalState), p0, cf23, safeModuloInt(p0, cf23), p0, p0];
						v25[safeIndex(668, v25.Length)] := p0;
						v4, v25[safeIndex(668, v25.Length)], v0 := (cf24 + v4) + v5.cf24, -cf23, v0;
						v0 := v0;
						var v26: multiset<array<int>> := multiset{v25, v25, v25, v25, if (p2) then v25 else v25};
						v26, v25[safeIndex(668, v25.Length)], cf23, cf25 := v26, v25[safeIndex(668, v25.Length)] + cf23, v25[safeIndex(668, v25.Length)], p1 ==> p1;
					case DC12(cf20) =>
						var v27 := -0x25a;
						v27 := -p0;
						v27 := p0 * p0;
						...
						v35[safeIndex(811, v35.Length)] := p0;
						v35[safeIndex(811, v35.Length)] := -safeDivisionInt(-v27, p0);
						var v36 := false;
						v36 := p3;
				}
			...
			case DC14(cf21, cf22) =>
				...
				var v45: array<string> := new string[22] ["jaajl", v41 + fm27(p3, -p0, p1, fm23(p3, globalState), globalState), v41, if ({v42, v42} in v44) then v44[{v42, v42}] else v41, "gxettus", (v41 + "qtbpv")[safeIndex(p0, |(v41 + "qtbpv")|) := v0], v41, v41, v41, v41 + "ff", fm47(globalState), v41, v41, v41, fm42(globalState), v41, "hjprpvc" + v41, v41, v41, v41, "dchqgxtk", v41];
				v45[safeIndex(667, v45.Length)] := v41;
				var v46: array<int> := new int[21];
				v46[safeIndex(339, v46.Length)] := p0;
				v45[safeIndex(667, v45.Length)], v46, v46[safeIndex(339, v46.Length)] := v41, v46, p0;
				var v47: map<bool, int> := map[p3 := p0];
				v46[safeIndex(339, v46.Length)] := fm3(fm23(!p1, globalState) in v47, globalState);
				var v48, v49, v50 := m0(globalState);
				var v51 := DC43(p2, "amvjw", p3, p2, p3);
				var v52: seq<map<bool, bool>> := [fm49(v49, v48, 18, globalState)];
				v48 := |v51.cf77| - |(v52[safeIndex(v49, |v52|)] + fm49(p0, 882, v49, globalState))|;
			case DC15(cf23, cf24, cf25) =>
				cf25 := p2;
				...
				var v58 := new C1(v56[safeIndex(cf23, |v56|)], v57);
				var v59: seq<int> := [cf23];
				var v60: multiset<int> := multiset{-cf23};
				var v61: array<int> := new int[16] [cf23, p0, -p0, cf23, 0x2aa, p0, 968, safeDivisionInt(|multiset(v4)|, cf23), p0, |(f6 + f6)|, safeModuloInt(p0, |v59|), p0, if (p1) then 0x1ad else p0, fm3(p1, globalState), safeDivisionInt(|map[cf23 := v60]|, p0), p0];
				var v62 := DC34();
				var v63 := DC45(p0, p2, v62);
				v61[safeIndex(925, v61.Length)] := v63.cf84;
				var v64: multiset<char> := multiset{fm48(p2, 684, globalState)};
				var v65: seq<multiset<char>> := [v64, v64, v64, multiset{v58.f18}, v64];
				v61[safeIndex(925, v61.Length)], v65, cf23 := cf23 + (|(seq(abs(42), i4  => (v0)))| + p0), ((seq(abs(58), i5  => (v65[safeIndex(p0, |v65|)]))) + (seq(abs(316), i6  => (v64)))) + v65, cf23;
			case DC12(cf20) =>
				if (p2) {
					var v66: array<C2> := new C2[13];
					var v67: seq<array<C2>> := [v66];
					v67 := [v66] + v67[safeIndex(p0, |v67|) := v66];
					var v68: set<bool> := {p2};
					var v69 := new C1(v0, v68);
					var v70 := "ll";
					var v71: seq<string> := [v70];
					r0 := v71[safeIndex(p0, |v71|)] + v70;
					var v72 := 655;
					var v73: array<int> := new int[25];
					var v74: multiset<array<int>> := multiset{v73};
					var v75: multiset<int> := multiset{|v74[v73 := abs(p0)]|};
					v72 := if ((v72 * |multiset{v72}|) in v75) then v75[v72 * |multiset{v72}|] else p0;
					var v76 := false;
					var v77: map<int, multiset<int>> := map[v72 := v75];
					v72, v72, v4, v76 := safeModuloInt(v72 * -|(if (v72 in v77) then v77[v72] else v75)|, v72), safeDivisionInt(0xcd, |v4|) - p0, v4, p2;
				} else {
					var v78 := "pqex";
					v4 := (v4 + [if (-|v78| in f7) then f7[-|v78|] else p2, p3])[safeIndex(-p0, |(v4 + [if (-|v78| in f7) then f7[-|v78|] else p2, p3])|) := p3];
					...
					var v85: array<int> := new int[25] [safeDivisionInt(p0, p0), -0x113, p0, -p0, p0, safeModuloInt(|f6|, |v84|), -p0, p0 + --0x2ab, |v4| - p0, p0, -(if (v83.f9) then fm3(p2, globalState) else p0), p0, fm3(v83.f9, globalState), p0, safeModuloInt(p0, |v4|), p0, p0, p0, -0x45, p0, p0, p0, p0, p0, p0];
					v85[safeIndex(129, v85.Length)] := p0;
					v85[safeIndex(129, v85.Length)] := p0 - p0;
					v85 := v85;
				}
				
				var v86: multiset<bool> := multiset{p1};
				var v87 := "felt";
				var v88: array<int> := new int[12] [safeModuloInt(p0, p0), p0, |v4|, p0, safeModuloInt(if (p2 in v86) then v86[p2] else |v87|, p0), -0x18c, p0, -p0, p0, p0, p0, -229 + |"rrb"|];
				v88[safeIndex(960, v88.Length)] := p0 - p0;
				var v89: map<bool, int> := map[p1 := p0];
				v88[safeIndex(960, v88.Length)] := |((map[p2 := 0x35d] + v89) + v89)|;
				var v90: set<map<bool, bool>> := {f6, f6};
				var v91: seq<int> := [|v90|, p0, v88[safeIndex(960, v88.Length)]];
				v88[safeIndex(960, v88.Length)] := -(-v91[safeIndex(p0, |v91|)] * |(v86 + v86)|);
				match (DC5(v4)) {
					case DC6(cf10, cf11, cf12, cf13, cf14) =>
						var v92: array<bool> := new bool[27];
						v92 := v92;
						var v93: set<int> := {-|v87|};
						cf14 := !(safeDivisionInt(p0, fm3(!p1, globalState)) != |(v93 - fm4(fm23(p2, globalState), v88[safeIndex(960, v88.Length)], v88[safeIndex(960, v88.Length)], |v93|, globalState))|);
						v88[safeIndex(960, v88.Length)] := p0;
						var v94: array<set<int>> := new set<int>[28];
						v88[safeIndex(960, v88.Length)], v88[safeIndex(960, v88.Length)], cf13, v94, v88[safeIndex(960, v88.Length)] := p0, safeDivisionInt(safeModuloInt(if (v4[safeIndex(cf13, |v4|)] in v89) then v89[v4[safeIndex(cf13, |v4|)]] else cf13, -0x3b7), p0 - |v91|), safeModuloInt(-safeModuloInt(v88[safeIndex(960, v88.Length)], v88[safeIndex(960, v88.Length)]), v88[safeIndex(960, v88.Length)]), v94, fm3(p1, globalState);
					case DC7(cf15, cf16) =>
						var v95: set<char> := {v0};
						v88[safeIndex(960, v88.Length)], cf15, v88[safeIndex(960, v88.Length)], v88[safeIndex(960, v88.Length)], v91 := p0, v95 >= v95, |(v86 + multiset{!p3})| + p0, p0, v91;
						var v96 := DC26({v88[safeIndex(960, v88.Length)]});
						var v98: map<D9, seq<bool>> := map[v96.(cf45 := set v97 : int | (-0x16c <= v97) && (v97 < 288) :: (safeDivisionInt(v97, |v91|))) := v4];
						v4 := (if (v96 in v98) then v98[v96] else v4) + v4;
						v88[safeIndex(960, v88.Length)] := v88[safeIndex(960, v88.Length)];
						v88[safeIndex(960, v88.Length)] := -v88[safeIndex(960, v88.Length)];
					case DC5(cf9) =>
						...
						var v104 := DC42(v101);
						v100[safeIndex(886, v100.Length)] := if (v102.(cf87 := v104) in v103) then v103[v102.(cf87 := v104)] else v99;
						var v105: multiset<int> := multiset{906};
						var v106: seq<multiset<int>> := [v105];
						var v107: T2 := new C5();
						var v108: map<T2, multiset<int>> := map[v107 := v105];
						v88[safeIndex(960, v88.Length)], v100[safeIndex(886, v100.Length)], v106 := |((if (v107 in v108) then v108[v107] else v105) - v105)|, v99, v106 + [(v106[safeIndex(|v4|, |v106|)])[v88[safeIndex(960, v88.Length)] := abs(v88[safeIndex(960, v88.Length)])], multiset(v91)];
						var v109 := true;
						v109 := fm1(v109, 0x1a5, globalState);
						v109 := v88[safeIndex(960, v88.Length)] >= v88[safeIndex(960, v88.Length)];
						var v110: array<D11> := new D11[9];
						var v111: set<bool> := {p1, false};
						var v112 := DC30(v111);
						v110[safeIndex(459, v110.Length)] := v112;
						v109, v91, v110[safeIndex(459, v110.Length)], v88[safeIndex(960, v88.Length)], v88[safeIndex(960, v88.Length)] := if (fm1(p2, v88[safeIndex(960, v88.Length)], globalState)) then fm1(p1, |v4[safeIndex(p0, |v4|) := v109]|, globalState) else v109, v91, v112, -(if (v109) then |v4| else p0), p0;
					case DC8(cf17) =>
						var v113 := DC37(p1, [p1], seq(abs(-293), i7  => ('u')), |f7|);
						var v114: map<bool, D13> := map[p2 := v113];
						v114 := v114 + (v114 + map[p2 := v113]);
						var v115: array<bool> := new bool[6] [p2, p1, p3, !p2, p1, p3 in f6];
						v115[safeIndex(700, v115.Length)] := p3;
						v115[safeIndex(700, v115.Length)] := v88[safeIndex(960, v88.Length)] == safeDivisionInt(500, p0);
						v115[safeIndex(700, v115.Length)] := !p3;
						var v116: map<int, array<bool>> := map[v88[safeIndex(960, v88.Length)] := v115];
						var v117: array<array<bool>> := new array<bool>[23] [v115, v115, if (v88[safeIndex(960, v88.Length)] in v116) then v116[v88[safeIndex(960, v88.Length)]] else v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, v115, if (p1) then v115 else v115, v115, v115, v115, v115, v115];
						var v118 := DC63(v117);
						v117 := v118.cf118;
				}
		...
		for i9 := p0 to p0 {
			var v127 := false;
			var v128: array<seq<map<bool, int>>> := new seq<map<bool, int>>[21](i10 => seq(abs(0x353), i11  => (map[true := |f6|])));
			...
			v128[safeIndex(448, v128.Length)] := (seq(abs(0x341), i12  => (map[p2 := p0]))) + v131;
			var v132: seq<int> := [|map[p0 := v129]|];
			var v133 := "kkbljsc";
			var v134: map<string, int> := map[v133 := v132[safeIndex(p0, |v132|)]];
			var v135: map<int, seq<map<bool, int>>> := map[if (p1) then -412 else 0x163 := [v130, map[fm1(p1, i9, globalState) := v132[safeIndex(|v134|, |v132|)]], v130[p1 := DC0(i9).cf0], v130]];
			v127, v128[safeIndex(448, v128.Length)], v127 := p2 ==> false, if (-0x1f8 in v135) then v135[-0x1f8] else (seq(abs(-0xfa), i13  => (map[!p3 := i9]))) + [v130], p2;
			var v136: map<int, int> := map[p0 := i9];
			v136 := v136[p0 * |v134| := i9 * p0];
			v127 := p2;
			var v137 := 435;
			var v138: array<bool> := new bool[19];
			v138[safeIndex(563, v138.Length)] := !!p1;
			var v139: multiset<char> := multiset{v0};
			v137, v137, v127, v138[safeIndex(563, v138.Length)], v137 := |v139|, safeModuloInt(safeModuloInt(i9, if (p1 in v129) then v129[p1] else fm3(p1, globalState)), fm3(!p1, globalState)), v4[safeIndex(v137, |v4|)], fm1(p2, i9, globalState), v137;
		}
		var v140 := 506;
		var v141: array<array<bool>> := new array<bool>[23];
		var v142: array<bool> := new bool[19];
		v141[safeIndex(905, v141.Length)] := v142;
		v140, v141[safeIndex(905, v141.Length)], v4 := 0x6, v142, [if (true) then p2 else p3, !p3, false, 0x18c < v140];
		var v143: array<string> := new string[26];
		var v144: seq<array<string>> := [v143];
		var v145 := DC32(v144[safeIndex(v140, |v144|)]);
		match (v145) {
			case DC33(cf57, cf58, cf59, cf60, cf61) =>
				var v146: set<bool> := {p3};
				v146 := v146 + v146;
				var v147: array<int> := new int[4];
				v147[safeIndex(979, v147.Length)] := cf58;
				var v148 := "i";
				v147[safeIndex(979, v147.Length)] := |v148|;
				var v149 := new C0();
				cf60 := 339;
			case DC34() =>
				var v150 := false;
			...
			case DC32(cf56) =>
				if (if (!!p1) then p3 ==> p3 else false) {
					...
					v153 := (v153 + [v155, v155]) + ((seq(abs(817), i14  => (v155))) + fm83(p1, |map[p1 := p3]|, globalState));
					var v156 := false;
					v156, v140 := p3, -v140;
					...
					v158[safeIndex(459, v158.Length)] := v1;
					v158[safeIndex(459, v158.Length)] := v1;
				} else {
					var v159: array<int> := new int[18](i15 => i15 - v140);
					var v160 := "xbyehech";
					var v161: seq<string> := [v160];
					var v162: seq<string> := [v161[safeIndex(v140, |v161|)]];
					v159[safeIndex(779, v159.Length)] := |[f6, f6, map[true := p1]]| * |v162|;
					v159[safeIndex(779, v159.Length)] := DC50(fm1(p3, v140, globalState), v4[safeIndex(p0, |v4|)], fm3(p1, globalState)).cf95;
					var v163 := true;
					v163 := fm3(p3, globalState) < safeModuloInt(fm3(p2, globalState), p0);
					var v164: map<array<int>, bool> := map[v159 := p1];
					v164 := map[v159 := v163];
					var v165: set<int> := {v159[safeIndex(779, v159.Length)]};
					var v166: set<bool> := {false, v163, fm23(p3, globalState)};
					var v167: multiset<int> := multiset{|v160|, |v165|, |v166|, p0};
					var v168: map<int, multiset<int>> := map[v159[safeIndex(779, v159.Length)] := v167];
...
class C12 extends T2, T0 {
	...
	method m4(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: array<set<int>>, r1: bool, r2: multiset<seq<D0>>) {
		...
		var v1 := 0x320;
		v0, v1 := multiset{p2, p0}, safeModuloInt(580, v1 + |fm22(0x334, v1, globalState)|);
		v1 := safeDivisionInt(|p1|, v1);
		var v2: array<int> := new int[19](i0 => i0 * v1);
		v2[safeIndex(79, v2.Length)] := fm3(p0, globalState);
		var v3: multiset<int> := multiset{-v1};
		var v4: map<multiset<int>, bool> := map[v3 := p2];
		r1, v2[safeIndex(79, v2.Length)], v1 := !p0, |(v4 + v4)|, safeDivisionInt(v1, v1);
		var v5 := new C2(p0);
		v2[safeIndex(79, v2.Length)] := 198 * (v1 - v1);
		if (!p2) {
			r1 := (v0 !! v0[v5.f17 := abs(v2[safeIndex(79, v2.Length)])]) ==> v5.f17;
			v2[safeIndex(79, v2.Length)], r1 := v5.fm41(0x1bc, v1, v5.f17, v5.f17 && p0, globalState), v1 < 0x26e;
			var v6: array<bool> := new bool[12](i1 => !p2);
			v6[safeIndex(709, v6.Length)] := p2;
			var v7 := 'j';
			...
			v6[safeIndex(709, v6.Length)] := v11[safeIndex(|v13|, |v11|)] < v1;
			v6[safeIndex(709, v6.Length)] := true;
			v2[safeIndex(79, v2.Length)] := v1;
		} else {
			var v14 := "jcivf";
			var v15 := DC15(|v14|, [p1[safeIndex(837, |p1|)], !p2], false);
			match (v15) {
				case DC13() =>
					v2[safeIndex(79, v2.Length)] := v1;
					var v16: array<string> := new string[16];
					v16[safeIndex(393, v16.Length)] := v14;
					v16[safeIndex(393, v16.Length)] := v14;
					...
					v1 := -|(v18 + v18)|;
					v2[safeIndex(79, v2.Length)] := safeModuloInt(|([p0, p2] + p1[safeIndex(v1, |p1|) := v5.f17])|, -(v1 + |p1|));
				case DC14(cf21, cf22) =>
					var v19: seq<int> := [0x368];
					v14 := fm22(v19[safeIndex(|p1|, |v19|)], -v1, globalState);
					var v20: map<bool, bool> := map[false := p0];
					var v21: map<int, bool> := map[v2[safeIndex(79, v2.Length)] := p0];
					var v22 := new C11(v20, v21[v2[safeIndex(79, v2.Length)] := v5.f17] + v21);
					var v23: array<bool> := new bool[28];
					v23[safeIndex(525, v23.Length)] := v5.f17;
					v23[safeIndex(525, v23.Length)] := v5.f17;
					v23[safeIndex(525, v23.Length)] := !(p2 !in v0);
				case DC15(cf23, cf24, cf25) =>
					r1 := v5.f17;
					v2[safeIndex(79, v2.Length)] := fm3(fm21(v14, v5.f17, |v14|, globalState), globalState);
					var v24: set<int> := {safeModuloInt(v2[safeIndex(79, v2.Length)], v2[safeIndex(79, v2.Length)])};
					v24 := v24;
					var v25 := new C2(false ==> v5.f17);
				case DC12(cf20) =>
					var v26: map<int, string> := map[-487 - -v2[safeIndex(79, v2.Length)] := v14 + v14];
					v26, v2[safeIndex(79, v2.Length)] := v26, v1 * |p1|;
					var v27: array<bool> := new bool[8](i2 => p2);
					v27[safeIndex(500, v27.Length)] := v5.f17;
					v27[safeIndex(500, v27.Length)] := p2;
					v1 := v2[safeIndex(79, v2.Length)];
			...
			match (fm80(globalState)) {
				case DC4(cf8) =>
					var v33: map<bool, D8> := map[false := DC24(v2[safeIndex(79, v2.Length)], v2[safeIndex(79, v2.Length)], p1)];
					v33 := v33;
					cf8 := v5.f17;
					cf8 := v5.f17;
					v1 := safeDivisionInt(-149, 0x2e1);
				case DC3(cf7) =>
					r1 := v5.f17;
					var v34: seq<int> := [-v1, -599];
					v2[safeIndex(79, v2.Length)] := v34[safeIndex(v1, |v34|)];
					r1 := p1[safeIndex(|v14| - |p1|, |p1|)];
					var v35: seq<multiset<bool>> := [v0, v0, v0[v5.f17 := abs(-v2[safeIndex(79, v2.Length)])], v0];
					var v36: seq<multiset<bool>> := [v35[safeIndex(v2[safeIndex(79, v2.Length)], |v35|)], multiset{!p2, v5.f17}];
					v0 := v36[safeIndex(if (v2[safeIndex(79, v2.Length)] in v3) then v3[v2[safeIndex(79, v2.Length)]] else v1, |v36|)];
			}
		...
		var v38 := 'q';
		var v39 := DC1(v37, v2[safeIndex(79, v2.Length)], true, map[v5.f17 := v38], p0);
		var v40: seq<D0> := [v39];
		var v41: seq<seq<D0>> := [v40];
		var v42: multiset<array<int>> := multiset{v2};
		var v43: map<int, int> := map[|v42| := v1];
		var v44: multiset<seq<D0>> := multiset{[v39] + v41[safeIndex(|v43|, |v41|)], v40 + v40, v40, v40 + [v39], v40};
		r2 := v44;
	}
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
		var v0 := false;
		...
		var v4: seq<bool> := [v0];
		var v5 := 0x94;
		var v6 := DC21(true, v2[v0 := fm1(v0, |v3|, globalState)], v0, |[v4[safeIndex(v5, |v4|)], v0]|);
		...
		match (v11) {
			case DC43(cf76, cf77, cf78, cf79, cf80) =>
				...
				var v15: array<set<bool>> := new set<bool>[27] [f2 + f2, f2, {cf76}, f2, fm74(v0, v12.cf111, globalState), f2, f2, {v0}, f2, f2, f2, f2 - f2, f2, {v0}, f2, {fm1(cf76, 0x3a0, globalState)} + {cf78}, f2, f2, f2 * f2, f2 * f2, f2, f2, f2 + f2, v14[safeIndex(v5, |v14|)], f2, f2, f2];
				v15[safeIndex(249, v15.Length)] := f2;
				v15[safeIndex(249, v15.Length)] := f2 * f2;
				var v16: array<seq<bool>> := new seq<bool>[12](i0 => v4 + v4);
				v16[safeIndex(604, v16.Length)] := v4 + v4;
				var v17: multiset<bool> := multiset{cf78, v0};
				v16[safeIndex(604, v16.Length)], v0 := if (v5 < |v9.f7|) then v4 else v4, !(|v17| !in v9.f7);
				var v18: array<int> := new int[27];
				v18 := v18;
				var v19 := 'j';
				v5 := |fm5(cf76, |(seq(abs(0x17d), i1  => (v5)))[safeIndex(0x310, |(seq(abs(0x17d), i1  => (v5)))|) := v5]|, v19, v5, globalState)|;
			case DC44(cf81, cf82, cf83) =>
				var v20 := 't';
				var v21: map<bool, map<char, int>> := map[cf81 := map[v20 := v5]];
				var v22: array<int> := new int[26];
				var v23: map<array<int>, int> := map[v22 := v5];
				var v24: array<int> := new int[15] [v5, v5, |(if (cf81 in v21) then v21[cf81] else map[v20 := |v23|])|, fm3(false, globalState), safeDivisionInt(v5, v5), -0xce, v5, v5, v5, safeModuloInt(v5, fm3(fm1(cf83, v5, globalState), globalState)), safeModuloInt(v5, v5), -safeModuloInt(v5, v5), v5, -(if (cf82) then |v9.f7[v5 := cf83]| else fm3(v0, globalState)), -v5];
				v24[safeIndex(524, v24.Length)] := v5;
				v24[safeIndex(524, v24.Length)] := v5;
				v2 := v2[cf83 := cf82];
			...
			case DC45(cf84, cf85, cf86) =>
				cf84 := v5;
				v4 := [v0, |v9.f6| < v5, v0];
				var v26: map<char, bool> := map[v1[safeIndex(v5, |v1|)] := true];
				var v27: seq<int> := [|v26|, safeDivisionInt(cf84, cf84)];
				v27 := (fm66(globalState))[safeIndex(v5, |fm66(globalState)|) := cf84];
			...
			case DC42(cf75) =>
				...
				if (true) {
					...
					v5 := |v31[safeIndex(v5 * v5, |v31|)]|;
					v0 := !v0;
					var v32: seq<int> := [v5];
					var v33: array<int> := new int[21] [|(seq(abs(0x247), i2  => (|v4|)))| * v5, v5, v5, safeModuloInt(995, fm3(v0, globalState)), fm3(fm21(seq(abs(-0x39b), i3  => ('u')), v0, v5, globalState), globalState), v5, v5, |(v9.f6 + v9.f6[false := v0])|, DC50(v0, !v0, |[v0, v0, v0, v0, v0]|).cf95, v5, -v5 - v5, v5, v5, v5, v5, v5, |v4| + -v32[safeIndex(v5, |v32|)], v5, v5, v5 + v5, v5];
					v33[safeIndex(306, v33.Length)] := v5;
					...
					v33[safeIndex(306, v33.Length)], v5, v5 := -v34.cf98, if (-0x277 in v35) then v35[-0x277] else v5, |v38[v5 := v37]|;
					v1 := v1;
				}
				...
				v40 := v40;
				var v41: map<int, seq<bool>> := map[v5 := v4[safeIndex(20, |v4|) := v0]];
			...
			case DC46(cf87) =>
				...
				var v47: map<int, int> := map[v5 := safeDivisionInt(|v9.f7|, v46.cf2)];
				v47 := v47[v5 := v5];
				var v48: T1 := new C9(v4, fm84(v5, -v5, globalState));
				var v49: array<int> := new int[4];
				v49[safeIndex(845, v49.Length)] := v5;
				var v50: array<array<array<int>>> := new array<array<int>>[21];
				var v51: array<array<int>> := new array<int>[1];
				v50[safeIndex(165, v50.Length)] := v51;
				v48, v49[safeIndex(845, v49.Length)], v50[safeIndex(165, v50.Length)] := v48, v5, v51;
				var v52: multiset<bool> := multiset{v0, v0};
				v43[safeIndex(97, v43.Length)] := !(v52 != v52);
				v0, v43[safeIndex(97, v43.Length)] := (seq(abs(598), i4  => (v44)))[safeIndex(|v3|, |(seq(abs(598), i4  => (v44)))|) := v44] == v1, v0;
				var v53 := new C4();
		}
		...
		v58[safeIndex(118, v58.Length)] := v54;
		v58[safeIndex(118, v58.Length)] := v54;
			...
			decreases 100 - i6
		{
			...
			i6 := i6 + 1;
			var v61: map<string, int> := map[seq(abs(0x77), i7  => (v56)) := 0x14c];
			...
			v68 := set v71 : int | v71 in v70[safeIndex(v5, |v70|) := v5] :: (safeDivisionInt(v71, if (true) then |[749, 0xa]| else 0x3dc));
			var v72 := DC47(v9.f7);
			var v73: array<D17> := new D17[1] [v72];
			v73[safeIndex(380, v73.Length)] := v72;
			var v74: array<bool> := new bool[22];
			v74[safeIndex(226, v74.Length)] := v0;
			var v75: map<bool, char> := map[v0 := v56];
			var v76 := DC1(v74, v5, v0, v75, v0);
			var v77: seq<D0> := [v76];
			var v78 := DC58(([v76, v76] + v77)[safeIndex(v5, |([v76, v76] + v77)|) := v76]);
			v73[safeIndex(380, v73.Length)], v74, v74[safeIndex(226, v74.Length)], v78 := v72.(cf88 := v8), v74, (if (false) then v5 else v5) < v5, v78;
			var v79 := DC43(v74[safeIndex(226, v74.Length)], v1, v74[safeIndex(226, v74.Length)], v0, v74[safeIndex(226, v74.Length)]);
			var v80: map<bool, D16> := map[v74[safeIndex(226, v74.Length)] := DC46(v79)];
			v0 := v80 != (v80 + v80);
		}
		v5 := 474;
	...
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
		...
		for i0 := -0x55 * 0x6b to v0 {
			...
			if ((v1 < v1) ==> v2) {
				...
				var v7 := 'm';
				var v8: array<int> := new int[18] [|v4|, i0, i0, i0, v0, i0, v6.cf35, v0, |v1[safeIndex(i0, |v1|) := v7]|, i0, |v1|, i0, i0, |v1|, v0, fm3(v2, globalState), i0, |v1|];
				p1[safeIndex(522, p1.Length)] := v8;
				p1[safeIndex(522, p1.Length)] := v8;
				var v9: set<array<int>> := {v8, v8};
				var v10 := DC61(v9);
				v10 := v10;
				var v11: array<string> := new string[25] [v1, "r" + v1, (seq(abs(0x1c8), i1  => (v7))) + v1, seq(abs(0x265), i2  => (v7)), v1, v1, v1, "axscnxbrw", v1, v1, v1, v1, "gf", v1, "ji" + v1, v1, (seq(abs(816), i3  => (v7))) + v1, v1[safeIndex(i0, |v1|) := fm34(i0, v2, globalState)], v1, v1, v1, "bbni", "tsi" + v1, seq(abs(417), i4  => (v7)), v1];
				v11[safeIndex(933, v11.Length)] := v1;
				v11[safeIndex(933, v11.Length)] := ((v1 + fm47(globalState)) + v1)[safeIndex(-v0, |((v1 + fm47(globalState)) + v1)|) := v7];
				v8[safeIndex(77, v8.Length)] := -189;
				var v13: multiset<map<int, bool>> := multiset{map v12 : int | (330 <= v12) && (v12 < 0x37b) :: (v12 - i0) := (v2), v4, v4, v4};
				v8[safeIndex(77, v8.Length)] := -((-i0 * |v13|) * v0);
			...
			var v20: multiset<multiset<bool>> := multiset{v17[safeIndex(v18[safeIndex(|v19|, |v18|)], |v17|)]};
			v2 := !(v20 !! v20);
		}
		var v21 := false;
		...
		v24[safeIndex(772, v24.Length)] := 'n';
		v24[safeIndex(772, v24.Length)] := v23;
		var v25: array<seq<bool>> := new seq<bool>[26];
		forall i5 | 0 <= i5 < v25.Length {
			v25[i5] := [v21, false, multiset(seq(abs(-0xd1), i6  => (v0))) < multiset([124, |(seq(abs(0x32c), i7  => (v24[safeIndex(772, v24.Length)])))|]), v21];
		}
		var v26: seq<int> := [|v22|];
		...
		if (fm53(if (v26 in v28) then v28[v26] else v27, v0, v0, v21, globalState) !! v29) {
			...
			if (v21) {
				...
				var v36: map<int, int> := map[v0 := |(seq(abs(236), i8  => (v24[safeIndex(772, v24.Length)])))|];
				...
				var v43: array<int> := new int[29] [v0, |multiset{v0}|, -0x197, -v0, v0 - v0, v0 - v0, |v35|, v0, v0, |(v36 + v38.cf31)|, 512, v0, v0, v0, |((seq(abs(379), i9  => (v23))) + (seq(abs(170), i10  => (v24[safeIndex(772, v24.Length)]))))|, |(v26 + v26)|, |(v27 + [v21])|, v0, v26[safeIndex(|v27|, |v26|)], fm3(v21, globalState), v0, |map[|"bqusaq"| := v21]| + v0, v0, v0, if (v40 in v41) then v41[v40] else if (v40.f9 in v42) then v42[v40.f9] else v0, v0, v0, v0, v0];
				v43[safeIndex(462, v43.Length)] := v0;
				v43[safeIndex(462, v43.Length)], v0, v36 := |(v26 + fm28(fm3(v21, globalState), globalState))|, safeModuloInt(v0, if (v21) then v0 else v0), v36[-fm3(v21, globalState) := v0] + (map[0xf1 := v0] + v38.cf31);
				v21 := v21;
			} else {
				var v44: array<map<bool, int>> := new map<bool, int>[20];
				var v45: set<int> := {v0};
				v44[safeIndex(130, v44.Length)] := fm5(v21, v0, v23, |v45|, globalState);
				var v46 := "rdbjcqh";
				var v47: set<string> := {"afag", "plxa", v46};
				var v48 := DC56(v47);
				var v49: map<bool, int> := map[v21 := v0];
				v44[safeIndex(130, v44.Length)], v21, v0, v48 := if (!!v21) then if (v21) then v49 else v49 else v49 + v49, |v46| <= -v0, v0, v48;
				...
				v52 := v52[v50 + (map v53 : map<bool, bool> | v53 in (map v54 : map<bool, bool> | v54 in v55 :: (v54) := (v21)) :: (v53) := (v0))[v22 := v0] := safeDivisionInt(0xa2, v0)];
				...
				var v74: array<bool> := new bool[29] [v21, v21, v21, v21, !(if ((if (v0 in v59) then v59[v0] else v26) in v56) then v56[if (v0 in v59) then v59[v0] else v26] else v21), fm1(true, v0, globalState), v21, v21, !false, v27[safeIndex(v0, |v27|)], v21 <==> v21, v21, v21, v21, v61 !! v61, v21, v62.cf111 || fm1(!v21, 0x35b, globalState), false, fm1(if (v0 in v65) then v65[v0] else v21, v0, globalState), v27[safeIndex(v0, |v27|)], v21, v21, map[v66 := true] == (map v67 : D9 | v67 in v69.cf122 :: (v67) := (v21)), v21, v21, if (v21 in v22) then v22[v21] else false, v21, fm1(v21, |v26|, globalState), (if (|v22[v21 := v27[safeIndex(|map[if (v72 in v73) then v73[v72] else v21 := |v26|]|, |v27|)]]| in v70) then v70[|v22[v21 := v27[safeIndex(|map[if (v72 in v73) then v73[v72] else v21 := |v26|]|, |v27|)]]|] else v0) < v0];
				v74[safeIndex(197, v74.Length)] := v21;
				var v75 := DC22(v60, v0, v21, v0);
				var v76: seq<array<int>> := [v75.cf36];
				var v77: map<bool, seq<array<int>>> := map[true := v76];
				v74[safeIndex(197, v74.Length)] := ((if (v21 in v77) then v77[v21] else v76) == v76) ==> !true;
			...
			if (false) {
				...
				v26 := ((seq(abs(-0xad), i11  => (|v26|))) + v26) + (if (v21) then v26 else v26[safeIndex(v0, |v26|) := if (0x27b in v81) then v81[0x27b] else v0]);
				var v82: array<set<array<int>>> := new set<array<int>>[8];
				var v83: array<int> := new int[20];
				v82[safeIndex(189, v82.Length)] := {v83, v83} - {v83, v83};
				var v84: array<map<C7, int>> := new map<C7, int>[7];
				var v85: C7 := new C7(v24[safeIndex(772, v24.Length)]);
				var v86: map<C7, int> := map[v85 := v0];
				v84[safeIndex(936, v84.Length)] := v86;
				var v87: set<array<int>> := {v83};
				var v88: map<int, map<C7, int>> := map[safeModuloInt(v0, v0) := map[v85 := v0]];
				v0, v82[safeIndex(189, v82.Length)], v84[safeIndex(936, v84.Length)], v0, v21 := v0, v87, if ((v0 - v0) in v88) then v88[v0 - v0] else v86 + v86, v0, !v21;
				v21 := v21;
				...
				v98[safeIndex(348, v98.Length)] := if (v21) then v21 else v21;
				var v99: multiset<array<bool>> := multiset{v98};
				v97, v21, v98[safeIndex(348, v98.Length)] := v97, v99 > v99, v21;
				v0, v24[safeIndex(772, v24.Length)], v21 := -safeDivisionInt(v0, v0), if (v21) then v24[safeIndex(772, v24.Length)] else v24[safeIndex(772, v24.Length)], false;
				v98 := v98;
			}
			...
			var v105 := new C3(if (v21) then v101[safeIndex(|(seq(abs(0x14), i12  => (v24[safeIndex(772, v24.Length)])))|, |v101|)] else v100, v21, {if (v0 in v104) then v104[v0] else v21});
			v0 := v0;
			var v106: array<bool> := new bool[19](i13 => v21 || v105.f16);
			var v107: map<int, int> := map[|v26| := v0];
			v106[safeIndex(498, v106.Length)] := v0 in v107;
			var v108: multiset<int> := multiset{fm3(v21, globalState), 47, v0};
			var v109 := DC6(v21, true, v24[safeIndex(772, v24.Length)], |v27|, v21);
			v0, v106[safeIndex(498, v106.Length)], v100, v108 := |(v105.f15 + v100)|, v21, "ldxu", multiset{v109.cf13, v0};
		}
	...
	method m13(p0: bool, p1: bool, globalState: GlobalState) returns (r0: seq<string>) {
		...
		match (fm85([!p1, p1], seq(abs(0x39d), i0  => ('a')), v0, v6, globalState)) {
			case DC6(cf10, cf11, cf12, cf13, cf14) =>
				var v7: array<int> := new int[26];
				v7[safeIndex(798, v7.Length)] := cf13;
				v7[safeIndex(798, v7.Length)], v0 := cf13, v0;
				var v8 := DC10();
				var v9 := DC11(v8);
				var v10 := DC11(v9);
				match (v10) {
					case DC10() =>
						...
						v11[safeIndex(481, v11.Length)] := v12;
						v11[safeIndex(481, v11.Length)] := v12;
						var v13: map<seq<int>, int> := map[v3 := v7[safeIndex(798, v7.Length)]];
						var v14 := new C10(v13, cf14);
						var v15 := DC49(v7[safeIndex(798, v7.Length)], v7[safeIndex(798, v7.Length)], v7);
						var v16: array<D18> := new D18[1] [v15];
						var v17: seq<bool> := [cf14];
						var v18: map<bool, char> := map[false := v1];
						var v19: seq<seq<bool>> := [v17];
						var v20: array<seq<bool>> := new seq<bool>[7] [v17 + fm0(cf10, v7[safeIndex(798, v7.Length)], v14.f9, globalState), v17, if (cf11) then v17 else v17, v17, v17, fm0(v14.f9, DC1(v12, cf13, p1, v18, cf11).cf2, true, globalState), v19[safeIndex(|v2|, |v19|)]];
						v20[safeIndex(673, v20.Length)] := v17;
						v16, v20[safeIndex(673, v20.Length)], cf14 := v16, v17 + v17[safeIndex(|v2|, |v17|) := p0], cf11 <== cf11;
						...
						v22, v7[safeIndex(798, v7.Length)], v24 := v22, (if (p0) then |v2| else v0) - (if (cf11) then v0 else cf13), (v24 + v24)[safeIndex(--|(seq(abs(0x13), i1  => (cf12)))|, |(v24 + v24)|) := v23];
					case DC9(cf18) =>
						cf14 := fm1(cf14, fm3(cf14, globalState), globalState) <==> p1;
						v4 := v4[v0 := v7[safeIndex(798, v7.Length)]];
						var v25: T0 := new C1(cf12, f2);
						v25 := v25;
						var v26: map<char, int> := map[v1 := cf13];
						var v28: map<char, bool> := map[cf12 := cf11];
						v26 := map v27 : char | v27 in v28 :: (v27) := (if (cf10) then cf13 else v7[safeIndex(798, v7.Length)]);
					case DC11(cf19) =>
						var v29: map<bool, int> := map[p0 := cf13];
						v7[safeIndex(798, v7.Length)] := -(-(if (p1 in v29) then v29[p1] else v0) * v7[safeIndex(798, v7.Length)]);
						var v30: map<int, bool> := map[v0 := cf14];
						var v31: multiset<int> := multiset{v7[safeIndex(798, v7.Length)], |v30|};
						cf14 := (v31 - multiset(v3)) > (if (false) then v31 else multiset{v7[safeIndex(798, v7.Length)]});
						var v32 := DC53(!p1, -v0);
						v4 := v4[v32.cf103 := 655 - v0];
						var v33: map<array<int>, int> := map[v7 := -|v2|];
						v33 := v33[v7 := safeModuloInt(0x3d8, cf13)];
				}
				
				v2 := v2;
				var v34: set<int> := {v0, v7[safeIndex(798, v7.Length)], cf13, cf13};
			...
			case DC7(cf15, cf16) =>
				...
				if (fm21(v2 + v2, p0, v0, globalState)) {
					...
					cf15 := fm21(v2, !cf15, |v38[safeIndex(v0, |v38|)]|, globalState) <==> DC43(!p0, v2, p1, cf15, p0).cf76;
					cf15 := cf15;
					v0 := |v3[safeIndex(v0, |v3|) := |v2|]|;
					var v39: map<array<bool>, int> := map[v36 := v0];
					v39 := v39[v36 := v0];
					v3 := [v0];
				} else {
					v0 := safeDivisionInt(0x1d1, v0);
					...
					v36[safeIndex(731, v36.Length)] := !(v44 != v44);
					v36[safeIndex(731, v36.Length)] := if (fm21(v2, true, 0x54, globalState)) then p1 else cf15;
				}
			...
			case DC5(cf9) =>
				...
				v46[safeIndex(587, v46.Length)] := v2;
				v46[safeIndex(587, v46.Length)] := if (if (p1) then p0 else p0) then seq(abs(0x223), i3  => (v45.f18)) else v2;
				v2 := v46[safeIndex(587, v46.Length)];
				v0 := fm3(p0, globalState);
			case DC8(cf17) =>
				var v47: array<seq<bool>> := new seq<bool>[1](i4 => [p0, p1]);
				var v48: seq<bool> := [p1, false];
				v47[safeIndex(855, v47.Length)] := v48;
				v47[safeIndex(855, v47.Length)] := [p1, p1] + v48;
				var v49 := true;
				var v50: array<seq<seq<D19>>> := new seq<seq<D19>>[28];
				var v51 := DC53(p1, |v47[safeIndex(855, v47.Length)]|);
				var v52 := DC54(v51);
				var v53 := DC54(DC54(v51));
				var v54: seq<D19> := [v53];
				var v55: seq<seq<D19>> := [v54];
				v50[safeIndex(142, v50.Length)] := v55;
				var v56 := DC43(p1, v2, false, v49, true);
				var v57 := DC3(v1);
				var v58: seq<D1> := [v57];
				var v60 := DC7(v56.cf78, set v59 : D1 | v59 in v58 :: (v59));
				v0, v49, v50[safeIndex(142, v50.Length)], v49 := v3[safeIndex(|fm4(p0, v0, v0, v0, globalState)|, |v3|)], p1, v55 + v55, !v60.cf15;
				var v62: multiset<seq<int>> := multiset{v3, [v0, -v0, v0, |(map v61 : int | v61 in fm86(p0, globalState) :: (v61 + v0) := (v0))|], v3, v3[safeIndex(v0, |v3|) := v0]};
		...
		for i5 := |v65| to v0 {
			...
			var v67: seq<bool> := [p0];
			var v68: array<bool> := new bool[20] [p0, false, p0, v66 != v66, false, p1, p0, p0, fm3(p1, globalState) < |fm28(i5, globalState)|, p1, p1, p0, v2 != v2, p1, v67[safeIndex(v0, |v67|)], fm21(v2, true, v0, globalState) <==> !p1, !!p1, p0, false, fm1(false, i5, globalState)];
			var v69: seq<seq<bool>> := [v67];
			var v70: map<bool, int> := map[p1 := |multiset(v69)|];
			v68[safeIndex(601, v68.Length)] := v67[safeIndex(if (p0 in v70) then v70[p0] else i5, |v67|)];
			v68[safeIndex(601, v68.Length)] := true;
			v68[safeIndex(601, v68.Length)], v68[safeIndex(601, v68.Length)] := false, (i5 - v0) >= i5;
		...
		match (if (p0) then DC48(v91) else DC48(v92[safeIndex(v0, |v92|)])) {
			case DC49(cf90, cf91, cf92) =>
				v1 := v1;
				var v93 := DC29(v3);
				v93 := v93;
				...
				if (f2 != {false, if (p1 in v94) then v94[p1] else p0}) {
					...
					v95[safeIndex(225, v95.Length)] := -0x365 != -v0;
					v95[safeIndex(556, v95.Length)] := p1;
					var v96 := true;
					v95[safeIndex(225, v95.Length)], v95[safeIndex(556, v95.Length)], v96 := [-cf91, cf90] <= v3, v90 == v90, p1 <== v96;
					v95[safeIndex(225, v95.Length)] := f2 >= f2;
					v96 := v0 > cf91;
					var v97 := DC26(v90);
				...
				v105 := 'q' !in (v2 + v2);
			case DC50(cf93, cf94, cf95) =>
				cf95 := safeModuloInt(cf95, v0);
				v2 := fm22(cf95, cf95, globalState) + "rn";
				var v106: array<int> := new int[23](i9 => safeDivisionInt(i9, v0));
			...
			case DC51(cf96, cf97, cf98, cf99, cf100) =>
				...
				v110[safeIndex(897, v110.Length)] := p1;
				...
				v113[safeIndex(44, v113.Length)] := v111;
				v110[safeIndex(897, v110.Length)], v113[safeIndex(44, v113.Length)], cf97 := (v63 * v63) !! v63, v111, |v2|;
				cf98 := 0x25a;
				v110[safeIndex(897, v110.Length)] := p0;
				var v114: set<array<int>> := {v113[safeIndex(44, v113.Length)], v113[safeIndex(44, v113.Length)], v113[safeIndex(44, v113.Length)], v111, v113[safeIndex(44, v113.Length)]};
				cf100 := |v114|;
			case DC48(cf89) =>
				if (p0) {
					var v115 := false;
					v115 := !p1 ==> p0;
					v0 := safeDivisionInt(|(v2 + v2)|, v0);
					var v116: array<int> := new int[9](i10 => i10 + v0);
					v116[safeIndex(157, v116.Length)] := |v6| - fm3(p1, globalState);
					v116[safeIndex(157, v116.Length)] := v0 - v0;
					v116[safeIndex(157, v116.Length)] := v0;
					v3 := v3;
				} else {
					...
					v120 := v120[v2[safeIndex(|v4|, |v2|)] := 0x1de];
				...
				v0 := safeModuloInt(v0, 256);
				if (false ==> false) {
					var v123: array<int> := new int[29];
					v123[safeIndex(710, v123.Length)] := |fm49(-v3[safeIndex(v0, |v3|)], |[v0]|, |v3|, globalState)|;
					var v124 := true;
					v123[safeIndex(710, v123.Length)], v124, v0 := v0, p0, v0;
					var v125: map<bool, array<int>> := map[p0 := v123];
					v0 := v0 - (0xa0 - |v125|);
					var v126: array<bool> := new bool[11];
					var v127: map<int, multiset<bool>> := map[v123[safeIndex(710, v123.Length)] := v63];
					v126[safeIndex(818, v126.Length)] := (if (v123[safeIndex(710, v123.Length)] in v127) then v127[v123[safeIndex(710, v123.Length)]] else v63) == v63;
					var v128: map<int, bool> := map[v123[safeIndex(710, v123.Length)] := false || p1];
					v126[safeIndex(818, v126.Length)] := if (v0 in v128) then v128[v0] else !p1;
					var v129: seq<bool> := [p0];
					var v130 := DC22(v123, |v129|, p0, fm3(v124, globalState));
					v130 := v130;
					var v131 := new C3(v2, v126[safeIndex(818, v126.Length)], {!v126[safeIndex(818, v126.Length)], v124});
				} else {
					var v132: T1 := new C6();
					...
					v135[safeIndex(930, v135.Length)] := v0;
					var v136: array<bool> := new bool[27](i11 => v0 <= v0);
					v136[safeIndex(187, v136.Length)] := v134;
					var v137: map<int, bool> := map[v0 := p1];
					var v138 := DC44(if (v0 in v137) then v137[v0] else v134, p1, p1);
					v134, v135[safeIndex(930, v135.Length)], v136, v134, v136[safeIndex(187, v136.Length)] := f2 >= ({p1, p0} + f2), v0, v136, !v138.cf81, !('r' !in v2);
					var v139: seq<string> := [v2, v2];
					v2 := (v2 + v2)[safeIndex(v135[safeIndex(930, v135.Length)], |(v2 + v2)|) := v1] + v139[safeIndex(v0, |v139|)];
					v135[safeIndex(930, v135.Length)] := v0;
				}
	...
	method m14(globalState: GlobalState) returns (r0: int, r1: int) {
		...
		var v2 := -970;
		var i0 := 0;
		while (fm1(v1[safeIndex(v2, |v1|)], v2, globalState) && v0)
			decreases 100 - i0
		{
			if (i0 >= 100) {
				break;
			...
			v10[safeIndex(921, v10.Length)] := v11;
			var v12 := DC71(v11);
			v10[safeIndex(921, v10.Length)] := v12.cf126;
			var v13: set<bool> := {if (false) then v0 else v0, v0};
			v13 := f2;
			var v14: seq<int> := [v2];
			v9[safeIndex(425, v9.Length)] := v6 !in map[v7 := v14];
			var v15: multiset<bool> := multiset{!v0, v0, v0};
			v9[safeIndex(425, v9.Length)] := multiset{v0} >= v15;
		}
		var i1 := 0;
		while (safeDivisionInt(-v2, 0x2a4) > |v1|)
			decreases 100 - i1
		{
			if (i1 >= 100) {
				break;
			...
			v16, r1, v0, v17 := fm73(v18, v20, v21, v2, globalState), v2, v0 && (|v23[safeIndex(v2, |v23|) := v22]| == -v2), v17;
			...
			v25 := v25[|v18| := v2 + -|v26|];
			v22[safeIndex(216, v22.Length)] := v2 * |v21|;
			v22[safeIndex(216, v22.Length)], r0 := fm3(!(v0 ==> v0), globalState), v2;
			r0 := safeModuloInt(|v18| * |map[v0 := v0]|, 0x1d2);
		}
		var i2 := 0;
		while (v0)
			decreases 100 - i2
		{
			...
			v27[safeIndex(129, v27.Length)] := v2;
			v27[safeIndex(129, v27.Length)] := v2;
			var v28: array<bool> := new bool[20];
			var v29: map<array<bool>, bool> := map[v28 := v0];
			var v30: map<int, map<array<bool>, bool>> := map[-v2 := v29];
			v29 := map[v28 := v0] + (if (v27[safeIndex(129, v27.Length)] in v30) then v30[v27[safeIndex(129, v27.Length)]] else v29);
			v28 := new bool[2];
			var v31 := 'l';
			var v32: map<int, map<char, bool>> := map[v2 := map[v31 := v0]];
			var v34: seq<char> := [v31, v31];
			v32 := v32[v27[safeIndex(129, v27.Length)] := (map v33 : char | v33 in v34 :: (v33) := (v0)) + map[v31 := true]];
		}
		...
		if (v0 || true) {
			...
			var v36 := DC27(v35, v2);
			v36 := v36;
			var v37: array<int> := new int[17](i3 => safeDivisionInt(i3, |"mpgnjj"|));
			v37[safeIndex(186, v37.Length)] := v2;
			v37[safeIndex(186, v37.Length)] := -safeModuloInt(v2, v2);
			var v38: array<bool> := new bool[4];
			var v39 := "pvtc";
			var v40: set<int> := {0x1bd};
			v38 := new bool[17] [fm21(v39, true, v37[safeIndex(186, v37.Length)], globalState), multiset(v1) !! v35, !v0, v0, v0, v0 <==> v0, v0, v0, v1 == v1, v0, v0, v0 <== v0, v0, !(DC44(v0, v0, v0).cf83 ==> v0), v0, v40 >= fm4(v0, v2, v2, v37[safeIndex(186, v37.Length)], globalState), !v0];
			var v41 := DC10();
			var v42 := new C9(v1, v41);
			var v43: seq<int> := [v2, v37[safeIndex(186, v37.Length)], v37[safeIndex(186, v37.Length)]];
			v38[safeIndex(321, v38.Length)] := fm1(v0, |v43[safeIndex(v37[safeIndex(186, v37.Length)], |v43|) := v2]|, globalState);
			v38[safeIndex(321, v38.Length)] := f2 == {v0, fm1(v0, v2, globalState), v0};
		} else {
			...
			v47[safeIndex(821, v47.Length)] := v45;
			...
			var v53: array<int> := new int[19] [v2, v2, |v48|, v2, v2, v2, v2, v50.cf37, v2, v2 * v2, v2, |v1|, |v51|, v2, safeModuloInt(v2, v2), if (true) then v2 else |v52|, -safeDivisionInt(|v51|, |v1|), safeModuloInt(v2, v2), v2];
			v47[safeIndex(821, v47.Length)], v49, v0, v0, r0 := v45, v53, v0, !v0, fm3(v0 <== v0, globalState);
			if ((v0 <==> v0) && v0) {
				var v54 := 'h';
				var v55 := DC43(v0, v51, v0, v0, v0);
				var v56: array<string> := new string[27] [v51, v51, v51, v51, v51, v51, v51, seq(abs(781), i5  => ('s')), seq(abs(0x5e), i6  => ('o')), v51, v51[safeIndex(|{v2}|, |v51|) := v54], v51, seq(abs(0x1e5), i7  => (v54)), v51, "ej", v51, seq(abs(0x92), i8  => (v54)), fm42(globalState), v51, v55.cf77, seq(abs(0x28d), i9  => (v51[safeIndex(v2, |v51|)])), v51, v51, v51, v51, v51, fm47(globalState)];
				var v57 := DC32(v56);
				v57 := v57;
				var v58 := new C9(v1, DC10());
				v0 := v0 && v0;
				v49[safeIndex(401, v49.Length)] := -v2 + v2;
				v49[safeIndex(401, v49.Length)], v0, v51 := fm3(v0, globalState), v0, v44[safeIndex(v2, |v44|)];
				var v60 := DC47(map v59 : int | (-0xc1 <= v59) && (v59 < 0x2da) :: (v59 - v2) := (v0));
				v54 := v51[safeIndex(|(DC24(|v60.cf88|, v49[safeIndex(401, v49.Length)], v58.f10).cf43 + v58.f10)|, |v51|)];
			} else {
				var v61: array<bool> := new bool[21](i10 => v0);
				var v62: seq<array<bool>> := [v61, v61, v61];
				r0 := |v62|;
				r1 := safeDivisionInt(if (v0) then 0x150 else v2, v2);
				var v63: array<seq<D13>> := new seq<D13>[10];
				var v64: array<array<seq<D13>>> := new array<seq<D13>>[4] [v63, v63, v63, v63];
				v64[safeIndex(329, v64.Length)] := v63;
				var v65: set<int> := {v2};
				v0, v64[safeIndex(329, v64.Length)] := v65 > v65, v63;
				var v66 := new C2(v51 <= (seq(abs(0x1f), i11  => ('y'))));
				var v67: map<string, int> := map[v44[safeIndex(|v46|, |v44|)] := 0x2fd];
				var v68 := DC39(v67);
				v68 := v68;
			}
		...
		var v69: array<int> := new int[21](i13 => safeDivisionInt(i13, v2));
		forall i12 | 0 <= i12 < v69.Length {
			v69[i12] := safeDivisionInt(i12, |(multiset{v0, v0} - multiset(v1))|);
		}
		r0 := v2;
		var v70: seq<int> := [v2];
		var v71: seq<int> := [|v70|, if (v0) then v2 else v2];
		r1 := v70[safeIndex(v2, |v70|)];
	}
}
...
class C13 {
	...
	function fm19(p0: int, globalState: GlobalState): int {
		-safeModuloInt(|([false] + [false])|, 0x1f8)
	}
	...
	method m11(p0: array<seq<D3>>, p1: int, globalState: GlobalState) returns (r0: map<map<bool, int>, array<bool>>) {
		...
		var v1 := false;
		v0[safeIndex(895, v0.Length)] := v1;
		var v3: set<bool> := {false, false};
		var v4 := DC3('f');
		var v5: map<set<bool>, D1> := map[v3 := v4];
		var v6 := DC16(v5);
		v0[safeIndex(895, v0.Length)] := (map v2 : set<bool> | v2 in (seq(abs(990), i1  => ({v1, v1})))[safeIndex(p1, |(seq(abs(990), i1  => ({v1, v1})))|) := v3] :: (v2) := (DC3('c'))) != v6.cf26;
		var v7: multiset<bool> := multiset{v0[safeIndex(895, v0.Length)]};
		for i2 := p1 to fm20(v7, v0[safeIndex(895, v0.Length)], false, -0x2fe, globalState) {
			var v8 := 0x25a;
			var v9 := "v";
			v8 := -|("gimwf" + (v9 + v9))|;
			var v10: set<int> := {i2};
			if (if ({0xf7} !! v10) then v1 else if (true) then v0[safeIndex(895, v0.Length)] else v0[safeIndex(895, v0.Length)]) {
				v0 := v0;
				v8 := v8 + p1;
				var v11: seq<bool> := [v0[safeIndex(895, v0.Length)]];
				var v12: map<int, seq<bool>> := map[i2 := v11];
				var v13 := new C8(v0[safeIndex(895, v0.Length)], v12);
				var v14 := DC24(i2, v13.fm32(i2, v1, globalState), v11);
				v14 := v14;
				var v15: seq<int> := [v8];
				v0[safeIndex(895, v0.Length)] := ([-|v15|, v8] + v15) != v15;
			} else {
				var v16 := new C12(v3);
				var v17 := 'r';
				...
				v20[safeIndex(464, v20.Length)] := i2;
				v17, v20[safeIndex(464, v20.Length)] := v17, i2;
				v0[safeIndex(895, v0.Length)] := i2 == v8;
				v20 := v20;
				var v21 := new C7(v17);
			}
			
			var v22: array<int> := new int[1](i3 => i3 - v8);
			v22[safeIndex(103, v22.Length)] := v8;
			var v23: map<bool, int> := map[!v0[safeIndex(895, v0.Length)] := -0x329];
			var v24: map<bool, bool> := map[!v1 := fm1(v1, i2, globalState)];
			var v25: seq<int> := [|v24|];
			v22[safeIndex(103, v22.Length)] := (if (v0[safeIndex(895, v0.Length)] in v23) then v23[v0[safeIndex(895, v0.Length)]] else |v25|) - i2;
			var v26: map<int, int> := map[v8 - i2 := i2];
			var v27: map<bool, array<int>> := map[v1 := v22];
			var v28: seq<array<int>> := [if (!v0[safeIndex(895, v0.Length)] in v27) then v27[!v0[safeIndex(895, v0.Length)]] else v22, v22];
			var v29 := 'b';
			var v30: multiset<char> := multiset{v29};
			var v31: multiset<int> := multiset{|multiset{v30, v30}|};
			var v32: array<array<int>> := new array<int>[27] [v22, v22, v22, v22, if (v1) then v22 else v22, v22, v22, v28[safeIndex(0x133, |v28|)], v22, v22, v22, v22, v22, v22, v22, v22, v28[safeIndex(i2, |v28|)], v22, v22, v28[safeIndex(|v31|, |v28|)], v22, v22, v22, v22, v22, v22, v22];
			v32[safeIndex(135, v32.Length)] := v22;
			v26, v0[safeIndex(895, v0.Length)], v0[safeIndex(895, v0.Length)], v8, v32[safeIndex(135, v32.Length)] := v26 + v26, v0[safeIndex(895, v0.Length)], if (v0[safeIndex(895, v0.Length)]) then v22[safeIndex(103, v22.Length)] >= i2 else v0[safeIndex(895, v0.Length)], v8, if (v3 !! v3) then v22 else v22;
		}
		var v33: array<seq<string>> := new seq<string>[3](i4 => ["vfb", "osqbdqqvi", seq(abs(0x93), i5  => ('v'))]);
		var v34 := "bkffgroge";
		var v35: seq<string> := ["m", v34];
		v33[safeIndex(718, v33.Length)] := [v34] + v35;
		v33[safeIndex(718, v33.Length)] := v35;
		var v36: seq<bool> := [v1];
		var v37: map<int, bool> := map[0x1c0 := v0[safeIndex(895, v0.Length)]];
		var v38: map<set<int>, int> := map[fm4(v36[safeIndex(p1, |v36|)], p1, -|v37|, p1, globalState) * {p1} := safeDivisionInt(p1, fm19(|v34|, globalState))];
		v38 := v38;
		...
		match (v40) {
			case DC41(cf71, cf72, cf73, cf74) =>
				var v41: set<int> := {-p1};
				v0[safeIndex(895, v0.Length)] := fm1(v41 !! v41, |v3|, globalState);
				var v42 := new C5();
				cf73 := p1;
				var v43: array<multiset<int>> := new multiset<int>[27];
				var v44: array<map<int, bool>> := new map<int, bool>[7];
				v44[safeIndex(532, v44.Length)] := v37;
				v0[safeIndex(895, v0.Length)], v43, v1, v44[safeIndex(532, v44.Length)] := cf71, v43, v0[safeIndex(895, v0.Length)], map[cf73 := v0[safeIndex(895, v0.Length)]] + v37;
			case DC40(cf70) =>
				v0[safeIndex(895, v0.Length)] := v1;
				var v45 := 0x380;
				v45 := fm20(v7, v45 >= p1, v0[safeIndex(895, v0.Length)], p1, globalState);
				var v46: set<int> := {v45, v45};
				v45 := safeDivisionInt(0x15a, p1) - (|v46| - v45);
				v0[safeIndex(895, v0.Length)], v1 := v1, false;
		}
	...
	method m12(p0: bool, p1: array<int>, p2: multiset<bool>, globalState: GlobalState) returns (r0: int, r1: bool, r2: map<bool, map<D2, int>>, r3: int) {
		...
		if (!p0) {
			if (p0) {
				...
				var v2: seq<bool> := [v1[safeIndex(0x301, |v1|)]];
				var v3 := DC53(p0, if (p0) then |multiset(v2)| else v0);
				var v4 := "i";
				var v5: seq<int> := [|v4|];
				v3 := DC53(p0, v5[safeIndex(v0, |v5|)]).(cf103 := v0);
				var v6: array<bool> := new bool[28](i0 => p0);
				var v7: seq<array<bool>> := [v6];
				var v8: map<bool, bool> := map[p0 := (DC41(p0, p0, v0, v7[safeIndex(v0, |v7|)]).(cf72 := p0, cf74 := v6)).cf72];
				var v9: set<bool> := {p0, p0};
				var v10 := DC4(p0);
				var v11: map<array<bool>, array<int>> := map[v6 := p1];
				var v12: array<bool> := new bool[26] [p0, v4 <= "lga", p0, p0, p0, if (p0 in v8) then v8[p0] else p0, v0 != v0, p0 ==> p0, p0, p0, p0, v9 >= v9, p0, v10.cf8, v0 == 627, v4[safeIndex(v0, |v4|)] !in v4, fm1(p0, v0, globalState), p0, p0, p0, !p0, p0, v4[safeIndex(v0, |v4|)] !in "mhjqdqoqv", |v9| <= |v11|, p0, false];
				v6[safeIndex(533, v6.Length)] := p0;
				v6[safeIndex(533, v6.Length)] := v2[safeIndex(-v0, |v2|)];
				v6[safeIndex(533, v6.Length)] := p0;
				var v13 := 'x';
				v4 := fm27(p0, |v4[safeIndex(|v5|, |v4|) := v13]|, v6[safeIndex(533, v6.Length)], v6[safeIndex(533, v6.Length)], globalState) + v4;
				v6[safeIndex(533, v6.Length)] := fm1(v6[safeIndex(533, v6.Length)], v0, globalState);
			} else {
				...
				v21[safeIndex(597, v21.Length)] := v14;
				v21[safeIndex(597, v21.Length)] := v14;
				r1 := 0x307 <= v0;
				r0 := v0;
				r1 := p0;
				p1[safeIndex(714, p1.Length)] := v0;
				var v22: set<bool> := {p0};
				...
				var v27: seq<array<bool>> := [v21[safeIndex(597, v21.Length)]];
				p1[safeIndex(714, p1.Length)], v23, r1, v24 := if (fm64(fm1(fm1(p0, v0, globalState), |v17|, globalState), |(seq(abs(359), i1  => (v22)))|, v23[safeIndex(|p2|, |v23|)], |v22|, globalState) in v26) then v26[fm64(fm1(fm1(p0, v0, globalState), |v17|, globalState), |(seq(abs(359), i1  => (v22)))|, v23[safeIndex(|p2|, |v23|)], |v22|, globalState)] else safeDivisionInt(fm19(|v27|, globalState), v0), v23 + v23, v23[safeIndex(v0 + v0, |v23|)], v24;
			}
			...
			var v34 := "qivdghv";
			var v35: array<bool> := new bool[6] [p0, !p0, |v31| <= |v33|, p0, true, (seq(abs(0x47), i2  => (v32))) < v34];
			v35[safeIndex(886, v35.Length)] := p0 || p0;
			v28, v29, v35[safeIndex(886, v35.Length)], v32 := v28, v29, p0, v32;
			var v36: map<bool, bool> := map[p0 := p0];
			var v37 := new C3(v34, !!p0 !in v36, v28 + v28);
			if (p0 ==> v35[safeIndex(886, v35.Length)]) {
				var v38: map<int, bool> := map[0xd := v37.f16 || v37.f16];
				v38 := v38[v0 := v37.f16];
				v37.f16 := v37.f16;
				v36 := v36[-v0 == v0 := v37.f16];
				v35[safeIndex(886, v35.Length)] := ([v0] <= v31) <==> (v0 > v0);
				v37.f16 := v35[safeIndex(886, v35.Length)];
			} else {
				v35[safeIndex(886, v35.Length)] := v37.f16;
				var v39: C7 := new C7(v32);
				var v40: seq<C7> := [v39];
				v37.f16 := v39 in v40;
				var v42: map<char, int> := map['w' := v0];
				var v43: map<int, int> := map[|v42| := v0];
				var v44 := DC9(map v41 : int | v41 in v43 :: (safeModuloInt(v41, v0)) := (seq(abs(0x36), i3  => (v39.f14))));
				var v45: map<int, string> := map[0xf2 := v34];
				var v46: seq<D3> := [v44, DC9(v45), v44];
				p1[safeIndex(96, p1.Length)] := v39.fm35(globalState);
				var v47: seq<string> := [v37.f15, v37.f15];
				v46, v0, v32, p1[safeIndex(96, p1.Length)] := fm88(v0, v37.f16, globalState), v0, 'n', |v47|;
				var v48: map<int, bool> := map[|v28| := !(v37.f16 <==> v37.f16)];
				v48 := v48[fm19(v0, globalState) := p0];
				v37.f15 := seq(abs(433), i4  => (v32));
			}
			...
			v53 := v53[p0 := (seq(abs(0x21b), i5  => ('i'))) + "btqoswhdk"];
			var v54: set<bool> := {p0};
			var v55 := DC19([v54]);
			...
			if (if (v61 !! v61) then !p0 else p0) {
				...
				var v63 := 'v';
				v57[safeIndex(233, v57.Length)] := if (p0) then p0 else p0;
				v62, v63, v57[safeIndex(233, v57.Length)] := v62 + v62, v63, p0;
				r3 := -fm19(0x69, globalState);
				var v64: array<string> := new string[22];
				var v65: seq<string> := [v49, seq(abs(0x83), i6  => (v63))];
				var v66: map<map<bool, bool>, int> := map[v60 := -847];
				v64[safeIndex(4, v64.Length)] := v65[safeIndex(|v66|, |v65|)];
				v64[safeIndex(4, v64.Length)] := v49;
				r1 := v57[safeIndex(233, v57.Length)];
				v57[safeIndex(233, v57.Length)] := p0 || v57[safeIndex(233, v57.Length)];
			} else {
				var v67 := 'b';
				...
				var v72 := DC39(v70 + v71[safeIndex(v0, |v71|)]);
				v72 := v72;
		...
		for i7 := v0 to v0 {
			...
			p1[safeIndex(242, p1.Length)] := i7;
			v76, v0, p1[safeIndex(242, p1.Length)] := v76, 0x2ec, fm20(p2, true, p0, fm19(|p2|, globalState), globalState);
			r1 := p0;
			var v77: seq<int> := [i7, v0];
			if (v77[safeIndex(i7, |v77|)] == 0x325) {
				var v79: set<seq<int>> := {v77};
				var v80: seq<bool> := [p0];
				var v81 := "rc";
				var v82 := DC51(v80[safeIndex(|v80|, |v80|)], |v81|, 0x26c, v80, v0);
				var v83: set<bool> := {p0};
				var v84: array<int> := new int[13] [-v0, v82.cf98, i7, p1[safeIndex(242, p1.Length)], i7, |v81|, i7, p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)], v77[safeIndex(|v83|, |v77|)], p1[safeIndex(242, p1.Length)], i7];
				var v85 := DC22(v84, 0x38f, p0, i7);
				var v86: array<int> := new int[23] [v0, p1[safeIndex(242, p1.Length)], i7, v0, v0, |v77|, |p2| + 0x3c0, -(-p1[safeIndex(242, p1.Length)] - p1[safeIndex(242, p1.Length)]), v0, p1[safeIndex(242, p1.Length)], v0, ---(v0 + p1[safeIndex(242, p1.Length)]), |(map v78 : seq<int> | v78 in v79 :: (v78) := (p1[safeIndex(242, p1.Length)]))|, p1[safeIndex(242, p1.Length)], safeDivisionInt(p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)]), -i7, p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)], v0 * p1[safeIndex(242, p1.Length)], v0, |multiset{v85.cf38, p0, p0}|, v0];
				v86 := v84;
				r0 := i7;
				r1 := p0;
				var v87 := 'q';
				r1 := v0 < (|v81[safeIndex(v0, |v81|) := v87]| - p1[safeIndex(242, p1.Length)]);
				r1 := i7 > i7;
			} else {
				var v89: array<map<int, string>> := new map<int, string>[22](i9 => map[p1[safeIndex(242, p1.Length)] := "xtl"] + (map v88 : int | v88 in {i7} :: (safeDivisionInt(v88, |(seq(abs(857), i10  => ('y')))|)) := ("pgtjoqs")));
				var v90 := "opti";
				var v91: map<int, string> := map[fm3(true, globalState) := v90];
				v89[safeIndex(75, v89.Length)] := fm89(i7, globalState) + v91[v0 := v90];
				var v92: map<seq<int>, int> := map[v77 := -i7];
				var v93: C10 := new C10(v92, p0);
				var v94: map<int, C10> := map[-0x3db := v93];
				v89[safeIndex(75, v89.Length)] := (fm89(|v94|, globalState))[safeDivisionInt(p1[safeIndex(242, p1.Length)], v0) := v90 + v90];
				p1[safeIndex(242, p1.Length)] := p1[safeIndex(242, p1.Length)];
				v0 := v0;
				v0 := i7;
				var v95 := 'w';
				v95 := 'r';
			...
			var v96 := "caf";
			var v97: map<seq<int>, int> := map[[|v96|, 288] := |(seq(abs(0x27a), i11  => (v0)))|];
			var v98: C10 := new C10(if (p0) then v97 else v97, p0);
			var v99 := DC50(true, v98.f9, i7 + v0);
			var v100 := 'y';
			var v101: array<char> := new char[28] [v100, v100, v100, v100, v100, fm48(v98.f9, i7, globalState), v100, 'v', v100, v100, v100, v96[safeIndex(v0, |v96|)], 'w', v100, v100, v100, v100, v96[safeIndex(v0, |v96|)], if (v98.f9) then v100 else v100, v96[safeIndex(i7, |v96|)], v100, v100, v100, v100, v100, 'y', v100, if (p0) then v100 else v100];
			var v102: map<bool, int> := map[p0 := v0];
			var v103: set<string> := {v96, seq(abs(-0x221), i12  => (v100))};
			var v104: set<int> := {p1[safeIndex(242, p1.Length)], p1[safeIndex(242, p1.Length)]};
			v98, v99, r0, v101, p1[safeIndex(242, p1.Length)] := v98, fm73(v77, v102 + v102, v96, |(v103 - {v96})|, globalState), safeDivisionInt(p1[safeIndex(242, p1.Length)] + |v104|, 0x391), v101, -p1[safeIndex(242, p1.Length)];
		}
		...
		match (DC21(p0, v106 + fm49(v0, v0, v0, globalState), (if (p0 in v106) then v106[p0] else p0) || p0, v0)) {
			case DC20(cf29, cf30, cf31) =>
				...
				var v108 := DC3(cf29);
				var v109: map<string, map<set<bool>, D1>> := map[seq(abs(-0x34a), i13  => (cf29)) := map[v107 := v108]];
				var v110 := "xi";
				...
				match (v112) {
					case DC17() =>
						...
						cf30 := v113[safeIndex(-v114[safeIndex(v0, |v114|)], |v113|)];
						...
						var v116: array<bool> := new bool[16] [true, cf30, p0, p0, p0, !cf30, !p0, p0, fm1(cf30, v0, globalState), cf30, p0, cf30, v113[safeIndex(v0, |v113|)], p0, !cf30, cf30];
						var v117: map<array<bool>, bool> := map[v116 := false];
						var v118: seq<array<bool>> := [v116];
						var v119: map<int, map<array<bool>, bool>> := map[v0 := v117];
						var v120: array<map<array<bool>, bool>> := new map<array<bool>, bool>[24] [v117, v117[v116 := p0], v117, v117, v117 + v117, v117, v117 + map[v118[safeIndex(-v0, |v118|)] := p0], v117, v117 + v117, map[v116 := cf30] + (if (v0 in v119) then v119[v0] else v117), v117, v117, v117 + v117, v117 + v117, v117, v117, v117, map[v116 := p0], v117, v117, v117, v117 + v117, v117, map[v116 := cf30]];
						v120[safeIndex(540, v120.Length)] := v117;
						v120[safeIndex(540, v120.Length)] := v117 + ((if (v0 in v119) then v119[v0] else v117[v116 := p0]) + v117);
					...
					case DC16(cf26) =>
						...
						v126 := v126[v125 := p0];
						var v127: map<D21, int> := map[DC57(seq(abs(414), i14  => (v0)), cf30, -337) := v0];
						v127 := v127;
				}
				...
				p1[safeIndex(798, p1.Length)] := v0;
				p1[safeIndex(934, p1.Length)] := -(v0 - v0);
				r0, p1[safeIndex(798, p1.Length)], v110, p1[safeIndex(934, p1.Length)] := -v0, v0, "eunsres" + v110, v0 * v0;
			case DC21(cf32, cf33, cf34, cf35) =>
				...
				v132 := v132[v0 + (if (true in v133) then v133[true] else |v134[safeIndex(cf35, |v134|) := cf35]|) := v131 * v131];
				var v135 := 'p';
				v135 := v135;
			...
			case DC22(cf36, cf37, cf38, cf39) =>
				...
				v137[safeIndex(524, v137.Length)] := p0;
				v137[safeIndex(524, v137.Length)] := p0;
				v137[safeIndex(524, v137.Length)] := p0;
				v137[safeIndex(524, v137.Length)] := cf38;
				var v138 := 'i';
				var v139 := DC3(v138);
				var v140: set<bool> := {v137[safeIndex(524, v137.Length)]};
				var v141 := DC16((map[{cf38, cf38, v137[safeIndex(524, v137.Length)]} := v139])[v140 := v139]);
				var v142: map<bool, char> := map[v137[safeIndex(524, v137.Length)] := v138];
				var v143 := "cjvhqh";
				v141, v138, r3, v137[safeIndex(524, v137.Length)] := v141, if (true in v142) then v142[true] else v138, v0, if ("ktvgjmfa" < v143) then v137[safeIndex(524, v137.Length)] else v137[safeIndex(524, v137.Length)];
			case DC19(cf28) =>
...
class C14 extends T1 {
	...
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
			...
			decreases 100 - i2
		{
			...
			v13[safeIndex(249, v13.Length)] := v11;
			var v14: seq<array<seq<bool>>> := [v11, v11, v11, v11];
			v13[safeIndex(249, v13.Length)] := v14[safeIndex(p0, |v14|)];
		...
		match (v18) {
			case DC10() =>
				...
				var v19: seq<int> := [p0, p0, p0, safeModuloInt(p0, p0), p0];
				r1 := v19[safeIndex(p0, |v19|)];
				if (if (p1) then v1 else if (true) then true else fm1(p1, p0, globalState)) {
					...
					v28 := v28[v25 := v27];
					v5[safeIndex(626, v5.Length)] := !true;
					v5[safeIndex(626, v5.Length)] := v1;
					v1 := v1;
					var v29: seq<bool> := [p1];
					var v30: map<seq<bool>, D3> := map[v29 := v18];
					v30 := v30[([!v1, p1] + v29)[safeIndex(|multiset{p1, v5[safeIndex(626, v5.Length)]}|, |([!v1, p1] + v29)|) := v1] := fm17(p0, v5[safeIndex(626, v5.Length)], v1, globalState)];
				} else {
					v1 := (p0 <= p0) ==> true;
					...
					v1 := v33[safeIndex(|"lkshmb"| + p0, |v33|)];
					v1 := v1;
					var v34: map<int, int> := map[p0 := |(seq(abs(0x30b), i3  => ('t')))|];
					var v36: seq<map<int, int>> := [map v35 : int | (-0x2d9 <= v35) && (v35 < 700) :: (safeModuloInt(v35, p0)) := (-p0), v34];
					var v37 := DC5(v33);
					var v38 := 'u';
					var v39 := DC6(v1, p1, v38, p0, p1);
					var v40 := DC14(v37, v39);
					var v41: multiset<D4> := multiset{v40, DC14(v37, DC6(v1, p1, v38, p0, v1))};
					var v42: map<multiset<D4>, string> := map[v41 := seq(abs(0x266), i4  => (v38))];
					var v43 := DC3(v38);
					r1, v34, v3, v36 := fm3(v1, globalState), v34, ((if (v41 in v42) then v42[v41] else v3)[safeIndex(|v33|, |(if (v41 in v42) then v42[v41] else v3)|) := v43.cf7])[safeIndex(|(v0 + v0)|, |(if (v41 in v42) then v42[v41] else v3)[safeIndex(|v33|, |(if (v41 in v42) then v42[v41] else v3)|) := v43.cf7]|) := v38], [v34, map[p0 := p0], map[p0 := p0]];
				}
			...
			case DC9(cf18) =>
				...
				v45[safeIndex(104, v45.Length)] := v5;
				v45[safeIndex(104, v45.Length)] := v5;
				var v46 := new C4();
			case DC11(cf19) =>
				...
				if ((multiset(v50) + multiset(v50)) !! v51) {
					...
					var v53: array<int> := new int[21];
					var v54: seq<int> := [p0];
					v53[safeIndex(831, v53.Length)] := |v54|;
					var v55: seq<bool> := [v1];
					var v56 := DC37(v1, v55, v3, p0);
					var v57: map<int, char> := map[|v56.cf65| := v48];
					var v58: map<bool, bool> := map[fm1(v55[safeIndex(p0, |v55|)], p0, globalState) := v1];
					var v59: set<bool> := {if (false in v58) then v58[false] else p1};
					var v60: C1 := new C1(if (p0 in v57) then v57[p0] else v48, v59);
					v53[safeIndex(831, v53.Length)], v60, v4 := safeModuloInt(p0, p0 * p0), v60, map v61 : string | v61 in (if (v1) then map["vqtbhvv" := v54] else map[v3 := v54]) :: (v61) := (true);
					v1 := v1;
					v53[safeIndex(831, v53.Length)] := p0;
					v5[safeIndex(982, v5.Length)] := if (p1) then if (v1 in v58) then v58[v1] else p1 else !p1;
					v5[safeIndex(982, v5.Length)] := v1;
				} else {
				...
				v3 := ((seq(abs(0xbf), i6  => ('j'))) + (v3 + v3))[safeIndex(0x160, |((seq(abs(0xbf), i6  => ('j'))) + (v3 + v3))|) := v48];
		}
	...
	method m10(p0: array<int>, p1: array<bool>, p2: bool, p3: int, globalState: GlobalState) returns (r0: string, r1: bool, r2: set<bool>, r3: int) {
		if (p2) {
			...
			p1[safeIndex(877, p1.Length)] := !v3.cf120;
			p1[safeIndex(877, p1.Length)] := v0.f17;
		} else {
			var v4: array<seq<bool>> := new seq<bool>[12];
			v4[safeIndex(755, v4.Length)] := [p2, p2];
			p0[safeIndex(453, p0.Length)] := p3;
			var v5: seq<bool> := [p2];
			var v6: map<int, string> := map[p3 := seq(abs(-825), i0  => ('y'))];
			var v7 := "iwfa";
			...
			v4[safeIndex(755, v4.Length)], p0[safeIndex(453, p0.Length)], r3 := v5, safeModuloInt(|((if (p3 in v6) then v6[p3] else v7) + v7)|, safeDivisionInt(|v11|, p3)), if (p2) then safeDivisionInt(p3, |v12[p2 := p3]|) else safeDivisionInt(p3, p3);
			var v13: array<map<int, bool>> := new map<int, bool>[24](i1 => v8);
			var v14 := DC71(v13);
			v14 := v14.(cf126 := v13).(cf126 := v13);
			if (p2) {
				var v15: map<bool, bool> := map[p2 := false];
				r1 := v5[safeIndex(|v15|, |v5|)];
				var v16 := DC28(DC26(v9));
				var v17 := DC28(v16);
				var v18: seq<D9> := [DC28(v16), v17, DC28(v16), v17, v17];
				var v19 := DC67(v18[safeIndex(p3, |v18|) := v17]);
				v19 := DC67(v18);
				r3 := p0[safeIndex(453, p0.Length)];
				var v20 := DC17();
				...
				r3 := p0[safeIndex(453, p0.Length)];
				var v23 := 'g';
				var v24: map<int, char> := map[p0[safeIndex(453, p0.Length)] := v23];
				var v25: set<bool> := {true};
				var v26 := new C1(if (|v25| in v24) then v24[|v25|] else v23, fm74(p2, true, globalState));
				r3 := p3;
				var v27 := DC43(p2, fm6(p2, p0[safeIndex(453, p0.Length)], globalState), p2, p2, p2);
				var v28: array<int> := new int[11] [-p3, p0[safeIndex(453, p0.Length)], |v7|, p3, p3, |v10|, p0[safeIndex(453, p0.Length)], p3, p3, -p3, -p0[safeIndex(453, p0.Length)]];
			...
			v31 := v31[v32.cf77 + v7 := -|v4[safeIndex(755, v4.Length)]|];
			if (p2) {
				p1[safeIndex(142, p1.Length)] := p2;
				p1[safeIndex(142, p1.Length)] := false;
				var v33 := DC37(p1[safeIndex(142, p1.Length)], v5[safeIndex(0x3bb, |v5|) := p2], "iasghoch", p3);
				var v34 := 'l';
				var v35: map<int, int> := map[p3 := p0[safeIndex(453, p0.Length)]];
				var v36 := DC20(v34, p1[safeIndex(142, p1.Length)], v35);
				var v37: map<bool, bool> := map[p2 := v36.cf30];
				p0[safeIndex(453, p0.Length)], r0, r3, r3, p1[safeIndex(142, p1.Length)] := |v10| * safeModuloInt(|v33.cf66|, p0[safeIndex(453, p0.Length)]), fm47(globalState), p0[safeIndex(453, p0.Length)], if (true) then p0[safeIndex(453, p0.Length)] else if (p2) then |v37| else p0[safeIndex(453, p0.Length)], (p3 > fm3(fm16(p3, v7, v4[safeIndex(755, v4.Length)], globalState), globalState)) || p1[safeIndex(142, p1.Length)];
				p0[safeIndex(453, p0.Length)] := p3;
				r3 := -307;
				p1[safeIndex(142, p1.Length)] := p0[safeIndex(453, p0.Length)] > 3;
			} else {
				p1[safeIndex(34, p1.Length)] := p2;
				var v38: set<array<bool>> := {p1};
				var v39 := DC36(v38);
				v7, p1[safeIndex(34, p1.Length)], v39 := v7, p2, v39;
				...
				var v47: map<D19, bool> := map[v46 := p1[safeIndex(34, p1.Length)]];
				var v48: array<int> := new int[18] [p3, p3, 0x4d, -0x364, p3, p3, 0x214, p3, -0x1fa, if (p0[safeIndex(453, p0.Length)] in v41) then v41[p0[safeIndex(453, p0.Length)]] else 0x1fa, p3, p0[safeIndex(453, p0.Length)], -|v47|, |(seq(abs(0x10c), i2  => (v7)))|, p0[safeIndex(453, p0.Length)], fm3(p1[safeIndex(34, p1.Length)], globalState), |v7|, -p3];
				var v49: map<array<int>, map<int, bool>> := map[v48 := map[p0[safeIndex(453, p0.Length)] := p2]];
				var v50: map<bool, map<array<int>, map<int, bool>>> := map[p2 := v49];
				v50 := v50[v40 > multiset(v4[safeIndex(755, v4.Length)]) := v49];
				var v51: array<bool> := new bool[27];
				var v52: seq<array<bool>> := [v51, v51, v51];
				var v53: seq<seq<array<bool>>> := [v52, [v51]];
				v52 := v52 + (v52 + v53[safeIndex(p0[safeIndex(453, p0.Length)], |v53|)]);
				p1[safeIndex(34, p1.Length)] := p1[safeIndex(34, p1.Length)];
				var v54 := DC15(|v9|, v5, p2);
				p1[safeIndex(34, p1.Length)] := p1[safeIndex(34, p1.Length)] in v54.cf24;
			}
		...
		r3 := if (v55[safeIndex(p3, |v55|)]) then p3 else safeModuloInt(p3, |v57|);
		for i3 := safeDivisionInt(p3, p3) to p3 {
			r3 := i3;
			var v58: map<array<int>, int> := map[p0 := p3];
			var v59: set<int> := {|v58|, |v56|};
			p1[safeIndex(575, p1.Length)] := !(v59 <= v59);
			p1[safeIndex(575, p1.Length)] := fm1(false, p3, globalState) || p2;
			var v60: multiset<int> := multiset{i3, 0x179};
			if (|v60| <= (i3 + -p3)) {
				var v61: map<set<int>, int> := map[v59 := i3];
				v61 := v61[set v62 : int | (0x23f <= v62) && (v62 < -521) :: (v62 - 0x1f6) := safeDivisionInt(i3, 49)];
				p1[safeIndex(575, p1.Length)] := p1[safeIndex(575, p1.Length)];
				var v63 := 'm';
				var v64: map<int, char> := map[i3 := v63];
				var v65: multiset<char> := multiset{v63, v63, if (i3 in v64) then v64[i3] else 'g', v56[safeIndex(i3, |v56|)], v63};
				var v66: map<string, bool> := map[v56 := p2];
				var v67: map<bool, int> := map[!(if (v56 in v66) then v66[v56] else p1[safeIndex(575, p1.Length)]) := p3];
				v65 := v65 - (v65 - v65[v63 := abs(|v67|)]);
				var v68: array<array<int>> := new array<int>[11];
				p0[safeIndex(442, p0.Length)] := |{true}|;
				var v69: map<int, bool> := map[i3 := p2];
				var v71 := DC51(p1[safeIndex(575, p1.Length)], |v56|, |fm50(globalState)|, v55, i3);
				r1, v68, p0[safeIndex(442, p0.Length)] := false, v68, safeDivisionInt(|(v69 + (map v70 : int | v70 in {v71.cf100} :: (v70 + i3) := (p2)))|, i3);
				var v72: set<bool> := {p1[safeIndex(575, p1.Length)], p1[safeIndex(575, p1.Length)]};
				var v73 := DC3(v63);
				var v74: map<set<bool>, D1> := map[v72 := v73];
				var v75 := DC16(v74);
				v75 := fm26(globalState);
			} else {
				var v76 := DC37(p2, [p1[safeIndex(575, p1.Length)], p1[safeIndex(575, p1.Length)]], v56, p3);
				var v77 := 'i';
				var v78: map<bool, char> := map[p1[safeIndex(575, p1.Length)] := v77];
				p1[safeIndex(575, p1.Length)] := !v76.cf64 !in v78;
				r3 := safeModuloInt(p3, fm3(p1[safeIndex(575, p1.Length)], globalState));
				var v80: seq<int> := [p3];
				var v81: map<seq<int>, int> := map[v80 := p3];
				var v82: multiset<char> := multiset{v77, v77, v77};
				var v83: map<int, bool> := map[i3 := p2];
				var v84 := new C10(map v79 : seq<int> | v79 in v81[v80 := |v82|] :: (v79) := (i3), v56 <= v56[safeIndex(|v83|, |v56|) := v77]);
				var v85, v86 := v84.m18(globalState);
				var v87: array<bool> := new bool[13](i4 => v84.f9);
				var v88: map<bool, bool> := map[p1[safeIndex(575, p1.Length)] := true];
				var v89: map<int, map<bool, bool>> := map[p3 := v88];
				var v90: seq<map<bool, bool>> := [v88 + v88, map[v84.f9 := v84.f9] + map[v84.f9 := p1[safeIndex(575, p1.Length)]], v88, v88 + (map[v84.f9 := p1[safeIndex(575, p1.Length)]])[p2 := p1[safeIndex(575, p1.Length)]], if (|fm0(v84.f9, -v85, p2, globalState)| in v89) then v89[|fm0(v84.f9, -v85, p2, globalState)|] else v88];
		...
		var v96 := 'y';
		v95[safeIndex(125, v95.Length)] := [v96, v96, 'r'];
		...
		var v100: map<bool, int> := map[true := |(seq(abs(566), i6  => (v96)))|];
		var v101: map<map<int, bool>, map<bool, int>> := map[v99[p3 := p2] := v100[p2 := p3]];
		v97[safeIndex(211, v97.Length)] := v101;
		v95[safeIndex(885, v95.Length)] := v56;
		var v102: set<int> := {p3};
		v95[safeIndex(125, v95.Length)], v97[safeIndex(211, v97.Length)], r1, v95[safeIndex(885, v95.Length)], r1 := ([v96, v96, 'c', v96, v96])[safeIndex(safeDivisionInt(p3, |v102|), |[v96, v96, 'c', v96, v96]|) := fm43(globalState)], v101, p2, seq(abs(0x3d), i7  => (v96)), false;
		var v103: array<array<seq<bool>>> := new array<seq<bool>>[7];
		var v104: array<seq<bool>> := new seq<bool>[24](i8 => v55);
		v103[safeIndex(956, v103.Length)] := v104;
		v103[safeIndex(956, v103.Length)] := v104;
		var v105, v106, v107 := m0(globalState);
		r0 := v56;
		r1 := p2;
		var v108: set<bool> := {p2};
		r2 := {p2, fm16(|v108|, seq(abs(0x140), i9  => (v96)), v55, globalState)} - {v107[safeIndex(v105, |v107|)]};
		r3 := 0x268;
	}
}
...
class C15 {
	...
	method m8(p0: map<bool, int>, p1: bool, globalState: GlobalState) returns (r0: map<bool, int>, r1: bool) {
		...
		for i0 := |(p0 + p0)| to v0 {
			...
			v5, v7, r1 := v8[safeIndex(i0, |v8|)], if (v11.cf57) then map[v6[v5.f16 := abs(if (v0 in v13) then v13[v0] else v0)] := v5.f15] else (fm92(globalState))[multiset(v9[safeIndex(v0, |v9|) := p1]) := v5.f15], !(i0 > i0);
			var v14: seq<string> := [v3];
			var v15: map<seq<map<int, bool>>, seq<string>> := map[seq(abs(0x37b), i1  => (map[580 := v5.f16])) := v14];
			var v16: map<int, bool> := map[i0 := true];
			var v17: seq<map<int, bool>> := [v16];
			v15 := v15[v17 + (seq(abs(0x1be), i2  => (map[v0 := v5.f16]))) := v14];
			r1 := |(v3 + v3)| < (v0 - i0);
		}
		v0 := v0;
			...
			decreases 100 - i3
		{
			...
			var v24 := "ejclt";
			v20[safeIndex(754, v20.Length)] := if (|v23| in v21) then v21[|v23|] else v24;
			v20[safeIndex(754, v20.Length)] := v24;
			var v25: array<bool> := new bool[21] [fm1(p1, v0, globalState), p1, p1, p1, p1, p1, p1, p1, !p1, p1, p1, p1, fm28(v0, globalState) != v23[safeIndex(--v0, |v23|) := v0], p1, if (p1) then p1 else p1, p1, p1, "tjfrpgsys" != "op", p1, p1, p1];
			v25[safeIndex(478, v25.Length)] := true;
			var v26 := 'j';
			v25[safeIndex(478, v25.Length)] := v26 in v24;
			var v27, v28, v29 := m0(globalState);
			var v30: multiset<int> := multiset{v28};
			if ((v30 !! multiset{v27, -v28}) <==> (DC43(p1, v24, p1, v25[safeIndex(478, v25.Length)], v25[safeIndex(478, v25.Length)]).cf77 != v24)) {
				var v31 := DC51(v25[safeIndex(478, v25.Length)], v27, v0, [p1, v25[safeIndex(478, v25.Length)], p1], v27);
				f5[safeIndex(921, f5.Length)] := -v31.cf97;
				f5[safeIndex(921, f5.Length)] := v27 * v27;
				var v32: seq<seq<bool>> := [v29 + v22, v22];
				v32 := [[v25[safeIndex(478, v25.Length)], v25[safeIndex(478, v25.Length)]], v22, v22[safeIndex(v0, |v22|) := v22[safeIndex(v23[safeIndex(v0, |v23|)], |v22|)]]];
				var v33: T1 := new C6();
				var v34: map<bool, T1> := map[v25[safeIndex(478, v25.Length)] := v33];
				v34 := (v34[v25[safeIndex(478, v25.Length)] := v33] + v34) + (v34 + v34);
				var v35: map<char, array<bool>> := map[v26 := v25];
				v35 := v35;
				v25[safeIndex(478, v25.Length)] := if (v25[safeIndex(478, v25.Length)]) then if (p1) then false else p1 else p1;
			} else {
				var v36: map<char, bool> := map[v26 := true];
				var v37: multiset<bool> := multiset{p1, v25[safeIndex(478, v25.Length)], p1};
				var v38: map<bool, multiset<bool>> := map[if (v26 in v36) then v36[v26] else p1 := v37[v25[safeIndex(478, v25.Length)] := abs(v28)]];
				v25[safeIndex(478, v25.Length)], v27 := p1, |v38|;
				f5[safeIndex(371, f5.Length)] := -v0;
				f5[safeIndex(371, f5.Length)] := fm3(v25[safeIndex(478, v25.Length)], globalState);
				f5[safeIndex(371, f5.Length)] := f5[safeIndex(371, f5.Length)] + v0;
				var v39 := DC3(v26);
				var v40 := DC7(v25[safeIndex(478, v25.Length)], {v39});
				var v41: map<D2, bool> := map[v40 := fm3(v25[safeIndex(478, v25.Length)], globalState) > v27];
				v25[safeIndex(478, v25.Length)] := !(if (v40 in v41) then v41[v40] else v25[safeIndex(478, v25.Length)]);
				v28 := safeModuloInt(v27, v28 + v0);
			}
			
		}
		r0 := (p0 + p0)[p1 := 0x89];
		r1 := fm1(p1, safeModuloInt(v0, v0), globalState);
	}
	method m9(p0: int, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		var v8 := new C3(v4[safeIndex(p0, |v4|) := if (p0 in v6) then v6[p0] else v5] + v4, v0, v7);
		var v9 := new C7(v5);
		for i1 := p0 to p0 {
			var v10 := new C6();
			v8.f16 := p0 >= p0;
			...
			if (v10.fm7(v8.f16, v4 + (seq(abs(950), i2  => ('i'))), v13, globalState)) {
				...
				v18[safeIndex(276, v18.Length)] := v17;
				var v19: multiset<int> := multiset{p0, i1};
				var v20: set<int> := {|v19|};
				v18[safeIndex(276, v18.Length)] := map[|map[|v20| := v0]| := v16] + v17;
				v20 := (v20 - v20) + v20;
				var v21 := new C3(if (v8.f16) then v8.f15 else v4, v0, v7);
				var v22: array<map<bool, bool>> := new map<bool, bool>[3];
				v22[safeIndex(149, v22.Length)] := v2;
				v22[safeIndex(149, v22.Length)] := v2;
				v8.f15 := v8.f15;
			} else {
				f5[safeIndex(970, f5.Length)] := if (v8.f16) then i1 else p0;
				var v23: array<array<bool>> := new array<bool>[17];
				v23[safeIndex(111, v23.Length)] := v3;
				var v24: seq<string> := ["wujmi", v4];
				f5[safeIndex(970, f5.Length)], v23[safeIndex(111, v23.Length)], v8.f16 := p0, v3, (v24[safeIndex(i1, |v24|)] + v4) != v4;
...
class C16 extends T1, T0 {
	...
	function fm6(p0: bool, p1: int, globalState: GlobalState): string {
		((seq(abs(-0x381), i0  => ('p'))) + (seq(abs(-17), i1  => ('a')))) + (seq(abs(0x216), i2  => ('k')))
	}
	function fm7(p0: bool, p1: string, p2: map<string, string>, globalState: GlobalState): bool {
	...
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		var v0: array<int> := new int[7](i1 => i1 + |(seq(abs(0x23d), i2  => ('s')))|);
		forall i0 | 0 <= i0 < v0.Length {
			v0[i0] := safeDivisionInt(i0, p0);
		}
			...
			decreases 100 - i3
		{
			...
			v0[safeIndex(310, v0.Length)] := v7.cf0;
			var v8: seq<int> := [0xf3];
			v0[safeIndex(310, v0.Length)] := v8[safeIndex(|v8| * v0[safeIndex(310, v0.Length)], |v8|)];
			r1 := p0 * safeModuloInt(p0, -0x1d8);
		}
		var v9 := 'm';
		var v10 := DC3(v9);
		var i5 := 0;
			...
			decreases 100 - i5
		{
			...
			i5 := i5 + 1;
			var v12 := "e";
			var v13: set<string> := {seq(abs(563), i6  => (v9)), v12};
			...
			var v21: seq<string> := [v12, v12, v20[safeIndex(p0, |v20|)]];
			var v22: map<string, string> := map["htv" := v12];
			v17, v21, v17, v17 := fm7(p1, v12, v22, globalState), (seq(abs(0x3a4), i7  => (v12))) + (v21 + ([v12, v12, v12])[safeIndex(p0, |[v12, v12, v12]|) := v12])[safeIndex(0x262, |(v21 + ([v12, v12, v12])[safeIndex(p0, |[v12, v12, v12]|) := v12])|) := seq(abs(0xa8), i8  => (v9))], fm7(true, fm6(p1, p0, globalState), v22 + map[v12 := v12], globalState), v17;
		}
		var v23 := "jl";
		...
		var v27: array<seq<bool>> := new seq<bool>[24] [v1, v1, v1 + v1, v1 + v1, [p1, p1], [v26.cf11, false], v1, v1, [p1, p1], v1, fm0(p1, p0, p1, globalState), v1 + v1, v1, v1, fm0(p1, -p0, p1, globalState), [p1], v1, [p1, p1], v1 + v1, fm0(v1[safeIndex(p0, |v1|)], p0, true, globalState) + v1, v1, v1, v1 + [p1], v1 + v1];
		var v28 := false;
		var v29 := DC12(v27);
		...
		v27, v28, v28, r1 := v29.cf20, if (p1 in v30) then v30[p1] else v28, (v31 * (if (v34 in v33) then v33[v34] else multiset([p0]))) > v31[p0 := abs(p0)], p0;
		for i10 := |v23| to p0 {
			...
			v0[safeIndex(373, v0.Length)] := i10;
			v0[safeIndex(373, v0.Length)] := -((if (i10 in v31) then v31[i10] else p0) - (p0 * p0));
			v28 := !(if (p1) then p1 else true) <== v28;
			var v39: map<bool, char> := map[v28 := v9];
			var v40 := DC15(0x3d1, v1, v28);
			v39 := v39[v0[safeIndex(373, v0.Length)] <= i10 := v23[safeIndex(v40.cf23, |v23|)]];
		}
		r0 := v9;
	...
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
		...
		if (fm1(if (v10.f9) then v2 else v2, v3, globalState)) {
			...
			v11[safeIndex(439, v11.Length)] := v13;
			var v14: array<array<char>> := new array<char>[6];
			var v15: array<char> := new char[27];
			v14[safeIndex(304, v14.Length)] := v15;
			v2, v11[safeIndex(439, v11.Length)], v0, v14[safeIndex(304, v14.Length)], v3 := v10.f9, v13, v0, v15, v3;
			var v16: map<int, int> := map[fm3(!v2, globalState) := v3 + v3];
			v16 := v16[v3 := safeModuloInt(v3, 167)];
			var v17: array<bool> := new bool[8](i0 => v10.f9);
			v17[safeIndex(60, v17.Length)] := v10.f9;
			v17[safeIndex(60, v17.Length)] := false && v10.f9;
			var v18: multiset<int> := multiset{v3};
			v2 := (-v3 + -(if (v3 in v18) then v18[v3] else 0x2b6)) > v3;
			v17[safeIndex(60, v17.Length)] := v2;
		} else {
			if (v10.f9) {
				var v19: array<int> := new int[16];
				v19[safeIndex(778, v19.Length)] := v3;
				var v20: set<int> := {v3 * v3};
				v19[safeIndex(778, v19.Length)] := |v20|;
				var v21: array<char> := new char[3];
				v21[safeIndex(480, v21.Length)] := 'j';
				v21[safeIndex(480, v21.Length)] := v0;
				v3 := v3;
				v7 := v7;
				var v22: C12 := new C12(f2);
				var v23: array<bool> := new bool[29];
				var v24: map<int, bool> := map[v19[safeIndex(778, v19.Length)] := v10.f9];
				v2, v19[safeIndex(778, v19.Length)], v22, v23 := v5[safeIndex(v3 * -v3, |v5|)], |v24| + fm3(v10.f9, globalState), v22, v23;
			} else {
				v2 := !fm1(v10.f9, v3, globalState);
				v2 := v5[safeIndex(--v3, |v5|)];
				...
				var v31 := DC57(v8[safeIndex(|v29|, |v8|) := v3] + v8, v30 == v30, v3);
				v31 := v31;
				var v32: map<bool, bool> := map[v10.f9 := v2];
				v32 := v32[v10.f9 := !v2];
			}
			
			v7 := v7[safeIndex(v3, |v7|) := v1.f18];
			v2, v3 := v2, safeDivisionInt(v8[safeIndex(|v7|, |v8|)], -v3);
			var v33: seq<string> := [v7];
			var v34 := DC68(v33);
			var v35: array<seq<bool>> := new seq<bool>[10](i1 => v5);
			v35[safeIndex(409, v35.Length)] := v5 + [true, v10.f9, v10.f9, false];
			var v36: map<int, int> := map[|v5| := v3];
			var v37 := DC3(v0);
			var v38 := DC7(v10.f9, {v37, v37});
			var v39: multiset<int> := multiset{|v36|};
			var v40: map<int, bool> := map[v3 := v2];
			var v41 := DC33(v38.cf15, |v7|, v10.f9, 0x257, |map[v3 := |v8[safeIndex(|v39|, |v8|) := |v40|]|]|);
			var v42: set<int> := {|v40|};
			var v43: set<int> := {(v41.(cf59 := v10.f9, cf58 := |v42|, cf60 := v3)).cf60};
			v34, v2, v2, v35[safeIndex(409, v35.Length)], v2 := v34.(cf123 := v33 + ([v7, v7])[safeIndex(|v36|, |[v7, v7]|) := v7]), !v10.f9, v10.f9, [v10.f9] + v5, v43 !! v42;
			var v44 := new C5();
		}
	...
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v1 := -0x3b2;
			v1 := safeModuloInt(v1, fm3(v0, globalState)) * v1;
		...
		var v10 := "sns";
		var v11: array<int> := new int[14] [v4, fm3(v0, globalState), |(if (v4 in v8) then v8[v4] else v9)| - 0x6c, v4, v4, v4, v4, v4, v4 + v4, safeDivisionInt(-fm3(v5[safeIndex(|v10|, |v5|)], globalState), v4), v4, v4, v4, |v9|];
		forall i1 | 0 <= i1 < v11.Length {
			v11[i1] := safeModuloInt(i1, |v5| * v4);
		}
		v0 := v0;
		if (v0) {
			var v12 := 'w';
			...
			if (v0) {
				...
				var v24: map<int, map<bool, int>> := map[-|(seq(abs(-774), i2  => (v12)))| := map[v0 := v4]];
				v23 := if (safeDivisionInt(v4, v4) in v24) then v24[safeDivisionInt(v4, v4)] else v23;
			...
			v29 := v29[v4 := v4];
			v0, v0, v0, v10, v5 := v0, v0, (v7.f10 + ([v0, v0])[safeIndex(v4, |[v0, v0]|) := v0]) < v7.f10, v10, v5;
		} else {
			...
			v30[safeIndex(493, v30.Length)] := v32;
			v11[safeIndex(641, v11.Length)] := 0x7a;
			var v33: seq<set<array<bool>>> := [v32, v32];
			var v34 := 'x';
			var v35 := DC6(v0, v0, v34, v4, true);
			v30[safeIndex(493, v30.Length)], v0, v4, v11[safeIndex(641, v11.Length)] := (v33[safeIndex(-v4, |v33|)] * v32) + (v32 - v32), !!fm13(v35, v4 * v4, v0, globalState), fm3(v0, globalState), v4;
			v11[safeIndex(641, v11.Length)] := v4;
			v11[safeIndex(641, v11.Length)] := v4;
			var v36: seq<string> := ["bec", seq(abs(444), i3  => (v34))];
			v10 := v36[safeIndex(v4, |v36|)];
		...
		for i4 := v4 to 0x222 {
			...
			v38[safeIndex(54, v38.Length)] := v0;
			v38[safeIndex(54, v38.Length)] := v0 !in v7.f10;
			var v39: seq<int> := [v4];
			var v40 := new C9(fm0(v0, |v39|, v0, globalState) + v5, DC10());
			var v41: multiset<bool> := multiset{v0, v38[safeIndex(54, v38.Length)], v0, v38[safeIndex(54, v38.Length)], v0};
			var v42 := DC47(v9[|v41| := !v38[safeIndex(54, v38.Length)]]);
			v42 := fm90(|v40.f10|, v4, globalState);
			var v43: T2 := new C12(f2);
			var v44: array<T2> := new T2[1] [if (v38[safeIndex(54, v38.Length)]) then v43 else v43];
			v44 := v44;
		}
		var v45: seq<int> := [v4, v4, -v4];
		var v46: multiset<bool> := multiset{[v4, v4] != v45, v7.f10[safeIndex(|v10|, |v7.f10|)]};
	...
	method m7(p0: int, p1: bool, globalState: GlobalState) returns (r0: bool, r1: int) {
		if (p1) {
			...
			v2[safeIndex(137, v2.Length)] := v3 - v3;
			var v4: map<bool, multiset<bool>> := map[p1 := v1.fm9(p0, p1, globalState)];
			v2[safeIndex(137, v2.Length)] := (if (p1 in v4) then v4[p1] else multiset{p1, p1, p1, p1}) * v3;
		} else {
			...
			if (v13 > (v13 + v13)) {
				...
				v14 := v14[v5 := v12.f12];
				var v15: map<bool, bool> := map[v8[safeIndex(v6, |v8|)] := true];
				...
				r0, v18, r0, v19, v6 := v12.f12, v18, v12.f12, v19, -safeModuloInt(safeDivisionInt(-p0, |v20|), v21.cf67);
				v6 := p0;
				var v22 := new C6();
			} else {
				...
				v29 := v29[v5 := v28];
				var v30 := DC59(v12.f12, |v10[safeIndex(p0, |v10|)]|);
			...
			match (v34) {
				case DC62(cf116, cf117) =>
					...
					r1 := v38;
					v32[safeIndex(962, v32.Length)] := v7;
					...
					v32[safeIndex(962, v32.Length)] := if ((if (true) then v8 else v36) in v40) then v40[if (true) then v8 else v36] else -cf116;
					v12.f12 := true;
				case DC61(cf115) =>
					v12.f12 := p1;
		...
		for i2 := |v52| to |v52| {
			...
			v53[safeIndex(284, v53.Length)] := i2;
			v53[safeIndex(284, v53.Length)] := i2;
			var v54: array<bool> := new bool[20];
			v54[safeIndex(698, v54.Length)] := true;
			v54[safeIndex(698, v54.Length)] := !p1;
			r1 := v53[safeIndex(284, v53.Length)];
			v54[safeIndex(698, v54.Length)] := v54[safeIndex(698, v54.Length)];
		}
		v52 := v52;
		var v55 := 'x';
		v55 := v55;
...
class C17 extends T1, T2, T0 {
	...
	function fm6(p0: bool, p1: int, globalState: GlobalState): string {
		match DC0(84) {
			...
			case DC0(cf0) => (seq(abs(0xd), i0  => ('v'))) + "eoe"
			case DC2(cf6) => "rbsboela" + (seq(abs(530), i1  => ('t')))
		}
	}
	function fm7(p0: bool, p1: string, p2: map<string, string>, globalState: GlobalState): bool {
		f3
	...
	function fm12(p0: int, p1: bool, p2: char, p3: bool, globalState: GlobalState): int {
		-|(if (f3) then map v0 : int | (-0x2e7 <= v0) && (v0 < 0x347) :: (safeModuloInt(v0, 0x270)) := (seq(abs(0x1e4), i0  => (DC0(|(map v1 : int | (0xb <= v1) && (v1 < 0x25a) :: (v1 * -103) := (!f3))|)))) else map[0x22b := [DC0(481), DC0(|[|"x"|, |"tqbkc"|, |"pppwquxt"|, |"i"|, -0x11]|)]])|
	}
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
		var v0: seq<bool> := [p1];
		var v1 := DC5(v0);
			...
			decreases 100 - i0
		{
			...
			if (p1) {
				...
				v6[safeIndex(477, v6.Length)] := v7 + (set v10 : int | v10 in v9 :: (safeDivisionInt(v10, -888)));
				var v12: seq<set<int>> := [v7, v7];
				v6[safeIndex(477, v6.Length)] := (set v11 : int | (202 <= v11) && (v11 < 55) :: (safeDivisionInt(v11, v3))) + (if (p1) then v7 else v12[safeIndex(fm3(f3, globalState), |v12|)]);
				var v13: map<string, int> := map[seq(abs(0x302), i2  => ('i')) := |v8|];
				var v14 := "ybclneijy";
				var v15: map<bool, bool> := map[p1 := f3];
				var v16: map<int, seq<bool>> := map[p0 := v0[safeIndex(if (v14 in v13) then v13[v14] else |v15[v5 := v5]|, |v0|) := f3]];
				...
				var v23: array<int> := new int[11] [|v16|, v3, p0, |v19|, safeModuloInt(-v2, p0), p0, |v4|, p0, v3 - 0x1be, p0, safeDivisionInt(p0, |(if (true in v22) then v22[true] else v21)|)];
				v23[safeIndex(107, v23.Length)] := v3;
				v3, v23[safeIndex(107, v23.Length)], v5 := v3, DC62(|v0|, p0).cf116, f3;
				v4 := fm0(v5, 930, fm1(v5, v23[safeIndex(107, v23.Length)], globalState), globalState) + [fm1(!p1, v23[safeIndex(107, v23.Length)], globalState), false];
				var v24: array<D21> := new D21[21];
				var v25: map<array<int>, bool> := map[v23 := v5];
				var v26: seq<int> := [v3];
				var v27: seq<int> := [|v26|, v2, v3, v2];
				var v28 := DC57(v26, p1, v3);
				v24[safeIndex(156, v24.Length)] := if (if (v23 in v25) then v25[v23] else !p1) then v28 else v28;
				...
				var v33: array<array<D29>> := new array<D29>[16] [v29, if (v30 in v31) then v31[v30] else v29, v29, v29, v29, v29, v29, v29, v29, v32[safeIndex(v2, |v32|)], v29, v29, v29, v29, v29, v29];
				v33[safeIndex(776, v33.Length)] := v29;
				var v34: set<bool> := {v5};
				var v35: map<bool, array<D29>> := map[f3 := v29];
				v24[safeIndex(156, v24.Length)], r1, v33[safeIndex(776, v33.Length)], v34 := v28, fm12(p0, v5 ==> !p1, v20, p1, globalState), if ((v2 == v23[safeIndex(107, v23.Length)]) in v35) then v35[v2 == v23[safeIndex(107, v23.Length)]] else v29, v34 * v17.f2;
			} else {
				var v36 := "hllfyvj";
				var v37 := 'i';
				v36 := v36[safeIndex(v2, |v36|) := v37];
				...
				v43[safeIndex(645, v43.Length)] := v3;
				v43[safeIndex(645, v43.Length)] := p0;
				var v44: seq<int> := [v2, |v36|];
				var v45: map<array<int>, seq<int>> := map[v43 := (fm66(globalState) + v44)[safeIndex(v2, |(fm66(globalState) + v44)|) := 0x2c]];
				v45 := v45 + v45[v43 := seq(abs(0x116), i4  => (p0))];
			}
			
			var v46: array<array<bool>> := new array<bool>[24];
			var v47: array<bool> := new bool[10];
			v46[safeIndex(77, v46.Length)] := v47;
			v46[safeIndex(77, v46.Length)] := new bool[25];
			v46[safeIndex(77, v46.Length)][safeIndex(962, v46[safeIndex(77, v46.Length)].Length)] := f3;
			var v48 := 'q';
			var v49 := "vssdg";
			var v50: map<string, string> := map[seq(abs(141), i5  => (v48)) := v49];
			var v51: map<bool, bool> := map[fm7(true, v49, v50, globalState) := p1];
			r1, v3, v46[safeIndex(77, v46.Length)][safeIndex(962, v46[safeIndex(77, v46.Length)].Length)] := 0x118, fm12(v3, f3, v48, false, globalState), p1 !in v51;
		}
		for i6 := -873 to p0 + -p0 {
			var v52 := true;
			...
			v58[safeIndex(528, v58.Length)] := "ftuinuna";
			var v59 := "jtm";
			v58[safeIndex(528, v58.Length)] := v59;
			v52 := f3;
		}
		...
		v61 := p1;
		var v62 := 'g';
		var v63: map<int, int> := map[p0 := |(seq(abs(0x1d4), i8  => (|DC29([p0, 0x3bd]).cf49|)))|];
		...
		var v69: seq<int> := [p0];
		var v70: array<int> := new int[19] [safeModuloInt(fm12(p0, f3, v64.cf29, p1, globalState), p0), -p0, p0 - 107, safeDivisionInt(p0, |v65|), p0, |(v65 + v65)|, p0, fm3(f3, globalState), 442, p0 * 16, -p0 - p0, p0, p0, safeDivisionInt(p0, |{p1, p1}|), safeModuloInt(|v66|, |v68|), p0, p0 + -p0, if (false) then v69[safeIndex(p0, |v69|)] else p0, p0];
		v70[safeIndex(794, v70.Length)] := -p0;
		v70[safeIndex(794, v70.Length)] := safeDivisionInt(-625, p0);
		v61 := f3;
		r0 := v62;
		r1 := safeDivisionInt(v70[safeIndex(794, v70.Length)], |v65|);
	}
	method m4(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: array<set<int>>, r1: bool, r2: multiset<seq<D0>>) {
		var v0 := -0x2c6;
		for i0 := v0 to v0 {
			...
			if (p2) {
				...
				v11, v0, v12 := map[v13[safeIndex(|"grjqybp"|, |v13|)] := f3] + (if (p0) then v11 else v11), i0, v12;
				var v14: array<D20> := new D20[29];
				var v15: array<int> := new int[29];
				var v16: map<map<bool, int>, array<int>> := map[v8 := v15];
				var v17 := DC55(v16);
				v14[safeIndex(245, v14.Length)] := v17.(cf105 := v16);
				v14[safeIndex(245, v14.Length)], r1 := v17, fm1(p0, v2.fm35(globalState), globalState);
			} else {
				var v18: array<int> := new int[25];
				v18[safeIndex(419, v18.Length)] := i0;
				var v19 := "pbrjneu";
				var v20: seq<int> := [v0];
				var v21: map<char, bool> := map[v2.f14 := !f3];
				var v22: array<bool> := new bool[22] [!p0, p2, 474 <= -i0, p0, p0, f3, v19 < v19, f3, f2 !! {p0}, fm28(|multiset{p0}|, globalState) != v20, p2, p2, f3, if (v1 in v21) then v21[v1] else !p0, false, p2, !p0, true, !f3 || f3, p0, v2.fm36(f3, globalState) <== p1[safeIndex(v0, |p1|)], if (f3) then p0 else p0];
				var v23: map<char, int> := map[v2.f14 := safeModuloInt(i0, i0)];
				v0, v18[safeIndex(419, v18.Length)], v0, r1, v22 := if (v2.f14 in v23) then v23[v2.f14] else v0, 0x14c * i0, v0 + (fm12(v0, f3, v2.f14, p2, globalState) * i0), !p0, v22;
				r1 := fm1(f3, 0x18f, globalState);
				r1 := v2.fm36(!p0, globalState);
				v19, v1 := seq(abs(969), i2  => (v2.f14)), v2.f14;
				r1 := (v19 + (seq(abs(100), i3  => (v2.f14)))) != v19;
			}
		...
		for i4 := v0 to v0 {
			...
			match (v25) {
				case DC10() =>
					...
					v29 := new int[14];
					v0 := v26[safeIndex(safeDivisionInt(v0, i4), |v26|)];
					var v30: array<bool> := new bool[24](i5 => |[DC69(map[p0 := |multiset{p2}|])]| <= i4);
					v29[safeIndex(165, v29.Length)] := v0;
					v30, v25, v29[safeIndex(165, v29.Length)] := v30, v25, if (0x3b9 in v27) then v27[0x3b9] else v0;
				case DC9(cf18) =>
					var v31: array<bool> := new bool[2](i6 => p0);
					v31[safeIndex(945, v31.Length)] := f3;
					var v32: seq<int> := [i4];
					var v33: seq<seq<int>> := [v32];
					v31[safeIndex(803, v31.Length)] := [|fm6(f3, v0, globalState)|, v0] in v33;
					var v34 := DC45(i4, f3, DC34());
					r1, r1, v31[safeIndex(945, v31.Length)], v31[safeIndex(803, v31.Length)] := !!f3, v32[safeIndex(v0, |v32|)] != v34.cf84, p2, p2;
					...
					var v40: map<int, bool> := map[v39.cf67 := !v31[safeIndex(945, v31.Length)]];
					v0 := fm3(!(map[|v37| := p2] != v40), globalState);
					v31[safeIndex(945, v31.Length)], v0 := true, |"vuw"|;
				case DC11(cf19) =>
					...
					v44[safeIndex(950, v44.Length)] := v45;
					v44[safeIndex(950, v44.Length)] := v45 + v45;
			}
			...
			var v50: set<int> := {v0, safeDivisionInt(v0, |(if (|v46| in v48) then v48[|v46|] else v49[safeIndex(fm3(v24.fm21(v49[safeIndex(v0, |v49|)], f3, v0, globalState), globalState), |v49|)])|), 737};
			var v51: map<int, set<int>> := map[v0 := v50];
			var v52 := 'p';
			v50 := ((if (fm12(i4, f3, v52, p0, globalState) in v51) then v51[fm12(i4, f3, v52, p0, globalState)] else v50) + (set v53 : int | (107 <= v53) && (v53 < -666) :: (safeDivisionInt(v53, v0)))) - v50;
			v0 := safeModuloInt(|p1|, v0);
		}
		var v54: array<bool> := new bool[8];
		v54[safeIndex(256, v54.Length)] := fm1(p2, v0, globalState);
		var v55: C2 := new C2(f3);
		var v56: set<C2> := {v55};
		var v57: seq<int> := [v0, v0];
		v0, v54, r1, v54[safeIndex(256, v54.Length)] := v0 - -(if (f3) then v0 else |v56|), v54, v57 != v57, f3 || v55.f17;
		...
		r1 := !(v63 !! (multiset{v62} + v63[v62 := abs(v58)]));
		var v64: map<bool, bool> := map[true := !p0];
		var v65 := DC1(v54, |v64|, !f3, map[p1[safeIndex(v0, |p1|)] := fm48(v55.f17, 274, globalState)], p0);
		var v66: seq<D0> := [v65];
	...
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
		var v1 := -736;
		var v2 := DC9(map v0 : int | v0 in {v1} :: (safeModuloInt(v0, 0x2bc)) := (seq(abs(0xcf), i0  => ('i'))));
		var v3 := 'h';
		...
		var v10: array<int> := new int[10] [|(v5 + (if (f3 in v6) then v6[f3] else v5))|, safeDivisionInt(|v8|, v1), -(0xd1 * v1), 0x227, v4.cf13, v1, v1, |(v9 + v9)|, v1, v1];
		v10[safeIndex(685, v10.Length)] := safeDivisionInt(v1, v1);
		var v11 := "ycskgkh";
		...
		v10[safeIndex(685, v10.Length)] := -|v15|;
		...
		if ((if (if (f3 in v16) then v16[f3] else f3) then v18 else v18).cf85) {
			v10[safeIndex(685, v10.Length)] := -|v11|;
			var v19 := false;
			var v20 := DC76(f3);
			v19 := v20.cf131;
			v1 := v10[safeIndex(685, v10.Length)];
			...
			match (if (f3) then v27 else DC11(v26)) {
				...
				case DC9(cf18) =>
					...
					v36[safeIndex(157, v36.Length)] := v37;
					v36[safeIndex(157, v36.Length)] := new C15(v37.f5);
					var v38: multiset<char> := multiset{v3, v3};
					var v39: map<int, multiset<char>> := map[v1 := v38];
					var v40: seq<int> := [v10[safeIndex(685, v10.Length)], v10[safeIndex(685, v10.Length)]];
					var v42: map<int, int> := map[v10[safeIndex(685, v10.Length)] := |(set v41 : int | (0x100 <= v41) && (v41 < 0x172) :: (v41 + |v9|))|];
					var v43: array<multiset<char>> := new multiset<char>[3] [v38 * v38, v38, (if (v40[safeIndex(|v42|, |v40|)] in v39) then v39[v40[safeIndex(|v42|, |v40|)]] else multiset{v3}) + v38];
					v43[safeIndex(898, v43.Length)] := v38;
					v43[safeIndex(898, v43.Length)] := multiset{'r'} - v38;
				case DC11(cf19) =>
					var v44: array<string> := new string[22];
					v44[safeIndex(324, v44.Length)] := v11[safeIndex(v1, |v11|) := v3];
					v44[safeIndex(324, v44.Length)] := v11;
					var v45: map<int, int> := map[|f2| := v1];
					v14[safeIndex(494, v14.Length)] := v45 != v45;
					v14[safeIndex(494, v14.Length)] := f3;
					var v46 := DC31(v10[safeIndex(685, v10.Length)] + 0x1a7, true, v1, safeModuloInt(-v10[safeIndex(685, v10.Length)], v10[safeIndex(685, v10.Length)]), if (false) then v10[safeIndex(685, v10.Length)] else v1);
					v46 := v46;
					v1, v19 := v10[safeIndex(685, v10.Length)] * v1, v14[safeIndex(494, v14.Length)];
			}
			
		} else {
			var v47: map<int, int> := map[safeModuloInt(0x32e, v10[safeIndex(685, v10.Length)]) := -(v10[safeIndex(685, v10.Length)] + v1)];
			v47 := v47[v1 := safeModuloInt(v1, if (f3 in v9) then v9[f3] else |v11|)];
			v1 := v1 + (if (v1 in v47) then v47[v1] else v1);
			var v48: seq<int> := [safeDivisionInt(v1, v10[safeIndex(685, v10.Length)]), 960];
			var v49 := DC40(v15);
			...
			var v59: array<map<int, int>> := new map<int, int>[14] [v47[v1 := |map[false := f3]|], v47, (map v51 : int | v51 in v53 :: (v51 + v1) := (v10[safeIndex(685, v10.Length)])) + (map v54 : int | (148 <= v54) && (v54 < 0x3c2) :: (v54 + v10[safeIndex(685, v10.Length)]) := (v10[safeIndex(685, v10.Length)])), map[|v16| := v1], v47[|v56| := -v10[safeIndex(685, v10.Length)]], v47, map[(v4.(cf14 := f3)).cf13 := v10[safeIndex(685, v10.Length)]], v47, fm50(globalState), v47, map[0x317 := if (f3 in v57) then v57[f3] else v1], (map v58 : int | v58 in v47 :: (safeModuloInt(v58, v1)) := (|map[f3 := v47]|)) + v47, v47, v47];
			v59[safeIndex(566, v59.Length)] := v47 + v47;
			v59[safeIndex(566, v59.Length)] := (map v60 : int | (-0x381 <= v60) && (v60 < 319) :: (v60 + 0x4d) := (v1)) + map[v1 := |f2|];
			v10[safeIndex(685, v10.Length)] := v1;
		}
		
		if (f3) {
			var v61 := new C15(DC49(v10[safeIndex(685, v10.Length)], v1, v10).cf92);
			var v62 := false;
			v62 := v62 <==> v62;
			var v63: array<D25> := new D25[18](i1 => DC66(v62, v62));
			v63[safeIndex(445, v63.Length)] := DC66(v62, v62);
			var v64 := DC66(v62, true);
			v63[safeIndex(445, v63.Length)] := v64;
			v11 := v11;
			v62 := f3;
		} else {
			v14[safeIndex(438, v14.Length)] := f3;
			v14[safeIndex(438, v14.Length)] := !false;
			var v65: seq<int> := [v1];
			var v66 := DC57(v65, !false, v1);
			v65 := v66.cf107;
			v14[safeIndex(438, v14.Length)] := v14[safeIndex(438, v14.Length)];
			var v67: map<int, bool> := map[v1 := v14[safeIndex(438, v14.Length)]];
			v67 := v67[v10[safeIndex(685, v10.Length)] := v14[safeIndex(438, v14.Length)]];
			v3 := v3;
		}
		
		var v68: map<int, bool> := map[932 := f3];
		v14[safeIndex(502, v14.Length)] := !(if (v10[safeIndex(685, v10.Length)] in v68) then v68[v10[safeIndex(685, v10.Length)]] else f3);
		var v69: array<map<int, int>> := new map<int, int>[21];
		v14[safeIndex(19, v14.Length)] := f3;
		v14[safeIndex(502, v14.Length)], v11, v69, v3, v14[safeIndex(19, v14.Length)] := f3, v11[safeIndex(-151, |v11|) := v3], v69, 'p', v8 <= v8;
		var v70: seq<bool> := [v14[safeIndex(502, v14.Length)]];
		var v71: C12 := new C12({f3});
		var v72: seq<C12> := [v71, v71];
		var v73: map<bool, int> := map[!v70[safeIndex(|multiset(v70)|, |v70|)] := |v72[safeIndex(0x2cc, |v72|) := v71]|];
		var v74: map<int, seq<bool>> := map[|v73| := v70];
		var v75 := new C8(v14[safeIndex(502, v14.Length)], v74);
		var v76 := DC39(v13);
		v76 := v76;
		var v77: seq<int> := [|v68|];
		r0 := (v8 + v8) * (multiset(v77) * multiset{v1, v10[safeIndex(685, v10.Length)]});
		r1 := v70;
	}
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
		var v0 := 0x41;
		...
		match (v7) {
			case DC27(cf46, cf47) =>
				...
				if (!((v11 !! multiset{v10}) <==> (f3 <==> false))) {
					...
					var v15 := 'h';
					var v16: map<string, bool> := map[("rvahpq")[safeIndex(v0, |"rvahpq"|) := v15] := f3];
					v14[safeIndex(360, v14.Length)] := v16 + v16;
					v14[safeIndex(360, v14.Length)] := v16 + v16;
					...
					v20[safeIndex(190, v20.Length)] := v1.fm7(f3, v3, v21, globalState);
					v20[safeIndex(190, v20.Length)] := if (f3) then f3 else !f3;
					v0 := safeModuloInt(-0x386, if (f3) then v0 else v0);
				} else {
					var v22: seq<seq<bool>> := [[f3]];
					var v23: array<seq<seq<bool>>> := new seq<seq<bool>>[19] [(seq(abs(0x163), i1  => (v8))) + v22, v22, v22 + v22, v22, v22, [v8, v8], [v8] + v22, [[f3, f3]], v22, v22, v22, [v8], v22, v22, v22, v22, v22, v22, v22];
					v23[safeIndex(923, v23.Length)] := fm95(v0, globalState);
					cf47, v23[safeIndex(923, v23.Length)], cf47 := cf47, v22, cf47;
					...
					v29 := v29;
					v0 := v0 + safeModuloInt(|v8|, v0);
					var v30: array<seq<int>> := new seq<int>[2](i2 => [v0]);
					var v31: seq<int> := [cf47];
					v30[safeIndex(874, v30.Length)] := v31;
					v30[safeIndex(874, v30.Length)] := v31 + v31;
				}
				
				var v32: array<set<bool>> := new set<bool>[8](i3 => f2 - f2);
				var v33: map<int, set<bool>> := map[cf47 := f2];
				v32[safeIndex(364, v32.Length)] := if (592 in v33) then v33[592] else f2;
				v32[safeIndex(364, v32.Length)] := f2;
				var v34 := false;
				...
				v35[safeIndex(202, v35.Length)] := v37;
				...
				v34, v3, v35[safeIndex(202, v35.Length)], v34, v34 := v1.fm7(v34, v3, v38, globalState), v3, v37, v42.cf14, v34;
			case DC26(cf45) =>
				v3 := v3;
			...
			case DC28(cf48) =>
				...
				v0 := safeModuloInt(-v0, if (map[v0 := f3] in v48) then v48[map[v0 := f3]] else |v3|) + v0;
				var v49 := true;
				v49 := true;
		...
		var v54 := DC37(false, v52, v53[safeIndex(|"pkikxo"|, |v53|)], --|"otwijpcjc"|);
		var v55 := DC38(v54);
		match (v55) {
			case DC37(cf64, cf65, cf66, cf67) =>
				var v56 := 's';
				v56 := cf66[safeIndex(fm3(f3, globalState), |cf66|)];
				...
				if (f3) {
					...
					var v61: map<bool, int> := map[cf65[safeIndex(v0, |cf65|)] := v0];
					v61 := v61[f3 := cf67];
					...
					cf64 := (if (|v66| in v63) then v63[|v66|] else v62) <= (seq(abs(0x63), i4  => (cf67)));
				} else {
					v0 := v0;
					...
					v67[safeIndex(158, v67.Length)] := v0 < v0;
					v67[safeIndex(158, v67.Length)] := (f3 || f3) && fm1(cf64, v0, globalState);
					cf64 := cf64;
			...
			case DC36(cf63) =>
				...
				v70[safeIndex(867, v70.Length)] := safeModuloInt(v0, v0);
				v70[safeIndex(867, v70.Length)] := v0;
				if (v70[safeIndex(867, v70.Length)] != v70[safeIndex(867, v70.Length)]) {
					var v71 := false;
					v71 := f3;
					var v72 := new C2(|v3| < v70[safeIndex(867, v70.Length)]);
					v70[safeIndex(867, v70.Length)] := 0x193;
					var v73: map<bool, bool> := map[v72.f17 := true];
					var v75: seq<int> := [v0, v0, |v3|];
					var v76: C11 := new C11(v73, if (f3) then map[v70[safeIndex(867, v70.Length)] := !false] else map v74 : int | v74 in v75 :: (v74 + v70[safeIndex(867, v70.Length)]) := (f3));
					v76 := v76;
					v0 := if (true) then v70[safeIndex(867, v70.Length)] else v0;
				} else {
					var v77 := DC51(f3, v0, v0, v52, v70[safeIndex(867, v70.Length)]);
					var v78: seq<int> := [v70[safeIndex(867, v70.Length)]];
					...
					v82[safeIndex(341, v82.Length)] := f3 <==> f3;
					v0, v82[safeIndex(341, v82.Length)], v0, v3 := v0, |v52| <= v0, 0x1bb, v3 + (seq(abs(-832), i5  => ('l')));
					v82[safeIndex(341, v82.Length)] := v82[safeIndex(341, v82.Length)];
					v82[safeIndex(341, v82.Length)] := (v78 + v78) <= (seq(abs(-0x3b4), i6  => (v70[safeIndex(867, v70.Length)])));
					v82[safeIndex(341, v82.Length)] := v82[safeIndex(341, v82.Length)];
					var v83: map<bool, map<bool, int>> := map[f3 := map[f3 := v70[safeIndex(867, v70.Length)]]];
					var v84 := DC46(DC42(v83));
					var v85 := 'o';
					var v86: map<char, array<bool>> := map[v85 := v82];
					v3, v82, v70[safeIndex(867, v70.Length)], v84, v70[safeIndex(867, v70.Length)] := (seq(abs(0x3b8), i7  => ('a'))) + v3, if (v85 in v86) then v86[v85] else v82, fm3(f3, globalState) - v78[safeIndex(0x2bd, |v78|)], v84, safeModuloInt(v70[safeIndex(867, v70.Length)], v70[safeIndex(867, v70.Length)] + v70[safeIndex(867, v70.Length)]);
				}
				
				var v87: seq<int> := [v0, v70[safeIndex(867, v70.Length)]];
				var v88: seq<int> := [v0, if (f3) then |[!f3]| else v87[safeIndex(v0, |v87|)]];
				v88 := v88;
				v70[safeIndex(867, v70.Length)] := 0xc0;
			case DC38(cf68) =>
				var v89 := true;
				v89 := (v3 + v3) < v3;
				...
				v91[safeIndex(855, v91.Length)] := v92;
				v0, v91[safeIndex(855, v91.Length)] := v0, (v92 + v92) + (v92 + map[f3 := v0]);
				...
				match (if (f3) then v94 else v94) {
					case DC33(cf57, cf58, cf59, cf60, cf61) =>
						...
						v95[safeIndex(500, v95.Length)] := fm4(f3, cf60, v0, -cf61, globalState);
						...
						var v99 := 'o';
						var v100: array<int> := new int[17] [v0, cf60, cf61, cf61, cf58, v0, cf58, |v3|, cf61, -715, cf58, |v98|, |v91[safeIndex(855, v91.Length)]|, cf58, cf58, |v3[safeIndex(cf61, |v3|) := v99]|, v0];
						var v101: seq<array<int>> := [v100];
						var v102: seq<set<int>> := [fm4(v89, cf58, |v101|, cf58, globalState)];
						v95[safeIndex(500, v95.Length)], v89, v4, cf60 := v4, f3 in v96[cf59 := abs(cf60)], v4 + v102[safeIndex(v0, |v102|)], cf58 - cf60;
						cf60 := cf61 - |map[cf59 := v0]|;
						var v103: set<bool> := {v89};
						v97[safeIndex(272, v97.Length)] := if (cf58 in v93) then v93[cf58] else cf61;
						...
						v104[safeIndex(354, v104.Length)] := v105 - v105;
						cf59, v103, v97[safeIndex(272, v97.Length)], v0, v104[safeIndex(354, v104.Length)] := v89, v103, -cf58, cf58, v105;
						...
						var v113: array<bool> := new bool[25] [!!true, f3, true, [|v91[safeIndex(855, v91.Length)]|] == v107.cf49, cf59, if (cf59) then true else cf59, cf59, v96 > v96, v89, !cf59, if (v108 in v109) then v109[v108] else f3, f3, if (v89) then v89 else cf57, v52[safeIndex(|v96|, |v52|)], fm1(f3, |v111|, globalState), false, cf59, v89, cf57, v89 <== cf59, if (false) then v89 else cf59, v89, if (v0 in v112) then v112[v0] else v89, cf59, v52[safeIndex(cf58, |v52|)]];
						cf61, v113 := v97[safeIndex(272, v97.Length)], v113;
					case DC34() =>
						v89 := v89;
						v0 := v0;
					...
					case DC32(cf56) =>
						...
						v121[safeIndex(309, v121.Length)] := f3;
						v121[safeIndex(309, v121.Length)] := f2 != f2;
						var v122 := new C12(f2);
					case DC35(cf62) =>
						var v123 := 't';
		...
		if (v3 != (v3 + v3)) {
			...
			v135 := new bool[8];
			var v136 := DC43(v52[safeIndex(v0, |v52|)], v3, f3, true, f3);
			var v137 := new C3(v3 + v136.cf77, f3, f2);
			v0 := v0;
			var v138: map<bool, bool> := map[v137.f16 := v137.f16];
			var v139 := 'h';
			var v140: map<string, bool> := map[("hgu")[safeIndex(v0, |"hgu"|) := v139] := f3];
			v138 := v138[if (v53[safeIndex(|v52|, |v53|)] in v140) then v140[v53[safeIndex(|v52|, |v53|)]] else v137.f16 := v137.f16];
			var v141: T2 := new C5();
			v141 := v141;
		} else {
			...
			var v145 := DC61(v144[safeIndex(v0, |v144|)]);
			match (v145) {
				case DC62(cf116, cf117) =>
					var v146 := 's';
					v146 := v146;
				...
				case DC61(cf115) =>
					...
					v151[safeIndex(44, v151.Length)] := if (v0 in v152) then v152[v0] else f3;
					v151[safeIndex(44, v151.Length)] := f3;
					var v153: multiset<bool> := multiset{f3, v151[safeIndex(44, v151.Length)]};
					v151[safeIndex(44, v151.Length)] := ((multiset([f3]))[!v151[safeIndex(44, v151.Length)] := abs(v0)] - v153) != fm8(DC4(v151[safeIndex(44, v151.Length)]), v0, globalState);
					var v154: seq<int> := [v0];
					v154 := v154 + [v0];
			}
			...
			v155[safeIndex(865, v155.Length)] := v156[safeIndex(|v53|, |v156|)];
			var v157 := true;
			var v158 := 'x';
			v0, v0, v155[safeIndex(865, v155.Length)], v3, v157 := v0, v0, f2, v3 + v3, v52[safeIndex(|map[false := fm2(v158, f3, v157, v0, globalState)]|, |v52|)];
			var v159: map<string, map<bool, int>> := map[seq(abs(-0x164), i13  => (v158)) := fm5(f3, v0, v158, |f2|, globalState)];
			v159 := v159;
			v3 := v3;
			var v160: T0 := new C1(v158, v155[safeIndex(865, v155.Length)]);
			v160 := new C16(f2);
		}
		
		var v161: array<int> := new int[23];
		forall i14 | 0 <= i14 < v161.Length {
			v161[i14] := i14 * safeModuloInt(v0, v0);
		}
		var v162: C1 := new C1(v3[safeIndex(-v0, |v3|)], {f3, f3} - f2);
		v162 := v162;
	}
	method m5(p0: seq<int>, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: string) {
		...
		for i0 := v0 to v2.cf42 {
			...
			if (!(p2 ==> (multiset(v4) != v7))) {
				...
				var v19 := "bmdrqo";
				v17[safeIndex(919, v17.Length)] := if (f3) then v18 else [v19];
				v17[safeIndex(919, v17.Length)] := v18;
			} else {
				var v20 := 'p';
				var v21: array<bool> := new bool[7](i1 => !p2);
				var v22: seq<array<bool>> := [v21];
				var v23: map<array<bool>, char> := map[v22[safeIndex(i0, |v22|)] := fm48(p2, v0, globalState)];
				v20, v23, v0 := v20, (map[v21 := v20])[v21 := 'v'], v0 - v0;
				var v24 := false;
				v24 := i0 <= safeDivisionInt(v0, i0);
				...
				v21[safeIndex(592, v21.Length)] := p2;
				var v31: map<int, set<bool>> := map[i0 := f2];
				v1, v25, v30, v21[safeIndex(592, v21.Length)] := v1, ({p2} * (if (|p1| in v31) then v31[|p1|] else {p2})) - f2, v30, f3;
			...
			if (v35 > (if (!f3) then v35 else v35)) {
				...
				v41[safeIndex(673, v41.Length)] := v0;
				v41[safeIndex(673, v41.Length)] := v0;
				v41[safeIndex(673, v41.Length)] := safeDivisionInt(|(seq(abs(0x1d5), i3  => (|v1|)))|, v41[safeIndex(673, v41.Length)] - |fm0(v36, i0, v36, globalState)|);
				var v42: map<bool, bool> := map[v36 := v36];
				var v43 := DC22(v41, |v42|, p1[safeIndex(i0, |p1|)], v41[safeIndex(673, v41.Length)]);
				...
				v47, r0 := v48 in v49, fm6(p1[safeIndex(|{i0, i0}|, |p1|)], v0, globalState);
			}
			...
			if (false) {
				...
				v54[safeIndex(885, v54.Length)] := i0;
				v54[safeIndex(885, v54.Length)] := |(v50 + (v50 + (seq(abs(0x177), i4  => ('h')))))|;
				var v55 := 'u';
				var v56: multiset<set<bool>> := multiset{f2, f2, {p2, p2}};
				var v57 := DC43(v53, v50, p2, false, false);
				var v58: map<string, string> := map["wqw" := v50];
				var v59: array<string> := new seq<char>[29] [if (p2) then seq(abs(0x2d5), i5  => (v55)) else v50, v50, (if (v53) then v50 else v50)[safeIndex(v54[safeIndex(885, v54.Length)], |(if (v53) then v50 else v50)|) := v55], v50, seq(abs(-288), i6  => (v55)), v50, fm42(globalState), "hthrulyo", v50 + v50, seq(abs(-0x44), i7  => (v55)), v50[safeIndex(|v56|, |v50|) := 'p'], v50, v50 + v50, v50, seq(abs(0x2e1), i8  => (v55)), v50, v50, v57.cf77, v50, if (v50 in v58) then v58[v50] else v50, v50 + v50, v50, seq(abs(306), i9  => (v55)), "mfcfyx" + v50, v50, v50, v50, v50 + ("tpejh")[safeIndex(i0, |"tpejh"|) := v55], v50];
				v59[safeIndex(493, v59.Length)] := v50;
				v55, v59[safeIndex(493, v59.Length)] := v55, "pmowmmt";
			}
			
		}
		var v60 := false;
		v60 := -0x95 <= safeDivisionInt(v0, |f2|);
		var v61 := "ipkykj";
			...
			decreases 100 - i10
		{
			...
			i10 := i10 + 1;
			var v65: set<string> := {fm42(globalState) + (seq(abs(756), i12  => ('c'))), v61};
			var v66 := 'w';
			...
			v0, v65, v0, v60 := safeDivisionInt(0x141, v0) + (v0 - 780), (set v69 : string | v69 in v68 :: (v69)) * fm76(globalState), |(((map v70 : int | (260 <= v70) && (v70 < -51) :: (v70 + v0) := ([|v61|])) + (map v71 : int | (-0x192 <= v71) && (v71 < 650) :: (v71 - |v61[safeIndex(v0, |v61|) := v66]|) := (seq(abs(498), i13  => (v0))))) + v72)|, fm1((seq(abs(959), i14  => (v66))) < v61, v0, globalState);
			v0 := fm3(false, globalState) + 429;
			var v73 := DC3(v66);
			match (v73.(cf7 := v66)) {
				case DC4(cf8) =>
					v63[safeIndex(998, v63.Length)] := -500;
					v63[safeIndex(611, v63.Length)] := safeModuloInt(v0, v0);
					var v74: set<int> := {v0, v0, v0};
					var v75: map<int, int> := map[|v61| := -v0];
					v63[safeIndex(998, v63.Length)], v0, v0, v0, v63[safeIndex(611, v63.Length)] := v0, |v74|, -safeModuloInt(safeDivisionInt(v0, v0), v0), (if (v0 in v75) then v75[v0] else 0x10) * v0, v0;
					var v76: set<bool> := {f3, v60};
					v76 := v76;
					var v77: array<map<bool, bool>> := new map<bool, bool>[5];
					v77, v63[safeIndex(998, v63.Length)] := v77, v63[safeIndex(998, v63.Length)];
					...
					var v82: array<string> := new string[4] [v61, v61, v61, v81[safeIndex(v63[safeIndex(998, v63.Length)], |v81|)]];
					v82[safeIndex(870, v82.Length)] := "ap";
					v63[safeIndex(998, v63.Length)], v0, v0, v80, v82[safeIndex(870, v82.Length)] := if (cf8) then v0 - v63[safeIndex(998, v63.Length)] else v0, v0, v0, [v63[safeIndex(998, v63.Length)], fm3(p2, globalState)], "yvokgud";
				case DC3(cf7) =>
					v63 := new int[11] [v0, v0 + |[v0]|, v0, v0, v0, v0, v0, v0, 0x1df, if (v60) then v2.cf41 else v0, safeModuloInt(v0, v0)];
					var v83: map<int, char> := map[-0x1fc := cf7];
					var v84: multiset<map<int, char>> := multiset{v83, v83, v83, v83};
					v63[safeIndex(907, v63.Length)] := -v0;
					var v85: map<int, int> := map[v0 := v0 * v0];
					v84, v0, v60, v63[safeIndex(907, v63.Length)] := v84 * v84, v0, if (fm45(globalState) !! multiset{v0, |v61|, v0, v0, v0}) then v60 else f3, |v85|;
					v63[safeIndex(907, v63.Length)] := v0;
					var v86 := DC19([f2]);
					var v87: map<D7, int> := map[v86 := v63[safeIndex(907, v63.Length)]];
					var v88 := DC52(map[v86 := v63[safeIndex(907, v63.Length)]] + v87[v86 := v0]);
		...
		for i15 := v0 to |v89| {
			var v90: map<int, int> := map[i15 := safeModuloInt(v0, v0)];
	...
	method m6(globalState: GlobalState) returns (r0: bool) {
		...
		for i0 := fm3(f3, globalState) to v2.cf47 {
			...
			if (!(f3 && (f3 && f3))) {
				...
				var v8: seq<D5> := [v7];
				v4[safeIndex(414, v4.Length)] := v8 + v8;
				v4[safeIndex(414, v4.Length)] := v8;
				var v9: array<bool> := new bool[11](i1 => f3);
				v9[safeIndex(496, v9.Length)] := f3;
				var v10 := "e";
				v9[safeIndex(496, v9.Length)] := (if (f3 in v0) then v0[f3] else i0) == |v10|;
				...
				v13[safeIndex(361, v13.Length)] := v1 + i0;
				var v14 := DC50(f3, f3, |v3|);
				v13[safeIndex(361, v13.Length)] := i0 + (i0 * v14.cf95);
				var v15 := "upjhr";
				v13[safeIndex(361, v13.Length)], r0, v1 := -(v13[safeIndex(361, v13.Length)] * i0), v15 != v15, i0 - v1;
				var v16 := 'o';
				v13[safeIndex(361, v13.Length)] := |{v16, v16}| + i0;
				var v17 := DC59(!f3, v13[safeIndex(361, v13.Length)] * -v13[safeIndex(361, v13.Length)]);
				v17 := if (fm1(f3, -|"wxogkiex"|, globalState)) then DC59(f3, v13[safeIndex(361, v13.Length)]) else v17;
				r0 := f3;
			}
			
			v1 := safeModuloInt(0x71, |v3|);
			var v18: seq<char> := ['n'];
			v1 := -(|v18| * v1);
		}
		var v19 := 'm';
		...
		var v22 := DC16(v21);
		var v24 := "yvxgtihob";
		var v25: map<string, string> := map[seq(abs(-0x165), i2  => (v19)) := v24];
		...
		v31 := v31;
		var v32: seq<string> := [seq(abs(0x2a0), i3  => (v19))];
		v24 := v32[safeIndex(v1, |v32|)];
		...
		if (f3 && f3) {
			...
			if (f3) {
				r0 := f3;
				r0 := 0x66 < v1;
				var v34: array<bool> := new bool[29](i4 => !([v1] < (seq(abs(0x324), i5  => (v1)))));
				v34[safeIndex(416, v34.Length)] := f3;
				v34[safeIndex(416, v34.Length)] := f3;
				v1 := |v24|;
				...
				v40[safeIndex(549, v40.Length)] := if (fm7(!f3, seq(abs(-0x3d5), i6  => (v19)), v25, globalState)) then v19 else v19;
				var v41: map<array<int>, array<bool>> := map[v31.f5 := v39];
				v39, v40[safeIndex(549, v40.Length)] := if (v31.f5 in v41) then v41[v31.f5] else v39, v19;
			...
			if (f3) {
				...
				v31.f5[safeIndex(144, v31.f5.Length)] := safeDivisionInt(|v49|, |v50|);
				var v51 := DC57(v45, true, v1);
				r0, v45, r0, v48, v31.f5[safeIndex(144, v31.f5.Length)] := if (f3) then !false else false, (v45 + v51.cf107) + [v1, 831, v1, v1], (v24 + v24[safeIndex(v1, |v24|) := v19]) <= (v24 + v24), (if (f3) then v48 else map[map[v46 := f3] := v1]) + v48, v1;
				var v52: map<bool, bool> := map[false := true];
				v52 := v52[f3 := f3];
				var v53: multiset<seq<bool>> := multiset{v26};
				v53 := v53;
				r0 := v1 > v31.f5[safeIndex(144, v31.f5.Length)];
				var v54: array<bool> := new bool[29];
				v54[safeIndex(873, v54.Length)] := f3;
				var v55: map<int, D23> := map[|v24[safeIndex(-0x20b, |v24|) := v19]| := DC62(v1, v31.f5[safeIndex(144, v31.f5.Length)])];
				v54[safeIndex(873, v54.Length)] := !(|(v55 + v55)| > -v1);
			} else {
				var v56: array<array<bool>> := new array<bool>[9];
				var v57 := DC63(v56);
				var v58: array<D24> := new D24[3] [v57, v57.(cf118 := v56), v57];
				v58[safeIndex(616, v58.Length)] := v57;
				v58[safeIndex(616, v58.Length)] := v57;
				var v59: array<bool> := new bool[7];
				var v60: seq<int> := [v1, safeModuloInt(-v1, v1)];
				v59[safeIndex(148, v59.Length)] := f3;
				var v61: map<int, seq<int>> := map[v1 := v60];
				v59, v60, v1, v59[safeIndex(148, v59.Length)] := v59, (if (-|v27| in v61) then v61[-|v27|] else v60) + v60, 0x62 - (|(set v62 : int | (0x24d <= v62) && (v62 < 0x110) :: (v62 + |v0|))| * v1), f3;
				...
				v64 := if (v59[safeIndex(148, v59.Length)] in v66) then v66[v59[safeIndex(148, v59.Length)]] else v64;
				var v67: map<int, string> := map[if (v1 in v27) then v27[v1] else v1 := v24];
				var v68: seq<array<bool>> := [v59, v59];
				v1 := |(if (safeModuloInt(0x2, v1) in v67) then v67[safeModuloInt(0x2, v1)] else v24)[safeIndex(-(|v68| + v1), |(if (safeModuloInt(0x2, v1) in v67) then v67[safeModuloInt(0x2, v1)] else v24)|) := v19]|;
			}
			
			v24 := v24;
		} else {
			v0 := v0 + v0;
			r0 := if (|(seq(abs(0x223), i7  => (v19)))| < v1) then true else f3;
			r0 := !("wcpmmmdc" < v24);
			r0 := f3;
			var v69: multiset<string> := multiset{v24, v24, "hbwys", seq(abs(849), i8  => ('k'))};
			var v70 := DC23(v69);
...
class C18 extends T0, T1, T2 {
	...
	function fm6(p0: bool, p1: int, globalState: GlobalState): string {
		(seq(abs(0x23e), i0  => ('d'))) + ("eivsrs" + "w")
	}
	function fm7(p0: bool, p1: string, p2: map<string, string>, globalState: GlobalState): bool {
		!(0x2ab >= safeModuloInt(|['p', 'j', 'd']|, |[true, false]|))
	}
	function fm8(p0: D1, p1: int, globalState: GlobalState): multiset<bool> {
		match DC3('c') {
	...
	function fm10(p0: int, globalState: GlobalState): int {
		-match DC4(true) {
			case DC4(cf8) => safeDivisionInt(0x2e1, 719)
			case DC3(cf7) => 813
		}
	}
	...
	method m1(globalState: GlobalState) returns (r0: multiset<int>, r1: seq<bool>) {
			...
			decreases 100 - i0
		{
			...
			if (if (v3 in v5) then v5[v3] else v3) {
				...
				v1 := v1[safeIndex(|(seq(abs(0x162), i1  => (v0)))|, |v1|) := v0];
				var v8 := new C16(if (v3) then f2 else f2);
				v3 := v3 <==> v3;
				var v9: seq<int> := [v4];
				var v10: map<seq<int>, char> := map[v9 + (seq(abs(0x2b9), i2  => (v4))) := v0];
		...
		for i3 := |v16| to |(v18 + v18)| {
			...
			var v20: map<string, string> := map[v1[safeIndex(i3, |v1|) := v0] := v1];
			...
			v17, v17, v1, v19 := fm7(!v17, "jkig", v20, globalState), !(safeDivisionInt(-i3, i3) > fm3(v17, globalState)), fm62(i3 * i3, v17, v24, globalState), if (v19 in v25) then v25[v19] else v19;
			v17 := v17 <==> v17;
			var v26: seq<bool> := [v17];
			var v27: set<set<bool>> := {f2};
			var v28: array<bool> := new bool[22] [v17, v17, v17, v17, false, v26[safeIndex(fm10(i3, globalState), |v26|)], |multiset((seq(abs(0x48), i4  => (i3)))[safeIndex(i3, |(seq(abs(0x48), i4  => (i3)))|) := 0x234])| == |multiset([i3])|, true, v17, v17, v17, v17, false, v17, !(if (!v17) then v17 else v17), v17, f2 >= {v17}, |v1| == i3, v17, v17, v27 >= v27, v17];
			v28[safeIndex(329, v28.Length)] := v17;
			var v29: set<array<bool>> := {v28};
			var v30: seq<set<array<bool>>> := [v29];
			var v31: map<int, bool> := map[i3 := v17];
			v28[safeIndex(329, v28.Length)] := fm1(v30[safeIndex(|v31|, |v30|)] > v29, i3, globalState);
			var v32: map<D1, bool> := map[DC3(v0) := v17];
			var v34 := DC3(v0);
			var v35: set<D1> := {v34};
			var v36 := DC7(v28[safeIndex(329, v28.Length)], v35);
			var v37: seq<D2> := [DC7(!v17, set v33 : D1 | v33 in v32 :: (v33)), v36, v36, v36, v36];
			var v39: set<D2> := {v36};
			v28[safeIndex(329, v28.Length)] := (set v38 : D2 | v38 in v37 :: (v38)) !! v39;
		}
		v17 := v17;
		var v40 := 0x289;
		for i5 := v40 to fm3(v17, globalState) {
			...
			v40, v40, v41, v17, v40 := v42[safeIndex(v40, |v42|)] - i5, (DC81(v17, i5, v40).(cf138 := true, cf139 := i5)).cf139, v41, !(v17 !in v16), v40 - safeModuloInt(v40, i5);
			var v43: array<string> := new string[17];
			v43[safeIndex(113, v43.Length)] := "isvyxjcv";
			var v44: C16 := new C16(f2);
			var v45: map<int, C16> := map[i5 := v44];
			v43[safeIndex(113, v43.Length)] := fm40(|v45|, globalState) + v1;
		...
		var v53 := DC23(v52[v1 := abs(v40)]);
		v0 := fm61(safeDivisionInt(v40, |(seq(abs(0x329), i6  => (v40)))|), v50[safeIndex(v40, |v50|)], v51[safeIndex(v40, |v51|)], v53, globalState);
		v17 := v17;
		var v54: multiset<int> := multiset{v40, v40};
		r0 := v54 * fm45(globalState);
		var v55: seq<seq<bool>> := [v50, v50];
		r1 := v50 + v55[safeIndex(0x377, |v55|)];
	}
	method m2(p0: map<bool, string>, p1: array<array<int>>, globalState: GlobalState) {
		var v0 := false;
		var v1 := 0x1fe;
		var v2: seq<int> := [v1];
		v0 := v2[safeIndex(852, |v2|)] >= v1;
		for i0 := v1 to if (fm1(v0, |fm89(v1, globalState)|, globalState)) then |v2| else v1 {
			...
			var v8: seq<D25> := [v7];
			var v9 := 'u';
			var v10: array<bool> := new bool[12] [v3 < v3, v1 < |v5|, i0 == v1, v0, "vhrln" < v4, false, !(DC26(set v6 : int | (-221 <= v6) && (v6 < 0x58) :: (safeModuloInt(v6, i0))).cf45 > {fm3(v0, globalState)}), v8 == (seq(abs(-0x125), i1  => (DC66(v0, v0)))), v0, v0, v9 in (seq(abs(0x10d), i2  => (v9))), fm11(globalState)];
			v10[safeIndex(198, v10.Length)] := fm3(v0, globalState) == v1;
			var v11: map<bool, array<bool>> := map[v0 := v10];
			v0, v10[safeIndex(198, v10.Length)], v0, v1, v1 := v0, if (v0) then v0 else v0, fm1(if (fm1(v0, v1, globalState)) then v0 else v0, i0, globalState), |v11|, i0;
			v1 := i0;
			var v12: map<int, bool> := map[i0 := v10[safeIndex(198, v10.Length)]];
			v12 := map[safeDivisionInt(v1, v1) := v0];
		}
		var v13: array<int> := new int[21];
		v13[safeIndex(532, v13.Length)] := v1;
		v13[safeIndex(532, v13.Length)] := safeModuloInt(v1, 0x380) * v1;
		var v14 := DC31(v1, v0, v1, v1, v13[safeIndex(532, v13.Length)] + 0x206);
		match (v14) {
			case DC31(cf51, cf52, cf53, cf54, cf55) =>
				var v15 := "lohy";
				cf53 := if (v0) then -v13[safeIndex(532, v13.Length)] + |v15| else v1 * v13[safeIndex(532, v13.Length)];
				var v16 := 'd';
				var v17: map<string, int> := map[("apwpa")[safeIndex(cf51, |"apwpa"|) := v16] := v1];
				var v18 := DC39(v17);
				match (v18) {
					case DC39(cf69) =>
						var v19: map<bool, bool> := map[cf52 := v0];
						cf55 := safeModuloInt(fm3(v0, globalState), |v19|) * v1;
						var v20: map<int, bool> := map[v1 := false];
						var v22: seq<map<int, bool>> := [map v21 : int | (737 <= v21) && (v21 < 0x293) :: (v21 + |(seq(abs(0x1b7), i3  => (v16)))|) := (v0)];
						...
						var v28: array<seq<map<int, bool>>> := new seq<map<int, bool>>[24] [[v20] + v22, v22 + v22, v22, v22, v22, v22, v22, [v20] + v22, v22, v22 + v22[safeIndex(cf55, |v22|) := v20], v22, v22, v22, v22 + v22, v22, fm98(v25, globalState), [map[v13[safeIndex(532, v13.Length)] := cf52]], [v20, v20] + v22, v22, v26[safeIndex(v1, |v26|)], v22, [map v27 : int | v27 in v2 :: (safeModuloInt(v27, |multiset{cf55}|)) := (v0)], fm98(v25, globalState), v22];
						v28[safeIndex(594, v28.Length)] := v22;
						v28[safeIndex(594, v28.Length)] := fm98(map[cf52 := v24], globalState);
						v0 := cf52;
						var v29: seq<bool> := [v0, cf52];
						var v30: map<seq<bool>, int> := map[v29 := v13[safeIndex(532, v13.Length)] * v1];
						v30 := v30[if (v0) then v29 else v29 := v1];
				}
				
				var v31 := new C6();
				p1[safeIndex(427, p1.Length)] := v13;
				p1[safeIndex(427, p1.Length)] := v13;
			case DC30(cf50) =>
				...
				v35 := v35 + (v35 + v35);
				var v36: map<int, string> := map[safeDivisionInt(v1, v1) := v35];
				v36 := v36;
				v13[safeIndex(532, v13.Length)] := -(safeDivisionInt(v1, v13[safeIndex(532, v13.Length)]) + safeDivisionInt(v13[safeIndex(532, v13.Length)], v13[safeIndex(532, v13.Length)]));
		}
		...
		v0 := v38 != v38;
		var v39 := "gnesu";
		var v40 := DC81(v0, v13[safeIndex(532, v13.Length)], v1);
		var v41: seq<bool> := [v0, v40.cf138];
		for i4 := -safeDivisionInt(v1, |v39|) to v2[safeIndex(|multiset(v41)|, |v2|)] {
			var v42, v43, v44 := v37.m4(v0, v41 + v41, v0, globalState);
			v2 := seq(abs(-0xd4), i5  => (|v2[safeIndex(v13[safeIndex(532, v13.Length)], |v2|) := i4]|));
			var v45 := DC34();
			v45 := v45;
			var v46: C4 := new C4();
			v46 := DC83(v46).cf142;
	...
	method m3(p0: int, p1: bool, globalState: GlobalState) returns (r0: char, r1: int) {
			...
			decreases 100 - i0
		{
			...
			v2[safeIndex(673, v2.Length)] := v0 + v0;
			v2[safeIndex(673, v2.Length)] := v0;
			var v4 := DC9(map v3 : int | (0x3dd <= v3) && (v3 < -0x2b7) :: (safeDivisionInt(v3, p0)) := (seq(abs(0x1c), i1  => ('d'))));
			v4 := DC9(fm89(p0, globalState) + (map v5 : int | (0x2ab <= v5) && (v5 < 0x183) :: (safeModuloInt(v5, p0)) := (seq(abs(0x287), i2  => ('a')))));
		}
		var v6 := false;
		var v7 := "ykuuaetix";
		...
		if (v8[safeIndex(p0 + |v9|, |v8|)]) {
			...
			var v18 := 't';
			v15 := v15[v17 == fm99(v6, v18, v6, globalState) := safeModuloInt(if (v6 in v15) then v15[v6] else p0, p0)];
		} else {
			var v19: array<map<int, bool>> := new map<int, bool>[15];
			var v20 := DC71(v19);
			v20 := v20;
			r1 := p0;
			var v21: seq<int> := [safeDivisionInt(p0, p0), -p0];
			r1 := v21[safeIndex(p0 - p0, |v21|)];
			...
			decreases 100 - i4
		{
			...
			v28[safeIndex(140, v28.Length)] := fm47(globalState);
			v28[safeIndex(140, v28.Length)] := v7 + v7;
			r1 := p0;
			var v29: seq<int> := [safeDivisionInt(p0, p0)];
			v29 := v29 + [p0, -p0];
			v25[safeIndex(29, v25.Length)] := p1 <== v6;
			...
			var v38 := 'j';
			var v39: multiset<string> := multiset{v28[safeIndex(140, v28.Length)]};
			var v40 := DC23(v39);
			...
			var v42: array<int> := new int[29] [p0, 0x66, p0, |{|v32|, p0}|, |(map v33 : int | v33 in v9 :: (safeModuloInt(v33, p0)) := (p0))|, |v36|, 0x21f, |v29|, p0, p0, p0, |map[v37 := v41]|, |{p0, p0}|, p0, p0, p0, p0, p0, p0, p0, |v9|, p0, |v28[safeIndex(140, v28.Length)]|, |v29|, p0, p0, |v28[safeIndex(140, v28.Length)]|, p0, p0];
			var v43: seq<array<int>> := [v42];
			v25[safeIndex(29, v25.Length)], v6, v6, r1 := v6, {[p1, !p1, p1, false, p1]} > v30, v43 <= v43, -p0;
		}
	...
	method m4(p0: bool, p1: seq<bool>, p2: bool, globalState: GlobalState) returns (r0: array<set<int>>, r1: bool, r2: multiset<seq<D0>>) {
			...
			decreases 100 - i0
		{
			...
			match (v3) {
				case DC57(cf107, cf108, cf109) =>
					...
					v4[safeIndex(154, v4.Length)] := -cf109;
					v4[safeIndex(154, v4.Length)] := |v1|;
					cf109 := v4[safeIndex(154, v4.Length)] * (cf109 + cf109);
					var v5: map<int, int> := map[cf109 := -v4[safeIndex(154, v4.Length)]];
					var v6: multiset<map<int, int>> := multiset{v5};
					v6 := (v6 * fm100(|map[if (p2 in v0) then v0[p2] else p0 := 0xc8]|, globalState)) * fm100(v4[safeIndex(154, v4.Length)], globalState);
				case DC56(cf106) =>
					r1 := !!p2;
					var v7: array<bool> := new bool[25];
					v7[safeIndex(467, v7.Length)] := p2;
					var v8 := 0x1a4;
					v7[safeIndex(467, v7.Length)] := fm1(p2 && p2, v8, globalState);
			...
			var v19: array<int> := new int[27] [-v10, v10, v10, safeModuloInt(v10, |fm49(0x3d2, v10, -v10, globalState)|), v10, 0x304 - |p1|, v10, v10, v10 - |v12|, safeDivisionInt(-v10, v10), v10 * v10, -|"qfyifh"|, v10, v10 * v10, v10 - v10, v10, |(v13 * v13)|, v10 - |v15|, 0x249, v10, v10, if (p2) then |p1| else v10, v10, |(p1 + p1)|, |v18| + -fm10(v10, globalState), v10, |v1|];
			v10, v19 := v10, v19;
		}
		var v20 := 0x246;
		var v21 := "pheippi";
		...
		match (v22) {
			case DC1(cf1, cf2, cf3, cf4, cf5) =>
				...
				var v25: seq<array<int>> := [v24[safeIndex(v20, |v24|)], v23, v23, v23, v23];
				v24 := (v24 + [v23])[safeIndex(v20, |(v24 + [v23])|) := v23];
				...
				if (p2) {
					...
					v32[safeIndex(9, v32.Length)] := v31;
					v32[safeIndex(9, v32.Length)] := v31;
					var v33: set<int> := {v20};
					cf3, cf5, cf3, cf5, v20 := if (!cf3) then !p1[safeIndex(v20, |p1|)] else cf5 <==> cf5, (v33 == v33) <==> false, fm1(f2 < f2, cf2, globalState), cf5, fm3(p2, globalState);
					var v34: C15 := new C15(v23);
					var v35: seq<C15> := [v34, v34, v34, v34];
					var v36: multiset<C15> := multiset{v34};
					cf3 := ((multiset(v35))[v34 := abs(|v21|)])[v34 := abs(-v20)] > (v36 * v36);
					cf3 := cf5;
				} else {
					cf3 := v21[safeIndex(0x16c, |v21|) := v30] == ("xpgciv")[safeIndex(fm10(|v21|, globalState), |"xpgciv"|) := v30];
					...
					v42[safeIndex(405, v42.Length)] := v41;
					cf5, v42[safeIndex(405, v42.Length)] := fm3(p0, globalState) <= 244, v41.(cf124 := v40);
					v21 := if (cf3) then v21 else seq(abs(0x330), i2  => (v30));
					v20 := v37;
				}
			...
			case DC0(cf0) =>
				...
				var v48: seq<string> := [seq(abs(872), i3  => ('v'))];
				var v49: array<string> := new string[8] [v21, v21, v21, v21, v21, v21, v48[safeIndex(cf0, |v48|)], seq(abs(0x287), i4  => ('w'))];
				var v50: map<array<string>, bool> := map[v49 := !p2];
				var v51: array<int> := new int[13] [v20 - v20, cf0, safeModuloInt(cf0, -0x1c9), cf0 * 0x3c0, v20, cf0, v43[safeIndex(cf0, |v43|)], fm3(p2, globalState) * cf0, v20, v20, v20, |((if ((if (v49 in v50) then v50[v49] else p2) in v47) then v47[if (v49 in v50) then v50[v49] else p2] else v46) + v46)|, cf0];
				v51 := DC22(v51, v20, p2, -13).cf36;
				var v52: array<array<int>> := new array<int>[21];
				v52[safeIndex(517, v52.Length)] := v51;
				v52[safeIndex(517, v52.Length)] := v51;
			...
			case DC2(cf6) =>
				...
				if (|(if (p0) then {map[fm1(p2, -v20, globalState) := p0]} else fm103(v20, v20, DC20(v56, !!p2, v55), v20, globalState))| == v20) {
					...
					v61[safeIndex(195, v61.Length)] := p2;
					v61[safeIndex(195, v61.Length)] := v20 >= --0x240;
					var v62: array<char> := new char[6](i5 => 'x');
					v61[safeIndex(195, v61.Length)] := v62 in ([v62] + [v62]);
					var v63: seq<string> := [v21, v21 + v21];
					var v64: array<int> := new int[4] [v20, v20 + v20, -|v21|, |v58[v20 := abs(0x37)]|];
					var v65: seq<int> := [v20, v20, 970, v20, v20];
					v20, v63, v64, v64, v20 := safeModuloInt(safeModuloInt(v20, |v65|), |(v21 + v21)|), ([v21] + v63) + v63, v64, v64, v20;
					v61[safeIndex(195, v61.Length)] := fm25(v20, globalState) !! f2;
					v20 := v20;
				} else {
					v20 := v20;
					v21, v20 := v21, v20;
				...
				v20, v67[safeIndex(365, v67.Length)] := safeModuloInt(|v72|, v20) - v20, v73[safeIndex(v20, |v73|)];
				v70 := v70;
		}
		
		for i6 := -0x186 to v20 {
			v20 := safeModuloInt(i6, v20);
			var v74 := 's';
			...
			var v80: array<int> := new int[15] [i6, safeModuloInt(v20, v20), -|fm52(v74, if (multiset(p1) in v76) then v76[multiset(p1)] else i6, globalState)| + i6, i6, v20, -|fm104(v77, v0, globalState)|, v20, v20, |({v78} * {map[v74 := v20], v78})|, v20, safeDivisionInt(i6, |v21|), i6, -i6, v20, if (p0) then |map[p2 := p0]| else |v79|];
			var v81: map<int, string> := map[-0x2b6 := seq(abs(-0x2cb), i7  => (v74))];
			var v82 := DC9(v81);
			var v83: T1 := new C7(v74);
			var v84: map<D3, T1> := map[v82 := v83];
			v80[safeIndex(189, v80.Length)] := |v84|;
			v80[safeIndex(189, v80.Length)] := -fm10(i6, globalState);
			var v85: array<seq<char>> := new seq<char>[18](i8 => seq(abs(0xa8), i9  => (v74)));
			v85 := v85;
			r1 := v20 >= safeModuloInt(-360, v80[safeIndex(189, v80.Length)]);
		}
		r1 := true;
		v20, r1, r1 := safeDivisionInt(|"nxtejc"|, safeModuloInt(0x10, v20)), p0, p0;
...
function fm1(p0: bool, p1: int, globalState: GlobalState): bool {
	(multiset{0x32d} - multiset([|(seq(abs(0x2e1), i0  => ('q')))|, -532])) > (multiset{-0x352, 0x314} - multiset{601})
}
...
function fm3(p0: bool, globalState: GlobalState): int {
	-|((seq(abs(0x22b), i0  => ('i'))) + "a")| * 0x2b5
}
function fm4(p0: bool, p1: int, p2: int, p3: int, globalState: GlobalState): set<int> {
	({|map['h' := |[422]|]|, |(seq(abs(0x1b), i0  => ('d')))|} - {426}) * (set v1 : int | v1 in multiset(seq(abs(625), i1  => (|(set v0 : int | v0 in {DC31(0x21e, false, |[|"nyqoaa"|]|, -|[true, false]|, 0x1b).cf54} :: (v0 * -0x166))|))) :: (safeDivisionInt(v1, 0x180)))
}
function fm5(p0: bool, p1: int, p2: char, p3: int, globalState: GlobalState): map<bool, int> {
	map[false := |multiset{true, false}|] + (map[false := |"nu"|] + map[true := |(seq(abs(0x393), i0  => ('h')))|])
}
...
function fm27(p0: bool, p1: int, p2: bool, p3: bool, globalState: GlobalState): string {
	"r" + ("hobif" + (seq(abs(0x62), i0  => ('l'))))
}
function fm28(p0: int, globalState: GlobalState): seq<int> {
	(if (!false) then [|map[true := |{-|[0x2f8]|}|]|] else seq(abs(151), i0  => (973))) + ([|"qgmpn"|] + (seq(abs(0xc5), i1  => (0x1fb))))
}
function fm31(globalState: GlobalState): seq<D2> {
	seq(abs(439), i0  => (DC8(DC6(false, false, 't', 0xc9, !false))))
}
...
function fm42(globalState: GlobalState): string {
	match DC53(!true, |(seq(abs(404), i0  => (919)))|) {
...
function fm50(globalState: GlobalState): map<int, int> {
	((map v0 : int | (0x19d <= v0) && (v0 < 0x74) :: (safeDivisionInt(v0, |{|map[true := true]|}|)) := (|[true]|)) + (map v1 : int | v1 in [0x7a, |(seq(abs(0xe4), i0  => ('c')))|] :: (v1 + 793) := (-0xd4))) + map[-0x49 := --0x159]
}
...
function fm52(p0: char, p1: int, globalState: GlobalState): map<char, int> {
	match DC85(|"axxdhiu"|, map[true := -|{false, true}|], 0xbe) {
		case DC85(cf144, cf145, cf146) => map v0 : char | v0 in (seq(abs(0x33d), i0  => ('e'))) :: (v0) := (-cf144)
...
function fm56(p0: int, globalState: GlobalState): seq<set<int>> {
	DC48(seq(abs(0xbd), i0  => ({-0x1e3}))).cf89
}
...
function fm58(globalState: GlobalState): D16 {
	DC45(0x280 - 0x2bd, |(seq(abs(0x32b), i0  => ('w')))| > |map[|"wtiby"| := true]|, DC34())
}
function fm59(p0: bool, p1: bool, globalState: GlobalState): map<D7, int> {
	map[DC19([{false, false}]) := |{'x'}|] + ((map v0 : D7 | v0 in [DC19(seq(abs(0x274), i0  => ({true})))] :: (v0) := (|map[true := false]|)) + map[DC19([{!false}, {false}, {true}]) := 0x1c4])
}
...
function fm62(p0: int, p1: bool, p2: multiset<set<D9>>, globalState: GlobalState): string {
	((seq(abs(0x6f), i0  => ('a'))) + (seq(abs(-0x71), i1  => ('y')))) + "vsqn"
}
...
function fm65(p0: bool, p1: bool, globalState: GlobalState): D21 {
	DC57(DC29([429, |multiset{30, |multiset{'l'}|, |multiset{false, false, false}|, 0x343, |"sxrrgisr"|}|]).cf49 + [|[false]|], true, |(seq(abs(0xe1), i0  => ('r')))| * 0x19f)
}
...
function fm69(p0: bool, p1: bool, globalState: GlobalState): D19 {
	if (!(|map[true := [413]]| < -|map[seq(abs(0x123), i0  => ('a')) := -0x115]|)) then DC54(DC54(DC53(!false, |map[-743 := 0xd0]|))) else DC54(DC53(!!false, 0x292))
}
function fm70(p0: bool, p1: int, p2: int, globalState: GlobalState): D1 {
	match DC78(map[-187 := multiset{|multiset{-0x281, |(seq(abs(865), i0  => ('g')))|, |map[0x120 := true]|, 0x22e}|}]) {
...
function fm72(p0: bool, p1: D18, globalState: GlobalState): set<seq<int>> {
	{[0x240, |multiset([false])|, -139] + [881, |{!false}|, |map[!true := false]|], (seq(abs(0x334), i0  => (|[|map[|{false}| := |multiset([false])|]|, 0x81]|))) + [288, |(seq(abs(-0x5d), i1  => ('e')))|, -61]}
}
...
function fm75(p0: bool, globalState: GlobalState): map<D7, bool> {
	map[DC20('k', false, map[0x107 := 0x2d8]) := true] + map[DC20('o', true, map v0 : int | (797 <= v0) && (v0 < 0x87) :: (v0 - 239) := (|map[false := -|(seq(abs(0x2c5), i0  => ('a')))|]|)) := false]
}
function fm76(globalState: GlobalState): set<string> {
	({seq(abs(0x35d), i0  => ('e')), "kcojsk"} * {"ptopx"}) * (if (false) then {seq(abs(830), i1  => (DC3('w').cf7))} else {"apjutuynh"})
}
...
function fm78(p0: int, p1: seq<int>, p2: int, globalState: GlobalState): seq<string> {
	match DC42(map[false := map[true := |"ihy"|]]) {
		case DC43(cf76, cf77, cf78, cf79, cf80) => [cf77[safeIndex(|map[false := 0x342]|, |cf77|) := 'a']]
		case DC44(cf81, cf82, cf83) => ["oym", seq(abs(0x1dd), i0  => ('l'))]
		case DC45(cf84, cf85, cf86) => ["iyjwlqp", "flba", "dqj", "elcor", "vux"]
		case DC42(cf75) => seq(abs(0x3a8), i1  => ("fogrubnio"))
		case DC46(cf87) => [seq(abs(0x28d), i2  => ('q'))] + ["frxqoa", "scjerf"]
	}
}
...
function fm81(p0: bool, p1: int, p2: int, globalState: GlobalState): seq<D2> {
	seq(abs(0x3bc), i0  => (DC5([false, !false])))
}
function fm82(globalState: GlobalState): D7 {
	match DC24(0x2d1, |map['t' := [false]]|, [true]) {
		case DC24(cf41, cf42, cf43) => if (true) then DC20('b', false, map[|"pjpaq"| := cf42]) else DC20('n', true, map v0 : int | v0 in (seq(abs(0xcc), i0  => (cf41))) :: (safeDivisionInt(v0, cf41)) := (cf42))
		case DC23(cf40) => DC20('a', true, map v1 : int | (0x35e <= v1) && (v1 < 0x10c) :: (safeModuloInt(v1, |DC29(seq(abs(0x24d), i1  => (|(map v2 : int | (12 <= v2) && (v2 < -403) :: (safeDivisionInt(v2, 0x119)) := (|map['h' := true]|))|))).cf49|)) := (370))
		case DC25(cf44) => DC20('v', true, map[0x38d := -|(seq(abs(0x269), i2  => ('i')))|])
	}
}
function fm83(p0: bool, p1: int, globalState: GlobalState): seq<seq<int>> {
	((seq(abs(0x37d), i0  => ([-96, -|multiset{{false, true}, {false}}|]))) + (seq(abs(0x9c), i1  => ([0x2c3])))) + (if (DC45(0x2bf, !false, DC34()).cf85) then [[0x233, |multiset{false}|, 0x6]] else [[|"tcxp"|], seq(abs(0x6d), i2  => (|(map v0 : D4 | v0 in (map v1 : D4 | v1 in multiset{DC15(|multiset([true, true])|, [false], false)} :: (v1) := (-|{0x64}|)) :: (v0) := (|map[true := "clbpuiu"]|))|))])
}
function fm84(p0: int, p1: int, globalState: GlobalState): D3 {
	match DC85(|map['l' := 0x21a]|, DC85(-0x1cd, map[!!true := |multiset([0x2c1])|], |multiset{'a'}|).cf145, |(seq(abs(0x10b), i0  => ('v')))|) {
...
function fm85(p0: seq<bool>, p1: string, p2: int, p3: set<char>, globalState: GlobalState): D2 {
	if (true) then DC7(true, {DC3('q'), DC3('y'), DC3('t')}) else DC7(true, set v0 : D1 | v0 in (seq(abs(-0x33b), i0  => (DC3('n')))) :: (v0))
}
function fm86(p0: bool, globalState: GlobalState): map<int, char> {
	map[-|(seq(abs(0x1ec), i0  => ('h')))| := 'o'] + map[-0x2a8 := 't']
}
...
function fm89(p0: int, globalState: GlobalState): map<int, string> {
	match DC28(DC26(set v0 : int | (0x25c <= v0) && (v0 < -0x2fe) :: (safeDivisionInt(v0, 0x26e)))) {
		case DC27(cf46, cf47) => map[|[DC57(seq(abs(0x0), i0  => (|"d"|)), false, cf47), DC57([cf47], true, |multiset{-cf47, cf47}|)]| := "vhpqt"]
		case DC26(cf45) => map[|"mh"| := "jvgofxkix"] + map[-0x20c := seq(abs(779), i1  => ('d'))]
...
function fm93(p0: bool, p1: bool, globalState: GlobalState): D6 {
	match DC6(false, false, 'v', |multiset{!!!false, false}|, true) {
		...
		case DC8(cf17) => DC18(multiset{|(seq(abs(0x1dd), i0  => ('t')))|, -|"ofniu"|, |{true}|, |(seq(abs(874), i1  => (--804)))|, 658})
	}
}
...
function fm95(p0: int, globalState: GlobalState): seq<seq<bool>> {
	((seq(abs(520), i0  => ([true, DC96(-|map[|map[!true := 939]| := true]|, -0x24e, false).cf164]))) + [[false], [false, true, false, !true]]) + [[false], [!false]]
}
...
function fm98(p0: map<bool, D32>, globalState: GlobalState): seq<map<int, bool>> {
	[map[0x220 := false], map v0 : int | (652 <= v0) && (v0 < 0x18f) :: (v0 + 809) := (true), map[0x26 := true]] + (seq(abs(0x28), i0  => (map[|{DC60(DC17(), DC5([true]))}| := !true])))
}
function fm99(p0: bool, p1: char, p2: bool, globalState: GlobalState): map<bool, seq<int>> {
	match DC99(DC97([map['h' := DC6(true, true, 'n', --0x95, false)], map['n' := DC6(true, true, 'p', -0x61, false)], map['r' := DC6(true, !false, 'n', -341, true)]], false, !!false, 0x2b8, DC80(|"ytdkbj"|, false, true).cf135)) {
		case DC96(cf162, cf163, cf164) => map[cf164 := [cf163, 95, cf162, cf162]] + map[false := seq(abs(0x218), i0  => (cf163))]
		...
		case DC99(cf170) => if (false) then map[!false := [|map[true := seq(abs(0x238), i1  => ('g'))]|]] else map[true := [0x386]]
	}
}
function fm100(p0: int, globalState: GlobalState): multiset<map<int, int>> {
	(if (true) then multiset([map[|"bn"| := |[false]|], map[|[true, false]| := -516], map[921 := |map[true := |{map[|(map v0 : int | (0x59 <= v0) && (v0 < 886) :: (safeModuloInt(v0, |multiset{|"phspx"|, -0x200}|)) := (794))| := 'k']}|]|], map[|"bndka"| := 804], map v1 : int | (185 <= v1) && (v1 < 0x395) :: (safeModuloInt(v1, 0xc3)) := (|map[0x3ac := |[!false, false]|]|)]) else multiset{map v2 : int | v2 in (seq(abs(86), i0  => (735))) :: (safeModuloInt(v2, |map[-|"saiurmvt"| := |"yrhwwhx"|]|)) := (|map[0x2ac := false]|), map[-508 := |"gbxdj"|]}) * multiset{map[|map['e' := -0x1a4]| := |multiset{0x254}|]}
}
function fm101(p0: bool, globalState: GlobalState): multiset<map<int, bool>> {
	(multiset{map[-158 := false], map v0 : int | (308 <= v0) && (v0 < 0xe5) :: (safeDivisionInt(v0, -0x2bd)) := (true)} * multiset{map[874 := false], map[-|"ci"| := false]}) * multiset{map[|"bnchkpfr"| := true]}
}
function fm102(p0: int, globalState: GlobalState): D23 {
	DC62(|"e"|, |(if (true) then map[|map[|(map v0 : int | v0 in multiset{0x66, -0x3a8} :: (safeModuloInt(v0, -0x115)) := (50))| := |map[true := 431]|]| := |multiset{DC96(|"eygj"|, 669, false)}|] else map v1 : int | (0x3b2 <= v1) && (v1 < 466) :: (v1 + |"peunku"|) := (|map[|[false]| := 174]|))|)
}
...
function fm105(globalState: GlobalState): map<seq<int>, int> {
	(map[[0x202] := |[true]|] + map[[--|(map v0 : string | v0 in ["qoxrwea", "ufncdwm", "gwp", "lwskaei", "o"] :: (v0) := (true))|] := |map[|map[false := -|"bmcmh"|]| := multiset([true])]|]) + (map[seq(abs(0xdc), i0  => (0x9d)) := |multiset([--0x1e7])|] + map[[|(seq(abs(732), i1  => (|multiset{false}|)))|, 0x19d] := |(seq(abs(0x391), i2  => (0xaf)))|])
}
method m0(globalState: GlobalState) returns (r0: int, r1: int, r2: seq<bool>) {
	...
	match (if (v7 >= v7) then v11 else DC28(v10)) {
		case DC27(cf46, cf47) =>
			...
			v12[safeIndex(250, v12.Length)] := v6.f2;
			v12[safeIndex(250, v12.Length)] := v6.f2;
			var v13 := 'a';
			var v14 := DC3(v13);
			match (DC16((map[v12[safeIndex(250, v12.Length)] := v14])[v4 := DC3(v13)] + map[v6.f2 := v14])) {
				case DC17() =>
					var v15: array<bool> := new bool[27];
					v15[safeIndex(632, v15.Length)] := v3;
					v15[safeIndex(632, v15.Length)] := v3;
					var v16: multiset<int> := multiset{|multiset(seq(abs(-0x6c), i0  => (|map[v3 := v3]|)))|};
					...
					var v25: array<set<int>> := new set<int>[27] [{0x10a, v0}, v5, v5, {cf47}, v5, if (v3) then {v0} else {304, if (v0 in v16) then v16[v0] else 0x2ce}, v5, v5, v1 * v5, v5, v1, v1, {v0, v0, v0, cf47}, set v17 : int | (-0x355 <= v17) && (v17 < 683) :: (v17 - v0), fm4(v15[safeIndex(632, v15.Length)], |v18|, if (v20 in v21) then v21[v20] else v0, cf47, globalState), v1, v5, v5, v1, (if (false in v22) then v22[false] else v1) + {v0, v0, v0, v0}, set v23 : int | (952 <= v23) && (v23 < -0x28f) :: (v23 * v0), if (v3) then v1 else set v24 : int | v24 in v5 :: (safeDivisionInt(v24, 397)), v1, {v0}, v1, v1, v1];
					var v26: C11 := new C11(v18[v15[safeIndex(632, v15.Length)] := true], map[|v19| := !v20.f16]);
					var v27: seq<C11> := [v26, v26, v26];
					v25[safeIndex(726, v25.Length)] := {fm3(v15[safeIndex(632, v15.Length)], globalState), v0, |v27|};
					v25[safeIndex(726, v25.Length)] := v1;
					var v28: array<int> := new int[9];
					v28[safeIndex(428, v28.Length)] := v0;
					var v29: map<multiset<bool>, array<int>> := map[multiset{false, v20.f16, true} := v28];
					v28, v28[safeIndex(428, v28.Length)], v3, v19 := v28, cf47, multiset{v3, !false} !in (if (v15[safeIndex(632, v15.Length)]) then v29 else v29), if (v3 <== v3) then v20.f15 else v20.f15;
					v15[safeIndex(632, v15.Length)] := v3 !in multiset{v15[safeIndex(632, v15.Length)]};
				case DC16(cf26) =>
					var v30 := DC30(v6.f2);
					var v31: T2 := new C17(v3, v12[safeIndex(250, v12.Length)] * v30.cf50);
					v31 := v31;
					var v32: array<int> := new int[18](i1 => safeModuloInt(i1, cf47));
					v32[safeIndex(590, v32.Length)] := |multiset{v13}|;
					v32[safeIndex(590, v32.Length)] := fm3(false, globalState);
					var v33: array<bool> := new bool[26];
					var v34: array<C6> := new C6[10];
					var v35: C6 := new C6();
					v34[safeIndex(361, v34.Length)] := v35;
					v33, v34[safeIndex(361, v34.Length)], v32 := v33, v35, v32;
					v0 := safeModuloInt(-|v9|, cf47 + v0);
			}
			
			var v36: array<array<string>> := new array<string>[17];
			var v37: array<string> := new string[17];
			v36[safeIndex(50, v36.Length)] := v37;
			var v38: seq<int> := [v0];
			var v39: map<seq<int>, int> := map[v38 := cf47];
			var v40: C10 := new C10(v39, v3);
			v36[safeIndex(50, v36.Length)], v40 := v37, v40;
			...
			v42[safeIndex(164, v42.Length)] := v41;
			v42[safeIndex(164, v42.Length)], r1 := if (v41.f3) then v41 else v41, v0 + -|fm105(globalState)|;
		case DC26(cf45) =>
			...
			var v52: C10 := new C10(v51[seq(abs(-0x381), i3  => (v0)) := v0], !v3);
			var v53: map<C10, bool> := map[v52 := v3];
			v47[safeIndex(418, v47.Length)] := [v53];
			var v54: seq<map<C10, bool>> := [v53, v53, v53, v53 + v53];
			v47[safeIndex(418, v47.Length)] := v54;
			if (v3 || !!false) {
				v44 := (v44 + v44) + v44;
				...
				v50 := v56[safeIndex(v0, |v56|)];
				r1 := v0;
			} else {
				r0 := safeDivisionInt(v0 - 0x86, v0);
				var v57: map<bool, int> := map[true := v0];
				var v58: C17 := new C17(v52.f9, fm74(v52.f9, v9[safeIndex(|v44|, |v9|)], globalState));
		...
		case DC28(cf48) =>
			...
			if (v3) {
				var v67: map<string, string> := map["wdkgntvft" := seq(abs(-625), i4  => ('e'))];
				var v68 := 'g';
				var v69: array<bool> := new bool[18] [!v66.f16, v63.fm7(!v3, v66.f15, v67[v66.f15[safeIndex(v0, |v66.f15|) := v68] := "fldxvun"], globalState), v66.f16 <== v66.f16, v66.f16, v66.f16, v66.f16, v3, v3, |v64| >= v0, if (v3) then v66.f16 else v3, !v66.f16, v66.f16, v3, v66.f16, v66.f16, v66.f16, v66.f16 ==> v66.f16, if (v66.f16) then !v66.f16 else false];
				v69[safeIndex(491, v69.Length)] := v66.f16;
				v69[safeIndex(491, v69.Length)] := false;
				var v70 := new C0();
				...
				v72 := v73[safeIndex(-0x92 + v0, |v73|)];
				var v74: seq<seq<int>> := [v65];
				v65 := v74[safeIndex(v0, |v74|)];
			} else {
				...
				var v82 := DC68(fm78(v0, seq(abs(0x258), i5  => (v0)), v0, globalState) + v81);
				var v83: map<bool, seq<int>> := map[true := v65];
				var v84: seq<C11> := [v80];
				v82 := DC68(fm78(v0, if (false in v83) then v83[false] else [v0], |v84|, globalState)).(cf123 := [v64]);
				v3, v8, r1, v3 := v66.f16, v8, v65[safeIndex(v0, |v65|)] * |v66.f15|, v66.f16;
				v3, r0 := v9[safeIndex(v0, |v9|)], v0;
			}
			
			var v85: T1 := new C18(v6.f2);
			var v86: seq<T1> := [v85];
			var v87: map<bool, T1> := map[v66.f16 := v85];
			var v88: array<T1> := new T1[19] [v86[safeIndex(|v66.f15|, |v86|)], v85, v85, if (false in v87) then v87[false] else v85, v85, v85, if (v3 in v87) then v87[v3] else v85, v85, v85, v85, v85, if (v3) then v85 else v85, v85, v85, v85, v85, v85, v85, v85];
			v88[safeIndex(119, v88.Length)] := v85;
			v88[safeIndex(119, v88.Length)] := new C7(if (v3) then 'm' else 'd');
	}
	
	v3 := v3;
	var v89: array<int> := new int[6](i6 => safeDivisionInt(i6, v0));
	v89[safeIndex(413, v89.Length)] := 0x321;
	v89[safeIndex(413, v89.Length)] := v0;
	r0 := v89[safeIndex(413, v89.Length)];
	var v90 := "p";
	var v91: map<bool, string> := map[v3 := v90];
	var v92 := DC22(v89, v0, v3, -v89[safeIndex(413, v89.Length)]);
...
method Main() {
	...
	if (v0 ==> false) {
		...
		v6 := map v7 : int | v7 in v8 :: (safeModuloInt(v7, |map[-0x30b := 0x34e]|)) := (v5 - v5);
		v1 := -v1;
	} else {
		var v9 := -739;
		v9 := v9;
		...
		if (v0) {
			...
			v14[safeIndex(434, v14.Length)] := false;
			var v15: multiset<seq<bool>> := multiset{v13};
			var v16: seq<seq<bool>> := [v13];
			var v17: seq<multiset<seq<bool>>> := [v15, v15];
			var v18: array<multiset<seq<bool>>> := new multiset<seq<bool>>[14] [v15, v15, v15, if (v0) then multiset(v16) else v15, v15, v15, v15, v17[safeIndex(v9, |v17|)] * multiset{v13}, v15, v15 * v15, multiset(v16) - v15, v15, v15, v15];
			v18[safeIndex(76, v18.Length)] := multiset(v16);
			var v19: map<set<bool>, seq<bool>> := map[v10 := (fm0(v0, v9, v0, globalState))[safeIndex(v9, |fm0(v0, v9, v0, globalState)|) := v0] + v13];
			var v20: seq<int> := [v9];
			var v21: set<seq<int>> := {v20};
			v13, v14[safeIndex(434, v14.Length)], v18[safeIndex(76, v18.Length)] := if (v10 in v19) then v19[v10] else v16[safeIndex(|v21|, |v16|)], if (v0) then v0 else false, v15;
			var v22: multiset<bool> := multiset{!!v14[safeIndex(434, v14.Length)]};
			v0 := !fm1(!(fm2('w', !v14[safeIndex(434, v14.Length)], v14[safeIndex(434, v14.Length)], v9, globalState) == v22), v9, globalState);
			var v23: array<int> := new int[18](i1 => i1 - -v9);
			v23[safeIndex(668, v23.Length)] := v9;
			v23[safeIndex(668, v23.Length)] := safeDivisionInt(v9, v9);
			v23[safeIndex(668, v23.Length)] := fm3(true, globalState);
		} else {
			var v24 := 'i';
			...
			v31[safeIndex(312, v31.Length)] := true;
			v31[safeIndex(312, v31.Length)] := v9 <= v9;
			var v32 := "mqyctk";
			var v33: multiset<bool> := multiset{v31[safeIndex(312, v31.Length)], v9 <= -|v32|};
			v9 := if (v0 in v33) then v33[v0] else |['p', v24]|;
			var v34: set<char> := {v24, v24};
			var v35: set<int> := {v9};
			v31[safeIndex(312, v31.Length)] := fm4(true, |v34|, |v33|, v9, globalState) >= v35;
			var v36 := DC3(v24);
			var v37: seq<D1> := [v36, DC3(v24), v36, v36, v36];
			v37 := (v37 + v37) + v37;
			v9 := safeDivisionInt(v9, safeModuloInt(v9, v9));
		}
		
		var v38: array<char> := new char[17](i2 => 'h');
		var v39 := 'p';
		v38[safeIndex(775, v38.Length)] := v39;
		v38[safeIndex(775, v38.Length)] := v39;
	}
	
	var v40: array<int> := new int[7](i3 => i3 * |(seq(abs(218), i4  => ('t')))|);
	var v41 := "bnf";
	var v42 := 0x4b;
	var v43: seq<bool> := [v0];
		...
		decreases 100 - i5
	{
		...
		i5 := i5 + 1;
		v0 := v0;
		v0 := |v47[safeIndex(v45, |v47|) := false]| > v46;
		var v48 := DC0(v42);
		var v49: seq<map<bool, D0>> := [map[v0 := v48]];
		var v50: map<bool, D0> := map[v0 := v48];
		var v51: multiset<seq<map<bool, D0>>> := multiset{(v49 + [v50, v50, v50])[safeIndex(v46, |(v49 + [v50, v50, v50])|) := (map[v0 := v48])[v0 := DC0(v42)]]};
		v46 := if ((v49 + v49) in v51) then v51[v49 + v49] else v45 * v42;
		var v52: array<map<int, bool>> := new map<int, bool>[1];
		v52[safeIndex(218, v52.Length)] := map[v46 := v0];
		var v53 := 'b';
		v46, v0, v52[safeIndex(218, v52.Length)] := v42, fm1(v0, v42, globalState) <== true, map[|fm5(v0, v42, v53, v46, globalState)| := v0];
	}
	...
	if ((if (v0) then v0 else v0) || v0) {
		var v58 := 'a';
		v0 := !(v58 !in (v41 + (seq(abs(0x191), i6  => (v58)))));
		if (v0) {
			var v59: multiset<seq<bool>> := multiset{v56};
			v42 := safeModuloInt(safeDivisionInt(|v56|, v55), |v59|);
			var v60: array<array<bool>> := new array<bool>[21];
			var v61: map<int, array<array<bool>>> := map[safeModuloInt(v45, v46) := v60];
			var v62 := DC4(v0);
			...
			v64[safeIndex(366, v64.Length)] := v62;
			v45, v45, v64[safeIndex(366, v64.Length)], v0 := -0x2d + v54, v55, v62, safeModuloInt(-576, v46) > v42;
		...
		if ((v0 || v47[safeIndex(v42, |v47|)]) && !true) {
			v41 := "ytyutfpug" + v41;
			var v77: map<int, bool> := map[v45 := v0];
			v77 := (v77 + v77) + v77[-v46 := v0];
			v46 := safeModuloInt(v42, safeModuloInt(v45, -v45));
			v55 := fm3(false, globalState);
			v41 := seq(abs(0x186), i7  => (v58));
		} else {
			...
			v79[safeIndex(377, v79.Length)] := v80 + v80;
			var v81: map<string, map<string, bool>> := map[v41 := v80[v41 := v0]];
			v79[safeIndex(377, v79.Length)] := (if (v41 in v81) then v81[v41] else map[v41 := v0]) + v80;
			var v82: map<array<int>, string> := map[v40 := v41];
			var v83: T0 := new C3(if (v40 in v82) then v82[v40] else seq(abs(0x352), i9  => (v58)), v0, {v0});
			var v84 := DC30(v83.f2);
		...
		var v89 := 'c';
		v40[safeIndex(739, v40.Length)] := v54;
		var v90 := DC59(v0, v45);
		var v91: set<bool> := {v0, !v90.cf111};
		var v92: T0 := new C16(v91);
		var v93: map<bool, bool> := map[v0 := v0];
		var v94: multiset<bool> := multiset{v56[safeIndex(|v93|, |v56|)]};
		v54, v89, v40[safeIndex(739, v40.Length)], v55, v92 := v42 + (if (v0 in v94) then v94[v0] else v42), v89, 0x1df, v55, v92;
		var v95: seq<int> := [v42];
		v45 := v95[safeIndex(v40[safeIndex(739, v40.Length)], |v95|)];
		var v96: array<bool> := new bool[29];
		var v97: map<int, array<bool>> := map[v42 := v96];
		var v98 := DC40(v97);
		v98 := DC40(v97).(cf70 := v97);
		var v99: array<int> := new int[7](i10 => i10 - DC51(v0, |map[v54 := false]|, v40[safeIndex(739, v40.Length)], v56, v42).cf97);
		v99 := v99;
		var v100: T2 := new C17(!({v0} !! v91), v91);
		var v101: seq<array<bool>> := [v96];
		var v102: map<int, bool> := map[|v91| := v0];
		v100, v0, v89 := v100, |(v101[safeIndex(v55, |v101|) := v96] + v101)| != |v102|, v89;
	}
	
	if (v0) {
		v40[safeIndex(800, v40.Length)] := v46;
		v40[safeIndex(115, v40.Length)] := v55;
		var v103 := 'w';
		v40[safeIndex(800, v40.Length)], v40[safeIndex(115, v40.Length)], v41, v103 := v46, 0x103, v41, 'y';
		if (fm1(false, v40[safeIndex(800, v40.Length)], globalState)) {
			...
			v106[safeIndex(129, v106.Length)] := v107;
			...
			v108[safeIndex(472, v108.Length)] := v112;
			var v113: set<int> := {v45, v54};
			var v114: seq<set<int>> := [v113, fm4(v0, v45, -|[v0, v0]|, v46, globalState)];
			v106[safeIndex(129, v106.Length)], v108[safeIndex(472, v108.Length)], v40[safeIndex(800, v40.Length)] := (multiset{v103})[v103 := abs(if (v0) then (DC21(v0, v109, v0, |v41|).(cf35 := v40[safeIndex(800, v40.Length)], cf34 := v0)).cf35 else |v114|)], v112, safeDivisionInt(v46, fm3(v0, globalState));
			...
			var v121: array<bool> := new bool[25] [false, !v43[safeIndex(v54, |v43|)], v116, v0, !v0, !v0, true, v117, v116, v0, (seq(abs(0x1c9), i11  => (|{!!v116}|))) == (seq(abs(426), i12  => (v42))), v117, v117, v116 !in v43, v117, v0, v117 || v0, v117, !(378 > v55), v55 in v113, (if (|[v119]| in v44) then v44[|[v119]|] else v46) != |v120[safeIndex(v40[safeIndex(800, v40.Length)], |v120|)]|, v117, v117, v0, v116];
			v121 := v121;
			...
			v0 := v123 != v123;
			v0 := v103 !in v41;
			v46 := v40[safeIndex(800, v40.Length)];
			v47 := fm0(v0, v40[safeIndex(800, v40.Length)], if (v0) then v0 else v0, globalState);
			...
			v124, v40[safeIndex(800, v40.Length)] := if (v127.cf92 in v126) then v126[v127.cf92] else v124 * v124, v40[safeIndex(800, v40.Length)];
		}
		...
		if (v0) {
			...
			var v130: map<seq<C12>, bool> := map[[v129] + ([v129])[safeIndex(v46, |[v129]|) := v129] := v0];
			...
			v40[safeIndex(800, v40.Length)], v45, v46, v0, v0 := -0x333, if (v0 <==> v0) then v40[safeIndex(800, v40.Length)] else v46, v45, v43[safeIndex(v45, |v43|)], fm1(69 == v55, |v41|, globalState);
			v41 := v41;
			...
			v137[safeIndex(248, v137.Length)] := v132;
			var v138 := DC49(v46, v54, v132);
			v40[safeIndex(800, v40.Length)], v137[safeIndex(248, v137.Length)], v0 := -|[v46]|, v138.cf92, v0;
		} else {
			var v139: seq<int> := [|[v0, v0, v0, v0]|, v46, v55 - 0x1a4, -v46, v55];
			v54 := v139[safeIndex(v42, |v139|)];
			var v140: array<int> := new int[11](i13 => i13 + v55);
			var v141: C15 := new C15(v140);
			v141 := v141;
			var v142, v143 := v141.m9(safeModuloInt(523, v42), globalState);
			var v144: T2 := new C4();
			...
			var v149: set<int> := {v40[safeIndex(800, v40.Length)]};
			v148[safeIndex(255, v148.Length)] := {0x29a, |"ka"|} >= v149;
			v148[safeIndex(255, v148.Length)] := v142;
		}
		...
		v153[safeIndex(824, v153.Length)] := v55 in v158;
		v153[safeIndex(824, v153.Length)] := v0;
		v41 := v41;
		var v159, v160 := v152.m1(globalState);
		var v161: C6 := new C6();
		var v162: multiset<C6> := multiset{v161, v161};
		v40[safeIndex(496, v40.Length)] := -(if (v161 in v162) then v162[v161] else v42);
		...
		v40[safeIndex(496, v40.Length)] := safeDivisionInt(-safeModuloInt(v54, if ((map v166 : int | v166 in [|v167|, |multiset(v168)|] :: (v166 - |multiset{v0}|) := (v54))[v54 := -v45] in v165) then v165[(map v166 : int | v166 in [|v167|, |multiset(v168)|] :: (v166 - |multiset{v0}|) := (v54))[v54 := -v45]] else v46), v54);
	}
	...
	for i14 := v45 to v45 {
		...
		v172 := v172[v0 := v41 + v41[safeIndex(0x28a, |v41|) := v171]];
	}
	var v173 := 'm';
	...
	if ((v41 != v41) || (DC7(v0, v176).(cf16 := v176)).cf15) {
		...
		v40[safeIndex(111, v40.Length)] := -|v179|;
		v40, v0, v40[safeIndex(111, v40.Length)] := v40, !v0 <== v0, v54;
		v40[safeIndex(111, v40.Length)] := v55;
		...
		var v185: T0 := new C18({!v0, v174.fm7(v0, v41[safeIndex(v174.fm35(globalState), |v41|) := 'q'], v184, globalState)});
		...
		v182[safeIndex(650, v182.Length)] := v189;
		var v190: seq<int> := [|"bihcvjgdb"|, v54];
		var v191 := DC92(v189);
		v0, v182[safeIndex(650, v182.Length)], v44, v45 := (v0 in map[v0 := |v190|]) ==> false, v189 + v191.cf155, multiset{v55, v54, v46 * v54}, v54;
		var v192: C4 := new C4();
		var v193 := DC83(v192);
		...
		var v197 := DC10();
		var v198: C9 := new C9(v196[safeIndex(v42, |v196|)], if (v0) then v197 else v197);
		var v199: map<int, bool> := map[fm3(true, globalState) := v0];
		var v202: seq<map<int, bool>> := [v199 + v199, v199, v199, map v200 : int | v200 in map[v42 := -v55] :: (safeModuloInt(v200, v54)) := (false), v199 + (map v201 : int | (0x1fa <= v201) && (v201 < 0xba) :: (safeModuloInt(v201, v55)) := (v0))];
	...
	if (v0) {
		...
		match (v212) {
			case DC66(cf120, cf121) =>
				...
				var v215: map<string, string> := map[v41[safeIndex(v54, |v41|) := v174.f14] := v41];
		...
		if (v211.f12) {
			...
			v0 := v227.cf96;
			v42 := safeDivisionInt(0x12c, |([v54, v211.fm32(v54, v211.f12, globalState), v42, v46, |v44|])[safeIndex(v223, |[v54, v211.fm32(v54, v211.f12, globalState), v42, v46, |v44|]|) := fm3(v211.f12, globalState)]|) * v223;
			...
			v231 := v231[safeDivisionInt(v46, -v45) := v174.f14];
			v41 := v41 + v41;
			var v232: set<int> := {v42};
			v54 := safeDivisionInt(v45, |v232|);
		...
		var v235: map<string, string> := map["ttmmiw" := seq(abs(0x1de), i15  => (v174.f14))];
		...
		if (!((v0 <== v211.f12) && v211.f12)) {
			...
			v239[safeIndex(370, v239.Length)] := 0x2e8 >= v45;
			var v240 := DC27(v238, -|v210|);
			var v241: array<char> := new char[3];
			var v242: seq<array<char>> := [v241, v241];
			v211.f12, v41, v238, v239[safeIndex(370, v239.Length)] := false, v41, v240.cf46, !(v241 !in v242);
			v0 := v211.f12;
			...
			v245[safeIndex(52, v245.Length)] := v41;
			v244, v54, v211.f12, v211.f12, v245[safeIndex(52, v245.Length)] := v244, fm3(fm1(v0, v54, globalState), globalState), v211.f12, v211.f12, v41 + v41;
			...
			v247[safeIndex(456, v247.Length)] := !v246.f3;
			var v248: map<int, int> := map[|v245[safeIndex(52, v245.Length)]| := v54];
			var v249 := DC20(v237.f18, v0, v248);
			var v250: set<D7> := {v249};
			var v251 := DC51(v211.f12, v45, v210[safeIndex(-0x37e, |v210|)], v56[safeIndex(-162, |v56|) := v211.f12], v46);
			v247[safeIndex(456, v247.Length)], v211.f12, v43 := v246.f3, !(v250 !! v250), if (multiset(v210) < v44[v42 := abs(v54)]) then v43 else v251.cf99 + v56;
			v211.f12 := v246.f3;
		}
		...
		if (v211.f12) {
			...
			v210 := v255.cf107;
			v45 := 0x12a;
			v40[safeIndex(941, v40.Length)] := 0x3ac;
			v40[safeIndex(941, v40.Length)] := v252;
			var v256: array<bool> := new bool[3](i16 => v56[safeIndex(v252, |v56|)]);
			...
			var v259: map<seq<int>, int> := map[[0x221, v42] := |(seq(abs(346), i17  => (v237.f18)))|];
		...
		decreases 100 - i18
	{
		...
		var v267: array<string> := new string[2](i20 => v41[safeIndex(if (v45 in v44) then v44[v45] else v54, |v41|) := v174.f14]);
		v266[safeIndex(255, v266.Length)] := v267;
		var v268 := DC32(v267);
		v266[safeIndex(255, v266.Length)] := if (v211.f12) then v268.cf56 else v267;
		v211.f12 := v211.f12;
	}
	...
	print v42, "\n";
	print v43 == [true], "\n";
	print v44 == multiset{385308, 150, 11250}, "\n";
	print v45, "\n";
	print v46, "\n";
	print v47 == [false, true, true, false, false], "\n";
	print i5, "\n";
	print v54, "\n";
	print v55, "\n";
	print v56 == [true], "\n";
	...
	print v175.cf7, "\n";
	print v176 == {DC3('m')}, "\n";
	print v205 == map[false := false], "\n";
	print v206 == {'m'}, "\n";
	print v207 == map[{'m'} := false], "\n";
	print v208 == map[150 := [false, false]], "\n";
	print v210 == [385308], "\n";
	print v211.f12, "\n";
	print v211.f13 == map[150 := [false, false], -1861600496 := [true]], "\n";
	print i18, "\n";
}