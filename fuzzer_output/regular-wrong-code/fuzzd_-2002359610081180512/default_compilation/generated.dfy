...
function fm0(globalState: GlobalState): int {
	|([true] + [false])| / (if (!!false) then |"rakhhgk"| else |"ry"|)
}
function fm1(p0: multiset<int>, p1: int, globalState: GlobalState): bool {
	'd' in "nkmmphev"
}
function fm6(p0: seq<bool>, globalState: GlobalState): string {
	(seq(110, i0  => ('s'))) + ("olpkpd" + (seq(0x307, i1  => ('m'))))
}
function fm7(p0: int, p1: bool, p2: D1, p3: bool, globalState: GlobalState): seq<D1> {
	(seq(0x3d5, i0  => (DC2(0x3d, true, -0x3d2, 0x34)))) + ([DC2(|{false}|, true, |map[false := |[false]|]|, |"ropqb"|), DC2(422, false, -0x2d8, -0x10c), DC2(0x9d, false, 0x10b, -0x3e6)] + [DC2(179, true, 207, |(seq(-541, i1  => (|"xv"|)))|)])
}
...
function fm13(p0: int, p1: bool, p2: bool, globalState: GlobalState): map<int, multiset<int>> {
	map[0x2f4 := multiset([|map[false := |(seq(0x121, i0  => ('c')))|]|])] + (map v0 : int | v0 in [0x357, -0x104, --|map[310 := |{|"dnvebqbov"|}|]|, |map[0x1fd := 0x353]|, 0x3c5] :: (v0 - |[|[!!false]|]|) := (multiset{|"n"|}))
}
function fm14(p0: int, p1: int, p2: int, globalState: GlobalState): set<int> {
	{|[false]| / -|multiset{false}|, |"ahpb"|, -|(seq(202, i0  => ('j')))|, --|(multiset([|multiset([!false, false])|]) * multiset{904})|}
}
function fm15(p0: bool, globalState: GlobalState): map<int, bool> {
	DC54(map[|['m', 'u', 'f']| := true]).cf93 + map[|(seq(0x330, i0  => (627)))| := false]
}
function fm16(p0: map<char, bool>, p1: bool, globalState: GlobalState): set<seq<int>> {
	{[814, ---0x1f9, -|map[0x2c0 := 455]|, -|multiset{"gf", "s", seq(-0x134, i0  => ('f'))}|, |map[!false := false]|]} * {[|{0x37d}|, 0x286]}
}
...
function fm22(globalState: GlobalState): map<multiset<int>, bool> {
	(map v0 : multiset<int> | v0 in map[multiset{|{0x22e, |(seq(0x1a1, i0  => ('r')))|}|} := |[false, false]|] :: (v0) := (!true)) + (map v1 : multiset<int> | v1 in map[multiset{|map[0x39 := true]|, |{|[false]|}|} := 656] :: (v1) := (true))
}
...
function fm26(globalState: GlobalState): seq<D1> {
	([DC2(|map[true := 'j']|, false, |{true, true, !false, false, true}|, 15), DC2(|map["xc" := |{true}|]|, !true, 0x2a7, 0xa3)] + [DC2(|{DC6(set v0 : int | v0 in {|map[false := 0x345]|} :: (v0 % 0x362)), DC6({|"xydlmxbg"|})}|, false, 0x2ab, |multiset{"mxrqqpsh"}|), DC2(|[31, 0x6a]|, true, 0x35c, -392), DC2(0x74, true, |"mn"|, -0x145)]) + [DC2(627, !false, 0x345, 0x1ad)]
}
...
function fm34(p0: int, p1: bool, p2: bool, globalState: GlobalState): seq<string> {
	["opsm"] + (["tmbalwqgj", "uetnpshyt"] + ["s", seq(-573, i0  => ('w')), "s"])
}
...
function fm39(globalState: GlobalState): set<multiset<bool>> {
	{multiset([DC32(|map[false := map[false := true]]|, false, |(set v0 : int | (37 <= v0) && (v0 < 25) :: (v0 / |multiset{207}|))|).cf54, false])} * {multiset([true])}
}
function fm40(globalState: GlobalState): multiset<string> {
	multiset{(seq(0xd5, i0  => ('l'))) + "rp"}
}
...
function fm45(globalState: GlobalState): seq<D1> {
	([DC3(true, "dwhk", -0x31e)] + [DC3(!false, "cc", --|"nsv"|)]) + [DC3(!true, DC36(seq(0, i0  => ('s')), 369, |[false]|, |multiset{true, false}|).cf62, 246), DC3(true, "e", 0x59)]
}
function fm46(p0: bool, p1: bool, p2: bool, globalState: GlobalState): map<int, string> {
	(map[|(map v0 : int | v0 in (seq(0x2bf, i0  => (945))) :: (v0 % |[0x28f, 0xeb]|) := (-|map[|"bwex"| := 493]|))| := seq(673, i1  => ('g'))] + (map v1 : int | (706 <= v1) && (v1 < 0x363) :: (v1 * |multiset([[0x3ad], [|multiset([!true])|, |(seq(0x1a4, i2  => ('r')))|], [284]])|) := ("pkrufmho"))) + map[|multiset{true, false, false}| := seq(0x1ec, i3  => ('i'))]
}
function fm47(globalState: GlobalState): map<D0, int> {
	(map[DC0([0x3a8]) := |"ti"|] + (map v0 : D0 | v0 in [DC0([|multiset{|[true, false]|}|])] :: (v0) := (0xb4))) + (map[DC0([0x15b, |{-0x212}|]) := |{multiset{true}}|] + map[DC0([|(seq(100, i0  => ('q')))|, |map[|multiset{|(set v1 : int | v1 in {|map[0x213 := true]|} :: (v1 * 0x321))|}| := !false]|]) := 0x294])
}
...
method m0(p0: bool, globalState: GlobalState) {
	...
	if (p0) {
		var v7 := "dlxanf";
		v1 := (if (-|multiset{p0, p0}| in v2) then v2[-|multiset{p0, p0}|] else v1) / |v7|;
		var v8: seq<int> := [v1];
		v1 := |multiset(v8)| * v1;
		...
		v10 := v10;
		var v11 := 'f';
		var v12: T0 := new C1(seq(0x284, i0  => (DC2(-|map[p0 := p0]|, p0, |{|v4|}|, v1))));
		...
		globalState.f2 := fm1(v4, v1 % v1, globalState);
		var v18: seq<D1> := [v14];
		var v19 := new C1(v18);
		var v20: seq<int> := [|multiset{p0, p0, p0, p0}|, v1, 0x1a3, |([p0])[v1 := true]|];
		...
		var v27: seq<bool> := [!p0, v26[v23.f10], true];
		var v28 := DC30();
		if (!v23.fm5(v25 - v25, map[v23.fm4(p0, p0, p0, p0, globalState) := v26], |(if (p0) then [v28] else [v28])|, globalState)) {
			...
			var v31: array<char> := new char[23] [v29, if (p0 in v30) then v30[p0] else v29, v29, v29, v29, if (!!!p0) then v29 else v29, v29, v29, v29, v29, v29, v29, v29, if (p0) then v29 else v29, v29, 's', 'd', v29, 'i', 'r', v29, v29, v22[v23.f10]];
			v31[554] := v29;
			v31[554] := v29;
			v20 := v20;
			var v32 := new C2(v23.f10, p0 ==> p0);
			var v33: array<bool> := new bool[3];
			v33[153] := v20[v23.f10] >= v23.f10;
			v33[153] := false;
			...
			var v36 := 'm';
			var v37: map<set<array<int>>, string> := map[{v34} + v35 := v22[v1 := v36]];
			v37 := v37[v35 * v35 := v22];
			var v38: C0 := new C0(v25, v23.f10 - v23.f10);
			var v39: seq<array<int>> := [DC22(v34).cf39];
			globalState.f2, v34, v20, v38, v38.f12 := p0, v39[v23.f10], v20, v38, -0x60;
			globalState.f2 := p0;
	...
	var i1 := 0;
	while (fm1(v4, |v40| % v1, globalState))
		decreases 100 - i1
	{
		if (i1 >= 100) {
			break;
	...
	if (p0 <== p0) {
		...
		var v50: array<multiset<bool>> := new multiset<bool>[10] [multiset(if (p0 in v48) then v48[p0] else [p0]), v49 - multiset{p0}, v49[p0 := v1], v49 * v49, v49, v49, v49 + v49, multiset(if (p0) then v47 else v47), v49, v49];
		v50[402] := v49;
		v50[402] := v49;
		...
		match (v56.(cf50 := v57 + v57)) {
			case DC28() =>
				...
				v58[90] := DC36(seq(579, i4  => ('l')), 0x147, v1, v1).cf62;
				var v59 := 'm';
				var v60: map<int, T0> := map[v1 := v54];
				var v61: map<int, char> := map[|v60| := v59];
				v1, v58[90], globalState.f2 := if (false) then |(map[v1 := v59] + v61)| else v1, seq(0x9e, i5  => ('s')), fm1(v4, if (if (v1 in v5) then v5[v1] else p0) then |v4| else v1, globalState);
				v1 := v1;
				v51 := v51;
		...
		decreases 100 - i6
	{
		...
		var v82: array<int> := new int[29] [|{v73, v73}|, 0x268, v1 * v1, |(v75[|v4| := v74] + v75)|, v1, --(v1 * v1), v1 + v1, |((seq(0x239, i7  => ('v'))) + v76)|, |fm6(v73, globalState)| / |v79|, v1, v1, v1, |v76|, v1 - v1, 0x3dd, 0x390, v1 - (if (v81[v1] in v80) then v80[v81[v1]] else 0x3c7), v1, 530, v1, 0x142, v1, |fm20(p0, !v74.f9, -0x21d, v76, globalState)| * v1, fm0(globalState), -v1, v1 * v1, v1, v1, |"k"|];
		var v83 := 'a';
		...
		v1 := (v1 / |v76|) % (if (v2 in v87) then v87[v2] else 0x21c);
		var v88: array<map<int, bool>> := new map<int, bool>[10];
		v88[640] := v5 + fm15(v74.f9, globalState);
		v88[640] := (map v89 : int | v89 in v5 :: (v89 + v1) := (p0)) + v5;
	}
}
trait T0 {
...
class C0 {
	...
	function fm8(p0: bool, p1: bool, p2: map<int, bool>, globalState: GlobalState): bool {
		match DC2(f12, !!true, f12, |(seq(67, i0  => ('r')))|) {
...
class C1 extends T0 {
	...
	function fm2(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): seq<int> {
		([|map[|multiset{multiset{|"eiomh"|}, multiset([628])}| := false]|] + [|(seq(0x289, i0  => ('q')))|]) + (seq(0x38, i1  => (|{false, !!!true, !false, !!DC4(|[976]|, false, false, false, false).cf12}|)))
	}
	method m6(p0: T0, p1: array<bool>, p2: bool, globalState: GlobalState) returns (r0: bool, r1: bool) {
		...
		if (-v0 >= (v0 * v0)) {
			...
			v5[713] := v0 - (if (0xb4 in v10) then v10[0xb4] else v1[v0]);
			var v11: set<seq<int>> := {v1};
			var v12 := new C0(v11 + {v1, v1}, fm0(globalState));
			var v13 := 'j';
			var v14 := DC3(false, "hgnqr", v5[713]);
			...
			v12, v5[713], globalState.f2, v15 := if (p2 in v17) then v17[p2] else v12, v12.f12, p2, map[v13 := !p2];
			r1 := p2;
		} else {
			p1[602] := p2;
			var v18: multiset<bool> := multiset{p2, !p2};
			globalState.f2, p1[602], v0, v0, v0 := p2, p2, |((v18 + multiset(v4)) * v18)|, |v3| * (v0 * v0), v0;
			globalState.f2, v0, v3 := p1[602], v0, v3;
			var v20: set<bool> := {p2};
			var v21: multiset<set<bool>> := multiset{v20, v20, v20, v20};
			v0 := |(map v19 : set<bool> | v19 in v21 :: (v19) := (p1[602]))| * (47 / v0);
			var v22: set<seq<int>> := {[v0]};
			var v23: C0 := new C0(v22, v0);
			var v24: map<C0, bool> := map[v23 := p1[602]];
		...
		match (v25) {
			case DC0(cf0) =>
				...
				v0 := -((|v27| * -v0) / v0);
				globalState.f2, v0, v0, globalState.f2 := false || true, if (!p2) then v0 else -|(fm2(v0, p2, p2, |v4|, globalState) + cf0)|, fm0(globalState) % -v0, !p2 && p2;
				r0 := p2;
				var v28 := DC10();
		...
		if (true) {
			...
			p1[7] := if (v32 in v33) then v33[v32] else p2;
			...
			v35, v37 := (v35 + (seq(404, i1  => (v32)))) + v35, v37;
			if (p1[7]) {
				var v38: set<seq<int>> := {v1, [v0], v1, v1};
				var v39 := new C0(v38 * v38, v0 + 0x49);
				var v40: map<bool, bool> := map[p1[7] := p2];
				v39.f12 := if (p2) then 0x90 % |[v39.f12]| else |("aajbnx")[|v40| := v32]| - v0;
				p1[7] := false;
				p1[7] := fm1(v3, |"fgnkdwmjc"|, globalState);
				...
				v42[417] := v43;
				v5[343] := |[p2, p2]|;
				v5[343] := if (fm1(v3, |v34|, globalState)) then |v1| else v0;
				var v44: array<int> := new int[10](i2 => i2 - DC1(|v35|).cf1);
				var v45: map<bool, array<int>> := map[p1[7] := v44];
				v45 := v45[fm1(v3, v5[343], globalState) := if (!p2 in v45) then v45[!p2] else v44];
				var v47: set<seq<int>> := {v1};
				var v48: C0 := new C0(v47, v5[343]);
				var v49: map<C0, bool> := map[v48 := p2];
				v36, p1[7], v5[343], v5[343] := if (true) then fm15(p2, globalState) else v36 + (map v46 : int | (-0x2d4 <= v46) && (v46 < 0x176) :: (v46 / v0) := (p1[7])), v4[|(v49 + map[v48 := p1[7]])|], v48.f12 * (v48.f12 + v5[343]), v5[343];
				var v50: map<bool, int> := map[p1[7] := 0x209];
				r1 := if (v50 != v50) then true else p1[7];
			}
			...
			if (!(!p2 <==> p2)) {
				...
				v0, globalState.f2, v5 := |(v61 + map[v62[|v63|] := v59.f12])|, if (p2) then p2 else |v66| != |[v68, v68]|, v5;
				var v69: map<seq<bool>, bool> := map[v4[if (v0 in v3) then v3[v0] else v59.f12 := p2] := !p2];
				v69 := v69[[p2] + v4 := p2 && p2];
				...
				v74, v75, v59.f12, v76[404], v78 := v74, fm17(v59.f12, v79, p2, if (p2 in v55) then v55[p2] else |v80|, globalState), -(|v2[v59.f12]| - (if (p2) then v59.f12 else |"d"|)), v73 * v73, v78;
				v1 := [v59.f12];
...
class C2 extends T1 {
	...
	method m1(p0: int, p1: bool, p2: bool, p3: array<seq<bool>>, globalState: GlobalState) {
		...
		var v5: seq<C0> := [v4, v4];
		var v6 := 'o';
		var v7: multiset<int> := multiset{|(v1[-|(v5[p0 := v4])[v4.f12 := v4]| := v6])[|map[f14 := p1]| := v6]|};
		...
		if (p1) {
			...
			v9, v10[992] := v9, v11 != v11;
			var v12: map<int, bool> := map[f14 := if (fm1(v7, 0x26c, globalState)) then f9 else v10[992]];
			v12 := v12;
			var v13: set<int> := {v0};
			...
			if (true) {
				...
				var v15: array<int> := new int[2] [|v14|, v4.f12 % 0x2a7];
				v15[181] := |[-v4.f12, v4.f12, |v2|, v4.f12, v4.f12]|;
				v15[181] := v4.f12;
				var v16 := DC2(f14, p2, v4.f12, v4.f12);
				v16 := DC2(0x2ce, v10[992], v4.f12, v4.f12 * -v0);
				var v17: array<C0> := new C0[23];
				v17[246] := v4;
				var v18: multiset<bool> := multiset{p1, v1 == v1};
				var v19: map<multiset<int>, bool> := map[v7 := v10[992]];
				var v20 := DC18(v19);
				var v21: seq<bool> := [v10[992], p1, p1, f9, false];
				v10[992], v15[181], v17[246], v18, v20 := v10[992], v4.f12, v4, (v18 * v18) + (multiset(v21) - multiset{f9}), v20;
				v21 := v21;
			} else {
				...
				var v26: array<int> := new int[21] [|v2[v4.f12 := |v2|]|, v0, -0x4e, v4.f12, v0, p0, p0, v4.f12, fm0(globalState), v4.f12, v0, v4.f12, f14, |v25|, v4.f12, f14, p0, p0, v0, v4.f12, 976];
			...
			v1, v2, globalState.f2, v1 := v1, (v2 + fm2(v4.f12, p1, f9, |v31|, globalState))[|(("e")[533 := v6])[-0x34 := v6]| - v4.f12 := f14], !p1, v32.cf7 + v1;
			var v33 := DC12(f9, p1, f14, |v2|, f9);
			var v34 := DC2(f14 % v4.f12, v28[fm0(globalState)], if (p1) then -v4.f12 else v0, f14 - v33.cf23);
		...
		match (DC16(v42)) {
			case DC16(cf30) =>
				...
				v4.f12 := v43.cf23 + (v4.f12 % |v1|);
				var v44: seq<set<seq<int>>> := [v4.f11, v4.f11];
				var v46 := new C0(set v45 : seq<int> | v45 in v44[|v1|] :: (v45), v4.f12);
		...
		var v50: seq<bool> := [f9];
		var v51: multiset<bool> := multiset{v39[459]};
		var v52: array<int> := new int[17] [v0 + |v50|, p0, |v1|, |v51| % |v2|, p0, f14 % p0, v0, v0, v0 + f14, v4.f12, f14, v0, fm0(globalState), v0, v4.f12 % v4.f12, v0, if (v39[459]) then f14 else -fm0(globalState)];
		var v53: C1 := new C1(fm26(globalState));
		var v54: map<string, map<C1, int>> := map[seq(0x19e, i1  => (v6)) := map[v53 := v4.f12]];
		var v55: map<C1, int> := map[v53 := p0];
		v52[751] := |(if ("nukgadch" in v54) then v54["nukgadch"] else v55)|;
		var v56: seq<set<int>> := [{v0}, v49, v49];
		v49, v52[751] := v49 - v56[v0], p0;
	}
	method m8(p0: bool, p1: multiset<array<int>>, globalState: GlobalState) {
		...
		var v5: array<bool> := new bool[3] [v0 < v0, f14 >= f14, (multiset(v1[f14 := f9]))[f9 := |v2|] !! v4];
		v5[557] := f9;
		var v6: array<int> := new int[7];
		v6[781] := -0x59;
		var v7: array<multiset<int>> := new multiset<int>[12];
		var v8: seq<array<multiset<int>>> := [v7];
		var v9: array<array<multiset<int>>> := new array<multiset<int>>[16] [v7, v7, v7, v7, v7, v7, v7, v7, v8[f14], v7, v7, v7, v7, v7, v7, v7];
		v9[218] := v7;
		var v10: seq<int> := [f14];
		globalState.f2, v5[557], v6[781], v9[218] := if (f9) then f9 else p0, fm1(v0, -f14, globalState), f14 / -(|v10| - f14), v7;
		v6[781] := v6[781];
		...
		v9[218][912] := if (multiset{v12, v12, v12} in v13) then v13[multiset{v12, v12, v12}] else multiset{f14, v6[781]};
		v9[218][912] := multiset(v10 + [f14]) - v0;
		var i0 := 0;
		while (v5[557])
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v14 := "a";
			var v15 := DC4(|v14|, !p0, p0, v5[557], v5[557]);
			if (fm1(v9[218][912] + v0, v15.cf9 / f14, globalState)) {
				var v16: map<multiset<int>, bool> := map[v0 := f9];
				v6[781] := v6[781] + -(|v14| - |v16|);
				var v17 := DC9(f9, v1);
				var v18: multiset<array<bool>> := multiset{v5};
				var v19 := DC7(v18);
				var v20: map<string, bool> := map[v14 + v14 := p0];
				var v21 := DC23(v20);
				v6[781], v17, v19, v20 := v6[781] * v6[781], v17, v19.(cf16 := v18), v21.cf40;
				var v22 := 'e';
				var v23: seq<string> := [v14[f14 := v22]];
				var v24: map<multiset<int>, int> := map[v0[v6[781] := |v23|] := -v6[781]];
				var v25: map<map<multiset<int>, int>, bool> := map[v24 := f9];
				v25 := v25[map[v9[218][912] := v6[781]] := f9];
				var v26: array<set<map<int, char>>> := new set<map<int, char>>[13];
				var v27: map<int, char> := map[v6[781] := v22];
				var v28: set<map<int, char>> := {v27, v27, v27};
				v26[435] := v28;
				var v29: array<string> := new string[15](i1 => v14);
				v29[840] := v14;
				globalState.f2, v26[435], v29[840], v22, v5[557] := v5[557], v28 * (v28 * v28), v14, if (f9) then 'r' else v22, !(if (v5[557]) then p0 else v5[557]);
				globalState.f2 := v5[557];
			} else {
				v14 := (seq(0x151, i2  => ('k'))) + v14;
				var v30 := 'w';
				globalState.f2 := !((v14[|v14| := v30] + (seq(766, i3  => (v30))))[f14 := v30] == (v14 + v14));
				var v31 := DC22(v6);
				var v32: map<bool, int> := map[v5[557] := f14];
				v6[781], v31 := if (p0 in v32) then v32[p0] else 0x2e2, v31;
				var v33: T0 := new C1(seq(0x144, i4  => (DC2(|{p0}|, p0, v6[781], f14))));
				var v34: multiset<T0> := multiset{v33};
				v6[781] := if (v34 >= v34) then f14 else f14;
				var v35: set<array<int>> := {v6};
				var v36: map<set<array<int>>, int> := map[v35 * v35 := f14];
				v6[781] := if (v35 in v36) then v36[v35] else v6[781];
			}
		...
		v39 := v39;
		var v40 := DC14(v5[557], false, v6[781]);
		var v41: multiset<char> := multiset{v38, v38};
		var v42 := DC3(f9, fm28(|v41|, true, globalState), v6[781]);
		var v43: multiset<D1> := multiset{v42};
		v40, v43, v5[557] := DC14(if (f9) then v5[557] else !p0, v5[557], v6[781]), (multiset{v42})[v42 := f14], p0;
	}
}
...
class C3 extends T2 {
	...
	function fm3(globalState: GlobalState): bool {
		|(map[f15 := |"kthtybr"|] + map[f15 := |(set v0 : set<bool> | v0 in multiset{{true, f9}, {false}} :: (v0))|])| >= (-|(seq(-0x2ea, i0  => ('m')))| % |map[DC28() := f9]|)
	}
	function fm2(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): seq<int> {
		[-|{true}|] + ((seq(0x11e, i0  => (-817))) + [611])
	}
	...
	method m2(p0: array<array<int>>, p1: string, p2: char, p3: seq<int>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: set<int>) {
		...
		v4[394] := !!(p1 !in v5);
		v4[394] := "jrugtgog" < (seq(0x372, i0  => (p2)));
		v4[394] := f15;
			...
			decreases 100 - i1
		{
			...
			v7[527] := v0;
			v7[527] := v0;
			var v8 := DC25(v0, v7[527], v1, map[v7[527] := p2], -0x309);
			var v9: map<int, D9> := map[v7[527] := v8];
			v9 := v9;
			var v10 := DC24(false, v7[527], "prdj");
			var v11: set<string> := {p1, p1, v10.cf43};
			var v12: seq<int> := [|v11|, |[p2, p2]|];
			var v13: map<bool, int> := map[f15 := v0];
			var v14: seq<seq<int>> := [[|v13|], p3, p3, p3, seq(0x307, i3  => (v0))];
			v12 := v14[v0] + p3;
			var v15: seq<string> := [p1];
			var v16: map<bool, seq<string>> := map[f15 <== f15 := v15];
			var v17: seq<bool> := [f15];
			var v18: map<int, int> := map[v0 := 0x35b];
			v16 := v16[v17[|v18|] := (fm34(-v0, v4[394], f15, globalState))[v0 := (("sooucaqvp")[v0 := p2])[v0 := p2]]];
		}
		if (v4[394]) {
			...
			if (f9) {
				...
				var v24: map<bool, bool> := map[fm1(multiset(seq(-0x278, i4  => (v0))), 0x134, globalState) := v4[394]];
				r2 := |v24|;
				var v25: array<string> := new string[22] [p1, "qvqafp", p1[v0 := v20], "n", p1, p1, p1, p1, p1, p1, p1, seq(51, i5  => (p2)), fm33(globalState), p1, fm33(globalState), "osyhtuwn" + p1, (p1 + p1)[v0 := p2], "iqiqgyo", "amy", p1 + fm33(globalState), p1, p1 + p1];
				v25 := v25;
			...
			var v30: array<int> := new int[9] [if (v0 in v28) then v28[v0] else v0, ---(if (f15) then |[|v29|]| else v0), v0, v0, v0, |(seq(899, i6  => (DC3(f9, p1, 0x3cd).cf7)))|, v0, v0, fm0(globalState)];
			v30 := new int[1] [v0 / |map[v0 := f15]|];
			r0 := !(v4[394] ==> !f9);
			globalState.f2 := (if (f9) then p1[v0] else p2) !in (p1 + fm33(globalState));
		} else {
			if (!false) {
				r1 := (v0 * v0) <= v0;
				...
				var v36: C2 := new C2(v0, v4[394]);
				var v37: seq<C2> := [v36, v36, v36];
				var v38: map<array<int>, int> := map[v35 := |v37|];
				var v39 := DC29(v38);
				v31, v38, v0 := (map[v4 := v0] + v31) + (if (v4[394]) then map[v4 := v36.f14] else v31), v39.cf51, if (v36.f14 >= v36.f14) then v36.f14 else v36.f14;
				var v40: map<int, int> := map[-v0 := v0];
				var v41: seq<map<int, int>> := [v40, v40, v40];
				var v42: map<int, bool> := map[-|v41| := f15];
				globalState.f2 := if (v4[394] <==> f9) then if (0x16 in v42) then v42[0x16] else f9 else !f15;
				var v43: array<string> := new string[13] [p1, p1, p1, p1, p1, p1, (p1[v36.f14 := p2] + p1)[v0 := p2], p1, p1, p1, "ofiikthw", p1, p1[v0 := p2]];
				v43 := v43;
				v1 := v1;
			} else {
				v4[394] := v1 >= v1;
				v4[394] := f15;
				var v44: map<bool, array<bool>> := map[v4[394] := v4];
				r2 := |(v44 + v44)| / (v0 * -v0);
				var v45: seq<string> := [p1 + p1, p1, p1, p1, p1];
				r2 := |v45[if (|p3| in v1) then v1[|p3|] else 0x113]|;
				var v46 := DC2(v0, f9, |p1|, v0);
				var v47: seq<D1> := [v46, v46, v46, v46];
				var v48 := DC31(v47);
				var v49 := new C1(v48.cf52[v0 := v46]);
			}
			
			var v50 := 'n';
			v0, r0, r1, v50 := v0, f9, f9, p1[v0];
			r2 := v0 * v0;
			m0(v4[394], globalState);
			r0 := if (if (f15) then f15 else f9) then f15 else f15;
		}
		
		var v51: seq<bool> := [f9, v4[394]];
		var v52: set<bool> := {v4[394], v51[v0], f15, if (v4[394]) then true else f15, v4[394]};
		v52 := v52 + v52;
		r0 := v4[394];
		r1 := v4[394];
		r2 := v0 / 186;
	...
	method m3(p0: bool, globalState: GlobalState) returns (r0: bool) {
		...
		if (fm32([v1], true, v0.f14, |v2| <= v0.f14, globalState)) {
			...
			var v12: map<map<bool, int>, int> := map[v10 := DC25(v3, v0.f14, v11[|v11| := v3], v5, v0.f14).cf45];
			v3 := |(fm36(f15, f15, p0, globalState) + v12)| - (-v3 / v3);
		} else {
			...
			if (if (v14 in v16) then v16[v14] else f9 !in v18) {
				...
				v28.f12, v26, v33[861], globalState.f2, v26 := |v34| - v13.f14, fm35(globalState), v0.f14 / 0x3a0, !(|("oyablh" + v35.cf7)| >= (v0.f14 + v36.cf28)), v26;
				globalState.f2 := !f9;
			}
		...
		for i1 := v0.f14 to fm0(globalState) / v0.f14 {
			...
			var v42: seq<int> := [-(530 * i1), |v37| / v0.f14, |v41|];
			v40 := |v42|;
			var v43: map<int, bool> := map[0x17a % i1 := !f9];
	...
	method m1(p0: int, p1: bool, p2: bool, p3: array<seq<bool>>, globalState: GlobalState) {
		...
		var v3 := DC37(v2);
		var v4: set<int> := {v0};
		v0 := |(v2 + (v3.(cf66 := [v2[v0], v1[f9 := |v4|], v1])).cf66)|;
		var v5 := "thqlb";
		...
		v15[897] := p0;
		var v16: multiset<string> := multiset{"afneutgkf", "eaxwwu", seq(-0xd1, i0  => ('p'))};
		var v17: array<map<bool, bool>> := new map<bool, bool>[4](i1 => map[p2 := true]);
		var v18 := DC19(v17, p1, v5);
		v15[897], v16, globalState.f2, v0 := v11[v0] / p0, multiset{v5, v18.cf35, seq(0x28b, i2  => ('e')), v5} + fm40(globalState), f15, v0 - v11[p0];
		var v19: array<char> := new char[26](i3 => 'd');
		var v20 := 'm';
		v19[966] := v20;
		v19[966] := v20;
		v15 := new int[6](i4 => i4 % |map[v15[897] := v15[897]]|);
		var v21 := DC27(map[p1 := |fm2(-|v5|, f9, f9, v0, globalState)|]);
		var v22 := DC38(v19[966], f15, fm41(v21, v0, v11, globalState));
		var v23: set<D14> := {v22, v22, v22, v22, v22.(cf69 := v10, cf68 := p1)};
		v23 := v23 * (v23 - v23);
		var v24: seq<multiset<int>> := [v6, multiset(v11), v6];
		var v25 := DC17(v24[v15[897]]);
		if (match v25 {
			case DC17(cf31) => false
		}) {
			globalState.f2 := v15[897] >= v0;
			if ((seq(-0x3d2, i5  => (v22.cf67))) <= v5) {
				...
				globalState.f2 := !(p2 || ((if (p1 in v30) then v30[p1] else v19[966]) in fm33(globalState)));
				v0 := v15[897];
				var v31: map<string, int> := map[v5 := |(seq(511, i6  => (p0)))|];
				v15[897] := -(if ((v5 + fm33(globalState)) in v31) then v31[v5 + fm33(globalState)] else |fm42(p2, p1, |v10|, globalState)|);
				v15 := new int[27];
			} else {
				var v32: map<bool, bool> := map[!p1 := p1];
				v15[897] := |v32|;
				v15[897] := p0;
				var v33: set<bool> := {v0 > v15[897]};
				v15[897], v33, v15, globalState.f2, globalState.f2 := |[p1, p1]| % v0, v33, v15, f9, p0 <= v0;
				var v34: array<D3> := new D3[29];
				var v35 := DC8();
				v34[147] := v35;
				globalState.f2, v32, v15[897], v34[147] := (v15[897] % p0) >= p0, v32, if (p1) then p0 else v15[897], if (p1) then v35 else v35;
				v15[897] := -fm0(globalState);
			}
			...
			var v39: map<map<C1, int>, array<string>> := map[map[v8 := 0x24e] := v38[v15[897]]];
			var v40: map<C1, int> := map[v8 := p0];
			v39 := v39[v40 := v37];
			v15[897] := v0;
		} else {
			v15[897] := p0;
			var v41: map<int, int> := map[v15[897] := v15[897]];
...
class C4 extends T1 {
	...
	function fm2(p0: int, p1: bool, p2: bool, p3: int, globalState: GlobalState): seq<int> {
		([|{222}|, |multiset{!f9}|] + [|multiset{'y', 'v'}|]) + ((seq(0x19d, i0  => (0x2d5))) + [0x17d])
	}
	method m1(p0: int, p1: bool, p2: bool, p3: array<seq<bool>>, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			var v4: seq<int> := [|v3|];
			var v5: seq<int> := [p0 + p0, p0, p0 - |map[p0 := v2]|, v4[p0], |map[p2 := f9]|];
			v4 := v4 + v5;
			var v6 := 0x1ba;
			v6 := |v4| * p0;
			var v7: array<string> := new string[16](i3 => "kwxxvgrr");
			var v8 := DC3(p2, seq(0x184, i4  => ('e')), v6);
			v7[653] := v8.cf7;
			v7[653] := seq(997, i5  => ('d'));
		}
		globalState.f2 := !!true;
		...
		var v18: array<bool> := new bool[21] [p2, f9, p1, if (p2) then p2 else p2, p2, p1, !f9, p0 != 0x364, p0 !in v0[p0 := -|v14|], v15 in map[v15 := multiset(if (v15 in v17) then v17[v15] else v16)], p1 || p1, false, p0 >= p0, true <==> !p1, fm1(v0, p0, globalState), f9, f9, f9, p2, v16[p0], p1];
			...
			case DC2(cf2, cf3, cf4, cf5) =>
				...
				match (v21) {
					case DC2(cf2, cf3, cf4, cf5) =>
						...
						v27[146] := v28;
						var v29: seq<seq<int>> := [seq(0x1f3, i9  => (|map[v24 := p0]|))];
						var v31 := DC12(v24, v25, p0, v22[731], f9);
						var v32 := DC18(map v30 : multiset<int> | v30 in [v0, v0, multiset{-v31.cf22, cf4}] :: (v30) := (true));
						v21, v26, cf3, v27[146] := DC5(v20).(cf14 := v20), v26, if (!f9) then v29 != v29 else !v24, v32.cf32;
						cf5 := cf2 * |v0|;
					case DC3(cf6, cf7, cf8) =>
						m0(p1, globalState);
						v15 := v15;
						var v33: set<seq<int>> := {v9, seq(0x371, i10  => (0x231))};
						...
						var v37: multiset<string> := multiset{seq(720, i11  => (v15)), "unmdd"};
						var v38: seq<multiset<string>> := [v37];
						var v39: seq<string> := [cf7, cf7];
						var v40: array<multiset<string>> := new multiset<string>[21] [v37 + v37, v37 + v38[cf2], v37, v37, multiset(seq(954, i12  => (cf7))) + v37, multiset(v39) - v37, fm19(p0, globalState), v37, multiset(v39) * v37, v37, v37, v37, v37, fm19(cf4, globalState), v37, v37, v37[cf7 := v34.f12], v37, v37, v37, v37];
						v40[442] := v37;
						var v41: map<int, C0> := map[v34.f12 := v34];
						var v42: array<map<bool, bool>> := new map<bool, bool>[27](i13 => map[p1 := cf3]);
						var v43 := DC19(v42, p1, cf7);
						cf4, v36, v40[442], v41, cf4 := -0x273, (v36 + v36)[cf5 := v35], v37, v41, |(v43.cf35 + cf7)|;
					...
					case DC4(cf9, cf10, cf11, cf12, cf13) =>
						...
						v46 := v46[v0 * multiset{cf5} := !v16[cf9]];
						v18[191] := cf3 <==> cf3;
						v18[191] := cf12;
						v18[191] := v18[191];
						globalState.f2 := p2;
					case DC1(cf1) =>
						...
						var v48 := new C0(v47 * {seq(0x216, i14  => (-cf5))}, 0xc5);
						v48 := v48;
				...
				globalState.f2, cf4 := !true, -((-cf4 % |map[|v9| := p0]|) * cf5);
				cf3 := p1;
				cf4 := p0 + cf2;
			case DC3(cf6, cf7, cf8) =>
				var v55: array<string> := new string[6];
				v55[87] := cf7;
				var v56: array<int> := new int[29](i16 => i16 / p0);
				var v57: multiset<bool> := multiset{p2};
				var v58: map<bool, seq<int>> := map[f9 := [p0, |v57|]];
				v56[520] := |v14| % |v58|;
				v55[87], v56[520], v16, cf8 := (seq(0x1eb, i17  => (v15))) + cf7, p0, fm20(!false, p1, fm0(globalState), seq(0x33, i18  => (v15)), globalState), 0x32c;
				...
				if (v16 !in v59) {
					...
					v18[561] := p2;
					cf8 := v56[520];
					var v60 := DC4(p0, false, p1, !cf6, v18[561]);
					v60 := v60;
					cf6 := (if (v18[561] in v14) then v14[v18[561]] else v56[520]) != (v56[520] / cf8);
				} else {
					v56[520] := (p0 % cf8) * v56[520];
					m0(cf6, globalState);
					var v61: set<seq<int>> := {v9};
					var v62 := new C0(if (cf6) then v61 else {fm2(cf8, f9, cf6, cf8, globalState), v9, v9}, if (p1 in v14) then v14[p1] else |v55[87]|);
				...
				cf8 := v56[520];
				v56[520] := |(v57 + (v57 - fm21(|v9|, cf6, globalState)))|;
			case DC4(cf9, cf10, cf11, cf12, cf13) =>
				...
				if (|v66| != |(v9 + v9)|) {
					...
					v72[698], v18, cf13 := if (fm1(v0, cf9, globalState)) then v73 else v74[0x20a], v18, f9;
				...
				cf9 := |([v82] + v83)|;
				var v84: array<D0> := new D0[27](i20 => DC0(DC0(seq(-0x9a, i21  => (cf9))).cf0));
				v84 := v84;
			case DC1(cf1) =>
				...
				v85[431] := cf1;
				v85[431] := cf1;
				globalState.f2, globalState.f2 := f9, !!fm1(v0, -0x18d / v85[431], globalState);
				globalState.f2 := p2;
			case DC5(cf14) =>
				...
				v87[175], globalState.f2, globalState.f2, v88, v88 := -|fm23(!((set v89 : int | (319 <= v89) && (v89 < 877) :: (v89 % v87[175])) <= v90), v88 != "tnvrovbj", p0, globalState)|, fm1(multiset{v87[175], 0x34c}, p0 / p0, globalState), f9 && f9, v88, v88;
	...
	method m7(p0: int, p1: int, p2: bool, globalState: GlobalState) returns (r0: int, r1: D4, r2: multiset<bool>, r3: bool) {
		if (!f9 <== f9) {
			...
			var v7: array<int> := new int[28] [0x105 * p0, 0x127 / p1, p1, p1, p0, -((if (p0 in v0) then v0[p0] else p0) / fm0(globalState)), p1, p0, |v1[p0 := p2]| % -p0, p0 % p0, p0, p0, p1, p0, 0x382, p1, p1, |v2| % |v3|, p0, -p1, p1, |(v4 + fm23(f9, p2, p0, globalState))|, 0x383, p1 - 944, if (f9) then 0xe5 else p0, p0, p1, p1 - |v6|];
			v7[262] := p1;
			...
			var v12: seq<int> := [p1];
			var v13 := "kcofbj";
			v7[262], v1, v9, r0, v10 := |v11|, (fm20(p1 != |v1|, fm1(fm29(p2, f9, globalState), v12[0x85], globalState), p0 + |v1|, v13, globalState))[-p1 := p2], DC18(v8), p0, v10;
			var v14: seq<multiset<char>> := [multiset{'c'}];
			var v15 := DC2(|v13|, f9, 0x1f7, p0);
			var v16: seq<D1> := [v15.(cf3 := f9), v15];
			var v17 := 'e';
			var v18 := new C1(if (fm1(multiset{0x27d, |v14[p0]|, -v7[262]}, p0, globalState)) then v16 else [v15.(cf3 := fm1(v0, |(seq(-0x12e, i1  => ('b')))|, globalState), cf4 := |(seq(0x3b5, i2  => ('c')))[|([p0, v7[262], p0, p1, v7[262]])[p0 := p1]| := v17]|, cf5 := v7[262]), v15, v15, v15, v15]);
			var v19: seq<map<bool, bool>> := [fm30(globalState)];
			v2 := v19[v7[262]];
			var v20: map<int, char> := map[-v7[262] := v17];
			var v21: seq<map<bool, int>> := [v4, v4, v4];
			var v22: set<bool> := {p2, f9, p2};
			var v23 := DC0(v12);
			var v24: array<bool> := new bool[19] [v3 !! multiset{f9}, p2, !f9, p2, p1 == |v20|, f9, f9, f9, p2, fm1((multiset{p1})[p0 := |v21[v7[262]]|], |v22|, globalState), f9, p2, p2, f9, 0x22f == -p1, false, p2 <==> !p2, false, p0 in (v23.(cf0 := [v7[262], v7[262]])).cf0];
			v24[745] := f9;
			v24[91] := !(v17 !in (seq(-0x238, i3  => (v17))));
			var v25: map<bool, char> := map[false := v17];
			r0, globalState.f2, v24[745], v24[91], v13 := p1, p2 !in v3, p0 == (v7[262] * |v25|), false <== p2, (v13 + fm28(p1, !f9, globalState))[p1 := v17] + v13;
			var v26 := DC27(v4);
			v4 := (v26.cf50 + v4) + v4;
		} else {
			r0 := p1 * p1;
			...
			var v35: array<bool> := new bool[19] [v27[p1], f9, p2, p2, v28 <= v28, v33 > v33, true, fm1(v34, -p0, globalState), f9, f9, f9, p2, f9 ==> true, !false, !false, !(v28 < v28), f9, p2, p2];
			v35[877] := f9;
			v35[877] := f9;
			var v36: set<int> := {|v30|, p1};
			var v37: map<set<int>, bool> := map[v36 := p2];
			v35[877] := !(if (v36 in v37) then v37[v36] else true <== !!v35[877]);
			var v38 := 'y';
			var v39 := DC3(f9, ("vwjn")[p0 := v38], p0);
			var v40: set<char> := {v38, 'j', v38, v38};
			var v41: seq<int> := [p1];
			var v42: map<bool, string> := map[p2 := v30];
			var v43: array<string> := new string[18] [v30 + v30, (v39.(cf6 := true, cf7 := v30).(cf6 := p2, cf8 := |[p1, p1, p1, |v40|, p1]|)).cf7[|v41| := v38] + "ltwca", v30, v30, v30, if (v35[877]) then v30 else v30[p1 := v38], v30, v30 + v30, fm28(p1, v35[877], globalState), v30, "hrwvirwn", v30 + v30, "silymvy", v30, if (!v35[877] in v42) then v42[!v35[877]] else "jmvllgg", v30, (seq(-884, i4  => (v38))) + v30, v30];
			v43[370] := v30;
			...
			if (v27[p0]) {
				...
				r0, v35[877], v47 := --p1, p2, v47;
				r2 := fm21(|v27[p0 := f9]|, fm1(v34, p1, globalState), globalState);
				...
				v49[555] := -0x282 % -p0;
				v30 := v30;
				var v50 := new C2(|(v30 + v30)|, v35[877]);
				v43[370] := v30;
				var v51: multiset<bool> := multiset{p2};
				var v52 := DC4(0x181, v35[877], p2, v35[877], p2);
				r2 := v51[v52.cf12 := |v27|];
			}
			...
			case DC8() =>
				...
				match (DC3(p2, v53, p1)) {
					case DC2(cf2, cf3, cf4, cf5) =>
						...
						v60 := v60;
						var v61: array<bool> := new bool[24](i5 => !(|v53[-p0 := v58]| < p1));
						v61 := v61;
					...
					case DC3(cf6, cf7, cf8) =>
						...
						v67[497] := fm1(multiset{p1, p0}, |v72|, globalState);
						v67[497] := cf6;
						...
						v77[469] := if (v71.f12 in v78) then v78[v71.f12] else v67;
					case DC4(cf9, cf10, cf11, cf12, cf13) =>
						var v79 := 'd';
						v79 := v79;
					...
					case DC1(cf1) =>
						cf1 := p1 % p0;
						var v81 := 'x';
						v53 := (v53 + v53) + (("jor")[|v53| := v81])[cf1 := fm31(globalState)];
						r3 := true;
						r3 := p2;
					case DC5(cf14) =>
				...
				v87 := v87[v54 := !f9];
			case DC9(cf17, cf18) =>
				var v88: array<int> := new int[11](i8 => i8 / p1);
				v88[663] := |cf18|;
				v88[663] := p1;
				var v89 := 'v';
				var v90: map<char, char> := map[v89 := v89];
				var v91: seq<char> := [v89, v89];
				v90 := (v90 + v90) + (v90 + map['u' := v91[v88[663]]]);
				var v92 := DC28();
				var v93: map<bool, int> := map[p2 := p1];
				var v94: map<D10, map<bool, int>> := map[v92 := v93];
				var v95: multiset<int> := multiset{|v94|};
				r0, cf17, r0 := -(v88[663] * -p0), fm1(v95, v88[663], globalState), p1;
				var v96 := DC2(p0, false, p0, |"chnn"|);
				var v97: seq<D1> := [v96];
				var v98: C1 := new C1(v97 + v97);
				var v99: C2 := new C2(v88[663], !p2);
				var v100 := DC13(v99.f14);
				var v101: set<bool> := {cf17, p2};
				var v102: array<D4> := new D4[25] [v100, v100, v100, v100, v100, v100, v100, v100.(cf25 := |v95|), v100, v100, v100.(cf25 := v88[663]), v100, v100, v100, v100, v100.(cf25 := p1), v100, v100, v100, v100, DC13(-|v101|), v100, DC13(p0), v100, v100];
				var v103: array<array<D4>> := new array<D4>[13] [v102, v102, v102, v102, v102, v102, v102, v102, v102, v102, v102, v102, v102];
				v98, v88[663], v99, v103 := v98, 0x1a0, v99, v103;
			case DC10() =>
				r3 := f9;
				var v104 := 'k';
				...
				var v109: array<bool> := new bool[29] [f9, p2, f9, p2, v106[|v107|], p2, f9, false, p2, f9, true, f9, f9, f9, !p2, fm1(v108, p1, globalState), f9, p2, f9, true, f9, fm1(v108, -p1, globalState), f9, f9, f9, f9, f9, !p2, !f9];
				...
				v110 := (v111[|v113|] + v110)[fm1(multiset{p1, p0}, |{f9}|, globalState) := v109];
				r0 := v112.f14;
				r0 := -(p1 + fm0(globalState));
			case DC7(cf16) =>
				var v114 := DC13(-p0);
				var v115 := 'y';
				var v116: C1 := new C1(seq(0x29e, i9  => (DC2(|map[f9 := p0]|, p2, p0, p0))));
				...
				v120[348] := v121 + (map v122 : int | v122 in v123 :: (v122 % p0) := (false));
				...
				match (v126) {
					case DC12(cf20, cf21, cf22, cf23, cf24) =>
						var v127: array<int> := new int[6](i10 => i10 / cf23);
						r0 := |map[v127 := v127]|;
						v127 := v127;
						...
						var v138: array<bool> := new bool[24] [62 != -cf22, !fm1(v123, 0xba, globalState), v115 in fm28(v129[|v123|], p2, globalState), |v136| > -0x209, !!cf20, true, v135.f9, f9, v137 >= v137, v135.f9, true, !cf20 <== p2, f9, cf24, f9, p2, fm2(cf23, v135.f9, !(if (p0 in v121) then v121[p0] else v135.f9), fm0(globalState), globalState) <= v129, false, cf21, p2, cf21, cf20, cf20, cf20];
						v132[235] := true;
						v127[665] := cf22;
						var v139: seq<map<bool, int>> := [v131, v131, v131, v131];
						v127[633] := |v139|;
						var v140: multiset<array<int>> := multiset{v127, v127, v127};
						v132[235], v127[665], v127[633], cf22, globalState.f2 := v140 !! v140, p1, if ((v117 > v117) in v131) then v131[v117 > v117] else cf22, -cf23, true;
					case DC13(cf25) =>
						var v141: array<int> := new int[12](i12 => i12 + cf25);
						v141[39] := if (f9) then p1 else cf25;
						v141[39] := cf25 % |(seq(0x22, i13  => (v115)))|;
						...
						var v147 := "n";
						var v148: multiset<multiset<int>> := multiset{multiset(([cf25])[v141[39] := cf25]), v123};
						v145 := v145[v146[|v147|] := v123 !in v148];
						r0 := p1 / 0x54;
					case DC14(cf26, cf27, cf28) =>
						var v149: array<int> := new int[29];
						v149[857] := p1;
						var v150: seq<multiset<int>> := [v123];
						var v151: map<bool, multiset<int>> := map[cf27 := v150[p1]];
						var v152: seq<int> := [p1, |v124|];
						v123, v149[857] := (if (!f9 in v151) then v151[!f9] else multiset(v152)) + v123, p1;
						...
						var v156 := "ifap";
						var v157: array<seq<bool>> := new seq<bool>[12] [v124, v155[p0], v124, fm20(f9, cf27, v149[857], v156, globalState), v124, [cf26] + v124, v124, v124, v124 + v124, v124[cf28 := true], v124 + v124, v124[p1 := cf27]];
						v157[554] := v124 + v124;
						var v158: map<bool, int> := map[cf26 := |fm28(284, fm1(v123, p0, globalState), globalState)|];
						var v159 := DC27(v158);
						v157[554] := v124[cf28 := p2] + fm41(v159, v149[857], v152, globalState);
						cf26 := cf27;
					case DC11(cf19) =>
				...
				if (f9) {
					...
					var v177: seq<string> := [seq(0x99, i16  => ('c')), v174, v176.cf35];
					v177, r0, r3, v115 := v177, p0, f9 in v124, v115;
					var v178: array<D3> := new D3[24];
					v178[789] := DC9(f9, v124).(cf18 := v124[p1 := p2]);
					var v179 := DC9(657 > fm0(globalState), [f9, p2]);
					v178[789] := v179;
					var v180: multiset<char> := multiset{v115};
					r0 := |(set v181 : char | v181 in (v180 + v180) :: (v181))|;
					var v182: array<set<int>> := new set<int>[12](i18 => {|(seq(0x34e, i19  => (v115)))|, |v117|});
					var v183: seq<array<set<int>>> := [v182, v182];
					var v184: seq<array<set<int>>> := [v183[fm0(globalState)]];
					var v185: C3 := new C3(true, v184[p0], p2);
		...
		var v200 := DC21(v198);
		var v201: seq<int> := [|"lo"|];
		globalState.f2, globalState.f2, v200, globalState.f2, r0 := f9 <==> f9, p2, v200, p0 == (if (f9) then p0 else |v201|), p0 % p0;
		var v202: array<D15> := new D15[19];
		var v203: set<int> := {p0, p1};
		var v204: seq<set<int>> := [{p1}];
		var v206: array<set<int>> := new set<int>[15] [v203, v203, v203, v203, v203, v203, v203, v204[fm0(globalState)], {p0, -0x356}, v203, v203, v203, v203, v203, set v205 : int | (0x60 <= v205) && (v205 < 923) :: (v205 / p1)];
		...
		var v212 := DC13(p0);
		r1 := v212;
		var v213: multiset<bool> := multiset{v188 < v188[|[|multiset{f9}|]| := v196]};
		r2 := v213;
		r3 := p2;
	}
}
...
class C5 extends T1, T2 {
	...
	method m1(p0: int, p1: bool, p2: bool, p3: array<seq<bool>>, globalState: GlobalState) {
		...
		for i0 := f10 to |multiset(v1 + (seq(0x17b, i1  => (v0))))| {
			var v2 := 'x';
			...
			v4[129] := v5;
			globalState.f2, globalState.f2, v3, v4[129], globalState.f2 := p2, p1, (if (p2) then i0 else i0) / |v0|, v5, f9;
			var v6: seq<bool> := [p1, p1];
			var v7: map<bool, array<bool>> := map[p2 := v4[129]];
			v4[129], v3, v6 := if (p2 in v7) then v7[p2] else v4[129], p0, v6;
			...
			if (multiset{v10, v10} < v11) {
				...
				var v14: map<string, array<map<bool, int>>> := map[(fm6([p2], globalState) + v0)[p0 := v2] := v13];
				v2, v4[129][931], v13 := v2, ("srhyeyrp" + (seq(0x23e, i4  => (v2)))) <= v0, if ((v0 + v0) in v14) then v14[v0 + v0] else v13;
				var v15: map<bool, char> := map[v6[p0] := v2];
				v15 := v15[v8 > v8 := v2];
				var v16: map<map<bool, bool>, int> := map[v10 := i0];
				var v17: seq<int> := [f10];
				v3 := -(if (f9) then if (v10 in v16) then v16[v10] else f10 else |multiset(v17[p0 := p0])|);
				var v18 := DC1(v3);
				...
				var v21: set<bool> := {v6[|map[v4[129][931] := p2]|]};
				...
				var v26: array<int> := new int[27] [if (v22 in v23) then v23[v22] else 245, |v8|, p0, |v9|, v3 / 0x1c9, fm0(globalState), p0, f10 - i0, i0, i0 + |v0|, f10, if (v10 in v16) then v16[v10] else |v0|, i0 - |v8|, |v0|, f10, |v9|, p0, v3 * f10, v3 - v3, 0x34d, v3 % i0, -p0, v3, f10, i0 + p0, |v0| * -(if (v24 in v25) then v25[v24] else p0), if (p1) then |v0| else 678];
				var v27: map<int, bool> := map[|(seq(-168, i5  => (v2)))| := v4[129][931]];
				v26[106] := |(if (p1) then v27 else v27)|;
				v3, v3, v20, v21, v26[106] := f10, 0x356, (v20 + v20) + map[|v0| := map v28 : int | (0x284 <= v28) && (v28 < 0x1ee) :: (v28 % p0) := (v3)], v21, i0;
				v4[129][931] := fm3(globalState);
			}
		...
		for i6 := p0 to f10 {
			...
			var v40: map<int, D1> := map[|fm2(|v31[v34 := 263]|, f9, false, f10, globalState)| := DC1(0x31a)];
			var v41 := DC1(v34);
			v40 := map[i6 / v34 := v41];
		...
		v44 := v45[f10] + v45[f10];
		var v46 := 38;
		var v47 := DC0(seq(884, i7  => (|map[v46 := f9]|)));
		var v48: set<seq<int>> := {v31, v31};
		var v49: C0 := new C0(v48, v46);
		var v50: map<bool, C0> := map[f9 := v49];
		globalState.f2, v46, v47, v0 := p0 != -v46, |v31| % (f10 * |v50|), fm9(f10 / p0, v46, false, globalState), "yuoebdhit";
	}
	method m2(p0: array<array<int>>, p1: string, p2: char, p3: seq<int>, globalState: GlobalState) returns (r0: bool, r1: bool, r2: int, r3: set<int>) {
		var i0 := 0;
		while (f9)
			decreases 100 - i0
		{
			...
			i0 := i0 + 1;
			var v0: set<seq<int>> := {p3[f10 := f10]};
			var v1 := new C0(v0, p3[f10] - f10);
		...
		v6[716] := f10 - f10;
		v3, v5, r1, v6[716], r1 := p1, v5, fm0(globalState) in {f10, 0x118, f10, f10}, f10, (f9 && false) <== f9;
		if (f9) {
			...
			var v10: multiset<int> := multiset{v6[716]};
			var v11: array<bool> := new bool[21] [|fm10(f9, globalState)| <= f10, !f9, f9, f9, f9, v8.cf6, f9, f9, f9, f9, p2 !in v3[f10 := fm11(f9, globalState)], f9, !f9, DC1(f10).cf1 >= f10, f9, f9, f9, fm1(multiset(p3), v6[716], globalState), v10 > v10, f9, f9];
			v11[341] := fm12(v8.cf6, |v3|, f9, |v3|, globalState) !! fm12(true, f10, f9, v6[716], globalState);
			var v12: seq<bool> := [f9];
			var v13 := DC4(0x90, f9, f9, f9, v12[f10]);
			v8, v9, v11[341], r2, r2 := v8.(cf6 := (seq(0x44, i1  => (-v6[716]))) < [|v3|]), v9, f9, -v13.cf9, f10;
			if (v11[341] || f9) {
				var v14: set<seq<int>> := {p3};
				var v15: map<int, seq<bool>> := map[v6[716] := v12];
				globalState.f2 := fm5(v14, v15, f10 * f10, globalState);
				r0 := v11[341];
				var v16: map<int, string> := map[f10 := "gjurujc"];
				v3 := (if (-v6[716] in v16) then v16[-v6[716]] else p1) + p1;
				var v17: multiset<bool> := multiset{p1 <= "vfyqtatu"};
				v17 := v17;
				v10 := v10;
			} else {
				r2, r2, globalState.f2, v6[716] := f10 % f10, f10, !f9, f10;
				...
				v22[675] := p2;
				var v23: seq<int> := [|(p1 + p1)|, f10 * v6[716]];
				var v24: C0 := new C0({v23}, f10);
				var v25: seq<C0> := [v24];
				v22[675], v3, v3, v23, v25 := p2, "lg", "lf", v23, v25;
				globalState.f2 := f10 >= |p3|;
				var v26: array<map<int, multiset<int>>> := new map<int, multiset<int>>[8](i2 => map[v6[716] := v10]);
				var v27: map<int, multiset<int>> := map[|v4| := multiset(p3)];
				v26[131] := map[v6[716] := v10] + v27;
				var v28 := DC2(f10, false, f10, -f10);
				var v29: seq<D1> := [v28, v28];
				var v30: T0 := new C1(v29);
				var v31: map<bool, T0> := map[true := v30];
				var v32 := DC2(v6[716], f9, |v31|, f10);
				v26[131] := v27 + (fm13(fm4(v11[341], f9, f9, v32.cf3, globalState), v11[341], f9, globalState) + v27);
				var v33 := new C0(v24.f11, |(seq(0x347, i3  => (p2)))|);
			}
			...
			v42 := v43.cf30;
			v6[716] := f10;
			var v44 := DC2(f10, f9, v6[716], 0xf7);
			var v45 := new C1([v44, v44]);
			var v46: map<bool, int> := map[f9 := -v6[716]];
			v46 := v46 + v46;
		}
		...
		v47[305], v47, v47, r1 := !((set v48 : int | v48 in v4 :: (v48 * 0x4e)) >= fm12(f9, v6[716], f9, f10, globalState)), v47, v49[f10], fm1(v50, v6[716], globalState);
		var v51 := DC10();
		...
		var v54: seq<bool> := [f9];
		var v55 := DC9(f9, v54);
		var v56: map<int, seq<int>> := map[v6[716] := [|v55.cf18|, v6[716], f10]];
		var v57: set<seq<int>> := {if (f10 in v56) then v56[f10] else p3};
		var v58: map<int, seq<bool>> := map[f10 := v54];
		r1 := fm5((set v53 : seq<int> | v53 in v52 :: (v53)) + v57, v58 + v58, v6[716], globalState);
		r2 := f10;
		r3 := v4 * v4;
	}
	method m3(p0: bool, globalState: GlobalState) returns (r0: bool) {
		for i0 := f10 to f10 {
			if (p0) {
				var v0: set<seq<int>> := {seq(-0x32a, i1  => (i0))};
				...
				v7[74] := v6;
				v7[74] := v6.(cf1 := v1.f12 / v1.f12);
				var v8: seq<bool> := [f9];
				v1.f12 := -((i0 * |v8|) + i0);
				var v9: C1 := new C1(seq(468, i2  => (DC2(f10, p0, i0, |v4|))));
				...
				var v23: array<int> := new int[21] [fm4(p0, p0, f9, p0, globalState), |v13[!f9 := f10]|, f10, i0 % f10, |v14| + -f10, f10, i0, |multiset([p0])| / |v18|, f10, -(v17[0x39b] % f10), f10, i0, |v15|, fm4(f9, p0, !false, !p0, globalState), -(0x327 / 9), f10, f10, f10, |v22|, i0, i0];
				v23[405] := i0;
				v23[405] := -f10;
				...
				v11 := v11;
				var v27 := DC17(v19);
				v20 := map v26 : int | v26 in v27.cf31 :: (v26 - i0) := (v23[405]);
			}
			...
			var v31 := 0x1e5;
			v28[790], v30, v31 := (v31 + f10) + (v31 + 0x72), if (true) then v30 + {v29} else v30, f10 / f10;
			var v32 := "jk";
			var v33 := 'q';
			...
			var v43: seq<string> := [seq(0x60, i3  => ('s')), ("x")[f10 := v33], if (fm5(v36, map v37 : int | v37 in v42 :: (v37 * 173) := ([v39.f9]), -|v32|, globalState)) then v32 else v32];
			var v44: set<bool> := {!f9, v39.f9, v29.f9};
			var v45: map<bool, bool> := map[v39.f9 := v33 in "goklh"];
			var v46: seq<bool> := [v29.f9];
			v32, v32, globalState.f2, globalState.f2 := v43[v35[|v44|]], seq(-0x3b1, i4  => (v33)), !(if (v46[v28[790]] in v45) then v45[v46[v28[790]]] else f9), v39.f9;
			...
			match (v49) {
				case DC12(cf20, cf21, cf22, cf23, cf24) =>
					...
					cf23 := v35[v28[790]];
					v28[790] := v35[i0];
					var v51 := new C2(-|v44|, v50[949]);
				case DC13(cf25) =>
					var v52: multiset<bool> := multiset{v46[v28[790]]};
					v52 := if (!v39.f9) then multiset(v46) else v52[p0 := v28[790]];
					...
					v58 := (fm43({|v59.cf18|, i0}, |v47|, fm0(globalState), globalState))[v44 := cf25];
				case DC14(cf26, cf27, cf28) =>
					var v60: array<string> := new string[9](i6 => ("hksmc")[cf28 := v33] + v32);
					v35, v28[790], v60 := v35, fm0(globalState), v60;
					var v61: map<int, bool> := map[-v31 := v29.f9];
					var v62: set<int> := {f10, f10};
					var v63 := DC6(v62);
					var v64: map<D2, int> := map[v63 := cf28];
					var v65: set<map<D2, int>> := {v64};
					r0, globalState.f2 := if (false) then p0 else if (v28[790] in v61) then v61[v28[790]] else fm1(multiset{-cf28, f10}, cf28, globalState), !(v65 > (if (!v39.f9) then v65 else v65));
					v32 := v32;
		...
		var v74: C1 := new C1((seq(0xcf, i7  => (DC2(0x33c, f9, f10, f10)))) + fm7(f10, f9, v73, true, globalState));
		v74 := v74;
		...
		var v82: array<map<int, bool>> := new map<int, bool>[27] [(map v77 : int | (294 <= v77) && (v77 < 229) :: (v77 % f10) := (p0))[-f10 := v76.f15], fm15(v76.f15, globalState) + v78, v78, map[f10 := v76.f15], v78, v78, map[f10 := p0], v78, v78, v78[f10 := !v76.f15] + v78, v78, v78, v78, v78, v78, v78, map[|v79| := p0], v78, v78, v78 + v78, fm15(f9, globalState), map[f10 := p0], v78, map v80 : int | (0x29e <= v80) && (v80 < -0x29c) :: (v80 * f10) := (f9), fm15(p0, globalState) + v81[f10], v78, map[f10 := p0] + v78];
		v82[713] := v78;
		var v83 := DC2(f10, true, f10, f10);
		v82[713] := match v83 {
			case DC2(cf2, cf3, cf4, cf5) => v78 + v78
			case DC3(cf6, cf7, cf8) => v81[f10]
		...
		if (f10 >= f10) {
			...
			match (fm44(globalState)) {
				...
				case DC20(cf36, cf37) =>
					...
					v106 := v106[!!v84[515] := 0x19e];
					var v107: map<bool, bool> := map[v76.f15 := cf36];
					var v108: set<bool> := {p0, p0, p0};
					v101.f12, globalState.f2, v86, v84[515] := v101.f12 - f10, multiset{cf36} >= v86, v86, if (({v76.f15} !! v108) in v107) then v107[{v76.f15} !! v108] else false;
	...
	method m4(p0: array<int>, p1: int, p2: bool, globalState: GlobalState) {
			...
			decreases 100 - i0
		{
			...
			v5[242] := f9;
			v0 := f10 / v0;
			var v6: seq<bool> := [v5[242]];
			var v7: map<bool, int> := map[f9 := |v6|];
			var v8: set<int> := {-|v7|, f10, v0, -0xab};
			v5[242], v0, globalState.f2, globalState.f2, v0 := true, (v0 % v0) + |({f10, -0xce} - v8)|, false, v0 in map[v0 := f9], f10;
		}
		var v9 := "ua";
		v9 := "iatft";
		var v10 := 0x19f;
		...
		v10, v10, v12 := -(p1 + -p1), |(v15 + (map[f9 := v14[f10 := v13]] + v15))|, v12;
	...
	method m5(globalState: GlobalState) returns (r0: bool, r1: int, r2: int) {
		...
		for i3 := -f10 to |v12| {
			...
			match (v20) {
				case DC6(cf15) =>
					...
					var v29: multiset<int> := multiset{if (v10.f15 in v23) then v23[v10.f15] else |(set v24 : int | (-0x75 <= v24) && (v24 < 0x19a) :: (v24 / -0x209))|, i3, |(if (f10 in v28) then v28[f10] else v27)|};
					v22[698] := if (v10.f15) then v10.f15 else !(v29 >= fm29(f9, f9, globalState));
					r1 := 0x156;
					v26.f12 := -i3;
			}
			
			var v30: set<bool> := {v17.f9, v10.f15, v10.f15};
			r0, v30, r2 := f10 != f10, v30, i3 % (v15[-f10] % i3);
		...
		match (v33) {
			case DC41() =>
				...
				var v36: set<seq<int>> := {v35};
				var v37: array<int> := new int[11](i5 => i5 / f10);
				...
				var v41: map<bool, bool> := map[v10.f15 := fm1(v40, v35[f10], globalState)];
				v41 := v41[v10.f15 := !v34[472]];
			...
			case DC42(cf73, cf74, cf75, cf76) =>
				...
				var v50: map<map<multiset<int>, char>, int> := map[if (!!cf73) then map v44 : multiset<int> | v44 in v47 :: (v44) := ('r') else v49 := f10 % |v45|];
				v50 := v50[v49 := f10];
			...
			case DC43() =>
				...
				v68 := v68[v67[v66 := 0x2a5] := v10.f15];
				var v69: set<int> := {|v63|};
				var v70: seq<set<int>> := [{f10, f10}, v69];
				var v71 := DC9(f9, v12);
				var v72: seq<int> := [-45, fm4(false, v10.fm32(v70, v71.cf17, f10, fm3(globalState), globalState), v10.f15, v10.f15, globalState) % f10];
				v72 := seq(-392, i6  => (-f10));
				r0 := v12[f10];
			...
			case DC44(cf77) =>
				...
				if (!(if (f10 <= f10) then if (v10.f15) then v10.f15 else v87.f9 else f9)) {
					...
					v89, v90[590] := v89 + ([f10] + v89), fm1(v91, f10, globalState);
					var v92: map<int, string> := map[0xf2 := v82];
					var v93: map<bool, string> := map[v87.f9 := if (|"lm"| in v92) then v92[|"lm"|] else v82];
					var v94: seq<string> := [seq(-0x74, i9  => (v85))];
					var v95: array<string> := new string[25] [v82, v82 + "ouulicrh", v82, v82, if (v10.f15) then "cc" else v82, seq(0x28c, i7  => (v85)), "a", v82, v82, v82, "anxityp" + "j", v82, if (v87.f9 in v93) then v93[v87.f9] else v82, v82, fm28(f10, !f9, globalState), v82, v82, seq(839, i8  => (v85)), v94[f10], seq(0x35b, i10  => (v85)), seq(0x3cf, i11  => (v85)), v82, v82, v82, "fc"];
					var v96: map<map<int, string>, array<string>> := map[v92 := v95];
					v95 := if ((v92 + v92) in v96) then v96[v92 + v92] else v95;
					var v97: multiset<bool> := multiset{v90[590]};
					v97 := v97;
					...
					var v103 := v10.m3((multiset{v10.f15})[v12[f10] := f10] !! v102, globalState);
					r0 := |v12| > -v101.f14;
				}
		...
		var v105 := DC46(-|(seq(-0x2c, i13  => ('s')))| - f10);
		v105 := v105;
		r0 := v10.f15;
		r1 := f10;
		r2 := f10;
...
method Main() {
	...
	forall i0 | 0 <= i0 < v3.Length {
		v3[i0] := i0 / |(if (v0) then seq(105, i2  => (multiset{v0, v0})) else [multiset([v0, v0]), multiset{v0, v0, v0}])|;
	}
	var v4 := 490;
	for i3 := v4 to fm0(globalState) {
		...
		v4, v3[487] := |v7|, i3;
		var v8: map<int, int> := map[v4 := v3[487]];
		var v9: seq<array<bool>> := [v5, v5];
		v4 := |v8| / |(v9 + v9)|;
		var v10: multiset<int> := multiset{v3[487], v3[487]};
		v0 := fm1(if (v0) then v10 else v10, v3[487], globalState);
	}
	var i5 := 0;
	while (v0)
		decreases 100 - i5
	{
		...
		var v13: seq<string> := [v2, seq(655, i6  => (v11)), v2, v2, v2];
		var v15: map<char, int> := map[v11 := |(set v14 : string | v14 in v13 :: (v14))|];
		v12 := v12[v15 + v15 := v0];
		var v16 := new C4(v0);
		globalState.f2 := (fm28(v4, !v0, globalState) + v2)[v4 := v11] <= [v11];
		if (v0 ==> v0) {
			var v17: seq<bool> := [v0];
			var v18: multiset<int> := multiset{|multiset{v4}|, |v17|};
			var v19: set<seq<int>> := {[|v18|], seq(-0xa5, i7  => (v4))};
			var v20 := new C0(v19, -v4);
			var v21 := DC2(v20.f12, v20.f12 == v4, v4 % v20.f12, v4);
			v21 := v21;
	...
	for i8 := |v2| to v4 {
		...
		var v41 := DC48(v39);
		globalState.f2, v4, v39 := fm46(v0, v0, !!v0, globalState) == (map v40 : int | (-0x246 <= v40) && (v40 < 489) :: (v40 % v4) := (v2)), v4, v41.cf81;
		m0(v0, globalState);
		globalState.f2 := i8 != v4;
		var v42: seq<bool> := [v0];
		v4, globalState.f2, v0 := i8, v0, (if (v0) then v42[v4] else v0) <== v0;
	}
	m0(v0, globalState);
	var i9 := 0;
	while (v0)
		...
		decreases 100 - i12
	{
		...
		if (!v0) {
			...
			v69 := v69[v0 := v0];
			var v70: seq<int> := [v3[547]];
			var v71: set<seq<int>> := {v70, [0x3b4, v3[547]], v70};
			var v72 := new C0(v71, v3[547] + |v69|);
			...
			v0 := v0;
			var v76: array<map<D0, int>> := new map<D0, int>[28](i13 => map[DC0([v3[547]]) := v3[547]] + map[DC0(seq(0x2b6, i14  => (v4))) := |{v3[547]}|]);
			v76[880] := fm47(globalState);
			var v77: seq<int> := [v4, v3[547]];
			var v78 := DC0(v77);
			var v79: map<D0, int> := map[v78 := v4];
			v76[880] := (map[v78 := v4] + v79[v78.(cf0 := v77) := |v77|])[v78 := v4];
			var v80: multiset<int> := multiset{v3[547]};
			var v81 := DC22(v3);
			globalState.f2, globalState.f2, v0, globalState.f2, v3 := v0, v0, v3[547] <= |v80|, v0, v81.cf39;
			var v82 := DC43();
			var v83 := DC44(v82);
			...
			var v90 := DC42(v0, v3[547], v89, v4);
			var v91: map<D15, bool> := map[v90 := v3[547] < -v4];
			v4, v83, globalState.f2, v87 := --(v4 % (v86.f14 * v86.f14)), v83.(cf77 := v82), if (v90 in v91) then v91[v90] else v89.f9, v87 + v87;
	...
	var v97 := DC13(v4);
	var v98: C2 := new C2(v3[547], v0);
	var v99: multiset<C2> := multiset{v98};
	var v100: seq<map<bool, int>> := [map[v0 := v98.f14]];
	var v101: seq<map<bool, int>> := [v100[v98.f14]];
	var v102: map<bool, int> := map[v0 := |{v0, v0}|];
	var v103: map<bool, bool> := map[v0 := v0];
	var v104 := DC24(v0, v3[547], "fqe");
	v95, v4, v55, v3[547], globalState.f2 := v95 + (fm48(v0, fm11(false, globalState), v0, if (-v3[547] in v95) then v95[-v3[547]] else |v96|, globalState))[-0x266 := |map[v97.(cf25 := v3[547]) := v58]|], v3[547], v55, if (v98 in v99) then v99[v98] else |(if (false) then v100[v4] else v102)|, (|v103| > v3[547]) <== (if (v0) then false else !v104.cf41);
	var v105: array<bool> := new bool[7];
	v105, v3[547], v97, v0 := v105, v3[547], DC13(|v2| % v98.f14), !v0;
